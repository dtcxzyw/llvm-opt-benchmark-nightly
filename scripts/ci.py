...
PER_FILE_INTERESTING_STATS = ["inline.NumInlined", "inline.NumDeleted", "loop-unroll.NumCompletelyUnrolled", "loop-unroll.NumRuntimeUnrolled", "loop-unroll.NumUnrolled", "loop-unroll.NumUnrolledNotLatch"]
...
RUN_OPT_TIME_BUDGET_SECONDS = 90 * 60
