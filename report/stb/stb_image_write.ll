...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.bb = load float, ptr %i.ar, align 4, !tbaa !23 ; 2 uses
  %i.bc = load float, ptr %i.as, align 4, !tbaa !23 ; 2 uses
  ...
  %i.bh = fadd float %i.bb, %i.bc                 ; 2 uses
  %i.bi = fsub float %i.bb, %i.bc
