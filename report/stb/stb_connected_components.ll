...
bb.e:                                             ; preds = %bb.d, %bb.i
  ...
  %i.ae = load i8, ptr %gep, align 1, !tbaa !10
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.ag = load i16, ptr %gep170, align 2, !tbaa !8
  %gep172 = getelementptr [2048 x i8], ptr %invariant.gep171, i64 %i.ad
  %i.ah = load i16, ptr %gep172, align 2, !tbaa !8
...
bb.j:                                             ; preds = %.loopexit
  %i.bc = load i32, ptr %i.k, align 4, !tbaa !30
...
bb.k:                                             ; preds = %bb.j
  %i.be = load i32, ptr %i.l, align 4, !tbaa !32
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.bn = load i8, ptr %gep176, align 1, !tbaa !10
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.bo = load i16, ptr %gep178, align 2, !tbaa !8
  %gep180 = getelementptr [2048 x i8], ptr %invariant.gep179, i64 %i.bl
  %i.bp = load i16, ptr %gep180, align 2, !tbaa !8
  ...
  %i.bw = load i8, ptr %i.bv, align 1, !tbaa !10  ; 2 uses
...
bb.p:                                             ; preds = %bb.o
  ...
  store i8 %i.cd, ptr %i.bv, align 1, !tbaa !10
...
bb.q:                                             ; preds = %bb.p, %bb.o, %bb.n, %bb.m
  ...
  br i1 %exitcond.1.not, label %.loopexit.1, label %bb.m, !llvm.loop !33
...
.loopexit.1.thread:                               ; preds = %bb.j, %bb.k, %.loopexit.1
  ...
  %i.ck = load i32, ptr %i.k, align 4, !tbaa !30
...
bb.r:                                             ; preds = %.loopexit.1.thread
  %i.cm = load i32, ptr %i.l, align 4, !tbaa !32
...
bb.v:                                             ; preds = %bb.u
  ...
  %i.dn = load i16, ptr %i.dm, align 2, !tbaa !8
  ...
  %i.dw = load i8, ptr %i.dv, align 1, !tbaa !10  ; 2 uses
...
bb.x:                                             ; preds = %bb.w, %bb.v, %bb.u, %bb.t
  ...
  br i1 %exitcond.2.not, label %.loopexit.2, label %bb.t, !llvm.loop !33
...
.loopexit.2.thread:                               ; preds = %.loopexit.1.thread, %bb.r, %.loopexit.2
  ...
  %i.ek = load i32, ptr %i.k, align 4, !tbaa !30
...
bb.y:                                             ; preds = %.loopexit.2.thread
  ...
  %i.en = load i32, ptr %i.l, align 4, !tbaa !32
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %i.fj = load i8, ptr %i.fi, align 1, !tbaa !10
...
bb.ac:                                            ; preds = %bb.ab
  ...
  %i.fp = load i16, ptr %i.fo, align 2, !tbaa !8
  ...
  %i.fy = load i8, ptr %i.fx, align 1, !tbaa !10  ; 2 uses
...
bb.ae:                                            ; preds = %bb.ad, %bb.ac, %bb.ab, %bb.aa
  ...
  br i1 %exitcond.3.not, label %.loopexit.3, label %bb.aa, !llvm.loop !33
...
bb.ai:                                            ; preds = %bb.ai, %.lr.ph.new
  ...
  %i.gz = load i8, ptr %i.gy, align 2, !tbaa !10
  ...
  store i8 %i.hn, ptr %i.hp, align 2, !tbaa !19
  ...
  store i8 0, ptr %i.hs, align 4, !tbaa !21
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.bj = load i16, ptr %i.bi, align 2, !tbaa !8  ; 2 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  store i8 %i.bx, ptr %i.bp, align 1, !tbaa !10
  ...
  %i.ch = load i8, ptr %i.cg, align 4, !tbaa !21  ; 3 uses
...
.sink.split:                                      ; preds = %bb.m, %bb.o
  ...
  store i16 %i.hs, ptr %i.ht, align 2, !tbaa !8
  br label %bb.p
...
.sink.split442:                                   ; preds = %bb.q, %bb.s
  ...
  store i16 %.sink, ptr %i.ip, align 2, !tbaa !8
  br label %bb.t
