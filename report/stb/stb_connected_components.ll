...
bb.ac:                                            ; preds = %bb.ab
  ...
  %i.ft = load i16, ptr %i.fs, align 2, !tbaa !8
  ...
  %i.ga = load i8, ptr %i.fz, align 1, !tbaa !10  ; 2 uses
...
.loopexit.3:                                      ; preds = %bb.ae, %bb.a, %.loopexit.1, %bb.y, %.loopexit.2.thread, %.loopexit.2
  ...
  %i.go = load i8, ptr %i.gn, align 2, !tbaa !11  ; 5 uses
...
bb.ai:                                            ; preds = %bb.ai, %.lr.ph.new
  ...
  %i.hb = load i8, ptr %i.ha, align 2, !tbaa !10
...
.epil.preheader:                                  ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph
  ...
  %i.hx = load i8, ptr %i.hw, align 1, !tbaa !10
...
.thread:                                          ; preds = %stbcc__add_clump_connection.exit, %bb.n, %bb.m, %bb.l
  ...
  br i1 %exitcond.not, label %.loopexit, label %bb.l, !llvm.loop !36
...
bb.j:                                             ; preds = %stbcc__add_connections_to_adjacent_cluster_with_rebuild.exit56
  %i.bi = load i32, ptr %i.au, align 4, !tbaa !30
...
bb.n:                                             ; preds = %bb.j, %bb.k, %bb.l, %bb.m
  %i.bt = load i32, ptr %i.au, align 4, !tbaa !30
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.bj = load i8, ptr %i.bi, align 1, !tbaa !10  ; 2 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  store i8 %i.bq, ptr %i.bi, align 1, !tbaa !10
  ...
  %i.cb = load i8, ptr %i.ca, align 2, !tbaa !19
  ...
  %i.cf = load i8, ptr %i.ce, align 4, !tbaa !21  ; 3 uses
...
bb.r:                                             ; preds = %bb.q, %bb.p, %bb.o
  ...
  br i1 %exitcond.not.i, label %stbcc__remove_clump_connection.exit, label %bb.o, !llvm.loop !38

bb.s:                                             ; preds = %bb.q
  %i.cs = getelementptr inbounds nuw [2 x i8], ptr %i.cd, i64 %indvars.iv.i
  %i.ct = add i8 %i.cf, -1                        ; 2 uses
  store i8 %i.ct, ptr %i.ce, align 4, !tbaa !21
  %i.cu = zext i8 %i.ct to i64
  %i.cv = getelementptr inbounds nuw [2 x i8], ptr %i.cd, i64 %i.cu
  %i.cw = load i16, ptr %i.cv, align 2, !tbaa !10
  store i16 %i.cw, ptr %i.cs, align 2, !tbaa !10
...
stbcc__remove_clump_connection.exit:              ; preds = %bb.r, %bb.s, %bb.n, %bb.m, %bb.l, %bb.k
  ...
  br i1 %exitcond.not, label %.loopexit, label %bb.k, !llvm.loop !39
