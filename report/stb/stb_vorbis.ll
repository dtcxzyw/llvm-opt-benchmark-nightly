...
.lr.ph86.prol:                                    ; preds = %.lr.ph86.preheader, %.lr.ph86.prol
  ...
  %i.bo = sub nuw nsw i32 32, %.085.prol
...
bb.g:                                             ; preds = %.lr.ph104, %bb.g
  ...
  %3 = sext i32 %i.bm to i64
  %i.bn = getelementptr inbounds [4 x i8], ptr %i.bk, i64 %3
  %i.bo = load i32, ptr %i.bn, align 4, !tbaa !25
  %.not71 = icmp ugt i32 %i.bo, %i.bh             ; 2 uses
  %i.bp = sub nuw nsw i32 %.0103, %i.bl
...
bb.h:                                             ; preds = %._crit_edge
  ...
  %i.bt = getelementptr inbounds [4 x i8], ptr %i.bs, i64 %.059.lcssa
  store i32 %i.br, ptr %i.bt, align 4, !tbaa !25
  %i.bu = load ptr, ptr %i.az, align 8, !tbaa !36
  %i.bv = getelementptr inbounds i8, ptr %i.bu, i64 %.059.lcssa
...
bb.i:                                             ; preds = %._crit_edge
  ...
  %i.bx = getelementptr inbounds [4 x i8], ptr %i.bw, i64 %.059.lcssa
...
.lr.ph:                                           ; preds = %.thread96, %.lr.ph
  ...
  %i.aj = add nsw i32 %i.ai, %.05471              ; 2 uses
  %2 = sext i32 %i.aj to i64
  %i.ak = getelementptr inbounds [4 x i8], ptr %i.ab, i64 %2
  %i.al = load i32, ptr %i.ak, align 4, !tbaa !25
  %.not65 = icmp ugt i32 %i.al, %i.ae             ; 2 uses
  %i.am = sub nuw nsw i32 %.072, %i.ai
...
bb.k:                                             ; preds = %._crit_edge
  ...
  %4 = sext i32 %.054.lcssa to i64
  %i.ar = getelementptr inbounds [4 x i8], ptr %i.aq, i64 %4
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.bb = sub nuw nsw i32 %i.az, %i.ay
  br label %.sink.split
...
.lr.ph.i426.us.us.us:                             ; preds = %.thread96.i420.us.us.us, %.lr.ph.i426.us.us.us
  ...
  %i.ux = add nsw i32 %i.uw, %.05471.i428.us.us.us ; 2 uses
  %6 = sext i32 %i.ux to i64
  %i.uy = getelementptr inbounds [4 x i8], ptr %i.ur, i64 %6
  %i.uz = load i32, ptr %i.uy, align 4, !tbaa !25
  %.not65.i429.us.us.us = icmp ugt i32 %i.uz, %i.ut ; 2 uses
  %i.va = sub nuw nsw i32 %.072.i427.us.us.us, %i.uw
  ...
  %7 = icmp samesign ugt i32 %.1.i431.us.us.us, 1
...
bb.ep:                                            ; preds = %._crit_edge.i421.us.us.us
  ...
  %8 = sext i32 %.054.lcssa.i422.us.us.us to i64
  %i.vd = getelementptr inbounds [4 x i8], ptr %i.vc, i64 %8
...
bb.er:                                            ; preds = %bb.eq
  ...
  %i.vm = sub nuw nsw i32 %i.vk, %i.vj
  br label %codebook_decode_scalar_raw.exit434.us.us.us
...
bb.id:                                            ; preds = %._crit_edge.i.us
  ...
  %11 = sext i32 %.054.lcssa.i.us to i64
  %i.agy = getelementptr inbounds [4 x i8], ptr %i.agx, i64 %11
...
bb.if:                                            ; preds = %bb.ie
  ...
  %i.ahh = sub nuw nsw i32 %i.ahf, %i.ahe
  br label %codebook_decode_scalar_raw.exit.us
...
bb.ed:                                            ; preds = %._crit_edge.i
  ...
  %10 = sext i32 %.054.lcssa.i to i64
  %i.pz = getelementptr inbounds [4 x i8], ptr %i.py, i64 %10
...
bb.ef:                                            ; preds = %bb.ee
  ...
  %i.qj = sub nuw nsw i32 %i.qh, %i.qg
...
begin_hunk_5_@compute_samples:bb.a
  ...
  %wide.load88 = load <4 x float>, ptr %i.u, align 16, !tbaa !56
  %wide.load89 = load <4 x float>, ptr %i.v, align 16, !tbaa !56
  %i.w = fadd <4 x float> %wide.load88, splat (float 3.840000e+02)
  %i.x = fadd <4 x float> %wide.load89, splat (float 3.840000e+02)
  ...
  %i.ag = getelementptr inbounds nuw [2 x i8], ptr %invariant.gep78, i64 %index87 ; 2 uses
  ...
  %i.ai = icmp eq i64 %index.next90, %n.vec85
  br i1 %i.ai, label %middle.block91, label %vector.body86, !llvm.loop !422
...
vector.body98:                                    ; preds = %.preheader.us.us, %vector.body98
  ...
  %i.aw = getelementptr [4 x i8], ptr %i.av, i64 %index99 ; 2 uses
  %i.ax = getelementptr i8, ptr %i.aw, i64 16
  %wide.load100 = load <4 x float>, ptr %i.aw, align 4, !tbaa !56
  %wide.load101 = load <4 x float>, ptr %i.ax, align 4, !tbaa !56
  %i.ay = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %index99 ; 3 uses
  %i.az = getelementptr inbounds nuw i8, ptr %i.ay, i64 16 ; 2 uses
  %wide.load102 = load <4 x float>, ptr %i.ay, align 16, !tbaa !56
  %wide.load103 = load <4 x float>, ptr %i.az, align 16, !tbaa !56
  %i.ba = fadd <4 x float> %wide.load100, %wide.load102
  %i.bb = fadd <4 x float> %wide.load101, %wide.load103
  ...
  %i.bc = icmp eq i64 %index.next104, %n.vec97
  br i1 %i.bc, label %middle.block105, label %vector.body98, !llvm.loop !425
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load81 = load <4 x float>, ptr %i.bm, align 16, !tbaa !56
  %i.bn = fadd <4 x float> %wide.load, splat (float 3.840000e+02)
  %i.bo = fadd <4 x float> %wide.load81, splat (float 3.840000e+02)
...
.lr.ph84:                                         ; preds = %bb.a
  ...
  %i.e = getelementptr inbounds [6 x i8], ptr @channel_position, i64 %i.d
...
scalar.ph162:                                     ; preds = %scalar.ph162.preheader, %scalar.ph162
  ...
  %6 = icmp samesign ult i64 %indvars.iv.next95, %5
  br i1 %6, label %scalar.ph162, label %.loopexit.us, !llvm.loop !428
...
scalar.ph150:                                     ; preds = %scalar.ph150.preheader, %scalar.ph150
  ...
  %i.ae = getelementptr inbounds nuw i8, ptr %i.a, i64 %.idx115 ; 2 uses
  ...
  %7 = icmp samesign ult i64 %indvars.iv.next98, %5
  br i1 %7, label %scalar.ph150, label %.loopexit.us, !llvm.loop !429
...
scalar.ph138:                                     ; preds = %scalar.ph138.preheader, %scalar.ph138
  ...
  %i.aj = getelementptr inbounds nuw i8, ptr %i.a, i64 %.idx116 ; 2 uses
  ...
  %indvars.iv.next101 = add nuw nsw i64 %indvars.iv100, 1 ; 2 uses
  %8 = icmp samesign ult i64 %indvars.iv.next101, %5
  br i1 %8, label %scalar.ph138, label %.loopexit.us, !llvm.loop !430
...
.lr.ph80.us:                                      ; preds = %.lr.ph80.us.preheader176, %.lr.ph80.us
  ...
  store i16 %i.au, ptr %gep121, align 2, !tbaa !44
...
vector.body166:                                   ; preds = %.lr.ph.us, %vector.body166
  ...
  %i.ba = getelementptr [4 x i8], ptr %i.az, i64 %index167
  %wide.load168 = load <4 x float>, ptr %i.ba, align 4, !tbaa !56
  %i.bb = shl nuw nsw i64 %index167, 3
  %i.bc = shl i64 %index167, 3
  %i.bd = shl i64 %index167, 3
  %i.be = shl i64 %index167, 3
  ...
  %wide.vec169 = load <8 x float>, ptr %i.bj, align 4, !tbaa !56
  %strided.vec170 = shufflevector <8 x float> %wide.vec169, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %i.bn = fadd <4 x float> %wide.load168, %strided.vec170 ; 4 uses
  ...
  %i.bs = icmp eq i64 %index.next171, %n.vec165
  br i1 %i.bs, label %scalar.ph162.preheader, label %vector.body166, !llvm.loop !434
...
vector.body154:                                   ; preds = %.lr.ph74.us, %vector.body154
  ...
  %i.bw = getelementptr [4 x i8], ptr %i.bv, i64 %index155
  %wide.load156 = load <4 x float>, ptr %i.bw, align 4, !tbaa !56
  %i.bx = shl nuw nsw i64 %index155, 3
  %i.by = shl i64 %index155, 3
  %i.bz = shl i64 %index155, 3
  %i.ca = shl i64 %index155, 3
  ...
  %wide.vec157 = load <8 x float>, ptr %i.cb, align 16, !tbaa !56
  %strided.vec158 = shufflevector <8 x float> %wide.vec157, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %i.ci = fadd <4 x float> %wide.load156, %strided.vec158 ; 4 uses
  ...
  %i.cn = icmp eq i64 %index.next159, %n.vec153
  br i1 %i.cn, label %scalar.ph150.preheader, label %vector.body154, !llvm.loop !435
...
vector.body142:                                   ; preds = %.lr.ph76.us, %vector.body142
  ...
  %i.cr = getelementptr [4 x i8], ptr %i.cq, i64 %index143
  %wide.load144 = load <2 x float>, ptr %i.cr, align 4, !tbaa !56
  %i.cs = shl nuw nsw i64 %index143, 3
  %i.ct = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.cs ; 2 uses
  %wide.vec = load <4 x float>, ptr %i.ct, align 16, !tbaa !56
  %i.cu = shufflevector <2 x float> %wide.load144, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 1>
  ...
  %i.cv = icmp eq i64 %index.next146, %n.vec141
  br i1 %i.cv, label %middle.block147, label %vector.body142, !llvm.loop !436
...
..preheader71_crit_edge.us:                       ; preds = %.loopexit.us
  %i.cw = shl nuw i32 %spec.select.us, 1          ; 2 uses
...
.lr.ph80.us.preheader:                            ; preds = %..preheader71_crit_edge.us
  ...
  %invariant.gep120 = getelementptr [2 x i8], ptr %0, i64 %i.cz ; 2 uses
...
vector.ph128:                                     ; preds = %.lr.ph80.us.preheader
  %n.vec129 = and i64 %i.da, 2147483640           ; 3 uses
...
vector.body130:                                   ; preds = %vector.body130, %vector.ph128
  ...
  %i.db = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %index131 ; 2 uses
  %i.dc = getelementptr inbounds nuw i8, ptr %i.db, i64 16
  %wide.load132 = load <4 x float>, ptr %i.db, align 16, !tbaa !56
  %wide.load133 = load <4 x float>, ptr %i.dc, align 16, !tbaa !56
  %i.dd = fadd <4 x float> %wide.load132, splat (float 3.840000e+02)
  %i.de = fadd <4 x float> %wide.load133, splat (float 3.840000e+02)
  ...
  %i.dn = getelementptr [2 x i8], ptr %invariant.gep120, i64 %index131 ; 2 uses
  ...
  %i.dp = icmp eq i64 %index.next134, %n.vec129
  br i1 %i.dp, label %middle.block135, label %vector.body130, !llvm.loop !437

middle.block135:                                  ; preds = %vector.body130
  %cmp.n136 = icmp eq i64 %n.vec129, %i.da
...
.preheader71:                                     ; preds = %.lr.ph84.split, %._crit_edge
  ...
  %i.du = sub i32 %4, %i.dt
  %spec.select = select i1 %i.ds, i32 %i.du, i32 %.05982 ; 3 uses
  %i.dv = shl nuw i32 %spec.select, 1             ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load125 = load <4 x float>, ptr %i.eb, align 16, !tbaa !56
  %i.ec = fadd <4 x float> %wide.load, splat (float 3.840000e+02)
  %i.ed = fadd <4 x float> %wide.load125, splat (float 3.840000e+02)
...
.lr.ph.i.preheader:                               ; preds = %.preheader.i
  ...
  %i.w = getelementptr inbounds [6 x i8], ptr @channel_position, i64 %i.v
...
.lr.ph78.us.i.us.us:                              ; preds = %._crit_edge.us.i39.us.us, %.lr.ph.i.us.us
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(128) %i.a, i8 0, i64 128, i1 false)
  %i.aa = add i32 %.05982.us.i.us.us, %indvars66  ; 2 uses
  %i.ab = icmp sgt i32 %i.aa, %spec.select
  %i.ac = sub i32 %spec.select, %indvars66
  ...
  %4 = zext i32 %i.af to i64                      ; 9 uses
  %min.iters.check111 = icmp ult i32 %i.af, 5
  %i.ag = and i64 %4, 3                           ; 2 uses
  %i.ah = icmp eq i64 %i.ag, 0
  %i.ai = select i1 %i.ah, i64 4, i64 %i.ag
  %n.vec113 = sub nsw i64 %4, %i.ai               ; 2 uses
  %min.iters.check99 = icmp ult i32 %i.af, 5
  %i.aj = and i64 %4, 3                           ; 2 uses
  %i.ak = icmp eq i64 %i.aj, 0
  %i.al = select i1 %i.ak, i64 4, i64 %i.aj
  %n.vec101 = sub nsw i64 %4, %i.al               ; 2 uses
  %min.iters.check87 = icmp ult i32 %i.af, 2
  %n.vec89 = and i64 %4, 4294967294               ; 3 uses
  %cmp.n96 = icmp eq i64 %n.vec89, %4
  br label %bb.e
...
vector.body114:                                   ; preds = %.lr.ph.us.i.us.us, %vector.body114
  ...
  %i.as = getelementptr [4 x i8], ptr %i.ar, i64 %index115
  %wide.load116 = load <4 x float>, ptr %i.as, align 4, !tbaa !56
  %i.at = shl nuw nsw i64 %index115, 3
  %i.au = shl i64 %index115, 3
  ...
  %wide.vec117 = load <8 x float>, ptr %i.bb, align 4, !tbaa !56
  %strided.vec118 = shufflevector <8 x float> %wide.vec117, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %i.bf = fadd <4 x float> %wide.load116, %strided.vec118 ; 4 uses
  ...
  %i.bk = icmp eq i64 %index.next119, %n.vec113
  br i1 %i.bk, label %scalar.ph110.preheader, label %vector.body114, !llvm.loop !455
...
scalar.ph110:                                     ; preds = %scalar.ph110.preheader, %scalar.ph110
  ...
  %exitcond59.not = icmp eq i64 %indvars.iv.next95.i.us.us, %4
...
vector.body102:                                   ; preds = %.lr.ph74.us.i.us.us, %vector.body102
  ...
  %i.bu = getelementptr [4 x i8], ptr %i.bt, i64 %index103
  %wide.load104 = load <4 x float>, ptr %i.bu, align 4, !tbaa !56
  %i.bv = shl nuw nsw i64 %index103, 3
  %i.bw = shl i64 %index103, 3
  ...
  %wide.vec105 = load <8 x float>, ptr %i.bz, align 16, !tbaa !56
  %strided.vec106 = shufflevector <8 x float> %wide.vec105, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %i.cg = fadd <4 x float> %wide.load104, %strided.vec106 ; 4 uses
  ...
  %i.cl = icmp eq i64 %index.next107, %n.vec101
  br i1 %i.cl, label %scalar.ph98.preheader, label %vector.body102, !llvm.loop !457
...
scalar.ph98:                                      ; preds = %scalar.ph98.preheader, %scalar.ph98
  ...
  %i.co = getelementptr inbounds nuw i8, ptr %i.a, i64 %.idx115.i.us.us ; 2 uses
  ...
  %exitcond61.not = icmp eq i64 %indvars.iv.next98.i.us.us, %4
...
vector.body90:                                    ; preds = %.lr.ph76.us.i.us.us, %vector.body90
  ...
  %i.cu = getelementptr [4 x i8], ptr %i.ct, i64 %index91
  %wide.load92 = load <2 x float>, ptr %i.cu, align 4, !tbaa !56
  %i.cv = shl nuw nsw i64 %index91, 3
  %i.cw = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.cv ; 2 uses
  %wide.vec = load <4 x float>, ptr %i.cw, align 16, !tbaa !56
  %i.cx = shufflevector <2 x float> %wide.load92, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 1>
  ...
  %i.cy = icmp eq i64 %index.next94, %n.vec89
  br i1 %i.cy, label %middle.block95, label %vector.body90, !llvm.loop !459
...
scalar.ph86:                                      ; preds = %scalar.ph86.preheader, %scalar.ph86
  ...
  %i.db = getelementptr inbounds nuw i8, ptr %i.a, i64 %.idx116.i.us.us ; 2 uses
  ...
  %exitcond63.not = icmp eq i64 %indvars.iv.next101.i.us.us, %4
...
..preheader71_crit_edge.us.i.us.us:               ; preds = %.loopexit.us.i.us.us
  %i.dg = shl nuw i32 %spec.select.us.i.us.us, 1
  %i.dh = icmp sgt i32 %i.dg, 0
  br i1 %i.dh, label %.lr.ph80.us.preheader.i.us.us, label %._crit_edge.us.i39.us.us

.lr.ph80.us.preheader.i.us.us:                    ; preds = %..preheader71_crit_edge.us.i.us.us
  %i.di = shl i32 %indvars66, 1
  %i.dj = sext i32 %i.di to i64
  %invariant.gep120.i.us.us = getelementptr [2 x i8], ptr %.031, i64 %i.dj ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load85 = load <4 x float>, ptr %i.dn, align 16, !tbaa !56
  %i.do = fadd <4 x float> %wide.load, splat (float 3.840000e+02)
  %i.dp = fadd <4 x float> %wide.load85, splat (float 3.840000e+02)
  ...
  %i.dy = getelementptr [2 x i8], ptr %invariant.gep120.i.us.us, i64 %index ; 2 uses
...
.lr.ph80.us.i.us.us:                              ; preds = %.lr.ph80.us.i.us.us.preheader, %.lr.ph80.us.i.us.us
  ...
  store i16 %i.eh, ptr %gep121.i.us.us, align 2, !tbaa !44
  %indvars.iv.next107.i.us.us = add nuw nsw i64 %indvars.iv106.i.us.us, 1 ; 2 uses
  %exitcond65.not = icmp eq i64 %indvars.iv.next107.i.us.us, %i.dl
...
.preheader71.i.us:                                ; preds = %._crit_edge.i.us, %.lr.ph.i.us
  ...
  %i.ek = add nsw i32 %.05982.i.us, %indvars55    ; 2 uses
  %i.el = icmp sgt i32 %i.ek, %spec.select
  %i.em = sub i32 %spec.select, %indvars55
  %spec.select.i.us = select i1 %i.el, i32 %i.em, i32 %.05982.i.us ; 2 uses
  %i.en = shl nuw i32 %spec.select.i.us, 1
...
.lr.ph80.preheader.i.us:                          ; preds = %.preheader71.i.us
  %i.ep = shl i32 %indvars55, 1
  %i.eq = sext i32 %i.ep to i64
  %invariant.gep.i.us = getelementptr [2 x i8], ptr %.031, i64 %i.eq ; 2 uses
  %smin = call i32 @llvm.smin.i32(i32 %i.ek, i32 %spec.select)
  %i.er = add i32 %smin, %indvars.iv53            ; 2 uses
  %5 = zext i32 %i.er to i64
  %6 = shl nuw nsw i64 %5, 1                      ; 2 uses
  %umax = call i64 @llvm.umax.i64(i64 %6, i64 1)  ; 2 uses
  %min.iters.check123 = icmp ult i32 %i.er, 4
...
vector.body126:                                   ; preds = %vector.body126, %vector.ph124
  ...
  %i.es = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %index127 ; 2 uses
  %i.et = getelementptr inbounds nuw i8, ptr %i.es, i64 16
  %wide.load128 = load <4 x float>, ptr %i.es, align 16, !tbaa !56
  %wide.load129 = load <4 x float>, ptr %i.et, align 16, !tbaa !56
  %i.eu = fadd <4 x float> %wide.load128, splat (float 3.840000e+02)
  %i.ev = fadd <4 x float> %wide.load129, splat (float 3.840000e+02)
  ...
  %i.fe = getelementptr [2 x i8], ptr %invariant.gep.i.us, i64 %index127 ; 2 uses
  ...
  br i1 %i.fg, label %middle.block131, label %vector.body126, !llvm.loop !463

middle.block131:                                  ; preds = %vector.body126
  %cmp.n132 = icmp eq i64 %6, %n.vec125
...
._crit_edge.i.us:                                 ; preds = %.lr.ph80.i.us, %middle.block131, %.preheader71.i.us
  ...
  br i1 %i.fo, label %.preheader71.i.us, label %compute_stereo_samples.exit.loopexit43.us, !llvm.loop !433
...
.preheader71.i.us.1:                              ; preds = %._crit_edge.i.us.1, %.lr.ph.i.us.1
  ...
  %i.fp = add nsw i32 %.05982.i.us.1, %indvars55.1 ; 2 uses
  %i.fq = icmp sgt i32 %i.fp, %spec.select
  %i.fr = sub i32 %spec.select, %indvars55.1
  %spec.select.i.us.1 = select i1 %i.fq, i32 %i.fr, i32 %.05982.i.us.1 ; 2 uses
  %i.fs = shl nuw i32 %spec.select.i.us.1, 1
...
.lr.ph80.preheader.i.us.1:                        ; preds = %.preheader71.i.us.1
  ...
  %i.fw = add i32 %smin.1, %indvars.iv53.1        ; 2 uses
  %7 = zext i32 %i.fw to i64
  %8 = shl nuw nsw i64 %7, 1                      ; 2 uses
  %umax.1 = call i64 @llvm.umax.i64(i64 %8, i64 1) ; 2 uses
  %min.iters.check123.1 = icmp ult i32 %i.fw, 4
...
vector.body126.1:                                 ; preds = %vector.body126.1, %vector.ph124.1
  ...
  %i.fx = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %index127.1 ; 2 uses
  %i.fy = getelementptr inbounds nuw i8, ptr %i.fx, i64 16
  %wide.load128.1 = load <4 x float>, ptr %i.fx, align 16, !tbaa !56
  %wide.load129.1 = load <4 x float>, ptr %i.fy, align 16, !tbaa !56
  %i.fz = fadd <4 x float> %wide.load128.1, splat (float 3.840000e+02)
  %i.ga = fadd <4 x float> %wide.load129.1, splat (float 3.840000e+02)
  ...
  %i.gj = getelementptr [2 x i8], ptr %invariant.gep.i.us.1, i64 %index127.1 ; 2 uses
  ...
  %i.gl = icmp eq i64 %index.next130.1, %n.vec125.1
  br i1 %i.gl, label %middle.block131.1, label %vector.body126.1, !llvm.loop !463

middle.block131.1:                                ; preds = %vector.body126.1
  %cmp.n132.1 = icmp eq i64 %8, %n.vec125.1
...
._crit_edge.i.us.1:                               ; preds = %.lr.ph80.i.us.1, %middle.block131.1, %.preheader71.i.us.1
  ...
  br i1 %i.gt, label %.preheader71.i.us.1, label %compute_stereo_samples.exit.loopexit43.us.1, !llvm.loop !433
...
.preheader45.us.i.preheader:                      ; preds = %.preheader45.us.preheader.i
  ...
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  %lcmp.mod141 = trunc i32 %i.gu to i1
...
.preheader45.us.i.us.preheader:                   ; preds = %.preheader45.us.preheader.i
  ...
  %lcmp.mod146 = trunc i32 %i.gu to i1
...
.preheader45.us.i.us:                             ; preds = %.preheader45.us.i.us.preheader, %..preheader44_crit_edge.us.i.us
  ...
  br i1 %i.hk, label %.epil.preheader142, label %.preheader45.us.i.us.new
...
..preheader44_crit_edge.us.i.us:                  ; preds = %..preheader44_crit_edge.us.i.us.unr-lcssa, %.epil.preheader142
  %.lcssa139 = phi ptr [ %i.ih, %..preheader44_crit_edge.us.i.us.unr-lcssa ], [ %i.is, %.epil.preheader142 ]
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 2 dereferenceable(1) %.lcssa139, i8 0, i64 %i.hc, i1 false), !tbaa !44
