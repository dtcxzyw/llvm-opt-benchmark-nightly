...
scalar.ph161:                                     ; preds = %scalar.ph161.preheader, %scalar.ph161
  ...
  br i1 %6, label %scalar.ph161, label %.loopexit.us, !llvm.loop !428
...
scalar.ph149:                                     ; preds = %scalar.ph149.preheader, %scalar.ph149
  ...
  br i1 %7, label %scalar.ph149, label %.loopexit.us, !llvm.loop !429
...
scalar.ph137:                                     ; preds = %scalar.ph137.preheader, %scalar.ph137
  ...
  br i1 %8, label %scalar.ph137, label %.loopexit.us, !llvm.loop !430
...
.lr.ph80.us.preheader:                            ; preds = %..preheader71_crit_edge.us
  ...
  %min.iters.check126 = icmp ult i32 %spec.select.us, 4
...
.lr.ph78.us.i.us.us:                              ; preds = %._crit_edge.us.i38.us.us, %.lr.ph.i.us.us
  ...
  %smin55 = call i32 @llvm.smin.i32(i32 %i.aa, i32 %spec.select)
  ...
  %n.vec88 = and i64 %4, 4294967294               ; 3 uses
...
middle.block130:                                  ; preds = %vector.body125
  %cmp.n131 = icmp eq i64 %6, %n.vec124
...
vector.ph123.1:                                   ; preds = %.lr.ph80.preheader.i.us.1
  %n.vec124.1 = and i64 %umax.1, 8589934584       ; 3 uses
...
middle.block130.1:                                ; preds = %vector.body125.1
  %cmp.n131.1 = icmp eq i64 %8, %n.vec124.1
