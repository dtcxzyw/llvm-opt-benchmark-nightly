...
.lr.ph:                                           ; preds = %bb.a
  ...
  %8 = load float, ptr %7, align 4, !tbaa !56     ; 2 uses
  %i.g = fneg float %8
  ...
  %11 = insertelement <2 x float> %10, float %i.g, i64 1
  br label %bb.b

bb.b:                                             ; preds = %.lr.ph, %bb.b
  %.075 = phi ptr [ %i.b, %.lr.ph ], [ %i.ad, %bb.b ] ; 13 uses
  %12 = getelementptr inbounds i8, ptr %.075, i64 -4
  %13 = getelementptr inbounds i8, ptr %.075, i64 -36
  %14 = getelementptr inbounds i8, ptr %.075, i64 -8
  %15 = getelementptr inbounds i8, ptr %.075, i64 -40
  %i.h = getelementptr inbounds i8, ptr %.075, i64 -12 ; 2 uses
  %i.i = getelementptr inbounds i8, ptr %.075, i64 -44 ; 2 uses
  %i.j = getelementptr inbounds i8, ptr %.075, i64 -20
  %i.k = getelementptr inbounds i8, ptr %.075, i64 -52
  %i.l = getelementptr inbounds i8, ptr %.075, i64 -24
  %i.m = getelementptr inbounds i8, ptr %.075, i64 -56
  %i.n = getelementptr inbounds i8, ptr %.075, i64 -28 ; 2 uses
  %i.o = getelementptr inbounds i8, ptr %.075, i64 -60 ; 2 uses
  %i.p = load <2 x float>, ptr %12, align 4, !tbaa !56 ; 2 uses
  %i.q = load <2 x float>, ptr %13, align 4, !tbaa !56 ; 2 uses
  %i.r = fsub <2 x float> %i.p, %i.q              ; 2 uses
  %i.s = load <2 x float>, ptr %i.h, align 4, !tbaa !56 ; 2 uses
  %16 = load float, ptr %14, align 4, !tbaa !56
  %i.t = load <2 x float>, ptr %i.i, align 4, !tbaa !56 ; 2 uses
  %17 = load float, ptr %15, align 4, !tbaa !56
  %18 = load <2 x float>, ptr %i.n, align 4, !tbaa !56 ; 2 uses
  %19 = load float, ptr %i.l, align 4, !tbaa !56
  %i.u = load <2 x float>, ptr %i.o, align 4, !tbaa !56 ; 2 uses
  %20 = load float, ptr %i.m, align 4, !tbaa !56
  %21 = shufflevector <2 x float> %i.s, <2 x float> %18, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %22 = shufflevector <2 x float> %i.t, <2 x float> %i.u, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %23 = fsub <4 x float> %21, %22                 ; 4 uses
  %24 = shufflevector <4 x float> %23, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %25 = shufflevector <4 x float> %23, <4 x float> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.v = fadd <2 x float> %24, %25
  %i.w = fsub <2 x float> %24, %25
  %26 = shufflevector <2 x float> %i.v, <2 x float> %i.w, <2 x i32> <i32 0, i32 3>
  %27 = fmul <2 x float> %10, %26                 ; 2 uses
  %28 = load <2 x float>, ptr %i.j, align 4, !tbaa !56 ; 2 uses
  %29 = load <2 x float>, ptr %i.k, align 4, !tbaa !56 ; 2 uses
  %i.x = fsub <2 x float> %28, %29
  %30 = shufflevector <2 x float> %i.x, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %31 = shufflevector <4 x float> %23, <4 x float> poison, <2 x i32> <i32 2, i32 2> ; 2 uses
  %32 = shufflevector <4 x float> %23, <4 x float> poison, <2 x i32> <i32 3, i32 3> ; 2 uses
  %33 = fsub <2 x float> %31, %32
  %i.y = fadd <2 x float> %31, %32
  %34 = shufflevector <2 x float> %33, <2 x float> %i.y, <2 x i32> <i32 0, i32 3>
  %35 = fmul <2 x float> %11, %34                 ; 2 uses
  %i.z = fadd <2 x float> %i.p, %i.q              ; 2 uses
  %36 = shufflevector <2 x float> %i.s, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %37 = insertelement <2 x float> %36, float %16, i64 0
  %38 = shufflevector <2 x float> %i.t, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %39 = insertelement <2 x float> %38, float %17, i64 0
  %40 = fadd <2 x float> %37, %39                 ; 2 uses
  %41 = fadd <2 x float> %28, %29                 ; 2 uses
  %42 = shufflevector <2 x float> %18, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %43 = insertelement <2 x float> %42, float %19, i64 0
  %44 = shufflevector <2 x float> %i.u, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %45 = insertelement <2 x float> %44, float %20, i64 0
  %46 = fadd <2 x float> %43, %45                 ; 2 uses
  %47 = fsub <2 x float> %40, %46
  %48 = shufflevector <2 x float> %47, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1> ; 2 uses
  %49 = fsub <2 x float> %i.z, %41
  %50 = shufflevector <2 x float> %49, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1> ; 2 uses
  %51 = fadd <2 x float> %i.z, %41
  %52 = shufflevector <2 x float> %51, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1> ; 2 uses
  %53 = fadd <2 x float> %40, %46
  %54 = shufflevector <2 x float> %53, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 1, i32 0> ; 2 uses
  %55 = fsub <4 x float> %52, %54
  %56 = fadd <4 x float> %52, %54
  %57 = shufflevector <4 x float> %55, <4 x float> %56, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  store <4 x float> %57, ptr %i.h, align 4, !tbaa !56
  %58 = fadd <4 x float> %50, %48
  %59 = fsub <4 x float> %50, %48
  %60 = shufflevector <4 x float> %58, <4 x float> %59, <4 x i32> <i32 0, i32 5, i32 6, i32 3>
  store <4 x float> %60, ptr %i.n, align 4, !tbaa !56
  %61 = fsub <2 x float> %27, %35
  %62 = shufflevector <2 x float> %61, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1> ; 2 uses
  %63 = fadd <2 x float> %i.r, %30                ; 2 uses
  %64 = fsub <2 x float> %i.r, %30                ; 2 uses
  %65 = shufflevector <2 x float> %63, <2 x float> %64, <4 x i32> <i32 0, i32 3, i32 0, i32 3> ; 2 uses
  %66 = shufflevector <2 x float> %64, <2 x float> %63, <4 x i32> <i32 0, i32 3, i32 0, i32 3> ; 2 uses
  %67 = fadd <2 x float> %27, %35
  %68 = shufflevector <2 x float> %67, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 1, i32 0> ; 2 uses
  %69 = fsub <4 x float> %66, %68
  %70 = fadd <4 x float> %66, %68
  %71 = shufflevector <4 x float> %69, <4 x float> %70, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  store <4 x float> %71, ptr %i.i, align 4, !tbaa !56
  %i.aa = fadd <4 x float> %65, %62
  %i.ab = fsub <4 x float> %65, %62
...
.lr.ph477:                                        ; preds = %.lr.ph477.preheader, %.lr.ph477
  ...
  %.0387472 = phi ptr [ %i.vc, %.lr.ph477 ], [ %i.ty, %.lr.ph477.preheader ] ; 3 uses
  %i.tz = getelementptr inbounds i8, ptr %.pn416474, i64 -8 ; 2 uses
  %i.ua = load <2 x float>, ptr %.0386473, align 4, !tbaa !56 ; 2 uses
  %i.ub = load <2 x float>, ptr %i.tz, align 4, !tbaa !56 ; 2 uses
  ...
  %4 = load <2 x float>, ptr %.0387472, align 4, !tbaa !56 ; 2 uses
  %5 = fneg <2 x float> %i.ue
  %6 = shufflevector <2 x float> %i.ud, <2 x float> %5, <2 x i32> <i32 1, i32 2>
  %i.uf = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ug = fmul <2 x float> %6, %i.uf
  %7 = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.uh = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %7, <2 x float> %i.ue, <2 x float> %i.ug) ; 3 uses
  ...
  store <2 x float> %i.um, ptr %i.tz, align 4, !tbaa !56
  %i.un = getelementptr inbounds nuw i8, ptr %.0386473, i64 8 ; 2 uses
  %i.uo = getelementptr inbounds i8, ptr %.pn416474, i64 -12
  %i.up = getelementptr inbounds nuw i8, ptr %.0387472, i64 8
  %i.uq = load <2 x float>, ptr %i.un, align 4, !tbaa !56 ; 2 uses
  ...
  %8 = load <2 x float>, ptr %i.up, align 4, !tbaa !56 ; 2 uses
  %9 = fneg <2 x float> %i.uu
  %10 = shufflevector <2 x float> %i.ut, <2 x float> %9, <2 x i32> <i32 1, i32 2>
  %i.uv = shufflevector <2 x float> %8, <2 x float> poison, <2 x i32> zeroinitializer
  %i.uw = fmul <2 x float> %10, %i.uv
  %11 = shufflevector <2 x float> %8, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.ux = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %11, <2 x float> %i.uu, <2 x float> %i.uw) ; 3 uses
  %i.uy = shufflevector <2 x float> %i.ut, <2 x float> %i.us, <2 x i32> <i32 0, i32 3> ; 3 uses
  %i.uz = fadd <2 x float> %i.uy, %i.ux
  store <2 x float> %i.uz, ptr %i.un, align 4, !tbaa !56
  ...
  store float %i.vb, ptr %i.uo, align 4, !tbaa !56
