...
bb.b:                                             ; preds = %bb.b, %.lr.ph.i
  ...
  %i.v = sub i64 %.02935.i, %i.s                  ; 2 uses
...
stbi__convert_16_to_8.exit:                       ; preds = %._crit_edge.i, %bb.f, %bb.b
  %.020 = phi ptr [ %i.b, %bb.b ], [ %i.m, %bb.f ], [ %i.m, %._crit_edge.i ] ; 5 uses
...
.lr.ph.i29:                                       ; preds = %._crit_edge.i31, %.lr.ph.preheader.i27
  ...
  %i.az = getelementptr inbounds nuw i8, ptr %.020, i64 %i.ay
  %i.ba = trunc i64 %indvars.iv.i30 to i32
  %i.bb = xor i32 %i.ba, -1
  %i.bc = add i32 %i.as, %i.bb
  %i.bd = sext i32 %i.bc to i64
  %i.be = mul i64 %i.av, %i.bd
  %i.bf = getelementptr inbounds nuw i8, ptr %.020, i64 %i.be
  br label %bb.l
...
bb.l:                                             ; preds = %bb.l, %.lr.ph.i29
  ...
  %i.bj = sub i64 %.02935.i, %i.bg                ; 2 uses
...
bb.m:                                             ; preds = %bb.g, %bb.h, %stbi__vertical_flip.exit, %bb.a
  %.0 = phi ptr [ null, %bb.a ], [ %.020, %stbi__vertical_flip.exit ], [ %.020, %bb.h ], [ %.020, %bb.g ]
...
stbi__convert_8_to_16.exit:                       ; preds = %._crit_edge.i, %bb.f, %bb.b
  %.020 = phi ptr [ %i.b, %bb.b ], [ %i.n, %bb.f ], [ %i.n, %._crit_edge.i ] ; 5 uses
...
.lr.ph.i29:                                       ; preds = %._crit_edge.i31, %.lr.ph.preheader.i27
  ...
  %i.bb = getelementptr inbounds nuw i8, ptr %.020, i64 %i.ba
  %i.bc = trunc i64 %indvars.iv.i30 to i32
  %i.bd = xor i32 %i.bc, -1
  %i.be = add i32 %i.at, %i.bd
  %i.bf = sext i32 %i.be to i64
  %i.bg = mul i64 %i.ax, %i.bf
  %i.bh = getelementptr inbounds nuw i8, ptr %.020, i64 %i.bg
  br label %bb.l
...
bb.l:                                             ; preds = %bb.l, %.lr.ph.i29
  ...
  %i.bl = sub i64 %.02935.i, %i.bi                ; 2 uses
...
bb.g:                                             ; preds = %bb.g, %.lr.ph.i
  ...
  %i.ab = sub i64 %.02935.i, %i.y                 ; 2 uses
...
bb.e:                                             ; preds = %bb.e, %.lr.ph.i.i
  ...
  %i.ao = sub i64 %.02935.i.i, %i.al              ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  br i1 %.not91, label %.thread171, label %bb.g
...
.peel.next:                                       ; preds = %bb.i, %bb.w
  ...
  %.077130 = phi ptr [ %i.ad, %bb.w ], [ %i.n, %bb.i ] ; 2 uses
  ...
  %i.ad = call ptr @realloc(ptr noundef nonnull %.077130, i64 noundef %i.ac) #39 ; 6 uses
...
._crit_edge:                                      ; preds = %bb.i, %._crit_edge.loopexit.loopexit, %bb.d
  %.077.lcssa = phi ptr [ null, %bb.d ], [ %i.n, %bb.i ], [ %i.ad, %._crit_edge.loopexit.loopexit ] ; 2 uses
  %.072.lcssa = phi i32 [ 0, %bb.d ], [ 1, %bb.i ], [ %i.bz, %._crit_edge.loopexit.loopexit ] ; 2 uses
...
bb.x:                                             ; preds = %._crit_edge
  ...
  %i.ci = mul nsw i32 %i.ch, %.072.lcssa
  %i.cj = getelementptr inbounds nuw i8, ptr %7, i64 4
  %i.ck = load i32, ptr %i.cj, align 4, !tbaa !36
  %i.cl = call ptr @stbi__convert_format(ptr noundef %.077.lcssa, i32 noundef 4, i32 noundef %6, i32 noundef %i.ci, i32 noundef %i.ck)
  br label %bb.y

bb.y:                                             ; preds = %bb.x, %._crit_edge
  %.481 = phi ptr [ %i.cl, %bb.x ], [ %.077.lcssa, %._crit_edge ]
  store i32 %.072.lcssa, ptr %4, align 4, !tbaa !27
  br label %.critedge
...
.critedge:                                        ; preds = %.thread, %stbi__load_gif_main_outofmem.exit, %bb.y, %stbi__load_gif_main_outofmem.exit109, %stbi__load_gif_main_outofmem.exit105
  %.6 = phi ptr [ %.481, %bb.y ], [ null, %stbi__load_gif_main_outofmem.exit105 ], [ null, %stbi__load_gif_main_outofmem.exit109 ], [ null, %stbi__load_gif_main_outofmem.exit ], [ null, %.thread ]
...
.preheader49.preheader:                           ; preds = %.preheader49.lr.ph
  ...
  %wide.trip.count = zext nneg i32 %.040 to i64   ; 2 uses
  %xtraiter = and i64 %wide.trip.count, 1
  %i.w = icmp eq i32 %.040, 1
  %unroll_iter = and i64 %wide.trip.count, 2147483646
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  %lcmp.mod73 = trunc i32 %.040 to i1
...
.lr.ph.preheader:                                 ; preds = %._crit_edge52.split
  ...
  %i.bd = sext i32 %.040 to i64                   ; 3 uses
...
.preheader66:                                     ; preds = %bb.a, %._crit_edge
  ...
  %.06073 = phi i32 [ 0, %bb.a ], [ %.161.lcssa, %._crit_edge ] ; 5 uses
...
.lr.ph:                                           ; preds = %.preheader66
  ...
  %i.g = sext i32 %.06073 to i64                  ; 2 uses
  %smax = tail call i32 @llvm.smax.i32(i32 %.06073, i32 256)
  %i.h = sub i32 %smax, %.06073
...
bb.b:                                             ; preds = %.lr.ph117
  ...
  br i1 %exitcond, label %.loopexit65.sink.split, label %.lr.ph117, !llvm.loop !224

.lr.ph117:                                        ; preds = %.lr.ph, %bb.b
  %.05572116 = phi i32 [ %i.k, %bb.b ], [ 0, %.lr.ph ]
  %indvars.iv115 = phi i64 [ %indvars.iv.next, %bb.b ], [ %i.g, %.lr.ph ]
  %indvars.iv.next = add nsw i64 %indvars.iv115, 1 ; 3 uses
  %i.k = add nuw nsw i32 %.05572116, 1            ; 3 uses
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader66
  %.161.lcssa = phi i32 [ %.06073, %.preheader66 ], [ %i.n, %._crit_edge.loopexit ] ; 2 uses
...
bb.d:                                             ; preds = %bb.c, %bb.e
  ...
  %.05782 = phi i32 [ 0, %bb.c ], [ %i.an, %bb.e ] ; 3 uses
  %.26281 = phi i32 [ 0, %bb.c ], [ %.4, %bb.e ]  ; 3 uses
  %i.t = sub i32 %.26281, %.05782
  %i.u = getelementptr inbounds nuw [4 x i8], ptr %i.q, i64 %indvars.iv99
  store i32 %i.t, ptr %i.u, align 4, !tbaa !27
  %i.v = sext i32 %.26281 to i64                  ; 2 uses
...
.lr.ph77:                                         ; preds = %bb.d, %.lr.ph77
  ...
  %.15876 = phi i32 [ %i.aa, %.lr.ph77 ], [ %.05782, %bb.d ] ; 3 uses
  %i.aa = add i32 %.15876, 1                      ; 2 uses
  %i.ab = trunc i32 %.15876 to i16
...
bb.i:                                             ; preds = %bb.h, %bb.i
  ...
  %.2.highbits = lshr i32 %i.ba, %i.aw
  %i.bb = icmp eq i32 %.2.highbits, 0
...
.loopexit65:                                      ; preds = %.loopexit, %.loopexit65.sink.split, %bb.f
  %.0 = phi i32 [ 1, %bb.f ], [ 0, %.loopexit65.sink.split ], [ 1, %.loopexit ]
  ret i32 %.0
}
...
bb.e:                                             ; preds = %bb.d
  ...
  %.032 = add nsw i32 %i.y, %i.u                  ; 2 uses
  %i.z = add nsw i32 %.032, 128
  %or.cond = icmp ult i32 %i.z, 256
  br i1 %or.cond, label %bb.f, label %bb.g

bb.f:                                             ; preds = %bb.e
  %i.aa = shl nsw i32 %.032, 8
...
bb.r:                                             ; preds = %bb.an, %stbi__mul2shorts_valid.exit.thread
  ...
  %.066 = phi i32 [ 1, %stbi__mul2shorts_valid.exit.thread ], [ %.470.ph, %bb.an ] ; 3 uses
...
bb.v:                                             ; preds = %bb.u
  ...
  %i.cv = sub nsw i32 %i.cp, %i.co                ; 2 uses
...
bb.aa:                                            ; preds = %bb.z
  ...
  %i.ds = sub nsw i32 %i.dp, %i.do                ; 2 uses
...
bb.ag:                                            ; preds = %bb.af
  %i.ej = sub nsw i32 %i.dz, %i.dx                ; 2 uses
...
bb.am:                                            ; preds = %bb.al
  ...
  %i.fh = sub nsw i32 %i.ex, %i.en                ; 2 uses
...
bb.an:                                            ; preds = %bb.v, %stbi__extend_receive.exit95, %bb.ai
  ...
  %.470.ph = phi i32 [ %i.ep, %bb.ai ], [ %i.es, %stbi__extend_receive.exit95 ], [ %i.cw, %bb.v ] ; 2 uses
  %i.fu = icmp slt i32 %.470.ph, 64
...
.thread118:                                       ; preds = %bb.an, %bb.ah, %.thread118.sink.split
  %.4 = phi i32 [ 0, %.thread118.sink.split ], [ 1, %bb.ah ], [ 1, %bb.an ]
  ret i32 %.4
}
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.z = sub nsw i32 %i.w, %i.v                   ; 2 uses
...
bb.q:                                             ; preds = %bb.p
  %i.av = sub nsw i32 %i.aj, %i.ah                ; 2 uses
...
bb.f:                                             ; preds = %.preheader, %bb.aj
  ...
  %.0115 = phi i32 [ %.4119.ph, %bb.aj ], [ %i.b, %.preheader ] ; 3 uses
...
bb.k:                                             ; preds = %bb.i
  ...
  %i.ah = add nsw i32 %i.ag, %.0115               ; 2 uses
  %i.ai = shl i32 %i.v, %i.ab
  store i32 %i.ai, ptr %i.m, align 8, !tbaa !234
  %i.aj = sub nsw i32 %i.ac, %i.ab                ; 2 uses
...
bb.w:                                             ; preds = %bb.v
  %i.bx = sub nsw i32 %i.bm, %i.bk                ; 2 uses
...
stbi__jpeg_huff_decode.exit:                      ; preds = %bb.w, %bb.p
  ...
  %.pn307 = phi i64 [ %i.bz, %bb.w ], [ %i.ay, %bb.p ]
  %.1.i.in.in = getelementptr inbounds nuw i8, ptr %i.o, i64 %.pn307
...
bb.ad:                                            ; preds = %bb.x
  %i.cw = add nsw i32 %.0115, 16
  br label %bb.aj

bb.ae:                                            ; preds = %stbi__jpeg_huff_decode.exit
  %i.cx = add nsw i32 %i.cd, %.0115               ; 2 uses
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.dn = sub nsw i32 %i.dd, %i.cc                ; 2 uses
...
bb.aj:                                            ; preds = %bb.k, %stbi__extend_receive.exit, %bb.ad
  ...
  %.4119.ph = phi i32 [ %i.cw, %bb.ad ], [ %i.cy, %stbi__extend_receive.exit ], [ %i.ak, %bb.k ] ; 2 uses
  %i.dz = load i32, ptr %i.r, align 8, !tbaa !240
  %.not169 = icmp sgt i32 %.4119.ph, %i.dz
...
bb.aq:                                            ; preds = %.preheader223, %.loopexit222
  ...
  %.6121 = phi i32 [ %.9124, %.loopexit222 ], [ %i.b, %.preheader223 ] ; 3 uses
...
bb.au:                                            ; preds = %bb.at
  ...
  %i.ga = sub nsw i32 %i.fx, %i.fw                ; 2 uses
...
bb.bb:                                            ; preds = %bb.ba
  %i.gs = sub nsw i32 %i.gh, %i.gf                ; 2 uses
...
bb.bh:                                            ; preds = %bb.bg
  ...
  %i.hn = sub nsw i32 %i.hd, %i.gz                ; 2 uses
...
stbi__jpeg_get_bit.exit186:                       ; preds = %.stbi__jpeg_get_bit.exit186_crit_edge, %bb.bj
  ...
  %.not154322 = icmp slt i32 %i.hu, 0
  %spec.select = select i1 %.not154322, i32 %i.eg, i32 %i.eh
  br label %stbi__jpeg_get_bit.exit186.thread
...
stbi__jpeg_get_bit.exit186.thread:                ; preds = %stbi__jpeg_get_bit.exit186, %bb.bk, %bb.bd, %stbi__jpeg_get_bits.exit182, %bb.bc
  ...
  %.0126 = phi i32 [ %i.gz, %stbi__jpeg_get_bit.exit186 ], [ %i.gz, %bb.bc ], [ 64, %bb.bd ], [ 64, %stbi__jpeg_get_bits.exit182 ], [ %i.gz, %bb.bk ]
  %.0125 = phi i32 [ %spec.select, %stbi__jpeg_get_bit.exit186 ], [ 0, %bb.bc ], [ 0, %bb.bd ], [ 0, %stbi__jpeg_get_bits.exit182 ], [ %i.eh, %bb.bk ]
  %i.hz = load i32, ptr %i.ei, align 8, !tbaa !240 ; 3 uses
  %.not157250 = icmp sgt i32 %.6121, %i.hz
  br i1 %.not157250, label %.loopexit222, label %.lr.ph253.preheader

.lr.ph253.preheader:                              ; preds = %stbi__jpeg_get_bit.exit186.thread
  %i.ia = sext i32 %.6121 to i64
  br label %.lr.ph253
...
.lr.ph253:                                        ; preds = %.lr.ph253.preheader, %stbi__jpeg_get_bit.exit190.thread
  ...
  %.1127251 = phi i32 [ %.0126, %.lr.ph253.preheader ], [ %.3129, %stbi__jpeg_get_bit.exit190.thread ] ; 7 uses
...
stbi__jpeg_get_bit.exit190.thread:                ; preds = %bb.bm, %bb.bs, %bb.bn, %bb.bq, %bb.bp, %stbi__jpeg_get_bit.exit190
  ...
  %.3129 = phi i32 [ %i.iy, %bb.bs ], [ %.1127251, %bb.bp ], [ %.1127251, %bb.bq ], [ %.1127251, %bb.bn ], [ %.1127251, %stbi__jpeg_get_bit.exit190 ], [ %.1127251, %bb.bm ]
...
.loopexit222:                                     ; preds = %.loopexit222.loopexit, %stbi__jpeg_get_bit.exit186.thread, %.thread219
  ...
  %.9124 = phi i32 [ %i.iw, %.thread219 ], [ %.6121, %stbi__jpeg_get_bit.exit186.thread ], [ %i.jc, %.loopexit222.loopexit ] ; 2 uses
  %.not161 = icmp sgt i32 %.9124, %i.jd
...
.critedge:                                        ; preds = %stbi__jpeg_get_bit.exit.thread, %.loopexit222, %bb.aj, %bb.al, %bb.ai, %.loopexit, %bb.j, %bb.e, %bb.bi, %.loopexit224, %bb.b
  %.9 = phi i32 [ 0, %bb.b ], [ 1, %.loopexit222 ], [ 0, %bb.bi ], [ 0, %.loopexit224 ], [ 1, %bb.e ], [ 0, %.loopexit ], [ 1, %bb.al ], [ 0, %bb.j ], [ 1, %bb.ai ], [ 1, %bb.aj ], [ 1, %stbi__jpeg_get_bit.exit.thread ]
  ret i32 %.9
}
...
stbi__get8.exit160:                               ; preds = %bb.aa, %bb.ab, %stbi__refill_buffer.exit.i157
  ...
  %i.gb = add nuw nsw i32 %.0121195, %i.fz        ; 5 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, 16
  br i1 %exitcond.not, label %bb.af, label %.preheader188, !llvm.loop !299
...
bb.aj:                                            ; preds = %bb.ai, %bb.ah
  ...
  %.0124 = getelementptr inbounds nuw i8, ptr %i.gm, i64 1024
  %.not211 = icmp eq i32 %i.gb, 0
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %stbi__get8.exit166
  %indvars.iv216 = phi i64 [ 0, %.lr.ph.preheader ], [ %indvars.iv.next217, %stbi__get8.exit166 ] ; 2 uses
...
stbi__get8.exit166:                               ; preds = %bb.ak, %bb.al, %stbi__refill_buffer.exit.i163
  ...
  %i.hv = getelementptr inbounds nuw i8, ptr %.0124, i64 %indvars.iv216
  ...
  br i1 %exitcond219.not, label %._crit_edge, label %.lr.ph, !llvm.loop !300
...
bb.at:                                            ; preds = %bb.as
  ...
  %.032.i = add nsw i32 %i.ix, %i.it              ; 2 uses
  %i.iy = add nsw i32 %.032.i, 128
  %or.cond.i = icmp ult i32 %i.iy, 256
  br i1 %or.cond.i, label %bb.au, label %bb.av

bb.au:                                            ; preds = %bb.at
  %i.iz = shl nsw i32 %.032.i, 8
...
stbi__build_fast_ac.exit:                         ; preds = %bb.av, %._crit_edge
  ...
  br i1 %i.je, label %bb.u, label %._crit_edge200, !llvm.loop !301

._crit_edge200:                                   ; preds = %stbi__build_fast_ac.exit, %bb.t
  %.2116.lcssa = phi i32 [ %i.db, %bb.t ], [ %i.jd, %stbi__build_fast_ac.exit ]
  %i.jf = icmp eq i32 %.2116.lcssa, 0
  br label %.critedge
...
bb.bd:                                            ; preds = %.preheader.preheader
  ...
  %.not.i168 = icmp eq i32 %i.jx, 0
  br i1 %.not.i168, label %stbi__get8.exit173, label %bb.be
...
bb.bg:                                            ; preds = %bb.be
  ...
  %.pre.i169 = load i8, ptr %i.kc, align 8, !tbaa !24
  br label %stbi__refill_buffer.exit.i170

stbi__refill_buffer.exit.i170:                    ; preds = %bb.bg, %bb.bf
  %i.ku = phi i8 [ 0, %bb.bf ], [ %.pre.i169, %bb.bg ]
  %.sink.i.i171 = phi ptr [ %i.kr, %bb.bf ], [ %i.kt, %bb.bg ]
  store ptr %.sink.i.i171, ptr %i.jr, align 8, !tbaa !18
  %i.kv = getelementptr inbounds nuw i8, ptr %i.jo, i64 57
  store ptr %i.kv, ptr %i.jp, align 8, !tbaa !16
  %.pre259 = load ptr, ptr %0, align 8, !tbaa !103 ; 3 uses
  %.phi.trans.insert260 = getelementptr inbounds nuw i8, ptr %.pre259, i64 192
  %.pre261 = load ptr, ptr %.phi.trans.insert260, align 8, !tbaa !16
  %.phi.trans.insert262 = getelementptr inbounds nuw i8, ptr %.pre259, i64 200
  %.pre263 = load ptr, ptr %.phi.trans.insert262, align 8, !tbaa !18
  br label %stbi__get8.exit173

stbi__get8.exit173:                               ; preds = %bb.bc, %bb.bd, %stbi__refill_buffer.exit.i170
  %i.kw = phi ptr [ %i.js, %bb.bc ], [ %.pre263, %stbi__refill_buffer.exit.i170 ], [ %i.js, %bb.bd ] ; 3 uses
  %i.kx = phi ptr [ %i.ju, %bb.bc ], [ %.pre261, %stbi__refill_buffer.exit.i170 ], [ %i.jq, %bb.bd ] ; 4 uses
  %i.ky = phi ptr [ %i.jo, %bb.bc ], [ %.pre259, %stbi__refill_buffer.exit.i170 ], [ %i.jo, %bb.bd ] ; 13 uses
  %.0.i172 = phi i8 [ %i.jv, %bb.bc ], [ %i.ku, %stbi__refill_buffer.exit.i170 ], [ 0, %bb.bd ]
  %.not139 = icmp ne i8 %.0.i172, 74
...
bb.bh:                                            ; preds = %stbi__get8.exit173
  %i.lc = getelementptr inbounds nuw i8, ptr %i.ky, i64 48 ; 2 uses
  %i.ld = load i32, ptr %i.lc, align 8, !tbaa !13
  %.not.i168.1 = icmp eq i32 %i.ld, 0
  br i1 %.not.i168.1, label %stbi__get8.exit173.1, label %bb.bi
...
bb.bj:                                            ; preds = %bb.bi
  ...
  %.pre.i169.1 = load i8, ptr %i.li, align 8, !tbaa !24
  br label %stbi__refill_buffer.exit.i170.1
...
stbi__refill_buffer.exit.i170.1:                  ; preds = %bb.bk, %bb.bj
  %i.ma = phi i8 [ 0, %bb.bk ], [ %.pre.i169.1, %bb.bj ]
  %.sink.i.i171.1 = phi ptr [ %i.lz, %bb.bk ], [ %i.ly, %bb.bj ]
  store ptr %.sink.i.i171.1, ptr %i.la, align 8, !tbaa !18
  %i.mb = getelementptr inbounds nuw i8, ptr %i.ky, i64 57
  store ptr %i.mb, ptr %i.kz, align 8, !tbaa !16
  %.pre264 = load ptr, ptr %0, align 8, !tbaa !103 ; 3 uses
  %.phi.trans.insert265 = getelementptr inbounds nuw i8, ptr %.pre264, i64 192
  %.pre266 = load ptr, ptr %.phi.trans.insert265, align 8, !tbaa !16
  %.phi.trans.insert267 = getelementptr inbounds nuw i8, ptr %.pre264, i64 200
  %.pre268 = load ptr, ptr %.phi.trans.insert267, align 8, !tbaa !18
  br label %stbi__get8.exit173.1
...
.lr.ph400:                                        ; preds = %bb.l
  ...
  %min.iters.check700 = icmp ult i64 %i.bk, 8
  %i.bn = add nsw i64 %i.ax, -1
  %diff.check698 = icmp ult i64 %i.bn, 31
  %or.cond737 = select i1 %min.iters.check700, i1 true, i1 %diff.check698
  %min.iters.check702 = icmp ult i64 %i.bk, 32
  %i.bo = and i64 %i.bk, 24
  %n.vec704 = and i64 %i.bk, -32                  ; 4 uses
  %i.bp = add nsw i64 %n.vec704, %i.ax
  %cmp.n713 = icmp eq i64 %i.bk, %n.vec704
  %min.epilog.iters.check719 = icmp eq i64 %i.bo, 0
  %n.vec721 = and i64 %i.bk, -8                   ; 3 uses
  %i.bq = add nsw i64 %n.vec721, %i.ax
  %cmp.n728 = icmp eq i64 %i.bk, %n.vec721
  %i.br = add nsw i64 %i.bb, -1
  %min.iters.check668 = icmp ult i32 %spec.select, 4
  %min.iters.check670 = icmp ult i32 %spec.select, 32
  %i.bs = and i64 %wide.trip.count424, 28
  %n.vec672 = and i64 %wide.trip.count424, 2147483616 ; 4 uses
  %cmp.n681 = icmp eq i64 %n.vec672, %wide.trip.count424
  %min.epilog.iters.check686 = icmp eq i64 %i.bs, 0
  %n.vec688 = and i64 %wide.trip.count424, 2147483644 ; 3 uses
  %cmp.n695 = icmp eq i64 %n.vec688, %wide.trip.count424
  %xtraiter751 = and i64 %wide.trip.count424, 3   ; 2 uses
  %lcmp.mod752.not = icmp eq i64 %xtraiter751, 0
  %min.iters.check633 = icmp ult i64 %i.bk, 4
  %i.bt = add nsw i64 %i.ax, -1
  %diff.check627 = icmp ult i64 %i.bt, 15
  %min.iters.check635 = icmp ult i64 %i.bk, 16
  %i.bu = and i64 %i.bk, 12
  %n.vec637 = and i64 %i.bk, -16                  ; 4 uses
  %i.bv = add nsw i64 %n.vec637, %i.ax
  %cmp.n646 = icmp eq i64 %i.bk, %n.vec637
  %min.epilog.iters.check652 = icmp eq i64 %i.bu, 0
  %n.vec654 = and i64 %i.bk, -4                   ; 3 uses
  %i.bw = add nsw i64 %n.vec654, %i.ax
  %cmp.n663 = icmp eq i64 %i.bk, %n.vec654
  %min.iters.check597 = icmp ult i32 %spec.select, 4
  %min.iters.check599 = icmp ult i32 %spec.select, 32
  %i.bx = and i64 %wide.trip.count424, 28
  %n.vec601 = and i64 %wide.trip.count424, 2147483616 ; 4 uses
  %cmp.n610 = icmp eq i64 %n.vec601, %wide.trip.count424
  %min.epilog.iters.check615 = icmp eq i64 %i.bx, 0
  %n.vec617 = and i64 %wide.trip.count424, 2147483644 ; 3 uses
  %cmp.n624 = icmp eq i64 %n.vec617, %wide.trip.count424
  %xtraiter753 = and i64 %wide.trip.count424, 1
  %lcmp.mod754.not = icmp eq i64 %xtraiter753, 0
  %i.by = add nsw i64 %wide.trip.count424, -1
  %min.iters.check564 = icmp ult i64 %i.bk, 4
  %i.bz = add nsw i64 %i.ax, -1
  %diff.check562 = icmp ult i64 %i.bz, 15
  %min.iters.check566 = icmp ult i64 %i.bk, 16
  %i.ca = and i64 %i.bk, 12
  %n.vec568 = and i64 %i.bk, -16                  ; 4 uses
  %i.cb = add nsw i64 %n.vec568, %i.ax
  %cmp.n576 = icmp eq i64 %i.bk, %n.vec568
  %min.epilog.iters.check582 = icmp eq i64 %i.ca, 0
  %n.vec584 = and i64 %i.bk, -4                   ; 3 uses
  %i.cc = add nsw i64 %n.vec584, %i.ax
  %cmp.n592 = icmp eq i64 %i.bk, %n.vec584
  %i.cd = add nsw i64 %i.bb, -1
  %min.iters.check531 = icmp ult i32 %i.aw, 4
  %min.iters.check533 = icmp ult i32 %i.aw, 32
  %i.ce = and i64 %wide.trip.count444, 28
  %n.vec535 = and i64 %wide.trip.count444, 2147483616 ; 4 uses
  %cmp.n544 = icmp eq i64 %n.vec535, %wide.trip.count444
  %min.epilog.iters.check549 = icmp eq i64 %i.ce, 0
  %n.vec551 = and i64 %wide.trip.count444, 2147483644 ; 3 uses
  %cmp.n558 = icmp eq i64 %n.vec551, %wide.trip.count444
  %xtraiter759 = and i64 %wide.trip.count444, 3   ; 2 uses
  %lcmp.mod760.not = icmp eq i64 %xtraiter759, 0
  %min.iters.check507 = icmp ult i64 %i.bk, 8
  %i.cf = add nsw i64 %i.ax, -1
  %diff.check = icmp ult i64 %i.cf, 31
  %or.cond736 = select i1 %min.iters.check507, i1 true, i1 %diff.check
  %min.iters.check508 = icmp ult i64 %i.bk, 32
  %i.cg = and i64 %i.bk, 24
  %n.vec510 = and i64 %i.bk, -32                  ; 4 uses
  %i.ch = add nsw i64 %n.vec510, %i.ax
  %cmp.n519 = icmp eq i64 %i.bk, %n.vec510
  %min.epilog.iters.check = icmp eq i64 %i.cg, 0
  %n.vec521 = and i64 %i.bk, -8                   ; 3 uses
  %i.ci = add nsw i64 %n.vec521, %i.ax
  %cmp.n526 = icmp eq i64 %i.bk, %n.vec521
  ...
  %i.cm = and i64 %i.bg, 1
  %lcmp.mod774.not.not = icmp eq i64 %i.cm, 0
  ...
  %xtraiter776 = and i32 %i.z, 1
  %i.cs = icmp eq i32 %i.bl, 0
  %unroll_iter780 = and i32 %i.z, -2
  %lcmp.mod778.not = icmp eq i32 %xtraiter776, 0
  %lcmp.mod779 = trunc i32 %i.z to i1
  ...
  %i.cv = and i64 %i.bg, 1
  %lcmp.mod795.not.not = icmp eq i64 %i.cv, 0
  ...
  %xtraiter797 = and i64 %i.bm, 3                 ; 2 uses
...
bb.m:                                             ; preds = %.lr.ph400, %.loopexit
  ...
  %.0237399 = phi ptr [ %1, %.lr.ph400 ], [ %i.ri, %.loopexit ] ; 2 uses
  ...
  %i.ei = getelementptr inbounds nuw i8, ptr %.0237399, i64 1 ; 41 uses
  %i.ej = load i8, ptr %.0237399, align 1, !tbaa !24 ; 3 uses
...
bb.p:                                             ; preds = %bb.o, %bb.n
  %.0257.in = phi i8 [ %i.eo, %bb.o ], [ %i.ej, %bb.n ]
...
begin_hunk_5_@stbi__create_png_image_raw:bb.a
  ...
  %i.xg = load i8, ptr %.0268379, align 1, !tbaa !24
  %i.xh = zext i8 %i.xg to i16
  %i.xi = shl nuw i16 %i.xh, 8
  %i.xj = getelementptr inbounds nuw i8, ptr %.0268379, i64 1
  %i.xk = load i8, ptr %i.xj, align 1, !tbaa !24
  %i.xl = zext i8 %i.xk to i16
  %i.xm = or disjoint i16 %i.xi, %i.xl
  store i16 %i.xm, ptr %.0236381, align 2, !tbaa !85
  %i.xn = getelementptr inbounds nuw i8, ptr %.0236381, i64 2
  %i.xo = getelementptr inbounds nuw i8, ptr %.0268379, i64 2
  %i.xp = load i8, ptr %i.xo, align 1, !tbaa !24
  %i.xq = zext i8 %i.xp to i16
  %i.xr = shl nuw i16 %i.xq, 8
  %i.xs = getelementptr inbounds nuw i8, ptr %.0268379, i64 3
  ...
  %i.xw = getelementptr inbounds nuw i8, ptr %.0236381, i64 4
  %i.xx = getelementptr inbounds nuw i8, ptr %.0268379, i64 4
  %i.xy = load i8, ptr %i.xx, align 1, !tbaa !24
  %i.xz = zext i8 %i.xy to i16
  %i.ya = shl nuw i16 %i.xz, 8
  %i.yb = getelementptr inbounds nuw i8, ptr %.0268379, i64 5
  ...
  %i.yf = getelementptr inbounds nuw i8, ptr %.0236381, i64 6
  %i.yg = getelementptr inbounds nuw i8, ptr %.0268379, i64 6
  %i.yh = load i8, ptr %i.yg, align 1, !tbaa !24
  %i.yi = zext i8 %i.yh to i16
  %i.yj = shl nuw i16 %i.yi, 8
  %i.yk = getelementptr inbounds nuw i8, ptr %.0268379, i64 7
  ...
  %i.yo = getelementptr inbounds nuw i8, ptr %.0236381, i64 8 ; 2 uses
  %i.yp = getelementptr inbounds nuw i8, ptr %.0268379, i64 8 ; 2 uses
  %niter772.next.3 = add i32 %niter772, 4         ; 2 uses
  %niter772.ncmp.3 = icmp eq i32 %niter772.next.3, %unroll_iter771
  br i1 %niter772.ncmp.3, label %.loopexit.loopexit744.unr-lcssa, label %.lr.ph382, !llvm.loop !462
...
.lr.ph378:                                        ; preds = %.lr.ph378.preheader, %.lr.ph378
  ...
  %.1269375 = phi ptr [ %i.zj, %.lr.ph378 ], [ %i.dy, %.lr.ph378.preheader ] ; 5 uses
  %niter = phi i32 [ %niter.next.1, %.lr.ph378 ], [ 0, %.lr.ph378.preheader ]
  %i.yq = load i8, ptr %.1269375, align 1, !tbaa !24
  %i.yr = zext i8 %i.yq to i16
  %i.ys = shl nuw i16 %i.yr, 8
  %i.yt = getelementptr inbounds nuw i8, ptr %.1269375, i64 1
  ...
  %i.yz = getelementptr inbounds nuw i8, ptr %.1269375, i64 2
  %i.za = load i8, ptr %i.yz, align 1, !tbaa !24
  %i.zb = zext i8 %i.za to i16
  %i.zc = shl nuw i16 %i.zb, 8
  %i.zd = getelementptr inbounds nuw i8, ptr %.1269375, i64 3
  ...
  %i.zj = getelementptr inbounds nuw i8, ptr %.1269375, i64 4 ; 2 uses
  %niter.next.1 = add nuw i32 %niter, 2           ; 2 uses
  %niter.ncmp.1 = icmp eq i32 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.loopexit.loopexit745.unr-lcssa, label %.lr.ph378, !llvm.loop !463

.lr.ph374:                                        ; preds = %.preheader346, %.lr.ph374
  %.2373 = phi ptr [ %i.aal, %.lr.ph374 ], [ %i.eh, %.preheader346 ] ; 5 uses
  %.5256372 = phi i32 [ %i.aak, %.lr.ph374 ], [ 0, %.preheader346 ]
  %.2270371 = phi ptr [ %i.aam, %.lr.ph374 ], [ %i.dy, %.preheader346 ] ; 7 uses
  %i.zk = load i8, ptr %.2270371, align 1, !tbaa !24
  %i.zl = zext i8 %i.zk to i16
  %i.zm = shl nuw i16 %i.zl, 8
  %i.zn = getelementptr inbounds nuw i8, ptr %.2270371, i64 1
  ...
  %i.zr = getelementptr inbounds nuw i8, ptr %.2270371, i64 2
  %i.zs = load i8, ptr %i.zr, align 1, !tbaa !24
  %i.zt = zext i8 %i.zs to i16
  %i.zu = shl nuw i16 %i.zt, 8
  %i.zv = getelementptr inbounds nuw i8, ptr %.2270371, i64 3
  ...
  %i.aaa = getelementptr inbounds nuw i8, ptr %.2270371, i64 4
  %i.aab = load i8, ptr %i.aaa, align 1, !tbaa !24
  %i.aac = zext i8 %i.aab to i16
  %i.aad = shl nuw i16 %i.aac, 8
  %i.aae = getelementptr inbounds nuw i8, ptr %.2270371, i64 5
  ...
  %i.aak = add nuw i32 %.5256372, 1               ; 2 uses
  %i.aal = getelementptr inbounds nuw i8, ptr %.2373, i64 8
  %i.aam = getelementptr inbounds nuw i8, ptr %.2270371, i64 6
...
.lr.ph382.epil.preheader:                         ; preds = %.loopexit.loopexit744.unr-lcssa, %.lr.ph382.preheader
  %.0236381.epil.init = phi ptr [ %i.eh, %.lr.ph382.preheader ], [ %i.yo, %.loopexit.loopexit744.unr-lcssa ]
  %.0268379.epil.init = phi ptr [ %i.dy, %.lr.ph382.preheader ], [ %i.yp, %.loopexit.loopexit744.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod770)
  br label %.lr.ph382.epil

.lr.ph382.epil:                                   ; preds = %.lr.ph382.epil, %.lr.ph382.epil.preheader
  %.0236381.epil = phi ptr [ %i.aau, %.lr.ph382.epil ], [ %.0236381.epil.init, %.lr.ph382.epil.preheader ] ; 2 uses
  %.0268379.epil = phi ptr [ %i.aav, %.lr.ph382.epil ], [ %.0268379.epil.init, %.lr.ph382.epil.preheader ] ; 3 uses
  %epil.iter = phi i32 [ %epil.iter.next, %.lr.ph382.epil ], [ 0, %.lr.ph382.epil.preheader ]
  %i.aan = load i8, ptr %.0268379.epil, align 1, !tbaa !24
  %i.aao = zext i8 %i.aan to i16
  %i.aap = shl nuw i16 %i.aao, 8
  %i.aaq = getelementptr inbounds nuw i8, ptr %.0268379.epil, i64 1
  %i.aar = load i8, ptr %i.aaq, align 1, !tbaa !24
  %i.aas = zext i8 %i.aar to i16
  %i.aat = or disjoint i16 %i.aap, %i.aas
  store i16 %i.aat, ptr %.0236381.epil, align 2, !tbaa !85
  %i.aau = getelementptr inbounds nuw i8, ptr %.0236381.epil, i64 2
  %i.aav = getelementptr inbounds nuw i8, ptr %.0268379.epil, i64 2
...
.lr.ph378.epil.preheader:                         ; preds = %.loopexit.loopexit745.unr-lcssa, %.lr.ph378.preheader
  %.1377.epil.init = phi ptr [ %i.eh, %.lr.ph378.preheader ], [ %i.zi, %.loopexit.loopexit745.unr-lcssa ] ; 2 uses
  %.1269375.epil.init = phi ptr [ %i.dy, %.lr.ph378.preheader ], [ %i.zj, %.loopexit.loopexit745.unr-lcssa ] ; 2 uses
  tail call void @llvm.assume(i1 %lcmp.mod767)
  %i.aaw = load i8, ptr %.1269375.epil.init, align 1, !tbaa !24
  %i.aax = zext i8 %i.aaw to i16
  %i.aay = shl nuw i16 %i.aax, 8
  %i.aaz = getelementptr inbounds nuw i8, ptr %.1269375.epil.init, i64 1
...
bb.ak:                                            ; preds = %bb.aj, %._crit_edge, %bb.k, %bb.i, %stbi__mad2sizes_valid.exit.thread, %stbi__mad3sizes_valid.exit.thread, %bb.d
  %.0 = phi i32 [ 0, %bb.i ], [ 0, %bb.d ], [ 0, %stbi__mad3sizes_valid.exit.thread ], [ 0, %bb.k ], [ 0, %stbi__mad2sizes_valid.exit.thread ], [ 0, %bb.aj ], [ 1, %._crit_edge ]
  ret i32 %.0
}
...
bb.f:                                             ; preds = %.preheader100, %bb.h
  ...
  %.080105 = phi i32 [ %2, %.preheader100 ], [ %.383, %bb.h ] ; 3 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.az = tail call i32 @stbi__create_png_image_raw(ptr noundef nonnull %0, ptr noundef %.076106, i32 noundef %.080105, i32 noundef %3, i32 noundef %i.ae, i32 noundef %i.ao, i32 noundef %4, i32 noundef %5)
...
._crit_edge103.split:                             ; preds = %._crit_edge, %.preheader99
  ...
  %i.cm = sub i32 %.080105, %i.ay
  br label %bb.h

bb.h:                                             ; preds = %._crit_edge103.split, %bb.f
  %.383 = phi i32 [ %.080105, %bb.f ], [ %i.cm, %._crit_edge103.split ]
