...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %bb.h
  ...
  %i.v = mul nuw nsw i64 %indvars.iv65, %i.s      ; 2 uses
  br label %bb.f
...
bb.x:                                             ; preds = %.lr.ph397
  ...
  %i.rm = load i8, ptr %.4246394, align 1, !tbaa !24
  br label %.lr.ph397.1
...
.lr.ph397.1:                                      ; preds = %bb.x, %.lr.ph397
  ...
  store i8 %i.rn, ptr %.2241395, align 1, !tbaa !24
  %.mask = and i8 %.5, 64
...
bb.y:                                             ; preds = %.lr.ph397.epil.preheader
  %i.rv = load i8, ptr %.4246394.epil.init, align 1, !tbaa !24
...
.loopexit335.loopexit.epilog-lcssa:               ; preds = %bb.y, %.lr.ph397.epil.preheader
  ...
  store i8 %i.rw, ptr %.2241395.epil.init, align 1, !tbaa !24
...
bb.z:                                             ; preds = %.lr.ph392.epil.preheader
  %i.rz = load i8, ptr %.0242389.epil.init, align 1, !tbaa !24
  %i.sa = lshr i8 %i.rz, 4
...
bb.aa:                                            ; preds = %.lr.ph387.epil.preheader
  %i.se = load i8, ptr %.2244384.epil.init, align 1, !tbaa !24
...
.loopexit335.loopexit736.epilog-lcssa:            ; preds = %bb.aa, %.lr.ph387.epil.preheader
  ...
  store i8 %i.sg, ptr %.1240385.epil.init, align 1, !tbaa !24
  br label %.loopexit335
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader
  ...
  store i8 %i.so, ptr %i.sp, align 1, !tbaa !24
  %i.sq = load i8, ptr %i.sj, align 1, !tbaa !24
  store i8 %i.sq, ptr %i.sh, align 1, !tbaa !24
...
.lr.ph32.i.prol:                                  ; preds = %.lr.ph32.i.preheader, %.lr.ph32.i.prol
  ...
  store i8 -1, ptr %i.st, align 1, !tbaa !24
  %i.su = getelementptr inbounds nuw i8, ptr %i.dn, i64 %indvars.iv35.i.prol
  %i.sv = load i8, ptr %i.su, align 1, !tbaa !24
  store i8 %i.sv, ptr %i.ss, align 1, !tbaa !24
...
.lr.ph32.i:                                       ; preds = %.lr.ph32.i.prol.loopexit, %.lr.ph32.i
  ...
  store i8 -1, ptr %i.sy, align 1, !tbaa !24
  ...
  store i8 -1, ptr %i.td, align 1, !tbaa !24
  %i.te = getelementptr inbounds nuw i8, ptr %i.dn, i64 %indvars.iv.next36.i
  %i.tf = load i8, ptr %i.te, align 1, !tbaa !24
  store i8 %i.tf, ptr %i.tc, align 1, !tbaa !24
  ...
  store i8 -1, ptr %i.tn, align 1, !tbaa !24
  %i.to = getelementptr inbounds nuw i8, ptr %i.dn, i64 %indvars.iv.next36.i.2
  %i.tp = load i8, ptr %i.to, align 1, !tbaa !24
  store i8 %i.tp, ptr %i.tm, align 1, !tbaa !24
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.tq = shl nuw nsw i64 %indvars.iv.i, 2
  ...
  %i.tw = load i8, ptr %i.tv, align 1, !tbaa !24
  %i.tx = getelementptr inbounds nuw i8, ptr %i.tr, i64 2
  store i8 %i.tw, ptr %i.tx, align 1, !tbaa !24
  ...
  store i8 %i.tz, ptr %i.ua, align 1, !tbaa !24
  %i.ub = load i8, ptr %i.tu, align 1, !tbaa !24
  store i8 %i.ub, ptr %i.tr, align 1, !tbaa !24
  %indvars.iv.next.i = add nsw i64 %indvars.iv.i, -1 ; 3 uses
  %i.uc = shl nuw nsw i64 %indvars.iv.next.i, 2
  %i.ud = getelementptr inbounds nuw i8, ptr %i.dn, i64 %i.uc ; 4 uses
  %i.ue = getelementptr inbounds nuw i8, ptr %i.ud, i64 3
  store i8 -1, ptr %i.ue, align 1, !tbaa !24
  ...
  store i8 %i.ui, ptr %i.uj, align 1, !tbaa !24
  %i.uk = getelementptr inbounds nuw i8, ptr %i.ug, i64 1
  %i.ul = load i8, ptr %i.uk, align 1, !tbaa !24
  %i.um = getelementptr inbounds nuw i8, ptr %i.ud, i64 1
  store i8 %i.ul, ptr %i.um, align 1, !tbaa !24
  %i.un = load i8, ptr %i.ug, align 1, !tbaa !24
  store i8 %i.un, ptr %i.ud, align 1, !tbaa !24
...
.lr.ph.i308.prol:                                 ; preds = %.lr.ph.i308.preheader
  ...
  %i.ux = load i8, ptr %i.uq, align 1, !tbaa !24
  store i8 %i.ux, ptr %i.uo, align 1, !tbaa !24
...
vector.body:                                      ; preds = %.lr.ph32.i314.preheader, %vector.body
  ...
  %wide.load = load <8 x i8>, ptr %i.vc, align 1, !tbaa !24
  %i.vd = getelementptr inbounds i8, ptr %i.va, i64 -14
  %interleaved.vec = shufflevector <8 x i8> %wide.load, <8 x i8> splat (i8 -1), <16 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11, i32 4, i32 12, i32 5, i32 13, i32 6, i32 14, i32 7, i32 15>
  store <16 x i8> %interleaved.vec, ptr %i.vd, align 1, !tbaa !24
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ve = icmp eq i64 %index.next, %n.vec
  br i1 %i.ve, label %middle.block, label %vector.body, !llvm.loop !460
...
.lr.ph32.i314:                                    ; preds = %.lr.ph32.i314.preheader737, %.lr.ph32.i314
  ...
  store i8 -1, ptr %i.vh, align 1, !tbaa !24
  %i.vi = getelementptr inbounds nuw i8, ptr %i.de, i64 %indvars.iv35.i315
  %i.vj = load i8, ptr %i.vi, align 1, !tbaa !24
  store i8 %i.vj, ptr %i.vg, align 1, !tbaa !24
...
.lr.ph.i308:                                      ; preds = %.lr.ph.i308.prol.loopexit, %.lr.ph.i308
  ...
  %i.wc = load i8, ptr %i.wb, align 1, !tbaa !24
  %i.wd = getelementptr inbounds nuw i8, ptr %i.vx, i64 2
  store i8 %i.wc, ptr %i.wd, align 1, !tbaa !24
  %i.we = getelementptr inbounds nuw i8, ptr %i.wa, i64 1
  %i.wf = load i8, ptr %i.we, align 1, !tbaa !24
  %i.wg = getelementptr inbounds nuw i8, ptr %i.vx, i64 1
  store i8 %i.wf, ptr %i.wg, align 1, !tbaa !24
  %i.wh = load i8, ptr %i.wa, align 1, !tbaa !24
  store i8 %i.wh, ptr %i.vx, align 1, !tbaa !24
...
.lr.ph378:                                        ; preds = %.lr.ph378.preheader, %.lr.ph378
  ...
  store i16 %i.yi, ptr %i.ya, align 2, !tbaa !85
  %i.yj = getelementptr inbounds nuw i8, ptr %.1377, i64 6
  store i16 -1, ptr %i.yj, align 2, !tbaa !85
...
.lr.ph374:                                        ; preds = %.preheader346, %.lr.ph374
  ...
  %i.ym = load i8, ptr %.2251372, align 1, !tbaa !24
  ...
  store i16 %i.ys, ptr %.2373, align 2, !tbaa !85
  ...
  store i16 %i.za, ptr %i.zb, align 2, !tbaa !85
  %i.zc = getelementptr inbounds nuw i8, ptr %.2251372, i64 4
  %i.zd = load i8, ptr %i.zc, align 1, !tbaa !24
