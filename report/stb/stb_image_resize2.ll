...
bb.n:                                             ; preds = %.loopexit.i, %.lr.ph82.i
  ...
  %foldExtExtBinop241.a = fadd <4 x float> %i.ep, %i.et
  %i.eu = extractelement <4 x float> %foldExtExtBinop241.a, i64 0
...
.lr.ph.preheader.i:                               ; preds = %bb.ag
  %i.ig = sub nsw i32 %i.hj, %.0139181            ; 2 uses
