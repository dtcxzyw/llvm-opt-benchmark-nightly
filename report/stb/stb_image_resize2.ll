...
bb.i:                                             ; preds = %bb.h, %bb.g, %bb.d, %bb.f, %bb.b
  ...
  %9 = sitofp i32 %1 to float                     ; 2 uses
  ...
  %i.p = insertelement <2 x float> %i.o, float %10, i64 1
  ...
  %11 = getelementptr inbounds nuw i8, ptr %i.l, i64 8
  %i.s = fmul float %5, %9
  %i.t = load <2 x float>, ptr %11, align 4, !tbaa !58
