...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %.0174227 = phi i32 [ %.1175, %.lr.ph ], [ 2147483647, %bb.a ] ; 2 uses
  %.0182226 = phi i32 [ %.1183, %.lr.ph ], [ %i.f, %bb.a ]
  %i.l = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv
  %i.m = load i32, ptr %i.l, align 4, !tbaa !36   ; 2 uses
  %i.n = icmp slt i32 %i.m, %.0174227
  %i.o = trunc i64 %indvars.iv to i32
  %i.p = add i32 %i.i, %i.o
  %spec.select = tail call i32 @llvm.smin.i32(i32 %i.p, i32 %i.f)
  %.1183 = select i1 %i.n, i32 %spec.select, i32 %.0182226 ; 2 uses
  %.1175 = tail call i32 @llvm.smin.i32(i32 %i.m, i32 %.0174227) ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.q = sext i32 %.1183 to i64
...
.lr.ph232:                                        ; preds = %.lr.ph232.preheader, %.lr.ph232
  ...
  %.0172231 = phi i32 [ -2147483647, %.lr.ph232.preheader ], [ %.1173, %.lr.ph232 ] ; 2 uses
  %.2184230 = phi i32 [ 0, %.lr.ph232.preheader ], [ %.3185, %.lr.ph232 ]
  ...
  %i.v = icmp sgt i32 %i.u, %.0172231
  %i.w = trunc i64 %indvars.iv.next248 to i32
  %i.x = sub i32 %i.w, %i.i
  %spec.store.select = tail call i32 @llvm.smax.i32(i32 %i.x, i32 0)
  %.3185 = select i1 %i.v, i32 %spec.store.select, i32 %.2184230 ; 2 uses
  %.1173 = tail call i32 @llvm.smax.i32(i32 %i.u, i32 %.0172231) ; 2 uses
  %i.y = zext nneg i32 %.3185 to i64
...
._crit_edge:                                      ; preds = %.lr.ph232, %bb.a
  %.0174.lcssa259 = phi i32 [ 2147483647, %bb.a ], [ %.1175, %.lr.ph232 ] ; 3 uses
  %.0172.lcssa = phi i32 [ -2147483647, %bb.a ], [ %.1173, %.lr.ph232 ] ; 3 uses
  %i.z = tail call i32 @llvm.smin.i32(i32 %.0174.lcssa259, i32 0) ; 2 uses
  %spec.select211 = sub nsw i32 0, %i.z           ; 3 uses
  %spec.select212 = tail call i32 @llvm.smax.i32(i32 %.0174.lcssa259, i32 0) ; 8 uses
  %.not = icmp slt i32 %.0172.lcssa, %i.g
  %reass.sub = sub i32 %.0172.lcssa, %i.g
  %i.aa = add i32 %reass.sub, 1
  %i.ab = add nsw i32 %i.g, -1
  %.0178 = select i1 %.not, i32 0, i32 %i.aa      ; 5 uses
  %.2 = tail call i32 @llvm.smin.i32(i32 %.0172.lcssa, i32 %i.ab) ; 5 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 2 uses
  store i32 %spec.select211, ptr %i.ac, align 4, !tbaa !21
  %i.ad = getelementptr inbounds nuw i8, ptr %1, i64 12 ; 2 uses
  store i32 %.0178, ptr %i.ad, align 4, !tbaa !21
  %i.ae = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 10 uses
  store i32 %spec.select212, ptr %i.ae, align 4, !tbaa !41
  %i.af = getelementptr inbounds nuw i8, ptr %1, i64 20 ; 5 uses
  store i32 %.2, ptr %i.af, align 4, !tbaa !42
  %i.ag = getelementptr inbounds nuw i8, ptr %1, i64 24 ; 3 uses
  store i32 %spec.select212, ptr %i.ag, align 4, !tbaa !43
...
.preheader223:                                    ; preds = %._crit_edge
  %i.al = icmp slt i32 %.0174.lcssa259, 0
...
.preheader:                                       ; preds = %stbir__edge_wrap.exit, %.preheader223
  %.0170.lcssa = phi i32 [ 2147483647, %.preheader223 ], [ %spec.select213, %stbir__edge_wrap.exit ] ; 7 uses
  %.0168.lcssa = phi i32 [ -2147483647, %.preheader223 ], [ %.1169, %stbir__edge_wrap.exit ] ; 4 uses
  %i.ao = add nsw i32 %.0178, %i.g
  %i.ap = icmp sgt i32 %.0178, 0
...
stbir__edge_wrap.exit:                            ; preds = %stbir__edge_wrap.exit.lr.ph, %stbir__edge_wrap.exit
  %.0168236 = phi i32 [ -2147483647, %stbir__edge_wrap.exit.lr.ph ], [ %.1169, %stbir__edge_wrap.exit ]
  %.0170235 = phi i32 [ 2147483647, %stbir__edge_wrap.exit.lr.ph ], [ %spec.select213, %stbir__edge_wrap.exit ]
  %.2188234 = phi i32 [ %i.z, %stbir__edge_wrap.exit.lr.ph ], [ %i.au, %stbir__edge_wrap.exit ] ; 2 uses
  %i.as = load ptr, ptr %i.an, align 8, !tbaa !44
  %i.at = tail call i32 %i.as(i32 noundef %.2188234, i32 noundef %i.g) #24, !inline_history !45 ; 2 uses
  %spec.select213 = tail call i32 @llvm.smin.i32(i32 %i.at, i32 %.0170235) ; 2 uses
  %.1169 = tail call i32 @llvm.smax.i32(i32 %i.at, i32 %.0168236) ; 2 uses
  %i.au = add i32 %.2188234, 1                    ; 2 uses
...
2:                                                ; preds = %.lr.ph242, %stbir__edge_wrap.exit221
  %.0165241 = phi i32 [ -2147483647, %.lr.ph242 ], [ %.1, %stbir__edge_wrap.exit221 ]
  %.0166240 = phi i32 [ 2147483647, %.lr.ph242 ], [ %spec.select214, %stbir__edge_wrap.exit221 ]
  %.3189239 = phi i32 [ %i.g, %.lr.ph242 ], [ %i.av, %stbir__edge_wrap.exit221 ] ; 5 uses
  %3 = icmp sgt i32 %.3189239, -1
  %4 = icmp slt i32 %.3189239, %i.g
  %or.cond.i219 = and i1 %3, %4
  br i1 %or.cond.i219, label %stbir__edge_wrap.exit221, label %5

5:                                                ; preds = %2
  %6 = load ptr, ptr %i.ar, align 8, !tbaa !44
  %7 = tail call i32 %6(i32 noundef %.3189239, i32 noundef %i.g) #24, !inline_history !45
  br label %stbir__edge_wrap.exit221

stbir__edge_wrap.exit221:                         ; preds = %2, %5
  %.0.i220 = phi i32 [ %7, %5 ], [ %.3189239, %2 ] ; 2 uses
  %spec.select214 = tail call i32 @llvm.smin.i32(i32 %.0.i220, i32 %.0166240) ; 2 uses
  %.1 = tail call i32 @llvm.smax.i32(i32 %.0.i220, i32 %.0165241) ; 2 uses
  %i.av = add nsw i32 %.3189239, 1                ; 2 uses
...
._crit_edge243:                                   ; preds = %stbir__edge_wrap.exit221, %.preheader
  %.0166.lcssa = phi i32 [ 2147483647, %.preheader ], [ %spec.select214, %stbir__edge_wrap.exit221 ] ; 7 uses
  %.0165.lcssa = phi i32 [ -2147483647, %.preheader ], [ %.1, %stbir__edge_wrap.exit221 ] ; 4 uses
  %i.ax = icmp ne i32 %.0170.lcssa, 2147483647    ; 2 uses
  br i1 %i.ax, label %bb.b, label %bb.e

bb.b:                                             ; preds = %._crit_edge243
  %.not203 = icmp sgt i32 %.0170.lcssa, %spec.select212
  %i.ay = add nsw i32 %.0168.lcssa, 16
  %.not204 = icmp slt i32 %i.ay, %spec.select212
  %or.cond215 = select i1 %.not203, i1 true, i1 %.not204
  br i1 %or.cond215, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  %.not205 = icmp sgt i32 %spec.select212, %.0170.lcssa
  %i.az = add nsw i32 %.2, 16
  %.not206 = icmp slt i32 %i.az, %.0168.lcssa
  %or.cond216 = select i1 %.not205, i1 true, i1 %.not206
  br i1 %or.cond216, label %bb.e, label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %i.ba = tail call i32 @llvm.smin.i32(i32 %spec.select212, i32 %.0170.lcssa) ; 3 uses
  store i32 %i.ba, ptr %i.ae, align 4, !tbaa !41
  %i.bb = tail call i32 @llvm.smax.i32(i32 %.2, i32 %.0168.lcssa) ; 2 uses
  store i32 %i.bb, ptr %i.af, align 4, !tbaa !42
  store i32 %i.ba, ptr %i.ag, align 4, !tbaa !43
  br label %bb.e

bb.e:                                             ; preds = %bb.c, %bb.d, %._crit_edge243
  %.1181 = phi i32 [ 0, %bb.d ], [ %spec.select211, %._crit_edge243 ], [ %spec.select211, %bb.c ] ; 3 uses
  %.3177 = phi i32 [ %i.ba, %bb.d ], [ %spec.select212, %._crit_edge243 ], [ %spec.select212, %bb.c ] ; 4 uses
  %.3 = phi i32 [ %i.bb, %bb.d ], [ %.2, %._crit_edge243 ], [ %.2, %bb.c ] ; 2 uses
  %i.bc = sub nsw i32 0, %.1181
  %i.bd = icmp ne i32 %.0166.lcssa, 2147483647    ; 2 uses
  br i1 %i.bd, label %bb.f, label %bb.i

bb.f:                                             ; preds = %bb.e
  %.not207 = icmp sgt i32 %.0166.lcssa, %.3177
  %i.be = add nsw i32 %.0165.lcssa, 16
  %.not208 = icmp slt i32 %i.be, %.3177
  %or.cond217 = select i1 %.not207, i1 true, i1 %.not208
  br i1 %or.cond217, label %bb.g, label %bb.h

bb.g:                                             ; preds = %bb.f
  %.not209 = icmp sgt i32 %.3177, %.0166.lcssa
  %i.bf = add nsw i32 %.3, 16
  %.not210 = icmp slt i32 %i.bf, %.0165.lcssa
  %or.cond218 = select i1 %.not209, i1 true, i1 %.not210
  br i1 %or.cond218, label %bb.i, label %bb.h

bb.h:                                             ; preds = %bb.g, %bb.f
  %i.bg = tail call i32 @llvm.smin.i32(i32 %.3177, i32 %.0166.lcssa) ; 2 uses
  store i32 %i.bg, ptr %i.ae, align 4, !tbaa !41
  %i.bh = tail call i32 @llvm.smax.i32(i32 %.3, i32 %.0165.lcssa)
  store i32 %i.bh, ptr %i.af, align 4, !tbaa !42
  store i32 %i.bg, ptr %i.ag, align 4, !tbaa !43
  br label %bb.i

bb.i:                                             ; preds = %bb.g, %bb.h, %bb.e
  %.1179 = phi i32 [ 0, %bb.h ], [ %.0178, %bb.e ], [ %.0178, %bb.g ]
  %i.bi = icmp ne i32 %.1181, 0
  %or.cond = and i1 %i.ax, %i.bi
  br i1 %or.cond, label %bb.j, label %bb.m

bb.j:                                             ; preds = %bb.i
  %i.bj = load i32, ptr %i.ae, align 4, !tbaa !41 ; 3 uses
  %i.bk = icmp slt i32 %.0170.lcssa, %i.bj
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  store i32 %.0170.lcssa, ptr %i.bm, align 4, !tbaa !43
  store i32 %i.bc, ptr %.0164, align 4, !tbaa !41
  %i.bn = add i32 %.0170.lcssa, %.1181
  %i.bo = sub i32 %.0168.lcssa, %i.bn
...
bb.p:                                             ; preds = %._crit_edge250, %bb.o
  ...
  store i32 %.0166.lcssa, ptr %i.bv, align 4, !tbaa !43
  %i.bw = add nsw i32 %i.bu, 1                    ; 2 uses
  store i32 %i.bw, ptr %.0, align 4, !tbaa !41
  %i.bx = sub i32 %.0165.lcssa, %.0166.lcssa
...
bb.c:                                             ; preds = %bb.b, %bb.a
  %.126 = phi i32 [ %i.p, %bb.a ], [ %spec.select32, %bb.b ]
  %.1 = phi i32 [ %spec.select, %bb.a ], [ %spec.select33, %bb.b ]
  store i32 %.126, ptr %0, align 4, !tbaa !21
