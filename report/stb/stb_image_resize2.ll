...
._crit_edge168.loopexit.unr-lcssa:                ; preds = %bb.ac
  %4 = trunc i32 %2 to i1
  br i1 %4, label %.lr.ph167.epil.preheader, label %._crit_edge168
...
._crit_edge77.loopexit.unr-lcssa:                 ; preds = %.lr.ph76.split.us
  %7 = trunc i32 %1 to i1
  br i1 %7, label %.lr.ph76.split.us.epil.preheader, label %._crit_edge77
...
stbir__get_max_split.exit.loopexit.unr-lcssa:     ; preds = %.lr.ph.i
  ...
  br i1 %10, label %.lr.ph.i.epil.preheader, label %stbir__get_max_split.exit
...
._crit_edge.loopexit.unr-lcssa:                   ; preds = %.thread351.us
  br i1 %11, label %.thread351.us.epil.preheader, label %._crit_edge
...
stbir_simd_memcpy.exit340:                        ; preds = %bb.bc, %bb.bg
  ...
  %i.pf = load i32, ptr %i.pe, align 4, !tbaa !1045 ; 9 uses
...
.loopexit.loopexit.unr-lcssa:                     ; preds = %.lr.ph76.split.us.i
  %12 = trunc i32 %i.pf to i1
  br i1 %12, label %.lr.ph76.split.us.i.epil.preheader, label %.loopexit
