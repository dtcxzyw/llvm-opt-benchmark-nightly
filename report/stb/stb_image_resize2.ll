...
stbir__edge_wrap.exit221:                         ; preds = %.lr.ph242, %stbir__edge_wrap.exit221
  ...
  %.0.i220 = phi i32 [ %i.g, %.lr.ph242 ], [ %i.av, %stbir__edge_wrap.exit221 ] ; 2 uses
  %2 = load ptr, ptr %i.ar, align 8, !tbaa !44
  %3 = tail call i32 %2(i32 noundef %.0.i220, i32 noundef %i.g) #24, !inline_history !45 ; 2 uses
  %spec.select214 = tail call i32 @llvm.smin.i32(i32 %3, i32 %.0166240) ; 2 uses
  %.1 = tail call i32 @llvm.smax.i32(i32 %3, i32 %.0165241) ; 2 uses
  %i.av = add nsw i32 %.0.i220, 1                 ; 2 uses
