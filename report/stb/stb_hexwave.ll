...
bb.a:
  %i.a = load i32, ptr @hexblep, align 8, !tbaa !20 ; 6 uses
...
.lr.ph.preheader39:                               ; preds = %vector.memcheck, %.lr.ph.preheader, %middle.block
  ...
  %lcmp.mod.not = trunc i32 %i.a to i1
...
bb.a:
  ...
  %i.b = load i32, ptr @hexblep, align 8, !tbaa !20 ; 6 uses
...
bb.a:
  ...
  %i.c = load i32, ptr @hexblep, align 8, !tbaa !20 ; 8 uses
...
.lr.ph.i.i.preheader:                             ; preds = %vector.memcheck, %.lr.ph.preheader.i.i, %middle.block
  ...
  %lcmp.mod.not = trunc i32 %i.c to i1
  br i1 %lcmp.mod.not, label %.lr.ph.i.i.prol, label %.lr.ph.i.i.prol.loopexit
...
bb.q:                                             ; preds = %bb.p, %bb.o, %bb.n, %bb.m, %bb.l, %bb.k, %bb.j, %.preheader205
  ...
  %lcmp.mod453.not = trunc i32 %i.ei to i1
  ...
  %lcmp.mod455.not = trunc i32 %i.ei to i1
  ...
  %lcmp.mod457.not = trunc i32 %i.ei to i1
  ...
  %lcmp.mod459.not = trunc i32 %i.ei to i1
...
.lr.ph.i.i151.preheader445:                       ; preds = %vector.memcheck395, %.lr.ph.i.i151.preheader, %middle.block425
  ...
  br i1 %lcmp.mod453.not, label %.lr.ph.i.i151.prol, label %.lr.ph.i.i151.prol.loopexit
...
.lr.ph.i.i158.preheader444:                       ; preds = %vector.memcheck362, %.lr.ph.i.i158.preheader, %middle.block392
  ...
  br i1 %lcmp.mod455.not, label %.lr.ph.i.i158.prol, label %.lr.ph.i.i158.prol.loopexit
...
.lr.ph.i.i166.preheader443:                       ; preds = %vector.memcheck330, %.lr.ph.i.i166.preheader, %middle.block359
  ...
  br i1 %lcmp.mod457.not, label %.lr.ph.i.i166.prol, label %.lr.ph.i.i166.prol.loopexit
...
.lr.ph.i.i174.preheader442:                       ; preds = %vector.memcheck298, %.lr.ph.i.i174.preheader, %middle.block327
  ...
  br i1 %lcmp.mod459.not, label %.lr.ph.i.i174.prol, label %.lr.ph.i.i174.prol.loopexit
...
.preheader139.preheader:                          ; preds = %.preheader140
  ...
  %lcmp.mod306.not = trunc i32 %spec.store.select135 to i1
...
scalar.ph258.preheader:                           ; preds = %.preheader139, %middle.block269
  ...
  br i1 %lcmp.mod306.not, label %scalar.ph258.prol, label %scalar.ph258.prol.loopexit
