...
bb.a:
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.n, ptr noundef nonnull align 4 dereferenceable(16) %i.a, i64 16, i1 false), !tbaa.struct !18
...
bb.a:
  %i.a = load i32, ptr @hexblep, align 8, !tbaa !23 ; 6 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %i.w, align 4, !tbaa !17, !alias.scope !40 ; 2 uses
  %wide.load34 = load <4 x float>, ptr %i.x, align 4, !tbaa !17, !alias.scope !40 ; 2 uses
  %i.y = getelementptr inbounds nuw [4 x i8], ptr %i.m, i64 %index ; 2 uses
  %i.z = getelementptr inbounds nuw i8, ptr %i.y, i64 16
  %wide.load35 = load <4 x float>, ptr %i.y, align 4, !tbaa !17, !alias.scope !41
  %wide.load36 = load <4 x float>, ptr %i.z, align 4, !tbaa !17, !alias.scope !41
  ...
  %wide.load37 = load <4 x float>, ptr %i.ae, align 4, !tbaa !17, !alias.scope !42, !noalias !43
  %wide.load38 = load <4 x float>, ptr %i.af, align 4, !tbaa !17, !alias.scope !42, !noalias !43
  ...
  store <4 x float> %i.ag, ptr %i.ae, align 4, !tbaa !17, !alias.scope !42, !noalias !43
  store <4 x float> %i.ah, ptr %i.af, align 4, !tbaa !17, !alias.scope !42, !noalias !43
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ai = icmp eq i64 %index.next, %n.vec
  br i1 %i.ai, label %middle.block, label %vector.body, !llvm.loop !38
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader39
  ...
  %i.ak = load float, ptr %i.aj, align 4, !tbaa !17 ; 2 uses
  ...
  store float %i.ar, ptr %i.ap, align 4, !tbaa !17
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  %i.av = load float, ptr %i.au, align 4, !tbaa !17 ; 2 uses
  ...
  store float %i.bc, ptr %i.ba, align 4, !tbaa !17
  ...
  %i.bk = load float, ptr %i.bj, align 4, !tbaa !17
  %i.bl = tail call float @llvm.fmuladd.f32(float %2, float %i.bi, float %i.bk)
  store float %i.bl, ptr %i.bj, align 4, !tbaa !17
...
bb.a:
  %i.a = load ptr, ptr getelementptr inbounds nuw (i8, ptr @hexblep, i64 8), align 8, !tbaa !28 ; 4 uses
  %i.b = load i32, ptr @hexblep, align 8, !tbaa !23 ; 6 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %i.x, align 4, !tbaa !17, !alias.scope !50 ; 2 uses
  %wide.load10 = load <4 x float>, ptr %i.y, align 4, !tbaa !17, !alias.scope !50 ; 2 uses
  %i.z = getelementptr inbounds nuw [4 x i8], ptr %i.n, i64 %index ; 2 uses
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 16
  %wide.load11 = load <4 x float>, ptr %i.z, align 4, !tbaa !17, !alias.scope !51
  %wide.load12 = load <4 x float>, ptr %i.aa, align 4, !tbaa !17, !alias.scope !51
  ...
  %wide.load13 = load <4 x float>, ptr %i.af, align 4, !tbaa !17, !alias.scope !52, !noalias !53
  %wide.load14 = load <4 x float>, ptr %i.ag, align 4, !tbaa !17, !alias.scope !52, !noalias !53
  ...
  store <4 x float> %i.ah, ptr %i.af, align 4, !tbaa !17, !alias.scope !52, !noalias !53
  store <4 x float> %i.ai, ptr %i.ag, align 4, !tbaa !17, !alias.scope !52, !noalias !53
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.aj = icmp eq i64 %index.next, %n.vec
  br i1 %i.aj, label %middle.block, label %vector.body, !llvm.loop !48
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader
  ...
  %i.al = load float, ptr %i.ak, align 4, !tbaa !17 ; 2 uses
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.ay = load float, ptr %i.ax, align 4, !tbaa !17
  ...
  store float %i.bm, ptr %i.bk, align 4, !tbaa !17
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2 ; 2 uses
  %exitcond.not.i.1 = icmp eq i64 %indvars.iv.next.i.1, %wide.trip.count.i
  br i1 %exitcond.not.i.1, label %hex_add_oversampled_bleplike.exit, label %.lr.ph.i, !llvm.loop !49
...
bb.a:
  %i.a = load ptr, ptr getelementptr inbounds nuw (i8, ptr @hexblep, i64 16), align 8, !tbaa !29 ; 4 uses
  %i.b = load i32, ptr @hexblep, align 8, !tbaa !23 ; 6 uses
  %i.c = load i32, ptr getelementptr inbounds nuw (i8, ptr @hexblep, i64 4), align 4, !tbaa !24 ; 2 uses
  %i.d = sitofp i32 %i.c to float                 ; 2 uses
  %i.e = fmul float %1, %i.d
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.x = getelementptr inbounds nuw [4 x i8], ptr %i.j, i64 %index ; 2 uses
  %i.y = getelementptr inbounds nuw i8, ptr %i.x, i64 16
  %wide.load = load <4 x float>, ptr %i.x, align 4, !tbaa !17, !alias.scope !60 ; 2 uses
  %wide.load10 = load <4 x float>, ptr %i.y, align 4, !tbaa !17, !alias.scope !60 ; 2 uses
  %i.z = getelementptr inbounds nuw [4 x i8], ptr %i.n, i64 %index ; 2 uses
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 16
  %wide.load11 = load <4 x float>, ptr %i.z, align 4, !tbaa !17, !alias.scope !61
  %wide.load12 = load <4 x float>, ptr %i.aa, align 4, !tbaa !17, !alias.scope !61
  %i.ab = fsub <4 x float> %wide.load11, %wide.load
  %i.ac = fsub <4 x float> %wide.load12, %wide.load10
  %i.ad = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ab, <4 x float> %broadcast.splat, <4 x float> %wide.load)
  %i.ae = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ac, <4 x float> %broadcast.splat, <4 x float> %wide.load10)
  %i.af = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %index ; 3 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %i.af, i64 16 ; 2 uses
  %wide.load13 = load <4 x float>, ptr %i.af, align 4, !tbaa !17, !alias.scope !62, !noalias !63
  %wide.load14 = load <4 x float>, ptr %i.ag, align 4, !tbaa !17, !alias.scope !62, !noalias !63
  %i.ah = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %broadcast.splat9, <4 x float> %i.ad, <4 x float> %wide.load13)
  %i.ai = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %broadcast.splat9, <4 x float> %i.ae, <4 x float> %wide.load14)
  store <4 x float> %i.ah, ptr %i.af, align 4, !tbaa !17, !alias.scope !62, !noalias !63
  store <4 x float> %i.ai, ptr %i.ag, align 4, !tbaa !17, !alias.scope !62, !noalias !63
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.aj = icmp eq i64 %index.next, %n.vec
...
bb.a:
  ...
  store <2 x float> zeroinitializer, ptr %0, align 4, !tbaa !17
  %i.b = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.d = load float, ptr %i.c, align 4, !tbaa !64
  %i.e = fmul float %i.d, 5.000000e-01            ; 6 uses
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 12 ; 2 uses
  store float %i.e, ptr %i.f, align 4, !tbaa !31
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 16
  store float 0.000000e+00, ptr %i.g, align 4, !tbaa !32
  %i.h = getelementptr inbounds nuw i8, ptr %1, i64 12
  %i.i = load float, ptr %i.h, align 4, !tbaa !65 ; 2 uses
  ...
  store float %i.l, ptr %i.m, align 4, !tbaa !31
  ...
  store float 5.000000e-01, ptr %i.o, align 4, !tbaa !31
  %i.p = getelementptr inbounds nuw i8, ptr %1, i64 20
  %i.q = load float, ptr %i.p, align 4, !tbaa !66 ; 5 uses
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 40
  store float %i.q, ptr %i.r, align 4, !tbaa !32
  %i.s = load i32, ptr %i.b, align 4, !tbaa !67
  %.not = icmp eq i32 %i.s, 0
  %i.t = getelementptr i8, ptr %0, i64 48
  store float 5.000000e-01, ptr %i.t, align 4, !tbaa !31
...
.preheader84.preheader:                           ; preds = %bb.a
  ...
  store float %i.v, ptr %i.w, align 4, !tbaa !32
...
.preheader82.preheader:                           ; preds = %bb.a
  ...
  store float -1.000000e+00, ptr %i.ak, align 4, !tbaa !32
  %i.al = getelementptr i8, ptr %0, i64 84
  store float 1.000000e+00, ptr %i.al, align 4, !tbaa !31
  %i.am = fneg float %i.q
  br label %.loopexit83
...
.loopexit83:                                      ; preds = %.preheader84.preheader, %.preheader82.preheader
  ...
  store float %.sink, ptr %i.u, align 4, !tbaa !32
  %i.as = getelementptr inbounds nuw i8, ptr %0, i64 96 ; 2 uses
  store <2 x float> <float 1.000000e+00, float 0.000000e+00>, ptr %i.as, align 4, !tbaa !17
  %i.at = fcmp ugt float %i.e, %i.a
  br i1 %i.at, label %.loopexit83._crit_edge, label %bb.b

bb.b:                                             ; preds = %.loopexit83
  store float 0.000000e+00, ptr %i.f, align 4, !tbaa !31
...
bb.c:                                             ; preds = %.loopexit83._crit_edge
  store float %i.au, ptr %i.m, align 4, !tbaa !31
  br label %bb.d
...
bb.e:                                             ; preds = %bb.d
  store float %i.aw, ptr %i.o, align 4, !tbaa !31
...
bb.f:                                             ; preds = %._crit_edge107
  ...
  store float %i.ay, ptr %i.bb, align 4, !tbaa !31
...
bb.g:                                             ; preds = %._crit_edge106
  store float %i.bc, ptr %i.bd, align 4, !tbaa !31
  br label %bb.h
...
bb.i:                                             ; preds = %bb.h
  store float %i.bg, ptr %i.bh, align 4, !tbaa !31
  br label %bb.j
...
._crit_edge:                                      ; preds = %bb.j
  store float %i.bj, ptr %i.bk, align 4, !tbaa !31
...
bb.k:                                             ; preds = %.preheader.preheader
  store float 1.000000e+00, ptr %i.bd, align 4, !tbaa !31
...
bb.l:                                             ; preds = %.preheader.1
  store float 1.000000e+00, ptr %i.bh, align 4, !tbaa !31
...
bb.m:                                             ; preds = %.preheader.2
  store float 1.000000e+00, ptr %i.bk, align 4, !tbaa !31
...
.loopexit:                                        ; preds = %bb.j, %._crit_edge, %.preheader.3, %bb.n
  ...
  store float %i.cx, ptr %i.cb, align 4, !tbaa !33
  ...
  store float %.sink103, ptr %i.ee, align 4, !tbaa !33
  store <2 x float> <float 1.000000e+00, float 0.000000e+00>, ptr %i.as, align 4, !tbaa !17
  %i.ef = getelementptr inbounds nuw i8, ptr %0, i64 104
  store float %i.cx, ptr %i.ef, align 4, !tbaa !33
  ret void
}
...
bb.a:
  ...
  %i.c = load i32, ptr @hexblep, align 8, !tbaa !23 ; 8 uses
...
.lr.ph.preheader.i.i:                             ; preds = %bb.d
  %wide.trip.count.i.i = zext nneg i32 %i.c to i64 ; 7 uses
...
.lr.ph.i.i.preheader:                             ; preds = %vector.memcheck, %.lr.ph.preheader.i.i, %middle.block
  ...
  br i1 %5, label %.lr.ph.i.i.prol, label %.lr.ph.i.i.prol.loopexit
...
bb.q:                                             ; preds = %bb.p, %bb.o, %bb.n, %bb.m, %bb.l, %bb.k, %bb.j, %.preheader205
  ...
  %i.ei = load i32, ptr @hexblep, align 8         ; 18 uses
  ...
  %wide.trip.count.i.i150 = zext i32 %i.ei to i64 ; 17 uses
...
bb.t:                                             ; preds = %._crit_edge
  ...
  %i.ga = load ptr, ptr getelementptr inbounds nuw (i8, ptr @hexblep, i64 8), align 8, !tbaa !28 ; 3 uses
...
vector.body416:                                   ; preds = %vector.body416, %vector.ph410
  ...
  %wide.load418 = load <4 x float>, ptr %i.gq, align 4, !tbaa !17, !alias.scope !107 ; 2 uses
  %wide.load419 = load <4 x float>, ptr %i.gr, align 4, !tbaa !17, !alias.scope !107 ; 2 uses
  %i.gs = getelementptr inbounds nuw [4 x i8], ptr %i.gj, i64 %index417 ; 2 uses
  %i.gt = getelementptr inbounds nuw i8, ptr %i.gs, i64 16
  %wide.load420 = load <4 x float>, ptr %i.gs, align 4, !tbaa !17, !alias.scope !108
  %wide.load421 = load <4 x float>, ptr %i.gt, align 4, !tbaa !17, !alias.scope !108
  ...
  %wide.load422 = load <4 x float>, ptr %i.gy, align 4, !tbaa !17, !alias.scope !109, !noalias !110
  %wide.load423 = load <4 x float>, ptr %i.gz, align 4, !tbaa !17, !alias.scope !109, !noalias !110
  ...
  store <4 x float> %i.ha, ptr %i.gy, align 4, !tbaa !17, !alias.scope !109, !noalias !110
  store <4 x float> %i.hb, ptr %i.gz, align 4, !tbaa !17, !alias.scope !109, !noalias !110
  %index.next424 = add nuw i64 %index417, 8       ; 2 uses
  %i.hc = icmp eq i64 %index.next424, %n.vec411
  br i1 %i.hc, label %middle.block425, label %vector.body416, !llvm.loop !79
...
.lr.ph.i.i151.preheader445:                       ; preds = %vector.memcheck395, %.lr.ph.i.i151.preheader, %middle.block425
  ...
  br i1 %6, label %.lr.ph.i.i151.prol, label %.lr.ph.i.i151.prol.loopexit
...
.lr.ph.i.i151.prol:                               ; preds = %.lr.ph.i.i151.preheader445
  ...
  %i.he = load float, ptr %i.hd, align 4, !tbaa !17 ; 2 uses
  ...
  store float %i.hl, ptr %i.hj, align 4, !tbaa !17
...
.lr.ph.i.i151:                                    ; preds = %.lr.ph.i.i151.prol.loopexit, %.lr.ph.i.i151
  ...
  %i.hp = load float, ptr %i.ho, align 4, !tbaa !17 ; 2 uses
  ...
  %i.hv = load float, ptr %i.hu, align 4, !tbaa !17
  %i.hw = tail call float @llvm.fmuladd.f32(float %i.fz, float %i.ht, float %i.hv)
  store float %i.hw, ptr %i.hu, align 4, !tbaa !17
  ...
  %i.hy = load float, ptr %i.hx, align 4, !tbaa !17 ; 2 uses
  ...
  store float %i.if, ptr %i.id, align 4, !tbaa !17
...
hex_blep.exit.thread:                             ; preds = %.lr.ph.i.i151.prol.loopexit, %.lr.ph.i.i151, %middle.block425
  ...
  %i.ii = load float, ptr %i.ih, align 4, !tbaa !33
  %i.ij = getelementptr inbounds nuw i8, ptr %i.fp, i64 8
  %i.ik = load float, ptr %i.ij, align 4, !tbaa !33
  %i.il = fsub float %i.ii, %i.ik
  %i.im = load ptr, ptr getelementptr inbounds nuw (i8, ptr @hexblep, i64 16), align 8, !tbaa !29 ; 2 uses
...
hex_blep.exit:                                    ; preds = %._crit_edge
  ...
  %i.ir = load float, ptr %i.iq, align 4, !tbaa !33
  %i.is = getelementptr inbounds nuw i8, ptr %i.fp, i64 8
  %i.it = load float, ptr %i.is, align 4, !tbaa !33
  %i.iu = fsub float %i.ir, %i.it
  %i.iv = load ptr, ptr getelementptr inbounds nuw (i8, ptr @hexblep, i64 16), align 8, !tbaa !29 ; 2 uses
...
vector.body383:                                   ; preds = %vector.body383, %vector.ph377
  ...
  %wide.load385 = load <4 x float>, ptr %i.je, align 4, !tbaa !17, !alias.scope !111 ; 2 uses
  %wide.load386 = load <4 x float>, ptr %i.jf, align 4, !tbaa !17, !alias.scope !111 ; 2 uses
  %i.jg = getelementptr inbounds nuw [4 x i8], ptr %i.iy, i64 %index384 ; 2 uses
  %i.jh = getelementptr inbounds nuw i8, ptr %i.jg, i64 16
  %wide.load387 = load <4 x float>, ptr %i.jg, align 4, !tbaa !17, !alias.scope !112
  %wide.load388 = load <4 x float>, ptr %i.jh, align 4, !tbaa !17, !alias.scope !112
  ...
  %wide.load389 = load <4 x float>, ptr %i.jm, align 4, !tbaa !17, !alias.scope !113, !noalias !114
  %wide.load390 = load <4 x float>, ptr %i.jn, align 4, !tbaa !17, !alias.scope !113, !noalias !114
  ...
  store <4 x float> %i.jo, ptr %i.jm, align 4, !tbaa !17, !alias.scope !113, !noalias !114
  store <4 x float> %i.jp, ptr %i.jn, align 4, !tbaa !17, !alias.scope !113, !noalias !114
  %index.next391 = add nuw i64 %index384, 8       ; 2 uses
  %i.jq = icmp eq i64 %index.next391, %n.vec378
  br i1 %i.jq, label %middle.block392, label %vector.body383, !llvm.loop !85
...
.lr.ph.i.i158.preheader444:                       ; preds = %vector.memcheck362, %.lr.ph.i.i158.preheader, %middle.block392
  ...
  br i1 %7, label %.lr.ph.i.i158.prol, label %.lr.ph.i.i158.prol.loopexit
...
.lr.ph.i.i158.prol:                               ; preds = %.lr.ph.i.i158.preheader444
  ...
  %i.jt = load float, ptr %i.js, align 4, !tbaa !17 ; 2 uses
  ...
  %i.jz = load float, ptr %i.jy, align 4, !tbaa !17
  %i.ka = tail call float @llvm.fmuladd.f32(float %i.jb, float %i.jx, float %i.jz)
  store float %i.ka, ptr %i.jy, align 4, !tbaa !17
...
.lr.ph.i.i158:                                    ; preds = %.lr.ph.i.i158, %.lr.ph.i.i158.preheader444.new
  ...
  %i.kf = load float, ptr %i.ke, align 4, !tbaa !17 ; 2 uses
  ...
  %i.kl = load float, ptr %i.kk, align 4, !tbaa !17
  %i.km = tail call float @llvm.fmuladd.f32(float %i.jb, float %i.kj, float %i.kl)
  store float %i.km, ptr %i.kk, align 4, !tbaa !17
  ...
  %i.ko = load float, ptr %i.kn, align 4, !tbaa !17 ; 2 uses
  ...
  %i.ku = load float, ptr %i.kt, align 4, !tbaa !17
  %i.kv = tail call float @llvm.fmuladd.f32(float %i.jb, float %i.ks, float %i.ku)
  store float %i.kv, ptr %i.kt, align 4, !tbaa !17
...
bb.v:                                             ; preds = %bb.u
  %i.la = load float, ptr %i.dd, align 8, !tbaa !33 ; 2 uses
  %i.lb = load float, ptr %i.de, align 4, !tbaa !32 ; 2 uses
  ...
  call void @hexwave_generate_linesegs(ptr noundef nonnull %4, ptr noundef nonnull %2, float noundef %i.e)
  %i.lc = load float, ptr %i.de, align 4, !tbaa !32 ; 2 uses
...
bb.w:                                             ; preds = %bb.v
  ...
  %i.lg = load ptr, ptr getelementptr inbounds nuw (i8, ptr @hexblep, i64 8), align 8, !tbaa !28 ; 3 uses
...
vector.body350:                                   ; preds = %vector.body350, %vector.ph344
  ...
  %wide.load352 = load <4 x float>, ptr %i.lv, align 4, !tbaa !17, !alias.scope !115 ; 2 uses
  %wide.load353 = load <4 x float>, ptr %i.lw, align 4, !tbaa !17, !alias.scope !115 ; 2 uses
  %i.lx = getelementptr inbounds nuw [4 x i8], ptr %i.lp, i64 %index351 ; 2 uses
  %i.ly = getelementptr inbounds nuw i8, ptr %i.lx, i64 16
  %wide.load354 = load <4 x float>, ptr %i.lx, align 4, !tbaa !17, !alias.scope !116
  %wide.load355 = load <4 x float>, ptr %i.ly, align 4, !tbaa !17, !alias.scope !116
  ...
  %wide.load356 = load <4 x float>, ptr %i.md, align 4, !tbaa !17, !alias.scope !117, !noalias !118
  %wide.load357 = load <4 x float>, ptr %i.me, align 4, !tbaa !17, !alias.scope !117, !noalias !118
  ...
  store <4 x float> %i.mf, ptr %i.md, align 4, !tbaa !17, !alias.scope !117, !noalias !118
  store <4 x float> %i.mg, ptr %i.me, align 4, !tbaa !17, !alias.scope !117, !noalias !118
  %index.next358 = add nuw i64 %index351, 8       ; 2 uses
  %i.mh = icmp eq i64 %index.next358, %n.vec345
  br i1 %i.mh, label %middle.block359, label %vector.body350, !llvm.loop !91
...
.lr.ph.i.i166.preheader443:                       ; preds = %vector.memcheck330, %.lr.ph.i.i166.preheader, %middle.block359
  ...
  br i1 %8, label %.lr.ph.i.i166.prol, label %.lr.ph.i.i166.prol.loopexit
...
.lr.ph.i.i166.prol:                               ; preds = %.lr.ph.i.i166.preheader443
  ...
  %i.mj = load float, ptr %i.mi, align 4, !tbaa !17 ; 2 uses
  ...
  %i.mp = load float, ptr %i.mo, align 4, !tbaa !17
  %i.mq = tail call float @llvm.fmuladd.f32(float %i.lf, float %i.mn, float %i.mp)
  store float %i.mq, ptr %i.mo, align 4, !tbaa !17
...
.lr.ph.i.i166:                                    ; preds = %.lr.ph.i.i166.prol.loopexit, %.lr.ph.i.i166
  ...
  %i.mt = load float, ptr %i.ms, align 4, !tbaa !17 ; 2 uses
  ...
  %i.mz = load float, ptr %i.my, align 4, !tbaa !17
  %i.na = tail call float @llvm.fmuladd.f32(float %i.lf, float %i.mx, float %i.mz)
  store float %i.na, ptr %i.my, align 4, !tbaa !17
  ...
  %i.nc = load float, ptr %i.nb, align 4, !tbaa !17 ; 2 uses
  ...
  %i.ni = load float, ptr %i.nh, align 4, !tbaa !17
  %i.nj = tail call float @llvm.fmuladd.f32(float %i.lf, float %i.ng, float %i.ni)
  store float %i.nj, ptr %i.nh, align 4, !tbaa !17
...
hex_blep.exit170:                                 ; preds = %.lr.ph.i.i166.prol.loopexit, %.lr.ph.i.i166, %middle.block359, %bb.w, %bb.v
  %i.nk = load float, ptr %i.dd, align 8, !tbaa !33 ; 2 uses
...
.lr.ph.i.i174.preheader442:                       ; preds = %vector.memcheck298, %.lr.ph.i.i174.preheader, %middle.block327
  ...
  br i1 %9, label %.lr.ph.i.i174.prol, label %.lr.ph.i.i174.prol.loopexit
...
._crit_edge202:                                   ; preds = %bb.y
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %0, ptr nonnull align 16 %i.a, i64 %i.qk, i1 false), !tbaa !17
  br label %bb.z
...
bb.d:                                             ; preds = %bb.c, %bb.b
  %spec.store.select135 = phi i32 [ %spec.store.select134, %bb.b ], [ %spec.store.select, %bb.c ] ; 7 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.hu = load float, ptr %i.gz, align 4, !tbaa !17, !alias.scope !144
  %i.hv = fdiv float 1.000000e+00, %i.hu
  %broadcast.splatinsert = insertelement <4 x float> poison, float %i.hv, i64 0
  %broadcast.splat = shufflevector <4 x float> %broadcast.splatinsert, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %i.hw = load float, ptr %i.hb, align 4, !tbaa !17, !alias.scope !145
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %i.hy, align 4, !tbaa !17, !alias.scope !146, !noalias !147
  %wide.load229 = load <4 x float>, ptr %i.hz, align 4, !tbaa !17, !alias.scope !146, !noalias !147
  %i.ia = fmul <4 x float> %wide.load, %broadcast.splat
  %i.ib = fmul <4 x float> %wide.load229, %broadcast.splat
  store <4 x float> %i.ia, ptr %i.hy, align 4, !tbaa !17, !alias.scope !146, !noalias !147
  store <4 x float> %i.ib, ptr %i.hz, align 4, !tbaa !17, !alias.scope !146, !noalias !147
  %i.ic = getelementptr inbounds nuw [4 x i8], ptr %i.s, i64 %index ; 3 uses
  %i.id = getelementptr inbounds nuw i8, ptr %i.ic, i64 16 ; 2 uses
  %wide.load230 = load <4 x float>, ptr %i.ic, align 4, !tbaa !17, !alias.scope !148, !noalias !149
  %wide.load231 = load <4 x float>, ptr %i.id, align 4, !tbaa !17, !alias.scope !148, !noalias !149
  %i.ie = fmul <4 x float> %wide.load230, %broadcast.splat233
  %i.if = fmul <4 x float> %wide.load231, %broadcast.splat233
  store <4 x float> %i.ie, ptr %i.ic, align 4, !tbaa !17, !alias.scope !148, !noalias !149
  store <4 x float> %i.if, ptr %i.id, align 4, !tbaa !17, !alias.scope !148, !noalias !149
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ig = icmp eq i64 %index.next, %n.vec
  br i1 %i.ig, label %scalar.ph.preheader, label %vector.body, !llvm.loop !128
...
.preheader142.split:                              ; preds = %.preheader142, %.preheader142.split
  ...
  br i1 %exitcond.not, label %.split.us, label %.preheader142.split, !llvm.loop !129
...
.preheader139.preheader:                          ; preds = %.preheader140
  ...
  %i.je = zext nneg i32 %spec.store.select135 to i64 ; 7 uses
  ...
  %3 = trunc i32 %spec.store.select135 to i1
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.jt = load float, ptr %i.js, align 4, !tbaa !17
  %i.ju = load float, ptr %i.gz, align 4, !tbaa !17
  ...
  %i.jy = load float, ptr %i.jx, align 4, !tbaa !17
  %i.jz = load float, ptr %i.hb, align 4, !tbaa !17
  %i.ka = fdiv float %i.ha, %i.jz
  %i.kb = fmul float %i.jy, %i.ka
  store float %i.kb, ptr %i.jx, align 4, !tbaa !17
  ...
  %i.ke = load float, ptr %i.gz, align 4, !tbaa !17
  %i.kf = fdiv float 1.000000e+00, %i.ke
  %i.kg = fmul float %i.kd, %i.kf
  store float %i.kg, ptr %i.kc, align 4, !tbaa !17
  %i.kh = getelementptr inbounds nuw [4 x i8], ptr %i.s, i64 %indvars.iv.next173 ; 2 uses
  %i.ki = load float, ptr %i.kh, align 4, !tbaa !17
  %i.kj = load float, ptr %i.hb, align 4, !tbaa !17
  %i.kk = fdiv float %i.ha, %i.kj
  %i.kl = fmul float %i.ki, %i.kk
  store float %i.kl, ptr %i.kh, align 4, !tbaa !17
  ...
  br i1 %exitcond177.not.1, label %.preheader140, label %scalar.ph, !llvm.loop !131
...
vector.body262:                                   ; preds = %.preheader139
  ...
  %wide.load264 = load <4 x float>, ptr %i.kn, align 4, !tbaa !17, !alias.scope !150
  %wide.load265 = load <4 x float>, ptr %i.ko, align 4, !tbaa !17, !alias.scope !150
  %i.kp = getelementptr inbounds nuw [4 x i8], ptr %.0125, i64 %i.km ; 2 uses
  %i.kq = getelementptr inbounds nuw i8, ptr %i.kp, i64 16
  store <4 x float> %wide.load264, ptr %i.kp, align 4, !tbaa !17, !alias.scope !151, !noalias !152
  store <4 x float> %wide.load265, ptr %i.kq, align 4, !tbaa !17, !alias.scope !151, !noalias !152
  ...
  %wide.load266 = load <4 x float>, ptr %i.kr, align 4, !tbaa !17, !alias.scope !153
  %wide.load267 = load <4 x float>, ptr %i.ks, align 4, !tbaa !17, !alias.scope !153
  %i.kt = getelementptr inbounds nuw [4 x i8], ptr %.0124, i64 %i.km ; 2 uses
  %i.ku = getelementptr inbounds nuw i8, ptr %i.kt, i64 16
  store <4 x float> %wide.load266, ptr %i.kt, align 4, !tbaa !17, !alias.scope !154, !noalias !155
  store <4 x float> %wide.load267, ptr %i.ku, align 4, !tbaa !17, !alias.scope !154, !noalias !155
...
vector.body262.1:                                 ; preds = %vector.body262
  ...
  %wide.load264.1 = load <4 x float>, ptr %i.kw, align 4, !tbaa !17, !alias.scope !150
  %wide.load265.1 = load <4 x float>, ptr %i.kx, align 4, !tbaa !17, !alias.scope !150
  ...
  store <4 x float> %wide.load264.1, ptr %i.kz, align 4, !tbaa !17, !alias.scope !151, !noalias !152
  store <4 x float> %wide.load265.1, ptr %i.la, align 4, !tbaa !17, !alias.scope !151, !noalias !152
  %i.lb = getelementptr inbounds nuw [4 x i8], ptr %i.s, i64 %i.kv ; 2 uses
  %i.lc = getelementptr inbounds nuw i8, ptr %i.lb, i64 16
  %wide.load266.1 = load <4 x float>, ptr %i.lb, align 4, !tbaa !17, !alias.scope !153
  %wide.load267.1 = load <4 x float>, ptr %i.lc, align 4, !tbaa !17, !alias.scope !153
  %i.ld = getelementptr inbounds nuw [4 x i8], ptr %.0124, i64 %i.ky ; 2 uses
  %i.le = getelementptr inbounds nuw i8, ptr %i.ld, i64 16
  store <4 x float> %wide.load266.1, ptr %i.ld, align 4, !tbaa !17, !alias.scope !154, !noalias !155
  store <4 x float> %wide.load267.1, ptr %i.le, align 4, !tbaa !17, !alias.scope !154, !noalias !155
...
vector.body262.2:                                 ; preds = %vector.body262.1
  ...
  %wide.load264.2 = load <4 x float>, ptr %i.lg, align 4, !tbaa !17, !alias.scope !150
  %wide.load265.2 = load <4 x float>, ptr %i.lh, align 4, !tbaa !17, !alias.scope !150
  ...
  store <4 x float> %wide.load264.2, ptr %i.lj, align 4, !tbaa !17, !alias.scope !151, !noalias !152
  store <4 x float> %wide.load265.2, ptr %i.lk, align 4, !tbaa !17, !alias.scope !151, !noalias !152
  %i.ll = getelementptr inbounds nuw [4 x i8], ptr %i.s, i64 %i.lf ; 2 uses
  %i.lm = getelementptr inbounds nuw i8, ptr %i.ll, i64 16
  %wide.load266.2 = load <4 x float>, ptr %i.ll, align 4, !tbaa !17, !alias.scope !153
  %wide.load267.2 = load <4 x float>, ptr %i.lm, align 4, !tbaa !17, !alias.scope !153
  %i.ln = getelementptr inbounds nuw [4 x i8], ptr %.0124, i64 %i.li ; 2 uses
  %i.lo = getelementptr inbounds nuw i8, ptr %i.ln, i64 16
  store <4 x float> %wide.load266.2, ptr %i.ln, align 4, !tbaa !17, !alias.scope !154, !noalias !155
  store <4 x float> %wide.load267.2, ptr %i.lo, align 4, !tbaa !17, !alias.scope !154, !noalias !155
...
vector.body262.3:                                 ; preds = %vector.body262.2
  ...
  %wide.load264.3 = load <4 x float>, ptr %i.lq, align 4, !tbaa !17, !alias.scope !150
  %wide.load265.3 = load <4 x float>, ptr %i.lr, align 4, !tbaa !17, !alias.scope !150
  ...
  store <4 x float> %wide.load264.3, ptr %i.lt, align 4, !tbaa !17, !alias.scope !151, !noalias !152
  store <4 x float> %wide.load265.3, ptr %i.lu, align 4, !tbaa !17, !alias.scope !151, !noalias !152
  %i.lv = getelementptr inbounds nuw [4 x i8], ptr %i.s, i64 %i.lp ; 2 uses
  %i.lw = getelementptr inbounds nuw i8, ptr %i.lv, i64 16
  %wide.load266.3 = load <4 x float>, ptr %i.lv, align 4, !tbaa !17, !alias.scope !153
  %wide.load267.3 = load <4 x float>, ptr %i.lw, align 4, !tbaa !17, !alias.scope !153
  %i.lx = getelementptr inbounds nuw [4 x i8], ptr %.0124, i64 %i.ls ; 2 uses
  %i.ly = getelementptr inbounds nuw i8, ptr %i.lx, i64 16
  store <4 x float> %wide.load266.3, ptr %i.lx, align 4, !tbaa !17, !alias.scope !154, !noalias !155
  store <4 x float> %wide.load267.3, ptr %i.ly, align 4, !tbaa !17, !alias.scope !154, !noalias !155
...
vector.body262.4:                                 ; preds = %vector.body262.3
  ...
  %wide.load264.4 = load <4 x float>, ptr %i.ma, align 4, !tbaa !17, !alias.scope !150
  %wide.load265.4 = load <4 x float>, ptr %i.mb, align 4, !tbaa !17, !alias.scope !150
  ...
  store <4 x float> %wide.load264.4, ptr %i.md, align 4, !tbaa !17, !alias.scope !151, !noalias !152
  store <4 x float> %wide.load265.4, ptr %i.me, align 4, !tbaa !17, !alias.scope !151, !noalias !152
  %i.mf = getelementptr inbounds nuw [4 x i8], ptr %i.s, i64 %i.lz ; 2 uses
  %i.mg = getelementptr inbounds nuw i8, ptr %i.mf, i64 16
  %wide.load266.4 = load <4 x float>, ptr %i.mf, align 4, !tbaa !17, !alias.scope !153
  %wide.load267.4 = load <4 x float>, ptr %i.mg, align 4, !tbaa !17, !alias.scope !153
  %i.mh = getelementptr inbounds nuw [4 x i8], ptr %.0124, i64 %i.mc ; 2 uses
  %i.mi = getelementptr inbounds nuw i8, ptr %i.mh, i64 16
  store <4 x float> %wide.load266.4, ptr %i.mh, align 4, !tbaa !17, !alias.scope !154, !noalias !155
  store <4 x float> %wide.load267.4, ptr %i.mi, align 4, !tbaa !17, !alias.scope !154, !noalias !155
...
vector.body262.5:                                 ; preds = %vector.body262.4
  ...
  %wide.load264.5 = load <4 x float>, ptr %i.mk, align 4, !tbaa !17, !alias.scope !150
  %wide.load265.5 = load <4 x float>, ptr %i.ml, align 4, !tbaa !17, !alias.scope !150
  ...
  store <4 x float> %wide.load264.5, ptr %i.mn, align 4, !tbaa !17, !alias.scope !151, !noalias !152
  store <4 x float> %wide.load265.5, ptr %i.mo, align 4, !tbaa !17, !alias.scope !151, !noalias !152
  %i.mp = getelementptr inbounds nuw [4 x i8], ptr %i.s, i64 %i.mj ; 2 uses
  %i.mq = getelementptr inbounds nuw i8, ptr %i.mp, i64 16
  %wide.load266.5 = load <4 x float>, ptr %i.mp, align 4, !tbaa !17, !alias.scope !153
  %wide.load267.5 = load <4 x float>, ptr %i.mq, align 4, !tbaa !17, !alias.scope !153
  %i.mr = getelementptr inbounds nuw [4 x i8], ptr %.0124, i64 %i.mm ; 2 uses
  %i.ms = getelementptr inbounds nuw i8, ptr %i.mr, i64 16
  store <4 x float> %wide.load266.5, ptr %i.mr, align 4, !tbaa !17, !alias.scope !154, !noalias !155
  store <4 x float> %wide.load267.5, ptr %i.ms, align 4, !tbaa !17, !alias.scope !154, !noalias !155
...
vector.body262.6:                                 ; preds = %vector.body262.5
  ...
  %wide.load264.6 = load <4 x float>, ptr %i.mu, align 4, !tbaa !17, !alias.scope !150
  %wide.load265.6 = load <4 x float>, ptr %i.mv, align 4, !tbaa !17, !alias.scope !150
  ...
  store <4 x float> %wide.load264.6, ptr %i.mx, align 4, !tbaa !17, !alias.scope !151, !noalias !152
  store <4 x float> %wide.load265.6, ptr %i.my, align 4, !tbaa !17, !alias.scope !151, !noalias !152
  %i.mz = getelementptr inbounds nuw [4 x i8], ptr %i.s, i64 %i.mt ; 2 uses
  %i.na = getelementptr inbounds nuw i8, ptr %i.mz, i64 16
  %wide.load266.6 = load <4 x float>, ptr %i.mz, align 4, !tbaa !17, !alias.scope !153
  %wide.load267.6 = load <4 x float>, ptr %i.na, align 4, !tbaa !17, !alias.scope !153
  %i.nb = getelementptr inbounds nuw [4 x i8], ptr %.0124, i64 %i.mw ; 2 uses
  %i.nc = getelementptr inbounds nuw i8, ptr %i.nb, i64 16
  store <4 x float> %wide.load266.6, ptr %i.nb, align 4, !tbaa !17, !alias.scope !154, !noalias !155
  store <4 x float> %wide.load267.6, ptr %i.nc, align 4, !tbaa !17, !alias.scope !154, !noalias !155
...
vector.body262.7:                                 ; preds = %vector.body262.6
  ...
  %wide.load264.7 = load <4 x float>, ptr %i.ne, align 4, !tbaa !17, !alias.scope !150
  %wide.load265.7 = load <4 x float>, ptr %i.nf, align 4, !tbaa !17, !alias.scope !150
  ...
  store <4 x float> %wide.load264.7, ptr %i.nh, align 4, !tbaa !17, !alias.scope !151, !noalias !152
  store <4 x float> %wide.load265.7, ptr %i.ni, align 4, !tbaa !17, !alias.scope !151, !noalias !152
  %i.nj = getelementptr inbounds nuw [4 x i8], ptr %i.s, i64 %i.nd ; 2 uses
  %i.nk = getelementptr inbounds nuw i8, ptr %i.nj, i64 16
  %wide.load266.7 = load <4 x float>, ptr %i.nj, align 4, !tbaa !17, !alias.scope !153
  %wide.load267.7 = load <4 x float>, ptr %i.nk, align 4, !tbaa !17, !alias.scope !153
  %i.nl = getelementptr inbounds nuw [4 x i8], ptr %.0124, i64 %i.ng ; 2 uses
  %i.nm = getelementptr inbounds nuw i8, ptr %i.nl, i64 16
  store <4 x float> %wide.load266.7, ptr %i.nl, align 4, !tbaa !17, !alias.scope !154, !noalias !155
  store <4 x float> %wide.load267.7, ptr %i.nm, align 4, !tbaa !17, !alias.scope !154, !noalias !155
...
scalar.ph258.preheader:                           ; preds = %.preheader139, %middle.block269
  ...
  br i1 %3, label %scalar.ph258.prol, label %scalar.ph258.prol.loopexit
...
vector.body295:                                   ; preds = %vector.body295, %vector.ph293
  ...
  %wide.load297 = load <4 x float>, ptr %gep309, align 4, !tbaa !17
  %wide.load298 = load <4 x float>, ptr %i.oh, align 4, !tbaa !17
  %i.oi = fadd <4 x float> %wide.load297, splat (float -1.000000e+00)
  %i.oj = fadd <4 x float> %wide.load298, splat (float -1.000000e+00)
  store <4 x float> %i.oi, ptr %gep309, align 4, !tbaa !17
  store <4 x float> %i.oj, ptr %i.oh, align 4, !tbaa !17
  %index.next299 = add nuw i64 %index296, 8       ; 2 uses
  %i.ok = icmp eq i64 %index.next299, %n.vec294
  br i1 %i.ok, label %middle.block300, label %vector.body295, !llvm.loop !137
...
scalar.ph291:                                     ; preds = %scalar.ph291.preheader, %scalar.ph291
  ...
  %i.ol = load float, ptr %gep, align 4, !tbaa !17
  %i.om = fadd float %i.ol, -1.000000e+00
  store float %i.om, ptr %gep, align 4, !tbaa !17
  %indvars.iv.next189 = add nsw i64 %indvars.iv188, 1 ; 2 uses
  %exitcond192.not = icmp eq i64 %indvars.iv.next189, %i.ob
  br i1 %exitcond192.not, label %..preheader_crit_edge.us.us, label %scalar.ph291, !llvm.loop !138
...
vector.body284:                                   ; preds = %vector.body284, %vector.ph274
  ...
  %wide.load286 = load <4 x float>, ptr %gep311, align 4, !tbaa !17
  ...
  store <4 x float> %i.pa, ptr %gep311, align 4, !tbaa !17
  %index.next287 = add nuw i64 %index285, 4       ; 2 uses
  %vec.ind.next = add <4 x i32> %vec.ind, splat (i32 4)
  %i.pb = icmp eq i64 %index.next287, %n.vec275
  br i1 %i.pb, label %middle.block288, label %vector.body284, !llvm.loop !140
...
._crit_edge161.us.us:                             ; preds = %scalar.ph272, %middle.block288
  ...
  br i1 %exitcond202.not, label %._crit_edge164, label %.preheader137.us.us, !llvm.loop !141
...
scalar.ph258:                                     ; preds = %scalar.ph258.prol.loopexit, %scalar.ph258
  ...
  store float %i.pj, ptr %i.pk, align 4, !tbaa !17
  ...
  br i1 %exitcond182.not.1, label %._crit_edge, label %scalar.ph258, !llvm.loop !142
...
._crit_edge:                                      ; preds = %scalar.ph258.prol.loopexit, %scalar.ph258, %middle.block269
  ...
  br i1 %exitcond187.not, label %.preheader138, label %.preheader139, !llvm.loop !143

._crit_edge164:                                   ; preds = %._crit_edge161.us.us, %.preheader137.lr.ph, %.preheader138
  store ptr %.0125, ptr getelementptr inbounds nuw (i8, ptr @hexblep, i64 8), align 8, !tbaa !28
  store ptr %.0124, ptr getelementptr inbounds nuw (i8, ptr @hexblep, i64 16), align 8, !tbaa !29
  store i32 %spec.store.select135, ptr @hexblep, align 8, !tbaa !23
