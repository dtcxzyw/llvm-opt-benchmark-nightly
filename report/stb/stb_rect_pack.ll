...
bb.d:                                             ; preds = %bb.c
  ...
  %i.o = load ptr, ptr %i.c, align 8, !tbaa !27   ; 3 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  store ptr %i.j, ptr %i.r, align 8, !tbaa !19
  br label %bb.g
...
bb.h:                                             ; preds = %.lr.ph
  ...
  br i1 %.not, label %.critedge, label %.lr.ph, !llvm.loop !1

.critedge:                                        ; preds = %.lr.ph, %bb.h, %bb.g
  %.1.lcssa = phi ptr [ %.0, %bb.g ], [ %i.v, %bb.h ], [ %.146, %.lr.ph ] ; 3 uses
  store ptr %.1.lcssa, ptr %i.m, align 8, !tbaa !19
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  store i32 %i.h, ptr %i.g, align 4, !tbaa !31
  ...
  store i32 %i.k, ptr %i.j, align 4, !tbaa !31
  ...
  store i32 %i.q, ptr %i.p, align 4, !tbaa !31
  ...
  store i32 %i.t, ptr %i.s, align 4, !tbaa !31
  ...
  store i32 %i.w, ptr %i.v, align 4, !tbaa !31
...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  store i32 %i.ad, ptr %i.ac, align 4, !tbaa !31
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.bc = load ptr, ptr %i.as, align 8, !tbaa !27 ; 3 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  store ptr %i.ax, ptr %i.bf, align 8, !tbaa !19
  br label %bb.k

bb.j:                                             ; preds = %bb.h
  store ptr %i.ax, ptr %i.as, align 8, !tbaa !27
  br label %bb.k
...
bb.l:                                             ; preds = %.lr.ph.i
  ...
  store ptr %i.bm, ptr %i.bk, align 8, !tbaa !19
  ...
  br i1 %.not.i, label %.critedge.i, label %.lr.ph.i, !llvm.loop !1

.critedge.i:                                      ; preds = %bb.l, %.lr.ph.i, %bb.k
  %.1.lcssa.i = phi ptr [ %.0.i, %bb.k ], [ %.146.i, %.lr.ph.i ], [ %i.bj, %bb.l ] ; 3 uses
  store ptr %.1.lcssa.i, ptr %i.ba, align 8, !tbaa !19
...
stbrp__skyline_pack_rectangle.exit.thread:        ; preds = %bb.f, %bb.g, %bb.e
  ...
  store i32 2147483647, ptr %i.bs, align 4, !tbaa !43
  %i.bt = getelementptr inbounds nuw i8, ptr %i.ah, i64 12
  store i32 2147483647, ptr %i.bt, align 4, !tbaa !44
  br label %bb.n
...
bb.n:                                             ; preds = %stbrp__skyline_pack_rectangle.exit, %stbrp__skyline_pack_rectangle.exit.thread, %bb.d
  ...
  br i1 %exitcond69.not, label %._crit_edge58, label %bb.b, !llvm.loop !41
...
.lr.ph62:                                         ; preds = %bb.s, %._crit_edge58.new
  ...
  %i.bx = load i32, ptr %i.bw, align 4, !tbaa !44
...
.thread:                                          ; preds = %.lr.ph62
  ...
  store i32 1, ptr %i.bz, align 4, !tbaa !31
  br label %bb.p
...
bb.o:                                             ; preds = %.lr.ph62
  ...
  store i32 %i.cd, ptr %i.ce, align 4, !tbaa !31
...
.thread.1:                                        ; preds = %.lr.ph62.1
  ...
  store i32 1, ptr %i.ck, align 4, !tbaa !31
  br label %bb.r

bb.q:                                             ; preds = %.lr.ph62.1
  %i.cl = getelementptr inbounds nuw i8, ptr %i.cg, i64 40
  %i.cm = load i32, ptr %i.cl, align 4, !tbaa !43
...
bb.s:                                             ; preds = %bb.r, %bb.q
  ...
  br i1 %niter89.ncmp.1, label %._crit_edge63.loopexit.unr-lcssa, label %.lr.ph62, !llvm.loop !42

._crit_edge63.loopexit.unr-lcssa:                 ; preds = %bb.s
  %3 = trunc i32 %2 to i1
  br i1 %3, label %.lr.ph62.epil.preheader, label %._crit_edge63
...
.thread.epil:                                     ; preds = %.lr.ph62.epil.preheader
  ...
  store i32 1, ptr %i.cv, align 4, !tbaa !31
  br label %bb.u
...
!11 = !{!"p1 _ZTS10stbrp_node", !10, i64 0}
!12 = !{!"stbrp_context", !7, i64 0, !7, i64 4, !7, i64 8, !7, i64 12, !7, i64 16, !7, i64 20, !11, i64 24, !11, i64 32, !6, i64 40}
!13 = !{!12, !7, i64 12}
!14 = !{!12, !7, i64 16}
!15 = !{!12, !7, i64 0}
!16 = !{!12, !7, i64 20}
!17 = !{!12, !7, i64 8}
!18 = !{!"stbrp_node", !7, i64 0, !7, i64 4, !11, i64 8}
!19 = !{!18, !11, i64 8}
...
!26 = !{!18, !7, i64 4}
!27 = !{!11, !11, i64 0}
!28 = !{!"stbrp_rect", !7, i64 0, !7, i64 4, !7, i64 8, !7, i64 12, !7, i64 16, !7, i64 20}
!29 = !{!28, !7, i64 8}
!30 = !{!28, !7, i64 4}
!31 = !{!28, !7, i64 20}
!32 = distinct !{!32, !20}
