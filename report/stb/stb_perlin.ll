...
bb.a:
  ...
  %8 = insertelement <2 x i32> %7, i32 %4, i64 1  ; 2 uses
  ...
  %i.o = add nsw <2 x i32> %i.m, %i.f             ; 2 uses
  %i.p = add nsw <3 x i32> %i.n, %i.d             ; 2 uses
  %i.q = extractelement <3 x i32> %i.p, i64 0
  %i.r = srem i32 %i.q, %i.g                      ; 2 uses
  %i.s = icmp slt i32 %i.r, 0
  %i.t = select i1 %i.s, i32 %i.g, i32 0
  %spec.select = add nsw i32 %i.t, %i.r           ; 2 uses
  %.0125 = add nsw i32 %spec.select, 1
  %10 = srem i32 %.0125, %i.g
  %11 = select <2 x i1> %9, <2 x i32> splat (i32 256), <2 x i32> %8 ; 3 uses
  %12 = srem <2 x i32> %i.o, %11                  ; 2 uses
  %13 = icmp slt <2 x i32> %12, zeroinitializer
  %14 = select <2 x i1> %13, <2 x i32> %11, <2 x i32> zeroinitializer
  %15 = add nsw <2 x i32> %14, %12                ; 3 uses
  %16 = add nsw <2 x i32> %15, splat (i32 1)
  %17 = srem <2 x i32> %16, %11                   ; 2 uses
  ...
  %18 = extractelement <2 x i32> %15, i64 1       ; 2 uses
  %i.bb = add nsw i32 %18, %i.ar
  ...
  %20 = extractelement <2 x i32> %15, i64 0       ; 4 uses
  %i.bv = add nsw i32 %20, %i.bf
  ...
  %21 = extractelement <2 x i32> %17, i64 0       ; 4 uses
  %i.ce = add nsw i32 %21, %i.bf
