...
bb.a:
  ...
  %7 = fptosi float %0 to i32                     ; 2 uses
  %8 = insertelement <2 x float> poison, float %2, i64 0
  %9 = insertelement <2 x float> %8, float %1, i64 1 ; 3 uses
  %i.g = fptosi <2 x float> %9 to <2 x i32>       ; 2 uses
  %i.h = zext i8 %6 to i32                        ; 2 uses
  %i.i = sitofp <2 x i32> %i.g to <2 x float>
  %10 = sitofp i32 %7 to float
  %i.j = fcmp olt <2 x float> %9, %i.i
  %11 = fcmp olt float %0, %10
  %i.k = sext <2 x i1> %i.j to <2 x i32>
  %12 = sext i1 %11 to i32
  %i.l = add nsw <2 x i32> %i.k, %i.g             ; 3 uses
  %13 = add nsw i32 %12, %7                       ; 3 uses
  %i.m = and i32 %13, %i.b
  %i.n = add nsw i32 %13, 1
  %i.o = and i32 %i.n, %i.b
  ...
  %15 = fsub float %0, %14                        ; 6 uses
  %i.y = tail call float @llvm.fmuladd.f32(float %15, float 6.000000e+00, float -1.500000e+01)
  %i.z = tail call float @llvm.fmuladd.f32(float %i.y, float %15, float 1.000000e+01)
  %i.aa = fmul float %15, %i.z
  %i.ab = fmul float %15, %i.aa
  %i.ac = fmul float %15, %i.ab
  %i.ad = fsub <2 x float> %9, %i.x               ; 8 uses
  ...
  %i.dc = shufflevector <2 x float> %16, <2 x float> poison, <2 x i32> zeroinitializer
...
bb.a:
  ...
  %8 = insertelement <2 x float> poison, float %2, i64 0
  %9 = insertelement <2 x float> %8, float %1, i64 1 ; 3 uses
  %i.a = fptosi <2 x float> %9 to <2 x i32>       ; 2 uses
  %.not = icmp eq i32 %3, 0
  ...
  %10 = sitofp i32 %7 to float
  %i.g = fcmp olt <2 x float> %9, %i.f
  %11 = fcmp olt float %0, %10
  %i.h = sext <2 x i1> %i.g to <2 x i32>
  %12 = sext i1 %11 to i32
  %i.i = add nsw <2 x i32> %i.h, %i.a             ; 3 uses
  %13 = add nsw i32 %12, %7                       ; 2 uses
  %i.j = srem i32 %13, %i.b                       ; 2 uses
  ...
  %14 = sitofp i32 %13 to float
  %15 = fsub float %0, %14                        ; 6 uses
  %i.ab = tail call float @llvm.fmuladd.f32(float %15, float 6.000000e+00, float -1.500000e+01)
  %i.ac = tail call float @llvm.fmuladd.f32(float %i.ab, float %15, float 1.000000e+01)
  %i.ad = fmul float %15, %i.ac
  %i.ae = fmul float %15, %i.ad
  %i.af = fmul float %15, %i.ae
  %i.ag = fsub <2 x float> %9, %i.aa              ; 8 uses
  ...
  %16 = insertelement <2 x float> poison, float %15, i64 0
  %i.dn = shufflevector <2 x float> %16, <2 x float> poison, <2 x i32> zeroinitializer
