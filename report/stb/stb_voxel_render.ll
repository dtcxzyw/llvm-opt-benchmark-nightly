...
bb.b:                                             ; preds = %bb.a
  ...
  %i.bm = load ptr, ptr %i.bl, align 8, !tbaa !65 ; 6 uses
  %.not829 = icmp eq ptr %i.bm, null
  %i.bn = getelementptr inbounds nuw i8, ptr %0, i64 336
  %i.bo = load ptr, ptr %i.bn, align 8, !tbaa !69 ; 2 uses
...
.loopexit910:                                     ; preds = %bb.a
  ...
  %.pre = load ptr, ptr %.phi.trans.insert, align 8, !tbaa !69 ; 2 uses
...
bb.h:                                             ; preds = %.loopexit
  ...
  %i.ev = load i16, ptr %i.eu, align 2, !tbaa !56
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.fr = load i16, ptr %i.fq, align 2, !tbaa !56
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.gm = load i16, ptr %i.gl, align 2, !tbaa !56
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.ir = load i16, ptr %i.iq, align 2, !tbaa !56
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.ja = load ptr, ptr %i.iz, align 8, !tbaa !65 ; 3 uses
...
bb.v:                                             ; preds = %bb.t
  %i.jd = load i32, ptr %i.iy, align 8, !tbaa !66
  %i.je = trunc i32 %i.jd to i8
  %i.jf = getelementptr inbounds nuw i8, ptr %0, i64 144
  %i.jg = load ptr, ptr %i.jf, align 8, !tbaa !67 ; 2 uses
...
begin_hunk_1_@stbvox_make_mesh_for_block_with_geo:bb.a
  ...
  %i.pe = load i32, ptr %i.pd, align 4, !tbaa !19
  %i.pf = load <4 x i32>, ptr getelementptr inbounds nuw (i8, ptr @stbvox_vmesh_pre_vheight, i64 64), align 16, !tbaa !19
  ...
  store <4 x i32> %i.pk, ptr %i.om, align 16, !tbaa !19
  ...
  %i.pq = load i32, ptr %i.pp, align 4, !tbaa !19
  ...
  %i.px = load i32, ptr %i.pw, align 4, !tbaa !19
  ...
  %i.qd = load i32, ptr %i.qc, align 4, !tbaa !19
  ...
  %i.qj = load i32, ptr %i.qi, align 4, !tbaa !19
  %i.qk = load <4 x i32>, ptr getelementptr inbounds nuw (i8, ptr @stbvox_vmesh_pre_vheight, i64 80), align 16, !tbaa !19
  ...
  store <4 x i32> %i.qp, ptr %i.pr, align 16, !tbaa !19
...
bb.aa:                                            ; preds = %bb.y
  ...
  %i.qw = load ptr, ptr %i.qv, align 8, !tbaa !67 ; 2 uses
...
bb.ac:                                            ; preds = %bb.aa, %bb.ab, %bb.z
  ...
  %i.rm = load ptr, ptr %i.rl, align 8, !tbaa !15
...
bb.az:                                            ; preds = %bb.ac
  ...
  store i32 1, ptr %i.ss, align 4, !tbaa !68
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #14
  br label %bb.cs
...
bb.bd:                                            ; preds = %bb.bb
  ...
  %i.ti = load ptr, ptr %i.th, align 8, !tbaa !74 ; 2 uses
...
bb.bf:                                            ; preds = %bb.bd
  %i.uo = load ptr, ptr %i.dz, align 8, !tbaa !69 ; 5 uses
...
bb.bh:                                            ; preds = %bb.bf
  %i.vk = load ptr, ptr %i.am, align 8, !tbaa !71 ; 5 uses
...
begin_hunk_2_@stbvox_make_mesh_for_block_with_geo:bb.a
  ...
  %i.aci = load i32, ptr %i.ach, align 4, !tbaa !19
  %i.acj = load <4 x i32>, ptr getelementptr inbounds nuw (i8, ptr @stbvox_vmesh_pre_vheight, i64 80), align 16, !tbaa !19
  ...
  store <4 x i32> %i.aco, ptr %i.abw, align 16, !tbaa !19
  ...
  %i.ade = load ptr, ptr %i.add, align 8, !tbaa !15
...
.thread900:                                       ; preds = %.thread1026
  ...
  store i32 1, ptr %i.adf, align 4, !tbaa !68
...
bb.bm:                                            ; preds = %bb.bl
  %i.adh = add nuw nsw i32 %.1043, %.1044
  %i.adi = add nuw nsw i32 %.1042, %.1045
...
bb.br:                                            ; preds = %bb.bq
  %i.adv = add nuw nsw i32 %.1039, %.1040
  %i.adw = add nuw nsw i32 %., %.1041
...
bb.bw:                                            ; preds = %.thread1030, %.thread882, %.thread884, %bb.bt, %bb.bu, %bb.bv, %bb.bp
  ...
  %i.aek = load ptr, ptr %i.aej, align 8, !tbaa !70 ; 2 uses
...
bb.by:                                            ; preds = %bb.bw
  %i.aeo = load ptr, ptr %i.iz, align 8, !tbaa !65
...
bb.cf:                                            ; preds = %.thread887
  br i1 %i.wr, label %.thread893, label %.thread894
...
bb.cg:                                            ; preds = %.thread887, %.thread893, %.thread891
  ...
  %or.cond908 = select i1 %i.wr, i1 %or.cond25.old, i1 false
...
bb.cj:                                            ; preds = %bb.ci
  ...
  %i.aff = load i32, ptr %i.iy, align 8, !tbaa !66
  %i.afg = trunc i32 %i.aff to i8
  %i.afh = load ptr, ptr %i.iz, align 8, !tbaa !65 ; 2 uses
...
bb.cl:                                            ; preds = %bb.ck, %bb.cj
  ...
  %i.afp = load ptr, ptr %i.afo, align 8, !tbaa !67 ; 2 uses
...
bb.a:
  ...
  %i.e = load i32, ptr %i.d, align 8, !tbaa !63   ; 4 uses
