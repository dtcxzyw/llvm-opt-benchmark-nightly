...
.lr.ph.i344:                                      ; preds = %bb.an, %.lr.ph.preheader.i342.new
  ...
  %.02633.i346 = phi i32 [ 0, %.lr.ph.preheader.i342.new ], [ %.127.i348.3, %bb.an ] ; 2 uses
...
bb.aj:                                            ; preds = %.lr.ph.i344
  ...
  %i.fe = add nsw i32 %i.fd, %.02633.i346
  br label %.lr.ph.i344.1

.lr.ph.i344.1:                                    ; preds = %bb.aj, %.lr.ph.i344
  %.127.i348 = phi i32 [ %i.fe, %bb.aj ], [ %.02633.i346, %.lr.ph.i344 ] ; 2 uses
...
bb.ak:                                            ; preds = %.lr.ph.i344.1
  ...
  %i.fh = add nsw i32 %i.fg, %.127.i348
  br label %.lr.ph.i344.2

.lr.ph.i344.2:                                    ; preds = %bb.ak, %.lr.ph.i344.1
  %.127.i348.1 = phi i32 [ %i.fh, %bb.ak ], [ %.127.i348, %.lr.ph.i344.1 ] ; 2 uses
...
bb.al:                                            ; preds = %.lr.ph.i344.2
  ...
  %i.fk = add nsw i32 %i.fj, %.127.i348.1
  br label %.lr.ph.i344.3

.lr.ph.i344.3:                                    ; preds = %bb.al, %.lr.ph.i344.2
  %.127.i348.2 = phi i32 [ %i.fk, %bb.al ], [ %.127.i348.1, %.lr.ph.i344.2 ] ; 2 uses
...
bb.am:                                            ; preds = %.lr.ph.i344.3
  ...
  %i.fn = add nsw i32 %i.fm, %.127.i348.2
  br label %bb.an

bb.an:                                            ; preds = %bb.am, %.lr.ph.i344.3
  %.127.i348.3 = phi i32 [ %i.fn, %bb.am ], [ %.127.i348.2, %.lr.ph.i344.3 ] ; 3 uses
...
.lr.ph.i344.epil.preheader:                       ; preds = %._crit_edge.i351.unr-lcssa, %.lr.ph.preheader.i342
  ...
  %.02633.i346.epil.init = phi i32 [ 0, %.lr.ph.preheader.i342 ], [ %.127.i348.3, %._crit_edge.i351.unr-lcssa ]
...
.lr.ph.i344.epil:                                 ; preds = %bb.ap, %.lr.ph.i344.epil.preheader
  ...
  %.02633.i346.epil = phi i32 [ %.02633.i346.epil.init, %.lr.ph.i344.epil.preheader ], [ %.127.i348.epil, %bb.ap ] ; 2 uses
...
bb.ao:                                            ; preds = %.lr.ph.i344.epil
  ...
  %i.fq = add nsw i32 %i.fp, %.02633.i346.epil
  br label %bb.ap

bb.ap:                                            ; preds = %bb.ao, %.lr.ph.i344.epil
  %.127.i348.epil = phi i32 [ %i.fq, %bb.ao ], [ %.02633.i346.epil, %.lr.ph.i344.epil ] ; 2 uses
...
._crit_edge.i351:                                 ; preds = %bb.ap, %._crit_edge.i351.unr-lcssa
  %.127.i348.lcssa = phi i32 [ %.127.i348.3, %._crit_edge.i351.unr-lcssa ], [ %.127.i348.epil, %bb.ap ]
  %i.fr = tail call i32 @rand() #16
  %i.fs = ashr i32 %i.fr, 4
  %i.ft = srem i32 %i.fs, %.127.i348.lcssa
...
.lr.ph38.i353:                                    ; preds = %bb.ar, %._crit_edge.i351
  ...
  %.235.i355 = phi i32 [ 0, %._crit_edge.i351 ], [ %.3.i357, %bb.ar ] ; 2 uses
...
bb.aq:                                            ; preds = %.lr.ph38.i353
  ...
  %i.fw = add nsw i32 %i.fv, %.235.i355           ; 2 uses
  %i.fx = icmp slt i32 %i.ft, %i.fw
  br i1 %i.fx, label %.loopexit.loopexit.split.loop.exit52.i360, label %bb.ar

bb.ar:                                            ; preds = %bb.aq, %.lr.ph38.i353
  %.3.i357 = phi i32 [ %i.fw, %bb.aq ], [ %.235.i355, %.lr.ph38.i353 ]
...
.loopexit.loopexit.split.loop.exit52.i360:        ; preds = %bb.aq
  %i.gf = trunc nuw nsw i64 %indvars.iv43.i354 to i32
  br label %stbhw__change_color.exit361

stbhw__change_color.exit361:                      ; preds = %bb.ar, %.thread418, %.loopexit.loopexit.split.loop.exit52.i360
  %.0.i341 = phi i32 [ %i.ge, %.thread418 ], [ %i.gf, %.loopexit.loopexit.split.loop.exit52.i360 ], [ %i.ev, %bb.ar ]
...
bb.at:                                            ; preds = %.lr.ph474, %._crit_edge469
  %indvars.iv529 = phi i64 [ %i.gq, %.lr.ph474 ], [ %indvars.iv.next530, %._crit_edge469 ] ; 4 uses
  %indvars.iv527 = phi i64 [ -1, %.lr.ph474 ], [ %indvars.iv.next528, %._crit_edge469 ] ; 3 uses
  %i.gr = trunc nsw i64 %indvars.iv527 to i32     ; 2 uses
  %i.gs = and i32 %i.gr, 3
  %i.gt = icmp eq i32 %i.gs, 0
  %i.gu = or i32 %i.gr, -4
  %.2264 = select i1 %i.gt, i32 0, i32 %i.gu      ; 2 uses
  %i.gv = mul nsw i32 %.2264, %i.b                ; 2 uses
  %.not303466 = icmp slt i32 %i.gv, %4
  br i1 %.not303466, label %.lr.ph, label %._crit_edge469

.lr.ph:                                           ; preds = %bb.at
  %i.gw = getelementptr [106 x i8], ptr @c_color, i64 %indvars.iv527 ; 3 uses
  ...
  %i.ha = sext i32 %.2264 to i64
  %i.hb = sext i32 %i.gv to i64
  %i.hc = trunc nsw i64 %indvars.iv529 to i32
  br label %bb.au
...
.lr.ph33.split.us.i:                              ; preds = %..loopexit_crit_edge.us.i, %.lr.ph33.split.us.preheader.i
  ...
  %i.hv = add nuw nsw i64 %indvars.iv36.i, %indvars.iv529 ; 2 uses
  %8 = icmp samesign ult i64 %i.hv, %6
  br i1 %8, label %.preheader.us.i, label %..loopexit_crit_edge.us.i
...
.lr.ph33.split.us.i371:                           ; preds = %..loopexit_crit_edge.us.i374, %.lr.ph33.split.us.preheader.i368
  ...
  %i.ix = add nsw i64 %indvars.iv36.i372, %indvars.iv529 ; 3 uses
  %i.iy = icmp sgt i64 %i.ix, -1
  %i.iz = icmp slt i64 %i.ix, %7
...
._crit_edge469:                                   ; preds = %.loopexit451, %bb.at
  %indvars.iv.next530 = add nsw i64 %indvars.iv529, %i.gp ; 2 uses
  %indvars.iv.next528 = add nsw i64 %indvars.iv527, 1
  %.not306 = icmp slt i64 %indvars.iv.next530, %7
...
bb.bg:                                            ; preds = %.lr.ph484, %._crit_edge479
  ...
  %i.kb = or i32 %i.jy, -4
  %.0269 = select i1 %i.ka, i32 0, i32 %i.kb      ; 2 uses
  %i.kc = mul nsw i32 %.0269, %i.b                ; 2 uses
...
.lr.ph33.split.us.i387:                           ; preds = %..loopexit_crit_edge.us.i390, %.lr.ph33.split.us.preheader.i384
  ...
  %i.lg = add nuw nsw i64 %indvars.iv36.i388, %indvars.iv537 ; 2 uses
  %11 = icmp samesign ult i64 %i.lg, %9
  br i1 %11, label %.preheader.us.i393, label %..loopexit_crit_edge.us.i390
...
._crit_edge479:                                   ; preds = %.loopexit, %bb.bg
  ...
  %.not302 = icmp slt i64 %indvars.iv.next538, %10
