...
begin_hunk_0_@stbhw__corner_process_h_rect:bb.a
  ...
  br i1 %i.gd, label %middle.block322, label %vector.body318, !llvm.loop !181
...
vec.epilog.iter.check327:                         ; preds = %middle.block322
  ...
  br i1 %min.epilog.iters.check328, label %vec.epilog.scalar.ph326.preheader, label %vec.epilog.ph329, !prof !70
...
vec.epilog.ph329:                                 ; preds = %vector.main.loop.iter.check308, %vec.epilog.iter.check327
  ...
  %i.gf = load i8, ptr %i.eo, align 1, !tbaa !45, !alias.scope !198
  ...
  %i.gh = load i8, ptr %i.ep, align 1, !tbaa !45, !alias.scope !198
  ...
  %i.gj = load i8, ptr %i.eq, align 1, !tbaa !45, !alias.scope !198
...
vec.epilog.vector.body337:                        ; preds = %vec.epilog.vector.body337, %vec.epilog.ph329
  ...
  store <6 x i8> %interleaved.vec339, ptr %i.gv, align 1, !alias.scope !199, !noalias !198
  %index.next340 = add nuw i64 %index338, 2       ; 2 uses
  %i.gw = icmp eq i64 %index.next340, %n.vec330
  br i1 %i.gw, label %vec.epilog.middle.block341, label %vec.epilog.vector.body337, !llvm.loop !182
...
vec.epilog.scalar.ph326:                          ; preds = %vec.epilog.scalar.ph326.preheader, %vec.epilog.scalar.ph326
  ...
  %i.gy = load i8, ptr %i.eo, align 1, !tbaa !45
  ...
  %i.he = load <2 x i8>, ptr %i.ep, align 1, !tbaa !45
  ...
  br i1 %exitcond39.not.i153, label %stbhw__draw_hline.exit162, label %vec.epilog.scalar.ph326, !llvm.loop !183

stbhw__draw_hline.exit162:                        ; preds = %vec.epilog.scalar.ph326, %vec.epilog.middle.block341, %middle.block322
  %i.hp = load ptr, ptr %i.e, align 8, !tbaa !67  ; 2 uses
  %i.hq = load i32, ptr %i.g, align 8, !tbaa !68  ; 2 uses
...
bb.d:                                             ; preds = %bb.d, %.lr.ph.i170.new
  ...
  br i1 %niter444.ncmp.1, label %._crit_edge.i163.loopexit.unr-lcssa, label %bb.d, !llvm.loop !18
...
bb.e:                                             ; preds = %bb.e, %.lr.ph32.i164
  ...
  %i.is = load i8, ptr %i.ik, align 1, !tbaa !45
  ...
  %i.iy = load <2 x i8>, ptr %i.il, align 1, !tbaa !45
  ...
  br i1 %exitcond41.not.i, label %stbhw__draw_vline.exit, label %bb.e, !llvm.loop !19

stbhw__draw_vline.exit:                           ; preds = %bb.e
  %i.ji = load ptr, ptr %i.e, align 8, !tbaa !67  ; 2 uses
  %i.jj = load i32, ptr %i.g, align 8, !tbaa !68  ; 2 uses
  %i.jk = shl nsw i32 %i.d, 1                     ; 6 uses
  ...
  %i.jp = load i32, ptr %i.jo, align 4, !tbaa !40
...
bb.f:                                             ; preds = %bb.f, %.lr.ph.i190.new
  ...
  br i1 %niter450.ncmp.1, label %._crit_edge.i175.loopexit.unr-lcssa, label %bb.f, !llvm.loop !18
...
bb.g:                                             ; preds = %bb.g, %.lr.ph32.i176
  ...
  %i.kl = load i8, ptr %i.ke, align 1, !tbaa !45
  ...
  %i.kr = load <2 x i8>, ptr %i.kf, align 1, !tbaa !45
  ...
  br i1 %exitcond41.not.i186, label %stbhw__draw_vline.exit197, label %bb.g, !llvm.loop !19

stbhw__draw_vline.exit197:                        ; preds = %bb.g
  %i.lb = load ptr, ptr %i.e, align 8, !tbaa !67  ; 4 uses
  %i.lc = load i32, ptr %i.g, align 8, !tbaa !68  ; 2 uses
  ...
  %i.li = load i32, ptr %i.lh, align 4, !tbaa !40
...
bb.h:                                             ; preds = %bb.h, %.lr.ph.i211.new
  ...
  br i1 %niter456.ncmp.1, label %._crit_edge.i198.loopexit.unr-lcssa, label %bb.h, !llvm.loop !17
...
vector.body406:                                   ; preds = %vector.body406, %vector.ph398
  ...
  store <48 x i8> %interleaved.vec408, ptr %i.rj, align 1, !alias.scope !203, !noalias !202
  %index.next409 = add nuw i64 %index407, 16      ; 2 uses
  %i.rk = icmp eq i64 %index.next409, %n.vec399
  br i1 %i.rk, label %middle.block410, label %vector.body406, !llvm.loop !193
...
vec.epilog.iter.check415:                         ; preds = %middle.block410
  ...
  br i1 %min.epilog.iters.check416, label %vec.epilog.scalar.ph414.preheader, label %vec.epilog.ph417, !prof !70
...
vec.epilog.ph417:                                 ; preds = %vector.main.loop.iter.check396, %vec.epilog.iter.check415
  ...
  %i.rm = load i8, ptr %i.pw, align 1, !tbaa !45, !alias.scope !202
  ...
  %i.ro = load i8, ptr %i.px, align 1, !tbaa !45, !alias.scope !202
  ...
  %i.rq = load i8, ptr %i.py, align 1, !tbaa !45, !alias.scope !202
...
vec.epilog.vector.body425:                        ; preds = %vec.epilog.vector.body425, %vec.epilog.ph417
  ...
  store <6 x i8> %interleaved.vec427, ptr %i.sc, align 1, !alias.scope !203, !noalias !202
  %index.next428 = add nuw i64 %index426, 2       ; 2 uses
  %i.sd = icmp eq i64 %index.next428, %n.vec418
  br i1 %i.sd, label %vec.epilog.middle.block429, label %vec.epilog.vector.body425, !llvm.loop !194
...
vec.epilog.scalar.ph414:                          ; preds = %vec.epilog.scalar.ph414.preheader, %vec.epilog.scalar.ph414
  ...
  %i.sf = load i8, ptr %i.pw, align 1, !tbaa !45
  ...
  %i.sl = load <2 x i8>, ptr %i.px, align 1, !tbaa !45
...
stbhw__draw_clipped_corner.exit:                  ; preds = %bb.j, %bb.k, %.split.us.2.i, %stbhw__draw_hline.exit235
  %i.tp = load ptr, ptr %i.a, align 8, !tbaa !34
...
bb.l:                                             ; preds = %stbhw__draw_clipped_corner.exit
  %i.tt = load ptr, ptr %i.e, align 8, !tbaa !67  ; 2 uses
  %i.tu = load i32, ptr %i.g, align 8, !tbaa !68
...
bb.o:                                             ; preds = %stbhw__draw_clipped_corner.exit240
  %i.us = load ptr, ptr %i.e, align 8, !tbaa !67  ; 2 uses
  %i.ut = load i32, ptr %i.g, align 8, !tbaa !68
  %i.uu = or disjoint i32 %i.jk, 1
  %i.uv = add nsw i32 %i.uu, %1
  %i.uw = sext i32 %i.uv to i64                   ; 3 uses
  %i.ux = sext i32 %i.ut to i64                   ; 2 uses
  %i.uy = icmp slt i32 %i.d, 1
  br i1 %i.uy, label %stbhw__draw_clipped_corner.exit253, label %bb.p

bb.p:                                             ; preds = %bb.o
  %9 = mul nsw i64 %i.ux, %i.ip
  %10 = getelementptr inbounds i8, ptr %i.us, i64 %9 ; 2 uses
  %11 = mul nsw i64 %i.uw, 3
  %12 = getelementptr i8, ptr %10, i64 %11
  %13 = getelementptr i8, ptr %12, i64 -6
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(3) %13, ptr noundef nonnull readonly align 1 dereferenceable(3) @__const.stbhw__draw_clipped_corner.template_color, i64 3, i1 false)
  %i.uz = mul nsw i64 %i.uw, 3
  %i.va = getelementptr i8, ptr %10, i64 %i.uz
  ...
  %14 = icmp eq i32 %i.d, 1
  br i1 %14, label %stbhw__draw_clipped_corner.exit253, label %bb.q

bb.q:                                             ; preds = %bb.p
  %15 = add nsw i64 %i.ip, 1
  %16 = mul nsw i64 %15, %i.ux
  %17 = getelementptr inbounds i8, ptr %i.us, i64 %16
  %i.vc = mul nsw i64 %i.uw, 3
  %i.vd = getelementptr i8, ptr %17, i64 %i.vc
...
stbhw__draw_clipped_corner.exit253:               ; preds = %bb.o, %bb.q, %bb.p, %stbhw__draw_clipped_corner.exit240
  %i.vf = load ptr, ptr %i.a, align 8, !tbaa !34
  %i.vg = getelementptr inbounds nuw i8, ptr %i.vf, i64 40
  %i.vh = getelementptr inbounds [4 x i8], ptr %i.vg, i64 %i.hs
  %i.vi = load i32, ptr %i.vh, align 4, !tbaa !40
...
bb.r:                                             ; preds = %stbhw__draw_clipped_corner.exit253
  %i.vj = load ptr, ptr %i.e, align 8, !tbaa !67  ; 2 uses
  %i.vk = load i32, ptr %i.g, align 8, !tbaa !68
...
bb.t:                                             ; preds = %bb.s, %stbhw__draw_clipped_corner.exit266
  ...
  %i.wg = load i32, ptr %i.wf, align 4, !tbaa !40
...
bb.v:                                             ; preds = %bb.u, %bb.t
  ...
  %i.wp = load ptr, ptr %i.e, align 8, !tbaa !67
  %i.wq = load i32, ptr %i.g, align 8, !tbaa !68
  ...
  %i.wy = load ptr, ptr %i.e, align 8, !tbaa !67
  %i.wz = load i32, ptr %i.g, align 8, !tbaa !68
  ...
  %i.xf = load ptr, ptr %i.e, align 8, !tbaa !67
  %i.xg = load i32, ptr %i.g, align 8, !tbaa !68
  ...
  %i.xm = load ptr, ptr %i.e, align 8, !tbaa !67
  %i.xn = load i32, ptr %i.g, align 8, !tbaa !68
...
bb.g:                                             ; preds = %bb.g, %.lr.ph.i194.new
  ...
  br i1 %niter380.ncmp.1, label %._crit_edge.i179.loopexit.unr-lcssa, label %bb.g, !llvm.loop !18
...
bb.h:                                             ; preds = %bb.h, %.lr.ph32.i180
  ...
  %i.ib = load i8, ptr %i.hv, align 1, !tbaa !45
  ...
  %i.ih = load <2 x i8>, ptr %i.hw, align 1, !tbaa !45
...
stbhw__draw_vline.exit201:                        ; preds = %bb.h
  %i.ir = load ptr, ptr %i.e, align 8, !tbaa !67  ; 2 uses
  %i.is = load i32, ptr %i.g, align 8, !tbaa !68  ; 2 uses
...
bb.i:                                             ; preds = %bb.i, %.lr.ph.i217.new
  ...
  br i1 %niter386.ncmp.1, label %._crit_edge.i202.loopexit.unr-lcssa, label %bb.i, !llvm.loop !18
...
bb.j:                                             ; preds = %bb.j, %.lr.ph32.i203
  ...
  %i.jo = load i8, ptr %i.jj, align 1, !tbaa !45
  ...
  %i.ju = load <2 x i8>, ptr %i.jk, align 1, !tbaa !45
...
stbhw__draw_vline.exit224:                        ; preds = %bb.j
  %i.ke = load ptr, ptr %i.e, align 8, !tbaa !67  ; 4 uses
  %i.kf = load i32, ptr %i.g, align 8, !tbaa !68  ; 2 uses
  %i.kg = shl nsw i32 %i.d, 1                     ; 7 uses
  ...
  %i.kk = load i32, ptr %i.kj, align 4, !tbaa !40
...
bb.k:                                             ; preds = %bb.k, %.lr.ph.i238.new
  ...
  br i1 %niter392.ncmp.1, label %._crit_edge.i225.loopexit.unr-lcssa, label %bb.k, !llvm.loop !17
...
vector.ph328:                                     ; preds = %vector.main.loop.iter.check326
  ...
  %i.lu = load i8, ptr %i.lc, align 1, !tbaa !45, !alias.scope !218
  ...
  %i.ma = load i8, ptr %i.ld, align 1, !tbaa !45, !alias.scope !218
  ...
  %i.mg = load i8, ptr %i.le, align 1, !tbaa !45, !alias.scope !218
...
vector.body336:                                   ; preds = %vector.body336, %vector.ph328
  ...
  store <48 x i8> %interleaved.vec338, ptr %i.mp, align 1, !alias.scope !219, !noalias !218
  %index.next339 = add nuw i64 %index337, 16      ; 2 uses
  %i.mq = icmp eq i64 %index.next339, %n.vec329
  br i1 %i.mq, label %middle.block340, label %vector.body336, !llvm.loop !213
...
vec.epilog.iter.check345:                         ; preds = %middle.block340
  ...
  br i1 %min.epilog.iters.check346, label %vec.epilog.scalar.ph344.preheader, label %vec.epilog.ph347, !prof !70
...
vec.epilog.ph347:                                 ; preds = %vector.main.loop.iter.check326, %vec.epilog.iter.check345
  ...
  %i.ms = load i8, ptr %i.lc, align 1, !tbaa !45, !alias.scope !218
  ...
  %i.mu = load i8, ptr %i.ld, align 1, !tbaa !45, !alias.scope !218
  ...
  %i.mw = load i8, ptr %i.le, align 1, !tbaa !45, !alias.scope !218
...
vec.epilog.vector.body355:                        ; preds = %vec.epilog.vector.body355, %vec.epilog.ph347
  ...
  store <6 x i8> %interleaved.vec357, ptr %i.ni, align 1, !alias.scope !219, !noalias !218
  %index.next358 = add nuw i64 %index356, 2       ; 2 uses
  %i.nj = icmp eq i64 %index.next358, %n.vec348
  br i1 %i.nj, label %vec.epilog.middle.block359, label %vec.epilog.vector.body355, !llvm.loop !214
...
vec.epilog.scalar.ph344:                          ; preds = %vec.epilog.scalar.ph344.preheader, %vec.epilog.scalar.ph344
  ...
  %i.nl = load i8, ptr %i.lc, align 1, !tbaa !45
  ...
  %i.nr = load <2 x i8>, ptr %i.ld, align 1, !tbaa !45
...
bb.o:                                             ; preds = %stbhw__draw_clipped_corner.exit
  %i.oz = load ptr, ptr %i.e, align 8, !tbaa !67  ; 6 uses
  %i.pa = load i32, ptr %i.g, align 8, !tbaa !68
...
bb.r:                                             ; preds = %stbhw__draw_clipped_corner.exit248
  %i.qk = or disjoint i32 %i.kg, 1                ; 2 uses
  %i.ql = icmp slt i32 %i.qk, 3
  br i1 %i.ql, label %stbhw__draw_clipped_corner.exit262, label %.preheader.split.split.preheader.1.i253

.preheader.split.split.preheader.1.i253:          ; preds = %bb.r
  %9 = load i32, ptr %i.g, align 8, !tbaa !68
  %10 = sext i32 %9 to i64                        ; 2 uses
  %11 = add nsw i32 %i.qk, %2
  %12 = sext i32 %11 to i64                       ; 2 uses
  %13 = load ptr, ptr %i.e, align 8, !tbaa !67    ; 2 uses
  %14 = add nsw i64 %12, -2
  %15 = mul nsw i64 %14, %10
  %16 = getelementptr inbounds i8, ptr %13, i64 %15
  %17 = mul nsw i64 %i.au, 3
  %18 = getelementptr inbounds i8, ptr %16, i64 %17
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(3) %18, ptr noundef nonnull readonly align 1 dereferenceable(3) @__const.stbhw__draw_clipped_corner.template_color, i64 3, i1 false)
  %i.qm = add nsw i64 %12, -1
  %i.qn = mul nsw i64 %i.qm, %10
  %i.qo = getelementptr inbounds i8, ptr %13, i64 %i.qn
...
stbhw__draw_clipped_corner.exit262:               ; preds = %bb.r, %bb.s, %.preheader.split.split.preheader.1.i253, %stbhw__draw_clipped_corner.exit248
  %i.qt = load ptr, ptr %i.a, align 8, !tbaa !34
  %i.qu = getelementptr inbounds nuw i8, ptr %i.qt, i64 56
  %i.qv = getelementptr inbounds [4 x i8], ptr %i.qu, i64 %i.l
  %i.qw = load i32, ptr %i.qv, align 4, !tbaa !40
...
bb.t:                                             ; preds = %stbhw__draw_clipped_corner.exit262
  %i.qx = load ptr, ptr %i.e, align 8, !tbaa !67  ; 2 uses
  %i.qy = load i32, ptr %i.g, align 8, !tbaa !68
...
bb.y:                                             ; preds = %bb.x, %bb.w
  ...
  %i.sf = load ptr, ptr %i.e, align 8, !tbaa !67
  %i.sg = load i32, ptr %i.g, align 8, !tbaa !68
  ...
  %i.sm = load ptr, ptr %i.e, align 8, !tbaa !67
  %i.sn = load i32, ptr %i.g, align 8, !tbaa !68
  ...
  %i.st = load ptr, ptr %i.e, align 8, !tbaa !67
  %i.su = load i32, ptr %i.g, align 8, !tbaa !68
  ...
  %i.ta = load ptr, ptr %i.e, align 8, !tbaa !67
  %i.tb = load i32, ptr %i.g, align 8, !tbaa !68
  ...
  %i.th = load ptr, ptr %i.e, align 8, !tbaa !67
  %i.ti = load i32, ptr %i.g, align 8, !tbaa !68
...
bb.a:
  ...
  store ptr %spec.select, ptr %i.g, align 8, !tbaa !33
  %i.h = getelementptr inbounds nuw i8, ptr %5, i64 24
  store ptr %spec.select76, ptr %i.h, align 8, !tbaa !38
