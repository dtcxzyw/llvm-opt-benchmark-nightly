...
.thread124:                                       ; preds = %bb.d, %bb.e, %bb.f
  ...
  %i.az = load <2 x float>, ptr %1, align 4, !tbaa !80 ; 4 uses
  %foldExtExtBinop139 = fmul <2 x float> %i.az, %i.az
  %i.ba = extractelement <2 x float> %foldExtExtBinop139, i64 1
  %i.bb = extractelement <2 x float> %i.az, i64 0 ; 2 uses
  %i.bc = tail call float @llvm.fmuladd.f32(float %i.bb, float %i.bb, float %i.ba)
  %i.bd = fdiv float 1.000000e+00, %i.bc
  ...
  %i.bg = fmul <2 x float> %i.az, %i.bf           ; 4 uses
  %i.bh = load <2 x float>, ptr %2, align 4, !tbaa !80 ; 2 uses
  %i.bi = load <2 x float>, ptr %3, align 4, !tbaa !80 ; 2 uses
  %i.bj = shufflevector <2 x float> %i.bi, <2 x float> %i.bh, <2 x i32> <i32 1, i32 3>
  %i.bk = shufflevector <2 x float> %i.bg, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.bl = fmul <2 x float> %i.bj, %i.bk
  %i.bm = shufflevector <2 x float> %i.bi, <2 x float> %i.bh, <2 x i32> <i32 0, i32 2>
  %i.bn = shufflevector <2 x float> %i.bg, <2 x float> poison, <2 x i32> zeroinitializer
  %i.bo = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bm, <2 x float> %i.bn, <2 x float> %i.bl) ; 2 uses
  %i.bp = load float, ptr %4, align 4, !tbaa !80
  %i.bq = load float, ptr %i.e, align 4, !tbaa !80
  %i.br = extractelement <2 x float> %i.bg, i64 1 ; 2 uses
  %i.bs = fmul float %i.br, %i.bq
  %i.bt = extractelement <2 x float> %i.bg, i64 0 ; 2 uses
  %i.bu = tail call float @llvm.fmuladd.f32(float %i.bp, float %i.bt, float %i.bs)
  %i.bv = load float, ptr %0, align 4, !tbaa !80
  %i.bw = load float, ptr %i.f, align 4, !tbaa !80
  %i.bx = fmul float %i.br, %i.bw
  %i.by = tail call float @llvm.fmuladd.f32(float %i.bv, float %i.bt, float %i.bx)
  %i.bz = extractelement <2 x float> %i.bo, i64 0
  %i.ca = extractelement <2 x float> %i.bo, i64 1 ; 3 uses
  %i.cb = fsub float %i.bz, %i.ca                 ; 2 uses
  %i.cc = fsub float %i.bu, %i.ca
  %i.cd = fsub float %i.ca, %i.by                 ; 2 uses
  %i.ce = tail call float @llvm.fmuladd.f32(float %.3110128, float -2.000000e+00, float 2.000000e+00)
  %i.cf = fmul float %.3110128, %i.ce
  %i.cg = fmul float %.3110128, %.3110128
  %i.ch = tail call float @llvm.fmuladd.f32(float %i.cf, float %i.cb, float %i.cd)
  %i.ci = insertelement <2 x float> poison, float %i.ac, i64 1 ; 2 uses
  %i.cj = insertelement <2 x float> %i.ci, float %i.cg, i64 0
  %i.ck = insertelement <2 x float> poison, float %i.cc, i64 0 ; 2 uses
  %i.cl = insertelement <2 x float> %i.ck, float %.3110128, i64 1
  %i.cm = insertelement <2 x float> poison, float %i.ad, i64 1 ; 2 uses
  %i.cn = insertelement <2 x float> %i.cm, float %i.ch, i64 0
  %i.co = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cj, <2 x float> %i.cl, <2 x float> %i.cn)
  store <2 x float> %i.co, ptr %5, align 4, !tbaa !80
  br i1 %.3130, label %bb.g, label %.thread

bb.g:                                             ; preds = %.thread124
  %i.cp = tail call float @llvm.fmuladd.f32(float %.1106129, float -2.000000e+00, float 2.000000e+00)
  %i.cq = fmul float %.1106129, %i.cp
  %i.cr = fmul float %.1106129, %.1106129
  %i.cs = getelementptr inbounds nuw i8, ptr %5, i64 8
  %i.ct = tail call float @llvm.fmuladd.f32(float %i.cq, float %i.cb, float %i.cd)
  %i.cu = insertelement <2 x float> %i.ci, float %i.cr, i64 0
  %i.cv = insertelement <2 x float> %i.ck, float %.1106129, i64 1
  %i.cw = insertelement <2 x float> %i.cm, float %i.ct, i64 0
  %i.cx = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cu, <2 x float> %i.cv, <2 x float> %i.cw)
  store <2 x float> %i.cx, ptr %i.cs, align 4, !tbaa !80
  br label %.thread
...
stbtt__cuberoot.exit49:                           ; preds = %bb.e, %bb.f
  ...
  store float %i.ao, ptr %3, align 4, !tbaa !80
  br label %bb.h
...
bb.g:                                             ; preds = %bb.a
  ...
  store <2 x float> %i.bq, ptr %3, align 4, !tbaa !80
