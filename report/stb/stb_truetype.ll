...
bb.a:
  ...
  br i1 %i.f, label %bb.ba, label %bb.b
...
bb.aq:                                            ; preds = %._crit_edge.us.us
  ...
  %spec.store.select.us.us = select i1 %i.mr, float 2.550000e+02, float %i.mz
...
bb.ar:                                            ; preds = %._crit_edge.us.us, %bb.aq
  ...
  store i8 %.0431.us.us, ptr %i.mv, align 1, !tbaa !14
...
._crit_edge.us.us:                                ; preds = %.thread.us.us
  ...
  br i1 %i.na, label %bb.ar, label %bb.aq
...
bb.au:                                            ; preds = %bb.as
  ...
  br i1 %i.pa, label %bb.aw, label %bb.av
...
bb.aw:                                            ; preds = %bb.as, %bb.au, %bb.av, %bb.at
  %.sink = phi float [ %i.pb, %bb.av ], [ 0.000000e+00, %bb.au ], [ %i.ob, %bb.at ], [ 0.000000e+00, %bb.as ]
...
bb.ax:                                            ; preds = %.preheader, %bb.az
  ...
  br i1 %i.pq, label %bb.az, label %bb.ay

bb.ay:                                            ; preds = %bb.ax
  %i.pr = fcmp ogt float %i.pp, 2.550000e+02
  %spec.store.select = select i1 %i.pr, float 2.550000e+02, float %i.pp
  %i.ps = fptoui float %spec.store.select to i8
  br label %bb.az

bb.az:                                            ; preds = %bb.ax, %bb.ay
  %.0431 = phi i8 [ %i.ps, %bb.ay ], [ 0, %bb.ax ]
  %i.pt = add i32 %i.pi, %i.pj
  %i.pu = sext i32 %i.pt to i64
  %i.pv = getelementptr inbounds i8, ptr %i.be, i64 %i.pu
  store i8 %.0431, ptr %i.pv, align 1, !tbaa !14
  %indvars.iv.next529 = add nsw i64 %indvars.iv528, 1 ; 2 uses
  %i.pw = icmp slt i64 %indvars.iv.next529, %i.bp
  br i1 %i.pw, label %bb.ax, label %._crit_edge522.split, !llvm.loop !241
