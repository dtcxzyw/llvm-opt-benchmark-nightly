...
._crit_edge:                                      ; preds = %91, %73, %mz_zip_reader_goto_next_entry.exit, %68
  %.268 = phi i32 [ %.0.i90, %91 ], [ %94, %mz_zip_reader_goto_next_entry.exit ], [ %69, %68 ], [ %75, %73 ] ; 2 uses
  %96 = icmp eq i32 %.268, -100
  %spec.select133 = select i1 %96, i32 0, i32 %.268
  br label %.loopexit
