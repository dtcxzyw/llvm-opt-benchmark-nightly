...
bb.aj:                                            ; preds = %_ZN7QStringD2Ev.exit153, %_ZN7QStringD2Ev.exit158, %_ZN7QStringD2Ev.exit132
  %.050 = phi i32 [ %i.au, %_ZN7QStringD2Ev.exit132 ], [ %i.cb, %_ZN7QStringD2Ev.exit153 ], [ %i.cp, %_ZN7QStringD2Ev.exit158 ] ; 2 uses
  %.049 = phi i32 [ %i.aw, %_ZN7QStringD2Ev.exit132 ], [ %i.cd, %_ZN7QStringD2Ev.exit153 ], [ %i.cr, %_ZN7QStringD2Ev.exit158 ] ; 2 uses
  %i.dc = icmp slt i32 %.050, 0
  %i.dd = icmp slt i32 %.049, 1
  %or.cond3 = or i1 %i.dc, %i.dd
  br i1 %or.cond3, label %bb.ak, label %bb.an

bb.ak:                                            ; preds = %bb.aj
  %i.de = getelementptr i8, ptr %.0, i64 188
  %i.df = load i32, ptr %i.de, align 4
  %i.dg = getelementptr i8, ptr %.0, i64 192
...
bb.an:                                            ; preds = %bb.aj, %_ZN7QStringD2Ev.exit163
  %.151 = phi i32 [ %i.df, %_ZN7QStringD2Ev.exit163 ], [ %.050, %bb.aj ] ; 7 uses
  %.1 = phi i32 [ %i.dh, %_ZN7QStringD2Ev.exit163 ], [ %.049, %bb.aj ] ; 3 uses
  %i.ds = icmp sgt i32 %.151, -1
  %i.dt = icmp sgt i32 %.1, 0
  %or.cond5 = and i1 %i.ds, %i.dt
  br i1 %or.cond5, label %bb.ao, label %bb.bw

bb.ao:                                            ; preds = %bb.an
  %i.du = add nsw i32 %.151, -1
