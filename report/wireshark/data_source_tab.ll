...
_ZN13DataSourceTab2trEPKcS1_i.exit183:            ; preds = %bb.av
  ...
  invoke void @_ZNK7QString3argExii5QChar(ptr dead_on_unwind nonnull writable sret(%class.QString) align 8 %18, ptr noundef nonnull align 8 dereferenceable_or_null(24) %19, i64 noundef %i.em, i32 noundef 0, i32 noundef 10, i16 32)
...
_ZNK7QString3argEiii5QChar.exit184:               ; preds = %_ZN13DataSourceTab2trEPKcS1_i.exit183
  %i.en = sub nuw nsw i32 %1, %.150
  %i.eo = zext nneg i32 %i.en to i64
  invoke void @_ZNK7QString3argExii5QChar(ptr dead_on_unwind nonnull writable sret(%class.QString) align 8 %17, ptr noundef nonnull align 8 dereferenceable_or_null(24) %18, i64 noundef %i.eo, i32 noundef 0, i32 noundef 10, i16 32)
...
_ZNK7QString3argEiii5QChar.exit185:               ; preds = %_ZNK7QString3argEiii5QChar.exit184
  %i.ep = invoke noundef align 8 dereferenceable(24) ptr @_ZN7QString6appendERKS_(ptr noundef nonnull align 8 dereferenceable_or_null(24) %3, ptr noundef nonnull align 8 dereferenceable(24) %17)
          to label %bb.aw unwind label %bb.bm     ; 0 uses

bb.aw:                                            ; preds = %_ZNK7QString3argEiii5QChar.exit185
  %i.eq = load ptr, ptr %17, align 8              ; 2 uses
  %.not.i.i.i186 = icmp eq ptr %i.eq, null
...
_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i187:   ; preds = %bb.aw
  ...
  %.not.i.i188 = icmp eq i32 %i.er, 1
  br i1 %.not.i.i188, label %bb.ax, label %_ZN7QStringD2Ev.exit189

bb.ax:                                            ; preds = %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i187
  %i.es = load ptr, ptr %17, align 8
  call void @_ZN10QArrayData10deallocateEPS_xx(ptr noundef %i.es, i64 noundef 2, i64 noundef 8) #26
...
_ZN7QStringD2Ev.exit189:                          ; preds = %bb.aw, %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i187, %bb.ax
  ...
  %.not.i.i.i190 = icmp eq ptr %i.et, null
...
_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i195:   ; preds = %_ZN7QStringD2Ev.exit193
  %i.ex = atomicrmw sub ptr %i.ew, i32 1 acq_rel, align 4
  %.not.i.i196 = icmp eq i32 %i.ex, 1
  br i1 %.not.i.i196, label %bb.az, label %_ZN7QStringD2Ev.exit197

bb.az:                                            ; preds = %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i195
  %i.ey = load ptr, ptr %19, align 8
  call void @_ZN10QArrayData10deallocateEPS_xx(ptr noundef %i.ey, i64 noundef 2, i64 noundef 8) #26
...
bb.be:                                            ; preds = %_ZNK7QString3argEiii5QChar.exit166
  %i.fd = landingpad { ptr, i32 }
          cleanup                                 ; 3 uses
  %i.fe = load ptr, ptr %13, align 8              ; 2 uses
  %.not.i.i.i198 = icmp eq ptr %i.fe, null
...
_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i199:   ; preds = %bb.be
  ...
  %.not.i.i200 = icmp eq i32 %i.ff, 1
  br i1 %.not.i.i200, label %bb.bf, label %_ZN7QStringD2Ev.exit201

bb.bf:                                            ; preds = %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i199
  %i.fg = load ptr, ptr %13, align 8
  call void @_ZN10QArrayData10deallocateEPS_xx(ptr noundef %i.fg, i64 noundef 2, i64 noundef 8) #26
  br label %_ZN7QStringD2Ev.exit201

_ZN7QStringD2Ev.exit201:                          ; preds = %bb.bf, %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i199, %bb.be, %bb.bd
  %.pn78 = phi { ptr, i32 } [ %i.fc, %bb.bd ], [ %i.fd, %bb.be ], [ %i.fd, %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i199 ], [ %i.fd, %bb.bf ] ; 3 uses
  %i.fh = load ptr, ptr %14, align 8              ; 2 uses
  %.not.i.i.i202 = icmp eq ptr %i.fh, null
...
_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i203:   ; preds = %_ZN7QStringD2Ev.exit201
  ...
  %.not.i.i204 = icmp eq i32 %i.fi, 1
  br i1 %.not.i.i204, label %bb.bg, label %_ZN7QStringD2Ev.exit205

bb.bg:                                            ; preds = %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i203
  %i.fj = load ptr, ptr %14, align 8
  call void @_ZN10QArrayData10deallocateEPS_xx(ptr noundef %i.fj, i64 noundef 2, i64 noundef 8) #26
  br label %_ZN7QStringD2Ev.exit205

_ZN7QStringD2Ev.exit205:                          ; preds = %bb.bg, %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i203, %_ZN7QStringD2Ev.exit201, %bb.bc
  %.pn78.pn = phi { ptr, i32 } [ %i.fb, %bb.bc ], [ %.pn78, %_ZN7QStringD2Ev.exit201 ], [ %.pn78, %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i203 ], [ %.pn78, %bb.bg ] ; 3 uses
  %i.fk = load ptr, ptr %15, align 8              ; 2 uses
  %.not.i.i.i206 = icmp eq ptr %i.fk, null
...
_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i207:   ; preds = %_ZN7QStringD2Ev.exit205
  ...
  %.not.i.i208 = icmp eq i32 %i.fl, 1
  br i1 %.not.i.i208, label %bb.bh, label %_ZN7QStringD2Ev.exit209

bb.bh:                                            ; preds = %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i207
  %i.fm = load ptr, ptr %15, align 8
  call void @_ZN10QArrayData10deallocateEPS_xx(ptr noundef %i.fm, i64 noundef 2, i64 noundef 8) #26
  br label %_ZN7QStringD2Ev.exit209

_ZN7QStringD2Ev.exit209:                          ; preds = %bb.bh, %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i207, %_ZN7QStringD2Ev.exit205, %bb.bb
  %.pn78.pn.pn = phi { ptr, i32 } [ %i.fa, %bb.bb ], [ %.pn78.pn, %_ZN7QStringD2Ev.exit205 ], [ %.pn78.pn, %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i207 ], [ %.pn78.pn, %bb.bh ] ; 3 uses
  %i.fn = load ptr, ptr %16, align 8              ; 2 uses
  %.not.i.i.i210 = icmp eq ptr %i.fn, null
...
_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i211:   ; preds = %_ZN7QStringD2Ev.exit209
  ...
  %.not.i.i212 = icmp eq i32 %i.fo, 1
  br i1 %.not.i.i212, label %bb.bi, label %_ZN7QStringD2Ev.exit213

bb.bi:                                            ; preds = %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i211
  %i.fp = load ptr, ptr %16, align 8
  call void @_ZN10QArrayData10deallocateEPS_xx(ptr noundef %i.fp, i64 noundef 2, i64 noundef 8) #26
  br label %_ZN7QStringD2Ev.exit213

_ZN7QStringD2Ev.exit213:                          ; preds = %bb.bi, %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i211, %_ZN7QStringD2Ev.exit209, %bb.ba
  %.pn78.pn.pn.pn = phi { ptr, i32 } [ %i.ez, %bb.ba ], [ %.pn78.pn.pn, %_ZN7QStringD2Ev.exit209 ], [ %.pn78.pn.pn, %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i211 ], [ %.pn78.pn.pn, %bb.bi ]
  call void @llvm.lifetime.end.p0(ptr nonnull %16) #26
  call void @llvm.lifetime.end.p0(ptr nonnull %15) #26
  call void @llvm.lifetime.end.p0(ptr nonnull %14) #26
  call void @llvm.lifetime.end.p0(ptr nonnull %13) #26
...
bb.bm:                                            ; preds = %_ZNK7QString3argEiii5QChar.exit185
  %i.ft = landingpad { ptr, i32 }
          cleanup                                 ; 3 uses
  %i.fu = load ptr, ptr %17, align 8              ; 2 uses
  %.not.i.i.i214 = icmp eq ptr %i.fu, null
...
_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i215:   ; preds = %bb.bm
  ...
  %.not.i.i216 = icmp eq i32 %i.fv, 1
  br i1 %.not.i.i216, label %bb.bn, label %_ZN7QStringD2Ev.exit217

bb.bn:                                            ; preds = %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i215
  %i.fw = load ptr, ptr %17, align 8
  call void @_ZN10QArrayData10deallocateEPS_xx(ptr noundef %i.fw, i64 noundef 2, i64 noundef 8) #26
  br label %_ZN7QStringD2Ev.exit217

_ZN7QStringD2Ev.exit217:                          ; preds = %bb.bn, %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i215, %bb.bm, %bb.bl
  %.pn89 = phi { ptr, i32 } [ %i.fs, %bb.bl ], [ %i.ft, %bb.bm ], [ %i.ft, %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i215 ], [ %i.ft, %bb.bn ] ; 3 uses
  %i.fx = load ptr, ptr %18, align 8              ; 2 uses
  %.not.i.i.i218 = icmp eq ptr %i.fx, null
...
_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i219:   ; preds = %_ZN7QStringD2Ev.exit217
  ...
  %.not.i.i220 = icmp eq i32 %i.fy, 1
  br i1 %.not.i.i220, label %bb.bo, label %_ZN7QStringD2Ev.exit221

bb.bo:                                            ; preds = %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i219
  %i.fz = load ptr, ptr %18, align 8
  call void @_ZN10QArrayData10deallocateEPS_xx(ptr noundef %i.fz, i64 noundef 2, i64 noundef 8) #26
  br label %_ZN7QStringD2Ev.exit221
