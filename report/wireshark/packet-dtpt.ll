...
.split.i:                                         ; preds = %bb.d
  %i.n = tail call i32 @tvb_get_letohl(ptr noundef %0, i32 noundef 64) ; 3 uses
  ...
  %4 = sub i32 0, %i.n
  %i.r = and i32 %4, 3
  %5 = add i32 %i.r, %i.n                         ; 2 uses
  %i.s = add i32 %5, 68
  %i.t = tail call i32 @tvb_get_letohl(ptr noundef %0, i32 noundef %i.s)
  %i.u = add i32 %5, 72
  %i.v = add i32 %i.u, %i.t                       ; 2 uses
  %i.w = tail call i32 @tvb_get_letohl(ptr noundef %0, i32 noundef %i.v) ; 3 uses
  ...
  %i.aa = and i32 %6, 3
  %7 = add i32 %i.aa, %i.w
  %i.ab = add i32 %7, %i.y                        ; 2 uses
  %i.ac = tail call i32 @tvb_get_letohl(ptr noundef %0, i32 noundef %i.ab)
  %i.ad = add i32 %i.ab, 4
  %i.ae = add i32 %i.ad, %i.ac                    ; 2 uses
  %i.af = tail call i32 @tvb_get_letohl(ptr noundef %0, i32 noundef %i.ae) ; 3 uses
