...
.thread199:                                       ; preds = %.thread199.sink.split, %bb.x, %bb.y, %bb.o, %bb.p
  %.0176.ph = phi i32 [ %i.bm, %bb.x ], [ %i.bm, %bb.y ], [ %i.ar, %bb.o ], [ %i.ar, %bb.p ], [ %i.ch, %.thread199.sink.split ]
  %.0175.ph = phi i32 [ %i.bs, %bb.x ], [ %i.bs, %bb.y ], [ %i.au, %bb.o ], [ %i.au, %bb.p ], [ %i.ck, %.thread199.sink.split ]
  %.0174.ph = phi i1 [ false, %bb.x ], [ false, %bb.y ], [ false, %bb.o ], [ true, %bb.p ], [ false, %.thread199.sink.split ]
  %i.cl = getelementptr i8, ptr %2, i64 4
  store i32 3, ptr %i.cl, align 4
  %i.cm = getelementptr i8, ptr %2, i64 52
  store i32 %.0176.ph, ptr %i.cm, align 4
  br label %bb.af

bb.ab:                                            ; preds = %bb.v, %bb.u, %bb.t, %bb.s, %bb.z
  %.0176 = phi i32 [ %i.ar, %bb.t ], [ %i.ar, %bb.u ], [ %i.bz, %bb.z ], [ %i.ar, %bb.s ], [ %i.ar, %bb.v ] ; 3 uses
  %.0175 = phi i32 [ %i.au, %bb.t ], [ %i.au, %bb.u ], [ %i.cc, %bb.z ], [ %i.au, %bb.s ], [ %i.au, %bb.v ] ; 3 uses
  %.0173 = phi i32 [ 3, %bb.t ], [ 26, %bb.u ], [ 24, %bb.z ], [ %i.bb, %bb.s ], [ 8, %bb.v ] ; 6 uses
  %i.cn = icmp ult i32 %.0176, %.0173
  br i1 %i.cn, label %bb.ac, label %bb.ad

bb.ac:                                            ; preds = %bb.ab
  store i32 -13, ptr %3, align 4
  %i.co = call noalias ptr (ptr, ptr, ...) @wmem_strdup_printf(ptr noundef null, ptr noundef nonnull @.str.2, i32 noundef %.0176, i32 noundef %.0173)
...
bb.ad:                                            ; preds = %bb.ab
  ...
  %i.cq = sub nuw i32 %.0176, %.0173
  %i.cr = getelementptr i8, ptr %2, i64 52
  store i32 %i.cq, ptr %i.cr, align 4
  %i.cs = icmp ult i32 %.0175, %.0173
  br i1 %i.cs, label %bb.ae, label %bb.af

bb.ae:                                            ; preds = %bb.ad
  store i32 -13, ptr %3, align 4
  %i.ct = call noalias ptr (ptr, ptr, ...) @wmem_strdup_printf(ptr noundef null, ptr noundef nonnull @.str.3, i32 noundef %.0175, i32 noundef %.0173)
  store ptr %i.ct, ptr %4, align 8
  br label %bb.aq

bb.af:                                            ; preds = %.thread199, %bb.ad
  %.0175196206 = phi i32 [ %.0175.ph, %.thread199 ], [ %.0175, %bb.ad ]
  %.0174197205 = phi i1 [ %.0174.ph, %.thread199 ], [ false, %bb.ad ]
  %.0173198204 = phi i32 [ 0, %.thread199 ], [ %.0173, %bb.ad ]
  %i.cu = sub nuw i32 %.0175196206, %.0173198204  ; 6 uses
...
bb.ah:                                            ; preds = %bb.af
  ...
  br i1 %.0174197205, label %bb.ai, label %bb.ao
...
bb.an:                                            ; preds = %bb.am, %bb.ak
  %.0172 = phi i32 [ %i.hq, %bb.am ], [ %i.hi, %bb.ak ]
  %i.hs = call zeroext i1 @wtap_read_bytes_buffer(ptr noundef %1, ptr noundef %i.hf, i32 noundef %.0172, ptr noundef %3, ptr noundef %4)
...
bb.aq:                                            ; preds = %bb.ao, %bb.an, %bb.am, %bb.al, %bb.aj, %bb.ai, %bb.z, %bb.y, %bb.w, %bb.v, %bb.u, %bb.t, %bb.r, %bb.q, %bb.e, %bb.d, %bb.a, %bb.ap, %bb.ag, %bb.ae, %bb.ac, %bb.c
  %.0 = phi i1 [ false, %bb.c ], [ false, %bb.ac ], [ false, %bb.ae ], [ false, %bb.ag ], [ false, %bb.ai ], [ false, %bb.al ], [ true, %bb.ap ], [ true, %bb.am ], [ true, %bb.aj ], [ false, %bb.z ], [ false, %bb.an ], [ false, %bb.q ], [ false, %bb.e ], [ false, %bb.r ], [ false, %bb.t ], [ false, %bb.u ], [ false, %bb.w ], [ false, %bb.v ], [ false, %bb.y ], [ false, %bb.d ], [ false, %bb.a ], [ false, %bb.ao ]
