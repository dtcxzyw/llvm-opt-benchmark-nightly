...
bb.j:                                             ; preds = %bb.h
  %i.aw = tail call noundef double @_Z5qQNaNv() #17
  br label %bb.k

bb.k:                                             ; preds = %bb.j, %bb.i
  %i.ax = phi double [ %i.av, %bb.i ], [ %i.aw, %bb.j ]
  %i.ay = call zeroext i1 @nstime_is_unset(ptr noundef %i.v)
  br i1 %i.ay, label %bb.m, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.az = call i32 @nstime_cmp(ptr noundef %i.q, ptr noundef %i.v)
...
bb.o:                                             ; preds = %_ZNSt6vectorI12_plot_item_tSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit16.i
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %i.a, i64 noundef %i.ak) #18
...
bb.p:                                             ; preds = %bb.e, %bb.j, %_ZNSt6vectorI12_plot_item_tSaIS0_EE17_M_realloc_insertIJRKS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit
  ...
  %i.ao = getelementptr i8, ptr %i.an, i64 %i.d
  ret ptr %i.ao
}
...
bb.a:
  ...
  %i.c = load ptr, ptr %i.b, align 8, !noalias !19
  %i.d = getelementptr inbounds nuw i8, ptr %6, i64 16
  %i.e = load i64, ptr %i.d, align 8, !noalias !19
