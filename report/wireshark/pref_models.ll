Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/wireshark/original/pref_models?download=true
...
bb.h:                                             ; preds = %bb.g
  %i.aq = shl i64 %i.ag, 5
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 1 %i.ak, ptr noundef nonnull align 1 %i.aj, i64 noundef %i.aq, i1 noundef false) #24
...
bb.a:
  %4 = alloca %struct.QArrayDataPointer, align 16 ; 13 uses
  %i.a = icmp ne i32 %1, 0
...
_ZNK17QArrayDataPointerI8QVariantE14freeSpaceAtEndEv.exit: ; preds = %_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit
  ...
  %i.q = add i64 %i.p, %2
  %i.r = add i64 %i.q, %i.n
  %i.s = tail call { ptr, ptr } @_ZN10QArrayData19reallocateUnalignedEPS_PvxxNS_16AllocationOptionE(ptr noundef nonnull %i.c, ptr noundef %i.h, i64 noundef 32, i64 noundef %i.r, i32 noundef 0) #24 ; 2 uses
...
_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit.thread: ; preds = %bb.b, %_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit, %bb.a
  ...
  call void @_ZN17QArrayDataPointerI8QVariantE12allocateGrowERKS1_xN10QArrayData14GrowthPositionE(ptr dead_on_unwind nonnull writable sret(%struct.QArrayDataPointer) align 8 %4, ptr noundef align 8 dereferenceable(24) %0, i64 noundef %2, i32 noundef %1)
...
.noexc:                                           ; preds = %bb.i
  ...
  br i1 %i.aq, label %bb.i, label %_ZN9QtPrivate16QGenericArrayOpsI8QVariantE10copyAppendEPKS1_S4_.exit, !llvm.loop !142
...
.lr.ph.i34.a:                                     ; preds = %.lr.ph.i34
  ...
  call void @llvm.memset.p0.i64(ptr noundef align 8 dereferenceable(32) %i.at, i8 0, i64 24, i1 false)
...
bb.l:                                             ; preds = %.prol.loopexit, %bb.l
  ...
  call void @llvm.memset.p0.i64(ptr noundef align 8 dereferenceable(32) %12, i8 0, i64 24, i1 false)
  ...
  br i1 %i.bd, label %bb.l, label %_ZN9QtPrivate16QGenericArrayOpsI8QVariantE10copyAppendEPKS1_S4_.exit, !llvm.loop !143
...
.lr.ph.i.i.i.i.i:                                 ; preds = %bb.o, %.lr.ph.i.i.i.i.i
  ...
  br i1 %.not.i.i.i.i.i, label %_ZN9QtPrivate16QGenericArrayOpsI8QVariantE10destroyAllEv.exit.i, label %.lr.ph.i.i.i.i.i, !llvm.loop !141
