...
_ZN5QListI6QPointED2Ev.exit200:                   ; preds = %_ZN5QListI6QPointED2Ev.exit, %_ZN17QArrayDataPointerI6QPointE5derefEv.exit.i.i198, %bb.k
  ...
  %61 = load double, ptr %2, align 8              ; 2 uses
  %i.bv = load double, ptr %i.q, align 8
  %i.bw = fadd double %i.bt, %i.bv                ; 4 uses
  %62 = insertelement <2 x double> poison, double %61, i64 0
  %i.bx = insertelement <2 x double> %62, double %i.bu, i64 1
  %63 = insertelement <2 x double> <double 0.000000e+00, double poison>, double %61, i64 1
  %i.by = fadd <2 x double> %i.bx, %63            ; 4 uses
...
_ZN10QCPPainter8drawLineERK6QLineF.exit:          ; preds = %bb.m, %bb.n
  ...
  %64 = load double, ptr %i.q, align 8
  ...
  %i.cy = shufflevector <2 x double> %65, <2 x double> poison, <2 x i32> zeroinitializer
...
_ZN10QCPPainter8drawLineERK6QLineF.exit217:       ; preds = %bb.p, %bb.q
  ...
  %66 = load double, ptr %i.q, align 8
  ...
  %i.ea = shufflevector <2 x double> %67, <2 x double> poison, <2 x i32> zeroinitializer
...
_ZN5QListI6QPointED2Ev.exit279:                   ; preds = %_ZN5QListI6QPointED2Ev.exit275, %_ZN17QArrayDataPointerI6QPointE5derefEv.exit.i.i277, %bb.z
  ...
  %68 = load double, ptr %2, align 8              ; 2 uses
  %i.hd = load double, ptr %i.q, align 8
  %i.he = fadd double %i.hb, %i.hd                ; 4 uses
  %69 = insertelement <2 x double> poison, double %68, i64 0
  %i.hf = insertelement <2 x double> %69, double %i.hc, i64 1
  %70 = insertelement <2 x double> <double 0.000000e+00, double poison>, double %68, i64 1
  %i.hg = fadd <2 x double> %i.hf, %70            ; 4 uses
...
_ZN10QCPPainter8drawLineERK6QLineF.exit293:       ; preds = %bb.ab, %bb.ac
  ...
  %71 = load double, ptr %i.q, align 8
  ...
  %i.ig = shufflevector <2 x double> %72, <2 x double> poison, <2 x i32> zeroinitializer
...
_ZN10QCPPainter8drawLineERK6QLineF.exit307:       ; preds = %bb.ae, %bb.af
  ...
  %73 = load double, ptr %i.q, align 8
  ...
  %i.ji = shufflevector <2 x double> %74, <2 x double> poison, <2 x i32> zeroinitializer
...
_ZN10QCPPainter6setPenERK4QPen.exit339:           ; preds = %bb.bd, %bb.be
  ...
  %75 = load double, ptr %2, align 8              ; 2 uses
  ...
  %i.lk = insertelement <2 x double> %76, double %i.lg, i64 1
  %77 = insertelement <2 x double> <double 0.000000e+00, double poison>, double %75, i64 1
  %i.ll = fadd <2 x double> %i.lk, %77            ; 4 uses
...
_ZN10QCPPainter8drawLineERK6QLineF.exit353:       ; preds = %bb.bg, %bb.bh
  ...
  %78 = load double, ptr %i.lh, align 8
  ...
  %i.ml = shufflevector <2 x double> %79, <2 x double> poison, <2 x i32> zeroinitializer
...
_ZN10QCPPainter8drawLineERK6QLineF.exit367:       ; preds = %bb.bj, %bb.bk
  ...
  %80 = load double, ptr %i.lh, align 8
  ...
  %i.nn = shufflevector <2 x double> %81, <2 x double> poison, <2 x i32> zeroinitializer
...
_ZN5QListI6QPointED2Ev.exit429:                   ; preds = %_ZN5QListI6QPointED2Ev.exit425, %_ZN17QArrayDataPointerI6QPointE5derefEv.exit.i.i427, %bb.bv
  ...
  %i.qx = shufflevector <2 x double> %83, <2 x double> poison, <2 x i32> zeroinitializer
...
_ZN5QListI6QPointED2Ev.exit507:                   ; preds = %_ZN5QListI6QPointED2Ev.exit503, %_ZN17QArrayDataPointerI6QPointE5derefEv.exit.i.i505, %bb.ch
  ...
  %i.ve = shufflevector <2 x double> %85, <2 x double> poison, <2 x i32> zeroinitializer
...
_ZN10QCPPainter6setPenERK4QPen.exit555:           ; preds = %bb.di, %bb.dj
  ...
  %i.yh = shufflevector <2 x double> %87, <2 x double> poison, <2 x i32> zeroinitializer
