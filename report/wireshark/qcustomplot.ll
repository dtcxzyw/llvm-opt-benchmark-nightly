...
bb.b:                                             ; preds = %bb.a
  %i.h = add i64 %i.e, 1
  %.sroa.0106.4.extract.shift.a = and i64 %i.h, 4294967295
  %.sroa.0106.4.extract.shift = and i64 %i.d, -4294967296
  %.sroa.0106.4.insert.insert = or disjoint i64 %.sroa.0106.4.extract.shift.a, %.sroa.0106.4.extract.shift
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.l = and i64 %.sroa.0106.0, 4294967295
  %.sroa.0106.4.insert.insert138 = or disjoint i64 %.sroa.0106.4.insert.shift136, %i.l
  %7 = and i64 %.sroa.0106.0, -4294967296
  %i.m = or i64 %.sroa.24.0, -4294967296
  %.sroa.24.12.insert.insert179 = add i64 %7, %i.m
  br label %bb.e
...
bb.f:                                             ; preds = %bb.e
  %i.n = add i64 %.sroa.24.1, %.sroa.0106.1
  %sh.diff190 = lshr i64 %.sroa.0106.1, 31
  %.sroa.0102.0.extract.trunc = trunc i64 %i.n to i32
  %tr.sh.diff191 = trunc i64 %sh.diff190 to i32
  %i.o = insertelement <2 x i32> poison, i32 %tr.sh.diff191, i64 0
  %i.p = insertelement <2 x i32> %i.o, i32 %.sroa.0102.0.extract.trunc, i64 1
  %i.q = and <2 x i32> %i.p, <i32 -2, i32 -1>
  %i.r = sitofp <2 x i32> %i.q to <2 x double>
  %i.s = fmul nnan <2 x double> %i.r, splat (double 5.000000e-01) ; 2 uses
  %i.t = call <2 x double> @llvm.copysign.v2f64(<2 x double> splat (double 5.000000e-01), <2 x double> %i.s)
  %i.u = fadd <2 x double> %i.s, %i.t
  %i.v = fptosi <2 x double> %i.u to <2 x i32>
  %i.w = sitofp <2 x i32> %i.v to <2 x double>
  br label %bb.y
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.x = sitofp <2 x i32> %9 to <2 x double>
  br label %bb.y
...
bb.h:                                             ; preds = %bb.e
  ...
  %i.y = add i32 %.sroa.489.0.extract.trunc, %.sroa.0106.4.extract.trunc147
  %i.z = insertelement <2 x i32> poison, i32 %i.y, i64 0
  %i.aa = insertelement <2 x i32> %i.z, i32 %.sroa.092.0.extract.trunc, i64 1
  %i.ab = sitofp <2 x i32> %i.aa to <2 x double>
  %i.ac = fmul nnan <2 x double> %i.ab, splat (double 5.000000e-01) ; 2 uses
...
bb.i:                                             ; preds = %bb.e
  %i.ah = add i64 %.sroa.24.1, %.sroa.0106.1
  %sh.diff = lshr i64 %.sroa.24.1, 31
  %.sroa.084.0.extract.trunc = trunc i64 %i.ah to i32
  %tr.sh.diff = trunc i64 %sh.diff to i32
  %i.ai = insertelement <2 x i32> poison, i32 %tr.sh.diff, i64 0
  %i.aj = insertelement <2 x i32> %i.ai, i32 %.sroa.084.0.extract.trunc, i64 1
  %i.ak = and <2 x i32> %i.aj, <i32 -2, i32 -1>
  %i.al = sitofp <2 x i32> %i.ak to <2 x double>
  %i.am = fmul nnan <2 x double> %i.al, splat (double 5.000000e-01) ; 2 uses
  %i.an = call <2 x double> @llvm.copysign.v2f64(<2 x double> splat (double 5.000000e-01), <2 x double> %i.am)
  %i.ao = fadd <2 x double> %i.am, %i.an
  %i.ap = fptosi <2 x double> %i.ao to <2 x i32>
...
bb.j:                                             ; preds = %bb.e
  ...
  %i.ar = insertelement <2 x i32> poison, i32 %.sroa.24.12.extract.trunc185, i64 0
  %i.as = insertelement <2 x i32> %i.ar, i32 %.sroa.078.0.extract.trunc, i64 1
  %i.at = sitofp <2 x i32> %i.as to <2 x double>
  br label %bb.y
...
bb.k:                                             ; preds = %bb.e
  ...
  %i.au = add i32 %.sroa.24.12.extract.trunc188, %.sroa.473.0.extract.trunc
  %i.av = insertelement <2 x i32> poison, i32 %i.au, i64 0
  %i.aw = insertelement <2 x i32> %i.av, i32 %.sroa.074.0.extract.trunc, i64 1
  %i.ax = sitofp <2 x i32> %i.aw to <2 x double>
  %i.ay = fmul nnan <2 x double> %i.ax, splat (double 5.000000e-01) ; 2 uses
  %i.az = call <2 x double> @llvm.copysign.v2f64(<2 x double> splat (double 5.000000e-01), <2 x double> %i.ay)
  %i.ba = fadd <2 x double> %i.ay, %i.az
  %i.bb = fptosi <2 x double> %i.ba to <2 x i32>
...
bb.l:                                             ; preds = %bb.e
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %i.bd, i8 0, i64 20, i1 false)
  store ptr @.str.230, ptr %i.be, align 8
...
.noexc:                                           ; preds = %bb.l
  %i.bg = invoke noundef align 8 dereferenceable(16) ptr @_ZN11QTextStreamlsERK7QString(ptr noundef align 8 dereferenceable_or_null(16) %i.bf, ptr noundef nonnull align 8 dereferenceable(24) %3)
...
_ZN7QStringD2Ev.exit.i:                           ; preds = %bb.n, %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i.i, %bb.m
  ...
  %i.bm = load i8, ptr %i.bl, align 8, !range !6, !noundef !7
  %i.bn = trunc nuw i8 %i.bm to i1
  br i1 %i.bn, label %bb.o, label %_ZN6QDebuglsEPKc.exit

bb.o:                                             ; preds = %_ZN7QStringD2Ev.exit.i
  %i.bo = invoke noundef align 8 dereferenceable(16) ptr @_ZN11QTextStreamlsEc(ptr noundef align 8 dereferenceable_or_null(16) %i.bk, i8 noundef signext 32)
...
bb.p:                                             ; preds = %.noexc
  ...
  %.not.i.i.i2.i = icmp eq ptr %i.bq, null
...
bb.q:                                             ; preds = %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i3.i
  ...
  call void @_ZN10QArrayData10deallocateEPS_xx(ptr noundef %i.bs, i64 noundef 2, i64 noundef 8) #51
...
_ZN6QDebuglsEPKc.exit:                            ; preds = %._ZN6QDebuglsEPKc.exit_crit_edge, %_ZN7QStringD2Ev.exit.i
  %i.bt = phi ptr [ %.pre, %._ZN6QDebuglsEPKc.exit_crit_edge ], [ %i.bk, %_ZN7QStringD2Ev.exit.i ]
...
.noexc65:                                         ; preds = %_ZN6QDebuglsEPKc.exit
  %i.bu = invoke noundef align 8 dereferenceable(16) ptr @_ZN11QTextStreamlsERK7QString(ptr noundef align 8 dereferenceable_or_null(16) %i.bt, ptr noundef nonnull align 8 dereferenceable(24) %2)
          to label %bb.r unwind label %bb.u       ; 0 uses

bb.r:                                             ; preds = %.noexc65
  %i.bv = load ptr, ptr %2, align 8               ; 2 uses
  %.not.i.i.i.i61 = icmp eq ptr %i.bv, null
...
_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i.i62:  ; preds = %bb.r
  ...
  %.not.i.i.i63 = icmp eq i32 %i.bw, 1
...
bb.s:                                             ; preds = %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i.i62
  ...
  call void @_ZN10QArrayData10deallocateEPS_xx(ptr noundef %i.bx, i64 noundef 2, i64 noundef 8) #51
...
_ZN7QStringD2Ev.exit.i64:                         ; preds = %bb.s, %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i.i62, %bb.r
  ...
  %i.by = load ptr, ptr %4, align 8               ; 3 uses
  %i.bz = getelementptr i8, ptr %i.by, i64 48
  %i.ca = load i8, ptr %i.bz, align 8, !range !6, !noundef !7
  %i.cb = trunc nuw i8 %i.ca to i1
  br i1 %i.cb, label %bb.t, label %_ZN6QDebuglsEPKc.exit69

bb.t:                                             ; preds = %_ZN7QStringD2Ev.exit.i64
  %i.cc = invoke noundef align 8 dereferenceable(16) ptr @_ZN11QTextStreamlsEc(ptr noundef align 8 dereferenceable_or_null(16) %i.by, i8 noundef signext 32)
...
bb.u:                                             ; preds = %.noexc65
  ...
  %.not.i.i.i2.i57 = icmp eq ptr %i.ce, null
...
_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i3.i58: ; preds = %bb.u
  ...
  %.not.i.i4.i59 = icmp eq i32 %i.cf, 1
...
bb.v:                                             ; preds = %_ZN17QArrayDataPointerIDsE5derefEv.exit.i.i3.i58
  ...
  call void @_ZN10QArrayData10deallocateEPS_xx(ptr noundef %i.cg, i64 noundef 2, i64 noundef 8) #51
...
_ZN6QDebuglsEPKc.exit69:                          ; preds = %._ZN6QDebuglsEPKc.exit69_crit_edge, %_ZN7QStringD2Ev.exit.i64
  %i.ch = phi ptr [ %.pre193, %._ZN6QDebuglsEPKc.exit69_crit_edge ], [ %i.by, %_ZN7QStringD2Ev.exit.i64 ]
  %i.ci = invoke noundef align 8 dereferenceable(16) ptr @_ZN11QTextStreamlsEi(ptr noundef align 8 dereferenceable_or_null(16) %i.ch, i32 noundef %1)
...
.noexc70:                                         ; preds = %_ZN6QDebuglsEPKc.exit69
  ...
  %i.cl = load i8, ptr %i.ck, align 8, !range !6, !noundef !7
  %i.cm = trunc nuw i8 %i.cl to i1
  br i1 %i.cm, label %bb.w, label %_ZN6QDebuglsEi.exit

bb.w:                                             ; preds = %.noexc70
  %i.cn = invoke noundef align 8 dereferenceable(16) ptr @_ZN11QTextStreamlsEc(ptr noundef align 8 dereferenceable_or_null(16) %i.cj, i8 noundef signext 32)
...
.body:                                            ; preds = %bb.x, %_ZN7QStringD2Ev.exit5.i60, %_ZN7QStringD2Ev.exit5.i
  %eh.lpad-body = phi { ptr, i32 } [ %i.bp, %_ZN7QStringD2Ev.exit5.i ], [ %i.co, %bb.x ], [ %i.cd, %_ZN7QStringD2Ev.exit5.i60 ]
  call void @_ZN6QDebugD1Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable_or_null(8) %4) #51
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #51
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #51
...
bb.y:                                             ; preds = %_ZN6QDebuglsEi.exit, %bb.k, %bb.j, %bb.i, %bb.h, %bb.g, %bb.f
  %i.cp = phi <2 x double> [ zeroinitializer, %_ZN6QDebuglsEi.exit ], [ %i.w, %bb.f ], [ %i.x, %bb.g ], [ %i.ag, %bb.h ], [ %i.aq, %bb.i ], [ %i.at, %bb.j ], [ %i.bc, %bb.k ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #51
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #51
  %i.cq = extractelement <2 x double> %i.cp, i64 1
  %.fca.0.insert = insertvalue { double, double } poison, double %i.cq, 0
  %i.cr = extractelement <2 x double> %i.cp, i64 0
  %.fca.1.insert = insertvalue { double, double } %.fca.0.insert, double %i.cr, 1
...
bb.l:                                             ; preds = %.lr.ph, %_ZN10QCPPainter8drawLineERK6QLineF.exit71
  %i.bw = phi i64 [ 0, %.lr.ph ], [ %i.di, %_ZN10QCPPainter8drawLineERK6QLineF.exit71 ]
  %.024165 = phi i32 [ 0, %.lr.ph ], [ %i.dh, %_ZN10QCPPainter8drawLineERK6QLineF.exit71 ]
  ...
  %i.ch = sitofp <2 x i32> %16 to <2 x double>    ; 2 uses
  %i.ci = fmul <2 x double> %i.bt, %i.ch          ; 2 uses
  %i.cj = fmul <2 x double> %i.bs, %i.ch          ; 2 uses
  %i.ck = shufflevector <2 x double> %i.cg, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.cl = fsub <2 x double> %i.ck, %i.ci          ; 2 uses
  %i.cm = fadd <2 x double> %i.ck, %i.ci          ; 2 uses
  %i.cn = shufflevector <2 x double> %i.cl, <2 x double> %i.cm, <2 x i32> <i32 0, i32 3> ; 2 uses
  %i.co = shufflevector <2 x double> %i.cg, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.cp = fsub <2 x double> %i.co, %i.cj          ; 2 uses
  %i.cq = fadd <2 x double> %i.co, %i.cj          ; 2 uses
  %i.cr = shufflevector <2 x double> %i.cp, <2 x double> %i.cq, <2 x i32> <i32 0, i32 3> ; 2 uses
  %17 = extractelement <2 x double> %i.cl, i64 0
  store double %17, ptr %11, align 8
  %18 = shufflevector <2 x double> %i.cp, <2 x double> %i.cm, <2 x i32> <i32 0, i32 3>
  store <2 x double> %18, ptr %i.br, align 8
  %i.cs = extractelement <2 x double> %i.cq, i64 1
  store double %i.cs, ptr %.sroa.4139.0..sroa_idx, align 8
  %i.ct = load i8, ptr %i.an, align 4, !range !6, !noundef !7
  %i.cu = trunc nuw i8 %i.ct to i1
  br i1 %i.cu, label %bb.n, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.cv = load i32, ptr %i.z, align 4
  %i.cw = and i32 %i.cv, 1
  %.not.i62 = icmp eq i32 %i.cw, 0
...
bb.o:                                             ; preds = %bb.m
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #51
  %i.cx = call <2 x double> @llvm.copysign.v2f64(<2 x double> splat (double 5.000000e-01), <2 x double> %i.cn)
  %i.cy = call <2 x double> @llvm.copysign.v2f64(<2 x double> splat (double 5.000000e-01), <2 x double> %i.cr)
  %i.cz = fadd <2 x double> %i.cn, %i.cx
  %i.da = fptosi <2 x double> %i.cz to <2 x i32>
  %i.db = fadd <2 x double> %i.cr, %i.cy
  %i.dc = fptosi <2 x double> %i.db to <2 x i32>
  %i.dd = zext <2 x i32> %i.dc to <2 x i64>
  %i.de = shl nuw <2 x i64> %i.dd, splat (i64 32)
  %i.df = zext <2 x i32> %i.da to <2 x i64>
  %i.dg = or disjoint <2 x i64> %i.de, %i.df
  store <2 x i64> %i.dg, ptr %3, align 16
...
_ZN10QCPPainter8drawLineERK6QLineF.exit71:        ; preds = %bb.n, %bb.o
  call void @llvm.lifetime.end.p0(ptr nonnull %11) #51
  %i.dh = add i32 %.024165, 1                     ; 2 uses
  %i.di = sext i32 %i.dh to i64                   ; 2 uses
  %i.dj = load i64, ptr %i.bf, align 8
  %i.dk = icmp sgt i64 %i.dj, %i.di
  br i1 %i.dk, label %bb.l, label %.loopexit, !llvm.loop !1456
...
.loopexit:                                        ; preds = %_ZN10QCPPainter8drawLineERK6QLineF.exit71, %_ZN10QCPPainter6setPenERK4QPen.exit49, %_ZN10QCPPainter8drawLineERK6QLineF.exit
  %i.dl = getelementptr i8, ptr %0, i64 432       ; 3 uses
  %i.dm = load i64, ptr %i.dl, align 8
  %i.dn = icmp eq i64 %i.dm, 0
  br i1 %i.dn, label %bb.aj, label %bb.p

bb.p:                                             ; preds = %.loopexit
  %i.do = getelementptr i8, ptr %0, i64 520       ; 2 uses
  %i.dp = getelementptr i8, ptr %0, i64 536
  %i.dq = load <2 x double>, ptr %i.ac, align 8
  %i.dr = load <2 x double>, ptr %6, align 16
  %i.ds = fsub <2 x double> %i.dq, %i.dr
  store <2 x double> %i.ds, ptr %i.dp, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %12) #51
  %i.dt = load i32, ptr %i.v, align 8, !noalias !1457
  %i.du = and i32 %i.dt, 2
  %.not.i74 = icmp eq i32 %i.du, 0
  %.v.i75 = select i1 %.not.i74, i64 224, i64 240
  %i.dv = getelementptr i8, ptr %0, i64 %.v.i75
  call void @_ZN5QFontC1ERKS_(ptr noundef nonnull align 8 dereferenceable_or_null(12) %12, ptr noundef align 8 dereferenceable(12) %i.dv)
  %i.dw = getelementptr i8, ptr %0, i64 560       ; 2 uses
  %i.dx = invoke noundef zeroext i1 @_ZNK5QFontneERKS_(ptr noundef align 8 dereferenceable_or_null(12) %i.dw, ptr noundef nonnull align 8 dereferenceable(12) %12)
          to label %.noexc76 unwind label %bb.s

.noexc76:                                         ; preds = %bb.p
  br i1 %i.dx, label %bb.q, label %_ZN22QCPLabelPainterPrivate7setFontERK5QFont.exit

bb.q:                                             ; preds = %.noexc76
  %i.dy = invoke noundef align 8 dereferenceable(12) ptr @_ZN5QFontaSERKS_(ptr noundef align 8 dereferenceable_or_null(12) %i.dw, ptr noundef nonnull align 8 dereferenceable(12) %12)
          to label %.noexc77 unwind label %bb.s   ; 0 uses

.noexc77:                                         ; preds = %bb.q
  invoke void @_ZN22QCPLabelPainterPrivate18analyzeFontMetricsEv(ptr noundef align 8 dereferenceable_or_null(256) %i.do)
...
_ZN22QCPLabelPainterPrivate7setFontERK5QFont.exit: ; preds = %.noexc76, %.noexc77
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %12) #51
  %i.dz = load i32, ptr %i.v, align 8             ; 2 uses
  %i.ea = and i32 %i.dz, 2
  %.not.i79 = icmp eq i32 %i.ea, 0
  %.v.i80 = select i1 %.not.i79, i64 256, i64 272
  %i.eb = getelementptr i8, ptr %0, i64 %.v.i80   ; 2 uses
  %.sroa.0.0.copyload.i = load i64, ptr %i.eb, align 8
  %.sroa.2.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.eb, i64 8
  %.sroa.2.0.copyload.i = load i64, ptr %.sroa.2.0..sroa_idx.i, align 8
  %.sroa.2.0.extract.trunc = trunc i64 %.sroa.2.0.copyload.i to i48
  %i.ec = getelementptr i8, ptr %0, i64 576
  store i64 %.sroa.0.0.copyload.i, ptr %i.ec, align 8
  %.sroa.4132.0..sroa_idx = getelementptr i8, ptr %0, i64 584
  store i48 %.sroa.2.0.extract.trunc, ptr %.sroa.4132.0..sroa_idx, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %13) #51
  %i.ed = and i32 %i.dz, 1
  %.not.i83 = icmp eq i32 %i.ed, 0
  %.v.i84 = select i1 %.not.i83, i64 320, i64 328
  %i.ee = getelementptr i8, ptr %0, i64 %.v.i84
  call void @_ZN4QPenC1ERKS_(ptr noundef nonnull align 8 dereferenceable_or_null(8) %13, ptr noundef align 8 dereferenceable(8) %i.ee) #51
...
.noexc86:                                         ; preds = %_ZN22QCPLabelPainterPrivate7setFontERK5QFont.exit
  %i.ef = load i32, ptr %i.z, align 4
  %i.eg = and i32 %i.ef, 4
  %.not.i85 = icmp eq i32 %i.eg, 0
...
_ZN10QCPPainter6setPenERK4QPen.exit88:            ; preds = %bb.r, %.noexc86
  %i.eh = load i64, ptr %i.dl, align 8
  %i.ei = icmp sgt i64 %i.eh, 0
  br i1 %i.ei, label %.lr.ph168, label %._crit_edge

.lr.ph168:                                        ; preds = %_ZN10QCPPainter6setPenERK4QPen.exit88
  %i.ej = getelementptr i8, ptr %0, i64 424
  %i.ek = getelementptr i8, ptr %0, i64 300
  ...
  %i.el = getelementptr i8, ptr %0, i64 456
  %i.em = getelementptr i8, ptr %0, i64 368
  %i.en = getelementptr i8, ptr %0, i64 312
  %i.eo = getelementptr i8, ptr %0, i64 448
  %i.ep = shufflevector <2 x double> %i.u, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.eq = shufflevector <2 x double> %i.u, <2 x double> poison, <2 x i32> zeroinitializer
  br label %bb.u
...
bb.u:                                             ; preds = %.lr.ph168, %bb.ah
  %i.et = phi i64 [ 0, %.lr.ph168 ], [ %i.hf, %bb.ah ] ; 3 uses
  %.0166 = phi i32 [ 0, %.lr.ph168 ], [ %i.he, %bb.ah ] ; 2 uses
  %i.eu = load ptr, ptr %i.ej, align 8
  %i.ev = getelementptr [8 x i8], ptr %i.eu, i64 %i.et
  %i.ew = load double, ptr %i.ev, align 8
  %i.ex = call noundef double @_ZNK18QCPPolarAxisRadial13coordToRadiusEd(ptr noundef align 8 dereferenceable_or_null(776) %0, double noundef %i.ew) ; 3 uses
  %i.ey = load <2 x double>, ptr %6, align 16
  ...
  %i.fb = fmul <2 x double> %i.fa, %i.ey
  %i.fc = load <2 x double>, ptr %i.ac, align 8
  %i.fd = fadd <2 x double> %i.fb, %i.fc          ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %14) #51
  %i.fe = load <2 x i32>, ptr %i.ek, align 4
  %i.ff = sitofp <2 x i32> %i.fe to <2 x double>  ; 2 uses
  %i.fg = fmul <2 x double> %i.eq, %i.ff          ; 2 uses
  %i.fh = fmul <2 x double> %i.ep, %i.ff          ; 2 uses
  %i.fi = shufflevector <2 x double> %i.fd, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.fj = fsub <2 x double> %i.fi, %i.fg          ; 2 uses
  %i.fk = fadd <2 x double> %i.fi, %i.fg          ; 2 uses
  %i.fl = shufflevector <2 x double> %i.fj, <2 x double> %i.fk, <2 x i32> <i32 0, i32 3> ; 2 uses
  %i.fm = shufflevector <2 x double> %i.fd, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.fn = fsub <2 x double> %i.fm, %i.fh          ; 2 uses
  %i.fo = fadd <2 x double> %i.fm, %i.fh          ; 2 uses
  %i.fp = shufflevector <2 x double> %i.fn, <2 x double> %i.fo, <2 x i32> <i32 0, i32 3> ; 2 uses
  %i.fq = extractelement <2 x double> %i.fj, i64 0
  store double %i.fq, ptr %14, align 8
  %i.fr = shufflevector <2 x double> %i.fn, <2 x double> %i.fk, <2 x i32> <i32 0, i32 3>
  store <2 x double> %i.fr, ptr %.sroa.5124.0..sroa_idx, align 8
  %i.fs = extractelement <2 x double> %i.fo, i64 1
  store double %i.fs, ptr %.sroa.5120.0..sroa_idx, align 8
  %i.ft = load i8, ptr %i.an, align 4, !range !6, !noundef !7
  %i.fu = trunc nuw i8 %i.ft to i1
  br i1 %i.fu, label %bb.w, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.fv = load i32, ptr %i.z, align 4
  %i.fw = and i32 %i.fv, 1
  %.not.i101 = icmp eq i32 %i.fw, 0
...
bb.x:                                             ; preds = %bb.v
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #51
  %i.fx = call <2 x double> @llvm.copysign.v2f64(<2 x double> splat (double 5.000000e-01), <2 x double> %i.fl)
  %i.fy = call <2 x double> @llvm.copysign.v2f64(<2 x double> splat (double 5.000000e-01), <2 x double> %i.fp)
  %i.fz = fadd <2 x double> %i.fl, %i.fx
  %i.ga = fptosi <2 x double> %i.fz to <2 x i32>
  %i.gb = fadd <2 x double> %i.fp, %i.fy
  %i.gc = fptosi <2 x double> %i.gb to <2 x i32>
  %i.gd = zext <2 x i32> %i.gc to <2 x i64>
  %i.ge = shl nuw <2 x i64> %i.gd, splat (i64 32)
  %i.gf = zext <2 x i32> %i.ga to <2 x i64>
  %i.gg = or disjoint <2 x i64> %i.ge, %i.gf
  store <2 x i64> %i.gg, ptr %2, align 16
...
_ZN10QCPPainter8drawLineERK6QLineF.exit112:       ; preds = %.noexc111, %bb.w
  ...
  %i.gh = load i64, ptr %i.el, align 8            ; 2 uses
  %i.gi = icmp eq i64 %i.gh, 0
  br i1 %i.gi, label %bb.ah, label %bb.y

bb.y:                                             ; preds = %_ZN10QCPPainter8drawLineERK6QLineF.exit112
  %i.gj = load i8, ptr %i.em, align 8, !range !6, !noundef !7
  %i.gk = trunc nuw i8 %i.gj to i1
  br i1 %i.gk, label %bb.ab, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.gl = add i64 %i.gh, -1
  %i.gm = icmp sgt i64 %i.gl, %i.et
  br i1 %i.gm, label %bb.ad, label %bb.aa
