...
.lr.ph:                                           ; preds = %bb.c, %.backedge
  ...
  %.04168 = phi i32 [ %.041.be, %.backedge ], [ %1, %bb.c ] ; 11 uses
  %.05667 = phi i16 [ %.163, %.backedge ], [ 0, %bb.c ] ; 2 uses
  %i.g = load i32, ptr @ett_zvt_tlv_dat_obj, align 4
  %i.h = call ptr @proto_tree_add_subtree(ptr noundef %4, ptr noundef %0, i32 noundef %.04168, i32 noundef -1, i32 noundef %i.g, ptr noundef nonnull %i.a, ptr noundef nonnull @.str.185) ; 3 uses
  %i.i = call zeroext i8 @tvb_get_uint8(ptr noundef %0, i32 noundef %.04168)
  %i.j = zext i8 %i.i to i32                      ; 3 uses
  %i.k = add i32 %.04168, 1                       ; 2 uses
  %i.l = and i32 %i.j, 31
...
dissect_zvt_tlv_tag.exit:                         ; preds = %.lr.ph, %.preheader.preheader.i, %.preheader.1.i, %.preheader.2.i, %.preheader.3.i
  ...
  %i.as = call ptr @proto_tree_add_item(ptr noundef %i.aq, i32 noundef %i.ar, ptr noundef %0, i32 noundef %.04168, i32 noundef 1, i32 noundef 0) ; 0 uses
  %i.at = load i32, ptr @hf_zvt_tlv_tag_type, align 4
  %i.au = call ptr @proto_tree_add_item(ptr noundef %i.aq, i32 noundef %i.at, ptr noundef %0, i32 noundef %.04168, i32 noundef 1, i32 noundef 0) ; 0 uses
...
bb.k:                                             ; preds = %bb.j
  %i.bt = call i32 %i.bs(ptr noundef %0, i32 noundef %i.bi, i32 noundef %.pre-phi, ptr noundef %3, ptr noundef %i.h, ptr noundef %.0) ; 0 uses
  br label %bb.l
...
.backedge:                                        ; preds = %bb.l, %dissect_zvt_tlv_len.exit
  %.041.be = phi i32 [ %i.bi, %dissect_zvt_tlv_len.exit ], [ %i.bu, %bb.l ] ; 2 uses
  %i.bv = sub i32 %.041.be, %1                    ; 3 uses
