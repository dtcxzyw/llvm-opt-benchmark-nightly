...
dissect_zvt_tlv_tag.exit:                         ; preds = %.lr.ph, %.preheader.preheader.i, %.preheader.1.i, %.preheader.2.i, %.preheader.3.i
  ...
  %i.am = sub i32 %.136.i, %.04068                ; 3 uses
  %i.an = call ptr @val_to_str_ext_const(i32 noundef %.1.i, ptr noundef nonnull @tlv_tags_ext, ptr noundef nonnull @.str.183)
  %i.ao = call ptr (ptr, i32, ptr, i32, i32, i32, ptr, ...) @proto_tree_add_uint_format(ptr noundef %i.h, i32 noundef %i.al, ptr noundef %0, i32 noundef %.04068, i32 noundef %i.am, i32 noundef %.1.i, ptr noundef nonnull @.str.186, ptr noundef %i.an, i32 noundef %.1.i)
...
bb.h:                                             ; preds = %bb.d, %bb.f, %bb.g
  ...
  %i.bg = call ptr @proto_tree_add_uint(ptr noundef %i.h, i32 noundef %i.aw, ptr noundef %0, i32 noundef %.136.i, i32 noundef %.0.i52, i32 noundef %i.bf) ; 0 uses
  %i.bh = add i32 %.0.i52, %.136.i
  br label %dissect_zvt_tlv_len.exit
...
bb.ag:                                            ; preds = %bb.d, %bb.a, %bb.af
  %.099.a = phi i32 [ %i.n, %bb.af ], [ -1, %bb.a ], [ -1, %bb.d ]
