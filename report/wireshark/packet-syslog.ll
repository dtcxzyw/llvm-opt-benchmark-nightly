Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/wireshark/original/packet-syslog?download=true
...
bb.cf:                                            ; preds = %bb.ce
  ...
  %.not.i128 = icmp eq ptr %i.ob, null
  br i1 %.not.i128, label %proto_item_set_generated.exit, label %bb.cg
...
proto_item_set_generated.exit:                    ; preds = %bb.cf, %bb.cg, %bb.ch
  ...
  %i.oi = call i32 @call_dissector(ptr noundef %i.oh, ptr noundef nonnull %.021.i130136, ptr noundef %1, ptr noundef %2) ; 0 uses
  br label %bb.ci
...
bb.b:                                             ; preds = %bb.d, %bb.a
  ...
  %.039 = phi i32 [ %i.m, %bb.d ], [ 0, %bb.a ]   ; 8 uses
  %i.b = add i32 %.039, %2                        ; 2 uses
  %i.c = tail call zeroext i1 @tvb_bytes_exist(ptr noundef %1, i32 noundef %i.b, i32 noundef 1)
  %i.d = icmp samesign ult i32 %.039, 5
  %i.e = and i1 %i.c, %i.d
...
bb.d:                                             ; preds = %bb.c
  %i.k = icmp eq i32 %.039, 0
  %i.l = icmp eq i8 %i.f, 48
  %or.cond = and i1 %i.k, %i.l
  %i.m = add nuw nsw i32 %.039, 1
...
bb.e:                                             ; preds = %.thread
  ...
  %i.p = tail call ptr @tvb_get_string_enc(ptr noundef %i.o, ptr noundef %1, i32 noundef %2, i32 noundef %.039, i32 noundef 0) ; 5 uses
...
bb.k:                                             ; preds = %bb.j
  %i.bb = add nuw nsw i32 %.039, 1                ; 2 uses
...
.thread47:                                        ; preds = %bb.d, %bb.l, %.thread, %bb.j, %bb.k
  %.041 = phi i32 [ 0, %.thread ], [ %spec.select, %bb.l ], [ 0, %bb.k ], [ 0, %bb.j ], [ 0, %bb.d ]
  ret i32 %.041
}
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.y, label %._crit_edge136, label %bb.g

._crit_edge136:                                   ; preds = %bb.f
  %.pre = load i32, ptr %i.a, align 4
  br label %bb.i

bb.g:                                             ; preds = %bb.f
  %i.z = call i32 @tvb_reported_length(ptr noundef %1) ; 4 uses
  %.not106 = icmp eq i32 %i.z, 0
  br i1 %.not106, label %bb.r, label %bb.h
...
bb.i:                                             ; preds = %._crit_edge136, %.critedge
  %i.ad = phi i32 [ %.pre, %._crit_edge136 ], [ %i.z, %.critedge ]
