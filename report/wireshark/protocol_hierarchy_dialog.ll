Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/wireshark/original/protocol_hierarchy_dialog?download=true
...
bb.a:
  %4 = alloca %struct.QArrayDataPointer.32, align 16 ; 13 uses
  %i.a = icmp ne i32 %1, 0
...
_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit.thread: ; preds = %bb.b, %_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit, %bb.a
  ...
  call void @_ZN17QArrayDataPointerI8QVariantE12allocateGrowERKS1_xN10QArrayData14GrowthPositionE(ptr dead_on_unwind nonnull writable sret(%struct.QArrayDataPointer.32) align 8 %4, ptr noundef align 8 dereferenceable(24) %0, i64 noundef %2, i32 noundef %1)
...
.noexc:                                           ; preds = %bb.i
  ...
  br i1 %i.aq, label %bb.i, label %_ZN9QtPrivate16QGenericArrayOpsI8QVariantE10copyAppendEPKS1_S4_.exit, !llvm.loop !121
...
bb.l:                                             ; preds = %bb.l, %.lr.ph.i34.a
  ...
  br i1 %i.bd, label %bb.l, label %_ZN9QtPrivate16QGenericArrayOpsI8QVariantE10copyAppendEPKS1_S4_.exit, !llvm.loop !122
...
; Function Attrs: mustprogress null_pointer_is_valid sspstrong uwtable
define linkonce_odr void @_ZN17QArrayDataPointerI8QVariantE12allocateGrowERKS1_xN10QArrayData14GrowthPositionE(ptr dead_on_unwind noalias writable sret(%struct.QArrayDataPointer.32) align 8 %0, ptr noundef align 8 dereferenceable(24) %1, i64 noundef %2, i32 noundef %3) local_unnamed_addr #0 comdat align 2 {
bb.a:
