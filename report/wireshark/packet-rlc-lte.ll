...
bb.eg:                                            ; preds = %bb.ef
  ...
  %i.abm = icmp eq i8 %i.abl, 16
  %i.abn = select i1 %i.abm, i32 65536, i32 1024  ; 3 uses
  ...
  %7 = and i32 %i.abr, 65535
  %reass.sub = sub nsw i32 %i.abq, %7
  %i.abs = add nsw i32 %reass.sub, 1
  %i.abt = add nsw i32 %i.abs, %i.abn
  %8 = add nsw i32 %i.abn, -1
  %i.abu = and i32 %i.abt, %8
...
bb.bb:                                            ; preds = %proto_item_set_hidden.exit
  ...
  %. = select i1 %i.je, i32 32, i32 1024          ; 2 uses
...
bb.bh:                                            ; preds = %proto_item_set_generated.exit276
  ...
  %i.kz = sub nsw i32 %i.kw, %i.ky
  %i.la = srem i32 %i.kz, %.
  %i.lb = trunc nsw i32 %i.la to i16
