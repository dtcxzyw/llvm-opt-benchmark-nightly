...
bb.l:                                             ; preds = %bb.k
  %i.au = shl nuw nsw i32 %i.q, 2
  %i.av = load i32, ptr @hf_reserved, align 4
  %i.aw = sdiv i32 %i.ap, 8
  %i.ax = srem i32 %i.ap, 8
  %i.ay = add nsw i32 %i.ax, 246
  %i.az = add nuw nsw i32 %i.ay, %i.au
  %i.ba = trunc i32 %i.az to i8
  %.lhs.trunc73 = add nsw i8 %i.ba, -1
  %i.bb = sdiv i8 %.lhs.trunc73, 8
  %narrow74 = add nsw i8 %i.bb, 1
  %i.bc = sext i8 %narrow74 to i32
  %i.bd = tail call ptr (ptr, i32, ptr, i32, i32, ptr, ptr, ...) @proto_tree_add_bytes_format(ptr noundef %i.m, i32 noundef %i.av, ptr noundef %2, i32 noundef %i.aw, i32 noundef %i.bc, ptr noundef null, ptr noundef nonnull @.str.550) ; 0 uses
  br label %bb.o

bb.m:                                             ; preds = %bb.g
  %i.be = icmp samesign ugt i8 %.in67, 2
...
bb.l:                                             ; preds = %bb.k
  %i.dh = sub nsw i32 4, %i.dg                    ; 3 uses
  %i.di = load i32, ptr @hf_padding, align 4
  %i.dj = sdiv i32 %.4, 8
  %i.dk = srem i32 %.4, 8
  %i.dl = add nsw i32 %i.dh, %i.dk
  %i.dm = trunc nsw i32 %i.dl to i8
  %.lhs.trunc = add nsw i8 %i.dm, -1
  %i.dn = sdiv i8 %.lhs.trunc, 8
  %narrow = add nuw nsw i8 %i.dn, 1
  %i.do = zext nneg i8 %narrow to i32
  %i.dp = tail call ptr (ptr, i32, ptr, i32, i32, ptr, ptr, ...) @proto_tree_add_bytes_format_value(ptr noundef %i.c, i32 noundef %i.di, ptr noundef %2, i32 noundef %i.dj, i32 noundef %i.do, ptr noundef null, ptr noundef nonnull @.str.12, i32 noundef %i.dh) ; 0 uses
  %i.dq = add i32 %i.dh, %.4
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %bb.k
  %.5 = phi i32 [ %i.dq, %bb.l ], [ %.4, %bb.k ]
end_hunk_0
