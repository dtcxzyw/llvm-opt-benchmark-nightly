...
bb.fd:                                            ; preds = %bb.et
  ...
  %16 = or disjoint <2 x i32> %i.bmd, splat (i32 3) ; 2 uses
  %17 = extractelement <2 x i32> %16, i64 0
  %18 = sdiv i32 %17, 8
  %19 = add nuw nsw i32 %18, 1
  %i.bme = tail call ptr @proto_tree_add_uint(ptr noundef %i.blm, i32 noundef %i.bma, ptr noundef %3, i32 noundef %i.blo, i32 noundef %19, i32 noundef %i.blz) ; 0 uses
  ...
  %i.bmk = tail call ptr @proto_tree_add_uint(ptr noundef %i.blm, i32 noundef %i.bmj, ptr noundef %3, i32 noundef %i.bmb, i32 noundef %22, i32 noundef %i.bmi) ; 0 uses
...
bb.fe:                                            ; preds = %bb.et
  ...
  %23 = or disjoint i32 %i.bow, 3
  %24 = sdiv i32 %23, 8
  %25 = add nuw nsw i32 %24, 1
  %i.bpb = tail call ptr @proto_tree_add_uint(ptr noundef %i.bos, i32 noundef %i.bpa, ptr noundef %3, i32 noundef %i.bot, i32 noundef %25, i32 noundef %i.boz) ; 0 uses
  ...
  %26 = or disjoint i32 %i.bpg, 3
  %27 = sdiv i32 %26, 8
  %28 = add nuw nsw i32 %27, 1
  %i.bpl = tail call ptr @proto_tree_add_uint(ptr noundef %i.bos, i32 noundef %i.bpk, ptr noundef %3, i32 noundef %i.bpd, i32 noundef %28, i32 noundef %i.bpj) ; 0 uses
...
bb.ff:                                            ; preds = %bb.et
  ...
  %29 = or disjoint i32 %i.bqw, 3
  %30 = sdiv i32 %29, 8
  %31 = add nuw nsw i32 %30, 1
  %i.brb = tail call ptr @proto_tree_add_uint(ptr noundef %i.bqs, i32 noundef %i.bra, ptr noundef %3, i32 noundef %i.bqt, i32 noundef %31, i32 noundef %i.bqz) ; 0 uses
  ...
  %32 = or disjoint i32 %i.brg, 3
  %33 = sdiv i32 %32, 8
  %34 = add nuw nsw i32 %33, 1
  %i.brl = tail call ptr @proto_tree_add_uint(ptr noundef %i.bqs, i32 noundef %i.brk, ptr noundef %3, i32 noundef %i.brd, i32 noundef %34, i32 noundef %i.brj) ; 0 uses
...
bb.fj:                                            ; preds = %bb.et
  ...
  %35 = or disjoint i32 %i.buj, 3
  %36 = sdiv i32 %35, 8
  %37 = add nuw nsw i32 %36, 1
  %i.buo = tail call ptr @proto_tree_add_uint(ptr noundef %i.buf, i32 noundef %i.bun, ptr noundef %3, i32 noundef %i.bug, i32 noundef %37, i32 noundef %i.bum) ; 0 uses
  ...
  %38 = or disjoint i32 %i.but, 3
  %39 = sdiv i32 %38, 8
  %40 = add nuw nsw i32 %39, 1
  %i.buy = tail call ptr @proto_tree_add_uint(ptr noundef %i.buf, i32 noundef %i.bux, ptr noundef %3, i32 noundef %i.buq, i32 noundef %40, i32 noundef %i.buw) ; 0 uses
...
bb.fl:                                            ; preds = %bb.et
  ...
  %41 = or disjoint i32 %i.bxk, 3
  %42 = sdiv i32 %41, 8
  %43 = add nuw nsw i32 %42, 1
  %i.bxp = tail call ptr @proto_tree_add_uint(ptr noundef %i.bxg, i32 noundef %i.bxo, ptr noundef %3, i32 noundef %i.bxh, i32 noundef %43, i32 noundef %i.bxn) ; 0 uses
  ...
  %44 = or disjoint i32 %i.bxu, 3
  %45 = sdiv i32 %44, 8
  %46 = add nuw nsw i32 %45, 1
  %i.bxz = tail call ptr @proto_tree_add_uint(ptr noundef %i.bxg, i32 noundef %i.bxy, ptr noundef %3, i32 noundef %i.bxr, i32 noundef %46, i32 noundef %i.bxx) ; 0 uses
...
bb.fm:                                            ; preds = %bb.et
  ...
  %47 = or disjoint i32 %i.bzf, 3
  %48 = sdiv i32 %47, 8
  %49 = add nuw nsw i32 %48, 1
  %i.bzk = tail call ptr @proto_tree_add_uint(ptr noundef %i.bzb, i32 noundef %i.bzj, ptr noundef %3, i32 noundef %i.bzc, i32 noundef %49, i32 noundef %i.bzi) ; 0 uses
  ...
  %50 = or disjoint i32 %i.bzp, 3
  %51 = sdiv i32 %50, 8
  %52 = add nuw nsw i32 %51, 1
  %i.bzu = tail call ptr @proto_tree_add_uint(ptr noundef %i.bzb, i32 noundef %i.bzt, ptr noundef %3, i32 noundef %i.bzm, i32 noundef %52, i32 noundef %i.bzs) ; 0 uses
...
bb.fo:                                            ; preds = %bb.et
  ...
  %53 = or disjoint i32 %i.cbb, 3
  %54 = sdiv i32 %53, 8
  %55 = add nuw nsw i32 %54, 1
  %i.cbg = tail call ptr @proto_tree_add_uint(ptr noundef %i.cax, i32 noundef %i.cbf, ptr noundef %3, i32 noundef %i.cay, i32 noundef %55, i32 noundef %i.cbe) ; 0 uses
  ...
  %56 = or disjoint i32 %i.cbl, 3
  %57 = sdiv i32 %56, 8
  %58 = add nuw nsw i32 %57, 1
  %i.cbq = tail call ptr @proto_tree_add_uint(ptr noundef %i.cax, i32 noundef %i.cbp, ptr noundef %3, i32 noundef %i.cbi, i32 noundef %58, i32 noundef %i.cbo) ; 0 uses
...
bb.fp:                                            ; preds = %bb.et
  ...
  %59 = or disjoint i32 %i.cdw, 3
  %60 = sdiv i32 %59, 8
  %61 = add nuw nsw i32 %60, 1
  %i.ceb = tail call ptr @proto_tree_add_uint(ptr noundef %i.cds, i32 noundef %i.cea, ptr noundef %3, i32 noundef %i.cdt, i32 noundef %61, i32 noundef %i.cdz) ; 0 uses
  ...
  %62 = or disjoint i32 %i.ceg, 3
  %63 = sdiv i32 %62, 8
  %64 = add nuw nsw i32 %63, 1
  %i.cel = tail call ptr @proto_tree_add_uint(ptr noundef %i.cds, i32 noundef %i.cek, ptr noundef %3, i32 noundef %i.ced, i32 noundef %64, i32 noundef %i.cej) ; 0 uses
