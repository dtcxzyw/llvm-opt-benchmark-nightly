...
._crit_edge:                                      ; preds = %bb.e, %bb.f, %.lr.ph, %bb.g
  %.0186303 = phi i8 [ 0, %bb.g ], [ %i.u, %.lr.ph ], [ 0, %bb.f ], [ 0, %bb.e ] ; 6 uses
...
.thread:                                          ; preds = %bb.b, %bb.a, %bb.k, %bb.m, %bb.l, %bb.i, %bb.h, %._crit_edge
  ...
  %.2188231.shrunk = phi i8 [ %.0186303, %._crit_edge ], [ %.0186303, %bb.k ], [ %.0186303, %bb.m ], [ %.0186303, %bb.l ], [ %.0186303, %bb.i ], [ %.0186303, %bb.h ], [ 0, %bb.a ], [ 0, %bb.b ] ; 2 uses
