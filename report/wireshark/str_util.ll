Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/wireshark/original/str_util?download=true
...
._crit_edge:                                      ; preds = %.lr.ph, %bb.b, %bb.a
  %.09 = phi ptr [ null, %bb.a ], [ null, %bb.b ], [ %.01014, %.lr.ph ]
  ret ptr %.09
}
...
.preheader.preheader:                             ; preds = %bb.d
  br i1 %.not.i.not, label %.lr.ph128, label %.loopexit84
...
.preheader:                                       ; preds = %.lr.ph128
  ...
  br i1 %i.r, label %.loopexit84, label %.lr.ph128, !llvm.loop !23

.lr.ph128:                                        ; preds = %.preheader.preheader, %.preheader
  %.06495127 = phi double [ %i.s, %.preheader ], [ %i.b, %.preheader.preheader ]
  %.096126 = phi i32 [ %i.t, %.preheader ], [ %i.d, %.preheader.preheader ]
  %i.s = fmul double %i.n, %.06495127             ; 3 uses
  %i.t = add nsw i32 %.096126, -1                 ; 3 uses
...
bb.f:                                             ; preds = %.lr.ph, %bb.e
  %.16592125 = phi double [ %i.b, %.lr.ph ], [ %i.w, %bb.e ]
  %.193124 = phi i32 [ %i.d, %.lr.ph ], [ %i.x, %bb.e ]
  %i.w = fdiv double %.16592125, %i.n             ; 3 uses
  %i.x = add i32 %.193124, 1                      ; 3 uses
...
.loopexit:                                        ; preds = %bb.f, %.lr.ph128, %.preheader85, %bb.c
  %.367.ph = phi double [ %i.b, %bb.c ], [ %i.s, %.lr.ph128 ], [ %i.b, %.preheader85 ], [ %i.w, %bb.f ]
  %.3.ph = phi i32 [ %i.d, %bb.c ], [ %i.t, %.lr.ph128 ], [ %i.d, %.preheader85 ], [ %i.x, %bb.f ] ; 3 uses
  %i.aa = icmp eq i32 %.3.ph, %i.d                ; 2 uses
  %i.ab = tail call double @llvm.copysign.f64(double %.367.ph, double %1)
...
bb.a:
  ...
  br i1 %i.c, label %.lr.ph782, label %._crit_edge783.thread

.lr.ph782:                                        ; preds = %bb.a
  %i.d = load ptr, ptr @g_ascii_table, align 8
  br label %bb.b

bb.b:                                             ; preds = %.lr.ph782, %bb.dx
  %.0420779 = phi i64 [ 0, %.lr.ph782 ], [ %.2422, %bb.dx ] ; 6 uses
  %.0426778 = phi ptr [ %1, %.lr.ph782 ], [ %.1427, %bb.dx ] ; 2 uses
  %.0428777 = phi i32 [ 0, %.lr.ph782 ], [ %.5, %bb.dx ] ; 4 uses
  %.0432776 = phi i32 [ 128, %.lr.ph782 ], [ %.25, %bb.dx ] ; 6 uses
  %.0439775 = phi ptr [ %i.a, %.lr.ph782 ], [ %.15454, %bb.dx ] ; 8 uses
  %i.e = phi i64 [ 128, %.lr.ph782 ], [ %i.qd, %bb.dx ] ; 3 uses
  %i.f = phi i64 [ 128, %.lr.ph782 ], [ %i.qc, %bb.dx ] ; 3 uses
  %.0462774 = phi ptr [ %1, %.lr.ph782 ], [ %.4466, %bb.dx ] ; 8 uses
  %i.g = getelementptr i8, ptr %.0462774, i64 1   ; 25 uses
  %i.h = load i8, ptr %.0462774, align 1          ; 11 uses
...
bb.c:                                             ; preds = %bb.b
  %i.k = add i64 %.0420779, 1
  br label %bb.dx

bb.d:                                             ; preds = %bb.b
  %.not504 = icmp eq i64 %.0420779, 0
  br i1 %.not504, label %bb.m, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.l = zext i32 %.0428777 to i64                ; 6 uses
  %i.m = add nuw nsw i64 %i.l, 1
  %i.n = add i64 %i.m, %.0420779                  ; 2 uses
  %i.o = zext i32 %.0432776 to i64
  %.not505.a = icmp ult i64 %i.n, %i.o
  br i1 %.not505.a, label %bb.l, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.p = icmp slt i32 %.0432776, 0
  br i1 %i.p, label %bb.g, label %bb.h

bb.g:                                             ; preds = %bb.f
  %i.q = getelementptr i8, ptr %.0439775, i64 %i.l
  store i8 0, ptr %i.q, align 1
  br label %.thread567

bb.h:                                             ; preds = %bb.f
  %i.r = shl nuw i32 %.0432776, 1                 ; 2 uses
  %i.s = zext i32 %i.r to i64                     ; 4 uses
  %.not506.a = icmp ult i64 %i.n, %i.s
  br i1 %.not506.a, label %bb.k, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.t = add nuw nsw i64 %i.l, 2
  %i.u = sub nsw i64 %i.t, %i.s
  %i.v = add i64 %i.u, %.0420779
  ...
  %i.aa = or i1 %i.x, %i.z
  br i1 %i.aa, label %bb.j, label %._crit_edge856

._crit_edge856:                                   ; preds = %bb.i
  %i.ab = trunc nuw i64 %i.y to i32
  br label %bb.k

bb.j:                                             ; preds = %bb.i
  %i.ac = getelementptr i8, ptr %.0439775, i64 %i.l
  store i8 0, ptr %i.ac, align 1
  br label %.thread567

bb.k:                                             ; preds = %._crit_edge856, %bb.h
  %.pre-phi859 = phi i64 [ %i.y, %._crit_edge856 ], [ %i.s, %bb.h ] ; 3 uses
  %.1433 = phi i32 [ %i.ab, %._crit_edge856 ], [ %i.r, %bb.h ]
  %i.ad = tail call ptr @wmem_realloc(ptr noundef %0, ptr noundef %.0439775, i64 noundef %.pre-phi859) #29
  br label %bb.l

bb.l:                                             ; preds = %bb.k, %bb.e
  %i.ae = phi i64 [ %.pre-phi859, %bb.k ], [ %i.f, %bb.e ]
  %i.af = phi i64 [ %.pre-phi859, %bb.k ], [ %i.e, %bb.e ] ; 2 uses
  %.1440 = phi ptr [ %i.ad, %bb.k ], [ %.0439775, %bb.e ] ; 2 uses
  %.2434 = phi i32 [ %.1433, %bb.k ], [ %.0432776, %bb.e ]
  %i.ag = getelementptr i8, ptr %.1440, i64 %i.l
  %i.ah = tail call i64 @llvm.usub.sat.i64(i64 %i.af, i64 %i.l)
  %i.ai = tail call ptr @__memcpy_chk(ptr noundef %i.ag, ptr noundef %.0426778, i64 noundef range(i64 1, 0) %.0420779, i64 noundef %i.ah) #24, !alias.scope !31 ; 0 uses
  %i.aj = trunc i64 %.0420779 to i32
  %i.ak = add i32 %.0428777, %i.aj
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %bb.d
  %i.al = phi i64 [ %i.ae, %bb.l ], [ %i.f, %bb.d ] ; 7 uses
  %i.am = phi i64 [ %i.af, %bb.l ], [ %i.e, %bb.d ] ; 7 uses
  %.2441 = phi ptr [ %.1440, %bb.l ], [ %.0439775, %bb.d ] ; 42 uses
  %.3435 = phi i32 [ %.2434, %bb.l ], [ %.0432776, %bb.d ] ; 28 uses
  %.1429 = phi i32 [ %i.ak, %bb.l ], [ %.0428777, %bb.d ] ; 73 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  %.not507 = icmp eq i16 %i.aq, 0
  br i1 %.not507, label %bb.w, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.ar = add i32 %.1429, 2                       ; 2 uses
  %.not529.a = icmp ult i32 %i.ar, %.3435
  br i1 %.not529.a, label %bb.v, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.as = icmp slt i32 %.3435, 0
  %i.at = shl i32 %.3435, 1                       ; 4 uses
  br i1 %i.as, label %bb.q, label %bb.r

bb.q:                                             ; preds = %bb.p
  %i.au = zext i32 %.1429 to i64
  %i.av = getelementptr i8, ptr %.2441, i64 %i.au
  store i8 0, ptr %i.av, align 1
  br label %.thread567

bb.r:                                             ; preds = %bb.p
  %.not530.a = icmp ult i32 %i.ar, %i.at
  br i1 %.not530.a, label %bb.u, label %bb.s
...
bb.t:                                             ; preds = %bb.s
  %i.bb = zext i32 %.1429 to i64
  %i.bc = getelementptr i8, ptr %.2441, i64 %i.bb
  store i8 0, ptr %i.bc, align 1
  br label %.thread567

bb.u:                                             ; preds = %bb.s, %bb.r
  %.4436 = phi i32 [ %i.ba, %bb.s ], [ %i.at, %bb.r ] ; 2 uses
  %i.bd = zext i32 %.4436 to i64                  ; 3 uses
  %i.be = tail call ptr @wmem_realloc(ptr noundef %0, ptr noundef %.2441, i64 noundef %i.bd) #29
  br label %bb.v

bb.v:                                             ; preds = %bb.u, %bb.o
  %i.bf = phi i64 [ %i.bd, %bb.u ], [ %i.al, %bb.o ]
  %i.bg = phi i64 [ %i.bd, %bb.u ], [ %i.am, %bb.o ]
  %.3442 = phi ptr [ %i.be, %bb.u ], [ %.2441, %bb.o ] ; 2 uses
  %.5437 = phi i32 [ %.4436, %bb.u ], [ %.3435, %bb.o ]
  %i.bh = zext i32 %.1429 to i64
  %i.bi = getelementptr i8, ptr %.3442, i64 %i.bh
...
bb.x:                                             ; preds = %bb.w
  %i.bl = add i32 %.1429, 3                       ; 3 uses
  %.not525.a = icmp ult i32 %i.bl, %.3435
  br i1 %.not525.a, label %bb.ae, label %bb.y

bb.y:                                             ; preds = %bb.x
  %i.bm = icmp slt i32 %.3435, 0
  %i.bn = shl i32 %.3435, 1                       ; 4 uses
  br i1 %i.bm, label %bb.z, label %bb.aa

bb.z:                                             ; preds = %bb.y
  %i.bo = zext i32 %.1429 to i64
  %i.bp = getelementptr i8, ptr %.2441, i64 %i.bo
  store i8 0, ptr %i.bp, align 1
  br label %.thread567

bb.aa:                                            ; preds = %bb.y
  %.not526.a = icmp ult i32 %i.bl, %i.bn
  br i1 %.not526.a, label %bb.ad, label %bb.ab
...
bb.ac:                                            ; preds = %bb.ab
  %i.bv = zext i32 %.1429 to i64
  %i.bw = getelementptr i8, ptr %.2441, i64 %i.bv
  store i8 0, ptr %i.bw, align 1
  br label %.thread567

bb.ad:                                            ; preds = %bb.ab, %bb.aa
  %.6438 = phi i32 [ %i.bu, %bb.ab ], [ %i.bn, %bb.aa ] ; 2 uses
  %i.bx = zext i32 %.6438 to i64                  ; 3 uses
  %i.by = tail call ptr @wmem_realloc(ptr noundef %0, ptr noundef %.2441, i64 noundef %i.bx) #29
  br label %bb.ae

bb.ae:                                            ; preds = %bb.ad, %bb.x
  %i.bz = phi i64 [ %i.bx, %bb.ad ], [ %i.al, %bb.x ] ; 8 uses
  %i.ca = phi i64 [ %i.bx, %bb.ad ], [ %i.am, %bb.x ] ; 8 uses
  %.4443 = phi ptr [ %i.by, %bb.ad ], [ %.2441, %bb.x ] ; 21 uses
  %.7 = phi i32 [ %.6438, %bb.ad ], [ %.3435, %bb.x ] ; 11 uses
  %i.cb = zext i32 %.1429 to i64
  %i.cc = getelementptr i8, ptr %.4443, i64 %i.cb
  store i8 92, ptr %i.cc, align 1
  %i.cd = add i32 %.1429, 1                       ; 10 uses
...
bb.af:                                            ; preds = %bb.ae
  ...
  %i.cf = getelementptr i8, ptr %.4443, i64 %i.ce
...
bb.ag:                                            ; preds = %bb.ae
  ...
  %i.ci = getelementptr i8, ptr %.4443, i64 %i.ch
...
bb.ah:                                            ; preds = %bb.ae
  ...
  %i.cl = getelementptr i8, ptr %.4443, i64 %i.ck
...
bb.ai:                                            ; preds = %bb.ae
  ...
  %i.co = getelementptr i8, ptr %.4443, i64 %i.cn
...
bb.aj:                                            ; preds = %bb.ae
  ...
  %i.cr = getelementptr i8, ptr %.4443, i64 %i.cq
...
bb.ak:                                            ; preds = %bb.ae
  ...
  %i.cu = getelementptr i8, ptr %.4443, i64 %i.ct
...
bb.al:                                            ; preds = %bb.ae
  ...
  %i.cx = getelementptr i8, ptr %.4443, i64 %i.cw
  store i8 118, ptr %i.cx, align 1
  %i.cy = add i32 %.1429, 2
  br label %bb.dx

bb.am:                                            ; preds = %bb.ae
  %i.cz = add i32 %.1429, 5                       ; 2 uses
  %.not527.a = icmp ult i32 %i.cz, %.7
  br i1 %.not527.a, label %bb.at, label %bb.an
...
bb.ao:                                            ; preds = %bb.an
  ...
  %i.dd = getelementptr i8, ptr %.4443, i64 %i.dc
  store i8 0, ptr %i.dd, align 1
  br label %.thread567

bb.ap:                                            ; preds = %bb.an
  %.not528 = icmp ult i32 %i.cz, %i.db
  br i1 %.not528, label %bb.as, label %bb.aq
...
bb.ar:                                            ; preds = %bb.aq
  ...
  %i.dk = getelementptr i8, ptr %.4443, i64 %i.dj
...
bb.ay:                                            ; preds = %bb.ax
  ...
  br i1 %i.en, label %.thread, label %.thread539
...
.thread:                                          ; preds = %bb.aw, %bb.av, %bb.au, %bb.ax, %bb.ay
  ...
  %.0417537 = phi i64 [ 5, %bb.ay ], [ 3, %bb.aw ], [ 2, %bb.av ], [ 1, %bb.au ], [ 4, %bb.ax ]
  %i.eo = getelementptr i8, ptr %.0462774, i64 %.0417537
  %scevgep854 = getelementptr i8, ptr %i.eo, i64 1
  %.not5081034 = icmp ult ptr %i.g, %i.b
  br i1 %.not5081034, label %.lr.ph1038, label %._crit_edge1042

.lr.ph1038:                                       ; preds = %.thread
  %4 = and i8 %.1417540, %i.h
  %5 = zext nneg i8 %4 to i32
  %i.ep = load i8, ptr %i.g, align 1              ; 4 uses
  %i.eq = zext i8 %i.ep to i32                    ; 2 uses
  %i.er = and i32 %i.eq, 192
  %.not509 = icmp eq i32 %i.er, 128
  br i1 %.not509, label %bb.bm, label %._crit_edge1042

bb.az:                                            ; preds = %bb.bm
  %i.es = getelementptr i8, ptr %.0462774, i64 2  ; 4 uses
  %.not508 = icmp ult ptr %i.es, %i.b
  br i1 %.not508, label %bb.ba, label %._crit_edge1042

bb.ba:                                            ; preds = %bb.az
  %i.et = load i8, ptr %i.es, align 1             ; 4 uses
  %i.eu = zext i8 %i.et to i32                    ; 2 uses
  %i.ev = and i32 %i.eu, 192
  %.not509.1 = icmp eq i32 %i.ev, 128
  br i1 %.not509.1, label %bb.bb, label %._crit_edge1042

bb.bb:                                            ; preds = %bb.ba
  %i.ew = shl nuw nsw i32 %i.fx, 6
  %i.ex = and i32 %i.eu, 63
  %i.ey = or disjoint i32 %i.ex, %i.ew            ; 2 uses
  br i1 %exitcond.not.1, label %._crit_edge1039, label %bb.bc, !llvm.loop !35

bb.bc:                                            ; preds = %bb.bb
  %i.ez = getelementptr i8, ptr %.0462774, i64 3  ; 4 uses
  %.not508.1 = icmp ult ptr %i.ez, %i.b
  br i1 %.not508.1, label %bb.bd, label %._crit_edge1042

bb.bd:                                            ; preds = %bb.bc
  %i.fa = load i8, ptr %i.ez, align 1             ; 4 uses
  %i.fb = zext i8 %i.fa to i32                    ; 2 uses
  %i.fc = and i32 %i.fb, 192
  %.not509.2 = icmp eq i32 %i.fc, 128
  br i1 %.not509.2, label %bb.be, label %._crit_edge1042

bb.be:                                            ; preds = %bb.bd
  %i.fd = shl nuw nsw i32 %i.ey, 6
  %i.fe = and i32 %i.fb, 63
  %i.ff = or disjoint i32 %i.fe, %i.fd            ; 2 uses
  br i1 %exitcond.not.2, label %._crit_edge1039, label %bb.bf, !llvm.loop !35

bb.bf:                                            ; preds = %bb.be
  %i.fg = getelementptr i8, ptr %.0462774, i64 4  ; 4 uses
  %.not508.2 = icmp ult ptr %i.fg, %i.b
  br i1 %.not508.2, label %bb.bg, label %._crit_edge1042

bb.bg:                                            ; preds = %bb.bf
  %i.fh = load i8, ptr %i.fg, align 1             ; 4 uses
  %i.fi = zext i8 %i.fh to i32                    ; 2 uses
  %i.fj = and i32 %i.fi, 192
  %.not509.3 = icmp eq i32 %i.fj, 128
  br i1 %.not509.3, label %bb.bh, label %._crit_edge1042

bb.bh:                                            ; preds = %bb.bg
  %i.fk = shl i32 %i.ff, 6
  %i.fl = and i32 %i.fi, 63
  %i.fm = or disjoint i32 %i.fl, %i.fk            ; 2 uses
  br i1 %exitcond.not.3, label %._crit_edge1039, label %bb.bi, !llvm.loop !35

bb.bi:                                            ; preds = %bb.bh
  %i.fn = getelementptr i8, ptr %.0462774, i64 5  ; 4 uses
  %.not508.3 = icmp ult ptr %i.fn, %i.b
  br i1 %.not508.3, label %bb.bj, label %._crit_edge1042

bb.bj:                                            ; preds = %bb.bi
  %i.fo = load i8, ptr %i.fn, align 1             ; 4 uses
  %i.fp = zext i8 %i.fo to i32                    ; 2 uses
  %i.fq = and i32 %i.fp, 192
  %.not509.4 = icmp eq i32 %i.fq, 128
  br i1 %.not509.4, label %bb.bk, label %._crit_edge1042

bb.bk:                                            ; preds = %bb.bj
  %i.fr = shl i32 %i.fm, 6
  %i.fs = and i32 %i.fp, 63
  %i.ft = or disjoint i32 %i.fs, %i.fr
  br i1 %exitcond.not.4, label %._crit_edge1039, label %bb.bl, !llvm.loop !35

bb.bl:                                            ; preds = %bb.bk
  %i.fu = getelementptr i8, ptr %.0462774, i64 6
  br label %._crit_edge1042

bb.bm:                                            ; preds = %.lr.ph1038
  %i.fv = shl nuw nsw i32 %5, 6
  %i.fw = and i32 %i.eq, 63
  %i.fx = or disjoint i32 %i.fw, %i.fv            ; 2 uses
  br i1 %i.ef, label %._crit_edge1039, label %bb.az, !llvm.loop !35

._crit_edge1039:                                  ; preds = %bb.bk, %bb.bh, %bb.be, %bb.bb, %bb.bm
  %.lcssa1051 = phi i8 [ %i.ep, %bb.bm ], [ %i.et, %bb.bb ], [ %i.fa, %bb.be ], [ %i.fh, %bb.bh ], [ %i.fo, %bb.bk ]
  %.lcssa = phi i32 [ %i.fx, %bb.bm ], [ %i.ey, %bb.bb ], [ %i.ff, %bb.be ], [ %i.fm, %bb.bh ], [ %i.ft, %bb.bk ]
  br label %._crit_edge1042, !llvm.loop !35

._crit_edge1042:                                  ; preds = %.lr.ph1038, %bb.az, %bb.ba, %bb.bc, %bb.bd, %bb.bf, %bb.bg, %bb.bi, %bb.bj, %bb.bl, %._crit_edge1039, %.thread
  %.1463.lcssa = phi ptr [ %scevgep854, %._crit_edge1039 ], [ %i.g, %.thread ], [ %i.es, %bb.az ], [ %i.g, %.lr.ph1038 ], [ %i.es, %bb.ba ], [ %i.ez, %bb.bc ], [ %i.ez, %bb.bd ], [ %i.fg, %bb.bf ], [ %i.fg, %bb.bg ], [ %i.fn, %bb.bi ], [ %i.fn, %bb.bj ], [ %i.fu, %bb.bl ] ; 6 uses
  %.1424 = phi i8 [ %.lcssa1051, %._crit_edge1039 ], [ %i.h, %.thread ], [ %i.ep, %bb.az ], [ %i.ep, %.lr.ph1038 ], [ %i.et, %bb.ba ], [ %i.et, %bb.bc ], [ %i.fa, %bb.bd ], [ %i.fa, %bb.bf ], [ %i.fh, %bb.bg ], [ %i.fh, %bb.bi ], [ %i.fo, %bb.bj ], [ %i.fo, %bb.bl ]
  %.1 = phi i32 [ %.lcssa, %._crit_edge1039 ], [ 65533, %.thread ], [ 65533, %bb.bl ], [ 65533, %bb.bj ], [ 65533, %bb.bi ], [ 65533, %bb.bg ], [ 65533, %bb.bf ], [ 65533, %bb.bd ], [ 65533, %bb.bc ], [ 65533, %bb.ba ], [ 65533, %bb.az ], [ 65533, %.lr.ph1038 ] ; 6 uses
  %i.fy = tail call i32 @g_unichar_validate(i32 noundef %.1) #27
  %.not510 = icmp eq i32 %i.fy, 0
  %spec.store.select = select i1 %.not510, i32 65533, i32 %.1 ; 8 uses
  %i.fz = tail call i32 @g_unichar_isprint(i32 noundef %spec.store.select) #27
  %.not511 = icmp eq i32 %i.fz, 0
  br i1 %.not511, label %bb.bz, label %bb.bn

.thread539:                                       ; preds = %bb.ay
  %i.ga = tail call i32 @g_unichar_isprint(i32 noundef 65533) #27
  %.not511543 = icmp eq i32 %i.ga, 0
  br i1 %.not511543, label %bb.bz, label %.thread563

bb.bn:                                            ; preds = %._crit_edge1042
  %i.gb = icmp ult i32 %spec.store.select, 128
  br i1 %i.gb, label %.thread563, label %bb.bo

bb.bo:                                            ; preds = %bb.bn
  %i.gc = icmp ult i32 %spec.store.select, 2048
  br i1 %i.gc, label %.thread563, label %bb.bp

bb.bp:                                            ; preds = %bb.bo
  %i.gd = icmp ult i32 %spec.store.select, 65536
  br i1 %i.gd, label %.thread563, label %bb.bq

bb.bq:                                            ; preds = %bb.bp
  %i.ge = icmp ult i32 %spec.store.select, 2097152
  br i1 %i.ge, label %.thread563, label %bb.br

bb.br:                                            ; preds = %bb.bq
  %i.gf = icmp ult i32 %spec.store.select, 67108864 ; 2 uses
  %.533 = select i1 %i.gf, i32 5, i32 6
  %.534 = select i1 %i.gf, i32 248, i32 252
  br label %.thread563

.thread563:                                       ; preds = %.thread539, %bb.br, %bb.bq, %bb.bp, %bb.bo, %bb.bn
  %.2464546557 = phi ptr [ %.1463.lcssa, %bb.bq ], [ %.1463.lcssa, %bb.bn ], [ %.1463.lcssa, %bb.bo ], [ %.1463.lcssa, %bb.bp ], [ %.1463.lcssa, %bb.br ], [ %i.g, %.thread539 ]
  %.2549555 = phi i32 [ %.1, %bb.bq ], [ %.1, %bb.bn ], [ %.1, %bb.bo ], [ %spec.store.select, %bb.bp ], [ %.1, %bb.br ], [ 65533, %.thread539 ] ; 7 uses
  %.1418 = phi i32 [ 4, %bb.bq ], [ 1, %bb.bn ], [ 2, %bb.bo ], [ 3, %bb.bp ], [ %.533, %bb.br ], [ 3, %.thread539 ] ; 13 uses
  %.0414 = phi i32 [ 240, %bb.bq ], [ 0, %bb.bn ], [ 192, %bb.bo ], [ 224, %bb.bp ], [ %.534, %bb.br ], [ 224, %.thread539 ]
  %i.gg = add i32 %.1429, 1
  %i.gh = add i32 %i.gg, %.1418                   ; 2 uses
  %.not523.a = icmp ult i32 %i.gh, %.3435
  br i1 %.not523.a, label %bb.by, label %bb.bs

bb.bs:                                            ; preds = %.thread563
  %i.gi = icmp slt i32 %.3435, 0
  %i.gj = shl i32 %.3435, 1                       ; 4 uses
  br i1 %i.gi, label %bb.bt, label %bb.bu

bb.bt:                                            ; preds = %bb.bs
  %i.gk = zext i32 %.1429 to i64
  %i.gl = getelementptr i8, ptr %.2441, i64 %i.gk
  store i8 0, ptr %i.gl, align 1
  br label %.thread567

bb.bu:                                            ; preds = %bb.bs
  %.not524.a = icmp ult i32 %i.gh, %i.gj
  br i1 %.not524.a, label %bb.bx, label %bb.bv

bb.bv:                                            ; preds = %bb.bu
  %i.gm = add i32 %.1429, 2
  %i.gn = sub i32 %i.gm, %i.gj
  %i.go = add i32 %i.gn, %.1418
...
bb.bw:                                            ; preds = %bb.bv
  %i.gs = zext i32 %.1429 to i64
  %i.gt = getelementptr i8, ptr %.2441, i64 %i.gs
...
bb.bx:                                            ; preds = %bb.bv, %bb.bu
  ...
  %i.gv = tail call ptr @wmem_realloc(ptr noundef %0, ptr noundef %.2441, i64 noundef %i.gu) #29
  br label %bb.by

bb.by:                                            ; preds = %bb.bx, %.thread563
  %i.gw = phi i64 [ %i.gu, %bb.bx ], [ %i.al, %.thread563 ]
  %i.gx = phi i64 [ %i.gu, %bb.bx ], [ %i.am, %.thread563 ]
  %.6445 = phi ptr [ %i.gv, %bb.bx ], [ %.2441, %.thread563 ] ; 6 uses
  %.11 = phi i32 [ %.10, %bb.bx ], [ %.3435, %.thread563 ]
  %i.gy = icmp samesign ugt i32 %.1418, 1
  br i1 %i.gy, label %.lr.ph, label %._crit_edge

._crit_edge:                                      ; preds = %.lr.ph, %.lr.ph.1, %.lr.ph.2, %.lr.ph.3, %.lr.ph.4, %bb.by
  %.3.lcssa = phi i32 [ %.2549555, %bb.by ], [ %i.hh, %.lr.ph ], [ %i.ho, %.lr.ph.1 ], [ %i.hw, %.lr.ph.2 ], [ %i.id, %.lr.ph.3 ], [ %i.il, %.lr.ph.4 ]
  %i.gz = or i32 %.3.lcssa, %.0414
  %i.ha = trunc i32 %i.gz to i8
  br label %bb.dw

.lr.ph:                                           ; preds = %bb.by
  %indvars.iv.next = add nsw i32 %.1418, -1
  %i.hb = trunc i32 %.2549555 to i8
  %i.hc = and i8 %i.hb, 63
  %i.hd = or disjoint i8 %i.hc, -128
  %i.he = add i32 %.1429, %indvars.iv.next
  %i.hf = zext i32 %i.he to i64
  %i.hg = getelementptr i8, ptr %.6445, i64 %i.hf
  store i8 %i.hd, ptr %i.hg, align 1
  %i.hh = lshr i32 %.2549555, 6                   ; 2 uses
  %.not1116 = icmp eq i32 %.1418, 2
  br i1 %.not1116, label %._crit_edge, label %.lr.ph.1

.lr.ph.1:                                         ; preds = %.lr.ph
  %indvars.iv.next.1 = add nsw i32 %.1418, -2
  %i.hi = trunc i32 %i.hh to i8
  %i.hj = and i8 %i.hi, 63
  %i.hk = or disjoint i8 %i.hj, -128
  %i.hl = add i32 %.1429, %indvars.iv.next.1
  %i.hm = zext i32 %i.hl to i64
  %i.hn = getelementptr i8, ptr %.6445, i64 %i.hm
  store i8 %i.hk, ptr %i.hn, align 1
  %i.ho = lshr i32 %.2549555, 12                  ; 2 uses
  %i.hp = icmp samesign ugt i32 %.1418, 3
  br i1 %i.hp, label %.lr.ph.2, label %._crit_edge

.lr.ph.2:                                         ; preds = %.lr.ph.1
  %indvars.iv.next.2 = add nsw i32 %.1418, -3
  %i.hq = trunc i32 %i.ho to i8
  %i.hr = and i8 %i.hq, 63
  %i.hs = or disjoint i8 %i.hr, -128
  %i.ht = add i32 %.1429, %indvars.iv.next.2
  %i.hu = zext i32 %i.ht to i64
  %i.hv = getelementptr i8, ptr %.6445, i64 %i.hu
  store i8 %i.hs, ptr %i.hv, align 1
  %i.hw = lshr i32 %.2549555, 18                  ; 2 uses
  %.not1117 = icmp eq i32 %.1418, 4
  br i1 %.not1117, label %._crit_edge, label %.lr.ph.3

.lr.ph.3:                                         ; preds = %.lr.ph.2
  %indvars.iv.next.3 = add nsw i32 %.1418, -4
  %i.hx = trunc i32 %i.hw to i8
  %i.hy = and i8 %i.hx, 63
  %i.hz = or disjoint i8 %i.hy, -128
  %i.ia = add i32 %.1429, %indvars.iv.next.3
  %i.ib = zext i32 %i.ia to i64
  %i.ic = getelementptr i8, ptr %.6445, i64 %i.ib
  store i8 %i.hz, ptr %i.ic, align 1
  %i.id = lshr i32 %.2549555, 24                  ; 2 uses
  %i.ie = icmp samesign ugt i32 %.1418, 5
  br i1 %i.ie, label %.lr.ph.4, label %._crit_edge

.lr.ph.4:                                         ; preds = %.lr.ph.3
  %indvars.iv.next.4 = add nsw i32 %.1418, -5
  %i.if = trunc nuw i32 %i.id to i8
  %i.ig = and i8 %i.if, 63
  %i.ih = or disjoint i8 %i.ig, -128
  %i.ii = add i32 %.1429, %indvars.iv.next.4
  %i.ij = zext i32 %i.ii to i64
  %i.ik = getelementptr i8, ptr %.6445, i64 %i.ij
  store i8 %i.ih, ptr %i.ik, align 1
  %i.il = lshr i32 %.2549555, 30
  br label %._crit_edge

bb.bz:                                            ; preds = %.thread539, %._crit_edge1042
  %.2550 = phi i32 [ 65533, %.thread539 ], [ %spec.store.select, %._crit_edge1042 ] ; 14 uses
  %.2425548 = phi i8 [ %i.h, %.thread539 ], [ %.1424, %._crit_edge1042 ] ; 5 uses
  %.2464547 = phi ptr [ %i.g, %.thread539 ], [ %.1463.lcssa, %._crit_edge1042 ] ; 12 uses
  br i1 %3, label %bb.ca, label %bb.ci

bb.ca:                                            ; preds = %bb.bz
  %i.im = tail call i32 @g_unichar_isspace(i32 noundef %.2550) #27
  %.not512 = icmp eq i32 %i.im, 0
  br i1 %.not512, label %bb.ci, label %bb.cb

bb.cb:                                            ; preds = %bb.ca
  %i.in = add i32 %.1429, 2                       ; 2 uses
  %.not521.a = icmp ult i32 %i.in, %.3435
  br i1 %.not521.a, label %bb.dw, label %bb.cc

bb.cc:                                            ; preds = %bb.cb
  %i.io = icmp slt i32 %.3435, 0
  %i.ip = shl i32 %.3435, 1                       ; 4 uses
  br i1 %i.io, label %bb.cd, label %bb.ce

bb.cd:                                            ; preds = %bb.cc
  %i.iq = zext i32 %.1429 to i64
  %i.ir = getelementptr i8, ptr %.2441, i64 %i.iq
  store i8 0, ptr %i.ir, align 1
  br label %.thread567

bb.ce:                                            ; preds = %bb.cc
  %.not522.a = icmp ult i32 %i.in, %i.ip
end_hunk_1
