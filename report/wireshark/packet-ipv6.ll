Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/wireshark/original/packet-ipv6?download=true
...
bb.ay:                                            ; preds = %bb.ax, %bb.aw
  ...
  %i.gw = add nuw nsw i32 %.0229296, 18
  ...
  %i.gz = add nuw nsw i32 %.0229296, 22
...
bb.bc:                                            ; preds = %bb.bb
  ...
  %i.hj = add nuw nsw i32 %.0229296, 3            ; 2 uses
...
bb.bg:                                            ; preds = %bb.bb
  ...
  %i.if = add nuw nsw i32 %.0229296, 3
...
dissect_opt_quickstart.exit.sink.split:           ; preds = %bb.bc, %proto_item_set_generated.exit.i, %bb.bg
  %i.ii = add nuw nsw i32 %.0229296, 4            ; 2 uses
  ...
  %i.in = add nuw nsw i32 %.0229296, 8
...
bb.bj:                                            ; preds = %bb.bi, %bb.bh
  ...
  %i.it = add nuw nsw i32 %.0229296, 3
  ...
  %i.iv = add nuw nsw i32 %.0229296, 4            ; 4 uses
...
bb.bm:                                            ; preds = %bb.bl, %bb.bk
  ...
  %i.jf = add nuw nsw i32 %.0229296, 6            ; 2 uses
...
bb.bo:                                            ; preds = %bb.bn, %bb.bm
  %i.jw = add nuw nsw i32 %.0229296, 8            ; 2 uses
  ...
  %i.kd = add nuw nsw i32 %.0229296, 11
  ...
  %i.kf = add nuw nsw i32 %.0229296, 12           ; 6 uses
...
bb.bu:                                            ; preds = %.backedge.i.i, %.lr.ph.i.i
  %.0122168.i.i = phi i8 [ 0, %.lr.ph.i.i ], [ %i.lw, %.backedge.i.i ]
  %.0123167.i.i = phi i16 [ %i.ko, %.lr.ph.i.i ], [ %.0123.be.i.i, %.backedge.i.i ]
  %.1131166.i.i = phi i32 [ %.0130.i.i, %.lr.ph.i.i ], [ %.1131.be.i.i, %.backedge.i.i ] ; 8 uses
  %i.lw = add i8 %.0122168.i.i, 1                 ; 2 uses
  %i.lx = zext i8 %i.lw to i32
  %i.ly = call ptr (ptr, ptr, i32, i32, i32, ptr, ptr, ...) @proto_tree_add_subtree_format(ptr noundef %i.kj, ptr noundef %0, i32 noundef %.1131166.i.i, i32 noundef %i.kq, i32 noundef 0, ptr noundef null, ptr noundef nonnull @.str.924, i32 noundef %i.lx) ; 23 uses
  br i1 %.not.i.i.i, label %bb.bw, label %bb.bv

bb.bv:                                            ; preds = %bb.bu
  %i.lz = call ptr @proto_tree_add_subtree(ptr noundef %i.ly, ptr noundef %0, i32 noundef %.1131166.i.i, i32 noundef 4, i32 noundef 0, ptr noundef null, ptr noundef nonnull @.str.381) ; 2 uses
  %i.ma = load i32, ptr @hf_ipv6_opt_ioam_trace_node_hlim, align 4
  %i.mb = call ptr @proto_tree_add_item(ptr noundef %i.lz, i32 noundef %i.ma, ptr noundef %0, i32 noundef %.1131166.i.i, i32 noundef 1, i32 noundef 0) ; 0 uses
  %i.mc = load i32, ptr @hf_ipv6_opt_ioam_trace_node_id, align 4
  %i.md = add i32 %.1131166.i.i, 1
  ...
  %i.mf = add i32 %.1131166.i.i, 4
  br label %bb.bw

bb.bw:                                            ; preds = %bb.bv, %bb.bu
  %.0.i.i.i = phi i32 [ %i.mf, %bb.bv ], [ %.1131166.i.i, %bb.bu ] ; 5 uses
...
dissect_opt_ioam_trace_node.exit.i.i:             ; preds = %bb.dl, %bb.dk
  ...
  %i.pd = sub i32 %.21.i.i.i, %.1131166.i.i
...
._crit_edge.i.i:                                  ; preds = %.backedge.i.i, %bb.bt
  %.1131.lcssa.i.i = phi i32 [ %.0130.i.i, %bb.bt ], [ %.1131.be.i.i, %.backedge.i.i ] ; 2 uses
  %.0123.lcssa.i.i = phi i16 [ %i.ko, %bb.bt ], [ %.0123.be.i.i, %.backedge.i.i ]
  %.not145.i.i = icmp eq i16 %.0123.lcssa.i.i, 0
...
dissect_opt_ioam_trace.exit.i:                    ; preds = %bb.dt, %._crit_edge.i.i, %.split.thread.i.i, %bb.dp, %bb.dm, %bb.bq, %bb.bp
  %.5.i.i = phi i32 [ %i.kf, %bb.bp ], [ %i.kf, %bb.bq ], [ %i.ps, %.split.thread.i.i ], [ %.1131.lcssa.i.i, %bb.dt ], [ %.1131.lcssa.i.i, %._crit_edge.i.i ], [ %.21.i.i.i, %bb.dp ], [ %.1131166.i.i, %bb.dm ]
...
bb.dw:                                            ; preds = %bb.dv, %bb.du
  ...
  %i.qk = add nuw nsw i32 %.0229296, 6
  ...
  %i.qn = add nuw nsw i32 %.0229296, 7            ; 2 uses
  ...
  %i.qt = add nuw nsw i32 %.0229296, 8
  ...
  %i.qy = add nuw nsw i32 %.0229296, 11
  ...
  %i.ra = add nuw nsw i32 %.0229296, 12           ; 2 uses
...
bb.dx:                                            ; preds = %bb.dw
  ...
  %i.rd = add nuw nsw i32 %.0229296, 16
  br label %bb.dy
...
dissect_opt_tpf.exit:                             ; preds = %bb.ea, %bb.eb
  ...
  %i.rl = add nuw nsw i32 %.0229296, 6
  br label %dissect_opt_apn6.exit
...
dissect_opt_calipso.exit:                         ; preds = %bb.ec, %bb.ed
  ...
  %i.rq = add nuw nsw i32 %.0229296, 6
  ...
  %i.rt = add nuw nsw i32 %.0229296, 7
  ...
  %i.rw = add nuw nsw i32 %.0229296, 8
  ...
  %i.rz = add nuw nsw i32 %.0229296, 10           ; 2 uses
...
bb.eg:                                            ; preds = %bb.ee
  ...
  %i.sr = add nuw nsw i32 %.0229296, 3            ; 3 uses
...
dissect_opt_pdm.exit:                             ; preds = %bb.ek, %bb.el
  ...
  %i.tg = add nuw nsw i32 %.0229296, 3
  ...
  %i.tj = add nuw nsw i32 %.0229296, 4
  ...
  %i.tm = add nuw nsw i32 %.0229296, 6
  ...
  %i.tp = add nuw nsw i32 %.0229296, 8
  ...
  %i.ts = add nuw nsw i32 %.0229296, 10
  ...
  %i.tv = add nuw nsw i32 %.0229296, 12
  br label %dissect_opt_apn6.exit
