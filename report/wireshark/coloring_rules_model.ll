Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/wireshark/original/coloring_rules_model?download=true
...
end_hunk_1
begin_hunk_2_@_ZN19ModelHelperTreeItemI16ColoringRuleItemED2Ev:bb.a
  %i.r = load ptr, ptr %i.q, align 8
  call void %i.r(ptr noundef nonnull align 8 dereferenceable_or_null(128) %i.n) #21
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.g
  call void @_ZN8QVariantD1Ev(ptr noundef nonnull align 8 dead_on_return(32) dereferenceable_or_null(32) %2) #21
  %i.s = add i32 %.010, 1                         ; 2 uses
  %i.t = sext i32 %i.s to i64                     ; 2 uses
  %i.u = load i64, ptr %i.a, align 8              ; 2 uses
  %i.v = icmp sgt i64 %i.u, %i.t
  br i1 %i.v, label %bb.b, label %._crit_edge, !llvm.loop !93

bb.j:                                             ; preds = %._crit_edge
  %i.w = load ptr, ptr %i.f, align 8              ; 2 uses
...
_ZN17QArrayDataPointerI8QVariantE5derefEv.exit.i.i: ; preds = %bb.j
  %i.x = atomicrmw sub ptr %i.w, i32 1 acq_rel, align 4
  %.not.i.i = icmp eq i32 %i.x, 1
  br i1 %.not.i.i, label %bb.k, label %_ZN5QListI8QVariantED2Ev.exit

bb.k:                                             ; preds = %_ZN17QArrayDataPointerI8QVariantE5derefEv.exit.i.i
  %i.y = getelementptr i8, ptr %0, i64 24
  %i.z = load ptr, ptr %i.y, align 8              ; 2 uses
  %i.aa = load i64, ptr %i.a, align 8
  %.idx.i.i.i = shl i64 %i.aa, 5                  ; 2 uses
  %i.ab = getelementptr i8, ptr %i.z, i64 %.idx.i.i.i
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %bb.k, %.lr.ph.i.i.i.i.i.i
  %.05.i.i.i.i.i.i = phi ptr [ %i.ac, %.lr.ph.i.i.i.i.i.i ], [ %i.z, %bb.k ] ; 2 uses
  call void @_ZN8QVariantD1Ev(ptr noundef align 8 dead_on_return(32) dereferenceable_or_null(32) %.05.i.i.i.i.i.i) #21
  %i.ac = getelementptr i8, ptr %.05.i.i.i.i.i.i, i64 32 ; 2 uses
  %.not.i.i.i.i.i.i = icmp eq ptr %i.ac, %i.ab
  br i1 %.not.i.i.i.i.i.i, label %_ZN9QtPrivate16QGenericArrayOpsI8QVariantE10destroyAllEv.exit.i.i, label %.lr.ph.i.i.i.i.i.i, !llvm.loop !70

_ZN9QtPrivate16QGenericArrayOpsI8QVariantE10destroyAllEv.exit.i.i: ; preds = %.lr.ph.i.i.i.i.i.i, %bb.k
  %i.ad = load ptr, ptr %i.f, align 8
  call void @_ZN10QArrayData10deallocateEPS_xx(ptr noundef %i.ad, i64 noundef 32, i64 noundef 8) #21
  br label %_ZN5QListI8QVariantED2Ev.exit

_ZN5QListI8QVariantED2Ev.exit:                    ; preds = %bb.j, %_ZN17QArrayDataPointerI8QVariantE5derefEv.exit.i.i, %_ZN9QtPrivate16QGenericArrayOpsI8QVariantE10destroyAllEv.exit.i.i
  ret void
...
.body:                                            ; preds = %.loopexit, %.loopexit.split-lp, %bb.e
  %eh.lpad-body = phi { ptr, i32 } [ %i.m, %bb.e ], [ %lpad.loopexit, %.loopexit ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ]
...
bb.a:
  tail call void @_ZN19ModelHelperTreeItemI16ColoringRuleItemED2Ev(ptr noundef align 8 dead_on_return(40) dereferenceable_or_null(40) %0) #21
  tail call void @_ZdlPvm(ptr noundef %0, i64 noundef 40) #22
  ret void
}
...
bb.a:
  ...
  br i1 %.not, label %_ZN17QArrayDataPointerI8QVariantED2Ev.exit, label %bb.b
...
bb.c:                                             ; preds = %_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit
  %i.g = getelementptr i8, ptr %i.d, i64 8
  %i.h = load i64, ptr %i.g, align 8
  br label %_ZN17QArrayDataPointerI8QVariantE17allocatedCapacityEv.exit

_ZN17QArrayDataPointerI8QVariantE17allocatedCapacityEv.exit: ; preds = %bb.b, %bb.c
  %i.i = phi i64 [ %i.h, %bb.c ], [ 0, %bb.b ]
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #21
  %i.j = call noalias noundef ptr @_ZN10QArrayData8allocateEPPS_xxxNS_16AllocationOptionE(ptr noundef nonnull %i.a, i64 noundef 32, i64 noundef 8, i64 noundef %i.i, i32 noundef 1) #21 ; 2 uses
...
_ZN17QArrayDataPointerI8QVariantE5derefEv.exit.i: ; preds = %_ZN17QArrayDataPointerI8QVariantE17allocatedCapacityEv.exit
  %i.p = atomicrmw sub ptr %i.l, i32 1 acq_rel, align 4
  %.not.i2 = icmp eq i32 %i.p, 1
  br i1 %.not.i2, label %bb.d, label %_ZN17QArrayDataPointerI8QVariantED2Ev.exit

bb.d:                                             ; preds = %_ZN17QArrayDataPointerI8QVariantE5derefEv.exit.i
  %.idx.i.i = shl i64 %i.o, 5                     ; 2 uses
  %i.q = getelementptr i8, ptr %i.n, i64 %.idx.i.i
...
.lr.ph.i.i.i.i.i:                                 ; preds = %bb.d, %.lr.ph.i.i.i.i.i
  %.05.i.i.i.i.i = phi ptr [ %i.r, %.lr.ph.i.i.i.i.i ], [ %i.n, %bb.d ] ; 2 uses
  call void @_ZN8QVariantD1Ev(ptr noundef align 8 dead_on_return(32) dereferenceable_or_null(32) %.05.i.i.i.i.i) #21
  %i.r = getelementptr i8, ptr %.05.i.i.i.i.i, i64 32 ; 2 uses
  %.not.i.i.i.i.i = icmp eq ptr %i.r, %i.q
  br i1 %.not.i.i.i.i.i, label %_ZN9QtPrivate16QGenericArrayOpsI8QVariantE10destroyAllEv.exit.i, label %.lr.ph.i.i.i.i.i, !llvm.loop !70

_ZN9QtPrivate16QGenericArrayOpsI8QVariantE10destroyAllEv.exit.i: ; preds = %.lr.ph.i.i.i.i.i, %bb.d
  call void @_ZN10QArrayData10deallocateEPS_xx(ptr noundef nonnull %i.l, i64 noundef 32, i64 noundef 8) #21
  br label %_ZN17QArrayDataPointerI8QVariantED2Ev.exit

bb.e:                                             ; preds = %_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit
  %i.s = getelementptr i8, ptr %0, i64 8
  %i.t = load ptr, ptr %i.s, align 8              ; 2 uses
  %.idx2.i = shl i64 %i.c, 5                      ; 2 uses
...
.lr.ph.i.i.i.i:                                   ; preds = %bb.e, %.lr.ph.i.i.i.i
  ...
  tail call void @_ZN8QVariantD1Ev(ptr noundef align 8 dead_on_return(32) dereferenceable_or_null(32) %.05.i.i.i.i) #21
  %i.v = getelementptr i8, ptr %.05.i.i.i.i, i64 32 ; 2 uses
  %.not.i.i.i.i = icmp eq ptr %i.v, %i.u
  br i1 %.not.i.i.i.i, label %_ZN9QtPrivate16QGenericArrayOpsI8QVariantE8truncateEm.exit, label %.lr.ph.i.i.i.i, !llvm.loop !70

_ZN9QtPrivate16QGenericArrayOpsI8QVariantE8truncateEm.exit: ; preds = %.lr.ph.i.i.i.i, %bb.e
  store i64 0, ptr %i.b, align 8
  br label %_ZN17QArrayDataPointerI8QVariantED2Ev.exit

_ZN17QArrayDataPointerI8QVariantED2Ev.exit:       ; preds = %_ZN9QtPrivate16QGenericArrayOpsI8QVariantE10destroyAllEv.exit.i, %_ZN17QArrayDataPointerI8QVariantE5derefEv.exit.i, %_ZN17QArrayDataPointerI8QVariantE17allocatedCapacityEv.exit, %bb.a, %_ZN9QtPrivate16QGenericArrayOpsI8QVariantE8truncateEm.exit
  ret void
}
...
bb.a:
  %3 = alloca %class.QVariant, align 8            ; 12 uses
...
_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit: ; preds = %bb.a
  %i.b = load atomic i32, ptr %i.a monotonic, align 4
  %i.c = icmp sgt i32 %i.b, 1
  br i1 %i.c, label %_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit.thread, label %bb.b

bb.b:                                             ; preds = %_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit
  %i.d = getelementptr i8, ptr %0, i64 16         ; 5 uses
  %i.e = load i64, ptr %i.d, align 8
  %i.f = icmp eq i64 %1, %i.e
  br i1 %i.f, label %_ZNK17QArrayDataPointerI8QVariantE14freeSpaceAtEndEv.exit, label %bb.d

_ZNK17QArrayDataPointerI8QVariantE14freeSpaceAtEndEv.exit: ; preds = %bb.b
...
bb.d:                                             ; preds = %_ZNK17QArrayDataPointerI8QVariantE14freeSpaceAtEndEv.exit, %bb.b
  %i.u = icmp eq i64 %1, 0
  br i1 %i.u, label %_ZNK17QArrayDataPointerI8QVariantE16freeSpaceAtBeginEv.exit, label %_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit.thread

_ZNK17QArrayDataPointerI8QVariantE16freeSpaceAtBeginEv.exit: ; preds = %bb.d
  %i.v = getelementptr i8, ptr %0, i64 8          ; 3 uses
  %i.w = load ptr, ptr %i.v, align 8              ; 2 uses
  %i.x = ptrtoint ptr %i.a to i64
  %i.y = add i64 %i.x, 23
  %i.z = and i64 %i.y, -8
  %i.aa = ptrtoint ptr %i.w to i64
  %.not14 = icmp eq i64 %i.z, %i.aa
  br i1 %.not14, label %_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit.thread, label %bb.e
...
_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit.thread: ; preds = %bb.a, %bb.d, %_ZNK17QArrayDataPointerI8QVariantE16freeSpaceAtBeginEv.exit, %_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit
  ...
  %i.ak = and i1 %i.aj, %i.ai                     ; 2 uses
  %i.al = zext i1 %i.ak to i32
  invoke void @_ZN17QArrayDataPointerI8QVariantE13detachAndGrowEN10QArrayData14GrowthPositionExPPKS0_PS1_(ptr noundef align 8 dereferenceable_or_null(24) %0, i32 noundef %i.al, i64 noundef 1, ptr noundef null, ptr noundef null)
          to label %bb.f unwind label %bb.h

bb.f:                                             ; preds = %_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit.thread
  %i.am = getelementptr i8, ptr %0, i64 8         ; 3 uses
  %i.an = load ptr, ptr %i.am, align 8            ; 2 uses
  br i1 %i.ak, label %bb.g, label %_ZN9QtPrivate16QMovableArrayOpsI8QVariantE8InserterD2Ev.exit

bb.g:                                             ; preds = %bb.f
  %i.ao = getelementptr i8, ptr %i.an, i64 -32
  call void @llvm.memcpy.p0.p0.i64(ptr noundef align 8 dereferenceable(32) dereferenceable_or_null(32) %i.ao, ptr noundef nonnull align 8 dereferenceable(32) %3, i64 32, i1 false)
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %3, i8 0, i64 24, i1 false)
  %.sroa.4.0..sroa_idx.i19 = getelementptr inbounds nuw i8, ptr %3, i64 24
...
bb.h:                                             ; preds = %_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit.thread
  %i.ar = landingpad { ptr, i32 }
          cleanup
  call void @_ZN8QVariantD1Ev(ptr noundef nonnull align 8 dead_on_return(32) dereferenceable_or_null(32) %3) #21
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #21
  resume { ptr, i32 } %i.ar

_ZN9QtPrivate16QMovableArrayOpsI8QVariantE8InserterD2Ev.exit: ; preds = %bb.f
  %i.as = getelementptr [32 x i8], ptr %i.an, i64 %1 ; 3 uses
  %i.at = getelementptr i8, ptr %i.as, i64 32
  %i.au = load i64, ptr %i.ag, align 8
  %i.av = sub i64 %i.au, %1
  %i.aw = shl i64 %i.av, 5
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef align 1 %i.at, ptr noundef align 1 %i.as, i64 noundef %i.aw, i1 noundef false) #21
  call void @llvm.memcpy.p0.p0.i64(ptr noundef align 8 dereferenceable(32) dereferenceable_or_null(32) %i.as, ptr noundef nonnull align 8 dereferenceable(32) %3, i64 32, i1 false)
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %3, i8 0, i64 24, i1 false)
  %.sroa.4.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %3, i64 24
  store i64 2, ptr %.sroa.4.0..sroa_idx.i.i, align 8
  br label %bb.i

bb.i:                                             ; preds = %_ZN9QtPrivate16QMovableArrayOpsI8QVariantE8InserterD2Ev.exit, %bb.g
  %storemerge.in = load i64, ptr %i.ag, align 8
  %storemerge = add i64 %storemerge.in, 1
  store i64 %storemerge, ptr %i.ag, align 8
  call void @_ZN8QVariantD1Ev(ptr noundef nonnull align 8 dead_on_return(32) dereferenceable_or_null(32) %3) #21
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #21
  br label %bb.j
...
_ZNK17QArrayDataPointerI8QVariantE16freeSpaceAtBeginEv.exit: ; preds = %bb.c
  ...
  br i1 %.not16, label %_ZN17QArrayDataPointerI8QVariantE20tryReadjustFreeSpaceEN10QArrayData14GrowthPositionExPPKS0_.exit, label %bb.j

_ZNK17QArrayDataPointerI8QVariantE14freeSpaceAtEndEv.exit: ; preds = %bb.c
  ...
  br i1 %.not17, label %_ZNK17QArrayDataPointerI8QVariantE14freeSpaceAtEndEv.exit.i, label %bb.j
...
bb.d:                                             ; preds = %_ZNK17QArrayDataPointerI8QVariantE14freeSpaceAtEndEv.exit.i
  %i.z = mul i64 %i.w, 3
  %i.aa = shl i64 %i.m, 1
...
bb.e:                                             ; preds = %bb.d
  ...
  %.idx.i.i = shl i64 %i.ac, 5                    ; 2 uses
  %i.ad = getelementptr i8, ptr %i.o, i64 %.idx.i.i ; 3 uses
  %i.ae = icmp eq i64 %i.w, 0
  br i1 %i.ae, label %_ZN9QtPrivate20q_relocate_overlap_nI8QVariantxEEvPT_T0_S3_.exit.i.i, label %bb.f
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %or.cond3.i.i.i, label %_ZN9QtPrivate20q_relocate_overlap_nI8QVariantxEEvPT_T0_S3_.exit.i.i, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.ai = shl i64 %i.w, 5
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 1 %i.ad, ptr noundef nonnull align 1 %i.o, i64 noundef %i.ai, i1 noundef false) #21
  br label %_ZN9QtPrivate20q_relocate_overlap_nI8QVariantxEEvPT_T0_S3_.exit.i.i

_ZN9QtPrivate20q_relocate_overlap_nI8QVariantxEEvPT_T0_S3_.exit.i.i: ; preds = %bb.g, %bb.f, %bb.e
  %.not.i21.i = icmp eq ptr %3, null
  br i1 %.not.i21.i, label %_ZN17QArrayDataPointerI8QVariantE20tryReadjustFreeSpaceEN10QArrayData14GrowthPositionExPPKS0_.exit.thread22, label %bb.h
...
end_hunk_2
begin_hunk_3_@_ZN17QArrayDataPointerI8QVariantE20tryReadjustFreeSpaceEN10QArrayData14GrowthPositionExPPKS0_:bb.a
  br label %bb.f
...
bb.h:                                             ; preds = %bb.g
  %i.aq = shl i64 %i.ag, 5
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 1 %i.ak, ptr noundef nonnull align 1 %i.aj, i64 noundef %i.aq, i1 noundef false) #21
...
bb.a:
  %4 = alloca %struct.QArrayDataPointer.4, align 16 ; 13 uses
  %i.a = icmp ne i32 %1, 0
...
_ZNK17QArrayDataPointerI8QVariantE14freeSpaceAtEndEv.exit: ; preds = %_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit
  ...
  %i.q = add i64 %i.p, %2
  %i.r = add i64 %i.q, %i.n
  %i.s = tail call { ptr, ptr } @_ZN10QArrayData19reallocateUnalignedEPS_PvxxNS_16AllocationOptionE(ptr noundef nonnull %i.c, ptr noundef %i.h, i64 noundef 32, i64 noundef %i.r, i32 noundef 0) #21 ; 2 uses
...
_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit.thread: ; preds = %bb.b, %_ZNK17QArrayDataPointerI8QVariantE11needsDetachEv.exit, %bb.a
  ...
  call void @_ZN17QArrayDataPointerI8QVariantE12allocateGrowERKS1_xN10QArrayData14GrowthPositionE(ptr dead_on_unwind nonnull writable sret(%struct.QArrayDataPointer.4) align 8 %4, ptr noundef align 8 dereferenceable(24) %0, i64 noundef %2, i32 noundef %1)
...
.noexc:                                           ; preds = %bb.i
  ...
  br i1 %i.aq, label %bb.i, label %_ZN9QtPrivate16QGenericArrayOpsI8QVariantE10copyAppendEPKS1_S4_.exit, !llvm.loop !94
...
.lr.ph.i34:                                       ; preds = %bb.k
  ...
  %.pre.i35 = load i64, ptr %i.ax, align 16
  br label %bb.l

bb.l:                                             ; preds = %bb.l, %.lr.ph.i34
  %i.ay = phi i64 [ %.pre.i35, %.lr.ph.i34 ], [ %i.bc, %bb.l ]
  ...
  br i1 %i.bd, label %bb.l, label %_ZN9QtPrivate16QGenericArrayOpsI8QVariantE10copyAppendEPKS1_S4_.exit, !llvm.loop !95
...
_ZN9QtPrivate16QGenericArrayOpsI8QVariantE10destroyAllEv.exit.i: ; preds = %.lr.ph.i.i.i.i.i, %bb.o
  ...
  call void @_ZN10QArrayData10deallocateEPS_xx(ptr noundef %i.bw, i64 noundef 32, i64 noundef 8) #21
  br label %_ZN17QArrayDataPointerI8QVariantED2Ev.exit
...
bb.q:                                             ; preds = %bb.j, %bb.f
  ...
  call void @_ZN17QArrayDataPointerI8QVariantED2Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable_or_null(24) %4) #21
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #21
  resume { ptr, i32 } %.pn
}
...
_ZNK17QArrayDataPointerI8QVariantE22constAllocatedCapacityEv.exit31: ; preds = %bb.b, %_ZNK17QArrayDataPointerI8QVariantE22constAllocatedCapacityEv.exit.thread, %_ZNK17QArrayDataPointerI8QVariantE22constAllocatedCapacityEv.exit
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #21
  %i.ac = call noalias noundef ptr @_ZN10QArrayData8allocateEPPS_xxxNS_16AllocationOptionE(ptr noundef nonnull %i.a, i64 noundef 32, i64 noundef 8, i64 noundef %i.y, i32 noundef %i.ab) #21 ; 6 uses
