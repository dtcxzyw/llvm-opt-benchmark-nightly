...
bb.i:                                             ; preds = %bb.h
  ...
  %8 = sub nsw i32 %i.bf, %i.bg
  %i.bh = select i1 %i.bb, i32 128, i32 4096      ; 3 uses
  %9 = add nsw i32 %8, %i.bh                      ; 2 uses
  %10 = srem i32 %9, 128
  %i.bi = srem i32 %9, 4096
  %11 = select i1 %i.bb, i32 %10, i32 %i.bi
  %12 = sub nsw i32 %i.bg, %i.bf
  %i.bj = add nsw i32 %12, %i.bh                  ; 2 uses
  %13 = srem i32 %i.bj, 128
  %i.bk = srem i32 %i.bj, 4096
  %14 = select i1 %i.bb, i32 %13, i32 %i.bk
...
bb.f:                                             ; preds = %bb.e, %bb.c
  ...
  %i.ay = icmp eq i32 %.val, 1                    ; 5 uses
  %..i = select i1 %i.ay, i16 128, i16 4096       ; 5 uses
...
bb.s:                                             ; preds = %bb.r
  ...
  %.v = select i1 %i.ay, i16 127, i16 4095        ; 3 uses
  %i.cw = and i16 %.v, %i.cv                      ; 3 uses
  %i.cx = zext nneg i16 %i.cw to i32              ; 2 uses
  %i.cy = sub nsw i32 1, %i.az                    ; 2 uses
  %i.cz = and i16 %.v, %i.cs                      ; 2 uses
...
bb.be:                                            ; preds = %bb.ar
  ...
  %i.iw = sub nsw i16 %i.iv, %5
  %.lhs.trunc = add nsw i16 %i.iw, %..i           ; 2 uses
  %12 = srem i16 %.lhs.trunc, 128
  %i.ix = srem i16 %.lhs.trunc, 4096
  %13 = select i1 %i.ay, i16 %12, i16 %i.ix
  %14 = sub nsw i16 %5, %i.iv
  %i.iy = add nsw i16 %14, %..i                   ; 2 uses
  %15 = srem i16 %i.iy, 128
  %i.iz = srem i16 %i.iy, 4096
  %16 = select i1 %i.ay, i16 %15, i16 %i.iz
  %i.ja = call i16 @llvm.smin.i16(i16 %13, i16 %16)
...
bb.a:
  ...
  %i.d = icmp eq i32 %.val, 1                     ; 4 uses
  %.neg54 = select i1 %i.d, i32 -128, i32 -4096   ; 2 uses
  %5 = select i1 %i.d, i32 128, i32 4096          ; 2 uses
  %.v = select i1 %i.d, i16 127, i16 4095         ; 3 uses
  %i.e = and i16 %.v, %4                          ; 3 uses
  %i.f = zext nneg i16 %i.e to i32                ; 2 uses
  %i.g = sub nsw i32 1, %5                        ; 2 uses
  %i.h = and i16 %3, %.v                          ; 2 uses
  %.not.i47 = icmp samesign ugt i16 %i.h, %i.e
  %i.i = select i1 %.not.i47, i32 %.neg54, i32 0
  %i.j = zext nneg i16 %i.h to i32
  %.neg4151 = sub nsw i32 %i.j, %i.f
  %.0.i52 = add nsw i32 %.neg4151, %i.i           ; 2 uses
  %i.k = icmp ne i32 %.0.i52, %i.g
  %i.l = icmp slt i32 %.0.i52, 1
  %i.m = and i1 %i.k, %i.l
...
rlc_sdu_add_fragment.exit:                        ; preds = %bb.c, %bb.d, %bb.o
  ...
  %i.bx = and i16 %i.bw, %.v                      ; 3 uses
  %.not.i = icmp samesign ugt i16 %i.bx, %i.e
  %i.by = select i1 %.not.i, i32 %.neg54, i32 0
  %i.bz = zext nneg i16 %i.bx to i32
  %.neg41 = sub nsw i32 %i.bz, %i.f
  %.0.i = add nsw i32 %.neg41, %i.by              ; 2 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  %6 = srem i32 %i.cp, 128
  %i.cq = srem i32 %i.cp, 4096
  %7 = select i1 %i.d, i32 %6, i32 %i.cq
