...
bb.j:                                             ; preds = %bb.i
  ...
  %i.eh = sub nuw nsw i32 %.0284, %spec.select299464
  br label %bb.k

bb.k:                                             ; preds = %bb.j, %bb.i
  %.1285 = phi i32 [ %i.eh, %bb.j ], [ %.0284, %bb.i ]
  %spec.select300465 = call i32 @llvm.umin.i32(i32 %.1285, i32 %i.dy) ; 3 uses
