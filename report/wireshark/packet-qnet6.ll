...
bb.g:                                             ; preds = %._crit_edge, %bb.f, %bb.c, %bb.b, %bb.a
  %.0109 = phi i32 [ -1, %bb.c ], [ -1, %bb.a ], [ -1, %bb.b ], [ 0, %bb.f ], [ 0, %._crit_edge ]
...
bb.h:                                             ; preds = %bb.g, %bb.f
  %.0284 = phi i32 [ %i.ds, %bb.g ], [ %i.az, %bb.f ] ; 4 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  %spec.select299464 = call i32 @llvm.umin.i32(i32 %.0284, i32 %i.eb) ; 3 uses
  ...
  %i.eh = sub nsw i32 %.0284, %spec.select299464
  br label %bb.k

bb.k:                                             ; preds = %bb.j, %bb.i
  %.1285 = phi i32 [ %i.eh, %bb.j ], [ %.0284, %bb.i ] ; 2 uses
  %spec.select300465 = call i32 @llvm.smin.i32(i32 %.1285, i32 %i.dy) ; 2 uses
