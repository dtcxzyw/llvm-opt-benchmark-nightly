...
bb.v:                                             ; preds = %bb.u
  ...
  %i.fx = sub i32 %i.fm, %spec.select.i
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.id = sub i32 %.0540, %spec.select.i531
...
bb.al:                                            ; preds = %bb.ak
  ...
  %i.kf = sub i32 %.0541, %spec.select.i533
...
bb.as:                                            ; preds = %bb.ar
  ...
  %i.ln = sub i32 %i.lc, %spec.select.i340
...
bb.aw:                                            ; preds = %bb.av
  ...
  %i.mn = sub i32 %i.md, %spec.select.i342
...
bb.ba:                                            ; preds = %bb.az
  ...
  %i.nw = sub i32 %i.nm, %spec.select.i344
...
bb.be:                                            ; preds = %bb.bd
  ...
  %i.oz = sub i32 %i.oo, %spec.select.i346
...
bb.bi:                                            ; preds = %bb.bh
  ...
  %i.qd = sub i32 %i.pt, %spec.select.i348
...
bb.bm:                                            ; preds = %bb.bl
  ...
  %i.rn = sub i32 %i.rd, %spec.select.i350
...
bb.bv:                                            ; preds = %bb.bu
  ...
  %i.ud = sub i32 %i.ts, %spec.select.i354
...
bb.bz:                                            ; preds = %bb.by
  ...
  %i.vq = sub i32 %i.vf, %spec.select.i356
...
bb.cd:                                            ; preds = %bb.cc
  ...
  %i.wm = sub i32 %i.wc, %spec.select.i358
...
bb.ch:                                            ; preds = %bb.cg
  ...
  %i.xr = sub i32 %i.xh, %spec.select.i360
...
bb.cl:                                            ; preds = %bb.ck
  ...
  %i.zm = sub i32 %i.zc, %spec.select.i362
...
bb.cp:                                            ; preds = %bb.co
  ...
  %i.aaj = sub i32 %i.zz, %spec.select.i364
...
bb.ct:                                            ; preds = %bb.cs
  ...
  %i.abw = sub i32 %i.abm, %spec.select.i366
...
bb.cx:                                            ; preds = %bb.cw
  ...
  %i.adb = sub i32 %i.acr, %spec.select.i368
...
bb.dt:                                            ; preds = %bb.ds
  ...
  %i.aja = sub i32 %i.aio, %spec.select.i370
...
bb.dx:                                            ; preds = %bb.dw
  ...
  %i.aki = sub i32 %i.ajy, %spec.select.i372
