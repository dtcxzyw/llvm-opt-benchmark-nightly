...
bb.c:                                             ; preds = %_ZNK4QSetIiE4sizeEv.exit
  %i.f = load ptr, ptr %1, align 8, !noalias !24  ; 4 uses
...
bb.f:                                             ; preds = %.lr.ph
  ...
  br i1 %i.n, label %._crit_edge, label %.lr.ph, !llvm.loop !27
...
.lr.ph:                                           ; preds = %bb.e, %bb.f
  ...
  br i1 %.not.i.i.i.i.i, label %bb.f, label %_ZNK4QSetIiE14const_iteratorneERKS1_.exit.thread.lr.ph, !llvm.loop !27
...
bb.c:                                             ; preds = %_ZNK4QSetIjE4sizeEv.exit
  %i.f = load ptr, ptr %1, align 8, !noalias !29  ; 4 uses
  %.not.i.i5 = icmp eq ptr %i.f, null
  br i1 %.not.i.i5, label %._crit_edge, label %bb.d
...
bb.f:                                             ; preds = %.lr.ph
  %i.m = add nuw i64 %i.o, 1                      ; 2 uses
  %i.n = icmp eq i64 %i.m, %i.k
  br i1 %i.n, label %._crit_edge, label %.lr.ph, !llvm.loop !32
...
.lr.ph:                                           ; preds = %bb.e, %bb.f
  ...
  %.not.i.i.i.i.i = icmp eq i8 %i.t, -1
  br i1 %.not.i.i.i.i.i, label %bb.f, label %_ZNK4QSetIjE14const_iteratorneERKS1_.exit.thread.lr.ph, !llvm.loop !32

_ZNK4QSetIjE14const_iteratorneERKS1_.exit.thread.lr.ph: ; preds = %.lr.ph, %bb.d
  %.sroa.4.0.i.i25 = phi i64 [ 0, %bb.d ], [ %i.o, %.lr.ph ]
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 16
...
_ZNK4QSetIjE14const_iteratorneERKS1_.exit.thread: ; preds = %_ZNK4QSetIjE14const_iteratorneERKS1_.exit.thread.lr.ph, %_ZN4QSetIjE14const_iteratorppEv.exit
  ...
  %.sroa.09.015 = phi ptr [ %i.f, %_ZNK4QSetIjE14const_iteratorneERKS1_.exit.thread.lr.ph ], [ %.sroa.09.1, %_ZN4QSetIjE14const_iteratorppEv.exit ] ; 3 uses
  %i.v = getelementptr i8, ptr %.sroa.09.015, i64 32 ; 2 uses
  %i.w = load ptr, ptr %i.v, align 8
  %i.x = lshr i64 %.sroa.8.016, 7
  %i.y = getelementptr [144 x i8], ptr %i.w, i64 %i.x ; 2 uses
...
._crit_edge:                                      ; preds = %bb.f, %_ZN4QSetIjE14const_iteratorppEv.exit, %bb.c, %bb.e
  ret void
