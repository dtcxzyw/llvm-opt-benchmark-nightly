Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/wireshark/original/packet-snmp?download=true
...
.split.us:                                        ; preds = %bb.b, %.split.us
  %.02232.us = phi i32 [ %i.j, %.split.us ], [ 0, %bb.b ] ; 2 uses
  ...
  %i.j = add nuw nsw i32 %.02232.us, 64
  %i.k = icmp samesign ult i32 %.02232.us, 1048512
  br i1 %i.k, label %.split.us, label %.split34.us, !llvm.loop !36

.preheader:                                       ; preds = %.preheader.preheader, %.loopexit
  %.02232 = phi i32 [ %i.y, %.loopexit ], [ 0, %.preheader.preheader ] ; 2 uses
  %.02331 = phi i32 [ %i.r, %.loopexit ], [ 0, %.preheader.preheader ]
  br label %bb.c
...
.loopexit:                                        ; preds = %bb.c
  ...
  call void @gcry_md_write(ptr noundef %i.x, ptr noundef nonnull %i.b, i64 noundef 64)
  %i.y = add nuw nsw i32 %.02232, 64
  %i.z = icmp samesign ult i32 %.02232, 1048512
  br i1 %i.z, label %.preheader, label %.split34.us, !llvm.loop !36

.split34.us:                                      ; preds = %.loopexit, %.split.us
  %i.aa = load ptr, ptr %i.a, align 8
  %i.ab = call ptr @gcry_md_read(ptr noundef %i.aa, i32 noundef 0)
  %i.ac = zext i32 %i.h to i64                    ; 4 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef align 1 %5, ptr noundef align 1 %i.ab, i64 noundef %i.ac, i1 noundef false) #10
  %i.ad = load ptr, ptr %i.a, align 8
  call void @gcry_md_close(ptr noundef %i.ad)
  %i.ae = call i32 @gcry_md_open(ptr noundef nonnull %i.a, i32 noundef %i.e, i32 noundef 0)
  %.not26 = icmp eq i32 %i.ae, 0
  br i1 %.not26, label %bb.d, label %bb.e

bb.d:                                             ; preds = %.split34.us
  %i.af = load ptr, ptr %i.a, align 8
  call void @gcry_md_write(ptr noundef %i.af, ptr noundef %5, i64 noundef %i.ac)
  %i.ag = load ptr, ptr %i.a, align 8
  %i.ah = zext i32 %4 to i64
  call void @gcry_md_write(ptr noundef %i.ag, ptr noundef %3, i64 noundef %i.ah)
  %i.ai = load ptr, ptr %i.a, align 8
  call void @gcry_md_write(ptr noundef %i.ai, ptr noundef %5, i64 noundef %i.ac)
  %i.aj = load ptr, ptr %i.a, align 8
  %i.ak = call ptr @gcry_md_read(ptr noundef %i.aj, i32 noundef 0)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef align 1 %5, ptr noundef align 1 %i.ak, i64 noundef %i.ac, i1 noundef false) #10
  %i.al = load ptr, ptr %i.a, align 8
  call void @gcry_md_close(ptr noundef %i.al)
  br label %bb.e
