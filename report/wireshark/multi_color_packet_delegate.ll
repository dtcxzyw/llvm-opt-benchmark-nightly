Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/wireshark/original/multi_color_packet_delegate?download=true
...
bb.h:                                             ; preds = %bb.g
  %i.aq = shl i64 %i.ag, 4
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 1 %i.ak, ptr noundef nonnull align 1 %i.aj, i64 noundef %i.aq, i1 noundef false) #14
...
define linkonce_odr void @_ZN17QArrayDataPointerI6QColorE17reallocateAndGrowEN10QArrayData14GrowthPositionExPS1_(ptr noundef align 8 dereferenceable_or_null(24) %0, i32 noundef %1, i64 noundef %2, ptr noundef %3) local_unnamed_addr #9 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %4 = alloca %struct.QArrayDataPointer.4, align 16 ; 14 uses
  %i.a = icmp ne i32 %1, 0
...
_ZNK17QArrayDataPointerI6QColorE14freeSpaceAtEndEv.exit: ; preds = %_ZNK17QArrayDataPointerI6QColorE11needsDetachEv.exit
  ...
  %i.q = add i64 %i.p, %2
  %i.r = add i64 %i.q, %i.n
  %i.s = tail call { ptr, ptr } @_ZN10QArrayData19reallocateUnalignedEPS_PvxxNS_16AllocationOptionE(ptr noundef nonnull %i.c, ptr noundef %i.h, i64 noundef 16, i64 noundef %i.r, i32 noundef 0) #14 ; 2 uses
...
_ZNK17QArrayDataPointerI6QColorE11needsDetachEv.exit.thread: ; preds = %bb.b, %_ZNK17QArrayDataPointerI6QColorE11needsDetachEv.exit, %bb.a
  ...
  call void @_ZN17QArrayDataPointerI6QColorE12allocateGrowERKS1_xN10QArrayData14GrowthPositionE(ptr dead_on_unwind nonnull writable sret(%struct.QArrayDataPointer.4) align 8 %4, ptr noundef align 8 dereferenceable(24) %0, i64 noundef %2, i32 noundef %1)
...
bb.g:                                             ; preds = %_ZN17QArrayDataPointerI6QColorE5derefEv.exit.i
  ...
  call void @_ZN10QArrayData10deallocateEPS_xx(ptr noundef %i.ab, i64 noundef 16, i64 noundef 8) #14
...
bb.j:                                             ; preds = %bb.j, %.lr.ph.i.a
  ...
  br i1 %i.at, label %bb.j, label %_ZN9QtPrivate16QGenericArrayOpsI6QColorE10copyAppendEPKS1_S4_.exit, !llvm.loop !12
...
bb.l:                                             ; preds = %bb.l, %.lr.ph.i32.a
  ...
  br i1 %i.bf, label %bb.l, label %_ZN9QtPrivate16QGenericArrayOpsI6QColorE10copyAppendEPKS1_S4_.exit, !llvm.loop !13
...
bb.o:                                             ; preds = %_ZN17QArrayDataPointerI6QColorE5derefEv.exit.i36
  ...
  call void @_ZN10QArrayData10deallocateEPS_xx(ptr noundef %i.bu, i64 noundef 16, i64 noundef 8) #14
...
; Function Attrs: mustprogress null_pointer_is_valid sspstrong uwtable
define linkonce_odr void @_ZN17QArrayDataPointerI6QColorE12allocateGrowERKS1_xN10QArrayData14GrowthPositionE(ptr dead_on_unwind noalias writable sret(%struct.QArrayDataPointer.4) align 8 %0, ptr noundef align 8 dereferenceable(24) %1, i64 noundef %2, i32 noundef %3) local_unnamed_addr #0 comdat align 2 {
bb.a:
...
_ZNK17QArrayDataPointerI6QColorE22constAllocatedCapacityEv.exit31: ; preds = %bb.b, %_ZNK17QArrayDataPointerI6QColorE22constAllocatedCapacityEv.exit.thread, %_ZNK17QArrayDataPointerI6QColorE22constAllocatedCapacityEv.exit
  ...
  %i.ac = call noalias noundef ptr @_ZN10QArrayData8allocateEPPS_xxxNS_16AllocationOptionE(ptr noundef nonnull %i.a, i64 noundef 16, i64 noundef 8, i64 noundef %i.y, i32 noundef %i.ab) #14 ; 6 uses
...
; Function Attrs: mustprogress null_pointer_is_valid sspstrong uwtable
define linkonce_odr void @_ZN9QtPrivate12QPodArrayOpsI6QPointE7emplaceIJS1_EEEvxDpOT_(ptr noundef align 8 dereferenceable_or_null(24) %0, i64 noundef %1, ptr noundef align 4 dereferenceable(8) %2) local_unnamed_addr #0 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
_ZNK17QArrayDataPointerI6QPointE11needsDetachEv.exit: ; preds = %bb.a
  %i.b = load atomic i32, ptr %i.a monotonic, align 4
  %i.c = icmp sgt i32 %i.b, 1
  br i1 %i.c, label %_ZNK17QArrayDataPointerI6QPointE11needsDetachEv.exit.thread, label %bb.b

bb.b:                                             ; preds = %_ZNK17QArrayDataPointerI6QPointE11needsDetachEv.exit
  %i.d = getelementptr i8, ptr %0, i64 16         ; 5 uses
  %i.e = load i64, ptr %i.d, align 8
  %i.f = icmp eq i64 %1, %i.e
  br i1 %i.f, label %_ZNK17QArrayDataPointerI6QPointE14freeSpaceAtEndEv.exit, label %bb.d

_ZNK17QArrayDataPointerI6QPointE14freeSpaceAtEndEv.exit: ; preds = %bb.b
