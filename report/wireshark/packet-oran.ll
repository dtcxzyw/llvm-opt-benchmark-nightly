...
begin_hunk_0_@dissect_active_beamspace_coefficient_mask:bb.a
  br i1 %.not.5, label %bb.z, label %bb.w

bb.w:                                             ; preds = %bb.v
  %i.bv = or disjoint i32 %i.s, 5                 ; 2 uses
  %i.bw = load i32, ptr @pref_num_bf_antennas, align 4
  %i.bx = icmp ult i32 %i.bv, %i.bw
  br i1 %i.bx, label %bb.x, label %bb.z

bb.x:                                             ; preds = %bb.w
  %i.by = load i32, ptr %3, align 4               ; 3 uses
  %i.bz = icmp ult i32 %i.by, 1023
  br i1 %i.bz, label %bb.y, label %bb.z

bb.y:                                             ; preds = %bb.x
  %i.ca = trunc i32 %i.bv to i16
  %i.cb = add nuw nsw i16 %i.ca, 1
  %i.cc = add nuw nsw i32 %i.by, 1
  store i32 %i.cc, ptr %3, align 4
  %i.cd = zext nneg i32 %i.by to i64
  %i.ce = getelementptr [2 x i8], ptr @dissect_active_beamspace_coefficient_mask.trx_enabled, i64 %i.cd
  store i16 %i.cb, ptr %i.ce, align 2
  br label %bb.z

bb.z:                                             ; preds = %bb.y, %bb.x, %bb.w, %bb.v
  %i.cf = and i32 %i.r, 64
  %.not.6 = icmp eq i32 %i.cf, 0
  br i1 %.not.6, label %bb.ad, label %bb.aa

bb.aa:                                            ; preds = %bb.z
  %i.cg = or disjoint i32 %i.s, 6                 ; 2 uses
  %i.ch = load i32, ptr @pref_num_bf_antennas, align 4
  %i.ci = icmp ult i32 %i.cg, %i.ch
  br i1 %i.ci, label %bb.ab, label %bb.ad

bb.ab:                                            ; preds = %bb.aa
  %i.cj = load i32, ptr %3, align 4               ; 3 uses
  %i.ck = icmp ult i32 %i.cj, 1023
  br i1 %i.ck, label %bb.ac, label %bb.ad

bb.ac:                                            ; preds = %bb.ab
  %i.cl = trunc i32 %i.cg to i16
  %i.cm = or disjoint i16 %i.cl, 1
  %i.cn = add nuw nsw i32 %i.cj, 1
  store i32 %i.cn, ptr %3, align 4
  %i.co = zext nneg i32 %i.cj to i64
  %i.cp = getelementptr [2 x i8], ptr @dissect_active_beamspace_coefficient_mask.trx_enabled, i64 %i.co
  store i16 %i.cm, ptr %i.cp, align 2
  br label %bb.ad

bb.ad:                                            ; preds = %bb.ac, %bb.ab, %bb.aa, %bb.z
  %i.cq = and i32 %i.r, 128
  %.not.7 = icmp eq i32 %i.cq, 0
  br i1 %.not.7, label %bb.ah, label %bb.ae

bb.ae:                                            ; preds = %bb.ad
  %i.cr = or disjoint i32 %i.s, 7                 ; 2 uses
  %i.cs = load i32, ptr @pref_num_bf_antennas, align 4
  %i.ct = icmp ult i32 %i.cr, %i.cs
  br i1 %i.ct, label %bb.af, label %bb.ah

bb.af:                                            ; preds = %bb.ae
  %i.cu = load i32, ptr %3, align 4               ; 3 uses
  %i.cv = icmp ult i32 %i.cu, 1023
  br i1 %i.cv, label %bb.ag, label %bb.ah

bb.ag:                                            ; preds = %bb.af
  %i.cw = trunc i32 %i.cr to i16
  %i.cx = add i16 %i.cw, 1
  %i.cy = add nuw nsw i32 %i.cu, 1
  store i32 %i.cy, ptr %3, align 4
  %i.cz = zext nneg i32 %i.cu to i64
  %i.da = getelementptr [2 x i8], ptr @dissect_active_beamspace_coefficient_mask.trx_enabled, i64 %i.cz
  store i16 %i.cx, ptr %i.da, align 2
  br label %bb.ah

bb.ah:                                            ; preds = %bb.ag, %bb.af, %bb.ae, %bb.ad
  %i.db = add i32 %.032, 1                        ; 2 uses
  %i.dc = add nuw nsw i32 %.02631, 1              ; 2 uses
...
define internal fastcc void @ext11_work_out_bundles(i32 noundef %0, i32 noundef %1, i32 noundef range(i32 1, 0) %2, ptr nofree noundef captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = load i8, ptr %3, align 4, !range !6, !noundef !7
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = udiv i32 %i.e, %2
  %i.g = icmp ugt i32 %2, %i.e
  %spec.store.select = select i1 %i.g, i32 1, i32 %i.f
  %i.h = getelementptr i8, ptr %3, i64 812
  %i.i = load i8, ptr %i.h, align 4, !range !6, !noundef !7
  %i.j = trunc nuw i8 %i.i to i1
  br i1 %i.j, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  %i.k = getelementptr i8, ptr %3, i64 813
...
attributes #7 = { nofree norecurse nosync nounwind null_pointer_is_valid sspstrong memory(argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "probe-stack"="inline-asm" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
