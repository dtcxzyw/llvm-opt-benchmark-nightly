...
._crit_edge.epil:                                 ; preds = %._crit_edge.epil, %._crit_edge.epil.preheader
  ...
  %.pre.epil = add i32 %.04662.us.us.epil, %i.w   ; 2 uses
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph.us.new
  ...
  %.pre.2 = add i32 %.pre.1, %i.w                 ; 3 uses
  ...
  %.pre.3 = add i32 %.pre.2, %i.w                 ; 3 uses
