...
begin_hunk_0_@wtap_block_add_bytes_option_borrow:bb.a
...
wtap_block_get_option.exit.i:                     ; preds = %bb.g
  ...
  br i1 %.not21.i, label %.loopexit, label %wtap_block_add_option_common.exit.thread

.loopexit:                                        ; preds = %bb.f, %wtap_block_get_option.exit.i, %bb.e, %bb.d
  %i.w = phi i32 [ %i.q, %bb.d ], [ %i.q, %wtap_block_get_option.exit.i ], [ 0, %bb.e ], [ %i.q, %bb.f ] ; 2 uses
  %i.x = add i32 %i.w, 1
  %i.y = tail call ptr @g_array_set_size(ptr noundef %i.o, i32 noundef %i.x) ; 0 uses
  %i.z = load ptr, ptr %i.n, align 8
  %i.aa = load ptr, ptr %i.z, align 8
  %i.ab = zext i32 %i.w to i64
  %i.ac = getelementptr [32 x i8], ptr %i.aa, i64 %i.ab ; 2 uses
  store i32 %1, ptr %i.ac, align 8
  %i.ad = tail call ptr @g_bytes_ref(ptr noundef %2)
  %i.ae = getelementptr i8, ptr %i.ac, i64 8
  store ptr %i.ad, ptr %i.ae, align 8
  br label %wtap_block_add_option_common.exit.thread

wtap_block_add_option_common.exit.thread:         ; preds = %wtap_block_get_option.exit.i, %bb.b, %bb.a, %bb.c, %.loopexit
  %.0 = phi i32 [ 0, %.loopexit ], [ -5, %wtap_block_get_option.exit.i ], [ -1, %bb.b ], [ -6, %bb.a ], [ -3, %bb.c ]
  ret i32 %.0
}

; Function Attrs: null_pointer_is_valid sspstrong uwtable
define range(i32 -6, 1) i32 @wtap_block_add_custom_string_option(ptr nofree noundef readonly captures(address_is_null) %0, i32 noundef %1, i32 noundef %2, ptr noundef %3, i64 noundef %4) local_unnamed_addr #0 {
bb.a:
  %i.a = icmp eq ptr %0, null
  br i1 %i.a, label %wtap_block_add_custom_string_option_common.exit.thread, label %bb.b
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.h, label %wtap_block_add_custom_string_option_common.exit.thread, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.i = getelementptr i8, ptr %i.g, i64 16
  %i.j = load i32, ptr %i.i, align 8
  %.not.i.i = icmp eq i32 %i.j, 7
  br i1 %.not.i.i, label %bb.d, label %wtap_block_add_custom_string_option_common.exit.thread

bb.d:                                             ; preds = %bb.c
  %i.k = getelementptr i8, ptr %i.g, i64 20
  %i.l = load i32, ptr %i.k, align 4
  %i.m = and i32 %i.l, 1
  %.not20.i.i = icmp eq i32 %i.m, 0
  %i.n = getelementptr i8, ptr %0, i64 16         ; 2 uses
  %i.o = load ptr, ptr %i.n, align 8              ; 3 uses
  %i.p = getelementptr i8, ptr %i.o, i64 8
  %i.q = load i32, ptr %i.p, align 8              ; 5 uses
  br i1 %.not20.i.i, label %bb.e, label %.loopexit
...
.lr.ph.i.i.i:                                     ; preds = %bb.e
  ...
  %wide.trip.count.i.i.i = zext i32 %i.q to i64
  br label %bb.g

bb.f:                                             ; preds = %bb.g
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1 ; 2 uses
  %exitcond.not.i.i.i = icmp eq i64 %indvars.iv.next.i.i.i, %wide.trip.count.i.i.i
  br i1 %exitcond.not.i.i.i, label %.loopexit, label %bb.g, !llvm.loop !0

bb.g:                                             ; preds = %bb.f, %.lr.ph.i.i.i
  %indvars.iv.i.i.i = phi i64 [ 0, %.lr.ph.i.i.i ], [ %indvars.iv.next.i.i.i, %bb.f ] ; 2 uses
  %i.s = getelementptr [32 x i8], ptr %i.r, i64 %indvars.iv.i.i.i ; 2 uses
  %i.t = load i32, ptr %i.s, align 8
  %i.u = icmp eq i32 %i.t, %1
  br i1 %i.u, label %wtap_block_get_option.exit.i.i, label %bb.f

wtap_block_get_option.exit.i.i:                   ; preds = %bb.g
  %i.v = getelementptr i8, ptr %i.s, i64 8
  %.not21.i.i = icmp eq ptr %i.v, null
  br i1 %.not21.i.i, label %.loopexit, label %wtap_block_add_custom_string_option_common.exit.thread

.loopexit:                                        ; preds = %bb.f, %wtap_block_get_option.exit.i.i, %bb.e, %bb.d
  %i.w = phi i32 [ %i.q, %bb.d ], [ %i.q, %wtap_block_get_option.exit.i.i ], [ 0, %bb.e ], [ %i.q, %bb.f ] ; 2 uses
  %i.x = add i32 %i.w, 1
  %i.y = tail call ptr @g_array_set_size(ptr noundef %i.o, i32 noundef %i.x) ; 0 uses
  %i.z = load ptr, ptr %i.n, align 8
  %i.aa = load ptr, ptr %i.z, align 8
  %i.ab = zext i32 %i.w to i64
  %i.ac = getelementptr [32 x i8], ptr %i.aa, i64 %i.ab ; 3 uses
  store i32 %1, ptr %i.ac, align 8
  %i.ad = getelementptr i8, ptr %i.ac, i64 8
  store i32 %2, ptr %i.ad, align 8
  %i.ae = tail call noalias ptr @g_strndup(ptr noundef %3, i64 noundef %4)
  %i.af = getelementptr i8, ptr %i.ac, i64 16
  store ptr %i.ae, ptr %i.af, align 8
  br label %wtap_block_add_custom_string_option_common.exit.thread

wtap_block_add_custom_string_option_common.exit.thread: ; preds = %bb.c, %bb.a, %bb.b, %wtap_block_get_option.exit.i.i, %.loopexit
  %.0 = phi i32 [ 0, %.loopexit ], [ -3, %bb.c ], [ -6, %bb.a ], [ -1, %bb.b ], [ -5, %wtap_block_get_option.exit.i.i ]
  ret i32 %.0
}

; Function Attrs: null_pointer_is_valid sspstrong uwtable
define range(i32 -6, 1) i32 @wtap_block_add_custom_binary_option(ptr nofree noundef readonly captures(address_is_null) %0, i32 noundef %1, i32 noundef %2, ptr nofree noundef readonly captures(none) %3) local_unnamed_addr #0 {
bb.a:
  %i.a = icmp eq ptr %0, null
  br i1 %i.a, label %wtap_block_add_custom_binary_option_common.exit.thread, label %bb.b
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = tail call ptr @g_hash_table_lookup(ptr noundef %i.d, ptr noundef %i.f) ; 3 uses
  %i.h = icmp eq ptr %i.g, null
  br i1 %i.h, label %wtap_block_add_custom_binary_option_common.exit.thread, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.i = getelementptr i8, ptr %i.g, i64 16
  %i.j = load i32, ptr %i.i, align 8
  %.not.i.i = icmp eq i32 %i.j, 8
  br i1 %.not.i.i, label %bb.d, label %wtap_block_add_custom_binary_option_common.exit.thread
...
wtap_block_get_option.exit.i.i:                   ; preds = %bb.g
  %i.v = getelementptr i8, ptr %i.s, i64 8
  %.not21.i.i = icmp eq ptr %i.v, null
  br i1 %.not21.i.i, label %.loopexit, label %wtap_block_add_custom_binary_option_common.exit.thread
...
.loopexit:                                        ; preds = %bb.f, %wtap_block_get_option.exit.i.i, %bb.e, %bb.d
  ...
  %i.aa = load ptr, ptr %i.z, align 8
  %i.ab = zext i32 %i.w to i64
  %i.ac = getelementptr [32 x i8], ptr %i.aa, i64 %i.ab ; 4 uses
  store i32 %1, ptr %i.ac, align 8
  %i.ad = getelementptr i8, ptr %i.ac, i64 8
  store i32 %2, ptr %i.ad, align 8
  ...
  %i.ai = tail call ptr @g_memdup2(ptr noundef %i.ah, i64 noundef %i.ae) #18
  %i.aj = getelementptr i8, ptr %i.ac, i64 24
  store ptr %i.ai, ptr %i.aj, align 8
  br label %wtap_block_add_custom_binary_option_common.exit.thread

wtap_block_add_custom_binary_option_common.exit.thread: ; preds = %bb.c, %bb.a, %bb.b, %wtap_block_get_option.exit.i.i, %.loopexit
  %.0 = phi i32 [ 0, %.loopexit ], [ -3, %bb.c ], [ -6, %bb.a ], [ -1, %bb.b ], [ -5, %wtap_block_get_option.exit.i.i ]
  ret i32 %.0
}
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = tail call ptr @g_hash_table_lookup(ptr noundef %i.d, ptr noundef %i.f) ; 3 uses
  %i.h = icmp eq ptr %i.g, null
  br i1 %i.h, label %wtap_block_add_option_common.exit.thread, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.i = getelementptr i8, ptr %i.g, i64 16
  %i.j = load i32, ptr %i.i, align 8
  %.not.i = icmp eq i32 %i.j, 9
  br i1 %.not.i, label %bb.d, label %wtap_block_add_option_common.exit.thread

bb.d:                                             ; preds = %bb.c
  %i.k = getelementptr i8, ptr %i.g, i64 20
  %i.l = load i32, ptr %i.k, align 4
  %i.m = and i32 %i.l, 1
  %.not20.i = icmp eq i32 %i.m, 0
  %i.n = getelementptr i8, ptr %0, i64 16         ; 2 uses
  %i.o = load ptr, ptr %i.n, align 8              ; 3 uses
  %i.p = getelementptr i8, ptr %i.o, i64 8
  %i.q = load i32, ptr %i.p, align 8              ; 5 uses
  br i1 %.not20.i, label %bb.e, label %.loopexit
...
bb.f:                                             ; preds = %bb.g
  ...
  br i1 %exitcond.not.i.i, label %.loopexit, label %bb.g, !llvm.loop !0
...
.loopexit:                                        ; preds = %bb.f, %wtap_block_get_option.exit.i, %bb.e, %bb.d
  ...
  %i.aa = load ptr, ptr %i.z, align 8
  %i.ab = zext i32 %i.w to i64
  %i.ac = getelementptr [32 x i8], ptr %i.aa, i64 %i.ab ; 5 uses
  store i32 %1, ptr %i.ac, align 8
  %i.ad = getelementptr i8, ptr %i.ac, i64 8
  ...
  %i.ae = load i32, ptr %2, align 8, !noalias !16 ; 2 uses
...
bb.h:                                             ; preds = %.loopexit
  ...
  %i.ag = load ptr, ptr %i.af, align 8, !noalias !16
  %i.ah = tail call noalias ptr @g_strdup(ptr noundef %i.ag)
  br label %.sink.split.i

bb.i:                                             ; preds = %.loopexit
  %i.ai = getelementptr i8, ptr %2, i64 8
  %i.aj = load i32, ptr %i.ai, align 8, !noalias !16 ; 2 uses
  store i32 %i.aj, ptr %.sroa.516, align 8, !alias.scope !16
  %i.ak = getelementptr i8, ptr %2, i64 16
  %i.al = load ptr, ptr %i.ak, align 8, !noalias !16
  %i.am = zext i32 %i.aj to i64
  %i.an = shl nuw nsw i64 %i.am, 3
  %i.ao = tail call ptr @g_memdup2(ptr noundef %i.al, i64 noundef %i.an) #18
  br label %.sink.split.i

.sink.split.i:                                    ; preds = %bb.i, %bb.h
  %.sink7.i.sroa.phi = phi ptr [ %.sroa.9, %bb.i ], [ %.sroa.516, %bb.h ]
  %.sink.i = phi ptr [ %i.ao, %bb.i ], [ %i.ah, %bb.h ]
  store ptr %.sink.i, ptr %.sink7.i.sroa.phi, align 8, !alias.scope !16
...
wtap_block_add_option_common.exit.thread:         ; preds = %wtap_block_get_option.exit.i, %bb.b, %bb.a, %bb.c, %if_filter_dup.exit
  %.0 = phi i32 [ 0, %if_filter_dup.exit ], [ -5, %wtap_block_get_option.exit.i ], [ -1, %bb.b ], [ -6, %bb.a ], [ -3, %bb.c ]
  ret i32 %.0
}

; Function Attrs: null_pointer_is_valid sspstrong uwtable
define range(i32 -6, 1) i32 @wtap_block_add_packet_verdict_option(ptr nofree noundef readonly captures(address_is_null) %0, i32 noundef %1, ptr nofree noundef readonly captures(none) %2) local_unnamed_addr #0 {
bb.a:
  %i.a = icmp eq ptr %0, null
  br i1 %i.a, label %wtap_block_add_option_common.exit.thread, label %bb.b
...
.loopexit:                                        ; preds = %bb.f, %wtap_block_get_option.exit.i, %bb.e, %bb.d
  ...
  store i32 %1, ptr %i.ac, align 8
  %i.ad = getelementptr i8, ptr %i.ac, i64 8
  %i.ae = load i32, ptr %2, align 8               ; 2 uses
  switch i32 %i.ae, label %packet_verdict_dup.exit [
    i32 0, label %bb.h
    i32 1, label %bb.i
    i32 2, label %bb.j
  ]
...
bb.h:                                             ; preds = %.loopexit
  %i.af = getelementptr i8, ptr %2, i64 8         ; 2 uses
  %i.ag = load ptr, ptr %i.af, align 8            ; 2 uses
  %i.ah = load ptr, ptr %i.ag, align 8
  %i.ai = getelementptr i8, ptr %i.ag, i64 8
  %i.aj = load i32, ptr %i.ai, align 8
  %i.ak = zext i32 %i.aj to i64
  %i.al = tail call ptr @g_memdup2(ptr noundef %i.ah, i64 noundef %i.ak) #18
  %i.am = load ptr, ptr %i.af, align 8
  %i.an = getelementptr i8, ptr %i.am, i64 8
  %i.ao = load i32, ptr %i.an, align 8
  %i.ap = zext i32 %i.ao to i64
  %i.aq = tail call ptr @g_byte_array_new_take(ptr noundef %i.al, i64 noundef %i.ap)
...
packet_verdict_dup.exit:                          ; preds = %.loopexit, %bb.h, %bb.i, %bb.j
  %.sroa.37.0.i = phi ptr [ null, %.loopexit ], [ %i.aq, %bb.h ], [ %i.at, %bb.i ], [ %i.aw, %bb.j ]
  store i32 %i.ae, ptr %i.ad, align 8
  %.sroa.41.0..sroa_idx = getelementptr i8, ptr %i.ac, i64 16
  store ptr %.sroa.37.0.i, ptr %.sroa.41.0..sroa_idx, align 8
  br label %wtap_block_add_option_common.exit.thread

wtap_block_add_option_common.exit.thread:         ; preds = %wtap_block_get_option.exit.i, %bb.b, %bb.a, %bb.c, %packet_verdict_dup.exit
  %.0 = phi i32 [ 0, %packet_verdict_dup.exit ], [ -5, %wtap_block_get_option.exit.i ], [ -1, %bb.b ], [ -6, %bb.a ], [ -3, %bb.c ]
  ret i32 %.0
}

; Function Attrs: null_pointer_is_valid sspstrong uwtable
define range(i32 -6, 1) i32 @wtap_block_add_packet_hash_option(ptr nofree noundef readonly captures(address_is_null) %0, i32 noundef %1, ptr nofree noundef readonly captures(none) %2) local_unnamed_addr #0 {
bb.a:
  %i.a = icmp eq ptr %0, null
  br i1 %i.a, label %wtap_block_add_option_common.exit.thread, label %bb.b
...
.loopexit:                                        ; preds = %bb.f, %wtap_block_get_option.exit.i, %bb.e, %bb.d
  ...
  store i32 %1, ptr %i.ac, align 8
  %i.ad = getelementptr i8, ptr %i.ac, i64 8
  %i.ae = load i8, ptr %2, align 8
  %i.af = getelementptr i8, ptr %2, i64 8         ; 2 uses
  %i.ag = load ptr, ptr %i.af, align 8            ; 2 uses
  %i.ah = load ptr, ptr %i.ag, align 8
  %i.ai = getelementptr i8, ptr %i.ag, i64 8
end_hunk_0
begin_hunk_1_@wtap_block_add_custom_binary_option_from_data:bb.a
  br i1 %.not21.i.i, label %.loopexit, label %wtap_block_add_custom_binary_option_common.exit.thread
...
.loopexit:                                        ; preds = %bb.f, %wtap_block_get_option.exit.i.i, %bb.e, %bb.d
  ...
  store i64 %4, ptr %i.ae, align 8
  %i.af = tail call ptr @g_memdup2(ptr noundef %3, i64 noundef %4) #18
...
; Function Attrs: null_pointer_is_valid sspstrong uwtable
define range(i32 -6, 1) i32 @wtap_block_get_nth_custom_binary_option_value(ptr nofree noundef readonly captures(address_is_null) %0, i32 noundef %1, i32 noundef %2, i32 noundef %3, ptr nofree noundef writeonly captures(none) %4) local_unnamed_addr #0 {
bb.a:
  %i.a = icmp eq ptr %0, null
  br i1 %i.a, label %wtap_block_get_nth_custom_option_with_pen_common.exit.thread, label %bb.b
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = tail call ptr @g_hash_table_lookup(ptr noundef %i.d, ptr noundef %i.f) ; 3 uses
  %i.h = icmp eq ptr %i.g, null
  br i1 %i.h, label %wtap_block_get_nth_custom_option_with_pen_common.exit.thread, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.i = getelementptr i8, ptr %i.g, i64 16
  %i.j = load i32, ptr %i.i, align 8
  %.not.i = icmp eq i32 %i.j, 8
  br i1 %.not.i, label %bb.d, label %wtap_block_get_nth_custom_option_with_pen_common.exit.thread
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %.not17.i, label %wtap_block_get_nth_custom_option_with_pen_common.exit.thread, label %bb.e
...
bb.e:                                             ; preds = %bb.d
  ...
  %.not.i.i = icmp eq i32 %i.q, 0
  br i1 %.not.i.i, label %wtap_block_get_nth_custom_option_with_pen_common.exit.thread, label %.lr.ph.i.i
...
bb.f:                                             ; preds = %bb.g
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1 ; 2 uses
  %exitcond.not.i.i = icmp eq i64 %indvars.iv.next.i.i, %wide.trip.count.i.i
  br i1 %exitcond.not.i.i, label %if_filter_free.exit, label %bb.g, !llvm.loop !0
...
wtap_block_get_option_common.exit:                ; preds = %wtap_block_get_option.exit.i
  ...
  store ptr null, ptr %.sroa.9, align 8
  %i.x = load i32, ptr %2, align 8, !noalias !26  ; 2 uses
...
bb.h:                                             ; preds = %wtap_block_get_option_common.exit
  ...
  %i.z = load ptr, ptr %i.y, align 8, !noalias !26
...
bb.i:                                             ; preds = %wtap_block_get_option_common.exit
  ...
  %i.ac = load i32, ptr %i.ab, align 8, !noalias !26 ; 2 uses
  store i32 %i.ac, ptr %.sroa.523, align 8, !alias.scope !26
  %i.ad = getelementptr i8, ptr %2, i64 16
  %i.ae = load ptr, ptr %i.ad, align 8, !noalias !26
...
.sink.split.i:                                    ; preds = %bb.i, %bb.h
  ...
  store ptr %.sink.i, ptr %.sink7.i.sroa.phi, align 8, !alias.scope !26
...
bb.f:                                             ; preds = %bb.g
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1 ; 2 uses
  %exitcond.not.i.i = icmp eq i64 %indvars.iv.next.i.i, %wide.trip.count.i.i
  br i1 %exitcond.not.i.i, label %wtap_block_get_option_common.exit.thread, label %bb.g, !llvm.loop !0
...
bb.i:                                             ; preds = %bb.h, %bb.f
  ...
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1 ; 2 uses
  %exitcond.not.i.i = icmp eq i64 %indvars.iv.next.i.i, %wide.trip.count.i.i
  br i1 %exitcond.not.i.i, label %wtap_packet_verdict_free.exit, label %bb.f, !llvm.loop !1
