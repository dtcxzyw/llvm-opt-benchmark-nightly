...
bb.f:                                             ; preds = %bb.g
  ...
  br i1 %exitcond.not.i.i.i, label %.loopexit, label %bb.g, !llvm.loop !11
...
bb.f:                                             ; preds = %bb.g
  ...
  br i1 %exitcond.not.i.i, label %.loopexit, label %bb.g, !llvm.loop !11
...
bb.h:                                             ; preds = %.loopexit
  ...
  %i.ag = load ptr, ptr %i.af, align 8, !noalias !13
  %i.ah = tail call noalias ptr @g_strdup(ptr noundef %i.ag)
  br label %.sink.split.i

bb.i:                                             ; preds = %.loopexit
  %i.ai = getelementptr i8, ptr %2, i64 8
  %i.aj = load i32, ptr %i.ai, align 8, !noalias !13 ; 2 uses
  store i32 %i.aj, ptr %.sroa.516, align 8, !alias.scope !13
  %i.ak = getelementptr i8, ptr %2, i64 16
  %i.al = load ptr, ptr %i.ak, align 8, !noalias !13
