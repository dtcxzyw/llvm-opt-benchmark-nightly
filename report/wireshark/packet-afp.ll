...
bb.aa:                                            ; preds = %bb.y
  ...
  %i.em = call i64 @tvb_get_uint64(ptr noundef %0, i32 noundef %i.el, i32 noundef range(i32 0, -2147483647) %7) ; 3 uses
  ...
  %11 = and i32 %10, 65535
  %i.et = call ptr @proto_tree_add_uint(ptr noundef %i.ei, i32 noundef %i.er, ptr noundef %0, i32 noundef %i.es, i32 noundef 2, i32 noundef %11) ; 0 uses
