...
bb.c:                                             ; preds = %_ZNK4QSetI19format_size_units_eE4sizeEv.exit
  %i.f = load ptr, ptr %1, align 8, !noalias !177 ; 4 uses
...
bb.f:                                             ; preds = %.lr.ph
  ...
  br i1 %i.n, label %._crit_edge, label %.lr.ph, !llvm.loop !180
...
.lr.ph:                                           ; preds = %bb.e, %bb.f
  ...
  br i1 %.not.i.i.i.i.i, label %bb.f, label %_ZNK4QSetI19format_size_units_eE14const_iteratorneERKS2_.exit.thread.lr.ph, !llvm.loop !180

_ZNK4QSetI19format_size_units_eE14const_iteratorneERKS2_.exit.thread.lr.ph: ; preds = %.lr.ph, %bb.d
...
_ZNK4QSetI19format_size_units_eE14const_iteratorneERKS2_.exit.thread: ; preds = %_ZNK4QSetI19format_size_units_eE14const_iteratorneERKS2_.exit.thread.lr.ph, %_ZN4QSetI19format_size_units_eE14const_iteratorppEv.exit
  ...
  %.sroa.09.015 = phi ptr [ %i.f, %_ZNK4QSetI19format_size_units_eE14const_iteratorneERKS2_.exit.thread.lr.ph ], [ %.sroa.09.1, %_ZN4QSetI19format_size_units_eE14const_iteratorppEv.exit ] ; 3 uses
...
._crit_edge:                                      ; preds = %bb.f, %_ZN4QSetI19format_size_units_eE14const_iteratorppEv.exit, %bb.c, %bb.e
  ret void
...
bb.c:                                             ; preds = %_ZNK4QSetI7QStringE4sizeEv.exit
  %i.e = load ptr, ptr %1, align 8, !noalias !182 ; 4 uses
...
bb.f:                                             ; preds = %.lr.ph
  ...
  br i1 %i.m, label %._crit_edge, label %.lr.ph, !llvm.loop !185
...
.lr.ph:                                           ; preds = %bb.e, %bb.f
  ...
  br i1 %.not.i.i.i.i.i, label %bb.f, label %_ZNK4QSetI7QStringE14const_iteratorneERKS2_.exit.thread.lr.ph, !llvm.loop !185
