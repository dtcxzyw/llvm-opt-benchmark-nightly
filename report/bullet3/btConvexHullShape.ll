...
.lr.ph.i:                                         ; preds = %bb.a
  ...
  %2 = load float, ptr %i.h, align 4, !tbaa !28
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 36
  %3 = getelementptr inbounds nuw i8, ptr %1, i64 8
  %4 = load float, ptr %3, align 4, !tbaa !28
  %i.j = load <2 x float>, ptr %i.i, align 4, !tbaa !28 ; 3 uses
  %5 = extractelement <2 x float> %i.j, i64 0
  %6 = fmul float %2, %5
  %7 = extractelement <2 x float> %i.j, i64 1
  %8 = fmul float %4, %7
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.i
  ...
  %i.v = tail call noundef float @llvm.fmuladd.f32(float %i.u, float %8, float %i.s) ; 2 uses
...
_ZNK9btVector36maxDotEPKS_lRf.exit:               ; preds = %bb.b
  ...
  %i.ae = fmul <2 x float> %i.j, %i.ad            ; 2 uses
