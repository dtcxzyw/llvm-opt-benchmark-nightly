...
bb.b:                                             ; preds = %.lr.ph, %bb.f
  ...
  %7 = load float, ptr %i.k, align 4, !tbaa !28
  %8 = load <3 x float>, ptr %i.t, align 4, !tbaa !28
  %9 = load <3 x float>, ptr %i.e, align 8, !tbaa !28
  %10 = fmul <3 x float> %8, %9                   ; 6 uses
  ...
  %12 = shufflevector <2 x float> %i.z, <2 x float> %i.aa, <2 x i32> <i32 1, i32 3>
  %13 = fmul <2 x float> %11, %12
  %i.ab = shufflevector <3 x float> %10, <3 x float> poison, <2 x i32> zeroinitializer
  %14 = shufflevector <2 x float> %i.z, <2 x float> %i.aa, <2 x i32> <i32 0, i32 2>
  %15 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ab, <2 x float> %14, <2 x float> %13)
  %16 = shufflevector <3 x float> %10, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.ac = insertelement <2 x float> %i.v, float %i.w, i64 1
  %17 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %16, <2 x float> %i.ac, <2 x float> %15)
  %18 = extractelement <3 x float> %10, i64 1
  %19 = fmul float %18, %i.y
  %20 = extractelement <3 x float> %10, i64 0
  %21 = tail call float @llvm.fmuladd.f32(float %20, float %i.x, float %19)
  %22 = extractelement <3 x float> %10, i64 2
  %23 = tail call noundef float @llvm.fmuladd.f32(float %22, float %7, float %21)
  %i.ad = load <2 x float>, ptr %i.l, align 4, !tbaa !28
  %i.ae = fadd <2 x float> %17, %i.ad             ; 4 uses
