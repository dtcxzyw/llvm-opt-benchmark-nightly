...
bb.b:                                             ; preds = %.lr.ph, %bb.f
  ...
  %9 = getelementptr inbounds nuw i8, ptr %i.t, i64 4
  %10 = getelementptr inbounds nuw i8, ptr %i.t, i64 8
  ...
  %11 = load float, ptr %9, align 4, !tbaa !29
  %12 = load float, ptr %i.t, align 4, !tbaa !29
  %13 = load float, ptr %10, align 4, !tbaa !29
  %14 = load float, ptr %7, align 4, !tbaa !29
  %15 = load float, ptr %i.e, align 8, !tbaa !29
  %16 = load float, ptr %8, align 8, !tbaa !29
  %17 = fmul float %11, %14                       ; 2 uses
  %18 = fmul float %12, %15                       ; 2 uses
  %19 = fmul float %13, %16                       ; 2 uses
  ...
  %i.ad = fmul <2 x float> %21, %i.ac
  %22 = insertelement <2 x float> poison, float %18, i64 0
  %i.ae = shufflevector <2 x float> %22, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.ah = insertelement <2 x float> poison, float %19, i64 0
  %23 = shufflevector <2 x float> %i.ah, <2 x float> poison, <2 x i32> zeroinitializer
  %24 = insertelement <2 x float> %i.v, float %i.w, i64 1
  %25 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %23, <2 x float> %24, <2 x float> %i.ag)
  %26 = fmul float %17, %i.y
  %i.ai = tail call float @llvm.fmuladd.f32(float %18, float %i.x, float %26)
  %i.aj = tail call noundef float @llvm.fmuladd.f32(float %19, float %i.z, float %i.ai)
  %i.ak = load <2 x float>, ptr %i.l, align 4, !tbaa !29
  %i.al = fadd <2 x float> %25, %i.ak             ; 4 uses
