...
bb.a:
  ...
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !68   ; 21 uses
...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  %i.bj = load <4 x float>, ptr %2, align 4       ; 11 uses
  %.sroa.5164.0.copyload = load float, ptr %i.r, align 4 ; 8 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %14 = getelementptr inbounds nuw i8, ptr %i.l, i64 376
  ...
  %15 = getelementptr inbounds nuw i8, ptr %i.l, i64 392
  ...
  %i.cc = load <2 x float>, ptr %i.bk, align 4, !tbaa !60
  %16 = load float, ptr %14, align 4, !tbaa !60
  %i.cd = load <2 x float>, ptr %i.bn, align 4, !tbaa !60
  %17 = load float, ptr %15, align 4, !tbaa !60
  %18 = fmul float %.sroa.5164.0.copyload, %17
  %19 = fmul float %.sroa.5164.0.copyload, %16
  ...
  %i.cg = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ce, <2 x float> %i.cf, <2 x float> %21)
...
bb.h:                                             ; preds = %bb.g
  ...
  %22 = getelementptr inbounds nuw i8, ptr %i.l, i64 376
  ...
  %23 = getelementptr inbounds nuw i8, ptr %i.l, i64 392
  %i.dz = getelementptr inbounds nuw i8, ptr %i.l, i64 396
  %i.ea = load float, ptr %i.dz, align 4, !tbaa !60
  %i.eb = load <2 x float>, ptr %i.dv, align 4, !tbaa !60
  %24 = load float, ptr %22, align 4, !tbaa !60
  %i.ec = load <2 x float>, ptr %i.dy, align 4, !tbaa !60
  %25 = load float, ptr %23, align 4, !tbaa !60
  %26 = fmul float %.sroa.5164.0.copyload, %25
  %27 = fmul float %.sroa.5164.0.copyload, %24
  ...
  %i.ef = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ed, <2 x float> %i.ee, <2 x float> %29)
