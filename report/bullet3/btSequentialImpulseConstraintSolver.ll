...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !136, !nonnull !103, !align !139 ; 15 uses
  %i.c = getelementptr inbounds nuw i8, ptr %2, i64 48 ; 2 uses
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !140, !nonnull !103, !align !139 ; 15 uses
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  %8 = getelementptr inbounds nuw i8, ptr %i.cy, i64 4
  %i.dk = getelementptr inbounds nuw i8, ptr %i.di, i64 380
  %i.dl = load float, ptr %i.dk, align 4, !tbaa !61
  %i.dm = getelementptr inbounds nuw i8, ptr %i.cy, i64 8
  %9 = getelementptr inbounds nuw i8, ptr %i.di, i64 388
  %i.dn = getelementptr inbounds nuw i8, ptr %i.di, i64 396
  %i.do = load float, ptr %i.dn, align 4, !tbaa !61
  %i.dp = getelementptr inbounds nuw i8, ptr %i.di, i64 404
  %10 = load float, ptr %i.dp, align 4, !tbaa !61
  %i.dq = getelementptr inbounds nuw i8, ptr %i.di, i64 408
  %i.dr = load float, ptr %i.dq, align 8, !tbaa !61
  %i.ds = getelementptr inbounds nuw i8, ptr %i.di, i64 412
  %i.dt = load float, ptr %i.ds, align 4, !tbaa !61
  %i.du = getelementptr inbounds nuw i8, ptr %i.di, i64 672
  %11 = load <2 x float>, ptr %i.dj, align 4, !tbaa !61 ; 2 uses
  %12 = load <2 x float>, ptr %9, align 4, !tbaa !61 ; 2 uses
  %13 = shufflevector <2 x float> %11, <2 x float> %12, <2 x i32> <i32 1, i32 3>
  %14 = shufflevector <2 x float> %11, <2 x float> %12, <2 x i32> <i32 0, i32 2>
  %15 = insertelement <2 x float> poison, float %i.dl, i64 0
  %16 = insertelement <2 x float> %15, float %i.do, i64 1
  %17 = load <2 x float>, ptr %i.du, align 8, !tbaa !61
  %i.dv = getelementptr inbounds nuw i8, ptr %i.di, i64 680
  %i.dw = load float, ptr %i.dv, align 8, !tbaa !61
  %18 = getelementptr inbounds nuw i8, ptr %i.cy, i64 64
  %.sroa.417.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.cy, i64 72
  %19 = getelementptr inbounds nuw i8, ptr %i.cy, i64 32
  %i.dx = getelementptr inbounds nuw i8, ptr %i.cy, i64 36
  %20 = getelementptr inbounds nuw i8, ptr %i.cy, i64 40
  %21 = getelementptr inbounds nuw i8, ptr %i.cy, i64 80
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.cy, i64 88
  %22 = getelementptr inbounds nuw i8, ptr %i.cy, i64 16
  %23 = getelementptr inbounds nuw i8, ptr %i.cy, i64 20
  %24 = getelementptr inbounds nuw i8, ptr %i.cy, i64 24
  %25 = getelementptr inbounds nuw i8, ptr %i.cy, i64 48
  %26 = getelementptr inbounds nuw i8, ptr %i.cy, i64 52
  %27 = getelementptr inbounds nuw i8, ptr %i.cy, i64 56
  %28 = load <2 x float>, ptr %i.cy, align 8, !tbaa !61 ; 6 uses
  %29 = extractelement <2 x float> %28, i64 0     ; 4 uses
  %30 = shufflevector <2 x float> %28, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %31 = fmul <2 x float> %30, %13
  %i.dy = shufflevector <2 x float> %28, <2 x float> poison, <2 x i32> zeroinitializer
  %i.dz = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> %i.dy, <2 x float> %31)
  %i.ea = load <2 x float>, ptr %19, align 8, !tbaa !61 ; 5 uses
  %32 = extractelement <2 x float> %i.ea, i64 0   ; 4 uses
  %33 = shufflevector <2 x float> %i.ea, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %34 = shufflevector <2 x float> %i.ea, <2 x float> poison, <2 x i32> zeroinitializer
  %35 = load <2 x float>, ptr %8, align 4, !tbaa !61 ; 5 uses
  %i.eb = load float, ptr %i.dm, align 8, !tbaa !61 ; 4 uses
  %36 = shufflevector <2 x float> %35, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %37 = load <2 x float>, ptr %i.dx, align 4, !tbaa !61 ; 5 uses
  %38 = load float, ptr %20, align 8, !tbaa !61   ; 4 uses
  %39 = shufflevector <2 x float> %37, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %40 = extractelement <2 x float> %35, i64 0     ; 4 uses
  %41 = fmul float %40, %i.dr
  %42 = call float @llvm.fmuladd.f32(float %10, float %29, float %41)
  %43 = call noundef float @llvm.fmuladd.f32(float %i.dt, float %i.eb, float %42)
  %44 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %16, <2 x float> %36, <2 x float> %i.dz)
  %45 = fmul <2 x float> %44, %17
  %46 = fmul float %43, %i.dw
  %.sroa.3.12.vec.insert.i129 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %46, i64 0
  store <2 x float> %45, ptr %18, align 8
  store <2 x float> %.sroa.3.12.vec.insert.i129, ptr %.sroa.417.0..sroa_idx, align 8, !tbaa !83
  %47 = load ptr, ptr %i.c, align 8, !tbaa !140, !nonnull !103, !align !139 ; 9 uses
  %48 = getelementptr inbounds nuw i8, ptr %47, i64 372
  %i.ec = getelementptr inbounds nuw i8, ptr %47, i64 380
  %i.ed = load float, ptr %i.ec, align 4, !tbaa !61
  %i.ee = getelementptr inbounds nuw i8, ptr %47, i64 388
  %i.ef = getelementptr inbounds nuw i8, ptr %47, i64 396
  %i.eg = load float, ptr %i.ef, align 4, !tbaa !61
  %i.eh = getelementptr inbounds nuw i8, ptr %47, i64 404
  %i.ei = load float, ptr %i.eh, align 4, !tbaa !61
  %i.ej = getelementptr inbounds nuw i8, ptr %47, i64 408
  %i.ek = load float, ptr %i.ej, align 8, !tbaa !61
  %49 = extractelement <2 x float> %37, i64 0     ; 4 uses
  %i.el = fmul float %49, %i.ek
  %i.em = call float @llvm.fmuladd.f32(float %i.ei, float %32, float %i.el)
  %i.en = getelementptr inbounds nuw i8, ptr %47, i64 412
  %i.eo = load float, ptr %i.en, align 4, !tbaa !61
  %i.ep = call noundef float @llvm.fmuladd.f32(float %i.eo, float %38, float %i.em)
  %i.eq = getelementptr inbounds nuw i8, ptr %47, i64 672
  %i.er = load <2 x float>, ptr %48, align 4, !tbaa !61 ; 2 uses
  %i.es = load <2 x float>, ptr %i.ee, align 4, !tbaa !61 ; 2 uses
  %50 = shufflevector <2 x float> %i.er, <2 x float> %i.es, <2 x i32> <i32 1, i32 3>
  %51 = fmul <2 x float> %33, %50
  %52 = shufflevector <2 x float> %i.er, <2 x float> %i.es, <2 x i32> <i32 0, i32 2>
  %53 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %52, <2 x float> %34, <2 x float> %51)
  %54 = insertelement <2 x float> poison, float %i.ed, i64 0
  %i.et = insertelement <2 x float> %54, float %i.eg, i64 1
  %55 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.et, <2 x float> %39, <2 x float> %53)
  %56 = load <2 x float>, ptr %i.eq, align 8, !tbaa !61
  %57 = fmul <2 x float> %55, %56
  %58 = getelementptr inbounds nuw i8, ptr %47, i64 680
  %59 = load float, ptr %58, align 8, !tbaa !61
  %60 = fmul float %i.ep, %59
  %.sroa.3.12.vec.insert.i139.a = insertelement <2 x float> <float poison, float 0.000000e+00>, float %60, i64 0
  store <2 x float> %57, ptr %21, align 8
  store <2 x float> %.sroa.3.12.vec.insert.i139.a, ptr %.sroa.4.0..sroa_idx, align 8, !tbaa !83
  %61 = load float, ptr %i.be, align 4, !tbaa !84 ; 3 uses
  %i.eu = load <2 x float>, ptr %22, align 8, !tbaa !61 ; 3 uses
  %62 = load float, ptr %23, align 4, !tbaa !61   ; 2 uses
  %63 = load float, ptr %24, align 8, !tbaa !61   ; 3 uses
  %i.ev = load float, ptr %i.bg, align 8, !tbaa !61
  %64 = load float, ptr %i.bf, align 4, !tbaa !61
  %65 = load float, ptr %i.bh, align 4, !tbaa !61
  %66 = load float, ptr %i.bj, align 8, !tbaa !61
  %67 = load float, ptr %i.bi, align 4, !tbaa !61
  %68 = load float, ptr %i.bk, align 4, !tbaa !61
  %69 = load <2 x float>, ptr %i.bl, align 4, !tbaa !61 ; 2 uses
  %70 = load float, ptr %i.bm, align 4, !tbaa !61
  %i.ew = load float, ptr %i.bn, align 4, !tbaa !84 ; 3 uses
  %71 = load <2 x float>, ptr %25, align 8, !tbaa !61 ; 2 uses
  %i.ex = load float, ptr %26, align 4, !tbaa !61 ; 2 uses
  %72 = load float, ptr %27, align 8, !tbaa !61   ; 3 uses
  %73 = load float, ptr %i.bp, align 8, !tbaa !61
  %i.ey = load float, ptr %i.bo, align 4, !tbaa !61
  %i.ez = fmul float %49, %73
  %74 = extractelement <2 x float> %71, i64 0     ; 2 uses
  %75 = fmul float %i.ew, %74
  %i.fa = fmul float %40, %i.ev
  %76 = extractelement <2 x float> %i.eu, i64 0   ; 2 uses
  %77 = fmul float %61, %76
  %78 = call float @llvm.fmuladd.f32(float %i.ey, float %32, float %i.ez)
  %i.fb = call float @llvm.fmuladd.f32(float %64, float %29, float %i.fa)
  %i.fc = load float, ptr %i.bq, align 4, !tbaa !61
  %79 = call noundef float @llvm.fmuladd.f32(float %i.fc, float %38, float %78)
  %i.fd = call noundef float @llvm.fmuladd.f32(float %65, float %i.eb, float %i.fb)
  %i.fe = load float, ptr %i.bs, align 8, !tbaa !61
  %i.ff = load float, ptr %i.br, align 4, !tbaa !61
  %80 = fmul float %49, %i.fe
  %i.fg = fmul float %i.ew, %i.ex
  %81 = fmul float %40, %66
  %82 = fmul float %61, %62
  %i.fh = call float @llvm.fmuladd.f32(float %i.ff, float %32, float %80)
  %83 = call float @llvm.fmuladd.f32(float %67, float %29, float %81)
  %i.fi = load float, ptr %i.bt, align 4, !tbaa !61
  %84 = call noundef float @llvm.fmuladd.f32(float %i.fi, float %38, float %i.fh)
  %i.fj = call noundef float @llvm.fmuladd.f32(float %68, float %i.eb, float %83)
  %85 = load <2 x float>, ptr %i.bu, align 4, !tbaa !61 ; 2 uses
  %86 = fmul float %i.ew, %72
  %87 = shufflevector <2 x float> %37, <2 x float> %35, <2 x i32> <i32 0, i32 2>
  %88 = shufflevector <2 x float> %85, <2 x float> %69, <2 x i32> <i32 1, i32 3>
  %89 = fmul <2 x float> %87, %88
  %i.fk = fmul float %61, %63
  %90 = shufflevector <2 x float> %85, <2 x float> %69, <2 x i32> <i32 0, i32 2>
  %91 = shufflevector <2 x float> %i.ea, <2 x float> %28, <2 x i32> <i32 0, i32 2>
  %92 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %90, <2 x float> %91, <2 x float> %89)
  %i.fl = load float, ptr %i.bv, align 4, !tbaa !61
  %93 = insertelement <2 x float> poison, float %i.fl, i64 0
  %94 = insertelement <2 x float> %93, float %70, i64 1
  %95 = shufflevector <2 x float> %37, <2 x float> %35, <2 x i32> <i32 1, i32 3>
  %96 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %94, <2 x float> %95, <2 x float> %92)
  %97 = shufflevector <2 x float> %i.eu, <2 x float> %28, <4 x i32> <i32 1, i32 3, i32 poison, i32 poison>
  %98 = shufflevector <2 x float> %71, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %99 = shufflevector <4 x float> %97, <4 x float> %98, <4 x i32> <i32 0, i32 1, i32 5, i32 poison>
  %100 = shufflevector <2 x float> %i.ea, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %101 = shufflevector <4 x float> %99, <4 x float> %100, <4 x i32> <i32 0, i32 1, i32 2, i32 5>
  %102 = insertelement <4 x float> poison, float %82, i64 0
  %103 = insertelement <4 x float> %102, float %i.fj, i64 1
  %104 = insertelement <4 x float> %103, float %i.fg, i64 2
  %105 = insertelement <4 x float> %104, float %84, i64 3
  %106 = fmul <4 x float> %101, %105
  %107 = insertelement <4 x float> poison, float %77, i64 0
  %108 = insertelement <4 x float> %107, float %i.fd, i64 1
  %109 = insertelement <4 x float> %108, float %75, i64 2
  %110 = insertelement <4 x float> %109, float %79, i64 3
  %111 = shufflevector <2 x float> %i.eu, <2 x float> %28, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
  %112 = shufflevector <4 x float> %111, <4 x float> %98, <4 x i32> <i32 0, i32 1, i32 4, i32 poison>
  %113 = shufflevector <4 x float> %112, <4 x float> %100, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %114 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %110, <4 x float> %113, <4 x float> %106)
  %115 = insertelement <4 x float> poison, float %i.fk, i64 0
  %116 = shufflevector <2 x float> %96, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %117 = shufflevector <4 x float> %115, <4 x float> %116, <4 x i32> <i32 0, i32 5, i32 poison, i32 4>
  %118 = insertelement <4 x float> %117, float %86, i64 2
  %119 = shufflevector <2 x float> %35, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %120 = insertelement <4 x float> %119, float %63, i64 0
  %121 = shufflevector <2 x float> %37, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %122 = shufflevector <4 x float> %120, <4 x float> %121, <4 x i32> <i32 0, i32 1, i32 poison, i32 5>
  %123 = insertelement <4 x float> %122, float %72, i64 2
  %124 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %118, <4 x float> %123, <4 x float> %114) ; 4 uses
  %shift = shufflevector <4 x float> %124, <4 x float> poison, <4 x i32> <i32 1, i32 poison, i32 poison, i32 poison>
  %foldExtExtBinop = fadd <4 x float> %124, %shift
  %shift258 = shufflevector <4 x float> %124, <4 x float> poison, <4 x i32> <i32 2, i32 poison, i32 poison, i32 poison>
  %foldExtExtBinop259 = fadd <4 x float> %foldExtExtBinop, %shift258
  %shift261 = shufflevector <4 x float> %124, <4 x float> poison, <4 x i32> <i32 3, i32 poison, i32 poison, i32 poison>
  %foldExtExtBinop262 = fadd <4 x float> %foldExtExtBinop259, %shift261
  %125 = extractelement <4 x float> %foldExtExtBinop262, i64 0 ; 2 uses
  %i.fm = call noundef float @llvm.fabs.f32(float %125)
  %i.fn = fcmp ogt float %i.fm, f0x34000000
  %i.fo = fdiv float 1.000000e+00, %125
...
bb.l:                                             ; preds = %bb.j, %bb.k
  ...
  %i.fz = fmul float %62, %i.fw
  %i.ga = call float @llvm.fmuladd.f32(float %76, float %i.fu, float %i.fz)
  %i.gb = call noundef float @llvm.fmuladd.f32(float %63, float %i.fy, float %i.ga)
  ...
  %i.gi = fmul float %40, %i.gf
  %i.gj = call float @llvm.fmuladd.f32(float %29, float %i.gd, float %i.gi)
  %i.gk = call noundef float @llvm.fmuladd.f32(float %i.eb, float %i.gh, float %i.gj)
  ...
  %i.gs = fmul float %i.ex, %i.gp
  %i.gt = call float @llvm.fmuladd.f32(float %74, float %i.gn, float %i.gs)
  %i.gu = call noundef float @llvm.fmuladd.f32(float %72, float %i.gr, float %i.gt)
  ...
  %i.hb = fmul float %49, %i.gy
  %i.hc = call float @llvm.fmuladd.f32(float %32, float %i.gw, float %i.hb)
  %i.hd = call noundef float @llvm.fmuladd.f32(float %38, float %i.ha, float %i.hc)
