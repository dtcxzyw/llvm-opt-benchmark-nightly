...
bb.bl:                                            ; preds = %bb.bk, %bb.bj
  ...
  %.sroa.0805.0 = phi float [ %i.we, %bb.bj ], [ %27, %bb.bk ] ; 3 uses
  %29 = phi <2 x float> [ %i.wg, %bb.bj ], [ %28, %bb.bk ] ; 4 uses
  ...
  %i.wn = fmul <2 x float> %30, %i.wm
  %31 = insertelement <2 x float> poison, float %.sroa.0805.0, i64 0
  %32 = shufflevector <2 x float> %31, <2 x float> poison, <2 x i32> zeroinitializer
  %i.wo = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.wl, <2 x float> %32, <2 x float> %i.wn)
  %i.wp = load <2 x float>, ptr %i.wk, align 4, !tbaa !18
  %33 = shufflevector <2 x float> %29, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.wq = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.wp, <2 x float> %33, <2 x float> %i.wo) ; 2 uses
  ...
  %i.wv = extractelement <2 x float> %29, i64 0   ; 2 uses
  %i.ww = fmul float %i.wv, %i.wu
  %i.wx = tail call float @llvm.fmuladd.f32(float %i.ws, float %.sroa.0805.0, float %i.ww)
  %i.wy = getelementptr inbounds nuw i8, ptr %.0663957, i64 40
  %i.wz = load float, ptr %i.wy, align 4, !tbaa !18
  %i.xa = extractelement <2 x float> %29, i64 1   ; 2 uses
...
bb.bs:                                            ; preds = %bb.br, %bb.bu
  ...
  %i.aee = tail call float @llvm.fmuladd.f32(float %.sroa.0805.0, float %i.aea, float %i.aed)
