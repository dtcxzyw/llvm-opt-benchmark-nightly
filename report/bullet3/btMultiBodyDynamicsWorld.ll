...
bb.b:                                             ; preds = %bb.a
  ...
  %i.bf = fneg <2 x float> %i.aw                  ; 3 uses
  %i.bg = extractelement <2 x float> %i.ax, i64 0 ; 3 uses
  %2 = fneg float %i.bg                           ; 3 uses
  %i.bh = extractelement <2 x float> %i.bd, i64 0
  %i.bi = fneg float %i.bh
  %i.bj = fmul float %i.bg, %i.bi
  %3 = tail call float @llvm.fmuladd.f32(float %i.ae, float %i.af, float %i.bb)
  %i.bk = extractelement <2 x float> %i.bf, i64 1 ; 3 uses
  %i.bl = extractelement <2 x float> %i.be, i64 0 ; 2 uses
  %4 = tail call float @llvm.fmuladd.f32(float %i.bk, float %i.bl, float %i.bj)
  %i.bm = extractelement <2 x float> %i.au, i64 0
  %i.bn = extractelement <2 x float> %i.ag, i64 1
  %i.bo = tail call float @llvm.fmuladd.f32(float %i.bm, float %i.bn, float %3)
  %i.bp = extractelement <2 x float> %i.bf, i64 0 ; 3 uses
  %i.bq = extractelement <2 x float> %i.bd, i64 1 ; 2 uses
  %5 = tail call float @llvm.fmuladd.f32(float %i.bp, float %i.bq, float %4) ; 3 uses
  %6 = extractelement <2 x float> %i.au, i64 1
  %7 = extractelement <2 x float> %i.ah, i64 1
  %8 = tail call float @llvm.fmuladd.f32(float %6, float %7, float %i.bo) ; 6 uses
  %.sroa.3.12.vec.insert.i = insertelement <2 x float> %i.aw, float %8, i64 1
  store <2 x float> %i.bc, ptr %i.c, align 8
  store <2 x float> %.sroa.3.12.vec.insert.i, ptr %.sroa.414.0..sroa_idx, align 8
  %9 = shufflevector <2 x float> %i.bd, <2 x float> %i.be, <2 x i32> <i32 1, i32 2>
  %10 = fmul <2 x float> %i.ax, %9
  %shift = shufflevector <2 x float> %i.aw, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop165 = fmul <2 x float> %i.bd, %shift
  %11 = extractelement <2 x float> %foldExtExtBinop165, i64 0
  ...
  %i.bt = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bs, <2 x float> %i.be, <2 x float> %10)
  %i.bu = tail call float @llvm.fmuladd.f32(float %8, float %i.bq, float %11)
  %i.bv = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bf, <2 x float> %i.bd, <2 x float> %i.bt) ; 3 uses
  %i.bw = tail call float @llvm.fmuladd.f32(float %2, float %i.bl, float %i.bu) ; 3 uses
  %i.bx = extractelement <2 x float> %i.bv, i64 0 ; 2 uses
  %i.by = fmul float %8, %i.bx
  %i.bz = tail call float @llvm.fmuladd.f32(float %5, float %i.bk, float %i.by)
  %i.ca = extractelement <2 x float> %i.bv, i64 1 ; 2 uses
  ...
  %12 = fmul float %8, %i.bw
  %13 = fmul float %8, %i.ca
  %14 = tail call float @llvm.fmuladd.f32(float %5, float %i.bp, float %12)
  %15 = tail call float @llvm.fmuladd.f32(float %5, float %2, float %13)
  %16 = tail call float @llvm.fmuladd.f32(float %i.bx, float %2, float %14)
  %17 = tail call float @llvm.fmuladd.f32(float %i.bw, float %i.bk, float %15)
  %i.cd = insertelement <2 x float> poison, float %17, i64 0
  %i.ce = insertelement <2 x float> %i.cd, float %16, i64 1
  %i.cf = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bv, <2 x float> %i.aw, <2 x float> %i.ce)
...
bb.d:                                             ; preds = %bb.a
  ...
  %i.gt = fneg <2 x float> %i.gk                  ; 3 uses
  %i.gu = extractelement <2 x float> %i.gl, i64 0 ; 3 uses
  %18 = fneg float %i.gu                          ; 3 uses
  %i.gv = extractelement <2 x float> %i.gr, i64 0
  %i.gw = fneg float %i.gv
  %i.gx = fmul float %i.gu, %i.gw
  %19 = tail call float @llvm.fmuladd.f32(float %i.fq, float %i.ft, float %i.gp)
  %i.gy = extractelement <2 x float> %i.gt, i64 1 ; 3 uses
  %i.gz = extractelement <2 x float> %i.gs, i64 0 ; 2 uses
  %20 = tail call float @llvm.fmuladd.f32(float %i.gy, float %i.gz, float %i.gx)
  %i.ha = extractelement <2 x float> %i.gi, i64 0
  %i.hb = extractelement <2 x float> %i.fu, i64 1
  %i.hc = tail call float @llvm.fmuladd.f32(float %i.ha, float %i.hb, float %19)
  %i.hd = extractelement <2 x float> %i.gt, i64 0 ; 3 uses
  %i.he = extractelement <2 x float> %i.gr, i64 1 ; 2 uses
  %21 = tail call float @llvm.fmuladd.f32(float %i.hd, float %i.he, float %20) ; 3 uses
  %22 = extractelement <2 x float> %i.gi, i64 1
  %23 = extractelement <2 x float> %i.fv, i64 1
  %24 = tail call float @llvm.fmuladd.f32(float %22, float %23, float %i.hc) ; 6 uses
  %.sroa.3.12.vec.insert.i65 = insertelement <2 x float> %i.gk, float %24, i64 1
  store <2 x float> %i.gq, ptr %i.c, align 8
  store <2 x float> %.sroa.3.12.vec.insert.i65, ptr %.sroa.48.0..sroa_idx, align 8
  %25 = shufflevector <2 x float> %i.gr, <2 x float> %i.gs, <2 x i32> <i32 1, i32 2>
  %26 = fmul <2 x float> %i.gl, %25
  ...
  %27 = extractelement <2 x float> %foldExtExtBinop168, i64 0
  %i.hf = insertelement <2 x float> poison, float %24, i64 0
  %i.hg = shufflevector <2 x float> %i.hf, <2 x float> poison, <2 x i32> zeroinitializer
  %i.hh = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.hg, <2 x float> %i.gs, <2 x float> %26)
  %i.hi = tail call float @llvm.fmuladd.f32(float %24, float %i.he, float %27)
  %i.hj = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.gt, <2 x float> %i.gr, <2 x float> %i.hh) ; 3 uses
  %i.hk = tail call float @llvm.fmuladd.f32(float %18, float %i.gz, float %i.hi) ; 3 uses
  %i.hl = extractelement <2 x float> %i.hj, i64 0 ; 2 uses
  %i.hm = fmul float %24, %i.hl
  %i.hn = tail call float @llvm.fmuladd.f32(float %21, float %i.gy, float %i.hm)
  %i.ho = extractelement <2 x float> %i.hj, i64 1 ; 2 uses
  %i.hp = tail call float @llvm.fmuladd.f32(float %i.ho, float %i.hd, float %i.hn)
  %i.hq = tail call float @llvm.fmuladd.f32(float %i.hk, float %i.gu, float %i.hp)
  %28 = fmul float %24, %i.hk
  %29 = fmul float %24, %i.ho
  %30 = tail call float @llvm.fmuladd.f32(float %21, float %i.hd, float %28)
  %31 = tail call float @llvm.fmuladd.f32(float %21, float %18, float %29)
  %32 = tail call float @llvm.fmuladd.f32(float %i.hl, float %18, float %30)
  %33 = tail call float @llvm.fmuladd.f32(float %i.hk, float %i.gy, float %31)
  %i.hr = insertelement <2 x float> poison, float %33, i64 0
  %i.hs = insertelement <2 x float> %i.hr, float %32, i64 1
  %i.ht = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.hj, <2 x float> %i.gk, <2 x float> %i.hs)
