...
bb.n:                                             ; preds = %.lr.ph686, %._crit_edge682
  ...
  %i.alx = getelementptr inbounds nuw [816 x i8], ptr %i.alw, i64 %indvars.iv.next714 ; 15 uses
...
_ZN24btInverseDynamicsBullet3L20setThreeDoFJacobiansEiRNS_4vec3ES1_.exit: ; preds = %bb.z, %bb.s, %switch.lookup, %_ZN24btInverseDynamicsBullet3L18setSixDoFJacobiansEiRNS_4vec3ES1_.exit
  ...
  %21 = load <2 x float>, ptr %18, align 8, !tbaa !65 ; 4 uses
  %i.ani = load float, ptr %i.aml, align 8, !tbaa !65
  %i.anj = load float, ptr %i.amo, align 4, !tbaa !65 ; 3 uses
  %22 = extractelement <2 x float> %21, i64 0
  %23 = fmul float %22, %i.anj
  %i.ank = load <2 x float>, ptr %17, align 16, !tbaa !65 ; 5 uses
  %i.anl = extractelement <2 x float> %i.ank, i64 0
  %i.anm = shufflevector <2 x float> %21, <2 x float> %i.ank, <2 x i32> <i32 1, i32 3> ; 2 uses
  ...
  %i.anv = shufflevector <2 x float> %21, <2 x float> %i.ank, <2 x i32> <i32 0, i32 2> ; 2 uses
  ...
  %24 = extractelement <2 x float> %i.anz, i64 0
  %25 = fmul float %24, %i.anj
  %i.aob = fmul float %i.aoa, %i.anj
  %i.aoc = load <2 x float>, ptr %i.xh, align 4, !tbaa !65 ; 5 uses
  %i.aod = load float, ptr %i.xi, align 8, !tbaa !65 ; 2 uses
  %i.aoe = extractelement <2 x float> %i.aoc, i64 0
  %i.aof = fmul float %i.anc, %i.aoe
  %i.aog = call float @llvm.fmuladd.f32(float %i.anb, float %i.anl, float %i.aof)
  %i.aoh = call noundef float @llvm.fmuladd.f32(float %i.and, float %i.aod, float %i.aog)
  %26 = shufflevector <2 x float> %i.aoc, <2 x float> %i.anz, <2 x i32> <i32 3, i32 1> ; 2 uses
  %27 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ans, <2 x float> %26, <2 x float> %i.anq) ; 2 uses
  %28 = insertelement <2 x float> poison, float %i.aoh, i64 0
  %29 = insertelement <2 x float> %28, float %23, i64 1 ; 2 uses
  %30 = fadd <2 x float> %29, %27                 ; 2 uses
  %31 = fsub <2 x float> %29, %27                 ; 2 uses
  %32 = shufflevector <2 x float> %30, <2 x float> %31, <2 x i32> <i32 0, i32 3> ; 3 uses
  %33 = fneg <2 x float> %26
  %34 = fmul <2 x float> %i.anu, %33
  %i.aoi = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.anp, <2 x float> %i.anv, <2 x float> %34) ; 2 uses
  %35 = load <2 x float>, ptr %i.amh, align 8, !tbaa !65 ; 2 uses
  %36 = load <2 x float>, ptr %i.amj, align 8, !tbaa !65 ; 2 uses
  %37 = shufflevector <2 x float> %i.aoc, <2 x float> poison, <2 x i32> zeroinitializer
  %38 = shufflevector <2 x float> %35, <2 x float> %36, <2 x i32> <i32 1, i32 3>
  %39 = fmul <2 x float> %37, %38
  %40 = shufflevector <2 x float> %35, <2 x float> %36, <2 x i32> <i32 0, i32 2>
  %41 = shufflevector <2 x float> %i.ank, <2 x float> poison, <2 x i32> zeroinitializer
  %42 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %40, <2 x float> %41, <2 x float> %39)
  %43 = insertelement <2 x float> poison, float %i.ane, i64 0
  %44 = insertelement <2 x float> %43, float %i.anf, i64 1
  %i.aoj = insertelement <2 x float> poison, float %i.aod, i64 0
  %45 = shufflevector <2 x float> %i.aoj, <2 x float> poison, <2 x i32> zeroinitializer
  %46 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %44, <2 x float> %45, <2 x float> %42) ; 2 uses
  %i.aok = insertelement <2 x float> %46, float %25, i64 1 ; 2 uses
  %i.aol = fadd <2 x float> %i.aok, %i.aoi        ; 2 uses
  %i.aom = fsub <2 x float> %i.aok, %i.aoi        ; 2 uses
  %i.aon = shufflevector <2 x float> %i.aol, <2 x float> %i.aom, <2 x i32> <i32 0, i32 3> ; 3 uses
  %i.aoo = shufflevector <2 x float> %30, <2 x float> %i.aol, <2 x i32> <i32 0, i32 2>
  ...
  %i.aou = shufflevector <2 x float> %31, <2 x float> %i.aom, <2 x i32> <i32 1, i32 3>
  ...
  %i.aoy = shufflevector <2 x float> %i.ank, <2 x float> %21, <2 x i32> <i32 0, i32 2>
  %i.aoz = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aoy, <2 x float> %32, <2 x float> %i.aox)
...
_ZN24btInverseDynamicsBullet3L20setThreeDoFJacobiansEiRNS_4vec3ES1_.exit282: ; preds = %bb.aa, %switch.lookup752
  ...
  %i.aql = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aqk, <2 x float> %32, <2 x float> %i.aqj)
...
_ZN24btInverseDynamicsBullet3L18setSixDoFJacobiansEiRNS_4vec3ES1_.exit283: ; preds = %bb.ac, %bb.ad, %bb.ae, %bb.af, %bb.ag, %bb.ah, %bb.ai
  ...
  %i.ari = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.arh, <2 x float> %32, <2 x float> %i.arg)
