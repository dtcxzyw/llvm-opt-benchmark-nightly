...
bb.w:                                             ; preds = %.lr.ph659, %bb.aa
  ...
  %12 = shufflevector <2 x float> %i.ahr, <2 x float> <float poison, float -0.000000e+00>, <4 x i32> <i32 0, i32 0, i32 0, i32 3>
  ...
  %i.akb = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.aka, <4 x float> %12, <4 x float> %i.ajy)
  ...
  %13 = shufflevector <2 x float> %i.ahy, <2 x float> <float poison, float -0.000000e+00>, <4 x i32> <i32 0, i32 0, i32 0, i32 3>
  %i.akm = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.akl, <4 x float> %13, <4 x float> %i.akj)
  ...
  %14 = shufflevector <2 x float> %i.aib, <2 x float> <float poison, float -0.000000e+00>, <4 x i32> <i32 0, i32 0, i32 0, i32 3>
  %i.alf = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ale, <4 x float> %14, <4 x float> %i.ald)
...
bb.l:                                             ; preds = %bb.k
  ...
  %21 = shufflevector <2 x float> %i.agu, <2 x float> <float poison, float -0.000000e+00>, <4 x i32> <i32 0, i32 0, i32 0, i32 3>
  %i.aiv = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.aiu, <4 x float> %21, <4 x float> %i.ais)
  ...
  %22 = shufflevector <2 x float> %i.ahg, <2 x float> <float poison, float -0.000000e+00>, <4 x i32> <i32 0, i32 0, i32 0, i32 3>
  %i.ajx = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ajw, <4 x float> %22, <4 x float> %i.aju)
  ...
  %23 = shufflevector <2 x float> %i.aic, <2 x float> <float poison, float 1.000000e+00>, <4 x i32> <i32 0, i32 0, i32 0, i32 3>
  %i.akm = insertelement <4 x float> %i.air, float %i.aib, i64 2
  %i.akn = fmul <4 x float> %23, %i.akm
  %i.ako = insertelement <4 x float> %i.aiu, float %i.ahz, i64 2
  %24 = shufflevector <2 x float> %i.agv, <2 x float> <float poison, float -0.000000e+00>, <4 x i32> <i32 0, i32 0, i32 0, i32 3>
  %i.akp = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ako, <4 x float> %24, <4 x float> %i.akn)
  ...
  %25 = shufflevector <2 x float> %i.aje, <2 x float> <float poison, float 0.000000e+00>, <4 x i32> <i32 0, i32 0, i32 0, i32 3>
  %i.akt = insertelement <4 x float> %i.ajt, float %i.ajd, i64 2
  %i.aku = fmul <4 x float> %25, %i.akt
  %i.akv = insertelement <4 x float> %i.ajw, float %i.ajb, i64 2
  %26 = shufflevector <2 x float> %i.ahh, <2 x float> <float poison, float -0.000000e+00>, <4 x i32> <i32 0, i32 0, i32 0, i32 3>
  %i.akw = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.akv, <4 x float> %26, <4 x float> %i.aku)
