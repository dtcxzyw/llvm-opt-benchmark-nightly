...
bb.h:                                             ; preds = %.lr.ph267, %bb.h
  ...
  %i.je = load <2 x float>, ptr %i.hr, align 4, !tbaa !68, !noalias !142
  %7 = load float, ptr %i.hs, align 4, !tbaa !68, !noalias !142
  %i.jf = load float, ptr %i.ht, align 4, !tbaa !68, !noalias !142
  %i.jg = load float, ptr %i.hu, align 4, !tbaa !68, !noalias !142
  %i.jh = load float, ptr %i.it, align 4, !tbaa !68 ; 2 uses
  %i.ji = load float, ptr %i.is, align 4, !tbaa !68 ; 2 uses
  %i.jj = load float, ptr %i.iu, align 4, !tbaa !68 ; 2 uses
  %8 = load <2 x float>, ptr %i.hq, align 4, !tbaa !68, !noalias !142
  %i.jk = insertelement <2 x float> poison, float %i.jh, i64 0
  %i.jl = shufflevector <2 x float> %i.jk, <2 x float> poison, <2 x i32> zeroinitializer
  %i.jm = fmul <2 x float> %8, %i.jl
  ...
  %i.js = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.je, <2 x float> %i.jr, <2 x float> %i.jp)
  %i.jt = fmul float %i.jf, %i.jh
  %i.ju = call float @llvm.fmuladd.f32(float %7, float %i.ji, float %i.jt)
...
bb.k:                                             ; preds = %.lr.ph654, %bb.m
  ...
  %i.aaq = load float, ptr %i.yq, align 4, !tbaa !68, !noalias !229 ; 2 uses
  ...
  %i.abw = extractelement <2 x float> %i.abu, i64 0 ; 2 uses
  ...
  %21 = shufflevector <3 x float> %i.acj, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %22 = shufflevector <2 x float> %i.abu, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %23 = insertelement <2 x float> %22, float %i.aaq, i64 1 ; 2 uses
  %24 = fmul <2 x float> %21, %23
  %25 = extractelement <3 x float> %i.acj, i64 2
  %26 = fmul float %25, %i.abw
  %27 = shufflevector <2 x float> %i.abt, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.ack = insertelement <2 x float> %27, float %i.aap, i64 1 ; 2 uses
  %28 = shufflevector <3 x float> %i.acj, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.acl = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ack, <2 x float> %28, <2 x float> %24)
  %i.acm = extractelement <3 x float> %i.acj, i64 1
  %29 = call float @llvm.fmuladd.f32(float %i.abx, float %i.acm, float %26)
  ...
  %30 = call noundef float @llvm.fmuladd.f32(float %i.acr, float %i.acs, float %29)
  ...
  %i.acy = call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %i.ach, <3 x float> %i.acx, <3 x float> %i.acw) ; 6 uses
  %31 = shufflevector <3 x float> %i.acy, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %32 = fmul <2 x float> %31, %23
  %i.acz = extractelement <3 x float> %i.acy, i64 2
  %33 = fmul float %i.acz, %i.abw
  %i.ada = shufflevector <3 x float> %i.acy, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.adb = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ack, <2 x float> %i.ada, <2 x float> %32)
  %i.adc = extractelement <3 x float> %i.acy, i64 1
  %i.add = call float @llvm.fmuladd.f32(float %i.abx, float %i.adc, float %33)
  ...
  %i.adu = insertelement <4 x float> <float poison, float poison, float poison, float -0.000000e+00>, float %30, i64 0
