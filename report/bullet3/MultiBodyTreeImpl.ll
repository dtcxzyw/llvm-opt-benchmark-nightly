...
bb.h:                                             ; preds = %.lr.ph267, %bb.h
  ...
  %i.ho = getelementptr inbounds [816 x i8], ptr %i.gj, i64 %i.hn ; 15 uses
  ...
  %i.iq = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ih, <2 x float> %i.ip, <2 x float> %i.in) ; 3 uses
  ...
  %7 = getelementptr inbounds nuw i8, ptr %i.ho, i64 348
  %8 = extractelement <2 x float> %i.iq, i64 1    ; 2 uses
  %i.ix = extractelement <2 x float> %i.iq, i64 0 ; 2 uses
  ...
  %9 = load float, ptr %7, align 4, !tbaa !65     ; 2 uses
  %i.jw = load float, ptr %i.iw, align 4, !tbaa !65 ; 2 uses
  %10 = load float, ptr %i.iv, align 4, !tbaa !65 ; 2 uses
  %i.jx = fneg float %i.iz
  %11 = fneg float %8
  %i.jy = fmul float %10, %i.jx
  %12 = fmul float %9, %11
  %13 = call float @llvm.fmuladd.f32(float %9, float %i.ix, float %i.jy)
  %14 = call float @llvm.fmuladd.f32(float %i.jw, float %i.iz, float %12)
  %15 = fneg float %i.ix
  %16 = fmul float %i.jw, %15
  %17 = call float @llvm.fmuladd.f32(float %10, float %8, float %16)
  %18 = insertelement <2 x float> poison, float %14, i64 0
  %19 = insertelement <2 x float> %18, float %13, i64 1
  %i.jz = fadd <2 x float> %i.js, %19
  %i.ka = fadd float %i.jv, %17
...
bb.w:                                             ; preds = %.lr.ph659, %bb.aa
  ...
  %i.agu = getelementptr inbounds nuw [816 x i8], ptr %i.agt, i64 %indvars.iv670 ; 39 uses
...
bb.z:                                             ; preds = %bb.y
  ...
  %12 = call float @llvm.fmuladd.f32(float %i.aqu, float %i.aqt, float %i.ash) ; 2 uses
  %i.asl = call float @llvm.fmuladd.f32(float %i.asg, float %12, float %i.ask)
  %i.asm = shufflevector <4 x float> %i.asd, <4 x float> poison, <2 x i32> <i32 poison, i32 1>
  %i.asn = insertelement <2 x float> %i.asm, float %12, i64 0
  ...
  %13 = load <2 x float>, ptr %i.aqv, align 4, !tbaa !65 ; 3 uses
  ...
  %15 = fneg float %i.aqx
  %i.asz = insertelement <2 x float> poison, float %15, i64 0
  %i.ata = fneg <2 x float> %13
  %16 = shufflevector <2 x float> %i.asz, <2 x float> %i.ata, <2 x i32> <i32 0, i32 2>
  %i.atb = fmul <2 x float> %i.asp, %16
  %i.atc = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.asr, <2 x float> %13, <2 x float> %i.atb)
...
bb.i:                                             ; preds = %.lr.ph651, %bb.i
  ...
  %21 = extractelement <2 x float> %i.ro, i64 0
  %i.si = extractelement <2 x float> %i.rq, i64 0
  %22 = extractelement <4 x float> %i.ry, i64 3
  %23 = call float @llvm.fmuladd.f32(float %i.rl, float %i.oz, float %i.rk)
  %i.sj = call noundef float @llvm.fmuladd.f32(float %i.rm, float %i.pb, float %23) ; 2 uses
  %i.sk = extractelement <4 x float> %i.se, i64 3
  %24 = call float @llvm.fmuladd.f32(float %i.pw, float %i.oz, float %i.rn)
  %25 = call noundef float @llvm.fmuladd.f32(float %i.qa, float %i.pb, float %24) ; 2 uses
  ...
  %26 = fmul float %25, %i.sh
  %27 = call float @llvm.fmuladd.f32(float %21, float %i.sj, float %26)
  %28 = call noundef float @llvm.fmuladd.f32(float %i.si, float %i.pe, float %27) ; 2 uses
  ...
  %i.sw = insertelement <4 x float> poison, float %25, i64 0
  ...
  %i.tf = insertelement <4 x float> poison, float %i.sj, i64 0
  ...
  %i.uj = call float @llvm.fmuladd.f32(float %i.ts, float %22, float %i.ui)
  %i.uk = call noundef float @llvm.fmuladd.f32(float %i.tu, float %i.uf, float %i.uj) ; 2 uses
  %i.ul = fmul float %i.tj, %i.tt
  %i.um = call float @llvm.fmuladd.f32(float %i.ts, float %28, float %i.ul)
  ...
  %i.uu = insertelement <2 x float> poison, float %28, i64 0
