...
bb.g:                                             ; preds = %.lr.ph273, %bb.q
  ...
  %i.cu = load float, ptr %i.bz, align 8, !tbaa !60 ; 5 uses
  %i.cv = fmul float %i.ca, %i.cu
  ...
  %4 = load <2 x float>, ptr %i.bn, align 4, !tbaa !60
  %5 = load <2 x float>, ptr %i.bq, align 4, !tbaa !60
  %i.da = load <2 x float>, ptr %i.bj, align 8, !tbaa !60 ; 5 uses
  %6 = shufflevector <2 x float> %i.da, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 0> ; 3 uses
  %i.db = insertelement <4 x float> poison, float %i.by, i64 2
  %i.dc = insertelement <4 x float> %i.db, float %i.cp, i64 3
  %7 = shufflevector <2 x float> %5, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 poison, i32 poison>
  %i.dd = shufflevector <4 x float> %7, <4 x float> %i.dc, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.de = fmul <4 x float> %6, %i.dd
  %8 = shufflevector <2 x float> %i.da, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %i.df = insertelement <4 x float> poison, float %i.bv, i64 2
  %i.dg = insertelement <4 x float> %i.df, float %i.cr, i64 3
  %9 = shufflevector <2 x float> %4, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 poison, i32 poison>
  %i.dh = shufflevector <4 x float> %9, <4 x float> %i.dg, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.di = fmul <4 x float> %8, %i.dh
  ...
  %10 = insertelement <2 x float> poison, float %i.cu, i64 0
  %11 = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.dp = fmul <2 x float> %11, %i.dn
  %12 = shufflevector <4 x float> %i.dj, <4 x float> poison, <2 x i32> <i32 0, i32 2>
  %i.dq = fadd <2 x float> %12, %i.dp
  ...
  %13 = shufflevector <2 x float> %i.da, <2 x float> poison, <2 x i32> zeroinitializer
  %14 = fmul <2 x float> %13, %i.cy
  %15 = shufflevector <2 x float> %i.da, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %16 = fmul <2 x float> %15, %i.cz
  %17 = fadd <2 x float> %14, %16
  %i.dy = load <2 x float>, ptr %i.cn, align 4, !tbaa !60
  %i.dz = fmul <2 x float> %11, %i.dy
  %i.ea = fmul float %i.cu, %i.ct
  %i.eb = fadd <2 x float> %17, %i.dz
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %foldExtExtBinop309 = fmul <4 x float> %6, %6
  %18 = extractelement <4 x float> %foldExtExtBinop309, i64 0
  %i.ge = extractelement <2 x float> %i.da, i64 0 ; 2 uses
  %i.gf = tail call float @llvm.fmuladd.f32(float %i.ge, float %i.ge, float %18)
  %i.gg = tail call noundef float @llvm.fmuladd.f32(float %i.cu, float %i.cu, float %i.gf)
