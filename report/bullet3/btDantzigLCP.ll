...
begin_hunk_0_@_Z11btLDLTAddTLPfS_PKfiiR20btAlignedObjectArrayIfE:bb.a
  %i.bc = shl nsw i64 %i.ay, 2
  %diff.check187.a = icmp ugt i64 %i.bc, -32
  %i.bd = shl nsw i64 %i.ay, 2
  %i.be = add i64 %i.bd, %i.bb
  %i.bf = sub i64 %i.a, %i.be
  %diff.check188 = icmp ugt i64 %i.bf, -32
  %conflict.rdx = or i1 %diff.check187.a, %diff.check188
  %i.bg = sub i64 %i.a, %i.bb
  %diff.check189 = icmp ugt i64 %i.bg, -32
  %conflict.rdx190 = or i1 %conflict.rdx, %diff.check189
  br i1 %conflict.rdx190, label %.lr.ph.preheader218, label %vector.ph193

vector.ph193:                                     ; preds = %vector.memcheck186
  %n.vec194 = and i64 %i.ba, -8                   ; 3 uses
  %i.bh = or disjoint i64 %n.vec194, 1
  br label %vector.body195

vector.body195:                                   ; preds = %vector.body195, %vector.ph193
  %index196 = phi i64 [ 0, %vector.ph193 ], [ %index.next199, %vector.body195 ] ; 2 uses
  %i.bi = or disjoint i64 %index196, 1            ; 3 uses
  %i.bj = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %i.bi ; 2 uses
  %i.bk = getelementptr inbounds nuw i8, ptr %i.bj, i64 16
  %wide.load197 = load <4 x float>, ptr %i.bj, align 4, !tbaa !17
  %wide.load198 = load <4 x float>, ptr %i.bk, align 4, !tbaa !17
  %i.bl = fmul <4 x float> %wide.load197, splat (float f0x3F3504F3) ; 2 uses
  %i.bm = fmul <4 x float> %wide.load198, splat (float f0x3F3504F3) ; 2 uses
  %i.bn = getelementptr inbounds nuw [4 x i8], ptr %i.az, i64 %i.bi ; 2 uses
  %i.bo = getelementptr inbounds nuw i8, ptr %i.bn, i64 16
  store <4 x float> %i.bl, ptr %i.bn, align 4, !tbaa !17
  store <4 x float> %i.bm, ptr %i.bo, align 4, !tbaa !17
  %i.bp = getelementptr inbounds nuw [4 x i8], ptr %i.ax, i64 %i.bi ; 2 uses
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bp, i64 16
  store <4 x float> %i.bl, ptr %i.bp, align 4, !tbaa !17
  store <4 x float> %i.bm, ptr %i.bq, align 4, !tbaa !17
  %index.next199 = add nuw i64 %index196, 8       ; 2 uses
  %i.br = icmp eq i64 %index.next199, %n.vec194
  br i1 %i.br, label %middle.block200, label %vector.body195, !llvm.loop !142

middle.block200:                                  ; preds = %vector.body195
  %cmp.n201 = icmp eq i64 %i.ba, %n.vec194
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader218
  ...
  store float %i.bv, ptr %i.bw, align 4, !tbaa !17
  %i.bx = getelementptr inbounds nuw [4 x i8], ptr %i.ax, i64 %indvars.iv.ph
  store float %i.bv, ptr %i.bx, align 4, !tbaa !17
...
.lver.check210:                                   ; preds = %.lr.ph.prol.loopexit, %.lr.ph, %middle.block200
  %i.ca = load float, ptr %2, align 4, !tbaa !17  ; 2 uses
  ...
  %i.cf = load float, ptr %1, align 4, !tbaa !17  ; 2 uses
...
.ph211.lver.orig:                                 ; preds = %.ph211.lver.orig, %.ph211.lver.orig.preheader.new
  ...
  %i.ct = load float, ptr %i.cs, align 4, !tbaa !17 ; 2 uses
  %i.cu = load float, ptr %.0138.lver.orig, align 4, !tbaa !17 ; 2 uses
  %i.cv = tail call float @llvm.fmuladd.f32(float %i.cq, float %i.cu, float %i.ct)
  store float %i.cv, ptr %i.cs, align 4, !tbaa !17
  ...
  %i.da = load float, ptr %i.cz, align 4, !tbaa !17 ; 2 uses
  %i.db = load float, ptr %.0138.lver.orig.1, align 4, !tbaa !17 ; 2 uses
  %i.dc = tail call float @llvm.fmuladd.f32(float %i.cq, float %i.db, float %i.da)
  store float %i.dc, ptr %i.cz, align 4, !tbaa !17
  ...
  store float %i.de, ptr %i.df, align 4, !tbaa !17
  %indvars.iv.next161.lver.orig.1 = add nuw nsw i64 %indvars.iv160.lver.orig, 2 ; 2 uses
  %niter.next.1 = add nuw i64 %niter, 2           ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.lr.ph158.preheader.loopexit217.unr-lcssa, label %.ph211.lver.orig, !llvm.loop !143
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  store float %i.dj, ptr %i.dk, align 4, !tbaa !17
  %i.dl = getelementptr inbounds nuw [4 x i8], ptr %i.ax, i64 %indvars.iv
  store float %i.dj, ptr %i.dl, align 4, !tbaa !17
  ...
  store float %i.do, ptr %i.dp, align 4, !tbaa !17
  %i.dq = getelementptr inbounds nuw [4 x i8], ptr %i.ax, i64 %indvars.iv.next
  store float %i.do, ptr %i.dq, align 4, !tbaa !17
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, %wide.trip.count
  br i1 %exitcond.not.1, label %.lver.check210, label %.lr.ph, !llvm.loop !144
...
.epil.preheader:                                  ; preds = %.lr.ph158.preheader.loopexit.unr-lcssa, %.ph211
  %store_forwarded215.epil.init = phi float [ %load_initial214, %.ph211 ], [ %i.er, %.lr.ph158.preheader.loopexit.unr-lcssa ] ; 2 uses
  ...
  store float %i.dv, ptr %i.dw, align 4, !tbaa !17
...
.ph211.lver.orig.epil.preheader:                  ; preds = %.lr.ph158.preheader.loopexit217.unr-lcssa, %.ph211.lver.orig.preheader
  ...
  %i.dy = load float, ptr %i.dx, align 4, !tbaa !17 ; 2 uses
  %i.dz = load float, ptr %.0138.lver.orig.epil, align 4, !tbaa !17 ; 2 uses
  %i.ea = tail call float @llvm.fmuladd.f32(float %i.cq, float %i.dz, float %i.dy)
  store float %i.ea, ptr %i.dx, align 4, !tbaa !17
  ...
  store float %i.ec, ptr %i.ed, align 4, !tbaa !17
  br label %.lr.ph158.preheader
...
.lr.ph158.preheader:                              ; preds = %.ph211.lver.orig.epil.preheader, %.lr.ph158.preheader.loopexit217.unr-lcssa, %.epil.preheader, %.lr.ph158.preheader.loopexit.unr-lcssa
  ...
  %wide.trip.count171 = zext nneg i32 %3 to i64   ; 3 uses
  %i.ee = shl nuw nsw i64 %wide.trip.count, 2
  %i.ef = add nuw nsw i64 %i.ee, 4                ; 2 uses
  %scevgep204.a = getelementptr i8, ptr %i.ax, i64 %i.ef
  %i.eg = getelementptr i8, ptr %0, i64 %i.ef
  %ident.check = icmp ne i32 %4, 1
  br label %.lr.ph158

bb.g:                                             ; preds = %bb.g, %.ph211.new
  %store_forwarded215 = phi float [ %load_initial214, %.ph211.new ], [ %i.er, %bb.g ] ; 2 uses
  ...
  %i.eh = getelementptr inbounds nuw [4 x i8], ptr %i.ax, i64 %indvars.iv160
  %i.ei = load float, ptr %.0138, align 4, !tbaa !17 ; 2 uses
  %i.ej = tail call float @llvm.fmuladd.f32(float %i.cq, float %i.ei, float %store_forwarded215)
  store float %i.ej, ptr %i.eh, align 4, !tbaa !17
  %i.ek = fmul float %i.cp, %i.ei
  %i.el = tail call float @llvm.fmuladd.f32(float %i.cn, float %store_forwarded215, float %i.ek) ; 3 uses
  %i.em = getelementptr inbounds nuw [4 x i8], ptr %i.az, i64 %indvars.iv160
  store float %i.el, ptr %i.em, align 4, !tbaa !17
  ...
  %i.en = getelementptr inbounds nuw [4 x i8], ptr %i.ax, i64 %indvars.iv.next161
  %i.eo = load float, ptr %.0138.1, align 4, !tbaa !17 ; 2 uses
  %i.ep = tail call float @llvm.fmuladd.f32(float %i.cq, float %i.eo, float %i.el)
  store float %i.ep, ptr %i.en, align 4, !tbaa !17
  %i.eq = fmul float %i.cp, %i.eo
  %i.er = tail call float @llvm.fmuladd.f32(float %i.cn, float %i.el, float %i.eq) ; 3 uses
  %i.es = getelementptr inbounds nuw [4 x i8], ptr %i.az, i64 %indvars.iv.next161
  store float %i.er, ptr %i.es, align 4, !tbaa !17
  ...
  br i1 %niter229.ncmp.1, label %.lr.ph158.preheader.loopexit.unr-lcssa, label %bb.g, !llvm.loop !143

.loopexit:                                        ; preds = %bb.h, %.ph.lver.orig, %.lr.ph158
  %indvars.iv.next167 = add nuw nsw i64 %indvars.iv166, 1
  %exitcond178.not = icmp eq i64 %indvars.iv.next174, %wide.trip.count171
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond178.not, label %.loopexit143, label %.lr.ph158, !llvm.loop !145
...
.lr.ph158:                                        ; preds = %.lr.ph158.preheader, %.loopexit
  ...
  %i.et = shl nuw nsw i64 %indvar, 2
  %i.eu = getelementptr i8, ptr %i.ax, i64 %i.et
  %scevgep208 = getelementptr i8, ptr %i.eu, i64 8
  ...
  %i.ew = load float, ptr %i.ev, align 4, !tbaa !17 ; 4 uses
  %i.ex = getelementptr inbounds nuw [4 x i8], ptr %i.az, i64 %indvars.iv173
  %i.ey = load float, ptr %i.ex, align 4, !tbaa !17 ; 3 uses
  %i.ez = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv173 ; 2 uses
  %i.fa = load float, ptr %i.ez, align 4, !tbaa !17 ; 2 uses
  ...
  store float %i.fk, ptr %i.ez, align 4, !tbaa !17
  %indvars.iv.next174 = add nuw nsw i64 %indvars.iv173, 1 ; 3 uses
  %i.fl = icmp samesign ult i64 %indvars.iv.next174, %wide.trip.count177
  br i1 %i.fl, label %.lver.check, label %.loopexit

.lver.check:                                      ; preds = %.lr.ph158
  %i.fm = shl nuw nsw i64 %indvar, 2              ; 2 uses
  %scevgep206 = getelementptr i8, ptr %i.eg, i64 %i.fm
  %i.fn = shl nuw nsw i64 %indvar, 3
  %i.fo = getelementptr i8, ptr %0, i64 %i.fn
  %scevgep205 = getelementptr i8, ptr %i.fo, i64 12
  %i.fp = getelementptr i8, ptr %i.ax, i64 %i.fm
  %scevgep203 = getelementptr i8, ptr %i.fp, i64 8
  %i.fq = fneg float %i.ew                        ; 2 uses
  %i.fr = fneg float %i.fj
  %i.fs = fmul float %i.ey, %i.fr                 ; 2 uses
  %bound0 = icmp ult ptr %scevgep203, %scevgep206
  %bound1 = icmp ult ptr %scevgep205, %scevgep204.a
...
.ph.lver.orig:                                    ; preds = %.lver.check, %.ph.lver.orig
  ...
  %i.ft = load float, ptr %.0133.lver.orig, align 4, !tbaa !17 ; 2 uses
  %i.fu = getelementptr inbounds nuw [4 x i8], ptr %i.ax, i64 %indvars.iv168.lver.orig ; 2 uses
  %i.fv = load float, ptr %i.fu, align 4, !tbaa !17
  %i.fw = tail call float @llvm.fmuladd.f32(float %i.fq, float %i.ft, float %i.fv) ; 2 uses
  %i.fx = tail call float @llvm.fmuladd.f32(float %i.fe, float %i.fw, float %i.ft) ; 2 uses
  store float %i.fw, ptr %i.fu, align 4, !tbaa !17
  %i.fy = getelementptr inbounds nuw [4 x i8], ptr %i.az, i64 %indvars.iv168.lver.orig ; 2 uses
  %i.fz = load float, ptr %i.fy, align 4, !tbaa !17
  %i.ga = tail call float @llvm.fmuladd.f32(float %i.fg, float %i.fx, float %i.fz) ; 2 uses
  %i.gb = tail call float @llvm.fmuladd.f32(float %i.fs, float %i.ga, float %i.fx)
  store float %i.ga, ptr %i.fy, align 4, !tbaa !17
  store float %i.gb, ptr %.0133.lver.orig, align 4, !tbaa !17
  ...
  br i1 %exitcond172.not.lver.orig, label %.loopexit, label %.ph.lver.orig, !llvm.loop !146
...
bb.h:                                             ; preds = %.ph, %bb.h
  %store_forwarded = phi float [ %load_initial, %.ph ], [ %i.gi, %bb.h ]
  ...
  %i.gc = load float, ptr %.0133, align 4, !tbaa !17 ; 2 uses
  %i.gd = getelementptr inbounds nuw [4 x i8], ptr %i.ax, i64 %indvars.iv168
  %i.ge = tail call float @llvm.fmuladd.f32(float %i.fq, float %i.gc, float %store_forwarded) ; 2 uses
  %i.gf = tail call float @llvm.fmuladd.f32(float %i.fe, float %i.ge, float %i.gc) ; 2 uses
  store float %i.ge, ptr %i.gd, align 4, !tbaa !17
  %i.gg = getelementptr inbounds nuw [4 x i8], ptr %i.az, i64 %indvars.iv168 ; 2 uses
  %i.gh = load float, ptr %i.gg, align 4, !tbaa !17
  %i.gi = tail call float @llvm.fmuladd.f32(float %i.fg, float %i.gf, float %i.gh) ; 3 uses
  %i.gj = tail call float @llvm.fmuladd.f32(float %i.fs, float %i.gi, float %i.gf)
  store float %i.gi, ptr %i.gg, align 4, !tbaa !17
  store float %i.gj, ptr %.0133, align 4, !tbaa !17
  %indvars.iv.next169 = add nuw nsw i64 %indvars.iv168, 1 ; 2 uses
  %exitcond172.not = icmp eq i64 %indvars.iv.next169, %wide.trip.count171
  br i1 %exitcond172.not, label %.loopexit, label %bb.h, !llvm.loop !146
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.j = load i32, ptr %i.i, align 4, !tbaa !57   ; 3 uses
...
._ZN20btAlignedObjectArrayIfE6resizeEiRKf.exit_crit_edge: ; preds = %bb.b
  ...
  %.pre144 = load ptr, ptr %.phi.trans.insert143, align 8, !tbaa !58
...
bb.e:                                             ; preds = %bb.d
  ...
  %.pre.i = load i32, ptr %i.i, align 4, !tbaa !57
...
_ZN20btAlignedObjectArrayIfE8allocateEi.exit.i.i: ; preds = %bb.e, %bb.d
  ...
  %i.u = load ptr, ptr %i.t, align 8, !tbaa !58   ; 9 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %i.y, align 4, !tbaa !17
  %wide.load155 = load <4 x float>, ptr %i.z, align 4, !tbaa !17
  %i.aa = getelementptr inbounds nuw i8, ptr %i.x, i64 16
  store <4 x float> %wide.load, ptr %i.x, align 4, !tbaa !17
  store <4 x float> %wide.load155, ptr %i.aa, align 4, !tbaa !17
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ab = icmp eq i64 %index.next, %n.vec
  br i1 %i.ab, label %middle.block, label %vector.body, !llvm.loop !147
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  store float %i.ae, ptr %i.ac, align 4, !tbaa !17
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  store float %i.aj, ptr %i.ah, align 4, !tbaa !17
  ...
  store float %i.am, ptr %i.ak, align 4, !tbaa !17
  ...
  store float %i.ap, ptr %i.an, align 4, !tbaa !17
  ...
  store float %i.as, ptr %i.aq, align 4, !tbaa !17
  %indvars.iv.next.i.i.i.3 = add nuw nsw i64 %indvars.iv.i.i.i, 4 ; 2 uses
  %exitcond.not.i.i.i.3 = icmp eq i64 %indvars.iv.next.i.i.i.3, %wide.trip.count.i.i.i
  br i1 %exitcond.not.i.i.i.3, label %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.thread.i.i, label %scalar.ph, !llvm.loop !149
