...
.lr.ph:                                           ; preds = %bb.b, %.lr.ph
  ...
  %.0406431 = phi ptr [ %i.cn, %.lr.ph ], [ %i.m, %bb.b ] ; 8 uses
  %.0410430 = phi ptr [ %i.co, %.lr.ph ], [ %1, %bb.b ] ; 3 uses
  ...
  %i.v = getelementptr inbounds [4 x i8], ptr %.0406431, i64 %i.d ; 4 uses
  %i.w = load float, ptr %i.v, align 4, !tbaa !17
  %i.x = getelementptr inbounds [4 x i8], ptr %.0406431, i64 %i.e ; 4 uses
  %i.y = load float, ptr %i.x, align 4, !tbaa !17
  %i.z = getelementptr inbounds [4 x i8], ptr %.0406431, i64 %i.f ; 4 uses
  ...
  %i.ai = getelementptr inbounds nuw i8, ptr %.0406431, i64 4
  %i.aj = getelementptr inbounds nuw i8, ptr %.0410430, i64 4
  %i.ak = getelementptr i8, ptr %i.v, i64 4
  %i.al = getelementptr i8, ptr %i.x, i64 4
  %i.am = getelementptr i8, ptr %i.z, i64 4
  %i.an = getelementptr inbounds nuw i8, ptr %.0406431, i64 20
  %i.ao = getelementptr i8, ptr %i.v, i64 20
  %i.ap = getelementptr i8, ptr %i.x, i64 20
  %i.aq = getelementptr i8, ptr %i.z, i64 20
  %i.ar = getelementptr inbounds nuw i8, ptr %.0406431, i64 36
  %i.as = getelementptr i8, ptr %i.v, i64 36
  %i.at = getelementptr i8, ptr %i.x, i64 36
  %i.au = getelementptr i8, ptr %i.z, i64 36
  %i.av = load <4 x float>, ptr %i.ai, align 4, !tbaa !17 ; 4 uses
  %i.aw = load <4 x float>, ptr %i.ak, align 4, !tbaa !17 ; 4 uses
  %i.ax = load <4 x float>, ptr %i.al, align 4, !tbaa !17 ; 4 uses
  %i.ay = load <4 x float>, ptr %i.am, align 4, !tbaa !17 ; 4 uses
  %4 = load <11 x float>, ptr %i.aj, align 4, !tbaa !17 ; 11 uses
  ...
  %i.bc = shufflevector <11 x float> %4, <11 x float> poison, <4 x i32> zeroinitializer
  ...
  %5 = shufflevector <11 x float> %4, <11 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.bh = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bg, <4 x float> %5, <4 x float> %i.bd)
  ...
  %6 = shufflevector <11 x float> %4, <11 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %i.bl = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bk, <4 x float> %6, <4 x float> %i.bh)
  ...
  %7 = shufflevector <11 x float> %4, <11 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
  %i.bp = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bo, <4 x float> %7, <4 x float> %i.bl)
  %i.bq = load <4 x float>, ptr %i.an, align 4, !tbaa !17 ; 4 uses
  %i.br = load <4 x float>, ptr %i.ao, align 4, !tbaa !17 ; 4 uses
  %i.bs = load <4 x float>, ptr %i.ap, align 4, !tbaa !17 ; 4 uses
  %i.bt = load <4 x float>, ptr %i.aq, align 4, !tbaa !17 ; 4 uses
  ...
  %8 = shufflevector <11 x float> %4, <11 x float> poison, <4 x i32> <i32 4, i32 4, i32 4, i32 4>
  %i.bx = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bw, <4 x float> %8, <4 x float> %i.bp)
  ...
  %9 = shufflevector <11 x float> %4, <11 x float> poison, <4 x i32> <i32 5, i32 5, i32 5, i32 5>
  %i.cb = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ca, <4 x float> %9, <4 x float> %i.bx)
  ...
  %10 = shufflevector <11 x float> %4, <11 x float> poison, <4 x i32> <i32 6, i32 6, i32 6, i32 6>
  %i.cf = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ce, <4 x float> %10, <4 x float> %i.cb)
  ...
  %11 = shufflevector <11 x float> %4, <11 x float> poison, <4 x i32> <i32 7, i32 7, i32 7, i32 7>
  %i.cj = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ci, <4 x float> %11, <4 x float> %i.cf)
  %12 = load <3 x float>, ptr %i.ar, align 4, !tbaa !17
  %13 = load <3 x float>, ptr %i.as, align 4, !tbaa !17
  %14 = load <3 x float>, ptr %i.at, align 4, !tbaa !17 ; 3 uses
  %15 = load <3 x float>, ptr %i.au, align 4, !tbaa !17 ; 3 uses
  %16 = shufflevector <3 x float> %15, <3 x float> %14, <4 x i32> <i32 0, i32 3, i32 poison, i32 poison>
  %17 = shufflevector <3 x float> %13, <3 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 poison> ; 3 uses
  %18 = shufflevector <4 x float> %16, <4 x float> %17, <4 x i32> <i32 0, i32 1, i32 4, i32 poison>
  %19 = shufflevector <3 x float> %12, <3 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 poison> ; 3 uses
  %20 = shufflevector <4 x float> %18, <4 x float> %19, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %21 = shufflevector <11 x float> %4, <11 x float> poison, <4 x i32> <i32 8, i32 8, i32 8, i32 8>
  %i.ck = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %20, <4 x float> %21, <4 x float> %i.cj)
  %22 = shufflevector <3 x float> %15, <3 x float> %14, <4 x i32> <i32 1, i32 4, i32 poison, i32 poison>
  %23 = shufflevector <4 x float> %22, <4 x float> %17, <4 x i32> <i32 0, i32 1, i32 5, i32 poison>
  %24 = shufflevector <4 x float> %23, <4 x float> %19, <4 x i32> <i32 0, i32 1, i32 2, i32 5>
  %25 = shufflevector <11 x float> %4, <11 x float> poison, <4 x i32> <i32 9, i32 9, i32 9, i32 9>
  %i.cl = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %24, <4 x float> %25, <4 x float> %i.ck)
  %26 = shufflevector <3 x float> %15, <3 x float> %14, <4 x i32> <i32 2, i32 5, i32 poison, i32 poison>
  %27 = shufflevector <4 x float> %26, <4 x float> %17, <4 x i32> <i32 0, i32 1, i32 6, i32 poison>
  %28 = shufflevector <4 x float> %27, <4 x float> %19, <4 x i32> <i32 0, i32 1, i32 2, i32 6>
  %29 = shufflevector <11 x float> %4, <11 x float> poison, <4 x i32> <i32 10, i32 10, i32 10, i32 10>
  %i.cm = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %28, <4 x float> %29, <4 x float> %i.cl) ; 2 uses
