...
bb.g:                                             ; preds = %bb.g, %.ph211.new
  ...
  %i.ej = load float, ptr %.0138, align 4, !tbaa !17 ; 2 uses
  %i.ek = tail call float @llvm.fmuladd.f32(float %i.cq, float %i.ej, float %store_forwarded215)
  store float %i.ek, ptr %i.ei, align 4, !tbaa !17
  ...
  store float %i.em, ptr %i.en, align 4, !tbaa !17
  ...
  %i.ep = load float, ptr %.0138.1, align 4, !tbaa !17 ; 2 uses
  %i.eq = tail call float @llvm.fmuladd.f32(float %i.cq, float %i.ep, float %i.em)
  store float %i.eq, ptr %i.eo, align 4, !tbaa !17
...
.ph.lver.orig:                                    ; preds = %.lver.check, %.ph.lver.orig
  ...
  %i.fs = load float, ptr %.0133.lver.orig, align 4, !tbaa !17 ; 2 uses
  ...
  store float %i.fz, ptr %i.fx, align 4, !tbaa !17
  store float %i.ga, ptr %.0133.lver.orig, align 4, !tbaa !17
...
bb.h:                                             ; preds = %.ph, %bb.h
  ...
  %i.gb = load float, ptr %.0133, align 4, !tbaa !17 ; 2 uses
  ...
  store float %i.gd, ptr %i.gc, align 4, !tbaa !17
  ...
  store float %i.gh, ptr %i.gf, align 4, !tbaa !17
  store float %i.gi, ptr %.0133, align 4, !tbaa !17
...
_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.thread.i.i: ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block, %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i
  ...
  %i.au = load i8, ptr %i.at, align 8, !tbaa !60, !range !53, !noundef !54
