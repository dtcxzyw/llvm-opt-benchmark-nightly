...
bb.a:
  ...
  %i.ad = shufflevector <2 x float> %i.o, <2 x float> %i.m, <2 x i32> <i32 1, i32 3>
  ...
  %4 = shufflevector <2 x float> %i.k, <2 x float> %i.o, <4 x i32> <i32 2, i32 0, i32 poison, i32 poison>
  %i.ak = insertelement <4 x float> %4, float %i.n, i64 2
  %5 = shufflevector <2 x float> %i.ad, <2 x float> %i.k, <4 x i32> <i32 1, i32 0, i32 3, i32 poison>
  %6 = fneg <4 x float> %5
  %7 = insertelement <4 x float> %i.ak, float %i.y, i64 3
  %8 = insertelement <4 x float> %6, float 0.000000e+00, i64 3
  %9 = fmul <4 x float> %7, %8
  %i.al = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ag, <4 x float> %i.aj, <4 x float> %9) ; 4 uses
  ...
  %i.ar = load float, ptr %i.ab, align 4, !tbaa !16, !noalias !48
  %10 = load float, ptr %i.aa, align 8, !tbaa !16, !noalias !48
  %i.as = load float, ptr %i.ac, align 8, !tbaa !16, !noalias !48
  %i.at = fneg float %i.ar                        ; 2 uses
  %11 = fneg float %10                            ; 2 uses
  %i.au = fneg float %i.as                        ; 2 uses
  ...
  %i.ay = insertelement <2 x float> poison, float %11, i64 0
  ...
  %i.bf = tail call float @llvm.fmuladd.f32(float %i.x, float %11, float %i.be)
  ...
  %i.dr = load float, ptr %i.dj, align 4, !tbaa !16, !noalias !51
  %12 = load float, ptr %i.di, align 8, !tbaa !16, !noalias !51
  %i.ds = load float, ptr %i.dk, align 8, !tbaa !16, !noalias !51
  %i.dt = fneg float %i.dr                        ; 2 uses
  %13 = fneg float %12                            ; 2 uses
  %i.du = fneg float %i.ds                        ; 2 uses
  ...
  %i.dy = insertelement <2 x float> poison, float %13, i64 0
  ...
  %i.ef = tail call float @llvm.fmuladd.f32(float %i.df, float %13, float %i.ee)
