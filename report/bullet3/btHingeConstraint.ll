...
bb.a:
  ...
  %i.bv = load float, ptr %i.aj, align 4, !tbaa !12, !noalias !120
  %6 = load <3 x float>, ptr %i.ai, align 8, !tbaa !12, !noalias !120 ; 5 uses
  ...
  %8 = fmul <2 x float> %i.bw, %7
  %9 = shufflevector <3 x float> %6, <3 x float> poison, <2 x i32> zeroinitializer
  %i.bx = shufflevector <2 x float> %i.bt, <2 x float> %i.bu, <2 x i32> <i32 0, i32 2>
  %10 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %9, <2 x float> %i.bx, <2 x float> %8)
  %11 = shufflevector <3 x float> %6, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %12 = extractelement <3 x float> %6, i64 2
  ...
  %i.cy = load <2 x float>, ptr %i.e, align 4, !tbaa !12, !noalias !117 ; 4 uses
  ...
  %13 = shufflevector <2 x float> %i.cz, <2 x float> poison, <4 x i32> <i32 1, i32 poison, i32 poison, i32 0>
  %i.di = insertelement <4 x float> %13, float %i.bv, i64 1
  %14 = insertelement <4 x float> %i.di, float %i.ab, i64 2
  %15 = fmul <4 x float> %i.dh, %14
  %16 = shufflevector <2 x float> %i.am, <2 x float> poison, <3 x i32> <i32 0, i32 poison, i32 poison>
  %17 = shufflevector <3 x float> %16, <3 x float> %6, <4 x i32> <i32 0, i32 3, i32 poison, i32 poison>
  %18 = insertelement <4 x float> %17, float %i.z, i64 2
  %19 = shufflevector <2 x float> %i.cy, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %20 = shufflevector <4 x float> %18, <4 x float> %19, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %21 = shufflevector <2 x float> %i.ax, <2 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 poison, i32 0>
  %22 = shufflevector <2 x float> %i.cy, <2 x float> %i.de, <4 x i32> <i32 1, i32 2, i32 2, i32 poison>
  %23 = shufflevector <4 x float> %22, <4 x float> %21, <4 x i32> <i32 0, i32 1, i32 2, i32 7>
  %24 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %20, <4 x float> %23, <4 x float> %15) ; 4 uses
  %25 = extractelement <4 x float> %24, i64 0
  %26 = tail call noundef float @llvm.fmuladd.f32(float %i.j, float %i.ap, float %25) ; 4 uses
  %i.dj = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.av, <2 x float> %i.aw, <2 x float> %i.dd)
  %i.dk = extractelement <4 x float> %24, i64 1
  %i.dl = tail call noundef float @llvm.fmuladd.f32(float %12, float %i.x, float %i.dk)
  %i.dm = extractelement <4 x float> %24, i64 2
  %i.dn = tail call noundef float @llvm.fmuladd.f32(float %i.ad, float %i.x, float %i.dm) ; 4 uses
  %i.do = fadd float %i.bs, %i.dl                 ; 2 uses
  %i.dp = fmul float %26, %storemerge
  ...
  %i.dz = extractelement <4 x float> %24, i64 3
  ...
  %i.ej = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %11, <2 x float> %i.ei, <2 x float> %10)
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.ff = insertelement <2 x float> %i.fe, float %26, i64 0
...
.preheader663:                                    ; preds = %bb.c, %bb.d
  ...
  %.sroa.0697.0 = phi <2 x float> [ %.sroa.0697.4.vec.insert, %bb.d ], [ %i.dj, %bb.c ] ; 5 uses
...
bb.h:                                             ; preds = %.preheader661._crit_edge, %.preheader660
  ...
  %i.pi = tail call float @llvm.fmuladd.f32(float %26, float %i.ow, float %i.ph) ; 2 uses
