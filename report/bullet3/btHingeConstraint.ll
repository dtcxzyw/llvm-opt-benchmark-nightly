...
bb.a:
  ...
  %i.w = getelementptr inbounds nuw i8, ptr %0, i64 624 ; 2 uses
  ...
  %i.ab = load float, ptr %i.aa, align 4, !tbaa !12, !noalias !118 ; 2 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %0, i64 648
  %i.ad = load float, ptr %i.ac, align 8, !tbaa !12, !noalias !118 ; 2 uses
  %i.ae = getelementptr inbounds nuw i8, ptr %0, i64 664
  %i.af = load float, ptr %i.ae, align 8, !tbaa !12, !noalias !118 ; 2 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %0, i64 680
  %i.ah = load float, ptr %i.ag, align 8, !tbaa !12, !noalias !118 ; 2 uses
  ...
  %6 = load float, ptr %i.an, align 4, !tbaa !12, !noalias !119
  %i.ao = getelementptr inbounds nuw i8, ptr %3, i64 52
  %7 = load float, ptr %i.x, align 4, !tbaa !12, !noalias !120
  %8 = load <2 x float>, ptr %i.ai, align 4, !tbaa !12, !noalias !118 ; 3 uses
  %i.ap = load <2 x float>, ptr %i.ak, align 4, !tbaa !12, !noalias !118 ; 3 uses
  %9 = load <3 x float>, ptr %i.am, align 8, !tbaa !12, !noalias !119 ; 5 uses
  %i.aq = load float, ptr %i.am, align 8, !tbaa !12, !noalias !119
  %10 = shufflevector <2 x float> %8, <2 x float> %i.ap, <2 x i32> <i32 1, i32 3>
  %11 = shufflevector <3 x float> %9, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %12 = fmul <2 x float> %10, %11
  %i.ar = shufflevector <3 x float> %9, <3 x float> poison, <2 x i32> zeroinitializer
  %i.as = shufflevector <2 x float> %8, <2 x float> %i.ap, <2 x i32> <i32 0, i32 2>
  %13 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ar, <2 x float> %i.as, <2 x float> %12)
  %14 = shufflevector <3 x float> %9, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %15 = load <2 x float>, ptr %i.ao, align 4, !tbaa !12, !noalias !119 ; 2 uses
  %16 = load <2 x float>, ptr %i.q, align 4, !tbaa !12, !noalias !117 ; 4 uses
  %17 = load <2 x float>, ptr %i.t, align 4, !tbaa !12, !noalias !117 ; 4 uses
  %i.at = extractelement <2 x float> %17, i64 0
  %18 = load <3 x float>, ptr %i.w, align 8, !tbaa !12, !noalias !120 ; 5 uses
  %19 = load float, ptr %i.w, align 8, !tbaa !12, !noalias !120
  %20 = load <2 x float>, ptr %i.y, align 4, !tbaa !12, !noalias !120 ; 2 uses
  %i.au = shufflevector <2 x float> %16, <2 x float> %17, <2 x i32> <i32 1, i32 3>
  %21 = shufflevector <3 x float> %18, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %22 = fmul <2 x float> %i.au, %21
  %23 = shufflevector <3 x float> %18, <3 x float> poison, <2 x i32> zeroinitializer
  %24 = shufflevector <2 x float> %16, <2 x float> %17, <2 x i32> <i32 0, i32 2>
  %25 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %23, <2 x float> %24, <2 x float> %22)
  %26 = shufflevector <3 x float> %18, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %27 = load <2 x float>, ptr %3, align 4, !tbaa !12, !noalias !118 ; 3 uses
  %28 = load float, ptr %i.z, align 4, !tbaa !12, !noalias !118
  %29 = fmul float %28, %i.af
  %30 = extractelement <2 x float> %27, i64 0
  %31 = tail call float @llvm.fmuladd.f32(float %i.ad, float %30, float %29)
  %32 = tail call noundef float @llvm.fmuladd.f32(float %i.ah, float %i.ab, float %31) ; 4 uses
  %33 = load <2 x float>, ptr %2, align 4, !tbaa !12, !noalias !117 ; 4 uses
  %34 = extractelement <2 x float> %33, i64 0
  %35 = load <2 x float>, ptr %i.r, align 4, !tbaa !12, !noalias !117 ; 4 uses
  %36 = load float, ptr %i.s, align 4, !tbaa !12, !noalias !117
  %37 = load <2 x float>, ptr %i.c, align 4, !tbaa !12, !noalias !117 ; 4 uses
  %38 = load float, ptr %i.d, align 4, !tbaa !12, !noalias !117
  %i.av = insertelement <2 x float> poison, float %i.h, i64 0
  %i.aw = shufflevector <2 x float> %i.av, <2 x float> poison, <2 x i32> zeroinitializer
  %39 = shufflevector <2 x float> %37, <2 x float> %35, <2 x i32> <i32 0, i32 2>
  %40 = fmul <2 x float> %i.aw, %39
  %i.ax = insertelement <2 x float> poison, float %i.f, i64 0
  %41 = shufflevector <2 x float> %i.ax, <2 x float> poison, <2 x i32> zeroinitializer
  %42 = shufflevector <2 x float> %33, <2 x float> %16, <2 x i32> <i32 0, i32 2>
  %43 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %41, <2 x float> %42, <2 x float> %40)
  %44 = insertelement <2 x float> poison, float %i.j, i64 0
  %45 = shufflevector <2 x float> %44, <2 x float> poison, <2 x i32> zeroinitializer
  %46 = shufflevector <2 x float> %37, <2 x float> %35, <2 x i32> <i32 1, i32 3>
  %47 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %45, <2 x float> %46, <2 x float> %43)
  %48 = extractelement <2 x float> %37, i64 0
  %49 = fmul float %48, %i.n
  %50 = tail call float @llvm.fmuladd.f32(float %i.l, float %34, float %49)
  %51 = tail call noundef float @llvm.fmuladd.f32(float %i.p, float %38, float %50) ; 4 uses
  %52 = shufflevector <2 x float> %33, <2 x float> %27, <2 x i32> <i32 1, i32 3>
  %53 = shufflevector <3 x float> %18, <3 x float> %9, <2 x i32> <i32 1, i32 4>
  %i.ay = fmul <2 x float> %52, %53
  %i.az = insertelement <2 x float> poison, float %19, i64 0
  %54 = insertelement <2 x float> %i.az, float %i.aq, i64 1
  %i.ba = shufflevector <2 x float> %33, <2 x float> %27, <2 x i32> <i32 0, i32 2>
  %i.bb = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %54, <2 x float> %i.ba, <2 x float> %i.ay)
  %55 = shufflevector <3 x float> %18, <3 x float> %9, <2 x i32> <i32 2, i32 5>
  %56 = shufflevector <2 x float> %37, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.bc = insertelement <2 x float> %56, float %i.ab, i64 1
  %57 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %55, <2 x float> %i.bc, <2 x float> %i.bb)
  %58 = insertelement <2 x float> poison, float %7, i64 0
  %59 = insertelement <2 x float> %58, float %6, i64 1 ; 2 uses
  %60 = fadd <2 x float> %59, %57                 ; 3 uses
  %shift = shufflevector <2 x float> %60, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop = fsub <2 x float> %shift, %60
  %61 = extractelement <2 x float> %foldExtExtBinop, i64 0 ; 3 uses
  ...
  %i.bs = fmul float %51, %storemerge
  %i.bt = fmul float %32, %i.br
  %i.bu = load <2 x float>, ptr %i.aj, align 4, !tbaa !12, !noalias !118 ; 3 uses
  %i.bv = insertelement <2 x float> poison, float %i.n, i64 0
  %i.bw = insertelement <2 x float> %i.bv, float %i.af, i64 1 ; 2 uses
  %i.bx = shufflevector <2 x float> %35, <2 x float> %i.bu, <2 x i32> <i32 0, i32 2>
  ...
  %i.cb = shufflevector <2 x float> %16, <2 x float> %8, <2 x i32> <i32 0, i32 2>
  ...
  %i.cf = insertelement <2 x float> %i.bu, float %36, i64 0
  ...
  %i.ci = insertelement <2 x float> %i.ch, float %i.br, i64 1 ; 3 uses
  %i.cj = fmul <2 x float> %i.cg, %i.ci           ; 2 uses
  %i.ck = load <2 x float>, ptr %i.al, align 4, !tbaa !12, !noalias !118 ; 3 uses
  %i.cl = shufflevector <2 x float> %i.bu, <2 x float> %i.ck, <2 x i32> <i32 1, i32 3>
  %i.cm = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> %i.cl, <2 x float> %13)
  %i.cn = fadd <2 x float> %i.cm, %15             ; 3 uses
  %i.co = load <2 x float>, ptr %i.u, align 4, !tbaa !12, !noalias !117 ; 4 uses
  %62 = load float, ptr %i.v, align 4, !tbaa !12, !noalias !117
  %63 = extractelement <2 x float> %i.co, i64 0
  %64 = fmul float %i.h, %63
  %65 = tail call float @llvm.fmuladd.f32(float %i.f, float %i.at, float %64)
  %66 = tail call noundef float @llvm.fmuladd.f32(float %i.j, float %62, float %65)
  %i.cp = shufflevector <2 x float> %i.co, <2 x float> %i.ck, <2 x i32> <i32 0, i32 2>
  %i.cq = fmul <2 x float> %i.bw, %i.cp
  %i.cr = shufflevector <2 x float> %17, <2 x float> %i.ap, <2 x i32> <i32 0, i32 2>
  %i.cs = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ca, <2 x float> %i.cr, <2 x float> %i.cq)
  %i.ct = shufflevector <2 x float> %i.co, <2 x float> %i.ck, <2 x i32> <i32 1, i32 3>
  %i.cu = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ce, <2 x float> %i.ct, <2 x float> %i.cs) ; 5 uses
  %67 = shufflevector <2 x float> %35, <2 x float> %i.co, <2 x i32> <i32 1, i32 3>
  %68 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %26, <2 x float> %67, <2 x float> %25)
  %69 = fadd <2 x float> %68, %20                 ; 3 uses
  %foldExtExtBinop804 = fsub <2 x float> %i.cn, %69 ; 2 uses
  %i.cv = extractelement <2 x float> %foldExtExtBinop804, i64 0 ; 2 uses
  %foldExtExtBinop806 = fsub <2 x float> %i.cn, %69
  ...
  %70 = insertelement <2 x float> poison, float %i.br, i64 0
  %71 = insertelement <2 x float> %70, float %storemerge, i64 1
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.dh = insertelement <2 x float> %i.dg, float %51, i64 0
  %i.di = fmul <2 x float> %i.dh, zeroinitializer
  %i.dj = insertelement <2 x float> %i.cg, float %32, i64 0
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %72 = phi <2 x float> [ <float 0.000000e+00, float 1.000000e+00>, %bb.b ], [ %i.ci, %bb.a ] ; 3 uses
  %73 = phi <2 x float> [ <float 1.000000e+00, float 0.000000e+00>, %bb.b ], [ %71, %bb.a ] ; 2 uses
  ...
  %i.dq = fdiv float 1.000000e+00, %sqrt.i.i      ; 2 uses
  %i.dr = shl i32 %i.b, 1
  %i.ds = fsub <2 x float> %60, %59               ; 2 uses
  %i.dt = fsub <2 x float> %i.cn, %15             ; 3 uses
  %i.du = fsub <2 x float> %69, %20               ; 3 uses
  %i.dv = shufflevector <2 x float> %.sroa.0769.0, <2 x float> %.sroa.15.0, <2 x i32> <i32 1, i32 2>
  %74 = insertelement <2 x float> poison, float %i.dq, i64 0
  %75 = shufflevector <2 x float> %74, <2 x float> poison, <2 x i32> zeroinitializer
  %76 = fmul <2 x float> %i.dv, %75               ; 12 uses
  %77 = shufflevector <2 x float> %72, <2 x float> poison, <2 x i32> zeroinitializer
  %78 = shufflevector <2 x float> %72, <2 x float> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.dw = fmul float %.sroa.0769.0.vec.extract771, %i.dq ; 8 uses
  %.sroa.0769.0.vec.insert = insertelement <2 x float> poison, float %i.dw, i64 0 ; 3 uses
  %79 = shufflevector <2 x float> %.sroa.0769.0.vec.insert, <2 x float> %76, <2 x i32> <i32 0, i32 2>
  %80 = shufflevector <2 x float> %76, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %81 = shufflevector <2 x float> %i.du, <2 x float> %i.dt, <2 x i32> <i32 0, i32 2>
  %82 = fmul <2 x float> %80, %81
  %83 = shufflevector <2 x float> %.sroa.0769.0.vec.insert, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %84 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ds, <2 x float> %83, <2 x float> %82)
  %85 = shufflevector <2 x float> %i.du, <2 x float> %i.dt, <2 x i32> <i32 1, i32 3>
  %86 = shufflevector <2 x float> %76, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %87 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %85, <2 x float> %86, <2 x float> %84) ; 3 uses
  %88 = shufflevector <2 x float> %87, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.dx = fmul <2 x float> %76, %88               ; 2 uses
  %89 = fsub <2 x float> %i.dt, %i.dx             ; 3 uses
  %i.dy = shufflevector <2 x float> %87, <2 x float> poison, <2 x i32> zeroinitializer
  %i.dz = fmul <2 x float> %76, %i.dy             ; 2 uses
  %i.ea = fmul <2 x float> %83, %87               ; 3 uses
  %i.eb = fsub <2 x float> %i.dz, %i.dx           ; 2 uses
  %i.ec = fsub <2 x float> %i.du, %i.dz           ; 3 uses
  %i.ed = fsub <2 x float> %i.ds, %i.ea           ; 3 uses
  %i.ee = fmul <2 x float> %77, %i.eb
  %90 = shufflevector <2 x float> %i.ea, <2 x float> poison, <2 x i32> zeroinitializer
  %91 = shufflevector <2 x float> %i.ea, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.ef = fsub <2 x float> %90, %91
  %i.eg = fmul <2 x float> %72, %i.ef             ; 2 uses
  %92 = fadd <2 x float> %i.ec, %i.ee             ; 8 uses
  %i.eh = fmul <2 x float> %78, %i.eb
  %93 = fadd <2 x float> %i.ed, %i.eg             ; 5 uses
  %i.ei = fsub <2 x float> %i.ed, %i.eg           ; 5 uses
  %94 = shufflevector <2 x float> %93, <2 x float> %i.ei, <2 x i32> <i32 0, i32 3>
  %95 = fsub <2 x float> %89, %i.eh               ; 8 uses
  %i.ej = extractelement <2 x float> %89, i64 0
  %i.ek = fmul float %.0649, %i.ej
  %i.el = extractelement <2 x float> %89, i64 1
  %i.em = fmul float %.0649, %i.el
  %96 = fmul <2 x float> %73, %i.ed
  %i.en = extractelement <2 x float> %i.ec, i64 0
  %i.eo = fmul float %.0648, %i.en
  %i.ep = extractelement <2 x float> %i.ec, i64 1
  %i.eq = fmul float %.0648, %i.ep
  %97 = tail call reassoc float @llvm.vector.reduce.fadd.v2f32(float -0.000000e+00, <2 x float> %96) ; 3 uses
  %i.er = fadd float %i.eo, %i.ek                 ; 3 uses
  %i.es = fadd float %i.eq, %i.em                 ; 3 uses
  %i.et = fmul float %i.er, %i.er
  %i.eu = tail call float @llvm.fmuladd.f32(float %97, float %97, float %i.et)
...
.preheader663:                                    ; preds = %bb.c, %bb.d
  %.sink = phi float [ %i.fb, %bb.d ], [ %66, %bb.c ] ; 7 uses
  %.sroa.0697.0 = phi <2 x float> [ %.sroa.0697.4.vec.insert, %bb.d ], [ %47, %bb.c ] ; 6 uses
  %98 = extractelement <2 x float> %76, i64 1     ; 6 uses
  %.sroa.0697.0.vec.extract700 = extractelement <2 x float> %.sroa.0697.0, i64 0 ; 4 uses
  %i.fc = extractelement <2 x float> %93, i64 0
  %i.fd = extractelement <2 x float> %i.ei, i64 1
  ...
  %99 = fneg float %.sink                         ; 5 uses
  %100 = fmul <2 x float> %76, %i.fj
  %101 = fmul float %i.dw, %99
  %102 = insertelement <2 x float> %.sroa.0769.0.vec.insert, float %.sink, i64 1
  %103 = shufflevector <2 x float> %.sroa.0697.0, <2 x float> %76, <2 x i32> <i32 1, i32 2>
  %104 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %102, <2 x float> %103, <2 x float> %100) ; 6 uses
  %105 = shufflevector <2 x float> %104, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %106 = extractelement <2 x float> %i.fj, i64 1  ; 2 uses
  %107 = fmul float %i.fc, %99
  %foldExtExtBinop821 = fmul <2 x float> %92, %i.fj
  %108 = shufflevector <2 x float> %.sroa.0697.0, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %109 = insertelement <2 x float> %108, float %.sink, i64 0 ; 2 uses
  %110 = shufflevector <2 x float> %foldExtExtBinop821, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %111 = insertelement <2 x float> %110, float %107, i64 1
  %i.fk = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %92, <2 x float> %109, <2 x float> %111)
  store <2 x float> %i.fk, ptr %i.ff, align 4, !tbaa !12
  %112 = fmul float %i.fd, %99
  %foldExtExtBinop823 = fmul <2 x float> %95, %i.fj
  %113 = shufflevector <2 x float> %foldExtExtBinop823, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %114 = insertelement <2 x float> %113, float %112, i64 1
  %i.fl = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %95, <2 x float> %109, <2 x float> %114)
  %i.fm = fneg <2 x float> %i.fl
  %115 = shufflevector <2 x float> %92, <2 x float> %93, <2 x i32> <i32 1, i32 2>
  %116 = extractelement <2 x float> %104, i64 1   ; 4 uses
  %117 = shufflevector <2 x float> %95, <2 x float> %i.ei, <2 x i32> <i32 1, i32 3>
  %.sroa.0697.4.vec.extract705 = extractelement <2 x float> %.sroa.0697.0, i64 1 ; 3 uses
  %118 = tail call float @llvm.fmuladd.f32(float %98, float %.sroa.0697.0.vec.extract700, float %101) ; 6 uses
  %.sroa.0.4.vec.insert.i398 = insertelement <2 x float> %105, float %118, i64 1
  %i.fn = fneg float %116                         ; 3 uses
  %119 = shufflevector <2 x float> %92, <2 x float> %95, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %120 = shufflevector <2 x float> %i.fj, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 0, i32 poison>
  %i.fo = insertelement <4 x float> poison, float %i.fn, i64 0
  %121 = shufflevector <4 x float> %i.fo, <4 x float> poison, <4 x i32> <i32 poison, i32 0, i32 poison, i32 0>
  %122 = shufflevector <4 x float> %120, <4 x float> %121, <4 x i32> <i32 0, i32 5, i32 2, i32 7>
  %i.fp = fmul <4 x float> %119, %122
  %123 = shufflevector <2 x float> %93, <2 x float> %i.ei, <4 x i32> <i32 0, i32 0, i32 3, i32 3>
  %124 = insertelement <2 x float> %108, float %118, i64 1
  %125 = shufflevector <2 x float> %124, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %i.fq = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %123, <4 x float> %125, <4 x float> %i.fp) ; 6 uses
  ...
  %126 = insertelement <2 x float> %105, float %118, i64 0
  %127 = fneg <2 x float> %126                    ; 6 uses
  %128 = fmul <2 x float> %115, %127
  %129 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %92, <2 x float> %104, <2 x float> %128) ; 3 uses
  %i.fu = shufflevector <4 x float> %i.fq, <4 x float> poison, <2 x i32> <i32 3, i32 poison>
  %130 = shufflevector <4 x float> <float poison, float 0.000000e+00, float poison, float poison>, <4 x float> %i.fq, <2 x i32> <i32 5, i32 1> ; 3 uses
  %131 = fmul <2 x float> %117, %127
  %132 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %95, <2 x float> %104, <2 x float> %131) ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  %133 = shufflevector <2 x float> %73, <2 x float> poison, <2 x i32> zeroinitializer
  %i.fy = fmul <2 x float> %133, %132
  %i.fz = extractelement <4 x float> %i.fq, i64 3
  %i.ga = fmul float %.0648, %i.fz
  %.sroa.19.8.vec.insert = insertelement <2 x float> %i.fv, float %i.ga, i64 0
  %i.gb = insertelement <2 x float> poison, float %.0649, i64 0
  %134 = shufflevector <2 x float> %i.gb, <2 x float> poison, <2 x i32> zeroinitializer
  %i.gc = fmul <2 x float> %134, %129
  %i.gd = extractelement <4 x float> %i.fq, i64 1
  %i.ge = fmul float %.0649, %i.gd
  %.sroa.16.8.vec.insert = insertelement <2 x float> %130, float %i.ge, i64 0
  br label %.preheader662

.preheader662:                                    ; preds = %bb.f, %bb.e, %.preheader663
  %.sroa.16.0 = phi <2 x float> [ %130, %bb.e ], [ %.sroa.16.8.vec.insert, %bb.f ], [ %130, %.preheader663 ]
  %.sroa.0747.0 = phi <2 x float> [ %129, %bb.e ], [ %i.gc, %bb.f ], [ %129, %.preheader663 ]
  %.sroa.19.0 = phi <2 x float> [ %i.fv, %bb.e ], [ %.sroa.19.8.vec.insert, %bb.f ], [ %i.fv, %.preheader663 ]
  %.sroa.0713.0 = phi <2 x float> [ %132, %bb.e ], [ %i.fy, %bb.f ], [ %132, %.preheader663 ]
  ...
  %135 = fneg <2 x float> %76                     ; 6 uses
  %136 = shufflevector <2 x float> %92, <2 x float> %93, <2 x i32> <i32 1, i32 2>
  %137 = fmul <2 x float> %136, %135
  %138 = shufflevector <2 x float> %76, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %139 = insertelement <2 x float> %138, float %i.dw, i64 1 ; 2 uses
  %140 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %92, <2 x float> %139, <2 x float> %137) ; 3 uses
  %141 = fneg float %i.dw                         ; 3 uses
  %142 = shufflevector <2 x float> %95, <2 x float> %i.ei, <2 x i32> <i32 1, i32 3>
  %143 = fmul <2 x float> %142, %135
  %144 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %95, <2 x float> %139, <2 x float> %143) ; 2 uses
  %145 = shufflevector <2 x float> %92, <2 x float> %95, <2 x i32> <i32 0, i32 2>
  %i.gm = insertelement <2 x float> poison, float %141, i64 0
  %146 = shufflevector <2 x float> %i.gm, <2 x float> poison, <2 x i32> zeroinitializer
  %i.gn = fmul <2 x float> %145, %146
  %i.go = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %94, <2 x float> %80, <2 x float> %i.gn) ; 4 uses
  %147 = insertelement <2 x float> %i.go, float 0.000000e+00, i64 1 ; 2 uses
...
bb.g:                                             ; preds = %.preheader662
  %148 = fmul <2 x float> %78, %144
  %149 = extractelement <2 x float> %i.go, i64 1
  %150 = fmul float %.0648, %149
  %.sroa.19.8.vec.insert738 = insertelement <2 x float> %i.gp, float %150, i64 0
  %151 = extractelement <2 x float> %140, i64 0
  %152 = fmul float %.0649, %151
  %.sroa.0747.0.vec.insert752 = insertelement <2 x float> poison, float %152, i64 0
  %i.gq = extractelement <2 x float> %140, i64 1
  %i.gr = fmul float %.0649, %i.gq
  %.sroa.0747.4.vec.insert759 = insertelement <2 x float> %.sroa.0747.0.vec.insert752, float %i.gr, i64 1
  %i.gs = extractelement <2 x float> %i.go, i64 0
  %i.gt = fmul float %.0649, %i.gs
  %.sroa.16.8.vec.insert766 = insertelement <2 x float> %147, float %i.gt, i64 0
  br label %.preheader661

.preheader661:                                    ; preds = %bb.g, %.preheader662
  %.sroa.16.1 = phi <2 x float> [ %.sroa.16.8.vec.insert766, %bb.g ], [ %147, %.preheader662 ]
  %.sroa.0747.1 = phi <2 x float> [ %.sroa.0747.4.vec.insert759, %bb.g ], [ %140, %.preheader662 ]
  %.sroa.19.1 = phi <2 x float> [ %.sroa.19.8.vec.insert738, %bb.g ], [ %i.gp, %.preheader662 ]
  %.sroa.0713.1 = phi <2 x float> [ %148, %bb.g ], [ %144, %.preheader662 ]
...
.preheader660:                                    ; preds = %.preheader661
  ...
  store float %106, ptr %i.hs, align 4, !tbaa !12
  %i.ht = getelementptr inbounds nuw i8, ptr %i.hq, i64 8
  store float %99, ptr %i.ht, align 4, !tbaa !12
  ...
  %153 = fmul float %i.cv, %118
  %i.im = tail call float @llvm.fmuladd.f32(float %116, float %61, float %153)
  ...
  %foldExtExtBinop825 = fmul <2 x float> %foldExtExtBinop804, %76
  %154 = extractelement <2 x float> %foldExtExtBinop825, i64 0
  %i.iq = tail call float @llvm.fmuladd.f32(float %i.dw, float %61, float %154)
...
bb.h:                                             ; preds = %.preheader661._crit_edge, %.preheader660
  ...
  store float %.sroa.0697.0.vec.extract700, ptr %i.iy, align 4, !tbaa !12
  %i.iz = add nsw i32 %i.iv, 1
  %i.ja = sext i32 %i.iz to i64                   ; 2 uses
  %i.jb = getelementptr inbounds [4 x i8], ptr %i.ff, i64 %i.ja
  store float %.sroa.0697.4.vec.extract705, ptr %i.jb, align 4, !tbaa !12
  ...
  store float %106, ptr %i.jq, align 4, !tbaa !12
  %i.jr = getelementptr inbounds [4 x i8], ptr %i.fh, i64 %i.jd
  store float %99, ptr %i.jr, align 4, !tbaa !12
  ...
  %i.kh = fmul float %51, %i.kg
  %i.ki = tail call float @llvm.fmuladd.f32(float %i.kb, float %32, float %i.kh) ; 2 uses
  %i.kj = fneg float %32
  %i.kk = fmul float %i.ke, %i.kj
  %i.kl = tail call float @llvm.fmuladd.f32(float %51, float %i.jz, float %i.kk) ; 2 uses
  %i.km = fmul float %i.ki, %.sroa.0697.4.vec.extract705
  %i.kn = tail call float @llvm.fmuladd.f32(float %i.kf, float %.sroa.0697.0.vec.extract700, float %i.km)
  ...
  %i.ks = fmul float %i.ki, %118
  %i.kt = tail call float @llvm.fmuladd.f32(float %i.kf, float %116, float %i.ks)
...
bb.j:                                             ; preds = %.thread, %bb.i
  ...
  store float %i.dw, ptr %i.lp, align 4, !tbaa !12
  %i.lq = add nsw i32 %i.ln, 1
  %i.lr = sext i32 %i.lq to i64                   ; 2 uses
  %i.ls = getelementptr inbounds [4 x i8], ptr %i.ff, i64 %i.lr
  %155 = extractelement <2 x float> %76, i64 0    ; 3 uses
  store float %155, ptr %i.ls, align 4, !tbaa !12
...
bb.v:                                             ; preds = %bb.u
  ...
  %i.oo = fmul float %155, %i.on
  %i.op = tail call float @llvm.fmuladd.f32(float %i.ol, float %i.dw, float %i.oo)
  ...
  %i.ow = fmul float %155, %i.ov
  %i.ox = tail call float @llvm.fmuladd.f32(float %i.ot, float %i.dw, float %i.ow)
