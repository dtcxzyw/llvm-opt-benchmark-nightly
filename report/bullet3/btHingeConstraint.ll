...
bb.a:                                             ; preds = %.preheader.preheader
  ...
  %8 = load <4 x float>, ptr %i.aa, align 8
  %9 = shufflevector <4 x float> %8, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %i.ad = load float, ptr %i.ab, align 8, !tbaa !11
  %10 = load float, ptr %i.ac, align 8, !tbaa !11
  %i.ae = insertelement <2 x float> %9, float %i.ad, i64 1
  ...
  %.sroa.0.0.vec.insert.i66 = load <2 x float>, ptr %i.ah, align 4
...
bb.c:                                             ; preds = %bb.b
  ...
  %11 = load <4 x float>, ptr %i.an, align 8      ; 2 uses
  %.sroa.0.0.vec.insert.i71 = shufflevector <4 x float> %11, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  ...
  %.sroa.0.0.vec.insert.i76 = load <2 x float>, ptr %i.as, align 4
  %12 = shufflevector <4 x float> %11, <4 x float> poison, <2 x i32> <i32 poison, i32 3>
  %.sroa.0.4.vec.insert.i77 = shufflevector <2 x float> %.sroa.0.0.vec.insert.i76, <2 x float> %12, <2 x i32> <i32 0, i32 3>
...
bb.c:                                             ; preds = %bb.b
  ...
  %2 = load <4 x float>, ptr %i.af, align 4
  ...
  %i.cd = shufflevector <4 x float> %2, <4 x float> poison, <2 x i32> zeroinitializer
...
bb.a:
  ...
  %6 = load <4 x float>, ptr %i.cf, align 8
  %i.cg = getelementptr inbounds nuw i8, ptr %0, i64 692
  %7 = load <4 x float>, ptr %i.cg, align 4
  %i.ch = getelementptr inbounds nuw i8, ptr %0, i64 696
  %8 = load <4 x float>, ptr %i.ch, align 8
  ...
  %i.cu = shufflevector <4 x float> %7, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %i.cy = shufflevector <4 x float> %6, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %i.dd = shufflevector <4 x float> %8, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
...
bb.a:
  ...
  %6 = load <4 x float>, ptr %i.ak, align 4
  ...
  %i.bq = shufflevector <4 x float> %6, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 poison, i32 poison>
  ...
  %7 = load <4 x float>, ptr %i.di, align 4
  ...
  %i.fc = shufflevector <4 x float> %7, <4 x float> poison, <2 x i32> zeroinitializer
