...
bb.a:
  ...
  %2 = load <3 x float>, ptr %i.d, align 8, !tbaa !19 ; 5 uses
  %i.ad = load float, ptr %i.d, align 8, !tbaa !19
  ...
  %4 = fmul <2 x float> %3, %i.af
  %i.ag = shufflevector <2 x float> %i.ac, <2 x float> %i.ae, <2 x i32> <i32 0, i32 2>
  %5 = shufflevector <3 x float> %2, <3 x float> poison, <2 x i32> zeroinitializer
  %6 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ag, <2 x float> %5, <2 x float> %4)
  %i.ah = insertelement <2 x float> poison, float %i.f, i64 0
  %i.ai = insertelement <2 x float> %i.ah, float %i.i, i64 1
  %7 = shufflevector <3 x float> %2, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %8 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ai, <2 x float> %7, <2 x float> %6)
  ...
  %9 = shufflevector <2 x float> %i.al, <2 x float> poison, <3 x i32> <i32 poison, i32 1, i32 poison>
  %10 = shufflevector <3 x float> %9, <3 x float> %2, <4 x i32> <i32 1, i32 1, i32 1, i32 4>
  ...
  %11 = insertelement <2 x float> %i.al, float %i.ad, i64 1
  %12 = shufflevector <2 x float> %11, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %i.ax = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.aw, <4 x float> %12, <4 x float> %i.at) ; 4 uses
  ...
  %13 = extractelement <3 x float> %2, i64 2
  %i.be = extractelement <4 x float> %i.ax, i64 3
  %i.bf = tail call noundef float @llvm.fmuladd.f32(float %i.l, float %13, float %i.be)
  store <2 x float> %8, ptr %i.ab, align 4, !tbaa !19
