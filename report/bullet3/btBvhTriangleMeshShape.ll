...
.split.us.1:                                      ; preds = %bb.d, %bb.c, %bb.b, %.split.us.preheader
  ...
  switch i32 %i.u, label %.split.us.2 [
    ...
    i32 3, label %.split.us.2.thread51
    i32 5, label %.split.us.2.thread56
  ]

.split.us.2.thread56:                             ; preds = %.split.us.1
...
.split.us.2.thread51:                             ; preds = %.split.us.1
...
.split43.us:                                      ; preds = %.split43.us.loopexit44, %.split43.us.loopexit
  %.sink = phi float [ %i.gb, %.split43.us.loopexit44 ], [ %i.dh, %.split43.us.loopexit ]
  %i.di = phi <2 x float> [ %i.fx, %.split43.us.loopexit44 ], [ %i.de, %.split43.us.loopexit ]
...
.split.2:                                         ; preds = %bb.j, %bb.i, %bb.h, %.split.1
  ...
  switch i32 %i.u, label %.split43.us.loopexit44 [
    i32 2, label %bb.m
    i32 3, label %bb.l
    i32 5, label %bb.k
  ]
