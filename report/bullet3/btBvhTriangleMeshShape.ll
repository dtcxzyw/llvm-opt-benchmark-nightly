...
.split.us.1:                                      ; preds = %bb.d, %bb.c, %bb.b, %.split.us.preheader
  %.0.us = phi i32 [ undef, %.split.us.preheader ], [ %i.ah, %bb.d ], [ %i.af, %bb.c ], [ %i.ac, %bb.b ]
...
.split42.us.loopexit:                             ; preds = %.split.us.2, %.split.us.2.thread, %.split.us.2.thread50, %.split.us.2.thread55
  %.0.us.2 = phi i32 [ undef, %.split.us.2 ], [ %i.cr, %.split.us.2.thread ], [ %i.cd, %.split.us.2.thread50 ], [ %i.bn, %.split.us.2.thread55 ]
...
.split.1:                                         ; preds = %.split.preheader, %bb.g, %bb.f, %bb.e
  %.0 = phi i32 [ undef, %.split.preheader ], [ %i.dt, %bb.e ], [ %i.dw, %bb.f ], [ %i.dz, %bb.g ]
...
.split.2:                                         ; preds = %bb.j, %bb.i, %bb.h, %.split.1
  %.0.1 = phi i32 [ undef, %.split.1 ], [ %i.ez, %bb.j ], [ %i.ex, %bb.i ], [ %i.eu, %bb.h ]
...
.split42.us.loopexit43:                           ; preds = %bb.m, %bb.l, %bb.k, %.split.2
  %.0.2 = phi i32 [ undef, %.split.2 ], [ %i.fr, %bb.m ], [ %i.fq, %bb.l ], [ %i.fo, %bb.k ]
