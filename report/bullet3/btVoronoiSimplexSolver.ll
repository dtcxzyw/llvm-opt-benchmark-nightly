...
bb.a:
  ...
  %7 = load float, ptr %i.d, align 4, !tbaa !21   ; 5 uses
  %i.q = load float, ptr %2, align 4, !tbaa !21   ; 5 uses
  %8 = load float, ptr %6, align 4, !tbaa !21     ; 5 uses
  ...
  %i.u = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> zeroinitializer
  %i.v = fsub <2 x float> %i.n, %i.u              ; 7 uses
  %10 = insertelement <2 x float> poison, float %8, i64 0
  %11 = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer
  %i.w = fsub <2 x float> %i.p, %11               ; 7 uses
  ...
  %i.aa = fsub float %i.x, %7
  %i.ab = fsub float %i.y, %i.q
  %i.ac = fsub float %i.z, %8
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.bz = fadd float %7, %i.bv
  %i.ca = fadd float %8, %i.bx
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.dl = fadd float %7, %i.dh
  %i.dm = fadd float %8, %i.dj
...
bb.o:                                             ; preds = %bb.m, %bb.l, %bb.k
  ...
  %12 = fmul float %i.cy, %i.el                   ; 5 uses
  %13 = fmul float %i.bm, %i.el                   ; 5 uses
  %i.em = extractelement <2 x float> %i.t, i64 0
  %i.en = fmul float %i.em, %12
  %14 = extractelement <2 x float> %i.v, i64 0
  %i.eo = fmul float %14, %12
  %15 = extractelement <2 x float> %i.w, i64 0
  %16 = fmul float %15, %12
  %17 = fadd float %i.q, %i.en
  %18 = fadd float %7, %i.eo
  %i.ep = fadd float %8, %16
  %19 = extractelement <2 x float> %i.t, i64 1
  %i.eq = fmul float %19, %13
  %20 = extractelement <2 x float> %i.v, i64 1
  %21 = fmul float %20, %13
  %22 = extractelement <2 x float> %i.w, i64 1
  %23 = fmul float %22, %13
  %24 = fadd float %i.eq, %17
  %i.er = fadd float %21, %18
  %25 = fadd float %23, %i.ep
  %.sroa.0.0.vec.insert.i185 = insertelement <2 x float> poison, float %24, i64 0
  %.sroa.0.4.vec.insert.i186 = insertelement <2 x float> %.sroa.0.0.vec.insert.i185, float %i.er, i64 1
  %.sroa.3.12.vec.insert.i187 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %25, i64 0
  store <2 x float> %.sroa.0.4.vec.insert.i186, ptr %5, align 4
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %5, i64 8
  store <2 x float> %.sroa.3.12.vec.insert.i187, ptr %.sroa.4.0..sroa_idx, align 4, !tbaa !17
  %i.es = or disjoint i8 %i.c, 7
  store i8 %i.es, ptr %i.a, align 4
  %i.et = fsub float 1.000000e+00, %12
  %i.eu = fsub float %i.et, %13
  br label %bb.p
...
bb.p:                                             ; preds = %bb.d, %bb.f, %bb.j, %bb.o, %bb.n, %bb.h, %bb.b
  ...
  %.sink291 = phi float [ 1.000000e+00, %bb.d ], [ %i.br, %bb.f ], [ 0.000000e+00, %bb.j ], [ %12, %bb.o ], [ %i.ei, %bb.n ], [ 0.000000e+00, %bb.h ], [ 0.000000e+00, %bb.b ]
  %.sink = phi float [ 0.000000e+00, %bb.d ], [ 0.000000e+00, %bb.f ], [ %i.dd, %bb.j ], [ %13, %bb.o ], [ %i.dy, %bb.n ], [ 1.000000e+00, %bb.h ], [ 0.000000e+00, %bb.b ]
