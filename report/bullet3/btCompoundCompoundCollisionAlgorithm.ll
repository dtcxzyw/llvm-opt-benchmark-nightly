...
bb.a:
  ...
  %i.dw = getelementptr inbounds [88 x i8], ptr %i.dv, i64 %i.x ; 10 uses
  ...
  %i.eb = getelementptr inbounds nuw i8, ptr %i.dw, i64 36
  %i.ec = getelementptr inbounds nuw i8, ptr %i.dw, i64 8
  %i.ed = getelementptr inbounds nuw i8, ptr %i.dw, i64 24
  %i.ee = getelementptr inbounds nuw i8, ptr %i.dw, i64 40
  %i.ef = getelementptr inbounds nuw i8, ptr %i.dw, i64 48 ; 2 uses
  ...
  %i.fc = load <2 x float>, ptr %i.dx, align 4, !tbaa !81, !noalias !160 ; 2 uses
  %i.fd = load <2 x float>, ptr %i.dy, align 4, !tbaa !81, !noalias !160 ; 2 uses
  %i.fe = load <2 x float>, ptr %i.dz, align 4, !tbaa !81, !noalias !160 ; 2 uses
  %i.ff = load float, ptr %i.ec, align 4, !tbaa !81, !noalias !160
  %i.fg = load <2 x float>, ptr %i.ea, align 4, !tbaa !81, !noalias !160 ; 2 uses
  %i.fh = load float, ptr %i.ed, align 4, !tbaa !81, !noalias !160
  ...
  %i.fs = load <2 x float>, ptr %i.eb, align 4, !tbaa !81, !noalias !160 ; 2 uses
  %i.ft = load float, ptr %i.ee, align 4, !tbaa !81, !noalias !160
  ...
  %12 = load <3 x float>, ptr %i.ef, align 4, !tbaa !81, !noalias !159 ; 5 uses
  %i.go = load float, ptr %i.ef, align 4, !tbaa !81, !noalias !159
  ...
  %i.gq = fmul <2 x float> %i.gp, %13
  %i.gr = shufflevector <3 x float> %12, <3 x float> poison, <2 x i32> zeroinitializer
  ...
  %15 = shufflevector <2 x float> %i.ev, <2 x float> %i.ey, <2 x i32> <i32 1, i32 3>
  %16 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> %15, <2 x float> %i.gt)
  %17 = extractelement <3 x float> %12, i64 1
  %i.gu = fmul float %.sroa.13.32.copyload, %17
  %i.gv = call float @llvm.fmuladd.f32(float %i.go, float %i.et, float %i.gu)
  %18 = extractelement <3 x float> %12, i64 2
  %i.gw = call noundef float @llvm.fmuladd.f32(float %18, float %.sroa.14.32.copyload, float %i.gv)
  %i.gx = fadd <2 x float> %i.eu, %16
