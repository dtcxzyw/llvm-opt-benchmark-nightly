...
bb.aa:                                            ; preds = %._crit_edge257.thread, %._crit_edge257, %bb.y
  ...
  %i.du = load float, ptr %i.dr, align 4, !tbaa !96, !noalias !97 ; 4 uses
  ...
  %i.ei = load <2 x float>, ptr %i.do, align 4, !tbaa !96, !noalias !97 ; 4 uses
  %i.ej = extractelement <2 x float> %i.ei, i64 0 ; 3 uses
  %i.ek = extractelement <2 x float> %i.ei, i64 1 ; 3 uses
  ...
  %i.fa = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ep, <4 x float> %i.ez, <4 x float> %i.ex) ; 4 uses
  %17 = extractelement <4 x float> %i.fa, i64 0
  %i.fb = extractelement <4 x float> %i.fa, i64 1
  %i.fc = call noundef float @llvm.fmuladd.f32(float %i.ej, float %i.ea, float %i.fb)
  %18 = extractelement <4 x float> %i.fa, i64 2
  ...
  %i.fs = load float, ptr %i.fr, align 4, !tbaa !96, !noalias !108 ; 3 uses
  ...
  %i.gi = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.fz, <4 x float> %i.gd, <4 x float> %i.gh) ; 5 uses
  ...
  %19 = call noundef float @llvm.fmuladd.f32(float %i.du, float %i.ea, float %17)
  %i.gm = call noundef float @llvm.fmuladd.f32(float %i.ek, float %i.ea, float %18)
  %i.gn = call noundef float @llvm.fmuladd.f32(float %i.fu, float %i.ek, float %i.fm) ; 2 uses
  %20 = extractelement <4 x float> %i.gi, i64 3
  %21 = call float @llvm.fmuladd.f32(float %i.fo, float %i.ds, float %i.gl)
  %22 = call noundef float @llvm.fmuladd.f32(float %i.fs, float %i.du, float %21)
  %23 = call noundef float @llvm.fmuladd.f32(float %i.fs, float %i.ek, float %20)
  %24 = fadd float %i.fc, %i.gk
  %i.go = fadd float %i.gm, %23
  %25 = fadd float %19, %22
  ...
  %i.gs = load float, ptr %i.gr, align 8, !tbaa !115 ; 5 uses
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %26 = shufflevector <4 x float> %i.gi, <4 x float> poison, <2 x i32> <i32 poison, i32 1>
  %i.ic = insertelement <2 x float> %26, float %i.gn, i64 0
...
bb.ac:                                            ; preds = %_ZL11MyIntersectRK12btDbvtAabbMmS1_RK11btTransformf.exit.thread.i, %bb.ab
  ...
  %27 = extractelement <4 x float> %i.ke, i64 1
  %i.kg = extractelement <2 x float> %i.jy, i64 1 ; 2 uses
  %28 = fmul float %i.hy, %i.kg
  %29 = fmul float %i.ib, %i.kg
  %i.kh = fadd float %i.ji, 0.000000e+00          ; 2 uses
  %30 = shufflevector <2 x float> %i.ju, <2 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 1, i32 1>
  %31 = insertelement <4 x float> %30, float %i.jj, i64 0
  %32 = insertelement <4 x float> %31, float %i.kh, i64 1
  %33 = fmul <4 x float> %32, <float 5.000000e-01, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00> ; 2 uses
  %34 = extractelement <4 x float> %33, i64 0     ; 2 uses
  %35 = call noundef float @llvm.fmuladd.f32(float %34, float %i.fv, float %i.kf)
  %36 = fadd float %24, %35                       ; 2 uses
  %i.ki = shufflevector <4 x float> %i.ke, <4 x float> poison, <4 x i32> <i32 2, i32 3, i32 poison, i32 poison>
  %i.kj = insertelement <4 x float> %i.ki, float %28, i64 2
  %i.kk = insertelement <4 x float> %i.kj, float %29, i64 3
  %i.kl = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %33, <4 x float> %i.iq, <4 x float> %i.kk) ; 3 uses
  %37 = extractelement <4 x float> %i.kl, i64 0
  %38 = call noundef float @llvm.fmuladd.f32(float %34, float %i.gn, float %27)
  %39 = fadd float %25, %37                       ; 2 uses
  %40 = fadd float %i.go, %38                     ; 2 uses
