...
bb.c:                                             ; preds = %.lr.ph180, %bb.c
  ...
  %i.bo = phi <2 x float> [ zeroinitializer, %.lr.ph180 ], [ %37, %bb.c ]
  %i.bp = phi <2 x float> [ zeroinitializer, %.lr.ph180 ], [ %38, %bb.c ]
  ...
  %i.cj = getelementptr inbounds nuw i8, ptr %i.cb, i64 36
  ...
  %6 = load float, ptr %i.ck, align 4, !tbaa !23, !noalias !56
  ...
  %9 = shufflevector <2 x float> %7, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %10 = insertelement <2 x float> poison, float %i.bn, i64 0
  %11 = insertelement <2 x float> %10, float %i.cm, i64 1
  %12 = load <2 x float>, ptr %i.ci, align 4, !tbaa !23, !noalias !56 ; 3 uses
  %13 = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.do = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %14 = load <2 x float>, ptr %i.cg, align 4, !tbaa !23, !noalias !56 ; 5 uses
  %15 = load float, ptr %i.bl, align 4, !tbaa !23 ; 2 uses
  %16 = load float, ptr %5, align 4, !tbaa !23    ; 2 uses
  %17 = load float, ptr %i.bm, align 4, !tbaa !23 ; 2 uses
  %18 = shufflevector <2 x float> %7, <2 x float> %14, <2 x i32> <i32 0, i32 2> ; 2 uses
  %19 = insertelement <2 x float> poison, float %16, i64 0
  %20 = shufflevector <2 x float> %19, <2 x float> poison, <2 x i32> zeroinitializer
  %21 = fmul <2 x float> %18, %20                 ; 3 uses
  %22 = shufflevector <2 x float> %7, <2 x float> %14, <2 x i32> <i32 1, i32 3>
  %23 = insertelement <2 x float> poison, float %15, i64 0
  %24 = shufflevector <2 x float> %23, <2 x float> poison, <2 x i32> zeroinitializer
  %25 = fmul <2 x float> %22, %24                 ; 3 uses
  %26 = insertelement <2 x float> %13, float %6, i64 1 ; 3 uses
  %i.dp = insertelement <2 x float> poison, float %17, i64 0
  %i.dq = shufflevector <2 x float> %i.dp, <2 x float> poison, <2 x i32> zeroinitializer
  %27 = fmul <2 x float> %26, %i.dq               ; 3 uses
  %i.dr = fmul <2 x float> %8, %25
  %28 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %21, <2 x float> %9, <2 x float> %i.dr)
  %29 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %27, <2 x float> %i.do, <2 x float> %28)
  %30 = shufflevector <2 x float> %14, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.ds = fmul <2 x float> %30, %25
  %31 = shufflevector <2 x float> %14, <2 x float> poison, <2 x i32> zeroinitializer
  %32 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %21, <2 x float> %31, <2 x float> %i.ds)
  %33 = shufflevector <2 x float> %26, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %34 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %27, <2 x float> %33, <2 x float> %32)
  %35 = fadd <2 x float> %i.bo, %29
  %36 = fadd <2 x float> %34, %i.bp
  %37 = fadd <2 x float> %35, %i.de               ; 2 uses
  %38 = fadd <2 x float> %36, %i.dh               ; 2 uses
  %39 = load float, ptr %i.cj, align 4, !tbaa !23, !noalias !56 ; 3 uses
  %40 = load float, ptr %i.ch, align 4, !tbaa !23, !noalias !56 ; 3 uses
  %41 = load float, ptr %i.cl, align 4, !tbaa !23, !noalias !56 ; 3 uses
  %42 = fmul float %39, %15                       ; 2 uses
  %43 = fmul float %40, %16                       ; 2 uses
  %44 = fmul float %41, %17                       ; 2 uses
  %45 = shufflevector <2 x float> %12, <2 x float> %14, <2 x i32> <i32 0, i32 3>
  %i.dt = insertelement <2 x float> poison, float %42, i64 0
  %i.du = shufflevector <2 x float> %i.dt, <2 x float> poison, <2 x i32> zeroinitializer
  %i.dv = fmul <2 x float> %45, %i.du
  %i.dw = insertelement <2 x float> poison, float %43, i64 0
  %i.dx = shufflevector <2 x float> %i.dw, <2 x float> poison, <2 x i32> zeroinitializer
  %i.dy = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dx, <2 x float> %18, <2 x float> %i.dv)
  %i.dz = insertelement <2 x float> poison, float %44, i64 0
  ...
  %i.ec = insertelement <2 x float> poison, float %39, i64 0
  %i.ed = shufflevector <2 x float> %i.ec, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ee = fmul <2 x float> %i.ed, %25
  %i.ef = insertelement <2 x float> poison, float %40, i64 0
  %i.eg = shufflevector <2 x float> %i.ef, <2 x float> poison, <2 x i32> zeroinitializer
  %i.eh = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %21, <2 x float> %i.eg, <2 x float> %i.ee)
  %i.ei = insertelement <2 x float> poison, float %41, i64 0
  %i.ej = shufflevector <2 x float> %i.ei, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ek = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %27, <2 x float> %i.ej, <2 x float> %i.eh)
  %i.el = fmul float %39, %42
  %i.em = call float @llvm.fmuladd.f32(float %43, float %40, float %i.el)
  %i.en = call noundef float @llvm.fmuladd.f32(float %44, float %41, float %i.em)
  %i.eo = fadd <2 x float> %i.eb, %i.bq
  %i.ep = fadd <2 x float> %i.ek, %11
  %i.eq = fadd float %i.en, %i.cn
  store <2 x float> %37, ptr %4, align 8, !tbaa !23
  %i.er = fadd <2 x float> %i.eo, %i.dn           ; 3 uses
  %i.es = extractelement <2 x float> %i.er, i64 0
  store float %i.es, ptr %i.be, align 8, !tbaa !23
  store <2 x float> %38, ptr %i.bf, align 8, !tbaa !23
