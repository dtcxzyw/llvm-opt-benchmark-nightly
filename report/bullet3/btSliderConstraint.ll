...
begin_hunk_0_@_ZN18btSliderConstraint19calculateTransformsERK11btTransformS2_:bb.a
  ...
  %3 = load float, ptr %i.gv, align 8, !tbaa !9   ; 3 uses
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %i.ih = tail call float @llvm.fmuladd.f32(float %3, float %.sink458, float %i.ig)
  ...
  %i.jl = tail call float @llvm.fmuladd.f32(float %.sink458, float %8, float %i.jk)
...
bb.e:                                             ; preds = %bb.a
  ...
  %8 = load float, ptr %i.bz, align 4, !tbaa !9
  %.sroa.0.0.vec.insert.i478 = insertelement <2 x float> poison, float %8, i64 0
  ...
  %9 = load float, ptr %i.ce, align 8, !tbaa !9
  %.sroa.0.0.vec.insert.i483 = insertelement <2 x float> poison, float %9, i64 0
...
bb.k:                                             ; preds = %bb.j
  ...
  %10 = load float, ptr %i.j, align 8, !tbaa !9
  ...
  %i.gd = insertelement <2 x float> %11, float %i.fm, i64 1
...
bb.m:                                             ; preds = %bb.k
  ...
  %12 = load float, ptr %i.io, align 4, !tbaa !9
  %.sroa.0.0.vec.insert.i573 = insertelement <2 x float> poison, float %12, i64 0
