...
bb.a:
  ...
  %storemerge = select i1 %i.t, float %i.u, float 5.000000e-01 ; 15 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  %8 = fmul <2 x float> %i.gl, %i.gp              ; 3 uses
  %9 = extractelement <2 x float> %8, i64 0
  %10 = fadd <2 x float> %i.gr, %i.fx
  %i.gt = fadd float %9, %i.fy
  ...
  %12 = fsub float %i.gt, %11                     ; 2 uses
  %13 = fmul <2 x float> %i.ga, %i.gx
  %14 = fmul float %storemerge, %12
  %i.gy = fadd <2 x float> %i.gs, %13             ; 7 uses
  %15 = shufflevector <2 x float> <float poison, float 0.000000e+00>, <2 x float> %i.gy, <2 x i32> <i32 3, i32 1>
  %i.gz = insertelement <2 x float> poison, float %i.v, i64 0 ; 2 uses
  %i.ha = shufflevector <2 x float> %i.gz, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.hb = fmul <2 x float> %i.ha, %i.gx
  %16 = fmul float %i.v, %12
  %i.hc = fsub <2 x float> %i.gw, %i.hb           ; 8 uses
  %17 = shufflevector <2 x float> <float poison, float 0.000000e+00>, <2 x float> %i.hc, <2 x i32> <i32 3, i32 1>
  %18 = extractelement <2 x float> %i.gw, i64 0
  %19 = fmul float %storemerge, %18
  %20 = extractelement <2 x float> %i.gw, i64 1
  %21 = fmul float %storemerge, %20
  %i.hd = fsub <2 x float> %i.gh, %8              ; 3 uses
  %22 = extractelement <2 x float> %i.hd, i64 0
  %23 = fadd float %22, %14                       ; 5 uses
  %.sroa.0.0.vec.insert.i543 = insertelement <2 x float> poison, float %23, i64 0
  %24 = shufflevector <2 x float> %.sroa.0.0.vec.insert.i543, <2 x float> %i.gy, <2 x i32> <i32 0, i32 2>
  %i.he = extractelement <2 x float> %i.hd, i64 1
  %25 = fsub float %i.he, %16                     ; 5 uses
  %.sroa.0.0.vec.insert.i553 = insertelement <2 x float> poison, float %25, i64 0
  %26 = shufflevector <2 x float> %.sroa.0.0.vec.insert.i553, <2 x float> %i.hc, <2 x i32> <i32 0, i32 2>
  %i.hf = insertelement <2 x float> %i.gz, float %storemerge, i64 1
  ...
  %i.hm = fadd float %19, %i.hi                   ; 3 uses
  %i.hn = fadd float %21, %i.hk                   ; 3 uses
...
.preheader995.preheader:                          ; preds = %bb.m, %bb.l
  ...
  %i.ii = fneg <2 x float> %.sroa.01139.2         ; 6 uses
  %i.ij = fneg float %.sink                       ; 4 uses
  %i.ik = fmul <2 x float> %i.fu, %i.ii
  %i.il = fmul float %.sroa.0822.0.vec.extract833, %i.ij
  %i.im = shufflevector <2 x float> %.sroa.01139.2, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  ...
  %27 = tail call float @llvm.fmuladd.f32(float %.sroa.49.8.vec.extract917, float %.sroa.01139.0.vec.extract1148, float %i.il) ; 4 uses
  %i.ip = shufflevector <2 x float> %i.io, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %.sroa.0.4.vec.insert.i579 = insertelement <2 x float> %i.ip, float %27, i64 1 ; 2 uses
  ...
  %i.it = extractelement <2 x float> %i.gy, i64 0
  %i.iu = fmul float %23, %i.ij
  ...
  %i.ja = extractelement <2 x float> %i.ii, i64 0
  %foldExtExtBinop = fmul <2 x float> %i.gy, %i.ii
  %28 = extractelement <2 x float> %foldExtExtBinop, i64 0
  %29 = tail call float @llvm.fmuladd.f32(float %23, float %.sroa.01139.4.vec.extract1164, float %28)
  %30 = extractelement <2 x float> %i.hc, i64 0
  %foldExtExtBinop1211 = fmul <2 x float> %i.hc, %i.ii
  %i.jb = extractelement <2 x float> %foldExtExtBinop1211, i64 0
  %31 = tail call float @llvm.fmuladd.f32(float %25, float %.sroa.01139.4.vec.extract1164, float %i.jb)
  store <2 x float> %i.iz, ptr %scevgep1027, align 4, !tbaa !10
  store float %29, ptr %.sroa.15.0.scevgep1027.sroa_idx, align 4, !tbaa !10
  %32 = fmul float %25, %i.ij
  %foldExtExtBinop1213 = fmul <2 x float> %i.hc, %i.ii
  %33 = shufflevector <2 x float> %foldExtExtBinop1213, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.jc = insertelement <2 x float> %33, float %32, i64 1
  %34 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.hc, <2 x float> %i.iw, <2 x float> %i.jc)
  %35 = fneg <2 x float> %34
  store <2 x float> %35, ptr %i.if, align 4, !tbaa !10
  %36 = fneg float %31
  store float %36, ptr %i.ih, align 4, !tbaa !10
  %37 = extractelement <2 x float> %i.io, i64 0   ; 2 uses
  %38 = extractelement <2 x float> %i.io, i64 1
  %39 = fneg float %38                            ; 3 uses
  %40 = fmul float %i.it, %39
  %41 = tail call float @llvm.fmuladd.f32(float %23, float %27, float %40) ; 2 uses
  %.sroa.3.12.vec.insert.i595 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %41, i64 0 ; 3 uses
  %42 = fneg float %37                            ; 3 uses
  %43 = fneg float %27                            ; 3 uses
  %44 = fmul float %23, %42
  %45 = fmul float %i.ir, %43
  %46 = insertelement <2 x float> poison, float %45, i64 0
  %47 = insertelement <2 x float> %46, float %44, i64 1
  %48 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.gy, <2 x float> %i.io, <2 x float> %47) ; 3 uses
  %49 = shufflevector <2 x float> %i.hc, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.jd = insertelement <2 x float> %49, float %25, i64 1
  %i.je = insertelement <2 x float> poison, float %43, i64 0
  %50 = insertelement <2 x float> %i.je, float %42, i64 1
  %51 = fmul <2 x float> %i.jd, %50
  %52 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.hc, <2 x float> %i.io, <2 x float> %51) ; 3 uses
  %53 = fmul float %30, %39
  %54 = tail call float @llvm.fmuladd.f32(float %25, float %27, float %53) ; 2 uses
  %.sroa.3.12.vec.insert.i600 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %54, i64 0 ; 3 uses
...
bb.o:                                             ; preds = %bb.n
  %i.ji = fmul <2 x float> %i.ha, %52
  %i.jj = fmul float %i.v, %54
  %.sroa.17.8.vec.insert1077 = insertelement <2 x float> %.sroa.3.12.vec.insert.i600, float %i.jj, i64 0
  %i.jk = fmul <2 x float> %i.ga, %48
  %i.jl = fmul float %storemerge, %41
  %.sroa.15.8.vec.insert1100 = insertelement <2 x float> %.sroa.3.12.vec.insert.i595, float %i.jl, i64 0
...
.preheader994.preheader:                          ; preds = %bb.o, %bb.n, %.preheader995.preheader
  ...
  %.sroa.01085.0 = phi <2 x float> [ %i.jk, %bb.o ], [ %48, %bb.n ], [ %48, %.preheader995.preheader ]
  ...
  %.sroa.01057.0 = phi <2 x float> [ %i.ji, %bb.o ], [ %52, %bb.n ], [ %52, %.preheader995.preheader ]
  ...
  store <2 x float> %.sroa.0.4.vec.insert.i579, ptr %scevgep1035, align 4, !tbaa !10
  %.sroa.20.0.scevgep1035.sroa_idx = getelementptr inbounds nuw i8, ptr %scevgep1035, i64 8
  store float %37, ptr %.sroa.20.0.scevgep1035.sroa_idx, align 4, !tbaa !10
  ...
  store float %i.ja, ptr %i.jx, align 4, !tbaa !10
...
.loopexit:                                        ; preds = %.preheader994.preheader, %.preheader1001.preheader
  ...
  %.sroa.01104.2 = phi <2 x float> [ %.sroa.0.4.vec.insert.i579, %.preheader994.preheader ], [ %.sroa.01104.1, %.preheader1001.preheader ] ; 2 uses
  %.sroa.0715.0 = phi <2 x float> [ %26, %.preheader994.preheader ], [ zeroinitializer, %.preheader1001.preheader ] ; 4 uses
  %.sroa.16.0 = phi <2 x float> [ %17, %.preheader994.preheader ], [ zeroinitializer, %.preheader1001.preheader ] ; 2 uses
  %.sroa.0746.0 = phi <2 x float> [ %24, %.preheader994.preheader ], [ zeroinitializer, %.preheader1001.preheader ] ; 3 uses
  %.sroa.16765.0 = phi <2 x float> [ %15, %.preheader994.preheader ], [ zeroinitializer, %.preheader1001.preheader ] ; 2 uses
