...
.preheader.preheader:
  ...
  %i.az = load float, ptr %i.t, align 4, !tbaa !10, !noalias !63
  %4 = load <3 x float>, ptr %i.i, align 4, !tbaa !10, !noalias !64 ; 5 uses
  %i.ba = load float, ptr %i.i, align 4, !tbaa !10, !noalias !64
  ...
  %i.bh = fmul <2 x float> %i.bg, %5
  %i.bi = shufflevector <3 x float> %4, <3 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.bm = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %6, <2 x float> %i.bl, <2 x float> %i.bk)
  ...
  %i.cn = fmul float %i.cm, %7
  %i.co = extractelement <2 x float> %i.cl, i64 0
  %i.cp = tail call float @llvm.fmuladd.f32(float %i.ba, float %i.co, float %i.cn)
  %8 = extractelement <3 x float> %4, i64 2
  %i.cq = tail call noundef float @llvm.fmuladd.f32(float %8, float %i.z, float %i.cp)
  ...
  %i.db = insertelement <4 x float> %i.cg, float %i.az, i64 2
