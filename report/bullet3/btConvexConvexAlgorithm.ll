...
bb.a:
  ...
  %i.r = load float, ptr %i.d, align 4, !tbaa !54 ; 3 uses
  ...
  %i.x = load <2 x float>, ptr %i.a, align 4, !tbaa !54
  %4 = load float, ptr %2, align 4, !tbaa !54
  %5 = load <2 x float>, ptr %i.b, align 4, !tbaa !54
  ...
  %i.aa = shufflevector <2 x float> %i.x, <2 x float> %5, <2 x i32> <i32 0, i32 2>
  %9 = insertelement <2 x float> poison, float %8, i64 0
  %10 = insertelement <2 x float> %9, float %7, i64 1
  %i.ab = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.z, <2 x float> %i.aa, <2 x float> %10)
