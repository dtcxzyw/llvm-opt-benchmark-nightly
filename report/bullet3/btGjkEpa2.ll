...
_ZNK12gjkepa2_impl13MinkowskiDiff8Support0ERK9btVector3.exit.i.i: ; preds = %bb.c, %bb.b
  ...
  %8 = load float, ptr %i.i, align 8, !tbaa !28
  %9 = load float, ptr %.sroa.42.0..sroa_idx.i, align 8, !tbaa !28
...
_ZNK12gjkepa2_impl3GJK10getsupportERK9btVector3RNS0_3sSVE.exit: ; preds = %bb.d, %bb.e
  ...
  %10 = fneg float %9                             ; 2 uses
  %11 = fneg float %7                             ; 2 uses
  %12 = fneg float %8                             ; 2 uses
  ...
  %i.ce = fmul <2 x float> %i.cd, %14
  %i.cf = shufflevector <2 x float> %i.cb, <2 x float> %i.cc, <2 x i32> <i32 0, i32 2>
  %15 = insertelement <2 x float> poison, float %12, i64 0
  %i.cg = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ch = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cf, <2 x float> %i.cg, <2 x float> %i.ce)
  %16 = insertelement <2 x float> poison, float %i.by, i64 0
  %i.ci = insertelement <2 x float> %16, float %i.ca, i64 1
  %i.cj = insertelement <2 x float> poison, float %10, i64 0
  %17 = shufflevector <2 x float> %i.cj, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ck = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ci, <2 x float> %17, <2 x float> %i.ch)
  ...
  %i.co = fmul float %i.cn, %11
  %i.cp = tail call float @llvm.fmuladd.f32(float %i.cl, float %12, float %i.co)
  %i.cq = getelementptr inbounds nuw i8, ptr %0, i64 56 ; 2 uses
  %i.cr = load float, ptr %i.cq, align 8, !tbaa !28
  %i.cs = tail call noundef float @llvm.fmuladd.f32(float %i.cr, float %10, float %i.cp)
