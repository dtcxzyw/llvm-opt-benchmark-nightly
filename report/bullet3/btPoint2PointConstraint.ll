...
bb.a:
  ...
  %i.q = load <2 x float>, ptr %i.b, align 8, !tbaa !25 ; 2 uses
  %i.r = load float, ptr %i.e, align 4, !tbaa !25 ; 2 uses
  %i.s = load float, ptr %2, align 4, !tbaa !25   ; 2 uses
  %i.t = load float, ptr %i.f, align 4, !tbaa !25 ; 2 uses
  %3 = load <2 x float>, ptr %i.c, align 8, !tbaa !25 ; 2 uses
  %4 = insertelement <2 x float> poison, float %i.r, i64 0
  %5 = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> zeroinitializer
  %6 = shufflevector <2 x float> %i.q, <2 x float> %3, <2 x i32> <i32 1, i32 3>
  ...
  %i.w = shufflevector <2 x float> %i.q, <2 x float> %3, <2 x i32> <i32 0, i32 2>
  %i.x = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.v, <2 x float> %i.w, <2 x float> %7)
  %i.y = insertelement <2 x float> poison, float %i.t, i64 0
  ...
  %i.ad = fmul float %i.r, %i.m
  %i.ae = tail call float @llvm.fmuladd.f32(float %i.s, float %i.k, float %i.ad)
  %i.af = tail call noundef float @llvm.fmuladd.f32(float %i.t, float %i.o, float %i.ae)
...
bb.a:
  ...
  %i.cl = load <2 x float>, ptr %3, align 4, !tbaa !25 ; 2 uses
  %i.cm = load float, ptr %i.bn, align 8, !tbaa !25 ; 2 uses
  %i.cn = load float, ptr %i.bm, align 4, !tbaa !25 ; 2 uses
  %i.co = load float, ptr %i.br, align 4, !tbaa !25 ; 2 uses
  %4 = load <2 x float>, ptr %i.bs, align 4, !tbaa !25 ; 2 uses
  %5 = insertelement <2 x float> poison, float %i.cm, i64 0
  %6 = shufflevector <2 x float> %5, <2 x float> poison, <2 x i32> zeroinitializer
  %7 = shufflevector <2 x float> %i.cl, <2 x float> %4, <2 x i32> <i32 1, i32 3>
  %8 = fmul <2 x float> %6, %7
  %i.cp = shufflevector <2 x float> %i.cl, <2 x float> %4, <2 x i32> <i32 0, i32 2>
  ...
  %i.cs = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cp, <2 x float> %i.cr, <2 x float> %8)
  ...
  %i.cx = fmul float %i.cm, %i.by
  %i.cy = tail call float @llvm.fmuladd.f32(float %i.bw, float %i.cn, float %i.cx)
  %i.cz = tail call noundef float @llvm.fmuladd.f32(float %i.ca, float %i.co, float %i.cy) ; 3 uses
