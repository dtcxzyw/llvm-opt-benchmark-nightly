...
bb.a:
  ...
  %4 = load float, ptr %i.e, align 4, !tbaa !23
  %5 = load float, ptr %1, align 4, !tbaa !23
  %6 = load float, ptr %i.g, align 4, !tbaa !23
  %7 = fneg float %4                              ; 2 uses
  ...
  %i.az = fmul <2 x float> %i.ay, %11
  %12 = insertelement <2 x float> poison, float %8, i64 0
  %i.ba = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.bd = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bc, <2 x float> %14, <2 x float> %i.bb)
  ...
  %i.bi = fmul float %i.bh, %7
  %i.bj = call float @llvm.fmuladd.f32(float %i.bf, float %8, float %i.bi)
  %i.bk = getelementptr inbounds nuw i8, ptr %0, i64 176 ; 2 uses
  %i.bl = load float, ptr %i.bk, align 8, !tbaa !23
  %i.bm = call noundef float @llvm.fmuladd.f32(float %i.bl, float %9, float %i.bj)
