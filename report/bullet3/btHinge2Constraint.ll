...
bb.j:                                             ; preds = %bb.h, %bb.f, %_ZN11btTransform11getIdentityEv.exit
  ...
  %i.eh = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cl, <2 x float> %7, <2 x float> %i.cj) ; 2 uses
  ...
  %i.fb = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %8, <2 x float> %i.el, <2 x float> %i.fa)
  ...
  %15 = insertelement <2 x float> poison, float %i.eo, i64 0
  %16 = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> zeroinitializer
  %i.fh = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> %16, <2 x float> %i.fg) ; 2 uses
