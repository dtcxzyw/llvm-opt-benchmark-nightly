...
bb.a:
  ...
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !60, !nonnull !43, !align !61 ; 11 uses
  %7 = getelementptr inbounds nuw i8, ptr %i.r, i64 16
  ...
  %i.aa = getelementptr inbounds nuw i8, ptr %i.r, i64 56
  ...
  %i.af = fneg <3 x float> %i.ae                  ; 4 uses
  %i.ag = shufflevector <3 x float> %i.af, <3 x float> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  ...
  %8 = load float, ptr %i.aa, align 4, !tbaa !44, !noalias !105 ; 2 uses
  %9 = insertelement <2 x float> poison, float %8, i64 0
  %10 = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> zeroinitializer
  %11 = load <2 x float>, ptr %i.z, align 4, !tbaa !44, !noalias !105 ; 4 uses
  %i.am = shufflevector <2 x float> %11, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.an = fmul <2 x float> %i.ac, %i.am
  %i.ao = shufflevector <2 x float> %11, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ap = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ao, <2 x float> %i.ab, <2 x float> %i.an)
  %i.aq = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %10, <2 x float> %i.ad, <2 x float> %i.ap)
  ...
  %12 = shufflevector <2 x float> %i.ag, <2 x float> %11, <2 x i32> <i32 0, i32 3>
  %i.at = fmul <2 x float> %i.as, %12
  ...
  %13 = shufflevector <2 x float> %i.ai, <2 x float> %11, <2 x i32> <i32 0, i32 2>
  %i.aw = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.av, <2 x float> %13, <2 x float> %i.at)
  ...
  %14 = shufflevector <3 x float> %i.af, <3 x float> poison, <2 x i32> <i32 2, i32 poison>
  %15 = insertelement <2 x float> %14, float %8, i64 1
  %i.az = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ay, <2 x float> %15, <2 x float> %i.aw) ; 2 uses
  ...
  %i.bc = load <2 x float>, ptr %7, align 4, !tbaa !44, !noalias !106 ; 2 uses
  %i.bd = load <2 x float>, ptr %i.s, align 4, !tbaa !44, !noalias !106 ; 2 uses
  ...
  %i.br = load <2 x float>, ptr %i.u, align 4, !tbaa !44, !noalias !106 ; 2 uses
  %i.bs = load float, ptr %i.x, align 4, !tbaa !44, !noalias !106
  %i.bt = load <2 x float>, ptr %i.t, align 4, !tbaa !44, !noalias !106 ; 2 uses
  %i.bu = load float, ptr %i.w, align 4, !tbaa !44, !noalias !106
  %i.bv = load <2 x float>, ptr %i.v, align 4, !tbaa !44, !noalias !106 ; 2 uses
  %i.bw = load float, ptr %i.y, align 4, !tbaa !44, !noalias !106
...
bb.a:
  ...
  %i.k = load <2 x float>, ptr %i.a, align 8, !tbaa !44 ; 2 uses
  %i.l = load float, ptr %i.d, align 4, !tbaa !44 ; 2 uses
  %i.m = load float, ptr %1, align 4, !tbaa !44   ; 2 uses
  %i.n = load float, ptr %i.e, align 4, !tbaa !44 ; 2 uses
  %2 = load <2 x float>, ptr %i.b, align 8, !tbaa !44 ; 2 uses
  %3 = insertelement <2 x float> poison, float %i.l, i64 0
  %4 = shufflevector <2 x float> %3, <2 x float> poison, <2 x i32> zeroinitializer
  %5 = shufflevector <2 x float> %i.k, <2 x float> %2, <2 x i32> <i32 1, i32 3>
  ...
  %i.q = shufflevector <2 x float> %i.k, <2 x float> %2, <2 x i32> <i32 0, i32 2>
  %i.r = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.p, <2 x float> %i.q, <2 x float> %6)
  %i.s = insertelement <2 x float> poison, float %i.n, i64 0
  ...
  %i.ad = tail call noundef float @llvm.fmuladd.f32(float %i.n, float %i.ac, float %i.aa)
