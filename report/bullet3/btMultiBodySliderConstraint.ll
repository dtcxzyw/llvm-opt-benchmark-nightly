...
begin_hunk_0_@_ZN27btMultiBodySliderConstraint20createConstraintRowsER20btAlignedObjectArrayI27btMultiBodySolverConstraintER23btMultiBodyJacobianDataRK19btContactSolverInfo:bb.a
  %i.tl = insertelement <2 x float> poison, float %i.rj, i64 0
  %i.tm = shufflevector <2 x float> %i.tl, <2 x float> poison, <2 x i32> zeroinitializer
  %i.tn = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.sx, <2 x float> %i.tm, <2 x float> %i.tk)
  %i.to = insertelement <2 x float> poison, float %i.rr, i64 0
  %i.tp = shufflevector <2 x float> %i.to, <2 x float> poison, <2 x i32> zeroinitializer
  %i.tq = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.tb, <2 x float> %i.tp, <2 x float> %i.tn)
  store <2 x float> %i.tq, ptr %i.th, align 4, !tbaa !30, !alias.scope !87
  %i.tr = getelementptr inbounds nuw i8, ptr %10, i64 40
  store float %i.sf, ptr %i.tr, align 4, !tbaa !30, !alias.scope !87
  %i.ts = getelementptr inbounds nuw i8, ptr %10, i64 44
  store float 0.000000e+00, ptr %i.ts, align 4, !tbaa !30, !alias.scope !87
  call void @llvm.lifetime.start.p0(ptr nonnull %11) #13
  %i.tt = call noundef zeroext i1 @_ZN30btGeneric6DofSpring2Constraint16matrixToEulerXYZERK11btMatrix3x3R9btVector3(ptr noundef nonnull align 4 dereferenceable(48) %10, ptr noundef nonnull align 4 dereferenceable(16) %11) ; 0 uses
  %i.tu = getelementptr inbounds nuw i8, ptr %1, i64 4 ; 4 uses
  %i.tv = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 2 uses
  %i.tw = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 6 uses
  %i.tx = getelementptr inbounds nuw i8, ptr %1, i64 24 ; 2 uses
  %i.ty = getelementptr inbounds nuw i8, ptr %2, i64 200
  %i.tz = getelementptr inbounds nuw i8, ptr %12, i64 4
  %i.ua = getelementptr inbounds nuw i8, ptr %12, i64 8
  %i.ub = getelementptr inbounds nuw i8, ptr %13, i64 8
  %i.uc = getelementptr inbounds nuw i8, ptr %0, i64 60 ; 2 uses
  %i.ud = getelementptr inbounds nuw i8, ptr %4, i64 4
  %i.ue = getelementptr inbounds nuw i8, ptr %7, i64 4
  br label %bb.m
...
bb.m:                                             ; preds = %.loopexit, %bb.z
  ...
  %i.uf = load i32, ptr %i.tu, align 4, !tbaa !90 ; 8 uses
  %i.ug = load i32, ptr %i.tv, align 8, !tbaa !94
  %i.uh = icmp eq i32 %i.uf, %i.ug
  br i1 %i.uh, label %bb.n, label %_ZN20btAlignedObjectArrayI27btMultiBodySolverConstraintE21expandNonInitializingEv.exit

bb.n:                                             ; preds = %bb.m
  %.not.i.i = icmp eq i32 %i.uf, 0
  %i.ui = shl nsw i32 %i.uf, 1
  %i.uj = select i1 %.not.i.i, i32 1, i32 %i.ui   ; 4 uses
  %i.uk = icmp slt i32 %i.uf, %i.uj
  br i1 %i.uk, label %bb.o, label %_ZN20btAlignedObjectArrayI27btMultiBodySolverConstraintE21expandNonInitializingEv.exit

bb.o:                                             ; preds = %bb.n
  %.not.i.i.i = icmp eq i32 %i.uj, 0
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.um = mul nsw i64 %i.ul, 224
  %i.un = call noundef ptr @_Z22btAlignedAllocInternalmi(i64 noundef %i.um, i32 noundef 16)
  %.pre.i = load i32, ptr %i.tu, align 4, !tbaa !90
...
_ZN20btAlignedObjectArrayI27btMultiBodySolverConstraintE8allocateEi.exit.i.i: ; preds = %bb.p, %bb.o
  %i.uo = phi i32 [ %.pre.i, %bb.p ], [ %i.uf, %bb.o ] ; 4 uses
  %.0.i.i.i = phi ptr [ %i.un, %bb.p ], [ null, %bb.o ] ; 4 uses
  %i.up = icmp sgt i32 %i.uo, 0
  br i1 %i.up, label %.lr.ph.i.i.i, label %_ZNK20btAlignedObjectArrayI27btMultiBodySolverConstraintE4copyEiiPS0_.exit.i.i

.lr.ph.i.i.i:                                     ; preds = %_ZN20btAlignedObjectArrayI27btMultiBodySolverConstraintE8allocateEi.exit.i.i
  %wide.trip.count.i.i.i = zext nneg i32 %i.uo to i64 ; 2 uses
  %xtraiter = and i64 %wide.trip.count.i.i.i, 1
  %i.uq = icmp eq i32 %i.uo, 1
  br i1 %i.uq, label %.epil.preheader, label %.lr.ph.i.i.i.new
...
bb.q:                                             ; preds = %bb.q, %.lr.ph.i.i.i.new
  ...
  %i.ur = getelementptr inbounds nuw [224 x i8], ptr %.0.i.i.i, i64 %indvars.iv.i.i.i
  %i.us = load ptr, ptr %i.tw, align 8, !tbaa !95
  %i.ut = getelementptr inbounds nuw [224 x i8], ptr %i.us, i64 %indvars.iv.i.i.i
  ...
  %i.uu = getelementptr inbounds nuw [224 x i8], ptr %.0.i.i.i, i64 %indvars.iv.next.i.i.i
  %i.uv = load ptr, ptr %i.tw, align 8, !tbaa !95
  %i.uw = getelementptr inbounds nuw [224 x i8], ptr %i.uv, i64 %indvars.iv.next.i.i.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(224) %i.uu, ptr noundef nonnull align 8 dereferenceable(224) %i.uw, i64 224, i1 false), !tbaa.struct !96
...
.epil.preheader:                                  ; preds = %_ZNK20btAlignedObjectArrayI27btMultiBodySolverConstraintE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa, %.lr.ph.i.i.i
  ...
  %lcmp.mod284 = trunc i32 %i.uo to i1
  call void @llvm.assume(i1 %lcmp.mod284)
  %i.ux = getelementptr inbounds nuw [224 x i8], ptr %.0.i.i.i, i64 %indvars.iv.i.i.i.epil.init
  %i.uy = load ptr, ptr %i.tw, align 8, !tbaa !95
  %i.uz = getelementptr inbounds nuw [224 x i8], ptr %i.uy, i64 %indvars.iv.i.i.i.epil.init
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(224) %i.ux, ptr noundef nonnull align 8 dereferenceable(224) %i.uz, i64 224, i1 false), !tbaa.struct !96
...
_ZNK20btAlignedObjectArrayI27btMultiBodySolverConstraintE4copyEiiPS0_.exit.i.i: ; preds = %.epil.preheader, %_ZNK20btAlignedObjectArrayI27btMultiBodySolverConstraintE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa, %_ZN20btAlignedObjectArrayI27btMultiBodySolverConstraintE8allocateEi.exit.i.i
  %i.va = load ptr, ptr %i.tw, align 8, !tbaa !95 ; 2 uses
  %.not.i5.i.i = icmp eq ptr %i.va, null
...
bb.r:                                             ; preds = %_ZNK20btAlignedObjectArrayI27btMultiBodySolverConstraintE4copyEiiPS0_.exit.i.i
  %i.vb = load i8, ptr %i.tx, align 8, !tbaa !102, !range !39, !noundef !40
  %i.vc = trunc nuw i8 %i.vb to i1
  br i1 %i.vc, label %bb.s, label %_ZN20btAlignedObjectArrayI27btMultiBodySolverConstraintE10deallocateEv.exit.i.i

bb.s:                                             ; preds = %bb.r
  call void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %i.va)
...
_ZN20btAlignedObjectArrayI27btMultiBodySolverConstraintE10deallocateEv.exit.i.i: ; preds = %bb.s, %bb.r, %_ZNK20btAlignedObjectArrayI27btMultiBodySolverConstraintE4copyEiiPS0_.exit.i.i
  store i8 1, ptr %i.tx, align 8, !tbaa !102
  store ptr %.0.i.i.i, ptr %i.tw, align 8, !tbaa !95
  store i32 %i.uj, ptr %i.tv, align 8, !tbaa !94
  %.pre2.i = load i32, ptr %i.tu, align 4, !tbaa !90
...
_ZN20btAlignedObjectArrayI27btMultiBodySolverConstraintE21expandNonInitializingEv.exit: ; preds = %bb.m, %bb.n, %_ZN20btAlignedObjectArrayI27btMultiBodySolverConstraintE10deallocateEv.exit.i.i
  %i.vd = phi i32 [ %.pre2.i, %_ZN20btAlignedObjectArrayI27btMultiBodySolverConstraintE10deallocateEv.exit.i.i ], [ %i.uf, %bb.n ], [ %i.uf, %bb.m ]
  %i.ve = add nsw i32 %i.vd, 1
  store i32 %i.ve, ptr %i.tu, align 4, !tbaa !90
  %i.vf = load ptr, ptr %i.tw, align 8, !tbaa !95
  %i.vg = sext i32 %i.uf to i64
  %i.vh = getelementptr inbounds [224 x i8], ptr %i.vf, i64 %i.vg ; 7 uses
  %i.vi = getelementptr inbounds nuw i8, ptr %i.vh, i64 208
  store ptr %0, ptr %i.vi, align 8, !tbaa !103
  %i.vj = getelementptr inbounds nuw i8, ptr %i.vh, i64 216
  %i.vk = trunc nuw nsw i64 %indvars.iv to i32
  store i32 %i.vk, ptr %i.vj, align 8, !tbaa !105
  %i.vl = getelementptr inbounds nuw i8, ptr %i.vh, i64 16
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(96) %i.vl, i8 0, i64 96, i1 false)
  %i.vm = load i32, ptr %i.ty, align 8, !tbaa !106 ; 2 uses
  %i.vn = getelementptr inbounds nuw i8, ptr %i.vh, i64 168 ; 2 uses
  store i32 %i.vm, ptr %i.vn, align 8, !tbaa !109
  %i.vo = getelementptr inbounds nuw i8, ptr %i.vh, i64 188 ; 2 uses
  store i32 %i.vm, ptr %i.vo, align 4, !tbaa !110
  %i.vp = load ptr, ptr %i.h, align 8, !tbaa !11  ; 2 uses
  %.not65 = icmp eq ptr %i.vp, null
...
bb.t:                                             ; preds = %_ZN20btAlignedObjectArrayI27btMultiBodySolverConstraintE21expandNonInitializingEv.exit
  %i.vq = getelementptr inbounds nuw i8, ptr %i.vp, i64 232
  %i.vr = load i32, ptr %i.vq, align 8, !tbaa !111
  store i32 %i.vr, ptr %i.vn, align 8, !tbaa !109
  br label %bb.u

bb.u:                                             ; preds = %bb.t, %_ZN20btAlignedObjectArrayI27btMultiBodySolverConstraintE21expandNonInitializingEv.exit
  %i.vs = load ptr, ptr %i.gz, align 8, !tbaa !24 ; 2 uses
  %.not66 = icmp eq ptr %i.vs, null
  br i1 %.not66, label %bb.w, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.vt = getelementptr inbounds nuw i8, ptr %i.vs, i64 232
  %i.vu = load i32, ptr %i.vt, align 8, !tbaa !111
  store i32 %i.vu, ptr %i.vo, align 4, !tbaa !110
  br label %bb.w
...
bb.w:                                             ; preds = %bb.v, %bb.u
  ...
  %i.vv = icmp samesign ult i64 %indvars.iv, 2
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %13, i8 0, i64 16, i1 false)
  br i1 %i.vv, label %bb.x, label %bb.y

bb.x:                                             ; preds = %bb.w
  %i.vw = getelementptr inbounds nuw [16 x i8], ptr %9, i64 %indvars.iv
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %12, ptr noundef nonnull align 16 dereferenceable(16) %i.vw, i64 16, i1 false), !tbaa.struct !25
  %i.vx = load float, ptr %4, align 8, !tbaa !30
  %i.vy = load float, ptr %7, align 8, !tbaa !30
  %i.vz = fsub float %i.vx, %i.vy
  %i.wa = load <2 x float>, ptr %i.ud, align 4, !tbaa !30
  %i.wb = load <2 x float>, ptr %i.ue, align 4, !tbaa !30
  %i.wc = fsub <2 x float> %i.wa, %i.wb           ; 2 uses
  %i.wd = load float, ptr %12, align 4, !tbaa !30
  %i.we = load float, ptr %i.tz, align 4, !tbaa !30
  %i.wf = extractelement <2 x float> %i.wc, i64 0
  %i.wg = fmul float %i.wf, %i.we
  %i.wh = call float @llvm.fmuladd.f32(float %i.vz, float %i.wd, float %i.wg)
  %i.wi = load float, ptr %i.ua, align 4, !tbaa !30
  %i.wj = extractelement <2 x float> %i.wc, i64 1
  %i.wk = call noundef float @llvm.fmuladd.f32(float %i.wj, float %i.wi, float %i.wh)
  %i.wl = load float, ptr %i.uc, align 4, !tbaa !112 ; 2 uses
  %i.wm = fneg float %i.wl
  %i.wn = call noundef float @_ZN21btMultiBodyConstraint23fillMultiBodyConstraintER27btMultiBodySolverConstraintR23btMultiBodyJacobianDataPfS4_RK9btVector3S7_S7_S7_fRK19btContactSolverInfoffbfbfff(ptr noundef nonnull align 8 dereferenceable(96) %0, ptr noundef nonnull align 8 dereferenceable(220) %i.vh, ptr noundef nonnull align 8 dereferenceable(204) %2, ptr noundef null, ptr noundef null, ptr noundef nonnull align 4 dereferenceable(16) %13, ptr noundef nonnull align 4 dereferenceable(16) %12, ptr noundef nonnull align 4 dereferenceable(16) %4, ptr noundef nonnull align 4 dereferenceable(16) %7, float noundef %i.wk, ptr noundef nonnull align 4 dereferenceable(128) %3, float noundef %i.wm, float noundef %i.wl, i1 noundef zeroext false, float noundef 1.000000e+00, i1 noundef zeroext false, float noundef 0.000000e+00, float noundef 0.000000e+00, float noundef 1.000000e+00) ; 0 uses
  br label %bb.z
...
bb.y:                                             ; preds = %bb.w
  ...
  %i.wo = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %16
  %i.wp = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %16
  %i.wq = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %16
  %i.wr = load float, ptr %i.wo, align 4, !tbaa !30
  %.sroa.0.0.vec.insert.i106 = insertelement <2 x float> poison, float %i.wr, i64 0
  %i.ws = load float, ptr %i.wp, align 4, !tbaa !30
  %.sroa.0.4.vec.insert.i107 = insertelement <2 x float> %.sroa.0.0.vec.insert.i106, float %i.ws, i64 1
  %i.wt = load float, ptr %i.wq, align 4, !tbaa !30
  %.sroa.3.12.vec.insert.i108 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.wt, i64 0
  store <2 x float> %.sroa.0.4.vec.insert.i107, ptr %13, align 8
  store <2 x float> %.sroa.3.12.vec.insert.i108, ptr %i.ub, align 8, !tbaa !26
  %i.wu = getelementptr inbounds nuw [4 x i8], ptr %11, i64 %16
  %i.wv = load float, ptr %i.wu, align 4, !tbaa !30
  %i.ww = load float, ptr %i.uc, align 4, !tbaa !112 ; 2 uses
  %i.wx = fneg float %i.ww
  %i.wy = call noundef float @_ZN21btMultiBodyConstraint23fillMultiBodyConstraintER27btMultiBodySolverConstraintR23btMultiBodyJacobianDataPfS4_RK9btVector3S7_S7_S7_fRK19btContactSolverInfoffbfbfff(ptr noundef nonnull align 8 dereferenceable(96) %0, ptr noundef nonnull align 8 dereferenceable(220) %i.vh, ptr noundef nonnull align 8 dereferenceable(204) %2, ptr noundef null, ptr noundef null, ptr noundef nonnull align 4 dereferenceable(16) %13, ptr noundef nonnull align 4 dereferenceable(16) %12, ptr noundef nonnull align 4 dereferenceable(16) %4, ptr noundef nonnull align 4 dereferenceable(16) %7, float noundef %i.wv, ptr noundef nonnull align 4 dereferenceable(128) %3, float noundef %i.wx, float noundef %i.ww, i1 noundef zeroext true, float noundef 1.000000e+00, i1 noundef zeroext false, float noundef 0.000000e+00, float noundef 0.000000e+00, float noundef 1.000000e+00) ; 0 uses
  br label %bb.z
