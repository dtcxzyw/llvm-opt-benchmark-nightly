...
bb.e:                                             ; preds = %bb.c, %bb.d, %bb.b
  %.sroa.0239.0 = phi <2 x float> [ %.sroa.0239.0.copyload, %bb.c ], [ %i.gs, %bb.d ], [ %i.fw, %bb.b ] ; 2 uses
  %.sroa.9244.0 = phi <2 x float> [ %.sroa.9244.0.copyload, %bb.c ], [ %i.gt, %bb.d ], [ %.sroa.3.12.vec.insert.i, %bb.b ]
...
.preheader:                                       ; preds = %bb.g, %bb.h, %bb.f
  ...
  %.sroa.9244.8.vec.extract = extractelement <2 x float> %.sroa.9244.0, i64 0 ; 6 uses
  %.sroa.0239.4.vec.extract = extractelement <2 x float> %.sroa.0239.0, i64 1 ; 6 uses
  %i.mm = fneg float %.sroa.0239.4.vec.extract    ; 3 uses
  %.sroa.0239.0.vec.extract = extractelement <2 x float> %.sroa.0239.0, i64 0 ; 6 uses
  %i.mn = fneg float %.sroa.9244.8.vec.extract    ; 3 uses
  %i.mo = fneg float %.sroa.0239.0.vec.extract    ; 3 uses
  %.sroa.430.0..sroa_idx = getelementptr inbounds nuw i8, ptr %9, i64 8 ; 2 uses
  %i.mp = load float, ptr %5, align 16, !tbaa !30 ; 7 uses
  %i.mq = load float, ptr %i.d, align 16, !tbaa !30 ; 6 uses
  %14 = load float, ptr %i.f, align 16, !tbaa !30 ; 5 uses
  %i.mr = fmul float %14, %i.mm
  %i.ms = call float @llvm.fmuladd.f32(float %i.mq, float %.sroa.9244.8.vec.extract, float %i.mr) ; 3 uses
  %15 = fmul float %i.mp, %i.mn
  %16 = call float @llvm.fmuladd.f32(float %14, float %.sroa.0239.0.vec.extract, float %15) ; 3 uses
  %i.mt = fmul float %i.mq, %i.mo
  %i.mu = call float @llvm.fmuladd.f32(float %i.mp, float %.sroa.0239.4.vec.extract, float %i.mt) ; 3 uses
  %i.mv = fmul float %16, %16
  %i.mw = call float @llvm.fmuladd.f32(float %i.ms, float %i.ms, float %i.mv)
  %i.mx = call noundef float @llvm.fmuladd.f32(float %i.mu, float %i.mu, float %i.mw) ; 2 uses
  ...
  %.phi.trans.insert258.phi.trans.insert = getelementptr inbounds nuw i8, ptr %5, i64 36 ; 2 uses
  br i1 %i.na, label %.preheader._crit_edge, label %bb.i

.preheader._crit_edge:                            ; preds = %.preheader
  %.sroa.3.12.vec.insert.i77 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.mu, i64 0
  %.sroa.0.0.vec.insert.i75 = insertelement <2 x float> poison, float %i.ms, i64 0
  %.sroa.0.4.vec.insert.i76 = insertelement <2 x float> %.sroa.0.0.vec.insert.i75, float %16, i64 1
  %.phi.trans.insert.phi.trans.insert = getelementptr inbounds nuw i8, ptr %5, i64 20
  %.pre.pre = load float, ptr %.phi.trans.insert.phi.trans.insert, align 4, !tbaa !30, !noalias !84
  %.pre.pre.a = load float, ptr %.phi.trans.insert258.phi.trans.insert, align 4, !tbaa !30, !noalias !84
...
bb.i:                                             ; preds = %.preheader
  ...
  %17 = load float, ptr %i.nb, align 4, !tbaa !30 ; 5 uses
  %i.nd = load float, ptr %i.nc, align 4, !tbaa !30 ; 5 uses
  %i.ne = load float, ptr %.phi.trans.insert258.phi.trans.insert, align 4, !tbaa !30 ; 5 uses
  %i.nf = fmul float %i.ne, %i.mm
  %i.ng = call float @llvm.fmuladd.f32(float %i.nd, float %.sroa.9244.8.vec.extract, float %i.nf) ; 3 uses
  %i.nh = fmul float %17, %i.mn
  %i.ni = call float @llvm.fmuladd.f32(float %i.ne, float %.sroa.0239.0.vec.extract, float %i.nh) ; 3 uses
  %i.nj = fmul float %i.nd, %i.mo
  %i.nk = call float @llvm.fmuladd.f32(float %17, float %.sroa.0239.4.vec.extract, float %i.nj) ; 3 uses
  ...
  %.sroa.3.12.vec.insert.i77.1 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.nk, i64 0
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.nu = load float, ptr %i.nr, align 8, !tbaa !30 ; 4 uses
  %i.nv = load float, ptr %i.ns, align 8, !tbaa !30 ; 4 uses
  %i.nw = load float, ptr %i.nt, align 8, !tbaa !30 ; 4 uses
  ...
  %18 = insertelement <4 x float> poison, float %i.nw, i64 0
  %19 = insertelement <4 x float> %18, float %i.ne, i64 1
  %20 = insertelement <4 x float> %19, float %i.nv, i64 2
  %21 = insertelement <4 x float> %20, float %i.nu, i64 3
  br i1 %i.oi, label %bb.k, label %.loopexit

bb.k:                                             ; preds = %.preheader._crit_edge, %bb.j, %bb.i
  %.pre261 = phi float [ %17, %bb.j ], [ %17, %bb.i ], [ %.pre261.pre, %.preheader._crit_edge ]
  %.pre.a = phi float [ %i.ne, %bb.j ], [ %i.ne, %bb.i ], [ %.pre.pre.a, %.preheader._crit_edge ]
  %.pre = phi float [ %i.nd, %bb.j ], [ %i.nd, %bb.i ], [ %.pre.pre, %.preheader._crit_edge ]
  %.sroa.8.0.copyload.i = phi <2 x float> [ %.sroa.3.12.vec.insert.i77.2, %bb.j ], [ %.sroa.3.12.vec.insert.i77.1, %bb.i ], [ %.sroa.3.12.vec.insert.i77, %.preheader._crit_edge ] ; 2 uses
  ...
  %22 = fmul float %.sroa.0.0.vec.extract.i, %i.om ; 3 uses
  %.sroa.0.0.vec.insert.i80 = insertelement <2 x float> poison, float %22, i64 0
  %i.on = fmul float %.sroa.0.4.vec.extract.i, %i.om ; 3 uses
  %.sroa.0.0.vec.insert.i80.a = insertelement <2 x float> %.sroa.0.0.vec.insert.i80, float %i.on, i64 1
  %i.oo = fmul float %.sroa.8.8.vec.extract.i, %i.om ; 3 uses
  %.sroa.0.4.vec.insert.i81 = insertelement <2 x float> %.sroa.8.0.copyload.i, float %i.oo, i64 0
  store <2 x float> %.sroa.0.0.vec.insert.i80.a, ptr %9, align 16
  store <2 x float> %.sroa.0.4.vec.insert.i81, ptr %.sroa.430.0..sroa_idx, align 8, !tbaa !26
  %23 = fneg float %i.on
  %24 = fmul float %.sroa.9244.8.vec.extract, %23
  %25 = call float @llvm.fmuladd.f32(float %.sroa.0239.4.vec.extract, float %i.oo, float %24) ; 3 uses
  %26 = fneg float %i.oo
  %27 = fmul float %.sroa.0239.0.vec.extract, %26
  %28 = call float @llvm.fmuladd.f32(float %.sroa.9244.8.vec.extract, float %22, float %27) ; 3 uses
  %i.op = fneg float %22
  %i.oq = fmul float %.sroa.0239.4.vec.extract, %i.op
  %i.or = call float @llvm.fmuladd.f32(float %.sroa.0239.0.vec.extract, float %i.on, float %i.oq) ; 3 uses
  %29 = getelementptr inbounds nuw i8, ptr %9, i64 16
  %.sroa.426.0..sroa_idx = getelementptr inbounds nuw i8, ptr %9, i64 24
  %30 = fmul float %28, %28
  %i.os = call float @llvm.fmuladd.f32(float %25, float %25, float %30)
  ...
  %i.ou = fdiv float 1.000000e+00, %sqrt.i.i.i95  ; 3 uses
  %31 = fmul float %25, %i.ou
  %i.ov = insertelement <2 x float> poison, float %31, i64 0
  %32 = fmul float %28, %i.ou
  %.sroa.0.4.vec.insert.i97 = insertelement <2 x float> %i.ov, float %32, i64 1
  ...
  store <2 x float> %.sroa.0.4.vec.insert.i97, ptr %29, align 16
  ...
  %.pre255 = load float, ptr %.phi.trans.insert254, align 8, !tbaa !30, !noalias !84 ; 2 uses
  %.phi.trans.insert256 = getelementptr inbounds nuw i8, ptr %5, i64 24
  %.pre257 = load float, ptr %.phi.trans.insert256, align 8, !tbaa !30, !noalias !84 ; 2 uses
  %.phi.trans.insert262 = getelementptr inbounds nuw i8, ptr %5, i64 8
  %.pre263 = load float, ptr %.phi.trans.insert262, align 8, !tbaa !30, !noalias !84 ; 2 uses
  %33 = insertelement <4 x float> poison, float %.pre255, i64 0
  %34 = insertelement <4 x float> %33, float %.pre.a, i64 1
  %35 = insertelement <4 x float> %34, float %.pre257, i64 2
  %36 = insertelement <4 x float> %35, float %.pre263, i64 3
  br label %.loopexit

.loopexit:                                        ; preds = %bb.j, %bb.k
  %i.ox = phi float [ %.pre263, %bb.k ], [ %i.nu, %bb.j ] ; 4 uses
  %i.oy = phi float [ %.pre261, %bb.k ], [ %17, %bb.j ] ; 5 uses
  %i.oz = phi float [ %.pre257, %bb.k ], [ %i.nv, %bb.j ] ; 2 uses
  %i.pa = phi float [ %.pre255, %bb.k ], [ %i.nw, %bb.j ]
  %i.pb = phi float [ %.pre, %bb.k ], [ %i.nd, %bb.j ] ; 4 uses
  %37 = phi <4 x float> [ %36, %bb.k ], [ %21, %bb.j ] ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %10) #13
  %38 = shufflevector <4 x float> %37, <4 x float> poison, <4 x i32> <i32 1, i32 poison, i32 0, i32 0>
  %i.pc = insertelement <4 x float> %38, float %14, i64 1
  %i.pd = fneg <4 x float> %i.pc                  ; 3 uses
  %i.pe = insertelement <4 x float> poison, float %i.mq, i64 2
  %39 = shufflevector <4 x float> %i.pe, <4 x float> %37, <4 x i32> <i32 6, i32 poison, i32 2, i32 poison>
  %i.pf = insertelement <4 x float> %39, float %i.pb, i64 1
  %i.pg = insertelement <4 x float> %i.pf, float %i.oy, i64 3
  %i.ph = fmul <4 x float> %i.pg, %i.pd
  %40 = insertelement <4 x float> poison, float %i.pb, i64 0
  %i.pi = insertelement <4 x float> %40, float %i.mq, i64 1
  %i.pj = insertelement <4 x float> %i.pi, float %14, i64 2
  %41 = shufflevector <4 x float> %i.pj, <4 x float> %37, <4 x i32> <i32 0, i32 1, i32 2, i32 5>
  %i.pk = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %37, <4 x float> %41, <4 x float> %i.ph) ; 4 uses
  ...
  %i.ql = call noundef float @llvm.fmuladd.f32(float %i.oy, float %14, float %i.qk)
