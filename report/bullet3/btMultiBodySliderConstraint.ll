...
bb.y:                                             ; preds = %bb.w
  ...
  %i.wn = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %16
  %i.wo = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %16
  %i.wp = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %16
  ...
  %i.wt = getelementptr inbounds nuw [4 x i8], ptr %11, i64 %16
