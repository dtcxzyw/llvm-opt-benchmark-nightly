...
bb.a:
  ...
  %.sroa.49.0..sroa_idx = getelementptr inbounds nuw i8, ptr %4, i64 8 ; 2 uses
  ...
  %.sroa.45.0..sroa_idx = getelementptr inbounds nuw i8, ptr %7, i64 8 ; 2 uses
...
bb.r:                                             ; preds = %bb.q
  ...
  %14 = load <2 x float>, ptr %i.bb, align 4, !tbaa !30
  %15 = load <2 x float>, ptr %i.bc, align 4, !tbaa !30
  %16 = fsub <2 x float> %14, %15                 ; 2 uses
  %i.qj = load float, ptr %12, align 4, !tbaa !30
  %i.qk = load float, ptr %i.ax, align 4, !tbaa !30
  %17 = extractelement <2 x float> %16, i64 0
  %i.ql = fmul float %17, %i.qk
  %i.qm = call float @llvm.fmuladd.f32(float %i.qi, float %i.qj, float %i.ql)
