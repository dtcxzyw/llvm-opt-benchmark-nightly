...
bb.a:
  ...
  %.pre177 = load float, ptr %1, align 8, !tbaa !26 ; 11 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %5 = load float, ptr %i.dz, align 8, !tbaa !26  ; 4 uses
  %6 = getelementptr inbounds nuw i8, ptr %0, i64 636
  %7 = getelementptr inbounds nuw i8, ptr %0, i64 640
  %i.eg = load float, ptr %7, align 8, !tbaa !26  ; 4 uses
  %i.eh = load float, ptr %6, align 4, !tbaa !26  ; 4 uses
  %8 = fsub float %3, %i.eg                       ; 4 uses
  %i.ei = load float, ptr %4, align 8, !tbaa !26  ; 3 uses
  %i.ej = fsub float %i.ei, %i.ef                 ; 2 uses
  %i.ek = fsub float %.pre177, %5                 ; 4 uses
  %i.el = fsub float %2, %i.eh                    ; 4 uses
  %i.em = fneg float %i.ej
  %i.en = fmul float %i.ek, %i.em
  %i.eo = load <2 x float>, ptr %i.dy, align 8, !tbaa !26 ; 4 uses
  %i.ep = load float, ptr %i.ed, align 4, !tbaa !26 ; 3 uses
  %i.eq = load <2 x float>, ptr %i.dx, align 8, !tbaa !26 ; 4 uses
  %i.er = load float, ptr %i.eb, align 4, !tbaa !26 ; 2 uses
  %9 = shufflevector <2 x float> %i.eq, <2 x float> %i.eo, <2 x i32> <i32 0, i32 2> ; 2 uses
  %10 = insertelement <2 x float> poison, float %5, i64 0
  %11 = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer
  %i.es = fsub <2 x float> %9, %11                ; 4 uses
  %i.et = insertelement <2 x float> poison, float %3, i64 0
  ...
  %i.ew = insertelement <2 x float> %i.ev, float %i.ei, i64 1 ; 2 uses
  %i.ex = fsub <2 x float> %i.eu, %i.ew           ; 4 uses
  %12 = shufflevector <2 x float> %i.eo, <2 x float> %i.eq, <2 x i32> <i32 1, i32 3> ; 2 uses
  ...
  %i.fa = fsub <2 x float> %12, %i.ez             ; 3 uses
  %13 = shufflevector <2 x float> %i.fa, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %14 = insertelement <2 x float> poison, float %i.eg, i64 0
  %15 = shufflevector <2 x float> %i.ew, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %16 = shufflevector <2 x float> %14, <2 x float> poison, <2 x i32> zeroinitializer
  %17 = fsub <2 x float> %15, %16                 ; 4 uses
  %18 = insertelement <2 x float> poison, float %2, i64 0
  %i.fb = shufflevector <2 x float> %18, <2 x float> poison, <2 x i32> zeroinitializer
  %i.fc = fsub <2 x float> %i.fb, %12             ; 4 uses
  %i.fd = extractelement <2 x float> %i.eo, i64 0 ; 2 uses
  %foldExtExtBinop = fsub <2 x float> %i.eq, %i.eo
  %i.fe = extractelement <2 x float> %foldExtExtBinop, i64 0 ; 2 uses
  %i.ff = fsub float %i.er, %i.ep                 ; 2 uses
  ...
  %i.fi = fsub <2 x float> %i.fh, %9              ; 3 uses
  %i.fj = shufflevector <2 x float> %i.fi, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.fk = fneg <2 x float> %13                    ; 3 uses
  %i.fl = fmul <2 x float> %i.ex, %i.fk
  %i.fm = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.fc, <2 x float> %17, <2 x float> %i.fl) ; 2 uses
  %i.fn = fneg <2 x float> %17                    ; 3 uses
  %i.fo = fmul <2 x float> %i.fj, %i.fn
  %i.fp = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ex, <2 x float> %i.es, <2 x float> %i.fo) ; 2 uses
  %i.fq = fneg <2 x float> %i.es                  ; 3 uses
  %i.fr = fmul <2 x float> %i.fc, %i.fq
  %i.fs = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.fj, <2 x float> %13, <2 x float> %i.fr) ; 2 uses
  ...
  %i.gl = extractelement <2 x float> %i.fa, i64 0
  %i.gm = extractelement <2 x float> %i.fc, i64 0
  %i.gn = extractelement <2 x float> %i.fq, i64 1
  %i.go = extractelement <2 x float> %i.es, i64 1
  %i.gp = extractelement <2 x float> %17, i64 1
...
._crit_edge156:                                   ; preds = %bb.f
  %i.gt = extractelement <2 x float> %i.eq, i64 0
  ...
  %.pre158.a = load float, ptr %.phi.trans.insert157, align 8, !tbaa !26 ; 3 uses
  %.pre302 = fsub float %.pre158.a, %5            ; 2 uses
  %.pre281 = fsub float %.pre177, %.pre158.a
  %.pre162 = load float, ptr %.phi.trans.insert161, align 8, !tbaa !26 ; 3 uses
  %.pre160 = load float, ptr %.phi.trans.insert159, align 4, !tbaa !26 ; 3 uses
  %.pre285.a = fsub float %3, %.pre162
  %.pre304 = fsub float %.pre160, %i.eh           ; 2 uses
  %.pre283.a = fsub float %2, %.pre160
  %.pre306 = fsub float %.pre162, %i.eg           ; 2 uses
  %.pre314 = fneg float %.pre304
  %.pre316 = fneg float %.pre306
  %.pre318 = fneg float %.pre302
  %i.gu = insertelement <2 x float> %i.ex, float %.pre285.a, i64 0
  %19 = extractelement <2 x float> %i.fi, i64 0
  %20 = extractelement <2 x float> %i.fa, i64 1
  %i.gv = extractelement <2 x float> %i.fc, i64 1
  %i.gw = extractelement <2 x float> %i.fq, i64 0
  %i.gx = extractelement <2 x float> %i.es, i64 0
  %i.gy = extractelement <2 x float> %17, i64 0
...
bb.g:                                             ; preds = %._crit_edge, %bb.f
  ...
  %i.hb = phi float [ %.pre155, %._crit_edge ], [ %i.eg, %bb.f ] ; 2 uses
  %i.hc = phi float [ %.pre153, %._crit_edge ], [ %i.eh, %bb.f ] ; 2 uses
  %i.hd = phi float [ %.pre151, %._crit_edge ], [ %5, %bb.f ] ; 2 uses
  %i.he = phi float [ %.pre149, %._crit_edge ], [ %i.ef, %bb.f ] ; 3 uses
  %i.hf = phi float [ %.pre147, %._crit_edge ], [ %i.ep, %bb.f ] ; 3 uses
  %i.hg = phi float [ %.pre145, %._crit_edge ], [ %i.fd, %bb.f ] ; 3 uses
  %i.hh = phi float [ %.pre143, %._crit_edge ], [ %3, %bb.f ] ; 2 uses
  %i.hi = phi float [ %.pre141, %._crit_edge ], [ %2, %bb.f ] ; 3 uses
  ...
  %.pre174 = load float, ptr %.phi.trans.insert173, align 4, !tbaa !26 ; 5 uses
  %.phi.trans.insert175 = getelementptr inbounds nuw i8, ptr %0, i64 224
  %.pre176 = load float, ptr %.phi.trans.insert175, align 8, !tbaa !26 ; 5 uses
  %21 = insertelement <2 x float> poison, float %i.hh, i64 0
  %22 = shufflevector <2 x float> %21, <2 x float> poison, <2 x i32> zeroinitializer
  %.pre263 = fsub float %.pre177, %.pre172        ; 2 uses
  %23 = load float, ptr %i.hj, align 8, !tbaa !26 ; 5 uses
  %i.hm = fsub float %23, %i.hd                   ; 3 uses
  %24 = fsub float %23, %i.hg                     ; 3 uses
  %i.hn = load float, ptr %i.hl, align 8, !tbaa !26 ; 5 uses
  %25 = load float, ptr %i.hk, align 4, !tbaa !26 ; 5 uses
  %26 = fsub float %i.hn, %i.he                   ; 3 uses
  %27 = fneg float %26                            ; 2 uses
  %i.ho = insertelement <2 x float> poison, float %i.hn, i64 0
  %28 = insertelement <2 x float> %i.ho, float %.pre176, i64 1
  %29 = fsub <2 x float> %22, %28                 ; 3 uses
  %30 = extractelement <2 x float> %29, i64 0     ; 2 uses
  %31 = fsub float %i.hi, %25                     ; 4 uses
  %32 = fsub float %i.hn, %i.hb                   ; 3 uses
  %33 = fneg float %32                            ; 2 uses
  %.pre265 = fsub float %i.hi, %.pre174           ; 2 uses
  %34 = fsub float %.pre177, %23                  ; 4 uses
  %35 = fsub float %25, %i.hc                     ; 3 uses
  %i.hp = fmul float %31, %.pre-phi259
  %i.hq = tail call float @llvm.fmuladd.f32(float %34, float %.pre-phi251, float %i.hp) ; 2 uses
  %i.hr = fneg float %35                          ; 2 uses
  %i.hs = fneg float %i.hm                        ; 2 uses
  %i.ht = fmul float %.pre-phi239, %i.hs
  %i.hu = tail call float @llvm.fmuladd.f32(float %.pre-phi237, float %35, float %i.ht) ; 2 uses
  %i.hv = fsub float %25, %i.hf                   ; 3 uses
  %i.hw = fneg float %i.hv                        ; 2 uses
  %i.hx = fmul float %.pre-phi247, %i.hw
  %i.hy = fmul float %.pre-phi241, %i.hr
  %i.hz = fmul float %30, %.pre-phi255
  %i.ia = tail call float @llvm.fmuladd.f32(float %.pre-phi245, float %26, float %i.hx)
  %i.ib = tail call float @llvm.fmuladd.f32(float %.pre-phi239, float %32, float %i.hy)
  %i.ic = tail call float @llvm.fmuladd.f32(float %31, float %.pre-phi253, float %i.hz)
  %i.id = fneg float %24                          ; 2 uses
  %i.ie = fmul float %.pre-phi243, %27
  %i.if = fmul float %.pre-phi237, %33
  %i.ig = fmul float %34, %.pre-phi257
  %i.ih = tail call float @llvm.fmuladd.f32(float %.pre-phi247, float %24, float %i.ie) ; 2 uses
  %i.ii = tail call float @llvm.fmuladd.f32(float %.pre-phi241, float %i.hm, float %i.if) ; 2 uses
  %i.ij = tail call float @llvm.fmuladd.f32(float %30, float %.pre-phi249, float %i.ig) ; 2 uses
...
._crit_edge170:                                   ; preds = %bb.g
  %.pre269 = fsub float %23, %.pre172             ; 2 uses
  %.pre271 = fsub float %25, %.pre174             ; 2 uses
  %.pre273 = fsub float %i.hn, %.pre176           ; 2 uses
...
._crit_edge163:                                   ; preds = %bb.g
  ...
  %.pre298 = fsub float %.pre174, %i.hc           ; 2 uses
  %.pre300 = fsub float %.pre176, %i.hb           ; 2 uses
...
bb.h:                                             ; preds = %._crit_edge163, %._crit_edge156
  ...
  %.pre-phi317 = phi float [ %33, %._crit_edge163 ], [ %.pre316, %._crit_edge156 ]
  ...
  %.pre-phi307 = phi float [ %32, %._crit_edge163 ], [ %.pre306, %._crit_edge156 ]
  %.pre-phi305 = phi float [ %35, %._crit_edge163 ], [ %.pre304, %._crit_edge156 ]
  %.pre-phi303 = phi float [ %i.hm, %._crit_edge163 ], [ %.pre302, %._crit_edge156 ]
  %.pre-phi301 = phi float [ %.pre300, %._crit_edge163 ], [ %i.gy, %._crit_edge156 ]
  %.pre-phi299 = phi float [ %.pre298, %._crit_edge163 ], [ %20, %._crit_edge156 ]
  ...
  %.pre-phi290 = phi float [ %.pre265, %._crit_edge163 ], [ %i.gv, %._crit_edge156 ] ; 3 uses
  %.pre-phi288 = phi float [ %.pre263, %._crit_edge163 ], [ %19, %._crit_edge156 ] ; 3 uses
  %.pre-phi284 = phi float [ %31, %._crit_edge163 ], [ %.pre283.a, %._crit_edge156 ] ; 3 uses
  %.pre-phi282 = phi float [ %34, %._crit_edge163 ], [ %.pre281, %._crit_edge156 ] ; 3 uses
  %i.jh = phi float [ %i.he, %._crit_edge163 ], [ %i.ef, %._crit_edge156 ] ; 3 uses
  %i.ji = phi float [ %i.hf, %._crit_edge163 ], [ %i.ep, %._crit_edge156 ] ; 3 uses
  %i.jj = phi float [ %i.hg, %._crit_edge163 ], [ %i.fd, %._crit_edge156 ] ; 3 uses
  %i.jk = phi float [ %.pre176, %._crit_edge163 ], [ %i.ei, %._crit_edge156 ] ; 2 uses
  %i.jl = phi float [ %.pre174, %._crit_edge163 ], [ %i.er, %._crit_edge156 ] ; 2 uses
  %i.jm = phi float [ %.pre172, %._crit_edge163 ], [ %i.gt, %._crit_edge156 ] ; 2 uses
  %i.jn = phi float [ %i.hn, %._crit_edge163 ], [ %.pre162, %._crit_edge156 ] ; 2 uses
  %i.jo = phi float [ %i.hh, %._crit_edge163 ], [ %3, %._crit_edge156 ]
  %i.jp = phi float [ %25, %._crit_edge163 ], [ %.pre160, %._crit_edge156 ] ; 2 uses
  %i.jq = phi float [ %i.hi, %._crit_edge163 ], [ %2, %._crit_edge156 ]
  %i.jr = phi float [ %23, %._crit_edge163 ], [ %.pre158.a, %._crit_edge156 ] ; 2 uses
  ...
  %i.js = phi <2 x float> [ %29, %._crit_edge163 ], [ %i.gu, %._crit_edge156 ] ; 3 uses
  %36 = fsub float %i.jr, %i.jm                   ; 3 uses
  %37 = fsub float %i.jp, %i.jl                   ; 3 uses
  %i.jt = fsub float %i.jn, %i.jk                 ; 3 uses
  %38 = insertelement <2 x float> poison, float %.pre-phi309, i64 0
  %39 = insertelement <2 x float> %38, float %.pre-phi315, i64 1
  %40 = fmul <2 x float> %i.js, %39
  %i.ju = fmul float %.pre-phi282, %.pre-phi311
  %41 = insertelement <2 x float> poison, float %.pre-phi290, i64 0
  %42 = insertelement <2 x float> %41, float %.pre-phi284, i64 1
  %43 = insertelement <2 x float> poison, float %.pre-phi319, i64 0
  %44 = insertelement <2 x float> %43, float %.pre-phi313, i64 1
  %45 = fmul <2 x float> %42, %44
  %46 = fmul float %.pre-phi288, %.pre-phi317
  %i.jv = fneg float %37                          ; 2 uses
  %i.jw = fmul float %.pre-phi295, %i.jv
  %i.jx = tail call float @llvm.fmuladd.f32(float %.pre-phi294, float %i.jt, float %i.jw) ; 2 uses
  %47 = fneg float %i.jt                          ; 2 uses
  %48 = fmul float %.pre-phi293, %47
  %49 = tail call float @llvm.fmuladd.f32(float %.pre-phi295, float %36, float %48) ; 2 uses
  %50 = fneg float %36                            ; 2 uses
  %51 = fmul float %.pre-phi294, %50
  %52 = tail call float @llvm.fmuladd.f32(float %.pre-phi293, float %37, float %51) ; 2 uses
  %i.jy = insertelement <2 x float> poison, float %.pre-phi284, i64 0
  %i.jz = insertelement <2 x float> %i.jy, float %.pre-phi307, i64 1
  %i.ka = insertelement <2 x float> poison, float %.pre-phi301, i64 0
  %53 = insertelement <2 x float> %i.ka, float %.pre-phi290, i64 1
  %54 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.jz, <2 x float> %53, <2 x float> %40)
  %55 = shufflevector <2 x float> %i.js, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.kb = insertelement <2 x float> poison, float %.pre-phi303, i64 0
  %i.kc = insertelement <2 x float> %i.kb, float %.pre-phi297, i64 1
  %i.kd = insertelement <2 x float> poison, float %46, i64 0
  %i.ke = insertelement <2 x float> %i.kd, float %i.ju, i64 1
  %i.kf = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %55, <2 x float> %i.kc, <2 x float> %i.ke) ; 2 uses
  %i.kg = insertelement <2 x float> poison, float %.pre-phi305, i64 0
  %i.kh = insertelement <2 x float> %i.kg, float %.pre-phi282, i64 1
  %i.ki = insertelement <2 x float> poison, float %.pre-phi288, i64 0
  %i.kj = insertelement <2 x float> %i.ki, float %.pre-phi299, i64 1
  %56 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.kh, <2 x float> %i.kj, <2 x float> %45) ; 2 uses
  %57 = fmul <2 x float> %i.kf, %i.kf
  %58 = shufflevector <2 x float> %54, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.kk = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %58, <2 x float> %58, <2 x float> %57)
  %i.kl = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %56, <2 x float> %56, <2 x float> %i.kk) ; 2 uses
  ...
  %i.kp = fmul float %49, %49
  %i.kq = tail call float @llvm.fmuladd.f32(float %i.jx, float %i.jx, float %i.kp)
  %i.kr = tail call noundef float @llvm.fmuladd.f32(float %52, float %52, float %i.kq) ; 2 uses
...
bb.i:                                             ; preds = %._crit_edge320, %._crit_edge170
  ...
  %.pre-phi336 = phi float [ %.pre335, %._crit_edge320 ], [ %27, %._crit_edge170 ]
  %.pre-phi334 = phi float [ %.pre333, %._crit_edge320 ], [ %i.hw, %._crit_edge170 ]
  %.pre-phi332 = phi float [ %.pre331, %._crit_edge320 ], [ %26, %._crit_edge170 ]
  %.pre-phi330 = phi float [ %.pre329, %._crit_edge320 ], [ %i.hv, %._crit_edge170 ]
  %.pre-phi328 = phi float [ %.pre327, %._crit_edge320 ], [ %24, %._crit_edge170 ]
  ...
  %.pre-phi280 = phi float [ %50, %._crit_edge320 ], [ %.pre279, %._crit_edge170 ]
  %.pre-phi278 = phi float [ %47, %._crit_edge320 ], [ %.pre277, %._crit_edge170 ]
  %.pre-phi276 = phi float [ %i.jv, %._crit_edge320 ], [ %.pre275, %._crit_edge170 ]
  %.pre-phi274 = phi float [ %i.jt, %._crit_edge320 ], [ %.pre273, %._crit_edge170 ]
  %.pre-phi272.a = phi float [ %37, %._crit_edge320 ], [ %.pre271, %._crit_edge170 ]
  %.pre-phi270.a = phi float [ %36, %._crit_edge320 ], [ %.pre269, %._crit_edge170 ]
  ...
  %.pre-phi261 = phi float [ %.pre-phi284, %._crit_edge320 ], [ %31, %._crit_edge170 ]
  %.pre-phi260 = phi float [ %.pre-phi282, %._crit_edge320 ], [ %34, %._crit_edge170 ]
  ...
  %i.kw = phi float [ %i.jk, %._crit_edge320 ], [ %.pre176, %._crit_edge170 ]
  %i.kx = phi float [ %i.jl, %._crit_edge320 ], [ %.pre174, %._crit_edge170 ]
  ...
  %i.kz = phi <2 x float> [ %i.js, %._crit_edge320 ], [ %29, %._crit_edge170 ] ; 2 uses
  ...
  %i.lg = fmul float %.pre-phi326, %.pre-phi276
  %i.lh = tail call float @llvm.fmuladd.f32(float %.pre-phi324, float %.pre-phi274, float %i.lg) ; 2 uses
  %i.li = fmul float %.pre-phi322, %.pre-phi278
  %i.lj = tail call float @llvm.fmuladd.f32(float %.pre-phi326, float %.pre-phi270.a, float %i.li) ; 2 uses
  %i.lk = fmul float %.pre-phi324, %.pre-phi280
  %i.ll = tail call float @llvm.fmuladd.f32(float %.pre-phi322, float %.pre-phi272.a, float %i.lk) ; 2 uses
  ...
  %59 = insertelement <2 x float> poison, float %.pre-phi261, i64 0
  %60 = insertelement <2 x float> %59, float %.pre-phi266, i64 1 ; 2 uses
  %i.lp = insertelement <2 x float> poison, float %i.lc, i64 0
  %i.lq = insertelement <2 x float> %i.lp, float %.pre-phi332, i64 1
  %i.lr = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %60, <2 x float> %i.lq, <2 x float> %i.lo) ; 2 uses
  %61 = insertelement <2 x float> poison, float %.pre-phi260, i64 0
  %62 = insertelement <2 x float> %61, float %.pre-phi264, i64 1 ; 2 uses
  %i.ls = insertelement <2 x float> poison, float %i.le, i64 0
  %i.lt = insertelement <2 x float> %i.ls, float %.pre-phi336, i64 1
  %i.lu = fmul <2 x float> %62, %i.lt
  ...
  %i.ma = fmul <2 x float> %60, %i.lz
  %i.mb = insertelement <2 x float> poison, float %i.lb, i64 0
  %i.mc = insertelement <2 x float> %i.mb, float %.pre-phi330, i64 1
  %i.md = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %62, <2 x float> %i.mc, <2 x float> %i.ma) ; 2 uses
