...
bb.ah:                                            ; preds = %bb.p
  ...
  %i.kl = load <2 x float>, ptr %i.jd, align 4, !tbaa !57 ; 4 uses
  ...
  %36 = shufflevector <2 x float> %i.kl, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.lc = fmul <2 x float> %i.jg, %36
...
bb.r:                                             ; preds = %.loopexit251
  ...
  %i.ro = getelementptr inbounds nuw [48 x i8], ptr %i.rn, i64 %indvars.iv282 ; 3 uses
  %24 = getelementptr inbounds nuw i8, ptr %i.ro, i64 32
  %25 = getelementptr inbounds nuw i8, ptr %i.ro, i64 36
  ...
  %i.rv = fmul <3 x float> %i.ru, %i.rb           ; 6 uses
  ...
  %26 = extractelement <3 x float> %i.rv, i64 2   ; 2 uses
  %27 = extractelement <3 x float> %i.rv, i64 1   ; 2 uses
  %28 = extractelement <3 x float> %i.rv, i64 0   ; 2 uses
  %29 = load float, ptr %25, align 4, !tbaa !57
  %30 = load float, ptr %24, align 4, !tbaa !57
  %31 = load float, ptr %i.rp, align 4, !tbaa !57
  %i.rz = call noundef ptr %i.rs(ptr noundef nonnull align 8 dereferenceable(121) %0) ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %12) #21
  %i.sa = load float, ptr %i.mm, align 4, !tbaa !57 ; 2 uses
  %i.sb = load float, ptr %i.mp, align 4, !tbaa !57 ; 2 uses
  %i.sc = load float, ptr %i.mq, align 4, !tbaa !57 ; 2 uses
  ...
  %32 = fmul float %26, %i.sb
  %33 = call float @llvm.fmuladd.f32(float %27, float %i.sa, float %32)
  %34 = call noundef float @llvm.fmuladd.f32(float %28, float %i.sc, float %33)
  %35 = load <2 x float>, ptr %i.mr, align 4, !tbaa !57 ; 2 uses
  %36 = fadd <2 x float> %i.sm, %35
  %37 = load float, ptr %i.ms, align 4, !tbaa !57 ; 2 uses
  %38 = fadd float %34, %37
  %.sroa.3.12.vec.insert.i4.i.i175 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %38, i64 0
  store <2 x float> %36, ptr %12, align 8
  store <2 x float> %.sroa.3.12.vec.insert.i4.i.i175, ptr %i.mv, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %13) #21
  %39 = fadd float %26, %29                       ; 2 uses
  %40 = fadd float %27, %30                       ; 2 uses
  %41 = fadd float %28, %31                       ; 2 uses
  %i.sn = insertelement <2 x float> poison, float %39, i64 0
  %i.so = shufflevector <2 x float> %i.sn, <2 x float> poison, <2 x i32> zeroinitializer
  %42 = shufflevector <2 x float> %i.se, <2 x float> %i.sg, <2 x i32> <i32 0, i32 2>
  %43 = fmul <2 x float> %i.so, %42
  %i.sp = insertelement <2 x float> poison, float %40, i64 0
  %i.sq = shufflevector <2 x float> %i.sp, <2 x float> poison, <2 x i32> zeroinitializer
  %i.sr = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.sq, <2 x float> %i.sj, <2 x float> %43)
  %i.ss = insertelement <2 x float> poison, float %41, i64 0
  %i.st = shufflevector <2 x float> %i.ss, <2 x float> poison, <2 x i32> zeroinitializer
  %i.su = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.st, <2 x float> %i.sl, <2 x float> %i.sr)
  %44 = fmul float %39, %i.sb
  %45 = call float @llvm.fmuladd.f32(float %40, float %i.sa, float %44)
  %46 = call noundef float @llvm.fmuladd.f32(float %41, float %i.sc, float %45)
  %47 = fadd <2 x float> %i.su, %35
  %48 = fadd float %46, %37
  %.sroa.3.12.vec.insert.i4.i.i185 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %48, i64 0
  store <2 x float> %47, ptr %13, align 8
  store <2 x float> %.sroa.3.12.vec.insert.i4.i.i185, ptr %i.mw, align 8
