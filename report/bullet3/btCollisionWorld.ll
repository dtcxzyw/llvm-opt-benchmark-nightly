...
.preheader:                                       ; preds = %bb.a
  ...
  %foldExtExtBinop130 = fmul <2 x float> %i.m, %i.m
  %i.n = extractelement <2 x float> %foldExtExtBinop130, i64 1
...
bb.b:                                             ; preds = %.preheader, %_Z10btRayAabb2RK9btVector3S1_PKjPS0_Rfff.exit.thread
  ...
  %.024 = phi i32 [ %.2, %_Z10btRayAabb2RK9btVector3S1_PKjPS0_Rfff.exit.thread ], [ 126, %.preheader ] ; 6 uses
  %.0 = phi i32 [ %.1, %_Z10btRayAabb2RK9btVector3S1_PKjPS0_Rfff.exit.thread ], [ 1, %.preheader ] ; 3 uses
  %i.al = ptrtoaddr ptr %i.ak to i64
  %i.am = add nsw i32 %.0, -1                     ; 6 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %.052.i = select i1 %i.bm, float %i.bd, float %i.bf ; 3 uses
  ...
  %i.bt = fcmp ogt float %i.bp, %.052.i
...
_Z10btRayAabb2RK9btVector3S1_PKjPS0_Rfff.exit:    ; preds = %bb.c
  ...
  %i.bw = fcmp olt float %i.br, %.052.i
  %.1.i = select i1 %i.bw, float %i.br, float %.052.i
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load127 = load <2 x ptr>, ptr %i.cl, align 8, !tbaa !173
  %i.cm = getelementptr inbounds nuw i8, ptr %i.cj, i64 16
  store <2 x ptr> %wide.load, ptr %i.cj, align 8, !tbaa !173
  store <2 x ptr> %wide.load127, ptr %i.cm, align 8, !tbaa !173
...
bb.k:                                             ; preds = %.loopexit, %bb.e
  ...
  %.125 = phi i32 [ %i.dp, %.loopexit ], [ %.024, %bb.e ]
...
_Z10btRayAabb2RK9btVector3S1_PKjPS0_Rfff.exit.thread: ; preds = %bb.c, %bb.b, %bb.k, %bb.l, %_Z10btRayAabb2RK9btVector3S1_PKjPS0_Rfff.exit
  ...
  %.1 = phi i32 [ %i.ea, %bb.k ], [ %i.am, %bb.l ], [ %i.am, %_Z10btRayAabb2RK9btVector3S1_PKjPS0_Rfff.exit ], [ %i.am, %bb.b ], [ %i.am, %bb.c ] ; 2 uses
