...
bb.r:                                             ; preds = %.loopexit251
  ...
  %24 = load float, ptr %i.mq, align 4, !tbaa !74
  %25 = load float, ptr %i.mt, align 4, !tbaa !74
  %26 = load float, ptr %i.mu, align 4, !tbaa !74
  ...
  %27 = insertelement <2 x float> %i.sm, float %i.sz, i64 1
  %i.tr = insertelement <2 x float> poison, float %25, i64 0
  %i.ts = shufflevector <2 x float> %i.tr, <2 x float> poison, <2 x i32> zeroinitializer
  %i.tt = fmul <2 x float> %27, %i.ts
  %28 = insertelement <2 x float> %i.sq, float %i.sy, i64 1
  %i.tu = insertelement <2 x float> poison, float %24, i64 0
  %i.tv = shufflevector <2 x float> %i.tu, <2 x float> poison, <2 x i32> zeroinitializer
  %i.tw = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %28, <2 x float> %i.tv, <2 x float> %i.tt)
  %29 = insertelement <2 x float> %i.su, float %i.ta, i64 1
  %i.tx = insertelement <2 x float> poison, float %26, i64 0
  %i.ty = shufflevector <2 x float> %i.tx, <2 x float> poison, <2 x i32> zeroinitializer
  %i.tz = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %29, <2 x float> %i.ty, <2 x float> %i.tw)
...
bb.t:                                             ; preds = %.lr.ph270, %bb.t
  ...
  %30 = load float, ptr %i.nh, align 4, !tbaa !74
  %31 = load float, ptr %i.nk, align 4, !tbaa !74
  %32 = load float, ptr %i.nl, align 4, !tbaa !74
  ...
  %i.vk = shufflevector <2 x float> %33, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.vo = shufflevector <2 x float> %34, <2 x float> poison, <2 x i32> zeroinitializer
  %i.vp = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.vn, <2 x float> %i.vo, <2 x float> %i.vm)
  %35 = insertelement <2 x float> %i.up, float %i.ux, i64 1
  %i.vq = insertelement <2 x float> poison, float %32, i64 0
  %i.vr = shufflevector <2 x float> %i.vq, <2 x float> poison, <2 x i32> zeroinitializer
  %i.vs = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %35, <2 x float> %i.vr, <2 x float> %i.vp)
