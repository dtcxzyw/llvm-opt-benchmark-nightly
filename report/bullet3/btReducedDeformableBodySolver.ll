...
bb.f:                                             ; preds = %bb.f, %.lr.ph.i
  ...
  %i.aj = getelementptr inbounds nuw [16 x i8], ptr %i.ai, i64 %indvars.iv.i ; 3 uses
  %i.ak = load float, ptr %i.aj, align 4, !tbaa !68
  %i.al = fpext float %i.ak to double
  %i.am = getelementptr inbounds nuw i8, ptr %i.aj, i64 4
  %1 = load float, ptr %i.am, align 4, !tbaa !68
  %2 = fpext float %1 to double
  %3 = getelementptr inbounds nuw i8, ptr %i.aj, i64 8
  %4 = load float, ptr %3, align 4, !tbaa !68
  %5 = fpext float %4 to double
  %i.an = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef %i.ah, double noundef %i.al, double noundef %2, double noundef %5) ; 0 uses
...
bb.h:                                             ; preds = %bb.h, %.lr.ph.i30
  ...
  %i.bh = getelementptr inbounds nuw [16 x i8], ptr %i.bg, i64 %indvars.iv.i31 ; 3 uses
  %i.bi = load float, ptr %i.bh, align 4, !tbaa !68
  %i.bj = fpext float %i.bi to double
  %i.bk = getelementptr inbounds nuw i8, ptr %i.bh, i64 4
  %6 = load float, ptr %i.bk, align 4, !tbaa !68
  %7 = fpext float %6 to double
  %8 = getelementptr inbounds nuw i8, ptr %i.bh, i64 8
  %9 = load float, ptr %8, align 4, !tbaa !68
  %10 = fpext float %9 to double
  %i.bl = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef %i.bf, double noundef %i.bj, double noundef %7, double noundef %10) ; 0 uses
