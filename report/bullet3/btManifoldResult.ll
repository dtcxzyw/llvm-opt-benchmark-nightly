...
bb.b:                                             ; preds = %bb.a
  ...
  %6 = load <3 x float>, ptr %2, align 4, !tbaa !50 ; 3 uses
  %i.t = fadd <3 x float> %i.s, %6                ; 4 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c
  %.sink137 = phi ptr [ %i.cg, %bb.d ], [ %i.k, %bb.c ] ; 9 uses
  ...
  %7 = getelementptr inbounds nuw i8, ptr %.sink137, i64 8
  %8 = getelementptr inbounds nuw i8, ptr %.sink137, i64 56
  %i.ch = getelementptr inbounds nuw i8, ptr %.sink137, i64 60
  %i.ci = getelementptr inbounds nuw i8, ptr %.sink137, i64 64
  ...
  %9 = load float, ptr %i.cl, align 4, !tbaa !50, !noalias !53
  %10 = load float, ptr %i.cm, align 4, !tbaa !50, !noalias !53
  %11 = load float, ptr %i.cn, align 4, !tbaa !50, !noalias !53
  %i.co = load float, ptr %i.ch, align 4, !tbaa !50
  %i.cp = load float, ptr %8, align 4, !tbaa !50
  %i.cq = load float, ptr %i.ci, align 4, !tbaa !50
  %12 = fsub float %5, %i.co                      ; 2 uses
  %13 = extractelement <3 x float> %6, i64 0
  %14 = fsub float %13, %i.cp                     ; 2 uses
  %15 = extractelement <3 x float> %6, i64 2
  %16 = fsub float %15, %i.cq                     ; 2 uses
  %i.cr = load <2 x float>, ptr %7, align 4, !tbaa !50, !noalias !53
  ...
  %19 = fmul <2 x float> %18, %i.cs
  %20 = insertelement <2 x float> poison, float %14, i64 0
  %21 = shufflevector <2 x float> %20, <2 x float> poison, <2 x i32> zeroinitializer
  %i.cu = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cr, <2 x float> %21, <2 x float> %19)
  %22 = insertelement <2 x float> poison, float %16, i64 0
  %23 = shufflevector <2 x float> %22, <2 x float> poison, <2 x i32> zeroinitializer
  %24 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ct, <2 x float> %23, <2 x float> %i.cu)
  %25 = fmul float %12, %10
  %26 = tail call float @llvm.fmuladd.f32(float %9, float %14, float %25)
  %i.cv = tail call noundef float @llvm.fmuladd.f32(float %11, float %16, float %26)
  ...
  store <2 x float> %24, ptr %i.cw, align 8
