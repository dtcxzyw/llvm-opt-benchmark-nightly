...
_ZNK14b3QuantizedBvh10getAabbMinEi.exit.prol:     ; preds = %_ZNK14b3QuantizedBvh10getAabbMinEi.exit.preheader
  ...
  %.sroa.594.8.vec.extract.prol = load float, ptr %.sroa.3.0..sroa_idx.i.prol, align 8, !tbaa !41
  %.sroa.592.8.vec.extract.prol = load float, ptr %.sroa.3.0..sroa_idx.i18.prol, align 8, !tbaa !41
  %i.z = fadd float %.sroa.594.8.vec.extract.prol, %.sroa.592.8.vec.extract.prol
...
_ZNK14b3QuantizedBvh10getAabbMinEi.exit:          ; preds = %_ZNK14b3QuantizedBvh10getAabbMinEi.exit.prol.loopexit, %_ZNK14b3QuantizedBvh10getAabbMinEi.exit
  ...
  %.sroa.594.8.vec.extract = load float, ptr %.sroa.3.0..sroa_idx.i, align 8, !tbaa !41
  %.sroa.592.8.vec.extract = load float, ptr %.sroa.3.0..sroa_idx.i18, align 8, !tbaa !41
  %i.cb = fadd float %.sroa.594.8.vec.extract, %.sroa.592.8.vec.extract
  ...
  %.sroa.594.8.vec.extract.1 = load float, ptr %.sroa.3.0..sroa_idx.i.1, align 8, !tbaa !41
  %.sroa.592.8.vec.extract.1 = load float, ptr %.sroa.3.0..sroa_idx.i18.1, align 8, !tbaa !41
  %i.ck = fadd float %.sroa.594.8.vec.extract.1, %.sroa.592.8.vec.extract.1
...
_ZNK14b3QuantizedBvh10getAabbMinEi.exit45:        ; preds = %.lr.ph170.split, %_ZNK14b3QuantizedBvh10getAabbMinEi.exit45
  ...
  %.sroa.582.8.vec.extract = load float, ptr %.sroa.3.0..sroa_idx.i27, align 8, !tbaa !41
  %.sroa.5.8.vec.extract = load float, ptr %.sroa.3.0..sroa_idx.i37, align 8, !tbaa !41
  %i.fq = fadd float %.sroa.582.8.vec.extract, %.sroa.5.8.vec.extract
...
_ZNK14b3QuantizedBvh10getAabbMinEi.exit.prol:     ; preds = %_ZNK14b3QuantizedBvh10getAabbMinEi.exit.preheader
  ...
  %.sroa.589.8.vec.extract.prol = load float, ptr %.sroa.3.0..sroa_idx.i.prol, align 8, !tbaa !41
  %.sroa.587.8.vec.extract.prol = load float, ptr %.sroa.3.0..sroa_idx.i41.prol, align 8, !tbaa !41
  %i.w = fadd float %.sroa.589.8.vec.extract.prol, %.sroa.587.8.vec.extract.prol
...
_ZNK14b3QuantizedBvh10getAabbMinEi.exit:          ; preds = %_ZNK14b3QuantizedBvh10getAabbMinEi.exit.prol.loopexit, %_ZNK14b3QuantizedBvh10getAabbMinEi.exit
  ...
  %.sroa.589.8.vec.extract = load float, ptr %.sroa.3.0..sroa_idx.i, align 8, !tbaa !41
  %.sroa.587.8.vec.extract = load float, ptr %.sroa.3.0..sroa_idx.i41, align 8, !tbaa !41
  ...
  %.sroa.589.8.vec.extract.1 = load float, ptr %.sroa.3.0..sroa_idx.i.1, align 8, !tbaa !41
  %.sroa.587.8.vec.extract.1 = load float, ptr %.sroa.3.0..sroa_idx.i41.1, align 8, !tbaa !41
