...
_Z8b3SetMinIfEvRT_RKS0_.exit.i:
  ...
  %i.ax = shufflevector <4 x float> %8, <4 x float> %i.aw, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
...
bb.c:                                             ; preds = %bb.b
  ...
  %9 = load <4 x float>, ptr %i.ak, align 8
  %i.eq = shufflevector <4 x float> %9, <4 x float> poison, <2 x i32> zeroinitializer
  %i.er = fdiv <2 x float> %i.ep, %i.eq
  %10 = load <4 x float>, ptr %i.ah, align 8
  %i.es = shufflevector <4 x float> %10, <4 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.ev = insertelement <2 x float> %12, float %i.eu, i64 1
