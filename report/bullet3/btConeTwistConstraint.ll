...
bb.al:                                            ; preds = %bb.ae
  store float 0.000000e+00, ptr %i.ajn, align 8, !tbaa !70
  br label %bb.am
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !41, !nonnull !37, !align !42 ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 48
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !43, !nonnull !37, !align !42 ; 2 uses
...
bb.a:
  ...
  %i.d = load i32, ptr %i.c, align 8, !tbaa !74   ; 6 uses
  ...
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !75 ; 17 uses
  ...
  %i.bh = load ptr, ptr %i.bg, align 8, !tbaa !76 ; 3 uses
  ...
  %i.bp = load float, ptr %i.bo, align 8, !tbaa !28 ; 2 uses
  %i.bq = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.br = load float, ptr %i.bq, align 4, !tbaa !28
  %i.bs = getelementptr inbounds nuw i8, ptr %0, i64 444
  ...
  %i.cb = fmul float %i.bp, %i.ca
  %i.cc = tail call float @llvm.fmuladd.f32(float %i.by, float %i.bn, float %i.cb)
  %i.cd = getelementptr inbounds nuw i8, ptr %3, i64 40
  %i.ce = load float, ptr %i.cd, align 4, !tbaa !28
  %i.cf = tail call noundef float @llvm.fmuladd.f32(float %i.ce, float %i.bt, float %i.cc) ; 4 uses
  %i.cg = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.ch = load ptr, ptr %i.cg, align 8, !tbaa !77 ; 17 uses
  %i.ci = getelementptr inbounds [4 x i8], ptr %i.ch, i64 %i.e ; 4 uses
  %i.cj = getelementptr inbounds [4 x i8], ptr %i.ch, i64 %i.i ; 3 uses
  %i.ck = fneg float %i.cf
  %i.cl = getelementptr inbounds nuw i8, ptr %i.ch, i64 4
  %i.cm = getelementptr inbounds nuw i8, ptr %i.ch, i64 8
  %i.cn = getelementptr inbounds nuw i8, ptr %i.ch, i64 12
  %i.co = getelementptr inbounds nuw i8, ptr %i.ci, i64 4
  %i.cp = getelementptr inbounds nuw i8, ptr %i.ci, i64 8
  %i.cq = getelementptr inbounds nuw i8, ptr %i.ci, i64 12
  %i.cr = load <2 x float>, ptr %3, align 4, !tbaa !28 ; 2 uses
  %i.cs = load <2 x float>, ptr %i.bu, align 4, !tbaa !28 ; 2 uses
  %i.ct = insertelement <2 x float> poison, float %i.bp, i64 0
  ...
  %i.cy = insertelement <2 x float> poison, float %i.bn, i64 0
  %i.cz = shufflevector <2 x float> %i.cy, <2 x float> poison, <2 x i32> zeroinitializer
  %i.da = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cx, <2 x float> %i.cz, <2 x float> %i.cw)
  %i.db = insertelement <2 x float> poison, float %i.br, i64 0
  %i.dc = insertelement <2 x float> %i.db, float %i.bw, i64 1
  %i.dd = insertelement <2 x float> poison, float %i.bt, i64 0
  %i.de = shufflevector <2 x float> %i.dd, <2 x float> poison, <2 x i32> zeroinitializer
  %i.df = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dc, <2 x float> %i.de, <2 x float> %i.da) ; 3 uses
  store float 0.000000e+00, ptr %i.ch, align 4, !tbaa !28
  store float %i.ck, ptr %i.cl, align 4, !tbaa !28
  %i.dg = extractelement <2 x float> %i.df, i64 1 ; 3 uses
  store float %i.dg, ptr %i.cm, align 4, !tbaa !28
  store float 0.000000e+00, ptr %i.cn, align 4, !tbaa !28
  store float %i.cf, ptr %i.ci, align 4, !tbaa !28
  store float 0.000000e+00, ptr %i.co, align 4, !tbaa !28
  %i.dh = fneg <2 x float> %i.df                  ; 2 uses
  %i.di = extractelement <2 x float> %i.dh, i64 0
  store float %i.di, ptr %i.cp, align 4, !tbaa !28
  store float 0.000000e+00, ptr %i.cq, align 4, !tbaa !28
  %i.dj = extractelement <2 x float> %i.dh, i64 1
  store float %i.dj, ptr %i.cj, align 4, !tbaa !28
  %i.dk = getelementptr inbounds nuw i8, ptr %i.cj, i64 4
  %i.dl = extractelement <2 x float> %i.df, i64 0 ; 3 uses
  ...
  %i.dt = load float, ptr %1, align 8, !tbaa !78
  ...
  %i.dy = load ptr, ptr %i.dx, align 8, !tbaa !79 ; 9 uses
  %i.dz = getelementptr inbounds nuw i8, ptr %1, i64 64 ; 2 uses
  %i.ea = load ptr, ptr %i.dz, align 8, !tbaa !80 ; 9 uses
  %i.eb = getelementptr inbounds nuw i8, ptr %1, i64 72 ; 2 uses
  %i.ec = load ptr, ptr %i.eb, align 8, !tbaa !81 ; 9 uses
  %.not169 = trunc i32 %i.do to i1
  br i1 %.not169, label %.split, label %.split.us.preheader
...
.split:                                           ; preds = %bb.a
  ...
  %i.fi = load ptr, ptr %i.fh, align 8, !tbaa !82 ; 3 uses
  ...
  store float f0xFF7FFFFF, ptr %i.ea, align 4, !tbaa !28
  store float f0x7F7FFFFF, ptr %i.ec, align 4, !tbaa !28
  %i.fp = load float, ptr %i.fg, align 4, !tbaa !83
  ...
  %i.gb = load float, ptr %i.fg, align 4, !tbaa !83
  ...
  %i.gp = load float, ptr %i.fg, align 4, !tbaa !83
...
.split271.us:                                     ; preds = %.split.us.preheader, %.split
  ...
  %i.gt = load i8, ptr %i.gs, align 2, !tbaa !33, !range !36, !noundef !37
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.hh = load float, ptr %i.af, align 4, !tbaa !28, !noalias !84 ; 2 uses
  %i.hi = load float, ptr %i.ao, align 4, !tbaa !28, !noalias !84
  ...
  %i.hu = load <2 x float>, ptr %2, align 4, !tbaa !28, !noalias !84 ; 3 uses
  %i.hv = load float, ptr %i.o, align 4, !tbaa !28, !noalias !84
  %i.hw = load <2 x float>, ptr %i.z, align 4, !tbaa !28, !noalias !84 ; 3 uses
  %i.hx = load float, ptr %i.ab, align 4, !tbaa !28, !noalias !84
  %i.hy = load <2 x float>, ptr %i.he, align 8, !tbaa !28, !noalias !84 ; 2 uses
  %i.hz = shufflevector <2 x float> %i.hy, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
  %i.ia = load <2 x float>, ptr %i.hf, align 8, !tbaa !28, !noalias !84 ; 2 uses
  %i.ib = shufflevector <2 x float> %i.ia, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
  %i.ic = load <2 x float>, ptr %i.ai, align 4, !tbaa !28, !noalias !84 ; 2 uses
  ...
  %i.ix = getelementptr inbounds [4 x i8], ptr %i.ch, i64 %i.hk
  %i.iy = getelementptr inbounds [4 x i8], ptr %i.ch, i64 %i.hn
  %i.iz = getelementptr inbounds [4 x i8], ptr %i.ch, i64 %i.hq
  %i.ja = getelementptr inbounds [4 x i8], ptr %i.ch, i64 %i.hs
  %i.jb = load <2 x float>, ptr %i.hg, align 8, !tbaa !28, !noalias !84 ; 2 uses
  ...
  %i.jv = getelementptr inbounds [4 x i8], ptr %i.ch, i64 %i.iv
  %i.jw = extractelement <4 x float> %i.jo, i64 1
  store float %i.jw, ptr %i.jv, align 4, !tbaa !28
  %i.jx = load float, ptr %1, align 8, !tbaa !78
  %i.jy = getelementptr inbounds nuw i8, ptr %0, i64 460
  %i.jz = load float, ptr %i.jy, align 4, !tbaa !89
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.mp = load ptr, ptr %i.mo, align 8, !tbaa !82
