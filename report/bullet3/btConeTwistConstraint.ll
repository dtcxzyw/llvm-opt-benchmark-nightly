...
bb.a:
  ...
  %i.ck = load <2 x float>, ptr %3, align 4, !tbaa !28
  %i.cl = load float, ptr %6, align 4, !tbaa !28
  %i.cm = load float, ptr %i.bn, align 8, !tbaa !28 ; 3 uses
  %i.cn = load float, ptr %i.bm, align 4, !tbaa !28 ; 2 uses
  %8 = load float, ptr %i.bq, align 4, !tbaa !28  ; 2 uses
  %9 = load <2 x float>, ptr %i.br, align 4, !tbaa !28
  %10 = load float, ptr %7, align 4, !tbaa !28
  %11 = fmul float %i.cm, %10
  %12 = fmul float %i.cl, %i.cm
  %i.co = shufflevector <2 x float> %i.ck, <2 x float> %9, <2 x i32> <i32 0, i32 2>
  ...
  %i.cr = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.co, <2 x float> %i.cq, <2 x float> %14)
  %i.cs = insertelement <2 x float> poison, float %i.bp, i64 0
  %i.ct = insertelement <2 x float> %i.cs, float %i.bt, i64 1
  %i.cu = insertelement <2 x float> poison, float %8, i64 0
  ...
  %i.cx = fmul float %i.cm, %i.bx
  %i.cy = tail call float @llvm.fmuladd.f32(float %i.bv, float %i.cn, float %i.cx)
  %i.cz = tail call noundef float @llvm.fmuladd.f32(float %i.bz, float %8, float %i.cy) ; 4 uses
...
bb.ab:                                            ; preds = %_ZN12btSolverBody20internalApplyImpulseERK9btVector3S2_f.exit384
  ...
  %i.bfx = load float, ptr %i.bfv, align 8, !tbaa !28 ; 4 uses
...
bb.ae:                                            ; preds = %bb.ad
  %i.bgu = load ptr, ptr %i.f, align 8, !tbaa !40, !nonnull !36, !align !41 ; 9 uses
  ...
  %15 = getelementptr inbounds nuw i8, ptr %i.bgu, i64 388
  %i.bhh = getelementptr inbounds nuw i8, ptr %i.bgu, i64 392
  %i.bhi = getelementptr inbounds nuw i8, ptr %i.bgu, i64 380
  %i.bhj = load float, ptr %i.bhi, align 4, !tbaa !28
  %16 = getelementptr inbounds nuw i8, ptr %i.bgu, i64 376
  ...
  %i.bie = load <2 x float>, ptr %15, align 4, !tbaa !28
  %17 = load float, ptr %i.bhh, align 8, !tbaa !28
  %18 = load <2 x float>, ptr %i.bhe, align 4, !tbaa !28
  %19 = load float, ptr %16, align 8, !tbaa !28
  %20 = fmul float %i.bfx, %17
  %21 = fmul float %i.bfx, %19
  %i.bif = shufflevector <2 x float> %18, <2 x float> %i.bie, <2 x i32> <i32 0, i32 2>
  ...
  %i.bii = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bif, <2 x float> %i.bih, <2 x float> %23)
...
bb.af:                                            ; preds = %_ZN12btSolverBody20internalApplyImpulseERK9btVector3S2_f.exit396
  ...
  %i.bja = load ptr, ptr %i.n, align 8, !tbaa !42, !nonnull !36, !align !41 ; 9 uses
  ...
  %24 = getelementptr inbounds nuw i8, ptr %i.bja, i64 388
  %i.bjk = getelementptr inbounds nuw i8, ptr %i.bja, i64 392
  %i.bjl = getelementptr inbounds nuw i8, ptr %i.bja, i64 380
  %i.bjm = load float, ptr %i.bjl, align 4, !tbaa !28
  %25 = getelementptr inbounds nuw i8, ptr %i.bja, i64 376
  ...
  %i.bkg = load float, ptr %i.bfv, align 8, !tbaa !28 ; 3 uses
  ...
  %i.bkm = load <2 x float>, ptr %24, align 4, !tbaa !28
  %26 = load float, ptr %i.bjk, align 8, !tbaa !28
  %27 = load <2 x float>, ptr %i.bjh, align 4, !tbaa !28
  %28 = load float, ptr %25, align 8, !tbaa !28
  %29 = fmul float %i.bkg, %26
  %30 = fmul float %i.bkg, %28
  %i.bkn = shufflevector <2 x float> %27, <2 x float> %i.bkm, <2 x i32> <i32 0, i32 2>
  ...
  %i.bkq = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bkn, <2 x float> %i.bkp, <2 x float> %32)
