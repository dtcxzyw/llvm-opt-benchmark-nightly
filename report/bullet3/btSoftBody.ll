...
bb.a:
  ...
  %i.bu = insertelement <4 x float> poison, float %.sroa.079.0.copyload, i64 0
  %i.bv = insertelement <4 x float> %i.bu, float %.sroa.089.0.copyload, i64 1
  %4 = shufflevector <4 x float> %i.bv, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
