...
bb.b:                                             ; preds = %.lr.ph, %bb.c
  ...
  %6 = getelementptr inbounds nuw i8, ptr %i.n, i64 24
  %i.q = getelementptr inbounds nuw i8, ptr %i.n, i64 40
  %7 = load float, ptr %i.o, align 4, !tbaa !223
  %i.r = getelementptr inbounds nuw i8, ptr %i.l, i64 12
  %i.s = getelementptr inbounds nuw i8, ptr %i.n, i64 12
  %i.t = load float, ptr %i.s, align 4, !tbaa !223
  %8 = getelementptr inbounds nuw i8, ptr %i.l, i64 16
  %i.u = load float, ptr %8, align 8, !tbaa !223  ; 3 uses
  %i.v = getelementptr inbounds nuw i8, ptr %i.n, i64 16
  %9 = load float, ptr %i.v, align 4, !tbaa !223
  %i.w = load float, ptr %6, align 4, !tbaa !223
  %i.x = getelementptr inbounds nuw i8, ptr %i.n, i64 28
  %i.y = load float, ptr %i.x, align 4, !tbaa !223
  %10 = getelementptr inbounds nuw i8, ptr %i.n, i64 32
  %11 = load float, ptr %10, align 4, !tbaa !223
  %12 = getelementptr inbounds nuw i8, ptr %i.n, i64 44
  %i.z = getelementptr inbounds nuw i8, ptr %i.n, i64 48
  %i.aa = load float, ptr %i.z, align 4, !tbaa !223
  %i.ab = getelementptr inbounds nuw i8, ptr %i.n, i64 56
  %i.ac = load float, ptr %i.ab, align 4, !tbaa !223
  %13 = getelementptr inbounds nuw i8, ptr %i.n, i64 60
  %i.ad = load float, ptr %13, align 4, !tbaa !223
  %i.ae = getelementptr inbounds nuw i8, ptr %i.n, i64 64
  %i.af = load float, ptr %i.ae, align 4, !tbaa !223
  %14 = getelementptr inbounds nuw i8, ptr %i.l, i64 84 ; 2 uses
  %15 = getelementptr inbounds nuw i8, ptr %i.n, i64 420
  %i.ag = getelementptr inbounds nuw i8, ptr %i.n, i64 436
  %16 = getelementptr inbounds nuw i8, ptr %i.n, i64 440
  %17 = getelementptr inbounds nuw i8, ptr %i.l, i64 92
  %i.ah = load float, ptr %17, align 4, !tbaa !223 ; 2 uses
  %i.ai = getelementptr inbounds nuw i8, ptr %i.n, i64 444
  %18 = fneg float %i.ah
  %19 = load float, ptr %i.r, align 4, !tbaa !223 ; 3 uses
  %i.aj = load float, ptr %5, align 8, !tbaa !223 ; 3 uses
  %i.ak = fmul float %19, %i.t
  %i.al = call float @llvm.fmuladd.f32(float %i.aj, float %7, float %i.ak)
  %20 = call noundef float @llvm.fmuladd.f32(float %i.u, float %9, float %i.al)
  %21 = fmul float %19, %i.y
  %i.am = call float @llvm.fmuladd.f32(float %i.aj, float %i.w, float %21)
  %22 = call noundef float @llvm.fmuladd.f32(float %i.u, float %11, float %i.am)
  %i.an = load float, ptr %12, align 4, !tbaa !223
  %23 = load float, ptr %i.q, align 4, !tbaa !223
  %24 = fmul float %19, %i.an
  %25 = fadd float %20, %i.ac
  %i.ao = fadd float %22, %i.ad
  %26 = load float, ptr %16, align 4, !tbaa !223  ; 2 uses
  %i.ap = load float, ptr %i.ai, align 4, !tbaa !223 ; 2 uses
  %27 = load <2 x float>, ptr %14, align 4, !tbaa !223 ; 2 uses
  %28 = load float, ptr %i.ag, align 4, !tbaa !223 ; 2 uses
  %29 = call float @llvm.fmuladd.f32(float %i.aj, float %23, float %24)
  %30 = fneg <2 x float> %27
  %31 = insertelement <4 x float> poison, float %29, i64 0
  %32 = insertelement <4 x float> %31, float %28, i64 1
  %33 = insertelement <4 x float> %32, float %26, i64 2
  %34 = insertelement <4 x float> %33, float %i.ap, i64 3
  %35 = insertelement <4 x float> <float 1.000000e+00, float poison, float poison, float poison>, float %18, i64 1
  %36 = shufflevector <2 x float> %30, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %37 = shufflevector <4 x float> %35, <4 x float> %36, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %38 = fmul <4 x float> %34, %37
  %39 = insertelement <4 x float> poison, float %i.aa, i64 0
  %40 = insertelement <4 x float> %39, float %i.ap, i64 1
  %41 = insertelement <4 x float> %40, float %28, i64 2
  %42 = insertelement <4 x float> %41, float %26, i64 3
  %43 = shufflevector <2 x float> %27, <2 x float> poison, <4 x i32> <i32 poison, i32 0, i32 1, i32 poison>
  %44 = insertelement <4 x float> %43, float %i.u, i64 0
  %45 = insertelement <4 x float> %44, float %i.ah, i64 3
  %46 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %42, <4 x float> %45, <4 x float> %38) ; 4 uses
  %47 = extractelement <4 x float> %46, i64 0
  %48 = fadd float %47, %i.af
  %49 = load float, ptr %15, align 4, !tbaa !223
  %50 = extractelement <4 x float> %46, i64 3
  %i.aq = fadd float %50, %49
  %i.ar = getelementptr inbounds nuw i8, ptr %i.n, i64 424
  %i.as = load float, ptr %i.ar, align 4, !tbaa !223
  %51 = extractelement <4 x float> %46, i64 1
  %i.at = fadd float %i.as, %51
  %i.au = getelementptr inbounds nuw i8, ptr %i.n, i64 428
  %i.av = load float, ptr %i.au, align 4, !tbaa !223
  %52 = extractelement <4 x float> %46, i64 2
  %i.aw = fadd float %52, %i.av
  ...
  invoke void @_ZN11btRigidBody12applyImpulseERK9btVector3S2_(ptr noundef nonnull align 8 dereferenceable(744) %i.n, ptr noundef nonnull align 4 dereferenceable(16) %4, ptr noundef nonnull align 4 dereferenceable(16) %14)
