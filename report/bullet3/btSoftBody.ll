...
bb.a:
  ...
  %i.dh = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %6, <4 x float> %i.dg, <4 x float> %i.bz) ; 4 uses
...
bb.a:
  ...
  %8 = load float, ptr %6, align 4, !tbaa !253    ; 2 uses
  %i.f = load float, ptr %2, align 4, !tbaa !253  ; 2 uses
  %9 = load float, ptr %7, align 4, !tbaa !253    ; 2 uses
  %i.g = fsub float %i.c, %8                      ; 2 uses
  %i.h = fsub float %i.d, %i.f                    ; 2 uses
  %i.i = fsub float %i.e, %9                      ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.aa = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.ad = fsub <2 x float> %i.ac, %12             ; 5 uses
  %13 = insertelement <2 x float> %i.w, float %i.u, i64 1
  %i.ae = insertelement <2 x float> poison, float %9, i64 0
  %14 = shufflevector <2 x float> %i.ae, <2 x float> poison, <2 x i32> zeroinitializer
  %i.af = fsub <2 x float> %13, %14               ; 5 uses
