...
bb.e:                                             ; preds = %.lr.ph, %bb.l
  ...
  %.0253465 = phi i32 [ 0, %.lr.ph ], [ %i.cp, %bb.l ] ; 4 uses
  %i.bi = load ptr, ptr %i.bb, align 8, !tbaa !148
  %i.bj = sext i32 %.0253465 to i64               ; 2 uses
...
bb.l:                                             ; preds = %bb.h, %bb.i, %bb.e
  ...
  %.1254 = phi i32 [ %i.cl, %bb.i ], [ %.0253465, %bb.h ], [ %.0253465, %bb.e ]
  %i.cp = add nsw i32 %.1254, 1                   ; 2 uses
...
bb.o:                                             ; preds = %.lr.ph476, %.loopexit448
  ...
  br i1 %i.fn, label %.lr.ph472, label %.loopexit448

.lr.ph472:                                        ; preds = %bb.o
  %13 = trunc nuw nsw i64 %indvars.iv524 to i32   ; 2 uses
  br label %bb.p

bb.p:                                             ; preds = %.lr.ph472, %_ZL13ImplicitSolvePN10btSoftBody10ImplicitFnERK9btVector3S4_fi.exit.thread
  %indvars.iv521 = phi i64 [ %indvars.iv519, %.lr.ph472 ], [ %indvars.iv.next522, %_ZL13ImplicitSolvePN10btSoftBody10ImplicitFnERK9btVector3S4_fi.exit.thread ] ; 3 uses
  %14 = trunc nuw nsw i64 %indvars.iv521 to i32   ; 2 uses
  %spec.select.i.i334 = call i32 @llvm.smin.i32(i32 %13, i32 %14)
  %spec.select5.i.i335 = call i32 @llvm.smax.i32(i32 %13, i32 %14) ; 2 uses
  %15 = add nuw nsw i32 %spec.select5.i.i335, 1
  %16 = mul nuw nsw i32 %15, %spec.select5.i.i335
  %17 = lshr i32 %16, 1
  %18 = add nuw nsw i32 %17, %spec.select.i.i334
  %i.fo = load ptr, ptr %i.f, align 8, !tbaa !220
  %19 = zext nneg i32 %18 to i64                  ; 2 uses
  %i.fp = getelementptr inbounds nuw [4 x i8], ptr %i.fo, i64 %19
...
bb.t:                                             ; preds = %bb.x, %.preheader.i
  %.064.i = phi i32 [ 0, %.preheader.i ], [ %i.hj, %bb.x ]
...
bb.x:                                             ; preds = %bb.w, %bb.v
  ...
  %i.hj = add nuw nsw i32 %.064.i, 1              ; 2 uses
...
bb.ae:                                            ; preds = %bb.ac, %bb.ad, %bb.aa, %bb.ab
  %.0260 = phi float [ %i.jf, %bb.aa ], [ %i.jh, %bb.ab ], [ %i.jj, %bb.ad ], [ 0.000000e+00, %bb.ac ]
  invoke void @_ZN10btSoftBody10appendNodeERK9btVector3f(ptr noundef nonnull align 8 dereferenceable(2064) %0, ptr noundef nonnull align 4 dereferenceable(16) %8, float noundef %.0260)
          to label %bb.af unwind label %bb.ag

bb.af:                                            ; preds = %bb.ae
  %i.jk = load i32, ptr %i.c, align 4, !tbaa !141
  %i.jl = load ptr, ptr %i.f, align 8, !tbaa !220
  %i.jm = getelementptr inbounds nuw [4 x i8], ptr %i.jl, i64 %19
...
bb.an:                                            ; preds = %.lr.ph483, %.loopexit445
  ...
  %.6259482 = phi i32 [ 0, %.lr.ph483 ], [ %.10, %.loopexit445 ] ; 5 uses
  %i.mg = load ptr, ptr %i.ka, align 8, !tbaa !152 ; 4 uses
  %i.mh = sext i32 %.6259482 to i64               ; 2 uses
...
bb.ap:                                            ; preds = %bb.bn, %bb.bm, %bb.ao
  ...
  %i.nm = icmp sgt i32 %.6259482, -1
  br i1 %i.nm, label %bb.aq, label %bb.ar

bb.aq:                                            ; preds = %bb.ap
  %i.nn = zext nneg i32 %.6259482 to i64
