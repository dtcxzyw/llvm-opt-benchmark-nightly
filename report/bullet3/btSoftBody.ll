...
bb.n:                                             ; preds = %bb.m, %bb.l, %bb.k
  ...
  %20 = insertelement <2 x float> <float 0.000000e+00, float poison>, float %i.gu, i64 1 ; 3 uses
  %i.if = shufflevector <3 x float> %i.ib, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.ig = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %20, <2 x float> %i.if, <2 x float> %i.ie)
  %i.ih = shufflevector <2 x float> %i.gf, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %i.ii = insertelement <2 x float> %i.ih, float %i.gy, i64 0 ; 3 uses
  ...
  %i.is = insertelement <3 x float> poison, float %i.gj, i64 0
  ...
  %i.jb = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %20, <2 x float> %i.ja, <2 x float> %i.iz)
  ...
  %i.jh = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %20, <2 x float> %i.jg, <2 x float> %i.jf)
  %i.ji = shufflevector <3 x float> %i.hp, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.jj = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ii, <2 x float> %i.ji, <2 x float> %i.jh) ; 2 uses
