...
bb.a:
  ...
  %i.t = load <2 x float>, ptr %i.a, align 8, !tbaa !142 ; 2 uses
  %i.u = load float, ptr %i.b, align 4, !tbaa !142 ; 2 uses
  %i.v = load float, ptr %1, align 4, !tbaa !142  ; 2 uses
  %i.w = load float, ptr %i.f, align 4, !tbaa !142 ; 2 uses
  %i.x = load <2 x float>, ptr %i.g, align 8, !tbaa !142 ; 2 uses
  %2 = insertelement <2 x float> poison, float %i.u, i64 0
  %3 = shufflevector <2 x float> %2, <2 x float> poison, <2 x i32> zeroinitializer
  %4 = shufflevector <2 x float> %i.t, <2 x float> %i.x, <2 x i32> <i32 1, i32 3>
  %5 = fmul <2 x float> %3, %4
  %6 = shufflevector <2 x float> %i.t, <2 x float> %i.x, <2 x i32> <i32 0, i32 2>
  %i.y = insertelement <2 x float> poison, float %i.v, i64 0
  %7 = shufflevector <2 x float> %i.y, <2 x float> poison, <2 x i32> zeroinitializer
  %i.z = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %6, <2 x float> %7, <2 x float> %5)
...
bb.a:
  ...
  %2 = shufflevector <2 x float> %i.l, <2 x float> %i.m, <2 x i32> <i32 1, i32 3>
  ...
  %6 = shufflevector <2 x float> %i.l, <2 x float> %i.m, <2 x i32> <i32 0, i32 2>
  %i.t = insertelement <2 x float> poison, float %i.o, i64 0
  %7 = shufflevector <2 x float> %i.t, <2 x float> poison, <2 x i32> zeroinitializer
  %i.u = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %6, <2 x float> %7, <2 x float> %5)
