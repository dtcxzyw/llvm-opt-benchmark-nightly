...
bb.b:                                             ; preds = %.lr.ph, %.split108
  ...
  %i.fb = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bv, <2 x float> %i.fa, <2 x float> %i.ey) ; 5 uses
...
.split108:                                        ; preds = %._crit_edge.1.epil.preheader, %.split108.loopexit.unr-lcssa, %bb.b
  ...
  %i.gf = shufflevector <2 x float> %i.fb, <2 x float> poison, <3 x i32> zeroinitializer ; 2 uses
  ...
  %1 = shufflevector <3 x float> %i.gf, <3 x float> <float 0.000000e+00, float poison, float poison>, <2 x i32> <i32 3, i32 0>
...
bb.a:
  ...
  %i.w = tail call noundef float @llvm.fmuladd.f32(float %.sroa.16303.0.copyload, float %i.t, float %i.v) ; 4 uses
...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  %i.br = insertelement <3 x float> poison, float %i.w, i64 0 ; 2 uses
  ...
  %4 = shufflevector <3 x float> %i.br, <3 x float> <float poison, float 0.000000e+00, float poison>, <2 x i32> <i32 0, i32 4>
