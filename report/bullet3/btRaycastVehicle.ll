...
_Z8btSetMinIfEvRT_RKS0_.exit:
  ...
  %i.ak = shufflevector <2 x float> %i.ai, <2 x float> %i.ah, <2 x i32> <i32 0, i32 2>
  %i.al = fsub <2 x float> %i.aj, %i.ak           ; 2 uses
  %i.am = shufflevector <2 x float> %i.ag, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.an = shufflevector <2 x float> %i.ai, <2 x float> %i.ah, <2 x i32> <i32 1, i32 3>
  ...
  %i.as = shufflevector <2 x float> %i.aq, <2 x float> %i.ap, <2 x i32> <i32 1, i32 3>
  %i.at = fmul <2 x float> %i.as, %i.ar
  %i.au = shufflevector <2 x float> %i.aq, <2 x float> %i.ap, <2 x i32> <i32 0, i32 2> ; 2 uses
  ...
  %i.ax = insertelement <2 x float> poison, float %i.l, i64 0
  %i.ay = insertelement <2 x float> %i.ax, float %i.g, i64 1
  ...
  %i.bf = shufflevector <2 x float> %i.bd, <2 x float> %i.ba, <2 x i32> <i32 1, i32 3>
  %i.bg = fmul <2 x float> %i.bf, %i.bc
  %i.bh = shufflevector <2 x float> %i.bd, <2 x float> %i.ba, <2 x i32> <i32 0, i32 2>
  %i.bi = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bh, <2 x float> %i.az, <2 x float> %i.bg)
  %i.bj = insertelement <2 x float> poison, float %i.ab, i64 0
  %i.bk = insertelement <2 x float> %i.bj, float %i.s, i64 1
  ...
  %i.bp = insertelement <2 x float> %i.bo, float %i.bb, i64 1
  ...
  %i.bs = insertelement <2 x float> %i.br, float %i.u, i64 1
  %i.bt = fadd <2 x float> %i.bs, %i.bq           ; 2 uses
  %i.bu = insertelement <2 x float> poison, float %i.af, i64 0
  ...
  %foldExtExtBinop = fsub <2 x float> %shift, %i.bl
  ...
  %foldExtExtBinop41 = fsub <2 x float> %shift40, %i.bt
  ...
  %foldExtExtBinop44 = fsub <2 x float> %shift43, %i.bw
...
bb.u:                                             ; preds = %bb.s
  ...
  %i.nn = shufflevector <2 x float> %i.nl, <2 x float> %i.nk, <2 x i32> <i32 0, i32 2>
  %i.no = fsub <2 x float> %i.nm, %i.nn           ; 2 uses
  %i.np = shufflevector <2 x float> %i.nj, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.nq = shufflevector <2 x float> %i.nl, <2 x float> %i.nk, <2 x i32> <i32 1, i32 3>
  ...
  %i.nv = shufflevector <2 x float> %i.nt, <2 x float> %i.ns, <2 x i32> <i32 1, i32 3>
  %i.nw = fmul <2 x float> %i.nv, %i.nu
  %i.nx = shufflevector <2 x float> %i.nt, <2 x float> %i.ns, <2 x i32> <i32 0, i32 2> ; 2 uses
  ...
  %i.oa = insertelement <2 x float> poison, float %i.mp, i64 0
  %i.ob = insertelement <2 x float> %i.oa, float %i.ml, i64 1
  ...
  %i.oi = shufflevector <2 x float> %i.og, <2 x float> %i.od, <2 x i32> <i32 1, i32 3>
  %i.oj = fmul <2 x float> %i.oi, %i.of
  %i.ok = shufflevector <2 x float> %i.og, <2 x float> %i.od, <2 x i32> <i32 0, i32 2>
  %i.ol = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ok, <2 x float> %i.oc, <2 x float> %i.oj)
  %i.om = insertelement <2 x float> poison, float %i.ne, i64 0
  %i.on = insertelement <2 x float> %i.om, float %i.mv, i64 1
  %i.oo = fadd <2 x float> %i.ol, %i.on           ; 2 uses
  %i.op = fneg <2 x float> %i.oc
  %i.oq = fmul <2 x float> %i.nx, %i.op
  %i.or = insertelement <2 x float> poison, float %i.oh, i64 0
  %i.os = insertelement <2 x float> %i.or, float %i.oe, i64 1
  %i.ot = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.os, <2 x float> %i.no, <2 x float> %i.oq)
  %i.ou = insertelement <2 x float> poison, float %i.ng, i64 0
  %i.ov = insertelement <2 x float> %i.ou, float %i.mx, i64 1
  %i.ow = fadd <2 x float> %i.ov, %i.ot           ; 2 uses
  %i.ox = insertelement <2 x float> poison, float %i.ni, i64 0
  %i.oy = insertelement <2 x float> %i.ox, float %i.mz, i64 1
  %i.oz = fadd <2 x float> %i.ny, %i.oy           ; 2 uses
  %shift = shufflevector <2 x float> %i.oo, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop340 = fsub <2 x float> %shift, %i.oo
  ...
  %foldExtExtBinop343 = fsub <2 x float> %shift342, %i.ow
  ...
  %foldExtExtBinop346 = fsub <2 x float> %shift345, %i.oz
