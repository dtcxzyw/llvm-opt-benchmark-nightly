...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  %.sroa.519.0 = extractvalue { <2 x float>, <2 x float> } %.pn, 1 ; 2 uses
  %.sroa.018.0 = extractvalue { <2 x float>, <2 x float> } %.pn, 0 ; 3 uses
  ...
  %i.by = getelementptr inbounds nuw i8, ptr %9, i64 4 ; 2 uses
...
.thread163:                                       ; preds = %bb.c
  ...
  %15 = extractelement <2 x float> %.sroa.018.0, i64 0 ; 2 uses
  %16 = extractelement <2 x float> %.sroa.519.0, i64 0 ; 2 uses
  %17 = extractelement <2 x float> %.sroa.018.0, i64 1 ; 2 uses
  ...
  %i.dl = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.di, <2 x float> %i.dk, <2 x float> %i.dg) ; 3 uses
  ...
  %i.dz = load float, ptr %i.w, align 4, !tbaa !17 ; 2 uses
  %18 = fneg float %i.dz
  %19 = fmul float %16, %18
  %20 = tail call float @llvm.fmuladd.f32(float %17, float %i.dy, float %19)
  %i.ea = load float, ptr %8, align 16, !tbaa !17 ; 2 uses
  %21 = fneg float %i.dy
  %22 = fmul float %15, %21
  %23 = tail call float @llvm.fmuladd.f32(float %16, float %i.ea, float %22)
  %i.eb = fneg float %i.ea
  %24 = fmul float %17, %i.eb
  %25 = tail call float @llvm.fmuladd.f32(float %15, float %i.dz, float %24)
  %26 = getelementptr inbounds nuw i8, ptr %i.k, i64 68
  %27 = load float, ptr %26, align 4, !tbaa !85   ; 2 uses
  %28 = load float, ptr %4, align 16, !tbaa !17   ; 2 uses
  %29 = getelementptr inbounds nuw i8, ptr %4, i64 4
  %30 = load float, ptr %29, align 4, !tbaa !17   ; 2 uses
  %31 = fmul float %23, %30
  %32 = tail call float @llvm.fmuladd.f32(float %28, float %20, float %31)
  %33 = getelementptr inbounds nuw i8, ptr %4, i64 8
  %34 = load float, ptr %33, align 8, !tbaa !17   ; 2 uses
  %35 = tail call noundef float @llvm.fmuladd.f32(float %34, float %25, float %32)
  %36 = fadd float %27, %35                       ; 2 uses
  %37 = extractelement <2 x float> %i.dl, i64 0   ; 2 uses
  %38 = fneg float %37
  %39 = extractelement <2 x float> %i.dl, i64 1   ; 2 uses
  %40 = fneg float %39
  %41 = fneg float %i.dw
  %42 = load float, ptr %i.cq, align 8, !tbaa !17 ; 2 uses
  %43 = load float, ptr %i.by, align 4, !tbaa !17 ; 2 uses
  %44 = fmul float %i.dw, %43
  %45 = tail call float @llvm.fmuladd.f32(float %40, float %42, float %44)
  %46 = load float, ptr %9, align 16, !tbaa !17   ; 2 uses
  %47 = fmul float %37, %42
  %48 = tail call float @llvm.fmuladd.f32(float %41, float %46, float %47)
  %49 = fmul float %39, %46
  %50 = tail call float @llvm.fmuladd.f32(float %38, float %43, float %49)
  %51 = getelementptr inbounds nuw i8, ptr %i.o, i64 68
  %52 = load float, ptr %51, align 4, !tbaa !85
  %53 = fmul float %48, %30
  %54 = tail call float @llvm.fmuladd.f32(float %28, float %45, float %53)
  %55 = tail call noundef float @llvm.fmuladd.f32(float %34, float %50, float %54)
  %56 = fadd float %52, %55                       ; 2 uses
...
bb.e:                                             ; preds = %._crit_edge, %.thread163
  %i.eg = phi float [ %27, %.thread163 ], [ %.pre, %._crit_edge ]
  %.087169 = phi float [ %56, %.thread163 ], [ 0.000000e+00, %._crit_edge ] ; 3 uses
  %.088157167 = phi float [ %36, %.thread163 ], [ 0.000000e+00, %._crit_edge ] ; 2 uses
  %i.eh = fadd float %.087169, %.088157167
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.fc = fmul float %.087169, %i.fb
  br label %.thread158

.thread158:                                       ; preds = %bb.h, %bb.g
  %i.fd = phi float [ %i.fc, %bb.h ], [ %.087169, %bb.g ]
  %i.fe = tail call float @llvm.fmuladd.f32(float %.088157167, float %i.er, float %i.fd)
