...
bb.ci:                                            ; preds = %.lr.ph611, %bb.cn
  ...
  %i.vt = getelementptr inbounds nuw [160 x i8], ptr %i.ta, i64 %indvars.iv646 ; 19 uses
...
bb.cn:                                            ; preds = %bb.cm, %bb.cl
  ...
  %12 = load float, ptr %11, align 8, !tbaa !19   ; 7 uses
  %13 = load <2 x float>, ptr %i.wl, align 16, !tbaa !19 ; 2 uses
  %14 = shufflevector <2 x float> %i.wo, <2 x float> %13, <2 x i32> <i32 1, i32 3>
  %15 = shufflevector <2 x float> %i.wo, <2 x float> %13, <2 x i32> <i32 0, i32 2>
  %16 = insertelement <2 x float> poison, float %i.wk, i64 0
  %17 = insertelement <2 x float> %16, float %i.wn, i64 1
  %18 = insertelement <2 x float> poison, float %12, i64 0
  %i.wp = shufflevector <2 x float> %18, <2 x float> poison, <2 x i32> zeroinitializer
  %19 = getelementptr inbounds nuw i8, ptr %i.wi, i64 32 ; 2 uses
  %20 = load float, ptr %19, align 16, !tbaa !19
  %21 = getelementptr inbounds nuw i8, ptr %i.wi, i64 36
  %22 = load float, ptr %21, align 4, !tbaa !19
  %23 = getelementptr inbounds nuw i8, ptr %i.wi, i64 40 ; 2 uses
  %24 = load float, ptr %23, align 8, !tbaa !19
  %25 = getelementptr inbounds nuw i8, ptr %i.vt, i64 48
  %.sroa.540.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.vt, i64 56
  %i.wq = getelementptr inbounds nuw i8, ptr %i.vt, i64 32
  %26 = getelementptr inbounds nuw i8, ptr %i.vt, i64 36
  %i.wr = getelementptr inbounds nuw i8, ptr %i.vt, i64 40
  %i.ws = load float, ptr %i.wr, align 8, !tbaa !19 ; 7 uses
  %27 = insertelement <2 x float> poison, float %i.ws, i64 0
  %28 = shufflevector <2 x float> %27, <2 x float> poison, <2 x i32> zeroinitializer
  %29 = getelementptr inbounds nuw i8, ptr %i.vt, i64 64
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.vt, i64 72
  %30 = getelementptr inbounds nuw i8, ptr %i.vt, i64 16
  %31 = getelementptr inbounds nuw i8, ptr %i.vt, i64 20
  %i.wt = getelementptr inbounds nuw i8, ptr %i.vt, i64 24
  %32 = load float, ptr %i.wt, align 8, !tbaa !19 ; 6 uses
  %33 = load <2 x float>, ptr %i.vt, align 16, !tbaa !19 ; 7 uses
  %i.wu = load float, ptr %10, align 4, !tbaa !19 ; 3 uses
  %34 = shufflevector <2 x float> %33, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %35 = fmul <2 x float> %34, %14
  %36 = shufflevector <2 x float> %33, <2 x float> poison, <2 x i32> zeroinitializer
  %37 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %15, <2 x float> %36, <2 x float> %35)
  %38 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %17, <2 x float> %i.wp, <2 x float> %37)
  %39 = fmul float %i.wu, %22
  %i.wv = extractelement <2 x float> %33, i64 0
  %i.ww = call float @llvm.fmuladd.f32(float %20, float %i.wv, float %39)
  %40 = call noundef float @llvm.fmuladd.f32(float %24, float %12, float %i.ww)
  %.sroa.3.12.vec.insert.i.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %40, i64 0
  store <2 x float> %38, ptr %25, align 16
  ...
  %41 = load <2 x float>, ptr %i.wz, align 16, !tbaa !19 ; 2 uses
  %i.xf = load <2 x float>, ptr %i.wq, align 16, !tbaa !19 ; 7 uses
  %42 = shufflevector <2 x float> %i.xf, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %i.xg = load float, ptr %26, align 4, !tbaa !19 ; 4 uses
  %i.xh = load <2 x float>, ptr %i.xc, align 16, !tbaa !19 ; 2 uses
  %i.xi = shufflevector <2 x float> %i.xf, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.xj = shufflevector <2 x float> %41, <2 x float> %i.xh, <2 x i32> <i32 1, i32 3>
  %i.xk = fmul <2 x float> %i.xi, %i.xj
  %i.xl = shufflevector <2 x float> %41, <2 x float> %i.xh, <2 x i32> <i32 0, i32 2>
  %i.xm = shufflevector <2 x float> %i.xf, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.xq = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.xp, <2 x float> %28, <2 x float> %i.xn)
  ...
  %43 = fmul float %i.xg, %i.xu
  %44 = extractelement <2 x float> %i.xf, i64 0   ; 2 uses
  %i.xv = call float @llvm.fmuladd.f32(float %i.xs, float %44, float %43)
  %i.xw = getelementptr inbounds nuw i8, ptr %i.wz, i64 40 ; 2 uses
  %i.xx = load float, ptr %i.xw, align 8, !tbaa !19
  %i.xy = call noundef float @llvm.fmuladd.f32(float %i.xx, float %i.ws, float %i.xv)
  %.sroa.3.12.vec.insert.i.i443 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.xy, i64 0
  store <2 x float> %i.xq, ptr %29, align 16
  ...
  %i.ya = fmul float %i.xz, %32
  %45 = load <2 x float>, ptr %i.wi, align 16, !tbaa !19 ; 2 uses
  %i.yb = load float, ptr %i.wj, align 8, !tbaa !19
  %i.yc = load <2 x float>, ptr %i.wl, align 16, !tbaa !19 ; 2 uses
  %i.yd = load <2 x float>, ptr %19, align 16, !tbaa !19
  %i.ye = load <2 x float>, ptr %i.wz, align 16, !tbaa !19
  %46 = shufflevector <2 x float> %33, <2 x float> %i.xf, <4 x i32> <i32 1, i32 1, i32 1, i32 3>
  %i.yf = shufflevector <2 x float> %45, <2 x float> %i.yc, <4 x i32> <i32 1, i32 3, i32 poison, i32 poison>
  ...
  %i.yk = fmul <4 x float> %46, %i.yj
  %i.yl = shufflevector <2 x float> %45, <2 x float> %i.yc, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
  ...
  %47 = shufflevector <2 x float> %33, <2 x float> %i.xf, <4 x i32> <i32 0, i32 0, i32 0, i32 2>
  %48 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.yn, <4 x float> %47, <4 x float> %i.yk) ; 4 uses
  %49 = extractelement <4 x float> %48, i64 0
  %50 = call noundef float @llvm.fmuladd.f32(float %i.yb, float %12, float %49)
  %51 = load float, ptr %i.wm, align 8, !tbaa !19
  %i.yo = extractelement <4 x float> %48, i64 1
  %i.yp = call noundef float @llvm.fmuladd.f32(float %51, float %12, float %i.yo)
  %52 = load float, ptr %23, align 8, !tbaa !19
  %i.yq = extractelement <4 x float> %48, i64 2
  %i.yr = call noundef float @llvm.fmuladd.f32(float %52, float %12, float %i.yq)
  %53 = load float, ptr %i.vk, align 4, !tbaa !17 ; 3 uses
  %54 = fmul float %32, %53
  %i.ys = load float, ptr %i.xa, align 8, !tbaa !19
  %i.yt = extractelement <4 x float> %48, i64 3
  %i.yu = call noundef float @llvm.fmuladd.f32(float %i.ys, float %i.ws, float %i.yt)
  %i.yv = load float, ptr %i.xd, align 8, !tbaa !19
  %i.yw = load float, ptr %i.xw, align 8, !tbaa !19
  %i.yx = load <2 x float>, ptr %30, align 16, !tbaa !19 ; 4 uses
  %i.yy = load float, ptr %31, align 4, !tbaa !19 ; 4 uses
  %i.yz = extractelement <2 x float> %i.yx, i64 0 ; 3 uses
  %i.za = fmul float %i.yz, %i.xz
  %i.zb = fmul float %i.xz, %i.yy
  %i.zc = fmul float %i.yz, %53
  %i.zd = fmul float %i.yy, %53
  %i.ze = load <2 x float>, ptr %i.xc, align 16, !tbaa !19 ; 2 uses
  %i.zf = load <2 x float>, ptr %i.xr, align 16, !tbaa !19 ; 2 uses
  %55 = shufflevector <2 x float> %i.yx, <2 x float> poison, <3 x i32> <i32 poison, i32 1, i32 poison>
  %56 = insertelement <3 x float> %55, float %i.xg, i64 0
  %57 = insertelement <3 x float> %56, float %i.wu, i64 2
  %58 = shufflevector <3 x float> %57, <3 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 2>
  ...
  %i.zi = insertelement <4 x float> %i.zh, float %i.yp, i64 3
  %i.zj = fmul <4 x float> %58, %i.zi
  %i.zk = shufflevector <2 x float> %i.ze, <2 x float> %i.zf, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
  %i.zl = insertelement <4 x float> %i.zk, float %i.za, i64 2
  %i.zm = insertelement <4 x float> %i.zl, float %50, i64 3
  %59 = shufflevector <2 x float> %i.xf, <2 x float> %33, <4 x i32> <i32 0, i32 0, i32 poison, i32 2>
  %60 = shufflevector <2 x float> %i.yx, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %61 = shufflevector <4 x float> %59, <4 x float> %60, <4 x i32> <i32 0, i32 1, i32 4, i32 3>
  %i.zn = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.zm, <4 x float> %61, <4 x float> %i.zj) ; 4 uses
  %i.zo = extractelement <4 x float> %i.zn, i64 0
  %i.zp = call noundef float @llvm.fmuladd.f32(float %i.yv, float %i.ws, float %i.zo)
  %i.zq = extractelement <4 x float> %i.zn, i64 1
  %i.zr = call noundef float @llvm.fmuladd.f32(float %i.yw, float %i.ws, float %i.zq)
  %i.zs = extractelement <4 x float> %i.zn, i64 2
  %i.zt = call noundef float @llvm.fmuladd.f32(float %i.ya, float %32, float %i.zs)
  %i.zu = extractelement <4 x float> %i.zn, i64 3
  %i.zv = call noundef float @llvm.fmuladd.f32(float %i.yr, float %12, float %i.zu)
  %i.zw = fadd float %i.zt, %i.zv
  %i.zx = fmul float %i.yy, %i.zd
  %i.zy = call float @llvm.fmuladd.f32(float %i.zc, float %i.yz, float %i.zx)
  %i.zz = call noundef float @llvm.fmuladd.f32(float %54, float %32, float %i.zy)
  %i.aaa = fadd float %i.zw, %i.zz
  %i.aab = fmul float %i.xg, %i.zp
  %i.aac = call float @llvm.fmuladd.f32(float %i.yu, float %44, float %i.aab)
  %i.aad = call noundef float @llvm.fmuladd.f32(float %i.zr, float %i.ws, float %i.aac)
  ...
  %62 = insertelement <4 x float> poison, float %i.yy, i64 0
  %i.aar = insertelement <4 x float> %62, float %i.wu, i64 1
  %63 = insertelement <4 x float> %i.aar, float %i.xg, i64 2
  %64 = shufflevector <4 x float> %63, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 2>
  ...
  %i.aax = fmul <4 x float> %64, %i.aaw
  %65 = shufflevector <2 x float> %i.yx, <2 x float> %33, <4 x i32> <i32 0, i32 2, i32 0, i32 poison>
  %66 = shufflevector <4 x float> %65, <4 x float> %42, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  ...
  %i.abb = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %66, <4 x float> %i.aba, <4 x float> %i.aax) ; 4 uses
  %i.abc = extractelement <4 x float> %i.abb, i64 0
  %i.abd = call noundef float @llvm.fmuladd.f32(float %32, float %i.aak, float %i.abc)
  %i.abe = extractelement <4 x float> %i.abb, i64 1
  %i.abf = call noundef float @llvm.fmuladd.f32(float %12, float %i.aal, float %i.abe)
  %i.abg = fadd float %i.abd, %i.abf
  %i.abh = extractelement <4 x float> %i.abb, i64 2
  %i.abi = call noundef float @llvm.fmuladd.f32(float %32, float %i.aam, float %i.abh)
  %i.abj = load float, ptr %i.vs, align 8, !tbaa !19
  %i.abk = extractelement <4 x float> %i.abb, i64 3
  %i.abl = call noundef float @llvm.fmuladd.f32(float %i.ws, float %i.abj, float %i.abk)
