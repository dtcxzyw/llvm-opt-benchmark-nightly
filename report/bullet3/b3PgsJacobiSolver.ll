...
bb.i:                                             ; preds = %.thread170, %.thread158
  ...
  %.089162 = phi float [ %i.fw, %.thread170 ], [ %i.gz, %.thread158 ]
  ...
  %.sroa.6136.8.vec.extract = load float, ptr %.sroa.6136.0..sroa_idx, align 8, !tbaa !17
  ...
  %.sroa.6132.8.vec.extract = load float, ptr %.sroa.6132.0..sroa_idx, align 8, !tbaa !17
  %i.hl = shufflevector <2 x float> %i.ab, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %15 = insertelement <2 x float> poison, float %.sroa.6136.8.vec.extract, i64 0
  %16 = insertelement <2 x float> %15, float %.sroa.6132.8.vec.extract, i64 1
  %i.hm = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.hl, <2 x float> %16, <2 x float> %i.hk)
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %.089161180197 = phi float [ %i.ho, %bb.j ], [ %.089162, %bb.i ]
  ...
  %i.il = fmul float %.089161180197, %i.ik
...
bb.g:                                             ; preds = %bb.f
  ...
  %.sroa.696.8.vec.extract = load float, ptr %.sroa.696.0..sroa_idx, align 8, !tbaa !17
  ...
  %.sroa.694.8.vec.extract = load float, ptr %.sroa.694.0..sroa_idx, align 8, !tbaa !17
  %15 = insertelement <2 x float> poison, float %i.fo, i64 0
  %i.fz = insertelement <2 x float> %15, float %i.ey, i64 1
  %i.ga = insertelement <2 x float> poison, float %.sroa.694.8.vec.extract, i64 0
  %16 = insertelement <2 x float> %i.ga, float %.sroa.696.8.vec.extract, i64 1
  %i.gb = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.fz, <2 x float> %16, <2 x float> %i.fy)
...
bb.a:
  ...
  %.sroa.0.0.copyload.i178 = load <2 x float>, ptr %i.a, align 16
  %.sroa.2.0..sroa_idx.i179 = getelementptr inbounds nuw i8, ptr %6, i64 24
  %.sroa.2.0.copyload.i180 = load <2 x float>, ptr %.sroa.2.0..sroa_idx.i179, align 8, !tbaa !17
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !27   ; 2 uses
  ...
  %.sroa.5296.8.vec.extract = load float, ptr %.sroa.2.0..sroa_idx.i, align 8, !tbaa !17
  %i.s = getelementptr inbounds nuw i8, ptr %i.e, i64 56
  %i.t = load float, ptr %i.s, align 8, !tbaa !17
  %i.u = fsub float %.sroa.5296.8.vec.extract, %i.t
  ...
  %i.x = fsub <2 x float> %.sroa.0.0.copyload.i178, %i.w
  %.sroa.5294.8.vec.extract = extractelement <2 x float> %.sroa.2.0.copyload.i180, i64 0
  %i.y = getelementptr inbounds nuw i8, ptr %i.g, i64 56
  %i.z = load float, ptr %i.y, align 8, !tbaa !17
  %i.aa = fsub float %.sroa.5294.8.vec.extract, %i.z
  %.sroa.3.12.vec.insert.i.i185 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.aa, i64 0
  store <2 x float> %i.x, ptr %12, align 16
  %.sroa.443.0..sroa_idx = getelementptr inbounds nuw i8, ptr %12, i64 8 ; 3 uses
  store <2 x float> %.sroa.3.12.vec.insert.i.i185, ptr %.sroa.443.0..sroa_idx, align 8, !tbaa !17
  ...
  %.sroa.3.12.vec.insert.i.i190 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.au, i64 0
...
bb.b:                                             ; preds = %bb.a
  ...
  %.sroa.0.0.vec.insert.i.i193 = insertelement <2 x float> poison, float %i.bh, i64 0
  %i.cb = shufflevector <2 x float> %.sroa.0.0.vec.insert.i.i193, <2 x float> %i.ca, <2 x i32> <i32 0, i32 2>
  %i.cc = shufflevector <2 x float> <float poison, float 0.000000e+00>, <2 x float> %i.ca, <2 x i32> <i32 3, i32 1>
  %.fca.0.insert.i.i196 = insertvalue { <2 x float>, <2 x float> } poison, <2 x float> %i.cb, 0
  %.fca.1.insert.i.i197 = insertvalue { <2 x float>, <2 x float> } %.fca.0.insert.i.i196, <2 x float> %i.cc, 1
  br label %bb.c

bb.c:                                             ; preds = %bb.a, %bb.b
  %.pn = phi { <2 x float>, <2 x float> } [ %.fca.1.insert.i.i197, %bb.b ], [ zeroinitializer, %bb.a ] ; 2 uses
  ...
  br i1 %.not, label %.thread301, label %bb.d

.thread301:                                       ; preds = %bb.c
...
bb.d:                                             ; preds = %bb.c
  ...
  %.sroa.3.12.vec.insert.i.i210 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.ej, i64 0
  ...
  store <2 x float> %.sroa.3.12.vec.insert.i.i210, ptr %.sroa.539.0..sroa_idx, align 8, !tbaa !17
...
begin_hunk_2_@_ZN17b3PgsJacobiSolver22setupContactConstraintEP15b3RigidBodyDataP13b3InertiaDataR18b3SolverConstraintiiR14b3ContactPointRK19b3ContactSolverInfoR9b3Vector3RfSD_SC_SC_:bb.a
  ...
  store <2 x float> %.sroa.3.12.vec.insert.i.i240337, ptr %.sroa.4.0..sroa_idx, align 8, !tbaa !17
  ...
  %i.kh = fcmp ole float %i.kg, 0.000000e+00
  %spec.store.select = select i1 %i.kh, float 0.000000e+00, float %i.kg
  %i.ki = getelementptr inbounds nuw i8, ptr %7, i64 64
  %i.kj = load i32, ptr %i.ki, align 4, !tbaa !71
  %i.kk = and i32 %i.kj, 4
  %.not175 = icmp eq i32 %i.kk, 0
  br i1 %.not175, label %bb.o, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.kl = getelementptr inbounds nuw i8, ptr %6, i64 48
  %i.km = load float, ptr %i.kl, align 16, !tbaa !9
  %i.kn = getelementptr inbounds nuw i8, ptr %7, i64 60
  %i.ko = load float, ptr %i.kn, align 4, !tbaa !103
  %i.kp = fmul float %i.km, %i.ko                 ; 4 uses
  %i.kq = getelementptr inbounds nuw i8, ptr %3, i64 84 ; 2 uses
  store float %i.kp, ptr %i.kq, align 4, !tbaa !74
  br i1 %.not, label %.thread313, label %.thread314

.thread313:                                       ; preds = %bb.n
  %i.kr = getelementptr inbounds nuw i8, ptr %3, i64 80
  store float 0.000000e+00, ptr %i.kr, align 16, !tbaa !80
  br label %bb.q

.thread314:                                       ; preds = %bb.n
  %i.ks = getelementptr inbounds nuw i8, ptr %i.e, i64 128
  %i.kt = getelementptr inbounds nuw i8, ptr %3, i64 24 ; 2 uses
  %i.ku = load float, ptr %i.kt, align 8, !tbaa !17
  %i.kv = getelementptr inbounds nuw i8, ptr %i.e, i64 136
  %i.kw = load float, ptr %i.kv, align 8, !tbaa !17
  %i.kx = fmul float %i.ku, %i.kw
  %i.ky = fmul float %i.kp, %i.kx
  %i.kz = getelementptr inbounds nuw i8, ptr %i.e, i64 112
  %i.la = getelementptr inbounds nuw i8, ptr %i.e, i64 120
  %i.lb = load float, ptr %i.la, align 8, !tbaa !17
  %i.lc = fmul float %i.ky, %i.lb
  %i.ld = getelementptr inbounds nuw i8, ptr %i.e, i64 64 ; 2 uses
  %i.le = load <2 x float>, ptr %i.hh, align 16, !tbaa !17
  %i.lf = load <2 x float>, ptr %i.ks, align 16, !tbaa !17
  %i.lg = fmul <2 x float> %i.le, %i.lf
  %i.lh = insertelement <2 x float> poison, float %i.kp, i64 0
  %i.li = shufflevector <2 x float> %i.lh, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.lj = fmul <2 x float> %i.li, %i.lg
  %i.lk = load <2 x float>, ptr %i.kz, align 16, !tbaa !17
  %i.ll = fmul <2 x float> %i.lj, %i.lk
  %i.lm = load <2 x float>, ptr %i.ld, align 16, !tbaa !17
  %i.ln = fadd <2 x float> %i.ll, %i.lm
  store <2 x float> %i.ln, ptr %i.ld, align 16, !tbaa !17
  %i.lo = getelementptr inbounds nuw i8, ptr %i.e, i64 72 ; 2 uses
  %i.lp = load float, ptr %i.lo, align 8, !tbaa !17
  %i.lq = fadd float %i.lc, %i.lp
  store float %i.lq, ptr %i.lo, align 8, !tbaa !17
  %i.lr = getelementptr inbounds nuw i8, ptr %i.e, i64 96
  %i.ls = getelementptr inbounds nuw i8, ptr %i.e, i64 104
  %i.lt = load float, ptr %i.ls, align 8, !tbaa !17
  %i.lu = fmul float %i.kp, %i.lt
  %i.lv = load float, ptr %.sroa.541.0..sroa_idx, align 8, !tbaa !17
  %i.lw = fmul float %i.lu, %i.lv
  %i.lx = getelementptr inbounds nuw i8, ptr %i.e, i64 80 ; 2 uses
  %i.ly = load <2 x float>, ptr %i.lr, align 16, !tbaa !17
  %i.lz = fmul <2 x float> %i.li, %i.ly
  %i.ma = load <2 x float>, ptr %i.cd, align 16, !tbaa !17
  %i.mb = fmul <2 x float> %i.lz, %i.ma
  %i.mc = load <2 x float>, ptr %i.lx, align 16, !tbaa !17
  %i.md = fadd <2 x float> %i.mb, %i.mc
  store <2 x float> %i.md, ptr %i.lx, align 16, !tbaa !17
  %i.me = getelementptr inbounds nuw i8, ptr %i.e, i64 88 ; 2 uses
  %i.mf = load float, ptr %i.me, align 8, !tbaa !17
  %i.mg = fadd float %i.lw, %i.mf
  store float %i.mg, ptr %i.me, align 8, !tbaa !17
  %i.mh = getelementptr inbounds nuw i8, ptr %i.g, i64 128
  %i.mi = load float, ptr %i.kt, align 8, !tbaa !17
  %i.mj = getelementptr inbounds nuw i8, ptr %i.g, i64 136
  %i.mk = load float, ptr %i.mj, align 8, !tbaa !17
  %i.ml = fmul float %i.mi, %i.mk
  %i.mm = load float, ptr %i.ga, align 16, !tbaa !17
  %i.mn = getelementptr inbounds nuw i8, ptr %3, i64 68
  %i.mo = load float, ptr %i.mn, align 4, !tbaa !17
  %i.mp = getelementptr inbounds nuw i8, ptr %3, i64 72
  %i.mq = load float, ptr %i.mp, align 8, !tbaa !17
  %i.mr = load float, ptr %i.kq, align 4, !tbaa !74
  %i.ms = fneg float %i.mr                        ; 3 uses
  %i.mt = fmul float %i.ml, %i.ms
  %i.mu = getelementptr inbounds nuw i8, ptr %i.g, i64 112
  %i.mv = getelementptr inbounds nuw i8, ptr %i.g, i64 120
  %i.mw = load float, ptr %i.mv, align 8, !tbaa !17
  %i.mx = fmul float %i.mt, %i.mw
  %i.my = getelementptr inbounds nuw i8, ptr %i.g, i64 64 ; 2 uses
  %i.mz = load <2 x float>, ptr %i.hh, align 16, !tbaa !17
  %i.na = load <2 x float>, ptr %i.mh, align 16, !tbaa !17
  %i.nb = fmul <2 x float> %i.mz, %i.na
  %i.nc = insertelement <2 x float> poison, float %i.ms, i64 0
  %i.nd = shufflevector <2 x float> %i.nc, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.ne = fmul <2 x float> %i.nb, %i.nd
  %i.nf = load <2 x float>, ptr %i.mu, align 16, !tbaa !17
  %i.ng = fmul <2 x float> %i.ne, %i.nf
  %i.nh = load <2 x float>, ptr %i.my, align 16, !tbaa !17
  %i.ni = fadd <2 x float> %i.ng, %i.nh
  store <2 x float> %i.ni, ptr %i.my, align 16, !tbaa !17
  %i.nj = getelementptr inbounds nuw i8, ptr %i.g, i64 72 ; 2 uses
  %i.nk = load float, ptr %i.nj, align 8, !tbaa !17
  %i.nl = fadd float %i.mx, %i.nk
  store float %i.nl, ptr %i.nj, align 8, !tbaa !17
  %i.nm = getelementptr inbounds nuw i8, ptr %i.g, i64 96
  %i.nn = getelementptr inbounds nuw i8, ptr %i.g, i64 104
  %i.no = load float, ptr %i.nn, align 8, !tbaa !17
  %i.np = fmul float %i.no, %i.ms
  %i.nq = getelementptr inbounds nuw i8, ptr %i.g, i64 80 ; 2 uses
  %i.nr = load <2 x float>, ptr %i.nm, align 16, !tbaa !17
  %i.ns = fmul <2 x float> %i.nr, %i.nd
  %i.nt = load <2 x float>, ptr %i.nq, align 16, !tbaa !17
  %i.nu = insertelement <2 x float> poison, float %i.mm, i64 0
  %i.nv = insertelement <2 x float> %i.nu, float %i.mo, i64 1
  %i.nw = fmul <2 x float> %i.nv, %i.ns
  %i.nx = fsub <2 x float> %i.nt, %i.nw
  store <2 x float> %i.nx, ptr %i.nq, align 16, !tbaa !17
  %i.ny = getelementptr inbounds nuw i8, ptr %i.g, i64 88 ; 2 uses
  %i.nz = load float, ptr %i.ny, align 8, !tbaa !17
  %i.oa = fmul float %i.mq, %i.np
  %i.ob = fsub float %i.nz, %i.oa
  store float %i.ob, ptr %i.ny, align 8, !tbaa !17
  %i.oc = getelementptr inbounds nuw i8, ptr %3, i64 80
  store float 0.000000e+00, ptr %i.oc, align 16, !tbaa !80
  br label %bb.p

bb.o:                                             ; preds = %bb.m
  %i.od = getelementptr inbounds nuw i8, ptr %3, i64 80
  store <2 x float> zeroinitializer, ptr %i.od, align 16, !tbaa !14
  br i1 %.not, label %bb.q, label %bb.p

bb.p:                                             ; preds = %.thread314, %bb.o
  %i.oe = getelementptr inbounds nuw i8, ptr %i.e, i64 176
  %.sroa.0262.0.copyload = load <2 x float>, ptr %i.oe, align 16
  %.sroa.6263.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.e, i64 184
  %.sroa.6263.0.copyload = load <2 x float>, ptr %.sroa.6263.0..sroa_idx, align 8, !tbaa !17
  br label %bb.q

bb.q:                                             ; preds = %bb.o, %.thread313, %bb.p
  %.sroa.6263.0 = phi <2 x float> [ %.sroa.6263.0.copyload, %bb.p ], [ zeroinitializer, %.thread313 ], [ zeroinitializer, %bb.o ]
  %.sroa.0262.0 = phi <2 x float> [ %.sroa.0262.0.copyload, %bb.p ], [ zeroinitializer, %.thread313 ], [ zeroinitializer, %bb.o ] ; 2 uses
  %i.of = load float, ptr %i.hh, align 16, !tbaa !17 ; 3 uses
  %.sroa.0262.0.vec.extract = extractelement <2 x float> %.sroa.0262.0, i64 0
  %i.og = getelementptr inbounds nuw i8, ptr %3, i64 20
  %i.oh = load float, ptr %i.og, align 4, !tbaa !17 ; 3 uses
  %.sroa.0262.4.vec.extract = extractelement <2 x float> %.sroa.0262.0, i64 1
  %i.oi = fmul float %.sroa.0262.4.vec.extract, %i.oh
  %i.oj = tail call float @llvm.fmuladd.f32(float %i.of, float %.sroa.0262.0.vec.extract, float %i.oi)
  %i.ok = getelementptr inbounds nuw i8, ptr %3, i64 24
  %i.ol = load float, ptr %i.ok, align 8, !tbaa !17 ; 3 uses
  %.sroa.6263.8.vec.extract = extractelement <2 x float> %.sroa.6263.0, i64 0
  %i.om = tail call noundef float @llvm.fmuladd.f32(float %i.ol, float %.sroa.6263.8.vec.extract, float %i.oj)
  br i1 %.not, label %bb.s, label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.on = getelementptr inbounds nuw i8, ptr %i.e, i64 192
  %.sroa.0260.0.copyload = load <2 x float>, ptr %i.on, align 16
  %.sroa.6261.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.e, i64 200
  %.sroa.6261.0.copyload = load <2 x float>, ptr %.sroa.6261.0..sroa_idx, align 8, !tbaa !17
  br label %bb.s

bb.s:                                             ; preds = %bb.q, %bb.r
  %.sroa.6261.0 = phi <2 x float> [ %.sroa.6261.0.copyload, %bb.r ], [ zeroinitializer, %bb.q ]
  %.sroa.0260.0 = phi <2 x float> [ %.sroa.0260.0.copyload, %bb.r ], [ zeroinitializer, %bb.q ] ; 2 uses
  %i.oo = load float, ptr %3, align 16, !tbaa !17
  %.sroa.0260.0.vec.extract = extractelement <2 x float> %.sroa.0260.0, i64 0
  %i.op = getelementptr inbounds nuw i8, ptr %3, i64 4
  %i.oq = load float, ptr %i.op, align 4, !tbaa !17
  %.sroa.0260.4.vec.extract = extractelement <2 x float> %.sroa.0260.0, i64 1
  %i.or = fmul float %.sroa.0260.4.vec.extract, %i.oq
  %i.os = tail call float @llvm.fmuladd.f32(float %i.oo, float %.sroa.0260.0.vec.extract, float %i.or)
  %i.ot = load float, ptr %.sroa.6292.0..sroa_idx, align 8, !tbaa !17
  %.sroa.6261.8.vec.extract = extractelement <2 x float> %.sroa.6261.0, i64 0
  %i.ou = tail call noundef float @llvm.fmuladd.f32(float %i.ot, float %.sroa.6261.8.vec.extract, float %i.os)
  %i.ov = fadd float %i.om, %i.ou
  br i1 %.not, label %bb.u, label %bb.t

bb.t:                                             ; preds = %bb.s
  %i.ow = getelementptr inbounds nuw i8, ptr %i.g, i64 176
  %.sroa.0258.0.copyload = load <2 x float>, ptr %i.ow, align 16 ; 2 uses
  %.sroa.6259.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.g, i64 184
  %.sroa.0258.0.vec.extract = extractelement <2 x float> %.sroa.0258.0.copyload, i64 0
  %.sroa.0258.4.vec.extract = extractelement <2 x float> %.sroa.0258.0.copyload, i64 1
  %i.ox = fmul float %i.oh, %.sroa.0258.4.vec.extract
  %i.oy = tail call float @llvm.fmuladd.f32(float %i.of, float %.sroa.0258.0.vec.extract, float %i.ox)
  %.sroa.6259.8.vec.extract = load float, ptr %.sroa.6259.0..sroa_idx, align 8, !tbaa !17
  %i.oz = tail call noundef float @llvm.fmuladd.f32(float %i.ol, float %.sroa.6259.8.vec.extract, float %i.oy)
  %i.pa = getelementptr inbounds nuw i8, ptr %i.g, i64 192
  %.sroa.0.0.copyload = load <2 x float>, ptr %i.pa, align 16
  %.sroa.6.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.g, i64 200
  %.sroa.6.0.copyload = load <2 x float>, ptr %.sroa.6.0..sroa_idx, align 8, !tbaa !17
  br label %bb.v

bb.u:                                             ; preds = %bb.s
  %i.pb = fmul float %i.oh, 0.000000e+00
  %i.pc = tail call float @llvm.fmuladd.f32(float %i.of, float 0.000000e+00, float %i.pb)
  %i.pd = tail call noundef float @llvm.fmuladd.f32(float %i.ol, float 0.000000e+00, float %i.pc)
  br label %bb.v

bb.v:                                             ; preds = %bb.u, %bb.t
  %i.pe = phi float [ %i.pd, %bb.u ], [ %i.oz, %bb.t ]
  ...
  %i.pf = load float, ptr %i.hk, align 16, !tbaa !17
  %.sroa.0.0.vec.extract = extractelement <2 x float> %.sroa.0.0, i64 0
  %i.pg = getelementptr inbounds nuw i8, ptr %3, i64 36
  %i.ph = load float, ptr %i.pg, align 4, !tbaa !17
  %.sroa.0.4.vec.extract = extractelement <2 x float> %.sroa.0.0, i64 1
  %i.pi = fmul float %.sroa.0.4.vec.extract, %i.ph
  %i.pj = tail call float @llvm.fmuladd.f32(float %i.pf, float %.sroa.0.0.vec.extract, float %i.pi)
  %i.pk = load float, ptr %.sroa.422.0..sroa_idx, align 8, !tbaa !17
  %.sroa.6.8.vec.extract = extractelement <2 x float> %.sroa.6.0, i64 0
  %i.pl = tail call noundef float @llvm.fmuladd.f32(float %i.pk, float %.sroa.6.8.vec.extract, float %i.pj)
  %i.pm = fsub float %i.pl, %i.pe
  %i.pn = fadd float %i.ov, %i.pm
  %i.po = fsub float %spec.store.select, %i.pn    ; 2 uses
  %i.pp = getelementptr inbounds nuw i8, ptr %7, i64 44
  %i.pq = load i32, ptr %i.pp, align 4, !tbaa !69
  %.not176 = icmp eq i32 %i.pq, 0                 ; 2 uses
  %i.pr = fcmp ogt float %i.hp, 0.000000e+00
  br i1 %i.pr, label %bb.w, label %bb.x

bb.w:                                             ; preds = %bb.v
  %i.ps = getelementptr inbounds nuw i8, ptr %7, i64 12
  %i.pt = load float, ptr %i.ps, align 4, !tbaa !104
  %i.pu = fdiv float %i.hp, %i.pt
  %i.pv = fsub float %i.po, %i.pu
  br label %bb.y

bb.x:                                             ; preds = %bb.v
  %i.pw = getelementptr inbounds nuw i8, ptr %7, i64 48
  %i.px = load float, ptr %i.pw, align 4
  %i.py = fcmp ogt float %i.hp, %i.px
  %or.cond = select i1 %.not176, i1 true, i1 %i.py
  ...
  %i.pz = fneg float %i.hp
  %i.qa = fmul float %.0, %i.pz
  %i.qb = getelementptr inbounds nuw i8, ptr %7, i64 12
  %i.qc = load float, ptr %i.qb, align 4, !tbaa !104
  %i.qd = fdiv float %i.qa, %i.qc
  br label %bb.y

bb.y:                                             ; preds = %bb.x, %bb.w
  %.0157 = phi float [ 0.000000e+00, %bb.w ], [ %i.qd, %bb.x ]
  %.0156 = phi float [ %i.pv, %bb.w ], [ %i.po, %bb.x ]
  %i.qe = fmul float %.0161, %.0157               ; 2 uses
  %i.qf = fmul float %.0161, %.0156               ; 2 uses
  %i.qg = getelementptr inbounds nuw i8, ptr %7, i64 48
  %i.qh = load float, ptr %i.qg, align 4
  %i.qi = fcmp ogt float %i.hp, %i.qh
  %or.cond335 = select i1 %.not176, i1 true, i1 %i.qi ; 2 uses
  %i.qj = fadd float %i.qe, %i.qf
  %.sink328 = select i1 %or.cond335, float %i.qj, float %i.qf
  %.sink = select i1 %or.cond335, float 0.000000e+00, float %i.qe
  %i.qk = getelementptr inbounds nuw i8, ptr %3, i64 104
  store float %.sink328, ptr %i.qk, align 8, !tbaa !72
  %i.ql = getelementptr inbounds nuw i8, ptr %3, i64 120
  store float %.sink, ptr %i.ql, align 8, !tbaa !79
  %i.qm = getelementptr inbounds nuw i8, ptr %3, i64 108
  store <2 x float> zeroinitializer, ptr %i.qm, align 4, !tbaa !14
  %i.qn = getelementptr inbounds nuw i8, ptr %3, i64 116
  store float 1.000000e+10, ptr %i.qn, align 4, !tbaa !78
  ret void
}
