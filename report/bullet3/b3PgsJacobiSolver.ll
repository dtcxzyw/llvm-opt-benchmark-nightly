...
bb.cn:                                            ; preds = %bb.cm, %bb.cl
  ...
  %i.wz = insertelement <2 x float> poison, float %11, i64 0
  %i.xa = shufflevector <2 x float> %i.wz, <2 x float> poison, <2 x i32> zeroinitializer
  %12 = shufflevector <2 x float> %i.wx, <2 x float> %i.wy, <2 x i32> <i32 1, i32 3>
  %13 = fmul <2 x float> %i.xa, %12
  %14 = shufflevector <2 x float> %i.wx, <2 x float> %i.wy, <2 x i32> <i32 0, i32 2>
  ...
  %18 = insertelement <2 x float> poison, float %i.wq, i64 0
  %19 = insertelement <2 x float> %18, float %i.ww, i64 1
  %i.xb = insertelement <2 x float> poison, float %i.ws, i64 0
  %i.xc = shufflevector <2 x float> %i.xb, <2 x float> poison, <2 x i32> zeroinitializer
  %20 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %19, <2 x float> %i.xc, <2 x float> %17)
  %i.xd = getelementptr inbounds nuw i8, ptr %i.wm, i64 32 ; 2 uses
  %21 = load float, ptr %i.xd, align 16, !tbaa !17
  %i.xe = getelementptr inbounds nuw i8, ptr %i.wm, i64 36 ; 2 uses
  %i.xf = load float, ptr %i.xe, align 4, !tbaa !17
  %22 = fmul float %11, %i.xf
  %23 = call float @llvm.fmuladd.f32(float %21, float %10, float %22)
  %24 = getelementptr inbounds nuw i8, ptr %i.wm, i64 40 ; 2 uses
  %25 = load float, ptr %24, align 8, !tbaa !17
  %26 = call noundef float @llvm.fmuladd.f32(float %25, float %i.ws, float %23)
  %.sroa.3.12.vec.insert.i.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %26, i64 0
  %27 = getelementptr inbounds nuw i8, ptr %i.vx, i64 48
  store <2 x float> %20, ptr %27, align 16
  ...
  %28 = load i32, ptr %i.th, align 8, !tbaa !136
  %29 = sext i32 %28 to i64
  %30 = getelementptr inbounds [96 x i8], ptr %2, i64 %29 ; 10 uses
  %31 = getelementptr inbounds nuw i8, ptr %i.vx, i64 32
  %32 = load float, ptr %31, align 16, !tbaa !17  ; 7 uses
  %33 = getelementptr inbounds nuw i8, ptr %30, i64 4
  %34 = getelementptr inbounds nuw i8, ptr %i.vx, i64 36
  %35 = load float, ptr %34, align 4, !tbaa !17   ; 7 uses
  %36 = getelementptr inbounds nuw i8, ptr %30, i64 8 ; 2 uses
  %i.xg = load float, ptr %36, align 8, !tbaa !17
  %i.xh = getelementptr inbounds nuw i8, ptr %i.vx, i64 40
  %i.xi = load float, ptr %i.xh, align 8, !tbaa !17 ; 7 uses
  %i.xj = getelementptr inbounds nuw i8, ptr %30, i64 16 ; 2 uses
  %i.xk = getelementptr inbounds nuw i8, ptr %30, i64 20
  %i.xl = getelementptr inbounds nuw i8, ptr %30, i64 24 ; 2 uses
  %i.xm = load float, ptr %i.xl, align 8, !tbaa !17
  %i.xn = load <2 x float>, ptr %30, align 16, !tbaa !17 ; 2 uses
  ...
  %i.xq = fmul <2 x float> %38, %i.xp
  %i.xr = shufflevector <2 x float> %i.xn, <2 x float> %i.xo, <2 x i32> <i32 0, i32 2>
  %39 = insertelement <2 x float> poison, float %32, i64 0
  %i.xs = shufflevector <2 x float> %39, <2 x float> poison, <2 x i32> zeroinitializer
  %i.xt = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.xr, <2 x float> %i.xs, <2 x float> %i.xq)
  %40 = insertelement <2 x float> poison, float %i.xg, i64 0
  %i.xu = insertelement <2 x float> %40, float %i.xm, i64 1
  %i.xv = insertelement <2 x float> poison, float %i.xi, i64 0
  %41 = shufflevector <2 x float> %i.xv, <2 x float> poison, <2 x i32> zeroinitializer
  %i.xw = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.xu, <2 x float> %41, <2 x float> %i.xt)
  %i.xx = getelementptr inbounds nuw i8, ptr %30, i64 32 ; 2 uses
  %i.xy = load float, ptr %i.xx, align 16, !tbaa !17
  %i.xz = getelementptr inbounds nuw i8, ptr %30, i64 36 ; 2 uses
  %i.ya = load float, ptr %i.xz, align 4, !tbaa !17
  %i.yb = fmul float %35, %i.ya
  %i.yc = call float @llvm.fmuladd.f32(float %i.xy, float %32, float %i.yb)
  %i.yd = getelementptr inbounds nuw i8, ptr %30, i64 40 ; 2 uses
  %i.ye = load float, ptr %i.yd, align 8, !tbaa !17
  %i.yf = call noundef float @llvm.fmuladd.f32(float %i.ye, float %i.xi, float %i.yc)
  %.sroa.3.12.vec.insert.i.i443 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.yf, i64 0
  %42 = getelementptr inbounds nuw i8, ptr %i.vx, i64 64
  store <2 x float> %i.xw, ptr %42, align 16
  ...
  %43 = getelementptr inbounds nuw i8, ptr %i.vx, i64 16
  %i.yg = load float, ptr %43, align 16, !tbaa !17 ; 6 uses
  %i.yh = load float, ptr %i.vj, align 4, !tbaa !14 ; 3 uses
  %44 = fmul float %i.yg, %i.yh
  %45 = getelementptr inbounds nuw i8, ptr %i.vx, i64 20
  %i.yi = load float, ptr %45, align 4, !tbaa !17 ; 6 uses
  %46 = fmul float %i.yh, %i.yi
  %47 = getelementptr inbounds nuw i8, ptr %i.vx, i64 24
  %i.yj = load float, ptr %47, align 8, !tbaa !17 ; 6 uses
  %48 = fmul float %i.yh, %i.yj
  %i.yk = load float, ptr %i.wm, align 16, !tbaa !17
  %i.yl = load float, ptr %i.wn, align 4, !tbaa !17
  %i.ym = fmul float %11, %i.yl
  %i.yn = call float @llvm.fmuladd.f32(float %i.yk, float %10, float %i.ym)
  %i.yo = load float, ptr %i.wp, align 8, !tbaa !17
  %i.yp = call noundef float @llvm.fmuladd.f32(float %i.yo, float %i.ws, float %i.yn)
  %i.yq = load float, ptr %i.wt, align 16, !tbaa !17
  %i.yr = load float, ptr %i.wu, align 4, !tbaa !17
  %i.ys = fmul float %11, %i.yr
  %49 = call float @llvm.fmuladd.f32(float %i.yq, float %10, float %i.ys)
  %50 = load float, ptr %i.wv, align 8, !tbaa !17
  %i.yt = call noundef float @llvm.fmuladd.f32(float %50, float %i.ws, float %49)
  %51 = load float, ptr %i.xd, align 16, !tbaa !17
  %i.yu = load float, ptr %i.xe, align 4, !tbaa !17
  %52 = fmul float %11, %i.yu
  %i.yv = call float @llvm.fmuladd.f32(float %51, float %10, float %52)
  %i.yw = load float, ptr %24, align 8, !tbaa !17
  %53 = call noundef float @llvm.fmuladd.f32(float %i.yw, float %i.ws, float %i.yv)
  %54 = load float, ptr %i.vk, align 4, !tbaa !14 ; 3 uses
  %i.yx = fmul float %i.yg, %54
  %i.yy = fmul float %i.yi, %54
  %i.yz = fmul float %i.yj, %54
  %55 = load float, ptr %30, align 16, !tbaa !17
  %i.za = load float, ptr %33, align 4, !tbaa !17
  %56 = fmul float %35, %i.za
  %i.zb = call float @llvm.fmuladd.f32(float %55, float %32, float %56)
  %57 = load float, ptr %36, align 8, !tbaa !17
  %58 = call noundef float @llvm.fmuladd.f32(float %57, float %i.xi, float %i.zb)
  %59 = load float, ptr %i.xj, align 16, !tbaa !17
  %60 = load float, ptr %i.xk, align 4, !tbaa !17
  %61 = fmul float %35, %60
  %62 = call float @llvm.fmuladd.f32(float %59, float %32, float %61)
  %63 = load float, ptr %i.xl, align 8, !tbaa !17
  %64 = call noundef float @llvm.fmuladd.f32(float %63, float %i.xi, float %62)
  %65 = load float, ptr %i.xx, align 16, !tbaa !17
  %66 = load float, ptr %i.xz, align 4, !tbaa !17
  %67 = fmul float %35, %66
  %68 = call float @llvm.fmuladd.f32(float %65, float %32, float %67)
  %69 = load float, ptr %i.yd, align 8, !tbaa !17
  %70 = call noundef float @llvm.fmuladd.f32(float %69, float %i.xi, float %68)
  %71 = fmul float %i.yi, %46
  %72 = call float @llvm.fmuladd.f32(float %44, float %i.yg, float %71)
  %73 = call noundef float @llvm.fmuladd.f32(float %48, float %i.yj, float %72)
  %74 = fmul float %11, %i.yt
  %75 = call float @llvm.fmuladd.f32(float %i.yp, float %10, float %74)
  %76 = call noundef float @llvm.fmuladd.f32(float %53, float %i.ws, float %75)
  %77 = fadd float %73, %76
  %78 = fmul float %i.yi, %i.yy
  %79 = call float @llvm.fmuladd.f32(float %i.yx, float %i.yg, float %78)
  %80 = call noundef float @llvm.fmuladd.f32(float %i.yz, float %i.yj, float %79)
  %81 = fadd float %77, %80
  %82 = fmul float %35, %64
  %83 = call float @llvm.fmuladd.f32(float %58, float %32, float %82)
  %84 = call noundef float @llvm.fmuladd.f32(float %70, float %i.xi, float %83)
  %85 = fadd float %81, %84                       ; 2 uses
  %i.zc = call noundef float @llvm.fabs.f32(float %85)
  %i.zd = fcmp ogt float %i.zc, f0x34000000
  %i.ze = fdiv float 1.000000e+00, %85
  ...
  %i.zj = fmul float %i.yi, %i.zi
  %i.zk = call float @llvm.fmuladd.f32(float %i.yg, float %i.zh, float %i.zj)
  %i.zl = load float, ptr %i.vn, align 8, !tbaa !17
  %i.zm = call noundef float @llvm.fmuladd.f32(float %i.yj, float %i.zl, float %i.zk)
  %i.zn = load float, ptr %i.vo, align 16, !tbaa !17
  %i.zo = load float, ptr %i.vp, align 4, !tbaa !17
  %i.zp = fmul float %11, %i.zo
  %i.zq = call float @llvm.fmuladd.f32(float %10, float %i.zn, float %i.zp)
  ...
  %i.zw = fmul float %i.yi, %i.zv
  %i.zx = call float @llvm.fmuladd.f32(float %i.yg, float %i.zu, float %i.zw)
  %i.zy = load float, ptr %i.vt, align 8, !tbaa !17
  %i.zz = call noundef float @llvm.fmuladd.f32(float %i.yj, float %i.zy, float %i.zx)
  %i.aaa = load float, ptr %i.vu, align 16, !tbaa !17
  %i.aab = load float, ptr %i.vv, align 4, !tbaa !17
  %i.aac = fmul float %35, %i.aab
  %i.aad = call float @llvm.fmuladd.f32(float %32, float %i.aaa, float %i.aac)
  %i.aae = load float, ptr %i.vw, align 8, !tbaa !17
  %i.aaf = call noundef float @llvm.fmuladd.f32(float %i.xi, float %i.aae, float %i.aad)
