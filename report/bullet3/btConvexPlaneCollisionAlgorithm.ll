...
bb.b:                                             ; preds = %bb.a
  ...
  %i.jw = load ptr, ptr %i.q, align 8, !tbaa !32, !nonnull !30, !align !33 ; 7 uses
  ...
  %i.kc = load <2 x float>, ptr %i.jw, align 4, !tbaa !35 ; 2 uses
  %i.kd = load float, ptr %i.ae, align 4, !tbaa !35 ; 2 uses
  %i.ke = load float, ptr %i.j, align 4, !tbaa !35 ; 2 uses
  %i.kf = load float, ptr %i.iy, align 4, !tbaa !35 ; 2 uses
  %i.kg = load <2 x float>, ptr %i.jz, align 4, !tbaa !35 ; 2 uses
  %9 = insertelement <2 x float> poison, float %i.kd, i64 0
  %10 = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> zeroinitializer
  %11 = shufflevector <2 x float> %i.kc, <2 x float> %i.kg, <2 x i32> <i32 1, i32 3>
  %12 = fmul <2 x float> %10, %11
  %13 = shufflevector <2 x float> %i.kc, <2 x float> %i.kg, <2 x i32> <i32 0, i32 2>
  %i.kh = insertelement <2 x float> poison, float %i.ke, i64 0
  %14 = shufflevector <2 x float> %i.kh, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ki = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %13, <2 x float> %14, <2 x float> %12)
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.gm = load ptr, ptr %i.am, align 8, !tbaa !32, !nonnull !30, !align !33 ; 7 uses
  ...
  %i.gs = load <2 x float>, ptr %i.gm, align 4, !tbaa !35 ; 2 uses
  %i.gt = load float, ptr %i.aw, align 4, !tbaa !35 ; 2 uses
  %i.gu = load float, ptr %i.l, align 4, !tbaa !35 ; 2 uses
  %i.gv = load float, ptr %i.ax, align 4, !tbaa !35 ; 2 uses
  %i.gw = load <2 x float>, ptr %i.gp, align 4, !tbaa !35 ; 2 uses
  %9 = insertelement <2 x float> poison, float %i.gt, i64 0
  %10 = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> zeroinitializer
  %11 = shufflevector <2 x float> %i.gs, <2 x float> %i.gw, <2 x i32> <i32 1, i32 3>
  %12 = fmul <2 x float> %10, %11
  %13 = shufflevector <2 x float> %i.gs, <2 x float> %i.gw, <2 x i32> <i32 0, i32 2>
  %i.gx = insertelement <2 x float> poison, float %i.gu, i64 0
  %14 = shufflevector <2 x float> %i.gx, <2 x float> poison, <2 x i32> zeroinitializer
  %i.gy = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %13, <2 x float> %14, <2 x float> %12)
