...
bb.h:                                             ; preds = %bb.f
  ...
  %7 = load <2 x float>, ptr %i.cj, align 8, !tbaa !29, !noalias !226
  ...
  %i.df = shufflevector <4 x float> %8, <4 x float> %i.de, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  ...
  %9 = load <2 x float>, ptr %i.cp, align 8, !tbaa !29, !noalias !226
  ...
  %i.dm = shufflevector <4 x float> %10, <4 x float> %i.dl, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  ...
  %11 = load <2 x float>, ptr %i.cv, align 8, !tbaa !29, !noalias !226
  ...
  %i.dt = shufflevector <4 x float> %12, <4 x float> %i.ds, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
...
bb.e:                                             ; preds = %bb.c
  ...
  %i.de = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.dh = shufflevector <2 x float> %11, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.do = shufflevector <2 x float> %13, <2 x float> poison, <2 x i32> zeroinitializer
  %i.dp = fmul <2 x float> %i.do, %i.df
  %14 = insertelement <2 x float> poison, float %4, i64 0
  %i.dq = shufflevector <2 x float> %14, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.ds = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.du = shufflevector <2 x float> %16, <2 x float> poison, <2 x i32> zeroinitializer
  %i.dv = fmul <2 x float> %i.du, %i.df
  %17 = insertelement <2 x float> poison, float %7, i64 0
  %i.dw = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.dy = shufflevector <2 x float> %18, <2 x float> poison, <2 x i32> zeroinitializer
