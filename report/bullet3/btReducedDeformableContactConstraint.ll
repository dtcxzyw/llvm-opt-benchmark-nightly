...
bb.a:
  ...
  %1 = load <3 x float>, ptr %i.h, align 4, !tbaa !27 ; 5 uses
  %i.v = load float, ptr %i.n, align 4, !tbaa !27
  %2 = extractelement <3 x float> %1, i64 0
  %i.w = fmul float %i.i, %2
  %i.x = load <2 x float>, ptr %i.j, align 4, !tbaa !27
  %i.y = shufflevector <3 x float> %1, <3 x float> poison, <2 x i32> zeroinitializer
  %i.z = fmul <2 x float> %i.y, %i.x
  %i.aa = fmul float %i.o, %i.v
  %i.ab = load <2 x float>, ptr %i.p, align 4, !tbaa !27
  %3 = shufflevector <3 x float> %1, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.ac = fmul <2 x float> %3, %i.ab
  %i.ad = fadd float %i.w, %i.aa
  %i.ae = fadd <2 x float> %i.z, %i.ac
  %4 = extractelement <3 x float> %1, i64 2
  %5 = fmul float %i.t, %4
  %6 = load <2 x float>, ptr %i.u, align 4, !tbaa !27
  %7 = shufflevector <3 x float> %1, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.af = fmul <2 x float> %7, %6
  %i.ag = fadd float %i.ad, %5
...
bb.a:
  ...
  %i.q = getelementptr inbounds nuw i8, ptr %i.d, i64 32
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !113  ; 2 uses
  %i.s = getelementptr inbounds nuw i8, ptr %i.r, i64 140
  %i.t = load float, ptr %i.s, align 4, !tbaa !27
