...
bb.a:
  ...
  %14 = load float, ptr %i.aa, align 4, !tbaa !13
  ...
  %15 = load <2 x float>, ptr %i.w, align 8, !tbaa !13
  ...
  %i.bc = insertelement <2 x float> %17, float %i.ap, i64 1
...
bb.b:                                             ; preds = %bb.a
  ...
  %3 = load float, ptr %i.av, align 4, !tbaa !13
...
bb.d:                                             ; preds = %bb.c
  %4 = load float, ptr %i.x, align 8, !tbaa !13
...
bb.e:                                             ; preds = %bb.c
  %5 = load float, ptr %i.u, align 8, !tbaa !13
...
bb.h:                                             ; preds = %bb.g
  ...
  %6 = load float, ptr %i.ap, align 4, !tbaa !13
...
bb.j:                                             ; preds = %bb.i
  ...
  %7 = load float, ptr %i.bc, align 8, !tbaa !13
...
bb.a:                                             ; preds = %.peel.begin
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %10) #22
  %11 = load float, ptr %i.ae, align 8, !tbaa !13
  %.sroa.0.0.vec.insert.i.peel = insertelement <2 x float> poison, float %11, i64 0
...
bb.d:                                             ; preds = %bb.c
  ...
  %13 = load float, ptr %i.ba, align 8, !tbaa !13
