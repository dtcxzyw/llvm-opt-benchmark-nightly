...
.lr.ph168:                                        ; preds = %bb.h
  ...
  %10 = getelementptr inbounds nuw i8, ptr %i.cl, i64 36 ; 2 uses
  %11 = getelementptr inbounds nuw i8, ptr %i.cl, i64 40 ; 2 uses
...
._crit_edge169.loopexit.peel.begin:               ; preds = %.lr.ph168, %_ZN20btAlignedObjectArrayI9btVector3E6resizeEiRKS0_.exit114
  ...
  %12 = load float, ptr %10, align 4, !tbaa !18
  %13 = load float, ptr %i.cz, align 8, !tbaa !18
  %14 = load float, ptr %11, align 8, !tbaa !18
  ...
  %i.eu = fmul <2 x float> %i.el, %16
  %i.ev = fmul <2 x float> %i.ek, %16
  %17 = insertelement <2 x float> poison, float %13, i64 0
  %i.ew = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %i.ez = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.et, <2 x float> %19, <2 x float> %i.ex) ; 2 uses
  %i.fa = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ep, <2 x float> %19, <2 x float> %i.ey) ; 2 uses
...
bb.l:                                             ; preds = %.lr.ph168.split, %_ZN20btAlignedObjectArrayI9btVector3E6resizeEiRKS0_.exit114
  ...
  %20 = load float, ptr %10, align 4, !tbaa !18
  %21 = load float, ptr %i.cz, align 8, !tbaa !18
  %22 = load float, ptr %11, align 8, !tbaa !18
  ...
  %i.kq = fmul <2 x float> %i.kh, %24
  %i.kr = fmul <2 x float> %i.kg, %24
  %25 = insertelement <2 x float> poison, float %21, i64 0
  %i.ks = shufflevector <2 x float> %25, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %27 = shufflevector <2 x float> %26, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.kv = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.kp, <2 x float> %27, <2 x float> %i.kt) ; 2 uses
  %i.kw = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.kl, <2 x float> %27, <2 x float> %i.ku) ; 2 uses
