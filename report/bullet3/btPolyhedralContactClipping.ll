...
bb.b:                                             ; preds = %.lr.ph, %.thread
  ...
  %i.do = load float, ptr %i.t, align 4, !tbaa !18
  %i.dp = load float, ptr %i.v, align 4, !tbaa !18
  %i.dq = load float, ptr %i.x, align 4, !tbaa !18
  ...
  %i.ef = insertelement <3 x float> poison, float %i.dq, i64 0 ; 2 uses
  %i.eg = insertelement <3 x float> %i.ef, float %i.do, i64 1 ; 2 uses
  %i.eh = insertelement <3 x float> %i.eg, float %i.dp, i64 2 ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %23 = shufflevector <3 x float> %i.eh, <3 x float> poison, <2 x i32> <i32 2, i32 poison>
  %i.gg = insertelement <2 x float> %23, float %i.fi, i64 1
  %i.gh = fmul <2 x float> %i.gg, %i.fq
  %24 = shufflevector <3 x float> %i.eg, <3 x float> poison, <2 x i32> <i32 1, i32 poison>
  ...
  %25 = shufflevector <3 x float> %i.ef, <3 x float> poison, <2 x i32> <i32 0, i32 poison>
...
bb.j:                                             ; preds = %.lr.ph561, %.thread391
  ...
  %i.jg = load float, ptr %i.az, align 4, !tbaa !18
  %i.jh = load float, ptr %i.bb, align 4, !tbaa !18
  %i.ji = load float, ptr %i.bd, align 4, !tbaa !18
...
bb.m:                                             ; preds = %bb.l
  ...
  %26 = shufflevector <3 x float> %i.jz, <3 x float> poison, <2 x i32> <i32 poison, i32 2>
  %i.ly = insertelement <2 x float> %26, float %i.la, i64 0
  %i.lz = fmul <2 x float> %i.lj, %i.ly
  %27 = shufflevector <3 x float> %i.jy, <3 x float> poison, <2 x i32> <i32 poison, i32 1>
  %i.ma = insertelement <2 x float> %27, float %i.kz, i64 0
  %i.mb = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ma, <2 x float> %i.ln, <2 x float> %i.lz)
  %28 = shufflevector <3 x float> %i.jx, <3 x float> poison, <2 x i32> <i32 poison, i32 0>
  %i.mc = insertelement <2 x float> %28, float %i.lb, i64 0
...
.lr.ph579:                                        ; preds = %.lr.ph579.preheader, %bb.aa
  ...
  %i.pb = load float, ptr %i.az, align 4, !tbaa !18
  %i.pc = load float, ptr %i.bb, align 4, !tbaa !18
  %i.pd = load float, ptr %i.bd, align 4, !tbaa !18
  ...
  %i.ps = insertelement <3 x float> poison, float %i.pc, i64 0 ; 2 uses
  %i.pt = insertelement <3 x float> %i.ps, float %i.pd, i64 1 ; 2 uses
  %i.pu = insertelement <3 x float> %i.pt, float %i.pb, i64 2 ; 2 uses
...
bb.v:                                             ; preds = %bb.u
  ...
  %29 = shufflevector <3 x float> %i.ps, <3 x float> poison, <2 x i32> <i32 poison, i32 0>
  %i.sv = insertelement <2 x float> %29, float %i.rx, i64 0
  %i.sw = fmul <2 x float> %i.sg, %i.sv
  %30 = shufflevector <3 x float> %i.pu, <3 x float> poison, <2 x i32> <i32 poison, i32 2>
  %i.sx = insertelement <2 x float> %30, float %i.rw, i64 0
  %i.sy = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.sx, <2 x float> %i.sk, <2 x float> %i.sw)
  %31 = shufflevector <3 x float> %i.pt, <3 x float> poison, <2 x i32> <i32 poison, i32 1>
  %i.sz = insertelement <2 x float> %31, float %i.ry, i64 0
