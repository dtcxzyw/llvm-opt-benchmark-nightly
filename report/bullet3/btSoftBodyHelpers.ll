...
bb.b:                                             ; preds = %bb.a
  ...
  %i.h = load float, ptr %i.g, align 8, !tbaa !9, !noalias !230 ; 2 uses
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 816
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 744
  %i.k = load float, ptr %i.j, align 8, !tbaa !9, !noalias !230
  ...
  %i.p = load float, ptr %i.o, align 8, !tbaa !9, !noalias !230 ; 2 uses
  ...
  %i.u = load float, ptr %i.t, align 8, !tbaa !9, !noalias !230 ; 2 uses
  %i.v = load <2 x float>, ptr %i.e, align 8, !tbaa !9, !noalias !230 ; 3 uses
  %i.w = load <2 x float>, ptr %i.m, align 4, !tbaa !9, !noalias !230 ; 5 uses
  %i.x = load float, ptr %i.q, align 8, !tbaa !9, !noalias !230
  %i.y = load <2 x float>, ptr %i.s, align 8, !tbaa !9, !noalias !230 ; 3 uses
  ...
  %i.as = load float, ptr %i.ar, align 8, !tbaa !9, !noalias !230 ; 3 uses
  %i.at = extractelement <2 x float> %i.w, i64 0
  %i.au = load float, ptr %i.l, align 4, !tbaa !9, !noalias !230 ; 3 uses
  %i.av = load float, ptr %i.f, align 8, !tbaa !9, !noalias !230 ; 2 uses
  %i.aw = load float, ptr %i.n, align 4, !tbaa !9, !noalias !230 ; 2 uses
  %i.ax = load float, ptr %i.i, align 8, !tbaa !9, !noalias !230 ; 2 uses
  %i.ay = load float, ptr %i.r, align 8, !tbaa !9, !noalias !230 ; 2 uses
  ...
  %i.bp = load float, ptr %i.ap, align 8, !tbaa !9, !noalias !230 ; 3 uses
