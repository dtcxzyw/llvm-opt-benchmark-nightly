...
bb.u:                                             ; preds = %.lr.ph, %bb.aj
  ...
  %i.gm = load ptr, ptr %i.gl, align 8, !tbaa !45 ; 2 uses
  ...
  %i.gq = getelementptr inbounds nuw i8, ptr %i.gm, i64 20
  ...
  %i.gw = getelementptr inbounds nuw i8, ptr %i.gu, i64 20
  ...
  %4 = load <2 x float>, ptr %i.gn, align 4, !tbaa !19 ; 3 uses
  %5 = load <2 x float>, ptr %i.gq, align 4, !tbaa !19 ; 2 uses
  %i.ha = load float, ptr %i.gr, align 4, !tbaa !19 ; 4 uses
  %i.hb = load float, ptr %i.gp, align 4, !tbaa !19 ; 3 uses
  %i.hc = load float, ptr %i.gs, align 4, !tbaa !19 ; 3 uses
  %6 = insertelement <2 x float> poison, float %i.hb, i64 0 ; 2 uses
  %7 = insertelement <2 x float> %6, float %i.ha, i64 1 ; 3 uses
  %8 = fsub <2 x float> %4, %7
  %i.hd = insertelement <2 x float> poison, float %i.ha, i64 0
  %i.he = insertelement <2 x float> %i.hd, float %i.hc, i64 1 ; 3 uses
  %9 = fsub <2 x float> %5, %i.he
  %10 = load <2 x float>, ptr %i.gv, align 4, !tbaa !19 ; 2 uses
  ...
  %13 = fsub <2 x float> %11, %12                 ; 5 uses
  %14 = load <2 x float>, ptr %i.gw, align 4, !tbaa !19 ; 3 uses
  %15 = shufflevector <2 x float> %14, <2 x float> %4, <2 x i32> <i32 0, i32 3>
  %16 = shufflevector <2 x float> %7, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.hf = fsub <2 x float> %15, %16               ; 5 uses
  %17 = fsub <2 x float> %10, %7
  %18 = shufflevector <2 x float> %14, <2 x float> %5, <2 x i32> <i32 1, i32 3>
  %19 = shufflevector <2 x float> %i.he, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %20 = fsub <2 x float> %18, %19                 ; 5 uses
  %i.hg = fsub <2 x float> %14, %i.he
  %i.hh = extractelement <2 x float> %20, i64 0   ; 2 uses
  %i.hi = fneg float %i.hh
  %i.hj = extractelement <2 x float> %13, i64 1   ; 2 uses
  %i.hk = fmul float %i.hj, %i.hi
  %i.hl = extractelement <2 x float> %20, i64 1   ; 2 uses
  %i.hm = extractelement <2 x float> %13, i64 0   ; 2 uses
  %i.hn = call float @llvm.fmuladd.f32(float %i.hl, float %i.hm, float %i.hk) ; 3 uses
  %21 = fneg <2 x float> %17
  %22 = fmul <2 x float> %9, %21
  %23 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %8, <2 x float> %i.hg, <2 x float> %22) ; 3 uses
  %i.ho = fmul float %i.hn, %i.hn
  %i.hp = extractelement <2 x float> %23, i64 1   ; 2 uses
  %i.hq = call float @llvm.fmuladd.f32(float %i.hp, float %i.hp, float %i.ho)
  %24 = extractelement <2 x float> %23, i64 0     ; 2 uses
  %i.hr = call noundef float @llvm.fmuladd.f32(float %24, float %24, float %i.hq)
  %sqrt.i.i.i = call noundef float @llvm.sqrt.f32(float %i.hr)
  %i.hs = fdiv float 1.000000e+00, %sqrt.i.i.i    ; 2 uses
  %i.ht = fmul float %i.hn, %i.hs                 ; 2 uses
  %25 = insertelement <2 x float> poison, float %i.hs, i64 0
  %26 = shufflevector <2 x float> %25, <2 x float> poison, <2 x i32> zeroinitializer
  %27 = fmul <2 x float> %23, %26                 ; 3 uses
  %i.hu = fsub float %i.gx, %i.hb
  %i.hv = fsub float %i.gy, %i.ha
  %i.hw = fsub float %i.gz, %i.hc
  %i.hx = fmul float %i.hv, %i.ht
  %28 = extractelement <2 x float> %27, i64 1
  %i.hy = call float @llvm.fmuladd.f32(float %i.hu, float %28, float %i.hx)
  %29 = extractelement <2 x float> %27, i64 0
  %i.hz = call noundef float @llvm.fmuladd.f32(float %i.hw, float %29, float %i.hy) ; 4 uses
  %i.ia = fmul float %i.ht, %i.hz
  %30 = insertelement <2 x float> poison, float %i.hz, i64 0
  %31 = shufflevector <2 x float> %30, <2 x float> poison, <2 x i32> zeroinitializer
  %32 = fmul <2 x float> %27, %31
  %i.ib = fsub float %i.gy, %i.ia
  %33 = insertelement <2 x float> poison, float %i.gz, i64 0
  %34 = insertelement <2 x float> %33, float %i.gx, i64 1
  %35 = fsub <2 x float> %34, %32
  %i.ic = fsub float %i.ib, %i.ha                 ; 2 uses
  %36 = insertelement <2 x float> poison, float %i.hc, i64 0
  %37 = insertelement <2 x float> %36, float %i.hb, i64 1
  %38 = fsub <2 x float> %35, %37                 ; 2 uses
  %shift = shufflevector <2 x float> %i.hf, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop = fmul <2 x float> %shift, %i.hf
  %39 = extractelement <2 x float> %foldExtExtBinop, i64 0
  %i.id = call float @llvm.fmuladd.f32(float %i.hj, float %i.hm, float %39)
  %i.ie = call noundef float @llvm.fmuladd.f32(float %i.hl, float %i.hh, float %i.id) ; 3 uses
  %i.if = fmul <2 x float> %i.hf, %i.hf
  %i.ig = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %13, <2 x float> %13, <2 x float> %i.if)
  %i.ih = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %20, <2 x float> %20, <2 x float> %i.ig) ; 3 uses
  %i.ii = shufflevector <2 x float> %i.hf, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.ij = insertelement <2 x float> %i.ii, float %i.ic, i64 0
  %i.ik = insertelement <2 x float> %i.ii, float %i.ic, i64 1
  %i.il = fmul <2 x float> %i.ij, %i.ik
  %40 = shufflevector <2 x float> %38, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.im = shufflevector <2 x float> %13, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.in = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %40, <2 x float> %i.im, <2 x float> %i.il)
  %i.io = shufflevector <2 x float> %38, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ip = shufflevector <2 x float> %20, <2 x float> poison, <2 x i32> <i32 1, i32 0>
