...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %._crit_edge
  ...
  %12 = load float, ptr %1, align 4, !tbaa !9
  ...
  %17 = insertelement <2 x float> %16, float %i.z, i64 1
  %i.ae = insertelement <2 x float> poison, float %14, i64 0
  %i.af = insertelement <2 x float> %i.ae, float %i.y, i64 1 ; 2 uses
  %i.ag = fsub <2 x float> %17, %i.af
  ...
  %18 = insertelement <4 x float> poison, float %13, i64 0
  %19 = insertelement <4 x float> %18, float %i.ab, i64 1
  %i.am = insertelement <4 x float> %19, float %i.ad, i64 2
  %i.an = insertelement <4 x float> %i.am, float %i.al, i64 3
  %i.ao = insertelement <4 x float> poison, float %12, i64 0
  %i.ap = insertelement <4 x float> %i.ao, float %i.aa, i64 1
  %i.aq = insertelement <4 x float> %i.ap, float %i.ac, i64 2
  %i.ar = insertelement <4 x float> %i.aq, float %i.ak, i64 3 ; 2 uses
  %i.as = fsub <4 x float> %i.an, %i.ar
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %._crit_edge
  ...
  %12 = load float, ptr %10, align 4, !tbaa !9
  %13 = load float, ptr %11, align 4, !tbaa !9
  ...
  %15 = insertelement <2 x float> %14, float %i.ad, i64 1
  %i.ae = insertelement <2 x float> poison, float %12, i64 0
  %i.af = insertelement <2 x float> %i.ae, float %i.ac, i64 1 ; 2 uses
  %i.ag = fsub <2 x float> %15, %i.af
