...
.lr.ph1360:                                       ; preds = %.lr.ph1360.preheader, %bb.h
  %.01991358 = phi i32 [ %i.dh, %bb.h ], [ %i.dc, %.lr.ph1360.preheader ] ; 2 uses
  %.02001357 = phi i32 [ %.01991358, %bb.h ], [ %i.de, %.lr.ph1360.preheader ]
  %.02011356 = phi ptr [ %i.dy, %bb.h ], [ %i.df, %.lr.ph1360.preheader ] ; 3 uses
  %i.dg = getelementptr inbounds nuw i8, ptr %.02011356, i64 8
  %i.dh = load i32, ptr %i.dg, align 4, !tbaa !68 ; 2 uses
  %i.di = load ptr, ptr %i.m, align 8, !tbaa !40  ; 3 uses
  %i.dj = sext i32 %.02001357 to i64
  %i.dk = getelementptr inbounds [16 x i8], ptr %i.di, i64 %i.dj
  %i.dl = sext i32 %.01991358 to i64
...
bb.h:                                             ; preds = %.lr.ph1360
  %i.ds = getelementptr inbounds nuw i8, ptr %.02011356, i64 4
  %i.dt = load i32, ptr %i.ds, align 4, !tbaa !65
  %i.du = sext i32 %i.dt to i64
  %i.dv = getelementptr inbounds [12 x i8], ptr %.02011356, i64 %i.du ; 2 uses
