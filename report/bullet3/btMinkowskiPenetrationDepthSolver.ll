...
bb.c:                                             ; preds = %.preheader330, %bb.c
  ...
  %i.w = getelementptr inbounds nuw [16 x i8], ptr @_ZZN33btMinkowskiPenetrationDepthSolver24getPenetrationDirectionsEvE22sPenetrationDirections, i64 %indvars.iv ; 2 uses
  %.sroa.5277.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %i.w, i64 4
  %.sroa.5277.0.copyload = load float, ptr %.sroa.5277.0..sroa_idx.a, align 4 ; 2 uses
  %19 = load <3 x float>, ptr %i.w, align 16      ; 5 uses
  %20 = extractelement <3 x float> %19, i64 0     ; 2 uses
  %21 = fneg <3 x float> %19                      ; 5 uses
  %22 = fneg float %20
  %23 = load <2 x float>, ptr %4, align 4, !tbaa !10
  %24 = load <2 x float>, ptr %i.j, align 4, !tbaa !10
  %25 = shufflevector <3 x float> %21, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %26 = fmul <2 x float> %24, %25
  %27 = shufflevector <3 x float> %21, <3 x float> poison, <2 x i32> zeroinitializer
  %28 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %23, <2 x float> %27, <2 x float> %26)
  %29 = load <2 x float>, ptr %i.k, align 4, !tbaa !10
  %30 = shufflevector <3 x float> %21, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %31 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %29, <2 x float> %30, <2 x float> %28)
  %32 = load float, ptr %i.m, align 4, !tbaa !10
  %33 = load float, ptr %i.n, align 4, !tbaa !10
  %34 = extractelement <3 x float> %21, i64 1
  %35 = fmul float %33, %34
  %36 = tail call float @llvm.fmuladd.f32(float %32, float %22, float %35)
  %37 = load float, ptr %i.o, align 4, !tbaa !10
  %38 = extractelement <3 x float> %21, i64 2
  %39 = tail call noundef float @llvm.fmuladd.f32(float %37, float %38, float %36)
  %.sroa.3.12.vec.insert.i142 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %39, i64 0
  %40 = getelementptr inbounds nuw [16 x i8], ptr %12, i64 %indvars.iv ; 2 uses
  store <2 x float> %31, ptr %40, align 16
  %.sroa.434.0..sroa_idx = getelementptr inbounds nuw i8, ptr %40, i64 8
  store <2 x float> %.sroa.3.12.vec.insert.i142, ptr %.sroa.434.0..sroa_idx, align 8, !tbaa !11
  %41 = extractelement <3 x float> %19, i64 2
  ...
  %i.ac = shufflevector <3 x float> %19, <3 x float> poison, <2 x i32> zeroinitializer
  ...
  %42 = shufflevector <3 x float> %19, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.af = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ae, <2 x float> %42, <2 x float> %i.ad)
  %i.ag = load float, ptr %i.s, align 4, !tbaa !10
  %i.ah = load float, ptr %i.t, align 4, !tbaa !10
  %i.ai = fmul float %.sroa.5277.0.copyload, %i.ah
  %i.aj = tail call float @llvm.fmuladd.f32(float %i.ag, float %20, float %i.ai)
  %i.ak = load float, ptr %i.u, align 4, !tbaa !10
  %i.al = tail call noundef float @llvm.fmuladd.f32(float %i.ak, float %41, float %i.aj)
