...
bb.c:                                             ; preds = %.lr.ph74, %bb.c
  ...
  %20 = load <3 x float>, ptr %i.ch, align 16, !tbaa !89 ; 5 uses
  %21 = load float, ptr %i.ch, align 16, !tbaa !89
  %22 = shufflevector <3 x float> %20, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.dq = insertelement <2 x float> poison, float %i.dj, i64 0
  %23 = insertelement <2 x float> %i.dq, float %i.di, i64 1
  %24 = fmul <2 x float> %22, %23
  %i.dr = shufflevector <3 x float> %20, <3 x float> poison, <2 x i32> zeroinitializer
  %i.ds = insertelement <2 x float> poison, float %i.dg, i64 0
  %i.dt = insertelement <2 x float> %i.ds, float %i.df, i64 1
  %i.du = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dr, <2 x float> %i.dt, <2 x float> %24)
  %25 = shufflevector <3 x float> %20, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %26 = insertelement <2 x float> poison, float %i.dl, i64 0
  %i.dv = insertelement <2 x float> %26, float %i.dk, i64 1
  %27 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %25, <2 x float> %i.dv, <2 x float> %i.du)
  %28 = extractelement <3 x float> %20, i64 1
  %i.dw = fmul float %28, %i.dn
  %i.dx = tail call float @llvm.fmuladd.f32(float %21, float %i.dm, float %i.dw)
  %29 = extractelement <3 x float> %20, i64 2
  %i.dy = tail call noundef float @llvm.fmuladd.f32(float %29, float %i.dp, float %i.dx)
  %i.dz = fadd <2 x float> %i.cj, %27
