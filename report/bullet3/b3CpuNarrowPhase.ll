...
bb.c:                                             ; preds = %.lr.ph74, %bb.c
  ...
  %20 = getelementptr inbounds nuw i8, ptr %i.ch, i64 4
  %21 = getelementptr inbounds nuw i8, ptr %i.ch, i64 8
  ...
  %22 = load float, ptr %20, align 4, !tbaa !80   ; 2 uses
  %23 = load float, ptr %i.ch, align 16, !tbaa !80 ; 2 uses
  %i.dq = load float, ptr %21, align 8, !tbaa !80 ; 2 uses
  ...
  %i.dt = fmul <2 x float> %25, %i.ds
  %26 = insertelement <2 x float> poison, float %23, i64 0
  %i.du = shufflevector <2 x float> %26, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %27 = insertelement <2 x float> poison, float %i.dq, i64 0
  %28 = shufflevector <2 x float> %27, <2 x float> poison, <2 x i32> zeroinitializer
  %i.dy = insertelement <2 x float> poison, float %i.dl, i64 0
  %29 = insertelement <2 x float> %i.dy, float %i.dk, i64 1
  %30 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %28, <2 x float> %29, <2 x float> %i.dx)
  %i.dz = fmul float %22, %i.dn
  %i.ea = tail call float @llvm.fmuladd.f32(float %23, float %i.dm, float %i.dz)
  %i.eb = tail call noundef float @llvm.fmuladd.f32(float %i.dq, float %i.dp, float %i.ea)
  %i.ec = fadd <2 x float> %i.cj, %30
