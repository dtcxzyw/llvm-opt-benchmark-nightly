...
bb.a:
  ...
  %9 = load float, ptr %i.b, align 4, !tbaa !15   ; 2 uses
  %i.f = load float, ptr %2, align 4, !tbaa !15   ; 2 uses
  %10 = load float, ptr %i.d, align 4, !tbaa !15  ; 2 uses
  ...
  %i.i = fmul <2 x float> %12, %i.h
  %13 = insertelement <2 x float> poison, float %i.f, i64 0
  %i.j = shufflevector <2 x float> %13, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.m = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.l, <2 x float> %15, <2 x float> %i.k)
  ...
  %i.v = tail call noundef float @llvm.fmuladd.f32(float %i.u, float %10, float %i.s)
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.y = load float, ptr %i.p, align 4, !tbaa !15 ; 2 uses
  %i.z = load float, ptr %1, align 4, !tbaa !15   ; 2 uses
  %i.aa = load float, ptr %i.q, align 4, !tbaa !15 ; 2 uses
  %i.ab = load <2 x float>, ptr %i.r, align 8, !tbaa !15 ; 2 uses
  %5 = load <2 x float>, ptr %i.s, align 8, !tbaa !15 ; 2 uses
  %6 = insertelement <2 x float> poison, float %i.y, i64 0
  %7 = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> zeroinitializer
  %8 = shufflevector <2 x float> %i.ab, <2 x float> %5, <2 x i32> <i32 1, i32 3>
  ...
  %i.ae = shufflevector <2 x float> %i.ab, <2 x float> %5, <2 x i32> <i32 0, i32 2>
  %i.af = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ad, <2 x float> %i.ae, <2 x float> %9)
