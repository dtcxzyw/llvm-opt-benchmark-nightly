...
_ZNK13btConvexShape19getMarginNonVirtualEv.exit69: ; preds = %bb.a, %bb.a
  ...
  %9 = load float, ptr %i.ag, align 4, !tbaa !17, !noalias !44
  %10 = tail call noundef float @llvm.fabs.f32(float %9)
  %11 = getelementptr inbounds nuw i8, ptr %1, i64 40
  %12 = load float, ptr %11, align 4, !tbaa !17, !noalias !44
  ...
  %i.ai = fmul float %i.w, %10
  %i.aj = tail call float @llvm.fmuladd.f32(float %i.v, float %i.af, float %i.ai)
  %i.ak = tail call noundef float @llvm.fmuladd.f32(float %i.x, float %13, float %i.aj) ; 2 uses
...
bb.c:                                             ; preds = %bb.a
  ...
  %14 = load float, ptr %i.gv, align 4, !tbaa !17, !noalias !48
  %15 = tail call noundef float @llvm.fabs.f32(float %14)
  %16 = getelementptr inbounds nuw i8, ptr %1, i64 40
  %17 = load float, ptr %16, align 4, !tbaa !17, !noalias !48
  ...
  %i.hc = tail call noundef float @llvm.fmuladd.f32(float %i.gz, float %18, float %i.hb) ; 2 uses
