...
bb.gk:                                            ; preds = %bb.gj, %bb.gi
  ...
  %13 = shufflevector <2 x float> %i.arl, <2 x float> %i.arm, <2 x i32> <i32 1, i32 3>
  %14 = shufflevector <2 x float> %i.arl, <2 x float> %i.arm, <2 x i32> <i32 0, i32 2>
  %15 = insertelement <2 x float> poison, float %i.are, i64 0
  %16 = insertelement <2 x float> %15, float %i.ark, i64 1
  %i.arn = insertelement <2 x float> poison, float %i.arg, i64 0
  %i.aro = shufflevector <2 x float> %i.arn, <2 x float> poison, <2 x i32> zeroinitializer
  %17 = getelementptr inbounds nuw i8, ptr %i.ara, i64 32 ; 2 uses
  %18 = load float, ptr %17, align 16, !tbaa !9
  %19 = getelementptr inbounds nuw i8, ptr %i.ara, i64 36 ; 2 uses
  %20 = load float, ptr %19, align 4, !tbaa !9
  %21 = getelementptr inbounds nuw i8, ptr %i.ara, i64 40 ; 2 uses
  %22 = load float, ptr %21, align 8, !tbaa !9
  %23 = getelementptr inbounds nuw i8, ptr %i.aqh, i64 48
  %.sroa.518.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.aqh, i64 56
  %24 = getelementptr inbounds nuw i8, ptr %i.aqh, i64 32
  %25 = getelementptr inbounds nuw i8, ptr %i.aqh, i64 36
  %26 = getelementptr inbounds nuw i8, ptr %i.aqh, i64 40
  %27 = load float, ptr %26, align 8, !tbaa !9    ; 7 uses
  %i.arp = insertelement <2 x float> poison, float %27, i64 0
  %i.arq = shufflevector <2 x float> %i.arp, <2 x float> poison, <2 x i32> zeroinitializer
  %28 = getelementptr inbounds nuw i8, ptr %i.aqh, i64 64
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.aqh, i64 72
  %i.arr = getelementptr inbounds nuw i8, ptr %i.aqh, i64 16
  %29 = getelementptr inbounds nuw i8, ptr %i.aqh, i64 20
  %i.ars = getelementptr inbounds nuw i8, ptr %i.aqh, i64 24
  %30 = load <2 x float>, ptr %i.aqh, align 16, !tbaa !9 ; 5 uses
  %i.art = load float, ptr %i.arc, align 4, !tbaa !9 ; 5 uses
  %31 = shufflevector <2 x float> %30, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %32 = fmul <2 x float> %31, %13
  %33 = shufflevector <2 x float> %30, <2 x float> poison, <2 x i32> zeroinitializer
  %34 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> %33, <2 x float> %32)
  %35 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %16, <2 x float> %i.aro, <2 x float> %34)
  %36 = fmul float %i.art, %20
  %37 = extractelement <2 x float> %30, i64 0     ; 5 uses
  %38 = call float @llvm.fmuladd.f32(float %18, float %37, float %36)
  %39 = call noundef float @llvm.fmuladd.f32(float %22, float %i.arg, float %38)
  %.sroa.3.12.vec.insert.i.i405 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %39, i64 0
  store <2 x float> %35, ptr %23, align 16
  ...
  %40 = load <2 x float>, ptr %24, align 16, !tbaa !9 ; 4 uses
  %i.asb = load float, ptr %25, align 4, !tbaa !9 ; 5 uses
  %i.asc = getelementptr inbounds nuw i8, ptr %i.arz, i64 8 ; 2 uses
  %i.asd = load float, ptr %i.asc, align 8, !tbaa !9
  ...
  %i.asl = fmul <2 x float> %41, %i.ask
  %i.asm = shufflevector <2 x float> %i.asi, <2 x float> %i.asj, <2 x i32> <i32 0, i32 2>
  %i.asn = shufflevector <2 x float> %40, <2 x float> poison, <2 x i32> zeroinitializer
  %i.aso = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.asm, <2 x float> %i.asn, <2 x float> %i.asl)
  %i.asp = insertelement <2 x float> poison, float %i.asd, i64 0
  %i.asq = insertelement <2 x float> %i.asp, float %i.ash, i64 1
  %i.asr = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.asq, <2 x float> %i.arq, <2 x float> %i.aso)
  ...
  %i.asw = fmul float %i.asb, %i.asv
  %42 = extractelement <2 x float> %40, i64 0     ; 5 uses
  %i.asx = call float @llvm.fmuladd.f32(float %i.ast, float %42, float %i.asw)
  %i.asy = getelementptr inbounds nuw i8, ptr %i.arz, i64 40 ; 2 uses
  %i.asz = load float, ptr %i.asy, align 8, !tbaa !9
  %i.ata = call noundef float @llvm.fmuladd.f32(float %i.asz, float %27, float %i.asx)
  %.sroa.3.12.vec.insert.i.i408 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.ata, i64 0
  store <2 x float> %i.asr, ptr %28, align 16
  store <2 x float> %.sroa.3.12.vec.insert.i.i408, ptr %.sroa.5.0..sroa_idx, align 8, !tbaa !9
  %43 = load float, ptr %i.any, align 4, !tbaa !184 ; 3 uses
  %44 = load <2 x float>, ptr %i.arr, align 16, !tbaa !9 ; 3 uses
  %45 = load float, ptr %29, align 4, !tbaa !9    ; 4 uses
  %46 = load float, ptr %i.ars, align 8, !tbaa !9 ; 5 uses
  %47 = load float, ptr %i.arb, align 4, !tbaa !9
  %i.atb = load float, ptr %i.ara, align 16, !tbaa !9
  %i.atc = load float, ptr %i.ard, align 8, !tbaa !9
  %48 = load float, ptr %i.ari, align 4, !tbaa !9
  %49 = load float, ptr %i.arh, align 16, !tbaa !9
  %i.atd = load float, ptr %i.arj, align 8, !tbaa !9
  %50 = load float, ptr %19, align 4, !tbaa !9
  %51 = load float, ptr %17, align 16, !tbaa !9
  %i.ate = load float, ptr %21, align 8, !tbaa !9
  %52 = load float, ptr %i.aoc, align 4, !tbaa !184 ; 3 uses
  %i.atf = load float, ptr %i.asa, align 4, !tbaa !9
  %i.atg = load float, ptr %i.arz, align 16, !tbaa !9
  %53 = fmul float %i.asb, %i.atf
  %54 = extractelement <2 x float> %44, i64 0     ; 4 uses
  %55 = fmul float %54, %52
  %56 = fmul float %i.art, %47
  %i.ath = fmul float %54, %43
  %57 = call float @llvm.fmuladd.f32(float %i.atg, float %42, float %53)
  %i.ati = call float @llvm.fmuladd.f32(float %i.atb, float %37, float %56)
  %i.atj = load float, ptr %i.asc, align 8, !tbaa !9
  %58 = call noundef float @llvm.fmuladd.f32(float %i.atj, float %27, float %57)
  %i.atk = call noundef float @llvm.fmuladd.f32(float %i.atc, float %i.arg, float %i.ati)
  %i.atl = load float, ptr %i.asf, align 4, !tbaa !9
  %i.atm = load float, ptr %i.ase, align 16, !tbaa !9
  %59 = fmul float %i.asb, %i.atl
  %i.atn = fmul float %45, %52
  %60 = fmul float %i.art, %48
  %61 = fmul float %43, %45
  %i.ato = call float @llvm.fmuladd.f32(float %i.atm, float %42, float %59)
  %62 = call float @llvm.fmuladd.f32(float %49, float %37, float %60)
  %i.atp = load float, ptr %i.asg, align 8, !tbaa !9
  %63 = call noundef float @llvm.fmuladd.f32(float %i.atp, float %27, float %i.ato)
  %i.atq = call noundef float @llvm.fmuladd.f32(float %i.atd, float %i.arg, float %62)
  %i.atr = load float, ptr %i.asu, align 4, !tbaa !9
  %64 = load float, ptr %i.ass, align 16, !tbaa !9
  %65 = fmul float %i.asb, %i.atr
  %i.ats = fmul float %46, %52
  %i.att = fmul float %i.art, %50
  %i.atu = fmul float %43, %46
  %66 = call float @llvm.fmuladd.f32(float %64, float %42, float %65)
  %67 = call float @llvm.fmuladd.f32(float %51, float %37, float %i.att)
  %i.atv = load float, ptr %i.asy, align 8, !tbaa !9
  %68 = call noundef float @llvm.fmuladd.f32(float %i.atv, float %27, float %66)
  %i.atw = call noundef float @llvm.fmuladd.f32(float %i.ate, float %i.arg, float %67)
  %69 = shufflevector <2 x float> %44, <2 x float> %30, <4 x i32> <i32 1, i32 3, i32 poison, i32 poison>
  %70 = shufflevector <2 x float> %40, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %71 = shufflevector <4 x float> %69, <4 x float> %70, <4 x i32> <i32 0, i32 1, i32 0, i32 5>
  %72 = insertelement <4 x float> poison, float %61, i64 0
  %73 = insertelement <4 x float> %72, float %i.atq, i64 1
  %74 = insertelement <4 x float> %73, float %i.atn, i64 2
  %75 = insertelement <4 x float> %74, float %63, i64 3
  %76 = fmul <4 x float> %71, %75
  %77 = insertelement <4 x float> poison, float %i.ath, i64 0
  %78 = insertelement <4 x float> %77, float %i.atk, i64 1
  %79 = insertelement <4 x float> %78, float %55, i64 2
  %80 = insertelement <4 x float> %79, float %58, i64 3
  %81 = shufflevector <2 x float> %44, <2 x float> %30, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
  %82 = shufflevector <4 x float> %81, <4 x float> %70, <4 x i32> <i32 0, i32 1, i32 0, i32 4>
  %83 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %80, <4 x float> %82, <4 x float> %76)
  %84 = insertelement <4 x float> poison, float %i.atu, i64 0
  %85 = insertelement <4 x float> %84, float %i.atw, i64 1
  %86 = insertelement <4 x float> %85, float %i.ats, i64 2
  %87 = insertelement <4 x float> %86, float %68, i64 3
  %88 = insertelement <4 x float> poison, float %46, i64 0
  %89 = insertelement <4 x float> %88, float %i.arg, i64 1
  %90 = insertelement <4 x float> %89, float %27, i64 2
  %91 = shufflevector <4 x float> %90, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 2>
  %92 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %87, <4 x float> %91, <4 x float> %83) ; 4 uses
  %shift = shufflevector <4 x float> %92, <4 x float> poison, <4 x i32> <i32 1, i32 poison, i32 poison, i32 poison>
  %foldExtExtBinop = fadd <4 x float> %92, %shift
  %shift870 = shufflevector <4 x float> %92, <4 x float> poison, <4 x i32> <i32 2, i32 poison, i32 poison, i32 poison>
  %foldExtExtBinop871 = fadd <4 x float> %foldExtExtBinop, %shift870
  %shift873 = shufflevector <4 x float> %92, <4 x float> poison, <4 x i32> <i32 3, i32 poison, i32 poison, i32 poison>
  %foldExtExtBinop874 = fadd <4 x float> %foldExtExtBinop871, %shift873
  %93 = extractelement <4 x float> %foldExtExtBinop874, i64 0 ; 2 uses
  %i.atx = call noundef float @llvm.fabs.f32(float %93)
  %i.aty = fcmp ogt float %i.atx, f0x34000000
  %i.atz = fdiv float 1.000000e+00, %93
  ...
  %i.aue = fmul float %45, %i.aud
  %i.auf = call float @llvm.fmuladd.f32(float %54, float %i.auc, float %i.aue)
  %i.aug = load float, ptr %i.apx, align 8, !tbaa !9
  %i.auh = call noundef float @llvm.fmuladd.f32(float %46, float %i.aug, float %i.auf)
  %i.aui = load float, ptr %i.apy, align 16, !tbaa !9
  %i.auj = load float, ptr %i.apz, align 4, !tbaa !9
  %i.auk = fmul float %i.art, %i.auj
  %i.aul = call float @llvm.fmuladd.f32(float %37, float %i.aui, float %i.auk)
  ...
  %i.aur = fmul float %45, %i.auq
  %i.aus = call float @llvm.fmuladd.f32(float %54, float %i.aup, float %i.aur)
  %i.aut = load float, ptr %i.aqd, align 8, !tbaa !9
  %i.auu = call noundef float @llvm.fmuladd.f32(float %46, float %i.aut, float %i.aus)
  %i.auv = load float, ptr %i.aqe, align 16, !tbaa !9
  %i.auw = load float, ptr %i.aqf, align 4, !tbaa !9
  %i.aux = fmul float %i.asb, %i.auw
  %i.auy = call float @llvm.fmuladd.f32(float %42, float %i.auv, float %i.aux)
  %i.auz = load float, ptr %i.aqg, align 8, !tbaa !9
  %i.ava = call noundef float @llvm.fmuladd.f32(float %27, float %i.auz, float %i.auy)
