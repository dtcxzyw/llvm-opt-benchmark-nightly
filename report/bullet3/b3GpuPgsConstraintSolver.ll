...
bb.gf:                                            ; preds = %.lr.ph763, %bb.gk
  ...
  %i.aqd = getelementptr inbounds nuw [160 x i8], ptr %i.anh, i64 %indvars.iv775 ; 15 uses
...
bb.gk:                                            ; preds = %bb.gj, %bb.gi
  ...
  %13 = load <3 x float>, ptr %i.aqd, align 16, !tbaa !17 ; 7 uses
  %14 = load float, ptr %i.aqd, align 16, !tbaa !17 ; 4 uses
  %15 = load <2 x float>, ptr %i.aqz, align 16, !tbaa !17 ; 2 uses
  %16 = shufflevector <3 x float> %13, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %17 = shufflevector <2 x float> %i.arc, <2 x float> %15, <2 x i32> <i32 1, i32 3>
  %18 = fmul <2 x float> %16, %17
  %19 = shufflevector <2 x float> %i.arc, <2 x float> %15, <2 x i32> <i32 0, i32 2>
  %i.ard = shufflevector <3 x float> %13, <3 x float> poison, <2 x i32> zeroinitializer
  %20 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %19, <2 x float> %i.ard, <2 x float> %18)
  %21 = insertelement <2 x float> poison, float %i.aqy, i64 0
  %22 = insertelement <2 x float> %21, float %i.arb, i64 1
  %23 = shufflevector <3 x float> %13, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %24 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %22, <2 x float> %23, <2 x float> %20)
  %i.are = getelementptr inbounds nuw i8, ptr %i.aqw, i64 32 ; 2 uses
  %25 = load float, ptr %i.are, align 16, !tbaa !17
  %i.arf = getelementptr inbounds nuw i8, ptr %i.aqw, i64 36
  %i.arg = load float, ptr %i.arf, align 4, !tbaa !17
  %26 = extractelement <3 x float> %13, i64 1
  %27 = fmul float %26, %i.arg
  %28 = call float @llvm.fmuladd.f32(float %25, float %14, float %27)
  %i.arh = getelementptr inbounds nuw i8, ptr %i.aqw, i64 40 ; 2 uses
  %i.ari = load float, ptr %i.arh, align 8, !tbaa !17
  %i.arj = extractelement <3 x float> %13, i64 2  ; 6 uses
  %i.ark = call noundef float @llvm.fmuladd.f32(float %i.ari, float %i.arj, float %28)
  %.sroa.3.12.vec.insert.i.i405 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.ark, i64 0
  %29 = getelementptr inbounds nuw i8, ptr %i.aqd, i64 48
  store <2 x float> %24, ptr %29, align 16
  ...
  %30 = getelementptr inbounds nuw i8, ptr %i.aqd, i64 32 ; 2 uses
  ...
  %i.arw = load <2 x float>, ptr %i.arq, align 16, !tbaa !17 ; 2 uses
  %31 = load <3 x float>, ptr %30, align 16, !tbaa !17 ; 7 uses
  %i.arx = load float, ptr %30, align 16, !tbaa !17 ; 5 uses
  %i.ary = load <2 x float>, ptr %i.art, align 16, !tbaa !17 ; 2 uses
  %i.arz = shufflevector <3 x float> %31, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.asa = shufflevector <2 x float> %i.arw, <2 x float> %i.ary, <2 x i32> <i32 1, i32 3>
  %i.asb = fmul <2 x float> %i.arz, %i.asa
  %i.asc = shufflevector <2 x float> %i.arw, <2 x float> %i.ary, <2 x i32> <i32 0, i32 2>
  %i.asd = shufflevector <3 x float> %31, <3 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.ash = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.asg, <2 x float> %32, <2 x float> %i.ase)
  ...
  %33 = extractelement <3 x float> %31, i64 1     ; 2 uses
  %34 = fmul float %33, %i.asl
  %i.asm = call float @llvm.fmuladd.f32(float %i.asj, float %i.arx, float %34)
  %i.asn = getelementptr inbounds nuw i8, ptr %i.arq, i64 40 ; 2 uses
  %i.aso = load float, ptr %i.asn, align 8, !tbaa !17
  %35 = extractelement <3 x float> %31, i64 2     ; 6 uses
  %i.asp = call noundef float @llvm.fmuladd.f32(float %i.aso, float %35, float %i.asm)
  %.sroa.3.12.vec.insert.i.i408 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.asp, i64 0
  %36 = getelementptr inbounds nuw i8, ptr %i.aqd, i64 64
  store <2 x float> %i.ash, ptr %36, align 16
  ...
  %37 = getelementptr inbounds nuw i8, ptr %i.aqd, i64 16
  %i.asq = load float, ptr %i.any, align 4, !tbaa !169 ; 3 uses
  %38 = getelementptr inbounds nuw i8, ptr %i.aqd, i64 20
  %39 = getelementptr inbounds nuw i8, ptr %i.aqd, i64 24
  %i.asr = load float, ptr %39, align 8, !tbaa !17 ; 6 uses
  %i.ass = fmul float %i.asq, %i.asr
  %40 = load float, ptr %i.aqx, align 8, !tbaa !17
  %41 = load float, ptr %i.ara, align 8, !tbaa !17
  %42 = load float, ptr %i.arh, align 8, !tbaa !17
  %i.ast = load float, ptr %i.aoc, align 4, !tbaa !169 ; 3 uses
  %43 = fmul float %i.asr, %i.ast
  %44 = load <2 x float>, ptr %i.aqw, align 16, !tbaa !17 ; 2 uses
  %i.asu = load <2 x float>, ptr %i.aqz, align 16, !tbaa !17 ; 2 uses
  %i.asv = load <2 x float>, ptr %i.are, align 16, !tbaa !17
  %i.asw = load <2 x float>, ptr %i.arq, align 16, !tbaa !17
  %45 = shufflevector <3 x float> %13, <3 x float> %31, <4 x i32> <i32 1, i32 1, i32 1, i32 4> ; 2 uses
  %i.asx = shufflevector <2 x float> %44, <2 x float> %i.asu, <4 x i32> <i32 1, i32 3, i32 poison, i32 poison>
  ...
  %i.atc = fmul <4 x float> %45, %i.atb
  %i.atd = shufflevector <2 x float> %44, <2 x float> %i.asu, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
  ...
  %47 = insertelement <4 x float> %46, float %i.arx, i64 1
  %48 = shufflevector <4 x float> %47, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %49 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.atf, <4 x float> %48, <4 x float> %i.atc) ; 4 uses
  %i.atg = extractelement <4 x float> %49, i64 0
  %i.ath = call noundef float @llvm.fmuladd.f32(float %40, float %i.arj, float %i.atg)
  %i.ati = extractelement <4 x float> %49, i64 1
  %i.atj = call noundef float @llvm.fmuladd.f32(float %41, float %i.arj, float %i.ati)
  %50 = extractelement <4 x float> %49, i64 2
  %51 = call noundef float @llvm.fmuladd.f32(float %42, float %i.arj, float %50)
  %i.atk = load float, ptr %i.arr, align 8, !tbaa !17
  %i.atl = extractelement <4 x float> %49, i64 3
  %i.atm = call noundef float @llvm.fmuladd.f32(float %i.atk, float %35, float %i.atl)
  %i.atn = load float, ptr %i.aru, align 8, !tbaa !17
  %i.ato = load float, ptr %i.asn, align 8, !tbaa !17
  %i.atp = load <2 x float>, ptr %37, align 16, !tbaa !17 ; 2 uses
  %i.atq = load float, ptr %38, align 4, !tbaa !17 ; 4 uses
  %i.atr = extractelement <2 x float> %i.atp, i64 0 ; 3 uses
  %i.ats = fmul float %i.atr, %i.asq
  %i.att = fmul float %i.asq, %i.atq
  %i.atu = fmul float %i.atr, %i.ast
  %i.atv = fmul float %i.atq, %i.ast
  %i.atw = load <2 x float>, ptr %i.art, align 16, !tbaa !17 ; 2 uses
  %i.atx = load <2 x float>, ptr %i.asi, align 16, !tbaa !17 ; 2 uses
  %52 = shufflevector <3 x float> %31, <3 x float> %13, <4 x i32> <i32 1, i32 1, i32 poison, i32 4>
  %53 = shufflevector <2 x float> %i.atp, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 poison> ; 3 uses
  %54 = shufflevector <4 x float> %52, <4 x float> %53, <4 x i32> <i32 0, i32 1, i32 5, i32 3>
  ...
  %i.aua = insertelement <4 x float> %i.atz, float %i.atj, i64 3
  %i.aub = fmul <4 x float> %54, %i.aua
  %i.auc = shufflevector <2 x float> %i.atw, <2 x float> %i.atx, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
  %55 = insertelement <4 x float> %i.auc, float %i.ats, i64 2
  %i.aud = insertelement <4 x float> %55, float %i.ath, i64 3
  %i.aue = insertelement <4 x float> poison, float %i.arx, i64 0
  %56 = shufflevector <4 x float> %i.aue, <4 x float> %53, <4 x i32> <i32 0, i32 4, i32 poison, i32 poison>
  %57 = insertelement <4 x float> %56, float %14, i64 2
  %58 = shufflevector <4 x float> %57, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 2>
  %i.auf = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.aud, <4 x float> %58, <4 x float> %i.aub) ; 4 uses
  %i.aug = extractelement <4 x float> %i.auf, i64 0
  %i.auh = call noundef float @llvm.fmuladd.f32(float %i.atn, float %35, float %i.aug)
  %i.aui = extractelement <4 x float> %i.auf, i64 1
  %i.auj = call noundef float @llvm.fmuladd.f32(float %i.ato, float %35, float %i.aui)
  ...
  %i.aun = call noundef float @llvm.fmuladd.f32(float %51, float %i.arj, float %i.aum)
  ...
  %i.aur = call noundef float @llvm.fmuladd.f32(float %43, float %i.asr, float %i.auq)
  %i.aus = fadd float %i.auo, %i.aur
  %i.aut = fmul float %33, %i.auh
  %i.auu = call float @llvm.fmuladd.f32(float %i.atm, float %i.arx, float %i.aut)
  %i.auv = call noundef float @llvm.fmuladd.f32(float %i.auj, float %35, float %i.auu)
  ...
  %i.avj = insertelement <4 x float> poison, float %i.atq, i64 0
  %59 = shufflevector <4 x float> %i.avj, <4 x float> poison, <4 x i32> <i32 0, i32 poison, i32 0, i32 poison>
  %60 = shufflevector <4 x float> %59, <4 x float> %45, <4 x i32> <i32 0, i32 5, i32 2, i32 7>
  ...
  %i.avp = fmul <4 x float> %60, %i.avo
  %61 = insertelement <4 x float> %53, float %14, i64 1
  %62 = insertelement <4 x float> %61, float %i.arx, i64 3
  ...
  %i.avt = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %62, <4 x float> %i.avs, <4 x float> %i.avp) ; 4 uses
  ...
  %i.avx = call noundef float @llvm.fmuladd.f32(float %i.arj, float %i.avd, float %i.avw)
  ...
  %i.awd = call noundef float @llvm.fmuladd.f32(float %35, float %i.awb, float %i.awc)
