...
bb.a:
  ...
  %4 = load float, ptr %i.a, align 8, !tbaa !20
  %5 = fadd float %i.e, %4                        ; 2 uses
  %6 = getelementptr inbounds nuw i8, ptr %0, i64 52
  %7 = load float, ptr %6, align 4, !tbaa !20
  %8 = fadd float %i.e, %7                        ; 2 uses
  %9 = getelementptr inbounds nuw i8, ptr %0, i64 56
  %10 = load float, ptr %9, align 8, !tbaa !20
  %11 = fadd float %i.e, %10                      ; 2 uses
  ...
  %12 = extractelement <2 x float> %i.p, i64 0
  %13 = fmul float %8, %12
  %14 = tail call float @llvm.fmuladd.f32(float %5, float %i.m, float %13)
  %15 = extractelement <2 x float> %i.p, i64 1
  %16 = tail call noundef float @llvm.fmuladd.f32(float %11, float %15, float %14) ; 2 uses
  ...
  %i.ab = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> zeroinitializer
  %18 = fmul <2 x float> %i.ab, %i.w
  %19 = insertelement <2 x float> poison, float %5, i64 0
  %20 = shufflevector <2 x float> %19, <2 x float> poison, <2 x i32> zeroinitializer
  %21 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %20, <2 x float> %i.u, <2 x float> %18)
  %22 = insertelement <2 x float> poison, float %11, i64 0
  %23 = shufflevector <2 x float> %22, <2 x float> poison, <2 x i32> zeroinitializer
  %24 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %23, <2 x float> %i.z, <2 x float> %21) ; 2 uses
  %i.ac = fsub <2 x float> %i.aa, %24
  %i.ad = fsub float %.sroa.731.0.copyload.i, %16
  ...
  %i.ae = fadd <2 x float> %24, %i.aa
  %i.af = fadd float %.sroa.731.0.copyload.i, %16
