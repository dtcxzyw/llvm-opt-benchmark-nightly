...
bb.a:
  ...
  %i.e = tail call noundef float %i.d(ptr noundef nonnull align 8 dereferenceable(72) %0) ; 3 uses
  %i.f = load float, ptr %i.a, align 8, !tbaa !20
  ...
  %i.o = load float, ptr %i.n, align 4, !tbaa !20, !noalias !24
  %i.p = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.q = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.r = load float, ptr %i.q, align 4, !tbaa !20, !noalias !24
  %i.s = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.t = load float, ptr %i.s, align 4, !tbaa !20, !noalias !24
  %i.u = tail call noundef float @llvm.fabs.f32(float %i.t)
  %i.v = getelementptr inbounds nuw i8, ptr %1, i64 36
  %4 = load <2 x float>, ptr %i.v, align 4, !tbaa !20, !noalias !24
  %5 = tail call <2 x float> @llvm.fabs.v2f32(<2 x float> %4) ; 2 uses
  ...
  %i.x = fmul float %i.j, %6
  %i.y = tail call float @llvm.fmuladd.f32(float %i.g, float %i.u, float %i.x)
  %7 = extractelement <2 x float> %5, i64 1
  %i.z = tail call noundef float @llvm.fmuladd.f32(float %i.m, float %7, float %i.y) ; 2 uses
  %i.aa = load <2 x float>, ptr %1, align 4, !tbaa !20, !noalias !24 ; 2 uses
  %i.ab = load <2 x float>, ptr %i.p, align 4, !tbaa !20, !noalias !24 ; 2 uses
  %i.ac = shufflevector <2 x float> %i.aa, <2 x float> %i.ab, <2 x i32> <i32 0, i32 2>
  %i.ad = tail call <2 x float> @llvm.fabs.v2f32(<2 x float> %i.ac)
  %i.ae = shufflevector <2 x float> %i.aa, <2 x float> %i.ab, <2 x i32> <i32 1, i32 3>
  %i.af = tail call <2 x float> @llvm.fabs.v2f32(<2 x float> %i.ae)
  %i.ag = insertelement <2 x float> poison, float %i.o, i64 0
  %i.ah = insertelement <2 x float> %i.ag, float %i.r, i64 1
  %i.ai = tail call <2 x float> @llvm.fabs.v2f32(<2 x float> %i.ah)
  %i.aj = load <2 x float>, ptr %i.w, align 4     ; 2 uses
  ...
  %i.ap = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ao, <2 x float> %i.ad, <2 x float> %i.am)
  ...
  %i.as = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ar, <2 x float> %i.ai, <2 x float> %i.ap) ; 2 uses
  %i.at = fsub <2 x float> %i.aj, %i.as
  %i.au = fsub float %.sroa.731.0.copyload.i, %i.z
  %.sroa.3.12.vec.insert.i14.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.au, i64 0
  store <2 x float> %i.at, ptr %2, align 4
  ...
  %i.av = fadd <2 x float> %i.as, %i.aj
  %i.aw = fadd float %.sroa.731.0.copyload.i, %i.z
  %.sroa.3.12.vec.insert.i19.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.aw, i64 0
  store <2 x float> %i.av, ptr %3, align 4
