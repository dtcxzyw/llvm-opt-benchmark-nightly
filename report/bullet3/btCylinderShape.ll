...
bb.a:
  ...
  %4 = load float, ptr %i.v, align 4, !tbaa !20, !noalias !24
  %5 = tail call noundef float @llvm.fabs.f32(float %4)
  %6 = getelementptr inbounds nuw i8, ptr %1, i64 40
  %7 = load float, ptr %6, align 4, !tbaa !20, !noalias !24
  ...
  %i.x = fmul float %i.j, %5
  %i.y = tail call float @llvm.fmuladd.f32(float %i.g, float %i.u, float %i.x)
  %i.z = tail call noundef float @llvm.fmuladd.f32(float %i.m, float %8, float %i.y) ; 2 uses
