...
bb.e:                                             ; preds = %.lr.ph, %.loopexit
  ...
  %i.dm = getelementptr inbounds nuw [688 x i8], ptr %i.dl, i64 %indvars.iv ; 28 uses
...
bb.i:                                             ; preds = %bb.f, %bb.e
  ...
  %i.ei = getelementptr [4 x i8], ptr %i.eg, i64 %i.eh ; 2 uses
...
.preheader164:                                    ; preds = %bb.i
  ...
  %2 = getelementptr i8, ptr %i.dm, i64 188
  %3 = getelementptr i8, ptr %i.dm, i64 216
  %4 = getelementptr i8, ptr %i.dm, i64 220
  %i.ew = getelementptr inbounds nuw i8, ptr %i.dm, i64 136
  %5 = load float, ptr %i.ew, align 8, !tbaa !9   ; 3 uses
  %i.ex = getelementptr inbounds nuw i8, ptr %i.dm, i64 140
  %i.ey = load float, ptr %i.ex, align 4, !tbaa !9 ; 3 uses
  %i.ez = fmul float %i.ey, %i.ey
  %6 = tail call float @llvm.fmuladd.f32(float %5, float %5, float %i.ez)
  %i.fa = getelementptr inbounds nuw i8, ptr %i.dm, i64 144
  %i.fb = load float, ptr %i.fa, align 8, !tbaa !9 ; 3 uses
  %7 = tail call noundef float @llvm.fmuladd.f32(float %i.fb, float %i.fb, float %6)
  %sqrt.i.i.i120 = tail call noundef float @llvm.sqrt.f32(float %7)
  %8 = fmul float %i.et, 5.000000e-01             ; 2 uses
  %9 = tail call noundef float @sinf(float noundef %8) #26
  %10 = fdiv float %9, %sqrt.i.i.i120             ; 3 uses
  %11 = tail call noundef float @cosf(float noundef %8) #26 ; 5 uses
  %i.fc = getelementptr inbounds nuw i8, ptr %i.dm, i64 496
  %12 = load <2 x float>, ptr %i.ev, align 8, !tbaa !9 ; 3 uses
  %13 = load <2 x float>, ptr %3, align 8, !tbaa !9 ; 3 uses
  %14 = load <2 x float>, ptr %i.eu, align 4, !tbaa !9 ; 2 uses
  %15 = fmul float %5, %10                        ; 3 uses
  %16 = fmul float %i.ey, %10                     ; 4 uses
  %i.fd = fmul float %i.fb, %10                   ; 3 uses
  %17 = load <2 x float>, ptr %2, align 4, !tbaa !9 ; 3 uses
  %18 = load <2 x float>, ptr %4, align 4, !tbaa !9 ; 3 uses
  %19 = shufflevector <2 x float> %12, <2 x float> %18, <4 x i32> <i32 poison, i32 poison, i32 0, i32 3>
  %20 = shufflevector <2 x float> %14, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 poison, i32 poison> ; 2 uses
  %21 = shufflevector <4 x float> %20, <4 x float> %19, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %22 = shufflevector <2 x float> %18, <2 x float> %17, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison> ; 2 uses
  %23 = shufflevector <2 x float> %14, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %24 = shufflevector <4 x float> %22, <4 x float> %23, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %25 = fmul <4 x float> %21, %24
  %26 = shufflevector <2 x float> %17, <2 x float> %13, <4 x i32> <i32 poison, i32 poison, i32 1, i32 2>
  %27 = shufflevector <4 x float> %26, <4 x float> %20, <4 x i32> <i32 5, i32 4, i32 3, i32 2>
  %28 = shufflevector <4 x float> %22, <4 x float> %23, <4 x i32> <i32 1, i32 0, i32 5, i32 4>
  %29 = fmul <4 x float> %27, %28
  %30 = fadd <4 x float> %25, %29                 ; 5 uses
  %31 = extractelement <4 x float> %30, i64 3     ; 3 uses
  %32 = fmul float %31, %16
  %33 = fneg float %i.fd                          ; 4 uses
  %34 = fneg float %15                            ; 4 uses
  %35 = fneg float %16                            ; 3 uses
  %i.fe = extractelement <4 x float> %30, i64 2   ; 2 uses
  %36 = tail call float @llvm.fmuladd.f32(float %11, float %i.fe, float %32)
  %37 = insertelement <4 x float> poison, float %i.fd, i64 0
  %38 = insertelement <4 x float> %37, float %36, i64 1
  %39 = insertelement <4 x float> %38, float %16, i64 2
  %40 = insertelement <4 x float> %39, float %15, i64 3
  %41 = shufflevector <4 x float> %30, <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, <4 x i32> <i32 2, i32 5, i32 poison, i32 0>
  %42 = fneg <4 x float> %30
  %43 = shufflevector <4 x float> %41, <4 x float> %42, <4 x i32> <i32 0, i32 1, i32 4, i32 3>
  %44 = fmul <4 x float> %40, %43
  %45 = insertelement <4 x float> poison, float %11, i64 0
  %46 = insertelement <4 x float> %45, float %33, i64 1
  %47 = insertelement <4 x float> %46, float %34, i64 2
  %48 = shufflevector <4 x float> %47, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 0>
  %49 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %48, <4 x float> %30, <4 x float> %44) ; 4 uses
  %50 = extractelement <4 x float> %49, i64 0
  %i.ff = tail call float @llvm.fmuladd.f32(float %34, float %31, float %50) ; 3 uses
  %51 = extractelement <4 x float> %49, i64 3
  %52 = tail call float @llvm.fmuladd.f32(float %35, float %i.fe, float %51) ; 3 uses
  %53 = extractelement <4 x float> %49, i64 2
  %i.fg = tail call float @llvm.fmuladd.f32(float %33, float %31, float %53) ; 3 uses
  %54 = extractelement <4 x float> %49, i64 1     ; 3 uses
  %i.fh = fmul float %11, %54
  %i.fi = tail call float @llvm.fmuladd.f32(float %i.fg, float %34, float %i.fh)
  %i.fj = tail call float @llvm.fmuladd.f32(float %i.ff, float %33, float %i.fi)
  %i.fk = tail call float @llvm.fmuladd.f32(float %52, float %16, float %i.fj)
  %i.fl = fmul float %11, %i.ff
  %i.fm = tail call float @llvm.fmuladd.f32(float %i.fg, float %35, float %i.fl)
  %i.fn = tail call float @llvm.fmuladd.f32(float %52, float %34, float %i.fm)
  %i.fo = tail call float @llvm.fmuladd.f32(float %54, float %i.fd, float %i.fn)
  %i.fp = fmul float %11, %52
  %i.fq = tail call float @llvm.fmuladd.f32(float %i.fg, float %33, float %i.fp)
  %i.fr = tail call float @llvm.fmuladd.f32(float %54, float %35, float %i.fq)
  %i.fs = tail call float @llvm.fmuladd.f32(float %i.ff, float %15, float %i.fr)
  %i.ft = shufflevector <2 x float> %12, <2 x float> %13, <2 x i32> <i32 1, i32 3>
  ...
  %i.fx = shufflevector <2 x float> %12, <2 x float> %13, <2 x i32> <i32 0, i32 2>
  ...
  %55 = shufflevector <2 x float> %17, <2 x float> %18, <2 x i32> <i32 1, i32 3>
  ...
  %i.gd = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %55, <2 x float> %i.gc, <2 x float> %i.ga)
  ...
  store <2 x float> %i.gg, ptr %i.fc, align 8, !tbaa !9
  br label %.loopexit
