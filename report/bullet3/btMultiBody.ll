...
bb.al:                                            ; preds = %bb.aj, %bb.ak
  %.0408 = phi float [ %i.arp, %bb.ak ], [ 0.000000e+00, %bb.aj ]
...
.preheader384:                                    ; preds = %._crit_edge391
  %.not400 = icmp eq i32 %.0186.lcssa, 0
...
.lr.ph393:                                        ; preds = %.preheader384
  ...
  %9 = sext i32 %.0186.lcssa to i64
  %wide.trip.count = zext i32 %.0186.lcssa to i64
