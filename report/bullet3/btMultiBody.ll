...
bb.a:
  ...
  %i.f = load float, ptr %i.b, align 4, !tbaa !20 ; 5 uses
  %i.g = fneg float %i.f                          ; 8 uses
  %i.h = extractelement <2 x float> %i.d, i64 0
  %i.i = fneg float %i.h                          ; 7 uses
  %i.j = extractelement <2 x float> %i.e, i64 0
  %i.k = fneg float %i.j                          ; 7 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.ay = shufflevector <2 x float> %i.e, <2 x float> poison, <3 x i32> <i32 0, i32 1, i32 poison> ; 4 uses
  %i.az = shufflevector <3 x float> %i.ax, <3 x float> %i.ay, <3 x i32> <i32 0, i32 4, i32 2> ; 8 uses
  ...
  %i.kf = insertelement <3 x float> %i.ke, float %i.i, i64 0
  %i.kg = fmul <3 x float> %i.kd, %i.kf
  %i.kh = insertelement <3 x float> %i.ay, float 0.000000e+00, i64 1
  %i.ki = insertelement <3 x float> %i.kh, float %i.g, i64 2
  ...
  %i.km = insertelement <3 x float> %i.kl, float %i.k, i64 1 ; 6 uses
  ...
  %i.kq = fmul <3 x float> %i.kp, %i.az
  %4 = insertelement <3 x float> %i.ay, float 0.000000e+00, i64 1
  %5 = insertelement <3 x float> %4, float %i.g, i64 2 ; 5 uses
  %i.kr = shufflevector <4 x float> %i.jq, <4 x float> poison, <3 x i32> zeroinitializer
  %i.ks = tail call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %5, <3 x float> %i.kr, <3 x float> %i.kq)
  ...
  %i.kx = fmul <3 x float> %i.kw, %i.az
  %i.ky = shufflevector <4 x float> %i.jt, <4 x float> poison, <3 x i32> zeroinitializer
  %i.kz = tail call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %5, <3 x float> %i.ky, <3 x float> %i.kx)
  ...
  %6 = insertelement <3 x float> poison, float %i.g, i64 0
  %7 = shufflevector <3 x float> %6, <3 x float> poison, <3 x i32> zeroinitializer
  %i.lm = fmul <3 x float> %i.li, %7
  ...
  %8 = insertelement <3 x float> poison, float %i.i, i64 0
  %i.lt = shufflevector <3 x float> %8, <3 x float> poison, <3 x i32> zeroinitializer
  ...
  %9 = insertelement <3 x float> poison, float %i.k, i64 0
  %10 = shufflevector <3 x float> %9, <3 x float> poison, <3 x i32> zeroinitializer
  %i.lx = tail call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %i.lf, <3 x float> %10, <3 x float> %i.lw)
  ...
  %i.mj = fmul <3 x float> %i.mi, %i.az
  %i.mk = shufflevector <3 x float> %i.ld, <3 x float> poison, <3 x i32> zeroinitializer
  %i.ml = tail call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %5, <3 x float> %i.mk, <3 x float> %i.mj)
  ...
  %i.mp = fmul <3 x float> %i.mo, %i.az
  %i.mq = shufflevector <3 x float> %i.ld, <3 x float> poison, <3 x i32> <i32 1, i32 1, i32 1>
  %i.mr = tail call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %5, <3 x float> %i.mq, <3 x float> %i.mp)
  ...
  %i.mv = fmul <3 x float> %i.mu, %i.az
  %i.mw = shufflevector <3 x float> %i.ld, <3 x float> poison, <3 x i32> <i32 2, i32 2, i32 2>
  %i.mx = tail call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %5, <3 x float> %i.mw, <3 x float> %i.mv)
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.rm = insertelement <3 x float> <float poison, float poison, float 0.000000e+00>, float %i.i, i64 0
  %i.rn = insertelement <3 x float> %i.rm, float %i.f, i64 1 ; 9 uses
  ...
  %i.sa = insertelement <3 x float> %i.rz, float %i.g, i64 2 ; 9 uses
  ...
  %i.sf = insertelement <3 x float> %i.se, float %i.k, i64 1 ; 9 uses
  ...
  %11 = insertelement <3 x float> poison, float %i.g, i64 0
  %12 = shufflevector <3 x float> %11, <3 x float> poison, <3 x i32> zeroinitializer
  %i.adk = fmul <3 x float> %i.adj, %12
  ...
  %13 = insertelement <3 x float> poison, float %i.f, i64 0
  %14 = shufflevector <3 x float> %13, <3 x float> poison, <3 x i32> zeroinitializer
  %i.ael = tail call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %i.aef, <3 x float> %14, <3 x float> %i.adl)
  %15 = insertelement <3 x float> poison, float %i.i, i64 0
  %i.aem = shufflevector <3 x float> %15, <3 x float> poison, <3 x i32> zeroinitializer
  %i.aen = tail call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %i.aei, <3 x float> %i.aem, <3 x float> %i.ael)
  %16 = insertelement <3 x float> poison, float %i.k, i64 0
  %17 = shufflevector <3 x float> %16, <3 x float> poison, <3 x i32> zeroinitializer
  %i.aeo = tail call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %i.aef, <3 x float> %17, <3 x float> %i.adm)
...
bb.d:                                             ; preds = %bb.a
  ...
  %i.aki = insertelement <3 x float> <float poison, float poison, float 0.000000e+00>, float %i.i, i64 0
  %i.akj = insertelement <3 x float> %i.aki, float %i.f, i64 1 ; 9 uses
  ...
  %i.akw = insertelement <3 x float> %i.akv, float %i.g, i64 2 ; 9 uses
  ...
  %i.alb = insertelement <3 x float> %i.ala, float %i.k, i64 1 ; 9 uses
  ...
  %18 = insertelement <3 x float> poison, float %i.g, i64 0
  %19 = shufflevector <3 x float> %18, <3 x float> poison, <3 x i32> zeroinitializer
  %i.awg = fmul <3 x float> %i.awf, %19
  ...
  %20 = insertelement <3 x float> poison, float %i.f, i64 0
  %21 = shufflevector <3 x float> %20, <3 x float> poison, <3 x i32> zeroinitializer
  %i.axh = tail call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %i.axb, <3 x float> %21, <3 x float> %i.awh)
  %22 = insertelement <3 x float> poison, float %i.i, i64 0
  %i.axi = shufflevector <3 x float> %22, <3 x float> poison, <3 x i32> zeroinitializer
  %i.axj = tail call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %i.axe, <3 x float> %i.axi, <3 x float> %i.axh)
  %23 = insertelement <3 x float> poison, float %i.k, i64 0
  %24 = shufflevector <3 x float> %23, <3 x float> poison, <3 x i32> zeroinitializer
  %i.axk = tail call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %i.axb, <3 x float> %24, <3 x float> %i.awi)
...
.preheader164:                                    ; preds = %bb.i
  ...
  %i.fh = load <2 x float>, ptr %i.ev, align 8, !tbaa !20 ; 3 uses
  %i.fi = shufflevector <2 x float> %i.ff, <2 x float> poison, <3 x i32> <i32 0, i32 1, i32 1>
  %i.fj = shufflevector <2 x float> %i.fh, <2 x float> poison, <3 x i32> <i32 poison, i32 0, i32 1>
  ...
  %2 = shufflevector <2 x float> %i.fe, <2 x float> %i.fh, <2 x i32> <i32 0, i32 2>
  %i.hf = shufflevector <3 x float> %i.hb, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.hg = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %2, <2 x float> %i.hf, <2 x float> %i.he)
