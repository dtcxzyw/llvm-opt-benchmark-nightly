...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load1816 = load <4 x float>, ptr %i.aq, align 4, !tbaa !9
  %i.ar = getelementptr inbounds nuw i8, ptr %i.ao, i64 16
  store <4 x float> %wide.load, ptr %i.ao, align 4, !tbaa !9
  store <4 x float> %wide.load1816, ptr %i.ar, align 4, !tbaa !9
...
.lr.ph.i.i.i440:                                  ; preds = %bb.f
  ...
  %xtraiter1930 = and i64 %wide.trip.count.i.i.i441, 1
...
_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa: ; preds = %bb.g
  ...
  br i1 %lcmp.mod1931.not, label %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i, label %.epil.preheader
...
.epil.preheader:                                  ; preds = %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa, %.lr.ph.i.i.i440
  ...
  %lcmp.mod1932 = trunc i32 %.pre.i438 to i1
  tail call void @llvm.assume(i1 %lcmp.mod1932)
...
begin_hunk_1_@_ZN11btMultiBody52computeAccelerationsArticulatedBodyAlgorithmMultiDofEfR20btAlignedObjectArrayIfERS0_I9btVector3ERS0_I11btMatrix3x3Ebbb:bb.a
  ...
  %.pre1657 = load float, ptr %i.ef, align 4, !tbaa !9 ; 4 uses
...
bb.s:                                             ; preds = %_ZNK11btMultiBody23isBaseStaticOrKinematicEv.exit.thread1384
  ...
  %i.mp = insertelement <2 x float> %i.mo, float %.pre1657, i64 1 ; 2 uses
  ...
  %i.mz = tail call float @llvm.fmuladd.f32(float %.pre1657, float %i.my, float %i.mx)
...
bb.t:                                             ; preds = %bb.s, %_ZNK11btMultiBody23isBaseStaticOrKinematicEv.exit.thread1384
  ...
  %i.nk = insertelement <2 x float> %i.nj, float %.pre1657, i64 1
  ...
  %i.nq = tail call float @llvm.fmuladd.f32(float %.pre1657, float %i.np, float %i.nf)
...
.lr.ph1430:                                       ; preds = %bb.u
  ...
  %i.ou = getelementptr inbounds nuw i8, ptr %10, i64 4 ; 2 uses
  %i.ov = getelementptr inbounds nuw i8, ptr %10, i64 8 ; 2 uses
  %i.ow = getelementptr inbounds nuw i8, ptr %10, i64 24 ; 2 uses
  %i.ox = getelementptr inbounds nuw i8, ptr %10, i64 40 ; 2 uses
  %i.oy = getelementptr inbounds nuw i8, ptr %10, i64 52
  %i.oz = getelementptr inbounds nuw i8, ptr %10, i64 56
...
bb.v:                                             ; preds = %.lr.ph1430, %bb.af
  ...
  %.scalar1888 = fsub float %i.rd, %i.rb          ; 2 uses
  %i.sc = insertelement <2 x float> <float poison, float 1.000000e+00>, float %.scalar1888, i64 0
  %i.sd = shufflevector <2 x float> %i.sc, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %.scalar1889 = fadd float %i.re, %i.ra          ; 2 uses
  %i.se = insertelement <2 x float> <float poison, float -0.000000e+00>, float %.scalar1889, i64 0
  ...
  %.scalar1890 = fsub float 1.000000e+00, %i.rj   ; 2 uses
  %i.si = insertelement <2 x float> <float poison, float 1.000000e+00>, float %.scalar1890, i64 0
  ...
  store float %.scalar1890, ptr %.sroa.91083.16..sroa_idx, align 4
  ...
  %.scalar1891 = fsub float %i.re, %i.ra          ; 2 uses
  %i.sq = insertelement <2 x float> <float poison, float -0.000000e+00>, float %.scalar1891, i64 0
  %i.sr = shufflevector <2 x float> %i.sq, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %.scalar1892 = fadd float %i.rg, %i.qz          ; 2 uses
  %i.ss = insertelement <2 x float> <float poison, float 1.000000e+00>, float %.scalar1892, i64 0
  %i.st = shufflevector <2 x float> %i.ss, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %.scalar1893 = fsub float 1.000000e+00, %i.rk   ; 2 uses
  %i.su = insertelement <2 x float> <float poison, float -0.000000e+00>, float %.scalar1893, i64 0
  %i.sv = shufflevector <2 x float> %i.su, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  store float %.scalar1891, ptr %i.rn, align 4
  store float %.scalar1892, ptr %.sroa.141087.32..sroa_idx, align 4
  store float %.scalar1893, ptr %.sroa.151088.32..sroa_idx, align 4
  ...
  %i.um = load <2 x float>, ptr %i.rz, align 4    ; 3 uses
  %i.un = load <2 x float>, ptr %i.sg, align 4    ; 3 uses
  %i.uo = load <2 x float>, ptr %i.sp, align 4    ; 2 uses
  %i.up = getelementptr inbounds [32 x i8], ptr %i.ef, i64 %i.rp ; 6 uses
  %i.uq = getelementptr inbounds nuw [32 x i8], ptr %i.ef, i64 %indvars.iv.next1574 ; 13 uses
  ...
  %i.uv = load float, ptr %i.uu, align 4, !tbaa !9 ; 2 uses
  %i.uw = load <4 x float>, ptr %i.ow, align 8
  %i.ux = shufflevector <4 x float> %i.uw, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %i.uy = load float, ptr %i.ox, align 8, !tbaa !9
  %i.uz = load <2 x float>, ptr %.sroa.91071.16..sroa_idx, align 4 ; 4 uses
  %.sroa.461242.16.copyload = load float, ptr %.sroa.101072.16..sroa_idx, align 4
  %i.va = load <2 x float>, ptr %.sroa.141075.32..sroa_idx, align 4 ; 4 uses
  %.sroa.72.32.copyload = load float, ptr %.sroa.151076.32..sroa_idx, align 4
  %i.vb = load float, ptr %i.ou, align 4, !tbaa !9
  %i.vc = load <2 x float>, ptr %i.or, align 8, !tbaa !9 ; 2 uses
  %i.vd = load <2 x float>, ptr %i.os, align 8, !tbaa !9 ; 2 uses
  %i.ve = insertelement <2 x float> poison, float %i.ut, i64 0
  %i.vf = shufflevector <2 x float> %i.ve, <2 x float> poison, <2 x i32> zeroinitializer
  %i.vg = shufflevector <2 x float> %i.vc, <2 x float> %i.vd, <2 x i32> <i32 1, i32 3>
  %i.vh = fmul <2 x float> %i.vf, %i.vg
  %i.vi = fmul float %i.vb, %i.ut
  %i.vj = shufflevector <2 x float> %i.vc, <2 x float> %i.vd, <2 x i32> <i32 0, i32 2>
  %i.vk = insertelement <2 x float> poison, float %i.ur, i64 0
  %i.vl = shufflevector <2 x float> %i.vk, <2 x float> poison, <2 x i32> zeroinitializer
  %i.vm = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.vj, <2 x float> %i.vl, <2 x float> %i.vh)
  %i.vn = insertelement <2 x float> %i.ux, float %i.uy, i64 1
  %i.vo = insertelement <2 x float> poison, float %i.uv, i64 0
  %i.vp = shufflevector <2 x float> %i.vo, <2 x float> poison, <2 x i32> zeroinitializer
  %i.vq = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.vn, <2 x float> %i.vp, <2 x float> %i.vm) ; 6 uses
  %i.vr = shufflevector <2 x float> <float poison, float 0.000000e+00>, <2 x float> %i.vq, <2 x i32> <i32 3, i32 1>
  %.sroa.42.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.uq, i64 8 ; 3 uses
  %i.vs = extractelement <2 x float> %i.vq, i64 0
  %i.vt = getelementptr inbounds nuw i8, ptr %i.up, i64 16
  %i.vu = load float, ptr %i.vt, align 4, !tbaa !9 ; 2 uses
  %i.vv = getelementptr inbounds nuw i8, ptr %i.up, i64 20
  ...
  %i.vz = load float, ptr %i.ov, align 8, !tbaa !9
end_hunk_1
begin_hunk_2_@_ZN11btMultiBody52computeAccelerationsArticulatedBodyAlgorithmMultiDofEfR20btAlignedObjectArrayIfERS0_I9btVector3ERS0_I11btMatrix3x3Ebbb:bb.a
  ...
  %i.ahp = load <2 x float>, ptr %i.xu, align 4, !tbaa !9 ; 3 uses
...
bb.ac:                                            ; preds = %_ZNK11btMultiBody30isLinkAndAllAncestorsKinematicEi.exit.thread
  ...
  %i.aix = load <2 x float>, ptr %i.adh, align 4, !tbaa !9 ; 4 uses
...
bb.ae:                                            ; preds = %bb.ad
  %i.ajp = load float, ptr %i.xu, align 4, !tbaa !9 ; 2 uses
  %i.ajq = load float, ptr %i.uq, align 4, !tbaa !9 ; 2 uses
  %i.ajr = fneg float %i.ajp
  %i.ajs = load float, ptr %i.ahg, align 8, !tbaa !9 ; 2 uses
  %i.ajt = load <2 x float>, ptr %i.adh, align 4, !tbaa !9 ; 3 uses
  %i.aju = load <2 x float>, ptr %i.adu, align 4, !tbaa !9 ; 3 uses
...
bb.af:                                            ; preds = %bb.ad, %bb.ae, %bb.ab
  %i.akm = phi ptr [ %i.ahf, %bb.ad ], [ %i.ahf, %bb.ae ], [ %.pre1658, %bb.ab ]
...
.lr.ph.i624:                                      ; preds = %.lr.ph.i624.lr.ph, %bb.av
  %indvars.iv1627 = phi i64 [ %12, %.lr.ph.i624.lr.ph ], [ %indvars.iv.next1628, %bb.av ] ; 7 uses
  %indvars.iv.next1628 = add nsw i64 %indvars.iv1627, -1 ; 9 uses
  %i.alf = load ptr, ptr %i.pd, align 8, !tbaa !38 ; 3 uses
  %i.alg = trunc nuw nsw i64 %indvars.iv.next1628 to i32
  br label %bb.ah
...
_ZNK11btMultiBody30isLinkAndAllAncestorsKinematicEi.exit633.thread: ; preds = %bb.ah, %_ZNK11btMultiBody15isLinkKinematicEi.exit.i627, %._crit_edge.i630, %_ZNK11btMultiBody30isLinkAndAllAncestorsKinematicEi.exit633
  %i.alu = getelementptr inbounds nuw [688 x i8], ptr %i.alf, i64 %indvars.iv.next1628 ; 5 uses
  %i.alv = getelementptr inbounds nuw i8, ptr %i.alu, i64 20
  %i.alw = load i32, ptr %i.alv, align 4, !tbaa !84
  %i.alx = getelementptr inbounds nuw [48 x i8], ptr %i.et, i64 %indvars.iv1627 ; 3 uses
...
.lr.ph1433:                                       ; preds = %_ZNK11btMultiBody30isLinkAndAllAncestorsKinematicEi.exit633.thread
  %i.ame = getelementptr inbounds nuw [144 x i8], ptr %i.er, i64 %indvars.iv1627 ; 22 uses
  ...
  %i.ana = getelementptr inbounds nuw [32 x i8], ptr %i.ej, i64 %indvars.iv1627 ; 4 uses
  ...
  %i.ane = getelementptr inbounds nuw [32 x i8], ptr %i.ek, i64 %indvars.iv.next1628 ; 4 uses
  ...
  %.phi.trans.insert1684 = getelementptr inbounds nuw i8, ptr %i.alu, i64 328
  %.pre1685 = load i32, ptr %.phi.trans.insert1684, align 8, !tbaa !110
  br label %bb.aj
...
.preheader1410.._crit_edge1443_crit_edge:         ; preds = %_ZNK11btMultiBody30isLinkAndAllAncestorsKinematicEi.exit633.thread, %.preheader1410
  ...
  %.lcssa14311752 = phi ptr [ %i.arq, %.preheader1410 ], [ %i.alu, %_ZNK11btMultiBody30isLinkAndAllAncestorsKinematicEi.exit633.thread ] ; 2 uses
  %.phi.trans.insert1666 = getelementptr inbounds nuw i8, ptr %.lcssa14311752, i64 328
  %.pre1667 = load i32, ptr %.phi.trans.insert1666, align 8, !tbaa !110
...
.lr.ph1442:                                       ; preds = %.preheader1410
  ...
  %min.iters.check1818 = icmp ult i32 %i.atp, 5
  %i.anp = and i64 %i.ano, 3                      ; 2 uses
  %i.anq = icmp eq i64 %i.anp, 0
  %i.anr = select i1 %i.anq, i64 4, i64 %i.anp
  %n.vec1820 = sub nsw i64 %i.ano, %i.anr         ; 2 uses
  br label %.lr.ph1439

bb.aj:                                            ; preds = %.lr.ph1433, %bb.al
  %i.ans = phi i32 [ %.pre1685, %.lr.ph1433 ], [ %i.atk, %bb.al ]
  %indvars.iv1578 = phi i64 [ 0, %.lr.ph1433 ], [ %indvars.iv.next1579, %bb.al ] ; 5 uses
  %i.ant = phi ptr [ %i.alf, %.lr.ph1433 ], [ %.pre1659, %bb.al ]
  %i.anu = getelementptr inbounds nuw [688 x i8], ptr %i.ant, i64 %indvars.iv.next1628
  ...
  %.pre1659 = load ptr, ptr %i.pd, align 8, !tbaa !38 ; 3 uses
  br i1 %5, label %bb.al, label %bb.ak

bb.ak:                                            ; preds = %bb.aj
  %i.arm = getelementptr inbounds nuw [688 x i8], ptr %.pre1659, i64 %indvars.iv.next1628
...
bb.al:                                            ; preds = %bb.aj, %bb.ak
  ...
  %i.arq = getelementptr inbounds nuw [688 x i8], ptr %.pre1659, i64 %indvars.iv.next1628 ; 7 uses
...
._crit_edge1443:                                  ; preds = %._crit_edge1440, %.preheader1410.._crit_edge1443_crit_edge
  ...
  %.lcssa14311751 = phi ptr [ %.lcssa14311752, %.preheader1410.._crit_edge1443_crit_edge ], [ %i.arq, %._crit_edge1440 ]
  %i.atu = phi i32 [ %.pre1667, %.preheader1410.._crit_edge1443_crit_edge ], [ %i.anm, %._crit_edge1440 ] ; 4 uses
  ...
  %i.aty = getelementptr inbounds nuw i8, ptr %.lcssa14311751, i64 564
...
scalar.ph1817.preheader:                          ; preds = %vector.body1831, %.lr.ph1439
  ...
  %i.auk = insertelement <2 x float> poison, float %.pre1662, i64 0
  %i.aul = insertelement <2 x float> %i.auk, float %.pre1665, i64 1
...
vector.ph1819:                                    ; preds = %.lr.ph1439
  ...
  %broadcast.splat1822 = shufflevector <2 x float> %i.aug, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  ...
  %broadcast.splat1826 = shufflevector <2 x float> %i.auh, <2 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splat1828 = shufflevector <2 x float> %i.auh, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
...
vector.body1831:                                  ; preds = %vector.body1831, %vector.ph1819
  ...
  %i.aum = getelementptr [32 x i8], ptr %invariant.gep, i64 %index1832 ; 6 uses
  %i.aun = getelementptr [32 x i8], ptr %invariant.gep, i64 %index1832 ; 6 uses
  %i.auo = getelementptr i8, ptr %i.aun, i64 32
  %i.aup = getelementptr [32 x i8], ptr %invariant.gep, i64 %index1832 ; 6 uses
  %i.auq = getelementptr i8, ptr %i.aup, i64 64
  %i.aur = getelementptr [32 x i8], ptr %invariant.gep, i64 %index1832 ; 6 uses
  ...
  %i.avn = fmul <4 x float> %broadcast.splat1822, %i.avm
  ...
  %i.awb = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %broadcast.splat1824, <4 x float> %i.awa, <4 x float> %i.avo)
  ...
  %i.axa = fmul <4 x float> %broadcast.splat1828, %i.awz
  %i.axb = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %broadcast.splat1826, <4 x float> %i.awn, <4 x float> %i.axa)
  ...
  %i.axo = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %broadcast.splat1830, <4 x float> %i.axn, <4 x float> %i.axb)
  %i.axp = fadd <4 x float> %i.awb, %i.axo
  %i.axq = getelementptr inbounds nuw [4 x i8], ptr %i.aub, i64 %index1832
  store <4 x float> %i.axp, ptr %i.axq, align 4, !tbaa !9
  %index.next1833 = add nuw i64 %index1832, 4     ; 2 uses
  %i.axr = icmp eq i64 %index.next1833, %n.vec1820
  br i1 %i.axr, label %scalar.ph1817.preheader, label %vector.body1831, !llvm.loop !161
...
begin_hunk_3_@_ZN11btMultiBody52computeAccelerationsArticulatedBodyAlgorithmMultiDofEfR20btAlignedObjectArrayIfERS0_I9btVector3ERS0_I11btMatrix3x3Ebbb:bb.a
  ...
  br i1 %exitcond1585.not, label %._crit_edge1440, label %scalar.ph1817, !llvm.loop !163
...
.preheader1409:                                   ; preds = %._crit_edge1443, %._crit_edge1443
  ...
  %shift1895 = shufflevector <4 x float> %i.ayx, <4 x float> poison, <4 x i32> <i32 3, i32 poison, i32 poison, i32 poison>
  %foldExtExtBinop1896 = fmul <4 x float> %i.ayo, %shift1895
  %i.ayz = extractelement <4 x float> %foldExtExtBinop1896, i64 0
  ...
  %i.azc = getelementptr i8, ptr %i.fc, i64 %i.aym
  %i.azd = load <2 x float>, ptr %i.pj, align 8, !tbaa !9 ; 4 uses
  %i.aze = load float, ptr %i.pk, align 4, !tbaa !9
  %i.azf = fneg <4 x float> %i.ayq
  %i.azg = shufflevector <2 x float> %i.azd, <2 x float> poison, <3 x i32> <i32 0, i32 poison, i32 poison>
  ...
  %i.azl = shufflevector <4 x float> %i.azf, <4 x float> poison, <4 x i32> <i32 1, i32 0, i32 poison, i32 poison>
  ...
  %i.azq = shufflevector <2 x float> %i.azd, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %i.azr = shufflevector <4 x float> %i.azp, <4 x float> %i.azq, <4 x i32> <i32 0, i32 5, i32 2, i32 3>
  %i.azs = shufflevector <2 x float> %i.azd, <2 x float> poison, <4 x i32> <i32 poison, i32 0, i32 1, i32 poison>
  ...
  %i.azw = extractelement <2 x float> %i.azd, i64 0
  ...
  %.sroa.15.32.scevgep1591.2.sroa_idx = getelementptr i8, ptr %i.azc, i64 32
...
.lr.ph1448.us.preheader:                          ; preds = %bb.ap
  ...
  %wide.trip.count1605 = zext nneg i32 %i.att to i64 ; 2 uses
  %invariant.gep1776 = getelementptr [32 x i8], ptr %i.fb, i64 %i.bah
...
.lr.ph1448.us:                                    ; preds = %.lr.ph1448.us.preheader, %._crit_edge1449.us
  ...
  %i.baj = getelementptr inbounds nuw [32 x i8], ptr %9, i64 %indvars.iv1602 ; 5 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %i.baj, i8 0, i64 32, i1 false)
  %invariant.gep1778 = getelementptr inbounds nuw [4 x i8], ptr %i.atx, i64 %indvars.iv1602
  br label %bb.aq
...
bb.aq:                                            ; preds = %.lr.ph1448.us, %bb.aq
  ...
  %i.bao = mul nuw nsw i64 %indvars.iv1597, %i.bai
  %gep1779 = getelementptr inbounds nuw [4 x i8], ptr %invariant.gep1778, i64 %i.bao
  %i.bap = getelementptr inbounds nuw i8, ptr %gep1777, i64 16
  %i.baq = load float, ptr %gep1779, align 4, !tbaa !9, !noalias !164 ; 3 uses
  ...
  %i.bav = getelementptr inbounds nuw i8, ptr %gep1777, i64 24
  %i.baw = load float, ptr %i.bav, align 4, !tbaa !9, !noalias !164
  %i.bax = fmul float %i.baq, %i.baw
  %i.bay = load <2 x float>, ptr %gep1777, align 4, !tbaa !9, !noalias !164
  %i.baz = fmul <2 x float> %i.bat, %i.bay
  %i.bba = getelementptr inbounds nuw i8, ptr %gep1777, i64 8
  ...
  br i1 %exitcond1601.not, label %._crit_edge1449.us, label %bb.aq, !llvm.loop !167
...
._crit_edge1449.us:                               ; preds = %bb.aq
  ...
  br i1 %exitcond1606.not, label %._crit_edge1464.split.us, label %.lr.ph1448.us, !llvm.loop !168

._crit_edge1464.split.us:                         ; preds = %._crit_edge1449.us, %bb.ap
  %i.bbk = getelementptr inbounds nuw [144 x i8], ptr %i.er, i64 %indvars.iv1627 ; 19 uses
...
.lr.ph1487:                                       ; preds = %._crit_edge1464.split.us
  ...
  %wide.trip.count1610 = zext nneg i32 %i.att to i64
  %invariant.gep1780 = getelementptr [32 x i8], ptr %i.fb, i64 %i.bcc
  br label %bb.ar
...
._crit_edge1488:                                  ; preds = %bb.ar, %._crit_edge1464.split.us
  ...
  %i.bch = getelementptr inbounds nuw [688 x i8], ptr %i.bcg, i64 %indvars.iv.next1628 ; 3 uses
...
.lr.ph1503:                                       ; preds = %._crit_edge1488
  ...
  %wide.trip.count1620 = zext nneg i32 %i.bcj to i64 ; 3 uses
  %.pre1668 = load i32, ptr %i.bcl, align 8, !tbaa !110
  %i.bcn = sext i32 %.pre1668 to i64
  %invariant.gep1784 = getelementptr [4 x i8], ptr %i.eb, i64 %i.bcn ; 5 uses
  %xtraiter1934 = and i64 %wide.trip.count1620, 3 ; 3 uses
  %i.bco = icmp ult i32 %i.bcj, 4
  %unroll_iter1938 = and i64 %wide.trip.count1620, 2147483644
  %lcmp.mod1935.not = icmp eq i64 %xtraiter1934, 0
  %lcmp.mod1937 = icmp ne i64 %xtraiter1934, 0
  br label %.lr.ph1497
...
bb.ar:                                            ; preds = %.lr.ph1487, %bb.ar
  ...
  %i.bdh = getelementptr inbounds nuw [32 x i8], ptr %9, i64 %indvars.iv1607 ; 6 uses
  %i.bdi = getelementptr inbounds nuw i8, ptr %i.bdh, i64 16
  %i.bdj = load float, ptr %gep1781, align 4, !tbaa !9, !noalias !169
  %i.bdk = getelementptr inbounds nuw i8, ptr %i.bdh, i64 20
  %i.bdl = getelementptr inbounds nuw i8, ptr %i.bdh, i64 24
  %i.bdm = getelementptr inbounds nuw i8, ptr %gep1781, i64 4
  %i.bdn = load float, ptr %i.bdm, align 4, !tbaa !9, !noalias !169
  %i.bdo = getelementptr inbounds nuw i8, ptr %gep1781, i64 8
  ...
  %i.bds = getelementptr inbounds nuw i8, ptr %gep1781, i64 16
  %i.bdt = load float, ptr %i.bds, align 4, !tbaa !9, !noalias !174 ; 2 uses
  %i.bdu = getelementptr inbounds nuw i8, ptr %gep1781, i64 20
  %i.bdv = load float, ptr %i.bdu, align 4, !tbaa !9, !noalias !174 ; 2 uses
  %i.bdw = getelementptr inbounds nuw i8, ptr %gep1781, i64 24
  ...
  br i1 %exitcond1611.not, label %._crit_edge1488, label %bb.ar, !llvm.loop !180

._crit_edge1504:                                  ; preds = %._crit_edge1498, %._crit_edge1488
  %i.bhy = getelementptr inbounds nuw [32 x i8], ptr %i.ej, i64 %indvars.iv1627 ; 5 uses
  %i.bhz = getelementptr inbounds nuw [32 x i8], ptr %i.ek, i64 %indvars.iv.next1628 ; 4 uses
...
.lr.ph374.us.preheader:                           ; preds = %bb.t
  ...
  %xtraiter572 = and i64 %wide.trip.count, 3      ; 3 uses
  %i.hw = icmp ult i32 %i.hh, 4
  %unroll_iter576 = and i64 %wide.trip.count, 2147483644
...
.lr.ph374.us:                                     ; preds = %.lr.ph374.us.preheader, %._crit_edge375.us
  ...
  br i1 %i.hw, label %.epil.preheader571, label %.lr.ph374.us.new
...
.lr.ph374.us.new:                                 ; preds = %.lr.ph374.us, %.lr.ph374.us.new
  ...
  %niter577 = phi i64 [ %niter577.next.3, %.lr.ph374.us.new ], [ 0, %.lr.ph374.us ]
  ...
  %niter577.next.3 = add i64 %niter577, 4         ; 2 uses
  %niter577.ncmp.3 = icmp eq i64 %niter577.next.3, %unroll_iter576
  br i1 %niter577.ncmp.3, label %._crit_edge375.us.unr-lcssa, label %.lr.ph374.us.new, !llvm.loop !358

._crit_edge375.us.unr-lcssa:                      ; preds = %.lr.ph374.us.new
  br i1 %lcmp.mod573.not, label %._crit_edge375.us, label %.epil.preheader571

.epil.preheader571:                               ; preds = %._crit_edge375.us.unr-lcssa, %.lr.ph374.us
...
bb.s:                                             ; preds = %bb.s, %.epil.preheader571
  %indvars.iv424.epil = phi i64 [ %indvars.iv424.epil.init, %.epil.preheader571 ], [ %indvars.iv.next425.epil, %bb.s ] ; 3 uses
  %i.im = phi float [ %.epil.init, %.epil.preheader571 ], [ %i.ip, %bb.s ]
  %epil.iter = phi i64 [ 0, %.epil.preheader571 ], [ %epil.iter.next, %bb.s ]
  ...
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter572
