...
bb.n:                                             ; preds = %.lr.ph136, %bb.y
  ...
  %i.cq = getelementptr inbounds nuw [872 x i8], ptr %i.cp, i64 %indvars.iv144 ; 8 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.cy = getelementptr inbounds nuw i8, ptr %i.cq, i64 856
  %6 = getelementptr inbounds nuw i8, ptr %i.cq, i64 860
  %i.cz = getelementptr inbounds nuw i8, ptr %i.cw, i64 16
  %i.da = load float, ptr %i.cz, align 4, !tbaa !75
  %7 = getelementptr inbounds nuw i8, ptr %i.cq, i64 864
  ...
  %8 = load float, ptr %6, align 4, !tbaa !75     ; 2 uses
  %9 = load float, ptr %i.cy, align 8, !tbaa !75  ; 2 uses
  %i.df = load float, ptr %7, align 8, !tbaa !75  ; 2 uses
  ...
  %i.di = fmul <2 x float> %11, %i.dh
  %i.dj = shufflevector <2 x float> %i.de, <2 x float> %i.dg, <2 x i32> <i32 0, i32 2>
  %12 = insertelement <2 x float> poison, float %9, i64 0
  %i.dk = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> zeroinitializer
  %i.dl = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dj, <2 x float> %i.dk, <2 x float> %i.di)
  %13 = insertelement <2 x float> poison, float %i.da, i64 0
  %i.dm = insertelement <2 x float> %13, float %i.dd, i64 1
  %i.dn = insertelement <2 x float> poison, float %i.df, i64 0
  %14 = shufflevector <2 x float> %i.dn, <2 x float> poison, <2 x i32> zeroinitializer
  %i.do = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dm, <2 x float> %14, <2 x float> %i.dl)
  ...
  %i.dt = fmul float %8, %i.ds
  %i.du = call float @llvm.fmuladd.f32(float %i.dq, float %9, float %i.dt)
  %i.dv = getelementptr inbounds nuw i8, ptr %i.cw, i64 48
  %i.dw = load float, ptr %i.dv, align 4, !tbaa !75
  %i.dx = call noundef float @llvm.fmuladd.f32(float %i.dw, float %i.df, float %i.du)
