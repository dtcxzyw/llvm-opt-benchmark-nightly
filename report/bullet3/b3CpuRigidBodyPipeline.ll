...
.lr.ph:                                           ; preds = %bb.a, %bb.c
  ...
  %i.i = getelementptr inbounds nuw [80 x i8], ptr %i.h, i64 %indvars.iv ; 7 uses
  ...
  %1 = getelementptr inbounds nuw i8, ptr %i.i, i64 16
  %.sroa.420.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.i, i64 20
  %.sroa.521.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.i, i64 24
  %i.j = load <2 x float>, ptr %i.i, align 16
  %.sroa.019.0.copyload = load float, ptr %1, align 16 ; 6 uses
  %.sroa.521.0.copyload = load float, ptr %.sroa.521.0..sroa_idx, align 8 ; 4 uses
  %.sroa.420.0.copyload = load float, ptr %.sroa.420.0..sroa_idx, align 4 ; 5 uses
  %.sroa.622.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.i, i64 28
  %.sroa.622.0.copyload = load float, ptr %.sroa.622.0..sroa_idx, align 4 ; 5 uses
...
bb.b:                                             ; preds = %.lr.ph
  ...
  %2 = fmul float %.sroa.420.0.copyload, %.sroa.420.0.copyload
  %i.ab = tail call float @llvm.fmuladd.f32(float %.sroa.019.0.copyload, float %.sroa.019.0.copyload, float %2)
  %i.ac = tail call float @llvm.fmuladd.f32(float %.sroa.521.0.copyload, float %.sroa.521.0.copyload, float %i.ab)
  %i.ad = tail call noundef float @llvm.fmuladd.f32(float %.sroa.622.0.copyload, float %.sroa.622.0.copyload, float %i.ac)
  %i.ae = fdiv float 2.000000e+00, %i.ad          ; 3 uses
  ...
  %3 = fmul float %.sroa.019.0.copyload, %i.ae    ; 2 uses
  %4 = fmul float %.sroa.420.0.copyload, %i.ae    ; 3 uses
  %5 = fmul float %.sroa.622.0.copyload, %3       ; 2 uses
  %i.am = fmul float %.sroa.622.0.copyload, %4    ; 2 uses
  %6 = fmul float %.sroa.019.0.copyload, %3       ; 2 uses
  %7 = fmul float %.sroa.019.0.copyload, %4       ; 2 uses
  %8 = fmul float %.sroa.521.0.copyload, %i.ae    ; 4 uses
  %9 = fmul float %.sroa.420.0.copyload, %4       ; 2 uses
  %10 = fmul float %.sroa.420.0.copyload, %8      ; 2 uses
  %11 = fmul float %.sroa.019.0.copyload, %8      ; 2 uses
  %12 = fmul float %.sroa.521.0.copyload, %8      ; 2 uses
  %13 = fmul float %.sroa.622.0.copyload, %8      ; 2 uses
  %14 = fadd float %9, %12
  %15 = fadd float %7, %13
  %16 = fsub float 1.000000e+00, %14
  %17 = fadd float %6, %12
  %i.an = fsub float 1.000000e+00, %17
  %i.ao = fsub float %7, %13
  %18 = fsub float %10, %5
  %i.ap = fadd float %11, %i.am
  %19 = fsub float %11, %i.am                     ; 2 uses
  %20 = fadd float %10, %5                        ; 2 uses
  %21 = fadd float %6, %9
  %i.aq = fsub float 1.000000e+00, %21            ; 2 uses
  %22 = insertelement <2 x float> poison, float %16, i64 0
  %i.ar = insertelement <2 x float> %22, float %15, i64 1 ; 2 uses
  ...
  %i.aw = insertelement <2 x float> %23, float %18, i64 1 ; 2 uses
  %i.ax = tail call <2 x float> @llvm.fabs.v2f32(<2 x float> %i.aw)
  %i.ay = tail call noundef float @llvm.fabs.f32(float %19)
  %i.az = tail call noundef float @llvm.fabs.f32(float %20)
  ...
  %i.bi = fmul float %20, %i.bh
  %i.bj = extractelement <3 x float> %i.al, i64 0
  %i.bk = tail call float @llvm.fmuladd.f32(float %i.bj, float %19, float %i.bi)
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.al = load float, ptr %i.v, align 4, !tbaa !67 ; 4 uses
  %i.am = load float, ptr %i.w, align 4, !tbaa !67 ; 5 uses
  %i.an = fmul float %i.am, %i.am
  %i.ao = call float @llvm.fmuladd.f32(float %i.ak, float %i.ak, float %i.an)
  %i.ap = call float @llvm.fmuladd.f32(float %i.al, float %i.al, float %i.ao)
  ...
  %i.at = fmul float %i.am, %i.ar                 ; 3 uses
  %i.au = fmul float %i.af, %i.as                 ; 2 uses
  %i.av = fmul float %i.af, %i.at                 ; 2 uses
  %i.aw = fmul float %i.ak, %i.as                 ; 2 uses
  %i.ax = fmul float %i.ak, %i.at                 ; 2 uses
  %i.ay = fmul float %i.al, %i.ar                 ; 4 uses
  %i.az = fmul float %i.am, %i.at                 ; 2 uses
  %i.ba = fmul float %i.am, %i.ay                 ; 2 uses
  %i.bb = fmul float %i.ak, %i.ay                 ; 2 uses
  %i.bc = fmul float %i.al, %i.ay                 ; 2 uses
  %i.bd = fadd float %i.az, %i.bc
  %i.be = fsub float 1.000000e+00, %i.bd
  %i.bf = fadd float %i.aw, %i.bc
  %i.bg = fmul float %i.af, %i.ay                 ; 2 uses
  %i.bh = fadd float %i.ax, %i.bg
  %i.bi = insertelement <2 x float> <float poison, float 1.000000e+00>, float %i.ax, i64 0
  %i.bj = insertelement <2 x float> poison, float %i.bg, i64 0
  %i.bk = insertelement <2 x float> %i.bj, float %i.bf, i64 1
  %i.bl = fsub <2 x float> %i.bi, %i.bk           ; 2 uses
  %i.bm = fsub float %i.ba, %i.au
  %8 = fadd float %i.bb, %i.av
  %i.bn = fsub float %i.bb, %i.av                 ; 2 uses
  %i.bo = fadd float %i.ba, %i.au                 ; 2 uses
  %i.bp = fadd float %i.aw, %i.az
  ...
  %i.bx = insertelement <2 x float> %i.bw, float %i.bh, i64 1 ; 2 uses
  %i.by = call <2 x float> @llvm.fabs.v2f32(<2 x float> %i.bx)
  %i.bz = call <2 x float> @llvm.fabs.v2f32(<2 x float> %i.bl)
  %i.ca = insertelement <2 x float> poison, float %8, i64 0
