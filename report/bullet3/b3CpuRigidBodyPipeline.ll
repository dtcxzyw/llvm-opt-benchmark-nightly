...
bb.z:                                             ; preds = %bb.y
  ...
  %4 = load float, ptr %i.fp, align 4, !tbaa !52
  %i.gy = load float, ptr %i.fq, align 8, !tbaa !52
  %5 = load float, ptr %i.fr, align 8, !tbaa !52  ; 3 uses
  ...
  %i.hj = fmul float %i.ek, %5
  %i.hk = load <2 x float>, ptr %i.fc, align 16, !tbaa !52 ; 6 uses
  %i.hl = fneg <2 x float> %i.hk                  ; 5 uses
  ...
  %6 = shufflevector <3 x float> %i.hq, <3 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %i.hr = extractelement <3 x float> %i.hq, i64 0
  %i.hs = fsub float %i.hr, %i.gx                 ; 2 uses
  %7 = extractelement <3 x float> %i.hq, i64 1
  %8 = fsub float %7, %4                          ; 2 uses
  %i.ht = insertelement <4 x float> poison, float %i.gw, i64 2
  %9 = insertelement <4 x float> %i.ht, float %i.gy, i64 3
  %i.hu = shufflevector <2 x float> %i.hp, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.hv = shufflevector <4 x float> %i.hu, <4 x float> %9, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.hw = fsub <4 x float> %6, %i.hv              ; 3 uses
  %10 = fneg float %5                             ; 4 uses
  %i.hx = fmul float %i.er, %10
  %i.hy = insertelement <4 x float> %i.hw, float %i.hs, i64 3
  %11 = shufflevector <2 x float> %i.hk, <2 x float> poison, <4 x i32> <i32 poison, i32 0, i32 1, i32 poison>
  %i.hz = insertelement <4 x float> poison, float %5, i64 0 ; 2 uses
  %12 = shufflevector <4 x float> %i.hz, <4 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 0>
  %i.ia = shufflevector <4 x float> %i.hy, <4 x float> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 3>
  %13 = shufflevector <4 x float> %11, <4 x float> %12, <4 x i32> <i32 1, i32 2, i32 4, i32 7>
  %14 = fmul <4 x float> %i.ia, %13
  %15 = shufflevector <2 x float> %i.hl, <2 x float> poison, <4 x i32> <i32 1, i32 poison, i32 0, i32 0>
  %16 = insertelement <4 x float> %15, float %10, i64 1
  %i.ib = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.hw, <4 x float> %16, <4 x float> %14) ; 5 uses
  %i.ic = extractelement <4 x float> %i.ib, i64 2
  %i.id = fneg float %i.ic                        ; 3 uses
  %i.ie = extractelement <4 x float> %i.ib, i64 0
  %i.if = fneg float %i.ie                        ; 3 uses
  %i.ig = extractelement <4 x float> %i.hw, i64 3
  %17 = fmul float %i.ig, %i.hm
  %i.ih = fmul float %8, %i.hn
  ...
  %18 = extractelement <4 x float> %i.ib, i64 1
  %19 = fneg float %18                            ; 3 uses
  %20 = tail call float @llvm.fmuladd.f32(float %8, float %10, float %17) ; 3 uses
  %21 = extractelement <4 x float> %i.ib, i64 3   ; 2 uses
  %i.ir = fmul float %21, %i.iq
  %i.is = insertelement <2 x float> poison, float %i.im, i64 0
  %i.it = insertelement <2 x float> %i.is, float %i.io, i64 1
  %i.iu = insertelement <2 x float> %i.hl, float %i.id, i64 0
  %i.iv = fmul <2 x float> %i.it, %i.iu
  %i.iw = fmul float %i.hm, %i.ik
  %i.ix = shufflevector <2 x float> %i.hk, <2 x float> %i.hl, <4 x i32> <i32 0, i32 poison, i32 2, i32 poison>
  %i.iy = insertelement <4 x float> %i.ix, float %19, i64 1
  %22 = insertelement <4 x float> %i.iy, float %20, i64 3
  ...
  %i.ji = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %22, <4 x float> %i.jd, <4 x float> %i.jh)
  %i.jj = insertelement <4 x float> %i.hz, float %i.if, i64 1
  %i.jk = insertelement <4 x float> %i.jj, float %10, i64 2
  ...
  %i.ki = fmul float %i.kh, %i.id
  %i.kj = tail call float @llvm.fmuladd.f32(float %i.kg, float %19, float %i.ki)
  %i.kk = load float, ptr %i.gh, align 8, !tbaa !52
  %i.kl = tail call noundef float @llvm.fmuladd.f32(float %i.kk, float %i.if, float %i.kj)
  ...
  %i.kr = fmul float %21, %i.kq
  %i.ks = tail call float @llvm.fmuladd.f32(float %i.kp, float %20, float %i.kr)
  ...
  %23 = shufflevector <4 x float> %i.ib, <4 x float> poison, <2 x i32> <i32 3, i32 3>
  %i.lc = shufflevector <2 x float> %i.la, <2 x float> %i.lb, <2 x i32> <i32 1, i32 3>
  %i.ld = fmul <2 x float> %23, %i.lc
  ...
  %i.lf = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.le, <2 x float> %25, <2 x float> %i.ld)
  ...
  %i.lt = insertelement <2 x float> poison, float %i.id, i64 0
  ...
  %i.lx = insertelement <2 x float> poison, float %19, i64 0
  ...
  %i.mc = insertelement <2 x float> poison, float %i.if, i64 0
...
bb.af:                                            ; preds = %bb.af, %_Z13b3PlaneSpace1I9b3Vector3EvRKT_RS1_S4_.exit.i
  ...
  %26 = extractelement <4 x float> %i.tk, i64 1
  %27 = fneg float %26                            ; 3 uses
  %28 = tail call float @llvm.fmuladd.f32(float %i.pi, float %i.sn, float %i.tq) ; 3 uses
  ...
  %i.uf = insertelement <4 x float> %i.ue, float %27, i64 1
  %i.ug = insertelement <4 x float> %i.uf, float %28, i64 3
  ...
  %i.vp = tail call float @llvm.fmuladd.f32(float %i.vm, float %27, float %i.vo)
  ...
  %i.vy = tail call float @llvm.fmuladd.f32(float %i.vv, float %28, float %i.vx)
  ...
  %i.wn = insertelement <2 x float> poison, float %28, i64 0
  ...
  %i.xc = insertelement <2 x float> poison, float %27, i64 0
