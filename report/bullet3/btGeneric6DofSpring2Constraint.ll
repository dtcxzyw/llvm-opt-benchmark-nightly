...
.split368:                                        ; preds = %bb.b
  ...
  %13 = load <2 x float>, ptr %4, align 4, !tbaa !13
  ...
  %14 = shufflevector <2 x float> %13, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %i.di = shufflevector <4 x float> %i.dh, <4 x float> %14, <4 x i32> <i32 5, i32 1, i32 poison, i32 3>
  ...
  %i.dq = shufflevector <4 x float> %14, <4 x float> %i.dp, <4 x i32> <i32 0, i32 5, i32 poison, i32 7>
...
bb.am:                                            ; preds = %.thread636
  ...
  %i.acn = getelementptr inbounds nuw i8, ptr %10, i64 4 ; 5 uses
  ...
  %i.acs = getelementptr inbounds nuw i8, ptr %10, i64 8 ; 4 uses
...
.thread:                                          ; preds = %bb.ao, %bb.an
  ...
  %15 = load float, ptr %i.adu, align 4, !tbaa !13
  ...
  %18 = load float, ptr %i.agh, align 4, !tbaa !13
  %19 = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.agi = load float, ptr %19, align 4, !tbaa !13
  %20 = load float, ptr %10, align 4, !tbaa !13
  %21 = load float, ptr %i.acn, align 4, !tbaa !13
  %22 = load float, ptr %i.acs, align 4, !tbaa !13
  ...
  %i.agw = insertelement <2 x float> %23, float %i.agf, i64 1
  ...
  %i.ahb = insertelement <2 x float> %24, float %18, i64 1 ; 2 uses
  ...
  %25 = insertelement <2 x float> poison, float %i.agi, i64 0
  %i.aht = insertelement <2 x float> %25, float %i.agk, i64 1
  %i.ahu = fadd <2 x float> %i.ahm, %i.aht
  %26 = insertelement <2 x float> poison, float %21, i64 0
  %27 = shufflevector <2 x float> %26, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ahv = fmul <2 x float> %i.ahs, %27
  %28 = insertelement <2 x float> poison, float %20, i64 0
  %i.ahw = shufflevector <2 x float> %28, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.ahy = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ahu, <2 x float> %30, <2 x float> %i.ahx) ; 2 uses
