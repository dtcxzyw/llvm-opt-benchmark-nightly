...
bb.a:
  ...
  %i.q = load ptr, ptr %i.p, align 8, !tbaa !40, !nonnull !41, !align !42 ; 7 uses
  ...
  %3 = load <3 x float>, ptr %i.aa, align 8, !tbaa !14, !noalias !129
  %4 = fneg <3 x float> %3                        ; 6 uses
  %5 = shufflevector <3 x float> %4, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %6 = fmul <2 x float> %i.au, %5
  %i.aw = shufflevector <3 x float> %4, <3 x float> poison, <2 x i32> zeroinitializer
  %7 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.at, <2 x float> %i.aw, <2 x float> %6)
  %8 = shufflevector <3 x float> %4, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.ax = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.av, <2 x float> %8, <2 x float> %7)
  %9 = extractelement <3 x float> %4, i64 1
  %10 = fmul float %i.y, %9
  %11 = extractelement <3 x float> %4, i64 0
  %12 = tail call float @llvm.fmuladd.f32(float %i.x, float %11, float %10)
  %13 = extractelement <3 x float> %4, i64 2
  %i.ay = tail call noundef float @llvm.fmuladd.f32(float %i.z, float %13, float %12)
  ...
  %i.cq = load ptr, ptr %i.cp, align 8, !tbaa !43, !nonnull !41, !align !42 ; 7 uses
  ...
  %i.da = getelementptr inbounds nuw i8, ptr %i.cq, i64 56
  ...
  %14 = load <3 x float>, ptr %i.da, align 8, !tbaa !14, !noalias !131
  %15 = fneg <3 x float> %14                      ; 6 uses
  %16 = shufflevector <3 x float> %15, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %17 = fmul <2 x float> %i.df, %16
  %i.dh = shufflevector <3 x float> %15, <3 x float> poison, <2 x i32> zeroinitializer
  %18 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.de, <2 x float> %i.dh, <2 x float> %17)
  %19 = shufflevector <3 x float> %15, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.di = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dg, <2 x float> %19, <2 x float> %18)
  %20 = extractelement <3 x float> %15, i64 1
  %21 = fmul float %i.cy, %20
  %22 = extractelement <3 x float> %15, i64 0
  %23 = tail call float @llvm.fmuladd.f32(float %i.cx, float %22, float %21)
  %24 = extractelement <3 x float> %15, i64 2
  %i.dj = tail call noundef float @llvm.fmuladd.f32(float %i.cz, float %24, float %23)
