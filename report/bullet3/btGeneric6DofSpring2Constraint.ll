...
bb.a:
  ...
  %.sroa.8.0.copyload.i = load <2 x float>, ptr %.sroa.8.0..sroa_idx.i, align 4, !tbaa !12
  %.sroa.0.0.copyload3.i3 = load <2 x float>, ptr %2, align 4 ; 2 uses
  %.sroa.8.0..sroa_idx.i4 = getelementptr inbounds nuw i8, ptr %2, i64 8
  %.sroa.8.0.copyload.i5 = load <2 x float>, ptr %.sroa.8.0..sroa_idx.i4, align 4, !tbaa !12
  ...
  %3 = shufflevector <2 x float> %.sroa.8.0.copyload.i5, <2 x float> %.sroa.8.0.copyload.i, <2 x i32> <i32 0, i32 2> ; 3 uses
  %i.e = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %3, <2 x float> %3, <2 x float> %i.d)
  ...
  %i.l = fmul <2 x float> %3, %i.g                ; 5 uses
