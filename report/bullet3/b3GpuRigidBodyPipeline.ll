...
bb.a:
  ...
  %i.b = getelementptr inbounds [80 x i8], ptr %1, i64 %i.a ; 8 uses
...
bb.b:                                             ; preds = %bb.a
  %.sroa.627.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.b, i64 28
  %.sroa.627.0.copyload = load float, ptr %.sroa.627.0..sroa_idx, align 4 ; 5 uses
  %i.j = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  %.sroa.526.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.b, i64 24
  %.sroa.425.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.b, i64 20
  ...
  %.sroa.526.0.copyload = load float, ptr %.sroa.526.0..sroa_idx, align 8 ; 4 uses
  %.sroa.425.0.copyload = load float, ptr %.sroa.425.0..sroa_idx, align 4 ; 5 uses
  %.sroa.024.0.copyload = load float, ptr %i.j, align 16 ; 6 uses
  ...
  %5 = fmul float %.sroa.425.0.copyload, %.sroa.425.0.copyload
  %6 = tail call float @llvm.fmuladd.f32(float %.sroa.024.0.copyload, float %.sroa.024.0.copyload, float %5)
  %i.t = tail call float @llvm.fmuladd.f32(float %.sroa.526.0.copyload, float %.sroa.526.0.copyload, float %6)
  %i.u = tail call noundef float @llvm.fmuladd.f32(float %.sroa.627.0.copyload, float %.sroa.627.0.copyload, float %i.t)
  %7 = fdiv float 2.000000e+00, %i.u              ; 3 uses
  %8 = fmul float %.sroa.024.0.copyload, %7       ; 2 uses
  %9 = fmul float %.sroa.425.0.copyload, %7       ; 3 uses
  %10 = fmul float %.sroa.627.0.copyload, %8      ; 2 uses
  %11 = fmul float %.sroa.627.0.copyload, %9      ; 2 uses
  %12 = fmul float %.sroa.024.0.copyload, %8      ; 2 uses
  %13 = fmul float %.sroa.024.0.copyload, %9      ; 2 uses
  %i.v = fmul float %.sroa.526.0.copyload, %7     ; 4 uses
  %14 = fmul float %.sroa.425.0.copyload, %9      ; 2 uses
  %15 = fmul float %.sroa.425.0.copyload, %i.v    ; 2 uses
  %16 = fmul float %.sroa.024.0.copyload, %i.v    ; 2 uses
  %17 = fmul float %.sroa.526.0.copyload, %i.v    ; 2 uses
  %18 = fadd float %14, %17
  %19 = fsub float 1.000000e+00, %18
  %20 = fadd float %12, %17
  %21 = fmul float %.sroa.627.0.copyload, %i.v    ; 2 uses
  %22 = fadd float %13, %21
  %23 = insertelement <2 x float> <float poison, float 1.000000e+00>, float %13, i64 0
  %i.w = insertelement <2 x float> poison, float %21, i64 0
  %24 = insertelement <2 x float> %i.w, float %20, i64 1
  %i.x = fsub <2 x float> %23, %24                ; 2 uses
  %i.y = fsub float %15, %10
  %i.z = fadd float %16, %11
  %25 = fsub float %16, %11                       ; 2 uses
  %26 = fadd float %15, %10                       ; 2 uses
  %27 = fadd float %12, %14
  %i.aa = fsub float 1.000000e+00, %27            ; 2 uses
  %28 = insertelement <2 x float> poison, float %19, i64 0
  %i.ab = insertelement <2 x float> %28, float %22, i64 1 ; 2 uses
  ...
  %i.ae = insertelement <2 x float> %29, float %i.y, i64 1 ; 2 uses
  %i.af = tail call <2 x float> @llvm.fabs.v2f32(<2 x float> %i.ae)
  %i.ag = tail call noundef float @llvm.fabs.f32(float %25)
  %i.ah = tail call noundef float @llvm.fabs.f32(float %26)
  ...
  %i.aq = fmul float %26, %i.ap
  %i.ar = extractelement <3 x float> %i.s, i64 0
  %i.as = tail call float @llvm.fmuladd.f32(float %i.ar, float %25, float %i.aq)
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.s = load float, ptr %i.l, align 4, !tbaa !132 ; 4 uses
  %i.t = load float, ptr %i.k, align 4, !tbaa !132 ; 5 uses
  ...
  %i.aa = fmul float %i.t, %i.y                   ; 3 uses
  %i.ab = fmul float %i.n, %i.z                   ; 2 uses
  %i.ac = fmul float %i.n, %i.aa                  ; 2 uses
  %i.ad = fmul float %i.r, %i.z                   ; 2 uses
  %i.ae = fmul float %i.r, %i.aa                  ; 2 uses
  %i.af = fmul float %i.s, %i.y                   ; 4 uses
  %i.ag = fmul float %i.t, %i.aa                  ; 2 uses
  %i.ah = fmul float %i.t, %i.af                  ; 2 uses
  %i.ai = fmul float %i.r, %i.af                  ; 2 uses
  %i.aj = fmul float %i.s, %i.af                  ; 2 uses
  %i.ak = fadd float %i.ag, %i.aj
  %i.al = fsub float 1.000000e+00, %i.ak
  %i.am = fadd float %i.ad, %i.aj
  %i.an = fmul float %i.n, %i.af                  ; 2 uses
  %i.ao = fadd float %i.ae, %i.an
  %i.ap = insertelement <2 x float> <float poison, float 1.000000e+00>, float %i.ae, i64 0
  ...
  %i.at = fsub float %i.ah, %i.ab
  %10 = fadd float %i.ai, %i.ac
  %i.au = fsub float %i.ai, %i.ac                 ; 2 uses
  %i.av = fadd float %i.ah, %i.ab                 ; 2 uses
  %i.aw = fadd float %i.ad, %i.ag
