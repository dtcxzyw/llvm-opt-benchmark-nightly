...
bb.b:                                             ; preds = %.lr.ph230, %bb.ar
  ...
  %.sroa.17.0228 = phi i32 [ undef, %.lr.ph230 ], [ %.sroa.17.3, %bb.ar ]
  %.sroa.12207.0227 = phi ptr [ undef, %.lr.ph230 ], [ %.sroa.12207.3, %bb.ar ]
...
.loopexit214:                                     ; preds = %.epil.preheader, %.loopexit214.loopexit.unr-lcssa, %_ZN20btAlignedObjectArrayIPsE9push_backERKS0_.exit, %bb.h
  ...
  %.sroa.17.1 = phi i32 [ %.sroa.17.0228, %bb.h ], [ 6, %_ZN20btAlignedObjectArrayIPsE9push_backERKS0_.exit ], [ 6, %.loopexit214.loopexit.unr-lcssa ], [ 6, %.epil.preheader ]
...
.loopexit213:                                     ; preds = %scalar.ph340.prol.loopexit, %scalar.ph340, %_ZN20btAlignedObjectArrayIPsE9push_backERKS0_.exit135, %.loopexit214
  ...
  %.sroa.12207.2 = phi ptr [ %.sroa.12207.1, %.loopexit214 ], [ %i.gu, %_ZN20btAlignedObjectArrayIPsE9push_backERKS0_.exit135 ], [ %i.gu, %scalar.ph340 ], [ %i.gu, %scalar.ph340.prol.loopexit ]
  %.sroa.17.2.a = phi i32 [ %.sroa.17.1, %.loopexit214 ], [ 6, %_ZN20btAlignedObjectArrayIPsE9push_backERKS0_.exit135 ], [ 6, %scalar.ph340 ], [ 6, %scalar.ph340.prol.loopexit ]
  %.sroa.31.1 = phi i32 [ %.sroa.31.0, %.loopexit214 ], [ 3, %_ZN20btAlignedObjectArrayIPsE9push_backERKS0_.exit135 ], [ 3, %scalar.ph340 ], [ 3, %scalar.ph340.prol.loopexit ]
...
.loopexit212:                                     ; preds = %scalar.ph383.prol.loopexit, %scalar.ph383, %.lr.ph222, %middle.block392, %_ZN20btAlignedObjectArrayIPiE9push_backERKS0_.exit, %_ZN20btAlignedObjectArrayIPhE9push_backERKS0_.exit, %.loopexit213
  %.sroa.12207.3 = phi ptr [ %.sroa.12207.2, %.loopexit213 ], [ %i.ka, %_ZN20btAlignedObjectArrayIPhE9push_backERKS0_.exit ], [ %i.ap, %_ZN20btAlignedObjectArrayIPiE9push_backERKS0_.exit ], [ %i.ap, %middle.block392 ], [ %i.ka, %.lr.ph222 ], [ %i.ap, %scalar.ph383 ], [ %i.ap, %scalar.ph383.prol.loopexit ] ; 3 uses
  %.sroa.17.3 = phi i32 [ %.sroa.17.2.a, %.loopexit213 ], [ 3, %_ZN20btAlignedObjectArrayIPhE9push_backERKS0_.exit ], [ 12, %_ZN20btAlignedObjectArrayIPiE9push_backERKS0_.exit ], [ 12, %middle.block392 ], [ 3, %.lr.ph222 ], [ 12, %scalar.ph383 ], [ 12, %scalar.ph383.prol.loopexit ] ; 2 uses
  %.sroa.31.2 = phi i32 [ %.sroa.31.1, %.loopexit213 ], [ 5, %_ZN20btAlignedObjectArrayIPhE9push_backERKS0_.exit ], [ 2, %_ZN20btAlignedObjectArrayIPiE9push_backERKS0_.exit ], [ 2, %middle.block392 ], [ 5, %.lr.ph222 ], [ 2, %scalar.ph383 ], [ 2, %scalar.ph383.prol.loopexit ] ; 2 uses
...
bb.a:
  ...
  %i.e = load i32, ptr %i.d, align 8, !tbaa !337  ; 4 uses
...
.lr.ph:                                           ; preds = %bb.a
  %i.n = load ptr, ptr %1, align 8, !tbaa !338
  %wide.trip.count = zext nneg i32 %i.e to i64
  br label %bb.f

._crit_edge:                                      ; preds = %bb.u, %bb.a
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 188 ; 4 uses
  %i.p = load i32, ptr %i.o, align 4, !tbaa !93   ; 7 uses
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 192 ; 2 uses
  %i.r = load i32, ptr %i.q, align 8, !tbaa !94
  %i.s = icmp eq i32 %i.p, %i.r
  br i1 %i.s, label %bb.b, label %_ZN20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE9push_backERKS1_.exit
...
bb.b:                                             ; preds = %._crit_edge
  ...
  br i1 %i.v, label %bb.c, label %_ZN20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE9push_backERKS1_.exit
...
bb.d:                                             ; preds = %bb.c
  ...
  %.pre.i = load i32, ptr %i.o, align 4, !tbaa !93
...
_ZN20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE8allocateEi.exit.i.i: ; preds = %bb.d, %bb.c
  %i.z = phi i32 [ %.pre.i, %bb.d ], [ %i.p, %bb.c ] ; 5 uses
  %.0.i.i.i = phi ptr [ %i.y, %bb.d ], [ null, %bb.c ] ; 8 uses
  %i.aa = icmp sgt i32 %i.z, 0
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 200 ; 2 uses
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !92 ; 9 uses
  br i1 %i.aa, label %.lr.ph.i.i.i, label %_ZNK20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE4copyEiiPS1_.exit.i.i
...
.lr.ph.i.i.i:                                     ; preds = %_ZN20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE8allocateEi.exit.i.i
  ...
  %.0.i.i.i76 = ptrtoaddr ptr %.0.i.i.i to i64
  %wide.trip.count.i.i.i = zext nneg i32 %i.z to i64 ; 5 uses
  %min.iters.check = icmp ult i32 %i.z, 8
  %i.ae = sub i64 %i.ad, %.0.i.i.i76
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.af = getelementptr inbounds nuw [8 x i8], ptr %.0.i.i.i, i64 %index ; 2 uses
  %i.ag = getelementptr inbounds nuw [8 x i8], ptr %i.ac, i64 %index ; 2 uses
  %i.ah = getelementptr inbounds nuw i8, ptr %i.ag, i64 16
  %wide.load = load <2 x ptr>, ptr %i.ag, align 8, !tbaa !335
  %wide.load77 = load <2 x ptr>, ptr %i.ah, align 8, !tbaa !335
  %i.ai = getelementptr inbounds nuw i8, ptr %i.af, i64 16
  store <2 x ptr> %wide.load, ptr %i.af, align 8, !tbaa !335
  store <2 x ptr> %wide.load77, ptr %i.ai, align 8, !tbaa !335
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.aj = icmp eq i64 %index.next, %n.vec
  br i1 %i.aj, label %middle.block, label %vector.body, !llvm.loop !473
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  %i.ak = getelementptr inbounds nuw [8 x i8], ptr %.0.i.i.i, i64 %indvars.iv.i.i.i.prol
  %i.al = getelementptr inbounds nuw [8 x i8], ptr %i.ac, i64 %indvars.iv.i.i.i.prol
  %i.am = load ptr, ptr %i.al, align 8, !tbaa !335
  store ptr %i.am, ptr %i.ak, align 8, !tbaa !335
  %indvars.iv.next.i.i.i.prol = add nuw nsw i64 %indvars.iv.i.i.i.prol, 1 ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
...
scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  ...
  br i1 %i.ao, label %_ZNK20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE4copyEiiPS1_.exit.thread.i.i, label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  %indvars.iv.i.i.i = phi i64 [ %indvars.iv.next.i.i.i.3, %scalar.ph ], [ %indvars.iv.i.i.i.unr, %scalar.ph.prol.loopexit ] ; 6 uses
  %i.ap = getelementptr inbounds nuw [8 x i8], ptr %.0.i.i.i, i64 %indvars.iv.i.i.i
  %i.aq = getelementptr inbounds nuw [8 x i8], ptr %i.ac, i64 %indvars.iv.i.i.i
  %i.ar = load ptr, ptr %i.aq, align 8, !tbaa !335
  store ptr %i.ar, ptr %i.ap, align 8, !tbaa !335
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1 ; 2 uses
  %i.as = getelementptr inbounds nuw [8 x i8], ptr %.0.i.i.i, i64 %indvars.iv.next.i.i.i
  %i.at = getelementptr inbounds nuw [8 x i8], ptr %i.ac, i64 %indvars.iv.next.i.i.i
  %i.au = load ptr, ptr %i.at, align 8, !tbaa !335
  store ptr %i.au, ptr %i.as, align 8, !tbaa !335
  %indvars.iv.next.i.i.i.1 = add nuw nsw i64 %indvars.iv.i.i.i, 2 ; 2 uses
  %i.av = getelementptr inbounds nuw [8 x i8], ptr %.0.i.i.i, i64 %indvars.iv.next.i.i.i.1
  %i.aw = getelementptr inbounds nuw [8 x i8], ptr %i.ac, i64 %indvars.iv.next.i.i.i.1
  %i.ax = load ptr, ptr %i.aw, align 8, !tbaa !335
  store ptr %i.ax, ptr %i.av, align 8, !tbaa !335
  %indvars.iv.next.i.i.i.2 = add nuw nsw i64 %indvars.iv.i.i.i, 3 ; 2 uses
  %i.ay = getelementptr inbounds nuw [8 x i8], ptr %.0.i.i.i, i64 %indvars.iv.next.i.i.i.2
  %i.az = getelementptr inbounds nuw [8 x i8], ptr %i.ac, i64 %indvars.iv.next.i.i.i.2
  %i.ba = load ptr, ptr %i.az, align 8, !tbaa !335
  store ptr %i.ba, ptr %i.ay, align 8, !tbaa !335
  %indvars.iv.next.i.i.i.3 = add nuw nsw i64 %indvars.iv.i.i.i, 4 ; 2 uses
  %exitcond.not.i.i.i.3 = icmp eq i64 %indvars.iv.next.i.i.i.3, %wide.trip.count.i.i.i
...
_ZNK20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE4copyEiiPS1_.exit.i.i: ; preds = %_ZN20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE8allocateEi.exit.i.i
  %.not.i5.i.i = icmp eq ptr %i.ac, null
...
_ZNK20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE4copyEiiPS1_.exit.thread.i.i: ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block, %_ZNK20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE4copyEiiPS1_.exit.i.i
  ...
  %i.bc = load i8, ptr %i.bb, align 8, !tbaa !91, !range !135, !noundef !144
  %i.bd = trunc nuw i8 %i.bc to i1
  br i1 %i.bd, label %bb.e, label %_ZN20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE10deallocateEv.exit.i.i

bb.e:                                             ; preds = %_ZNK20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE4copyEiiPS1_.exit.thread.i.i
  tail call void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %i.ac)
  %.pre2.pre.pre.i = load i32, ptr %i.o, align 4, !tbaa !93
...
_ZN20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE10deallocateEv.exit.i.i: ; preds = %bb.e, %_ZNK20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE4copyEiiPS1_.exit.thread.i.i, %_ZNK20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE4copyEiiPS1_.exit.i.i
  %.pre2.i = phi i32 [ %i.z, %_ZNK20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE4copyEiiPS1_.exit.i.i ], [ %.pre2.pre.pre.i, %bb.e ], [ %i.z, %_ZNK20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE4copyEiiPS1_.exit.thread.i.i ]
  %i.be = getelementptr inbounds nuw i8, ptr %0, i64 208
  store i8 1, ptr %i.be, align 8, !tbaa !91
  store ptr %.0.i.i.i, ptr %i.ab, align 8, !tbaa !92
  store i32 %i.u, ptr %i.q, align 8, !tbaa !94
...
_ZN20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE9push_backERKS1_.exit: ; preds = %._crit_edge, %bb.b, %_ZN20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE10deallocateEv.exit.i.i
  %i.bf = phi i32 [ %.pre2.i, %_ZN20btAlignedObjectArrayIP27btStridingMeshInterfaceDataE10deallocateEv.exit.i.i ], [ %i.p, %bb.b ], [ %i.p, %._crit_edge ] ; 2 uses
