...
bb.a:
  ...
  %.sroa.8.0.copyload.i = load <2 x float>, ptr %.sroa.8.0..sroa_idx.i, align 4, !tbaa !11
  %.sroa.0.0.copyload3.i5 = load <2 x float>, ptr %2, align 4 ; 2 uses
  %.sroa.8.0..sroa_idx.i6 = getelementptr inbounds nuw i8, ptr %2, i64 8
  %.sroa.8.0.copyload.i7 = load <2 x float>, ptr %.sroa.8.0..sroa_idx.i6, align 4, !tbaa !11
  ...
  %3 = shufflevector <2 x float> %.sroa.8.0.copyload.i7, <2 x float> %.sroa.8.0.copyload.i, <2 x i32> <i32 0, i32 2> ; 3 uses
  %i.g = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %3, <2 x float> %3, <2 x float> %i.f)
  ...
  %i.n = fmul <2 x float> %3, %i.i                ; 5 uses
  %i.o = fneg float %i.l
