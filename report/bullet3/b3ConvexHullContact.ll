...
bb.c:                                             ; preds = %.lr.ph143, %bb.c
  ...
  %i.cg = getelementptr inbounds [16 x i8], ptr %16, i64 %i.cf ; 3 uses
  %.sroa.4130.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.cg, i64 4
  %.sroa.5131.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.cg, i64 8
  %.sroa.26.48.copyload.i = load float, ptr %.sroa.26.48..sroa_idx.i, align 8
  %i.ch = load float, ptr %i.af, align 4, !tbaa !37 ; 5 uses
  %.sroa.4130.0.copyload = load float, ptr %.sroa.4130.0..sroa_idx, align 4 ; 2 uses
  %.sroa.0129.0.copyload = load float, ptr %i.cg, align 16 ; 2 uses
  %.sroa.0129.0.copyload.a = load float, ptr %.sroa.5131.0..sroa_idx, align 8 ; 2 uses
  ...
  %21 = insertelement <2 x float> poison, float %.sroa.4130.0.copyload, i64 0
  ...
  %23 = insertelement <2 x float> poison, float %.sroa.0129.0.copyload, i64 0
  %i.ds = shufflevector <2 x float> %23, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %24 = insertelement <2 x float> poison, float %.sroa.0129.0.copyload.a, i64 0
  %25 = shufflevector <2 x float> %24, <2 x float> poison, <2 x i32> zeroinitializer
  %i.dw = insertelement <2 x float> poison, float %i.dk, i64 0
  %26 = insertelement <2 x float> %i.dw, float %i.dj, i64 1
  %27 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %25, <2 x float> %26, <2 x float> %i.dv)
  %i.dx = fmul float %.sroa.4130.0.copyload, %i.dm
  %i.dy = tail call float @llvm.fmuladd.f32(float %.sroa.0129.0.copyload, float %i.dl, float %i.dx)
  %i.dz = tail call noundef float @llvm.fmuladd.f32(float %.sroa.0129.0.copyload.a, float %i.do, float %i.dy)
  %i.ea = fadd <2 x float> %i.ci, %27
...
bb.g:                                             ; preds = %.lr.ph153, %bb.g
  ...
  %i.hu = getelementptr inbounds [16 x i8], ptr %13, i64 %i.ht ; 3 uses
  %.sroa.4.0..sroa_idx124 = getelementptr inbounds nuw i8, ptr %i.hu, i64 4
  ...
  %.sroa.4.0.copyload = load float, ptr %.sroa.4.0..sroa_idx124, align 4 ; 2 uses
  %.sroa.0.0.copyload = load float, ptr %i.hu, align 16 ; 2 uses
  %.sroa.0.0.copyload.a = load float, ptr %.sroa.5.0..sroa_idx, align 8 ; 2 uses
  ...
  %28 = insertelement <2 x float> poison, float %.sroa.4.0.copyload, i64 0
  ...
  %30 = insertelement <2 x float> poison, float %.sroa.0.0.copyload, i64 0
  %i.jg = shufflevector <2 x float> %30, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %31 = insertelement <2 x float> poison, float %.sroa.0.0.copyload.a, i64 0
  %32 = shufflevector <2 x float> %31, <2 x float> poison, <2 x i32> zeroinitializer
  %i.jk = insertelement <2 x float> poison, float %i.iy, i64 0
  %33 = insertelement <2 x float> %i.jk, float %i.ix, i64 1
  %34 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %32, <2 x float> %33, <2 x float> %i.jj)
  %i.jl = fmul float %.sroa.4.0.copyload, %i.ja
  %i.jm = tail call float @llvm.fmuladd.f32(float %.sroa.0.0.copyload, float %i.iz, float %i.jl)
  %i.jn = tail call noundef float @llvm.fmuladd.f32(float %.sroa.0.0.copyload.a, float %i.jc, float %i.jm)
  %i.jo = fadd <2 x float> %i.hw, %34
...
bb.c:                                             ; preds = %.lr.ph77, %bb.c
  ...
  %19 = getelementptr inbounds nuw i8, ptr %i.ch, i64 4
  %20 = getelementptr inbounds nuw i8, ptr %i.ch, i64 8
  ...
  %21 = load float, ptr %19, align 4, !tbaa !37   ; 2 uses
  %22 = load float, ptr %i.ch, align 16, !tbaa !37 ; 2 uses
  %i.dq = load float, ptr %20, align 8, !tbaa !37 ; 2 uses
  ...
  %i.dt = fmul <2 x float> %24, %i.ds
  %25 = insertelement <2 x float> poison, float %22, i64 0
  %i.du = shufflevector <2 x float> %25, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %26 = insertelement <2 x float> poison, float %i.dq, i64 0
  %27 = shufflevector <2 x float> %26, <2 x float> poison, <2 x i32> zeroinitializer
  %i.dy = insertelement <2 x float> poison, float %i.dl, i64 0
  %28 = insertelement <2 x float> %i.dy, float %i.dk, i64 1
  %29 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %27, <2 x float> %28, <2 x float> %i.dx)
  %i.dz = fmul float %21, %i.dn
  %i.ea = tail call float @llvm.fmuladd.f32(float %22, float %i.dm, float %i.dz)
  %i.eb = tail call noundef float @llvm.fmuladd.f32(float %i.dq, float %i.dp, float %i.ea)
  %i.ec = fadd <2 x float> %i.cj, %29
...
bb.b:                                             ; preds = %.lr.ph, %bb.e
  ...
  %.sroa.5141.0..sroa_idx = getelementptr inbounds nuw i8, ptr %gep, i64 4
  %.sroa.7.0..sroa_idx = getelementptr inbounds nuw i8, ptr %gep, i64 8
  %17 = load <2 x float>, ptr %gep, align 16      ; 5 uses
  %.sroa.0139.0.copyload = load float, ptr %.sroa.5141.0..sroa_idx, align 4
  %.sroa.7.0.copyload = load float, ptr %.sroa.7.0..sroa_idx, align 8 ; 3 uses
  %i.ii = fmul float %.sroa.0139.0.copyload, %i.ie
  %18 = extractelement <2 x float> %17, i64 0
  %19 = tail call float @llvm.fmuladd.f32(float %18, float %i.id, float %i.ii)
  %i.ij = tail call noundef float @llvm.fmuladd.f32(float %.sroa.7.0.copyload, float %i.hp, float %19) ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  %i.io = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.ip = fmul <2 x float> %i.ic, %i.io
  %i.iq = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ir = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.iq, <2 x float> %i.ia, <2 x float> %i.ip)
  %20 = insertelement <2 x float> poison, float %.sroa.7.0.copyload, i64 0
  ...
  %24 = shufflevector <2 x float> %17, <2 x float> %23, <4 x i32> <i32 1, i32 3, i32 3, i32 3>
  %i.is = fmul <4 x float> %i.da, %24
  %25 = shufflevector <2 x float> %17, <2 x float> %23, <4 x i32> <i32 0, i32 2, i32 2, i32 2>
  %i.it = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %25, <4 x float> %i.ig, <4 x float> %i.is) ; 3 uses
  %i.iu = extractelement <4 x float> %i.it, i64 0
  %i.iv = tail call noundef float @llvm.fmuladd.f32(float %.sroa.7.0.copyload, float %i.gl, float %i.iu)
...
bb.ao:                                            ; preds = %.lr.ph851, %bb.ar
  ...
  %i.aqe = getelementptr inbounds [48 x i8], ptr %11, i64 %i.aqd ; 7 uses
  ...
  %.sroa.4703.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.aqe, i64 4
  %.sroa.5704.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.aqe, i64 8
  ...
  %.sroa.4703.0.copyload = load float, ptr %.sroa.4703.0..sroa_idx, align 4 ; 2 uses
  %.sroa.0702.0.copyload = load float, ptr %i.aqe, align 16 ; 2 uses
  %.sroa.0702.0.copyload.a = load float, ptr %.sroa.5704.0..sroa_idx, align 8 ; 2 uses
  ...
  %26 = insertelement <2 x float> poison, float %.sroa.4703.0.copyload, i64 0
  %27 = shufflevector <2 x float> %26, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %28 = insertelement <2 x float> poison, float %.sroa.0702.0.copyload, i64 0
  %i.asj = shufflevector <2 x float> %28, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %29 = insertelement <2 x float> poison, float %.sroa.0702.0.copyload.a, i64 0
  %30 = shufflevector <2 x float> %29, <2 x float> poison, <2 x i32> zeroinitializer
  %i.asn = insertelement <2 x float> poison, float %i.asb, i64 0
  %31 = insertelement <2 x float> %i.asn, float %i.asa, i64 1
  %32 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %30, <2 x float> %31, <2 x float> %i.asm)
  %i.aso = fmul float %.sroa.4703.0.copyload, %i.asd
  %i.asp = call float @llvm.fmuladd.f32(float %.sroa.0702.0.copyload, float %i.asc, float %i.aso)
  %i.asq = call noundef float @llvm.fmuladd.f32(float %.sroa.0702.0.copyload.a, float %i.asf, float %i.asp)
  %i.asr = fadd <2 x float> %i.arf, %32
...
bb.c:                                             ; preds = %.lr.ph, %bb.f
  ...
  %gep = getelementptr [16 x i8], ptr %invariant.gep, i64 %indvars.iv ; 3 uses
  %.sroa.5173.0..sroa_idx = getelementptr inbounds nuw i8, ptr %gep, i64 4
  %.sroa.7.0..sroa_idx = getelementptr inbounds nuw i8, ptr %gep, i64 8
  %18 = load <2 x float>, ptr %gep, align 16      ; 5 uses
  %.sroa.0171.0.copyload = load float, ptr %.sroa.5173.0..sroa_idx, align 4
  %.sroa.7.0.copyload = load float, ptr %.sroa.7.0..sroa_idx, align 8 ; 3 uses
  %i.la = fmul float %.sroa.0171.0.copyload, %i.kq
  %19 = extractelement <2 x float> %18, i64 0
  %20 = tail call float @llvm.fmuladd.f32(float %19, float %i.kp, float %i.la)
  %i.lb = tail call noundef float @llvm.fmuladd.f32(float %.sroa.7.0.copyload, float %i.kf, float %20) ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  %i.lg = shufflevector <2 x float> %18, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.lh = fmul <2 x float> %i.ko, %i.lg
  %i.li = shufflevector <2 x float> %18, <2 x float> poison, <2 x i32> zeroinitializer
  %i.lj = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.li, <2 x float> %i.km, <2 x float> %i.lh)
  %21 = insertelement <2 x float> poison, float %.sroa.7.0.copyload, i64 0
  %22 = shufflevector <2 x float> %21, <2 x float> poison, <2 x i32> zeroinitializer
  %23 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %22, <2 x float> %i.gr, <2 x float> %i.lj)
  %24 = fadd <2 x float> %i.cz, %23               ; 3 uses
  %25 = shufflevector <2 x float> %18, <2 x float> %24, <4 x i32> <i32 1, i32 3, i32 3, i32 3>
  %i.lk = fmul <4 x float> %i.kv, %25
  %26 = shufflevector <2 x float> %18, <2 x float> %24, <4 x i32> <i32 0, i32 2, i32 2, i32 2>
  %i.ll = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %26, <4 x float> %i.ky, <4 x float> %i.lk) ; 3 uses
  %i.lm = extractelement <4 x float> %i.ll, i64 0
  %i.ln = tail call noundef float @llvm.fmuladd.f32(float %.sroa.7.0.copyload, float %i.fi, float %i.lm)
