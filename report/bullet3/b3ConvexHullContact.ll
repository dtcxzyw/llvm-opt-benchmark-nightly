...
bb.a:
  ...
  %i.h = load float, ptr %i.g, align 8, !tbaa !37
  ...
  %i.o = load float, ptr %i.e, align 8, !tbaa !37 ; 3 uses
  ...
  %6 = insertelement <2 x float> poison, float %i.o, i64 0
  %i.ag = insertelement <2 x float> %6, float %i.h, i64 1
  ...
  %i.aw = shufflevector <2 x float> %i.aj, <2 x float> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  ...
  %9 = insertelement <2 x float> %i.aw, float %5, i64 1
  %i.bb = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %8, <2 x float> %9, <2 x float> %i.az) ; 4 uses
  %i.bc = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %8, <2 x float> %i.aj, <2 x float> %i.ba) ; 2 uses
