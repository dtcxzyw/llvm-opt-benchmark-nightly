...
bb.b:                                             ; preds = %.lr.ph, %bb.f
  ...
  %9 = load float, ptr %i.j, align 4, !tbaa !36
  %10 = load <2 x float>, ptr %1, align 4, !tbaa !36
  %i.aa = load float, ptr %7, align 4, !tbaa !36
  %11 = load float, ptr %i.t, align 4, !tbaa !36  ; 3 uses
  %12 = load float, ptr %i.s, align 4, !tbaa !36  ; 2 uses
  %13 = load float, ptr %i.u, align 4, !tbaa !36  ; 2 uses
  %14 = load <2 x float>, ptr %i.e, align 4, !tbaa !36
  %15 = load float, ptr %8, align 4, !tbaa !36
  %16 = fmul float %11, %15
  %17 = fmul float %11, %i.aa
  %i.ab = insertelement <2 x float> poison, float %12, i64 0
  %i.ac = shufflevector <2 x float> %i.ab, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ad = shufflevector <2 x float> %10, <2 x float> %14, <2 x i32> <i32 0, i32 2>
  %18 = insertelement <2 x float> poison, float %17, i64 0
  %19 = insertelement <2 x float> %18, float %16, i64 1
  %i.ae = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ac, <2 x float> %i.ad, <2 x float> %19)
  %i.af = insertelement <2 x float> poison, float %13, i64 0
  ...
  %20 = fmul float %11, %i.z
  %21 = tail call float @llvm.fmuladd.f32(float %12, float %i.y, float %20)
  %22 = tail call noundef float @llvm.fmuladd.f32(float %13, float %9, float %21)
  %i.aj = load <2 x float>, ptr %i.k, align 4, !tbaa !36
  %i.ak = fadd <2 x float> %i.ai, %i.aj           ; 4 uses
  %i.al = load float, ptr %i.l, align 4, !tbaa !36
  %i.am = fadd float %22, %i.al                   ; 2 uses
