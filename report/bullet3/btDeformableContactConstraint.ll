...
bb.a:
  ...
  %i.h = getelementptr inbounds nuw i8, ptr %i.b, i64 156
  ...
  %i.t = load <2 x float>, ptr %i.c, align 4, !tbaa !40 ; 2 uses
  %i.u = load float, ptr %i.d, align 4, !tbaa !40 ; 2 uses
  %i.v = load float, ptr %1, align 4, !tbaa !40   ; 2 uses
  %i.w = load float, ptr %i.g, align 4, !tbaa !40 ; 2 uses
  %i.x = load <2 x float>, ptr %i.h, align 4, !tbaa !40 ; 2 uses
