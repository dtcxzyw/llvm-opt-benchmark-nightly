...
bb.a:
  ...
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !30, !nonnull !29, !align !31 ; 13 uses
  %8 = getelementptr inbounds nuw i8, ptr %i.i, i64 48 ; 2 uses
  %9 = getelementptr inbounds nuw i8, ptr %i.i, i64 56
  ...
  %i.m = getelementptr inbounds nuw i8, ptr %i.i, i64 20 ; 2 uses
  ...
  %i.ab = load <3 x float>, ptr %8, align 4, !tbaa !36
  %i.ac = fsub <3 x float> %i.aa, %i.ab           ; 6 uses
  %i.ad = load <2 x float>, ptr %i.i, align 4, !tbaa !36, !noalias !49
  %i.ae = load <2 x float>, ptr %i.j, align 4, !tbaa !36, !noalias !49
  %i.af = load <2 x float>, ptr %i.k, align 4, !tbaa !36, !noalias !49
...
bb.n:                                             ; preds = %bb.m, %_ZN29btSphereBoxCollisionAlgorithm20getSpherePenetrationERK9btVector3S2_RS0_S3_.exit
  ...
  %i.dn = load float, ptr %i.k, align 4, !tbaa !36
  %i.do = load float, ptr %i.n, align 4, !tbaa !36
  %i.dp = load float, ptr %i.q, align 4, !tbaa !36
  %i.dq = load <2 x float>, ptr %i.i, align 4, !tbaa !36
  %i.dr = load float, ptr %i.l, align 4, !tbaa !36
  %i.ds = load float, ptr %i.dk, align 4, !tbaa !36 ; 3 uses
  %i.dt = load float, ptr %2, align 4, !tbaa !36  ; 2 uses
  %10 = load float, ptr %.sroa.46.0..sroa_idx, align 4, !tbaa !36 ; 2 uses
  %11 = load <2 x float>, ptr %i.j, align 4, !tbaa !36
  %12 = load float, ptr %i.m, align 4, !tbaa !36
  %13 = fmul float %i.ds, %12
  %14 = fmul float %i.ds, %i.dr
  ...
  %i.dw = shufflevector <2 x float> %i.dq, <2 x float> %11, <2 x i32> <i32 0, i32 2>
  %15 = insertelement <2 x float> poison, float %14, i64 0
  %16 = insertelement <2 x float> %15, float %13, i64 1
  %i.dx = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dv, <2 x float> %i.dw, <2 x float> %16)
  %i.dy = insertelement <2 x float> poison, float %10, i64 0
  ...
  %i.ed = fmul float %i.ds, %i.do
  %i.ee = tail call float @llvm.fmuladd.f32(float %i.dt, float %i.dn, float %i.ed)
  %i.ef = tail call noundef float @llvm.fmuladd.f32(float %10, float %i.dp, float %i.ee)
  %i.eg = load <2 x float>, ptr %8, align 4, !tbaa !36
  %i.eh = fadd <2 x float> %i.ec, %i.eg
  %i.ei = load float, ptr %9, align 4, !tbaa !36
  ...
  %i.em = load <2 x float>, ptr %i.i, align 4, !tbaa !36
  %17 = load float, ptr %i.l, align 4, !tbaa !36
  %i.en = load float, ptr %i.bc, align 4, !tbaa !36 ; 3 uses
  %i.eo = load float, ptr %3, align 4, !tbaa !36  ; 2 uses
  %i.ep = load float, ptr %.sroa.49.0..sroa_idx, align 4, !tbaa !36 ; 2 uses
  %i.eq = load <2 x float>, ptr %i.j, align 4, !tbaa !36
  %18 = load float, ptr %i.m, align 4, !tbaa !36
  %19 = fmul float %i.en, %18
  %20 = fmul float %17, %i.en
  %21 = shufflevector <2 x float> %i.em, <2 x float> %i.eq, <2 x i32> <i32 0, i32 2>
  %22 = insertelement <2 x float> poison, float %i.eo, i64 0
  %23 = shufflevector <2 x float> %22, <2 x float> poison, <2 x i32> zeroinitializer
  %i.er = insertelement <2 x float> poison, float %20, i64 0
  %24 = insertelement <2 x float> %i.er, float %19, i64 1
  %i.es = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %21, <2 x float> %23, <2 x float> %24)
  ...
  %i.ey = load float, ptr %i.k, align 4, !tbaa !36
