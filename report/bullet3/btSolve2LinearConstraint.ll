...
bb.b:                                             ; preds = %bb.a
  ...
  %23 = load float, ptr %i.an, align 4, !tbaa !9
  %24 = load float, ptr %5, align 4, !tbaa !9     ; 2 uses
  %25 = getelementptr inbounds nuw i8, ptr %5, i64 4
  %i.ao = load float, ptr %25, align 4, !tbaa !9  ; 2 uses
  ...
  %26 = load float, ptr %i.as, align 4, !tbaa !9  ; 2 uses
  %27 = getelementptr inbounds nuw i8, ptr %10, i64 8
  %28 = load float, ptr %27, align 4, !tbaa !9    ; 2 uses
  ...
  %29 = insertelement <2 x float> %i.ah, float %23, i64 1 ; 2 uses
  %30 = insertelement <2 x float> poison, float %24, i64 0
  %31 = insertelement <2 x float> %30, float %i.aq, i64 1
  %32 = insertelement <2 x float> poison, float %i.ar, i64 0
  %i.cz = insertelement <2 x float> %32, float %28, i64 1
  ...
  %34 = insertelement <2 x float> %33, float %i.ao, i64 1
  ...
  %36 = tail call float @llvm.fmuladd.f32(float %i.c, float %i.fp, float %i.fr)
  %i.fs = tail call noundef float @llvm.fmuladd.f32(float %i.f, float %i.fq, float %36)
  ...
  %i.hc = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %29, <2 x float> %i.hb, <2 x float> %i.ha) ; 3 uses
  %37 = fmul <2 x float> %i.gw, %31               ; 3 uses
  %38 = fmul <2 x float> %i.hc, %i.cz             ; 3 uses
  %39 = extractelement <2 x float> %37, i64 1
  %40 = extractelement <2 x float> %i.gw, i64 1
  %i.hd = extractelement <2 x float> %38, i64 1
  ...
  %i.in = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %29, <2 x float> %i.im, <2 x float> %i.il) ; 3 uses
  %i.io = extractelement <2 x float> %i.id, i64 0
  %i.ip = fmul float %24, %i.io
  %i.iq = extractelement <2 x float> %i.ih, i64 1
  %i.ir = fmul float %i.ao, %i.iq
  %i.is = extractelement <2 x float> %i.id, i64 1 ; 2 uses
  %41 = fmul float %i.aq, %i.is
  %42 = extractelement <2 x float> %i.in, i64 0   ; 2 uses
  %43 = fmul float %i.ar, %42
  %i.it = extractelement <2 x float> %i.ih, i64 0 ; 2 uses
  %44 = fmul float %26, %i.it
  %45 = extractelement <2 x float> %i.in, i64 1   ; 2 uses
  %46 = fmul float %28, %45
  %47 = shufflevector <2 x float> %i.ei, <2 x float> %i.ih, <4 x i32> <i32 poison, i32 1, i32 0, i32 3>
  %48 = insertelement <4 x float> %47, float %i.fs, i64 0
  ...
  %49 = insertelement <4 x float> %i.iv, float %i.ir, i64 3
  %50 = fmul <4 x float> %48, %49
  %51 = shufflevector <2 x float> %37, <2 x float> %38, <4 x i32> <i32 poison, i32 0, i32 2, i32 poison>
  %52 = insertelement <4 x float> %51, float %15, i64 0
  %53 = insertelement <4 x float> %52, float %i.ip, i64 3
  %i.iw = shufflevector <2 x float> %i.gw, <2 x float> %i.hc, <4 x i32> <i32 poison, i32 0, i32 2, i32 poison>
  %i.ix = insertelement <4 x float> %i.iw, float %i.cm, i64 0
  %54 = shufflevector <4 x float> %i.ix, <4 x float> %i.ie, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %i.iy = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %53, <4 x float> %54, <4 x float> %50) ; 5 uses
  %i.iz = extractelement <4 x float> %i.iy, i64 1
  %i.ja = extractelement <4 x float> %i.iy, i64 3
  %55 = fmul float %i.it, %44
  ...
  %i.jh = fmul <2 x float> %37, %i.id
  %i.ji = fmul <2 x float> %35, %i.ih             ; 2 uses
  %i.jj = fmul <2 x float> %38, %i.in
  ...
  %i.ke = tail call noundef float @llvm.fmuladd.f32(float %41, float %i.is, float %i.ja)
  %i.kf = tail call noundef float @llvm.fmuladd.f32(float %39, float %40, float %i.iz)
  %i.kg = fadd float %6, %i.ke
  %i.kh = fadd float %6, %i.kf
  %i.ki = fadd float %11, %i.kg
  %i.kj = fadd float %11, %i.kh
  %i.kk = tail call float @llvm.fmuladd.f32(float %43, float %42, float %55)
  %i.kl = tail call noundef float @llvm.fmuladd.f32(float %46, float %45, float %i.kk)
  %i.km = tail call noundef float @llvm.fmuladd.f32(float %i.hd, float %i.he, float %i.kd)
