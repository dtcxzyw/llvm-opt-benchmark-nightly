...
bb.c:                                             ; preds = %bb.b
  ...
  %12 = load float, ptr %i.t, align 4, !tbaa !20
  %13 = load float, ptr %i.ad, align 4, !tbaa !20
  %14 = load float, ptr %i.ai, align 4, !tbaa !20
  ...
  %i.ec = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ed = fmul <2 x float> %i.eb, %i.ec
  %16 = insertelement <2 x float> poison, float %12, i64 0
  %i.ee = shufflevector <2 x float> %16, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.eh = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> zeroinitializer
