...
bb.c:                                             ; preds = %bb.b
  ...
  %.sroa.12556.8.vec.extract = load float, ptr %.sroa.12556.0..sroa_idx, align 4, !tbaa !126 ; 2 uses
  ...
  %47 = insertelement <2 x float> poison, float %.sroa.12556.8.vec.extract, i64 0
  %i.bd = shufflevector <2 x float> %47, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %.sroa.12556.8.vec.extract564 = load float, ptr %.sroa.12556.0..sroa_idx557, align 4, !tbaa !126 ; 2 uses
  ...
  %48 = insertelement <2 x float> poison, float %.sroa.12556.8.vec.extract564, i64 0
  %i.cv = shufflevector <2 x float> %48, <2 x float> poison, <2 x i32> zeroinitializer
