...
bb.y:                                             ; preds = %.critedge229
  ...
  %i.amc = fmul float %i.alz, %i.amb
  %48 = call float @llvm.fmuladd.f32(float %i.aly, float %47, float %i.amc)
  %49 = load float, ptr %i.akv, align 8, !tbaa !9 ; 2 uses
  %50 = fmul float %i.alw, %i.amb
  ...
  %i.ami = insertelement <2 x float> poison, float %48, i64 0
  %i.amj = insertelement <2 x float> %i.ami, float %50, i64 1
