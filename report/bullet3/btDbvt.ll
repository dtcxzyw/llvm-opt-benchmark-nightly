...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load67 = load <2 x ptr>, ptr %i.t, align 8, !tbaa !35
  %i.u = getelementptr inbounds nuw i8, ptr %i.r, i64 16
  store <2 x ptr> %wide.load, ptr %i.r, align 8, !tbaa !35
  store <2 x ptr> %wide.load67, ptr %i.u, align 8, !tbaa !35
...
_ZNK20btAlignedObjectArrayIPK10btDbvtNodeE4copyEiiPS2_.exit.thread.i: ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  ...
  br i1 %.old63, label %bb.c, label %_ZN20btAlignedObjectArrayIPK10btDbvtNodeE10deallocateEv.exit.i
...
.lr.ph:                                           ; preds = %.preheader, %bb.q
  ...
  %i.bd = phi i32 [ %i.cj, %bb.q ], [ %i.av, %.preheader ] ; 5 uses
...
_ZNK20btAlignedObjectArrayIPK10btDbvtNodeE16findLinearSearchERKS2_.exit: ; preds = %bb.i, %._crit_edge.loopexit.split.loop.exit.i, %.lr.ph
  %.023 = phi i32 [ -1, %.lr.ph ], [ %i.bm, %._crit_edge.loopexit.split.loop.exit.i ], [ %i.bd, %bb.i ] ; 2 uses
  ...
  br i1 %.not46, label %bb.p, label %.lr.ph.i29
...
.lr.ph.i37:                                       ; preds = %bb.l, %._crit_edge.loopexit.split.loop.exit.i34
  %.06.i28 = phi i32 [ %i.bv, %._crit_edge.loopexit.split.loop.exit.i34 ], [ %i.bd, %bb.l ]
  br label %bb.m
...
_ZNK20btAlignedObjectArrayIPK10btDbvtNodeE16findLinearSearchERKS2_.exit43: ; preds = %bb.n, %._crit_edge.loopexit.split.loop.exit.i42
  %.06.i36 = phi i32 [ %i.bz, %._crit_edge.loopexit.split.loop.exit.i42 ], [ %i.bd, %bb.n ]
  ...
  invoke void %i.cc(ptr noundef nonnull align 8 dereferenceable(8) %1, ptr noundef nonnull %i.bg, i32 noundef %i.cd, i32 noundef %.023, i32 noundef %.06.i28, i32 noundef %.06.i36)
...
bb.p:                                             ; preds = %_ZNK20btAlignedObjectArrayIPK10btDbvtNodeE16findLinearSearchERKS2_.exit
  ...
  invoke void %i.ch(ptr noundef nonnull align 8 dereferenceable(8) %1, ptr noundef nonnull %i.bg, i32 noundef %i.ci, i32 noundef %.023)
