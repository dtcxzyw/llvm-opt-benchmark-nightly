...
bb.cl:                                            ; preds = %bb.ck
  ...
  %14 = load float, ptr %i.ado, align 4, !tbaa !66
  %i.adp = getelementptr inbounds nuw i8, ptr %4, i64 36
  %15 = load float, ptr %i.adp, align 4, !tbaa !66
  %16 = fsub float %14, %15
  %17 = getelementptr inbounds nuw i8, ptr %4, i64 56
  %i.adq = load float, ptr %17, align 8, !tbaa !66
  %i.adr = getelementptr inbounds nuw i8, ptr %4, i64 40
  %18 = load float, ptr %i.adr, align 8, !tbaa !66
  %19 = fsub float %i.adq, %18
  %i.ads = load float, ptr %2, align 4, !tbaa !66
  %20 = getelementptr inbounds nuw i8, ptr %2, i64 4
  %21 = load float, ptr %20, align 4, !tbaa !66
  %i.adt = fmul float %16, %21
  %i.adu = call float @llvm.fmuladd.f32(float %i.adn, float %i.ads, float %i.adt)
  %i.adv = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.adw = load float, ptr %i.adv, align 4, !tbaa !66
  %i.adx = call noundef float @llvm.fmuladd.f32(float %19, float %i.adw, float %i.adu)
  br label %bb.cm
