...
bb.c:                                             ; preds = %bb.b
  ...
  %i.v = getelementptr inbounds nuw i8, ptr %3, i64 48 ; 2 uses
  ...
  %i.aa = fneg <3 x float> %i.z                   ; 5 uses
  %i.ab = shufflevector <3 x float> %i.aa, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  ...
  %6 = load <3 x float>, ptr %i.v, align 4, !tbaa !19, !noalias !94 ; 5 uses
  %7 = load float, ptr %i.v, align 4, !tbaa !19, !noalias !94
  %i.an = shufflevector <3 x float> %6, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.ao = fmul <2 x float> %i.x, %i.an
  %i.ap = shufflevector <3 x float> %6, <3 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.ar = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %8, <2 x float> %i.y, <2 x float> %i.aq)
  ...
  %9 = shufflevector <3 x float> %i.aa, <3 x float> %6, <2 x i32> <i32 1, i32 4>
  %i.au = fmul <2 x float> %i.at, %9
  ...
  %10 = insertelement <2 x float> %i.ad, float %7, i64 1
  %i.ax = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aw, <2 x float> %10, <2 x float> %i.au)
  ...
  %11 = shufflevector <3 x float> %i.aa, <3 x float> %6, <2 x i32> <i32 2, i32 5>
  %i.ba = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.az, <2 x float> %11, <2 x float> %i.ax) ; 2 uses
