...
bb.b:                                             ; preds = %.lr.ph, %bb.q
  ...
  %5 = load float, ptr %i.g, align 4, !tbaa !19   ; 2 uses
  %6 = load float, ptr %4, align 8, !tbaa !19     ; 2 uses
  ...
  %i.af = fdiv <4 x float> %i.ae, %i.ab           ; 4 uses
  %7 = extractelement <4 x float> %i.af, i64 0
  %8 = fadd float %7, %5
  %9 = extractelement <4 x float> %i.af, i64 1
  %10 = fadd float %9, %6
  ...
  %i.ap = extractelement <4 x float> %i.af, i64 2
  %i.aq = fadd float %5, %i.ap                    ; 2 uses
  %11 = extractelement <4 x float> %i.af, i64 3
  %12 = fadd float %6, %11                        ; 2 uses
  %13 = extractelement <2 x float> %i.ao, i64 0
  %14 = extractelement <2 x float> %i.ao, i64 1   ; 2 uses
  %15 = fadd float %13, %14
  %16 = fadd float %8, %i.aq
  %17 = fadd float %10, %12
  %i.ar = fmul float %15, 5.000000e-01            ; 2 uses
  %18 = fmul float %16, 5.000000e-01              ; 2 uses
  %i.as = fmul float %17, 5.000000e-01            ; 2 uses
  %i.at = fsub float %14, %i.ar                   ; 3 uses
  %i.au = fsub float %i.aq, %18                   ; 2 uses
  %i.av = fsub float %12, %i.as                   ; 3 uses
  %i.aw = load float, ptr %2, align 4, !tbaa !19
  %i.ax = fsub float %i.aw, %i.ar                 ; 4 uses
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %i.be = fsub float %i.bd, %18                   ; 4 uses
