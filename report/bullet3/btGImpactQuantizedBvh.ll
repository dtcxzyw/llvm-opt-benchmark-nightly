...
bb.c:                                             ; preds = %bb.b
  ...
  %6 = load <3 x float>, ptr %i.m, align 4, !tbaa !19, !noalias !93
  %7 = fneg <3 x float> %6                        ; 4 uses
  %8 = shufflevector <3 x float> %7, <3 x float> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.aa = fmul <2 x float> %i.y, %8
  %i.ab = shufflevector <3 x float> %7, <3 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %i.ad = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.z, <2 x float> %9, <2 x float> %i.ac)
  ...
  %10 = shufflevector <2 x float> %8, <2 x float> %i.an, <2 x i32> <i32 0, i32 3>
  %i.av = fmul <2 x float> %i.au, %10
  ...
  %11 = shufflevector <2 x float> %i.ab, <2 x float> %i.an, <2 x i32> <i32 0, i32 2>
  %i.ay = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ax, <2 x float> %11, <2 x float> %i.av)
  ...
  %12 = shufflevector <3 x float> %7, <3 x float> poison, <2 x i32> <i32 2, i32 poison>
  %i.bb = insertelement <2 x float> %12, float %i.ak, i64 1
