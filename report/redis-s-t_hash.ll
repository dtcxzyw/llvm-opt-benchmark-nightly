...
define dso_local range(i32 -1, 1) i32 @hashTypeNext(ptr noundef initializes((40, 48)) %0, i32 noundef %1) local_unnamed_addr #1 {
  ...
  %.not = icmp eq i32 %4, 0                       ; [#uses=1 type=i1]
...
67:                                               ; preds = %64, %hashTypeLength.exit
  ...
  %68 = load i32, ptr %2, align 4, !tbaa !9       ; [#uses=8 type=i32]
  %69 = and i32 %68, 192                          ; [#uses=1 type=i32]
...
.lr.ph:                                           ; preds = %.preheader
  ...
  %73 = and i32 %68, 64                           ; [#uses=1 type=i32]
  %74 = icmp eq i32 %73, 0                        ; [#uses=1 type=i1]
  %75 = and i32 %68, 128                          ; [#uses=2 type=i32]
  %.not189 = icmp eq i32 %75, 0                   ; [#uses=2 type=i1]
  br i1 %74, label %.lr.ph.split.us, label %.lr.ph.split

.lr.ph.split.us:                                  ; preds = %.lr.ph
  %76 = sext i32 %72 to i64                       ; [#uses=2 type=i64]
  %wide.trip.count214 = zext nneg i32 %70 to i64  ; [#uses=2 type=i64]
  br i1 %.not189, label %.critedge.us.us, label %.lr.ph.split.us.split

.critedge.us.us:                                  ; preds = %.lr.ph.split.us, %.critedge.us.us
  %indvars.iv211 = phi i64 [ %indvars.iv.next212, %.critedge.us.us ], [ 0, %.lr.ph.split.us ] ; [#uses=2 type=i64]
  ...
  %.idx231 = shl i64 %indvars.iv211, 4            ; [#uses=1 type=i64]
  %78 = getelementptr i8, ptr %77, i64 %.idx231   ; [#uses=1 type=ptr]
...
begin_hunk_3
  ...
  %indvars.iv.next212 = add nuw nsw i64 %indvars.iv211, 1 ; [#uses=2 type=i64]
  %exitcond215.not = icmp eq i64 %indvars.iv.next212, %wide.trip.count214 ; [#uses=1 type=i1]
...
.lr.ph.split.us.split:                            ; preds = %.lr.ph.split.us, %.critedge.us
  %indvars.iv206 = phi i64 [ %indvars.iv.next207, %.critedge.us ], [ 0, %.lr.ph.split.us ] ; [#uses=2 type=i64]
  ...
  %.idx230 = shl i64 %indvars.iv206, 4            ; [#uses=1 type=i64]
  %93 = getelementptr i8, ptr %92, i64 %.idx230   ; [#uses=1 type=ptr]
...
begin_hunk_4
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %11) #14
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #14
  %indvars.iv.next207 = add nuw nsw i64 %indvars.iv206, 1 ; [#uses=2 type=i64]
  %exitcond210.not = icmp eq i64 %indvars.iv.next207, %wide.trip.count214 ; [#uses=1 type=i1]
...
.loopexit.thread:                                 ; preds = %.critedge.us159, %.critedge.us.us, %.preheader, %.loopexit
  %.1105240 = phi i32 [ %.1105, %.loopexit ], [ %90, %.critedge.us.us ], [ 0, %.preheader ], [ %121, %.critedge.us159 ] ; [#uses=2 type=i32]
  %.1115238 = phi i32 [ %.1115, %.loopexit ], [ %91, %.critedge.us.us ], [ 0, %.preheader ], [ %122, %.critedge.us159 ] ; [#uses=1 type=i32]
  %138 = icmp eq i32 %.1115238, %70               ; [#uses=1 type=i1]
  %139 = and i32 %68, 64                          ; [#uses=1 type=i32]
...
.thread:                                          ; preds = %.loopexit.thread, %67
  %.2106 = phi i32 [ 0, %67 ], [ %.1105240, %.loopexit.thread ] ; [#uses=4 type=i32]
...
begin_hunk_6
  ...
  %148 = and i32 %68, 15                          ; [#uses=1 type=i32]
...
.lr.ph180.split.preheader:                        ; preds = %.thread241
  %160 = and i32 %68, 47                          ; [#uses=1 type=i32]
  %.not129242 = icmp eq i32 %160, 0               ; [#uses=1 type=i1]
  %spec.select243 = select i1 %.not129242, i32 0, i32 4 ; [#uses=1 type=i32]
  %161 = load i64, ptr %6, align 8                ; [#uses=1 type=i64]
  %162 = sext i32 %144 to i64                     ; [#uses=1 type=i64]
  %wide.trip.count219 = zext nneg i32 %158 to i64 ; [#uses=1 type=i64]
  br label %.lr.ph180.split

.lr.ph180.split.us.preheader:                     ; preds = %149
  %163 = lshr exact i32 %68, 3                    ; [#uses=1 type=i32]
  %spec.select = and i32 %163, 4                  ; [#uses=1 type=i32]
  %164 = sext i32 %144 to i64                     ; [#uses=1 type=i64]
  %wide.trip.count224 = zext nneg i32 %150 to i64 ; [#uses=1 type=i64]
  br label %.lr.ph180.split.us

.lr.ph180.split.us:                               ; preds = %.lr.ph180.split.us.preheader, %.lr.ph180.split.us
  %indvars.iv221 = phi i64 [ 0, %.lr.ph180.split.us.preheader ], [ %indvars.iv.next222, %.lr.ph180.split.us ] ; [#uses=2 type=i64]
  %165 = load ptr, ptr %17, align 8, !tbaa !148   ; [#uses=1 type=ptr]
  %.idx233 = shl i64 %indvars.iv221, 4            ; [#uses=1 type=i64]
  %166 = getelementptr i8, ptr %165, i64 %.idx233 ; [#uses=1 type=ptr]
...
begin_hunk_8
  ...
  %indvars.iv.next222 = add nuw nsw i64 %indvars.iv221, 1 ; [#uses=2 type=i64]
  %exitcond225.not = icmp eq i64 %indvars.iv.next222, %wide.trip.count224 ; [#uses=1 type=i1]
...
.lr.ph180.split:                                  ; preds = %.lr.ph180.split.preheader, %.lr.ph180.split
  %indvars.iv216 = phi i64 [ 0, %.lr.ph180.split.preheader ], [ %indvars.iv.next217, %.lr.ph180.split ] ; [#uses=2 type=i64]
  ...
  %.idx232 = shl i64 %indvars.iv216, 4            ; [#uses=1 type=i64]
  %181 = getelementptr i8, ptr %180, i64 %.idx232 ; [#uses=1 type=ptr]
...
begin_hunk_9
  ...
  %192 = call i32 @hashTypeSet(ptr noundef %190, ptr noundef %191, ptr noundef %185, ptr noundef %189, i32 noundef %spec.select243) ; [#uses=0 type=i32]
...
begin_hunk_10
  ...
  %indvars.iv.next217 = add nuw nsw i64 %indvars.iv216, 1 ; [#uses=2 type=i64]
  %exitcond220.not = icmp eq i64 %indvars.iv.next217, %wide.trip.count219 ; [#uses=1 type=i1]
...
.thread135:                                       ; preds = %._crit_edge.loopexit190, %.thread241
  %.0.lcssa252 = phi i1 [ false, %.thread241 ], [ %178, %._crit_edge.loopexit190 ] ; [#uses=3 type=i1]
  %.0100.lcssa247 = phi i1 [ true, %.thread241 ], [ %179, %._crit_edge.loopexit190 ] ; [#uses=1 type=i1]
...
208:                                              ; preds = %.thread135
  %209 = and i32 %68, 8                           ; [#uses=1 type=i32]
...
216:                                              ; preds = %207, %210, %208, %._crit_edge, %.loopexit.thread, %.loopexit
  ...
  %.3 = phi i32 [ %.1105240, %.loopexit.thread ], [ %.1105, %.loopexit ], [ %.2106, %._crit_edge ], [ %.2106, %208 ], [ %.2106, %210 ], [ %.2106, %207 ] ; [#uses=1 type=i32]
  %.2102 = phi i1 [ false, %.loopexit.thread ], [ false, %.loopexit ], [ false, %._crit_edge ], [ false, %208 ], [ false, %210 ], [ true, %207 ] ; [#uses=2 type=i1]
  %.2 = phi i1 [ false, %.loopexit.thread ], [ false, %.loopexit ], [ false, %._crit_edge ], [ %.0.lcssa252, %208 ], [ %.0.lcssa252, %210 ], [ %.0.lcssa252, %207 ] ; [#uses=1 type=i1]
...
hashTypeLength.exit:                              ; preds = %36, %48, %41
  ...
  %57 = load i32, ptr %5, align 4, !tbaa !9       ; [#uses=3 type=i32]
  %.not121 = icmp eq i32 %57, 0                   ; [#uses=3 type=i1]
...
.lr.ph:                                           ; preds = %64
  ...
  %70 = and i32 %57, 16                           ; [#uses=1 type=i32]
...
158:                                              ; preds = %157
  %159 = and i32 %57, 16                          ; [#uses=1 type=i32]
