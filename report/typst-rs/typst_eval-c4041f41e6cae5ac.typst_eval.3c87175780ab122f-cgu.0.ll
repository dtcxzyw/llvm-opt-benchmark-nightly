...
bb.a:
  %.sroa.4 = alloca [8 x i8], align 8             ; 12 uses
  %.sroa.13 = alloca [8 x i8], align 8            ; 8 uses
  ...
  switch i8 %i.c, label %default.unreachable42.i [
    i8 0, label %bb.b
    i8 1, label %bb.c
    i8 2, label %bb.d
    i8 3, label %bb.e
...
default.unreachable42.i:                          ; preds = %bb.a
  unreachable

bb.b:                                             ; preds = %bb.a
  %i.d = fmul double %i.b, 1.270000e+02           ; 2 uses
  %.inv41.i = fcmp ord double %i.d, 0.000000e+00
  %.sroa.031.0.i = select i1 %.inv41.i, double %i.d, double 0.000000e+00
  store double %.sroa.031.0.i, ptr %.sroa.4, align 8, !alias.scope !18995
...
bb.c:                                             ; preds = %bb.a
  ...
  %.inv40.i = fcmp ord double %i.e, 0.000000e+00
  %.sroa.028.0.i = select i1 %.inv40.i, double %i.e, double 0.000000e+00
  store double %.sroa.028.0.i, ptr %.sroa.4, align 8, !alias.scope !18995
  br label %_RNvMNtNtCsdaEETE4DqmE_13typst_library11foundations5valueNtB2_5Value7numeric.exit

bb.d:                                             ; preds = %bb.a
  %i.f = fmul double %i.b, 3.600000e+03           ; 2 uses
  %.inv39.i = fcmp ord double %i.f, 0.000000e+00
  %.sroa.025.0.i = select i1 %.inv39.i, double %i.f, double 0.000000e+00
  store double %.sroa.025.0.i, ptr %.sroa.4, align 8, !alias.scope !18995
  br label %_RNvMNtNtCsdaEETE4DqmE_13typst_library11foundations5valueNtB2_5Value7numeric.exit

bb.e:                                             ; preds = %bb.a
  %i.g = fmul double %i.b, 9.144000e+03           ; 2 uses
  %.inv38.i = fcmp ord double %i.g, 0.000000e+00
  %.sroa.022.0.i = select i1 %.inv38.i, double %i.g, double 0.000000e+00
  store double %.sroa.022.0.i, ptr %.sroa.4, align 8, !alias.scope !18995
  br label %_RNvMNtNtCsdaEETE4DqmE_13typst_library11foundations5valueNtB2_5Value7numeric.exit

bb.f:                                             ; preds = %bb.a
  %.inv37.i = fcmp ord double %i.b, 0.000000e+00
  %.sroa.019.0.i = select i1 %.inv37.i, double %i.b, double 0.000000e+00
  br label %_RNvMNtNtCsdaEETE4DqmE_13typst_library11foundations5valueNtB2_5Value7numeric.exit

bb.g:                                             ; preds = %bb.a
  %i.h = fmul double %i.b, f0x3F91DF46A2529D39    ; 2 uses
  %.inv36.i = fcmp ord double %i.h, 0.000000e+00
  %.sroa.016.0.i = select i1 %.inv36.i, double %i.h, double 0.000000e+00
  br label %_RNvMNtNtCsdaEETE4DqmE_13typst_library11foundations5valueNtB2_5Value7numeric.exit

bb.h:                                             ; preds = %bb.a
  %.inv35.i = fcmp ord double %i.b, 0.000000e+00
  %.sroa.0.0.i = select i1 %.inv35.i, double %i.b, double 0.000000e+00
  store double 0.000000e+00, ptr %.sroa.4, align 8, !alias.scope !18995
  br label %_RNvMNtNtCsdaEETE4DqmE_13typst_library11foundations5valueNtB2_5Value7numeric.exit

bb.i:                                             ; preds = %bb.a
  %.inv34.i = fcmp ord double %i.b, 0.000000e+00
  %.sroa.0.1.i = select i1 %.inv34.i, double %i.b, double 0.000000e+00
  br label %_RNvMNtNtCsdaEETE4DqmE_13typst_library11foundations5valueNtB2_5Value7numeric.exit

bb.j:                                             ; preds = %bb.a
  %i.i = fdiv double %i.b, 1.000000e+02           ; 2 uses
  %.inv.i = fcmp ord double %i.i, 0.000000e+00
  %.sroa.013.0.i = select i1 %.inv.i, double %i.i, double 0.000000e+00
  br label %_RNvMNtNtCsdaEETE4DqmE_13typst_library11foundations5valueNtB2_5Value7numeric.exit
...
_RNvMNtNtCsdaEETE4DqmE_13typst_library11foundations5valueNtB2_5Value7numeric.exit: ; preds = %bb.b, %bb.c, %bb.d, %bb.e, %bb.f, %bb.g, %bb.h, %bb.i, %bb.j
  %.sink44.i.sroa.phi = phi ptr [ %.sroa.4, %bb.j ], [ %.sroa.4, %bb.i ], [ %.sroa.13, %bb.h ], [ %.sroa.4, %bb.g ], [ %.sroa.4, %bb.f ], [ %.sroa.13, %bb.e ], [ %.sroa.13, %bb.d ], [ %.sroa.13, %bb.c ], [ %.sroa.13, %bb.b ]
  %.sroa.013.0.sink.i = phi double [ %.sroa.013.0.i, %bb.j ], [ %.sroa.0.1.i, %bb.i ], [ %.sroa.0.0.i, %bb.h ], [ %.sroa.016.0.i, %bb.g ], [ %.sroa.019.0.i, %bb.f ], [ 0.000000e+00, %bb.e ], [ 0.000000e+00, %bb.d ], [ 0.000000e+00, %bb.c ], [ 0.000000e+00, %bb.b ]
  %.sink.i = phi i64 [ 9, %bb.j ], [ 11, %bb.i ], [ 7, %bb.h ], [ 8, %bb.g ], [ 8, %bb.f ], [ 7, %bb.e ], [ 7, %bb.d ], [ 7, %bb.c ], [ 7, %bb.b ]
  store double %.sroa.013.0.sink.i, ptr %.sink44.i.sroa.phi, align 8, !alias.scope !18995
