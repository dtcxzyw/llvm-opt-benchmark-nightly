...
bb.e:                                             ; preds = %bb.b
  %i.r = load i64, ptr %i.j, align 8, !noalias !61 ; 3 uses
...
bb.g:                                             ; preds = %bb.d
  ...
  %i.z = load i64, ptr %i.j, align 8, !noalias !61 ; 3 uses
...
bb.p:                                             ; preds = %bb.o, %bb.n, %bb.m
  ...
  %i.an = load i64, ptr %i.j, align 8, !noalias !61
  %i.ao = add i64 %i.an, %.sroa.01.0.neg.i        ; 2 uses
  store i64 %i.ao, ptr %i.j, align 8, !noalias !61
  br label %bb.ak
...
bb.t:                                             ; preds = %bb.r
  ...
  store i64 %i.ax, ptr %i.j, align 8, !noalias !61
  br label %bb.ak

bb.u:                                             ; preds = %bb.r
  store i64 %i.aq, ptr %i.j, align 8, !noalias !61
...
bb.y:                                             ; preds = %bb.w
  %i.bn = load i64, ptr %i.j, align 8, !noalias !62 ; 2 uses
...
.sink.split.i.i:                                  ; preds = %bb.aj, %.split28.us.i, %bb.x
  ...
  store i64 %.sink61.i.i, ptr %i.i, align 8, !noalias !62
  br label %bb.z
...
bb.aa:                                            ; preds = %bb.y
  %i.br = load i64, ptr %i.i, align 8, !noalias !62
...
.split28.us.i:                                    ; preds = %.lr.ph
  %i.cc = load i64, ptr %i.j, align 8, !noalias !62
...
bb.ad:                                            ; preds = %.split26.us.i
  %i.ce = load i64, ptr %i.i, align 8, !noalias !62
  br label %bb.ae

bb.ae:                                            ; preds = %bb.ad, %.split26.us.i
  %.sroa.06.0.i.i = phi i64 [ %i.ce, %bb.ad ], [ %i.bd, %.split26.us.i ] ; 2 uses
  %i.cf = load i64, ptr %i.j, align 8, !noalias !62 ; 4 uses
...
bb.ag:                                            ; preds = %._crit_edge
  store i64 %i.bd, ptr %i.i, align 8, !noalias !62
  br label %_RNvXsw_NtNtCs3oUPovFnLWP_4core3str7patternNtB5_11StrSearcherNtB5_15ReverseSearcher9next_backCse52LceO7DeS_12typst_macros.exit
