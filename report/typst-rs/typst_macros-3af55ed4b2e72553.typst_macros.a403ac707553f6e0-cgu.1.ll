...
bb.b:                                             ; preds = %_RNvXsw_NtNtCs3oUPovFnLWP_4core3str7patternNtB5_11StrSearcherNtB5_15ReverseSearcher9next_backCse52LceO7DeS_12typst_macros.exit, %bb.a
  ...
  %i.o = load i64, ptr %1, align 8, !noalias !57
...
bb.d:                                             ; preds = %bb.b
  %i.p = load i8, ptr %i.l, align 2, !noalias !57
...
bb.f:                                             ; preds = %bb.b
  %i.t = load i64, ptr %i.b, align 8, !noalias !57 ; 5 uses
...
bb.g:                                             ; preds = %bb.d
  %i.v = load i8, ptr %i.m, align 1, !noalias !57 ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  store ptr %i.ad, ptr %i.a, align 8, !noalias !57
  store ptr %i.af, ptr %i.n, align 8, !noalias !57
  %i.ag = call { i32, i32 } @_RINvNtNtCs3oUPovFnLWP_4core3str11validations23next_code_point_reverseINtNtNtB6_5slice4iter4IterhEECsjMPGGl8VONr_3syn(ptr nonnull align 8 %i.a) #20, !noalias !57 ; 2 uses
  %i.ah = extractvalue { i32, i32 } %i.ag, 0
  %i.ai = trunc i32 %i.ah to i1
  br i1 %i.ai, label %bb.j, label %bb.k

bb.i:                                             ; preds = %bb.g
  call void @_RNvNtCs3oUPovFnLWP_4core3str16slice_error_fail(ptr %i.aa, i64 %i.ab, i64 0, i64 %i.z, ptr nonnull align 8 @74) #19, !noalias !57
  unreachable
...
bb.l:                                             ; preds = %bb.k
  store i8 1, ptr %i.l, align 2, !noalias !57
...
bb.q:                                             ; preds = %bb.e
  %i.ap = load i64, ptr %i.e, align 8, !noalias !57 ; 3 uses
  %i.aq = add i64 %i.r, -1                        ; 5 uses
  %i.ar = icmp ult i64 %i.aq, %i.ap
  br i1 %i.ar, label %bb.r, label %bb.s

bb.r:                                             ; preds = %bb.q
  %i.as = load ptr, ptr %i.d, align 8, !noalias !57 ; 2 uses
  %i.at = getelementptr inbounds nuw i8, ptr %i.as, i64 %i.aq
  %i.au = load i8, ptr %i.at, align 1, !noalias !57
  %i.av = load i8, ptr %i.k, align 8, !noalias !57
  %i.aw = icmp eq i8 %i.au, %i.av
  br i1 %i.aw, label %bb.u, label %bb.t

bb.s:                                             ; preds = %bb.q
  call void @_RNvNtCs3oUPovFnLWP_4core9panicking18panic_bounds_check(i64 %i.aq, i64 %i.ap, ptr nonnull align 8 @75) #19, !noalias !57
  unreachable
...
bb.v:                                             ; preds = %bb.f
  %i.ay = load i64, ptr %i.c, align 8, !noalias !57
  %i.az = icmp eq i64 %i.ay, -1                   ; 6 uses
  %i.ba = load ptr, ptr %i.d, align 8, !noalias !57 ; 3 uses
  %i.bb = load i64, ptr %i.e, align 8, !noalias !57 ; 2 uses
  %i.bc = load ptr, ptr %i.f, align 8, !noalias !57 ; 2 uses
  %i.bd = load i64, ptr %i.g, align 8, !noalias !57 ; 13 uses
...
._crit_edge.i.i:                                  ; preds = %bb.v, %bb.z
  store i64 0, ptr %i.b, align 8, !noalias !60
  br label %.loopexit.i
...
bb.w:                                             ; preds = %.lr.ph.i.i
  ...
  %i.bj = load i8, ptr %i.bi, align 1, !noalias !60
...
.lr.ph.preheader:                                 ; preds = %.split.us.i.preheader
  %i.bu = load i64, ptr %i.b, align 8, !noalias !60 ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.split.us.i
  ...
  %i.bz = load i8, ptr %i.by, align 1, !noalias !60
  %i.ca = getelementptr i8, ptr %i.bw, i64 %i.bx
  %i.cb = load i8, ptr %i.ca, align 1, !noalias !60
...
bb.ac:                                            ; preds = %.split.i
  call void @_RNvNtCs3oUPovFnLWP_4core9panicking18panic_bounds_check(i64 %i.bt, i64 %i.bd, ptr nonnull align 8 @4) #19, !noalias !60
  unreachable
...
._crit_edge:                                      ; preds = %bb.ae, %bb.af
  %i.ch = load i64, ptr %i.b, align 8, !noalias !60
  %i.ci = sub i64 %i.ch, %i.bd
  store i64 %i.ci, ptr %i.b, align 8, !noalias !60
...
bb.ah:                                            ; preds = %.lr.ph209
  ...
  %i.ck = load i8, ptr %i.cj, align 1, !noalias !60
  %i.cl = load i64, ptr %i.b, align 8, !noalias !60 ; 2 uses
  %i.cm = sub i64 %i.cl, %i.bd
  %i.cn = getelementptr i8, ptr %i.ba, i64 %i.cm
  %i.co = getelementptr i8, ptr %i.cn, i64 %.sroa.07.0.i.i208
  %i.cp = load i8, ptr %i.co, align 1, !noalias !60
  %.not18.i.i = icmp eq i8 %i.ck, %i.cp
  br i1 %.not18.i.i, label %bb.af, label %bb.aj

bb.ai:                                            ; preds = %.lr.ph209
  call void @_RNvNtCs3oUPovFnLWP_4core9panicking18panic_bounds_check(i64 %umax.i.i, i64 %i.bd, ptr nonnull align 8 @3) #19, !noalias !60
  unreachable

bb.aj:                                            ; preds = %bb.ah
  %i.cq = load i64, ptr %i.k, align 8, !noalias !60 ; 2 uses
  %i.cr = sub i64 %i.cl, %i.cq                    ; 3 uses
  store i64 %i.cr, ptr %i.b, align 8, !noalias !60
  br i1 %i.az, label %bb.z, label %.sink.split.i.i

.loopexit.i:                                      ; preds = %.lr.ph.i.i, %._crit_edge.i.i
  %.sink59.i.ph.i = phi i64 [ 0, %._crit_edge.i.i ], [ %i.bh, %.lr.ph.i.i ]
  %i.cs = load ptr, ptr %i.d, align 8, !noalias !57
  %i.ct = load i64, ptr %i.e, align 8, !noalias !57
  %i.cu = call i64 @_RNvMNtCs3oUPovFnLWP_4core3stre19floor_char_boundaryCse52LceO7DeS_12typst_macros(ptr %i.cs, i64 %i.ct, i64 %.sink59.i.ph.i) #20, !noalias !57 ; 2 uses
  %i.cv = load i64, ptr %i.b, align 8, !noalias !57
  %i.cw = call i64 @_RNvYjNtNtCs3oUPovFnLWP_4core3cmp3Ord3minCscVvfRCjUNk2_11proc_macro2(i64 %i.cu, i64 %i.cv) #20, !noalias !57
  store i64 %i.cw, ptr %i.b, align 8, !noalias !57
  br label %bb.ak
