...
begin_hunk_0_@_RNvMs2_NtNtCsbMQOdixSu6G_5image6codecs3pngINtB5_10PngEncoderQINtNtCs1xwejQucwHj_5alloc3vec3VechEE12encode_innerCsl4q486LaARA_9typst_svg:bb.a
  ...
  %.sroa.12310.0.copyload = load i64, ptr %.sroa.12310.0..sroa_idx, align 8, !alias.scope !7015, !noalias !7016 ; 2 uses
  %.sroa.18311.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.ba, i64 32
  %.sroa.18311.0.copyload = load i8, ptr %.sroa.18311.0..sroa_idx, align 8, !alias.scope !7015, !noalias !7016 ; 2 uses
  %.sroa.23.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.ba, i64 33
  %.sroa.23.0.copyload = load i8, ptr %.sroa.23.0..sroa_idx, align 1, !alias.scope !7015, !noalias !7016 ; 2 uses
  %.sroa.24.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.ba, i64 34
  %.sroa.24.0.copyload = load i8, ptr %.sroa.24.0..sroa_idx, align 2, !alias.scope !7015, !noalias !7016 ; 2 uses
  %.sroa.25.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.ba, i64 35
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(45) %.sroa.25, ptr noundef nonnull align 1 dereferenceable(45) %.sroa.25.0..sroa_idx, i64 45, i1 false), !alias.scope !7015, !noalias !7016
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.21.i.i.sroa.23)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ba), !noalias !6912
  call fastcc void @_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtCs75Nu06PSjCb_3png6common4InfoECsl4q486LaARA_9typst_svg(ptr noalias nofree noundef nonnull readonly align 8 dereferenceable(448) %i.be), !noalias !6913
...
bb.ec:                                            ; preds = %.loopexit496
  ...
  %i.mq = load i8, ptr %i.mp, align 1, !range !7018, !alias.scope !7017, !noalias !7019, !noundef !12
  %i.mr = icmp ne i8 %i.mq, 3
  %i.ms = load i8, ptr %.sroa.7196.0..sroa_idx, align 8, !range !19, !alias.scope !7017, !noalias !7019
...
bb.ed:                                            ; preds = %bb.ec
  ...
  %i.mw = load i8, ptr %i.mv, align 1, !range !19, !alias.scope !7017, !noalias !7019, !noundef !12
  ...
  %i.na = load i8, ptr %i.mz, align 1, !range !18
...
bb.ee:                                            ; preds = %bb.ed
  ...
  %i.nd = load i8, ptr %i.nc, align 1, !range !18, !alias.scope !7017, !noalias !7019, !noundef !12
  ...
  %.sroa.014.0.in.i = load i32, ptr %.sroa.014.0.in.in.v.i.sroa.sel.v.sroa.sel.v.sroa.sel, align 4, !alias.scope !7017, !noalias !7019, !noundef !12
...
bb.ef:                                            ; preds = %.noexc
  ...
  br i1 %.not.i.i.i252, label %bb.ej, label %bb.eg, !prof !15
...
bb.eh:                                            ; preds = %bb.eg
  call void @_RNvCsjHpjAFo4bi0_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #31, !noalias !7020
  %i.ni = call noundef ptr @_RNvCsjHpjAFo4bi0_7___rustc19___rust_alloc_zeroed(i64 noundef range(i64 1, -9223372036854775808) %i.nf, i64 noundef range(i64 1, 17) 1) #31, !noalias !7020 ; 2 uses
...
_RINvXs1_NtNtCs1xwejQucwHj_5alloc3vec14spec_from_elemhNtB6_12SpecFromElem9from_elemNtNtBa_5alloc6GlobalECsl4q486LaARA_9typst_svg.exit.i: ; preds = %bb.ei, %bb.eg
  ...
  %i.nm = invoke noundef i8 @_RNvMs6_NtCs75Nu06PSjCb_3png7encoderNtB5_11PartialInfo17bpp_in_prediction(ptr noalias nofree noundef nonnull readonly align 4 captures(address, read_provenance) dereferenceable(52) %.sroa.6195.0..sroa_idx)
          to label %bb.en unwind label %bb.em, !noalias !7021 ; 2 uses
...
bb.el:                                            ; preds = %.body.thread591.i, %.body.i253
  ...
  call void @_RNvCsjHpjAFo4bi0_7___rustc14___rust_dealloc(ptr noundef nonnull %i.nl, i64 noundef %i.nf, i64 noundef range(i64 1, -9223372036854775807) 1) #31, !noalias !7022
  br label %.body258
...
bb.en:                                            ; preds = %_RINvXs1_NtNtCs1xwejQucwHj_5alloc3vec14spec_from_elemhNtB6_12SpecFromElem9from_elemNtNtBa_5alloc6GlobalECsl4q486LaARA_9typst_svg.exit.i
  ...
  %i.np = load i8, ptr %i.no, align 4, !range !7018, !alias.scope !7017, !noalias !7019, !noundef !12 ; 2 uses
  %i.nq = getelementptr inbounds nuw i8, ptr %i.bd, i64 74
  %i.nr = load i8, ptr %i.nq, align 2, !range !18, !alias.scope !7017, !noalias !7019, !noundef !12
...
bb.eo:                                            ; preds = %bb.en
  call void @llvm.lifetime.start.p0(ptr nonnull %i.z), !noalias !7023
  call void @llvm.lifetime.start.p0(ptr nonnull %i.y), !noalias !7023
  call void @llvm.lifetime.start.p0(ptr nonnull %i.x), !noalias !7023
  store i64 0, ptr %i.x, align 8, !noalias !7023
  %.sroa.434.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.x, i64 8
  store ptr inttoptr (i64 1 to ptr), ptr %.sroa.434.0..sroa_idx.i, align 8, !noalias !7023
  %.sroa.535.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.x, i64 16
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.535.0..sroa_idx.i, i8 0, i64 16, i1 false), !noalias !7023
  invoke fastcc void @_RNvMs_NtCsidRW4tbWwi3_8fdeflate8compressINtB4_20StoredOnlyCompressorINtNtNtCs3oUPovFnLWP_4core2io6cursor6CursorINtNtCs1xwejQucwHj_5alloc3vec3VechEEE3newCsl4q486LaARA_9typst_svg(ptr noalias nofree noundef align 8 captures(none) dereferenceable(56) %i.y, ptr noalias nofree noundef align 8 captures(address) dereferenceable(32) %i.x)
          to label %bb.fc unwind label %bb.em, !noalias !7021

bb.ep:                                            ; preds = %bb.en
  call void @llvm.lifetime.start.p0(ptr nonnull %i.u), !noalias !7023
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.8488.i)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !7024
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !7024
  invoke void @_RNvMCsfKc8T7pWkLT_12simd_adler32NtB2_7Adler323new(ptr noalias nofree noundef nonnull sret([16 x i8]) align 8 captures(address) dereferenceable(16) %i.c)
          to label %bb.eq unwind label %bb.ex, !noalias !7025

bb.eq:                                            ; preds = %bb.ep
  %i.ns = getelementptr inbounds nuw i8, ptr %i.d, i64 32
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.ns, ptr noundef nonnull align 8 dereferenceable(16) %i.c, i64 16, i1 false), !noalias !7024
  %i.nt = getelementptr inbounds nuw i8, ptr %i.d, i64 48 ; 4 uses
  store i64 0, ptr %i.nt, align 8, !noalias !7024
  %i.nu = getelementptr inbounds nuw i8, ptr %i.d, i64 56 ; 5 uses
  store i8 0, ptr %i.nu, align 8, !noalias !7024
  store i64 0, ptr %i.d, align 8, !noalias !7026
  store ptr inttoptr (i64 1 to ptr), ptr %.sink26.i.sroa.gep489.i, align 8, !noalias !7026
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.7491.0..sroa_idx.i, i8 0, i64 16, i1 false), !noalias !7023
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !7024
  call void @llvm.experimental.noalias.scope.decl(metadata !7027)
  call void @llvm.experimental.noalias.scope.decl(metadata !7028)
  call void @llvm.experimental.noalias.scope.decl(metadata !7029)
  ...
  invoke fastcc void @_RINvNvMs2_NtCs1xwejQucwHj_5alloc7raw_vecINtB8_11RawVecInnerpE7reserve21do_reserve_and_handleNtNtBa_5alloc6GlobalECsl4q486LaARA_9typst_svg(ptr noalias nofree noundef nonnull align 8 dereferenceable(64) %i.d, i64 noundef 0, i64 noundef 53, i64 noundef 1, i64 noundef 1)
          to label %_RINvNtNtCs1xwejQucwHj_5alloc2io6cursor15reserve_and_padNtNtB6_5alloc6GlobalECsl4q486LaARA_9typst_svg.exit.i.i.i.i.i.i unwind label %bb.ew, !noalias !7025
...
_RINvNtNtCs1xwejQucwHj_5alloc2io6cursor15reserve_and_padNtNtB6_5alloc6GlobalECsl4q486LaARA_9typst_svg.exit.i.i.i.i.i.i: ; preds = %bb.eq
  %i.nv = load i64, ptr %.sroa.7491.0..sroa_idx.i, align 8, !alias.scope !7032, !noalias !7033, !noundef !12 ; 3 uses
  %i.nw = icmp sgt i64 %i.nv, -1
  call void @llvm.assume(i1 %i.nw)
  %.val8.pre.i.i.i.i.i.i = load ptr, ptr %.sink26.i.sroa.gep489.i, align 8, !alias.scope !7034, !noalias !7033 ; 4 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(53) %.val8.pre.i.i.i.i.i.i, ptr noundef nonnull readonly align 1 dereferenceable(53) @121, i64 range(i64 0, -9223372036854775808) 53, i1 false), !noalias !7035
...
bb.er:                                            ; preds = %_RINvNtNtCs1xwejQucwHj_5alloc2io6cursor15reserve_and_padNtNtB6_5alloc6GlobalECsl4q486LaARA_9typst_svg.exit.i.i.i.i.i.i
  store i64 53, ptr %.sroa.7491.0..sroa_idx.i, align 8, !alias.scope !7034, !noalias !7033
...
_RNvXs5_NtNtCs3oUPovFnLWP_4core2io6cursorINtB5_6CursorINtNtCs1xwejQucwHj_5alloc3vec3VechEENtNtB7_5write5Write9write_allCsl4q486LaARA_9typst_svg.exit.i.i.i: ; preds = %bb.er, %_RINvNtNtCs1xwejQucwHj_5alloc2io6cursor15reserve_and_padNtNtB6_5alloc6GlobalECsl4q486LaARA_9typst_svg.exit.i.i.i.i.i.i
  ...
  store i64 53, ptr %.sroa.8492.0..sroa_idx.i, align 8, !alias.scope !7036, !noalias !7037
  call void @llvm.experimental.noalias.scope.decl(metadata !7038)
  %i.nz = load i8, ptr %i.nu, align 8, !alias.scope !7039, !noalias !7024, !noundef !12 ; 2 uses
  %i.oa = and i8 %i.nz, 63
  %i.ob = zext nneg i8 %i.oa to i64
  %i.oc = shl i64 15, %i.ob
  %i.od = load i64, ptr %i.nt, align 8, !alias.scope !7039, !noalias !7024, !noundef !12
  %i.oe = or i64 %i.oc, %i.od                     ; 3 uses
  store i64 %i.oe, ptr %i.nt, align 8, !alias.scope !7039, !noalias !7024
  %i.of = add i8 %i.nz, 5                         ; 2 uses
  store i8 %i.of, ptr %i.nu, align 8, !alias.scope !7039, !noalias !7024
  %i.og = icmp ugt i8 %i.of, 63
  %.sroa.0486.0.copyload.pre689.i = load i64, ptr %i.d, align 8, !noalias !7040 ; 3 uses
...
bb.es:                                            ; preds = %_RNvXs5_NtNtCs3oUPovFnLWP_4core2io6cursorINtB5_6CursorINtNtCs1xwejQucwHj_5alloc3vec3VechEENtNtB7_5write5Write9write_allCsl4q486LaARA_9typst_svg.exit.i.i.i
  call void @llvm.experimental.noalias.scope.decl(metadata !7041)
  call void @llvm.experimental.noalias.scope.decl(metadata !7042)
  call void @llvm.experimental.noalias.scope.decl(metadata !7043)
  call void @llvm.experimental.noalias.scope.decl(metadata !7044)
  call void @llvm.experimental.noalias.scope.decl(metadata !7045)
...
bb.et:                                            ; preds = %bb.es
  ...
  br i1 %i.ok, label %bb.eu, label %_RINvNtNtCs1xwejQucwHj_5alloc2io6cursor15reserve_and_padNtNtB6_5alloc6GlobalECsl4q486LaARA_9typst_svg.exit.i.i.i.i.i.i.i, !prof !13
...
bb.eu:                                            ; preds = %bb.et
  invoke fastcc void @_RINvNvMs2_NtCs1xwejQucwHj_5alloc7raw_vecINtB8_11RawVecInnerpE7reserve21do_reserve_and_handleNtNtBa_5alloc6GlobalECsl4q486LaARA_9typst_svg(ptr noalias nofree noundef nonnull align 8 dereferenceable(64) %i.d, i64 noundef %i.ny, i64 noundef %i.oi, i64 noundef 1, i64 noundef 1)
          to label %_RNvMs_NtCs1xwejQucwHj_5alloc3vecINtB4_3VechE7reserveCsl4q486LaARA_9typst_svg.exit.i.i.i.i.i.i.i.i unwind label %bb.ew, !noalias !7025

_RNvMs_NtCs1xwejQucwHj_5alloc3vecINtB4_3VechE7reserveCsl4q486LaARA_9typst_svg.exit.i.i.i.i.i.i.i.i: ; preds = %bb.eu
  %.pre.i.i.i = load i64, ptr %.sroa.7491.0..sroa_idx.i, align 8, !alias.scope !7046, !noalias !7047 ; 5 uses
  %i.ol = icmp sgt i64 %.pre.i.i.i, -1
  call void @llvm.assume(i1 %i.ol)
  %i.om = icmp samesign ult i64 %.pre.i.i.i, 53
  %.val8.pre.i.i.i.i.i.i.i.pre = load ptr, ptr %.sink26.i.sroa.gep489.i, align 8, !alias.scope !7048, !noalias !7047 ; 4 uses
...
_RINvNtNtCs1xwejQucwHj_5alloc2io6cursor15reserve_and_padNtNtB6_5alloc6GlobalECsl4q486LaARA_9typst_svg.exit.i.i.i.i.i.i.thread.i: ; preds = %_RNvMs_NtCs1xwejQucwHj_5alloc3vecINtB4_3VechE7reserveCsl4q486LaARA_9typst_svg.exit.i.i.i.i.i.i.i.i
  ...
  call void @llvm.memset.p0.i64(ptr nonnull align 1 %i.oo, i8 0, i64 range(i64 0, -9223372036854775808) %i.on, i1 false), !alias.scope !7049, !noalias !7050
  %i.op = getelementptr inbounds nuw i8, ptr %.val8.pre.i.i.i.i.i.i.i.pre, i64 53
  store i64 %i.oe, ptr %i.op, align 1, !noalias !7051
  br label %bb.ev
...
_RINvNtNtCs1xwejQucwHj_5alloc2io6cursor15reserve_and_padNtNtB6_5alloc6GlobalECsl4q486LaARA_9typst_svg.exit.i.i.i.i.i.i.i: ; preds = %bb.es, %bb.et, %_RNvMs_NtCs1xwejQucwHj_5alloc3vecINtB4_3VechE7reserveCsl4q486LaARA_9typst_svg.exit.i.i.i.i.i.i.i.i
  ...
  store i64 %i.oe, ptr %i.or, align 1, !noalias !7051
...
bb.ev:                                            ; preds = %_RINvNtNtCs1xwejQucwHj_5alloc2io6cursor15reserve_and_padNtNtB6_5alloc6GlobalECsl4q486LaARA_9typst_svg.exit.i.i.i.i.i.i.i, %_RINvNtNtCs1xwejQucwHj_5alloc2io6cursor15reserve_and_padNtNtB6_5alloc6GlobalECsl4q486LaARA_9typst_svg.exit.i.i.i.i.i.i.thread.i
  ...
  store i64 61, ptr %.sroa.7491.0..sroa_idx.i, align 8, !alias.scope !7048, !noalias !7047
...
_RNvXs5_NtNtCs3oUPovFnLWP_4core2io6cursorINtB5_6CursorINtNtCs1xwejQucwHj_5alloc3vec3VechEENtNtB7_5write5Write9write_allCsl4q486LaARA_9typst_svg.exit.i.i.i.i: ; preds = %bb.ev, %_RINvNtNtCs1xwejQucwHj_5alloc2io6cursor15reserve_and_padNtNtB6_5alloc6GlobalECsl4q486LaARA_9typst_svg.exit.i.i.i.i.i.i.i
  ...
  store i64 61, ptr %.sroa.8492.0..sroa_idx.i, align 8, !alias.scope !7052, !noalias !7053
  %i.ot = load i8, ptr %i.nu, align 8, !alias.scope !7039, !noalias !7024, !noundef !12 ; 2 uses
  %i.ou = add i8 %i.ot, -64
  store i8 %i.ou, ptr %i.nu, align 8, !alias.scope !7039, !noalias !7024
  ...
  store i64 %.sroa.04.0.i.i.i.i, ptr %i.nt, align 8, !alias.scope !7039, !noalias !7024
  %.sroa.0486.0.copyload.pre.i = load i64, ptr %i.d, align 8, !noalias !7040
  br label %bb.fx

bb.ew:                                            ; preds = %bb.eu, %bb.eq
  %i.oz = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %.val7.i.i = load i64, ptr %i.d, align 8, !alias.scope !7054, !noalias !7024 ; 2 uses
...
_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueINtNtNtB4_2io6cursor6CursorINtNtCs1xwejQucwHj_5alloc3vec3VechEEECsl4q486LaARA_9typst_svg.exit.sink.split.i.i: ; preds = %bb.ew
  %.sink26.i.sroa.phi.sroa.speculate.load.493.i = load ptr, ptr %.sink26.i.sroa.gep489.i, align 8, !noalias !7026
  call void @_RNvCsjHpjAFo4bi0_7___rustc14___rust_dealloc(ptr noundef nonnull %.sink26.i.sroa.phi.sroa.speculate.load.493.i, i64 noundef %.val7.i.i, i64 noundef range(i64 1, -9223372036854775807) 1) #31, !noalias !7025
  br label %.body.i253
...
bb.ey:                                            ; preds = %bb.en
  ...
  %i.pd = load i8, ptr %i.pc, align 1, !alias.scope !7017, !noalias !7019, !noundef !12
  br i1 %i.nh, label %bb.jh, label %bb.ez

bb.ez:                                            ; preds = %bb.ey
  call void @_RNvCsjHpjAFo4bi0_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #31, !noalias !7055
  %i.pe = call noundef ptr @_RNvCsjHpjAFo4bi0_7___rustc19___rust_alloc_zeroed(i64 noundef range(i64 1, -9223372036854775808) %i.nf, i64 noundef range(i64 1, 17) 1) #31, !noalias !7055 ; 2 uses
...
bb.fb:                                            ; preds = %bb.ez
  invoke void @_RNvNtCs1xwejQucwHj_5alloc7raw_vec12handle_error(i64 noundef 1, i64 %i.nf) #36
          to label %.noexc.i254 unwind label %bb.em, !noalias !7021

.noexc.i254:                                      ; preds = %bb.fb
  unreachable

bb.fc:                                            ; preds = %bb.eo
  call void @llvm.lifetime.end.p0(ptr nonnull %i.x), !noalias !7023
  %i.ph = load i64, ptr %i.y, align 8, !range !30, !noalias !7023, !noundef !12 ; 2 uses
  %i.pi = icmp eq i64 %i.ph, -1
  %i.pj = getelementptr inbounds nuw i8, ptr %i.y, i64 8
  %i.pk = load ptr, ptr %i.pj, align 8, !noalias !7023 ; 2 uses
  br i1 %i.pi, label %bb.fd, label %bb.fe

bb.fd:                                            ; preds = %bb.fc
  call void @llvm.lifetime.end.p0(ptr nonnull %i.y), !noalias !7023
...
bb.fe:                                            ; preds = %bb.fc
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %.sroa.538.0..sroa_idx.i, ptr noundef nonnull align 8 dereferenceable(40) %.sroa.5198.0..sroa_idx.i, i64 40, i1 false), !noalias !7023
  call void @llvm.lifetime.end.p0(ptr nonnull %i.y), !noalias !7023
  store i64 %i.ph, ptr %i.z, align 8, !noalias !7023
  %.sroa.437.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.z, i64 8 ; 3 uses
  store ptr %i.pk, ptr %.sroa.437.0..sroa_idx.i, align 8, !noalias !7023
  br i1 %i.nh, label %bb.ff, label %.preheader.i, !prof !13
...
bb.ff:                                            ; preds = %bb.fe
  invoke void @_RNvNtCs3oUPovFnLWP_4core9panicking9panic_fmt(ptr noundef nonnull @10, ptr noundef nonnull inttoptr (i64 55 to ptr), ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @214) #36
          to label %bb.fh unwind label %.loopexit.split-lp599.i, !noalias !7021
...
bb.fi:                                            ; preds = %.preheader.i
  ...
  %i.po = invoke fastcc noundef ptr @_RNvMs_NtCsidRW4tbWwi3_8fdeflate8compressINtB4_20StoredOnlyCompressorINtNtNtCs3oUPovFnLWP_4core2io6cursor6CursorINtNtCs1xwejQucwHj_5alloc3vec3VechEEE10write_dataCsl4q486LaARA_9typst_svg(ptr noalias nofree noundef align 8 dereferenceable(56) %i.z, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @41, i64 noundef 1)
          to label %bb.fp unwind label %.loopexit598.i, !noalias !7021 ; 2 uses

bb.fj:                                            ; preds = %.preheader.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.w), !noalias !7023
  call void @llvm.lifetime.start.p0(ptr nonnull %i.v), !noalias !7023
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %i.v, ptr noundef nonnull align 8 dereferenceable(56) %i.z, i64 56, i1 false), !noalias !7023
  invoke fastcc void @_RNvMs_NtCsidRW4tbWwi3_8fdeflate8compressINtB4_20StoredOnlyCompressorINtNtNtCs3oUPovFnLWP_4core2io6cursor6CursorINtNtCs1xwejQucwHj_5alloc3vec3VechEEE6finishCsl4q486LaARA_9typst_svg(ptr noalias nofree noundef align 8 captures(none) dereferenceable(32) %i.w, ptr noalias nofree noundef align 8 captures(address) dereferenceable(56) %i.v)
          to label %bb.fk unwind label %bb.fg, !noalias !7021

bb.fk:                                            ; preds = %bb.fj
  call void @llvm.lifetime.end.p0(ptr nonnull %i.v), !noalias !7023
end_hunk_0
