...
begin_hunk_0_@_RNvMs_NtNtCsjFU9swAW47b_8indexmap3map4coreINtB4_12IndexMapCoreoINtNtCs3oUPovFnLWP_4core6option6OptionNtNtCsl4q486LaARA_9typst_svg4text13RenderedGlyphEE13insert_uniqueB1F_:bb.a
  ...
  store i64 %1, ptr %i.cd, align 16, !noalias !8319
  %i.ce = getelementptr inbounds nuw i8, ptr %i.c, i64 160
  store i128 %2, ptr %i.ce, align 16, !noalias !8319
...
bb.j:                                             ; preds = %_RNvMs_NtNtCsjFU9swAW47b_8indexmap3map4coreINtB4_12IndexMapCoreoINtNtCs3oUPovFnLWP_4core6option6OptionNtNtCsl4q486LaARA_9typst_svg4text13RenderedGlyphEE15reserve_entriesB1F_.exit.i
  invoke void @_RNvMs4_NtCs1xwejQucwHj_5alloc7raw_vecINtB5_6RawVecINtCsjFU9swAW47b_8indexmap6BucketoINtNtCs3oUPovFnLWP_4core6option6OptionNtNtCsl4q486LaARA_9typst_svg4text13RenderedGlyphEEE8grow_oneB20_(ptr noalias nofree noundef nonnull align 8 dereferenceable(56) %0)
          to label %bb.o unwind label %bb.k, !noalias !8325
...
bb.k:                                             ; preds = %bb.j
  ...
  invoke fastcc void @_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueINtNtB4_6option6OptionNtNtCsl4q486LaARA_9typst_svg4text13RenderedGlyphEEB11_(ptr noalias nofree noundef nonnull align 16 dereferenceable(192) %i.c)
          to label %.body.thread unwind label %bb.l, !noalias !8326

bb.l:                                             ; preds = %bb.k
  %i.cg = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCs3oUPovFnLWP_4core9panicking16panic_in_cleanup() #37, !noalias !8326
  unreachable
...
bb.m:                                             ; preds = %bb.f
  ...
  invoke fastcc void @_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueINtNtB4_6option6OptionNtNtCsl4q486LaARA_9typst_svg4text13RenderedGlyphEEB11_(ptr noalias nofree noundef nonnull align 8 dereferenceable(160) %i.d) #32
          to label %.body.thread unwind label %bb.n, !noalias !8310

bb.n:                                             ; preds = %bb.m
  %i.ci = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCs3oUPovFnLWP_4core9panicking16panic_in_cleanup() #37, !noalias !8310
  unreachable
...
.sink.split:                                      ; preds = %bb.c, %_RNvMs_NtNtCsjFU9swAW47b_8indexmap3map4coreINtB4_12IndexMapCoreoINtNtCs3oUPovFnLWP_4core6option6OptionNtNtCsl4q486LaARA_9typst_svg4text13RenderedGlyphEE15reserve_entriesB1F_.exit.i.thread
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !8319
  %i.cj = getelementptr inbounds nuw i8, ptr %i.c, i64 176
  store i64 %1, ptr %i.cj, align 16, !noalias !8319
  %i.ck = getelementptr inbounds nuw i8, ptr %i.c, i64 160
  store i128 %2, ptr %i.ck, align 16, !noalias !8319
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(160) %i.c, ptr noundef nonnull align 8 dereferenceable(160) %3, i64 160, i1 false)
  br label %bb.o
...
bb.o:                                             ; preds = %.sink.split, %bb.j, %_RNvMs_NtNtCsjFU9swAW47b_8indexmap3map4coreINtB4_12IndexMapCoreoINtNtCs3oUPovFnLWP_4core6option6OptionNtNtCsl4q486LaARA_9typst_svg4text13RenderedGlyphEE15reserve_entriesB1F_.exit.i
  %i.cl = load ptr, ptr %i.h, align 8, !alias.scope !8327, !noalias !8325, !nonnull !12, !noundef !12
  %i.cm = getelementptr inbounds nuw [192 x i8], ptr %i.cl, i64 %i.bg
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(192) %i.cm, ptr noundef nonnull align 16 dereferenceable(192) %i.c, i64 192, i1 false), !noalias !8326
  %i.cn = add nuw nsw i64 %i.bg, 1                ; 2 uses
  store i64 %i.cn, ptr %i.j, align 8, !alias.scope !8327, !noalias !8325
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !8319
...
bb.e:                                             ; preds = %_RNvNtCs3oUPovFnLWP_4core3ptr25swap_nonoverlapping_bytes.exit
  ...
  %.sroa.0.0.copyload.i68.i = load <16 x i8>, ptr %i.al, align 1, !noalias !8333
...
.lr.ph.i15:                                       ; preds = %bb.e, %.lr.ph.i15
  ...
  %.sroa.0.0.copyload.i6.i = load <16 x i8>, ptr %i.bc, align 1, !noalias !8333
...
_RNvNtCs3oUPovFnLWP_4core3ptr25swap_nonoverlapping_bytes.exit.loopexit: ; preds = %bb.h
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8335)
  %.sroa.0.0.copyload.i.i.i = load i64, ptr %i.ai, align 1, !alias.scope !8334, !noalias !8335
  %.sroa.02.0.copyload.i.i.i = load i64, ptr %i.bt, align 1, !alias.scope !8335, !noalias !8334
  store i64 %.sroa.02.0.copyload.i.i.i, ptr %i.ai, align 1, !alias.scope !8334, !noalias !8335
  store i64 %.sroa.0.0.copyload.i.i.i, ptr %i.bt, align 1, !alias.scope !8335, !noalias !8334
  br label %_RNvNtCs3oUPovFnLWP_4core3ptr25swap_nonoverlapping_bytes.exit
...
bb.a:
  ...
  %.sroa.0.0.copyload.i68 = load <16 x i8>, ptr %i.a, align 1, !noalias !8338
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %.sroa.0.0.copyload.i6 = load <16 x i8>, ptr %i.r, align 1, !noalias !8338
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.j = load i8, ptr %i.i, align 8, !alias.scope !8358, !noundef !12 ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  tail call void @_RNvNtNtCs3oUPovFnLWP_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %i.k, i64 noundef 64, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @229) #33, !noalias !8358
  unreachable
...
bb.g:                                             ; preds = %bb.c
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !8361
  %i.n = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  store ptr %3, ptr %i.n, align 16, !noalias !8361
  %i.o = getelementptr inbounds nuw i8, ptr %i.b, i64 24
  store ptr %4, ptr %i.o, align 8, !noalias !8361
  %i.p = getelementptr inbounds nuw i8, ptr %i.b, i64 32
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>, ptr %i.p, align 16, !noalias !8361
  %.sroa.7.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.b, i64 48
  store <2 x float> zeroinitializer, ptr %.sroa.7.0..sroa_idx.i, align 16, !noalias !8361
  %i.q = getelementptr inbounds nuw i8, ptr %i.b, i64 92
  store i8 1, ptr %i.q, align 4, !noalias !8361
  store i128 -664613998047200450621976900532174849, ptr %i.b, align 16, !noalias !8361
  %i.r = getelementptr inbounds nuw i8, ptr %i.b, i64 56
  store i32 0, ptr %i.r, align 8, !noalias !8361
  %i.s = getelementptr inbounds nuw i8, ptr %i.b, i64 68
  store i32 0, ptr %i.s, align 4, !noalias !8361
  %i.t = getelementptr inbounds nuw i8, ptr %i.b, i64 80
  store i32 0, ptr %i.t, align 16, !noalias !8361
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.x = load i64, ptr %i.w, align 8, !alias.scope !8364, !noalias !8365 ; 7 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  %.val26.i.i.i = load ptr, ptr %i.z, align 8, !alias.scope !8364, !noalias !8365 ; 6 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  %.val.i35.i.i.i = load i16, ptr %i.am, align 1, !noalias !8366
