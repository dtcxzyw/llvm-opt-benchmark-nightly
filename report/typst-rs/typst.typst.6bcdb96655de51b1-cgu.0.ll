...
.lr.ph.i:                                         ; preds = %.noexc
  ...
  %i.ee = trunc nuw nsw i32 %i.dn to i8
  %3 = add nuw nsw i8 %2, %i.ee                   ; 2 uses
  %i.ef = udiv i8 %3, 10
  ...
  %i.gi = trunc nuw nsw i32 %i.co to i16          ; 2 uses
  ...
  %4 = add nuw nsw i16 %i.cr, 7
  %.pn.i.i.i = select i1 %i.cs, i16 %4, i16 %i.cr
  %5 = add nuw nsw i16 %i.gi, 12
