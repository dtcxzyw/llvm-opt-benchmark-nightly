...
begin_hunk_0_@_RNvXs_NtNtCsdaEETE4DqmE_13typst_library13introspection12introspectorNtB4_17EmptyIntrospectorNtB4_12Introspector14page_numbering:bb.a
bb.a:
  ret ptr null
}
...
.lr.ph.i:                                         ; preds = %.noexc
  ...
  %.sroa.04.0.i.i = add nuw nsw i32 %i.dn, %i.dt
  %i.du = trunc i32 %i.dq to i8                   ; 4 uses
  %i.dv = icmp ugt i8 %i.du, 99                   ; 2 uses
  %i.dw = udiv i8 %i.du, 10
  %i.dx = or disjoint i8 %i.dw, 48                ; 2 uses
  %i.dy = urem i8 %i.du, 10
  %i.dz = or disjoint i8 %i.dy, 48                ; 2 uses
  %i.ea = trunc nuw nsw i32 %i.dp to i8           ; 3 uses
  %i.eb = udiv i8 %i.ea, 10
  %i.ec = or disjoint i8 %i.eb, 48                ; 2 uses
  %i.ed = urem i8 %i.ea, 10
  %i.ee = or disjoint i8 %i.ed, 48                ; 2 uses
  %i.ef = trunc nuw nsw i32 %.sroa.04.0.i.i to i8 ; 2 uses
  %i.eg = udiv i8 %i.ef, 10
  %i.eh = or disjoint i8 %i.eg, 48
  %i.ei = urem i8 %i.ef, 10
  %i.ej = or disjoint i8 %i.ei, 48
  %i.ek = icmp eq i32 %storemerge.i.i, 0
  %i.el = urem i32 %storemerge.i.i, 1000000
  ...
  %i.et = udiv i8 %i.es, 10
  %i.eu = or disjoint i8 %i.et, 48
  %i.ev = urem i8 %i.es, 10
  %i.ew = or disjoint i8 %i.ev, 48
  %i.ex = udiv i32 %.sroa.21.0.copyload.i.i, 1000000000
  %i.ey = add nuw nsw i32 %i.ex, %i.dn
  %i.ez = trunc nuw nsw i32 %i.ey to i8           ; 3 uses
  %i.fa = udiv i8 %i.ez, 10
  %i.fb = or disjoint i8 %i.fa, 48
  %i.fc = urem i8 %i.ez, 10
  %i.fd = or disjoint i8 %i.fc, 48
  %i.fe = getelementptr inbounds nuw i8, ptr %i.u, i64 3
  %i.ff = getelementptr inbounds nuw i8, ptr %i.u, i64 1
  %i.fg = getelementptr inbounds nuw i8, ptr %i.u, i64 2
  %i.fh = getelementptr inbounds nuw i8, ptr %i.t, i64 3
  %i.fi = getelementptr inbounds nuw i8, ptr %i.t, i64 1
  %i.fj = getelementptr inbounds nuw i8, ptr %i.t, i64 2
  %i.fk = getelementptr inbounds nuw i8, ptr %i.bc, i64 2
  %i.fl = sext i32 %i.de to i64
  %.sroa.055.0.i.i = select i1 %.not.i37.i, i64 0, i64 %i.fl
  %i.fm = add nsw i32 %i.df, -1
  %i.fn = icmp slt i32 %i.df, 1                   ; 2 uses
  %i.fo = sub nsw i32 1, %i.df
  %i.fp = udiv i32 %i.fo, 400
  %i.fq = add nuw nsw i32 %i.fp, 1                ; 2 uses
  %i.fr = mul nuw nsw i32 %i.fq, 400
  %.neg.i.i = mul nsw i32 %i.fq, -146097
  %i.fs = zext i32 %.sroa.10.0.copyload.i.i to i64
  %i.ft = add nuw nsw i32 %i.co, -719163
  %i.fu = sub nsw i64 %i.fs, %.sroa.055.0.i.i
  %.sroa.426.0..sroa_idx.i116.i.i = getelementptr inbounds nuw i8, ptr %i.aq, i64 8
  %i.fv = getelementptr inbounds nuw i8, ptr %i.aq, i64 16
  ...
  %i.fw = getelementptr inbounds nuw i8, ptr %i.ar, i64 16
  ...
  %i.fx = zext nneg i32 %i.bv to i64
  %.sroa.426.0..sroa_idx.i105.i.i = getelementptr inbounds nuw i8, ptr %i.au, i64 8
  %i.fy = getelementptr inbounds nuw i8, ptr %i.au, i64 16
  ...
  %i.fz = getelementptr inbounds nuw i8, ptr %i.av, i64 16
  ...
  %i.ga = urem i32 %i.dq, 12                      ; 2 uses
  %i.gb = icmp eq i32 %i.ga, 0
  %i.gc = trunc nuw nsw i32 %i.ga to i8
  %i.gd = select i1 %i.gb, i8 12, i8 %i.gc
  %i.ge = zext nneg i32 %i.co to i64
  ...
  %i.gh = trunc i32 %i.br to i8
  %i.gi = and i8 %i.gh, 15                        ; 4 uses
  %i.gj = trunc nuw nsw i32 %i.co to i16
  %i.gk = add nuw nsw i16 %i.gj, 6
  %.lhs.trunc1.i101.i.i = sub nuw nsw i16 %i.gk, %i.cr
  %i.gl = udiv i16 %.lhs.trunc1.i101.i.i, 7
  %i.gm = trunc nuw nsw i16 %i.gl to i8
  %spec.select.i96.i.i = zext nneg i16 %i.cr to i32 ; 2 uses
  %i.gn = add nuw nsw i32 %spec.select.i96.i.i, 7
  %.pn.i.i.i = select i1 %i.cs, i32 %i.gn, i32 %spec.select.i96.i.i
  %.sroa.0.0.neg.i.i.i = add nuw nsw i32 %i.co, 6
  %i.go = sub nsw i32 %.sroa.0.0.neg.i.i.i, %.pn.i.i.i
  %i.gp = trunc nsw i32 %i.go to i16
  %.lhs.trunc1.i.i.i = add nsw i16 %i.gp, 6
  %i.gq = sdiv i16 %.lhs.trunc1.i.i.i, 7
  %i.gr = trunc nuw nsw i16 %i.gq to i8
  %i.gs = srem i32 %i.df, 100                     ; 4 uses
  %i.gt = icmp slt i32 %i.gs, 0
  %i.gu = add nsw i32 %i.gs, 100
  %spec.select.i.i.i = select i1 %i.gt, i32 %i.gu, i32 %i.gs
  %i.gv = trunc nuw nsw i32 %spec.select.i.i.i to i8
  %i.gw = sdiv i32 %i.df, 100
  %.lobit.i.i.i = ashr i32 %i.gs, 31
  %.sroa.0.0.i.i.i = add nsw i32 %.lobit.i.i.i, %i.gw
  %i.gx = trunc i32 %.sroa.0.0.i.i.i to i8
  %.sroa.03.0.i = getelementptr inbounds nuw i8, ptr %i.bc, i64 8 ; 4 uses
  %i.gy = getelementptr inbounds nuw i8, ptr %i.bc, i64 16 ; 6 uses
  %spec.select.i = select i1 %i.fn, i32 %.neg.i.i, i32 0
  %i.gz = select i1 %i.fn, i32 %i.fr, i32 0
  %spec.select228.i = add nsw i32 %i.fm, %i.gz    ; 2 uses
  %i.ha = sdiv i32 %spec.select228.i, 100         ; 2 uses
  %i.hb = mul nsw i32 %spec.select228.i, 1461
  %i.hc = ashr i32 %i.hb, 2
  %i.hd = ashr i32 %i.ha, 2
  %i.he = add i32 %i.ft, %spec.select.i
  %i.hf = sub i32 %i.he, %i.ha
  %i.hg = add i32 %i.hf, %i.hc
  %narrow.i.i = add i32 %i.hg, %i.hd
  %i.hh = sext i32 %narrow.i.i to i64
  %i.hi = mul nsw i64 %i.hh, 86400
  %i.hj = add nsw i64 %i.fu, %i.hi
  ...
  %i.ho = insertelement <2 x ptr> poison, ptr %.146.i.i, i64 0
  %i.hp = insertelement <2 x ptr> %i.ho, ptr %i.ci, i64 1
  %i.hq = shl nuw nsw i16 %i.cr, 3
...
bb.b:                                             ; preds = %.noexc4, %.lr.ph.i
  ...
  %i.hr = load i8, ptr %i.bc, align 8, !range !87, !noalias !46416, !noundef !28
...
bb.c:                                             ; preds = %bb.b
  %i.hs = load i8, ptr %i.fk, align 2, !range !40, !noalias !46416, !noundef !28 ; 6 uses
