...
bb.a:
  ...
  %.119 = select i1 %i.ab, double %i.w, double %i.y
  %.19.i = select i1 %i.q, double %i.u, double %. ; 2 uses
  %..i = select i1 %i.n, double %i.s, double %.119 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d)
  ...
  %.sroa.032.0 = select i1 %i.ah, double 0.000000e+00, double %i.ag
  %i.ai = fadd double %.sroa.speculated.i, %.sroa.032.0 ; 2 uses
  %.inv160.a = fcmp ord double %i.ai, 0.000000e+00
  %.sroa.035.0 = select i1 %.inv160.a, double %i.ai, double 0.000000e+00
...
.cont:                                            ; preds = %bb.b, %bb.a
  %.sroa.0.0153.in = phi double [ %..i.i, %bb.a ], [ %..i.i., %bb.b ] ; 4 uses
  %.sroa.9.0.in = phi double [ %..i2.i, %bb.a ], [ %...i2.i, %bb.b ] ; 4 uses
  %i.ao = call double @llvm.fabs.f64(double %.sroa.0.0153.in)
  %i.ap = fcmp one double %i.ao, +inf
  %i.aq = call double @llvm.fabs.f64(double %.sroa.9.0.in)
  %i.ar = fcmp one double %i.aq, +inf
  %or.cond3 = and i1 %i.ap, %i.ar
  br i1 %or.cond3, label %switch.lookup, label %bb.c
...
bb.c:                                             ; preds = %.cont
  ...
  %.sroa.442.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.i, i64 15
  store i8 -128, ptr %.sroa.442.0..sroa_idx, align 1
...
switch.lookup:                                    ; preds = %.cont
  ...
  call void @_RNvMNtNtCsdaEETE4DqmE_13typst_library6layout5frameNtB2_5Frame4soft(ptr noalias nofree noundef nonnull sret([48 x i8]) align 8 captures(address) dereferenceable(48) %i.h, double noundef %.sroa.0.0153.in, double noundef %.sroa.9.0.in, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @409)
  ...
  %.sroa.2149.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.g, i64 8
  store ptr %i.bc, ptr %.sroa.2149.0..sroa_idx, align 8
  %.sroa.3150.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.g, i64 16
  store ptr %i.aw, ptr %.sroa.3150.0..sroa_idx, align 8
  %.sroa.4151.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.g, i64 24
  store i64 %i.ay, ptr %.sroa.4151.0..sroa_idx, align 8
  %.sroa.5152.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.g, i64 32
...
common.resume:                                    ; preds = %bb.d, %bb.al, %bb.am, %bb.ap, %.thread, %bb.g
  %common.resume.op = phi { ptr, i32 } [ %i.bh, %bb.g ], [ %i.dr, %bb.am ], [ %i.be, %bb.d ], [ %i.dr, %bb.al ], [ %.pn116156, %bb.ap ], [ %.pn116156, %.thread ]
...
_RINvMs1_NtCsdaEETE4DqmE_13typst_library4diagNtB6_16SourceDiagnostic5errorNtNtCs5PEMdK7bMAG_12typst_syntax4span4SpanNtNtCsakL8LGkl72C_4ecow6string9EcoStringECs7tN9tvpkfrg_12typst_layout.exit: ; preds = %bb.e
  ...
  %.sroa.7146.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.k, i64 48
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.7146.0..sroa_idx, ptr noundef nonnull align 8 dereferenceable(16) %i.j, i64 16, i1 false)
  ...
  %.sroa.6145.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.k, i64 40
  store i64 0, ptr %.sroa.6145.0..sroa_idx, align 8
...
default.unreachable194:                           ; preds = %bb.y, %bb.n
  unreachable

bb.j:                                             ; preds = %bb.k
  unreachable

.thread157:                                       ; preds = %._crit_edge
...
.lr.ph:                                           ; preds = %switch.lookup
  ...
  %.sroa.4.0..sroa_idx185 = getelementptr inbounds nuw i8, ptr %i.f, i64 8
  %.sroa.5.0..sroa_idx186 = getelementptr inbounds nuw i8, ptr %i.f, i64 16
  %.sroa.6187.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.f, i64 24
  %.sroa.8.0..sroa_idx189 = getelementptr inbounds nuw i8, ptr %i.f, i64 40
  br label %bb.k

bb.k:                                             ; preds = %.lr.ph, %bb.o
  %.sroa.019.1176 = phi i8 [ %switch.masked, %.lr.ph ], [ %.sroa.019.2, %bb.o ] ; 4 uses
  %.sroa.0108.0175 = phi double [ 0.000000e+00, %.lr.ph ], [ %.sroa.0108.1, %bb.o ] ; 6 uses
  %i.bs = phi ptr [ %i.bb, %.lr.ph ], [ %i.bt, %bb.o ] ; 8 uses
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bs, i64 56 ; 3 uses
  %.sroa.055.0.copyload = load i64, ptr %i.bs, align 8 ; 3 uses
  %.sroa.456.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.bs, i64 8
  %.sroa.456.0.copyload = load double, ptr %.sroa.456.0..sroa_idx, align 8 ; 3 uses
  %.sroa.557.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.bs, i64 16
  %.sroa.557.sroa.0.0.copyload = load i64, ptr %.sroa.557.0..sroa_idx, align 8
  %.sroa.557.sroa.4.0..sroa.557.0..sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.bs, i64 24
  %i.bu = load <2 x double>, ptr %.sroa.557.sroa.4.0..sroa.557.0..sroa_idx.sroa_idx, align 8 ; 3 uses
  %.sroa.557.sroa.6.0..sroa.557.0..sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.bs, i64 40
  %.sroa.557.sroa.6.0.copyload = load i64, ptr %.sroa.557.sroa.6.0..sroa.557.0..sroa_idx.sroa_idx, align 8
  %.sroa.658.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.bs, i64 48
  %.sroa.658.0.copyload = load i8, ptr %.sroa.658.0..sroa_idx, align 8 ; 2 uses
  %.sroa.759.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.bs, i64 49
  %.sroa.759.0.copyload = load i8, ptr %.sroa.759.0..sroa_idx, align 1 ; 2 uses
  %i.bv = add i64 %.sroa.055.0.copyload, -2
  %.inv = icmp ult i64 %.sroa.055.0.copyload, 2
  %i.bw = select i1 %.inv, i64 2, i64 %i.bv
...
._crit_edge:                                      ; preds = %bb.o, %switch.lookup
  ...
  invoke fastcc void @_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueINtNtNtCs1xwejQucwHj_5alloc3vec5drain5DrainNtNtCs7tN9tvpkfrg_12typst_layout5stack9StackItemEEB1m_(ptr noalias nofree noundef align 8 dereferenceable(40) %i.g)
          to label %bb.af unwind label %.thread157

bb.l:                                             ; preds = %bb.k
  %i.bx = fadd double %.sroa.0108.0175, %.sroa.456.0.copyload ; 2 uses
  %.inv170 = fcmp ord double %i.bx, 0.000000e+00
  %.sroa.061.0 = select i1 %.inv170, double %i.bx, double 0.000000e+00
  br label %bb.o

bb.m:                                             ; preds = %bb.k
  %i.by = load double, ptr %i.aj, align 16, !noundef !10
  %i.bz = invoke noundef double @_RNvMNtNtCsdaEETE4DqmE_13typst_library6layout2frNtB2_2Fr5share(double noundef %.sroa.456.0.copyload, double noundef %i.by, double noundef %.sroa.035.0)
...
bb.n:                                             ; preds = %bb.k
  ...
  %.sroa.speculated.i120 = select i1 %i.cc, i8 %.sroa.759.0.copyload, i8 %.sroa.658.0.copyload ; 2 uses
  switch i8 %i.ca, label %default.unreachable194 [
    i8 0, label %bb.t
    i8 1, label %bb.u
    i8 2, label %bb.t
    i8 3, label %bb.u
...
bb.o:                                             ; preds = %bb.ae, %bb.r, %bb.l
  %.sroa.0108.1 = phi double [ %.sroa.061.0, %bb.l ], [ %.sroa.064.0, %bb.r ], [ %.sroa.0102.0, %bb.ae ]
  %.sroa.019.2 = phi i8 [ %.sroa.019.1176, %bb.l ], [ %.sroa.019.1176, %bb.r ], [ %.sroa.019.3, %bb.ae ]
...
bb.r:                                             ; preds = %bb.m
  %i.cf = fadd double %.sroa.0108.0175, %i.bz     ; 2 uses
  %.inv169 = fcmp ord double %i.cf, 0.000000e+00
  %.sroa.064.0 = select i1 %.inv169, double %i.cf, double 0.000000e+00
  br label %bb.o
...
bb.t:                                             ; preds = %bb.n, %bb.n
  %..i122 = call noundef range(i8 0, 3) i8 @llvm.umax.i8(i8 range(i8 0, 3) %.sroa.speculated.i120, i8 range(i8 0, 3) %.sroa.019.1176)
  br label %bb.v

bb.u:                                             ; preds = %bb.n, %bb.n
  %..i124 = call noundef range(i8 0, 3) i8 @llvm.umin.i8(i8 range(i8 0, 3) %.sroa.speculated.i120, i8 range(i8 0, 3) %.sroa.019.1176)
  br label %bb.v

bb.v:                                             ; preds = %bb.u, %bb.t
  %.sroa.019.3 = phi i8 [ %..i124, %bb.u ], [ %..i122, %bb.t ] ; 2 uses
  %.sroa.speculated.i123 = select i1 %i.cc, double %.sroa.9.0.in, double %.sroa.0.0153.in
  %i.ch = extractelement <2 x double> %i.bu, i64 0 ; 2 uses
  %i.ci = extractelement <2 x double> %i.bu, i64 1 ; 2 uses
  %.sroa.speculated.i125 = select i1 %i.cc, double %i.ci, double %i.ch ; 3 uses
  %i.cj = load double, ptr %i.x, align 8, !noundef !10 ; 3 uses
  %i.ck = fneg double %i.cj
  %i.cl = fcmp uno double %i.cj, 0.000000e+00
  %.sroa.067.0 = select i1 %i.cl, double 0.000000e+00, double %i.ck
  %i.cm = fadd double %.sroa.speculated.i123, %.sroa.067.0 ; 2 uses
  %.inv161.a = fcmp ord double %i.cm, 0.000000e+00
  %.sroa.070.0 = select i1 %.inv161.a, double %i.cm, double 0.000000e+00 ; 2 uses
  switch i8 %.sroa.019.3, label %default.unreachable.loopexit [
    i8 0, label %bb.w
    i8 1, label %bb.x
    i8 2, label %bb.y
  ]
...
bb.x:                                             ; preds = %bb.v
  %i.cn = fmul double %.sroa.070.0, 5.000000e-01  ; 2 uses
  %.inv162.a = fcmp ord double %i.cn, 0.000000e+00
  %.sroa.074.0 = select i1 %.inv162.a, double %i.cn, double 0.000000e+00
  br label %bb.y

bb.y:                                             ; preds = %bb.v, %bb.x, %bb.w
  %.sroa.070.1 = phi double [ 0.000000e+00, %bb.w ], [ %.sroa.074.0, %bb.x ], [ %.sroa.070.0, %bb.v ]
  switch i8 %i.ca, label %default.unreachable194 [
    i8 0, label %bb.aa
    i8 1, label %bb.z
    i8 2, label %bb.aa
...
bb.z:                                             ; preds = %bb.y, %bb.y
  %i.co = fneg double %.sroa.speculated.i125
  %i.cp = fcmp uno double %.sroa.speculated.i125, 0.000000e+00
  %.sroa.077.0 = select i1 %i.cp, double 0.000000e+00, double %i.co
  %i.cq = fadd double %i.cj, %.sroa.077.0         ; 2 uses
  %.inv163 = fcmp ord double %i.cq, 0.000000e+00
  %.sroa.080.0 = select i1 %.inv163, double %i.cq, double 0.000000e+00
  %i.cr = fsub double %.sroa.080.0, %.sroa.0108.0175 ; 2 uses
  %.inv164 = fcmp ord double %i.cr, 0.000000e+00
  %.sroa.086.1 = select i1 %.inv164, double %i.cr, double 0.000000e+00
  br label %bb.aa

bb.aa:                                            ; preds = %bb.z, %bb.y, %bb.y
  %.sroa.086.0 = phi double [ %.sroa.086.1, %bb.z ], [ %.sroa.0108.0175, %bb.y ], [ %.sroa.0108.0175, %bb.y ]
  %i.cs = fadd double %.sroa.070.1, %.sroa.086.0  ; 2 uses
  %.inv165 = fcmp ord double %i.cs, 0.000000e+00
  %.sroa.089.0 = select i1 %.inv165, double %i.cs, double 0.000000e+00 ; 2 uses
  %.sroa.speculated.i126 = select i1 %i.cc, i8 %.sroa.658.0.copyload, i8 %.sroa.759.0.copyload
  %.sroa.speculated.i127 = select i1 %i.cc, double %.sroa.0.0153.in, double %.sroa.9.0.in
  %.sroa.speculated.i128 = select i1 %i.cc, double %i.ch, double %i.ci ; 2 uses
  %i.ct = fneg double %.sroa.speculated.i128
  %i.cu = fcmp uno double %.sroa.speculated.i128, 0.000000e+00
  %.sroa.092.0 = select i1 %i.cu, double 0.000000e+00, double %i.ct
  %i.cv = fadd double %.sroa.speculated.i127, %.sroa.092.0 ; 2 uses
  %.inv166 = fcmp ord double %i.cv, 0.000000e+00
  %.sroa.095.0 = select i1 %.inv166, double %i.cv, double 0.000000e+00 ; 2 uses
  switch i8 %.sroa.speculated.i126, label %default.unreachable.loopexit [
    i8 0, label %bb.ab
    i8 1, label %bb.ac
    i8 2, label %bb.ad
  ]
...
bb.ac:                                            ; preds = %bb.aa
  %i.cw = fmul double %.sroa.095.0, 5.000000e-01  ; 2 uses
  %.inv167 = fcmp ord double %i.cw, 0.000000e+00
  %.sroa.098.0 = select i1 %.inv167, double %i.cw, double 0.000000e+00
  br label %bb.ad

bb.ad:                                            ; preds = %bb.aa, %bb.ac, %bb.ab
  %.sroa.027.0 = phi double [ 0.000000e+00, %bb.ab ], [ %.sroa.098.0, %bb.ac ], [ %.sroa.095.0, %bb.aa ] ; 2 uses
  %.sroa.027.0..sroa.089.0 = select i1 %i.cc, double %.sroa.027.0, double %.sroa.089.0
  %.sroa.089.0..sroa.027.0 = select i1 %i.cc, double %.sroa.089.0, double %.sroa.027.0
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f)
  store i64 %.sroa.055.0.copyload, ptr %i.f, align 8
  store double %.sroa.456.0.copyload, ptr %.sroa.4.0..sroa_idx185, align 8
  store i64 %.sroa.557.sroa.0.0.copyload, ptr %.sroa.5.0..sroa_idx186, align 8
  store <2 x double> %i.bu, ptr %.sroa.6187.0..sroa_idx, align 8
  store i64 %.sroa.557.sroa.6.0.copyload, ptr %.sroa.8.0..sroa_idx189, align 8
  invoke void @_RNvMs_NtNtCsdaEETE4DqmE_13typst_library6layout5frameNtB4_5Frame10push_frame(ptr noalias nofree noundef nonnull align 8 dereferenceable(48) %i.h, double noundef %.sroa.027.0..sroa.089.0, double noundef %.sroa.089.0..sroa.027.0, ptr noalias nofree noundef nonnull align 8 captures(address) dereferenceable(48) %i.f)
          to label %bb.ae unwind label %bb.s

bb.ae:                                            ; preds = %bb.ad
  %i.cx = fadd double %.sroa.0108.0175, %.sroa.speculated.i125 ; 2 uses
  %.inv168 = fcmp ord double %i.cx, 0.000000e+00
  %.sroa.0102.0 = select i1 %.inv168, double %i.cx, double 0.000000e+00
...
bb.af:                                            ; preds = %._crit_edge
  ...
  %i.cz = load i64, ptr %i.cy, align 8, !noundef !10 ; 2 uses
  %.not = icmp eq i64 %i.cz, 0
  br i1 %.not, label %bb.ag, label %bb.ah

bb.ag:                                            ; preds = %bb.af
  %i.da = load i64, ptr %0, align 16, !range !285, !noundef !10
  %i.db = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.dc = trunc nuw i64 %i.da to i1
  br i1 %i.dc, label %bb.ai, label %._crit_edge190

._crit_edge190:                                   ; preds = %bb.ag
...
bb.ah:                                            ; preds = %bb.af
  ...
  %i.de = load ptr, ptr %i.dd, align 16, !nonnull !10, !align !151, !noundef !10 ; 2 uses
  %i.df = getelementptr inbounds nuw i8, ptr %i.de, i64 8
  %i.dg = add i64 %i.cz, -1
  store ptr %i.df, ptr %i.dd, align 16, !captures !1091
  store i64 %i.dg, ptr %i.cy, align 8
  br label %bb.ai

bb.ai:                                            ; preds = %bb.ah, %bb.ag
  %.sroa.5106.0.in = phi ptr [ %i.de, %bb.ah ], [ %i.db, %bb.ag ]
  %.sroa.5106.0 = load double, ptr %.sroa.5106.0.in, align 8 ; 3 uses
  %i.dh = getelementptr inbounds nuw i8, ptr %0, i64 40
  store double %.sroa.5106.0, ptr %i.dh, align 8
  %i.di = getelementptr inbounds nuw i8, ptr %0, i64 48
  store double %.sroa.5106.0, ptr %i.di, align 16
  br label %bb.aj

bb.aj:                                            ; preds = %._crit_edge190, %bb.ai
  %i.dj = phi double [ %.pre, %._crit_edge190 ], [ %.sroa.5106.0, %bb.ai ]
  %i.dk = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.dl = load double, ptr %i.dk, align 16, !noundef !10
  store double %i.dl, ptr %i.r, align 16
  store double %i.dj, ptr %i.t, align 8
  store double 0.000000e+00, ptr %i.aj, align 16
  %i.dm = getelementptr inbounds nuw i8, ptr %0, i64 184 ; 2 uses
  ...
  %i.dn = getelementptr inbounds nuw i8, ptr %0, i64 200 ; 2 uses
  %i.do = load i64, ptr %i.dn, align 8, !alias.scope !27526, !noalias !27529, !noundef !10 ; 3 uses
  %i.dp = load i64, ptr %i.dm, align 8, !range !69, !alias.scope !27526, !noalias !27529, !noundef !10
  %i.dq = icmp eq i64 %i.do, %i.dp
  br i1 %i.dq, label %bb.ak, label %bb.ao

bb.ak:                                            ; preds = %bb.aj
  invoke void @_RNvMs4_NtCs1xwejQucwHj_5alloc7raw_vecINtB5_6RawVecNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameE8grow_oneCs7tN9tvpkfrg_12typst_layout(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %i.dm)
...
bb.al:                                            ; preds = %bb.ak
  ...
  %i.ds = getelementptr inbounds nuw i8, ptr %i.e, i64 16 ; 2 uses
  ...
  %i.dt = load ptr, ptr %i.ds, align 8, !alias.scope !27540, !noalias !27526, !nonnull !10, !noundef !10
  %i.du = atomicrmw sub ptr %i.dt, i64 1 release, align 8, !noalias !27541
  %i.dv = icmp eq i64 %i.du, 1
  br i1 %i.dv, label %bb.am, label %common.resume

bb.am:                                            ; preds = %bb.al
  fence acquire
  invoke void @_RNvMsn_NtCs1xwejQucwHj_5alloc4syncINtB5_3ArcINtNtCs6xpQEr8gLsQ_11typst_utils4hash8LazyHashINtNtB7_3vec3VecTNtNtNtCsdaEETE4DqmE_13typst_library6layout5point5PointNtNtB1L_5frame9FrameItemEEEE9drop_slowB1N_(ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %i.ds) #58
...
bb.ao:                                            ; preds = %bb.ak, %bb.aj
  ...
  %i.dy = load ptr, ptr %i.dx, align 16, !alias.scope !27526, !noalias !27529, !nonnull !10, !noundef !10
  %i.dz = getelementptr inbounds nuw [48 x i8], ptr %i.dy, i64 %i.do
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %i.dz, ptr noundef nonnull align 8 dereferenceable(48) %i.e, i64 48, i1 false), !noalias !27526
  %i.ea = add i64 %i.do, 1
  store i64 %i.ea, ptr %i.dn, align 8, !alias.scope !27526, !noalias !27529
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.h)
  br label %bb.h

.thread:                                          ; preds = %bb.p, %.thread157
  %.pn116156 = phi { ptr, i32 } [ %i.bq, %.thread157 ], [ %.pn, %bb.p ] ; 2 uses
  ...
  %i.ec = load ptr, ptr %i.eb, align 8, !alias.scope !27551, !nonnull !10, !noundef !10
  %i.ed = atomicrmw sub ptr %i.ec, i64 1 release, align 8, !noalias !27551
  %i.ee = icmp eq i64 %i.ed, 1
  br i1 %i.ee, label %bb.ap, label %common.resume

bb.ap:                                            ; preds = %.thread
  fence acquire
  invoke void @_RNvMsn_NtCs1xwejQucwHj_5alloc4syncINtB5_3ArcINtNtCs6xpQEr8gLsQ_11typst_utils4hash8LazyHashINtNtB7_3vec3VecTNtNtNtCsdaEETE4DqmE_13typst_library6layout5point5PointNtNtB1L_5frame9FrameItemEEEE9drop_slowB1N_(ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %i.eb) #58
          to label %common.resume unwind label %bb.i
}
...
bb.b:                                             ; preds = %bb.a
  ...
  %.inv23 = fcmp ord double %i.h, 0.000000e+00
  %.sroa.03.0 = select i1 %.inv23, double %i.h, double 0.000000e+00
  store double %.sroa.03.0, ptr %i.f, align 16
...
_RNvMsG_NtCs1xwejQucwHj_5alloc3vecINtB5_3VecNtNtCs7tN9tvpkfrg_12typst_layout5stack9StackItemE8push_mutBJ_.exit: ; preds = %bb.c, %bb.b
  ...
  %.sroa.425.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.p, i64 8
  store double %i.e, ptr %.sroa.425.0..sroa_idx, align 8, !noalias !27552
  %i.q = add i64 %i.k, 1
...
bb.o:                                             ; preds = %bb.l
  invoke void @_RNvNtCs3oUPovFnLWP_4core6option13unwrap_failed(ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @295) #53
          to label %.noexc153 unwind label %.body.thread270

.noexc153:                                        ; preds = %bb.o
  unreachable

bb.p:                                             ; preds = %bb.l
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.val151) ]
  %i.ax = getelementptr [8 x i8], ptr %.val151, i64 %.val152
...
bb.t:                                             ; preds = %bb.s, %bb.n
  %.sink.i.sroa.phi = phi ptr [ %.sink.i.sroa.gep, %bb.s ], [ %.sink.i.sroa.gep227, %bb.n ]
...
.noexc157:                                        ; preds = %bb.ac, %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit222
  br i1 %.sroa.041.2, label %.body.thread, label %bb.e

.body.thread270:                                  ; preds = %bb.at, %bb.o
...
bb.ab:                                            ; preds = %bb.y
  %i.bq = load double, ptr %.sroa.412.0..sroa_idx, align 8, !alias.scope !44154, !noundef !10
  %i.br = fmul double %i.bq, 5.000000e-01         ; 3 uses
  %.inv.i = fcmp ord double %i.br, 0.000000e+00
  %.sroa.01.010.i = select i1 %.inv.i, double %i.br, double 0.000000e+00
  br label %._crit_edge.i154

._crit_edge.i154:                                 ; preds = %bb.y, %bb.ab
  %.sroa.01.011.i = phi double [ %.sroa.01.010.i, %bb.ab ], [ 0.000000e+00, %bb.y ]
  %.sroa.08.0.i = phi double [ %i.br, %bb.ab ], [ 0.000000e+00, %bb.y ] ; 2 uses
  %.inv13.i = fcmp ord double %.sroa.08.0.i, 0.000000e+00
  %.sroa.04.0.i = select i1 %.inv13.i, double %.sroa.08.0.i, double 0.000000e+00
  %i.bs = insertelement <2 x double> poison, double %.sroa.01.011.i, i64 0
  %i.bt = insertelement <2 x double> %i.bs, double %.sroa.04.0.i, i64 1
  br label %bb.ae

_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit222: ; preds = %.body215, %bb.cj, %bb.ay, %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit, %bb.cr, %bb.cq, %bb.ad
  %.sroa.041.2 = phi i1 [ true, %bb.ad ], [ false, %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit ], [ %.sroa.041.4276, %bb.cq ], [ true, %bb.ay ], [ %.sroa.041.4276, %bb.cr ], [ false, %.body215 ], [ false, %bb.cj ]
  %.pn.pn.pn = phi { ptr, i32 } [ %i.bx, %bb.ad ], [ %lpad.thr_comm296, %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit ], [ %.pn277, %bb.cq ], [ %i.eb, %bb.ay ], [ %.pn277, %bb.cr ], [ %lpad.thr_comm.split-lp297, %.body215 ], [ %i.jx, %bb.cj ] ; 2 uses
  ...
  br i1 %i.bw, label %bb.ac, label %.noexc157

bb.ac:                                            ; preds = %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit222
  fence acquire
...
bb.ad:                                            ; preds = %bb.af, %_RNvMs1_NtNtNtCsdaEETE4DqmE_13typst_library4math2ir4itemNtB5_8MathItem21set_stretch_font_size.exit, %_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment6ascent.exit
  %i.bx = landingpad { ptr, i32 }
          cleanup
  br label %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit222

bb.ae:                                            ; preds = %._crit_edge.i154, %bb.aa, %bb.z
  %i.by = phi <2 x double> [ %i.bt, %._crit_edge.i154 ], [ %i.bn, %bb.z ], [ %i.bp, %bb.aa ] ; 3 uses
...
_RINvMNtNtCsaL1QbXo9JQH_3std4sync9once_lockINtB3_8OnceLockINtNtCs1xwejQucwHj_5alloc5boxed3BoxNtNtNtNtCsdaEETE4DqmE_13typst_library4text4font7metrics13MathConstantsEE15get_or_try_initNCINvB2_11get_or_initNCNvMs3_B1w_NtB1w_12FontInstance4math0E0zECs7tN9tvpkfrg_12typst_layout.exit: ; preds = %bb.ae, %bb.af
  ...
  %.inv = fcmp ord double %i.cg, 0.000000e+00
  %.sroa.046.0 = select i1 %.inv, double %i.cg, double 0.000000e+00 ; 2 uses
  %i.ch = call double @llvm.fabs.f64(double %.sroa.046.0)
  %i.ci = fcmp ueq double %i.ch, +inf
  %storemerge = select i1 %i.ci, double 0.000000e+00, double %.sroa.046.0
  store double %storemerge, ptr %i.q, align 8
...
bb.aj:                                            ; preds = %bb.ag
  %6 = load i64, ptr %.sroa.412.0..sroa_idx, align 8, !alias.scope !44170, !noundef !10
  br label %_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment5width.exit
...
bb.am:                                            ; preds = %bb.ak
  %i.cr = load i64, ptr %.sroa.412.0..sroa_idx, align 8, !range !285, !alias.scope !44173, !noundef !10
...
bb.aq:                                            ; preds = %_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment5width.exit
  ...
  %.not.i161 = icmp ne i64 %.sroa.044.0.copyload.i, 2 ; 2 uses
  %.not4.i = icmp eq i64 %.sroa.546.0.copyload.i, 0
  %or.cond60.i = select i1 %.not.i161, i1 %.not4.i, i1 false ; 2 uses
  %spec.select = select i1 %or.cond60.i, i64 1, i64 %.sroa.546.0.copyload.i
  %spec.select304 = select i1 %or.cond60.i, i64 %7, i64 %.sroa.647.0.copyload.i
  store i64 %spec.select, ptr %.sroa.546.0..sroa_idx.i, align 8, !noalias !44176
  store i64 %spec.select304, ptr %.sroa.647.0..sroa_idx.i, align 8, !noalias !44176
  ...
  %.not4.i164 = icmp eq i64 %.sroa.518.0.copyload.i, 0
  %or.cond21.i = select i1 %.not.i161, i1 %.not4.i164, i1 false ; 2 uses
...
bb.as:                                            ; preds = %bb.ar
  ...
  br i1 %i.dt, label %bb.at, label %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library4text4font12FontInstanceECs7tN9tvpkfrg_12typst_layout.exit166

bb.at:                                            ; preds = %bb.as
  fence acquire
  invoke void @_RNvMsn_NtCs1xwejQucwHj_5alloc4syncINtB5_3ArcNtNtNtCsdaEETE4DqmE_13typst_library4text4font17FontInstanceInnerE9drop_slowBM_(ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %i.s) #58
          to label %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library4text4font12FontInstanceECs7tN9tvpkfrg_12typst_layout.exit166 unwind label %.body.thread270

bb.au:                                            ; preds = %bb.ar
  %.sroa.652.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.o, i64 24
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %.sroa.8, ptr noundef nonnull align 8 dereferenceable(56) %.sroa.652.0..sroa_idx, i64 56, i1 false)
  %.sroa.652.sroa.4.0..sroa.652.0..sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.o, i64 80
  %i.du = load <2 x double>, ptr %.sroa.652.sroa.4.0..sroa.652.0..sroa_idx.sroa_idx, align 16 ; 3 uses
  %.sroa.652.sroa.6.0..sroa.652.0..sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.o, i64 96
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(208) %.sroa.11, ptr noundef nonnull align 16 dereferenceable(208) %.sroa.652.sroa.6.0..sroa.652.0..sroa_idx.sroa_idx, i64 208, i1 false)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.o)
...
bb.ax:                                            ; preds = %bb.au
  ...
  %.inv.i174 = fcmp ord double %i.ea, 0.000000e+00
  %.sroa.01.010.i175 = select i1 %.inv.i174, double %i.ea, double 0.000000e+00
  br label %._crit_edge.i167

bb.ay:                                            ; preds = %._crit_edge.i167
  %i.eb = landingpad { ptr, i32 }
          cleanup
  br label %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit222

._crit_edge.i167:                                 ; preds = %bb.au, %bb.ax, %bb.aw, %bb.av
  %.sroa.0.0.i173 = phi double [ %i.dy, %bb.aw ], [ %i.dx, %bb.av ], [ %.sroa.01.010.i175, %bb.ax ], [ 0.000000e+00, %bb.au ] ; 5 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.n)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.m)
  store i64 %i.dl, ptr %i.m, align 16
  %.sroa.5.0..sroa_idx323 = getelementptr inbounds nuw i8, ptr %i.m, i64 8
  store i64 %i.dv, ptr %.sroa.5.0..sroa_idx323, align 8
  %.sroa.7.0..sroa_idx324 = getelementptr inbounds nuw i8, ptr %i.m, i64 16
  store i64 %i.dq, ptr %.sroa.7.0..sroa_idx324, align 16
  %.sroa.8.0..sroa_idx325 = getelementptr inbounds nuw i8, ptr %i.m, i64 24
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %.sroa.8.0..sroa_idx325, ptr noundef nonnull align 8 dereferenceable(56) %.sroa.8, i64 56, i1 false)
  %.sroa.9.0..sroa_idx326 = getelementptr inbounds nuw i8, ptr %i.m, i64 80
  store <2 x double> %i.du, ptr %.sroa.9.0..sroa_idx326, align 16
  %.sroa.11.0..sroa_idx328 = getelementptr inbounds nuw i8, ptr %i.m, i64 96
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(208) %.sroa.11.0..sroa_idx328, ptr noundef nonnull align 16 dereferenceable(208) %.sroa.11, i64 208, i1 false)
...
bb.ba:                                            ; preds = %bb.az
  ...
  switch i64 %i.ei, label %default.unreachable [
    ...
    i64 1, label %bb.bc
    i64 2, label %bb.bd
    i64 3, label %_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment5width.exit180
  ]

bb.bb:                                            ; preds = %bb.ba
  %i.ej = getelementptr inbounds nuw i8, ptr %i.u, i64 64
  %i.ek = load double, ptr %i.ej, align 16, !alias.scope !44192, !noundef !10
  br label %_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment5width.exit180
...
bb.bd:                                            ; preds = %bb.ba
  %i.en = load double, ptr %.sroa.412.0..sroa_idx, align 8, !alias.scope !44192, !noundef !10
  br label %_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment5width.exit180
...
bb.be:                                            ; preds = %bb.az
  ...
  %.sroa.059.0 = select i1 %i.ep, double 0.000000e+00, double %i.eo ; 2 uses
  %i.eq = fadd double %.sroa.059.0, %.sroa.0.0.i173 ; 2 uses
  %.inv306.a = fcmp ord double %i.eq, 0.000000e+00
  %.sroa.062.0 = select i1 %.inv306.a, double %i.eq, double 0.000000e+00 ; 4 uses
  store double %.sroa.062.0, ptr %i.l, align 8
  %i.er = getelementptr inbounds nuw i8, ptr %i.n, i64 24
  %i.es = load double, ptr %i.er, align 8, !noundef !10
  %i.et = fneg double %.sroa.0.0.i173
  %i.eu = fcmp uno double %.sroa.0.0.i173, 0.000000e+00
  %.sroa.065.0 = select i1 %i.eu, double 0.000000e+00, double %i.et
  %i.ev = fadd double %.sroa.065.0, %i.es         ; 2 uses
  %.inv307.a = fcmp ord double %i.ev, 0.000000e+00
  %.sroa.068.0 = select i1 %.inv307.a, double %i.ev, double 0.000000e+00
  %i.ew = load i64, ptr %i.u, align 16, !range !4641, !alias.scope !44195, !noundef !10
  %i.ex = call i64 @llvm.usub.sat.i64(i64 %i.ew, i64 1)
  switch i64 %i.ex, label %default.unreachable [
    i64 0, label %bb.bf
    i64 1, label %bb.bg
    i64 2, label %bb.bh
    i64 3, label %_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment5width.exit183
  ]

bb.bf:                                            ; preds = %bb.be
  %i.ey = getelementptr inbounds nuw i8, ptr %i.u, i64 64
  %i.ez = load double, ptr %i.ey, align 16, !alias.scope !44195, !noundef !10
  br label %_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment5width.exit183

bb.bg:                                            ; preds = %bb.be
  %i.fa = getelementptr inbounds nuw i8, ptr %i.u, i64 32
  %i.fb = load double, ptr %i.fa, align 16, !alias.scope !44195, !noundef !10
  br label %_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment5width.exit183

bb.bh:                                            ; preds = %bb.be
  %i.fc = load double, ptr %.sroa.412.0..sroa_idx, align 8, !alias.scope !44195, !noundef !10
  br label %_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment5width.exit183

.thread:                                          ; preds = %_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment5width.exit183, %_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment5width.exit186, %bb.bn, %_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment6ascent.exit199, %_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment12base_descent.exit, %bb.bt
  %i.fd = landingpad { ptr, i32 }
          cleanup
  br label %bb.cq

_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment5width.exit180: ; preds = %bb.bd, %bb.bc, %bb.bb, %bb.ba
  %.sroa.0.0.i178 = phi double [ %i.ek, %bb.bb ], [ %i.em, %bb.bc ], [ %i.en, %bb.bd ], [ 0.000000e+00, %bb.ba ]
  %i.fe = fneg double %.sroa.0.0.i173
  %i.ff = fcmp uno double %.sroa.0.0.i173, 0.000000e+00
  %.sroa.053.0 = select i1 %i.ff, double 0.000000e+00, double %i.fe
  %i.fg = fadd double %., %.sroa.053.0            ; 2 uses
  %.inv305 = fcmp ord double %i.fg, 0.000000e+00
  %.sroa.056.0 = select i1 %.inv305, double %i.fg, double 0.000000e+00
  br label %bb.bi

bb.bi:                                            ; preds = %bb.bo, %_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment5width.exit180
  %.sroa.029.0 = phi double [ %.sroa.029.1, %bb.bo ], [ %.sroa.056.0, %_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment5width.exit180 ]
  %.sroa.028.0 = phi double [ %.sroa.086.0, %bb.bo ], [ %.sroa.0.0.i178, %_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment5width.exit180 ]
  %.sroa.0136.0 = phi double [ %.sroa.0136.1, %bb.bo ], [ 0.000000e+00, %_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment5width.exit180 ]
  br i1 %i.ab, label %bb.bs, label %bb.bp

_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment5width.exit183: ; preds = %bb.bh, %bb.bg, %bb.bf, %bb.be
end_hunk_4
...
bb.a:
  ...
  %.sroa.0457 = alloca [56 x i8], align 8         ; 5 uses
...
bb.t:                                             ; preds = %bb.q
  invoke void @_RNvNtCs3oUPovFnLWP_4core6option13unwrap_failed(ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @295) #53
          to label %.noexc362 unwind label %bb.ad

.noexc362:                                        ; preds = %bb.t
  unreachable

bb.u:                                             ; preds = %bb.q
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.val360) ]
  %i.cj = getelementptr [8 x i8], ptr %.val360, i64 %.val361
...
bb.y:                                             ; preds = %bb.x, %bb.s
  %.sink.i.sroa.phi = phi ptr [ %.sink.i.sroa.gep, %bb.x ], [ %.sink.i.sroa.gep451, %bb.s ]
...
_RINvMNtNtCsaL1QbXo9JQH_3std4sync9once_lockINtB3_8OnceLockINtNtCs1xwejQucwHj_5alloc5boxed3BoxNtNtNtNtCsdaEETE4DqmE_13typst_library4text4font7metrics13MathConstantsEE15get_or_try_initNCINvB2_11get_or_initNCNvMs3_B1w_NtB1w_12FontInstance4math0E0zECs7tN9tvpkfrg_12typst_layout.exit: ; preds = %bb.ae, %bb.af
  ...
  %.inv = fcmp ord double %i.di, 0.000000e+00
  %.sroa.0124.0 = select i1 %.inv, double %i.di, double 0.000000e+00 ; 2 uses
  %i.dj = call double @llvm.fabs.f64(double %.sroa.0124.0)
  %i.dk = fcmp ueq double %i.dj, +inf
  %.sroa.0124.1 = select i1 %i.dk, double 0.000000e+00, double %.sroa.0124.0
  %i.dl = invoke noundef align 8 ptr @_RNvMsk_NtNtCsdaEETE4DqmE_13typst_library11foundations6stylesNtB5_10StyleChain4find(ptr noalias nofree noundef nonnull readonly align 8 captures(none) dereferenceable(24) %i.aw, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(216) @_RNvNvXs0_NvNtNtCsdaEETE4DqmE_13typst_library4math8equation1__NtB9_12EquationElemNtNtNtNtBd_11foundations7content7element13NativeElement4ELEM6VTABLE, i8 noundef 6)
          to label %.noexc365 unwind label %bb.ag ; 4 uses

.noexc365:                                        ; preds = %_RINvMNtNtCsaL1QbXo9JQH_3std4sync9once_lockINtB3_8OnceLockINtNtCs1xwejQucwHj_5alloc5boxed3BoxNtNtNtNtCsdaEETE4DqmE_13typst_library4text4font7metrics13MathConstantsEE15get_or_try_initNCINvB2_11get_or_initNCNvMs3_B1w_NtB1w_12FontInstance4math0E0zECs7tN9tvpkfrg_12typst_layout.exit
...
bb.ai:                                            ; preds = %.noexc365
  ...
  invoke void %i.ds(ptr noalias nofree noundef nonnull sret([16 x i8]) align 8 captures(address) dereferenceable(16) %i.h, ptr noundef nonnull %i.dm) #59
          to label %.noexc366 unwind label %bb.ag, !inline_history !42972

.noexc366:                                        ; preds = %bb.ai
...
bb.aj:                                            ; preds = %.noexc366
  invoke void @_RNvNtNtCsdaEETE4DqmE_13typst_library11foundations6styles16block_wrong_type(ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(216) @_RNvNvXs0_NvNtNtCsdaEETE4DqmE_13typst_library4math8equation1__NtB9_12EquationElemNtNtNtNtBd_11foundations7content7element13NativeElement4ELEM6VTABLE, i8 noundef 6, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %i.dl) #57
          to label %.noexc367 unwind label %bb.ag

.noexc367:                                        ; preds = %bb.aj
  unreachable

_RINvMsk_NtNtCsdaEETE4DqmE_13typst_library11foundations6stylesNtB6_10StyleChain10get_clonedNtNtNtBa_4math8equation12EquationElemKh6_ECs7tN9tvpkfrg_12typst_layout.exit: ; preds = %.noexc366
...
bb.al:                                            ; preds = %bb.ak
  invoke fastcc void @_RINvMNtNtCsaL1QbXo9JQH_3std4sync9once_lockINtB3_8OnceLockINtNtCs1xwejQucwHj_5alloc5boxed3BoxNtNtNtNtCsdaEETE4DqmE_13typst_library4text4font7metrics13MathConstantsEE10initializeNCINvB2_11get_or_initNCNvMs3_B1w_NtB1w_12FontInstance4math0E0zECs7tN9tvpkfrg_12typst_layout(ptr noundef nonnull align 8 %i.dx, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %i.av)
          to label %_RINvMNtNtCsaL1QbXo9JQH_3std4sync9once_lockINtB3_8OnceLockINtNtCs1xwejQucwHj_5alloc5boxed3BoxNtNtNtNtCsdaEETE4DqmE_13typst_library4text4font7metrics13MathConstantsEE15get_or_try_initNCINvB2_11get_or_initNCNvMs3_B1w_NtB1w_12FontInstance4math0E0zECs7tN9tvpkfrg_12typst_layout.exit369 unwind label %bb.ag

_RINvMsk_NtNtCsdaEETE4DqmE_13typst_library11foundations6stylesNtB6_10StyleChain10get_clonedNtNtNtBa_4math8equation12EquationElemKh6_ECs7tN9tvpkfrg_12typst_layout.exit.thread: ; preds = %.noexc365, %_RINvMsk_NtNtCsdaEETE4DqmE_13typst_library11foundations6stylesNtB6_10StyleChain10get_clonedNtNtNtBa_4math8equation12EquationElemKh6_ECs7tN9tvpkfrg_12typst_layout.exit
...
bb.am:                                            ; preds = %_RINvMsk_NtNtCsdaEETE4DqmE_13typst_library11foundations6stylesNtB6_10StyleChain10get_clonedNtNtNtBa_4math8equation12EquationElemKh6_ECs7tN9tvpkfrg_12typst_layout.exit.thread
  invoke fastcc void @_RINvMNtNtCsaL1QbXo9JQH_3std4sync9once_lockINtB3_8OnceLockINtNtCs1xwejQucwHj_5alloc5boxed3BoxNtNtNtNtCsdaEETE4DqmE_13typst_library4text4font7metrics13MathConstantsEE10initializeNCINvB2_11get_or_initNCNvMs3_B1w_NtB1w_12FontInstance4math0E0zECs7tN9tvpkfrg_12typst_layout(ptr noundef nonnull align 8 %i.ec, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %i.av)
          to label %_RINvMNtNtCsaL1QbXo9JQH_3std4sync9once_lockINtB3_8OnceLockINtNtCs1xwejQucwHj_5alloc5boxed3BoxNtNtNtNtCsdaEETE4DqmE_13typst_library4text4font7metrics13MathConstantsEE15get_or_try_initNCINvB2_11get_or_initNCNvMs3_B1w_NtB1w_12FontInstance4math0E0zECs7tN9tvpkfrg_12typst_layout.exit371 unwind label %bb.ag

_RINvMNtNtCsaL1QbXo9JQH_3std4sync9once_lockINtB3_8OnceLockINtNtCs1xwejQucwHj_5alloc5boxed3BoxNtNtNtNtCsdaEETE4DqmE_13typst_library4text4font7metrics13MathConstantsEE15get_or_try_initNCINvB2_11get_or_initNCNvMs3_B1w_NtB1w_12FontInstance4math0E0zECs7tN9tvpkfrg_12typst_layout.exit369: ; preds = %bb.ak, %bb.al
  %i.eg = load ptr, ptr %i.dx, align 8, !nonnull !10, !noundef !10
  %i.eh = getelementptr inbounds nuw i8, ptr %i.eg, i64 344
  br label %bb.an

bb.an:                                            ; preds = %_RINvMNtNtCsaL1QbXo9JQH_3std4sync9once_lockINtB3_8OnceLockINtNtCs1xwejQucwHj_5alloc5boxed3BoxNtNtNtNtCsdaEETE4DqmE_13typst_library4text4font7metrics13MathConstantsEE15get_or_try_initNCINvB2_11get_or_initNCNvMs3_B1w_NtB1w_12FontInstance4math0E0zECs7tN9tvpkfrg_12typst_layout.exit371, %_RINvMNtNtCsaL1QbXo9JQH_3std4sync9once_lockINtB3_8OnceLockINtNtCs1xwejQucwHj_5alloc5boxed3BoxNtNtNtNtCsdaEETE4DqmE_13typst_library4text4font7metrics13MathConstantsEE15get_or_try_initNCINvB2_11get_or_initNCNvMs3_B1w_NtB1w_12FontInstance4math0E0zECs7tN9tvpkfrg_12typst_layout.exit369
  %.sroa.0323.0.in = phi ptr [ %i.eh, %_RINvMNtNtCsaL1QbXo9JQH_3std4sync9once_lockINtB3_8OnceLockINtNtCs1xwejQucwHj_5alloc5boxed3BoxNtNtNtNtCsdaEETE4DqmE_13typst_library4text4font7metrics13MathConstantsEE15get_or_try_initNCINvB2_11get_or_initNCNvMs3_B1w_NtB1w_12FontInstance4math0E0zECs7tN9tvpkfrg_12typst_layout.exit369 ], [ %i.eu, %_RINvMNtNtCsaL1QbXo9JQH_3std4sync9once_lockINtB3_8OnceLockINtNtCs1xwejQucwHj_5alloc5boxed3BoxNtNtNtNtCsdaEETE4DqmE_13typst_library4text4font7metrics13MathConstantsEE15get_or_try_initNCINvB2_11get_or_initNCNvMs3_B1w_NtB1w_12FontInstance4math0E0zECs7tN9tvpkfrg_12typst_layout.exit371 ]
  %.sroa.0323.0 = load double, ptr %.sroa.0323.0.in, align 8, !noundef !10
  %i.ei = fmul double %.sroa.0.0.i, %.sroa.0323.0 ; 2 uses
  %.inv554.a = fcmp ord double %i.ei, 0.000000e+00
  %.sroa.0128.0 = select i1 %.inv554.a, double %i.ei, double 0.000000e+00 ; 2 uses
  %i.ej = call double @llvm.fabs.f64(double %.sroa.0128.0)
  %i.ek = fcmp ueq double %i.ej, +inf
  %.sroa.0128.1 = select i1 %i.ek, double 0.000000e+00, double %.sroa.0128.0
  ...
  %i.eo = fadd double %.sroa.0124.1, %i.en        ; 2 uses
  %.inv555.a = fcmp ord double %i.eo, 0.000000e+00
  %.sroa.0132.0 = select i1 %.inv555.a, double %i.eo, double 0.000000e+00
  %i.ep = fadd double %.sroa.0132.0, %.sroa.0128.1 ; 2 uses
  %.inv556.a = fcmp ord double %i.ep, 0.000000e+00
  ...
  br i1 %i.es, label %bb.ao, label %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library4text4font12FontInstanceECs7tN9tvpkfrg_12typst_layout.exit373

bb.ao:                                            ; preds = %bb.an
  fence acquire
  invoke void @_RNvMsn_NtCs1xwejQucwHj_5alloc4syncINtB5_3ArcNtNtNtCsdaEETE4DqmE_13typst_library4text4font17FontInstanceInnerE9drop_slowBM_(ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %i.av) #58
          to label %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library4text4font12FontInstanceECs7tN9tvpkfrg_12typst_layout.exit373 unwind label %bb.ad
...
_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library4text4font12FontInstanceECs7tN9tvpkfrg_12typst_layout.exit373: ; preds = %bb.an, %bb.ao
...
bb.ap:                                            ; preds = %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library4text4font12FontInstanceECs7tN9tvpkfrg_12typst_layout.exit373
...
bb.aq:                                            ; preds = %bb.ap
  invoke void @_RNvXs2_NtNtNtCsdaEETE4DqmE_13typst_library11foundations7content3rawNtB5_10RawContentNtNtNtCs3oUPovFnLWP_4core3ops4drop4Drop4drop(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %.sroa.623.0..sroa_idx)
...
bb.ar:                                            ; preds = %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library4text4font12FontInstanceECs7tN9tvpkfrg_12typst_layout.exit373
...
bb.as:                                            ; preds = %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library4text4font12FontInstanceECs7tN9tvpkfrg_12typst_layout.exit373
  ...
  %i.ez = load ptr, ptr %.sroa.623.0..sroa_idx, align 8, !alias.scope !44666, !nonnull !10, !noundef !10
...
bb.at:                                            ; preds = %bb.as
  fence acquire
  invoke void @_RNvMsn_NtCs1xwejQucwHj_5alloc4syncINtB5_3ArcINtNtCs6xpQEr8gLsQ_11typst_utils4hash8LazyHashINtNtB7_3vec3VecTNtNtNtCsdaEETE4DqmE_13typst_library6layout5point5PointNtNtB1L_5frame9FrameItemEEEE9drop_slowB1N_(ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %.sroa.623.0..sroa_idx) #58
          to label %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCs7tN9tvpkfrg_12typst_layout4math8fragment12MathFragmentEBH_.exit unwind label %bb.l

_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCs7tN9tvpkfrg_12typst_layout4math8fragment12MathFragmentEBH_.exit: ; preds = %bb.as, %bb.ap, %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library4text4font12FontInstanceECs7tN9tvpkfrg_12typst_layout.exit373, %bb.aq, %bb.ar, %bb.at
...
.cont.i:                                          ; preds = %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCs7tN9tvpkfrg_12typst_layout4math8fragment12MathFragmentEBH_.exit
  ...
  %.not.i377 = icmp ne i64 %.sroa.849.0.copyload.i, 2
  %.not4.i = icmp eq i64 %.sroa.1051.0.copyload.i, 0
  %or.cond60.i = select i1 %.not.i377, i1 %.not4.i, i1 false ; 2 uses
  %4 = bitcast double %i.ep to i64
  %5 = select i1 %.inv556.a, i64 %4, i64 0
  %spec.select = select i1 %or.cond60.i, i64 1, i64 %.sroa.1051.0.copyload.i
  %spec.select553 = select i1 %or.cond60.i, i64 %5, i64 %.sroa.1152.0.copyload.i
  store i64 %spec.select, ptr %.sroa.1051.0..sroa_idx.i, align 8, !noalias !44667
  store i64 %spec.select553, ptr %.sroa.1152.0..sroa_idx.i, align 8, !noalias !44667
...
bb.aw:                                            ; preds = %bb.au
  %.sroa.6141.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.as, i64 24
  %.sroa.637.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.at, i64 24
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(280) %.sroa.637.0..sroa_idx, ptr noundef nonnull align 8 dereferenceable(280) %.sroa.6141.0..sroa_idx, i64 280, i1 false)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.as)
  store i64 %i.fh, ptr %i.at, align 16
  %.sroa.435.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.at, i64 8
  store ptr %i.fk, ptr %.sroa.435.0..sroa_idx, align 8
  %.sroa.536.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.at, i64 16
  store i64 %i.fm, ptr %.sroa.536.0..sroa_idx, align 16
  %i.fn = getelementptr inbounds nuw i8, ptr %0, i64 256
  %.sink635 = select i1 %i.by, ptr %i.fn, ptr %2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.ao, ptr noundef nonnull align 8 dereferenceable(24) %.sink635, i64 24, i1 false)
  ...
  %.val358 = load ptr, ptr %i.ca, align 8         ; 2 uses
  %.val359 = load i64, ptr %i.cb, align 8         ; 2 uses
...
bb.ay:                                            ; preds = %bb.aw
  %.not.i378 = icmp eq i64 %.val359, 0
  br i1 %.not.i378, label %bb.bb, label %bb.bc, !prof !33

bb.az:                                            ; preds = %bb.ax
  call void @llvm.trap()
  unreachable

bb.ba:                                            ; preds = %._crit_edge.i379, %bb.ax
  %i.ft = phi ptr [ %i.fq, %bb.ax ], [ %storemerge.pre.i380, %._crit_edge.i379 ] ; 5 uses
...
bb.bb:                                            ; preds = %bb.ay
  invoke void @_RNvNtCs3oUPovFnLWP_4core6option13unwrap_failed(ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @295) #53
          to label %.noexc385 unwind label %.body386

.noexc385:                                        ; preds = %bb.bb
  unreachable

bb.bc:                                            ; preds = %bb.ay
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.val358) ]
  %i.fv = getelementptr [8 x i8], ptr %.val358, i64 %.val359
  ...
  br i1 %i.fz, label %bb.bd, label %._crit_edge.i379

._crit_edge.i379:                                 ; preds = %bb.bc
  %storemerge.pre.i380 = load ptr, ptr %i.fw, align 8, !noalias !44673
  br label %bb.ba
...
bb.bg:                                            ; preds = %bb.bf, %bb.ba
  %.sink.i381.sroa.phi = phi ptr [ %.sink.i381.sroa.gep, %bb.bf ], [ %.sink.i381.sroa.gep452, %bb.ba ]
  %.sroa.4.0.i382 = load double, ptr %.sink.i381.sroa.phi, align 8, !alias.scope !44670, !noalias !44675, !noundef !10
  br label %bb.bl
...
bb.bh:                                            ; preds = %bb.bj, %bb.be
  ...
  br i1 %i.gd, label %bb.bi, label %.body386.thread
...
bb.bi:                                            ; preds = %bb.bh
  ...
  invoke void @_RNvMsn_NtCs1xwejQucwHj_5alloc4syncINtB5_3ArcNtNtNtCsdaEETE4DqmE_13typst_library4text4font17FontInstanceInnerE9drop_slowBM_(ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %i.g) #58
          to label %.body386.thread unwind label %bb.bk, !noalias !44673
...
.noexc391:                                        ; preds = %bb.bo, %bb.bn
  br i1 %.sroa.0114.2, label %.body386.thread, label %bb.k

.body386.thread479:                               ; preds = %bb.fb
  %lpad.thr_comm = landingpad { ptr, i32 }
          cleanup
  br label %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit450
...
bb.bl:                                            ; preds = %bb.bj, %bb.bg
  %.sroa.0.0.i383 = phi double [ %.sroa.4.0.i382, %bb.bg ], [ %i.gg, %bb.bj ] ; 5 uses
...
bb.bm:                                            ; preds = %bb.bl
  invoke fastcc void @_RINvMNtNtCsaL1QbXo9JQH_3std4sync9once_lockINtB3_8OnceLockINtNtCs1xwejQucwHj_5alloc5boxed3BoxNtNtNtNtCsdaEETE4DqmE_13typst_library4text4font7metrics13MathConstantsEE10initializeNCINvB2_11get_or_initNCNvMs3_B1w_NtB1w_12FontInstance4math0E0zECs7tN9tvpkfrg_12typst_layout(ptr noundef nonnull align 8 %i.gi, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %i.ar)
          to label %_RINvMNtNtCsaL1QbXo9JQH_3std4sync9once_lockINtB3_8OnceLockINtNtCs1xwejQucwHj_5alloc5boxed3BoxNtNtNtNtCsdaEETE4DqmE_13typst_library4text4font7metrics13MathConstantsEE15get_or_try_initNCINvB2_11get_or_initNCNvMs3_B1w_NtB1w_12FontInstance4math0E0zECs7tN9tvpkfrg_12typst_layout.exit390 unwind label %bb.bp

bb.bn:                                            ; preds = %.thread493, %bb.cv, %bb.bp
  %.sroa.0115.3 = phi i1 [ true, %bb.bp ], [ %.sroa.0115.4498, %.thread493 ], [ %.sroa.0115.5, %bb.cv ] ; 2 uses
  %.sroa.0114.2 = phi i1 [ %.sroa.0114.3, %bb.bp ], [ %.sroa.0114.4499, %.thread493 ], [ false, %bb.cv ]
  %.pn348 = phi { ptr, i32 } [ %i.gp, %bb.bp ], [ %.pn346500, %.thread493 ], [ %.pn344, %bb.cv ] ; 2 uses
  ...
  %i.go = icmp eq i64 %i.gn, 1
  br i1 %i.go, label %bb.bo, label %.noexc391
...
_RINvMNtNtCsaL1QbXo9JQH_3std4sync9once_lockINtB3_8OnceLockINtNtCs1xwejQucwHj_5alloc5boxed3BoxNtNtNtNtCsdaEETE4DqmE_13typst_library4text4font7metrics13MathConstantsEE15get_or_try_initNCINvB2_11get_or_initNCNvMs3_B1w_NtB1w_12FontInstance4math0E0zECs7tN9tvpkfrg_12typst_layout.exit390: ; preds = %bb.bl, %bb.bm
  ...
  %i.gt = fmul double %.sroa.0.0.i383, %i.gs      ; 2 uses
  %.inv557.a = fcmp ord double %i.gt, 0.000000e+00
  %.sroa.0142.0 = select i1 %.inv557.a, double %i.gt, double 0.000000e+00 ; 2 uses
  %i.gu = call double @llvm.fabs.f64(double %.sroa.0142.0)
  %i.gv = fcmp ueq double %i.gu, +inf
  %storemerge = select i1 %i.gv, double 0.000000e+00, double %.sroa.0142.0
  store double %storemerge, ptr %i.ap, align 8
...
.thread503:                                       ; preds = %bb.ld, %bb.lf, %.thread495, %bb.on, %bb.n, %bb.h
  %.pn390 = phi { ptr, i32 } [ %i.bt, %bb.h ], [ %.pn388, %bb.on ], [ %.pn388, %bb.n ], [ %lpad.thr_comm.split-lp, %.thread495 ], [ %.pn199.i, %bb.lf ], [ %.pn199.i, %bb.ld ]
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %.val162 = load i64, ptr %i.z, align 8, !noundef !10 ; 2 uses
  %.not.i = icmp eq i64 %.val162, 0
...
_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit180: ; preds = %bb.al, %.body, %bb.u, %bb.aw, %bb.ax, %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit177, %bb.p, %bb.g
  %.pn160 = phi { ptr, i32 } [ %i.ac, %bb.g ], [ %.pn.pn188, %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit177 ], [ %.pn195, %bb.p ], [ %.pn158183, %bb.ax ], [ %.pn158183, %bb.aw ], [ %lpad.thr_comm, %bb.u ], [ %lpad.thr_comm.split-lp, %.body ], [ %i.fa, %bb.al ]
...
bb.f:                                             ; preds = %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit180
...
bb.g:                                             ; preds = %bb.at, %bb.i, %bb.e, %bb.n, %bb.k, %bb.j, %_RINvMNtNtCsaL1QbXo9JQH_3std4sync9once_lockINtB3_8OnceLockINtNtCs1xwejQucwHj_5alloc5boxed3BoxNtNtNtNtCsdaEETE4DqmE_13typst_library4text4font7metrics13MathConstantsEE15get_or_try_initNCINvB2_11get_or_initNCNvMs3_B1w_NtB1w_12FontInstance4math0E0zECs7tN9tvpkfrg_12typst_layout.exit
  %i.ac = landingpad { ptr, i32 }
          cleanup
  br label %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit180

bb.h:                                             ; preds = %bb.d
  %i.ad = getelementptr inbounds nuw i8, ptr %1, i64 8
  %.val = load ptr, ptr %i.ad, align 8, !nonnull !10, !noundef !10
  %i.ae = getelementptr [8 x i8], ptr %.val, i64 %.val162
...
bb.k:                                             ; preds = %bb.j
  ...
  %.inv = fcmp ord double %i.as, 0.000000e+00
  %.sroa.032.0 = select i1 %.inv, double %i.as, double 0.000000e+00 ; 2 uses
  %i.at = call double @llvm.fabs.f64(double %.sroa.032.0)
  %i.au = fcmp ueq double %i.at, +inf
  %.sroa.032.1 = select i1 %i.au, double 0.000000e+00, double %.sroa.032.0 ; 2 uses
  ...
  %.inv219.a = fcmp ord double %i.ax, 0.000000e+00
  %.sroa.037.0 = select i1 %.inv219.a, double %i.ax, double 0.000000e+00 ; 2 uses
  %i.ay = call double @llvm.fabs.f64(double %.sroa.037.0)
  %i.az = fcmp ueq double %i.ay, +inf
  %.sroa.037.1 = select i1 %i.az, double 0.000000e+00, double %.sroa.037.0 ; 2 uses
  ...
  %.inv220.a = fcmp ord double %i.bc, 0.000000e+00
  %.sroa.042.0 = select i1 %.inv220.a, double %i.bc, double 0.000000e+00 ; 2 uses
  %i.bd = call double @llvm.fabs.f64(double %.sroa.042.0)
  %i.be = fcmp ueq double %i.bd, +inf
  %.sroa.042.1 = select i1 %i.be, double 0.000000e+00, double %.sroa.042.0
  call void @llvm.lifetime.start.p0(ptr nonnull %i.u)
...
bb.m:                                             ; preds = %bb.l
  ...
  br label %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit175

bb.n:                                             ; preds = %bb.l
  %.sroa.648.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.t, i64 24
  %.sroa.10.0..sroa_idx7 = getelementptr inbounds nuw i8, ptr %i.s, i64 24
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(280) %.sroa.10.0..sroa_idx7, ptr noundef nonnull align 8 dereferenceable(280) %.sroa.648.0..sroa_idx, i64 280, i1 false)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.t)
  store i64 %i.bf, ptr %i.s, align 16
  %.sroa.6.0..sroa_idx3 = getelementptr inbounds nuw i8, ptr %i.s, i64 8
  store ptr %i.bi, ptr %.sroa.6.0..sroa_idx3, align 8
  %.sroa.8.0..sroa_idx5 = getelementptr inbounds nuw i8, ptr %i.s, i64 16
  store i64 %i.bk, ptr %.sroa.8.0..sroa_idx5, align 16
...
bb.p:                                             ; preds = %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit173
  br i1 %.sroa.031.2196, label %bb.aw, label %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit180
...
bb.s:                                             ; preds = %bb.q
  %.sroa.652.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.q, i64 24
  %.sroa.1016.0..sroa_idx17 = getelementptr inbounds nuw i8, ptr %i.p, i64 24
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(280) %.sroa.1016.0..sroa_idx17, ptr noundef nonnull align 8 dereferenceable(280) %.sroa.652.0..sroa_idx, i64 280, i1 false)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.q)
  store i64 %i.br, ptr %i.p, align 16
  %.sroa.610.0..sroa_idx11 = getelementptr inbounds nuw i8, ptr %i.p, i64 8
  store ptr %i.bu, ptr %.sroa.610.0..sroa_idx11, align 8
  %.sroa.813.0..sroa_idx14 = getelementptr inbounds nuw i8, ptr %i.p, i64 16
  store i64 %i.bw, ptr %.sroa.813.0..sroa_idx14, align 16
...
bb.t:                                             ; preds = %bb.s
  ...
  %.inv221.a = fcmp ord double %i.cb, 0.000000e+00
  %.sroa.053.0 = select i1 %.inv221.a, double %i.cb, double 0.000000e+00
  %i.cc = fadd double %.sroa.032.1, %.sroa.053.0  ; 2 uses
...
.cont.i:                                          ; preds = %bb.t
  ...
  %.not.i167 = icmp ne i64 %.sroa.849.0.copyload.i, 2
  %.not4.i = icmp eq i64 %.sroa.1051.0.copyload.i, 0
  %or.cond60.i = select i1 %.not.i167, i1 %.not4.i, i1 false ; 2 uses
  %4 = bitcast double %i.cc to i64
  %spec.select = select i1 %or.cond60.i, i64 1, i64 %.sroa.1051.0.copyload.i
  %spec.select218 = select i1 %or.cond60.i, i64 %4, i64 %.sroa.1152.0.copyload.i
  store i64 %spec.select, ptr %.sroa.1051.0..sroa_idx.i, align 8, !noalias !45854
  store i64 %spec.select218, ptr %.sroa.1152.0..sroa_idx.i, align 8, !noalias !45854
  br label %_RNvMs1_NtNtNtCsdaEETE4DqmE_13typst_library4math2ir4itemNtB5_8MathItem23set_stretch_relative_to.exit

bb.u:                                             ; preds = %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit171
  br i1 %.sroa.030.2.ph, label %bb.au, label %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCsdaEETE4DqmE_13typst_library6layout5frame5FrameECs7tN9tvpkfrg_12typst_layout.exit180

.thread184:                                       ; preds = %_RNvMs1_NtNtNtCsdaEETE4DqmE_13typst_library4math2ir4itemNtB5_8MathItem23set_stretch_relative_to.exit, %bb.y
...
_RNvMs1_NtNtNtCsdaEETE4DqmE_13typst_library4math2ir4itemNtB5_8MathItem23set_stretch_relative_to.exit: ; preds = %.cont.i, %bb.t
  ...
  invoke fastcc void @_RNvMNtCs7tN9tvpkfrg_12typst_layout4mathNtB2_11MathContext20layout_into_fragment(ptr noalias nofree noundef align 16 captures(none) dereferenceable(304) %i.n, ptr noalias nofree noundef align 8 dereferenceable(80) %1, ptr noalias nofree noundef readonly align 16 captures(address, read_provenance) dereferenceable(144) %i.cd, ptr noalias nofree noundef align 8 captures(address) dereferenceable(24) %i.b)
          to label %bb.v unwind label %.thread184
...
bb.y:                                             ; preds = %bb.v
  %.sroa.662.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.n, i64 24
  %.sroa.1026.0..sroa_idx27 = getelementptr inbounds nuw i8, ptr %i.m, i64 24
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(280) %.sroa.1026.0..sroa_idx27, ptr noundef nonnull align 8 dereferenceable(280) %.sroa.662.0..sroa_idx, i64 280, i1 false)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.n)
  store i64 %i.cm, ptr %i.m, align 16
  %.sroa.620.0..sroa_idx21 = getelementptr inbounds nuw i8, ptr %i.m, i64 8
  store ptr %i.cp, ptr %.sroa.620.0..sroa_idx21, align 8
  %.sroa.823.0..sroa_idx24 = getelementptr inbounds nuw i8, ptr %i.m, i64 16
  store i64 %i.cr, ptr %.sroa.823.0..sroa_idx24, align 16
  call void @llvm.lifetime.start.p0(ptr nonnull %i.l)
  invoke fastcc void @_RNvMNtNtCs7tN9tvpkfrg_12typst_layout4math8fragmentNtB2_12MathFragment10into_frame(ptr noalias nofree noundef align 8 captures(address) dereferenceable(48) %i.l, ptr noalias nofree noundef readonly align 16 captures(address) dereferenceable(304) %i.m)
          to label %bb.z unwind label %.thread184
...
bb.z:                                             ; preds = %bb.y
  ...
  %.sroa.063.0 = select i1 %i.dc, double 0.000000e+00, double %i.db
  %i.dd = fadd double %i.cz, %.sroa.063.0         ; 2 uses
  %.inv222.a = fcmp ord double %i.dd, 0.000000e+00
  %.sroa.066.0 = select i1 %.inv222.a, double %i.dd, double 0.000000e+00
  %i.de = invoke noundef double @_RNvMNtNtCsdaEETE4DqmE_13typst_library6layout3absNtB2_3Abs3max(double noundef 0.000000e+00, double noundef %.sroa.066.0)
          to label %bb.aa unwind label %.thread190

.thread190:                                       ; preds = %bb.z, %bb.aa, %bb.ab, %bb.ac, %bb.ad, %bb.ae
...
bb.aa:                                            ; preds = %bb.z
  ...
  %.inv223.a = fcmp ord double %i.dg, 0.000000e+00
  %.sroa.069.0 = select i1 %.inv223.a, double %i.dg, double 0.000000e+00 ; 2 uses
  invoke void @_RNvMNtNtCsdaEETE4DqmE_13typst_library6layout3absNtB2_3Abs7set_max(ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %i.o, double noundef %i.cz)
          to label %bb.ab unwind label %.thread190

bb.ab:                                            ; preds = %bb.aa
  %i.dh = fmul nnan double %.sroa.037.1, 5.000000e-01
  %i.di = fadd double %i.dh, %i.bm                ; 2 uses
  %.inv224.a = fcmp ord double %i.di, 0.000000e+00
  %.sroa.075.0 = select i1 %.inv224.a, double %i.di, double 0.000000e+00
  %i.dj = load double, ptr %i.o, align 8, !noundef !10
  %i.dk = fmul double %i.dj, 5.000000e-01         ; 2 uses
  %.inv225.a = fcmp ord double %i.dk, 0.000000e+00
  %.sroa.078.0 = select i1 %.inv225.a, double %i.dk, double 0.000000e+00
  %i.dl = fmul double %i.cx, 5.000000e-01         ; 2 uses
  %.inv226.a = fcmp ord double %i.dl, 0.000000e+00
  %i.dm = fmul double %i.cz, 5.000000e-01         ; 2 uses
  %.inv227 = fcmp ord double %i.dm, 0.000000e+00
  %.neg = fneg double %i.dl
  %i.dn = select i1 %.inv226.a, double %.neg, double -0.000000e+00
  %.neg228 = fneg double %i.dm
  %i.do = select i1 %.inv227, double %.neg228, double -0.000000e+00
  %i.dp = fadd double %.sroa.075.0, %i.dn         ; 2 uses
  %.inv.i = fcmp ord double %i.dp, 0.000000e+00
  %.sroa.06.0.i = select i1 %.inv.i, double %i.dp, double 0.000000e+00 ; 4 uses
  %i.dq = fadd double %i.do, %.sroa.078.0         ; 2 uses
  %.inv12.i = fcmp ord double %i.dq, 0.000000e+00
  %i.dr = fadd double %i.bm, 0.000000e+00
  %i.ds = fcmp uno double %i.bm, 0.000000e+00
  %.sroa.087.0 = select i1 %i.ds, double 0.000000e+00, double %i.dr
  %i.dt = fadd double %i.bo, %.sroa.069.0         ; 2 uses
  %.inv229.a = fcmp ord double %i.dt, 0.000000e+00
  %.sroa.090.0 = select i1 %.inv229.a, double %i.dt, double 0.000000e+00
  %i.du = fadd double %.sroa.037.1, %.sroa.087.0  ; 2 uses
  %.inv230.a = fcmp ord double %i.du, 0.000000e+00
  %.sroa.093.0 = select i1 %.inv230.a, double %i.du, double 0.000000e+00 ; 2 uses
  %i.dv = fadd double %.sroa.032.1, %.sroa.090.0  ; 2 uses
  %.inv231.a = fcmp ord double %i.dv, 0.000000e+00
  %i.dw = fadd double %.sroa.093.0, %i.by         ; 2 uses
  %.inv232.a = fcmp ord double %i.dw, 0.000000e+00
  %.sroa.099.0 = select i1 %.inv232.a, double %i.dw, double 0.000000e+00
  %i.dx = fadd double %i.cx, %.sroa.06.0.i        ; 2 uses
  %.inv233.a = fcmp ord double %i.dx, 0.000000e+00
  %.sroa.0102.0 = select i1 %.inv233.a, double %i.dx, double 0.000000e+00
  %i.dy = invoke noundef double @_RNvMNtNtCsdaEETE4DqmE_13typst_library6layout3absNtB2_3Abs3max(double noundef %.sroa.099.0, double noundef %.sroa.0102.0)
          to label %bb.ac unwind label %.thread190

bb.ac:                                            ; preds = %bb.ab
  %i.dz = fneg double %.sroa.06.0.i
  %i.ea = fcmp uno double %.sroa.06.0.i, 0.000000e+00
  %.sroa.0105.0 = select i1 %i.ea, double 0.000000e+00, double %i.dz ; 2 uses
  %i.eb = invoke noundef double @_RNvMNtNtCsdaEETE4DqmE_13typst_library6layout3absNtB2_3Abs3max(double noundef 0.000000e+00, double noundef %.sroa.0105.0)
          to label %bb.ad unwind label %.thread190

bb.ad:                                            ; preds = %bb.ac
  %i.ec = invoke noundef double @_RNvMNtNtCsdaEETE4DqmE_13typst_library6layout3absNtB2_3Abs3max(double noundef 0.000000e+00, double noundef %.sroa.0105.0)
          to label %bb.ae unwind label %.thread190 ; 4 uses

bb.ae:                                            ; preds = %bb.ad
  %i.ed = fadd double %i.dy, %i.eb                ; 2 uses
  %.inv234.a = fcmp ord double %i.ed, 0.000000e+00
  %.sroa.0108.0 = select i1 %.inv234.a, double %i.ed, double 0.000000e+00
  %i.ee = fadd double %.sroa.06.0.i, %i.ec        ; 2 uses
  %.inv235.a = fcmp ord double %i.ee, 0.000000e+00
  %.sroa.0120.0 = select i1 %.inv235.a, double %i.ee, double 0.000000e+00
  %i.ef = fadd double %i.dq, 0.000000e+00
  %i.eg = select i1 %.inv12.i, double %i.ef, double 0.000000e+00
  %i.eh = fadd double %.sroa.093.0, %i.ec         ; 2 uses
  %.inv236.a = fcmp ord double %i.eh, 0.000000e+00
  %.sroa.0143.0 = select i1 %.inv236.a, double %i.eh, double 0.000000e+00
  %i.ei = fadd double %i.dv, 0.000000e+00
  %i.ej = select i1 %.inv231.a, double %i.ei, double 0.000000e+00
  call void @llvm.lifetime.start.p0(ptr nonnull %i.k)
  %i.ek = load double, ptr %i.o, align 8, !noundef !10
  invoke void @_RNvMNtNtCsdaEETE4DqmE_13typst_library6layout5frameNtB2_5Frame4soft(ptr noalias nofree noundef nonnull sret([48 x i8]) align 8 captures(address) dereferenceable(48) %i.k, double noundef %.sroa.0108.0, double noundef %i.ek, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @644)
          to label %bb.af unwind label %.thread190

bb.af:                                            ; preds = %bb.ae
  %i.el = fadd double %.sroa.069.0, 0.000000e+00
  %i.em = fcmp uno double %i.ec, 0.000000e+00
  %i.en = fadd double %i.ec, 0.000000e+00
  %.sroa.0132.0 = select i1 %i.em, double 0.000000e+00, double %i.en
  %i.eo = load double, ptr %i.o, align 8, !noundef !10
  %i.ep = fmul double %i.eo, 5.000000e-01         ; 2 uses
  %.inv237 = fcmp ord double %i.ep, 0.000000e+00
  %.sroa.0149.0 = select i1 %.inv237, double %i.ep, double 0.000000e+00
  %i.eq = fadd double %.sroa.042.1, %.sroa.0149.0
  ...
  invoke void @_RNvMs_NtNtCsdaEETE4DqmE_13typst_library6layout5frameNtB4_5Frame10push_frame(ptr noalias nofree noundef nonnull align 8 dereferenceable(48) %i.k, double noundef %.sroa.0132.0, double noundef %i.el, ptr noalias nofree noundef nonnull align 8 captures(address) dereferenceable(48) %i.j)
...
bb.ag:                                            ; preds = %bb.af
  ...
  invoke void @_RNvMs_NtNtCsdaEETE4DqmE_13typst_library6layout5frameNtB4_5Frame10push_frame(ptr noalias nofree noundef nonnull align 8 dereferenceable(48) %i.k, double noundef %.sroa.0143.0, double noundef %i.ej, ptr noalias nofree noundef nonnull align 8 captures(address) dereferenceable(48) %i.i)
...
bb.ah:                                            ; preds = %bb.ag
  ...
  invoke void @_RNvMs_NtNtCsdaEETE4DqmE_13typst_library6layout5frameNtB4_5Frame10push_frame(ptr noalias nofree noundef nonnull align 8 dereferenceable(48) %i.k, double noundef %.sroa.0120.0, double noundef %i.eg, ptr noalias nofree noundef nonnull align 8 captures(address) dereferenceable(48) %i.h)
...
bb.ai:                                            ; preds = %bb.ah
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.g)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %i.f, ptr noundef nonnull align 8 dereferenceable(48) %i.k, i64 48, i1 false)
  %i.es = getelementptr inbounds nuw i8, ptr %3, i64 45
end_hunk_8
