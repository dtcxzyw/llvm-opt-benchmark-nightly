Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/mimalloc/original/alloc-aligned?download=true
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.m = and i64 %i.k, %i.l
  %.not40.i.i = icmp eq i64 %i.m, 0
  br i1 %.not40.i.i, label %bb.e, label %.thread.i.i, !prof !9

bb.e:                                             ; preds = %bb.d
  %i.n = tail call ptr @_mi_page_malloc_zero(ptr noundef nonnull %0, ptr noundef nonnull %i.h, i64 noundef %1, i1 noundef zeroext false) #10
  br label %mi_theap_malloc_aligned_at.exit

.thread.i.i:                                      ; preds = %bb.d, %bb.c, %bb.b
  %i.o = tail call fastcc ptr @mi_theap_malloc_zero_aligned_at_generic(ptr noundef %0, i64 noundef %1, i64 noundef %2, i64 noundef 0, i1 noundef zeroext false, ptr noundef null) #11
  br label %mi_theap_malloc_aligned_at.exit

mi_theap_malloc_aligned_at.exit:                  ; preds = %mi_alignment_is_valid.exit.thread.i.i, %bb.e, %.thread.i.i
  %.3.i.i = phi ptr [ null, %mi_alignment_is_valid.exit.thread.i.i ], [ %i.o, %.thread.i.i ], [ %i.n, %bb.e ]
  ret ptr %.3.i.i
}

; Function Attrs: nooutline nounwind uwtable
define hidden noalias ptr @mi_theap_zalloc_aligned(ptr noundef %0, i64 noundef %1, i64 noundef %2) local_unnamed_addr #0 {
bb.a:
  %i.a = tail call range(i64 0, 65) i64 @llvm.ctpop.i64(i64 %2)
  %or.cond.i.i = icmp eq i64 %i.a, 1
  br i1 %or.cond.i.i, label %bb.b, label %mi_alignment_is_valid.exit.thread.i.i, !prof !8
...
bb.e:                                             ; preds = %bb.d
  %i.n = tail call ptr @_mi_page_malloc_zero(ptr noundef nonnull %0, ptr noundef nonnull %i.h, i64 noundef %1, i1 noundef zeroext true) #10
  br label %mi_theap_zalloc_aligned_at.exit

.thread.i.i:                                      ; preds = %bb.d, %bb.c, %bb.b
  %i.o = tail call fastcc ptr @mi_theap_malloc_zero_aligned_at_generic(ptr noundef %0, i64 noundef %1, i64 noundef %2, i64 noundef 0, i1 noundef zeroext true, ptr noundef null) #11
  br label %mi_theap_zalloc_aligned_at.exit
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.o = add i64 %2, %i.n
  %i.p = and i64 %i.o, %i.m
  %.not40.i.i = icmp eq i64 %i.p, 0
  br i1 %.not40.i.i, label %bb.e, label %.thread.i.i, !prof !9

bb.e:                                             ; preds = %bb.d
  %i.q = tail call ptr @_mi_page_malloc_zero(ptr noundef nonnull %i.b, ptr noundef nonnull %i.j, i64 noundef %0, i1 noundef zeroext false) #10
  br label %mi_theap_malloc_aligned_at.exit

.thread.i.i:                                      ; preds = %bb.d, %bb.c, %bb.b
  %i.r = tail call fastcc ptr @mi_theap_malloc_zero_aligned_at_generic(ptr noundef %i.b, i64 noundef %0, i64 noundef %1, i64 noundef %2, i1 noundef zeroext false, ptr noundef null) #11
  br label %mi_theap_malloc_aligned_at.exit

mi_theap_malloc_aligned_at.exit:                  ; preds = %mi_alignment_is_valid.exit.thread.i.i, %bb.e, %.thread.i.i
  %.3.i.i = phi ptr [ null, %mi_alignment_is_valid.exit.thread.i.i ], [ %i.r, %.thread.i.i ], [ %i.q, %bb.e ]
  ret ptr %.3.i.i
}
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.n = ptrtoint ptr %i.l to i64
  %i.o = and i64 %i.m, %i.n
  %.not40.i.i.i = icmp eq i64 %i.o, 0
  br i1 %.not40.i.i.i, label %bb.e, label %.thread.i.i.i, !prof !9

bb.e:                                             ; preds = %bb.d
  %i.p = tail call ptr @_mi_page_malloc_zero(ptr noundef nonnull %i.b, ptr noundef nonnull %i.j, i64 noundef %0, i1 noundef zeroext false) #10
  br label %mi_theap_malloc_aligned.exit

.thread.i.i.i:                                    ; preds = %bb.d, %bb.c, %bb.b
  %i.q = tail call fastcc ptr @mi_theap_malloc_zero_aligned_at_generic(ptr noundef %i.b, i64 noundef %0, i64 noundef %1, i64 noundef 0, i1 noundef zeroext false, ptr noundef null) #11
  br label %mi_theap_malloc_aligned.exit

mi_theap_malloc_aligned.exit:                     ; preds = %mi_alignment_is_valid.exit.thread.i.i.i, %bb.e, %.thread.i.i.i
  %.3.i.i.i = phi ptr [ null, %mi_alignment_is_valid.exit.thread.i.i.i ], [ %i.q, %.thread.i.i.i ], [ %i.p, %bb.e ]
  ret ptr %.3.i.i.i
}
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.i = lshr i64 %i.h, 3
  %i.j = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %i.i
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.q = tail call ptr @_mi_page_malloc_zero(ptr noundef nonnull %i.c, ptr noundef nonnull %i.k, i64 noundef %0, i1 noundef zeroext false) #10
  br label %mi_theap_malloc_zero_aligned_at.exit

.thread.i:                                        ; preds = %bb.d, %bb.c, %bb.b
  %i.r = call fastcc ptr @mi_theap_malloc_zero_aligned_at_generic(ptr noundef %i.c, i64 noundef %0, i64 noundef %1, i64 noundef 0, i1 noundef zeroext false, ptr noundef nonnull %i.a) #11
  br label %mi_theap_malloc_zero_aligned_at.exit

mi_theap_malloc_zero_aligned_at.exit:             ; preds = %bb.e, %.thread.i
  %.3.i = phi ptr [ %i.q, %bb.e ], [ %i.r, %.thread.i ] ; 3 uses
  %i.s = icmp ne ptr %.3.i, null
...
bb.f:                                             ; preds = %mi_theap_malloc_zero_aligned_at.exit
  ...
  %.val = load i64, ptr %i.v, align 8, !tbaa !24
...
bb.e:                                             ; preds = %bb.d
  %i.q = tail call ptr @_mi_page_malloc_zero(ptr noundef nonnull %i.b, ptr noundef nonnull %i.j, i64 noundef %0, i1 noundef zeroext true) #10
  br label %mi_theap_zalloc_aligned_at.exit

.thread.i.i:                                      ; preds = %bb.d, %bb.c, %bb.b
  %i.r = tail call fastcc ptr @mi_theap_malloc_zero_aligned_at_generic(ptr noundef %i.b, i64 noundef %0, i64 noundef %1, i64 noundef %2, i1 noundef zeroext true, ptr noundef null) #11
  br label %mi_theap_zalloc_aligned_at.exit
...
bb.e:                                             ; preds = %bb.d
  %i.p = tail call ptr @_mi_page_malloc_zero(ptr noundef nonnull %i.b, ptr noundef nonnull %i.j, i64 noundef %0, i1 noundef zeroext true) #10
  br label %mi_theap_zalloc_aligned.exit

.thread.i.i.i:                                    ; preds = %bb.d, %bb.c, %bb.b
  %i.q = tail call fastcc ptr @mi_theap_malloc_zero_aligned_at_generic(ptr noundef %i.b, i64 noundef %0, i64 noundef %1, i64 noundef 0, i1 noundef zeroext true, ptr noundef null) #11
  br label %mi_theap_zalloc_aligned.exit
...
bb.e:                                             ; preds = %bb.d
  store ptr %i.k, ptr %i.a, align 8, !tbaa !12
  %i.q = tail call ptr @_mi_page_malloc_zero(ptr noundef nonnull %i.c, ptr noundef nonnull %i.k, i64 noundef %0, i1 noundef zeroext true) #10
  br label %mi_theap_malloc_zero_aligned_at.exit

.thread.i:                                        ; preds = %bb.d, %bb.c, %bb.b
  %i.r = call fastcc ptr @mi_theap_malloc_zero_aligned_at_generic(ptr noundef %i.c, i64 noundef %0, i64 noundef %1, i64 noundef 0, i1 noundef zeroext true, ptr noundef nonnull %i.a) #11
  br label %mi_theap_malloc_zero_aligned_at.exit
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.r = add i64 %3, %i.q
  %i.s = and i64 %i.r, %i.p
  %.not40.i.i.i = icmp eq i64 %i.s, 0
  br i1 %.not40.i.i.i, label %bb.g, label %.thread.i.i.i, !prof !9

bb.g:                                             ; preds = %bb.f
  %i.t = tail call ptr @_mi_page_malloc_zero(ptr noundef nonnull %i.b, ptr noundef nonnull %i.m, i64 noundef %storemerge.i.ph.i, i1 noundef zeroext true) #10
  br label %mi_theap_calloc_aligned_at.exit

.thread.i.i.i:                                    ; preds = %bb.f, %bb.e, %bb.d
  %i.u = tail call fastcc ptr @mi_theap_malloc_zero_aligned_at_generic(ptr noundef %i.b, i64 noundef %storemerge.i.ph.i, i64 noundef %2, i64 noundef %3, i1 noundef zeroext true, ptr noundef null) #11
  br label %mi_theap_calloc_aligned_at.exit

mi_theap_calloc_aligned_at.exit:                  ; preds = %bb.b, %mi_alignment_is_valid.exit.thread.i.i.i, %bb.g, %.thread.i.i.i
  %.0.i = phi ptr [ null, %bb.b ], [ null, %mi_alignment_is_valid.exit.thread.i.i.i ], [ %i.u, %.thread.i.i.i ], [ %i.t, %bb.g ]
  ret ptr %.0.i
}
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.q = ptrtoint ptr %i.o to i64
  %i.r = and i64 %i.p, %i.q
  %.not40.i.i.i.i = icmp eq i64 %i.r, 0
  br i1 %.not40.i.i.i.i, label %bb.g, label %.thread.i.i.i.i, !prof !9

bb.g:                                             ; preds = %bb.f
  %i.s = tail call ptr @_mi_page_malloc_zero(ptr noundef nonnull %i.b, ptr noundef nonnull %i.m, i64 noundef %storemerge.i.ph.i.i, i1 noundef zeroext true) #10
  br label %mi_theap_calloc_aligned.exit

.thread.i.i.i.i:                                  ; preds = %bb.f, %bb.e, %bb.d
  %i.t = tail call fastcc ptr @mi_theap_malloc_zero_aligned_at_generic(ptr noundef %i.b, i64 noundef %storemerge.i.ph.i.i, i64 noundef %2, i64 noundef 0, i1 noundef zeroext true, ptr noundef null) #11
  br label %mi_theap_calloc_aligned.exit

mi_theap_calloc_aligned.exit:                     ; preds = %bb.b, %mi_alignment_is_valid.exit.thread.i.i.i.i, %bb.g, %.thread.i.i.i.i
  %.0.i.i = phi ptr [ null, %bb.b ], [ null, %mi_alignment_is_valid.exit.thread.i.i.i.i ], [ %i.t, %.thread.i.i.i.i ], [ %i.s, %bb.g ]
  ret ptr %.0.i.i
}
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.l = lshr i64 %i.k, 3
  %i.m = getelementptr inbounds nuw [8 x i8], ptr %.0.i, i64 %i.l
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.s = add i64 %3, %i.r
  %i.t = and i64 %i.s, %i.q
  %.not40.i.i = icmp eq i64 %i.t, 0
  br i1 %.not40.i.i, label %bb.f, label %.thread.i.i, !prof !9

bb.f:                                             ; preds = %bb.e
  %i.u = tail call ptr @_mi_page_malloc_zero(ptr noundef nonnull %.0.i, ptr noundef nonnull %i.n, i64 noundef %1, i1 noundef zeroext false) #10
  br label %mi_theap_malloc_aligned_at.exit

.thread.i.i:                                      ; preds = %bb.e, %bb.d, %bb.c
  %i.v = tail call fastcc ptr @mi_theap_malloc_zero_aligned_at_generic(ptr noundef %.0.i, i64 noundef %1, i64 noundef %2, i64 noundef %3, i1 noundef zeroext false, ptr noundef null) #11
  br label %mi_theap_malloc_aligned_at.exit

mi_theap_malloc_aligned_at.exit:                  ; preds = %mi_alignment_is_valid.exit.thread.i.i, %bb.f, %.thread.i.i
  %.3.i.i = phi ptr [ null, %mi_alignment_is_valid.exit.thread.i.i ], [ %i.v, %.thread.i.i ], [ %i.u, %bb.f ]
  ret ptr %.3.i.i
}
...
bb.f:                                             ; preds = %bb.e
  %i.t = tail call ptr @_mi_page_malloc_zero(ptr noundef nonnull %.0.i, ptr noundef nonnull %i.n, i64 noundef %1, i1 noundef zeroext false) #10
  br label %mi_theap_malloc_aligned.exit

.thread.i.i.i:                                    ; preds = %bb.e, %bb.d, %bb.c
  %i.u = tail call fastcc ptr @mi_theap_malloc_zero_aligned_at_generic(ptr noundef %.0.i, i64 noundef %1, i64 noundef %2, i64 noundef 0, i1 noundef zeroext false, ptr noundef null) #11
  br label %mi_theap_malloc_aligned.exit

mi_theap_malloc_aligned.exit:                     ; preds = %mi_alignment_is_valid.exit.thread.i.i.i, %bb.f, %.thread.i.i.i
  %.3.i.i.i = phi ptr [ null, %mi_alignment_is_valid.exit.thread.i.i.i ], [ %i.u, %.thread.i.i.i ], [ %i.t, %bb.f ]
  ret ptr %.3.i.i.i
}
...
bb.f:                                             ; preds = %bb.e
  %i.u = tail call ptr @_mi_page_malloc_zero(ptr noundef nonnull %.0.i, ptr noundef nonnull %i.n, i64 noundef %1, i1 noundef zeroext true) #10
  br label %mi_theap_zalloc_aligned_at.exit

.thread.i.i:                                      ; preds = %bb.e, %bb.d, %bb.c
  %i.v = tail call fastcc ptr @mi_theap_malloc_zero_aligned_at_generic(ptr noundef %.0.i, i64 noundef %1, i64 noundef %2, i64 noundef %3, i1 noundef zeroext true, ptr noundef null) #11
  br label %mi_theap_zalloc_aligned_at.exit
...
bb.f:                                             ; preds = %bb.e
  %i.t = tail call ptr @_mi_page_malloc_zero(ptr noundef nonnull %.0.i, ptr noundef nonnull %i.n, i64 noundef %1, i1 noundef zeroext true) #10
  br label %mi_theap_zalloc_aligned.exit

.thread.i.i.i:                                    ; preds = %bb.e, %bb.d, %bb.c
  %i.u = tail call fastcc ptr @mi_theap_malloc_zero_aligned_at_generic(ptr noundef %.0.i, i64 noundef %1, i64 noundef %2, i64 noundef 0, i1 noundef zeroext true, ptr noundef null) #11
  br label %mi_theap_zalloc_aligned.exit
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.v = add i64 %4, %i.u
  %i.w = and i64 %i.v, %i.t
  %.not40.i.i.i = icmp eq i64 %i.w, 0
  br i1 %.not40.i.i.i, label %bb.h, label %.thread.i.i.i, !prof !9

bb.h:                                             ; preds = %bb.g
  %i.x = tail call ptr @_mi_page_malloc_zero(ptr noundef nonnull %.0.i, ptr noundef nonnull %i.q, i64 noundef %storemerge.i.ph.i, i1 noundef zeroext true) #10
  br label %mi_theap_calloc_aligned_at.exit

.thread.i.i.i:                                    ; preds = %bb.g, %bb.f, %bb.e
  %i.y = tail call fastcc ptr @mi_theap_malloc_zero_aligned_at_generic(ptr noundef %.0.i, i64 noundef %storemerge.i.ph.i, i64 noundef %3, i64 noundef %4, i1 noundef zeroext true, ptr noundef null) #11
  br label %mi_theap_calloc_aligned_at.exit

mi_theap_calloc_aligned_at.exit:                  ; preds = %bb.c, %mi_alignment_is_valid.exit.thread.i.i.i, %bb.h, %.thread.i.i.i
  %.0.i4 = phi ptr [ null, %bb.c ], [ null, %mi_alignment_is_valid.exit.thread.i.i.i ], [ %i.y, %.thread.i.i.i ], [ %i.x, %bb.h ]
  ret ptr %.0.i4
}
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.u = ptrtoint ptr %i.s to i64
  %i.v = and i64 %i.t, %i.u
  %.not40.i.i.i.i = icmp eq i64 %i.v, 0
  br i1 %.not40.i.i.i.i, label %bb.h, label %.thread.i.i.i.i, !prof !9

bb.h:                                             ; preds = %bb.g
  %i.w = tail call ptr @_mi_page_malloc_zero(ptr noundef nonnull %.0.i, ptr noundef nonnull %i.q, i64 noundef %storemerge.i.ph.i.i, i1 noundef zeroext true) #10
  br label %mi_theap_calloc_aligned.exit

.thread.i.i.i.i:                                  ; preds = %bb.g, %bb.f, %bb.e
  %i.x = tail call fastcc ptr @mi_theap_malloc_zero_aligned_at_generic(ptr noundef %.0.i, i64 noundef %storemerge.i.ph.i.i, i64 noundef %3, i64 noundef 0, i1 noundef zeroext true, ptr noundef null) #11
  br label %mi_theap_calloc_aligned.exit

mi_theap_calloc_aligned.exit:                     ; preds = %bb.c, %mi_alignment_is_valid.exit.thread.i.i.i.i, %bb.h, %.thread.i.i.i.i
  %.0.i.i = phi ptr [ null, %bb.c ], [ null, %mi_alignment_is_valid.exit.thread.i.i.i.i ], [ %i.x, %.thread.i.i.i.i ], [ %i.w, %bb.h ]
  ret ptr %.0.i.i
}
...
begin_hunk_1_@mi_heap_recalloc_aligned:bb.a
  %i.l = tail call fastcc ptr @mi_theap_realloc_zero_aligned_at(ptr noundef %.0.i, ptr noundef %1, i64 noundef %storemerge.i.ph.i, i64 noundef %4, i64 noundef 0, i1 noundef zeroext true) #11
  br label %mi_theap_recalloc_aligned.exit
...
bb.i:                                             ; preds = %bb.h
  %i.u = load ptr, ptr %i.a, align 8, !tbaa !12   ; 2 uses
  %i.v = getelementptr inbounds nuw i8, ptr %i.u, i64 8
  %i.w = atomicrmw or ptr %i.v, i64 2 monotonic, align 8 ; 0 uses
  %i.x = add i64 %i.r, %1
  call void @_mi_padding_shrink(ptr noundef %i.u, ptr noundef nonnull %.0, i64 noundef %i.x) #10
  br label %bb.j
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.r = add i64 %4, %i.q
  %i.s = and i64 %i.r, %i.p
  %.not40.i = icmp eq i64 %i.s, 0
  br i1 %.not40.i, label %bb.h, label %.thread.i, !prof !9

bb.h:                                             ; preds = %bb.g
  %i.t = tail call ptr @_mi_page_malloc_zero(ptr noundef nonnull %0, ptr noundef nonnull %i.m, i64 noundef %2, i1 noundef zeroext %5) #10
  br label %mi_theap_malloc_zero_aligned_at.exit

.thread.i:                                        ; preds = %bb.g, %bb.f, %bb.e
  %i.u = tail call fastcc ptr @mi_theap_malloc_zero_aligned_at_generic(ptr noundef %0, i64 noundef %2, i64 noundef %3, i64 noundef %4, i1 noundef zeroext %5, ptr noundef null) #11
  br label %mi_theap_malloc_zero_aligned_at.exit

bb.i:                                             ; preds = %bb.d
  %i.v = tail call i64 @mi_usable_size(ptr noundef nonnull %1) #10 ; 4 uses
  %.not = icmp ugt i64 %2, %i.v
  br i1 %.not, label %bb.l, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.w = lshr i64 %i.v, 1
  %i.x = sub nuw i64 %i.v, %i.w
  %.not57 = icmp ult i64 %2, %i.x
...
bb.k:                                             ; preds = %bb.j
  ...
  br i1 %i.ac, label %mi_theap_malloc_zero_aligned_at.exit, label %bb.l
...
bb.l:                                             ; preds = %bb.i, %bb.j, %bb.k
  ...
  br i1 %i.af, label %bb.m, label %.thread.i64, !prof !9
...
bb.m:                                             ; preds = %bb.l
  ...
  %.not.i65 = icmp eq ptr %i.al, null
  br i1 %.not.i65, label %.thread.i64, label %bb.n, !prof !22

bb.n:                                             ; preds = %bb.m
  %i.am = add nsw i64 %3, -1
  %i.an = ptrtoint ptr %i.al to i64
  %i.ao = add i64 %4, %i.an
  %i.ap = and i64 %i.ao, %i.am
  %.not40.i66 = icmp eq i64 %i.ap, 0
  br i1 %.not40.i66, label %bb.o, label %.thread.i64, !prof !9

bb.o:                                             ; preds = %bb.n
  store ptr %i.aj, ptr %i.a, align 8, !tbaa !12
  %i.aq = tail call ptr @_mi_page_malloc_zero(ptr noundef nonnull %0, ptr noundef nonnull %i.aj, i64 noundef %2, i1 noundef zeroext false) #10
  br label %mi_theap_malloc_zero_aligned_at.exit67

.thread.i64:                                      ; preds = %bb.n, %bb.m, %bb.l
  %i.ar = call fastcc ptr @mi_theap_malloc_zero_aligned_at_generic(ptr noundef %0, i64 noundef %2, i64 noundef %3, i64 noundef %4, i1 noundef zeroext false, ptr noundef nonnull %i.a) #11
  br label %mi_theap_malloc_zero_aligned_at.exit67

mi_theap_malloc_zero_aligned_at.exit67:           ; preds = %bb.o, %.thread.i64
  %.3.i63 = phi ptr [ %i.aq, %bb.o ], [ %i.ar, %.thread.i64 ] ; 6 uses
  %.not58 = icmp eq ptr %.3.i63, null
  br i1 %.not58, label %bb.v, label %bb.p

bb.p:                                             ; preds = %mi_theap_malloc_zero_aligned_at.exit67
  %i.as = call i64 @llvm.umin.i64(i64 %2, i64 %i.v) ; 4 uses
  %i.at = call i64 @llvm.usub.sat.i64(i64 %i.as, i64 8) ; 3 uses
  %i.au = load ptr, ptr %i.a, align 8, !tbaa !12
  %i.av = call i64 @_mi_page_usable_size(ptr noundef %i.au, ptr noundef nonnull %.3.i63) #10 ; 2 uses
  %i.aw = icmp ugt i64 %i.av, %i.at
  %or.cond59 = select i1 %5, i1 %i.aw, i1 false
  br i1 %or.cond59, label %bb.q, label %_mi_memzero.exit

bb.q:                                             ; preds = %bb.p
  %i.ax = getelementptr inbounds nuw i8, ptr %.3.i63, i64 %i.at ; 2 uses
  %i.ay = sub nuw i64 %i.av, %i.at                ; 3 uses
  %i.az = load i64, ptr @_mi_cpu_stosb_max, align 8, !tbaa !25
  %.not.i.i = icmp ugt i64 %i.ay, %i.az
  br i1 %.not.i.i, label %bb.s, label %bb.r, !prof !22

bb.r:                                             ; preds = %bb.q
  %i.ba = call { ptr, i64 } asm sideeffect "rep stosb", "={di},={cx},{ax},0,1,~{memory},~{dirflag},~{fpsr},~{flags}"(i8 0, ptr nonnull %i.ax, i64 %i.ay) #12, !srcloc !26 ; 0 uses
  br label %_mi_memzero.exit

bb.s:                                             ; preds = %bb.q
  call void @llvm.memset.p0.i64(ptr nonnull align 1 %i.ax, i8 0, i64 %i.ay, i1 false)
  br label %_mi_memzero.exit

_mi_memzero.exit:                                 ; preds = %bb.s, %bb.r, %bb.p
  %i.bb = load i64, ptr @_mi_cpu_movsb_max, align 8, !tbaa !25
  %.not.i68 = icmp ugt i64 %i.as, %i.bb
  br i1 %.not.i68, label %bb.u, label %bb.t, !prof !22

bb.t:                                             ; preds = %_mi_memzero.exit
  %i.bc = call { ptr, i64, ptr } asm sideeffect "rep movsb", "={di},={cx},={si},0,1,2,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr nonnull %.3.i63, i64 %i.as, ptr nonnull %1) #12, !srcloc !27 ; 0 uses
  br label %_mi_memcpy.exit

bb.u:                                             ; preds = %_mi_memzero.exit
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %.3.i63, ptr nonnull align 1 %1, i64 %i.as, i1 false)
  br label %_mi_memcpy.exit
...
mi_theap_malloc_zero_aligned_at.exit:             ; preds = %.thread.i, %bb.h, %bb.v, %bb.k, %bb.c, %mi_alignment_is_valid.exit.thread
  %.1 = phi ptr [ null, %mi_alignment_is_valid.exit.thread ], [ %i.e, %bb.c ], [ %1, %bb.k ], [ %.3.i63, %bb.v ], [ %i.t, %bb.h ], [ %i.u, %.thread.i ]
  ret ptr %.1
}
...
!19 = !{!"mi_memid_s", !4, i64 0, !5, i64 16, !16, i64 20, !16, i64 21, !16, i64 22}
!20 = !{!"mi_page_s", !4, i64 0, !4, i64 8, !13, i64 16, !14, i64 24, !13, i64 32, !14, i64 40, !14, i64 48, !15, i64 56, !15, i64 58, !15, i64 60, !4, i64 62, !16, i64 63, !4, i64 64, !17, i64 72, !18, i64 80, !11, i64 88, !11, i64 96, !19, i64 104}
!21 = !{!20, !13, i64 16}
