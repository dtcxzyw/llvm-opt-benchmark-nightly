...
bb.ag:                                            ; preds = %bb.af, %bb.ae
  ...
  %i.bt = load ptr, ptr %i.bs, align 8, !tbaa !35 ; 3 uses
  %i.bu = icmp eq ptr %i.bt, null
  br i1 %i.bu, label %mi_outs.exit, label %bb.ah

bb.ah:                                            ; preds = %bb.ag
  %i.bv = load i8, ptr %i.bt, align 1, !tbaa !10  ; 2 uses
...
.lr.ph.i:                                         ; preds = %bb.ah, %.lr.ph.i
  ...
  store i8 %i.bw, ptr %.012.i, align 1, !tbaa !10
  %i.bz = load i8, ptr %i.bx, align 1, !tbaa !10  ; 2 uses
  %i.ca = icmp ne i8 %i.bz, 0
  %i.cb = icmp ult ptr %i.by, %i.g
  %i.cc = select i1 %i.ca, i1 %i.cb, i1 false
  br i1 %i.cc, label %.lr.ph.i, label %mi_outs.exit, !llvm.loop !25

bb.ai:                                            ; preds = %bb.ac
  %i.cd = icmp eq i8 %.6229, 112                  ; 2 uses
  %i.ce = icmp eq i8 %.6229, 120
  switch i8 %.6229, label %bb.di [
    i8 120, label %bb.aj
    i8 117, label %bb.aj
    i8 112, label %bb.be
    i8 105, label %bb.by
...
bb.ar:                                            ; preds = %bb.aq, %bb.ap
  ...
  %i.cy = load i64, ptr %i.cx, align 8, !tbaa !15
  br label %bb.bh
...
.lr.ph.i289:                                      ; preds = %bb.bg, %bb.bf
  ...
  %i.eh = load ptr, ptr %i.eg, align 8, !tbaa !38
  %i.ei = getelementptr inbounds nuw i8, ptr %.0342378, i64 1 ; 3 uses
  store i8 48, ptr %.0342378, align 1, !tbaa !10
...
.lr.ph.i289.1:                                    ; preds = %.lr.ph.i289
  ...
  store i8 120, ptr %i.ei, align 1, !tbaa !10
  br label %mi_outs.exit292

mi_outs.exit292:                                  ; preds = %.lr.ph.i289.1, %.lr.ph.i289
  %.lcssa465 = phi ptr [ %i.ei, %.lr.ph.i289 ], [ %i.ek, %.lr.ph.i289.1 ]
...
bb.bh:                                            ; preds = %mi_outs.exit292, %bb.an, %bb.av, %bb.bd, %bb.az, %bb.ar
  %.1343 = phi ptr [ %.0342378, %bb.bd ], [ %.0342378, %bb.an ], [ %.0342378, %bb.ar ], [ %.0342378, %bb.av ], [ %.0342378, %bb.az ], [ %.lcssa465, %mi_outs.exit292 ] ; 15 uses
  %.4 = phi i64 [ %.3, %bb.bd ], [ %.3, %bb.an ], [ %.3, %bb.ar ], [ %.3, %bb.av ], [ %.3, %bb.az ], [ %i.em, %mi_outs.exit292 ] ; 2 uses
  %.0210 = phi i64 [ %i.dx, %bb.bd ], [ %i.cq, %bb.an ], [ %i.cy, %bb.ar ], [ %i.dg, %bb.av ], [ %i.do, %bb.az ], [ %i.el, %mi_outs.exit292 ] ; 4 uses
  %i.en = icmp eq i64 %.4, 0
  br i1 %i.en, label %bb.bi, label %bb.bk

bb.bi:                                            ; preds = %bb.bh
  switch i8 %.6229, label %bb.bk [
    i8 120, label %bb.bj
    i8 112, label %bb.bj
  ]

bb.bj:                                            ; preds = %bb.bi, %bb.bi
  %i.eo = icmp ult i64 %.0210, 4294967296
  %i.ep = icmp ult i64 %.0210, 281474976710656
...
bb.bk:                                            ; preds = %bb.bj, %bb.bi, %bb.bh
  %.1219 = phi i8 [ %.0218, %bb.bh ], [ %spec.select274, %bb.bj ], [ %.0218, %bb.bi ] ; 4 uses
  %.6 = phi i64 [ %.4, %bb.bh ], [ %spec.store.select, %bb.bj ], [ 0, %bb.bi ] ; 4 uses
  %i.es = or i1 %i.ce, %i.cd
  %i.et = select i1 %i.es, i64 16, i64 10         ; 3 uses
  %i.eu = icmp eq i64 %.0210, 0
  br i1 %i.eu, label %4, label %bb.bo

4:                                                ; preds = %bb.bk
  %.not35.i = icmp eq i8 %.0214, 0
  br i1 %.not35.i, label %mi_outc.exit.i, label %bb.bl

bb.bl:                                            ; preds = %4
  %.not.i.i = icmp ult ptr %.1343, %i.g
  br i1 %.not.i.i, label %bb.bm, label %mi_outs.exit

bb.bm:                                            ; preds = %bb.bl
  store i8 %.0214, ptr %.1343, align 1, !tbaa !10
  %i.ev = getelementptr inbounds nuw i8, ptr %.1343, i64 1
  br label %mi_outc.exit.i

mi_outc.exit.i:                                   ; preds = %bb.bm, %4
  %.18 = phi ptr [ %.1343, %4 ], [ %i.ev, %bb.bm ] ; 4 uses
...
bb.bp:                                            ; preds = %bb.bp, %bb.bo
  ...
  %.03042.i = phi i64 [ %.0210, %bb.bo ], [ %i.fe, %bb.bp ] ; 3 uses
  %i.ex = urem i64 %.03042.i, %i.et               ; 2 uses
  ...
  store i8 %i.fc, ptr %i.fd, align 1, !tbaa !10
  %i.fe = udiv i64 %.03042.i, %i.et
  %i.ff = icmp ule i64 %i.et, %.03042.i
  %i.fg = icmp samesign ult i64 %indvars.iv.i, 159
  %i.fh = select i1 %i.ff, i1 %i.fg, i1 false
  %indvars.iv.next48.i = add nuw nsw i64 %indvars.iv47.i, 1
  br i1 %i.fh, label %bb.bp, label %bb.bq, !llvm.loop !26

bb.bq:                                            ; preds = %bb.bp
  %i.fi = icmp samesign ugt i64 %indvars.iv.i, 158
  br i1 %i.fi, label %.loopexit.i, label %5

5:                                                ; preds = %bb.bq
  %.not.i293 = icmp eq i8 %.0214, 0
  br i1 %.not.i293, label %mi_outc.exit39.i, label %bb.br

bb.br:                                            ; preds = %5
  %.not.i38.i = icmp ult ptr %.1343, %i.g
  br i1 %.not.i38.i, label %bb.bs, label %.loopexit.i
...
mi_outc.exit39.i:                                 ; preds = %bb.bs, %5
  %.14.a = phi ptr [ %.1343, %5 ], [ %i.fj, %bb.bs ] ; 6 uses
  %i.fk = icmp ult ptr %.14.a, %i.g
...
mi_outc.exit39.split.i.prol:                      ; preds = %mi_outc.exit39.split.i.preheader, %mi_outc.exit41.i.prol
  %.16.prol = phi ptr [ %.17.prol, %mi_outc.exit41.i.prol ], [ %.14.a, %mi_outc.exit39.split.i.preheader ]
  %i.fl = phi ptr [ %i.fp, %mi_outc.exit41.i.prol ], [ %.14.a, %mi_outc.exit39.split.i.preheader ] ; 4 uses
...
mi_outc.exit41.i.prol:                            ; preds = %bb.bt, %mi_outc.exit39.split.i.prol
  ...
  br i1 %prol.iter469.cmp.not, label %mi_outc.exit39.split.i.prol.loopexit, label %mi_outc.exit39.split.i.prol, !llvm.loop !27

mi_outc.exit39.split.i.prol.loopexit:             ; preds = %mi_outc.exit41.i.prol, %mi_outc.exit39.split.i.preheader
  %.16.unr = phi ptr [ %.14.a, %mi_outc.exit39.split.i.preheader ], [ %.17.prol, %mi_outc.exit41.i.prol ]
  %.unr470 = phi ptr [ %.14.a, %mi_outc.exit39.split.i.preheader ], [ %i.fp, %mi_outc.exit41.i.prol ]
...
mi_outc.exit39.split.i:                           ; preds = %mi_outc.exit39.split.i.prol.loopexit, %mi_outc.exit41.i.3
  ...
  %i.fr = phi ptr [ %i.gk, %mi_outc.exit41.i.3 ], [ %.unr470, %mi_outc.exit39.split.i.prol.loopexit ] ; 4 uses
...
bb.bu:                                            ; preds = %mi_outc.exit39.split.i
  ...
  store i8 %i.fu, ptr %i.fr, align 1, !tbaa !10
...
bb.bv:                                            ; preds = %mi_outc.exit41.i
  ...
  store i8 %i.fz, ptr %i.fw, align 1, !tbaa !10
...
bb.bw:                                            ; preds = %mi_outc.exit41.i.1
  ...
  store i8 %i.ge, ptr %i.gb, align 1, !tbaa !10
...
mi_outc.exit41.i.3:                               ; preds = %bb.bx, %mi_outc.exit41.i.2
  ...
  br i1 %i.gl, label %mi_outc.exit39.split.i, label %.loopexit.i, !llvm.loop !28

.loopexit.i:                                      ; preds = %mi_outc.exit39.split.i.prol.loopexit, %mi_outc.exit41.i.3, %mi_outc.exit39.i, %bb.br, %bb.bq
  %.14 = phi ptr [ %.1343, %bb.bq ], [ %.1343, %bb.br ], [ %.14.a, %mi_outc.exit39.i ], [ %.17.lcssa.unr, %mi_outc.exit39.split.i.prol.loopexit ], [ %.17.3, %mi_outc.exit41.i.3 ]
...
bb.cc:                                            ; preds = %bb.cb, %bb.ca
  ...
  %i.gx = load i64, ptr %i.gw, align 8, !tbaa !15
  br label %bb.ct
...
bb.ck:                                            ; preds = %bb.cj, %bb.ci
  ...
  %i.hn = load i64, ptr %i.hm, align 8, !tbaa !37
  br label %bb.ct
...
bb.co:                                            ; preds = %bb.cn, %bb.cm
  ...
  %i.hv = load i64, ptr %i.hu, align 8, !tbaa !15
  br label %bb.ct
...
mi_outc.exit.i314:                                ; preds = %bb.cw, %bb.cv
  %.24 = phi ptr [ %.0342378, %bb.cv ], [ %i.ii, %bb.cw ] ; 4 uses
...
mi_outc.exit39.i303:                              ; preds = %bb.dc, %bb.db
  %.20.a = phi ptr [ %.0342378, %bb.db ], [ %i.it, %bb.dc ] ; 6 uses
  %i.iu = icmp ult ptr %.20.a, %i.g
...
mi_outc.exit39.split.i305.prol:                   ; preds = %mi_outc.exit39.split.i305.preheader, %mi_outc.exit41.i309.prol
  %.22.prol = phi ptr [ %.23.prol, %mi_outc.exit41.i309.prol ], [ %.20.a, %mi_outc.exit39.split.i305.preheader ]
  %i.iv = phi ptr [ %i.iz, %mi_outc.exit41.i309.prol ], [ %.20.a, %mi_outc.exit39.split.i305.preheader ] ; 4 uses
...
mi_outc.exit39.split.i305.prol.loopexit:          ; preds = %mi_outc.exit41.i309.prol, %mi_outc.exit39.split.i305.preheader
  %.22.unr = phi ptr [ %.20.a, %mi_outc.exit39.split.i305.preheader ], [ %.23.prol, %mi_outc.exit41.i309.prol ]
  %.unr = phi ptr [ %.20.a, %mi_outc.exit39.split.i305.preheader ], [ %i.iz, %mi_outc.exit41.i309.prol ]
...
.loopexit.i304:                                   ; preds = %mi_outc.exit39.split.i305.prol.loopexit, %mi_outc.exit41.i309.3, %mi_outc.exit39.i303, %bb.da
  %.21 = phi ptr [ %.0342378, %bb.da ], [ %.20.a, %mi_outc.exit39.i303 ], [ %.23.lcssa.unr, %mi_outc.exit39.split.i305.prol.loopexit ], [ %.23.3, %mi_outc.exit41.i309.3 ]
...
mi_outs.exit:                                     ; preds = %.lr.ph.i, %bb.dj, %mi_outc.exit318, %.loopexit.i304, %bb.cx, %mi_outc.exit.i314, %.loopexit.i, %bb.bn, %mi_outc.exit.i, %bb.bl, %bb.ag, %bb.ah, %bb.di, %mi_outc.exit286
  %.2342 = phi ptr [ %.21, %.loopexit.i304 ], [ %.0342378, %bb.di ], [ %i.jx, %mi_outc.exit318 ], [ %.14, %.loopexit.i ], [ %i.bj, %mi_outc.exit286 ], [ %.0342378, %bb.ag ], [ %.0342378, %bb.ah ], [ %i.ew, %bb.bn ], [ %.18, %mi_outc.exit.i ], [ %.1343, %bb.bl ], [ %i.ij, %bb.cx ], [ %.24, %mi_outc.exit.i314 ], [ %i.jy, %bb.dj ], [ %i.by, %.lr.ph.i ]
  %.2220 = phi i8 [ %.0218, %.loopexit.i304 ], [ %.0218, %bb.di ], [ %.0218, %mi_outc.exit318 ], [ %.1219, %.loopexit.i ], [ %.0218, %mi_outc.exit286 ], [ %.0218, %bb.ag ], [ %.0218, %bb.ah ], [ %.1219, %bb.bn ], [ %.1219, %mi_outc.exit.i ], [ %.1219, %bb.bl ], [ %.0218, %bb.cx ], [ %.0218, %mi_outc.exit.i314 ], [ %.0218, %bb.dj ], [ %.0218, %.lr.ph.i ] ; 2 uses
  %.7 = phi i64 [ %.3, %.loopexit.i304 ], [ %.3, %bb.di ], [ %.3, %mi_outc.exit318 ], [ %.6, %.loopexit.i ], [ %.3, %mi_outc.exit286 ], [ %.3, %bb.ag ], [ %.3, %bb.ah ], [ %.6, %bb.bn ], [ %.6, %mi_outc.exit.i ], [ %.6, %bb.bl ], [ %.3, %bb.cx ], [ %.3, %mi_outc.exit.i314 ], [ %.3, %bb.dj ], [ %.3, %.lr.ph.i ] ; 7 uses
  %.1212 = phi ptr [ %.0342378, %.loopexit.i304 ], [ %.0342378, %bb.di ], [ %.0342378, %mi_outc.exit318 ], [ %.1343, %.loopexit.i ], [ %.0342378, %mi_outc.exit286 ], [ %.0342378, %bb.ag ], [ %.0342378, %bb.ah ], [ %.1343, %bb.bn ], [ %.1343, %mi_outc.exit.i ], [ %.1343, %bb.bl ], [ %.0342378, %bb.cx ], [ %.0342378, %mi_outc.exit.i314 ], [ %.0342378, %bb.dj ], [ %.0342378, %.lr.ph.i ] ; 10 uses
  %.fr.i = freeze ptr %.2342                      ; 7 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.kr = getelementptr inbounds nuw i8, ptr %.1212, i64 %i.kq ; 2 uses
  %i.ks = getelementptr inbounds i8, ptr %i.kr, i64 -15
  %i.kt = getelementptr inbounds i8, ptr %i.kr, i64 -31
  %wide.load = load <16 x i8>, ptr %i.ks, align 1, !tbaa !10
  %wide.load454 = load <16 x i8>, ptr %i.kt, align 1, !tbaa !10
  %i.ku = sub i64 %.7, %i.kp
  %i.kv = getelementptr inbounds nuw i8, ptr %.1212, i64 %i.ku ; 2 uses
  %i.kw = getelementptr inbounds i8, ptr %i.kv, i64 -15
  %i.kx = getelementptr inbounds i8, ptr %i.kv, i64 -31
  store <16 x i8> %wide.load, ptr %i.kw, align 1, !tbaa !10
  store <16 x i8> %wide.load454, ptr %i.kx, align 1, !tbaa !10
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.ky = icmp eq i64 %index.next, %n.vec
  br i1 %i.ky, label %middle.block, label %vector.body, !llvm.loop !30
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load457 = load <8 x i8>, ptr %i.ld, align 1, !tbaa !10
  %i.le = sub i64 %.7, %i.la
  %i.lf = getelementptr inbounds nuw i8, ptr %.1212, i64 %i.le
  %i.lg = getelementptr inbounds i8, ptr %i.lf, i64 -7
  store <8 x i8> %wide.load457, ptr %i.lg, align 1, !tbaa !10
  %index.next458 = add nuw i64 %index456, 8       ; 2 uses
  %i.lh = icmp eq i64 %index.next458, %n.vec455
  br i1 %i.lh, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !31
...
.preheader31.i:                                   ; preds = %.preheader31.i.preheader, %.preheader31.i
  ...
  %i.lk = load i8, ptr %i.lj, align 1, !tbaa !10
  %i.ll = sub i64 %.7, %.02232.i
  %i.lm = getelementptr inbounds nuw i8, ptr %.1212, i64 %i.ll
  store i8 %i.lk, ptr %i.lm, align 1, !tbaa !10
...
bb.dm:                                            ; preds = %bb.a, %mi_out_alignright.exit.thread365
  %.0238 = phi i32 [ %i.lr, %mi_out_alignright.exit.thread365 ], [ 0, %bb.a ]
  ret i32 %.0238
}
