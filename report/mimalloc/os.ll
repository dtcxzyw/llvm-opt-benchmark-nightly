...
bb.a:
  ...
  %i.b = icmp ule i64 %0, %i.a
  %i.c = icmp ugt i64 %0, 17179869184
  %or.cond = or i1 %i.c, %i.b
  %i.d = load i64, ptr getelementptr inbounds nuw (i8, ptr @mi_os_mem_config, i64 32), align 8
  %i.e = icmp ult i64 %i.d, 46
  %or.cond37 = select i1 %or.cond, i1 true, i1 %i.e
  br i1 %or.cond37, label %.critedge, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.f = load i64, ptr @mi_os_mem_config, align 8, !tbaa !15 ; 2 uses
  %i.g = add nsw i64 %0, -1                       ; 2 uses
  %i.h = load i64, ptr getelementptr inbounds nuw (i8, ptr @mi_os_mem_config, i64 8), align 8, !tbaa !16 ; 2 uses
  %.not.i = icmp eq i64 %i.h, 0
  %spec.select.i = select i1 %.not.i, i64 %i.f, i64 %i.h ; 4 uses
  %i.i = tail call range(i64 0, 65) i64 @llvm.ctpop.i64(i64 %spec.select.i)
  %i.j = icmp samesign ult i64 %i.i, 2
  %i.k = add i64 %1, -1
  %i.l = add i64 %i.k, %i.g
  %i.m = add i64 %i.l, %i.f
  %i.n = add i64 %i.m, %spec.select.i             ; 3 uses
  br i1 %i.j, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  %i.o = sub i64 0, %spec.select.i
  %i.p = and i64 %i.n, %i.o
  br label %_mi_align_up.exit

bb.d:                                             ; preds = %bb.b
  %i.q = urem i64 %i.n, %spec.select.i
  %i.r = sub nuw i64 %i.n, %i.q
  br label %_mi_align_up.exit

_mi_align_up.exit:                                ; preds = %bb.c, %bb.d
  %.0.i = phi i64 [ %i.p, %bb.c ], [ %i.r, %bb.d ] ; 3 uses
  %i.s = atomicrmw add ptr @_mi_os_get_aligned_hint.aligned_base, i64 %.0.i acq_rel, align 64 ; 3 uses
  %i.t = add i64 %i.s, -32985348833281
  %or.cond3 = icmp ult i64 %i.t, -32985348833280
  br i1 %or.cond3, label %bb.e, label %bb.g

bb.e:                                             ; preds = %_mi_align_up.exit
  %i.u = tail call align 8 ptr @llvm.threadlocal.address.p0(ptr align 8 @__mi_theap_default)
  %i.v = load ptr, ptr %i.u, align 8, !tbaa !21   ; 3 uses
  %.not.i38 = icmp eq ptr %i.v, null
  br i1 %.not.i38, label %.critedge, label %mi_theap_is_initialized.exit

mi_theap_is_initialized.exit:                     ; preds = %bb.e
...
bb.f:                                             ; preds = %mi_theap_is_initialized.exit
  %i.y = tail call i64 @_mi_theap_random_next(ptr noundef nonnull %i.v) #9
  %i.z = shl i64 %i.y, 3
  %i.aa = and i64 %i.z, 4398045462528
  %i.ab = add nuw nsw i64 %i.aa, 2199023255552
  %i.ac = add i64 %i.s, %.0.i
  %i.ad = cmpxchg ptr @_mi_os_get_aligned_hint.aligned_base, i64 %i.ac, i64 %i.ab acq_rel acquire, align 64 ; 0 uses
  %i.ae = atomicrmw add ptr @_mi_os_get_aligned_hint.aligned_base, i64 %.0.i acq_rel, align 64 ; 2 uses
  %.not41 = icmp eq i64 %i.ae, 0
  br i1 %.not41, label %.critedge, label %bb.g

bb.g:                                             ; preds = %bb.f, %_mi_align_up.exit
  %.132 = phi i64 [ %i.ae, %bb.f ], [ %i.s, %_mi_align_up.exit ]
  %i.af = tail call range(i64 0, 36) i64 @llvm.ctpop.i64(i64 %0)
  %i.ag = icmp samesign ult i64 %i.af, 2
  %i.ah = add i64 %.132, %i.g                     ; 3 uses
  br i1 %i.ag, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g
  %i.ai = sub nsw i64 0, %0
  %i.aj = and i64 %i.ah, %i.ai
  br label %_mi_align_up.exit40

bb.i:                                             ; preds = %bb.g
  %i.ak = urem i64 %i.ah, %0
  %i.al = sub nuw i64 %i.ah, %i.ak
  br label %_mi_align_up.exit40

_mi_align_up.exit40:                              ; preds = %bb.h, %bb.i
  %.0.i39 = phi i64 [ %i.aj, %bb.h ], [ %i.al, %bb.i ]
  %i.am = inttoptr i64 %.0.i39 to ptr
  br label %.critedge

.critedge:                                        ; preds = %bb.e, %_mi_align_up.exit40, %bb.f, %mi_theap_is_initialized.exit, %bb.a
  %.3 = phi ptr [ null, %mi_theap_is_initialized.exit ], [ null, %bb.a ], [ %i.am, %_mi_align_up.exit40 ], [ null, %bb.f ], [ null, %bb.e ]
  ret ptr %.3
}

declare i64 @_mi_theap_random_next(ptr noundef) local_unnamed_addr #3

; Function Attrs: mustprogress nofree nooutline norecurse nosync nounwind willreturn memory(none) uwtable
define hidden noundef i64 @_mi_os_secure_guard_page_size() local_unnamed_addr #4 {
bb.a:
  ret i64 0
}

; Function Attrs: mustprogress nofree nooutline norecurse nosync nounwind willreturn memory(none) uwtable
define hidden noundef zeroext i1 @_mi_os_secure_guard_page_set_at(ptr nofree noundef readnone captures(none) %0, ptr nofree noundef readnone captures(none) %1, ptr nofree noundef readnone byval(%struct.mi_memid_s) align 8 captures(none) %2) local_unnamed_addr #4 {
bb.a:
  ret i1 true
}

; Function Attrs: mustprogress nofree nooutline norecurse nosync nounwind willreturn memory(none) uwtable
define hidden noundef zeroext i1 @_mi_os_secure_guard_page_set_before(ptr nofree noundef readnone captures(none) %0, ptr nofree noundef readnone captures(none) %1, ptr nofree noundef readnone byval(%struct.mi_memid_s) align 8 captures(none) %2) local_unnamed_addr #4 {
bb.a:
  ret i1 true
}

; Function Attrs: mustprogress nofree nooutline norecurse nosync nounwind willreturn memory(none) uwtable
define hidden noundef zeroext i1 @_mi_os_secure_guard_page_reset_at(ptr nofree noundef readnone captures(none) %0, ptr nofree noundef readnone captures(none) %1, ptr nofree noundef readnone byval(%struct.mi_memid_s) align 8 captures(none) %2) local_unnamed_addr #4 {
bb.a:
  ret i1 true
}

; Function Attrs: mustprogress nofree nooutline norecurse nosync nounwind willreturn memory(none) uwtable
define hidden noundef zeroext i1 @_mi_os_secure_guard_page_reset_before(ptr nofree noundef readnone captures(none) %0, ptr nofree noundef readnone captures(none) %1, ptr nofree noundef readnone byval(%struct.mi_memid_s) align 8 captures(none) %2) local_unnamed_addr #4 {
bb.a:
  ret i1 true
}

; Function Attrs: nooutline nounwind uwtable
define hidden void @_mi_os_free_ex(ptr noundef %0, ptr noundef %1, i64 noundef %2, i1 noundef zeroext %3, ptr nofree noundef readonly byval(%struct.mi_memid_s) align 8 captures(none) %4) local_unnamed_addr #1 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %4, i64 16
  %i.b = load i32, ptr %i.a, align 8, !tbaa !24   ; 2 uses
  %i.c = add i32 %i.b, -3
  %i.d = icmp ult i32 %i.c, 3
  br i1 %i.d, label %bb.b, label %mi_os_free_huge_os_pages.exit

bb.b:                                             ; preds = %bb.a
  %i.e = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.f = load i64, ptr %i.e, align 8, !tbaa !26   ; 2 uses
  %i.g = icmp eq i64 %i.f, 0                      ; 2 uses
  br i1 %i.g, label %bb.c, label %_mi_os_good_alloc_size.exit

bb.c:                                             ; preds = %bb.b
  %i.h = icmp ult i64 %2, 524288
  br i1 %i.h, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  %i.i = load i64, ptr @mi_os_mem_config, align 8, !tbaa !15
  br label %bb.h

bb.e:                                             ; preds = %bb.c
  %i.j = icmp ult i64 %2, 2097152
  br i1 %i.j, label %bb.h, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.k = icmp ult i64 %2, 8388608
  br i1 %i.k, label %bb.h, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.l = icmp ult i64 %2, 33554432
  %..i = select i1 %i.l, i64 1048576, i64 4194304
  br label %bb.h

bb.h:                                             ; preds = %bb.g, %bb.f, %bb.e, %bb.d
  %.0.i = phi i64 [ %i.i, %bb.d ], [ 262144, %bb.f ], [ 65536, %bb.e ], [ %..i, %bb.g ] ; 5 uses
  %i.m = xor i64 %.0.i, -1
  %.not.i = icmp ult i64 %2, %i.m
  br i1 %.not.i, label %bb.i, label %_mi_os_good_alloc_size.exit, !prof !19

bb.i:                                             ; preds = %bb.h
  %i.n = tail call range(i64 0, 65) i64 @llvm.ctpop.i64(i64 %.0.i)
  %i.o = icmp samesign ult i64 %i.n, 2
  %i.p = add i64 %2, -1
  %i.q = add i64 %i.p, %.0.i                      ; 3 uses
...
bb.k:                                             ; preds = %bb.i
  %i.t = urem i64 %i.q, %.0.i
  %i.u = sub nuw i64 %i.q, %i.t
  br label %_mi_os_good_alloc_size.exit

_mi_os_good_alloc_size.exit:                      ; preds = %bb.k, %bb.j, %bb.h, %bb.b
  %.0.a = phi i64 [ %i.f, %bb.b ], [ %2, %bb.h ], [ %i.s, %bb.j ], [ %i.u, %bb.k ] ; 4 uses
  %i.v = select i1 %3, i64 %.0.a, i64 0
  %i.w = load ptr, ptr %4, align 8, !tbaa !26     ; 3 uses
...
bb.l:                                             ; preds = %_mi_os_good_alloc_size.exit
  ...
  %spec.select = add i64 %i.aa, %.0.a
  %i.ab = sub i64 %.0.a, %i.z
  %.020 = select i1 %3, i64 %i.ab, i64 0
  br label %bb.m
...
bb.o:                                             ; preds = %mi_os_prim_free.exit.i, %.lr.ph.i
  %.012.i = phi ptr [ %.019, %.lr.ph.i ], [ %i.aj, %mi_os_prim_free.exit.i ] ; 3 uses
...
bb.q:                                             ; preds = %bb.m
  %i.al = select i1 %3, i64 %.121, i64 0          ; 2 uses
  %i.am = icmp eq ptr %.019, null
  br i1 %i.am, label %mi_os_free_huge_os_pages.exit, label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.an = tail call i32 @_mi_prim_free(ptr noundef nonnull %.019, i64 noundef %.2) #9 ; 3 uses
  %.not.i26 = icmp eq i32 %i.an, 0
  br i1 %.not.i26, label %bb.t, label %bb.s

bb.s:                                             ; preds = %bb.r
  tail call void (ptr, ...) @_mi_warning_message(ptr noundef nonnull @.str.8, i32 noundef %i.an, i32 noundef %i.an, i64 noundef %.2, ptr noundef nonnull %.019) #9
  br label %bb.t
...
begin_hunk_1_@_mi_os_alloc_aligned:bb.a
  ...
  br i1 %i.aq, label %mi_os_prim_free.exit116.i, label %bb.q
...
bb.u:                                             ; preds = %.critedge.i, %mi_os_prim_free.exit.i
  ...
  %.not100.i = icmp ult i64 %.0.i.i, %i.ax
  br i1 %.not100.i, label %bb.v, label %.critedge105.i
...
bb.w:                                             ; preds = %bb.v
  ...
  br i1 %i.bb, label %.critedge105.i, label %bb.x
...
bb.x:                                             ; preds = %bb.w
  ...
  %spec.select119.i = select i1 %or.cond.i.i.i, i64 1, i64 %i.bc ; 2 uses
  store i8 0, ptr %i.c, align 1, !tbaa !29
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #11
  store ptr null, ptr %i.a, align 8, !tbaa !30
  %i.be = call i32 @_mi_prim_alloc(ptr noundef null, i64 noundef %i.ay, i64 noundef %spec.select119.i, i1 noundef zeroext false, i1 noundef zeroext false, ptr noundef nonnull %i.b, ptr noundef nonnull %i.c, ptr noundef nonnull %i.a) #9 ; 3 uses
  %.not40.i.i.i = icmp eq i32 %i.be, 0
  br i1 %.not40.i.i.i, label %bb.z, label %bb.y

bb.y:                                             ; preds = %bb.x
  call void (ptr, ...) @_mi_warning_message(ptr noundef nonnull @.str.9, i32 noundef %i.be, i32 noundef %i.be, ptr noundef null, i64 noundef %i.ay, i64 noundef %spec.select119.i, i32 noundef 0, i32 noundef 0) #9
  br label %bb.z
...
bb.z:                                             ; preds = %bb.y, %bb.x
  ...
  br i1 %.not41.i.i.i, label %mi_os_prim_alloc.exit.thread118.i, label %mi_os_prim_alloc.exit.i

mi_os_prim_alloc.exit.thread118.i:                ; preds = %bb.z
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #11
...
mi_os_prim_alloc.exit.i:                          ; preds = %bb.z
  ...
  br i1 %i.bi, label %.critedge105.i, label %_mi_align_up_ptr.exit.i
...
_mi_align_up_ptr.exit.i:                          ; preds = %mi_os_prim_alloc.exit.i
  ...
  br i1 %3, label %bb.aa, label %mi_os_prim_free.exit116.i
...
bb.aa:                                            ; preds = %_mi_align_up_ptr.exit.i
  ...
  br i1 %i.bp, label %mi_os_prim_free.exit116.i, label %bb.ab
...
bb.ac:                                            ; preds = %bb.v
  ...
  br i1 %i.br, label %.critedge105.i, label %_mi_align_up_ptr.exit108.i

_mi_align_up_ptr.exit108.i:                       ; preds = %bb.ac
...
bb.ad:                                            ; preds = %_mi_align_up_ptr.exit108.i
  %i.ce = sub i64 0, %i.bz
  %i.cf = and i64 %i.cd, %i.ce
  br label %_mi_align_up.exit110.i

bb.ae:                                            ; preds = %_mi_align_up_ptr.exit108.i
  %i.cg = urem i64 %i.cd, %i.bz
  %i.ch = sub nuw i64 %i.cd, %i.cg
  br label %_mi_align_up.exit110.i

_mi_align_up.exit110.i:                           ; preds = %bb.ae, %bb.ad
  %.0.i109.i = phi i64 [ %i.cf, %bb.ad ], [ %i.ch, %bb.ae ] ; 5 uses
  %i.ci = add i64 %.0.i109.i, %i.by               ; 2 uses
  %i.cj = sub i64 %i.ay, %i.ci                    ; 4 uses
  %.not101.i = icmp eq ptr %i.bq, %i.bx
  br i1 %.not101.i, label %bb.aj, label %bb.af

bb.af:                                            ; preds = %_mi_align_up.exit110.i
  %i.ck = select i1 %3, i64 %i.by, i64 0          ; 2 uses
  %i.cl = call i32 @_mi_prim_free(ptr noundef nonnull %i.bq, i64 noundef %i.by) #9 ; 3 uses
  %.not.i111.i = icmp eq i32 %i.cl, 0
  br i1 %.not.i111.i, label %bb.ah, label %bb.ag
...
bb.ah:                                            ; preds = %bb.ag, %bb.af
  %.not21.i112.i = icmp eq i64 %i.ck, 0
  br i1 %.not21.i112.i, label %mi_os_prim_free.exit113.i, label %bb.ai
...
bb.ai:                                            ; preds = %bb.ah
  ...
  br label %mi_os_prim_free.exit113.i

mi_os_prim_free.exit113.i:                        ; preds = %bb.ai, %bb.ah
...
bb.aj:                                            ; preds = %mi_os_prim_free.exit113.i, %_mi_align_up.exit110.i
  %.not102.i = icmp eq i64 %i.ay, %i.ci
  br i1 %.not102.i, label %mi_os_prim_free.exit116.i, label %bb.ak

bb.ak:                                            ; preds = %bb.aj
  %i.co = getelementptr inbounds nuw i8, ptr %i.bx, i64 %.0.i109.i ; 2 uses
  %i.cp = select i1 %3, i64 %i.cj, i64 0          ; 2 uses
  %i.cq = icmp eq i64 %i.bw, 0
  br i1 %i.cq, label %mi_os_prim_free.exit116.i, label %bb.al

bb.al:                                            ; preds = %bb.ak
  %i.cr = call i32 @_mi_prim_free(ptr noundef nonnull %i.co, i64 noundef %i.cj) #9 ; 3 uses
  %.not.i114.i = icmp eq i32 %i.cr, 0
  br i1 %.not.i114.i, label %bb.an, label %bb.am
...
bb.an:                                            ; preds = %bb.am, %bb.al
  %.not21.i115.i = icmp eq i64 %i.cp, 0
  br i1 %.not21.i115.i, label %bb.ap, label %bb.ao
...
mi_os_prim_alloc_aligned.exit:                    ; preds = %.critedge105.i, %_mi_align_up.exit, %bb.a
  %.1 = phi ptr [ null, %bb.a ], [ %.1.i, %.critedge105.i ], [ null, %_mi_align_up.exit ]
  ret ptr %.1
}
...
mi_os_prim_free.exit.thread:                      ; preds = %.split.us, %.thread, %bb.r, %.split111.us, %bb.o
  ...
  %.158.ph = phi i64 [ %.us-phi115, %bb.o ], [ %.us-phi115, %.split111.us ], [ %.us-phi115, %bb.r ], [ %i.ae, %.thread ], [ %.us-phi109, %.split.us ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #11
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #11
  br label %.loopexit
...
bb.x:                                             ; preds = %bb.v, %bb.w, %mi_os_claim_huge_pages.exit.thread
  %.0 = phi ptr [ null, %mi_os_claim_huge_pages.exit.thread ], [ %i.s, %bb.w ], [ null, %bb.v ]
  ret ptr %.0
}
