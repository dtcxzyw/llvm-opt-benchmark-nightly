...
bb.as:                                            ; preds = %bb.ar, %bb.aq
  ...
  %12 = getelementptr inbounds nuw i8, ptr %i.xq, i64 4
  %i.yd = getelementptr inbounds nuw i8, ptr %i.xt, i64 8
  %i.ye = load float, ptr %i.yd, align 4, !tbaa !52
  %13 = getelementptr inbounds nuw i8, ptr %i.xq, i64 8
  ...
  %15 = load float, ptr %i.xq, align 4, !tbaa !52
  %16 = load float, ptr %13, align 4, !tbaa !52
  ...
  %i.za = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.zd = fsub <2 x float> %i.zc, %19             ; 2 uses
  %20 = insertelement <2 x float> poison, float %i.ye, i64 0
  %i.ze = insertelement <2 x float> %20, float %i.yg, i64 1
  %i.zf = insertelement <2 x float> poison, float %16, i64 0
  %21 = shufflevector <2 x float> %i.zf, <2 x float> poison, <2 x i32> zeroinitializer
  %i.zg = fsub <2 x float> %i.ze, %21             ; 2 uses
