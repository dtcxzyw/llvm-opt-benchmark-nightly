...
bb.as:                                            ; preds = %bb.ar, %bb.aq
  ...
  %12 = load float, ptr %i.xq, align 4, !tbaa !52
  %13 = load <2 x float>, ptr %i.xt, align 4, !tbaa !52 ; 2 uses
  %i.yz = load float, ptr %i.yd, align 4, !tbaa !52
  %i.za = load float, ptr %i.yg, align 4, !tbaa !52
  %i.zb = load <2 x float>, ptr %i.xw, align 4, !tbaa !52 ; 2 uses
  %i.zc = shufflevector <2 x float> %13, <2 x float> %i.zb, <2 x i32> <i32 0, i32 2>
  %i.zd = insertelement <2 x float> poison, float %12, i64 0
  %i.ze = shufflevector <2 x float> %i.zd, <2 x float> poison, <2 x i32> zeroinitializer
  %i.zf = fsub <2 x float> %i.zc, %i.ze           ; 2 uses
  %i.zg = shufflevector <2 x float> %13, <2 x float> %i.zb, <2 x i32> <i32 1, i32 3>
  %i.zh = insertelement <2 x float> poison, float %i.yz, i64 0
