...
bb.df:                                            ; preds = %bb.df, %.lr.ph.i485
  ...
  %i.axe = load float, ptr %i.axd, align 4, !tbaa !44 ; 2 uses
  ...
  %18 = insertelement <2 x float> poison, float %i.axg, i64 0
  %19 = insertelement <2 x float> %18, float %i.axi, i64 1
  %20 = insertelement <2 x float> poison, float %i.axe, i64 0
  %21 = shufflevector <2 x float> %20, <2 x float> poison, <2 x i32> zeroinitializer
  %22 = fsub <2 x float> %19, %21                 ; 2 uses
  %23 = shufflevector <2 x float> %22, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %24 = fmul <4 x float> %i.awq, %23
  %i.axj = shufflevector <2 x float> %22, <2 x float> poison, <4 x i32> zeroinitializer
  %i.axk = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.awp, <4 x float> %i.axj, <4 x float> %24) ; 9 uses
