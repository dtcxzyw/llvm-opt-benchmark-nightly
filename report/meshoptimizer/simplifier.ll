...
.lr.ph.i.epil.preheader:                          ; preds = %.lr.ph64.i.preheader.unr-lcssa, %.lr.ph.i.preheader
  ...
  %lcmp.mod1264 = icmp ne i64 %xtraiter, 0
  tail call void @llvm.assume(i1 %lcmp.mod1264)
...
.lr.ph64.i.preheader.new:                         ; preds = %.lr.ph64.i.preheader
  %unroll_iter1270 = and i64 %2, -2
  br label %.lr.ph64.i

._crit_edge.i.unr-lcssa:                          ; preds = %.lr.ph64.i
  %lcmp.mod1267.not = icmp eq i64 %xtraiter1265, 0
  br i1 %lcmp.mod1267.not, label %._crit_edge.i, label %.lr.ph64.i.epil.preheader
...
.lr.ph64.i.epil.preheader:                        ; preds = %._crit_edge.i.unr-lcssa, %.lr.ph64.i.preheader
  ...
  %lcmp.mod1269 = trunc i64 %2 to i1
  tail call void @llvm.assume(i1 %lcmp.mod1269)
...
._crit_edge.i:                                    ; preds = %._crit_edge.i.unr-lcssa, %.lr.ph64.i.epil.preheader
  %.lcssa1263 = phi i64 [ %i.dg, %._crit_edge.i.unr-lcssa ], [ %i.bg, %.lr.ph64.i.epil.preheader ] ; 3 uses
  %i.bj = icmp ugt i64 %.lcssa1263, 4611686018427387903
  %i.bk = shl nuw i64 %.lcssa1263, 2
  %spec.select.i = select i1 %i.bj, i64 -1, i64 %i.bk
  br label %._crit_edge.thread.i

._crit_edge.thread.i:                             ; preds = %.noexc, %._crit_edge.i
  %.051.lcssa88.i = phi i64 [ %.lcssa1263, %._crit_edge.i ], [ 0, %.noexc ] ; 3 uses
...
.lr.ph64.i:                                       ; preds = %.lr.ph64.i, %.lr.ph64.i.preheader.new
  ...
  %niter1271 = phi i64 [ 0, %.lr.ph64.i.preheader.new ], [ %niter1271.next.1, %.lr.ph64.i ]
  ...
  %niter1271.next.1 = add i64 %niter1271, 2       ; 2 uses
  %niter1271.ncmp.1 = icmp eq i64 %niter1271.next.1, %unroll_iter1270
  br i1 %niter1271.ncmp.1, label %._crit_edge.i.unr-lcssa, label %.lr.ph64.i, !llvm.loop !60
...
.lr.ph.split.us.i.preheader:                      ; preds = %bb.j
  %i.fi = add i64 %2, -1
  %xtraiter1272 = and i64 %2, 3                   ; 3 uses
...
.lr.ph.split.us.i:                                ; preds = %.lr.ph.split.us.i, %.lr.ph.split.us.i.preheader.new
  ...
  %niter1277 = phi i64 [ 0, %.lr.ph.split.us.i.preheader.new ], [ %niter1277.next.3, %.lr.ph.split.us.i ]
  ...
  %niter1277.next.3 = add nuw i64 %niter1277, 4   ; 2 uses
  %niter1277.ncmp.3 = icmp eq i64 %niter1277.next.3, %unroll_iter1276
  br i1 %niter1277.ncmp.3, label %.preheader80.i.loopexit.unr-lcssa, label %.lr.ph.split.us.i, !llvm.loop !1

.preheader80.i.loopexit.unr-lcssa:                ; preds = %.lr.ph.split.us.i
  %lcmp.mod1274.not = icmp eq i64 %xtraiter1272, 0
  br i1 %lcmp.mod1274.not, label %.preheader80.i, label %.lr.ph.split.us.i.epil.preheader
...
.lr.ph.split.us.i.epil.preheader:                 ; preds = %.preheader80.i.loopexit.unr-lcssa, %.lr.ph.split.us.i.preheader
  ...
  %lcmp.mod1275 = icmp ne i64 %xtraiter1272, 0
  tail call void @llvm.assume(i1 %lcmp.mod1275)
...
.lr.ph.split.us.i.epil:                           ; preds = %.lr.ph.split.us.i.epil, %.lr.ph.split.us.i.epil.preheader
  ...
  %epil.iter1273 = phi i64 [ %epil.iter1273.next, %.lr.ph.split.us.i.epil ], [ 0, %.lr.ph.split.us.i.epil.preheader ]
  ...
  %epil.iter1273.next = add i64 %epil.iter1273, 1 ; 2 uses
  %epil.iter1273.cmp.not = icmp eq i64 %epil.iter1273.next, %xtraiter1272
  br i1 %epil.iter1273.cmp.not, label %.preheader80.i, label %.lr.ph.split.us.i.epil, !llvm.loop !63
...
.lr.ph84.i.preheader:                             ; preds = %.preheader80.i
  %i.gt = add i64 %.0702, -1
  %xtraiter1278 = and i64 %.0702, 3               ; 3 uses
...
.lr.ph84.i.preheader.new:                         ; preds = %.lr.ph84.i.preheader
  %unroll_iter1282 = and i64 %.0702, -4
  br label %.lr.ph84.i

.preheader.i.loopexit.unr-lcssa:                  ; preds = %.lr.ph84.i
  %lcmp.mod1280.not = icmp eq i64 %xtraiter1278, 0
  br i1 %lcmp.mod1280.not, label %.preheader.i, label %.lr.ph84.i.epil.preheader
...
.lr.ph84.i.epil.preheader:                        ; preds = %.preheader.i.loopexit.unr-lcssa, %.lr.ph84.i.preheader
  ...
  %lcmp.mod1281 = icmp ne i64 %xtraiter1278, 0
...
.lr.ph84.i.epil:                                  ; preds = %.lr.ph84.i.epil, %.lr.ph84.i.epil.preheader
  ...
  %epil.iter1279 = phi i64 [ %epil.iter1279.next, %.lr.ph84.i.epil ], [ 0, %.lr.ph84.i.epil.preheader ]
  ...
  %epil.iter1279.next = add i64 %epil.iter1279, 1 ; 2 uses
  %epil.iter1279.cmp.not = icmp eq i64 %epil.iter1279.next, %xtraiter1278
  br i1 %epil.iter1279.cmp.not, label %.preheader.i, label %.lr.ph84.i.epil, !llvm.loop !64
...
.lr.ph84.i:                                       ; preds = %.lr.ph84.i, %.lr.ph84.i.preheader.new
  ...
  %niter1283 = phi i64 [ 0, %.lr.ph84.i.preheader.new ], [ %niter1283.next.3, %.lr.ph84.i ]
  ...
  %niter1283.next.3 = add nuw i64 %niter1283, 4   ; 2 uses
  %niter1283.ncmp.3 = icmp eq i64 %niter1283.next.3, %unroll_iter1282
  br i1 %niter1283.ncmp.3, label %.preheader.i.loopexit.unr-lcssa, label %.lr.ph84.i, !llvm.loop !2
...
.preheader729.preheader.new:                      ; preds = %.preheader729.preheader
  %unroll_iter1307 = and i64 %9, -2
  br label %.preheader729

.unr-lcssa:                                       ; preds = %bb.bz
  %lcmp.mod1304.not = icmp eq i64 %xtraiter1302, 0
  br i1 %lcmp.mod1304.not, label %.epilog-lcssa, label %.preheader729.epil.preheader
...
.preheader729.epil.preheader:                     ; preds = %.unr-lcssa, %.preheader729.preheader
  ...
  %lcmp.mod1306 = trunc i64 %9 to i1
  call void @llvm.assume(i1 %lcmp.mod1306)
...
.preheader729:                                    ; preds = %bb.bz, %.preheader729.preheader.new
  ...
  %niter1308 = phi i64 [ 0, %.preheader729.preheader.new ], [ %niter1308.next.1, %bb.bz ]
...
bb.bz:                                            ; preds = %bb.by, %.preheader729.1
  ...
  %niter1308.next.1 = add nuw i64 %niter1308, 2   ; 2 uses
  %niter1308.ncmp.1 = icmp eq i64 %niter1308.next.1, %unroll_iter1307
  br i1 %niter1308.ncmp.1, label %.unr-lcssa, label %.preheader729, !llvm.loop !81
...
.lr.ph.us.i.preheader:                            ; preds = %.lr.ph29.split.us.i
  %xtraiter1309 = and i64 %.1351.lcssa, 1
  %i.abk = icmp eq i64 %.1351.lcssa, 1
  %unroll_iter1313 = and i64 %.1351.lcssa, -2
  %lcmp.mod1311.not = icmp eq i64 %xtraiter1309, 0
  %lcmp.mod1312 = trunc i64 %.1351.lcssa to i1
  br label %.lr.ph.us.i

.lr.ph.us.us.i.preheader:                         ; preds = %.lr.ph29.split.us.i
  %xtraiter1316 = and i64 %.1351.lcssa, 1
  %i.abl = icmp eq i64 %.1351.lcssa, 1
  %unroll_iter1320 = and i64 %.1351.lcssa, -2
  %lcmp.mod1318.not = icmp eq i64 %xtraiter1316, 0
  %lcmp.mod1319 = trunc i64 %.1351.lcssa to i1
...
.lr.ph.us.us.i:                                   ; preds = %.lr.ph.us.us.i.preheader, %._crit_edge.us.us.i
  ...
  br i1 %i.abl, label %.epil.preheader1315, label %.lr.ph.us.us.i.new
...
.lr.ph.us.us.i.new:                               ; preds = %.lr.ph.us.us.i, %.lr.ph.us.us.i.new
  ...
  %niter1321 = phi i64 [ %niter1321.next.1, %.lr.ph.us.us.i.new ], [ 0, %.lr.ph.us.us.i ]
  ...
  %niter1321.next.1 = add nuw i64 %niter1321, 2   ; 2 uses
  %niter1321.ncmp.1 = icmp eq i64 %niter1321.next.1, %unroll_iter1320
  br i1 %niter1321.ncmp.1, label %._crit_edge.us.us.i.unr-lcssa, label %.lr.ph.us.us.i.new, !llvm.loop !82

._crit_edge.us.us.i.unr-lcssa:                    ; preds = %.lr.ph.us.us.i.new
  br i1 %lcmp.mod1318.not, label %._crit_edge.us.us.i, label %.epil.preheader1315

.epil.preheader1315:                              ; preds = %._crit_edge.us.us.i.unr-lcssa, %.lr.ph.us.us.i
  %.02326.us.us.i.epil.init = phi i64 [ 0, %.lr.ph.us.us.i ], [ %i.ack, %._crit_edge.us.us.i.unr-lcssa ] ; 2 uses
  call void @llvm.assume(i1 %lcmp.mod1319)
...
._crit_edge.us.us.i:                              ; preds = %._crit_edge.us.us.i.unr-lcssa, %.epil.preheader1315
...
.lr.ph.us.i.new:                                  ; preds = %.lr.ph.us.i, %.lr.ph.us.i.new
  ...
  %niter1314 = phi i64 [ %niter1314.next.1, %.lr.ph.us.i.new ], [ 0, %.lr.ph.us.i ]
  ...
  %niter1314.next.1 = add nuw i64 %niter1314, 2   ; 2 uses
  %niter1314.ncmp.1 = icmp eq i64 %niter1314.next.1, %unroll_iter1313
  br i1 %niter1314.ncmp.1, label %._crit_edge.us.i.unr-lcssa, label %.lr.ph.us.i.new, !llvm.loop !82

._crit_edge.us.i.unr-lcssa:                       ; preds = %.lr.ph.us.i.new
  br i1 %lcmp.mod1311.not, label %._crit_edge.us.i, label %.epil.preheader
...
.epil.preheader:                                  ; preds = %._crit_edge.us.i.unr-lcssa, %.lr.ph.us.i
  ...
  call void @llvm.assume(i1 %lcmp.mod1312)
...
begin_hunk_2_@_Z20meshopt_simplifyEdgePjPKjmPKfmmS3_mS3_mPKhmfjPf:bb.a
  %i.ayc = call float @llvm.fmuladd.f32(float %i.awu, float %i.axz, float %i.ayb) ; 4 uses
  %i.ayd = insertelement <4 x float> poison, float %i.ayc, i64 0
  %i.aye = shufflevector <4 x float> %i.axq, <4 x float> %i.ayd, <4 x i32> <i32 2, i32 1, i32 4, i32 4>
  %i.ayf = fmul <4 x float> %i.axu, %i.aye
  %i.ayg = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.aww, <4 x float> %i.ayf, <4 x float> %i.axa) ; 4 uses
  %i.ayh = insertelement <2 x float> %i.axv, float %i.ayc, i64 1
  %i.ayi = insertelement <2 x float> poison, float %i.ayc, i64 0
  %i.ayj = shufflevector <2 x float> %i.ayi, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ayk = fmul <2 x float> %i.ayh, %i.ayj
  %i.ayl = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.awy, <2 x float> %i.ayk, <2 x float> %i.axb) ; 4 uses
  %i.aym = insertelement <4 x float> %i.axq, float %i.ayc, i64 3
  %i.ayn = fmul <4 x float> %i.aww, %i.aym
  store <4 x float> %i.ayn, ptr %i.axw, align 16, !tbaa !44
  %i.ayo = add nuw nsw i64 %.0210.i.i, 1          ; 2 uses
  %exitcond.not.i.i487 = icmp eq i64 %i.ayo, %.0330
...
_ZN7meshoptL21quadricFromAttributesERNS_7QuadricEPNS_11QuadricGradERKNS_7Vector3ES6_S6_PKfS8_S8_m.exit.i: ; preds = %bb.df
  %i.ayp = getelementptr inbounds nuw [44 x i8], ptr %.0348, i64 %i.atz ; 5 uses
  %i.ayq = load <4 x float>, ptr %i.ayp, align 4, !tbaa !44
  %i.ayr = fadd <4 x float> %i.axt, %i.ayq
  store <4 x float> %i.ayr, ptr %i.ayp, align 4, !tbaa !44
  %i.ays = getelementptr inbounds nuw i8, ptr %i.ayp, i64 16 ; 2 uses
  %i.ayt = load <4 x float>, ptr %i.ays, align 4, !tbaa !44
  %i.ayu = fadd <4 x float> %i.ayg, %i.ayt
  store <4 x float> %i.ayu, ptr %i.ays, align 4, !tbaa !44
  %i.ayv = getelementptr inbounds nuw i8, ptr %i.ayp, i64 32 ; 2 uses
  %i.ayw = load <2 x float>, ptr %i.ayv, align 4, !tbaa !44
  %i.ayx = fadd <2 x float> %i.ayl, %i.ayw
  store <2 x float> %i.ayx, ptr %i.ayv, align 4, !tbaa !44
  %i.ayy = getelementptr inbounds nuw i8, ptr %i.ayp, i64 40 ; 2 uses
  %i.ayz = load float, ptr %i.ayy, align 4, !tbaa !48
  %i.aza = fadd float %i.avz, %i.ayz
  store float %i.aza, ptr %i.ayy, align 4, !tbaa !48
  %i.azb = getelementptr inbounds nuw [44 x i8], ptr %.0348, i64 %i.aub ; 5 uses
  %i.azc = load <4 x float>, ptr %i.azb, align 4, !tbaa !44
  %i.azd = fadd <4 x float> %i.axt, %i.azc
  store <4 x float> %i.azd, ptr %i.azb, align 4, !tbaa !44
  %i.aze = getelementptr inbounds nuw i8, ptr %i.azb, i64 16 ; 2 uses
  %i.azf = load <4 x float>, ptr %i.aze, align 4, !tbaa !44
  %i.azg = fadd <4 x float> %i.ayg, %i.azf
  store <4 x float> %i.azg, ptr %i.aze, align 4, !tbaa !44
  %i.azh = getelementptr inbounds nuw i8, ptr %i.azb, i64 32 ; 2 uses
  %i.azi = load <2 x float>, ptr %i.azh, align 4, !tbaa !44
  %i.azj = fadd <2 x float> %i.ayl, %i.azi
  store <2 x float> %i.azj, ptr %i.azh, align 4, !tbaa !44
  %i.azk = getelementptr inbounds nuw i8, ptr %i.azb, i64 40 ; 2 uses
  %i.azl = load float, ptr %i.azk, align 4, !tbaa !48
  %i.azm = fadd float %i.avz, %i.azl
  store float %i.azm, ptr %i.azk, align 4, !tbaa !48
  %i.azn = getelementptr inbounds nuw [44 x i8], ptr %.0348, i64 %i.aud ; 5 uses
  %i.azo = load <4 x float>, ptr %i.azn, align 4, !tbaa !44
  %i.azp = fadd <4 x float> %i.axt, %i.azo
  store <4 x float> %i.azp, ptr %i.azn, align 4, !tbaa !44
  %i.azq = getelementptr inbounds nuw i8, ptr %i.azn, i64 16 ; 2 uses
  %i.azr = load <4 x float>, ptr %i.azq, align 4, !tbaa !44
  %i.azs = fadd <4 x float> %i.ayg, %i.azr
  store <4 x float> %i.azs, ptr %i.azq, align 4, !tbaa !44
  %i.azt = getelementptr inbounds nuw i8, ptr %i.azn, i64 32 ; 2 uses
  %i.azu = load <2 x float>, ptr %i.azt, align 4, !tbaa !44
  %i.azv = fadd <2 x float> %i.ayl, %i.azu
  store <2 x float> %i.azv, ptr %i.azt, align 4, !tbaa !44
  %i.azw = getelementptr inbounds nuw i8, ptr %i.azn, i64 40 ; 2 uses
  %i.azx = load float, ptr %i.azw, align 4, !tbaa !48
  %i.azy = fadd float %i.avz, %i.azx
  store float %i.azy, ptr %i.azw, align 4, !tbaa !48
  %i.azz = getelementptr inbounds nuw [16 x i8], ptr %.0347, i64 %i.auf ; 3 uses
  br i1 %i.atq, label %.epil.preheader1322, label %_ZN7meshoptL21quadricFromAttributesERNS_7QuadricEPNS_11QuadricGradERKNS_7Vector3ES6_S6_PKfS8_S8_m.exit.i.new
...
_ZN7meshoptL21quadricFromAttributesERNS_7QuadricEPNS_11QuadricGradERKNS_7Vector3ES6_S6_PKfS8_S8_m.exit.i.new: ; preds = %_ZN7meshoptL21quadricFromAttributesERNS_7QuadricEPNS_11QuadricGradERKNS_7Vector3ES6_S6_PKfS8_S8_m.exit.i, %_ZN7meshoptL21quadricFromAttributesERNS_7QuadricEPNS_11QuadricGradERKNS_7Vector3ES6_S6_PKfS8_S8_m.exit.i.new
  %.018.i.i = phi i64 [ %i.bal, %_ZN7meshoptL21quadricFromAttributesERNS_7QuadricEPNS_11QuadricGradERKNS_7Vector3ES6_S6_PKfS8_S8_m.exit.i.new ], [ 0, %_ZN7meshoptL21quadricFromAttributesERNS_7QuadricEPNS_11QuadricGradERKNS_7Vector3ES6_S6_PKfS8_S8_m.exit.i ] ; 4 uses
  %niter1328 = phi i64 [ %niter1328.next.1, %_ZN7meshoptL21quadricFromAttributesERNS_7QuadricEPNS_11QuadricGradERKNS_7Vector3ES6_S6_PKfS8_S8_m.exit.i.new ], [ 0, %_ZN7meshoptL21quadricFromAttributesERNS_7QuadricEPNS_11QuadricGradERKNS_7Vector3ES6_S6_PKfS8_S8_m.exit.i ]
  %i.baa = getelementptr inbounds nuw [16 x i8], ptr %15, i64 %.018.i.i
  %i.bab = getelementptr inbounds nuw [16 x i8], ptr %i.azz, i64 %.018.i.i ; 2 uses
  ...
  %i.baf = or disjoint i64 %.018.i.i, 1           ; 2 uses
  %i.bag = getelementptr inbounds nuw [16 x i8], ptr %15, i64 %i.baf
  %i.bah = getelementptr inbounds nuw [16 x i8], ptr %i.azz, i64 %i.baf ; 2 uses
  ...
  %i.bal = add nuw nsw i64 %.018.i.i, 2           ; 2 uses
  %niter1328.next.1 = add nuw i64 %niter1328, 2   ; 2 uses
  %niter1328.ncmp.1 = icmp eq i64 %niter1328.next.1, %unroll_iter1327
  br i1 %niter1328.ncmp.1, label %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i.unr-lcssa, label %_ZN7meshoptL21quadricFromAttributesERNS_7QuadricEPNS_11QuadricGradERKNS_7Vector3ES6_S6_PKfS8_S8_m.exit.i.new, !llvm.loop !90
...
_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i.unr-lcssa: ; preds = %_ZN7meshoptL21quadricFromAttributesERNS_7QuadricEPNS_11QuadricGradERKNS_7Vector3ES6_S6_PKfS8_S8_m.exit.i.new
  br i1 %lcmp.mod1325.not, label %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i, label %.epil.preheader1322

.epil.preheader1322:                              ; preds = %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i.unr-lcssa, %_ZN7meshoptL21quadricFromAttributesERNS_7QuadricEPNS_11QuadricGradERKNS_7Vector3ES6_S6_PKfS8_S8_m.exit.i
  %.018.i.i.epil.init = phi i64 [ 0, %_ZN7meshoptL21quadricFromAttributesERNS_7QuadricEPNS_11QuadricGradERKNS_7Vector3ES6_S6_PKfS8_S8_m.exit.i ], [ %i.bal, %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i.unr-lcssa ] ; 2 uses
  call void @llvm.assume(i1 %lcmp.mod1326)
  %i.bam = getelementptr inbounds nuw [16 x i8], ptr %15, i64 %.018.i.i.epil.init
  %i.ban = getelementptr inbounds nuw [16 x i8], ptr %i.azz, i64 %.018.i.i.epil.init ; 2 uses
...
_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i: ; preds = %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i.unr-lcssa, %.epil.preheader1322
  %i.bar = getelementptr inbounds nuw [16 x i8], ptr %.0347, i64 %i.auh ; 3 uses
  br i1 %i.atr, label %.epil.preheader1329, label %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i.new
...
_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i.new: ; preds = %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i, %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i.new
  %.018.i43.i = phi i64 [ %i.bbd, %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i.new ], [ 0, %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i ] ; 4 uses
  %niter1335 = phi i64 [ %niter1335.next.1, %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i.new ], [ 0, %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i ]
  %i.bas = getelementptr inbounds nuw [16 x i8], ptr %15, i64 %.018.i43.i
  %i.bat = getelementptr inbounds nuw [16 x i8], ptr %i.bar, i64 %.018.i43.i ; 2 uses
  ...
  %i.bax = or disjoint i64 %.018.i43.i, 1         ; 2 uses
  %i.bay = getelementptr inbounds nuw [16 x i8], ptr %15, i64 %i.bax
  %i.baz = getelementptr inbounds nuw [16 x i8], ptr %i.bar, i64 %i.bax ; 2 uses
  ...
  %i.bbd = add nuw nsw i64 %.018.i43.i, 2         ; 2 uses
  %niter1335.next.1 = add nuw i64 %niter1335, 2   ; 2 uses
  %niter1335.ncmp.1 = icmp eq i64 %niter1335.next.1, %unroll_iter1334
  br i1 %niter1335.ncmp.1, label %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i.unr-lcssa, label %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i.new, !llvm.loop !90
...
_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i.unr-lcssa: ; preds = %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i.new
  br i1 %lcmp.mod1332.not, label %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i, label %.epil.preheader1329

.epil.preheader1329:                              ; preds = %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i.unr-lcssa, %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i
  %.018.i43.i.epil.init = phi i64 [ 0, %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit.i ], [ %i.bbd, %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i.unr-lcssa ] ; 2 uses
  call void @llvm.assume(i1 %lcmp.mod1333)
  %i.bbe = getelementptr inbounds nuw [16 x i8], ptr %15, i64 %.018.i43.i.epil.init
  %i.bbf = getelementptr inbounds nuw [16 x i8], ptr %i.bar, i64 %.018.i43.i.epil.init ; 2 uses
...
_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i: ; preds = %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i.unr-lcssa, %.epil.preheader1329
  %i.bbj = getelementptr inbounds nuw [16 x i8], ptr %.0347, i64 %i.auj ; 3 uses
  br i1 %i.ats, label %.epil.preheader1336, label %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i.new
...
_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i.new: ; preds = %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i, %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i.new
  %.018.i46.i = phi i64 [ %i.bbv, %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i.new ], [ 0, %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i ] ; 4 uses
  %niter1342 = phi i64 [ %niter1342.next.1, %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i.new ], [ 0, %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i ]
  %i.bbk = getelementptr inbounds nuw [16 x i8], ptr %15, i64 %.018.i46.i
  %i.bbl = getelementptr inbounds nuw [16 x i8], ptr %i.bbj, i64 %.018.i46.i ; 2 uses
  ...
  %i.bbp = or disjoint i64 %.018.i46.i, 1         ; 2 uses
  %i.bbq = getelementptr inbounds nuw [16 x i8], ptr %15, i64 %i.bbp
  %i.bbr = getelementptr inbounds nuw [16 x i8], ptr %i.bbj, i64 %i.bbp ; 2 uses
  ...
  %i.bbv = add nuw nsw i64 %.018.i46.i, 2         ; 2 uses
  %niter1342.next.1 = add nuw i64 %niter1342, 2   ; 2 uses
  %niter1342.ncmp.1 = icmp eq i64 %niter1342.next.1, %unroll_iter1341
  br i1 %niter1342.ncmp.1, label %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit48.i.unr-lcssa, label %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i.new, !llvm.loop !90
...
_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit48.i.unr-lcssa: ; preds = %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i.new
  br i1 %lcmp.mod1339.not, label %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit48.i, label %.epil.preheader1336

.epil.preheader1336:                              ; preds = %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit48.i.unr-lcssa, %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i
  %.018.i46.i.epil.init = phi i64 [ 0, %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit45.i ], [ %i.bbv, %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit48.i.unr-lcssa ] ; 2 uses
  call void @llvm.assume(i1 %lcmp.mod1340)
  %i.bbw = getelementptr inbounds nuw [16 x i8], ptr %15, i64 %.018.i46.i.epil.init
  %i.bbx = getelementptr inbounds nuw [16 x i8], ptr %i.bbj, i64 %.018.i46.i.epil.init ; 2 uses
  %i.bby = load <4 x float>, ptr %i.bbw, align 16, !tbaa !44
  %i.bbz = load <4 x float>, ptr %i.bbx, align 4, !tbaa !44
  %i.bca = fadd <4 x float> %i.bby, %i.bbz
  store <4 x float> %i.bca, ptr %i.bbx, align 4, !tbaa !44
  br label %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit48.i

_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit48.i: ; preds = %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit48.i.unr-lcssa, %.epil.preheader1336
  call void @llvm.lifetime.end.p0(ptr nonnull %15) #14
  %i.bcb = add i64 %.080.i, 3                     ; 2 uses
  %i.bcc = icmp ult i64 %i.bcb, %2
  br i1 %i.bcc, label %.lr.ph.i485, label %_ZN7meshoptL21fillAttributeQuadricsEPNS_7QuadricEPNS_11QuadricGradEPKjmPKNS_7Vector3EPKfm.exit, !llvm.loop !91
...
_ZN7meshoptL21fillAttributeQuadricsEPNS_7QuadricEPNS_11QuadricGradEPKjmPKNS_7Vector3EPKfm.exit: ; preds = %_ZN7meshoptL10quadricAddEPNS_11QuadricGradEPKS0_m.exit48.i, %_ZN7meshoptL16fillEdgeQuadricsEPNS_7QuadricEPKjmPKNS_7Vector3ES3_PKhS3_S3_.exit, %_ZN7meshoptL18fillVertexQuadricsEPNS_7QuadricEPKNS_7Vector3EmPKjPKhS6_j.exit
  %i.bcd = and i32 %13, 8
  %.not405 = icmp ne i32 %i.bcd, 0                ; 3 uses
...
bb.dg:                                            ; preds = %_ZN7meshoptL21fillAttributeQuadricsEPNS_7QuadricEPNS_11QuadricGradEPKjmPKNS_7Vector3EPKfm.exit
  %i.bce = load ptr, ptr @_ZZN17meshopt_Allocator7storageEvE1s, align 8, !tbaa !23
  %i.bcf = invoke noundef ptr %i.bce(i64 noundef %i.jf)
...
bb.dh:                                            ; preds = %bb.dg
  ...
  %i.bcj = call fastcc noundef i64 @_ZN7meshoptL15buildComponentsEPjmPKjmS2_(ptr noundef %i.bcf, i64 noundef %.0702, ptr noundef %0, i64 noundef %2, ptr noundef %i.jg) ; 8 uses
  %i.bck = shl nuw nsw i64 %i.bcj, 4
  %i.bcl = load ptr, ptr @_ZZN17meshopt_Allocator7storageEvE1s, align 8, !tbaa !23
  %i.bcm = invoke noundef ptr %i.bcl(i64 noundef %i.bck)
...
bb.di:                                            ; preds = %bb.dh
  ...
  call fastcc void @_ZN7meshoptL17measureComponentsEPfmPKjPKNS_7Vector3Em(ptr noundef %i.bcm, i64 noundef %i.bcj, ptr noundef %i.bcf, ptr noundef %i.zt, i64 noundef %.0702)
  %.not832 = icmp eq i64 %i.bcj, 0
  br i1 %.not832, label %.loopexit727, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %bb.di
  %xtraiter1343 = and i64 %i.bcj, 3               ; 3 uses
  %i.bcq = icmp samesign ult i64 %i.bcj, 4
  br i1 %i.bcq, label %.lr.ph.epil.preheader, label %.lr.ph.preheader.new

.lr.ph.preheader.new:                             ; preds = %.lr.ph.preheader
  %unroll_iter1348 = and i64 %i.bcj, 4294967292
  br label %.lr.ph
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  %.0342776 = phi i64 [ 0, %.lr.ph.preheader.new ], [ %i.bdh, %.lr.ph ] ; 5 uses
  %.0696775 = phi float [ f0x7F7FFFFF, %.lr.ph.preheader.new ], [ %..3, %.lr.ph ] ; 2 uses
  %niter1349 = phi i64 [ 0, %.lr.ph.preheader.new ], [ %niter1349.next.3, %.lr.ph ]
  %i.bcs = getelementptr inbounds nuw [4 x i8], ptr %i.bcm, i64 %.0342776
  %i.bct = load float, ptr %i.bcs, align 4, !tbaa !44 ; 2 uses
  %i.bcu = fcmp ogt float %.0696775, %i.bct
  %. = select i1 %i.bcu, float %i.bct, float %.0696775 ; 2 uses
  %i.bcv = getelementptr inbounds nuw [4 x i8], ptr %i.bcm, i64 %.0342776
  %i.bcw = getelementptr inbounds nuw i8, ptr %i.bcv, i64 4
  %i.bcx = load float, ptr %i.bcw, align 4, !tbaa !44 ; 2 uses
  %i.bcy = fcmp ogt float %., %i.bcx
  %..1 = select i1 %i.bcy, float %i.bcx, float %. ; 2 uses
  %i.bcz = getelementptr inbounds nuw [4 x i8], ptr %i.bcm, i64 %.0342776
  %i.bda = getelementptr inbounds nuw i8, ptr %i.bcz, i64 8
  %i.bdb = load float, ptr %i.bda, align 4, !tbaa !44 ; 2 uses
  %i.bdc = fcmp ogt float %..1, %i.bdb
  %..2 = select i1 %i.bdc, float %i.bdb, float %..1 ; 2 uses
  %i.bdd = getelementptr inbounds nuw [4 x i8], ptr %i.bcm, i64 %.0342776
  %i.bde = getelementptr inbounds nuw i8, ptr %i.bdd, i64 12
  %i.bdf = load float, ptr %i.bde, align 4, !tbaa !44 ; 2 uses
  %i.bdg = fcmp ogt float %..2, %i.bdf
  %..3 = select i1 %i.bdg, float %i.bdf, float %..2 ; 3 uses
  %i.bdh = add nuw nsw i64 %.0342776, 4           ; 2 uses
  %niter1349.next.3 = add nuw nsw i64 %niter1349, 4 ; 2 uses
  %niter1349.ncmp.3 = icmp eq i64 %niter1349.next.3, %unroll_iter1348
  br i1 %niter1349.ncmp.3, label %.loopexit727.loopexit.unr-lcssa, label %.lr.ph, !llvm.loop !92

.loopexit727.loopexit.unr-lcssa:                  ; preds = %.lr.ph
  %lcmp.mod1345.not = icmp eq i64 %xtraiter1343, 0
  br i1 %lcmp.mod1345.not, label %.loopexit727, label %.lr.ph.epil.preheader

.lr.ph.epil.preheader:                            ; preds = %.loopexit727.loopexit.unr-lcssa, %.lr.ph.preheader
  %.0342776.epil.init = phi i64 [ 0, %.lr.ph.preheader ], [ %i.bdh, %.loopexit727.loopexit.unr-lcssa ]
  %.0696775.epil.init = phi float [ f0x7F7FFFFF, %.lr.ph.preheader ], [ %..3, %.loopexit727.loopexit.unr-lcssa ]
  %lcmp.mod1347 = icmp ne i64 %xtraiter1343, 0
  call void @llvm.assume(i1 %lcmp.mod1347)
  br label %.lr.ph.epil

.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  %.0342776.epil = phi i64 [ %i.bdl, %.lr.ph.epil ], [ %.0342776.epil.init, %.lr.ph.epil.preheader ] ; 2 uses
  %.0696775.epil = phi float [ %..epil, %.lr.ph.epil ], [ %.0696775.epil.init, %.lr.ph.epil.preheader ] ; 2 uses
  %epil.iter1344 = phi i64 [ %epil.iter1344.next, %.lr.ph.epil ], [ 0, %.lr.ph.epil.preheader ]
  %i.bdi = getelementptr inbounds nuw [4 x i8], ptr %i.bcm, i64 %.0342776.epil
  %i.bdj = load float, ptr %i.bdi, align 4, !tbaa !44 ; 2 uses
  %i.bdk = fcmp ogt float %.0696775.epil, %i.bdj
  %..epil = select i1 %i.bdk, float %i.bdj, float %.0696775.epil ; 2 uses
  %i.bdl = add nuw nsw i64 %.0342776.epil, 1
  %epil.iter1344.next = add i64 %epil.iter1344, 1 ; 2 uses
  %epil.iter1344.cmp.not = icmp eq i64 %epil.iter1344.next, %xtraiter1343
  br i1 %epil.iter1344.cmp.not, label %.loopexit727, label %.lr.ph.epil, !llvm.loop !93
...
.loopexit727:                                     ; preds = %.loopexit727.loopexit.unr-lcssa, %.lr.ph.epil, %bb.di, %_ZN7meshoptL21fillAttributeQuadricsEPNS_7QuadricEPNS_11QuadricGradEPKjmPKNS_7Vector3EPKfm.exit
  ...
  %.0345 = phi ptr [ null, %_ZN7meshoptL21fillAttributeQuadricsEPNS_7QuadricEPNS_11QuadricGradEPKjmPKNS_7Vector3EPKfm.exit ], [ %i.bcf, %bb.di ], [ %i.bcf, %.lr.ph.epil ], [ %i.bcf, %.loopexit727.loopexit.unr-lcssa ] ; 2 uses
  %.0344 = phi ptr [ null, %_ZN7meshoptL21fillAttributeQuadricsEPNS_7QuadricEPNS_11QuadricGradEPKjmPKNS_7Vector3EPKfm.exit ], [ %i.bcm, %bb.di ], [ %i.bcm, %.lr.ph.epil ], [ %i.bcm, %.loopexit727.loopexit.unr-lcssa ] ; 5 uses
  %.0343 = phi i64 [ 0, %_ZN7meshoptL21fillAttributeQuadricsEPNS_7QuadricEPNS_11QuadricGradEPKjmPKNS_7Vector3EPKfm.exit ], [ 0, %bb.di ], [ %i.bcj, %.lr.ph.epil ], [ %i.bcj, %.loopexit727.loopexit.unr-lcssa ] ; 5 uses
...
vector.body1187:                                  ; preds = %vector.body1187, %vector.ph1185
  ...
  %vec.phi = phi <2 x i64> [ zeroinitializer, %vector.ph1185 ], [ %i.bef, %vector.body1187 ]
  %vec.phi1189 = phi <2 x i64> [ zeroinitializer, %vector.ph1185 ], [ %i.beg, %vector.body1187 ]
  %i.bdm = getelementptr inbounds nuw i8, ptr %i.jq, i64 %index1188 ; 2 uses
  %i.bdn = getelementptr inbounds nuw i8, ptr %i.bdm, i64 2
  %wide.load1190 = load <2 x i8>, ptr %i.bdm, align 1, !tbaa !29
  %wide.load1191 = load <2 x i8>, ptr %i.bdn, align 1, !tbaa !29
  %i.bdo = getelementptr inbounds nuw [4 x i8], ptr %i.er, i64 %index1188 ; 2 uses
  %i.bdp = getelementptr inbounds nuw i8, ptr %i.bdo, i64 4
  %i.bdq = getelementptr inbounds nuw i8, ptr %i.bdo, i64 12
  %wide.load1192 = load <2 x i32>, ptr %i.bdp, align 4, !tbaa !28 ; 3 uses
  %wide.load1193 = load <2 x i32>, ptr %i.bdq, align 4, !tbaa !28 ; 4 uses
  %i.bdr = shufflevector <2 x i32> %vector.recur, <2 x i32> %wide.load1192, <2 x i32> <i32 1, i32 2>
  %i.bds = shufflevector <2 x i32> %wide.load1192, <2 x i32> %wide.load1193, <2 x i32> <i32 1, i32 2>
  %i.bdt = sub <2 x i32> %wide.load1192, %i.bdr
  %i.bdu = sub <2 x i32> %wide.load1193, %i.bds
  %i.bdv = and <2 x i8> %wide.load1190, splat (i8 -3)
  %i.bdw = and <2 x i8> %wide.load1191, splat (i8 -3)
  %i.bdx = icmp eq <2 x i8> %i.bdv, zeroinitializer
  %i.bdy = icmp eq <2 x i8> %i.bdw, zeroinitializer
  %i.bdz = zext <2 x i32> %i.bdt to <2 x i64>
  %i.bea = zext <2 x i32> %i.bdu to <2 x i64>
  %i.beb = select <2 x i1> %i.bdx, <2 x i64> %i.bdz, <2 x i64> zeroinitializer
  %i.bec = select <2 x i1> %i.bdy, <2 x i64> %i.bea, <2 x i64> zeroinitializer
  %i.bed = freeze <2 x i64> %i.beb
  %i.bee = freeze <2 x i64> %i.bec
  %i.bef = add <2 x i64> %i.bed, %vec.phi         ; 2 uses
  %i.beg = add <2 x i64> %i.bee, %vec.phi1189     ; 2 uses
  %index.next1194 = add nuw i64 %index1188, 4     ; 2 uses
  %i.beh = icmp eq i64 %index.next1194, %n.vec1186
  br i1 %i.beh, label %middle.block1195, label %vector.body1187, !llvm.loop !94

middle.block1195:                                 ; preds = %vector.body1187
  %bin.rdx = add <2 x i64> %i.beg, %i.bef
  %i.bei = call i64 @llvm.vector.reduce.add.v2i64(<2 x i64> %bin.rdx) ; 2 uses
...
.lr.ph.i494.preheader:                            ; preds = %.lr.ph.preheader.i, %middle.block1195
  ...
  %.02.i.ph = phi i64 [ 0, %.lr.ph.preheader.i ], [ %i.bei, %middle.block1195 ]
  %.0161.i.ph = phi i64 [ 0, %.lr.ph.preheader.i ], [ %n.vec1186, %middle.block1195 ]
  br label %.lr.ph.i494

._crit_edge.loopexit.i:                           ; preds = %.lr.ph.i494, %middle.block1195
  %.lcssa1078 = phi i64 [ %i.bei, %middle.block1195 ], [ %i.beu, %.lr.ph.i494 ]
  %i.bej = lshr i64 %.lcssa1078, 1
  br label %_ZN7meshoptL18boundEdgeCollapsesERKNS_13EdgeAdjacencyEmmPh.exit

.lr.ph.i494:                                      ; preds = %.lr.ph.i494.preheader, %.lr.ph.i494
  %i.bek = phi i32 [ %i.bep, %.lr.ph.i494 ], [ %.ph, %.lr.ph.i494.preheader ]
  %.02.i = phi i64 [ %i.beu, %.lr.ph.i494 ], [ %.02.i.ph, %.lr.ph.i494.preheader ]
  %.0161.i = phi i64 [ %i.ben, %.lr.ph.i494 ], [ %.0161.i.ph, %.lr.ph.i494.preheader ] ; 2 uses
  %i.bel = getelementptr inbounds nuw i8, ptr %i.jq, i64 %.0161.i
  %i.bem = load i8, ptr %i.bel, align 1, !tbaa !29
  %i.ben = add nuw i64 %.0161.i, 1                ; 3 uses
  %i.beo = getelementptr inbounds nuw [4 x i8], ptr %i.er, i64 %i.ben
  %i.bep = load i32, ptr %i.beo, align 4, !tbaa !28 ; 2 uses
  %i.beq = sub i32 %i.bep, %i.bek
  %i.ber = and i8 %i.bem, -3
  %or.cond.i495 = icmp eq i8 %i.ber, 0
  %i.bes = zext i32 %i.beq to i64
  %i.bet = select i1 %or.cond.i495, i64 %i.bes, i64 0
  %.fr835 = freeze i64 %i.bet
  %i.beu = add i64 %.fr835, %.02.i                ; 2 uses
  %exitcond.not.i496 = icmp eq i64 %i.ben, %.0702
...
_ZN7meshoptL18boundEdgeCollapsesERKNS_13EdgeAdjacencyEmmPh.exit: ; preds = %.loopexit727, %._crit_edge.loopexit.i
  %.0.lcssa.i = phi i64 [ 0, %.loopexit727 ], [ %i.bej, %._crit_edge.loopexit.i ]
  %i.bev = add i64 %2, 3
  %i.bew = sub i64 %i.bev, %.0.lcssa.i            ; 6 uses
  %i.bex = load ptr, ptr @_ZZN17meshopt_Allocator7storageEvE1s, align 8, !tbaa !23
  %i.bey = icmp ugt i64 %i.bew, 1537228672809129301
  %i.bez = mul nuw i64 %i.bew, 12
  %i.bfa = select i1 %i.bey, i64 -1, i64 %i.bez
  %i.bfb = invoke noundef ptr %i.bex(i64 noundef %i.bfa)
...
bb.dk:                                            ; preds = %_ZN7meshoptL18boundEdgeCollapsesERKNS_13EdgeAdjacencyEmmPh.exit
  ...
  %i.bff = load ptr, ptr @_ZZN17meshopt_Allocator7storageEvE1s, align 8, !tbaa !23
  %i.bfg = icmp ugt i64 %i.bew, 4611686018427387903
  %i.bfh = shl nuw i64 %i.bew, 2
  %i.bfi = select i1 %i.bfg, i64 -1, i64 %i.bfh
  %i.bfj = invoke noundef ptr %i.bff(i64 noundef %i.bfi)
...
bb.dl:                                            ; preds = %bb.dk
  ...
  %i.bfn = load ptr, ptr @_ZZN17meshopt_Allocator7storageEvE1s, align 8, !tbaa !23
  %i.bfo = invoke noundef ptr %i.bfn(i64 noundef %i.jf)
...
bb.dm:                                            ; preds = %bb.dl
  ...
  %i.bfs = load ptr, ptr @_ZZN17meshopt_Allocator7storageEvE1s, align 8, !tbaa !23
  %i.bft = invoke noundef ptr %i.bfs(i64 noundef %.0702)
...
bb.dn:                                            ; preds = %bb.dm
  ...
  %i.bfx = and i32 %13, 4
  %.not406 = icmp eq i32 %i.bfx, 0
  %i.bfy = select i1 %.not406, float 1.000000e+00, float %i.zx ; 3 uses
  %i.bfz = fmul float %12, %12
  %i.bga = fmul float %i.bfy, %i.bfy
  %i.bgb = fdiv float %i.bfz, %i.bga              ; 5 uses
  %i.bgc = icmp ugt i64 %2, %11
  br i1 %i.bgc, label %.lr.ph784, label %_ZN7meshoptL15pruneComponentsEPjmPKjPKfmfRf.exit.thread

.lr.ph784:                                        ; preds = %bb.dn
  %i.bgd = icmp ult i64 %i.bew, 3
  %.not.i542 = icmp eq ptr %.0346, null
  br i1 %i.bgd, label %.lr.ph784.split.us, label %.preheader.i505.preheader.preheader
...
.preheader.i505.preheader.preheader:              ; preds = %.lr.ph784
  ...
  %xtraiter1366 = and i64 %.0330, 1
  %i.bge = icmp eq i64 %.0330, 1
  %unroll_iter1370 = and i64 %.0330, -2
  %lcmp.mod1368.not = icmp eq i64 %xtraiter1366, 0
  %lcmp.mod1369 = trunc i64 %.0330 to i1
...
.preheader.i505.preheader:                        ; preds = %.preheader.i505.preheader.preheader, %_ZN7meshoptL15pruneComponentsEPjmPKjPKfmfRf.exit
  ...
  %.0680781 = phi float [ %i.cve, %_ZN7meshoptL15pruneComponentsEPjmPKjPKfmfRf.exit ], [ 0.000000e+00, %.preheader.i505.preheader.preheader ] ; 2 uses
...
.preheader.i505:                                  ; preds = %.preheader.i505.preheader, %bb.el
  ...
  %.07792.i = phi i64 [ %i.bki, %bb.el ], [ 0, %.preheader.i505.preheader ] ; 2 uses
  %i.bgf = getelementptr [4 x i8], ptr %0, i64 %.07792.i ; 4 uses
  %i.bgg = load i32, ptr %i.bgf, align 4, !tbaa !28 ; 4 uses
  %i.bgh = getelementptr i8, ptr %i.bgf, i64 4    ; 2 uses
  %i.bgi = load i32, ptr %i.bgh, align 4, !tbaa !28 ; 9 uses
  %i.bgj = zext i32 %i.bgg to i64                 ; 3 uses
  %i.bgk = getelementptr inbounds nuw [4 x i8], ptr %i.jg, i64 %i.bgj
  %i.bgl = load i32, ptr %i.bgk, align 4, !tbaa !28 ; 3 uses
  %i.bgm = zext i32 %i.bgi to i64                 ; 8 uses
  %i.bgn = getelementptr inbounds nuw [4 x i8], ptr %i.jg, i64 %i.bgm
  %i.bgo = load i32, ptr %i.bgn, align 4, !tbaa !28 ; 6 uses
  %i.bgp = icmp eq i32 %i.bgl, %i.bgo
  br i1 %i.bgp, label %bb.dv, label %bb.do

bb.do:                                            ; preds = %.preheader.i505
  %i.bgq = getelementptr inbounds nuw i8, ptr %i.jq, i64 %i.bgj
  %i.bgr = load i8, ptr %i.bgq, align 1, !tbaa !29 ; 3 uses
  %i.bgs = getelementptr inbounds nuw i8, ptr %i.jq, i64 %i.bgm
  %i.bgt = load i8, ptr %i.bgs, align 1, !tbaa !29 ; 3 uses
  %i.bgu = zext i8 %i.bgr to i64                  ; 3 uses
  %i.bgv = getelementptr inbounds nuw [5 x i8], ptr @_ZN7meshoptL12kCanCollapseE, i64 %i.bgu
  %i.bgw = zext i8 %i.bgt to i64                  ; 3 uses
  %i.bgx = getelementptr inbounds nuw i8, ptr %i.bgv, i64 %i.bgw
  %i.bgy = load i8, ptr %i.bgx, align 1, !tbaa !29 ; 3 uses
  %i.bgz = getelementptr inbounds nuw [5 x i8], ptr @_ZN7meshoptL12kCanCollapseE, i64 %i.bgw
  %i.bha = getelementptr inbounds nuw i8, ptr %i.bgz, i64 %i.bgu
  %i.bhb = load i8, ptr %i.bha, align 1, !tbaa !29 ; 2 uses
  %i.bhc = or i8 %i.bhb, %i.bgy
  %.not.i506 = icmp eq i8 %i.bhc, 0
  br i1 %.not.i506, label %bb.dv, label %bb.dp

bb.dp:                                            ; preds = %bb.do
  %i.bhd = getelementptr inbounds nuw [5 x i8], ptr @_ZN7meshoptL12kHasOppositeE, i64 %i.bgu
  %i.bhe = getelementptr inbounds nuw i8, ptr %i.bhd, i64 %i.bgw
  %i.bhf = load i8, ptr %i.bhe, align 1, !tbaa !29
  %.not81.i = icmp ne i8 %i.bhf, 0
  %i.bhg = icmp ugt i32 %i.bgo, %i.bgl
  %or.cond86.i = and i1 %i.bhg, %.not81.i
  br i1 %or.cond86.i, label %bb.dv, label %bb.dq

bb.dq:                                            ; preds = %bb.dp
  %i.bhh = add i8 %i.bgr, -1
  %or.cond.i507 = icmp ult i8 %i.bhh, 2
  %i.bhi = icmp ne i8 %i.bgt, 0
  %or.cond5.i508 = and i1 %or.cond.i507, %i.bhi
  br i1 %or.cond5.i508, label %bb.dr, label %bb.ds

bb.dr:                                            ; preds = %bb.dq
  %i.bhj = getelementptr inbounds nuw [4 x i8], ptr %i.jv, i64 %i.bgj
  %i.bhk = load i32, ptr %i.bhj, align 4, !tbaa !28
  %.not82.i = icmp eq i32 %i.bhk, %i.bgi
  br i1 %.not82.i, label %bb.ds, label %bb.dv

bb.ds:                                            ; preds = %bb.dr, %bb.dq
  %i.bhl = add i8 %i.bgt, -1
  %or.cond8.i509 = icmp ult i8 %i.bhl, 2
  %i.bhm = icmp ne i8 %i.bgr, 0
  %or.cond11.i510 = and i1 %i.bhm, %or.cond8.i509
  br i1 %or.cond11.i510, label %bb.dt, label %bb.du

bb.dt:                                            ; preds = %bb.ds
  %i.bhn = getelementptr inbounds nuw [4 x i8], ptr %i.ka, i64 %i.bgm
  %i.bho = load i32, ptr %i.bhn, align 4, !tbaa !28
  %.not83.i = icmp eq i32 %i.bho, %i.bgg
  br i1 %.not83.i, label %bb.du, label %bb.dv

bb.du:                                            ; preds = %bb.dt, %bb.ds
  %i.bhp = and i8 %i.bhb, %i.bgy
  %.not84.i = icmp ne i8 %i.bhp, 0
  %.not85.i = icmp eq i8 %i.bgy, 0                ; 2 uses
  %.sink116.i = select i1 %.not85.i, i32 %i.bgi, i32 %i.bgg
  %.sink114.i = select i1 %.not85.i, i32 %i.bgg, i32 %i.bgi
  %.sink.i = zext i1 %.not84.i to i32
  %i.bhq = getelementptr inbounds nuw [12 x i8], ptr %i.bfb, i64 %.093.i ; 3 uses
  store i32 %.sink116.i, ptr %i.bhq, align 4, !tbaa !28
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.bhq, i64 4
  store i32 %.sink114.i, ptr %.sroa.4.0..sroa_idx.i, align 4, !tbaa !28
  %.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.bhq, i64 8
  store i32 %.sink.i, ptr %.sroa.5.0..sroa_idx.i, align 4, !tbaa !29
  %.2.i = add i64 %.093.i, 1
  %.pre.i511 = load i32, ptr %i.bgh, align 4, !tbaa !28 ; 2 uses
...
bb.dv:                                            ; preds = %bb.du, %bb.dt, %bb.dr, %bb.dp, %bb.do, %.preheader.i505
  %.pre-phi.i = phi i64 [ %.phi.trans.insert.i, %bb.du ], [ %i.bgm, %bb.do ], [ %i.bgm, %bb.dp ], [ %i.bgm, %bb.dr ], [ %i.bgm, %bb.dt ], [ %i.bgm, %.preheader.i505 ] ; 2 uses
  %i.bhr = phi i32 [ %.pre96.i, %bb.du ], [ %i.bgo, %bb.do ], [ %i.bgo, %bb.dp ], [ %i.bgo, %bb.dr ], [ %i.bgo, %bb.dt ], [ %i.bgl, %.preheader.i505 ] ; 3 uses
  %i.bhs = phi i32 [ %.pre.i511, %bb.du ], [ %i.bgi, %bb.do ], [ %i.bgi, %bb.dp ], [ %i.bgi, %bb.dr ], [ %i.bgi, %bb.dt ], [ %i.bgi, %.preheader.i505 ] ; 3 uses
  %.4.i = phi i64 [ %.2.i, %bb.du ], [ %.093.i, %bb.do ], [ %.093.i, %bb.dp ], [ %.093.i, %bb.dr ], [ %.093.i, %bb.dt ], [ %.093.i, %.preheader.i505 ] ; 7 uses
  %i.bht = getelementptr i8, ptr %i.bgf, i64 8    ; 2 uses
  %i.bhu = load i32, ptr %i.bht, align 4, !tbaa !28 ; 9 uses
  %i.bhv = zext i32 %i.bhu to i64                 ; 8 uses
  %i.bhw = getelementptr inbounds nuw [4 x i8], ptr %i.jg, i64 %i.bhv
  %i.bhx = load i32, ptr %i.bhw, align 4, !tbaa !28 ; 6 uses
  %i.bhy = icmp eq i32 %i.bhr, %i.bhx
  br i1 %i.bhy, label %bb.ed, label %bb.dw

bb.dw:                                            ; preds = %bb.dv
  %i.bhz = getelementptr inbounds nuw i8, ptr %i.jq, i64 %.pre-phi.i
  %i.bia = load i8, ptr %i.bhz, align 1, !tbaa !29 ; 3 uses
  %i.bib = getelementptr inbounds nuw i8, ptr %i.jq, i64 %i.bhv
  %i.bic = load i8, ptr %i.bib, align 1, !tbaa !29 ; 3 uses
  %i.bid = zext i8 %i.bia to i64                  ; 3 uses
  %i.bie = getelementptr inbounds nuw [5 x i8], ptr @_ZN7meshoptL12kCanCollapseE, i64 %i.bid
  %i.bif = zext i8 %i.bic to i64                  ; 3 uses
  %i.big = getelementptr inbounds nuw i8, ptr %i.bie, i64 %i.bif
  %i.bih = load i8, ptr %i.big, align 1, !tbaa !29 ; 3 uses
  %i.bii = getelementptr inbounds nuw [5 x i8], ptr @_ZN7meshoptL12kCanCollapseE, i64 %i.bif
  %i.bij = getelementptr inbounds nuw i8, ptr %i.bii, i64 %i.bid
  %i.bik = load i8, ptr %i.bij, align 1, !tbaa !29 ; 2 uses
  %i.bil = or i8 %i.bik, %i.bih
  %.not.1.i = icmp eq i8 %i.bil, 0
  br i1 %.not.1.i, label %bb.ed, label %bb.dx

bb.dx:                                            ; preds = %bb.dw
  %i.bim = getelementptr inbounds nuw [5 x i8], ptr @_ZN7meshoptL12kHasOppositeE, i64 %i.bid
  %i.bin = getelementptr inbounds nuw i8, ptr %i.bim, i64 %i.bif
  %i.bio = load i8, ptr %i.bin, align 1, !tbaa !29
  %.not81.1.i = icmp ne i8 %i.bio, 0
  %i.bip = icmp ugt i32 %i.bhx, %i.bhr
  %or.cond86.1.i = and i1 %i.bip, %.not81.1.i
  br i1 %or.cond86.1.i, label %bb.ed, label %bb.dy

bb.dy:                                            ; preds = %bb.dx
  %i.biq = add i8 %i.bia, -1
  %or.cond.1.i = icmp ult i8 %i.biq, 2
  %i.bir = icmp ne i8 %i.bic, 0
  %or.cond5.1.i = and i1 %or.cond.1.i, %i.bir
  br i1 %or.cond5.1.i, label %bb.dz, label %bb.ea

bb.dz:                                            ; preds = %bb.dy
  %i.bis = getelementptr inbounds nuw [4 x i8], ptr %i.jv, i64 %.pre-phi.i
  %i.bit = load i32, ptr %i.bis, align 4, !tbaa !28
  %.not82.1.i = icmp eq i32 %i.bit, %i.bhu
  br i1 %.not82.1.i, label %bb.ea, label %bb.ed

bb.ea:                                            ; preds = %bb.dz, %bb.dy
  %i.biu = add i8 %i.bic, -1
  %or.cond8.1.i = icmp ult i8 %i.biu, 2
  %i.biv = icmp ne i8 %i.bia, 0
  %or.cond11.1.i = and i1 %i.biv, %or.cond8.1.i
  br i1 %or.cond11.1.i, label %bb.eb, label %bb.ec

bb.eb:                                            ; preds = %bb.ea
  %i.biw = getelementptr inbounds nuw [4 x i8], ptr %i.ka, i64 %i.bhv
  %i.bix = load i32, ptr %i.biw, align 4, !tbaa !28
  %.not83.1.i = icmp eq i32 %i.bix, %i.bhs
  br i1 %.not83.1.i, label %bb.ec, label %bb.ed

bb.ec:                                            ; preds = %bb.eb, %bb.ea
  %i.biy = and i8 %i.bik, %i.bih
  %.not84.1.i = icmp ne i8 %i.biy, 0
  %.not85.1.i = icmp eq i8 %i.bih, 0              ; 2 uses
  %.sink122.i = select i1 %.not85.1.i, i32 %i.bhu, i32 %i.bhs
  %.sink120.i = select i1 %.not85.1.i, i32 %i.bhs, i32 %i.bhu
