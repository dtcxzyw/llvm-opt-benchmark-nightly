...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %0 = or disjoint <2 x i64> %i.ax, %i.ay
  %i.az = or disjoint <2 x i64> %0, %i.au
  %i.ba = or disjoint <2 x i64> %i.az, %i.ar
  %i.bb = or disjoint <2 x i64> %i.ba, %i.ao
  %i.bc = or <2 x i64> %i.bb, %i.al
  %i.bd = or <2 x i64> %i.bc, %i.ai
  %i.be = or <2 x i64> %i.bd, %i.af
