...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.ag = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ad, <2 x double> <double 2.000000e+00, double -5.000000e-01>, <2 x double> %i.af) ; 3 uses
  ...
  %i.cj = insertelement <2 x double> poison, double %i.ar, i64 0
  ...
  %i.es = extractelement <2 x double> %i.ag, i64 0
  ...
  %10 = extractelement <2 x double> %i.gb, i64 0
  %11 = fadd double %i.ar, %10                    ; 2 uses
  %12 = extractelement <2 x double> %i.gj, i64 0
  %13 = fadd double %i.cv, %12                    ; 2 uses
  %14 = fmul double %13, f0xBFFE6F0E134454FF
  %15 = fmul double %13, f0x3FF2CF2304755A5E
  %16 = tail call double @llvm.fmuladd.f64(double %11, double f0x3FFE6F0E134454FF, double %15) ; 2 uses
  %17 = fmul <2 x double> %i.gy, <double f0x3FE753B603D2B816, double f0x3FB0130A1BE09379>
  %18 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ha, <2 x double> <double f0x3FE5E7CF55112014, double f0x3FEFEFD5BFE443FE>, <2 x double> %17) ; 2 uses
  %i.hb = shufflevector <2 x double> %18, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.hc = fmul <2 x double> %i.hb, <double f0xBFFE6F0E134454FF, double f0x3FF2CF2304755A5E>
  %i.hd = shufflevector <2 x double> %18, <2 x double> poison, <2 x i32> zeroinitializer
  %i.he = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hd, <2 x double> <double f0x3FF2CF2304755A5E, double f0x3FFE6F0E134454FF>, <2 x double> %i.hc) ; 2 uses
  %19 = extractelement <2 x double> %i.p, i64 1   ; 2 uses
  %i.hf = fadd double %19, %i.aj                  ; 2 uses
  %20 = fmul <2 x double> %i.gy, <double f0xBFE5E7CF55112014, double f0xBFEFEFD5BFE443FE>
  %21 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ha, <2 x double> <double f0x3FE753B603D2B816, double f0x3FB0130A1BE09379>, <2 x double> %20) ; 2 uses
  %22 = getelementptr inbounds nuw i8, ptr %.0417424, i64 8
  %23 = load i64, ptr %22, align 8, !tbaa !11     ; 2 uses
  %24 = getelementptr inbounds [8 x i8], ptr %.0414427, i64 %23
  %25 = getelementptr inbounds nuw i8, ptr %.0417424, i64 32
  %26 = load i64, ptr %25, align 8, !tbaa !11     ; 2 uses
  %27 = getelementptr inbounds [8 x i8], ptr %.0428, i64 %26
  %28 = tail call double @llvm.fmuladd.f64(double %11, double f0x3FF2CF2304755A5E, double %14)
  %29 = shufflevector <2 x double> %21, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %30 = insertelement <2 x double> %29, double %i.fo, i64 0 ; 2 uses
  %31 = insertelement <2 x double> %21, double %i.gw, i64 0 ; 2 uses
  %32 = fadd <2 x double> %30, %31                ; 3 uses
  %33 = extractelement <2 x double> %32, i64 0
  %34 = tail call double @llvm.fmuladd.f64(double %33, double 2.000000e+00, double %i.es)
  store double %34, ptr %.0428, align 8, !tbaa !13
  %35 = insertelement <2 x double> %i.ag, double %i.hf, i64 1
  %i.hg = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %32, <2 x double> splat (double -5.000000e-01), <2 x double> %35) ; 4 uses
  %36 = fsub <2 x double> %30, %31
  %i.hh = fmul <2 x double> %36, splat (double f0x3FF1E3779B97F4A8) ; 4 uses
  %foldExtExtBinop432 = fadd <2 x double> %i.hh, %i.hg
  %i.hi = extractelement <2 x double> %foldExtExtBinop432, i64 0 ; 2 uses
  %37 = fsub double %i.hi, %16
  store double %37, ptr %i.ev, align 8, !tbaa !13
  %38 = fadd double %i.hi, %16
  store double %38, ptr %i.ey, align 8, !tbaa !13
  %39 = fsub <2 x double> %i.hg, %i.hh
  %40 = fadd <2 x double> %i.hg, %i.hh
  %41 = shufflevector <2 x double> %39, <2 x double> %40, <2 x i32> <i32 0, i32 3> ; 2 uses
  %i.hj = insertelement <2 x double> %i.he, double %28, i64 0 ; 2 uses
  %42 = fadd <2 x double> %41, %i.hj              ; 2 uses
  %43 = extractelement <2 x double> %42, i64 0
  %44 = extractelement <2 x double> %32, i64 1
  %45 = tail call double @llvm.fmuladd.f64(double %44, double 2.000000e+00, double %i.hf)
  %46 = fsub <2 x double> %41, %i.hj              ; 2 uses
  %i.hk = extractelement <2 x double> %46, i64 0
  store double %i.hk, ptr %i.fb, align 8, !tbaa !13
  store double %43, ptr %i.fe, align 8, !tbaa !13
  store double %45, ptr %24, align 8, !tbaa !13
  %i.hl = extractelement <2 x double> %46, i64 1
  store double %i.hl, ptr %27, align 8, !tbaa !13
  %i.hm = getelementptr inbounds nuw i8, ptr %.0417424, i64 88
  %i.hn = load i64, ptr %i.hm, align 8, !tbaa !11 ; 2 uses
  %i.ho = getelementptr inbounds [8 x i8], ptr %.0414427, i64 %i.hn
  %47 = extractelement <2 x double> %42, i64 1
  store double %47, ptr %i.ho, align 8, !tbaa !13
  %foldExtExtBinop434 = fsub <2 x double> %i.hg, %i.hh
  %48 = extractelement <2 x double> %foldExtExtBinop434, i64 1 ; 2 uses
  %i.hp = extractelement <2 x double> %i.he, i64 0 ; 2 uses
  %i.hq = fsub double %48, %i.hp
  ...
  %i.kr = getelementptr inbounds [8 x i8], ptr %.0414427, i64 %26
  ...
  %i.lx = getelementptr inbounds [8 x i8], ptr %.0428, i64 %23
  ...
  %i.mf = getelementptr inbounds [8 x i8], ptr %.0428, i64 %i.hn
