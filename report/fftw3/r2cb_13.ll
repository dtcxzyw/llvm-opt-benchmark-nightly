...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.ad = fsub double %i.j, %i.n                  ; 2 uses
  %10 = fneg double %i.ad
  %i.ae = insertelement <2 x double> poison, double %10, i64 0
  %i.af = insertelement <2 x double> %i.ae, double %i.ac, i64 1
  %11 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ab, <2 x double> <double 2.000000e+00, double -2.000000e+00>, <2 x double> %i.af) ; 4 uses
  %12 = fadd double %i.r, %i.ac
  %i.ag = fadd double %i.f, %i.ad
  %13 = insertelement <2 x double> poison, double %12, i64 0
  %14 = shufflevector <2 x double> %13, <2 x double> poison, <2 x i32> zeroinitializer
  %15 = fmul <2 x double> %14, <double f0xBFD64A2C7675B5D5, double f0x3FF2678D87F60797>
  %i.ah = insertelement <2 x double> poison, double %i.ag, i64 0
  %16 = shufflevector <2 x double> %i.ah, <2 x double> poison, <2 x i32> zeroinitializer
  %17 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %16, <2 x double> <double f0x3FF2678D87F60797, double f0x3FD64A2C7675B5D5>, <2 x double> %15) ; 2 uses
  %18 = fadd double %i.j, %i.n
  %19 = fsub double %i.v, %i.z
  %20 = insertelement <2 x double> poison, double %19, i64 0
  %21 = insertelement <2 x double> %20, double %18, i64 1
  %22 = fmul <2 x double> %21, splat (double f0x3FFBB67AE8584CAA) ; 4 uses
  %foldExtExtBinop = fsub <2 x double> %11, %22
  %foldExtExtBinop230 = fadd <2 x double> %11, %22
  %23 = shufflevector <2 x double> %foldExtExtBinop, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %24 = fmul <2 x double> %23, <double f0x3FD3371C1C9E25A7, double f0xBF87C14599EAC08D>
  %25 = shufflevector <2 x double> %foldExtExtBinop230, <2 x double> poison, <2 x i32> zeroinitializer
  %26 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %25, <2 x double> <double f0x3F87C14599EAC08D, double f0x3FD3371C1C9E25A7>, <2 x double> %24) ; 3 uses
  %27 = fsub <2 x double> %11, %22                ; 2 uses
  %28 = fadd <2 x double> %11, %22                ; 2 uses
  %i.ai = shufflevector <2 x double> %27, <2 x double> %28, <2 x i32> <i32 0, i32 3>
  %i.aj = shufflevector <2 x double> %28, <2 x double> %27, <2 x i32> <i32 1, i32 2>
  ...
  %i.cl = extractelement <2 x double> %17, i64 0  ; 2 uses
  ...
  %foldExtExtBinop230.a = fsub <2 x double> %26, %i.al
  %i.co = extractelement <2 x double> %foldExtExtBinop230.a, i64 0 ; 2 uses
  %i.cp = extractelement <2 x double> %17, i64 1  ; 2 uses
