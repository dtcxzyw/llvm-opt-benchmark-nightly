...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %10 = fadd double %i.al, %i.ap
  %11 = fadd double %i.aj, %i.ar
  %i.au = insertelement <2 x double> poison, double %10, i64 0
  %12 = shufflevector <2 x double> %i.au, <2 x double> poison, <2 x i32> zeroinitializer
  %13 = fmul <2 x double> %12, <double f0x3FE2CF2304755A5E, double f0xBFEE6F0E134454FF>
  %14 = insertelement <2 x double> poison, double %11, i64 0
  %i.av = shufflevector <2 x double> %14, <2 x double> poison, <2 x i32> zeroinitializer
  %i.aw = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.av, <2 x double> <double f0x3FEE6F0E134454FF, double f0x3FE2CF2304755A5E>, <2 x double> %13) ; 3 uses
