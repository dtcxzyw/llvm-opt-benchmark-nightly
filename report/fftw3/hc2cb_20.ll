...
begin_hunk_0_@hc2cb_20:bb.a
  ...
  %i.mt = fadd <2 x double> %i.mq, %i.ms          ; 3 uses
  ...
  %11 = extractelement <2 x double> %i.mt, i64 0
  %12 = extractelement <2 x double> %i.mt, i64 1
  ...
  %i.nn = fsub double %i.me, %i.lk                ; 2 uses
  %i.no = fadd double %10, %i.mf                  ; 2 uses
  ...
  %14 = fsub double %i.mu, %11
  %15 = fsub double %12, %i.mo
  %16 = fsub double %9, %i.md
  %17 = fsub double %i.mc, %i.lj
  %i.oj = insertelement <2 x double> poison, double %15, i64 0
  %i.ok = insertelement <2 x double> %i.oj, double %14, i64 1 ; 2 uses
  %18 = fmul <2 x double> %i.ok, splat (double f0x3FE2CF2304755A5E)
  %i.ol = insertelement <2 x double> poison, double %17, i64 0
  %i.om = insertelement <2 x double> %i.ol, double %16, i64 1 ; 2 uses
  %19 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.om, <2 x double> splat (double f0x3FEE6F0E134454FF), <2 x double> %18) ; 2 uses
  %i.on = fmul <2 x double> %i.ok, splat (double f0xBFEE6F0E134454FF)
  %i.oo = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.om, <2 x double> splat (double f0x3FE2CF2304755A5E), <2 x double> %i.on) ; 2 uses
  %i.op = fsub <2 x double> %i.oi, %19            ; 4 uses
  %i.oq = fadd <2 x double> %i.oi, %19            ; 3 uses
  ...
  %i.ou = fsub <2 x double> %13, %i.oo            ; 4 uses
  %i.ov = fadd <2 x double> %13, %i.oo            ; 4 uses
  %i.ow = shufflevector <2 x double> %i.ou, <2 x double> %i.ov, <2 x i32> <i32 0, i32 3>
  %i.ox = shufflevector <2 x double> %i.oq, <2 x double> %i.op, <2 x i32> <i32 0, i32 3>
  %i.oy = shufflevector <2 x double> %i.ov, <2 x double> %i.op, <2 x i32> <i32 1, i32 3>
  %i.oz = fneg <2 x double> %i.oy                 ; 2 uses
  %i.pa = shufflevector <2 x double> %i.oz, <2 x double> %i.ou, <2 x i32> <i32 0, i32 2>
  %i.pb = shufflevector <2 x double> %i.oz, <2 x double> %i.oq, <2 x i32> <i32 1, i32 2>
  %i.pc = shufflevector <2 x double> %i.ov, <2 x double> %i.ou, <2 x i32> <i32 0, i32 3>
  ...
  %i.qp = fmul <2 x double> %i.qn, %i.ot
  %i.qq = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.qo, <2 x double> %i.or, <2 x double> %i.qp) ; 2 uses
  ...
  %i.qv = fmul <2 x double> %i.qu, %i.pa
  %i.qw = shufflevector <2 x double> %i.qt, <2 x double> poison, <2 x i32> zeroinitializer
  %i.qx = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.qw, <2 x double> %i.ow, <2 x double> %i.qv) ; 2 uses
  ...
  %i.sg = shufflevector <2 x double> %i.ou, <2 x double> %i.se, <2 x i32> <i32 1, i32 3>
  %i.sh = fneg <2 x double> %i.sg                 ; 2 uses
  %i.si = shufflevector <2 x double> %i.sh, <2 x double> %i.ov, <2 x i32> <i32 0, i32 2>
