...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %10 = insertelement <2 x double> poison, double %i.t, i64 0 ; 2 uses
  %11 = insertelement <2 x double> %10, double %i.k, i64 1
  %12 = insertelement <2 x double> poison, double %i.x, i64 0 ; 2 uses
  %i.bb = insertelement <2 x double> %12, double %i.o, i64 1
  %13 = fsub <2 x double> %11, %i.bb              ; 2 uses
  %14 = shufflevector <2 x double> %13, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %15 = fmul <2 x double> %14, <double f0xBFFE6F0E134454FF, double f0x3FF2CF2304755A5E>
  %i.bc = shufflevector <2 x double> %13, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bd = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bc, <2 x double> <double f0x3FF2CF2304755A5E, double f0x3FFE6F0E134454FF>, <2 x double> %15) ; 2 uses
  ...
  %i.by = insertelement <2 x double> %10, double %i.at, i64 1
  %i.bz = insertelement <2 x double> %12, double %i.av, i64 1
  %i.ca = fadd <2 x double> %i.by, %i.bz          ; 3 uses
