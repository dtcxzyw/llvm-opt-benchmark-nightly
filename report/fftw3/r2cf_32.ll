...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %10 = insertelement <2 x double> poison, double %i.ay, i64 0
  %11 = insertelement <2 x double> %10, double %i.bh, i64 1
  %12 = insertelement <2 x double> poison, double %i.bc, i64 0
  %i.bp = insertelement <2 x double> %12, double %i.bl, i64 1
  %13 = fsub <2 x double> %11, %i.bp              ; 2 uses
  %14 = shufflevector <2 x double> %13, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %15 = fmul <2 x double> %14, <double f0x3FD87DE2A6AEA963, double f0xBFED906BCF328D46>
  %i.bq = shufflevector <2 x double> %13, <2 x double> poison, <2 x i32> zeroinitializer
  %i.br = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bq, <2 x double> <double f0x3FED906BCF328D46, double f0x3FD87DE2A6AEA963>, <2 x double> %15) ; 3 uses
  ...
  %16 = insertelement <2 x double> poison, double %i.bv, i64 0
  %17 = insertelement <2 x double> %16, double %i.ce, i64 1
  %18 = insertelement <2 x double> poison, double %i.bz, i64 0
  %i.cm = insertelement <2 x double> %18, double %i.ci, i64 1
  %19 = fsub <2 x double> %17, %i.cm              ; 2 uses
  %20 = shufflevector <2 x double> %19, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %21 = fmul <2 x double> %20, <double f0xBFD87DE2A6AEA963, double f0x3FED906BCF328D46>
  %i.cn = shufflevector <2 x double> %19, <2 x double> poison, <2 x i32> zeroinitializer
  %i.co = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cn, <2 x double> <double f0x3FED906BCF328D46, double f0x3FD87DE2A6AEA963>, <2 x double> %21) ; 3 uses
