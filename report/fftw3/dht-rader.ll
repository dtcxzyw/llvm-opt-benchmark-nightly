...
.lr.ph67.i.prol:                                  ; preds = %.lr.ph67.i.preheader28, %.lr.ph67.i.prol
  %.266.i.prol = phi i64 [ %i.br, %.lr.ph67.i.prol ], [ %.266.i.ph, %.lr.ph67.i.preheader28 ] ; 3 uses
  %prol.iter = phi i64 [ %prol.iter.next, %.lr.ph67.i.prol ], [ 0, %.lr.ph67.i.preheader28 ]
  %i.bm = sub nuw nsw i64 %i.ac, %.266.i.prol
  %i.bn = getelementptr inbounds nuw [8 x i8], ptr %i.z, i64 %i.bm
  %i.bo = load double, ptr %i.bn, align 8, !tbaa !30
  %i.bp = sub nsw i64 %i.u, %.266.i.prol
  %i.bq = getelementptr inbounds [8 x i8], ptr %i.z, i64 %i.bp
  store double %i.bo, ptr %i.bq, align 8, !tbaa !30
  %i.br = add nuw nsw i64 %.266.i.prol, 1         ; 2 uses
...
.lr.ph67.i.prol.loopexit:                         ; preds = %.lr.ph67.i.prol, %.lr.ph67.i.preheader28
  %.266.i.unr = phi i64 [ %.266.i.ph, %.lr.ph67.i.preheader28 ], [ %i.br, %.lr.ph67.i.prol ]
  %i.bs = icmp ult i64 %i.bl, 7
  br i1 %i.bs, label %.loopexit.i, label %.lr.ph67.i

.lr.ph67.i:                                       ; preds = %.lr.ph67.i.prol.loopexit, %.lr.ph67.i
  %.266.i = phi i64 [ %i.do, %.lr.ph67.i ], [ %.266.i.unr, %.lr.ph67.i.prol.loopexit ] ; 10 uses
  %i.bt = sub nuw nsw i64 %i.ac, %.266.i
  %i.bu = getelementptr inbounds nuw [8 x i8], ptr %i.z, i64 %i.bt
  %i.bv = load double, ptr %i.bu, align 8, !tbaa !30
  %i.bw = sub nsw i64 %i.u, %.266.i
  %i.bx = getelementptr inbounds [8 x i8], ptr %i.z, i64 %i.bw
  store double %i.bv, ptr %i.bx, align 8, !tbaa !30
  %i.by = add nuw nsw i64 %.266.i, 1              ; 2 uses
  %i.bz = sub nuw nsw i64 %i.ac, %i.by
  %i.ca = getelementptr inbounds nuw [8 x i8], ptr %i.z, i64 %i.bz
  %i.cb = load double, ptr %i.ca, align 8, !tbaa !30
  %i.cc = sub nsw i64 %i.u, %i.by
  %i.cd = getelementptr inbounds [8 x i8], ptr %i.z, i64 %i.cc
  store double %i.cb, ptr %i.cd, align 8, !tbaa !30
  %i.ce = add nuw nsw i64 %.266.i, 2              ; 2 uses
  %i.cf = sub nuw nsw i64 %i.ac, %i.ce
  %i.cg = getelementptr inbounds nuw [8 x i8], ptr %i.z, i64 %i.cf
  %i.ch = load double, ptr %i.cg, align 8, !tbaa !30
  %i.ci = sub nsw i64 %i.u, %i.ce
  %i.cj = getelementptr inbounds [8 x i8], ptr %i.z, i64 %i.ci
  store double %i.ch, ptr %i.cj, align 8, !tbaa !30
  %i.ck = add nuw nsw i64 %.266.i, 3              ; 2 uses
  %i.cl = sub nuw nsw i64 %i.ac, %i.ck
  %i.cm = getelementptr inbounds nuw [8 x i8], ptr %i.z, i64 %i.cl
  %i.cn = load double, ptr %i.cm, align 8, !tbaa !30
  %i.co = sub nsw i64 %i.u, %i.ck
  %i.cp = getelementptr inbounds [8 x i8], ptr %i.z, i64 %i.co
  store double %i.cn, ptr %i.cp, align 8, !tbaa !30
  %i.cq = add nuw nsw i64 %.266.i, 4              ; 2 uses
  %i.cr = sub nuw nsw i64 %i.ac, %i.cq
  %i.cs = getelementptr inbounds nuw [8 x i8], ptr %i.z, i64 %i.cr
  %i.ct = load double, ptr %i.cs, align 8, !tbaa !30
  %i.cu = sub nsw i64 %i.u, %i.cq
  %i.cv = getelementptr inbounds [8 x i8], ptr %i.z, i64 %i.cu
  store double %i.ct, ptr %i.cv, align 8, !tbaa !30
  %i.cw = add nuw nsw i64 %.266.i, 5              ; 2 uses
  %i.cx = sub nuw nsw i64 %i.ac, %i.cw
  %i.cy = getelementptr inbounds nuw [8 x i8], ptr %i.z, i64 %i.cx
  %i.cz = load double, ptr %i.cy, align 8, !tbaa !30
  %i.da = sub nsw i64 %i.u, %i.cw
  %i.db = getelementptr inbounds [8 x i8], ptr %i.z, i64 %i.da
  store double %i.cz, ptr %i.db, align 8, !tbaa !30
  %i.dc = add nuw nsw i64 %.266.i, 6              ; 2 uses
  %i.dd = sub nuw nsw i64 %i.ac, %i.dc
  %i.de = getelementptr inbounds nuw [8 x i8], ptr %i.z, i64 %i.dd
  %i.df = load double, ptr %i.de, align 8, !tbaa !30
  %i.dg = sub nsw i64 %i.u, %i.dc
  %i.dh = getelementptr inbounds [8 x i8], ptr %i.z, i64 %i.dg
  store double %i.df, ptr %i.dh, align 8, !tbaa !30
  %i.di = add nuw nsw i64 %.266.i, 7              ; 2 uses
  %i.dj = sub nuw nsw i64 %i.ac, %i.di
  %i.dk = getelementptr inbounds nuw [8 x i8], ptr %i.z, i64 %i.dj
  %i.dl = load double, ptr %i.dk, align 8, !tbaa !30
  %i.dm = sub nsw i64 %i.u, %i.di
  %i.dn = getelementptr inbounds [8 x i8], ptr %i.z, i64 %i.dm
  store double %i.dl, ptr %i.dn, align 8, !tbaa !30
  %i.do = add nuw nsw i64 %.266.i, 8              ; 2 uses
  %exitcond70.not.i.7 = icmp eq i64 %i.do, %i.ac
...
.loopexit.i:                                      ; preds = %.lr.ph67.i.prol.loopexit, %.lr.ph67.i, %middle.block, %._crit_edge65.i
  %i.dp = getelementptr inbounds nuw i8, ptr %i.r, i64 56
  %i.dq = load ptr, ptr %i.dp, align 8, !tbaa !31
  call void %i.dq(ptr noundef %i.r, ptr noundef %i.z, ptr noundef %i.z) #6, !inline_history !48
...
mkomega.exit:                                     ; preds = %bb.c, %.loopexit.i
  ...
  store ptr %.053.i, ptr %i.dr, align 8, !tbaa !25
  br label %bb.i
