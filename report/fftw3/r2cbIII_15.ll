...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %10 = fsub double %i.ap, %i.at
  %11 = fsub double %i.av, %i.az
  ...
  %13 = fmul <2 x double> %12, <double f0xBFFA5B4064AE062C, double f0x3FF04A07E1338541>
  ...
  %i.bd = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bc, <2 x double> <double f0x3FF04A07E1338541, double f0x3FFA5B4064AE062C>, <2 x double> %13) ; 2 uses
