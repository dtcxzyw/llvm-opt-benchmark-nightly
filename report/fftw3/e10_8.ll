...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.aw = insertelement <2 x double> poison, double %i.k, i64 0
  %i.ax = insertelement <2 x double> %i.aw, double %i.c, i64 1
  %i.ay = insertelement <2 x double> poison, double %i.o, i64 0
  ...
  %7 = fadd double %i.ab, %i.af                   ; 2 uses
  %8 = fadd double %i.k, %i.o                     ; 2 uses
  %9 = fadd double %i.s, %i.w                     ; 2 uses
  %10 = fadd double %i.c, %i.g                    ; 2 uses
  %11 = fadd double %10, %8                       ; 2 uses
  %12 = fadd double %9, %7                        ; 2 uses
  %13 = fsub double %11, %12
  %14 = fmul double %13, f0x3FF6A09E667F3BCD
  %15 = fadd double %11, %12
  %16 = fmul double %15, 2.000000e+00
  store double %14, ptr %i.ar, align 8, !tbaa !13
  store double %16, ptr %.09097, align 8, !tbaa !13
  ...
  %21 = fmul <2 x double> %20, <double f0xBFE87DE2A6AEA963, double f0x3FFD906BCF328D46>
  %22 = insertelement <2 x double> poison, double %18, i64 0
  %i.bx = shufflevector <2 x double> %22, <2 x double> poison, <2 x i32> zeroinitializer
  %i.by = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bx, <2 x double> <double f0x3FFD906BCF328D46, double f0x3FE87DE2A6AEA963>, <2 x double> %21) ; 2 uses
