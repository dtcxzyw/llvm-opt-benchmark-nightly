...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %.0110115 = phi ptr [ %i.c, %.lr.ph ], [ %i.br, %bb.b ] ; 4 uses
  %.0111114 = phi ptr [ %5, %.lr.ph ], [ %i.bs, %bb.b ] ; 2 uses
  %.0112113 = phi i64 [ %6, %.lr.ph ], [ %i.bm, %bb.b ]
  %9 = getelementptr inbounds nuw i8, ptr %.0110115, i64 8
  %i.f = getelementptr inbounds nuw i8, ptr %.0110115, i64 16
  %10 = load double, ptr %9, align 8, !tbaa !13   ; 3 uses
  %11 = load double, ptr %.0110115, align 8, !tbaa !13 ; 3 uses
  ...
  %i.k = fmul <2 x double> %13, %i.j
  %14 = insertelement <2 x double> poison, double %11, i64 0
  %i.l = shufflevector <2 x double> %14, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.ba = fmul double %10, %i.az
  %i.bb = tail call double @llvm.fmuladd.f64(double %11, double %i.ax, double %i.ba)
  store double %i.bb, ptr %.0107118, align 8, !tbaa !13
  %i.bc = fmul double %10, %i.ax
  %i.bd = tail call double @llvm.fmuladd.f64(double %11, double %i.ay, double %i.bc)
