...
begin_hunk_0_@_ZN7msdfgen21SimpleContourCombinerINS_21MultiDistanceSelectorEE5resetERKNS_7Vector2E
...
.noexc8:                                          ; preds = %_ZNSt12_Vector_baseIiSaIiEE11_M_allocateEm.exit.i
  %i.o = load ptr, ptr %i.a, align 8, !tbaa !17   ; 4 uses
...
_ZNSt12_Vector_baseIiSaIiEE13_M_deallocateEPim.exit.i: ; preds = %bb.e, %_ZNSt6vectorIiSaIiEE11_S_relocateEPiS2_S2_RS0_.exit.i
  store ptr %i.n, ptr %i.a, align 8, !tbaa !17
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %_ZNSt6vectorIiSaIiEE7reserveEm.exit
  ...
  %.lcssa = phi ptr [ %i.y, %_ZNSt6vectorIiSaIiEE7reserveEm.exit ], [ %i.bo, %._crit_edge.loopexit ]
...
_ZSt8_DestroyIPN7msdfgen20TrueDistanceSelectorES1_EvT_S3_RSaIT0_E.exit.i.i: ; preds = %bb.h
  store ptr %i.aq, ptr %i.ag, align 8, !tbaa !23
...
bb.j:                                             ; preds = %.lr.ph, %_ZNSt6vectorIiSaIiEE9push_backEOi.exit
  %.sroa.015.021 = phi ptr [ %i.z, %.lr.ph ], [ %i.bo, %_ZNSt6vectorIiSaIiEE9push_backEOi.exit ] ; 2 uses
...
bb.m:                                             ; preds = %bb.k
  %i.aw = load ptr, ptr %i.a, align 8, !tbaa !17  ; 4 uses
...
_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc.exit.i.i.i: ; preds = %bb.m
  %i.bb = ashr exact i64 %i.az, 2
  %mul2.i.i.i = ashr exact i64 %i.az, 1
  %2 = tail call i64 @llvm.umax.i64(i64 %mul2.i.i.i, i64 1) ; 2 uses
  %i.bc = icmp ult i64 %2, %i.bb
  %i.bd = tail call i64 @llvm.umin.i64(i64 %2, i64 2305843009213693951)
  %i.be = select i1 %i.bc, i64 2305843009213693951, i64 %i.bd ; 2 uses
...
.noexc12:                                         ; preds = %_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc.exit.i.i.i
  %i.bh = getelementptr inbounds i8, ptr %i.bg, i64 %i.az ; 2 uses
  store i32 %i.as, ptr %i.bh, align 4, !tbaa !25
  %i.bi = icmp sgt i64 %i.az, 0
  br i1 %i.bi, label %bb.o, label %_ZNSt6vectorIiSaIiEE11_S_relocateEPiS2_S2_RS0_.exit16.i.i.i

bb.o:                                             ; preds = %.noexc12
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 4 %i.bg, ptr align 4 %i.aw, i64 %i.az, i1 false)
...
bb.p:                                             ; preds = %_ZNSt6vectorIiSaIiEE11_S_relocateEPiS2_S2_RS0_.exit16.i.i.i
  %i.bk = load ptr, ptr %i.k, align 8, !tbaa !19
  %i.bl = ptrtoint ptr %i.bk to i64
  %i.bm = sub i64 %i.bl, %i.ay
  tail call void @_ZdlPvm(ptr noundef nonnull %i.aw, i64 noundef %i.bm) #14
...
_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i.i: ; preds = %bb.p, %_ZNSt6vectorIiSaIiEE11_S_relocateEPiS2_S2_RS0_.exit16.i.i.i
  ...
  store ptr %i.bj, ptr %i.aa, align 8, !tbaa !18
  %i.bn = getelementptr inbounds nuw [4 x i8], ptr %i.bg, i64 %i.be
  store ptr %i.bn, ptr %i.k, align 8, !tbaa !19
  br label %_ZNSt6vectorIiSaIiEE9push_backEOi.exit
...
bb.q:                                             ; preds = %.loopexit, %.loopexit.split-lp, %bb.i
  ...
  %i.bq = load ptr, ptr %i.b, align 8, !tbaa !24  ; 3 uses
...
bb.r:                                             ; preds = %bb.q
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %i.bq, i64 noundef %i.bv) #14
...
_ZNSt6vectorIN7msdfgen20TrueDistanceSelectorESaIS1_EED2Ev.exit: ; preds = %bb.q, %bb.r
  %i.bw = load ptr, ptr %i.a, align 8, !tbaa !17  ; 3 uses
  %.not.i.i.i13 = icmp eq ptr %i.bw, null
...
bb.s:                                             ; preds = %_ZNSt6vectorIN7msdfgen20TrueDistanceSelectorESaIS1_EED2Ev.exit
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %i.bw, i64 noundef %i.cb) #14
...
bb.a:
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef nonnull align 8 dereferenceable(16) %1, i64 16, i1 false), !tbaa.struct !28
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %i.f = load ptr, ptr %i.c, align 8, !tbaa !50
...
bb.a:
  ...
  store <2 x double> <double f0xFFEFFFFFFFFFFFFF, double 0.000000e+00>, ptr %i.j, align 8, !tbaa !9
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #15
  %i.k = getelementptr inbounds nuw i8, ptr %2, i64 16
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %2, i8 0, i64 16, i1 false)
  store <2 x double> <double f0xFFEFFFFFFFFFFFFF, double 0.000000e+00>, ptr %i.k, align 8, !tbaa !9
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #15
  %i.l = getelementptr inbounds nuw i8, ptr %3, i64 16
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %3, i8 0, i64 16, i1 false)
  store <2 x double> <double f0xFFEFFFFFFFFFFFFF, double 0.000000e+00>, ptr %i.l, align 8, !tbaa !9
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %_ZNSt6vectorIiSaIiEE7reserveEm.exit
  ...
  %i.ai = load ptr, ptr %i.b, align 8, !tbaa !32  ; 2 uses
  %i.aj = ptrtoint ptr %i.ah to i64
  %i.ak = ptrtoint ptr %i.ai to i64
  %i.al = sub i64 %i.aj, %i.ak
...
_ZSt8_DestroyIPN7msdfgen29PerpendicularDistanceSelectorES1_EvT_S3_RSaIT0_E.exit.i.i: ; preds = %bb.h
  store ptr %i.aq, ptr %i.ag, align 8, !tbaa !31
...
bb.q:                                             ; preds = %.loopexit, %.loopexit.split-lp, %bb.i
  %.pn = phi { ptr, i32 } [ %i.ar, %bb.i ], [ %lpad.loopexit, %.loopexit ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ]
  %i.bq = load ptr, ptr %i.b, align 8, !tbaa !32  ; 3 uses
  %.not.i.i.i = icmp eq ptr %i.bq, null
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %i.f = load ptr, ptr %i.c, align 8, !tbaa !57
  %.not = icmp eq ptr %i.e, %i.f
...
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.b = sext i32 %1 to i64
  %i.c = load ptr, ptr %i.a, align 8, !tbaa !32
...
bb.q:                                             ; preds = %.loopexit, %.loopexit.split-lp, %bb.i
  %.pn = phi { ptr, i32 } [ %i.ar, %bb.i ], [ %lpad.loopexit, %.loopexit ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ]
  %i.bq = load ptr, ptr %i.b, align 8, !tbaa !37  ; 3 uses
  %.not.i.i.i = icmp eq ptr %i.bq, null
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %i.f = load ptr, ptr %i.c, align 8, !tbaa !64
  %.not = icmp eq ptr %i.e, %i.f
...
._crit_edge:                                      ; preds = %.thread, %bb.a
  ...
  %i.w = load double, ptr %7, align 8, !tbaa !40  ; 6 uses
  %i.x = getelementptr inbounds nuw i8, ptr %7, i64 8
  %i.y = load double, ptr %i.x, align 8, !tbaa !41 ; 6 uses
  %i.z = getelementptr inbounds nuw i8, ptr %7, i64 16
  %i.aa = load double, ptr %i.z, align 8, !tbaa !42 ; 4 uses
  ...
  %i.aj = load double, ptr %8, align 8, !tbaa !40 ; 6 uses
  %i.ak = getelementptr inbounds nuw i8, ptr %8, i64 8
  %i.al = load double, ptr %i.ak, align 8, !tbaa !41 ; 6 uses
end_hunk_2
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %_ZNSt6vectorIiSaIiEE7reserveEm.exit
  ...
  %i.ai = load ptr, ptr %i.b, align 8, !tbaa !46  ; 2 uses
  %i.aj = ptrtoint ptr %i.ah to i64
  %i.ak = ptrtoint ptr %i.ai to i64
  %i.al = sub i64 %i.aj, %i.ak
  %i.am = sdiv exact i64 %i.al, 160               ; 3 uses
...
_ZSt8_DestroyIPN7msdfgen28MultiAndTrueDistanceSelectorES1_EvT_S3_RSaIT0_E.exit.i.i: ; preds = %bb.h
  store ptr %i.aq, ptr %i.ag, align 8, !tbaa !45
