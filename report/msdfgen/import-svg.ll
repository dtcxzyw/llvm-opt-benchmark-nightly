...
bb.at:                                            ; preds = %bb.as, %bb.ar
  %.sroa.14.0.i = phi double [ %27, %bb.as ], [ %i.me, %bb.ar ] ; 2 uses
  %.sroa.0140.0.i = phi double [ %28, %bb.as ], [ %i.mf, %bb.ar ] ; 2 uses
  %29 = phi <2 x double> [ %26, %bb.as ], [ %15, %bb.ar ] ; 6 uses
  %i.mg = extractelement <2 x double> %i.ma, i64 0
  %i.mh = fmul double %i.mg, %.sroa.0140.0.i
  %i.mi = extractelement <2 x double> %i.ma, i64 1
  %i.mj = call double @llvm.fmuladd.f64(double %.sroa.14.0.i, double %i.mi, double %i.mh)
  %i.mk = fmul double %.sroa.14.0.i, %.sroa.0140.0.i
  ...
  %foldExtExtBinop1494 = fmul <2 x double> %shift1493, %i.nj
  ...
  %48 = shufflevector <2 x double> %foldExtExtBinop1494, <2 x double> %i.nj, <2 x i32> <i32 0, i32 3>
