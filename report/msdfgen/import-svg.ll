...
bb.at:                                            ; preds = %bb.as, %bb.ar
  ...
  %13 = fmul double %i.op, %i.ox
  %14 = fadd double %i.oi, %i.pa
  %i.pb = call noundef double @llvm.fmuladd.f64(double %i.oi, double %i.ou, double %13)
  %i.pc = insertelement <2 x double> poison, double %i.pb, i64 0
  %i.pd = insertelement <2 x double> %i.pc, double %14, i64 1
