...
bb.at:                                            ; preds = %bb.as, %bb.ar
  ...
  %.sroa.0140.0.i.a = phi double [ %24, %bb.as ], [ %14, %bb.ar ] ; 4 uses
  %.sroa.8.0.i.a = phi double [ %25, %bb.as ], [ %i.mf, %bb.ar ] ; 2 uses
  ...
  %i.mj = call double @llvm.fmuladd.f64(double %.sroa.8.0.i.a, double %i.mi, double %i.mh)
  %i.mk = fmul double %.sroa.8.0.i.a, %.sroa.8.0.i
  ...
  %30 = fdiv double %29, %.sroa.0140.0.i.a
  %31 = fneg double %i.ms
  %32 = fmul double %.sroa.0140.0.i.a, %31
  ...
  %52 = insertelement <2 x double> poison, double %.sroa.0140.0.i.a, i64 0
  ...
  %foldExtExtBinop1498 = fmul <2 x double> %i.nj, %shift1497
  ...
  %53 = shufflevector <2 x double> %foldExtExtBinop1498, <2 x double> %i.nj, <2 x i32> <i32 0, i32 2>
...
bb.ay:                                            ; preds = %.preheader.i
  ...
  %i.qk = fmul double %.sroa.0140.0.i.a, %i.pq    ; 2 uses
