...
bb.ar:                                            ; preds = %bb.an
  ...
  %13 = insertelement <2 x double> poison, double %i.lv, i64 0 ; 2 uses
...
bb.at:                                            ; preds = %bb.as, %bb.ar
  ...
  %14 = shufflevector <2 x double> %i.mc, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  ...
  %i.oa = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %14, <2 x double> %i.nz, <2 x double> %i.nx)
...
.preheader.lr.ph.i:                               ; preds = %bb.ax
  ...
  %i.qn = insertelement <2 x double> %13, double %i.lw, i64 1 ; 3 uses
...
bb.ay:                                            ; preds = %.preheader.i
  ...
  %i.sh = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %14, <2 x double> %i.sg, <2 x double> %i.se)
