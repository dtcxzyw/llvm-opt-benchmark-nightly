...
bb.ar:                                            ; preds = %bb.an
  %13 = call double @llvm.fabs.f64(double %i.jq)  ; 2 uses
  %14 = call double @llvm.fabs.f64(double %i.jv)  ; 2 uses
  ...
  %15 = insertelement <2 x double> poison, double %i.jv, i64 0
  %i.lx = insertelement <2 x double> %15, double %i.jq, i64 1 ; 2 uses
  %16 = fmul <2 x double> %i.lx, %i.lx            ; 3 uses
  %17 = shufflevector <2 x double> %i.lv, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %18 = insertelement <2 x double> poison, double %i.ls, i64 0
  %i.ly = insertelement <2 x double> %18, double %i.lt, i64 1 ; 4 uses
  %19 = fmul <2 x double> %17, %i.ly
  %20 = shufflevector <2 x double> %i.ly, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 3 uses
  %i.lz = insertelement <2 x double> %20, double %i.lw, i64 0
  %21 = shufflevector <2 x double> %i.lv, <2 x double> poison, <2 x i32> zeroinitializer
  %22 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.lz, <2 x double> %21, <2 x double> %19) ; 8 uses
  %i.ma = fmul <2 x double> %22, %22              ; 3 uses
  %i.mb = fdiv <2 x double> %i.ma, %16            ; 2 uses
  ...
  %i.me = extractelement <2 x double> %16, i64 0
  %i.mf = extractelement <2 x double> %16, i64 1
  br i1 %i.md, label %bb.as, label %bb.at

bb.as:                                            ; preds = %bb.ar
  %sqrt.i = call double @llvm.sqrt.f64(double %i.mc) ; 2 uses
  %23 = fmul double %13, %sqrt.i                  ; 3 uses
  %24 = fmul double %14, %sqrt.i                  ; 3 uses
  %25 = fmul double %23, %23
  %26 = fmul double %24, %24
  br label %bb.at

bb.at:                                            ; preds = %bb.as, %bb.ar
  %.sroa.0260.0.i = phi double [ %23, %bb.as ], [ %13, %bb.ar ] ; 6 uses
  %.sroa.14.0.i = phi double [ %24, %bb.as ], [ %14, %bb.ar ] ; 4 uses
  %.sroa.0140.0.i = phi double [ %25, %bb.as ], [ %i.mf, %bb.ar ] ; 2 uses
  %.sroa.8.0.i = phi double [ %26, %bb.as ], [ %i.me, %bb.ar ] ; 2 uses
  %i.mg = extractelement <2 x double> %i.ma, i64 1
  %i.mh = fmul double %i.mg, %.sroa.8.0.i
  %i.mi = extractelement <2 x double> %i.ma, i64 0
  %i.mj = call double @llvm.fmuladd.f64(double %.sroa.0140.0.i, double %i.mi, double %i.mh)
  %i.mk = fmul double %.sroa.0140.0.i, %.sroa.8.0.i
  ...
  %27 = fmul double %.sroa.0260.0.i, %i.ms
  %28 = extractelement <2 x double> %22, i64 0
  %29 = fmul double %28, %27
  %30 = fdiv double %29, %.sroa.14.0.i
  %31 = fneg double %i.ms
  %32 = fmul double %.sroa.14.0.i, %31
  %33 = extractelement <2 x double> %22, i64 1
  %34 = fmul double %33, %32
  %35 = fdiv double %34, %.sroa.0260.0.i          ; 3 uses
  %36 = fadd <2 x double> %i.am, %i.lf
  %37 = fneg double %35
  %38 = fmul <2 x double> %36, splat (double 5.000000e-01)
  %39 = insertelement <2 x double> poison, double %i.lt, i64 0
  %40 = insertelement <2 x double> %39, double %i.ls, i64 1 ; 3 uses
  %i.mt = insertelement <2 x double> poison, double %37, i64 0
  %41 = insertelement <2 x double> %i.mt, double %35, i64 1
  %i.mu = fmul <2 x double> %40, %41
  %42 = shufflevector <2 x double> %40, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %43 = insertelement <2 x double> poison, double %30, i64 0
  %44 = shufflevector <2 x double> %43, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.mv = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %42, <2 x double> %44, <2 x double> %i.mu)
  %i.mw = fadd <2 x double> %38, %i.mv            ; 3 uses
  %45 = fneg <2 x double> %22
  %46 = shufflevector <2 x double> %22, <2 x double> %45, <2 x i32> <i32 1, i32 3>
  %i.mx = fsub <2 x double> %46, %44
  %47 = insertelement <2 x double> poison, double %.sroa.0260.0.i, i64 0
  %48 = shufflevector <2 x double> %47, <2 x double> poison, <2 x i32> zeroinitializer
  %i.my = fdiv <2 x double> %i.mx, %48            ; 4 uses
  %i.mz = extractelement <2 x double> %i.my, i64 0 ; 4 uses
  %i.na = fmul double %i.mz, 0.000000e+00
  %49 = fneg <2 x double> %22
  %50 = shufflevector <2 x double> %22, <2 x double> %49, <2 x i32> <i32 0, i32 2>
  %51 = insertelement <2 x double> poison, double %35, i64 0
  %i.nb = shufflevector <2 x double> %51, <2 x double> poison, <2 x i32> zeroinitializer
  %i.nc = fsub <2 x double> %50, %i.nb
  %52 = insertelement <2 x double> poison, double %.sroa.14.0.i, i64 0
  %i.nd = shufflevector <2 x double> %52, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.ne = fdiv <2 x double> %i.nc, %i.nd          ; 4 uses
  %i.nf = extractelement <2 x double> %i.ne, i64 0 ; 4 uses
  ...
  %i.nk = extractelement <2 x double> %i.my, i64 1 ; 2 uses
  %i.nl = fneg double %i.nk
  %i.nm = fmul double %i.nf, %i.nl
  %i.nn = extractelement <2 x double> %i.ne, i64 1 ; 2 uses
  %i.no = call noundef double @llvm.fmuladd.f64(double %i.mz, double %i.nn, double %i.nm)
  %i.np = fcmp ogt double %i.no, 0.000000e+00
  %shift1493 = shufflevector <2 x double> %i.nj, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop1494 = fmul <2 x double> %i.nj, %shift1493
  ...
  %53 = shufflevector <2 x double> %foldExtExtBinop1494, <2 x double> %i.nj, <2 x i32> <i32 0, i32 2>
  %i.nw = fdiv <2 x double> %i.nv, %53            ; 3 uses
...
.preheader.lr.ph.i:                               ; preds = %bb.ax
  ...
  %i.pe = insertelement <2 x double> %i.pd, double %i.pa, i64 1
...
.preheader.i:                                     ; preds = %bb.ba, %.preheader.lr.ph.i
  ...
  %i.pn = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.pe, <2 x double> %i.pl, <2 x double> %i.pm) ; 2 uses
  %54 = extractelement <2 x double> %i.pn, i64 0
  %55 = fmul double %.sroa.0260.0.i, %54
  ...
  %58 = extractelement <2 x double> %i.pu, i64 0
  %59 = fmul double %.sroa.0260.0.i, %58
  ...
  %i.pz = fmul <2 x double> %i.ly, %i.py
  %i.qa = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %20, <2 x double> %57, <2 x double> %i.pz)
  ...
  %i.qe = fmul <2 x double> %i.ly, %i.qd
  %60 = insertelement <2 x double> poison, double %59, i64 0
  %61 = shufflevector <2 x double> %60, <2 x double> poison, <2 x i32> zeroinitializer
  %i.qf = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %20, <2 x double> %61, <2 x double> %i.qe)
...
bb.ay:                                            ; preds = %.preheader.i
  %i.qj = fmul double %.sroa.0260.0.i, %i.pp
  %i.qk = fmul double %.sroa.14.0.i, %i.pq        ; 2 uses
  ...
  %i.qr = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %42, <2 x double> %i.qq, <2 x double> %i.qo)
