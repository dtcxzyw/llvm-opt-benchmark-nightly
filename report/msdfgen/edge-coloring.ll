...
.noexc354:                                        ; preds = %bb.dz
  %i.vk = load ptr, ptr %i.sv, align 8, !tbaa !18
...
bb.ea:                                            ; preds = %.noexc357, %.noexc355
  ...
  store double %i.vx, ptr %i.a, align 8, !tbaa !32
  %i.vy = load ptr, ptr %i.sx, align 8, !tbaa !18
...
.noexc356:                                        ; preds = %bb.ea
  ...
  %i.we = load ptr, ptr %i.sv, align 8, !tbaa !18
  ...
  %i.wh = invoke { double, double } %i.wg(ptr noundef nonnull align 8 dereferenceable(12) %i.sv, double %i.wc, double %i.wd, ptr noundef nonnull align 8 dereferenceable(8) %i.a)
          to label %.noexc357 unwind label %.loopexit.split-lp719.loopexit, !inline_history !88
...
.noexc357:                                        ; preds = %.noexc356
  ...
  br i1 %exitcond.not.i.i, label %.preheader.i.i, label %bb.ea, !llvm.loop !89
...
.preheader.i.i:                                   ; preds = %.noexc357, %.noexc359
  ...
  store double %i.wo, ptr %i.b, align 8, !tbaa !32
  %i.wp = load ptr, ptr %i.sv, align 8, !tbaa !18
  ...
  %i.ws = invoke { double, double } %i.wr(ptr noundef nonnull align 8 dereferenceable(12) %i.sv, double noundef %i.wo)
          to label %.noexc358 unwind label %.loopexit718, !inline_history !88 ; 2 uses

.noexc358:                                        ; preds = %.preheader.i.i
  %i.wt = extractvalue { double, double } %i.ws, 0
  %i.wu = extractvalue { double, double } %i.ws, 1
  %i.wv = load ptr, ptr %i.sx, align 8, !tbaa !18
  ...
  %i.wy = invoke { double, double } %i.wx(ptr noundef nonnull align 8 dereferenceable(12) %i.sx, double %i.wt, double %i.wu, ptr noundef nonnull align 8 dereferenceable(8) %i.b)
          to label %.noexc359 unwind label %.loopexit718, !inline_history !88
...
_ZN7msdfgenL18edgeToEdgeDistanceERKNS_11EdgeSegmentES2_i.exit.i: ; preds = %.noexc359, %.noexc353, %.noexc351, %.noexc349, %.noexc347
  %.0.i.i = phi double [ 0.000000e+00, %.noexc347 ], [ 0.000000e+00, %.noexc353 ], [ 0.000000e+00, %.noexc351 ], [ 0.000000e+00, %.noexc349 ], [ %i.xc, %.noexc359 ] ; 2 uses
...
_ZN7msdfgenL22splineToSplineDistanceEPKPNS_11EdgeSegmentEiiiii.exit: ; preds = %_ZN7msdfgenL22splineToSplineDistanceEPKPNS_11EdgeSegmentEiiiii.exit.loopexit, %bb.du
  ...
  store double %.0.lcssa.i, ptr %i.xk, align 8, !tbaa !32
  %i.xl = getelementptr inbounds nuw [8 x i8], ptr %i.qv, i64 %indvars.iv1790
  %i.xm = load ptr, ptr %i.xl, align 8, !tbaa !34
  %i.xn = getelementptr inbounds nuw [8 x i8], ptr %i.xm, i64 %indvars.iv1795
  store double %.0.lcssa.i, ptr %i.xn, align 8, !tbaa !32
...
bb.eb:                                            ; preds = %.lr.ph1381, %_ZNSt6vectorIPKdSaIS1_EE9push_backEOS1_.exit
  ...
  %i.xx = load ptr, ptr %i.xw, align 8, !tbaa !34
...
bb.ec:                                            ; preds = %bb.eb
  store ptr %i.xy, ptr %.sroa.18.11377, align 8, !tbaa !34
...
.noexc365:                                        ; preds = %_ZNKSt6vectorIPKdSaIS1_EE12_M_check_lenEmPKc.exit.i.i.i
  ...
  store ptr %i.xy, ptr %i.yk, align 8, !tbaa !34
