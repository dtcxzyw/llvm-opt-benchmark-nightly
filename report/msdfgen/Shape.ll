...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %_ZN7msdfgenL14deconvergeEdgeERNS_10EdgeHolderEiNS_7Vector2E.exit58
  ...
  %i.bh = insertelement <2 x double> %i.bg, double %i.au, i64 1 ; 3 uses
  ...
  %i.bk = insertelement <2 x double> %i.bh, double %i.av, i64 0
  %6 = shufflevector <2 x double> %i.bj, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %7 = fdiv <2 x double> %i.bk, %6
  %8 = fcmp une <2 x double> %i.bi, zeroinitializer ; 2 uses
  %i.bl = shufflevector <2 x i1> %8, <2 x i1> poison, <2 x i32> <i32 1, i32 1>
  %i.bm = select <2 x i1> %i.bl, <2 x double> %7, <2 x double> <double 1.000000e+00, double 0.000000e+00> ; 3 uses
  ...
  %i.bq = shufflevector <2 x i1> %8, <2 x i1> poison, <2 x i32> zeroinitializer
