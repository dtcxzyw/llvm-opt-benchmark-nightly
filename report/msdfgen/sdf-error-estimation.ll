...
_ZNKSt6vectorIN7msdfgen8Scanline12IntersectionESaIS2_EE12_M_check_lenEmPKc.exit.i.i70: ; preds = %bb.o
  %i.de = ashr exact i64 %i.dc, 4
  %mul2.i.i70 = ashr exact i64 %i.dc, 3
  %7 = tail call i64 @llvm.umax.i64(i64 %mul2.i.i70, i64 1) ; 2 uses
  %i.df = icmp ult i64 %7, %i.de
  %i.dg = tail call i64 @llvm.umin.i64(i64 %7, i64 576460752303423487)
  %i.dh = select i1 %i.df, i64 576460752303423487, i64 %i.dg ; 2 uses
  %i.di = shl nuw nsw i64 %i.dh, 4
  %i.dj = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.di) #10
...
bb.t:                                             ; preds = %bb.s
  ...
  call void @_ZdlPvm(ptr noundef nonnull %i.dv, i64 noundef %i.ea) #9
...
bb.w:                                             ; preds = %bb.v
  ...
  call void @_ZdlPvm(ptr noundef nonnull %i.eb, i64 noundef %i.eg) #9
  br label %_ZNSt6vectorIN7msdfgen8Scanline12IntersectionESaIS2_EED2Ev.exit82
...
_ZNKSt6vectorIN7msdfgen8Scanline12IntersectionESaIS2_EE12_M_check_lenEmPKc.exit.i.i128: ; preds = %bb.ak
  %i.jz = ashr exact i64 %i.jx, 4
  %mul2.i.i128 = ashr exact i64 %i.jx, 3
  %8 = tail call i64 @llvm.umax.i64(i64 %mul2.i.i128, i64 1) ; 2 uses
  %i.ka = icmp ult i64 %8, %i.jz
  %i.kb = tail call i64 @llvm.umin.i64(i64 %8, i64 576460752303423487)
  %i.kc = select i1 %i.ka, i64 576460752303423487, i64 %i.kb ; 2 uses
  %i.kd = shl nuw nsw i64 %i.kc, 4
  %i.ke = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.kd) #10
...
bb.au:                                            ; preds = %bb.at
  ...
  call void @_ZdlPvm(ptr noundef nonnull %i.ln, i64 noundef %i.ls) #9
...
bb.ax:                                            ; preds = %bb.aw
  ...
  call void @_ZdlPvm(ptr noundef nonnull %i.lt, i64 noundef %i.ly) #9
