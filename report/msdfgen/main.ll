...
bb.sl:                                            ; preds = %bb.sk
  %i.avr = load i8, ptr %.014.i.i1401, align 1, !tbaa !17 ; 3 uses
  ...
  %i.avv = load i8, ptr %.013.i.i1400, align 1, !tbaa !17 ; 3 uses
  ...
  br i1 %.not16.i.i1406, label %bb.sk, label %_ZL12cmpExtensionPKcS0_.exit.thread.i1407.preheader, !llvm.loop !0
...
bb.sm:                                            ; preds = %_ZL12cmpExtensionPKcS0_.exit.thread.i1407
  %i.awa = load i8, ptr %.014.i87.i1411, align 1, !tbaa !17 ; 3 uses
  ...
  %i.awe = load i8, ptr %.013.i86.i1410, align 1, !tbaa !17 ; 3 uses
  ...
  br i1 %.not16.i92.i1416, label %_ZL12cmpExtensionPKcS0_.exit.thread.i1407, label %_ZL12cmpExtensionPKcS0_.exit94.thread.i1417.preheader, !llvm.loop !0
...
bb.sn:                                            ; preds = %_ZL12cmpExtensionPKcS0_.exit94.thread.i1417
  %i.awj = load i8, ptr %.014.i98.i1421, align 1, !tbaa !17 ; 3 uses
  ...
  %i.awn = load i8, ptr %.013.i97.i1420, align 1, !tbaa !17 ; 3 uses
  ...
  br i1 %.not16.i103.i1426, label %_ZL12cmpExtensionPKcS0_.exit94.thread.i1417, label %_ZL12cmpExtensionPKcS0_.exit105.thread.i1427.preheader, !llvm.loop !0
...
bb.so:                                            ; preds = %_ZL12cmpExtensionPKcS0_.exit105.thread.i1427
  %i.aws = load i8, ptr %.014.i109.i1431, align 1, !tbaa !17 ; 3 uses
  ...
  %i.aww = load i8, ptr %.013.i108.i1430, align 1, !tbaa !17 ; 3 uses
  ...
  br i1 %.not16.i114.i1436, label %_ZL12cmpExtensionPKcS0_.exit105.thread.i1427, label %_ZL12cmpExtensionPKcS0_.exit116.thread.i1437, !llvm.loop !0
...
.thread4925:                                      ; preds = %.thread156.i1439.thread, %bb.ss
  ...
  %i.axn = load ptr, ptr %40, align 8, !tbaa !214
  %i.axo = load i32, ptr %i.avj, align 8, !tbaa !216
  %i.axp = mul nsw i32 %i.axo, 3
  %i.axq = load i32, ptr %i.avk, align 4, !tbaa !217
  %i.axr = load i32, ptr %i.avl, align 8, !tbaa !218
...
bb.st:                                            ; preds = %bb.ss
  %i.axs = load i32, ptr %i.avj, align 8, !tbaa !216 ; 2 uses
  %i.axt = mul nuw nsw i32 %i.axs, 3
  %i.axu = load i32, ptr %i.avk, align 4, !tbaa !217 ; 3 uses
...
.preheader.lr.ph.i.i1382:                         ; preds = %bb.st
  %i.axw = load i32, ptr %i.avl, align 8, !tbaa !218
...
.preheader.us.i.i1387:                            ; preds = %._crit_edge.us.i.i1395, %.preheader.us.i.preheader.i
  ...
  %i.aya = load float, ptr %.01417.us.i.i1389, align 4, !tbaa !23
...
.peel.next.i.i1390:                               ; preds = %.peel.next.i.i1390, %.preheader.us.i.i1387
  ...
  %i.ayd = load float, ptr %.01215.us.i.i1393, align 4, !tbaa !23
  ...
  br i1 %exitcond21.not.i.i1394, label %._crit_edge.us.i.i1395, label %.peel.next.i.i1390, !llvm.loop !66
...
._crit_edge.us.i.i1395:                           ; preds = %.peel.next.i.i1390
  ...
  br i1 %exitcond23.not.i.i1397, label %_ZL20writeTextBitmapFloatP8_IO_FILEPKfiii.exit.i1381, label %.preheader.us.i.i1387, !llvm.loop !67
...
.preheader.i.i1383:                               ; preds = %.preheader.lr.ph.i.i1382, %.preheader.i.i1383
  ...
  br i1 %exitcond.not.i.i1386, label %_ZL20writeTextBitmapFloatP8_IO_FILEPKfiii.exit.i1381, label %.preheader.i.i1383, !llvm.loop !67
...
bb.sv:                                            ; preds = %bb.su
  %i.ayn = load i32, ptr %i.avj, align 8, !tbaa !216 ; 2 uses
  %i.ayo = mul nuw nsw i32 %i.ayn, 3
  %i.ayp = load i32, ptr %i.avk, align 4, !tbaa !217 ; 2 uses
...
.preheader.lr.ph.i117.i1366:                      ; preds = %bb.sv
  %i.ayr = load i32, ptr %i.avl, align 8, !tbaa !218
...
.preheader.i118.preheader.i1367:                  ; preds = %.preheader.lr.ph.i117.i1366
  %i.ayu = load ptr, ptr %40, align 8, !tbaa !214
...
._crit_edge.i.i1378:                              ; preds = %bb.sw
  ...
  br i1 %exitcond18.not.i.i1379, label %_ZL14writeBinBitmapP8_IO_FILEPKfiii.exit.i1338, label %.preheader.i118.i1368, !llvm.loop !68
...
bb.sw:                                            ; preds = %bb.sw, %.preheader.i118.i1368
  ...
  %i.ayy = load float, ptr %.01013.i.i1372, align 4, !tbaa !23 ; 4 uses
  ...
  br i1 %exitcond.not.i121.i1377, label %._crit_edge.i.i1378, label %bb.sw, !llvm.loop !69

bb.sx:                                            ; preds = %bb.su
  %i.azi = load i32, ptr %i.avk, align 4, !tbaa !217 ; 2 uses
...
.lr.ph.i.i1362:                                   ; preds = %bb.sx
  %i.azk = load i32, ptr %i.avl, align 8, !tbaa !218
  %i.azl = load i32, ptr %i.avj, align 8, !tbaa !216
  %i.azm = mul nsw i32 %i.azl, 3
  %i.azn = load ptr, ptr %40, align 8, !tbaa !214
...
bb.sy:                                            ; preds = %bb.sy, %.lr.ph.i.i1362
  ...
  br i1 %exitcond.not.i123.i1365, label %_ZL14writeBinBitmapP8_IO_FILEPKfiii.exit.i1338, label %bb.sy, !llvm.loop !70

bb.sz:                                            ; preds = %bb.su
  %i.azt = load i32, ptr %i.avj, align 8, !tbaa !216 ; 2 uses
  %i.azu = mul nuw nsw i32 %i.azt, 3
  %i.azv = load i32, ptr %i.avk, align 4, !tbaa !217 ; 2 uses
...
.preheader.lr.ph.i124.i1340:                      ; preds = %bb.sz
  %i.azx = load i32, ptr %i.avl, align 8, !tbaa !218
...
.preheader.i125.preheader.i1341:                  ; preds = %.preheader.lr.ph.i124.i1340
  %i.baa = load ptr, ptr %40, align 8, !tbaa !214
...
._crit_edge.i129.i1360:                           ; preds = %bb.ta
  ...
  br i1 %exitcond24.not.i.i1361, label %_ZL14writeBinBitmapP8_IO_FILEPKfiii.exit.i1338, label %.preheader.i125.i1342, !llvm.loop !71
...
bb.ta:                                            ; preds = %bb.ta, %.preheader.i125.i1342
  ...
  br i1 %exitcond.not.i128.i1359, label %._crit_edge.i129.i1360, label %bb.ta, !llvm.loop !72
...
bb.tc:                                            ; preds = %bb.tb, %bb.tb
  %i.baj = load ptr, ptr @stdout, align 8, !tbaa !139
...
bb.td:                                            ; preds = %bb.tb
  %i.bak = load ptr, ptr @stdout, align 8, !tbaa !139 ; 4 uses
...
.preheader.us.i136.i:                             ; preds = %.preheader.lr.ph.i130.i1448, %._crit_edge.us.i144.i
  ...
  %i.bao = load float, ptr %.01417.us.i138.i, align 4, !tbaa !23
...
.peel.next.i139.i:                                ; preds = %.peel.next.i139.i, %.preheader.us.i136.i
  ...
  %i.bar = load float, ptr %.01215.us.i142.i, align 4, !tbaa !23
...
._crit_edge.us.i144.i:                            ; preds = %.peel.next.i139.i
  ...
  br i1 %exitcond23.not.i146.i, label %.loopexit2279.thread, label %.preheader.us.i136.i, !llvm.loop !67
...
.preheader.i131.i1449:                            ; preds = %.preheader.lr.ph.i130.i1448, %.preheader.i131.i1449
  ...
  br i1 %exitcond.not.i134.i1452, label %.thread2199, label %.preheader.i131.i1449, !llvm.loop !67
...
bb.te:                                            ; preds = %.thread156.i1439.thread, %bb.sr, %.thread156.i1439, %.thread157.i1438, %bb.tb, %.noexc1453, %.noexc1454, %.noexc1455, %.noexc1456, %.noexc1457
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %40) #21
  %i.bay = load ptr, ptr @stderr, align 8, !tbaa !139
...
bb.th:                                            ; preds = %bb.tg
  ...
  store ptr %.sroa.01805.1, ptr %41, align 8, !tbaa !182, !alias.scope !224
  %i.bbd = getelementptr inbounds nuw i8, ptr %41, i64 8
  store i32 %.sroa.171817.0, ptr %i.bbd, align 8, !tbaa !184, !alias.scope !224
  %i.bbe = getelementptr inbounds nuw i8, ptr %41, i64 12
  store i32 %.sroa.271826.0, ptr %i.bbe, align 4, !tbaa !185, !alias.scope !224
  %i.bbf = getelementptr inbounds nuw i8, ptr %41, i64 16
  store i32 %i.avm, ptr %i.bbf, align 8, !tbaa !186, !alias.scope !224
  %i.bbg = getelementptr inbounds nuw i8, ptr %41, i64 20
  store i32 0, ptr %i.bbg, align 4, !tbaa !187, !alias.scope !224
...
bb.tj:                                            ; preds = %.split4930, %.loopexit2279.thread, %.thread2199, %_ZL12is8bitFormat6Format.exit1458
  ...
  store ptr %.sroa.01805.1, ptr %42, align 8, !tbaa !214, !alias.scope !225
  %i.bbi = getelementptr inbounds nuw i8, ptr %42, i64 8
  store i32 %.sroa.171817.0, ptr %i.bbi, align 8, !tbaa !216, !alias.scope !225
  %i.bbj = getelementptr inbounds nuw i8, ptr %42, i64 12
  store i32 %.sroa.271826.0, ptr %i.bbj, align 4, !tbaa !217, !alias.scope !225
  %i.bbk = getelementptr inbounds nuw i8, ptr %42, i64 16
  store i32 %i.avm, ptr %i.bbk, align 8, !tbaa !218, !alias.scope !225
  %i.bbl = getelementptr inbounds nuw i8, ptr %42, i64 20
  store i32 0, ptr %i.bbl, align 4, !tbaa !219, !alias.scope !225
...
bb.uo:                                            ; preds = %bb.un
  %i.bey = load i8, ptr %.014.i.i1559, align 1, !tbaa !17 ; 3 uses
  ...
  %i.bfc = load i8, ptr %.013.i.i1558, align 1, !tbaa !17 ; 3 uses
  ...
  br i1 %.not16.i.i1564, label %bb.un, label %_ZL12cmpExtensionPKcS0_.exit.thread.i1565.preheader, !llvm.loop !0
...
bb.up:                                            ; preds = %_ZL12cmpExtensionPKcS0_.exit.thread.i1565
  %i.bfh = load i8, ptr %.014.i87.i1569, align 1, !tbaa !17 ; 3 uses
  ...
  %i.bfl = load i8, ptr %.013.i86.i1568, align 1, !tbaa !17 ; 3 uses
  ...
  br i1 %.not16.i92.i1574, label %_ZL12cmpExtensionPKcS0_.exit.thread.i1565, label %_ZL12cmpExtensionPKcS0_.exit94.thread.i1575.preheader, !llvm.loop !0
...
bb.uq:                                            ; preds = %_ZL12cmpExtensionPKcS0_.exit94.thread.i1575
  %i.bfq = load i8, ptr %.014.i98.i1579, align 1, !tbaa !17 ; 3 uses
  ...
  %i.bfu = load i8, ptr %.013.i97.i1578, align 1, !tbaa !17 ; 3 uses
  ...
  br i1 %.not16.i103.i1584, label %_ZL12cmpExtensionPKcS0_.exit94.thread.i1575, label %_ZL12cmpExtensionPKcS0_.exit105.thread.i1585.preheader, !llvm.loop !0
...
bb.ur:                                            ; preds = %_ZL12cmpExtensionPKcS0_.exit105.thread.i1585
  %i.bfz = load i8, ptr %.014.i109.i1589, align 1, !tbaa !17 ; 3 uses
  ...
  %i.bgd = load i8, ptr %.013.i108.i1588, align 1, !tbaa !17 ; 3 uses
  ...
  br i1 %.not16.i114.i1594, label %_ZL12cmpExtensionPKcS0_.exit105.thread.i1585, label %_ZL12cmpExtensionPKcS0_.exit116.thread.i1595, !llvm.loop !0
...
.thread4934:                                      ; preds = %.thread156.i1597.thread, %bb.uv
  ...
  %i.bgu = load ptr, ptr %49, align 8, !tbaa !233
  %i.bgv = load i32, ptr %i.beq, align 8, !tbaa !235
  %i.bgw = shl nsw i32 %i.bgv, 2
  %i.bgx = load i32, ptr %i.ber, align 4, !tbaa !236
  %i.bgy = load i32, ptr %i.bes, align 8, !tbaa !237
...
bb.uw:                                            ; preds = %bb.uv
  %i.bgz = load i32, ptr %i.beq, align 8, !tbaa !235 ; 2 uses
  %i.bha = shl nuw nsw i32 %i.bgz, 2
  %i.bhb = load i32, ptr %i.ber, align 4, !tbaa !236 ; 3 uses
...
.preheader.lr.ph.i.i1539:                         ; preds = %bb.uw
  %i.bhd = load i32, ptr %i.bes, align 8, !tbaa !237
...
.preheader.us.i.preheader.i1544:                  ; preds = %.preheader.lr.ph.i.i1539
  %i.bhg = load ptr, ptr %49, align 8, !tbaa !233
...
.preheader.us.i.i1545:                            ; preds = %._crit_edge.us.i.i1553, %.preheader.us.i.preheader.i1544
  ...
  %i.bhh = load float, ptr %.01417.us.i.i1547, align 4, !tbaa !23
...
.peel.next.i.i1548:                               ; preds = %.peel.next.i.i1548, %.preheader.us.i.i1545
  ...
  %i.bhk = load float, ptr %.01215.us.i.i1551, align 4, !tbaa !23
  ...
  br i1 %exitcond21.not.i.i1552, label %._crit_edge.us.i.i1553, label %.peel.next.i.i1548, !llvm.loop !66
...
._crit_edge.us.i.i1553:                           ; preds = %.peel.next.i.i1548
  ...
  br i1 %exitcond23.not.i.i1555, label %_ZL20writeTextBitmapFloatP8_IO_FILEPKfiii.exit.i1538, label %.preheader.us.i.i1545, !llvm.loop !67
...
.preheader.i.i1540:                               ; preds = %.preheader.lr.ph.i.i1539, %.preheader.i.i1540
  ...
  br i1 %exitcond.not.i.i1543, label %_ZL20writeTextBitmapFloatP8_IO_FILEPKfiii.exit.i1538, label %.preheader.i.i1540, !llvm.loop !67
...
bb.uy:                                            ; preds = %bb.ux
  %i.bhu = load i32, ptr %i.beq, align 8, !tbaa !235 ; 2 uses
  %i.bhv = shl nuw nsw i32 %i.bhu, 2
  %i.bhw = load i32, ptr %i.ber, align 4, !tbaa !236 ; 2 uses
...
.preheader.lr.ph.i117.i1523:                      ; preds = %bb.uy
  %i.bhy = load i32, ptr %i.bes, align 8, !tbaa !237
...
.preheader.i118.preheader.i1524:                  ; preds = %.preheader.lr.ph.i117.i1523
  %i.bib = load ptr, ptr %49, align 8, !tbaa !233
...
._crit_edge.i.i1535:                              ; preds = %bb.uz
  ...
  br i1 %exitcond18.not.i.i1536, label %_ZL14writeBinBitmapP8_IO_FILEPKfiii.exit.i1495, label %.preheader.i118.i1525, !llvm.loop !68
...
bb.uz:                                            ; preds = %bb.uz, %.preheader.i118.i1525
  ...
  %i.bif = load float, ptr %.01013.i.i1529, align 4, !tbaa !23 ; 4 uses
  ...
  br i1 %exitcond.not.i121.i1534, label %._crit_edge.i.i1535, label %bb.uz, !llvm.loop !69

bb.va:                                            ; preds = %bb.ux
  %i.bip = load i32, ptr %i.ber, align 4, !tbaa !236 ; 2 uses
...
.lr.ph.i.i1519:                                   ; preds = %bb.va
  %i.bir = load i32, ptr %i.bes, align 8, !tbaa !237
  %i.bis = load i32, ptr %i.beq, align 8, !tbaa !235
  %i.bit = shl nsw i32 %i.bis, 2
  %i.biu = load ptr, ptr %49, align 8, !tbaa !233
...
bb.vb:                                            ; preds = %bb.vb, %.lr.ph.i.i1519
  ...
  br i1 %exitcond.not.i123.i1522, label %_ZL14writeBinBitmapP8_IO_FILEPKfiii.exit.i1495, label %bb.vb, !llvm.loop !70

bb.vc:                                            ; preds = %bb.ux
  %i.bja = load i32, ptr %i.beq, align 8, !tbaa !235 ; 2 uses
  %i.bjb = shl nuw nsw i32 %i.bja, 2
  %i.bjc = load i32, ptr %i.ber, align 4, !tbaa !236 ; 2 uses
...
.preheader.lr.ph.i124.i1497:                      ; preds = %bb.vc
  %i.bje = load i32, ptr %i.bes, align 8, !tbaa !237
...
.preheader.i125.preheader.i1498:                  ; preds = %.preheader.lr.ph.i124.i1497
  %i.bjh = load ptr, ptr %49, align 8, !tbaa !233
...
._crit_edge.i129.i1517:                           ; preds = %bb.vd
  ...
  br i1 %exitcond24.not.i.i1518, label %_ZL14writeBinBitmapP8_IO_FILEPKfiii.exit.i1495, label %.preheader.i125.i1499, !llvm.loop !71
...
bb.vd:                                            ; preds = %bb.vd, %.preheader.i125.i1499
  ...
  br i1 %exitcond.not.i128.i1516, label %._crit_edge.i129.i1517, label %bb.vd, !llvm.loop !72
...
bb.vf:                                            ; preds = %bb.ve, %bb.ve
  %i.bjq = load ptr, ptr @stdout, align 8, !tbaa !139
...
bb.vg:                                            ; preds = %bb.ve
  %i.bjr = load ptr, ptr @stdout, align 8, !tbaa !139 ; 4 uses
...
.preheader.us.i136.i1613:                         ; preds = %.preheader.lr.ph.i130.i1607, %._crit_edge.us.i144.i1621
  ...
  %i.bjv = load float, ptr %.01417.us.i138.i1615, align 4, !tbaa !23
...
.peel.next.i139.i1616:                            ; preds = %.peel.next.i139.i1616, %.preheader.us.i136.i1613
  ...
  %i.bjy = load float, ptr %.01215.us.i142.i1619, align 4, !tbaa !23
  ...
  br i1 %exitcond21.not.i143.i1620, label %._crit_edge.us.i144.i1621, label %.peel.next.i139.i1616, !llvm.loop !66
...
._crit_edge.us.i144.i1621:                        ; preds = %.peel.next.i139.i1616
  ...
  br i1 %exitcond23.not.i146.i1623, label %.loopexit2283.thread, label %.preheader.us.i136.i1613, !llvm.loop !67
...
.preheader.i131.i1608:                            ; preds = %.preheader.lr.ph.i130.i1607, %.preheader.i131.i1608
  ...
  br i1 %exitcond.not.i134.i1611, label %.thread2221, label %.preheader.i131.i1608, !llvm.loop !67
...
bb.vh:                                            ; preds = %.thread156.i1597.thread, %bb.uu, %.thread156.i1597, %.thread157.i1596, %bb.ve, %.noexc1624, %.noexc1625, %.noexc1626, %.noexc1627, %.noexc1628
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %49) #21
  %i.bkf = load ptr, ptr @stderr, align 8, !tbaa !139
...
bb.vk:                                            ; preds = %bb.vj
  ...
  store ptr %.sroa.01752.1, ptr %50, align 8, !tbaa !190, !alias.scope !239
  %i.bkk = getelementptr inbounds nuw i8, ptr %50, i64 8
  store i32 %.sroa.171764.0, ptr %i.bkk, align 8, !tbaa !192, !alias.scope !239
  %i.bkl = getelementptr inbounds nuw i8, ptr %50, i64 12
  store i32 %.sroa.27.0, ptr %i.bkl, align 4, !tbaa !193, !alias.scope !239
  %i.bkm = getelementptr inbounds nuw i8, ptr %50, i64 16
  store i32 %i.bet, ptr %i.bkm, align 8, !tbaa !194, !alias.scope !239
  %i.bkn = getelementptr inbounds nuw i8, ptr %50, i64 20
  store i32 0, ptr %i.bkn, align 4, !tbaa !195, !alias.scope !239
...
bb.vn:                                            ; preds = %_ZL12is8bitFormat6Format.exit1629
  ...
  store ptr %.sroa.01752.1, ptr %51, align 8, !tbaa !233, !alias.scope !240
  %i.bkp = getelementptr inbounds nuw i8, ptr %51, i64 8
  store i32 %.sroa.171764.0, ptr %i.bkp, align 8, !tbaa !235, !alias.scope !240
  %i.bkq = getelementptr inbounds nuw i8, ptr %51, i64 12
  store i32 %.sroa.27.0, ptr %i.bkq, align 4, !tbaa !236, !alias.scope !240
  %i.bkr = getelementptr inbounds nuw i8, ptr %51, i64 16
  store i32 %i.bet, ptr %i.bkr, align 8, !tbaa !237, !alias.scope !240
  %i.bks = getelementptr inbounds nuw i8, ptr %51, i64 20
  store i32 0, ptr %i.bks, align 4, !tbaa !238, !alias.scope !240
