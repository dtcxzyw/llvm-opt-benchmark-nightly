...
.lr.ph.i10.us.preheader:                          ; preds = %.lr.ph
  ...
  %.phi.trans.insert69 = getelementptr inbounds nuw i8, ptr %.pre66.a, i64 8
  %.pre70 = load ptr, ptr %.phi.trans.insert69, align 8, !tbaa !103 ; 2 uses
  %i.t = ptrtoint ptr %.pre68 to i64
  %i.u = ptrtoint ptr %.pre70 to i64
  %i.v = sub i64 %i.t, %i.u
...
bb.e:                                             ; preds = %.lr.ph.i10.us
  %i.af = getelementptr inbounds nuw [8 x i8], ptr %.pre70, i64 %i.ac
...
.lr.ph.i.us.preheader:                            ; preds = %.lr.ph
  ...
  %.pre63 = load ptr, ptr %.phi.trans.insert, align 8, !tbaa !127
  %.phi.trans.insert64 = getelementptr inbounds nuw i8, ptr %.pre, i64 8
  %.pre65 = load ptr, ptr %.phi.trans.insert64, align 8, !tbaa !103 ; 2 uses
  %i.an = ptrtoint ptr %.pre63 to i64
  %i.ao = ptrtoint ptr %.pre65 to i64
