...
bb.a:
  ...
  %17 = alloca %"class.absl::lts_20260526::time_internal::cctz::detail::civil_time.57", align 8 ; 10 uses
  ...
  %22 = alloca %"class.absl::lts_20260526::time_internal::cctz::detail::civil_time.56", align 8 ; 7 uses
  ...
  %27 = alloca %"class.absl::lts_20260526::time_internal::cctz::detail::civil_time", align 8 ; 7 uses
...
_ZN7testing15AssertionResultD2Ev.exit113:         ; preds = %bb.ai, %_ZNKSt14default_deleteINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclEPS5_.exit.i.i111
  ...
  %49 = lshr i64 %.fca.1.extract.i.i.i119, 8
  %50 = trunc i64 %49 to i8
  %51 = lshr i64 %.fca.1.extract.i.i.i119, 16
  ...
  %or.cond567 = select i1 %i.dm, i1 %i.dp, i1 false
  %i.dq = getelementptr inbounds nuw i8, ptr %17, i64 9
  %53 = load i8, ptr %i.dq, align 1
  %54 = icmp eq i8 %53, %50
  %or.cond570 = select i1 %or.cond567, i1 %54, i1 false
  %55 = getelementptr inbounds nuw i8, ptr %17, i64 10
  %56 = load i8, ptr %55, align 2
  %57 = icmp eq i8 %56, %52
  %or.cond573 = select i1 %or.cond570, i1 %57, i1 false
  %58 = getelementptr inbounds nuw i8, ptr %17, i64 11
  %59 = load i8, ptr %58, align 1
  %60 = icmp eq i8 %59, 0
  %or.cond576 = select i1 %or.cond573, i1 %60, i1 false
  %61 = getelementptr inbounds nuw i8, ptr %17, i64 12
  %62 = load i8, ptr %61, align 4
  %63 = icmp eq i8 %62, 0
  %op.rdx610.a = select i1 %or.cond576, i1 %63, i1 false
...
_ZN7testing15AssertionResultD2Ev.exit134:         ; preds = %bb.au, %_ZNKSt14default_deleteINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclEPS5_.exit.i.i132
  ...
  %.fca.1.extract.i.i.i140 = extractvalue { i64, i64 } %i.eq, 1 ; 2 uses
  ...
  %i.eu = icmp eq i64 %i.et, %i.er
  %64 = load <4 x i8>, ptr %.sroa.2.0..sroa_idx.i.i138, align 8
  %65 = bitcast i64 %.fca.1.extract.i.i.i140 to <8 x i8>
  %66 = shufflevector <8 x i8> %65, <8 x i8> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %67 = icmp eq <4 x i8> %64, %66
  %i.ev = getelementptr inbounds nuw i8, ptr %22, i64 12
  %i.ew = load i8, ptr %i.ev, align 4
  %i.ex = icmp eq i8 %i.ew, 0
  %68 = freeze <4 x i1> %67
  %69 = bitcast <4 x i1> %68 to i4
  %i.ey = icmp eq i4 %69, -1
  %70 = and i1 %i.eu, %i.ey
  %or.cond594 = select i1 %70, i1 %i.ex, i1 false
...
_ZN7testing15AssertionResultD2Ev.exit155:         ; preds = %bb.bg, %_ZNKSt14default_deleteINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclEPS5_.exit.i.i153
  ...
  %.fca.1.extract.i.i.i160 = extractvalue { i64, i64 } %i.fy, 1 ; 3 uses
  ...
  %71 = load <4 x i8>, ptr %.sroa.2.0..sroa_idx.i.i158, align 8
  %72 = bitcast i64 %.fca.1.extract.i.i.i160 to <8 x i8>
  %73 = shufflevector <8 x i8> %72, <8 x i8> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %74 = icmp eq <4 x i8> %71, %73
  %i.gf = getelementptr inbounds nuw i8, ptr %27, i64 12
  %i.gg = load i8, ptr %i.gf, align 4
  %i.gh = icmp eq i8 %i.gg, %i.ge
  %75 = freeze <4 x i1> %74
  %76 = bitcast <4 x i1> %75 to i4
  %i.gi = icmp eq i4 %76, -1
  %77 = and i1 %i.gc, %i.gi
  %or.cond609 = select i1 %77, i1 %i.gh, i1 false
