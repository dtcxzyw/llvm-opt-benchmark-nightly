...
bb.k:                                             ; preds = %.lr.ph
  %i.cc = tail call fastcc noundef double @_ZN4absl12lts_2026052615random_internal12_GLOBAL__N_118BetaIncompleteImplEdddd(double noundef %.1145162, double noundef %0, double noundef %1, double noundef %2) ; 3 uses
...
.split:                                           ; preds = %bb.l, %bb.p
  ...
  br i1 %i.cr, label %bb.m, label %bb.p, !llvm.loop !39
...
bb.m:                                             ; preds = %.split
  ...
  br i1 %or.cond7, label %bb.p, label %bb.n, !llvm.loop !39
...
bb.o:                                             ; preds = %bb.n
  ...
  br i1 %or.cond9, label %bb.p, label %.loopexit, !llvm.loop !39
...
define dso_local noundef double @_ZN4absl12lts_2026052615random_internal26RequiredSuccessProbabilityEdi(double noundef %0, i32 noundef %1) local_unnamed_addr #5 {
bb.a:
...
define dso_local noundef double @_ZN4absl12lts_2026052615random_internal6ZScoreEdRKNS1_19DistributionMomentsE(double noundef %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(40) %1) local_unnamed_addr #10 {
bb.a:
  ...
  %i.g = load i64, ptr %1, align 8, !tbaa !40
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(errnomem: write) uwtable
define dso_local noundef double @_ZN4absl12lts_2026052615random_internal17MaxErrorToleranceEd(double noundef %0) local_unnamed_addr #5 {
bb.a:
  %i.a = fsub double 1.000000e+00, %0
  %i.b = fmul double %i.a, 5.000000e-01
  %i.c = tail call double @llvm.fmuladd.f64(double %i.b, double 2.000000e+00, double -1.000000e+00)
  %i.d = tail call noundef double @_ZN4absl12lts_2026052615random_internal6erfinvEd(double noundef %i.c)
  %i.e = fmul double %i.d, f0xBFF6A09E667F3BCD
  ret double %i.e
}

declare noundef i64 @_ZN4absl12lts_2026052616numbers_internal17SixDigitsToBufferEdPc(double noundef, ptr noundef) local_unnamed_addr #6
...
declare void @_ZN4absl12lts_2026052619str_format_internal10FormatPackB5cxx11ENS1_21UntypedFormatSpecImplENS0_4SpanIKNS1_13FormatArgImplEEE(ptr dead_on_unwind writable sret(%"class.std::__cxx11::basic_string") align 8, ptr, i64, ptr, i64) local_unnamed_addr #6

; Function Attrs: mustprogress uwtable
declare noundef zeroext i1 @_ZN4absl12lts_2026052619str_format_internal13FormatArgImpl8DispatchIdEEbNS2_4DataENS1_24FormatConversionSpecImplEPv(ptr, i64, i32, ptr noundef) #4 align 2

declare void @_ZN4absl12lts_2026052616strings_internal9CatPiecesB5cxx11ESt16initializer_listISt17basic_string_viewIcSt11char_traitsIcEEE(ptr dead_on_unwind writable sret(%"class.std::__cxx11::basic_string") align 8, ptr, i64) local_unnamed_addr #6
