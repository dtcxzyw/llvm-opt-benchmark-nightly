Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/abseil-cpp/original/cord_rep_btree_reader?download=true
...
define dso_local { i64, ptr } @_ZN4absl12lts_2026052613cord_internal18CordRepBtreeReader4ReadEmmRPNS1_7CordRepE(ptr noundef nonnull align 8 dereferenceable(120) %0, i64 noundef %1, i64 noundef %2, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %3) local_unnamed_addr #0 align 2 {
bb.a:
  %.not = icmp eq i64 %2, 0
  ...
  %i.d = load i8, ptr %i.c, align 4, !tbaa !12    ; 2 uses
  %i.e = zext i8 %i.d to i64                      ; 2 uses
  br i1 %.not, label %bb.b, label %_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator4NextEv.exit.thread

_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator4NextEv.exit.thread: ; preds = %bb.a
  ...
  %i.j = sub i64 %i.i, %2
  br label %_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator4NextEv.exit
...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %exitcond.not.i.i74, label %_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator4NextEv.exit, label %.lr.ph

bb.d:                                             ; preds = %.lr.ph
  %indvars.iv.next38.i.i = add nuw nsw i64 %indvars.iv37.i.i75, 1
  %exitcond.not.i.i = icmp eq i64 %indvars.iv.next.i.i, %wide.trip.count.i.i
  br i1 %exitcond.not.i.i, label %_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator4NextEv.exit, label %.lr.ph, !llvm.loop !23

.lr.ph:                                           ; preds = %bb.c, %bb.d
  %indvars.iv.i.i76 = phi i64 [ %indvars.iv.next.i.i, %bb.d ], [ 0, %bb.c ] ; 2 uses
  %indvars.iv37.i.i75 = phi i64 [ %indvars.iv.next38.i.i, %bb.d ], [ 1, %bb.c ] ; 4 uses
  ...
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !9    ; 3 uses
  ...
  br i1 %i.aa, label %bb.d, label %bb.e, !llvm.loop !23
...
bb.e:                                             ; preds = %.lr.ph
  ...
  %xtraiter = and i64 %indvars.iv37.i.i75, 1
...
.prol.loopexit.unr-lcssa:                         ; preds = %bb.e
  ...
  %indvars.iv.next41.i.i.prol = add nsw i64 %indvars.iv37.i.i75, -1 ; 3 uses
  %i.ag = getelementptr inbounds nuw [8 x i8], ptr %i.a, i64 %indvars.iv.next41.i.i.prol
  ...
  %i.ak = getelementptr inbounds nuw i8, ptr %i.c, i64 %indvars.iv.next41.i.i.prol
  store i8 %i.ai, ptr %i.ak, align 1, !tbaa !12
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.prol.loopexit.unr-lcssa, %bb.e
  %indvars.iv40.i.i.unr = phi i64 [ %indvars.iv37.i.i75, %bb.e ], [ %indvars.iv.next41.i.i.prol, %.prol.loopexit.unr-lcssa ]
  ...
  br i1 %i.al, label %_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator6NextUpEv.exit.sink.split.i, label %.new
...
.new:                                             ; preds = %.prol.loopexit, %.new
  ...
  %i.ao = load ptr, ptr %i.an, align 8, !tbaa !13 ; 3 uses
  ...
  %i.ar = load i8, ptr %i.aq, align 1, !tbaa !12  ; 2 uses
  ...
  store ptr %i.aw, ptr %i.ax, align 8, !tbaa !9
  ...
  store i8 %i.az, ptr %i.bb, align 1, !tbaa !12
  %i.bc = icmp sgt i64 %indvars.iv40.i.i, 2
  br i1 %i.bc, label %.new, label %_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator6NextUpEv.exit.sink.split.i, !llvm.loop !25

bb.f:                                             ; preds = %bb.b
  %i.bd = add i8 %i.d, 1                          ; 2 uses
  store i8 %i.bd, ptr %i.c, align 4, !tbaa !12
  %i.be = zext i8 %i.bd to i64
  br label %_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator6NextUpEv.exit.sink.split.i

_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator6NextUpEv.exit.sink.split.i: ; preds = %.prol.loopexit, %.new, %bb.f
...
_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator4NextEv.exit: ; preds = %bb.d, %bb.c, %_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator6NextUpEv.exit.sink.split.i, %_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator4NextEv.exit.thread
  %i.bi = phi ptr [ %i.h, %_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator4NextEv.exit.thread ], [ %i.bh, %_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator6NextUpEv.exit.sink.split.i ], [ null, %bb.c ], [ null, %bb.d ] ; 5 uses
  %i.bj = phi i64 [ %i.j, %_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator4NextEv.exit.thread ], [ 0, %_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator6NextUpEv.exit.sink.split.i ], [ 0, %bb.c ], [ 0, %bb.d ]
  %i.bk = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.bl = tail call { ptr, i64 } @_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator4ReadEmm(ptr noundef nonnull align 8 dereferenceable(112) %i.bk, i64 noundef %i.bj, i64 noundef %1) ; 2 uses
  %i.bm = extractvalue { ptr, i64 } %i.bl, 0
  %i.bn = extractvalue { ptr, i64 } %i.bl, 1      ; 9 uses
  store ptr %i.bm, ptr %3, align 8, !tbaa !13
  %i.bo = icmp ult i64 %1, %2
  br i1 %i.bo, label %bb.g, label %bb.m

bb.g:                                             ; preds = %_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator4NextEv.exit
  %i.bp = load i64, ptr %i.bi, align 8, !tbaa !15 ; 3 uses
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bi, i64 12
  %i.br = load i8, ptr %i.bq, align 4, !tbaa !26  ; 2 uses
  %i.bs = icmp eq i8 %i.br, 1
  br i1 %i.bs, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bi, i64 16
  %i.bu = load i64, ptr %i.bt, align 8, !tbaa !27
  ...
  %.pre.i = load i8, ptr %.phi.trans.insert.i, align 4, !tbaa !26
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.g
  %i.bx = phi i8 [ %.pre.i, %bb.h ], [ %i.br, %bb.g ]
  %.010.i = phi ptr [ %i.bw, %bb.h ], [ %i.bi, %bb.g ] ; 2 uses
  %.0.i = phi i64 [ %i.bu, %bb.h ], [ 0, %bb.g ]
  %i.by = icmp ugt i8 %i.bx, 5
  br i1 %i.by, label %bb.j, label %bb.k

bb.j:                                             ; preds = %bb.i
  %i.bz = getelementptr inbounds nuw i8, ptr %.010.i, i64 13
  br label %_ZN4absl12lts_2026052613cord_internal8EdgeDataEPKNS1_7CordRepE.exit
...
_ZN4absl12lts_2026052613cord_internal8EdgeDataEPKNS1_7CordRepE.exit: ; preds = %bb.j, %bb.k
...
bb.l:                                             ; preds = %_ZN4absl12lts_2026052613cord_internal8EdgeDataEPKNS1_7CordRepE.exit
...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE6substrEmm.exit: ; preds = %_ZN4absl12lts_2026052613cord_internal8EdgeDataEPKNS1_7CordRepE.exit
...
bb.m:                                             ; preds = %_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator4NextEv.exit
  %i.cf = add i64 %2, %i.bn
  %i.cg = sub i64 %1, %i.cf                       ; 2 uses
  %i.ch = load i64, ptr %0, align 8, !tbaa !33    ; 2 uses
...
bb.o:                                             ; preds = %bb.m
  ...
  %i.cl = load i8, ptr %i.ck, align 4, !tbaa !12
  %i.cm = zext i8 %i.cl to i64
  %i.cn = getelementptr inbounds nuw i8, ptr %i.cj, i64 16
  %i.co = getelementptr inbounds nuw [8 x i8], ptr %i.cn, i64 %i.cm
  %i.cp = load ptr, ptr %i.co, align 8, !tbaa !13 ; 5 uses
  %i.cq = load i64, ptr %i.cp, align 8, !tbaa !15 ; 4 uses
  %i.cr = add i64 %i.cg, %i.cq
  %i.cs = sub i64 %i.ch, %i.cr
  store i64 %i.cs, ptr %0, align 8, !tbaa !33
  %i.ct = getelementptr inbounds nuw i8, ptr %i.cp, i64 12
  %i.cu = load i8, ptr %i.ct, align 4, !tbaa !26  ; 2 uses
...
bb.p:                                             ; preds = %bb.o
  ...
  %.pre.i30 = load i8, ptr %.phi.trans.insert.i29, align 4, !tbaa !26
  br label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.o
  %i.da = phi i8 [ %.pre.i30, %bb.p ], [ %i.cu, %bb.o ]
  %.010.i23 = phi ptr [ %i.cz, %bb.p ], [ %i.cp, %bb.o ] ; 2 uses
  %.0.i24 = phi i64 [ %i.cx, %bb.p ], [ 0, %bb.o ]
  %i.db = icmp ugt i8 %i.da, 5
  br i1 %i.db, label %bb.r, label %bb.s

bb.r:                                             ; preds = %bb.q
  %i.dc = getelementptr inbounds nuw i8, ptr %.010.i23, i64 13
  br label %_ZN4absl12lts_2026052613cord_internal8EdgeDataEPKNS1_7CordRepE.exit31

bb.s:                                             ; preds = %bb.q
  %i.dd = getelementptr inbounds nuw i8, ptr %.010.i23, i64 16
  %i.de = load ptr, ptr %i.dd, align 8, !tbaa !30
  br label %_ZN4absl12lts_2026052613cord_internal8EdgeDataEPKNS1_7CordRepE.exit31

_ZN4absl12lts_2026052613cord_internal8EdgeDataEPKNS1_7CordRepE.exit31: ; preds = %bb.r, %bb.s
...
bb.t:                                             ; preds = %_ZN4absl12lts_2026052613cord_internal8EdgeDataEPKNS1_7CordRepE.exit31
...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE6substrEmm.exit34: ; preds = %_ZN4absl12lts_2026052613cord_internal8EdgeDataEPKNS1_7CordRepE.exit31
  %.sroa.3.0.i26 = getelementptr inbounds nuw i8, ptr %.pn.i25, i64 %.0.i24
...
declare { ptr, i64 } @_ZN4absl12lts_2026052613cord_internal21CordRepBtreeNavigator4ReadEmm(ptr noundef nonnull align 8 dereferenceable(112), i64 noundef, i64 noundef) local_unnamed_addr #1
