...
bb.bp:                                            ; preds = %bb.f
  ...
  %24 = fmul double %i.lq, 6.000000e+00
  %25 = fdiv double %i.lh, %i.lf
  %i.lr = insertelement <2 x double> poison, double %25, i64 0
  %i.ls = insertelement <2 x double> %i.lr, double %24, i64 1
