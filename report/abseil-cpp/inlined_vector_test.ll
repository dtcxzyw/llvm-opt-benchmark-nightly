...
begin_hunk_0_@_ZN4absl12lts_2026052623inlined_vector_internal7StorageIiLm8ESaIiEE6InsertINS1_20IteratorValueAdapterIS3_St24_Fwd_list_const_iteratorIiEEEEEPiPKiT_m:bb.a
  ...
  br i1 %niter.ncmp.3, label %_ZN4absl12lts_2026052623inlined_vector_internal14AssignElementsISaIiENS1_20IteratorValueAdapterIS3_St24_Fwd_list_const_iteratorIiEEEEEvNSt16allocator_traitsIT_E7pointerERT0_NSA_9size_typeE.exit.loopexit.unr-lcssa, label %.lr.ph.i62, !llvm.loop !1400
...
.lr.ph.i62.epil:                                  ; preds = %.lr.ph.i62.epil, %.lr.ph.i62.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %_ZN4absl12lts_2026052623inlined_vector_internal14AssignElementsISaIiENS1_20IteratorValueAdapterIS3_St24_Fwd_list_const_iteratorIiEEEEEvNSt16allocator_traitsIT_E7pointerERT0_NSA_9size_typeE.exit, label %.lr.ph.i62.epil, !llvm.loop !1401
...
.lr.ph.i67:                                       ; preds = %.lr.ph.i67, %.lr.ph.i67.preheader.new
  ...
  br i1 %niter171.ncmp.3, label %.loopexit.loopexit.unr-lcssa, label %.lr.ph.i67, !llvm.loop !1390

.loopexit.loopexit.unr-lcssa:                     ; preds = %.lr.ph.i67
  %lcmp.mod168.not = icmp eq i64 %xtraiter164, 0
  br i1 %lcmp.mod168.not, label %.loopexit, label %.lr.ph.i67.epil.preheader

.lr.ph.i67.epil.preheader:                        ; preds = %.loopexit.loopexit.unr-lcssa, %.lr.ph.i67.preheader
  %.epil.init167 = phi ptr [ %.sroa.0113.0, %.lr.ph.i67.preheader ], [ %i.ha, %.loopexit.loopexit.unr-lcssa ]
  %.06.i.epil.init = phi i64 [ 0, %.lr.ph.i67.preheader ], [ %i.hb, %.loopexit.loopexit.unr-lcssa ]
  %lcmp.mod169 = icmp ne i64 %xtraiter164, 0
...
.lr.ph.i67.epil:                                  ; preds = %.lr.ph.i67.epil, %.lr.ph.i67.epil.preheader
  %i.hc = phi ptr [ %i.hg, %.lr.ph.i67.epil ], [ %.epil.init167, %.lr.ph.i67.epil.preheader ] ; 2 uses
  %.06.i.epil = phi i64 [ %i.hh, %.lr.ph.i67.epil ], [ %.06.i.epil.init, %.lr.ph.i67.epil.preheader ] ; 2 uses
  %epil.iter165 = phi i64 [ %epil.iter165.next, %.lr.ph.i67.epil ], [ 0, %.lr.ph.i67.epil.preheader ]
  ...
  br i1 %epil.iter165.cmp.not, label %.loopexit, label %.lr.ph.i67.epil, !llvm.loop !1402

.loopexit:                                        ; preds = %.loopexit.loopexit.unr-lcssa, %.lr.ph.i67.epil, %_ZN4absl12lts_2026052623inlined_vector_internal14AssignElementsISaIiENS1_20IteratorValueAdapterIS3_St24_Fwd_list_const_iteratorIiEEEEEvNSt16allocator_traitsIT_E7pointerERT0_NSA_9size_typeE.exit
  %i.hi = shl i64 %3, 1
