...
bb.an:                                            ; preds = %.critedge107
  ...
  %i.ea = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.dz, <2 x double> %i.dz, <2 x double> <double -1.000000e+00, double 1.000000e+00>) ; 2 uses
  %21 = fmul <2 x double> %i.ea, <double 1.000000e+00, double 6.000000e+00>
  ...
  %i.ee = fdiv <2 x double> %21, %i.ed            ; 2 uses
...
bb.an:                                            ; preds = %.critedge107
  ...
  %i.dz = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.dy, <2 x double> %i.dy, <2 x double> <double -1.000000e+00, double 1.000000e+00>) ; 2 uses
  %21 = fmul <2 x double> %i.dz, <double 1.000000e+00, double 6.000000e+00>
  ...
  %i.ed = fdiv <2 x double> %21, %i.ec            ; 2 uses
...
bb.an:                                            ; preds = %.critedge107
  ...
  %i.dv = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.du, <2 x double> %i.du, <2 x double> <double -1.000000e+00, double 1.000000e+00>) ; 2 uses
  %21 = fmul <2 x double> %i.dv, <double 1.000000e+00, double 6.000000e+00>
  ...
  %i.dz = fdiv <2 x double> %21, %i.dy            ; 2 uses
