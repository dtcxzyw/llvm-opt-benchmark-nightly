...
.lr.ph.preheader.i:                               ; preds = %_ZN4absl12lts_2026052612_GLOBAL__N_16Fls128ENS0_7uint128E.exit30.i
  ...
  %5 = add nuw nsw i32 %i.t, 1
  %6 = sub nsw i32 %5, %i.w
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i, %.lr.ph.preheader.i
  %.074.i = phi i32 [ %i.ba, %.lr.ph.i ], [ 0, %.lr.ph.preheader.i ]
  ...
  %i.ba = add nuw nsw i32 %.074.i, 1              ; 2 uses
  %exitcond.not.i = icmp eq i32 %i.ba, %6
