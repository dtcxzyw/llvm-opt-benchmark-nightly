...
begin_hunk_0_@_ZN4absl12lts_2026052618debugging_internal18DecodeRustPunycodeENS1_25DecodeRustPunycodeOptionsE:bb.a
...
bb.i:                                             ; preds = %bb.o, %.lr.ph.i51
  ...
  %i.ay = load i8, ptr %i.av, align 1, !tbaa !16  ; 4 uses
...
.lr.ph:                                           ; preds = %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit, %.lr.ph
  %.03795 = phi i32 [ %i.by, %.lr.ph ], [ %i.bw, %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit ] ; 2 uses
  %.14294 = phi i32 [ %i.bz, %.lr.ph ], [ 0, %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit ]
  %i.by = udiv i32 %.03795, 35                    ; 2 uses
  %i.bz = add i32 %.14294, 36                     ; 2 uses
  %i.ca = icmp ugt i32 %.03795, 15959
  br i1 %i.ca, label %.lr.ph, label %._crit_edge, !llvm.loop !23

._crit_edge:                                      ; preds = %.lr.ph, %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit
  %.142.lcssa = phi i32 [ 0, %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit ], [ %i.bz, %.lr.ph ]
  %.037.lcssa = phi i32 [ %i.bw, %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit ], [ %i.by, %.lr.ph ]
  ...
  call void @_ZN4absl12lts_2026052618debugging_internal16Utf8ForCodePointC1Em(ptr noundef nonnull align 4 dereferenceable(8) %2, i64 noundef %i.ch)
  %i.ci = load i32, ptr %i.ad, align 4, !tbaa !24 ; 6 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.cu = load i64, ptr %i.ct, align 8, !tbaa !19 ; 2 uses
...
._crit_edge.loopexit.i:                           ; preds = %.lr.ph48.i.6, %.lr.ph48.i.5, %.lr.ph48.i.4, %.lr.ph48.i.3, %.lr.ph48.i.2, %.lr.ph48.i.1, %.lr.ph48.i
  %.pre54.i = load i64, ptr %i.ct, align 8, !tbaa !19 ; 2 uses
...
_ZN4absl12lts_2026052618debugging_internal25BoundedUtf8LengthSequenceILj256EE32InsertAndReturnSumOfPredecessorsEjj.exit: ; preds = %.preheader.i, %._crit_edge.loopexit.i
  ...
  store i64 %i.hb, ptr %i.ct, align 8, !tbaa !19
  ...
  br i1 %.not, label %._crit_edge106, label %bb.h, !llvm.loop !21

._crit_edge106:                                   ; preds = %_ZN4absl12lts_2026052618debugging_internal25BoundedUtf8LengthSequenceILj256EE32InsertAndReturnSumOfPredecessorsEjj.exit, %bb.g
  %.038.lcssa = phi i32 [ %.1.ph, %bb.g ], [ %i.hi, %_ZN4absl12lts_2026052618debugging_internal25BoundedUtf8LengthSequenceILj256EE32InsertAndReturnSumOfPredecessorsEjj.exit ]
...
.critedge:                                        ; preds = %bb.h, %bb.m, %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_110DigitValueEc.exit.thread.i, %bb.o, %.lr.ph105, %.critedge.critedge, %._crit_edge106
  %.3 = phi ptr [ %i.hk, %._crit_edge106 ], [ null, %.critedge.critedge ], [ null, %.lr.ph105 ], [ null, %bb.m ], [ null, %bb.o ], [ null, %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_110DigitValueEc.exit.thread.i ], [ null, %bb.h ]
...
!8 = !{!"Simple C++ TBAA"}
!9 = !{!10, !11, i64 0}
!10 = !{!"_ZTSN4absl12lts_2026052618debugging_internal25DecodeRustPunycodeOptionsE", !11, i64 0, !11, i64 8, !11, i64 16, !11, i64 24}
...
!23 = distinct !{!23, !18}
!24 = !{!25, !6, i64 4}
!25 = !{!"_ZTSN4absl12lts_2026052618debugging_internal16Utf8ForCodePointE", !7, i64 0, !6, i64 4}
end_hunk_0
