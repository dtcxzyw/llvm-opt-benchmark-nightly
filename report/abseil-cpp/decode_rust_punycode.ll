...
.lr.ph.i51:                                       ; preds = %.lr.ph.i51.preheader, %bb.h
  ...
  %.0101147 = phi i32 [ %i.br, %bb.h ], [ %.1.ph, %.lr.ph.i51.preheader ]
  %.046102146 = phi i32 [ %i.cc, %bb.h ], [ 128, %.lr.ph.i51.preheader ]
  %.043103145 = phi i32 [ %i.ca, %bb.h ], [ 72, %.lr.ph.i51.preheader ] ; 3 uses
  %.040104144 = phi i32 [ %i.hf, %bb.h ], [ %.1.ph, %.lr.ph.i51.preheader ] ; 2 uses
  %i.as = add i32 %.043103145, 1
  %i.at = add i32 %.043103145, 26
...
bb.i:                                             ; preds = %bb.o, %.lr.ph.i51
  ...
  %.02550.i = phi i64 [ 1, %.lr.ph.i51 ], [ %i.bm, %bb.o ] ; 2 uses
  %.03349.i = phi i32 [ 36, %.lr.ph.i51 ], [ %i.bn, %bb.o ] ; 4 uses
...
bb.n:                                             ; preds = %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_110DigitValueEc.exit.thread.i
  %.not37.i = icmp ugt i32 %.03349.i, %i.as
  %.not38.i = icmp ult i32 %.03349.i, %i.at
  %i.bj = sub i32 %.03349.i, %.043103145
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.bm = mul i64 %.02550.i, %i.bl
  %i.bn = add i32 %.03349.i, 36
...
.lr.ph:                                           ; preds = %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit, %.lr.ph
  %.03796 = phi i32 [ %i.bv, %.lr.ph ], [ %i.bt, %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit ] ; 2 uses
  %.14495 = phi i32 [ %i.bw, %.lr.ph ], [ 0, %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit ]
  %i.bv = udiv i32 %.03796, 35                    ; 2 uses
  %i.bw = add i32 %.14495, 36                     ; 2 uses
  %i.bx = icmp ugt i32 %.03796, 15959
  br i1 %i.bx, label %.lr.ph, label %._crit_edge, !llvm.loop !23

._crit_edge:                                      ; preds = %.lr.ph, %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit
  %.144.lcssa = phi i32 [ 0, %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit ], [ %i.bw, %.lr.ph ]
  %.037.lcssa = phi i32 [ %i.bt, %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit ], [ %i.bv, %.lr.ph ]
  ...
  %i.cb = udiv i32 %i.bo, %i.br
  %i.cc = add i32 %i.cb, %.046102146              ; 2 uses
  %i.cd = urem i32 %i.bo, %i.br                   ; 7 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #5
  %i.ce = zext i32 %i.cc to i64
  call void @_ZN4absl12lts_2026052618debugging_internal16Utf8ForCodePointC1Em(ptr noundef nonnull align 4 dereferenceable(8) %2, i64 noundef %i.ce)
  %i.cf = load i32, ptr %i.ad, align 4, !tbaa !24 ; 6 uses
  %.not85 = icmp eq i32 %i.cf, 0
  br i1 %.not85, label %.critedge.critedge, label %bb.p

bb.p:                                             ; preds = %._crit_edge
  %i.cg = add i32 %.040104144, 1                  ; 2 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.cr = load i64, ptr %i.cq, align 8, !tbaa !19 ; 2 uses
...
.preheader.i:                                     ; preds = %.lr.ph.i53.6, %.lr.ph.i53.5, %.lr.ph.i53.4, %.lr.ph.i53.3, %.lr.ph.i53.2, %.lr.ph.i53.1, %.lr.ph.i53
  %.lcssa155 = phi <2 x i32> [ %i.dg, %.lr.ph.i53 ], [ %i.dq, %.lr.ph.i53.1 ], [ %i.ea, %.lr.ph.i53.2 ], [ %i.ek, %.lr.ph.i53.3 ], [ %i.eu, %.lr.ph.i53.4 ], [ %i.fe, %.lr.ph.i53.5 ], [ %i.fo, %.lr.ph.i53.6 ] ; 2 uses
...
.lr.ph.i53.5:                                     ; preds = %.lr.ph.i53.4
  ...
  %i.ey = load i64, ptr %i.ex, align 8, !tbaa !19
...
._crit_edge.loopexit.i:                           ; preds = %.lr.ph48.i.6, %.lr.ph48.i.5, %.lr.ph48.i.4, %.lr.ph48.i.3, %.lr.ph48.i.2, %.lr.ph48.i.1, %.lr.ph48.i
  %.pre54.i = load i64, ptr %i.cq, align 8, !tbaa !19 ; 2 uses
