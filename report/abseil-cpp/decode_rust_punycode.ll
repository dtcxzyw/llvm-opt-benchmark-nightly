...
bb.a:
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !17   ; 4 uses
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !18   ; 7 uses
...
.lr.ph.i:                                         ; preds = %bb.b, %.thread.i
  ...
  %i.p = load i8, ptr %i.o, align 1, !tbaa !20    ; 3 uses
...
bb.i:                                             ; preds = %bb.o, %.lr.ph.i51
  ...
  %i.ax = load i8, ptr %i.av, align 1, !tbaa !20  ; 4 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  br i1 %.not.not.i, label %.critedge, label %bb.i, !llvm.loop !11
...
.lr.ph:                                           ; preds = %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit, %.lr.ph
  ...
  br i1 %i.bz, label %.lr.ph, label %._crit_edge, !llvm.loop !12
...
._crit_edge:                                      ; preds = %.lr.ph, %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit
  ...
  %i.ch = load i32, ptr %i.ad, align 4, !tbaa !25 ; 6 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.ct = load i64, ptr %i.cs, align 8, !tbaa !23 ; 2 uses
...
._crit_edge.loopexit.i:                           ; preds = %.lr.ph48.i.6, %.lr.ph48.i.5, %.lr.ph48.i.4, %.lr.ph48.i.3, %.lr.ph48.i.2, %.lr.ph48.i.1, %.lr.ph48.i
  %.pre54.i = load i64, ptr %i.cs, align 8, !tbaa !23 ; 2 uses
...
.lr.ph48.i:                                       ; preds = %bb.q, %.preheader.i
  ...
  %i.fs = load i64, ptr %i.af, align 8, !tbaa !23 ; 2 uses
  %i.ft = call i64 @llvm.fshl.i64(i64 %.pre.i, i64 %i.fs, i64 2)
  store i64 %i.ft, ptr %i.ae, align 8, !tbaa !23
  %i.fu = icmp ult i32 %i.cf, 192
  br i1 %i.fu, label %.lr.ph48.i.1, label %._crit_edge.loopexit.i

.lr.ph48.i.1:                                     ; preds = %.lr.ph48.i
  %i.fv = load i64, ptr %i.ah, align 8, !tbaa !23 ; 2 uses
  %i.fw = call i64 @llvm.fshl.i64(i64 %i.fs, i64 %i.fv, i64 2)
  store i64 %i.fw, ptr %i.ag, align 8, !tbaa !23
  %i.fx = icmp ult i32 %i.cf, 160
  br i1 %i.fx, label %.lr.ph48.i.2, label %._crit_edge.loopexit.i

.lr.ph48.i.2:                                     ; preds = %.lr.ph48.i.1
  %i.fy = load i64, ptr %i.aj, align 8, !tbaa !23 ; 2 uses
  %i.fz = call i64 @llvm.fshl.i64(i64 %i.fv, i64 %i.fy, i64 2)
  store i64 %i.fz, ptr %i.ai, align 8, !tbaa !23
  %i.ga = icmp ult i32 %i.cf, 128
  br i1 %i.ga, label %.lr.ph48.i.3, label %._crit_edge.loopexit.i

.lr.ph48.i.3:                                     ; preds = %.lr.ph48.i.2
  %i.gb = load i64, ptr %i.al, align 8, !tbaa !23 ; 2 uses
  %i.gc = call i64 @llvm.fshl.i64(i64 %i.fy, i64 %i.gb, i64 2)
  store i64 %i.gc, ptr %i.ak, align 8, !tbaa !23
  %i.gd = icmp ult i32 %i.cf, 96
  br i1 %i.gd, label %.lr.ph48.i.4, label %._crit_edge.loopexit.i

.lr.ph48.i.4:                                     ; preds = %.lr.ph48.i.3
  %i.ge = load i64, ptr %i.an, align 8, !tbaa !23 ; 2 uses
  %i.gf = call i64 @llvm.fshl.i64(i64 %i.gb, i64 %i.ge, i64 2)
  store i64 %i.gf, ptr %i.am, align 8, !tbaa !23
  %i.gg = icmp ult i32 %i.cf, 64
  br i1 %i.gg, label %.lr.ph48.i.5, label %._crit_edge.loopexit.i

.lr.ph48.i.5:                                     ; preds = %.lr.ph48.i.4
  %i.gh = load i64, ptr %i.ap, align 8, !tbaa !23 ; 2 uses
  %i.gi = call i64 @llvm.fshl.i64(i64 %i.ge, i64 %i.gh, i64 2)
  store i64 %i.gi, ptr %i.ao, align 8, !tbaa !23
  %i.gj = icmp eq i32 %i.cm, 0
  br i1 %i.gj, label %.lr.ph48.i.6, label %._crit_edge.loopexit.i

.lr.ph48.i.6:                                     ; preds = %.lr.ph48.i.5
  %i.gk = load i64, ptr %1, align 8, !tbaa !23
  %i.gl = call i64 @llvm.fshl.i64(i64 %i.gh, i64 %i.gk, i64 2)
  store i64 %i.gl, ptr %i.aq, align 8, !tbaa !23
  br label %._crit_edge.loopexit.i

_ZN4absl12lts_2026052618debugging_internal25BoundedUtf8LengthSequenceILj256EE32InsertAndReturnSumOfPredecessorsEjj.exit: ; preds = %.preheader.i, %._crit_edge.loopexit.i
  %.pre-phi.i = phi i64 [ %.pre55.i, %._crit_edge.loopexit.i ], [ %i.cu, %.preheader.i ]
  %i.gm = phi i64 [ %.pre54.i, %._crit_edge.loopexit.i ], [ %i.ct, %.preheader.i ]
  %i.gn = phi <2 x i32> [ %i.fr, %._crit_edge.loopexit.i ], [ %.lcssa155, %.preheader.i ] ; 2 uses
  %i.go = extractelement <2 x i32> %i.gn, i64 0
  %i.gp = add nuw i32 %i.go, %spec.store.select.i
  %i.gq = extractelement <2 x i32> %i.gn, i64 1
  %i.gr = add nuw i32 %i.gp, %i.gq                ; 2 uses
  %i.gs = icmp ugt i32 %i.ch, 4
  %i.gt = add nsw i32 %i.ch, -1
  %i.gu = select i1 %i.gs, i32 0, i32 %i.gt
  %i.gv = zext i32 %i.gu to i64
  %i.gw = shl i64 %i.gv, %i.cp
  %i.gx = or i64 %.pre-phi.i, %i.gw
  %i.gy = and i64 %i.gm, %notmask.i
  %i.gz = shl i64 %i.gy, 2
  %i.ha = or i64 %i.gx, %i.gz
  store i64 %i.ha, ptr %i.cs, align 8, !tbaa !23
  %i.hb = zext i32 %i.gr to i64
  %i.hc = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.hb ; 3 uses
  %i.hd = zext i32 %i.ch to i64                   ; 2 uses
  %i.he = getelementptr inbounds nuw i8, ptr %i.hc, i64 %i.hd
  %i.hf = sub i32 %i.ci, %i.gr
  %i.hg = zext i32 %i.hf to i64
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %i.he, ptr nonnull align 1 %i.hc, i64 %i.hg, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.hc, ptr nonnull align 4 %2, i64 %i.hd, i1 false)
  %i.hh = add i32 %i.ch, %.038104144              ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #5
  %.not = icmp eq ptr %i.aw, %i.c
  br i1 %.not, label %._crit_edge107, label %bb.h, !llvm.loop !10

._crit_edge107:                                   ; preds = %_ZN4absl12lts_2026052618debugging_internal25BoundedUtf8LengthSequenceILj256EE32InsertAndReturnSumOfPredecessorsEjj.exit, %bb.g
  %.038.lcssa = phi i32 [ %.1.ph, %bb.g ], [ %i.hh, %_ZN4absl12lts_2026052618debugging_internal25BoundedUtf8LengthSequenceILj256EE32InsertAndReturnSumOfPredecessorsEjj.exit ]
  %i.hi = zext i32 %.038.lcssa to i64
  %i.hj = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.hi
  br label %.critedge
...
.critedge:                                        ; preds = %bb.h, %bb.m, %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_110DigitValueEc.exit.thread.i, %bb.o, %.lr.ph106, %.critedge.critedge, %._crit_edge107
  %.3 = phi ptr [ %i.hj, %._crit_edge107 ], [ null, %.critedge.critedge ], [ null, %.lr.ph106 ], [ null, %bb.m ], [ null, %bb.o ], [ null, %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_110DigitValueEc.exit.thread.i ], [ null, %bb.h ]
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #5
  br label %_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_126ConsumeOptionalAsciiPrefixERPKcS4_PcS6_Rj.exit

_ZN4absl12lts_2026052618debugging_internal12_GLOBAL__N_126ConsumeOptionalAsciiPrefixERPKcS4_PcS6_Rj.exit: ; preds = %bb.c, %.critedge, %bb.d, %bb.e, %bb.a
...
declare void @_ZN4absl12lts_2026052618debugging_internal16Utf8ForCodePointC1Em(ptr noundef nonnull align 4 dereferenceable(8), i64 noundef) unnamed_addr #2
...
!15 = !{!"_ZTSN4absl12lts_2026052618debugging_internal25DecodeRustPunycodeOptionsE", !14, i64 0, !14, i64 8, !14, i64 16, !14, i64 24}
!16 = !{!15, !14, i64 0}
!17 = !{!15, !14, i64 8}
!18 = !{!15, !14, i64 16}
!19 = !{!15, !14, i64 24}
...
!22 = !{!"long", !5, i64 0}
!23 = !{!22, !22, i64 0}
!24 = !{!"_ZTSN4absl12lts_2026052618debugging_internal16Utf8ForCodePointE", !5, i64 0, !6, i64 4}
!25 = !{!24, !6, i64 4}
end_hunk_0
