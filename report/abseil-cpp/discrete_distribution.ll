...
bb.a:
  %i.a = load ptr, ptr %1, align 8, !tbaa !9      ; 9 uses
...
.lr.ph.i:                                         ; preds = %bb.a, %.lr.ph.i
  ...
  %i.d = load double, ptr %.sroa.02.06.i, align 8, !tbaa !12
  %i.e = fadd double %.07.i, %i.d                 ; 4 uses
  %i.f = getelementptr inbounds nuw i8, ptr %.sroa.02.06.i, i64 8 ; 2 uses
  %.not.i = icmp eq ptr %i.f, %i.c
  br i1 %.not.i, label %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEdET0_T_S8_S7_.exit, label %.lr.ph.i, !llvm.loop !14
...
.lr.ph.preheader:                                 ; preds = %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEdET0_T_S8_S7_.exit
  ...
  br i1 %min.iters.check, label %.lr.ph.preheader530, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %next.gep, align 8, !tbaa !12
  %i.s = fdiv <2 x double> %wide.load, %broadcast.splat
  store <2 x double> %i.s, ptr %next.gep, align 8, !tbaa !12
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %.loopexit165, label %.lr.ph.preheader530

.lr.ph.preheader530:                              ; preds = %.lr.ph.preheader, %middle.block
  %.sroa.0142.0242.ph = phi ptr [ %i.a, %.lr.ph.preheader ], [ %i.q, %middle.block ]
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader530, %.lr.ph
  %.sroa.0142.0242 = phi ptr [ %i.w, %.lr.ph ], [ %.sroa.0142.0242.ph, %.lr.ph.preheader530 ] ; 3 uses
  %i.u = load double, ptr %.sroa.0142.0242, align 8, !tbaa !12
  %i.v = fdiv double %i.u, %i.e
  store double %i.v, ptr %.sroa.0142.0242, align 8, !tbaa !12
  %i.w = getelementptr inbounds nuw i8, ptr %.sroa.0142.0242, i64 8 ; 2 uses
  %.not = icmp eq ptr %i.w, %i.c
  br i1 %.not, label %.loopexit165, label %.lr.ph, !llvm.loop !19
...
bb.c:                                             ; preds = %.loopexit165
  ...
  %.not338 = icmp eq ptr %i.c, %i.a
  br i1 %.not338, label %_ZNSt6vectorISt4pairIdmESaIS1_EE7reserveEm.exit, label %_ZNSt12_Vector_baseISt4pairIdmESaIS1_EE11_M_allocateEm.exit.i
...
bb.e:                                             ; preds = %.lr.ph252, %_ZNSt6vectorImSaImEE9push_backEOm.exit
  %.0251 = phi i64 [ 0, %.lr.ph252 ], [ %.1, %_ZNSt6vectorImSaImEE9push_backEOm.exit ] ; 5 uses
  ...
  %i.am = load double, ptr %.sroa.0108.0244, align 8, !tbaa !12
  %i.an = fmul double %i.am, %i.ah                ; 3 uses
  %i.ao = load ptr, ptr %i.ai, align 8, !tbaa !23 ; 7 uses
  %i.ap = load ptr, ptr %i.ac, align 8, !tbaa !24
  %.not.i38 = icmp eq ptr %i.ao, %i.ap
  br i1 %.not.i38, label %bb.g, label %bb.f

bb.f:                                             ; preds = %bb.e
  store double %i.an, ptr %i.ao, align 8, !tbaa !25
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ao, i64 8
  store i64 0, ptr %i.aq, align 8, !tbaa !28
  %i.ar = getelementptr inbounds nuw i8, ptr %i.ao, i64 16
  store ptr %i.ar, ptr %i.ai, align 8, !tbaa !23
  br label %_ZNSt6vectorISt4pairIdmESaIS1_EE12emplace_backIJRKdiEEERS1_DpOT_.exit

bb.g:                                             ; preds = %bb.e
  %i.as = load ptr, ptr %0, align 8, !tbaa !20    ; 5 uses
...
.noexc40:                                         ; preds = %_ZNKSt6vectorISt4pairIdmESaIS1_EE12_M_check_lenEmPKc.exit.i.i
  ...
  store double %i.an, ptr %i.be, align 8, !tbaa !25
  %i.bf = getelementptr inbounds nuw i8, ptr %i.be, i64 8
  store i64 0, ptr %i.bf, align 8, !tbaa !28
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.noexc40, %.lr.ph.i.i.i.i.i
  ...
  br i1 %.not.i.i.i.i.i, label %_ZNSt6vectorISt4pairIdmESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit33.i.i, label %.lr.ph.i.i.i.i.i, !llvm.loop !33
...
_ZNSt6vectorISt4pairIdmESaIS1_EE17_M_realloc_insertIJRKdiEEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i: ; preds = %bb.i, %_ZNSt6vectorISt4pairIdmESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit33.i.i
  ...
  store ptr %i.bi, ptr %i.ai, align 8, !tbaa !23
  %i.bj = getelementptr inbounds nuw [16 x i8], ptr %i.bd, i64 %i.bb
  store ptr %i.bj, ptr %i.ac, align 8, !tbaa !24
  br label %_ZNSt6vectorISt4pairIdmESaIS1_EE12emplace_backIJRKdiEEERS1_DpOT_.exit
...
bb.k:                                             ; preds = %bb.j
  store i64 %.0251, ptr %.sroa.12.0246, align 8, !tbaa !34
...
.noexc43:                                         ; preds = %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i.i
  ...
  store i64 %.0251, ptr %i.bx, align 8, !tbaa !34
...
bb.q:                                             ; preds = %bb.p
  store i64 %.0251, ptr %.sroa.12131.0249, align 8, !tbaa !34
...
.noexc52:                                         ; preds = %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i.i45
  ...
  store i64 %.0251, ptr %i.cn, align 8, !tbaa !34
...
.lr.ph274:                                        ; preds = %.critedge.preheader
  %i.cs = load ptr, ptr %0, align 8, !tbaa !20
  br label %.critedge
...
.noexc58:                                         ; preds = %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i
  ...
  store i64 %i.cw, ptr %i.dr, align 8, !tbaa !34
...
bb.ab:                                            ; preds = %bb.aa
  store i64 %i.cw, ptr %i.cv, align 8, !tbaa !34
  br label %_ZNSt6vectorImSaImEE9push_backERKm.exit
...
.noexc67:                                         ; preds = %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i60
  ...
  store i64 %i.cw, ptr %i.eg, align 8, !tbaa !34
...
_ZNSt6vectorImSaImEE9push_backERKm.exit:          ; preds = %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i65, %bb.ab, %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i, %bb.w
  ...
  br i1 %or.cond, label %.critedge.preheader, label %.lr.ph265, !llvm.loop !35
...
.lr.ph277:                                        ; preds = %.preheader
  %i.em = load ptr, ptr %0, align 8, !tbaa !20
  br label %bb.ah

.critedge:                                        ; preds = %.lr.ph274, %.critedge
  %.sroa.088.0273 = phi ptr [ %.sroa.0125.2.lcssa, %.lr.ph274 ], [ %i.eq, %.critedge ] ; 2 uses
  %i.en = load i64, ptr %.sroa.088.0273, align 8, !tbaa !34 ; 2 uses
  %i.eo = getelementptr inbounds nuw [16 x i8], ptr %i.cs, i64 %i.en ; 2 uses
  store double 1.000000e+00, ptr %i.eo, align 8, !tbaa !25
  %i.ep = getelementptr inbounds nuw i8, ptr %i.eo, i64 8
  store i64 %i.en, ptr %i.ep, align 8, !tbaa !28
