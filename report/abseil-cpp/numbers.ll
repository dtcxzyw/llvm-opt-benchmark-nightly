...
_ZN4absl12lts_2026052612_GLOBAL__N_113EncodeFullU32EjPc.exit.i52.i: ; preds = %bb.i, %bb.j
  ...
  %i.eu = mul nuw nsw i64 %i.et, 5243
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.ge = mul nuw nsw i64 %i.gd, 5243
  %i.gf = lshr i64 %i.ge, 19
...
bb.q:                                             ; preds = %bb.o
  ...
  %i.hh = mul nuw nsw i64 %i.hg, 5243
  %i.hi = lshr i64 %i.hh, 19
...
_ZN4absl12lts_2026052612_GLOBAL__N_113EncodeFullU32EjPc.exit.i42.i: ; preds = %bb.l
  ...
  %i.ja = mul nuw nsw i64 %i.iz, 5243
  %i.jb = lshr i64 %i.ja, 19
...
_ZN4absl12lts_2026052612_GLOBAL__N_113EncodeFullU64EmPc.exit44.i: ; preds = %bb.n, %bb.p, %bb.q, %_ZN4absl12lts_2026052612_GLOBAL__N_113EncodeFullU32EjPc.exit.i42.i
  ...
  %i.ka = mul nuw nsw <2 x i64> %i.jz, splat (i64 5243)
  %i.kb = lshr <2 x i64> %i.ka, splat (i64 19)
...
bb.t:                                             ; preds = %bb.r
  ...
  %i.lc = mul nuw nsw i64 %i.lb, 5243
  %i.ld = lshr i64 %i.lc, 19
...
_ZN4absl12lts_2026052612_GLOBAL__N_113EncodeFullU64EmPc.exit.i: ; preds = %bb.s, %bb.t
  ...
  %i.mj = mul nuw nsw <2 x i64> %i.mi, splat (i64 5243)
  %i.mk = lshr <2 x i64> %i.mj, splat (i64 19)
  ...
  %i.nl = mul nuw nsw <2 x i64> %i.nk, splat (i64 5243)
  %i.nm = lshr <2 x i64> %i.nl, splat (i64 19)
...
_ZN4absl12lts_2026052612_GLOBAL__N_113EncodeFullU32EjPc.exit.i52.i: ; preds = %bb.k, %bb.l
  ...
  %i.fc = mul nuw nsw i64 %i.fb, 5243
  %i.fd = lshr i64 %i.fc, 19
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.gm = mul nuw nsw i64 %i.gl, 5243
  %i.gn = lshr i64 %i.gm, 19
...
bb.s:                                             ; preds = %bb.q
  ...
  %i.hp = mul nuw nsw i64 %i.ho, 5243
  %i.hq = lshr i64 %i.hp, 19
...
_ZN4absl12lts_2026052612_GLOBAL__N_113EncodeFullU32EjPc.exit.i42.i: ; preds = %bb.n
  ...
  %i.ji = mul nuw nsw i64 %i.jh, 5243
  %i.jj = lshr i64 %i.ji, 19
