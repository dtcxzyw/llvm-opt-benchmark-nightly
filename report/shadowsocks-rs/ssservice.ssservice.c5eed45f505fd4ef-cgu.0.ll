...
bb.ap:                                            ; preds = %bb.au, %bb.an
  ...
  %.not.i.i = icmp ult i64 %.pre-phi.i.i, %i.fk   ; 2 uses
  %i.fl = getelementptr inbounds nuw [112 x i8], ptr %i.fi, i64 %.pre-phi.i.i
  %.sroa.0.0.i.i.i.i = select i1 %.not.i.i, ptr %i.fl, ptr null
  %i.fm = getelementptr inbounds nuw i8, ptr %.sroa.0.0.i.i.i.i, i64 72
...
bb.an:                                            ; preds = %bb.as, %bb.al
  ...
  %.not.i.i = icmp ult i64 %.pre-phi.i.i, %i.ec   ; 2 uses
  %i.ed = getelementptr inbounds nuw [112 x i8], ptr %i.ea, i64 %.pre-phi.i.i
  %.sroa.0.0.i.i.i.i = select i1 %.not.i.i, ptr %i.ed, ptr null
  %i.ee = getelementptr inbounds nuw i8, ptr %.sroa.0.0.i.i.i.i, i64 72
...
bb.da:                                            ; preds = %bb.df, %bb.cy
  ...
  %.not.i.i.i.i = icmp ult i64 %.pre-phi.i.i.i.i, %i.pk ; 2 uses
  %i.pl = getelementptr inbounds nuw [112 x i8], ptr %i.pi, i64 %.pre-phi.i.i.i.i
  %.sroa.0.0.i.i.i.i.i.i = select i1 %.not.i.i.i.i, ptr %i.pl, ptr null
  %i.pm = getelementptr inbounds nuw i8, ptr %.sroa.0.0.i.i.i.i.i.i, i64 72
