...
bb.ey:                                            ; preds = %bb.fc, %bb.ew
  ...
  %.not.i.i = icmp ult i64 %.pre-phi.i.i, %i.un   ; 2 uses
  %i.uo = getelementptr inbounds nuw [112 x i8], ptr %i.ul, i64 %.pre-phi.i.i
  %.sroa.0.0.i.i.i.i = select i1 %.not.i.i, ptr %i.uo, ptr null
  %i.up = getelementptr inbounds nuw i8, ptr %.sroa.0.0.i.i.i.i, i64 72
