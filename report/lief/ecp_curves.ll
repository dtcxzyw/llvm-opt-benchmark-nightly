...
bb.q:                                             ; preds = %bb.p, %bb.o
  ...
  store i64 %i.hp, ptr %i.er, align 8, !tbaa !16
...
bb.w:                                             ; preds = %bb.v, %bb.u
  ...
  store i64 %i.ks, ptr %i.hq, align 8, !tbaa !16
  ...
  store i64 %i.kw, ptr %i.e, align 8, !tbaa !16
  %i.kx = getelementptr inbounds nuw i8, ptr %0, i64 10
  %i.ky = load i16, ptr %i.kx, align 2, !tbaa !14 ; 3 uses
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  store i64 %i.ln, ptr %i.ll, align 8, !tbaa !16
...
._crit_edge:                                      ; preds = %.lr.ph.epil, %bb.w
  %i.lu = icmp slt i8 %i.ko, 0
  br i1 %i.lu, label %.preheader.preheader, label %bb.x

.preheader.preheader:                             ; preds = %._crit_edge
  %i.lv = load <2 x i64>, ptr %i.b, align 8, !tbaa !16
  %i.lw = xor <2 x i64> %i.lv, splat (i64 -1)
  store <2 x i64> %i.lw, ptr %i.b, align 8, !tbaa !16
  %i.lx = load <2 x i64>, ptr %i.er, align 8, !tbaa !16
  %i.ly = xor <2 x i64> %i.lx, splat (i64 -1)
  store <2 x i64> %i.ly, ptr %i.er, align 8, !tbaa !16
  %i.lz = load i64, ptr %i.e, align 8, !tbaa !16
  %i.ma = xor i64 %i.lz, -1
  store i64 %i.ma, ptr %i.e, align 8, !tbaa !16
  %i.mb = load i64, ptr %i.b, align 8, !tbaa !16
  %i.mc = add i64 %i.mb, 1                        ; 2 uses
  store i64 %i.mc, ptr %i.b, align 8, !tbaa !16
  %.not465 = icmp eq i64 %i.mc, 0
  br i1 %.not465, label %.preheader.i.1, label %mbedtls_ecp_fix_negative.exit

.preheader.i.1:                                   ; preds = %.preheader.preheader
  %i.md = getelementptr inbounds nuw i8, ptr %i.b, i64 8 ; 2 uses
  %i.me = load i64, ptr %i.md, align 8, !tbaa !16
  %i.mf = add i64 %i.me, 1                        ; 2 uses
  store i64 %i.mf, ptr %i.md, align 8, !tbaa !16
  %.not466 = icmp eq i64 %i.mf, 0
  br i1 %.not466, label %.preheader.i.2, label %mbedtls_ecp_fix_negative.exit

.preheader.i.2:                                   ; preds = %.preheader.i.1
  %i.mg = getelementptr inbounds nuw i8, ptr %i.b, i64 16 ; 2 uses
  %i.mh = load i64, ptr %i.mg, align 8, !tbaa !16
  %i.mi = add i64 %i.mh, 1                        ; 2 uses
  store i64 %i.mi, ptr %i.mg, align 8, !tbaa !16
  %.not467 = icmp eq i64 %i.mi, 0
  br i1 %.not467, label %.preheader.i.3, label %mbedtls_ecp_fix_negative.exit

.preheader.i.3:                                   ; preds = %.preheader.i.2
  %i.mj = getelementptr inbounds nuw i8, ptr %i.b, i64 24 ; 2 uses
  %i.mk = load i64, ptr %i.mj, align 8, !tbaa !16
  %i.ml = add i64 %i.mk, 1                        ; 2 uses
  store i64 %i.ml, ptr %i.mj, align 8, !tbaa !16
  %.not468 = icmp eq i64 %i.ml, 0
  br i1 %.not468, label %.preheader.i.4, label %mbedtls_ecp_fix_negative.exit

.preheader.i.4:                                   ; preds = %.preheader.i.3
  %i.mm = getelementptr inbounds nuw i8, ptr %i.b, i64 32 ; 2 uses
  %i.mn = load i64, ptr %i.mm, align 8, !tbaa !16
  %i.mo = add i64 %i.mn, 1
...
mbedtls_ecp_fix_negative.exit:                    ; preds = %.preheader.i.4, %.preheader.i.3, %.preheader.i.2, %.preheader.i.1, %.preheader.preheader
  ...
  store i16 -1, ptr %i.mp, align 8, !tbaa !13
  %i.mq = sext i8 %i.ko to i64
  %i.mr = load i64, ptr %i.e, align 8, !tbaa !16
  %i.ms = sub i64 %i.mr, %i.mq
  store i64 %i.ms, ptr %i.e, align 8, !tbaa !16
  br label %bb.x
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  store i64 %i.bm, ptr %i.b, align 8, !tbaa !16
  %i.bn = getelementptr inbounds nuw i8, ptr %i.b, i64 8 ; 2 uses
  %i.bo = load i64, ptr %i.bn, align 8, !tbaa !16 ; 2 uses
...
begin_hunk_1_@ecp_mod_p384:bb.a
  ...
  store i64 %i.kn, ptr %i.hq, align 8, !tbaa !16
  %i.ko = getelementptr inbounds nuw i8, ptr %i.b, i64 32 ; 4 uses
  %i.kp = load i64, ptr %i.ko, align 8, !tbaa !16 ; 2 uses
...
bb.ac:                                            ; preds = %bb.ab, %bb.aa
  ...
  store i64 %i.mq, ptr %i.ko, align 8, !tbaa !16
  %i.mr = getelementptr inbounds nuw i8, ptr %i.b, i64 40 ; 2 uses
  %i.ms = load i64, ptr %i.mr, align 8, !tbaa !16 ; 2 uses
...
bb.ai:                                            ; preds = %bb.ah, %bb.ag
  ...
  store i64 %i.ot, ptr %i.mr, align 8, !tbaa !16
  ...
  store i64 %i.ox, ptr %i.e, align 8, !tbaa !16
  %i.oy = getelementptr inbounds nuw i8, ptr %0, i64 10
  %i.oz = load i16, ptr %i.oy, align 2, !tbaa !14 ; 3 uses
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  store i64 %i.po, ptr %i.pm, align 8, !tbaa !16
...
._crit_edge:                                      ; preds = %.lr.ph.epil, %bb.ai
  %i.pv = icmp slt i8 %i.op, 0
  br i1 %i.pv, label %.preheader.preheader, label %bb.aj

.preheader.preheader:                             ; preds = %._crit_edge
  %i.pw = load <2 x i64>, ptr %i.b, align 8, !tbaa !16
  %i.px = xor <2 x i64> %i.pw, splat (i64 -1)
  store <2 x i64> %i.px, ptr %i.b, align 8, !tbaa !16
  %i.py = load <2 x i64>, ptr %i.ee, align 8, !tbaa !16
  %i.pz = xor <2 x i64> %i.py, splat (i64 -1)
  store <2 x i64> %i.pz, ptr %i.ee, align 8, !tbaa !16
  %i.qa = load <2 x i64>, ptr %i.ko, align 8, !tbaa !16
  %i.qb = xor <2 x i64> %i.qa, splat (i64 -1)
  store <2 x i64> %i.qb, ptr %i.ko, align 8, !tbaa !16
  %i.qc = load i64, ptr %i.e, align 8, !tbaa !16
  %i.qd = xor i64 %i.qc, -1
  store i64 %i.qd, ptr %i.e, align 8, !tbaa !16
  %i.qe = load i64, ptr %i.b, align 8, !tbaa !16
  %i.qf = add i64 %i.qe, 1                        ; 2 uses
  store i64 %i.qf, ptr %i.b, align 8, !tbaa !16
  %.not604 = icmp eq i64 %i.qf, 0
  br i1 %.not604, label %.preheader.i.1, label %mbedtls_ecp_fix_negative.exit

.preheader.i.1:                                   ; preds = %.preheader.preheader
  %i.qg = getelementptr inbounds nuw i8, ptr %i.b, i64 8 ; 2 uses
  %i.qh = load i64, ptr %i.qg, align 8, !tbaa !16
  %i.qi = add i64 %i.qh, 1                        ; 2 uses
  store i64 %i.qi, ptr %i.qg, align 8, !tbaa !16
  %.not605 = icmp eq i64 %i.qi, 0
  br i1 %.not605, label %.preheader.i.2, label %mbedtls_ecp_fix_negative.exit

.preheader.i.2:                                   ; preds = %.preheader.i.1
  %i.qj = getelementptr inbounds nuw i8, ptr %i.b, i64 16 ; 2 uses
  %i.qk = load i64, ptr %i.qj, align 8, !tbaa !16
  %i.ql = add i64 %i.qk, 1                        ; 2 uses
  store i64 %i.ql, ptr %i.qj, align 8, !tbaa !16
  %.not606 = icmp eq i64 %i.ql, 0
  br i1 %.not606, label %.preheader.i.3, label %mbedtls_ecp_fix_negative.exit

.preheader.i.3:                                   ; preds = %.preheader.i.2
  %i.qm = getelementptr inbounds nuw i8, ptr %i.b, i64 24 ; 2 uses
  %i.qn = load i64, ptr %i.qm, align 8, !tbaa !16
  %i.qo = add i64 %i.qn, 1                        ; 2 uses
  store i64 %i.qo, ptr %i.qm, align 8, !tbaa !16
  %.not607 = icmp eq i64 %i.qo, 0
  br i1 %.not607, label %.preheader.i.4, label %mbedtls_ecp_fix_negative.exit

.preheader.i.4:                                   ; preds = %.preheader.i.3
  %i.qp = getelementptr inbounds nuw i8, ptr %i.b, i64 32 ; 2 uses
  %i.qq = load i64, ptr %i.qp, align 8, !tbaa !16
  %i.qr = add i64 %i.qq, 1                        ; 2 uses
  store i64 %i.qr, ptr %i.qp, align 8, !tbaa !16
  %.not608 = icmp eq i64 %i.qr, 0
  br i1 %.not608, label %.preheader.i.5, label %mbedtls_ecp_fix_negative.exit

.preheader.i.5:                                   ; preds = %.preheader.i.4
  %i.qs = getelementptr inbounds nuw i8, ptr %i.b, i64 40 ; 2 uses
  %i.qt = load i64, ptr %i.qs, align 8, !tbaa !16
  %i.qu = add i64 %i.qt, 1                        ; 2 uses
  store i64 %i.qu, ptr %i.qs, align 8, !tbaa !16
  %.not609 = icmp eq i64 %i.qu, 0
  br i1 %.not609, label %.preheader.i.6, label %mbedtls_ecp_fix_negative.exit

.preheader.i.6:                                   ; preds = %.preheader.i.5
  %i.qv = getelementptr inbounds nuw i8, ptr %i.b, i64 48 ; 2 uses
  %i.qw = load i64, ptr %i.qv, align 8, !tbaa !16
  %i.qx = add i64 %i.qw, 1
  store i64 %i.qx, ptr %i.qv, align 8, !tbaa !16
  br label %mbedtls_ecp_fix_negative.exit
...
mbedtls_ecp_fix_negative.exit:                    ; preds = %.preheader.i.6, %.preheader.i.5, %.preheader.i.4, %.preheader.i.3, %.preheader.i.2, %.preheader.i.1, %.preheader.preheader
  ...
  store i16 -1, ptr %i.qy, align 8, !tbaa !13
  %i.qz = sext i8 %i.op to i64
  %i.ra = load i64, ptr %i.e, align 8, !tbaa !16
  %i.rb = sub i64 %i.ra, %i.qz
  store i64 %i.rb, ptr %i.e, align 8, !tbaa !16
  br label %bb.aj
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.q = load i16, ptr %i.b, align 2, !tbaa !14   ; 2 uses
...
.lr.ph.preheader:                                 ; preds = %bb.c
  ...
  call void @llvm.memset.p0.i64(ptr align 8 %scevgep, i8 0, i64 %i.u, i1 false), !tbaa !16
  br label %._crit_edge
...
bb.a:
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #5
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 10 ; 2 uses
  %i.c = load i16, ptr %i.b, align 2, !tbaa !14   ; 4 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  store i16 1, ptr %i.e, align 8, !tbaa !13
  store ptr @ecp_mod_p256k1.Rp, ptr %2, align 8, !tbaa !15
  %i.f = getelementptr inbounds nuw i8, ptr %2, i64 10 ; 2 uses
  store i16 1, ptr %i.f, align 2, !tbaa !14
  %i.g = getelementptr inbounds nuw i8, ptr %1, i64 8
  store i16 1, ptr %i.g, align 8, !tbaa !13
  store ptr %i.a, ptr %1, align 8, !tbaa !15
  %i.h = add i16 %i.c, -4
  ...
  store i16 %i.n, ptr %i.i, align 2, !tbaa !14
...
.lr.ph.preheader.i:                               ; preds = %bb.b
  ...
  call void @llvm.memset.p0.i64(ptr align 8 %i.k, i8 0, i64 %i.q, i1 false), !tbaa !16
