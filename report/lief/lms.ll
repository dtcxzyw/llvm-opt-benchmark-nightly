...
bb.c:                                             ; preds = %bb.b
  ...
  %i.p = load i32, ptr %i.a, align 4, !tbaa !8
...
bb.d:                                             ; preds = %bb.c
  ...
  store i64 %i.u, ptr %3, align 8, !tbaa !13
  br label %bb.e
...
bb.h:                                             ; preds = %bb.g
  ...
  store i32 4, ptr %i.o, align 4, !tbaa !15
...
bb.i:                                             ; preds = %bb.h
  %i.q = load i32, ptr %i.g, align 4, !tbaa !8
...
bb.j:                                             ; preds = %bb.i
  %i.v = load i32, ptr %i.g, align 4, !tbaa !8
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.k
  ...
  %.not78 = trunc i32 %.06484 to i1               ; 2 uses
  ...
  %.95 = select i1 %.not78, ptr %i.ai, ptr %i.d
  %.96 = select i1 %.not78, ptr %i.d, ptr %i.ai
...
bb.o:                                             ; preds = %bb.n
  %i.ao = load i32, ptr %i.g, align 4, !tbaa !19
...
bb.p:                                             ; preds = %bb.o
  %i.as = load i32, ptr %i.g, align 4, !tbaa !19
...
bb.q:                                             ; preds = %bb.p
  %i.aw = load i32, ptr %i.g, align 4, !tbaa !19
...
bb.f:                                             ; preds = %bb.e
  %i.q = load i32, ptr %i.c, align 4, !tbaa !19
  %i.r = icmp eq i32 %i.q, 6
...
!7 = !{!"Simple C/C++ TBAA"}
!8 = !{!9, !5, i64 20}
!9 = !{!"", !10, i64 0, !6, i64 24, !6, i64 56}
!10 = !{!"", !6, i64 0, !5, i64 16, !5, i64 20}
!11 = !{!9, !5, i64 16}
!12 = !{!9, !6, i64 56}
!13 = !{!14, !14, i64 0}
!14 = !{!"long", !6, i64 0}
!15 = !{!16, !5, i64 20}
!16 = !{!"", !6, i64 0, !6, i64 16, !5, i64 20}
!17 = distinct !{!17, !18}
