...
begin_hunk_0_@mbedtls_chacha20_update:bb.a
...
vector.body105:                                   ; preds = %vector.ph103, %vector.body105
...
.lr.ph66.preheader:                               ; preds = %iter.check, %vector.memcheck96, %vec.epilog.iter.check, %vec.epilog.middle.block
...
bb.b:                                             ; preds = %bb.a, %bb.b
  ...
  %i.ds = add i32 %i.dr, %i.co                    ; 3 uses
  %i.dt = xor i32 %i.ds, %i.cq                    ; 2 uses
  %i.du = tail call i32 @llvm.fshl.i32(i32 %i.dt, i32 %i.dt, i32 7) ; 2 uses
end_hunk_0
