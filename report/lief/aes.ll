...
.preheader.i:                                     ; preds = %bb.g
  ...
  %3 = getelementptr inbounds nuw i8, ptr %i.d, i64 13
  %4 = getelementptr inbounds nuw i8, ptr %i.d, i64 11
  %5 = load i8, ptr %i.u, align 2
  %i.w = load i8, ptr %3, align 1
  %i.x = load i8, ptr %4, align 1
  %6 = load i8, ptr %i.v, align 1
  %i.y = zext i8 %5 to i16
  %7 = zext i8 %6 to i16
  %8 = zext i8 %i.w to i16
  %i.z = zext i8 %i.x to i16
  %i.aa = insertelement <4 x i16> poison, i16 %7, i64 0
  %i.ab = insertelement <4 x i16> %i.aa, i16 %i.z, i64 1
  %i.ac = insertelement <4 x i16> %i.ab, i16 %8, i64 2
  %i.ad = insertelement <4 x i16> %i.ac, i16 %i.y, i64 3
  br label %bb.h
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ce = extractelement <4 x i16> %i.cd, i64 3
  ...
  %i.cj = extractelement <4 x i16> %i.cd, i64 0
  ...
  %i.cx = extractelement <4 x i16> %i.cd, i64 1
