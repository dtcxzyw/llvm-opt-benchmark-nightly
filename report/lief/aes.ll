...
.preheader.i:                                     ; preds = %bb.g
  ...
  %3 = load <16 x i8>, ptr %i.u, align 2
  %4 = shufflevector <16 x i8> %3, <16 x i8> poison, <2 x i32> <i32 0, i32 poison>
  %i.v = getelementptr inbounds nuw i8, ptr %i.d, i64 9
  %i.w = load i8, ptr %i.v, align 1
  %5 = insertelement <2 x i8> %4, i8 %i.w, i64 1
  %6 = zext <2 x i8> %5 to <2 x i16>
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.bv = zext i8 %i.bu to i16                    ; 3 uses
  %10 = insertelement <2 x i16> poison, i16 %i.bv, i64 0
  %11 = shufflevector <2 x i16> %10, <2 x i16> poison, <2 x i32> zeroinitializer
  %12 = add nuw nsw <2 x i16> %11, %6
  %13 = urem <2 x i16> %12, splat (i16 255)       ; 2 uses
  %14 = extractelement <2 x i16> %13, i64 0
  %i.bw = zext nneg i16 %14 to i64
  %i.bx = getelementptr inbounds nuw i8, ptr %i.c, i64 %i.bw
  %i.by = load i8, ptr %i.bx, align 1, !tbaa !11
  %i.bz = zext i8 %i.by to i32
  %15 = extractelement <2 x i16> %13, i64 1
  %i.ca = zext nneg i16 %15 to i64
  ...
  %.lhs.trunc87.i = add nuw nsw i16 %i.bv, %i.z
  %16 = urem i16 %.lhs.trunc87.i, 255
  %i.cg = zext nneg i16 %16 to i64
  ...
  %.lhs.trunc89.i = add nuw nsw i16 %i.bv, %9
  %17 = urem i16 %.lhs.trunc89.i, 255
  %i.cm = zext nneg i16 %17 to i64
