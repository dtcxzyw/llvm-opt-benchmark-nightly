...
bb.f:                                             ; preds = %bb.e
  ...
  %i.kc = load i32, ptr %i.an, align 4, !tbaa !12
  %3 = load i32, ptr %i.ai, align 8, !tbaa !12
  %i.kd = load i32, ptr %i.ad, align 4, !tbaa !12
  %4 = load i32, ptr %i.f, align 16, !tbaa !12
  %5 = tail call i32 @llvm.bswap.i32(i32 %i.kc)   ; 2 uses
  %i.ke = tail call i32 @llvm.bswap.i32(i32 %3)   ; 2 uses
  %6 = tail call i32 @llvm.bswap.i32(i32 %i.kd)   ; 2 uses
  %i.kf = tail call i32 @llvm.bswap.i32(i32 %4)   ; 2 uses
  %i.kg = tail call i32 @llvm.fshl.i32(i32 %5, i32 %i.kf, i32 19)
  %7 = tail call i32 @llvm.fshl.i32(i32 %i.ke, i32 %5, i32 19)
  %8 = tail call i32 @llvm.fshl.i32(i32 %6, i32 %i.ke, i32 19)
  %9 = tail call i32 @llvm.fshl.i32(i32 %i.kf, i32 %6, i32 19)
  %10 = tail call i32 @llvm.bswap.i32(i32 %i.kg)
  %i.kh = tail call i32 @llvm.bswap.i32(i32 %7)
  %11 = tail call i32 @llvm.bswap.i32(i32 %8)
  %i.ki = tail call i32 @llvm.bswap.i32(i32 %9)
  %i.kj = load <4 x i32>, ptr %i.a, align 16, !tbaa !12
  %i.kk = insertelement <4 x i32> poison, i32 %i.ki, i64 0
  %i.kl = insertelement <4 x i32> %i.kk, i32 %11, i64 1
  %i.km = insertelement <4 x i32> %i.kl, i32 %i.kh, i64 2
  %i.kn = insertelement <4 x i32> %i.km, i32 %10, i64 3
