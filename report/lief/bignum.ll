...
begin_hunk_0_@mbedtls_mpi_safe_cond_swap:bb.a
  %i.ae = sext i16 %i.z to i64
  %i.af = add nsw i64 %i.ae, 1
  %i.ag = and i64 %i.ad, 4294967295
  %i.ah = and i64 %i.af, 4294967295               ; 2 uses
  %i.ai = tail call { i64, i64, i64 } asm sideeffect "and  $0, $1                      \0A\09not  $0                              \0A\09and  $0, $2                      \0A\09or   $1, $2                            \0A\09", "=&{di},=&{si},=&{ax},0,1,2,~{dirflag},~{fpsr},~{flags}"(i64 %i.c, i64 range(i64 0, 4294967296) %i.ag, i64 range(i64 0, 4294967296) %i.ah) #16, !srcloc !24
  %i.aj = extractvalue { i64, i64, i64 } %i.ai, 2
  %i.ak = trunc i64 %i.aj to i16
  %i.al = add i16 %i.ak, -1
  store i16 %i.al, ptr %i.y, align 8, !tbaa !21
  %i.am = load i16, ptr %i.aa, align 8, !tbaa !21
  %i.an = sext i16 %i.am to i64
  %i.ao = add nsw i64 %i.an, 1
  %i.ap = and i64 %i.ao, 4294967295
  %i.aq = tail call { i64, i64, i64 } asm sideeffect "and  $0, $1                      \0A\09not  $0                              \0A\09and  $0, $2                      \0A\09or   $1, $2                            \0A\09", "=&{di},=&{si},=&{ax},0,1,2,~{dirflag},~{fpsr},~{flags}"(i64 %i.c, i64 range(i64 0, 4294967296) %i.ah, i64 range(i64 0, 4294967296) %i.ap) #16, !srcloc !24
  %i.ar = extractvalue { i64, i64, i64 } %i.aq, 2
  %i.as = trunc i64 %i.ar to i16
  %i.at = add i16 %i.as, -1
  store i16 %i.at, ptr %i.aa, align 8, !tbaa !21
  %i.au = load ptr, ptr %0, align 8, !tbaa !23
  %i.av = load ptr, ptr %1, align 8, !tbaa !23
  %i.aw = load i16, ptr %i.h, align 2, !tbaa !20
  %i.ax = zext i16 %i.aw to i64
  tail call void @mbedtls_mpi_core_cond_swap(ptr noundef %i.au, ptr noundef %i.av, i64 noundef %i.ax, i64 noundef %i.c) #16
  br label %mbedtls_mpi_grow.exit

mbedtls_mpi_grow.exit:                            ; preds = %bb.i, %bb.g, %bb.d, %bb.b, %bb.m, %bb.a
  %.021 = phi i32 [ 0, %bb.a ], [ 0, %bb.m ], [ -141, %bb.b ], [ -141, %bb.d ], [ -141, %bb.i ], [ -141, %bb.g ]
  ret i32 %.021
}
...
bb.b:                                             ; preds = %bb.a
  %i.b = load ptr, ptr %0, align 8, !tbaa !23     ; 2 uses
  %.not = icmp eq ptr %i.b, null
  br i1 %.not, label %bb.d, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 10
  %i.d = load i16, ptr %i.c, align 2, !tbaa !20
  %i.e = zext i16 %i.d to i64
  %i.f = shl nuw nsw i64 %i.e, 3
  tail call void @mbedtls_zeroize_and_free(ptr noundef nonnull %i.b, i64 noundef %i.f) #16
  br label %bb.d
...
; Function Attrs: nounwind uwtable
define hidden range(i32 -141, 1) i32 @mbedtls_mpi_shrink(ptr nofree noundef captures(none) %0, i64 noundef %1) local_unnamed_addr #0 {
bb.a:
...
bb.d:                                             ; preds = %bb.c
  %i.g = tail call noalias ptr @calloc(i64 noundef %1, i64 noundef 8) #17 ; 4 uses
  %i.h = icmp eq ptr %i.g, null
  br i1 %i.h, label %mbedtls_mpi_grow.exit, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.i = load ptr, ptr %0, align 8, !tbaa !23     ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  tail call void @mbedtls_zeroize_and_free(ptr noundef nonnull %i.i, i64 noundef %i.j) #16
  br label %mbedtls_mpi_grow.exit.sink.split

.preheader:                                       ; preds = %.lr.ph
  %.0 = add nsw i64 %.044, -1                     ; 2 uses
  %.not30 = icmp eq i64 %.0, 0
  br i1 %.not30, label %.preheader._crit_edge, label %.lr.ph, !llvm.loop !35
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.preheader
  ...
  br i1 %.not31, label %.preheader, label %._crit_edge, !llvm.loop !35

._crit_edge:                                      ; preds = %.lr.ph
  br label %.preheader._crit_edge, !llvm.loop !35
...
.preheader._crit_edge:                            ; preds = %.preheader, %._crit_edge, %.preheader.preheader
  ...
  %i.m = tail call noalias ptr @calloc(i64 noundef %spec.select, i64 noundef 8) #17 ; 4 uses
  %i.n = icmp eq ptr %i.m, null
  br i1 %i.n, label %mbedtls_mpi_grow.exit, label %bb.g

bb.g:                                             ; preds = %.preheader._crit_edge
  %i.o = load ptr, ptr %0, align 8, !tbaa !23     ; 3 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  tail call void @mbedtls_zeroize_and_free(ptr noundef nonnull %i.o, i64 noundef %i.q) #16
  br label %mbedtls_mpi_grow.exit.sink.split
...
mbedtls_mpi_grow.exit.sink.split:                 ; preds = %bb.g, %bb.h, %bb.e, %bb.f
  ...
  store i16 %i.r, ptr %i.b, align 2, !tbaa !20
...
mbedtls_mpi_grow.exit:                            ; preds = %mbedtls_mpi_grow.exit.sink.split, %bb.d, %bb.c, %.preheader._crit_edge, %bb.a
  %.025 = phi i32 [ 0, %bb.c ], [ -141, %.preheader._crit_edge ], [ -141, %bb.a ], [ -141, %bb.d ], [ 0, %mbedtls_mpi_grow.exit.sink.split ]
  ret i32 %.025
}

; Function Attrs: nounwind uwtable
define hidden range(i32 -141, 1) i32 @mbedtls_mpi_copy(ptr nofree noundef captures(address) %0, ptr nofree noundef readonly captures(address) %1) local_unnamed_addr #0 {
bb.a:
  %i.a = icmp eq ptr %0, %1
  br i1 %i.a, label %mbedtls_mpi_grow.exit, label %bb.b
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.c = load i16, ptr %i.b, align 2, !tbaa !20   ; 2 uses
...
2:                                                ; preds = %bb.f
  ...
  %.not = icmp eq i64 %.0, 0
  br i1 %.not, label %._crit_edge, label %bb.f, !llvm.loop !36
...
bb.f:                                             ; preds = %.lr.ph.a, %2
  ...
  br i1 %.not37, label %2, label %bb.g, !llvm.loop !36
...
._crit_edge:                                      ; preds = %2, %bb.e
  ...
  %i.q = load i16, ptr %i.p, align 8, !tbaa !21
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i16 %i.q, ptr %i.r, align 8, !tbaa !21
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 10 ; 2 uses
  %i.t = load i16, ptr %i.s, align 2, !tbaa !20   ; 2 uses
...
bb.i:                                             ; preds = %._crit_edge, %bb.h
  ...
  %i.w = tail call noalias ptr @calloc(i64 noundef %.0.in65, i64 noundef 8) #17 ; 4 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  tail call void @mbedtls_zeroize_and_free(ptr noundef nonnull %i.y, i64 noundef %i.z) #16
  br label %bb.l

bb.l:                                             ; preds = %bb.j, %bb.k
  %i.aa = trunc nuw nsw i64 %.0.in65 to i16
  store i16 %i.aa, ptr %11, align 2, !tbaa !20
...
mbedtls_mpi_grow.exit.thread.a:                   ; preds = %bb.l, %bb.m
  ...
  %i.ag = load ptr, ptr %1, align 8, !tbaa !23
...
mbedtls_mpi_grow.exit:                            ; preds = %bb.h, %bb.i, %mbedtls_mpi_grow.exit.thread.a, %bb.c, %bb.d, %bb.a
  %.028 = phi i32 [ 0, %bb.c ], [ 0, %bb.a ], [ 0, %bb.d ], [ 0, %mbedtls_mpi_grow.exit.thread.a ], [ -141, %bb.i ], [ -141, %bb.h ]
  ret i32 %.028
}
...
; Function Attrs: nounwind uwtable
define hidden range(i32 -141, 1) i32 @mbedtls_mpi_lset(ptr nofree noundef captures(none) %0, i64 noundef %1) local_unnamed_addr #0 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  %i.f = tail call noalias dereferenceable_or_null(8) ptr @calloc(i64 noundef 1, i64 noundef 8) #17 ; 3 uses
...
bb.d:                                             ; preds = %bb.c
  tail call void @mbedtls_zeroize_and_free(ptr noundef nonnull %i.h, i64 noundef 0) #16
  br label %bb.e

bb.e:                                             ; preds = %bb.d, %bb.c
  store i16 1, ptr %i.a, align 2, !tbaa !20
...
bb.f:                                             ; preds = %._crit_edge, %bb.e
  ...
  store i64 %.0.i7, ptr %i.k, align 8, !tbaa !26
  %i.l = ashr i64 %1, 62
  %i.m = trunc nsw i64 %i.l to i16
  %i.n = or i16 %i.m, 1
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i16 %i.n, ptr %i.o, align 8, !tbaa !21
  br label %mbedtls_mpi_grow.exit

mbedtls_mpi_grow.exit:                            ; preds = %bb.b, %bb.f
  %.0.i10 = phi i32 [ 0, %bb.f ], [ -141, %bb.b ]
  ret i32 %.0.i10
}
...
bb.a:
  ...
  %i.b = load i16, ptr %i.a, align 2, !tbaa !20
...
; Function Attrs: nounwind uwtable
define hidden range(i32 -141, 1) i32 @mbedtls_mpi_set_bit(ptr nofree noundef captures(none) %0, i64 noundef %1, i8 noundef zeroext %2) local_unnamed_addr #0 {
bb.a:
...
bb.f:                                             ; preds = %bb.e
  %i.j = tail call noalias ptr @calloc(i64 noundef %i.h, i64 noundef 8) #17 ; 3 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  tail call void @mbedtls_zeroize_and_free(ptr noundef nonnull %i.l, i64 noundef %i.m) #16
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.g
  %i.n = trunc nuw nsw i64 %i.h to i16
  store i16 %i.n, ptr %i.c, align 2, !tbaa !20
...
mbedtls_mpi_grow.exit:                            ; preds = %bb.f, %bb.d, %mbedtls_mpi_grow.exit.thread, %bb.c, %bb.a
  %.019 = phi i32 [ 0, %bb.c ], [ -135, %bb.a ], [ 0, %mbedtls_mpi_grow.exit.thread ], [ -141, %bb.f ], [ -141, %bb.d ]
  ret i32 %.019
}

; Function Attrs: nofree norecurse nosync nounwind memory(read, inaccessiblemem: none, target_mem: none) uwtable
define hidden range(i64 0, 4194240) i64 @mbedtls_mpi_lsb(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #8 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 10
  %i.b = load i16, ptr %i.a, align 2, !tbaa !20   ; 2 uses
  %i.c = zext i16 %i.b to i64
