...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load81 = load <8 x i8>, ptr %i.r, align 1, !tbaa !16, !alias.scope !18, !noalias !21
  %i.s = getelementptr inbounds nuw i8, ptr %.061, i64 %i.q
  %wide.load82 = load <8 x i8>, ptr %i.s, align 1, !tbaa !16, !alias.scope !21
...
vector.memcheck:                                  ; preds = %iter.check
  ...
  %scevgep100 = getelementptr i8, ptr %i.o, i64 408
  %scevgep101 = getelementptr i8, ptr %1, i64 %.0.i60.lcssa
  %scevgep102 = getelementptr i8, ptr %1, i64 %spec.select
...
vec.epilog.ph:                                    ; preds = %vector.memcheck
  ...
  %n.vec107 = sub nsw i64 %i.k, %i.p              ; 2 uses
  %i.q = add nsw i64 %.0.i60.lcssa, %n.vec107
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index108 = phi i64 [ 0, %vec.epilog.ph ], [ %index.next111, %vec.epilog.vector.body ] ; 2 uses
  %i.r = add nuw i64 %.0.i60.lcssa, %index108     ; 2 uses
  %i.s = getelementptr inbounds nuw i8, ptr %i.h, i64 %i.r ; 2 uses
  %wide.load109 = load <8 x i8>, ptr %i.s, align 1, !tbaa !16, !alias.scope !35, !noalias !38
  %i.t = getelementptr inbounds nuw i8, ptr %1, i64 %i.r
  %wide.load110 = load <8 x i8>, ptr %i.t, align 1, !tbaa !16, !alias.scope !38
  %i.u = xor <8 x i8> %wide.load110, %wide.load109
  store <8 x i8> %i.u, ptr %i.s, align 1, !tbaa !16, !alias.scope !35, !noalias !38
  %index.next111 = add nuw i64 %index108, 8       ; 2 uses
  %i.v = icmp eq i64 %index.next111, %n.vec107
  br i1 %i.v, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !40

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n112 = icmp eq i64 %i.p, 0
  br i1 %cmp.n112, label %mbedtls_xor.exit63, label %.lr.ph74.preheader
...
bb.f:                                             ; preds = %bb.e, %bb.b
  ...
  %.046 = phi i64 [ %i.bg, %bb.e ], [ %2, %bb.b ] ; 3 uses
  %.045 = phi ptr [ %i.bh, %bb.e ], [ %1, %bb.b ] ; 2 uses
  store i64 %.pre-phi, ptr %i.a, align 8, !tbaa !34
  %i.bi = icmp ugt i64 %.046, 15
...
mbedtls_xor.exit59:                               ; preds = %mbedtls_xor.exit59, %.lr.ph80
  ...
  %i.bo = add i64 %.14778, -16                    ; 3 uses
  %i.bp = getelementptr inbounds nuw i8, ptr %.179, i64 16 ; 2 uses
...
._crit_edge:                                      ; preds = %mbedtls_xor.exit59, %bb.f
  %.147.lcssa = phi i64 [ %.046, %bb.f ], [ %i.bo, %mbedtls_xor.exit59 ] ; 10 uses
  %.1.lcssa = phi ptr [ %.045, %bb.f ], [ %i.bp, %mbedtls_xor.exit59 ] ; 9 uses
...
bb.g:                                             ; preds = %._crit_edge
  ...
  %.not.i83 = icmp samesign ult i64 %.147.lcssa, 8
...
.preheader:                                       ; preds = %.preheader.loopexit, %bb.g
  ...
  %i.bt = icmp samesign ult i64 %.0.i.lcssa, %.147.lcssa
  br i1 %i.bt, label %iter.check137, label %mbedtls_xor.exit

iter.check137:                                    ; preds = %.preheader
  %i.bu = sub nuw nsw i64 %.147.lcssa, %.0.i.lcssa ; 2 uses
  %min.iters.check122 = icmp samesign ult i64 %i.bu, 8
  br i1 %min.iters.check122, label %.lr.ph89.preheader, label %vector.memcheck114

vector.memcheck114:                               ; preds = %iter.check137
  %i.bv = getelementptr i8, ptr %0, i64 %.0.i.lcssa
  %scevgep115 = getelementptr i8, ptr %i.bv, i64 408
  %i.bw = getelementptr i8, ptr %0, i64 %.147.lcssa
  %scevgep116 = getelementptr i8, ptr %i.bw, i64 408
  %scevgep117 = getelementptr i8, ptr %.1.lcssa, i64 %.0.i.lcssa
  %scevgep118 = getelementptr i8, ptr %.1.lcssa, i64 %.147.lcssa
  %bound0119 = icmp ult ptr %scevgep115, %scevgep118
  %bound1120 = icmp ult ptr %scevgep117, %scevgep116
  %found.conflict121 = and i1 %bound0119, %bound1120
  br i1 %found.conflict121, label %.lr.ph89.preheader, label %vec.epilog.ph141

vec.epilog.ph141:                                 ; preds = %vector.memcheck114
  %i.bx = and i64 %.147.lcssa, 7                  ; 2 uses
  %n.vec142 = sub nsw i64 %i.bu, %i.bx            ; 2 uses
  %i.by = add nsw i64 %.0.i.lcssa, %n.vec142
  br label %vec.epilog.vector.body143

vec.epilog.vector.body143:                        ; preds = %vec.epilog.vector.body143, %vec.epilog.ph141
  %index144 = phi i64 [ 0, %vec.epilog.ph141 ], [ %index.next147, %vec.epilog.vector.body143 ] ; 2 uses
  %i.bz = add nuw i64 %.0.i.lcssa, %index144      ; 2 uses
  %i.ca = getelementptr inbounds nuw i8, ptr %i.br, i64 %i.bz ; 2 uses
  %wide.load145 = load <8 x i8>, ptr %i.ca, align 1, !tbaa !16, !alias.scope !44, !noalias !47
  %i.cb = getelementptr inbounds nuw i8, ptr %.1.lcssa, i64 %i.bz
  %wide.load146 = load <8 x i8>, ptr %i.cb, align 1, !tbaa !16, !alias.scope !47
  %i.cc = xor <8 x i8> %wide.load146, %wide.load145
  store <8 x i8> %i.cc, ptr %i.ca, align 1, !tbaa !16, !alias.scope !44, !noalias !47
  %index.next147 = add nuw i64 %index144, 8       ; 2 uses
  %i.cd = icmp eq i64 %index.next147, %n.vec142
  br i1 %i.cd, label %vec.epilog.middle.block148, label %vec.epilog.vector.body143, !llvm.loop !49

vec.epilog.middle.block148:                       ; preds = %vec.epilog.vector.body143
  %cmp.n149 = icmp eq i64 %i.bx, 0
  br i1 %cmp.n149, label %mbedtls_xor.exit, label %.lr.ph89.preheader

.lr.ph89.preheader:                               ; preds = %vector.memcheck114, %iter.check137, %vec.epilog.middle.block148
  %.1.i88.ph = phi i64 [ %.0.i.lcssa, %vector.memcheck114 ], [ %.0.i.lcssa, %iter.check137 ], [ %i.by, %vec.epilog.middle.block148 ] ; 4 uses
  %i.ce = sub i64 %.147.lcssa, %.1.i88.ph
  %xtraiter152 = and i64 %i.ce, 3                 ; 2 uses
  %lcmp.mod153.not = icmp eq i64 %xtraiter152, 0
  br i1 %lcmp.mod153.not, label %.lr.ph89.prol.loopexit, label %.lr.ph89.prol

.lr.ph89.prol:                                    ; preds = %.lr.ph89.preheader, %.lr.ph89.prol
  %.1.i88.prol = phi i64 [ %i.ck, %.lr.ph89.prol ], [ %.1.i88.ph, %.lr.ph89.preheader ] ; 3 uses
  %prol.iter154 = phi i64 [ %prol.iter154.next, %.lr.ph89.prol ], [ 0, %.lr.ph89.preheader ]
  %i.cf = getelementptr inbounds nuw i8, ptr %i.br, i64 %.1.i88.prol ; 2 uses
  %i.cg = load i8, ptr %i.cf, align 1, !tbaa !16
  %i.ch = getelementptr inbounds nuw i8, ptr %.1.lcssa, i64 %.1.i88.prol
...
.lr.ph89:                                         ; preds = %.lr.ph89.prol.loopexit, %.lr.ph89
  ...
  %i.cp = getelementptr inbounds nuw i8, ptr %.1.lcssa, i64 %.1.i88
  ...
  %i.cv = getelementptr inbounds nuw i8, ptr %.1.lcssa, i64 %i.cs
  ...
  %i.db = getelementptr inbounds nuw i8, ptr %.1.lcssa, i64 %i.cy
  ...
  %i.dh = getelementptr inbounds nuw i8, ptr %.1.lcssa, i64 %i.de
  ...
  %exitcond93.not.3 = icmp eq i64 %i.dk, %.147.lcssa
  br i1 %exitcond93.not.3, label %mbedtls_xor.exit, label %.lr.ph89, !llvm.loop !51

mbedtls_xor.exit:                                 ; preds = %.lr.ph89.prol.loopexit, %.lr.ph89, %vec.epilog.middle.block148, %.preheader, %._crit_edge, %bb.a
  %.048 = phi i32 [ -135, %bb.a ], [ 0, %._crit_edge ], [ 0, %.preheader ], [ 0, %vec.epilog.middle.block148 ], [ 0, %.lr.ph89 ], [ 0, %.lr.ph89.prol.loopexit ]
  ret i32 %.048
}
