...
bb.l:                                             ; preds = %bb.k
  ...
  br i1 %.not53.i, label %bb.k, label %ecp_mul_mxz.exit, !llvm.loop !42
...
bb.o:                                             ; preds = %bb.s
  ...
  br i1 %.not47.i, label %._crit_edge, label %.lr.ph, !llvm.loop !43
...
bb.s:                                             ; preds = %bb.r
  ...
  br i1 %.not52.i, label %bb.o, label %ecp_mul_mxz.exit, !llvm.loop !43
...
bb.u:                                             ; preds = %mbedtls_ecp_get_type.exit29
  ...
  %i.bb = load i64, ptr %i.ba, align 8, !tbaa !32 ; 6 uses
...
.preheader24.i:                                   ; preds = %bb.y, %.preheader24.i
  ...
  br i1 %i.ce, label %.preheader24.i, label %bb.z, !llvm.loop !44
...
bb.ab:                                            ; preds = %bb.ae
  ...
  br i1 %exitcond.not.i.i, label %.lr.ph14.i.i.preheader, label %.lr.ph.i.i, !llvm.loop !45
...
.lr.ph14.i.i:                                     ; preds = %.lr.ph14.i.i.preheader, %.lr.ph14.i.i
  ...
  %i.dm = add nuw nsw i64 %.113.i.i, 1            ; 2 uses
  %i.dn = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %.113.i.i
  store ptr %i.dl, ptr %i.dn, align 8, !tbaa !33
  %i.do = shl nuw nsw i32 %.05312.i.i, 1          ; 2 uses
  %i.dp = icmp samesign ult i32 %i.do, %i.bn
  br i1 %i.dp, label %.lr.ph14.i.i, label %._crit_edge.i.i, !llvm.loop !46
...
bb.af:                                            ; preds = %.lr.ph95
  ...
  br i1 %.not70.i.i, label %._crit_edge96, label %.lr.ph95, !llvm.loop !47
...
.lr.ph95:                                         ; preds = %.lr.ph16.i.i, %bb.af
  ...
  br i1 %.not71.i.i, label %bb.af, label %ecp_precompute_comb.exit.i, !llvm.loop !47

._crit_edge96:                                    ; preds = %bb.af, %.lr.ph16.i.i
  %i.dx = shl i8 %.15415.i.i, 1                   ; 2 uses
  %i.dy = zext i8 %i.dx to i32
  %i.dz = icmp samesign ugt i32 %i.bn, %i.dy
  br i1 %i.dz, label %.lr.ph16.i.i, label %.lr.ph18.i.i.preheader, !llvm.loop !48

.lr.ph18.i.i.preheader:                           ; preds = %._crit_edge96
  %i.ea = add nsw i64 %i.bv, -1                   ; 2 uses
  br i1 %.not11.i.i.not, label %vector.ph, label %.lr.ph18.i.i.preheader101

vector.ph:                                        ; preds = %.lr.ph18.i.i.preheader
  %n.vec = and i64 %i.ea, -4                      ; 5 uses
  %i.eb = or disjoint i64 %n.vec, 1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ec = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %index ; 2 uses
  %i.ed = getelementptr inbounds nuw i8, ptr %i.ec, i64 16
  store <2 x ptr> %wide.gep98, ptr %i.ec, align 16, !tbaa !33
  store <2 x ptr> %wide.gep99, ptr %i.ed, align 16, !tbaa !33
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %vec.ind.next = add <2 x i64> %vec.ind, splat (i64 4)
  %i.ee = icmp eq i64 %index.next, %n.vec
  br i1 %i.ee, label %middle.block, label %vector.body, !llvm.loop !49
...
.lr.ph18.i.i.preheader101:                        ; preds = %.lr.ph18.i.i.preheader, %middle.block
  %.ph = phi i64 [ 1, %.lr.ph18.i.i.preheader ], [ %i.eb, %middle.block ]
  %.317.i.i.ph = phi i64 [ 0, %.lr.ph18.i.i.preheader ], [ %n.vec, %middle.block ]
  br label %.lr.ph18.i.i

.lr.ph18.i.i:                                     ; preds = %.lr.ph18.i.i.preheader101, %.lr.ph18.i.i
  %i.ef = phi i64 [ %i.ej, %.lr.ph18.i.i ], [ %.ph, %.lr.ph18.i.i.preheader101 ] ; 3 uses
  %.317.i.i = phi i64 [ %i.ef, %.lr.ph18.i.i ], [ %.317.i.i.ph, %.lr.ph18.i.i.preheader101 ] ; 2 uses
  %i.eg = getelementptr inbounds nuw [48 x i8], ptr %i.bw, i64 %.317.i.i
  %i.eh = getelementptr inbounds nuw i8, ptr %i.eg, i64 48
  %i.ei = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %.317.i.i
  store ptr %i.eh, ptr %i.ei, align 8, !tbaa !33
  %i.ej = add nuw nsw i64 %i.ef, 1                ; 2 uses
  %exitcond29.not.i.i = icmp eq i64 %i.ej, %i.bv
  br i1 %exitcond29.not.i.i, label %._crit_edge19.i.i, label %.lr.ph18.i.i, !llvm.loop !50
...
ecp_precompute_comb.exit.i:                       ; preds = %bb.ae, %mbedtls_ecp_copy.exit78.i.i, %bb.ad, %bb.ac, %.lr.ph95, %.preheader.i.i, %._crit_edge19.i.i, %._crit_edge.i.i, %mbedtls_ecp_copy.exit.i.i, %bb.aa, %bb.z
  %.056.i.i = phi i32 [ %i.cn, %mbedtls_ecp_copy.exit.i.i ], [ %i.ci, %bb.z ], [ %i.ck, %bb.aa ], [ %i.dq, %._crit_edge.i.i ], [ %i.dw, %.lr.ph95 ], [ %i.ek, %._crit_edge19.i.i ], [ 0, %.preheader.i.i ], [ %i.df, %bb.ad ], [ %i.dc, %bb.ac ], [ %i.dj, %bb.ae ], [ %i.di, %mbedtls_ecp_copy.exit78.i.i ] ; 2 uses
...
bb.ah:                                            ; preds = %bb.ag
  %i.en = getelementptr inbounds nuw i8, ptr %0, i64 176
  store ptr %i.bw, ptr %i.en, align 8, !tbaa !23
  %i.eo = getelementptr inbounds nuw i8, ptr %0, i64 184
  store i64 %i.bv, ptr %i.eo, align 8, !tbaa !24
  br label %bb.ai
...
bb.ai:                                            ; preds = %bb.ah, %bb.ag, %bb.x
  ...
  %i.eq = call i32 @mbedtls_mpi_get_bit(ptr noundef nonnull %i.ep, i64 noundef 0) #18
  %.not.i.i71.i = icmp eq i32 %i.eq, 1
...
bb.aj:                                            ; preds = %bb.ai
  %i.er = call i32 @mbedtls_mpi_get_bit(ptr noundef %2, i64 noundef 0) #18
  %i.es = icmp eq i32 %i.er, 0
  %i.et = zext i1 %i.es to i8                     ; 2 uses
  %i.eu = call i32 @mbedtls_mpi_copy(ptr noundef nonnull %10, ptr noundef %2) #18 ; 2 uses
  %.not15.i.i.i = icmp eq i32 %i.eu, 0
  br i1 %.not15.i.i.i, label %bb.ak, label %ecp_comb_recode_scalar.exit.i.i

bb.ak:                                            ; preds = %bb.aj
  %i.ev = call i32 @mbedtls_mpi_sub_mpi(ptr noundef nonnull %11, ptr noundef nonnull %i.ep, ptr noundef %2) #18 ; 2 uses
  %.not16.i.i.i = icmp eq i32 %i.ev, 0
  br i1 %.not16.i.i.i, label %bb.al, label %ecp_comb_recode_scalar.exit.i.i

bb.al:                                            ; preds = %bb.ak
  %i.ew = call i32 @mbedtls_mpi_safe_cond_assign(ptr noundef nonnull %10, ptr noundef nonnull %11, i8 noundef zeroext %i.et) #18 ; 2 uses
  %.not17.i.i.i = icmp eq i32 %i.ew, 0
  br i1 %.not17.i.i.i, label %bb.am, label %ecp_comb_recode_scalar.exit.i.i

bb.am:                                            ; preds = %bb.al
  %i.ex = add nuw i64 %i.bs, 1
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(1) %i.a, i8 0, i64 %i.ex, i1 false)
...
.preheader48.i.i.i.i:                             ; preds = %bb.am, %bb.ao
  %.04550.i.i.i.i = phi i64 [ %i.fi, %bb.ao ], [ 0, %bb.am ] ; 3 uses
  %i.ey = getelementptr inbounds nuw i8, ptr %i.a, i64 %.04550.i.i.i.i ; 2 uses
  br label %bb.an

bb.an:                                            ; preds = %bb.an, %.preheader48.i.i.i.i
  %.04449.i.i.i.i = phi i64 [ 0, %.preheader48.i.i.i.i ], [ %i.fh, %bb.an ] ; 3 uses
  %i.ez = mul i64 %.04449.i.i.i.i, %i.bs
  %i.fa = add i64 %i.ez, %.04550.i.i.i.i
  %i.fb = call i32 @mbedtls_mpi_get_bit(ptr noundef nonnull %10, i64 noundef %i.fa) #18
  %i.fc = trunc nuw nsw i64 %.04449.i.i.i.i to i32
  %i.fd = shl i32 %i.fb, %i.fc
  %i.fe = load i8, ptr %i.ey, align 1, !tbaa !27
  %i.ff = trunc i32 %i.fd to i8
  %i.fg = or i8 %i.fe, %i.ff
  store i8 %i.fg, ptr %i.ey, align 1, !tbaa !27
  %i.fh = add nuw nsw i64 %.04449.i.i.i.i, 1      ; 2 uses
  %exitcond.not.i.i.i.i = icmp eq i64 %i.fh, %i.bp
  br i1 %exitcond.not.i.i.i.i, label %bb.ao, label %bb.an, !llvm.loop !52

bb.ao:                                            ; preds = %bb.an
  %i.fi = add nuw nsw i64 %.04550.i.i.i.i, 1      ; 2 uses
  %exitcond55.not.i.i.i.i = icmp eq i64 %i.fi, %i.bs
  br i1 %exitcond55.not.i.i.i.i, label %.lr.ph.i.i.i.i.preheader, label %.preheader48.i.i.i.i, !llvm.loop !53
...
.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i.preheader, %.lr.ph.i.i.i.i
  %store_forwarded = phi i8 [ %load_initial, %.lr.ph.i.i.i.i.preheader ], [ %i.fs, %.lr.ph.i.i.i.i ] ; 2 uses
  %.053.i.i.i.i = phi i8 [ 0, %.lr.ph.i.i.i.i.preheader ], [ %i.fr, %.lr.ph.i.i.i.i ] ; 2 uses
  %.152.i.i.i.i = phi i64 [ 1, %.lr.ph.i.i.i.i.preheader ], [ %i.fv, %.lr.ph.i.i.i.i ] ; 3 uses
  %i.fj = getelementptr inbounds nuw i8, ptr %i.a, i64 %.152.i.i.i.i ; 3 uses
  %i.fk = load i8, ptr %i.fj, align 1, !tbaa !27  ; 2 uses
  %i.fl = and i8 %i.fk, %.053.i.i.i.i
  %i.fm = xor i8 %i.fk, %.053.i.i.i.i             ; 3 uses
  %i.fn = and i8 %i.fm, 1
  %i.fo = xor i8 %i.fn, 1                         ; 2 uses
  %i.fp = getelementptr i8, ptr %i.fj, i64 -1
  %narrow.i.i.i.i = mul nuw nsw i8 %i.fo, %store_forwarded ; 2 uses
  %i.fq = and i8 %narrow.i.i.i.i, %i.fm
  %i.fr = or i8 %i.fq, %i.fl
  %i.fs = xor i8 %narrow.i.i.i.i, %i.fm           ; 2 uses
  store i8 %i.fs, ptr %i.fj, align 1, !tbaa !27
  %i.ft = shl nuw i8 %i.fo, 7
  %i.fu = or i8 %i.ft, %store_forwarded
  store i8 %i.fu, ptr %i.fp, align 1, !tbaa !27
  %i.fv = add nuw nsw i64 %.152.i.i.i.i, 1
  %exitcond56.not.i.i.i.i = icmp eq i64 %.152.i.i.i.i, %i.bs
  br i1 %exitcond56.not.i.i.i.i, label %ecp_comb_recode_scalar.exit.i.i, label %.lr.ph.i.i.i.i, !llvm.loop !54

ecp_comb_recode_scalar.exit.i.i:                  ; preds = %.lr.ph.i.i.i.i, %bb.am, %bb.al, %bb.ak, %bb.aj
  %.0.i.i.i = phi i32 [ %i.eu, %bb.aj ], [ %i.ev, %bb.ak ], [ %i.ew, %bb.al ], [ 0, %bb.am ], [ 0, %.lr.ph.i.i.i.i ] ; 2 uses
...
bb.ap:                                            ; preds = %ecp_comb_recode_scalar.exit.i.i
  ...
  %i.fw = getelementptr inbounds nuw i8, ptr %8, i64 16 ; 2 uses
  call void @mbedtls_mpi_init(ptr noundef nonnull %i.fw) #18
  %i.fx = getelementptr inbounds nuw i8, ptr %8, i64 32 ; 2 uses
  call void @mbedtls_mpi_init(ptr noundef nonnull %i.fx) #18
  %i.fy = getelementptr inbounds nuw i8, ptr %9, i64 16 ; 2 uses
  call void @mbedtls_mpi_init(ptr noundef nonnull %9) #18
  %i.fz = getelementptr inbounds nuw i8, ptr %9, i64 32 ; 2 uses
  call void @mbedtls_mpi_init(ptr noundef nonnull %i.fy) #18
  %i.ga = getelementptr inbounds nuw i8, ptr %9, i64 48 ; 2 uses
  call void @mbedtls_mpi_init(ptr noundef nonnull %i.fz) #18
  call void @mbedtls_mpi_init(ptr noundef nonnull %i.ga) #18
  %i.gb = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.bs
  %i.gc = load i8, ptr %i.gb, align 1, !tbaa !27
  %i.gd = call fastcc i32 @ecp_select_comb(ptr noundef %0, ptr noundef %1, ptr noundef nonnull %.0549.i, i8 noundef zeroext range(i8 2, 33) %i.bo, i8 noundef zeroext %i.gc) ; 2 uses
  %.not.i22.i.i = icmp eq i32 %i.gd, 0
...
bb.ar:                                            ; preds = %bb.aq
  ...
  %i.gf = call i32 @mbedtls_mpi_random(ptr noundef nonnull %7, i64 noundef 2, ptr noundef nonnull %i.ge, ptr noundef nonnull %4, ptr noundef %5) #18 ; 2 uses
  %.not.i40.i.i.i = icmp eq i32 %i.gf, 0
  br i1 %.not.i40.i.i.i, label %bb.as, label %ecp_randomize_jac.exit.i.i.i

bb.as:                                            ; preds = %bb.ar
  %i.gg = getelementptr inbounds nuw i8, ptr %1, i64 32 ; 2 uses
  ...
  %.not22.i.i.i.i = icmp eq i32 %i.gh, 0
  br i1 %.not22.i.i.i.i, label %bb.at, label %ecp_randomize_jac.exit.i.i.i

bb.at:                                            ; preds = %bb.as
  %i.gi = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 4 uses
  %i.gj = call fastcc i32 @mbedtls_mpi_mul_mod(ptr noundef nonnull %0, ptr noundef nonnull %i.gi, ptr noundef nonnull %i.gi, ptr noundef nonnull %7) ; 2 uses
  %.not23.i.i.i.i = icmp eq i32 %i.gj, 0
  br i1 %.not23.i.i.i.i, label %bb.au, label %ecp_randomize_jac.exit.i.i.i

bb.au:                                            ; preds = %bb.at
  %i.gk = call fastcc i32 @mbedtls_mpi_mul_mod(ptr noundef nonnull %0, ptr noundef nonnull %7, ptr noundef nonnull %7, ptr noundef nonnull %7) ; 2 uses
  %.not24.i.i.i.i = icmp eq i32 %i.gk, 0
  br i1 %.not24.i.i.i.i, label %bb.av, label %ecp_randomize_jac.exit.i.i.i

bb.av:                                            ; preds = %bb.au
  %i.gl = call fastcc i32 @mbedtls_mpi_mul_mod(ptr noundef nonnull %0, ptr noundef nonnull %1, ptr noundef nonnull %1, ptr noundef nonnull %7) ; 2 uses
  %.not25.i.i.i.i = icmp eq i32 %i.gl, 0
  br i1 %.not25.i.i.i.i, label %bb.aw, label %ecp_randomize_jac.exit.i.i.i

bb.aw:                                            ; preds = %bb.av
  %i.gm = call fastcc i32 @mbedtls_mpi_mul_mod(ptr noundef nonnull %0, ptr noundef nonnull %i.gi, ptr noundef nonnull %i.gi, ptr noundef nonnull %7)
  br label %ecp_randomize_jac.exit.i.i.i

ecp_randomize_jac.exit.i.i.i:                     ; preds = %bb.aw, %bb.av, %bb.au, %bb.at, %bb.as, %bb.ar
  %.0.i.i.i.i = phi i32 [ %i.gf, %bb.ar ], [ %i.gh, %bb.as ], [ %i.gj, %bb.at ], [ %i.gk, %bb.au ], [ %i.gl, %bb.av ], [ %i.gm, %bb.aw ] ; 2 uses
  call void @mbedtls_mpi_free(ptr noundef nonnull %7) #18
  %i.gn = icmp eq i32 %.0.i.i.i.i, -14
  %spec.store.select.i.i.i.i = select i1 %i.gn, i32 -19712, i32 %.0.i.i.i.i ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #18
  %i.go = icmp eq i32 %spec.store.select.i.i.i.i, 0
  %.old1.i.i.i = icmp uge i64 %i.br, %i.bp
  %or.cond2.i.i.i = and i1 %.old1.i.i.i, %i.go
