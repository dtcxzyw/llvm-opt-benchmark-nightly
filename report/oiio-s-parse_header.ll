...
.loopexit:                                        ; preds = %63, %.thread78, %37
  ...
  %.4 = phi i32 [ %31, %37 ], [ %.265.ph, %.thread78 ], [ %.366, %63 ] ; [#uses=1 type=i32]
  %.4.fr = freeze i32 %.4                         ; [#uses=2 type=i32]
  %64 = icmp eq i32 %.4.fr, -1                    ; [#uses=1 type=i1]
  %65 = icmp eq i64 %.05685, %2                   ; [#uses=1 type=i1]
  %. = select i1 %65, i32 0, i32 10               ; [#uses=1 type=i32]
  %spec.select113 = select i1 %64, i32 %., i32 %.4.fr ; [#uses=1 type=i32]
...
.loopexit:                                        ; preds = %34, %.thread
  ...
  %.4 = phi i32 [ %.2.ph, %.thread ], [ %.3, %34 ] ; [#uses=1 type=i32]
  %.4.fr = freeze i32 %.4                         ; [#uses=2 type=i32]
  %36 = icmp eq i32 %.4.fr, -1                    ; [#uses=1 type=i1]
  %37 = icmp eq i64 %.02940, %4                   ; [#uses=1 type=i1]
  %. = select i1 %37, i32 0, i32 10               ; [#uses=1 type=i32]
  %spec.select60 = select i1 %36, i32 %., i32 %.4.fr ; [#uses=1 type=i32]
  br label %.loopexit.thread
