...
bb.b:                                             ; preds = %bb.l, %bb.a
  %i.e = load i8, ptr %i.c, align 8, !range !20, !alias.scope !21, !noundef !5
...
bb.e:                                             ; preds = %bb.k, %bb.g
  ...
  %i.i = load i64, ptr %i.b, align 8, !range !22, !alias.scope !23, !noundef !5
...
bb.i:                                             ; preds = %_RNvXs8_NtCs2wCc12Mnjqg_5ropey4iterNtB5_6ChunksNtNtNtNtCskKLDkoKarTP_4core4iter6traits8iterator8Iterator4next.exit
  %i.n = load i64, ptr %i.b, align 8, !range !22, !alias.scope !24, !noundef !5
...
bb.a:
  ...
  %i.b = load i8, ptr %i.a, align 8, !alias.scope !27, !noundef !5 ; 3 uses
  %i.c = zext i8 %i.b to i64                      ; 2 uses
  %i.d = icmp ult i8 %i.b, 25
  br i1 %i.d, label %bb.c, label %bb.b, !prof !6

bb.b:                                             ; preds = %bb.a
  tail call void @_RNvNtNtCskKLDkoKarTP_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %i.c, i64 noundef 24, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @51) #22, !noalias !27
  unreachable
...
.lr.ph.i:                                         ; preds = %bb.c, %bb.e
  ...
  %i.h = load ptr, ptr %.sroa.0.02.i, align 8, !alias.scope !27, !nonnull !5, !noundef !5
...
bb.b:                                             ; preds = %bb.a
  tail call void @_RNvNtNtCskKLDkoKarTP_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %1, i64 noundef %2, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @35) #22, !noalias !30
  unreachable

bb.c:                                             ; preds = %bb.a
  %i.b = icmp ugt i64 %0, %1
  br i1 %i.b, label %bb.d, label %_RNvNtNtCskKLDkoKarTP_4core5slice5index16into_slice_range.exit, !prof !7

bb.d:                                             ; preds = %bb.c
  tail call void @_RNvNtNtCskKLDkoKarTP_4core5slice5index16slice_index_fail(i64 noundef %0, i64 noundef %1, i64 noundef %2, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @36) #22, !noalias !30
  unreachable
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.b, align 1, !alias.scope !43, !noalias !44
  %wide.load6 = load <2 x i64>, ptr %i.d, align 1, !alias.scope !43, !noalias !44
  %i.e = getelementptr inbounds nuw i8, ptr %i.c, i64 16 ; 2 uses
  %wide.load7 = load <2 x i64>, ptr %i.c, align 1, !alias.scope !44, !noalias !41
  %wide.load8 = load <2 x i64>, ptr %i.e, align 1, !alias.scope !44, !noalias !41
  store <2 x i64> %wide.load7, ptr %i.b, align 1, !alias.scope !43, !noalias !44
  store <2 x i64> %wide.load8, ptr %i.d, align 1, !alias.scope !43, !noalias !44
  store <2 x i64> %wide.load, ptr %i.c, align 1, !alias.scope !44, !noalias !41
  store <2 x i64> %wide.load6, ptr %i.e, align 1, !alias.scope !44, !noalias !41
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !41)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !42)
  %.sroa.0.0.copyload.i.prol = load i64, ptr %i.h, align 1, !alias.scope !41, !noalias !42
  %.sroa.02.0.copyload.i.prol = load i64, ptr %i.i, align 1, !alias.scope !42, !noalias !41
  store i64 %.sroa.02.0.copyload.i.prol, ptr %i.h, align 1, !alias.scope !41, !noalias !42
  store i64 %.sroa.0.0.copyload.i.prol, ptr %i.i, align 1, !alias.scope !42, !noalias !41
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !41)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !42)
  %.sroa.0.0.copyload.i = load i64, ptr %i.l, align 1, !alias.scope !41, !noalias !42
  %.sroa.02.0.copyload.i = load i64, ptr %i.m, align 1, !alias.scope !42, !noalias !41
  store i64 %.sroa.02.0.copyload.i, ptr %i.l, align 1, !alias.scope !41, !noalias !42
  store i64 %.sroa.0.0.copyload.i, ptr %i.m, align 1, !alias.scope !42, !noalias !41
  ...
  %.sroa.0.0.copyload.i.1 = load i64, ptr %i.o, align 1, !alias.scope !47, !noalias !48
  %.sroa.02.0.copyload.i.1 = load i64, ptr %i.p, align 1, !alias.scope !48, !noalias !47
  store i64 %.sroa.02.0.copyload.i.1, ptr %i.o, align 1, !alias.scope !47, !noalias !48
  store i64 %.sroa.0.0.copyload.i.1, ptr %i.p, align 1, !alias.scope !48, !noalias !47
  %exitcond.not.1 = icmp eq i64 %i.n, %2
  br i1 %exitcond.not.1, label %.loopexit, label %scalar.ph, !llvm.loop !40
}
...
_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE6tripleBP_.exit:
  ...
  %i.b = load i64, ptr %i.a, align 8, !alias.scope !69, !noalias !70, !noundef !5 ; 2 uses
...
.split1.i:                                        ; preds = %_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE6tripleBP_.exit
  %i.j = tail call { i64, i64 } @_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE11try_reserveBP_(ptr noalias nofree noundef nonnull align 8 dereferenceable(1000) %0, i64 noundef range(i64 0, -9223372036854775808) %3), !noalias !71 ; 2 uses
  %i.k = extractvalue { i64, i64 } %i.j, 0
  %i.l = extractvalue { i64, i64 } %i.j, 1
  tail call void @_RINvCs2efQY0w7vw4_8smallvec10infallibleuECs2wCc12Mnjqg_5ropey(i64 noundef %i.k, i64 %i.l), !noalias !71
  %i.m = load i64, ptr %i.a, align 8, !alias.scope !72, !noalias !73, !noundef !5 ; 2 uses
  %i.n = icmp ugt i64 %i.m, 984                   ; 2 uses
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.p = load i64, ptr %i.o, align 8
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.r = load ptr, ptr %i.q, align 8, !nonnull !5
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %i.t, ptr nonnull align 1 %.sink12.i2.i, i64 %.sink12.i1517.i, i1 false), !noalias !71
...
.split:                                           ; preds = %bb.a
  ...
  br i1 %i.u, label %.split.i, label %bb.f, !prof !8

bb.b:                                             ; preds = %bb.a
  %i.v = getelementptr inbounds nuw i8, ptr %.sink13.i, i64 %1
  %i.w = load i8, ptr %i.v, align 1, !noalias !74, !noundef !5
  %i.x = icmp sgt i8 %i.w, -65
  br i1 %i.x, label %.split.i, label %bb.f, !prof !8

.split.i:                                         ; preds = %.split, %bb.b
  %i.y = tail call { i64, i64 } @_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE11try_reserveBP_(ptr noalias nofree noundef nonnull align 8 dereferenceable(1000) %0, i64 noundef range(i64 0, -9223372036854775808) %3), !noalias !75 ; 2 uses
  %i.z = extractvalue { i64, i64 } %i.y, 0
  %i.aa = extractvalue { i64, i64 } %i.y, 1
  tail call void @_RINvCs2efQY0w7vw4_8smallvec10infallibleuECs2wCc12Mnjqg_5ropey(i64 noundef %i.z, i64 %i.aa), !noalias !75
  %i.ab = load i64, ptr %i.a, align 8, !alias.scope !76, !noalias !77, !noundef !5 ; 3 uses
...
_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE6tripleBP_.exit.i7: ; preds = %.split.i
  ...
  %i.ae = load i64, ptr %i.ad, align 8, !alias.scope !76, !noalias !77, !noundef !5 ; 2 uses
  %.not.i8 = icmp ugt i64 %1, %i.ae
  br i1 %.not.i8, label %bb.c, label %bb.d, !prof !7
...
_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE6tripleBP_.exit.thread.i2: ; preds = %.split.i
  ...
  br i1 %.not14.i, label %bb.c, label %bb.e, !prof !7
...
bb.c:                                             ; preds = %_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE6tripleBP_.exit.thread.i2, %_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE6tripleBP_.exit.i7
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking5panic(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @26, i64 noundef 30, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @27) #22, !noalias !75
  unreachable
...
bb.d:                                             ; preds = %_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE6tripleBP_.exit.i7
  ...
  %i.ag = load ptr, ptr %i.af, align 8, !alias.scope !78, !noalias !79, !nonnull !5, !noundef !5
...
_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE10triple_mutBP_.exit.i3: ; preds = %bb.e, %bb.d
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %i.aj, ptr nonnull align 1 %i.ai, i64 %i.ak, i1 false), !noalias !75
  br label %_RNvMs_NtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5innerNtB4_15NodeSmallString10insert_str.exit

bb.f:                                             ; preds = %.split, %bb.b
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking5panic(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @14, i64 noundef 58, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @15) #22, !noalias !74
  unreachable
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.cm = load i8, ptr %i.cl, align 1, !alias.scope !517, !noundef !5
...
bb.p:                                             ; preds = %bb.k, %.split.i, %_RNvXs5_NtNtCs2wCc12Mnjqg_5ropey4tree9node_textNtB5_8NodeTextNtNtNtCskKLDkoKarTP_4core3ops5deref5Deref5deref.exit56
  ...
  %i.cp = load i64, ptr %i.co, align 8, !alias.scope !518, !noalias !519
  %.sink12.i.i68 = select i1 %i.c, i64 %i.cp, i64 %i.b ; 5 uses
  %i.cq = icmp eq i64 %.sink12.i.i68, 0
  %i.cr = tail call { i64, i64 } @_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE11try_reserveBP_(ptr noalias nofree noundef nonnull align 8 dereferenceable(1000) %0, i64 noundef range(i64 0, -9223372036854775808) %i.bv), !noalias !519 ; 2 uses
  %i.cs = extractvalue { i64, i64 } %i.cr, 0
  %i.ct = extractvalue { i64, i64 } %i.cr, 1
  tail call void @_RINvCs2efQY0w7vw4_8smallvec10infallibleuECs2wCc12Mnjqg_5ropey(i64 noundef %i.cs, i64 %i.ct), !noalias !519
  %i.cu = load i64, ptr %i.a, align 8, !alias.scope !518, !noalias !519, !noundef !5 ; 4 uses
...
.split1.i.i:                                      ; preds = %bb.p
  ...
  %i.cy = load ptr, ptr %i.cx, align 8, !nonnull !5
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %i.da, ptr nonnull align 1 %.sink12.i2.i.i, i64 %.sink12.i1517.i.i, i1 false), !noalias !520
...
_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE6tripleBP_.exit.i7.i: ; preds = %.split.i.i
  %i.db = load i64, ptr %i.co, align 8, !alias.scope !521, !noalias !522, !noundef !5 ; 2 uses
  %.not.i8.i = icmp ugt i64 %.sink12.i.i68, %i.db
  br i1 %.not.i8.i, label %bb.q, label %bb.r, !prof !7
...
_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE6tripleBP_.exit.thread.i2.i: ; preds = %.split.i.i
  ...
  br i1 %.not14.i.i, label %bb.q, label %bb.s, !prof !7
...
bb.q:                                             ; preds = %_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE6tripleBP_.exit.thread.i2.i, %_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE6tripleBP_.exit.i7.i
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking5panic(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @26, i64 noundef 30, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @27) #22, !noalias !523
  unreachable
...
bb.r:                                             ; preds = %_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE6tripleBP_.exit.i7.i
  ...
  %i.dd = load ptr, ptr %i.dc, align 8, !alias.scope !524, !noalias !525, !nonnull !5, !noundef !5
...
_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE10triple_mutBP_.exit.i3.i: ; preds = %bb.s, %bb.r
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %i.dg, ptr nonnull align 1 %i.df, i64 %i.dh, i1 false), !noalias !523
  br label %_RNvMNtNtCs2wCc12Mnjqg_5ropey4tree9node_textNtB2_8NodeText8push_str.exit
...
_RNvMNtNtCs2wCc12Mnjqg_5ropey4tree9node_textNtB2_8NodeText8push_str.exit: ; preds = %.split1.i.i, %_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE10triple_mutBP_.exit.i3.i
  ...
  %i.di = load i64, ptr %i.a, align 8, !alias.scope !518, !noalias !519, !noundef !5
  %i.dj = icmp ugt i64 %i.di, 984
  %spec.select = select i1 %i.dj, ptr %i.co, ptr %i.a
  %i.dk = add i64 %.sink12.i1517.i.sink.i, %i.bv
  store i64 %i.dk, ptr %spec.select, align 8, !alias.scope !518, !noalias !519
...
_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE6tripleBP_.exit.i: ; preds = %bb.o, %.split.i66, %_RNvXs5_NtNtCs2wCc12Mnjqg_5ropey4tree9node_textNtB5_8NodeTextNtNtNtCskKLDkoKarTP_4core3ops5deref5Deref5deref.exit64
  ...
  %i.dn = tail call { i64, i64 } @_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE11try_reserveBP_(ptr noalias nofree noundef nonnull align 8 dereferenceable(1000) %1, i64 noundef range(i64 0, -9223372036854775808) %i.dl), !noalias !526 ; 2 uses
  %i.do = extractvalue { i64, i64 } %i.dn, 0
  %i.dp = extractvalue { i64, i64 } %i.dn, 1
  tail call void @_RINvCs2efQY0w7vw4_8smallvec10infallibleuECs2wCc12Mnjqg_5ropey(i64 noundef %i.do, i64 %i.dp), !noalias !526
  %i.dq = load i64, ptr %i.i, align 8, !alias.scope !527, !noalias !528, !noundef !5 ; 2 uses
  ...
  %i.dv = load ptr, ptr %i.du, align 8, !nonnull !5
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %i.dx, ptr nonnull align 1 %.sink12.i2.i.i75, i64 %.sink12.i1517.i.i74, i1 false), !noalias !526
  ...
  %i.dy = load i64, ptr %i.i, align 8, !alias.scope !529, !noalias !530, !noundef !5
  ...
  store i64 %i.eb, ptr %.sink11.i5.i.sink.i77, align 8, !alias.scope !531, !noalias !532
  tail call void @llvm.experimental.noalias.scope.decl(metadata !533)
  %i.ec = load i64, ptr %i.a, align 8, !alias.scope !534, !noalias !535, !noundef !5 ; 2 uses
  %i.ed = icmp ugt i64 %i.ec, 984                 ; 2 uses
  %i.ee = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.ef = load ptr, ptr %i.ee, align 8, !nonnull !5
...
.split.i82:                                       ; preds = %bb.u
  ...
  br i1 %i.ej, label %_RNvMs_NtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5innerNtB4_15NodeSmallString8truncate.exit.i, label %bb.w, !prof !8
...
bb.v:                                             ; preds = %bb.u
  ...
  br i1 %i.em, label %_RNvMs_NtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5innerNtB4_15NodeSmallString8truncate.exit.i, label %bb.w, !prof !8

bb.w:                                             ; preds = %bb.v, %.split.i82
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking5panic(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @14, i64 noundef 58, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @22) #22, !noalias !533
  unreachable
...
_RNvMs_NtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5innerNtB4_15NodeSmallString8truncate.exit.i: ; preds = %bb.v, %.split.i82, %_RNvMsc_Cs2efQY0w7vw4_8smallvecINtB5_8SmallVecNtNtNtNtCs2wCc12Mnjqg_5ropey4tree9node_text5inner12BackingArrayE6tripleBP_.exit.i
  ...
  %i.en = load i64, ptr %i.a, align 8, !alias.scope !533, !noundef !5
...
_RNvXs5_NtNtCs2wCc12Mnjqg_5ropey4tree9node_textNtB5_8NodeTextNtNtNtCskKLDkoKarTP_4core3ops5deref5Deref5deref.exit:
  ...
  %i.b = load i64, ptr %i.a, align 8, !alias.scope !541, !noalias !542, !noundef !5 ; 2 uses
  %i.c = icmp ugt i64 %i.b, 984                   ; 2 uses
...
bb.a:                                             ; preds = %_RNvXs5_NtNtCs2wCc12Mnjqg_5ropey4tree9node_textNtB5_8NodeTextNtNtNtCskKLDkoKarTP_4core3ops5deref5Deref5deref.exit
  ...
  %i.j = load ptr, ptr %i.i, align 8, !nonnull !5
...
_RNvXs5_NtNtCs2wCc12Mnjqg_5ropey4tree9node_textNtB5_8NodeTextNtNtNtCskKLDkoKarTP_4core3ops5deref5Deref5deref.exit:
  ...
  %i.b = load i64, ptr %i.a, align 8, !alias.scope !548, !noalias !549, !noundef !5 ; 2 uses
  %i.c = icmp ugt i64 %i.b, 984                   ; 2 uses
...
bb.a:
  ...
  store ptr %i.b, ptr %i.a, align 8, !noalias !553
...
bb.a:
  %i.a = load ptr, ptr %0, align 8, !nonnull !5, !align !9, !noundef !5 ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 992
  %i.c = load i64, ptr %i.b, align 8, !alias.scope !562, !noalias !563, !noundef !5 ; 2 uses
  %i.d = icmp ugt i64 %i.c, 984
  br i1 %i.d, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %i.e = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  %i.f = load ptr, ptr %i.e, align 8, !alias.scope !562, !noalias !563, !nonnull !5, !noundef !5
  %i.g = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  %i.h = load i64, ptr %i.g, align 8, !alias.scope !562, !noalias !563, !noundef !5
...
bb.a:
  %i.a = alloca [8 x i8], align 8                 ; 4 uses
  %i.b = load ptr, ptr %0, align 8, !nonnull !5, !align !9, !noundef !5 ; 4 uses
  %i.c = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %i.d = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !567
  %i.e = getelementptr inbounds nuw i8, ptr %i.b, i64 24
  store ptr %i.e, ptr %i.a, align 8, !noalias !567
...
bb.a:
  ...
  %i.c = load ptr, ptr %0, align 8, !nonnull !5, !align !9, !noundef !5 ; 2 uses
  %.val = load ptr, ptr %i.c, align 8, !nonnull !5, !align !9, !noundef !5 ; 2 uses
  %i.d = getelementptr i8, ptr %i.c, i64 8
  %.val1 = load i64, ptr %i.d, align 8, !noundef !5 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !575
  call void @_RNvMsa_NtCskKLDkoKarTP_4core3fmtNtB5_9Formatter10debug_list(ptr noalias nofree noundef nonnull sret([16 x i8]) align 8 captures(address) dereferenceable(16) %i.b, ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %1), !noalias !576
...
.lr.ph.i.i.i:                                     ; preds = %bb.a, %.lr.ph.i.i.i
  ...
  store ptr %.sroa.0.05.i.i.i, ptr %i.a, align 8, !noalias !577, !captures !4
...
_RNvXs1g_NtCskKLDkoKarTP_4core3fmtRSNtNtNtCs2wCc12Mnjqg_5ropey4tree9text_info8TextInfoNtB6_5Debug3fmtBD_.exit: ; preds = %.lr.ph.i.i.i, %bb.a
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !575
  ret i1 %i.j
}
...
bb.a:
  %i.a = load ptr, ptr %0, align 8, !nonnull !5, !align !9, !noundef !5 ; 3 uses
  %i.b = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.c = load i32, ptr %i.b, align 8, !alias.scope !581, !noalias !582, !noundef !5 ; 2 uses
