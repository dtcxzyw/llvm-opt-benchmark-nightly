...
.preheader1141.us:                                ; preds = %.preheader1141.us.preheader, %._crit_edge1238.us
  ...
  %invariant.gep1874 = getelementptr [8 x i8], ptr %i.oi, i64 %i.os
...
scalar.ph:                                        ; preds = %middle.block, %scalar.ph
  %indvars.iv1554 = phi i64 [ %indvars.iv.next1555, %scalar.ph ], [ %i.oq, %middle.block ] ; 4 uses
  ...
  %4 = load double, ptr %gep1869, align 8, !tbaa !132 ; 2 uses
  ...
  %i.qf = load <2 x double>, ptr %gep1863, align 8, !tbaa !132 ; 3 uses
  %5 = extractelement <2 x double> %i.qf, i64 0
  %6 = tail call double @llvm.fmuladd.f64(double %i.qa, double 2.000000e+00, double %5)
  %7 = fadd double %6, %i.qb
  %8 = fsub double %7, %4
  %9 = insertelement <2 x double> %i.qf, double %i.qd, i64 0
  %10 = shufflevector <2 x double> %i.qf, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %i.qg = insertelement <2 x double> %10, double %8, i64 0
  %11 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %9, <2 x double> splat (double 2.000000e+00), <2 x double> %i.qg) ; 2 uses
  %12 = extractelement <2 x double> %11, i64 0
  %13 = fsub double %12, %i.qe                    ; 2 uses
  %i.qh = extractelement <2 x double> %11, i64 1
  %14 = fadd double %4, %i.qh
  %i.qi = fsub double %14, %i.qb
  ...
  %i.ql = tail call double @llvm.fmuladd.f64(double %i.qk, double 2.000000e+00, double %i.qi)
  %i.qm = fsub double %i.ql, %i.qe                ; 2 uses
  %i.qn = fmul double %i.qm, %i.qm
  %i.qo = tail call double @llvm.fmuladd.f64(double %13, double %13, double %i.qn)
