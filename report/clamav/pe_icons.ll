...
bb.ba:                                            ; preds = %bb.az, %bb.ay
  ...
  %i.sc = fmul double %.046.i.i, 1.000000e+02     ; 2 uses
  %i.sd = fmul double %.047.i.i, 1.000000e+02     ; 2 uses
  %i.se = fmul double %.048.i.i, 1.000000e+02     ; 2 uses
  %i.sf = fmul double %i.sd, f0x3FBE83E420000000
  %i.sg = tail call double @llvm.fmuladd.f64(double %i.sc, double f0x3F93C36120000000, double %i.sf)
  %i.sh = tail call double @llvm.fmuladd.f64(double %i.se, double f0x3FEE6A7F00000000, double %i.sg)
  %i.si = insertelement <2 x double> poison, double %i.sd, i64 0
  %i.sj = shufflevector <2 x double> %i.si, <2 x double> poison, <2 x i32> zeroinitializer
  %i.sk = fmul <2 x double> %i.sj, <double f0x3FD6E2EB20000000, double f0x3FE6E2EB20000000>
  %i.sl = insertelement <2 x double> poison, double %i.sc, i64 0
  %i.sm = shufflevector <2 x double> %i.sl, <2 x double> poison, <2 x i32> zeroinitializer
  %i.sn = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.sm, <2 x double> <double f0x3FDA64C300000000, double f0x3FCB367A00000000>, <2 x double> %i.sk)
  %i.so = insertelement <2 x double> poison, double %i.se, i64 0
  %i.sp = shufflevector <2 x double> %i.so, <2 x double> poison, <2 x i32> zeroinitializer
  %i.sq = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.sp, <2 x double> <double f0x3FC71A9FC0000000, double f0x3FB27BB300000000>, <2 x double> %i.sn)
  %i.sr = fdiv <2 x double> %i.sq, <double f0x4057C30200000000, double 1.000000e+02> ; 2 uses
  %i.ss = fdiv double %i.sh, f0x405B388320000000  ; 3 uses
  %i.st = extractelement <2 x double> %i.sr, i64 0 ; 3 uses
  %i.su = fcmp ogt double %i.st, f0x3F82231840000000
  br i1 %i.su, label %bb.bb, label %bb.bc

bb.bb:                                            ; preds = %bb.ba
  %i.sv = tail call double @pow(double noundef %i.st, double noundef f0x3FD5555560000000) #13
  br label %bb.bd

bb.bc:                                            ; preds = %bb.ba
  %i.sw = tail call double @llvm.fmuladd.f64(double %i.st, double f0x401F25E360000000, double f0x3FC1A7B960000000)
  br label %bb.bd

bb.bd:                                            ; preds = %bb.bc, %bb.bb
  %.045.i.i = phi double [ %i.sv, %bb.bb ], [ %i.sw, %bb.bc ]
  %i.sx = extractelement <2 x double> %i.sr, i64 1 ; 3 uses
  %i.sy = fcmp ogt double %i.sx, f0x3F82231840000000
  br i1 %i.sy, label %bb.be, label %bb.bf

bb.be:                                            ; preds = %bb.bd
  %i.sz = tail call double @pow(double noundef %i.sx, double noundef f0x3FD5555560000000) #13
  br label %bb.bg

bb.bf:                                            ; preds = %bb.bd
  %i.ta = tail call double @llvm.fmuladd.f64(double %i.sx, double f0x401F25E360000000, double f0x3FC1A7B960000000)
  br label %bb.bg

bb.bg:                                            ; preds = %bb.bf, %bb.be
  %.044.i.i = phi double [ %i.sz, %bb.be ], [ %i.ta, %bb.bf ] ; 3 uses
  %i.tb = fcmp ogt double %i.ss, f0x3F82231840000000
  br i1 %i.tb, label %bb.bh, label %bb.bi

bb.bh:                                            ; preds = %bb.bg
  %i.tc = tail call double @pow(double noundef %i.ss, double noundef f0x3FD5555560000000) #13
  br label %labdiff.exit

bb.bi:                                            ; preds = %bb.bg
  %i.td = tail call double @llvm.fmuladd.f64(double %i.ss, double f0x401F25E360000000, double f0x3FC1A7B960000000)
  br label %labdiff.exit

labdiff.exit:                                     ; preds = %bb.bh, %bb.bi
  %.0.i.i = phi double [ %i.tc, %bb.bh ], [ %i.td, %bb.bi ]
  %i.te = tail call double @llvm.fmuladd.f64(double %.044.i.i, double 1.160000e+02, double -1.600000e+01)
  %i.tf = fsub double %.045.i.i, %.044.i.i
  %i.tg = fmul double %i.tf, 5.000000e+02
  %i.th = fsub double %.044.i.i, %.0.i.i
  %i.ti = fmul double %i.th, 2.000000e+02
  %i.tj = fsub double f0x404A98AD00000000, %i.te
  %i.tk = tail call double @pow(double noundef %i.tj, double noundef 2.000000e+00) #13
  %i.tl = fsub double f0x3F69BD7300000000, %i.tg
  %i.tm = tail call double @pow(double noundef %i.tl, double noundef 2.000000e+00) #13
  %i.tn = fadd double %i.tk, %i.tm
  %i.to = fsub double f0xBF796D20A0000000, %i.ti
  %i.tp = tail call double @pow(double noundef %i.to, double noundef 2.000000e+00) #13
  %i.tq = fadd double %i.tn, %i.tp
  %i.tr = tail call double @sqrt(double noundef %i.tq) #13
  %i.ts = getelementptr inbounds nuw [8 x i8], ptr %i.oc, i64 %i.qw
  store double %i.tr, ptr %i.ts, align 8, !tbaa !142
...
bb.bk:                                            ; preds = %bb.bk, %.preheader1168.new
  ...
  %27 = add nuw nsw i64 %indvars.iv1594, %i.tt    ; 2 uses
  ...
  %i.tu = add nuw nsw i64 %indvars.iv1594, %invariant.op ; 2 uses
  %i.tv = getelementptr inbounds nuw [4 x i8], ptr %i.l, i64 %i.tu
  %i.tw = load i32, ptr %i.tv, align 4, !tbaa !56
  %i.tx = mul i32 %i.tw, 255
  %i.ty = udiv i32 %i.tx, %spec.select.us.lcssa   ; 3 uses
  %i.tz = shl i32 %i.ty, 8
  %i.ua = shl i32 %i.ty, 16
  %i.ub = or i32 %i.ua, %i.tz
  %i.uc = or i32 %i.ub, %i.ty
  %i.ud = or i32 %i.uc, -16777216
  %i.ue = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.tu
  store i32 %i.ud, ptr %i.ue, align 4, !tbaa !56
...
.epil.preheader:                                  ; preds = %._crit_edge1278.unr-lcssa, %.preheader1168
  ...
  %38 = add nuw nsw i64 %indvars.iv1594.epil.init, %i.tt ; 2 uses
...
.loopexit1170:                                    ; preds = %._crit_edge1278, %._crit_edge1272
  %i.uf = mul nuw nsw i32 %i.og, %0
  %i.ug = zext nneg i32 %i.uf to i64
  %invariant.gep1910 = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.ug ; 2 uses
...
vector.body32:                                    ; preds = %vector.body32, %.loopexit1170
  ...
  %i.uh = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %index33
  store <4 x i32> splat (i32 -16777216), ptr %i.uh, align 4, !tbaa !56
  %i.ui = getelementptr inbounds nuw [4 x i8], ptr %invariant.gep1910, i64 %index33
  store <4 x i32> splat (i32 -16777216), ptr %i.ui, align 4, !tbaa !56
  %index.next34 = add nuw i64 %index33, 4         ; 2 uses
  %i.uj = icmp eq i64 %index.next34, %n.vec31
  br i1 %i.uj, label %middle.block35, label %vector.body32, !llvm.loop !131
...
scalar.ph29:                                      ; preds = %middle.block35, %scalar.ph29
  ...
  %i.uk = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv1604
  store i32 -16777216, ptr %i.uk, align 4, !tbaa !56
...
.preheader1167:                                   ; preds = %.preheader1167, %.preheader1167.preheader
  ...
  %i.ul = mul nuw nsw i64 %indvars.iv1609, %i.i   ; 2 uses
  %i.um = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.ul
  store i32 -16777216, ptr %i.um, align 4, !tbaa !56
  %gep1913 = getelementptr [4 x i8], ptr %invariant.gep1912, i64 %i.ul
  %i.un = getelementptr i8, ptr %gep1913, i64 -4
  store i32 -16777216, ptr %i.un, align 4, !tbaa !56
  %indvars.iv.next1610 = or disjoint i64 %indvars.iv1609, 1
  %i.uo = mul nuw nsw i64 %indvars.iv.next1610, %i.i ; 2 uses
  %i.up = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.uo
  store i32 -16777216, ptr %i.up, align 4, !tbaa !56
  %gep1913.1 = getelementptr [4 x i8], ptr %invariant.gep1912, i64 %i.uo
  %i.uq = getelementptr i8, ptr %gep1913.1, i64 -4
  store i32 -16777216, ptr %i.uq, align 4, !tbaa !56
  %indvars.iv.next1610.1 = or disjoint i64 %indvars.iv1609, 2
  %i.ur = mul nuw nsw i64 %indvars.iv.next1610.1, %i.i ; 2 uses
  %i.us = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.ur
  store i32 -16777216, ptr %i.us, align 4, !tbaa !56
  %gep1913.2 = getelementptr [4 x i8], ptr %invariant.gep1912, i64 %i.ur
  %i.ut = getelementptr i8, ptr %gep1913.2, i64 -4
  store i32 -16777216, ptr %i.ut, align 4, !tbaa !56
  %indvars.iv.next1610.2 = or disjoint i64 %indvars.iv1609, 3
  %i.uu = mul nuw nsw i64 %indvars.iv.next1610.2, %i.i ; 2 uses
  %i.uv = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.uu
  store i32 -16777216, ptr %i.uv, align 4, !tbaa !56
  %gep1913.3 = getelementptr [4 x i8], ptr %invariant.gep1912, i64 %i.uu
  %i.uw = getelementptr i8, ptr %gep1913.3, i64 -4
...
.preheader1167.epil:                              ; preds = %.preheader1167.epil, %.preheader1167.epil.preheader
  ...
  %i.ux = mul nuw nsw i64 %indvars.iv1609.epil, %i.i ; 2 uses
  %i.uy = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.ux
  store i32 -16777216, ptr %i.uy, align 4, !tbaa !56
  %gep1913.epil = getelementptr [4 x i8], ptr %invariant.gep1912, i64 %i.ux
  %i.uz = getelementptr i8, ptr %gep1913.epil, i64 -4
...
.preheader1166.preheader:                         ; preds = %.preheader1167.epil, %.preheader1166.preheader.unr-lcssa
  ...
  %i.va = zext nneg i32 %0 to i64
  %wide.trip.count1626 = zext nneg i32 %i.og to i64 ; 2 uses
  %i.vb = shl nuw nsw i64 %i.i, 2
  %i.vc = shl nuw nsw i64 %i.i, 2
  %i.vd = getelementptr i8, ptr %1, i64 %i.vb
...
.preheader1166:                                   ; preds = %.preheader1166.preheader, %._crit_edge1286
  ...
  %i.ve = mul i64 %i.vc, %indvar
  %scevgep = getelementptr i8, ptr %i.vd, i64 %i.ve
  %i.vf = mul nuw nsw i64 %indvars.iv1623, %i.va
  %load_initial = load i32, ptr %scevgep, align 4
  %i.vg = and i32 %load_initial, 255
  br label %.preheader1165

.preheader1163.preheader:                         ; preds = %._crit_edge1286
  %i.vh = zext nneg i32 %0 to i64                 ; 3 uses
  %wide.trip.count1640 = zext nneg i32 %i.og to i64 ; 2 uses
  %n.vec39 = and i64 %i.oi, -4                    ; 3 uses
  %i.vi = or disjoint i64 %n.vec39, 1
  %cmp.n47 = icmp eq i64 %i.oi, %n.vec39
  br label %.preheader1163

.preheader1165:                                   ; preds = %.preheader1166, %.preheader1165
  %store_forwarded = phi i32 [ %i.vg, %.preheader1166 ], [ %i.vm, %.preheader1165 ]
  %indvars.iv1618 = phi i64 [ 1, %.preheader1166 ], [ %indvars.iv.next1619, %.preheader1165 ] ; 2 uses
  %i.vj = add nuw nsw i64 %indvars.iv1618, %i.vf  ; 2 uses
  %i.vk = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.vj ; 2 uses
  %i.vl = load i32, ptr %i.vk, align 4, !tbaa !56
  %i.vm = and i32 %i.vl, 255                      ; 3 uses
  %i.vn = shl nuw nsw i32 %i.vm, 1
  %i.vo = add nuw nsw i32 %i.vn, %store_forwarded
  %i.vp = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.vj
  %i.vq = getelementptr inbounds nuw i8, ptr %i.vp, i64 4
  %i.vr = load i32, ptr %i.vq, align 4, !tbaa !56
  %i.vs = and i32 %i.vr, 255
  %i.vt = add nuw nsw i32 %i.vs, %i.vo
  %i.vu = shl nuw nsw i32 %i.vt, 6
  %i.vv = and i32 %i.vu, 130816
  %i.vw = or disjoint i32 %i.vm, %i.vv
  store i32 %i.vw, ptr %i.vk, align 4, !tbaa !56
...
.preheader1163:                                   ; preds = %.preheader1163.preheader, %._crit_edge1293
  %indvars.iv1637 = phi i64 [ 1, %.preheader1163.preheader ], [ %i.wc, %._crit_edge1293 ] ; 3 uses
  %i.vx = mul nuw nsw i64 %indvars.iv1637, %i.vh
  %i.vy = add nsw i64 %indvars.iv1637, -1
  %i.vz = mul nuw nsw i64 %i.vy, %i.vh
  %i.wa = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.vz ; 2 uses
  %i.wb = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.vx ; 2 uses
  %i.wc = add nuw nsw i64 %indvars.iv1637, 1      ; 3 uses
  %i.wd = mul nuw nsw i64 %i.wc, %i.vh
  %i.we = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.wd ; 2 uses
...
vector.body40:                                    ; preds = %vector.body40, %.preheader1163
  ...
  %i.wf = or disjoint i64 %index41, 1             ; 3 uses
  %i.wg = getelementptr inbounds nuw [4 x i8], ptr %i.wa, i64 %i.wf
  %wide.load42 = load <4 x i32>, ptr %i.wg, align 4, !tbaa !56
  %i.wh = lshr <4 x i32> %wide.load42, splat (i32 8)
  %i.wi = and <4 x i32> %i.wh, splat (i32 255)
  %i.wj = getelementptr inbounds nuw [4 x i8], ptr %i.wb, i64 %i.wf ; 2 uses
  %wide.load43 = load <4 x i32>, ptr %i.wj, align 4, !tbaa !56
  %i.wk = lshr <4 x i32> %wide.load43, splat (i32 7)
  %i.wl = and <4 x i32> %i.wk, splat (i32 510)
  %i.wm = add nuw nsw <4 x i32> %i.wl, %i.wi
  %i.wn = getelementptr inbounds nuw [4 x i8], ptr %i.we, i64 %i.wf
  %wide.load44 = load <4 x i32>, ptr %i.wn, align 4, !tbaa !56
  %i.wo = lshr <4 x i32> %wide.load44, splat (i32 8)
  %i.wp = and <4 x i32> %i.wo, splat (i32 255)
  %i.wq = add nuw nsw <4 x i32> %i.wp, %i.wm
  %i.wr = lshr <4 x i32> %i.wq, splat (i32 2)     ; 3 uses
  %i.ws = shl nuw nsw <4 x i32> %i.wr, splat (i32 8)
  %i.wt = shl nuw nsw <4 x i32> %i.wr, splat (i32 16)
  %i.wu = or <4 x i32> %i.wt, %i.ws
  %i.wv = or <4 x i32> %i.wu, %i.wr
  %i.ww = or <4 x i32> %i.wv, splat (i32 -16777216)
  store <4 x i32> %i.ww, ptr %i.wj, align 4, !tbaa !56
  %index.next45 = add nuw i64 %index41, 4         ; 2 uses
  %i.wx = icmp eq i64 %index.next45, %n.vec39
  br i1 %i.wx, label %middle.block46, label %vector.body40, !llvm.loop !134
...
.preheader1162:                                   ; preds = %middle.block46, %.preheader1162
  %indvars.iv1632 = phi i64 [ %indvars.iv.next1633, %.preheader1162 ], [ %i.vi, %middle.block46 ] ; 4 uses
  %i.wy = getelementptr inbounds nuw [4 x i8], ptr %i.wa, i64 %indvars.iv1632
end_hunk_1
