...
bb.ah:                                            ; preds = %.loopexit655.i, %.lr.ph680.i
  ...
  %7 = mul i32 %narrow, %i.hi
  %i.hj = trunc i64 %indvars.iv747.i to i32
  %i.hk = mul i32 %i.cn, %i.hj                    ; 19 uses
