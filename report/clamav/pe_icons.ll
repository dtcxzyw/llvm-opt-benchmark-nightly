...
.lr.ph680.i:                                      ; preds = %.preheader662.i
  ...
  %i.ds = add nsw i64 %i.dr, -1                   ; 4 uses
  ...
  %i.ea = add nsw i64 %i.dr, -1                   ; 5 uses
  ...
  %i.ei = add nsw i64 %i.dr, -1                   ; 6 uses
  ...
  %min.iters.check118 = icmp ult i32 %.4..4..4..4..4..i, 28
  %i.ep = trunc nsw i64 %i.ei to i32
  %i.eq = trunc nsw i64 %i.ei to i32
  %mul.result96 = shl i32 %i.eq, 2
  %mul.overflow97 = icmp ugt i64 %i.ei, 1073741823
  %7 = trunc nsw i64 %i.ei to i32
  %mul.result99 = shl i32 %7, 2
  %8 = trunc nsw i64 %i.ei to i32
  %mul.result102 = shl i32 %8, 2
  %9 = trunc nsw i64 %i.ei to i32
  %mul.result105 = shl i32 %9, 2
  ...
  %min.iters.check83 = icmp ult i32 %.4..4..4..4..4..i, 28
  ...
  %mul.result64 = extractvalue { i32, i1 } %mul63, 0
  %mul.overflow65 = extractvalue { i32, i1 } %mul63, 1
  %i.ev = icmp ugt i64 %i.ea, 4294967295
  %invariant.op = or i1 %mul.overflow65, %i.ev
  %10 = trunc nsw i64 %i.ea to i32
  %mul66 = call { i32, i1 } @llvm.umul.with.overflow.i32(i32 %10, i32 3) ; 2 uses
  %mul.result67 = extractvalue { i32, i1 } %mul66, 0
  %mul.overflow68 = extractvalue { i32, i1 } %mul66, 1
  %11 = trunc nsw i64 %i.ea to i32
  %mul69 = call { i32, i1 } @llvm.umul.with.overflow.i32(i32 %11, i32 3) ; 2 uses
  %mul.result70 = extractvalue { i32, i1 } %mul69, 0
  %mul.overflow71 = extractvalue { i32, i1 } %mul69, 1
  ...
  %mul.result = shl i32 %i.ez, 1
  %i.fa = icmp ugt i64 %i.ds, 4294967295
  %12 = trunc nsw i64 %i.ds to i32
  %mul.result54 = shl i32 %12, 1
...
vector.scevcheck94:                               ; preds = %.lr.ph.i
  ...
  %13 = or i1 %i.hv, %mul.overflow97
  %i.hw = xor i32 %i.gd, -1
  %i.hx = icmp ugt i32 %mul.result99, %i.hw
  %i.hy = xor i32 %i.ge, -2
  %i.hz = icmp ult i32 %i.hy, %mul.result102
  %i.ia = xor i32 %i.gf, -3
  %i.ib = icmp ult i32 %i.ia, %mul.result105
  %i.ic = or i1 %i.ht, %13
  %i.id = or i1 %i.hx, %i.ic
...
vector.scevcheck62:                               ; preds = %.lr.ph668.i
  ...
  %.reass.a = or i1 %i.pw, %invariant.op
  %i.px = xor i32 %i.gv, -2
  %i.py = icmp ult i32 %i.px, %mul.result67
  %i.pz = or i1 %i.py, %mul.overflow68
  %i.qa = xor i32 %i.gw, -3
  %i.qb = icmp ult i32 %i.qa, %mul.result70
  %14 = or i1 %i.qb, %mul.overflow71
  %i.qc = or i1 %i.pu, %.reass.a
  %i.qd = or i1 %i.pz, %i.qc
  %i.qe = or i1 %14, %i.qd
...
vector.scevcheck:                                 ; preds = %.lr.ph671.i
  ...
  %i.tj = xor i32 %i.hm, -2
  %i.tk = icmp ult i32 %i.tj, %mul.result54
...
._crit_edge1267.split:                            ; preds = %._crit_edge1263
  ...
  %i.ya = add nsw i64 %wide.trip.count, -1        ; 4 uses
  ...
  %4 = trunc nsw i64 %i.ya to i32
  %i.yd = trunc nsw i64 %i.ya to i32
