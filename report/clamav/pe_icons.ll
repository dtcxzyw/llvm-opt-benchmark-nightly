...
bb.ba:                                            ; preds = %bb.az, %bb.ay
  ...
  %4 = fmul double %.046.i.i, 1.000000e+02        ; 2 uses
  %5 = fmul double %.047.i.i, 1.000000e+02        ; 2 uses
  %6 = fmul double %.048.i.i, 1.000000e+02        ; 2 uses
  %i.so = fmul double %5, f0x3FBE83E420000000
  %7 = tail call double @llvm.fmuladd.f64(double %4, double f0x3F93C36120000000, double %i.so)
  %i.sp = tail call double @llvm.fmuladd.f64(double %6, double f0x3FEE6A7F00000000, double %7)
  %8 = insertelement <2 x double> poison, double %5, i64 0
  %9 = shufflevector <2 x double> %8, <2 x double> poison, <2 x i32> zeroinitializer
  %10 = fmul <2 x double> %9, <double f0x3FD6E2EB20000000, double f0x3FE6E2EB20000000>
  %11 = insertelement <2 x double> poison, double %4, i64 0
  %12 = shufflevector <2 x double> %11, <2 x double> poison, <2 x i32> zeroinitializer
  %i.sq = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %12, <2 x double> <double f0x3FDA64C300000000, double f0x3FCB367A00000000>, <2 x double> %10)
  %13 = insertelement <2 x double> poison, double %6, i64 0
  %i.sr = shufflevector <2 x double> %13, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.su = fdiv double %i.sp, f0x405B388320000000  ; 3 uses
...
labdiff.exit:                                     ; preds = %bb.bh, %bb.bi
  ...
  store double %i.tt, ptr %i.tu, align 8, !tbaa !142
...
bb.bk:                                            ; preds = %.preheader1168, %bb.bk
  ...
  %i.ty = load i32, ptr %i.tx, align 4, !tbaa !56
  ...
  store i32 %i.uf, ptr %i.ug, align 4, !tbaa !56
...
vector.body32:                                    ; preds = %vector.body32, %.loopexit1170
  ...
  store <4 x i32> splat (i32 -16777216), ptr %i.uk, align 4, !tbaa !56
  %index.next34 = add nuw i64 %index33, 4         ; 2 uses
  %i.ul = icmp eq i64 %index.next34, %n.vec31
  br i1 %i.ul, label %middle.block35, label %vector.body32, !llvm.loop !131
...
.preheader1167.epil:                              ; preds = %.preheader1167.epil, %.preheader1167.epil.preheader
  ...
  store i32 -16777216, ptr %i.vb, align 4, !tbaa !56
