...
bb.ef:                                            ; preds = %._crit_edge1031
  ...
  %i.vw = getelementptr inbounds nuw i8, ptr %i.ro, i64 9
...
.lr.ph1061:                                       ; preds = %bb.ef
  ...
  %i.wb = getelementptr inbounds nuw i8, ptr %i.rr, i64 9
  %i.wc = getelementptr inbounds nuw i8, ptr %i.ro, i64 11
  %i.wd = getelementptr inbounds nuw i8, ptr %i.rr, i64 11
  ...
  %.pre1276 = load i8, ptr %i.wa, align 8, !tbaa !32 ; 2 uses
  %i.wk = load i8, ptr %i.wb, align 1, !tbaa !31  ; 2 uses
  %.not4621053 = icmp ugt i8 %.pre1276, %i.wk
  %4 = zext i8 %.pre1276 to i32
  %5 = zext i8 %i.wk to i32
  %i.wl = zext i8 %i.vx to i32
  br label %bb.eg
...
bb.eh:                                            ; preds = %.lr.ph1056, %._crit_edge1052
  %.24161054 = phi i32 [ %4, %.lr.ph1056 ], [ %i.yn, %._crit_edge1052 ] ; 4 uses
...
spec_ith_char.exit536:                            ; preds = %spec_ith_char.exit533, %bb.er
  ...
  %i.xk = load i8, ptr %i.wc, align 1, !tbaa !30  ; 2 uses
  %.not463 = icmp ne i8 %i.xk, 0                  ; 3 uses
  %i.xl = select i1 %.not463, i32 255, i32 %.0.i532 ; 2 uses
  %i.xm = load i8, ptr %i.wd, align 1, !tbaa !30  ; 3 uses
  %.not464 = icmp eq i8 %i.xm, 0                  ; 2 uses
  %i.xn = select i1 %.not464, i32 %.0.i535, i32 255 ; 4 uses
  %i.xo = select i1 %.not463, i32 0, i32 %.0.i532 ; 2 uses
...
.preheader.preheader:                             ; preds = %spec_ith_char.exit536
  ...
  %.not468.us = icmp ne i8 %i.xm, 0
  %.not1077 = icmp eq i8 %i.xk, 0
  %.not468 = icmp ne i8 %i.xm, 0
  br label %.preheader
...
.lr.ph1039.split.us:                              ; preds = %.lr.ph1039, %filter_set_end.exit.us
  %.11038.us = phi i32 [ %i.yc, %filter_set_end.exit.us ], [ %.01051, %.lr.ph1039 ] ; 4 uses
...
.lr.ph1039.split.split.a:                         ; preds = %.lr.ph1039
  br i1 %.not1077, label %bb.eu, label %._crit_edge1040
...
filter_set_end.exit:                              ; preds = %bb.ew, %bb.ev, %bb.eu
  ...
  br i1 %exitcond1275.not, label %._crit_edge1040, label %bb.eu, !llvm.loop !12

._crit_edge1040:                                  ; preds = %filter_set_end.exit.us, %filter_set_end.exit, %.lr.ph1039.split.split.a, %.preheader
  %.1.lcssa = phi i32 [ %.01051, %.preheader ], [ %i.xq, %filter_set_end.exit ], [ %i.xq, %.lr.ph1039.split.split.a ], [ %i.xq, %filter_set_end.exit.us ]
...
._crit_edge1052:                                  ; preds = %._crit_edge1040, %spec_ith_char.exit536
  ...
  %.not462 = icmp samesign ugt i32 %i.yn, %5
...
._crit_edge1057:                                  ; preds = %._crit_edge1052, %bb.eg
  ...
  %.not461 = icmp samesign ugt i32 %i.yq, %i.wl
