...
begin_hunk_0_@cli_scanpe:bb.a
  %indvars.iv.next3388 = add nuw nsw i64 %indvars.iv3387, 1 ; 2 uses
  %exitcond3391.not = icmp eq i64 %indvars.iv.next3388, %wide.trip.count3390
  br i1 %exitcond3391.not, label %bb.fu, label %bb.fk

bb.fu:                                            ; preds = %bb.ft
  call void @free(ptr noundef nonnull %.022463218) #22
  br label %.critedge

.critedge:                                        ; preds = %.preheader3193, %bb.ev, %bb.fu, %bb.eu, %._crit_edge3270, %bb.es, %bb.et, %bb.er, %.thread2979
  %.42094 = phi i32 [ %.02090.lcssa, %.thread2979 ], [ %.02090.lcssa, %bb.es ], [ %.02090.lcssa, %bb.er ], [ %.02090.lcssa, %bb.et ], [ %.02090.lcssa, %bb.ev ], [ %.022433215, %bb.fu ], [ %.02090.lcssa, %bb.eu ], [ %i.vh, %._crit_edge3270 ], [ 0, %.preheader3193 ]
  %i.wa = load ptr, ptr %i.p, align 8, !tbaa !40
  %i.wb = load i32, ptr %i.wa, align 4, !tbaa !52
  %i.wc = and i32 %i.wb, 4
  %.not2539 = icmp eq i32 %i.wc, 0
  %.pre3431 = load ptr, ptr %i.kx, align 8, !tbaa !60 ; 5 uses
  br i1 %.not2539, label %bb.gd, label %bb.fv

bb.fv:                                            ; preds = %.critedge
  %i.wd = load i32, ptr %.pre3431, align 4, !tbaa !61
...
bb.fz:                                            ; preds = %bb.fy
  ...
  br i1 %i.wp, label %bb.ga, label %.thread2988
...
bb.ga:                                            ; preds = %bb.fz
  ...
  br i1 %.not2543, label %.thread2988, label %bb.gb

bb.gb:                                            ; preds = %bb.ga
  call void @free(ptr noundef nonnull %i.wm) #22
  br label %bb.gc

.thread2988:                                      ; preds = %bb.fz, %bb.ga
  call void @llvm.lifetime.end.p0(ptr nonnull %i.l) #22
  %.pre3430 = load ptr, ptr %i.kx, align 8, !tbaa !60
  br label %bb.gd

bb.gc:                                            ; preds = %bb.fy, %bb.gb
  %.14 = phi i32 [ %i.wq, %bb.gb ], [ 20, %bb.fy ]
  call void @cli_exe_info_destroy(ptr noundef nonnull %2) #22
  call void @llvm.lifetime.end.p0(ptr nonnull %i.l) #22
  br label %.thread2998

bb.gd:                                            ; preds = %.thread2988, %bb.fx, %bb.fw, %bb.fv, %.critedge
  %i.wr = phi ptr [ %.pre3430, %.thread2988 ], [ %.pre3431, %bb.fx ], [ %.pre3431, %bb.fw ], [ %.pre3431, %bb.fv ], [ %.pre3431, %.critedge ]
  ...
  br i1 %.not2544, label %.loopexit3191, label %.preheader3190

.preheader3190:                                   ; preds = %bb.gd
  %i.ww = load i16, ptr %i.bf, align 8, !tbaa !26
  %i.wx = zext i16 %i.ww to i32                   ; 2 uses
  %i.wy = add nsw i32 %i.wx, -1                   ; 2 uses
  %.not3338 = icmp eq i32 %i.wy, 0
  br i1 %.not3338, label %.loopexit3191, label %.lr.ph3276

.lr.ph3276:                                       ; preds = %.preheader3190
  %i.wz = load ptr, ptr %2, align 8, !tbaa !25    ; 2 uses
  %i.xa = add nsw i32 %i.wx, -1
  %wide.trip.count3395 = zext i32 %i.wy to i64
  br label %bb.ge

bb.ge:                                            ; preds = %.lr.ph3276, %bb.gk
  %indvars.iv3392 = phi i64 [ 0, %.lr.ph3276 ], [ %indvars.iv.next3393, %bb.gk ] ; 6 uses
  %i.xb = getelementptr inbounds nuw [36 x i8], ptr %i.wz, i64 %indvars.iv3392 ; 2 uses
...
bb.gg:                                            ; preds = %bb.gf
  %i.xg = getelementptr inbounds nuw [36 x i8], ptr %i.wz, i64 %indvars.iv3392 ; 2 uses
...
bb.gi:                                            ; preds = %bb.gh
  %i.xl = trunc nuw i64 %indvars.iv3392 to i32    ; 10 uses
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.26) #22
  %.not2549 = icmp eq ptr %.02169, null           ; 2 uses
  br i1 %.not2549, label %bb.gl, label %bb.gj

bb.gj:                                            ; preds = %bb.gi
  %i.xm = call i32 @cli_jsonbool(ptr noundef nonnull %.02169, ptr noundef nonnull @.str.27, i32 noundef 1) #22 ; 0 uses
  br label %bb.gl

bb.gk:                                            ; preds = %bb.ge, %bb.gf, %bb.gg, %bb.gh
  %indvars.iv.next3393 = add nuw nsw i64 %indvars.iv3392, 1 ; 2 uses
  %exitcond3396.not = icmp eq i64 %indvars.iv.next3393, %wide.trip.count3395
  br i1 %exitcond3396.not, label %.loopexit3191, label %bb.ge
...
bb.gl:                                            ; preds = %bb.gj, %bb.gi
  ...
  %i.xr = icmp samesign ugt i64 %.0.i2924, 15
  ...
  br i1 %or.cond51, label %bb.gm, label %.loopexit3191
...
bb.gm:                                            ; preds = %bb.gl
  ...
  switch i32 %i.xz, label %.loopexit3191 [
    i32 344, label %bb.gn
    i32 340, label %bb.gn
  ]
...
bb.gn:                                            ; preds = %bb.gm, %bb.gm
  ...
  br i1 %.not2550, label %.loopexit3191, label %bb.go
...
bb.go:                                            ; preds = %bb.gn
  ...
  %i.yl = add nuw i64 %indvars.iv3392, 1
...
bb.gt:                                            ; preds = %bb.gr
  ...
  %i.yy = getelementptr inbounds nuw [36 x i8], ptr %i.yk, i64 %indvars.iv3392
...
bb.hn:                                            ; preds = %bb.hh, %bb.hm
  %.02235 = phi i32 [ %i.abk, %bb.hm ], [ 0, %bb.hh ]
  br i1 %.not2549, label %bb.hp, label %bb.ho

bb.ho:                                            ; preds = %bb.hn
  %i.abl = call i32 @cli_jsonstr(ptr noundef nonnull %.02169, ptr noundef nonnull @.str.41, ptr noundef nonnull @.str.42) #22 ; 0 uses
  br label %bb.hp
...
bb.ht:                                            ; preds = %bb.hr
  ...
  %i.abx = call i32 @unmew11(ptr noundef nonnull %i.zz, i32 noundef %i.yt, i32 noundef %i.yx, i32 noundef %i.abt, i32 noundef %i.abu, i32 noundef %i.abw, i32 noundef %.02235, i32 noundef %i.abp) #22
end_hunk_0
...
bb.kf:                                            ; preds = %bb.ke
  ...
  %i.ajq = add i32 %.620962995, 1                 ; 2 uses
  ...
  %i.ajv = zext i32 %.620962995 to i64            ; 2 uses
...
bb.le:                                            ; preds = %bb.lc
  ...
  %or.cond3168 = select i1 %i.amq, i1 true, i1 %.not2605
  %i.amr = zext i32 %i.aml to i64
  %i.ams = add nuw nsw i64 %i.amr, 16
  %.not2606.not = icmp samesign ugt i64 %i.ams, %i.alw
  %or.cond3693 = select i1 %or.cond3168, i1 true, i1 %.not2606.not
  br i1 %or.cond3693, label %bb.lf, label %bb.lg
...
bb.lg:                                            ; preds = %bb.le
  %reass.sub3339 = sub nuw i32 %i.aml, %i.ald
  %i.amt = add i32 %reass.sub3339, 12
...
bb.li:                                            ; preds = %bb.lg
  %.not2607 = icmp eq ptr %.02169, null
  br i1 %.not2607, label %bb.lk, label %bb.lj

bb.lj:                                            ; preds = %bb.li
  %i.anc = call i32 @cli_jsonstr(ptr noundef nonnull %.02169, ptr noundef nonnull @.str.41, ptr noundef nonnull @.str.69) #22 ; 0 uses
  br label %bb.lk
...
bb.ma:                                            ; preds = %bb.ly
  ...
  br label %.sink.split3694
end_hunk_1
begin_hunk_2_@cli_peheader:bb.a
  %.0672.ph = phi ptr [ %i.dh, %bb.cn ], [ null, %bb.cr ]
  %.0671.ph = phi i32 [ 112, %bb.cn ], [ 96, %bb.cr ]
  ...
  %i.jb = call i32 @cli_jsonstr(ptr noundef %.0704, ptr noundef nonnull @.str.258, ptr noundef nonnull %i.g) #22 ; 0 uses
  ...
  %i.jf = call i32 @cli_jsonstr(ptr noundef %.0704, ptr noundef nonnull @.str.259, ptr noundef nonnull %i.g) #22 ; 0 uses
  ...
  %i.jj = call i32 @cli_jsonstr(ptr noundef %.0704, ptr noundef nonnull @.str.260, ptr noundef nonnull %i.g) #22 ; 0 uses
  ...
  %i.jn = call i32 @cli_jsonstr(ptr noundef %.0704, ptr noundef nonnull @.str.261, ptr noundef nonnull %i.g) #22 ; 0 uses
  ...
  %i.jr = call i32 @cli_jsonstr(ptr noundef %.0704, ptr noundef nonnull @.str.262, ptr noundef nonnull %i.g) #22 ; 0 uses
  ...
  %i.jt = call i32 @cli_jsonstr(ptr noundef %.0704, ptr noundef nonnull @.str.263, ptr noundef nonnull %i.g) #22 ; 0 uses
  br label %bb.cs

bb.cs:                                            ; preds = %.sink.split, %bb.cq, %bb.cm
  %.0705 = phi i64 [ %i.dm, %bb.cq ], [ %i.dx, %bb.cm ], [ %.0705.ph, %.sink.split ] ; 2 uses
  %.0672 = phi ptr [ null, %bb.cq ], [ %i.dh, %bb.cm ], [ %.0672.ph, %.sink.split ] ; 4 uses
  %.0671 = phi i32 [ 96, %bb.cq ], [ 112, %bb.cm ], [ %.0671.ph, %.sink.split ]
  %i.ju = getelementptr inbounds nuw i8, ptr %1, i64 84
  %i.jv = load i32, ptr %i.ju, align 4, !tbaa !59
  %i.jw = icmp ne i32 %i.jv, 0
  %i.jx = icmp ne ptr %.0672, null
  %or.cond6 = and i1 %i.jx, %i.jw                 ; 3 uses
  %i.jy = getelementptr inbounds nuw i8, ptr %.0672, i64 32
  ...
  %i.kb = getelementptr inbounds nuw i8, ptr %.0672, i64 36
  ...
  %i.ke = getelementptr inbounds nuw i8, ptr %.0672, i64 68
...
bb.dg:                                            ; preds = %bb.cs, %bb.df, %bb.de, %bb.dd, %bb.dc, %bb.db, %bb.da, %bb.cz, %bb.cy, %bb.cx, %bb.cw, %bb.cv, %bb.cu, %bb.ct
  ...
  %.0668 = phi ptr [ @.str.183, %bb.cs ], [ @.str.277, %bb.df ], [ @.str.265, %bb.ct ], [ @.str.266, %bb.cu ], [ @.str.267, %bb.cv ], [ @.str.268, %bb.cw ], [ @.str.269, %bb.cx ], [ @.str.270, %bb.cy ], [ @.str.271, %bb.cz ], [ @.str.272, %bb.da ], [ @.str.273, %bb.db ], [ @.str.274, %bb.dc ], [ @.str.275, %bb.dd ], [ @.str.276, %bb.de ] ; 2 uses
  br i1 %.not752.not, label %bb.di, label %bb.dh

bb.dh:                                            ; preds = %bb.dg
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.278, ptr noundef nonnull %.0668) #22
...
bb.dj:                                            ; preds = %bb.di
  %i.kg = call i32 @cli_jsonstr(ptr noundef %.0704, ptr noundef nonnull @.str.279, ptr noundef nonnull %.0668) #22 ; 0 uses
  br label %bb.dk
...
bb.dm:                                            ; preds = %bb.dl
  ...
  br i1 %.not765, label %bb.dn, label %.thread946
...
bb.do:                                            ; preds = %bb.dn
  ...
  br i1 %.not768, label %.critedge844, label %.thread946
...
bb.ds:                                            ; preds = %bb.dr, %bb.dq
  ...
  %i.kt = add nuw nsw i32 %i.kr, %.0671           ; 3 uses
...
bb.du:                                            ; preds = %bb.ds
  ...
  %i.kx = call fastcc i64 @fmap_readn(ptr noundef nonnull %i.k, ptr noundef nonnull %i.kv, i64 noundef %.0705, i64 noundef %i.kw)
  %.not769 = icmp eq i64 %i.kx, %i.kw
  br i1 %.not769, label %.preheader974, label %bb.dv

.preheader974:                                    ; preds = %bb.du
  %i.ky = add nuw nsw i64 %.0705, %i.kw           ; 2 uses
...
bb.dx:                                            ; preds = %bb.dw, %.preheader974
  %.1706 = phi i64 [ %i.lb, %bb.dw ], [ %i.ky, %.preheader974 ]
...
bb.eh:                                            ; preds = %bb.ef
  ...
  %i.mk = call fastcc i64 @fmap_readn(ptr noundef nonnull %i.k, ptr noundef nonnull %i.mg, i64 noundef %.1706, i64 noundef %i.mj) ; 2 uses
  %i.ml = icmp eq i64 %i.mk, -1
  br i1 %i.ml, label %.thread951, label %bb.ei
...
bb.ei:                                            ; preds = %bb.eh
  ...
  br i1 %.not777, label %.preheader973, label %.thread951

.preheader973:                                    ; preds = %bb.ei
  %.not778981 = icmp eq i32 %i.kd, 512
  br i1 %.not778981, label %.critedge, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %.preheader973
...
.thread951:                                       ; preds = %bb.eh, %bb.ei
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.289) #22
  br label %bb.ic

.lr.ph1139:                                       ; preds = %.lr.ph.preheader, %.lr.ph
  %.16849831138 = phi i64 [ %i.my, %.lr.ph ], [ 0, %.lr.ph.preheader ] ; 2 uses
  br i1 %.not837, label %.lr.ph, label %bb.ej

bb.ej:                                            ; preds = %.lr.ph1139
  %i.mr = getelementptr inbounds nuw [40 x i8], ptr %i.mg, i64 %.16849831138 ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph1139, %bb.ej, %bb.ek
  %i.my = add nuw nsw i64 %.16849831138, 1        ; 2 uses
  %i.mz = icmp samesign ult i64 %i.my, %i.mq
  br i1 %i.mz, label %.lr.ph1139, label %.critedge

.critedge:                                        ; preds = %.lr.ph, %.lr.ph.preheader, %.thread1110, %.preheader973
  %i.na = phi i16 [ %i.mm, %.preheader973 ], [ %.pre.pre, %.thread1110 ], [ %i.mp, %.lr.ph.preheader ], [ 1, %.lr.ph ]
  %.0702.lcssa = phi i32 [ 512, %.preheader973 ], [ 512, %.thread1110 ], [ %i.kd, %.lr.ph.preheader ], [ %i.kd, %.lr.ph ] ; 5 uses
  ...
  %.not1021 = icmp eq i16 %i.na, 0
  br i1 %.not1021, label %.critedge.._crit_edge995_crit_edge, label %.lr.ph994

.critedge.._crit_edge995_crit_edge:               ; preds = %.critedge
  %.pre1046 = trunc i64 %i.ne to i32
  br label %._crit_edge995

.lr.ph994:                                        ; preds = %.critedge
  %.not804 = icmp eq i32 %.0702.lcssa, 0
  %i.nf = and i32 %2, 16
...
bb.el:                                            ; preds = %.lr.ph994, %bb.gm
  %.2685993 = phi i64 [ 0, %.lr.ph994 ], [ %i.tk, %bb.gm ] ; 12 uses
  %.0701991 = phi i64 [ 0, %.lr.ph994 ], [ %i.tl, %bb.gm ] ; 5 uses
  %i.nm = load ptr, ptr %1, align 8, !tbaa !25
  %i.nn = getelementptr inbounds nuw [36 x i8], ptr %i.nm, i64 %.2685993 ; 14 uses
  %i.no = getelementptr inbounds nuw [40 x i8], ptr %i.mg, i64 %.2685993 ; 12 uses
...
bb.gn:                                            ; preds = %._crit_edge995
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.310) #22
  br label %bb.ic

bb.go:                                            ; preds = %._crit_edge995
  br i1 %.not, label %bb.gp, label %bb.gq

bb.gp:                                            ; preds = %bb.go
  %i.uc = call i32 @cli_jsonint(ptr noundef %.0704, ptr noundef nonnull @.str.311, i32 noundef %i.tx) #22 ; 0 uses
...
bb.hb:                                            ; preds = %bb.ha, %bb.gz
  ...
  br i1 %.not784, label %.thread943, label %bb.hc
...
bb.hd:                                            ; preds = %bb.hc
  ...
  %.not1022 = icmp eq i32 %i.uw, 0
  br i1 %.not1022, label %.thread943, label %.lr.ph1017

.lr.ph1017:                                       ; preds = %bb.hd, %.thread939
  %i.ux = phi i32 [ %i.zu, %.thread939 ], [ %i.uw, %bb.hd ]
  %.46871015 = phi i64 [ %i.va, %.thread939 ], [ 0, %bb.hd ] ; 2 uses
  %i.uy = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %.46871015 ; 2 uses
  %i.uz = load i32, ptr %i.uy, align 4, !tbaa !12
  %i.va = add nuw nsw i64 %.46871015, 1           ; 3 uses
  ...
  br i1 %.not786, label %bb.he, label %.thread939

bb.he:                                            ; preds = %.lr.ph1017
  ...
  br i1 %.not787, label %.thread939, label %bb.hf
...
bb.hf:                                            ; preds = %bb.he
  ...
  br i1 %.not788, label %bb.hg, label %.thread939
...
bb.hi:                                            ; preds = %bb.hh
  ...
  br i1 %or.cond16, label %.thread939, label %bb.hj
...
bb.hj:                                            ; preds = %bb.hi
  ...
  br i1 %.not789, label %bb.hk, label %.thread939
...
bb.hk:                                            ; preds = %bb.hj
  ...
  %or.cond1020 = select i1 %.not790, i1 %i.ws, i1 false
  br i1 %or.cond1020, label %.lr.ph1000.preheader, label %.thread939

.lr.ph1000.preheader:                             ; preds = %bb.hk
  ...
  br i1 %or.cond1131, label %bb.hl, label %.thread939

bb.hl:                                            ; preds = %.lr.ph1000.preheader
...
.loopexit1030:                                    ; preds = %.lr.ph1000, %bb.hl
  %.0688997.lcssa1025 = phi ptr [ %i.xk, %.lr.ph1000 ], [ %i.wq, %bb.hl ] ; 2 uses
  %.lcssa1024 = phi i32 [ %i.xl, %.lr.ph1000 ], [ %i.wu, %bb.hl ] ; 3 uses
  %i.xn = icmp samesign ult i32 %.lcssa1024, 37
  br i1 %i.xn, label %.thread939, label %bb.hn

bb.hn:                                            ; preds = %.loopexit1030
  %i.xo = getelementptr inbounds nuw i8, ptr %.0688997.lcssa1025, i64 6 ; 2 uses
  ...
  %i.xx = icmp samesign ugt i32 %.lcssa1024, 42
  %or.cond1150 = select i1 %.not794, i1 %i.xx, i1 false
  br i1 %or.cond1150, label %.lr.ph1013, label %.thread939

.lr.ph1013:                                       ; preds = %bb.hn
  %i.xy = add nsw i32 %.lcssa1024, -36
  %i.xz = getelementptr inbounds nuw i8, ptr %.0688997.lcssa1025, i64 36
  %i.ya = ptrtoint ptr %i.vl to i64
  br label %bb.ho

bb.ho:                                            ; preds = %.lr.ph1013, %.thread914
  %.06751011 = phi i32 [ %i.xy, %.lr.ph1013 ], [ %i.yf, %.thread914 ] ; 2 uses
  %.16891010 = phi ptr [ %i.xz, %.lr.ph1013 ], [ %i.ye, %.thread914 ] ; 3 uses
  %i.yb = load i32, ptr %.16891010, align 1, !tbaa !36
  %i.yc = and i32 %i.yb, 65535                    ; 6 uses
  %i.yd = zext nneg i32 %i.yc to i64
  %i.ye = getelementptr inbounds nuw i8, ptr %.16891010, i64 %i.yd
  %i.yf = sub i32 %.06751011, %i.yc               ; 2 uses
  %i.yg = icmp ugt i32 %i.yc, %.06751011
  %i.yh = icmp samesign ult i32 %i.yc, 25
  %or.cond20 = select i1 %i.yg, i1 true, i1 %i.yh
  br i1 %or.cond20, label %.thread939, label %bb.hp

bb.hp:                                            ; preds = %bb.ho
  %i.yi = icmp samesign ugt i32 %i.yc, 30
  br i1 %i.yi, label %.lr.ph1006.preheader, label %.thread914

.lr.ph1006.preheader:                             ; preds = %bb.hp
  %i.yj = add nsw i32 %i.yc, -24
  %i.yk = getelementptr inbounds nuw i8, ptr %.16891010, i64 24
  br label %.lr.ph1006

.lr.ph1006:                                       ; preds = %.lr.ph1006.preheader, %bb.ib
  %.06731004 = phi i32 [ %.1674, %bb.ib ], [ %i.yj, %.lr.ph1006.preheader ] ; 2 uses
  %.26901003 = phi ptr [ %.3691, %bb.ib ], [ %i.yk, %.lr.ph1006.preheader ] ; 7 uses
  %i.yl = load i32, ptr %.26901003, align 1, !tbaa !36
  %i.ym = and i32 %i.yl, 65535
  %i.yn = add nuw nsw i32 %i.ym, 3
  %i.yo = and i32 %i.yn, 131068                   ; 8 uses
  %i.yp = icmp ugt i32 %i.yo, %.06731004
  %i.yq = icmp samesign ult i32 %i.yo, 17
  %or.cond22 = select i1 %i.yp, i1 true, i1 %i.yq
  br i1 %or.cond22, label %.thread939, label %.preheader.preheader

.preheader.preheader:                             ; preds = %.lr.ph1006
  %i.yr = zext nneg i32 %i.yo to i64              ; 2 uses
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %bb.hs
  %indvars.iv1031 = phi i64 [ 6, %.preheader.preheader ], [ %indvars.iv.next1032, %bb.hs ] ; 3 uses
  %indvars.iv = phi i64 [ 7, %.preheader.preheader ], [ %indvars.iv.next, %bb.hs ] ; 2 uses
  %i.ys = getelementptr inbounds nuw i8, ptr %.26901003, i64 %indvars.iv1031
  %i.yt = load i8, ptr %i.ys, align 1, !tbaa !36
  %.not795 = icmp eq i8 %i.yt, 0
  br i1 %.not795, label %bb.hq, label %bb.hs

bb.hq:                                            ; preds = %.preheader
  %i.yu = getelementptr inbounds nuw i8, ptr %.26901003, i64 %indvars.iv
  %i.yv = load i8, ptr %i.yu, align 1, !tbaa !36
  %.not796 = icmp eq i8 %i.yv, 0
  br i1 %.not796, label %bb.hr, label %bb.hs

bb.hr:                                            ; preds = %bb.hq
  %i.yw = trunc nuw nsw i64 %indvars.iv1031 to i32
  %i.yx = add i32 %i.yw, 2
  br label %.loopexit

bb.hs:                                            ; preds = %.preheader, %bb.hq
  %indvars.iv.next1032 = add nuw nsw i64 %indvars.iv1031, 2 ; 2 uses
  %i.yy = or disjoint i64 %indvars.iv.next1032, 1
  %i.yz = icmp samesign ult i64 %i.yy, %i.yr
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 2
  br i1 %i.yz, label %.preheader, label %.loopexit

.loopexit:                                        ; preds = %bb.hs, %bb.hr
  %.1670 = phi i32 [ %i.yx, %bb.hr ], [ %i.yo, %bb.hs ]
  %i.za = add i32 %.1670, 3
...
bb.ht:                                            ; preds = %.loopexit
  ...
  %i.ze = ptrtoint ptr %.26901003 to i64
...
bb.hv:                                            ; preds = %bb.hu
  %i.zk = getelementptr inbounds nuw i8, ptr %.26901003, i64 6 ; 2 uses
...
bb.hw:                                            ; preds = %bb.hv
  ...
  %i.zn = getelementptr inbounds nuw i8, ptr %.26901003, i64 %i.zm
...
.thread914:                                       ; preds = %bb.ib, %bb.hp
  %i.zt = icmp ugt i32 %i.yf, 6
  br i1 %i.zt, label %bb.ho, label %.thread939

.thread939:                                       ; preds = %.thread914, %bb.ho, %.lr.ph1006, %.lr.ph1000.preheader, %bb.hm, %.lr.ph1000, %bb.hn, %.loopexit1030, %bb.hj, %bb.hk, %bb.hh, %bb.hi, %bb.hg, %bb.hf, %bb.he, %.lr.ph1017
  %i.zu = load i32, ptr %i.us, align 4, !tbaa !140 ; 2 uses
  %i.zv = zext i32 %i.zu to i64
  %i.zw = icmp samesign ult i64 %i.va, %i.zv
  br i1 %i.zw, label %.lr.ph1017, label %.thread943

.thread943:                                       ; preds = %.thread939, %bb.hd, %bb.hb
...
.critedge14:                                      ; preds = %.thread943, %bb.gx, %bb.gw, %bb.gy
  store i32 %.0709882961, ptr %i.cq, align 8, !tbaa !104
  br label %bb.ic

bb.ic:                                            ; preds = %bb.gn, %.critedge14, %bb.gp, %.thread900, %.loopexit1132, %.thread951
  %.2956 = phi i32 [ 26, %.thread951 ], [ 34, %.loopexit1132 ], [ 0, %.critedge14 ], [ %.1.ph, %.thread900 ], [ 26, %bb.gn ], [ 21, %bb.gp ]
  call void @free(ptr noundef nonnull %i.mg) #22
  br label %.thread946

.thread946:                                       ; preds = %bb.br, %bb.ch, %bb.cb, %bb.bt, %bb.bv, %bb.bu, %bb.cg, %bb.dm, %bb.ee, %bb.eg, %bb.do, %bb.dv, %bb.dt, %fmap_readn.exit873.thread, %bb.ca, %fmap_readn.exit869.thread, %.thread886, %bb.r, %bb.v, %fmap_readn.exit865.thread, %fmap_readn.exit861.thread, %bb.l, %fmap_readn.exit.thread, %bb.b, %bb.ic
  %.2950 = phi i32 [ %.2956, %bb.ic ], [ 26, %bb.br ], [ 3, %bb.b ], [ 26, %bb.ch ], [ 26, %bb.cb ], [ 26, %bb.bt ], [ 26, %bb.bv ], [ 26, %bb.bu ], [ 26, %bb.cg ], [ 26, %bb.dm ], [ 34, %bb.ee ], [ 34, %bb.eg ], [ 26, %bb.do ], [ 34, %bb.dv ], [ 26, %bb.dt ], [ 26, %fmap_readn.exit873.thread ], [ 26, %bb.ca ], [ 26, %fmap_readn.exit869.thread ], [ 26, %.thread886 ], [ 34, %bb.r ], [ 34, %bb.v ], [ 34, %fmap_readn.exit865.thread ], [ 26, %fmap_readn.exit861.thread ], [ 34, %bb.l ], [ 34, %fmap_readn.exit.thread ]
...
bb.e:                                             ; preds = %bb.c, %bb.b, %bb.a, %bb.d
  %.0 = phi i64 [ 0, %bb.a ], [ %i.k, %bb.d ], [ -1, %bb.b ], [ -1, %bb.c ]
  ret i64 %.0
}
...
.lr.ph.preheader:                                 ; preds = %bb.g, %bb.j
  %.05374.lcssa.wide.ph = phi i64 [ 2, %bb.j ], [ 1, %bb.g ]
  tail call void (ptr, ...) @cli_errmsg(ptr noundef nonnull @.str.348) #22
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %indvars.iv = phi i64 [ %.05374.lcssa.wide.ph, %.lr.ph.preheader ], [ %i.n, %.lr.ph ]
...
bb.e:                                             ; preds = %bb.d, %bb.c
  %.0130 = phi ptr [ %3, %bb.d ], [ %1, %bb.c ]   ; 7 uses
  %.0130.sroa.phi300 = getelementptr inbounds nuw i8, ptr %.0130, i64 284
  %.0130.sroa.phi297 = getelementptr inbounds nuw i8, ptr %.0130, i64 280
  %.0130.sroa.phi = getelementptr inbounds nuw i8, ptr %.0130, i64 24
  %.0130.sroa.phi292 = getelementptr inbounds nuw i8, ptr %.0130, i64 84
  %.0130.sroa.phi290 = getelementptr inbounds nuw i8, ptr %.0130, i64 88
  %i.o = load i32, ptr %.0130.sroa.phi297, align 8, !tbaa !23 ; 4 uses
  %i.p = load i32, ptr %.0130.sroa.phi300, align 4, !tbaa !107 ; 4 uses
...
bb.i:                                             ; preds = %bb.h
  %i.ac = load i32, ptr %.0130.sroa.phi290, align 8, !tbaa !98 ; 2 uses
  ...
  %i.ah = load i32, ptr %.0130.sroa.phi292, align 4, !tbaa !59
  ...
  %i.an = load i32, ptr %.0130.sroa.phi, align 8, !tbaa !27
...
bb.q:                                             ; preds = %bb.o, %bb.n
  %.0140 = phi i32 [ 3, %bb.n ], [ 2, %bb.o ]     ; 2 uses
...
bb.y:                                             ; preds = %bb.x, %bb.w
  ...
  %i.bg = call i32 @asn1_check_mscat(ptr noundef %i.bf, ptr noundef nonnull %i.c, i64 noundef %i.bd, i32 noundef %i.be, ptr noundef nonnull %i.ab, i32 noundef %.0140, ptr noundef nonnull %0) #22 ; 3 uses
...
bb.ab:                                            ; preds = %bb.y, %bb.z, %bb.aa
  %.1141 = phi i32 [ %.0140, %bb.y ], [ 3, %bb.aa ], [ 2, %bb.z ] ; 4 uses
  %.0136 = phi i32 [ %i.bg, %bb.y ], [ 26, %bb.aa ], [ 26, %bb.z ] ; 2 uses
...
bb.ah:                                            ; preds = %.thread279, %.thread
  %.lcssa244 = phi ptr [ @.str.326, %.thread ], [ @.str.327, %.thread279 ] ; 3 uses
...
.preheader.preheader.1:                           ; preds = %bb.al
  %wide.trip.count.1 = zext nneg i32 %.1141 to i64
