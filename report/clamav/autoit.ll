...
bb.i:                                             ; preds = %.lr.ph671.i, %.backedge.i
  %.1122670.i = phi ptr [ %.1116.ph691.i, %.lr.ph671.i ], [ %.1122.be.i, %.backedge.i ] ; 4 uses
...
.loopexit438.i:                                   ; preds = %.loopexit438.loopexit.i, %bb.ey, %bb.ex, %bb.ew, %bb.ev
  %.0216.i = phi i32 [ 3, %bb.ev ], [ 44, %bb.ey ], [ 13, %bb.ex ], [ 6, %bb.ew ], [ %3, %.loopexit438.loopexit.i ]
  %.1.i38 = phi i32 [ %i.bbq, %bb.ev ], [ %i.bbw, %bb.ey ], [ %i.bbu, %bb.ex ], [ %i.bbs, %bb.ew ], [ %i.bby, %.loopexit438.loopexit.i ]
  %i.bcb = add i32 %.1.i38, %.0216.i              ; 5 uses
