...
bb.i:                                             ; preds = %.lr.ph671.i, %.backedge.i
  ...
  %i.cs = ptrtoint ptr %.1116670.i to i64
...
bb.j:                                             ; preds = %bb.i
  %i.cx = load i32, ptr %.1116670.i, align 1, !tbaa !50
...
bb.l:                                             ; preds = %bb.j
  %i.cy = getelementptr inbounds nuw i8, ptr %.1116670.i, i64 4
...
bb.m:                                             ; preds = %bb.l
  %i.dc = getelementptr inbounds nuw i8, ptr %.1116670.i, i64 8 ; 3 uses
...
.backedge.i:                                      ; preds = %bb.cn, %bb.ak, %bb.ai, %bb.ac, %bb.aa, %bb.y
  %.1116.be.i = phi ptr [ %i.ey, %bb.y ], [ %i.fk, %bb.aa ], [ %i.fh, %bb.ac ], [ %i.fu, %bb.ai ], [ %i.fu, %bb.ak ], [ %i.fu, %bb.cn ]
...
begin_hunk_1_@cli_scanautoit:bb.a
  %i.ams = or disjoint i32 %i.amq, %.masked813.i
...
.preheader594.4.thread.i:                         ; preds = %.preheader594.3.i
  ...
  %.sroa.125.sroa.0.0.insert.ext353.3984.i = shl nuw nsw i32 %i.ang, 1
...
.preheader594.5.thread.i:                         ; preds = %bb.ch, %.preheader594.4.thread.i
  %.sroa.125.sroa.0.26.3986.ph.i = phi i32 [ %i.ang, %.preheader594.4.thread.i ], [ %.sroa.125.sroa.0.0.insert.ext353.2.i, %bb.ch ]
  %.sroa.125.sroa.0.26.4.ph.i = phi i32 [ %.sroa.125.sroa.0.0.insert.ext353.3984.i, %.preheader594.4.thread.i ], [ %i.ans, %bb.ch ] ; 2 uses
  %.ph987.i = phi i32 [ 14, %.preheader594.4.thread.i ], [ 15, %bb.ch ]
  %.sroa.46.26.4.ph.i = add i32 %.sroa.46.26.2.i, 2
  %.sroa.125.sroa.0.0.insert.ext353.4991.i = shl nuw nsw i32 %.sroa.125.sroa.0.26.4.ph.i, 1
...
.preheader594.6.i:                                ; preds = %bb.ci, %.preheader594.5.i, %.preheader594.5.thread.i
  %.pn1046.in.i = phi i32 [ %.sroa.125.sroa.0.0.insert.ext353.2.i, %bb.ci ], [ %.sroa.125.sroa.0.0.insert.ext353.2.i, %.preheader594.5.i ], [ %.sroa.125.sroa.0.26.3986.ph.i, %.preheader594.5.thread.i ]
  %.sroa.125.sroa.0.26.4993.i = phi i32 [ %.sroa.125.sroa.0.0.insert.ext353.3.i, %bb.ci ], [ %.sroa.125.sroa.0.0.insert.ext353.3.i, %.preheader594.5.i ], [ %.sroa.125.sroa.0.26.4.ph.i, %.preheader594.5.thread.i ]
  %.sroa.46.26.5.i = phi i32 [ %i.aoa, %bb.ci ], [ %.sroa.46.26.2.i, %.preheader594.5.i ], [ %.sroa.46.26.4.ph.i, %.preheader594.5.thread.i ] ; 4 uses
  %.sroa.125.sroa.0.26.5.i = phi i32 [ %i.aog, %bb.ci ], [ %.sroa.125.sroa.0.0.insert.ext353.4.i, %.preheader594.5.i ], [ %.sroa.125.sroa.0.0.insert.ext353.4991.i, %.preheader594.5.thread.i ]
  %i.aoh = phi i32 [ 16, %bb.ci ], [ %i.ant, %.preheader594.5.i ], [ %.ph987.i, %.preheader594.5.thread.i ]
  %.pn1046.i = and i32 %.pn1046.in.i, 32768
  %i.aoi = or disjoint i32 %.pn1046.i, %i.amu
  %i.aoj = shl nuw nsw i32 %i.aoi, 3
  %i.aok = shl nuw nsw i32 %.sroa.125.sroa.0.26.4993.i, 2
...
.loopexit.i:                                      ; preds = %.preheader594.7.i, %bb.ck
  ...
  %i.aqc = zext i32 %.sroa.35.0662.i207 to i64
  %i.aqd = getelementptr inbounds nuw i8, ptr %i.gb, i64 %i.aqc
  store i8 %i.aqb, ptr %i.aqd, align 1, !tbaa !50
  %i.aqe = add nuw i32 %.sroa.35.0662.i207, 1     ; 2 uses
  %i.aqf = icmp ult i32 %i.aqe, %spec.select.i
  br i1 %i.aqf, label %.backedge, label %._crit_edge.i.thread115
...
.backedge:                                        ; preds = %.loopexit.i, %.loopexit.i.thread
  ...
  %.sroa.35.0662.i.be = phi i32 [ %i.aqe, %.loopexit.i ], [ %.lcssa434, %.loopexit.i.thread ] ; 2 uses
  ...
  br i1 %or.cond566.not.i, label %.preheader603.preheader.i, label %.thread950.i

._crit_edge.i.thread115:                          ; preds = %.loopexit.i
...
.loopexit.i.thread:                               ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i, %vec.epilog.middle.block, %middle.block
  %.lcssa434 = phi i32 [ %i.ajc, %vec.epilog.middle.block ], [ %i.air, %middle.block ], [ %.lcssa503.unr, %.lr.ph.i.prol.loopexit ], [ %i.akw, %.lr.ph.i ] ; 2 uses
  %i.aqj = icmp ult i32 %.lcssa434, %spec.select.i
...
._crit_edge.i:                                    ; preds = %bb.ce, %.thread950.i
  %.sroa.35.0662.i158 = phi i32 [ %.sroa.35.0662.i.lcssa, %.thread950.i ], [ %.sroa.35.0662.i207, %bb.ce ] ; 2 uses
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.480) #14
  %i.aqk = zext i32 %.sroa.35.0662.i158 to i64
  %i.aql = getelementptr inbounds nuw i8, ptr %i.gb, i64 %i.aqk
  store i8 0, ptr %i.aql, align 1, !tbaa !50
  %i.aqm = add nuw i32 %.sroa.35.0662.i158, 1
  br label %.thread525.i

.thread525.i:                                     ; preds = %.loopexit597.i, %bb.cb, %bb.cc, %bb.cd, %.thread525.sink.split.i, %._crit_edge.i
  %.sroa.35.0630.i = phi i32 [ %i.aqm, %._crit_edge.i ], [ %.sroa.35.0662.i207, %.thread525.sink.split.i ], [ %.sroa.35.0662.i207, %bb.cd ], [ %.sroa.35.0662.i207, %bb.cc ], [ %.sroa.35.0662.i207, %bb.cb ], [ %.sroa.35.0662.i207, %.loopexit597.i ] ; 2 uses
  call void @free(ptr noundef %i.fn) #14
...
bb.cn:                                            ; preds = %bb.cm, %.thread996.i
  %.sroa.0.1999.i = phi ptr [ %i.gb, %.thread996.i ], [ %.sroa.0.1.i, %bb.cm ]
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.473) #14
  call void @free(ptr noundef %.sroa.0.1999.i) #14
  br label %.backedge.i
...
bb.cp:                                            ; preds = %bb.co
  ...
  br i1 %.not172.i, label %bb.cq, label %.thread546.thread1000.i

.thread546.thread1000.i:                          ; preds = %bb.cp
...
.thread551.i:                                     ; preds = %bb.al, %bb.af
  %.0117.i = phi i32 [ 0, %bb.af ], [ 20, %bb.al ]
...
.thread546.thread559.i:                           ; preds = %bb.cv, %bb.cu, %.thread546.thread1000.i
  %.0117537543563.i = phi i32 [ 14, %.thread546.thread1000.i ], [ 13, %bb.cu ], [ %i.aqz, %bb.cv ] ; 2 uses
...
ea05.exit:                                        ; preds = %.outer.i, %bb.i, %bb.l, %bb.n, %bb.p, %bb.q, %bb.s, %bb.u, %.backedge.i, %bb.ad, %bb.h, %.preheader605.preheader.i, %bb.k, %bb.w, %.thread551.i, %.thread546.i, %.thread546.thread559.i, %bb.cy
  %.0117537543554.i = phi i32 [ %.0117.i, %.thread551.i ], [ %.0117537543563.i, %.thread546.thread559.i ], [ %.0117537543563.i, %bb.cy ], [ 9, %.thread546.i ], [ 0, %bb.h ], [ 0, %bb.k ], [ 0, %bb.w ], [ 0, %bb.l ], [ %i.bi, %.preheader605.preheader.i ], [ %i.ez, %.backedge.i ], [ 0, %bb.i ], [ 0, %bb.n ], [ 0, %bb.p ], [ 0, %bb.s ], [ 0, %bb.u ], [ 20, %bb.ad ], [ 0, %bb.q ], [ %i.arf, %.outer.i ]
...
.lr.ph49.i.i.epil.preheader:                      ; preds = %u2a.exit.i.loopexit.unr-lcssa, %.lr.ph49.preheader.i.i
  ...
  %lcmp.mod554 = icmp ne i64 %xtraiter, 0
...
bb.dr:                                            ; preds = %bb.dq, %bb.dp, %u2a.exit.i
  ...
  %.0223.i = phi i1 [ %.not289.i, %bb.dp ], [ false, %u2a.exit.i ], [ false, %bb.dq ] ; 2 uses
...
.lr.ph49.preheader.i370.i:                        ; preds = %._crit_edge.i368.i, %bb.dx
  ...
  %narrow565 = add nuw i32 %i.axq, 1
  %i.axr = zext i32 %narrow565 to i64             ; 2 uses
  %xtraiter555 = and i64 %i.axr, 7                ; 3 uses
...
.lr.ph49.preheader.i370.i.new:                    ; preds = %.lr.ph49.preheader.i370.i
  %unroll_iter559 = and i64 %i.axr, 4294967288
...
.lr.ph49.i373.i:                                  ; preds = %.lr.ph49.i373.i, %.lr.ph49.preheader.i370.i.new
  ...
  %niter560 = phi i64 [ 0, %.lr.ph49.preheader.i370.i.new ], [ %niter560.next.7, %.lr.ph49.i373.i ]
  ...
  %niter560.next.7 = add i64 %niter560, 8         ; 2 uses
  %niter560.ncmp.7 = icmp eq i64 %niter560.next.7, %unroll_iter559
  br i1 %niter560.ncmp.7, label %u2a.exit378.i.loopexit.unr-lcssa, label %.lr.ph49.i373.i

u2a.exit378.i.loopexit.unr-lcssa:                 ; preds = %.lr.ph49.i373.i
  %lcmp.mod557.not = icmp eq i64 %xtraiter555, 0
  br i1 %lcmp.mod557.not, label %u2a.exit378.i, label %.lr.ph49.i373.i.epil.preheader
...
.lr.ph49.i373.i.epil.preheader:                   ; preds = %u2a.exit378.i.loopexit.unr-lcssa, %.lr.ph49.preheader.i370.i
  ...
  %lcmp.mod558 = icmp ne i64 %xtraiter555, 0
...
.lr.ph49.i373.i.epil:                             ; preds = %.lr.ph49.i373.i.epil, %.lr.ph49.i373.i.epil.preheader
  ...
  %epil.iter556 = phi i64 [ %epil.iter556.next, %.lr.ph49.i373.i.epil ], [ 0, %.lr.ph49.i373.i.epil.preheader ]
  ...
  %epil.iter556.next = add i64 %epil.iter556, 1   ; 2 uses
  %epil.iter556.cmp.not = icmp eq i64 %epil.iter556.next, %xtraiter555
  br i1 %epil.iter556.cmp.not, label %u2a.exit378.i, label %.lr.ph49.i373.i.epil, !llvm.loop !65
...
._crit_edge578.i:                                 ; preds = %u2a.exit378.i, %bb.dt
...
.preheader437.i:                                  ; preds = %bb.ey, %.preheader437.i
  %.0236.i = phi i32 [ %i.bca, %.preheader437.i ], [ 296, %bb.ey ] ; 2 uses
...
bb.fb:                                            ; preds = %bb.fa
  ...
  br i1 %or.cond352.i, label %.lr.ph.i38.preheader, label %bb.fc

.lr.ph.i38.preheader:                             ; preds = %bb.fb
  %xtraiter561 = and i32 %i.bcb, 1
  %lcmp.mod562.not = icmp eq i32 %xtraiter561, 0
  br i1 %lcmp.mod562.not, label %.lr.ph.i38.prol.loopexit, label %.lr.ph.i38.prol

.lr.ph.i38.prol:                                  ; preds = %.lr.ph.i38.preheader
...
.lr.ph.i38.prol.loopexit:                         ; preds = %.lr.ph.i38.prol, %.lr.ph.i38.preheader
  %.lcssa535.unr = phi i32 [ poison, %.lr.ph.i38.preheader ], [ %i.bdj, %.lr.ph.i38.prol ]
  %.unr = phi i32 [ %i.bck, %.lr.ph.i38.preheader ], [ %i.bdj, %.lr.ph.i38.prol ]
  %.1235476.i.unr = phi i32 [ %i.bcb, %.lr.ph.i38.preheader ], [ %i.bda, %.lr.ph.i38.prol ]
  %i.bdk = icmp eq i32 %i.bcg, 0
  br i1 %i.bdk, label %.loopexit.i36, label %.lr.ph.i38
...
.lr.ph.i38:                                       ; preds = %.lr.ph.i38.prol.loopexit, %.lr.ph.i38
  %i.bdl = phi i32 [ %i.bee, %.lr.ph.i38 ], [ %.unr, %.lr.ph.i38.prol.loopexit ] ; 2 uses
  %.1235476.i = phi i32 [ %i.bdv, %.lr.ph.i38 ], [ %.1235476.i.unr, %.lr.ph.i38.prol.loopexit ]
  ...
  %i.bdv = add i32 %.1235476.i, -2                ; 2 uses
  ...
  br i1 %.not309.i.1, label %.loopexit.i36, label %.lr.ph.i38
...
.loopexit.i36:                                    ; preds = %.lr.ph.i38.prol.loopexit, %.lr.ph.i38, %bb.fd
  %i.ben = phi i32 [ %i.bem, %bb.fd ], [ %.lcssa535.unr, %.lr.ph.i38.prol.loopexit ], [ %i.bee, %.lr.ph.i38 ]
...
.thread._crit_edge.i:                             ; preds = %.thread.i37
  %.pre558.i.a = load i32, ptr %i.asc, align 8, !tbaa !69
  br label %bb.fg
...
bb.fg:                                            ; preds = %bb.ff, %bb.fe, %.thread._crit_edge.i
  %i.bey = phi i32 [ %.pre558.i.a, %.thread._crit_edge.i ], [ %i.bev, %bb.fe ], [ %i.bex, %bb.ff ] ; 4 uses
...
bb.fi:                                            ; preds = %bb.fg
  br i1 %.0223.i, label %bb.fj, label %bb.hv
...
.lr.ph486.i:                                      ; preds = %bb.fl, %bb.ht
  ...
  %.0217484.i = phi ptr [ %.21.i, %bb.ht ], [ %i.bfc, %bb.fl ] ; 35 uses
...
bb.hn:                                            ; preds = %bb.hm
  ...
  %i.bpp = call ptr @cli_max_realloc(ptr noundef %.0217484.i, i64 noundef %i.bpo) #14 ; 2 uses
  %.not323.i = icmp eq ptr %i.bpp, null
  br i1 %.not323.i, label %bb.ho, label %..thread398_crit_edge.i

..thread398_crit_edge.i:                          ; preds = %bb.hn
  %.pre560.i = load i32, ptr %i.asd, align 8, !tbaa !71
...
.thread398.i:                                     ; preds = %..thread398_crit_edge.i, %bb.hm
  %i.bpq = phi i32 [ %i.bpk, %bb.hm ], [ %.pre560.i, %..thread398_crit_edge.i ]
  %.18.i = phi ptr [ %.0217484.i, %bb.hm ], [ %i.bpp, %..thread398_crit_edge.i ] ; 2 uses
...
bb.hq:                                            ; preds = %bb.hp
  ...
  %i.bqg = call ptr @cli_max_realloc(ptr noundef %.0217484.i, i64 noundef %i.bqf) #14 ; 2 uses
  %.not321.i = icmp eq ptr %i.bqg, null
  br i1 %.not321.i, label %bb.hr, label %..thread401_crit_edge.i

..thread401_crit_edge.i:                          ; preds = %bb.hq
  %.pre559.i = load i32, ptr %i.asd, align 8, !tbaa !71 ; 2 uses
  %.pre576.i = add i32 %.pre559.i, 1
...
.thread401.i:                                     ; preds = %..thread401_crit_edge.i, %bb.hp
  %.pre-phi577.i = phi i32 [ %.pre576.i, %..thread401_crit_edge.i ], [ %i.bqc, %bb.hp ]
  %i.bqh = phi i32 [ %.pre559.i, %..thread401_crit_edge.i ], [ %i.bqb, %bb.hp ]
  %.20.i = phi ptr [ %i.bqg, %..thread401_crit_edge.i ], [ %.0217484.i, %bb.hp ] ; 2 uses
  store i32 %.pre-phi577.i, ptr %i.asd, align 8, !tbaa !71
...
bb.ht:                                            ; preds = %bb.hs, %.thread401.i, %bb.hr, %.thread398.i, %bb.ho, %bb.hl, %bb.hj, %.thread396.i, %bb.hc, %bb.ha, %bb.gy, %bb.gv, %bb.gs, %bb.gq, %.thread391.i, %bb.gn, %.thread388.i, %bb.gl, %bb.gi, %bb.gg, %.thread386.i, %bb.ga, %bb.fy, %bb.fw, %.thread384.i, %bb.fq, %bb.fo
  %.21.i = phi ptr [ %.0217484.i, %bb.hs ], [ %.0217484.i, %bb.hr ], [ %.0217484.i, %.thread384.i ], [ %.0217484.i, %bb.gi ], [ %.8.i, %.thread388.i ], [ %.0217484.i, %bb.gl ], [ %.0217484.i, %.thread386.i ], [ %.0217484.i, %bb.gs ], [ %.13.i, %bb.gy ], [ %.0217484.i, %bb.gv ], [ %.0217484.i, %.thread391.i ], [ %.18.i, %.thread398.i ], [ %.0217484.i, %bb.ho ], [ %.20.i, %.thread401.i ], [ %.0217484.i, %bb.fo ], [ %.0217484.i, %bb.fq ], [ %.2219.i, %bb.fw ], [ %.0217484.i, %bb.fy ], [ %.0217484.i, %bb.ga ], [ %.5.i, %bb.gg ], [ %.0217484.i, %bb.gn ], [ %.10.i, %bb.gq ], [ %.0217484.i, %bb.ha ], [ %.0217484.i, %bb.hc ], [ %.0217484.i, %.thread396.i ], [ %.15.i, %bb.hj ], [ %.15.i, %bb.hl ] ; 2 uses
...
.critedge.i:                                      ; preds = %bb.ht, %bb.fl
  %.0217.lcssa.i = phi ptr [ %i.bfc, %bb.fl ], [ %.21.i, %bb.ht ] ; 2 uses
...
.critedge.thread.i:                               ; preds = %.lr.ph486.i, %bb.hu, %.critedge.i
  %.0217444.i = phi ptr [ %.0217.lcssa.i, %.critedge.i ], [ %.0217.lcssa.i, %bb.hu ], [ %.0217484.i, %.lr.ph486.i ]
...
bb.hw:                                            ; preds = %bb.hv, %.critedge.thread.i
  %.22.i = phi ptr [ %.0217444.i, %.critedge.thread.i ], [ %i.bqq, %bb.hv ] ; 4 uses
...
bb.ia:                                            ; preds = %bb.hy
  ...
  %i.bre = select i1 %.0223.i, ptr @.str.531, ptr @.str.532 ; 2 uses
...
ea06.exit:                                        ; preds = %bb.de, %bb.dh, %bb.dj, %bb.dr, %bb.ds, %bb.du, %._crit_edge578.i, %bb.ei, %bb.ik, %bb.il, %bb.dd, %bb.dg, %bb.eb, %bb.ek, %bb.et, %bb.fk, %bb.hx, %bb.hz, %bb.ie, %bb.ih, %bb.ii
  %.2.i = phi i32 [ 10, %bb.ih ], [ 0, %bb.dg ], [ 1, %bb.ii ], [ 13, %bb.ie ], [ 14, %bb.hz ], [ 9, %bb.hx ], [ 0, %bb.eb ], [ 0, %bb.ek ], [ 20, %bb.et ], [ 20, %bb.fk ], [ %i.ars, %bb.dd ], [ 10, %bb.ik ], [ 0, %bb.dh ], [ 0, %bb.dj ], [ 0, %bb.ds ], [ 0, %bb.du ], [ 0, %._crit_edge578.i ], [ 20, %bb.ei ], [ 0, %bb.dr ], [ 0, %bb.de ], [ %i.brp, %bb.il ]
...
bb.in:                                            ; preds = %bb.dc, %ea06.exit, %bb.im, %ea05.exit
  %.020.a = phi i32 [ 0, %bb.im ], [ %.0117537543554.i, %ea05.exit ], [ 0, %bb.dc ], [ %.2.i, %ea06.exit ]
...
bb.iq:                                            ; preds = %bb.b, %bb.a, %bb.ip, %bb.d
  %.0 = phi i32 [ 18, %bb.d ], [ %.020.a, %bb.ip ], [ 12, %bb.a ], [ 18, %bb.b ]
  ret i32 %.0
}
...
bb.e:                                             ; preds = %.lr.ph, %MT_getnext.exit
  ...
  %.018 = phi ptr [ %0, %.lr.ph ], [ %i.ee, %MT_getnext.exit ] ; 3 uses
