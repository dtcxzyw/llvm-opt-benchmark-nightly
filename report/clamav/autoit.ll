...
getbits.exit205.i:                                ; preds = %bb.az, %.preheader601.1.i, %.preheader601.1.thread.i
  ...
  %.sroa.125.sroa.0.0.insert.ext333.1.i = zext i16 %.sroa.125.sroa.0.11.1.i to i32
  ...
  %.sroa.125.sroa.0.0.extract.trunc336.1.i = trunc i32 %i.rn to i16 ; 2 uses
...
.preheader600.1.thread.i:                         ; preds = %.preheader600.preheader.i
  ...
  %.sroa.125.sroa.0.14.tr876.i = trunc i32 %i.sg to i16
  %.sroa.125.sroa.0.0.extract.trunc340877.i = shl i16 %.sroa.125.sroa.0.14.tr876.i, 1
  br label %.preheader600.2.i

.preheader600.1.i:                                ; preds = %.preheader600.preheader.i
  %.sroa.125.sroa.0.0.extract.trunc340.i = shl i16 %.sroa.125.sroa.0.0.extract.trunc336.1.i, 1 ; 2 uses
...
bb.bb:                                            ; preds = %.preheader600.1.i
  ...
  %5 = zext i8 %i.sp to i16
  %6 = or disjoint i16 %4, %5
  %7 = or i16 %6, %.sroa.125.sroa.0.0.extract.trunc340.i
  br label %.preheader600.2.i
...
.preheader600.2.i:                                ; preds = %bb.bb, %.preheader600.1.i, %.preheader600.1.thread.i
  ...
  %.sroa.125.sroa.0.14.1.i = phi i16 [ %7, %bb.bb ], [ %.sroa.125.sroa.0.0.extract.trunc340.i, %.preheader600.1.i ], [ %.sroa.125.sroa.0.0.extract.trunc340877.i, %.preheader600.1.thread.i ]
  %i.sq = phi i32 [ 16, %bb.bb ], [ %i.sh, %.preheader600.1.i ], [ 15, %.preheader600.1.thread.i ]
  %.sroa.125.sroa.0.0.insert.ext337.1.i = zext i16 %.sroa.125.sroa.0.14.1.i to i32
  %i.sr = shl nuw nsw i32 %.sroa.125.sroa.0.14878.i, 2
  %i.ss = and i32 %i.sr, 131072
  %.sroa.125.sroa.0.0.insert.ext337.1.i.a = shl nuw nsw i32 %.sroa.125.sroa.0.0.insert.ext337.1.i, 1 ; 3 uses
  %i.st = or disjoint i32 %.sroa.125.sroa.0.0.insert.ext337.1.i.a, %i.ss
...
getbits.exit210.i:                                ; preds = %bb.bc, %.preheader600.2.i
  ...
  %i.tl = or disjoint i32 %i.tk, %8               ; 2 uses
...
.preheader598.7.i:                                ; preds = %bb.bl, %.preheader598.6.i, %.preheader598.6.thread.i
  ...
  %.sroa.125.sroa.0.0.insert.ext345.6.i = shl nuw nsw i32 %.sroa.125.sroa.0.20.6.i, 1 ; 3 uses
...
getbits.exit220.i:                                ; preds = %bb.bm, %.preheader598.7.i
  ...
  %.sroa.125.sroa.0.0.insert.ext345.7.i = shl nuw nsw i32 %.sroa.125.sroa.0.20.7.i, 1 ; 2 uses
