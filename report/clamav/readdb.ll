...
bb.x:                                             ; preds = %bb.w
  ...
  store ptr %i.bo, ptr %i.bh, align 8, !tbaa !150
...
bb.bk:                                            ; preds = %bb.bi
  ...
  store ptr %i.yw, ptr %i.yx, align 8, !tbaa !152
...
.lr.ph488:                                        ; preds = %.preheader371
  ...
  %i.za = load ptr, ptr %.0281, align 8, !tbaa !153
...
._crit_edge489.thread:                            ; preds = %bb.bm, %._crit_edge489
  ...
  %i.zh = load ptr, ptr %.0281, align 8, !tbaa !153
  %i.zi = add i32 %i.yy, 1
  ...
  store ptr %i.zl, ptr %.0281, align 8, !tbaa !153
...
bb.bn:                                            ; preds = %._crit_edge489.thread
  ...
  %i.zp = load ptr, ptr %.0281, align 8, !tbaa !153
...
.lr.ph497:                                        ; preds = %bb.bp
  ...
  %i.zw = load ptr, ptr %i.x, align 8, !tbaa !153
...
._crit_edge498.thread:                            ; preds = %bb.br, %._crit_edge498
  ...
  %i.aad = load ptr, ptr %i.x, align 8, !tbaa !153
  ...
  store ptr %i.aah, ptr %i.x, align 8, !tbaa !153
...
bb.bs:                                            ; preds = %._crit_edge498.thread
  ...
  %i.aal = load ptr, ptr %i.x, align 8, !tbaa !153
