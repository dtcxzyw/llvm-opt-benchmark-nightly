...
bb.j:                                             ; preds = %bb.i
  ...
  %i.by = add nuw nsw i16 %i.bq, %i.br
  %i.bz = add nuw nsw i16 %i.bu, %i.bv
  %i.ca = add nuw nsw i16 %i.bx, %i.bw
  %i.cb = insertelement <4 x i16> <i16 poison, i16 poison, i16 poison, i16 1>, i16 %i.by, i64 0
  %i.cc = insertelement <4 x i16> %i.cb, i16 %i.bz, i64 1
  %i.cd = insertelement <4 x i16> %i.cc, i16 %i.ca, i64 2
