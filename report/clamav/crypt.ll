...
bb.b:                                             ; preds = %bb.c
  ...
  %4 = zext nneg i32 %i.aa to i64
  %i.ab = lshr i32 %i.f, 16
  %i.ac = lshr i32 %i.f, 8
  %i.ad = lshr i32 %i.a, 24
  %5 = zext nneg i32 %i.ad to i64
  ...
  %i.bd = getelementptr inbounds nuw [4 x i8], ptr %i.an, i64 %5
  %i.be = load i32, ptr %i.bd, align 4, !tbaa !16
  ...
  %i.bv = getelementptr inbounds nuw [4 x i8], ptr %i.an, i64 %4
  %i.bw = load i32, ptr %i.bv, align 4, !tbaa !16
  ...
  %i.cn = getelementptr inbounds nuw [4 x i8], ptr %i.an, i64 %3
  %i.co = load i32, ptr %i.cn, align 4, !tbaa !16
  ...
  %i.df = getelementptr inbounds nuw [4 x i8], ptr %i.an, i64 %2
