Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/clamav/original/msdoc?download=true
inline.NumInlined: 8
inline.NumDeleted: 5
...
bb.di:                                            ; preds = %bb.dh
  ...
  %i.hn = load i32, ptr %i.ao, align 8, !tbaa !27
  %i.ho = or i32 %i.hn, 512
  store i32 %i.ho, ptr %i.ao, align 8, !tbaa !27
...
bb.dk:                                            ; preds = %bb.dj
  %i.hs = load i32, ptr %i.ao, align 8, !tbaa !27
  %i.ht = or i32 %i.hs, 2
  store i32 %i.ht, ptr %i.ao, align 8, !tbaa !27
  br label %.thread
...
bb.do:                                            ; preds = %bb.dn
  ...
  %i.id = load ptr, ptr %i.aq, align 8, !tbaa !24
...
bb.dr:                                            ; preds = %bb.dq, %bb.dm
  ...
  %i.if = load ptr, ptr %i.aq, align 8, !tbaa !24
...
bb.dv:                                            ; preds = %bb.dt
  %i.iu = load ptr, ptr %i.aq, align 8, !tbaa !24
...
bb.dw:                                            ; preds = %bb.ds
  %i.iy = load i32, ptr %i.ao, align 8, !tbaa !27
  %i.iz = or i32 %i.iy, 2
  store i32 %i.iz, ptr %i.ao, align 8, !tbaa !27
  br label %.thread
...
bb.dx:                                            ; preds = %bb.bm
  ...
  %i.jc = load i32, ptr %i.ao, align 8, !tbaa !27
  %i.jd = or i32 %i.jc, 256
  store i32 %i.jd, ptr %i.ao, align 8, !tbaa !27
  br label %ole2_process_property.exit.thread83
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.i = load i16, ptr %i.h, align 8, !tbaa !25
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.l = load i16, ptr %i.h, align 8, !tbaa !25
...
.lr.phthread-pre-split:                           ; preds = %.lr.ph205
  %i.q = add nuw nsw i64 %.086138203, 1           ; 2 uses
...
.preheader126:                                    ; preds = %bb.p
  %i.ak = load i16, ptr %i.h, align 8, !tbaa !25  ; 5 uses
  br label %bb.q
...
bb.q:                                             ; preds = %bb.w, %.preheader126
  ...
  %i.am = load i16, ptr %i.al, align 16, !tbaa !51 ; 2 uses
...
bb.t:                                             ; preds = %bb.r, %bb.s
  ...
  %i.at = load i16, ptr %i.as, align 16, !tbaa !51 ; 2 uses
...
bb.y:                                             ; preds = %bb.x
  ...
  store i32 %i.bc, ptr %i.ba, align 8, !tbaa !27
...
bb.aa:                                            ; preds = %bb.z
  ...
  store i32 %i.bn, ptr %i.bl, align 8, !tbaa !27
...
.loopexit.sink.split:                             ; preds = %bb.ad, %bb.ag, %bb.aj, %bb.ac, %bb.af, %bb.ai
  ...
  %i.cy = load i32, ptr %i.cx, align 8, !tbaa !27
  %i.cz = or i32 %i.cy, %.sink198
  store i32 %i.cz, ptr %i.cx, align 8, !tbaa !27
  br label %.loopexit
...
bb.ak:                                            ; preds = %.loopexit
  ...
  %i.dg = load i32, ptr %i.df, align 8, !tbaa !27
  %i.dh = or i32 %i.dg, 8192
  store i32 %i.dh, ptr %i.df, align 8, !tbaa !27
  br label %bb.al
...
!10 = !{!"p1 _ZTS11cli_ctx_tag", !9, i64 0}
!11 = !{!"p1 _ZTS7cl_fmap", !9, i64 0}
!12 = !{!"p1 _ZTS11json_object", !9, i64 0}
!13 = !{!"long", !5, i64 0}
!14 = !{!"short", !5, i64 0}
!15 = !{!"p1 omnipotent char", !9, i64 0}
!16 = !{!"summary_ctx", !10, i64 0, !6, i64 8, !11, i64 16, !12, i64 24, !13, i64 32, !6, i64 40, !6, i64 44, !14, i64 48, !6, i64 52, !15, i64 56, !6, i64 64}
!17 = !{!16, !10, i64 0}
!18 = !{!16, !6, i64 8}
!19 = !{!16, !11, i64 16}
!20 = !{!"_Bool", !5, i64 0}
!21 = !{!"p1 long", !9, i64 0}
!22 = !{!"cl_fmap", !9, i64 0, !9, i64 8, !9, i64 16, !13, i64 24, !13, i64 32, !13, i64 40, !13, i64 48, !20, i64 56, !20, i64 57, !20, i64 58, !13, i64 64, !13, i64 72, !13, i64 80, !13, i64 88, !9, i64 96, !9, i64 104, !9, i64 112, !9, i64 120, !9, i64 128, !9, i64 136, !9, i64 144, !5, i64 152, !5, i64 155, !5, i64 158, !21, i64 256, !15, i64 264, !15, i64 272}
!23 = !{!16, !13, i64 32}
!24 = !{!16, !12, i64 24}
!25 = !{!16, !14, i64 48}
!26 = !{!16, !6, i64 52}
!27 = !{!16, !6, i64 40}
!28 = !{!22, !9, i64 104}
!29 = !{!"timespec", !13, i64 0, !13, i64 8}
!30 = !{!"stat", !13, i64 0, !13, i64 8, !13, i64 16, !6, i64 24, !6, i64 28, !6, i64 32, !6, i64 36, !13, i64 40, !13, i64 48, !13, i64 56, !13, i64 64, !29, i64 72, !29, i64 88, !29, i64 104, !5, i64 120}
!31 = !{!30, !13, i64 48}
!32 = !{!22, !13, i64 88}
!33 = !{!"p1 _ZTS11cli_matcher", !9, i64 0}
!34 = !{!"p1 _ZTS9cl_engine", !9, i64 0}
!35 = !{!"p1 _ZTS15cl_scan_options", !9, i64 0}
!36 = !{!"p1 _ZTS14cli_scan_layer", !9, i64 0}
!37 = !{!"p1 _ZTS9cli_dconf", !9, i64 0}
!38 = !{!"p1 _ZTS10bitset_tag", !9, i64 0}
!39 = !{!"p1 _ZTS10cli_events", !9, i64 0}
!40 = !{!"timeval", !13, i64 0, !13, i64 8}
!41 = !{!"cli_ctx_tag", !15, i64 0, !15, i64 8, !21, i64 16, !33, i64 24, !34, i64 32, !13, i64 40, !35, i64 48, !6, i64 56, !6, i64 60, !36, i64 64, !6, i64 72, !6, i64 76, !9, i64 80, !11, i64 88, !13, i64 96, !37, i64 104, !38, i64 112, !9, i64 120, !39, i64 128, !12, i64 136, !12, i64 144, !40, i64 152, !20, i64 168, !20, i64 169}
!42 = !{!41, !12, i64 144}
!43 = distinct !{null}
!44 = !{!22, !9, i64 96}
!45 = !{!16, !15, i64 56}
...
!48 = !{!15, !15, i64 0}
!49 = !{!13, !13, i64 0}
!50 = !{!"codepage_entry", !14, i64 0, !15, i64 8}
!51 = !{!50, !14, i64 0}
!52 = !{!50, !15, i64 8}
!53 = !{!6, !6, i64 0}
end_hunk_0
