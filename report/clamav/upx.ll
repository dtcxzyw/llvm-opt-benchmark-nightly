...
bb.f:                                             ; preds = %._crit_edge.thread, %._crit_edge
  ...
  %.lcssa501640 = phi i32 [ %i.m, %._crit_edge.thread ], [ %.lcssa501, %._crit_edge ] ; 5 uses
...
.loopexit:                                        ; preds = %.loopexit.loopexit577, %bb.j
  ...
  %i.cd = phi i32 [ %i.s, %.loopexit.loopexit577 ], [ %.lcssa501640, %bb.j ] ; 9 uses
...
.preheader:                                       ; preds = %.preheader.preheader, %bb.u
  %.1281.pn = phi ptr [ %.2282, %bb.u ], [ %.1281511, %.preheader.preheader ] ; 2 uses
  %.2282 = getelementptr inbounds nuw i8, ptr %.1281.pn, i64 1 ; 3 uses
  br i1 %.not374, label %.critedge12, label %bb.t
...
.critedge12:                                      ; preds = %bb.t, %.preheader, %bb.u
...
.critedge:                                        ; preds = %.lr.ph528, %.critedge10, %bb.q, %.lr.ph521
  ...
  br i1 %or.cond480, label %checkpe.exit, label %bb.v
...
checkpe.exit:                                     ; preds = %.critedge.thread, %.critedge, %bb.v, %bb.w, %bb.x, %bb.y, %bb.z, %bb.aa
  ...
  %.6450 = phi i32 [ %i.cd, %.critedge.thread ], [ %i.cd, %bb.x ], [ 0, %bb.y ], [ %i.ef, %bb.z ], [ %i.ef, %bb.aa ], [ %i.cd, %bb.w ], [ %i.cd, %bb.v ], [ %i.cd, %.critedge ]
  %.5442 = phi i32 [ %.0, %.critedge.thread ], [ 0, %bb.x ], [ %i.eb, %bb.y ], [ %i.eb, %bb.z ], [ %i.eb, %bb.aa ], [ %.0, %bb.w ], [ %.0, %bb.v ], [ %.0, %.critedge ]
...
.thread452:                                       ; preds = %bb.k, %bb.h, %._crit_edge, %bb.g, %bb.f, %checkpe.exit, %bb.o, %bb.m, %bb.l, %.loopexit
  %.1445 = phi i32 [ %i.cd, %bb.l ], [ %.6450, %checkpe.exit ], [ %i.cd, %bb.o ], [ %i.cd, %bb.m ], [ %i.cd, %.loopexit ], [ %.lcssa501640, %bb.f ], [ %.lcssa501640, %bb.g ], [ %.lcssa501, %._crit_edge ], [ %.lcssa501640, %bb.h ], [ %.lcssa501640, %bb.k ] ; 3 uses
  ...
  br i1 %or.cond14, label %.lr.ph541, label %bb.ah
...
.lr.ph541.split.preheader:                        ; preds = %.lr.ph541
  ...
  %i.fa = sub i64 0, %i.ez
  %scevgep594 = getelementptr i8, ptr %2, i64 %i.fa
  br label %checkpe.exit428

.lr.ph541.split.us:                               ; preds = %.lr.ph541.split.us.preheader, %bb.ag
  %.4284539.us = phi ptr [ %i.fs, %bb.ag ], [ %i.ew, %.lr.ph541.split.us.preheader ] ; 7 uses
  %.2538.us = phi i32 [ %.6443.ph.us, %bb.ag ], [ %.1, %.lr.ph541.split.us.preheader ] ; 2 uses
  %.2446537.us = phi i32 [ %.7451.ph.us, %bb.ag ], [ %.1445, %.lr.ph541.split.us.preheader ] ; 3 uses
...
bb.ag:                                            ; preds = %bb.af, %bb.ae, %bb.ad, %bb.ac, %bb.ab, %.lr.ph541.split.us
  %.7451.ph.us = phi i32 [ %.2446537.us, %.lr.ph541.split.us ], [ %.2446537.us, %bb.ab ], [ %i.fl, %bb.af ], [ %i.fl, %bb.ae ], [ 0, %bb.ad ], [ %.2446537.us, %bb.ac ] ; 2 uses
  %.6443.ph.us = phi i32 [ %.2538.us, %.lr.ph541.split.us ], [ %.2538.us, %bb.ab ], [ %i.fh, %bb.af ], [ %i.fh, %bb.ae ], [ %i.fh, %bb.ad ], [ 0, %bb.ac ] ; 2 uses
...
checkpe.exit428:                                  ; preds = %bb.ag, %bb.af, %.lr.ph541.split.preheader
  %.4284.lcssa = phi ptr [ %scevgep594, %.lr.ph541.split.preheader ], [ %.4284539.us, %bb.af ], [ %i.fs, %bb.ag ] ; 2 uses
  %.3447 = phi i32 [ %.1445, %.lr.ph541.split.preheader ], [ %i.fl, %bb.af ], [ %.7451.ph.us, %bb.ag ]
  %.3440 = phi i32 [ %.1, %.lr.ph541.split.preheader ], [ %i.fh, %bb.af ], [ %.6443.ph.us, %bb.ag ]
  %.2276 = phi ptr [ null, %.lr.ph541.split.preheader ], [ %i.fi, %bb.af ], [ null, %bb.ag ]
  %i.fu = ptrtoint ptr %.4284.lcssa to i64
  %i.fv = sub i64 %i.fu, %i.eu
  %i.fw = trunc i64 %i.fv to i32                  ; 2 uses
  %.not378 = icmp eq i32 %i.fw, 0
  br i1 %.not378, label %.thread462, label %bb.ah

bb.ah:                                            ; preds = %checkpe.exit428, %.thread452
  ...
  br i1 %.not379, label %.thread462, label %bb.ak

.thread462:                                       ; preds = %checkpe.exit428, %bb.ah
  %i.fx = and i32 %8, 4095
