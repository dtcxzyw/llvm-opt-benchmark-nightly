...
.lr.ph127:                                        ; preds = %.lr.ph127.preheader, %_ZN7RSCoder6gfMultEii.exit86
  ...
  %.066125 = phi i32 [ 0, %.lr.ph127.preheader ], [ %i.ea, %_ZN7RSCoder6gfMultEii.exit86 ] ; 2 uses
...
._crit_edge140:                                   ; preds = %_ZN7RSCoder6gfMultEii.exit91, %bb.l
  %.062.lcssa = phi i32 [ 0, %bb.l ], [ %i.hz, %_ZN7RSCoder6gfMultEii.exit91 ] ; 2 uses
  %i.hc = xor i32 %i.gy, -1
...
.lr.ph139:                                        ; preds = %.lr.ph139.preheader, %_ZN7RSCoder6gfMultEii.exit91
  ...
  %.062136 = phi i32 [ 0, %.lr.ph139.preheader ], [ %i.hz, %_ZN7RSCoder6gfMultEii.exit91 ] ; 2 uses
...
._crit_edge105.thread:                            ; preds = %.preheader96.lr.ph, %bb.a, %._crit_edge105, %.loopexit
  %.075 = phi i1 [ %i.jg, %.loopexit ], [ true, %._crit_edge105 ], [ true, %bb.a ], [ true, %.preheader96.lr.ph ]
