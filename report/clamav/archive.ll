...
bb.c:                                             ; preds = %bb.a
  ...
  %.not68 = icmp eq i32 %i.p, 7
  br i1 %.not68, label %bb.d, label %bb.ck
...
bb.l:                                             ; preds = %bb.k
  ...
  switch i8 %i.ao, label %bb.n [
    i8 0, label %_ZN7Archive11IsSignatureEPKhm.exit.thread96
    i8 1, label %bb.m
  ]

bb.m:                                             ; preds = %bb.l
  br label %_ZN7Archive11IsSignatureEPKhm.exit.thread96

bb.n:                                             ; preds = %bb.l
  %i.ap = icmp ult i8 %i.ao, 5
  br i1 %i.ap, label %_ZN7Archive11IsSignatureEPKhm.exit.thread96, label %.thread

_ZN7Archive11IsSignatureEPKhm.exit.thread96:      ; preds = %bb.m, %bb.l, %bb.n
...
.lr.ph:                                           ; preds = %.preheader
  ...
  %wide.trip.count137 = zext nneg i32 %i.bi to i64 ; 4 uses
...
.lr.ph.split.preheader:                           ; preds = %.lr.ph
  ...
  br i1 %i.bt, label %bb.r, label %.lr.ph.split.preheader169
...
bb.r:                                             ; preds = %.lr.ph.split.preheader
  ...
  switch i8 %i.bv, label %.lr.ph.split.preheader169 [
    i8 69, label %bb.z
    i8 97, label %bb.s
  ]
...
bb.y:                                             ; preds = %bb.w
  ...
  br i1 %i.ck, label %.split.sink.split, label %.lr.ph.split.preheader169

bb.z:                                             ; preds = %bb.r
  %i.cl = getelementptr inbounds nuw i8, ptr %malloc.i, i64 2
  %i.cm = load i8, ptr %i.cl, align 1, !tbaa !115
  %i.cn = icmp eq i8 %i.cm, 126
  br i1 %i.cn, label %bb.aa, label %.lr.ph.split.preheader169

bb.aa:                                            ; preds = %bb.z
  %i.co = getelementptr inbounds nuw i8, ptr %malloc.i, i64 3
  %i.cp = load i8, ptr %i.co, align 1, !tbaa !115
  %i.cq = icmp eq i8 %i.cp, 94
  br i1 %i.cq, label %.split.sink.split, label %.lr.ph.split.preheader169

.lr.ph.split.preheader169:                        ; preds = %bb.r, %.lr.ph.split.preheader, %bb.s, %bb.t, %bb.u, %bb.v, %bb.y, %bb.z, %bb.aa
  br label %.lr.ph.split

.lr.ph.split.us:                                  ; preds = %.lr.ph, %_ZN7Archive11IsSignatureEPKhm.exit84.thread.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %_ZN7Archive11IsSignatureEPKhm.exit84.thread.us ], [ 0, %.lr.ph ] ; 7 uses
  ...
  br i1 %i.ct, label %bb.ab, label %_ZN7Archive11IsSignatureEPKhm.exit84.thread.us

bb.ab:                                            ; preds = %.lr.ph.split.us
  %4 = sub nuw nsw i64 %wide.trip.count137, %indvars.iv ; 2 uses
  %i.cu = icmp samesign ult i64 %4, 4
  br i1 %i.cu, label %_ZN7Archive11IsSignatureEPKhm.exit84.thread.us, label %bb.ac
...
.lr.ph.split:                                     ; preds = %.lr.ph.split.preheader169, %_ZN7Archive11IsSignatureEPKhm.exit84.thread
  %indvars.iv134 = phi i64 [ %indvars.iv.next135, %_ZN7Archive11IsSignatureEPKhm.exit84.thread ], [ 1, %.lr.ph.split.preheader169 ] ; 7 uses
  %i.dw = getelementptr inbounds nuw i8, ptr %malloc.i, i64 %indvars.iv134 ; 9 uses
  %i.dx = load i8, ptr %i.dw, align 1, !tbaa !115
  %i.dy = icmp eq i8 %i.dx, 82
  br i1 %i.dy, label %bb.an, label %_ZN7Archive11IsSignatureEPKhm.exit84.thread

bb.an:                                            ; preds = %.lr.ph.split
  %5 = sub nuw nsw i64 %wide.trip.count137, %indvars.iv134 ; 2 uses
  %i.dz = icmp samesign ult i64 %5, 4
  br i1 %i.dz, label %_ZN7Archive11IsSignatureEPKhm.exit84.thread, label %bb.ao
...
bb.ap:                                            ; preds = %bb.ao
  ...
  br i1 %i.ef, label %bb.aq, label %_ZN7Archive11IsSignatureEPKhm.exit84.thread

bb.aq:                                            ; preds = %bb.ap
  %i.eg = getelementptr inbounds nuw i8, ptr %i.dw, i64 3
  %i.eh = load i8, ptr %i.eg, align 1, !tbaa !115
  %i.ei = icmp eq i8 %i.eh, 94
  br i1 %i.ei, label %bb.ay, label %_ZN7Archive11IsSignatureEPKhm.exit84.thread

bb.ar:                                            ; preds = %bb.ao
  %i.ej = icmp samesign ugt i64 %5, 6
  %i.ek = icmp eq i8 %i.eb, 97
  %or.cond19.i = and i1 %i.ej, %i.ek
  br i1 %or.cond19.i, label %bb.as, label %_ZN7Archive11IsSignatureEPKhm.exit84.thread

bb.as:                                            ; preds = %bb.ar
  %i.el = getelementptr inbounds nuw i8, ptr %i.dw, i64 2
  %i.em = load i8, ptr %i.el, align 1, !tbaa !115
  %i.en = icmp eq i8 %i.em, 114
  br i1 %i.en, label %bb.at, label %_ZN7Archive11IsSignatureEPKhm.exit84.thread

bb.at:                                            ; preds = %bb.as
  %i.eo = getelementptr inbounds nuw i8, ptr %i.dw, i64 3
  %i.ep = load i8, ptr %i.eo, align 1, !tbaa !115
  %i.eq = icmp eq i8 %i.ep, 33
  br i1 %i.eq, label %bb.au, label %_ZN7Archive11IsSignatureEPKhm.exit84.thread

bb.au:                                            ; preds = %bb.at
  %i.er = getelementptr inbounds nuw i8, ptr %i.dw, i64 4
  %i.es = load i8, ptr %i.er, align 1, !tbaa !115
  %i.et = icmp eq i8 %i.es, 26
  br i1 %i.et, label %bb.av, label %_ZN7Archive11IsSignatureEPKhm.exit84.thread

bb.av:                                            ; preds = %bb.au
  %i.eu = getelementptr inbounds nuw i8, ptr %i.dw, i64 5
  %i.ev = load i8, ptr %i.eu, align 1, !tbaa !115
  %i.ew = icmp eq i8 %i.ev, 7
  br i1 %i.ew, label %bb.aw, label %_ZN7Archive11IsSignatureEPKhm.exit84.thread

bb.aw:                                            ; preds = %bb.av
  %i.ex = getelementptr inbounds nuw i8, ptr %i.dw, i64 6
  %i.ey = load i8, ptr %i.ex, align 1, !tbaa !115 ; 2 uses
  switch i8 %i.ey, label %bb.ax [
    i8 0, label %.split.sink.split.loopexit170
    i8 1, label %.split.sink.split
  ]

bb.ax:                                            ; preds = %bb.aw
  %i.ez = icmp ult i8 %i.ey, 5
  br i1 %i.ez, label %.split.sink.split, label %_ZN7Archive11IsSignatureEPKhm.exit84.thread

bb.ay:                                            ; preds = %bb.aq
  store i32 1, ptr %i.bk, align 8, !tbaa !62
  %i.fa = load i8, ptr %i.bo, align 1, !tbaa !115
  %.not71 = icmp eq i8 %i.fa, 82
  br i1 %.not71, label %bb.az, label %_ZN7Archive11IsSignatureEPKhm.exit84.thread

bb.az:                                            ; preds = %bb.ay
  %i.fb = load i8, ptr %i.bp, align 1, !tbaa !115
  %.not72 = icmp eq i8 %i.fb, 83
  br i1 %.not72, label %bb.ba, label %_ZN7Archive11IsSignatureEPKhm.exit84.thread

bb.ba:                                            ; preds = %bb.az
  %i.fc = load i8, ptr %i.bq, align 1, !tbaa !115
  %.not73 = icmp eq i8 %i.fc, 70
  br i1 %.not73, label %bb.bb, label %_ZN7Archive11IsSignatureEPKhm.exit84.thread

bb.bb:                                            ; preds = %bb.ba
  %i.fd = load i8, ptr %i.br, align 1, !tbaa !115
  %.not74 = icmp eq i8 %i.fd, 88
  br i1 %.not74, label %.split, label %_ZN7Archive11IsSignatureEPKhm.exit84.thread
...
.split.sink.split.loopexit170:                    ; preds = %bb.aw
  br label %.split.sink.split

.split.sink.split.loopexit174:                    ; preds = %bb.ai
  br label %.split.sink.split

.split.sink.split:                                ; preds = %bb.aj, %bb.al, %bb.ax, %bb.ai, %bb.aw, %.split.sink.split.loopexit174, %.split.sink.split.loopexit170, %bb.w, %bb.x, %bb.y, %bb.aa
  %.0.i82.peel.sink = phi i32 [ 4, %bb.y ], [ 2, %.split.sink.split.loopexit170 ], [ 2, %bb.w ], [ 1, %bb.aa ], [ 3, %bb.x ], [ 3, %bb.aw ], [ 3, %bb.ai ], [ 4, %bb.ax ], [ 1, %bb.al ], [ 4, %bb.aj ], [ 2, %.split.sink.split.loopexit174 ]
  %.us-phi.ph = phi i64 [ 0, %bb.y ], [ %indvars.iv134, %.split.sink.split.loopexit170 ], [ 0, %bb.w ], [ 0, %bb.aa ], [ 0, %bb.x ], [ %indvars.iv134, %bb.aw ], [ %indvars.iv, %bb.ai ], [ %indvars.iv134, %bb.ax ], [ %indvars.iv, %bb.al ], [ %indvars.iv, %bb.aj ], [ %indvars.iv, %.split.sink.split.loopexit174 ]
  store i32 %.0.i82.peel.sink, ptr %i.bk, align 8, !tbaa !62
  br label %.split

.split:                                           ; preds = %bb.bb, %.split.sink.split
  %.us-phi = phi i64 [ %.us-phi.ph, %.split.sink.split ], [ %indvars.iv134, %bb.bb ]
...
_ZN7Archive11IsSignatureEPKhm.exit84.thread:      ; preds = %bb.an, %bb.az, %bb.ba, %bb.bb, %bb.ay, %bb.ap, %bb.aq, %bb.ar, %bb.as, %bb.at, %bb.au, %bb.av, %bb.ax, %.lr.ph.split
  %indvars.iv.next135 = add nuw nsw i64 %indvars.iv134, 1 ; 2 uses
  %exitcond138.not = icmp eq i64 %indvars.iv.next135, %wide.trip.count137
  br i1 %exitcond138.not, label %_ZN5ArrayIcED2Ev.exit, label %.lr.ph.split, !llvm.loop !154

_ZN5ArrayIcED2Ev.exit:                            ; preds = %_ZN7Archive11IsSignatureEPKhm.exit84.thread.us, %_ZN7Archive11IsSignatureEPKhm.exit84.thread, %.preheader, %bb.bd, %bb.be
  %i.fp = load i64, ptr %i.q, align 8, !tbaa !63
  %.not77 = icmp eq i64 %i.fp, 0
  tail call void @free(ptr noundef nonnull %malloc.i) #18
  br i1 %.not77, label %bb.ck, label %bb.bg

bb.bf:                                            ; preds = %_ZN5ArrayIcEC2Em.exit
  %i.fq = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  br i1 %i.ba, label %_ZN5ArrayIcED2Ev.exit87, label %.thread109

.thread109:                                       ; preds = %bb.bc, %bb.am, %bb.bf
  %.pn.pn111 = phi { ptr, i32 } [ %i.fq, %bb.bf ], [ %i.dv, %bb.am ], [ %i.fe, %bb.bc ]
  tail call void @free(ptr noundef nonnull %malloc.i) #18
  br label %_ZN5ArrayIcED2Ev.exit87

_ZN5ArrayIcED2Ev.exit87:                          ; preds = %bb.bf, %.thread109
  %.pn.pn112 = phi { ptr, i32 } [ %i.fq, %bb.bf ], [ %.pn.pn111, %.thread109 ]
  resume { ptr, i32 } %.pn.pn112

bb.bg:                                            ; preds = %_ZN7Archive11IsSignatureEPKhm.exit.thread96, %_ZN5ArrayIcED2Ev.exit, %bb.o
...
bb.bi:                                            ; preds = %bb.bg
  ...
  %.not78 = icmp eq i32 %i.gf, 1
  br i1 %.not78, label %bb.bj, label %bb.ck

bb.bj:                                            ; preds = %bb.bi
  %i.gg = load i8, ptr %i.gb, align 1, !tbaa !115
  %.not79 = icmp eq i8 %i.gg, 0
  br i1 %.not79, label %bb.bk, label %bb.ck
...
bb.bn:                                            ; preds = %bb.bp, %bb.bm
  ...
  %.not80 = icmp eq i64 %i.gr, 0                  ; 3 uses
  br i1 %.not80, label %.thread113, label %bb.bo
