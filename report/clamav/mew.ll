...
bb.k:                                             ; preds = %bb.j
  %i.am = load i32, ptr %i.x, align 4, !tbaa !12
  %i.an = shl i32 %i.am, 8
  store i32 %i.an, ptr %i.x, align 4, !tbaa !12
  ...
  store ptr %i.aq, ptr %0, align 8, !tbaa !14
  br label %bb.l
...
bb.q:                                             ; preds = %bb.p
  ...
  br i1 %.not285.us.peel, label %.split399.us, label %bb.r
...
bb.r:                                             ; preds = %bb.q
  ...
  store i32 %5, ptr %i.ay, align 4, !tbaa !26
  %i.bi = getelementptr inbounds nuw i8, ptr %i.ay, i64 36
  %i.bj = getelementptr inbounds nuw i8, ptr %i.ay, i64 44
  store i32 %i.bg, ptr %i.bj, align 4, !tbaa !25
  %i.bk = add i32 %i.bg, %5
  store i32 %i.bk, ptr %i.bi, align 4, !tbaa !26
  %i.bl = getelementptr inbounds nuw i8, ptr %i.ay, i64 4
  store i32 %i.bg, ptr %i.bl, align 4, !tbaa !27
  %i.bm = getelementptr inbounds nuw i8, ptr %i.ay, i64 12
  store i32 %i.bg, ptr %i.bm, align 4, !tbaa !28
  %i.bn = icmp ugt i32 %i.bg, %3
  br i1 %i.bn, label %.split402.us, label %bb.s
...
.outer.us:                                        ; preds = %bb.s, %bb.ad
  %indvars.iv = phi i64 [ %indvars.iv.next, %bb.ad ], [ 1, %bb.s ] ; 6 uses
  %.pn271.ph.us = phi i32 [ %i.cn, %bb.ad ], [ %i.aw, %bb.s ]
  %.0235.ph.us = phi i32 [ %i.cm, %bb.ad ], [ %i.av, %bb.s ] ; 4 uses
  %.0234.ph.us = phi ptr [ %i.cj, %bb.ad ], [ %i.as, %bb.s ] ; 4 uses
  %.0230.ph.us = phi ptr [ %i.dd, %bb.ad ], [ %i.ay, %bb.s ] ; 8 uses
  ...
  br i1 %or.cond295.not.us.us, label %bb.t, label %bb.ai

bb.t:                                             ; preds = %.outer.us
  %i.bt = ptrtoint ptr %.0234.ph.us to i64        ; 3 uses
  %.not274.us.us = icmp ult ptr %.0234.ph.us, %0
  br i1 %.not274.us.us, label %bb.ai, label %bb.u

bb.u:                                             ; preds = %bb.t
  %i.bu = add i64 %i.bt, %i.br                    ; 2 uses
  %.not275.us.us = icmp ule i64 %i.bu, %i.o
  %i.bv = icmp ugt i64 %i.bu, %i.j
  %or.cond296.us.us = and i1 %.not275.us.us, %i.bv
  br i1 %or.cond296.us.us, label %bb.v, label %bb.ai

bb.v:                                             ; preds = %bb.u
  %i.bw = icmp ule i64 %i.o, %i.bt
  %i.bx = icmp ule i32 %i.d, %.pn.us.us
  %or.cond297.us.us = or i1 %i.bx, %i.bw
  br i1 %or.cond297.us.us, label %bb.ai, label %bb.w

bb.w:                                             ; preds = %bb.v
  %i.by = zext i32 %.0236.us.us to i64
  %i.bz = ptrtoint ptr %.0233.us.us to i64        ; 2 uses
  %i.ca = add i64 %i.bz, %i.by                    ; 2 uses
  %.not278.us.us = icmp ule i64 %i.ca, %i.o
  %i.cb = icmp ugt i64 %i.ca, %i.j
  %or.cond298.us.us = and i1 %.not278.us.us, %i.cb
  %i.cc = icmp ugt i64 %i.o, %i.bz
  %or.cond299.us.us = and i1 %i.cc, %or.cond298.us.us
  br i1 %or.cond299.us.us, label %bb.x, label %bb.ai

bb.x:                                             ; preds = %bb.w
  %i.cd = call i32 @unmew(ptr noundef nonnull %.0234.ph.us, ptr noundef %.0233.us.us, i32 noundef %.0235.ph.us, i32 noundef %.0236.us.us, ptr noundef nonnull %i.a, ptr noundef nonnull %i.b) #7
  %.not280.us.us = icmp eq i32 %i.cd, 0
  br i1 %.not280.us.us, label %bb.y, label %.split344.us

bb.y:                                             ; preds = %bb.x
  %i.ce = load ptr, ptr %i.a, align 8, !tbaa !16  ; 4 uses
  %.not281.us.us = icmp ult ptr %i.ce, %0
  br i1 %.not281.us.us, label %.split347.us, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.cf = ptrtoint ptr %i.ce to i64               ; 2 uses
  %i.cg = add i64 %i.cf, 4                        ; 2 uses
  %.not282.us.us = icmp ule i64 %i.cg, %i.o
  %i.ch = icmp ugt i64 %i.cg, %i.j
  %or.cond300.us.us = and i1 %.not282.us.us, %i.ch
  %i.ci = icmp ugt i64 %i.o, %i.cf
  %or.cond301.us.us = and i1 %i.ci, %or.cond300.us.us
  br i1 %or.cond301.us.us, label %bb.aa, label %.split347.us

bb.aa:                                            ; preds = %bb.z
  %i.cj = getelementptr inbounds nuw i8, ptr %i.ce, i64 4 ; 2 uses
  %i.ck = ptrtoint ptr %i.cj to i64
  %.neg.us.us = sub i64 %i.bt, %i.ck
  %i.cl = trunc i64 %.neg.us.us to i32
  %i.cm = add i32 %.0235.ph.us, %i.cl
  %i.cn = load i32, ptr %i.ce, align 1, !tbaa !8
  %i.co = load ptr, ptr %i.b, align 8, !tbaa !16
  %i.cp = ptrtoint ptr %i.co to i64
  %i.cq = sub i64 %i.cp, %i.j                     ; 2 uses
  %i.cr = sdiv i64 %i.cq, 4096
  %i.cs = and i64 %i.cq, 4095
  %i.ct = icmp ne i64 %i.cs, 0
  %i.cu = zext i1 %i.ct to i64
  %i.cv = add nsw i64 %i.cr, %i.cu
  %.tr.us = trunc i64 %i.cv to i32
  %i.cw = shl i32 %.tr.us, 12                     ; 6 uses
  %i.cx = getelementptr inbounds nuw [36 x i8], ptr %.0230.ph.us, i64 %indvars.iv
  %i.cy = getelementptr inbounds nuw i8, ptr %i.cx, i64 8
  %i.cz = load i32, ptr %i.cy, align 4, !tbaa !25
  %i.da = icmp ult i32 %i.cw, %i.cz
  br i1 %i.da, label %.split396.us, label %bb.ab

bb.ab:                                            ; preds = %bb.aa
  %i.db = mul nuw i64 %indvars.iv, 36
  %i.dc = add nuw i64 %i.db, 72
  %i.dd = call ptr @cli_max_realloc(ptr noundef nonnull %.0230.ph.us, i64 noundef %i.dc) #7 ; 7 uses
  %.not285.us = icmp eq ptr %i.dd, null
  br i1 %.not285.us, label %.split399.us, label %bb.ac

bb.ac:                                            ; preds = %bb.ab
  %i.de = getelementptr inbounds nuw i8, ptr %i.dd, i64 8
  store i32 0, ptr %i.de, align 4, !tbaa !25
  store i32 %5, ptr %i.dd, align 4, !tbaa !26
  %i.df = getelementptr inbounds nuw [36 x i8], ptr %i.dd, i64 %indvars.iv ; 5 uses
  %i.dg = getelementptr inbounds nuw i8, ptr %i.df, i64 36
  %i.dh = getelementptr inbounds nuw i8, ptr %i.df, i64 44
  store i32 %i.cw, ptr %i.dh, align 4, !tbaa !25
  %i.di = add i32 %i.cw, %5
  store i32 %i.di, ptr %i.dg, align 4, !tbaa !26
  %i.dj = getelementptr inbounds nuw i8, ptr %i.df, i64 8
  %i.dk = load i32, ptr %i.dj, align 4, !tbaa !25 ; 2 uses
  %i.dl = sub i32 %i.cw, %i.dk                    ; 2 uses
  %i.dm = getelementptr inbounds nuw i8, ptr %i.df, i64 4
  store i32 %i.dl, ptr %i.dm, align 4, !tbaa !27
  %i.dn = getelementptr inbounds nuw i8, ptr %i.df, i64 12
  store i32 %i.dl, ptr %i.dn, align 4, !tbaa !28
  %i.do = icmp ugt i32 %i.cw, %3
  br i1 %i.do, label %.split402.us.loopexit, label %bb.ad

bb.ad:                                            ; preds = %bb.ac
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.dp = load ptr, ptr %i.a, align 8, !tbaa !16
  %i.dq = load i32, ptr %i.dp, align 1, !tbaa !8
  %.not286.us = icmp eq i32 %i.dq, 0
  br i1 %.not286.us, label %.loopexit.loopexit.loopexit, label %.outer.us, !llvm.loop !23
...
bb.ai:                                            ; preds = %.outer.us, %bb.t, %bb.u, %bb.v, %bb.w
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.9) #7
...
.split344.us:                                     ; preds = %bb.aj, %bb.x, %bb.n
  %.us-phi345 = phi ptr [ %.0230.ph.us, %bb.x ], [ null, %bb.n ], [ null, %bb.aj ]
...
.split347.us:                                     ; preds = %bb.ak, %bb.al, %bb.z, %bb.y, %bb.o, %bb.p
  %.us-phi348 = phi ptr [ %.0230.ph.us, %bb.z ], [ null, %bb.o ], [ null, %bb.p ], [ %.0230.ph.us, %bb.y ], [ null, %bb.al ], [ null, %bb.ak ]
...
.split396.us:                                     ; preds = %bb.aa
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.10) #7
  call void @free(ptr noundef nonnull %.0230.ph.us) #7
  br label %.critedge

.split399.us:                                     ; preds = %bb.ab, %bb.q
  %.0230.ph.us.lcssa415 = phi ptr [ null, %bb.q ], [ %.0230.ph.us, %bb.ab ]
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.11) #7
  call void @free(ptr noundef %.0230.ph.us.lcssa415) #7
  br label %.critedge

.split402.us.loopexit:                            ; preds = %bb.ac
  %i.ep = trunc nuw nsw i64 %indvars.iv to i32
  br label %.split402.us

.split402.us:                                     ; preds = %bb.r, %.split402.us.loopexit
  %.lcssa428 = phi i32 [ %i.dk, %.split402.us.loopexit ], [ 0, %bb.r ]
  %.lcssa426 = phi i32 [ %i.cw, %.split402.us.loopexit ], [ %i.bg, %bb.r ]
  %.lcssa424 = phi ptr [ %i.dd, %.split402.us.loopexit ], [ %i.ay, %bb.r ]
  %.0231.ph.us.lcssa422.wide = phi i32 [ %i.ep, %.split402.us.loopexit ], [ 0, %bb.r ]
...
bb.av:                                            ; preds = %bb.at
  store i32 %5, ptr %i.fl, align 4, !tbaa !26
  %i.fm = getelementptr inbounds nuw i8, ptr %i.fl, i64 4
  store i32 %3, ptr %i.fm, align 4, !tbaa !27
  %i.fn = getelementptr inbounds nuw i8, ptr %i.fl, i64 12
  store i32 %3, ptr %i.fn, align 4, !tbaa !28
  br label %.loopexit

.loopexit.loopexit.loopexit:                      ; preds = %bb.ad
...
.loopexit:                                        ; preds = %bb.s, %.loopexit.loopexit.loopexit, %bb.av
  ...
  %.3 = phi ptr [ %i.fl, %bb.av ], [ %i.ay, %bb.s ], [ %i.dd, %.loopexit.loopexit.loopexit ] ; 3 uses
  %i.fp = sub i32 %i.w, %4
