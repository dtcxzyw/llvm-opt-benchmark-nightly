...
.split.us:                                        ; preds = %bb.c, %fmap_readn.exit.us
  %.044.us = phi i32 [ %i.al, %fmap_readn.exit.us ], [ %i.m, %bb.c ] ; 3 uses
...
.split.split.us:                                  ; preds = %.split, %cli_memmem.exit.us
  %.044.us72 = phi i32 [ %i.be, %cli_memmem.exit.us ], [ %i.m, %.split ] ; 4 uses
  %i.an = zext i32 %.044.us72 to i64              ; 6 uses
...
bb.k:                                             ; preds = %bb.j, %.split.split.us
  %.0.us73 = phi i64 [ %i.ar, %bb.j ], [ 4096, %.split.split.us ] ; 2 uses
  %i.as = load i64, ptr %i.s, align 8, !tbaa !39  ; 3 uses
  %i.at = icmp ne i64 %i.as, %i.an
  %i.au = icmp ne i64 %.0.us73, 0
  %or.cond.i.us74 = and i1 %i.au, %i.at
  br i1 %or.cond.i.us74, label %bb.l, label %fmap_readn.exit.us77
...
bb.m:                                             ; preds = %bb.l
  ...
  br i1 %.not.i.us76, label %.thread, label %bb.n
...
cli_memmem.exit.us:                               ; preds = %fmap_readn.exit.us77
  ...
  %i.bd = call ptr @memchr(ptr noundef nonnull %i.a, i32 noundef %i.bc, i64 noundef %.020.i.us78) #28 ; 2 uses
  %.not.us = icmp eq ptr %i.bd, null
  %i.be = add i32 %.044.us72, %i.ba
...
.split.split:                                     ; preds = %.split.split.preheader, %cli_memmem.exit.thread.loopexit
  %.044 = phi i32 [ %i.ch, %cli_memmem.exit.thread.loopexit ], [ %i.m, %.split.split.preheader ] ; 4 uses
  %i.bf = zext i32 %.044 to i64                   ; 6 uses
  %i.bg = add nuw nsw i64 %i.bf, 4096
  %i.bh = icmp samesign ugt i64 %i.bg, %i.n
  br i1 %i.bh, label %bb.o, label %bb.q

bb.o:                                             ; preds = %.split.split
  %i.bi = icmp ugt i32 %.044, %3
...
bb.u:                                             ; preds = %bb.w, %.preheader.i
  %.02537.i = phi i32 [ %i.bs, %.preheader.i ], [ %i.cb, %bb.w ] ; 2 uses
  %.02636.i = phi ptr [ %i.a, %.preheader.i ], [ %i.bx, %bb.w ] ; 2 uses
  %.reass.i.reass.reass = add i32 %.02537.i, %invariant.op
  %i.bv = zext i32 %.reass.i.reass.reass to i64
  %i.bw = call ptr @memchr(ptr noundef nonnull %.02636.i, i32 noundef %i.bu, i64 noundef %i.bv) #28 ; 3 uses
...
bb.v:                                             ; preds = %bb.u
  ...
  br i1 %.not33.i, label %cli_memmem.exit.thread60, label %bb.w

bb.w:                                             ; preds = %bb.v
  %i.by = ptrtoint ptr %.02636.i to i64
  %i.bz = ptrtoint ptr %i.bx to i64
  %.neg.i = sub i64 %i.by, %i.bz
  %i.ca = trunc i64 %.neg.i to i32
  %i.cb = add i32 %.02537.i, %i.ca                ; 2 uses
  %.not31.i = icmp ult i32 %i.cb, %2
  br i1 %.not31.i, label %cli_memmem.exit.thread.loopexit, label %bb.u

cli_memmem.exit.thread60:                         ; preds = %bb.v, %cli_memmem.exit.us
  %.04471 = phi i32 [ %.044.us72, %cli_memmem.exit.us ], [ %.044, %bb.v ]
  %.0.i63 = phi ptr [ %i.bd, %cli_memmem.exit.us ], [ %i.bw, %bb.v ]
  %i.cc = ptrtoint ptr %.0.i63 to i64
  %i.cd = ptrtoint ptr %i.a to i64
  %i.ce = sub i64 %i.cc, %i.cd
  %i.cf = trunc i64 %i.ce to i32
  %i.cg = add i32 %.04471, %i.cf
  br label %.thread

cli_memmem.exit.thread.loopexit:                  ; preds = %bb.u, %bb.w
  %i.ch = add i32 %.044, %i.bs
  br label %.split.split

.thread:                                          ; preds = %bb.s, %bb.r, %fmap_readn.exit, %bb.o, %bb.i, %bb.l, %bb.m, %fmap_readn.exit.us77, %fmap_readn.exit.us, %bb.h, %bb.g, %bb.d, %cli_memmem.exit.thread60, %bb.b
  %.2 = phi i32 [ -1, %bb.b ], [ %i.cg, %cli_memmem.exit.thread60 ], [ -1, %fmap_readn.exit.us ], [ -1, %bb.i ], [ -1, %bb.d ], [ -1, %bb.g ], [ -1, %bb.h ], [ -1, %fmap_readn.exit.us77 ], [ -1, %bb.m ], [ -1, %bb.l ], [ -1, %bb.o ], [ -1, %fmap_readn.exit ], [ -1, %bb.r ], [ -1, %bb.s ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #27
  ret i32 %.2
}
