...
.lr.ph1508:                                       ; preds = %bb.fu
  ...
  br i1 %i.sd, label %.split1510, label %.lr.ph1508.split.a

.lr.ph1508.split.a:                               ; preds = %.lr.ph1508, %bb.fv
  %indvars.iv = phi i64 [ %indvars.iv.next, %bb.fv ], [ 0, %.lr.ph1508 ] ; 2 uses
  %.19901506 = phi ptr [ %i.ss, %bb.fv ], [ %i.sc, %.lr.ph1508 ] ; 6 uses
...
.split1510:                                       ; preds = %.lr.ph1508.split.a, %.lr.ph1508
...
._crit_edge:                                      ; preds = %bb.fv, %bb.fu
  %.1990.lcssa = phi ptr [ %i.sc, %bb.fu ], [ %i.ss, %bb.fv ] ; 2 uses
  %i.st = icmp ult i32 %1, 40
  br i1 %i.st, label %bb.fx, label %bb.fw
