...
bb.c:                                             ; preds = %.split
  ...
  %i.v = ptrtoint ptr %.01060 to i64              ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ab = load i32, ptr %.01060, align 1, !tbaa !11
  %i.ac = sub i32 %i.aa, %i.ab                    ; 2 uses
  %i.ad = getelementptr inbounds nuw i8, ptr %.01060, i64 8
  %i.ae = load i32, ptr %i.ad, align 1, !tbaa !11 ; 2 uses
  %i.af = shl nsw i32 %i.ae, 2                    ; 4 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %.01060, i64 12
  %i.ah = load i32, ptr %i.ag, align 1, !tbaa !11 ; 3 uses
  %i.ai = getelementptr inbounds nuw i8, ptr %.01060, i64 16
  ...
  br i1 %or.cond1511, label %.split1503, label %bb.e
...
.lr.ph1491:                                       ; preds = %.lr.ph1491.preheader, %.loopexit
  %.29481490 = phi i32 [ %.40986, %.loopexit ], [ %i.bd, %.lr.ph1491.preheader ] ; 2 uses
  %.09881489 = phi i8 [ %.231011, %.loopexit ], [ 32, %.lr.ph1491.preheader ]
  %.010121488 = phi ptr [ %.61018, %.loopexit ], [ %i.ap, %.lr.ph1491.preheader ] ; 18 uses
  %.110201487 = phi ptr [ %.401059, %.loopexit ], [ %i.be, %.lr.ph1491.preheader ] ; 6 uses
  %i.bf = shl i32 %.29481490, 1                   ; 2 uses
  %i.bg = add i8 %.09881489, -1                   ; 2 uses
  %.not1247 = icmp eq i8 %i.bg, 0
  br i1 %.not1247, label %bb.h, label %bb.l

bb.h:                                             ; preds = %.lr.ph1491
  %.not1248 = icmp ult ptr %.110201487, %i.ax
  br i1 %.not1248, label %bb.k, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.bh = ptrtoint ptr %.110201487 to i64         ; 2 uses
...
bb.j:                                             ; preds = %bb.i
  %i.bl = load i32, ptr %.110201487, align 1, !tbaa !11
  %i.bm = getelementptr inbounds nuw i8, ptr %.110201487, i64 4
  br label %bb.l
...
bb.l:                                             ; preds = %bb.j, %bb.k, %.lr.ph1491
  %.31022 = phi ptr [ %.110201487, %.lr.ph1491 ], [ %i.bm, %bb.j ], [ %.110201487, %bb.k ] ; 15 uses
  %.1989 = phi i8 [ %i.bg, %.lr.ph1491 ], [ 32, %bb.j ], [ 32, %bb.k ] ; 3 uses
  %.4950 = phi i32 [ %i.bf, %.lr.ph1491 ], [ %i.bl, %bb.j ], [ %i.bf, %bb.k ] ; 6 uses
  %.4 = phi i32 [ 0, %.lr.ph1491 ], [ 0, %bb.j ], [ 1, %bb.k ] ; 4 uses
  %.not1250 = icmp sgt i32 %.29481490, -1
  br i1 %.not1250, label %bb.m, label %bb.p

bb.m:                                             ; preds = %bb.l
  %i.bn = ptrtoint ptr %.31022 to i64
  %i.bo = sub i64 %i.bn, %i.ay
  %i.bp = icmp sge i64 %i.bo, %i.al
  %.not1251 = icmp ult ptr %.010121488, %0
  %or.cond1449 = select i1 %i.bp, i1 true, i1 %.not1251
  br i1 %or.cond1449, label %.critedge.sink.split, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.bq = ptrtoint ptr %.010121488 to i64         ; 2 uses
...
bb.o:                                             ; preds = %bb.n
  %i.bu = getelementptr inbounds nuw i8, ptr %.31022, i64 1
  %i.bv = load i8, ptr %.31022, align 1, !tbaa !11
  %i.bw = getelementptr inbounds nuw i8, ptr %.010121488, i64 1
  store i8 %i.bv, ptr %.010121488, align 1, !tbaa !11
  br label %.loopexit

bb.p:                                             ; preds = %bb.l
  %i.bx = lshr i32 %.4950, 30                     ; 6 uses
  %i.by = icmp ugt i8 %.1989, 1
  br i1 %i.by, label %bb.q, label %bb.v

bb.q:                                             ; preds = %bb.p
  %i.bz = add i8 %.1989, -2                       ; 2 uses
  %i.ca = shl i32 %.4950, 2                       ; 2 uses
  %.not1255 = icmp eq i8 %i.bz, 0
  br i1 %.not1255, label %bb.r, label %bb.y

bb.r:                                             ; preds = %bb.q
  %.not1256 = icmp ult ptr %.31022, %i.ax
  br i1 %.not1256, label %bb.u, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.cb = ptrtoint ptr %.31022 to i64             ; 2 uses
...
bb.t:                                             ; preds = %bb.s
  %i.cf = load i32, ptr %.31022, align 1, !tbaa !11
  %i.cg = getelementptr inbounds nuw i8, ptr %.31022, i64 4
  br label %bb.y
...
bb.v:                                             ; preds = %bb.p
  %.not1253 = icmp ult ptr %.31022, %i.ax
  br i1 %.not1253, label %.thread1564, label %bb.w

bb.w:                                             ; preds = %bb.v
  %i.ch = ptrtoint ptr %.31022 to i64             ; 2 uses
  ...
  br i1 %or.cond1360, label %bb.x, label %.thread1564

bb.x:                                             ; preds = %bb.w
  %i.cl = load i32, ptr %.31022, align 1, !tbaa !11 ; 2 uses
  %i.cm = getelementptr inbounds nuw i8, ptr %.31022, i64 4
...
bb.y:                                             ; preds = %bb.t, %bb.u, %bb.x, %bb.q
  %.61025 = phi ptr [ %.31022, %bb.q ], [ %.31022, %bb.u ], [ %i.cm, %bb.x ], [ %i.cg, %bb.t ] ; 14 uses
end_hunk_0
begin_hunk_1_@wwunpack:bb.a
  %i.ov = getelementptr i8, ptr %.010121488, i64 %n.vec1629 ; 2 uses
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index1630 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next1633, %vec.epilog.vector.body ] ; 2 uses
  %next.gep1631 = getelementptr i8, ptr %.010121488, i64 %index1630 ; 2 uses
  %i.ow = getelementptr inbounds i8, ptr %next.gep1631, i64 %i.oe
  %wide.load1632 = load <4 x i8>, ptr %i.ow, align 1, !tbaa !11
  store <4 x i8> %wide.load1632, ptr %next.gep1631, align 1, !tbaa !11
  %index.next1633 = add nuw i64 %index1630, 4     ; 2 uses
  %i.ox = icmp eq i64 %index.next1633, %n.vec1629
  br i1 %i.ox, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !16

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n1634 = icmp eq i64 %n.vec1629, %i.nx
  br i1 %cmp.n1634, label %.loopexit, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.19271486.ph = phi i32 [ %.0926, %iter.check ], [ %i.on, %vec.epilog.iter.check ], [ %i.ou, %vec.epilog.middle.block ] ; 4 uses
  %.410161485.ph = phi ptr [ %.010121488, %iter.check ], [ %i.oo, %vec.epilog.iter.check ], [ %i.ov, %vec.epilog.middle.block ] ; 2 uses
  %i.oy = add i32 %.19271486.ph, -1
  %xtraiter = and i32 %.19271486.ph, 7            ; 2 uses
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol

.lr.ph.prol:                                      ; preds = %.lr.ph.preheader, %.lr.ph.prol
  %.19271486.prol = phi i32 [ %i.oz, %.lr.ph.prol ], [ %.19271486.ph, %.lr.ph.preheader ]
  %.410161485.prol = phi ptr [ %i.pc, %.lr.ph.prol ], [ %.410161485.ph, %.lr.ph.preheader ] ; 3 uses
  %prol.iter = phi i32 [ %prol.iter.next, %.lr.ph.prol ], [ 0, %.lr.ph.preheader ]
  %i.oz = add i32 %.19271486.prol, -1             ; 2 uses
  %i.pa = getelementptr inbounds i8, ptr %.410161485.prol, i64 %i.oe
  %i.pb = load i8, ptr %i.pa, align 1, !tbaa !11
  store i8 %i.pb, ptr %.410161485.prol, align 1, !tbaa !11
  %i.pc = getelementptr inbounds nuw i8, ptr %.410161485.prol, i64 1 ; 3 uses
  %prol.iter.next = add i32 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol, !llvm.loop !17

.lr.ph.prol.loopexit:                             ; preds = %.lr.ph.prol, %.lr.ph.preheader
  %.lcssa1639.unr = phi ptr [ poison, %.lr.ph.preheader ], [ %i.pc, %.lr.ph.prol ]
  %.19271486.unr = phi i32 [ %.19271486.ph, %.lr.ph.preheader ], [ %i.oz, %.lr.ph.prol ]
  %.410161485.unr = phi ptr [ %.410161485.ph, %.lr.ph.preheader ], [ %i.pc, %.lr.ph.prol ]
  %i.pd = icmp ult i32 %i.oy, 7
  br i1 %i.pd, label %.loopexit, label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  %.19271486 = phi i32 [ %i.pz, %.lr.ph ], [ %.19271486.unr, %.lr.ph.prol.loopexit ]
  %.410161485 = phi ptr [ %i.qc, %.lr.ph ], [ %.410161485.unr, %.lr.ph.prol.loopexit ] ; 10 uses
  %i.pe = getelementptr inbounds i8, ptr %.410161485, i64 %i.oe
  %i.pf = load i8, ptr %i.pe, align 1, !tbaa !11
  store i8 %i.pf, ptr %.410161485, align 1, !tbaa !11
  %i.pg = getelementptr inbounds nuw i8, ptr %.410161485, i64 1 ; 2 uses
  ...
  %i.pj = getelementptr inbounds nuw i8, ptr %.410161485, i64 2 ; 2 uses
  ...
  %i.pm = getelementptr inbounds nuw i8, ptr %.410161485, i64 3 ; 2 uses
  ...
  %i.pp = getelementptr inbounds nuw i8, ptr %.410161485, i64 4 ; 2 uses
  ...
  %i.ps = getelementptr inbounds nuw i8, ptr %.410161485, i64 5 ; 2 uses
  ...
  %i.pv = getelementptr inbounds nuw i8, ptr %.410161485, i64 6 ; 2 uses
  ...
  %i.py = getelementptr inbounds nuw i8, ptr %.410161485, i64 7 ; 2 uses
  %i.pz = add i32 %.19271486, -8                  ; 2 uses
  ...
  %i.qc = getelementptr inbounds nuw i8, ptr %.410161485, i64 8 ; 2 uses
...
.loopexit:                                        ; preds = %.lr.ph.prol.loopexit, %.lr.ph, %middle.block, %vec.epilog.middle.block, %bb.av, %bb.o
  %.401059 = phi ptr [ %.101029, %bb.av ], [ %i.bu, %bb.o ], [ %.391058, %middle.block ], [ %.391058, %vec.epilog.middle.block ], [ %.391058, %.lr.ph ], [ %.391058, %.lr.ph.prol.loopexit ]
  %.61018 = phi ptr [ %i.fh, %bb.av ], [ %i.bw, %bb.o ], [ %i.oo, %middle.block ], [ %i.ov, %vec.epilog.middle.block ], [ %.lcssa1639.unr, %.lr.ph.prol.loopexit ], [ %i.qc, %.lr.ph ]
  %.231011 = phi i8 [ %.4992, %bb.av ], [ %.1989, %bb.o ], [ %.221010, %middle.block ], [ %.221010, %vec.epilog.middle.block ], [ %.221010, %.lr.ph ], [ %.221010, %.lr.ph.prol.loopexit ]
  %.40986 = phi i32 [ %.10956, %bb.av ], [ %.4950, %bb.o ], [ %.39985, %middle.block ], [ %.39985, %vec.epilog.middle.block ], [ %.39985, %.lr.ph ], [ %.39985, %.lr.ph.prol.loopexit ]
  %.44 = phi i32 [ 0, %bb.av ], [ %.4, %bb.o ], [ %.42, %middle.block ], [ %.42, %vec.epilog.middle.block ], [ %.42, %.lr.ph ], [ %.42, %.lr.ph.prol.loopexit ]
...
.critedge.sink.split:                             ; preds = %.loopexit, %bb.m, %bb.fk, %bb.n, %bb.fm, %bb.au, %bb.at, %bb.as, %bb.fl, %bb.ar, %bb.fj, %.critedge.sink.split.sink.split
  tail call void @free(ptr noundef %i.ax) #5
  br label %.critedge
...
bb.fo:                                            ; preds = %bb.fn
  %i.qe = getelementptr inbounds nuw i8, ptr %.01060, i64 17
...
bb.fx:                                            ; preds = %._crit_edge
  ...
  br i1 %or.cond1423, label %bb.fz, label %bb.fy

bb.fy:                                            ; preds = %bb.fx, %._crit_edge
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.8) #5
  br label %bb.ga

bb.fz:                                            ; preds = %bb.fx
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(40) %.11061.lcssa, i8 0, i64 40, i1 false)
...
bb.ga:                                            ; preds = %bb.fz, %.critedge, %bb.fy, %.split1510, %bb.ft, %bb.fq
  %.01062 = phi i32 [ 26, %.split1510 ], [ 26, %bb.fq ], [ 26, %bb.fy ], [ 26, %bb.ft ], [ 1, %.critedge ], [ %spec.select1424, %bb.fz ]
  ret i32 %.01062
}
