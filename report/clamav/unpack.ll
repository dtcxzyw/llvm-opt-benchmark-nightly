...
define noundef nonnull align 1 dereferenceable(1) ptr @_ZN16FragmentedWindowixEm(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(512) %0, i64 noundef %1) local_unnamed_addr #19 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 256 ; 2 uses
  %i.b = load i64, ptr %i.a, align 8, !tbaa !168
...
bb.d:                                             ; preds = %.preheader.30, %.preheader.29, %.preheader.28, %.preheader.27, %.preheader.26, %.preheader.25, %.preheader.24, %.preheader.23, %.preheader.22, %.preheader.21, %.preheader.20, %.preheader.19, %.preheader.18, %.preheader.17, %.preheader.16, %.preheader.15, %.preheader.14, %.preheader.13, %.preheader.12, %.preheader.11, %.preheader.10, %.preheader.9, %.preheader.8, %.preheader.7, %.preheader.6, %.preheader.5, %.preheader.4, %.preheader.3, %.preheader.2, %.preheader.1, %.preheader.preheader
  ...
  %i.cx = getelementptr [8 x i8], ptr %i.a, i64 %.lcssa
  %i.cy = getelementptr i8, ptr %i.cx, i64 -8
  %i.cz = load i64, ptr %i.cy, align 8, !tbaa !168
  %i.da = sub i64 %1, %i.cz
...
bb.n:                                             ; preds = %bb.n, %_ZN6Unpack14ReadFilterDataER8BitInput.exit
  ...
  %i.ca = load i32, ptr %1, align 8, !tbaa !125
  %i.cb = add i32 %i.bz, %i.ca
  store i32 %i.cb, ptr %1, align 8, !tbaa !125
  %i.cc = and i32 %i.bx, 7
end_hunk_0
