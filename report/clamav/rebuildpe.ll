...
bb.e:                                             ; preds = %.lr.ph, %bb.e
  ...
  %i.bl = mul nuw i64 %i.bk, %i.z                 ; 2 uses
  %9 = and i64 %i.bl, 511
  %.not220 = icmp eq i64 %9, 0
  %10 = select i1 %.not220, i64 0, i64 512
  %i.bm = add nuw i64 %10, %i.bl
...
bb.k:                                             ; preds = %bb.j, %.lr.ph233.split.us
  ...
  %i.dz = load i32, ptr %i.dm, align 4, !tbaa !10 ; 2 uses
  %11 = and i32 %i.dz, 511
  %.not208.us = icmp eq i32 %11, 0
  %12 = select i1 %.not208.us, i32 0, i32 512
  %i.ea = add i32 %12, %i.dz
  %i.eb = load i32, ptr %i.dh, align 4, !tbaa !20 ; 2 uses
  %13 = and i32 %i.eb, 4095
  %.not209.us = icmp eq i32 %13, 0
  %14 = select i1 %.not209.us, i32 0, i32 4096
  %i.ec = add i32 %14, %i.eb
...
.lr.ph233.split:                                  ; preds = %.lr.ph233, %bb.m
  ...
  %.1232 = phi i32 [ %.2.a, %bb.m ], [ %.0186, %.lr.ph233 ]
  %.1191230 = phi i32 [ %.2192, %bb.m ], [ %.0190, %.lr.ph233 ] ; 3 uses
  %.1194229 = phi ptr [ %20, %bb.m ], [ %.0193, %.lr.ph233 ] ; 7 uses
...
bb.m:                                             ; preds = %bb.l, %.lr.ph233.split
  ...
  %i.fz = mul i32 %i.fy, %8                       ; 2 uses
  %15 = and i32 %i.fz, 511
  %.not210 = icmp eq i32 %15, 0
  %16 = select i1 %.not210, i32 0, i32 512
  %17 = add i32 %16, %i.fz
  ...
  %i.gg = mul i32 %i.gf, %8                       ; 2 uses
  %18 = and i32 %i.gg, 4095
  %.not211 = icmp eq i32 %18, 0
  %19 = select i1 %.not211, i32 0, i32 4096
  %i.gh = add i32 %19, %i.gg
  %20 = getelementptr inbounds nuw i8, ptr %.1194229, i64 40
  %.pn212 = and i32 %i.gh, -4096
  %.2.a = add i32 %.pn212, %.1232                 ; 2 uses
  %.pn = and i32 %17, -512
...
._crit_edge:                                      ; preds = %bb.m, %bb.k, %bb.i
  ...
  %.1.lcssa = phi i32 [ %.0186, %bb.i ], [ %.2.us, %bb.k ], [ %.2.a, %bb.m ]
