...
inline.NumInlined: 6
begin_hunk_0_@_Z8LowAsciiPKc:bb.a
  br i1 %or.cond, label %bb.c, label %bb.b, !llvm.loop !23
...
bb.b:                                             ; preds = %bb.b, %bb.a
  ...
  %i.d = add i64 %.06, 1
  br i1 %or.cond, label %bb.c, label %bb.b, !llvm.loop !24
...
.lr.ph:                                           ; preds = %.preheader, %bb.b
  ...
  %i.c = load i32, ptr %.0514, align 4, !tbaa !14 ; 2 uses
...
.lr.ph.i:                                         ; preds = %.preheader.i, %bb.b
  ...
  %i.g = load i8, ptr %.0513.i, align 1, !tbaa !11 ; 2 uses
...
.lr.ph.i:                                         ; preds = %.preheader.i, %bb.b
  ...
  %i.g = load i32, ptr %.0514.i, align 4, !tbaa !14 ; 2 uses
  %.not11.i = icmp eq i32 %i.g, 0
  br i1 %.not11.i, label %.critedge.i, label %bb.b

bb.b:                                             ; preds = %.lr.ph.i
  %i.h = getelementptr inbounds nuw i8, ptr %.0514.i, i64 4
  %i.i = getelementptr inbounds nuw i8, ptr %.0613.i, i64 4 ; 2 uses
  store i32 %i.g, ptr %.0613.i, align 4, !tbaa !14
  %i.j = add i64 %i.f, -1                         ; 2 uses
  %.not10.i = icmp eq i64 %i.j, 0
  br i1 %.not10.i, label %.critedge.i, label %.lr.ph.i, !llvm.loop !1

.critedge.i:                                      ; preds = %bb.b, %.lr.ph.i, %.preheader.i
  %.06.lcssa.i = phi ptr [ %i.c, %.preheader.i ], [ %.0613.i, %.lr.ph.i ], [ %i.i, %bb.b ]
  store i32 0, ptr %.06.lcssa.i, align 4, !tbaa !14
  br label %_Z8wcsncpyzPwPKwm.exit

_Z8wcsncpyzPwPKwm.exit:                           ; preds = %.critedge.i, %bb.a
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(argmem: write) uwtable
define void @_Z4itoalPcm(i64 noundef %0, ptr nofree noundef writeonly captures(none) %1, i64 noundef %2) local_unnamed_addr #9 {
bb.a:
...
bb.b:                                             ; preds = %bb.c
  ...
  br i1 %exitcond.not, label %._crit_edge36, label %bb.c, !llvm.loop !25
...
bb.c:                                             ; preds = %.lr.ph35, %bb.b
  ...
  %i.h = trunc nuw nsw i64 %i.f to i8
  %i.i = or disjoint i8 %i.h, 48
  %i.j = getelementptr inbounds nuw i8, ptr %i.a, i64 %.02033
  store i8 %i.i, ptr %i.j, align 1, !tbaa !11
  %.not27 = icmp samesign ult i64 %.12232, 10
  br i1 %.not27, label %._crit_edge37, label %bb.b, !llvm.loop !25
...
bb.b:                                             ; preds = %bb.c
  ...
  br i1 %exitcond.not.i, label %._crit_edge29, label %bb.c, !llvm.loop !2

bb.c:                                             ; preds = %.lr.ph, %bb.b
  %.020.i26 = phi i64 [ 0, %.lr.ph ], [ %i.j, %bb.b ] ; 2 uses
  %.122.i25 = phi i64 [ %spec.select.i, %.lr.ph ], [ %i.l, %bb.b ] ; 3 uses
  ...
  br i1 %.not27.i, label %._crit_edge28, label %bb.b, !llvm.loop !2

._crit_edge28:                                    ; preds = %bb.c
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 3 uses
  %i.s = xor i64 %index, -1
  %i.t = getelementptr [4 x i8], ptr %i.r, i64 %i.s ; 2 uses
  %i.u = getelementptr i8, ptr %i.t, i64 -12
  %i.v = getelementptr i8, ptr %i.t, i64 -28
  %wide.load = load <4 x i32>, ptr %i.u, align 4, !tbaa !14
  %wide.load31 = load <4 x i32>, ptr %i.v, align 4, !tbaa !14
  %reverse = shufflevector <4 x i32> %wide.load, <4 x i32> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  ...
  store <4 x i32> %reverse, ptr %i.w, align 16, !tbaa !14
  store <4 x i32> %reverse32, ptr %i.x, align 16, !tbaa !14
  %index.next = add nuw i64 %index, 8             ; 2 uses
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %.028.i = phi i64 [ %i.ad, %scalar.ph ], [ %.028.i.ph, %scalar.ph.preheader ] ; 3 uses
  %i.z = xor i64 %.028.i, -1
  %i.aa = getelementptr [4 x i8], ptr %i.r, i64 %i.z
...
_Z4itoalPwm.exit:                                 ; preds = %scalar.ph, %middle.block
  ...
  %i.ah = icmp ugt i64 %2, 1
  %i.ai = and i1 %i.ag, %i.ah
  br i1 %i.ai, label %bb.e, label %._crit_edge

bb.e:                                             ; preds = %_Z4itoalPwm.exit
  %i.aj = call i64 @wcslen(ptr noundef nonnull %i.b) #14
  ...
  %i.ao = load i32, ptr %i.an, align 4, !tbaa !14 ; 2 uses
  %i.ap = icmp ne i32 %i.ao, 0
  %i.aq = icmp ugt i64 %2, 2
  %i.ar = and i1 %i.ap, %i.aq
  br i1 %i.ar, label %.peel.next, label %._crit_edge

.peel.next:                                       ; preds = %bb.e, %bb.g
  %indvars.iv = phi i64 [ %indvars.iv.next, %bb.g ], [ 1, %bb.e ] ; 2 uses
  %i.as = phi i32 [ %i.bg, %bb.g ], [ 2, %bb.e ]
  %i.at = phi i32 [ %i.be, %bb.g ], [ %i.ao, %bb.e ]
  %.015 = phi i32 [ %i.ba, %bb.g ], [ 1, %bb.e ]  ; 2 uses
  %i.au = trunc nuw i64 %indvars.iv to i32
  %i.av = add i32 %i.am, %i.au
  %i.aw = urem i32 %i.av, 3
  %i.ax = icmp eq i32 %i.aw, 0
  br i1 %i.ax, label %bb.f, label %bb.g

bb.f:                                             ; preds = %.peel.next
  %i.ay = zext i32 %.015 to i64
  %i.az = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.ay
  store i32 %spec.store.select, ptr %i.az, align 4, !tbaa !14
  br label %bb.g

bb.g:                                             ; preds = %bb.f, %.peel.next
  %.1 = phi i32 [ %i.as, %bb.f ], [ %.015, %.peel.next ] ; 3 uses
  %indvars.iv.next = add nuw i64 %indvars.iv, 1   ; 2 uses
  %i.ba = add i32 %.1, 1                          ; 2 uses
  %i.bb = zext i32 %.1 to i64
  %i.bc = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.bb
  store i32 %i.at, ptr %i.bc, align 4, !tbaa !14
  %i.bd = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %indvars.iv.next
  %i.be = load i32, ptr %i.bd, align 4, !tbaa !14 ; 2 uses
  %i.bf = icmp ne i32 %i.be, 0
  %i.bg = add i32 %.1, 2                          ; 2 uses
  %i.bh = zext i32 %i.bg to i64
  %i.bi = icmp ugt i64 %2, %i.bh
  %i.bj = and i1 %i.bf, %i.bi
  br i1 %i.bj, label %.peel.next, label %._crit_edge.loopexit.loopexit, !llvm.loop !34
...
._crit_edge:                                      ; preds = %bb.e, %._crit_edge.loopexit.loopexit, %_Z4itoalPwm.exit
  %.0.lcssa = phi i64 [ 0, %_Z4itoalPwm.exit ], [ 1, %bb.e ], [ %i.bk, %._crit_edge.loopexit.loopexit ]
  %i.bl = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %.0.lcssa
