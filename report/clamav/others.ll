...
bb.b:                                             ; preds = %bb.a
  ...
  store i32 1, ptr %i.a, align 8, !tbaa !140
...
bb.f:                                             ; preds = %bb.e
  ...
  store ptr %i.v, ptr %i.w, align 8, !tbaa !142
...
bb.g:                                             ; preds = %bb.f
  ...
  store ptr %i.x, ptr %i.y, align 8, !tbaa !143
...
bb.k:                                             ; preds = %bb.j
  ...
  store ptr %i.a, ptr %i.ae, align 8, !tbaa !144
  %i.af = getelementptr inbounds nuw i8, ptr %i.ab, i64 28
  store i32 50, ptr %i.af, align 4, !tbaa !145
  %i.ag = getelementptr inbounds nuw i8, ptr %i.ab, i64 32
  store i32 1048576, ptr %i.ag, align 8, !tbaa !146
...
bb.l:                                             ; preds = %bb.i, %bb.k
  ...
  store ptr null, ptr %i.aj, align 8, !tbaa !147
  ...
  store ptr @clamav_stats_flush, ptr %i.al, align 8, !tbaa !149
  %i.am = getelementptr inbounds nuw i8, ptr %i.a, i64 1144
  store ptr @clamav_stats_remove_sample, ptr %i.am, align 8, !tbaa !150
  %i.an = getelementptr inbounds nuw i8, ptr %i.a, i64 1152
  store ptr @clamav_stats_decrement_count, ptr %i.an, align 8, !tbaa !151
  %i.ao = getelementptr inbounds nuw i8, ptr %i.a, i64 1176
  store ptr @clamav_stats_get_num, ptr %i.ao, align 8, !tbaa !152
  %i.ap = getelementptr inbounds nuw i8, ptr %i.a, i64 1184
  store ptr @clamav_stats_get_size, ptr %i.ap, align 8, !tbaa !153
  %i.aq = getelementptr inbounds nuw i8, ptr %i.a, i64 1192
  store ptr @clamav_stats_get_hostid, ptr %i.aq, align 8, !tbaa !154
...
bb.a:
  %i.a = tail call noalias dereferenceable_or_null(384) ptr @malloc(i64 noundef 384) #24 ; 32 uses
  %.not = icmp eq ptr %i.a, null
...
bb.g:                                             ; preds = %bb.e, %bb.f
  ...
  %i.ax = load <2 x ptr>, ptr %i.aw, align 8, !tbaa !13
  %i.ay = insertelement <4 x ptr> poison, ptr %i.as, i64 0
  %i.az = insertelement <4 x ptr> %i.ay, ptr %i.av, i64 1
  %i.ba = shufflevector <2 x ptr> %i.ax, <2 x ptr> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.bb = shufflevector <4 x ptr> %i.az, <4 x ptr> %i.ba, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  store <4 x ptr> %i.bb, ptr %i.at, align 8, !tbaa !13
  %i.bc = getelementptr inbounds nuw i8, ptr %0, i64 368
  %i.bd = getelementptr inbounds nuw i8, ptr %i.a, i64 136
  %i.be = load <2 x ptr>, ptr %i.bc, align 8, !tbaa !13
  store <2 x ptr> %i.be, ptr %i.bd, align 8, !tbaa !13
  %i.bf = getelementptr inbounds nuw i8, ptr %0, i64 424
  %i.bg = getelementptr inbounds nuw i8, ptr %i.a, i64 192
  %i.bh = load <2 x ptr>, ptr %i.bf, align 8, !tbaa !13
  store <2 x ptr> %i.bh, ptr %i.bg, align 8, !tbaa !13
  %i.bi = getelementptr inbounds nuw i8, ptr %0, i64 440
  %i.bj = getelementptr inbounds nuw i8, ptr %i.a, i64 208
  %i.bk = load <2 x ptr>, ptr %i.bi, align 8, !tbaa !13
  store <2 x ptr> %i.bk, ptr %i.bj, align 8, !tbaa !13
  ...
  store ptr %i.bm, ptr %i.bn, align 8, !tbaa !156
  %i.bo = getelementptr inbounds nuw i8, ptr %0, i64 384
  %i.bp = getelementptr inbounds nuw i8, ptr %i.a, i64 160
  %i.bq = load <2 x ptr>, ptr %i.bo, align 8, !tbaa !13
  store <2 x ptr> %i.bq, ptr %i.bp, align 8, !tbaa !13
  %i.br = getelementptr inbounds nuw i8, ptr %0, i64 408
  %i.bs = getelementptr inbounds nuw i8, ptr %i.a, i64 176
  %i.bt = load <2 x ptr>, ptr %i.br, align 8, !tbaa !13
  store <2 x ptr> %i.bt, ptr %i.bs, align 8, !tbaa !13
  %i.bu = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.bv = load i64, ptr %i.bu, align 8, !tbaa !51
  %i.bw = getelementptr inbounds nuw i8, ptr %i.a, i64 88
  ...
  %i.bz = getelementptr inbounds nuw i8, ptr %i.a, i64 96
  store i32 %i.by, ptr %i.bz, align 8, !tbaa !88
  %i.ca = getelementptr inbounds nuw i8, ptr %0, i64 1136
  %i.cb = getelementptr inbounds nuw i8, ptr %i.a, i64 280
  %i.cc = load <2 x ptr>, ptr %i.ca, align 8, !tbaa !13
  store <2 x ptr> %i.cc, ptr %i.cb, align 8, !tbaa !13
  %i.cd = getelementptr inbounds nuw i8, ptr %0, i64 1152
  %i.ce = getelementptr inbounds nuw i8, ptr %i.a, i64 296
  %i.cf = load <2 x ptr>, ptr %i.cd, align 8, !tbaa !13
  store <2 x ptr> %i.cf, ptr %i.ce, align 8, !tbaa !13
  %i.cg = getelementptr inbounds nuw i8, ptr %0, i64 1168
  %i.ch = getelementptr inbounds nuw i8, ptr %i.a, i64 312
  %i.ci = load <2 x ptr>, ptr %i.cg, align 8, !tbaa !13
  store <2 x ptr> %i.ci, ptr %i.ch, align 8, !tbaa !13
  %i.cj = getelementptr inbounds nuw i8, ptr %0, i64 1184
  %i.ck = getelementptr inbounds nuw i8, ptr %i.a, i64 328
  %i.cl = load <2 x ptr>, ptr %i.cj, align 8, !tbaa !13
  store <2 x ptr> %i.cl, ptr %i.ck, align 8, !tbaa !13
  %i.cm = getelementptr inbounds nuw i8, ptr %0, i64 1200
  %i.cn = getelementptr inbounds nuw i8, ptr %i.a, i64 344
  %i.co = load <2 x i32>, ptr %i.cm, align 8, !tbaa !9
  store <2 x i32> %i.co, ptr %i.cn, align 8, !tbaa !9
  %i.cp = getelementptr inbounds nuw i8, ptr %0, i64 1208
  %i.cq = load i32, ptr %i.cp, align 8, !tbaa !60
  %i.cr = getelementptr inbounds nuw i8, ptr %i.a, i64 352
  store i32 %i.cq, ptr %i.cr, align 8, !tbaa !89
  %i.cs = getelementptr inbounds nuw i8, ptr %0, i64 1216
  %i.ct = getelementptr inbounds nuw i8, ptr %i.a, i64 360
  %i.cu = load <2 x i64>, ptr %i.cs, align 8, !tbaa !80
  store <2 x i64> %i.cu, ptr %i.ct, align 8, !tbaa !80
  %i.cv = getelementptr inbounds nuw i8, ptr %0, i64 1232
  %i.cw = load i64, ptr %i.cv, align 8, !tbaa !63
  %i.cx = getelementptr inbounds nuw i8, ptr %i.a, i64 376
  store i64 %i.cw, ptr %i.cx, align 8, !tbaa !90
  br label %bb.h
...
bb.a:
  ...
  %i.ah = load i64, ptr %i.ag, align 8, !tbaa !87
...
bb.k:                                             ; preds = %bb.i, %bb.j
  ...
  %i.bo = load ptr, ptr %i.bn, align 8, !tbaa !158
  %i.bp = getelementptr inbounds nuw i8, ptr %0, i64 376
  store ptr %i.bo, ptr %i.bp, align 8, !tbaa !91
  ...
  %i.cv = load i32, ptr %i.cu, align 8, !tbaa !89
  ...
  %i.db = load i64, ptr %i.da, align 8, !tbaa !90
