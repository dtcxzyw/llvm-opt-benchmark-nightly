...
.lr.ph:                                           ; preds = %bb.b, %bb.j
  %.1313663 = phi i32 [ %i.ay, %bb.j ], [ %.0312, %bb.b ] ; 3 uses
  %.1320662 = phi i32 [ %i.ax, %bb.j ], [ %.0319, %bb.b ]
  %.1333661 = phi ptr [ %.2334, %bb.j ], [ %.0332, %bb.b ] ; 2 uses
  %.1346660 = phi ptr [ %i.at, %bb.j ], [ %.0345, %bb.b ] ; 2 uses
  %.not418 = icmp ult ptr %.1346660, %.1333661
...
bb.j:                                             ; preds = %bb.i, %.lr.ph
  %.2347 = phi ptr [ %i.aq, %bb.i ], [ %.1346660, %.lr.ph ] ; 2 uses
  %.2334 = phi ptr [ %i.as, %bb.i ], [ %.1333661, %.lr.ph ] ; 2 uses
  %i.at = getelementptr inbounds nuw i8, ptr %.2347, i64 1 ; 2 uses
  %i.au = load i8, ptr %.2347, align 1, !tbaa !35
  %i.av = zext i8 %i.au to i32
  %i.aw = shl nuw nsw i32 %i.av, %.1313663
  %i.ax = or i32 %i.aw, %.1320662                 ; 2 uses
  %i.ay = add nsw i32 %.1313663, 8                ; 2 uses
  %i.az = icmp slt i32 %.1313663, -7
...
.lr.ph672:                                        ; preds = %._crit_edge, %bb.r
  %.2314670 = phi i32 [ %i.cb, %bb.r ], [ %i.bc, %._crit_edge ] ; 3 uses
  %.2321669 = phi i32 [ %i.ca, %bb.r ], [ %i.bb, %._crit_edge ]
  %.3335668 = phi ptr [ %.4336, %bb.r ], [ %.1333.lcssa, %._crit_edge ] ; 2 uses
  %.3348667 = phi ptr [ %i.bw, %bb.r ], [ %.1346.lcssa, %._crit_edge ] ; 2 uses
  %.not416 = icmp ult ptr %.3348667, %.3335668
...
bb.r:                                             ; preds = %bb.q, %.lr.ph672
  %.4349 = phi ptr [ %i.bt, %bb.q ], [ %.3348667, %.lr.ph672 ] ; 2 uses
  %.4336 = phi ptr [ %i.bv, %bb.q ], [ %.3335668, %.lr.ph672 ] ; 2 uses
  %i.bw = getelementptr inbounds nuw i8, ptr %.4349, i64 1 ; 2 uses
  %i.bx = load i8, ptr %.4349, align 1, !tbaa !35
  %i.by = zext i8 %i.bx to i32
  %i.bz = shl nuw nsw i32 %i.by, %.2314670
  %i.ca = or i32 %i.bz, %.2321669                 ; 2 uses
  %i.cb = add nuw nsw i32 %.2314670, 8            ; 2 uses
  %i.cc = icmp slt i32 %.2314670, -6
  br i1 %i.cc, label %.lr.ph672, label %._crit_edge673

._crit_edge673:                                   ; preds = %bb.r, %._crit_edge
  %.3348.lcssa = phi ptr [ %.1346.lcssa, %._crit_edge ], [ %i.bw, %bb.r ] ; 6 uses
  %.3335.lcssa = phi ptr [ %.1333.lcssa, %._crit_edge ], [ %.4336, %bb.r ] ; 6 uses
  %.2321.lcssa = phi i32 [ %i.bb, %._crit_edge ], [ %i.ca, %bb.r ] ; 2 uses
  %.2314.lcssa = phi i32 [ %i.bc, %._crit_edge ], [ %i.cb, %bb.r ] ; 2 uses
  %i.cd = and i32 %.2321.lcssa, 3
  %i.ce = lshr i32 %.2321.lcssa, 2                ; 5 uses
  %i.cf = add nsw i32 %.2314.lcssa, -2            ; 6 uses
...
.lr.ph757.preheader:                              ; preds = %bb.s, %.lr.ph750.preheader, %.lr.ph750.1, %.lr.ph750.2
  %.3322.lcssa.ph = phi i32 [ %i.cq, %.lr.ph750.2 ], [ %i.cn, %.lr.ph750.1 ], [ %i.ck, %.lr.ph750.preheader ], [ %i.ch, %bb.s ]
...
.lr.ph757:                                        ; preds = %.lr.ph757.preheader, %bb.y
  ...
  %.5337755 = phi ptr [ %.3335.lcssa, %.lr.ph757.preheader ], [ %.6338, %bb.y ] ; 2 uses
  %.5350754 = phi ptr [ %.3348.lcssa, %.lr.ph757.preheader ], [ %i.dk, %bb.y ] ; 2 uses
  %.not411 = icmp ult ptr %.5350754, %.5337755
...
bb.y:                                             ; preds = %bb.x, %.lr.ph757
  %.6351 = phi ptr [ %i.dh, %bb.x ], [ %.5350754, %.lr.ph757 ] ; 2 uses
  %.6338 = phi ptr [ %i.dj, %bb.x ], [ %.5337755, %.lr.ph757 ] ; 2 uses
  %i.dk = getelementptr inbounds nuw i8, ptr %.6351, i64 1 ; 2 uses
  %i.dl = load i8, ptr %.6351, align 1, !tbaa !35
...
._crit_edge758:                                   ; preds = %bb.y, %.lr.ph750.3
  %.3322.lcssa981 = phi i32 [ 0, %.lr.ph750.3 ], [ %.3322.lcssa.ph, %bb.y ]
  %.5350.lcssa = phi ptr [ %.3348.lcssa, %.lr.ph750.3 ], [ %i.dk, %bb.y ] ; 2 uses
  %.5337.lcssa = phi ptr [ %.3335.lcssa, %.lr.ph750.3 ], [ %.6338, %bb.y ] ; 2 uses
...
.lr.ph765:                                        ; preds = %.lr.ph765.preheader, %bb.ah
  ...
  %.7339763 = phi ptr [ %.8340, %bb.ah ], [ %.5337.lcssa, %.lr.ph765.preheader ] ; 2 uses
  %.7352762 = phi ptr [ %i.ev, %bb.ah ], [ %.5350.lcssa, %.lr.ph765.preheader ] ; 2 uses
  %.not408 = icmp ult ptr %.7352762, %.7339763
...
bb.ae:                                            ; preds = %bb.ad, %.lr.ph765
  %.8353 = phi ptr [ %i.ee, %bb.ad ], [ %.7352762, %.lr.ph765 ] ; 3 uses
  %.8340 = phi ptr [ %i.eg, %bb.ad ], [ %.7339763, %.lr.ph765 ] ; 3 uses
...
.thread:                                          ; preds = %._crit_edge758, %.lr.ph750.3, %bb.af, %.thread.sink.split
  %.1369.ph = phi i32 [ 3, %.thread.sink.split ], [ -3, %bb.af ], [ -4, %.lr.ph750.3 ], [ -2, %._crit_edge758 ]
...
bb.ai:                                            ; preds = %._crit_edge673
  ...
  %i.fb = icmp slt i32 %.2314.lcssa, 7
...
.lr.ph.i:                                         ; preds = %bb.ai, %bb.ao
  ...
  %.0196413.i = phi ptr [ %.1197.i, %bb.ao ], [ %.3335.lcssa, %bb.ai ] ; 2 uses
  %.0208412.i = phi ptr [ %i.fs, %bb.ao ], [ %.3348.lcssa, %bb.ai ] ; 2 uses
...
._crit_edge.i:                                    ; preds = %bb.ao, %bb.ai
  %.0208.lcssa.i = phi ptr [ %.3348.lcssa, %bb.ai ], [ %i.fs, %bb.ao ] ; 2 uses
  %.0196.lcssa.i = phi ptr [ %.3335.lcssa, %bb.ai ], [ %.1197.i, %bb.ao ] ; 2 uses
