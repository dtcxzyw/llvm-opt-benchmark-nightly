...
begin_hunk_0_@_ZN7xgboost10collective14ConnectWorkersERKNS0_4CommEPNS0_9TCPSocketEiNS0_5proto8PeerInfoENSt6chrono8durationIlSt5ratioILl1ELl1EEEEiPSt6vectorISt10shared_ptrIS4_ESaISF_EE:bb.a
  %i.cb = shl nsw i32 %i.ca, 6
  %i.cc = select i1 %.not.i209, i32 64, i32 %i.cb ; 4 uses
  %i.cd = sext i32 %i.cc to i64                   ; 6 uses
  %i.ce = icmp slt i32 %i.cc, 0
  br i1 %i.ce, label %bb.r, label %_ZNSt6vectorIaSaIaEE17_S_check_init_lenEmRKS0_.exit.i
...
_ZN7xgboost6common4SpanIaLm18446744073709551615EEC2EPam.exit: ; preds = %_ZNSt6vectorIaSaIaEE17_S_check_init_lenEmRKS0_.exit.i
  ...
  br i1 %.not.i213.not, label %bb.u, label %bb.t, !prof !100
...
_ZN7xgboost6common4SpanIaLm18446744073709551615EEC2EPam.exit.thread: ; preds = %bb.s
  ...
  br i1 %.not.i213625, label %bb.t, label %.thread, !prof !69
...
.thread:                                          ; preds = %_ZN7xgboost6common4SpanIaLm18446744073709551615EEC2EPam.exit.thread
  ...
  %i.cp = load i64, ptr %i.w, align 8, !tbaa !61  ; 6 uses
...
.noexc.i:                                         ; preds = %.thread
  ...
  store ptr %i.cr, ptr %27, align 8, !tbaa !59
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e) #12
  store i64 25, ptr %i.e, align 8, !tbaa !57
...
.noexc214:                                        ; preds = %.noexc.i
  store ptr %i.cs, ptr %27, align 8, !tbaa !60
  %i.ct = load i64, ptr %i.e, align 8, !tbaa !57  ; 3 uses
  store i64 %i.ct, ptr %i.cr, align 8, !tbaa !62
  ...
  store i64 %i.ct, ptr %i.cu, align 8, !tbaa !61
  %i.cv = load ptr, ptr %27, align 8, !tbaa !60
...
.noexc217:                                        ; preds = %.noexc214
  ...
  %i.cx = invoke noalias noundef nonnull dereferenceable(56) ptr @_Znwm(i64 noundef 56) #30
          to label %.noexc.i215 unwind label %bb.v, !noalias !406 ; 7 uses

.noexc.i215:                                      ; preds = %.noexc217
  %i.cy = load ptr, ptr %15, align 8, !tbaa !60, !noalias !408 ; 2 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit.thread.i.i.i: ; preds = %.noexc.i215
  ...
  %i.dd = load i64, ptr %i.dc, align 8, !tbaa !61, !noalias !408 ; 3 uses
  %i.de = add nuw nsw i64 %i.dd, 1
  %i.df = icmp ult i64 %i.dd, 16
  call void @llvm.assume(i1 %i.df)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.db, ptr noundef nonnull align 8 dereferenceable(1) %i.cz, i64 %i.de, i1 false), !noalias !406
  br label %bb.w

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit.i.i.i: ; preds = %.noexc.i215
  %i.dg = load i64, ptr %i.cz, align 8, !tbaa !62, !noalias !408
  %.phi.trans.insert.i.i.i = getelementptr inbounds nuw i8, ptr %15, i64 8
  %.pre.i.i.i = load i64, ptr %.phi.trans.insert.i.i.i, align 8, !tbaa !61, !noalias !408
  store i64 %i.dg, ptr %i.db, align 8, !tbaa !62, !noalias !408
  br label %bb.w

bb.v:                                             ; preds = %.noexc217
  %i.dh = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.di = load ptr, ptr %15, align 8, !tbaa !60, !noalias !406 ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i3.i: ; preds = %bb.v
  %i.dl = load i64, ptr %i.dj, align 8, !tbaa !62, !noalias !406
  %i.dm = add i64 %i.dl, 1
  call void @_ZdlPvm(ptr noundef %i.di, i64 noundef %i.dm) #31, !noalias !406
  br label %.body218
...
bb.w:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit.i.i.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit.thread.i.i.i
  ...
  store ptr %.sink.i.i216, ptr %i.cx, align 8, !tbaa !59, !noalias !408
  %i.do = getelementptr inbounds nuw i8, ptr %i.cx, i64 8
  store i64 %i.dn, ptr %i.do, align 8, !tbaa !61, !noalias !408
  %i.dp = getelementptr inbounds nuw i8, ptr %i.cx, i64 32
  store i32 0, ptr %i.dp, align 8, !tbaa !76, !noalias !408
  ...
  store ptr %i.dr, ptr %i.dq, align 8, !tbaa !77, !noalias !408
  %i.ds = getelementptr inbounds nuw i8, ptr %i.cx, i64 48
  store ptr null, ptr %i.ds, align 8, !tbaa !72, !noalias !408
  store ptr %i.cx, ptr %0, align 8, !tbaa !73, !alias.scope !408
  call void @llvm.lifetime.end.p0(ptr nonnull %15)
  %i.dt = load ptr, ptr %27, align 8, !tbaa !60   ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.w
  %i.dv = load i64, ptr %i.cr, align 8, !tbaa !62
  %i.dw = add i64 %i.dv, 1
...
.body218:                                         ; preds = %bb.v, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i3.i, %bb.z
  ...
  %i.ea = load ptr, ptr %27, align 8, !tbaa !60   ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i220: ; preds = %.body218
  %i.ec = load i64, ptr %i.cr, align 8, !tbaa !62
  %i.ed = add i64 %i.ec, 1
...
_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.peel: ; preds = %bb.aa
  %i.ee = load ptr, ptr %4, align 8, !tbaa !60    ; 6 uses
  %i.ef = ptrtoaddr ptr %i.ee to i64
  %i.eg = load i8, ptr %i.ee, align 1, !tbaa !62
  store i8 %i.eg, ptr %i.co, align 1, !tbaa !62
...
.lr.ph.i.i.i.i.i.preheader:                       ; preds = %_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.peel
  ...
  br i1 %min.iters.check, label %.lr.ph.i.i.i.i.i.preheader923, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph.i.i.i.i.i.preheader
  %i.ek = add i64 %i.ci, %i.cm
  %i.el = sub i64 %i.ef, %i.ek
  %diff.check = icmp ugt i64 %i.el, -16
  br i1 %diff.check, label %.lr.ph.i.i.i.i.i.preheader923, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ep = getelementptr inbounds nuw i8, ptr %next.gep, i64 1
  %i.eq = getelementptr inbounds nuw i8, ptr %next.gep, i64 9
  %wide.load = load <8 x i8>, ptr %i.ep, align 1, !tbaa !62
  %wide.load916 = load <8 x i8>, ptr %i.eq, align 1, !tbaa !62
  %i.er = getelementptr inbounds nuw i8, ptr %i.co, i64 %index ; 2 uses
  %i.es = getelementptr inbounds nuw i8, ptr %i.er, i64 1
  %i.et = getelementptr inbounds nuw i8, ptr %i.er, i64 9
  store <8 x i8> %wide.load, ptr %i.es, align 1, !tbaa !62
...
.lr.ph.i.i.i.i.i.prol:                            ; preds = %.lr.ph.i.i.i.i.i.preheader923, %_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.prol
  %.0512.i.i.i.i.i.pn.prol = phi ptr [ %.0512.i.i.i.i.i.prol, %_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.prol ], [ %.0512.i.i.i.i.i.pn.ph, %.lr.ph.i.i.i.i.i.preheader923 ]
  %.sroa.4.011.i.i.i.i.i.prol = phi i64 [ %i.fb, %_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.prol ], [ %.sroa.4.011.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader923 ] ; 3 uses
  %prol.iter = phi i64 [ %prol.iter.next, %_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.prol ], [ 0, %.lr.ph.i.i.i.i.i.preheader923 ]
  %i.ey = icmp samesign ult i64 %.sroa.4.011.i.i.i.i.i.prol, 64
  br i1 %i.ey, label %_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.prol, label %.loopexit725, !prof !100
...
_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.prol: ; preds = %.lr.ph.i.i.i.i.i.prol
  ...
  %i.ez = load i8, ptr %.0512.i.i.i.i.i.prol, align 1, !tbaa !62
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.i.i.prol, !llvm.loop !351

.lr.ph.i.i.i.i.i.prol.loopexit:                   ; preds = %_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.prol, %.lr.ph.i.i.i.i.i.preheader923
  %.0512.i.i.i.i.i.pn.unr = phi ptr [ %.0512.i.i.i.i.i.pn.ph, %.lr.ph.i.i.i.i.i.preheader923 ], [ %.0512.i.i.i.i.i.prol, %_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.prol ]
  %.sroa.4.011.i.i.i.i.i.unr = phi i64 [ %.sroa.4.011.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader923 ], [ %i.fb, %_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.prol ]
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i.prol.loopexit, %_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.3
  ...
  br i1 %i.fd, label %_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i, label %.loopexit725, !prof !100
...
_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i: ; preds = %.lr.ph.i.i.i.i.i
  ...
  %i.fe = load i8, ptr %.0512.i.i.i.i.i, align 1, !tbaa !62
  ...
  br i1 %.not, label %.loopexit725, label %_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.1, !prof !69
...
_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.1: ; preds = %_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i
  ...
  %i.fg = load i8, ptr %.0512.i.i.i.i.i.1, align 1, !tbaa !62
  %i.fh = getelementptr inbounds nuw i8, ptr %i.co, i64 %.sroa.4.011.i.i.i.i.i
  %i.fi = getelementptr inbounds nuw i8, ptr %i.fh, i64 1
  store i8 %i.fg, ptr %i.fi, align 1, !tbaa !62
  %i.fj = icmp ult i64 %.sroa.4.011.i.i.i.i.i, 62
  br i1 %i.fj, label %_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.2, label %.loopexit725, !prof !100
...
_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.2: ; preds = %_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.1
  ...
  %i.fk = load i8, ptr %.0512.i.i.i.i.i.2, align 1, !tbaa !62
  %i.fl = getelementptr inbounds nuw i8, ptr %i.co, i64 %.sroa.4.011.i.i.i.i.i
  %i.fm = getelementptr inbounds nuw i8, ptr %i.fl, i64 2
  store i8 %i.fk, ptr %i.fm, align 1, !tbaa !62
  %.not928 = icmp eq i64 %.sroa.4.011.i.i.i.i.i, 61
  br i1 %.not928, label %.loopexit725, label %_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.3, !prof !69
...
_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.3: ; preds = %_ZN7xgboost6common6detail12SpanIteratorINS0_4SpanIaLm18446744073709551615EEELb0EEppEv.exit.i.i.i.i.i.2
  ...
  %i.fn = load i8, ptr %.0512.i.i.i.i.i.3, align 1, !tbaa !62
  ...
  br i1 %exitcond.not.3, label %_ZSt4copyIN9__gnu_cxx17__normal_iteratorIPKcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEN7xgboost6common6detail12SpanIteratorINSC_4SpanIaLm18446744073709551615EEELb0EEEET0_T_SJ_SI_.exit, label %.lr.ph.i.i.i.i.i, !llvm.loop !352
...
.noexc225:                                        ; preds = %_ZSt4copyIN9__gnu_cxx17__normal_iteratorIPKcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEN7xgboost6common6detail12SpanIteratorINSC_4SpanIaLm18446744073709551615EEELb0EEEET0_T_SJ_SI_.exit
  ...
  store i32 1, ptr %i.fs, align 8, !tbaa !79, !noalias !413
  %i.ft = getelementptr inbounds nuw i8, ptr %i.fr, i64 12
  store i32 1, ptr %i.ft, align 4, !tbaa !80, !noalias !413
  store ptr getelementptr inbounds nuw inrange(-16, 40) (i8, ptr @_ZTVSt23_Sp_counted_ptr_inplaceIN7xgboost10collective7ChannelESaIvELN9__gnu_cxx12_Lock_policyE2EE, i64 16), ptr %i.fr, align 8, !tbaa !28, !noalias !413
  %i.fu = load ptr, ptr %i.q, align 8, !tbaa !81, !noalias !413 ; 2 uses
  %i.fv = load <2 x ptr>, ptr %21, align 16, !tbaa !88, !noalias !413
...
bb.ab:                                            ; preds = %.noexc225
  ...
  %i.fx = load i8, ptr @__libc_single_threaded, align 1, !tbaa !62, !noalias !413
  %.not.i.i.i.i.i.i.i.i.i.i = icmp eq i8 %i.fx, 0
  br i1 %.not.i.i.i.i.i.i.i.i.i.i, label %bb.ad, label %bb.ac

bb.ac:                                            ; preds = %bb.ab
  %i.fy = load i32, ptr %i.fw, align 4, !tbaa !68, !noalias !413
  %i.fz = add nsw i32 %i.fy, 1
  store i32 %i.fz, ptr %i.fw, align 4, !tbaa !68, !noalias !413
  br label %bb.ae

bb.ad:                                            ; preds = %bb.ab
  %i.ga = atomicrmw volatile add ptr %i.fw, i32 1 acq_rel, align 4, !noalias !413 ; 0 uses
  br label %bb.ae
...
bb.ae:                                            ; preds = %bb.ad, %bb.ac, %.noexc225
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 40) (i8, ptr @_ZTVN7xgboost10collective7ChannelE, i64 16), ptr %i.gc, align 8, !tbaa !28, !noalias !413
  %i.gd = getelementptr inbounds nuw i8, ptr %i.fr, i64 24
  store <2 x ptr> %i.fv, ptr %i.gd, align 8, !tbaa !88, !noalias !413
  %i.ge = getelementptr inbounds nuw i8, ptr %i.fr, i64 40
  store ptr null, ptr %i.ge, align 8, !tbaa !72, !noalias !413
  %i.gf = getelementptr inbounds nuw i8, ptr %i.fr, i64 48
  store ptr %1, ptr %i.gf, align 8, !tbaa !101, !noalias !413
  store ptr %i.fr, ptr %i.gb, align 8, !tbaa !81, !alias.scope !413
  store ptr %i.gc, ptr %28, align 16, !tbaa !103, !alias.scope !413
...
.noexc228:                                        ; preds = %bb.ae
  ...
  store i32 1, ptr %i.gh, align 8, !tbaa !79, !noalias !414
  %i.gi = getelementptr inbounds nuw i8, ptr %i.gg, i64 12
  store i32 1, ptr %i.gi, align 4, !tbaa !80, !noalias !414
  store ptr getelementptr inbounds nuw inrange(-16, 40) (i8, ptr @_ZTVSt23_Sp_counted_ptr_inplaceIN7xgboost10collective7ChannelESaIvELN9__gnu_cxx12_Lock_policyE2EE, i64 16), ptr %i.gg, align 8, !tbaa !28, !noalias !414
  %i.gj = load ptr, ptr %i.l, align 8, !tbaa !81, !noalias !414 ; 2 uses
  %i.gk = load <2 x ptr>, ptr %20, align 16, !tbaa !88, !noalias !414
...
bb.af:                                            ; preds = %.noexc228
  ...
  %i.gm = load i8, ptr @__libc_single_threaded, align 1, !tbaa !62, !noalias !414
  %.not.i.i.i.i.i.i.i.i.i.i227 = icmp eq i8 %i.gm, 0
  br i1 %.not.i.i.i.i.i.i.i.i.i.i227, label %bb.ah, label %bb.ag

bb.ag:                                            ; preds = %bb.af
  %i.gn = load i32, ptr %i.gl, align 4, !tbaa !68, !noalias !414
  %i.go = add nsw i32 %i.gn, 1
  store i32 %i.go, ptr %i.gl, align 4, !tbaa !68, !noalias !414
  br label %bb.ai

bb.ah:                                            ; preds = %bb.af
  %i.gp = atomicrmw volatile add ptr %i.gl, i32 1 acq_rel, align 4, !noalias !414 ; 0 uses
  br label %bb.ai
...
bb.ai:                                            ; preds = %bb.ah, %bb.ag, %.noexc228
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 40) (i8, ptr @_ZTVN7xgboost10collective7ChannelE, i64 16), ptr %i.gr, align 8, !tbaa !28, !noalias !414
  %i.gs = getelementptr inbounds nuw i8, ptr %i.gg, i64 24
  store <2 x ptr> %i.gk, ptr %i.gs, align 8, !tbaa !88, !noalias !414
  %i.gt = getelementptr inbounds nuw i8, ptr %i.gg, i64 40
  store ptr null, ptr %i.gt, align 8, !tbaa !72, !noalias !414
  %i.gu = getelementptr inbounds nuw i8, ptr %i.gg, i64 48
  store ptr %1, ptr %i.gu, align 8, !tbaa !101, !noalias !414
  store ptr %i.gg, ptr %i.gq, align 8, !tbaa !81, !alias.scope !414
  store ptr %i.gr, ptr %29, align 16, !tbaa !103, !alias.scope !414
...
"_ZN7xgboost10collectivelsIZNS0_14ConnectWorkersERKNS0_4CommEPNS0_9TCPSocketEiNS0_5proto8PeerInfoENSt6chrono8durationIlSt5ratioILl1ELl1EEEEiPSt6vectorISt10shared_ptrIS5_ESaISG_EEE3$_4EENSt9enable_ifIXsr3stdE14is_invocable_vIT_EENS0_6ResultEE4typeEOSN_OSM_.exit.thread": ; preds = %bb.ai
  store ptr null, ptr %22, align 8, !tbaa !73, !noalias !415
  br label %bb.bd
...
bb.aj:                                            ; preds = %bb.ai
  ...
  %i.gy = load ptr, ptr %i.gb, align 8, !tbaa !81, !noalias !416 ; 2 uses
  %i.gz = load <2 x ptr>, ptr %28, align 16, !tbaa !88, !noalias !416
  store <2 x ptr> %i.gz, ptr %13, align 16, !tbaa !88, !noalias !416
...
bb.ak:                                            ; preds = %bb.aj
  ...
  %i.hb = load i8, ptr @__libc_single_threaded, align 1, !tbaa !62, !noalias !416
  %.not.i.i.i.i.i.i232 = icmp eq i8 %i.hb, 0
  br i1 %.not.i.i.i.i.i.i232, label %_ZNSt10shared_ptrIN7xgboost10collective7ChannelEEC2ERKS3_.exit.i.i, label %bb.al

bb.al:                                            ; preds = %bb.ak
  %i.hc = load i32, ptr %i.ha, align 4, !tbaa !68, !noalias !416
  %i.hd = add nsw i32 %i.hc, 1
  store i32 %i.hd, ptr %i.ha, align 4, !tbaa !68, !noalias !416
  br label %_ZNSt10shared_ptrIN7xgboost10collective7ChannelEEC2ERKS3_.exit.i.i.thread
end_hunk_0
