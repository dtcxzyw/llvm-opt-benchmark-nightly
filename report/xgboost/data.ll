...
vector.body168:                                   ; preds = %vector.body168, %vector.ph166
  ...
  %wide.load172 = load <2 x i64>, ptr %next.gep171, align 8, !tbaa !98, !alias.scope !1139, !noalias !1142
  %wide.load173 = load <2 x i64>, ptr %i.x, align 8, !tbaa !98, !alias.scope !1139, !noalias !1142
  %i.y = getelementptr i8, ptr %next.gep170, i64 16 ; 2 uses
  %wide.load174 = load <2 x i64>, ptr %next.gep170, align 8, !tbaa !98, !alias.scope !1142
  %wide.load175 = load <2 x i64>, ptr %i.y, align 8, !tbaa !98, !alias.scope !1142
  store <2 x i64> %wide.load174, ptr %next.gep171, align 8, !tbaa !98, !alias.scope !1139, !noalias !1142
  store <2 x i64> %wide.load175, ptr %i.x, align 8, !tbaa !98, !alias.scope !1139, !noalias !1142
  store <2 x i64> %wide.load172, ptr %next.gep170, align 8, !tbaa !98, !alias.scope !1142
  store <2 x i64> %wide.load173, ptr %i.y, align 8, !tbaa !98, !alias.scope !1142
  %index.next176 = add nuw i64 %index169, 4       ; 2 uses
  %i.z = icmp eq i64 %index.next176, %n.vec167
  br i1 %i.z, label %middle.block177, label %vector.body168, !llvm.loop !1144
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader181, %.lr.ph.i
  ...
  br i1 %.not.i, label %_ZSt11swap_rangesIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEES6_ET0_T_S8_S7_.exit, label %.lr.ph.i, !llvm.loop !1145
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %next.gep129, align 8, !tbaa !98, !alias.scope !1146, !noalias !1149
  %wide.load130 = load <2 x i64>, ptr %i.aw, align 8, !tbaa !98, !alias.scope !1146, !noalias !1149
  %i.ax = getelementptr i8, ptr %next.gep, i64 16 ; 2 uses
  %wide.load131 = load <2 x i64>, ptr %next.gep, align 8, !tbaa !98, !alias.scope !1149
  %wide.load132 = load <2 x i64>, ptr %i.ax, align 8, !tbaa !98, !alias.scope !1149
  store <2 x i64> %wide.load131, ptr %next.gep129, align 8, !tbaa !98, !alias.scope !1146, !noalias !1149
  store <2 x i64> %wide.load132, ptr %i.aw, align 8, !tbaa !98, !alias.scope !1146, !noalias !1149
  store <2 x i64> %wide.load, ptr %next.gep, align 8, !tbaa !98, !alias.scope !1149
  store <2 x i64> %wide.load130, ptr %i.ax, align 8, !tbaa !98, !alias.scope !1149
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ay = icmp eq i64 %index.next, %n.vec
  br i1 %i.ay, label %middle.block, label %vector.body, !llvm.loop !1151
...
.lr.ph100.prol:                                   ; preds = %.lr.ph100.preheader182, %.lr.ph100.prol
  ...
  br i1 %prol.iter192.cmp.not, label %.lr.ph100.prol.loopexit, label %.lr.ph100.prol, !llvm.loop !1152
...
.lr.ph100:                                        ; preds = %.lr.ph100.prol.loopexit, %.lr.ph100
  ...
  br i1 %exitcond109.not.3, label %._crit_edge101, label %.lr.ph100, !llvm.loop !1153
...
vector.body144:                                   ; preds = %vector.body144, %vector.ph142
  ...
  %wide.load148 = load <2 x i64>, ptr %i.cv, align 8, !tbaa !98, !alias.scope !1154, !noalias !1157
  %wide.load149 = load <2 x i64>, ptr %i.cw, align 8, !tbaa !98, !alias.scope !1154, !noalias !1157
  %i.cx = getelementptr inbounds i8, ptr %next.gep146, i64 -16 ; 2 uses
  %i.cy = getelementptr inbounds i8, ptr %next.gep146, i64 -32 ; 2 uses
  %wide.load150 = load <2 x i64>, ptr %i.cx, align 8, !tbaa !98, !alias.scope !1157
  %wide.load151 = load <2 x i64>, ptr %i.cy, align 8, !tbaa !98, !alias.scope !1157
  store <2 x i64> %wide.load150, ptr %i.cv, align 8, !tbaa !98, !alias.scope !1154, !noalias !1157
  store <2 x i64> %wide.load151, ptr %i.cw, align 8, !tbaa !98, !alias.scope !1154, !noalias !1157
  store <2 x i64> %wide.load148, ptr %i.cx, align 8, !tbaa !98, !alias.scope !1157
  store <2 x i64> %wide.load149, ptr %i.cy, align 8, !tbaa !98, !alias.scope !1157
  %index.next152 = add nuw i64 %index145, 4       ; 2 uses
  %i.cz = icmp eq i64 %index.next152, %n.vec143
  br i1 %i.cz, label %middle.block153, label %vector.body144, !llvm.loop !1159
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader183, %.lr.ph.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol, !llvm.loop !1160
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  br i1 %exitcond.not.3, label %._crit_edge, label %.lr.ph, !llvm.loop !1162
...
.lr.ph117.i.i.i.i.i648.epil:                      ; preds = %.lr.ph117.i.i.i.i.i648.epil, %.lr.ph117.i.i.i.i.i648.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %_ZZN7xgboost13DispatchDTypeILi1EZNS_12_GLOBAL__N_118CopyTensorInfoImplILi1EjEEvPKNS_7ContextENS_4JsonEPNS_6linalg6TensorIT0_XT_EEEEUlOT_E_EEvNS_14ArrayInterfaceIXT_EXeqT_Li1EEEENS_9DeviceOrdES9_ENKUlSC_E_clIfEEDaSC_.exit, label %.lr.ph117.i.i.i.i.i648.epil, !llvm.loop !1842
...
vector.body131:                                   ; preds = %vector.body131, %vector.ph127
  ...
  br i1 %i.al, label %middle.block135, label %vector.body131, !llvm.loop !1843
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i
  ...
  br i1 %.not.i.i.i, label %_ZSt4fillIPjjEvT_S1_RKT0_.exit, label %.lr.ph.i.i.i, !llvm.loop !1844
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.az, label %middle.block, label %vector.body, !llvm.loop !1845
...
.lr.ph.i.i.i.i.i.i.i:                             ; preds = %.lr.ph.i.i.i.i.i.i.i.preheader, %.lr.ph.i.i.i.i.i.i.i
  ...
  br i1 %.not.i.i.i.i.i.i.i, label %_ZSt24__uninitialized_fill_n_aIPjmjjET_S1_T0_RKT1_RSaIT2_E.exit, label %.lr.ph.i.i.i.i.i.i.i, !llvm.loop !1846
...
vector.body118:                                   ; preds = %vector.body118, %vector.ph114
  ...
  br i1 %i.bo, label %middle.block122, label %vector.body118, !llvm.loop !1847
...
.lr.ph.i.i.i71:                                   ; preds = %.lr.ph.i.i.i71.preheader151, %.lr.ph.i.i.i71
  ...
  br i1 %.not.i.i.i73, label %_ZSt4fillIPjjEvT_S1_RKT0_.exit, label %.lr.ph.i.i.i71, !llvm.loop !1848
...
.lr.ph.i.i.i:                                     ; preds = %_ZNKSt6vectorIS_ImSaImEESaIS1_EE12_M_check_lenEmPKc.exit, %.lr.ph.i.i.i
  ...
  %i.x = load <2 x ptr>, ptr %.0911.i.i.i, align 8, !tbaa !120, !alias.scope !1919, !noalias !1916
  store <2 x ptr> %i.x, ptr %.012.i.i.i, align 8, !tbaa !120, !alias.scope !1916, !noalias !1919
  %i.y = getelementptr inbounds nuw i8, ptr %.012.i.i.i, i64 16
  %i.z = getelementptr inbounds nuw i8, ptr %.0911.i.i.i, i64 16
  %i.aa = load ptr, ptr %i.z, align 8, !tbaa !115, !alias.scope !1919, !noalias !1916
  store ptr %i.aa, ptr %i.y, align 8, !tbaa !115, !alias.scope !1916, !noalias !1919
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.0911.i.i.i, i8 0, i64 24, i1 false), !alias.scope !1919, !noalias !1916
  ...
  br i1 %.not.i.i.i, label %_ZNSt6vectorIS_ImSaImEESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit, label %.lr.ph.i.i.i, !llvm.loop !1921
...
vector.body131:                                   ; preds = %vector.body131, %vector.ph127
  ...
  %i.al = icmp eq i64 %index.next134, %n.vec128
  br i1 %i.al, label %middle.block135, label %vector.body131, !llvm.loop !1922
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i
  ...
  %.not.i.i.i = icmp eq ptr %i.am, %i.ad
  br i1 %.not.i.i.i, label %_ZSt4fillIPmmEvT_S1_RKT0_.exit, label %.lr.ph.i.i.i, !llvm.loop !1923
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.az = icmp eq i64 %index.next, %n.vec
  br i1 %i.az, label %middle.block, label %vector.body, !llvm.loop !1924
...
.lr.ph.i.i.i.i.i.i.i:                             ; preds = %.lr.ph.i.i.i.i.i.i.i.preheader, %.lr.ph.i.i.i.i.i.i.i
  ...
  %.not.i.i.i.i.i.i.i = icmp eq ptr %i.ba, %i.ap
  br i1 %.not.i.i.i.i.i.i.i, label %_ZSt24__uninitialized_fill_n_aIPmmmmET_S1_T0_RKT1_RSaIT2_E.exit, label %.lr.ph.i.i.i.i.i.i.i, !llvm.loop !1925
...
vector.body118:                                   ; preds = %vector.body118, %vector.ph114
  ...
  %i.bo = icmp eq i64 %index.next121, %n.vec115
  br i1 %i.bo, label %middle.block122, label %vector.body118, !llvm.loop !1926
...
.lr.ph.i.i.i71:                                   ; preds = %.lr.ph.i.i.i71.preheader151, %.lr.ph.i.i.i71
  ...
  %.not.i.i.i73 = icmp eq ptr %i.bp, %i.d
  br i1 %.not.i.i.i73, label %_ZSt4fillIPmmEvT_S1_RKT0_.exit, label %.lr.ph.i.i.i71, !llvm.loop !1927
