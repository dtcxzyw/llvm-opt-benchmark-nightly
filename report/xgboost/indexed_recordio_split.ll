...
bb.o:                                             ; preds = %_ZNSt6vectorImSaImEE9push_backERKm.exit, %bb.n
  %.sroa.20.0.a = phi ptr [ null, %bb.n ], [ %.sroa.20.1.a, %_ZNSt6vectorImSaImEE9push_backERKm.exit ] ; 5 uses
...
bb.q:                                             ; preds = %bb.p
  %.not.i44 = icmp eq ptr %.sroa.13.0, %.sroa.20.0.a
...
bb.s:                                             ; preds = %bb.q
  %i.cf = ptrtoint ptr %.sroa.20.0.a to i64
  %i.cg = ptrtoint ptr %.sroa.088.0 to i64
...
bb.u:                                             ; preds = %.noexc47
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.cp, ptr align 8 %.sroa.088.0, i64 %i.ch, i1 false)
...
bb.v:                                             ; preds = %_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.088.0, i64 noundef %i.ch) #27
...
_ZNSt6vectorImSaImEE9push_backERKm.exit:          ; preds = %bb.r, %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i
  %.sroa.20.1.a = phi ptr [ %i.ct, %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i ], [ %.sroa.20.0.a, %bb.r ]
  ...
  %.sroa.088.1 = phi ptr [ %i.cp, %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i ], [ %.sroa.088.0, %bb.r ]
...
bb.y:                                             ; preds = %bb.p
  ...
  %.pre226 = ptrtoint ptr %.sroa.088.0 to i64     ; 3 uses
...
bb.z:                                             ; preds = %bb.y
  ...
  invoke void @_ZSt16__introsort_loopIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEElNS0_5__ops15_Iter_less_iterEEvT_S9_T0_T1_(ptr %.sroa.088.0, ptr %.sroa.13.0, i64 noundef %i.cy)
...
.lr.ph:                                           ; preds = %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEEEvT_S7_.exit, %_ZNSt6vectorISt4pairImmESaIS1_EE9push_backEOS1_.exit
  ...
  %i.db = getelementptr inbounds nuw [8 x i8], ptr %.sroa.088.0, i64 %.0182
  %i.dc = add nuw i64 %.0182, 1                   ; 3 uses
  %i.dd = getelementptr inbounds nuw [8 x i8], ptr %.sroa.088.0, i64 %i.dc
...
bb.ai:                                            ; preds = %_ZNSt6vectorISt4pairImmESaIS1_EE9push_backEOS1_.exit70
  %i.fd = ptrtoint ptr %.sroa.20.0.a to i64
  %i.fe = sub i64 %i.fd, %.pre226
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.088.0, i64 noundef %i.fe) #27
...
bb.ak:                                            ; preds = %.loopexit.split-lp._crit_edge, %.thread107
  ...
  %i.fv = ptrtoint ptr %.sroa.20.0.a to i64
  %i.fw = sub i64 %i.fv, %.pre-phi
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.088.0, i64 noundef %i.fw) #27
