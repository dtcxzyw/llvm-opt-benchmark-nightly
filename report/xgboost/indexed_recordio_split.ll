...
bb.h:                                             ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit39
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #9
  %.pr105 = load ptr, ptr %4, align 8, !tbaa !73  ; 4 uses
  %.not.i = icmp eq ptr %.pr105, null
...
bb.i:                                             ; preds = %bb.h
  %i.aa = load ptr, ptr %.pr105, align 8, !tbaa !75 ; 2 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %.pr105, i64 16 ; 2 uses
...
_ZNKSt14default_deleteINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclEPS5_.exit.i: ; preds = %bb.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i
  call void @_ZdlPvm(ptr noundef nonnull %.pr105, i64 noundef 32) #27
...
_ZNSt10unique_ptrINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt14default_deleteIS5_EED2Ev.exit: ; preds = %_ZN4dmlc11LogCheck_EQImmEESt10unique_ptrINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt14default_deleteIS7_EERKT_RKT0_.exit, %_ZN4dmlc11LogCheck_EQImmEESt10unique_ptrINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt14default_deleteIS7_EERKT_RKT0_.exit.thread, %bb.h, %_ZNKSt14default_deleteINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclEPS5_.exit.i
  ...
  %.not187 = icmp eq ptr %i.af, %i.ag
  br i1 %.not187, label %._crit_edge185, label %.lr.ph184

.lr.ph184:                                        ; preds = %_ZNSt10unique_ptrINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt14default_deleteIS5_EED2Ev.exit
  %i.ah = getelementptr inbounds nuw i8, ptr %0, i64 200 ; 4 uses
  %i.ai = getelementptr inbounds nuw i8, ptr %0, i64 208 ; 7 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %0, i64 216 ; 4 uses
...
._crit_edge185:                                   ; preds = %_ZNSt10unique_ptrIN4dmlc6StreamESt14default_deleteIS1_EED2Ev.exit, %_ZNSt10unique_ptrINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt14default_deleteIS5_EED2Ev.exit
  %.lcssa164 = phi ptr [ %i.af, %_ZNSt10unique_ptrINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt14default_deleteIS5_EED2Ev.exit ], [ %i.fo, %_ZNSt10unique_ptrIN4dmlc6StreamESt14default_deleteIS1_EED2Ev.exit ] ; 2 uses
  %.lcssa154 = phi ptr [ %i.ag, %_ZNSt10unique_ptrINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt14default_deleteIS5_EED2Ev.exit ], [ %i.fp, %_ZNSt10unique_ptrIN4dmlc6StreamESt14default_deleteIS1_EED2Ev.exit ] ; 3 uses
  %.not4.i.i.i = icmp eq ptr %.lcssa154, %.lcssa164
  br i1 %.not4.i.i.i, label %_ZSt8_DestroyIPN4dmlc2io3URIES2_EvT_S4_RSaIT0_E.exit.i, label %.lr.ph.i.i.i

.lr.ph.i.i.i:                                     ; preds = %._crit_edge185, %_ZSt8_DestroyIN4dmlc2io3URIEEvPT_.exit.i.i.i
  %.05.i.i.i = phi ptr [ %i.bi, %_ZSt8_DestroyIN4dmlc2io3URIEEvPT_.exit.i.i.i ], [ %.lcssa154, %._crit_edge185 ] ; 7 uses
...
_ZSt8_DestroyIN4dmlc2io3URIEEvPT_.exit.i.i.i:     ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit3.i.i.i.i.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i4.i.i.i.i.i
  ...
  %.not.i.i.i = icmp eq ptr %i.bi, %.lcssa164
...
_ZSt8_DestroyIPN4dmlc2io3URIES2_EvT_S4_RSaIT0_E.exit.i: ; preds = %_ZSt8_DestroyIPN4dmlc2io3URIES2_EvT_S4_RSaIT0_E.exitthread-pre-split.i, %._crit_edge185
  %i.bj = phi ptr [ %.pr.i, %_ZSt8_DestroyIPN4dmlc2io3URIES2_EvT_S4_RSaIT0_E.exitthread-pre-split.i ], [ %.lcssa154, %._crit_edge185 ] ; 3 uses
...
bb.l:                                             ; preds = %.lr.ph184, %_ZNSt10unique_ptrIN4dmlc6StreamESt14default_deleteIS1_EED2Ev.exit
  %i.bp = phi ptr [ %i.ag, %.lr.ph184 ], [ %i.fp, %_ZNSt10unique_ptrIN4dmlc6StreamESt14default_deleteIS1_EED2Ev.exit ]
  %.021183 = phi i64 [ 0, %.lr.ph184 ], [ %i.fn, %_ZNSt10unique_ptrIN4dmlc6StreamESt14default_deleteIS1_EED2Ev.exit ] ; 2 uses
  %i.bq = getelementptr inbounds nuw [96 x i8], ptr %i.bp, i64 %.021183
...
bb.o:                                             ; preds = %_ZNSt6vectorImSaImEE9push_backERKm.exit, %bb.n
  %.sroa.20.0.a = phi ptr [ null, %bb.n ], [ %.sroa.20.1.a, %_ZNSt6vectorImSaImEE9push_backERKm.exit ] ; 16 uses
  %.sroa.13.0 = phi ptr [ null, %bb.n ], [ %.sroa.13.1, %_ZNSt6vectorImSaImEE9push_backERKm.exit ] ; 11 uses
  %.sroa.088.0 = phi ptr [ null, %bb.n ], [ %.sroa.088.1, %_ZNSt6vectorImSaImEE9push_backERKm.exit ] ; 9 uses
...
bb.q:                                             ; preds = %bb.p
  %.not.i44 = icmp eq ptr %.sroa.13.0, %.sroa.088.0
...
bb.s:                                             ; preds = %bb.q
  %i.cf = ptrtoint ptr %.sroa.13.0 to i64
  %i.cg = ptrtoint ptr %.sroa.20.0.a to i64
...
bb.u:                                             ; preds = %.noexc47
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.cp, ptr align 8 %.sroa.20.0.a, i64 %i.ch, i1 false)
  br label %_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i

_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i: ; preds = %bb.u, %.noexc47
  %.not.i17.i.i = icmp eq ptr %.sroa.20.0.a, null
...
bb.v:                                             ; preds = %_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.20.0.a, i64 noundef %i.ch) #27
...
_ZNSt6vectorImSaImEE9push_backERKm.exit:          ; preds = %bb.r, %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i
  %.sroa.20.1.a = phi ptr [ %i.cp, %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i ], [ %.sroa.20.0.a, %bb.r ]
  %.pn112 = phi ptr [ %i.cq, %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i ], [ %.sroa.13.0, %bb.r ]
  %.sroa.088.1 = phi ptr [ %i.ct, %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i ], [ %.sroa.088.0, %bb.r ]
  %.sroa.13.1 = getelementptr inbounds nuw i8, ptr %.pn112, i64 8
  br label %bb.o
...
.loopexit:                                        ; preds = %bb.o, %_ZNSirsERm.exit, %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i
  %.sroa.20.0.lcssa = phi ptr [ %.sroa.088.0, %bb.o ], [ %.sroa.088.0, %_ZNSirsERm.exit ], [ %.sroa.13.0, %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i ]
...
bb.y:                                             ; preds = %bb.p
  %.not.i.i = icmp eq ptr %.sroa.20.0.a, %.sroa.13.0
  %.pre224 = ptrtoint ptr %.sroa.13.0 to i64
  %.pre226 = ptrtoint ptr %.sroa.20.0.a to i64    ; 3 uses
  %.pre228 = sub i64 %.pre224, %.pre226
  %.pre230 = ashr exact i64 %.pre228, 3           ; 2 uses
  br i1 %.not.i.i, label %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEEEvT_S7_.exit, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.cw = call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %.pre230, i1 true)
  %i.cx = shl nuw nsw i64 %i.cw, 1
  %i.cy = xor i64 %i.cx, 126
  invoke void @_ZSt16__introsort_loopIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEElNS0_5__ops15_Iter_less_iterEEvT_S9_T0_T1_(ptr %.sroa.20.0.a, ptr %.sroa.13.0, i64 noundef %i.cy)
          to label %.noexc48 unwind label %.loopexit.split-lp.loopexit

.noexc48:                                         ; preds = %bb.z
  invoke void @_ZSt22__final_insertion_sortIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEENS0_5__ops15_Iter_less_iterEEvT_S9_T0_(ptr %.sroa.20.0.a, ptr %.sroa.13.0)
...
_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEEEvT_S7_.exit: ; preds = %bb.y, %.noexc48
  %i.cz = add nsw i64 %.pre230, -1                ; 2 uses
  %.not188 = icmp eq i64 %i.cz, 0
  %.pre223 = load ptr, ptr %i.ai, align 8, !tbaa !8 ; 2 uses
...
.lr.ph:                                           ; preds = %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEEEvT_S7_.exit, %_ZNSt6vectorISt4pairImmESaIS1_EE9push_backEOS1_.exit
  %i.da = phi ptr [ %i.eb, %_ZNSt6vectorISt4pairImmESaIS1_EE9push_backEOS1_.exit ], [ %.pre223, %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEEEvT_S7_.exit ] ; 6 uses
  %.0182 = phi i64 [ %i.dc, %_ZNSt6vectorISt4pairImmESaIS1_EE9push_backEOS1_.exit ], [ 0, %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEEEvT_S7_.exit ] ; 2 uses
  %i.db = getelementptr inbounds nuw [8 x i8], ptr %.sroa.20.0.a, i64 %.0182
  %i.dc = add nuw i64 %.0182, 1                   ; 3 uses
  %i.dd = getelementptr inbounds nuw [8 x i8], ptr %.sroa.20.0.a, i64 %i.dc
...
bb.ac:                                            ; preds = %bb.ab
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.37) #25
          to label %.noexc53 unwind label %.thread107.loopexit.split-lp
...
_ZNKSt6vectorISt4pairImmESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i: ; preds = %bb.ab
  ...
  %i.dv = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.du) #26
          to label %.noexc54 unwind label %.thread107.loopexit ; 5 uses
...
bb.ad:                                            ; preds = %_ZNSt6vectorISt4pairImmESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i.i
  call void @_ZdlPvm(ptr noundef nonnull %i.dk, i64 noundef %i.dn) #27
...
_ZNSt6vectorISt4pairImmESaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i: ; preds = %bb.ad, %_ZNSt6vectorISt4pairImmESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i.i
  ...
  store ptr %i.ea, ptr %i.aj, align 8, !tbaa !51
  br label %_ZNSt6vectorISt4pairImmESaIS1_EE9push_backEOS1_.exit
...
_ZNSt6vectorISt4pairImmESaIS1_EE9push_backEOS1_.exit: ; preds = %_ZNSt6vectorISt4pairImmESaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i, %bb.aa
  %i.eb = phi ptr [ %i.dz, %_ZNSt6vectorISt4pairImmESaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i ], [ %i.dj, %bb.aa ] ; 2 uses
  %exitcond.not = icmp eq i64 %i.dc, %i.cz
  br i1 %exitcond.not, label %._crit_edge, label %.lr.ph, !llvm.loop !93

.thread107.loopexit:                              ; preds = %_ZNKSt6vectorISt4pairImmESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i
  %lpad.loopexit = landingpad { ptr, i32 }
          cleanup
  br label %.thread107

.thread107.loopexit.split-lp:                     ; preds = %bb.ac
  %lpad.loopexit.split-lp = landingpad { ptr, i32 }
          cleanup
  br label %.thread107

.thread107:                                       ; preds = %.thread107.loopexit.split-lp, %.thread107.loopexit
  %lpad.phi = phi { ptr, i32 } [ %lpad.loopexit, %.thread107.loopexit ], [ %lpad.loopexit.split-lp, %.thread107.loopexit.split-lp ]
...
._crit_edge:                                      ; preds = %_ZNSt6vectorISt4pairImmESaIS1_EE9push_backEOS1_.exit, %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEEEvT_S7_.exit
  %i.ec = phi ptr [ %.pre223, %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEEEvT_S7_.exit ], [ %i.eb, %_ZNSt6vectorISt4pairImmESaIS1_EE9push_backEOS1_.exit ] ; 6 uses
  %i.ed = getelementptr inbounds i8, ptr %.sroa.13.0, i64 -8
  %i.ee = load ptr, ptr %i.ak, align 8, !tbaa !13
  %i.ef = getelementptr inbounds i8, ptr %i.ee, i64 -8
  %i.eg = load i64, ptr %i.ef, align 8, !tbaa !15
  %i.eh = load i64, ptr %i.ed, align 8, !tbaa !15 ; 3 uses
  %i.ei = sub i64 %i.eg, %i.eh                    ; 2 uses
  %i.ej = load ptr, ptr %i.aj, align 8, !tbaa !51
  %.not.i.i55 = icmp eq ptr %i.ec, %i.ej
  br i1 %.not.i.i55, label %bb.af, label %bb.ae

bb.ae:                                            ; preds = %._crit_edge
  store i64 %i.eh, ptr %i.ec, align 8
  %.sroa.6.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.ec, i64 8
  store i64 %i.ei, ptr %.sroa.6.0..sroa_idx, align 8
  %i.ek = load ptr, ptr %i.ai, align 8, !tbaa !8
  %i.el = getelementptr inbounds nuw i8, ptr %i.ek, i64 16
  store ptr %i.el, ptr %i.ai, align 8, !tbaa !8
  br label %_ZNSt6vectorISt4pairImmESaIS1_EE9push_backEOS1_.exit70

bb.af:                                            ; preds = %._crit_edge
  %i.em = load ptr, ptr %i.ah, align 8, !tbaa !12 ; 5 uses
  ...
  br i1 %i.eq, label %bb.ag, label %_ZNKSt6vectorISt4pairImmESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i56
...
_ZNKSt6vectorISt4pairImmESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i56: ; preds = %bb.af
  ...
  %.sroa.speculated.i.i.i.i57 = call i64 @llvm.umax.i64(i64 %i.er, i64 1)
  %i.es = add nsw i64 %.sroa.speculated.i.i.i.i57, %i.er ; 2 uses
  ...
  %.not.i.i.i.i58 = icmp ne i64 %i.ev, 0
  call void @llvm.assume(i1 %.not.i.i.i.i58)
  %i.ew = shl nuw nsw i64 %i.ev, 4
  %i.ex = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.ew) #26
          to label %.noexc69 unwind label %.loopexit119 ; 5 uses
...
.noexc69:                                         ; preds = %_ZNKSt6vectorISt4pairImmESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i56
  ...
  store i64 %i.eh, ptr %i.ey, align 8
  %.sroa.6.0..sroa_idx80 = getelementptr inbounds nuw i8, ptr %i.ey, i64 8
  store i64 %i.ei, ptr %.sroa.6.0..sroa_idx80, align 8
  %.not10.i.i.i.i.i.i59 = icmp eq ptr %i.em, %i.ec
...
.lr.ph.i.i.i.i.i.i60:                             ; preds = %.noexc69, %.lr.ph.i.i.i.i.i.i60
  %.012.i.i.i.i.i.i61 = phi ptr [ %i.fa, %.lr.ph.i.i.i.i.i.i60 ], [ %i.ex, %.noexc69 ] ; 2 uses
  %.0911.i.i.i.i.i.i62 = phi ptr [ %i.ez, %.lr.ph.i.i.i.i.i.i60 ], [ %i.em, %.noexc69 ] ; 2 uses
  ...
  %i.ez = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i.i62, i64 16 ; 2 uses
  %i.fa = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i.i61, i64 16 ; 2 uses
  %.not.i.i.i.i.i.i63 = icmp eq ptr %i.ez, %i.ec
...
_ZNSt6vectorISt4pairImmESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i.i64: ; preds = %.lr.ph.i.i.i.i.i.i60, %.noexc69
  %.0.lcssa.i.i.i.i.i.i65 = phi ptr [ %i.ex, %.noexc69 ], [ %i.fa, %.lr.ph.i.i.i.i.i.i60 ]
  %i.fb = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i.i.i65, i64 16
  %.not.i23.i.i.i66 = icmp eq ptr %i.em, null
...
bb.ah:                                            ; preds = %_ZNSt6vectorISt4pairImmESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i.i64
  call void @_ZdlPvm(ptr noundef nonnull %i.em, i64 noundef %i.ep) #27
...
_ZNSt6vectorISt4pairImmESaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i67: ; preds = %bb.ah, %_ZNSt6vectorISt4pairImmESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i.i64
  store ptr %i.ex, ptr %i.ah, align 8, !tbaa !12
  store ptr %i.fb, ptr %i.ai, align 8, !tbaa !8
  %i.fc = getelementptr inbounds nuw [16 x i8], ptr %i.ex, i64 %i.ev
  store ptr %i.fc, ptr %i.aj, align 8, !tbaa !51
  br label %_ZNSt6vectorISt4pairImmESaIS1_EE9push_backEOS1_.exit70
...
_ZNSt6vectorISt4pairImmESaIS1_EE9push_backEOS1_.exit70: ; preds = %_ZNSt6vectorISt4pairImmESaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i67, %bb.ae
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #9
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #9
  %.not.i.i.i71 = icmp eq ptr %.sroa.20.0.a, null
...
bb.ai:                                            ; preds = %_ZNSt6vectorISt4pairImmESaIS1_EE9push_backEOS1_.exit70
  %i.fd = ptrtoint ptr %.sroa.088.0 to i64
  %i.fe = sub i64 %i.fd, %.pre226
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.20.0.a, i64 noundef %i.fe) #27
...
_ZNSt6vectorImSaImEED2Ev.exit:                    ; preds = %_ZNSt6vectorISt4pairImmESaIS1_EE9push_backEOS1_.exit70, %bb.ai
  ...
  %i.ff = load ptr, ptr %i.an, align 8, !tbaa !98 ; 3 uses
  %.not.i.i.i.i.i.i72 = icmp eq ptr %i.ff, null
  br i1 %.not.i.i.i.i.i.i72, label %_ZN4dmlc7istreamD1Ev.exit, label %bb.aj

bb.aj:                                            ; preds = %_ZNSt6vectorImSaImEED2Ev.exit
  %i.fg = load ptr, ptr %i.ao, align 8, !tbaa !100
  %i.fh = ptrtoint ptr %i.fg to i64
  %i.fi = ptrtoint ptr %i.ff to i64
  %i.fj = sub i64 %i.fh, %i.fi
  call void @_ZdlPvm(ptr noundef nonnull %i.ff, i64 noundef %i.fj) #27, !inline_history !101
...
_ZNKSt14default_deleteIN4dmlc6StreamEEclEPS1_.exit.i: ; preds = %_ZN4dmlc7istreamD1Ev.exit
  %i.fk = load ptr, ptr %i.bu, align 8, !tbaa !63
  %i.fl = getelementptr inbounds nuw i8, ptr %i.fk, i64 24
  %i.fm = load ptr, ptr %i.fl, align 8
  call void %i.fm(ptr noundef nonnull align 8 dereferenceable(8) %i.bu) #9, !inline_history !105
...
_ZNSt10unique_ptrIN4dmlc6StreamESt14default_deleteIS1_EED2Ev.exit: ; preds = %_ZN4dmlc7istreamD1Ev.exit, %_ZNKSt14default_deleteIN4dmlc6StreamEEclEPS1_.exit.i
  %i.fn = add nuw i64 %.021183, 1                 ; 2 uses
  %i.fo = load ptr, ptr %i.e, align 8, !tbaa !69  ; 2 uses
  %i.fp = load ptr, ptr %3, align 8, !tbaa !72    ; 3 uses
  %i.fq = ptrtoint ptr %i.fo to i64
  %i.fr = ptrtoint ptr %i.fp to i64
  %i.fs = sub i64 %i.fq, %i.fr
  %i.ft = sdiv exact i64 %i.fs, 96
  %i.fu = icmp ult i64 %i.fn, %i.ft
  br i1 %i.fu, label %bb.l, label %._crit_edge185, !llvm.loop !106

.loopexit119:                                     ; preds = %_ZNKSt6vectorISt4pairImmESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i56
  %lpad.loopexit121 = landingpad { ptr, i32 }
          cleanup
  br label %.loopexit.split-lp

.loopexit.split-lp120:                            ; preds = %bb.ag
  %lpad.loopexit.split-lp122 = landingpad { ptr, i32 }
          cleanup
  br label %.loopexit.split-lp

.loopexit.split-lp:                               ; preds = %.loopexit119, %.loopexit.split-lp120, %.loopexit, %.loopexit.split-lp.loopexit.split-lp, %.loopexit.split-lp.loopexit
  %.sroa.20.0192 = phi ptr [ %.sroa.13.0, %.loopexit.split-lp.loopexit.split-lp ], [ %.sroa.20.0.lcssa, %.loopexit ], [ %.sroa.088.0, %.loopexit.split-lp.loopexit ], [ %.sroa.088.0, %.loopexit119 ], [ %.sroa.088.0, %.loopexit.split-lp120 ]
  %.pn24 = phi { ptr, i32 } [ %lpad.loopexit.split-lp117, %.loopexit.split-lp.loopexit.split-lp ], [ %lpad.loopexit113, %.loopexit ], [ %lpad.loopexit116, %.loopexit.split-lp.loopexit ], [ %lpad.loopexit121, %.loopexit119 ], [ %lpad.loopexit.split-lp122, %.loopexit.split-lp120 ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #9
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #9
  %.not.i.i.i74 = icmp eq ptr %.sroa.20.0.a, null
...
.loopexit.split-lp._crit_edge:                    ; preds = %.loopexit.split-lp
  %.pre = ptrtoint ptr %.sroa.20.0.a to i64
  br label %bb.ak

bb.ak:                                            ; preds = %.loopexit.split-lp._crit_edge, %.thread107
  %.pre-phi = phi i64 [ %.pre, %.loopexit.split-lp._crit_edge ], [ %.pre226, %.thread107 ]
  %.sroa.20.0191 = phi ptr [ %.sroa.20.0192, %.loopexit.split-lp._crit_edge ], [ %.sroa.088.0, %.thread107 ]
  %.pn24110 = phi { ptr, i32 } [ %.pn24, %.loopexit.split-lp._crit_edge ], [ %lpad.phi, %.thread107 ]
  %i.fv = ptrtoint ptr %.sroa.20.0191 to i64
  %i.fw = sub i64 %i.fv, %.pre-phi
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.20.0.a, i64 noundef %i.fw) #27
  br label %_ZNSt6vectorImSaImEED2Ev.exit75

_ZNSt6vectorImSaImEED2Ev.exit75:                  ; preds = %.loopexit.split-lp, %bb.ak
  %.pn24111 = phi { ptr, i32 } [ %.pn24, %.loopexit.split-lp ], [ %.pn24110, %bb.ak ]
...
bb.al:                                            ; preds = %_ZNSt6vectorImSaImEED2Ev.exit75, %bb.x
  %.pn24.pn = phi { ptr, i32 } [ %.pn24111, %_ZNSt6vectorImSaImEED2Ev.exit75 ], [ %i.cv, %bb.x ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #9
...
_ZNKSt14default_deleteIN4dmlc6StreamEEclEPS1_.exit.i77: ; preds = %bb.al
  %i.fx = load ptr, ptr %i.bu, align 8, !tbaa !63
  %i.fy = getelementptr inbounds nuw i8, ptr %i.fx, i64 24
  %i.fz = load ptr, ptr %i.fy, align 8
  call void %i.fz(ptr noundef nonnull align 8 dereferenceable(8) %i.bu) #9, !inline_history !105
  br label %_ZNSt10unique_ptrIN4dmlc6StreamESt14default_deleteIS1_EED2Ev.exit78
...
bb.am:                                            ; preds = %bb.f
  ...
  call void @__clang_call_terminate(ptr %i.gb) #28
  unreachable
}
