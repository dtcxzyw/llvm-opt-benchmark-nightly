...
bb.y:                                             ; preds = %bb.p
  ...
  %.pre227 = ptrtoint ptr %.sroa.20.0.a to i64    ; 3 uses
...
.lr.ph:                                           ; preds = %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEEEvT_S7_.exit, %_ZNSt6vectorISt4pairImmESaIS1_EE9push_backEOS1_.exit
  ...
  %i.db = getelementptr inbounds nuw [8 x i8], ptr %.sroa.20.0.a, i64 %.0183
...
bb.ai:                                            ; preds = %_ZNSt6vectorISt4pairImmESaIS1_EE9push_backEOS1_.exit70
  %i.fj = ptrtoint ptr %.sroa.088.0 to i64
  %i.fk = sub i64 %i.fj, %.pre227
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.20.0.a, i64 noundef %i.fk) #27
...
.loopexit.split-lp:                               ; preds = %.loopexit120, %.loopexit.split-lp121, %.loopexit, %.loopexit.split-lp.loopexit.split-lp, %.loopexit.split-lp.loopexit
  %.sroa.20.0193 = phi ptr [ %.sroa.13.0, %.loopexit.split-lp.loopexit.split-lp ], [ %.sroa.20.0.lcssa, %.loopexit ], [ %.sroa.088.0, %.loopexit.split-lp.loopexit ], [ %.sroa.088.0, %.loopexit120 ], [ %.sroa.088.0, %.loopexit.split-lp121 ]
...
bb.ak:                                            ; preds = %.loopexit.split-lp._crit_edge, %.thread108
  ...
  %.sroa.20.0192 = phi ptr [ %.sroa.20.0193, %.loopexit.split-lp._crit_edge ], [ %.sroa.088.0, %.thread108 ]
  %.pn24111 = phi { ptr, i32 } [ %.pn24, %.loopexit.split-lp._crit_edge ], [ %lpad.phi, %.thread108 ]
  %i.gb = ptrtoint ptr %.sroa.20.0192 to i64
  %i.gc = sub i64 %i.gb, %.pre-phi
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.20.0.a, i64 noundef %i.gc) #27
