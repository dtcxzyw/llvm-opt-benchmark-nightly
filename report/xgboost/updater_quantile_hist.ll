...
.lr.ph207.split.us:                               ; preds = %.lr.ph207, %bb.s
  %.0206.us = phi i32 [ %16, %bb.s ], [ %i.al, %.lr.ph207 ] ; 3 uses
...
bb.s:                                             ; preds = %bb.r
  %spec.select.us = select i1 %i.cx, i32 %.0206.us, i32 %.034205.us ; 2 uses
  %16 = add nsw i32 %.0206.us, 1                  ; 2 uses
...
.lr.ph207.split:                                  ; preds = %.lr.ph207, %bb.af
  %.0206 = phi i32 [ %21, %bb.af ], [ %i.al, %.lr.ph207 ] ; 3 uses
...
bb.af:                                            ; preds = %bb.ae
  %spec.select = select i1 %i.gu, i32 %.0206, i32 %.034205 ; 2 uses
  %21 = add nsw i32 %.0206, 1                     ; 2 uses
...
.split.us.i:                                      ; preds = %.lr.ph.split.i
  ...
  unreachable
end_hunk_0
begin_hunk_1_@_ZNK7xgboost4tree13HistEvaluator15EnumerateOneHotERKNS_6common13HistogramCutsENS2_4SpanIKNS_6detail20GradientPairInternalIdEELm18446744073709551615EEEjiRKNS0_13TreeEvaluator14SplitEvaluatorINS0_10TrainParamEEEPNS0_19SplitEntryContainerINS0_9GradStatsEEE:bb.a
