...
bb.m:                                             ; preds = %bb.l
  ...
  %i.ew = call double @log(double noundef %i.ev) #11, !noalias !207
  %i.ex = extractelement <2 x double> %i.eu, i64 1
  %i.ey = call double @log(double noundef %i.ex) #11, !noalias !207
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %_ZNK7xgboost6common15OptionalWeightsixEm.exit79.i
  ...
  %i.ff = load i64, ptr %i.fe, align 8, !tbaa !25, !noalias !207 ; 4 uses
  %i.fg = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.ff
  %i.fh = load float, ptr %i.fg, align 4, !tbaa !49, !noalias !207
  %i.fi = getelementptr i8, ptr %i.fe, i64 -8
  %i.fj = load i64, ptr %i.fi, align 8, !tbaa !25, !noalias !207
  %i.fk = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.fj
  %i.fl = load float, ptr %i.fk, align 4, !tbaa !49, !noalias !207
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.gc = call double @log(double noundef %i.gb) #11, !noalias !207
  %i.gd = extractelement <2 x double> %i.ga, i64 1
  %i.ge = call double @log(double noundef %i.gd) #11, !noalias !207
...
bb.q:                                             ; preds = %"_ZZN7xgboost6metric11BinaryPRAUCEPKNS_7ContextENS_6common4SpanIKfLm18446744073709551615EEENS_6linalg10TensorViewIS6_Li1EEENS4_15OptionalWeightsEENK3$_0clEdddd.exit76.i", %.lr.ph.i
  ...
  %i.gn = load float, ptr %i.gm, align 4, !tbaa !49, !noalias !207 ; 2 uses
  br i1 %i.dp, label %_ZNK7xgboost6common15OptionalWeightsixEm.exit79.i, label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.go = icmp ult i64 %i.ff, %.sroa.042.0.copyload
  br i1 %i.go, label %_ZNK7xgboost6common4SpanIKfLm18446744073709551615EEixEm.exit.i77.i, label %bb.s, !prof !51
...
_ZNK7xgboost6common4SpanIKfLm18446744073709551615EEixEm.exit.i77.i: ; preds = %bb.r
  ...
  %.in.i78.i.sroa.speculate.load._ZNK7xgboost6common4SpanIKfLm18446744073709551615EEixEm.exit.i77.i = load float, ptr %i.gp, align 4, !tbaa !49, !noalias !207
...
bb.t:                                             ; preds = %bb.f
  ...
  call void @__clang_call_terminate(ptr %i.gz) #35, !noalias !207
  unreachable
...
.thread:                                          ; preds = %bb.m, %.thread.i.i.i
  ...
  store <2 x double> splat (double 1.000000e+00), ptr %i.hd, align 8, !tbaa !59, !alias.scope !208
  br label %bb.v
...
._crit_edge.thread:                               ; preds = %bb.a, %._crit_edge
  ...
  store double 1.000000e+00, ptr %i.hf, align 8, !tbaa !58
...
bb.v:                                             ; preds = %.thread, %._crit_edge.thread
  ...
  %i.hi = load ptr, ptr %i.hh, align 8, !tbaa !21
...
.body:                                            ; preds = %bb.u, %bb.g
  ...
  %i.hm = load ptr, ptr %8, align 8, !tbaa !20    ; 3 uses
...
bb.d:                                             ; preds = %_ZNKSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PN7xgboost9MetricRegEESt10_Select1stISB_ESt4lessIS5_ESaISB_EE14_M_lower_boundEPKSt13_Rb_tree_nodeISB_EPKSt18_Rb_tree_node_baseRS7_.exit.i.i
  ...
  %i.t = load i64, ptr %i.s, align 8, !tbaa !45   ; 2 uses
...
bb.h:                                             ; preds = %_ZNKSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPN7xgboost9MetricRegESt4lessIS5_ESaISt4pairIKS5_S8_EEE5countERSC_.exit.thread
  ...
  store ptr %i.af, ptr %i.ad, align 16, !tbaa !69
  %i.ag = getelementptr inbounds nuw i8, ptr %i.ad, i64 8
  store i64 0, ptr %i.ag, align 8, !tbaa !45
  %i.ah = getelementptr inbounds nuw i8, ptr %i.ad, i64 32
  %i.ai = getelementptr inbounds nuw i8, ptr %i.ad, i64 48 ; 2 uses
  store ptr %i.ai, ptr %i.ah, align 16, !tbaa !69
  store i8 0, ptr %i.ai, align 16, !tbaa !46
  ...
  store ptr %i.al, ptr %i.ak, align 8, !tbaa !69
