...
._crit_edge.i:                                    ; preds = %bb.m, %bb.j
  %.03133.1.i = phi i64 [ %i.ci, %bb.j ], [ 0, %bb.m ] ; 3 uses
...
bb.h:                                             ; preds = %._crit_edge.i
  %i.by = shl nuw nsw i64 %i.bq, 2
  %i.bz = getelementptr inbounds nuw i8, ptr %i.bj, i64 %i.by
  %i.ca = load float, ptr %i.bz, align 4, !tbaa !64
  %i.cb = fcmp uge float %i.bw, %i.ca
  br label %bb.j

bb.i:                                             ; preds = %._crit_edge.i
  %i.cc = getelementptr inbounds nuw i8, ptr %6, i64 %i.bq
  %i.cd = load i8, ptr %i.cc, align 1, !tbaa !26
  %i.ce = icmp eq i8 %i.cd, 0
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %bb.h
  %.not.1.i = phi i1 [ %i.ce, %bb.i ], [ %i.cb, %bb.h ]
  %i.cf = shl nsw i32 %i.bn, 1
  %i.cg = zext i1 %.not.1.i to i32
  %i.ch = or disjoint i32 %i.cf, %i.cg
  store i32 %i.ch, ptr %i.bm, align 4, !tbaa !80
  %i.ci = add nuw i64 %.03133.1.i, 1              ; 2 uses
  %exitcond40.1.not.i = icmp eq i64 %i.ci, %3
...
.lr.ph.preheader.i:                               ; preds = %_ZN7xgboost9predictor15ArrayTreeLayoutILb0ELb1ELi2ENS_4tree14ScalarTreeViewEE8PopulateILi0EEEvRKS3_RKNS_7RegTree22CategoricalSplitMatrixEii.exit, %bb.m
  %.03133.i = phi i64 [ %i.de, %bb.m ], [ 0, %_ZN7xgboost9predictor15ArrayTreeLayoutILb0ELb1ELi2ENS_4tree14ScalarTreeViewEE8PopulateILi0EEEvRKS3_RKNS_7RegTree22CategoricalSplitMatrixEii.exit ] ; 4 uses
  %i.cj = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.03133.i ; 2 uses
...
_ZNK7xgboost6common4SpanINS_7RegTree4FVecELm18446744073709551615EEixEm.exit.i: ; preds = %.lr.ph.preheader.i
  %i.cl = getelementptr inbounds nuw [32 x i8], ptr %2, i64 %.03133.i
  %i.cm = sext i32 %i.ck to i64                   ; 3 uses
  %i.cn = getelementptr inbounds nuw [4 x i8], ptr %i.bi, i64 %i.cm
  %i.co = load i32, ptr %i.cn, align 4, !tbaa !80
  %i.cp = zext i32 %i.co to i64
  %i.cq = load ptr, ptr %i.cl, align 8, !tbaa !59
...
bb.k:                                             ; preds = %_ZNK7xgboost6common4SpanINS_7RegTree4FVecELm18446744073709551615EEixEm.exit.i
  %i.cu = getelementptr inbounds nuw i8, ptr %6, i64 %i.cm
...
bb.l:                                             ; preds = %_ZNK7xgboost6common4SpanINS_7RegTree4FVecELm18446744073709551615EEixEm.exit.i
  %i.cx = shl nuw nsw i64 %i.cm, 2
  %i.cy = getelementptr inbounds nuw i8, ptr %i.bj, i64 %i.cx
  %i.cz = load float, ptr %i.cy, align 4, !tbaa !64
  %i.da = fcmp uge float %i.cs, %i.cz
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %bb.k
  %.not.i = phi i1 [ %i.cw, %bb.k ], [ %i.da, %bb.l ]
  %i.db = shl nuw nsw i32 %i.ck, 1
  %i.dc = zext i1 %.not.i to i32
  %i.dd = or disjoint i32 %i.db, %i.dc
  store i32 %i.dd, ptr %i.cj, align 4, !tbaa !80
  %i.de = add nuw i64 %.03133.i, 1                ; 2 uses
  %exitcond40.not.i = icmp eq i64 %i.de, %3
  br i1 %exitcond40.not.i, label %._crit_edge.i, label %.lr.ph.preheader.i, !llvm.loop !921

bb.n:                                             ; preds = %bb.n, %.lr.ph36.i.new
  %.035.i = phi i64 [ 0, %.lr.ph36.i.new ], [ %i.ec, %bb.n ] ; 5 uses
  %niter = phi i64 [ 0, %.lr.ph36.i.new ], [ %niter.next.3, %bb.n ]
  %i.df = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.035.i ; 2 uses
  %i.dg = load i32, ptr %i.df, align 4, !tbaa !80
  %i.dh = sext i32 %i.dg to i64
  %i.di = getelementptr inbounds nuw [4 x i8], ptr %i.bk, i64 %i.dh
  %i.dj = load i32, ptr %i.di, align 4, !tbaa !80
  store i32 %i.dj, ptr %i.df, align 4, !tbaa !80
  %i.dk = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.035.i
  %i.dl = getelementptr inbounds nuw i8, ptr %i.dk, i64 4 ; 2 uses
  %i.dm = load i32, ptr %i.dl, align 4, !tbaa !80
  %i.dn = sext i32 %i.dm to i64
  %i.do = getelementptr inbounds nuw [4 x i8], ptr %i.bk, i64 %i.dn
  %i.dp = load i32, ptr %i.do, align 4, !tbaa !80
  store i32 %i.dp, ptr %i.dl, align 4, !tbaa !80
  %i.dq = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.035.i
  %i.dr = getelementptr inbounds nuw i8, ptr %i.dq, i64 8 ; 2 uses
  %i.ds = load i32, ptr %i.dr, align 4, !tbaa !80
  %i.dt = sext i32 %i.ds to i64
  %i.du = getelementptr inbounds nuw [4 x i8], ptr %i.bk, i64 %i.dt
  %i.dv = load i32, ptr %i.du, align 4, !tbaa !80
  store i32 %i.dv, ptr %i.dr, align 4, !tbaa !80
  %i.dw = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.035.i
  %i.dx = getelementptr inbounds nuw i8, ptr %i.dw, i64 12 ; 2 uses
  %i.dy = load i32, ptr %i.dx, align 4, !tbaa !80
  %i.dz = sext i32 %i.dy to i64
  %i.ea = getelementptr inbounds nuw [4 x i8], ptr %i.bk, i64 %i.dz
  %i.eb = load i32, ptr %i.ea, align 4, !tbaa !80
  store i32 %i.eb, ptr %i.dx, align 4, !tbaa !80
  %i.ec = add nuw i64 %.035.i, 4                  ; 2 uses
  %niter.next.3 = add nuw i64 %niter, 4           ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
...
.epil.preheader:                                  ; preds = %_ZN7xgboost9predictor15ArrayTreeLayoutILb0ELb1ELi2ENS_4tree14ScalarTreeViewEE7ProcessENS_6common4SpanINS_7RegTree4FVecELm18446744073709551615EEEmPi.exit.loopexit.unr-lcssa, %.lr.ph36.i
  %.035.i.epil.init = phi i64 [ 0, %.lr.ph36.i ], [ %i.ec, %_ZN7xgboost9predictor15ArrayTreeLayoutILb0ELb1ELi2ENS_4tree14ScalarTreeViewEE7ProcessENS_6common4SpanINS_7RegTree4FVecELm18446744073709551615EEEmPi.exit.loopexit.unr-lcssa ]
  %lcmp.mod25 = icmp ne i64 %xtraiter, 0
  tail call void @llvm.assume(i1 %lcmp.mod25)
  br label %bb.o

bb.o:                                             ; preds = %bb.o, %.epil.preheader
  %.035.i.epil = phi i64 [ %.035.i.epil.init, %.epil.preheader ], [ %i.ei, %bb.o ] ; 2 uses
  %epil.iter = phi i64 [ 0, %.epil.preheader ], [ %epil.iter.next, %bb.o ]
  %i.ed = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.035.i.epil ; 2 uses
  %i.ee = load i32, ptr %i.ed, align 4, !tbaa !80
  %i.ef = sext i32 %i.ee to i64
  %i.eg = getelementptr inbounds nuw [4 x i8], ptr %i.bk, i64 %i.ef
  %i.eh = load i32, ptr %i.eg, align 4, !tbaa !80
  store i32 %i.eh, ptr %i.ed, align 4, !tbaa !80
  %i.ei = add nuw i64 %.035.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
...
._crit_edge.i:                                    ; preds = %bb.h, %bb.e
  %.03133.1.i = phi i64 [ %i.ab, %bb.e ], [ 0, %bb.h ] ; 3 uses
...
bb.c:                                             ; preds = %._crit_edge.i
  ...
  %i.t = load float, ptr %i.s, align 4, !tbaa !64
  %i.u = fcmp uge float %i.p, %i.t
  br label %bb.e

bb.d:                                             ; preds = %._crit_edge.i
  %i.v = getelementptr inbounds nuw i8, ptr %6, i64 %i.j
  %i.w = load i8, ptr %i.v, align 1, !tbaa !26
  %i.x = icmp eq i8 %i.w, 0
  br label %bb.e

bb.e:                                             ; preds = %bb.d, %bb.c
  %.not.1.i = phi i1 [ %i.x, %bb.d ], [ %i.u, %bb.c ]
  %i.y = shl nsw i32 %i.g, 1
  %i.z = zext i1 %.not.1.i to i32
  %i.aa = or disjoint i32 %i.y, %i.z
  store i32 %i.aa, ptr %i.f, align 4, !tbaa !80
  %i.ab = add nuw i64 %.03133.1.i, 1              ; 2 uses
  %exitcond40.1.not.i = icmp eq i64 %i.ab, %3
  br i1 %exitcond40.1.not.i, label %.lr.ph36.i, label %._crit_edge.i, !llvm.loop !1001

.lr.ph.preheader.i:                               ; preds = %bb.b, %bb.h
  %.03133.i = phi i64 [ %i.ax, %bb.h ], [ 0, %bb.b ] ; 4 uses
  %i.ac = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.03133.i ; 2 uses
  %i.ad = load i32, ptr %i.ac, align 4, !tbaa !80 ; 2 uses
  %exitcond.not.i = icmp eq i64 %.03133.i, %1
  br i1 %exitcond.not.i, label %.loopexit.i, label %_ZNK7xgboost6common4SpanINS_7RegTree4FVecELm18446744073709551615EEixEm.exit.i, !prof !179
...
_ZNK7xgboost6common4SpanINS_7RegTree4FVecELm18446744073709551615EEixEm.exit.i: ; preds = %.lr.ph.preheader.i
  %i.ae = getelementptr inbounds nuw [32 x i8], ptr %2, i64 %.03133.i
  ...
  %i.aj = load ptr, ptr %i.ae, align 8, !tbaa !59
  %i.ak = getelementptr inbounds nuw [4 x i8], ptr %i.aj, i64 %i.ai
  %i.al = load float, ptr %i.ak, align 4, !tbaa !64 ; 2 uses
  %i.am = fcmp uno float %i.al, 0.000000e+00
  br i1 %i.am, label %bb.f, label %bb.g

bb.f:                                             ; preds = %_ZNK7xgboost6common4SpanINS_7RegTree4FVecELm18446744073709551615EEixEm.exit.i
  %i.an = getelementptr inbounds nuw i8, ptr %6, i64 %i.af
  %i.ao = load i8, ptr %i.an, align 1, !tbaa !26
  %i.ap = icmp eq i8 %i.ao, 0
  br label %bb.h

bb.g:                                             ; preds = %_ZNK7xgboost6common4SpanINS_7RegTree4FVecELm18446744073709551615EEixEm.exit.i
  %i.aq = shl nuw nsw i64 %i.af, 2
  %i.ar = getelementptr inbounds nuw i8, ptr %i.c, i64 %i.aq
  %i.as = load float, ptr %i.ar, align 4, !tbaa !64
  %i.at = fcmp uge float %i.al, %i.as
  br label %bb.h

bb.h:                                             ; preds = %bb.g, %bb.f
  %.not.i = phi i1 [ %i.ap, %bb.f ], [ %i.at, %bb.g ]
  %i.au = shl nuw nsw i32 %i.ad, 1
  %i.av = zext i1 %.not.i to i32
  %i.aw = or disjoint i32 %i.au, %i.av
  store i32 %i.aw, ptr %i.ac, align 4, !tbaa !80
  %i.ax = add nuw i64 %.03133.i, 1                ; 2 uses
  %exitcond40.not.i = icmp eq i64 %i.ax, %3
  br i1 %exitcond40.not.i, label %._crit_edge.i, label %.lr.ph.preheader.i, !llvm.loop !1001

bb.i:                                             ; preds = %bb.i, %.lr.ph36.i.new
  %.035.i = phi i64 [ 0, %.lr.ph36.i.new ], [ %i.bv, %bb.i ] ; 5 uses
  %niter = phi i64 [ 0, %.lr.ph36.i.new ], [ %niter.next.3, %bb.i ]
  %i.ay = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.035.i ; 2 uses
  %i.az = load i32, ptr %i.ay, align 4, !tbaa !80
  %i.ba = sext i32 %i.az to i64
  %i.bb = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %i.ba
  %i.bc = load i32, ptr %i.bb, align 4, !tbaa !80
  store i32 %i.bc, ptr %i.ay, align 4, !tbaa !80
  %i.bd = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.035.i
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 4 ; 2 uses
  %i.bf = load i32, ptr %i.be, align 4, !tbaa !80
  %i.bg = sext i32 %i.bf to i64
  %i.bh = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %i.bg
  %i.bi = load i32, ptr %i.bh, align 4, !tbaa !80
  store i32 %i.bi, ptr %i.be, align 4, !tbaa !80
  %i.bj = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.035.i
  %i.bk = getelementptr inbounds nuw i8, ptr %i.bj, i64 8 ; 2 uses
  %i.bl = load i32, ptr %i.bk, align 4, !tbaa !80
  %i.bm = sext i32 %i.bl to i64
  %i.bn = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %i.bm
  %i.bo = load i32, ptr %i.bn, align 4, !tbaa !80
  store i32 %i.bo, ptr %i.bk, align 4, !tbaa !80
  %i.bp = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.035.i
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bp, i64 12 ; 2 uses
...
.epil.preheader:                                  ; preds = %_ZN7xgboost9predictor15ArrayTreeLayoutILb0ELb1ELi2ENS_4tree19MultiTargetTreeViewEE7ProcessENS_6common4SpanINS_7RegTree4FVecELm18446744073709551615EEEmPi.exit.loopexit.unr-lcssa, %.lr.ph36.i
  %.035.i.epil.init = phi i64 [ 0, %.lr.ph36.i ], [ %i.bv, %_ZN7xgboost9predictor15ArrayTreeLayoutILb0ELb1ELi2ENS_4tree19MultiTargetTreeViewEE7ProcessENS_6common4SpanINS_7RegTree4FVecELm18446744073709551615EEEmPi.exit.loopexit.unr-lcssa ]
...
bb.j:                                             ; preds = %bb.j, %.epil.preheader
  ...
  %i.bx = load i32, ptr %i.bw, align 4, !tbaa !80
  %i.by = sext i32 %i.bx to i64
  %i.bz = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %i.by
  %i.ca = load i32, ptr %i.bz, align 4, !tbaa !80
  store i32 %i.ca, ptr %i.bw, align 4, !tbaa !80
  %i.cb = add nuw i64 %.035.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
...
end_hunk_4
begin_hunk_5_@_ZN7xgboost9predictor15ArrayTreeLayoutILb1ELb0ELi6ENS_4tree14ScalarTreeViewEE8PopulateILi5EEEvRKS3_RKNS_7RegTree22CategoricalSplitMatrixEii:bb.a
...
._crit_edge.i:                                    ; preds = %_ZNK7xgboost6common4SpanINS_7RegTree4FVecELm18446744073709551615EEixEm.exit.i, %._crit_edge.i
  %.02728.1.i = phi i64 [ %i.bx, %._crit_edge.i ], [ 0, %_ZNK7xgboost6common4SpanINS_7RegTree4FVecELm18446744073709551615EEixEm.exit.i ] ; 3 uses
  ...
  %i.br = shl nuw nsw i64 %i.bj, 2
  %i.bs = getelementptr inbounds nuw i8, ptr %i.bc, i64 %i.br
  %i.bt = load float, ptr %i.bs, align 4, !tbaa !64
  %i.bu = fcmp uge float %i.bp, %i.bt
  %i.bv = zext i1 %i.bu to i32
  %i.bw = or disjoint i32 %i.bq, %i.bv
  store i32 %i.bw, ptr %i.bf, align 4, !tbaa !80
  %i.bx = add nuw i64 %.02728.1.i, 1              ; 2 uses
  %exitcond34.1.not.i = icmp eq i64 %i.bx, %3
...
.lr.ph.preheader.i:                               ; preds = %_ZN7xgboost9predictor15ArrayTreeLayoutILb0ELb0ELi2ENS_4tree14ScalarTreeViewEE8PopulateILi0EEEvRKS3_RKNS_7RegTree22CategoricalSplitMatrixEii.exit, %_ZNK7xgboost6common4SpanINS_7RegTree4FVecELm18446744073709551615EEixEm.exit.i
  %.02728.i = phi i64 [ %i.cp, %_ZNK7xgboost6common4SpanINS_7RegTree4FVecELm18446744073709551615EEixEm.exit.i ], [ 0, %_ZN7xgboost9predictor15ArrayTreeLayoutILb0ELb0ELi2ENS_4tree14ScalarTreeViewEE8PopulateILi0EEEvRKS3_RKNS_7RegTree22CategoricalSplitMatrixEii.exit ] ; 4 uses
...
_ZNK7xgboost6common4SpanINS_7RegTree4FVecELm18446744073709551615EEixEm.exit.i: ; preds = %.lr.ph.preheader.i
  %i.by = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.02728.i ; 2 uses
  %i.bz = load i32, ptr %i.by, align 4, !tbaa !80 ; 2 uses
  %i.ca = getelementptr inbounds nuw [32 x i8], ptr %2, i64 %.02728.i
  %i.cb = sext i32 %i.bz to i64                   ; 2 uses
  %i.cc = getelementptr inbounds nuw [4 x i8], ptr %i.bb, i64 %i.cb
  %i.cd = load i32, ptr %i.cc, align 4, !tbaa !80
  %i.ce = zext i32 %i.cd to i64
  %i.cf = load ptr, ptr %i.ca, align 8, !tbaa !59
  %i.cg = getelementptr inbounds nuw [4 x i8], ptr %i.cf, i64 %i.ce
  %i.ch = load float, ptr %i.cg, align 4, !tbaa !64
  %i.ci = shl nuw nsw i32 %i.bz, 1
  %i.cj = shl nuw nsw i64 %i.cb, 2
  %i.ck = getelementptr inbounds nuw i8, ptr %i.bc, i64 %i.cj
  %i.cl = load float, ptr %i.ck, align 4, !tbaa !64
  %i.cm = fcmp uge float %i.ch, %i.cl
  %i.cn = zext i1 %i.cm to i32
  %i.co = or disjoint i32 %i.ci, %i.cn
  store i32 %i.co, ptr %i.by, align 4, !tbaa !80
  %i.cp = add nuw i64 %.02728.i, 1                ; 2 uses
  %exitcond34.not.i = icmp eq i64 %i.cp, %3
  br i1 %exitcond34.not.i, label %._crit_edge.i, label %.lr.ph.preheader.i, !llvm.loop !1038

bb.h:                                             ; preds = %bb.h, %.lr.ph31.i.new
  %.030.i = phi i64 [ 0, %.lr.ph31.i.new ], [ %i.dn, %bb.h ] ; 5 uses
  %niter = phi i64 [ 0, %.lr.ph31.i.new ], [ %niter.next.3, %bb.h ]
  %i.cq = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.030.i ; 2 uses
  %i.cr = load i32, ptr %i.cq, align 4, !tbaa !80
  %i.cs = sext i32 %i.cr to i64
  %i.ct = getelementptr inbounds nuw [4 x i8], ptr %i.bd, i64 %i.cs
  %i.cu = load i32, ptr %i.ct, align 4, !tbaa !80
  store i32 %i.cu, ptr %i.cq, align 4, !tbaa !80
  %i.cv = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.030.i
  %i.cw = getelementptr inbounds nuw i8, ptr %i.cv, i64 4 ; 2 uses
  %i.cx = load i32, ptr %i.cw, align 4, !tbaa !80
  %i.cy = sext i32 %i.cx to i64
  %i.cz = getelementptr inbounds nuw [4 x i8], ptr %i.bd, i64 %i.cy
  %i.da = load i32, ptr %i.cz, align 4, !tbaa !80
  store i32 %i.da, ptr %i.cw, align 4, !tbaa !80
  %i.db = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.030.i
  %i.dc = getelementptr inbounds nuw i8, ptr %i.db, i64 8 ; 2 uses
  %i.dd = load i32, ptr %i.dc, align 4, !tbaa !80
  %i.de = sext i32 %i.dd to i64
  %i.df = getelementptr inbounds nuw [4 x i8], ptr %i.bd, i64 %i.de
  %i.dg = load i32, ptr %i.df, align 4, !tbaa !80
  store i32 %i.dg, ptr %i.dc, align 4, !tbaa !80
  %i.dh = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.030.i
  %i.di = getelementptr inbounds nuw i8, ptr %i.dh, i64 12 ; 2 uses
  %i.dj = load i32, ptr %i.di, align 4, !tbaa !80
  %i.dk = sext i32 %i.dj to i64
  %i.dl = getelementptr inbounds nuw [4 x i8], ptr %i.bd, i64 %i.dk
  %i.dm = load i32, ptr %i.dl, align 4, !tbaa !80
  store i32 %i.dm, ptr %i.di, align 4, !tbaa !80
  %i.dn = add nuw i64 %.030.i, 4                  ; 2 uses
  %niter.next.3 = add nuw i64 %niter, 4           ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
...
.epil.preheader:                                  ; preds = %_ZN7xgboost9predictor15ArrayTreeLayoutILb0ELb0ELi2ENS_4tree14ScalarTreeViewEE7ProcessENS_6common4SpanINS_7RegTree4FVecELm18446744073709551615EEEmPi.exit.loopexit.unr-lcssa, %.lr.ph31.i
  %.030.i.epil.init = phi i64 [ 0, %.lr.ph31.i ], [ %i.dn, %_ZN7xgboost9predictor15ArrayTreeLayoutILb0ELb0ELi2ENS_4tree14ScalarTreeViewEE7ProcessENS_6common4SpanINS_7RegTree4FVecELm18446744073709551615EEEmPi.exit.loopexit.unr-lcssa ]
  %lcmp.mod22 = icmp ne i64 %xtraiter, 0
  tail call void @llvm.assume(i1 %lcmp.mod22)
  br label %bb.i

bb.i:                                             ; preds = %bb.i, %.epil.preheader
  %.030.i.epil = phi i64 [ %.030.i.epil.init, %.epil.preheader ], [ %i.dt, %bb.i ] ; 2 uses
  %epil.iter = phi i64 [ 0, %.epil.preheader ], [ %epil.iter.next, %bb.i ]
  %i.do = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.030.i.epil ; 2 uses
  %i.dp = load i32, ptr %i.do, align 4, !tbaa !80
  %i.dq = sext i32 %i.dp to i64
  %i.dr = getelementptr inbounds nuw [4 x i8], ptr %i.bd, i64 %i.dq
  %i.ds = load i32, ptr %i.dr, align 4, !tbaa !80
  store i32 %i.ds, ptr %i.do, align 4, !tbaa !80
  %i.dt = add nuw i64 %.030.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
...
end_hunk_5
begin_hunk_6_@_ZN7xgboost9predictor16ProcessArrayTreeILb0ELb0ELi1ENS_4tree19MultiTargetTreeViewEEEvRKT2_NS_6common4SpanINS_7RegTree4FVecELm18446744073709551615EEEmPii:bb.a
...
._crit_edge.i:                                    ; preds = %_ZNK7xgboost6common4SpanINS_7RegTree4FVecELm18446744073709551615EEixEm.exit.i, %._crit_edge.i
  %.02728.1.i = phi i64 [ %i.bv, %._crit_edge.i ], [ 0, %_ZNK7xgboost6common4SpanINS_7RegTree4FVecELm18446744073709551615EEixEm.exit.i ] ; 3 uses
  ...
  %i.bp = shl nuw nsw i64 %i.bh, 2
  %i.bq = getelementptr inbounds nuw i8, ptr %i.ba, i64 %i.bp
  %i.br = load float, ptr %i.bq, align 4, !tbaa !64
  %i.bs = fcmp uge float %i.bn, %i.br
  %i.bt = zext i1 %i.bs to i32
  %i.bu = or disjoint i32 %i.bo, %i.bt
  store i32 %i.bu, ptr %i.bd, align 4, !tbaa !80
  %i.bv = add nuw i64 %.02728.1.i, 1              ; 2 uses
  %exitcond34.1.not.i = icmp eq i64 %i.bv, %3
...
.lr.ph.preheader.i:                               ; preds = %_ZN7xgboost9predictor15ArrayTreeLayoutILb0ELb0ELi2ENS_4tree19MultiTargetTreeViewEE8PopulateILi0EEEvRKS3_RKNS_7RegTree22CategoricalSplitMatrixEii.exit, %_ZNK7xgboost6common4SpanINS_7RegTree4FVecELm18446744073709551615EEixEm.exit.i
  %.02728.i = phi i64 [ %i.cn, %_ZNK7xgboost6common4SpanINS_7RegTree4FVecELm18446744073709551615EEixEm.exit.i ], [ 0, %_ZN7xgboost9predictor15ArrayTreeLayoutILb0ELb0ELi2ENS_4tree19MultiTargetTreeViewEE8PopulateILi0EEEvRKS3_RKNS_7RegTree22CategoricalSplitMatrixEii.exit ] ; 4 uses
  %exitcond.not.i = icmp eq i64 %.02728.i, %1
  br i1 %exitcond.not.i, label %.loopexit.i, label %_ZNK7xgboost6common4SpanINS_7RegTree4FVecELm18446744073709551615EEixEm.exit.i, !prof !179
...
_ZNK7xgboost6common4SpanINS_7RegTree4FVecELm18446744073709551615EEixEm.exit.i: ; preds = %.lr.ph.preheader.i
  %i.bw = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.02728.i ; 2 uses
  %i.bx = load i32, ptr %i.bw, align 4, !tbaa !80 ; 2 uses
  %i.by = getelementptr inbounds nuw [32 x i8], ptr %2, i64 %.02728.i
  %i.bz = sext i32 %i.bx to i64                   ; 2 uses
  %i.ca = getelementptr inbounds nuw [4 x i8], ptr %i.az, i64 %i.bz
  %i.cb = load i32, ptr %i.ca, align 4, !tbaa !80
  %i.cc = zext i32 %i.cb to i64
  %i.cd = load ptr, ptr %i.by, align 8, !tbaa !59
  %i.ce = getelementptr inbounds nuw [4 x i8], ptr %i.cd, i64 %i.cc
  %i.cf = load float, ptr %i.ce, align 4, !tbaa !64
  %i.cg = shl nuw nsw i32 %i.bx, 1
  %i.ch = shl nuw nsw i64 %i.bz, 2
  %i.ci = getelementptr inbounds nuw i8, ptr %i.ba, i64 %i.ch
  %i.cj = load float, ptr %i.ci, align 4, !tbaa !64
  %i.ck = fcmp uge float %i.cf, %i.cj
  %i.cl = zext i1 %i.ck to i32
  %i.cm = or disjoint i32 %i.cg, %i.cl
  store i32 %i.cm, ptr %i.bw, align 4, !tbaa !80
  %i.cn = add nuw i64 %.02728.i, 1                ; 2 uses
  %exitcond34.not.i = icmp eq i64 %i.cn, %3
  br i1 %exitcond34.not.i, label %._crit_edge.i, label %.lr.ph.preheader.i, !llvm.loop !1108

bb.h:                                             ; preds = %bb.h, %.lr.ph31.i.new
  %.030.i = phi i64 [ 0, %.lr.ph31.i.new ], [ %i.dl, %bb.h ] ; 5 uses
  %niter = phi i64 [ 0, %.lr.ph31.i.new ], [ %niter.next.3, %bb.h ]
  %i.co = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.030.i ; 2 uses
  %i.cp = load i32, ptr %i.co, align 4, !tbaa !80
  %i.cq = sext i32 %i.cp to i64
  %i.cr = getelementptr inbounds nuw [4 x i8], ptr %i.bb, i64 %i.cq
  %i.cs = load i32, ptr %i.cr, align 4, !tbaa !80
  store i32 %i.cs, ptr %i.co, align 4, !tbaa !80
  %i.ct = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.030.i
  %i.cu = getelementptr inbounds nuw i8, ptr %i.ct, i64 4 ; 2 uses
  %i.cv = load i32, ptr %i.cu, align 4, !tbaa !80
  %i.cw = sext i32 %i.cv to i64
  %i.cx = getelementptr inbounds nuw [4 x i8], ptr %i.bb, i64 %i.cw
  %i.cy = load i32, ptr %i.cx, align 4, !tbaa !80
  store i32 %i.cy, ptr %i.cu, align 4, !tbaa !80
  %i.cz = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.030.i
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 8 ; 2 uses
  %i.db = load i32, ptr %i.da, align 4, !tbaa !80
  %i.dc = sext i32 %i.db to i64
  %i.dd = getelementptr inbounds nuw [4 x i8], ptr %i.bb, i64 %i.dc
  %i.de = load i32, ptr %i.dd, align 4, !tbaa !80
  store i32 %i.de, ptr %i.da, align 4, !tbaa !80
  %i.df = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.030.i
  %i.dg = getelementptr inbounds nuw i8, ptr %i.df, i64 12 ; 2 uses
  %i.dh = load i32, ptr %i.dg, align 4, !tbaa !80
  %i.di = sext i32 %i.dh to i64
  %i.dj = getelementptr inbounds nuw [4 x i8], ptr %i.bb, i64 %i.di
  %i.dk = load i32, ptr %i.dj, align 4, !tbaa !80
  store i32 %i.dk, ptr %i.dg, align 4, !tbaa !80
  %i.dl = add nuw i64 %.030.i, 4                  ; 2 uses
  %niter.next.3 = add nuw i64 %niter, 4           ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
...
.epil.preheader:                                  ; preds = %_ZN7xgboost9predictor15ArrayTreeLayoutILb0ELb0ELi2ENS_4tree19MultiTargetTreeViewEE7ProcessENS_6common4SpanINS_7RegTree4FVecELm18446744073709551615EEEmPi.exit.loopexit.unr-lcssa, %.lr.ph31.i
  %.030.i.epil.init = phi i64 [ 0, %.lr.ph31.i ], [ %i.dl, %_ZN7xgboost9predictor15ArrayTreeLayoutILb0ELb0ELi2ENS_4tree19MultiTargetTreeViewEE7ProcessENS_6common4SpanINS_7RegTree4FVecELm18446744073709551615EEEmPi.exit.loopexit.unr-lcssa ]
  %lcmp.mod22 = icmp ne i64 %xtraiter, 0
  tail call void @llvm.assume(i1 %lcmp.mod22)
  br label %bb.i

bb.i:                                             ; preds = %bb.i, %.epil.preheader
  %.030.i.epil = phi i64 [ %.030.i.epil.init, %.epil.preheader ], [ %i.dr, %bb.i ] ; 2 uses
  %epil.iter = phi i64 [ 0, %.epil.preheader ], [ %epil.iter.next, %bb.i ]
  %i.dm = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %.030.i.epil ; 2 uses
  %i.dn = load i32, ptr %i.dm, align 4, !tbaa !80
  %i.do = sext i32 %i.dn to i64
  %i.dp = getelementptr inbounds nuw [4 x i8], ptr %i.bb, i64 %i.do
  %i.dq = load i32, ptr %i.dp, align 4, !tbaa !80
  store i32 %i.dq, ptr %i.dm, align 4, !tbaa !80
  %i.dr = add nuw i64 %.030.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
