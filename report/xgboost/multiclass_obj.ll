...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %i.af, align 4, !tbaa !146
  %wide.load163 = load <4 x float>, ptr %i.ag, align 4, !tbaa !146
  %10 = freeze <4 x float> %wide.load             ; 2 uses
  %11 = freeze <4 x float> %wide.load163          ; 2 uses
  %i.ah = call nsz <4 x float> @llvm.maxnum.v4f32(<4 x float> %10, <4 x float> %vec.phi) ; 2 uses
  %i.ai = call nsz <4 x float> @llvm.maxnum.v4f32(<4 x float> %11, <4 x float> %vec.phi162) ; 2 uses
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.aj = fcmp uno <4 x float> %10, %11
  %i.ak = bitcast <4 x i1> %i.aj to i4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %i.p, align 4, !tbaa !146
  %wide.load60 = load <4 x float>, ptr %i.q, align 4, !tbaa !146
  %2 = freeze <4 x float> %wide.load              ; 2 uses
  %3 = freeze <4 x float> %wide.load60            ; 2 uses
  %i.r = tail call nsz <4 x float> @llvm.maxnum.v4f32(<4 x float> %2, <4 x float> %vec.phi) ; 2 uses
  %i.s = tail call nsz <4 x float> @llvm.maxnum.v4f32(<4 x float> %3, <4 x float> %vec.phi59) ; 2 uses
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.t = fcmp uno <4 x float> %2, %3
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %i.q, align 4, !tbaa !146
  %wide.load83 = load <4 x float>, ptr %i.r, align 4, !tbaa !146
  %4 = freeze <4 x float> %wide.load              ; 2 uses
  %5 = freeze <4 x float> %wide.load83            ; 2 uses
  %i.s = tail call nsz <4 x float> @llvm.maxnum.v4f32(<4 x float> %4, <4 x float> %vec.phi) ; 2 uses
  %i.t = tail call nsz <4 x float> @llvm.maxnum.v4f32(<4 x float> %5, <4 x float> %vec.phi82) ; 2 uses
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.u = fcmp uno <4 x float> %4, %5
