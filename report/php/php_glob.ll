...
bb.d:                                             ; preds = %bb.b, %bb.c, %bb.a
  ...
  store i32 %i.f, ptr %i.g, align 8, !tbaa !22
  ...
  %i.j = tail call i64 @strnlen(ptr noundef nonnull dereferenceable(1) %0, i64 noundef 4096) #20
...
bb.f:                                             ; preds = %bb.e
  %i.o = load i64, ptr %3, align 8, !tbaa !20     ; 2 uses
...
.preheader60:                                     ; preds = %bb.g, %bb.h
  ...
  %i.s = load i8, ptr %.04162, align 1, !tbaa !25 ; 2 uses
...
.preheader60.1:                                   ; preds = %.preheader60
  ...
  store i16 %i.u, ptr %.0.ptr64, align 2, !tbaa !27
...
bb.h:                                             ; preds = %.preheader60.2
  ...
  store i16 %i.ac, ptr %.0.ptr64.2, align 2, !tbaa !27
  %i.ad = icmp samesign ult i64 %.0.idx63, 8184
  br i1 %i.ad, label %.preheader60, label %.critedge, !llvm.loop !41
...
.preheader:                                       ; preds = %bb.g, %bb.n
  ...
  %i.af = load i8, ptr %.14265, align 1, !tbaa !25 ; 2 uses
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  store i16 %storemerge, ptr %.1.ptr67, align 4, !tbaa !27
...
.preheader.1:                                     ; preds = %bb.k
  ...
  %i.ao = load i8, ptr %.344, align 1, !tbaa !25  ; 2 uses
...
bb.l:                                             ; preds = %.preheader.1
  ...
  %i.aq = load i8, ptr %i.an, align 1, !tbaa !25  ; 2 uses
...
bb.n:                                             ; preds = %bb.m, %bb.l
  ...
  store i16 %storemerge.1, ptr %.1.ptr67.1, align 2, !tbaa !27
  br label %.preheader
...
bb.a:
  ...
  %i.b = load i16, ptr %0, align 2, !tbaa !27
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = load i16, ptr %i.d, align 2, !tbaa !27
...
bb.e:                                             ; preds = %.preheader93, %bb.f
  ...
  %i.k = load i16, ptr %.04.i, align 2, !tbaa !27 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %.not.i, label %bb.t, label %bb.e, !llvm.loop !0
...
.lr.ph.preheader:                                 ; preds = %g_strchr.exit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 %i.a, ptr nonnull align 2 %0, i64 %i.n, i1 false), !tbaa !27
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %.lr.ph.preheader, %g_strchr.exit
  ...
  store i16 0, ptr %.069.i.lcssa, align 2, !tbaa !27
...
bb.g:                                             ; preds = %bb.k, %._crit_edge
  ...
  %i.p = load i16, ptr %.066.i, align 2, !tbaa !27
...
.preheader31:                                     ; preds = %bb.g, %.preheader31
  ...
  %i.q = load i16, ptr %.167.i, align 2, !tbaa !27 ; 2 uses
...
.thread:                                          ; preds = %bb.g
  %i.v = call fastcc i32 @glob0(ptr noundef %i.a, ptr noundef %1, ptr noundef nonnull %2), !inline_history !44
...
.lr.ph47:                                         ; preds = %.preheader30, %bb.s
  ...
  %.060.i4675 = ptrtoaddr ptr %.060.i46 to i64    ; 2 uses
  %i.w = load i16, ptr %.162.i45, align 2, !tbaa !27
...
.preheader:                                       ; preds = %.lr.ph47, %.preheader
  ...
  %i.x = load i16, ptr %.263.i, align 2, !tbaa !27 ; 2 uses
...
iter.check:                                       ; preds = %bb.p
  ...
  %i.ad = add i64 %i.ac, %.162.i4576              ; 3 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x i16>, ptr %next.gep, align 2, !tbaa !27
  %wide.load79 = load <8 x i16>, ptr %i.am, align 2, !tbaa !27
  %i.an = getelementptr i8, ptr %next.gep78, i64 16
  store <8 x i16> %wide.load, ptr %next.gep78, align 2, !tbaa !27
  store <8 x i16> %wide.load79, ptr %i.an, align 2, !tbaa !27
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph41.preheader, label %vec.epilog.ph, !prof !51
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load85 = load <4 x i16>, ptr %next.gep83, align 2, !tbaa !27
  store <4 x i16> %wide.load85, ptr %next.gep84, align 2, !tbaa !27
...
.lr.ph41:                                         ; preds = %.lr.ph41.preheader, %.lr.ph41
  ...
  %i.av = load i16, ptr %.1.i39, align 2, !tbaa !27
  %i.aw = getelementptr inbounds nuw i8, ptr %.170.i38, i64 2 ; 2 uses
  store i16 %i.av, ptr %.170.i38, align 2, !tbaa !27
  %i.ax = icmp ult ptr %i.au, %.162.i45
  br i1 %i.ax, label %.lr.ph41, label %.preheader29.preheader, !llvm.loop !48
...
.preheader29:                                     ; preds = %.preheader29.preheader, %.preheader29
  ...
  %i.ay = load i16, ptr %.2.i, align 2, !tbaa !27 ; 2 uses
  %i.az = getelementptr inbounds nuw i8, ptr %.271.i, i64 2
  store i16 %i.ay, ptr %.271.i, align 2, !tbaa !27
  %.not91.i = icmp eq i16 %i.ay, 0
  br i1 %.not91.i, label %bb.q, label %.preheader29, !llvm.loop !49

bb.q:                                             ; preds = %.preheader29
  %i.ba = call fastcc i32 @globexp1(ptr noundef %i.a, ptr noundef %1, ptr noundef nonnull %2), !inline_history !44 ; 2 uses
...
bb.s:                                             ; preds = %bb.l, %.lr.ph47, %bb.n, %.critedge2.i, %bb.r, %bb.o
  ...
  br i1 %.not88.i, label %globexp2.exit, label %.lr.ph47, !llvm.loop !50
...
bb.a:
  ...
  %i.e = load i16, ptr %0, align 2, !tbaa !27
...
bb.c:                                             ; preds = %bb.h, %.preheader.i
  ...
  %i.i = load i16, ptr %.03451.i, align 2, !tbaa !27 ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  store i8 %i.j, ptr %.036.ptr52.i, align 1, !tbaa !25
  ...
  %i.l = load i16, ptr %.034.i, align 2, !tbaa !27 ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  store i8 %i.m, ptr %.036.ptr52.i.1, align 1, !tbaa !25
  ...
  %i.o = load i16, ptr %.034.i.1, align 2, !tbaa !27 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  store i8 %i.p, ptr %.036.ptr52.i.2, align 1, !tbaa !25
  ...
  %i.r = load i16, ptr %.034.i.2, align 2, !tbaa !27 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  store i8 %i.s, ptr %.036.ptr52.i.3, align 1, !tbaa !25
  ...
  %i.u = load i16, ptr %.034.i.3, align 2, !tbaa !27 ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  store i8 %i.v, ptr %.036.ptr52.i.4, align 1, !tbaa !25
  %.034.i.4 = getelementptr inbounds nuw i8, ptr %.03451.i, i64 10 ; 2 uses
  %exitcond.not.i.4 = icmp eq i64 %.036.add.i.4, 8190
  br i1 %exitcond.not.i.4, label %.critedge.i, label %bb.c, !llvm.loop !52
...
.critedge.i:                                      ; preds = %bb.c, %bb.c, %bb.h, %.critedge.i.split.loop.exit461, %.critedge.i.split.loop.exit458, %.critedge.i.split.loop.exit455, %.critedge.i.split.loop.exit452
  ...
  store i8 0, ptr %.036.ptr.lcssa.i, align 1, !tbaa !25
  %i.w = load i8, ptr %i.d, align 16, !tbaa !25
  %i.x = icmp eq i8 %i.w, 0
  br i1 %i.x, label %bb.i, label %bb.k

bb.i:                                             ; preds = %.critedge.i
  %i.y = tail call ptr @getenv(ptr noundef nonnull @.str) #19 ; 2 uses
  %i.z = icmp eq ptr %i.y, null
  br i1 %i.z, label %bb.j, label %.preheader

bb.j:                                             ; preds = %bb.i
  %i.aa = tail call i32 @getuid() #19
  %i.ab = call i32 @getpwuid_r(i32 noundef %i.aa, ptr noundef nonnull %3, ptr noundef nonnull %i.c, i64 noundef 4096, ptr noundef nonnull %i.b) #19 ; 0 uses
  %i.ac = load ptr, ptr %i.b, align 8, !tbaa !68  ; 2 uses
...
.lr.ph192:                                        ; preds = %.lr.ph192.unr-lcssa, %.epil.preheader
  ...
  %i.ih = load ptr, ptr %i.ig, align 8, !tbaa !32 ; 6 uses
  %i.ii = getelementptr inbounds nuw i8, ptr %1, i64 40
  %i.ij = load ptr, ptr %i.ii, align 8, !tbaa !33 ; 6 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <4 x ptr>, ptr %i.is, align 8, !tbaa !72 ; 2 uses
  ...
  %wide.vec351 = load <4 x ptr>, ptr %i.iu, align 8, !tbaa !72 ; 2 uses
  ...
  store <2 x ptr> %strided.vec, ptr %i.iw, align 8, !tbaa !34, !alias.scope !73, !noalias !74
  store <2 x ptr> %strided.vec352, ptr %i.ix, align 8, !tbaa !34, !alias.scope !73, !noalias !74
  %i.iy = getelementptr inbounds nuw [8 x i8], ptr %i.ij, i64 %i.iv ; 2 uses
  %i.iz = getelementptr inbounds nuw i8, ptr %i.iy, i64 16
  store <2 x ptr> %strided.vec350, ptr %i.iy, align 8, !tbaa !38, !alias.scope !75, !noalias !76
  store <2 x ptr> %strided.vec353, ptr %i.iz, align 8, !tbaa !38, !alias.scope !75, !noalias !76
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ja = icmp eq i64 %index.next, %n.vec
  br i1 %i.ja, label %middle.block, label %vector.body, !llvm.loop !65
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader
  ...
  store ptr %i.jf, ptr %i.jh, align 8, !tbaa !34
  %i.ji = getelementptr inbounds nuw i8, ptr %i.je, i64 8
  %i.jj = load ptr, ptr %i.ji, align 8, !tbaa !71
  %i.jk = getelementptr inbounds nuw [8 x i8], ptr %i.ij, i64 %i.jg
  store ptr %i.jj, ptr %i.jk, align 8, !tbaa !38
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.ka = load ptr, ptr %i.jz, align 8, !tbaa !71
  ...
  br i1 %exitcond212.not.1, label %._crit_edge193, label %scalar.ph, !llvm.loop !66

._crit_edge193:                                   ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  call void @free(ptr noundef nonnull %i.hd) #19
  br label %.critedge101
...
bb.br:                                            ; preds = %bb.bo
  ...
  %i.kg = load i64, ptr %i.kf, align 8, !tbaa !21
  ...
  call void @qsort(ptr noundef %i.ki, i64 noundef %i.kj, i64 noundef 8, ptr noundef nonnull @compare) #19
  br label %.critedge101
...
.preheader:                                       ; preds = %bb.c
  %i.m = load i64, ptr %0, align 8, !tbaa !20
...
.lr.ph24:                                         ; preds = %.preheader, %.lr.ph24
  ...
  %i.n = load ptr, ptr %i.k, align 8, !tbaa !33
  ...
  br i1 %i.s, label %.lr.ph24, label %._crit_edge25.loopexit, !llvm.loop !78

._crit_edge25.loopexit:                           ; preds = %.lr.ph24
  %.pre27 = load ptr, ptr %i.k, align 8, !tbaa !33
  br label %._crit_edge25

._crit_edge25:                                    ; preds = %._crit_edge25.loopexit, %.preheader
  %i.t = phi ptr [ %.pre27, %._crit_edge25.loopexit ], [ %i.l, %.preheader ]
  tail call void @free(ptr noundef %i.t) #19
  store ptr null, ptr %i.k, align 8, !tbaa !33
  br label %bb.d
...
bb.c:                                             ; preds = %bb.o, %bb.l, %bb.a, %bb.b
  %i.i = load i64, ptr %i.b, align 8, !tbaa !21   ; 2 uses
...
bb.d:                                             ; preds = %.lr.ph, %bb.k
  ...
  %i.n = load ptr, ptr %i.k, align 8, !tbaa !32   ; 2 uses
...
bb.g:                                             ; preds = %bb.f, %bb.e, %bb.d
  %i.q = load i32, ptr %i.l, align 8, !tbaa !22
  %i.r = and i32 %i.q, 16384
  %.not125 = icmp eq i32 %i.r, 0
  br i1 %.not125, label %bb.k, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.s = load ptr, ptr %i.k, align 8, !tbaa !32   ; 2 uses
...
bb.l:                                             ; preds = %bb.b
  ...
  %i.af = tail call ptr @reallocarray(ptr noundef %i.ae, i64 noundef %i.e, i64 noundef 8) #19 ; 5 uses
  %i.ag = icmp eq ptr %i.af, null
...
bb.n:                                             ; preds = %bb.m
  %i.aj = load i64, ptr %i.b, align 8, !tbaa !21  ; 2 uses
...
.loopexit130.loopexit:                            ; preds = %bb.n
  ...
  tail call void @llvm.memset.p0.i64(ptr nonnull align 8 %i.af, i8 0, i64 %i.ak, i1 false), !tbaa !34
...
bb.o:                                             ; preds = %.loopexit130
  ...
  %i.aq = tail call ptr @reallocarray(ptr noundef %i.ap, i64 noundef %i.e, i64 noundef 8) #19 ; 6 uses
  %i.ar = icmp eq ptr %i.aq, null
  br i1 %i.ar, label %bb.c, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.as = load ptr, ptr %i.ao, align 8, !tbaa !33
  %i.at = icmp eq ptr %i.as, null
  br i1 %i.at, label %bb.q, label %.loopexit

bb.q:                                             ; preds = %bb.p
  %i.au = load i64, ptr %i.b, align 8, !tbaa !21  ; 2 uses
...
.loopexit.loopexit:                               ; preds = %bb.q
  ...
  tail call void @llvm.memset.p0.i64(ptr nonnull align 8 %i.aq, i8 0, i64 %i.av, i1 false), !tbaa !38
  br label %.loopexit
...
bb.r:                                             ; preds = %.loopexit
  %i.ax = load i64, ptr %i.b, align 8, !tbaa !21  ; 2 uses
  %i.ay = load i64, ptr %1, align 8, !tbaa !20    ; 2 uses
...
bb.s:                                             ; preds = %.loopexit
  %i.bb = load i64, ptr %2, align 8, !tbaa !81
  %i.bc = add i64 %i.bb, 144                      ; 2 uses
  store i64 %i.bc, ptr %2, align 8, !tbaa !81
  %i.bd = load i32, ptr %i.al, align 8, !tbaa !22
...
bb.t:                                             ; preds = %bb.s
  %i.bg = tail call ptr @__errno_location() #22
  store i32 0, ptr %i.bg, align 4, !tbaa !40
  br label %bb.ae

bb.u:                                             ; preds = %bb.s
  %i.bh = tail call noalias dereferenceable_or_null(144) ptr @malloc(i64 noundef 144) #23 ; 3 uses
  %i.bi = load i64, ptr %i.b, align 8, !tbaa !21  ; 2 uses
  %i.bj = load i64, ptr %1, align 8, !tbaa !20    ; 2 uses
  %i.bk = getelementptr [8 x i8], ptr %i.aq, i64 %i.bi
  %i.bl = getelementptr [8 x i8], ptr %i.bk, i64 %i.bj
  store ptr %i.bh, ptr %i.bl, align 8, !tbaa !38
...
bb.w:                                             ; preds = %bb.v, %bb.r
  ...
  store ptr null, ptr %i.br, align 8, !tbaa !38
...
bb.x:                                             ; preds = %.preheader158, %bb.x
  ...
  %i.bt = load i16, ptr %.097, align 2, !tbaa !27
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.by = load i64, ptr %2, align 8, !tbaa !81
  %i.bz = add i64 %i.by, %i.bx                    ; 2 uses
  store i64 %i.bz, ptr %2, align 8, !tbaa !81
  %i.ca = tail call noalias ptr @malloc(i64 noundef %i.bx) #23 ; 6 uses
...
._crit_edge138:                                   ; preds = %bb.y
  ...
  %.pre139 = load i64, ptr %1, align 8, !tbaa !20
  br label %bb.aa
...
.preheader:                                       ; preds = %.lr.ph157
  ...
  br i1 %.not.i, label %g_Ctoc.exit, label %.lr.ph157, !llvm.loop !1
...
.lr.ph157:                                        ; preds = %bb.y, %.preheader
  ...
  %i.ce = load i16, ptr %.04.i154, align 2, !tbaa !27
  %i.cf = trunc i16 %i.ce to i8                   ; 2 uses
  store i8 %i.cf, ptr %.03.i155, align 1, !tbaa !25
  %i.cg = icmp eq i8 %i.cf, 0
  br i1 %i.cg, label %bb.z, label %.preheader, !llvm.loop !1

g_Ctoc.exit:                                      ; preds = %.preheader
  tail call void @free(ptr noundef %i.ca) #19
  br label %bb.ae

bb.z:                                             ; preds = %.lr.ph157
  %i.ch = load i64, ptr %i.b, align 8, !tbaa !21  ; 2 uses
  %i.ci = load i64, ptr %1, align 8, !tbaa !20    ; 2 uses
  %i.cj = add i64 %i.ci, 1                        ; 2 uses
  store i64 %i.cj, ptr %1, align 8, !tbaa !20
  %i.ck = getelementptr [8 x i8], ptr %i.af, i64 %i.ch
  %i.cl = getelementptr [8 x i8], ptr %i.ck, i64 %i.ci
  store ptr %i.ca, ptr %i.cl, align 8, !tbaa !34
  br label %bb.aa
...
bb.aa:                                            ; preds = %._crit_edge138, %bb.z
  ...
  store ptr null, ptr %i.cp, align 8, !tbaa !34
  %i.cq = load i32, ptr %i.al, align 8, !tbaa !22
...
bb.ac:                                            ; preds = %bb.ab
  ...
  store i32 0, ptr %i.cv, align 4, !tbaa !40
  br label %bb.ae
...
bb.a:
  ...
  %i.b = load ptr, ptr %1, align 8, !tbaa !37
  %i.c = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %i.a, ptr noundef nonnull dereferenceable(1) %i.b) #20
  ret i32 %i.c
}
...
bb.a:
  ...
  %.pr = load i16, ptr %3, align 2, !tbaa !27     ; 2 uses
...
._crit_edge:                                      ; preds = %.loopexit14, %bb.a
  ...
  store i16 0, ptr %.049.lcssa, align 2, !tbaa !27
  %i.g = getelementptr inbounds nuw i8, ptr %4, i64 24 ; 2 uses
  %i.h = load i32, ptr %i.g, align 8, !tbaa !22   ; 2 uses
...
bb.b:                                             ; preds = %._crit_edge
  ...
  %i.l = add i64 %i.k, 1
  store i64 %i.l, ptr %i.j, align 8, !tbaa !92
  %i.m = icmp ugt i64 %i.k, 2047
  br i1 %i.m, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  %i.n = tail call ptr @__errno_location() #22
  store i32 0, ptr %i.n, align 4, !tbaa !40
  %i.o = getelementptr inbounds nuw i8, ptr %.049.lcssa, i64 2
  store i16 47, ptr %.049.lcssa, align 2, !tbaa !27
  store i16 0, ptr %i.o, align 2, !tbaa !27
  br label %.loopexit15
...
bb.h:                                             ; preds = %bb.g
  ...
  br i1 %.not.i.i.3, label %g_lstat.exit.thread, label %bb.i, !llvm.loop !1
...
bb.i:                                             ; preds = %bb.h, %bb.d
  ...
  %i.ah = load i16, ptr %.04.i.i146, align 2, !tbaa !27
  %i.ai = trunc i16 %i.ah to i8                   ; 2 uses
  store i8 %i.ai, ptr %.03.i.i147, align 1, !tbaa !25
  %i.aj = icmp eq i8 %i.ai, 0
  br i1 %i.aj, label %bb.j, label %bb.e, !llvm.loop !1
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.an = call i32 %i.am(ptr noundef nonnull %i.b, ptr noundef nonnull %6) #19, !inline_history !82
  br label %g_lstat.exit

bb.l:                                             ; preds = %bb.j
  %i.ao = call i32 @lstat(ptr noundef nonnull %i.b, ptr noundef nonnull %6) #19
  br label %g_lstat.exit
...
bb.m:                                             ; preds = %g_lstat.exit
  %i.ap = load i32, ptr %i.g, align 8, !tbaa !22
  %i.aq = and i32 %i.ap, 8
...
bb.q:                                             ; preds = %bb.p
  %i.ay = load i32, ptr %i.at, align 8, !tbaa !96
...
bb.s:                                             ; preds = %bb.r
  store i16 47, ptr %.049.lcssa, align 2, !tbaa !27
  store i16 0, ptr %i.bb, align 2, !tbaa !27
  br label %bb.t
...
bb.t:                                             ; preds = %bb.o, %bb.s, %bb.q, %bb.p, %bb.n, %bb.m
  ...
  %i.bf = add i64 %i.be, 1
  store i64 %i.bf, ptr %i.bd, align 8, !tbaa !24
...
bb.w:                                             ; preds = %bb.v
  ...
  store i16 %i.bh, ptr %.046, align 2, !tbaa !27
  %.pre = load i16, ptr %i.bk, align 2, !tbaa !27
  br label %bb.u, !llvm.loop !83
...
bb.x:                                             ; preds = %.lr.ph
  ...
  store i16 47, ptr %.15039, align 2, !tbaa !27
  %i.bp = load i16, ptr %i.bo, align 2, !tbaa !27 ; 2 uses
  %i.bq = icmp eq i16 %i.bp, 47
  br i1 %i.bq, label %.lr.ph, label %.loopexit14, !llvm.loop !84
...
bb.z:                                             ; preds = %bb.y
  store i16 0, ptr %.04943, align 2, !tbaa !27
  %i.bs = tail call ptr @__errno_location() #22, !inline_history !85 ; 3 uses
  store i32 0, ptr %i.bs, align 4, !tbaa !40
  %i.bt = tail call fastcc ptr @g_opendir(ptr noundef nonnull %0, ptr noundef %4), !inline_history !85 ; 5 uses
  %i.bu = icmp eq ptr %i.bt, null
  br i1 %i.bu, label %bb.aa, label %bb.ae

bb.aa:                                            ; preds = %bb.z
  %i.bv = getelementptr inbounds nuw i8, ptr %4, i64 48
  %i.bw = load ptr, ptr %i.bv, align 8, !tbaa !23 ; 2 uses
...
.preheader:                                       ; preds = %.preheader.preheader
  ...
  %i.bz = load i16, ptr %i.by, align 2, !tbaa !27
  %i.ca = trunc i16 %i.bz to i8                   ; 2 uses
  store i8 %i.ca, ptr %i.bx, align 1, !tbaa !25
  %i.cb = icmp eq i8 %i.ca, 0
  br i1 %i.cb, label %bb.ab, label %.preheader.1, !llvm.loop !1
...
.preheader.1:                                     ; preds = %.preheader
  ...
  %i.ce = load i16, ptr %i.cd, align 2, !tbaa !27
  %i.cf = trunc i16 %i.ce to i8                   ; 2 uses
  store i8 %i.cf, ptr %i.cc, align 1, !tbaa !25
  %i.cg = icmp eq i8 %i.cf, 0
  br i1 %i.cg, label %bb.ab, label %.preheader.2, !llvm.loop !1
...
.preheader.2:                                     ; preds = %.preheader.1
  ...
  store i8 %i.ck, ptr %i.ch, align 1, !tbaa !25
  %i.cl = icmp eq i8 %i.ck, 0
  br i1 %i.cl, label %bb.ab, label %.preheader.3, !llvm.loop !1
...
.preheader.3:                                     ; preds = %.preheader.2
  ...
  br i1 %.not.i75.3, label %glob3.exit, label %.preheader.preheader, !llvm.loop !1
...
.preheader.preheader:                             ; preds = %bb.aa, %.preheader.3
  ...
  %i.cp = load i16, ptr %.04.i143, align 2, !tbaa !27
  %i.cq = trunc i16 %i.cp to i8                   ; 2 uses
  store i8 %i.cq, ptr %.03.i144, align 1, !tbaa !25
  %i.cr = icmp eq i8 %i.cq, 0
  br i1 %i.cr, label %bb.ab, label %.preheader, !llvm.loop !1

bb.ab:                                            ; preds = %.preheader.2, %.preheader.1, %.preheader, %.preheader.preheader
  %i.cs = load i32, ptr %i.bs, align 4, !tbaa !40
  %i.ct = call i32 %i.bw(ptr noundef nonnull %i.a, i32 noundef %i.cs) #19, !inline_history !85
  %.not71.i = icmp eq i32 %i.ct, 0
  br i1 %.not71.i, label %bb.ac, label %glob3.exit

bb.ac:                                            ; preds = %bb.ab
  %i.cu = getelementptr inbounds nuw i8, ptr %4, i64 24
  %i.cv = load i32, ptr %i.cu, align 8, !tbaa !22
  %i.cw = and i32 %i.cv, 4
...
bb.ag:                                            ; preds = %bb.af, %bb.ae
  ...
  %i.dc = tail call ptr %.049.i(ptr noundef nonnull %i.bt) #19, !inline_history !85 ; 2 uses
...
bb.ah:                                            ; preds = %.lr.ph47, %select.unfold
  ...
  %i.df = load i32, ptr %i.cx, align 8, !tbaa !22
  %i.dg = and i32 %i.df, 8192
  %.not62.i = icmp eq i32 %i.dg, 0
  br i1 %.not62.i, label %bb.ak, label %bb.ai

bb.ai:                                            ; preds = %bb.ah
  %i.dh = load i64, ptr %i.dd, align 8, !tbaa !98 ; 2 uses
  %i.di = add i64 %i.dh, 1
  store i64 %i.di, ptr %i.dd, align 8, !tbaa !98
...
bb.aj:                                            ; preds = %bb.ai
  ...
  store i16 47, ptr %.04943, align 2, !tbaa !27
  store i16 0, ptr %i.dk, align 2, !tbaa !27
  br label %.thread
...
bb.al:                                            ; preds = %bb.ak
  %i.do = load i16, ptr %.05142, align 2, !tbaa !27
  %.not63.i = icmp eq i16 %i.do, 46
  br i1 %.not63.i, label %.preheader151, label %select.unfold, !llvm.loop !86
...
bb.an:                                            ; preds = %bb.am
  ...
  %i.dr = load i8, ptr %.047.i, align 1, !tbaa !25 ; 2 uses
  %i.ds = zext i8 %i.dr to i16
  %i.dt = getelementptr inbounds nuw i8, ptr %.0.i65, i64 2 ; 2 uses
  store i16 %i.ds, ptr %.0.i65, align 2, !tbaa !27
  %.not64.i = icmp eq i8 %i.dr, 0
  br i1 %.not64.i, label %.critedge.i, label %bb.am, !llvm.loop !87
...
bb.ao:                                            ; preds = %.critedge.i
  store i16 0, ptr %.1.i, align 2, !tbaa !27
  br label %.thread
...
.lr.ph85.i:                                       ; preds = %.preheader10, %bb.bg
  ...
  %i.dw = load i16, ptr %.14882.i, align 2, !tbaa !27 ; 2 uses
...
.lr.ph.i:                                         ; preds = %.preheader.i, %bb.ap
  ...
  %i.dy = load i16, ptr %.24978.i, align 2, !tbaa !27
...
bb.ap:                                            ; preds = %.lr.ph.i
  ...
  br i1 %i.eb, label %.lr.ph.i, label %.critedge.i72, !llvm.loop !88
...
bb.aq:                                            ; preds = %.critedge.i72
  %i.ed = load i16, ptr %.15381.i, align 2, !tbaa !27
...
bb.as:                                            ; preds = %.lr.ph85.i
  ...
  %i.ei = load i16, ptr %.15381.i, align 2, !tbaa !27
...
bb.av:                                            ; preds = %.backedge, %bb.au
  ...
  %i.es = load i16, ptr %.451.i, align 2, !tbaa !27 ; 3 uses
...
bb.aw:                                            ; preds = %bb.av
  %i.et = load i16, ptr %i.er, align 2, !tbaa !27 ; 2 uses
...
bb.ax:                                            ; preds = %bb.aw
  ...
  %i.ey = load ptr, ptr %i.ex, align 8, !tbaa !100
  %i.ez = tail call i32 %i.ey(i32 noundef %i.em) #19, !inline_history !89
...
bb.az:                                            ; preds = %bb.ay, %bb.av
  ...
  %i.fb = load i16, ptr %.5.i, align 2, !tbaa !27
...
bb.bf:                                            ; preds = %.lr.ph85.i
  ...
  %i.fk = load i16, ptr %.15381.i, align 2, !tbaa !27
...
bb.bg:                                            ; preds = %bb.bf, %bb.be, %bb.as, %bb.ar
  ...
  br i1 %i.fl, label %.lr.ph85.i, label %._crit_edge.i, !llvm.loop !91
...
._crit_edge.i:                                    ; preds = %bb.bg, %.preheader10
  ...
  %i.fm = load i16, ptr %.153.lcssa.i, align 2, !tbaa !27
...
.loopexit:                                        ; preds = %.loopexit.i, %bb.aq
  store i16 0, ptr %.04943, align 2, !tbaa !27
  br label %select.unfold, !llvm.loop !86
...
select.unfold:                                    ; preds = %match.exit, %.loopexit, %bb.al
  %i.fq = tail call ptr %.049.i(ptr noundef nonnull %i.bt) #19, !inline_history !85 ; 2 uses
...
.thread:                                          ; preds = %select.unfold, %match.exit, %bb.ag, %bb.ao, %bb.aj
  ...
  %i.fr = load i32, ptr %i.cx, align 8, !tbaa !22
...
bb.bh:                                            ; preds = %.thread
  ...
  tail call void %i.fu(ptr noundef nonnull %i.bt) #19, !inline_history !85
  br label %glob3.exit

bb.bi:                                            ; preds = %.thread
  %i.fv = tail call i32 @closedir(ptr noundef nonnull %i.bt), !inline_history !85 ; 0 uses
  br label %glob3.exit
...
bb.b:                                             ; preds = %bb.f
  ...
  store i8 %i.e, ptr %i.b, align 1, !tbaa !25
  %i.f = icmp eq i8 %i.e, 0
  br i1 %i.f, label %bb.g, label %bb.c, !llvm.loop !1

bb.c:                                             ; preds = %bb.b
  %i.g = getelementptr inbounds nuw i8, ptr %.03.i9, i64 2
  %i.h = getelementptr inbounds nuw i8, ptr %.04.i8, i64 4
  %i.i = load i16, ptr %i.h, align 2, !tbaa !27
  %i.j = trunc i16 %i.i to i8                     ; 2 uses
  store i8 %i.j, ptr %i.g, align 1, !tbaa !25
  %i.k = icmp eq i8 %i.j, 0
  br i1 %i.k, label %bb.g, label %bb.d, !llvm.loop !1
...
bb.d:                                             ; preds = %bb.c
  ...
  store i8 %i.o, ptr %i.l, align 1, !tbaa !25
  %i.p = icmp eq i8 %i.o, 0
  br i1 %i.p, label %bb.g, label %bb.e, !llvm.loop !1
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %.not.i.3, label %g_Ctoc.exit, label %bb.f, !llvm.loop !1

bb.f:                                             ; preds = %bb.e, %bb.a
  %.0.i10 = phi i64 [ 4096, %bb.a ], [ %i.q, %bb.e ]
  %.03.i9 = phi ptr [ %i.a, %bb.a ], [ %i.r, %bb.e ] ; 5 uses
  %.04.i8 = phi ptr [ %0, %bb.a ], [ %i.s, %bb.e ] ; 5 uses
  %i.t = load i16, ptr %.04.i8, align 2, !tbaa !27
  %i.u = trunc i16 %i.t to i8                     ; 2 uses
  store i8 %i.u, ptr %.03.i9, align 1, !tbaa !25
  %i.v = icmp eq i8 %i.u, 0
  br i1 %i.v, label %bb.g, label %bb.b, !llvm.loop !1
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ab = call i32 %i.aa(ptr noundef nonnull %i.a, ptr noundef nonnull %1) #19
  br label %g_Ctoc.exit

bb.i:                                             ; preds = %bb.g
  %i.ac = call i32 @stat(ptr noundef nonnull %i.a, ptr noundef nonnull %1) #19
  br label %g_Ctoc.exit
...
.preheader:                                       ; preds = %.preheader.preheader
  ...
  store i8 %i.f, ptr %i.c, align 1, !tbaa !25
  %i.g = icmp eq i8 %i.f, 0
  br i1 %i.g, label %g_Ctoc.exit.thread, label %.preheader.1, !llvm.loop !1
...
.preheader.1:                                     ; preds = %.preheader
  ...
  store i8 %i.k, ptr %i.h, align 1, !tbaa !25
  %i.l = icmp eq i8 %i.k, 0
  br i1 %i.l, label %g_Ctoc.exit.thread, label %.preheader.2, !llvm.loop !1
...
.preheader.2:                                     ; preds = %.preheader.1
  ...
  store i8 %i.p, ptr %i.m, align 1, !tbaa !25
  %i.q = icmp eq i8 %i.p, 0
  br i1 %i.q, label %g_Ctoc.exit.thread, label %.preheader.3, !llvm.loop !1
...
.preheader.3:                                     ; preds = %.preheader.2
  ...
  br i1 %.not.i.3, label %g_Ctoc.exit, label %.preheader.preheader, !llvm.loop !1
...
.preheader.preheader:                             ; preds = %bb.a, %.preheader.3
  ...
  %i.u = load i16, ptr %.04.i9, align 2, !tbaa !27
  %i.v = trunc i16 %i.u to i8                     ; 2 uses
  store i8 %i.v, ptr %.03.i10, align 1, !tbaa !25
  %i.w = icmp eq i8 %i.v, 0
  br i1 %i.w, label %g_Ctoc.exit.thread, label %.preheader, !llvm.loop !1
...
bb.c:                                             ; preds = %g_Ctoc.exit.thread
  ...
  %i.ac = call ptr %i.ab(ptr noundef nonnull %i.a) #19
  br label %g_Ctoc.exit
...
!19 = !{!"", !14, i64 0, !14, i64 8, !14, i64 16, !11, i64 24, !17, i64 32, !18, i64 40, !15, i64 48, !15, i64 56, !15, i64 64, !15, i64 72, !15, i64 80, !15, i64 88}
!20 = !{!19, !14, i64 0}
!21 = !{!19, !14, i64 16}
!22 = !{!19, !11, i64 24}
!23 = !{!19, !15, i64 48}
...
!33 = !{!19, !18, i64 40}
!34 = !{!31, !31, i64 0}
!35 = !{!"p1 _ZTS4stat", !15, i64 0}
!36 = !{!"glob_path_stat", !31, i64 0, !35, i64 8}
!37 = !{!36, !31, i64 0}
!38 = !{!35, !35, i64 0}
!39 = !{!"glob_lim", !14, i64 0, !14, i64 8, !14, i64 16}
!40 = !{!11, !11, i64 0}
!41 = distinct !{!41, !28}
!42 = distinct !{!42, !28}
!43 = distinct !{!43, !28}
...
!67 = !{!"p1 _ZTS6passwd", !15, i64 0}
!68 = !{!67, !67, i64 0}
!69 = !{!"passwd", !31, i64 0, !31, i64 8, !11, i64 16, !11, i64 20, !31, i64 24, !31, i64 32, !31, i64 40}
!70 = !{!69, !31, i64 32}
!71 = !{!36, !35, i64 8}
!72 = !{!15, !15, i64 0}
!73 = !{!61}
...
!95 = !{!"stat", !14, i64 0, !14, i64 8, !14, i64 16, !11, i64 24, !11, i64 28, !11, i64 32, !11, i64 36, !14, i64 40, !14, i64 48, !14, i64 56, !14, i64 64, !94, i64 72, !94, i64 88, !94, i64 104, !10, i64 120}
!96 = !{!95, !11, i64 24}
!97 = !{!19, !15, i64 64}
!98 = !{!39, !14, i64 16}
!99 = !{!"cclass", !31, i64 0, !15, i64 8}
!100 = !{!99, !15, i64 8}
!101 = !{!19, !15, i64 56}
!102 = !{!19, !15, i64 88}
!103 = !{!19, !15, i64 72}
