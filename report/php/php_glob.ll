...
bb.k:                                             ; preds = %bb.j
  ...
  %i.an = call i32 %i.am(ptr noundef nonnull %i.b, ptr noundef nonnull %6) #20, !inline_history !82
...
bb.z:                                             ; preds = %bb.y
  ...
  %i.bs = tail call ptr @__errno_location() #23, !inline_history !85 ; 3 uses
...
bb.ab:                                            ; preds = %.preheader.2, %.preheader.1, %.preheader, %.preheader.preheader
  ...
  %i.ct = call i32 %i.bw(ptr noundef nonnull %i.a, i32 noundef %i.cs) #20, !inline_history !85
...
bb.ag:                                            ; preds = %bb.af, %bb.ae
  ...
  %i.dc = tail call ptr %.049.i(ptr noundef nonnull %i.bt) #20, !inline_history !85 ; 2 uses
...
bb.ax:                                            ; preds = %bb.aw
  ...
  %i.ez = tail call i32 %i.ey(i32 noundef %i.em) #20, !inline_history !89
...
select.unfold:                                    ; preds = %match.exit, %.loopexit, %bb.al
  %i.fq = tail call ptr %.049.i(ptr noundef nonnull %i.bt) #20, !inline_history !85 ; 2 uses
...
bb.bh:                                            ; preds = %.thread
  ...
  tail call void %i.fu(ptr noundef nonnull %i.bt) #20, !inline_history !85
  br label %glob3.exit
