...
bb.n:                                             ; preds = %bb.m
  %i.ap = load i32, ptr %i.al, align 4, !tbaa !42
  %i.aq = add i32 %i.ap, 1
  store i32 %i.aq, ptr %i.al, align 4, !tbaa !42
...
zend_string_copy.exit:                            ; preds = %bb.m, %bb.n
  ...
  %i.as = load i64, ptr %i.ar, align 8, !tbaa !180
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !41   ; 6 uses
  %.not9 = icmp eq ptr %i.e, null
  br i1 %.not9, label %zend_object_release.exit, label %bb.c, !prof !48
...
bb.e:                                             ; preds = %bb.c
  ...
  br i1 %i.m, label %bb.f, label %zend_object_release.exit, !prof !48
...
bb.g:                                             ; preds = %bb.a
  ...
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !41   ; 5 uses
...
bb.i:                                             ; preds = %bb.h
  %i.s = load i32, ptr %i.o, align 4, !tbaa !42   ; 2 uses
  %i.t = icmp ne i32 %i.s, 0
  tail call void @llvm.assume(i1 %i.t)
  %i.u = add i32 %i.s, -1                         ; 2 uses
  store i32 %i.u, ptr %i.o, align 4, !tbaa !42
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !41   ; 6 uses
  %.not9.i = icmp eq ptr %i.h, null
  br i1 %.not9.i, label %pdo_stmt_free_default_fetch_mode.exit, label %bb.c, !prof !48
...
bb.c:                                             ; preds = %bb.b
  ...
  store i32 %i.k, ptr %i.h, align 4, !tbaa !42
...
bb.e:                                             ; preds = %bb.c
  ...
  br i1 %i.p, label %bb.f, label %pdo_stmt_free_default_fetch_mode.exit, !prof !48
...
bb.g:                                             ; preds = %bb.a
  ...
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !41   ; 5 uses
...
bb.i:                                             ; preds = %bb.h
  %i.v = load i32, ptr %i.r, align 4, !tbaa !42   ; 2 uses
  %i.w = icmp ne i32 %i.v, 0
  tail call void @llvm.assume(i1 %i.w)
  %i.x = add i32 %i.v, -1                         ; 2 uses
  store i32 %i.x, ptr %i.r, align 4, !tbaa !42
...
pdo_stmt_free_default_fetch_mode.exit:            ; preds = %bb.a, %bb.b, %bb.d, %bb.e, %bb.f, %bb.g, %bb.h, %bb.i, %bb.j
  ...
  store i32 4, ptr %i.d, align 4, !tbaa !87
...
bb.k:                                             ; preds = %pdo_stmt_free_default_fetch_mode.exit
  ...
  %.026.i = select i1 %i.ac, i32 4, i32 %i.ab
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.af = load ptr, ptr getelementptr inbounds nuw (i8, ptr @executor_globals, i64 960), align 8, !tbaa !110
  %.not32.i = icmp eq ptr %i.af, null
  br i1 %.not32.i, label %bb.o, label %.critedge, !prof !84

bb.o:                                             ; preds = %bb.n, %bb.m, %bb.k
  switch i32 %.026.i, label %.critedge.sink.split.i [
    i32 10, label %bb.p
...
bb.ac:                                            ; preds = %bb.w
  ...
  %i.bc = load i8, ptr %i.bb, align 8, !tbaa !41
...
bb.ae:                                            ; preds = %bb.ac
  %i.be = load i64, ptr %3, align 8, !tbaa !41    ; 2 uses
...
bb.ag:                                            ; preds = %bb.ae
  ...
  store i32 %i.bg, ptr %i.z, align 8, !tbaa !41
  br label %bb.bx
...
bb.aq:                                            ; preds = %bb.ap
  %i.by = load i32, ptr %i.bt, align 4, !tbaa !42 ; 2 uses
  %i.bz = icmp ne i32 %i.by, 0
  tail call void @llvm.assume(i1 %i.bz)
  %i.ca = add i32 %i.by, -1                       ; 2 uses
  store i32 %i.ca, ptr %i.bt, align 4, !tbaa !42
...
bb.av:                                            ; preds = %bb.au
  ...
  %i.ch = load i32, ptr %i.cg, align 4, !tbaa !41 ; 2 uses
