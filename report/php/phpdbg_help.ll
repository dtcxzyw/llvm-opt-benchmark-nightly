...
.preheader35.i23:                                 ; preds = %.preheader35.i, %.thread
  ...
  %i.bg = tail call i32 @strncmp(ptr noundef nonnull @.str, ptr noundef readonly %i.f, i64 noundef %i.h) #7 ; 2 uses
  %.not33.i27 = icmp eq i32 %i.bg, 0              ; 2 uses
  %.6 = select i1 %.not33.i27, ptr @phpdbg_help_commands, ptr %.4444853
  ...
  %1 = icmp ne i32 %i.bg, 0
  %2 = select i1 %.not33.i27.1, i1 %1, i1 false
  %.6.1 = select i1 %2, ptr getelementptr inbounds nuw (i8, ptr @phpdbg_help_commands, i64 80), ptr %.6
