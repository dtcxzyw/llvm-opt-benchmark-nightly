...
begin_hunk_0_@zend_resolve_goto_label:bb.a
  store <4 x i8> zeroinitializer, ptr %i.br, align 4, !tbaa !57
  %i.bu = getelementptr inbounds i8, ptr %.05988, i64 -16
  store i32 -1, ptr %i.bu, align 8, !tbaa !57
  tail call void @zend_vm_set_opcode_handler(ptr noundef nonnull %i.bq) #30
  %.not67 = icmp eq i32 %i.bp, 0
  br i1 %.not67, label %._crit_edge92, label %.lr.ph91, !llvm.loop !222
...
bb.c:                                             ; preds = %bb.c, %.lr.ph.new
  ...
  %indvars.iv.next.tr.1 = trunc nuw nsw i64 %indvars.iv.next.1 to i32
...
begin_hunk_1_@zend_compile_func_decl_ex:bb.a
  br label %zend_string_copy.exit.i173

zend_string_copy.exit.i173:                       ; preds = %bb.fy, %bb.fz, %bb.fx
  %i.aeu = phi ptr [ null, %bb.fx ], [ %i.aeo, %bb.fz ], [ %i.aeo, %bb.fy ] ; 3 uses
  %.val.i = load i32, ptr %i.adg, align 4, !tbaa !137
  %i.aev = and i32 %.val.i, 1
  %.not.i224 = icmp eq i32 %i.aev, 0
  br i1 %.not.i224, label %bb.ga, label %bb.gg

bb.ga:                                            ; preds = %zend_string_copy.exit.i173
  %.not18.i = icmp eq ptr %i.wi, null
  br i1 %.not18.i, label %.thread257, label %.preheader.i225
...
bb.gq:                                            ; preds = %bb.gq, %.lr.ph.i217.new
  ...
  %indvars.iv.next.tr.i = trunc nuw nsw i64 %indvars.iv.next.i219 to i32
  ...
  %indvars.iv.next.tr.i.1 = trunc nuw nsw i64 %indvars.iv.next.i219.1 to i32
