...
bb.ay:                                            ; preds = %bb.ax
  %i.bz = icmp eq i8 %.2249534, %i.bo
  %.not324 = icmp eq i8 %.2249534, 92
  %spec.select = select i1 %.not324, i8 92, i8 %i.bo
  %.3250 = select i1 %i.bz, i8 0, i8 %spec.select ; 2 uses
...
bb.ba:                                            ; preds = %.lr.ph541, %.lr.ph541
  %i.cc = icmp ugt i64 %.2244.idx.in535, 3
  br i1 %i.cc, label %bb.bb, label %.critedge348

bb.bb:                                            ; preds = %bb.ba
  %i.cd = getelementptr inbounds nuw i8, ptr %i.a, i64 %.2244.idx.in535
...
bb.bc:                                            ; preds = %bb.bb, %bb.bb
  %i.cf = getelementptr inbounds i8, ptr %.2244.ptr540, i64 -2
...
bb.bd:                                            ; preds = %bb.bc, %bb.bc
  %i.ch = getelementptr inbounds i8, ptr %.2244.ptr540, i64 -3
  %i.ci = load i8, ptr %i.ch, align 1, !tbaa !16
  %i.cj = icmp eq i8 %i.ci, 63
  br i1 %i.cj, label %bb.be, label %.critedge348

bb.be:                                            ; preds = %bb.bd
  %i.ck = getelementptr inbounds i8, ptr %.2244.ptr540, i64 -4
...
.outer364:                                        ; preds = %bb.be
  %.2244.add = add nuw nsw i64 %.2244.idx.in535, 2 ; 2 uses
  %.not295520 = icmp samesign ult i64 %.2244.add, %1
...
.lr.ph526:                                        ; preds = %.lr.ph526.lr.ph, %.outer364
  ...
  %.1243.idx.ph366549 = phi i64 [ %.1243.idx.ph567, %.lr.ph526.lr.ph ], [ %.2244.add, %.outer364 ]
  %.0247.ph365548 = phi i8 [ %.0247.ph566, %.lr.ph526.lr.ph ], [ %.2249534, %.outer364 ]
  br label %bb.q
...
.critedge348:                                     ; preds = %bb.ay, %bb.az, %bb.bc, %bb.bb, %bb.ap, %bb.ap, %bb.an, %bb.an, %.lr.ph541, %bb.ba, %bb.bd, %bb.be, %bb.ax, %bb.au, %bb.av, %bb.at, %bb.aq, %bb.ao, %bb.as
  %.4251 = phi i8 [ %.2249534, %.lr.ph541 ], [ 40, %bb.ao ], [ %.2249534, %bb.an ], [ 41, %bb.aq ], [ %.2249534, %bb.ap ], [ %.2249534, %bb.as ], [ %.2249534, %bb.at ], [ %.2249534, %bb.av ], [ 34, %bb.au ], [ %.2249534, %bb.ap ], [ %.2249534, %bb.an ], [ %.3250, %bb.az ], [ %.2249534, %bb.bb ], [ %.2249534, %bb.ax ], [ %.2249534, %bb.ba ], [ %.2249534, %bb.be ], [ %.2249534, %bb.bd ], [ %.2249534, %bb.bc ], [ %.3250, %bb.ay ]
  ...
  %.2244.idx = add i64 %.2244.idx539, 1           ; 2 uses
  %exitcond762.not = icmp eq i64 %.2244.idx, %1
  br i1 %exitcond762.not, label %.loopexit, label %.lr.ph541

.lr.ph514:                                        ; preds = %.preheader, %.critedge350
  %.3245.idx512 = phi i64 [ %.3245.idx, %.critedge350 ], [ %.3245.idx506, %.preheader ] ; 3 uses
  %.6511 = phi i32 [ %.7, %.critedge350 ], [ %.1231524, %.preheader ] ; 19 uses
  %.6238510 = phi i32 [ %.7239, %.critedge350 ], [ %.2234523, %.preheader ] ; 17 uses
  %.3245.idx.in509 = phi i64 [ %.3245.idx512, %.critedge350 ], [ %.1243.idx522, %.preheader ] ; 7 uses
  %.3245.ptr513 = getelementptr inbounds nuw i8, ptr %i.a, i64 %.3245.idx512 ; 7 uses
  %i.cn = load i8, ptr %.3245.ptr513, align 1, !tbaa !16 ; 2 uses
...
bb.ca:                                            ; preds = %bb.bx, %bb.by, %.lr.ph579.split
  ...
  %exitcond763.not = icmp eq i64 %.4246.add305, %1
  br i1 %exitcond763.not, label %.loopexit, label %.lr.ph579.split, !llvm.loop !254
...
bb.cb:                                            ; preds = %.loopexit
  store i8 0, ptr %.0252375, align 1, !tbaa !16
  br label %bb.cc
...
.critedge163:                                     ; preds = %zend_parse_arg_str_ex.exit.thread, %.lr.ph, %zend_parse_arg_str_ex.exit
  ...
  br i1 %exitcond.not, label %.lr.ph202, label %.lr.ph, !llvm.loop !255
...
.lr.ph200:                                        ; preds = %.lr.ph200.preheader, %.thread183
  %.0136198 = phi ptr [ %i.bo, %.thread183 ], [ %i.ap, %.lr.ph200.preheader ] ; 4 uses
  %.0137197 = phi i32 [ %i.bp, %.thread183 ], [ %i.ai, %.lr.ph200.preheader ]
  %i.aq = getelementptr inbounds nuw i8, ptr %.0136198, i64 8
