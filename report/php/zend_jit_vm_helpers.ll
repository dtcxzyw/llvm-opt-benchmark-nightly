...
bb.b:                                             ; preds = %bb.a
  ...
  %.not775 = icmp eq i32 %i.r, 0
  br i1 %.not775, label %bb.d, label %bb.c
...
bb.d:                                             ; preds = %bb.c, %bb.b
  %.0620 = phi ptr [ %i.t, %bb.c ], [ %i.f, %bb.b ] ; 2 uses
  ...
  store ptr %.0620, ptr %i.w, align 8, !tbaa !12
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.ak = and i8 %i.aj, 64
  %.not776 = icmp eq i8 %i.ak, 0
  br i1 %.not776, label %bb.h, label %bb.g
...
bb.h:                                             ; preds = %bb.f
  %.not777 = icmp eq ptr %i.d, null
  br i1 %.not777, label %.thread.preheader, label %bb.i

.thread.preheader:                                ; preds = %bb.i, %bb.h
  %.2637.ph = phi i32 [ %i.aq, %bb.i ], [ 2, %bb.h ]
...
.thread:                                          ; preds = %.thread.backedge, %.thread.outer1683
  %.0722 = phi i32 [ %.0722.ph1684, %.thread.outer1683 ], [ %.3725, %.thread.backedge ] ; 20 uses
  %.0716 = phi i32 [ %.0716.ph1685, %.thread.outer1683 ], [ %.3719, %.thread.backedge ] ; 19 uses
  %.0710 = phi i32 [ %.0710.ph1686, %.thread.outer1683 ], [ %.3713, %.thread.backedge ] ; 19 uses
  %.0691 = phi ptr [ %.0691.ph1690, %.thread.outer1683 ], [ %.3694, %.thread.backedge ] ; 3 uses
  %.0688 = phi ptr [ %.0688.ph1691, %.thread.outer1683 ], [ %.1689, %.thread.backedge ] ; 4 uses
  %.0684 = phi ptr [ %.0684.ph1692, %.thread.outer1683 ], [ %.1685, %.thread.backedge ] ; 23 uses
  %.0679 = phi ptr [ %.0679.ph1693, %.thread.outer1683 ], [ %.2681, %.thread.backedge ] ; 35 uses
  %.0674 = phi ptr [ %.0674.ph1694, %.thread.outer1683 ], [ %.3677, %.thread.backedge ]
  %.2637 = phi i32 [ %.2637.ph1695, %.thread.outer1683 ], [ %.17652, %.thread.backedge ] ; 3 uses
  %.0626 = phi i64 [ %.0626.ph1696, %.thread.outer1683 ], [ %.1627, %.thread.backedge ] ; 2 uses
  %.1621 = phi ptr [ %.1621.ph1697, %.thread.outer1683 ], [ %.3623, %.thread.backedge ] ; 2 uses
  %.0612 = phi i32 [ %.0612.ph1698, %.thread.outer1683 ], [ %.2614, %.thread.backedge ] ; 44 uses
  %.0608 = phi i32 [ %.0608.ph1699, %.thread.outer1683 ], [ %.2610, %.thread.backedge ] ; 9 uses
  %i.ax = getelementptr inbounds nuw i8, ptr %.0679, i64 29 ; 3 uses
  %i.ay = load i8, ptr %i.ax, align 1, !tbaa !137 ; 2 uses
  %i.az = and i8 %i.ay, 14
  %.not778 = icmp eq i8 %i.az, 0
  br i1 %.not778, label %bb.t, label %bb.k

bb.k:                                             ; preds = %.thread
  %i.ba = getelementptr inbounds nuw i8, ptr %.0679, i64 28
  %i.bb = load i8, ptr %i.ba, align 4, !tbaa !136
  switch i8 %i.bb, label %bb.l [
    i8 55, label %.thread930
    i8 56, label %.thread930
    i8 68, label %.thread930
    i8 -75, label %.thread930
    i8 113, label %.thread930
  ]

bb.l:                                             ; preds = %bb.k
  %i.bc = getelementptr inbounds nuw i8, ptr %.0679, i64 8
  %i.bd = load i32, ptr %i.bc, align 8, !tbaa !12
  %i.be = sext i32 %i.bd to i64
  %i.bf = getelementptr inbounds i8, ptr %.0684, i64 %i.be ; 3 uses
...
bb.n:                                             ; preds = %bb.m, %bb.l
  %.0747 = phi i8 [ %i.bl, %bb.m ], [ %i.bh, %bb.l ] ; 2 uses
  %.0665 = phi ptr [ %i.bj, %bb.m ], [ %i.bf, %bb.l ] ; 2 uses
  %.0662 = phi i8 [ 64, %bb.m ], [ 0, %bb.l ]     ; 2 uses
  %i.bm = icmp eq i8 %.0747, 10
  br i1 %i.bm, label %bb.o, label %bb.p

bb.o:                                             ; preds = %bb.n
  %i.bn = load ptr, ptr %.0665, align 8, !tbaa !12 ; 2 uses
  %i.bo = getelementptr inbounds nuw i8, ptr %i.bn, i64 8
  %i.bp = getelementptr inbounds nuw i8, ptr %i.bn, i64 16
  %i.bq = load i8, ptr %i.bp, align 8, !tbaa !12
  %i.br = or disjoint i8 %.0662, 32
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %bb.n
  %.1748 = phi i8 [ %i.bq, %bb.o ], [ %.0747, %bb.n ]
  %.1666 = phi ptr [ %i.bo, %bb.o ], [ %.0665, %bb.n ] ; 3 uses
  %.1663 = phi i8 [ %i.br, %bb.o ], [ %.0662, %bb.n ] ; 3 uses
  %i.bs = getelementptr inbounds nuw i8, ptr %.1666, i64 8
...
bb.q:                                             ; preds = %bb.p
  %i.bu = load ptr, ptr %.1666, align 8, !tbaa !12
  %i.bv = getelementptr inbounds nuw i8, ptr %i.bu, i64 16
  %i.bw = load ptr, ptr %i.bv, align 8, !tbaa !138
  br label %bb.s

bb.r:                                             ; preds = %bb.p
  %i.bx = load ptr, ptr %.1666, align 8, !tbaa !12
  %i.by = getelementptr inbounds nuw i8, ptr %i.bx, i64 8
  %i.bz = load i32, ptr %i.by, align 8, !tbaa !12
  %i.ca = trunc i32 %i.bz to i8
  %i.cb = shl i8 %i.ca, 2
  %i.cc = and i8 %i.cb, 16
  %spec.select = or i8 %i.cc, %.1663
  br label %bb.s

bb.s:                                             ; preds = %bb.p, %bb.r, %bb.q
  %.0738 = phi ptr [ %i.bw, %bb.q ], [ null, %bb.p ], [ null, %bb.r ]
  %.2664 = phi i8 [ %.1663, %bb.q ], [ %.1663, %bb.p ], [ %spec.select, %bb.r ]
  %i.cd = or i8 %.2664, %.1748
  br label %.thread930

bb.t:                                             ; preds = %.thread
  %i.ce = icmp eq i8 %i.ay, 0
  br i1 %i.ce, label %bb.u, label %.thread930

bb.u:                                             ; preds = %bb.t
  %i.cf = getelementptr inbounds nuw i8, ptr %.1621, i64 4
  %i.cg = load i32, ptr %i.cf, align 4, !tbaa !69
  %i.ch = and i32 %i.cg, 4194304
  %.not784 = icmp eq i32 %i.ch, 0
  br i1 %.not784, label %.thread930, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.ci = getelementptr inbounds nuw i8, ptr %.0679, i64 28
  ...
  br i1 %i.cm, label %bb.w, label %.thread930

bb.w:                                             ; preds = %bb.v
  %i.cn = getelementptr inbounds nuw i8, ptr %.0684, i64 32
  %i.co = load ptr, ptr %i.cn, align 8, !tbaa !12
  %i.cp = getelementptr inbounds nuw i8, ptr %i.co, i64 16
  %i.cq = load ptr, ptr %i.cp, align 8, !tbaa !138
  br label %.thread930

.thread930:                                       ; preds = %bb.k, %bb.k, %bb.k, %bb.k, %bb.k, %bb.v, %bb.w, %bb.t, %bb.u, %bb.s
  %.3750 = phi i8 [ %i.cd, %bb.s ], [ -1, %bb.t ], [ -1, %bb.u ], [ 8, %bb.w ], [ -1, %bb.v ], [ -1, %bb.k ], [ -1, %bb.k ], [ -1, %bb.k ], [ -1, %bb.k ], [ -1, %bb.k ] ; 2 uses
  %.2740 = phi ptr [ %.0738, %bb.s ], [ null, %bb.t ], [ null, %bb.u ], [ %i.cq, %bb.w ], [ null, %bb.v ], [ null, %bb.k ], [ null, %bb.k ], [ null, %bb.k ], [ null, %bb.k ], [ null, %bb.k ] ; 2 uses
  %i.cr = getelementptr inbounds nuw i8, ptr %.0679, i64 30 ; 4 uses
  %i.cs = load i8, ptr %i.cr, align 2, !tbaa !89  ; 2 uses
  %i.ct = and i8 %i.cs, 14
  %.not786 = icmp eq i8 %i.ct, 0
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %.0679, i64 28
  %.pre = load i8, ptr %.phi.trans.insert, align 4, !tbaa !136 ; 4 uses
  br i1 %.not786, label %.thread930._crit_edge, label %bb.x

bb.x:                                             ; preds = %.thread930
  switch i8 %.pre, label %bb.y [
    i8 -118, label %.thread930._crit_edge
    i8 -77, label %.thread930._crit_edge
    i8 -76, label %.thread930._crit_edge
    i8 25, label %.thread930._crit_edge
    i8 33, label %.thread930._crit_edge
    i8 29, label %.thread930._crit_edge
    i8 38, label %.thread930._crit_edge
    i8 40, label %.thread930._crit_edge
    i8 39, label %.thread930._crit_edge
    i8 41, label %.thread930._crit_edge
    i8 -83, label %.thread930._crit_edge
    i8 -82, label %.thread930._crit_edge
    i8 -81, label %.thread930._crit_edge
    i8 -80, label %.thread930._crit_edge
    i8 -79, label %.thread930._crit_edge
    i8 -78, label %.thread930._crit_edge
  ]
...
bb.z:                                             ; preds = %bb.y
  switch i8 %.pre, label %bb.aa [
    i8 78, label %.thread930._crit_edge
    i8 126, label %.thread930._crit_edge
  ]

bb.aa:                                            ; preds = %bb.z, %bb.y
  %i.cv = getelementptr inbounds nuw i8, ptr %.0679, i64 12
  %i.cw = load i32, ptr %i.cv, align 4, !tbaa !12
  %i.cx = sext i32 %i.cw to i64
  %i.cy = getelementptr inbounds i8, ptr %.0684, i64 %i.cx ; 3 uses
...
bb.ac:                                            ; preds = %bb.ab, %bb.aa
  %.0744 = phi i8 [ %i.de, %bb.ab ], [ %i.da, %bb.aa ] ; 2 uses
  %.0660 = phi ptr [ %i.dc, %bb.ab ], [ %i.cy, %bb.aa ] ; 2 uses
  %.0658 = phi i8 [ 64, %bb.ab ], [ 0, %bb.aa ]   ; 2 uses
  %i.df = icmp eq i8 %.0744, 10
  br i1 %i.df, label %bb.ad, label %bb.ae

bb.ad:                                            ; preds = %bb.ac
  %i.dg = load ptr, ptr %.0660, align 8, !tbaa !12 ; 2 uses
  %i.dh = getelementptr inbounds nuw i8, ptr %i.dg, i64 8
  %i.di = getelementptr inbounds nuw i8, ptr %i.dg, i64 16
  %i.dj = load i8, ptr %i.di, align 8, !tbaa !12
  %i.dk = or disjoint i8 %.0658, 32
  br label %bb.ae

bb.ae:                                            ; preds = %bb.ad, %bb.ac
  %.1745 = phi i8 [ %i.dj, %bb.ad ], [ %.0744, %bb.ac ]
  %.1661 = phi ptr [ %i.dh, %bb.ad ], [ %.0660, %bb.ac ] ; 2 uses
  %.1659 = phi i8 [ %i.dk, %bb.ad ], [ %.0658, %bb.ac ]
  %i.dl = getelementptr inbounds nuw i8, ptr %.1661, i64 8
  %i.dm = load i8, ptr %i.dl, align 8, !tbaa !12
  %i.dn = icmp eq i8 %i.dm, 8
  br i1 %i.dn, label %bb.af, label %bb.ag

bb.af:                                            ; preds = %bb.ae
  %i.do = load ptr, ptr %.1661, align 8, !tbaa !12
  %i.dp = getelementptr inbounds nuw i8, ptr %i.do, i64 16
  %i.dq = load ptr, ptr %i.dp, align 8, !tbaa !138
  br label %bb.ag

bb.ag:                                            ; preds = %bb.af, %bb.ae
  %.0736 = phi ptr [ %i.dq, %bb.af ], [ null, %bb.ae ]
  %i.dr = or i8 %.1659, %.1745
  br label %.thread930._crit_edge

end_hunk_0
begin_hunk_1_@zend_jit_trace_execute:bb.a
bb.bn:                                            ; preds = %bb.bm, %bb.bl
  %.0629 = phi i8 [ %i.hh, %bb.bm ], [ 0, %bb.bl ]
  %i.hi = zext nneg i32 %.4639 to i64
...
bb.bp:                                            ; preds = %bb.bo
  %i.hm = getelementptr inbounds nuw i8, ptr %.0684, i64 64
  %i.hn = load ptr, ptr %i.hm, align 8, !tbaa !110
  %i.ho = getelementptr inbounds nuw i8, ptr %.0679, i64 20
...
bb.br:                                            ; preds = %bb.bp, %bb.bq, %bb.bo, %bb.at, %bb.at, %bb.at, %bb.at, %bb.at, %bb.at, %bb.at, %bb.at, %bb.at, %bb.at, %bb.at, %bb.at, %bb.at, %bb.at
  ...
  %.not811 = icmp eq i8 %i.ia, 1
  br i1 %.not811, label %thread-pre-split, label %bb.bs
...
bb.bt:                                            ; preds = %bb.bs
  %i.id = getelementptr inbounds nuw i8, ptr %.0679, i64 12
  %i.ie = load i32, ptr %i.id, align 4, !tbaa !12
  %i.if = sext i32 %i.ie to i64
  %i.ig = getelementptr inbounds i8, ptr %.0679, i64 %i.if ; 2 uses
...
bb.bu:                                            ; preds = %bb.bt
  ...
  %.not812 = icmp eq i8 %i.im, 0
  br i1 %.not812, label %thread-pre-split, label %bb.bv
...
bb.bw:                                            ; preds = %bb.bv
  %i.io = getelementptr inbounds nuw i8, ptr %.0679, i64 8
...
bb.bx:                                            ; preds = %bb.bv, %bb.bw
  ...
  %i.ir = getelementptr inbounds i8, ptr %.0684, i64 %.sink ; 3 uses
  %i.is = getelementptr inbounds nuw i8, ptr %i.ir, i64 8
  %i.it = load i8, ptr %i.is, align 8, !tbaa !12
  %.not813 = icmp eq i8 %i.it, 8
  br i1 %.not813, label %bb.by, label %thread-pre-split
...
bb.by:                                            ; preds = %bb.bx
  ...
  %.not814 = icmp eq ptr %i.iw, @std_object_handlers
  br i1 %.not814, label %bb.bz, label %thread-pre-split
...
bb.bz:                                            ; preds = %bb.by
  ...
  %switch913 = icmp ult i64 %magicptr.off, -2
  br i1 %switch913, label %bb.ca, label %thread-pre-split

bb.ca:                                            ; preds = %bb.bz
  %i.ja = getelementptr inbounds nuw i8, ptr %i.iz, i64 64
  %i.jb = load ptr, ptr %i.ja, align 8, !tbaa !143
  %.not815 = icmp eq ptr %i.jb, null
  br i1 %.not815, label %bb.cb, label %thread-pre-split

bb.cb:                                            ; preds = %bb.ca
  %i.jc = getelementptr inbounds nuw i8, ptr %i.iz, i64 4
  %i.jd = load i32, ptr %i.jc, align 4, !tbaa !147
  %i.je = and i32 %i.jd, 16
  %.not816 = icmp eq i32 %i.je, 0
  br i1 %.not816, label %bb.cc, label %thread-pre-split
...
bb.cc:                                            ; preds = %bb.cb
  ...
  %i.jj = zext nneg i32 %.4639 to i64
...
thread-pre-split.sink.split:                      ; preds = %bb.cc, %bb.bn
  %.sink1559 = phi ptr [ %i.hj, %bb.bn ], [ %i.jk, %bb.cc ] ; 4 uses
  %.0629.sink = phi i8 [ %.0629, %bb.bn ], [ %i.jm, %bb.cc ]
  %i.jn = getelementptr inbounds nuw i8, ptr %.sink1559, i64 1
  store i8 %.0629.sink, ptr %i.jn, align 1, !tbaa !12
  %i.jo = getelementptr inbounds nuw i8, ptr %.sink1559, i64 2
  store i8 0, ptr %i.jo, align 1, !tbaa !12
  %i.jp = getelementptr inbounds nuw i8, ptr %.sink1559, i64 3
  store i8 0, ptr %i.jp, align 1, !tbaa !12
  %i.jq = getelementptr inbounds nuw i8, ptr %.sink1559, i64 8
  store ptr null, ptr %i.jq, align 8, !tbaa !12
  %i.jr = add nuw nsw i32 %.4639, 1
...
thread-pre-split:                                 ; preds = %thread-pre-split.sink.split, %bb.az, %bb.aw, %bb.bu, %bb.bt, %bb.bs, %bb.br, %bb.ax, %bb.ca, %bb.cb, %bb.bx, %bb.by, %bb.bz
  %.9644.ph = phi i32 [ %.4639, %bb.cb ], [ %.4639, %bb.ca ], [ %.4639, %bb.by ], [ %.4639, %bb.ax ], [ %.4639, %bb.bx ], [ %.4639, %bb.az ], [ %.4639, %bb.br ], [ %.4639, %bb.bs ], [ %.4639, %bb.bt ], [ %.4639, %bb.bu ], [ %.4639, %bb.bz ], [ %.4639, %bb.aw ], [ %i.jr, %thread-pre-split.sink.split ]
  %.pr = load i8, ptr %i.ds, align 4, !tbaa !136
  br label %bb.cd

bb.cd:                                            ; preds = %thread-pre-split, %bb.at
  %i.js = phi i8 [ %.pr, %thread-pre-split ], [ %i.fk, %bb.at ]
  %.9644 = phi i32 [ %.9644.ph, %thread-pre-split ], [ %.4639, %bb.at ] ; 8 uses
...
bb.ce:                                            ; preds = %bb.cd, %bb.cd, %bb.cd, %bb.cd
  %i.jt = getelementptr inbounds nuw i8, ptr %.0684, i64 8
  ...
  %.not821 = icmp eq i32 %i.jx, 0
  br i1 %.not821, label %bb.cf, label %.critedge
...
bb.cg:                                            ; preds = %bb.cf
  ...
  %or.cond888 = icmp eq i32 %i.ke, 0
  br i1 %or.cond888, label %bb.ch, label %bb.cj

bb.ch:                                            ; preds = %bb.cg
  %i.kf = getelementptr inbounds nuw i8, ptr %i.jz, i64 80
  %i.kg = load ptr, ptr %i.kf, align 8, !tbaa !12
  %.not824 = icmp eq ptr %i.kg, null
  br i1 %.not824, label %bb.ci, label %bb.cj

bb.ci:                                            ; preds = %bb.ch
  %i.kh = and i32 %i.kd, 12582912
  %.not825 = icmp eq i32 %i.kh, 0
  br i1 %.not825, label %bb.cj, label %.critedge

bb.cj:                                            ; preds = %bb.cg, %bb.ch, %bb.ci
  %.0607 = phi ptr [ %i.jz, %bb.ci ], [ null, %bb.ch ], [ null, %bb.cg ]
  %i.ki = zext nneg i32 %.9644 to i64
  ...
  store ptr %.0607, ptr %i.kk, align 8, !tbaa !12
  %i.kl = add nuw nsw i32 %.9644, 1               ; 3 uses
  ...
  %.not826 = icmp sgt i64 %i.ko, %i.km
  br i1 %.not826, label %bb.ck, label %.thread1013

bb.ck:                                            ; preds = %bb.cj, %bb.cd, %bb.cf
  %.11646 = phi i32 [ %.9644, %bb.cd ], [ %.9644, %bb.cf ], [ %i.kl, %bb.cj ] ; 22 uses
  %i.kp = getelementptr inbounds nuw i8, ptr %.0679, i64 %.0626
  %i.kq = getelementptr inbounds nuw i8, ptr %i.kp, i64 8
  %i.kr = load ptr, ptr %i.kq, align 8, !tbaa !12
  %i.ks = call ptr %i.kr(ptr noundef %.0684, ptr noundef nonnull %.0679) #8 ; 3 uses
...
.lr.ph:                                           ; preds = %bb.ck, %.lr.ph
  %.16801231 = phi ptr [ %i.kv, %.lr.ph ], [ %i.ks, %bb.ck ]
  %i.kv = call ptr @zend_vm_handle_interrupt(ptr noundef %.0684, ptr noundef %.16801231) #8 ; 3 uses
...
._crit_edge:                                      ; preds = %.lr.ph, %bb.ck
  %.1680.lcssa = phi ptr [ %i.ks, %bb.ck ], [ %i.kv, %.lr.ph ] ; 2 uses
  %i.ky = ptrtoint ptr %.1680.lcssa to i64        ; 2 uses
...
bb.cn:                                            ; preds = %._crit_edge
  %i.lc = and i64 %i.ky, 1
  %.not827 = icmp eq i64 %i.lc, 0                 ; 2 uses
  %i.ld = inttoptr i64 %i.kz to ptr
  %i.le = load ptr, ptr getelementptr inbounds nuw (i8, ptr @executor_globals, i64 512), align 8
  %.1685 = select i1 %.not827, ptr %.0684, ptr %i.le ; 50 uses
  %.2681 = select i1 %.not827, ptr %.1680.lcssa, ptr %i.ld ; 69 uses
  %.not828 = icmp eq ptr %.1685, %.0688
  br i1 %.not828, label %bb.eb, label %bb.co, !prof !13

bb.co:                                            ; preds = %bb.cn
  %i.lf = getelementptr inbounds nuw i8, ptr %.1685, i64 24 ; 3 uses
  ...
  %.not829 = icmp eq ptr %i.ll, null
  br i1 %.not829, label %bb.cq, label %bb.cp, !prof !27

bb.cp:                                            ; preds = %bb.co
  %i.lm = getelementptr inbounds nuw i8, ptr %i.ll, i64 4
  %i.ln = load i32, ptr %i.lm, align 4, !tbaa !153
  %i.lo = and i32 %i.ln, 65536
  %.not830 = icmp eq i32 %i.lo, 0
  br i1 %.not830, label %bb.cq, label %bb.cr, !prof !27

bb.cq:                                            ; preds = %bb.cp, %bb.co
  %i.lp = getelementptr inbounds nuw i8, ptr %.1685, i64 48
  %i.lq = load ptr, ptr %i.lp, align 8, !tbaa !31
  %.not884 = icmp eq ptr %i.lq, %.0688
  %.889 = select i1 %.not884, i32 5, i32 3        ; 2 uses
  br label %.critedge
...
bb.cr:                                            ; preds = %bb.cp
  ...
  %.not831 = icmp eq ptr %i.lu, null
  br i1 %.not831, label %bb.ct, label %bb.cs

bb.cs:                                            ; preds = %bb.cr
  %i.lv = getelementptr inbounds nuw i8, ptr %i.lg, i64 4
  %i.lw = load i32, ptr %i.lv, align 4, !tbaa !69
  %i.lx = and i32 %i.lw, 4194304
  %.not832 = icmp eq i32 %i.lx, 0
  br i1 %.not832, label %bb.cu, label %bb.ct
...
bb.cu:                                            ; preds = %bb.ct, %bb.cs
  %.2622 = phi ptr [ %i.lz, %bb.ct ], [ %i.lg, %bb.cs ] ; 10 uses
  %i.ma = getelementptr inbounds nuw i8, ptr %.1685, i64 48
  %i.mb = load ptr, ptr %i.ma, align 8, !tbaa !31 ; 4 uses
  %i.mc = icmp eq ptr %i.mb, %.0688
  br i1 %i.mc, label %bb.cv, label %bb.de

bb.cv:                                            ; preds = %bb.cu
  %i.md = icmp sgt i32 %.0608, 10
  br i1 %i.md, label %.thread1013, label %bb.cw

bb.cw:                                            ; preds = %bb.cv
  %i.me = getelementptr inbounds nuw i8, ptr %i.lg, i64 4
  %i.mf = load i32, ptr %i.me, align 4, !tbaa !12 ; 2 uses
  %i.mg = and i32 %i.mf, 262144
  %.not850 = icmp eq i32 %i.mg, 0
  br i1 %.not850, label %bb.cx, label %.critedge

bb.cx:                                            ; preds = %bb.cw
  %i.mh = getelementptr inbounds nuw i8, ptr %i.lg, i64 80
  %i.mi = load ptr, ptr %i.mh, align 8, !tbaa !12
  %.not851 = icmp eq ptr %i.mi, null
  br i1 %.not851, label %bb.cy, label %.critedge

bb.cy:                                            ; preds = %bb.cx
  %i.mj = and i32 %i.mf, 8388608
  %.not852 = icmp eq i32 %i.mj, 0
  br i1 %.not852, label %bb.cz, label %.critedge

bb.cz:                                            ; preds = %bb.cy
  %i.mk = getelementptr inbounds nuw i8, ptr %.1685, i64 16
  %i.ml = load ptr, ptr %i.mk, align 8, !tbaa !154
  %.not853 = icmp eq ptr %i.ml, null
  %i.mm = select i1 %.not853, i32 6, i32 262
  %i.mn = zext nneg i32 %.11646 to i64
  ...
  store ptr %.2622, ptr %i.mp, align 8, !tbaa !12
  %i.mq = add nuw nsw i32 %.11646, 1              ; 6 uses
  ...
  %.not854 = icmp sgt i64 %i.mt, %i.mr
  br i1 %.not854, label %bb.da, label %.thread1013

bb.da:                                            ; preds = %bb.cz
  %i.mu = load ptr, ptr %i.lf, align 8, !tbaa !24 ; 3 uses
  %i.mv = icmp slt i32 %.0612, %.0608
  br i1 %i.mv, label %.lr.ph.preheader.i, label %zend_jit_trace_recursive_call_count.exit

.lr.ph.preheader.i:                               ; preds = %bb.da
  %i.mw = sext i32 %.0612 to i64                  ; 4 uses
  %wide.trip.count.i = sext i32 %.0608 to i64     ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi1678 = phi <2 x i32> [ zeroinitializer, %vector.ph ], [ %i.nf, %vector.body ]
...
bb.db:                                            ; preds = %zend_jit_trace_recursive_call_count.exit
  ...
  %.not856 = icmp sgt i64 %i.nq, %i.np
  br i1 %.not856, label %bb.dd, label %.critedge
...
bb.dc:                                            ; preds = %zend_jit_trace_recursive_call_count.exit
  ...
  %.not855 = icmp sgt i64 %i.ns, %i.nr
  br i1 %.not855, label %bb.dd, label %.thread1013

bb.dd:                                            ; preds = %bb.db, %bb.dc
  %.1723 = phi i32 [ %.0722, %bb.dc ], [ %i.mq, %bb.db ]
  %i.nt = add nsw i32 %.0608, %.0612
  %i.nu = sext i32 %i.nt to i64
  %i.nv = getelementptr inbounds [8 x i8], ptr %i.b, i64 %i.nu
  store ptr %i.mu, ptr %i.nv, align 8, !tbaa !155
  %i.nw = add nsw i32 %.0608, 1
  br label %bb.eb

bb.de:                                            ; preds = %bb.cu
  %i.nx = getelementptr inbounds nuw i8, ptr %.1685, i64 8
  %i.ny = load ptr, ptr %i.nx, align 8, !tbaa !133 ; 7 uses
  %i.nz = icmp eq i32 %.0608, 0
...
bb.df:                                            ; preds = %bb.de
  ...
  %or.cond9.not1108 = select i1 %i.tw, i1 true, i1 %i.ob
  %.not835 = icmp eq ptr %i.mb, null              ; 2 uses
  %or.cond890 = or i1 %.not835, %or.cond9.not1108
  br i1 %or.cond890, label %zend_jit_trace_has_recursive_ret.exit.thread, label %bb.dg

bb.dg:                                            ; preds = %bb.df
  %i.oc = getelementptr inbounds nuw i8, ptr %i.mb, i64 24
  %i.od = load ptr, ptr %i.oc, align 8, !tbaa !24 ; 2 uses
  %.not836 = icmp eq ptr %i.od, null
  br i1 %.not836, label %.critedge, label %bb.dh
...
.lr.ph.i919:                                      ; preds = %bb.di, %bb.dl
  %.015.i = phi i32 [ %i.or, %bb.dl ], [ %.0612, %bb.di ] ; 2 uses
  %.01114.i = phi ptr [ %i.oq, %bb.dl ], [ %.1685, %bb.di ] ; 3 uses
...
bb.dl:                                            ; preds = %bb.dk, %bb.dj
  ...
  %.not.i921 = icmp eq ptr %i.oq, null
  br i1 %.not.i921, label %zend_jit_trace_has_recursive_ret.exit.thread, label %.lr.ph.i919, !llvm.loop !161

bb.dm:                                            ; preds = %bb.dk
  %i.os = zext nneg i32 %.11646 to i64
  ...
  store ptr %.2622, ptr %i.ou, align 8, !tbaa !12
  %i.ov = add nuw nsw i32 %.11646, 1              ; 8 uses
  ...
  %.not846 = icmp sgt i64 %i.oy, %i.ow
  br i1 %.not846, label %bb.dn, label %.thread1013

bb.dn:                                            ; preds = %bb.dm
  %i.oz = load ptr, ptr %i.lf, align 8, !tbaa !24 ; 3 uses
  %i.pa = icmp sgt i32 %.0612, 0
  br i1 %i.pa, label %.lr.ph.preheader.i923, label %zend_jit_trace_recursive_ret_count.exit

.lr.ph.preheader.i923:                            ; preds = %bb.dn
  %wide.trip.count.i924 = zext nneg i32 %.0612 to i64 ; 3 uses
  %min.iters.check1681 = icmp ult i32 %.0612, 4
  br i1 %min.iters.check1681, label %.lr.ph.i925.preheader, label %.lr.ph.i925.a

.lr.ph.i925.a:                                    ; preds = %.lr.ph.preheader.i923
  %n.vec1683 = and i64 %wide.trip.count.i924, 2147483644 ; 3 uses
  %broadcast.splatinsert1684 = insertelement <2 x ptr> poison, ptr %i.oz, i64 0
  %broadcast.splat1685 = shufflevector <2 x ptr> %broadcast.splatinsert1684, <2 x ptr> poison, <2 x i32> zeroinitializer ; 2 uses
  br label %.lr.ph.i925.1

.lr.ph.i925.1:                                    ; preds = %.lr.ph.i925.1, %.lr.ph.i925.a
  %index1687 = phi i64 [ 0, %.lr.ph.i925.a ], [ %index.next1692, %.lr.ph.i925.1 ] ; 2 uses
  %vec.phi1688 = phi <2 x i32> [ zeroinitializer, %.lr.ph.i925.a ], [ %12, %.lr.ph.i925.1 ]
  %vec.phi1689 = phi <2 x i32> [ zeroinitializer, %.lr.ph.i925.a ], [ %13, %.lr.ph.i925.1 ]
  %6 = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %index1687 ; 2 uses
  %7 = getelementptr inbounds nuw i8, ptr %6, i64 16
  %wide.load1690 = load <2 x ptr>, ptr %6, align 16, !tbaa !155
  %wide.load1691 = load <2 x ptr>, ptr %7, align 16, !tbaa !155
  %8 = icmp eq <2 x ptr> %wide.load1690, %broadcast.splat1685
  %9 = icmp eq <2 x ptr> %wide.load1691, %broadcast.splat1685
  %10 = zext <2 x i1> %8 to <2 x i32>
  %11 = zext <2 x i1> %9 to <2 x i32>
  %12 = add <2 x i32> %vec.phi1688, %10           ; 2 uses
  %13 = add <2 x i32> %vec.phi1689, %11           ; 2 uses
  %index.next1692 = add nuw i64 %index1687, 4     ; 2 uses
  %exitcond.not.i928.1 = icmp eq i64 %index.next1692, %n.vec1683
  br i1 %exitcond.not.i928.1, label %.lr.ph.i925.2, label %.lr.ph.i925.1, !llvm.loop !162

.lr.ph.i925.2:                                    ; preds = %.lr.ph.i925.1
  %bin.rdx1694 = add <2 x i32> %13, %12
  %14 = call i32 @llvm.vector.reduce.add.v2i32(<2 x i32> %bin.rdx1694) ; 2 uses
  %exitcond.not.i928.2 = icmp eq i64 %n.vec1683, %wide.trip.count.i924
  br i1 %exitcond.not.i928.2, label %zend_jit_trace_recursive_ret_count.exit, label %.lr.ph.i925.preheader

.lr.ph.i925.preheader:                            ; preds = %.lr.ph.preheader.i923, %.lr.ph.i925.2
  %indvars.iv.i926.ph = phi i64 [ 0, %.lr.ph.preheader.i923 ], [ %n.vec1683, %.lr.ph.i925.2 ]
  %.09.i.ph = phi i32 [ 0, %.lr.ph.preheader.i923 ], [ %14, %.lr.ph.i925.2 ]
  br label %.lr.ph.i925.3

.lr.ph.i925.3:                                    ; preds = %.lr.ph.i925.preheader, %.lr.ph.i925.3
  %indvars.iv.i926 = phi i64 [ %indvars.iv.next.i927, %.lr.ph.i925.3 ], [ %indvars.iv.i926.ph, %.lr.ph.i925.preheader ] ; 2 uses
  %.09.i = phi i32 [ %i.pe, %.lr.ph.i925.3 ], [ %.09.i.ph, %.lr.ph.i925.preheader ]
  %15 = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %indvars.iv.i926
  ...
  %indvars.iv.next.i927 = add nuw nsw i64 %indvars.iv.i926, 1 ; 2 uses
  %exitcond.not.i928 = icmp eq i64 %indvars.iv.next.i927, %wide.trip.count.i924
  br i1 %exitcond.not.i928, label %zend_jit_trace_recursive_ret_count.exit, label %.lr.ph.i925.3, !llvm.loop !163

zend_jit_trace_recursive_ret_count.exit:          ; preds = %.lr.ph.i925.3, %.lr.ph.i925.2, %bb.dn
  %.0.lcssa.i922 = phi i32 [ 0, %bb.dn ], [ %14, %.lr.ph.i925.2 ], [ %i.pe, %.lr.ph.i925.3 ] ; 2 uses
  %i.pf = icmp eq ptr %.2681, %1
  br i1 %i.pf, label %bb.do, label %bb.dp

bb.do:                                            ; preds = %zend_jit_trace_recursive_ret_count.exit
  %i.pg = add nsw i32 %.0.lcssa.i922, 1
  %i.ph = sext i32 %i.pg to i64
  %i.pi = load i64, ptr getelementptr inbounds nuw (i8, ptr @jit_globals, i64 136), align 8, !tbaa !164
  %.not848 = icmp sgt i64 %i.pi, %i.ph
  br i1 %.not848, label %bb.dq, label %.critedge

bb.dp:                                            ; preds = %zend_jit_trace_recursive_ret_count.exit
  %i.pj = sext i32 %.0.lcssa.i922 to i64
  %i.pk = load i64, ptr getelementptr inbounds nuw (i8, ptr @jit_globals, i64 136), align 8, !tbaa !164
  %.not847 = icmp sgt i64 %i.pk, %i.pj
  br i1 %.not847, label %bb.dq, label %.thread1013

bb.dq:                                            ; preds = %bb.do, %bb.dp
  %.1717 = phi i32 [ %.0716, %bb.dp ], [ %i.ov, %bb.do ] ; 2 uses
  %.1711 = phi i32 [ %.0710, %bb.dp ], [ %.0612, %bb.do ] ; 2 uses
  %i.pl = sext i32 %.0612 to i64
  %i.pm = getelementptr inbounds [8 x i8], ptr %i.b, i64 %i.pl
  store ptr %i.oz, ptr %i.pm, align 8, !tbaa !155
  %i.pn = add nsw i32 %.0612, 1                   ; 3 uses
  %.not849 = icmp eq ptr %i.ny, null
  br i1 %.not849, label %bb.eb, label %bb.dr
...
zend_jit_trace_has_recursive_ret.exit.thread:     ; preds = %bb.dl, %.lr.ph.i919, %bb.df
  br i1 %.not838, label %bb.dt, label %bb.ds
...
bb.ds:                                            ; preds = %zend_jit_trace_has_recursive_ret.exit.thread
  ...
  %.not839 = icmp eq i8 %i.pt, 19
  br i1 %.not839, label %bb.dt, label %.thread1013

bb.dt:                                            ; preds = %bb.ds, %zend_jit_trace_has_recursive_ret.exit.thread
  %brmerge = or i1 %.not840, %.not835
...
bb.dv:                                            ; preds = %bb.du
  ...
  %.not842 = icmp eq i8 %i.qa, 20
  br i1 %.not842, label %bb.dw, label %.thread1013

bb.dw:                                            ; preds = %bb.dt, %bb.dv, %bb.du
  %i.qb = icmp slt i32 %.0612, %5
  %or.cond893 = select i1 %.not843, i1 %i.qb, i1 false
  br i1 %or.cond893, label %bb.dx, label %.critedge

bb.dx:                                            ; preds = %bb.dw
  %i.qc = zext nneg i32 %.11646 to i64
  ...
  store ptr %.2622, ptr %i.qe, align 8, !tbaa !12
  %i.qf = add nuw nsw i32 %.11646, 1              ; 5 uses
  ...
  %.not844 = icmp sgt i64 %i.qi, %i.qg
  br i1 %.not844, label %bb.dy, label %.thread1013

bb.dy:                                            ; preds = %bb.dx
  %i.qj = add nsw i32 %.0612, 1                   ; 3 uses
  %.not845 = icmp eq ptr %i.ny, null
  br i1 %.not845, label %bb.eb, label %bb.dz
...
bb.ea:                                            ; preds = %bb.de
  %i.qm = add nsw i32 %.0608, -1
  %.not833 = icmp sgt i32 %.0608, %.0698.ph1689
  %spec.select897 = select i1 %.not833, ptr %.0691, ptr null
  %i.qn = zext nneg i32 %.11646 to i64
  ...
  store ptr %.2622, ptr %i.qp, align 8, !tbaa !12
  %i.qq = add nuw nsw i32 %.11646, 1              ; 3 uses
  ...
  %.not834 = icmp sgt i64 %i.qt, %i.qr
  br i1 %.not834, label %bb.eb, label %.thread1013

bb.eb:                                            ; preds = %bb.dd, %bb.ea, %bb.dr, %bb.dq, %bb.dy, %bb.dz, %bb.cn
  %.3725 = phi i32 [ %.0722, %bb.cn ], [ %.1723, %bb.dd ], [ %.0722, %bb.dr ], [ %.0722, %bb.dq ], [ %.0722, %bb.dz ], [ %.0722, %bb.dy ], [ %.0722, %bb.ea ] ; 11 uses
  %.3719 = phi i32 [ %.0716, %bb.cn ], [ %.0716, %bb.dd ], [ %.1717, %bb.dr ], [ %.1717, %bb.dq ], [ %.0716, %bb.dz ], [ %.0716, %bb.dy ], [ %.0716, %bb.ea ] ; 11 uses
  %.3713 = phi i32 [ %.0710, %bb.cn ], [ %.0710, %bb.dd ], [ %.1711, %bb.dr ], [ %.1711, %bb.dq ], [ %.0710, %bb.dz ], [ %.0710, %bb.dy ], [ %.0710, %bb.ea ] ; 11 uses
  %.3694 = phi ptr [ %.0691, %bb.cn ], [ %.0691, %bb.dd ], [ null, %bb.dr ], [ null, %bb.dq ], [ null, %bb.dz ], [ null, %bb.dy ], [ %spec.select897, %bb.ea ] ; 3 uses
  %.1689 = phi ptr [ %.0688, %bb.cn ], [ %.1685, %bb.dd ], [ %.1685, %bb.dr ], [ %.1685, %bb.dq ], [ %.1685, %bb.dz ], [ %.1685, %bb.dy ], [ %.1685, %bb.ea ] ; 3 uses
  %.2676 = phi ptr [ %.0674, %bb.cn ], [ null, %bb.dd ], [ %i.ny, %bb.dr ], [ null, %bb.dq ], [ %i.ny, %bb.dz ], [ null, %bb.dy ], [ %i.ny, %bb.ea ] ; 3 uses
  %.15650 = phi i32 [ %.11646, %bb.cn ], [ %i.mq, %bb.dd ], [ %i.po, %bb.dr ], [ %i.ov, %bb.dq ], [ %i.qk, %bb.dz ], [ %i.qf, %bb.dy ], [ %i.qq, %bb.ea ] ; 5 uses
  %.1627 = phi i64 [ %.0626, %bb.cn ], [ %i.ls, %bb.dd ], [ %i.ls, %bb.dr ], [ %i.ls, %bb.dq ], [ %i.ls, %bb.dz ], [ %i.ls, %bb.dy ], [ %i.ls, %bb.ea ] ; 4 uses
  %.3623 = phi ptr [ %.1621, %bb.cn ], [ %.2622, %bb.dd ], [ %.2622, %bb.dr ], [ %.2622, %bb.dq ], [ %.2622, %bb.dz ], [ %.2622, %bb.dy ], [ %.2622, %bb.ea ] ; 4 uses
  %.2614 = phi i32 [ %.0612, %bb.cn ], [ %.0612, %bb.dd ], [ %i.pn, %bb.dr ], [ %i.pn, %bb.dq ], [ %i.qj, %bb.dz ], [ %i.qj, %bb.dy ], [ %.0612, %bb.ea ] ; 17 uses
  %.2610 = phi i32 [ %.0608, %bb.cn ], [ %i.nw, %bb.dd ], [ 0, %bb.dr ], [ 0, %bb.dq ], [ 0, %bb.dz ], [ 0, %bb.dy ], [ %i.qm, %bb.ea ] ; 7 uses
  %i.qu = getelementptr inbounds nuw i8, ptr %.1685, i64 8 ; 3 uses
  %i.qv = load ptr, ptr %i.qu, align 8, !tbaa !133 ; 6 uses
  %.not857 = icmp eq ptr %i.qv, %.2676
  br i1 %.not857, label %bb.eq, label %bb.ec

bb.ec:                                            ; preds = %bb.eb
  %.not858 = icmp eq ptr %i.qv, null
  br i1 %.not858, label %bb.eq, label %bb.ed

bb.ed:                                            ; preds = %bb.ec
  %i.qw = getelementptr inbounds nuw i8, ptr %i.qv, i64 48
  %i.qx = load ptr, ptr %i.qw, align 8, !tbaa !31
  %i.qy = icmp eq ptr %i.qx, %.2676
...
bb.ee:                                            ; preds = %bb.ed
  ...
  switch i8 %i.rb, label %.thread953 [
    i8 1, label %bb.ef
    i8 2, label %bb.eg
  ]
...
bb.ef:                                            ; preds = %bb.ee
  ...
  %.not859 = icmp eq i32 %i.re, 0
  br i1 %.not859, label %.thread953, label %.thread949
...
bb.eg:                                            ; preds = %bb.ee
  ...
  %.not860 = icmp eq ptr %i.rj, null
  br i1 %.not860, label %bb.eh, label %.critedge915

bb.eh:                                            ; preds = %bb.eg
  %i.rk = getelementptr inbounds nuw i8, ptr %i.ra, i64 4
  %i.rl = load i32, ptr %i.rk, align 4, !tbaa !12 ; 2 uses
  %i.rm = and i32 %i.rl, 4194304
  %.not1109 = icmp eq i32 %i.rm, 0
  br i1 %.not1109, label %.critedge899, label %.thread949, !prof !13

.critedge915:                                     ; preds = %bb.eg
  %i.rn = getelementptr inbounds nuw i8, ptr %i.rj, i64 4
  %i.ro = load i32, ptr %i.rn, align 4, !tbaa !153
  %i.rp = and i32 %i.ro, 65536
  %.not861 = icmp eq i32 %i.rp, 0
  br i1 %.not861, label %.thread949, label %.critedge915..critedge899_crit_edge

.critedge915..critedge899_crit_edge:              ; preds = %.critedge915
  %.phi.trans.insert1360 = getelementptr inbounds nuw i8, ptr %i.ra, i64 4
  %.pre1361 = load i32, ptr %.phi.trans.insert1360, align 4, !tbaa !12
  br label %.critedge899

.critedge899:                                     ; preds = %.critedge915..critedge899_crit_edge, %bb.eh
  %i.rq = phi i32 [ %.pre1361, %.critedge915..critedge899_crit_edge ], [ %i.rl, %bb.eh ] ; 2 uses
  %i.rr = and i32 %i.rq, 8388608
  %.not862 = icmp eq i32 %i.rr, 0
  br i1 %.not862, label %bb.ei, label %.thread949

bb.ei:                                            ; preds = %.critedge899
  %i.rs = and i32 %i.rq, 4194304
  %.not863 = icmp eq i32 %i.rs, 0
  br i1 %.not863, label %.thread953, label %bb.ej

bb.ej:                                            ; preds = %bb.ei
  %i.rt = getelementptr inbounds nuw i8, ptr %i.rj, i64 152
  %i.ru = load ptr, ptr %i.rt, align 8, !tbaa !135 ; 2 uses
  %.not864 = icmp eq ptr %i.ru, null
  br i1 %.not864, label %.thread949, label %.thread953

.thread953:                                       ; preds = %bb.ee, %bb.ef, %bb.ei, %bb.ej
  %.0597956 = phi ptr [ %i.ru, %bb.ej ], [ %i.ra, %bb.ee ], [ %i.ra, %bb.ei ], [ %i.ra, %bb.ef ] ; 4 uses
  %i.rv = getelementptr inbounds nuw i8, ptr %.0597956, i64 4
  %i.rw = load i32, ptr %i.rv, align 4, !tbaa !12
  %i.rx = and i32 %i.rw, 786432
  %or.cond900 = icmp eq i32 %i.rx, 0
  br i1 %or.cond900, label %bb.ek, label %.thread949

bb.ek:                                            ; preds = %.thread953
  %i.ry = getelementptr inbounds nuw i8, ptr %.0597956, i64 80
  %i.rz = load ptr, ptr %i.ry, align 8, !tbaa !12
  %.not867 = icmp eq ptr %i.rz, null
  br i1 %.not867, label %bb.el, label %.thread949

bb.el:                                            ; preds = %bb.ek
  %i.sa = load i64, ptr getelementptr inbounds nuw (i8, ptr @jit_globals, i64 144), align 8, !tbaa !166
  %i.sb = icmp eq i64 %i.sa, 0
  br i1 %i.sb, label %bb.em, label %zend_jit_may_be_polymorphic_call.exit.thread959

bb.em:                                            ; preds = %bb.el
  %i.sc = getelementptr inbounds i8, ptr %.2681, i64 -4
  %i.sd = load i8, ptr %i.sc, align 4, !tbaa !136
  switch i8 %i.sd, label %.unreachabledefault.i [
    i8 61, label %zend_jit_may_be_polymorphic_call.exit.thread959
    i8 59, label %zend_jit_may_be_polymorphic_call.exit.thread959
    i8 69, label %zend_jit_may_be_polymorphic_call.exit.thread959
    i8 -47, label %zend_jit_may_be_polymorphic_call.exit.thread959
    i8 112, label %.thread949.sink.split
    i8 -128, label %.thread949.sink.split
    i8 113, label %bb.en
    i8 118, label %.split961
    i8 68, label %.split
  ]

bb.en:                                            ; preds = %bb.em
  %i.se = getelementptr inbounds i8, ptr %.2681, i64 -3
  %i.sf = load i8, ptr %i.se, align 1, !tbaa !137
  %.not.i = icmp eq i8 %i.sf, 1
  br i1 %.not.i, label %zend_jit_may_be_polymorphic_call.exit, label %.thread949.sink.split

.split961:                                        ; preds = %bb.em
  %i.sg = getelementptr inbounds i8, ptr %.2681, i64 -2
  %i.sh = load i8, ptr %i.sg, align 2, !tbaa !89
  %.not1111 = icmp eq i8 %i.sh, 1
  br i1 %.not1111, label %zend_jit_may_be_polymorphic_call.exit.thread959, label %.thread949.sink.split

.unreachabledefault.i:                            ; preds = %bb.em
  unreachable

.split:                                           ; preds = %bb.em
  %i.si = getelementptr inbounds i8, ptr %.2681, i64 -3
  %i.sj = load i8, ptr %i.si, align 1, !tbaa !137
  %.not1110 = icmp eq i8 %i.sj, 1
  br i1 %.not1110, label %zend_jit_may_be_polymorphic_call.exit.thread959, label %.thread949.sink.split

zend_jit_may_be_polymorphic_call.exit:            ; preds = %bb.en
  %i.sk = getelementptr inbounds i8, ptr %.2681, i64 -2
  %i.sl = load i8, ptr %i.sk, align 2, !tbaa !89
  %.not1112 = icmp eq i8 %i.sl, 1
  br i1 %.not1112, label %zend_jit_may_be_polymorphic_call.exit.thread959, label %.thread949.sink.split

zend_jit_may_be_polymorphic_call.exit.thread959:  ; preds = %bb.em, %bb.em, %bb.em, %bb.em, %.split961, %.split, %zend_jit_may_be_polymorphic_call.exit, %bb.el
  switch i32 %4, label %bb.ep [
    i32 512, label %bb.eo
    i32 256, label %bb.eo
  ]

bb.eo:                                            ; preds = %zend_jit_may_be_polymorphic_call.exit.thread959, %zend_jit_may_be_polymorphic_call.exit.thread959
  %i.sm = load ptr, ptr %i.y, align 8, !tbaa !12
  %i.sn = getelementptr inbounds i8, ptr %.2681, i64 -32
  %i.so = icmp eq ptr %i.sm, %i.sn
  br i1 %i.so, label %.thread949.sink.split, label %bb.ep

.thread949.sink.split:                            ; preds = %bb.eo, %zend_jit_may_be_polymorphic_call.exit, %.split, %.split961, %bb.en, %bb.em, %bb.em
...
.thread949:                                       ; preds = %.thread949.sink.split, %bb.eh, %.critedge915, %.critedge899, %bb.ef, %bb.ek, %.thread953, %bb.ej
...
bb.ep:                                            ; preds = %bb.eo, %zend_jit_may_be_polymorphic_call.exit.thread959, %.thread949
  %.1598966 = phi ptr [ null, %.thread949 ], [ %.0597956, %zend_jit_may_be_polymorphic_call.exit.thread959 ], [ %.0597956, %bb.eo ]
  %.0596 = phi i32 [ %i.sw, %.thread949 ], [ 4, %zend_jit_may_be_polymorphic_call.exit.thread959 ], [ 4, %bb.eo ]
  %i.sx = zext nneg i32 %.15650 to i64
  %i.sy = getelementptr inbounds nuw [16 x i8], ptr %2, i64 %i.sx ; 2 uses
  store i32 %.0596, ptr %i.sy, align 8, !tbaa !12
  %i.sz = getelementptr inbounds nuw i8, ptr %i.sy, i64 8
  store ptr %.1598966, ptr %i.sz, align 8, !tbaa !12
  %i.ta = add nuw nsw i32 %.15650, 1              ; 3 uses
  ...
  %.not869 = icmp sgt i64 %i.td, %i.tb
  br i1 %.not869, label %._crit_edge1362, label %.thread1013

._crit_edge1362:                                  ; preds = %bb.ep
  %.pre1363 = load ptr, ptr %i.qu, align 8, !tbaa !133
  br label %bb.eq

bb.eq:                                            ; preds = %bb.ec, %bb.ed, %._crit_edge1362, %bb.eb
  %.3677 = phi ptr [ %.2676, %bb.eb ], [ %.pre1363, %._crit_edge1362 ], [ %i.qv, %bb.ed ], [ null, %bb.ec ] ; 3 uses
  %.17652 = phi i32 [ %.15650, %bb.eb ], [ %i.ta, %._crit_edge1362 ], [ %.15650, %bb.ed ], [ %.15650, %bb.ec ] ; 18 uses
  %i.te = getelementptr inbounds nuw i8, ptr %.2681, i64 28
  %i.tf = load i8, ptr %i.te, align 4, !tbaa !136
  %i.tg = icmp eq i8 %i.tf, -107
  br i1 %i.tg, label %.thread1013, label %bb.er, !prof !27

bb.er:                                            ; preds = %bb.eq
  %i.th = getelementptr inbounds nuw i8, ptr %.2681, i64 %.1627
  %i.ti = getelementptr inbounds nuw i8, ptr %i.th, i64 24
  %i.tj = load i8, ptr %i.ti, align 8, !tbaa !12  ; 2 uses
  %.not870 = icmp eq i8 %i.tj, 0
  br i1 %.not870, label %.thread.backedge, label %bb.es
...
bb.es:                                            ; preds = %bb.er
  ...
  %.not871 = icmp eq i32 %i.tl, 0
  br i1 %.not871, label %bb.ey, label %bb.et

bb.et:                                            ; preds = %bb.es
  %i.tm = and i32 %i.tk, 1
  %.not879 = icmp eq i32 %i.tm, 0
  br i1 %.not879, label %bb.ew, label %bb.eu

bb.eu:                                            ; preds = %bb.et
  %.not882 = trunc i8 %.0594.ph to i1
  %i.tn = sub i32 0, %.2614
  %i.to = icmp eq i32 %.2610, %i.tn
  %or.cond903 = select i1 %.not882, i1 %i.to, i1 false
  br i1 %or.cond903, label %bb.ev, label %.preheader
...
bb.ev:                                            ; preds = %bb.eu
  ...
  %.not883 = icmp eq i8 %i.ts, 23
  br i1 %.not883, label %.preheader, label %.thread1013

bb.ew:                                            ; preds = %bb.et
  %i.tt = and i32 %i.tk, 2
  %.not880 = icmp ne i32 %i.tt, 0
  %.not881 = icmp eq i8 %.0594.ph, 4
  %or.cond916 = and i1 %.not880, %.not881
  br i1 %or.cond916, label %bb.ex, label %.preheader

bb.ex:                                            ; preds = %bb.ew
  %i.tu = icmp slt i32 %.0728.ph, 0               ; 2 uses
  %spec.select904 = select i1 %i.tu, ptr %.2681, ptr %.0732.ph
  %spec.select905 = select i1 %i.tu, i32 %.17652, i32 %.0728.ph
  br label %.thread.outer

.thread.outer:                                    ; preds = %.thread.preheader, %bb.ex
  %.0732.ph = phi ptr [ null, %.thread.preheader ], [ %spec.select904, %bb.ex ] ; 2 uses
  %.0728.ph = phi i32 [ -1, %.thread.preheader ], [ %spec.select905, %bb.ex ] ; 4 uses
  %.0722.ph = phi i32 [ -1, %.thread.preheader ], [ %.3725, %bb.ex ]
  %.0716.ph = phi i32 [ -1, %.thread.preheader ], [ %.3719, %bb.ex ]
  %.0710.ph = phi i32 [ 0, %.thread.preheader ], [ %.3713, %bb.ex ]
  %.0706.ph = phi i32 [ 0, %.thread.preheader ], [ %.0706.ph1687, %bb.ex ]
  %.0702.ph = phi i32 [ -1, %.thread.preheader ], [ %.0702.ph1688, %bb.ex ]
  %.0698.ph = phi i32 [ -1, %.thread.preheader ], [ %.0698.ph1689, %bb.ex ]
  %.0691.ph = phi ptr [ null, %.thread.preheader ], [ %.3694, %bb.ex ]
  %.0688.ph = phi ptr [ %0, %.thread.preheader ], [ %.1689, %bb.ex ]
  %.0684.ph = phi ptr [ %0, %.thread.preheader ], [ %.1685, %bb.ex ]
  %.0679.ph = phi ptr [ %1, %.thread.preheader ], [ %.2681, %bb.ex ]
  %.0674.ph = phi ptr [ %i.d, %.thread.preheader ], [ %.3677, %bb.ex ]
  %.2637.ph1682 = phi i32 [ %.2637.ph, %.thread.preheader ], [ %.17652, %bb.ex ]
  %.0626.ph = phi i64 [ %i.m, %.thread.preheader ], [ %.1627, %bb.ex ]
  %.1621.ph = phi ptr [ %.0620, %.thread.preheader ], [ %.3623, %bb.ex ]
  %.0612.ph = phi i32 [ 0, %.thread.preheader ], [ %.2614, %bb.ex ]
  %.0608.ph = phi i32 [ 0, %.thread.preheader ], [ %.2610, %bb.ex ]
  %.0594.ph = phi i8 [ %3, %.thread.preheader ], [ 4, %bb.ex ] ; 5 uses
  %i.tv = zext i8 %.0594.ph to i32                ; 3 uses
  %i.tw = icmp ne i8 %.0594.ph, 4
  %i.tx = and i32 %i.tv, 1
  %.not838 = icmp eq i32 %i.tx, 0
  %i.ty = and i32 %i.tv, 2
  %.not840 = icmp eq i32 %i.ty, 0
  %i.tz = and i32 %i.tv, 8
  %.not843 = icmp ne i32 %i.tz, 0
  %.not876 = icmp eq i8 %.0594.ph, 8              ; 3 uses
  %.not876.not = xor i1 %.not876, true
  br label %.thread.outer1683

bb.ey:                                            ; preds = %bb.es
  %i.ua = and i32 %i.tk, 32
  %.not872 = icmp eq i32 %i.ua, 0
  br i1 %.not872, label %bb.ez, label %.thread1013

bb.ez:                                            ; preds = %bb.ey
  %i.ub = and i32 %i.tk, 1
  %.not873 = icmp eq i32 %i.ub, 0
  br i1 %.not873, label %bb.fj, label %bb.fa

bb.fa:                                            ; preds = %bb.ez
  %i.uc = icmp eq ptr %.2681, %1
  %or.cond906 = and i1 %i.uc, %.not876.not
  %i.ud = sub i32 0, %.2614
  %i.ue = icmp eq i32 %.2610, %i.ud               ; 2 uses
  %or.cond908 = select i1 %or.cond906, i1 %i.ue, i1 false
  br i1 %or.cond908, label %.critedge, label %bb.fb

bb.fb:                                            ; preds = %bb.fa
  %or.cond909 = select i1 %.not876, i1 %i.ue, i1 false
  br i1 %or.cond909, label %bb.ff, label %bb.fc
...
bb.fc:                                            ; preds = %bb.fb
  ...
  %i.ui = call fastcc zeroext i8 @zend_jit_trace_bad_stop_event(ptr noundef nonnull %.2681, i32 noundef %i.uh)
...
bb.fd:                                            ; preds = %bb.fc
  br i1 %.not876, label %.thread1013, label %bb.fe

bb.fe:                                            ; preds = %bb.fd
  %i.uj = call fastcc zeroext i8 @zend_jit_trace_bad_stop_event(ptr noundef %1, i32 noundef %i.uh)
  %.not878 = icmp eq i8 %i.uj, 22
  br i1 %.not878, label %bb.ff, label %.thread1013

bb.ff:                                            ; preds = %bb.fc, %bb.fc, %bb.fb, %bb.fe
  %i.uk = icmp eq ptr %.2681, %.3694
  %i.ul = icmp eq i32 %.2610, %.0698.ph1689
  %or.cond910 = select i1 %i.uk, i1 %i.ul, i1 false
  br i1 %or.cond910, label %bb.fg, label %bb.fh

bb.fg:                                            ; preds = %bb.ff
  store i8 9, ptr %2, align 8, !tbaa !12
  store i8 1, ptr %i.u, align 1, !tbaa !12
  store i8 0, ptr %i.v, align 1, !tbaa !12
  store ptr %.3623, ptr %i.w, align 8, !tbaa !12
  store i32 0, ptr %i.x, align 8, !tbaa !12
  store ptr %.2681, ptr %i.y, align 8, !tbaa !12
  %i.um = getelementptr inbounds nuw i8, ptr %2, i64 32
  %i.un = sext i32 %.0702.ph1688 to i64
  %i.uo = getelementptr inbounds [16 x i8], ptr %2, i64 %i.un
  %i.up = sub nsw i32 %.17652, %.0702.ph1688      ; 2 uses
...
bb.fh:                                            ; preds = %bb.ff
  %i.ut = sext i32 %.0706.ph1687 to i64
  %i.uu = load i64, ptr getelementptr inbounds nuw (i8, ptr @jit_globals, i64 120), align 8, !tbaa !167
  %i.uv = icmp sgt i64 %i.uu, %i.ut
  br i1 %i.uv, label %bb.fi, label %.thread1013

bb.fi:                                            ; preds = %bb.fh
  %i.uw = add nsw i32 %.0706.ph1687, 1
  br label %.thread.outer1683

.thread.outer1683:                                ; preds = %.thread.outer, %bb.fi
  %.0722.ph1684 = phi i32 [ %.0722.ph, %.thread.outer ], [ %.3725, %bb.fi ]
  %.0716.ph1685 = phi i32 [ %.0716.ph, %.thread.outer ], [ %.3719, %bb.fi ]
  %.0710.ph1686 = phi i32 [ %.0710.ph, %.thread.outer ], [ %.3713, %bb.fi ]
  %.0706.ph1687 = phi i32 [ %.0706.ph, %.thread.outer ], [ %i.uw, %bb.fi ] ; 3 uses
  %.0702.ph1688 = phi i32 [ %.0702.ph, %.thread.outer ], [ %.17652, %bb.fi ] ; 3 uses
  %.0698.ph1689 = phi i32 [ %.0698.ph, %.thread.outer ], [ %.2610, %bb.fi ] ; 3 uses
  %.0691.ph1690 = phi ptr [ %.0691.ph, %.thread.outer ], [ %.2681, %bb.fi ]
  %.0688.ph1691 = phi ptr [ %.0688.ph, %.thread.outer ], [ %.1689, %bb.fi ]
  %.0684.ph1692 = phi ptr [ %.0684.ph, %.thread.outer ], [ %.1685, %bb.fi ]
  %.0679.ph1693 = phi ptr [ %.0679.ph, %.thread.outer ], [ %.2681, %bb.fi ]
  %.0674.ph1694 = phi ptr [ %.0674.ph, %.thread.outer ], [ %.3677, %bb.fi ]
  %.2637.ph1695 = phi i32 [ %.2637.ph1682, %.thread.outer ], [ %.17652, %bb.fi ]
  %.0626.ph1696 = phi i64 [ %.0626.ph, %.thread.outer ], [ %.1627, %bb.fi ]
  %.1621.ph1697 = phi ptr [ %.1621.ph, %.thread.outer ], [ %.3623, %bb.fi ]
  %.0612.ph1698 = phi i32 [ %.0612.ph, %.thread.outer ], [ %.2614, %bb.fi ]
  %.0608.ph1699 = phi i32 [ %.0608.ph, %.thread.outer ], [ %.2610, %bb.fi ]
  br label %.thread

bb.fj:                                            ; preds = %bb.ez
  %i.ux = and i32 %i.tk, 64
  %.not874 = icmp eq i32 %i.ux, 0
  br i1 %.not874, label %.thread.backedge, label %bb.fk

bb.fk:                                            ; preds = %bb.fj
  %i.uy = zext nneg i32 %.17652 to i64
  ...
  store ptr %.2681, ptr %i.va, align 8, !tbaa !12
  %i.vb = add nuw nsw i32 %.17652, 1              ; 2 uses
  ...
  %.not875 = icmp sgt i64 %i.ve, %i.vc
  %.911 = select i1 %.not875, i32 12, i32 14
  br label %.thread1013

.thread1013:                                      ; preds = %bb.cj, %bb.cv, %bb.cz, %bb.ea, %bb.eq, %bb.ey, %bb.dc, %bb.dm, %bb.dp, %bb.ds, %bb.dv, %bb.dx, %bb.as, %bb.aq, %bb.ao, %bb.ep, %bb.fd, %bb.fe, %bb.fh, %bb.ev, %bb.fk
  %.181038 = phi i32 [ %.911, %bb.fk ], [ 23, %bb.ev ], [ 14, %bb.cj ], [ 14, %bb.ao ], [ 14, %bb.ep ], [ 14, %bb.dx ], [ 20, %bb.dv ], [ 19, %bb.ds ], [ 17, %bb.dp ], [ 14, %bb.dm ], [ 17, %bb.dc ], [ 21, %bb.ey ], [ 13, %bb.eq ], [ 14, %bb.ea ], [ 14, %bb.cz ], [ 15, %bb.cv ], [ 14, %bb.as ], [ 14, %bb.aq ], [ 18, %bb.fh ], [ 22, %bb.fe ], [ 22, %bb.fd ] ; 3 uses
  %.66181035 = phi i32 [ %.2614, %bb.fk ], [ %.2614, %bb.ev ], [ %.0612, %bb.cj ], [ %.0612, %bb.ao ], [ %.2614, %bb.ep ], [ %.0612, %bb.dx ], [ %.0612, %bb.dv ], [ %.0612, %bb.ds ], [ %.0612, %bb.dp ], [ %.0612, %bb.dm ], [ %.0612, %bb.dc ], [ %.2614, %bb.ey ], [ %.2614, %bb.eq ], [ %.0612, %bb.ea ], [ %.0612, %bb.cz ], [ %.0612, %bb.cv ], [ %.0612, %bb.as ], [ %.0612, %bb.aq ], [ %.2614, %bb.fd ], [ %.2614, %bb.fe ], [ %.2614, %bb.fh ] ; 4 uses
  %.211034 = phi i32 [ %i.vb, %bb.fk ], [ %.17652, %bb.ev ], [ %i.kl, %bb.cj ], [ %i.et, %bb.ao ], [ %i.ta, %bb.ep ], [ %i.qf, %bb.dx ], [ %.11646, %bb.dv ], [ %.11646, %bb.ds ], [ %i.ov, %bb.dp ], [ %i.ov, %bb.dm ], [ %i.mq, %bb.dc ], [ %.17652, %bb.ey ], [ %.17652, %bb.eq ], [ %i.qq, %bb.ea ], [ %i.mq, %bb.cz ], [ %.11646, %bb.cv ], [ %i.fg, %bb.as ], [ %i.ez, %bb.aq ], [ %.17652, %bb.fd ], [ %.17652, %bb.fe ], [ %.17652, %bb.fh ] ; 2 uses
  %.46831032 = phi ptr [ %.2681, %bb.fk ], [ %.2681, %bb.ev ], [ %.0679, %bb.cj ], [ %.0679, %bb.ao ], [ %.2681, %bb.ep ], [ %.2681, %bb.dx ], [ %.2681, %bb.dv ], [ %.2681, %bb.ds ], [ %.2681, %bb.dp ], [ %.2681, %bb.dm ], [ %.2681, %bb.dc ], [ %.2681, %bb.ey ], [ %.2681, %bb.eq ], [ %.2681, %bb.ea ], [ %.2681, %bb.cz ], [ %.2681, %bb.cv ], [ %.0679, %bb.as ], [ %.0679, %bb.aq ], [ %.2681, %bb.fd ], [ %.2681, %bb.fe ], [ %.2681, %bb.fh ] ; 7 uses
  %.36871030 = phi ptr [ %.1685, %bb.fk ], [ %.1685, %bb.ev ], [ %.0684, %bb.cj ], [ %.0684, %bb.ao ], [ %.1685, %bb.ep ], [ %.1685, %bb.dx ], [ %.1685, %bb.dv ], [ %.1685, %bb.ds ], [ %.1685, %bb.dp ], [ %.1685, %bb.dm ], [ %.1685, %bb.dc ], [ %.1685, %bb.ey ], [ %.1685, %bb.eq ], [ %.1685, %bb.ea ], [ %.1685, %bb.cz ], [ %.1685, %bb.cv ], [ %.0684, %bb.as ], [ %.0684, %bb.aq ], [ %.1685, %bb.fd ], [ %.1685, %bb.fe ], [ %.1685, %bb.fh ] ; 5 uses
  %.57151029 = phi i32 [ %.3713, %bb.fk ], [ %.3713, %bb.ev ], [ %.0710, %bb.cj ], [ %.0710, %bb.ao ], [ %.3713, %bb.ep ], [ %.0710, %bb.dx ], [ %.0710, %bb.dv ], [ %.0710, %bb.ds ], [ %.0710, %bb.dp ], [ %.0710, %bb.dm ], [ %.0710, %bb.dc ], [ %.3713, %bb.ey ], [ %.3713, %bb.eq ], [ %.0710, %bb.ea ], [ %.0710, %bb.cz ], [ %.0710, %bb.cv ], [ %.0710, %bb.as ], [ %.0710, %bb.aq ], [ %.3713, %bb.fd ], [ %.3713, %bb.fe ], [ %.3713, %bb.fh ]
  %.57211028 = phi i32 [ %.3719, %bb.fk ], [ %.3719, %bb.ev ], [ %.0716, %bb.cj ], [ %.0716, %bb.ao ], [ %.3719, %bb.ep ], [ %.0716, %bb.dx ], [ %.0716, %bb.dv ], [ %.0716, %bb.ds ], [ %.0716, %bb.dp ], [ %.0716, %bb.dm ], [ %.0716, %bb.dc ], [ %.3719, %bb.ey ], [ %.3719, %bb.eq ], [ %.0716, %bb.ea ], [ %.0716, %bb.cz ], [ %.0716, %bb.cv ], [ %.0716, %bb.as ], [ %.0716, %bb.aq ], [ %.3719, %bb.fd ], [ %.3719, %bb.fe ], [ %.3719, %bb.fh ] ; 2 uses
  %.57271027 = phi i32 [ %.3725, %bb.fk ], [ %.3725, %bb.ev ], [ %.0722, %bb.cj ], [ %.0722, %bb.ao ], [ %.3725, %bb.ep ], [ %.0722, %bb.dx ], [ %.0722, %bb.dv ], [ %.0722, %bb.ds ], [ %.0722, %bb.dp ], [ %.0722, %bb.dm ], [ %.0722, %bb.dc ], [ %.3725, %bb.ey ], [ %.3725, %bb.eq ], [ %.0722, %bb.ea ], [ %.0722, %bb.cz ], [ %.0722, %bb.cv ], [ %.0722, %bb.as ], [ %.0722, %bb.aq ], [ %.3725, %bb.fd ], [ %.3725, %bb.fe ], [ %.3725, %bb.fh ] ; 2 uses
  %i.vf = icmp sgt i32 %.57271027, 0
  br i1 %i.vf, label %.critedge, label %bb.fl

bb.fl:                                            ; preds = %.thread1013
  %i.vg = icmp sgt i32 %.57211028, 0
  br i1 %i.vg, label %.critedge, label %bb.fm

bb.fm:                                            ; preds = %bb.fl
  %i.vh = icmp sgt i32 %.0728.ph, 0
  %i.vi = icmp eq i32 %.181038, 17
  %or.cond16 = and i1 %i.vi, %i.vh
...
.preheader:                                       ; preds = %bb.ew, %bb.fn, %bb.eu, %bb.ev
  %.46831033.ph = phi ptr [ %.46831032, %bb.fn ], [ %.2681, %bb.ev ], [ %.2681, %bb.eu ], [ %.2681, %bb.ew ] ; 2 uses
  %.36871031.ph = phi ptr [ %.36871030, %bb.fn ], [ %.1685, %bb.ev ], [ %.1685, %bb.eu ], [ %.1685, %bb.ew ] ; 2 uses
  %.22.ph = phi i32 [ %.0728.ph, %bb.fn ], [ %.17652, %bb.ev ], [ %.17652, %bb.eu ], [ %.17652, %bb.ew ] ; 2 uses
  %.7619.ph = phi i32 [ %.66181035, %bb.fn ], [ %.2614, %bb.ev ], [ %.2614, %bb.eu ], [ %.2614, %bb.ew ] ; 2 uses
  %.0599.ph = phi ptr [ %.0732.ph, %bb.fn ], [ %.2681, %bb.ev ], [ %.2681, %bb.eu ], [ %.2681, %bb.ew ] ; 2 uses
  ...
  br i1 %i.vs, label %.lr.ph1233, label %.critedge

.lr.ph1233:                                       ; preds = %.preheader, %bb.fo
  ...
  %.not885 = icmp eq i32 %i.vv, 0
  br i1 %.not885, label %.critedge.loopexit, label %bb.fo

bb.fo:                                            ; preds = %.lr.ph1233
  ...
  br i1 %i.vz, label %.lr.ph1233, label %.critedge.loopexit, !llvm.loop !168

.critedge.loopexit:                               ; preds = %.lr.ph1233, %bb.fo
  %.24.ph.in = phi i64 [ %indvars.iv.next, %bb.fo ], [ %indvars.iv, %.lr.ph1233 ]
  %.24.ph = trunc i64 %.24.ph.in to i32
  br label %.critedge

.critedge:                                        ; preds = %bb.dg, %bb.ci, %bb.dh, %bb.do, %bb.cy, %bb.cx, %bb.db, %bb.cw, %bb.dw, %bb.cd, %bb.cd, %bb.ce, %bb.dr, %bb.dz, %bb.fa, %.critedge.loopexit, %.preheader, %bb.cm, %bb.cq, %bb.fg, %bb.cl, %bb.cl, %bb.fl, %bb.fn, %.thread1013, %bb.fm
  %.05991066 = phi ptr [ null, %bb.cl ], [ null, %bb.cl ], [ %.0599.ph, %.critedge.loopexit ], [ %.46831032, %bb.fm ], [ %1, %bb.fl ], [ %.46831032, %bb.fn ], [ %1, %.thread1013 ], [ null, %bb.cm ], [ %.0599.ph, %.preheader ], [ %.2681, %bb.cq ], [ %.2681, %bb.fg ], [ %.0679, %bb.ce ], [ %.2681, %bb.dr ], [ %.2681, %bb.dz ], [ %.0679, %bb.cd ], [ %.0679, %bb.cd ], [ %.2681, %bb.dg ], [ %.0679, %bb.ci ], [ %.2681, %bb.dh ], [ %.2681, %bb.do ], [ %.2681, %bb.cy ], [ %.2681, %bb.cx ], [ %.2681, %bb.db ], [ %.2681, %bb.cw ], [ %.2681, %bb.dw ], [ %.2681, %bb.fa ]
  %.191065 = phi i32 [ 5, %bb.cl ], [ 5, %bb.cl ], [ 4, %.critedge.loopexit ], [ %.181038, %bb.fm ], [ 2, %bb.fl ], [ 17, %bb.fn ], [ 1, %.thread1013 ], [ 3, %bb.cm ], [ 4, %.preheader ], [ %.889, %bb.cq ], [ 0, %bb.fg ], [ 5, %bb.ce ], [ 8, %bb.dr ], [ 8, %bb.dz ], [ 5, %bb.cd ], [ 5, %bb.cd ], [ 3, %bb.dg ], [ 8, %bb.ci ], [ 3, %bb.dh ], [ 2, %bb.do ], [ 5, %bb.cy ], [ 7, %bb.cx ], [ 1, %bb.db ], [ 6, %bb.cw ], [ 3, %bb.dw ], [ 0, %bb.fa ]
  %.76191064 = phi i32 [ %.0612, %bb.cl ], [ %.0612, %bb.cl ], [ %.7619.ph, %.critedge.loopexit ], [ %.66181035, %bb.fm ], [ %.57151029, %bb.fl ], [ %.66181035, %bb.fn ], [ %.66181035, %.thread1013 ], [ %.0612, %bb.cm ], [ %.7619.ph, %.preheader ], [ %.0612, %bb.cq ], [ 0, %bb.fg ], [ %.0612, %bb.ce ], [ %i.pn, %bb.dr ], [ %i.qj, %bb.dz ], [ %.0612, %bb.cd ], [ %.0612, %bb.cd ], [ %.0612, %bb.dg ], [ %.0612, %bb.ci ], [ %.0612, %bb.dh ], [ %.0612, %bb.do ], [ %.0612, %bb.cy ], [ %.0612, %bb.cx ], [ %.0612, %bb.db ], [ %.0612, %bb.cw ], [ %.0612, %bb.dw ], [ %.2614, %bb.fa ]
  %.368710311063 = phi ptr [ %.0684, %bb.cl ], [ %.0684, %bb.cl ], [ %.36871031.ph, %.critedge.loopexit ], [ %.36871030, %bb.fm ], [ %.36871030, %bb.fl ], [ %.36871030, %bb.fn ], [ %.36871030, %.thread1013 ], [ %.0684, %bb.cm ], [ %.36871031.ph, %.preheader ], [ %.1685, %bb.cq ], [ %.1685, %bb.fg ], [ %.0684, %bb.ce ], [ %.1685, %bb.dr ], [ %.1685, %bb.dz ], [ %.0684, %bb.cd ], [ %.0684, %bb.cd ], [ %.1685, %bb.dg ], [ %.0684, %bb.ci ], [ %.1685, %bb.dh ], [ %.1685, %bb.do ], [ %.1685, %bb.cy ], [ %.1685, %bb.cx ], [ %.1685, %bb.db ], [ %.1685, %bb.cw ], [ %.1685, %bb.dw ], [ %.1685, %bb.fa ]
  %.468310331062 = phi ptr [ null, %bb.cl ], [ null, %bb.cl ], [ %.46831033.ph, %.critedge.loopexit ], [ %.46831032, %bb.fm ], [ %.46831032, %bb.fl ], [ %.46831032, %bb.fn ], [ %.46831032, %.thread1013 ], [ null, %bb.cm ], [ %.46831033.ph, %.preheader ], [ %.2681, %bb.cq ], [ %.2681, %bb.fg ], [ %.0679, %bb.ce ], [ %.2681, %bb.dr ], [ %.2681, %bb.dz ], [ %.0679, %bb.cd ], [ %.0679, %bb.cd ], [ %.2681, %bb.dg ], [ %.0679, %bb.ci ], [ %.2681, %bb.dh ], [ %.2681, %bb.do ], [ %.2681, %bb.cy ], [ %.2681, %bb.cx ], [ %.2681, %bb.db ], [ %.2681, %bb.cw ], [ %.2681, %bb.dw ], [ %.2681, %bb.fa ]
  %.not887 = phi i1 [ false, %bb.cl ], [ false, %bb.cl ], [ true, %.critedge.loopexit ], [ true, %bb.fm ], [ true, %bb.fl ], [ true, %bb.fn ], [ true, %.thread1013 ], [ false, %bb.cm ], [ true, %.preheader ], [ true, %bb.cq ], [ true, %bb.fg ], [ true, %bb.fa ], [ true, %bb.dz ], [ true, %bb.dr ], [ true, %bb.ce ], [ true, %bb.cd ], [ true, %bb.cd ], [ true, %bb.dw ], [ true, %bb.cw ], [ true, %bb.db ], [ true, %bb.cx ], [ true, %bb.cy ], [ true, %bb.do ], [ true, %bb.dh ], [ true, %bb.ci ], [ true, %bb.dg ]
  %.260610371061 = phi i32 [ 69, %bb.cl ], [ 69, %bb.cl ], [ 4, %.critedge.loopexit ], [ %.181038, %bb.fm ], [ 2, %bb.fl ], [ 17, %bb.fn ], [ 1, %.thread1013 ], [ 67, %bb.cm ], [ 4, %.preheader ], [ %.889, %bb.cq ], [ 0, %bb.fg ], [ 5, %bb.ce ], [ 8, %bb.dr ], [ 8, %bb.dz ], [ 5, %bb.cd ], [ 5, %bb.cd ], [ 3, %bb.dg ], [ 8, %bb.ci ], [ 3, %bb.dh ], [ 2, %bb.do ], [ 5, %bb.cy ], [ 7, %bb.cx ], [ 1, %bb.db ], [ 6, %bb.cw ], [ 3, %bb.dw ], [ 0, %bb.fa ] ; 2 uses
  %.24 = phi i32 [ %.11646, %bb.cl ], [ %.11646, %bb.cl ], [ %.24.ph, %.critedge.loopexit ], [ %.211034, %bb.fm ], [ %.57211028, %bb.fl ], [ %.211034, %bb.fn ], [ %.57271027, %.thread1013 ], [ %.11646, %bb.cm ], [ %.22.ph, %.preheader ], [ %.11646, %bb.cq ], [ %i.us, %bb.fg ], [ %.9644, %bb.ce ], [ %i.ov, %bb.dr ], [ %i.qf, %bb.dz ], [ %.9644, %bb.cd ], [ %.9644, %bb.cd ], [ %.11646, %bb.dg ], [ %.9644, %bb.ci ], [ %.11646, %bb.dh ], [ %i.ov, %bb.do ], [ %.11646, %bb.cy ], [ %.11646, %bb.cx ], [ %i.mq, %bb.db ], [ %.11646, %bb.cw ], [ %.11646, %bb.dw ], [ %.17652, %bb.fa ] ; 2 uses
  %.76191064.fr = freeze i32 %.76191064           ; 2 uses
  ...
  %i.wc = trunc nuw nsw i32 %.191065 to i8        ; 2 uses
  ...
  %.not886 = icmp eq i32 %.76191064.fr, 0
  %i.wf = trunc i32 %.76191064.fr to i8
  %i.wg = add i8 %i.wf, 1
  %spec.select1105 = select i1 %.not886, i8 0, i8 %i.wg ; 2 uses
  store i8 %spec.select1105, ptr %i.v, align 1, !tbaa !12
  %i.wh = getelementptr inbounds nuw i8, ptr %i.wb, i64 3
  store i8 %spec.select1105, ptr %i.wh, align 1, !tbaa !12
  %i.wi = getelementptr inbounds nuw i8, ptr %i.wb, i64 8
  store ptr %.05991066, ptr %i.wi, align 8, !tbaa !12
  br i1 %.not887, label %bb.fp, label %bb.fq

bb.fp:                                            ; preds = %.critedge
  store ptr %.468310331062, ptr %.368710311063, align 8, !tbaa !65
  br label %bb.fq

bb.fq:                                            ; preds = %.critedge, %bb.fp, %bb.j, %bb.g, %bb.e
  %.1 = phi i32 [ 13, %bb.e ], [ 12, %bb.g ], [ 8, %bb.j ], [ %.260610371061, %bb.fp ], [ %.260610371061, %.critedge ]
...
begin_hunk_2_@zend_jit_trace_record_fake_init_call_ex:bb.a
  %.140 = phi ptr [ %.03967, %bb.j ], [ null, %bb.m ], [ %.03967, %bb.l ], [ null, %bb.i ], [ null, %.thread64 ], [ null, %bb.h ], [ null, %bb.d ], [ null, %.critedge ], [ null, %.critedge59 ], [ null, %bb.f ]
  %i.an = shl i32 %4, 16
  ...
  store ptr %.140, ptr %i.ar, align 8, !tbaa !12
  %i.as = add nsw i32 %.041, 1
  br label %select.unfold

select.unfold:                                    ; preds = %.thread60, %bb.b
  %.1 = phi i32 [ %i.d, %bb.b ], [ %i.as, %.thread60 ]
  ret i32 %.1
}
