...
.thread656:                                       ; preds = %bb.am, %.preheader753.split.us, %bb.ce, %bb.ca, %bb.bv, %bb.bq, %bb.bf, %bb.bc, %bb.bw
  ...
  %i.ha = load ptr, ptr %i.gz, align 8, !tbaa !35 ; 2 uses
...
bb.cl:                                            ; preds = %bb.ck
  ...
  %i.hp = load ptr, ptr %i.gz, align 8, !tbaa !35
...
bb.cy:                                            ; preds = %bb.ct, %bb.cs
  ...
  %i.ie = load ptr, ptr %i.id, align 8, !tbaa !38 ; 3 uses
...
.thread876:                                       ; preds = %bb.cu
  ...
  %i.ii = load ptr, ptr %i.ih, align 8, !tbaa !38 ; 2 uses
...
.thread870:                                       ; preds = %bb.cv
  ...
  %i.in = load ptr, ptr %i.im, align 8, !tbaa !38 ; 2 uses
...
.preheader.split.us:                              ; preds = %.thread876, %.preheader
  ...
  %i.it = load ptr, ptr %i.iq, align 8, !tbaa !41
...
.lr.ph929:                                        ; preds = %.preheader.split.us, %bb.cz
  ...
  %i.jf = load ptr, ptr %i.je, align 8, !tbaa !42 ; 4 uses
...
bb.cz:                                            ; preds = %.lr.ph929
  ...
  %i.jj = load ptr, ptr %i.jf, align 8, !tbaa !41
...
.preheader.split:                                 ; preds = %.preheader.split.preheader, %bb.dd
  ...
  %i.js = load ptr, ptr %.0, align 8, !tbaa !41   ; 2 uses
...
.thread686:                                       ; preds = %bb.da
  ...
  %i.kd = load ptr, ptr %i.kc, align 8, !tbaa !42
...
bb.dd:                                            ; preds = %.thread690
  ...
  %.pr = load ptr, ptr %i.kc, align 8, !tbaa !42  ; 2 uses
  %.not616 = icmp eq ptr %.pr, null
  br i1 %.not616, label %.thread702, label %.preheader.split, !llvm.loop !19
...
.thread736:                                       ; preds = %.thread893, %.thread746, %.thread713, %bb.dt, %bb.dx
  ...
  store i8 0, ptr %i.nk, align 1, !tbaa !16
...
.thread:                                          ; preds = %bb.h
  ...
  %i.h = load ptr, ptr %1, align 8, !tbaa !54     ; 3 uses
...
.thread656:                                       ; preds = %bb.am, %.preheader763.split.us, %bb.ce, %bb.ca, %bb.bv, %bb.bq, %bb.bf, %bb.bc, %bb.bw
  ...
  %i.hm = load ptr, ptr %i.hl, align 8, !tbaa !64 ; 2 uses
...
bb.cl:                                            ; preds = %bb.ck
  ...
  %i.ic = load ptr, ptr %i.hl, align 8, !tbaa !64
...
bb.cr:                                            ; preds = %.thread864, %bb.cq, %bb.cl, %.thread639, %.thread656, %bb.s
  ...
  %i.im = load i32, ptr %i.il, align 8, !tbaa !66
  %.not605 = icmp eq i32 %i.im, 0
  br i1 %.not605, label %bb.cs, label %bb.cu

bb.cs:                                            ; preds = %bb.cr
  %i.in = getelementptr inbounds nuw i8, ptr %1, i64 96
  %i.io = load ptr, ptr %i.in, align 8, !tbaa !67
...
bb.cy:                                            ; preds = %bb.ct, %bb.cs
  ...
  %i.ir = load ptr, ptr %i.iq, align 8, !tbaa !67 ; 3 uses
...
.thread886:                                       ; preds = %bb.cu
  ...
  %i.iv = load ptr, ptr %i.iu, align 8, !tbaa !67 ; 2 uses
...
.preheader.split.us:                              ; preds = %.thread886, %.preheader
  ...
  %i.jf = load ptr, ptr %i.je, align 8, !tbaa !69
  %i.jg = load ptr, ptr %i.jd, align 8, !tbaa !70
...
.lr.ph939:                                        ; preds = %.preheader.split.us, %bb.cz
  ...
  %i.jt = load ptr, ptr %i.js, align 8, !tbaa !71 ; 4 uses
...
bb.cz:                                            ; preds = %.lr.ph939
  ...
  %i.jw = load ptr, ptr %i.jv, align 8, !tbaa !69
  %i.jx = load ptr, ptr %i.jt, align 8, !tbaa !70
...
.preheader.split:                                 ; preds = %.preheader.split.preheader, %bb.dd
  ...
  %i.kg = load ptr, ptr %i.kf, align 8, !tbaa !69
  %i.kh = load ptr, ptr %.0, align 8, !tbaa !70   ; 2 uses
...
.thread686:                                       ; preds = %bb.da
  ...
  %i.kt = load ptr, ptr %i.ks, align 8, !tbaa !71
...
bb.dd:                                            ; preds = %.thread690
  ...
  %.pr = load ptr, ptr %i.ks, align 8, !tbaa !71  ; 2 uses
  %.not616 = icmp eq ptr %.pr, null
  br i1 %.not616, label %.thread702, label %.preheader.split, !llvm.loop !48
...
!14 = !{!"p1 _ZTS12UriIp4Struct", !13, i64 0}
!15 = !{!"p1 _ZTS12UriIp6Struct", !13, i64 0}
!16 = !{!8, !8, i64 0}
!17 = !{!"llvm.loop.mustprogress"}
!18 = distinct !{!18, !17}
!19 = distinct !{!19, !17}
!20 = !{!"p1 omnipotent char", !13, i64 0}
!21 = !{!"UriTextRangeStructA", !20, i64 0, !20, i64 8}
!22 = !{!"UriHostDataStructA", !14, i64 0, !15, i64 8, !21, i64 16}
!23 = !{!"p1 _ZTS21UriPathSegmentStructA", !13, i64 0}
!24 = !{!"UriUriStructA", !21, i64 0, !21, i64 16, !21, i64 32, !22, i64 48, !21, i64 80, !23, i64 96, !23, i64 104, !21, i64 112, !21, i64 128, !9, i64 144, !9, i64 148, !13, i64 152}
!25 = !{!24, !20, i64 0}
!26 = !{!24, !20, i64 8}
!27 = !{!24, !20, i64 16}
!28 = !{!24, !20, i64 24}
...
!37 = !{!24, !9, i64 144}
!38 = !{!24, !23, i64 96}
!39 = !{!"UriPathSegmentStructA", !21, i64 0, !23, i64 16, !13, i64 24}
!40 = !{!39, !20, i64 8}
!41 = !{!39, !20, i64 0}
!42 = !{!39, !23, i64 16}
!43 = !{!24, !20, i64 112}
...
!48 = distinct !{!48, !17}
!49 = !{!"p1 int", !13, i64 0}
!50 = !{!"UriTextRangeStructW", !49, i64 0, !49, i64 8}
!51 = !{!"UriHostDataStructW", !14, i64 0, !15, i64 8, !50, i64 16}
!52 = !{!"p1 _ZTS21UriPathSegmentStructW", !13, i64 0}
!53 = !{!"UriUriStructW", !50, i64 0, !50, i64 16, !50, i64 32, !51, i64 48, !50, i64 80, !52, i64 96, !52, i64 104, !50, i64 112, !50, i64 128, !9, i64 144, !9, i64 148, !13, i64 152}
!54 = !{!53, !49, i64 0}
!55 = !{!53, !49, i64 8}
!56 = !{!53, !49, i64 16}
!57 = !{!53, !49, i64 24}
...
!66 = !{!53, !9, i64 144}
!67 = !{!53, !52, i64 96}
!68 = !{!"UriPathSegmentStructW", !50, i64 0, !52, i64 16, !13, i64 24}
!69 = !{!68, !49, i64 8}
!70 = !{!68, !49, i64 0}
!71 = !{!68, !52, i64 16}
!72 = !{!53, !49, i64 112}
