...
zend_parse_arg_obj.exit:                          ; preds = %bb.c, %bb.b
  ...
  tail call void @zend_wrong_parameter_error(i32 noundef %.045, i32 noundef %.046, ptr noundef null, i32 noundef %.046.a, ptr noundef %.047.a) #9
  br label %bb.d
...
bb.d:                                             ; preds = %bb.b, %bb.c
  ...
  tail call void @zend_wrong_parameter_error(i32 noundef %.035.ph, i32 noundef %.034.ph, ptr noundef null, i32 noundef %.037.ph, ptr noundef %.036.ph) #9
  br label %bb.e
...
bb.d:                                             ; preds = %bb.b, %bb.c
  ...
  %.052.ph.a = phi i32 [ 1, %bb.c ], [ 0, %bb.b ]
  tail call void @zend_wrong_parameter_error(i32 noundef %.055.ph, i32 noundef %.052.ph.a, ptr noundef null, i32 noundef %.052.ph, ptr noundef %.051.ph) #9
  br label %bb.o
...
bb.g:                                             ; preds = %.lr.ph, %spl_object_storage_free_hash.exit.thread
  ...
  %.in.a = phi i64 [ undef, %.lr.ph ], [ %.sroa.0.2617183102, %spl_object_storage_free_hash.exit.thread ] ; 3 uses
...
bb.p:                                             ; preds = %bb.n
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #9
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #9
  %.not.i.i.a = icmp eq ptr %i.bp, null
  br i1 %.not.i.i.a, label %8, label %6

6:                                                ; preds = %bb.p
  %7 = call ptr @zend_hash_find(ptr noundef nonnull %i.g, ptr noundef nonnull %i.bp) #9 ; 2 uses
  %.not.i.i = icmp eq ptr %7, null
  br i1 %.not.i.i, label %spl_object_storage_get.exit.thread79, label %spl_object_storage_get.exit

8:                                                ; preds = %.thread, %bb.p
  %.sroa.0.26169 = phi i64 [ %i.bo, %.thread ], [ %.in.a, %bb.p ] ; 3 uses
...
spl_object_storage_free_hash.exit.thread91:       ; preds = %8
...
spl_object_storage_get.exit.thread79:             ; preds = %6, %spl_object_storage_get.exit
  %.0.i5484 = phi ptr [ %i.br, %spl_object_storage_get.exit ], [ null, %6 ] ; 2 uses
...
bb.s:                                             ; preds = %spl_object_storage_free_hash.exit.thread91, %spl_object_storage_free_hash.exit
  %.sroa.0.2617183110 = phi i64 [ %.sroa.0.26169, %spl_object_storage_free_hash.exit.thread91 ], [ %.in.a, %spl_object_storage_free_hash.exit ]
...
spl_object_storage_free_hash.exit.thread:         ; preds = %8, %spl_object_storage_free_hash.exit, %bb.u
  %.sroa.0.2617183102 = phi i64 [ %.in.a, %spl_object_storage_free_hash.exit ], [ %.sroa.0.2617183110, %bb.u ], [ %.sroa.0.26169, %8 ]
...
.thread106:                                       ; preds = %zend_parse_arg_str_or_long.exit, %bb.g, %bb.f, %bb.b
  %.062119.a = phi i32 [ 0, %bb.b ], [ 1, %bb.f ], [ 1, %bb.g ], [ 2, %zend_parse_arg_str_or_long.exit ]
  %.063118.a = phi ptr [ null, %bb.b ], [ %i.g, %bb.f ], [ %i.g, %bb.g ], [ %i.v, %zend_parse_arg_str_or_long.exit ]
  ...
  call void @zend_wrong_parameter_error(i32 noundef %.065117, i32 noundef %.062119.a, ptr noundef %.066116, i32 noundef %.064117, ptr noundef %.063118.a) #9
  br label %bb.n
