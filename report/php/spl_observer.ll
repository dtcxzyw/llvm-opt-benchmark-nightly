...
.sink.split:                                      ; preds = %bb.l, %bb.m
  %.sink139 = phi i32 [ %i.ay, %bb.m ], [ %i.ar, %bb.l ]
  %.sink.in = phi ptr [ %i.aw, %bb.m ], [ %i.ap, %bb.l ] ; 2 uses
  %i.ba = and i32 %.sink139, 65280
...
bb.n:                                             ; preds = %.sink.split, %bb.k, %bb.m
  %.053 = phi ptr [ %i.ap, %bb.k ], [ %i.aw, %bb.m ], [ %.sink.in, %.sink.split ] ; 2 uses
  %i.be = load ptr, ptr %.053, align 8, !tbaa !12
  %i.bf = getelementptr inbounds nuw i8, ptr %.053, i64 8
...
bb.c:                                             ; preds = %.lr.ph, %zend_object_release.exit
  ...
  %.033 = phi ptr [ %i.p, %.lr.ph ], [ %i.by, %zend_object_release.exit ] ; 2 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %.033, i64 8
  %i.ac = load i8, ptr %i.ab, align 8, !tbaa !12
  %i.ad = icmp eq i8 %i.ac, 0
  br i1 %i.ad, label %zend_object_release.exit, label %bb.d, !prof !15

bb.d:                                             ; preds = %bb.c
  %i.ae = load ptr, ptr %.033, align 8, !tbaa !12
...
bb.g:                                             ; preds = %.lr.ph, %spl_object_storage_free_hash.exit.thread
  ...
  br i1 %.not42, label %bb.h, label %.thread112
...
bb.h:                                             ; preds = %bb.g
  ...
  switch i8 %i.ap, label %.thread112 [
    i8 79, label %bb.i
    i8 67, label %bb.i
    i8 114, label %bb.i
  ]
...
bb.i:                                             ; preds = %bb.h, %bb.h, %bb.h
  ...
  br i1 %.not46, label %.thread112, label %bb.j
...
bb.q:                                             ; preds = %spl_object_storage_get.exit.thread85
...
spl_object_storage_free_hash.exit:                ; preds = %spl_object_storage_get.exit.thread85, %bb.q, %bb.r
  %.not49 = icmp eq ptr %.0.i5492, null
...
bb.t:                                             ; preds = %bb.s
  %i.cc = getelementptr inbounds nuw i8, ptr %.0.i5484109, i64 8
  call void @var_push_dtor(ptr noundef nonnull %i.d, ptr noundef nonnull %i.cc) #9
  br label %bb.u

bb.u:                                             ; preds = %bb.s, %bb.t
  %i.cd = load ptr, ptr %.0.i5484109, align 8, !tbaa !55
...
.thread112.sink.split:                            ; preds = %bb.l, %bb.k, %.loopexit
  call void @zval_ptr_dtor(ptr noundef nonnull %4) #9
  br label %.thread112

.thread112:                                       ; preds = %bb.h, %bb.g, %bb.i, %.thread112.sink.split
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #9
  br label %bb.aa
...
bb.aa:                                            ; preds = %.thread112, %bb.x, %bb.y, %bb.v, %bb.w, %._crit_edge, %bb.f, %bb.d, %bb.e, %bb.b, %bb.c
...
bb.d:                                             ; preds = %bb.c
  ...
  %.pre144.a = load ptr, ptr %i.g, align 8, !tbaa !12 ; 3 uses
  br i1 %.not.i, label %instanceof_function.exit.thread, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.l = getelementptr inbounds nuw i8, ptr %.pre144.a, i64 16
...
bb.f:                                             ; preds = %thread-pre-split, %bb.c
  ...
  br i1 %.not, label %.thread107, label %bb.g, !prof !91
...
instanceof_function.exit.thread:                  ; preds = %instanceof_function.exit.instanceof_function.exit.thread_crit_edge, %bb.e, %bb.d
  %i.t = phi ptr [ %.pre, %instanceof_function.exit.instanceof_function.exit.thread_crit_edge ], [ %.pre144.a, %bb.e ], [ %.pre144.a, %bb.d ] ; 2 uses
...
.critedge.thread136.thread:                       ; preds = %bb.h
  store ptr null, ptr %i.a, align 8, !tbaa !76
  %i.z = load i64, ptr %i.v, align 8, !tbaa !12
  store i64 %i.z, ptr %i.b, align 8, !tbaa !63
  %.pn152 = load ptr, ptr %i.c, align 8, !tbaa !12 ; 2 uses
  %i.aa = getelementptr inbounds i8, ptr %.pn152, i64 -88
  br label %bb.k
...
.critedge:                                        ; preds = %zend_parse_arg_str_or_long.exit
  %.pre145 = load ptr, ptr %i.a, align 8, !tbaa !76
  br label %.critedge.thread136

.critedge.thread136:                              ; preds = %bb.i, %.critedge
  %i.ac = phi ptr [ %.pre145, %.critedge ], [ %i.y, %bb.i ] ; 3 uses
...
bb.k:                                             ; preds = %.critedge.thread136.thread, %.critedge.thread136
  %i.ai = phi ptr [ %i.aa, %.critedge.thread136.thread ], [ %i.ad, %.critedge.thread136 ]
  %.pn155 = phi ptr [ %.pn152, %.critedge.thread136.thread ], [ %.pn, %.critedge.thread136 ]
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %.pn154 = phi ptr [ %.pn155, %bb.k ], [ %.pn, %bb.j ]
  ...
  %i.am = getelementptr inbounds i8, ptr %.pn154, i64 -24 ; 4 uses
  ...
  %.not.i78142 = icmp eq ptr %i.an, null
  br i1 %.not.i78142, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %bb.l, %fast_is_identical_function.exit.thread132
  %i.ao = phi ptr [ %i.az, %fast_is_identical_function.exit.thread132 ], [ %i.an, %bb.l ]
  ...
  br i1 %.not.i81, label %bb.m, label %fast_is_identical_function.exit.thread132
...
fast_is_identical_function.exit:                  ; preds = %bb.m
  ...
  br i1 %i.av, label %fast_is_identical_function.exit.thread, label %fast_is_identical_function.exit.thread132
...
fast_is_identical_function.exit.thread132:        ; preds = %.lr.ph, %fast_is_identical_function.exit
...
._crit_edge:                                      ; preds = %fast_is_identical_function.exit.thread132, %bb.l
...
.critedge.thread:                                 ; preds = %bb.h, %instanceof_function.exit.thread
  %.pn143 = load ptr, ptr %i.c, align 8, !tbaa !12
  %i.bb = getelementptr inbounds i8, ptr %.pn143, i64 -88
  %i.bc = tail call fastcc ptr @spl_object_storage_attach(ptr noundef nonnull %i.bb, ptr noundef %i.t, ptr noundef null) ; 0 uses
  br label %bb.n

bb.n:                                             ; preds = %fast_is_identical_function.exit.thread, %._crit_edge, %.thread107, %.critedge.thread
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #9
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #9
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #9
  ret void
