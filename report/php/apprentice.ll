...
.preheader127:                                    ; preds = %bb.r, %set_last_default.exit.thread
  ...
  %.pre = load ptr, ptr %indvars.iv187.sroa.phi, align 16, !tbaa !94 ; 20 uses
...
.lr.ph.i:                                         ; preds = %bb.ap, %.loopexit223
  %indvars.iv.i = phi i64 [ 0, %.loopexit223 ], [ %indvars.iv.next.i, %bb.ap ] ; 4 uses
...
.preheader.preheader.i:                           ; preds = %bb.an
  ...
  %exitcond29.not.i260 = icmp eq i64 %indvars.iv.i, %wide.trip.count28.i
  br i1 %exitcond29.not.i260, label %set_last_default.exit.thread123, label %.lr.ph262

.preheader.i:                                     ; preds = %.lr.ph262
  %exitcond29.not.i = icmp eq i64 %indvars.iv.next26.i, %wide.trip.count28.i
  br i1 %exitcond29.not.i, label %set_last_default.exit.thread123, label %.lr.ph262, !llvm.loop !101

.lr.ph262:                                        ; preds = %.preheader.preheader.i, %.preheader.i
  %indvars.iv25.i261 = phi i64 [ %indvars.iv.next26.i, %.preheader.i ], [ %indvars.iv.i, %.preheader.preheader.i ]
  %indvars.iv.next26.i = add nuw nsw i64 %indvars.iv25.i261, 1 ; 3 uses
...
set_last_default.exit.thread123:                  ; preds = %bb.ap, %.preheader.i, %.preheader.preheader.i, %bb.ao
