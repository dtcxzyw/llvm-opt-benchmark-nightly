...
bb.a:
  ...
  %indvars.iv187.sroa.gep287 = getelementptr inbounds nuw i8, ptr %4, i64 16
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %.not, label %.thread119, label %.preheader128

.preheader128:                                    ; preds = %bb.g
  %i.s = call ptr @_php_stream_readdir(ptr noundef nonnull %i.r, ptr noundef nonnull %5) #28
  %.not92144148 = icmp eq ptr %i.s, null
  br i1 %.not92144148, label %.outer._crit_edge.thread, label %.lr.ph
...
bb.m:                                             ; preds = %bb.k
  %.not94 = icmp ult i64 %.080.ph151, %.083.ph149
  br i1 %.not94, label %.outer, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.aj = shl i64 %.083.ph149, 1
  %i.ak = or i64 %i.aj, 2                         ; 2 uses
  %i.al = shl i64 %i.ak, 3                        ; 2 uses
  %i.am = call ptr @_erealloc(ptr noundef %.081.ph150, i64 noundef %i.al) #35 ; 2 uses
...
.outer:                                           ; preds = %bb.n, %bb.m
  %.184 = phi i64 [ %.083.ph149, %bb.m ], [ %i.ak, %bb.n ]
  %.182 = phi ptr [ %.081.ph150, %bb.m ], [ %i.am, %bb.n ] ; 3 uses
  ...
  %i.at = add i64 %.080.ph151, 1                  ; 2 uses
  %i.au = getelementptr inbounds nuw [8 x i8], ptr %.182, i64 %.080.ph151
  ...
  %.not92144 = icmp eq ptr %i.av, null
  br i1 %.not92144, label %.outer._crit_edge.thread213, label %.lr.ph, !llvm.loop !89

.outer._crit_edge.thread213:                      ; preds = %.outer
  %i.aw = call i32 @_php_stream_free(ptr noundef nonnull %i.r, i32 noundef 3) #28 ; 0 uses
  br label %bb.o

.lr.ph:                                           ; preds = %.preheader128, %.outer
  %.080.ph151 = phi i64 [ %i.at, %.outer ], [ 0, %.preheader128 ] ; 4 uses
  %.081.ph150 = phi ptr [ %.182, %.outer ], [ null, %.preheader128 ] ; 4 uses
  %.083.ph149 = phi i64 [ %.184, %.outer ], [ 0, %.preheader128 ] ; 3 uses
  br label %bb.h

.outer._crit_edge:                                ; preds = %bb.l
  %i.ax = call i32 @_php_stream_free(ptr noundef nonnull %i.r, i32 noundef 3) #28 ; 0 uses
  %.not93 = icmp eq ptr %.081.ph150, null
  br i1 %.not93, label %bb.p, label %bb.o

bb.o:                                             ; preds = %.outer._crit_edge.thread213, %.outer._crit_edge
  %.080.ph.lcssa141218 = phi i64 [ %i.at, %.outer._crit_edge.thread213 ], [ %.080.ph151, %.outer._crit_edge ] ; 3 uses
  %.081.ph.lcssa143217 = phi ptr [ %.182, %.outer._crit_edge.thread213 ], [ %.081.ph150, %.outer._crit_edge ] ; 3 uses
  call void @qsort(ptr noundef nonnull %.081.ph.lcssa143217, i64 noundef %.080.ph.lcssa141218, i64 noundef 8, ptr noundef nonnull @cmpstrp) #28
  %.not166.a = icmp eq i64 %.080.ph.lcssa141218, 0
  br i1 %.not166.a, label %._crit_edge157, label %.lr.ph156

.lr.ph156:                                        ; preds = %bb.o, %.lr.ph156
  %i.ay = phi i64 [ %i.bd, %.lr.ph156 ], [ 0, %bb.o ]
  %.075154 = phi i32 [ %i.bc, %.lr.ph156 ], [ 0, %bb.o ]
  %i.az = getelementptr inbounds nuw [8 x i8], ptr %.081.ph.lcssa143217, i64 %i.ay ; 2 uses
  ...
  %i.bc = add i32 %.075154, 1                     ; 2 uses
  %i.bd = zext i32 %i.bc to i64                   ; 2 uses
  %i.be = icmp ugt i64 %.080.ph.lcssa141218, %i.bd
  br i1 %i.be, label %.lr.ph156, label %._crit_edge157, !llvm.loop !90

._crit_edge157:                                   ; preds = %.lr.ph156, %bb.o
  call void @_efree(ptr noundef nonnull %.081.ph.lcssa143217) #28
  br label %bb.p
...
bb.p:                                             ; preds = %.outer._crit_edge.thread, %.outer._crit_edge, %._crit_edge157
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #28
...
.preheader127:                                    ; preds = %bb.r, %set_last_default.exit.thread
  %i.bl = phi i1 [ true, %bb.r ], [ false, %set_last_default.exit.thread ]
  %indvars.iv187.sroa.phi = phi ptr [ %4, %bb.r ], [ %indvars.iv187.sroa.gep287, %set_last_default.exit.thread ] ; 2 uses
  %indvars.iv187 = phi i64 [ 0, %bb.r ], [ 1, %set_last_default.exit.thread ] ; 2 uses
  %i.bm = getelementptr inbounds nuw i8, ptr %indvars.iv187.sroa.phi, i64 8
  %i.bn = load i32, ptr %i.bm, align 8, !tbaa !91 ; 11 uses
  %.not167 = icmp eq i32 %i.bn, 0
  %.pre = load ptr, ptr %indvars.iv187.sroa.phi, align 16, !tbaa !94 ; 21 uses
  br i1 %.not167, label %._crit_edge160, label %.lr.ph159

.lr.ph159:                                        ; preds = %.preheader127
  %i.bo = zext i32 %i.bn to i64                   ; 3 uses
  br label %bb.s

bb.s:                                             ; preds = %.lr.ph159, %.backedge
  %.1158 = phi i32 [ 0, %.lr.ph159 ], [ %.1.be, %.backedge ] ; 2 uses
  %i.bp = zext i32 %.1158 to i64                  ; 2 uses
...
.backedge:                                        ; preds = %.backedge.loopexit, %bb.t
  ...
  br i1 %i.bv, label %bb.s, label %.loopexit223, !llvm.loop !97
...
._crit_edge.i:                                    ; preds = %.preheader, %.preheader
  ...
  %.not125 = icmp eq i32 %i.ct, 0
  br i1 %.not125, label %bb.z, label %bb.y
...
bb.al:                                            ; preds = %bb.ak, %bb.aj, %bb.ag, %bb.ae, %bb.ad, %set_test_type.exit.i
  ...
  br i1 %i.ey, label %bb.am, label %.loopexit223
...
._crit_edge160:                                   ; preds = %.preheader127
  %.not97 = icmp eq ptr %.pre, null
  br i1 %.not97, label %set_last_default.exit.thread, label %.thread222

.thread222:                                       ; preds = %._crit_edge160
...
.loopexit223:                                     ; preds = %.backedge, %bb.al
...
.lr.ph.i:                                         ; preds = %bb.ap, %.loopexit223
  %indvars.iv27.i = phi i32 [ 1, %.loopexit223 ], [ %indvars.iv.next28.i, %bb.ap ] ; 2 uses
  %indvars.iv.i = phi i64 [ 0, %.loopexit223 ], [ %indvars.iv.next.i, %bb.ap ] ; 3 uses
...
.preheader.preheader.i:                           ; preds = %bb.an
  ...
  %6 = icmp samesign ult i64 %indvars.iv.next26.i259, %wide.trip.count.i
  br i1 %6, label %.lr.ph262, label %.split.loop.exit33.i

.preheader.i:                                     ; preds = %.lr.ph262
  %indvars.iv.next26.i = add nuw nsw i64 %indvars.iv25.i261, 1 ; 2 uses
  %7 = icmp samesign ult i64 %indvars.iv.next26.i, %wide.trip.count.i
  br i1 %7, label %.lr.ph262, label %.split.loop.exit33.i, !llvm.loop !101

.lr.ph262:                                        ; preds = %.preheader.preheader.i, %.preheader.i
  %indvars.iv25.i261 = phi i64 [ %indvars.iv.next26.i, %.preheader.i ], [ %indvars.iv.next26.i259, %.preheader.preheader.i ] ; 3 uses
  %i.fl = getelementptr inbounds nuw [16 x i8], ptr %.pre, i64 %indvars.iv25.i261
...
.split.loop.exit.i:                               ; preds = %.lr.ph262
  %8 = trunc nuw i64 %indvars.iv25.i261 to i32
...
.split.loop.exit33.i:                             ; preds = %.preheader.i, %.preheader.preheader.i, %.split.loop.exit.i
  ...
  br i1 %.not.i100, label %set_last_default.exit.thread123, label %bb.ao
...
bb.ao:                                            ; preds = %.split.loop.exit33.i
  ...
  br label %set_last_default.exit.thread123

bb.ap:                                            ; preds = %bb.an, %.lr.ph.i
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  %indvars.iv.next28.i = add i32 %indvars.iv27.i, 1
  br i1 %exitcond.not.i, label %set_last_default.exit.thread123, label %.lr.ph.i, !llvm.loop !102

set_last_default.exit.thread123:                  ; preds = %bb.ap, %bb.ao, %.split.loop.exit33.i
  %min.iters.check = icmp ult i32 %i.bn, 9
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.ph

vector.ph:                                        ; preds = %set_last_default.exit.thread123
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi263 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %i.hc, %vector.body ]
  ...
  %i.hc = add <4 x i32> %i.ha, %vec.phi263        ; 2 uses
...
scalar.ph.preheader:                              ; preds = %set_last_default.exit.thread123, %middle.block
  %indvars.iv.i102.ph = phi i64 [ 0, %set_last_default.exit.thread123 ], [ %n.vec, %middle.block ]
  %.06268.i.ph = phi i32 [ 0, %set_last_default.exit.thread123 ], [ %i.he, %middle.block ]
  br label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv.i102 = phi i64 [ %indvars.iv.next.i103, %scalar.ph ], [ %indvars.iv.i102.ph, %scalar.ph.preheader ] ; 2 uses
  %.06268.i = phi i32 [ %i.hi, %scalar.ph ], [ %.06268.i.ph, %scalar.ph.preheader ]
  ...
  %i.hi = add i32 %i.hh, %.06268.i                ; 3 uses
...
bb.aq:                                            ; preds = %scalar.ph
  %i.hj = getelementptr inbounds nuw [8 x i8], ptr %i.bj, i64 %indvars.iv187 ; 2 uses
  %i.hk = getelementptr inbounds nuw [4 x i8], ptr %i.bk, i64 %indvars.iv187 ; 2 uses
...
.preheader.i105.epil.preheader:                   ; preds = %.unr-lcssa, %.preheader.i105.preheader
  ...
  %lcmp.mod286 = trunc i32 %i.bn to i1
...
bb.at:                                            ; preds = %.unr-lcssa, %.preheader.i105.epil.preheader
  %.lcssa272 = phi i32 [ %i.il, %.unr-lcssa ], [ %i.iv, %.preheader.i105.epil.preheader ]
  store i32 %.lcssa272, ptr %i.hk, align 4, !tbaa !35
  br label %set_last_default.exit.thread
...
set_last_default.exit.thread:                     ; preds = %._crit_edge160, %.thread222, %bb.at, %bb.ar
  br i1 %i.bl, label %.preheader127, label %.loopexit, !llvm.loop !109
...
.lr.ph.i111:                                      ; preds = %.lr.ph.i111, %.lr.ph.preheader.i109
  ...
  %i.ja = getelementptr inbounds nuw [16 x i8], ptr %i.iw, i64 %indvars.iv.i112
