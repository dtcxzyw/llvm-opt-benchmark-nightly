...
bb.dp:                                            ; preds = %bb.do
  store ptr %spec.store.select, ptr %i.hp, align 8, !tbaa !102
  br label %.thread730
...
bb.dr:                                            ; preds = %bb.dq
  %i.qh = load i32, ptr %i.dr, align 4, !tbaa !44 ; 2 uses
  %.not685 = icmp eq i32 %i.qh, 0
  %i.qi = load ptr, ptr %i.dd, align 8, !tbaa !36 ; 3 uses
...
bb.du:                                            ; preds = %bb.dr
  %i.ql = load i32, ptr %i.hr, align 8, !tbaa !45 ; 2 uses
...
bb.dv:                                            ; preds = %bb.du
  %i.qp = load i8, ptr %.11, align 1, !tbaa !46
  %i.qq = load i8, ptr %i.hs, align 8, !tbaa !46
...
bb.dx:                                            ; preds = %bb.dw
  ...
  %i.qu = load i8, ptr %i.qt, align 1, !tbaa !46
  %i.qv = load i8, ptr %i.ht, align 1, !tbaa !46
...
.lr.ph805:                                        ; preds = %.lr.ph805.preheader, %bb.dz
  ...
  %i.ra = load i8, ptr %.12804, align 1, !tbaa !46
...
bb.dz:                                            ; preds = %.lr.ph805
  ...
  br i1 %exitcond.not, label %.critedge37, label %.lr.ph805, !llvm.loop !64
...
bb.q:                                             ; preds = %switch.edge
  ...
  %i.em = load i8, ptr %i.el, align 1, !tbaa !46
...
.lr.ph4599:                                       ; preds = %.peel.next.preheader, %.peel.next
  ...
  %i.fd = load i8, ptr %i.fc, align 1, !tbaa !46
  %i.fe = icmp eq i8 %i.fd, 120
  br i1 %i.fe, label %.peel.next, label %.thread3582, !llvm.loop !117
...
bb.r:                                             ; preds = %bb.aez, %.thread3582
  ...
  %i.gj = load ptr, ptr %i.ff, align 8, !tbaa !52
  %i.gk = icmp ugt ptr %.02992, %i.gj
  br i1 %i.gk, label %bb.s, label %bb.t

bb.s:                                             ; preds = %bb.r
  store ptr %.02992, ptr %i.ff, align 8, !tbaa !52
  br label %bb.t

bb.t:                                             ; preds = %bb.s, %bb.r
  %i.gl = load i32, ptr %6, align 4, !tbaa !22
  %i.gm = xor i32 %i.gl, 1
  store i32 %i.gm, ptr %6, align 4, !tbaa !22
  store i32 %.52860, ptr %i.fg, align 4, !tbaa !22
...
bb.u:                                             ; preds = %bb.t
  %i.gq = load i8, ptr %.02992, align 1, !tbaa !46 ; 2 uses
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.hj = load i8, ptr %i.hi, align 1, !tbaa !46
  %i.hk = and i8 %i.hj, 63
...
bb.aa:                                            ; preds = %bb.z
  ...
  %i.hu = load i8, ptr %i.ht, align 1, !tbaa !46
  %i.hv = and i8 %i.hu, 63
  ...
  %i.ia = load i8, ptr %i.hz, align 1, !tbaa !46
  %i.ib = and i8 %i.ia, 63
...
bb.ad:                                            ; preds = %bb.ab
  ...
  %i.jm = load i8, ptr %i.jl, align 1, !tbaa !46
  %i.jn = and i8 %i.jm, 63
...
bb.af:                                            ; preds = %.lr.ph4249, %.thread3602
  ...
  %i.kl = load i32, ptr %i.kk, align 4, !tbaa !141 ; 4 uses
...
bb.bj:                                            ; preds = %bb.bi
  ...
  store i32 %i.pc, ptr %.030764234, align 4, !tbaa !141
  %i.pd = getelementptr inbounds nuw i8, ptr %.030764234, i64 4
  store i32 0, ptr %i.pd, align 4, !tbaa !142
...
bb.bn:                                            ; preds = %bb.bm
  %i.pt = load i32, ptr %i.fv, align 4, !tbaa !39 ; 2 uses
  %i.pu = and i32 %i.pt, 4
...
bb.bp:                                            ; preds = %bb.bo
  %i.py = load i64, ptr %i.gd, align 8, !tbaa !37
...
.thread3596.thread:                               ; preds = %.thread3592, %11, %.thread3596
  ...
  store i64 %i.gh, ptr %4, align 8, !tbaa !54
  %i.qi = ptrtoint ptr %.129934237 to i64
  %i.qj = sub i64 %i.qi, %i.fo
  store i64 %i.qj, ptr %i.gi, align 8, !tbaa !54
...
.thread3596.thread4440:                           ; preds = %.thread3584.thread, %.thread3596.thread, %.thread3596
  ...
  %i.qk = load i32, ptr %i.fv, align 4, !tbaa !39
...
.preheader:                                       ; preds = %bb.bg, %.preheader
  ...
  %i.qv = load i8, ptr %i.qu, align 1, !tbaa !46
  %i.qw = icmp eq i8 %i.qv, 120
  br i1 %i.qw, label %.preheader, label %bb.bt, !llvm.loop !119
...
bb.bu:                                            ; preds = %bb.bt
  ...
  store i32 %i.rb, ptr %.030764234, align 4, !tbaa !141
  %i.rc = getelementptr inbounds nuw i8, ptr %.030764234, i64 4
  store i32 0, ptr %i.rc, align 4, !tbaa !142
...
bb.bw:                                            ; preds = %.lr.ph4617
  ...
  br i1 %exitcond4310.not, label %.critedge3469, label %.lr.ph4617, !llvm.loop !120
...
.lr.ph4617:                                       ; preds = %bb.bv, %bb.bw
  ...
  %i.ru = load i8, ptr %i.rt, align 1, !tbaa !46
  %i.rv = icmp eq i8 %i.ru, 120
  br i1 %i.rv, label %bb.bw, label %.thread3602, !llvm.loop !120
...
bb.by:                                            ; preds = %bb.bx
  ...
  store i32 %i.rx, ptr %.030764234, align 4, !tbaa !141
  %i.ry = getelementptr inbounds nuw i8, ptr %.030764234, i64 4
  store i32 0, ptr %i.ry, align 4, !tbaa !142
  %i.rz = getelementptr inbounds nuw i8, ptr %i.lj, i64 1
  %i.sa = load i8, ptr %i.rz, align 1, !tbaa !46
...
.lr.ph4230:                                       ; preds = %.lr.ph4611
  ...
  br i1 %exitcond4308.not, label %.critedge3469, label %.lr.ph4611, !llvm.loop !121
...
.lr.ph4611:                                       ; preds = %.lr.ph4230.preheader, %.lr.ph4230
  ...
  %i.sy = load i8, ptr %i.sx, align 1, !tbaa !46
  %i.sz = icmp eq i8 %i.sy, 120
  br i1 %i.sz, label %.lr.ph4230, label %.thread3602, !llvm.loop !121
...
bb.ca:                                            ; preds = %bb.bz
  ...
  %i.to = load i8, ptr %i.tn, align 1, !tbaa !46
...
.lr.ph4220:                                       ; preds = %bb.ca, %.lr.ph4220
  ...
  %i.tz = load i8, ptr %i.ty, align 1, !tbaa !46
  %i.ua = icmp eq i8 %i.tz, 120
  br i1 %i.ua, label %.lr.ph4220, label %._crit_edge4221, !llvm.loop !122
...
bb.cb:                                            ; preds = %._crit_edge4221
  ...
  %i.ug = add i32 %i.uf, 3
  store i32 %i.ug, ptr %i.td, align 4, !tbaa !141
  %i.uh = getelementptr inbounds nuw i8, ptr %.030764234, i64 16
  store i32 0, ptr %i.uh, align 4, !tbaa !142
...
bb.cc:                                            ; preds = %bb.bg
  ...
  %i.ut = load i8, ptr %i.us, align 1, !tbaa !46
