...
bb.g:                                             ; preds = %bb.f
  ...
  %i.ob = load i64, ptr %i.oa, align 8, !tbaa !51 ; 23 uses
...
bb.s:                                             ; preds = %bb.r
  ...
  %.0.copyload.i7.i.i = load i64, ptr %i.rm, align 16, !noalias !270
  %2 = getelementptr inbounds nuw i8, ptr %1, i64 312
  %.0.copyload.i8.i.i = load i64, ptr %2, align 8, !noalias !270
  %3 = add i64 %i.ob, 4554437623014685352
  %4 = xor i64 %.0.copyload.i7.i.i, %3
  %5 = sub i64 2111919702937427193, %i.ob
  %6 = xor i64 %.0.copyload.i8.i.i, %5
  %7 = zext i64 %4 to i128
  %8 = zext i64 %6 to i128
  %9 = mul nuw i128 %8, %7                        ; 2 uses
  %10 = lshr i128 %9, 64
  %11 = xor i128 %10, %9
  %12 = trunc i128 %11 to i64
  %13 = add i64 %i.ri, %12
  %14 = getelementptr inbounds nuw i8, ptr %i.nz, i64 %i.h ; 2 uses
  %15 = getelementptr inbounds i8, ptr %14, i64 -64
  %.0.copyload.i9.i19.i = load i64, ptr %15, align 1, !noalias !273
  %16 = getelementptr inbounds i8, ptr %14, i64 -56
  %.0.copyload.i10.i.i = load i64, ptr %16, align 1, !noalias !273
  %i.rn = add i64 %i.ob, 3556072174620004746
  %17 = xor i64 %.0.copyload.i9.i19.i, %i.rn
  %18 = sub i64 7238261902898274248, %i.ob
  %19 = xor i64 %.0.copyload.i10.i.i, %18
  %20 = zext i64 %17 to i128
  %21 = zext i64 %19 to i128
  %22 = mul nuw i128 %21, %20                     ; 2 uses
  %23 = lshr i128 %22, 64
  %24 = xor i128 %23, %22
...
bb.t:                                             ; preds = %bb.s, %bb.r
  ...
  %.0.copyload.i11.i.i = load i64, ptr %i.rp, align 16, !noalias !276
  %26 = getelementptr inbounds nuw i8, ptr %1, i64 296
  %.0.copyload.i12.i.i = load i64, ptr %26, align 8, !noalias !276
  %27 = add i64 %i.ob, -3818837453329782724
  %28 = xor i64 %.0.copyload.i11.i.i, %27
  %29 = sub i64 -6688317018830679928, %i.ob
  %30 = xor i64 %.0.copyload.i12.i.i, %29
  %31 = zext i64 %28 to i128
  %32 = zext i64 %30 to i128
  %33 = mul nuw i128 %32, %31                     ; 2 uses
  %34 = lshr i128 %33, 64
  %35 = xor i128 %34, %33
  %36 = trunc i128 %35 to i64
  %37 = add i64 %.0.i3.i.i, %36
  %38 = getelementptr inbounds nuw i8, ptr %i.nz, i64 %i.h ; 2 uses
  %39 = getelementptr inbounds i8, ptr %38, i64 -48
  %.0.copyload.i13.i.i = load i64, ptr %39, align 1, !noalias !279
  %40 = getelementptr inbounds i8, ptr %38, i64 -40
  %.0.copyload.i14.i.i = load i64, ptr %40, align 1, !noalias !279
  %i.rq = add i64 %i.ob, 5690594596133299313
  %41 = xor i64 %.0.copyload.i13.i.i, %i.rq
  %42 = sub i64 -2833645246901970632, %i.ob
  %43 = xor i64 %.0.copyload.i14.i.i, %42
  %44 = zext i64 %41 to i128
  %45 = zext i64 %43 to i128
  %46 = mul nuw i128 %45, %44                     ; 2 uses
  %47 = lshr i128 %46, 64
  %48 = xor i128 %47, %46
...
bb.u:                                             ; preds = %bb.t, %bb.q
  ...
  %.0.copyload.i15.i.i = load i64, ptr %i.rs, align 16, !noalias !282
  %50 = getelementptr inbounds nuw i8, ptr %1, i64 280
  %.0.copyload.i16.i.i = load i64, ptr %50, align 8, !noalias !282
  %51 = add i64 %i.ob, 8711581037947681227
  %52 = xor i64 %.0.copyload.i15.i.i, %51
  %53 = sub i64 2410270004345854594, %i.ob
  %54 = xor i64 %.0.copyload.i16.i.i, %53
  %55 = zext i64 %52 to i128
  %56 = zext i64 %54 to i128
  %57 = mul nuw i128 %56, %55                     ; 2 uses
  %58 = lshr i128 %57, 64
  %59 = xor i128 %58, %57
  %60 = trunc i128 %59 to i64
  %61 = add i64 %.1.i.i.i, %60
  %62 = getelementptr inbounds nuw i8, ptr %i.nz, i64 %i.h ; 2 uses
  %63 = getelementptr inbounds i8, ptr %62, i64 -32
  %.0.copyload.i17.i.i = load i64, ptr %63, align 1, !noalias !285
  %64 = getelementptr inbounds i8, ptr %62, i64 -24
  %.0.copyload.i18.i.i = load i64, ptr %64, align 1, !noalias !285
  %i.rt = add i64 %i.ob, -8204357891075471176
  %65 = xor i64 %.0.copyload.i17.i.i, %i.rt
  %66 = sub i64 5487137525590930912, %i.ob
  %67 = xor i64 %.0.copyload.i18.i.i, %66
  %68 = zext i64 %65 to i128
  %69 = zext i64 %67 to i128
  %70 = mul nuw i128 %69, %68                     ; 2 uses
  %71 = lshr i128 %70, 64
  %72 = xor i128 %71, %70
...
XXH3_len_17to128_64b.exit.i.i:                    ; preds = %bb.u, %bb.p
  ...
  %.0.copyload.i19.i.i = load i64, ptr %i.nz, align 16, !noalias !288
  %74 = getelementptr inbounds nuw i8, ptr %1, i64 264
  %.0.copyload.i20.i.i = load i64, ptr %74, align 8, !noalias !288
  %75 = add i64 %i.ob, -4734510112055689544
  %76 = xor i64 %.0.copyload.i19.i.i, %75
  %77 = sub i64 2066345149520216444, %i.ob
  %78 = xor i64 %.0.copyload.i20.i.i, %77
  %79 = zext i64 %76 to i128
  %80 = zext i64 %78 to i128
  %81 = mul nuw i128 %80, %79                     ; 2 uses
  %82 = lshr i128 %81, 64
  %83 = xor i128 %82, %81
  %84 = trunc i128 %83 to i64
  %85 = add i64 %.2.i.i.i, %84
  %86 = getelementptr inbounds nuw i8, ptr %i.nz, i64 %i.h ; 2 uses
  %87 = getelementptr inbounds i8, ptr %86, i64 -16
  %.0.copyload.i21.i.i = load i64, ptr %87, align 1, !noalias !291
  %88 = getelementptr inbounds i8, ptr %86, i64 -8
  %.0.copyload.i22.i.i = load i64, ptr %88, align 1, !noalias !291
  %i.rv = add i64 %i.ob, -2623469361688619810
  %89 = xor i64 %.0.copyload.i21.i.i, %i.rv
  %90 = sub i64 2262974939099578482, %i.ob
  %91 = xor i64 %.0.copyload.i22.i.i, %90
  %92 = zext i64 %89 to i128
  %93 = zext i64 %91 to i128
  %94 = mul nuw i128 %93, %92                     ; 2 uses
  %95 = lshr i128 %94, 64
  %96 = xor i128 %95, %94
  %97 = trunc i128 %96 to i64
  %i.rw = add i64 %85, %97                        ; 2 uses
