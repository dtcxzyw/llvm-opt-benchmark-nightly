...
accel_sapi_is_cli.exit.thread:                    ; preds = %bb.k, %accel_sapi_is_cli.exit
  store i8 0, ptr @accel_startup_ok, align 1, !tbaa !64
  store ptr @.str.46, ptr @zps_api_failure_reason, align 8, !tbaa !53
...
bb.l:                                             ; preds = %accel_sapi_is_cli.exit, %bb.j
  %i.aj = load i8, ptr getelementptr inbounds nuw (i8, ptr @accel_globals, i64 1), align 1, !tbaa !226, !range !49, !noundef !50
  %i.ak = icmp eq i8 %i.aj, 0
  br i1 %i.ak, label %bb.n, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.al = load ptr, ptr @zend_post_startup_cb, align 8, !tbaa !51
  store ptr %i.al, ptr @orig_post_startup_cb, align 8, !tbaa !51
  store ptr @accel_post_startup, ptr @zend_post_startup_cb, align 8, !tbaa !51
...
bb.a:
  %i.a = load ptr, ptr getelementptr inbounds nuw (i8, ptr @accel_globals, i64 368), align 8, !tbaa !239 ; 2 uses
  %.not = icmp eq ptr %i.a, null
  br i1 %.not, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.b = load i64, ptr getelementptr inbounds nuw (i8, ptr @accel_globals, i64 376), align 8, !tbaa !268
...
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !358
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr null, ptr %i.c, align 8, !tbaa !359
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 80
  store ptr null, ptr %i.e, align 8, !tbaa !360
...
bb.a:
  ...
  %i.b = load ptr, ptr @orig_post_startup_cb, align 8, !tbaa !51 ; 2 uses
  %.not44 = icmp eq ptr %i.b, null
  br i1 %.not44, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.a
  store ptr null, ptr @orig_post_startup_cb, align 8, !tbaa !51
  %i.c = tail call i32 %i.b() #28
  %.not45 = icmp eq i32 %i.c, 0
  br i1 %.not45, label %bb.c, label %bb.cg

bb.c:                                             ; preds = %bb.b, %bb.a
  %i.d = load i8, ptr getelementptr inbounds nuw (i8, ptr @accel_globals, i64 161), align 1, !tbaa !361, !range !49, !noundef !50 ; 2 uses
  %i.e = trunc nuw i8 %i.d to i1
  store i8 %i.d, ptr @file_cache_only, align 1, !tbaa !64
  br i1 %i.e, label %bb.aa, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.f = load i64, ptr getelementptr inbounds nuw (i8, ptr @accel_globals, i64 8), align 8, !tbaa !38 ; 3 uses
  %i.g = load i8, ptr @jit_globals, align 8, !tbaa !362, !range !49, !noundef !50
...
bb.h:                                             ; preds = %bb.f
  %i.o = add i64 %i.m, -1
  %i.p = load i64, ptr getelementptr inbounds nuw (i8, ptr @jit_globals, i64 16), align 8, !tbaa !363
  %i.q = add i64 %i.o, %i.p
  %i.r = sub i64 0, %i.m
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.v = load i64, ptr getelementptr inbounds nuw (i8, ptr @accel_globals, i64 128), align 8, !tbaa !230 ; 2 uses
  ...
  store ptr %i.y, ptr @accel_shared_globals, align 8, !tbaa !41
...
bb.l:                                             ; preds = %bb.j
  ...
  %i.z = load ptr, ptr @smm_shared_globals, align 8, !tbaa !20
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 56
  store ptr %i.y, ptr %i.aa, align 8, !tbaa !364
  %i.ab = getelementptr inbounds nuw i8, ptr %i.y, i64 48
  %i.ac = load i64, ptr getelementptr inbounds nuw (i8, ptr @accel_globals, i64 16), align 8, !tbaa !365
  %i.ad = trunc i64 %i.ac to i32
  tail call void @zend_accel_hash_init(ptr noundef nonnull %i.ab, i32 noundef %i.ad) #28
  %i.ae = load i64, ptr getelementptr inbounds nuw (i8, ptr @accel_globals, i64 128), align 8, !tbaa !230 ; 3 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.aq = shl i32 %i.ap, 2
  %i.ar = load ptr, ptr @accel_shared_globals, align 8, !tbaa !41 ; 8 uses
  %i.as = getelementptr inbounds nuw i8, ptr %i.ar, i64 176
  store i32 %i.aq, ptr %i.as, align 8, !tbaa !70
  %i.at = getelementptr inbounds nuw i8, ptr %i.ar, i64 180
  store i32 0, ptr %i.at, align 4, !tbaa !75
  %i.au = add i32 %i.ap, 1
  ...
  store ptr %i.ay, ptr %i.az, align 8, !tbaa !66
  ...
  store ptr %i.bd, ptr %i.be, align 8, !tbaa !74
  ...
  store ptr null, ptr %i.bg, align 8, !tbaa !236
...
bb.n:                                             ; preds = %bb.l
  %i.bh = load ptr, ptr @accel_shared_globals, align 8, !tbaa !41
  %i.bi = getelementptr inbounds nuw i8, ptr %i.bh, i64 216
  store i32 0, ptr %i.bi, align 1, !tbaa !71
  br label %zend_accel_init_shm.exit
...
zend_accel_init_shm.exit:                         ; preds = %bb.m, %bb.n
  ...
  %i.bj = load ptr, ptr @smm_shared_globals, align 8, !tbaa !20 ; 2 uses
  %i.bk = getelementptr inbounds nuw i8, ptr %i.bj, i64 32
  store i8 0, ptr %i.bk, align 8, !tbaa !152
  %i.bl = load ptr, ptr @accel_shared_globals, align 8, !tbaa !41 ; 7 uses
  ...
  store i64 0, ptr %i.bm, align 8, !tbaa !28
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bl, i64 121
  store i8 0, ptr %i.bn, align 1, !tbaa !48
  %i.bo = getelementptr inbounds nuw i8, ptr %i.bl, i64 112
  store i64 0, ptr %i.bo, align 8, !tbaa !62
  %i.bp = load i64, ptr getelementptr inbounds nuw (i8, ptr @compiler_globals, i64 528), align 8, !tbaa !227
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bl, i64 80
  store i64 %i.bp, ptr %i.bq, align 8, !tbaa !228
  %i.br = load i64, ptr @zend_map_ptr_static_last, align 8, !tbaa !84
  %i.bs = getelementptr inbounds nuw i8, ptr %i.bl, i64 88
  store i64 %i.br, ptr %i.bs, align 8, !tbaa !229
  ...
  store i8 1, ptr %i.bu, align 8, !tbaa !59
  %i.bv = tail call i64 @time(ptr noundef null) #28
  %i.bw = load ptr, ptr @accel_shared_globals, align 8, !tbaa !41 ; 4 uses
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bw, i64 96
  store i64 %i.bv, ptr %i.bx, align 8, !tbaa !366
  %i.by = getelementptr inbounds nuw i8, ptr %i.bw, i64 104
  store i64 0, ptr %i.by, align 8, !tbaa !232
  %i.bz = getelementptr inbounds nuw i8, ptr %i.bw, i64 129
  store i8 0, ptr %i.bz, align 1, !tbaa !160
...
bb.p:                                             ; preds = %bb.i
  tail call void @zend_shared_alloc_lock() #28
  %i.cb = load ptr, ptr @smm_shared_globals, align 8, !tbaa !20
  %i.cc = getelementptr inbounds nuw i8, ptr %i.cb, i64 56
  %i.cd = load ptr, ptr %i.cc, align 8, !tbaa !364
  store ptr %i.cd, ptr @accel_shared_globals, align 8, !tbaa !41
  tail call void @zend_interned_strings_set_request_storage_handlers(ptr noundef nonnull @accel_new_interned_string_for_php, ptr noundef nonnull @accel_init_interned_string_for_php, ptr noundef nonnull @accel_init_interned_string_for_php) #28
  br label %.sink.split
...
bb.r:                                             ; preds = %.sink.split, %bb.i
  ...
  %i.ce = load ptr, ptr @accel_shared_globals, align 8, !tbaa !41
  %i.cf = getelementptr inbounds nuw i8, ptr %i.ce, i64 104
  %i.cg = load i64, ptr %i.cf, align 8, !tbaa !232
  store i64 %i.cg, ptr getelementptr inbounds nuw (i8, ptr @accel_globals, i64 296), align 8, !tbaa !233
  tail call void @zend_shared_alloc_lock() #28
  %i.ch = load i8, ptr @jit_globals, align 8, !tbaa !362, !range !49, !noundef !50
  %i.ci = trunc nuw i8 %i.ch to i1
  br i1 %i.ci, label %bb.s, label %bb.x

bb.s:                                             ; preds = %bb.r
  %i.cj = load i64, ptr getelementptr inbounds nuw (i8, ptr @jit_globals, i64 16), align 8, !tbaa !363
  %i.ck = icmp eq i64 %i.cj, 0
  br i1 %i.ck, label %bb.t, label %bb.u

bb.t:                                             ; preds = %bb.s
  store i8 0, ptr @jit_globals, align 8, !tbaa !362
  store i8 0, ptr getelementptr inbounds nuw (i8, ptr @jit_globals, i64 1), align 1, !tbaa !273
  br label %bb.x

bb.u:                                             ; preds = %bb.s
  %i.cl = load ptr, ptr @smm_shared_globals, align 8, !tbaa !20
...
bb.w:                                             ; preds = %bb.u
  ...
  store i8 1, ptr @zend_jit_startup_ok, align 1, !tbaa !64
  br label %bb.x

bb.x:                                             ; preds = %bb.t, %bb.w, %bb.r
  tail call void @zend_shared_alloc_save_state() #28
  tail call void @zend_shared_alloc_unlock() #28
  %i.co = load i8, ptr getelementptr inbounds nuw (i8, ptr @accel_globals, i64 54), align 2, !tbaa !57, !range !49, !noundef !50
...
bb.z:                                             ; preds = %bb.i
  ...
  store i8 0, ptr @accel_startup_ok, align 1, !tbaa !64
  store ptr @.str.63, ptr @zps_api_failure_reason, align 8, !tbaa !53
  tail call void @zend_llist_del_element(ptr noundef nonnull @zend_extensions, ptr noundef null, ptr noundef nonnull @accelerator_remove_cb) #28
  br label %bb.cg

bb.aa:                                            ; preds = %bb.c
  %i.cq = load ptr, ptr getelementptr inbounds nuw (i8, ptr @accel_globals, i64 152), align 8, !tbaa !149
...
bb.ac:                                            ; preds = %bb.aa
  ...
  store ptr %i.cr, ptr @accel_shared_globals, align 8, !tbaa !41
  br label %.thread

.thread:                                          ; preds = %bb.x, %bb.y, %bb.ac
  %i.cs = load i8, ptr getelementptr inbounds nuw (i8, ptr @accel_globals, i64 160), align 8, !tbaa !368, !range !49, !noundef !50
...
bb.ad:                                            ; preds = %.thread
  ...
  %i.cu = load ptr, ptr getelementptr inbounds nuw (i8, ptr @accel_globals, i64 152), align 8, !tbaa !149
...
bb.af:                                            ; preds = %.thread
  %.pr = load ptr, ptr getelementptr inbounds nuw (i8, ptr @accel_globals, i64 152), align 8, !tbaa !149
...
.thread67:                                        ; preds = %bb.ad, %bb.af
  ...
  %i.cv = load ptr, ptr getelementptr inbounds nuw (i8, ptr @accel_globals, i64 152), align 8, !tbaa !149 ; 2 uses
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.da = load i32, ptr %i.cz, align 8, !tbaa !369
  %i.db = and i32 %i.da, 61440
  %i.dc = icmp eq i32 %i.db, 16384
  br i1 %i.dc, label %bb.ai, label %bb.aj

bb.ai:                                            ; preds = %bb.ah
  %i.dd = load ptr, ptr getelementptr inbounds nuw (i8, ptr @accel_globals, i64 152), align 8, !tbaa !149
