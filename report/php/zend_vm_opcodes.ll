...
@.str.208 = private unnamed_addr constant [30 x i8] c"ZEND_DECLARE_ATTRIBUTED_CONST\00", align 1

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local ptr @zend_get_opcode_name(i8 noundef zeroext %0) local_unnamed_addr #0 {
bb.a:
  %i.a = icmp ugt i8 %0, -46
  br i1 %i.a, label %bb.c, label %bb.b, !prof !12

bb.b:                                             ; preds = %bb.a
  %i.b = zext i8 %0 to i64
  %i.c = getelementptr inbounds nuw [8 x i8], ptr @zend_vm_opcodes_names, i64 %i.b
...
bb.c:                                             ; preds = %bb.b, %bb.a
  %.0 = phi i8 [ 0, %bb.b ], [ %0, %bb.a ]
  %i.b = zext i8 %.0 to i64
  %i.c = getelementptr inbounds nuw [4 x i8], ptr @zend_vm_opcodes_flags, i64 %i.b
  %i.d = load i32, ptr %i.c, align 4, !tbaa !16
  ret i32 %i.d
}

; Function Attrs: nofree norecurse nosync nounwind memory(read, inaccessiblemem: none, target_mem: none) uwtable
define dso_local zeroext range(i8 0, -44) i8 @zend_get_opcode_id(ptr nofree noundef readonly captures(none) %0, i64 noundef %1) local_unnamed_addr #1 {
bb.a:
  br label %bb.b
...
bb.c:                                             ; preds = %bb.b
  %i.b = getelementptr inbounds nuw [8 x i8], ptr @zend_vm_opcodes_names, i64 %indvars.iv
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !13
  %i.d = tail call i32 @strncmp(ptr noundef %i.c, ptr noundef %0, i64 noundef %1) #3
