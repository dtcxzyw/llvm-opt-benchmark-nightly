...
bb.m:                                             ; preds = %bb.l
  %i.as = call i32 (ptr, ptr, ...) @file_printf(ptr noundef nonnull %0, ptr noundef nonnull @.str.7) #6
  %i.at = icmp eq i32 %i.as, -1
  br i1 %i.at, label %bb.ah, label %.thread44

bb.n:                                             ; preds = %bb.l
  %i.au = and i32 %i.ap, 16
  %.not36 = icmp eq i32 %i.au, 0
  br i1 %.not36, label %.thread44, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.av = call i32 (ptr, ptr, ...) @file_printf(ptr noundef nonnull %0, ptr noundef nonnull @.str.8) #6
  %i.aw = icmp eq i32 %i.av, -1
  br i1 %i.aw, label %bb.ah, label %.thread44

bb.p:                                             ; preds = %bb.k, %bb.j
  %i.ax = call i32 @cdf_zero_stream(ptr noundef nonnull %7) #6 ; 0 uses
  br label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.i
  %i.ay = call i32 @cdf_read_summary_info(ptr noundef nonnull %2, ptr noundef nonnull %3, ptr noundef nonnull %4, ptr noundef nonnull %5, ptr noundef nonnull %6, ptr noundef nonnull %8, ptr noundef nonnull %7) #6
...
bb.r:                                             ; preds = %bb.q
  ...
  %.not34 = icmp eq i32 %i.bb, 3
  br i1 %.not34, label %.thread, label %bb.s

bb.s:                                             ; preds = %bb.r
  store ptr @.str.9, ptr %i.a, align 8, !tbaa !15
  br label %.thread

bb.t:                                             ; preds = %bb.q
  %i.bc = load ptr, ptr %i.b, align 8, !tbaa !23
  %i.bd = call fastcc i32 @cdf_check_summary_info(ptr noundef nonnull %0, ptr noundef %2, ptr noundef %3, ptr noundef %4, ptr noundef %5, ptr noundef %6, ptr noundef %8, ptr noundef %7, ptr noundef %i.bc, ptr noundef %i.a)
  %i.be = call i32 @cdf_zero_stream(ptr noundef nonnull %7) #6 ; 0 uses
  %i.bf = icmp slt i32 %i.bd, 1
  br i1 %i.bf, label %.thread, label %.thread44

.thread:                                          ; preds = %bb.r, %bb.s, %bb.t
  %i.bg = call i32 @cdf_read_doc_summary_info(ptr noundef nonnull %2, ptr noundef nonnull %3, ptr noundef nonnull %4, ptr noundef nonnull %5, ptr noundef nonnull %6, ptr noundef nonnull %8, ptr noundef nonnull %7) #6
  %i.bh = icmp eq i32 %i.bg, -1
  br i1 %i.bh, label %bb.u, label %bb.w

bb.u:                                             ; preds = %.thread
  %i.bi = tail call ptr @__errno_location() #7
  %i.bj = load i32, ptr %i.bi, align 4, !tbaa !45
  %.not35 = icmp eq i32 %i.bj, 3
  br i1 %.not35, label %.thread42, label %bb.v
...
bb.w:                                             ; preds = %.thread
  ...
  %i.bl = call fastcc i32 @cdf_check_summary_info(ptr noundef nonnull %0, ptr noundef %2, ptr noundef %3, ptr noundef %4, ptr noundef %5, ptr noundef %6, ptr noundef %8, ptr noundef %7, ptr noundef %i.bk, ptr noundef %i.a)
  %i.bm = icmp slt i32 %i.bl, 1
  br i1 %i.bm, label %.thread42, label %.thread44

.thread42:                                        ; preds = %bb.u, %bb.v, %bb.w
  %i.bn = call fastcc i32 @cdf_file_dir_info(ptr noundef nonnull %0, ptr noundef %8) ; 2 uses
  %i.bo = icmp slt i32 %i.bn, 0
  br i1 %i.bo, label %bb.x, label %.thread44

bb.x:                                             ; preds = %.thread42
  store ptr @.str.10, ptr %i.a, align 8, !tbaa !15
  br label %.thread44

.thread44:                                        ; preds = %bb.t, %bb.m, %bb.o, %bb.n, %bb.w, %bb.x, %.thread42
  %.2 = phi i32 [ 1, %bb.w ], [ -1, %bb.x ], [ %i.bn, %.thread42 ], [ 1, %bb.n ], [ 1, %bb.o ], [ 1, %bb.m ], [ 1, %bb.t ]
  %i.bp = call i32 @cdf_zero_stream(ptr noundef nonnull %7) #6 ; 0 uses
  %i.bq = call i32 @cdf_zero_stream(ptr noundef nonnull %6) #6 ; 0 uses
  br label %bb.y

bb.y:                                             ; preds = %.thread44, %bb.h
  %.3 = phi i32 [ -1, %bb.h ], [ %.2, %.thread44 ]
  %i.br = load ptr, ptr %8, align 8, !tbaa !25
  call void @_efree(ptr noundef %i.br) #6
  br label %bb.z

bb.z:                                             ; preds = %bb.f, %bb.y
  %.4 = phi i32 [ -1, %bb.f ], [ %.3, %bb.y ]     ; 2 uses
  %i.bs = load ptr, ptr %5, align 8, !tbaa !42
  call void @_efree(ptr noundef %i.bs) #6
  %i.bt = load ptr, ptr %4, align 8, !tbaa !42
  call void @_efree(ptr noundef %i.bt) #6
  %.not37 = icmp eq i32 %.4, -1
  br i1 %.not37, label %bb.aa, label %bb.ah

bb.aa:                                            ; preds = %.thread49, %.thread46, %bb.z
  %i.bu = load i32, ptr %i.j, align 4, !tbaa !22  ; 2 uses
...
bb.ac:                                            ; preds = %bb.ab
  %i.bz = load ptr, ptr %i.a, align 8, !tbaa !15  ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  %i.q = load i16, ptr %11, align 4, !tbaa !53
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.w = load i16, ptr %i.v, align 2, !tbaa !54   ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.y = load i16, ptr %i.x, align 4, !tbaa !55
...
bb.h:                                             ; preds = %bb.e
  ...
  %i.an = load i16, ptr %i.am, align 4, !tbaa !55
...
cdf_clsid_to_mime.exit.thread.i:                  ; preds = %cdf_clsid_to_mime.exit.i, %bb.k, %bb.j, %bb.i, %bb.b
  %i.bb = load ptr, ptr %i.f, align 8, !tbaa !23
  %i.bc = load i64, ptr %i.g, align 8, !tbaa !56  ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %10) #6
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #6
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %10, i8 0, i64 16, i1 false)
  %i.bd = load i32, ptr %i.k, align 4, !tbaa !22  ; 2 uses
...
bb.n:                                             ; preds = %bb.m, %bb.l
  br label %cdf_clsid_to_mime.exit.i.i, !llvm.loop !46
...
.lr.ph131.i.i:                                    ; preds = %cdf_clsid_to_mime.exit.i.i, %bb.ar
  ...
  %i.bo = load i32, ptr %i.bn, align 8, !tbaa !58
...
bb.o:                                             ; preds = %.lr.ph131.i.i
  %i.bs = load i32, ptr %i.k, align 4, !tbaa !22
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.bw = load i16, ptr %i.bv, align 8, !tbaa !26
...
bb.q:                                             ; preds = %.lr.ph131.i.i
  %i.ca = load i32, ptr %i.k, align 4, !tbaa !22
...
bb.s:                                             ; preds = %.lr.ph131.i.i
  %i.ch = load i32, ptr %i.k, align 4, !tbaa !22
...
bb.u:                                             ; preds = %.lr.ph131.i.i
  %i.co = load i32, ptr %i.k, align 4, !tbaa !22
...
bb.w:                                             ; preds = %.lr.ph131.i.i
  %i.cw = load i32, ptr %i.k, align 4, !tbaa !22
...
bb.y:                                             ; preds = %.lr.ph131.i.i, %.lr.ph131.i.i
  ...
  %i.de = load i32, ptr %i.dd, align 8, !tbaa !26 ; 3 uses
...
bb.z:                                             ; preds = %bb.ac, %.lr.ph.preheader.i.i
  ...
  %i.dm = load i8, ptr %.090122.i.i78, align 1, !tbaa !26 ; 3 uses
...
bb.aa:                                            ; preds = %bb.z
  ...
  %i.ds = load i16, ptr %i.dr, align 2, !tbaa !62
...
bb.ab:                                            ; preds = %bb.aa
  ...
  store i8 %i.dm, ptr %i.dv, align 1, !tbaa !26
  br label %bb.ac
...
bb.ac:                                            ; preds = %bb.ab, %bb.aa
  ...
  br i1 %or.cond, label %.critedge.i.i, label %bb.z, !llvm.loop !47
...
bb.af:                                            ; preds = %bb.ae
  %i.eg = load i32, ptr %i.bn, align 8, !tbaa !58
...
bb.ai:                                            ; preds = %.lr.ph131.i.i
  ...
  %i.el = load i64, ptr %i.ek, align 8, !tbaa !26 ; 4 uses
...
bb.ak:                                            ; preds = %bb.aj
  ...
  %i.eo = load i32, ptr %i.k, align 4, !tbaa !22
...
bb.ap:                                            ; preds = %bb.ao, %bb.an, %bb.am
  %i.ew = load i32, ptr %i.k, align 4, !tbaa !22
...
bb.ar:                                            ; preds = %.critedge113.i.i, %bb.ai, %bb.ah, %.thread.i.i, %bb.y, %bb.x, %bb.w, %bb.v, %bb.u, %bb.t, %bb.s, %bb.r, %bb.q, %bb.p, %bb.o, %.lr.ph131.i.i, %.lr.ph131.i.i
  ...
  br i1 %exitcond.not.i.i, label %._crit_edge.loopexit.i.i, label %.lr.ph131.i.i, !llvm.loop !48

._crit_edge.loopexit.i.i:                         ; preds = %bb.ar
  %.pre.i.i = load i32, ptr %i.k, align 4, !tbaa !22
...
.thread:                                          ; preds = %._crit_edge.i.i, %bb.at
  ...
  %i.fh = load ptr, ptr %i.f, align 8, !tbaa !23
...
cdf_file_summary_info.exit.thread50:              ; preds = %bb.ah, %bb.x, %bb.v, %bb.t, %bb.r, %bb.p, %.lr.ph131.i.i, %.critedge115.i.i, %bb.at
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #6
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #6
  %i.fi = load ptr, ptr %i.f, align 8, !tbaa !23
...
bb.au:                                            ; preds = %bb.as
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #6
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #6
  %i.fj = load ptr, ptr %i.f, align 8, !tbaa !23
...
bb.aw:                                            ; preds = %bb.av
  ...
  br i1 %i.lw, label %bb.av, label %.critedge.thread, !llvm.loop !49

.critedge:                                        ; preds = %bb.av
  %i.lx = load i32, ptr %i.k, align 4, !tbaa !22  ; 2 uses
  %i.ly = and i32 %i.lx, 1040
  %i.lz = icmp eq i32 %i.ly, 0
  br i1 %i.lz, label %bb.bb, label %bb.ay

.critedge.thread:                                 ; preds = %bb.aw
  %i.ma = load i32, ptr %i.k, align 4, !tbaa !22  ; 2 uses
...
bb.bc:                                            ; preds = %bb.bb
  ...
  %i.ml = load i32, ptr %i.k, align 4, !tbaa !22  ; 2 uses
...
bb.bf:                                            ; preds = %bb.be
  %i.ms = load ptr, ptr %i.a, align 8, !tbaa !23  ; 3 uses
  %i.mt = getelementptr inbounds nuw i8, ptr %i.ms, i64 8
  %i.mu = load i64, ptr %i.ms, align 8, !tbaa !65
...
bb.bg:                                            ; preds = %.lr.ph.i.i46
  ...
  %i.mx = load ptr, ptr %i.a, align 8, !tbaa !23  ; 2 uses
  %i.my = load i64, ptr %i.mx, align 8, !tbaa !65
  %i.mz = icmp ult i64 %i.mw, %i.my
  br i1 %i.mz, label %.lr.ph.i.i46, label %._crit_edge.i.i45, !llvm.loop !50
...
.lr.ph.i.i46:                                     ; preds = %bb.bf, %bb.bg
  ...
  %i.nb = load i16, ptr %i.na, align 8, !tbaa !67
  ...
  %i.nf = load ptr, ptr %i.a, align 8, !tbaa !23
  %i.ng = load i64, ptr %i.nf, align 8, !tbaa !65
  %i.nh = add i64 %i.ng, -1
...
bb.bh:                                            ; preds = %.lr.ph.i.i46
  %i.nm = load ptr, ptr %i.a, align 8, !tbaa !23
...
bb.b:                                             ; preds = %.loopexit
  %i.i = load ptr, ptr %.lcssa, align 8, !tbaa !69
...
!15 = !{!14, !14, i64 0}
!16 = !{!"p1 _ZTS10level_info", !13, i64 0}
!17 = !{!"cont", !12, i64 0, !16, i64 8}
!18 = !{!"out", !14, i64 0, !12, i64 8, !14, i64 16}
!19 = !{!"short", !8, i64 0}
!20 = !{!"", !14, i64 0, !12, i64 8, !12, i64 16, !12, i64 24}
!21 = !{!"magic_set", !8, i64 0, !17, i64 16, !18, i64 32, !9, i64 56, !9, i64 60, !9, i64 64, !9, i64 68, !9, i64 72, !14, i64 80, !12, i64 88, !9, i64 96, !19, i64 100, !20, i64 104, !8, i64 136, !19, i64 264, !19, i64 266, !19, i64 268, !19, i64 270, !19, i64 272, !19, i64 274, !19, i64 276, !12, i64 280, !12, i64 288, !12, i64 296}
!22 = !{!21, !9, i64 68}
!23 = !{!13, !13, i64 0}
!24 = !{!"", !13, i64 0, !12, i64 8}
!25 = !{!24, !13, i64 0}
!26 = !{!8, !8, i64 0}
!27 = !{!"llvm.loop.mustprogress"}
!28 = !{!"timespec", !12, i64 0, !12, i64 8}
!29 = !{!"stat", !12, i64 0, !12, i64 8, !12, i64 16, !9, i64 24, !9, i64 28, !9, i64 32, !9, i64 36, !12, i64 40, !12, i64 48, !12, i64 56, !12, i64 64, !28, i64 72, !28, i64 88, !28, i64 104, !8, i64 120}
!30 = !{!"buffer", !9, i64 0, !29, i64 8, !13, i64 152, !12, i64 160, !12, i64 168, !13, i64 176, !12, i64 184}
!31 = !{!30, !9, i64 0}
!32 = !{!30, !13, i64 152}
!33 = !{!30, !12, i64 160}
!34 = !{!"", !13, i64 0, !12, i64 8, !12, i64 16, !12, i64 24}
!35 = !{!34, !13, i64 0}
!36 = !{!"", !9, i64 0, !14, i64 8, !12, i64 16}
!37 = !{!36, !9, i64 0}
!38 = !{!36, !14, i64 8}
!39 = !{!36, !12, i64 16}
!40 = !{!"p1 int", !13, i64 0}
!41 = !{!"", !40, i64 0, !12, i64 8}
!42 = !{!41, !40, i64 0}
!43 = !{!34, !12, i64 8}
!44 = !{!34, !12, i64 24}
!45 = !{!9, !9, i64 0}
...
!49 = distinct !{!49, !27}
!50 = distinct !{!50, !27}
!51 = !{!"", !9, i64 0, !8, i64 4, !8, i64 8, !8, i64 10}
!52 = !{!"", !19, i64 0, !19, i64 2, !19, i64 4, !19, i64 6, !51, i64 8, !9, i64 24}
!53 = !{!52, !19, i64 0}
!54 = !{!52, !19, i64 6}
!55 = !{!52, !19, i64 4}
!56 = !{!12, !12, i64 0}
!57 = !{!"", !9, i64 0, !9, i64 4, !8, i64 8}
!58 = !{!57, !9, i64 0}
!59 = !{!57, !9, i64 4}
!60 = !{!"p1 short", !13, i64 0}
!61 = !{!60, !60, i64 0}
!62 = !{!19, !19, i64 0}
!63 = !{!24, !12, i64 8}
!64 = !{!"", !12, i64 0, !8, i64 8}
!65 = !{!64, !12, i64 0}
!66 = !{!"", !19, i64 0, !9, i64 4, !12, i64 8, !8, i64 16}
!67 = !{!66, !19, i64 0}
!68 = !{!"sinfo", !14, i64 0, !14, i64 8, !8, i64 16, !8, i64 56}
!69 = !{!68, !14, i64 0}
!70 = !{!68, !14, i64 8}
!71 = distinct !{!71, !27}
!72 = !{!"nv", !14, i64 0, !14, i64 8}
!73 = !{!72, !14, i64 0}
!74 = !{!72, !14, i64 8}
end_hunk_0
