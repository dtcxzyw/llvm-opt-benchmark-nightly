...
.preheader161.preheader:                          ; preds = %bb.b
  ...
  br i1 %i.e, label %.lr.ph218, label %.critedge

.preheader161:                                    ; preds = %.lr.ph218
  %i.f = icmp ugt ptr %i.g, %0
  br i1 %i.f, label %.lr.ph218, label %.critedge, !llvm.loop !90

.lr.ph218:                                        ; preds = %.preheader161.preheader, %.preheader161
  %.0113217 = phi ptr [ %i.g, %.preheader161 ], [ %i.d, %.preheader161.preheader ] ; 2 uses
  %i.g = getelementptr inbounds i8, ptr %.0113217, i64 -1 ; 4 uses
...
..critedge_crit_edge:                             ; preds = %.lr.ph218
  br label %.critedge, !llvm.loop !90

.critedge:                                        ; preds = %.preheader161, %..critedge_crit_edge, %.preheader161.preheader
  %.0113.lcssa = phi ptr [ %i.d, %.preheader161.preheader ], [ %.0113217, %..critedge_crit_edge ], [ %i.g, %.preheader161 ] ; 3 uses
  %i.i = ptrtoint ptr %.0113.lcssa to i64
  %i.j = ptrtoint ptr %0 to i64
  %i.k = sub i64 %i.i, %i.j                       ; 3 uses
  %i.l = sub i64 %1, %i.k
  %i.m = call fastcc zeroext i1 @_php_filter_validate_ipv4(ptr noundef nonnull %.0113.lcssa, i64 noundef %i.l, ptr noundef %i.b)
  %i.n = icmp ugt i64 %i.k, 1
  %or.cond154.not = and i1 %i.n, %i.m
  br i1 %or.cond154.not, label %bb.c, label %.loopexit160

bb.c:                                             ; preds = %.critedge
  %i.o = getelementptr inbounds i8, ptr %.0113.lcssa, i64 -2
...
bb.d:                                             ; preds = %bb.c, %bb.b
  %.0121 = phi i32 [ 2, %bb.c ], [ 0, %bb.b ]
  %.1112 = phi i64 [ %spec.select, %bb.c ], [ %1, %bb.b ] ; 2 uses
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 %.1112 ; 4 uses
  %i.s = icmp ne ptr %2, null                     ; 4 uses
  br label %bb.e

bb.e:                                             ; preds = %bb.w, %bb.d
  %.0124 = phi i32 [ -1, %bb.d ], [ %.1125, %bb.w ] ; 4 uses
  %.1122 = phi i32 [ %.0121, %bb.d ], [ %i.bh, %bb.w ] ; 9 uses
  %.0110 = phi ptr [ %0, %bb.d ], [ %.2.lcssa, %bb.w ] ; 6 uses
  %i.t = icmp ult ptr %.0110, %i.r
  br i1 %i.t, label %bb.f, label %.loopexit159

bb.f:                                             ; preds = %bb.e
  %i.u = load i8, ptr %.0110, align 1, !tbaa !12
  %i.v = icmp eq i8 %i.u, 58
  br i1 %i.v, label %bb.g, label %bb.o

bb.g:                                             ; preds = %bb.f
  %i.w = getelementptr inbounds nuw i8, ptr %.0110, i64 1 ; 3 uses
...
bb.i:                                             ; preds = %bb.h
  %i.z = icmp sgt i32 %.0124, -1
  br i1 %i.z, label %.loopexit160, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.aa = icmp slt i32 %.1122, 8
  %or.cond = and i1 %i.s, %i.aa
  br i1 %or.cond, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  %i.ab = sext i32 %.1122 to i64
  %i.ac = getelementptr inbounds [4 x i8], ptr %2, i64 %i.ab
  store i32 -1, ptr %i.ac, align 4, !tbaa !69
  br label %bb.l

bb.l:                                             ; preds = %bb.k, %bb.j
  %i.ad = add nsw i32 %.1122, 1                   ; 2 uses
  %i.ae = getelementptr inbounds nuw i8, ptr %.0110, i64 2 ; 2 uses
  %i.af = icmp eq ptr %i.ae, %i.r
  br i1 %i.af, label %bb.m, label %bb.o

bb.m:                                             ; preds = %bb.l
  %i.ag = icmp sgt i32 %.1122, 7
  br i1 %i.ag, label %.loopexit160, label %.loopexit159

bb.n:                                             ; preds = %bb.h
  %i.ah = icmp eq ptr %.0110, %0
  br i1 %i.ah, label %.loopexit160, label %bb.o

bb.o:                                             ; preds = %bb.l, %bb.n, %bb.f
  %.1125 = phi i32 [ %.1122, %bb.l ], [ %.0124, %bb.n ], [ %.0124, %bb.f ]
  %.2123 = phi i32 [ %i.ad, %bb.l ], [ %.1122, %bb.n ], [ %.1122, %bb.f ] ; 4 uses
  %.1 = phi ptr [ %i.ae, %bb.l ], [ %i.w, %bb.n ], [ %.0110, %bb.f ] ; 5 uses
  %i.ai = icmp ult ptr %.1, %i.r
  br i1 %i.ai, label %.lr.ph.preheader, label %._crit_edge

.lr.ph.preheader:                                 ; preds = %bb.o
  %.1189 = ptrtoaddr ptr %.1 to i64
  %i.aj = getelementptr i8, ptr %.1, i64 %.1112
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.u
  %.2169 = phi ptr [ %i.bb, %bb.u ], [ %.1, %.lr.ph.preheader ] ; 3 uses
  %.0118168 = phi i32 [ %i.ba, %bb.u ], [ 0, %.lr.ph.preheader ] ; 2 uses
  %.0119167 = phi i32 [ %.1120, %bb.u ], [ 0, %.lr.ph.preheader ] ; 4 uses
  %i.al = load i8, ptr %.2169, align 1, !tbaa !12 ; 3 uses
  %i.am = add i8 %i.al, -48                       ; 2 uses
  %or.cond150 = icmp ult i8 %i.am, 10
  br i1 %or.cond150, label %bb.p, label %bb.q

bb.p:                                             ; preds = %.lr.ph
  %i.an = shl i32 %.0119167, 4
...
bb.u:                                             ; preds = %bb.r, %bb.t, %bb.p
  %.1120 = phi i32 [ %i.ap, %bb.p ], [ %i.au, %bb.r ], [ %i.az, %bb.t ] ; 2 uses
  %i.ba = add i32 %.0118168, 1                    ; 2 uses
  %i.bb = getelementptr inbounds nuw i8, ptr %.2169, i64 1 ; 2 uses
...
._crit_edge.loopexit:                             ; preds = %bb.s, %bb.u
  %.0119.lcssa.ph = phi i32 [ %.1120, %bb.u ], [ %.0119167, %bb.s ]
  %.0118.lcssa.ph = phi i32 [ %i.ba, %bb.u ], [ %.0118168, %bb.s ]
  %.2.lcssa.ph = phi ptr [ %scevgep190, %bb.u ], [ %.2169, %bb.s ]
  %i.bc = add i32 %.0118.lcssa.ph, -5
  %i.bd = icmp ult i32 %i.bc, -4
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %bb.o
  %.0119.lcssa = phi i32 [ 0, %bb.o ], [ %.0119.lcssa.ph, %._crit_edge.loopexit ]
  %.0118.lcssa = phi i1 [ true, %bb.o ], [ %i.bd, %._crit_edge.loopexit ]
  %.2.lcssa = phi ptr [ %.1, %bb.o ], [ %.2.lcssa.ph, %._crit_edge.loopexit ]
  %i.be = icmp slt i32 %.2123, 8
  %or.cond3 = select i1 %i.s, i1 %i.be, i1 false
  br i1 %or.cond3, label %bb.v, label %bb.w

bb.v:                                             ; preds = %._crit_edge
  %i.bf = sext i32 %.2123 to i64
  %i.bg = getelementptr inbounds [4 x i8], ptr %2, i64 %i.bf
  store i32 %.0119.lcssa, ptr %i.bg, align 4, !tbaa !69
  br label %bb.w

bb.w:                                             ; preds = %bb.v, %._crit_edge
  %i.bh = add nsw i32 %.2123, 1
  %i.bi = icmp sgt i32 %.2123, 7
  %or.cond156 = select i1 %.0118.lcssa, i1 true, i1 %i.bi
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %.loopexit, label %.lr.ph182.preheader220

.lr.ph182.preheader220:                           ; preds = %.lr.ph182.preheader, %middle.block
...
.lr.ph182:                                        ; preds = %.lr.ph182.preheader220, %.lr.ph182
  %.2117181 = phi i32 [ %i.cz, %.lr.ph182 ], [ %.2117181.ph, %.lr.ph182.preheader220 ] ; 3 uses
  %i.cx = zext nneg i32 %.2117181 to i64
  %i.cy = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %i.cx
  store i32 0, ptr %i.cy, align 4, !tbaa !69
  %i.cz = add nsw i32 %.2117181, -1
  %.not149.not = icmp samesign ugt i32 %.2117181, %.2126
  br i1 %.not149.not, label %.lr.ph182, label %.loopexit, !llvm.loop !96

.loopexit:                                        ; preds = %.lr.ph182, %middle.block, %bb.x, %.preheader.preheader
  %i.da = icmp sgt i32 %.2126, -1
...
.loopexit160:                                     ; preds = %bb.w, %bb.n, %bb.i, %bb.g, %bb.m, %.critedge, %bb.a, %.loopexit
  %.0 = phi i1 [ false, %.critedge ], [ false, %bb.a ], [ %i.dc, %.loopexit ], [ false, %bb.m ], [ false, %bb.g ], [ false, %bb.i ], [ false, %bb.n ], [ false, %bb.w ]
...
zend_hash_str_find_deref.exit.thread112:          ; preds = %bb.b, %bb.a, %bb.e, %zend_hash_str_find_deref.exit
  %.079116 = phi ptr [ %i.o, %zend_hash_str_find_deref.exit ], [ null, %bb.e ], [ null, %bb.a ], [ null, %bb.b ]
...
bb.r:                                             ; preds = %bb.l, %.fold.split, %zend_hash_str_find_deref.exit.thread112
  %.083 = phi i32 [ 2, %bb.l ], [ 4, %zend_hash_str_find_deref.exit.thread112 ], [ 2, %.fold.split ] ; 2 uses
  %.080 = phi i32 [ 45, %bb.l ], [ 46, %zend_hash_str_find_deref.exit.thread112 ], [ 58, %.fold.split ] ; 6 uses
...
bb.s:                                             ; preds = %bb.r
  %i.ag = load i8, ptr %.079116, align 1, !tbaa !12
  %i.ah = sext i8 %i.ag to i32
  %.not91 = icmp eq i32 %.080, %i.ah
...
bb.z:                                             ; preds = %bb.s, %bb.r
  %i.an = or disjoint i32 %.083, 1
  %i.ao = zext nneg i32 %.083 to i64              ; 7 uses
