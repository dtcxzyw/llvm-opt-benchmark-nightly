Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/php/original/logical_filters?download=true
inline.NumInlined: 5
inline.NumDeleted: 4
...
.loopexit159:                                     ; preds = %bb.e, %bb.m
  ...
  %.3 = phi i32 [ %i.ad, %bb.m ], [ %.1116, %bb.e ] ; 10 uses
...
.lr.ph178:                                        ; preds = %bb.y
  ...
  %.not224 = icmp eq i32 %i.bs, 6
  br i1 %.not224, label %.lr.ph182.preheader, label %.lr.ph178.1
