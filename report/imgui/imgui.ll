...
begin_hunk_0_@_ZN5ImGui11FocusWindowEP11ImGuiWindowi:bb.a
  ...
  br i1 %exitcond.not.i177, label %_ZN5ImGui26IsWindowWithinBeginStackOfEP11ImGuiWindowS1_.exit.loopexit.i178, label %.lr.ph.i169, !llvm.loop !34
...
select.unfold.i179:                               ; preds = %bb.az, %.lr.ph.i.i172, %bb.ay
  ...
  br i1 %exitcond64.not.i181, label %.split.thread, label %bb.ay, !llvm.loop !35
...
bb.bc:                                            ; preds = %bb.bb
  ...
  %i.hl = load ptr, ptr %i.hk, align 8, !tbaa !313
  tail call void (ptr, ...) @_ZN5ImGui8DebugLogEPKcz(ptr noundef nonnull @.str.164, ptr noundef %i.hl), !inline_history !710
  br label %bb.bd

bb.bd:                                            ; preds = %bb.bc, %bb.bb
  tail call void @_ZN5ImGui17ClosePopupToLevelEib(i32 noundef %.128.i163, i1 noundef zeroext false), !inline_history !710
...
.split.thread:                                    ; preds = %select.unfold.i179, %bb.bd, %_ZN5ImGui26IsWindowWithinBeginStackOfEP11ImGuiWindowS1_.exit.i162, %.split, %_ZN5ImGui21ClosePopupsOverWindowEP11ImGuiWindowb.exit
  ...
  %i.hm = load ptr, ptr %.in, align 8, !tbaa !674
  br label %.thread
...
bb.bj:                                            ; preds = %bb.bi
  %i.hx = load ptr, ptr @GImGui, align 8, !tbaa !227 ; 4 uses
...
.lr.ph.i74.prol:                                  ; preds = %.lr.ph.preheader.i
  ...
  %i.ip = load ptr, ptr %i.io, align 8, !tbaa !601 ; 2 uses
  %i.iq = getelementptr inbounds [8 x i8], ptr %i.ib, i64 %i.im
  store ptr %i.ip, ptr %i.iq, align 8, !tbaa !601
  %i.ir = getelementptr inbounds nuw i8, ptr %i.ip, i64 226 ; 2 uses
  %i.is = load i16, ptr %i.ir, align 2, !tbaa !717
  %i.it = add i16 %i.is, -1
  store i16 %i.it, ptr %i.ir, align 2, !tbaa !717
...
._crit_edge.i:                                    ; preds = %.lr.ph.i74.prol.loopexit, %.lr.ph.i74, %.._crit_edge_crit_edge.i
  ...
  store ptr %i.hn, ptr %i.iw, align 8, !tbaa !601
  %i.ix = trunc i32 %i.ik to i16
  store i16 %i.ix, ptr %i.hy, align 2, !tbaa !717
...
.lr.ph.i74:                                       ; preds = %.lr.ph.i74.prol.loopexit, %.lr.ph.i74
  ...
  %i.iz = load ptr, ptr %i.iy, align 8, !tbaa !601 ; 2 uses
  %i.ja = getelementptr inbounds [8 x i8], ptr %i.ib, i64 %indvars.iv.i75
  store ptr %i.iz, ptr %i.ja, align 8, !tbaa !601
  %i.jb = getelementptr inbounds nuw i8, ptr %i.iz, i64 226 ; 2 uses
  %i.jc = load i16, ptr %i.jb, align 2, !tbaa !717
  %i.jd = add i16 %i.jc, -1
  store i16 %i.jd, ptr %i.jb, align 2, !tbaa !717
  ...
  %i.jf = load ptr, ptr %i.je, align 8, !tbaa !601 ; 2 uses
  %i.jg = getelementptr inbounds [8 x i8], ptr %i.ib, i64 %indvars.iv.next.i76
  store ptr %i.jf, ptr %i.jg, align 8, !tbaa !601
  %i.jh = getelementptr inbounds nuw i8, ptr %i.jf, i64 226 ; 2 uses
  %i.ji = load i16, ptr %i.jh, align 2, !tbaa !717
  %i.jj = add i16 %i.ji, -1
  store i16 %i.jj, ptr %i.jh, align 2, !tbaa !717
  %exitcond.not.i.1 = icmp eq i64 %indvars.iv.next.i76.1, %wide.trip.count.i
  br i1 %exitcond.not.i.1, label %._crit_edge.i, label %.lr.ph.i74, !llvm.loop !36
...
_ZN5ImGui23BringWindowToFocusFrontEP11ImGuiWindow.exit: ; preds = %bb.bj, %._crit_edge.i
  ...
  %i.jl = load i32, ptr %i.jk, align 4, !tbaa !614
  %i.jm = getelementptr inbounds nuw i8, ptr %i.hn, i64 20
  %i.jn = load i32, ptr %i.jm, align 4, !tbaa !614
...
bb.bl:                                            ; preds = %_ZN5ImGui23BringWindowToFocusFrontEP11ImGuiWindow.exit
  ...
  %i.jt = load ptr, ptr %i.js, align 8, !tbaa !493 ; 3 uses
  %i.ju = load i32, ptr %i.jr, align 8, !tbaa !495 ; 4 uses
  %i.jv = sext i32 %i.ju to i64
  %i.jw = getelementptr [8 x i8], ptr %i.jt, i64 %i.jv
  %i.jx = getelementptr i8, ptr %i.jw, i64 -8
  %i.jy = load ptr, ptr %i.jx, align 8, !tbaa !601 ; 2 uses
...
bb.bm:                                            ; preds = %bb.bl
  ...
  %i.kb = load ptr, ptr %i.ka, align 8, !tbaa !674
...
.lr.ph.i79:                                       ; preds = %bb.bo, %.lr.ph.preheader.i78
  %.023.i = phi i32 [ %i.ku, %bb.bo ], [ %i.ke, %.lr.ph.preheader.i78 ] ; 4 uses
  %i.kf = zext nneg i32 %.023.i to i64            ; 2 uses
  %i.kg = getelementptr inbounds nuw [8 x i8], ptr %i.jt, i64 %i.kf
  %i.kh = load ptr, ptr %i.kg, align 8, !tbaa !601
  %i.ki = icmp eq ptr %i.kh, %i.hn
...
bb.bn:                                            ; preds = %.lr.ph.i79
  ...
  %i.ks = getelementptr [8 x i8], ptr %i.kq, i64 %i.kr
  %i.kt = getelementptr i8, ptr %i.ks, i64 -8
  store ptr %i.hn, ptr %i.kt, align 8, !tbaa !601
  br label %_ZN5ImGui25BringWindowToDisplayFrontEP11ImGuiWindow.exit

bb.bo:                                            ; preds = %.lr.ph.i79
  %i.ku = add nsw i32 %.023.i, -1
  %i.kv = icmp sgt i32 %.023.i, 0
  br i1 %i.kv, label %.lr.ph.i79, label %_ZN5ImGui25BringWindowToDisplayFrontEP11ImGuiWindow.exit, !llvm.loop !37
...
bb.a:
  %i.a = load ptr, ptr @GImGui, align 8, !tbaa !227 ; 16 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = load i32, ptr %i.d, align 4, !tbaa !652  ; 2 uses
  %i.f = getelementptr inbounds nuw i8, ptr %i.a, i64 5432
  store i32 %i.e, ptr %i.f, align 8, !tbaa !654
  %i.g = getelementptr inbounds nuw i8, ptr %i.a, i64 5484
  %i.h = load i32, ptr %i.g, align 4, !tbaa !672
...
bb.c:                                             ; preds = %bb.b
  ...
  store i8 1, ptr %i.j, align 1, !tbaa !719
...
_ZN5ImGui11KeepAliveIDEj.exit:                    ; preds = %bb.b, %bb.c
  ...
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !674  ; 8 uses
  %i.m = getelementptr inbounds nuw i8, ptr %i.a, i64 280
  %i.n = load i8, ptr %i.m, align 8, !tbaa !243, !range !99, !noundef !236
...
._crit_edge.i:                                    ; preds = %bb.e
  ...
  %i.ac = load <2 x float>, ptr %i.y, align 8, !tbaa !75
...
bb.f:                                             ; preds = %._crit_edge.i
  ...
  %i.ao = load i32, ptr %i.an, align 4, !tbaa !614
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.ar = load float, ptr %i.aq, align 4, !tbaa !573
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.au = load float, ptr %i.at, align 4, !tbaa !720
  store float %i.au, ptr %i.aq, align 4, !tbaa !573
...
_ZN5ImGui20MarkIniSettingsDirtyEP11ImGuiWindow.exit.i: ; preds = %bb.h, %bb.g, %bb.f
  ...
  %i.aw = load <2 x float>, ptr %i.av, align 8, !tbaa !75
  %i.ax = fadd <2 x float> %i.ah, %i.aw
  store <2 x float> %i.ax, ptr %i.av, align 8, !tbaa !75
  %i.ay = getelementptr inbounds nuw i8, ptr %i.l, i64 312 ; 2 uses
  %i.az = load <2 x float>, ptr %i.ay, align 8, !tbaa !75
  %i.ba = fadd <2 x float> %i.ah, %i.az
  store <2 x float> %i.ba, ptr %i.ay, align 8, !tbaa !75
  %i.bb = getelementptr inbounds nuw i8, ptr %i.l, i64 296 ; 2 uses
  %i.bc = load <4 x float>, ptr %i.bb, align 8, !tbaa !75
  %i.bd = fadd <4 x float> %i.ai, %i.bc
  store <4 x float> %i.bd, ptr %i.bb, align 8, !tbaa !75
...
_ZN5ImGui12SetWindowPosEP11ImGuiWindowRK6ImVec2i.exit: ; preds = %bb.e, %._crit_edge.i, %_ZN5ImGui20MarkIniSettingsDirtyEP11ImGuiWindow.exit.i
  %i.be = load ptr, ptr %i.b, align 8, !tbaa !500
...
bb.m:                                             ; preds = %bb.l
  ...
  store i8 1, ptr %i.bq, align 1, !tbaa !719
...
_ZN5ImGui11KeepAliveIDEj.exit16:                  ; preds = %bb.l, %bb.m
  ...
  %i.bs = load i8, ptr %i.br, align 8, !tbaa !243, !range !99, !noundef !236
...
bb.a:
  %i.a = load ptr, ptr @GImGui, align 8, !tbaa !227 ; 4 uses
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %i.s = load i8, ptr %.3.i.i, align 1, !tbaa !222 ; 2 uses
...
_Z9ImHashStrPKcmj.exit.loopexit.i:                ; preds = %bb.f
  ...
  %i.w = load ptr, ptr %i.v, align 8, !tbaa !262  ; 3 uses
  %i.x = load i32, ptr %i.u, align 8, !tbaa !261  ; 2 uses
...
.lr.ph.i.i.i.i:                                   ; preds = %_Z9ImHashStrPKcmj.exit.loopexit.i, %.lr.ph.i.i.i.i
  ...
  %i.ac = load i32, ptr %i.ab, align 8, !tbaa !260
...
bb.g:                                             ; preds = %_Z12ImLowerBoundP16ImGuiStoragePairS0_j.exit.i.i.i
  %i.ah = load i32, ptr %.013.lcssa.i.i.i.i, align 8, !tbaa !260
...
_ZN5ImGui16FindWindowByNameEPKc.exit:             ; preds = %bb.g
  ...
  %i.al = load i8, ptr %i.ak, align 4, !tbaa !759, !range !99, !noundef !236
...
bb.h:                                             ; preds = %_ZN5ImGui16FindWindowByNameEPKc.exit
  ...
  %i.ap = load i8, ptr %i.ao, align 1, !tbaa !397, !range !99, !noundef !236
...
_ZN5ImGui16FindWindowByNameEPKc.exit.thread:      ; preds = %_Z12ImLowerBoundP16ImGuiStoragePairS0_j.exit.i.i.i, %bb.g, %bb.h, %_ZN5ImGui16FindWindowByNameEPKc.exit
  ...
  %i.at = load <2 x float>, ptr %i.as, align 4, !tbaa !75 ; 2 uses
  %i.au = getelementptr inbounds nuw i8, ptr %i.a, i64 3604 ; 2 uses
  %i.av = load <2 x float>, ptr %i.au, align 4, !tbaa !75 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %0) #41
  %i.aw = getelementptr inbounds nuw i8, ptr %0, i64 4
  store i32 4, ptr %0, align 4, !tbaa !384
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.aw, ptr noundef nonnull align 4 dereferenceable(16) %i.as, i64 16, i1 false), !tbaa.struct !385
  ...
  %i.az = load i32, ptr %i.ay, align 4, !tbaa !386
...
bb.j:                                             ; preds = %_ZN5ImGui14PushStyleColorEiRK6ImVec4.exit
  ...
  %i.bf = load ptr, ptr @GImGui, align 8, !tbaa !227 ; 5 uses
  %i.bg = getelementptr inbounds nuw i8, ptr %i.bf, i64 7928 ; 2 uses
  %i.bh = load i32, ptr %i.bg, align 8, !tbaa !852
  %i.bi = or i32 %i.bh, 1
  store i32 %i.bi, ptr %i.bg, align 8, !tbaa !852
  ...
  store i32 1, ptr %i.bm, align 4, !tbaa !907
  br label %bb.k
...
bb.k:                                             ; preds = %bb.j, %_ZN5ImGui14PushStyleColorEiRK6ImVec4.exit
  ...
  %i.bo = load ptr, ptr @GImGui, align 8, !tbaa !227 ; 3 uses
  %i.bp = getelementptr inbounds nuw i8, ptr %i.bo, i64 8056 ; 4 uses
  %i.bq = load i32, ptr %i.bp, align 8, !tbaa !390 ; 2 uses
  %i.br = icmp slt i32 %i.bq, 1
  br i1 %i.br, label %bb.l, label %.lr.ph

bb.l:                                             ; preds = %bb.k
  %i.bs = call noundef zeroext i1 @_ZN5ImGui8ErrorLogEPKc(ptr noundef nonnull @.str.11), !inline_history !990 ; 0 uses
  %i.bt = load i32, ptr %i.bp, align 8, !tbaa !390 ; 3 uses
...
bb.m:                                             ; preds = %.lr.ph, %bb.m
  ...
  %i.bz = load ptr, ptr %i.bw, align 8, !tbaa !389
  ...
  %i.ce = load i32, ptr %i.cc, align 4, !tbaa !384
  %i.cf = sext i32 %i.ce to i64
  %i.cg = getelementptr inbounds [16 x i8], ptr %i.bx, i64 %i.cf
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.cg, ptr noundef nonnull align 4 dereferenceable(16) %i.cd, i64 16, i1 false), !tbaa.struct !385
  %i.ch = load i32, ptr %i.bp, align 8, !tbaa !387
  %i.ci = add nsw i32 %i.ch, -1                   ; 2 uses
  store i32 %i.ci, ptr %i.bp, align 8, !tbaa !387
  %i.cj = add nsw i32 %.1.i24, -1
  %i.ck = icmp samesign ugt i32 %.1.i24, 1
  br i1 %i.ck, label %bb.m, label %_ZN5ImGui13PopStyleColorEi.exit, !llvm.loop !17
...
bb.n:                                             ; preds = %_ZN5ImGui13PopStyleColorEi.exit
  ...
  %i.cm = load ptr, ptr %i.cl, align 8, !tbaa !289
  %i.cn = getelementptr inbounds nuw i8, ptr %i.cm, i64 218
  %i.co = load i16, ptr %i.cn, align 2, !tbaa !838
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.cq = load ptr, ptr %i.cl, align 8, !tbaa !289 ; 7 uses
  %i.cr = load ptr, ptr @GImGui, align 8, !tbaa !227 ; 5 uses
  %i.cs = getelementptr inbounds nuw i8, ptr %i.cr, i64 5216 ; 2 uses
  %i.ct = getelementptr inbounds nuw i8, ptr %i.cr, i64 5224 ; 2 uses
  %i.cu = load ptr, ptr %i.ct, align 8, !tbaa !493 ; 3 uses
  %i.cv = load i32, ptr %i.cs, align 8, !tbaa !495 ; 4 uses
  %i.cw = sext i32 %i.cv to i64
  %i.cx = getelementptr [8 x i8], ptr %i.cu, i64 %i.cw
  %i.cy = getelementptr i8, ptr %i.cx, i64 -8
  %i.cz = load ptr, ptr %i.cy, align 8, !tbaa !601 ; 2 uses
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.dc = load ptr, ptr %i.db, align 8, !tbaa !674
...
.lr.ph.i:                                         ; preds = %bb.r, %.lr.ph.preheader.i
  %.023.i = phi i32 [ %i.dv, %bb.r ], [ %i.df, %.lr.ph.preheader.i ] ; 4 uses
  %i.dg = zext nneg i32 %.023.i to i64            ; 2 uses
  %i.dh = getelementptr inbounds nuw [8 x i8], ptr %i.cu, i64 %i.dg
  %i.di = load ptr, ptr %i.dh, align 8, !tbaa !601
...
bb.q:                                             ; preds = %.lr.ph.i
  ...
  store ptr %i.cq, ptr %i.du, align 8, !tbaa !601
  %.pre = load ptr, ptr %i.cl, align 8, !tbaa !289
  %.pre28 = load ptr, ptr @GImGui, align 8, !tbaa !227
  br label %_ZN5ImGui25BringWindowToDisplayFrontEP11ImGuiWindow.exit

bb.r:                                             ; preds = %.lr.ph.i
  %i.dv = add nsw i32 %.023.i, -1
  %i.dw = icmp sgt i32 %.023.i, 0
  br i1 %i.dw, label %.lr.ph.i, label %_ZN5ImGui25BringWindowToDisplayFrontEP11ImGuiWindow.exit, !llvm.loop !37

_ZN5ImGui25BringWindowToDisplayFrontEP11ImGuiWindow.exit: ; preds = %bb.r, %bb.o, %bb.p, %bb.q
  %i.dx = phi ptr [ %.pre28, %bb.q ], [ %i.cr, %bb.o ], [ %i.cr, %bb.p ], [ %i.cr, %bb.r ] ; 3 uses
  %i.dy = phi ptr [ %.pre, %bb.q ], [ %i.cq, %bb.o ], [ %i.cq, %bb.p ], [ %i.cq, %bb.r ] ; 3 uses
  %i.dz = getelementptr inbounds nuw i8, ptr %i.dy, i64 226 ; 2 uses
  %i.ea = getelementptr inbounds nuw i8, ptr %i.dx, i64 5232
  %i.eb = getelementptr inbounds nuw i8, ptr %i.dx, i64 5240
  %i.ec = load ptr, ptr %i.eb, align 8, !tbaa !493 ; 8 uses
  %i.ed = load i32, ptr %i.ea, align 8, !tbaa !495 ; 2 uses
  %i.ee = sext i32 %i.ed to i64
  %i.ef = getelementptr [8 x i8], ptr %i.ec, i64 %i.ee
  %i.eg = getelementptr i8, ptr %i.ef, i64 -8
  %i.eh = load ptr, ptr %i.eg, align 8, !tbaa !601
  %i.ei = icmp eq ptr %i.eh, %i.dy
  br i1 %i.ei, label %_ZN5ImGui23BringWindowToFocusFrontEP11ImGuiWindow.exit, label %bb.s

bb.s:                                             ; preds = %_ZN5ImGui25BringWindowToDisplayFrontEP11ImGuiWindow.exit
  %i.ej = load i16, ptr %i.dz, align 2, !tbaa !717 ; 2 uses
  %i.ek = sext i16 %i.ej to i32
  %i.el = add nsw i32 %i.ed, -1                   ; 4 uses
  %i.em = icmp sgt i32 %i.el, %i.ek
  br i1 %i.em, label %.lr.ph.preheader.i13, label %.._crit_edge_crit_edge.i

.._crit_edge_crit_edge.i:                         ; preds = %bb.s
  %.pre.i = sext i32 %i.el to i64
  br label %._crit_edge.i

.lr.ph.preheader.i13:                             ; preds = %bb.s
  %i.en = sext i16 %i.ej to i64                   ; 5 uses
  %wide.trip.count.i = sext i32 %i.el to i64      ; 5 uses
  %i.eo = sub nsw i64 %wide.trip.count.i, %i.en
...
.lr.ph.i14.prol:                                  ; preds = %.lr.ph.preheader.i13
  %indvars.iv.next.i.prol = add nsw i64 %i.en, 1  ; 2 uses
  %i.ep = getelementptr inbounds [8 x i8], ptr %i.ec, i64 %indvars.iv.next.i.prol
  %i.eq = load ptr, ptr %i.ep, align 8, !tbaa !601 ; 2 uses
  %i.er = getelementptr inbounds [8 x i8], ptr %i.ec, i64 %i.en
  store ptr %i.eq, ptr %i.er, align 8, !tbaa !601
  %i.es = getelementptr inbounds nuw i8, ptr %i.eq, i64 226 ; 2 uses
  %i.et = load i16, ptr %i.es, align 2, !tbaa !717
  %i.eu = add i16 %i.et, -1
  store i16 %i.eu, ptr %i.es, align 2, !tbaa !717
  br label %.lr.ph.i14.prol.loopexit

.lr.ph.i14.prol.loopexit:                         ; preds = %.lr.ph.i14.prol, %.lr.ph.preheader.i13
  %indvars.iv.i.unr = phi i64 [ %i.en, %.lr.ph.preheader.i13 ], [ %indvars.iv.next.i.prol, %.lr.ph.i14.prol ]
  %i.ev = add nsw i64 %wide.trip.count.i, -1
  %i.ew = icmp eq i64 %i.ev, %i.en
  br i1 %i.ew, label %._crit_edge.i, label %.lr.ph.i14
...
._crit_edge.i:                                    ; preds = %.lr.ph.i14.prol.loopexit, %.lr.ph.i14, %.._crit_edge_crit_edge.i
  ...
  %i.ex = getelementptr inbounds [8 x i8], ptr %i.ec, i64 %.pre-phi.i
  store ptr %i.dy, ptr %i.ex, align 8, !tbaa !601
  %i.ey = trunc i32 %i.el to i16
  store i16 %i.ey, ptr %i.dz, align 2, !tbaa !717
  br label %_ZN5ImGui23BringWindowToFocusFrontEP11ImGuiWindow.exit

.lr.ph.i14:                                       ; preds = %.lr.ph.i14.prol.loopexit, %.lr.ph.i14
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i.1, %.lr.ph.i14 ], [ %indvars.iv.i.unr, %.lr.ph.i14.prol.loopexit ] ; 3 uses
  %indvars.iv.next.i = add nsw i64 %indvars.iv.i, 1 ; 2 uses
  %i.ez = getelementptr inbounds [8 x i8], ptr %i.ec, i64 %indvars.iv.next.i
  %i.fa = load ptr, ptr %i.ez, align 8, !tbaa !601 ; 2 uses
  %i.fb = getelementptr inbounds [8 x i8], ptr %i.ec, i64 %indvars.iv.i
  store ptr %i.fa, ptr %i.fb, align 8, !tbaa !601
  %i.fc = getelementptr inbounds nuw i8, ptr %i.fa, i64 226 ; 2 uses
  %i.fd = load i16, ptr %i.fc, align 2, !tbaa !717
  %i.fe = add i16 %i.fd, -1
  store i16 %i.fe, ptr %i.fc, align 2, !tbaa !717
  %indvars.iv.next.i.1 = add nsw i64 %indvars.iv.i, 2 ; 3 uses
  %i.ff = getelementptr inbounds [8 x i8], ptr %i.ec, i64 %indvars.iv.next.i.1
  %i.fg = load ptr, ptr %i.ff, align 8, !tbaa !601 ; 2 uses
  %i.fh = getelementptr inbounds [8 x i8], ptr %i.ec, i64 %indvars.iv.next.i
  store ptr %i.fg, ptr %i.fh, align 8, !tbaa !601
  %i.fi = getelementptr inbounds nuw i8, ptr %i.fg, i64 226 ; 2 uses
  %i.fj = load i16, ptr %i.fi, align 2, !tbaa !717
  %i.fk = add i16 %i.fj, -1
  store i16 %i.fk, ptr %i.fi, align 2, !tbaa !717
  %exitcond.not.i.1 = icmp eq i64 %indvars.iv.next.i.1, %wide.trip.count.i
  br i1 %exitcond.not.i.1, label %._crit_edge.i, label %.lr.ph.i14, !llvm.loop !36
...
_ZN5ImGui23BringWindowToFocusFrontEP11ImGuiWindow.exit: ; preds = %_ZN5ImGui25BringWindowToDisplayFrontEP11ImGuiWindow.exit, %._crit_edge.i
  %i.fl = getelementptr inbounds nuw i8, ptr %i.dx, i64 5312
  %i.fm = load ptr, ptr %i.fl, align 8, !tbaa !289
  %i.fn = getelementptr inbounds nuw i8, ptr %i.fm, i64 40
  %.sroa.0.0.copyload.i = load <2 x float>, ptr %i.fn, align 8
  %i.fo = getelementptr inbounds nuw i8, ptr %i.a, i64 10352
  store <2 x float> %.sroa.0.0.copyload.i, ptr %i.fo, align 8
  br label %bb.t
...
bb.a:
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !289  ; 15 uses
  %i.d = getelementptr inbounds nuw i8, ptr %i.c, i64 209
  %i.e = load i8, ptr %i.d, align 1, !tbaa !927, !range !99, !noundef !236
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.x = load float, ptr %i.w, align 4, !tbaa !993
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.d
  %.0 = phi float [ %i.x, %bb.e ], [ %1, %bb.d ]
  %i.y = getelementptr inbounds nuw i8, ptr %i.c, i64 280
  %i.z = getelementptr inbounds nuw i8, ptr %i.c, i64 288
  %i.aa = load float, ptr %i.z, align 8, !tbaa !992
  %i.ab = fadd float %.0, %i.aa
  store float %i.ab, ptr %i.y, align 8, !tbaa !979
  br label %bb.g

bb.g:                                             ; preds = %bb.f, %bb.c
  %i.ac = getelementptr inbounds nuw i8, ptr %i.c, i64 292
  %i.ad = load float, ptr %i.ac, align 4, !tbaa !322
  ...
  %i.aj = load float, ptr %i.ai, align 4, !tbaa !971
  %i.ak = getelementptr inbounds nuw i8, ptr %i.c, i64 336
  store float %i.aj, ptr %i.ak, align 8, !tbaa !972
  %i.al = getelementptr inbounds nuw i8, ptr %i.c, i64 344
  store i8 1, ptr %i.al, align 8, !tbaa !973
  br label %bb.h
...
bb.a:
  ...
  store i8 1, ptr %i.b, align 1, !tbaa !580
  ret void
}
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !493  ; 3 uses
  %i.e = load i32, ptr %i.b, align 8, !tbaa !495  ; 4 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.d
  ...
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !601
...
bb.c:                                             ; preds = %.lr.ph
  ...
  store ptr %0, ptr %i.ad, align 8, !tbaa !601
  br label %.loopexit

bb.d:                                             ; preds = %.lr.ph
  %i.ae = add nsw i32 %.023, -1
  %i.af = icmp sgt i32 %.023, 0
  br i1 %i.af, label %.lr.ph, label %.loopexit, !llvm.loop !37
...
bb.a:
  ...
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !493  ; 8 uses
  %i.f = load i32, ptr %i.c, align 8, !tbaa !495  ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  %i.l = load i16, ptr %i.b, align 2, !tbaa !717  ; 2 uses
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader
  ...
  store ptr %i.s, ptr %i.t, align 8, !tbaa !601
  %i.u = getelementptr inbounds nuw i8, ptr %i.s, i64 226 ; 2 uses
  %i.v = load i16, ptr %i.u, align 2, !tbaa !717
  %i.w = add i16 %i.v, -1
  store i16 %i.w, ptr %i.u, align 2, !tbaa !717
...
._crit_edge:                                      ; preds = %.lr.ph.prol.loopexit, %.lr.ph, %.._crit_edge_crit_edge
  ...
  store ptr %0, ptr %i.z, align 8, !tbaa !601
  %i.aa = trunc i32 %i.n to i16
  store i16 %i.aa, ptr %i.b, align 2, !tbaa !717
  br label %bb.c
...
bb.a:
  ...
  store i8 1, ptr %i.g, align 1, !tbaa !978
  ret void
}
...
bb.a:
  ...
  %i.g = load <2 x float>, ptr %i.d, align 4, !tbaa !75
  %i.h = load <2 x float>, ptr %i.e, align 4, !tbaa !75
  %i.i = fsub <2 x float> %i.g, %i.h
  %i.j = load <2 x float>, ptr %i.f, align 4, !tbaa !75
...
bb.a:
  ...
  %i.e = load float, ptr %i.d, align 4, !tbaa !319
  %i.f = getelementptr inbounds nuw i8, ptr %i.c, i64 44
  %i.g = load float, ptr %i.f, align 4, !tbaa !735
  %i.h = fsub float %i.e, %i.g
  %i.i = getelementptr inbounds nuw i8, ptr %i.c, i64 156
  %i.j = load float, ptr %i.i, align 4, !tbaa !823
  %i.k = fadd float %i.h, %i.j
  ret float %i.k
}
...
bb.a:
  %i.a = load ptr, ptr @GImGui, align 8, !tbaa !227
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 5312
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !289  ; 5 uses
  %i.d = getelementptr inbounds nuw i8, ptr %i.c, i64 206
  store i8 1, ptr %i.d, align 2, !tbaa !679
  %i.e = getelementptr inbounds nuw i8, ptr %i.c, i64 40
  %i.f = getelementptr inbounds nuw i8, ptr %i.c, i64 152
  %i.g = load <2 x float>, ptr %i.e, align 4, !tbaa !75
  %i.h = load <2 x float>, ptr %i.f, align 4, !tbaa !75
  %i.i = fsub <2 x float> %i.g, %i.h
  %i.j = load <2 x float>, ptr %0, align 4, !tbaa !75
  %i.k = fadd <2 x float> %i.i, %i.j
