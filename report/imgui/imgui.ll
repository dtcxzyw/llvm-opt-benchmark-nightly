...
begin_hunk_0_@_ZN5ImGui17ShowMetricsWindowEPb:bb.a
  %i.bfn = load i16, ptr %i.bfm, align 2, !tbaa !233
  ...
  %.pre1243.a = load i16, ptr %i.bfa, align 4, !tbaa !229
  ...
  %.pre1245.a = load i16, ptr %i.bfa, align 4, !tbaa !229
  ...
  %.pre1247.a = load i16, ptr %i.bfa, align 4, !tbaa !229
  ...
  %.pre1249.a = load i16, ptr %i.bfa, align 4, !tbaa !229
  ...
  %.pre1251.a = load i16, ptr %i.bfa, align 4, !tbaa !229
...
bb.hm:                                            ; preds = %bb.hl
  ...
  %i.biw = load float, ptr %i.biv, align 4, !tbaa !971
  %i.bix = getelementptr inbounds nuw i8, ptr %i.bif, i64 336
  store float %i.biw, ptr %i.bix, align 8, !tbaa !972
  %i.biy = getelementptr inbounds nuw i8, ptr %i.bif, i64 344
  store i8 1, ptr %i.biy, align 8, !tbaa !973
  br label %bb.hn

bb.hn:                                            ; preds = %bb.hl, %bb.hm
  %i.biz = load i32, ptr %i.bfb, align 4, !tbaa !228
  %i.bja = load i32, ptr %i.bhu, align 4, !tbaa !231
...
_ZN5ImGui10GetKeyDataE8ImGuiKey.exit.i.i:         ; preds = %bb.hp, %_ZN5ImGui9IsKeyDownE8ImGuiKey.exit.thread1031
  ...
  %i.bjw = load i8, ptr %i.bjv, align 4, !tbaa !239, !range !99, !noundef !236
...
_ZN5ImGui9IsKeyDownE8ImGuiKey.exit:               ; preds = %_ZN5ImGui10GetKeyDataE8ImGuiKey.exit.i.i
  ...
  %i.bka = load i8, ptr %i.bjz, align 4, !tbaa !525, !range !99, !noundef !236
...
_ZN5ImGui9IsKeyDownE8ImGuiKey.exit.thread:        ; preds = %_ZN5ImGui9IsKeyDownE8ImGuiKey.exit
  ...
  %i.bkd = load ptr, ptr %i.bkc, align 8, !tbaa !289 ; 10 uses
  %i.bke = getelementptr inbounds nuw i8, ptr %i.bkd, i64 209
  %i.bkf = load i8, ptr %i.bke, align 1, !tbaa !927, !range !99, !noundef !236
...
bb.hr:                                            ; preds = %_ZN5ImGui9IsKeyDownE8ImGuiKey.exit.thread
  ...
  %i.bku = load float, ptr %i.bkt, align 4, !tbaa !971
  %i.bkv = getelementptr inbounds nuw i8, ptr %i.bkd, i64 336
  store float %i.bku, ptr %i.bkv, align 8, !tbaa !972
  %i.bkw = getelementptr inbounds nuw i8, ptr %i.bkd, i64 344
  store i8 1, ptr %i.bkw, align 8, !tbaa !973
  br label %_ZN5ImGui8SameLineEff.exit718

_ZN5ImGui8SameLineEff.exit718:                    ; preds = %_ZN5ImGui9IsKeyDownE8ImGuiKey.exit.thread, %bb.hr
  %i.bkx = getelementptr [8 x i8], ptr @_ZL9GKeyNames, i64 %indvars.iv1190
  %i.bky = getelementptr i8, ptr %i.bkx, i64 -4096
  %i.bkz = load ptr, ptr %i.bky, align 8, !tbaa !256
  ...
  %i.blb = load ptr, ptr @GImGui, align 8, !tbaa !227 ; 3 uses
  %i.blc = getelementptr inbounds nuw i8, ptr %i.blb, i64 5312
  %i.bld = load ptr, ptr %i.blc, align 8, !tbaa !289 ; 10 uses
  %i.ble = getelementptr inbounds nuw i8, ptr %i.bld, i64 209
  %i.blf = load i8, ptr %i.ble, align 1, !tbaa !927, !range !99, !noundef !236
...
bb.hs:                                            ; preds = %_ZN5ImGui8SameLineEff.exit718
  ...
  %i.blu = load float, ptr %i.blt, align 4, !tbaa !971
  %i.blv = getelementptr inbounds nuw i8, ptr %i.bld, i64 336
  store float %i.blu, ptr %i.blv, align 8, !tbaa !972
  %i.blw = getelementptr inbounds nuw i8, ptr %i.bld, i64 344
  store i8 1, ptr %i.blw, align 8, !tbaa !973
...
_ZN5ImGui9IsKeyDownE8ImGuiKey.exit.thread1031:    ; preds = %_ZN5ImGui10GetKeyDataE8ImGuiKey.exit.i.i, %_ZN5ImGui9IsKeyDownE8ImGuiKey.exit, %_ZN5ImGui10GetKeyDataE8ImGuiKey.exit
  ...
  br i1 %exitcond1193.not, label %bb.hq, label %_ZN5ImGui10GetKeyDataE8ImGuiKey.exit.i.i, !llvm.loop !1659

bb.ht:                                            ; preds = %bb.hx
  call void (ptr, ...) @_ZN5ImGui4TextEPKcz(ptr noundef nonnull @.str.377)
  %.pre1256.a = load ptr, ptr @GImGui, align 8, !tbaa !227
...
bb.hv:                                            ; preds = %bb.hu
  %i.bme = load ptr, ptr @GImGui, align 8, !tbaa !227 ; 2 uses
  %i.bmf = getelementptr inbounds nuw i8, ptr %i.bme, i64 5312
  %i.bmg = load ptr, ptr %i.bmf, align 8, !tbaa !289 ; 10 uses
  %i.bmh = getelementptr inbounds nuw i8, ptr %i.bmg, i64 209
  %i.bmi = load i8, ptr %i.bmh, align 1, !tbaa !927, !range !99, !noundef !236
...
bb.hw:                                            ; preds = %bb.hv
  ...
  %i.bmx = load float, ptr %i.bmw, align 4, !tbaa !971
  %i.bmy = getelementptr inbounds nuw i8, ptr %i.bmg, i64 336
  store float %i.bmx, ptr %i.bmy, align 8, !tbaa !972
  %i.bmz = getelementptr inbounds nuw i8, ptr %i.bmg, i64 344
  store i8 1, ptr %i.bmz, align 8, !tbaa !973
...
_ZN5ImGui8SameLineEff.exit728:                    ; preds = %bb.hv, %bb.hw
  ...
  %i.bnc = load ptr, ptr %i.bnb, align 8, !tbaa !256
...
bb.hx:                                            ; preds = %bb.hu, %_ZN5ImGui8SameLineEff.exit728
  ...
  br i1 %exitcond1197.not, label %bb.ht, label %bb.hu, !llvm.loop !1660

bb.hy:                                            ; preds = %_ZN5ImGui13IsKeyReleasedE8ImGuiKey.exit.thread1035
  %i.bnd = getelementptr inbounds nuw i8, ptr %i.g, i64 300
  %i.bne = load i8, ptr %i.bnd, align 4, !tbaa !767, !range !99, !noundef !236
  ...
  %i.bni = load i8, ptr %i.bnh, align 1, !tbaa !768, !range !99, !noundef !236
  ...
  %i.bnm = load i8, ptr %i.bnl, align 2, !tbaa !769, !range !99, !noundef !236
  ...
  %i.bnq = load i8, ptr %i.bnp, align 1, !tbaa !770, !range !99, !noundef !236
  ...
  %i.bnu = load i32, ptr %i.bnt, align 8, !tbaa !805
...
_ZN5ImGui10GetKeyDataE8ImGuiKey.exit.i.i740:      ; preds = %bb.ht, %_ZN5ImGui13IsKeyReleasedE8ImGuiKey.exit.thread1035
  ...
  %i.boa = load float, ptr %i.bnz, align 4, !tbaa !775
...
bb.hz:                                            ; preds = %_ZN5ImGui10GetKeyDataE8ImGuiKey.exit.i.i740
  ...
  %i.bod = load i8, ptr %i.boc, align 4, !tbaa !239, !range !99, !noundef !236
...
_ZN5ImGui13IsKeyReleasedE8ImGuiKey.exit:          ; preds = %bb.hz
  ...
  %i.boh = load i8, ptr %i.bog, align 4, !tbaa !525, !range !99, !noundef !236
...
_ZN5ImGui13IsKeyReleasedE8ImGuiKey.exit.thread:   ; preds = %_ZN5ImGui13IsKeyReleasedE8ImGuiKey.exit
  ...
  %i.bok = load ptr, ptr %i.boj, align 8, !tbaa !289 ; 10 uses
  %i.bol = getelementptr inbounds nuw i8, ptr %i.bok, i64 209
  %i.bom = load i8, ptr %i.bol, align 1, !tbaa !927, !range !99, !noundef !236
...
bb.ia:                                            ; preds = %_ZN5ImGui13IsKeyReleasedE8ImGuiKey.exit.thread
  ...
  %i.bpb = load float, ptr %i.bpa, align 4, !tbaa !971
  %i.bpc = getelementptr inbounds nuw i8, ptr %i.bok, i64 336
  store float %i.bpb, ptr %i.bpc, align 8, !tbaa !972
  %i.bpd = getelementptr inbounds nuw i8, ptr %i.bok, i64 344
  store i8 1, ptr %i.bpd, align 8, !tbaa !973
  br label %_ZN5ImGui8SameLineEff.exit751

_ZN5ImGui8SameLineEff.exit751:                    ; preds = %_ZN5ImGui13IsKeyReleasedE8ImGuiKey.exit.thread, %bb.ia
  %i.bpe = getelementptr [8 x i8], ptr @_ZL9GKeyNames, i64 %indvars.iv1198
  %i.bpf = getelementptr i8, ptr %i.bpe, i64 -4096
  %i.bpg = load ptr, ptr %i.bpf, align 8, !tbaa !256
  ...
  %.pre1255.a = load ptr, ptr @GImGui, align 8, !tbaa !227
...
bb.ib:                                            ; preds = %.lr.ph1131, %_ZN5ImGui8SameLineEff.exit764
  ...
  %i.bqz = load ptr, ptr %i.bnw, align 8, !tbaa !241
  %i.bra = getelementptr inbounds nuw [2 x i8], ptr %i.bqz, i64 %indvars.iv1202
  %i.brb = load i16, ptr %i.bra, align 2, !tbaa !255 ; 2 uses
  %i.brc = load ptr, ptr @GImGui, align 8, !tbaa !227 ; 2 uses
  %i.brd = getelementptr inbounds nuw i8, ptr %i.brc, i64 5312
  %i.bre = load ptr, ptr %i.brd, align 8, !tbaa !289 ; 10 uses
  %i.brf = getelementptr inbounds nuw i8, ptr %i.bre, i64 209
  %i.brg = load i8, ptr %i.brf, align 1, !tbaa !927, !range !99, !noundef !236
...
bb.ic:                                            ; preds = %bb.ib
  ...
  %i.brv = load float, ptr %i.bru, align 4, !tbaa !971
  %i.brw = getelementptr inbounds nuw i8, ptr %i.bre, i64 336
  store float %i.brv, ptr %i.brw, align 8, !tbaa !972
  %i.brx = getelementptr inbounds nuw i8, ptr %i.bre, i64 344
  store i8 1, ptr %i.brx, align 8, !tbaa !973
...
bb.if:                                            ; preds = %bb.ie, %bb.id
  ...
  %i.bsl = load <2 x float>, ptr %i.bsk, align 4, !tbaa !75
  ...
  %i.bsq = load ptr, ptr @GImGui, align 8, !tbaa !227 ; 6 uses
  %i.bsr = getelementptr inbounds nuw i8, ptr %i.bsq, i64 280
  %i.bss = load i8, ptr %i.bsr, align 1, !tbaa !243, !range !99, !noundef !236
...
_ZN5ImGui11IsMouseDownEi.exit:                    ; preds = %bb.if
  ...
  %i.bsv = load i8, ptr %i.bsu, align 4, !tbaa !525, !range !99, !noundef !236
...
bb.ig:                                            ; preds = %_ZN5ImGui11IsMouseDownEi.exit
  ...
  %i.bsy = load ptr, ptr %i.bsx, align 8, !tbaa !289 ; 10 uses
  %i.bsz = getelementptr inbounds nuw i8, ptr %i.bsy, i64 209
  %i.bta = load i8, ptr %i.bsz, align 1, !tbaa !927, !range !99, !noundef !236
...
_ZN5ImGui8SameLineEff.exit769:                    ; preds = %bb.ig, %bb.ih
  ...
  %.pre1257.a = load ptr, ptr @GImGui, align 8, !tbaa !227
...
_ZN5ImGui11IsMouseDownEi.exit.thread:             ; preds = %bb.if, %_ZN5ImGui11IsMouseDownEi.exit, %_ZN5ImGui8SameLineEff.exit769
  ...
  %i.btw = load i8, ptr %i.btv, align 1, !tbaa !243, !range !99, !noundef !236
