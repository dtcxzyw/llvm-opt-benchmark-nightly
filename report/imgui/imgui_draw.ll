...
.epil.preheader:                                  ; preds = %.unr-lcssa, %.lr.ph
  ...
  %.0125133.epil.init = phi i32 [ 2, %.lr.ph ], [ %i.bj, %.unr-lcssa ]
  %lcmp.mod176 = trunc i32 %2 to i1
  tail call void @llvm.assume(i1 %lcmp.mod176)
  store i16 %i.q, ptr %.epil.init, align 2, !tbaa !240
  %i.w = shl nuw i32 %.0125133.epil.init, 1       ; 2 uses
  %i.x = add i32 %i.s, %i.w
...
bb.c:                                             ; preds = %.unr-lcssa, %.epil.preheader
  %.lcssa174 = phi ptr [ %i.bi, %.unr-lcssa ], [ %i.ad, %.epil.preheader ]
  store ptr %.lcssa174, ptr %i.r, align 8, !tbaa !105
  ...
  br i1 %.not.i, label %bb.d, label %.lr.ph136.preheader
...
.lr.ph136.preheader:                              ; preds = %bb.f, %bb.c
...
bb.g:                                             ; preds = %bb.g, %.lr.ph.new
  ...
  %i.bj = add nuw nsw i32 %.0125133, 2            ; 2 uses
...
.lr.ph136:                                        ; preds = %.lr.ph136.preheader, %bb.i
  %indvars.iv = phi i64 [ 0, %.lr.ph136.preheader ], [ %indvars.iv.next, %bb.i ] ; 3 uses
  %.0124134 = phi i64 [ %i.aq, %.lr.ph136.preheader ], [ %indvars.iv, %bb.i ] ; 2 uses
  %i.bp = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.0124134
...
bb.i:                                             ; preds = %bb.h, %.lr.ph136
  %i.cc = phi <2 x float> [ %i.cb, %bb.h ], [ %i.bt, %.lr.ph136 ] ; 2 uses
  %i.cd = getelementptr inbounds nuw [8 x i8], ptr %i.ao, i64 %.0124134 ; 2 uses
  ...
  br i1 %exitcond151.not, label %.lr.ph139, label %.lr.ph136, !llvm.loop !256

._crit_edge140:                                   ; preds = %bb.l
...
bb.j:                                             ; preds = %.lr.ph139, %bb.l
  %indvars.iv152 = phi i64 [ 0, %.lr.ph139 ], [ %indvars.iv.next153, %bb.l ] ; 5 uses
  %.0120137 = phi i32 [ %i.ap, %.lr.ph139 ], [ %i.ei, %bb.l ] ; 2 uses
  %i.cl = sext i32 %.0120137 to i64
  %i.cm = getelementptr inbounds [8 x i8], ptr %i.ao, i64 %i.cl
  %i.cn = getelementptr inbounds nuw [8 x i8], ptr %i.ao, i64 %indvars.iv152
  ...
  %foldExtExtBinop172 = fmul <2 x float> %i.cr, %i.cr
  %i.cs = extractelement <2 x float> %foldExtExtBinop172, i64 1
...
bb.k:                                             ; preds = %bb.j
  ...
  %.0116 = select i1 %i.cx, float 1.000000e+02, float %i.cw
  %i.cy = insertelement <2 x float> poison, float %.0116, i64 0
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %i.dd = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv152 ; 2 uses
  ...
  %indvars.iv152.tr = trunc nuw i64 %indvars.iv152 to i32
  %i.dr = shl nuw i32 %indvars.iv152.tr, 1        ; 2 uses
  ...
  %i.ei = trunc nuw nsw i64 %indvars.iv152 to i32
  %exitcond156.not = icmp eq i64 %indvars.iv.next153, %wide.trip.count155
  br i1 %exitcond156.not, label %._crit_edge140, label %bb.j, !llvm.loop !257
...
.lr.ph143:                                        ; preds = %bb.b
  ...
  %wide.trip.count160 = zext nneg i32 %2 to i64   ; 2 uses
  %xtraiter178 = and i64 %wide.trip.count160, 1
  %.pre163 = load ptr, ptr %i.el, align 8, !tbaa !239
  %unroll_iter183 = and i64 %wide.trip.count160, 2147483646
  br label %bb.m

.lr.ph145.unr-lcssa:                              ; preds = %bb.m
  %lcmp.mod181.not = icmp eq i64 %xtraiter178, 0
  br i1 %lcmp.mod181.not, label %.lr.ph145, label %.epil.preheader177

.epil.preheader177:                               ; preds = %.lr.ph145.unr-lcssa
  %lcmp.mod182 = trunc i32 %2 to i1
  tail call void @llvm.assume(i1 %lcmp.mod182)
  %i.em = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv.next158.1
...
.lr.ph145:                                        ; preds = %.lr.ph145.unr-lcssa, %.epil.preheader177
  ...
  %.promoted147 = load ptr, ptr %i.ew, align 8, !tbaa !105 ; 2 uses
  %i.ex = add nsw i32 %2, -2                      ; 2 uses
  %i.ey = add nsw i32 %2, -3
  %xtraiter187 = and i32 %i.ex, 3                 ; 3 uses
  %i.ez = icmp ult i32 %i.ey, 3
  br i1 %i.ez, label %.epil.preheader186, label %.lr.ph145.new

.lr.ph145.new:                                    ; preds = %.lr.ph145
  %unroll_iter194 = and i32 %i.ex, -4
  %invariant.op = add i32 2, %i.eu
  %invariant.op202 = add i32 3, %i.eu
  br label %bb.o

bb.m:                                             ; preds = %bb.m, %.lr.ph143
  %i.fa = phi ptr [ %.pre163, %.lr.ph143 ], [ %i.fp, %bb.m ]
  %indvars.iv157 = phi i64 [ 0, %.lr.ph143 ], [ %indvars.iv.next158.1, %bb.m ] ; 3 uses
  %niter184 = phi i64 [ 0, %.lr.ph143 ], [ %niter184.next.1, %bb.m ]
  %i.fb = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv157
  ...
  %i.fi = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv157
  ...
  %niter184.next.1 = add nuw nsw i64 %niter184, 2 ; 2 uses
  %niter184.ncmp.1 = icmp eq i64 %niter184.next.1, %unroll_iter183
  br i1 %niter184.ncmp.1, label %.lr.ph145.unr-lcssa, label %bb.m, !llvm.loop !258

.unr-lcssa185:                                    ; preds = %bb.o
  %lcmp.mod190.not = icmp eq i32 %xtraiter187, 0
  br i1 %lcmp.mod190.not, label %.epilog-lcssa191, label %.epil.preheader186

.epil.preheader186:                               ; preds = %.unr-lcssa185, %.lr.ph145
  %.epil.init189 = phi ptr [ %.promoted147, %.lr.ph145 ], [ %i.gy, %.unr-lcssa185 ]
  %.0144.epil.init = phi i32 [ 2, %.lr.ph145 ], [ %i.gz, %.unr-lcssa185 ]
  %lcmp.mod193 = icmp ne i32 %xtraiter187, 0
  tail call void @llvm.assume(i1 %lcmp.mod193)
  br label %bb.n

bb.n:                                             ; preds = %bb.n, %.epil.preheader186
  %i.fq = phi ptr [ %.epil.init189, %.epil.preheader186 ], [ %i.fw, %bb.n ] ; 4 uses
  %.0144.epil = phi i32 [ %.0144.epil.init, %.epil.preheader186 ], [ %i.fx, %bb.n ] ; 2 uses
  %epil.iter = phi i32 [ 0, %.epil.preheader186 ], [ %epil.iter.next, %bb.n ]
  store i16 %i.ev, ptr %i.fq, align 2, !tbaa !240
  %i.fr = add i32 %i.eu, %.0144.epil
...
bb.l:                                             ; preds = %bb.k, %.lr.ph134
  %i.cg = phi <2 x float> [ %i.cf, %bb.k ], [ %i.bx, %.lr.ph134 ] ; 2 uses
  %i.ch = getelementptr inbounds nuw [8 x i8], ptr %i.bl, i64 %.0119132 ; 2 uses
  ...
  br i1 %exitcond.not, label %.lr.ph137, label %.lr.ph134, !llvm.loop !324

._crit_edge138:                                   ; preds = %bb.o
...
bb.m:                                             ; preds = %.lr.ph137, %bb.o
  %indvars.iv146 = phi i64 [ 0, %.lr.ph137 ], [ %indvars.iv.next147, %bb.o ] ; 5 uses
  %.0115135 = phi i32 [ %i.bm, %.lr.ph137 ], [ %i.em, %bb.o ] ; 2 uses
  %i.cp = sext i32 %.0115135 to i64
  %i.cq = getelementptr inbounds [8 x i8], ptr %i.bl, i64 %i.cp
  %i.cr = getelementptr inbounds nuw [8 x i8], ptr %i.bl, i64 %indvars.iv146
  ...
  %foldExtExtBinop167 = fmul <2 x float> %i.cv, %i.cv
  %i.cw = extractelement <2 x float> %foldExtExtBinop167, i64 1
...
bb.n:                                             ; preds = %bb.m
  ...
  %.0111 = select i1 %i.db, float 1.000000e+02, float %i.da
  %i.dc = insertelement <2 x float> poison, float %.0111, i64 0
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  %i.dh = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv146 ; 2 uses
  ...
  %indvars.iv146.tr = trunc nuw i64 %indvars.iv146 to i32
  %i.dv = shl nuw i32 %indvars.iv146.tr, 1        ; 2 uses
  %i.dw = add i32 %i.dv, %i.s
  %i.dx = trunc i32 %i.dw to i16                  ; 2 uses
  %i.dy = load ptr, ptr %i.bq, align 8, !tbaa !105 ; 7 uses
  store i16 %i.dx, ptr %i.dy, align 2, !tbaa !240
  %i.dz = shl i32 %.0115135, 1                    ; 2 uses
  ...
  %i.em = trunc nuw nsw i64 %indvars.iv146 to i32
  %exitcond150.not = icmp eq i64 %indvars.iv.next147, %wide.trip.count149
  br i1 %exitcond150.not, label %._crit_edge138, label %bb.m, !llvm.loop !325
...
.lr.ph141:                                        ; preds = %bb.b
  ...
  %wide.trip.count154 = zext nneg i32 %2 to i64   ; 2 uses
  %xtraiter = and i64 %wide.trip.count154, 1
  %.pre157 = load ptr, ptr %i.ep, align 8, !tbaa !239
  %unroll_iter = and i64 %wide.trip.count154, 2147483646
  br label %bb.s

._crit_edge142.unr-lcssa:                         ; preds = %bb.s
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %._crit_edge142, label %.epil.preheader

.epil.preheader:                                  ; preds = %._crit_edge142.unr-lcssa
  %lcmp.mod169 = trunc i32 %2 to i1
  tail call void @llvm.assume(i1 %lcmp.mod169)
  %i.eq = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv.next152.1
...
._crit_edge142:                                   ; preds = %._crit_edge142.unr-lcssa, %.epil.preheader
  ...
  %.not.i127.not = icmp slt i32 %i.ez, %i.fc
  br i1 %.not.i127.not, label %_ZN8ImVectorI6ImVec2E15reserve_discardEi.exit129, label %bb.p

bb.p:                                             ; preds = %._crit_edge142
  %i.fd = getelementptr inbounds nuw i8, ptr %i.ex, i64 80 ; 2 uses
  %i.fe = load ptr, ptr %i.fd, align 8, !tbaa !28 ; 2 uses
  %.not4.i128 = icmp eq ptr %i.fe, null
  br i1 %.not4.i128, label %bb.r, label %bb.q
...
bb.r:                                             ; preds = %bb.q, %bb.p
  ...
  %.pre158 = load ptr, ptr %i.d, align 8, !tbaa !35
  br label %_ZN8ImVectorI6ImVec2E15reserve_discardEi.exit129

_ZN8ImVectorI6ImVec2E15reserve_discardEi.exit129: ; preds = %._crit_edge142, %bb.r
  %i.fi = phi ptr [ %i.ex, %._crit_edge142 ], [ %.pre158, %bb.r ]
  ...
  br i1 %i.fm, label %.lr.ph143, label %_ZN8ImVectorI6ImVec2E15reserve_discardEi.exit129.._crit_edge144_crit_edge

_ZN8ImVectorI6ImVec2E15reserve_discardEi.exit129.._crit_edge144_crit_edge: ; preds = %_ZN8ImVectorI6ImVec2E15reserve_discardEi.exit129
  %.pre159 = load i32, ptr %i.fn, align 4, !tbaa !75
  br label %._crit_edge144

.lr.ph143:                                        ; preds = %_ZN8ImVectorI6ImVec2E15reserve_discardEi.exit129
  %i.fo = getelementptr inbounds nuw i8, ptr %0, i64 72 ; 2 uses
  %i.fp = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  br label %bb.t

bb.s:                                             ; preds = %bb.s, %.lr.ph141
  %i.fq = phi ptr [ %.pre157, %.lr.ph141 ], [ %i.gf, %bb.s ]
  %indvars.iv151 = phi i64 [ 0, %.lr.ph141 ], [ %indvars.iv.next152.1, %bb.s ] ; 3 uses
  %niter = phi i64 [ 0, %.lr.ph141 ], [ %niter.next.1, %bb.s ]
  %i.fr = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv151
  ...
  %i.fy = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv151
  ...
  br i1 %niter.ncmp.1, label %._crit_edge142.unr-lcssa, label %bb.s, !llvm.loop !326

bb.t:                                             ; preds = %.lr.ph143, %bb.t
  call void @_ZN14ImTriangulator15GetNextTriangleEPj(ptr noundef nonnull align 8 dereferenceable(48) %4, ptr noundef nonnull %i.a)
  ...
  br i1 %i.gt, label %bb.t, label %._crit_edge144, !llvm.loop !327

._crit_edge144:                                   ; preds = %bb.t, %_ZN8ImVectorI6ImVec2E15reserve_discardEi.exit129.._crit_edge144_crit_edge
  %i.gu = phi i32 [ %.pre159, %_ZN8ImVectorI6ImVec2E15reserve_discardEi.exit129.._crit_edge144_crit_edge ], [ %i.gg, %bb.t ]
...
bb.u:                                             ; preds = %._crit_edge144, %._crit_edge138
