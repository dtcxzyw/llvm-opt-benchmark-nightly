...
.lr.ph550:                                        ; preds = %.thread612
  ...
  %.pre595 = load ptr, ptr %i.fu, align 8, !tbaa !239
  br label %bb.s

bb.s:                                             ; preds = %.lr.ph550, %bb.s
  %i.fv = phi ptr [ %.pre595, %.lr.ph550 ], [ %i.gj, %bb.s ]
...
bb.t:                                             ; preds = %.lr.ph552, %bb.t
  %i.gk = phi ptr [ %.pre596, %.lr.ph552 ], [ %i.hf, %bb.t ]
  %indvars.iv575 = phi i64 [ 0, %.lr.ph552 ], [ %indvars.iv.next576, %bb.t ] ; 3 uses
  %i.gl = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv575
  ...
  %i.gr = getelementptr inbounds nuw i8, ptr %i.aw, i64 %.idx610 ; 2 uses
...
.lr.ph556:                                        ; preds = %bb.u, %.thread532
  %i.ix = phi float [ %i.bx, %.thread532 ], [ %i.hh, %bb.u ] ; 2 uses
...
.lr.ph558:                                        ; preds = %bb.x
  ...
  %.pre597 = load ptr, ptr %i.jg, align 8, !tbaa !239
  br label %bb.y

bb.v:                                             ; preds = %.lr.ph556, %bb.x
  %indvars.iv580 = phi i64 [ 0, %.lr.ph556 ], [ %indvars.iv.next581, %bb.x ] ; 2 uses
  %i.jh = phi ptr [ %.promoted, %.lr.ph556 ], [ %i.lr, %bb.x ] ; 9 uses
  %.0425553 = phi i32 [ %i.iz, %.lr.ph556 ], [ %spec.select, %bb.x ] ; 3 uses
  %indvars.iv.next581 = add nuw nsw i64 %indvars.iv580, 1 ; 4 uses
  %i.ji = icmp eq i64 %indvars.iv.next581, %i.av  ; 2 uses
  %i.jj = trunc nuw nsw i64 %indvars.iv.next581 to i32
  %i.jk = select i1 %i.ji, i32 0, i32 %i.jj       ; 2 uses
  %i.jl = add i32 %.0425553, 4
  %spec.select = select i1 %i.ji, i32 %i.iz, i32 %i.jl ; 3 uses
  %i.jm = getelementptr inbounds nuw [8 x i8], ptr %i.au, i64 %indvars.iv580
  ...
  %foldExtExtBinop622 = fmul <2 x float> %i.js, %i.js
  %i.jt = extractelement <2 x float> %foldExtExtBinop622, i64 1
...
bb.w:                                             ; preds = %bb.v
  ...
  %.0421 = select i1 %i.jy, float 1.000000e+02, float %i.jx
  %i.jz = insertelement <2 x float> poison, float %.0421, i64 0
...
bb.x:                                             ; preds = %bb.w, %bb.v
  ...
  %i.la = trunc i32 %.0425553 to i16              ; 3 uses
...
bb.z:                                             ; preds = %.lr.ph561, %bb.ab
  ...
  %i.ni = icmp eq i64 %indvars.iv.next591, %i.nf
  %i.nj = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv590 ; 3 uses
  %i.nk = select i1 %i.ni, i64 0, i64 %indvars.iv.next591
  ...
  %foldExtExtBinop624 = fmul <2 x float> %i.nq, %i.nq
  %i.nr = extractelement <2 x float> %foldExtExtBinop624, i64 1
