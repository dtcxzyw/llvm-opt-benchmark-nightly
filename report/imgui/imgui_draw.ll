...
_ZL17stbtt_GetGlyphBoxPK14stbtt_fontinfoiPiS2_S2_S2_.exit: ; preds = %bb.i, %bb.b
  ...
  store i32 %i.cx, ptr %4, align 4, !tbaa !259
  %i.cy = extractelement <2 x i32> %i.cw, i64 0
  store i32 %i.cy, ptr %5, align 4, !tbaa !259
...
bb.m:                                             ; preds = %_ZL17stbtt_GetGlyphBoxPK14stbtt_fontinfoiPiS2_S2_S2_.exit
  ...
  store i32 %i.dc, ptr %6, align 4, !tbaa !259
  br label %bb.n
...
.sink.split:                                      ; preds = %bb.l, %bb.o
  ...
  store i32 %.sink, ptr %7, align 4, !tbaa !259
  br label %bb.p
...
bb.a:
  ...
  %.sroa.073.0.copyload = load ptr, ptr %i.b, align 8, !tbaa !412
  ...
  %.sroa.065.0.copyload = load ptr, ptr %i.d, align 8, !tbaa !412
  ...
  store ptr %i.f, ptr %4, align 8, !tbaa !412
...
_ZL15stbtt__buf_get8P10stbtt__buf.exit:           ; preds = %_ZL15stbtt__buf_get8P10stbtt__buf.exit.lr.ph, %.thread
  ...
  %.sroa.5.0374 = phi i64 [ %i.c, %_ZL15stbtt__buf_get8P10stbtt__buf.exit.lr.ph ], [ %.sroa.5.3350, %.thread ] ; 27 uses
  ...
  %i.am = load ptr, ptr %4, align 8, !tbaa !505   ; 6 uses
  %i.an = add nsw i32 %i.al, 1                    ; 7 uses
  store i32 %i.an, ptr %.sroa.468.0..sroa_idx, align 8, !tbaa !503
  %i.ao = sext i32 %i.al to i64
  %i.ap = getelementptr inbounds i8, ptr %i.am, i64 %i.ao
  %i.aq = load i8, ptr %i.ap, align 1, !tbaa !50  ; 6 uses
...
bb.b:                                             ; preds = %_ZL15stbtt__buf_get8P10stbtt__buf.exit, %_ZL15stbtt__buf_get8P10stbtt__buf.exit
  %.not274.a = icmp eq i32 %.0234373, 0
  br i1 %.not274.a, label %bb.d, label %bb.c
...
_ZL19stbtt__track_vertexP12stbtt__csctxii.exit.i.i: ; preds = %bb.x, %bb.w
  store i32 1, ptr %i.af, align 4, !tbaa !540
  %.pre.i = load i32, ptr %.phi.trans.insert.i309, align 8, !tbaa !544
  br label %_ZL21stbtt__csctx_rline_toP12stbtt__csctxff.exit

bb.y:                                             ; preds = %.preheader
  %i.cn = load ptr, ptr %i.aj, align 8, !tbaa !545
  %i.co = load i32, ptr %.phi.trans.insert.i309, align 8, !tbaa !544 ; 2 uses
  %i.cp = sext i32 %i.co to i64
  %i.cq = getelementptr inbounds [14 x i8], ptr %i.cn, i64 %i.cp ; 3 uses
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cq, i64 12
  store i8 2, ptr %i.cr, align 2, !tbaa !514
  %i.cs = trunc <2 x i32> %i.bx to <2 x i16>
  store <2 x i16> %i.cs, ptr %i.cq, align 2, !tbaa !243
...
_ZL21stbtt__csctx_rline_toP12stbtt__csctxff.exit: ; preds = %_ZL19stbtt__track_vertexP12stbtt__csctxii.exit.i.i, %bb.y
  %i.cu = phi i32 [ %.pre.i, %_ZL19stbtt__track_vertexP12stbtt__csctxii.exit.i.i ], [ %i.co, %bb.y ]
  %i.cv = add nsw i32 %i.cu, 1
  store i32 %i.cv, ptr %.phi.trans.insert.i309, align 8, !tbaa !544
  %indvars.iv.next430 = add nuw nsw i64 %indvars.iv429, 2 ; 2 uses
  %i.cw = or disjoint i64 %indvars.iv.next430, 1
end_hunk_0
begin_hunk_1_@_ZL21stbtt__run_charstringPK14stbtt_fontinfoiP12stbtt__csctx:bb.a
  ...
  br i1 %i.mi, label %.lr.ph.split.us, label %.thread, !llvm.loop !867
...
.lr.ph.split:                                     ; preds = %.lr.ph.split.peel.next, %.lr.ph.split
  ...
  %i.mk = load float, ptr %i.mj, align 4, !tbaa !29
  %i.ml = getelementptr inbounds nuw i8, ptr %i.mj, i64 4
  %i.mm = load float, ptr %i.ml, align 4, !tbaa !29
  %i.mn = getelementptr inbounds nuw i8, ptr %i.mj, i64 8
  %i.mo = load float, ptr %i.mn, align 4, !tbaa !29
  %i.mp = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %indvars.iv
  %i.mq = load float, ptr %i.mp, align 4, !tbaa !29
  ...
  br i1 %i.ms, label %.lr.ph.split, label %.thread, !llvm.loop !868
...
bb.cx:                                            ; preds = %bb.cw
  %i.mt = load i32, ptr %i.x, align 4, !tbaa !871 ; 13 uses
  %.not266 = icmp eq i32 %i.mt, 0
  br i1 %.not266, label %bb.dh, label %bb.cy

bb.cy:                                            ; preds = %bb.cx
  %.sroa.0.0.copyload53.i = load ptr, ptr %i.y, align 8, !tbaa !412 ; 9 uses
...
_ZL15stbtt__buf_get8P10stbtt__buf.exit.i:         ; preds = %bb.cy
  ...
  %i.mx = load i8, ptr %i.mw, align 1, !tbaa !50
...
bb.cz:                                            ; preds = %_ZL15stbtt__buf_get8P10stbtt__buf.exit.thread.i
  ...
  %i.nd = load i8, ptr %i.nc, align 1, !tbaa !50
...
bb.da:                                            ; preds = %.preheader.preheader.i
  ...
  %i.ng = load i8, ptr %i.nf, align 1, !tbaa !50
...
bb.db:                                            ; preds = %_ZL15stbtt__buf_get8P10stbtt__buf.exit.i.i
  ...
  %i.nm = load i8, ptr %i.nl, align 1, !tbaa !50
...
bb.dc:                                            ; preds = %_ZL15stbtt__buf_get8P10stbtt__buf.exit.i.1.i
  ...
  %i.ns = load i8, ptr %i.nr, align 1, !tbaa !50
...
bb.dd:                                            ; preds = %_ZL15stbtt__buf_get8P10stbtt__buf.exit.i33.i
  ...
  %i.ny = load i8, ptr %i.nx, align 1, !tbaa !50
...
_ZL14stbtt__buf_getP10stbtt__bufi.exit36.i:       ; preds = %_ZL15stbtt__buf_get8P10stbtt__buf.exit.i44.1.i
  ...
  br i1 %exitcond.not.i, label %_ZL26stbtt__cid_get_glyph_subrsPK14stbtt_fontinfoi.exit, label %.lr.ph.i, !llvm.loop !869
...
bb.df:                                            ; preds = %_ZL15stbtt__buf_get8P10stbtt__buf.exit39.i
  ...
  %i.ok = load i8, ptr %i.oj, align 1, !tbaa !50
...
bb.dg:                                            ; preds = %_ZL15stbtt__buf_get8P10stbtt__buf.exit.i44.i
  ...
  %i.oq = load i8, ptr %i.op, align 1, !tbaa !50
...
_ZL15stbtt__buf_get8P10stbtt__buf.exit28.i:       ; preds = %_ZL15stbtt__buf_get8P10stbtt__buf.exit.i44.1.i, %bb.cz, %_ZL15stbtt__buf_get8P10stbtt__buf.exit.thread.i
  ...
  %.sroa.03.0.copyload.i = load ptr, ptr %i.z, align 8, !tbaa !412
  %.sroa.24.0.copyload.i = load i64, ptr %.sroa.24.0..sroa_idx.i, align 8
  %.sroa.0.0.copyload.i = load ptr, ptr %i.aa, align 8, !tbaa !412
...
bb.dh:                                            ; preds = %bb.cx, %_ZL26stbtt__cid_get_glyph_subrsPK14stbtt_fontinfoi.exit, %bb.cw, %_ZL15stbtt__buf_get8P10stbtt__buf.exit
  %.1254 = phi i32 [ 1, %bb.cw ], [ %.0253366, %_ZL15stbtt__buf_get8P10stbtt__buf.exit ], [ 1, %_ZL26stbtt__cid_get_glyph_subrsPK14stbtt_fontinfoi.exit ], [ 1, %bb.cx ]
  %.sroa.073.2 = phi ptr [ %.sroa.073.0367, %bb.cw ], [ %.sroa.073.0367, %_ZL15stbtt__buf_get8P10stbtt__buf.exit ], [ %i.oy, %_ZL26stbtt__cid_get_glyph_subrsPK14stbtt_fontinfoi.exit ], [ %.sroa.073.0367, %bb.cx ] ; 2 uses
  %.sroa.5.2 = phi i64 [ %.sroa.5.0374, %bb.cw ], [ %.sroa.5.0374, %_ZL15stbtt__buf_get8P10stbtt__buf.exit ], [ %i.oz, %_ZL26stbtt__cid_get_glyph_subrsPK14stbtt_fontinfoi.exit ], [ %.sroa.5.0374, %bb.cx ] ; 2 uses
...
bb.di:                                            ; preds = %bb.dh
  ...
  %i.pe = load float, ptr %i.pd, align 4, !tbaa !29
...
bb.dj:                                            ; preds = %bb.di
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %i.pj, ptr noundef nonnull align 8 dereferenceable(16) %4, i64 16, i1 false), !tbaa.struct !502
  %i.pk = icmp eq i8 %i.aq, 10
  br i1 %i.pk, label %.cont, label %.else

.else:                                            ; preds = %bb.dj
  %.sroa.0.0.copyload.else.val = load ptr, ptr %i.ab, align 8, !tbaa !412
  %.sroa.2.0.copyload.else.val = load i64, ptr %.sroa.gep72, align 8
  br label %.cont

.cont:                                            ; preds = %bb.dj, %.else
  %.sroa.0.0.copyload = phi ptr [ %.sroa.0.0.copyload.else.val, %.else ], [ %.sroa.073.2, %bb.dj ] ; 3 uses
  %.sroa.2.0.copyload = phi i64 [ %.sroa.2.0.copyload.else.val, %.else ], [ %.sroa.5.2, %bb.dj ] ; 2 uses
...
bb.dk:                                            ; preds = %.cont
  ...
  %i.po = load i8, ptr %i.pn, align 1, !tbaa !50
...
bb.dl:                                            ; preds = %_ZL15stbtt__buf_get8P10stbtt__buf.exit.i.i.i
  ...
  %i.pu = load i8, ptr %i.pt, align 1, !tbaa !50
...
_ZL15stbtt__get_subr10stbtt__bufi.exit:           ; preds = %_ZL22stbtt__cff_index_countP10stbtt__buf.exit.i, %bb.dm
  ...
  store ptr %i.qc, ptr %4, align 8, !tbaa !412
...
bb.dn:                                            ; preds = %_ZL15stbtt__get_subr10stbtt__bufi.exit
  store i32 0, ptr %.sroa.468.0..sroa_idx, align 8, !tbaa !503
  br label %.thread
...
bb.dp:                                            ; preds = %bb.do
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %4, ptr noundef nonnull align 16 dereferenceable(16) %i.qi, i64 16, i1 false), !tbaa.struct !502
  br label %.thread

bb.dq:                                            ; preds = %_ZL15stbtt__buf_get8P10stbtt__buf.exit
  %i.qj = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.qk = load float, ptr %i.ac, align 8, !tbaa !546
  %i.ql = load <2 x float>, ptr %i.qj, align 8, !tbaa !29 ; 3 uses
  %i.qm = extractelement <2 x float> %i.ql, i64 0
  %i.qn = fcmp une float %i.qm, %i.qk
  br i1 %i.qn, label %._crit_edge.i, label %bb.dr

bb.dr:                                            ; preds = %bb.dq
  %i.qo = load float, ptr %i.ad, align 4, !tbaa !547
...
bb.ed:                                            ; preds = %bb.ec, %bb.eb
  store i32 %i.qy, ptr %i.ai, align 8, !tbaa !543
...
_ZL19stbtt__track_vertexP12stbtt__csctxii.exit.i.i325: ; preds = %bb.ed, %bb.ec
  store i32 1, ptr %i.af, align 4, !tbaa !540
  %.pre8.i = load i32, ptr %.phi.trans.insert.i309, align 8, !tbaa !544
  br label %_ZL14stbtt__csctx_vP12stbtt__csctxhiiiiii.exit.i

bb.ee:                                            ; preds = %._crit_edge.i
  %i.rh = load ptr, ptr %i.aj, align 8, !tbaa !545
  %i.ri = load i32, ptr %.phi.trans.insert.i309, align 8, !tbaa !544 ; 2 uses
  ...
  store i8 2, ptr %i.rl, align 2, !tbaa !514
  %i.rm = trunc <2 x i32> %i.qr to <2 x i16>
  store <2 x i16> %i.rm, ptr %i.rk, align 2, !tbaa !243
...
_ZL14stbtt__csctx_vP12stbtt__csctxhiiiiii.exit.i: ; preds = %bb.ee, %_ZL19stbtt__track_vertexP12stbtt__csctxii.exit.i.i325
  ...
  store i32 %i.rp, ptr %.phi.trans.insert.i309, align 8, !tbaa !544
  br label %.critedge
...
_ZL15stbtt__buf_get8P10stbtt__buf.exit328:        ; preds = %bb.ef
  ...
  store i32 %i.rq, ptr %.sroa.468.0..sroa_idx, align 8, !tbaa !503
...
bb.eh:                                            ; preds = %bb.eg
  %i.rv = load float, ptr %i.a, align 16, !tbaa !29
  %i.rw = load float, ptr %i.m, align 4, !tbaa !29
  %i.rx = load float, ptr %i.n, align 8, !tbaa !29 ; 2 uses
  %i.ry = load float, ptr %i.o, align 4, !tbaa !29
  %i.rz = load float, ptr %i.p, align 16, !tbaa !29
  %i.sa = load float, ptr %i.q, align 4, !tbaa !29
  %i.sb = load float, ptr %i.r, align 8, !tbaa !29
...
bb.ej:                                            ; preds = %bb.ei
  %i.se = load float, ptr %i.a, align 16, !tbaa !29
  %i.sf = load float, ptr %i.m, align 4, !tbaa !29
  %i.sg = load float, ptr %i.n, align 8, !tbaa !29
  %i.sh = load float, ptr %i.o, align 4, !tbaa !29
  %i.si = load float, ptr %i.p, align 16, !tbaa !29
  %i.sj = load float, ptr %i.q, align 4, !tbaa !29
  %i.sk = load float, ptr %i.r, align 8, !tbaa !29
  %i.sl = load float, ptr %i.s, align 4, !tbaa !29
  %i.sm = load float, ptr %i.t, align 16, !tbaa !29
  %i.sn = load float, ptr %i.u, align 4, !tbaa !29
  %i.so = load float, ptr %i.v, align 8, !tbaa !29
  %i.sp = load float, ptr %i.w, align 4, !tbaa !29
...
bb.el:                                            ; preds = %bb.ek
  %i.sr = load float, ptr %i.a, align 16, !tbaa !29
  %i.ss = load float, ptr %i.m, align 4, !tbaa !29 ; 2 uses
  %i.st = load float, ptr %i.n, align 8, !tbaa !29
  %i.su = load float, ptr %i.o, align 4, !tbaa !29 ; 2 uses
  %i.sv = load float, ptr %i.p, align 16, !tbaa !29
  %i.sw = load float, ptr %i.q, align 4, !tbaa !29
  %i.sx = load float, ptr %i.r, align 8, !tbaa !29
  %i.sy = load float, ptr %i.s, align 4, !tbaa !29 ; 2 uses
  %i.sz = load float, ptr %i.t, align 16, !tbaa !29
...
bb.en:                                            ; preds = %bb.em
  %i.te = load float, ptr %i.v, align 8, !tbaa !29 ; 2 uses
  %i.tf = load <2 x float>, ptr %i.a, align 16, !tbaa !29 ; 3 uses
  %i.tg = load <2 x float>, ptr %i.n, align 8, !tbaa !29 ; 3 uses
  %i.th = load <2 x float>, ptr %i.p, align 16, !tbaa !29 ; 3 uses
  %i.ti = load <2 x float>, ptr %i.r, align 8, !tbaa !29 ; 3 uses
  %i.tj = load <2 x float>, ptr %i.t, align 16, !tbaa !29 ; 3 uses
...
bb.er:                                            ; preds = %bb.eq
  ...
  %i.ul = load i8, ptr %i.uk, align 1, !tbaa !50
...
bb.es:                                            ; preds = %_ZL15stbtt__buf_get8P10stbtt__buf.exit.i331
  ...
  %i.us = load i8, ptr %i.ur, align 1, !tbaa !50
...
bb.et:                                            ; preds = %_ZL15stbtt__buf_get8P10stbtt__buf.exit.i331.1
  ...
  %i.va = load i8, ptr %i.uz, align 1, !tbaa !50
...
bb.eu:                                            ; preds = %_ZL15stbtt__buf_get8P10stbtt__buf.exit.i331.2
  ...
  %i.vi = load i8, ptr %i.vh, align 1, !tbaa !50
...
bb.ev:                                            ; preds = %bb.ep
  ...
  store i32 %..i.i334, ptr %.sroa.468.0..sroa_idx, align 8, !tbaa !503
...
bb.ex:                                            ; preds = %bb.ew
  ...
  store float %.2251, ptr %i.vw, align 4, !tbaa !29
  br label %.thread
...
.thread:                                          ; preds = %.lr.ph.split, %.lr.ph.split.us, %.preheader348, %_ZL21stbtt__csctx_rline_toP12stbtt__csctxff.exit, %.lr.ph.split.preheader, %.lr.ph.split.us.preheader, %bb.cv, %bb.en, %bb.el, %bb.ej, %bb.eh, %bb.ct, %_ZL21stbtt__csctx_rline_toP12stbtt__csctxff.exit302, %bb.bh, %bb.bl, %bb.ab, %bb.aq, %bb.k, %bb.i, %bb.g, %bb.e, %bb.d, %bb.ex, %bb.dp, %bb.dn
  %.1235347 = phi i32 [ %.0234373, %bb.dp ], [ %.0234373, %bb.ex ], [ %.0234373, %bb.dn ], [ %.0234373, %bb.en ], [ %.0234373, %bb.el ], [ %.0234373, %bb.ej ], [ %.0234373, %bb.eh ], [ %.0234373, %bb.cv ], [ %.0234373, %bb.ct ], [ %.0234373, %_ZL21stbtt__csctx_rline_toP12stbtt__csctxff.exit302 ], [ %.0234373, %.lr.ph.split.us.preheader ], [ %.0234373, %bb.bh ], [ %.0234373, %bb.bl ], [ %.0234373, %bb.ab ], [ %.0234373, %bb.aq ], [ 0, %bb.d ], [ 0, %bb.k ], [ 0, %bb.i ], [ 0, %bb.g ], [ %.0234373, %bb.e ], [ %.0234373, %.lr.ph.split.preheader ], [ %.0234373, %.preheader348 ], [ %.0234373, %.lr.ph.split.us ], [ %.0234373, %_ZL21stbtt__csctx_rline_toP12stbtt__csctxff.exit ], [ %.0234373, %.lr.ph.split ]
  %.2238346 = phi i32 [ %.0236372, %bb.dp ], [ %.0236372, %bb.ex ], [ %.0236372, %bb.dn ], [ %.0236372, %bb.en ], [ %.0236372, %bb.el ], [ %.0236372, %bb.ej ], [ %.0236372, %bb.eh ], [ %.0236372, %bb.cv ], [ %.0236372, %bb.ct ], [ %.0236372, %_ZL21stbtt__csctx_rline_toP12stbtt__csctxff.exit302 ], [ %.0236372, %.lr.ph.split.us.preheader ], [ %.0236372, %bb.bh ], [ %.0236372, %bb.bl ], [ %.0236372, %bb.ab ], [ %.0236372, %bb.aq ], [ %.1237, %bb.d ], [ %.0236372, %bb.k ], [ %.0236372, %bb.i ], [ %.0236372, %bb.g ], [ %i.az, %bb.e ], [ %.0236372, %.lr.ph.split.preheader ], [ %.0236372, %.preheader348 ], [ %.0236372, %.lr.ph.split.us ], [ %.0236372, %_ZL21stbtt__csctx_rline_toP12stbtt__csctxff.exit ], [ %.0236372, %.lr.ph.split ]
  %.1240345 = phi i32 [ %i.qg, %bb.dp ], [ %.0239371, %bb.ex ], [ %i.ph, %bb.dn ], [ %.0239371, %bb.en ], [ %.0239371, %bb.el ], [ %.0239371, %bb.ej ], [ %.0239371, %bb.eh ], [ %.0239371, %bb.cv ], [ %.0239371, %bb.ct ], [ %.0239371, %_ZL21stbtt__csctx_rline_toP12stbtt__csctxff.exit302 ], [ %.0239371, %.lr.ph.split.us.preheader ], [ %.0239371, %bb.bh ], [ %.0239371, %bb.bl ], [ %.0239371, %bb.ab ], [ %.0239371, %bb.aq ], [ %.0239371, %bb.d ], [ %.0239371, %bb.k ], [ %.0239371, %bb.i ], [ %.0239371, %bb.g ], [ %.0239371, %bb.e ], [ %.0239371, %.lr.ph.split.preheader ], [ %.0239371, %.preheader348 ], [ %.0239371, %.lr.ph.split.us ], [ %.0239371, %_ZL21stbtt__csctx_rline_toP12stbtt__csctxff.exit ], [ %.0239371, %.lr.ph.split ]
  %.sroa.5.3350 = phi i64 [ %.sroa.5.0374, %bb.dp ], [ %.sroa.5.0374, %bb.ex ], [ %.sroa.5.2, %bb.dn ], [ %.sroa.5.0374, %bb.en ], [ %.sroa.5.0374, %bb.el ], [ %.sroa.5.0374, %bb.ej ], [ %.sroa.5.0374, %bb.eh ], [ %.sroa.5.0374, %bb.cv ], [ %.sroa.5.0374, %bb.ct ], [ %.sroa.5.0374, %_ZL21stbtt__csctx_rline_toP12stbtt__csctxff.exit302 ], [ %.sroa.5.0374, %.lr.ph.split.us.preheader ], [ %.sroa.5.0374, %bb.bh ], [ %.sroa.5.0374, %bb.bl ], [ %.sroa.5.0374, %bb.ab ], [ %.sroa.5.0374, %bb.aq ], [ %.sroa.5.0374, %bb.d ], [ %.sroa.5.0374, %bb.k ], [ %.sroa.5.0374, %bb.i ], [ %.sroa.5.0374, %bb.g ], [ %.sroa.5.0374, %bb.e ], [ %.sroa.5.0374, %.lr.ph.split.preheader ], [ %.sroa.5.0374, %.preheader348 ], [ %.sroa.5.0374, %.lr.ph.split.us ], [ %.sroa.5.0374, %_ZL21stbtt__csctx_rline_toP12stbtt__csctxff.exit ], [ %.sroa.5.0374, %.lr.ph.split ]
  %.sroa.073.3344 = phi ptr [ %.sroa.073.0367, %bb.dp ], [ %.sroa.073.0367, %bb.ex ], [ %.sroa.073.2, %bb.dn ], [ %.sroa.073.0367, %bb.en ], [ %.sroa.073.0367, %bb.el ], [ %.sroa.073.0367, %bb.ej ], [ %.sroa.073.0367, %bb.eh ], [ %.sroa.073.0367, %bb.cv ], [ %.sroa.073.0367, %bb.ct ], [ %.sroa.073.0367, %_ZL21stbtt__csctx_rline_toP12stbtt__csctxff.exit302 ], [ %.sroa.073.0367, %.lr.ph.split.us.preheader ], [ %.sroa.073.0367, %bb.bh ], [ %.sroa.073.0367, %bb.bl ], [ %.sroa.073.0367, %bb.ab ], [ %.sroa.073.0367, %bb.aq ], [ %.sroa.073.0367, %bb.d ], [ %.sroa.073.0367, %bb.k ], [ %.sroa.073.0367, %bb.i ], [ %.sroa.073.0367, %bb.g ], [ %.sroa.073.0367, %bb.e ], [ %.sroa.073.0367, %.lr.ph.split.preheader ], [ %.sroa.073.0367, %.preheader348 ], [ %.sroa.073.0367, %.lr.ph.split.us ], [ %.sroa.073.0367, %_ZL21stbtt__csctx_rline_toP12stbtt__csctxff.exit ], [ %.sroa.073.0367, %.lr.ph.split ]
  %.2255343 = phi i32 [ %.0253366, %bb.dp ], [ %.0253366, %bb.ex ], [ %.1254, %bb.dn ], [ %.0253366, %bb.en ], [ %.0253366, %bb.el ], [ %.0253366, %bb.ej ], [ %.0253366, %bb.eh ], [ %.0253366, %bb.cv ], [ %.0253366, %bb.ct ], [ %.0253366, %_ZL21stbtt__csctx_rline_toP12stbtt__csctxff.exit302 ], [ %.0253366, %.lr.ph.split.us.preheader ], [ %.0253366, %bb.bh ], [ %.0253366, %bb.bl ], [ %.0253366, %bb.ab ], [ %.0253366, %bb.aq ], [ %.0253366, %bb.d ], [ %.0253366, %bb.k ], [ %.0253366, %bb.i ], [ %.0253366, %bb.g ], [ %.0253366, %bb.e ], [ %.0253366, %.lr.ph.split.preheader ], [ %.0253366, %.preheader348 ], [ %.0253366, %.lr.ph.split.us ], [ %.0253366, %_ZL21stbtt__csctx_rline_toP12stbtt__csctxff.exit ], [ %.0253366, %.lr.ph.split ]
  %i.vx = phi i32 [ %.0242368, %bb.dp ], [ %i.vu, %bb.ex ], [ %i.pb, %bb.dn ], [ 0, %bb.en ], [ 0, %bb.el ], [ 0, %bb.ej ], [ 0, %bb.eh ], [ 0, %bb.cv ], [ 0, %bb.ct ], [ 0, %_ZL21stbtt__csctx_rline_toP12stbtt__csctxff.exit302 ], [ 0, %.lr.ph.split.us.preheader ], [ 0, %bb.bh ], [ 0, %bb.bl ], [ 0, %bb.ab ], [ 0, %bb.aq ], [ 0, %bb.d ], [ 0, %bb.k ], [ 0, %bb.i ], [ 0, %bb.g ], [ 0, %bb.e ], [ 0, %.lr.ph.split.preheader ], [ 0, %.preheader348 ], [ 0, %.lr.ph.split.us ], [ 0, %_ZL21stbtt__csctx_rline_toP12stbtt__csctxff.exit ], [ 0, %.lr.ph.split ]
  %i.vy = load i32, ptr %.sroa.468.0..sroa_idx, align 8, !tbaa !503 ; 2 uses
  %i.vz = load i32, ptr %i.h, align 4, !tbaa !504 ; 2 uses
...
bb.a:
  ...
  %i.c = load float, ptr %i.b, align 8, !tbaa !546 ; 3 uses
  %.phi.trans.insert.i = getelementptr inbounds nuw i8, ptr %0, i64 12
  %i.d = load <2 x float>, ptr %i.a, align 8, !tbaa !29 ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.h = load float, ptr %i.g, align 4, !tbaa !547 ; 2 uses
...
_ZL14stbtt__csctx_vP12stbtt__csctxhiiiiii.exit.i: ; preds = %bb.o, %_ZL19stbtt__track_vertexP12stbtt__csctxii.exit.i.i
  ...
  store i32 %i.au, ptr %i.at, align 8, !tbaa !544
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %0, i64 20
  %.pre13 = load float, ptr %.phi.trans.insert, align 4, !tbaa !547
...
_ZL24stbtt__csctx_close_shapeP12stbtt__csctx.exit: ; preds = %bb.b, %_ZL14stbtt__csctx_vP12stbtt__csctxhiiiiii.exit.i
  ...
  store float %i.ax, ptr %i.b, align 8, !tbaa !546
  store float %i.ax, ptr %i.a, align 8, !tbaa !872
  %i.ay = getelementptr inbounds nuw i8, ptr %0, i64 20
  %i.az = fadd float %2, %i.av                    ; 3 uses
  store float %i.az, ptr %i.ay, align 4, !tbaa !547
  store float %i.az, ptr %.phi.trans.insert.i, align 4, !tbaa !873
  %i.ba = fptosi float %i.ax to i32               ; 5 uses
  %i.bb = fptosi float %i.az to i32               ; 5 uses
  %i.bc = load i32, ptr %0, align 8, !tbaa !538
