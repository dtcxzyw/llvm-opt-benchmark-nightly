...
bb.a:
  ...
  %4 = fmul float %i.a, 2.000000e+00
  %5 = fmul float %3, %4
  %6 = fmul float %i.a, %i.a
  %7 = fmul float %3, %3
  ...
  %i.g = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> zeroinitializer
...
bb.d:                                             ; preds = %.lr.ph, %_ZN8ImVectorI6ImVec2E9push_backERKS0_.exit
  ...
  %5 = fmul float %i.ad, %i.ah
  %6 = fmul float %i.ae, %i.af
  %7 = fmul float %i.ad, %i.ai
  %8 = fmul float %i.ad, %i.aj
  %9 = load <2 x float>, ptr %1, align 4, !tbaa !29
  ...
  %i.ak = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> %i.h, <2 x float> %12)
  %i.al = load <2 x float>, ptr %2, align 4, !tbaa !29
  %15 = insertelement <2 x float> poison, float %7, i64 0
  %16 = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> zeroinitializer
  %i.am = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %16, <2 x float> %i.al, <2 x float> %i.ak)
  %i.an = load <2 x float>, ptr %3, align 4, !tbaa !29
  %17 = insertelement <2 x float> poison, float %8, i64 0
  %i.ao = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> zeroinitializer
...
bb.cm:                                            ; preds = %bb.cl, %bb.ck
  ...
  %7 = insertelement <2 x i32> poison, i32 %.pre-phi480.i.i.i.i.i.i, i64 0
  %8 = insertelement <2 x i32> %7, i32 %i.xf, i64 1
  %9 = sitofp <2 x i32> %8 to <2 x float>         ; 3 uses
  ...
  %i.xs = fsub nnan float %10, %.1308.i.i.i.i.i.i
...
._crit_edge.i.i.i.i.i.i:                          ; preds = %.prol.loopexit, %.lr.ph472.i.i.i.i.i.i.new, %bb.co
  ...
  %i.ze = fadd float %11, 1.000000e+00            ; 2 uses
  %i.zf = fsub nnan float %i.ze, %11
