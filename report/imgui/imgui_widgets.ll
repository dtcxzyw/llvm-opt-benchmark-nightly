...
.thread:                                          ; preds = %bb.d, %bb.c
  %.0117132 = phi float [ %i.x, %bb.d ], [ 1.000000e+00, %bb.c ] ; 2 uses
  %i.z = fcmp oge float %.0117132, 1.000000e+00
...
.split.us:                                        ; preds = %bb.c, %bb.g
  %.052.us = phi i32 [ %i.aw, %bb.g ], [ 0, %bb.c ] ; 6 uses
  %.0.us = phi i32 [ %.052.us, %bb.g ], [ 0, %bb.c ] ; 2 uses
  ...
  %i.aw = add nsw i32 %.052.us, %i.av             ; 5 uses
...
.split:                                           ; preds = %bb.c, %.split.backedge
  ...
  %.052 = phi i32 [ %i.cd, %.split.backedge ], [ 0, %bb.c ] ; 7 uses
  %.0 = phi i32 [ %.052, %.split.backedge ], [ 0, %bb.c ] ; 3 uses
  %i.bl = load ptr, ptr %i.y, align 8, !tbaa !476 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #41
  store ptr null, ptr %i.c, align 8, !tbaa !182
  %i.bm = load ptr, ptr %1, align 8, !tbaa !576   ; 3 uses
  %i.bn = sext i32 %.052 to i64
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #41
  %i.cd = add nsw i32 %.052, %i.cc                ; 5 uses
...
.split74.us:                                      ; preds = %.split.us, %bb.f, %bb.g, %.split, %bb.j, %bb.l, %bb.m
  ...
  %.us-phi77 = phi i32 [ %.052, %.split ], [ %.val.fr, %bb.m ], [ %.052, %bb.l ], [ %.052, %bb.j ], [ %.val.fr, %bb.g ], [ %.052.us, %.split.us ], [ %.052.us, %bb.f ] ; 5 uses
  %.us-phi78 = phi i32 [ %.0, %.split ], [ %.052, %bb.m ], [ %.0, %bb.l ], [ %.0, %bb.j ], [ %.052.us, %bb.g ], [ %.0.us, %.split.us ], [ %.0.us, %bb.f ]
  %i.cw = getelementptr inbounds nuw i8, ptr %0, i64 12
  store i32 %.us-phi77, ptr %i.cw, align 4, !tbaa !573
  ...
  store i32 %.us-phi78, ptr %i.cz, align 4, !tbaa !578
  store float 0.000000e+00, ptr %0, align 4, !tbaa !911
  %i.da = icmp slt i32 %.us-phi77, %2
  br i1 %i.da, label %.lr.ph, label %.loopexit

.lr.ph:                                           ; preds = %.split74.us
  %i.db = sext i32 %.us-phi77 to i64
  br label %bb.n

bb.n:                                             ; preds = %.lr.ph, %_ZN5ImStbL36IMSTB_TEXTEDIT_GETNEXTCHARINDEX_IMPLEP19ImGuiInputTextStatei.exit
  %i.dc = phi i32 [ %.us-phi77, %.lr.ph ], [ %.0.i67, %_ZN5ImStbL36IMSTB_TEXTEDIT_GETNEXTCHARINDEX_IMPLEP19ImGuiInputTextStatei.exit ] ; 3 uses
...
_ZN5ImStbL36IMSTB_TEXTEDIT_GETNEXTCHARINDEX_IMPLEP19ImGuiInputTextStatei.exit: ; preds = %bb.p, %bb.q
  ...
  %i.eh = sub nsw i32 %.0.i67, %.us-phi77
...
bb.d:                                             ; preds = %bb.c, %bb.i
  %.0519 = phi ptr [ %i.i, %bb.c ], [ %i.af, %bb.i ] ; 3 uses
  %i.s = load ptr, ptr %i.o, align 8, !tbaa !477
  %i.t = load float, ptr %i.p, align 8, !tbaa !189
  %i.u = load float, ptr %i.a, align 8, !tbaa !490
  %i.v = tail call noundef ptr @_Z28ImFontCalcWordWrapPositionExP6ImFontfPKcS2_fi(ptr noundef %i.s, float noundef %i.t, ptr noundef %.0519, ptr noundef %i.n, float noundef %i.u, i32 noundef 2) ; 4 uses
  %i.w = icmp eq ptr %.0519, %i.h
...
bb.j:                                             ; preds = %_ZN5ImStbL36IMSTB_TEXTEDIT_GETPREVCHARINDEX_IMPLEP19ImGuiInputTextStatei.exit, %.thread4
  %.048 = phi i32 [ %1, %.thread4 ], [ %i.aq, %_ZN5ImStbL36IMSTB_TEXTEDIT_GETPREVCHARINDEX_IMPLEP19ImGuiInputTextStatei.exit ] ; 4 uses
  %i.ah = icmp sgt i32 %.048, 0
...
.loopexit.sink.split:                             ; preds = %bb.h, %bb.g, %bb.d
  %.0519.lcssa16.sink = phi ptr [ %i.i, %bb.g ], [ %i.i, %bb.d ], [ %.0519, %bb.h ]
  %i.av = load ptr, ptr %i.e, align 8, !tbaa !476
  %i.aw = ptrtoint ptr %.0519.lcssa16.sink to i64
...
.loopexit:                                        ; preds = %_ZN5ImStbL36IMSTB_TEXTEDIT_GETPREVCHARINDEX_IMPLEP19ImGuiInputTextStatei.exit, %bb.j, %.loopexit.sink.split, %bb.a
  %.3 = phi i32 [ %i.az, %.loopexit.sink.split ], [ 0, %bb.a ], [ %.048, %bb.j ], [ %.048, %_ZN5ImStbL36IMSTB_TEXTEDIT_GETPREVCHARINDEX_IMPLEP19ImGuiInputTextStatei.exit ]
  ret i32 %.3
}
...
bb.d:                                             ; preds = %.lr.ph, %bb.g
  %.04315 = phi ptr [ %i.k, %.lr.ph ], [ %i.ac, %bb.g ]
  %i.t = load ptr, ptr %i.q, align 8, !tbaa !477
  %i.u = load float, ptr %i.r, align 8, !tbaa !189
  %i.v = load float, ptr %i.c, align 8, !tbaa !490
  %i.w = tail call noundef ptr @_Z28ImFontCalcWordWrapPositionExP6ImFontfPKcS2_fi(ptr noundef %i.t, float noundef %i.u, ptr noundef %.04315, ptr noundef nonnull %i.o, float noundef %i.v, i32 noundef 2) ; 6 uses
