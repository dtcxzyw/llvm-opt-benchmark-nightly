...
.preheader.lr.ph:                                 ; preds = %bb.a
  ...
  %.lhs.trunc105 = mul nuw i16 %i.bg, 223         ; 2 uses
  %6 = udiv i16 %.lhs.trunc105, 255
  %.zext106 = zext nneg i16 %6 to i32
  %i.bh = trunc nuw i32 %4 to i16
  %i.bi = and i16 %i.bh, 255
  %.lhs.trunc107 = mul nuw i16 %i.bi, 223         ; 2 uses
  %7 = trunc nuw nsw i32 %5 to i16
  %8 = mul nuw i16 %7, 223
  %.lhs.trunc109 = add nuw i16 %8, 2048
  %9 = shl nuw nsw i32 %.zext106, 8
  %.lhs.trunc97 = add nuw i16 %.lhs.trunc105, 6144
  %.lhs.trunc99 = add nuw i16 %.lhs.trunc107, 8160
  %10 = insertelement <4 x i16> poison, i16 %.lhs.trunc107, i64 0
  %11 = insertelement <4 x i16> %10, i16 %.lhs.trunc109, i64 1
  %12 = insertelement <4 x i16> %11, i16 %.lhs.trunc97, i64 2
  %13 = insertelement <4 x i16> %12, i16 %.lhs.trunc99, i64 3
  %i.bj = udiv <4 x i16> %13, splat (i16 255)     ; 4 uses
  %i.bk = extractelement <4 x i16> %i.bj, i64 0
  %.zext108 = zext nneg i16 %i.bk to i32
  %i.bl = extractelement <4 x i16> %i.bj, i64 1
  ...
  %i.br = extractelement <4 x i16> %i.bj, i64 2
  %.zext100.a = zext nneg i16 %i.br to i32
  %14 = extractelement <4 x i16> %i.bj, i64 3
  %.zext100 = zext nneg i16 %14 to i32
  %15 = shl nuw nsw i32 %.zext100.a, 8
  %16 = shl nuw nsw i32 %.zext100, 16
  %17 = or i32 %15, %16
  %18 = or i32 %17, %.zext104
  %19 = or i32 %18, %i.bp
  %20 = bitcast i32 %i.j to <4 x i8>
  %21 = zext <4 x i8> %20 to <4 x i32>
  %22 = mul nuw nsw <4 x i32> %21, splat (i32 223)
...
bb.e:                                             ; preds = %bb.c
  ...
  %i.ct = shl i32 %i.cp, 5
  %23 = insertelement <4 x i32> poison, i32 %i.ct, i64 0
  %24 = insertelement <4 x i32> %23, i32 %i.cs, i64 1
  %25 = insertelement <4 x i32> %24, i32 %i.cr, i64 2
  %26 = insertelement <4 x i32> %25, i32 %i.cq, i64 3
  %27 = and <4 x i32> %26, splat (i32 8160)
  %28 = add nuw nsw <4 x i32> %27, %22
  %29 = trunc <4 x i32> %28 to <4 x i16>
  %i.cu = udiv <4 x i16> %29, splat (i16 255)
...
bb.f:                                             ; preds = %bb.c, %bb.d, %bb.e
  %.0 = phi i32 [ %i.cx, %bb.e ], [ %i.bq, %bb.d ], [ %19, %bb.c ] ; 4 uses
...
.preheader.lr.ph:                                 ; preds = %bb.a
  ...
  %i.be = and i32 %6, 255
  %7 = lshr i32 %i.j, 24
  %i.bf = mul nuw nsw i32 %4, 63
  %i.bg = mul nuw nsw i32 %5, 63
  %i.bh = mul nuw nsw i32 %i.be, 63
  %i.bi = mul nuw nsw i32 %7, 63
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.cf = and i32 %10, 255
  %11 = lshr i32 %i.cd, 24
  %i.cg = mul nuw nsw i32 %11, 192
  %i.ch = mul nuw nsw i32 %i.cf, 192
  %i.ci = mul nuw nsw i32 %9, 192
  %i.cj = mul nuw nsw i32 %8, 192
