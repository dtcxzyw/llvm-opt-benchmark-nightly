...
.preheader.lr.ph:                                 ; preds = %bb.a
  ...
  %5 = and i16 %i.bj, 255
  %i.bk = trunc nuw nsw i32 %i.bg to i16
  %6 = insertelement <4 x i16> poison, i16 %4, i64 0
  %7 = insertelement <4 x i16> %6, i16 %5, i64 1
  %8 = insertelement <4 x i16> %7, i16 %i.bk, i64 2
  %9 = mul nuw <4 x i16> %8, <i16 223, i16 223, i16 223, i16 poison> ; 2 uses
  %10 = shufflevector <4 x i16> %9, <4 x i16> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 1>
  %i.bl = extractelement <4 x i16> %9, i64 0
  %i.bm = udiv i16 %i.bl, 255
  %.zext106 = zext nneg i16 %i.bm to i32
  %i.bn = shl nuw nsw i32 %.zext106, 8
  %11 = add nuw <4 x i16> %10, <i16 6144, i16 0, i16 2048, i16 8160>
  %12 = udiv <4 x i16> %11, splat (i16 255)       ; 4 uses
  %13 = extractelement <4 x i16> %12, i64 0
  %.zext98 = zext nneg i16 %13 to i32
  %14 = shl nuw nsw i32 %.zext98, 8
  %i.bo = extractelement <4 x i16> %12, i64 1
  %.zext108 = zext nneg i16 %i.bo to i32
  %i.bp = extractelement <4 x i16> %12, i64 2
  ...
  %i.bv = extractelement <4 x i16> %12, i64 3
