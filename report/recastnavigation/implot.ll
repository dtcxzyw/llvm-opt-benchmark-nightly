...
bb.by:                                            ; preds = %.lr.ph1095, %bb.cn
  ...
  %i.ot = getelementptr inbounds nuw [32 x i8], ptr %i.os, i64 %indvars.iv1147 ; 10 uses
...
bb.cm:                                            ; preds = %bb.cl, %bb.ck
  ...
  %50 = load <2 x float>, ptr %i.ot, align 4, !tbaa !41 ; 2 uses
  ...
  %i.qv = fsub <2 x float> %51, %i.qu             ; 2 uses
  %52 = shufflevector <2 x float> %50, <2 x float> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %53 = shufflevector <4 x float> %i.qt, <4 x float> %i.qr, <2 x i32> <i32 1, i32 5>
  %i.qw = fsub <2 x float> %52, %53               ; 2 uses
