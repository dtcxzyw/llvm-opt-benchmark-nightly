...
bb.ay:                                            ; preds = %bb.ax, %bb.aw
  ...
  %i.nb = fmul float %i.gy, %i.na                 ; 3 uses
  ...
  %37 = load float, ptr getelementptr inbounds nuw (i8, ptr @app, i64 720), align 8, !tbaa !86
  %38 = call float @llvm.fmuladd.f32(float %i.nb, float %i.ni, float %37)
  %i.nj = load double, ptr %i.bx, align 16, !tbaa !382
  %39 = fptrunc double %i.nj to float
  %i.nk = load double, ptr %i.by, align 16, !tbaa !382
  %40 = load double, ptr %i.bz, align 16, !tbaa !382
  ...
  %i.np = load float, ptr getelementptr inbounds nuw (i8, ptr @app, i64 724), align 4, !tbaa !86
  %i.nq = call float @llvm.fmuladd.f32(float %i.nb, float %39, float %i.np)
  %i.nr = load float, ptr getelementptr inbounds nuw (i8, ptr @app, i64 768), align 8, !tbaa !388
  %42 = load float, ptr getelementptr inbounds nuw (i8, ptr @app, i64 764), align 4, !tbaa !387
  %43 = fmul float %i.mw, %i.ne
  %44 = fsub float %42, %i.nr
  %45 = fmul float %i.mw, %44
  %46 = call float @llvm.fmuladd.f32(float %43, float %i.gy, float %i.ng) ; 3 uses
  %47 = call float @llvm.fmuladd.f32(float %46, float %41, float %38)
  ...
  %i.nu = insertelement <2 x float> poison, float %46, i64 0
  %48 = insertelement <2 x float> %i.nu, float %i.nb, i64 1
  %49 = insertelement <2 x float> poison, float %i.nq, i64 0
  %50 = insertelement <2 x float> %49, float %i.no, i64 1
  %51 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %48, <2 x float> %i.nt, <2 x float> %50)
  %i.nv = insertelement <2 x float> poison, float %45, i64 0
  %i.nw = insertelement <2 x float> %i.nv, float %46, i64 1
  %i.nx = insertelement <2 x float> poison, float %i.gy, i64 0
  %i.ny = insertelement <2 x float> %i.nx, float %i.nn, i64 1
  %i.nz = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.nw, <2 x float> %i.ny, <2 x float> %51)
