...
.preheader.lr.ph:                                 ; preds = %bb.a
  ...
  %.lhs.trunc102 = mul nuw i16 %i.as, 223         ; 2 uses
  %5 = udiv i16 %.lhs.trunc102, 255
  %.zext103 = zext nneg i16 %5 to i32
  %i.at = trunc nuw i32 %3 to i16
  %i.au = and i16 %i.at, 255
  %.lhs.trunc104 = mul nuw i16 %i.au, 223         ; 2 uses
  %6 = trunc nuw nsw i32 %4 to i16
  %7 = mul nuw i16 %6, 223
  %.lhs.trunc106 = add nuw i16 %7, 2048
  %8 = shl nuw nsw i32 %.zext103, 8
  %.lhs.trunc94 = add nuw i16 %.lhs.trunc102, 6144
  %.lhs.trunc96 = add nuw i16 %.lhs.trunc104, 8160
  %9 = insertelement <4 x i16> poison, i16 %.lhs.trunc104, i64 0
  %10 = insertelement <4 x i16> %9, i16 %.lhs.trunc106, i64 1
  %11 = insertelement <4 x i16> %10, i16 %.lhs.trunc94, i64 2
  %12 = insertelement <4 x i16> %11, i16 %.lhs.trunc96, i64 3
  %i.av = udiv <4 x i16> %12, splat (i16 255)     ; 4 uses
  %i.aw = extractelement <4 x i16> %i.av, i64 0
  %.zext105 = zext nneg i16 %i.aw to i32
  %i.ax = extractelement <4 x i16> %i.av, i64 1
  ...
  %i.bd = extractelement <4 x i16> %i.av, i64 2
  %.zext97.a = zext nneg i16 %i.bd to i32
  %13 = extractelement <4 x i16> %i.av, i64 3
  %.zext97 = zext nneg i16 %13 to i32
  %14 = shl nuw nsw i32 %.zext97.a, 8
  %15 = shl nuw nsw i32 %.zext97, 16
  %16 = or i32 %14, %15
  %17 = or i32 %16, %.zext101
  %18 = or i32 %17, %i.bb
  %19 = bitcast i32 %i.j to <4 x i8>
  %20 = zext <4 x i8> %19 to <4 x i32>
  %21 = mul nuw nsw <4 x i32> %20, splat (i32 223)
...
bb.l:                                             ; preds = %bb.j
  ...
  %i.gn = shl i32 %i.gj, 5
  %22 = insertelement <4 x i32> poison, i32 %i.gn, i64 0
  %23 = insertelement <4 x i32> %22, i32 %i.gm, i64 1
  %24 = insertelement <4 x i32> %23, i32 %i.gl, i64 2
  %25 = insertelement <4 x i32> %24, i32 %i.gk, i64 3
  %26 = and <4 x i32> %25, splat (i32 8160)
  %27 = add nuw nsw <4 x i32> %26, %21
  %28 = trunc <4 x i32> %27 to <4 x i16>
  %i.go = udiv <4 x i16> %28, splat (i16 255)
...
bb.m:                                             ; preds = %bb.j, %bb.k, %bb.l
  %.0 = phi i32 [ %i.gr, %bb.l ], [ %i.bc, %bb.k ], [ %18, %bb.j ] ; 4 uses
