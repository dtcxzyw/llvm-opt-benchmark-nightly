...
.preheader.lr.ph:                                 ; preds = %bb.a
  ...
  %i.au = lshr i32 %i.j, 8                        ; 2 uses
  %i.av = trunc nuw nsw i32 %i.as to i16
  %3 = mul nuw i16 %i.av, 223
  %.lhs.trunc106 = add nuw i16 %3, 2048
  %i.aw = trunc nuw i32 %i.at to i16
  %4 = trunc i32 %i.au to i16
  %5 = insertelement <2 x i16> poison, i16 %4, i64 0
  %6 = insertelement <2 x i16> %5, i16 %i.aw, i64 1
  %7 = and <2 x i16> %6, splat (i16 255)
  %8 = mul nuw <2 x i16> %7, splat (i16 223)      ; 3 uses
  %i.ax = extractelement <2 x i16> %8, i64 0
  %i.ay = udiv i16 %i.ax, 255
  %.zext103 = zext nneg i16 %i.ay to i32
  %i.az = shl nuw nsw i32 %.zext103, 8
  %9 = add nuw <2 x i16> %8, <i16 6144, i16 8160>
  %10 = shufflevector <2 x i16> %9, <2 x i16> %8, <4 x i32> <i32 3, i32 poison, i32 0, i32 1>
  %11 = insertelement <4 x i16> %10, i16 %.lhs.trunc106, i64 1
  %12 = udiv <4 x i16> %11, splat (i16 255)       ; 4 uses
  %i.ba = extractelement <4 x i16> %12, i64 0
  %.zext105 = zext nneg i16 %i.ba to i32
  %i.bb = extractelement <4 x i16> %12, i64 1
  ...
  %.zext95 = zext nneg i16 %13 to i32
  %i.bh = extractelement <4 x i16> %12, i64 3
  %.zext97 = zext nneg i16 %i.bh to i32
  %14 = shl nuw nsw i32 %.zext95, 8
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ao = tail call noundef i32 @_Z10duIntToColii(i32 noundef %i.an, i32 noundef %i.m) #6 ; 5 uses
  %i.ap = lshr i32 %i.ao, 24
  %3 = mul nuw nsw i32 %i.ap, 127
  %4 = add nuw nsw i32 %3, %i.n
  %5 = lshr i32 %i.ao, 16
  %6 = lshr i32 %i.ao, 8
  %i.aq = trunc nuw i32 %4 to i16
  %7 = trunc nuw i32 %5 to i16
  %8 = trunc i32 %6 to i16
  %9 = trunc i32 %i.ao to i16
  %10 = insertelement <4 x i16> poison, i16 %9, i64 0
  %i.ar = insertelement <4 x i16> %10, i16 %8, i64 1
  %i.as = insertelement <4 x i16> %i.ar, i16 %7, i64 2
  %i.at = insertelement <4 x i16> %i.as, i16 %i.aq, i64 3
  %11 = and <4 x i16> %i.at, <i16 255, i16 255, i16 255, i16 -1>
  %i.au = mul nuw nsw <4 x i16> %11, <i16 127, i16 127, i16 127, i16 1>
  %i.av = add nuw <4 x i16> %i.au, <i16 32640, i16 32640, i16 32640, i16 0>
  %i.aw = udiv <4 x i16> %i.av, splat (i16 255)   ; 4 uses
  %i.ax = extractelement <4 x i16> %i.aw, i64 1
  %.zext = zext nneg i16 %i.ax to i32
  %12 = shl nuw nsw i32 %.zext, 8
  %13 = extractelement <4 x i16> %i.aw, i64 2
  %14 = zext nneg i16 %13 to i32
  %15 = shl nuw nsw i32 %14, 16
  %i.ay = extractelement <4 x i16> %i.aw, i64 3
  %.zext106 = zext nneg i16 %i.ay to i32
  %i.az = shl nuw i32 %.zext106, 24
  %16 = extractelement <4 x i16> %i.aw, i64 0
  %17 = zext nneg i16 %16 to i32
  %18 = or disjoint i32 %i.az, %17
  %i.ba = or i32 %18, %12
  %i.bb = or i32 %i.ba, %15
