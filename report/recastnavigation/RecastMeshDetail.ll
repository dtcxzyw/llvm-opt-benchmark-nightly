...
bb.hp:                                            ; preds = %bb.hp, %.lr.ph573.new
  ...
  %niter1217 = phi i64 [ 0, %.lr.ph573.new ], [ %niter1217.next.1, %bb.hp ]
  ...
  %niter1217.next.1 = add i64 %niter1217, 2       ; 2 uses
  %niter1217.ncmp.1 = icmp eq i64 %niter1217.next.1, %unroll_iter1216
  br i1 %niter1217.ncmp.1, label %._crit_edge574.unr-lcssa, label %bb.hp
