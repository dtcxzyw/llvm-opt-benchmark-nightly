...
bb.p:                                             ; preds = %bb.o
  ...
  %.val.i = load float, ptr %i.ef, align 4, !tbaa !62 ; 3 uses
  %i.ej = getelementptr i8, ptr %i.ef, i64 8
  %.val34.i = load float, ptr %i.ej, align 4, !tbaa !62 ; 3 uses
  ...
  %8 = fsub float %.val36.i, %.val34.i
  %9 = fsub float %.val35.i, %.val.i
  %i.el = insertelement <2 x float> poison, float %.val.i, i64 0
  %10 = shufflevector <2 x float> %i.el, <2 x float> poison, <2 x i32> zeroinitializer
  %i.em = fsub <2 x float> %i.dr, %10
  %11 = insertelement <2 x float> poison, float %.val34.i, i64 0
  %i.en = shufflevector <2 x float> %11, <2 x float> poison, <2 x i32> zeroinitializer
  %i.eo = fsub <2 x float> %i.dq, %i.en
  %12 = fneg <2 x float> %i.em
  ...
  %i.ep = shufflevector <2 x float> %16, <2 x float> poison, <2 x i32> zeroinitializer
  %i.eq = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ep, <2 x float> %i.eo, <2 x float> %15) ; 2 uses
...
bb.t:                                             ; preds = %bb.s
  ...
  %.val.i118 = load float, ptr %i.fw, align 4, !tbaa !62 ; 3 uses
  %i.ga = getelementptr i8, ptr %i.fw, i64 8
  %.val34.i119 = load float, ptr %i.ga, align 4, !tbaa !62 ; 3 uses
  ...
  %17 = fsub float %.val36.i121, %.val34.i119
  %18 = fsub float %.val35.i120, %.val.i118
  %i.gc = insertelement <2 x float> poison, float %.val.i118, i64 0
  %19 = shufflevector <2 x float> %i.gc, <2 x float> poison, <2 x i32> zeroinitializer
  %i.gd = fsub <2 x float> %i.fi, %19
  %20 = insertelement <2 x float> poison, float %.val34.i119, i64 0
  %i.ge = shufflevector <2 x float> %20, <2 x float> poison, <2 x i32> zeroinitializer
  %i.gf = fsub <2 x float> %i.fh, %i.ge
  %21 = fneg <2 x float> %i.gd
  ...
  %i.gg = shufflevector <2 x float> %25, <2 x float> poison, <2 x i32> zeroinitializer
  %i.gh = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.gg, <2 x float> %i.gf, <2 x float> %24) ; 2 uses
