...
._crit_edge:                                      ; preds = %.lr.ph, %_ZN13rcScopedTimerC2EP9rcContext12rcTimerLabel.exit
  ...
  %.sroa.0100.0.lcssa = phi float [ %i.j, %_ZN13rcScopedTimerC2EP9rcContext12rcTimerLabel.exit ], [ %7, %.lr.ph ]
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %.sroa.0100.0123 = phi float [ %i.j, %.lr.ph.preheader ], [ %7, %.lr.ph ] ; 2 uses
  ...
  %7 = select i1 %i.ba, float %.sroa.0100.0123, float %i.at ; 2 uses
  %8 = fcmp ogt float %.sroa.10.0121, %i.ax
  %i.bb = select i1 %8, float %.sroa.10.0121, float %i.ax ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
