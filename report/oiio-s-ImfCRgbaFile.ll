...
begin_hunk_1
  ...
  %15 = icmp ugt i32 %1, 9
  %16 = sub nuw nsw i32 9, %1                     ; 2 uses
  %17 = sub nuw nsw i32 10, %1
  %18 = shl nsw i32 -1, %17
  br i1 %15, label %.split.us, label %.split

.split.us:                                        ; preds = %8, %45
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %45 ], [ 0, %8 ] ; 7 uses
  %19 = trunc i64 %indvars.iv26 to i16            ; 5 uses
  %20 = and i16 %19, 31744
...
28:                                               ; preds = %25
  %29 = getelementptr inbounds nuw [4 x i8], ptr %10, i64 %indvars.iv26
...
_ZN27OpenImageIO_v3_1_Imf__3_3_59roundNBitclEN9Imath_3_14halfE.exit.us: ; preds = %33
  %36 = getelementptr inbounds nuw [2 x i8], ptr %9, i64 %indvars.iv26
  store i16 %19, ptr %36, align 2, !tbaa !8
  br label %45

37:                                               ; preds = %33, %28
  %38 = getelementptr inbounds nuw [2 x i8], ptr %9, i64 %indvars.iv26
  store i16 %4, ptr %38, align 2, !tbaa !8
  br label %45

39:                                               ; preds = %25
  %40 = icmp slt i16 %19, 0
  %41 = getelementptr inbounds nuw [2 x i8], ptr %9, i64 %indvars.iv26
  %42 = select i1 %40, i16 %6, i16 %5
  store i16 %42, ptr %41, align 2, !tbaa !8
  br label %45

43:                                               ; preds = %.split.us
  %44 = getelementptr inbounds nuw [2 x i8], ptr %9, i64 %indvars.iv26
...
45:                                               ; preds = %43, %39, %37, %_ZN27OpenImageIO_v3_1_Imf__3_3_59roundNBitclEN9Imath_3_14halfE.exit.us
  ...
  %exitcond29.not = icmp eq i64 %indvars.iv.next27, 65536
  br i1 %exitcond29.not, label %.split23.us, label %.split.us, !llvm.loop !71
