...
.lr.ph:                                           ; preds = %.preheader54, %bb.f
  %.04259 = phi ptr [ %.042, %bb.f ], [ %i.l, %.preheader54 ] ; 3 uses
  %i.n = load ptr, ptr %.04259, align 8, !tbaa !13 ; 2 uses
  %i.o = icmp eq ptr %i.n, %1
  br i1 %i.o, label %.loopexit, label %bb.f

bb.f:                                             ; preds = %.lr.ph
  %i.p = icmp ult ptr %1, %i.n
  %.143.in.v = select i1 %i.p, i64 8, i64 16
  %.143.in = getelementptr i8, ptr %.04259, i64 %.143.in.v
  %.042 = load ptr, ptr %.143.in, align 8, !tbaa !10 ; 2 uses
...
.lr.ph64:                                         ; preds = %.preheader, %bb.r
  %.03963 = phi ptr [ %.038, %bb.r ], [ %i.l, %.preheader ] ; 5 uses
  %.04062 = phi ptr [ %.141, %bb.r ], [ %0, %.preheader ] ; 2 uses
...
randombits.exit53:                                ; preds = %bb.j, %bb.k
  %.not50 = trunc nuw i32 %i.y to i1              ; 2 uses
  %i.ac = load ptr, ptr %.03963, align 8, !tbaa !13
  %i.ad = icmp ult ptr %1, %i.ac
  br i1 %i.ad, label %bb.l, label %bb.o

bb.l:                                             ; preds = %randombits.exit53
  %i.ae = getelementptr i8, ptr %.03963, i64 8    ; 3 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  store ptr %.03963, ptr %i.ah, align 8, !tbaa !19
  br label %.sink.split

bb.o:                                             ; preds = %randombits.exit53
  %i.aj = getelementptr i8, ptr %.03963, i64 16   ; 3 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  store ptr %.03963, ptr %i.am, align 8, !tbaa !18
  br label %.sink.split

.sink.split:                                      ; preds = %bb.n, %bb.q
  %.sink = phi ptr [ %i.ak, %bb.q ], [ %i.af, %bb.n ] ; 2 uses
  store ptr %.sink, ptr %.04062, align 8, !tbaa !10
  br label %bb.r

bb.r:                                             ; preds = %.sink.split, %bb.p, %bb.m
  %.141 = phi ptr [ %i.aj, %bb.p ], [ %i.ae, %bb.m ], [ %.04062, %.sink.split ]
  %.038 = phi ptr [ %i.ak, %bb.p ], [ %i.af, %bb.m ], [ %.sink, %.sink.split ] ; 3 uses
  %i.ao = load ptr, ptr %.038, align 8, !tbaa !13
...
.loopexit:                                        ; preds = %bb.f, %.lr.ph, %bb.o, %bb.l, %bb.r, %.preheader54, %.preheader, %bb.g
  %.2 = phi ptr [ null, %bb.g ], [ %.038, %bb.r ], [ %i.l, %.preheader ], [ null, %.preheader54 ], [ null, %bb.l ], [ null, %bb.o ], [ %.04259, %.lr.ph ], [ null, %bb.f ]
  ret ptr %.2
}
