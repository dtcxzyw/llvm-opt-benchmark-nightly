...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %4 = icmp ne <4 x i32> %i.k, zeroinitializer    ; 2 uses
  %i.l = lshr <4 x i32> %i.j, splat (i32 6)
  %i.m = and <4 x i32> %i.l, splat (i32 1)
  %i.n = and <4 x i32> %i.j, splat (i32 96)
  %5 = icmp eq <4 x i32> %i.n, splat (i32 64)     ; 3 uses
  %i.o = lshr <4 x i8> %wide.load, splat (i8 7)
  %i.p = zext nneg <4 x i8> %i.o to <4 x i32>
  %6 = or <4 x i1> %5, %4
  %predphi.a = select <4 x i1> %6, <4 x i32> zeroinitializer, <4 x i32> %i.p
  %predphi12 = add <4 x i32> %vec.phi11, %predphi.a ; 2 uses
  %7 = select <4 x i1> %4, <4 x i32> %i.m, <4 x i32> zeroinitializer
  %predphi14.v = select <4 x i1> %5, <4 x i32> splat (i32 1), <4 x i32> %7
  %predphi14.a = add <4 x i32> %vec.phi10, %predphi14.v ; 2 uses
  %i.q = lshr exact <4 x i32> %i.k, splat (i32 5)
  %predphi15 = select <4 x i1> %5, <4 x i32> zeroinitializer, <4 x i32> %i.q
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ei = icmp eq <4 x i32> %i.eh, zeroinitializer ; 2 uses
  %i.ej = lshr <4 x i32> %i.eg, splat (i32 6)
  %i.ek = and <4 x i32> %i.ej, splat (i32 1)
  %i.el = and <4 x i32> %i.eg, splat (i32 96)
  %i.em = icmp ne <4 x i32> %i.el, splat (i32 64) ; 2 uses
  %i.en = lshr <4 x i8> %wide.load, splat (i8 7)
  %i.eo = zext nneg <4 x i8> %i.en to <4 x i32>
  %1 = and <4 x i1> %i.ei, %i.em
  %predphi.a = select <4 x i1> %1, <4 x i32> %i.eo, <4 x i32> zeroinitializer
  %predphi87 = add <4 x i32> %vec.phi86, %predphi.a ; 2 uses
  %not. = xor <4 x i1> %i.em, splat (i1 true)
  %i.ep = zext <4 x i1> %not. to <4 x i32>
