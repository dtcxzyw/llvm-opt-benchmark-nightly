...
begin_hunk_0_@get_localsplus_counts:bb.a
  ...
  %4 = lshr exact <4 x i32> %i.k, splat (i32 5)
  %predphi = select <4 x i1> %i.p, <4 x i32> zeroinitializer, <4 x i32> %4
  ...
  %5 = or <4 x i1> %i.p, %i.l
  %predphi15 = select <4 x i1> %5, <4 x i32> zeroinitializer, <4 x i32> %i.r
...
scalar.ph.preheader:                              ; preds = %vector.scevcheck, %.lr.ph, %middle.block
  ...
  %.0224.ph = phi i32 [ 0, %vector.scevcheck ], [ 0, %.lr.ph ], [ %i.u, %middle.block ]
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %bb.f
  ...
  %.05 = phi i32 [ %i.ai, %bb.f ], [ %.05.ph, %scalar.ph.preheader ]
...
begin_hunk_4_@get_localsplus_counts:bb.a
  ...
  store i32 %.025.lcssa, ptr %1, align 4, !tbaa !7
...
bb.i:                                             ; preds = %bb.h
  store i32 %.0.lcssa, ptr %3, align 4, !tbaa !7
  br label %bb.j
...
begin_hunk_6_@_PyCode_New:bb.a
  ...
  %1 = icmp ne <4 x i32> %i.eh, zeroinitializer   ; 2 uses
  %i.ei = lshr <4 x i32> %i.eg, splat (i32 6)
  %i.ej = and <4 x i32> %i.ei, splat (i32 1)
  %i.ek = and <4 x i32> %i.eg, splat (i32 96)
  %2 = icmp eq <4 x i32> %i.ek, splat (i32 64)    ; 2 uses
  %i.el = lshr <4 x i8> %wide.load, splat (i8 7)
  %i.em = zext nneg <4 x i8> %i.el to <4 x i32>
  %3 = lshr exact <4 x i32> %i.eh, splat (i32 5)
  %predphi87 = add <4 x i32> %vec.phi86, %3       ; 2 uses
  %i.en = zext <4 x i1> %2 to <4 x i32>
  %predphi89.v = select <4 x i1> %1, <4 x i32> %i.ej, <4 x i32> %i.en
  %predphi89 = add <4 x i32> %vec.phi85, %predphi89.v ; 2 uses
  %.not96 = or <4 x i1> %1, %2
  %predphi90 = select <4 x i1> %.not96, <4 x i32> zeroinitializer, <4 x i32> %i.em
  %predphi90.a = add <4 x i32> %vec.phi, %predphi90 ; 2 uses
  %index.next = add nuw i64 %index, 4             ; 2 uses
...
scalar.ph.preheader:                              ; preds = %vector.scevcheck, %.lr.ph.i.i24, %middle.block
  ...
  %.05.i.i.ph = phi i32 [ 0, %vector.scevcheck ], [ 0, %.lr.ph.i.i24 ], [ %i.ee, %middle.block ]
  %.0224.i.i.ph = phi i32 [ 0, %vector.scevcheck ], [ 0, %.lr.ph.i.i24 ], [ %i.ep, %middle.block ]
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %bb.ah
  ...
  %.05.i.i = phi i32 [ %i.fd, %bb.ah ], [ %.05.i.i.ph, %scalar.ph.preheader ]
  %.0224.i.i = phi i32 [ %.1.i.i, %bb.ah ], [ %.0224.i.i.ph, %scalar.ph.preheader ] ; 3 uses
...
bb.ag:                                            ; preds = %bb.ae
  ...
  %spec.select35.i.i = add i32 %.0224.i.i, %i.fc
  br label %bb.ah

bb.ah:                                            ; preds = %bb.ag, %bb.af, %bb.ad
  %.126.i.i = phi i32 [ %i.ex, %bb.ad ], [ %.0252.i.i, %bb.ag ], [ %.0252.i.i, %bb.af ] ; 2 uses
  %.124.i.i = phi i32 [ %spec.select.i.i, %bb.ad ], [ %.0233.i.i, %bb.ag ], [ %i.fb, %bb.af ] ; 2 uses
  %.1.i.i = phi i32 [ %.0224.i.i, %bb.ad ], [ %spec.select35.i.i, %bb.ag ], [ %.0224.i.i, %bb.af ] ; 2 uses
  %i.fd = add i32 %.05.i.i, 1                     ; 2 uses
...
begin_hunk_10_@_PyCode_New:bb.a
  ...
  store i32 %.025.lcssa.i.i, ptr %i.ht, align 8, !tbaa !159
...
begin_hunk_11_@_PyCode_New:bb.a
  ...
  store i32 %.0.lcssa.i.i, ptr %i.hy, align 8, !tbaa !162
...
.preheader:                                       ; preds = %bb.o, %.preheader168
  %.1115.lcssa = phi i32 [ %i.x, %.preheader168 ], [ %.2116, %bb.o ] ; 2 uses
  %.0109.lcssa = phi i32 [ %.0114.lcssa, %.preheader168 ], [ %.1110, %bb.o ]
...
bb.l:                                             ; preds = %.lr.ph180, %bb.o
  ...
  %.0109179 = phi i32 [ %.0114.lcssa, %.lr.ph180 ], [ %.1110, %bb.o ] ; 3 uses
  %.1115178 = phi i32 [ %i.x, %.lr.ph180 ], [ %.2116, %bb.o ] ; 2 uses
...
_Py_set_localsplus_info.exit150:                  ; preds = %._crit_edge.thread, %bb.n
  %i.ca = sext i32 %.0109179 to i64               ; 2 uses
  ...
  %i.cd = add i32 %.0109179, 1
  br label %bb.o

bb.o:                                             ; preds = %_Py_set_localsplus_info.exit150, %._crit_edge
  %.2116 = phi i32 [ %i.bs, %._crit_edge ], [ %.1115178, %_Py_set_localsplus_info.exit150 ] ; 2 uses
  %.1110 = phi i32 [ %.0109179, %._crit_edge ], [ %i.cd, %_Py_set_localsplus_info.exit150 ] ; 2 uses
...
bb.p:                                             ; preds = %.lr.ph185, %_Py_set_localsplus_info.exit151
  ...
  %.3117184 = phi i32 [ %.0109.lcssa, %.lr.ph185 ], [ %i.cn, %_Py_set_localsplus_info.exit151 ] ; 2 uses
...
begin_hunk_17_@PyUnstable_Code_NewWithPosOnlyArgs:bb.a
  ...
  %.not135 = icmp slt i32 %i.de, %.1115.lcssa
...
.thread163:                                       ; preds = %bb.u, %bb.r, %._crit_edge186
  %i.du = sext i32 %.1115.lcssa to i64            ; 3 uses
...
bb.l:                                             ; preds = %.thread139.i, %.lr.ph.i
  %.sroa.027.0191.i = phi i32 [ 0, %.lr.ph.i ], [ %i.bj, %.thread139.i ] ; 3 uses
  %.sroa.8.0190.i = phi i32 [ 0, %.lr.ph.i ], [ %.sroa.027.4154.i, %.thread139.i ] ; 9 uses
  %.sroa.10.0189.i = phi i32 [ 0, %.lr.ph.i ], [ %.sroa.8.3153.i, %.thread139.i ] ; 8 uses
  %.sroa.12.0188.i = phi i32 [ 0, %.lr.ph.i ], [ %.sroa.10.4152.i, %.thread139.i ] ; 10 uses
  %.sroa.14.0187.i = phi i32 [ 0, %.lr.ph.i ], [ %.sroa.12.4151.i, %.thread139.i ] ; 10 uses
  %.sroa.16.0186.i = phi i32 [ 0, %.lr.ph.i ], [ %.sroa.14.4150.i, %.thread139.i ] ; 10 uses
  %.062185.i = phi i32 [ 0, %.lr.ph.i ], [ %.sroa.16.3149.i, %.thread139.i ] ; 8 uses
  %.073184.i = phi i32 [ 0, %.lr.ph.i ], [ %.668148.i, %.thread139.i ] ; 7 uses
  %i.r = tail call i16 @_Py_GetBaseCodeUnit(ptr noundef %1, i32 noundef %.sroa.027.0191.i) #15 ; 3 uses
...
bb.o:                                             ; preds = %bb.m
  %i.aa = add i32 %.073184.i, 1                   ; 2 uses
  %i.ab = add i32 %.sroa.10.0189.i, 1             ; 2 uses
...
bb.t:                                             ; preds = %bb.r
  %i.ar = add i32 %.073184.i, 1                   ; 2 uses
  %i.as = add i32 %.062185.i, 1                   ; 2 uses
...
_PyErr_Occurred.exit111.thread.i:                 ; preds = %_PyErr_Occurred.exit111.i, %bb.y
  %i.ba = add i32 %.sroa.14.0187.i, 1
  br label %bb.aa

bb.z:                                             ; preds = %bb.x, %bb.w
  %i.bb = add i32 %.sroa.12.0188.i, 1
  br label %bb.aa

bb.aa:                                            ; preds = %bb.z, %_PyErr_Occurred.exit111.thread.i, %_PyErr_Occurred.exit108.thread.i
  %.sroa.14.1.i.a = phi i32 [ %i.aw, %_PyErr_Occurred.exit108.thread.i ], [ %.sroa.16.0186.i, %_PyErr_Occurred.exit111.thread.i ], [ %.sroa.16.0186.i, %bb.z ] ; 2 uses
  %.sroa.12.1.i = phi i32 [ %.sroa.14.0187.i, %_PyErr_Occurred.exit108.thread.i ], [ %i.ba, %_PyErr_Occurred.exit111.thread.i ], [ %.sroa.14.0187.i, %bb.z ] ; 2 uses
  %.sroa.10.1.i = phi i32 [ %.sroa.12.0188.i, %_PyErr_Occurred.exit108.thread.i ], [ %.sroa.12.0188.i, %_PyErr_Occurred.exit111.thread.i ], [ %i.bb, %bb.z ] ; 2 uses
...
.thread139.i:                                     ; preds = %_PyErr_Occurred.exit114.thread.i, %bb.ab, %_PyErr_Occurred.exit105.i, %bb.s, %_PyErr_Occurred.exit102.thread.i, %bb.p, %_PyErr_Occurred.exit.i, %bb.n, %bb.l
  %.sroa.027.4154.i = phi i32 [ %.sroa.8.0190.i, %bb.l ], [ %i.ah, %_PyErr_Occurred.exit102.thread.i ], [ %i.bh, %_PyErr_Occurred.exit114.thread.i ], [ %.sroa.8.0190.i, %bb.ab ], [ %.sroa.8.0190.i, %bb.p ], [ %.sroa.8.0190.i, %_PyErr_Occurred.exit.i ], [ %.sroa.8.0190.i, %_PyErr_Occurred.exit105.i ], [ %.sroa.8.0190.i, %bb.n ], [ %.sroa.8.0190.i, %bb.s ] ; 2 uses
  %.sroa.8.3153.i = phi i32 [ %.sroa.10.0189.i, %bb.l ], [ %i.ab, %_PyErr_Occurred.exit102.thread.i ], [ %.sroa.10.0189.i, %_PyErr_Occurred.exit114.thread.i ], [ %.sroa.10.0189.i, %bb.ab ], [ %i.ab, %bb.p ], [ %.sroa.10.0189.i, %_PyErr_Occurred.exit.i ], [ %.sroa.10.0189.i, %_PyErr_Occurred.exit105.i ], [ %.sroa.10.0189.i, %bb.n ], [ %.sroa.10.0189.i, %bb.s ] ; 2 uses
  %.sroa.10.4152.i = phi i32 [ %.sroa.12.0188.i, %bb.l ], [ %.sroa.12.0188.i, %_PyErr_Occurred.exit102.thread.i ], [ %.sroa.10.1.i, %_PyErr_Occurred.exit114.thread.i ], [ %.sroa.10.1.i, %bb.ab ], [ %.sroa.12.0188.i, %bb.p ], [ %.sroa.12.0188.i, %_PyErr_Occurred.exit.i ], [ %.sroa.12.0188.i, %_PyErr_Occurred.exit105.i ], [ %.sroa.12.0188.i, %bb.n ], [ %.sroa.12.0188.i, %bb.s ] ; 2 uses
  %.sroa.12.4151.i = phi i32 [ %.sroa.14.0187.i, %bb.l ], [ %.sroa.14.0187.i, %_PyErr_Occurred.exit102.thread.i ], [ %.sroa.12.1.i, %_PyErr_Occurred.exit114.thread.i ], [ %.sroa.12.1.i, %bb.ab ], [ %.sroa.14.0187.i, %bb.p ], [ %.sroa.14.0187.i, %_PyErr_Occurred.exit.i ], [ %.sroa.14.0187.i, %_PyErr_Occurred.exit105.i ], [ %.sroa.14.0187.i, %bb.n ], [ %.sroa.14.0187.i, %bb.s ] ; 2 uses
  %.sroa.14.4150.i = phi i32 [ %.sroa.16.0186.i, %bb.l ], [ %.sroa.16.0186.i, %_PyErr_Occurred.exit102.thread.i ], [ %.sroa.14.1.i.a, %_PyErr_Occurred.exit114.thread.i ], [ %.sroa.14.1.i.a, %bb.ab ], [ %.sroa.16.0186.i, %bb.p ], [ %.sroa.16.0186.i, %_PyErr_Occurred.exit.i ], [ %.sroa.16.0186.i, %_PyErr_Occurred.exit105.i ], [ %.sroa.16.0186.i, %bb.n ], [ %.sroa.16.0186.i, %bb.s ] ; 2 uses
  %.sroa.16.3149.i = phi i32 [ %.062185.i, %bb.l ], [ %.062185.i, %_PyErr_Occurred.exit102.thread.i ], [ %i.as, %_PyErr_Occurred.exit114.thread.i ], [ %i.as, %bb.ab ], [ %.062185.i, %bb.p ], [ %.062185.i, %_PyErr_Occurred.exit.i ], [ %.062185.i, %_PyErr_Occurred.exit105.i ], [ %.062185.i, %bb.n ], [ %.062185.i, %bb.s ] ; 2 uses
  %.668148.i = phi i32 [ %.073184.i, %bb.l ], [ %i.aa, %_PyErr_Occurred.exit102.thread.i ], [ %i.ar, %_PyErr_Occurred.exit114.thread.i ], [ %i.ar, %bb.ab ], [ %i.aa, %bb.p ], [ %.073184.i, %_PyErr_Occurred.exit.i ], [ %.073184.i, %_PyErr_Occurred.exit105.i ], [ %.073184.i, %bb.n ], [ %.073184.i, %bb.s ] ; 2 uses
  %i.bi = tail call i32 @_PyInstruction_GetLength(ptr noundef %1, i32 noundef %.sroa.027.0191.i) #15
  %i.bj = add i32 %i.bi, %.sroa.027.0191.i        ; 2 uses
...
identify_unbound_names.exit:                      ; preds = %.thread139.i, %bb.k
  %.sroa.0.0 = phi i32 [ 0, %bb.k ], [ %.668148.i, %.thread139.i ]
  %.sroa.5.0 = phi i32 [ 0, %bb.k ], [ %.sroa.16.3149.i, %.thread139.i ]
  %.sroa.6.0 = phi i32 [ 0, %bb.k ], [ %.sroa.14.4150.i, %.thread139.i ]
  %.sroa.7.0 = phi i32 [ 0, %bb.k ], [ %.sroa.12.4151.i, %.thread139.i ]
  %.sroa.8.0 = phi i32 [ 0, %bb.k ], [ %.sroa.10.4152.i, %.thread139.i ]
  %.sroa.9.0 = phi i32 [ 0, %bb.k ], [ %.sroa.8.3153.i, %.thread139.i ]
  %.052 = phi i32 [ 0, %bb.k ], [ %.sroa.027.4154.i, %.thread139.i ] ; 2 uses
...
Py_DECREF.exit150:                                ; preds = %bb.ar, %bb.aq, %bb.ap, %bb.ao, %bb.an, %bb.am, %bb.al
  %.0112 = phi ptr [ null, %bb.al ], [ null, %bb.am ], [ null, %bb.an ], [ null, %bb.ao ], [ %i.ch, %bb.ap ], [ %i.ch, %bb.aq ], [ %i.ch, %bb.ar ]
  %.0111 = phi ptr [ null, %bb.al ], [ null, %bb.am ], [ %i.bz, %bb.an ], [ %i.bz, %bb.ao ], [ %i.bz, %bb.ap ], [ %i.bz, %bb.aq ], [ %i.bz, %bb.ar ]
  %.3108 = phi ptr [ null, %bb.al ], [ null, %bb.am ], [ null, %bb.an ], [ %i.cd, %bb.ao ], [ %i.cd, %bb.ap ], [ %i.cd, %bb.aq ], [ %i.cd, %bb.ar ]
  tail call fastcc void @Py_XDECREF(ptr noundef %i.bv)
  tail call fastcc void @Py_XDECREF(ptr noundef %.0111)
  tail call fastcc void @Py_XDECREF(ptr noundef %.3108)
...
Py_DECREF.exit158:                                ; preds = %bb.at, %bb.au, %bb.av, %bb.aa, %bb.z, %._crit_edge207, %bb.v, %bb.w, %bb.x, %Py_DECREF.exit150, %bb.f, %bb.j, %bb.i, %bb.o, %bb.r, %bb.q, %bb.m, %bb.c, %bb.d, %bb.as, %bb.t, %Py_DECREF.exit152
  %.7 = phi ptr [ null, %bb.as ], [ null, %bb.t ], [ %.5, %Py_DECREF.exit152 ], [ %0, %bb.d ], [ %i.ae, %bb.r ], [ %i.j, %bb.f ], [ %i.at, %bb.aa ], [ %i.p, %bb.j ], [ null, %bb.v ], [ %.0112, %Py_DECREF.exit150 ], [ %i.o, %bb.i ], [ %i.ab, %bb.m ], [ %i.ac, %bb.o ], [ %i.ad, %bb.q ], [ %0, %bb.c ], [ null, %bb.x ], [ null, %bb.w ], [ %i.at, %._crit_edge207 ], [ %i.at, %bb.z ], [ %i.cm, %bb.av ], [ %i.cm, %bb.au ], [ %i.cm, %bb.at ]
  ret ptr %.7
}
...
.lr.ph.i:                                         ; preds = %bb.v, %.lr.ph.preheader.i
  %.0881.i = phi i32 [ %.210.i, %bb.v ], [ %i.f, %.lr.ph.preheader.i ] ; 3 uses
  %.01280.i = phi i32 [ %.214.i, %bb.v ], [ 0, %.lr.ph.preheader.i ] ; 2 uses
  %.079.i = phi i32 [ %.1.i, %bb.v ], [ 0, %.lr.ph.preheader.i ] ; 3 uses
  %.sroa.6.078.i = phi i32 [ %i.ak, %bb.v ], [ 0, %.lr.ph.preheader.i ] ; 3 uses
  %.sroa.1134.079.i = phi i32 [ %i.ag, %bb.v ], [ %i.n, %.lr.ph.preheader.i ]
  %.sroa.1637.078.i = phi ptr [ %.lcssa61, %bb.v ], [ %i.k, %.lr.ph.preheader.i ] ; 3 uses
  %i.o = load i8, ptr %.sroa.1637.078.i, align 1, !tbaa !106 ; 2 uses
  %i.p = lshr i8 %i.o, 3
  %i.q = and i8 %i.p, 15
...
bb.d:                                             ; preds = %.lr.ph.i, %.lr.ph.i
  %i.r = getelementptr i8, ptr %.sroa.1637.078.i, i64 1 ; 2 uses
...
get_line_delta.exit.i.i.i:                        ; preds = %bb.f, %bb.e, %scan_signed_varint.exit.i.i.i.i, %.lr.ph.i
  ...
  %i.ag = add i32 %.0.i.i.i.i, %.sroa.1134.079.i  ; 4 uses
  %i.ah = shl i8 %i.o, 1
  ...
  %i.al = getelementptr i8, ptr %.sroa.1637.078.i, i64 1 ; 3 uses
...
._crit_edge72:                                    ; preds = %bb.g, %._crit_edge, %get_line_delta.exit.i.i.i
  ...
  %.not16.i = icmp eq i32 %i.ag, %.0881.i
  br i1 %.not16.i, label %bb.v, label %bb.h

bb.h:                                             ; preds = %._crit_edge72
  %i.as = sub i32 %.sroa.6.078.i, %.01280.i       ; 3 uses
  %i.at = sub i32 %i.ag, %.0881.i                 ; 7 uses
...
bb.v:                                             ; preds = %Py_DECREF.exit.i, %._crit_edge72
  ...
  %.214.i = phi i32 [ %.01280.i, %._crit_edge72 ], [ %.sroa.6.078.i, %Py_DECREF.exit.i ]
  %.210.i = phi i32 [ %.0881.i, %._crit_edge72 ], [ %i.ag, %Py_DECREF.exit.i ]
