...
bb.d:                                             ; preds = %bb.c
  %lsr.iv.next.lcssa58 = phi i32 [ %lsr.iv.next, %bb.c ]
  %.0.i.lcssa56 = phi i32 [ %.0.i, %bb.c ]
  %lsr.iv.next.lcssa = phi i32 [ %lsr.iv.next, %bb.c ]
  %.0.i.lcssa49 = phi i32 [ %.0.i, %bb.c ]
...
begin_hunk_2_@delitem_common:bb.a
  ...
  %i.aj = sext i32 %lsr.iv.next.lcssa to i64
...
begin_hunk_4_@delitem_common:bb.a
  ...
  %i.at = sext i32 %lsr.iv.next.lcssa58 to i64
...
bb.b:                                             ; preds = %bb.ai, %.lr.ph.i
  ...
  %.042126.i = phi i64 [ 0, %.lr.ph.i ], [ %i.bm, %bb.ai ] ; 5 uses
...
split.a:                                          ; preds = %bb.f
  %.val87.i.lcssa.ph = phi i64 [ %.val87.i, %bb.f ]
  %.lcssa197.ph = phi ptr [ %i.f, %bb.f ]
  %.042126.i.lcssa212 = phi i64 [ %.042126.i, %bb.f ]
  %.lcssa188.ph = phi ptr [ %i.g, %bb.f ]
  %.lcssa183.ph = phi i1 [ %i.h, %bb.f ]
  br label %bb.g

.thread.i._crit_edge:                             ; preds = %.thread.i
  %.042126.i.lcssa216 = phi i64 [ %.042126.i, %.thread.i ]
  %split = phi i64 [ %.val87.i, %.thread.i ]
  %split210 = phi ptr [ %i.f, %.thread.i ]
  %.042126.i.lcssa211 = phi i64 [ %.042126.i, %.thread.i ] ; 0 uses
  %split212 = phi ptr [ %i.g, %.thread.i ]
  %split213 = phi i1 [ %i.h, %.thread.i ]
  br label %bb.g

bb.g:                                             ; preds = %split.a, %.thread.i._crit_edge
  %.val87.i.lcssa = phi i64 [ %split, %.thread.i._crit_edge ], [ %.val87.i.lcssa.ph, %split.a ]
  %.lcssa197 = phi ptr [ %split210, %.thread.i._crit_edge ], [ %.lcssa197.ph, %split.a ]
  %.042126.i.lcssa192 = phi i64 [ %.042126.i.lcssa216, %.thread.i._crit_edge ], [ %.042126.i.lcssa212, %split.a ]
  %.lcssa188 = phi ptr [ %split212, %.thread.i._crit_edge ], [ %.lcssa188.ph, %split.a ]
  %.lcssa183 = phi i1 [ %split213, %.thread.i._crit_edge ], [ %.lcssa183.ph, %split.a ]
...
bb.v:                                             ; preds = %bb.u
  %lsr.iv.next.lcssa127 = phi i32 [ %lsr.iv.next, %bb.u ]
  %.0.i.lcssa125 = phi i32 [ %.0.i, %bb.u ]
  %lsr.iv.next.lcssa = phi i32 [ %lsr.iv.next, %bb.u ]
  %.0.i.lcssa118 = phi i32 [ %.0.i, %bb.u ]
...
begin_hunk_8_@store_instance_attr_lock_held:bb.a
  ...
  %i.cm = sub i32 %i.ch, %.0.i.lcssa118
...
begin_hunk_9_@store_instance_attr_lock_held:bb.a
  ...
  %i.ct = sext i32 %lsr.iv.next.lcssa to i64
...
begin_hunk_10_@store_instance_attr_lock_held:bb.a
  ...
  %i.cw = sub i32 %i.ch, %.0.i.lcssa125
...
begin_hunk_11_@store_instance_attr_lock_held:bb.a
  ...
  %i.dd = sext i32 %lsr.iv.next.lcssa127 to i64
