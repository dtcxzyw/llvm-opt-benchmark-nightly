...
.lr.ph:                                           ; preds = %bb.t, %bb.u
  %.0.i.i.i221 = phi ptr [ %i.au, %bb.u ], [ %i.ar, %bb.t ]
  %i.au = getelementptr i8, ptr %.0.i.i.i221, i64 -1 ; 4 uses
...
.lr.ph.i70.i.i.prol.loopexit:                     ; preds = %.lr.ph.i70.i.i.prol, %bb.w
  ...
  %.lcssa236.unr = phi i64 [ poison, %bb.w ], [ %i.bk, %.lr.ph.i70.i.i.prol ]
  %spec.select.i.i.i.lcssa.unr = phi i64 [ poison, %bb.w ], [ %spec.select.i.i.i.prol, %.lr.ph.i70.i.i.prol ]
  %i.bn = icmp eq i64 %.val64, 2
  br i1 %i.bn, label %.preheader56.i.i.i, label %.lr.ph.i70.i.i

.preheader56.i.i.i:                               ; preds = %.lr.ph.i70.i.i, %.lr.ph.i70.i.i.prol.loopexit
  %.lcssa236 = phi i64 [ %.lcssa236.unr, %.lr.ph.i70.i.i.prol.loopexit ], [ %i.db, %.lr.ph.i70.i.i ] ; 2 uses
  ...
  %2 = icmp sgt i64 %i.bo, -1
  br i1 %2, label %.lr.ph66.split.us.i.i.i, label %asciilib_fastsearch.exit.thread.i

.lr.ph66.split.us.i.i.i:                          ; preds = %.preheader56.i.i.i, %bb.ac
  %.14865.us.i.i.i = phi i64 [ %i.cm, %bb.ac ], [ %i.bo, %.preheader56.i.i.i ] ; 5 uses
...
.lr.ph.i70.i.i:                                   ; preds = %.lr.ph.i70.i.i.prol.loopexit, %.lr.ph.i70.i.i
  ...
  br i1 %i.de, label %.lr.ph.i70.i.i, label %.preheader56.i.i.i, !llvm.loop !27

asciilib_fastsearch.exit.i:                       ; preds = %bb.z, %bb.v, %bb.s
  %.0.i.i84 = phi i64 [ %i.aq, %bb.s ], [ %i.az, %bb.v ], [ %.14865.us.i.i.i, %bb.z ] ; 5 uses
  %i.df = icmp slt i64 %.0.i.i84, 0
  br i1 %i.df, label %asciilib_fastsearch.exit.thread.i, label %bb.ag

asciilib_fastsearch.exit.thread.i:                ; preds = %bb.ac, %bb.x, %bb.u, %bb.t, %asciilib_fastsearch.exit.i, %.preheader56.i.i.i, %bb.r, %bb.p
...
bb.bd:                                            ; preds = %bb.ba
  ...
  br i1 %i.fr, label %.lr.ph223, label %ucs1lib_fastsearch.exit.thread.i

bb.be:                                            ; preds = %.lr.ph223
  %i.fs = icmp ugt ptr %i.ft, %.0.i73
  br i1 %i.fs, label %.lr.ph223, label %ucs1lib_fastsearch.exit.thread.i, !llvm.loop !17

.lr.ph223:                                        ; preds = %bb.bd, %bb.be
  %.0.i.i.i115222 = phi ptr [ %i.ft, %bb.be ], [ %i.fq, %bb.bd ]
  %i.ft = getelementptr i8, ptr %.0.i.i.i115222, i64 -1 ; 4 uses
  %i.fu = load i8, ptr %i.ft, align 1, !tbaa !237
  %i.fv = icmp eq i8 %i.fu, %i.fj
  br i1 %i.fv, label %bb.bf, label %bb.be, !llvm.loop !17

bb.bf:                                            ; preds = %.lr.ph223
...
bb.bg:                                            ; preds = %bb.ay
  ...
  br i1 %lcmp.mod239.not, label %.lr.ph.i75.i.i.prol.loopexit, label %.lr.ph.i75.i.i.prol
...
.lr.ph.i75.i.i.prol.loopexit:                     ; preds = %.lr.ph.i75.i.i.prol, %bb.bg
  ...
  %.lcssa231.unr = phi i64 [ poison, %bb.bg ], [ %i.gj, %.lr.ph.i75.i.i.prol ]
  %spec.select.i76.i.i.lcssa.unr = phi i64 [ poison, %bb.bg ], [ %spec.select.i76.i.i.prol, %.lr.ph.i75.i.i.prol ]
  %i.gm = icmp eq i64 %.val64, 2
  br i1 %i.gm, label %.preheader56.i.i.i90, label %.lr.ph.i75.i.i

.preheader56.i.i.i90:                             ; preds = %.lr.ph.i75.i.i, %.lr.ph.i75.i.i.prol.loopexit
  %.lcssa231 = phi i64 [ %.lcssa231.unr, %.lr.ph.i75.i.i.prol.loopexit ], [ %i.ia, %.lr.ph.i75.i.i ] ; 2 uses
  ...
  %i.gn = sub i64 %.val65, %.val64                ; 2 uses
  %3 = icmp sgt i64 %i.gn, -1
  br i1 %3, label %.lr.ph66.split.us.i.i.i95, label %ucs1lib_fastsearch.exit.thread.i

.lr.ph66.split.us.i.i.i95:                        ; preds = %.preheader56.i.i.i90, %bb.bm
  %.14865.us.i.i.i96 = phi i64 [ %i.hl, %bb.bm ], [ %i.gn, %.preheader56.i.i.i90 ] ; 5 uses
  %i.go = getelementptr i8, ptr %.0.i73, i64 %.14865.us.i.i.i96 ; 4 uses
  %i.gp = load i8, ptr %i.go, align 1, !tbaa !237
  %i.gq = icmp eq i8 %i.gp, %i.ga
  br i1 %i.gq, label %.preheader.us.i78.i.i, label %bb.bh

bb.bh:                                            ; preds = %.lr.ph66.split.us.i.i.i95
  %.not.us.i77.i.i = icmp eq i64 %.14865.us.i.i.i96, 0
...
bb.bi:                                            ; preds = %bb.bh
  ...
  %i.gw = and i64 %i.gv, %.lcssa231
  %.not51.us.i.i.i97 = icmp eq i64 %i.gw, 0
  %i.gx = select i1 %.not51.us.i.i.i97, i64 %.val64, i64 0
  br label %bb.bm

.preheader.us.i78.i.i:                            ; preds = %.lr.ph66.split.us.i.i.i95, %bb.bj
  %.04662.us.i.i.i99 = phi i64 [ %i.hc, %bb.bj ], [ %i.fz, %.lr.ph66.split.us.i.i.i95 ] ; 4 uses
...
.thread.us.i.i.i:                                 ; preds = %.preheader.us.i78.i.i
  %.not53.us.i.i.i101 = icmp eq i64 %.14865.us.i.i.i96, 0
...
bb.bm:                                            ; preds = %bb.bl, %bb.bk, %bb.bi
  %spec.select.lcssa.sink.i.i.i98 = phi i64 [ %spec.select.i76.i.i.lcssa, %bb.bl ], [ %i.gx, %bb.bi ], [ %.val64, %bb.bk ]
  %i.hk = sub nsw i64 %.14865.us.i.i.i96, %spec.select.lcssa.sink.i.i.i98 ; 2 uses
  %i.hl = add nsw i64 %i.hk, -1
  %i.hm = icmp sgt i64 %i.hk, 0
  br i1 %i.hm, label %.lr.ph66.split.us.i.i.i95, label %ucs1lib_fastsearch.exit.thread.i, !llvm.loop !29
...
.lr.ph.i75.i.i:                                   ; preds = %.lr.ph.i75.i.i.prol.loopexit, %.lr.ph.i75.i.i
  ...
  br i1 %i.id, label %.lr.ph.i75.i.i, label %.preheader56.i.i.i90, !llvm.loop !30

ucs1lib_fastsearch.exit.i:                        ; preds = %bb.bj, %bb.bf, %bb.bc
  %.0.i.i103 = phi i64 [ %i.fy, %bb.bf ], [ %i.fp, %bb.bc ], [ %.14865.us.i.i.i96, %bb.bj ] ; 6 uses
  %i.ie = icmp slt i64 %.0.i.i103, 0
  br i1 %i.ie, label %ucs1lib_fastsearch.exit.thread.i, label %bb.bq

ucs1lib_fastsearch.exit.thread.i:                 ; preds = %bb.bm, %bb.bh, %bb.be, %bb.bd, %ucs1lib_fastsearch.exit.i, %.preheader56.i.i.i90, %bb.bb, %bb.az
  ...
  br i1 %i.ig, label %Py_INCREF.exit38.i91, label %bb.bn
...
Py_INCREF.exit38.i91:                             ; preds = %bb.bn, %ucs1lib_fastsearch.exit.thread.i
  ...
  br i1 %i.ik, label %Py_INCREF.exit37.i92, label %bb.bo

bb.bo:                                            ; preds = %Py_INCREF.exit38.i91
...
Py_INCREF.exit37.i92:                             ; preds = %bb.bo, %Py_INCREF.exit38.i91
  ...
  br i1 %i.io, label %Py_INCREF.exit36.i93, label %bb.bp

bb.bp:                                            ; preds = %Py_INCREF.exit37.i92
  %i.ip = add nuw i32 %i.in, 1
  store i32 %i.ip, ptr %0, align 8, !tbaa !237
  br label %Py_INCREF.exit36.i93

Py_INCREF.exit36.i93:                             ; preds = %bb.bp, %Py_INCREF.exit37.i92
...
bb.by:                                            ; preds = %bb.bx
  ...
  %.not.i.i.i.i108 = icmp eq i32 %i.jl, 0
  %.0.v.i.i.i.i109 = select i1 %.not.i.i.i.i108, i64 56, i64 40
  %.0.i.i.i.i110 = getelementptr i8, ptr %i.ji, i64 %.0.v.i.i.i.i109
  br label %_PyUnicode_DATA.exit.i.i111

bb.bz:                                            ; preds = %bb.bx
  %i.jm = getelementptr i8, ptr %i.ji, i64 56
  %.val4.i.i.i112 = load ptr, ptr %i.jm, align 8, !tbaa !237
  br label %_PyUnicode_DATA.exit.i.i111

_PyUnicode_DATA.exit.i.i111:                      ; preds = %bb.bz, %bb.by
  %.0.i.i41.i = phi ptr [ %.0.i.i.i.i110, %bb.by ], [ %.val4.i.i.i112, %bb.bz ]
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %.0.i.i41.i, ptr align 1 %.0.i73, i64 %.0.i.i103, i1 false)
  br label %_PyUnicode_FromUCS1.exit.i

_PyUnicode_FromUCS1.exit.i:                       ; preds = %_PyUnicode_DATA.exit.i.i111, %ucs1lib_find_max_char.exit.i.i, %bb.br, %bb.bq
  %.0.i39.i = phi ptr [ null, %ucs1lib_find_max_char.exit.i.i ], [ %i.ix, %bb.br ], [ %i.ji, %_PyUnicode_DATA.exit.i.i111 ], [ getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 60176), %bb.bq ]
  %i.jn = getelementptr i8, ptr %i.fh, i64 32
  store ptr %.0.i39.i, ptr %i.jn, align 8, !tbaa !227
  %i.jo = load i32, ptr %1, align 8, !tbaa !237   ; 2 uses
  %i.jp = icmp ugt i32 %i.jo, -1073741825
  br i1 %i.jp, label %Py_INCREF.exit.i104, label %bb.ca

bb.ca:                                            ; preds = %_PyUnicode_FromUCS1.exit.i
  %i.jq = add nuw i32 %i.jo, 1
  store i32 %i.jq, ptr %1, align 8, !tbaa !237
  br label %Py_INCREF.exit.i104

Py_INCREF.exit.i104:                              ; preds = %bb.ca, %_PyUnicode_FromUCS1.exit.i
  %i.jr = getelementptr i8, ptr %i.fh, i64 40
  store ptr %1, ptr %i.jr, align 8, !tbaa !227
  %i.js = add i64 %.0.i.i103, %.val64             ; 2 uses
  %i.jt = getelementptr i8, ptr %.0.i73, i64 %i.js ; 3 uses
  %i.ju = sub i64 %.val65, %i.js                  ; 3 uses
  switch i64 %i.ju, label %bb.cc [
    i64 0, label %_PyUnicode_FromUCS1.exit63.i
    i64 1, label %bb.cb
  ]

bb.cb:                                            ; preds = %Py_INCREF.exit.i104
  %i.jv = load i8, ptr %i.jt, align 1, !tbaa !237 ; 2 uses
  %i.jw = zext i8 %i.jv to i64                    ; 2 uses
  %i.jx = getelementptr [48 x i8], ptr getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 105088), i64 %i.jw
  %i.jy = getelementptr [64 x i8], ptr getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 111232), i64 %i.jw
  %i.jz = getelementptr i8, ptr %i.jy, i64 -8192
  %i.ka = icmp slt i8 %i.jv, 0
  %i.kb = select i1 %i.ka, ptr %i.jz, ptr %i.jx
  br label %_PyUnicode_FromUCS1.exit63.i

bb.cc:                                            ; preds = %Py_INCREF.exit.i104
  %i.kc = getelementptr i8, ptr %.0.i73, i64 %.val65 ; 3 uses
  br label %bb.cd

bb.cd:                                            ; preds = %.thread31.i.i56.i, %bb.cc
  %.019.i.i43.i = phi ptr [ %i.jt, %bb.cc ], [ %i.kk, %.thread31.i.i56.i ] ; 4 uses
  %i.kd = icmp ult ptr %.019.i.i43.i, %i.kc
  br i1 %i.kd, label %bb.ce, label %ucs1lib_find_max_char.exit.i44.i

bb.ce:                                            ; preds = %bb.cd
  %i.ke = ptrtoint ptr %.019.i.i43.i to i64
  %i.kf = and i64 %i.ke, 7
  %.not.i.i55.i = icmp eq i64 %i.kf, 0
  br i1 %.not.i.i55.i, label %.preheader.i.i59.i, label %.thread31.i.i56.i

.preheader.i.i59.i:                               ; preds = %bb.ce, %bb.cf
  %.017.i.i60.i = phi ptr [ %i.kg, %bb.cf ], [ %.019.i.i43.i, %bb.ce ] ; 4 uses
  %i.kg = getelementptr i8, ptr %.017.i.i60.i, i64 8 ; 2 uses
  %.not26.i.i61.i = icmp ugt ptr %i.kg, %i.kc
  br i1 %.not26.i.i61.i, label %bb.cg, label %bb.cf

bb.cf:                                            ; preds = %.preheader.i.i59.i
  %i.kh = load i64, ptr %.017.i.i60.i, align 8, !tbaa !226
  %i.ki = and i64 %i.kh, -9187201950435737472
  %.not27.i.i62.i = icmp eq i64 %i.ki, 0
  br i1 %.not27.i.i62.i, label %.preheader.i.i59.i, label %ucs1lib_find_max_char.exit.i44.i, !llvm.loop !0

bb.cg:                                            ; preds = %.preheader.i.i59.i
  %i.kj = icmp eq ptr %.017.i.i60.i, %i.kc
  br i1 %i.kj, label %ucs1lib_find_max_char.exit.i44.i, label %.thread31.i.i56.i

.thread31.i.i56.i:                                ; preds = %bb.cg, %bb.ce
  %.2.i.i57.i = phi ptr [ %.019.i.i43.i, %bb.ce ], [ %.017.i.i60.i, %bb.cg ] ; 2 uses
  %i.kk = getelementptr i8, ptr %.2.i.i57.i, i64 1
  %i.kl = load i8, ptr %.2.i.i57.i, align 1, !tbaa !237
  %.not28.i.i58.i = icmp sgt i8 %i.kl, -1
  br i1 %.not28.i.i58.i, label %bb.cd, label %ucs1lib_find_max_char.exit.i44.i, !llvm.loop !1

ucs1lib_find_max_char.exit.i44.i:                 ; preds = %.thread31.i.i56.i, %bb.cg, %bb.cd, %bb.cf
  %.5.i.i45.i = phi i32 [ 255, %bb.cf ], [ 127, %bb.cd ], [ 127, %bb.cg ], [ 255, %.thread31.i.i56.i ]
  %i.km = tail call ptr @PyUnicode_New(i64 noundef %i.ju, i32 noundef %.5.i.i45.i), !inline_history !724 ; 5 uses
  %.not.i46.i = icmp eq ptr %i.km, null
  br i1 %.not.i46.i, label %_PyUnicode_FromUCS1.exit63.i, label %bb.ch
...
.critedge.i.thread.i:                             ; preds = %.loopexit.i.i, %.critedge.thread.i.i, %.critedge.i.i
  ...
  %.050.lcssa131.i.i = phi i64 [ %.050.lcssa132.i.i, %.critedge.thread.i.i ], [ %.050105.i.i1421, %.critedge.i.i ], [ %i.qz, %.loopexit.i.i ] ; 3 uses
...
.lr.ph.i70.i.i.prol.loopexit:                     ; preds = %.lr.ph.i70.i.i.prol, %.lr.ph.i287.split
  ...
  %.lcssa1634.unr = phi i64 [ poison, %.lr.ph.i287.split ], [ %i.tg, %.lr.ph.i70.i.i.prol ]
  %spec.select.i.i.i.lcssa.unr = phi i64 [ poison, %.lr.ph.i287.split ], [ %spec.select.i.i.i.prol, %.lr.ph.i70.i.i.prol ]
  br i1 %i.sx, label %.preheader56.i.i.i, label %.lr.ph.i70.i.i

.preheader56.i.i.i:                               ; preds = %.lr.ph.i70.i.i, %.lr.ph.i70.i.i.prol.loopexit
  %.lcssa1634 = phi i64 [ %.lcssa1634.unr, %.lr.ph.i70.i.i.prol.loopexit ], [ %i.uw, %.lr.ph.i70.i.i ] ; 2 uses
  %spec.select.i.i.i.lcssa = phi i64 [ %spec.select.i.i.i.lcssa.unr, %.lr.ph.i70.i.i.prol.loopexit ], [ %spec.select.i.i.i.1, %.lr.ph.i70.i.i ]
  %i.ti = add nsw i64 %.in.i, -1
  %i.tj = sub i64 %.057136.i, %.val99             ; 2 uses
  %3 = icmp sgt i64 %i.tj, -1
  br i1 %3, label %.lr.ph66.split.us.i.i.i, label %asciilib_fastsearch.exit.thread.i

.lr.ph66.split.us.i.i.i:                          ; preds = %.preheader56.i.i.i, %bb.hj
  %.14865.us.i.i.i = phi i64 [ %i.uh, %bb.hj ], [ %i.tj, %.preheader56.i.i.i ] ; 9 uses
...
.lr.ph.i70.i.i:                                   ; preds = %.lr.ph.i70.i.i.prol.loopexit, %.lr.ph.i70.i.i
  ...
  br i1 %i.uz, label %.lr.ph.i70.i.i, label %.preheader56.i.i.i, !llvm.loop !27
...
asciilib_fastsearch.exit.thread.i:                ; preds = %.preheader56.i.i.i, %asciilib_fastsearch.exit.i, %bb.hj, %bb.he
  %i.wd = icmp eq i64 %.0137.i, 0
  br i1 %i.wd, label %asciilib_fastsearch.exit.thread.thread.i, label %asciilib_fastsearch.exit.thread.thread209.i
...
asciilib_fastsearch.exit.thread.thread.i:         ; preds = %.lr.ph.i287, %asciilib_fastsearch.exit.thread.i, %.preheader.i286
  ...
  br i1 %.not109.i, label %bb.hx, label %asciilib_fastsearch.exit.thread.thread209.i
...
bb.hy:                                            ; preds = %bb.hx
  %i.wh = add nuw i32 %i.wf, 1
  store i32 %i.wh, ptr %0, align 8, !tbaa !237
  br label %Py_INCREF.exit.i290

Py_INCREF.exit.i290:                              ; preds = %bb.hy, %bb.hx
  %i.wi = getelementptr i8, ptr %i.sp, i64 24
  %.val80.i = load ptr, ptr %i.wi, align 8, !tbaa !280
...
asciilib_fastsearch.exit.thread.thread209.i:      ; preds = %Py_DECREF.exit72.i, %asciilib_fastsearch.exit.thread.thread.i, %asciilib_fastsearch.exit.thread.i
  %.0119207.i = phi i64 [ 0, %asciilib_fastsearch.exit.thread.thread.i ], [ %.0137.i, %asciilib_fastsearch.exit.thread.i ], [ %i.wa, %Py_DECREF.exit72.i ] ; 3 uses
  ...
  %i.wj = icmp eq i64 %.057124205.i, 1
  br i1 %i.wj, label %_PyUnicode_FromASCII.exit99.i, label %bb.hz

bb.hz:                                            ; preds = %asciilib_fastsearch.exit.thread.thread209.i
  %i.wk = tail call ptr @PyUnicode_New(i64 noundef %.057124205.i, i32 noundef 127), !inline_history !754 ; 5 uses
  %.not.i89.i = icmp eq ptr %i.wk, null
  br i1 %.not.i89.i, label %Py_DECREF.exit74.i, label %bb.ia

bb.ia:                                            ; preds = %bb.hz
  %i.wl = getelementptr i8, ptr %i.wk, i64 32
  %.val.i.i90.i = load i32, ptr %i.wl, align 8    ; 2 uses
  %i.wm = and i32 %.val.i.i90.i, 32
  %.not.i.i91.i = icmp eq i32 %i.wm, 0
  br i1 %.not.i.i91.i, label %bb.ic, label %bb.ib

bb.ib:                                            ; preds = %bb.ia
  %i.wn = and i32 %.val.i.i90.i, 64
  %.not.i.i.i92.i = icmp eq i32 %i.wn, 0
  %.0.v.i.i.i93.i = select i1 %.not.i.i.i92.i, i64 56, i64 40
  %.0.i.i.i94.i = getelementptr i8, ptr %i.wk, i64 %.0.v.i.i.i93.i
  br label %_PyUnicode_FromASCII.exit99.thread106.i

bb.ic:                                            ; preds = %bb.ia
  %i.wo = getelementptr i8, ptr %i.wk, i64 56
  %.val4.i.i98.i = load ptr, ptr %i.wo, align 8, !tbaa !237
  br label %_PyUnicode_FromASCII.exit99.thread106.i

_PyUnicode_FromASCII.exit99.thread106.i:          ; preds = %bb.ic, %bb.ib
  %.0.i.i96.i = phi ptr [ %.0.i.i.i94.i, %bb.ib ], [ %.val4.i.i98.i, %bb.ic ]
...
_PyUnicode_FromASCII.exit99.i:                    ; preds = %asciilib_fastsearch.exit.thread.thread209.i
  %i.wp = load i8, ptr %.0.i271, align 1, !tbaa !237 ; 2 uses
  %i.wq = zext i8 %i.wp to i64                    ; 2 uses
  %i.wr = getelementptr [48 x i8], ptr getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 105088), i64 %i.wq
  %i.ws = getelementptr [64 x i8], ptr getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 111232), i64 %i.wq
  %i.wt = getelementptr i8, ptr %i.ws, i64 -8192
  %i.wu = icmp slt i8 %i.wp, 0
  %i.wv = select i1 %i.wu, ptr %i.wt, ptr %i.wr   ; 2 uses
  %i.ww = icmp eq ptr %i.wv, null
  br i1 %i.ww, label %Py_DECREF.exit74.i, label %bb.id

bb.id:                                            ; preds = %_PyUnicode_FromASCII.exit99.i, %_PyUnicode_FromASCII.exit99.thread106.i
  %.0.i97108.i = phi ptr [ %i.wk, %_PyUnicode_FromASCII.exit99.thread106.i ], [ %i.wv, %_PyUnicode_FromASCII.exit99.i ] ; 7 uses
  %i.wx = icmp slt i64 %.0119207.i, 12
  br i1 %i.wx, label %bb.ie, label %bb.if

bb.ie:                                            ; preds = %bb.id
  %i.wy = getelementptr i8, ptr %i.sp, i64 24
  %.val79.i = load ptr, ptr %i.wy, align 8, !tbaa !280
  %i.wz = getelementptr [8 x i8], ptr %.val79.i, i64 %.0119207.i
  store ptr %.0.i97108.i, ptr %i.wz, align 8, !tbaa !227
  br label %Py_DECREF.exit68.i

bb.if:                                            ; preds = %bb.id
  %i.xa = tail call i32 @PyList_Append(ptr noundef nonnull %i.sp, ptr noundef nonnull %.0.i97108.i) #33, !inline_history !749
  %.not66.i = icmp eq i32 %i.xa, 0
  %i.xb = load i32, ptr %.0.i97108.i, align 8, !tbaa !237 ; 3 uses
  %.not.i67.i = icmp sgt i32 %i.xb, -1            ; 2 uses
...
bb.ih:                                            ; preds = %bb.ig
  %i.xc = add nsw i32 %i.xb, -1                   ; 2 uses
  store i32 %i.xc, ptr %.0.i97108.i, align 8, !tbaa !237
  %i.xd = icmp eq i32 %i.xc, 0
  br i1 %i.xd, label %Py_DECREF.exit74.sink.split.i, label %Py_DECREF.exit74.i

bb.ii:                                            ; preds = %bb.if
  br i1 %.not.i67.i, label %bb.ij, label %Py_DECREF.exit68.i

bb.ij:                                            ; preds = %bb.ii
  %i.xe = add nsw i32 %i.xb, -1                   ; 2 uses
  store i32 %i.xe, ptr %.0.i97108.i, align 8, !tbaa !237
  %i.xf = icmp eq i32 %i.xe, 0
  br i1 %i.xf, label %bb.ik, label %Py_DECREF.exit68.i
...
Py_DECREF.exit68.i:                               ; preds = %bb.ik, %bb.ij, %bb.ii, %bb.ie
  %i.xg = add i64 %.0119207.i, 1
  br label %bb.il

bb.il:                                            ; preds = %Py_DECREF.exit68.i, %Py_INCREF.exit.i290
  %.1.i = phi i64 [ 1, %Py_INCREF.exit.i290 ], [ %i.xg, %Py_DECREF.exit68.i ]
  %i.xh = getelementptr i8, ptr %i.sp, i64 16
  store i64 %.1.i, ptr %i.xh, align 8, !tbaa !263
  %i.xi = tail call i32 @PyList_Reverse(ptr noundef nonnull %i.sp) #33, !inline_history !749
  %i.xj = icmp slt i32 %i.xi, 0
  br i1 %i.xj, label %Py_DECREF.exit74.i, label %asciilib_rsplit.exit

Py_DECREF.exit74.sink.split.i:                    ; preds = %bb.ih, %bb.ht
  %.0.i97108.sink.i = phi ptr [ %.0.i88104.i, %bb.ht ], [ %.0.i97108.i, %bb.ih ]
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i97108.sink.i) #33, !inline_history !749
  br label %Py_DECREF.exit74.i

Py_DECREF.exit74.i:                               ; preds = %_PyUnicode_FromASCII.exit.i295, %bb.hl, %Py_DECREF.exit74.sink.split.i, %bb.il, %bb.ih, %bb.ig, %_PyUnicode_FromASCII.exit99.i, %bb.hz, %bb.ht, %bb.hs
  %i.xk = load i32, ptr %i.sp, align 8, !tbaa !237 ; 2 uses
  %.not.i.i288 = icmp sgt i32 %i.xk, -1
  br i1 %.not.i.i288, label %bb.im, label %asciilib_rsplit.exit

bb.im:                                            ; preds = %Py_DECREF.exit74.i
  %i.xl = add nsw i32 %i.xk, -1                   ; 2 uses
  store i32 %i.xl, ptr %i.sp, align 8, !tbaa !237
  %i.xm = icmp eq i32 %i.xl, 0
  br i1 %i.xm, label %bb.in, label %asciilib_rsplit.exit

bb.in:                                            ; preds = %bb.im
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.sp) #33, !inline_history !749
  br label %asciilib_rsplit.exit
...
bb.ip:                                            ; preds = %bb.io
  %i.xn = load ptr, ptr @PyExc_ValueError, align 8, !tbaa !227
  tail call void @PyErr_SetString(ptr noundef %i.xn, ptr noundef nonnull @.str.197) #33, !inline_history !756
  br label %asciilib_rsplit.exit

bb.iq:                                            ; preds = %bb.io
  %i.xo = load i8, ptr %.080, align 1, !tbaa !237
  %i.xp = tail call i64 @llvm.smin.i64(i64 %.1, i64 11)
  %i.xq = add nsw i64 %i.xp, 1
  %i.xr = tail call ptr @PyList_New(i64 noundef %i.xq) #33, !inline_history !757 ; 12 uses
  %i.xs = icmp eq ptr %i.xr, null
  br i1 %i.xs, label %asciilib_rsplit.exit, label %bb.ir

bb.ir:                                            ; preds = %bb.iq
  %i.xt = add i64 %.val100, -1                    ; 4 uses
  %i.xu = icmp sgt i64 %i.xt, -1
  br i1 %i.xu, label %.lr.ph122.i.i, label %.critedge.thread.i.i296

.lr.ph122.i.i:                                    ; preds = %bb.ir
  %i.xv = getelementptr i8, ptr %i.xr, i64 24
  %smin.i311 = tail call i64 @llvm.smin.i64(i64 %.1, i64 0)
  %i.xw = sub i64 %.1, %smin.i311                 ; 4 uses
  %exitcond.not.i3121496 = icmp eq i64 %i.xw, 0
  br i1 %exitcond.not.i3121496, label %.critedge.i.i314, label %.lr.ph.i.i313.preheader

bb.is:                                            ; preds = %.loopexit.i.i319
  %exitcond.not.i312 = icmp eq i64 %i.zk, %i.xw
  br i1 %exitcond.not.i312, label %.critedge.i.i314, label %.lr.ph.i.i313.preheader, !llvm.loop !758

.lr.ph.i.i313.preheader:                          ; preds = %.lr.ph122.i.i, %bb.is
  %.050120.i.i1498 = phi i64 [ %i.zl, %bb.is ], [ %i.xt, %.lr.ph122.i.i ] ; 3 uses
  %.0121.i.i1497 = phi i64 [ %i.zk, %bb.is ], [ 0, %.lr.ph122.i.i ] ; 4 uses
  br label %.lr.ph.i.i313

.lr.ph.i.i313:                                    ; preds = %.lr.ph.i.i313.preheader, %bb.jj
  %.153117.i.i = phi i64 [ %i.zi, %bb.jj ], [ %.050120.i.i1498, %.lr.ph.i.i313.preheader ] ; 7 uses
  %i.xx = getelementptr i8, ptr %.0.i271, i64 %.153117.i.i
  %i.xy = load i8, ptr %i.xx, align 1, !tbaa !237
  %i.xz = icmp eq i8 %i.xy, %i.xo
  br i1 %i.xz, label %bb.it, label %bb.jj

bb.it:                                            ; preds = %.lr.ph.i.i313
  %i.ya = getelementptr i8, ptr %.0.i271, i64 %.153117.i.i
  %i.yb = getelementptr i8, ptr %i.ya, i64 1      ; 4 uses
  %i.yc = sub nuw nsw i64 %.050120.i.i1498, %.153117.i.i ; 4 uses
  switch i64 %i.yc, label %bb.iu [
...
.lr.ph.i75.i.i.prol.loopexit:                     ; preds = %.lr.ph.i75.i.i.prol, %.lr.ph.i330.split
  ...
  %.lcssa1594.unr = phi i64 [ poison, %.lr.ph.i330.split ], [ %i.acb, %.lr.ph.i75.i.i.prol ]
  %spec.select.i76.i.i.lcssa.unr = phi i64 [ poison, %.lr.ph.i330.split ], [ %spec.select.i76.i.i.prol, %.lr.ph.i75.i.i.prol ]
  br i1 %i.abs, label %.preheader56.i.i.i335, label %.lr.ph.i75.i.i

.preheader56.i.i.i335:                            ; preds = %.lr.ph.i75.i.i, %.lr.ph.i75.i.i.prol.loopexit
  %.lcssa1594 = phi i64 [ %.lcssa1594.unr, %.lr.ph.i75.i.i.prol.loopexit ], [ %i.adr, %.lr.ph.i75.i.i ] ; 2 uses
  %spec.select.i76.i.i.lcssa = phi i64 [ %spec.select.i76.i.i.lcssa.unr, %.lr.ph.i75.i.i.prol.loopexit ], [ %spec.select.i76.i.i.1, %.lr.ph.i75.i.i ]
  %i.acd = add nsw i64 %.in.i331, -1
  %i.ace = sub i64 %.057155.i, %.val99            ; 2 uses
  %4 = icmp sgt i64 %i.ace, -1
  br i1 %4, label %.lr.ph66.split.us.i.i.i347, label %ucs1lib_fastsearch.exit.thread.i

.lr.ph66.split.us.i.i.i347:                       ; preds = %.preheader56.i.i.i335, %bb.kl
  %.14865.us.i.i.i348 = phi i64 [ %i.adc, %bb.kl ], [ %i.ace, %.preheader56.i.i.i335 ] ; 9 uses
  %i.acf = getelementptr i8, ptr %.0.i271, i64 %.14865.us.i.i.i348 ; 4 uses
  %i.acg = load i8, ptr %i.acf, align 1, !tbaa !237
  %i.ach = icmp eq i8 %i.acg, %i.abt
  br i1 %i.ach, label %.preheader.us.i78.i.i, label %bb.kg

bb.kg:                                            ; preds = %.lr.ph66.split.us.i.i.i347
...
bb.kh:                                            ; preds = %bb.kg
  ...
  %i.acn = and i64 %i.acm, %.lcssa1594
  %.not51.us.i.i.i349 = icmp eq i64 %i.acn, 0
  %i.aco = select i1 %.not51.us.i.i.i349, i64 %.val99, i64 0
  br label %bb.kl

.preheader.us.i78.i.i:                            ; preds = %.lr.ph66.split.us.i.i.i347, %bb.ki
  %.04662.us.i.i.i351 = phi i64 [ %i.act, %bb.ki ], [ %i.abo, %.lr.ph66.split.us.i.i.i347 ] ; 4 uses
...
bb.kl:                                            ; preds = %bb.kk, %bb.kj, %bb.kh
  %spec.select.lcssa.sink.i.i.i350 = phi i64 [ %spec.select.i76.i.i.lcssa, %bb.kk ], [ %i.aco, %bb.kh ], [ %.val99, %bb.kj ]
  %i.adb = sub nsw i64 %.14865.us.i.i.i348, %spec.select.lcssa.sink.i.i.i350 ; 2 uses
  %i.adc = add nsw i64 %i.adb, -1
  %i.add = icmp sgt i64 %i.adb, 0
  br i1 %i.add, label %.lr.ph66.split.us.i.i.i347, label %ucs1lib_fastsearch.exit.thread.i, !llvm.loop !29
...
.lr.ph.i75.i.i:                                   ; preds = %.lr.ph.i75.i.i.prol.loopexit, %.lr.ph.i75.i.i
  ...
  br i1 %i.adu, label %.lr.ph.i75.i.i, label %.preheader56.i.i.i335, !llvm.loop !30

ucs1lib_fastsearch.exit.i:                        ; preds = %bb.ki
  %i.adv = icmp slt i64 %.14865.us.i.i.i348, 0
  br i1 %i.adv, label %ucs1lib_fastsearch.exit.thread.i, label %bb.km

bb.km:                                            ; preds = %ucs1lib_fastsearch.exit.i
  %i.adw = add nuw i64 %.14865.us.i.i.i348, %.val99 ; 2 uses
...
ucs1lib_find_max_char.exit.i.i364:                ; preds = %.thread31.i.i.i375, %bb.kr, %bb.ko, %bb.kq
  ...
  br i1 %.not.i84.i366, label %Py_DECREF.exit74.i338, label %bb.ks
...
_PyUnicode_FromUCS1.exit.i355:                    ; preds = %bb.km
  ...
  br i1 %i.aev, label %Py_DECREF.exit74.i338, label %_PyUnicode_FromUCS1.exit.thread.i356
...
bb.kx:                                            ; preds = %bb.kw
  br i1 %.not.i71.i359, label %bb.ky, label %Py_DECREF.exit74.i338

bb.ky:                                            ; preds = %bb.kx
  %i.afa = add nsw i32 %i.aez, -1                 ; 2 uses
  store i32 %i.afa, ptr %.0.i83113.i, align 8, !tbaa !237
  %i.afb = icmp eq i32 %i.afa, 0
  br i1 %i.afb, label %Py_DECREF.exit74.sink.split.i340, label %Py_DECREF.exit74.i338

bb.kz:                                            ; preds = %bb.kw
  br i1 %.not.i71.i359, label %bb.la, label %Py_DECREF.exit72.i360

bb.la:                                            ; preds = %bb.kz
  %i.afc = add nsw i32 %i.aez, -1                 ; 2 uses
  store i32 %i.afc, ptr %.0.i83113.i, align 8, !tbaa !237
  %i.afd = icmp eq i32 %i.afc, 0
  br i1 %i.afd, label %bb.lb, label %Py_DECREF.exit72.i360

bb.lb:                                            ; preds = %bb.la
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i83113.i) #33, !inline_history !756
  br label %Py_DECREF.exit72.i360

Py_DECREF.exit72.i360:                            ; preds = %bb.lb, %bb.la, %bb.kz, %bb.kv
  %i.afe = add nuw nsw i64 %.0156.i, 1            ; 2 uses
  %i.aff = icmp slt i64 %.in.i331, 2
  %i.afg = icmp slt i64 %.14865.us.i.i.i348, %.val99
  %or.cond.i361 = or i1 %i.aff, %i.afg
  br i1 %or.cond.i361, label %ucs1lib_fastsearch.exit.thread.thread242.i, label %.lr.ph.i330.split, !llvm.loop !762

ucs1lib_fastsearch.exit.thread.i:                 ; preds = %.preheader56.i.i.i335, %ucs1lib_fastsearch.exit.i, %bb.kl, %bb.kg
  %i.afh = icmp eq i64 %.0156.i, 0
  br i1 %i.afh, label %ucs1lib_fastsearch.exit.thread.thread.i, label %ucs1lib_fastsearch.exit.thread.thread242.i
...
ucs1lib_fastsearch.exit.thread.thread.i:          ; preds = %.lr.ph.i330, %ucs1lib_fastsearch.exit.thread.i, %.preheader.i329
  ...
  %i.afi = getelementptr i8, ptr %0, i64 8
  %.val.i344 = load ptr, ptr %i.afi, align 8, !tbaa !229
  %.not120.i = icmp eq ptr %.val.i344, @PyUnicode_Type
  br i1 %.not120.i, label %bb.lc, label %ucs1lib_fastsearch.exit.thread.thread242.i

bb.lc:                                            ; preds = %ucs1lib_fastsearch.exit.thread.thread.i
  %i.afj = load i32, ptr %0, align 8, !tbaa !237  ; 2 uses
  %i.afk = icmp ugt i32 %i.afj, -1073741825
  br i1 %i.afk, label %Py_INCREF.exit.i345, label %bb.ld

bb.ld:                                            ; preds = %bb.lc
  %i.afl = add nuw i32 %i.afj, 1
  store i32 %i.afl, ptr %0, align 8, !tbaa !237
  br label %Py_INCREF.exit.i345

Py_INCREF.exit.i345:                              ; preds = %bb.ld, %bb.lc
  %i.afm = getelementptr i8, ptr %i.abk, i64 24
  %.val80.i346 = load ptr, ptr %i.afm, align 8, !tbaa !280
...
ucs1lib_fastsearch.exit.thread.thread242.i:       ; preds = %Py_DECREF.exit72.i360, %ucs1lib_fastsearch.exit.thread.thread.i, %ucs1lib_fastsearch.exit.thread.i
  %.0136240.i = phi i64 [ 0, %ucs1lib_fastsearch.exit.thread.thread.i ], [ %.0156.i, %ucs1lib_fastsearch.exit.thread.i ], [ %i.afe, %Py_DECREF.exit72.i360 ] ; 3 uses
  ...
  switch i64 %.057141238.i, label %bb.le [
    i64 0, label %_PyUnicode_FromUCS1.exit110.thread.i
    i64 1, label %_PyUnicode_FromUCS1.exit110.i
  ]

bb.le:                                            ; preds = %ucs1lib_fastsearch.exit.thread.thread242.i
  %i.afn = getelementptr i8, ptr %.0.i271, i64 %.057141238.i ; 3 uses
  br label %bb.lf

bb.lf:                                            ; preds = %.thread31.i.i103.i, %bb.le
  %.019.i.i90.i = phi ptr [ %.0.i271, %bb.le ], [ %i.afv, %.thread31.i.i103.i ] ; 4 uses
  %i.afo = icmp ult ptr %.019.i.i90.i, %i.afn
  br i1 %i.afo, label %bb.lg, label %ucs1lib_find_max_char.exit.i91.i

bb.lg:                                            ; preds = %bb.lf
  %i.afp = ptrtoint ptr %.019.i.i90.i to i64
  %i.afq = and i64 %i.afp, 7
  %.not.i.i102.i = icmp eq i64 %i.afq, 0
  br i1 %.not.i.i102.i, label %.preheader.i.i106.i, label %.thread31.i.i103.i

.preheader.i.i106.i:                              ; preds = %bb.lg, %bb.lh
  %.017.i.i107.i = phi ptr [ %i.afr, %bb.lh ], [ %.019.i.i90.i, %bb.lg ] ; 4 uses
  %i.afr = getelementptr i8, ptr %.017.i.i107.i, i64 8 ; 2 uses
  %.not26.i.i108.i = icmp ugt ptr %i.afr, %i.afn
  br i1 %.not26.i.i108.i, label %bb.li, label %bb.lh

bb.lh:                                            ; preds = %.preheader.i.i106.i
  %i.afs = load i64, ptr %.017.i.i107.i, align 8, !tbaa !226
  %i.aft = and i64 %i.afs, -9187201950435737472
  %.not27.i.i109.i = icmp eq i64 %i.aft, 0
  br i1 %.not27.i.i109.i, label %.preheader.i.i106.i, label %ucs1lib_find_max_char.exit.i91.i, !llvm.loop !0

bb.li:                                            ; preds = %.preheader.i.i106.i
  %i.afu = icmp eq ptr %.017.i.i107.i, %i.afn
  br i1 %i.afu, label %ucs1lib_find_max_char.exit.i91.i, label %.thread31.i.i103.i

.thread31.i.i103.i:                               ; preds = %bb.li, %bb.lg
  %.2.i.i104.i = phi ptr [ %.019.i.i90.i, %bb.lg ], [ %.017.i.i107.i, %bb.li ] ; 2 uses
  %i.afv = getelementptr i8, ptr %.2.i.i104.i, i64 1
  %i.afw = load i8, ptr %.2.i.i104.i, align 1, !tbaa !237
  %.not28.i.i105.i = icmp sgt i8 %i.afw, -1
  br i1 %.not28.i.i105.i, label %bb.lf, label %ucs1lib_find_max_char.exit.i91.i, !llvm.loop !1

ucs1lib_find_max_char.exit.i91.i:                 ; preds = %.thread31.i.i103.i, %bb.li, %bb.lf, %bb.lh
  %.5.i.i92.i = phi i32 [ 255, %bb.lh ], [ 127, %bb.lf ], [ 127, %bb.li ], [ 255, %.thread31.i.i103.i ]
  %i.afx = tail call ptr @PyUnicode_New(i64 noundef %.057141238.i, i32 noundef %.5.i.i92.i), !inline_history !761 ; 5 uses
  %.not.i93.i = icmp eq ptr %i.afx, null
  br i1 %.not.i93.i, label %Py_DECREF.exit74.i338, label %bb.lj

bb.lj:                                            ; preds = %ucs1lib_find_max_char.exit.i91.i
  %i.afy = getelementptr i8, ptr %i.afx, i64 32
  %.val.i.i94.i = load i32, ptr %i.afy, align 8   ; 2 uses
  %i.afz = and i32 %.val.i.i94.i, 32
  %.not.i15.i95.i = icmp eq i32 %i.afz, 0
  br i1 %.not.i15.i95.i, label %bb.ll, label %bb.lk

bb.lk:                                            ; preds = %bb.lj
  %i.aga = and i32 %.val.i.i94.i, 64
  %.not.i.i.i96.i = icmp eq i32 %i.aga, 0
  %.0.v.i.i.i97.i = select i1 %.not.i.i.i96.i, i64 56, i64 40
  %.0.i.i.i98.i = getelementptr i8, ptr %i.afx, i64 %.0.v.i.i.i97.i
  br label %_PyUnicode_DATA.exit.i99.i

bb.ll:                                            ; preds = %bb.lj
  %i.agb = getelementptr i8, ptr %i.afx, i64 56
  %.val4.i.i101.i = load ptr, ptr %i.agb, align 8, !tbaa !237
  br label %_PyUnicode_DATA.exit.i99.i

_PyUnicode_DATA.exit.i99.i:                       ; preds = %bb.ll, %bb.lk
  %.0.i.i100.i = phi ptr [ %.0.i.i.i98.i, %bb.lk ], [ %.val4.i.i101.i, %bb.ll ]
...
_PyUnicode_FromUCS1.exit110.i:                    ; preds = %ucs1lib_fastsearch.exit.thread.thread242.i
  %i.agc = load i8, ptr %.0.i271, align 1, !tbaa !237 ; 2 uses
  %i.agd = zext i8 %i.agc to i64                  ; 2 uses
  %i.age = getelementptr [48 x i8], ptr getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 105088), i64 %i.agd
  %i.agf = getelementptr [64 x i8], ptr getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 111232), i64 %i.agd
  %i.agg = getelementptr i8, ptr %i.agf, i64 -8192
  %i.agh = icmp slt i8 %i.agc, 0
  %i.agi = select i1 %i.agh, ptr %i.agg, ptr %i.age ; 2 uses
  %i.agj = icmp eq ptr %i.agi, null
  br i1 %i.agj, label %Py_DECREF.exit74.i338, label %_PyUnicode_FromUCS1.exit110.thread.i
...
_PyUnicode_FromUCS1.exit110.thread.i:             ; preds = %_PyUnicode_FromUCS1.exit110.i, %_PyUnicode_DATA.exit.i99.i, %ucs1lib_fastsearch.exit.thread.thread242.i
  %.0.i89117.i = phi ptr [ %i.agi, %_PyUnicode_FromUCS1.exit110.i ], [ getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 60176), %ucs1lib_fastsearch.exit.thread.thread242.i ], [ %i.afx, %_PyUnicode_DATA.exit.i99.i ] ; 7 uses
  %i.agk = icmp slt i64 %.0136240.i, 12
  br i1 %i.agk, label %bb.lm, label %bb.ln

bb.lm:                                            ; preds = %_PyUnicode_FromUCS1.exit110.thread.i
  %i.agl = getelementptr i8, ptr %i.abk, i64 24
  %.val79.i343 = load ptr, ptr %i.agl, align 8, !tbaa !280
  %i.agm = getelementptr [8 x i8], ptr %.val79.i343, i64 %.0136240.i
  store ptr %.0.i89117.i, ptr %i.agm, align 8, !tbaa !227
  br label %Py_DECREF.exit68.i341

bb.ln:                                            ; preds = %_PyUnicode_FromUCS1.exit110.thread.i
  %i.agn = tail call i32 @PyList_Append(ptr noundef nonnull %i.abk, ptr noundef nonnull %.0.i89117.i) #33, !inline_history !756
  %.not66.i336 = icmp eq i32 %i.agn, 0
  %i.ago = load i32, ptr %.0.i89117.i, align 8, !tbaa !237 ; 3 uses
  %.not.i67.i337 = icmp sgt i32 %i.ago, -1        ; 2 uses
  br i1 %.not66.i336, label %bb.lq, label %bb.lo

bb.lo:                                            ; preds = %bb.ln
  br i1 %.not.i67.i337, label %bb.lp, label %Py_DECREF.exit74.i338

bb.lp:                                            ; preds = %bb.lo
  %i.agp = add nsw i32 %i.ago, -1                 ; 2 uses
  store i32 %i.agp, ptr %.0.i89117.i, align 8, !tbaa !237
  %i.agq = icmp eq i32 %i.agp, 0
  br i1 %i.agq, label %Py_DECREF.exit74.sink.split.i340, label %Py_DECREF.exit74.i338

bb.lq:                                            ; preds = %bb.ln
  br i1 %.not.i67.i337, label %bb.lr, label %Py_DECREF.exit68.i341

bb.lr:                                            ; preds = %bb.lq
  %i.agr = add nsw i32 %i.ago, -1                 ; 2 uses
  store i32 %i.agr, ptr %.0.i89117.i, align 8, !tbaa !237
  %i.ags = icmp eq i32 %i.agr, 0
  br i1 %i.ags, label %bb.ls, label %Py_DECREF.exit68.i341

bb.ls:                                            ; preds = %bb.lr
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i89117.i) #33, !inline_history !756
  br label %Py_DECREF.exit68.i341

Py_DECREF.exit68.i341:                            ; preds = %bb.ls, %bb.lr, %bb.lq, %bb.lm
  %i.agt = add i64 %.0136240.i, 1
  br label %bb.lt

bb.lt:                                            ; preds = %Py_DECREF.exit68.i341, %Py_INCREF.exit.i345
  %.1.i342 = phi i64 [ 1, %Py_INCREF.exit.i345 ], [ %i.agt, %Py_DECREF.exit68.i341 ]
  %i.agu = getelementptr i8, ptr %i.abk, i64 16
  store i64 %.1.i342, ptr %i.agu, align 8, !tbaa !263
  %i.agv = tail call i32 @PyList_Reverse(ptr noundef nonnull %i.abk) #33, !inline_history !756
  %i.agw = icmp slt i32 %i.agv, 0
  br i1 %i.agw, label %Py_DECREF.exit74.i338, label %asciilib_rsplit.exit

Py_DECREF.exit74.sink.split.i340:                 ; preds = %bb.lp, %bb.ky
  %.0.i89117.sink.i = phi ptr [ %.0.i83113.i, %bb.ky ], [ %.0.i89117.i, %bb.lp ]
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i89117.sink.i) #33, !inline_history !756
  br label %Py_DECREF.exit74.i338

Py_DECREF.exit74.i338:                            ; preds = %_PyUnicode_FromUCS1.exit.i355, %ucs1lib_find_max_char.exit.i.i364, %Py_DECREF.exit74.sink.split.i340, %bb.lt, %bb.lp, %bb.lo, %_PyUnicode_FromUCS1.exit110.i, %ucs1lib_find_max_char.exit.i91.i, %bb.ky, %bb.kx
  %i.agx = load i32, ptr %i.abk, align 8, !tbaa !237 ; 2 uses
  %.not.i.i339 = icmp sgt i32 %i.agx, -1
  br i1 %.not.i.i339, label %bb.lu, label %asciilib_rsplit.exit

bb.lu:                                            ; preds = %Py_DECREF.exit74.i338
  %i.agy = add nsw i32 %i.agx, -1                 ; 2 uses
  store i32 %i.agy, ptr %i.abk, align 8, !tbaa !237
  %i.agz = icmp eq i32 %i.agy, 0
  br i1 %i.agz, label %bb.lv, label %asciilib_rsplit.exit

bb.lv:                                            ; preds = %bb.lu
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.abk) #33, !inline_history !756
  br label %asciilib_rsplit.exit
...
bb.lx:                                            ; preds = %bb.lw
  %i.aha = load ptr, ptr @PyExc_ValueError, align 8, !tbaa !227
  tail call void @PyErr_SetString(ptr noundef %i.aha, ptr noundef nonnull @.str.197) #33, !inline_history !763
  br label %asciilib_rsplit.exit

bb.ly:                                            ; preds = %bb.lw
  %i.ahb = load i16, ptr %.080, align 2, !tbaa !240
  %i.ahc = tail call i64 @llvm.smin.i64(i64 %.1, i64 11)
end_hunk_2
begin_hunk_3_@charmapencode_lookup:bb.a
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = load i32, ptr %i.c, align 8, !tbaa !237  ; 2 uses
  %.not.i23 = icmp sgt i32 %i.f, -1
  br i1 %.not.i23, label %bb.c, label %Py_DECREF.exit24

bb.c:                                             ; preds = %bb.b
  %i.g = add nsw i32 %i.f, -1                     ; 2 uses
  store i32 %i.g, ptr %i.c, align 8, !tbaa !237
...
bb.f:                                             ; preds = %Py_DECREF.exit24
  %i.j = load ptr, ptr %i.a, align 8, !tbaa !227  ; 6 uses
  %i.k = icmp eq ptr %i.j, null
  br i1 %i.k, label %bb.g, label %bb.i

bb.g:                                             ; preds = %bb.f
  %i.l = load ptr, ptr @PyExc_LookupError, align 8, !tbaa !227
...
bb.j:                                             ; preds = %bb.i
  store ptr %i.j, ptr %2, align 8, !tbaa !227
  br label %Py_DECREF.exit22

bb.k:                                             ; preds = %bb.i
  %i.o = getelementptr i8, ptr %i.j, i64 8
  %.val27 = load ptr, ptr %i.o, align 8, !tbaa !229
  %i.p = getelementptr i8, ptr %.val27, i64 168
  %.val29 = load i64, ptr %i.p, align 8, !tbaa !234 ; 2 uses
...
bb.p:                                             ; preds = %bb.l
  %i.y = load ptr, ptr %i.a, align 8, !tbaa !227
  store ptr %i.y, ptr %2, align 8, !tbaa !227
  %i.z = trunc nuw nsw i64 %i.r to i32
  store i32 %i.z, ptr %3, align 4, !tbaa !43
  br label %Py_DECREF.exit22
...
bb.s:                                             ; preds = %bb.q
  %i.ab = load ptr, ptr @PyExc_TypeError, align 8, !tbaa !227
  call void @PyErr_SetString(ptr noundef %i.ab, ptr noundef nonnull @.str.186) #33
  %i.ac = load ptr, ptr %i.a, align 8, !tbaa !227 ; 3 uses
  %i.ad = load i32, ptr %i.ac, align 8, !tbaa !237 ; 2 uses
  %.not.i = icmp sgt i32 %i.ad, -1
  br i1 %.not.i, label %bb.t, label %Py_DECREF.exit22

bb.t:                                             ; preds = %bb.s
  %i.ae = add nsw i32 %i.ad, -1                   ; 2 uses
  store i32 %i.ae, ptr %i.ac, align 8, !tbaa !237
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.g = load i8, ptr %1, align 1, !tbaa !237     ; 5 uses
  %i.h = and i8 %i.g, 63
...
.preheader56.i.i.i:                               ; preds = %.lr.ph.i70.i.i, %.lr.ph.i70.i.i.prol.loopexit
  %.lcssa = phi i64 [ %.lcssa.unr, %.lr.ph.i70.i.i.prol.loopexit ], [ %i.bg, %.lr.ph.i70.i.i ] ; 2 uses
  %spec.select.i.i.i.lcssa = phi i64 [ %spec.select.i.i.i.lcssa.unr, %.lr.ph.i70.i.i.prol.loopexit ], [ %spec.select.i.i.i.1, %.lr.ph.i70.i.i ]
  %i.t = sub nuw i64 %i.b, %2                     ; 2 uses
  %5 = icmp sgt i64 %i.t, -1
  br i1 %5, label %.lr.ph66.split.us.i.i.i, label %asciilib_rfind.exit

.lr.ph66.split.us.i.i.i:                          ; preds = %.preheader56.i.i.i, %bb.i
  %.14865.us.i.i.i = phi i64 [ %i.ar, %bb.i ], [ %i.t, %.preheader56.i.i.i ]
  %.14865.us.i.i.fr.i = freeze i64 %.14865.us.i.i.i ; 6 uses
  %i.u = getelementptr i8, ptr %i.a, i64 %.14865.us.i.i.fr.i ; 4 uses
  %i.v = load i8, ptr %i.u, align 1, !tbaa !237
  %i.w = icmp eq i8 %i.v, %i.g
  br i1 %i.w, label %.preheader.us.i72.i.i, label %bb.d
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.y = load i8, ptr %i.x, align 1, !tbaa !237
  %i.z = and i8 %i.y, 63
  %i.aa = zext nneg i8 %i.z to i64
  %i.ab = shl nuw i64 1, %i.aa
  %i.ac = and i64 %i.ab, %.lcssa
  %.not51.us.i.i.i = icmp eq i64 %i.ac, 0
  %i.ad = select i1 %.not51.us.i.i.i, i64 %2, i64 0
  br label %bb.i

.preheader.us.i72.i.i:                            ; preds = %.lr.ph66.split.us.i.i.i, %bb.f
  %.04662.us.i.i.i = phi i64 [ %i.ai, %bb.f ], [ %i.f, %.lr.ph66.split.us.i.i.i ] ; 4 uses
  %i.ae = getelementptr i8, ptr %i.u, i64 %.04662.us.i.i.i
  %i.af = load i8, ptr %i.ae, align 1, !tbaa !237
  %i.ag = getelementptr i8, ptr %1, i64 %.04662.us.i.i.i
  %i.ah = load i8, ptr %i.ag, align 1, !tbaa !237
  %.not52.us.i.i.i = icmp eq i8 %i.af, %i.ah
  br i1 %.not52.us.i.i.i, label %bb.f, label %.thread.us.i73.i.i

bb.f:                                             ; preds = %.preheader.us.i72.i.i
  %i.ai = add nsw i64 %.04662.us.i.i.i, -1
  %i.aj = icmp sgt i64 %.04662.us.i.i.i, 1
  br i1 %i.aj, label %.preheader.us.i72.i.i, label %asciilib_fastsearch.exit.i, !llvm.loop !25
...
bb.g:                                             ; preds = %.thread.us.i73.i.i
  %i.ak = getelementptr i8, ptr %i.u, i64 -1
  %i.al = load i8, ptr %i.ak, align 1, !tbaa !237
  %i.am = and i8 %i.al, 63
...
bb.i:                                             ; preds = %bb.h, %bb.g, %bb.e
  %spec.select.lcssa.sink.i.i.i = phi i64 [ %spec.select.i.i.i.lcssa, %bb.h ], [ %i.ad, %bb.e ], [ %2, %bb.g ]
  %i.aq = sub nsw i64 %.14865.us.i.i.fr.i, %spec.select.lcssa.sink.i.i.i ; 2 uses
  %i.ar = add nsw i64 %i.aq, -1
  %i.as = icmp sgt i64 %i.aq, 0
  br i1 %i.as, label %.lr.ph66.split.us.i.i.i, label %asciilib_rfind.exit, !llvm.loop !26

.lr.ph.i70.i.i:                                   ; preds = %.lr.ph.i70.i.i.prol.loopexit, %.lr.ph.i70.i.i
  %.060.i.i.i = phi i64 [ %spec.select.i.i.i.1, %.lr.ph.i70.i.i ], [ %.060.i.i.i.unr, %.lr.ph.i70.i.i.prol.loopexit ]
  %.04759.i.i.i = phi i64 [ %i.bi, %.lr.ph.i70.i.i ], [ %.04759.i.i.i.unr, %.lr.ph.i70.i.i.prol.loopexit ] ; 4 uses
  %.04958.i.i.i = phi i64 [ %i.bg, %.lr.ph.i70.i.i ], [ %.04958.i.i.i.unr, %.lr.ph.i70.i.i.prol.loopexit ]
  ...
  %spec.select.i.i.i = select i1 %i.az, i64 %i.ba, i64 %.060.i.i.i
  ...
  %spec.select.i.i.i.1 = select i1 %i.bh, i64 %i.bi, i64 %spec.select.i.i.i ; 2 uses
  %i.bj = icmp sgt i64 %.04759.i.i.i, 2
  br i1 %i.bj, label %.lr.ph.i70.i.i, label %.preheader56.i.i.i, !llvm.loop !27

asciilib_fastsearch.exit.i:                       ; preds = %bb.f
...
asciilib_rfind.exit:                              ; preds = %bb.d, %bb.i, %bb.a, %bb.b, %.preheader56.i.i.i, %asciilib_fastsearch.exit.i
  %.011.i = phi i64 [ %4, %bb.a ], [ -1, %bb.b ], [ %spec.select.i, %asciilib_fastsearch.exit.i ], [ -1, %.preheader56.i.i.i ], [ -1, %bb.i ], [ -1, %bb.d ]
  ret i64 %.011.i
}

; Function Attrs: inlinehint nofree norecurse nosync nounwind memory(argmem: read) uwtable
define internal fastcc noundef i64 @ucs1lib_rfind_slice(ptr nofree noundef readonly captures(none) %0, ptr nofree noundef readonly captures(none) %1, i64 noundef range(i64 2, 1) %2, i64 noundef %3, i64 noundef %4) unnamed_addr #23 {
bb.a:
  %i.a = getelementptr i8, ptr %0, i64 %3
  %i.b = sub i64 %4, %3                           ; 2 uses
  %i.c = icmp eq i64 %2, 0
...
.lr.ph.i75.i.i.prol:                              ; preds = %bb.c
  ...
  %i.q = icmp eq i8 %i.l, %i.g
  %i.r = add nsw i64 %2, -2                       ; 2 uses
  %spec.select.i76.i.i.prol = select i1 %i.q, i64 %i.r, i64 %i.f ; 2 uses
  br label %.lr.ph.i75.i.i.prol.loopexit

.lr.ph.i75.i.i.prol.loopexit:                     ; preds = %.lr.ph.i75.i.i.prol, %bb.c
  %.060.i.i.i.unr = phi i64 [ %i.f, %bb.c ], [ %spec.select.i76.i.i.prol, %.lr.ph.i75.i.i.prol ]
  %.04759.i.i.i.unr = phi i64 [ %i.f, %bb.c ], [ %i.r, %.lr.ph.i75.i.i.prol ]
  %.04958.i.i.i.unr = phi i64 [ %i.j, %bb.c ], [ %i.p, %.lr.ph.i75.i.i.prol ]
  %.lcssa.unr = phi i64 [ poison, %bb.c ], [ %i.p, %.lr.ph.i75.i.i.prol ]
  %spec.select.i76.i.i.lcssa.unr = phi i64 [ poison, %bb.c ], [ %spec.select.i76.i.i.prol, %.lr.ph.i75.i.i.prol ]
  %i.s = icmp eq i64 %2, 2
  br i1 %i.s, label %.preheader56.i.i.i, label %.lr.ph.i75.i.i

.preheader56.i.i.i:                               ; preds = %.lr.ph.i75.i.i, %.lr.ph.i75.i.i.prol.loopexit
  %.lcssa = phi i64 [ %.lcssa.unr, %.lr.ph.i75.i.i.prol.loopexit ], [ %i.bg, %.lr.ph.i75.i.i ] ; 2 uses
  %spec.select.i76.i.i.lcssa = phi i64 [ %spec.select.i76.i.i.lcssa.unr, %.lr.ph.i75.i.i.prol.loopexit ], [ %spec.select.i76.i.i.1, %.lr.ph.i75.i.i ]
  %i.t = sub nuw i64 %i.b, %2                     ; 2 uses
  %5 = icmp sgt i64 %i.t, -1
  br i1 %5, label %.lr.ph66.split.us.i.i.i, label %ucs1lib_rfind.exit
...
.lr.ph66.split.us.i.i.i:                          ; preds = %.preheader56.i.i.i, %bb.i
  ...
  %i.v = load i8, ptr %i.u, align 1, !tbaa !237
  %i.w = icmp eq i8 %i.v, %i.g
  br i1 %i.w, label %.preheader.us.i78.i.i, label %bb.d

bb.d:                                             ; preds = %.lr.ph66.split.us.i.i.i
  %.not.us.i77.i.i = icmp eq i64 %.14865.us.i.i.fr.i, 0
  br i1 %.not.us.i77.i.i, label %ucs1lib_rfind.exit, label %bb.e
...
.preheader.us.i78.i.i:                            ; preds = %.lr.ph66.split.us.i.i.i, %bb.f
  %.04662.us.i.i.i = phi i64 [ %i.ai, %bb.f ], [ %i.f, %.lr.ph66.split.us.i.i.i ] ; 4 uses
  %i.ae = getelementptr i8, ptr %i.u, i64 %.04662.us.i.i.i
  %i.af = load i8, ptr %i.ae, align 1, !tbaa !237
  %i.ag = getelementptr i8, ptr %1, i64 %.04662.us.i.i.i
  %i.ah = load i8, ptr %i.ag, align 1, !tbaa !237
  %.not52.us.i.i.i = icmp eq i8 %i.af, %i.ah
  br i1 %.not52.us.i.i.i, label %bb.f, label %.thread.us.i.i.i

bb.f:                                             ; preds = %.preheader.us.i78.i.i
  %i.ai = add nsw i64 %.04662.us.i.i.i, -1
  %i.aj = icmp sgt i64 %.04662.us.i.i.i, 1
  br i1 %i.aj, label %.preheader.us.i78.i.i, label %ucs1lib_fastsearch.exit.i, !llvm.loop !28

.thread.us.i.i.i:                                 ; preds = %.preheader.us.i78.i.i
  %.not53.us.i.i.i = icmp eq i64 %.14865.us.i.i.fr.i, 0
  br i1 %.not53.us.i.i.i, label %bb.h, label %bb.g

bb.g:                                             ; preds = %.thread.us.i.i.i
  %i.ak = getelementptr i8, ptr %i.u, i64 -1
  %i.al = load i8, ptr %i.ak, align 1, !tbaa !237
  %i.am = and i8 %i.al, 63
  %i.an = zext nneg i8 %i.am to i64
...
.lr.ph.i75.i.i:                                   ; preds = %.lr.ph.i75.i.i.prol.loopexit, %.lr.ph.i75.i.i
  ...
  %i.bj = icmp sgt i64 %.04759.i.i.i, 2
  br i1 %i.bj, label %.lr.ph.i75.i.i, label %.preheader56.i.i.i, !llvm.loop !30
...
ucs1lib_rfind.exit:                               ; preds = %bb.d, %bb.i, %bb.a, %bb.b, %.preheader56.i.i.i, %ucs1lib_fastsearch.exit.i
  %.011.i = phi i64 [ %4, %bb.a ], [ -1, %bb.b ], [ %spec.select.i, %ucs1lib_fastsearch.exit.i ], [ -1, %.preheader56.i.i.i ], [ -1, %bb.i ], [ -1, %bb.d ]
  ret i64 %.011.i
}
...
.preheader56.i:                                   ; preds = %.lr.ph.i70, %.lr.ph.i70.prol.loopexit
  ...
  %5 = icmp sgt i64 %i.dr, -1
  br i1 %5, label %.lr.ph66.split.us.i, label %asciilib_find_char.exit

.lr.ph66.split.us.i:                              ; preds = %.preheader56.i, %bb.aj
  %.14865.us.i = phi i64 [ %i.ep, %bb.aj ], [ %i.dr, %.preheader56.i ] ; 5 uses
...
.lr.ph.i70:                                       ; preds = %.lr.ph.i70.prol.loopexit, %.lr.ph.i70
  ...
  br i1 %i.fh, label %.lr.ph.i70, label %.preheader56.i, !llvm.loop !27
...
bb.v:                                             ; preds = %bb.u
  %i.eg = add i64 %.0124205.us.i, 1               ; 2 uses
  %exitcond280.not.i = icmp eq i64 %i.eg, %3
  br i1 %exitcond280.not.i, label %..preheader_crit_edge.us.i, label %bb.u, !llvm.loop !828

bb.w:                                             ; preds = %.lr.ph210.us.i
  %i.eh = add nuw nsw i64 %.0209.us.i, 1          ; 2 uses
  %exitcond281.not.i = icmp eq i64 %i.eh, %.fr239.i
  br i1 %exitcond281.not.i, label %.thread170.i, label %.lr.ph210.us.i, !llvm.loop !829

.lr.ph210.us.i:                                   ; preds = %..preheader_crit_edge.us.i, %bb.w
  %.0209.us.i = phi i64 [ %i.eh, %bb.w ], [ 0, %..preheader_crit_edge.us.i ] ; 3 uses
  %i.ei = getelementptr i8, ptr %2, i64 %.0209.us.i
  %i.ej = load i8, ptr %i.ei, align 1, !tbaa !237
  %i.ek = getelementptr i8, ptr %i.eb, i64 %.0209.us.i
  %i.el = load i8, ptr %i.ek, align 1, !tbaa !237
  %.not151.us.i = icmp eq i8 %i.ej, %i.el
  br i1 %.not151.us.i, label %bb.w, label %.thread167.us.i

.thread167.us.i:                                  ; preds = %.lr.ph210.us.i
  %i.em = getelementptr i8, ptr %i.dz, i64 %i.dp
end_hunk_3
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load144 = load <2 x i8>, ptr %i.ak, align 1, !tbaa !237
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %ucs1lib_find_char.exit, label %.lr.ph.i68.preheader145
...
.preheader56.i:                                   ; preds = %.lr.ph.i75, %.lr.ph.i75.prol.loopexit
  ...
  br i1 %7, label %.lr.ph66.split.us.i, label %ucs1lib_find_char.exit
...
.lr.ph.i75:                                       ; preds = %.lr.ph.i75.prol.loopexit, %.lr.ph.i75
  ...
  br i1 %i.gk, label %.lr.ph.i75, label %.preheader56.i, !llvm.loop !30
...
.lr.ph151.split.us:                               ; preds = %.lr.ph151.split.us.preheader, %bb.l
  ...
  %i.ag = load i8, ptr %i.af, align 1, !tbaa !237
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.aj = load i8, ptr %i.ai, align 1, !tbaa !237
  %i.ak = and i8 %i.aj, 63
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %exitcond225.not, label %._crit_edge141.us.thread, label %bb.c, !llvm.loop !848
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.bb = load i8, ptr %i.ba, align 1, !tbaa !237
  %i.bc = and i8 %i.bb, 63
  %i.bd = zext nneg i8 %i.bc to i64
...
bb.h:                                             ; preds = %.lr.ph207.us, %bb.i
  ...
  %i.by = load i8, ptr %i.bx, align 1, !tbaa !237
...
.lr.ph.i.preheader:                               ; preds = %bb.v
  %min.iters.check178 = icmp ult i64 %1, 4
  br i1 %min.iters.check178, label %.lr.ph.i.preheader197, label %vector.ph179

vector.ph179:                                     ; preds = %.lr.ph.i.preheader
  %n.vec180 = and i64 %1, -4                      ; 3 uses
  %broadcast.splatinsert181 = insertelement <2 x i16> poison, i16 %i.au, i64 0
  %broadcast.splat182 = shufflevector <2 x i16> %broadcast.splatinsert181, <2 x i16> poison, <2 x i32> zeroinitializer ; 2 uses
  br label %vector.body183

vector.body183:                                   ; preds = %vector.body183, %vector.ph179
  %index184 = phi i64 [ 0, %vector.ph179 ], [ %index.next189, %vector.body183 ] ; 2 uses
  %vec.phi185 = phi <2 x i64> [ zeroinitializer, %vector.ph179 ], [ %i.bb, %vector.body183 ]
  %vec.phi186 = phi <2 x i64> [ zeroinitializer, %vector.ph179 ], [ %i.bc, %vector.body183 ]
  %i.av = getelementptr [2 x i8], ptr %0, i64 %index184 ; 2 uses
  %i.aw = getelementptr i8, ptr %i.av, i64 4
  %wide.load187 = load <2 x i16>, ptr %i.av, align 2, !tbaa !240
  %wide.load188 = load <2 x i16>, ptr %i.aw, align 2, !tbaa !240
  %i.ax = icmp eq <2 x i16> %wide.load187, %broadcast.splat182
  %i.ay = icmp eq <2 x i16> %wide.load188, %broadcast.splat182
  %i.az = zext <2 x i1> %i.ax to <2 x i64>
  %i.ba = zext <2 x i1> %i.ay to <2 x i64>
  %i.bb = add <2 x i64> %vec.phi185, %i.az        ; 2 uses
  %i.bc = add <2 x i64> %vec.phi186, %i.ba        ; 2 uses
  %index.next189 = add nuw i64 %index184, 4       ; 2 uses
  %i.bd = icmp eq i64 %index.next189, %n.vec180
  br i1 %i.bd, label %middle.block190, label %vector.body183, !llvm.loop !858

middle.block190:                                  ; preds = %vector.body183
  %bin.rdx191 = add <2 x i64> %i.bc, %i.bb
  %i.be = tail call i64 @llvm.vector.reduce.add.v2i64(<2 x i64> %bin.rdx191) ; 2 uses
  %cmp.n192 = icmp eq i64 %1, %n.vec180
  br i1 %cmp.n192, label %ucs2lib_rfind_char.exit, label %.lr.ph.i.preheader197

.lr.ph.i.preheader197:                            ; preds = %.lr.ph.i.preheader, %middle.block190
  %.09.i.ph = phi i64 [ 0, %.lr.ph.i.preheader ], [ %n.vec180, %middle.block190 ]
  %.078.i.ph = phi i64 [ 0, %.lr.ph.i.preheader ], [ %i.be, %middle.block190 ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader197, %.lr.ph.i
  %.09.i = phi i64 [ %i.bj, %.lr.ph.i ], [ %.09.i.ph, %.lr.ph.i.preheader197 ] ; 2 uses
  %.078.i = phi i64 [ %spec.select.i, %.lr.ph.i ], [ %.078.i.ph, %.lr.ph.i.preheader197 ]
...
vector.ph:                                        ; preds = %bb.ab
  ...
  %broadcast.splat = shufflevector <2 x i64> %broadcast.splatinsert, <2 x i64> poison, <2 x i32> zeroinitializer ; 2 uses
  %broadcast.splatinsert145 = insertelement <2 x i16> poison, i16 %i.bw, i64 0
  %broadcast.splat146 = shufflevector <2 x i16> %broadcast.splatinsert145, <2 x i16> poison, <2 x i32> zeroinitializer
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi147 = phi <2 x i64> [ %broadcast.splat, %vector.ph ], [ %i.cj, %vector.body ]
  ...
  %i.cd = icmp eq <2 x i16> %wide.load, %broadcast.splat146
  ...
  %.not195 = icmp eq i2 %i.ch, 0                  ; 2 uses
  %i.ci = select i1 %.not195, <2 x i1> %i.bx, <2 x i1> %i.ce ; 2 uses
  %i.cj = select i1 %.not195, <2 x i64> %vec.phi147, <2 x i64> %i.cg ; 2 uses
...
._crit_edge.i:                                    ; preds = %.lr.ph.i69, %middle.block
  %.lcssa144 = phi i64 [ %i.cl, %middle.block ], [ %i.ea, %.lr.ph.i69 ]
  ...
  %i.cr = shl nuw i64 1, %i.cq
  %i.cs = or i64 %.lcssa144, %i.cr                ; 2 uses
...
.loopexit.i:                                      ; preds = %bb.al, %._crit_edge.i
  %.375.ph.i = phi i64 [ 0, %._crit_edge.i ], [ %.274.us.i, %bb.al ]
  %i.ef = select i1 %i.b, i64 %.375.ph.i, i64 -1
  br label %ucs2lib_rfind_char.exit
...
bb.ar:                                            ; preds = %bb.y
  ...
  %min.iters.check150 = icmp ult i64 %3, 7
...
vector.ph151:                                     ; preds = %bb.ar
  ...
  %broadcast.splatinsert153.a = insertelement <2 x i16> poison, i16 %i.ep, i64 0
  %broadcast.splat154.a = shufflevector <2 x i16> %broadcast.splatinsert153.a, <2 x i16> poison, <2 x i32> zeroinitializer ; 2 uses
...
vector.body157:                                   ; preds = %vector.body157, %vector.ph151
  ...
  %vec.phi159.a = phi <2 x i64> [ splat (i64 9223372036854775807), %vector.ph151 ], [ %i.fk, %vector.body157 ]
  %vec.phi160.a = phi <2 x i64> [ splat (i64 9223372036854775807), %vector.ph151 ], [ %i.fl, %vector.body157 ]
  %vec.phi161 = phi <2 x i1> [ zeroinitializer, %vector.ph151 ], [ %i.fm, %vector.body157 ]
  %vec.phi162.a = phi <2 x i1> [ zeroinitializer, %vector.ph151 ], [ %i.fn, %vector.body157 ]
  ...
  %wide.load166 = load <2 x i16>, ptr %i.ey, align 2, !tbaa !240
  %wide.load167 = load <2 x i16>, ptr %i.ez, align 2, !tbaa !240
  ...
  %i.fi = icmp eq <2 x i16> %reverse, %broadcast.splat154.a ; 2 uses
  %i.fj = icmp eq <2 x i16> %reverse168, %broadcast.splat154.a ; 2 uses
  %i.fk = select <2 x i1> %i.fi, <2 x i64> %vec.ind163, <2 x i64> %vec.phi159.a ; 2 uses
  %i.fl = select <2 x i1> %i.fj, <2 x i64> %step.add, <2 x i64> %vec.phi160.a ; 2 uses
  %i.fm = or <2 x i1> %vec.phi161, %i.fi          ; 2 uses
  %i.fn = or <2 x i1> %vec.phi162.a, %i.fj        ; 2 uses
  ...
  br i1 %i.fo, label %middle.block171, label %vector.body157, !llvm.loop !865
...
.preheader56.i:                                   ; preds = %.lr.ph.i71, %middle.block171
  %.lcssa143 = phi i64 [ %i.fs, %middle.block171 ], [ %i.gy, %.lr.ph.i71 ] ; 2 uses
  %spec.select.i72.lcssa = phi i64 [ %rdx.select, %middle.block171 ], [ %spec.select.i72, %.lr.ph.i71 ]
  %i.ft = sub i64 %1, %3                          ; 2 uses
  %6 = icmp sgt i64 %i.ft, -1
  br i1 %6, label %.lr.ph66.split.us.i, label %ucs2lib_rfind_char.exit

.lr.ph66.split.us.i:                              ; preds = %.preheader56.i, %bb.ax
  %.14865.us.i = phi i64 [ %i.gr, %bb.ax ], [ %i.ft, %.preheader56.i ] ; 5 uses
...
.lr.ph.i71:                                       ; preds = %.lr.ph.i71.preheader, %.lr.ph.i71
  ...
  br i1 %i.hb, label %.lr.ph.i71, label %.preheader56.i, !llvm.loop !868
...
.lr.ph151.split.us:                               ; preds = %.lr.ph151.split.us.preheader, %bb.l
  ...
  %i.ag = load i16, ptr %i.af, align 2, !tbaa !240
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.aj = load i16, ptr %i.ai, align 2, !tbaa !240
...
bb.c:                                             ; preds = %.preheader.us, %bb.d
  ...
  %i.aq = load i16, ptr %i.ap, align 2, !tbaa !240
  %i.ar = getelementptr [2 x i8], ptr %2, i64 %.0139.us
  %i.as = load i16, ptr %i.ar, align 2, !tbaa !240
...
bb.d:                                             ; preds = %bb.c
  %i.at = add nuw nsw i64 %.0139.us, 1            ; 2 uses
  %exitcond225.not = icmp eq i64 %i.at, %i.b
  br i1 %exitcond225.not, label %._crit_edge141.us.thread, label %bb.c, !llvm.loop !870
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.bb = load i16, ptr %i.ba, align 2, !tbaa !240
...
.preheader177.us.backedge:                        ; preds = %.preheader177.us, %bb.l
  %.6143.us.be = phi ptr [ %i.bv, %.preheader177.us ], [ %.9.us, %bb.l ]
  br label %.preheader177.us
...
bb.h:                                             ; preds = %.lr.ph207.us, %bb.i
  %.0124205.us = phi i64 [ %.fr239, %.lr.ph207.us ], [ %i.cc, %bb.i ] ; 5 uses
  %i.by = getelementptr [2 x i8], ptr %i.g, i64 %.0124205.us
  %i.bz = load i16, ptr %i.by, align 2, !tbaa !240
  %i.ca = getelementptr [2 x i8], ptr %i.bx, i64 %.0124205.us
  %i.cb = load i16, ptr %i.ca, align 2, !tbaa !240
  %.not153.us = icmp eq i16 %i.bz, %i.cb
  br i1 %.not153.us, label %bb.i, label %bb.k

bb.i:                                             ; preds = %bb.h
  %i.cc = add i64 %.0124205.us, 1                 ; 2 uses
end_hunk_7
...
.lr.ph.i69.preheader:                             ; preds = %bb.y
  %min.iters.check = icmp ult i64 %1, 4
  br i1 %min.iters.check, label %.lr.ph.i69.preheader162, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi160 = phi <2 x i64> [ zeroinitializer, %vector.ph ], [ %i.bo, %vector.body ]
...
middle.block:                                     ; preds = %vector.body
  ...
  %cmp.n = icmp eq i64 %1, %n.vec
  br i1 %cmp.n, label %ucs4lib_find_char.exit, label %.lr.ph.i69.preheader162

.lr.ph.i69.preheader162:                          ; preds = %.lr.ph.i69.preheader, %middle.block
  %.09.i.ph = phi i64 [ 0, %.lr.ph.i69.preheader ], [ %n.vec, %middle.block ]
  %.078.i.ph = phi i64 [ 0, %.lr.ph.i69.preheader ], [ %i.bq, %middle.block ]
  br label %.lr.ph.i69

.lr.ph.i69:                                       ; preds = %.lr.ph.i69.preheader162, %.lr.ph.i69
  %.09.i = phi i64 [ %i.bv, %.lr.ph.i69 ], [ %.09.i.ph, %.lr.ph.i69.preheader162 ] ; 2 uses
  %.078.i = phi i64 [ %spec.select.i, %.lr.ph.i69 ], [ %.078.i.ph, %.lr.ph.i69.preheader162 ]
...
.lr.ph.i72.epil.preheader:                        ; preds = %._crit_edge.i.unr-lcssa, %bb.ae
  ...
  %lcmp.mod182 = trunc i64 %i.cg to i1
...
.lr.ph113.split.us.i:                             ; preds = %bb.ao, %.lr.ph113.split.us.preheader.i
  %.066110.us.i = phi i64 [ %i.dz, %bb.ao ], [ 0, %.lr.ph113.split.us.preheader.i ] ; 9 uses
  %.072109.us.i = phi i64 [ %.274.us.i, %bb.ao ], [ 0, %.lr.ph113.split.us.preheader.i ] ; 4 uses
...
.loopexit.i:                                      ; preds = %bb.ao, %._crit_edge.i
  %.375.ph.i = phi i64 [ 0, %._crit_edge.i ], [ %.274.us.i, %bb.ao ]
  %6 = icmp eq i32 %5, 0
  %i.ev = select i1 %6, i64 %.375.ph.i, i64 -1
  br label %ucs4lib_find_char.exit
...
bb.au:                                            ; preds = %bb.ab
  ...
  %xtraiter184 = and i64 %i.fe, 1
  %lcmp.mod185.not = icmp eq i64 %xtraiter184, 0
  br i1 %lcmp.mod185.not, label %.lr.ph.i74.prol.loopexit, label %.lr.ph.i74.prol
...
.lr.ph.i74.prol.loopexit:                         ; preds = %.lr.ph.i74.prol, %bb.au
  ...
  %.lcssa176.unr = phi i64 [ poison, %bb.au ], [ %i.fo, %.lr.ph.i74.prol ]
  %spec.select.i75.lcssa.unr = phi i64 [ poison, %bb.au ], [ %spec.select.i75.prol, %.lr.ph.i74.prol ]
  %i.fr = icmp eq i64 %3, 2
  br i1 %i.fr, label %.preheader56.i, label %.lr.ph.i74

.preheader56.i:                                   ; preds = %.lr.ph.i74, %.lr.ph.i74.prol.loopexit
  %.lcssa176 = phi i64 [ %.lcssa176.unr, %.lr.ph.i74.prol.loopexit ], [ %i.hf, %.lr.ph.i74 ] ; 2 uses
  %spec.select.i75.lcssa = phi i64 [ %spec.select.i75.lcssa.unr, %.lr.ph.i74.prol.loopexit ], [ %spec.select.i75.1, %.lr.ph.i74 ]
  %i.fs = sub i64 %1, %3                          ; 2 uses
  %7 = icmp sgt i64 %i.fs, -1
  br i1 %7, label %.lr.ph66.split.us.i, label %ucs4lib_find_char.exit

.lr.ph66.split.us.i:                              ; preds = %.preheader56.i, %bb.ba
  %.14865.us.i = phi i64 [ %i.gq, %bb.ba ], [ %i.fs, %.preheader56.i ] ; 5 uses
...
.lr.ph.i74:                                       ; preds = %.lr.ph.i74.prol.loopexit, %.lr.ph.i74
  ...
  br i1 %i.hi, label %.lr.ph.i74, label %.preheader56.i, !llvm.loop !888

ucs4lib_find_char.exit:                           ; preds = %bb.am, %._crit_edge104.us.thread.i.loopexit, %bb.ba, %bb.av, %bb.ax, %bb.m, %bb.l, %bb.v, %bb.i, %bb.aa, %bb.z, %.lr.ph.i69, %middle.block, %.preheader56.i, %.loopexit.i, %bb.x, %bb.s, %bb.h, %bb.g, %bb.f, %.preheader.i, %bb.c, %bb.a, %bb.at, %bb.as, %bb.ar
  %.0 = phi i64 [ -1, %bb.i ], [ -1, %bb.a ], [ -1, %bb.c ], [ -1, %bb.ba ], [ %spec.select.i, %.lr.ph.i69 ], [ -1, %.preheader56.i ], [ -1, %bb.v ], [ %i.fb, %bb.ar ], [ %i.fc, %bb.as ], [ %i.fd, %bb.at ], [ %i.k, %bb.g ], [ -1, %bb.f ], [ %i.q, %bb.h ], [ -1, %.preheader.i ], [ %i.be, %bb.x ], [ %.14865.us.i, %bb.ax ], [ %i.ar, %bb.s ], [ %4, %bb.z ], [ %i.ev, %.loopexit.i ], [ -1, %bb.l ], [ %i.bq, %middle.block ], [ %.1.i, %bb.aa ], [ %i.ae, %bb.m ], [ -1, %bb.av ], [ %.066110.us.i, %._crit_edge104.us.thread.i.loopexit ], [ %4, %bb.am ]
  ret i64 %.0
}
...
bb.d:                                             ; preds = %bb.c
  %i.at = add nuw nsw i64 %.0139.us, 1            ; 2 uses
  %exitcond225.not = icmp eq i64 %i.at, %i.b
  br i1 %exitcond225.not, label %._crit_edge141.us.thread, label %bb.c, !llvm.loop !890
...
bb.h:                                             ; preds = %.lr.ph207.us, %bb.i
  %.0124205.us = phi i64 [ %.fr239, %.lr.ph207.us ], [ %i.cc, %bb.i ] ; 5 uses
  %i.by = getelementptr [4 x i8], ptr %i.g, i64 %.0124205.us
  %i.bz = load i32, ptr %i.by, align 4, !tbaa !43
  %i.ca = getelementptr [4 x i8], ptr %i.bx, i64 %.0124205.us
  %i.cb = load i32, ptr %i.ca, align 4, !tbaa !43
  %.not153.us = icmp eq i32 %i.bz, %i.cb
  br i1 %.not153.us, label %bb.i, label %bb.k
