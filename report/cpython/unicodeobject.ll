...
.outer.outer:                                     ; preds = %.outer.outer.backedge, %bb.d
  ...
  %.0110.ph.ph = phi i64 [ 0, %bb.d ], [ %.0110.ph.ph.be, %.outer.outer.backedge ] ; 10 uses
  %.0108.ph.ph = phi i32 [ 0, %bb.d ], [ %.0108.ph.ph.be, %.outer.outer.backedge ]
  %.0106.ph.ph = phi i64 [ 0, %bb.d ], [ %.0106.ph.ph.be, %.outer.outer.backedge ]
  %.0104.ph.ph = phi i32 [ 0, %bb.d ], [ %.0104.ph.ph.be, %.outer.outer.backedge ]
  br label %.outer
...
.lr.ph.preheader:                                 ; preds = %.outer
  ...
  br i1 %.0112.ph, label %.loopexit, label %bb.e
...
bb.n:                                             ; preds = %bb.m
  ...
  %.not136.peel = icmp eq i32 %.0104.ph, 0
...
.loopexit476:                                     ; preds = %bb.o
  ...
  %i.cp = load i32, ptr %i.k, align 4, !tbaa !276
  %.not.i144 = icmp ugt i32 %.0104.ph, %i.cp
  br i1 %.not.i144, label %bb.ag, label %bb.af

bb.af:                                            ; preds = %.loopexit476
  %i.cq = load i64, ptr %i.l, align 8, !tbaa !278
  %i.cr = load i64, ptr %i.m, align 8, !tbaa !279 ; 2 uses
  %i.cs = sub i64 %i.cq, %i.cr
  %i.ct = icmp sgt i64 %i.cs, 0
  br i1 %i.ct, label %.critedge.i148, label %bb.ag

bb.ag:                                            ; preds = %bb.af, %.loopexit476
  %i.cu = call i32 @_PyUnicodeWriter_PrepareInternal(ptr noundef nonnull %4, i64 noundef 1, i32 noundef %.0104.ph) #33
  %i.cv = icmp slt i32 %i.cu, 0
  br i1 %i.cv, label %.thread213, label %..critedge_crit_edge.i145
...
.critedge.i148:                                   ; preds = %..critedge_crit_edge.i145, %bb.af
  %i.cw = phi i64 [ %.pre.i147, %..critedge_crit_edge.i145 ], [ %i.cr, %bb.af ] ; 5 uses
  %i.cx = load i32, ptr %i.n, align 8, !tbaa !280
  %i.cy = load ptr, ptr %i.o, align 8, !tbaa !281 ; 3 uses
  switch i32 %i.cx, label %bb.aj [
    i32 1, label %bb.ah
    i32 2, label %bb.ai
  ]

bb.ah:                                            ; preds = %.critedge.i148
  %i.cz = trunc i32 %.0104.ph to i8
  %i.da = getelementptr i8, ptr %i.cy, i64 %i.cw
...
bb.ai:                                            ; preds = %.critedge.i148
  %i.db = trunc i32 %.0104.ph to i16
  %i.dc = getelementptr [2 x i8], ptr %i.cy, i64 %i.cw
  store i16 %i.db, ptr %i.dc, align 2, !tbaa !208
  br label %_PyUnicodeWriter_WriteCharInline.exit152

bb.aj:                                            ; preds = %.critedge.i148
  %i.dd = getelementptr [4 x i8], ptr %i.cy, i64 %i.cw
  store i32 %.0104.ph, ptr %i.dd, align 4, !tbaa !7
  br label %_PyUnicodeWriter_WriteCharInline.exit152

_PyUnicodeWriter_WriteCharInline.exit152:         ; preds = %bb.ah, %bb.ai, %bb.aj
  %i.de = phi i64 [ %.pre11.i151, %bb.ah ], [ %i.cw, %bb.ai ], [ %i.cw, %bb.aj ]
  %i.df = add i64 %i.de, 1
  store i64 %i.df, ptr %i.m, align 8, !tbaa !279
  br label %bb.ak

.loopexit233.loopexit:                            ; preds = %bb.ae
  %indvars.iv.next = add i32 %.0108.ph, -20       ; 3 uses
  %notmask = shl nsw i32 -1, %indvars.iv.next
  %i.dg = xor i32 %notmask, -1
  %i.dh = zext nneg i32 %i.dg to i64
  %i.di = and i64 %i.cn, %i.dh
  %i.dj = zext nneg i32 %indvars.iv.next to i64
  %i.dk = lshr i64 %i.cn, %i.dj                   ; 2 uses
...
.loopexit233:                                     ; preds = %bb.n, %.loopexit233.loopexit
  ...
  %.lcssa417 = phi i64 [ %i.dk, %.loopexit233.loopexit ], [ %i.at, %bb.n ]
  %.lcssa413 = phi i32 [ %i.dl, %.loopexit233.loopexit ], [ %i.au, %bb.n ] ; 2 uses
  %.lcssa409 = phi i64 [ %i.di, %.loopexit233.loopexit ], [ %i.ax, %bb.n ]
  %.lcssa395 = phi ptr [ %i.co, %.loopexit233.loopexit ], [ %i.ar, %bb.n ]
...
bb.ak:                                            ; preds = %.loopexit233, %_PyUnicodeWriter_WriteCharInline.exit152
  ...
  %i.dm = phi i32 [ %.lcssa421, %.loopexit233 ], [ %indvars.peel, %_PyUnicodeWriter_WriteCharInline.exit152 ] ; 2 uses
  %i.dn = phi i64 [ %.lcssa417, %.loopexit233 ], [ %i.at, %_PyUnicodeWriter_WriteCharInline.exit152 ] ; 2 uses
  %i.do = phi i32 [ %.lcssa413, %.loopexit233 ], [ %i.au, %_PyUnicodeWriter_WriteCharInline.exit152 ] ; 4 uses
  %i.dp = phi i64 [ %.lcssa409, %.loopexit233 ], [ %i.ax, %_PyUnicodeWriter_WriteCharInline.exit152 ] ; 2 uses
  %.not230 = icmp eq i32 %.pre-phi, 55296
  br i1 %.not230, label %.outer.outer.backedge, label %bb.al

bb.al:                                            ; preds = %bb.ak
  %i.dq = load i32, ptr %i.k, align 4, !tbaa !276
  %.not.i153 = icmp ult i32 %i.dq, %i.do
  br i1 %.not.i153, label %bb.an, label %bb.am

bb.am:                                            ; preds = %bb.al
  %i.dr = load i64, ptr %i.l, align 8, !tbaa !278
  %i.ds = load i64, ptr %i.m, align 8, !tbaa !279 ; 2 uses
  %i.dt = sub i64 %i.dr, %i.ds
  %i.du = icmp sgt i64 %i.dt, 0
  br i1 %i.du, label %.critedge.i157, label %bb.an

bb.an:                                            ; preds = %bb.am, %bb.al
  %i.dv = call i32 @_PyUnicodeWriter_PrepareInternal(ptr noundef nonnull %4, i64 noundef 1, i32 noundef %i.do) #33
  %i.dw = icmp slt i32 %i.dv, 0
  br i1 %i.dw, label %.thread213, label %..critedge_crit_edge.i154
...
.critedge.i157:                                   ; preds = %..critedge_crit_edge.i154, %bb.am
  %i.dx = phi i64 [ %.pre.i156, %..critedge_crit_edge.i154 ], [ %i.ds, %bb.am ] ; 5 uses
  %i.dy = load i32, ptr %i.n, align 8, !tbaa !280
  %i.dz = load ptr, ptr %i.o, align 8, !tbaa !281 ; 3 uses
  switch i32 %i.dy, label %bb.aq [
    i32 1, label %bb.ao
    i32 2, label %bb.ap
  ]
...
bb.ao:                                            ; preds = %.critedge.i157
  ...
  %i.eb = getelementptr i8, ptr %i.dz, i64 %i.dx
  store i8 %i.ea, ptr %i.eb, align 1, !tbaa !205
  %.pre11.i160 = load i64, ptr %i.m, align 8, !tbaa !279
  br label %_PyUnicodeWriter_WriteCharInline.exit161

bb.ap:                                            ; preds = %.critedge.i157
  %i.ec = trunc i64 %i.dn to i16
  %i.ed = getelementptr [2 x i8], ptr %i.dz, i64 %i.dx
  store i16 %i.ec, ptr %i.ed, align 2, !tbaa !208
  br label %_PyUnicodeWriter_WriteCharInline.exit161

bb.aq:                                            ; preds = %.critedge.i157
  %i.ee = getelementptr [4 x i8], ptr %i.dz, i64 %i.dx
  store i32 %i.do, ptr %i.ee, align 4, !tbaa !7
  br label %_PyUnicodeWriter_WriteCharInline.exit161

_PyUnicodeWriter_WriteCharInline.exit161:         ; preds = %bb.ao, %bb.ap, %bb.aq
  %i.ef = phi i64 [ %.pre11.i160, %bb.ao ], [ %i.dx, %bb.ap ], [ %i.dx, %bb.aq ]
  %i.eg = add i64 %i.ef, 1
  store i64 %i.eg, ptr %i.m, align 8, !tbaa !279
  br label %.outer.outer.backedge

._crit_edge487:                                   ; preds = %bb.x, %bb.f
  %.pre-phi489 = phi i32 [ %.0108.ph, %bb.f ], [ %indvars.peel, %bb.x ] ; 6 uses
  %.0104349.lcssa388 = phi i32 [ %.0104.ph, %bb.f ], [ 0, %bb.x ] ; 8 uses
  %.0106348.lcssa382 = phi i64 [ %.0106.ph, %bb.f ], [ %i.ax, %bb.x ] ; 4 uses
...
bb.ar:                                            ; preds = %._crit_edge487
  %i.eh = icmp ugt i32 %.pre-phi489, 5
...
bb.at:                                            ; preds = %bb.ar
  %.not134 = icmp eq i64 %.0106348.lcssa382, 0
  br i1 %.not134, label %bb.av, label %bb.au

bb.au:                                            ; preds = %bb.at
  %i.ej = getelementptr i8, ptr %.lcssa370, i64 1
  br label %bb.by

bb.av:                                            ; preds = %bb.at, %._crit_edge487
  %.0106348.lcssa382.lcssa = phi i64 [ 0, %bb.at ], [ %.0106348.lcssa382, %._crit_edge487 ] ; 2 uses
  %i.ek = icmp ne i32 %.0104349.lcssa388, 0
  %i.el = icmp sgt i8 %.lcssa363, -1
  %or.cond17 = select i1 %i.ek, i1 %i.el, i1 false
  br i1 %or.cond17, label %bb.aw, label %bb.bc

bb.aw:                                            ; preds = %bb.av
  %i.em = load i32, ptr %i.k, align 4, !tbaa !276
  %.not.i162 = icmp ugt i32 %.0104349.lcssa388, %i.em
  br i1 %.not.i162, label %bb.ay, label %bb.ax

bb.ax:                                            ; preds = %bb.aw
  %i.en = load i64, ptr %i.l, align 8, !tbaa !278
  %i.eo = load i64, ptr %i.m, align 8, !tbaa !279 ; 2 uses
  %i.ep = sub i64 %i.en, %i.eo
  %i.eq = icmp sgt i64 %i.ep, 0
  br i1 %i.eq, label %.critedge.i166, label %bb.ay

bb.ay:                                            ; preds = %bb.ax, %bb.aw
  %i.er = call i32 @_PyUnicodeWriter_PrepareInternal(ptr noundef nonnull %4, i64 noundef 1, i32 noundef %.0104349.lcssa388) #33
  %i.es = icmp slt i32 %i.er, 0
  br i1 %i.es, label %.thread213, label %..critedge_crit_edge.i163
...
.critedge.i166:                                   ; preds = %..critedge_crit_edge.i163, %bb.ax
  %i.et = phi i64 [ %.pre.i165, %..critedge_crit_edge.i163 ], [ %i.eo, %bb.ax ] ; 5 uses
  %i.eu = load i32, ptr %i.n, align 8, !tbaa !280
  %i.ev = load ptr, ptr %i.o, align 8, !tbaa !281 ; 3 uses
  switch i32 %i.eu, label %bb.bb [
    i32 1, label %bb.az
end_hunk_0
begin_hunk_1_@PyUnicode_DecodeUTF7Stateful:bb.a

bb.ba:                                            ; preds = %.critedge.i166
  %i.ey = trunc i32 %.0104349.lcssa388 to i16
...
bb.bb:                                            ; preds = %.critedge.i166
  ...
  store i32 %.0104349.lcssa388, ptr %i.fa, align 4, !tbaa !7
  br label %_PyUnicodeWriter_WriteCharInline.exit170

_PyUnicodeWriter_WriteCharInline.exit170:         ; preds = %bb.az, %bb.ba, %bb.bb
  %i.fb = phi i64 [ %.pre11.i169, %bb.az ], [ %i.et, %bb.ba ], [ %i.et, %bb.bb ]
  %i.fc = add i64 %i.fb, 1
  store i64 %i.fc, ptr %i.m, align 8, !tbaa !279
  br label %bb.bc

bb.bc:                                            ; preds = %_PyUnicodeWriter_WriteCharInline.exit170, %bb.av
  %i.fd = icmp eq i8 %.lcssa363, 45
  br i1 %i.fd, label %bb.bd, label %.outer.outer.backedge

bb.bd:                                            ; preds = %bb.bc
  %i.fe = getelementptr i8, ptr %.lcssa370, i64 1
  store ptr %i.fe, ptr %i.a, align 8, !tbaa !355
  br label %.outer.outer.backedge

.loopexit:                                        ; preds = %.lr.ph.preheader, %.thread
  %i.ff = phi ptr [ %i.hy, %.thread ], [ %i.r, %.lr.ph.preheader ]
  %.0108263 = phi i32 [ %.0108.lcssa, %.thread ], [ %.0108.ph, %.lr.ph.preheader ] ; 4 uses
  %.0106253 = phi i64 [ %.0106.lcssa, %.thread ], [ %.0106.ph, %.lr.ph.preheader ] ; 4 uses
  %.0104243 = phi i32 [ %.0104.lcssa, %.thread ], [ %.0104.ph, %.lr.ph.preheader ] ; 4 uses
  %i.fg = phi i32 [ %i.ib, %.thread ], [ %i.x, %.lr.ph.preheader ] ; 4 uses
  %i.fh = phi i8 [ %i.ia, %.thread ], [ %i.w, %.lr.ph.preheader ] ; 3 uses
  %i.fi = phi ptr [ %i.hx, %.thread ], [ %.promoted, %.lr.ph.preheader ] ; 7 uses
  %i.fj = icmp eq i8 %i.fh, 43
  br i1 %i.fj, label %bb.be, label %bb.bq

bb.be:                                            ; preds = %.loopexit
  %i.fk = load ptr, ptr %i.b, align 8, !tbaa !355
  %i.fl = ptrtoint ptr %i.fi to i64
  %i.fm = ptrtoint ptr %i.fk to i64
  %i.fn = sub i64 %i.fl, %i.fm                    ; 4 uses
  store i64 %i.fn, ptr %i.c, align 8, !tbaa !193
  %i.fo = getelementptr i8, ptr %i.fi, i64 1      ; 3 uses
  store ptr %i.fo, ptr %i.a, align 8, !tbaa !355
  %i.fp = icmp ult ptr %i.fo, %i.ff
  br i1 %i.fp, label %bb.bf, label %bb.bp

bb.bf:                                            ; preds = %bb.be
  %i.fq = load i8, ptr %i.fo, align 1, !tbaa !205 ; 4 uses
  %i.fr = icmp eq i8 %i.fq, 45
  br i1 %i.fr, label %bb.bg, label %bb.bm

bb.bg:                                            ; preds = %bb.bf
  %i.fs = getelementptr i8, ptr %i.fi, i64 2
  store ptr %i.fs, ptr %i.a, align 8, !tbaa !355
  %i.ft = load i32, ptr %i.k, align 4, !tbaa !276
  %.not.i171 = icmp ult i32 %i.ft, 43
  br i1 %.not.i171, label %bb.bi, label %bb.bh

bb.bh:                                            ; preds = %bb.bg
  %i.fu = load i64, ptr %i.l, align 8, !tbaa !278
  %i.fv = load i64, ptr %i.m, align 8, !tbaa !279 ; 2 uses
  %i.fw = sub i64 %i.fu, %i.fv
  %i.fx = icmp sgt i64 %i.fw, 0
  br i1 %i.fx, label %.critedge.i175, label %bb.bi

bb.bi:                                            ; preds = %bb.bh, %bb.bg
  %i.fy = call i32 @_PyUnicodeWriter_PrepareInternal(ptr noundef nonnull %4, i64 noundef 1, i32 noundef 43) #33
  %i.fz = icmp slt i32 %i.fy, 0
  br i1 %i.fz, label %.thread213, label %..critedge_crit_edge.i172
...
.critedge.i175:                                   ; preds = %..critedge_crit_edge.i172, %bb.bh
  %i.ga = phi i64 [ %.pre.i174, %..critedge_crit_edge.i172 ], [ %i.fv, %bb.bh ] ; 5 uses
  %i.gb = load i32, ptr %i.n, align 8, !tbaa !280
  %i.gc = load ptr, ptr %i.o, align 8, !tbaa !281 ; 3 uses
  switch i32 %i.gb, label %bb.bl [
    i32 1, label %bb.bj
    i32 2, label %bb.bk
  ]
...
bb.bj:                                            ; preds = %.critedge.i175
  ...
  store i8 43, ptr %i.gd, align 1, !tbaa !205
  %.pre11.i178 = load i64, ptr %i.m, align 8, !tbaa !279
  br label %_PyUnicodeWriter_WriteCharInline.exit179

bb.bk:                                            ; preds = %.critedge.i175
  %i.ge = getelementptr [2 x i8], ptr %i.gc, i64 %i.ga
  store i16 43, ptr %i.ge, align 2, !tbaa !208
  br label %_PyUnicodeWriter_WriteCharInline.exit179

bb.bl:                                            ; preds = %.critedge.i175
  %i.gf = getelementptr [4 x i8], ptr %i.gc, i64 %i.ga
  store i32 43, ptr %i.gf, align 4, !tbaa !7
  br label %_PyUnicodeWriter_WriteCharInline.exit179

_PyUnicodeWriter_WriteCharInline.exit179:         ; preds = %bb.bj, %bb.bk, %bb.bl
  %i.gg = phi i64 [ %.pre11.i178, %bb.bj ], [ %i.ga, %bb.bk ], [ %i.ga, %bb.bl ]
  %i.gh = add i64 %i.gg, 1
  store i64 %i.gh, ptr %i.m, align 8, !tbaa !279
  br label %.outer.outer.backedge

bb.bm:                                            ; preds = %bb.bf
  %i.gi = and i8 %i.fq, -33
  %i.gj = add i8 %i.gi, -65
  %or.cond231 = icmp ult i8 %i.gj, 26
  %i.gk = add i8 %i.fq, -48
  %or.cond143 = icmp ult i8 %i.gk, 10
  %or.cond232 = or i1 %or.cond143, %or.cond231
  br i1 %or.cond232, label %bb.bp, label %bb.bn

bb.bn:                                            ; preds = %bb.bm
  switch i8 %i.fq, label %bb.bo [
    i8 43, label %bb.bp
    i8 47, label %bb.bp
  ]

bb.bo:                                            ; preds = %bb.bn
  %i.gl = getelementptr i8, ptr %i.fi, i64 2
  br label %bb.by

bb.bp:                                            ; preds = %bb.be, %bb.bn, %bb.bn, %bb.bm
  %i.gm = load i64, ptr %i.m, align 8, !tbaa !279
  br label %.outer.outer.backedge

bb.bq:                                            ; preds = %.loopexit
  %i.gn = icmp sgt i8 %i.fh, -1
  br i1 %i.gn, label %bb.br, label %bb.bx

bb.br:                                            ; preds = %bb.bq
  %i.go = getelementptr i8, ptr %i.fi, i64 1
  store ptr %i.go, ptr %i.a, align 8, !tbaa !355
  %i.gp = load i32, ptr %i.k, align 4, !tbaa !276
  %.not.i180 = icmp ugt i32 %i.fg, %i.gp
  br i1 %.not.i180, label %bb.bt, label %bb.bs

bb.bs:                                            ; preds = %bb.br
  %i.gq = load i64, ptr %i.l, align 8, !tbaa !278
  %i.gr = load i64, ptr %i.m, align 8, !tbaa !279 ; 2 uses
  %i.gs = sub i64 %i.gq, %i.gr
  %i.gt = icmp sgt i64 %i.gs, 0
  br i1 %i.gt, label %.critedge.i184, label %bb.bt

bb.bt:                                            ; preds = %bb.bs, %bb.br
  %i.gu = call i32 @_PyUnicodeWriter_PrepareInternal(ptr noundef nonnull %4, i64 noundef 1, i32 noundef %i.fg) #33
  %i.gv = icmp slt i32 %i.gu, 0
  br i1 %i.gv, label %.thread213, label %..critedge_crit_edge.i181
...
.critedge.i184:                                   ; preds = %..critedge_crit_edge.i181, %bb.bs
  %i.gw = phi i64 [ %.pre.i183, %..critedge_crit_edge.i181 ], [ %i.gr, %bb.bs ] ; 5 uses
  %i.gx = load i32, ptr %i.n, align 8, !tbaa !280
  %i.gy = load ptr, ptr %i.o, align 8, !tbaa !281 ; 3 uses
  switch i32 %i.gx, label %bb.bw [
    i32 1, label %bb.bu
    i32 2, label %bb.bv
  ]

bb.bu:                                            ; preds = %.critedge.i184
  %i.gz = getelementptr i8, ptr %i.gy, i64 %i.gw
  store i8 %i.fh, ptr %i.gz, align 1, !tbaa !205
  %.pre11.i187 = load i64, ptr %i.m, align 8, !tbaa !279
  br label %_PyUnicodeWriter_WriteCharInline.exit188

bb.bv:                                            ; preds = %.critedge.i184
  %i.ha = trunc nuw nsw i32 %i.fg to i16
  %i.hb = getelementptr [2 x i8], ptr %i.gy, i64 %i.gw
  store i16 %i.ha, ptr %i.hb, align 2, !tbaa !208
  br label %_PyUnicodeWriter_WriteCharInline.exit188

bb.bw:                                            ; preds = %.critedge.i184
  %i.hc = getelementptr [4 x i8], ptr %i.gy, i64 %i.gw
  store i32 %i.fg, ptr %i.hc, align 4, !tbaa !7
  br label %_PyUnicodeWriter_WriteCharInline.exit188

_PyUnicodeWriter_WriteCharInline.exit188:         ; preds = %bb.bu, %bb.bv, %bb.bw
  %i.hd = phi i64 [ %.pre11.i187, %bb.bu ], [ %i.gw, %bb.bv ], [ %i.gw, %bb.bw ]
  %i.he = add i64 %i.hd, 1
  store i64 %i.he, ptr %i.m, align 8, !tbaa !279
  br label %.outer.outer.backedge

bb.bx:                                            ; preds = %bb.bq
  %i.hf = load ptr, ptr %i.b, align 8, !tbaa !355
  %i.hg = ptrtoint ptr %i.fi to i64
  %i.hh = ptrtoint ptr %i.hf to i64
  %i.hi = sub i64 %i.hg, %i.hh                    ; 2 uses
  store i64 %i.hi, ptr %i.c, align 8, !tbaa !193
  %i.hj = getelementptr i8, ptr %i.fi, i64 1
  br label %bb.by
...
.thread217.loopexit:                              ; preds = %bb.m, %.thread217.loopexit.loopexit
  ...
  %.lcssa399 = phi i32 [ %i.hk, %.thread217.loopexit.loopexit ], [ %i.aq, %bb.m ]
  %.lcssa394 = phi ptr [ %i.co, %.thread217.loopexit.loopexit ], [ %i.ar, %bb.m ]
  %.0104349.lcssa389 = phi i32 [ 0, %.thread217.loopexit.loopexit ], [ %.0104.ph, %bb.m ]
...
.outer.outer.backedge:                            ; preds = %.thread217.loopexit, %bb.ak, %_PyUnicodeWriter_WriteCharInline.exit161, %_PyUnicodeWriter_WriteCharInline.exit188, %_PyUnicodeWriter_WriteCharInline.exit179, %bb.bp, %bb.bd, %bb.bc
  %.ph.ph.be = phi i64 [ %.ph, %_PyUnicodeWriter_WriteCharInline.exit188 ], [ %.ph, %bb.ak ], [ %.ph, %bb.bd ], [ %.ph, %bb.bc ], [ %i.fn, %_PyUnicodeWriter_WriteCharInline.exit179 ], [ %i.fn, %bb.bp ], [ %.ph, %_PyUnicodeWriter_WriteCharInline.exit161 ], [ %.ph, %.thread217.loopexit ]
  ...
  %.0110.ph.ph.be = phi i64 [ %.0110.ph.ph, %_PyUnicodeWriter_WriteCharInline.exit188 ], [ %.0110.ph.ph, %bb.ak ], [ %.0110.ph.ph, %bb.bd ], [ %.0110.ph.ph, %bb.bc ], [ %.0110.ph.ph, %_PyUnicodeWriter_WriteCharInline.exit179 ], [ %i.gm, %bb.bp ], [ %.0110.ph.ph, %_PyUnicodeWriter_WriteCharInline.exit161 ], [ %.0110.ph.ph, %.thread217.loopexit ]
  %.0108.ph.ph.be = phi i32 [ %.0108263, %_PyUnicodeWriter_WriteCharInline.exit188 ], [ %i.dm, %bb.ak ], [ %.pre-phi489, %bb.bd ], [ %.pre-phi489, %bb.bc ], [ %.0108263, %_PyUnicodeWriter_WriteCharInline.exit179 ], [ 0, %bb.bp ], [ %i.dm, %_PyUnicodeWriter_WriteCharInline.exit161 ], [ %.lcssa399, %.thread217.loopexit ]
  %.0106.ph.ph.be = phi i64 [ %.0106253, %_PyUnicodeWriter_WriteCharInline.exit188 ], [ %i.dp, %bb.ak ], [ %.0106348.lcssa382.lcssa, %bb.bd ], [ %.0106348.lcssa382.lcssa, %bb.bc ], [ %.0106253, %_PyUnicodeWriter_WriteCharInline.exit179 ], [ 0, %bb.bp ], [ %i.dp, %_PyUnicodeWriter_WriteCharInline.exit161 ], [ %.lcssa404, %.thread217.loopexit ]
  %.0104.ph.ph.be = phi i32 [ %.0104243, %_PyUnicodeWriter_WriteCharInline.exit188 ], [ %i.do, %bb.ak ], [ 0, %bb.bd ], [ 0, %bb.bc ], [ %.0104243, %_PyUnicodeWriter_WriteCharInline.exit179 ], [ 0, %bb.bp ], [ 0, %_PyUnicodeWriter_WriteCharInline.exit161 ], [ %.0104349.lcssa389, %.thread217.loopexit ]
  br label %.outer.outer, !llvm.loop !494

bb.by:                                            ; preds = %bb.bx, %bb.bo, %bb.au, %bb.as
  %.sink = phi ptr [ %i.hj, %bb.bx ], [ %i.gl, %bb.bo ], [ %i.ej, %bb.au ], [ %i.ei, %bb.as ] ; 2 uses
  %.0108262 = phi i32 [ %.0108263, %bb.bx ], [ %.0108263, %bb.bo ], [ %.pre-phi489, %bb.au ], [ %.pre-phi489, %bb.as ]
  %.0106252 = phi i64 [ %.0106253, %bb.bx ], [ %.0106253, %bb.bo ], [ %.0106348.lcssa382, %bb.au ], [ %.0106348.lcssa382, %bb.as ]
  %.0104242 = phi i32 [ %.0104243, %bb.bx ], [ %.0104243, %bb.bo ], [ %.0104349.lcssa388, %bb.au ], [ %.0104349.lcssa388, %bb.as ]
  %i.hl = phi i64 [ %i.hi, %bb.bx ], [ %i.fn, %bb.bo ], [ %.ph, %bb.au ], [ %.ph, %bb.as ]
  %.0102 = phi ptr [ @.str.63, %bb.bx ], [ @.str.62, %bb.bo ], [ @.str.61, %bb.au ], [ @.str.60, %bb.as ]
  store ptr %.sink, ptr %i.a, align 8, !tbaa !355
  %i.hm = load ptr, ptr %i.b, align 8, !tbaa !355
  %i.hn = ptrtoint ptr %.sink to i64
  %i.ho = ptrtoint ptr %i.hm to i64
  %i.hp = sub i64 %i.hn, %i.ho
  store i64 %i.hp, ptr %i.d, align 8, !tbaa !193
  %i.hq = call fastcc i32 @unicode_decode_call_errorhandler_writer(ptr noundef %2, ptr noundef %i.f, ptr noundef nonnull @.str.64, ptr noundef nonnull %.0102, ptr noundef %i.b, ptr noundef %i.e, ptr noundef %i.c, ptr noundef %i.d, ptr noundef %i.g, ptr noundef %i.a, ptr noundef nonnull %4)
  %.not135 = icmp eq i32 %i.hq, 0
  br i1 %.not135, label %.outer, label %.thread213, !llvm.loop !494

._crit_edge:                                      ; preds = %bb.v, %.outer
  %i.hr = phi ptr [ %.promoted, %.outer ], [ %scevgep, %bb.v ] ; 2 uses
  %.0108.lcssa = phi i32 [ %.0108.ph, %.outer ], [ %indvars.peel, %bb.v ] ; 3 uses
  %.0106.lcssa = phi i64 [ %.0106.ph, %.outer ], [ %i.ax, %bb.v ] ; 2 uses
  %.0104.lcssa = phi i32 [ %.0104.ph, %.outer ], [ 0, %bb.v ] ; 2 uses
  store ptr %i.hr, ptr %i.a, align 8
  %or.cond23 = or i1 %i.p, %.0112.ph
  br i1 %or.cond23, label %bb.cd, label %bb.bz

bb.bz:                                            ; preds = %._crit_edge
  %i.hs = icmp ne i32 %.0104.lcssa, 0
  %i.ht = icmp ugt i32 %.0108.lcssa, 5
  %or.cond25 = select i1 %i.hs, i1 true, i1 %i.ht
  br i1 %or.cond25, label %bb.cb, label %bb.ca

bb.ca:                                            ; preds = %bb.bz
  %i.hu = icmp ne i32 %.0108.lcssa, 0
  %i.hv = icmp ne i64 %.0106.lcssa, 0
  %or.cond27 = select i1 %i.hu, i1 %i.hv, i1 false
  br i1 %or.cond27, label %bb.cb, label %.thread225

bb.cb:                                            ; preds = %bb.ca, %bb.bz
  store i64 %1, ptr %i.d, align 8, !tbaa !193
  %i.hw = call fastcc i32 @unicode_decode_call_errorhandler_writer(ptr noundef %2, ptr noundef %i.f, ptr noundef nonnull @.str.64, ptr noundef nonnull @.str.65, ptr noundef %i.b, ptr noundef %i.e, ptr noundef %i.c, ptr noundef %i.d, ptr noundef %i.g, ptr noundef %i.a, ptr noundef nonnull %4)
  %.not = icmp eq i32 %i.hw, 0
  br i1 %.not, label %bb.cc, label %.thread213

bb.cc:                                            ; preds = %bb.cb
  %i.hx = load ptr, ptr %i.a, align 8, !tbaa !355 ; 3 uses
  %i.hy = load ptr, ptr %i.e, align 8, !tbaa !355 ; 2 uses
  %i.hz = icmp ult ptr %i.hx, %i.hy
  br i1 %i.hz, label %.thread, label %.thread225

.thread:                                          ; preds = %bb.cc
  %i.ia = load i8, ptr %i.hx, align 1, !tbaa !205 ; 2 uses
...
bb.ce:                                            ; preds = %bb.cd
  br i1 %.0112.ph, label %bb.co, label %bb.cf

bb.cf:                                            ; preds = %bb.ce
  store i64 %.ph, ptr %3, align 8, !tbaa !193
  %i.ic = load i64, ptr %i.m, align 8, !tbaa !279
  %i.id = icmp ne i64 %i.ic, %.0110.ph.ph
  %i.ie = load i32, ptr %i.k, align 4
  %i.if = icmp ugt i32 %i.ie, 127
  %or.cond30 = select i1 %i.id, i1 %i.if, i1 false
  br i1 %or.cond30, label %bb.cg, label %bb.cn

bb.cg:                                            ; preds = %bb.cf
  %i.ig = load i32, ptr %i.n, align 8, !tbaa !280
  %i.ih = load ptr, ptr %i.o, align 8, !tbaa !281
  %i.ii = call ptr @PyUnicode_FromKindAndData(i32 noundef %i.ig, ptr noundef %i.ih, i64 noundef %.0110.ph.ph)
  %i.ij = load ptr, ptr %i.f, align 8, !tbaa !194 ; 4 uses
  %.not.i189 = icmp eq ptr %i.ij, null
  br i1 %.not.i189, label %Py_XDECREF.exit, label %bb.ch

bb.ch:                                            ; preds = %bb.cg
  %i.ik = load i32, ptr %i.ij, align 8, !tbaa !205 ; 2 uses
  %.not.i.i = icmp sgt i32 %i.ik, -1
  br i1 %.not.i.i, label %bb.ci, label %Py_XDECREF.exit

bb.ci:                                            ; preds = %bb.ch
  %i.il = add nsw i32 %i.ik, -1                   ; 2 uses
  store i32 %i.il, ptr %i.ij, align 8, !tbaa !205
  %i.im = icmp eq i32 %i.il, 0
  br i1 %i.im, label %bb.cj, label %Py_XDECREF.exit

bb.cj:                                            ; preds = %bb.ci
  call void @_Py_Dealloc(ptr noundef nonnull %i.ij) #33
  br label %Py_XDECREF.exit

Py_XDECREF.exit:                                  ; preds = %bb.cg, %bb.ch, %bb.ci, %bb.cj
  %i.in = load ptr, ptr %i.g, align 8, !tbaa !194 ; 4 uses
  %.not.i190 = icmp eq ptr %i.in, null
  br i1 %.not.i190, label %Py_XDECREF.exit192, label %bb.ck

bb.ck:                                            ; preds = %Py_XDECREF.exit
  %i.io = load i32, ptr %i.in, align 8, !tbaa !205 ; 2 uses
  %.not.i.i191 = icmp sgt i32 %i.io, -1
  br i1 %.not.i.i191, label %bb.cl, label %Py_XDECREF.exit192

bb.cl:                                            ; preds = %bb.ck
  %i.ip = add nsw i32 %i.io, -1                   ; 2 uses
  store i32 %i.ip, ptr %i.in, align 8, !tbaa !205
  %i.iq = icmp eq i32 %i.ip, 0
  br i1 %i.iq, label %bb.cm, label %Py_XDECREF.exit192
...
bb.cn:                                            ; preds = %bb.cf
  store i64 %.0110.ph.ph, ptr %i.m, align 8, !tbaa !279
  br label %.thread225

bb.co:                                            ; preds = %bb.ce
  %i.ir = load ptr, ptr %i.b, align 8, !tbaa !355
  %i.is = ptrtoint ptr %i.hr to i64
  %i.it = ptrtoint ptr %i.ir to i64
  %i.iu = sub i64 %i.is, %i.it
  store i64 %i.iu, ptr %3, align 8, !tbaa !193
  br label %.thread225

.thread225:                                       ; preds = %bb.cc, %bb.ca, %bb.cn, %bb.co, %bb.cd
  %i.iv = load ptr, ptr %i.f, align 8, !tbaa !194 ; 4 uses
  %.not.i193 = icmp eq ptr %i.iv, null
  br i1 %.not.i193, label %Py_XDECREF.exit195, label %bb.cp

bb.cp:                                            ; preds = %.thread225
  %i.iw = load i32, ptr %i.iv, align 8, !tbaa !205 ; 2 uses
  %.not.i.i194 = icmp sgt i32 %i.iw, -1
  br i1 %.not.i.i194, label %bb.cq, label %Py_XDECREF.exit195

bb.cq:                                            ; preds = %bb.cp
  %i.ix = add nsw i32 %i.iw, -1                   ; 2 uses
  store i32 %i.ix, ptr %i.iv, align 8, !tbaa !205
  %i.iy = icmp eq i32 %i.ix, 0
  br i1 %i.iy, label %bb.cr, label %Py_XDECREF.exit195

bb.cr:                                            ; preds = %bb.cq
  call void @_Py_Dealloc(ptr noundef nonnull %i.iv) #33
  br label %Py_XDECREF.exit195

Py_XDECREF.exit195:                               ; preds = %.thread225, %bb.cp, %bb.cq, %bb.cr
  %i.iz = load ptr, ptr %i.g, align 8, !tbaa !194 ; 4 uses
  %.not.i196 = icmp eq ptr %i.iz, null
  br i1 %.not.i196, label %Py_XDECREF.exit198, label %bb.cs

bb.cs:                                            ; preds = %Py_XDECREF.exit195
  %i.ja = load i32, ptr %i.iz, align 8, !tbaa !205 ; 2 uses
  %.not.i.i197 = icmp sgt i32 %i.ja, -1
  br i1 %.not.i.i197, label %bb.ct, label %Py_XDECREF.exit198

bb.ct:                                            ; preds = %bb.cs
  %i.jb = add nsw i32 %i.ja, -1                   ; 2 uses
  store i32 %i.jb, ptr %i.iz, align 8, !tbaa !205
  %i.jc = icmp eq i32 %i.jb, 0
  br i1 %i.jc, label %bb.cu, label %Py_XDECREF.exit198

bb.cu:                                            ; preds = %bb.ct
  call void @_Py_Dealloc(ptr noundef nonnull %i.iz) #33
  br label %Py_XDECREF.exit198

Py_XDECREF.exit198:                               ; preds = %Py_XDECREF.exit195, %bb.cs, %bb.ct, %bb.cu
  %i.jd = call ptr @_PyUnicodeWriter_Finish(ptr noundef nonnull %4) #33
  br label %bb.db

.thread213:                                       ; preds = %bb.bt, %bb.bi, %bb.ay, %bb.ag, %bb.an, %bb.cb, %bb.by, %bb.r
  %i.je = load ptr, ptr %i.f, align 8, !tbaa !194 ; 4 uses
  %.not.i199 = icmp eq ptr %i.je, null
  br i1 %.not.i199, label %Py_XDECREF.exit201, label %bb.cv

bb.cv:                                            ; preds = %.thread213
  %i.jf = load i32, ptr %i.je, align 8, !tbaa !205 ; 2 uses
  %.not.i.i200 = icmp sgt i32 %i.jf, -1
end_hunk_1
