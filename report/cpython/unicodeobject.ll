...
begin_hunk_0_@_PyUnicode_ResizeCompact:bb.a
  ...
  %.not40 = icmp eq i32 %i.s, 0                   ; 2 uses
  %..a = select i1 %.not40, i64 9223372036854775751, i64 9223372036854775767
  %i.t = udiv i64 %..a, %i.r
...
bb.j:                                             ; preds = %bb.h
  %. = select i1 %.not40, i64 56, i64 40          ; 2 uses
  %i.v = add nsw i64 %1, 1
  %i.w = mul i64 %i.v, %i.r
  %i.x = add i64 %i.w, %.
...
bb.m:                                             ; preds = %bb.l
  %.0.i.i.i = getelementptr i8, ptr %0, i64 %.
...
begin_hunk_3_@backslashreplace:bb.a
  ...
  %i.m = icmp ult i16 %i.l, 256                   ; 2 uses
  %.054.us83.a = select i1 %i.m, i64 9223372036854775803, i64 9223372036854775801
  %.not.us84 = icmp sgt i64 %.06075.us79, %.054.us83.a
  br i1 %.not.us84, label %.thread, label %bb.d

bb.d:                                             ; preds = %PyUnicode_READ.exit.us80
  %.054.us83 = select i1 %i.m, i64 4, i64 6
  %i.n = add i64 %.054.us83, %.06075.us79         ; 2 uses
