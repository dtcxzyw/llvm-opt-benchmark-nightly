...
begin_hunk_0_@_PyUnicode_JoinArray:bb.a
  %i.dq = add i64 %.0117226, %.1126.fr276         ; 3 uses
  %i.dr = getelementptr i8, ptr %i.do, i64 16
  %.val155 = load i64, ptr %i.dr, align 8, !tbaa !207 ; 3 uses
  %.not144 = icmp eq i64 %.val155, 0
...
.critedge:                                        ; preds = %bb.ao, %.lr.ph227.split.peel.next
  %.2119 = phi i64 [ %i.dt, %bb.ao ], [ %i.dq, %.lr.ph227.split.peel.next ]
  %i.du = add nuw nsw i64 %.2122225, 1            ; 2 uses
...
.loopexit:                                        ; preds = %bb.an, %bb.aj, %.critedge, %.critedge.us, %.critedge.peel, %_PyUnicode_DATA.exit178.thread
  ...
  %.0105273 = phi ptr [ %.0105271283288, %bb.aj ], [ %.0105272, %.critedge.peel ], [ %.0105272, %.critedge ], [ %.0105271283288, %_PyUnicode_DATA.exit178.thread ], [ %.0105272, %.critedge.us ], [ %.0105271283288, %bb.an ] ; 2 uses
  %.not.i187 = icmp eq ptr %.0105273, null
  br i1 %.not.i187, label %_Py_NewRef.exit, label %.loopexit.thread

.loopexit.thread:                                 ; preds = %bb.af, %_PyUnicode_DATA.exit178, %.loopexit
  %.0105273295 = phi ptr [ %.0105273, %.loopexit ], [ %.0105271283288, %_PyUnicode_DATA.exit178 ], [ %.0105271283288, %bb.af ] ; 3 uses
  %i.dw = phi ptr [ %i.dv, %.loopexit ], [ %i.bx, %_PyUnicode_DATA.exit178 ], [ %i.bx, %bb.af ] ; 3 uses
  %i.dx = load i32, ptr %.0105273295, align 8, !tbaa !205 ; 2 uses
...
bb.ap:                                            ; preds = %.loopexit.thread
  ...
  store i32 %i.dy, ptr %.0105273295, align 8, !tbaa !205
  %i.dz = icmp eq i32 %i.dy, 0
  br i1 %i.dz, label %bb.aq, label %_Py_NewRef.exit

bb.aq:                                            ; preds = %bb.ap
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0105273295) #33
  br label %_Py_NewRef.exit

bb.ar:                                            ; preds = %._crit_edge.thread, %.loopexit243, %.loopexit244, %._crit_edge
  %.0105274 = phi ptr [ %.0105272, %.loopexit243 ], [ %.0105272, %.loopexit244 ], [ %.0105272, %._crit_edge ], [ %.0105, %._crit_edge.thread ] ; 4 uses
  %.not.i189 = icmp eq ptr %.0105274, null
  br i1 %.not.i189, label %_Py_NewRef.exit, label %bb.as

bb.as:                                            ; preds = %bb.ar
  %i.ea = load i32, ptr %.0105274, align 8, !tbaa !205 ; 2 uses
  %.not.i.i190 = icmp sgt i32 %i.ea, -1
  br i1 %.not.i.i190, label %bb.at, label %_Py_NewRef.exit

bb.at:                                            ; preds = %bb.as
  %i.eb = add nsw i32 %i.ea, -1                   ; 2 uses
  store i32 %i.eb, ptr %.0105274, align 8, !tbaa !205
  %i.ec = icmp eq i32 %i.eb, 0
  br i1 %i.ec, label %bb.au, label %_Py_NewRef.exit

bb.au:                                            ; preds = %bb.at
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0105274) #33
  br label %_Py_NewRef.exit

_Py_NewRef.exit:                                  ; preds = %bb.au, %bb.at, %bb.as, %bb.ar, %.thread201, %bb.aq, %bb.ap, %.loopexit.thread, %.loopexit, %bb.d, %bb.c, %bb.a
  %.0131 = phi ptr [ %i.dw, %bb.aq ], [ getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 60176), %bb.a ], [ %i.a, %bb.d ], [ %i.a, %bb.c ], [ %i.dv, %.loopexit ], [ %i.dw, %.loopexit.thread ], [ %i.dw, %bb.ap ], [ null, %.thread201 ], [ null, %bb.ar ], [ null, %bb.as ], [ null, %bb.at ], [ null, %bb.au ]
  ret ptr %.0131
}
...
.lr.ph30.i.preheader:                             ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.02629.i.ph = phi ptr [ %i.k, %iter.check ], [ %i.aa, %vec.epilog.iter.check ], [ %i.af, %vec.epilog.middle.block ]
  br label %.lr.ph30.i

.lr.ph30.i:                                       ; preds = %.lr.ph30.i.preheader, %.lr.ph30.i
  %.02629.i = phi ptr [ %i.ai, %.lr.ph30.i ], [ %.02629.i.ph, %.lr.ph30.i.preheader ] ; 2 uses
  store i16 %i.j, ptr %.02629.i, align 2, !tbaa !208
  %i.ai = getelementptr i8, ptr %.02629.i, i64 2  ; 2 uses
...
vector.ph:                                        ; preds = %.lr.ph.i.preheader
  ...
  %i.bb = getelementptr i8, ptr %i.ak, i64 %i.ba
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %i.ak, i64 %i.bc ; 2 uses
  ...
  br i1 %i.be, label %middle.block, label %vector.body, !llvm.loop !551
...
.lr.ph.i.preheader36:                             ; preds = %.lr.ph.i.preheader, %middle.block
  %.028.i.ph = phi ptr [ %i.ak, %.lr.ph.i.preheader ], [ %i.bb, %middle.block ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader36, %.lr.ph.i
  %.028.i = phi ptr [ %i.bf, %.lr.ph.i ], [ %.028.i.ph, %.lr.ph.i.preheader36 ] ; 2 uses
  store i32 %3, ptr %.028.i, align 4, !tbaa !7
  %i.bf = getelementptr i8, ptr %.028.i, i64 4    ; 2 uses
  %i.bg = icmp ult ptr %i.bf, %i.al
  br i1 %i.bg, label %.lr.ph.i, label %_PyUnicode_Fill.exit, !llvm.loop !552
...
.lr.ph30.i.i.preheader:                           ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.02629.i.i.ph = phi ptr [ %i.z, %iter.check ], [ %i.ao, %vec.epilog.iter.check ], [ %i.at, %vec.epilog.middle.block ]
  br label %.lr.ph30.i.i

.lr.ph30.i.i:                                     ; preds = %.lr.ph30.i.i.preheader, %.lr.ph30.i.i
  %.02629.i.i = phi ptr [ %i.aw, %.lr.ph30.i.i ], [ %.02629.i.i.ph, %.lr.ph30.i.i.preheader ] ; 2 uses
  store i16 %i.y, ptr %.02629.i.i, align 2, !tbaa !208
  %i.aw = getelementptr i8, ptr %.02629.i.i, i64 2 ; 2 uses
...
vector.ph:                                        ; preds = %.lr.ph.i.i.preheader
  ...
  %i.bo = getelementptr i8, ptr %i.ay, i64 %i.bn
  %broadcast.splatinsert = insertelement <4 x i32> poison, i32 %3, i64 0
  %broadcast.splat = shufflevector <4 x i32> %broadcast.splatinsert, <4 x i32> poison, <4 x i32> zeroinitializer ; 2 uses
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %i.ay, i64 %i.bp ; 2 uses
  %i.bq = getelementptr i8, ptr %next.gep, i64 16
  store <4 x i32> %broadcast.splat, ptr %next.gep, align 4, !tbaa !7
  store <4 x i32> %broadcast.splat, ptr %i.bq, align 4, !tbaa !7
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.br = icmp eq i64 %index.next, %n.vec
  br i1 %i.br, label %middle.block, label %vector.body, !llvm.loop !556
...
.lr.ph.i.i.preheader62:                           ; preds = %.lr.ph.i.i.preheader, %middle.block
  %.028.i.i.ph = phi ptr [ %i.ay, %.lr.ph.i.i.preheader ], [ %i.bo, %middle.block ]
  br label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader62, %.lr.ph.i.i
  %.028.i.i = phi ptr [ %i.bs, %.lr.ph.i.i ], [ %.028.i.i.ph, %.lr.ph.i.i.preheader62 ] ; 2 uses
  store i32 %3, ptr %.028.i.i, align 4, !tbaa !7
  %i.bs = getelementptr i8, ptr %.028.i.i, i64 4  ; 2 uses
  %i.bt = icmp ult ptr %i.bs, %i.az
  br i1 %i.bt, label %.lr.ph.i.i, label %_PyUnicode_FastFill.exit, !llvm.loop !557
...
bb.b:                                             ; preds = %_PyUnicode_EnsureUnicode.exit
  ...
  %i.k = and i32 %i.g, 32
  %.not.i33 = icmp eq i32 %i.k, 0                 ; 2 uses
  br i1 %.not, label %bb.v, label %bb.c

bb.c:                                             ; preds = %bb.b
  br i1 %.not.i33, label %bb.e, label %bb.d
...
bb.f:                                             ; preds = %Py_DECREF.exit64.i, %.preheader81.i
  %.048.i = phi i64 [ %.3.i, %Py_DECREF.exit64.i ], [ 0, %.preheader81.i ] ; 5 uses
  %i.p = icmp slt i64 %.048.i, %.val24
  br i1 %i.p, label %.preheader.i, label %asciilib_splitlines.exit

.preheader.i:                                     ; preds = %bb.f, %.thread.i
  %.14984.i = phi i64 [ %i.af, %.thread.i ], [ %.048.i, %bb.f ] ; 6 uses
  %i.q = getelementptr i8, ptr %.0.i27, i64 %.14984.i
...
..critedge.i_crit_edge:                           ; preds = %bb.h
  %i.ae = getelementptr i8, ptr %.0.i27, i64 %.14984.i
  %.pre160 = load i8, ptr %i.ae, align 1, !tbaa !205
  br label %.critedge.i

.thread.i:                                        ; preds = %bb.h, %bb.g, %.split.i
  %i.af = add i64 %.14984.i, 1                    ; 2 uses
...
.critedge.i:                                      ; preds = %.split.i, %..critedge.i_crit_edge
  %i.ag = phi i8 [ %.pre160, %..critedge.i_crit_edge ], [ %i.r, %.split.i ]
  %i.ah = icmp eq i8 %i.ag, 13
  %i.ai = add nsw i64 %.14984.i, 1                ; 4 uses
  %i.aj = icmp slt i64 %i.ai, %.val24
  %or.cond99.i = select i1 %i.ah, i1 %i.aj, i1 false
  br i1 %or.cond99.i, label %bb.i, label %.critedge._crit_edge.i
...
bb.i:                                             ; preds = %.critedge.i
  ...
  %i.an = add nsw i64 %.14984.i, 2
  %spec.select100.i = select i1 %i.am, i64 %i.an, i64 %i.ai
  br label %.critedge._crit_edge.i

.critedge._crit_edge.i:                           ; preds = %bb.i, %.critedge.i
  %.2.i = phi i64 [ %spec.select100.i, %bb.i ], [ %i.ai, %.critedge.i ] ; 2 uses
  %spec.select.i = select i1 %.not57.i, i64 %.14984.i, i64 %.2.i
...
bb.l:                                             ; preds = %bb.j, %.critedge61.i
  %i.ar = getelementptr i8, ptr %.0.i27, i64 %.048.i ; 2 uses
  %i.as = sub i64 %.0.i29, %.048.i                ; 3 uses
  %i.at = icmp eq i64 %i.as, 1
  br i1 %i.at, label %_PyUnicode_FromASCII.exit.i, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.au = tail call ptr @PyUnicode_New(i64 noundef %i.as, i32 noundef 127), !inline_history !560 ; 5 uses
  %.not.i66.i = icmp eq ptr %i.au, null
  br i1 %.not.i66.i, label %_PyUnicode_FromASCII.exit.thread.i, label %bb.n
...
.lr.ph.split.us.i:                                ; preds = %.lr.ph.i, %bb.q
  ...
  %.062101.us.i = phi i64 [ %.163.us.i, %bb.q ], [ 0, %.lr.ph.i ] ; 3 uses
  %.064100.us.i = phi i64 [ %.165.us.i, %bb.q ], [ 0, %.lr.ph.i ] ; 4 uses
  %.06899.us.i = phi i64 [ %i.aq, %bb.q ], [ 0, %.lr.ph.i ] ; 4 uses
...
bb.l:                                             ; preds = %PyUnicode_READ.exit.us.i
  %i.ah = icmp eq i64 %.064100.us.i, 9223372036854775807
  br i1 %i.ah, label %.split.us.i, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.ai = add i64 %.062101.us.i, 1
  %i.aj = add nsw i64 %.064100.us.i, 1            ; 2 uses
...
bb.o:                                             ; preds = %PyUnicode_READ.exit.us.i
  %i.ak = srem i64 %.062101.us.i, %i.x
  %i.al = sub nsw i64 %i.x, %i.ak                 ; 3 uses
  %i.am = sub i64 9223372036854775807, %i.al
  %i.an = icmp sgt i64 %.064100.us.i, %i.am
  br i1 %i.an, label %.split.us.i, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.ao = add i64 %i.al, %.062101.us.i
  %i.ap = add i64 %i.al, %.064100.us.i
  br label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.n, %bb.m
  %.165.us.i = phi i64 [ %i.ap, %bb.p ], [ %i.aj, %bb.m ], [ %i.aj, %bb.n ] ; 2 uses
  %.163.us.i = phi i64 [ %i.ao, %bb.p ], [ %i.ai, %bb.m ], [ 0, %bb.n ]
  %.1.us.i = phi i32 [ 1, %bb.p ], [ %.0102.us.i, %bb.m ], [ %.0102.us.i, %bb.n ] ; 2 uses
  %i.aq = add nuw nsw i64 %.06899.us.i, 1         ; 2 uses
...
PyUnicode_READ.exit.us109.i:                      ; preds = %.lr.ph.split.i, %bb.t
  ...
  %.064100.us107.i = phi i64 [ %.165.us111.i, %bb.t ], [ 0, %.lr.ph.split.i ] ; 3 uses
  %.06899.us108.i = phi i64 [ %i.aw, %bb.t ], [ 0, %.lr.ph.split.i ] ; 2 uses
  %i.ar = getelementptr i8, ptr %.0.i.i, i64 %.06899.us108.i
...
bb.r:                                             ; preds = %PyUnicode_READ.exit.us109.i
  %i.au = icmp eq i64 %.064100.us107.i, 9223372036854775807
  br i1 %i.au, label %.split.us.i, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.av = add nsw i64 %.064100.us107.i, 1
  br label %bb.t

bb.t:                                             ; preds = %bb.s, %PyUnicode_READ.exit.us109.i
  %.165.us111.i = phi i64 [ %i.av, %bb.s ], [ %.064100.us107.i, %PyUnicode_READ.exit.us109.i ] ; 2 uses
  %.1.us113.i = phi i32 [ %.0102.us105.i, %bb.s ], [ 1, %PyUnicode_READ.exit.us109.i ] ; 2 uses
  %i.aw = add nuw nsw i64 %.06899.us108.i, 1      ; 2 uses
...
PyUnicode_READ.exit.us123.i:                      ; preds = %.lr.ph.split.i, %bb.w
  ...
  %.064100.us121.i = phi i64 [ %.165.us125.i, %bb.w ], [ 0, %.lr.ph.split.i ] ; 3 uses
  %.06899.us122.i = phi i64 [ %i.bc, %bb.w ], [ 0, %.lr.ph.split.i ] ; 2 uses
  %i.ax = getelementptr [2 x i8], ptr %.0.i.i, i64 %.06899.us122.i
...
bb.u:                                             ; preds = %PyUnicode_READ.exit.us123.i
  %i.ba = icmp eq i64 %.064100.us121.i, 9223372036854775807
  br i1 %i.ba, label %.split.us.i, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.bb = add nsw i64 %.064100.us121.i, 1
  br label %bb.w

bb.w:                                             ; preds = %bb.v, %PyUnicode_READ.exit.us123.i
  %.165.us125.i = phi i64 [ %i.bb, %bb.v ], [ %.064100.us121.i, %PyUnicode_READ.exit.us123.i ] ; 2 uses
  %.1.us127.i = phi i32 [ %.0102.us119.i, %bb.v ], [ 1, %PyUnicode_READ.exit.us123.i ] ; 2 uses
  %i.bc = add nuw nsw i64 %.06899.us122.i, 1      ; 2 uses
...
PyUnicode_READ.exit.i:                            ; preds = %.lr.ph.split.i, %bb.z
  ...
  %.064100.i = phi i64 [ %.165.i, %bb.z ], [ 0, %.lr.ph.split.i ] ; 3 uses
  %.06899.i = phi i64 [ %i.bi, %bb.z ], [ 0, %.lr.ph.split.i ] ; 2 uses
  %i.bd = getelementptr [4 x i8], ptr %.0.i.i, i64 %.06899.i
...
bb.x:                                             ; preds = %PyUnicode_READ.exit.i
  %i.bg = icmp eq i64 %.064100.i, 9223372036854775807
  br i1 %i.bg, label %.split.us.i, label %bb.y

bb.y:                                             ; preds = %bb.x
  %i.bh = add nsw i64 %.064100.i, 1
  br label %bb.z

bb.z:                                             ; preds = %bb.y, %PyUnicode_READ.exit.i
  %.165.i = phi i64 [ %i.bh, %bb.y ], [ %.064100.i, %PyUnicode_READ.exit.i ] ; 2 uses
  %.1.i = phi i32 [ %.0102.i, %bb.y ], [ 1, %PyUnicode_READ.exit.i ] ; 2 uses
  %i.bi = add nuw nsw i64 %.06899.i, 1            ; 2 uses
...
._crit_edge.i:                                    ; preds = %bb.w, %bb.t, %bb.z, %bb.q
  %.064.lcssa.i = phi i64 [ %.165.us.i, %bb.q ], [ %.165.us111.i, %bb.t ], [ %.165.i, %bb.z ], [ %.165.us125.i, %bb.w ]
...
PyUnicode_MAX_CHAR_VALUE.exit.i:                  ; preds = %._crit_edge.i
  ...
  %i.bl = call ptr @PyUnicode_New(i64 noundef %.064.lcssa.i, i32 noundef %.0.i81.i), !inline_history !905 ; 16 uses
...
bb.ae:                                            ; preds = %bb.ad
  %i.bw = getelementptr i8, ptr %.0.i.i, i64 %.169132.i
  %i.bx = load i8, ptr %i.bw, align 1, !tbaa !205
  %i.by = zext i8 %i.bx to i32
  br label %PyUnicode_READ.exit91.i

bb.af:                                            ; preds = %bb.ad
  %i.bz = getelementptr [2 x i8], ptr %.0.i.i, i64 %.169132.i
  %i.ca = load i16, ptr %i.bz, align 2, !tbaa !208
  %i.cb = zext i16 %i.ca to i32
  br label %PyUnicode_READ.exit91.i

bb.ag:                                            ; preds = %bb.ad
  %i.cc = getelementptr [4 x i8], ptr %.0.i.i, i64 %.169132.i
...
bb.ai:                                            ; preds = %bb.ah
  %i.cf = srem i64 %.2134.i, %i.x                 ; 3 uses
  %i.cg = sub nsw i64 %i.x, %i.cf                 ; 5 uses
  %i.ch = add i64 %i.cg, %.2134.i
...
bb.aj:                                            ; preds = %bb.ai
  %i.ci = getelementptr i8, ptr %.0.i87.i, i64 %.266133.i
  call void @llvm.memset.p0.i64(ptr align 1 %i.ci, i8 32, i64 %i.cg, i1 false)
  br label %_PyUnicode_Fill.exit.i

bb.ak:                                            ; preds = %bb.ai
  %i.cj = getelementptr [2 x i8], ptr %.0.i87.i, i64 %.266133.i ; 7 uses
...
iter.check:                                       ; preds = %bb.ak
  %i.cm = shl i64 %.266133.i, 1                   ; 3 uses
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  %i.cv = and i64 %i.cu, 12
  %n.vec = and i64 %i.cu, -16                     ; 4 uses
  %i.cw = shl i64 %n.vec, 1
  %i.cx = getelementptr i8, ptr %i.cj, i64 %i.cw
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.cy = shl i64 %index, 1
  %next.gep = getelementptr i8, ptr %i.cj, i64 %i.cy ; 2 uses
  %i.cz = getelementptr i8, ptr %next.gep, i64 16
  store <8 x i16> splat (i16 32), ptr %next.gep, align 2, !tbaa !208
  store <8 x i16> splat (i16 32), ptr %i.cz, align 2, !tbaa !208
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.da = icmp eq i64 %index.next, %n.vec
  br i1 %i.da, label %middle.block, label %vector.body, !llvm.loop !906
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec81 = and i64 %i.cu, -4                    ; 3 uses
  %i.db = shl i64 %n.vec81, 1
  %i.dc = getelementptr i8, ptr %i.cj, i64 %i.db
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index82 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next84, %vec.epilog.vector.body ] ; 2 uses
  %i.dd = shl i64 %index82, 1
  %next.gep83 = getelementptr i8, ptr %i.cj, i64 %i.dd
  store <4 x i16> splat (i16 32), ptr %next.gep83, align 2, !tbaa !208
  %index.next84 = add nuw i64 %index82, 4         ; 2 uses
  %i.de = icmp eq i64 %index.next84, %n.vec81
  br i1 %i.de, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !907

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n85 = icmp eq i64 %i.cu, %n.vec81
  br i1 %cmp.n85, label %_PyUnicode_Fill.exit.i, label %.lr.ph30.i.i.preheader

.lr.ph30.i.i.preheader:                           ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.02629.i.i.ph = phi ptr [ %i.cj, %iter.check ], [ %i.cx, %vec.epilog.iter.check ], [ %i.dc, %vec.epilog.middle.block ]
  br label %.lr.ph30.i.i

.lr.ph30.i.i:                                     ; preds = %.lr.ph30.i.i.preheader, %.lr.ph30.i.i
  %.02629.i.i = phi ptr [ %i.df, %.lr.ph30.i.i ], [ %.02629.i.i.ph, %.lr.ph30.i.i.preheader ] ; 2 uses
  store i16 32, ptr %.02629.i.i, align 2, !tbaa !208
  %i.df = getelementptr i8, ptr %.02629.i.i, i64 2 ; 2 uses
  %i.dg = icmp ult ptr %i.df, %i.ck
  br i1 %i.dg, label %.lr.ph30.i.i, label %_PyUnicode_Fill.exit.i, !llvm.loop !908

bb.al:                                            ; preds = %bb.ai
  %i.dh = getelementptr [4 x i8], ptr %.0.i87.i, i64 %.266133.i ; 5 uses
  %i.di = getelementptr [4 x i8], ptr %i.dh, i64 %i.cg ; 2 uses
...
vector.ph88:                                      ; preds = %.lr.ph.i.i.preheader
  %n.vec89 = and i64 %i.ds, 9223372036854775800   ; 3 uses
  %i.dt = shl i64 %n.vec89, 2
...
vector.body90:                                    ; preds = %vector.body90, %vector.ph88
  ...
  %i.dv = shl i64 %index91, 2
  %next.gep92 = getelementptr i8, ptr %i.dh, i64 %i.dv ; 2 uses
  %i.dw = getelementptr i8, ptr %next.gep92, i64 16
  store <4 x i32> splat (i32 32), ptr %next.gep92, align 4, !tbaa !7
  store <4 x i32> splat (i32 32), ptr %i.dw, align 4, !tbaa !7
  %index.next93 = add nuw i64 %index91, 8         ; 2 uses
  %i.dx = icmp eq i64 %index.next93, %n.vec89
  br i1 %i.dx, label %middle.block94, label %vector.body90, !llvm.loop !909

middle.block94:                                   ; preds = %vector.body90
  %cmp.n95 = icmp eq i64 %i.ds, %n.vec89
...
.lr.ph.i.i.preheader96:                           ; preds = %.lr.ph.i.i.preheader, %middle.block94
  %.028.i.i.ph = phi ptr [ %i.dh, %.lr.ph.i.i.preheader ], [ %i.du, %middle.block94 ]
  br label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader96, %.lr.ph.i.i
  %.028.i.i = phi ptr [ %i.dy, %.lr.ph.i.i ], [ %.028.i.i.ph, %.lr.ph.i.i.preheader96 ] ; 2 uses
  store i32 32, ptr %.028.i.i, align 4, !tbaa !7
  %i.dy = getelementptr i8, ptr %.028.i.i, i64 4  ; 2 uses
  %i.dz = icmp ult ptr %i.dy, %i.di
  br i1 %i.dz, label %.lr.ph.i.i, label %_PyUnicode_Fill.exit.i, !llvm.loop !910

bb.am:                                            ; preds = %bb.ai
  unreachable

_PyUnicode_Fill.exit.i:                           ; preds = %.lr.ph.i.i, %.lr.ph30.i.i, %middle.block94, %middle.block, %vec.epilog.middle.block, %bb.al, %bb.ak, %bb.aj
  %i.ea = add i64 %i.cg, %.266133.i
  br label %bb.as

bb.an:                                            ; preds = %PyUnicode_READ.exit91.i
  %i.eb = add i64 %.2134.i, 1
...
bb.ao:                                            ; preds = %bb.an
  %i.ec = trunc i32 %.0.i90.i to i8
  %i.ed = getelementptr i8, ptr %.0.i87.i, i64 %.266133.i
  store i8 %i.ec, ptr %i.ed, align 1, !tbaa !205
  br label %PyUnicode_WRITE.exit.i

bb.ap:                                            ; preds = %bb.an
  %i.ee = trunc i32 %.0.i90.i to i16
  %i.ef = getelementptr [2 x i8], ptr %.0.i87.i, i64 %.266133.i
  store i16 %i.ee, ptr %i.ef, align 2, !tbaa !208
  br label %PyUnicode_WRITE.exit.i

bb.aq:                                            ; preds = %bb.an
  %i.eg = getelementptr [4 x i8], ptr %.0.i87.i, i64 %.266133.i
  store i32 %.0.i90.i, ptr %i.eg, align 4, !tbaa !7
  br label %PyUnicode_WRITE.exit.i

PyUnicode_WRITE.exit.i:                           ; preds = %bb.aq, %bb.ap, %bb.ao
  %i.eh = add i64 %.266133.i, 1                   ; 2 uses
...
bb.as:                                            ; preds = %bb.ar, %PyUnicode_WRITE.exit.i, %_PyUnicode_Fill.exit.i, %bb.ah
  %.367.i = phi i64 [ %i.ea, %_PyUnicode_Fill.exit.i ], [ %.266133.i, %bb.ah ], [ %i.eh, %bb.ar ], [ %i.eh, %PyUnicode_WRITE.exit.i ]
  %.3.i = phi i64 [ %i.ch, %_PyUnicode_Fill.exit.i ], [ %.2134.i, %bb.ah ], [ 0, %bb.ar ], [ %i.eb, %PyUnicode_WRITE.exit.i ]
  %i.ei = add nuw nsw i64 %.169132.i, 1           ; 2 uses
  %exitcond147.not.i = icmp eq i64 %i.ei, %.val.i
  br i1 %exitcond147.not.i, label %._crit_edge136.i, label %bb.ad, !llvm.loop !911

._crit_edge136.i:                                 ; preds = %bb.as
  %i.ej = getelementptr i8, ptr %i.bl, i64 16
  %.val.i92.i = load i64, ptr %i.ej, align 8, !tbaa !207
...
bb.au:                                            ; preds = %bb.at
  %i.ek = load i32, ptr %i.bl, align 8, !tbaa !205 ; 2 uses
  %.not.i27.i.i = icmp sgt i32 %i.ek, -1
  br i1 %.not.i27.i.i, label %bb.av, label %unicode_expandtabs_impl.exit

bb.av:                                            ; preds = %bb.au
  %i.el = add nsw i32 %i.ek, -1                   ; 2 uses
  store i32 %i.el, ptr %i.bl, align 8, !tbaa !205
  %i.em = icmp eq i32 %i.el, 0
  br i1 %i.em, label %Py_DECREF.exit28.sink.split.i.i, label %unicode_expandtabs_impl.exit

bb.aw:                                            ; preds = %._crit_edge136.i
  %i.en = load i32, ptr %i.bm, align 8            ; 3 uses
  %i.eo = and i32 %i.en, 28
  %.not25.i.i = icmp eq i32 %i.eo, 4
  br i1 %.not25.i.i, label %bb.ax, label %unicode_expandtabs_impl.exit

bb.ax:                                            ; preds = %bb.aw
  %i.ep = and i32 %i.en, 32
  %.not.i30.i.i = icmp eq i32 %i.ep, 0
  br i1 %.not.i30.i.i, label %bb.az, label %bb.ay

bb.ay:                                            ; preds = %bb.ax
  %i.eq = and i32 %i.en, 64
  %.not.i.i.i.i = icmp eq i32 %i.eq, 0
...
bb.az:                                            ; preds = %bb.ax
  %i.er = getelementptr i8, ptr %i.bl, i64 56
  %.val4.i.i.i = load ptr, ptr %i.er, align 8, !tbaa !205
  br label %_PyUnicode_DATA.exit.i.i

_PyUnicode_DATA.exit.i.i:                         ; preds = %bb.az, %bb.ay
  %.0.i.i93.i = phi ptr [ %.0.i.i.i.i, %bb.ay ], [ %.val4.i.i.i, %bb.az ]
  %i.es = load i8, ptr %.0.i.i93.i, align 1, !tbaa !205 ; 3 uses
  %i.et = zext nneg i8 %i.es to i64
  %i.eu = getelementptr [48 x i8], ptr getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 105088), i64 %i.et
  %i.ev = and i8 %i.es, 127
  %i.ew = zext nneg i8 %i.ev to i64
  %i.ex = getelementptr [64 x i8], ptr getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 111232), i64 %i.ew
  %i.ey = icmp slt i8 %i.es, 0
  %i.ez = select i1 %i.ey, ptr %i.ex, ptr %i.eu   ; 5 uses
  %.not.i94.i = icmp eq ptr %i.bl, %i.ez
  br i1 %.not.i94.i, label %unicode_expandtabs_impl.exit, label %bb.ba

bb.ba:                                            ; preds = %_PyUnicode_DATA.exit.i.i
  %i.fa = load i32, ptr %i.bl, align 8, !tbaa !205 ; 2 uses
  %.not.i.i95.i = icmp sgt i32 %i.fa, -1
  br i1 %.not.i.i95.i, label %bb.bb, label %unicode_expandtabs_impl.exit

bb.bb:                                            ; preds = %bb.ba
  %i.fb = add nsw i32 %i.fa, -1                   ; 2 uses
  store i32 %i.fb, ptr %i.bl, align 8, !tbaa !205
  %i.fc = icmp eq i32 %i.fb, 0
  br i1 %i.fc, label %Py_DECREF.exit28.sink.split.i.i, label %unicode_expandtabs_impl.exit

Py_DECREF.exit28.sink.split.i.i:                  ; preds = %bb.bb, %bb.av
  %.1.ph.i.i = phi ptr [ getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 60176), %bb.av ], [ %i.ez, %bb.bb ]
  call void @_Py_Dealloc(ptr noundef nonnull %i.bl) #33, !inline_history !905
  br label %unicode_expandtabs_impl.exit

.split.us.i:                                      ; preds = %bb.u, %bb.r, %bb.x, %bb.o, %bb.l
  %i.fd = load ptr, ptr @PyExc_OverflowError, align 8, !tbaa !194
  call void @PyErr_SetString(ptr noundef %i.fd, ptr noundef nonnull @.str.266) #33, !inline_history !905
  br label %unicode_expandtabs_impl.exit
...
unicode_expandtabs_impl.exit:                     ; preds = %.split.us.i, %Py_DECREF.exit28.sink.split.i.i, %bb.bb, %bb.ba, %_PyUnicode_DATA.exit.i.i, %bb.aw, %bb.av, %bb.au, %bb.at, %._crit_edge136.i, %PyUnicode_MAX_CHAR_VALUE.exit.i, %._crit_edge.thread.i, %bb.e, %bb.c
  %.022 = phi ptr [ null, %bb.e ], [ null, %bb.c ], [ null, %.split.us.i ], [ null, %PyUnicode_MAX_CHAR_VALUE.exit.i ], [ %i.bj, %._crit_edge.thread.i ], [ %i.bl, %._crit_edge136.i ], [ %i.ez, %bb.ba ], [ getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 60176), %bb.at ], [ getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 60176), %bb.au ], [ getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 60176), %bb.av ], [ %i.bl, %bb.aw ], [ %i.ez, %_PyUnicode_DATA.exit.i.i ], [ %i.ez, %bb.bb ], [ %.1.ph.i.i, %Py_DECREF.exit28.sink.split.i.i ]
...
.lr.ph30.i.preheader:                             ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.02629.i.ph = phi ptr [ %.0.i45, %iter.check ], [ %i.am, %vec.epilog.iter.check ], [ %i.ar, %vec.epilog.middle.block ]
  br label %.lr.ph30.i

.lr.ph30.i:                                       ; preds = %.lr.ph30.i.preheader, %.lr.ph30.i
  %.02629.i = phi ptr [ %i.au, %.lr.ph30.i ], [ %.02629.i.ph, %.lr.ph30.i.preheader ] ; 2 uses
  store i16 %i.aa, ptr %.02629.i, align 2, !tbaa !208
  %i.au = getelementptr i8, ptr %.02629.i, i64 2  ; 2 uses
...
.lr.ph.i.preheader137:                            ; preds = %.lr.ph.i.preheader, %middle.block
  %.028.i.ph = phi ptr [ %.0.i45, %.lr.ph.i.preheader ], [ %i.bi, %middle.block ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader137, %.lr.ph.i
  %.028.i = phi ptr [ %i.bm, %.lr.ph.i ], [ %.028.i.ph, %.lr.ph.i.preheader137 ] ; 2 uses
  store i32 %3, ptr %.028.i, align 4, !tbaa !7
  %i.bm = getelementptr i8, ptr %.028.i, i64 4    ; 2 uses
...
vector.ph92:                                      ; preds = %.lr.ph.i46.preheader
  %n.vec93 = and i64 %i.dg, 9223372036854775800   ; 3 uses
  %i.dh = shl i64 %n.vec93, 2
  %i.di = getelementptr i8, ptr %i.cs, i64 %i.dh
...
vector.body96:                                    ; preds = %vector.body96, %vector.ph92
  ...
  %i.dj = shl i64 %index97, 2
  %next.gep98 = getelementptr i8, ptr %i.cs, i64 %i.dj ; 2 uses
  %i.dk = getelementptr i8, ptr %next.gep98, i64 16
  store <4 x i32> %broadcast.splat95, ptr %next.gep98, align 4, !tbaa !7
  store <4 x i32> %broadcast.splat95, ptr %i.dk, align 4, !tbaa !7
  %index.next99 = add nuw i64 %index97, 8         ; 2 uses
  %i.dl = icmp eq i64 %index.next99, %n.vec93
  br i1 %i.dl, label %middle.block100, label %vector.body96, !llvm.loop !976

middle.block100:                                  ; preds = %vector.body96
  %cmp.n101 = icmp eq i64 %i.dg, %n.vec93
...
.lr.ph.i46.preheader135:                          ; preds = %.lr.ph.i46.preheader, %middle.block100
  %.028.i47.ph = phi ptr [ %i.cs, %.lr.ph.i46.preheader ], [ %i.di, %middle.block100 ]
  br label %.lr.ph.i46

.lr.ph.i46:                                       ; preds = %.lr.ph.i46.preheader135, %.lr.ph.i46
  %.028.i47 = phi ptr [ %i.dm, %.lr.ph.i46 ], [ %.028.i47.ph, %.lr.ph.i46.preheader135 ] ; 2 uses
  store i32 %3, ptr %.028.i47, align 4, !tbaa !7
  %i.dm = getelementptr i8, ptr %.028.i47, i64 4  ; 2 uses
  %i.dn = icmp ult ptr %i.dm, %i.ct
  br i1 %i.dn, label %.lr.ph.i46, label %_PyUnicode_Fill.exit50, !llvm.loop !977
...
_PyUnicode_Fill.exit50:                           ; preds = %.lr.ph.i46, %.lr.ph30.i48, %middle.block100, %middle.block116, %vec.epilog.middle.block132, %bb.s, %bb.r, %bb.q, %_PyUnicode_Fill.exit
  %i.do = phi i64 [ %.pre55, %middle.block116 ], [ %.pre55, %_PyUnicode_Fill.exit ], [ %.pre55, %bb.s ], [ %.pre55, %bb.r ], [ %.pre, %bb.q ], [ %.pre55, %middle.block100 ], [ %.pre55, %vec.epilog.middle.block132 ], [ %.pre55, %.lr.ph30.i48 ], [ %.pre55, %.lr.ph.i46 ]
  %i.dp = tail call fastcc i32 @_copy_characters(ptr noundef nonnull %i.r, i64 noundef %spec.store.select, ptr noundef nonnull %0, i64 noundef 0, i64 noundef %i.do, i32 noundef 0) ; 0 uses
  br label %bb.u
