...
.lr.ph.i.i.preheader:                             ; preds = %bb.al
  ...
  %4 = shl i64 %i.ce, 2
  %5 = sub i64 %.0.i87.i79, %4
  %6 = add i64 %5, %i.dj
  %7 = add i64 %6, %i.bu
  %.reass = add i64 %i.dj, %invariant.op
  %i.dk = call i64 @llvm.umax.i64(i64 %7, i64 %.reass)
  %8 = shl i64 %.2133.i, 2
  %i.dl = add i64 %8, %.0.i87.i79
  %9 = xor i64 %i.dl, -1
  %10 = add i64 %i.dk, %9                         ; 2 uses
  %i.dm = lshr i64 %10, 2
...
.lr.ph.i46.preheader:                             ; preds = %bb.s
  ...
  %4 = shl i64 %i.bo, 2
  %i.dc = add i64 %4, %.0.i4567
  %5 = xor i64 %i.dc, -1
  %6 = add i64 %i.db, %5                          ; 2 uses
  %i.dd = lshr i64 %6, 2
