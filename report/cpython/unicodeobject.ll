...
bb.bu:                                            ; preds = %.thread499
  ...
  %i.gg = load ptr, ptr %i.a, align 8, !tbaa !227 ; 2 uses
...
.thread490.sink.split:                            ; preds = %bb.bi, %bb.bh
  %i.gk = load ptr, ptr @PyExc_OverflowError, align 8, !tbaa !227
...
bb.a:
  ...
  %.val2.i = load i64, ptr %i.b, align 8, !tbaa !234
...
bb.b:                                             ; preds = %_PyUnicode_EnsureUnicode.exit
  ...
  %.val.i8 = load ptr, ptr %i.g, align 8, !tbaa !229
  %i.h = getelementptr i8, ptr %.val.i8, i64 168
  %.val2.i9 = load i64, ptr %i.h, align 8, !tbaa !234
...
_PyUnicode_EnsureUnicode.exit12.thread:           ; preds = %bb.b
  %i.j = load ptr, ptr @PyExc_TypeError, align 8, !tbaa !227
...
bb.a:
  ...
  %.val100 = load i64, ptr %i.a, align 8, !tbaa !239 ; 75 uses
...
_PyUnicode_DATA.exit:                             ; preds = %bb.g, %bb.h
  ...
  %i.p = tail call ptr @PyList_New(i64 noundef %i.o) #33, !inline_history !668 ; 10 uses
...
.lr.ph.i:                                         ; preds = %.preheader129.i, %bb.k
  ...
  %i.w = load i8, ptr %i.v, align 1, !tbaa !237   ; 3 uses
...
bb.j:                                             ; preds = %.lr.ph.i
  ...
  %i.ad = tail call i32 @_PyUnicode_IsWhitespace(i32 noundef %i.ac) #33, !inline_history !668
  br label %Py_UNICODE_ISSPACE.exit.i
...
bb.k:                                             ; preds = %Py_UNICODE_ISSPACE.exit.i
  ...
  br i1 %exitcond.not.i, label %.loopexit.thread.i, label %.lr.ph.i, !llvm.loop !669
...
.preheader128.i:                                  ; preds = %Py_UNICODE_ISSPACE.exit103.i
  ...
  br i1 %i.ah, label %.lr.ph1320, label %.critedge2.i, !llvm.loop !670
...
.lr.ph1320:                                       ; preds = %.preheader128.i.preheader, %.preheader128.i
  ...
  %i.aj = load i8, ptr %i.ai, align 1, !tbaa !237 ; 3 uses
...
bb.r:                                             ; preds = %bb.q
  %i.ba = tail call ptr @PyUnicode_New(i64 noundef %i.ay, i32 noundef 127), !inline_history !671 ; 5 uses
...
bb.u:                                             ; preds = %bb.s
  ...
  %.val4.i.i.i = load ptr, ptr %i.be, align 8, !tbaa !237
  br label %_PyUnicode_FromASCII.exit.thread120.i
...
_PyUnicode_FromASCII.exit.i:                      ; preds = %bb.q
  %i.bf = load i8, ptr %i.ax, align 1, !tbaa !237 ; 3 uses
...
bb.w:                                             ; preds = %bb.v
  %.val100.i = load ptr, ptr %i.t, align 8, !tbaa !279
  %i.bp = getelementptr [8 x i8], ptr %.val100.i, i64 %.0139.i
  store ptr %.0.i105122.i, ptr %i.bp, align 8, !tbaa !227
  br label %Py_DECREF.exit92.i

bb.x:                                             ; preds = %bb.v
  %i.bq = tail call i32 @PyList_Append(ptr noundef nonnull %i.p, ptr noundef nonnull %.0.i105122.i) #33, !inline_history !668
  %.not83.i = icmp eq i32 %i.bq, 0
  %i.br = load i32, ptr %.0.i105122.i, align 8, !tbaa !237 ; 3 uses
...
bb.z:                                             ; preds = %bb.y
  ...
  store i32 %i.bs, ptr %.0.i105122.i, align 8, !tbaa !237
...
bb.ab:                                            ; preds = %bb.aa
  ...
  store i32 %i.bu, ptr %.0.i105122.i, align 8, !tbaa !237
  %i.bv = icmp eq i32 %i.bu, 0
  br i1 %i.bv, label %bb.ac, label %Py_DECREF.exit92.i

bb.ac:                                            ; preds = %bb.ab
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i105122.i) #33, !inline_history !668
  br label %Py_DECREF.exit92.i
...
Py_DECREF.exit92.i:                               ; preds = %bb.ac, %bb.ab, %bb.aa, %bb.w
  ...
  br i1 %exitcond150.not.i, label %.loopexit.i, label %.preheader129.i, !llvm.loop !672
...
.preheader.i:                                     ; preds = %.loopexit.i, %bb.af
  ...
  %i.bz = load i8, ptr %i.by, align 1, !tbaa !237 ; 3 uses
...
bb.ad:                                            ; preds = %.preheader.i
  ...
  %i.cd = load i8, ptr %i.cc, align 1, !tbaa !237
  %i.ce = zext i8 %i.cd to i32
  br label %Py_UNICODE_ISSPACE.exit107.i

bb.ae:                                            ; preds = %.preheader.i
  %i.cf = zext i8 %i.bz to i32
  %i.cg = tail call i32 @_PyUnicode_IsWhitespace(i32 noundef %i.cf) #33, !inline_history !668
  br label %Py_UNICODE_ISSPACE.exit107.i
...
bb.af:                                            ; preds = %Py_UNICODE_ISSPACE.exit107.i
  ...
  br i1 %exitcond151.not.i, label %.loopexit.thread.i, label %.preheader.i, !llvm.loop !673
...
bb.ah:                                            ; preds = %bb.ag
  %i.ck = tail call ptr @PyUnicode_New(i64 noundef %i.ci, i32 noundef 127), !inline_history !671 ; 5 uses
...
bb.ak:                                            ; preds = %bb.ai
  ...
  %.val4.i.i117.i = load ptr, ptr %i.co, align 8, !tbaa !237
  br label %_PyUnicode_FromASCII.exit118.thread124.i
...
_PyUnicode_FromASCII.exit118.i:                   ; preds = %bb.ag
  %i.cp = load i8, ptr %3, align 1, !tbaa !237    ; 3 uses
...
bb.am:                                            ; preds = %bb.al
  ...
  %.val99.i = load ptr, ptr %i.cz, align 8, !tbaa !279
  %i.da = getelementptr [8 x i8], ptr %.val99.i, i64 %.1.i
  store ptr %.0.i116126.i, ptr %i.da, align 8, !tbaa !227
  br label %Py_DECREF.exit88.i

bb.an:                                            ; preds = %bb.al
  %i.db = tail call i32 @PyList_Append(ptr noundef nonnull %i.p, ptr noundef nonnull %.0.i116126.i) #33, !inline_history !668
  %.not86.i = icmp eq i32 %i.db, 0
  %i.dc = load i32, ptr %.0.i116126.i, align 8, !tbaa !237 ; 3 uses
...
bb.ap:                                            ; preds = %bb.ao
  ...
  store i32 %i.dd, ptr %.0.i116126.i, align 8, !tbaa !237
...
bb.ar:                                            ; preds = %bb.aq
  ...
  store i32 %i.df, ptr %.0.i116126.i, align 8, !tbaa !237
  %i.dg = icmp eq i32 %i.df, 0
  br i1 %i.dg, label %bb.as, label %Py_DECREF.exit88.i

bb.as:                                            ; preds = %bb.ar
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i116126.i) #33, !inline_history !668
  br label %Py_DECREF.exit88.i
...
.loopexit.thread.i:                               ; preds = %.critedge.i, %bb.k, %bb.af, %Py_DECREF.exit88.i, %.critedge4.i, %.loopexit.i, %Py_INCREF.exit.i
  ...
  store i64 %.2.i, ptr %i.di, align 8, !tbaa !262
...
Py_DECREF.exit94.sink.split.i:                    ; preds = %bb.ap, %bb.z
  ...
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i116126.sink.i) #33, !inline_history !668
...
Py_DECREF.exit94.i:                               ; preds = %_PyUnicode_FromASCII.exit.i, %bb.r, %Py_DECREF.exit94.sink.split.i, %bb.ap, %bb.ao, %_PyUnicode_FromASCII.exit118.i, %bb.ah, %bb.z, %bb.y
  %i.dj = load i32, ptr %i.p, align 8, !tbaa !237 ; 2 uses
...
bb.at:                                            ; preds = %Py_DECREF.exit94.i
  ...
  store i32 %i.dk, ptr %i.p, align 8, !tbaa !237
  %i.dl = icmp eq i32 %i.dk, 0
  br i1 %i.dl, label %bb.au, label %asciilib_split_whitespace.exit

bb.au:                                            ; preds = %bb.at
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.p) #33, !inline_history !668
  br label %asciilib_split_whitespace.exit
...
bb.aw:                                            ; preds = %bb.av
  %.val4.i112 = load ptr, ptr %i.dm, align 8, !tbaa !237
...
_PyUnicode_DATA.exit113:                          ; preds = %bb.av, %bb.aw
  ...
  %i.dp = tail call ptr @PyList_New(i64 noundef %i.do) #33, !inline_history !674 ; 10 uses
...
.lr.ph.i157:                                      ; preds = %.preheader142.i, %bb.az
  ...
  %i.dw = load i8, ptr %i.dv, align 1, !tbaa !237 ; 3 uses
...
bb.ax:                                            ; preds = %.lr.ph.i157
  ...
  %i.ea = load i8, ptr %i.dz, align 1, !tbaa !237
  %i.eb = zext i8 %i.ea to i32
  br label %Py_UNICODE_ISSPACE.exit.i158

bb.ay:                                            ; preds = %.lr.ph.i157
  %i.ec = zext i8 %i.dw to i32
  %i.ed = tail call i32 @_PyUnicode_IsWhitespace(i32 noundef %i.ec) #33, !inline_history !674
  br label %Py_UNICODE_ISSPACE.exit.i158
...
bb.az:                                            ; preds = %Py_UNICODE_ISSPACE.exit.i158
  ...
  br i1 %exitcond.not.i161, label %.loopexit.thread.i117, label %.lr.ph.i157, !llvm.loop !675
...
.preheader141.i:                                  ; preds = %Py_UNICODE_ISSPACE.exit103.i154
  ...
  br i1 %i.eh, label %.lr.ph1325, label %.critedge2.i137, !llvm.loop !676
...
.lr.ph1325:                                       ; preds = %.preheader141.i.preheader, %.preheader141.i
  ...
  %i.ej = load i8, ptr %i.ei, align 1, !tbaa !237 ; 3 uses
...
bb.ba:                                            ; preds = %.lr.ph1325
  ...
  %i.en = load i8, ptr %i.em, align 1, !tbaa !237
  %i.eo = zext i8 %i.en to i32
  br label %Py_UNICODE_ISSPACE.exit103.i154

bb.bb:                                            ; preds = %.lr.ph1325
  %i.ep = zext i8 %i.ej to i32
  %i.eq = tail call i32 @_PyUnicode_IsWhitespace(i32 noundef %i.ep) #33, !inline_history !674
  br label %Py_UNICODE_ISSPACE.exit103.i154
...
Py_UNICODE_ISSPACE.exit103.i154:                  ; preds = %bb.bb, %bb.ba
  ...
  br i1 %.not81.i156, label %.preheader141.i, label %Py_UNICODE_ISSPACE.exit103.i154..critedge2.i137_crit_edge, !llvm.loop !676

Py_UNICODE_ISSPACE.exit103.i154..critedge2.i137_crit_edge: ; preds = %Py_UNICODE_ISSPACE.exit103.i154
  br label %.critedge2.i137, !llvm.loop !676
...
bb.bj:                                            ; preds = %.preheader.i.i.i
  %i.fe = load i64, ptr %.017.i.i.i, align 8, !tbaa !226
...
.thread31.i.i.i:                                  ; preds = %bb.bk, %bb.bi
  ...
  %i.fi = load i8, ptr %.2.i.i.i, align 1, !tbaa !237
  %.not28.i.i.i = icmp sgt i8 %i.fi, -1
  br i1 %.not28.i.i.i, label %bb.bh, label %ucs1lib_find_max_char.exit.i.i, !llvm.loop !1
...
ucs1lib_find_max_char.exit.i.i:                   ; preds = %.thread31.i.i.i, %bb.bk, %bb.bh, %bb.bj
  ...
  %i.fj = tail call ptr @PyUnicode_New(i64 noundef %i.ey, i32 noundef %.5.i.i.i), !inline_history !677 ; 5 uses
...
bb.bn:                                            ; preds = %bb.bl
  ...
  %.val4.i.i.i149 = load ptr, ptr %i.fn, align 8, !tbaa !237
  br label %_PyUnicode_DATA.exit.i.i
...
_PyUnicode_FromUCS1.exit.i:                       ; preds = %bb.bf
  %i.fo = load i8, ptr %i.ex, align 1, !tbaa !237 ; 3 uses
...
bb.bo:                                            ; preds = %_PyUnicode_FromUCS1.exit.thread.i
  %.val100.i143 = load ptr, ptr %i.dt, align 8, !tbaa !279
  %i.fy = getelementptr [8 x i8], ptr %.val100.i143, i64 %.0154.i
  store ptr %.0.i104131.i, ptr %i.fy, align 8, !tbaa !227
  br label %Py_DECREF.exit92.i142

bb.bp:                                            ; preds = %_PyUnicode_FromUCS1.exit.thread.i
  %i.fz = tail call i32 @PyList_Append(ptr noundef nonnull %i.dp, ptr noundef nonnull %.0.i104131.i) #33, !inline_history !674
  %.not83.i139 = icmp eq i32 %i.fz, 0
  %i.ga = load i32, ptr %.0.i104131.i, align 8, !tbaa !237 ; 3 uses
...
bb.br:                                            ; preds = %bb.bq
  ...
  store i32 %i.gb, ptr %.0.i104131.i, align 8, !tbaa !237
...
bb.bt:                                            ; preds = %bb.bs
  ...
  store i32 %i.gd, ptr %.0.i104131.i, align 8, !tbaa !237
  %i.ge = icmp eq i32 %i.gd, 0
  br i1 %i.ge, label %bb.bu, label %Py_DECREF.exit92.i142

bb.bu:                                            ; preds = %bb.bt
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i104131.i) #33, !inline_history !674
  br label %Py_DECREF.exit92.i142
...
Py_DECREF.exit92.i142:                            ; preds = %bb.bu, %bb.bt, %bb.bs, %bb.bo
  ...
  br i1 %exitcond169.not.i, label %.loopexit.i114, label %.preheader142.i, !llvm.loop !678
...
.preheader.i120:                                  ; preds = %.loopexit.i114, %bb.bx
  ...
  %i.gi = load i8, ptr %i.gh, align 1, !tbaa !237 ; 3 uses
...
bb.bv:                                            ; preds = %.preheader.i120
  ...
  %i.gm = load i8, ptr %i.gl, align 1, !tbaa !237
  %i.gn = zext i8 %i.gm to i32
  br label %Py_UNICODE_ISSPACE.exit107.i121

bb.bw:                                            ; preds = %.preheader.i120
  %i.go = zext i8 %i.gi to i32
  %i.gp = tail call i32 @_PyUnicode_IsWhitespace(i32 noundef %i.go) #33, !inline_history !674
  br label %Py_UNICODE_ISSPACE.exit107.i121
...
bb.bx:                                            ; preds = %Py_UNICODE_ISSPACE.exit107.i121
  ...
  br i1 %exitcond170.not.i, label %.loopexit.thread.i117, label %.preheader.i120, !llvm.loop !679
...
bb.cb:                                            ; preds = %.preheader.i.i125.i
  %i.gx = load i64, ptr %.017.i.i126.i, align 8, !tbaa !226
  %i.gy = and i64 %i.gx, -9187201950435737472
  %.not27.i.i128.i = icmp eq i64 %i.gy, 0
  br i1 %.not27.i.i128.i, label %.preheader.i.i125.i, label %ucs1lib_find_max_char.exit.i110.i, !llvm.loop !0
...
.thread31.i.i122.i:                               ; preds = %bb.cc, %bb.ca
  ...
  %i.hb = load i8, ptr %.2.i.i123.i, align 1, !tbaa !237
  %.not28.i.i124.i = icmp sgt i8 %i.hb, -1
  br i1 %.not28.i.i124.i, label %bb.bz, label %ucs1lib_find_max_char.exit.i110.i, !llvm.loop !1
...
ucs1lib_find_max_char.exit.i110.i:                ; preds = %.thread31.i.i122.i, %bb.cc, %bb.bz, %bb.cb
  ...
  %i.hc = tail call ptr @PyUnicode_New(i64 noundef %5, i32 noundef %.5.i.i111.i), !inline_history !677 ; 5 uses
...
bb.cf:                                            ; preds = %bb.cd
  ...
  %.val4.i.i120.i = load ptr, ptr %i.hg, align 8, !tbaa !237
  br label %_PyUnicode_DATA.exit.i118.i
...
_PyUnicode_FromUCS1.exit129.i:                    ; preds = %4
  %i.hh = load i8, ptr %i.gr, align 1, !tbaa !237 ; 3 uses
...
bb.cg:                                            ; preds = %_PyUnicode_FromUCS1.exit129.thread.i
  ...
  %.val99.i132 = load ptr, ptr %i.hr, align 8, !tbaa !279
  %i.hs = getelementptr [8 x i8], ptr %.val99.i132, i64 %.1.i116
  store ptr %.0.i108135.i, ptr %i.hs, align 8, !tbaa !227
  br label %Py_DECREF.exit88.i131

bb.ch:                                            ; preds = %_PyUnicode_FromUCS1.exit129.thread.i
  %i.ht = tail call i32 @PyList_Append(ptr noundef nonnull %i.dp, ptr noundef nonnull %.0.i108135.i) #33, !inline_history !674
  %.not86.i126 = icmp eq i32 %i.ht, 0
  %i.hu = load i32, ptr %.0.i108135.i, align 8, !tbaa !237 ; 3 uses
...
bb.cj:                                            ; preds = %bb.ci
  ...
  store i32 %i.hv, ptr %.0.i108135.i, align 8, !tbaa !237
...
bb.cl:                                            ; preds = %bb.ck
  ...
  store i32 %i.hx, ptr %.0.i108135.i, align 8, !tbaa !237
  %i.hy = icmp eq i32 %i.hx, 0
  br i1 %i.hy, label %bb.cm, label %Py_DECREF.exit88.i131

bb.cm:                                            ; preds = %bb.cl
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i108135.i) #33, !inline_history !674
  br label %Py_DECREF.exit88.i131
...
.loopexit.thread.i117:                            ; preds = %.critedge.i133, %bb.az, %bb.bx, %Py_DECREF.exit88.i131, %.critedge4.i124, %.loopexit.i114, %Py_INCREF.exit.i152
  ...
  store i64 %.2.i118, ptr %i.ia, align 8, !tbaa !262
  br label %asciilib_split_whitespace.exit

Py_DECREF.exit94.sink.split.i130:                 ; preds = %bb.cj, %bb.br
  %.0.i108135.sink.i = phi ptr [ %.0.i104131.i, %bb.br ], [ %.0.i108135.i, %bb.cj ]
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i108135.sink.i) #33, !inline_history !674
...
Py_DECREF.exit94.i128:                            ; preds = %_PyUnicode_FromUCS1.exit.i, %ucs1lib_find_max_char.exit.i.i, %Py_DECREF.exit94.sink.split.i130, %bb.cj, %bb.ci, %_PyUnicode_FromUCS1.exit129.i, %ucs1lib_find_max_char.exit.i110.i, %bb.br, %bb.bq
  %i.ib = load i32, ptr %i.dp, align 8, !tbaa !237 ; 2 uses
...
bb.cn:                                            ; preds = %Py_DECREF.exit94.i128
  ...
  store i32 %i.ic, ptr %i.dp, align 8, !tbaa !237
  %i.id = icmp eq i32 %i.ic, 0
  br i1 %i.id, label %bb.co, label %asciilib_split_whitespace.exit

bb.co:                                            ; preds = %bb.cn
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.dp) #33, !inline_history !674
  br label %asciilib_split_whitespace.exit
...
bb.cr:                                            ; preds = %bb.cp
  ...
  %.val4.i168 = load ptr, ptr %i.ig, align 8, !tbaa !237
  br label %_PyUnicode_DATA.exit169
...
_PyUnicode_DATA.exit169:                          ; preds = %bb.cq, %bb.cr
  ...
  %i.ij = tail call ptr @PyList_New(i64 noundef %i.ii) #33, !inline_history !680 ; 10 uses
...
.lr.ph.i204:                                      ; preds = %.preheader108.i, %bb.cu
  ...
  %i.iq = load i16, ptr %i.ip, align 2, !tbaa !240 ; 3 uses
...
bb.cs:                                            ; preds = %.lr.ph.i204
  ...
  %i.iu = load i8, ptr %i.it, align 1, !tbaa !237
  %i.iv = zext i8 %i.iu to i32
  br label %Py_UNICODE_ISSPACE.exit.i205

bb.ct:                                            ; preds = %.lr.ph.i204
  %i.iw = zext i16 %i.iq to i32
  %i.ix = tail call i32 @_PyUnicode_IsWhitespace(i32 noundef %i.iw) #33, !inline_history !680
  br label %Py_UNICODE_ISSPACE.exit.i205
...
bb.cu:                                            ; preds = %Py_UNICODE_ISSPACE.exit.i205
  ...
  br i1 %exitcond.not.i208, label %.loopexit.thread.i173, label %.lr.ph.i204, !llvm.loop !681
...
.preheader107.i:                                  ; preds = %Py_UNICODE_ISSPACE.exit103.i201
  ...
  br i1 %i.jb, label %.lr.ph1315, label %.critedge2.i191, !llvm.loop !682
...
.lr.ph1315:                                       ; preds = %.preheader107.i.preheader, %.preheader107.i
  ...
  %i.jd = load i16, ptr %i.jc, align 2, !tbaa !240 ; 3 uses
...
bb.cv:                                            ; preds = %.lr.ph1315
  ...
  %i.jh = load i8, ptr %i.jg, align 1, !tbaa !237
  %i.ji = zext i8 %i.jh to i32
  br label %Py_UNICODE_ISSPACE.exit103.i201

bb.cw:                                            ; preds = %.lr.ph1315
  %i.jj = zext i16 %i.jd to i32
  %i.jk = tail call i32 @_PyUnicode_IsWhitespace(i32 noundef %i.jj) #33, !inline_history !680
  br label %Py_UNICODE_ISSPACE.exit103.i201
...
Py_UNICODE_ISSPACE.exit103.i201:                  ; preds = %bb.cw, %bb.cv
  ...
  br i1 %.not81.i203, label %.preheader107.i, label %Py_UNICODE_ISSPACE.exit103.i201..critedge2.i191_crit_edge, !llvm.loop !682

Py_UNICODE_ISSPACE.exit103.i201..critedge2.i191_crit_edge: ; preds = %Py_UNICODE_ISSPACE.exit103.i201
  br label %.critedge2.i191, !llvm.loop !682
...
bb.da:                                            ; preds = %bb.cx, %.critedge2.i191
  ...
  %i.jt = tail call fastcc ptr @_PyUnicode_FromUCS2(ptr noundef readonly %i.jr, i64 noundef %i.js), !inline_history !680 ; 8 uses
...
bb.dc:                                            ; preds = %bb.db
  %.val100.i197 = load ptr, ptr %i.in, align 8, !tbaa !279
  %i.jw = getelementptr [8 x i8], ptr %.val100.i197, i64 %.0119.i
  store ptr %i.jt, ptr %i.jw, align 8, !tbaa !227
  br label %Py_DECREF.exit92.i196

bb.dd:                                            ; preds = %bb.db
  %i.jx = tail call i32 @PyList_Append(ptr noundef nonnull %i.ij, ptr noundef nonnull %i.jt) #33, !inline_history !680
  %.not83.i193 = icmp eq i32 %i.jx, 0
  %i.jy = load i32, ptr %i.jt, align 8, !tbaa !237 ; 3 uses
...
bb.df:                                            ; preds = %bb.de
  ...
  store i32 %i.jz, ptr %i.jt, align 8, !tbaa !237
...
bb.dh:                                            ; preds = %bb.dg
  ...
  store i32 %i.kb, ptr %i.jt, align 8, !tbaa !237
  %i.kc = icmp eq i32 %i.kb, 0
  br i1 %i.kc, label %bb.di, label %Py_DECREF.exit92.i196

bb.di:                                            ; preds = %bb.dh
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.jt) #33, !inline_history !680
  br label %Py_DECREF.exit92.i196
...
Py_DECREF.exit92.i196:                            ; preds = %bb.di, %bb.dh, %bb.dg, %bb.dc
  ...
  br i1 %exitcond131.not.i, label %.loopexit.i170, label %.preheader108.i, !llvm.loop !683
...
.preheader.i176:                                  ; preds = %.loopexit.i170, %bb.dl
  ...
  %i.kg = load i16, ptr %i.kf, align 2, !tbaa !240 ; 3 uses
...
bb.dj:                                            ; preds = %.preheader.i176
  ...
  %i.kk = load i8, ptr %i.kj, align 1, !tbaa !237
  %i.kl = zext i8 %i.kk to i32
  br label %Py_UNICODE_ISSPACE.exit105.i

bb.dk:                                            ; preds = %.preheader.i176
  %i.km = zext i16 %i.kg to i32
  %i.kn = tail call i32 @_PyUnicode_IsWhitespace(i32 noundef %i.km) #33, !inline_history !680
  br label %Py_UNICODE_ISSPACE.exit105.i
...
bb.dl:                                            ; preds = %Py_UNICODE_ISSPACE.exit105.i
  ...
  br i1 %exitcond132.not.i, label %.loopexit.thread.i173, label %.preheader.i176, !llvm.loop !684
...
bb.dm:                                            ; preds = %.critedge4.i178
  ...
  %i.kr = tail call fastcc ptr @_PyUnicode_FromUCS2(ptr noundef nonnull readonly %i.kp, i64 noundef %i.kq), !inline_history !680 ; 8 uses
...
bb.do:                                            ; preds = %bb.dn
  ...
  %.val99.i186 = load ptr, ptr %i.ku, align 8, !tbaa !279
  %i.kv = getelementptr [8 x i8], ptr %.val99.i186, i64 %.1.i172
  store ptr %i.kr, ptr %i.kv, align 8, !tbaa !227
  br label %Py_DECREF.exit88.i185

bb.dp:                                            ; preds = %bb.dn
  %i.kw = tail call i32 @PyList_Append(ptr noundef nonnull %i.ij, ptr noundef nonnull %i.kr) #33, !inline_history !680
  %.not86.i180 = icmp eq i32 %i.kw, 0
  %i.kx = load i32, ptr %i.kr, align 8, !tbaa !237 ; 3 uses
...
bb.dr:                                            ; preds = %bb.dq
  ...
  store i32 %i.ky, ptr %i.kr, align 8, !tbaa !237
...
bb.dt:                                            ; preds = %bb.ds
  ...
  store i32 %i.la, ptr %i.kr, align 8, !tbaa !237
  %i.lb = icmp eq i32 %i.la, 0
  br i1 %i.lb, label %bb.du, label %Py_DECREF.exit88.i185

bb.du:                                            ; preds = %bb.dt
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.kr) #33, !inline_history !680
  br label %Py_DECREF.exit88.i185
...
.loopexit.thread.i173:                            ; preds = %.critedge.i187, %bb.cu, %bb.dl, %Py_DECREF.exit88.i185, %.critedge4.i178, %.loopexit.i170, %Py_INCREF.exit.i199
  ...
  store i64 %.2.i174, ptr %i.ld, align 8, !tbaa !262
  br label %asciilib_split_whitespace.exit

Py_DECREF.exit94.sink.split.i184:                 ; preds = %bb.dr, %bb.df
  %.sink.i = phi ptr [ %i.jt, %bb.df ], [ %i.kr, %bb.dr ]
  tail call void @_Py_Dealloc(ptr noundef nonnull %.sink.i) #33, !inline_history !680
...
Py_DECREF.exit94.i182:                            ; preds = %bb.da, %Py_DECREF.exit94.sink.split.i184, %bb.dr, %bb.dq, %bb.dm, %bb.df, %bb.de
  %i.le = load i32, ptr %i.ij, align 8, !tbaa !237 ; 2 uses
...
bb.dv:                                            ; preds = %Py_DECREF.exit94.i182
  ...
  store i32 %i.lf, ptr %i.ij, align 8, !tbaa !237
  %i.lg = icmp eq i32 %i.lf, 0
  br i1 %i.lg, label %bb.dw, label %asciilib_split_whitespace.exit

bb.dw:                                            ; preds = %bb.dv
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.ij) #33, !inline_history !680
  br label %asciilib_split_whitespace.exit
...
bb.dz:                                            ; preds = %bb.dx
  ...
  %.val4.i215 = load ptr, ptr %i.lj, align 8, !tbaa !237
  br label %_PyUnicode_DATA.exit216
...
_PyUnicode_DATA.exit216:                          ; preds = %bb.dy, %bb.dz
  ...
  %i.lm = tail call ptr @PyList_New(i64 noundef %i.ll) #33, !inline_history !685 ; 10 uses
...
.lr.ph.i264:                                      ; preds = %.preheader108.i241, %bb.ec
  ...
  %i.lt = load i32, ptr %i.ls, align 4, !tbaa !43 ; 3 uses
...
bb.ea:                                            ; preds = %.lr.ph.i264
  ...
  %i.lx = load i8, ptr %i.lw, align 1, !tbaa !237
  %i.ly = zext i8 %i.lx to i32
  br label %Py_UNICODE_ISSPACE.exit.i266

bb.eb:                                            ; preds = %.lr.ph.i264
  %i.lz = tail call i32 @_PyUnicode_IsWhitespace(i32 noundef %i.lt) #33, !inline_history !685
  br label %Py_UNICODE_ISSPACE.exit.i266
...
bb.ec:                                            ; preds = %Py_UNICODE_ISSPACE.exit.i266
  ...
  br i1 %exitcond.not.i269, label %.loopexit.thread.i221, label %.lr.ph.i264, !llvm.loop !686
...
.preheader107.i246:                               ; preds = %Py_UNICODE_ISSPACE.exit103.i261
  ...
  br i1 %i.md, label %.lr.ph, label %.critedge2.i249, !llvm.loop !687
...
.lr.ph:                                           ; preds = %.preheader107.i246.preheader, %.preheader107.i246
  ...
  %i.mf = load i32, ptr %i.me, align 4, !tbaa !43 ; 3 uses
...
bb.ed:                                            ; preds = %.lr.ph
  ...
  %i.mj = load i8, ptr %i.mi, align 1, !tbaa !237
  %i.mk = zext i8 %i.mj to i32
  br label %Py_UNICODE_ISSPACE.exit103.i261

bb.ee:                                            ; preds = %.lr.ph
  %i.ml = tail call i32 @_PyUnicode_IsWhitespace(i32 noundef %i.mf) #33, !inline_history !685
  br label %Py_UNICODE_ISSPACE.exit103.i261
...
Py_UNICODE_ISSPACE.exit103.i261:                  ; preds = %bb.ee, %bb.ed
  ...
  br i1 %.not81.i263, label %.preheader107.i246, label %Py_UNICODE_ISSPACE.exit103.i261..critedge2.i249_crit_edge, !llvm.loop !687

Py_UNICODE_ISSPACE.exit103.i261..critedge2.i249_crit_edge: ; preds = %Py_UNICODE_ISSPACE.exit103.i261
  br label %.critedge2.i249, !llvm.loop !687
...
bb.ei:                                            ; preds = %bb.ef, %.critedge2.i249
  ...
  %i.mu = tail call fastcc ptr @_PyUnicode_FromUCS4(ptr noundef %i.ms, i64 noundef %i.mt), !inline_history !685 ; 8 uses
...
bb.ek:                                            ; preds = %bb.ej
  %.val100.i256 = load ptr, ptr %i.lq, align 8, !tbaa !279
  %i.mx = getelementptr [8 x i8], ptr %.val100.i256, i64 %.0119.i242
  store ptr %i.mu, ptr %i.mx, align 8, !tbaa !227
  br label %Py_DECREF.exit92.i254

bb.el:                                            ; preds = %bb.ej
  %i.my = tail call i32 @PyList_Append(ptr noundef nonnull %i.lm, ptr noundef nonnull %i.mu) #33, !inline_history !685
  %.not83.i251 = icmp eq i32 %i.my, 0
  %i.mz = load i32, ptr %i.mu, align 8, !tbaa !237 ; 3 uses
...
bb.en:                                            ; preds = %bb.em
  ...
  store i32 %i.na, ptr %i.mu, align 8, !tbaa !237
...
bb.ep:                                            ; preds = %bb.eo
  ...
  store i32 %i.nc, ptr %i.mu, align 8, !tbaa !237
  %i.nd = icmp eq i32 %i.nc, 0
  br i1 %i.nd, label %bb.eq, label %Py_DECREF.exit92.i254

bb.eq:                                            ; preds = %bb.ep
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.mu) #33, !inline_history !685
  br label %Py_DECREF.exit92.i254
...
Py_DECREF.exit92.i254:                            ; preds = %bb.eq, %bb.ep, %bb.eo, %bb.ek
  ...
  br i1 %exitcond131.not.i255, label %.loopexit.i218, label %.preheader108.i241, !llvm.loop !688
...
.preheader.i224:                                  ; preds = %.loopexit.i218, %bb.et
  ...
  %i.nh = load i32, ptr %i.ng, align 4, !tbaa !43 ; 3 uses
...
bb.er:                                            ; preds = %.preheader.i224
  ...
  %i.nl = load i8, ptr %i.nk, align 1, !tbaa !237
  %i.nm = zext i8 %i.nl to i32
  br label %Py_UNICODE_ISSPACE.exit105.i226

bb.es:                                            ; preds = %.preheader.i224
  %i.nn = tail call i32 @_PyUnicode_IsWhitespace(i32 noundef %i.nh) #33, !inline_history !685
  br label %Py_UNICODE_ISSPACE.exit105.i226
...
bb.et:                                            ; preds = %Py_UNICODE_ISSPACE.exit105.i226
  ...
  br i1 %exitcond132.not.i229, label %.loopexit.thread.i221, label %.preheader.i224, !llvm.loop !689
...
bb.eu:                                            ; preds = %.critedge4.i230
  ...
  %i.nr = tail call fastcc ptr @_PyUnicode_FromUCS4(ptr noundef nonnull %i.np, i64 noundef %i.nq), !inline_history !685 ; 8 uses
...
bb.ew:                                            ; preds = %bb.ev
  ...
  %.val99.i239 = load ptr, ptr %i.nu, align 8, !tbaa !279
...
bb.ex:                                            ; preds = %bb.ev
  %i.nw = tail call i32 @PyList_Append(ptr noundef nonnull %i.lm, ptr noundef nonnull %i.nr) #33, !inline_history !685
...
bb.fc:                                            ; preds = %bb.fb
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.nr) #33, !inline_history !685
  br label %Py_DECREF.exit88.i238
...
.loopexit.thread.i221:                            ; preds = %.critedge.i244, %bb.ec, %bb.et, %Py_DECREF.exit88.i238, %.critedge4.i230, %.loopexit.i218, %Py_INCREF.exit.i259
  ...
  store i64 %.2.i222, ptr %i.od, align 8, !tbaa !262
  br label %asciilib_split_whitespace.exit

Py_DECREF.exit94.sink.split.i236:                 ; preds = %bb.ez, %bb.en
  %.sink.i237 = phi ptr [ %i.mu, %bb.en ], [ %i.nr, %bb.ez ]
  tail call void @_Py_Dealloc(ptr noundef nonnull %.sink.i237) #33, !inline_history !685
...
Py_DECREF.exit94.i234:                            ; preds = %bb.ei, %Py_DECREF.exit94.sink.split.i236, %bb.ez, %bb.ey, %bb.eu, %bb.en, %bb.em
  %i.oe = load i32, ptr %i.lm, align 8, !tbaa !237 ; 2 uses
...
bb.fd:                                            ; preds = %Py_DECREF.exit94.i234
  ...
  store i32 %i.of, ptr %i.lm, align 8, !tbaa !237
  %i.og = icmp eq i32 %i.of, 0
  br i1 %i.og, label %bb.fe, label %asciilib_split_whitespace.exit

bb.fe:                                            ; preds = %bb.fd
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.lm) #33, !inline_history !685
  br label %asciilib_split_whitespace.exit
...
bb.fg:                                            ; preds = %bb.a
  ...
  %.val99 = load i64, ptr %i.ol, align 8, !tbaa !239 ; 16 uses
...
bb.fo:                                            ; preds = %bb.fm
  ...
  %.val4.i277 = load ptr, ptr %i.pb, align 8, !tbaa !237
  br label %_PyUnicode_DATA.exit278
...
bb.fq:                                            ; preds = %_PyUnicode_DATA.exit278
  ...
  %.val4.i285 = load ptr, ptr %i.pe, align 8, !tbaa !237
  br label %_PyUnicode_DATA.exit286
...
bb.fw:                                            ; preds = %bb.fv
  %i.pi = load ptr, ptr @PyExc_ValueError, align 8, !tbaa !227
  tail call void @PyErr_SetString(ptr noundef %i.pi, ptr noundef nonnull @.str.197) #33, !inline_history !690
  br label %asciilib_split.exit

bb.fx:                                            ; preds = %bb.fv
  %i.pj = load i8, ptr %.080, align 1, !tbaa !237
  %i.pk = tail call i64 @llvm.smin.i64(i64 %.1, i64 11)
  %i.pl = add nsw i64 %i.pk, 1
  %i.pm = tail call ptr @PyList_New(i64 noundef %i.pl) #33, !inline_history !691 ; 9 uses
...
bb.fy:                                            ; preds = %.loopexit.i.i
  ...
  br i1 %i.pq, label %.preheader.i.i, label %.critedge.i.i, !llvm.loop !692
...
.lr.ph.i.i:                                       ; preds = %.preheader.i.i, %bb.gm
  ...
  %i.pu = load i8, ptr %i.pt, align 1, !tbaa !237
...
bb.ga:                                            ; preds = %bb.fz
  %i.pz = tail call ptr @PyUnicode_New(i64 noundef %i.px, i32 noundef 127), !inline_history !693 ; 5 uses
