...
.thread.i132:                                     ; preds = %bb.az, %.lr.ph.i130, %.preheader.i129
  %.168.lcssa.i133 = phi ptr [ %.067.i123285, %.preheader.i129 ], [ %i.my, %bb.az ], [ %.168114.i, %.lr.ph.i130 ] ; 2 uses
  %.062.lcssa.i = phi ptr [ %.070.i122284, %.preheader.i129 ], [ %i.mk, %bb.az ], [ %.062115.i, %.lr.ph.i130 ] ; 3 uses
  %.not83.i134 = icmp ult ptr %.062.lcssa.i, %i.kg
...
bb.ba:                                            ; preds = %.thread.i132, %.lr.ph286
  ...
  %i.na = getelementptr i8, ptr %.171.i125, i64 %i.ao
  %i.nb = load i8, ptr %i.na, align 1, !tbaa !205
  %i.nc = zext i8 %i.nb to i32                    ; 3 uses
  %i.nd = shl nuw nsw i32 %i.nc, 8
  %i.ne = getelementptr i8, ptr %.171.i125, i64 %i.ap
  %i.nf = load i8, ptr %i.ne, align 1, !tbaa !205
  %i.ng = zext i8 %i.nf to i32
  %i.nh = or disjoint i32 %i.nd, %i.ng            ; 2 uses
  %i.ni = getelementptr i8, ptr %.171.i125, i64 2 ; 6 uses
  %i.nj = and i32 %i.nc, 248
  %.not110.i = icmp eq i32 %i.nj, 216
  br i1 %.not110.i, label %bb.bb, label %.split.i121, !llvm.loop !505

bb.bb:                                            ; preds = %bb.ba
  %i.nk = and i32 %i.nc, 220
  %.not111.i = icmp eq i32 %i.nk, 216
  br i1 %.not111.i, label %bb.bc, label %ucs4lib_utf16_decode.exit

bb.bc:                                            ; preds = %bb.bb
  %.not86.i127 = icmp ult ptr %i.ni, %i.kg
  br i1 %.not86.i127, label %bb.bd, label %ucs4lib_utf16_decode.exit

bb.bd:                                            ; preds = %bb.bc
  %i.nl = getelementptr i8, ptr %i.ni, i64 %i.ao
  %i.nm = load i8, ptr %i.nl, align 1, !tbaa !205
  %i.nn = zext i8 %i.nm to i32                    ; 2 uses
  %i.no = getelementptr i8, ptr %.171.i125, i64 4 ; 2 uses
  %i.np = and i32 %i.nn, 252
  %.not112.i = icmp eq i32 %i.np, 220
  br i1 %.not112.i, label %bb.be, label %ucs4lib_utf16_decode.exit

bb.be:                                            ; preds = %bb.bd
  %i.nq = shl nuw nsw i32 %i.nn, 8
  %i.nr = getelementptr i8, ptr %i.ni, i64 %i.ap
  %i.ns = load i8, ptr %i.nr, align 1, !tbaa !205
  %i.nt = zext i8 %i.ns to i32
  %i.nu = shl nuw nsw i32 %i.nh, 10
  %i.nv = and i32 %i.nu, 1047552
  %.masked.i128 = and i32 %i.nq, 768
  %i.nw = or disjoint i32 %.masked.i128, %i.nt
  %i.nx = add nuw nsw i32 %i.nv, 65536
  %i.ny = or disjoint i32 %i.nw, %i.nx
  br label %.split.i121

.split.i121:                                      ; preds = %bb.be, %bb.ba
  %.sink149.i = phi i32 [ %i.ny, %bb.be ], [ %i.nh, %bb.ba ]
  %.272.i = phi ptr [ %i.no, %bb.be ], [ %i.ni, %bb.ba ] ; 3 uses
  %i.nz = getelementptr i8, ptr %.4.i126, i64 4   ; 2 uses
  store i32 %.sink149.i, ptr %.4.i126, align 4, !tbaa !7
  %i.oa = icmp ult ptr %.272.i, %i.kg
  br i1 %i.oa, label %.lr.ph286, label %ucs4lib_utf16_decode.exit
...
ucs4lib_utf16_decode.exit:                        ; preds = %bb.aw, %bb.av, %bb.au, %.thread.us.i145, %.split.us.i136, %bb.bd, %bb.bc, %bb.bb, %.thread.i132, %.split.i121, %.split.us.i136.preheader, %.split.i121.preheader
  %.us-phi.i = phi ptr [ %i.as, %.split.us.i136.preheader ], [ %i.as, %.split.i121.preheader ], [ %.272.i, %.split.i121 ], [ %i.ni, %bb.bc ], [ %i.no, %bb.bd ], [ %i.ni, %bb.bb ], [ %.062.lcssa.i, %.thread.i132 ], [ %.062.lcssa.us.i, %.thread.us.i145 ], [ %i.ky, %bb.aw ], [ %i.ks, %bb.au ], [ %i.ks, %bb.av ], [ %.272.us.i, %.split.us.i136 ] ; 2 uses
  %.us-phi126.i = phi ptr [ %i.kf, %.split.us.i136.preheader ], [ %i.kf, %.split.i121.preheader ], [ %i.nz, %.split.i121 ], [ %.4.i126, %bb.bc ], [ %.4.i126, %bb.bd ], [ %.4.i126, %bb.bb ], [ %.168.lcssa.i133, %.thread.i132 ], [ %.168.lcssa.us.i146, %.thread.us.i145 ], [ %.4.us.i141, %bb.aw ], [ %.4.us.i141, %bb.au ], [ %.4.us.i141, %bb.av ], [ %i.lj, %.split.us.i136 ]
  ...
  %i.ob = ptrtoint ptr %.us-phi126.i to i64
  %i.oc = ptrtoint ptr %i.kd to i64
  %i.od = sub i64 %i.ob, %i.oc
  %i.oe = ashr exact i64 %i.od, 2
  br label %bb.bf

bb.bf:                                            ; preds = %ucs1lib_utf16_decode.exit, %asciilib_utf16_decode.exit, %ucs4lib_utf16_decode.exit, %ucs2lib_utf16_decode.exit
  %.sink = phi i64 [ %i.hj, %ucs1lib_utf16_decode.exit ], [ %i.ej, %asciilib_utf16_decode.exit ], [ %i.oe, %ucs4lib_utf16_decode.exit ], [ %i.kc, %ucs2lib_utf16_decode.exit ] ; 3 uses
  %i.of = phi ptr [ %.474.i62, %ucs1lib_utf16_decode.exit ], [ %.474.i, %asciilib_utf16_decode.exit ], [ %.us-phi.i, %ucs4lib_utf16_decode.exit ], [ %.474.i97, %ucs2lib_utf16_decode.exit ] ; 5 uses
  ...
  store i64 %.sink, ptr %i.am, align 8, !tbaa !193
...
..thread_crit_edge:                               ; preds = %bb.bf
  %.pre350 = load ptr, ptr %i.e, align 8, !tbaa !355
  br label %.thread

.thread:                                          ; preds = %..thread_crit_edge, %bb.o
  %i.og = phi ptr [ %i.at, %bb.o ], [ %.pre350, %..thread_crit_edge ] ; 2 uses
  %i.oh = phi ptr [ %i.as, %bb.o ], [ %i.of, %..thread_crit_edge ] ; 3 uses
  %i.oi = icmp eq ptr %i.oh, %i.og
  %or.cond3 = or i1 %i.aq, %i.oi
  br i1 %or.cond3, label %bb.bs, label %bb.bg

bb.bg:                                            ; preds = %.thread
  %i.oj = load ptr, ptr %i.a, align 8, !tbaa !355
  %i.ok = ptrtoint ptr %i.oh to i64
  %i.ol = ptrtoint ptr %i.oj to i64               ; 2 uses
  %i.om = sub i64 %i.ok, %i.ol
  store i64 %i.om, ptr %i.b, align 8, !tbaa !193
  %i.on = ptrtoint ptr %i.og to i64
  %i.oo = sub i64 %i.on, %i.ol
  br label %bb.br

bb.bh:                                            ; preds = %bb.bf
  %i.op = getelementptr i8, ptr %i.of, i64 -2     ; 3 uses
  store ptr %i.op, ptr %i.d, align 8, !tbaa !355
