...
unicode_char.exit:                                ; preds = %.lr.ph103, %.lr.ph111, %middle.block, %middle.block167, %.preheader94, %.preheader, %bb.a, %_PyUnicode_DATA.exit19.i, %_PyUnicode_DATA.exit.i, %bb.f, %bb.e, %bb.d, %_PyUnicode_DATA.exit92, %ucs4lib_find_max_char.exit
  %.0 = phi ptr [ %i.j, %bb.e ], [ %i.an, %_PyUnicode_DATA.exit92 ], [ null, %ucs4lib_find_max_char.exit ], [ %i.an, %.preheader ], [ getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 60176), %bb.a ], [ %i.k, %_PyUnicode_DATA.exit.i ], [ null, %bb.f ], [ %i.k, %_PyUnicode_DATA.exit19.i ], [ %i.g, %bb.d ], [ %i.an, %.preheader94 ], [ %i.an, %middle.block167 ], [ %i.an, %middle.block ], [ %i.an, %.lr.ph111 ], [ %i.an, %.lr.ph103 ]
  ret ptr %.0
}
...
_Py_NewRef.exit:                                  ; preds = %bb.a, %bb.ax, %bb.aw, %bb.av, %bb.au, %.thread202, %bb.at, %bb.as, %.loopexit.thread, %.loopexit, %bb.d, %bb.c
  %.0 = phi ptr [ null, %bb.ax ], [ %i.dw, %bb.at ], [ %i.a, %bb.d ], [ %i.a, %bb.c ], [ %i.dv, %.loopexit ], [ %i.dw, %.loopexit.thread ], [ %i.dw, %bb.as ], [ null, %.thread202 ], [ null, %bb.au ], [ null, %bb.av ], [ null, %bb.aw ], [ getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 60176), %bb.a ]
  ret ptr %.0
}
