...
begin_hunk_0_@rsplit:bb.a
  ...
  %.val92.i234 = load ptr, ptr %i.ny, align 8, !tbaa !541
  %i.nz = getelementptr [8 x i8], ptr %.val92.i234, i64 %.0.lcssa.i217
  store ptr %i.nv, ptr %i.nz, align 8, !tbaa !194
  br label %Py_DECREF.exit81.i233

bb.eu:                                            ; preds = %bb.es
  %i.oa = tail call i32 @PyList_Append(ptr noundef nonnull %i.lr, ptr noundef nonnull %i.nv) #33, !inline_history !690
  %.not78.i229 = icmp eq i32 %i.oa, 0
  %i.ob = load i32, ptr %i.nv, align 8, !tbaa !205 ; 3 uses
...
bb.ew:                                            ; preds = %bb.ev
  ...
  store i32 %i.oc, ptr %i.nv, align 8, !tbaa !205
...
bb.ey:                                            ; preds = %bb.ex
  ...
  store i32 %i.oe, ptr %i.nv, align 8, !tbaa !205
  %i.of = icmp eq i32 %i.oe, 0
  br i1 %i.of, label %bb.ez, label %Py_DECREF.exit81.i233

bb.ez:                                            ; preds = %bb.ey
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.nv) #33, !inline_history !690
  br label %Py_DECREF.exit81.i233
...
.critedge79.i218:                                 ; preds = %.preheader104.i236, %bb.eb, %bb.er, %Py_DECREF.exit81.i233, %._crit_edge.i215, %Py_INCREF.exit.i263
  ...
  store i64 %.2.i219, ptr %i.oh, align 8, !tbaa !380
  %i.oi = tail call i32 @PyList_Reverse(ptr noundef nonnull %i.lr) #33, !inline_history !690
...
Py_DECREF.exit87.sink.split.i231:                 ; preds = %bb.ew, %bb.el
  ...
  tail call void @_Py_Dealloc(ptr noundef nonnull %.sink.i232) #33, !inline_history !690
...
Py_DECREF.exit87.i221:                            ; preds = %.critedge2.thread.i252, %Py_DECREF.exit87.sink.split.i231, %.critedge79.i218, %bb.ew, %bb.ev, %.critedge5.i228, %bb.el, %bb.ek
  %i.ok = load i32, ptr %i.lr, align 8, !tbaa !205 ; 2 uses
...
bb.fa:                                            ; preds = %Py_DECREF.exit87.i221
  ...
  store i32 %i.ol, ptr %i.lr, align 8, !tbaa !205
  %i.om = icmp eq i32 %i.ol, 0
  br i1 %i.om, label %bb.fb, label %asciilib_rsplit_whitespace.exit

bb.fb:                                            ; preds = %bb.fa
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.lr) #33, !inline_history !690
...
bb.fd:                                            ; preds = %bb.a
  ...
  %.val99 = load i64, ptr %i.or, align 8, !tbaa !207 ; 30 uses
...
bb.fl:                                            ; preds = %bb.fj
  ...
  %.val4.i272 = load ptr, ptr %i.ph, align 8, !tbaa !205
  br label %_PyUnicode_DATA.exit273
...
bb.fn:                                            ; preds = %_PyUnicode_DATA.exit273
  ...
  %.val4.i280 = load ptr, ptr %i.pk, align 8, !tbaa !205
  br label %_PyUnicode_DATA.exit281
...
bb.ft:                                            ; preds = %bb.fs
  %i.po = load ptr, ptr @PyExc_ValueError, align 8, !tbaa !194
  tail call void @PyErr_SetString(ptr noundef %i.po, ptr noundef nonnull @.str.197) #33, !inline_history !695
  br label %asciilib_rsplit.exit

bb.fu:                                            ; preds = %bb.fs
  %i.pp = load i8, ptr %.080, align 1, !tbaa !205
  %i.pq = tail call i64 @llvm.smin.i64(i64 %.1, i64 11)
  %i.pr = add nsw i64 %i.pq, 1
  %i.ps = tail call ptr @PyList_New(i64 noundef %i.pr) #33, !inline_history !696 ; 12 uses
  %i.pt = icmp eq ptr %i.ps, null
  br i1 %i.pt, label %asciilib_rsplit.exit, label %3
...
.lr.ph107.i.i:                                    ; preds = %3
  %i.pu = getelementptr i8, ptr %i.ps, i64 24
...
bb.fv:                                            ; preds = %.loopexit.i.i
  ...
  br i1 %exitcond.not.i283, label %.critedge.i.i, label %.lr.ph.i.i.preheader, !llvm.loop !697

.lr.ph.i.i.preheader:                             ; preds = %.lr.ph107.i.i, %bb.fv
  %.050105.i.i1494 = phi i64 [ %i.rc, %bb.fv ], [ %4, %.lr.ph107.i.i ] ; 3 uses
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %bb.gj
  ...
  %i.px = load i8, ptr %i.pw, align 1, !tbaa !205
...
bb.fx:                                            ; preds = %bb.fw
  %i.qd = tail call ptr @PyUnicode_New(i64 noundef %i.qb, i32 noundef 127), !inline_history !698 ; 5 uses
...
bb.ga:                                            ; preds = %bb.fy
  ...
  %.val4.i.i.i.i = load ptr, ptr %i.qh, align 8, !tbaa !205
  br label %_PyUnicode_FromASCII.exit.thread90.i.i
...
_PyUnicode_FromASCII.exit.i.i:                    ; preds = %bb.fw
  %i.qi = load i8, ptr %i.qa, align 1, !tbaa !205 ; 3 uses
...
bb.gc:                                            ; preds = %bb.gb
  %.val76.i.i = load ptr, ptr %i.pu, align 8, !tbaa !541
  %i.qs = getelementptr [8 x i8], ptr %.val76.i.i, i64 %.0106.i.i1493
  store ptr %.0.i92.i.i, ptr %i.qs, align 8, !tbaa !194
  br label %.loopexit.i.i

bb.gd:                                            ; preds = %bb.gb
  %i.qt = tail call i32 @PyList_Append(ptr noundef nonnull %i.ps, ptr noundef nonnull %.0.i92.i.i) #33, !inline_history !696
  %.not61.i.i = icmp eq i32 %i.qt, 0
  %i.qu = load i32, ptr %.0.i92.i.i, align 8, !tbaa !205 ; 3 uses
...
bb.gf:                                            ; preds = %bb.ge
  ...
  store i32 %i.qv, ptr %.0.i92.i.i, align 8, !tbaa !205
...
bb.gh:                                            ; preds = %bb.gg
  ...
  store i32 %i.qx, ptr %.0.i92.i.i, align 8, !tbaa !205
  %i.qy = icmp eq i32 %i.qx, 0
  br i1 %i.qy, label %bb.gi, label %.loopexit.i.i

bb.gi:                                            ; preds = %bb.gh
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i92.i.i) #33, !inline_history !696
  br label %.loopexit.i.i

bb.gj:                                            ; preds = %.lr.ph.i.i
  %i.qz = add nsw i64 %.153102.i.i, -1
  %i.ra = icmp sgt i64 %.153102.i.i, 0
  br i1 %i.ra, label %.lr.ph.i.i, label %.critedge.i.i, !llvm.loop !699
...
.loopexit.i.i:                                    ; preds = %bb.gi, %bb.gh, %bb.gg, %bb.gc
  ...
  br i1 %i.rd, label %bb.fv, label %.critedge.i.thread.i, !llvm.loop !697

.critedge.i.i:                                    ; preds = %bb.fv, %bb.gj, %.lr.ph107.i.i
  %.050105.i.i1421 = phi i64 [ %.050105.i.i1494, %bb.gj ], [ %4, %.lr.ph107.i.i ], [ %i.rc, %bb.fv ] ; 2 uses
...
.critedge.thread.i.i:                             ; preds = %.critedge.i.i, %3
  ...
  %.val.i.i = load ptr, ptr %i.rf, align 8, !tbaa !197
...
bb.gk:                                            ; preds = %.critedge.thread.i.i
  %i.rg = load i32, ptr %0, align 8, !tbaa !205   ; 2 uses
  %i.rh = icmp ugt i32 %i.rg, -1073741825
  br i1 %i.rh, label %Py_INCREF.exit.i.i, label %bb.gl

bb.gl:                                            ; preds = %bb.gk
  %i.ri = add nuw i32 %i.rg, 1
  store i32 %i.ri, ptr %0, align 8, !tbaa !205
  br label %Py_INCREF.exit.i.i

Py_INCREF.exit.i.i:                               ; preds = %bb.gl, %bb.gk
  %6 = getelementptr i8, ptr %i.ps, i64 24
  %.val75.i.i = load ptr, ptr %6, align 8, !tbaa !541
  store ptr %0, ptr %.val75.i.i, align 8, !tbaa !194
  br label %bb.gz
...
.critedge.i.thread.i:                             ; preds = %.loopexit.i.i, %.critedge.thread.i.i, %.critedge.i.i
  ...
  %.050.lcssa131.i.i = phi i64 [ %.050.lcssa132.i.i, %.critedge.thread.i.i ], [ %.050105.i.i1421, %.critedge.i.i ], [ %i.rc, %.loopexit.i.i ] ; 3 uses
  %i.rj = icmp sgt i64 %.050.lcssa131.i.i, -2
  br i1 %i.rj, label %bb.gm, label %bb.gz

bb.gm:                                            ; preds = %.critedge.i.thread.i
  %i.rk = add i64 %.050.lcssa131.i.i, 1           ; 2 uses
  %i.rl = icmp eq i64 %.050.lcssa131.i.i, 0
  br i1 %i.rl, label %_PyUnicode_FromASCII.exit88.i.i, label %bb.gn

bb.gn:                                            ; preds = %bb.gm
  %i.rm = tail call ptr @PyUnicode_New(i64 noundef %i.rk, i32 noundef 127), !inline_history !698 ; 5 uses
...
bb.gq:                                            ; preds = %bb.go
  ...
  %.val4.i.i87.i.i = load ptr, ptr %i.rq, align 8, !tbaa !205
  br label %_PyUnicode_FromASCII.exit88.thread94.i.i
...
_PyUnicode_FromASCII.exit88.i.i:                  ; preds = %bb.gm
  %i.rr = load i8, ptr %.0.i271, align 1, !tbaa !205 ; 3 uses
...
bb.gs:                                            ; preds = %bb.gr
  %7 = getelementptr i8, ptr %i.ps, i64 24
  %.val74.i.i = load ptr, ptr %7, align 8, !tbaa !541
  %i.sb = getelementptr [8 x i8], ptr %.val74.i.i, i64 %.0.lcssa133.i.i
  store ptr %.0.i8696.i.i, ptr %i.sb, align 8, !tbaa !194
  br label %Py_DECREF.exit63.i.i

bb.gt:                                            ; preds = %bb.gr
  %i.sc = tail call i32 @PyList_Append(ptr noundef nonnull %i.ps, ptr noundef nonnull %.0.i8696.i.i) #33, !inline_history !696
  %.not60.i.i = icmp eq i32 %i.sc, 0
  %i.sd = load i32, ptr %.0.i8696.i.i, align 8, !tbaa !205 ; 3 uses
...
bb.gv:                                            ; preds = %bb.gu
  ...
  store i32 %i.se, ptr %.0.i8696.i.i, align 8, !tbaa !205
...
bb.gx:                                            ; preds = %bb.gw
  ...
  store i32 %i.sg, ptr %.0.i8696.i.i, align 8, !tbaa !205
  %i.sh = icmp eq i32 %i.sg, 0
  br i1 %i.sh, label %bb.gy, label %Py_DECREF.exit63.i.i

bb.gy:                                            ; preds = %bb.gx
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i8696.i.i) #33, !inline_history !696
  br label %Py_DECREF.exit63.i.i
...
bb.gz:                                            ; preds = %Py_DECREF.exit63.i.i, %.critedge.i.thread.i, %Py_INCREF.exit.i.i
  ...
  store i64 %.2.i.i, ptr %i.sj, align 8, !tbaa !380
  %i.sk = tail call i32 @PyList_Reverse(ptr noundef nonnull %i.ps) #33, !inline_history !696
...
Py_DECREF.exit69.sink.split.i.i:                  ; preds = %bb.gv, %bb.gf
  ...
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i8696.sink.i.i) #33, !inline_history !696
...
Py_DECREF.exit69.i.i:                             ; preds = %_PyUnicode_FromASCII.exit.i.i, %bb.fx, %Py_DECREF.exit69.sink.split.i.i, %bb.gz, %bb.gv, %bb.gu, %_PyUnicode_FromASCII.exit88.i.i, %bb.gn, %bb.gf, %bb.ge
  %i.sm = load i32, ptr %i.ps, align 8, !tbaa !205 ; 2 uses
...
bb.ha:                                            ; preds = %Py_DECREF.exit69.i.i
  ...
  store i32 %i.sn, ptr %i.ps, align 8, !tbaa !205
  %i.so = icmp eq i32 %i.sn, 0
  br i1 %i.so, label %bb.hb, label %asciilib_rsplit.exit

bb.hb:                                            ; preds = %bb.ha
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.ps) #33, !inline_history !696
  br label %asciilib_rsplit.exit

bb.hc:                                            ; preds = %bb.fs
  %i.sp = tail call i64 @llvm.smin.i64(i64 %.1, i64 11)
  %i.sq = add nsw i64 %i.sp, 1
  %i.sr = tail call ptr @PyList_New(i64 noundef %i.sq) #33, !inline_history !695 ; 12 uses
...
.lr.ph.i287.split:                                ; preds = %.lr.ph.i287.split.preheader, %Py_DECREF.exit72.i
  ...
  %i.ta = load i8, ptr %.080, align 1, !tbaa !205 ; 5 uses
  %i.tb = and i8 %i.ta, 63
...
.lr.ph.i70.i.i.prol:                              ; preds = %.lr.ph.i287.split
  %i.te = load i8, ptr %i.sx, align 1, !tbaa !205 ; 2 uses
  %i.tf = and i8 %i.te, 63
...
.lr.ph66.split.us.i.i.i:                          ; preds = %.preheader56.i.i.i, %bb.hi
  ...
  %i.to = load i8, ptr %i.tn, align 1, !tbaa !205
...
bb.he:                                            ; preds = %bb.hd
  ...
  %i.tr = load i8, ptr %i.tq, align 1, !tbaa !205
  %i.ts = and i8 %i.tr, 63
...
.preheader.us.i72.i.i:                            ; preds = %.lr.ph66.split.us.i.i.i, %bb.hf
  ...
  %i.ty = load i8, ptr %i.tx, align 1, !tbaa !205
  %i.tz = getelementptr i8, ptr %.080, i64 %.04662.us.i.i.i
  %i.ua = load i8, ptr %i.tz, align 1, !tbaa !205
...
bb.hf:                                            ; preds = %.preheader.us.i72.i.i
  ...
  br i1 %i.uc, label %.preheader.us.i72.i.i, label %asciilib_fastsearch.exit.i, !llvm.loop !662
...
bb.hg:                                            ; preds = %.thread.us.i73.i.i
  ...
  %i.ue = load i8, ptr %i.ud, align 1, !tbaa !205
  %i.uf = and i8 %i.ue, 63
...
bb.hi:                                            ; preds = %bb.hh, %bb.hg, %bb.he
  ...
  br i1 %i.ul, label %.lr.ph66.split.us.i.i.i, label %asciilib_fastsearch.exit.thread.i, !llvm.loop !663
...
.lr.ph.i70.i.i:                                   ; preds = %.lr.ph.i70.i.i.prol.loopexit, %.lr.ph.i70.i.i
  ...
  %i.un = load i8, ptr %i.um, align 1, !tbaa !205 ; 2 uses
  %i.uo = and i8 %i.un, 63
...
bb.hq:                                            ; preds = %bb.ho
  %i.vy = tail call i32 @PyList_Append(ptr noundef nonnull %i.sr, ptr noundef nonnull %.0.i88104.i) #33, !inline_history !695
  %.not.i293 = icmp eq i32 %i.vy, 0
  %i.vz = load i32, ptr %.0.i88104.i, align 8, !tbaa !205 ; 3 uses
...
bb.hs:                                            ; preds = %bb.hr
  ...
  store i32 %i.wa, ptr %.0.i88104.i, align 8, !tbaa !205
...
bb.hu:                                            ; preds = %bb.ht
  ...
  store i32 %i.wc, ptr %.0.i88104.i, align 8, !tbaa !205
  %i.wd = icmp eq i32 %i.wc, 0
  br i1 %i.wd, label %bb.hv, label %Py_DECREF.exit72.i

bb.hv:                                            ; preds = %bb.hu
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i88104.i) #33, !inline_history !695
  br label %Py_DECREF.exit72.i
...
Py_DECREF.exit72.i:                               ; preds = %bb.hv, %bb.hu, %bb.ht, %bb.hp
  ...
  br i1 %or.cond.i, label %asciilib_fastsearch.exit.thread.thread209.i, label %.lr.ph.i287.split, !llvm.loop !701
...
asciilib_fastsearch.exit.thread.thread.i:         ; preds = %.lr.ph.i287, %asciilib_fastsearch.exit.thread.i, %.preheader.i286
  ...
  %.val.i289 = load ptr, ptr %i.wi, align 8, !tbaa !197
...
bb.hy:                                            ; preds = %asciilib_fastsearch.exit.thread.thread209.i
  %i.wo = tail call ptr @PyUnicode_New(i64 noundef %.057124205.i, i32 noundef 127), !inline_history !700 ; 5 uses
...
bb.ib:                                            ; preds = %bb.hz
  ...
  %.val4.i.i98.i = load ptr, ptr %i.ws, align 8, !tbaa !205
  br label %_PyUnicode_FromASCII.exit99.thread106.i
...
_PyUnicode_FromASCII.exit99.i:                    ; preds = %asciilib_fastsearch.exit.thread.thread209.i
  %i.wt = load i8, ptr %.0.i271, align 1, !tbaa !205 ; 3 uses
...
bb.id:                                            ; preds = %bb.ic
  ...
  %.val79.i = load ptr, ptr %i.xd, align 8, !tbaa !541
  %i.xe = getelementptr [8 x i8], ptr %.val79.i, i64 %.0119207.i
  store ptr %.0.i97108.i, ptr %i.xe, align 8, !tbaa !194
  br label %Py_DECREF.exit68.i

bb.ie:                                            ; preds = %bb.ic
  %i.xf = tail call i32 @PyList_Append(ptr noundef nonnull %i.sr, ptr noundef nonnull %.0.i97108.i) #33, !inline_history !695
  %.not66.i = icmp eq i32 %i.xf, 0
  %i.xg = load i32, ptr %.0.i97108.i, align 8, !tbaa !205 ; 3 uses
...
bb.ig:                                            ; preds = %bb.if
  ...
  store i32 %i.xh, ptr %.0.i97108.i, align 8, !tbaa !205
...
bb.ii:                                            ; preds = %bb.ih
  ...
  store i32 %i.xj, ptr %.0.i97108.i, align 8, !tbaa !205
  %i.xk = icmp eq i32 %i.xj, 0
  br i1 %i.xk, label %bb.ij, label %Py_DECREF.exit68.i

bb.ij:                                            ; preds = %bb.ii
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i97108.i) #33, !inline_history !695
  br label %Py_DECREF.exit68.i
...
bb.ik:                                            ; preds = %Py_DECREF.exit68.i, %Py_INCREF.exit.i290
  ...
  store i64 %.1.i, ptr %i.xm, align 8, !tbaa !380
  %i.xn = tail call i32 @PyList_Reverse(ptr noundef nonnull %i.sr) #33, !inline_history !695
...
Py_DECREF.exit74.sink.split.i:                    ; preds = %bb.ig, %bb.hs
  ...
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i97108.sink.i) #33, !inline_history !695
...
Py_DECREF.exit74.i:                               ; preds = %_PyUnicode_FromASCII.exit.i295, %bb.hk, %Py_DECREF.exit74.sink.split.i, %bb.ik, %bb.ig, %bb.if, %_PyUnicode_FromASCII.exit99.i, %bb.hy, %bb.hs, %bb.hr
  %i.xp = load i32, ptr %i.sr, align 8, !tbaa !205 ; 2 uses
...
bb.il:                                            ; preds = %Py_DECREF.exit74.i
  ...
  store i32 %i.xq, ptr %i.sr, align 8, !tbaa !205
  %i.xr = icmp eq i32 %i.xq, 0
  br i1 %i.xr, label %bb.im, label %asciilib_rsplit.exit

bb.im:                                            ; preds = %bb.il
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.sr) #33, !inline_history !695
  br label %asciilib_rsplit.exit
...
bb.io:                                            ; preds = %bb.in
  %i.xs = load ptr, ptr @PyExc_ValueError, align 8, !tbaa !194
  tail call void @PyErr_SetString(ptr noundef %i.xs, ptr noundef nonnull @.str.197) #33, !inline_history !702
  br label %asciilib_rsplit.exit

bb.ip:                                            ; preds = %bb.in
  %i.xt = load i8, ptr %.080, align 1, !tbaa !205
  %i.xu = tail call i64 @llvm.smin.i64(i64 %.1, i64 11)
  %i.xv = add nsw i64 %i.xu, 1
  %i.xw = tail call ptr @PyList_New(i64 noundef %i.xv) #33, !inline_history !703 ; 12 uses
  %i.xx = icmp eq ptr %i.xw, null
  br i1 %i.xx, label %asciilib_rsplit.exit, label %8
...
.lr.ph122.i.i:                                    ; preds = %8
  %i.xy = getelementptr i8, ptr %i.xw, i64 24
...
bb.iq:                                            ; preds = %.loopexit.i.i319
  ...
  br i1 %exitcond.not.i312, label %.critedge.i.i314, label %.lr.ph.i.i313.preheader, !llvm.loop !704

.lr.ph.i.i313.preheader:                          ; preds = %.lr.ph122.i.i, %bb.iq
  %.050120.i.i1498 = phi i64 [ %i.zp, %bb.iq ], [ %9, %.lr.ph122.i.i ] ; 3 uses
...
.lr.ph.i.i313:                                    ; preds = %.lr.ph.i.i313.preheader, %bb.jh
  ...
  %i.yb = load i8, ptr %i.ya, align 1, !tbaa !205
...
bb.iv:                                            ; preds = %.preheader.i.i.i.i
  %i.yl = load i64, ptr %.017.i.i.i.i, align 8, !tbaa !193
...
.thread31.i.i.i.i:                                ; preds = %bb.iw, %bb.iu
  ...
  %i.yp = load i8, ptr %.2.i.i.i.i, align 1, !tbaa !205
  %.not28.i.i.i.i = icmp sgt i8 %i.yp, -1
  br i1 %.not28.i.i.i.i, label %bb.it, label %ucs1lib_find_max_char.exit.i.i.i, !llvm.loop !221
...
ucs1lib_find_max_char.exit.i.i.i:                 ; preds = %.thread31.i.i.i.i, %bb.iw, %bb.it, %bb.iv
  ...
  %i.yq = tail call ptr @PyUnicode_New(i64 noundef %i.yf, i32 noundef %.5.i.i.i.i), !inline_history !705 ; 5 uses
...
bb.iz:                                            ; preds = %bb.ix
  ...
  %.val4.i.i.i.i327 = load ptr, ptr %i.yu, align 8, !tbaa !205
  br label %_PyUnicode_DATA.exit.i.i.i
...
_PyUnicode_FromUCS1.exit.i.i:                     ; preds = %bb.ir
  %i.yv = load i8, ptr %i.ye, align 1, !tbaa !205 ; 3 uses
...
bb.ja:                                            ; preds = %_PyUnicode_FromUCS1.exit.thread.i.i
  %.val76.i.i320 = load ptr, ptr %i.xy, align 8, !tbaa !541
  %i.zf = getelementptr [8 x i8], ptr %.val76.i.i320, i64 %.0121.i.i1497
  store ptr %.0.i101.i.i, ptr %i.zf, align 8, !tbaa !194
  br label %.loopexit.i.i319

bb.jb:                                            ; preds = %_PyUnicode_FromUCS1.exit.thread.i.i
  %i.zg = tail call i32 @PyList_Append(ptr noundef nonnull %i.xw, ptr noundef nonnull %.0.i101.i.i) #33, !inline_history !703
  %.not61.i.i316 = icmp eq i32 %i.zg, 0
  %i.zh = load i32, ptr %.0.i101.i.i, align 8, !tbaa !205 ; 3 uses
...
bb.jd:                                            ; preds = %bb.jc
  ...
  store i32 %i.zi, ptr %.0.i101.i.i, align 8, !tbaa !205
...
bb.jf:                                            ; preds = %bb.je
  ...
  store i32 %i.zk, ptr %.0.i101.i.i, align 8, !tbaa !205
  %i.zl = icmp eq i32 %i.zk, 0
  br i1 %i.zl, label %bb.jg, label %.loopexit.i.i319

bb.jg:                                            ; preds = %bb.jf
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i101.i.i) #33, !inline_history !703
  br label %.loopexit.i.i319

bb.jh:                                            ; preds = %.lr.ph.i.i313
  %i.zm = add nsw i64 %.153117.i.i, -1
  %i.zn = icmp sgt i64 %.153117.i.i, 0
  br i1 %i.zn, label %.lr.ph.i.i313, label %.critedge.i.i314, !llvm.loop !706
...
.loopexit.i.i319:                                 ; preds = %bb.jg, %bb.jf, %bb.je, %bb.ja
  ...
  br i1 %i.zq, label %bb.iq, label %.critedge.i.thread.i299, !llvm.loop !704

.critedge.i.i314:                                 ; preds = %bb.iq, %bb.jh, %.lr.ph122.i.i
  %.050120.i.i1392 = phi i64 [ %.050120.i.i1498, %bb.jh ], [ %9, %.lr.ph122.i.i ], [ %i.zp, %bb.iq ] ; 2 uses
...
.critedge.thread.i.i296:                          ; preds = %.critedge.i.i314, %8
  ...
  %.val.i.i297 = load ptr, ptr %i.zs, align 8, !tbaa !197
...
bb.ji:                                            ; preds = %.critedge.thread.i.i296
  %i.zt = load i32, ptr %0, align 8, !tbaa !205   ; 2 uses
  %i.zu = icmp ugt i32 %i.zt, -1073741825
  br i1 %i.zu, label %Py_INCREF.exit.i.i309, label %bb.jj

bb.jj:                                            ; preds = %bb.ji
  %i.zv = add nuw i32 %i.zt, 1
  store i32 %i.zv, ptr %0, align 8, !tbaa !205
  br label %Py_INCREF.exit.i.i309

Py_INCREF.exit.i.i309:                            ; preds = %bb.jj, %bb.ji
  %11 = getelementptr i8, ptr %i.xw, i64 24
  %.val75.i.i310 = load ptr, ptr %11, align 8, !tbaa !541
  store ptr %0, ptr %.val75.i.i310, align 8, !tbaa !194
  br label %bb.ka
...
.critedge.i.thread.i299:                          ; preds = %.loopexit.i.i319, %.critedge.thread.i.i296, %.critedge.i.i314
  ...
  %.050.lcssa153.i.i = phi i64 [ %.050.lcssa154.i.i, %.critedge.thread.i.i296 ], [ %.050120.i.i1392, %.critedge.i.i314 ], [ %i.zp, %.loopexit.i.i319 ] ; 2 uses
  %i.zw = icmp sgt i64 %.050.lcssa153.i.i, -2
  br i1 %i.zw, label %bb.jk, label %bb.ka

bb.jk:                                            ; preds = %.critedge.i.thread.i299
  %i.zx = add i64 %.050.lcssa153.i.i, 1           ; 4 uses
...
bb.jo:                                            ; preds = %.preheader.i.i95.i.i
  %i.aad = load i64, ptr %.017.i.i96.i.i, align 8, !tbaa !193
...
.thread31.i.i92.i.i:                              ; preds = %bb.jp, %bb.jn
  ...
  %i.aah = load i8, ptr %.2.i.i93.i.i, align 1, !tbaa !205
  %.not28.i.i94.i.i = icmp sgt i8 %i.aah, -1
  br i1 %.not28.i.i94.i.i, label %bb.jm, label %ucs1lib_find_max_char.exit.i80.i.i, !llvm.loop !221
...
ucs1lib_find_max_char.exit.i80.i.i:               ; preds = %.thread31.i.i92.i.i, %bb.jp, %bb.jm, %bb.jo
  ...
  %i.aai = tail call ptr @PyUnicode_New(i64 noundef %i.zx, i32 noundef %.5.i.i81.i.i), !inline_history !705 ; 5 uses
...
bb.js:                                            ; preds = %bb.jq
  ...
  %.val4.i.i90.i.i = load ptr, ptr %i.aam, align 8, !tbaa !205
  br label %_PyUnicode_DATA.exit.i88.i.i
...
_PyUnicode_FromUCS1.exit99.i.i:                   ; preds = %bb.jk
  %i.aan = load i8, ptr %.0.i271, align 1, !tbaa !205 ; 3 uses
...
bb.jt:                                            ; preds = %_PyUnicode_FromUCS1.exit99.thread.i.i
  %12 = getelementptr i8, ptr %i.xw, i64 24
  %.val74.i.i308 = load ptr, ptr %12, align 8, !tbaa !541
  %i.aax = getelementptr [8 x i8], ptr %.val74.i.i308, i64 %.0.lcssa155.i.i
  store ptr %.0.i78105.i.i, ptr %i.aax, align 8, !tbaa !194
  br label %Py_DECREF.exit63.i.i307

bb.ju:                                            ; preds = %_PyUnicode_FromUCS1.exit99.thread.i.i
  %i.aay = tail call i32 @PyList_Append(ptr noundef nonnull %i.xw, ptr noundef nonnull %.0.i78105.i.i) #33, !inline_history !703
  %.not60.i.i304 = icmp eq i32 %i.aay, 0
  %i.aaz = load i32, ptr %.0.i78105.i.i, align 8, !tbaa !205 ; 3 uses
...
bb.jy:                                            ; preds = %bb.jx
  ...
  store i32 %i.abc, ptr %.0.i78105.i.i, align 8, !tbaa !205
  %i.abd = icmp eq i32 %i.abc, 0
  br i1 %i.abd, label %bb.jz, label %Py_DECREF.exit63.i.i307

bb.jz:                                            ; preds = %bb.jy
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i78105.i.i) #33, !inline_history !703
  br label %Py_DECREF.exit63.i.i307
...
bb.ka:                                            ; preds = %Py_DECREF.exit63.i.i307, %.critedge.i.thread.i299, %Py_INCREF.exit.i.i309
  ...
  store i64 %.2.i.i300, ptr %i.abf, align 8, !tbaa !380
  %i.abg = tail call i32 @PyList_Reverse(ptr noundef nonnull %i.xw) #33, !inline_history !703
...
Py_DECREF.exit69.sink.split.i.i306:               ; preds = %bb.jw, %bb.jd
  ...
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i78105.sink.i.i) #33, !inline_history !703
...
Py_DECREF.exit69.i.i302:                          ; preds = %_PyUnicode_FromUCS1.exit.i.i, %ucs1lib_find_max_char.exit.i.i.i, %Py_DECREF.exit69.sink.split.i.i306, %bb.ka, %bb.jw, %bb.jv, %_PyUnicode_FromUCS1.exit99.i.i, %ucs1lib_find_max_char.exit.i80.i.i, %bb.jd, %bb.jc
  %i.abi = load i32, ptr %i.xw, align 8, !tbaa !205 ; 2 uses
...
bb.kb:                                            ; preds = %Py_DECREF.exit69.i.i302
  ...
  store i32 %i.abj, ptr %i.xw, align 8, !tbaa !205
  %i.abk = icmp eq i32 %i.abj, 0
  br i1 %i.abk, label %bb.kc, label %asciilib_rsplit.exit

bb.kc:                                            ; preds = %bb.kb
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.xw) #33, !inline_history !703
  br label %asciilib_rsplit.exit

bb.kd:                                            ; preds = %bb.in
  %i.abl = tail call i64 @llvm.smin.i64(i64 %.1, i64 11)
  %i.abm = add nsw i64 %i.abl, 1
  %i.abn = tail call ptr @PyList_New(i64 noundef %i.abm) #33, !inline_history !702 ; 12 uses
...
.lr.ph.i330.split:                                ; preds = %.lr.ph.i330.split.preheader, %Py_DECREF.exit72.i360
  ...
  %i.abw = load i8, ptr %.080, align 1, !tbaa !205 ; 5 uses
...
.lr.ph.i75.i.i.prol:                              ; preds = %.lr.ph.i330.split
  %i.aca = load i8, ptr %i.abt, align 1, !tbaa !205 ; 2 uses
...
.lr.ph66.split.us.i.i.i347:                       ; preds = %.preheader56.i.i.i335, %bb.kj
  ...
  %i.ack = load i8, ptr %i.acj, align 1, !tbaa !205
...
bb.kf:                                            ; preds = %bb.ke
  ...
  %i.acn = load i8, ptr %i.acm, align 1, !tbaa !205
...
bb.kg:                                            ; preds = %.preheader.us.i78.i.i
  ...
  br i1 %i.acy, label %.preheader.us.i78.i.i, label %ucs1lib_fastsearch.exit.i, !llvm.loop !667
...
bb.kh:                                            ; preds = %.thread.us.i.i.i
  ...
  %i.ada = load i8, ptr %i.acz, align 1, !tbaa !205
...
bb.kj:                                            ; preds = %bb.ki, %bb.kh, %bb.kf
  ...
  br i1 %i.adh, label %.lr.ph66.split.us.i.i.i347, label %ucs1lib_fastsearch.exit.thread.i, !llvm.loop !668
...
.lr.ph.i75.i.i:                                   ; preds = %.lr.ph.i75.i.i.prol.loopexit, %.lr.ph.i75.i.i
  ...
  %i.adj = load i8, ptr %i.adi, align 1, !tbaa !205 ; 2 uses
...
ucs1lib_fastsearch.exit.thread.thread.i:          ; preds = %.lr.ph.i330, %ucs1lib_fastsearch.exit.thread.i, %.preheader.i329
  ...
  %.val.i344 = load ptr, ptr %i.afn, align 8, !tbaa !197
...
bb.lf:                                            ; preds = %.preheader.i.i106.i
  %i.afx = load i64, ptr %.017.i.i107.i, align 8, !tbaa !193
  %i.afy = and i64 %i.afx, -9187201950435737472
  %.not27.i.i109.i = icmp eq i64 %i.afy, 0
  br i1 %.not27.i.i109.i, label %.preheader.i.i106.i, label %ucs1lib_find_max_char.exit.i91.i, !llvm.loop !220
...
.thread31.i.i103.i:                               ; preds = %bb.lg, %bb.le
  ...
  %i.agb = load i8, ptr %.2.i.i104.i, align 1, !tbaa !205
  %.not28.i.i105.i = icmp sgt i8 %i.agb, -1
  br i1 %.not28.i.i105.i, label %bb.ld, label %ucs1lib_find_max_char.exit.i91.i, !llvm.loop !221
...
ucs1lib_find_max_char.exit.i91.i:                 ; preds = %.thread31.i.i103.i, %bb.lg, %bb.ld, %bb.lf
  ...
  %i.agc = tail call ptr @PyUnicode_New(i64 noundef %.057141238.i, i32 noundef %.5.i.i92.i), !inline_history !707 ; 5 uses
...
bb.lj:                                            ; preds = %bb.lh
  ...
  %.val4.i.i101.i = load ptr, ptr %i.agg, align 8, !tbaa !205
  br label %_PyUnicode_DATA.exit.i99.i
...
_PyUnicode_FromUCS1.exit110.i:                    ; preds = %ucs1lib_fastsearch.exit.thread.thread242.i
  %i.agh = load i8, ptr %.0.i271, align 1, !tbaa !205 ; 3 uses
...
bb.lk:                                            ; preds = %_PyUnicode_FromUCS1.exit110.thread.i
  ...
  %.val79.i343 = load ptr, ptr %i.agr, align 8, !tbaa !541
  %i.ags = getelementptr [8 x i8], ptr %.val79.i343, i64 %.0136240.i
  store ptr %.0.i89117.i, ptr %i.ags, align 8, !tbaa !194
  br label %Py_DECREF.exit68.i341

bb.ll:                                            ; preds = %_PyUnicode_FromUCS1.exit110.thread.i
  %i.agt = tail call i32 @PyList_Append(ptr noundef nonnull %i.abn, ptr noundef nonnull %.0.i89117.i) #33, !inline_history !702
  %.not66.i336 = icmp eq i32 %i.agt, 0
  %i.agu = load i32, ptr %.0.i89117.i, align 8, !tbaa !205 ; 3 uses
...
bb.ln:                                            ; preds = %bb.lm
  ...
  store i32 %i.agv, ptr %.0.i89117.i, align 8, !tbaa !205
...
bb.lp:                                            ; preds = %bb.lo
  ...
  store i32 %i.agx, ptr %.0.i89117.i, align 8, !tbaa !205
  %i.agy = icmp eq i32 %i.agx, 0
  br i1 %i.agy, label %bb.lq, label %Py_DECREF.exit68.i341

bb.lq:                                            ; preds = %bb.lp
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i89117.i) #33, !inline_history !702
  br label %Py_DECREF.exit68.i341
...
bb.lr:                                            ; preds = %Py_DECREF.exit68.i341, %Py_INCREF.exit.i345
  ...
  store i64 %.1.i342, ptr %i.aha, align 8, !tbaa !380
  %i.ahb = tail call i32 @PyList_Reverse(ptr noundef nonnull %i.abn) #33, !inline_history !702
...
Py_DECREF.exit74.sink.split.i340:                 ; preds = %bb.ln, %bb.kw
  ...
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i89117.sink.i) #33, !inline_history !702
...
Py_DECREF.exit74.i338:                            ; preds = %_PyUnicode_FromUCS1.exit.i355, %ucs1lib_find_max_char.exit.i.i364, %Py_DECREF.exit74.sink.split.i340, %bb.lr, %bb.ln, %bb.lm, %_PyUnicode_FromUCS1.exit110.i, %ucs1lib_find_max_char.exit.i91.i, %bb.kw, %bb.kv
  %i.ahd = load i32, ptr %i.abn, align 8, !tbaa !205 ; 2 uses
...
bb.ls:                                            ; preds = %Py_DECREF.exit74.i338
  ...
  store i32 %i.ahe, ptr %i.abn, align 8, !tbaa !205
  %i.ahf = icmp eq i32 %i.ahe, 0
  br i1 %i.ahf, label %bb.lt, label %asciilib_rsplit.exit

bb.lt:                                            ; preds = %bb.ls
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.abn) #33, !inline_history !702
  br label %asciilib_rsplit.exit
...
bb.lv:                                            ; preds = %bb.lu
  %i.ahg = load ptr, ptr @PyExc_ValueError, align 8, !tbaa !194
  tail call void @PyErr_SetString(ptr noundef %i.ahg, ptr noundef nonnull @.str.197) #33, !inline_history !709
  br label %asciilib_rsplit.exit

bb.lw:                                            ; preds = %bb.lu
  %i.ahh = load i16, ptr %.080, align 2, !tbaa !208
  %i.ahi = tail call i64 @llvm.smin.i64(i64 %.1, i64 11)
  %i.ahj = add nsw i64 %i.ahi, 1
  %i.ahk = tail call ptr @PyList_New(i64 noundef %i.ahj) #33, !inline_history !710 ; 12 uses
  %i.ahl = icmp eq ptr %i.ahk, null
  br i1 %i.ahl, label %asciilib_rsplit.exit, label %13
...
bb.lx:                                            ; preds = %.loopexit.i.i405
  ...
  br i1 %exitcond.not.i398, label %.critedge.i.i400, label %.lr.ph.i.i399.preheader, !llvm.loop !711

.lr.ph.i.i399.preheader:                          ; preds = %.lr.ph89.i.i, %bb.lx
  %.05087.i.i1490 = phi i64 [ %i.aih, %bb.lx ], [ %14, %.lr.ph89.i.i ] ; 3 uses
...
.lr.ph.i.i399:                                    ; preds = %.lr.ph.i.i399.preheader, %bb.mh
  ...
  %i.ahp = load i16, ptr %i.aho, align 2, !tbaa !208
...
bb.ly:                                            ; preds = %.lr.ph.i.i399
  ...
  %i.ahu = tail call fastcc ptr @_PyUnicode_FromUCS2(ptr noundef readonly %i.ahs, i64 noundef %i.aht), !inline_history !710 ; 8 uses
...
bb.ma:                                            ; preds = %bb.lz
  %.val76.i.i406 = load ptr, ptr %i.ahm, align 8, !tbaa !541
  %i.ahx = getelementptr [8 x i8], ptr %.val76.i.i406, i64 %.088.i.i1489
  store ptr %i.ahu, ptr %i.ahx, align 8, !tbaa !194
  br label %.loopexit.i.i405

bb.mb:                                            ; preds = %bb.lz
  %i.ahy = tail call i32 @PyList_Append(ptr noundef nonnull %i.ahk, ptr noundef nonnull %i.ahu) #33, !inline_history !710
  %.not61.i.i402 = icmp eq i32 %i.ahy, 0
  %i.ahz = load i32, ptr %i.ahu, align 8, !tbaa !205 ; 3 uses
...
bb.md:                                            ; preds = %bb.mc
  ...
  store i32 %i.aia, ptr %i.ahu, align 8, !tbaa !205
...
bb.mf:                                            ; preds = %bb.me
  ...
  store i32 %i.aic, ptr %i.ahu, align 8, !tbaa !205
  %i.aid = icmp eq i32 %i.aic, 0
  br i1 %i.aid, label %bb.mg, label %.loopexit.i.i405

bb.mg:                                            ; preds = %bb.mf
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.ahu) #33, !inline_history !710
  br label %.loopexit.i.i405

bb.mh:                                            ; preds = %.lr.ph.i.i399
  %i.aie = add nsw i64 %.15384.i.i, -1
  %i.aif = icmp sgt i64 %.15384.i.i, 0
  br i1 %i.aif, label %.lr.ph.i.i399, label %.critedge.i.i400, !llvm.loop !712
...
.loopexit.i.i405:                                 ; preds = %bb.mg, %bb.mf, %bb.me, %bb.ma
  ...
  br i1 %i.aii, label %bb.lx, label %.critedge.i.thread.i385, !llvm.loop !711

.critedge.i.i400:                                 ; preds = %bb.lx, %bb.mh, %.lr.ph89.i.i
  %.05087.i.i1447 = phi i64 [ %.05087.i.i1490, %bb.mh ], [ %14, %.lr.ph89.i.i ], [ %i.aih, %bb.lx ] ; 2 uses
...
.critedge.thread.i.i382:                          ; preds = %.critedge.i.i400, %13
  ...
  %.val.i.i383 = load ptr, ptr %i.aik, align 8, !tbaa !197
...
bb.mi:                                            ; preds = %.critedge.thread.i.i382
  %i.ail = load i32, ptr %0, align 8, !tbaa !205  ; 2 uses
  %i.aim = icmp ugt i32 %i.ail, -1073741825
  br i1 %i.aim, label %Py_INCREF.exit.i.i395, label %bb.mj

bb.mj:                                            ; preds = %bb.mi
  %i.ain = add nuw i32 %i.ail, 1
  store i32 %i.ain, ptr %0, align 8, !tbaa !205
  br label %Py_INCREF.exit.i.i395

Py_INCREF.exit.i.i395:                            ; preds = %bb.mj, %bb.mi
  %16 = getelementptr i8, ptr %i.ahk, i64 24
  %.val75.i.i396 = load ptr, ptr %16, align 8, !tbaa !541
  store ptr %0, ptr %.val75.i.i396, align 8, !tbaa !194
  br label %bb.mt
...
.critedge.i.thread.i385:                          ; preds = %.loopexit.i.i405, %.critedge.thread.i.i382, %.critedge.i.i400
  ...
  %.050.lcssa111.i.i = phi i64 [ %.050.lcssa112.i.i, %.critedge.thread.i.i382 ], [ %.05087.i.i1447, %.critedge.i.i400 ], [ %i.aih, %.loopexit.i.i405 ] ; 2 uses
  %i.aio = icmp sgt i64 %.050.lcssa111.i.i, -2
  br i1 %i.aio, label %bb.mk, label %bb.mt

bb.mk:                                            ; preds = %.critedge.i.thread.i385
  %i.aip = add i64 %.050.lcssa111.i.i, 1
  %i.aiq = tail call fastcc ptr @_PyUnicode_FromUCS2(ptr noundef readonly %.0.i271, i64 noundef %i.aip), !inline_history !710 ; 8 uses
...
bb.mm:                                            ; preds = %bb.ml
  %17 = getelementptr i8, ptr %i.ahk, i64 24
  %.val74.i.i394 = load ptr, ptr %17, align 8, !tbaa !541
  %i.ait = getelementptr [8 x i8], ptr %.val74.i.i394, i64 %.0.lcssa113.i.i
  store ptr %i.aiq, ptr %i.ait, align 8, !tbaa !194
  br label %Py_DECREF.exit63.i.i393

bb.mn:                                            ; preds = %bb.ml
  %i.aiu = tail call i32 @PyList_Append(ptr noundef nonnull %i.ahk, ptr noundef nonnull %i.aiq) #33, !inline_history !710
  %.not60.i.i390 = icmp eq i32 %i.aiu, 0
  %i.aiv = load i32, ptr %i.aiq, align 8, !tbaa !205 ; 3 uses
...
bb.mp:                                            ; preds = %bb.mo
  ...
  store i32 %i.aiw, ptr %i.aiq, align 8, !tbaa !205
...
bb.mr:                                            ; preds = %bb.mq
  ...
  store i32 %i.aiy, ptr %i.aiq, align 8, !tbaa !205
  %i.aiz = icmp eq i32 %i.aiy, 0
  br i1 %i.aiz, label %bb.ms, label %Py_DECREF.exit63.i.i393

bb.ms:                                            ; preds = %bb.mr
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.aiq) #33, !inline_history !710
  br label %Py_DECREF.exit63.i.i393
...
bb.mt:                                            ; preds = %Py_DECREF.exit63.i.i393, %.critedge.i.thread.i385, %Py_INCREF.exit.i.i395
  ...
  store i64 %.2.i.i386, ptr %i.ajb, align 8, !tbaa !380
  %i.ajc = tail call i32 @PyList_Reverse(ptr noundef nonnull %i.ahk) #33, !inline_history !710
...
Py_DECREF.exit69.sink.split.i.i392:               ; preds = %bb.mp, %bb.md
  ...
  tail call void @_Py_Dealloc(ptr noundef nonnull %.sink.i.i) #33, !inline_history !710
...
Py_DECREF.exit69.i.i388:                          ; preds = %bb.ly, %Py_DECREF.exit69.sink.split.i.i392, %bb.mt, %bb.mp, %bb.mo, %bb.mk, %bb.md, %bb.mc
  %i.aje = load i32, ptr %i.ahk, align 8, !tbaa !205 ; 2 uses
...
bb.mu:                                            ; preds = %Py_DECREF.exit69.i.i388
  ...
  store i32 %i.ajf, ptr %i.ahk, align 8, !tbaa !205
  %i.ajg = icmp eq i32 %i.ajf, 0
  br i1 %i.ajg, label %bb.mv, label %asciilib_rsplit.exit

bb.mv:                                            ; preds = %bb.mu
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.ahk) #33, !inline_history !710
  br label %asciilib_rsplit.exit

bb.mw:                                            ; preds = %bb.lu
  %i.ajh = tail call i64 @llvm.smin.i64(i64 %.1, i64 11)
  %i.aji = add nsw i64 %i.ajh, 1
  %i.ajj = tail call ptr @PyList_New(i64 noundef %i.aji) #33, !inline_history !709 ; 12 uses
...
bb.mx:                                            ; preds = %Py_DECREF.exit72.i422, %.lr.ph.i416
  ...
  %i.ajn = tail call fastcc i64 @ucs2lib_fastsearch(ptr noundef %.0.i271, i64 noundef %.057102.i, ptr noundef %.080, i64 noundef %.val99, i64 noundef -1, i32 noundef 2), !inline_history !709 ; 4 uses
...
bb.my:                                            ; preds = %bb.mx
  ...
  %i.ajs = tail call fastcc ptr @_PyUnicode_FromUCS2(ptr noundef %i.ajq, i64 noundef %i.ajr), !inline_history !709 ; 8 uses
...
bb.na:                                            ; preds = %bb.mz
  %.val81.i425 = load ptr, ptr %i.ajm, align 8, !tbaa !541
  %i.ajv = getelementptr [8 x i8], ptr %.val81.i425, i64 %.0103.i
  store ptr %i.ajs, ptr %i.ajv, align 8, !tbaa !194
  br label %Py_DECREF.exit72.i422

bb.nb:                                            ; preds = %bb.mz
  %i.ajw = tail call i32 @PyList_Append(ptr noundef nonnull %i.ajj, ptr noundef nonnull %i.ajs) #33, !inline_history !709
  %.not.i417 = icmp eq i32 %i.ajw, 0
  %i.ajx = load i32, ptr %i.ajs, align 8, !tbaa !205 ; 3 uses
...
bb.nd:                                            ; preds = %bb.nc
  ...
  store i32 %i.ajy, ptr %i.ajs, align 8, !tbaa !205
...
bb.nf:                                            ; preds = %bb.ne
  ...
  store i32 %i.aka, ptr %i.ajs, align 8, !tbaa !205
  %i.akb = icmp eq i32 %i.aka, 0
  br i1 %i.akb, label %bb.ng, label %Py_DECREF.exit72.i422

bb.ng:                                            ; preds = %bb.nf
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.ajs) #33, !inline_history !709
  br label %Py_DECREF.exit72.i422
...
Py_DECREF.exit72.i422:                            ; preds = %bb.ng, %bb.nf, %bb.ne, %bb.na
  ...
  br i1 %exitcond118.not.i, label %._crit_edge.thread151.i, label %bb.mx, !llvm.loop !713
...
._crit_edge.thread151.i:                          ; preds = %Py_DECREF.exit72.i422, %._crit_edge.i426
  ...
  %i.akj = tail call fastcc ptr @_PyUnicode_FromUCS2(ptr noundef %.0.i271, i64 noundef %.057.lcssa154.i), !inline_history !709 ; 8 uses
  %i.akk = icmp eq ptr %i.akj, null
  br i1 %i.akk, label %Py_DECREF.exit74.i412, label %bb.nj

.thread.i:                                        ; preds = %._crit_edge.thread.i
  %i.akl = tail call fastcc ptr @_PyUnicode_FromUCS2(ptr noundef %.0.i271, i64 noundef %.057.lcssa147.i), !inline_history !709 ; 2 uses
...
.thread83.i:                                      ; preds = %bb.nj, %.thread.i
  ...
  %.val79.i409 = load ptr, ptr %i.akp, align 8, !tbaa !541
  %i.akq = getelementptr [8 x i8], ptr %.val79.i409, i64 %.0.lcssa148.i
  store ptr %i.ako, ptr %i.akq, align 8, !tbaa !194
  br label %Py_DECREF.exit68.i410

bb.nk:                                            ; preds = %bb.nj
  %i.akr = tail call i32 @PyList_Append(ptr noundef nonnull %i.ajj, ptr noundef nonnull %i.akj) #33, !inline_history !709
  %.not66.i423 = icmp eq i32 %i.akr, 0
  %i.aks = load i32, ptr %i.akj, align 8, !tbaa !205 ; 3 uses
...
bb.nm:                                            ; preds = %bb.nl
  ...
  store i32 %i.akt, ptr %i.akj, align 8, !tbaa !205
...
bb.no:                                            ; preds = %bb.nn
  ...
  store i32 %i.akv, ptr %i.akj, align 8, !tbaa !205
  %i.akw = icmp eq i32 %i.akv, 0
  br i1 %i.akw, label %bb.np, label %Py_DECREF.exit68.i410

bb.np:                                            ; preds = %bb.no
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.akj) #33, !inline_history !709
  br label %Py_DECREF.exit68.i410
...
bb.nq:                                            ; preds = %Py_DECREF.exit68.i410, %Py_INCREF.exit.i414
  ...
  store i64 %.1.i411, ptr %i.aky, align 8, !tbaa !380
  %i.akz = tail call i32 @PyList_Reverse(ptr noundef nonnull %i.ajj) #33, !inline_history !709
...
Py_DECREF.exit74.sink.split.i419:                 ; preds = %bb.nm, %bb.nd
  ...
  tail call void @_Py_Dealloc(ptr noundef nonnull %.sink.i420) #33, !inline_history !709
...
Py_DECREF.exit74.i412:                            ; preds = %bb.my, %Py_DECREF.exit74.sink.split.i419, %bb.nq, %bb.nm, %bb.nl, %.thread.i, %._crit_edge.thread151.i, %bb.nd, %bb.nc
  %i.alb = load i32, ptr %i.ajj, align 8, !tbaa !205 ; 2 uses
...
bb.nr:                                            ; preds = %Py_DECREF.exit74.i412
  ...
  store i32 %i.alc, ptr %i.ajj, align 8, !tbaa !205
  %i.ald = icmp eq i32 %i.alc, 0
  br i1 %i.ald, label %bb.ns, label %asciilib_rsplit.exit

bb.ns:                                            ; preds = %bb.nr
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.ajj) #33, !inline_history !709
  br label %asciilib_rsplit.exit
...
bb.nu:                                            ; preds = %bb.nt
  %i.ale = load ptr, ptr @PyExc_ValueError, align 8, !tbaa !194
  tail call void @PyErr_SetString(ptr noundef %i.ale, ptr noundef nonnull @.str.197) #33, !inline_history !714
  br label %asciilib_rsplit.exit

bb.nv:                                            ; preds = %bb.nt
  %i.alf = load i32, ptr %.080, align 4, !tbaa !7
  %i.alg = tail call i64 @llvm.smin.i64(i64 %.1, i64 11)
  %i.alh = add nsw i64 %i.alg, 1
  %i.ali = tail call ptr @PyList_New(i64 noundef %i.alh) #33, !inline_history !715 ; 12 uses
  %i.alj = icmp eq ptr %i.ali, null
  br i1 %i.alj, label %asciilib_rsplit.exit, label %18
...
bb.nw:                                            ; preds = %.loopexit.i.i458
  ...
  br i1 %exitcond.not.i450, label %.critedge.i.i453, label %.lr.ph.i.i451.preheader, !llvm.loop !716

.lr.ph.i.i451.preheader:                          ; preds = %.lr.ph89.i.i446, %bb.nw
  %.05087.i.i4491487 = phi i64 [ %i.amf, %bb.nw ], [ %19, %.lr.ph89.i.i446 ] ; 3 uses
...
.lr.ph.i.i451:                                    ; preds = %.lr.ph.i.i451.preheader, %bb.og
  ...
  %i.aln = load i32, ptr %i.alm, align 4, !tbaa !7
...
bb.nx:                                            ; preds = %.lr.ph.i.i451
  ...
  %i.als = tail call fastcc ptr @_PyUnicode_FromUCS4(ptr noundef %i.alq, i64 noundef %i.alr), !inline_history !715 ; 8 uses
...
bb.nz:                                            ; preds = %bb.ny
  %.val76.i.i459 = load ptr, ptr %i.alk, align 8, !tbaa !541
  %i.alv = getelementptr [8 x i8], ptr %.val76.i.i459, i64 %.088.i.i4481486
  store ptr %i.als, ptr %i.alv, align 8, !tbaa !194
  br label %.loopexit.i.i458

bb.oa:                                            ; preds = %bb.ny
  %i.alw = tail call i32 @PyList_Append(ptr noundef nonnull %i.ali, ptr noundef nonnull %i.als) #33, !inline_history !715
  %.not61.i.i455 = icmp eq i32 %i.alw, 0
  %i.alx = load i32, ptr %i.als, align 8, !tbaa !205 ; 3 uses
...
bb.oc:                                            ; preds = %bb.ob
  ...
  store i32 %i.aly, ptr %i.als, align 8, !tbaa !205
...
bb.oe:                                            ; preds = %bb.od
  ...
  store i32 %i.ama, ptr %i.als, align 8, !tbaa !205
  %i.amb = icmp eq i32 %i.ama, 0
  br i1 %i.amb, label %bb.of, label %.loopexit.i.i458

bb.of:                                            ; preds = %bb.oe
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.als) #33, !inline_history !715
  br label %.loopexit.i.i458

bb.og:                                            ; preds = %.lr.ph.i.i451
  %i.amc = add nsw i64 %.15384.i.i452, -1
  %i.amd = icmp sgt i64 %.15384.i.i452, 0
  br i1 %i.amd, label %.lr.ph.i.i451, label %.critedge.i.i453, !llvm.loop !717
...
.loopexit.i.i458:                                 ; preds = %bb.of, %bb.oe, %bb.od, %bb.nz
  ...
  br i1 %i.amg, label %bb.nw, label %.critedge.i.thread.i431, !llvm.loop !716

.critedge.i.i453:                                 ; preds = %bb.nw, %bb.og, %.lr.ph89.i.i446
  %.05087.i.i4491475 = phi i64 [ %.05087.i.i4491487, %bb.og ], [ %19, %.lr.ph89.i.i446 ], [ %i.amf, %bb.nw ] ; 2 uses
...
.critedge.thread.i.i427:                          ; preds = %.critedge.i.i453, %18
  ...
  %.val.i.i429 = load ptr, ptr %i.ami, align 8, !tbaa !197
...
bb.oh:                                            ; preds = %.critedge.thread.i.i427
  %i.amj = load i32, ptr %0, align 8, !tbaa !205  ; 2 uses
  %i.amk = icmp ugt i32 %i.amj, -1073741825
  br i1 %i.amk, label %Py_INCREF.exit.i.i444, label %bb.oi

bb.oi:                                            ; preds = %bb.oh
  %i.aml = add nuw i32 %i.amj, 1
  store i32 %i.aml, ptr %0, align 8, !tbaa !205
  br label %Py_INCREF.exit.i.i444

Py_INCREF.exit.i.i444:                            ; preds = %bb.oi, %bb.oh
  %21 = getelementptr i8, ptr %i.ali, i64 24
  %.val75.i.i445 = load ptr, ptr %21, align 8, !tbaa !541
  store ptr %0, ptr %.val75.i.i445, align 8, !tbaa !194
  br label %bb.os
...
.critedge.i.thread.i431:                          ; preds = %.loopexit.i.i458, %.critedge.thread.i.i427, %.critedge.i.i453
  ...
  %.050.lcssa111.i.i433 = phi i64 [ %.050.lcssa112.i.i428, %.critedge.thread.i.i427 ], [ %.05087.i.i4491475, %.critedge.i.i453 ], [ %i.amf, %.loopexit.i.i458 ] ; 2 uses
  %i.amm = icmp sgt i64 %.050.lcssa111.i.i433, -2
  br i1 %i.amm, label %bb.oj, label %bb.os

bb.oj:                                            ; preds = %.critedge.i.thread.i431
  %i.amn = add i64 %.050.lcssa111.i.i433, 1
  %i.amo = tail call fastcc ptr @_PyUnicode_FromUCS4(ptr noundef %.0.i271, i64 noundef %i.amn), !inline_history !715 ; 8 uses
...
bb.ol:                                            ; preds = %bb.ok
  %22 = getelementptr i8, ptr %i.ali, i64 24
  %.val74.i.i443 = load ptr, ptr %22, align 8, !tbaa !541
  %i.amr = getelementptr [8 x i8], ptr %.val74.i.i443, i64 %.0.lcssa113.i.i432
  store ptr %i.amo, ptr %i.amr, align 8, !tbaa !194
  br label %Py_DECREF.exit63.i.i442

bb.om:                                            ; preds = %bb.ok
  %i.ams = tail call i32 @PyList_Append(ptr noundef nonnull %i.ali, ptr noundef nonnull %i.amo) #33, !inline_history !715
  %.not60.i.i438 = icmp eq i32 %i.ams, 0
  %i.amt = load i32, ptr %i.amo, align 8, !tbaa !205 ; 3 uses
...
bb.oo:                                            ; preds = %bb.on
  ...
  store i32 %i.amu, ptr %i.amo, align 8, !tbaa !205
...
bb.oq:                                            ; preds = %bb.op
  ...
  store i32 %i.amw, ptr %i.amo, align 8, !tbaa !205
  %i.amx = icmp eq i32 %i.amw, 0
  br i1 %i.amx, label %bb.or, label %Py_DECREF.exit63.i.i442

bb.or:                                            ; preds = %bb.oq
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.amo) #33, !inline_history !715
  br label %Py_DECREF.exit63.i.i442
...
bb.os:                                            ; preds = %Py_DECREF.exit63.i.i442, %.critedge.i.thread.i431, %Py_INCREF.exit.i.i444
  ...
  store i64 %.2.i.i434, ptr %i.amz, align 8, !tbaa !380
  %i.ana = tail call i32 @PyList_Reverse(ptr noundef nonnull %i.ali) #33, !inline_history !715
...
Py_DECREF.exit69.sink.split.i.i440:               ; preds = %bb.oo, %bb.oc
  ...
  tail call void @_Py_Dealloc(ptr noundef nonnull %.sink.i.i441) #33, !inline_history !715
...
Py_DECREF.exit69.i.i436:                          ; preds = %bb.nx, %Py_DECREF.exit69.sink.split.i.i440, %bb.os, %bb.oo, %bb.on, %bb.oj, %bb.oc, %bb.ob
  %i.anc = load i32, ptr %i.ali, align 8, !tbaa !205 ; 2 uses
...
bb.ot:                                            ; preds = %Py_DECREF.exit69.i.i436
  ...
  store i32 %i.and, ptr %i.ali, align 8, !tbaa !205
  %i.ane = icmp eq i32 %i.and, 0
  br i1 %i.ane, label %bb.ou, label %asciilib_rsplit.exit

bb.ou:                                            ; preds = %bb.ot
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.ali) #33, !inline_history !715
  br label %asciilib_rsplit.exit

bb.ov:                                            ; preds = %bb.nt
  %i.anf = tail call i64 @llvm.smin.i64(i64 %.1, i64 11)
  %i.ang = add nsw i64 %i.anf, 1
  %i.anh = tail call ptr @PyList_New(i64 noundef %i.ang) #33, !inline_history !714 ; 12 uses
...
bb.ow:                                            ; preds = %Py_DECREF.exit72.i484, %.lr.ph.i476
  ...
  %i.anl = tail call fastcc i64 @ucs4lib_fastsearch(ptr noundef %.0.i271, i64 noundef %.057102.i478, ptr noundef %.080, i64 noundef %.val99, i64 noundef -1, i32 noundef 2), !inline_history !714 ; 4 uses
...
bb.ox:                                            ; preds = %bb.ow
  ...
  %i.anq = tail call fastcc ptr @_PyUnicode_FromUCS4(ptr noundef %i.ano, i64 noundef %i.anp), !inline_history !714 ; 8 uses
...
bb.oz:                                            ; preds = %bb.oy
  %.val81.i491 = load ptr, ptr %i.ank, align 8, !tbaa !541
  %i.ant = getelementptr [8 x i8], ptr %.val81.i491, i64 %.0103.i477
  store ptr %i.anq, ptr %i.ant, align 8, !tbaa !194
  br label %Py_DECREF.exit72.i484

bb.pa:                                            ; preds = %bb.oy
  %i.anu = tail call i32 @PyList_Append(ptr noundef nonnull %i.anh, ptr noundef nonnull %i.anq) #33, !inline_history !714
  %.not.i479 = icmp eq i32 %i.anu, 0
  %i.anv = load i32, ptr %i.anq, align 8, !tbaa !205 ; 3 uses
...
bb.pc:                                            ; preds = %bb.pb
  ...
  store i32 %i.anw, ptr %i.anq, align 8, !tbaa !205
...
bb.pe:                                            ; preds = %bb.pd
  ...
  store i32 %i.any, ptr %i.anq, align 8, !tbaa !205
  %i.anz = icmp eq i32 %i.any, 0
  br i1 %i.anz, label %bb.pf, label %Py_DECREF.exit72.i484

bb.pf:                                            ; preds = %bb.pe
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.anq) #33, !inline_history !714
  br label %Py_DECREF.exit72.i484
...
Py_DECREF.exit72.i484:                            ; preds = %bb.pf, %bb.pe, %bb.pd, %bb.oz
  ...
  br i1 %exitcond118.not.i485, label %._crit_edge.thread151.i486, label %bb.ow, !llvm.loop !718
...
._crit_edge.thread.i461:                          ; preds = %._crit_edge.i492, %.preheader.i460
  ...
  %.val.i463 = load ptr, ptr %i.aoc, align 8, !tbaa !197
...
._crit_edge.thread151.i486:                       ; preds = %Py_DECREF.exit72.i484, %._crit_edge.i492
  ...
  %i.aoh = tail call fastcc ptr @_PyUnicode_FromUCS4(ptr noundef %.0.i271, i64 noundef %.057.lcssa154.i488), !inline_history !714 ; 8 uses
  %i.aoi = icmp eq ptr %i.aoh, null
  br i1 %i.aoi, label %Py_DECREF.exit74.i472, label %bb.pi

.thread.i465:                                     ; preds = %._crit_edge.thread.i461
  %i.aoj = tail call fastcc ptr @_PyUnicode_FromUCS4(ptr noundef %.0.i271, i64 noundef %.057.lcssa147.i462), !inline_history !714 ; 2 uses
...
.thread83.i466:                                   ; preds = %bb.pi, %.thread.i465
  ...
  %.val79.i468 = load ptr, ptr %i.aon, align 8, !tbaa !541
  %i.aoo = getelementptr [8 x i8], ptr %.val79.i468, i64 %.0.lcssa148.i467
  store ptr %i.aom, ptr %i.aoo, align 8, !tbaa !194
  br label %Py_DECREF.exit68.i469

bb.pj:                                            ; preds = %bb.pi
  %i.aop = tail call i32 @PyList_Append(ptr noundef nonnull %i.anh, ptr noundef nonnull %i.aoh) #33, !inline_history !714
  %.not66.i489 = icmp eq i32 %i.aop, 0
  %i.aoq = load i32, ptr %i.aoh, align 8, !tbaa !205 ; 3 uses
