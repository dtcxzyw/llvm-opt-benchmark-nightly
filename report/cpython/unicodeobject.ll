...
bb.s:                                             ; preds = %.thread.us.i, %.lr.ph228
  ...
  %6 = getelementptr i8, ptr %.171.us.i, i64 %i.an
  %i.bi = load i8, ptr %6, align 1, !tbaa !205
  %i.bj = zext i8 %i.bi to i32                    ; 3 uses
  %i.bk = shl nuw nsw i32 %i.bj, 8
  %i.bl = getelementptr i8, ptr %.171.us.i, i64 %i.ao
...
bb.ac:                                            ; preds = %.thread.us.i88, %.lr.ph252
  ...
  %7 = getelementptr i8, ptr %.171.us.i83, i64 %i.an
  %i.ek = load i8, ptr %7, align 1, !tbaa !205    ; 2 uses
  %i.el = zext i8 %i.ek to i32                    ; 3 uses
  %i.em = getelementptr i8, ptr %.171.us.i83, i64 %i.ao
...
bb.am:                                            ; preds = %.thread.us.i117, %.lr.ph
  ...
  %8 = getelementptr i8, ptr %.171.us.i113, i64 %i.an
  %i.ho = load i8, ptr %8, align 1, !tbaa !205
  %i.hp = zext i8 %i.ho to i32                    ; 3 uses
  %i.hq = shl nuw nsw i32 %i.hp, 8
  %i.hr = getelementptr i8, ptr %.171.us.i113, i64 %i.ao
...
bb.at:                                            ; preds = %.thread.us.i145, %.lr.ph266
  %.171.us.i140 = phi ptr [ %.070.us.i137264, %.lr.ph266 ], [ %.062.lcssa.us.i, %.thread.us.i145 ] ; 4 uses
  %.4.us.i141 = phi ptr [ %.067.us.i138265, %.lr.ph266 ], [ %.168.lcssa.us.i146, %.thread.us.i145 ] ; 5 uses
  %9 = getelementptr i8, ptr %.171.us.i140, i64 %i.an
  %i.kg = load i8, ptr %9, align 1, !tbaa !205
  %i.kh = zext i8 %i.kg to i32                    ; 3 uses
  %i.ki = shl nuw nsw i32 %i.kh, 8
  %i.kj = getelementptr i8, ptr %.171.us.i140, i64 %i.ao
  %i.kk = load i8, ptr %i.kj, align 1, !tbaa !205
  %i.kl = zext i8 %i.kk to i32
  %i.km = or disjoint i32 %i.ki, %i.kl            ; 2 uses
  %i.kn = getelementptr i8, ptr %.171.us.i140, i64 2 ; 6 uses
...
bb.aw:                                            ; preds = %bb.av
  %10 = getelementptr i8, ptr %i.kn, i64 %i.an
  %i.kq = load i8, ptr %10, align 1, !tbaa !205
...
bb.ax:                                            ; preds = %bb.aw
  ...
  %i.kv = getelementptr i8, ptr %i.kn, i64 %i.ao
