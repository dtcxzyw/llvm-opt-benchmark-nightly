...
begin_hunk_7_@unicode_decode_utf8:bb.a
  ...
  %or.cond.not68 = and i1 %i.x, %i.y
  %i.z = icmp ugt i8 %i.w, -63
  %or.cond4 = select i1 %or.cond.not68, i1 %i.z, i1 false
  br i1 %or.cond4, label %bb.p, label %bb.r

bb.p:                                             ; preds = %bb.o
  %i.aa = ptrtoint ptr %i.m to i64
  %i.ab = icmp samesign ugt i64 %1, 7
  br i1 %i.ab, label %.preheader40.i, label %.loopexit.i

.preheader40.i:                                   ; preds = %bb.p
  %i.ac = ptrtoint ptr %0 to i64
  %i.ad = and i64 %i.ac, 7
  %.not41.i = icmp eq i64 %i.ad, 0
...
.preheader.i:                                     ; preds = %.lr.ph.i, %.lr.ph.i.1, %.lr.ph.i.2, %.lr.ph.i.3, %.lr.ph.i.4, %.lr.ph.i.5, %.lr.ph.i.6, %.lr.ph.i.7, %.preheader40.i
  %.030.lcssa.i = phi i64 [ 0, %.preheader40.i ], [ %i.an, %.lr.ph.i ], [ %i.ay, %.lr.ph.i.1 ], [ %i.bj, %.lr.ph.i.2 ], [ %i.bu, %.lr.ph.i.3 ], [ %i.cf, %.lr.ph.i.4 ], [ %i.cq, %.lr.ph.i.5 ], [ %i.db, %.lr.ph.i.6 ], [ %i.dn, %.lr.ph.i.7 ] ; 2 uses
  %.0.lcssa.i = phi ptr [ %0, %.preheader40.i ], [ %i.af, %.lr.ph.i ], [ %i.aq, %.lr.ph.i.1 ], [ %i.bb, %.lr.ph.i.2 ], [ %i.bm, %.lr.ph.i.3 ], [ %i.bx, %.lr.ph.i.4 ], [ %i.ci, %.lr.ph.i.5 ], [ %i.ct, %.lr.ph.i.6 ], [ %i.de, %.lr.ph.i.7 ] ; 3 uses
  %i.ae = getelementptr i8, ptr %.0.lcssa.i, i64 8
  %.not3851.i = icmp ugt ptr %i.ae, %i.m
  br i1 %.not3851.i, label %.loopexit.i, label %.lr.ph54.i

.lr.ph.i:                                         ; preds = %.preheader40.i
  %i.af = getelementptr i8, ptr %0, i64 1         ; 3 uses
  %i.ag = load i8, ptr %0, align 1, !tbaa !205
  %i.ah = zext i8 %i.ag to i32                    ; 2 uses
  %i.ai = xor i32 %i.ah, -1
  %i.aj = lshr i32 %i.ai, 7
  %i.ak = lshr i32 %i.ah, 6
  %i.al = or i32 %i.aj, %i.ak
  %i.am = and i32 %i.al, 1                        ; 2 uses
  %i.an = zext nneg i32 %i.am to i64
  %i.ao = ptrtoint ptr %i.af to i64
  %i.ap = and i64 %i.ao, 7
  %.not.i72 = icmp eq i64 %i.ap, 0
  br i1 %.not.i72, label %.preheader.i, label %.lr.ph.i.1

.lr.ph.i.1:                                       ; preds = %.lr.ph.i
  %i.aq = getelementptr i8, ptr %0, i64 2         ; 3 uses
  %i.ar = load i8, ptr %i.af, align 1, !tbaa !205
  ...
  %i.ax = and i32 %i.aw, 1
  %narrow = add nuw nsw i32 %i.am, %i.ax          ; 2 uses
  %i.ay = zext nneg i32 %narrow to i64
  %i.az = ptrtoint ptr %i.aq to i64
  %i.ba = and i64 %i.az, 7
  %.not.i72.1 = icmp eq i64 %i.ba, 0
  br i1 %.not.i72.1, label %.preheader.i, label %.lr.ph.i.2

.lr.ph.i.2:                                       ; preds = %.lr.ph.i.1
  %i.bb = getelementptr i8, ptr %0, i64 3         ; 3 uses
  %i.bc = load i8, ptr %i.aq, align 1, !tbaa !205
  %i.bd = zext i8 %i.bc to i32                    ; 2 uses
  %i.be = xor i32 %i.bd, -1
  %i.bf = lshr i32 %i.be, 7
  %i.bg = lshr i32 %i.bd, 6
  %i.bh = or i32 %i.bf, %i.bg
  %i.bi = and i32 %i.bh, 1
  %narrow124 = add nuw nsw i32 %narrow, %i.bi     ; 2 uses
  %i.bj = zext nneg i32 %narrow124 to i64
  %i.bk = ptrtoint ptr %i.bb to i64
  %i.bl = and i64 %i.bk, 7
  %.not.i72.2 = icmp eq i64 %i.bl, 0
  br i1 %.not.i72.2, label %.preheader.i, label %.lr.ph.i.3

.lr.ph.i.3:                                       ; preds = %.lr.ph.i.2
  %i.bm = getelementptr i8, ptr %0, i64 4         ; 3 uses
  %i.bn = load i8, ptr %i.bb, align 1, !tbaa !205
  %i.bo = zext i8 %i.bn to i32                    ; 2 uses
  %i.bp = xor i32 %i.bo, -1
  %i.bq = lshr i32 %i.bp, 7
  %i.br = lshr i32 %i.bo, 6
  %i.bs = or i32 %i.bq, %i.br
  %i.bt = and i32 %i.bs, 1
  %narrow125 = add nuw nsw i32 %narrow124, %i.bt  ; 2 uses
  %i.bu = zext nneg i32 %narrow125 to i64
  %i.bv = ptrtoint ptr %i.bm to i64
  %i.bw = and i64 %i.bv, 7
  %.not.i72.3 = icmp eq i64 %i.bw, 0
  br i1 %.not.i72.3, label %.preheader.i, label %.lr.ph.i.4

.lr.ph.i.4:                                       ; preds = %.lr.ph.i.3
  %i.bx = getelementptr i8, ptr %0, i64 5         ; 3 uses
  %i.by = load i8, ptr %i.bm, align 1, !tbaa !205
  %i.bz = zext i8 %i.by to i32                    ; 2 uses
  %i.ca = xor i32 %i.bz, -1
  %i.cb = lshr i32 %i.ca, 7
  %i.cc = lshr i32 %i.bz, 6
  %i.cd = or i32 %i.cb, %i.cc
  %i.ce = and i32 %i.cd, 1
  %narrow126 = add nuw nsw i32 %narrow125, %i.ce  ; 2 uses
  %i.cf = zext nneg i32 %narrow126 to i64
  %i.cg = ptrtoint ptr %i.bx to i64
  %i.ch = and i64 %i.cg, 7
  %.not.i72.4 = icmp eq i64 %i.ch, 0
  br i1 %.not.i72.4, label %.preheader.i, label %.lr.ph.i.5

.lr.ph.i.5:                                       ; preds = %.lr.ph.i.4
  %i.ci = getelementptr i8, ptr %0, i64 6         ; 3 uses
  %i.cj = load i8, ptr %i.bx, align 1, !tbaa !205
  %i.ck = zext i8 %i.cj to i32                    ; 2 uses
  %i.cl = xor i32 %i.ck, -1
  %i.cm = lshr i32 %i.cl, 7
  %i.cn = lshr i32 %i.ck, 6
  %i.co = or i32 %i.cm, %i.cn
  %i.cp = and i32 %i.co, 1
  %narrow127 = add nuw nsw i32 %narrow126, %i.cp  ; 2 uses
  %i.cq = zext nneg i32 %narrow127 to i64
  %i.cr = ptrtoint ptr %i.ci to i64
  %i.cs = and i64 %i.cr, 7
  %.not.i72.5 = icmp eq i64 %i.cs, 0
  br i1 %.not.i72.5, label %.preheader.i, label %.lr.ph.i.6

.lr.ph.i.6:                                       ; preds = %.lr.ph.i.5
  %i.ct = getelementptr i8, ptr %0, i64 7         ; 3 uses
  %i.cu = load i8, ptr %i.ci, align 1, !tbaa !205
  %i.cv = zext i8 %i.cu to i32                    ; 2 uses
  %i.cw = xor i32 %i.cv, -1
  %i.cx = lshr i32 %i.cw, 7
  %i.cy = lshr i32 %i.cv, 6
  %i.cz = or i32 %i.cx, %i.cy
  %i.da = and i32 %i.cz, 1
  %narrow128 = add nuw nsw i32 %narrow127, %i.da
  %i.db = zext i32 %narrow128 to i64              ; 2 uses
  %i.dc = ptrtoint ptr %i.ct to i64
  %i.dd = and i64 %i.dc, 7
  %.not.i72.6 = icmp eq i64 %i.dd, 0
