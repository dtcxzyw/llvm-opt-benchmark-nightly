...
begin_hunk_1_@asciilib__two_way_find:bb.a
  ...
  %i.bp = add nuw nsw i64 %.05361.i, 1            ; 2 uses
  %5 = icmp samesign ult i64 %i.bp, %3
...
begin_hunk_3_@ucs1lib__preprocess:bb.a
  ...
  %i.bn = add nuw nsw i64 %.05361, 1              ; 2 uses
  %3 = icmp samesign ult i64 %i.bn, %1
...
begin_hunk_5_@ucs2lib__preprocess:bb.a
  ...
  %i.bo = add nuw nsw i64 %.05361, 1              ; 2 uses
  %3 = icmp samesign ult i64 %i.bo, %1
