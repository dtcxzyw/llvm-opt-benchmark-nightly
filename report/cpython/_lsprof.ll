...
bb.c:                                             ; preds = %_PyVectorcall_FunctionInline.exit.i.i.i
  %i.q = tail call ptr %.0.copyload.i.i.i.i(ptr noundef nonnull %i.d, ptr noundef null, i64 noundef 0, ptr noundef null) #5
...
bb.g:                                             ; preds = %PyObject_TypeCheck.exit.thread.i.i
  ...
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !102  ; 7 uses
...
newProfilerEntry.exit:                            ; preds = %bb.e, %bb.f, %bb.z, %normalizeUserObj.exit.i
  ...
  store ptr %1, ptr %i.e, align 8, !tbaa !105
...
!102 = !{!78, !23, i64 32}
!103 = !{!104, !19, i64 0}
!104 = !{!"PyMethodDef", !19, i64 0, !13, i64 8, !7, i64 16, !19, i64 24}
!105 = !{!80, !13, i64 0}
end_hunk_6
