...
bb.l:                                             ; preds = %bb.k
  ...
  %i.aj = tail call range(i8 0, 9) i8 @llvm.ctpop.i8(i8 %i.fq)
  %i.ak = icmp samesign ugt i8 %i.aj, 1
  %or.cond130.i = select i1 %i.ai, i1 true, i1 %i.ak
  %i.al = tail call range(i8 0, 9) i8 @llvm.ctpop.i8(i8 %7)
...
bb.m:                                             ; preds = %bb.l
  %i.an = tail call range(i8 0, 9) i8 @llvm.ctpop.i8(i8 %8)
...
.loopexit136.7.i:                                 ; preds = %.preheader135.7.i, %.loopexit136.6.i
  ...
  %.sroa.1118.8.extract.trunc.i.i.a = trunc i64 %.sroa.1118.8.extract.shift.i.i to i8
  ...
  %i.fq = or i8 %.sroa.9.8.extract.trunc.i.i, %.sroa.917.8.extract.trunc.i.i
  %7 = or i8 %.sroa.11.8.extract.trunc.i.i, %.sroa.1118.8.extract.trunc.i.i.a
  %8 = or i8 %.sroa.12.8.extract.trunc.i.i, %.sroa.1219.8.extract.trunc.i.i
...
update_instrumentation_data.exit:                 ; preds = %update_instrumentation_data.exit.loopexit, %.preheader.i, %bb.ds, %.loopexit134.i, %initialize_line_tools.exit.i
  ...
  %.sroa.917.8.extract.trunc.i = trunc i64 %i.ahc to i8
  %.sroa.1118.8.extract.shift.i = lshr i64 %i.ahc, 8
  %.sroa.1118.8.extract.trunc.i.a = trunc i64 %.sroa.1118.8.extract.shift.i to i8
  %.sroa.1219.8.extract.shift.i = lshr i64 %i.ahc, 16
  %.sroa.1219.8.extract.trunc.i = trunc i64 %.sroa.1219.8.extract.shift.i to i8
  %.sroa.9.8.extract.trunc.i.a = trunc i24 %.sroa.288.0.copyload to i8
  %.sroa.11.8.extract.shift.i = lshr i24 %.sroa.288.0.copyload, 8
  %.sroa.11.8.extract.trunc.i.a = trunc i24 %.sroa.11.8.extract.shift.i to i8
  %.sroa.12.8.extract.shift.i = lshr i24 %.sroa.288.0.copyload, 16
  %.sroa.12.8.extract.trunc.i = trunc nuw i24 %.sroa.12.8.extract.shift.i to i8
  %i.ahd = or i64 %.sroa.087.0.copyload, %i.ahb   ; 4 uses
  %i.ahe = or i8 %.sroa.9.8.extract.trunc.i.a, %.sroa.917.8.extract.trunc.i ; 3 uses
  %i.ahf = or i8 %.sroa.11.8.extract.trunc.i.a, %.sroa.1118.8.extract.trunc.i.a ; 3 uses
  %9 = or i8 %.sroa.12.8.extract.trunc.i, %.sroa.1219.8.extract.trunc.i ; 3 uses
  %.sroa.1230.8.insert.ext.i = zext i8 %9 to i24
  %.sroa.1230.8.insert.shift.i = shl nuw i24 %.sroa.1230.8.insert.ext.i, 16
  ...
  %i.ahg = or disjoint i24 %.sroa.1230.8.insert.shift.i, %.sroa.928.8.insert.ext.i
  %.sroa.928.8.insert.insert.i = or disjoint i24 %i.ahg, %.sroa.1129.8.insert.shift.i ; 2 uses
...
bb.dw:                                            ; preds = %update_instrumentation_data.exit
  ...
  %.sroa.279.0.copyload = load i24, ptr %.sroa.279.0..sroa_idx, align 1 ; 3 uses
  ...
  %.sroa.1120.8.extract.trunc.i.a = trunc i24 %.sroa.1120.8.extract.shift.i to i8 ; 2 uses
  %.sroa.1221.8.extract.shift.i = lshr i24 %.sroa.279.0.copyload, 16
  %.sroa.1221.8.extract.trunc.i = trunc nuw i24 %.sroa.1221.8.extract.shift.i to i8 ; 2 uses
  %i.ahn = xor i64 %i.ahd, -1
  %i.aho = and i64 %.sroa.078.0.copyload, %i.ahn
  %i.ahp = xor i8 %i.ahe, -1
  %i.ahq = and i8 %.sroa.919.8.extract.trunc.i, %i.ahp
  %i.ahr = xor i8 %i.ahf, -1
  %10 = and i8 %.sroa.1120.8.extract.trunc.i.a, %i.ahr
  %11 = xor i8 %9, -1
  %i.ahs = and i8 %.sroa.1221.8.extract.trunc.i, %11
  %.sroa.1232.8.insert.ext.i = zext i8 %i.ahs to i24
  %.sroa.1232.8.insert.shift.i = shl nuw i24 %.sroa.1232.8.insert.ext.i, 16
  %.sroa.1131.8.insert.ext.i = zext i8 %10 to i24
  %.sroa.1131.8.insert.shift.i = shl nuw nsw i24 %.sroa.1131.8.insert.ext.i, 8
  %.sroa.1131.8.insert.insert.i = or disjoint i24 %.sroa.1232.8.insert.shift.i, %.sroa.1131.8.insert.shift.i
  ...
  %12 = xor i8 %.sroa.919.8.extract.trunc.i, -1
  %13 = and i8 %i.ahe, %12
  %i.ahv = xor i8 %.sroa.1120.8.extract.trunc.i.a, -1
  %i.ahw = and i8 %i.ahf, %i.ahv
  %i.ahx = xor i8 %.sroa.1221.8.extract.trunc.i, -1
  %i.ahy = and i8 %9, %i.ahx
  %.sroa.1232.8.insert.ext.i196 = zext i8 %i.ahy to i24
  %.sroa.1232.8.insert.shift.i197 = shl nuw i24 %.sroa.1232.8.insert.ext.i196, 16
  %.sroa.1131.8.insert.ext.i198 = zext i8 %i.ahw to i24
  ...
  %.sroa.930.8.insert.ext.i201 = zext i8 %13 to i24
