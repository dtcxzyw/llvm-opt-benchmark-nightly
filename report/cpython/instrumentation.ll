...
bb.f:                                             ; preds = %bb.d
  ...
  %i.ad = xor i8 %i.ac, -1
  %i.ae = insertelement <8 x i32> poison, i32 %1, i64 0
  %i.af = shufflevector <8 x i32> %i.ae, <8 x i32> poison, <16 x i32> zeroinitializer
  %i.ag = lshr <16 x i32> %i.af, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.ah = and <16 x i32> %i.ag, splat (i32 1)
  %i.ai = insertelement <16 x i8> poison, i8 %i.ad, i64 0
  %i.aj = shufflevector <16 x i8> %i.ai, <16 x i8> poison, <16 x i32> zeroinitializer
  %i.ak = and <16 x i8> %i.o, %i.aj
  %i.al = insertelement <16 x i32> poison, i32 %0, i64 0
  %i.am = shufflevector <16 x i32> %i.al, <16 x i32> poison, <16 x i32> zeroinitializer
  %i.an = shl nuw <16 x i32> %i.ah, %i.am
  %i.ao = trunc <16 x i32> %i.an to <16 x i8>
  %i.ap = or <16 x i8> %i.ak, %i.ao
  store <16 x i8> %i.ap, ptr %i.m, align 1, !tbaa !39
  %i.aq = load ptr, ptr %i.c, align 8, !tbaa !56  ; 3 uses
  %i.ar = load atomic i64, ptr %i.aq monotonic, align 8 ; 2 uses
  %i.as = zext i32 %i.y to i64                    ; 4 uses
  %i.at = and i64 %i.ar, 255
  %i.au = or i64 %i.at, %i.as
  %i.av = cmpxchg ptr %i.aq, i64 %i.ar, i64 %i.au seq_cst seq_cst, align 8 ; 2 uses
  %i.aw = extractvalue { i64, i1 } %i.av, 1
  br i1 %i.aw, label %set_version_raw.exit.i, label %_Py_atomic_compare_exchange_uintptr.exit.i.i

_Py_atomic_compare_exchange_uintptr.exit.i.i:     ; preds = %bb.f, %_Py_atomic_compare_exchange_uintptr.exit.i.i
  %i.ax = phi { i64, i1 } [ %i.bb, %_Py_atomic_compare_exchange_uintptr.exit.i.i ], [ %i.av, %bb.f ]
  %i.ay = extractvalue { i64, i1 } %i.ax, 0       ; 2 uses
  %i.az = and i64 %i.ay, 255
  %i.ba = or i64 %i.az, %i.as
  %i.bb = cmpxchg ptr %i.aq, i64 %i.ay, i64 %i.ba seq_cst seq_cst, align 8 ; 2 uses
  %i.bc = extractvalue { i64, i1 } %i.bb, 1
  br i1 %i.bc, label %set_version_raw.exit.i, label %_Py_atomic_compare_exchange_uintptr.exit.i.i

set_version_raw.exit.i:                           ; preds = %_Py_atomic_compare_exchange_uintptr.exit.i.i, %bb.f
  %i.bd = getelementptr i8, ptr %i.b, i64 24      ; 3 uses
  %i.be = load atomic i64, ptr %i.bd monotonic, align 8 ; 2 uses
  %i.bf = and i64 %i.be, 255
  %i.bg = or i64 %i.bf, %i.as
  %i.bh = cmpxchg ptr %i.bd, i64 %i.be, i64 %i.bg seq_cst seq_cst, align 8 ; 2 uses
  %i.bi = extractvalue { i64, i1 } %i.bh, 1
  br i1 %i.bi, label %set_global_version.exit, label %_Py_atomic_compare_exchange_uintptr.exit.i4.i

_Py_atomic_compare_exchange_uintptr.exit.i4.i:    ; preds = %set_version_raw.exit.i, %_Py_atomic_compare_exchange_uintptr.exit.i4.i
  %i.bj = phi { i64, i1 } [ %i.bn, %_Py_atomic_compare_exchange_uintptr.exit.i4.i ], [ %i.bh, %set_version_raw.exit.i ]
  %i.bk = extractvalue { i64, i1 } %i.bj, 0       ; 2 uses
  %i.bl = and i64 %i.bk, 255
  %i.bm = or i64 %i.bl, %i.as
  %i.bn = cmpxchg ptr %i.bd, i64 %i.bk, i64 %i.bm seq_cst seq_cst, align 8 ; 2 uses
  %i.bo = extractvalue { i64, i1 } %i.bn, 1
  br i1 %i.bo, label %set_global_version.exit, label %_Py_atomic_compare_exchange_uintptr.exit.i4.i

set_global_version.exit:                          ; preds = %_Py_atomic_compare_exchange_uintptr.exit.i4.i, %set_version_raw.exit.i
  %i.bp = getelementptr i8, ptr %i.d, i64 7376    ; 2 uses
  %i.bq = load ptr, ptr %i.bp, align 8, !tbaa !94
  %i.br = getelementptr i8, ptr %i.bq, i64 864    ; 2 uses
  %i.bs = cmpxchg ptr %i.br, i8 0, i8 1 seq_cst seq_cst, align 1
  %i.bt = extractvalue { i8, i1 } %i.bs, 1
  br i1 %i.bt, label %PyMutex_LockFlags.exit.i, label %bb.g

bb.g:                                             ; preds = %set_global_version.exit
  %i.bu = tail call i32 @_PyMutex_LockTimed(ptr noundef %i.br, i64 noundef -1, i32 noundef 0) #12 ; 0 uses
  br label %PyMutex_LockFlags.exit.i

PyMutex_LockFlags.exit.i:                         ; preds = %bb.g, %set_global_version.exit
  %i.bv = getelementptr i8, ptr %i.d, i64 7336
  %.01633.i = load ptr, ptr %i.bv, align 8, !tbaa !93 ; 2 uses
...
.lr.ph36.i:                                       ; preds = %PyMutex_LockFlags.exit.i, %._crit_edge.i
  ...
  %i.bw = getelementptr i8, ptr %.01635.i, i64 72
  %.030.i = load ptr, ptr %i.bw, align 8, !tbaa !161 ; 2 uses
...
.lr.ph.i:                                         ; preds = %.lr.ph36.i, %instrument_lock_held.exit.thread.i
  ...
  %i.bx = getelementptr i8, ptr %.032.i, i64 74
  %i.by = load i8, ptr %i.bx, align 2, !tbaa !162
  %i.bz = icmp slt i8 %i.by, 3
  br i1 %i.bz, label %bb.h, label %instrument_lock_held.exit.thread.i

bb.h:                                             ; preds = %.lr.ph.i
  %.0.val.i = load i64, ptr %.032.i, align 8
  %i.ca = and i64 %.0.val.i, -2
  %i.cb = inttoptr i64 %i.ca to ptr               ; 2 uses
  %i.cc = load atomic i64, ptr %i.d monotonic, align 8
  %i.cd = and i64 %i.cc, 4294967295
  %i.ce = getelementptr i8, ptr %i.cb, i64 168
  %i.cf = load i64, ptr %i.ce, align 8, !tbaa !92
  %i.cg = icmp eq i64 %i.cf, %i.cd
  br i1 %i.cg, label %instrument_lock_held.exit.thread.i, label %instrument_lock_held.exit.i

instrument_lock_held.exit.i:                      ; preds = %bb.h
  %i.ch = tail call fastcc i32 @force_instrument_lock_held(ptr noundef nonnull %i.cb, ptr noundef nonnull readonly %i.d)
...
instrument_lock_held.exit.thread.i:               ; preds = %instrument_lock_held.exit.i, %bb.h, %.lr.ph.i
  %i.ci = getelementptr i8, ptr %.032.i, i64 8
  %.0.i17 = load ptr, ptr %i.ci, align 8, !tbaa !161 ; 2 uses
...
._crit_edge.i:                                    ; preds = %instrument_lock_held.exit.thread.i, %.lr.ph36.i
  %i.cj = getelementptr i8, ptr %.01635.i, i64 8
  %.016.i = load ptr, ptr %i.cj, align 8, !tbaa !93 ; 2 uses
...
.loopexit.i:                                      ; preds = %._crit_edge.i, %instrument_lock_held.exit.i, %PyMutex_LockFlags.exit.i
  ...
  %i.ck = load ptr, ptr %i.bp, align 8, !tbaa !94
  %i.cl = getelementptr i8, ptr %i.ck, i64 864    ; 2 uses
  %i.cm = cmpxchg ptr %i.cl, i8 1, i8 0 seq_cst seq_cst, align 1
  %i.cn = extractvalue { i8, i1 } %i.cm, 1
  br i1 %i.cn, label %instrument_all_executing_code_objects.exit, label %bb.i

bb.i:                                             ; preds = %.loopexit.i
  tail call void @PyMutex_Unlock(ptr noundef %i.cl) #12
  br label %instrument_all_executing_code_objects.exit
