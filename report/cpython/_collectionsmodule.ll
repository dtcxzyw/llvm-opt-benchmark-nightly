...
begin_hunk_0_@deque_index:bb.a
  ...
  %spec.select.i = call i64 @llvm.smin.i64(i64 %.045.i, i64 %spec.select68.i) ; 8 uses
...
.lr.ph.i.epil.preheader:                          ; preds = %.preheader.i.loopexit.unr-lcssa, %.lr.ph.i.preheader
  ...
  %.05572.i.epil.init = phi i64 [ 0, %.lr.ph.i.preheader ], [ %4, %.preheader.i.loopexit.unr-lcssa ]
...
.lr.ph.i.epil:                                    ; preds = %.lr.ph.i.epil, %.lr.ph.i.epil.preheader
  ...
  %.05572.i.epil = phi i64 [ %3, %.lr.ph.i.epil ], [ %.05572.i.epil.init, %.lr.ph.i.epil.preheader ]
  %epil.iter = phi i64 [ %epil.iter.next, %.lr.ph.i.epil ], [ 0, %.lr.ph.i.epil.preheader ]
  %i.ag = getelementptr i8, ptr %.04873.i.epil, i64 520
  %i.ah = load ptr, ptr %i.ag, align 8, !tbaa !58 ; 2 uses
  %3 = add nuw nsw i64 %.05572.i.epil, 64         ; 2 uses
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %.preheader.i, label %.lr.ph.i.epil, !llvm.loop !93

.preheader.i:                                     ; preds = %.preheader.i.loopexit.unr-lcssa, %.lr.ph.i.epil, %._crit_edge93.i
  %.055.lcssa.i = phi i64 [ 0, %._crit_edge93.i ], [ %4, %.preheader.i.loopexit.unr-lcssa ], [ %3, %.lr.ph.i.epil ] ; 6 uses
  %.048.lcssa.i = phi ptr [ %i.r, %._crit_edge93.i ], [ %i.bg, %.preheader.i.loopexit.unr-lcssa ], [ %i.ah, %.lr.ph.i.epil ] ; 3 uses
...
bb.h:                                             ; preds = %bb.g, %.lr.ph78.i.prol
  ...
  %i.ao = add nuw nsw i64 %.15675.i.prol, 1       ; 2 uses
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %.lr.ph.i.preheader.new
  ...
  %.05572.i = phi i64 [ 0, %.lr.ph.i.preheader.new ], [ %4, %.lr.ph.i ]
...
begin_hunk_4_@deque_index:bb.a
  ...
  %4 = add nuw nsw i64 %.05572.i, 512             ; 3 uses
...
bb.m:                                             ; preds = %bb.l, %.lr.ph78.i.3
  ...
  %i.bx = add nuw nsw i64 %.15675.i, 4            ; 2 uses
