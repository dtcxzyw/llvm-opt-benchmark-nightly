...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep290 = getelementptr i8, ptr %i.as, i64 %offset.idx ; 2 uses
...
vector.ph300:                                     ; preds = %vector.memcheck294
  %n.vec302 = and i64 %.1, -4                     ; 3 uses
  %i.dm = shl i64 %n.vec302, 3                    ; 2 uses
  %i.dn = getelementptr i8, ptr %i.dd, i64 %i.dm
  %i.do = getelementptr i8, ptr %i.df, i64 %i.dm
  %i.dp = and i64 %.1, 3
  br label %vector.body303

vector.body303:                                   ; preds = %vector.body303, %vector.ph300
  %index304 = phi i64 [ 0, %vector.ph300 ], [ %index.next311, %vector.body303 ] ; 2 uses
  %offset.idx305 = shl i64 %index304, 3           ; 2 uses
  %next.gep306 = getelementptr i8, ptr %i.dd, i64 %offset.idx305 ; 2 uses
  %next.gep308 = getelementptr i8, ptr %i.df, i64 %offset.idx305 ; 2 uses
