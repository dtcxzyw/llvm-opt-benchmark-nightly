...
bb.a:
  ...
  %.val37.i = load i64, ptr %i.a, align 8, !tbaa !56 ; 3 uses
...
vector.memcheck294:                               ; preds = %bb.r
  ...
  %diff.check297 = icmp ult i64 %i.dk, 32
