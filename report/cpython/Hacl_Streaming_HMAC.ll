...
@switch.table._Py_LibHacl_Hacl_Streaming_HMAC_malloc_ = private unnamed_addr constant [13 x i64] [i64 64, i64 64, i64 64, i64 64, i64 128, i64 128, i64 144, i64 136, i64 104, i64 72, i64 64, i64 poison, i64 128], align 8
...
@switch.table._Py_LibHacl_Hacl_Streaming_HMAC_digest.26 = private unnamed_addr constant [14 x i8] c"@@@@\80\80\90\88hH@@\80\80", align 1
@switch.table._Py_LibHacl_Hacl_Streaming_HMAC_copy = private unnamed_addr constant [14 x i64] [i64 64, i64 64, i64 64, i64 64, i64 poison, i64 poison, i64 144, i64 136, i64 104, i64 72, i64 64, i64 64, i64 128, i64 128], align 8
@switch.table._Py_LibHacl_Hacl_Streaming_HMAC_copy.27 = private unnamed_addr constant [14 x i64] [i64 64, i64 64, i64 64, i64 64, i64 128, i64 128, i64 144, i64 136, i64 104, i64 72, i64 64, i64 64, i64 128, i64 128], align 8
...
@switch.table.init0.29 = private unnamed_addr constant [12 x i64] [i64 64, i64 64, i64 128, i64 128, i64 64, i64 64, i64 64, i64 128, i64 136, i64 144, i64 104, i64 72], align 8
@switch.table.init0.30 = private unnamed_addr constant [12 x i32] [i32 64, i32 64, i32 128, i32 128, i32 64, i32 64, i32 64, i32 128, i32 136, i32 144, i32 104, i32 72], align 4
...
switch.lookup19:                                  ; preds = %switch.hole_check
  ...
  %switch.gep20 = getelementptr inbounds nuw [8 x i8], ptr @switch.table._Py_LibHacl_Hacl_Streaming_HMAC_malloc_, i64 %i.d
...
begin_hunk_2
  ...
  %switch.gep = getelementptr inbounds nuw [8 x i8], ptr @switch.table._Py_LibHacl_Hacl_Streaming_HMAC_copy.27, i64 %i.c
...
switch.lookup:                                    ; preds = %_Py_LibHacl_Hacl_Streaming_HMAC_index_of_state.exit
  ...
  %switch.gep = getelementptr inbounds nuw [8 x i8], ptr @switch.table._Py_LibHacl_Hacl_Streaming_HMAC_copy.27, i64 %i.f
...
switch.lookup1014:                                ; preds = %switch.lookup
  ...
  %switch.gep1015 = getelementptr inbounds nuw [8 x i8], ptr @switch.table._Py_LibHacl_Hacl_Streaming_HMAC_copy.27, i64 %i.j
...
begin_hunk_5
  ...
  %switch.gep1018 = getelementptr inbounds nuw [8 x i8], ptr @switch.table._Py_LibHacl_Hacl_Streaming_HMAC_copy.27, i64 %i.n
...
switch.lookup1023:                                ; preds = %switch.lookup1017
  %switch.gep1024 = getelementptr inbounds nuw [8 x i8], ptr @switch.table._Py_LibHacl_Hacl_Streaming_HMAC_copy.27, i64 %i.q
...
switch.lookup1020:                                ; preds = %switch.lookup1017
  %switch.gep1021 = getelementptr inbounds nuw [8 x i8], ptr @switch.table._Py_LibHacl_Hacl_Streaming_HMAC_copy.27, i64 %i.q
...
begin_hunk_7
  ...
  %switch.gep1027 = getelementptr inbounds nuw [8 x i8], ptr @switch.table._Py_LibHacl_Hacl_Streaming_HMAC_copy.27, i64 %i.w
...
switch.lookup1029:                                ; preds = %switch.lookup1026
  ...
  %switch.gep1030 = getelementptr inbounds nuw [8 x i8], ptr @switch.table._Py_LibHacl_Hacl_Streaming_HMAC_copy.27, i64 %i.af
...
switch.lookup1038:                                ; preds = %block_len.exit315
  ...
  %switch.gep1039 = getelementptr inbounds nuw [8 x i8], ptr @switch.table._Py_LibHacl_Hacl_Streaming_HMAC_copy.27, i64 %i.de
...
switch.lookup1041:                                ; preds = %block_len.exit333
  ...
  %switch.gep1042 = getelementptr inbounds nuw [8 x i8], ptr @switch.table._Py_LibHacl_Hacl_Streaming_HMAC_copy.27, i64 %i.du
...
switch.lookup242:                                 ; preds = %_Py_LibHacl_Hacl_Streaming_HMAC_index_of_state.exit
  %switch.gep243 = getelementptr inbounds nuw [8 x i8], ptr @switch.table._Py_LibHacl_Hacl_Streaming_HMAC_copy.27, i64 %i.g
...
begin_hunk_13
  ...
  %switch.gep246 = getelementptr inbounds nuw i8, ptr @switch.table._Py_LibHacl_Hacl_Streaming_HMAC_digest.26, i64 %i.r
...
switch.lookup251:                                 ; preds = %switch.lookup245
  %switch.gep252 = getelementptr inbounds nuw i8, ptr @switch.table._Py_LibHacl_Hacl_Streaming_HMAC_digest.26, i64 %i.v
...
switch.lookup248:                                 ; preds = %switch.lookup245
  %switch.gep249 = getelementptr inbounds nuw [8 x i8], ptr @switch.table._Py_LibHacl_Hacl_Streaming_HMAC_copy.27, i64 %i.v
...
begin_hunk_15
  ...
  %.val.i = load i8, ptr %.sroa.065.sroa.4.0.copyload, align 8 ; 7 uses
...
begin_hunk_16
  ...
  br i1 %switch, label %block_len.exit84, label %block_len.exit

block_len.exit:                                   ; preds = %_Py_LibHacl_Hacl_Streaming_HMAC_index_of_state.exit
  %switch.maskindex = zext nneg i8 %.val.i to i16
  %switch.shifted = lshr i16 16335, %switch.maskindex
  %switch.lobit = trunc i16 %switch.shifted to i1
  br i1 %switch.lobit, label %switch.lookup, label %1

1:                                                ; preds = %block_len.exit
  %2 = load ptr, ptr @stderr, align 8, !tbaa !15
  %3 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %2, ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.1, i32 noundef 109) #12 ; 0 uses
  tail call void @exit(i32 noundef 253) #13
  unreachable

switch.lookup:                                    ; preds = %block_len.exit
  %i.d = zext nneg i8 %.val.i to i64
  %switch.gep = getelementptr inbounds nuw [8 x i8], ptr @switch.table._Py_LibHacl_Hacl_Streaming_HMAC_copy, i64 %i.d
  %switch.load = load i64, ptr %switch.gep, align 8
  br label %block_len.exit84

block_len.exit84:                                 ; preds = %switch.lookup, %_Py_LibHacl_Hacl_Streaming_HMAC_index_of_state.exit
  %.0.i82 = phi i64 [ %switch.load, %switch.lookup ], [ 128, %_Py_LibHacl_Hacl_Streaming_HMAC_index_of_state.exit ]
...
switch.lookup144:                                 ; preds = %block_len.exit84
  ...
  %switch.gep145 = getelementptr inbounds nuw [8 x i8], ptr @switch.table._Py_LibHacl_Hacl_Streaming_HMAC_copy.27, i64 %i.g
...
begin_hunk_17
  ...
  %switch.gep73 = getelementptr inbounds nuw [8 x i8], ptr @switch.table.init0.29, i64 %i.p
...
switch.lookup75.preheader:                        ; preds = %switch.lookup72
  ...
  %switch.gep76 = getelementptr inbounds nuw [8 x i8], ptr @switch.table.init0.29, i64 %i.r
...
switch.lookup78:                                  ; preds = %switch.lookup75
  ...
  %switch.gep79 = getelementptr inbounds nuw [4 x i8], ptr @switch.table.init0.30, i64 %i.z
