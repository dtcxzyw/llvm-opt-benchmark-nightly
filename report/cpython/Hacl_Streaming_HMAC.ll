...
block_len.exit381:                                ; preds = %block_len.exit375, %block_len.exit375, %block_len.exit375, %block_len.exit375, %block_len.exit375.thread843, %bb.ai, %block_len.exit375.thread839, %bb.ah, %block_len.exit375.thread835, %bb.ag, %bb.af, %block_len.exit375.thread831, %block_len.exit375.thread827, %block_len.exit375.thread, %alg_of_impl.exit378.thread
  %i.eq = phi i32 [ %i.ep, %alg_of_impl.exit378.thread ], [ %i.ep, %bb.ah ], [ %i.ep, %bb.ag ], [ %i.el, %block_len.exit375.thread831 ], [ %i.ep, %block_len.exit375 ], [ %i.ek, %block_len.exit375.thread827 ], [ %i.ej, %block_len.exit375.thread ], [ %i.ep, %block_len.exit375 ], [ %i.ep, %bb.ai ], [ %i.ep, %bb.af ], [ %i.em, %block_len.exit375.thread835 ], [ %i.en, %block_len.exit375.thread839 ], [ %i.eo, %block_len.exit375.thread843 ], [ %i.ep, %block_len.exit375 ], [ %i.ep, %block_len.exit375 ]
  %.0.i379 = phi i32 [ 64, %alg_of_impl.exit378.thread ], [ 104, %bb.ah ], [ 136, %bb.ag ], [ 144, %block_len.exit375.thread831 ], [ 128, %block_len.exit375 ], [ 128, %block_len.exit375.thread827 ], [ 128, %block_len.exit375.thread ], [ 128, %block_len.exit375 ], [ 72, %bb.ai ], [ 144, %bb.af ], [ 136, %block_len.exit375.thread835 ], [ 104, %block_len.exit375.thread839 ], [ 72, %block_len.exit375.thread843 ], [ 128, %block_len.exit375 ], [ 128, %block_len.exit375 ]
  %i.er = mul i32 %.0.i379, %i.eq                 ; 3 uses
  %i.es = sub i32 %i.dv, %i.er
  %i.et = zext i32 %i.er to i64
  %i.eu = getelementptr i8, ptr %i.cj, i64 %i.et
  %i.ev = extractelement <2 x ptr> %i.de, i64 0   ; 2 uses
  %.sroa.439.0.copyload.val = load i8, ptr %i.ev, align 8, !tbaa !18
  %i.ew = getelementptr i8, ptr %i.ev, i64 8
  %.sroa.439.0.copyload.val202 = load ptr, ptr %i.ew, align 8, !tbaa !18
  tail call fastcc void @update_multi(i8 %.sroa.439.0.copyload.val, ptr %.sroa.439.0.copyload.val202, i64 noundef %i.dd, ptr noundef %i.cj, i32 noundef %i.er)
  %i.ex = zext i32 %i.es to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %.sroa.454.0.copyload644667, ptr align 1 %i.eu, i64 %i.ex, i1 false)
  %i.ey = add i64 %i.dd, %i.dw
  store i64 %.sroa.0.0.copyload922, ptr %0, align 8
  store <2 x ptr> %i.de, ptr %.sroa.0158.sroa.5.0..sroa_idx, align 8, !tbaa !23
  store ptr %.sroa.454.0.copyload644667, ptr %.sroa.0158.sroa.7.0..sroa_idx, align 8, !tbaa !20
  store i64 %i.ey, ptr %.sroa.4159.0..sroa_idx, align 8, !tbaa !22
  call void @llvm.lifetime.end.p0(ptr nonnull %4)
  br label %bb.aj

bb.aj:                                            ; preds = %block_len.exit243, %block_len.exit381, %block_len.exit303, %_Py_LibHacl_Hacl_Streaming_HMAC_index_of_state.exit
...
bb.n:                                             ; preds = %bb.a
  %i.q = load ptr, ptr @stderr, align 8, !tbaa !16
...
bb.a:
  ...
  %.sroa.5142.0.copyload = load ptr, ptr %.sroa.5142.0..sroa_idx, align 8, !tbaa !23 ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  %i.a = load ptr, ptr @stderr, align 8, !tbaa !16
...
_Py_LibHacl_Hacl_Streaming_HMAC_index_of_state.exit: ; preds = %bb.a
  ...
  %.sroa.570.0.copyload = load ptr, ptr %.sroa.6143.0..sroa_idx, align 8, !tbaa !23 ; 2 uses
  %.sroa.671.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 24
  %.sroa.671.0.copyload = load ptr, ptr %.sroa.671.0..sroa_idx, align 8, !tbaa !20 ; 2 uses
  %.sroa.772.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 32
  %.sroa.772.0.copyload = load i64, ptr %.sroa.772.0..sroa_idx, align 8, !tbaa !22 ; 4 uses
...
block_len.exit103:                                ; preds = %switch.lookup, %switch.lookup243
  %.087 = phi i32 [ %i.i, %switch.lookup243 ], [ %switch.ext242, %switch.lookup ] ; 4 uses
...
switch.lookup247:                                 ; preds = %bb.c
  ...
  %i.p = zext nneg i32 %.087 to i64               ; 2 uses
  ...
  %.lhs.trunc = trunc nuw i32 %.087 to i8         ; 2 uses
  %i.s = urem i8 %.lhs.trunc, %switch.load249
  %i.t = icmp eq i8 %i.s, 0
  %i.u = icmp ne i32 %.087, 0
...
block_len.exit123:                                ; preds = %switch.lookup250, %switch.lookup254
  %switch.load252.sink = phi i8 [ %switch.load252, %switch.lookup250 ], [ %i.w, %switch.lookup254 ]
  ...
  %i.aa = getelementptr i8, ptr %i.j, i64 8
  %.sroa.11.1.val91 = load ptr, ptr %i.aa, align 8, !tbaa !18 ; 13 uses
  ...
  tail call fastcc void @update_last(i8 %.sroa.11.1.val, ptr %.sroa.11.1.val91, i64 noundef %i.q, ptr noundef %i.z, i32 noundef %.087)
...
finish0.exit:                                     ; preds = %bb.i, %bb.h, %bb.g, %bb.f, %bb.e, %block_len.exit.thread32.i, %block_len.exit.thread29.i, %block_len.exit.thread26.i, %block_len.exit.thread.i, %block_len.exit.i.thread216
  ...
  %i.ae = getelementptr i8, ptr %i.l, i64 8
  %.val10.i = load ptr, ptr %i.ae, align 8, !tbaa !18 ; 3 uses
  ...
  %switch.i = icmp ult i8 %.val9.i, 14
  br i1 %switch.i, label %free_.exit136, label %bb.j
...
free_.exit136:                                    ; preds = %finish0.exit
...
bb.al:                                            ; preds = %bb.a
  %i.y = load ptr, ptr @stderr, align 8, !tbaa !16
...
bb.a:
  ...
  %.sroa.519.0.copyload = load ptr, ptr %.sroa.519.0..sroa_idx, align 8, !tbaa !23 ; 3 uses
...
free_.exit:                                       ; preds = %bb.a
  ...
  %.sroa.5.0.copyload = load ptr, ptr %.sroa.6.0..sroa_idx20, align 8, !tbaa !23 ; 3 uses
...
bb.c:                                             ; preds = %free_.exit
  %i.c = load ptr, ptr @stderr, align 8, !tbaa !16
...
; Function Attrs: nounwind uwtable
define hidden noalias noundef ptr @_Py_LibHacl_Hacl_Streaming_HMAC_copy(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #4 {
bb.a:
  %.sroa.065.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 8
  %.sroa.065.sroa.4.0.copyload = load ptr, ptr %.sroa.065.sroa.4.0..sroa_idx, align 8, !tbaa !23 ; 3 uses
  %.sroa.065.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 16
  %.sroa.065.sroa.5.0.copyload = load ptr, ptr %.sroa.065.sroa.5.0..sroa_idx, align 8, !tbaa !23 ; 2 uses
  %.sroa.466.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 24
  %.sroa.466.0.copyload = load ptr, ptr %.sroa.466.0..sroa_idx, align 8, !tbaa !20
  %.sroa.567.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 32
  %.sroa.567.0.copyload = load i64, ptr %.sroa.567.0..sroa_idx, align 8, !tbaa !22
...
bb.e:                                             ; preds = %bb.d
  ...
  store ptr %i.h, ptr %.sroa.0.sroa.4.0..sroa_idx, align 8, !tbaa !23
  %.sroa.0.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.n, i64 16
  store ptr %i.j, ptr %.sroa.0.sroa.5.0..sroa_idx, align 8, !tbaa !23
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.n, i64 24
  store ptr %i.e, ptr %.sroa.4.0..sroa_idx, align 8, !tbaa !20
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.n, i64 32
  store i64 %.sroa.567.0.copyload, ptr %.sroa.5.0..sroa_idx, align 8, !tbaa !22
  br label %bb.i
