...
bb.ce:                                            ; preds = %bb.az, %bb.bb, %bb.bd, %bb.bi, %bb.cd, %bb.ax, %iso2022processesc.exit.thread150, %iso2022processg2.exit, %bb.e, %bb.d
  %.2144 = phi i64 [ %i.er, %bb.bb ], [ %i.ex, %bb.bd ], [ %i.bw, %iso2022processesc.exit.thread150 ], [ %i.ek, %bb.az ], [ %i.t, %bb.e ], [ %i.t, %bb.d ], [ %i.fg, %bb.bi ], [ %i.hl, %bb.cd ], [ %i.dw, %iso2022processg2.exit ], [ %i.ed, %bb.ax ] ; 2 uses
...
.thread159:                                       ; preds = %bb.ce, %bb.aw, %bb.c, %bb.bf, %bb.bc, %bb.bh, %.loopexit, %bb.bq, %bb.g, %bb.ad, %bb.bs, %bb.t, %bb.v, %bb.ab, %bb.r, %bb.s, %bb.y, %bb.x, %bb.w, %bb.av, %bb.ag, %bb.af, %bb.ai, %bb.al, %bb.ap, %bb.ar, %bb.as, %bb.at, %bb.aq, %bb.au, %bb.ae, %bb.bv, %switch.lookup, %bb.m, %bb.n, %.thread159.loopexit254, %bb.a, %bb.bo
  %.5 = phi i64 [ -2, %switch.lookup ], [ 0, %bb.a ], [ %i.fx, %bb.bo ], [ %i.aq, %bb.n ], [ 1, %bb.m ], [ -4, %bb.ag ], [ 3, %bb.af ], [ -4, %bb.ai ], [ -4, %bb.al ], [ -4, %bb.ap ], [ -4, %bb.ar ], [ -4, %bb.as ], [ -4, %bb.at ], [ 3, %bb.aq ], [ 3, %bb.au ], [ 4, %bb.t ], [ 6, %bb.v ], [ %i.aq, %bb.ab ], [ 3, %bb.r ], [ 4, %bb.s ], [ 6, %bb.y ], [ 6, %bb.x ], [ -3, %bb.ae ], [ -4, %bb.av ], [ -4, %bb.aw ], [ -4, %bb.c ], [ 0, %bb.ce ], [ 1, %bb.bf ], [ -4, %bb.bc ], [ -4, %bb.bh ], [ -2, %.loopexit ], [ 6, %bb.w ], [ -4, %bb.bq ], [ -2, %bb.g ], [ -4, %bb.bs ], [ -2, %bb.ad ], [ -4, %bb.bv ], [ 1, %.thread159.loopexit254 ]
  ret i64 %.5
}
