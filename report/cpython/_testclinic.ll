...
begin_hunk_1_@py_buffer_converter:bb.a
  ...
  br i1 %.not29.i, label %.loopexit10.i.thread.a, label %bb.i

.loopexit10.i:                                    ; preds = %bb.d, %bb.f, %bb.i
  %5 = phi i64 [ %.02721.lcssa36.wide.i, %bb.f ], [ 0, %bb.d ], [ 1, %bb.i ] ; 2 uses
  ...
  br i1 %.not30.i, label %bb.g, label %.preheader8.i.a

.loopexit10.i.thread.a:                           ; preds = %bytes_from_buffer.exit.i
  %i.o = call ptr @PyErr_Occurred() #11
  %.not30.i6.a = icmp eq ptr %i.o, null
  br i1 %.not30.i6.a, label %bb.g, label %py_buffer_converter_impl.exit

.loopexit10.thread.i.a:                           ; preds = %bytes_from_buffer.exit.1.i
  %i.p = call ptr @PyErr_Occurred() #11
  %.not3052.i.a = icmp eq ptr %i.p, null
  br i1 %.not3052.i.a, label %bb.g, label %.lr.ph.i

.preheader8.i.a:                                  ; preds = %.loopexit10.i
  %i.q = icmp eq i64 %5, 0
  br i1 %i.q, label %py_buffer_converter_impl.exit, label %.preheader8.i..lr.ph.i_crit_edge

.preheader8.i..lr.ph.i_crit_edge:                 ; preds = %.preheader8.i.a
  %.pre = load ptr, ptr %i.a, align 16, !tbaa !11
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.preheader8.i..lr.ph.i_crit_edge, %.loopexit10.thread.i.a
  %i.r = phi ptr [ %.pre, %.preheader8.i..lr.ph.i_crit_edge ], [ %i.l, %.loopexit10.thread.i.a ] ; 3 uses
...
bb.g:                                             ; preds = %.loopexit10.i.thread.a, %.loopexit10.thread.i.a, %.loopexit10.i
...
begin_hunk_2_@py_buffer_converter:bb.a
  ...
  br i1 %i.z, label %.loopexit10.i, label %bb.j
...
bytes_from_buffer.exit.1.i:                       ; preds = %bb.j
  ...
  br i1 %.not29.1.i, label %.loopexit10.thread.i.a, label %.critedge.i
...
py_buffer_converter_impl.exit:                    ; preds = %.loopexit10.i.thread.a, %.preheader8.i.a, %.lr.ph.i, %.lr.ph.split.i, %bb.h, %Py_DECREF.exit.i, %bb.m, %bb.n, %PyTuple_SET_ITEM.exit.1.i
  %.2.i = phi ptr [ null, %.lr.ph.i ], [ null, %Py_DECREF.exit.i ], [ %i.af, %PyTuple_SET_ITEM.exit.1.i ], [ null, %.preheader8.i.a ], [ null, %bb.n ], [ null, %bb.m ], [ null, %bb.h ], [ null, %.lr.ph.split.i ], [ null, %.loopexit10.i.thread.a ]
