...
.thread:                                          ; preds = %bb.o, %bb.m
  ...
  %i.w = call ptr %i.v(ptr noundef %0, i64 noundef 0) #11, !inline_history !65
  br label %bb.p
...
.thread60:                                        ; preds = %bb.i, %bb.l, %PyDict_GET_SIZE.exit56, %bb.o, %bb.p
  ...
  %i.ac = call ptr %i.ab(ptr noundef %0, i64 noundef 0) #11, !inline_history !70
  br label %bb.q
...
!65 = distinct !{null}
!66 = !{!67, !20, i64 16}
!67 = !{!"", !15, i64 0, !20, i64 16, !20, i64 24, !68, i64 32, !69, i64 40}
!68 = !{!"p1 _ZTS15_dictkeysobject", !13, i64 0}
!69 = !{!"p1 _ZTS11_dictvalues", !13, i64 0}
!70 = distinct !{null}
end_hunk_5
