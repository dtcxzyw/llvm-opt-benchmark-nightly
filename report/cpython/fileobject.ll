...
bb.f:                                             ; preds = %bb.e, %bb.d
  %i.g = phi ptr [ %i.f, %bb.e ], [ %i.e, %bb.d ] ; 5 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %2 = load ptr, ptr %i.b, align 8, !tbaa !12     ; 3 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  store i32 %i.n, ptr %2, align 8, !tbaa !11
...
Py_DECREF.exit47.thread:                          ; preds = %bb.i, %bb.h, %bb.f
  %i.p = icmp slt i32 %1, 0
  br label %bb.r

Py_DECREF.exit47:                                 ; preds = %bb.j, %bb.g
  %3 = phi ptr [ %.pre, %bb.j ], [ %i.g, %bb.g ]  ; 7 uses
  %i.q = icmp slt i32 %1, 0                       ; 6 uses
  %4 = icmp ne ptr %3, null
  %or.cond = select i1 %i.q, i1 %4, i1 false
...
bb.l:                                             ; preds = %bb.k
  %i.u = getelementptr i8, ptr %3, i64 16
...
bb.r:                                             ; preds = %Py_DECREF.exit47.thread, %Py_DECREF.exit45, %bb.q, %bb.p, %bb.k, %Py_DECREF.exit47
  %i.ag = phi i1 [ %i.p, %Py_DECREF.exit47.thread ], [ %i.q, %Py_DECREF.exit45 ], [ %i.q, %bb.q ], [ %i.q, %bb.p ], [ %i.q, %bb.k ], [ %i.q, %Py_DECREF.exit47 ]
