...
bb.q:                                             ; preds = %bb.p, %bb.o
  %i.ay = getelementptr i8, ptr %1, i64 64        ; 5 uses
...
bb.r:                                             ; preds = %bb.q
  ...
  br i1 %.not.i.i, label %19, label %bb.s

19:                                               ; preds = %bb.r
  store ptr null, ptr %i.ay, align 8, !tbaa !29, !noalias !425
...
config_get_env_dup.exit.thread.i:                 ; preds = %config_get_env_dup.exit.i, %20, %19, %bb.q
  %i.bm = getelementptr i8, ptr %1, i64 296       ; 5 uses
...
bb.z:                                             ; preds = %config_get_env_dup.exit.thread.i
  ...
  br i1 %.not.i85.i, label %21, label %bb.aa

21:                                               ; preds = %bb.z
  store ptr null, ptr %i.bm, align 8, !tbaa !29, !noalias !431
  br label %config_get_env_dup.exit91.thread.i

bb.aa:                                            ; preds = %bb.z
  %i.bq = call ptr @getenv(ptr noundef nonnull @.str.177) #29, !noalias !431 ; 3 uses
  %.not10.i86.i = icmp eq ptr %i.bq, null
  br i1 %.not10.i86.i, label %22, label %bb.ab

bb.ab:                                            ; preds = %bb.aa
  %i.br = load i8, ptr %i.bq, align 1, !tbaa !40, !noalias !431
  %i.bs = icmp eq i8 %i.br, 0
  br i1 %i.bs, label %22, label %bb.ac

22:                                               ; preds = %bb.ab, %bb.aa
  store ptr null, ptr %i.bm, align 8, !tbaa !29, !noalias !431
  br label %config_get_env_dup.exit91.thread.i
...
config_get_env_dup.exit91.thread.i:               ; preds = %config_get_env_dup.exit91.i, %22, %21, %config_get_env_dup.exit.thread.i
  %i.ca = getelementptr i8, ptr %1, i64 312       ; 5 uses
...
bb.ah:                                            ; preds = %config_get_env_dup.exit91.thread.i
  ...
  br i1 %.not.i92.i, label %23, label %bb.ai

23:                                               ; preds = %bb.ah
  store ptr null, ptr %i.ca, align 8, !tbaa !29, !noalias !437
  br label %config_get_env_dup.exit98.thread.i

bb.ai:                                            ; preds = %bb.ah
  %i.ce = call ptr @getenv(ptr noundef nonnull @.str.180) #29, !noalias !437 ; 3 uses
  %.not10.i93.i = icmp eq ptr %i.ce, null
  br i1 %.not10.i93.i, label %24, label %bb.aj

bb.aj:                                            ; preds = %bb.ai
  %i.cf = load i8, ptr %i.ce, align 1, !tbaa !40, !noalias !437
  %i.cg = icmp eq i8 %i.cf, 0
  br i1 %i.cg, label %24, label %bb.ak

24:                                               ; preds = %bb.aj, %bb.ai
  store ptr null, ptr %i.ca, align 8, !tbaa !29, !noalias !437
  br label %config_get_env_dup.exit98.thread.i
...
config_get_env_dup.exit98.thread.i:               ; preds = %config_get_env_dup.exit98.i, %24, %23, %config_get_env_dup.exit91.thread.i
