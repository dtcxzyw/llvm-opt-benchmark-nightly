...
begin_hunk_0_@_PyConfig_Read:bb.a
  ...
  %.sroa.069.2.i591 = phi i64 [ %i.lc, %.lr.ph.i.i ], [ 0, %.lr.ph.i.i.preheader.preheader ] ; 6 uses
...
config_init_env_warnoptions.exit.i.thread169.loopexitsplit: ; preds = %.lr.ph.i.i
  ...
  %.sroa.1073.2.i537.ph.ph = phi ptr [ %i.kz, %.lr.ph.i.i ]
...
.lr.ph.i.i.preheader.config_init_env_warnoptions.exit.i.thread169.loopexit_crit_edge: ; preds = %.lr.ph.i.i.preheader
  %.sroa.069.2.i591.lcssa = phi i64 [ %.sroa.069.2.i591, %.lr.ph.i.i.preheader ]
  %.sroa.069.2.i591.lcssa.a = phi i64 [ %.sroa.069.2.i591, %.lr.ph.i.i.preheader ] ; 0 uses
  %split846 = phi ptr [ %.sroa.1073.2.i592, %.lr.ph.i.i.preheader ]
  br label %config_init_env_warnoptions.exit.i.thread169.loopexit
...
config_init_env_warnoptions.exit.i.thread169.loopexit: ; preds = %config_init_env_warnoptions.exit.i.thread169.loopexitsplit, %.lr.ph.i.i.preheader.config_init_env_warnoptions.exit.i.thread169.loopexit_crit_edge
  %.sroa.069.2.i540.ph = phi i64 [ %.sroa.069.2.i591.lcssa, %.lr.ph.i.i.preheader.config_init_env_warnoptions.exit.i.thread169.loopexit_crit_edge ], [ %.lcssa848, %config_init_env_warnoptions.exit.i.thread169.loopexitsplit ]
  %.sroa.1073.2.i537.ph = phi ptr [ %split846, %.lr.ph.i.i.preheader.config_init_env_warnoptions.exit.i.thread169.loopexit_crit_edge ], [ %.sroa.1073.2.i537.ph.ph, %config_init_env_warnoptions.exit.i.thread169.loopexitsplit ]
...
bb.g:                                             ; preds = %bb.f
  %.lcssa50 = phi ptr [ %i.r, %bb.f ]
  %.032.lcssa48 = phi i64 [ %.032, %bb.f ]
...
bb.f:                                             ; preds = %.lr.ph.i
  %.01737.i.lcssa31 = phi i64 [ %.01737.i, %.lr.ph.i ]
...
begin_hunk_5_@PyInitConfig_SetStrList:bb.a
  ...
  %exitcond40.not.i = icmp eq i64 %.01737.i.lcssa31, %i.q
