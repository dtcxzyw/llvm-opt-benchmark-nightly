...
begin_hunk_0_@_io_TextIOWrapper_reconfigure:bb.a
  ...
  %.not108 = icmp ne ptr %.143, @_Py_NoneStruct   ; 6 uses
...
bb.p:                                             ; preds = %bb.n, %bb.m
  %.not109 = icmp ne ptr %.141, @_Py_NoneStruct   ; 6 uses
...
.thread77.i:                                      ; preds = %bb.ab, %bb.aa, %bb.z, %bb.y, %.thread.i
  ...
  %i.bp = phi i1 [ %i.au, %.thread.i ], [ %.not108, %bb.y ], [ %.not108, %bb.ab ], [ %.not108, %bb.aa ], [ %.not108, %bb.z ] ; 2 uses
  ...
  %i.bq = phi i1 [ %i.av, %.thread.i ], [ %.not109, %bb.y ], [ %.not109, %bb.ab ], [ %.not109, %bb.aa ], [ %.not109, %bb.z ] ; 3 uses
...
bb.ak:                                            ; preds = %bb.ai
  %or.cond3.i.i = or i1 %i.bp, %i.bq
  br i1 %or.cond3.i.i, label %.thread85.i, label %textiowrapper_change_encoding.exit.thread88.i
