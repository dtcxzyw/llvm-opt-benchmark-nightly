...
begin_hunk_0_@KeepRef:bb.a
  ...
  br i1 %.not15.i.i, label %unique_key.exit.i, label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.r
  %i.af = phi ptr [ %i.ar, %bb.r ], [ %i.ad, %bb.p ]
  %.01117.i.i = phi ptr [ %i.ap, %bb.r ], [ %i.ac, %bb.p ] ; 3 uses
  %.01216.i.i = phi ptr [ %i.aq, %bb.r ], [ %0, %bb.p ]
  %i.ag = ptrtoint ptr %.01117.i.i to i64
  %i.ah = sub i64 %.pre.i.i, %i.ag
  %3 = add i64 %i.ah, 255
  %i.ai = icmp ult i64 %3, 16
