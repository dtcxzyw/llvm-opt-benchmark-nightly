...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %bb.b
  %.078.i = phi i64 [ %i.h, %bb.b ], [ 0, %.lr.ph.i.preheader ] ; 4 uses
...
_ctypes_PyCArrayType_Type_value_get_impl.exit.loopexitsplit: ; preds = %bb.b
  %.07.lcssa.i.ph.ph = phi i64 [ %i.d, %bb.b ]
...
.lr.ph.i._ctypes_PyCArrayType_Type_value_get_impl.exit.loopexit_crit_edge: ; preds = %.lr.ph.i
  %.078.i.lcssa = phi i64 [ %.078.i, %.lr.ph.i ]
  %.078.i.lcssa.a = phi i64 [ %.078.i, %.lr.ph.i ] ; 0 uses
  br label %_ctypes_PyCArrayType_Type_value_get_impl.exit.loopexit
...
_ctypes_PyCArrayType_Type_value_get_impl.exit.loopexit: ; preds = %_ctypes_PyCArrayType_Type_value_get_impl.exit.loopexitsplit, %.lr.ph.i._ctypes_PyCArrayType_Type_value_get_impl.exit.loopexit_crit_edge
  %.07.lcssa.i.ph = phi i64 [ %.078.i.lcssa, %.lr.ph.i._ctypes_PyCArrayType_Type_value_get_impl.exit.loopexit_crit_edge ], [ %.07.lcssa.i.ph.ph, %_ctypes_PyCArrayType_Type_value_get_impl.exit.loopexitsplit ]
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %bb.b
  %.089.i = phi i64 [ %i.j, %bb.b ], [ 0, %.lr.ph.i.preheader ] ; 4 uses
  %i.g = shl i64 %.089.i, 2
...
WCharArray_get_value_lock_held.exit.loopexitsplit: ; preds = %bb.b
  %.08.lcssa.i.ph.ph = phi i64 [ %i.e, %bb.b ]
...
.lr.ph.i.WCharArray_get_value_lock_held.exit.loopexit_crit_edge: ; preds = %.lr.ph.i
  %.089.i.lcssa = phi i64 [ %.089.i, %.lr.ph.i ]
  %.089.i.lcssa.a = phi i64 [ %.089.i, %.lr.ph.i ] ; 0 uses
  br label %WCharArray_get_value_lock_held.exit.loopexit
...
WCharArray_get_value_lock_held.exit.loopexit:     ; preds = %WCharArray_get_value_lock_held.exit.loopexitsplit, %.lr.ph.i.WCharArray_get_value_lock_held.exit.loopexit_crit_edge
  %.08.lcssa.i.ph = phi i64 [ %.089.i.lcssa, %.lr.ph.i.WCharArray_get_value_lock_held.exit.loopexit_crit_edge ], [ %.08.lcssa.i.ph.ph, %WCharArray_get_value_lock_held.exit.loopexitsplit ]
...
bb.j:                                             ; preds = %.lr.ph, %_check_outarg_type.exit.thread
  %.02450 = phi i64 [ 0, %.lr.ph ], [ %i.bp, %_check_outarg_type.exit.thread ] ; 8 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.an = load ptr, ptr %scevgep98, align 8, !tbaa !32 ; 7 uses
  %i.ao = load ptr, ptr %i.y, align 8, !tbaa !63  ; 2 uses
  %i.ap = getelementptr i8, ptr %i.an, i64 8      ; 6 uses
...
_check_outarg_type.exitsplit:                     ; preds = %bb.s, %PyStgInfo_FromType.exit.i, %bb.r
  ...
  %.lcssa91.ph = phi ptr [ %i.an, %bb.s ], [ %i.an, %PyStgInfo_FromType.exit.i ], [ %i.an, %bb.r ]
  %.lcssa.ph = phi ptr [ %i.ap, %bb.s ], [ %i.ap, %PyStgInfo_FromType.exit.i ], [ %i.ap, %bb.r ]
  br label %_check_outarg_type.exit

._check_outarg_type.exit_crit_edge:               ; preds = %bb.q
  %.02450.lcssa101 = phi i64 [ %.02450, %bb.q ]
  %.02450.lcssa100 = phi i64 [ %.02450, %bb.q ]   ; 0 uses
  %split98 = phi ptr [ %i.an, %bb.q ]
  %split99 = phi ptr [ %i.ap, %bb.q ]
  br label %_check_outarg_type.exit

_check_outarg_type.exit:                          ; preds = %_check_outarg_type.exitsplit, %._check_outarg_type.exit_crit_edge
  %.02450.lcssa93 = phi i64 [ %.02450.lcssa101, %._check_outarg_type.exit_crit_edge ], [ %.02450.lcssa101.a, %_check_outarg_type.exitsplit ]
  %.lcssa91 = phi ptr [ %split98, %._check_outarg_type.exit_crit_edge ], [ %.lcssa91.ph, %_check_outarg_type.exitsplit ]
  %.lcssa = phi ptr [ %split99, %._check_outarg_type.exit_crit_edge ], [ %.lcssa.ph, %_check_outarg_type.exitsplit ]
