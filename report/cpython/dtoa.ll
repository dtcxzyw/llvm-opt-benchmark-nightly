...
begin_hunk_1_@_Py_dg_strtod:bb.a
  ...
  %exitcond.not = icmp eq i32 %.04541391, %i.db
...
.lr.ph97:                                         ; preds = %.lr.ph97.preheader, %bb.v
  ...
  %.07195 = phi i32 [ %i.du, %bb.v ], [ %i.an, %.lr.ph97.preheader ] ; 3 uses
...
.lr.ph97..critedge.loopexit_crit_edge:            ; preds = %.lr.ph97
  %.07195.lcssa.a = phi i32 [ %.07195, %.lr.ph97 ]
  br label %.critedge.loopexit

.critedge.loopexit:                               ; preds = %.critedge.loopexitsplit, %.lr.ph97..critedge.loopexit_crit_edge
  %.071.lcssa.ph = phi i32 [ %.07195.lcssa.a, %.lr.ph97..critedge.loopexit_crit_edge ], [ 0, %.critedge.loopexitsplit ]
  br label %.critedge
