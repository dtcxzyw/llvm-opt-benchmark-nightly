...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.ci = shl i64 %n.vec, 2                       ; 2 uses
  %i.cj = getelementptr i8, ptr %i.b, i64 %i.ci
  %i.ck = getelementptr i8, ptr %.046.lcssa, i64 %i.ci
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.cl = shl i64 %index, 2                       ; 2 uses
  %next.gep = getelementptr i8, ptr %i.b, i64 %i.cl ; 2 uses
  %next.gep92 = getelementptr i8, ptr %.046.lcssa, i64 %i.cl ; 2 uses
  %i.cm = getelementptr i8, ptr %next.gep, i64 16
  %wide.load = load <4 x i32>, ptr %next.gep, align 4, !tbaa !7
  %wide.load93 = load <4 x i32>, ptr %i.cm, align 4, !tbaa !7
  %i.cn = getelementptr i8, ptr %next.gep92, i64 16
  store <4 x i32> %wide.load, ptr %next.gep92, align 4, !tbaa !7
  store <4 x i32> %wide.load93, ptr %i.cn, align 4, !tbaa !7
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.co = icmp eq i64 %index.next, %n.vec
  br i1 %i.co, label %middle.block, label %vector.body, !llvm.loop !144
...
.preheader.preheader95:                           ; preds = %vector.memcheck, %.preheader.preheader, %middle.block
  %.148.ph = phi ptr [ %i.b, %vector.memcheck ], [ %i.b, %.preheader.preheader ], [ %i.cj, %middle.block ]
  %.2.ph = phi ptr [ %.046.lcssa, %vector.memcheck ], [ %.046.lcssa, %.preheader.preheader ], [ %i.ck, %middle.block ]
  br label %.preheader

bb.m:                                             ; preds = %._crit_edge70
  %i.cp = sub nuw nsw i32 32, %i.bx
  br label %bb.n

bb.n:                                             ; preds = %bb.n, %bb.m
  %.047 = phi ptr [ %i.b, %bb.m ], [ %i.cu, %bb.n ] ; 3 uses
  %.1 = phi ptr [ %.046.lcssa, %bb.m ], [ %i.ct, %bb.n ] ; 2 uses
  %.0 = phi i32 [ 0, %bb.m ], [ %i.cw, %bb.n ]
  %i.cq = load i32, ptr %.047, align 4, !tbaa !7
  %i.cr = shl i32 %i.cq, %i.bx
  %i.cs = or i32 %i.cr, %.0
  %i.ct = getelementptr i8, ptr %.1, i64 4        ; 2 uses
  store i32 %i.cs, ptr %.1, align 4, !tbaa !7
  %i.cu = getelementptr i8, ptr %.047, i64 4      ; 2 uses
  %i.cv = load i32, ptr %.047, align 4, !tbaa !7
  %i.cw = lshr i32 %i.cv, %i.cp                   ; 3 uses
  %i.cx = icmp ult ptr %i.cu, %i.bw
  br i1 %i.cx, label %bb.n, label %bb.o, !llvm.loop !147

bb.o:                                             ; preds = %bb.n
  store i32 %i.cw, ptr %i.ct, align 4, !tbaa !7
  %.not58 = icmp eq i32 %i.cw, 0
  %spec.select = select i1 %.not58, i32 %i.k, i32 %i.l
  br label %.loopexit

.preheader:                                       ; preds = %.preheader.preheader95, %.preheader
  %.148 = phi ptr [ %i.cy, %.preheader ], [ %.148.ph, %.preheader.preheader95 ] ; 2 uses
  %.2 = phi ptr [ %i.da, %.preheader ], [ %.2.ph, %.preheader.preheader95 ] ; 2 uses
  %i.cy = getelementptr i8, ptr %.148, i64 4      ; 2 uses
  %i.cz = load i32, ptr %.148, align 4, !tbaa !7
  %i.da = getelementptr i8, ptr %.2, i64 4
  store i32 %i.cz, ptr %.2, align 4, !tbaa !7
  %i.db = icmp ult ptr %i.cy, %i.bw
  br i1 %i.db, label %.preheader, label %.loopexit, !llvm.loop !148
...
.loopexit:                                        ; preds = %.preheader, %middle.block, %bb.o
  ...
  %i.dc = load i32, ptr %i.h, align 8, !tbaa !134 ; 2 uses
...
bb.q:                                             ; preds = %.loopexit
  %i.de = load ptr, ptr %i.s, align 8, !tbaa !39
  %i.df = getelementptr i8, ptr %i.de, i64 11960
  %i.dg = sext i32 %i.dc to i64
  %i.dh = getelementptr [8 x i8], ptr %i.df, i64 %i.dg ; 2 uses
  %i.di = load ptr, ptr %i.dh, align 8, !tbaa !41
  store ptr %i.di, ptr %0, align 8, !tbaa !43
  store ptr %0, ptr %i.dh, align 8, !tbaa !41
  br label %Bfree.exit
