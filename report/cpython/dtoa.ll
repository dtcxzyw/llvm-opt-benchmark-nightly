...
.preheader735.17:                                 ; preds = %.preheader735.16
  ...
  %.not545.17 = icmp ne i8 %i.jx, 48              ; 2 uses
  %spec.select1277 = zext i1 %.not545.17 to i64
...
.preheader734:                                    ; preds = %.preheader735.17, %.preheader735.10, %.preheader735.11, %.preheader735.12, %.preheader735.13, %.preheader735.14, %.preheader735.15, %.preheader735.16
  %.3457.lcssa = phi i64 [ 6, %.preheader735.12 ], [ 8, %.preheader735.10 ], [ 2, %.preheader735.16 ], [ 7, %.preheader735.11 ], [ %spec.select1277, %.preheader735.17 ], [ 3, %.preheader735.15 ], [ 5, %.preheader735.13 ], [ 4, %.preheader735.14 ] ; 3 uses
  %.3457.lcssa.a = phi i32 [ 6, %.preheader735.12 ], [ 8, %.preheader735.10 ], [ 2, %.preheader735.16 ], [ 7, %.preheader735.11 ], [ %spec.select1277.a, %.preheader735.17 ], [ 3, %.preheader735.15 ], [ 5, %.preheader735.13 ], [ 4, %.preheader735.14 ] ; 6 uses
...
.lr.ph896.preheader:                              ; preds = %.preheader
  ...
  %i.km = sub nsw i64 %.3457.lcssa, %i.kl
...
begin_hunk_3_@_Py_dg_strtod:bb.a
  ...
  %i.kt = sub nsw i64 %i.kl, %.3457.lcssa
...
begin_hunk_4_@_Py_dg_strtod:bb.a
  ...
  %exitcond1023.not.3 = icmp eq i64 %indvars.iv.next1020.3, %.3457.lcssa
