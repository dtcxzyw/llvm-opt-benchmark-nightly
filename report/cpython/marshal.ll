...
.lr.ph40.i:                                       ; preds = %bb.u
  ...
  br i1 %.not42.i, label %._crit_edge41.split.i, label %.lr.ph.us.i

._crit_edge41.split.i:                            ; preds = %._crit_edge.i, %.lr.ph40.i, %bb.u
  %4 = load i32, ptr %i.bt, align 4, !tbaa !7
  br label %bb.ah

.lr.ph.us.i:                                      ; preds = %.lr.ph40.i, %._crit_edge.i
  %.03038.us.i = phi i64 [ %5, %._crit_edge.i ], [ 0, %.lr.ph40.i ] ; 2 uses
  %i.ce = getelementptr [4 x i8], ptr %i.bm, i64 %.03038.us.i
  %i.cf = load i32, ptr %i.ce, align 4, !tbaa !7
  br label %bb.v

._crit_edge.i:                                    ; preds = %w_short.exit.us.i
  %5 = add nuw nsw i64 %.03038.us.i, 1            ; 2 uses
  %exitcond43.not.i = icmp eq i64 %5, %i.br
  br i1 %exitcond43.not.i, label %._crit_edge41.split.i, label %.lr.ph.us.i, !llvm.loop !111
...
bb.x:                                             ; preds = %bb.w
  ...
  br i1 %.not.i.i.us.i, label %bb.y, label %w_reserve.exit.i.i
...
w_reserve.exit.i.i:                               ; preds = %bb.x
  ...
  br i1 %12, label %w_reserve.exit.thread.i.us.i, label %bb.ab

bb.ab:                                            ; preds = %w_reserve.exit.i.i, %w_reserve.exit.thread20.i.us.i, %bb.v
  %i.dc = phi ptr [ %i.da, %w_reserve.exit.thread20.i.us.i ], [ %7, %w_reserve.exit.i.i ], [ %i.cg, %bb.v ] ; 2 uses
...
w_reserve.exit.thread.i.us.i:                     ; preds = %bb.ab, %w_reserve.exit.i.i
  %i.df = phi ptr [ %.pre.pre.i.us.i, %bb.ab ], [ %8, %w_reserve.exit.i.i ] ; 3 uses
  %i.dg = phi ptr [ %.pr.pre.i.us.i, %bb.ab ], [ %7, %w_reserve.exit.i.i ] ; 2 uses
...
bb.ac:                                            ; preds = %w_reserve.exit.thread.thread.i.us.i
  ...
  br i1 %.not.i12.i.us.i, label %._crit_edge89, label %w_reserve.exit17.i.i
...
w_reserve.exit17.i.i:                             ; preds = %bb.ac
  %14 = call i64 @fwrite(ptr noundef %.pre45.i.a, i64 noundef 1, i64 noundef %.pre49.i, ptr noundef nonnull %.pre.i) ; 0 uses
  ...
  br i1 %20, label %w_short.exit.us.i, label %bb.ag

bb.ag:                                            ; preds = %w_reserve.exit17.i.i, %w_reserve.exit17.thread25.i.us.i, %w_reserve.exit.thread.i.us.i
  %i.dr = phi ptr [ %i.dp, %w_reserve.exit17.thread25.i.us.i ], [ %15, %w_reserve.exit17.i.i ], [ %i.dg, %w_reserve.exit.thread.i.us.i ] ; 2 uses
...
w_short.exit.us.i:                                ; preds = %bb.ag, %w_reserve.exit17.i.i, %bb.af, %13, %w_reserve.exit.thread.thread.i.us.i, %bb.aa, %bb.w
...
.lr.ph40.i42:                                     ; preds = %bb.al
  ...
  br i1 %.not42.i43, label %._crit_edge41.split.i39, label %.lr.ph.us.i44

._crit_edge41.split.i39:                          ; preds = %._crit_edge.i55, %.lr.ph40.i42, %bb.al
  %21 = load i16, ptr %i.ea, align 2, !tbaa !114
  br label %bb.ay

.lr.ph.us.i44:                                    ; preds = %.lr.ph40.i42, %._crit_edge.i55
  %.03038.us.i45 = phi i64 [ %22, %._crit_edge.i55 ], [ 0, %.lr.ph40.i42 ] ; 2 uses
  %i.el = getelementptr [2 x i8], ptr %i.bm, i64 %.03038.us.i45
  %i.em = load i16, ptr %i.el, align 2, !tbaa !114
  br label %bb.am

._crit_edge.i55:                                  ; preds = %w_short.exit.us.i53
  %22 = add nuw nsw i64 %.03038.us.i45, 1         ; 2 uses
  %exitcond43.not.i56 = icmp eq i64 %22, %i.br
  br i1 %exitcond43.not.i56, label %._crit_edge41.split.i39, label %.lr.ph.us.i44, !llvm.loop !117
...
bb.ao:                                            ; preds = %bb.an
  ...
  br i1 %.not.i.i.us.i70, label %bb.ap, label %w_reserve.exit.i.i71
...
w_reserve.exit.i.i71:                             ; preds = %bb.ao
  ...
  br i1 %29, label %w_reserve.exit.thread.i.us.i51, label %bb.as

bb.as:                                            ; preds = %w_reserve.exit.i.i71, %w_reserve.exit.thread20.i.us.i75, %bb.am
  %i.fj = phi ptr [ %i.fh, %w_reserve.exit.thread20.i.us.i75 ], [ %24, %w_reserve.exit.i.i71 ], [ %i.en, %bb.am ] ; 2 uses
...
w_reserve.exit.thread.i.us.i51:                   ; preds = %bb.as, %w_reserve.exit.i.i71
  %i.fm = phi ptr [ %.pre.pre.i.us.i50, %bb.as ], [ %25, %w_reserve.exit.i.i71 ] ; 3 uses
  %i.fn = phi ptr [ %.pr.pre.i.us.i49, %bb.as ], [ %24, %w_reserve.exit.i.i71 ] ; 2 uses
...
bb.at:                                            ; preds = %w_reserve.exit.thread.thread.i.us.i57
  ...
  br i1 %.not.i12.i.us.i63, label %._crit_edge, label %w_reserve.exit17.i.i64
...
w_reserve.exit17.i.i64:                           ; preds = %bb.at
  %31 = call i64 @fwrite(ptr noundef %.pre45.i59, i64 noundef 1, i64 noundef %.pre49.i62, ptr noundef nonnull %.pre.i58) ; 0 uses
  ...
  br i1 %37, label %w_short.exit.us.i53, label %bb.ax

bb.ax:                                            ; preds = %w_reserve.exit17.i.i64, %w_reserve.exit17.thread25.i.us.i69, %w_reserve.exit.thread.i.us.i51
  %i.fy = phi ptr [ %i.fw, %w_reserve.exit17.thread25.i.us.i69 ], [ %32, %w_reserve.exit17.i.i64 ], [ %i.fn, %w_reserve.exit.thread.i.us.i51 ] ; 2 uses
...
w_short.exit.us.i53:                              ; preds = %bb.ax, %w_reserve.exit17.i.i64, %bb.aw, %30, %w_reserve.exit.thread.thread.i.us.i57, %bb.ar, %bb.an
