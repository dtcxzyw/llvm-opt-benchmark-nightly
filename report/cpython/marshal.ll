...
bb.v:                                             ; preds = %w_short.exit.i, %.lr.ph.i
  ...
  %.136.i = phi i32 [ %i.cf, %.lr.ph.i ], [ %i.dw, %w_short.exit.i ] ; 3 uses
...
bb.y:                                             ; preds = %bb.x
  ...
  %.val.i.i.i = load i64, ptr %i.cp, align 8, !tbaa !23 ; 6 uses
...
bb.ac:                                            ; preds = %w_reserve.exit.thread.thread.i.i
  ...
  %.pre44.i = load ptr, ptr %i.cb, align 8, !tbaa !18 ; 2 uses
  %.pre45.i = ptrtoint ptr %i.df to i64
...
._crit_edge89:                                    ; preds = %bb.ac
  ...
  %.val.i14.i.i.pre = load i64, ptr %.phi.trans.insert91, align 8, !tbaa !23 ; 4 uses
...
bb.ad:                                            ; preds = %._crit_edge89, %.thread.i
  ...
  %i.di = icmp sgt i64 %.val.i14.i.i, 16777216
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %.not38.i16.i.i = icmp eq i32 %i.dm, 0
  br i1 %.not38.i16.i.i, label %w_reserve.exit17.thread25.i.i, label %bb.af

bb.af:                                            ; preds = %bb.ae
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.a, i8 0, i64 24, i1 false)
  br label %w_short.exit.i

w_reserve.exit17.thread25.i.i:                    ; preds = %bb.ae
  ...
  %i.dp = getelementptr i8, ptr %i.do, i64 %.pre-phi4963.i
...
bb.am:                                            ; preds = %w_short.exit.i53, %.lr.ph.i44
  ...
  %.136.i47 = phi i16 [ %i.em, %.lr.ph.i44 ], [ %i.gd, %w_short.exit.i53 ] ; 3 uses
  %i.en = load ptr, ptr %i.a, align 8, !tbaa !19  ; 4 uses
  %i.eo = load ptr, ptr %i.c, align 8, !tbaa !20
  %.not.i.i48 = icmp eq ptr %i.en, %i.eo
  br i1 %.not.i.i48, label %bb.an, label %bb.as

bb.an:                                            ; preds = %bb.am
  %i.ep = icmp eq ptr %i.en, null
  br i1 %i.ep, label %w_short.exit.i53, label %bb.ao

bb.ao:                                            ; preds = %bb.an
  %i.eq = load ptr, ptr %2, align 8, !tbaa !11    ; 2 uses
  %.not.i.i.i70 = icmp eq ptr %i.eq, null
...
bb.ap:                                            ; preds = %bb.ao
  ...
  %.val.i.i.i72 = load i64, ptr %i.ew, align 8, !tbaa !23 ; 6 uses
  %i.ex = icmp sgt i64 %.val.i.i.i72, 16777216
  %i.ey = lshr i64 %.val.i.i.i72, 3               ; 2 uses
  %i.ez = add nsw i64 %.val.i.i.i72, 1024         ; 2 uses
  %.0.i.i.i73 = select i1 %i.ex, i64 %i.ey, i64 %i.ez
  %i.fa = call i64 @llvm.smax.i64(i64 %.0.i.i.i73, i64 1) ; 2 uses
...
bb.aq:                                            ; preds = %bb.ap
  ...
  %.not38.i.i.i74 = icmp eq i32 %i.fe, 0
  br i1 %.not38.i.i.i74, label %w_reserve.exit.thread20.i.i75, label %bb.ar

bb.ar:                                            ; preds = %bb.aq
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.a, i8 0, i64 24, i1 false)
  br label %w_short.exit.i53

w_reserve.exit.thread20.i.i75:                    ; preds = %bb.aq
...
bb.at:                                            ; preds = %w_reserve.exit.thread.thread.i.i57
  ...
  %.pre44.i59 = load ptr, ptr %i.ei, align 8, !tbaa !18 ; 2 uses
  %.pre45.i60 = ptrtoint ptr %i.fm to i64
...
._crit_edge:                                      ; preds = %bb.at
  ...
  %.val.i14.i.i66.pre = load i64, ptr %.phi.trans.insert, align 8, !tbaa !23 ; 4 uses
...
bb.au:                                            ; preds = %._crit_edge, %.thread.i76
  ...
  %.pre-phi4963.i65 = phi i64 [ %.pre48.i62, %._crit_edge ], [ %i.eu, %.thread.i76 ]
  %i.fp = icmp sgt i64 %.val.i14.i.i66, 16777216
...
bb.av:                                            ; preds = %bb.au
  ...
  %.not38.i16.i.i68 = icmp eq i32 %i.ft, 0
  br i1 %.not38.i16.i.i68, label %w_reserve.exit17.thread25.i.i69, label %bb.aw

bb.aw:                                            ; preds = %bb.av
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.a, i8 0, i64 24, i1 false)
  br label %w_short.exit.i53

w_reserve.exit17.thread25.i.i69:                  ; preds = %bb.av
  ...
  %i.fw = getelementptr i8, ptr %i.fv, i64 %.pre-phi4963.i65
