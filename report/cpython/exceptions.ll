...
bb.h:                                             ; preds = %bb.a, %PyTuple_GET_SIZE.exit
  %i.i = phi i64 [ %4, %PyTuple_GET_SIZE.exit ], [ 0, %bb.a ]
...
bb.k:                                             ; preds = %.thread
  ...
  br i1 %i.w, label %bb.x, label %bb.l
...
bb.r:                                             ; preds = %bb.p
  ...
  br i1 %i.ag, label %.thread74, label %bb.s
...
.thread77:                                        ; preds = %bb.u, %bb.o
  %.147 = phi i64 [ %i.k, %bb.o ], [ %i.ak, %bb.u ]
  %.043 = phi ptr [ null, %bb.o ], [ %i.af, %bb.u ] ; 2 uses
...
bb.w:                                             ; preds = %bb.u, %.thread77, %bb.n, %bb.v
  %.144 = phi ptr [ %.043, %bb.v ], [ %.043, %.thread77 ], [ null, %bb.n ], [ %i.af, %bb.u ]
  %.1 = phi ptr [ %i.am, %bb.v ], [ %i.am, %.thread77 ], [ null, %bb.n ], [ null, %bb.u ]
  %.041 = phi ptr [ %i.ao, %bb.v ], [ null, %.thread77 ], [ null, %bb.n ], [ null, %bb.u ]
...
bb.x:                                             ; preds = %.thread74, %bb.j, %bb.m, %bb.q, %bb.w, %bb.i, %bb.k
  %.048 = phi ptr [ null, %bb.k ], [ null, %bb.m ], [ %i.ap, %bb.w ], [ null, %.thread74 ], [ null, %bb.q ], [ null, %bb.j ], [ null, %bb.i ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #8
  ret ptr %.048
}
