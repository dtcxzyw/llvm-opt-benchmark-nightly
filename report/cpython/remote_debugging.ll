...
begin_hunk_1
  ...
  %i.o = tail call ptr @_PyInterpreterState_GetConfig(ptr noundef %i.n) #9
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void @PyErr_SetString(ptr noundef %i.r, ptr noundef nonnull @.str) #9
  br label %bb.cd
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.t = tail call i32 @getpagesize() #10
...
init_proc_handle.exit:                            ; preds = %bb.d
  ...
  %i.aj = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %i.b, ptr noundef nonnull dereferenceable(1) @.str.12, i32 noundef %0) #9 ; 0 uses
...
bb.e:                                             ; preds = %init_proc_handle.exit
  ...
  %i.an = tail call ptr @__errno_location() #10
  %i.ao = load i32, ptr %i.an, align 4, !tbaa !7
  %i.ap = tail call ptr @strerror(i32 noundef %i.ao) #9
  %i.aq = call ptr (ptr, ptr, ...) @PyErr_Format(ptr noundef %i.am, ptr noundef nonnull @.str.14, ptr noundef nonnull %i.b, i32 noundef %0, ptr noundef %i.ap) #9 ; 0 uses
  br label %search_linux_map_for_section.exit.thread.i.i.i.i

bb.f:                                             ; preds = %init_proc_handle.exit
  %i.ar = tail call ptr @PyMem_Malloc(i64 noundef 4096) #9 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.av = tail call i32 @PyErr_ExceptionMatches(ptr noundef %i.au) #9
...
_PyErr_Occurred.exit.thread.i.i.i.i.i:            ; preds = %_PyErr_Occurred.exit.i.i.i.i.i, %bb.h
  ...
  %i.bb = call ptr (ptr, ptr, ptr, ...) @_PyErr_Format(ptr noundef nonnull %i.aw, ptr noundef %i.ba, ptr noundef nonnull @.str.15, ptr noundef nonnull %i.b) #9 ; 0 uses
  br label %search_linux_map_for_section.exit.thread.i.i.i.i

bb.i:                                             ; preds = %_PyErr_Occurred.exit.i.i.i.i.i
  %i.bc = load ptr, ptr @PyExc_MemoryError, align 8, !tbaa !33
  %i.bd = call ptr (ptr, ptr, ...) @_PyErr_FormatFromCause(ptr noundef %i.bc, ptr noundef nonnull @.str.15, ptr noundef nonnull %i.b) #9 ; 0 uses
  br label %search_linux_map_for_section.exit.thread.i.i.i.i

bb.j:                                             ; preds = %select.unfold.i.i.i.i.i, %.lr.ph.i.i.i.i.i
  %i.be = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %.065.ph.i.i.i.i.i) #11 ; 2 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.bj = call ptr @PyMem_Realloc(ptr noundef nonnull %.065.ph.i.i.i.i.i, i64 noundef %i.bi) #9 ; 2 uses
...
bb.l:                                             ; preds = %bb.k
  call void @PyMem_Free(ptr noundef nonnull %.065.ph.i.i.i.i.i) #9
  %i.bp = call i32 @fclose(ptr noundef nonnull %i.ak) ; 0 uses
  %i.bq = load ptr, ptr @PyExc_PermissionError, align 8, !tbaa !33
  %i.br = call i32 @PyErr_ExceptionMatches(ptr noundef %i.bq) #9
...
_PyErr_Occurred.exit91.thread.i.i.i.i.i:          ; preds = %_PyErr_Occurred.exit91.i.i.i.i.i, %bb.m
  ...
  %i.bx = call ptr (ptr, ptr, ptr, ...) @_PyErr_Format(ptr noundef nonnull %i.bs, ptr noundef %i.bw, ptr noundef nonnull @.str.16, ptr noundef nonnull %i.b, i64 noundef %i.bi) #9 ; 0 uses
  br label %search_linux_map_for_section.exit.thread.i.i.i.i

bb.n:                                             ; preds = %_PyErr_Occurred.exit91.i.i.i.i.i
  %i.by = load ptr, ptr @PyExc_MemoryError, align 8, !tbaa !33
  %i.bz = call ptr (ptr, ptr, ...) @_PyErr_FormatFromCause(ptr noundef %i.by, ptr noundef nonnull @.str.16, ptr noundef nonnull %i.b, i64 noundef %i.bi) #9 ; 0 uses
  br label %search_linux_map_for_section.exit.thread.i.i.i.i
...
bb.o:                                             ; preds = %bb.j
  ...
  %i.ca = call i32 (ptr, ptr, ...) @__isoc23_sscanf(ptr noundef nonnull %.065.ph.i.i.i.i.i, ptr noundef nonnull @.str.17, ptr noundef nonnull %i.c, ptr noundef nonnull %i.d) #9 ; 0 uses
...
bb.q:                                             ; preds = %bb.p
  %i.cf = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %i.cc) #11
...
bb.r:                                             ; preds = %bb.q, %bb.p
  %i.ck = call ptr @strrchr(ptr noundef nonnull dereferenceable(1) %i.cc, i32 noundef 47) #11 ; 2 uses
  ...
  %i.cm = call ptr @strstr(ptr noundef nonnull dereferenceable(1) %.0.i.i.i.i.i, ptr noundef nonnull dereferenceable(1) @.str.10) #11
...
bb.t:                                             ; preds = %bb.s
  %i.cp = call i32 (ptr, i32, ...) @open64(ptr noundef nonnull %i.cc, i32 noundef 0) #9 ; 4 uses
...
.thread10.thread16.i.i.i.i.i.i:                   ; preds = %bb.t
  ...
  %i.cs = tail call ptr @__errno_location() #10
  %i.ct = load i32, ptr %i.cs, align 4, !tbaa !7
  %i.cu = call ptr @strerror(i32 noundef %i.ct) #9
  %i.cv = call ptr (ptr, ptr, ...) @PyErr_Format(ptr noundef %i.cr, ptr noundef nonnull @.str.19, ptr noundef nonnull %i.cc, ptr noundef nonnull @.str.9, ptr noundef %i.cu) #9 ; 0 uses
  br label %search_elf_file_for_section.exit.thread.i.i.i.i.i

bb.u:                                             ; preds = %bb.t
  %i.cw = call i32 @fstat64(i32 noundef %i.cp, ptr noundef nonnull %3) #9
...
.thread10.thread.i.i.i.i.i.i:                     ; preds = %bb.u
  ...
  %i.cy = tail call ptr @__errno_location() #10
  %i.cz = load i32, ptr %i.cy, align 4, !tbaa !7
  %i.da = call ptr @strerror(i32 noundef %i.cz) #9
  %i.db = call ptr (ptr, ptr, ...) @PyErr_Format(ptr noundef %i.cx, ptr noundef nonnull @.str.20, ptr noundef nonnull %i.cc, ptr noundef nonnull @.str.9, ptr noundef %i.da) #9 ; 0 uses
  br label %.thread10.i.i.i.i.i.i

bb.v:                                             ; preds = %bb.u
  %i.dc = load i64, ptr %i.as, align 8, !tbaa !52 ; 3 uses
  %i.dd = call ptr @mmap64(ptr noundef null, i64 noundef %i.dc, i32 noundef 1, i32 noundef 2, i32 noundef %i.cp, i64 noundef 0) #9 ; 11 uses
...
bb.w:                                             ; preds = %bb.v
  ...
  %i.dg = tail call ptr @__errno_location() #10
  %i.dh = load i32, ptr %i.dg, align 4, !tbaa !7
  %i.di = call ptr @strerror(i32 noundef %i.dh) #9
  %i.dj = call ptr (ptr, ptr, ...) @PyErr_Format(ptr noundef %i.df, ptr noundef nonnull @.str.21, ptr noundef nonnull %i.cc, i64 noundef %i.dc, ptr noundef nonnull @.str.9, ptr noundef %i.di) #9 ; 0 uses
...
begin_hunk_12
  ...
  %i.eb = call i32 @strcmp(ptr noundef nonnull dereferenceable(10) @.str.9, ptr noundef nonnull dereferenceable(1) %i.ea) #11
...
.thread.i.i.i.i.i.i:                              ; preds = %bb.ac, %bb.ab
  ...
  %i.em = call ptr (ptr, ptr, ...) @PyErr_Format(ptr noundef %i.el, ptr noundef nonnull @.str.23, ptr noundef nonnull %i.cc, i32 noundef %i.eh) #9 ; 0 uses
  br label %.thread2.i.i.i.i.i.i
...
begin_hunk_14
  ...
  %i.ez = call ptr (ptr, ptr, ...) @PyErr_Format(ptr noundef %i.ey, ptr noundef nonnull @.str.22, ptr noundef nonnull %i.cc, i32 noundef %i.ex, i32 noundef %i.ew) #9 ; 0 uses
...
_Py_RemoteDebug_ValidatePyRuntimeCookie.exit.i.i.i.i.i: ; preds = %bb.ag
  %6 = load i64, ptr %i.a, align 1
  %7 = icmp ne i64 %6, 8750607829840520312
  %8 = zext i1 %7 to i32
  %.not15.i.i.i.i.i = icmp eq i32 %8, 0
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #9
...
bb.ah:                                            ; preds = %.loopexit.i.i.i.i.i
  ...
  %i.fl = tail call ptr @__errno_location() #10
  %i.fm = load i32, ptr %i.fl, align 4, !tbaa !7
  %i.fn = call ptr @strerror(i32 noundef %i.fm) #9
  %i.fo = call ptr (ptr, ptr, ...) @PyErr_Format(ptr noundef %i.fk, ptr noundef nonnull @.str.18, ptr noundef nonnull %i.b, ptr noundef %i.fn) #9 ; 0 uses
  br label %search_linux_map_for_section.exit.thread.i.i.i.i
...
bb.ai:                                            ; preds = %search_linux_map_for_section.exit.i.i.i.i, %search_linux_map_for_section.exit.thread.i.i.i.i
  %i.fq = call ptr @PyErr_GetRaisedException() #9
  %i.fr = load ptr, ptr @PyExc_RuntimeError, align 8, !tbaa !33
  %i.fs = load i32, ptr %5, align 8, !tbaa !34    ; 2 uses
  %i.ft = call ptr (ptr, ptr, ...) @PyErr_Format(ptr noundef %i.fr, ptr noundef nonnull @.str.11, i32 noundef %i.fs) #9 ; 0 uses
  call void @_PyErr_ChainExceptions1(ptr noundef %i.fq) #9
  %i.fu = call ptr @PyErr_Occurred() #9
...
bb.aj:                                            ; preds = %bb.ai
  ...
  %i.fw = call ptr (ptr, ptr, ...) @PyErr_Format(ptr noundef %i.fv, ptr noundef nonnull @.str.6, i32 noundef %i.fs) #9 ; 0 uses
  br label %bb.ak

bb.ak:                                            ; preds = %bb.aj, %bb.ai
  %i.fx = load ptr, ptr @PyExc_PermissionError, align 8, !tbaa !33
  %i.fy = call i32 @PyErr_ExceptionMatches(ptr noundef %i.fx) #9
...
_PyErr_Occurred.exit.thread.i.i.i:                ; preds = %_PyErr_Occurred.exit.i.i.i, %bb.al
  ...
  %i.ge = call ptr (ptr, ptr, ptr, ...) @_PyErr_Format(ptr noundef nonnull %i.fz, ptr noundef %i.gd, ptr noundef nonnull @.str.7) #9 ; 0 uses
...
bb.am:                                            ; preds = %_PyErr_Occurred.exit.i.i.i
  ...
  %i.gg = call ptr (ptr, ptr, ...) @_PyErr_FormatFromCause(ptr noundef %i.gf, ptr noundef nonnull @.str.7) #9 ; 0 uses
  br label %send_exec_to_proc_handle.exit
...
bb.ao:                                            ; preds = %bb.an
  ...
  %i.gj = call i32 @PyErr_ExceptionMatches(ptr noundef %i.gi) #9
...
_PyErr_Occurred.exit22.thread.i.i.i:              ; preds = %_PyErr_Occurred.exit22.i.i.i, %bb.ap
  ...
  %i.gp = call ptr (ptr, ptr, ptr, ...) @_PyErr_Format(ptr noundef nonnull %i.gk, ptr noundef %i.go, ptr noundef nonnull @.str.8) #9 ; 0 uses
  br label %send_exec_to_proc_handle.exit

bb.aq:                                            ; preds = %_PyErr_Occurred.exit22.i.i.i
  %i.gq = load ptr, ptr @PyExc_RuntimeError, align 8, !tbaa !33
  %i.gr = call ptr (ptr, ptr, ...) @_PyErr_FormatFromCause(ptr noundef %i.gq, ptr noundef nonnull @.str.8) #9 ; 0 uses
  br label %send_exec_to_proc_handle.exit
...
bb.ar:                                            ; preds = %_Py_RemoteDebug_ReadDebugOffsets.exit.i.i
  ...
  call void @PyErr_SetString(ptr noundef %i.gs, ptr noundef nonnull @.str.30) #9
  br label %send_exec_to_proc_handle.exit
...
bb.au:                                            ; preds = %bb.at
  ...
  call void @PyErr_SetString(ptr noundef %i.gv, ptr noundef nonnull @.str.31) #9
  br label %send_exec_to_proc_handle.exit
...
bb.aw:                                            ; preds = %bb.av
  ...
  call void @PyErr_SetString(ptr noundef %i.gx, ptr noundef nonnull @.str.32) #9
  br label %send_exec_to_proc_handle.exit
...
bb.ax:                                            ; preds = %.thread.i.i.i
  ...
  %i.hg = call ptr (ptr, ptr, ...) @PyErr_Format(ptr noundef %i.hf, ptr noundef nonnull @.str.33, i32 noundef 3, i32 noundef 15, i32 noundef %i.ha, i32 noundef %i.hc) #9 ; 0 uses
  br label %send_exec_to_proc_handle.exit
...
bb.az:                                            ; preds = %bb.ay
  ...
  call void @PyErr_SetString(ptr noundef %i.hj, ptr noundef nonnull @.str.34) #9
  br label %send_exec_to_proc_handle.exit
...
bb.bb:                                            ; preds = %bb.ba
  ...
  call void @PyErr_SetString(ptr noundef %i.hq, ptr noundef nonnull @.str.1) #9
  br label %bb.by
...
bb.be:                                            ; preds = %bb.bd
  ...
  call void @PyErr_SetString(ptr noundef %i.hx, ptr noundef nonnull @.str.2) #9
  br label %bb.bx
...
.thread.i:                                        ; preds = %bb.bh, %bb.bl
  ...
  call void @PyErr_SetString(ptr noundef %i.iq, ptr noundef nonnull @.str.3) #9
  br label %.loopexit.i
...
bb.bo:                                            ; preds = %bb.bn
  ...
  call void @PyErr_SetString(ptr noundef %i.ix, ptr noundef nonnull @.str.4) #9
  br label %.loopexit.i
...
bb.bp:                                            ; preds = %bb.bn, %bb.bl
  ...
  %i.jb = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %2) #11 ; 2 uses
  %.not31.i = icmp ugt i64 %i.ja, %i.jb
  br i1 %.not31.i, label %bb.br, label %bb.bq

bb.bq:                                            ; preds = %bb.bp
  %i.jc = load ptr, ptr @PyExc_ValueError, align 8, !tbaa !33
  call void @PyErr_SetString(ptr noundef %i.jc, ptr noundef nonnull @.str.5) #9
  br label %.loopexit.i
...
bb.bz:                                            ; preds = %send_exec_to_proc_handle.exit
  %i.kd = call i32 @close(i32 noundef %i.kc) #9   ; 0 uses
  br label %.preheader
...
bb.cb:                                            ; preds = %bb.ca
  call void @PyMem_RawFree(ptr noundef nonnull %i.kg) #9
  br label %bb.cc
...
begin_hunk_34
  ...
  %i.h = call i64 @pwritev64(i32 noundef %i.g, ptr noundef nonnull %5, i32 noundef 1, i64 noundef %i.f) #9 ; 3 uses
  %i.i = icmp sgt i64 %i.h, -1
  br i1 %i.i, label %bb.e, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.j = load ptr, ptr @PyExc_OSError, align 8, !tbaa !33
  %i.k = call ptr @PyErr_SetFromErrno(ptr noundef %i.j) #9 ; 0 uses
...
begin_hunk_36
  ...
  %i.u = call i64 @process_vm_writev(i32 noundef %i.t, ptr noundef nonnull %6, i64 noundef 1, ptr noundef nonnull %7, i64 noundef 1, i64 noundef 0) #9 ; 3 uses
  %i.v = icmp slt i64 %i.u, 0
  br i1 %i.v, label %bb.h, label %bb.r

bb.h:                                             ; preds = %bb.g
  %i.w = tail call ptr @__errno_location() #10    ; 3 uses
...
begin_hunk_38
  ...
  %i.ai = call i64 @pwritev64(i32 noundef %i.ah, ptr noundef nonnull %4, i32 noundef 1, i64 noundef %i.ag) #9 ; 3 uses
  %i.aj = icmp sgt i64 %i.ai, -1
  br i1 %i.aj, label %bb.n, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.ak = load ptr, ptr @PyExc_OSError, align 8, !tbaa !33
  %i.al = call ptr @PyErr_SetFromErrno(ptr noundef %i.ak) #9 ; 0 uses
...
bb.o:                                             ; preds = %bb.h
  ...
  %i.ap = call ptr @PyErr_SetFromErrno(ptr noundef %i.ao) #9 ; 0 uses
  %i.aq = load ptr, ptr @PyExc_PermissionError, align 8, !tbaa !33
  %i.ar = call i32 @PyErr_ExceptionMatches(ptr noundef %i.aq) #9
...
begin_hunk_40
  ...
  %i.bb = call ptr @strerror(i32 noundef %i.ba) #9
  %i.bc = call ptr (ptr, ptr, ptr, ...) @_PyErr_Format(ptr noundef nonnull %i.at, ptr noundef %i.ax, ptr noundef nonnull @.str.35, i32 noundef %i.ay, i64 noundef %i.az, i64 noundef %i.r, i64 noundef %.036.i, ptr noundef %i.bb) #9 ; 0 uses
  br label %_Py_RemoteDebug_WriteRemoteMemoryFallback.exit46.i
...
begin_hunk_41
  ...
  %i.bh = call ptr @strerror(i32 noundef %i.bg) #9
  %i.bi = call ptr (ptr, ptr, ...) @_PyErr_FormatFromCause(ptr noundef %i.bd, ptr noundef nonnull @.str.35, i32 noundef %i.be, i64 noundef %i.bf, i64 noundef %i.r, i64 noundef %.036.i, ptr noundef %i.bh) #9 ; 0 uses
  br label %_Py_RemoteDebug_WriteRemoteMemoryFallback.exit46.i
...
begin_hunk_44
  ...
  %i.k = call i64 @process_vm_readv(i32 noundef %i.j, ptr noundef nonnull %4, i64 noundef 1, ptr noundef nonnull %5, i64 noundef 1, i64 noundef 0) #9 ; 3 uses
  %i.l = icmp slt i64 %i.k, 0
  br i1 %i.l, label %bb.e, label %bb.k

bb.e:                                             ; preds = %bb.d
  %i.m = tail call ptr @__errno_location() #10    ; 4 uses
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.r = call ptr @PyErr_SetFromErrno(ptr noundef %i.q) #9 ; 0 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.v = call i32 @PyErr_ExceptionMatches(ptr noundef %i.u) #9
...
begin_hunk_46
  ...
  %i.ae = call ptr @strerror(i32 noundef %i.ad) #9
  %i.af = call ptr (ptr, ptr, ptr, ...) @_PyErr_Format(ptr noundef nonnull %i.x, ptr noundef %i.ab, ptr noundef nonnull @.str.26, i32 noundef %i.ac, i64 noundef %i.h, i64 noundef %i.g, i64 noundef %.036, ptr noundef %i.ae) #9 ; 0 uses
  br label %.loopexit
...
bb.j:                                             ; preds = %_PyErr_Occurred.exit
  ...
  %i.aj = call ptr @strerror(i32 noundef %i.ai) #9
  %i.ak = call ptr (ptr, ptr, ...) @_PyErr_FormatFromCause(ptr noundef %i.ag, ptr noundef nonnull @.str.26, i32 noundef %i.ah, i64 noundef %i.h, i64 noundef %i.g, i64 noundef %.036, ptr noundef %i.aj) #9 ; 0 uses
  br label %.loopexit
...
begin_hunk_49
  ...
  %i.k = call i64 @preadv64(i32 noundef %i.j, ptr noundef nonnull %4, i32 noundef 1, i64 noundef %i.i) #9 ; 3 uses
  %i.l = icmp sgt i64 %i.k, -1
  br i1 %i.l, label %bb.h, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.m = load ptr, ptr @PyExc_OSError, align 8, !tbaa !33
  %i.n = call ptr @PyErr_SetFromErrno(ptr noundef %i.m) #9 ; 0 uses
  %i.o = load ptr, ptr @PyExc_PermissionError, align 8, !tbaa !33
  %i.p = call i32 @PyErr_ExceptionMatches(ptr noundef %i.o) #9
...
_PyErr_Occurred.exit.thread:                      ; preds = %bb.f, %_PyErr_Occurred.exit
  ...
  %i.z = call ptr @strerror(i32 noundef %i.y) #9
  %i.aa = call ptr (ptr, ptr, ptr, ...) @_PyErr_Format(ptr noundef nonnull %i.r, ptr noundef %i.v, ptr noundef nonnull @.str.27, i32 noundef %i.w, i64 noundef %i.i, i64 noundef %i.h, i64 noundef %.030, ptr noundef %i.z) #9 ; 0 uses
  br label %.thread
...
bb.g:                                             ; preds = %_PyErr_Occurred.exit
  ...
  %i.af = call ptr @strerror(i32 noundef %i.ae) #9
  %i.ag = call ptr (ptr, ptr, ...) @_PyErr_FormatFromCause(ptr noundef %i.ab, ptr noundef nonnull @.str.27, i32 noundef %i.ac, i64 noundef %i.i, i64 noundef %i.h, i64 noundef %.030, ptr noundef %i.af) #9 ; 0 uses
  br label %.thread
...
bb.a:
  ...
  %i.c = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %i.a, ptr noundef nonnull dereferenceable(1) @.str.28, i32 noundef %i.b) #9 ; 0 uses
  %i.d = call i32 (ptr, i32, ...) @open64(ptr noundef nonnull %i.a, i32 noundef 2) #9 ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.h = tail call ptr @PyErr_SetFromErrno(ptr noundef %i.g) #9 ; 0 uses
  %i.i = load ptr, ptr @PyExc_PermissionError, align 8, !tbaa !33
  %i.j = tail call i32 @PyErr_ExceptionMatches(ptr noundef %i.i) #9
...
_PyErr_Occurred.exit.thread:                      ; preds = %bb.c, %_PyErr_Occurred.exit
  ...
  %i.s = tail call ptr @strerror(i32 noundef %i.r) #9
  %i.t = call ptr (ptr, ptr, ptr, ...) @_PyErr_Format(ptr noundef nonnull %i.l, ptr noundef %i.p, ptr noundef nonnull @.str.29, ptr noundef nonnull %i.a, ptr noundef %i.s) #9 ; 0 uses
  br label %bb.e
...
bb.d:                                             ; preds = %_PyErr_Occurred.exit
  ...
  %i.x = tail call ptr @strerror(i32 noundef %i.w) #9
  %i.y = call ptr (ptr, ptr, ...) @_PyErr_FormatFromCause(ptr noundef %i.u, ptr noundef nonnull @.str.29, ptr noundef nonnull %i.a, ptr noundef %i.x) #9 ; 0 uses
  br label %bb.e
