...
bb.a:
  ...
  %i.d = tail call ptr @PyUnicode_DecodeUTF8(ptr noundef nonnull %1, i64 noundef %i.c, ptr noundef null) #14 ; 14 uses
...
bb.s:                                             ; preds = %Py_DECREF.exit44, %bb.b
  %i.aj = phi ptr [ %i.t, %Py_DECREF.exit44 ], [ %i.d, %bb.b ] ; 6 uses
...
bb.t:                                             ; preds = %bb.s
  %i.al = call i32 @_PyUnicode_EqualToASCIIString(ptr noundef nonnull %i.aj, ptr noundef nonnull @.str.7) #14
  %.not32.1 = icmp eq i32 %i.al, 0
  br i1 %.not32.1, label %bb.u, label %bb.v

bb.u:                                             ; preds = %bb.t
  %i.am = call i32 @_PyUnicode_EqualToASCIIString(ptr noundef nonnull %i.aj, ptr noundef nonnull @.str.8) #14
