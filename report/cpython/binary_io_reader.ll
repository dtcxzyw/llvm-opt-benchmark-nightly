...
.loopexit482:                                     ; preds = %.peel.next
  %i.do = load i32, ptr %.0185423, align 8, !tbaa !27 ; 2 uses
...
bb.aj:                                            ; preds = %.loopexit482
  ...
  store i32 %i.dp, ptr %.0185423, align 8, !tbaa !27
...
bb.ap:                                            ; preds = %bb.al
  ...
  %.not228 = icmp eq i8 %i.ea, %.0190422
  br i1 %.not228, label %bb.av, label %bb.aq

bb.aq:                                            ; preds = %bb.ap
  %i.ed = load ptr, ptr %i.cs, align 8, !tbaa !61
  %i.ee = load i64, ptr %i.ct, align 8, !tbaa !76
  %i.ef = getelementptr i8, ptr %.0185423, i64 16
  %.val.i = load i64, ptr %i.ef, align 8, !tbaa !77
  %i.eg = tail call i32 @PyList_SetSlice(ptr noundef nonnull %.0185423, i64 noundef %.0195421, i64 noundef %.val.i, ptr noundef null) #11
  %i.eh = icmp slt i32 %i.eg, 0
  br i1 %i.eh, label %emit_batch.exit, label %bb.ar

bb.ar:                                            ; preds = %bb.aq
  %i.ei = tail call fastcc i32 @emit_sample(ptr noundef nonnull readonly %i.e, ptr noundef %1, i64 noundef %i.an, i32 noundef %i.ao, i8 noundef zeroext %.0190422, ptr noundef readonly %i.ed, i64 noundef %i.ee, ptr noundef nonnull readonly %0, ptr noundef nonnull %.0185423)
  %i.ej = icmp sgt i32 %i.ei, -1
  br label %emit_batch.exit

emit_batch.exit:                                  ; preds = %bb.aq, %bb.ar
  %.0.i263 = phi i1 [ %i.ej, %bb.ar ], [ false, %bb.aq ]
  %i.ek = load i32, ptr %.0185423, align 8, !tbaa !27 ; 2 uses
...
bb.as:                                            ; preds = %emit_batch.exit
  ...
  store i32 %i.el, ptr %.0185423, align 8, !tbaa !27
...
bb.av:                                            ; preds = %._crit_edge497, %bb.ap
  ...
  %.1191 = phi i8 [ %.0190422, %bb.ap ], [ %i.ea, %._crit_edge497 ] ; 2 uses
  %.1186 = phi ptr [ %.0185423, %bb.ap ], [ %i.eo, %._crit_edge497 ] ; 4 uses
...
bb.ay:                                            ; preds = %bb.av
  ...
  br i1 %exitcond.not, label %.loopexit567, label %.peel.next, !llvm.loop !78

.loopexit567:                                     ; preds = %bb.ay, %bb.ai
...
emit_batch.exit266:                               ; preds = %.loopexit567, %bb.az
  %.0.i265 = phi i1 [ %i.fg, %bb.az ], [ false, %.loopexit567 ]
