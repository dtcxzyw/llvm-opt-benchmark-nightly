...
bb.a:
  %i.a = load i64, ptr %1, align 8, !tbaa !43     ; 13 uses
  %i.b = icmp ult i64 %i.a, %2
  br i1 %i.b, label %bb.b, label %.critedge.preheader.a, !prof !89

bb.b:                                             ; preds = %bb.a
  %i.c = getelementptr i8, ptr %0, i64 %i.a       ; 2 uses
  %i.d = load i8, ptr %i.c, align 1, !tbaa !27
  %i.e = icmp sgt i8 %i.d, -1
  %3 = add nuw i64 %i.a, 1                        ; 4 uses
  br i1 %i.e, label %bb.c, label %.critedge.preheader.thread, !prof !89
...
.critedge.preheader.thread:                       ; preds = %bb.b
...
bb.d:                                             ; preds = %bb.m, %bb.l, %bb.k, %bb.j, %bb.i, %bb.h, %bb.g, %bb.f, %bb.e, %.critedge.preheader.thread
  %.lcssa38 = phi i64 [ %3, %.critedge.preheader.thread ], [ %i.m, %bb.e ], [ %i.u, %bb.f ], [ %i.ac, %bb.g ], [ %i.ak, %bb.h ], [ %i.as, %bb.i ], [ %i.ba, %bb.j ], [ %i.bi, %bb.k ], [ %i.bq, %bb.l ], [ %i.by, %bb.m ]
...
.critedge.1:                                      ; preds = %.critedge.preheader.thread
  %4 = icmp ult i64 %3, %2
  br i1 %4, label %bb.e, label %.critedge.preheader.a

bb.e:                                             ; preds = %.critedge.1
  %i.m = add nuw i64 %i.a, 2                      ; 3 uses
...
.critedge.2:                                      ; preds = %bb.e
  %5 = icmp ult i64 %i.m, %2
  br i1 %5, label %bb.f, label %.critedge.preheader.a

bb.f:                                             ; preds = %.critedge.2
  %i.u = add nuw i64 %i.a, 3                      ; 3 uses
...
.critedge.3:                                      ; preds = %bb.f
  %6 = icmp ult i64 %i.u, %2
  br i1 %6, label %bb.g, label %.critedge.preheader.a

bb.g:                                             ; preds = %.critedge.3
  %i.ac = add nuw i64 %i.a, 4                     ; 3 uses
...
.critedge.4:                                      ; preds = %bb.g
  %7 = icmp ult i64 %i.ac, %2
  br i1 %7, label %bb.h, label %.critedge.preheader.a

bb.h:                                             ; preds = %.critedge.4
  %i.ak = add nuw i64 %i.a, 5                     ; 3 uses
...
.critedge.5:                                      ; preds = %bb.h
  %8 = icmp ult i64 %i.ak, %2
  br i1 %8, label %bb.i, label %.critedge.preheader.a

bb.i:                                             ; preds = %.critedge.5
  %i.as = add nuw i64 %i.a, 6                     ; 3 uses
...
.critedge.6:                                      ; preds = %bb.i
  %9 = icmp ult i64 %i.as, %2
  br i1 %9, label %bb.j, label %.critedge.preheader.a

bb.j:                                             ; preds = %.critedge.6
  %i.ba = add nuw i64 %i.a, 7                     ; 3 uses
...
.critedge.7:                                      ; preds = %bb.j
  %10 = icmp ult i64 %i.ba, %2
  br i1 %10, label %bb.k, label %.critedge.preheader.a

bb.k:                                             ; preds = %.critedge.7
  %i.bi = add nuw i64 %i.a, 8                     ; 3 uses
...
.critedge.8:                                      ; preds = %bb.k
  %11 = icmp ult i64 %i.bi, %2
  br i1 %11, label %bb.l, label %.critedge.preheader.a

bb.l:                                             ; preds = %.critedge.8
  %i.bq = add nuw i64 %i.a, 9                     ; 3 uses
...
.critedge.9:                                      ; preds = %bb.l
  %12 = icmp ult i64 %i.bq, %2
  br i1 %12, label %bb.m, label %.critedge.preheader.a

bb.m:                                             ; preds = %.critedge.9
  %i.by = add nuw i64 %i.a, 10
...
.critedge.preheader.a:                            ; preds = %bb.a, %.critedge.9, %.critedge.8, %.critedge.7, %.critedge.6, %.critedge.5, %.critedge.4, %.critedge.3, %.critedge.2, %.critedge.1
