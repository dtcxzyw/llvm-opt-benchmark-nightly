...
bb.em:                                            ; preds = %bb.ee
  %2 = tail call i32 @_PyLexer_token_setup(ptr noundef nonnull %0, ptr noundef %1, i32 noundef 67, ptr noundef null, ptr noundef null) #8 ; 2 uses
...
.backedge.i.i:                                    ; preds = %bb.dq, %bb.dy, %bb.em, %bb.el, %bb.ek, %bb.ej, %tok_backup.exit376.i.i, %bb.ec, %bb.ea, %bb.dw, %bb.du, %bb.ds, %bb.dp, %bb.cf, %bb.ce
  %.2262629.i.i = phi i32 [ 0, %bb.dy ], [ 0, %tok_backup.exit376.i.i ], [ %i.hw, %bb.ce ], [ 0, %bb.em ], [ 0, %bb.cf ], [ 0, %bb.el ], [ 0, %bb.ek ], [ 0, %bb.ea ], [ 0, %bb.du ], [ 0, %bb.ds ], [ 0, %bb.dp ], [ 0, %bb.dw ], [ 0, %bb.ec ], [ 0, %bb.ej ], [ 0, %bb.dq ] ; 4 uses
  %.5268628.i.i = phi i32 [ %.0263498.i.i, %bb.dy ], [ %.0263498.i.i, %tok_backup.exit376.i.i ], [ %.0263498.i.i, %bb.ce ], [ %.0263498.i.i, %bb.em ], [ %.0263498.i.i, %bb.cf ], [ %.0263498.i.i, %bb.el ], [ 1, %bb.ek ], [ %.0263498.i.i, %bb.ea ], [ %.0263498.i.i, %bb.du ], [ %.0263498.i.i, %bb.ds ], [ %.0263498.i.i, %bb.dp ], [ %.0263498.i.i, %bb.dw ], [ %.0263498.i.i, %bb.ec ], [ %.0263498.i.i, %bb.ej ], [ %.0263498.i.i, %bb.dq ]
...
tok_get.exit:                                     ; preds = %bb.em, %bb.em, %bb.b, %bb.aa, %bb.ab, %bb.az, %bb.bk, %bb.bq, %bb.bt, %tok_backup.exit334.i.i, %bb.cb, %bb.cc, %bb.cj, %bb.db, %bb.dd, %bb.df, %bb.dn, %._crit_edge505.i.i
  %.0.i = phi i32 [ %i.h, %bb.b ], [ %i.ce, %bb.aa ], [ %i.eg, %bb.az ], [ %i.fm, %bb.bk ], [ %i.oa, %._crit_edge505.i.i ], [ %i.cg, %bb.ab ], [ %i.kf, %bb.dd ], [ %i.jz, %bb.db ], [ %i.hq, %bb.cb ], [ %i.ls, %bb.dn ], [ %i.kl, %bb.df ], [ %i.if, %bb.cj ], [ %i.hs, %bb.cc ], [ %i.gx, %tok_backup.exit334.i.i ], [ %i.gi, %bb.bt ], [ %i.fx, %bb.bq ], [ %2, %bb.em ], [ %2, %bb.em ]
