...
tok_backup.exit.i.i:                              ; preds = %bb.n, %bb.v, %bb.r, %bb.p, %bb.m
  %.pre39.i315573.i.i = phi ptr [ %i.ao, %bb.v ], [ %i.bd, %bb.r ], [ %i.ao, %bb.m ], [ %i.av, %bb.p ], [ %i.ao, %bb.n ]
...
.preheader.i.i:                                   ; preds = %.backedge.i.i
  ...
  br i1 %i.eo, label %.lr.ph504.i.i, label %._crit_edge505.i.i
...
tok_nextc.exit373.i.i:                            ; preds = %bb.dx, %tok_nextc.exit365.i.i
  ...
  switch i8 %.0246.in.i.i, label %bb.ek [
    i8 125, label %bb.ed
    i8 123, label %bb.ed
  ]

bb.ed:                                            ; preds = %tok_nextc.exit373.i.i, %tok_nextc.exit373.i.i
  br i1 %i.nh, label %bb.ee, label %bb.eg
...
bb.ee:                                            ; preds = %bb.ed
  ...
  br i1 %.not291.i.i, label %._crit_edge580.i.i, label %bb.ef
...
bb.ef:                                            ; preds = %bb.ee
  %i.nj = tail call i32 @_PyLexer_token_setup(ptr noundef nonnull %0, ptr noundef %1, i32 noundef 67, ptr noundef null, ptr noundef null) #8
  br label %bb.en

bb.eg:                                            ; preds = %._crit_edge580.i.i, %bb.ed
  %i.nk = phi ptr [ %.pre.i.i, %._crit_edge580.i.i ], [ %i.nf, %bb.ed ]
  %i.nl = getelementptr i8, ptr %i.nk, i64 -1     ; 3 uses
  store ptr %i.nl, ptr %i.i, align 8, !tbaa !11
  %i.nm = load ptr, ptr %0, align 8, !tbaa !35
  %i.nn = icmp ult ptr %i.nl, %i.nm
  br i1 %i.nn, label %bb.eh, label %bb.ei
...
bb.ei:                                            ; preds = %bb.eg
  %i.no = load i8, ptr %i.nl, align 1, !tbaa !34
  %.not6.i375.i.i = icmp eq i8 %i.no, %.0246.in.i.i
  br i1 %.not6.i375.i.i, label %tok_backup.exit376.i.i, label %bb.ej

bb.ej:                                            ; preds = %bb.ei
  tail call void @_Py_FatalErrorFunc(ptr noundef nonnull @__func__.tok_backup, ptr noundef nonnull @.str.27) #9
  unreachable

tok_backup.exit376.i.i:                           ; preds = %bb.ei
  %i.np = load i32, ptr %i.o, align 4, !tbaa !28
  %i.nq = add i32 %i.np, -1
  store i32 %i.nq, ptr %i.o, align 4, !tbaa !28
  br label %bb.en, !llvm.loop !48

bb.ek:                                            ; preds = %tok_nextc.exit373.i.i
  %i.nr = icmp eq i8 %.0246.in.i.i, 78
  %or.cond15.i.i = and i1 %i.nr, %i.nh
  br i1 %or.cond15.i.i, label %bb.el, label %bb.en

bb.el:                                            ; preds = %bb.ek
  %i.ns = tail call fastcc i32 @tok_nextc(ptr noundef nonnull %0) ; 2 uses
  %i.nt = icmp eq i32 %i.ns, 123
  br i1 %i.nt, label %.backedge.i.i, label %bb.em

bb.em:                                            ; preds = %bb.el
  tail call fastcc void @tok_backup(ptr noundef nonnull %0, i32 noundef %i.ns)
  br label %.backedge.i.i
...
._crit_edge505.i.i:                               ; preds = %tok_backup.exit379.i.i, %.lr.ph504.i.i, %.preheader.i.i, %bb.ba
  %i.nv = phi ptr [ %i.eh, %bb.ba ], [ %.pre580.i.pre.i, %.lr.ph504.i.i ], [ %.pre580.i.pre.i, %.preheader.i.i ], [ %i.od, %tok_backup.exit379.i.i ]
  %i.nw = load ptr, ptr %i.k, align 8, !tbaa !23
  %i.nx = getelementptr i8, ptr %i.e, i64 96
  %i.ny = load i32, ptr %i.nx, align 8, !tbaa !37
  %i.nz = icmp eq i32 %i.ny, 1
  %i.oa = select i1 %i.nz, i32 63, i32 60
  %i.ob = tail call i32 @_PyLexer_token_setup(ptr noundef nonnull %0, ptr noundef %1, i32 noundef %i.oa, ptr noundef %i.nw, ptr noundef %i.nv) #8
  br label %tok_get.exit

bb.ep:                                            ; preds = %tok_backup.exit379.i.i, %.lr.ph504.split.i.i
  %i.oc = phi ptr [ %.pre580.i.pre.i, %.lr.ph504.split.i.i ], [ %i.od, %tok_backup.exit379.i.i ]
  %.0503.i.i = phi i32 [ 0, %.lr.ph504.split.i.i ], [ %i.oi, %tok_backup.exit379.i.i ]
  %i.od = getelementptr i8, ptr %i.oc, i64 -1     ; 5 uses
  store ptr %i.od, ptr %i.i, align 8, !tbaa !11
  %i.oe = icmp ult ptr %i.od, %i.eq
  br i1 %i.oe, label %bb.eq, label %bb.er
...
bb.er:                                            ; preds = %bb.ep
  %i.of = load i8, ptr %i.od, align 1, !tbaa !34
  %.not6.i378.i.i = icmp eq i8 %i.of, %i.ep
  br i1 %.not6.i378.i.i, label %tok_backup.exit379.i.i, label %bb.es

bb.es:                                            ; preds = %bb.er
  tail call void @_Py_FatalErrorFunc(ptr noundef nonnull @__func__.tok_backup, ptr noundef nonnull @.str.27) #9
  unreachable

tok_backup.exit379.i.i:                           ; preds = %bb.er
  %i.og = load i32, ptr %i.o, align 4, !tbaa !28
  %i.oh = add i32 %i.og, -1
  store i32 %i.oh, ptr %i.o, align 4, !tbaa !28
  %i.oi = add nuw nsw i32 %.0503.i.i, 1           ; 2 uses
  %exitcond.not.i.i = icmp eq i32 %i.oi, %.2262629.i.i
...
bb.et:                                            ; preds = %tok_get.exit
  %i.ol = getelementptr i8, ptr %0, i64 64
  store i32 22, ptr %i.ol, align 8, !tbaa !24
  br label %bb.eu

bb.eu:                                            ; preds = %bb.et, %tok_get.exit
  %.0 = phi i32 [ 67, %bb.et ], [ %.0.i, %tok_get.exit ]
  ret i32 %.0
}
