...
bb.de:                                            ; preds = %bb.cf
  %.not294.i.i = icmp eq i32 %.0263498.i.i, 0
...
bb.en:                                            ; preds = %bb.ek, %tok_backup.exit376.i.i, %bb.ef
  %.5274.i.i = phi i32 [ 6, %tok_backup.exit376.i.i ], [ 1, %bb.ef ], [ 0, %bb.ek ]
  %.5.i.i = phi i32 [ %.2500.i.i, %tok_backup.exit376.i.i ], [ %i.nj, %bb.ef ], [ %.2500.i.i, %bb.ek ] ; 4 uses
...
.backedge.i.i:                                    ; preds = %bb.dq, %bb.dy, %bb.eo, %bb.eo, %bb.en, %bb.em, %bb.el, %bb.ec, %bb.ea, %bb.dw, %bb.du, %bb.ds, %bb.dp, %bb.cf, %bb.ce
  %.8630.i.i = phi i32 [ %.5.i.i, %bb.eo ], [ %.5.i.i, %bb.eo ], [ %.2500.i.i, %bb.ce ], [ %.5.i.i, %bb.en ], [ %.2500.i.i, %bb.cf ], [ %.2500.i.i, %bb.em ], [ %.2500.i.i, %bb.el ], [ %.2500.i.i, %bb.dy ], [ %.2500.i.i, %bb.du ], [ %.2500.i.i, %bb.ds ], [ %.2500.i.i, %bb.dp ], [ %.2500.i.i, %bb.dw ], [ %.2500.i.i, %bb.ec ], [ %.2500.i.i, %bb.ea ], [ %.2500.i.i, %bb.dq ]
  %.2262629.i.i = phi i32 [ 0, %bb.eo ], [ 0, %bb.eo ], [ %i.hw, %bb.ce ], [ 0, %bb.en ], [ 0, %bb.cf ], [ 0, %bb.em ], [ 0, %bb.el ], [ 0, %bb.dy ], [ 0, %bb.du ], [ 0, %bb.ds ], [ 0, %bb.dp ], [ 0, %bb.dw ], [ 0, %bb.ec ], [ 0, %bb.ea ], [ 0, %bb.dq ] ; 4 uses
  %.5268628.i.i = phi i32 [ %.0263498.i.i, %bb.eo ], [ %.0263498.i.i, %bb.eo ], [ %.0263498.i.i, %bb.ce ], [ %.0263498.i.i, %bb.en ], [ %.0263498.i.i, %bb.cf ], [ %.0263498.i.i, %bb.em ], [ 1, %bb.el ], [ %.0263498.i.i, %bb.dy ], [ %.0263498.i.i, %bb.du ], [ %.0263498.i.i, %bb.ds ], [ %.0263498.i.i, %bb.dp ], [ %.0263498.i.i, %bb.dw ], [ %.0263498.i.i, %bb.ec ], [ %.0263498.i.i, %bb.ea ], [ %.0263498.i.i, %bb.dq ]
...
tok_get.exit:                                     ; preds = %bb.eo, %bb.b, %bb.aa, %bb.ab, %bb.az, %bb.bk, %bb.bq, %bb.bt, %tok_backup.exit334.i.i, %bb.cb, %bb.cc, %bb.cj, %bb.db, %bb.dd, %bb.df, %bb.dn, %._crit_edge505.i.i
  %.0.i = phi i32 [ %i.h, %bb.b ], [ %i.ce, %bb.aa ], [ %i.eg, %bb.az ], [ %i.fm, %bb.bk ], [ %i.ob, %._crit_edge505.i.i ], [ %i.cg, %bb.ab ], [ %i.kf, %bb.dd ], [ %i.jz, %bb.db ], [ %i.hq, %bb.cb ], [ %i.ls, %bb.dn ], [ %i.kl, %bb.df ], [ %i.if, %bb.cj ], [ %i.hs, %bb.cc ], [ %i.gx, %tok_backup.exit334.i.i ], [ %i.gi, %bb.bt ], [ %i.fx, %bb.bq ], [ %.5.i.i, %bb.eo ]
...
.outer:                                           ; preds = %bb.n, %bb.b
  %.01081.ph = phi i32 [ %i.av, %bb.n ], [ 0, %bb.b ] ; 5 uses
...
.backedge:                                        ; preds = %tok_nextc.exit, %bb.m, %bb.l
  %.01078.be = phi i32 [ 0, %tok_nextc.exit ], [ %4, %bb.l ], [ %i.au, %bb.m ]
  %.01075.be = phi i32 [ 0, %tok_nextc.exit ], [ %3, %bb.l ], [ %i.at, %bb.m ]
  br label %bb.c
...
.split.thread:                                    ; preds = %tok_nextc.exit.thread, %.split, %bb.u, %bb.w
  %.21080.ph = phi i32 [ %.01078, %.split ], [ 0, %bb.w ], [ %.01078, %bb.u ], [ %.01078, %tok_nextc.exit.thread ]
  %.21077.ph = phi i32 [ %.01075, %.split ], [ 0, %bb.w ], [ 0, %bb.u ], [ %.01075, %tok_nextc.exit.thread ]
  %i.bi = load i32, ptr %i.m, align 8, !tbaa !56
  %i.bj = icmp eq i32 %i.bi, 0
  br i1 %i.bj, label %bb.x, label %.thread

bb.x:                                             ; preds = %.split.thread
  %.not1178 = icmp eq i32 %.01081.ph, 0           ; 2 uses
  %i.bk = select i1 %.not1178, i32 %.21077.ph, i32 %.01081.ph ; 5 uses
  %i.bl = select i1 %.not1178, i32 %.21080.ph, i32 %.01081.ph ; 4 uses
...
bb.an:                                            ; preds = %bb.am, %bb.al
  %.21064 = phi ptr [ %i.dc, %bb.am ], [ null, %bb.al ]
  %.21051 = phi ptr [ %i.dj, %bb.am ], [ null, %bb.al ]
  %i.dk = add nsw i32 %i.de, -1
  store i32 %i.dk, ptr %i.p, align 4, !tbaa !58
  %i.dl = tail call i32 @_PyLexer_token_setup(ptr noundef nonnull %0, ptr noundef %2, i32 noundef 5, ptr noundef %.21051, ptr noundef %.21064) #8
  br label %.thread1499
...
.preheader1616.1:                                 ; preds = %.loopexit1617, %.critedge23.1
  %.11109.1.in = phi i32 [ %.11109.1, %.critedge23.1 ], [ %i.gd, %.loopexit1617 ] ; 2 uses
  %.21097.1 = phi ptr [ %i.gk, %.critedge23.1 ], [ %i.gh, %.loopexit1617 ] ; 11 uses
  %i.gj = load i8, ptr %.21097.1, align 1, !tbaa !34
...
.loopexit1617.3:                                  ; preds = %bb.bv
  %i.gs = getelementptr i8, ptr %.21097.1, i64 2  ; 4 uses
...
.loopexit1617.4:                                  ; preds = %bb.bw
  %i.gw = getelementptr i8, ptr %.21097.1, i64 3  ; 4 uses
...
.loopexit1617.5:                                  ; preds = %bb.bx
  %i.ha = getelementptr i8, ptr %.21097.1, i64 4  ; 4 uses
...
.loopexit1617.6:                                  ; preds = %bb.by
  %i.he = getelementptr i8, ptr %.21097.1, i64 5  ; 3 uses
...
.preheader1616.preheader.7:                       ; preds = %.loopexit1617.6
  %i.hg = add i32 %.11109.1.in, 6
  br label %.preheader1616.7

.preheader1616.7:                                 ; preds = %.critedge23.7, %.preheader1616.preheader.7
  %.11109.7 = phi i32 [ %i.hj, %.critedge23.7 ], [ %i.hg, %.preheader1616.preheader.7 ] ; 3 uses
  %.21097.7 = phi ptr [ %i.hi, %.critedge23.7 ], [ %i.he, %.preheader1616.preheader.7 ] ; 6 uses
  %i.hh = load i8, ptr %.21097.7, align 1, !tbaa !34
...
.critedge23.7:                                    ; preds = %.preheader1616.7, %.preheader1616.7
  %i.hi = getelementptr i8, ptr %.21097.7, i64 1
  %i.hj = add i32 %.11109.7, 1
  br label %.preheader1616.7, !llvm.loop !63

.loopexit1617.7:                                  ; preds = %.preheader1616.7
  %i.hk = getelementptr i8, ptr %.21097.7, i64 6  ; 4 uses
  %i.hl = add i32 %.11109.7, 6
...
bb.ce:                                            ; preds = %tok_backup.exit1300
  %i.hu = load i32, ptr %.21097.7, align 1
  %i.hv = xor i32 %i.hu, 1869506409
  %i.hw = getelementptr i8, ptr %.21097.7, i64 4
...
.critedge1247:                                    ; preds = %bb.ce, %tok_backup.exit1300, %bb.cg, %bb.ch
  ...
  %i.jh = tail call i32 @_PyLexer_type_comment_token_setup(ptr noundef nonnull %0, ptr noundef %2, i32 noundef 57, i32 noundef %.11109.7, i32 noundef %i.jg, ptr noundef nonnull %.21097.7, ptr noundef nonnull %i.ht) #8
  br label %.thread1499
...
.critedge21.thread:                               ; preds = %bb.bs, %bb.bt, %.loopexit1617, %.loopexit1617.1, %bb.bu, %.loopexit1617.2, %bb.bv, %.loopexit1617.3, %bb.bw, %.loopexit1617.4, %bb.bx, %.loopexit1617.5, %bb.by, %.loopexit1617.6, %bb.br
  %.41099 = phi ptr [ %.01095, %bb.br ], [ %i.gc, %bb.bt ], [ %i.gc, %bb.bs ], [ %i.gh, %.loopexit1617 ], [ %i.he, %.loopexit1617.6 ], [ %.21097.1, %.loopexit1617.1 ], [ %.21097.1, %bb.bu ], [ %i.go, %.loopexit1617.2 ], [ %i.go, %bb.bv ], [ %i.gs, %.loopexit1617.3 ], [ %i.gs, %bb.bw ], [ %i.gw, %.loopexit1617.4 ], [ %i.gw, %bb.bx ], [ %i.ha, %.loopexit1617.5 ], [ %i.ha, %bb.by ]
...
bb.dk:                                            ; preds = %bb.dj, %bb.di, %bb.dh, %bb.dg, %bb.df
  ...
  %.11121 = phi i32 [ 1, %bb.di ], [ %.01120.a, %bb.dh ], [ %.01120.a, %bb.dg ], [ %.01120.a, %bb.df ], [ %.01120.a, %bb.dj ] ; 3 uses
...
bb.du:                                            ; preds = %tok_nextc.exit1319, %tok_nextc.exit1319
  ...
  %i.la = icmp ne i32 %.11113, 0                  ; 3 uses
  %or.cond.i = and i1 %i.kz, %i.la
  br i1 %or.cond.i, label %bb.eb, label %bb.dv

bb.dv:                                            ; preds = %bb.du
  %i.lb = icmp ne i32 %.11115, 0
  %or.cond3.i = and i1 %i.kz, %i.lb
  br i1 %or.cond3.i, label %bb.eb, label %bb.dw

bb.dw:                                            ; preds = %bb.dv
  %i.lc = icmp ne i32 %.11121, 0                  ; 3 uses
  %or.cond5.i = and i1 %i.lc, %i.kz
  br i1 %or.cond5.i, label %bb.eb, label %bb.dx

bb.dx:                                            ; preds = %bb.dw
  %i.ld = icmp ne i32 %.11123, 0                  ; 3 uses
  %or.cond7.i = and i1 %i.ld, %i.kz
  br i1 %or.cond7.i, label %bb.eb, label %bb.dy

bb.dy:                                            ; preds = %bb.dx
  %or.cond9.i = and i1 %i.lc, %i.la
  br i1 %or.cond9.i, label %bb.eb, label %bb.dz

bb.dz:                                            ; preds = %bb.dy
  %or.cond11.i = and i1 %i.ld, %i.la
  br i1 %or.cond11.i, label %bb.eb, label %bb.ea

bb.ea:                                            ; preds = %bb.dz
  %or.cond13.i = and i1 %i.ld, %i.lc
