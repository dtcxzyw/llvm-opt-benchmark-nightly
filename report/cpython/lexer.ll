...
.preheader.i.i:                                   ; preds = %.backedge.i.i
  %.2262629.i.i.lcssa667 = phi i32 [ %.2262629.i.i, %.backedge.i.i ]
...
bb.ep:                                            ; preds = %tok_backup.exit379.i.i, %.lr.ph504.split.i.i
  %lsr.iv667 = phi i32 [ %lsr.iv.next, %tok_backup.exit379.i.i ], [ %.2262629.i.i.lcssa667, %.lr.ph504.split.i.i ]
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.ag
  %i.co = phi i32 [ %i.cv, %bb.ag ], [ %i.bo, %.lr.ph.preheader ] ; 5 uses
...
.critedgesplit:                                   ; preds = %bb.ag
  %.lcssa1773.ph.ph = phi i32 [ 0, %bb.ag ]
  br label %.critedge

.lr.ph..critedge_crit_edge:                       ; preds = %.lr.ph
  %.lcssa3847 = phi i32 [ %i.co, %.lr.ph ]
  %.lcssa3847.a = phi i32 [ %i.co, %.lr.ph ]      ; 0 uses
  br label %.critedge

.critedge:                                        ; preds = %.critedgesplit, %.lr.ph..critedge_crit_edge
  %.lcssa1773.ph = phi i32 [ %.lcssa3847, %.lr.ph..critedge_crit_edge ], [ %.lcssa1773.ph.ph, %.critedgesplit ]
