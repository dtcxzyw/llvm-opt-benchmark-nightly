...
bb.iw:                                            ; preds = %bb.iv
  ...
  %4 = ptrtoaddr ptr %i.xf to i64                 ; 6 uses
  %i.xg = load i64, ptr %i.ax, align 8, !tbaa !65 ; 12 uses
...
iter.check741:                                    ; preds = %bb.iy
  ...
  %i.xo = xor i64 %4, -1
  %12 = add i64 %umax726, %i.xo
  %13 = sub i64 %12, %7                           ; 3 uses
  %14 = lshr i64 %13, 1
  %i.xp = add nuw i64 %14, 1                      ; 5 uses
...
.lr.ph.i.i.i.preheader:                           ; preds = %bb.iz
  ...
  %25 = lshr i64 %24, 2
  %i.yh = add nuw nsw i64 %25, 1                  ; 2 uses
...
bb.jt:                                            ; preds = %bb.js
  ...
  %i.aab = load ptr, ptr %i.az, align 8, !tbaa !67 ; 4 uses
  %26 = ptrtoaddr ptr %i.aab to i64               ; 6 uses
  %i.aac = load i64, ptr %i.ax, align 8, !tbaa !65 ; 12 uses
...
iter.check:                                       ; preds = %bb.jv
  ...
  %i.aai = xor i64 %26, -1
  %34 = add i64 %umax, %i.aai
  %35 = sub i64 %34, %29                          ; 3 uses
  %36 = lshr i64 %35, 1
  %i.aaj = add nuw i64 %36, 1                     ; 5 uses
...
.lr.ph.i217.i.i.preheader:                        ; preds = %bb.jw
  ...
  %47 = lshr i64 %46, 2
  %i.abb = add nuw nsw i64 %47, 1                 ; 2 uses
