...
bb.hy:                                            ; preds = %PyUnicode_MAX_CHAR_VALUE.exit.i.i
  ...
  %.pre227.i.i = load i32, ptr %i.av, align 4, !tbaa !42
  br label %bb.hz
...
bb.ia:                                            ; preds = %bb.hz
  %i.vm = load i64, ptr %i.aw, align 8, !tbaa !43
  %i.vn = load i64, ptr %i.ax, align 8, !tbaa !44
...
bb.ie:                                            ; preds = %bb.id
  %i.vu = load i32, ptr %i.ay, align 8, !tbaa !45
  %i.vv = load ptr, ptr %i.az, align 8, !tbaa !46 ; 3 uses
  %i.vw = load i64, ptr %i.ax, align 8, !tbaa !44 ; 5 uses
...
bb.ij:                                            ; preds = %bb.ii
  ...
  store i64 %i.wf, ptr %i.ap, align 8, !tbaa !86
  br label %bb.ik
...
bb.in:                                            ; preds = %bb.im
  %i.wi = load i32, ptr %i.ay, align 8, !tbaa !45
  %i.wj = load ptr, ptr %i.az, align 8, !tbaa !46 ; 5 uses
  %i.wk = load i64, ptr %i.ax, align 8, !tbaa !44 ; 5 uses
...
bb.io:                                            ; preds = %bb.in
  ...
  %.pre230.i.i = load ptr, ptr %i.az, align 8, !tbaa !46
  %.pre231.i.i = load i64, ptr %i.ax, align 8, !tbaa !44
  br label %PyUnicode_WRITE.exit212.i.i

bb.ip:                                            ; preds = %bb.in
  %i.wm = getelementptr [2 x i8], ptr %i.wj, i64 %i.wk
  store i16 48, ptr %i.wm, align 2, !tbaa !39
  br label %PyUnicode_WRITE.exit212.i.i

bb.iq:                                            ; preds = %bb.in
  %i.wn = getelementptr [4 x i8], ptr %i.wj, i64 %i.wk
  store i32 48, ptr %i.wn, align 4, !tbaa !10
  br label %PyUnicode_WRITE.exit212.i.i
...
PyUnicode_WRITE.exit212.i.i:                      ; preds = %bb.iq, %bb.ip, %bb.io
  ...
  %i.wq = load i32, ptr %i.ay, align 8, !tbaa !45
...
bb.ir:                                            ; preds = %PyUnicode_WRITE.exit212.i.i
  ...
  %.pre232.i.i = load i64, ptr %i.ax, align 8, !tbaa !44
...
bb.iu:                                            ; preds = %PyUnicode_WRITE.exit213.i.i, %bb.im
  ...
  store i64 %spec.select207.i.i, ptr %i.ap, align 8, !tbaa !86
...
bb.iw:                                            ; preds = %bb.iv
  ...
  %i.xf = load i32, ptr %i.ay, align 8, !tbaa !45
  %i.xg = load ptr, ptr %i.az, align 8, !tbaa !46 ; 3 uses
  %i.xh = load i64, ptr %i.ax, align 8, !tbaa !44 ; 10 uses
...
bb.ix:                                            ; preds = %bb.iw
  ...
  %.pre233.i.i = load i64, ptr %i.ax, align 8, !tbaa !44
...
vector.body733:                                   ; preds = %vector.body733, %vector.ph731
  ...
  store <8 x i16> %broadcast.splat, ptr %next.gep735, align 2, !tbaa !39
  store <8 x i16> %broadcast.splat, ptr %i.xv, align 2, !tbaa !39
  %index.next736 = add nuw i64 %index734, 16      ; 2 uses
  %i.xw = icmp eq i64 %index.next736, %n.vec732
  br i1 %i.xw, label %middle.block737, label %vector.body733, !llvm.loop !66
...
vec.epilog.iter.check743:                         ; preds = %middle.block737
  ...
  br i1 %min.epilog.iters.check744, label %.lr.ph30.i.i.i.preheader, label %vec.epilog.ph745, !prof !24
...
vec.epilog.vector.body749:                        ; preds = %vec.epilog.vector.body749, %vec.epilog.ph745
  ...
  store <4 x i16> %broadcast.splat748, ptr %next.gep751, align 2, !tbaa !39
  %index.next752 = add nuw i64 %index750, 4       ; 2 uses
  %i.ya = icmp eq i64 %index.next752, %n.vec746
  br i1 %i.ya, label %vec.epilog.middle.block753, label %vec.epilog.vector.body749, !llvm.loop !67
...
.lr.ph30.i.i.i:                                   ; preds = %.lr.ph30.i.i.i.preheader, %.lr.ph30.i.i.i
  ...
  store i16 %i.xk, ptr %.02629.i.i.i, align 2, !tbaa !39
  %i.yb = getelementptr i8, ptr %.02629.i.i.i, i64 2 ; 2 uses
  %i.yc = icmp ult ptr %i.yb, %i.xm
  br i1 %i.yc, label %.lr.ph30.i.i.i, label %_PyUnicode_Fill.exit.i.i, !llvm.loop !68
...
vector.body762:                                   ; preds = %vector.body762, %vector.ph758
  ...
  store <4 x i32> %broadcast.splat761, ptr %i.ym, align 4, !tbaa !10
  %index.next765 = add nuw i64 %index763, 8       ; 2 uses
  %i.yn = icmp eq i64 %index.next765, %n.vec759
  br i1 %i.yn, label %middle.block766, label %vector.body762, !llvm.loop !69
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader777, %.lr.ph.i.i.i
  ...
  br i1 %i.yp, label %.lr.ph.i.i.i, label %_PyUnicode_Fill.exit.i.i, !llvm.loop !70
...
_PyUnicode_Fill.exit.i.i:                         ; preds = %.lr.ph.i.i.i, %.lr.ph30.i.i.i, %middle.block766, %middle.block737, %vec.epilog.middle.block753, %bb.iz, %bb.iy, %bb.ix
  ...
  store i64 %i.yr, ptr %i.ax, align 8, !tbaa !44
...
bb.jd:                                            ; preds = %bb.jc
  %i.yt = load i32, ptr %i.ay, align 8, !tbaa !45
  %i.yu = load ptr, ptr %i.az, align 8, !tbaa !46 ; 3 uses
  %i.yv = load i64, ptr %i.ax, align 8, !tbaa !44 ; 5 uses
...
bb.jj:                                            ; preds = %bb.ji, %bb.ji, %bb.ji
  %i.zd = load i32, ptr %i.ay, align 8, !tbaa !45
  %i.ze = load ptr, ptr %i.az, align 8, !tbaa !46 ; 5 uses
  %i.zf = load i64, ptr %i.ax, align 8, !tbaa !44 ; 5 uses
...
bb.jl:                                            ; preds = %bb.jj
  ...
  store i16 48, ptr %i.zh, align 2, !tbaa !39
  br label %PyUnicode_WRITE.exit215.i.i

bb.jm:                                            ; preds = %bb.jj
  %i.zi = getelementptr [4 x i8], ptr %i.ze, i64 %i.zf
  store i32 48, ptr %i.zi, align 4, !tbaa !10
  br label %PyUnicode_WRITE.exit215.i.i
...
PyUnicode_WRITE.exit215.i.i:                      ; preds = %bb.jm, %bb.jl, %bb.jk
  ...
  %i.zl = load i32, ptr %i.ay, align 8, !tbaa !45
...
bb.jr:                                            ; preds = %bb.jq
  %i.zv = load ptr, ptr %i.v, align 8, !tbaa !89
  %i.zw = load i64, ptr %i.ax, align 8, !tbaa !44
  ...
  %i.zx = load i64, ptr %i.ax, align 8, !tbaa !44
...
bb.jt:                                            ; preds = %bb.js
  ...
  %i.aab = load i32, ptr %i.ay, align 8, !tbaa !45
  %i.aac = load ptr, ptr %i.az, align 8, !tbaa !46 ; 3 uses
  %i.aad = load i64, ptr %i.ax, align 8, !tbaa !44 ; 10 uses
...
iter.check:                                       ; preds = %bb.jv
  ...
  %min.iters.check = icmp samesign ult i64 %12, 7
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <8 x i16> splat (i16 32), ptr %i.aap, align 2, !tbaa !39
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.aaq = icmp eq i64 %index.next, %n.vec
  br i1 %i.aaq, label %middle.block, label %vector.body, !llvm.loop !71
...
vec.epilog.iter.check:                            ; preds = %middle.block
  %min.epilog.iters.check.not.not = icmp eq i64 %i.aal, 0
  br i1 %min.epilog.iters.check.not.not, label %.lr.ph30.i219.i.i.preheader, label %vec.epilog.ph, !prof !90

vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec711 = and i64 %i.aak, -8                  ; 3 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.aau, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !72
...
.lr.ph30.i219.i.i:                                ; preds = %.lr.ph30.i219.i.i.preheader, %.lr.ph30.i219.i.i
  ...
  br i1 %i.aaw, label %.lr.ph30.i219.i.i, label %_PyUnicode_Fill.exit221.i.i, !llvm.loop !73
...
vector.body720:                                   ; preds = %vector.body720, %vector.ph718
  ...
  store <4 x i32> splat (i32 32), ptr %i.abg, align 4, !tbaa !10
  %index.next723 = add nuw i64 %index721, 8       ; 2 uses
  %i.abh = icmp eq i64 %index.next723, %n.vec719
  br i1 %i.abh, label %middle.block724, label %vector.body720, !llvm.loop !74
...
.lr.ph.i217.i.i:                                  ; preds = %.lr.ph.i217.i.i.preheader775, %.lr.ph.i217.i.i
  ...
  br i1 %i.abj, label %.lr.ph.i217.i.i, label %_PyUnicode_Fill.exit221.i.i, !llvm.loop !75
...
_PyUnicode_Fill.exit221.i.i:                      ; preds = %.lr.ph.i217.i.i, %.lr.ph30.i219.i.i, %middle.block724, %middle.block, %vec.epilog.middle.block, %bb.jw, %bb.jv, %bb.ju
  ...
  store i64 %i.abl, ptr %i.ax, align 8, !tbaa !44
...
bb.ki:                                            ; preds = %unicode_format_arg.exit, %.critedge
  %i.acb = load i64, ptr %i.t, align 8, !tbaa !80 ; 2 uses
  %i.acc = add i64 %i.acb, -1                     ; 3 uses
  store i64 %i.acc, ptr %i.t, align 8, !tbaa !80
  %i.acd = icmp sgt i64 %i.acc, -1
  br i1 %i.acd, label %bb.k, label %._crit_edge247.loopexit, !llvm.loop !76
...
._crit_edge247:                                   ; preds = %._crit_edge247.loopexit, %bb.j
  ...
  %i.acf = load i64, ptr %i.af, align 8, !tbaa !37 ; 2 uses
  %i.acg = load i64, ptr %i.ae, align 8, !tbaa !36 ; 3 uses
...
bb.kj:                                            ; preds = %._crit_edge247
  %i.acj = load ptr, ptr @PyExc_TypeError, align 8, !tbaa !13
...
bb.kk:                                            ; preds = %._crit_edge247
  %i.aco = load i32, ptr %i.ag, align 8, !tbaa !84
  %.not25 = icmp eq i32 %i.aco, 0
  br i1 %.not25, label %Py_DECREF.exit30, label %bb.kl

bb.kl:                                            ; preds = %bb.kk
  %i.acp = load ptr, ptr %3, align 8, !tbaa !38   ; 3 uses
...
bb.a:
  ...
  %i.d = load i64, ptr %i.c, align 8, !tbaa !36   ; 4 uses
...
bb.d:                                             ; preds = %bb.c
  %i.h = load ptr, ptr %0, align 8, !tbaa !38
...
bb.g:                                             ; preds = %bb.b, %bb.e, %bb.a
  %i.k = load ptr, ptr @PyExc_TypeError, align 8, !tbaa !13
...
bb.c:                                             ; preds = %bb.b
  %i.d = load ptr, ptr @PyExc_TypeError, align 8, !tbaa !13
...
bb.e:                                             ; preds = %bb.d
  %i.h = load ptr, ptr @PyExc_TypeError, align 8, !tbaa !13
  %i.i = load i32, ptr %2, align 8, !tbaa !41
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.n = load ptr, ptr @PyExc_TypeError, align 8, !tbaa !13 ; 2 uses
  %i.o = load i32, ptr %2, align 8, !tbaa !41     ; 2 uses
