...
bb.iw:                                            ; preds = %bb.iv
  ...
  %i.xg = load ptr, ptr %i.az, align 8, !tbaa !46 ; 4 uses
  %4 = ptrtoaddr ptr %i.xg to i64                 ; 6 uses
  %i.xh = load i64, ptr %i.ax, align 8, !tbaa !44 ; 12 uses
...
bb.jt:                                            ; preds = %bb.js
  ...
  %i.aac = load ptr, ptr %i.az, align 8, !tbaa !46 ; 4 uses
  %26 = ptrtoaddr ptr %i.aac to i64               ; 6 uses
  %i.aad = load i64, ptr %i.ax, align 8, !tbaa !44 ; 12 uses
...
iter.check:                                       ; preds = %bb.jv
  ...
  %min.iters.check = icmp ult i64 %35, 14
