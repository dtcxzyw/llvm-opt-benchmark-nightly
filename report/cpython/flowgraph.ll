...
bb.a:
  ...
  %12 = alloca %struct._Py_SourceLocation, align 8 ; 5 uses
  %.sroa.558.i = alloca %struct._Py_SourceLocation, align 8 ; 5 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %12)
  %.02879.i = load ptr, ptr %0, align 8, !tbaa !26 ; 2 uses
  %.not80.not.i = icmp eq ptr %.02879.i, null
  br i1 %.not80.not.i, label %.loopexit, label %.preheader.lr.ph.i
...
.preheader.i:                                     ; preds = %.critedge.i, %.preheader.lr.ph.i
  %.02881.i = phi ptr [ %.02879.i, %.preheader.lr.ph.i ], [ %.028.i, %.critedge.i ] ; 4 uses
  %i.o = getelementptr i8, ptr %.02881.i, i64 40  ; 8 uses
  %i.p = load i32, ptr %i.o, align 8, !tbaa !28   ; 2 uses
  %.not3977.i = icmp sgt i32 %i.p, 0
  br i1 %.not3977.i, label %.lr.ph.i, label %.critedge.i

.lr.ph.i:                                         ; preds = %.preheader.i
  %i.q = getelementptr i8, ptr %.02881.i, i64 24  ; 12 uses
  %i.r = getelementptr i8, ptr %.02881.i, i64 44  ; 4 uses
  br label %bb.b

bb.b:                                             ; preds = %.thread.i, %.lr.ph.i
  %i.s = phi i32 [ %i.p, %.lr.ph.i ], [ %i.cx, %.thread.i ]
  %.02978.i = phi i32 [ 0, %.lr.ph.i ], [ %i.cy, %.thread.i ] ; 5 uses
  %i.t = load ptr, ptr %i.q, align 8, !tbaa !23   ; 2 uses
  %i.u = sext i32 %.02978.i to i64                ; 5 uses
  %i.v = getelementptr [40 x i8], ptr %i.t, i64 %i.u ; 4 uses
  %i.w = load i32, ptr %i.v, align 8, !tbaa !29   ; 2 uses
  %i.x = and i32 %i.w, -2
  %switch.i = icmp eq i32 %i.x, 258
  br i1 %switch.i, label %bb.c, label %.thread.i
...
bb.c:                                             ; preds = %bb.b
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %12, ptr noundef nonnull align 8 dereferenceable(16) %i.aa, i64 16, i1 false)
  %i.ab = getelementptr i8, ptr %i.v, i64 32
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !148 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.558.i)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.558.i, ptr noundef nonnull align 8 dereferenceable(16) %i.aa, i64 16, i1 false)
  %i.ad = add nsw i32 %.02978.i, 1                ; 3 uses
...
basicblock_next_instr.exit.thread.i.i:            ; preds = %bb.c
  ...
  br label %convert_pseudo_conditional_jumps.exit
...
basicblock_next_instr.exit.i.i:                   ; preds = %bb.c
  ...
  br i1 %i.an, label %convert_pseudo_conditional_jumps.exit, label %bb.d

bb.d:                                             ; preds = %basicblock_next_instr.exit.i.i
  %i.ao = icmp sgt i32 %i.al, %.02978.i
...
bb.e:                                             ; preds = %._crit_edge.loopexit.i.i, %bb.d
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.558.0..sroa_idx.i, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.558.i, i64 16, i1 false), !tbaa.struct !180
...
basicblock_next_instr.exit.i41.i:                 ; preds = %bb.e
  ...
  br i1 %i.bx, label %convert_pseudo_conditional_jumps.exit, label %bb.f
...
bb.g:                                             ; preds = %._crit_edge.loopexit.i52.i, %.._crit_edge_crit_edge.i42.i
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.558.i)
  %.pre.i = load i32, ptr %i.o, align 8, !tbaa !28
  br label %.thread.i

.thread.i:                                        ; preds = %bb.g, %bb.b
  %i.cx = phi i32 [ %.pre.i, %bb.g ], [ %i.s, %bb.b ] ; 2 uses
  %.33264.i = phi i32 [ %i.bm, %bb.g ], [ %.02978.i, %bb.b ]
  %i.cy = add i32 %.33264.i, 1                    ; 2 uses
  %.not39.i = icmp slt i32 %i.cy, %i.cx
  br i1 %.not39.i, label %bb.b, label %.critedge.i, !llvm.loop !181

.critedge.i:                                      ; preds = %.thread.i, %.preheader.i
  %i.cz = getelementptr i8, ptr %.02881.i, i64 32
...
convert_pseudo_conditional_jumps.exit:            ; preds = %basicblock_next_instr.exit.i.i, %basicblock_next_instr.exit.i41.i, %basicblock_next_instr.exit.thread.i.i, %basicblock_next_instr.exit.thread.i54.i
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.558.i)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.dx, label %middle.block, label %vector.body, !llvm.loop !191
...
build_cellfixedoffsets.exit.thread.i:             ; preds = %bb.i, %bb.h
...
._crit_edge.i.i:                                  ; preds = %.lr.ph.i.i14, %middle.block, %.preheader.i.i
  ...
  %i.dz = load ptr, ptr %i.dg, align 8, !tbaa !189
...
.lr.ph41.i.i:                                     ; preds = %._crit_edge.i.i, %bb.r
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d) #8
  %i.ee = load ptr, ptr %i.dc, align 8, !tbaa !183
  ...
  br i1 %i.eh, label %build_cellfixedoffsets.exit.thread47.i, label %bb.j

bb.j:                                             ; preds = %.lr.ph41.i.i
  %i.ei = load ptr, ptr %i.d, align 8, !tbaa !49  ; 2 uses
  %i.ej = icmp eq ptr %i.ei, null
  br i1 %i.ej, label %bb.r, label %bb.k, !llvm.loop !193
...
bb.k:                                             ; preds = %bb.j
  ...
  br i1 %.not.i.i.i, label %bb.l, label %Py_DECREF.exit.i.i

bb.l:                                             ; preds = %bb.k
  %i.en = add nsw i32 %i.em, -1                   ; 2 uses
  store i32 %i.en, ptr %i.el, align 8, !tbaa !64
  %i.eo = icmp eq i32 %i.en, 0
  br i1 %i.eo, label %bb.m, label %Py_DECREF.exit.i.i
...
bb.n:                                             ; preds = %Py_DECREF.exit.i.i
  %i.eq = call ptr @PyErr_Occurred() #8
  %.not31.i.i = icmp eq ptr %i.eq, null
  br i1 %.not31.i.i, label %bb.o, label %build_cellfixedoffsets.exit.thread47.i

bb.o:                                             ; preds = %bb.n, %Py_DECREF.exit.i.i
...
bb.p:                                             ; preds = %bb.o
  ...
  br i1 %.not32.i.i, label %bb.q, label %build_cellfixedoffsets.exit.thread47.i
...
bb.r:                                             ; preds = %bb.q, %bb.j
  ...
  %i.ex = load ptr, ptr %i.dg, align 8, !tbaa !189
...
build_cellfixedoffsets.exit.thread47.i:           ; preds = %bb.p, %bb.n, %.lr.ph41.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #8
...
build_cellfixedoffsets.exit.thread49.i:           ; preds = %bb.r, %._crit_edge.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #8
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #8
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #8
  %i.ez = load ptr, ptr %0, align 8, !tbaa !21    ; 6 uses
  %i.fa = load ptr, ptr %i.dg, align 8, !tbaa !189
  %i.fb = getelementptr i8, ptr %i.fa, i64 16
  %.val50.i.i = load i64, ptr %i.fb, align 8, !tbaa !185 ; 5 uses
  %i.fc = trunc i64 %.val50.i.i to i32            ; 3 uses
  %.not.i25.i = icmp eq i32 %i.fc, 0
  br i1 %.not.i25.i, label %bb.y, label %bb.s

bb.s:                                             ; preds = %build_cellfixedoffsets.exit.thread49.i
  %i.fd = load ptr, ptr %i.dc, align 8, !tbaa !183
  %i.fe = getelementptr i8, ptr %i.fd, i64 16
  %.val.i26.i = load i64, ptr %i.fe, align 8, !tbaa !185
  ...
  br i1 %i.fi, label %bb.t, label %.preheader86.i.i

.preheader86.i.i:                                 ; preds = %bb.s
...
bb.u:                                             ; preds = %.thread.i32.i, %.lr.ph90.i.i
  ...
  br i1 %i.gx, label %.thread.i32.i, label %bb.v
...
basicblock_next_instr.exit.thread.i.i.i:          ; preds = %bb.v
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #8
  br label %.loopexit.i33.i

basicblock_next_instr.exit.i.i.i:                 ; preds = %bb.v
  ...
  br i1 %i.hj, label %.loopexit.i33.i, label %bb.w

bb.w:                                             ; preds = %basicblock_next_instr.exit.i.i.i
  %i.hk = icmp sgt i32 %i.hh, %.03489.i.i
  br i1 %i.hk, label %.lr.ph.preheader.i.i.i, label %.._crit_edge_crit_edge.i.i.i

.._crit_edge_crit_edge.i.i.i:                     ; preds = %bb.w
...
bb.x:                                             ; preds = %._crit_edge.loopexit.i.i.i, %.._crit_edge_crit_edge.i.i.i
...
.thread.i32.i:                                    ; preds = %bb.x, %bb.u
  %.23673.i.i = phi i32 [ %i.ij, %bb.x ], [ %.03489.i.i, %bb.u ] ; 2 uses
  %i.ik = add i32 %.03788.i.i, 1
  %i.il = icmp slt i32 %.23673.i.i, %i.fc
  br i1 %i.il, label %bb.u, label %._crit_edge.i27.i, !llvm.loop !196
...
bb.y:                                             ; preds = %._crit_edge.i27.i, %build_cellfixedoffsets.exit.thread49.i
  %.not48.i.i = icmp eq i32 %i.dn, 0
  br i1 %.not48.i.i, label %insert_prefix_instructions.exit.i, label %bb.z
...
basicblock_next_instr.exit.thread.i63.i.i:        ; preds = %bb.z
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #8
  br label %bb.ab

basicblock_next_instr.exit.i51.i.i:               ; preds = %bb.z
  ...
  br i1 %i.je, label %bb.ab, label %bb.aa

bb.aa:                                            ; preds = %basicblock_next_instr.exit.i51.i.i
  %i.jf = icmp sgt i32 %i.jc, 0
  br i1 %i.jf, label %.lr.ph.preheader.i56.i.i, label %basicblock_insert_instruction.exit64.i.i

.lr.ph.preheader.i56.i.i:                         ; preds = %bb.aa
...
basicblock_insert_instruction.exit64.i.i:         ; preds = %._crit_edge.loopexit.i61.i.i, %bb.aa
  %i.jy = phi ptr [ %.pre.i62.i.i, %._crit_edge.loopexit.i61.i.i ], [ %i.ja, %bb.aa ] ; 4 uses
...
bb.ab:                                            ; preds = %basicblock_next_instr.exit.i51.i.i, %basicblock_next_instr.exit.thread.i63.i.i, %.loopexit.i33.i, %bb.t
  call void @PyMem_Free(ptr noundef nonnull %i.ds) #8
  br label %prepare_localsplus.exit.thread

insert_prefix_instructions.exit.i:                ; preds = %basicblock_insert_instruction.exit64.i.i, %bb.y
  %i.jz = load ptr, ptr %0, align 8, !tbaa !21    ; 2 uses
  %i.ka = load ptr, ptr %i.dc, align 8, !tbaa !183
  %i.kb = getelementptr i8, ptr %i.ka, i64 16
  %.val34.i34.i = load i64, ptr %i.kb, align 8, !tbaa !185
  %i.kc = trunc i64 %.val34.i34.i to i32          ; 3 uses
  %i.kd = load ptr, ptr %i.dg, align 8, !tbaa !189
  %i.ke = getelementptr i8, ptr %i.kd, i64 16
  %.val33.i.i = load i64, ptr %i.ke, align 8, !tbaa !185
  %i.kf = trunc i64 %.val33.i.i to i32
  %i.kg = load ptr, ptr %i.dk, align 8, !tbaa !190
  %i.kh = getelementptr i8, ptr %i.kg, i64 16
  %.val.i35.i = load i64, ptr %i.kh, align 8, !tbaa !185
...
.preheader35.i.i.loopexit.unr-lcssa:              ; preds = %bb.ai
...
.lr.ph.i41.i.epil.preheader:                      ; preds = %.preheader35.i.i.loopexit.unr-lcssa, %.lr.ph.preheader.i39.i
  ...
  br i1 %i.kp, label %bb.ad, label %bb.ac

bb.ac:                                            ; preds = %.lr.ph.i41.i.epil.preheader
...
.preheader35.i.i:                                 ; preds = %.preheader35.i.i.loopexit.unr-lcssa, %bb.ad, %bb.ac, %insert_prefix_instructions.exit.i
  %.0.lcssa.i.i = phi i32 [ 0, %insert_prefix_instructions.exit.i ], [ %.1.i43.i.1, %.preheader35.i.i.loopexit.unr-lcssa ], [ %.037.i.i.epil.init, %bb.ad ], [ %i.kq, %bb.ac ] ; 2 uses
  %.not40.i.i = icmp eq ptr %i.jz, null
  br i1 %.not40.i.i, label %fix_cell_offsets.exit.i, label %.preheader.i36.i

.lr.ph.i41.i:                                     ; preds = %bb.ai, %.lr.ph.preheader.i39.i.new
  %indvars.iv.i42.i = phi i64 [ 0, %.lr.ph.preheader.i39.i.new ], [ %indvars.iv.next.i44.i.1, %bb.ai ] ; 4 uses
  %.037.i.i = phi i32 [ 0, %.lr.ph.preheader.i39.i.new ], [ %.1.i43.i.1, %bb.ai ] ; 3 uses
  %niter83 = phi i64 [ 0, %.lr.ph.preheader.i39.i.new ], [ %niter83.next.1, %bb.ai ]
...
.lr.ph.i41.i.1:                                   ; preds = %bb.af, %bb.ae
  %.1.i43.i = phi i32 [ %.037.i.i, %bb.ae ], [ %i.kx, %bb.af ] ; 3 uses
  ...
  br i1 %i.lb, label %bb.ah, label %bb.ag

bb.ag:                                            ; preds = %.lr.ph.i41.i.1
...
bb.ai:                                            ; preds = %bb.ah, %bb.ag
  %.1.i43.i.1 = phi i32 [ %.1.i43.i, %bb.ah ], [ %i.lc, %bb.ag ] ; 3 uses
  ...
  br i1 %niter83.ncmp.1, label %.preheader35.i.i.loopexit.unr-lcssa, label %.lr.ph.i41.i, !llvm.loop !197
...
._crit_edge.i37.i.loopexit.unr-lcssa:             ; preds = %bb.ao
...
bb.aj:                                            ; preds = %.epil.preheader, %.epil.preheader, %.epil.preheader, %.epil.preheader, %.epil.preheader, %.epil.preheader
...
._crit_edge.i37.i:                                ; preds = %._crit_edge.i37.i.loopexit.unr-lcssa, %bb.aj, %.epil.preheader, %.preheader.i36.i
  %i.lr = getelementptr i8, ptr %.03141.i.i, i64 32
  %i.ls = load ptr, ptr %i.lr, align 8, !tbaa !36 ; 2 uses
  %.not.i38.i = icmp eq ptr %i.ls, null
  br i1 %.not.i38.i, label %fix_cell_offsets.exit.i, label %.preheader.i36.i, !llvm.loop !198

bb.ak:                                            ; preds = %bb.ao, %.lr.ph39.i.i.new
  %indvars.iv44.i.i = phi i64 [ 0, %.lr.ph39.i.i.new ], [ %indvars.iv.next45.i.i.1, %bb.ao ] ; 3 uses
  %niter89 = phi i64 [ 0, %.lr.ph39.i.i.new ], [ %niter89.next.1, %bb.ao ]
  %i.lt = getelementptr [40 x i8], ptr %i.li, i64 %indvars.iv44.i.i ; 2 uses
  %i.lu = load i32, ptr %i.lt, align 8, !tbaa !29
  switch i32 %i.lu, label %bb.am [
    i32 97, label %bb.al
    i32 261, label %bb.al
    i32 83, label %bb.al
    i32 111, label %bb.al
...
bb.an:                                            ; preds = %bb.am, %bb.am, %bb.am, %bb.am, %bb.am, %bb.am
...
bb.ao:                                            ; preds = %bb.an, %bb.am
  ...
  br i1 %niter89.ncmp.1, label %._crit_edge.i37.i.loopexit.unr-lcssa, label %bb.ak, !llvm.loop !199
...
prepare_localsplus.exit.thread:                   ; preds = %fix_cell_offsets.exit.i, %bb.ab, %build_cellfixedoffsets.exit.thread47.i, %build_cellfixedoffsets.exit.thread.i
...
prepare_localsplus.exit:                          ; preds = %fix_cell_offsets.exit.i
  ...
  br i1 %i.mk, label %normalize_jumps.exit.thread, label %bb.ap

bb.ap:                                            ; preds = %prepare_localsplus.exit
...
.preheader.i18:                                   ; preds = %bb.ap, %._crit_edge.i
  %.023.i = phi ptr [ %.0.i19, %._crit_edge.i ], [ %.021.i, %bb.ap ] ; 3 uses
...
._crit_edge.i:                                    ; preds = %bb.av, %.preheader.i18
  %i.mq = getelementptr i8, ptr %.023.i, i64 32
  %.0.i19 = load ptr, ptr %i.mq, align 8, !tbaa !26 ; 2 uses
  %.not.i = icmp eq ptr %.0.i19, null
  br i1 %.not.i, label %convert_pseudo_ops.exit, label %.preheader.i18, !llvm.loop !200

bb.aq:                                            ; preds = %bb.av, %.lr.ph.i20
  %indvars.iv.i = phi i64 [ 0, %.lr.ph.i20 ], [ %indvars.iv.next.i, %bb.av ] ; 2 uses
  ...
  br i1 %narrow.i.i, label %bb.as, label %bb.ar
...
bb.as:                                            ; preds = %bb.aq
  switch i32 %.val.i21, label %bb.av [
    i32 261, label %bb.at
    i32 266, label %bb.au
  ]
...
bb.av:                                            ; preds = %bb.au, %bb.at, %bb.as, %bb.ar
  ...
  br i1 %exitcond.not.i, label %._crit_edge.i, label %bb.aq, !llvm.loop !201

convert_pseudo_ops.exit:                          ; preds = %._crit_edge.i, %bb.ap
  %i.mu = call fastcc range(i32 -1, 1) i32 @remove_redundant_nops_and_jumps(ptr noundef nonnull readonly %0)
  %i.mv = icmp eq i32 %i.mu, -1
  br i1 %i.mv, label %normalize_jumps.exit.thread, label %bb.aw

bb.aw:                                            ; preds = %convert_pseudo_ops.exit
...
.lr.ph.i23:                                       ; preds = %bb.aw, %.lr.ph.i23
  %.01323.i = phi ptr [ %i.nr, %.lr.ph.i23 ], [ %i.mw, %bb.aw ] ; 2 uses
  ...
  br i1 %.not.i24, label %.lr.ph27.i, label %.lr.ph.i23, !llvm.loop !202

bb.ax:                                            ; preds = %normalize_jumps_in_block.exit.i, %.lr.ph27.i
...
basicblock_last_instr.exit.i.i:                   ; preds = %bb.ax
  ...
  br i1 %i.od, label %normalize_jumps_in_block.exit.i, label %bb.ay

bb.ay:                                            ; preds = %basicblock_last_instr.exit.i.i
  %i.oe = load i32, ptr %i.oc, align 8, !tbaa !29 ; 2 uses
  %i.of = and i32 %i.oe, -4
  %switch.i.i = icmp eq i32 %i.of, 100
  br i1 %switch.i.i, label %bb.az, label %normalize_jumps_in_block.exit.i
...
bb.az:                                            ; preds = %bb.ay
  ...
  br i1 %i.ol, label %bb.ba, label %switch.lookup.i.i
...
basicblock_next_instr.exit.thread.i.i.i27:        ; preds = %bb.ba
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #8
  br label %normalize_jumps.exit.thread

basicblock_next_instr.exit.i.i.i26:               ; preds = %bb.ba
...
basicblock_next_instr.exit.thread.i39.i.i:        ; preds = %bb.bb
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #8
  br label %normalize_jumps.exit.thread

basicblock_next_instr.exit.i36.i.i:               ; preds = %bb.bb
  ...
  br i1 %i.pw, label %normalize_jumps.exit.thread, label %bb.bc

bb.bc:                                            ; preds = %basicblock_next_instr.exit.i36.i.i
...
basicblock_last_instr.exit.i.i.i:                 ; preds = %bb.bc
  ...
  br i1 %.not.i.i.i25, label %basicblock_last_instr.exit.thread.i.i.i, label %bb.bd

bb.bd:                                            ; preds = %basicblock_last_instr.exit.i.i.i
...
basicblock_last_instr.exit.thread.i.i.i:          ; preds = %bb.bd, %basicblock_last_instr.exit.i.i.i, %bb.bc
...
basicblock_next_instr.exit.i.i.i.i:               ; preds = %basicblock_last_instr.exit.thread.i.i.i
  ...
  br i1 %i.qx, label %normalize_jumps.exit.thread, label %bb.be

bb.be:                                            ; preds = %basicblock_next_instr.exit.i.i.i.i
...
normalize_jumps_in_block.exit.i:                  ; preds = %bb.be, %basicblock_addop.exit.i.i, %bb.ay, %basicblock_last_instr.exit.i.i, %bb.ax
  %i.rv = getelementptr i8, ptr %.01225.i, i64 32
  %i.rw = load ptr, ptr %i.rv, align 8, !tbaa !36 ; 2 uses
  %.not15.not.i = icmp eq ptr %i.rw, null
  br i1 %.not15.not.i, label %normalize_jumps.exit.loopexit, label %bb.ax, !llvm.loop !203
...
normalize_jumps.exit:                             ; preds = %normalize_jumps.exit.loopexit, %bb.aw
  %.val13 = phi ptr [ %.val13.pre, %normalize_jumps.exit.loopexit ], [ null, %bb.aw ]
  %i.rx = call fastcc i32 @optimize_load_fast(ptr %.val13)
  %i.ry = icmp eq i32 %i.rx, -1
  br i1 %i.ry, label %normalize_jumps.exit.thread, label %bb.bf

bb.bf:                                            ; preds = %normalize_jumps.exit
  %i.rz = call i32 @_PyCfg_ToInstructionSequence(ptr noundef nonnull %0, ptr noundef %4)
  br label %normalize_jumps.exit.thread

normalize_jumps.exit.thread:                      ; preds = %basicblock_next_instr.exit.i.i.i.i, %bb.bd, %basicblock_next_instr.exit.i36.i.i, %basicblock_next_instr.exit.i.i.i26, %cfg_builder_new_block.exit.thread.i.i, %basicblock_next_instr.exit.thread.i39.i.i, %basicblock_next_instr.exit.thread.i.i.i.i, %basicblock_next_instr.exit.thread.i.i.i27, %prepare_localsplus.exit.thread, %convert_pseudo_conditional_jumps.exit, %bb.bf, %normalize_jumps.exit, %convert_pseudo_ops.exit, %prepare_localsplus.exit, %.loopexit
  %.0 = phi i32 [ -1, %normalize_jumps.exit ], [ -1, %convert_pseudo_conditional_jumps.exit ], [ -1, %.loopexit ], [ -1, %prepare_localsplus.exit ], [ -1, %convert_pseudo_ops.exit ], [ -1, %prepare_localsplus.exit.thread ], [ %i.rz, %bb.bf ], [ -1, %basicblock_next_instr.exit.thread.i.i.i27 ], [ -1, %basicblock_next_instr.exit.thread.i.i.i.i ], [ -1, %basicblock_next_instr.exit.thread.i39.i.i ], [ -1, %cfg_builder_new_block.exit.thread.i.i ], [ -1, %basicblock_next_instr.exit.i.i.i26 ], [ -1, %basicblock_next_instr.exit.i36.i.i ], [ -1, %bb.bd ], [ -1, %basicblock_next_instr.exit.i.i.i.i ]
  ret i32 %.0
}
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  br i1 %.not, label %.lr.ph.i, label %.lr.ph, !llvm.loop !204
...
bb.q:                                             ; preds = %stackdepth_push.exit109.thread
  ...
  br i1 %i.ct, label %bb.c, label %._crit_edge116, !llvm.loop !205
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  br i1 %.not, label %._crit_edge.thread, label %.lr.ph, !llvm.loop !206
...
bb.g:                                             ; preds = %bb.f, %.lr.ph439
  ...
  br i1 %.not232, label %.lr.ph439, label %.preheader339, !llvm.loop !207
...
bb.k:                                             ; preds = %bb.j, %.lr.ph.i249
  ...
  br i1 %i.bm, label %.lr.ph.i249, label %.thread241, !llvm.loop !208
...
bb.p:                                             ; preds = %bb.o, %.lr.ph.i258
  ...
  br i1 %i.ce, label %.lr.ph.i258, label %kill_local.exit266, !llvm.loop !208
...
bb.y:                                             ; preds = %bb.x, %.lr.ph.i.i.1
  ...
  br i1 %niter665.ncmp.1, label %kill_local.exit.i.loopexit.unr-lcssa, label %.lr.ph.i.i, !llvm.loop !208
...
bb.ae:                                            ; preds = %bb.ad, %.lr.ph.i.i291.1
  ...
  br i1 %niter660.ncmp.1, label %kill_local.exit.i288.loopexit.unr-lcssa, label %.lr.ph.i.i291, !llvm.loop !208
...
bb.al:                                            ; preds = %bb.ak, %.lr.ph.i.i310.1
  ...
  br i1 %niter.ncmp.1, label %kill_local.exit.i307.loopexit.unr-lcssa, label %.lr.ph.i.i310, !llvm.loop !208
...
bb.aq:                                            ; preds = %bb.ap, %.lr.ph.i.i323.1
  ...
  br i1 %niter655.ncmp.1, label %kill_local.exit.i320.loopexit.unr-lcssa, label %.lr.ph.i.i323, !llvm.loop !208
...
bb.az:                                            ; preds = %bb.ay, %bb.ax
  ...
  br i1 %exitcond.not, label %.thread241, label %bb.ax, !llvm.loop !209
...
bb.bz:                                            ; preds = %bb.by, %bb.bx
  ...
  br i1 %exitcond521.not, label %.thread241, label %bb.bx, !llvm.loop !210
...
.thread241:                                       ; preds = %bb.az, %bb.k, %bb.bz, %.lr.ph446.preheader, %bb.ba, %bb.aw, %.preheader334, %load_fast_push_block.exit406, %bb.bk, %ref_stack_push.exit382, %ref_stack_push.exit404, %.thread257, %ref_stack_push.exit367, %ref_stack_push.exit360, %ref_stack_push.exit353.thread, %ref_stack_push.exit338.thread, %bb.as, %kill_local.exit.i320, %ref_stack_push.exit305.thread, %bb.aa, %kill_local.exit.i, %ref_stack_push.exit284, %ref_stack_push.exit272, %ref_stack_push.exit256, %bb.i, %bb.av
  ...
  br i1 %i.nn, label %bb.h, label %kill_local.exit, !llvm.loop !211
...
bb.cf:                                            ; preds = %bb.ce, %.lr.ph483.1
  ...
  br i1 %niter670.ncmp.1, label %.preheader338.loopexit.unr-lcssa, label %.lr.ph483, !llvm.loop !212
...
bb.cm:                                            ; preds = %.sink.split.1, %bb.ck, %bb.cj
  ...
  br i1 %niter675.ncmp.1, label %kill_local.exit.thread292.loopexit.loopexit.unr-lcssa, label %bb.cg, !llvm.loop !213
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !36   ; 2 uses
  %.not = icmp eq ptr %i.m, null
  br i1 %.not, label %.lr.ph.i, label %.lr.ph, !llvm.loop !214
...
.loopexit60:                                      ; preds = %bb.j, %basicblock_nofallthrough.exit.thread57
  ...
  br i1 %i.t, label %.lr.ph67, label %._crit_edge68, !llvm.loop !215
...
bb.j:                                             ; preds = %bb.f, %bb.i
  ...
  br i1 %i.bs, label %bb.f, label %.loopexit60, !llvm.loop !216
...
bb.l:                                             ; preds = %.lr.ph72, %bb.k
  ...
  br i1 %.not46, label %.loopexit, label %.lr.ph72, !llvm.loop !217
...
basicblock_last_instr.exit.thread.i:              ; preds = %bb.h, %next_nonempty_block.exit44.i, %next_nonempty_block.exit.i, %bb.d, %basicblock_last_instr.exit.i, %.lr.ph.i
  ...
  br i1 %.not.i, label %remove_redundant_jumps.exit, label %.lr.ph.i, !llvm.loop !218
...
remove_redundant_jumps.exit.thread9:              ; preds = %bb.c, %remove_redundant_jumps.exit
  ...
  br i1 %i.ah, label %bb.b, label %.loopexit, !llvm.loop !219
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %exitcond.not, label %._crit_edge.thread, label %bb.e, !llvm.loop !220
...
eval_const_unaryop.exit:                          ; preds = %bb.h, %bb.i, %bb.j, %bb.k, %bb.l, %bb.m
  %.1.i = phi ptr [ null, %bb.i ], [ %i.ap, %bb.m ], [ %i.ai, %bb.h ], [ %i.ak, %bb.j ], [ %i.ao, %bb.l ], [ null, %bb.k ] ; 7 uses
...
.lr.ph:                                           ; preds = %bb.b, %.lr.ph
  ...
  br i1 %or.cond, label %.critedge, label %.lr.ph, !llvm.loop !221
...
bb.m:                                             ; preds = %bb.f, %bb.g, %bb.h, %bb.i, %bb.l, %maybe_push.exit
  ...
  br i1 %i.am, label %bb.b, label %._crit_edge, !llvm.loop !223
...
!178 = distinct !{!178, !25}
!179 = distinct !{!179, !25}
!180 = !{i64 0, i64 4, !7, i64 4, i64 4, !7, i64 8, i64 4, !7, i64 12, i64 4, !7, i64 16, i64 8, !26, i64 24, i64 8, !26}
!181 = distinct !{!181, !25}
!182 = distinct !{!182, !25}
!183 = !{!184, !50, i64 32}
!184 = !{!"", !50, i64 0, !50, i64 8, !50, i64 16, !50, i64 24, !50, i64 32, !50, i64 40, !50, i64 48, !50, i64 56, !20, i64 64, !20, i64 72, !20, i64 80, !8, i64 88}
!185 = !{!186, !20, i64 16}
!186 = !{!"", !60, i64 0, !20, i64 16, !20, i64 24, !187, i64 32, !188, i64 40}
!187 = !{!"p1 _ZTS15_dictkeysobject", !14, i64 0}
!188 = !{!"p1 _ZTS11_dictvalues", !14, i64 0}
!189 = !{!184, !50, i64 40}
!190 = !{!184, !50, i64 48}
!191 = distinct !{!191, !25, !94, !95}
!192 = distinct !{!192, !25, !95, !94}
!193 = distinct !{!193, !25}
!194 = distinct !{!194, !73}
!195 = distinct !{!195, !25}
!196 = distinct !{!196, !25}
