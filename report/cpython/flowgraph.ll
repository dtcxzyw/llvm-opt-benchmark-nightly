...
bb.c:                                             ; preds = %bb.b
  ...
  %.sroa.0.0.copyload = load <16 x i8>, ptr %i.aa, align 8 ; 2 uses
...
bb.e:                                             ; preds = %._crit_edge.loopexit.i.i, %bb.d
  ...
  store <16 x i8> %.sroa.0.0.copyload, ptr %.sroa.558.0..sroa_idx.i, align 8
...
bb.g:                                             ; preds = %._crit_edge.loopexit.i52.i, %.._crit_edge_crit_edge.i42.i
  ...
  store <16 x i8> %.sroa.0.0.copyload, ptr %.sroa.5.0..sroa_idx.i, align 8
...
.thread.i:                                        ; preds = %bb.g, %bb.b
  ...
  br i1 %.not39.i, label %bb.b, label %.critedge.i, !llvm.loop !180
...
bb.j:                                             ; preds = %.lr.ph41.i.i
  ...
  br i1 %i.ej, label %bb.r, label %bb.k, !llvm.loop !192
...
.thread.i32.i:                                    ; preds = %bb.x, %bb.u
  ...
  br i1 %i.il, label %bb.u, label %._crit_edge.i27.i, !llvm.loop !195
...
bb.ao:                                            ; preds = %bb.an, %bb.am
  ...
  br i1 %niter89.ncmp.1, label %._crit_edge.i37.i.loopexit.unr-lcssa, label %bb.ak, !llvm.loop !198
...
bb.av:                                            ; preds = %bb.au, %bb.at, %bb.as, %bb.ar
  ...
  br i1 %exitcond.not.i, label %._crit_edge.i, label %bb.aq, !llvm.loop !200
...
normalize_jumps_in_block.exit.i:                  ; preds = %bb.be, %basicblock_addop.exit.i.i, %bb.ay, %basicblock_last_instr.exit.i.i, %bb.ax
  ...
  br i1 %.not15.not.i, label %normalize_jumps.exit.loopexit, label %bb.ax, !llvm.loop !202
