...
._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %bb.a
  %.07.lcssa.i = phi i64 [ 0, %bb.a ], [ %i.b, %._crit_edge.loopexit.i ]
  %i.c = tail call ptr @PyMem_Malloc(i64 noundef %.07.lcssa.i) #8 ; 8 uses
  %.not8.i = icmp eq ptr %i.c, null
  br i1 %.not8.i, label %make_cfg_traversal_stack.exit.thread, label %make_cfg_traversal_stack.exit

.lr.ph.i:                                         ; preds = %bb.a, %.lr.ph.i
  %.011.i = phi ptr [ %i.i, %.lr.ph.i ], [ %0, %bb.a ] ; 2 uses
  %.0710.i = phi i32 [ %i.g, %.lr.ph.i ], [ 0, %bb.a ]
  %i.d = getelementptr i8, ptr %.011.i, i64 64    ; 2 uses
  %i.e = load i8, ptr %i.d, align 8
  %i.f = and i8 %i.e, -3
  store i8 %i.f, ptr %i.d, align 8
  %i.g = add i32 %.0710.i, 1                      ; 2 uses
...
.lr.ph186:                                        ; preds = %bb.c, %bb.aa
  %.097184 = phi ptr [ %.8, %bb.aa ], [ %i.t, %bb.c ]
  %i.v = getelementptr i8, ptr %.097184, i64 -8   ; 3 uses
...
bb.d:                                             ; preds = %.lr.ph, %bb.w
  ...
  %.0100178 = phi ptr [ %i.y, %.lr.ph ], [ %.3103.ph, %bb.w ] ; 26 uses
...
bb.g:                                             ; preds = %bb.f
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(192) %i.ar, ptr noundef nonnull readonly align 8 dereferenceable(192) %.0100178, i64 192, i1 false)
...
bb.h:                                             ; preds = %bb.g, %bb.e
  ...
  %.3 = phi ptr [ %.198179, %bb.e ], [ %i.ay, %bb.g ]
...
bb.m:                                             ; preds = %bb.l
  store ptr %.094180, ptr %i.bu, align 8, !tbaa !148
...
bb.o:                                             ; preds = %basicblock_nofallthrough.exit.thread
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(192) %i.ce, ptr noundef nonnull readonly align 8 dereferenceable(192) %.0100178, i64 192, i1 false)
...
basicblock_nofallthrough.exit.thread138:          ; preds = %bb.n, %bb.n, %bb.n, %bb.n, %bb.n, %bb.n, %bb.n, %bb.n, %bb.o
  ...
  %.sink = phi ptr [ %i.ce, %bb.o ], [ %.0100178, %bb.n ], [ %.0100178, %bb.n ], [ %.0100178, %bb.n ], [ %.0100178, %bb.n ], [ %.0100178, %bb.n ], [ %.0100178, %bb.n ], [ %.0100178, %bb.n ], [ %.0100178, %bb.n ]
  %.1101 = phi ptr [ %.0100178, %bb.o ], [ null, %bb.n ], [ null, %bb.n ], [ null, %bb.n ], [ null, %bb.n ], [ null, %bb.n ], [ null, %bb.n ], [ null, %bb.n ], [ null, %bb.n ]
  %i.ch = getelementptr i8, ptr %.sink216, i64 16
  store ptr %.sink, ptr %i.ch, align 8, !tbaa !147
  store ptr %.sink216, ptr %.198179, align 8, !tbaa !26
  ...
  %i.cm = getelementptr i8, ptr %.198179, i64 8
  br label %bb.w
...
bb.q:                                             ; preds = %bb.p
  store ptr %.094180, ptr %i.bu, align 8, !tbaa !148
  %i.cn = getelementptr i8, ptr %.0100178, i64 184
...
bb.w:                                             ; preds = %bb.s, %bb.t, %bb.k, %bb.q, %bb.u, %bb.v, %bb.r, %bb.m, %basicblock_nofallthrough.exit.thread138, %push_except_block.exit
  %.3103.ph = phi ptr [ %.0100178, %bb.s ], [ %.0100178, %bb.t ], [ %.0100178, %bb.u ], [ %.0100178, %bb.r ], [ %.0100178, %bb.v ], [ %.0100178, %bb.q ], [ %.1101, %basicblock_nofallthrough.exit.thread138 ], [ %.0100178, %bb.m ], [ %.0100178, %bb.k ], [ %.0100178, %push_except_block.exit ] ; 12 uses
  %.5.ph = phi ptr [ %.198179, %bb.s ], [ %.198179, %bb.t ], [ %.198179, %bb.u ], [ %.198179, %bb.r ], [ %.198179, %bb.v ], [ %.198179, %bb.q ], [ %i.cm, %basicblock_nofallthrough.exit.thread138 ], [ %.198179, %bb.m ], [ %.198179, %bb.k ], [ %.3, %push_except_block.exit ] ; 12 uses
  %.296.ph = phi ptr [ %.094180, %bb.s ], [ %.094180, %bb.t ], [ %.094180, %bb.u ], [ %.094180, %bb.r ], [ %.094180, %bb.v ], [ %.094180, %bb.q ], [ %.094180, %basicblock_nofallthrough.exit.thread138 ], [ %.094180, %bb.m ], [ %i.bn, %bb.k ], [ %.val127, %push_except_block.exit ]
  %.293.ph = phi i32 [ -1, %bb.s ], [ -1, %bb.t ], [ %.091181, %bb.u ], [ %.091181, %bb.r ], [ %.091181, %bb.v ], [ %i.co, %bb.q ], [ %.091181, %basicblock_nofallthrough.exit.thread138 ], [ %.091181, %bb.m ], [ %.091181, %bb.k ], [ %.091181, %push_except_block.exit ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
...
basicblock_nofallthrough.exit133.thread:          ; preds = %.lr.ph186, %bb.x, %._crit_edge, %basicblock_last_instr.exit.i131
  %.198.lcssa209.a = phi ptr [ %.5.ph, %basicblock_last_instr.exit.i131 ], [ %.5.ph, %bb.x ], [ %.5.ph, %._crit_edge ], [ %i.v, %.lr.ph186 ] ; 3 uses
  %.0100.lcssa208 = phi ptr [ %.3103.ph, %basicblock_last_instr.exit.i131 ], [ %.3103.ph, %bb.x ], [ %.3103.ph, %._crit_edge ], [ %i.y, %.lr.ph186 ] ; 2 uses
...
bb.y:                                             ; preds = %basicblock_nofallthrough.exit133.thread
  ...
  store ptr %.0100.lcssa208, ptr %i.di, align 8, !tbaa !147
  store ptr %i.de, ptr %.198.lcssa209.a, align 8, !tbaa !26
  ...
  %i.dn = getelementptr i8, ptr %.198.lcssa209.a, i64 8
  br label %bb.aa
...
basicblock_nofallthrough.exit133.thread162:       ; preds = %bb.x, %bb.x, %bb.x, %bb.x, %bb.x, %bb.x, %bb.x, %bb.x, %basicblock_nofallthrough.exit133.thread
  %.198.lcssa210 = phi ptr [ %.5.ph, %bb.x ], [ %.5.ph, %bb.x ], [ %.5.ph, %bb.x ], [ %.5.ph, %bb.x ], [ %.5.ph, %bb.x ], [ %.5.ph, %bb.x ], [ %.5.ph, %bb.x ], [ %.5.ph, %bb.x ], [ %.198.lcssa209.a, %basicblock_nofallthrough.exit133.thread ] ; 2 uses
  %.0100.lcssa207 = phi ptr [ %.3103.ph, %bb.x ], [ %.3103.ph, %bb.x ], [ %.3103.ph, %bb.x ], [ %.3103.ph, %bb.x ], [ %.3103.ph, %bb.x ], [ %.3103.ph, %bb.x ], [ %.3103.ph, %bb.x ], [ %.3103.ph, %bb.x ], [ %.0100.lcssa208, %basicblock_nofallthrough.exit133.thread ] ; 2 uses
  %.not125 = icmp eq ptr %.0100.lcssa207, null
  br i1 %.not125, label %bb.aa, label %bb.z

bb.z:                                             ; preds = %basicblock_nofallthrough.exit133.thread162
  tail call void @PyMem_Free(ptr noundef nonnull %.0100.lcssa207) #8
  br label %bb.aa

bb.aa:                                            ; preds = %bb.y, %bb.z, %basicblock_nofallthrough.exit133.thread162
  %.8 = phi ptr [ %i.dn, %bb.y ], [ %.198.lcssa210, %bb.z ], [ %.198.lcssa210, %basicblock_nofallthrough.exit133.thread162 ] ; 2 uses
...
.thread:                                          ; preds = %basicblock_nofallthrough.exit.thread, %bb.f
  ...
  tail call void @PyMem_Free(ptr noundef nonnull %i.c) #8
  tail call void @PyMem_Free(ptr noundef %.0100178) #8
  br label %bb.ab
...
bb.b:                                             ; preds = %basicblock_last_instr.exit.thread.i, %.lr.ph.i
  %.047122.i = phi ptr [ %i.a, %.lr.ph.i ], [ %i.co, %basicblock_last_instr.exit.thread.i ] ; 3 uses
  %.048121.i = phi i32 [ %i.f, %.lr.ph.i ], [ %.553.ph.i, %basicblock_last_instr.exit.thread.i ] ; 9 uses
  %i.m = getelementptr i8, ptr %.047122.i, i64 40
...
basicblock_last_instr.exit.i:                     ; preds = %bb.b
  %i.p = getelementptr i8, ptr %.047122.i, i64 24
