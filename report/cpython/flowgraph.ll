...
bb.na:                                            ; preds = %insert_superinstructions.exit
  ...
  %i.bjl = getelementptr i8, ptr %i.bjk, i64 32   ; 3 uses
...
.critedge86.preheader.i:                          ; preds = %basicblock_nofallthrough.exit.thread92.i, %get_max_label.exit.i
  ...
  br i1 %.not78111.i, label %.critedge.thread.thread.i, label %.preheader.i66

.critedge.thread.thread.i:                        ; preds = %.critedge86.preheader.i
  store ptr null, ptr %i.bjl, align 8, !tbaa !36
  br label %push_cold_blocks_to_end.exit
...
push_cold_blocks_to_end.exit:                     ; preds = %.critedge.thread.thread.i, %.critedge.thread.i, %bb.od, %bb.na
