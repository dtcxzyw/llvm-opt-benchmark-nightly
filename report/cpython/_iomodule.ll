...
bb.br:                                            ; preds = %bb.bp, %bb.bo, %.thread443.i
  ...
  %.0138.lcssa359371395409432454.i = phi i32 [ 0, %.thread443.i ], [ %.1139.i, %bb.bp ], [ %.1139.i, %bb.bo ] ; 2 uses
...
bb.cw:                                            ; preds = %bb.cv
  ...
  %i.fe = or i32 %i.fd, %.0135.lcssa360370396408433453.i ; 2 uses
  %or.cond15.not.i = icmp eq i32 %i.fe, 0
  %4 = or i32 %i.fe, %.0138.lcssa359371395409432454.i
  %brmerge.not.i = icmp eq i32 %4, 0
...
bb.cx:                                            ; preds = %bb.cw, %bb.cv
  %.sink.i = phi i64 [ %.mux.i, %bb.cw ], [ 56, %bb.cv ]
