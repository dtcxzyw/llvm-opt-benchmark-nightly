...
bb.f:                                             ; preds = %bb.e, %.thread, %.thread23
  ...
  %i.t = tail call ptr %i.s(ptr noundef %0, i64 noundef 0) #7 ; 10 uses
...
.thread:                                          ; preds = %bb.a
  ...
  %.val = load i64, ptr %i.b, align 8, !tbaa !47
  %i.c = add i64 %.val, %3
  br label %bb.c
...
bb.c:                                             ; preds = %bb.b
  ...
  %.val = load i64, ptr %i.a, align 8, !tbaa !47
...
bb.c:                                             ; preds = %bb.b
  %i.h = load i64, ptr %i.a, align 8, !tbaa !49   ; 2 uses
...
.lr.ph.split.split.us:                            ; preds = %.lr.ph.split, %bb.h
  ...
  store i8 1, ptr %i.b, align 1, !tbaa !50
  store i8 1, ptr %i.n, align 8, !tbaa !51
...
begin_hunk_7_@_queue_SimpleQueue_get_impl:bb.a
  ...
  store i64 %i.at, ptr %i.s, align 8, !tbaa !52
...
_Py_NewRef.exit:                                  ; preds = %bb.a, %bb.b
  ...
  %i.g = load i8, ptr %i.f, align 8, !tbaa !51, !range !56, !noundef !57
...
bb.c:                                             ; preds = %_Py_NewRef.exit
  ...
  %.pre = load i8, ptr %2, align 8, !tbaa !58, !range !56
...
begin_hunk_11_@_queue_SimpleQueue_put_impl:bb.a
  ...
  store i64 %i.an, ptr %i.j, align 8, !tbaa !52
...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  store i8 %storemerge, ptr %0, align 8, !tbaa !58
  %i.d = icmp ne i32 %2, 0
  ...
  store i8 %i.h, ptr %i.g, align 8, !tbaa !51
  ret void
}
...
!52 = !{!26, !17, i64 0}
!53 = !{!54, !14, i64 8}
!54 = !{!"", !16, i64 0, !14, i64 8, !15, i64 16}
!55 = !{!54, !15, i64 16}
!56 = !{i8 0, i8 2}
!57 = !{}
!58 = !{!54, !16, i64 0}
