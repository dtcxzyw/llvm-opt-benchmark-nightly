...
iter.check89:                                     ; preds = %bb.m
  ...
  %min.iters.check68 = icmp ult i32 %i.an, 42
...
vec.epilog.vector.body101:                        ; preds = %vec.epilog.vector.body101, %vec.epilog.ph93
  ...
  %vec.ind103 = phi <8 x i32> [ %induction100, %vec.epilog.ph93 ], [ %vec.ind.next106, %vec.epilog.vector.body101 ] ; 2 uses
  %next.gep104 = getelementptr i8, ptr %.19.us.i, i64 %index102
  %5 = add nsw <8 x i32> %vec.ind103, splat (i32 -6)
  %6 = lshr <8 x i32> %broadcast.splat97, %5
  %7 = trunc <8 x i32> %6 to <8 x i8>
  %8 = and <8 x i8> %7, splat (i8 63)
  %9 = add nuw nsw <8 x i8> %8, splat (i8 32)
  store <8 x i8> %9, ptr %next.gep104, align 1, !tbaa !16
  %index.next105 = add nuw i64 %index102, 8       ; 2 uses
  %vec.ind.next106 = add nsw <8 x i32> %vec.ind103, splat (i32 -48)
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph.i.preheader, label %vec.epilog.ph, !prof !38
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.cz, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !39
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  br i1 %i.dg, label %.lr.ph.i, label %._crit_edge.split.i, !llvm.loop !40
...
bb.av:                                            ; preds = %bb.al, %bb.aj, %bb.ah, %bb.ab, %bb.x, %bb.v, %bb.t
  ...
  br i1 %.not133.i, label %._crit_edge.i, label %.lr.ph.i, !llvm.loop !42
...
ignorechar.exit154.jt1.i:                         ; preds = %ignorechar.exit154.i, %bb.af
  ...
  br i1 %.not133.jt2.i, label %._crit_edge.thread.i, label %.lr.ph.jt2.i, !llvm.loop !42
...
ignorechar.exit154.jt0.i:                         ; preds = %ignorechar.exit154.i, %bb.ad
  ...
  br i1 %.not133.jt1.i, label %.thread206.i, label %.lr.ph.jt1.i, !llvm.loop !42
...
ignorechar.exit154.jt2.i:                         ; preds = %ignorechar.exit154.i, %bb.ae
  ...
  br i1 %.not133.jt3.i, label %._crit_edge.thread.i, label %.lr.ph.jt3.i, !llvm.loop !42
...
bb.j:                                             ; preds = %bb.i, %bb.h, %bb.e
  ...
  %i.u = load i64, ptr %i.b, align 8, !tbaa !43   ; 3 uses
...
.lr.ph.i.i:                                       ; preds = %bb.p, %.lr.ph.i.i
  ...
  br i1 %i.cc, label %.lr.ph.i.i, label %base64_encode_fast.exit.i, !llvm.loop !44
...
bb.v:                                             ; preds = %bb.v, %.peel.next.i.i
  ...
  br i1 %.not31.i.i, label %wraplines.exit.i, label %bb.v, !llvm.loop !45
...
bb.p:                                             ; preds = %bb.o, %bb.n, %bb.k, %bb.h, %bb.e
  ...
  %i.af = load i64, ptr %i.b, align 8, !tbaa !43  ; 2 uses
...
bb.ag:                                            ; preds = %bb.af, %bb.ae, %bb.ac
  ...
  br i1 %i.cq, label %bb.ab, label %._crit_edge.i, !llvm.loop !47
...
bb.au:                                            ; preds = %bb.au, %.peel.next.i.i
  ...
  br i1 %.not31.i.i, label %wraplines.exit.i, label %bb.au, !llvm.loop !45
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.be, label %middle.block, label %vector.body, !llvm.loop !48
...
.loopexit.i:                                      ; preds = %.lr.ph31.preheader.i, %.lr.ph31.i.1, %.lr.ph31.i.2, %.lr.ph31.i.3, %bb.ap, %ignorechar.exit.thread.i, %bb.an, %bb.al
  ...
  br i1 %i.en, label %bb.ab, label %._crit_edge39.i, !llvm.loop !50
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader
  ...
  %i.aa = load i16, ptr %i.z, align 2, !tbaa !51
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.an = load i16, ptr %i.am, align 2, !tbaa !51
  ...
  %i.ba = load i16, ptr %i.az, align 2, !tbaa !51
  %i.bb = zext i16 %i.ba to i32
  %i.bc = xor i32 %i.as, %i.bb                    ; 2 uses
  %i.bd = icmp sgt i64 %.03.i, 2
  br i1 %i.bd, label %.lr.ph.i, label %binascii_crc_hqx_impl.exit, !llvm.loop !53
...
bb.c:                                             ; preds = %bb.a
  ...
  %.val16 = load i64, ptr %i.c, align 8, !tbaa !59
...
_PyUnicode_DATA.exit:                             ; preds = %bb.g, %bb.h
  ...
  %.val18 = load i64, ptr %i.j, align 8, !tbaa !64
...
!58 = !{!28, !29, i64 8}
!59 = !{!60, !19, i64 168}
!60 = !{!"_typeobject", !27, i64 0, !20, i64 24, !19, i64 32, !19, i64 40, !13, i64 48, !19, i64 56, !13, i64 64, !13, i64 72, !13, i64 80, !13, i64 88, !13, i64 96, !13, i64 104, !13, i64 112, !13, i64 120, !13, i64 128, !13, i64 136, !13, i64 144, !13, i64 152, !13, i64 160, !19, i64 168, !20, i64 176, !13, i64 184, !13, i64 192, !13, i64 200, !19, i64 208, !13, i64 216, !13, i64 224, !61, i64 232, !62, i64 240, !63, i64 248, !29, i64 256, !12, i64 264, !13, i64 272, !13, i64 280, !19, i64 288, !13, i64 296, !13, i64 304, !13, i64 312, !13, i64 320, !13, i64 328, !12, i64 336, !12, i64 344, !12, i64 352, !13, i64 360, !12, i64 368, !13, i64 376, !7, i64 384, !13, i64 392, !13, i64 400, !8, i64 408, !52, i64 410}
!61 = !{!"p1 _ZTS11PyMethodDef", !13, i64 0}
!62 = !{!"p1 _ZTS11PyMemberDef", !13, i64 0}
!63 = !{!"p1 _ZTS11PyGetSetDef", !13, i64 0}
!64 = !{!65, !19, i64 16}
!65 = !{!"", !28, i64 0, !19, i64 16, !19, i64 24, !66, i64 32}
!66 = !{!"_PyUnicodeObject_state", !7, i64 0, !7, i64 0, !7, i64 0, !7, i64 0, !7, i64 0}
!67 = !{!60, !20, i64 24}
!68 = distinct !{!68, !24}
!69 = distinct !{!69, !24}
!70 = distinct !{!70, !24}
