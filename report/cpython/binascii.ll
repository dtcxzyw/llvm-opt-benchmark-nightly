...
.lr.ph11.split.us.i:                              ; preds = %.lr.ph11.i, %._crit_edge.split.us.us.i
  ...
  %.19.us.i = phi ptr [ %.2.lcssa.us.i, %._crit_edge.split.us.us.i ], [ %.0.i, %.lr.ph11.i ] ; 4 uses
...
bb.m:                                             ; preds = %bb.l, %.lr.ph11.split.us.i
  %.146.us.i = phi i32 [ %i.ak, %bb.l ], [ %i.ah, %.lr.ph11.split.us.i ] ; 3 uses
  %i.al = add nsw i32 %.0436.us.i, 8              ; 4 uses
...
.lr.ph.us.i.preheader.a:                          ; preds = %bb.m
  %i.an = add i32 %.0436.us.i, 2                  ; 2 uses
  %i.ao = udiv i32 %i.an, 6
  %narrow73 = add nuw nsw i32 %i.ao, 1
  %i.ap = zext nneg i32 %narrow73 to i64          ; 2 uses
  %min.iters.check53 = icmp ult i32 %i.an, 90
  br i1 %min.iters.check53, label %.lr.ph.us.i.preheader74, label %vector.ph54

vector.ph54:                                      ; preds = %.lr.ph.us.i.preheader.a
  %n.vec56 = and i64 %i.ap, 2147483632            ; 4 uses
  %i.aq = getelementptr i8, ptr %.19.us.i, i64 %n.vec56 ; 2 uses
  %.cast57 = trunc nuw nsw i64 %n.vec56 to i32
  %i.ar = mul i32 %.cast57, -6
  %i.as = add i32 %i.al, %i.ar                    ; 2 uses
...
begin_hunk_2_@binascii_b2a_uu:bb.a
  ...
  br i1 %i.ay, label %middle.block69, label %vector.body63, !llvm.loop !30

middle.block69:                                   ; preds = %vector.body63
  %cmp.n70 = icmp eq i64 %n.vec56, %i.ap
  br i1 %cmp.n70, label %._crit_edge.split.us.us.i, label %.lr.ph.us.i.preheader74

.lr.ph.us.i.preheader74:                          ; preds = %.lr.ph.us.i.preheader.a, %middle.block69
  %.22.us.us.i.ph = phi ptr [ %.19.us.i, %.lr.ph.us.i.preheader.a ], [ %i.aq, %middle.block69 ]
  %.1441.us.us.i.ph.a = phi i32 [ %i.al, %.lr.ph.us.i.preheader.a ], [ %i.as, %middle.block69 ]
  br label %.lr.ph.us.i

._crit_edge.split.us.us.i:                        ; preds = %.lr.ph.us.i, %middle.block69, %bb.m
  %.144.lcssa.us.i = phi i32 [ %i.al, %bb.m ], [ %i.as, %middle.block69 ], [ %i.be, %.lr.ph.us.i ] ; 2 uses
  %.2.lcssa.us.i = phi ptr [ %.19.us.i, %bb.m ], [ %i.aq, %middle.block69 ], [ %.3.us.us.i, %.lr.ph.us.i ] ; 2 uses
  ...
  br i1 %i.bd, label %.lr.ph11.split.us.i, label %._crit_edge12.i, !llvm.loop !33

.lr.ph.us.i:                                      ; preds = %.lr.ph.us.i.preheader74, %.lr.ph.us.i
  %.22.us.us.i = phi ptr [ %.3.us.us.i, %.lr.ph.us.i ], [ %.22.us.us.i.ph, %.lr.ph.us.i.preheader74 ] ; 2 uses
  %.1441.us.us.i = phi i32 [ %i.be, %.lr.ph.us.i ], [ %.1441.us.us.i.ph.a, %.lr.ph.us.i.preheader74 ] ; 2 uses
...
begin_hunk_3_@binascii_b2a_uu:bb.a
  ...
  br i1 %i.bj, label %.lr.ph.us.i, label %._crit_edge.split.us.us.i, !llvm.loop !34

.lr.ph11.split.i:                                 ; preds = %.lr.ph11.i, %._crit_edge.split.i
  %i.bk = phi i1 [ %i.cp, %._crit_edge.split.i ], [ true, %.lr.ph11.i ]
  %.19.i = phi ptr [ %.2.lcssa.i, %._crit_edge.split.i ], [ %.0.i, %.lr.ph11.i ] ; 4 uses
...
begin_hunk_5_@binascii_b2a_uu:bb.a
  ...
  br i1 %i.cf, label %middle.block.a, label %vector.body, !llvm.loop !35

middle.block.a:                                   ; preds = %vector.body
  %cmp.n.a = icmp eq i64 %n.vec, %i.bt
  br i1 %cmp.n.a, label %._crit_edge.split.i, label %.lr.ph.i.preheader75

.lr.ph.i.preheader75:                             ; preds = %.lr.ph.i.preheader.a, %middle.block.a
  %.22.i.ph = phi ptr [ %.19.i, %.lr.ph.i.preheader.a ], [ %i.bu, %middle.block.a ]
  %.1441.i.ph.a = phi i32 [ %i.bp, %.lr.ph.i.preheader.a ], [ %i.bw, %middle.block.a ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader75, %.lr.ph.i
  %.22.i = phi ptr [ %.3.i, %.lr.ph.i ], [ %.22.i.ph, %.lr.ph.i.preheader75 ] ; 2 uses
  %.1441.i = phi i32 [ %i.cg, %.lr.ph.i ], [ %.1441.i.ph.a, %.lr.ph.i.preheader75 ] ; 2 uses
...
begin_hunk_6_@binascii_b2a_uu:bb.a
  ...
  br i1 %i.cm, label %.lr.ph.i, label %._crit_edge.split.i, !llvm.loop !36

._crit_edge.split.i:                              ; preds = %.lr.ph.i, %middle.block.a, %bb.o
  %.144.lcssa.i = phi i32 [ %i.bp, %bb.o ], [ %i.bw, %middle.block.a ], [ %i.cg, %.lr.ph.i ] ; 2 uses
  %.2.lcssa.i = phi ptr [ %.19.i, %bb.o ], [ %i.bu, %middle.block.a ], [ %.3.i, %.lr.ph.i ] ; 2 uses
  ...
  br i1 %i.cr, label %.lr.ph11.split.i, label %._crit_edge12.i, !llvm.loop !33
...
begin_hunk_7_@binascii_a2b_base64:bb.a
  ...
  br i1 %exitcond.not.i.i, label %.base64_decode_quad.exit.thread.loopexit.i_crit_edge.i, label %.lr.ph.i.i, !llvm.loop !37

.base64_decode_quad.exit.thread.loopexit.i_crit_edge.i: ; preds = %bb.q
  %.pre.i = shl nuw nsw i64 %i.ay, 2
  br label %base64_decode_fast.exit.i, !llvm.loop !37
...
begin_hunk_8_@binascii_a2b_base64:bb.a
  ...
  br i1 %.not133.i, label %._crit_edge.i, label %.lr.ph.i, !llvm.loop !38
...
bb.j:                                             ; preds = %bb.i, %bb.h, %bb.e
  ...
  %i.u = load i64, ptr %i.b, align 8, !tbaa !39   ; 3 uses
...
begin_hunk_11_@binascii_b2a_base64:bb.a
  ...
  br i1 %i.cc, label %.lr.ph.i.i, label %base64_encode_fast.exit.i, !llvm.loop !40
...
begin_hunk_12_@binascii_b2a_base64:bb.a
  ...
  br i1 %.not31.i.i, label %wraplines.exit.i, label %bb.v, !llvm.loop !41
...
begin_hunk_14_@binascii_b2a_ascii85:bb.a
  ...
  %i.af = load i64, ptr %i.b, align 8, !tbaa !39  ; 2 uses
...
begin_hunk_15_@binascii_b2a_ascii85:bb.a
  ...
  br i1 %i.cq, label %bb.ab, label %._crit_edge.i, !llvm.loop !43
...
begin_hunk_16_@binascii_b2a_ascii85:bb.a
  ...
  br i1 %.not31.i.i, label %wraplines.exit.i, label %bb.au, !llvm.loop !41
...
begin_hunk_17_@binascii_a2b_ascii85:bb.a
  ...
  br i1 %i.be, label %middle.block, label %vector.body, !llvm.loop !44
...
begin_hunk_19_@binascii_a2b_ascii85:bb.a
  ...
  br i1 %i.en, label %bb.ab, label %._crit_edge39.i, !llvm.loop !46
...
begin_hunk_21_@binascii_crc_hqx:bb.a
  ...
  %i.an = load i16, ptr %i.am, align 2, !tbaa !47
...
begin_hunk_22_@binascii_crc_hqx:bb.a
  ...
  %i.ba = load i16, ptr %i.az, align 2, !tbaa !47
  %i.bb = zext i16 %i.ba to i32
  %i.bc = xor i32 %i.as, %i.bb                    ; 2 uses
  %i.bd = icmp sgt i64 %.03.i, 2
  br i1 %i.bd, label %.lr.ph.i, label %binascii_crc_hqx_impl.exit, !llvm.loop !49
...
begin_hunk_23_@binascii_crc32:bb.a
  ...
  br i1 %i.y, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !50
...
begin_hunk_25_@binascii_a2b_qp:bb.a
  ...
  br i1 %i.bj, label %bb.i, label %._crit_edge.i, !llvm.loop !52
...
begin_hunk_26_@binascii_b2a_qp:bb.a
  ...
  br i1 %i.fh, label %.preheader.i, label %._crit_edge14.i, !llvm.loop !53
...
bb.c:                                             ; preds = %bb.a
  ...
  %.val15 = load ptr, ptr %i.b, align 8, !tbaa !54
  %i.c = getelementptr i8, ptr %.val15, i64 168
  %.val16 = load i64, ptr %i.c, align 8, !tbaa !55
...
begin_hunk_28_@ascii_buffer_converter:bb.a
  ...
  %.val18 = load i64, ptr %i.j, align 8, !tbaa !60
...
bb.j:                                             ; preds = %bb.i
  ...
  %.val = load ptr, ptr %i.b, align 8, !tbaa !54
...
begin_hunk_30_@base85_decode_impl:bb.a
  ...
  br i1 %i.bd, label %.lr.ph86, label %._crit_edge, !llvm.loop !64
...
begin_hunk_31_@base85_encode_impl:bb.a
  ...
  br i1 %i.bj, label %.lr.ph, label %._crit_edge, !llvm.loop !65
...
begin_hunk_32_@binascii_a2b_hex_impl:bb.a
  ...
  br i1 %i.ad, label %.lr.ph, label %._crit_edge, !llvm.loop !66
...
!54 = !{!28, !29, i64 8}
!55 = !{!56, !19, i64 168}
!56 = !{!"_typeobject", !27, i64 0, !20, i64 24, !19, i64 32, !19, i64 40, !13, i64 48, !19, i64 56, !13, i64 64, !13, i64 72, !13, i64 80, !13, i64 88, !13, i64 96, !13, i64 104, !13, i64 112, !13, i64 120, !13, i64 128, !13, i64 136, !13, i64 144, !13, i64 152, !13, i64 160, !19, i64 168, !20, i64 176, !13, i64 184, !13, i64 192, !13, i64 200, !19, i64 208, !13, i64 216, !13, i64 224, !57, i64 232, !58, i64 240, !59, i64 248, !29, i64 256, !12, i64 264, !13, i64 272, !13, i64 280, !19, i64 288, !13, i64 296, !13, i64 304, !13, i64 312, !13, i64 320, !13, i64 328, !12, i64 336, !12, i64 344, !12, i64 352, !13, i64 360, !12, i64 368, !13, i64 376, !7, i64 384, !13, i64 392, !13, i64 400, !8, i64 408, !48, i64 410}
!57 = !{!"p1 _ZTS11PyMethodDef", !13, i64 0}
!58 = !{!"p1 _ZTS11PyMemberDef", !13, i64 0}
!59 = !{!"p1 _ZTS11PyGetSetDef", !13, i64 0}
!60 = !{!61, !19, i64 16}
!61 = !{!"", !28, i64 0, !19, i64 16, !19, i64 24, !62, i64 32}
!62 = !{!"_PyUnicodeObject_state", !7, i64 0, !7, i64 0, !7, i64 0, !7, i64 0, !7, i64 0}
!63 = !{!56, !20, i64 24}
!64 = distinct !{!64, !24}
!65 = distinct !{!65, !24}
!66 = distinct !{!66, !24}
