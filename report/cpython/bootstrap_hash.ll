...
; Function Attrs: nounwind uwtable
define hidden void @_Py_HashRandomization_Init(ptr dead_on_unwind noalias writable writeonly sret(%struct.PyStatus) align 8 captures(none) initializes((0, 32)) %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
bb.a:
