...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.d
  ...
  %.021 = phi ptr [ %i.n, %bb.d ], [ %1, %.lr.ph.preheader ] ; 6 uses
...
..critedge.loopexit_crit_edge:                    ; preds = %bb.c
  ...
  %split36 = phi ptr [ %.021, %bb.c ]             ; 0 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.c
  ...
  %.016 = phi ptr [ %i.k, %bb.c ], [ %1, %.lr.ph.preheader ] ; 5 uses
...
bb.c:                                             ; preds = %bb.b
  %i.k = getelementptr i8, ptr %.016, i64 1       ; 3 uses
...
.critedge.loopexitsplitsplit:                     ; preds = %.lr.ph
  ...
  %.lcssa.ph.ph.ph = phi i8 [ %i.b, %.lr.ph ]
  br label %.critedge.loopexitsplit

..critedge.loopexitsplit_crit_edge:               ; preds = %bb.c
  %.lcssa30 = phi ptr [ %i.k, %bb.c ]
  %.lcssa27 = phi ptr [ %i.k, %bb.c ]             ; 0 uses
  %split29 = phi i8 [ 0, %bb.c ]
...
.critedge.loopexitsplit:                          ; preds = %.critedge.loopexitsplitsplit, %..critedge.loopexitsplit_crit_edge
  %.0.lcssa.ph.ph = phi ptr [ %.lcssa30, %..critedge.loopexitsplit_crit_edge ], [ %.016.lcssa, %.critedge.loopexitsplitsplit ]
  %.lcssa.ph.ph = phi i8 [ %split29, %..critedge.loopexitsplit_crit_edge ], [ %.lcssa.ph.ph.ph, %.critedge.loopexitsplitsplit ]
  br label %.critedge.loopexit

..critedge.loopexit_crit_edge:                    ; preds = %bb.b
  %.016.lcssa27 = phi ptr [ %.016, %bb.b ]
  %.016.lcssa28 = phi ptr [ %.016, %bb.b ]        ; 0 uses
  %split26 = phi i8 [ %i.b, %bb.b ]
  br label %.critedge.loopexit

.critedge.loopexit:                               ; preds = %.critedge.loopexitsplit, %..critedge.loopexit_crit_edge
  %.0.lcssa.ph = phi ptr [ %.016.lcssa27, %..critedge.loopexit_crit_edge ], [ %.0.lcssa.ph.ph, %.critedge.loopexitsplit ]
  %.lcssa.ph = phi i8 [ %split26, %..critedge.loopexit_crit_edge ], [ %.lcssa.ph.ph, %.critedge.loopexitsplit ]
