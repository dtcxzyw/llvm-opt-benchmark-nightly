...
; Function Attrs: nounwind uwtable
define internal fastcc void @fill_and_set_sslerror(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(address_is_null) %1, ptr noundef %2, i32 noundef %3, ptr noundef %4, i32 noundef range(i32 105, 5904) %5, i64 noundef %6) unnamed_addr #0 {
bb.a:
  %.not = icmp eq i64 %6, 0
