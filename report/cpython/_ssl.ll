...
bb.h:                                             ; preds = %bb.e, %PyObject_TypeCheck.exit.thread, %bb.c
  %.sink = phi ptr [ %i.d, %bb.c ], [ null, %bb.e ], [ null, %PyObject_TypeCheck.exit.thread ] ; 8 uses
  %.025 = phi ptr [ %i.e, %bb.c ], [ %i.g, %bb.e ], [ %.val40, %PyObject_TypeCheck.exit.thread ]
  %.024 = phi ptr [ %i.d, %bb.c ], [ %1, %bb.e ], [ %1, %PyObject_TypeCheck.exit.thread ]
  %i.k = getelementptr i8, ptr %.024, i64 16
