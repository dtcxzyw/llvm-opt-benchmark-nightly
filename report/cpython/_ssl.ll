...
.split63.us:                                      ; preds = %bb.n, %bb.l, %bb.i, %.lr.ph72
  %.us-phi = phi i32 [ %.040.us71, %bb.i ], [ %.040.us71, %.lr.ph72 ], [ %i.aj, %bb.n ], [ %.04065, %bb.l ]
  %i.ar = tail call i64 @ERR_peek_last_error() #11
