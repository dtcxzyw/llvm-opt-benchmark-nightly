...
bb.r:                                             ; preds = %bb.q, %bb.o, %Py_DECREF.exit274.i.outer
  ...
  %i.ag = icmp eq ptr %i.af, null                 ; 8 uses
...
bb.v:                                             ; preds = %bb.u, %bb.s, %bb.r
  %.1106.i.peel = phi i8 [ 0, %bb.r ], [ 1, %bb.u ], [ 1, %bb.s ] ; 2 uses
  %3 = trunc nuw i8 %.1106.i.peel to i1           ; 2 uses
...
bb.x:                                             ; preds = %bb.w
  br i1 %3, label %.loopexit, label %bb.y
...
bb.ak:                                            ; preds = %bb.aj, %bb.ah, %Py_DECREF.exit274.i
  ...
  %i.bx = icmp eq ptr %i.bw, null                 ; 7 uses
...
bb.ao:                                            ; preds = %bb.an, %bb.al, %bb.ak
  %.1106.i = phi i8 [ 0, %bb.ak ], [ 1, %bb.an ], [ 1, %bb.al ] ; 2 uses
  %4 = trunc nuw i8 %.1106.i to i1                ; 3 uses
...
bb.ap:                                            ; preds = %bb.ao
  br i1 %4, label %.loopexit, label %bb.aq
...
Py_DECREF.exit282.thread.i:                       ; preds = %_check_long_mult_overflow.exit.thread.i, %_check_long_mult_overflow.exit.i, %bb.as, %bb.ar, %_check_long_mult_overflow.exit.thread.i.peel, %_check_long_mult_overflow.exit.i.peel, %bb.aa, %bb.z
  ...
  %.lcssa107 = phi i1 [ %i.ag, %bb.z ], [ %i.ag, %bb.aa ], [ %i.ag, %_check_long_mult_overflow.exit.i.peel ], [ %i.ag, %_check_long_mult_overflow.exit.thread.i.peel ], [ %i.bx, %bb.ar ], [ %i.bx, %bb.as ], [ %i.bx, %_check_long_mult_overflow.exit.i ], [ %i.bx, %_check_long_mult_overflow.exit.thread.i ]
...
.loopexit:                                        ; preds = %bb.x, %bb.y, %bb.aq, %bb.ap, %Py_DECREF.exit282.thread.i
  %5 = phi i1 [ false, %Py_DECREF.exit282.thread.i ], [ true, %bb.x ], [ false, %bb.y ], [ %4, %bb.aq ], [ %4, %bb.ap ] ; 4 uses
  ...
  %i.dl = phi i1 [ %.lcssa107, %Py_DECREF.exit282.thread.i ], [ %i.ag, %bb.x ], [ %i.ag, %bb.y ], [ %i.bx, %bb.aq ], [ %i.bx, %bb.ap ] ; 4 uses
...
Py_DECREF.exit278.i:                              ; preds = %bb.w, %bb.bf, %bb.be, %Py_DECREF.exit280.i, %.loopexit
  %6 = phi i1 [ %5, %bb.bf ], [ %5, %.loopexit ], [ %5, %Py_DECREF.exit280.i ], [ %5, %bb.be ], [ %3, %bb.w ] ; 2 uses
  ...
  %i.dz = phi i1 [ %i.dl, %bb.bf ], [ %i.dl, %.loopexit ], [ %i.dl, %Py_DECREF.exit280.i ], [ %i.dl, %bb.be ], [ %i.ag, %bb.w ]
...
bb.bg:                                            ; preds = %Py_DECREF.exit278.i
  br i1 %6, label %Py_DECREF.exit274.thread.i, label %bb.bh
...
begin_hunk_10_@math_sumprod:bb.a
  ...
  br i1 %6, label %bb.cr, label %bb.ce

bb.ce:                                            ; preds = %Py_DECREF.exit270.i
  %i.gn = call ptr @PyNumber_Multiply(ptr noundef %i.ea, ptr noundef %i.dy) #17 ; 6 uses
...
Py_DECREF.exit268.i:                              ; preds = %bb.ci, %bb.ch, %bb.cg
  br i1 %i.eb, label %Py_DECREF.exit266.i, label %bb.cj

bb.cj:                                            ; preds = %Py_DECREF.exit268.i
  %i.gu = load i32, ptr %i.ea, align 8, !tbaa !29 ; 2 uses
  %.not.i265.i = icmp sgt i32 %i.gu, -1
  br i1 %.not.i265.i, label %bb.ck, label %Py_DECREF.exit266.i

bb.ck:                                            ; preds = %bb.cj
  %i.gv = add nsw i32 %i.gu, -1                   ; 2 uses
  store i32 %i.gv, ptr %i.ea, align 8, !tbaa !29
  %i.gw = icmp eq i32 %i.gv, 0
  br i1 %i.gw, label %bb.cl, label %Py_DECREF.exit266.i

bb.cl:                                            ; preds = %bb.ck
  call void @_Py_Dealloc(ptr noundef nonnull %i.ea) #17
  br label %Py_DECREF.exit266.i

Py_DECREF.exit266.i:                              ; preds = %bb.cl, %bb.ck, %bb.cj, %Py_DECREF.exit268.i
  br i1 %i.dz, label %Py_DECREF.exit264.i, label %bb.cm

bb.cm:                                            ; preds = %Py_DECREF.exit266.i
...
Py_DECREF.exit264.i:                              ; preds = %bb.co, %bb.cn, %bb.cm, %Py_DECREF.exit266.i
