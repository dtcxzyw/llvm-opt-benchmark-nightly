...
define internal fastcc void @init_import_site(ptr dead_on_unwind noalias nonnull writable writeonly align 8 captures(none) initializes((0, 32)) %0) unnamed_addr #1 {
bb.a:
