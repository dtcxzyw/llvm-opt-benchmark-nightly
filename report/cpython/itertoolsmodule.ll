...
bb.j:                                             ; preds = %bb.f
  ...
  store ptr %i.m, ptr %i.v, align 8, !tbaa !80
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = tail call ptr %i.d(ptr noundef %0, i64 noundef 0) #8, !inline_history !178 ; 4 uses
...
bb.f:                                             ; preds = %bb.b
  ...
  store ptr %i.a, ptr %i.j, align 8, !tbaa !80
...
bb.a:
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !84   ; 4 uses
...
Py_XDECREF.exit:                                  ; preds = %bb.a, %bb.b, %bb.c, %bb.d
  ...
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !85   ; 4 uses
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !86   ; 12 uses
  %i.e = getelementptr i8, ptr %0, i64 32         ; 3 uses
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !85   ; 12 uses
  %i.g = getelementptr i8, ptr %i.b, i64 16
  %.val.i = load i64, ptr %i.g, align 8, !tbaa !68
  %i.h = getelementptr i8, ptr %0, i64 40
  %i.i = load i64, ptr %i.h, align 8, !tbaa !87   ; 14 uses
...
bb.d:                                             ; preds = %bb.c
  store ptr %i.m, ptr %i.e, align 8, !tbaa !85
...
Py_INCREF.exit80.i:                               ; preds = %bb.f, %bb.e
  ...
  %i.ac = load i64, ptr %i.ab, align 8, !tbaa !89
...
Py_INCREF.exit80.i.1:                             ; preds = %bb.g, %Py_INCREF.exit80.i
  ...
  br i1 %niter.ncmp.1, label %.loopexit.i.loopexit.unr-lcssa, label %bb.e, !llvm.loop !179
...
bb.j:                                             ; preds = %bb.i
  store ptr %i.al, ptr %i.e, align 8, !tbaa !85
...
bb.m:                                             ; preds = %bb.h
  ...
  store i64 -1, ptr %i.aq, align 8, !tbaa !91
  %i.ar = getelementptr i8, ptr %i.f, i64 -16     ; 3 uses
  %.val.i.i = load i64, ptr %i.ar, align 8, !tbaa !93
...
bb.p:                                             ; preds = %.lr.ph
  ...
  br i1 %i.by, label %.lr.ph, label %Py_DECREF.exit78.i, !llvm.loop !180
...
.lr.ph:                                           ; preds = %_PyTuple_Recycle.exit.i, %bb.p
  ...
  %i.ca = load i64, ptr %i.bz, align 8, !tbaa !89 ; 2 uses
  %i.cb = add i64 %i.bw, %.1.i29
  %i.cc = icmp eq i64 %i.ca, %i.cb
  br i1 %i.cc, label %bb.p, label %.critedge.i, !llvm.loop !180

.critedge.i:                                      ; preds = %.lr.ph
  %i.cd = getelementptr [8 x i8], ptr %i.d, i64 %.1.i29
  %i.ce = add i64 %i.ca, 1
  store i64 %i.ce, ptr %i.cd, align 8, !tbaa !89
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader, %.lr.ph.i.prol
  ...
  store i64 %i.cj, ptr %i.ci, align 8, !tbaa !89
  %i.ck = add nsw i64 %.06887.i.prol, 1           ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.prol.loopexit, label %.lr.ph.i.prol, !llvm.loop !181
...
bb.q:                                             ; preds = %Py_DECREF.exit.i, %.lr.ph89.i
  ...
  %i.dc = load i64, ptr %i.db, align 8, !tbaa !89
...
Py_DECREF.exit.i:                                 ; preds = %bb.t, %bb.s, %Py_INCREF.exit.i
  ...
  br i1 %exitcond95.not.i, label %.loopexit.i, label %bb.q, !llvm.loop !183
...
.epil.preheader:                                  ; preds = %.loopexit.i.loopexit.unr-lcssa, %.lr.ph91.i
  ...
  %i.dp = load i64, ptr %i.do, align 8, !tbaa !89
...
Py_DECREF.exit78.i:                               ; preds = %bb.p, %_PyTuple_Recycle.exit.i, %bb.i, %bb.c
  store i32 1, ptr %i.j, align 8, !tbaa !88
  br label %combinations_next_lock_held.exit
...
bb.a:
  ...
  %.val = load i64, ptr %i.b, align 8, !tbaa !68  ; 2 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c, %bb.b
  ...
  %.val19 = load i64, ptr %i.m, align 8, !tbaa !68 ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.u = tail call ptr %i.t(ptr noundef %0, i64 noundef 0) #8, !inline_history !201 ; 8 uses
...
bb.k:                                             ; preds = %bb.h
  ...
  store ptr %i.q, ptr %i.z, align 8, !tbaa !139
  %i.aa = getelementptr i8, ptr %i.u, i64 24
  store ptr null, ptr %i.aa, align 8, !tbaa !140
  ...
  store ptr %i.ab, ptr %i.ac, align 8, !tbaa !141
...
bb.a:
  ...
  tail call void @PyObject_GC_UnTrack(ptr noundef %0) #8
  %i.b = getelementptr i8, ptr %0, i64 16
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !143  ; 4 uses
...
bb.e:                                             ; preds = %bb.c, %bb.d
  ...
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !144  ; 2 uses
  %.not34 = icmp eq ptr %i.g, null
  br i1 %.not34, label %bb.g, label %bb.f
...
bb.a:
  ...
  %i.c = getelementptr i8, ptr %0, i64 24
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !145  ; 10 uses
  %i.e = getelementptr i8, ptr %0, i64 32
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !146
  %i.g = getelementptr i8, ptr %0, i64 40         ; 3 uses
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !144  ; 12 uses
  %i.i = getelementptr i8, ptr %i.b, i64 16
  %.val.i = load i64, ptr %i.i, align 8, !tbaa !68 ; 5 uses
  %i.j = getelementptr i8, ptr %0, i64 48
  %i.k = load i64, ptr %i.j, align 8, !tbaa !147  ; 13 uses
...
bb.d:                                             ; preds = %bb.c
  store ptr %i.o, ptr %i.g, align 8, !tbaa !144
...
Py_INCREF.exit106.i.1:                            ; preds = %bb.g, %Py_INCREF.exit106.i
  ...
  %niter.next.1 = add nuw nsw i64 %niter, 2       ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.loopexit.i.loopexit.unr-lcssa, label %bb.e, !llvm.loop !202
...
bb.k:                                             ; preds = %bb.j
  store ptr %i.ao, ptr %i.g, align 8, !tbaa !144
...
bb.n:                                             ; preds = %bb.i
  ...
  store i64 -1, ptr %i.at, align 8, !tbaa !91
  %i.au = getelementptr i8, ptr %i.h, i64 -16     ; 3 uses
  %.val.i.i = load i64, ptr %i.au, align 8, !tbaa !93
  %.not3.i.i = icmp eq i64 %.val.i.i, 0
...
bb.o:                                             ; preds = %bb.n
  ...
  store i64 %i.bo, ptr %i.au, align 8, !tbaa !93
  store i64 %i.bb, ptr %i.ay, align 8, !tbaa !96
  ...
  %i.bu = add i64 %i.bt, 1
  store i64 %i.bu, ptr %i.bs, align 8, !tbaa !102
...
bb.q:                                             ; preds = %._crit_edge.i, %.lr.ph116.i
  ...
  %i.cg = load i64, ptr %i.cf, align 8, !tbaa !89
  %i.ch = add i64 %i.cg, -1                       ; 3 uses
  store i64 %i.ch, ptr %i.cf, align 8, !tbaa !89
  %i.ci = icmp eq i64 %i.ch, 0
  %i.cj = getelementptr [8 x i8], ptr %i.d, i64 %.1115.i
  %i.ck = load i64, ptr %i.cj, align 8, !tbaa !89 ; 2 uses
...
.lr.ph.preheader.i:                               ; preds = %bb.r
  tail call void @llvm.memmove.p0.p0.i64(ptr align 8 %scevgep.i, ptr align 8 %scevgep126.i, i64 %i.ce, i1 false), !tbaa !89
  br label %._crit_edge.i

._crit_edge.i:                                    ; preds = %.lr.ph.preheader.i, %bb.r
  store i64 %i.ck, ptr %i.cb, align 8, !tbaa !89
  %i.cm = sub i64 %.val.i, %.1115.i
  store i64 %i.cm, ptr %i.cf, align 8, !tbaa !89
  %.1.i = add nsw i64 %.1115.i, -1
  %indvar.next.i = add nuw i64 %indvar.i, 1       ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvar.next.i, %i.k
  br i1 %exitcond.not.i, label %Py_DECREF.exit104.i, label %bb.q, !llvm.loop !203

bb.s:                                             ; preds = %bb.q
  %i.cn = getelementptr [8 x i8], ptr %i.d, i64 %.1115.i
  %i.co = sub i64 %.val.i, %i.ch
  %i.cp = getelementptr [8 x i8], ptr %i.d, i64 %i.co ; 2 uses
  %i.cq = load i64, ptr %i.cp, align 8, !tbaa !89
  store i64 %i.cq, ptr %i.cn, align 8, !tbaa !89
  store i64 %i.ck, ptr %i.cp, align 8, !tbaa !89
...
Py_DECREF.exit.i:                                 ; preds = %bb.w, %bb.v, %Py_INCREF.exit.i
  ...
  br i1 %exitcond127.not.i, label %.loopexit.i, label %bb.t, !llvm.loop !204
