...
.critedge.i:                                      ; preds = %.lr.ph
  %lsr.iv73.lcssa = phi i64 [ %lsr.iv72, %.lr.ph ]
  %lsr.iv58.lcssa = phi i2 [ %lsr.iv58, %.lr.ph ]
...
.lr.ph.i.prol.preheader:                          ; preds = %.lr.ph.i.preheader
  %i.ck = zext i2 %lsr.iv58.lcssa to i64
...
bb.q:                                             ; preds = %Py_DECREF.exit.i, %.lr.ph90.i
  %lsr.iv74 = phi i64 [ %lsr.iv.next75, %Py_DECREF.exit.i ], [ %lsr.iv73.lcssa, %.lr.ph90.i ] ; 3 uses
...
bb.r:                                             ; preds = %Py_DECREF.exit.i, %.lr.ph.i
  %lsr.iv33 = phi i64 [ %lsr.iv.next34, %Py_DECREF.exit.i ], [ %lsr.iv.lcssa, %.lr.ph.i ] ; 3 uses
...
bb.s:                                             ; preds = %bb.q
  %lsr.iv62.lcssa = phi i64 [ %lsr.iv62, %bb.q ]
...
bb.t:                                             ; preds = %Py_DECREF.exit.i, %.lr.ph120.i
  %lsr.iv64 = phi i64 [ %lsr.iv.next65, %Py_DECREF.exit.i ], [ %lsr.iv62.lcssa, %.lr.ph120.i ] ; 3 uses
