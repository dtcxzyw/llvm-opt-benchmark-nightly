...
define internal fastcc ptr @get_base_by_token_recursive(ptr nofree noundef readonly captures(none) %0, ptr nofree noundef readnone captures(address) %1) unnamed_addr #13 {
bb.a:
...
define dso_local range(i32 -1, 2) i32 @PyType_GetBaseByToken(ptr noundef %0, ptr nofree noundef readnone captures(address) %1, ptr nofree noundef writeonly captures(address_is_null) %2) local_unnamed_addr #1 {
bb.a:
...
define dso_local ptr @PyObject_GetTypeData(ptr nofree noundef readnone captures(ret: address, provenance) %0, ptr nofree noundef readonly captures(none) %1) local_unnamed_addr #4 {
bb.a:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none, target_mem: none) uwtable
define dso_local range(i64 0, -9223372036854775808) i64 @PyType_GetTypeDataSize(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #4 {
bb.a:
...
; Function Attrs: nounwind uwtable
define dso_local ptr @PyObject_GetItemData(ptr nofree noundef readonly captures(ret: address, provenance) %0) local_unnamed_addr #1 {
bb.a:
...
; Function Attrs: nounwind uwtable
define hidden ptr @_PyType_LookupRefAndVersion(ptr noundef %0, ptr noundef %1, ptr nofree noundef writeonly captures(address_is_null) %2) local_unnamed_addr #1 {
bb.a:
...
; Function Attrs: nounwind uwtable
define internal fastcc ptr @find_name_in_mro(ptr noundef %0, ptr noundef %1, ptr nofree noundef nonnull writeonly captures(none) %2) unnamed_addr #1 {
bb.a:
