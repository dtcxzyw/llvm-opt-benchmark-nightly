...
PyType_IsSubtype.exit.thread56:                   ; preds = %.lr.ph.i.i, %.preheader.i.i, %.lr.ph.i.i45, %.preheader.i.i48, %PyType_IsSubtype.exit, %bb.k, %PyType_IsSubtype.exit51
  %.334 = phi ptr [ %i.am, %PyType_IsSubtype.exit51 ], [ %i.am, %bb.k ], [ %.03175, %PyType_IsSubtype.exit ], [ %i.am, %.lr.ph.i.i45 ], [ %.03175, %.preheader.i.i ], [ %i.am, %.preheader.i.i48 ], [ %.03175, %.lr.ph.i.i ]
  %.330 = phi ptr [ %i.f, %PyType_IsSubtype.exit51 ], [ %i.f, %bb.k ], [ %.02776, %PyType_IsSubtype.exit ], [ %i.f, %.lr.ph.i.i45 ], [ %.02776, %.preheader.i.i ], [ %i.f, %.preheader.i.i48 ], [ %.02776, %.lr.ph.i.i ] ; 2 uses
...
bb.k:                                             ; preds = %Py_XDECREF.exit
  %i.q = tail call ptr @PyStaticMethod_New(ptr noundef nonnull %i.p) #25 ; 3 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  br i1 %i.t, label %bb.m, label %Py_DECREF.exit60
...
Py_DECREF.exit60:                                 ; preds = %bb.m, %bb.l, %bb.k, %bb.n, %bb.d
  ...
  br i1 %i.v, label %.critedge, label %bb.o

bb.o:                                             ; preds = %Py_DECREF.exit60
...
bb.t:                                             ; preds = %bb.s
  tail call void @_Py_Dealloc(ptr noundef nonnull %.239) #25
  br label %.critedge
...
bb.x:                                             ; preds = %lookup_tp_dict.exit
  %i.ax = tail call i32 @PyDict_SetDefaultRef(ptr noundef %.0.i, ptr noundef %.036, ptr noundef nonnull %.239, ptr noundef null) #25
  br label %bb.z

bb.y:                                             ; preds = %lookup_tp_dict.exit
  %i.ay = tail call i32 @PyDict_SetItem(ptr noundef %.0.i, ptr noundef %.036, ptr noundef nonnull %.239) #25
  br label %bb.z

bb.z:                                             ; preds = %bb.y, %bb.x
  %.035.in = phi i32 [ %i.ay, %bb.y ], [ %i.ax, %bb.x ]
  br i1 %.242, label %bb.aa, label %Py_DECREF.exit56
...
.critedge:                                        ; preds = %bb.t, %bb.s, %bb.r, %Py_XDECREF.exit, %bb.g, %Py_DECREF.exit, %Py_DECREF.exit60, %bb.c
  %.4 = phi i32 [ -1, %bb.c ], [ -1, %bb.g ], [ -1, %Py_DECREF.exit60 ], [ -1, %Py_XDECREF.exit ], [ %.035.in.lobit, %Py_DECREF.exit ], [ -1, %bb.r ], [ -1, %bb.s ], [ -1, %bb.t ]
  ret i32 %.4
}
...
.critedge:                                        ; preds = %.critedge.sink.split, %bb.q, %bb.w, %._crit_edge, %bb.l, %set_tp_mro.exit, %_PyType_HasSubclasses.exit, %bb.t, %bb.a
  %.2 = phi i32 [ %i.b, %bb.a ], [ %i.h, %_PyType_HasSubclasses.exit ], [ -1, %bb.t ], [ %.235, %bb.w ], [ -1, %set_tp_mro.exit ], [ -1, %bb.l ], [ %i.h, %bb.q ], [ %.235, %._crit_edge ], [ %.2.ph, %.critedge.sink.split ]
...
Py_DECREF.exit98:                                 ; preds = %bb.bv, %bb.bu, %Py_DECREF.exit100, %bb.ai, %.critedge
  %.470 = phi ptr [ %.066, %.critedge ], [ %.066, %bb.ai ], [ %.268, %Py_DECREF.exit100 ], [ %.268, %bb.bu ], [ %.268, %bb.bv ] ; 3 uses
...
.critedge96:                                      ; preds = %Py_DECREF.exit102, %bb.bs, %bb.bt, %bb.bx, %bb.bw, %Py_DECREF.exit98, %Py_DECREF.exit106.thread, %bb.ao, %bb.an, %Py_DECREF.exit122, %bb.x, %bb.w, %_PyType_GetSlotNames.exit.thread, %Py_DECREF.exit124, %bb.g, %bb.c
  %.7 = phi ptr [ null, %bb.c ], [ null, %bb.x ], [ null, %bb.ao ], [ null, %bb.g ], [ null, %Py_DECREF.exit124 ], [ %.470, %bb.bx ], [ null, %Py_DECREF.exit106.thread ], [ null, %_PyType_GetSlotNames.exit.thread ], [ null, %bb.w ], [ null, %Py_DECREF.exit122 ], [ null, %bb.an ], [ %.470, %Py_DECREF.exit98 ], [ %.470, %bb.bw ], [ null, %bb.bt ], [ null, %bb.bs ], [ null, %Py_DECREF.exit102 ]
  ret ptr %.7
}
...
Py_XDECREF.exit147.thread.i:                      ; preds = %bb.dd, %Py_XDECREF.exit147.i, %Py_DECREF.exit87.i, %bb.cg, %bb.cf, %._crit_edge.thread.i
  %.046200.i = phi ptr [ %i.fb, %Py_XDECREF.exit147.i ], [ %i.fb, %bb.dd ], [ %i.fb, %bb.cg ], [ %i.fb, %bb.cf ], [ %i.fb, %._crit_edge.thread.i ], [ %i.hc, %Py_DECREF.exit87.i ] ; 10 uses
  %.149199.i = phi ptr [ %i.fv, %Py_XDECREF.exit147.i ], [ %i.fv, %bb.dd ], [ %i.fv, %bb.cg ], [ %i.fv, %bb.cf ], [ %i.fv, %._crit_edge.thread.i ], [ %i.hn, %Py_DECREF.exit87.i ] ; 10 uses
  %i.ik = phi i32 [ 0, %Py_XDECREF.exit147.i ], [ %i.ij, %bb.dd ], [ 0, %bb.cg ], [ 0, %bb.cf ], [ 0, %._crit_edge.thread.i ], [ 0, %Py_DECREF.exit87.i ]
...
bb.f:                                             ; preds = %bb.e
  %i.n = tail call i64 %i.m(ptr noundef nonnull %0) #25 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  %i.n = call i64 %i.m(ptr noundef nonnull %0) #25 ; 2 uses
  %i.o = icmp sgt i64 %i.n, -1
  %.015.i = add nsw i64 %i.n, %i.f
  br i1 %i.o, label %getindex.exit, label %getindex.exit.thread
...
bb.h:                                             ; preds = %bb.g
  %i.r = tail call i64 %i.q(ptr noundef nonnull %0) #25 ; 2 uses
