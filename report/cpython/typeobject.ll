...
bb.i:                                             ; preds = %bb.o, %.preheader.i
  %lsr.iv81 = phi i64 [ %lsr.iv.next82, %bb.o ], [ %lsr.iv.lcssa, %.preheader.i ] ; 2 uses
...
.lr.ph6.i:                                        ; preds = %.lr.ph6.i.preheader, %bb.d
  %.1224.i = phi ptr [ %i.q, %bb.d ], [ %i.j, %.lr.ph6.i.preheader ] ; 4 uses
...
.lr.ph6.i..critedge.i.loopexit_crit_edge:         ; preds = %.lr.ph6.i
  %.1224.i.lcssa = phi ptr [ %.1224.i, %.lr.ph6.i ]
  %.1224.i.lcssa.a = phi ptr [ %.1224.i, %.lr.ph6.i ] ; 0 uses
  br label %.critedge.i.loopexit

.critedge.i.loopexit:                             ; preds = %.critedge.i.loopexitsplit, %.lr.ph6.i..critedge.i.loopexit_crit_edge
  %.122.lcssa.i.ph = phi ptr [ %.1224.i.lcssa, %.lr.ph6.i..critedge.i.loopexit_crit_edge ], [ %.lcssa, %.critedge.i.loopexitsplit ]
  br label %.critedge.i
...
.lr.ph6.i.i.i:                                    ; preds = %.lr.ph6.i.i.i.preheader, %bb.aa
  %.1224.i.i.i = phi ptr [ %i.dg, %bb.aa ], [ %i.cz, %.lr.ph6.i.i.i.preheader ] ; 4 uses
...
.lr.ph6.i.i.i..critedge.i.i.i.loopexit_crit_edge: ; preds = %.lr.ph6.i.i.i
  %.1224.i.i.i.lcssa = phi ptr [ %.1224.i.i.i, %.lr.ph6.i.i.i ]
  %.1224.i.i.i.lcssa.a = phi ptr [ %.1224.i.i.i, %.lr.ph6.i.i.i ] ; 0 uses
  br label %.critedge.i.i.i.loopexit

.critedge.i.i.i.loopexit:                         ; preds = %.critedge.i.i.i.loopexitsplit, %.lr.ph6.i.i.i..critedge.i.i.i.loopexit_crit_edge
  %.122.lcssa.i.i.i.ph = phi ptr [ %.1224.i.i.i.lcssa, %.lr.ph6.i.i.i..critedge.i.i.i.loopexit_crit_edge ], [ %.lcssa, %.critedge.i.i.i.loopexitsplit ]
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %bb.c
  %.0275.i.i = phi i64 [ %i.k, %bb.c ], [ 0, %.lr.ph.i.i.preheader ] ; 4 uses
...
._crit_edge.loopexit.i.isplit:                    ; preds = %bb.c
  %.027.lcssa.ph.i.i.ph = phi i64 [ %i.f, %bb.c ]
  br label %._crit_edge.loopexit.i.i

.lr.ph.i.i.._crit_edge.loopexit.i.i_crit_edge:    ; preds = %.lr.ph.i.i
  %.0275.i.i.lcssa = phi i64 [ %.0275.i.i, %.lr.ph.i.i ]
  %.0275.i.i.lcssa.a = phi i64 [ %.0275.i.i, %.lr.ph.i.i ] ; 0 uses
  br label %._crit_edge.loopexit.i.i

._crit_edge.loopexit.i.i:                         ; preds = %._crit_edge.loopexit.i.isplit, %.lr.ph.i.i.._crit_edge.loopexit.i.i_crit_edge
  %.027.lcssa.ph.i.i = phi i64 [ %.0275.i.i.lcssa, %.lr.ph.i.i.._crit_edge.loopexit.i.i_crit_edge ], [ %.027.lcssa.ph.i.i.ph, %._crit_edge.loopexit.i.isplit ]
