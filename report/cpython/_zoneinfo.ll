...
.lr.ph343:                                        ; preds = %.lr.ph343.preheader, %bb.ab
  ...
  %.0227342 = phi i64 [ %i.cu, %bb.ab ], [ 0, %.lr.ph343.preheader ] ; 5 uses
...
bb.ac:                                            ; preds = %.lr.ph343
  %i.cu = add nuw i64 %.0227342, 1                ; 3 uses
...
.loopexit328.loopexitsplit:                       ; preds = %bb.ac
  %.0227342.lcssa469 = phi i64 [ %.0227342, %bb.ac ]
  %3 = add i64 %.0227342.lcssa469, 1
  br label %.loopexit328.loopexit

.lr.ph343..loopexit328.loopexit_crit_edge:        ; preds = %.lr.ph343
  %.0227342.lcssa.a = phi i64 [ %.0227342, %.lr.ph343 ]
  br label %.loopexit328.loopexit

.loopexit328.loopexit:                            ; preds = %.loopexit328.loopexitsplit, %.lr.ph343..loopexit328.loopexit_crit_edge
  %.3.ph.ph = phi i64 [ %.0227342.lcssa.a, %.lr.ph343..loopexit328.loopexit_crit_edge ], [ %3, %.loopexit328.loopexitsplit ]
