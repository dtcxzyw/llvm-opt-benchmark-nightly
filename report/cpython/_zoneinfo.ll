...
parse_digits.exit38.thread.i:                     ; preds = %.preheader76.i
  ...
  %i.dm = load i8, ptr %scevgep140.i, align 1, !tbaa !19
...
parse_digits.exit43.thread.i:                     ; preds = %.preheader.i57
  ...
  %i.dv = load i8, ptr %scevgep141.i, align 1, !tbaa !19
...
bb.x:                                             ; preds = %parse_digits.exit43.thread.i
  ...
  store ptr %i.dx, ptr %i.a, align 8, !tbaa !95
...
bb.z:                                             ; preds = %bb.y
  %i.eb = load i32, ptr %i.b, align 4, !tbaa !12
  %i.ec = load i32, ptr %i.c, align 4, !tbaa !12
  %i.ed = load i32, ptr %i.d, align 4, !tbaa !12
...
bb.ab:                                            ; preds = %bb.v
  ...
  %.pre.i = load i8, ptr %i.ef, align 1, !tbaa !19
  br label %bb.ac
...
.lr.ph121.1.i:                                    ; preds = %.lr.ph121.preheader.i
  ...
  %i.ey = load i8, ptr %i.ex, align 1, !tbaa !19  ; 2 uses
...
parse_digits.exit48.thread.i:                     ; preds = %parse_digits.exit48.thread.loopexit.i, %.lr.ph121.1.i, %.lr.ph121.preheader.i
  ...
  %i.fh = load i8, ptr %.lcssa116.ph.sink.i, align 1, !tbaa !19
...
bb.ad:                                            ; preds = %parse_digits.exit48.thread.i
  ...
  store ptr %i.fj, ptr %i.a, align 8, !tbaa !95
...
bb.af:                                            ; preds = %bb.ae
  ...
  %i.fo = load i32, ptr %i.c, align 4, !tbaa !12
  %i.fp = load i32, ptr %i.d, align 4, !tbaa !12
...
bb.ag:                                            ; preds = %bb.aw, %bb.af
  ...
  %i.fs = load ptr, ptr @PyExc_ValueError, align 8, !tbaa !17
...
bb.ai:                                            ; preds = %bb.ax, %bb.ah
  ...
  %i.fv = load ptr, ptr @PyExc_ValueError, align 8, !tbaa !17
...
bb.ak:                                            ; preds = %bb.ah
  ...
  store ptr @dayrule_year_to_timestamp, ptr %i.fl, align 8, !tbaa !18
  %.sroa.4.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.fl, i64 8
  store i8 %i.fy, ptr %.sroa.4.0..sroa_idx.i.i, align 8, !tbaa !19
  ...
  store i16 %i.fz, ptr %.sroa.6.0..sroa_idx.i.i, align 2, !tbaa !20
  %.sroa.7.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.fl, i64 12
  store i16 %i.ga, ptr %.sroa.7.0..sroa_idx.i.i, align 4, !tbaa !20
  %.sroa.8.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.fl, i64 14
  store i8 %i.gb, ptr %.sroa.8.0..sroa_idx.i.i, align 2, !tbaa !19
  %.sroa.9.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.fl, i64 15
  store i8 %i.gc, ptr %.sroa.9.0..sroa_idx.i.i, align 1, !tbaa !19
  br label %bb.am

.loopexit:                                        ; preds = %bb.av, %bb.au, %bb.at, %bb.ar, %bb.aq, %.preheader.i57.1, %parse_digits.exit38.thread.i.1, %.preheader76.i.1, %.lr.ph.preheader.i.1, %bb.ap, %bb.ac, %bb.w, %bb.ae, %.preheader.i57, %.lr.ph.preheader.i, %bb.ad, %parse_digits.exit38.thread.i, %.preheader76.i, %bb.y, %bb.x
...
bb.al:                                            ; preds = %.loopexit, %bb.aa, %bb.aj
  ...
  %i.gd = load ptr, ptr @PyExc_ValueError, align 8, !tbaa !17
...
bb.am:                                            ; preds = %bb.ak, %bb.z
  ...
  %i.gf = load ptr, ptr %i.a, align 8, !tbaa !95  ; 7 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #9
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #9
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #9
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #9
...
bb.an:                                            ; preds = %bb.am
  ...
  %i.gi = load i8, ptr %i.gh, align 1, !tbaa !19  ; 2 uses
...
bb.ao:                                            ; preds = %bb.an
  ...
  %.pre.i.1 = load i8, ptr %i.gj, align 1, !tbaa !19
  br label %bb.at

bb.ap:                                            ; preds = %bb.an
  %i.gk = getelementptr i8, ptr %i.gf, i64 2
  %i.gl = load i8, ptr %i.gk, align 1, !tbaa !19  ; 2 uses
...
.lr.ph.preheader.i.1:                             ; preds = %bb.ap
  ...
  %i.gt = load i8, ptr %i.gs, align 1, !tbaa !19  ; 2 uses
  %i.gu = zext i8 %i.gt to i64
  %i.gv = getelementptr [4 x i8], ptr @_Py_ctype_table, i64 %i.gu
  %i.gw = load i32, ptr %i.gv, align 4, !tbaa !12
  %i.gx = and i32 %i.gw, 4
  ...
  %i.hd = load i8, ptr %i.hc, align 1, !tbaa !19
...
.preheader76.i.1:                                 ; preds = %.lr.ph.preheader.i.1
  ...
  %i.hf = load i8, ptr %i.he, align 1, !tbaa !19  ; 2 uses
...
parse_digits.exit38.thread.i.1:                   ; preds = %.preheader76.i.1
  ...
  %i.hm = load i8, ptr %scevgep140.i.1, align 1, !tbaa !19
...
parse_digits.exit43.thread.i.1:                   ; preds = %.preheader.i57.1
  ...
  %i.hv = load i8, ptr %scevgep141.i.1, align 1, !tbaa !19
...
bb.aq:                                            ; preds = %parse_digits.exit43.thread.i.1
  ...
  store ptr %i.hx, ptr %i.a, align 8, !tbaa !95
...
bb.as:                                            ; preds = %bb.ar
  %i.ib = load i32, ptr %i.b, align 4, !tbaa !12
  %i.ic = load i32, ptr %i.c, align 4, !tbaa !12
  %i.id = load i32, ptr %i.d, align 4, !tbaa !12
...
bb.at:                                            ; preds = %bb.ao, %bb.an
  ...
  %i.ii = load i32, ptr %i.ih, align 4, !tbaa !12
  %i.ij = and i32 %i.ii, 4
...
.lr.ph121.preheader.i.1:                          ; preds = %bb.at
  ...
  %i.in = load i8, ptr %i.im, align 1, !tbaa !19  ; 3 uses
...
.lr.ph121.1.i.1:                                  ; preds = %.lr.ph121.preheader.i.1
  ...
  %i.ix = load i8, ptr %i.iw, align 1, !tbaa !19  ; 3 uses
...
parse_digits.exit48.thread.loopexit.i.1:          ; preds = %.lr.ph121.1.i.1
  ...
  %.pre = load i8, ptr %scevgep142.i.1, align 1, !tbaa !19
...
bb.au:                                            ; preds = %parse_digits.exit48.thread.i.1
  ...
  store ptr %i.ji, ptr %i.a, align 8, !tbaa !95
