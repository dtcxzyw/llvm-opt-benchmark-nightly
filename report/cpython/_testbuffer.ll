...
vector.body179:                                   ; preds = %vector.body179, %vector.ph176
  ...
  %i.cl = getelementptr [8 x i8], ptr %i.cb, i64 %index180 ; 2 uses
  %i.cm = getelementptr i8, ptr %i.cl, i64 16
  %wide.load181 = load <2 x i64>, ptr %i.cl, align 8, !tbaa !17
  %wide.load182 = load <2 x i64>, ptr %i.cm, align 8, !tbaa !17
  %i.cn = getelementptr [8 x i8], ptr %i.bf, i64 %index180 ; 2 uses
  %i.co = getelementptr i8, ptr %i.cn, i64 16
  store <2 x i64> %wide.load181, ptr %i.cn, align 8, !tbaa !17
  store <2 x i64> %wide.load182, ptr %i.co, align 8, !tbaa !17
  %i.cp = getelementptr [8 x i8], ptr %i.cd, i64 %index180 ; 2 uses
  %i.cq = getelementptr i8, ptr %i.cp, i64 16
  %wide.load183 = load <2 x i64>, ptr %i.cp, align 8, !tbaa !17
  %wide.load184 = load <2 x i64>, ptr %i.cq, align 8, !tbaa !17
  %i.cr = getelementptr [8 x i8], ptr %i.bk, i64 %index180 ; 2 uses
  %i.cs = getelementptr i8, ptr %i.cr, i64 16
  store <2 x i64> %wide.load183, ptr %i.cr, align 8, !tbaa !17
  store <2 x i64> %wide.load184, ptr %i.cs, align 8, !tbaa !17
  %index.next185 = add nuw i64 %index180, 4       ; 2 uses
  %i.ct = icmp eq i64 %index.next185, %n.vec178
...
.loopexit:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %.lr.ph.split.us.i.prol.loopexit, %.lr.ph.split.us.i, %middle.block, %middle.block186, %.thread52.i, %bb.t
  %.03655.i = phi ptr [ null, %.thread52.i ], [ null, %middle.block186 ], [ %i.bs, %bb.t ], [ %i.bs, %middle.block ], [ null, %.lr.ph.split.us.i.prol.loopexit ], [ null, %.lr.ph.split.us.i ], [ %i.bs, %scalar.ph ], [ %i.bs, %scalar.ph.prol.loopexit ]
...
.lr.ph.i78.preheader:                             ; preds = %.thread
  %min.iters.check192 = icmp ult i32 %i.je, 8
  br i1 %min.iters.check192, label %.lr.ph.i78.preheader205, label %vector.memcheck189

vector.memcheck189:                               ; preds = %.lr.ph.i78.preheader
  %scevgep = getelementptr i8, ptr %i.ai, i64 104
  %i.jg = shl nuw nsw i64 %4, 3
  %scevgep190 = getelementptr i8, ptr %i.jc, i64 %i.jg
  %bound0 = icmp ult ptr %i.jd, %scevgep190
  %bound1 = icmp ult ptr %i.jc, %scevgep
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %.lr.ph.i78.preheader205, label %vector.ph193

vector.ph193:                                     ; preds = %vector.memcheck189
  %n.vec195 = and i64 %4, 2147483644              ; 3 uses
  br label %vector.body196

vector.body196:                                   ; preds = %vector.body196, %vector.ph193
  %index197 = phi i64 [ 0, %vector.ph193 ], [ %index.next201, %vector.body196 ] ; 2 uses
  %vec.phi = phi <2 x i64> [ splat (i64 1), %vector.ph193 ], [ %i.jj, %vector.body196 ]
  %vec.phi198 = phi <2 x i64> [ splat (i64 1), %vector.ph193 ], [ %i.jk, %vector.body196 ]
  %i.jh = getelementptr [8 x i8], ptr %i.jc, i64 %index197 ; 2 uses
  %i.ji = getelementptr i8, ptr %i.jh, i64 16
  %wide.load199 = load <2 x i64>, ptr %i.jh, align 8, !tbaa !17, !alias.scope !70
  %wide.load200 = load <2 x i64>, ptr %i.ji, align 8, !tbaa !17, !alias.scope !70
  %i.jj = mul <2 x i64> %wide.load199, %vec.phi   ; 2 uses
  %i.jk = mul <2 x i64> %wide.load200, %vec.phi198 ; 2 uses
  %index.next201 = add nuw i64 %index197, 4       ; 2 uses
  %i.jl = icmp eq i64 %index.next201, %n.vec195
  br i1 %i.jl, label %middle.block202, label %vector.body196, !llvm.loop !73
...
middle.block202:                                  ; preds = %vector.body196
  ...
  %cmp.n203 = icmp eq i64 %n.vec195, %4
  br i1 %cmp.n203, label %init_len.exit.thread, label %.lr.ph.i78.preheader205
...
.lr.ph.i78.prol:                                  ; preds = %.lr.ph.i78.preheader205, %.lr.ph.i78.prol
  %i.jn = phi i64 [ %i.jq, %.lr.ph.i78.prol ], [ %.ph, %.lr.ph.i78.preheader205 ]
  %.08.i.prol = phi i64 [ %i.jr, %.lr.ph.i78.prol ], [ %.08.i.ph, %.lr.ph.i78.preheader205 ] ; 2 uses
  %prol.iter = phi i64 [ %prol.iter.next, %.lr.ph.i78.prol ], [ 0, %.lr.ph.i78.preheader205 ]
...
.lr.ph.i78.prol.loopexit:                         ; preds = %.lr.ph.i78.prol, %.lr.ph.i78.preheader205
  %.lcssa206.unr = phi i64 [ poison, %.lr.ph.i78.preheader205 ], [ %i.jq, %.lr.ph.i78.prol ]
  %.unr = phi i64 [ %.ph, %.lr.ph.i78.preheader205 ], [ %i.jq, %.lr.ph.i78.prol ]
  %.08.i.unr = phi i64 [ %.08.i.ph, %.lr.ph.i78.preheader205 ], [ %i.jr, %.lr.ph.i78.prol ]
...
init_len.exit.thread:                             ; preds = %.lr.ph.i78.prol.loopexit, %.lr.ph.i78, %middle.block202
  %.lcssa = phi i64 [ %i.jm, %middle.block202 ], [ %.lcssa206.unr, %.lr.ph.i78.prol.loopexit ], [ %i.kj, %.lr.ph.i78 ]
...
begin_hunk_1_@ndarray_push_base:bb.a
  ...
  br i1 %lcmp.mod148.not, label %._crit_edge145.i.i.i, label %.epil.preheader
...
.epil.preheader:                                  ; preds = %._crit_edge145.i.i.i.loopexit.unr-lcssa, %.lr.ph144.i.i.i
  ...
  %lcmp.mod149 = trunc i64 %.val124.i.i.i to i1
...
bb.bs:                                            ; preds = %.epil.preheader
  ...
  br i1 %i.iu, label %._crit_edge145.i.i.i, label %bb.bt
...
bb.bu:                                            ; preds = %._crit_edge145.i.i.i
  ...
  br i1 %i.iy, label %bb.bv, label %Py_DECREF.exit94.i.i.i
...
bb.bw:                                            ; preds = %Py_DECREF.exit94.i.i.i
  ...
  br i1 %i.jb, label %bb.bx, label %Py_DECREF.exit92.i.i.i
...
bb.bz:                                            ; preds = %pack_from_list.exit.i.i
  ...
  br i1 %i.jh, label %bb.ca, label %Py_DECREF.exit.i.i
...
Py_DECREF.exit.i.i:                               ; preds = %bb.ca, %bb.bz, %pack_from_list.exit.i.i
  ...
  br i1 %i.ji, label %init_simple.exit.thread.i, label %bb.cb
...
bb.cb:                                            ; preds = %Py_DECREF.exit.i.i
  ...
  br i1 %i.jn, label %init_simple.exit.thread123.i, label %bb.cc
...
bb.cc:                                            ; preds = %bb.cb
  ...
  br i1 %i.jr, label %bb.cd, label %bb.cf
...
bb.cd:                                            ; preds = %bb.cc
  ...
  br i1 %.not.i12.i.i.i, label %bb.ce, label %init_simple.exit.thread123.i
...
init_simple.exit.thread200.i:                     ; preds = %bb.ce
...
bb.cf:                                            ; preds = %bb.cc
  ...
  br i1 %.not.i.i18.i.i, label %bb.cg, label %init_simple.exit.thread127.i
...
init_simple.exit.thread123.i:                     ; preds = %bb.ce, %bb.cd, %bb.cb
  store ptr null, ptr %i.bs, align 8, !tbaa !38
  br label %init_simple.exit.thread.i

init_simple.exit.i:                               ; preds = %bb.cg
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.jm) #15
  br label %init_simple.exit.thread127.i

init_simple.exit.thread127.i:                     ; preds = %init_simple.exit.i, %bb.cg, %bb.cf
  store ptr %i.jq, ptr %i.bs, align 8, !tbaa !38
  %i.kb = trunc i64 %i.e to i32
  store i32 %i.kb, ptr %i.bt, align 4, !tbaa !27
  br i1 %i.ab, label %bb.ch, label %bb.ck

bb.ch:                                            ; preds = %init_simple.exit.thread127.i
  %i.kc = load i32, ptr %i.bl, align 8, !tbaa !49 ; 2 uses
  %i.kd = and i32 %i.kc, 16
  %.not40.i.i = icmp eq i32 %i.kd, 0
  br i1 %.not40.i.i, label %bb.cj, label %bb.ci
...
bb.ck:                                            ; preds = %init_simple.exit.thread127.i
  ...
  br i1 %i.kh, label %init_simple.exit.thread.i, label %bb.cl

bb.cl:                                            ; preds = %bb.ck
  %.not.i110.i = icmp eq ptr %.050.i, null
  br i1 %.not.i110.i, label %bb.cm, label %strides_from_shape.exit.i.i
...
bb.cm:                                            ; preds = %bb.cl
  ...
  br i1 %i.kn, label %strides_from_shape.exit.i.thread132.i, label %bb.cn

strides_from_shape.exit.i.thread132.i:            ; preds = %bb.cm
...
bb.cn:                                            ; preds = %bb.cm
  ...
  br i1 %.not.i.i113.i, label %bb.cq, label %bb.co
...
.lr.ph.i.i.i.new:                                 ; preds = %.lr.ph.i.i.i
  %unroll_iter154 = and i64 %i.kv, -4
  br label %bb.cp

bb.cp:                                            ; preds = %bb.cp, %.lr.ph.i.i.i.new
  %i.kx = phi i64 [ %i.kr, %.lr.ph.i.i.i.new ], [ %i.lt, %bb.cp ]
  %.031.i.i.i = phi i64 [ 1, %.lr.ph.i.i.i.new ], [ %i.lv, %bb.cp ] ; 6 uses
  %niter155 = phi i64 [ 0, %.lr.ph.i.i.i.new ], [ %niter155.next.3, %bb.cp ]
  ...
  br i1 %niter155.ncmp.3, label %strides_from_shape.exit.i.thread.i.loopexit141.unr-lcssa, label %bb.cp, !llvm.loop !110
...
.lr.ph33.i.i.i:                                   ; preds = %bb.cq
  ...
  %scevgep131 = getelementptr i8, ptr %i.mf, i64 8
  %load_initial = load i64, ptr %scevgep131, align 8 ; 2 uses
  %i.mg = add nuw nsw i64 %i.mc, 1
  %xtraiter156 = and i64 %i.mg, 3                 ; 2 uses
  %lcmp.mod157.not = icmp eq i64 %xtraiter156, 0
  br i1 %lcmp.mod157.not, label %.prol.loopexit, label %.prol.preheader
...
.prol.preheader:                                  ; preds = %.lr.ph33.i.i.i, %.prol.preheader
  ...
  %prol.iter158 = phi i64 [ %prol.iter158.next, %.prol.preheader ], [ 0, %.lr.ph33.i.i.i ]
  ...
  br i1 %prol.iter158.cmp.not, label %.prol.loopexit, label %.prol.preheader, !llvm.loop !111
...
strides_from_shape.exit.i.thread.i.loopexit141.unr-lcssa: ; preds = %bb.cp
  %lcmp.mod152.not = icmp eq i64 %xtraiter151, 0
  br i1 %lcmp.mod152.not, label %strides_from_shape.exit.i.thread.i, label %.epil.preheader150

.epil.preheader150:                               ; preds = %strides_from_shape.exit.i.thread.i.loopexit141.unr-lcssa, %.lr.ph.i.i.i
  %.epil.init = phi i64 [ %i.kr, %.lr.ph.i.i.i ], [ %i.lt, %strides_from_shape.exit.i.thread.i.loopexit141.unr-lcssa ]
  %.031.i.i.i.epil.init = phi i64 [ 1, %.lr.ph.i.i.i ], [ %i.lv, %strides_from_shape.exit.i.thread.i.loopexit141.unr-lcssa ]
  %lcmp.mod153 = icmp ne i64 %xtraiter151, 0
  tail call void @llvm.assume(i1 %lcmp.mod153)
  br label %bb.cr

bb.cr:                                            ; preds = %bb.cr, %.epil.preheader150
  %i.nm = phi i64 [ %.epil.init, %.epil.preheader150 ], [ %i.nq, %bb.cr ]
  %.031.i.i.i.epil = phi i64 [ %.031.i.i.i.epil.init, %.epil.preheader150 ], [ %i.ns, %bb.cr ] ; 3 uses
  %epil.iter = phi i64 [ 0, %.epil.preheader150 ], [ %epil.iter.next, %bb.cr ]
  ...
  br i1 %epil.iter.cmp.not, label %strides_from_shape.exit.i.thread.i, label %bb.cr, !llvm.loop !112

strides_from_shape.exit.i.thread.i:               ; preds = %strides_from_shape.exit.i.thread.i.loopexit141.unr-lcssa, %bb.cr, %.prol.loopexit, %.lr.ph33.i.i.i.new, %bb.cq, %bb.co
  %i.nt = getelementptr i8, ptr %i.az, i64 112    ; 2 uses
  store ptr %i.km, ptr %i.nt, align 8, !tbaa !45
  br label %bb.cs

strides_from_shape.exit.i.i:                      ; preds = %bb.cl
  ...
  br i1 %i.nw, label %init_simple.exit.thread.i, label %bb.cs

bb.cs:                                            ; preds = %strides_from_shape.exit.i.i, %strides_from_shape.exit.i.thread.i
...
.lr.ph.i41.i.i:                                   ; preds = %bb.cs, %bb.ct
  %.048.i.i.i = phi i64 [ %i.od, %bb.ct ], [ 0, %bb.cs ] ; 2 uses
  ...
  br i1 %.not.i42.i.i, label %bb.ct, label %verify_structure.exit.i.i

bb.cu:                                            ; preds = %.lr.ph50.i.i.i
...
.lr.ph54.i.i.i.preheader:                         ; preds = %bb.cu
  %min.iters.check93 = icmp ult i64 %i.e, 4
  br i1 %min.iters.check93, label %.lr.ph54.i.i.i.preheader136, label %vector.ph94

vector.ph94:                                      ; preds = %.lr.ph54.i.i.i.preheader
  %n.vec96 = and i64 %i.e, 9223372036854775804    ; 3 uses
  br label %vector.body97

vector.body97:                                    ; preds = %vector.body97, %vector.ph94
  %index98 = phi i64 [ 0, %vector.ph94 ], [ %index.next106, %vector.body97 ] ; 3 uses
  %vec.phi = phi <2 x i64> [ zeroinitializer, %vector.ph94 ], [ %i.oy, %vector.body97 ]
  %vec.phi99 = phi <2 x i64> [ zeroinitializer, %vector.ph94 ], [ %i.oz, %vector.body97 ]
  %vec.phi100 = phi <2 x i64> [ zeroinitializer, %vector.ph94 ], [ %i.ou, %vector.body97 ]
  %vec.phi101 = phi <2 x i64> [ zeroinitializer, %vector.ph94 ], [ %i.ov, %vector.body97 ]
  %i.oi = getelementptr [8 x i8], ptr %.sink.i131.i, i64 %index98 ; 2 uses
  %i.oj = getelementptr i8, ptr %i.oi, i64 16
  %wide.load102 = load <2 x i64>, ptr %i.oi, align 8, !tbaa !17 ; 2 uses
  %wide.load103 = load <2 x i64>, ptr %i.oj, align 8, !tbaa !17 ; 2 uses
  %i.ok = icmp slt <2 x i64> %wide.load102, splat (i64 1) ; 2 uses
  %i.ol = icmp slt <2 x i64> %wide.load103, splat (i64 1) ; 2 uses
  %i.om = getelementptr [8 x i8], ptr %i.ob, i64 %index98 ; 2 uses
  %i.on = getelementptr i8, ptr %i.om, i64 16
  %wide.load104 = load <2 x i64>, ptr %i.om, align 8, !tbaa !17
  %wide.load105 = load <2 x i64>, ptr %i.on, align 8, !tbaa !17
  %i.oo = add <2 x i64> %wide.load104, splat (i64 -1)
  %i.op = add <2 x i64> %wide.load105, splat (i64 -1)
  %i.oq = mul <2 x i64> %i.oo, %wide.load102      ; 2 uses
  %i.or = mul <2 x i64> %i.op, %wide.load103      ; 2 uses
  %i.os = select <2 x i1> %i.ok, <2 x i64> %i.oq, <2 x i64> zeroinitializer
  %i.ot = select <2 x i1> %i.ol, <2 x i64> %i.or, <2 x i64> zeroinitializer
  %i.ou = add <2 x i64> %i.os, %vec.phi100        ; 2 uses
  %i.ov = add <2 x i64> %i.ot, %vec.phi101        ; 2 uses
  ...
  %i.oz = add <2 x i64> %i.ox, %vec.phi99         ; 2 uses
  %index.next106 = add nuw i64 %index98, 4        ; 2 uses
  %i.pa = icmp eq i64 %index.next106, %n.vec96
  br i1 %i.pa, label %middle.block107, label %vector.body97, !llvm.loop !115

middle.block107:                                  ; preds = %vector.body97
  %bin.rdx = add <2 x i64> %i.oz, %i.oy
  %i.pb = tail call i64 @llvm.vector.reduce.add.v2i64(<2 x i64> %bin.rdx) ; 2 uses
  %bin.rdx108 = add <2 x i64> %i.ov, %i.ou
  %i.pc = tail call i64 @llvm.vector.reduce.add.v2i64(<2 x i64> %bin.rdx108) ; 2 uses
  %cmp.n109 = icmp eq i64 %i.e, %n.vec96
  br i1 %cmp.n109, label %._crit_edge.i.i111.i, label %.lr.ph54.i.i.i.preheader136

.lr.ph54.i.i.i.preheader136:                      ; preds = %.lr.ph54.i.i.i.preheader, %middle.block107
  %.253.i.i.i.ph = phi i64 [ 0, %.lr.ph54.i.i.i.preheader ], [ %n.vec96, %middle.block107 ]
  %.03752.i.i.i.ph = phi i64 [ 0, %.lr.ph54.i.i.i.preheader ], [ %i.pb, %middle.block107 ]
  %.03951.i.i.i.ph = phi i64 [ 0, %.lr.ph54.i.i.i.preheader ], [ %i.pc, %middle.block107 ]
  br label %.lr.ph54.i.i.i

.lr.ph50.i.i.i:                                   ; preds = %bb.ct, %bb.cu
  %.149.i.i.i = phi i64 [ %i.oh, %bb.cu ], [ 0, %bb.ct ] ; 2 uses
  %i.pd = getelementptr [8 x i8], ptr %i.ob, i64 %.149.i.i.i
  %i.pe = load i64, ptr %i.pd, align 8, !tbaa !17
  %i.pf = icmp eq i64 %i.pe, 0
  br i1 %i.pf, label %.loopexit.i.i, label %bb.cu

.lr.ph54.i.i.i:                                   ; preds = %.lr.ph54.i.i.i.preheader136, %.lr.ph54.i.i.i
  %.253.i.i.i = phi i64 [ %i.pp, %.lr.ph54.i.i.i ], [ %.253.i.i.i.ph, %.lr.ph54.i.i.i.preheader136 ] ; 3 uses
  %.03752.i.i.i = phi i64 [ %.138.i.i.i, %.lr.ph54.i.i.i ], [ %.03752.i.i.i.ph, %.lr.ph54.i.i.i.preheader136 ]
  %.03951.i.i.i = phi i64 [ %.140.i.i.i, %.lr.ph54.i.i.i ], [ %.03951.i.i.i.ph, %.lr.ph54.i.i.i.preheader136 ]
...
._crit_edge.i.i111.i:                             ; preds = %.lr.ph54.i.i.i, %middle.block107, %bb.cs
  %.039.lcssa.i.i.i = phi i64 [ 0, %bb.cs ], [ %i.pc, %middle.block107 ], [ %.140.i.i.i, %.lr.ph54.i.i.i ]
  %.037.lcssa.i.i.i = phi i64 [ 0, %bb.cs ], [ %i.pb, %middle.block107 ], [ %.138.i.i.i, %.lr.ph54.i.i.i ]
  %i.pq = add i64 %.039.lcssa.i.i.i, %i.oa
  %i.pr = icmp slt i64 %i.pq, 0
  br i1 %i.pr, label %verify_structure.exit.i.i, label %bb.cv

bb.cv:                                            ; preds = %._crit_edge.i.i111.i
...
verify_structure.exit.i.i:                        ; preds = %.lr.ph.i41.i.i, %bb.cv, %._crit_edge.i.i111.i
  %.str.79.sink.i.i.i = phi ptr [ @.str.79, %bb.cv ], [ @.str.79, %._crit_edge.i.i111.i ], [ @.str.78, %.lr.ph.i41.i.i ]
...
.loopexit.i.i:                                    ; preds = %.lr.ph50.i.i.i, %bb.cv
...
.lr.ph.i45.i.i.preheader:                         ; preds = %.loopexit.i.i
  %min.iters.check115 = icmp ult i32 %i.py, 8
  br i1 %min.iters.check115, label %.lr.ph.i45.i.i.preheader132, label %vector.memcheck112

vector.memcheck112:                               ; preds = %.lr.ph.i45.i.i.preheader
  %scevgep = getelementptr i8, ptr %i.az, i64 80
  %i.qa = shl nuw nsw i64 %9, 3
  %scevgep113 = getelementptr i8, ptr %i.ob, i64 %i.qa
  %bound0 = icmp ult ptr %i.bp, %scevgep113
  %bound1 = icmp ult ptr %i.ob, %scevgep
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %.lr.ph.i45.i.i.preheader132, label %vector.ph116

vector.ph116:                                     ; preds = %vector.memcheck112
  %n.vec118 = and i64 %9, 2147483644              ; 3 uses
  br label %vector.body119

vector.body119:                                   ; preds = %vector.body119, %vector.ph116
  %index120 = phi i64 [ 0, %vector.ph116 ], [ %index.next125, %vector.body119 ] ; 2 uses
  %vec.phi121 = phi <2 x i64> [ splat (i64 1), %vector.ph116 ], [ %i.qd, %vector.body119 ]
  %vec.phi122 = phi <2 x i64> [ splat (i64 1), %vector.ph116 ], [ %i.qe, %vector.body119 ]
  %i.qb = getelementptr [8 x i8], ptr %i.ob, i64 %index120 ; 2 uses
  %i.qc = getelementptr i8, ptr %i.qb, i64 16
  %wide.load123 = load <2 x i64>, ptr %i.qb, align 8, !tbaa !17, !alias.scope !117
  %wide.load124 = load <2 x i64>, ptr %i.qc, align 8, !tbaa !17, !alias.scope !117
  %i.qd = mul <2 x i64> %wide.load123, %vec.phi121 ; 2 uses
  %i.qe = mul <2 x i64> %wide.load124, %vec.phi122 ; 2 uses
  %index.next125 = add nuw i64 %index120, 4       ; 2 uses
  %i.qf = icmp eq i64 %index.next125, %n.vec118
  br i1 %i.qf, label %middle.block126, label %vector.body119, !llvm.loop !120

middle.block126:                                  ; preds = %vector.body119
  %bin.rdx127 = mul <2 x i64> %i.qe, %i.qd
  %i.qg = tail call i64 @llvm.vector.reduce.mul.v2i64(<2 x i64> %bin.rdx127) ; 3 uses
  store i64 %i.qg, ptr %i.bp, align 8, !tbaa !40, !alias.scope !121, !noalias !117
  %cmp.n128 = icmp eq i64 %n.vec118, %9
  br i1 %cmp.n128, label %init_len.exit.loopexit.i.i, label %.lr.ph.i45.i.i.preheader132
...
.lr.ph.i45.i.i.prol:                              ; preds = %.lr.ph.i45.i.i.preheader132, %.lr.ph.i45.i.i.prol
  %i.qh = phi i64 [ %i.qk, %.lr.ph.i45.i.i.prol ], [ %.ph, %.lr.ph.i45.i.i.preheader132 ]
  %.08.i.i.i.prol = phi i64 [ %i.ql, %.lr.ph.i45.i.i.prol ], [ %.08.i.i.i.ph, %.lr.ph.i45.i.i.preheader132 ] ; 2 uses
  %prol.iter161 = phi i64 [ %prol.iter161.next, %.lr.ph.i45.i.i.prol ], [ 0, %.lr.ph.i45.i.i.preheader132 ]
  ...
  br i1 %prol.iter161.cmp.not, label %.lr.ph.i45.i.i.prol.loopexit, label %.lr.ph.i45.i.i.prol, !llvm.loop !123

.lr.ph.i45.i.i.prol.loopexit:                     ; preds = %.lr.ph.i45.i.i.prol, %.lr.ph.i45.i.i.preheader132
  %.lcssa133.unr = phi i64 [ poison, %.lr.ph.i45.i.i.preheader132 ], [ %i.qk, %.lr.ph.i45.i.i.prol ]
  %.unr162 = phi i64 [ %.ph, %.lr.ph.i45.i.i.preheader132 ], [ %i.qk, %.lr.ph.i45.i.i.prol ]
  %.08.i.i.i.unr = phi i64 [ %.08.i.i.i.ph, %.lr.ph.i45.i.i.preheader132 ], [ %i.ql, %.lr.ph.i45.i.i.prol ]
...
.lr.ph.i45.i.i:                                   ; preds = %.lr.ph.i45.i.i.prol.loopexit, %.lr.ph.i45.i.i
  %i.qo = phi i64 [ %i.rd, %.lr.ph.i45.i.i ], [ %.unr162, %.lr.ph.i45.i.i.prol.loopexit ]
...
init_len.exit.loopexit.i.i:                       ; preds = %.lr.ph.i45.i.i.prol.loopexit, %.lr.ph.i45.i.i, %middle.block126
  %.lcssa = phi i64 [ %i.qg, %middle.block126 ], [ %.lcssa133.unr, %.lr.ph.i45.i.i.prol.loopexit ], [ %i.rd, %.lr.ph.i45.i.i ]
...
init_len.exit.i.i:                                ; preds = %init_len.exit.loopexit.i.i, %.loopexit.i.i
  ...
  br i1 %.not37.i.i, label %bb.cx, label %bb.cw

bb.cw:                                            ; preds = %init_len.exit.i.i
  %i.ri = load i32, ptr %i.bl, align 8, !tbaa !49
  %i.rj = or i32 %i.ri, 256
  store i32 %i.rj, ptr %i.bl, align 8, !tbaa !49
  br label %bb.cx

bb.cx:                                            ; preds = %bb.cw, %init_len.exit.i.i
  ...
  br i1 %.not38.i.i, label %._crit_edge.i.i, label %bb.cy
...
._crit_edge.i.i:                                  ; preds = %bb.cy, %bb.cx
  %i.rm = phi i32 [ %i.rl, %bb.cy ], [ %.pre.i.i, %bb.cx ]
  %i.rn = and i32 %i.rm, 16
  %.not39.i.i = icmp eq i32 %i.rn, 0
  br i1 %.not39.i.i, label %init_structure.exit.i, label %bb.cz
...
bb.cz:                                            ; preds = %._crit_edge.i.i
  ...
  br i1 %i.rx, label %bb.da, label %bb.db
...
.peel.next.i.i.i:                                 ; preds = %bb.dc, %bb.df
  %.06782.i.i.i = phi i64 [ %.1.i.i.i, %bb.df ], [ %.1.peel.i.i.i, %bb.dc ] ; 3 uses
  %.06881.i.i.i = phi i64 [ %i.sx, %bb.df ], [ 1, %bb.dc ] ; 3 uses
  %.07080.i.i.i = phi i64 [ %.171.i.i.i, %bb.df ], [ 0, %bb.dc ] ; 3 uses
...
bb.df:                                            ; preds = %bb.de, %bb.dd
  %.171.i.i.i = phi i64 [ %i.sw, %bb.de ], [ %.07080.i.i.i, %bb.dd ] ; 2 uses
  %.1.i.i.i = phi i64 [ %i.sv, %bb.de ], [ %.06782.i.i.i, %bb.dd ] ; 2 uses
...
._crit_edge.i47.i.i:                              ; preds = %bb.df, %.peel.next.i.i.i, %bb.dc, %.._crit_edge.i47_crit_edge.i.i
  %i.sy = phi i64 [ %.pre54.i.i, %.._crit_edge.i47_crit_edge.i.i ], [ %i.sk, %bb.dc ], [ %i.sk, %.peel.next.i.i.i ], [ %i.sk, %bb.df ]
  %.070.lcssa.i.i.i = phi i64 [ 0, %.._crit_edge.i47_crit_edge.i.i ], [ 0, %bb.dc ], [ %.171.i.i.i, %bb.df ], [ %.07080.i.i.i, %.peel.next.i.i.i ] ; 3 uses
  %.067.lcssa.i.i.i = phi i64 [ 0, %.._crit_edge.i47_crit_edge.i.i ], [ %.1.peel.i.i.i, %bb.dc ], [ %.1.i.i.i, %bb.df ], [ %.06782.i.i.i, %.peel.next.i.i.i ]
...
.lr.ph91.i.i.i:                                   ; preds = %._crit_edge.i47.i.i
  ...
  %xtraiter164 = and i64 %.pre99.i.i.i, 3         ; 3 uses
  %i.te = icmp ult i64 %.pre99.i.i.i, 4
  br i1 %i.te, label %.epil.preheader163, label %.lr.ph91.i.i.i.new

.lr.ph91.i.i.i.new:                               ; preds = %.lr.ph91.i.i.i
  %unroll_iter168 = and i64 %.pre99.i.i.i, 9223372036854775804
  br label %bb.dg

bb.dg:                                            ; preds = %bb.dg, %.lr.ph91.i.i.i.new
  %.16989.i.i.i = phi i64 [ 0, %.lr.ph91.i.i.i.new ], [ %i.tu, %bb.dg ] ; 6 uses
  %niter169 = phi i64 [ 0, %.lr.ph91.i.i.i.new ], [ %niter169.next.3, %bb.dg ]
