...
begin_hunk_0_@get_pointer:bb.a
  ...
  %i.af = call i64 @PyLong_AsSsize_t(ptr noundef %i.ae) #15 ; 4 uses
  %i.ag = getelementptr [8 x i8], ptr %i.c, i64 %.01740
...
bb.n:                                             ; preds = %bb.m
  ...
  %.not25 = icmp slt i64 %i.af, %i.al
  br i1 %.not25, label %bb.p, label %bb.o

bb.o:                                             ; preds = %bb.n, %bb.m
  %i.am = load ptr, ptr @PyExc_ValueError, align 8, !tbaa !14
  %i.an = call ptr (ptr, ptr, ...) @PyErr_Format(ptr noundef %i.am, ptr noundef nonnull @.str.15, i64 noundef %i.af, i64 noundef %.01740) #15 ; 0 uses
  br label %.thread
