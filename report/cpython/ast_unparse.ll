...
bb.g:                                             ; preds = %bb.e, %bb.f
  %i.n = phi i64 [ %i.m, %bb.f ], [ 0, %bb.e ]    ; 2 uses
  %i.o = add i64 %i.i, %i.d                       ; 5 uses
...
append_ast_arg.exit:                              ; preds = %bb.ac, %bb.aa, %bb.y, %bb.w
  %3 = sub nsw i64 %.076115, %i.o
  %i.cj = add i64 %3, %i.n                        ; 2 uses
...
bb.at:                                            ; preds = %.critedge, %bb.as
  %i.dy = phi i64 [ %i.dx, %bb.as ], [ 0, %.critedge ] ; 5 uses
...
bb.av:                                            ; preds = %bb.at, %bb.au
  %i.ed = phi i64 [ %i.ec, %bb.au ], [ 0, %bb.at ] ; 2 uses
...
append_ast_arg.exit107.peel:                      ; preds = %bb.ba, %bb.ay
  %4 = sub i64 %i.ed, %i.dy                       ; 2 uses
  %i.ev = icmp sgt i64 %4, -1
...
bb.bb:                                            ; preds = %append_ast_arg.exit107.peel
  ...
  %i.ey = getelementptr [8 x i8], ptr %i.ex, i64 %4
...
append_ast_arg.exit107:                           ; preds = %bb.bg, %bb.be
  %5 = sub nsw i64 %.177117, %i.dy
  %i.fu = add i64 %5, %i.ed                       ; 2 uses
