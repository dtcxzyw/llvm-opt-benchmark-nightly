...
.lr.ph235:                                        ; preds = %bb.r, %.lr.ph235
  ...
  br i1 %.not270, label %.thread212.loopexit, label %.lr.ph235, !llvm.loop !330
...
.lr.ph243.prol:                                   ; preds = %.lr.ph243.preheader, %.lr.ph243.prol
  ...
  br i1 %prol.iter288.cmp.not, label %.lr.ph243.prol.loopexit, label %.lr.ph243.prol, !llvm.loop !331
...
.lr.ph243:                                        ; preds = %.lr.ph243.prol.loopexit, %.lr.ph243
  ...
  br i1 %i.jv, label %.lr.ph243, label %._crit_edge244, !llvm.loop !332
