...
begin_hunk_0_@long_true_divide:bb.a
  %.val194 = load i64, ptr %i.f, align 8, !tbaa !35
...
bb.c:                                             ; preds = %bb.b
  ...
  %.val191 = load i64, ptr %i.h, align 8, !tbaa !25 ; 4 uses
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader, %.lr.ph.prol
  %.0121224.prol = phi i64 [ %i.ai, %.lr.ph.prol ], [ %i.ab, %.lr.ph.preheader ]
  %.0129223.prol = phi double [ %i.am, %.lr.ph.prol ], [ %i.ae, %.lr.ph.preheader ]
  %prol.iter = phi i64 [ %prol.iter.next, %.lr.ph.prol ], [ 0, %.lr.ph.preheader ]
  %i.ai = add nsw i64 %.0121224.prol, -1          ; 3 uses
  %i.aj = getelementptr [4 x i8], ptr %i.aa, i64 %i.ai
  %i.ak = load i32, ptr %i.aj, align 4, !tbaa !7
  %i.al = uitofp i32 %i.ak to double
  %i.am = tail call double @llvm.fmuladd.f64(double %.0129223.prol, double f0x41D0000000000000, double %i.al) ; 3 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol, !llvm.loop !306

.lr.ph.prol.loopexit:                             ; preds = %.lr.ph.prol, %.lr.ph.preheader
  %.0121224.unr = phi i64 [ %i.ab, %.lr.ph.preheader ], [ %i.ai, %.lr.ph.prol ]
  %.0129223.unr = phi double [ %i.ae, %.lr.ph.preheader ], [ %i.am, %.lr.ph.prol ]
  %.lcssa275.unr = phi double [ poison, %.lr.ph.preheader ], [ %i.am, %.lr.ph.prol ]
  %i.an = sub nsw i64 %umin, %i.i
  %i.ao = icmp ugt i64 %i.an, -4
  br i1 %i.ao, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  %.0121224 = phi i64 [ %i.be, %.lr.ph ], [ %.0121224.unr, %.lr.ph.prol.loopexit ] ; 5 uses
  %.0129223 = phi double [ %i.bi, %.lr.ph ], [ %.0129223.unr, %.lr.ph.prol.loopexit ]
  %i.ap = getelementptr [4 x i8], ptr %i.aa, i64 %.0121224
  %i.aq = getelementptr i8, ptr %i.ap, i64 -4
  %i.ar = load i32, ptr %i.aq, align 4, !tbaa !7
  %i.as = uitofp i32 %i.ar to double
  %i.at = tail call double @llvm.fmuladd.f64(double %.0129223, double f0x41D0000000000000, double %i.as)
  %i.au = getelementptr [4 x i8], ptr %i.aa, i64 %.0121224
  ...
  %i.az = getelementptr [4 x i8], ptr %i.aa, i64 %.0121224
  ...
  %i.be = add nsw i64 %.0121224, -4               ; 2 uses
  ...
  %i.bj = icmp sgt i64 %.0121224, 4
  br i1 %i.bj, label %.lr.ph, label %._crit_edge, !llvm.loop !307

._crit_edge:                                      ; preds = %.lr.ph.prol.loopexit, %.lr.ph, %bb.j
  %.0129.lcssa = phi double [ %i.ae, %bb.j ], [ %.lcssa275.unr, %.lr.ph.prol.loopexit ], [ %i.bi, %.lr.ph ]
...
._crit_edge229:                                   ; preds = %._crit_edge229.loopexit, %._crit_edge
  %.0128.lcssa = phi double [ %i.bo, %._crit_edge ], [ %i.br, %._crit_edge229.loopexit ]
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %.lr.ph.i.preheader.new
  ...
  br i1 %niter285.ncmp.1, label %.thread206.unr-lcssa, label %.lr.ph.i, !llvm.loop !214
...
.lr.ph.i200:                                      ; preds = %.lr.ph.i200, %.lr.ph.i200.preheader.new
  ...
  br i1 %niter.ncmp.1.not, label %v_rshift.exit.unr-lcssa, label %.lr.ph.i200, !llvm.loop !215
...
.lr.ph235:                                        ; preds = %bb.r, %.lr.ph235
  %.0124233 = phi i64 [ %i.gg, %.lr.ph235 ], [ %i.ek, %bb.r ] ; 2 uses
  %i.gg = add nsw i64 %.0124233, -1               ; 2 uses
  %i.gh = getelementptr [4 x i8], ptr %i.bx, i64 %i.gg
  %i.gi = load i32, ptr %i.gh, align 4, !tbaa !7
  %.not173 = icmp ne i32 %i.gi, 0                 ; 2 uses
  %i.gj = icmp ult i64 %.0124233, 2
  %.not270 = or i1 %i.gj, %.not173
  br i1 %.not270, label %.thread212.loopexit, label %.lr.ph235, !llvm.loop !308
