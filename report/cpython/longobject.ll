...
bb.e:                                             ; preds = %bb.d
  ...
  %i.j = getelementptr i8, ptr %.07495, i64 %.078.neg
...
bb.h:                                             ; preds = %bb.d, %bb.f, %bb.e
  %.0239.a = phi i32 [ 1, %bb.f ], [ 3, %bb.e ], [ 4, %bb.d ] ; 14 uses
...
.preheader342:                                    ; preds = %.critedge.thread326
  ...
  %8 = zext nneg i32 %i.av to i64
  %i.aw = zext nneg i32 %.0239.a to i64
...
begin_hunk_8_@long_format_binary:bb.a
  ...
  %i.bo = lshr i64 %.1245, %i.aw                  ; 3 uses
...
.preheader338:                                    ; preds = %_PyUnicode_DATA.exit286
  ...
  %9 = zext nneg i32 %i.cp to i64
  %i.cq = zext nneg i32 %.0239.a to i64
...
begin_hunk_11_@long_format_binary:bb.a
  ...
  %i.di = lshr i64 %.1232, %i.cq                  ; 3 uses
...
.preheader340:                                    ; preds = %_PyUnicode_DATA.exit302
  ...
  %10 = zext nneg i32 %i.ec to i64
  %i.ed = zext nneg i32 %.0239.a to i64
...
begin_hunk_14_@long_format_binary:bb.a
  ...
  %i.ew = lshr i64 %.1218, %i.ed                  ; 3 uses
...
.preheader:                                       ; preds = %_PyUnicode_DATA.exit318
  ...
  %11 = zext nneg i32 %i.fq to i64
  %i.fr = zext nneg i32 %.0239.a to i64
...
begin_hunk_17_@long_format_binary:bb.a
  ...
  %i.gk = lshr i64 %.1210, %i.fr                  ; 3 uses
