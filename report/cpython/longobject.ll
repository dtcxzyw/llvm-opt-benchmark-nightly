...
bb.d:                                             ; preds = %switch.lookup
  %i.k = icmp ult i64 %.val, 2459565876494606888
  br i1 %i.k, label %.thread, label %bb.e

.thread:                                          ; preds = %bb.d
  %i.l = add nsw i64 %i.f, -1                     ; 2 uses
  %i.m = mul nuw nsw i64 %i.l, 30
  %i.n = getelementptr i8, ptr %0, i64 24
  %i.o = getelementptr [4 x i8], ptr %i.n, i64 %i.l
...
bb.e:                                             ; preds = %bb.d
  %i.ab = load ptr, ptr @PyExc_OverflowError, align 8, !tbaa !11
  tail call void @PyErr_SetString(ptr noundef %i.ab, ptr noundef nonnull @.str.42) #16
  br label %bb.bs

bb.f:                                             ; preds = %.thread, %switch.lookup
  %.1226 = phi i64 [ %i.aa, %.thread ], [ 1, %switch.lookup ] ; 2 uses
  %.not267 = icmp eq i32 %2, 0                    ; 5 uses
  %i.ac = add nuw i64 %.1226, 2
  %spec.select = select i1 %.not267, i64 %.1226, i64 %i.ac ; 12 uses
  %.not268 = icmp eq ptr %4, null                 ; 5 uses
  br i1 %.not268, label %bb.k, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.ad = getelementptr i8, ptr %4, i64 20
  %i.ae = load i32, ptr %i.ad, align 4, !tbaa !154
  %i.af = icmp ugt i32 %i.ae, 119
  br i1 %i.af, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g
  %i.ag = getelementptr i8, ptr %4, i64 24
  %i.ah = load i64, ptr %i.ag, align 8, !tbaa !156
  %i.ai = getelementptr i8, ptr %4, i64 32
  %i.aj = load i64, ptr %i.ai, align 8, !tbaa !157
  %i.ak = sub i64 %i.ah, %i.aj
  %i.al = icmp sle i64 %spec.select, %i.ak
  %i.am = icmp eq i64 %spec.select, 0
  %or.cond = or i1 %i.am, %i.al
...
bb.j:                                             ; preds = %bb.h, %bb.i
  %i.an = tail call i32 @_PyUnicodeWriter_PrepareInternal(ptr noundef nonnull %4, i64 noundef %spec.select, i32 noundef 120) #16
  %i.ao = icmp eq i32 %i.an, -1
  br i1 %i.ao, label %bb.bs, label %.critedge
...
bb.l:                                             ; preds = %bb.k
  %i.ap = load ptr, ptr %6, align 8, !tbaa !158
  %i.aq = tail call ptr @PyBytesWriter_GrowAndUpdatePointer(ptr noundef nonnull %5, i64 noundef %spec.select, ptr noundef %i.ap) #16 ; 3 uses
  store ptr %i.aq, ptr %6, align 8, !tbaa !158
  %i.ar = icmp eq ptr %i.aq, null
  br i1 %i.ar, label %bb.bs, label %.critedge.thread326

bb.m:                                             ; preds = %bb.k
  %i.as = tail call ptr @PyUnicode_New(i64 noundef %spec.select, i32 noundef 120) #16 ; 3 uses
  %i.at = icmp eq ptr %i.as, null
  br i1 %i.at, label %bb.bs, label %bb.v
...
.critedge.thread326:                              ; preds = %.critedge..critedge.thread326_crit_edge, %bb.l
  %i.au = phi ptr [ %.pre, %.critedge..critedge.thread326_crit_edge ], [ %i.aq, %bb.l ]
  %i.av = getelementptr i8, ptr %i.au, i64 %spec.select ; 2 uses
  br i1 %i.j, label %bb.n, label %.preheader342
...
bb.n:                                             ; preds = %.critedge.thread326
  ...
  store i8 48, ptr %i.bb, align 1, !tbaa !24
  br label %.loopexit343

bb.o:                                             ; preds = %.preheader342, %bb.q
  %.0241358 = phi i64 [ 0, %.preheader342 ], [ %i.bu, %bb.q ] ; 3 uses
  %.0242357 = phi i32 [ 0, %.preheader342 ], [ %i.bq, %bb.q ] ; 2 uses
  %.0244356 = phi i64 [ 0, %.preheader342 ], [ %i.br, %bb.q ]
  %.0246355 = phi ptr [ %i.av, %.preheader342 ], [ %i.bp, %bb.q ]
  %i.bc = getelementptr [4 x i8], ptr %i.aw, i64 %.0241358
  %i.bd = load i32, ptr %i.bc, align 4, !tbaa !7
  %i.be = zext i32 %i.bd to i64
  %i.bf = zext nneg i32 %.0242357 to i64
  %i.bg = shl i64 %i.be, %i.bf
  %i.bh = or i64 %i.bg, %.0244356
  %i.bi = add i32 %.0242357, 30
  %i.bj = icmp slt i64 %.0241358, %i.ba
  br label %bb.p

bb.p:                                             ; preds = %bb.p, %bb.o
  %.1247 = phi ptr [ %.0246355, %bb.o ], [ %i.bp, %bb.p ]
  %.1245 = phi i64 [ %i.bh, %bb.o ], [ %i.br, %bb.p ] ; 2 uses
  %.1243 = phi i32 [ %i.bi, %bb.o ], [ %i.bq, %bb.p ]
  %i.bk = and i64 %.1245, %i.ay
  %i.bl = trunc i64 %i.bk to i8                   ; 2 uses
  %i.bm = icmp slt i8 %i.bl, 10
  %i.bn = select i1 %i.bm, i8 48, i8 87
...
bb.q:                                             ; preds = %bb.p
  %i.bu = add nuw nsw i64 %.0241358, 1            ; 2 uses
  %exitcond.not = icmp eq i64 %i.bu, %i.f
  br i1 %exitcond.not, label %.loopexit343, label %bb.o, !llvm.loop !200

.loopexit343:                                     ; preds = %bb.q, %bb.n
  %.2248 = phi ptr [ %i.bb, %bb.n ], [ %i.bp, %bb.q ] ; 3 uses
  br i1 %.not267, label %bb.s, label %bb.r

bb.r:                                             ; preds = %.loopexit343
  %i.bv = getelementptr i8, ptr %.2248, i64 -1
  ...
  store i8 %switch.select416, ptr %i.bv, align 1, !tbaa !24
  %i.bw = getelementptr i8, ptr %.2248, i64 -2    ; 2 uses
  store i8 48, ptr %i.bw, align 1, !tbaa !24
  br label %bb.s

bb.s:                                             ; preds = %bb.r, %.loopexit343
  %.4250 = phi ptr [ %i.bw, %bb.r ], [ %.2248, %.loopexit343 ]
  br i1 %i.h, label %bb.t, label %bb.bn

bb.t:                                             ; preds = %bb.s
  %i.bx = getelementptr i8, ptr %.4250, i64 -1
  store i8 45, ptr %i.bx, align 1, !tbaa !24
  br label %bb.bn

bb.u:                                             ; preds = %.critedge
  %i.by = getelementptr i8, ptr %4, i64 16
  %i.bz = load i32, ptr %i.by, align 8, !tbaa !191
  br label %bb.w

bb.v:                                             ; preds = %bb.m
  %i.ca = getelementptr i8, ptr %i.as, i64 32
...
bb.w:                                             ; preds = %bb.v, %bb.u
  %.0213323336 = phi ptr [ null, %bb.u ], [ %i.as, %bb.v ] ; 15 uses
  %i.ce = phi i32 [ %i.bz, %bb.u ], [ %i.cd, %bb.v ]
  switch i32 %i.ce, label %bb.az [
    i32 1, label %bb.x
    i32 2, label %bb.al
  ]
...
bb.y:                                             ; preds = %bb.x
  %i.cf = load ptr, ptr %4, align 8, !tbaa !192   ; 3 uses
  %i.cg = getelementptr i8, ptr %i.cf, i64 32
  %.val.i = load i32, ptr %i.cg, align 8          ; 2 uses
  %i.ch = and i32 %.val.i, 32
  %.not.i = icmp eq i32 %i.ch, 0
  br i1 %.not.i, label %bb.aa, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.ci = and i32 %.val.i, 64
  %.not.i.i = icmp eq i32 %i.ci, 0
  %.0.v.i.i = select i1 %.not.i.i, i64 56, i64 40
  %.0.i.i = getelementptr i8, ptr %i.cf, i64 %.0.v.i.i
  br label %_PyUnicode_DATA.exit

bb.aa:                                            ; preds = %bb.y
  %i.cj = getelementptr i8, ptr %i.cf, i64 56
  %.val4.i = load ptr, ptr %i.cj, align 8, !tbaa !24
  br label %_PyUnicode_DATA.exit

_PyUnicode_DATA.exit:                             ; preds = %bb.z, %bb.aa
  %.0.i = phi ptr [ %.0.i.i, %bb.z ], [ %.val4.i, %bb.aa ]
  %i.ck = getelementptr i8, ptr %4, i64 32
  %i.cl = load i64, ptr %i.ck, align 8, !tbaa !157
  %i.cm = getelementptr i8, ptr %.0.i, i64 %i.cl
  br label %_PyUnicode_DATA.exit286

bb.ab:                                            ; preds = %bb.x
  %i.cn = getelementptr i8, ptr %.0213323336, i64 32
  %.val.i279 = load i32, ptr %i.cn, align 8       ; 2 uses
  %i.co = and i32 %.val.i279, 32
  %.not.i280 = icmp eq i32 %i.co, 0
  br i1 %.not.i280, label %bb.ad, label %bb.ac

bb.ac:                                            ; preds = %bb.ab
  %i.cp = and i32 %.val.i279, 64
  %.not.i.i281 = icmp eq i32 %i.cp, 0
  %.0.v.i.i282 = select i1 %.not.i.i281, i64 56, i64 40
  %.0.i.i283 = getelementptr i8, ptr %.0213323336, i64 %.0.v.i.i282
  br label %_PyUnicode_DATA.exit286

bb.ad:                                            ; preds = %bb.ab
  %i.cq = getelementptr i8, ptr %.0213323336, i64 56
  %.val4.i285 = load ptr, ptr %i.cq, align 8, !tbaa !24
  br label %_PyUnicode_DATA.exit286

_PyUnicode_DATA.exit286:                          ; preds = %bb.ad, %bb.ac, %_PyUnicode_DATA.exit
  %.pn273 = phi ptr [ %i.cm, %_PyUnicode_DATA.exit ], [ %.0.i.i283, %bb.ac ], [ %.val4.i285, %bb.ad ]
  %.0233 = getelementptr i8, ptr %.pn273, i64 %spec.select ; 2 uses
  br i1 %i.j, label %bb.ae, label %.preheader338
...
bb.ae:                                            ; preds = %_PyUnicode_DATA.exit286
  %i.cw = getelementptr i8, ptr %.0233, i64 -1    ; 2 uses
  store i8 48, ptr %i.cw, align 1, !tbaa !24
  br label %.loopexit339

bb.af:                                            ; preds = %.preheader338, %bb.ah
  %.0228366 = phi i64 [ 0, %.preheader338 ], [ %i.dp, %bb.ah ] ; 3 uses
  %.0229365 = phi i32 [ 0, %.preheader338 ], [ %i.dl, %bb.ah ] ; 2 uses
  %.0231364 = phi i64 [ 0, %.preheader338 ], [ %i.dm, %bb.ah ]
  %.1234363 = phi ptr [ %.0233, %.preheader338 ], [ %i.dk, %bb.ah ]
  %i.cx = getelementptr [4 x i8], ptr %i.cr, i64 %.0228366
  %i.cy = load i32, ptr %i.cx, align 4, !tbaa !7
  %i.cz = zext i32 %i.cy to i64
  %i.da = zext nneg i32 %.0229365 to i64
  %i.db = shl i64 %i.cz, %i.da
  %i.dc = or i64 %i.db, %.0231364
  %i.dd = add i32 %.0229365, 30
  %i.de = icmp slt i64 %.0228366, %i.cv
  br label %bb.ag

bb.ag:                                            ; preds = %bb.ag, %bb.af
  %.2235 = phi ptr [ %.1234363, %bb.af ], [ %i.dk, %bb.ag ]
  %.1232 = phi i64 [ %i.dc, %bb.af ], [ %i.dm, %bb.ag ] ; 2 uses
  %.1230 = phi i32 [ %i.dd, %bb.af ], [ %i.dl, %bb.ag ]
  %i.df = and i64 %.1232, %i.ct
  %i.dg = trunc i64 %i.df to i8                   ; 2 uses
  %i.dh = icmp slt i8 %i.dg, 10
  %i.di = select i1 %i.dh, i8 48, i8 87
...
bb.ai:                                            ; preds = %.loopexit339
  ...
  store i8 %switch.select420, ptr %i.dq, align 1, !tbaa !24
  %i.dr = getelementptr i8, ptr %.3236, i64 -2    ; 2 uses
  store i8 48, ptr %i.dr, align 1, !tbaa !24
  br label %bb.aj

bb.aj:                                            ; preds = %bb.ai, %.loopexit339
  %.5238 = phi ptr [ %i.dr, %bb.ai ], [ %.3236, %.loopexit339 ]
  br i1 %i.h, label %bb.ak, label %bb.bn

bb.ak:                                            ; preds = %bb.aj
  %i.ds = getelementptr i8, ptr %.5238, i64 -1
  store i8 45, ptr %i.ds, align 1, !tbaa !24
  br label %bb.bn
...
bb.am:                                            ; preds = %bb.al
  %i.dt = load ptr, ptr %4, align 8, !tbaa !192   ; 3 uses
  %i.du = getelementptr i8, ptr %i.dt, i64 32
  %.val.i287 = load i32, ptr %i.du, align 8       ; 2 uses
  %i.dv = and i32 %.val.i287, 32
  %.not.i288 = icmp eq i32 %i.dv, 0
  br i1 %.not.i288, label %bb.ao, label %bb.an

bb.an:                                            ; preds = %bb.am
  %i.dw = and i32 %.val.i287, 64
  %.not.i.i289 = icmp eq i32 %i.dw, 0
  %.0.v.i.i290 = select i1 %.not.i.i289, i64 56, i64 40
  %.0.i.i291 = getelementptr i8, ptr %i.dt, i64 %.0.v.i.i290
  br label %_PyUnicode_DATA.exit294

bb.ao:                                            ; preds = %bb.am
  %i.dx = getelementptr i8, ptr %i.dt, i64 56
  %.val4.i293 = load ptr, ptr %i.dx, align 8, !tbaa !24
  br label %_PyUnicode_DATA.exit294

_PyUnicode_DATA.exit294:                          ; preds = %bb.an, %bb.ao
  %.0.i292 = phi ptr [ %.0.i.i291, %bb.an ], [ %.val4.i293, %bb.ao ]
  %i.dy = getelementptr i8, ptr %4, i64 32
  %i.dz = load i64, ptr %i.dy, align 8, !tbaa !157
  %i.ea = getelementptr [2 x i8], ptr %.0.i292, i64 %i.dz
  br label %_PyUnicode_DATA.exit302

bb.ap:                                            ; preds = %bb.al
  %i.eb = getelementptr i8, ptr %.0213323336, i64 32
  %.val.i295 = load i32, ptr %i.eb, align 8       ; 2 uses
  %i.ec = and i32 %.val.i295, 32
  %.not.i296 = icmp eq i32 %i.ec, 0
  br i1 %.not.i296, label %bb.ar, label %bb.aq

bb.aq:                                            ; preds = %bb.ap
  %i.ed = and i32 %.val.i295, 64
  %.not.i.i297 = icmp eq i32 %i.ed, 0
  %.0.v.i.i298 = select i1 %.not.i.i297, i64 56, i64 40
  %.0.i.i299 = getelementptr i8, ptr %.0213323336, i64 %.0.v.i.i298
  br label %_PyUnicode_DATA.exit302

bb.ar:                                            ; preds = %bb.ap
  %i.ee = getelementptr i8, ptr %.0213323336, i64 56
  %.val4.i301 = load ptr, ptr %i.ee, align 8, !tbaa !24
  br label %_PyUnicode_DATA.exit302

_PyUnicode_DATA.exit302:                          ; preds = %bb.ar, %bb.aq, %_PyUnicode_DATA.exit294
  %.pn271 = phi ptr [ %i.ea, %_PyUnicode_DATA.exit294 ], [ %.0.i.i299, %bb.aq ], [ %.val4.i301, %bb.ar ]
  %.0219 = getelementptr [2 x i8], ptr %.pn271, i64 %spec.select ; 2 uses
  br i1 %i.j, label %bb.as, label %.preheader340
...
bb.as:                                            ; preds = %_PyUnicode_DATA.exit302
  %i.ek = getelementptr i8, ptr %.0219, i64 -2    ; 2 uses
  store i16 48, ptr %i.ek, align 2, !tbaa !159
  br label %.loopexit341

bb.at:                                            ; preds = %.preheader340, %bb.av
  %.0214362 = phi i64 [ 0, %.preheader340 ], [ %i.fe, %bb.av ] ; 3 uses
  %.0215361 = phi i32 [ 0, %.preheader340 ], [ %i.fa, %bb.av ] ; 2 uses
  %.0217360 = phi i64 [ 0, %.preheader340 ], [ %i.fb, %bb.av ]
  %.1220359 = phi ptr [ %.0219, %.preheader340 ], [ %i.ez, %bb.av ]
  %i.el = getelementptr [4 x i8], ptr %i.ef, i64 %.0214362
  %i.em = load i32, ptr %i.el, align 4, !tbaa !7
  %i.en = zext i32 %i.em to i64
  %i.eo = zext nneg i32 %.0215361 to i64
  %i.ep = shl i64 %i.en, %i.eo
  %i.eq = or i64 %i.ep, %.0217360
  %i.er = add i32 %.0215361, 30
  %i.es = icmp slt i64 %.0214362, %i.ej
  br label %bb.au

bb.au:                                            ; preds = %bb.au, %bb.at
  %.2221 = phi ptr [ %.1220359, %bb.at ], [ %i.ez, %bb.au ]
  %.1218 = phi i64 [ %i.eq, %bb.at ], [ %i.fb, %bb.au ] ; 2 uses
  %.1216 = phi i32 [ %i.er, %bb.at ], [ %i.fa, %bb.au ]
  %i.et = and i64 %.1218, %i.eh
  %i.eu = trunc i64 %i.et to i8                   ; 2 uses
  %i.ev = icmp slt i8 %i.eu, 10
  %i.ew = select i1 %i.ev, i8 48, i8 87
...
bb.aw:                                            ; preds = %.loopexit341
  ...
  store i16 %switch.select424, ptr %i.ff, align 2, !tbaa !159
  %i.fg = getelementptr i8, ptr %.3222, i64 -4    ; 2 uses
  store i16 48, ptr %i.fg, align 2, !tbaa !159
  br label %bb.ax

bb.ax:                                            ; preds = %bb.aw, %.loopexit341
  %.5224 = phi ptr [ %i.fg, %bb.aw ], [ %.3222, %.loopexit341 ]
  br i1 %i.h, label %bb.ay, label %bb.bn

bb.ay:                                            ; preds = %bb.ax
  %i.fh = getelementptr i8, ptr %.5224, i64 -2
  store i16 45, ptr %i.fh, align 2, !tbaa !159
  br label %bb.bn
...
bb.ba:                                            ; preds = %bb.az
  %i.fi = load ptr, ptr %4, align 8, !tbaa !192   ; 3 uses
  %i.fj = getelementptr i8, ptr %i.fi, i64 32
  %.val.i303 = load i32, ptr %i.fj, align 8       ; 2 uses
  %i.fk = and i32 %.val.i303, 32
  %.not.i304 = icmp eq i32 %i.fk, 0
  br i1 %.not.i304, label %bb.bc, label %bb.bb

bb.bb:                                            ; preds = %bb.ba
  %i.fl = and i32 %.val.i303, 64
  %.not.i.i305 = icmp eq i32 %i.fl, 0
  %.0.v.i.i306 = select i1 %.not.i.i305, i64 56, i64 40
  %.0.i.i307 = getelementptr i8, ptr %i.fi, i64 %.0.v.i.i306
  br label %_PyUnicode_DATA.exit310

bb.bc:                                            ; preds = %bb.ba
  %i.fm = getelementptr i8, ptr %i.fi, i64 56
  %.val4.i309 = load ptr, ptr %i.fm, align 8, !tbaa !24
  br label %_PyUnicode_DATA.exit310

_PyUnicode_DATA.exit310:                          ; preds = %bb.bb, %bb.bc
  %.0.i308 = phi ptr [ %.0.i.i307, %bb.bb ], [ %.val4.i309, %bb.bc ]
  %i.fn = getelementptr i8, ptr %4, i64 32
  %i.fo = load i64, ptr %i.fn, align 8, !tbaa !157
  %i.fp = getelementptr [4 x i8], ptr %.0.i308, i64 %i.fo
  br label %_PyUnicode_DATA.exit318

bb.bd:                                            ; preds = %bb.az
  %i.fq = getelementptr i8, ptr %.0213323336, i64 32
  %.val.i311 = load i32, ptr %i.fq, align 8       ; 2 uses
  %i.fr = and i32 %.val.i311, 32
  %.not.i312 = icmp eq i32 %i.fr, 0
  br i1 %.not.i312, label %bb.bf, label %bb.be

bb.be:                                            ; preds = %bb.bd
  %i.fs = and i32 %.val.i311, 64
  %.not.i.i313 = icmp eq i32 %i.fs, 0
  %.0.v.i.i314 = select i1 %.not.i.i313, i64 56, i64 40
  %.0.i.i315 = getelementptr i8, ptr %.0213323336, i64 %.0.v.i.i314
  br label %_PyUnicode_DATA.exit318

bb.bf:                                            ; preds = %bb.bd
  %i.ft = getelementptr i8, ptr %.0213323336, i64 56
  %.val4.i317 = load ptr, ptr %i.ft, align 8, !tbaa !24
  br label %_PyUnicode_DATA.exit318

_PyUnicode_DATA.exit318:                          ; preds = %bb.bf, %bb.be, %_PyUnicode_DATA.exit310
  %.pn = phi ptr [ %i.fp, %_PyUnicode_DATA.exit310 ], [ %.0.i.i315, %bb.be ], [ %.val4.i317, %bb.bf ]
  %.0211 = getelementptr [4 x i8], ptr %.pn, i64 %spec.select ; 2 uses
  br i1 %i.j, label %bb.bg, label %.preheader
...
bb.bg:                                            ; preds = %_PyUnicode_DATA.exit318
  %i.fz = getelementptr i8, ptr %.0211, i64 -4    ; 2 uses
  store i32 48, ptr %i.fz, align 4, !tbaa !7
  br label %.loopexit

bb.bh:                                            ; preds = %.preheader, %bb.bj
  %.0206370 = phi i64 [ 0, %.preheader ], [ %i.gt, %bb.bj ] ; 3 uses
  %.0207369 = phi i32 [ 0, %.preheader ], [ %i.gp, %bb.bj ] ; 2 uses
  %.0209368 = phi i64 [ 0, %.preheader ], [ %i.gq, %bb.bj ]
  %.1212367 = phi ptr [ %.0211, %.preheader ], [ %i.go, %bb.bj ]
  %i.ga = getelementptr [4 x i8], ptr %i.fu, i64 %.0206370
  %i.gb = load i32, ptr %i.ga, align 4, !tbaa !7
  %i.gc = zext i32 %i.gb to i64
  %i.gd = zext nneg i32 %.0207369 to i64
  %i.ge = shl i64 %i.gc, %i.gd
  %i.gf = or i64 %i.ge, %.0209368
  %i.gg = add i32 %.0207369, 30
  %i.gh = icmp slt i64 %.0206370, %i.fy
  br label %bb.bi

bb.bi:                                            ; preds = %bb.bi, %bb.bh
  %.2 = phi ptr [ %.1212367, %bb.bh ], [ %i.go, %bb.bi ]
  %.1210 = phi i64 [ %i.gf, %bb.bh ], [ %i.gq, %bb.bi ] ; 2 uses
  %.1208 = phi i32 [ %i.gg, %bb.bh ], [ %i.gp, %bb.bi ]
  %i.gi = and i64 %.1210, %i.fw
  %i.gj = trunc i64 %i.gi to i8                   ; 2 uses
  %i.gk = icmp slt i8 %i.gj, 10
  %i.gl = select i1 %i.gk, i8 48, i8 87
...
bb.bj:                                            ; preds = %bb.bi
  %i.gt = add nuw nsw i64 %.0206370, 1            ; 2 uses
  %exitcond384.not = icmp eq i64 %i.gt, %i.f
  br i1 %exitcond384.not, label %.loopexit, label %bb.bh, !llvm.loop !206

.loopexit:                                        ; preds = %bb.bj, %bb.bg
  %.3 = phi ptr [ %i.fz, %bb.bg ], [ %i.go, %bb.bj ] ; 3 uses
  br i1 %.not267, label %bb.bl, label %bb.bk

bb.bk:                                            ; preds = %.loopexit
  %i.gu = getelementptr i8, ptr %.3, i64 -4
  ...
  store i32 %switch.select428, ptr %i.gu, align 4, !tbaa !7
  %i.gv = getelementptr i8, ptr %.3, i64 -8       ; 2 uses
  store i32 48, ptr %i.gv, align 4, !tbaa !7
  br label %bb.bl

bb.bl:                                            ; preds = %bb.bk, %.loopexit
  %.5 = phi ptr [ %i.gv, %bb.bk ], [ %.3, %.loopexit ]
  br i1 %i.h, label %bb.bm, label %bb.bn

bb.bm:                                            ; preds = %bb.bl
  %i.gw = getelementptr i8, ptr %.5, i64 -4
  store i32 45, ptr %i.gw, align 4, !tbaa !7
  br label %bb.bn
...
bb.bo:                                            ; preds = %bb.bn
  %i.gx = getelementptr i8, ptr %4, i64 32        ; 2 uses
  %i.gy = load i64, ptr %i.gx, align 8, !tbaa !157
  %i.gz = add i64 %i.gy, %spec.select
  store i64 %i.gz, ptr %i.gx, align 8, !tbaa !157
  br label %bb.bs
...
bb.bq:                                            ; preds = %bb.bp
  %i.ha = load ptr, ptr %6, align 8, !tbaa !158
  %i.hb = getelementptr i8, ptr %i.ha, i64 %spec.select
  store ptr %i.hb, ptr %6, align 8, !tbaa !158
  br label %bb.bs
