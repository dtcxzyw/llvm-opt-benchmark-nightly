...
.peel.begin:                                      ; preds = %bb.c
  ...
  %i.ac = icmp ult i64 %i.ab, 1152921504606846976
  %spec.select = select i1 %i.ac, i64 2, i64 3    ; 2 uses
...
.lr.ph.preheader:                                 ; preds = %.peel.begin
  %i.af = lshr i64 %0, 62
  %i.ag = and i64 %i.af, 2
  %1 = shl nuw nsw i64 %spec.select, 3
...
bb.i:                                             ; preds = %bb.c
  ...
  %i.ac = icmp ult i64 %.018.i, 1152921504606846976
  %spec.select.i = select i1 %i.ac, i64 2, i64 3  ; 2 uses
...
.lr.ph.preheader.i:                               ; preds = %bb.i
  %i.ae = lshr i64 %0, 62
  %i.af = and i64 %i.ae, 2
  %1 = shl nuw nsw i64 %spec.select.i, 3
