...
.lr.ph166:                                        ; preds = %bb.n
  ...
  store i8 %.sroa.0.0..sroa.0.0., ptr %i.as, align 1, !tbaa !40
...
bb.p:                                             ; preds = %.lr.ph166
  ...
  store i8 %.sroa.0.1..sroa.0.1., ptr %i.at, align 1, !tbaa !40
...
bb.q:                                             ; preds = %bb.p
  ...
  store i8 %.sroa.0.2..sroa.0.2., ptr %i.au, align 1, !tbaa !40
...
bb.r:                                             ; preds = %bb.q
  ...
  store i8 %.sroa.0.3..sroa.0.3., ptr %i.av, align 1, !tbaa !40
...
bb.s:                                             ; preds = %bb.r
  ...
  store i8 %.sroa.0.4..sroa.0.4., ptr %i.aw, align 1, !tbaa !40
...
bb.t:                                             ; preds = %bb.s
  ...
  store i8 %.sroa.0.5..sroa.0.5., ptr %i.ax, align 1, !tbaa !40
...
bb.u:                                             ; preds = %bb.t
  ...
  store i8 %.sroa.0.6..sroa.0.6., ptr %i.ay, align 1, !tbaa !40
...
bb.v:                                             ; preds = %bb.u
  ...
  store i8 %.sroa.0.7..sroa.0.7., ptr %i.az, align 1, !tbaa !40
  br label %.loopexit
...
.preheader159:                                    ; preds = %bb.x
  ...
  tail call void @llvm.memset.p0.i64(ptr align 1 %1, i8 %i.bk, i64 %i.bn, i1 false), !tbaa !40
  %scevgep = getelementptr i8, ptr %1, i64 %i.bn  ; 8 uses
  %i.bo = getelementptr i8, ptr %scevgep, i64 1
  store i8 %i.ac, ptr %scevgep, align 1, !tbaa !40
  %i.bp = getelementptr i8, ptr %scevgep, i64 2
  store i8 %i.ae, ptr %i.bo, align 1, !tbaa !40
  %i.bq = getelementptr i8, ptr %scevgep, i64 3
  store i8 %i.ag, ptr %i.bp, align 1, !tbaa !40
  %i.br = getelementptr i8, ptr %scevgep, i64 4
  store i8 %i.ai, ptr %i.bq, align 1, !tbaa !40
  %i.bs = getelementptr i8, ptr %scevgep, i64 5
  store i8 %i.ak, ptr %i.br, align 1, !tbaa !40
  %i.bt = getelementptr i8, ptr %scevgep, i64 6
  store i8 %i.am, ptr %i.bs, align 1, !tbaa !40
  %i.bu = getelementptr i8, ptr %scevgep, i64 7
  store i8 %i.ao, ptr %i.bt, align 1, !tbaa !40
  store i8 %i.ap, ptr %i.bu, align 1, !tbaa !40
  br label %_fits_in_n_bits.exit.thread
...
bb.aa:                                            ; preds = %bb.z
  %i.bv = tail call i32 @_PyLong_AsByteArray(ptr noundef nonnull %.095, ptr noundef %1, i64 noundef %2, i32 noundef %storemerge.i, i32 noundef 1, i32 noundef 0) ; 0 uses
...
bb.ac:                                            ; preds = %bb.ab
  %i.bx = getelementptr i8, ptr %.095, i64 24
...
bb.af:                                            ; preds = %bb.ae
  ...
  %i.cq = load i8, ptr %1, align 1, !tbaa !40
...
._crit_edge:                                      ; preds = %.peel.next, %bb.af
  %.1.in.lcssa = phi i1 [ %i.cs, %bb.af ], [ %.1.in, %.peel.next ]
  %spec.select = select i1 %.1.in.lcssa, i64 %2, i64 %i.ch
  br label %_fits_in_n_bits.exit.thread

.peel.next:                                       ; preds = %bb.af, %.peel.next
  %.0168 = phi i64 [ %i.da, %.peel.next ], [ 1, %bb.af ] ; 2 uses
  %.pn = phi ptr [ %.085167, %.peel.next ], [ %1, %bb.af ]
  %.085167 = getelementptr i8, ptr %.pn, i64 1    ; 2 uses
  %i.cv = icmp slt i64 %.0168, %i.cn
  %i.cw = load i8, ptr %.085167, align 1, !tbaa !40 ; 2 uses
  %i.cx = zext i8 %i.cw to i32
  %i.cy = icmp eq i32 %i.co, %i.cx
  %i.cz = icmp eq i8 %i.cw, 0
  %.1.in = select i1 %i.cv, i1 %i.cz, i1 %i.cy    ; 2 uses
  %i.da = add nuw nsw i64 %.0168, 1               ; 2 uses
  %i.db = icmp slt i64 %i.da, %2
  %i.dc = select i1 %i.db, i1 %.1.in, i1 false
  br i1 %i.dc, label %.peel.next, label %._crit_edge, !llvm.loop !180
...
_PyFreeList_Pop.exit.i:                           ; preds = %bb.d
  ...
  store ptr %i.w, ptr %i.u, align 8, !tbaa !34
...
bb.f:                                             ; preds = %bb.e
  ...
  store ptr @PyLong_Type, ptr %i.ac, align 8, !tbaa !39
  %i.ad = load i32, ptr @PyLong_Type, align 8, !tbaa !40 ; 2 uses
  %i.ae = icmp ugt i32 %i.ad, -1073741825
  br i1 %i.ae, label %_PyObject_Init.exit.i, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.af = add nuw i32 %i.ad, 1
  store i32 %i.af, ptr @PyLong_Type, align 8, !tbaa !40
  br label %_PyObject_Init.exit.i
...
_PyObject_Init.exit.i:                            ; preds = %bb.g, %bb.f, %_PyFreeList_Pop.exit.i
  ...
  store i64 %i.ak, ptr %i.al, align 8, !tbaa !43
  %i.am = getelementptr i8, ptr %.sink.i, i64 24
  store i32 %i.aj, ptr %i.am, align 8, !tbaa !26
...
bb.a:
  ...
  %.val = load i64, ptr %i.f, align 8, !tbaa !43
  %i.g = getelementptr i8, ptr %1, i64 24
  %.val2 = load i32, ptr %i.g, align 8, !tbaa !26
  %i.h = and i64 %.val, 3
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.x = load ptr, ptr %i.w, align 8, !tbaa !34   ; 3 uses
...
_PyFreeList_Pop.exit.i:                           ; preds = %bb.d
  ...
  %i.ab = add i64 %i.aa, -1
  store i64 %i.ab, ptr %i.z, align 8, !tbaa !36
  br label %_PyObject_Init.exit.i
...
bb.f:                                             ; preds = %bb.e
  ...
  store ptr @PyLong_Type, ptr %i.ae, align 8, !tbaa !39
  %i.af = load i32, ptr @PyLong_Type, align 8, !tbaa !40 ; 2 uses
  %i.ag = icmp ugt i32 %i.af, -1073741825
  br i1 %i.ag, label %_PyObject_Init.exit.i, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.ah = add nuw i32 %i.af, 1
  store i32 %i.ah, ptr @PyLong_Type, align 8, !tbaa !40
  br label %_PyObject_Init.exit.i
...
_PyObject_Init.exit.i:                            ; preds = %bb.g, %bb.f, %_PyFreeList_Pop.exit.i
  ...
  store i64 %i.am, ptr %i.an, align 8, !tbaa !43
  %i.ao = getelementptr i8, ptr %.sink.i, i64 24
  store i32 %i.al, ptr %i.ao, align 8, !tbaa !26
...
bb.a:
  %i.a = getelementptr i8, ptr %0, i64 16
  %.val = load i64, ptr %i.a, align 8, !tbaa !43  ; 4 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %.val73.i = load i32, ptr %i.g, align 8, !tbaa !26
  ...
  %i.n = tail call fastcc ptr @_PyLong_FromSTwoDigits(i64 noundef %i.m), !inline_history !256
...
bb.k:                                             ; preds = %bb.j, %bb.d
  %.064.i = phi i64 [ %i.ae, %bb.j ], [ %i.d, %bb.d ] ; 10 uses
  %.063.i = phi i32 [ 30, %bb.j ], [ %i.o, %bb.d ] ; 2 uses
  %i.af = sub nsw i64 %i.q, %.064.i               ; 4 uses
  %i.ag = icmp slt i64 %i.af, 1
  br i1 %i.ag, label %bb.l, label %bb.m

bb.l:                                             ; preds = %bb.k
  %i.ah = sext i1 %i.p to i64
  %i.ai = tail call ptr @PyLong_FromLong(i64 noundef %i.ah), !inline_history !256
  br label %long_rshift1.exit

bb.m:                                             ; preds = %bb.k
  %i.aj = tail call fastcc ptr @long_alloc(i64 noundef %i.af), !inline_history !256 ; 6 uses
  %i.ak = icmp eq ptr %i.aj, null
  br i1 %i.ak, label %long_rshift1.exit, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.al = sub nsw i32 30, %.063.i                 ; 2 uses
  %i.am = zext nneg i32 %i.al to i64              ; 3 uses
  %i.an = getelementptr i8, ptr %0, i64 24        ; 6 uses
  %i.ao = getelementptr [4 x i8], ptr %i.an, i64 %.064.i
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader26, %.lr.ph.i
  ...
  %i.bi = load i32, ptr %i.bh, align 4, !tbaa !26
  %i.bj = or i32 %i.bi, %.06178.i                 ; 2 uses
  %i.bk = add nuw nsw i64 %.06079.i, 1            ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.bk, %.064.i
  br i1 %exitcond.not.i, label %._crit_edge.loopexit.i, label %.lr.ph.i, !llvm.loop !259

bb.p:                                             ; preds = %._crit_edge.i, %bb.n
  %.062.i = phi i64 [ %i.bg, %._crit_edge.i ], [ %i.aq, %bb.n ]
  %i.bl = zext nneg i32 %.063.i to i64
  %i.bm = lshr i64 %.062.i, %i.bl                 ; 3 uses
  %.080.i = add nsw i64 %.064.i, 1                ; 3 uses
...
.epil.preheader:                                  ; preds = %._crit_edge86.i.loopexit.unr-lcssa, %.lr.ph85.i
  ...
  store i32 %i.bz, ptr %i.ca, align 4, !tbaa !26
...
._crit_edge86.i:                                  ; preds = %.epil.preheader, %._crit_edge86.i.loopexit.unr-lcssa, %bb.p
  ...
  store i32 %i.cc, ptr %i.ce, align 4, !tbaa !26
  %i.cf = getelementptr i8, ptr %i.aj, i64 16     ; 2 uses
  %.val.i75.i = load i64, ptr %i.cf, align 8, !tbaa !43 ; 2 uses
...
bb.q:                                             ; preds = %.lr.ph.i.i
  ...
  br i1 %.not13.i.i, label %.critedge.thread.thread.sink.split.i.i, label %.lr.ph.i.i, !llvm.loop !2
...
.critedge.thread.thread.sink.split.i.i:           ; preds = %bb.q, %bb.r
  ...
  store i64 %.sink.i.i, ptr %i.cf, align 8, !tbaa !43
...
long_normalize.exit.i:                            ; preds = %.critedge.thread.thread.sink.split.i.i, %.critedge.i.i, %._crit_edge86.i
  %i.co = tail call fastcc ptr @maybe_small_long(ptr noundef nonnull %i.aj), !inline_history !256
  br label %long_rshift1.exit
...
bb.s:                                             ; preds = %bb.s, %.lr.ph85.i.new
  ...
  %i.cq = load i32, ptr %i.cp, align 4, !tbaa !26
  ...
  store i32 %i.df, ptr %i.dh, align 4, !tbaa !26
  %i.di = lshr i64 %i.dd, 30                      ; 3 uses
  %i.dj = add nuw nsw i64 %.05982.i, 2            ; 2 uses
  %.0.i.1 = add nsw i64 %.083.i, 2                ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge86.i.loopexit.unr-lcssa, label %bb.s, !llvm.loop !260
...
bb.c:                                             ; preds = %bb.b
  ...
  %.val51.i = load i32, ptr %i.i, align 8, !tbaa !26
  %i.j = sub nsw i64 1, %i.b
  %i.k = zext i32 %.val51.i to i64
  %i.l = mul nsw i64 %i.j, %i.k
  %.pn.i = and i64 %i.e, 4294967295
  %i.m = shl i64 %i.l, %.pn.i
  %i.n = tail call fastcc ptr @_PyLong_FromSTwoDigits(i64 noundef %i.m), !inline_history !261
...
._crit_edge62.i:                                  ; preds = %bb.b
  ...
  %i.r = tail call fastcc ptr @long_alloc(i64 noundef %spec.select.i), !inline_history !261 ; 8 uses
  %i.s = icmp eq ptr %i.r, null
  br i1 %i.s, label %long_lshift1.exit, label %bb.d

bb.d:                                             ; preds = %._crit_edge62.i
  %.val52.i = load i64, ptr %i.a, align 8, !tbaa !43
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.w = load i64, ptr %i.v, align 8, !tbaa !43   ; 2 uses
  %i.x = and i64 %i.w, 3
  %i.y = sub nsw i64 2, %i.x
  %i.z = and i64 %i.w, -8
  %i.aa = and i64 %i.y, 4294967295
  %i.ab = or i64 %i.aa, %i.z
  store i64 %i.ab, ptr %i.v, align 8, !tbaa !43
  br label %bb.f
...
.lr.ph.i:                                         ; preds = %bb.f
  ...
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.ad, i8 0, i64 %i.ae, i1 false), !tbaa !26
  br label %.preheader.i

.preheader.i:                                     ; preds = %.lr.ph.i, %bb.f
  %.042.lcssa.i = phi i64 [ 0, %bb.f ], [ %i.d, %.lr.ph.i ] ; 2 uses
...
bb.g:                                             ; preds = %bb.g, %.lr.ph58.i.new
  %.057.i = phi i64 [ 0, %.lr.ph58.i.new ], [ %i.bb, %bb.g ]
  %.04156.i = phi i64 [ 0, %.lr.ph58.i.new ], [ %i.bd, %bb.g ] ; 3 uses
  %.155.i = phi i64 [ %.042.lcssa.i, %.lr.ph58.i.new ], [ %i.bc, %bb.g ] ; 3 uses
  %niter = phi i64 [ 0, %.lr.ph58.i.new ], [ %niter.next.1, %bb.g ]
  %i.ai = getelementptr [4 x i8], ptr %i.af, i64 %.04156.i
  %i.aj = load i32, ptr %i.ai, align 4, !tbaa !26
  %i.ak = zext i32 %i.aj to i64
  %i.al = shl i64 %i.ak, %2
  %i.am = or i64 %i.al, %.057.i                   ; 2 uses
  ...
  %i.ar = getelementptr [4 x i8], ptr %i.af, i64 %.04156.i
  ...
  store i32 %i.ay, ptr %i.ba, align 4, !tbaa !26
  %i.bb = lshr i64 %i.aw, 30                      ; 3 uses
  %i.bc = add nuw nsw i64 %.155.i, 2              ; 2 uses
  %i.bd = add nuw nsw i64 %.04156.i, 2            ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.loopexit.i.unr-lcssa, label %bb.g, !llvm.loop !262
...
.epil.preheader:                                  ; preds = %._crit_edge.loopexit.i.unr-lcssa, %.lr.ph58.i
  %.057.i.epil.init = phi i64 [ 0, %.lr.ph58.i ], [ %i.bb, %._crit_edge.loopexit.i.unr-lcssa ]
  %.04156.i.epil.init = phi i64 [ 0, %.lr.ph58.i ], [ %i.bd, %._crit_edge.loopexit.i.unr-lcssa ]
  %.155.i.epil.init = phi i64 [ %.042.lcssa.i, %.lr.ph58.i ], [ %i.bc, %._crit_edge.loopexit.i.unr-lcssa ]
  %lcmp.mod17 = trunc i64 %i.o to i1
  tail call void @llvm.assume(i1 %lcmp.mod17)
  %i.bf = getelementptr [4 x i8], ptr %i.af, i64 %.04156.i.epil.init
  %i.bg = load i32, ptr %i.bf, align 4, !tbaa !26
  %i.bh = zext i32 %i.bg to i64
  %i.bi = shl i64 %i.bh, %2
  %i.bj = or i64 %i.bi, %.057.i.epil.init         ; 2 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  br i1 %.not13.i.i, label %.critedge.thread.thread.sink.split.i.i, label %bb.j, !llvm.loop !2
...
.critedge.thread.thread.sink.split.i.i:           ; preds = %bb.k, %bb.l
  ...
  store i64 %.sink.i.i, ptr %i.br, align 8, !tbaa !43
  br label %long_normalize.exit.i

long_normalize.exit.i:                            ; preds = %.critedge.thread.thread.sink.split.i.i, %.critedge.i.i, %bb.i
  %i.cb = tail call fastcc ptr @maybe_small_long(ptr noundef nonnull %i.r), !inline_history !261
  br label %long_lshift1.exit
...
bb.e:                                             ; preds = %Py_INCREF.exit260
  ...
  store i32 %i.m, ptr %1, align 8, !tbaa !40
...
bb.k:                                             ; preds = %bb.g
  ...
  %.val31.i = load i64, ptr %i.u, align 8, !tbaa !43 ; 6 uses
  %i.v = getelementptr i8, ptr %i.p, i64 16
  %.val32.i = load i64, ptr %i.v, align 8, !tbaa !43 ; 6 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %.val29.i = load i32, ptr %i.y, align 8, !tbaa !26
  ...
  %.val27.i = load i32, ptr %i.ad, align 8, !tbaa !26
...
bb.n:                                             ; preds = %.lr.ph646
  ...
  br i1 %i.ar, label %.lr.ph646, label %._crit_edge648, !llvm.loop !6
...
.lr.ph646:                                        ; preds = %.preheader.i, %bb.n
  ...
  br i1 %.not25.i, label %bb.n, label %._crit_edge647, !llvm.loop !6

._crit_edge647:                                   ; preds = %.lr.ph646
  br label %._crit_edge648, !llvm.loop !6
