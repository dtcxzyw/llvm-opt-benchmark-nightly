...
begin_hunk_0_@_io_BytesIO_getbuffer:bb.a
  ...
  %i.k = tail call ptr %i.j(ptr noundef %.val8.val.val, i64 noundef 0) #11 ; 6 uses
...
_Py_NewRef.exit.i:                                ; preds = %bb.h, %bb.g
  ...
  store ptr %0, ptr %i.p, align 8, !tbaa !74
...
begin_hunk_2_@bytesio_sizeof:bb.a
  ...
  %.val.val = load i64, ptr %i.c, align 8, !tbaa !76 ; 3 uses
...
begin_hunk_3_@bytesiobuf_dealloc:bb.a
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !77   ; 4 uses
...
bb.c:                                             ; preds = %bb.a
  %i.c = getelementptr i8, ptr %0, i64 16
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !74   ; 5 uses
