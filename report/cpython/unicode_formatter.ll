...
bb.ao:                                            ; preds = %_PyUnicode_DATA.exit.i.i, %_PyUnicode_DATA.exit17.i.i, %_PyUnicode_DATA.exit25.i.i
  ...
  %i.bm = icmp eq i32 %.0.i.i, 45                 ; 3 uses
  %.083.i = select i1 %i.bm, i32 45, i32 0        ; 2 uses
  %.074.i = zext i1 %i.bm to i64                  ; 2 uses
  %8 = zext i1 %i.bm to i32
  %.1.i = or disjoint i32 %.070.i, %8
  %9 = zext nneg i32 %.1.i to i64                 ; 3 uses
  %i.bn = sub i64 %.val110.i, %9                  ; 2 uses
...
begin_hunk_3_@_PyLong_FormatAdvancedWriter:bb.a
  ...
  %.187.i40 = phi i64 [ 0, %.thread ], [ %9, %bb.ao ]
...
begin_hunk_4_@_PyLong_FormatAdvancedWriter:bb.a
  ...
  %.187.i41 = phi i64 [ %.187.i40, %bb.ap ], [ %9, %bb.ao ] ; 3 uses
