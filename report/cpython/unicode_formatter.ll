...
bb.i:                                             ; preds = %bb.h
  ...
  br i1 %cond, label %bb.j, label %bb.af
...
calc_padding.exit.i:                              ; preds = %._crit_edge.unreachabledefault.i, %bb.w, %bb.v
  ...
  br i1 %.not.i.i20, label %bb.x, label %PyUnicode_MAX_CHAR_VALUE.exit.i

bb.x:                                             ; preds = %calc_padding.exit.i
...
PyUnicode_MAX_CHAR_VALUE.exit.i:                  ; preds = %bb.x, %calc_padding.exit.i
  %.0.i.i = phi i32 [ %switch.select6.i.i, %bb.x ], [ 127, %calc_padding.exit.i ]
  %i.ax = icmp ugt i32 %.0.i.i, %.055.i
  br i1 %i.ax, label %bb.y, label %bb.z

bb.y:                                             ; preds = %PyUnicode_MAX_CHAR_VALUE.exit.i
...
bb.z:                                             ; preds = %bb.y, %PyUnicode_MAX_CHAR_VALUE.exit.i
  %i.ba = phi i32 [ %.pre85.i, %bb.y ], [ %i.ap, %PyUnicode_MAX_CHAR_VALUE.exit.i ]
  %.1.i = phi i32 [ %i.az, %bb.y ], [ %.055.i, %PyUnicode_MAX_CHAR_VALUE.exit.i ] ; 2 uses
  %.not71.i = icmp ugt i32 %.1.i, %i.ba
  br i1 %.not71.i, label %bb.ab, label %bb.aa
...
bb.aa:                                            ; preds = %bb.z
  ...
  br i1 %or.cond3.i, label %.critedge.i, label %bb.ac

bb.ab:                                            ; preds = %bb.z
  %.old2.i = icmp eq i64 %.sink.i.i, 0
  br i1 %.old2.i, label %.critedge.i, label %bb.ac
...
.critedge.i:                                      ; preds = %bb.ac, %bb.ab, %bb.aa
  ...
  br i1 %.not72.i, label %bb.ae, label %bb.ad
...
format_obj.exit:                                  ; preds = %bb.ae, %bb.ac, %bb.u, %bb.r, %bb.p, %bb.n, %bb.l, %bb.k, %bb.g, %bb.f, %bb.e, %bb.d, %bb.h, %bb.af, %bb.c
  %.0 = phi i32 [ %i.c, %bb.c ], [ -1, %bb.h ], [ %i.f, %bb.g ], [ -1, %bb.af ], [ -1, %bb.d ], [ %i.f, %bb.e ], [ %i.f, %bb.f ], [ %i.af, %bb.u ], [ -1, %bb.k ], [ -1, %bb.l ], [ -1, %bb.n ], [ -1, %bb.p ], [ -1, %bb.r ], [ -1, %bb.ac ], [ 0, %bb.ae ]
