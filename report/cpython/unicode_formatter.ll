...
iter.check152:                                    ; preds = %bb.m
  ...
  %min.iters.check139 = icmp ult i64 %17, 6
...
vec.epilog.iter.check154:                         ; preds = %middle.block148
  ...
  br i1 %min.epilog.iters.check155, label %.lr.ph30.i.preheader, label %vec.epilog.ph156, !prof !91
...
iter.check:                                       ; preds = %bb.s
  ...
  %min.iters.check108.a = icmp ult i64 %36, 6
...
vec.epilog.iter.check:                            ; preds = %middle.block116
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph30.i72.preheader, label %vec.epilog.ph, !prof !91
