...
.lr.ph30.i.preheader:                             ; preds = %iter.check152, %vec.epilog.iter.check154, %vec.epilog.middle.block162
  %.02629.i.ph = phi ptr [ %i.am, %iter.check152 ], [ %i.bc, %vec.epilog.iter.check154 ], [ %i.bh, %vec.epilog.middle.block162 ]
  br label %.lr.ph30.i

.lr.ph30.i:                                       ; preds = %.lr.ph30.i.preheader, %.lr.ph30.i
  %.02629.i = phi ptr [ %i.bk, %.lr.ph30.i ], [ %.02629.i.ph, %.lr.ph30.i.preheader ] ; 2 uses
  store i16 48, ptr %.02629.i, align 2, !tbaa !47
  %i.bk = getelementptr i8, ptr %.02629.i, i64 2  ; 2 uses
...
.lr.ph.i.preheader:                               ; preds = %bb.n
  ...
  %10 = shl i64 %5, 2                             ; 2 uses
  %i.br = add i64 %i.bq, %i.bp                    ; 2 uses
  %11 = add i64 %i.br, 4
  %i.bs = sub i64 %11, %10
  %i.bt = tail call i64 @llvm.umax.i64(i64 %i.bs, i64 %i.br)
  %i.bu = add i64 %i.bt, %10
  %i.bv = xor i64 %i.bp, -1
  %i.bw = add i64 %i.bu, %i.bv
  %i.bx = sub i64 %i.bw, %i.bq                    ; 2 uses
  %i.by = lshr i64 %i.bx, 2
  %i.bz = add nuw nsw i64 %i.by, 1                ; 2 uses
  %min.iters.check126 = icmp ult i64 %i.bx, 28
  br i1 %min.iters.check126, label %.lr.ph.i.preheader165, label %vector.ph127

vector.ph127:                                     ; preds = %.lr.ph.i.preheader
  %n.vec128 = and i64 %i.bz, 9223372036854775800  ; 3 uses
  %i.ca = shl i64 %n.vec128, 2
...
vector.body129:                                   ; preds = %vector.body129, %vector.ph127
  ...
  %i.cc = shl i64 %index130, 2
  %next.gep131 = getelementptr i8, ptr %i.bm, i64 %i.cc ; 2 uses
  %i.cd = getelementptr i8, ptr %next.gep131, i64 16
  store <4 x i32> splat (i32 48), ptr %next.gep131, align 4, !tbaa !7
  store <4 x i32> splat (i32 48), ptr %i.cd, align 4, !tbaa !7
  %index.next132 = add nuw i64 %index130, 8       ; 2 uses
  %i.ce = icmp eq i64 %index.next132, %n.vec128
  br i1 %i.ce, label %middle.block133, label %vector.body129, !llvm.loop !85

middle.block133:                                  ; preds = %vector.body129
  %cmp.n134 = icmp eq i64 %i.bz, %n.vec128
...
.lr.ph.i.preheader165:                            ; preds = %.lr.ph.i.preheader, %middle.block133
  %.028.i.ph = phi ptr [ %i.bm, %.lr.ph.i.preheader ], [ %i.cb, %middle.block133 ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader165, %.lr.ph.i
  %.028.i = phi ptr [ %i.cf, %.lr.ph.i ], [ %.028.i.ph, %.lr.ph.i.preheader165 ] ; 2 uses
  store i32 48, ptr %.028.i, align 4, !tbaa !7
  %i.cf = getelementptr i8, ptr %.028.i, i64 4    ; 2 uses
  %i.cg = icmp ult ptr %i.cf, %i.bn
  br i1 %i.cg, label %.lr.ph.i, label %_PyUnicode_Fill.exit, !llvm.loop !86

bb.o:                                             ; preds = %_PyUnicode_DATA.exit
  unreachable

.critedge59:                                      ; preds = %.thread96
  %i.ch = load ptr, ptr %0, align 8, !tbaa !34    ; 3 uses
  %i.ci = getelementptr i8, ptr %i.ch, i64 32
  %i.cj = load i32, ptr %i.ci, align 8            ; 3 uses
  %i.ck = lshr i32 %i.cj, 2
  %i.cl = and i32 %i.ck, 7
  %i.cm = and i32 %i.cj, 32
  %.not.i63 = icmp eq i32 %i.cm, 0
  br i1 %.not.i63, label %bb.q, label %bb.p

bb.p:                                             ; preds = %.critedge59
  %i.cn = and i32 %i.cj, 64
  %.not.i.i64 = icmp eq i32 %i.cn, 0
  %.0.v.i.i65 = select i1 %.not.i.i64, i64 56, i64 40
  %.0.i.i66 = getelementptr i8, ptr %i.ch, i64 %.0.v.i.i65
  br label %_PyUnicode_DATA.exit69

bb.q:                                             ; preds = %.critedge59
  %i.co = getelementptr i8, ptr %i.ch, i64 56
  %.val4.i68 = load ptr, ptr %i.co, align 8, !tbaa !15
  br label %_PyUnicode_DATA.exit69
...
_PyUnicode_DATA.exit69:                           ; preds = %bb.p, %bb.q
  ...
  %i.cp = load i64, ptr %1, align 8, !tbaa !43    ; 12 uses
...
bb.r:                                             ; preds = %_PyUnicode_DATA.exit69
  %i.cq = getelementptr i8, ptr %.0.i67, i64 %i.cp
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %i.cq, i8 48, i64 range(i64 1, 0) %5, i1 false)
  %.pre85 = load i64, ptr %1, align 8, !tbaa !43
  br label %_PyUnicode_Fill.exit74

bb.s:                                             ; preds = %_PyUnicode_DATA.exit69
  %i.cr = getelementptr [2 x i8], ptr %.0.i67, i64 %i.cp ; 7 uses
  %i.cs = getelementptr [2 x i8], ptr %i.cr, i64 %5 ; 2 uses
  %i.ct = icmp ult ptr %i.cr, %i.cs
  br i1 %i.ct, label %iter.check, label %_PyUnicode_Fill.exit74

iter.check:                                       ; preds = %bb.s
  %i.cu = shl i64 %i.cp, 1                        ; 2 uses
  %i.cv = add i64 %i.cu, %.0.i67106               ; 2 uses
  %i.cw = shl i64 %5, 1
  %i.cx = add i64 %i.cv, %i.cw
  %i.cy = add i64 %i.cv, 2
  %umax = tail call i64 @llvm.umax.i64(i64 %i.cx, i64 %i.cy)
  %i.cz = xor i64 %.0.i67106, -1
  %i.da = add i64 %umax, %i.cz
  %i.db = sub i64 %i.da, %i.cu                    ; 3 uses
  %i.dc = lshr i64 %i.db, 1
  %i.dd = add nuw i64 %i.dc, 1                    ; 5 uses
  %min.iters.check108 = icmp ult i64 %i.db, 6
  br i1 %min.iters.check108, label %.lr.ph30.i72.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check109 = icmp ult i64 %i.db, 30
...
vector.ph110:                                     ; preds = %vector.main.loop.iter.check
  ...
  %n.vec111 = and i64 %i.dd, -16                  ; 4 uses
  %i.df = shl i64 %n.vec111, 1
  %i.dg = getelementptr i8, ptr %i.cr, i64 %i.df
...
vector.body112:                                   ; preds = %vector.body112, %vector.ph110
  ...
  %i.dh = shl i64 %index113, 1
  %next.gep114 = getelementptr i8, ptr %i.cr, i64 %i.dh ; 2 uses
  %i.di = getelementptr i8, ptr %next.gep114, i64 16
  store <8 x i16> splat (i16 48), ptr %next.gep114, align 2, !tbaa !47
  store <8 x i16> splat (i16 48), ptr %i.di, align 2, !tbaa !47
  %index.next115 = add nuw i64 %index113, 16      ; 2 uses
  %i.dj = icmp eq i64 %index.next115, %n.vec111
  br i1 %i.dj, label %middle.block116, label %vector.body112, !llvm.loop !87

middle.block116:                                  ; preds = %vector.body112
  %cmp.n117 = icmp eq i64 %i.dd, %n.vec111
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec119 = and i64 %i.dd, -4                   ; 3 uses
  %i.dk = shl i64 %n.vec119, 1
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.dm = shl i64 %index120, 1
  %next.gep121 = getelementptr i8, ptr %i.cr, i64 %i.dm
  store <4 x i16> splat (i16 48), ptr %next.gep121, align 2, !tbaa !47
  %index.next122 = add nuw i64 %index120, 4       ; 2 uses
  %i.dn = icmp eq i64 %index.next122, %n.vec119
  br i1 %i.dn, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !88

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n123 = icmp eq i64 %i.dd, %n.vec119
...
.lr.ph30.i72.preheader:                           ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.02629.i73.ph = phi ptr [ %i.cr, %iter.check ], [ %i.dg, %vec.epilog.iter.check ], [ %i.dl, %vec.epilog.middle.block ]
  br label %.lr.ph30.i72

.lr.ph30.i72:                                     ; preds = %.lr.ph30.i72.preheader, %.lr.ph30.i72
  %.02629.i73 = phi ptr [ %i.do, %.lr.ph30.i72 ], [ %.02629.i73.ph, %.lr.ph30.i72.preheader ] ; 2 uses
  store i16 48, ptr %.02629.i73, align 2, !tbaa !47
  %i.do = getelementptr i8, ptr %.02629.i73, i64 2 ; 2 uses
  %i.dp = icmp ult ptr %i.do, %i.cs
  br i1 %i.dp, label %.lr.ph30.i72, label %_PyUnicode_Fill.exit74, !llvm.loop !89

bb.t:                                             ; preds = %_PyUnicode_DATA.exit69
  %i.dq = getelementptr [4 x i8], ptr %.0.i67, i64 %i.cp ; 5 uses
  %i.dr = getelementptr [4 x i8], ptr %i.dq, i64 %5 ; 2 uses
  %i.ds = icmp ult ptr %i.dq, %i.dr
  br i1 %i.ds, label %.lr.ph.i70.preheader, label %_PyUnicode_Fill.exit74

.lr.ph.i70.preheader:                             ; preds = %bb.t
  %i.dt = ptrtoaddr ptr %.0.i67 to i64            ; 2 uses
  %i.du = shl i64 %i.cp, 2                        ; 2 uses
  %i.dv = shl i64 %5, 2
  %i.dw = add i64 %i.du, %i.dt                    ; 2 uses
  %i.dx = add i64 %i.dw, %i.dv
  %i.dy = add i64 %i.dw, 4
  %i.dz = tail call i64 @llvm.umax.i64(i64 %i.dx, i64 %i.dy)
  %i.ea = xor i64 %i.dt, -1
  %i.eb = add i64 %i.dz, %i.ea
  %i.ec = sub i64 %i.eb, %i.du                    ; 2 uses
  %i.ed = lshr i64 %i.ec, 2
  %i.ee = add nuw nsw i64 %i.ed, 1                ; 2 uses
  %min.iters.check = icmp ult i64 %i.ec, 28
  br i1 %min.iters.check, label %.lr.ph.i70.preheader167, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph.i70.preheader
  %n.vec = and i64 %i.ee, 9223372036854775800     ; 3 uses
  %i.ef = shl i64 %n.vec, 2
  %i.eg = getelementptr i8, ptr %i.dq, i64 %i.ef
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.eh = shl i64 %index, 2
  %next.gep = getelementptr i8, ptr %i.dq, i64 %i.eh ; 2 uses
  %i.ei = getelementptr i8, ptr %next.gep, i64 16
  store <4 x i32> splat (i32 48), ptr %next.gep, align 4, !tbaa !7
  store <4 x i32> splat (i32 48), ptr %i.ei, align 4, !tbaa !7
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ej = icmp eq i64 %index.next, %n.vec
  br i1 %i.ej, label %middle.block, label %vector.body, !llvm.loop !90
...
.lr.ph.i70.preheader167:                          ; preds = %.lr.ph.i70.preheader, %middle.block
  %.028.i71.ph = phi ptr [ %i.dq, %.lr.ph.i70.preheader ], [ %i.eg, %middle.block ]
  br label %.lr.ph.i70

.lr.ph.i70:                                       ; preds = %.lr.ph.i70.preheader167, %.lr.ph.i70
  %.028.i71 = phi ptr [ %i.ek, %.lr.ph.i70 ], [ %.028.i71.ph, %.lr.ph.i70.preheader167 ] ; 2 uses
  store i32 48, ptr %.028.i71, align 4, !tbaa !7
  %i.ek = getelementptr i8, ptr %.028.i71, i64 4  ; 2 uses
  %i.el = icmp ult ptr %i.ek, %i.dr
  br i1 %i.el, label %.lr.ph.i70, label %_PyUnicode_Fill.exit74, !llvm.loop !91
...
_PyUnicode_Fill.exit74:                           ; preds = %.lr.ph.i70, %.lr.ph30.i72, %middle.block, %middle.block116, %vec.epilog.middle.block, %bb.r, %bb.s, %bb.t
  %i.em = phi i64 [ %i.cp, %middle.block116 ], [ %i.cp, %bb.t ], [ %.pre85, %bb.r ], [ %i.cp, %bb.s ], [ %i.cp, %middle.block ], [ %i.cp, %vec.epilog.middle.block ], [ %i.cp, %.lr.ph30.i72 ], [ %i.cp, %.lr.ph.i70 ]
  %i.en = add i64 %i.em, %5
  store i64 %i.en, ptr %1, align 8, !tbaa !43
  br label %_PyUnicode_Fill.exit
