...
bb.b:                                             ; preds = %bb.a
  %i.a = load i32, ptr %8, align 4, !tbaa !10
...
PyUnicode_MAX_CHAR_VALUE.exit:                    ; preds = %bb.c, %bb.d
  ...
  store i32 %.0.i, ptr %8, align 4, !tbaa !10
...
iter.check152:                                    ; preds = %bb.m
  %10 = shl i64 %i.ab, 1                          ; 2 uses
  %11 = add i64 %10, %.0.i61136                   ; 2 uses
  %12 = add i64 %11, 2
  %13 = shl i64 %5, 1                             ; 2 uses
  %14 = sub i64 %12, %13
  %umax137 = tail call i64 @llvm.umax.i64(i64 %14, i64 %11)
  %15 = add i64 %umax137, %13
  %16 = xor i64 %.0.i61136, -1
  %i.ap = add i64 %15, %16
  %17 = sub i64 %i.ap, %10                        ; 3 uses
  %18 = lshr i64 %17, 1
  %i.aq = add nuw i64 %18, 1                      ; 5 uses
  %min.iters.check139 = icmp ult i64 %17, 14
...
vector.main.loop.iter.check140:                   ; preds = %iter.check152
  %min.iters.check141 = icmp ult i64 %17, 30
...
vec.epilog.iter.check154:                         ; preds = %middle.block148
  %min.epilog.iters.check155.not.not = icmp eq i64 %i.ar, 0
  br i1 %min.epilog.iters.check155.not.not, label %.lr.ph30.i.preheader, label %vec.epilog.ph156, !prof !91
...
vec.epilog.ph156:                                 ; preds = %vector.main.loop.iter.check140, %vec.epilog.iter.check154
  ...
  %n.vec157 = and i64 %i.aq, -8                   ; 3 uses
...
vec.epilog.vector.body158:                        ; preds = %vec.epilog.vector.body158, %vec.epilog.ph156
  ...
  store <8 x i16> splat (i16 48), ptr %next.gep160, align 2, !tbaa !47
  %index.next161 = add nuw i64 %index159, 8       ; 2 uses
  %i.ba = icmp eq i64 %index.next161, %n.vec157
  br i1 %i.ba, label %vec.epilog.middle.block162, label %vec.epilog.vector.body158, !llvm.loop !80
...
.lr.ph30.i:                                       ; preds = %.lr.ph30.i.preheader, %.lr.ph30.i
  ...
  br i1 %i.bc, label %.lr.ph30.i, label %_PyUnicode_Fill.exit, !llvm.loop !81
...
.lr.ph.i.preheader:                               ; preds = %bb.n
  %19 = ptrtoaddr ptr %.0.i61 to i64              ; 2 uses
  %20 = shl i64 %i.ab, 2                          ; 2 uses
  %21 = shl i64 %5, 2                             ; 2 uses
  %22 = add i64 %20, %19                          ; 2 uses
  %23 = add i64 %22, 4
  %24 = sub i64 %23, %21
  ...
  %27 = xor i64 %19, -1
  %i.bg = add i64 %26, %27
  %28 = sub i64 %i.bg, %20                        ; 2 uses
  %29 = lshr i64 %28, 2
  %i.bh = add nuw nsw i64 %29, 1                  ; 2 uses
  %min.iters.check126 = icmp ult i64 %28, 28
...
vector.body129:                                   ; preds = %vector.body129, %vector.ph127
  ...
  store <4 x i32> splat (i32 48), ptr %next.gep131, align 4, !tbaa !10
  store <4 x i32> splat (i32 48), ptr %i.bl, align 4, !tbaa !10
  %index.next132 = add nuw i64 %index130, 8       ; 2 uses
  %i.bm = icmp eq i64 %index.next132, %n.vec128
  br i1 %i.bm, label %middle.block133, label %vector.body129, !llvm.loop !82
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader165, %.lr.ph.i
  ...
  store i32 48, ptr %.028.i, align 4, !tbaa !10
  %i.bn = getelementptr i8, ptr %.028.i, i64 4    ; 2 uses
  %i.bo = icmp ult ptr %i.bn, %i.be
  br i1 %i.bo, label %.lr.ph.i, label %_PyUnicode_Fill.exit, !llvm.loop !83
...
_PyUnicode_DATA.exit69:                           ; preds = %bb.p, %bb.q
  ...
  %i.bx = load i64, ptr %1, align 8, !tbaa !43    ; 12 uses
...
iter.check:                                       ; preds = %bb.s
  %30 = shl i64 %i.bx, 1                          ; 2 uses
  %31 = add i64 %30, %.0.i67106                   ; 2 uses
  %32 = shl i64 %5, 1
  %33 = add i64 %31, %32
  %34 = add i64 %31, 2
  %umax = tail call i64 @llvm.umax.i64(i64 %33, i64 %34)
  %35 = xor i64 %.0.i67106, -1
  %i.cc = add i64 %umax, %35
  %36 = sub i64 %i.cc, %30                        ; 3 uses
  %37 = lshr i64 %36, 1
  %i.cd = add nuw i64 %37, 1                      ; 5 uses
  %min.iters.check108.a = icmp ult i64 %36, 14
  br i1 %min.iters.check108.a, label %.lr.ph30.i72.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check109 = icmp ult i64 %36, 30
...
vector.body112:                                   ; preds = %vector.body112, %vector.ph110
  ...
  br i1 %i.cj, label %middle.block116, label %vector.body112, !llvm.loop !84
...
vec.epilog.iter.check:                            ; preds = %middle.block116
  %min.epilog.iters.check.not.not = icmp eq i64 %i.ce, 0
  br i1 %min.epilog.iters.check.not.not, label %.lr.ph30.i72.preheader, label %vec.epilog.ph, !prof !91

vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec111, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec119 = and i64 %i.cd, -8                   ; 3 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  store <8 x i16> splat (i16 48), ptr %next.gep121, align 2, !tbaa !47
  %index.next122 = add nuw i64 %index120, 8       ; 2 uses
  %i.cn = icmp eq i64 %index.next122, %n.vec119
  br i1 %i.cn, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !85
...
.lr.ph30.i72:                                     ; preds = %.lr.ph30.i72.preheader, %.lr.ph30.i72
  ...
  br i1 %i.cp, label %.lr.ph30.i72, label %_PyUnicode_Fill.exit74, !llvm.loop !86
...
.lr.ph.i70.preheader:                             ; preds = %bb.t
  %38 = ptrtoaddr ptr %.0.i67 to i64              ; 2 uses
  %39 = shl i64 %i.bx, 2                          ; 2 uses
  %40 = shl i64 %5, 2
  %41 = add i64 %39, %38                          ; 2 uses
  %42 = add i64 %41, %40
  %43 = add i64 %41, 4
  %44 = tail call i64 @llvm.umax.i64(i64 %42, i64 %43)
  %45 = xor i64 %38, -1
  %i.ct = add i64 %44, %45
  %46 = sub i64 %i.ct, %39                        ; 2 uses
  %47 = lshr i64 %46, 2
  %i.cu = add nuw nsw i64 %47, 1                  ; 2 uses
  %min.iters.check = icmp ult i64 %46, 28
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> splat (i32 48), ptr %next.gep, align 4, !tbaa !10
  store <4 x i32> splat (i32 48), ptr %i.cy, align 4, !tbaa !10
...
.lr.ph.i70:                                       ; preds = %.lr.ph.i70.preheader167, %.lr.ph.i70
  ...
  store i32 48, ptr %.028.i71, align 4, !tbaa !10
  %i.da = getelementptr i8, ptr %.028.i71, i64 4  ; 2 uses
  %i.db = icmp ult ptr %i.da, %i.cr
  br i1 %i.db, label %.lr.ph.i70, label %_PyUnicode_Fill.exit74, !llvm.loop !88
