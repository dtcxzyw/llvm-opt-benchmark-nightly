...
PyUnicode_READ.exit170.i:                         ; preds = %bb.ff, %bb.fe, %bb.fd
  ...
  br i1 %i.nu, label %.preheader.i, label %PyUnicode_READ.exit170.i..critedge.i.loopexit_crit_edge, !llvm.loop !70
...
.critedge.i:                                      ; preds = %.preheader.i, %PyUnicode_READ.exit168.i, %.preheader.i.preheader, %PyUnicode_READ.exit170.i..critedge.i.loopexit_crit_edge, %bb.fk
  %.2.i = phi i64 [ %i.oe, %bb.fk ], [ %i.nc, %.preheader.i.preheader ], [ %.1131.i263, %PyUnicode_READ.exit170.i..critedge.i.loopexit_crit_edge ], [ %.1131.i263, %PyUnicode_READ.exit168.i ], [ %i.nc, %.preheader.i ] ; 10 uses
...
.thread215.i:                                     ; preds = %bb.ht, %.critedge158.i, %.thread.i
  %.8207222.i = phi i64 [ %.8207.i, %bb.ht ], [ %.4.i, %.critedge158.i ], [ %.8209.i, %.thread.i ] ; 7 uses
