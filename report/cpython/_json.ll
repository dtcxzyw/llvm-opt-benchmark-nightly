...
begin_hunk_0_@scan_once_unicode:bb.a
  ...
  %.val = load i64, ptr %i.g, align 8, !tbaa !24  ; 18 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.preheader.i
  %.1131.i263 = phi i64 [ %.1131.i, %.preheader.i ], [ %.1131.i261, %.lr.ph.preheader ] ; 10 uses
...
.critedge.i.loopexitsplit:                        ; preds = %.preheader.i
  %.2.i.ph.ph = phi i64 [ %i.nc, %.preheader.i ]
  br label %.critedge.i.loopexit

PyUnicode_READ.exit168.i..critedge.i.loopexit_crit_edge: ; preds = %PyUnicode_READ.exit168.i
  %.1131.i263.lcssa = phi i64 [ %.1131.i263, %PyUnicode_READ.exit168.i ]
  %.1131.i263.lcssa.a = phi i64 [ %.1131.i263, %PyUnicode_READ.exit168.i ] ; 0 uses
  br label %.critedge.i.loopexit

.critedge.i.loopexit:                             ; preds = %.critedge.i.loopexitsplit, %PyUnicode_READ.exit168.i..critedge.i.loopexit_crit_edge
  %.2.i.ph = phi i64 [ %.1131.i263.lcssa, %PyUnicode_READ.exit168.i..critedge.i.loopexit_crit_edge ], [ %.2.i.ph.ph, %.critedge.i.loopexitsplit ]
  br label %.critedge.i
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %bb.gj
  %.3226.i = phi i64 [ %i.qg, %bb.gj ], [ %i.pn, %.lr.ph.i.preheader ] ; 10 uses
...
PyUnicode_READ.exit183.i..critedge2.i.loopexit_crit_edge: ; preds = %PyUnicode_READ.exit183.i
  %.3226.i.lcssa353 = phi i64 [ %.3226.i, %PyUnicode_READ.exit183.i ]
  %.3226.i.lcssa356 = phi i64 [ %.3226.i, %PyUnicode_READ.exit183.i ] ; 0 uses
  br label %.critedge2.i.loopexit

.critedge2.i.loopexit:                            ; preds = %.critedge2.i.loopexitsplit, %PyUnicode_READ.exit183.i..critedge2.i.loopexit_crit_edge
  %.3226.i.lcssa = phi i64 [ %.3226.i.lcssa353, %PyUnicode_READ.exit183.i..critedge2.i.loopexit_crit_edge ], [ %.3226.i.lcssa357, %.critedge2.i.loopexitsplit ]
...
.lr.ph231.i:                                      ; preds = %.lr.ph231.i.preheader, %bb.hk
  %.6230.i = phi i64 [ %i.sn, %bb.hk ], [ %.5.i, %.lr.ph231.i.preheader ] ; 10 uses
...
..critedge4.i.loopexitsplit_crit_edge:            ; preds = %bb.hk
  %split366 = phi i64 [ %.val, %bb.hk ]           ; 0 uses
...
PyUnicode_READ.exit195.i..critedge4.i.loopexit_crit_edge: ; preds = %PyUnicode_READ.exit195.i
  %.6230.i.lcssa = phi i64 [ %.6230.i, %PyUnicode_READ.exit195.i ]
  %.6230.i.lcssa.a = phi i64 [ %.6230.i, %PyUnicode_READ.exit195.i ] ; 0 uses
  br label %.critedge4.i.loopexit

.critedge4.i.loopexit:                            ; preds = %.critedge4.i.loopexitsplit, %PyUnicode_READ.exit195.i..critedge4.i.loopexit_crit_edge
  %.6.lcssa.i.ph = phi i64 [ %.6230.i.lcssa, %PyUnicode_READ.exit195.i..critedge4.i.loopexit_crit_edge ], [ %.6.lcssa.i.ph.ph, %.critedge4.i.loopexitsplit ]
...
.lr.ph419:                                        ; preds = %.lr.ph419.preheader, %.critedge10
  %.3418 = phi i64 [ %.3, %.critedge10 ], [ %.3416, %.lr.ph419.preheader ] ; 15 uses
...
PyUnicode_READ.exit296..critedge8.loopexit_crit_edge: ; preds = %PyUnicode_READ.exit296
  %.3418.lcssa = phi i64 [ %.3418, %PyUnicode_READ.exit296 ]
  %.3418.lcssa.a = phi i64 [ %.3418, %PyUnicode_READ.exit296 ] ; 0 uses
  br label %.critedge8.loopexit

.critedge8.loopexit:                              ; preds = %.critedge8.loopexitsplit, %PyUnicode_READ.exit296..critedge8.loopexit_crit_edge
  %.3.lcssa.ph = phi i64 [ %.3418.lcssa, %PyUnicode_READ.exit296..critedge8.loopexit_crit_edge ], [ %.3.lcssa708, %.critedge8.loopexitsplit ]
  br label %.critedge8
