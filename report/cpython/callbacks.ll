...
bb.j:                                             ; preds = %_PyVectorcall_FunctionInline.exit.i.i
  %i.am = tail call ptr %.0.copyload.i.i.i(ptr noundef nonnull %i.p, ptr noundef null, i64 noundef 0, ptr noundef null) #6
...
bb.k:                                             ; preds = %_PyObject_CallNoArgs.exit
  %i.ao = load ptr, ptr %i.n, align 8, !tbaa !70  ; 2 uses
...
Py_DECREF.exit99:                                 ; preds = %bb.k, %PyObject_TypeCheck.exit
  ...
  %i.ax = load ptr, ptr %i.aw, align 16, !tbaa !71
...
begin_hunk_3_@_CallPythonObject:bb.a
  ...
  br i1 %exitcond.not, label %._crit_edge, label %bb.e, !llvm.loop !74
...
bb.t:                                             ; preds = %bb.s
  %i.bk = load ptr, ptr %i.a, align 8, !tbaa !75  ; 2 uses
...
bb.x:                                             ; preds = %bb.w
  %i.br = load ptr, ptr %i.a, align 8, !tbaa !75  ; 2 uses
...
bb.ac:                                            ; preds = %Py_XDECREF.exit
  %i.ca = load i64, ptr %2, align 8, !tbaa !77
...
bb.ae:                                            ; preds = %bb.ac
  ...
  %i.cf = load ptr, ptr %i.ce, align 8, !tbaa !78
...
Py_DECREF.exit:                                   ; preds = %.lr.ph143, %bb.an, %bb.ao
  ...
  br i1 %exitcond154.not, label %._crit_edge144, label %.lr.ph143, !llvm.loop !80
...
!70 = !{!17, !13, i64 96}
!71 = !{!72, !30, i64 16}
!72 = !{!"tagCDataObject", !12, i64 0, !30, i64 16, !7, i64 24, !73, i64 32, !15, i64 40, !15, i64 48, !15, i64 56, !18, i64 64, !8, i64 80}
!73 = !{!"p1 _ZTS14tagCDataObject", !14, i64 0}
!74 = distinct !{!74, !40}
!75 = !{!76, !76, i64 0}
!76 = !{!"p1 int", !14, i64 0}
!77 = !{!47, !15, i64 0}
!78 = !{!79, !14, i64 16}
!79 = !{!"fielddesc", !8, i64 0, !20, i64 8, !14, i64 16, !14, i64 24, !14, i64 32, !14, i64 40}
!80 = distinct !{!80, !40}
end_hunk_9
