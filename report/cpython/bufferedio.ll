...
bb.z:                                             ; preds = %bb.y
  ...
  %i.bh = call ptr @PyBytes_FromStringAndSize(ptr noundef %i.bg, i64 noundef %i.be) #9 ; 2 uses
...
bb.av:                                            ; preds = %bb.as
  br i1 %.not6197.i.i, label %.thread153.i.i, label %bb.aw

.thread99.i.i:                                    ; preds = %bb.at
  br i1 %.not6197.i.i, label %bb.bl, label %3

3:                                                ; preds = %.thread99.i.i
...
bb.ay:                                            ; preds = %.backedge, %.preheader.i.i
  %i.dm = phi ptr [ %.pre.i.i, %.preheader.i.i ], [ %i.du, %.backedge ] ; 2 uses
...
bb.bl:                                            ; preds = %bb.bi, %.thread101.i.i, %bb.aw, %.thread99.i.i
  %.2.i.i = phi ptr [ %.0.i.i.i.i, %.thread99.i.i ], [ %i.ed, %bb.bi ], [ %.0.i.i.i.i, %bb.aw ], [ null, %.thread101.i.i ] ; 2 uses
  %.037.i.i = phi ptr [ null, %.thread99.i.i ], [ %i.dj, %bb.bi ], [ null, %bb.aw ], [ %i.dj, %.thread101.i.i ] ; 2 uses
  %.036.i.i = phi ptr [ %.0.i.i.i.i, %.thread99.i.i ], [ %i.ed, %bb.bi ], [ %.pre.i.i.a, %bb.aw ], [ %i.du, %.thread101.i.i ] ; 2 uses
