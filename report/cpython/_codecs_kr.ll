Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/cpython/original/_codecs_kr?download=true
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.o = load ptr, ptr %6, align 8, !tbaa !27
  store i8 %i.n, ptr %i.o, align 1, !tbaa !25
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.u = load ptr, ptr %i.t, align 16, !tbaa !32  ; 2 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.x = load i8, ptr %i.w, align 8, !tbaa !33
...
bb.l:                                             ; preds = %bb.k
  %i.ac = sub nuw nsw i32 %i.v, %i.y
  %i.ad = zext nneg i32 %i.ac to i64
  %i.ae = getelementptr [2 x i8], ptr %i.u, i64 %i.ad
  %i.af = load i16, ptr %i.ae, align 2, !tbaa !29 ; 4 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.ak = load ptr, ptr %6, align 8, !tbaa !27
  store i8 %i.aj, ptr %i.ak, align 1, !tbaa !25
  %i.al = trunc i16 %i.af to i8
  %i.am = or i8 %i.al, -128
  %i.an = load ptr, ptr %6, align 8, !tbaa !27
  %i.ao = getelementptr i8, ptr %i.an, i64 1
  store i8 %i.am, ptr %i.ao, align 1, !tbaa !25
  br label %bb.q
...
bb.p:                                             ; preds = %bb.o
  %i.aq = load ptr, ptr %6, align 8, !tbaa !27
  store i8 -92, ptr %i.aq, align 1, !tbaa !25
  %i.ar = load ptr, ptr %6, align 8, !tbaa !27
  %i.as = getelementptr i8, ptr %i.ar, i64 1
  store i8 -44, ptr %i.as, align 1, !tbaa !25
  %i.at = add nsw i32 %.0.i, -44032               ; 3 uses
  %i.au = load ptr, ptr %6, align 8, !tbaa !27
  %i.av = getelementptr i8, ptr %i.au, i64 2
  store i8 -92, ptr %i.av, align 1, !tbaa !25
  %i.aw = udiv i32 %i.at, 588
  %i.ax = zext nneg i32 %i.aw to i64
  %i.ay = getelementptr i8, ptr @u2cgk_choseong, i64 %i.ax
  %i.az = load i8, ptr %i.ay, align 1, !tbaa !25
  %i.ba = load ptr, ptr %6, align 8, !tbaa !27
  %i.bb = getelementptr i8, ptr %i.ba, i64 3
  store i8 %i.az, ptr %i.bb, align 1, !tbaa !25
  %i.bc = load ptr, ptr %6, align 8, !tbaa !27
  %i.bd = getelementptr i8, ptr %i.bc, i64 4      ; 2 uses
  store ptr %i.bd, ptr %6, align 8, !tbaa !27
  store i8 -92, ptr %i.bd, align 1, !tbaa !25
...
bb.q:                                             ; preds = %bb.n, %bb.p, %bb.f
  ...
  %i.bt = load i64, ptr %4, align 8, !tbaa !28
  %i.bu = add i64 %i.bt, 1                        ; 3 uses
  store i64 %i.bu, ptr %4, align 8, !tbaa !28
  %i.bv = load ptr, ptr %6, align 8, !tbaa !27
  %i.bw = getelementptr i8, ptr %i.bv, i64 %.sink91
  store ptr %i.bw, ptr %6, align 8, !tbaa !27
...
bb.b:                                             ; preds = %.lr.ph
  ...
  br i1 %i.g, label %.thread95, label %bb.v, !llvm.loop !66
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.u = load i8, ptr %i.t, align 1, !tbaa !25    ; 2 uses
  %i.v = add i8 %i.u, 95
...
bb.l:                                             ; preds = %bb.j, %bb.k
  %.064 = phi i32 [ %i.z, %bb.k ], [ 127, %bb.j ] ; 2 uses
  ...
  %i.ag = load i8, ptr %i.af, align 1, !tbaa !25  ; 3 uses
...
bb.q:                                             ; preds = %bb.e, %bb.d
  ...
  %i.bc = load ptr, ptr %i.bb, align 16, !tbaa !36 ; 2 uses
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.bi = load i8, ptr %i.bh, align 8, !tbaa !37  ; 2 uses
...
bb.t:                                             ; preds = %bb.s
  %i.bm = sub nuw nsw i64 %i.bg, %i.bj
  %i.bn = getelementptr [2 x i8], ptr %i.bc, i64 %i.bm
  %i.bo = load i16, ptr %i.bn, align 2, !tbaa !29 ; 2 uses
...
bb.v:                                             ; preds = %bb.u, %bb.p, %bb.b
  ...
  %i.bs = load ptr, ptr %2, align 8, !tbaa !27
  %i.bt = getelementptr i8, ptr %i.bs, i64 %.sink135 ; 2 uses
  store ptr %i.bt, ptr %2, align 8, !tbaa !27
...
bb.a:
  %i.a = load i64, ptr %4, align 8, !tbaa !28     ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.ai = or i8 %i.ah, -128
  %i.aj = load ptr, ptr %6, align 8, !tbaa !27
  ...
  %i.am = load ptr, ptr %6, align 8, !tbaa !27
  %i.an = getelementptr i8, ptr %i.am, i64 1
  store i8 %.sink, ptr %i.an, align 1, !tbaa !25
  br label %bb.n

bb.n:                                             ; preds = %bb.m, %bb.f
  %.sink76 = phi i64 [ 2, %bb.m ], [ 1, %bb.f ]
  %.sink73 = phi i64 [ -2, %bb.m ], [ -1, %bb.f ]
  %i.ao = load i64, ptr %4, align 8, !tbaa !28
  %i.ap = add i64 %i.ao, 1                        ; 3 uses
  store i64 %i.ap, ptr %4, align 8, !tbaa !28
  %i.aq = load ptr, ptr %6, align 8, !tbaa !27
  %i.ar = getelementptr i8, ptr %i.aq, i64 %.sink76
  store ptr %i.ar, ptr %6, align 8, !tbaa !27
