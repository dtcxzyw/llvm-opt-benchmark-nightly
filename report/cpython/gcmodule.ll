...
bb.f:                                             ; preds = %bb.d
  ...
  store i32 %i.s, ptr %i.w, align 8, !tbaa !28
  %i.x = getelementptr i8, ptr %i.v, i64 7448
  store i32 %i.t, ptr %i.x, align 8, !tbaa !29
  %i.y = getelementptr i8, ptr %i.v, i64 7472
  store i32 %.pre, ptr %i.y, align 8, !tbaa !29
  br label %gc_set_threshold_impl.exit
...
.thread28:                                        ; preds = %bb.b, %bb.c
  ...
  br i1 %.not24, label %.thread34, label %bb.d
...
.thread34:                                        ; preds = %.thread28
  %4 = call i32 (ptr, ptr, ...) @PySys_Audit(ptr noundef nonnull @.str.27, ptr noundef nonnull @.str.28, i64 noundef -1) #4
  %5 = icmp slt i32 %4, 0
  br i1 %5, label %gc_get_objects_impl.exit, label %.thread36
...
.thread36:                                        ; preds = %.thread34, %bb.h
  %6 = phi i64 [ %.pre, %bb.h ], [ -1, %.thread34 ]
  %i.t = call align 8 ptr @llvm.threadlocal.address.p0(ptr align 8 @_Py_tss_interp)
  %i.u = load ptr, ptr %i.t, align 8, !tbaa !11
  %i.v = trunc nsw i64 %6 to i32
  %i.w = call ptr @_PyGC_GetObjects(ptr noundef %i.u, i32 noundef %i.v) #4
  br label %gc_get_objects_impl.exit

gc_get_objects_impl.exit:                         ; preds = %.thread34, %.thread36, %bb.i, %bb.g, %bb.e, %bb.d, %bb.c
  %.0 = phi ptr [ null, %bb.c ], [ null, %bb.d ], [ %i.w, %.thread36 ], [ %i.q, %bb.g ], [ null, %bb.i ], [ null, %bb.e ], [ null, %.thread34 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #4
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #4
  ret ptr %.0
}
