...
_PyObject_IS_GC.exit.i.i:                         ; preds = %bb.e
  %i.t = tail call i32 %i.r(ptr noundef nonnull %i.m) #4
...
bb.f:                                             ; preds = %_PyObject_IS_GC.exit.thread22.i.i
  %i.w = tail call i32 %i.v(ptr noundef nonnull %i.m, ptr noundef nonnull @referentsvisit, ptr noundef nonnull %i.g) #4
...
begin_hunk_2_@gc_get_referents:bb.a
  ...
  br i1 %i.y, label %bb.d, label %append_referrents.exit.thread.i, !llvm.loop !45
