...
read_thread_ids.exit:                             ; preds = %.backedge.i, %bb.e
  ...
  br i1 %.not78, label %.thread66, label %.lr.ph

.lr.ph:                                           ; preds = %read_thread_ids.exit, %seize_thread.exit.thread60
  %.02976 = phi i64 [ %i.cs, %seize_thread.exit.thread60 ], [ 0, %read_thread_ids.exit ] ; 6 uses
  %i.aw = load ptr, ptr %1, align 8, !tbaa !123
  %i.ax = getelementptr [4 x i8], ptr %i.aw, i64 %.02976
...
.lr.ph.i38:                                       ; preds = %bb.q, %.lr.ph.i38
  ...
  %exitcond.not.i = icmp eq i64 %i.bn, %.02976
...
.lr.ph.i41:                                       ; preds = %bb.s, %.lr.ph.i41
  ...
  %exitcond.not.i43 = icmp eq i64 %.04.i42, %.02976
...
.lr.ph.i47:                                       ; preds = %bb.u, %.lr.ph.i47
  ...
  %exitcond.not.i49 = icmp eq i64 %.04.i48, %.02976
...
seize_thread.exit.thread60:                       ; preds = %bb.p, %bb.m, %bb.m, %seize_thread.exit.thread63
  %i.cs = add nuw i64 %.02976, 1                  ; 2 uses
