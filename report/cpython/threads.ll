...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %seize_thread.exit.thread60
  %.02975 = phi i64 [ %i.cq, %seize_thread.exit.thread60 ], [ 0, %.lr.ph.preheader ] ; 6 uses
...
._crit_edge:                                      ; preds = %bb.m
  %.02975.lcssa138 = phi i64 [ %.02975, %bb.m ]
  br label %bb.q

bb.q:                                             ; preds = %split.a, %._crit_edge
  %.02975.lcssa = phi i64 [ %.02975.lcssa138, %._crit_edge ], [ %.02975.lcssa139, %split.a ] ; 2 uses
  %.lcssa131 = phi i32 [ %i.ay, %._crit_edge ], [ %i.ay, %split.a ]
  %.lcssa = phi ptr [ %i.bb, %._crit_edge ], [ %i.bb, %split.a ]
  %i.bi = phi i32 [ %i.bc, %._crit_edge ], [ %i.bg, %split.a ]
...
begin_hunk_3_@_Py_RemoteDebug_StopAllThreads:bb.a
  ...
  %exitcond.not.i43 = icmp eq i64 %.02975, %lsr.iv.next
...
begin_hunk_5_@_Py_RemoteDebug_StopAllThreads:bb.a
  ...
  %exitcond.not.i49 = icmp eq i64 %.02975, %lsr.iv.next147
