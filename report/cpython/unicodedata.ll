...
bb.m:                                             ; preds = %bb.l
  ...
  %3 = insertelement <2 x i16> poison, i16 %.lhs.trunc, i64 0
  %4 = insertelement <2 x i16> %3, i16 %i.ao, i64 1
  %5 = udiv <2 x i16> %4, <i16 588, i16 28>
  %6 = add nuw nsw <2 x i16> %5, <i16 4352, i16 4449>
  %i.as = zext nneg <2 x i16> %6 to <2 x i32>
