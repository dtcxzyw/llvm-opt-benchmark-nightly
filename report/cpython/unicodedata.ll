...
bb.m:                                             ; preds = %bb.k, %bb.j, %bb.i, %bb.h
  ...
  %.022.i = phi i32 [ 1, %bb.i ], [ 0, %bb.h ], [ 0, %bb.j ], [ 1, %bb.k ]
  %3 = phi i32 [ 2, %bb.i ], [ 0, %bb.h ], [ 0, %bb.j ], [ 2, %bb.k ]
...
is_normalized_quickcheck.exit.thread29.i:         ; preds = %is_normalized_quickcheck.exit.i, %PyObject_TypeCheck.exit.i.i
  ...
  %i.de = tail call ptr %i.dd(ptr noundef %0, ptr noundef %i.g, i32 noundef %.022.i) #11, !callees !81, !inline_history !82 ; 5 uses
...
bb.u:                                             ; preds = %bb.g, %bb.f, %bb.e, %bb.d, %bb.c, %bb.b
  ...
  %.lcssa131.neg.ph = phi i32 [ -16, %bb.g ], [ -30, %bb.f ], [ -20, %bb.e ], [ -28, %bb.d ], [ -17, %bb.c ], [ -22, %bb.b ]
  %.ph = phi i64 [ 16, %bb.g ], [ 30, %bb.f ], [ 20, %bb.e ], [ 28, %bb.d ], [ 17, %bb.c ], [ 22, %bb.b ]
  %3 = add i32 %.lcssa131.neg.ph, %1              ; 2 uses
  %i.bf = add i32 %3, -7
  %or.cond.i = icmp ult i32 %i.bf, -3
  br i1 %or.cond.i, label %parse_hex_code.exit, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.bg = getelementptr i8, ptr %0, i64 %.ph      ; 2 uses
