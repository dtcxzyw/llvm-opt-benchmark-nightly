...
.critedge.a:                                      ; preds = %.critedgethread-pre-split, %bb.n
...
begin_hunk_3
  ...
  br i1 %i.bn, label %.lr.ph162, label %.critedge153
...
begin_hunk_4
  ...
  br i1 %i.cl, label %.critedge155, label %.lr.ph, !llvm.loop !98
...
begin_hunk_5
  ...
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !99   ; 7 uses
  %i.h = getelementptr i8, ptr %i.g, i64 24
  %i.i = load i32, ptr %i.h, align 8, !tbaa !100  ; 6 uses
  %i.j = getelementptr i8, ptr %i.g, i64 32
  %i.k = load i32, ptr %i.j, align 8, !tbaa !101  ; 4 uses
...
begin_hunk_6
  ...
  %i.q = load i32, ptr %i.p, align 4, !tbaa !102  ; 5 uses
...
..split67_crit_edge:                              ; preds = %bb.b
  ...
  %.pre96 = load i32, ptr %.phi.trans.insert95, align 4, !tbaa !103
  br label %.split67
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.t = load i32, ptr %i.s, align 4, !tbaa !103  ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.n = load ptr, ptr %i.m, align 8, !tbaa !110  ; 4 uses
...
begin_hunk_11
  ...
  br i1 %i.aa, label %bb.c, label %.thread, !llvm.loop !111
...
!104 = !{!52, !52, i64 0}
!105 = !{!106, !106, i64 0}
!106 = !{!"p1 _ZTS14_comprehension", !18, i64 0}
!107 = !{!108, !20, i64 0}
!108 = !{!"_comprehension", !20, i64 0, !20, i64 8, !18, i64 16, !8, i64 24}
!109 = !{!108, !20, i64 8}
!110 = !{!108, !18, i64 16}
!111 = distinct !{!111, !45}
end_hunk_12
