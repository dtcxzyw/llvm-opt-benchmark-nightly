...
begin_hunk_0_@_PyTuple_FromArraySteal:bb.a
  ...
  %2 = sub i64 %.2.i2437, %i.a
  %diff.check = icmp ugt i64 %2, -33
...
.lr.ph.preheader39:                               ; preds = %.lr.ph.preheader, %middle.block
  %.01925.ph = phi i64 [ 0, %.lr.ph.preheader ], [ %n.vec, %middle.block ] ; 3 uses
...
begin_hunk_3_@tuple_repeat:bb.a
  ...
  %2 = sub i64 %umax, %.2.i5579
  %3 = add i64 %2, -33                            ; 2 uses
  %i.as = lshr i64 %3, 3
