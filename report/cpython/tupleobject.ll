...
._crit_edge18:                                    ; preds = %._crit_edge, %bb.e, %bb.c
  ...
  %.024.i = select i1 %i.p, i64 %spec.store.select.i, i64 %i.o ; 2 uses
  %i.s = icmp slt i64 %i.n, 0
  %i.t = add i64 %.val32.i, %i.n
  %spec.select.i = call i64 @llvm.smin.i64(i64 %i.n, i64 %.val32.i)
  %.023.i = select i1 %i.s, i64 %i.t, i64 %spec.select.i ; 2 uses
  %i.u = icmp slt i64 %.024.i, %.023.i
...
bb.g:                                             ; preds = %bb.i, %.lr.ph.i
  %.02237.i = phi i64 [ %.024.i, %.lr.ph.i ], [ %i.ab, %bb.i ] ; 3 uses
  %i.w = getelementptr [8 x i8], ptr %i.v, i64 %.02237.i
...
.thread.i:                                        ; preds = %bb.g
  %i.aa = call ptr @PyLong_FromSsize_t(i64 noundef %.02237.i) #9
...
bb.i:                                             ; preds = %bb.h
  %i.ab = add nuw i64 %.02237.i, 1                ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.ab, %.023.i
...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %i.i, label %bb.b, label %._crit_edge.i, !llvm.loop !94

._crit_edge.i:                                    ; preds = %bb.c, %bb.a
  %.013.lcssa.i = phi i64 [ 0, %bb.a ], [ %.215.i, %bb.c ]
  %i.j = tail call ptr @PyLong_FromSsize_t(i64 noundef %.013.lcssa.i) #9
...
_Py_NewRef.exit.epil:                             ; preds = %bb.i, %.epil.preheader
  %i.ai = getelementptr [8 x i8], ptr %i.k, i64 %.020.i12.epil.init
