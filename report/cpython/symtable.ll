...
begin_hunk_0_@symtable_visit_stmt:bb.a
  ...
  %.not1394.not = icmp eq i32 %i.ahr, 0
  br i1 %.not1394.not, label %Py_DECREF.exit1643.thread, label %bb.fj
...
begin_hunk_1_@symtable_visit_stmt:bb.a
  ...
  %.not1388.not = icmp eq i32 %i.aji, 0
  br i1 %.not1388.not, label %Py_DECREF.exit1643.thread, label %bb.fs
