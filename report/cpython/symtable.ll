...
bb.k:                                             ; preds = %bb.j
  ...
  %i.bh = getelementptr i8, ptr %i.v, i64 44      ; 3 uses
  %i.bi = load i32, ptr %i.bh, align 4, !tbaa !89
  %i.bj = getelementptr i8, ptr %i.v, i64 52      ; 3 uses
...
bb.o:                                             ; preds = %bb.i
  ...
  %i.bx = getelementptr i8, ptr %i.v, i64 44      ; 3 uses
  %i.by = load i32, ptr %i.bx, align 4, !tbaa !89
  %i.bz = getelementptr i8, ptr %i.v, i64 52      ; 3 uses
...
symtable_extend_namedexpr_scope.exit:             ; preds = %bb.p, %bb.n
  %.sink77.in = phi ptr [ %i.bf, %bb.n ], [ %i.bv, %bb.p ]
  %.sink76.in = phi ptr [ %i.bd, %bb.n ], [ %i.bt, %bb.p ]
  %.sink75.in = phi ptr [ %i.bj, %bb.n ], [ %i.bz, %bb.p ]
  %.sink74.in = phi ptr [ %i.bh, %bb.n ], [ %i.bx, %bb.p ]
  %.sink = phi i32 [ 2, %bb.n ], [ 1, %bb.p ]
  %.sink74 = load i32, ptr %.sink74.in, align 4, !tbaa !89
  %.sink75 = load i32, ptr %.sink75.in, align 4, !tbaa !90
  %.sink76 = load i32, ptr %.sink76.in, align 8, !tbaa !86
  %.sink77 = load i32, ptr %.sink77.in, align 8, !tbaa !88
  ...
  %i.cv = tail call fastcc i32 @symtable_add_def_helper(ptr noundef nonnull readonly %0, ptr noundef %i.x, i32 noundef %.sink, ptr noundef nonnull %i.af, i64 %.sroa.023.0.insert.insert.i, i64 %.sroa.325.8.insert.insert.i)
