...
.critedge:                                        ; preds = %PyErr_Clear.exit31, %bb.g
  %.023 = phi ptr [ null, %bb.g ], [ %i.p, %PyErr_Clear.exit31 ]
  %.122 = phi ptr [ %2, %bb.g ], [ %.021, %PyErr_Clear.exit31 ]
...
bb.r:                                             ; preds = %bb.q, %bb.p, %.critedge.i
  ...
  %i.ay = call ptr @PyUnicode_Decode(ptr noundef nonnull %.021.i, i64 noundef %i.ax, ptr noundef nonnull %.122, ptr noundef nonnull @.str.60) #16 ; 2 uses
...
begin_hunk_2_@_PyErr_ProgramDecodedTextObject:bb.a
  ...
  call void @PyMem_Free(ptr noundef %.023) #16
  br label %PyErr_Clear.exit
