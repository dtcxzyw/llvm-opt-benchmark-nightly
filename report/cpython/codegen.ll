...
bb.a:
  %i.a = load ptr, ptr %3, align 8, !tbaa !306
...
.preheader:                                       ; preds = %bb.b
  ...
  br i1 %i.i, label %.lr.ph, label %._crit_edge21, !llvm.loop !318

.lr.ph:                                           ; preds = %.preheader.preheader, %.preheader
  %.020 = phi i64 [ %.0, %.preheader ], [ %.019, %.preheader.preheader ] ; 3 uses
  %i.j = load ptr, ptr %3, align 8, !tbaa !306
...
bb.b:                                             ; preds = %.lr.ph
  ...
  br i1 %i.q, label %._crit_edge, label %.preheader, !llvm.loop !318

._crit_edge:                                      ; preds = %bb.b
  br label %._crit_edge21, !llvm.loop !318
...
; Function Attrs: nounwind uwtable
define internal fastcc i32 @unpack_helper(ptr noundef %0, i64 %1, i64 %2, ptr noundef readonly captures(address_is_null) %3) unnamed_addr #3 {
bb.a:
...
bb.j:                                             ; preds = %bb.h
  ...
  br i1 %exitcond.not, label %._crit_edge, label %bb.c, !llvm.loop !319
