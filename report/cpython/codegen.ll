...
bb.l:                                             ; preds = %bb.a, %bb.b, %bb.c, %bb.d, %bb.e, %bb.f
  %.0 = phi i64 [ 5, %bb.f ], [ 3, %bb.b ], [ 0, %bb.c ], [ 1, %bb.d ], [ 4, %bb.e ], [ 2, %bb.a ]
  %.0.a = phi i32 [ 160, %bb.f ], [ 96, %bb.b ], [ 0, %bb.c ], [ 32, %bb.d ], [ 128, %bb.e ], [ 64, %bb.a ]
  %i.i = tail call ptr @_PyCompile_InstrSequence(ptr noundef %0) #11
  %i.j = getelementptr [4 x i8], ptr @compare_masks, i64 %.0
