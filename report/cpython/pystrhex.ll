...
.lr.ph.i.i.i:                                     ; preds = %bb.g, %.lr.ph.i.i.i
  %.010.i.i.i = phi ptr [ %i.ap, %.lr.ph.i.i.i ], [ %i.y, %bb.g ] ; 3 uses
  %.089.i.i.i = phi i64 [ %i.aq, %.lr.ph.i.i.i ], [ 0, %bb.g ] ; 2 uses
  %i.ab = getelementptr i8, ptr %2, i64 %.089.i.i.i
  %i.ac = load i8, ptr %i.ab, align 1, !tbaa !13
  %i.ad = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.ae = zext i8 %i.ac to i32                    ; 2 uses
  %i.af = lshr i32 %i.ae, 4
  %i.ag = zext nneg i32 %i.af to i64
  %i.ah = getelementptr i8, ptr %i.ad, i64 %i.ag
  %i.ai = load i8, ptr %i.ah, align 1, !tbaa !13
  %i.aj = getelementptr i8, ptr %.010.i.i.i, i64 1
  store i8 %i.ai, ptr %.010.i.i.i, align 1, !tbaa !13
  %i.ak = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.al = and i32 %i.ae, 15
  %i.am = zext nneg i32 %i.al to i64
  %i.an = getelementptr i8, ptr %i.ak, i64 %i.am
  %i.ao = load i8, ptr %i.an, align 1, !tbaa !13
  %i.ap = getelementptr i8, ptr %.010.i.i.i, i64 2
  store i8 %i.ao, ptr %i.aj, align 1, !tbaa !13
  %i.aq = add nuw nsw i64 %.089.i.i.i, 1          ; 2 uses
  %exitcond.not.i.i.i = icmp eq i64 %i.aq, %i.aa
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.i.i.preheader.new
  %.010.i.i = phi ptr [ %.0112.i, %.lr.ph.i.i.preheader.new ], [ %i.bw, %.lr.ph.i.i ] ; 5 uses
  %.089.i.i = phi i64 [ 0, %.lr.ph.i.i.preheader.new ], [ %i.bx, %.lr.ph.i.i ] ; 3 uses
  %niter = phi i64 [ 0, %.lr.ph.i.i.preheader.new ], [ %niter.next.1, %.lr.ph.i.i ]
  %i.as = getelementptr i8, ptr %0, i64 %.089.i.i
  %i.at = load i8, ptr %i.as, align 1, !tbaa !13
  %i.au = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.av = zext i8 %i.at to i32                    ; 2 uses
  %i.aw = lshr i32 %i.av, 4
  %i.ax = zext nneg i32 %i.aw to i64
  %i.ay = getelementptr i8, ptr %i.au, i64 %i.ax
  %i.az = load i8, ptr %i.ay, align 1, !tbaa !13
  %i.ba = getelementptr i8, ptr %.010.i.i, i64 1
  store i8 %i.az, ptr %.010.i.i, align 1, !tbaa !13
  %i.bb = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.bc = and i32 %i.av, 15
  %i.bd = zext nneg i32 %i.bc to i64
  %i.be = getelementptr i8, ptr %i.bb, i64 %i.bd
  %i.bf = load i8, ptr %i.be, align 1, !tbaa !13
  %i.bg = getelementptr i8, ptr %.010.i.i, i64 2
  store i8 %i.bf, ptr %i.ba, align 1, !tbaa !13
  %i.bh = getelementptr i8, ptr %0, i64 %.089.i.i
  ...
  %i.bq = getelementptr i8, ptr %.010.i.i, i64 3
  store i8 %i.bp, ptr %i.bg, align 1, !tbaa !13
  ...
  %i.bw = getelementptr i8, ptr %.010.i.i, i64 4  ; 2 uses
  store i8 %i.bv, ptr %i.bq, align 1, !tbaa !13
  %i.bx = add nuw nsw i64 %.089.i.i, 2            ; 2 uses
  %niter.next.1 = add nuw nsw i64 %niter, 2       ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %_Py_strhex_impl.exit.loopexit11.unr-lcssa, label %.lr.ph.i.i, !llvm.loop !1

_Py_strhex_impl.exit.loopexit11.unr-lcssa:        ; preds = %.lr.ph.i.i
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %_Py_strhex_impl.exit, label %.lr.ph.i.i.epil.preheader

.lr.ph.i.i.epil.preheader:                        ; preds = %_Py_strhex_impl.exit.loopexit11.unr-lcssa, %.lr.ph.i.i.preheader
  %.010.i.i.epil.init = phi ptr [ %.0112.i, %.lr.ph.i.i.preheader ], [ %i.bw, %_Py_strhex_impl.exit.loopexit11.unr-lcssa ] ; 2 uses
  %.089.i.i.epil.init = phi i64 [ 0, %.lr.ph.i.i.preheader ], [ %i.bx, %_Py_strhex_impl.exit.loopexit11.unr-lcssa ]
  %lcmp.mod12 = trunc i64 %1 to i1
  tail call void @llvm.assume(i1 %lcmp.mod12)
  %i.by = getelementptr i8, ptr %0, i64 %.089.i.i.epil.init
  %i.bz = load i8, ptr %i.by, align 1, !tbaa !13
  %i.ca = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.cb = zext i8 %i.bz to i32                    ; 2 uses
  %i.cc = lshr i32 %i.cb, 4
  %i.cd = zext nneg i32 %i.cc to i64
  %i.ce = getelementptr i8, ptr %i.ca, i64 %i.cd
  %i.cf = load i8, ptr %i.ce, align 1, !tbaa !13
  %i.cg = getelementptr i8, ptr %.010.i.i.epil.init, i64 1
  store i8 %i.cf, ptr %.010.i.i.epil.init, align 1, !tbaa !13
  %i.ch = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.ci = and i32 %i.cb, 15
  %i.cj = zext nneg i32 %i.ci to i64
  %i.ck = getelementptr i8, ptr %i.ch, i64 %i.cj
  %i.cl = load i8, ptr %i.ck, align 1, !tbaa !13
  store i8 %i.cl, ptr %i.cg, align 1, !tbaa !13
  br label %_Py_strhex_impl.exit

_Py_strhex_impl.exit:                             ; preds = %.lr.ph.i.i.epil.preheader, %_Py_strhex_impl.exit.loopexit11.unr-lcssa, %.lr.ph.i.i.i, %bb.b, %bb.c, %bb.g, %bb.h
  %.3123.i = phi ptr [ %i.d, %.lr.ph.i.i.i ], [ %i.b, %bb.b ], [ null, %bb.c ], [ %i.d, %bb.g ], [ %i.d, %bb.h ], [ %i.d, %_Py_strhex_impl.exit.loopexit11.unr-lcssa ], [ %i.d, %.lr.ph.i.i.epil.preheader ]
  ret ptr %.3123.i
}
...
.lr.ph.i.i:                                       ; preds = %bb.aa, %.lr.ph.i.i
  %.010.i.i = phi ptr [ %i.bv, %.lr.ph.i.i ], [ %i.be, %bb.aa ] ; 3 uses
  %.089.i.i = phi i64 [ %i.bw, %.lr.ph.i.i ], [ 0, %bb.aa ] ; 2 uses
  %i.bh = getelementptr i8, ptr %5, i64 %.089.i.i
  %i.bi = load i8, ptr %i.bh, align 1, !tbaa !13
  %i.bj = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  ...
  %i.bp = getelementptr i8, ptr %.010.i.i, i64 1
  store i8 %i.bo, ptr %.010.i.i, align 1, !tbaa !13
  %i.bq = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.br = and i32 %i.bk, 15
  %i.bs = zext nneg i32 %i.br to i64
  %i.bt = getelementptr i8, ptr %i.bq, i64 %i.bs
  %i.bu = load i8, ptr %i.bt, align 1, !tbaa !13
  %i.bv = getelementptr i8, ptr %.010.i.i, i64 2
  store i8 %i.bu, ptr %i.bp, align 1, !tbaa !13
  %i.bw = add nuw nsw i64 %.089.i.i, 1            ; 2 uses
...
.lr.ph.i.preheader:                               ; preds = %bb.ab
  %xtraiter268 = and i64 %1, 1
  %i.bx = icmp eq i64 %1, 1
  br i1 %i.bx, label %.lr.ph.i.epil.preheader, label %.lr.ph.i.preheader.new

.lr.ph.i.preheader.new:                           ; preds = %.lr.ph.i.preheader
  %unroll_iter271 = and i64 %1, -2
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i, %.lr.ph.i.preheader.new
  %.010.i = phi ptr [ %.0112, %.lr.ph.i.preheader.new ], [ %i.dc, %.lr.ph.i ] ; 5 uses
  %.089.i = phi i64 [ 0, %.lr.ph.i.preheader.new ], [ %i.dd, %.lr.ph.i ] ; 3 uses
  %niter272 = phi i64 [ 0, %.lr.ph.i.preheader.new ], [ %niter272.next.1, %.lr.ph.i ]
  %i.by = getelementptr i8, ptr %0, i64 %.089.i
  %i.bz = load i8, ptr %i.by, align 1, !tbaa !13
  %i.ca = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.cb = zext i8 %i.bz to i32                    ; 2 uses
  %i.cc = lshr i32 %i.cb, 4
  ...
  %i.ce = getelementptr i8, ptr %i.ca, i64 %i.cd
  %i.cf = load i8, ptr %i.ce, align 1, !tbaa !13
  %i.cg = getelementptr i8, ptr %.010.i, i64 1
  store i8 %i.cf, ptr %.010.i, align 1, !tbaa !13
  %i.ch = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.ci = and i32 %i.cb, 15
  %i.cj = zext nneg i32 %i.ci to i64
  %i.ck = getelementptr i8, ptr %i.ch, i64 %i.cj
  %i.cl = load i8, ptr %i.ck, align 1, !tbaa !13
  %i.cm = getelementptr i8, ptr %.010.i, i64 2
  store i8 %i.cl, ptr %i.cg, align 1, !tbaa !13
  %i.cn = getelementptr i8, ptr %0, i64 %.089.i
  %i.co = getelementptr i8, ptr %i.cn, i64 1
  %i.cp = load i8, ptr %i.co, align 1, !tbaa !13
  %i.cq = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.cr = zext i8 %i.cp to i32                    ; 2 uses
  %i.cs = lshr i32 %i.cr, 4
  %i.ct = zext nneg i32 %i.cs to i64
  %i.cu = getelementptr i8, ptr %i.cq, i64 %i.ct
  %i.cv = load i8, ptr %i.cu, align 1, !tbaa !13
  %i.cw = getelementptr i8, ptr %.010.i, i64 3
  store i8 %i.cv, ptr %i.cm, align 1, !tbaa !13
  %i.cx = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.cy = and i32 %i.cr, 15
  %i.cz = zext nneg i32 %i.cy to i64
  %i.da = getelementptr i8, ptr %i.cx, i64 %i.cz
  %i.db = load i8, ptr %i.da, align 1, !tbaa !13
  %i.dc = getelementptr i8, ptr %.010.i, i64 4    ; 2 uses
  store i8 %i.db, ptr %i.cw, align 1, !tbaa !13
  %i.dd = add nuw nsw i64 %.089.i, 2              ; 2 uses
  %niter272.next.1 = add i64 %niter272, 2         ; 2 uses
  %niter272.ncmp.1 = icmp eq i64 %niter272.next.1, %unroll_iter271
  br i1 %niter272.ncmp.1, label %.critedge.loopexit250.unr-lcssa, label %.lr.ph.i, !llvm.loop !1

bb.ac:                                            ; preds = %_PyUnicode_DATA.exit
  %i.de = add i64 %1, -1                          ; 4 uses
  %i.df = zext i32 %spec.select141 to i64
  %i.dg = sdiv i64 %i.de, %i.df                   ; 9 uses
  %i.dh = icmp slt i32 %spec.select, 0
  br i1 %i.dh, label %.preheader165, label %.preheader169

.preheader169:                                    ; preds = %bb.ac
  %.3175 = add i64 %i.ae, -1                      ; 3 uses
  %i.di = icmp sgt i64 %i.dg, 0
  br i1 %i.di, label %.preheader168.lr.ph, label %.preheader166
...
.preheader168.us.preheader:                       ; preds = %.preheader168.lr.ph
  ...
  %i.dj = icmp eq i32 %spec.select141, 1
  %unroll_iter = and i32 %spec.select141, -2
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  %lcmp.mod261 = trunc i32 %spec.select141 to i1
  br label %.preheader168.us

.preheader168.preheader:                          ; preds = %.preheader168.lr.ph
  %i.dk = sub nuw nsw i64 %i.ae, %i.dg
  %scevgep = getelementptr i8, ptr %.0112, i64 %i.dk
  tail call void @llvm.memset.p0.i64(ptr align 1 %scevgep, i8 %.2119152158, i64 %i.dg, i1 false), !tbaa !13
  %i.dl = sub nuw nsw i64 %.3175, %i.dg
...
.preheader168.us:                                 ; preds = %.preheader168.us.preheader, %._crit_edge.us
  ...
  %.3109176.us = phi i64 [ %.lcssa257.a, %._crit_edge.us ], [ %i.de, %.preheader168.us.preheader ] ; 2 uses
  br i1 %i.dj, label %.epil.preheader, label %.preheader168.us.new
...
.preheader168.us.new:                             ; preds = %.preheader168.us, %.preheader168.us.new
  ...
  %i.do = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  ...
  %i.dv = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  ...
  store i8 %i.dz, ptr %i.eb, align 1, !tbaa !13
  ...
  %i.eg = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  ...
  %i.en = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
...
.epil.preheader:                                  ; preds = %._crit_edge.us.unr-lcssa, %.preheader168.us
  ...
  %i.ex = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  ...
  %i.fe = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  ...
  store i8 %i.fi, ptr %i.fk, align 1, !tbaa !13
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.unr-lcssa, %.epil.preheader
  ...
  %.lcssa257.a = phi i64 [ %i.ec, %._crit_edge.us.unr-lcssa ], [ %i.eu, %.epil.preheader ] ; 2 uses
  %.lcssa256 = phi i64 [ %i.es, %._crit_edge.us.unr-lcssa ], [ %i.fj, %.epil.preheader ]
  %i.fl = getelementptr i8, ptr %.0112, i64 %.lcssa256
end_hunk_0
begin_hunk_1_@_Py_strhex_impl:bb.a
  %i.ie = getelementptr i8, ptr %.0112, i64 %.0104.lcssa ; 2 uses
  store i8 %i.id, ptr %i.ie, align 1, !tbaa !13
  %i.if = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.ig = and i32 %i.hz, 15
  %i.ih = zext nneg i32 %i.ig to i64
  %i.ii = getelementptr i8, ptr %i.if, i64 %i.ih
  %i.ij = load i8, ptr %i.ii, align 1, !tbaa !13
  %i.ik = add i64 %.0104.lcssa, 2
  %i.il = getelementptr i8, ptr %i.ie, i64 1
  store i8 %i.ij, ptr %i.il, align 1, !tbaa !13
...
.lr.ph200:                                        ; preds = %.lr.ph200.prol.loopexit, %.lr.ph200
  ...
  %i.jg = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  ...
  %i.jo = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
...
.preheader166:                                    ; preds = %._crit_edge.us, %.preheader168.preheader, %.preheader169
  %.3109.lcssa = phi i64 [ %i.de, %.preheader169 ], [ %i.de, %.preheader168.preheader ], [ %.lcssa257.a, %._crit_edge.us ] ; 6 uses
  %.3.lcssa = phi i64 [ %.3175, %.preheader169 ], [ %i.dl, %.preheader168.preheader ], [ %.3.us, %._crit_edge.us ] ; 3 uses
...
.lr.ph.preheader:                                 ; preds = %.preheader166
  ...
  %lcmp.mod263.not.not = icmp eq i64 %i.jw, 0
  br i1 %lcmp.mod263.not.not, label %.lr.ph.prol, label %.lr.ph.prol.loopexit

.lr.ph.prol:                                      ; preds = %.lr.ph.preheader
  %i.jx = add nsw i64 %.3109.lcssa, -1
  %i.jy = getelementptr i8, ptr %0, i64 %.3109.lcssa
  %i.jz = load i8, ptr %i.jy, align 1, !tbaa !13
  %i.ka = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  ...
  store i8 %i.kf, ptr %i.kg, align 1, !tbaa !13
  %i.kh = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  ...
  store i8 %i.kl, ptr %i.kn, align 1, !tbaa !13
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  %i.kr = load i8, ptr %i.kq, align 1, !tbaa !13
  %i.ks = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  ...
  store i8 %i.kx, ptr %i.ky, align 1, !tbaa !13
  %i.kz = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.la = lshr i32 %i.kt, 4
  %i.lb = zext nneg i32 %i.la to i64
  %i.lc = getelementptr i8, ptr %i.kz, i64 %i.lb
  %i.ld = load i8, ptr %i.lc, align 1, !tbaa !13
  %i.le = getelementptr i8, ptr %i.ky, i64 -1
  store i8 %i.ld, ptr %i.le, align 1, !tbaa !13
  %i.lf = add nsw i64 %.5111182, -2
  %i.lg = getelementptr i8, ptr %0, i64 %i.kp
  %i.lh = load i8, ptr %i.lg, align 1, !tbaa !13
  %i.li = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  ...
  store i8 %i.ln, ptr %i.lp, align 1, !tbaa !13
  %i.lq = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  ...
  store i8 %i.lu, ptr %i.lw, align 1, !tbaa !13
  %.not238.1 = icmp eq i64 %i.kp, 0
  br i1 %.not238.1, label %.critedge, label %.lr.ph, !llvm.loop !23

.critedge.loopexit250.unr-lcssa:                  ; preds = %.lr.ph.i
  %lcmp.mod269.not = icmp eq i64 %xtraiter268, 0
  br i1 %lcmp.mod269.not, label %.critedge, label %.lr.ph.i.epil.preheader

.lr.ph.i.epil.preheader:                          ; preds = %.critedge.loopexit250.unr-lcssa, %.lr.ph.i.preheader
  %.010.i.epil.init = phi ptr [ %.0112, %.lr.ph.i.preheader ], [ %i.dc, %.critedge.loopexit250.unr-lcssa ] ; 2 uses
  %.089.i.epil.init = phi i64 [ 0, %.lr.ph.i.preheader ], [ %i.dd, %.critedge.loopexit250.unr-lcssa ]
  %lcmp.mod270 = trunc i64 %1 to i1
  ...
  %i.lz = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  ...
  store i8 %i.me, ptr %.010.i.epil.init, align 1, !tbaa !13
  %i.mg = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
...
.lr.ph.i.i.i:                                     ; preds = %bb.e, %.lr.ph.i.i.i
  %.010.i.i.i = phi ptr [ %i.am, %.lr.ph.i.i.i ], [ %i.v, %bb.e ] ; 3 uses
  %.089.i.i.i = phi i64 [ %i.an, %.lr.ph.i.i.i ], [ 0, %bb.e ] ; 2 uses
  %i.y = getelementptr i8, ptr %2, i64 %.089.i.i.i
  %i.z = load i8, ptr %i.y, align 1, !tbaa !13
  %i.aa = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.ab = zext i8 %i.z to i32                     ; 2 uses
  %i.ac = lshr i32 %i.ab, 4
  %i.ad = zext nneg i32 %i.ac to i64
  %i.ae = getelementptr i8, ptr %i.aa, i64 %i.ad
  %i.af = load i8, ptr %i.ae, align 1, !tbaa !13
  %i.ag = getelementptr i8, ptr %.010.i.i.i, i64 1
  store i8 %i.af, ptr %.010.i.i.i, align 1, !tbaa !13
  %i.ah = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.ai = and i32 %i.ab, 15
  %i.aj = zext nneg i32 %i.ai to i64
  %i.ak = getelementptr i8, ptr %i.ah, i64 %i.aj
  %i.al = load i8, ptr %i.ak, align 1, !tbaa !13
  %i.am = getelementptr i8, ptr %.010.i.i.i, i64 2
  store i8 %i.al, ptr %i.ag, align 1, !tbaa !13
  %i.an = add nuw nsw i64 %.089.i.i.i, 1          ; 2 uses
  %exitcond.not.i.i.i = icmp eq i64 %i.an, %i.x
  br i1 %exitcond.not.i.i.i, label %_Py_strhex_impl.exit, label %.lr.ph.i.i.i, !llvm.loop !1
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.i.i.preheader.new
  %.010.i.i = phi ptr [ %i.e, %.lr.ph.i.i.preheader.new ], [ %i.bt, %.lr.ph.i.i ] ; 5 uses
  %.089.i.i = phi i64 [ 0, %.lr.ph.i.i.preheader.new ], [ %i.bu, %.lr.ph.i.i ] ; 3 uses
  %niter = phi i64 [ 0, %.lr.ph.i.i.preheader.new ], [ %niter.next.1, %.lr.ph.i.i ]
  %i.ap = getelementptr i8, ptr %0, i64 %.089.i.i
  %i.aq = load i8, ptr %i.ap, align 1, !tbaa !13
  %i.ar = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  ...
  %i.ax = getelementptr i8, ptr %.010.i.i, i64 1
  store i8 %i.aw, ptr %.010.i.i, align 1, !tbaa !13
  %i.ay = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.az = and i32 %i.as, 15
  %i.ba = zext nneg i32 %i.az to i64
  %i.bb = getelementptr i8, ptr %i.ay, i64 %i.ba
  %i.bc = load i8, ptr %i.bb, align 1, !tbaa !13
  %i.bd = getelementptr i8, ptr %.010.i.i, i64 2
  store i8 %i.bc, ptr %i.ax, align 1, !tbaa !13
  %i.be = getelementptr i8, ptr %0, i64 %.089.i.i
  %i.bf = getelementptr i8, ptr %i.be, i64 1
  %i.bg = load i8, ptr %i.bf, align 1, !tbaa !13
  %i.bh = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.bi = zext i8 %i.bg to i32                    ; 2 uses
  %i.bj = lshr i32 %i.bi, 4
  %i.bk = zext nneg i32 %i.bj to i64
  %i.bl = getelementptr i8, ptr %i.bh, i64 %i.bk
  %i.bm = load i8, ptr %i.bl, align 1, !tbaa !13
  %i.bn = getelementptr i8, ptr %.010.i.i, i64 3
  store i8 %i.bm, ptr %i.bd, align 1, !tbaa !13
  %i.bo = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.bp = and i32 %i.bi, 15
  %i.bq = zext nneg i32 %i.bp to i64
  %i.br = getelementptr i8, ptr %i.bo, i64 %i.bq
  %i.bs = load i8, ptr %i.br, align 1, !tbaa !13
  %i.bt = getelementptr i8, ptr %.010.i.i, i64 4  ; 2 uses
  store i8 %i.bs, ptr %i.bn, align 1, !tbaa !13
  %i.bu = add nuw nsw i64 %.089.i.i, 2            ; 2 uses
  %niter.next.1 = add nuw nsw i64 %niter, 2       ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %_Py_strhex_impl.exit.loopexit11.unr-lcssa, label %.lr.ph.i.i, !llvm.loop !1
...
.lr.ph.i.i.epil.preheader:                        ; preds = %_Py_strhex_impl.exit.loopexit11.unr-lcssa, %.lr.ph.i.i.preheader
  %.010.i.i.epil.init = phi ptr [ %i.e, %.lr.ph.i.i.preheader ], [ %i.bt, %_Py_strhex_impl.exit.loopexit11.unr-lcssa ] ; 2 uses
  %.089.i.i.epil.init = phi i64 [ 0, %.lr.ph.i.i.preheader ], [ %i.bu, %_Py_strhex_impl.exit.loopexit11.unr-lcssa ]
  %lcmp.mod12 = trunc i64 %1 to i1
  tail call void @llvm.assume(i1 %lcmp.mod12)
  %i.bv = getelementptr i8, ptr %0, i64 %.089.i.i.epil.init
  %i.bw = load i8, ptr %i.bv, align 1, !tbaa !13
  %i.bx = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  ...
  %i.cd = getelementptr i8, ptr %.010.i.i.epil.init, i64 1
  store i8 %i.cc, ptr %.010.i.i.epil.init, align 1, !tbaa !13
  %i.ce = load ptr, ptr @Py_hexdigits, align 8, !tbaa !17
  %i.cf = and i32 %i.by, 15
  %i.cg = zext nneg i32 %i.cf to i64
  %i.ch = getelementptr i8, ptr %i.ce, i64 %i.cg
  %i.ci = load i8, ptr %i.ch, align 1, !tbaa !13
  store i8 %i.ci, ptr %i.cd, align 1, !tbaa !13
  br label %_Py_strhex_impl.exit

_Py_strhex_impl.exit:                             ; preds = %.lr.ph.i.i.epil.preheader, %_Py_strhex_impl.exit.loopexit11.unr-lcssa, %.lr.ph.i.i.i, %bb.b, %bb.c, %bb.e, %bb.f
  %.3123.i = phi ptr [ %i.d, %.lr.ph.i.i.i ], [ %i.b, %bb.b ], [ %i.d, %bb.e ], [ null, %bb.c ], [ %i.d, %bb.f ], [ %i.d, %_Py_strhex_impl.exit.loopexit11.unr-lcssa ], [ %i.d, %.lr.ph.i.i.epil.preheader ]
  ret ptr %.3123.i
}
