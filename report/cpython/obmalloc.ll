...
mi_os_prim_alloc.exit:                            ; preds = %_mi_stat_increase.exit.i.i, %bb.aa, %bb.ab
  %.pr = load ptr, ptr %i.a, align 8, !tbaa !40   ; 5 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #56
  %6 = icmp eq ptr %.pr, null
  br i1 %6, label %mi_os_prim_alloc_aligned.exit.thread, label %mi_os_prim_alloc.exit.i

mi_os_prim_alloc.exit.i:                          ; preds = %mi_os_prim_alloc.exit
  %i.bh = ptrtoint ptr %.pr to i64
  %i.bi = add i64 %.0.i16, -1                     ; 2 uses
  %i.bj = and i64 %i.bi, %i.bh
  %i.bk = icmp eq i64 %i.bj, 0
  br i1 %i.bk, label %bb.bh, label %bb.ac
...
mi_os_prim_alloc_aligned.exit:                    ; preds = %bb.bf, %bb.bg
  %.not = icmp eq i64 %i.dr, 0
  br i1 %.not, label %mi_os_prim_alloc_aligned.exit.thread, label %bb.bh

bb.bh:                                            ; preds = %mi_os_prim_alloc.exit.i, %mi_os_prim_alloc_aligned.exit
  %.02233 = phi ptr [ %i.ds, %mi_os_prim_alloc_aligned.exit ], [ %.pr, %mi_os_prim_alloc.exit.i ] ; 2 uses
...
mi_os_prim_alloc_aligned.exit.thread:             ; preds = %_mi_align_up.exit.i, %_mi_prim_alloc.exit119.i, %bb.ar, %bb.ao, %mi_os_prim_alloc.exit107.i, %mi_os_prim_alloc.exit, %mi_os_prim_free.exit.i, %mi_os_prim_alloc.exit.thread3.i, %_mi_align_up.exit, %bb.bh, %mi_os_prim_alloc_aligned.exit
  %.2.i28 = phi ptr [ null, %mi_os_prim_alloc_aligned.exit ], [ %.02233, %bb.bh ], [ null, %_mi_align_up.exit ], [ null, %mi_os_prim_alloc.exit.thread3.i ], [ null, %mi_os_prim_free.exit.i ], [ null, %mi_os_prim_alloc.exit ], [ null, %bb.ao ], [ null, %mi_os_prim_alloc.exit107.i ], [ null, %_mi_align_up.exit.i ], [ null, %bb.ar ], [ null, %_mi_prim_alloc.exit119.i ]
...
begin_hunk_23_@mi_segment_span_allocate:bb.a
  ...
  %or.cond32.i.i = select i1 %or.cond30.i.i, i1 %.not.6.i.i.i.a, i1 false
  %13 = extractelement <2 x i64> %11, i64 1       ; 4 uses
  %i.at = icmp eq i64 %13, 0
  %or.cond34.i.i = select i1 %or.cond32.i.i, i1 %i.at, i1 false
  %14 = getelementptr inbounds nuw i8, ptr %4, i64 48 ; 2 uses
  %15 = load i64, ptr %14, align 16               ; 5 uses
  %.not.6.i.i.i = icmp eq i64 %15, 0
  %op.rdx14 = select i1 %or.cond34.i.i, i1 %.not.6.i.i.i, i1 false
...
bb.p:                                             ; preds = %mi_commit_mask_is_empty.exit.i.i
  ...
  %i.az = and i64 %i.ay, %6                       ; 2 uses
  %.not.i13.i.i = icmp eq i64 %i.az, %6
  %i.ba = getelementptr i8, ptr %0, i64 120
  %i.bb = load i64, ptr %i.ba, align 8, !tbaa !105
  %i.bc = and i64 %i.bb, %7                       ; 2 uses
  %.not.1.i15.i.i = icmp eq i64 %i.bc, %7
  ...
  %.not.2.i16.i.i = icmp eq i64 %i.bf, %8
  ...
  %i.bi = and i64 %i.bh, %10                      ; 2 uses
  %.not.3.i17.i.i = icmp eq i64 %i.bi, %10
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.bl = and i64 %i.bk, %12
  %.not.4.i18.i.i = icmp eq i64 %i.bl, %12
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.bo = and i64 %i.bn, %13
  %.not.5.i19.i.i = icmp eq i64 %i.bo, %13
...
bb.s:                                             ; preds = %bb.r
  ...
  %.not.6.i20.i.i = icmp eq i64 %i.br, %15
...
_mi_stat_decrease.exit.i.i:                       ; preds = %bb.x, %bb.w, %mi_commit_mask_all_set.exit.thread.i.i
  ...
  %i.db = call zeroext i1 @_mi_os_commit(ptr noundef %i.da, i64 noundef %16, ptr noundef nonnull %i.c, ptr readnone poison)
...
bb.y:                                             ; preds = %_mi_stat_decrease.exit.i.i
  ...
  %i.dh = or <2 x i64> %i.dg, %19
  store <2 x i64> %i.dh, ptr %i.ca, align 8, !tbaa !105
  %20 = load <2 x i64>, ptr %14, align 16, !tbaa !105 ; 3 uses
  %21 = load <2 x i64>, ptr %i.ce, align 8, !tbaa !105
  %22 = or <2 x i64> %21, %20
  store <2 x i64> %22, ptr %i.ce, align 8, !tbaa !105
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #56
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #56
...
bb.z:                                             ; preds = %bb.y, %mi_commit_mask_all_set.exit.i.i
  %31 = phi i64 [ %30, %bb.y ], [ %i.bv, %mi_commit_mask_all_set.exit.i.i ] ; 2 uses
  ...
  %i.di = phi i64 [ %23, %bb.y ], [ %6, %mi_commit_mask_all_set.exit.i.i ] ; 2 uses
