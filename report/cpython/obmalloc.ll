...
bb.r:                                             ; preds = %bb.q, %bb.p
  %i.an = load ptr, ptr %i.a, align 8, !tbaa !40
...
_mi_stat_increase.exit.i:                         ; preds = %bb.w, %bb.v
  br i1 %2, label %bb.x, label %mi_os_prim_alloc.exit
...
bb.aa:                                            ; preds = %mi_atomic_maxi64_relaxed.exit.i.i27.i
  ...
  br label %mi_os_prim_alloc.exit
...
mi_os_prim_alloc.exit:                            ; preds = %_mi_stat_increase.exit.i, %bb.aa, %bb.ab
  %.pr = load ptr, ptr %i.a, align 8, !tbaa !40   ; 5 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #56
  %6 = icmp eq ptr %.pr, null
  br i1 %6, label %mi_os_prim_alloc_aligned.exit.thread, label %bb.ac

bb.ac:                                            ; preds = %mi_os_prim_alloc.exit
  %i.bh = ptrtoint ptr %.pr to i64
  %i.bi = add i64 %.0.i16, -1                     ; 2 uses
  %i.bj = and i64 %i.bi, %i.bh
  %i.bk = icmp eq i64 %i.bj, 0
  br i1 %i.bk, label %mi_os_prim_alloc_aligned.exit.thread29, label %bb.ad

bb.ad:                                            ; preds = %bb.ac
  %i.bl = tail call i32 @munmap(ptr noundef nonnull %.pr, i64 noundef %.0.i.i) #56
...
bb.ae:                                            ; preds = %_mi_prim_free.exit.i.i
  tail call void (ptr, ...) @_mi_warning_message(ptr noundef nonnull @.str.94, i32 noundef %i.bo, i32 noundef %i.bo, i64 noundef %.0.i.i, ptr noundef nonnull %.pr)
...
mi_align_up_ptr.exit99.i:                         ; preds = %mi_os_prim_alloc.exit97.i
  ...
  %i.dr = and i64 %i.dp, %i.dq                    ; 3 uses
  %i.ds = inttoptr i64 %i.dr to ptr               ; 3 uses
...
mi_os_prim_alloc_aligned.exit:                    ; preds = %bb.bg, %bb.bh
  %.not = icmp eq i64 %i.dr, 0
  br i1 %.not, label %mi_os_prim_alloc_aligned.exit.thread, label %mi_os_prim_alloc_aligned.exit.thread29

mi_os_prim_alloc_aligned.exit.thread29:           ; preds = %bb.ac, %mi_os_prim_alloc_aligned.exit
  %.02233 = phi ptr [ %i.ds, %mi_os_prim_alloc_aligned.exit ], [ %.pr, %bb.ac ] ; 2 uses
...
begin_hunk_7_@_mi_os_alloc_aligned:bb.a
  ...
  store ptr %.02233, ptr %4, align 8, !tbaa !60
  %i.ej = getelementptr i8, ptr %4, i64 8
  store i64 %.0.i16, ptr %i.ej, align 8, !tbaa !60
  br label %mi_os_prim_alloc_aligned.exit.thread

mi_os_prim_alloc_aligned.exit.thread:             ; preds = %_mi_align_up.exit.i, %_mi_prim_alloc.exit109.i, %bb.as, %bb.ap, %mi_os_prim_alloc.exit97.i, %mi_os_prim_alloc.exit, %mi_os_prim_free.exit.i, %mi_os_prim_alloc.exit.thread24, %_mi_align_up.exit, %mi_os_prim_alloc_aligned.exit.thread29, %mi_os_prim_alloc_aligned.exit
  %.2.i28 = phi ptr [ null, %mi_os_prim_alloc_aligned.exit ], [ %.02233, %mi_os_prim_alloc_aligned.exit.thread29 ], [ null, %_mi_align_up.exit ], [ null, %mi_os_prim_alloc.exit.thread24 ], [ null, %mi_os_prim_free.exit.i ], [ null, %mi_os_prim_alloc.exit ], [ null, %bb.ap ], [ null, %mi_os_prim_alloc.exit97.i ], [ null, %_mi_align_up.exit.i ], [ null, %bb.as ], [ null, %_mi_prim_alloc.exit109.i ]
...
bb.bi:                                            ; preds = %bb.a, %mi_os_prim_alloc_aligned.exit.thread
  %.0 = phi ptr [ %.2.i28, %mi_os_prim_alloc_aligned.exit.thread ], [ null, %bb.a ]
  ret ptr %.0
}
...
begin_hunk_9_@mi_arena_try_alloc_at:bb.a
  ...
  %i.q = load i64, ptr %i.a, align 8, !tbaa !105  ; 3 uses
...
bb.i:                                             ; preds = %bb.h
  %5 = load i64, ptr %i.a, align 8, !tbaa !105    ; 2 uses
  %i.bk = lshr i64 %5, 6                          ; 2 uses
  %i.bl = and i64 %5, 63                          ; 5 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  %6 = load i64, ptr %i.a, align 8, !tbaa !105    ; 2 uses
  %i.da = lshr i64 %6, 6                          ; 2 uses
  %i.db = and i64 %6, 63                          ; 5 uses
...
bb.aa:                                            ; preds = %bb.p
  %7 = load i64, ptr %i.a, align 8, !tbaa !105    ; 2 uses
  %i.eo = lshr i64 %7, 6                          ; 2 uses
  %i.ep = and i64 %7, 63                          ; 5 uses
...
bb.a:
  ...
  %4 = alloca %struct.mi_commit_mask_s, align 16  ; 12 uses
...
begin_hunk_14_@mi_segment_purge:bb.a
  ...
  %i.f = load <2 x i64>, ptr %4, align 16         ; 5 uses
  ...
  %.fr4 = freeze <2 x i64> %i.k                   ; 3 uses
  %i.l = extractelement <2 x i64> %.fr4, i64 0    ; 4 uses
  %i.m = extractelement <2 x i64> %.fr4, i64 1    ; 4 uses
  %i.n = getelementptr inbounds nuw i8, ptr %4, i64 48 ; 2 uses
...
bb.d:                                             ; preds = %mi_commit_mask_is_empty.exit
  ...
  %i.ab = extractelement <2 x i64> %i.f, i64 0    ; 3 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.af = extractelement <2 x i64> %i.f, i64 1    ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.aj = extractelement <2 x i64> %i.h, i64 0    ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.an = extractelement <2 x i64> %i.h, i64 1    ; 2 uses
...
mi_commit_mask_any_set.exit.thread._crit_edge:    ; preds = %mi_commit_mask_any_set.exit.thread
  ...
  %6 = extractelement <2 x i64> %i.f, i64 1
  %7 = extractelement <2 x i64> %i.h, i64 0
  %8 = extractelement <2 x i64> %i.h, i64 1
  br label %bb.q
...
_mi_stat_increase.exit:                           ; preds = %bb.k, %bb.o, %bb.p
  ...
  %14 = extractelement <2 x i64> %9, i64 1
  %15 = extractelement <2 x i64> %10, i64 0
  %16 = extractelement <2 x i64> %10, i64 1
  %17 = extractelement <2 x i64> %11, i64 0
  %18 = extractelement <2 x i64> %11, i64 1
  %19 = extractelement <2 x i64> %12, i64 0
  %20 = extractelement <2 x i64> %12, i64 1
  br label %bb.q

bb.q:                                             ; preds = %mi_commit_mask_any_set.exit.thread._crit_edge, %_mi_stat_increase.exit, %mi_commit_mask_any_set.exit
  %21 = phi i64 [ %.pre, %mi_commit_mask_any_set.exit.thread._crit_edge ], [ %20, %_mi_stat_increase.exit ], [ %i.bb, %mi_commit_mask_any_set.exit ]
  %22 = phi i64 [ %i.o, %mi_commit_mask_any_set.exit.thread._crit_edge ], [ %19, %_mi_stat_increase.exit ], [ %i.o, %mi_commit_mask_any_set.exit ]
  %23 = phi i64 [ %i.m, %mi_commit_mask_any_set.exit.thread._crit_edge ], [ %18, %_mi_stat_increase.exit ], [ %i.m, %mi_commit_mask_any_set.exit ]
  %24 = phi i64 [ %i.l, %mi_commit_mask_any_set.exit.thread._crit_edge ], [ %17, %_mi_stat_increase.exit ], [ %i.l, %mi_commit_mask_any_set.exit ]
  %25 = phi i64 [ %8, %mi_commit_mask_any_set.exit.thread._crit_edge ], [ %16, %_mi_stat_increase.exit ], [ %i.an, %mi_commit_mask_any_set.exit ]
  %26 = phi i64 [ %7, %mi_commit_mask_any_set.exit.thread._crit_edge ], [ %15, %_mi_stat_increase.exit ], [ %i.aj, %mi_commit_mask_any_set.exit ]
  %27 = phi i64 [ %6, %mi_commit_mask_any_set.exit.thread._crit_edge ], [ %14, %_mi_stat_increase.exit ], [ %i.af, %mi_commit_mask_any_set.exit ]
  %i.cy = phi i64 [ %i.ab, %mi_commit_mask_any_set.exit.thread._crit_edge ], [ %13, %_mi_stat_increase.exit ], [ %i.ab, %mi_commit_mask_any_set.exit ]
  %i.cz = getelementptr i8, ptr %0, i64 48        ; 2 uses
  %28 = xor i64 %i.cy, -1
  %29 = load i64, ptr %i.cz, align 8, !tbaa !105
  %30 = and i64 %29, %28
  store i64 %30, ptr %i.cz, align 8, !tbaa !105
  %31 = xor i64 %27, -1
  %32 = getelementptr i8, ptr %0, i64 56          ; 2 uses
  %33 = load i64, ptr %32, align 8, !tbaa !105
  %34 = and i64 %33, %31
  store i64 %34, ptr %32, align 8, !tbaa !105
  %35 = xor i64 %26, -1
  %i.da = getelementptr i8, ptr %0, i64 64        ; 2 uses
  %36 = load i64, ptr %i.da, align 8, !tbaa !105
  %37 = and i64 %36, %35
  store i64 %37, ptr %i.da, align 8, !tbaa !105
  %38 = xor i64 %25, -1
  %39 = getelementptr i8, ptr %0, i64 72          ; 2 uses
  %40 = load i64, ptr %39, align 8, !tbaa !105
  %41 = and i64 %40, %38
  store i64 %41, ptr %39, align 8, !tbaa !105
  %42 = xor i64 %24, -1
  %i.db = getelementptr i8, ptr %0, i64 80        ; 2 uses
  %43 = load i64, ptr %i.db, align 8, !tbaa !105
  %44 = and i64 %43, %42
  store i64 %44, ptr %i.db, align 8, !tbaa !105
  %45 = xor i64 %23, -1
  %46 = getelementptr i8, ptr %0, i64 88          ; 2 uses
  %47 = load i64, ptr %46, align 8, !tbaa !105
  %48 = and i64 %47, %45
  store i64 %48, ptr %46, align 8, !tbaa !105
  %i.dc = insertelement <2 x i64> poison, i64 %22, i64 0
  %i.dd = insertelement <2 x i64> %i.dc, i64 %21, i64 1
...
bb.a:
  ...
  %4 = alloca %struct.mi_commit_mask_s, align 16  ; 14 uses
  %i.c = alloca i8, align 1                       ; 5 uses
...
begin_hunk_23_@mi_segment_span_allocate:bb.a
  ...
  %6 = load i64, ptr %4, align 16, !tbaa !105     ; 4 uses
  %.not.i.i.i = icmp eq i64 %6, 0
  %i.aq = getelementptr inbounds nuw i8, ptr %4, i64 8
  %7 = load i64, ptr %i.aq, align 8               ; 4 uses
  %.not.1.i.i.i = icmp eq i64 %7, 0
  %or.cond26.i.i = select i1 %.not.i.i.i, i1 %.not.1.i.i.i, i1 false
  %i.ar = getelementptr inbounds nuw i8, ptr %4, i64 16 ; 2 uses
  %8 = load i64, ptr %i.ar, align 16              ; 4 uses
  %.not.2.i.i.i = icmp eq i64 %8, 0
  %or.cond28.i.i = select i1 %or.cond26.i.i, i1 %.not.2.i.i.i, i1 false
  %9 = getelementptr inbounds nuw i8, ptr %4, i64 24
  %10 = load i64, ptr %9, align 8                 ; 4 uses
  %.not.3.i.i.i = icmp eq i64 %10, 0
  %or.cond30.i.i = select i1 %or.cond28.i.i, i1 %.not.3.i.i.i, i1 false
  %i.as = getelementptr inbounds nuw i8, ptr %4, i64 32 ; 2 uses
  %11 = load <2 x i64>, ptr %i.as, align 16       ; 3 uses
  %12 = extractelement <2 x i64> %11, i64 0       ; 4 uses
  %.not.4.i.i.i = icmp eq i64 %12, 0
  %or.cond32.i.i = select i1 %or.cond30.i.i, i1 %.not.4.i.i.i, i1 false
  %13 = extractelement <2 x i64> %11, i64 1       ; 4 uses
  %.not.5.i.i.i = icmp eq i64 %13, 0
  %or.cond34.i.i = select i1 %or.cond32.i.i, i1 %.not.5.i.i.i, i1 false
  %14 = getelementptr inbounds nuw i8, ptr %4, i64 48 ; 2 uses
  %15 = load i64, ptr %14, align 16               ; 5 uses
  %.not.6.i.i.i = icmp eq i64 %15, 0
  %or.cond36.i.i = select i1 %or.cond34.i.i, i1 %.not.6.i.i.i, i1 false
...
bb.p:                                             ; preds = %mi_commit_mask_is_empty.exit.i.i
  ...
  %.not.2.i16.i.i = icmp eq i64 %i.be, %8
  ...
  %i.bh = and i64 %i.bg, %10                      ; 2 uses
  %.not.3.i17.i.i = icmp eq i64 %i.bh, %10
...
bb.q:                                             ; preds = %bb.p
  ...
  %.not.4.i18.i.i = icmp eq i64 %i.bk, %12
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.bn = and i64 %i.bm, %13
  %.not.5.i19.i.i = icmp eq i64 %i.bn, %13
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.bq = and i64 %i.bp, %15
  %.not.6.i20.i.i = icmp eq i64 %i.bq, %15
...
mi_commit_mask_all_set.exit.thread.i.i:           ; preds = %bb.p, %mi_commit_mask_all_set.exit.i.i, %bb.s, %bb.r, %bb.q
  ...
  store i8 0, ptr %i.c, align 1, !tbaa !125
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #56
...
_mi_stat_decrease.exit.i.i:                       ; preds = %bb.x, %bb.w, %mi_commit_mask_all_set.exit.thread.i.i
  ...
  %16 = load i64, ptr %i.b, align 8, !tbaa !105
  %i.da = call zeroext i1 @_mi_os_commit(ptr noundef %i.cz, i64 noundef %16, ptr noundef nonnull %i.c, ptr readnone poison)
  br i1 %i.da, label %bb.y, label %mi_segment_ensure_committed.exit

bb.y:                                             ; preds = %_mi_stat_decrease.exit.i.i
  %17 = load <2 x i64>, ptr %4, align 16, !tbaa !105 ; 3 uses
  %i.db = load <2 x i64>, ptr %i.k, align 8, !tbaa !105
  %i.dc = or <2 x i64> %i.db, %17
  store <2 x i64> %i.dc, ptr %i.k, align 8, !tbaa !105
  %18 = load <2 x i64>, ptr %i.ar, align 16, !tbaa !105 ; 3 uses
  %i.dd = load <2 x i64>, ptr %i.bc, align 8, !tbaa !105
  %i.de = or <2 x i64> %i.dd, %18
  store <2 x i64> %i.de, ptr %i.bc, align 8, !tbaa !105
  %19 = load <2 x i64>, ptr %i.as, align 16, !tbaa !105 ; 3 uses
  %i.df = load <2 x i64>, ptr %i.bz, align 8, !tbaa !105
  %i.dg = or <2 x i64> %i.df, %19
  store <2 x i64> %i.dg, ptr %i.bz, align 8, !tbaa !105
  %20 = load <2 x i64>, ptr %14, align 16, !tbaa !105 ; 3 uses
  %21 = load <2 x i64>, ptr %i.cd, align 8, !tbaa !105
  %22 = or <2 x i64> %21, %20
  store <2 x i64> %22, ptr %i.cd, align 8, !tbaa !105
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #56
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #56
  %23 = extractelement <2 x i64> %17, i64 0
  %24 = extractelement <2 x i64> %17, i64 1
  %25 = extractelement <2 x i64> %18, i64 0
  %26 = extractelement <2 x i64> %18, i64 1
  %27 = extractelement <2 x i64> %19, i64 0
  %28 = extractelement <2 x i64> %19, i64 1
  %29 = extractelement <2 x i64> %20, i64 0
  %30 = extractelement <2 x i64> %20, i64 1
  br label %bb.z

bb.z:                                             ; preds = %bb.y, %mi_commit_mask_all_set.exit.i.i
  %31 = phi i64 [ %30, %bb.y ], [ %i.bu, %mi_commit_mask_all_set.exit.i.i ] ; 2 uses
  %32 = phi i64 [ %29, %bb.y ], [ %15, %mi_commit_mask_all_set.exit.i.i ] ; 2 uses
  %33 = phi i64 [ %28, %bb.y ], [ %13, %mi_commit_mask_all_set.exit.i.i ] ; 2 uses
  %34 = phi i64 [ %27, %bb.y ], [ %12, %mi_commit_mask_all_set.exit.i.i ] ; 2 uses
  %35 = phi i64 [ %26, %bb.y ], [ %10, %mi_commit_mask_all_set.exit.i.i ] ; 2 uses
  %36 = phi i64 [ %25, %bb.y ], [ %8, %mi_commit_mask_all_set.exit.i.i ] ; 2 uses
  %37 = phi i64 [ %24, %bb.y ], [ %7, %mi_commit_mask_all_set.exit.i.i ] ; 2 uses
  %i.dh = phi i64 [ %23, %bb.y ], [ %6, %mi_commit_mask_all_set.exit.i.i ] ; 2 uses
