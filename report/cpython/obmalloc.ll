...
bb.c:                                             ; preds = %bb.a
  ...
  %i.g = add i32 %i.f, 1
  store i32 %i.g, ptr %i.e, align 8, !tbaa !62
...
bb.e:                                             ; preds = %bb.d
  store atomic i64 0, ptr %i.b seq_cst, align 8, !tbaa !64
  br label %bb.g
...
tailrecurse:                                      ; preds = %.critedge, %bb.a
  ...
  br i1 %.not, label %bb.b, label %bb.c, !prof !61

bb.b:                                             ; preds = %tailrecurse
  %i.a = tail call ptr @mi_heap_get_default()     ; 2 uses
  %.not37 = icmp eq ptr %i.a, @_mi_heap_empty
  br i1 %.not37, label %_mi_page_malloc.exit34, label %bb.c, !prof !61

bb.c:                                             ; preds = %bb.b, %tailrecurse
  %.027 = phi ptr [ %i.a, %bb.b ], [ %.tr, %tailrecurse ] ; 8 uses
  %i.b = load ptr, ptr %.027, align 8, !tbaa !72  ; 3 uses
  %i.c = load i64, ptr %i.b, align 8, !tbaa !83
  %i.d = add i64 %i.c, 1                          ; 2 uses
  store i64 %i.d, ptr %i.b, align 8, !tbaa !83
  %i.e = load volatile ptr, ptr @deferred_free, align 8, !tbaa !84
  %.not.i = icmp eq ptr %i.e, null
  br i1 %.not.i, label %_mi_deferred_free.exit, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.f = getelementptr i8, ptr %i.b, i64 8        ; 2 uses
  %i.g = load i8, ptr %i.f, align 8, !tbaa !85, !range !86, !noundef !87
  %i.h = trunc nuw i8 %i.g to i1
  br i1 %i.h, label %_mi_deferred_free.exit, label %bb.e

bb.e:                                             ; preds = %bb.d
  store i8 1, ptr %i.f, align 8, !tbaa !85
  %i.i = load volatile ptr, ptr @deferred_free, align 8, !tbaa !84
  %i.j = load atomic ptr, ptr @deferred_arg monotonic, align 8
  tail call void %i.i(i1 noundef zeroext false, i64 noundef %i.d, ptr noundef %i.j) #55, !inline_history !88
  %i.k = load ptr, ptr %.027, align 8, !tbaa !72
  %i.l = getelementptr i8, ptr %i.k, i64 8
  store i8 0, ptr %i.l, align 8, !tbaa !85
...
.preheader.i:                                     ; preds = %_mi_deferred_free.exit, %.preheader.i
  ...
  br i1 %or.cond.not.i, label %.critedge.i, label %.preheader.i, !llvm.loop !0
...
bb.g:                                             ; preds = %bb.g, %bb.f
  ...
  br i1 %i.y, label %.loopexit.i, label %bb.g, !llvm.loop !1

.loopexit.i:                                      ; preds = %bb.g, %.lr.ph.i
  %.not.i30 = icmp eq i64 %i.s, 0
  br i1 %.not.i30, label %_mi_heap_delayed_free_partial.exit, label %.lr.ph.i, !llvm.loop !2
...
_mi_heap_delayed_free_partial.exit:               ; preds = %.loopexit.i, %_mi_deferred_free.exit, %.critedge.i
  ...
  br i1 %i.ab, label %bb.h, label %.thread, !prof !61
...
bb.h:                                             ; preds = %_mi_heap_delayed_free_partial.exit
  ...
  br i1 %i.ad, label %bb.i, label %.thread, !prof !90
...
bb.j:                                             ; preds = %.thread
  ...
  br i1 %i.ag, label %bb.k, label %.critedge, !prof !61

bb.k:                                             ; preds = %bb.j
  %i.ah = getelementptr i8, ptr %.02836, i64 16   ; 2 uses
  %i.ai = load ptr, ptr %i.ah, align 8, !tbaa !60 ; 3 uses
  %i.aj = icmp eq ptr %i.ai, null
  br i1 %i.aj, label %_mi_page_malloc.exit, label %_mi_page_malloc.exit.thread, !prof !61
...
_mi_page_malloc.exit.thread:                      ; preds = %bb.k
  ...
  %i.am = add i32 %i.al, 1
  store i32 %i.am, ptr %i.ak, align 8, !tbaa !62
  %i.an = load atomic i64, ptr %i.ai monotonic, align 8
  %i.ao = inttoptr i64 %i.an to ptr
  store ptr %i.ao, ptr %i.ah, align 8, !tbaa !60
  br label %bb.l

_mi_page_malloc.exit:                             ; preds = %bb.k
  %i.ap = getelementptr i8, ptr %.02836, i64 28
  %i.aq = tail call noalias ptr @_mi_malloc_generic(ptr noundef nonnull %.027, i64 noundef %1, i1 noundef zeroext false, i64 noundef 0), !inline_history !91 ; 2 uses
  %.pre = load i32, ptr %i.ap, align 4, !tbaa !65 ; 2 uses
  %i.ar = icmp sgt i32 %.pre, -1
  br i1 %i.ar, label %bb.l, label %_mi_segment_page_start.exit.i.i, !prof !92
...
_mi_segment_page_start.exit.i.i:                  ; preds = %_mi_page_malloc.exit
  %i.au = load i32, ptr %.02836, align 8, !tbaa !93
...
.critedge:                                        ; preds = %.thread, %bb.j
  ...
  %i.ay = load ptr, ptr %i.ax, align 8, !tbaa !60 ; 8 uses
  %i.az = icmp eq ptr %i.ay, null
  br i1 %i.az, label %tailrecurse, label %bb.m, !prof !61
...
bb.m:                                             ; preds = %.critedge
  ...
  %i.bd = add i32 %i.bc, 1
  store i32 %i.bd, ptr %i.bb, align 8, !tbaa !62
  %i.be = load atomic i64, ptr %i.ay monotonic, align 8
  %i.bf = inttoptr i64 %i.be to ptr
  store ptr %i.bf, ptr %i.ba, align 8, !tbaa !60
  br i1 %2, label %bb.n, label %_mi_page_malloc.exit34, !prof !61
...
bb.o:                                             ; preds = %bb.n
  store atomic i64 0, ptr %i.ay seq_cst, align 8, !tbaa !64
  br label %_mi_page_malloc.exit34
...
bb.b:                                             ; preds = %bb.a
  %i.i = tail call noalias ptr @_mi_malloc_generic(ptr noundef nonnull %0, i64 noundef %1, i1 noundef zeroext false, i64 noundef 0), !inline_history !91
  br label %mi_heap_malloc_small_zero.exit

bb.c:                                             ; preds = %bb.a
  %i.j = getelementptr i8, ptr %i.e, i64 24       ; 2 uses
  %i.k = load i32, ptr %i.j, align 8, !tbaa !62
  %i.l = add i32 %i.k, 1
  store i32 %i.l, ptr %i.j, align 8, !tbaa !62
  %i.m = load atomic i64, ptr %i.g monotonic, align 8
  %i.n = inttoptr i64 %i.m to ptr
  store ptr %i.n, ptr %i.f, align 8, !tbaa !60
  br label %mi_heap_malloc_small_zero.exit
...
bb.b:                                             ; preds = %bb.a
  %i.k = tail call noalias ptr @_mi_malloc_generic(ptr noundef nonnull %i.b, i64 noundef %0, i1 noundef zeroext false, i64 noundef 0), !inline_history !91
  br label %mi_heap_malloc_small.exit

bb.c:                                             ; preds = %bb.a
  %i.l = getelementptr i8, ptr %i.g, i64 24       ; 2 uses
  %i.m = load i32, ptr %i.l, align 8, !tbaa !62
  %i.n = add i32 %i.m, 1
  store i32 %i.n, ptr %i.l, align 8, !tbaa !62
  %i.o = load atomic i64, ptr %i.i monotonic, align 8
  %i.p = inttoptr i64 %i.o to ptr
  store ptr %i.p, ptr %i.h, align 8, !tbaa !60
  br label %mi_heap_malloc_small.exit
...
bb.a:
  ...
  br i1 %i.a, label %bb.b, label %bb.h, !prof !96
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !60   ; 8 uses
  %i.i = icmp eq ptr %i.h, null
  br i1 %i.i, label %bb.c, label %bb.d, !prof !61

bb.c:                                             ; preds = %bb.b
  %i.j = tail call noalias ptr @_mi_malloc_generic(ptr noundef nonnull %0, i64 noundef %1, i1 noundef zeroext %2, i64 noundef 0), !inline_history !91
  br label %mi_heap_malloc_small_zero.exit

bb.d:                                             ; preds = %bb.b
  %i.k = getelementptr i8, ptr %i.f, i64 24       ; 2 uses
  %i.l = load i32, ptr %i.k, align 8, !tbaa !62
  %i.m = add i32 %i.l, 1
  store i32 %i.m, ptr %i.k, align 8, !tbaa !62
  %i.n = load atomic i64, ptr %i.h monotonic, align 8
  %i.o = inttoptr i64 %i.n to ptr
  store ptr %i.o, ptr %i.g, align 8, !tbaa !60
  br i1 %2, label %bb.e, label %mi_heap_malloc_small_zero.exit, !prof !61
...
bb.f:                                             ; preds = %bb.e
  store atomic i64 0, ptr %i.h seq_cst, align 8, !tbaa !64
  br label %mi_heap_malloc_small_zero.exit
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.o = inttoptr i64 %i.n to ptr
  store ptr %i.o, ptr %i.g, align 8, !tbaa !60
  br i1 %2, label %bb.e, label %_mi_heap_malloc_zero_ex.exit, !prof !61
...
bb.a:
  %i.a = icmp ult i64 %1, 1025
  br i1 %i.a, label %bb.b, label %bb.e, !prof !96
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = getelementptr i8, ptr %i.f, i64 16       ; 2 uses
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !60   ; 3 uses
  %i.i = icmp eq ptr %i.h, null
  br i1 %i.i, label %bb.c, label %bb.d, !prof !61

bb.c:                                             ; preds = %bb.b
  %i.j = tail call noalias ptr @_mi_malloc_generic(ptr noundef nonnull %0, i64 noundef %1, i1 noundef zeroext false, i64 noundef 0), !inline_history !91
...
bb.c:                                             ; preds = %bb.b
  %i.l = tail call noalias ptr @_mi_malloc_generic(ptr noundef nonnull %i.b, i64 noundef %0, i1 noundef zeroext false, i64 noundef 0), !inline_history !91
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.o = add i32 %i.n, 1
  store i32 %i.o, ptr %i.m, align 8, !tbaa !62
  %i.p = load atomic i64, ptr %i.j monotonic, align 8
  %i.q = inttoptr i64 %i.p to ptr
  store ptr %i.q, ptr %i.i, align 8, !tbaa !60
  br label %mi_heap_malloc.exit
...
bb.a:
  ...
  %i.h = getelementptr i8, ptr %i.g, i64 16       ; 2 uses
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !60   ; 7 uses
  %i.j = icmp eq ptr %i.i, null
  br i1 %i.j, label %bb.b, label %bb.c, !prof !61

bb.b:                                             ; preds = %bb.a
  %i.k = tail call noalias ptr @_mi_malloc_generic(ptr noundef nonnull %i.b, i64 noundef %0, i1 noundef zeroext true, i64 noundef 0), !inline_history !91
  br label %mi_heap_malloc_small_zero.exit
...
bb.d:                                             ; preds = %bb.c
  store atomic i64 0, ptr %i.i seq_cst, align 8, !tbaa !64
  br label %mi_heap_malloc_small_zero.exit
...
bb.a:
  %i.a = icmp ult i64 %1, 1025
  br i1 %i.a, label %bb.b, label %bb.g, !prof !96
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !94   ; 4 uses
  %i.g = getelementptr i8, ptr %i.f, i64 16       ; 2 uses
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !60   ; 7 uses
  %i.i = icmp eq ptr %i.h, null
  br i1 %i.i, label %bb.c, label %bb.d, !prof !61

bb.c:                                             ; preds = %bb.b
  %i.j = tail call noalias ptr @_mi_malloc_generic(ptr noundef nonnull %0, i64 noundef %1, i1 noundef zeroext true, i64 noundef 0), !inline_history !91
  br label %_mi_heap_malloc_zero.exit
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !95   ; 3 uses
  %i.c = icmp ult i64 %0, 1025
  br i1 %i.c, label %bb.b, label %bb.g, !prof !96
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = getelementptr i8, ptr %i.b, i64 8
  %i.g = getelementptr [8 x i8], ptr %i.f, i64 %i.e
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !94   ; 4 uses
  %i.i = getelementptr i8, ptr %i.h, i64 16       ; 2 uses
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !60   ; 7 uses
  %i.k = icmp eq ptr %i.j, null
  br i1 %i.k, label %bb.c, label %bb.d, !prof !61

bb.c:                                             ; preds = %bb.b
  %i.l = tail call noalias ptr @_mi_malloc_generic(ptr noundef nonnull %i.b, i64 noundef %0, i1 noundef zeroext true, i64 noundef 0), !inline_history !91
...
bb.e:                                             ; preds = %bb.d
  store atomic i64 0, ptr %i.j seq_cst, align 8, !tbaa !64
  br label %mi_heap_zalloc.exit
...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 4, !tbaa !65   ; 5 uses
  %i.c = zext i32 %i.b to i64                     ; 4 uses
  %i.d = load i32, ptr %1, align 8, !tbaa !93
...
_mi_page_start.exit:                              ; preds = %bb.b
  ...
  br i1 %i.af, label %mi_page_block_size.exit, label %_mi_segment_page_start.exit.i, !prof !97
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load i32, ptr %i.c, align 4, !tbaa !65   ; 5 uses
  %i.e = zext i32 %i.d to i64                     ; 4 uses
  %i.f = load i32, ptr %1, align 8, !tbaa !93
...
_mi_page_start.exit.i:                            ; preds = %bb.c
  ...
  br i1 %i.ah, label %_mi_page_ptr_unalign.exit, label %_mi_segment_page_start.exit.i.i, !prof !97
...
bb.e:                                             ; preds = %bb.a, %_mi_page_ptr_unalign.exit
  ...
  br i1 %2, label %bb.f, label %bb.j, !prof !96
...
bb.f:                                             ; preds = %bb.e
  ...
  store ptr %i.ao, ptr %i.ap, align 8, !tbaa !98
  %i.as = getelementptr i8, ptr %1, i64 24        ; 2 uses
  %i.at = load i32, ptr %i.as, align 8, !tbaa !62
  %i.au = add i32 %i.at, -1                       ; 2 uses
  store i32 %i.au, ptr %i.as, align 8, !tbaa !62
  %i.av = icmp eq i32 %i.au, 0
  br i1 %i.av, label %bb.g, label %bb.h, !prof !61
...
bb.h:                                             ; preds = %bb.f
  ...
  br i1 %i.aw, label %bb.i, label %_mi_free_block.exit, !prof !61
...
bb.a:
  ...
  br i1 %i.a, label %bb.h, label %bb.b, !prof !61
...
begin_hunk_1_@mi_free_size:bb.a
  ...
  store ptr %0, ptr %i.w, align 8, !tbaa !98
...
bb.a:
  %i.a = icmp eq ptr %0, null
  br i1 %i.a, label %mi_free_size.exit, label %bb.b, !prof !61
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = tail call ptr asm "movq %fs:$1, $0", "=r,*m,~{dirflag},~{fpsr},~{flags}"(ptr elementtype(ptr) null) #60, !srcloc !99
  ...
  br i1 %i.j, label %bb.c, label %bb.g, !prof !96

bb.c:                                             ; preds = %bb.b
  %i.t = getelementptr i8, ptr %i.s, i64 14
  %i.u = load i8, ptr %i.t, align 2, !tbaa !101
  %i.v = icmp eq i8 %i.u, 0
  br i1 %i.v, label %bb.d, label %bb.f, !prof !96
...
bb.a:
  %i.a = icmp eq ptr %0, null
  br i1 %i.a, label %mi_free.exit, label %bb.b, !prof !61
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.b, label %mi_count_size_overflow.exit, label %bb.c, !prof !61

bb.c:                                             ; preds = %bb.b, %bb.a
  %storemerge.i.ph = phi i64 [ %2, %bb.a ], [ %i.c, %bb.b ] ; 4 uses
  %i.d = icmp ult i64 %storemerge.i.ph, 1025
  br i1 %i.d, label %bb.d, label %bb.i, !prof !96
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !94   ; 4 uses
  %i.j = getelementptr i8, ptr %i.i, i64 16       ; 2 uses
  %i.k = load ptr, ptr %i.j, align 8, !tbaa !60   ; 7 uses
  %i.l = icmp eq ptr %i.k, null
  br i1 %i.l, label %bb.e, label %bb.f, !prof !61

bb.e:                                             ; preds = %bb.d
  %i.m = tail call noalias ptr @_mi_malloc_generic(ptr noundef nonnull %0, i64 noundef %storemerge.i.ph, i1 noundef zeroext true, i64 noundef 0), !inline_history !91
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.p = add i32 %i.o, 1
  store i32 %i.p, ptr %i.n, align 8, !tbaa !62
...
bb.g:                                             ; preds = %bb.f
  store atomic i64 0, ptr %i.k seq_cst, align 8, !tbaa !64
  br label %mi_count_size_overflow.exit
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  br i1 %i.f, label %bb.d, label %bb.i, !prof !96
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.k = load ptr, ptr %i.j, align 8, !tbaa !94   ; 4 uses
  %i.l = getelementptr i8, ptr %i.k, i64 16       ; 2 uses
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !60   ; 7 uses
  %i.n = icmp eq ptr %i.m, null
  br i1 %i.n, label %bb.e, label %bb.f, !prof !61

bb.e:                                             ; preds = %bb.d
  %i.o = tail call noalias ptr @_mi_malloc_generic(ptr noundef nonnull %i.b, i64 noundef %storemerge.i.ph.i, i1 noundef zeroext true, i64 noundef 0), !inline_history !91
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.r = add i32 %i.q, 1
  store i32 %i.r, ptr %i.p, align 8, !tbaa !62
  %i.s = load atomic i64, ptr %i.m monotonic, align 8
  %i.t = inttoptr i64 %i.s to ptr
  store ptr %i.t, ptr %i.l, align 8, !tbaa !60
...
bb.g:                                             ; preds = %bb.f
  store atomic i64 0, ptr %i.m seq_cst, align 8, !tbaa !64
  br label %mi_heap_calloc.exit
...
bb.c:                                             ; preds = %bb.b, %bb.a
  %storemerge.i.ph = phi i64 [ %2, %bb.a ], [ %i.c, %bb.b ] ; 4 uses
  %i.d = icmp ult i64 %storemerge.i.ph, 1025
  br i1 %i.d, label %bb.d, label %bb.g, !prof !96
...
bb.e:                                             ; preds = %bb.d
  %i.m = tail call noalias ptr @_mi_malloc_generic(ptr noundef nonnull %0, i64 noundef %storemerge.i.ph, i1 noundef zeroext false, i64 noundef 0), !inline_history !91
  br label %mi_count_size_overflow.exit
...
bb.c:                                             ; preds = %bb.b, %bb.a
  %storemerge.i.ph.i = phi i64 [ %1, %bb.a ], [ %i.e, %bb.b ] ; 4 uses
  %i.f = icmp ult i64 %storemerge.i.ph.i, 1025
  br i1 %i.f, label %bb.d, label %bb.g, !prof !96
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.l = getelementptr i8, ptr %i.k, i64 16       ; 2 uses
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !60   ; 3 uses
  %i.n = icmp eq ptr %i.m, null
  br i1 %i.n, label %bb.e, label %bb.f, !prof !61

bb.e:                                             ; preds = %bb.d
  %i.o = tail call noalias ptr @_mi_malloc_generic(ptr noundef nonnull %i.b, i64 noundef %storemerge.i.ph.i, i1 noundef zeroext false, i64 noundef 0), !inline_history !91
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not.i, label %bb.c, label %bb.e, !prof !96

bb.c:                                             ; preds = %bb.b
  %i.q = getelementptr i8, ptr %i.n, i64 28
  %i.r = load i32, ptr %i.q, align 4, !tbaa !65   ; 2 uses
  %i.s = icmp sgt i32 %i.r, -1
  br i1 %i.s, label %bb.d, label %_mi_segment_page_start.exit.i.i.i.i, !prof !96
...
mi_try_new_handler.exit.i:                        ; preds = %.lr.ph.i
  tail call void %i.h() #55, !inline_history !471
  ...
  %i.k = icmp eq ptr %i.j, null
  br i1 %i.k, label %.lr.ph.i, label %mi_new_realloc.exit, !llvm.loop !8
...
bb.a:
  %i.a = icmp eq i64 %2, 0
  br i1 %i.a, label %mi_heap_malloc_zero_aligned_at.exit, label %bb.b, !prof !61
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %or.cond.i, label %mi_heap_malloc_zero_aligned_at.exit, label %bb.c, !prof !119

bb.c:                                             ; preds = %bb.b
  %i.e = icmp samesign ult i64 %1, 1025
  %i.f = icmp ule i64 %2, %1
  %i.g = and i1 %i.e, %i.f
  br i1 %i.g, label %bb.d, label %_mi_page_malloc.exit.i, !prof !96
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !60   ; 4 uses
  ...
  br i1 %.not31.i, label %_mi_page_malloc.exit.i, label %bb.e, !prof !61
...
bb.e:                                             ; preds = %bb.d
  ...
  store ptr %i.y, ptr %i.n, align 8, !tbaa !60
...
bb.a:
  ...
  br i1 %or.cond.not16, label %bb.b, label %.critedge, !prof !116
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.e, label %bb.c, label %bb.f, !prof !96
...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %i.m, label %bb.d, label %bb.e, !prof !61

bb.d:                                             ; preds = %bb.c
  %i.n = tail call noalias ptr @_mi_malloc_generic(ptr noundef nonnull %0, i64 noundef %1, i1 noundef zeroext false, i64 noundef 0), !inline_history !91
  br label %.critedge

bb.e:                                             ; preds = %bb.c
  %i.o = getelementptr i8, ptr %i.j, i64 24       ; 2 uses
  %i.p = load i32, ptr %i.o, align 8, !tbaa !62
  %i.q = add i32 %i.p, 1
  store i32 %i.q, ptr %i.o, align 8, !tbaa !62
  %i.r = load atomic i64, ptr %i.l monotonic, align 8
  %i.s = inttoptr i64 %i.r to ptr
  store ptr %i.s, ptr %i.k, align 8, !tbaa !60
  br label %.critedge
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.k = getelementptr i8, ptr %0, i64 8
  %i.l = getelementptr [8 x i8], ptr %i.k, i64 %i.j
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !94   ; 4 uses
  %i.n = getelementptr i8, ptr %i.m, i64 16       ; 2 uses
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !60   ; 8 uses
  %i.p = ptrtoint ptr %i.o to i64
  %i.q = add i64 %3, %i.p
  %i.r = and i64 %i.q, %i.h
  %i.s = icmp ne i64 %i.r, 0
...
bb.f:                                             ; preds = %bb.e
  store atomic i64 0, ptr %i.o seq_cst, align 8, !tbaa !64
  br label %mi_heap_malloc_zero_aligned_at.exit

bb.g:                                             ; preds = %bb.e
  %i.ac = getelementptr i8, ptr %i.m, i64 28
  %i.ad = load i32, ptr %i.ac, align 4, !tbaa !65
...
bb.a:
  %i.a = icmp eq i64 %2, 0
  br i1 %i.a, label %mi_heap_zalloc_aligned_at.exit, label %bb.b, !prof !61
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %or.cond.i.i, label %mi_heap_zalloc_aligned_at.exit, label %bb.c, !prof !119

bb.c:                                             ; preds = %bb.b
  %i.e = icmp samesign ult i64 %1, 1025
  %i.f = icmp ule i64 %2, %1
  %i.g = and i1 %i.e, %i.f
  br i1 %i.g, label %bb.d, label %_mi_page_malloc.exit.i.i, !prof !96
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %.not31.i.i, label %_mi_page_malloc.exit.i.i, label %bb.e, !prof !61
...
bb.e:                                             ; preds = %bb.d
  ...
  store ptr %i.x, ptr %i.n, align 8, !tbaa !60
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.d = icmp eq i64 %3, 0
  br i1 %i.d, label %mi_count_size_overflow.exit, label %bb.d, !prof !61
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %or.cond.i.i, label %mi_count_size_overflow.exit, label %bb.e, !prof !119

bb.e:                                             ; preds = %bb.d
  %i.h = icmp samesign ult i64 %storemerge.i.ph, 1025
  %i.i = icmp ule i64 %3, %storemerge.i.ph
  %i.j = and i1 %i.h, %i.i
  br i1 %i.j, label %bb.f, label %_mi_page_malloc.exit.i.i, !prof !96
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !94   ; 4 uses
  %i.q = getelementptr i8, ptr %i.p, i64 16       ; 2 uses
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !60   ; 8 uses
  ...
  br i1 %.not31.i.i, label %_mi_page_malloc.exit.i.i, label %bb.g, !prof !61

bb.g:                                             ; preds = %bb.f
  %i.x = getelementptr i8, ptr %i.p, i64 24       ; 2 uses
  %i.y = load i32, ptr %i.x, align 8, !tbaa !62
  %i.z = add i32 %i.y, 1
  store i32 %i.z, ptr %i.x, align 8, !tbaa !62
  %i.aa = load atomic i64, ptr %i.r monotonic, align 8
  %i.ab = inttoptr i64 %i.aa to ptr
  store ptr %i.ab, ptr %i.q, align 8, !tbaa !60
...
bb.h:                                             ; preds = %bb.g
  store atomic i64 0, ptr %i.r seq_cst, align 8, !tbaa !64
  br label %mi_count_size_overflow.exit
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.d = icmp eq i64 %3, 0
  br i1 %i.d, label %mi_heap_calloc_aligned_at.exit, label %bb.d, !prof !61
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %or.cond.i.i.i, label %mi_heap_calloc_aligned_at.exit, label %bb.e, !prof !119

bb.e:                                             ; preds = %bb.d
  %i.h = icmp samesign ult i64 %storemerge.i.ph.i, 1025
  %i.i = icmp ule i64 %3, %storemerge.i.ph.i
  %i.j = and i1 %i.h, %i.i
  br i1 %i.j, label %bb.f, label %_mi_page_malloc.exit.i.i.i, !prof !96
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %.not31.i.i.i, label %_mi_page_malloc.exit.i.i.i, label %bb.g, !prof !61

bb.g:                                             ; preds = %bb.f
  %i.w = getelementptr i8, ptr %i.p, i64 24       ; 2 uses
  %i.x = load i32, ptr %i.w, align 8, !tbaa !62
  %i.y = add i32 %i.x, 1
  store i32 %i.y, ptr %i.w, align 8, !tbaa !62
  %i.z = load atomic i64, ptr %i.r monotonic, align 8
  %i.aa = inttoptr i64 %i.z to ptr
  store ptr %i.aa, ptr %i.q, align 8, !tbaa !60
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !95   ; 2 uses
  %i.c = icmp eq i64 %1, 0
  br i1 %i.c, label %mi_heap_malloc_aligned_at.exit, label %bb.b, !prof !61
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %or.cond.i.i, label %mi_heap_malloc_aligned_at.exit, label %bb.c, !prof !119

bb.c:                                             ; preds = %bb.b
  %i.g = icmp samesign ult i64 %0, 1025
  %i.h = icmp ule i64 %1, %0
  %i.i = and i1 %i.g, %i.h
  br i1 %i.i, label %bb.d, label %_mi_page_malloc.exit.i.i, !prof !96
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.q = load ptr, ptr %i.p, align 8, !tbaa !60   ; 4 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.aa = inttoptr i64 %i.z to ptr
  store ptr %i.aa, ptr %i.p, align 8, !tbaa !60
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !95   ; 2 uses
  %i.c = icmp eq i64 %1, 0
  br i1 %i.c, label %mi_heap_zalloc_aligned_at.exit, label %bb.b, !prof !61
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.p = getelementptr i8, ptr %i.o, i64 16       ; 2 uses
  %i.q = load ptr, ptr %i.p, align 8, !tbaa !60   ; 8 uses
  %i.r = ptrtoint ptr %i.q to i64
  %i.s = add i64 %2, %i.r
  %i.t = and i64 %i.s, %i.j
  %i.u = icmp ne i64 %i.t, 0
...
bb.f:                                             ; preds = %bb.e
  store atomic i64 0, ptr %i.q seq_cst, align 8, !tbaa !64
  br label %mi_heap_zalloc_aligned_at.exit
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !95   ; 2 uses
  %i.c = icmp eq i64 %1, 0
  br i1 %i.c, label %mi_heap_zalloc_aligned.exit, label %bb.b, !prof !61
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %or.cond.i.i.i, label %mi_heap_zalloc_aligned.exit, label %bb.c, !prof !119

bb.c:                                             ; preds = %bb.b
  %i.g = icmp samesign ult i64 %0, 1025
  %i.h = icmp ule i64 %1, %0
  %i.i = and i1 %i.g, %i.h
  br i1 %i.i, label %bb.d, label %_mi_page_malloc.exit.i.i.i, !prof !96
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %.not31.i.i.i, label %_mi_page_malloc.exit.i.i.i, label %bb.e, !prof !61
...
bb.e:                                             ; preds = %bb.d
  ...
  store ptr %i.z, ptr %i.p, align 8, !tbaa !60
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.ae = load i32, ptr %i.ad, align 4, !tbaa !65
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.f = icmp eq i64 %2, 0
  br i1 %i.f, label %mi_heap_calloc_aligned_at.exit, label %bb.d, !prof !61
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.l = and i1 %i.j, %i.k
  br i1 %i.l, label %bb.f, label %_mi_page_malloc.exit.i.i.i, !prof !96
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !94   ; 4 uses
  %i.s = getelementptr i8, ptr %i.r, i64 16       ; 2 uses
  %i.t = load ptr, ptr %i.s, align 8, !tbaa !60   ; 8 uses
...
bb.h:                                             ; preds = %bb.g
  store atomic i64 0, ptr %i.t seq_cst, align 8, !tbaa !64
  br label %mi_heap_calloc_aligned_at.exit
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.f = icmp eq i64 %2, 0
  br i1 %i.f, label %mi_heap_calloc_aligned.exit, label %bb.d, !prof !61
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %or.cond.i.i.i.i, label %mi_heap_calloc_aligned.exit, label %bb.e, !prof !119

bb.e:                                             ; preds = %bb.d
  %i.j = icmp samesign ult i64 %storemerge.i.ph.i.i, 1025
  %i.k = icmp ule i64 %2, %storemerge.i.ph.i.i
  %i.l = and i1 %i.j, %i.k
  br i1 %i.l, label %bb.f, label %_mi_page_malloc.exit.i.i.i.i, !prof !96
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %.not31.i.i.i.i, label %_mi_page_malloc.exit.i.i.i.i, label %bb.g, !prof !61

bb.g:                                             ; preds = %bb.f
  %i.y = getelementptr i8, ptr %i.r, i64 24       ; 2 uses
  %i.z = load i32, ptr %i.y, align 8, !tbaa !62
  %i.aa = add i32 %i.z, 1
  store i32 %i.aa, ptr %i.y, align 8, !tbaa !62
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %or.cond.i, label %mi_heap_malloc_zero_aligned_at.exit, label %bb.e, !prof !119

bb.e:                                             ; preds = %bb.d
  %i.g = icmp samesign ult i64 %2, 1025
  %i.h = icmp ule i64 %3, %2
  %i.i = and i1 %i.g, %i.h
  br i1 %i.i, label %bb.f, label %_mi_page_malloc.exit.i, !prof !96
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %.not31.i, label %_mi_page_malloc.exit.i, label %bb.g, !prof !61
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.aa = inttoptr i64 %i.z to ptr
  store ptr %i.aa, ptr %i.p, align 8, !tbaa !60
  br i1 %5, label %bb.h, label %mi_heap_malloc_zero_aligned_at.exit, !prof !61
...
bb.k:                                             ; preds = %bb.c
  ...
  %i.ar = load i32, ptr %i.aq, align 4, !tbaa !100
  ...
  br i1 %.not.i.i52, label %bb.l, label %bb.n, !prof !96

bb.l:                                             ; preds = %bb.k
  %i.ax = getelementptr i8, ptr %i.au, i64 28
  %i.ay = load i32, ptr %i.ax, align 4, !tbaa !65 ; 2 uses
  %i.az = icmp sgt i32 %i.ay, -1
  br i1 %i.az, label %bb.m, label %_mi_segment_page_start.exit.i.i.i.i.i, !prof !96
...
_mi_segment_page_start.exit.i.i.i.i.i:            ; preds = %bb.l
  %i.bb = load i32, ptr %i.au, align 8, !tbaa !93
...
bb.q:                                             ; preds = %mi_usable_size.exit, %bb.o, %bb.p
  ...
  br i1 %or.cond.i.i, label %mi_heap_malloc_zero_aligned_at.exit, label %bb.r, !prof !119

bb.r:                                             ; preds = %bb.q
  %i.bn = icmp samesign ult i64 %2, 1025
  %i.bo = icmp ule i64 %3, %2
  %i.bp = and i1 %i.bn, %i.bo
  br i1 %i.bp, label %bb.s, label %mi_heap_malloc_aligned_at.exit, !prof !96
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.bv = load ptr, ptr %i.bu, align 8, !tbaa !94 ; 2 uses
  %i.bw = getelementptr i8, ptr %i.bv, i64 16     ; 2 uses
  %i.bx = load ptr, ptr %i.bw, align 8, !tbaa !60 ; 4 uses
  ...
  br i1 %.not31.i.i, label %mi_heap_malloc_aligned_at.exit, label %mi_heap_malloc_aligned_at.exit.thread55, !prof !61

mi_heap_malloc_aligned_at.exit.thread55:          ; preds = %bb.s
  %i.cd = getelementptr i8, ptr %i.bv, i64 24     ; 2 uses
  %i.ce = load i32, ptr %i.cd, align 8, !tbaa !62
  %i.cf = add i32 %i.ce, 1
  store i32 %i.cf, ptr %i.cd, align 8, !tbaa !62
  %i.cg = load atomic i64, ptr %i.bx monotonic, align 8
  %i.ch = inttoptr i64 %i.cg to ptr
  store ptr %i.ch, ptr %i.bw, align 8, !tbaa !60
  br label %bb.t
...
bb.v:                                             ; preds = %bb.t, %bb.u
  ...
  call void @llvm.assume(i1 true) [ "align"(ptr %.2.i.i58, i64 8) ]
  ...
  %i.cp = tail call ptr asm "movq %fs:$1, $0", "=r,*m,~{dirflag},~{fpsr},~{flags}"(ptr elementtype(ptr) null) #60, !srcloc !99
  ...
  %i.cz = load i32, ptr %i.cy, align 4, !tbaa !100
  %i.da = zext i32 %i.cz to i64
  %i.db = sub nsw i64 0, %i.da
  %i.dc = getelementptr i8, ptr %i.cx, i64 %i.db  ; 6 uses
  br i1 %i.ct, label %bb.w, label %bb.aa, !prof !96

bb.w:                                             ; preds = %bb.v
  %i.dd = getelementptr i8, ptr %i.dc, i64 14
  %i.de = load i8, ptr %i.dd, align 2, !tbaa !101
  %i.df = icmp eq i8 %i.de, 0
  br i1 %i.df, label %bb.x, label %bb.z, !prof !96

bb.x:                                             ; preds = %bb.w
  %i.dg = getelementptr i8, ptr %i.dc, i64 32     ; 2 uses
  %i.dh = load ptr, ptr %i.dg, align 8, !tbaa !98
  %i.di = ptrtoint ptr %i.dh to i64
  store atomic i64 %i.di, ptr %1 monotonic, align 8
  store ptr %1, ptr %i.dg, align 8, !tbaa !98
  %i.dj = getelementptr i8, ptr %i.dc, i64 24     ; 2 uses
  %i.dk = load i32, ptr %i.dj, align 8, !tbaa !62
  %i.dl = add i32 %i.dk, -1                       ; 2 uses
  store i32 %i.dl, ptr %i.dj, align 8, !tbaa !62
  %i.dm = icmp eq i32 %i.dl, 0
  br i1 %i.dm, label %bb.y, label %mi_heap_malloc_zero_aligned_at.exit, !prof !61
...
begin_hunk_3_@_mi_random_next:bb.a
  ...
  store i32 0, ptr %i.h, align 4, !tbaa !54
  %i.j = load i32, ptr %i.a, align 4, !tbaa !166
  %i.k = add i32 %i.j, -1                         ; 3 uses
  store i32 %i.k, ptr %i.a, align 4, !tbaa !166
...
bb.c:                                             ; preds = %chacha_next32.exit
  ...
  store i32 16, ptr %i.a, align 4, !tbaa !166
...
chacha_next32.exit2:                              ; preds = %chacha_next32.exit, %bb.c
  ...
  %i.t = load i32, ptr %i.a, align 4, !tbaa !166
  %i.u = add i32 %i.t, -1
  store i32 %i.u, ptr %i.a, align 4, !tbaa !166
...
.lr.ph:                                           ; preds = %bb.c, %_mi_heap_page_destroy.exit
  %.0.i9 = phi ptr [ %i.i, %_mi_heap_page_destroy.exit ], [ %i.g, %bb.c ] ; 6 uses
  %i.h = getelementptr i8, ptr %.0.i9, i64 56     ; 2 uses
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !171  ; 2 uses
  %i.j = tail call zeroext i1 @_mi_page_try_use_delayed_free(ptr noundef nonnull %.0.i9, i32 noundef 3, i1 noundef zeroext false)
  br i1 %i.j, label %mi_page_block_size.exit.i, label %.lr.ph.i.i.preheader

.lr.ph.i.i.preheader:                             ; preds = %.lr.ph
  %i.k = getelementptr i8, ptr %.0.i9, i64 40     ; 10 uses
  br label %.lr.ph.i.i
...
bb.d:                                             ; preds = %.critedge.1.i
  ...
  br i1 %i.t, label %mi_page_block_size.exit.i, label %.critedge.1.i, !llvm.loop !5
...
bb.e:                                             ; preds = %.critedge.2.i
  ...
  br i1 %i.z, label %mi_page_block_size.exit.i, label %.critedge.2.i, !llvm.loop !5
...
bb.f:                                             ; preds = %.critedge.3.i
  ...
  br i1 %i.af, label %mi_page_block_size.exit.i, label %.critedge.3.i, !llvm.loop !5
...
bb.g:                                             ; preds = %.critedge.4.i
  ...
  br i1 %i.al, label %mi_page_block_size.exit.i, label %.critedge.4.i, !llvm.loop !5
...
bb.h:                                             ; preds = %.critedge.i2
  ...
  br i1 %i.ao, label %mi_page_block_size.exit.i, label %.critedge.i2, !llvm.loop !5
...
mi_page_block_size.exit.i:                        ; preds = %.critedge.i2, %bb.h, %.critedge.1.i, %bb.d, %.critedge.2.i, %bb.e, %.critedge.3.i, %bb.f, %.critedge.4.i, %bb.g, %.lr.ph
  %i.ap = getelementptr i8, ptr %.0.i9, i64 24
  store i32 0, ptr %i.ap, align 8, !tbaa !62
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.h, i8 0, i64 16, i1 false)
  %i.aq = load ptr, ptr %0, align 8, !tbaa !72
  %i.ar = getelementptr i8, ptr %i.aq, i64 32     ; 3 uses
  %i.as = ptrtoint ptr %.0.i9 to i64
  %i.at = add i64 %i.as, -1
  %i.au = and i64 %i.at, -33554432
  %i.av = inttoptr i64 %i.au to ptr               ; 4 uses
  %i.aw = tail call fastcc ptr @mi_segment_page_clear(ptr noundef nonnull %.0.i9, ptr noundef %i.ar) ; 0 uses
  %i.ax = getelementptr i8, ptr %i.av, i64 208
  %i.ay = load i64, ptr %i.ax, align 16, !tbaa !112 ; 2 uses
...
bb.j:                                             ; preds = %mi_page_block_size.exit.i
  ...
  %i.bb = load i64, ptr %i.ba, align 64, !tbaa !113
...
_mi_heap_page_destroy.exit:                       ; preds = %bb.i, %bb.j, %bb.k
  ...
  br i1 %.not.i, label %.critedge.i, label %.lr.ph, !llvm.loop !19
...
mi_heap_visit_pages.exit:                         ; preds = %.critedge.i, %bb.a, %bb.b
  ...
  store atomic ptr null, ptr %i.bg seq_cst, align 8, !tbaa !180
  %i.bh = getelementptr i8, ptr %0, i64 3024
  store i64 0, ptr %i.bh, align 8, !tbaa !170
  ret void
}
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load i8, ptr %i.c, align 8, !tbaa !169, !range !86, !noundef !87
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !168  ; 4 uses
...
.preheader.i.i:                                   ; preds = %bb.d, %.preheader.i.i
  ...
  br i1 %or.cond.not.i.i, label %.critedge.i.i, label %.preheader.i.i, !llvm.loop !0
...
bb.f:                                             ; preds = %bb.f, %bb.e
  ...
  br i1 %i.v, label %.loopexit.i.i, label %bb.f, !llvm.loop !1

.loopexit.i.i:                                    ; preds = %bb.f, %.lr.ph.i.i
  %.not.i.i = icmp eq i64 %i.p, 0
  br i1 %.not.i.i, label %_mi_heap_delayed_free_partial.exit.i, label %.lr.ph.i.i, !llvm.loop !2
...
bb.g:                                             ; preds = %bb.h
  ...
  store atomic ptr null, ptr %i.j seq_cst, align 8, !tbaa !180
...
bb.h:                                             ; preds = %bb.h, %_mi_heap_delayed_free_partial.exit.i
  ...
  %i.ae = load i64, ptr %i.z, align 8, !tbaa !170
  %i.af = add i64 %i.ae, %i.ad
  store i64 %i.af, ptr %i.z, align 8, !tbaa !170
  %i.ag = load i64, ptr %i.g, align 8, !tbaa !170
  %i.ah = sub i64 %i.ag, %i.ad
  store i64 %i.ah, ptr %i.g, align 8, !tbaa !170
  %i.ai = add nuw nsw i64 %.019.i, 1              ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.ai, 75
  br i1 %exitcond.not.i, label %bb.g, label %bb.h, !llvm.loop !518
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !168  ; 3 uses
...
bb.d:                                             ; preds = %bb.c
  store ptr %i.c, ptr %i.e, align 8, !tbaa !95
  %i.h = load i32, ptr @_mi_heap_default_key, align 4, !tbaa !54 ; 2 uses
...
bb.f:                                             ; preds = %bb.f, %_mi_heap_set_default_direct.exit
  ...
  %.0 = load ptr, ptr %.0.in, align 8, !tbaa !95  ; 5 uses
  %i.l = icmp ne ptr %.0, %0
  %i.m = icmp ne ptr %.0, null
  %i.n = and i1 %i.l, %i.m
  %i.o = getelementptr i8, ptr %.0, i64 3048
  br i1 %i.n, label %bb.f, label %bb.g, !llvm.loop !519
...
bb.i:                                             ; preds = %bb.h
  ...
  store ptr %i.r, ptr %i.s, align 8, !tbaa !178
  br label %bb.k

bb.j:                                             ; preds = %bb.h
  store ptr %i.r, ptr %i.k, align 8, !tbaa !177
  br label %bb.k
...
bb.k:                                             ; preds = %bb.i, %bb.j, %bb.g
  ...
  %i.x = tail call ptr asm "movq %fs:$1, $0", "=r,*m,~{dirflag},~{fpsr},~{flags}"(ptr elementtype(ptr) null) #60, !srcloc !99
  %i.y = ptrtoint ptr %i.x to i64
...
bb.a:
  tail call void @mi_process_init(), !inline_history !174
  %i.a = tail call fastcc zeroext i1 @_mi_heap_init(), !inline_history !174
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %i.g, label %_mi_stat_increase.exit.i.i, label %bb.c, !llvm.loop !10
...
mi_heap_get_backing.exit:                         ; preds = %bb.a, %_mi_stat_increase.exit.i.i
  ...
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !177  ; 2 uses
...
.lr.ph:                                           ; preds = %mi_heap_get_backing.exit, %mi_heap_destroy.exit
  ...
  %i.v = load i8, ptr %i.u, align 8, !tbaa !169, !range !86, !noundef !87
...
bb.am:                                            ; preds = %bb.ak, %bb.aj
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.au, ptr noundef nonnull align 8 dereferenceable(24) %0, i64 24, i1 false), !tbaa.struct !162
  %i.av = getelementptr inbounds nuw i8, ptr %0, i64 18
  %i.aw = load i8, ptr %i.av, align 2, !tbaa !160, !range !86, !noundef !87
...
bb.ao:                                            ; preds = %mi_thread_data_zalloc.exit.thread, %mi_thread_data_zalloc.exit
  ...
  store ptr %i.bb, ptr %i.bc, align 8, !tbaa !185
  %i.bd = getelementptr i8, ptr %.4.i, i64 4008
  store ptr @_mi_abandoned_default, ptr %i.bd, align 8, !tbaa !186
  %i.be = getelementptr i8, ptr %.4.i, i64 4024
  store ptr %i.az, ptr %i.be, align 8, !tbaa !187
  %i.bf = getelementptr i8, ptr %.4.i, i64 3080
  store ptr %.4.i, ptr %i.bf, align 8, !tbaa !168
  ...
  store ptr %.4.i, ptr %i.a, align 8, !tbaa !95
  %i.bg = load i32, ptr @_mi_heap_default_key, align 4, !tbaa !54 ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %i.l, label %mi_atomic_maxi64_relaxed.exit.i, label %bb.d, !llvm.loop !10
...
bb.h:                                             ; preds = %bb.b
  %i.r = load i64, ptr %i.e, align 8, !tbaa !144
  %i.s = add i64 %i.r, %1                         ; 3 uses
  store i64 %i.s, ptr %i.e, align 8, !tbaa !144
  %i.t = getelementptr i8, ptr %0, i64 16         ; 2 uses
  %i.u = load i64, ptr %i.t, align 8, !tbaa !145
  %i.v = icmp sgt i64 %i.s, %i.u
  br i1 %i.v, label %bb.i, label %bb.j

bb.i:                                             ; preds = %bb.h
  store i64 %i.s, ptr %i.t, align 8, !tbaa !145
  br label %bb.j
...
bb.k:                                             ; preds = %bb.j
  %i.x = load i64, ptr %0, align 8, !tbaa !146
  %i.y = add i64 %i.x, %1
  store i64 %i.y, ptr %0, align 8, !tbaa !146
  br label %mi_stat_update.exit
...
bb.l:                                             ; preds = %bb.j
  ...
  %i.ab = sub i64 %i.aa, %1
  store i64 %i.ab, ptr %i.z, align 8, !tbaa !147
  br label %mi_stat_update.exit
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.k, label %_mi_stat_decrease.exit, label %bb.e, !llvm.loop !10
...
_mi_stat_decrease.exit:                           ; preds = %bb.e, %bb.f
  ...
  %i.o = load i64, ptr %i.n, align 8, !tbaa !167  ; 2 uses
  %i.p = tail call ptr asm "movq %fs:$1, $0", "=r,*m,~{dirflag},~{fpsr},~{flags}"(ptr elementtype(ptr) null) #60, !srcloc !99
  %i.q = ptrtoint ptr %i.p to i64
  %.not.not = icmp eq i64 %i.o, %i.q
  br i1 %.not.not, label %bb.g, label %_mi_heap_done.exit

bb.g:                                             ; preds = %_mi_stat_decrease.exit
  %i.r = load i64, ptr getelementptr inbounds nuw (i8, ptr @_mi_heap_main, i64 2848), align 8, !tbaa !167 ; 2 uses
...
bb.h:                                             ; preds = %_mi_is_main_thread.exit.thread.i, %_mi_is_main_thread.exit.i
  ...
  store ptr %i.u, ptr %i.v, align 8, !tbaa !95
  %i.w = load i32, ptr @_mi_heap_default_key, align 4, !tbaa !54 ; 2 uses
...
_mi_heap_set_default_direct.exit.i:               ; preds = %bb.i, %bb.h
  ...
  %i.aa = load ptr, ptr %i.z, align 8, !tbaa !168 ; 25 uses
...
.lr.ph.i:                                         ; preds = %bb.j, %bb.l
  %.024.i = phi ptr [ %i.af, %bb.l ], [ %i.ad, %bb.j ] ; 3 uses
  %i.ae = getelementptr i8, ptr %.024.i, i64 3048
  %i.af = load ptr, ptr %i.ae, align 8, !tbaa !178 ; 2 uses
  %.not19.i = icmp eq ptr %.024.i, %i.aa
end_hunk_4
...
.thread:                                          ; preds = %bb.d, %bb.c, %.thread39, %bb.f
  %.227 = phi i1 [ false, %bb.f ], [ %.0.lcssa, %.thread39 ], [ false, %bb.d ], [ %i.e, %bb.c ]
  ret i1 %.227
}
...
bb.c:                                             ; preds = %bb.b
  %i.l = tail call noalias ptr @_mi_malloc_generic(ptr noundef nonnull %i.b, i64 noundef %1, i1 noundef zeroext false, i64 noundef 0), !inline_history !91
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = extractvalue { i64, i1 } %i.c, 1
  %i.e = extractvalue { i64, i1 } %i.c, 0
  br i1 %i.d, label %mi_calloc.exit, label %bb.c, !prof !61
...
bb.e:                                             ; preds = %bb.d
  %i.o = tail call noalias ptr @_mi_malloc_generic(ptr noundef nonnull %i.b, i64 noundef %storemerge.i.ph.i.i, i1 noundef zeroext true, i64 noundef 0), !inline_history !91
...
bb.d:                                             ; preds = %bb.c
  ...
  store ptr %1, ptr %i.w, align 8, !tbaa !98
  %i.z = getelementptr i8, ptr %i.s, i64 24       ; 2 uses
  %i.aa = load i32, ptr %i.z, align 8, !tbaa !62
  %i.ab = add i32 %i.aa, -1                       ; 2 uses
  store i32 %i.ab, ptr %i.z, align 8, !tbaa !62
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = load i32, ptr %i.d, align 4, !tbaa !594
...
bb.b:                                             ; preds = %bb.a
  %i.b = load i8, ptr %0, align 1, !tbaa !101
...
bb.h:                                             ; preds = %.backedge, %_mi_segment_huge_page_reset.exit
  ...
  br i1 %i.aq, label %bb.i, label %.thread, !prof !61
...
bb.l:                                             ; preds = %bb.l, %bb.k
  ...
  br i1 %i.bf, label %.loopexit, label %bb.l, !llvm.loop !632
...
bb.m:                                             ; preds = %bb.m, %.loopexit
  ...
  br i1 %i.bl, label %.thread55, label %bb.m, !llvm.loop !633
...
_mi_page_start.exit.i:                            ; preds = %bb.b
  ...
  %i.ae = sub i64 %i.ac, %i.ad                    ; 2 uses
  %i.af = icmp sgt i32 %i.b, -1
  br i1 %i.af, label %bb.d, label %_mi_segment_page_start.exit.i.i.i, !prof !97
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.k = load ptr, ptr %i.j, align 8, !tbaa !94   ; 4 uses
  %i.l = getelementptr i8, ptr %i.k, i64 16       ; 2 uses
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !60   ; 8 uses
  %i.n = icmp eq ptr %i.m, null
  br i1 %i.n, label %bb.d, label %bb.e, !prof !61

bb.d:                                             ; preds = %bb.c
  %i.o = tail call noalias ptr @_mi_malloc_generic(ptr noundef nonnull %0, i64 noundef %1, i1 noundef zeroext %4, i64 noundef 0), !inline_history !91
  br label %_mi_heap_malloc_zero.exit
...
bb.e:                                             ; preds = %bb.c
  ...
  %i.t = inttoptr i64 %i.s to ptr
  store ptr %i.t, ptr %i.l, align 8, !tbaa !60
  br i1 %4, label %bb.f, label %_mi_heap_malloc_zero.exit, !prof !61
...
bb.i:                                             ; preds = %bb.b
  ...
  br i1 %i.aa, label %bb.j, label %bb.k, !prof !61

.thread:                                          ; preds = %bb.a
  %i.ab = icmp ugt i64 %2, 16777216
  br i1 %i.ab, label %_mi_heap_malloc_zero.exit, label %bb.k, !prof !61
...
bb.k:                                             ; preds = %.thread, %bb.i
  ...
  br i1 %i.ah, label %bb.l, label %_mi_heap_malloc_zero.exit63, !prof !96
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.am = load ptr, ptr %i.al, align 8, !tbaa !94 ; 4 uses
  %i.an = getelementptr i8, ptr %i.am, i64 16     ; 2 uses
  %i.ao = load ptr, ptr %i.an, align 8, !tbaa !60 ; 8 uses
  %i.ap = icmp eq ptr %i.ao, null
  br i1 %i.ap, label %_mi_heap_malloc_zero.exit63, label %bb.m, !prof !61

bb.m:                                             ; preds = %bb.l
  %i.aq = getelementptr i8, ptr %i.am, i64 24     ; 2 uses
  %i.ar = load i32, ptr %i.aq, align 8, !tbaa !62
  %i.as = add i32 %i.ar, 1
  store i32 %i.as, ptr %i.aq, align 8, !tbaa !62
  %i.at = load atomic i64, ptr %i.ao monotonic, align 8
  %i.au = inttoptr i64 %i.at to ptr
  store ptr %i.au, ptr %i.an, align 8, !tbaa !60
  br i1 %4, label %bb.n, label %_mi_heap_malloc_zero.exit63.thread, !prof !61
...
bb.o:                                             ; preds = %bb.n
  store atomic i64 0, ptr %i.ao seq_cst, align 8, !tbaa !64
...
bb.q:                                             ; preds = %_mi_heap_malloc_zero.exit63.thread
  ...
  %i.bt = load i32, ptr %i.bs, align 4, !tbaa !100
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !100
  ...
  br i1 %.not.i.i, label %bb.u, label %bb.w, !prof !96

bb.u:                                             ; preds = %bb.t
  %i.cp = getelementptr i8, ptr %i.cm, i64 28
  %i.cq = load i32, ptr %i.cp, align 4, !tbaa !65 ; 2 uses
  %i.cr = icmp sgt i32 %i.cq, -1
  br i1 %i.cr, label %bb.v, label %_mi_segment_page_start.exit.i.i.i.i.i, !prof !96
...
_mi_segment_page_start.exit.i.i.i.i.i:            ; preds = %bb.u
  %i.ct = load i32, ptr %i.cm, align 8, !tbaa !93
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.h = load i64, ptr %i.a, align 8, !tbaa !128  ; 2 uses
  %i.i = lshr i64 %i.h, 6
  store atomic i64 %i.i, ptr %i.g monotonic, align 8
  %i.j = getelementptr i8, ptr %0, i64 32
  %i.k = load atomic ptr, ptr %i.j seq_cst, align 8, !tbaa !126
  %i.l = shl i64 %i.h, 25
  %i.m = getelementptr i8, ptr %i.k, i64 %i.l     ; 7 uses
  %i.n = load i32, ptr %0, align 8, !tbaa !138
  %i.o = getelementptr i8, ptr %0, i64 92
  %i.p = load i8, ptr %i.o, align 4, !tbaa !139, !range !86, !noundef !87
  %i.q = load i64, ptr %i.a, align 8, !tbaa !128  ; 9 uses
  ...
  store i32 6, ptr %.sroa.787.0..sroa_idx, align 4, !tbaa !54
  %i.r = getelementptr i8, ptr %0, i64 24
  %i.s = load i8, ptr %i.r, align 8, !tbaa !149, !range !86, !noundef !87
  %i.t = getelementptr i8, ptr %3, i64 16
  store i8 %i.s, ptr %i.t, align 8, !tbaa !161
  %i.u = getelementptr i8, ptr %0, i64 128
  %i.v = load ptr, ptr %i.u, align 8, !tbaa !155  ; 3 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %i.z, label %bb.d, label %mi_bitmap_mask_.exit24.i.i, !prof !96
...
mi_bitmap_mask_.exit24.i.i:                       ; preds = %bb.c
  ...
  %i.aj = sub nuw nsw i64 %1, %i.af               ; 3 uses
