...
begin_hunk_0_@mi_arenas_try_purge:bb.a
  %i.a = tail call zeroext i1 @_mi_preloading()
  br i1 %i.a, label %.critedge, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.b = load i32, ptr getelementptr inbounds nuw (i8, ptr @options, i64 488), align 8, !tbaa !111
  %i.c = icmp eq i32 %i.b, 0
  br i1 %i.c, label %bb.c, label %mi_option_get.exit.i, !prof !17
