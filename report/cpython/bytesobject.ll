...
.lr.ph106:                                        ; preds = %_PyUnicode_DATA.exit, %bb.t
  ...
  %.082104 = phi ptr [ %.183, %bb.t ], [ %i.x, %_PyUnicode_DATA.exit ] ; 14 uses
...
bb.r:                                             ; preds = %bb.q
  %4 = getelementptr i8, ptr %.082104, i64 1
  store i8 92, ptr %.082104, align 1, !tbaa !14
  %i.ai = getelementptr i8, ptr %.082104, i64 2
  store i8 120, ptr %4, align 1, !tbaa !14
...
bb.t:                                             ; preds = %bb.n, %bb.p, %bb.s, %bb.r, %bb.o, %bb.l
  %.pn = phi i64 [ 2, %bb.l ], [ 2, %bb.n ], [ 2, %bb.o ], [ 2, %bb.p ], [ 4, %bb.r ], [ 1, %bb.s ]
  %.183 = getelementptr i8, ptr %.082104, i64 %.pn ; 2 uses
