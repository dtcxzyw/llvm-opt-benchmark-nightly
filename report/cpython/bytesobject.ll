...
bb.ce:                                            ; preds = %bb.cd
  ...
  %i.iv = load i32, ptr %i.im, align 8, !tbaa !22 ; 3 uses
...
bb.cg:                                            ; preds = %bb.cf
  ...
  store i32 %i.iw, ptr %i.im, align 8, !tbaa !22
...
bb.ci:                                            ; preds = %bb.ch
  ...
  store i32 %i.iy, ptr %i.im, align 8, !tbaa !22
...
bb.ck:                                            ; preds = %Py_DECREF.exit68.i.i, %Py_INCREF.exit.i23.i
  ...
  store i64 %.1.i.i, ptr %i.jb, align 8, !tbaa !29
...
Py_DECREF.exit74.i.i:                             ; preds = %bb.bt, %Py_DECREF.exit74.sink.split.i.i, %bb.ck, %bb.cg, %bb.cf, %.thread.i.i, %fastsearch.exit.thread.thread.i.i, %bb.bx, %.split.us.i.i
  %i.je = load i32, ptr %i.fc, align 8, !tbaa !22 ; 2 uses
...
bb.cl:                                            ; preds = %Py_DECREF.exit74.i.i
  ...
  store i32 %i.jf, ptr %i.fc, align 8, !tbaa !22
...
.thread58:                                        ; preds = %Py_DECREF.exit.thread, %Py_DECREF.exit, %bb.e
  ...
  %.val.i = load i64, ptr %i.u, align 8, !tbaa !29 ; 8 uses
...
bb.q:                                             ; preds = %bb.p
  %.val100.i.i = load ptr, ptr %i.ac, align 8, !tbaa !66
  %i.bg = getelementptr [8 x i8], ptr %.val100.i.i, i64 %.0116.i.i
  store ptr %i.bd, ptr %i.bg, align 8, !tbaa !21
...
bb.r:                                             ; preds = %bb.p
  ...
  %i.bi = load i32, ptr %i.bd, align 8, !tbaa !22 ; 3 uses
...
bb.t:                                             ; preds = %bb.s
  ...
  store i32 %i.bj, ptr %i.bd, align 8, !tbaa !22
...
bb.v:                                             ; preds = %bb.u
  ...
  store i32 %i.bl, ptr %i.bd, align 8, !tbaa !22
...
bb.aa:                                            ; preds = %bb.z
  ...
  %.val99.i.i = load ptr, ptr %i.cc, align 8, !tbaa !66
  %i.cd = getelementptr [8 x i8], ptr %.val99.i.i, i64 %spec.store.select.i69
  store ptr %i.bz, ptr %i.cd, align 8, !tbaa !21
...
bb.ab:                                            ; preds = %bb.z
  ...
  %i.cf = load i32, ptr %i.bz, align 8, !tbaa !22 ; 3 uses
...
bb.ad:                                            ; preds = %bb.ac
  ...
  store i32 %i.cg, ptr %i.bz, align 8, !tbaa !22
...
bb.af:                                            ; preds = %bb.ae
  ...
  store i32 %i.ci, ptr %i.bz, align 8, !tbaa !22
...
.loopexit.thread.i.i:                             ; preds = %.critedge.i.i, %bb.k, %bb.x, %Py_DECREF.exit88.i.i, %.loopexit.i.i, %Py_INCREF.exit.i.i
  ...
  store i64 %.2.i.i, ptr %i.cl, align 8, !tbaa !29
...
Py_DECREF.exit94.i.i:                             ; preds = %bb.o, %Py_DECREF.exit94.sink.split.i.i, %bb.ad, %bb.ac, %bb.y, %bb.t, %bb.s
  %i.cm = load i32, ptr %i.z, align 8, !tbaa !22  ; 2 uses
...
bb.ah:                                            ; preds = %Py_DECREF.exit94.i.i
  ...
  store i32 %i.cn, ptr %i.z, align 8, !tbaa !22
...
bb.ak:                                            ; preds = %bb.aj
  %i.cq = load ptr, ptr %4, align 8, !tbaa !71    ; 2 uses
  %i.cr = getelementptr inbounds nuw i8, ptr %4, i64 16
  %i.cs = load i64, ptr %i.cr, align 8, !tbaa !69 ; 3 uses
...
bb.al:                                            ; preds = %bb.ak
  %i.ct = load ptr, ptr @PyExc_ValueError, align 8, !tbaa !21
...
bb.am:                                            ; preds = %bb.ak
  %i.cu = load i8, ptr %i.cq, align 1, !tbaa !22
...
.lr.ph.i.i.i:                                     ; preds = %.preheader.i.i.i, %bb.ax
  ...
  %i.de = load i8, ptr %i.dd, align 1, !tbaa !22
...
bb.aq:                                            ; preds = %bb.ap
  %.val82.i.i.i = load ptr, ptr %i.da, align 8, !tbaa !66
  %i.dl = getelementptr [8 x i8], ptr %.val82.i.i.i, i64 %.094.i.i.i250
  store ptr %i.di, ptr %i.dl, align 8, !tbaa !21
...
bb.ar:                                            ; preds = %bb.ap
  ...
  %i.dn = load i32, ptr %i.di, align 8, !tbaa !22 ; 3 uses
...
bb.at:                                            ; preds = %bb.as
  ...
  store i32 %i.do, ptr %i.di, align 8, !tbaa !22
...
bb.av:                                            ; preds = %bb.au
  ...
  store i32 %i.dq, ptr %i.di, align 8, !tbaa !22
...
bb.bd:                                            ; preds = %bb.bc
  ...
  %.val80.i.i.i = load ptr, ptr %i.eh, align 8, !tbaa !66
  %i.ei = getelementptr [8 x i8], ptr %.val80.i.i.i, i64 %.0.lcssa121.i.i.i
  store ptr %i.ee, ptr %i.ei, align 8, !tbaa !21
...
bb.be:                                            ; preds = %bb.bc
  ...
  %i.ek = load i32, ptr %i.ee, align 8, !tbaa !22 ; 3 uses
