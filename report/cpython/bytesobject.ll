...
.lr.ph1244:                                       ; preds = %.lr.ph1244.preheader, %bb.cl
  ...
  %.03721242.a = phi i32 [ %i.ig, %bb.cl ], [ %.4368696704, %.lr.ph1244.preheader ]
  %.03721242 = add i32 %.03721242.a, -48          ; 3 uses
...
bb.cj:                                            ; preds = %.lr.ph1244
  ...
  %i.hy = icmp sgt i32 %.03721242, %i.hx
...
bb.cl:                                            ; preds = %bb.cj
  %i.if = mul i32 %.03721242, 10
  %i.ig = add i32 %i.if, %i.hr
...
begin_hunk_4_@_PyBytes_FormatEx:bb.a
  ...
  %.1373721 = phi i32 [ %.1373, %.thread684 ], [ 0, %bb.ch ], [ -1, %bb.bg ], [ %spec.store.select, %bb.cg ], [ %.03721242, %.lr.ph1244 ] ; 9 uses
...
bb.d:                                             ; preds = %._crit_edge141.us
  %i.au = add i64 %.0104146.us, %.0139.us
...
bb.e:                                             ; preds = %.split.us.i.i
  %i.m = add i64 %.02941.us.i.i, %.03339.us.i.i
...
bb.g:                                             ; preds = %.split.i.i
  %i.y = add i64 %.02941.i.i, %.03339.i.i
...
begin_hunk_9_@bytes_rsplit:bb.a
  ...
  %5 = sub i64 %.168117.i.i, %.269.in.i.i271
  %6 = add i64 %5, 1
