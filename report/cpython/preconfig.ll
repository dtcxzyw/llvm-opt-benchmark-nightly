...
begin_hunk_0_@_PyPreCmdline_Read:bb.a
bb.k:                                             ; preds = %bb.h
  %i.t = load ptr, ptr @_PyOS_optarg, align 8, !tbaa !30, !noalias !52
  call void @PyWideStringList_Append(ptr dead_on_unwind writable sret(%struct.PyStatus) align 8 %0, ptr noundef %i.n, ptr noundef %i.t) #13
  %i.u = load i32, ptr %0, align 8, !tbaa !23
  %.not.i24 = icmp eq i32 %i.u, 0
  br i1 %.not.i24, label %bb.l, label %precmdline_parse_cmdline.exit

bb.l:                                             ; preds = %bb.k, %bb.j, %bb.i, %bb.h
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #13, !noalias !52
  br label %bb.h

precmdline_parse_cmdline.exit.thread:             ; preds = %bb.h, %bb.h, %bb.h
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #13, !noalias !52
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %0, i8 0, i64 32, i1 false), !alias.scope !52
  br label %bb.m

precmdline_parse_cmdline.exit:                    ; preds = %bb.k
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #13, !noalias !52
  br label %bb.ai

bb.m:                                             ; preds = %precmdline_parse_cmdline.exit.thread, %precmdline_get_preconfig.exit
  %i.v = getelementptr i8, ptr %1, i64 32         ; 2 uses
  %i.w = load i32, ptr %i.v, align 8, !tbaa !47   ; 2 uses
  %i.x = icmp slt i32 %i.w, 0
  br i1 %i.x, label %.thread, label %bb.n

.thread:                                          ; preds = %bb.m
  store i32 0, ptr %i.v, align 8, !tbaa !47
  br label %bb.p
...
bb.p:                                             ; preds = %.thread, %bb.o, %bb.n
  %i.z = getelementptr i8, ptr %1, i64 36         ; 2 uses
  %i.aa = load i32, ptr %i.z, align 4, !tbaa !49  ; 2 uses
  %i.ab = icmp slt i32 %i.aa, 0
  br i1 %i.ab, label %bb.q, label %bb.r

bb.q:                                             ; preds = %bb.p
  store i32 0, ptr %i.z, align 4, !tbaa !49
  br label %bb.r

bb.r:                                             ; preds = %bb.q, %bb.p
  %i.ac = phi i32 [ 0, %bb.q ], [ %i.aa, %bb.p ]  ; 2 uses
  %i.ad = getelementptr i8, ptr %1, i64 40        ; 2 uses
  %i.ae = load i32, ptr %i.ad, align 8, !tbaa !39
  %i.af = icmp slt i32 %i.ae, 0
  %i.ag = getelementptr i8, ptr %1, i64 16
  %i.ah = load i64, ptr %i.ag, align 8, !tbaa !32 ; 4 uses
  br i1 %i.af, label %bb.s, label %.thread42

bb.s:                                             ; preds = %bb.r
  %i.ai = icmp sgt i64 %i.ah, 0
  br i1 %i.ai, label %.lr.ph.i, label %_Py_get_xoption.exit.thread
...
bb.t:                                             ; preds = %bb.x, %.lr.ph.i
  %.01929.i = phi i64 [ 0, %.lr.ph.i ], [ %i.ax, %bb.x ] ; 2 uses
  %i.al = getelementptr [8 x i8], ptr %i.ak, i64 %.01929.i
  %i.am = load ptr, ptr %i.al, align 8, !tbaa !30 ; 5 uses
  %i.an = call ptr @wcschr(ptr noundef %i.am, i32 noundef 61) #14 ; 2 uses
  %.not.i25 = icmp eq ptr %i.an, null
...
bb.v:                                             ; preds = %bb.t
  %i.as = call i64 @wcslen(ptr noundef %i.am) #14
  br label %bb.w

bb.w:                                             ; preds = %bb.v, %bb.u
  %.018.i = phi i64 [ %i.ar, %bb.u ], [ %i.as, %bb.v ] ; 2 uses
  %i.at = call i32 @wcsncmp(ptr noundef %i.am, ptr noundef nonnull @.str.2, i64 noundef %.018.i) #14
  %i.au = icmp eq i32 %i.at, 0
  %i.av = and i64 %.018.i, 4611686018427387903
  %i.aw = icmp eq i64 %i.av, 3
  %or.cond = and i1 %i.au, %i.aw
  br i1 %or.cond, label %_Py_get_xoption.exit, label %bb.x

bb.x:                                             ; preds = %bb.w
  %i.ax = add nuw nsw i64 %.01929.i, 1            ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.ax, %i.ah
  br i1 %exitcond.not.i, label %_Py_get_xoption.exit.thread, label %bb.t, !llvm.loop !55

_Py_get_xoption.exit:                             ; preds = %bb.w
  %.not20 = icmp eq ptr %i.am, null
  br i1 %.not20, label %_Py_get_xoption.exit.thread, label %.thread42.sink.split

_Py_get_xoption.exit.thread:                      ; preds = %bb.x, %bb.s, %_Py_get_xoption.exit
  %.not.i26 = icmp eq i32 %i.ac, 0
  br i1 %.not.i26, label %bb.aa, label %bb.y

bb.y:                                             ; preds = %_Py_get_xoption.exit.thread
  %i.ay = call ptr @getenv(ptr noundef nonnull @.str.3) #13 ; 2 uses
  %.not6.i = icmp eq ptr %i.ay, null
  br i1 %.not6.i, label %bb.aa, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.az = load i8, ptr %i.ay, align 1, !tbaa !56
  %.not7.i = icmp eq i8 %i.az, 0
  br i1 %.not7.i, label %bb.aa, label %.thread42.sink.split

bb.aa:                                            ; preds = %_Py_get_xoption.exit.thread, %bb.z, %bb.y
  br label %.thread42.sink.split

.thread42.sink.split:                             ; preds = %_Py_get_xoption.exit, %bb.z, %bb.aa
  %.sink = phi i32 [ 0, %bb.aa ], [ 1, %bb.z ], [ 1, %_Py_get_xoption.exit ]
  store i32 %.sink, ptr %i.ad, align 8, !tbaa !39
  br label %.thread42

.thread42:                                        ; preds = %.thread42.sink.split, %bb.r
  %i.ba = icmp sgt i64 %i.ah, 0
  br i1 %i.ba, label %.lr.ph.i27, label %_Py_get_xoption.exit32.thread
...
bb.ab:                                            ; preds = %bb.af, %.lr.ph.i27
  %.01929.i28 = phi i64 [ 0, %.lr.ph.i27 ], [ %i.bp, %bb.af ] ; 2 uses
  %i.bd = getelementptr [8 x i8], ptr %i.bc, i64 %.01929.i28
  %i.be = load ptr, ptr %i.bd, align 8, !tbaa !30 ; 5 uses
  %i.bf = call ptr @wcschr(ptr noundef %i.be, i32 noundef 61) #14 ; 2 uses
  %.not.i29 = icmp eq ptr %i.bf, null
  br i1 %.not.i29, label %bb.ad, label %bb.ac
...
bb.ad:                                            ; preds = %bb.ab
  %i.bk = call i64 @wcslen(ptr noundef %i.be) #14
  br label %bb.ae

bb.ae:                                            ; preds = %bb.ad, %bb.ac
  %.018.i30 = phi i64 [ %i.bj, %bb.ac ], [ %i.bk, %bb.ad ] ; 2 uses
  %i.bl = call i32 @wcsncmp(ptr noundef %i.be, ptr noundef nonnull @.str.4, i64 noundef %.018.i30) #14
  %i.bm = icmp eq i32 %i.bl, 0
  %i.bn = and i64 %.018.i30, 4611686018427387903
  %i.bo = icmp eq i64 %i.bn, 21
  %or.cond49 = and i1 %i.bm, %i.bo
  br i1 %or.cond49, label %_Py_get_xoption.exit32, label %bb.af

bb.af:                                            ; preds = %bb.ae
  %i.bp = add nuw nsw i64 %.01929.i28, 1          ; 2 uses
  %exitcond.not.i31 = icmp eq i64 %i.bp, %i.ah
  br i1 %exitcond.not.i31, label %_Py_get_xoption.exit32.thread, label %bb.ab, !llvm.loop !55

_Py_get_xoption.exit32:                           ; preds = %bb.ae
  %.not22 = icmp eq ptr %i.be, null
  br i1 %.not22, label %_Py_get_xoption.exit32.thread, label %_Py_GetEnv.exit37

_Py_get_xoption.exit32.thread:                    ; preds = %bb.af, %.thread42, %_Py_get_xoption.exit32
  %.not.i33 = icmp eq i32 %i.ac, 0
  br i1 %.not.i33, label %_Py_GetEnv.exit37.thread, label %bb.ag

bb.ag:                                            ; preds = %_Py_get_xoption.exit32.thread
  %i.bq = call ptr @getenv(ptr noundef nonnull @.str.5) #13 ; 2 uses
  %.not6.i34 = icmp eq ptr %i.bq, null
  br i1 %.not6.i34, label %_Py_GetEnv.exit37.thread, label %bb.ah

bb.ah:                                            ; preds = %bb.ag
  %i.br = load i8, ptr %i.bq, align 1, !tbaa !56
  %.not7.i35 = icmp eq i8 %i.br, 0
  br i1 %.not7.i35, label %_Py_GetEnv.exit37.thread, label %_Py_GetEnv.exit37

_Py_GetEnv.exit37:                                ; preds = %bb.ah, %_Py_get_xoption.exit32
  %i.bs = getelementptr i8, ptr %1, i64 44
  store i32 1, ptr %i.bs, align 4, !tbaa !43
  br label %_Py_GetEnv.exit37.thread

_Py_GetEnv.exit37.thread:                         ; preds = %bb.ag, %bb.ah, %_Py_get_xoption.exit32.thread, %_Py_GetEnv.exit37
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %0, i8 0, i64 32, i1 false)
  br label %bb.ai

bb.ai:                                            ; preds = %precmdline_parse_cmdline.exit, %_Py_GetEnv.exit37.thread
  ret void
}
...
bb.b:                                             ; preds = %.lr.ph, %bb.g
  %.01929 = phi i64 [ 0, %.lr.ph ], [ %i.r, %bb.g ] ; 2 uses
  %i.e = getelementptr [8 x i8], ptr %i.d, i64 %.01929
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !30   ; 5 uses
  %i.g = tail call ptr @wcschr(ptr noundef %i.f, i32 noundef 61) #14 ; 2 uses
...
bb.d:                                             ; preds = %bb.b
  %i.l = tail call i64 @wcslen(ptr noundef %i.f) #14
  br label %bb.e

bb.e:                                             ; preds = %bb.d, %bb.c
  %.018 = phi i64 [ %i.k, %bb.c ], [ %i.l, %bb.d ] ; 2 uses
  %i.m = tail call i32 @wcsncmp(ptr noundef %i.f, ptr noundef %1, i64 noundef %.018) #14
  %i.n = icmp eq i32 %i.m, 0
  br i1 %i.n, label %bb.f, label %bb.g

bb.f:                                             ; preds = %bb.e
  %i.o = getelementptr [4 x i8], ptr %1, i64 %.018
  %i.p = load i32, ptr %i.o, align 4, !tbaa !7
  %i.q = icmp eq i32 %i.p, 0
  br i1 %i.q, label %._crit_edge, label %bb.g

bb.g:                                             ; preds = %bb.e, %bb.f
  %i.r = add nuw nsw i64 %.01929, 1               ; 2 uses
  %exitcond.not = icmp eq i64 %i.r, %i.a
  br i1 %exitcond.not, label %._crit_edge, label %bb.b, !llvm.loop !55

._crit_edge:                                      ; preds = %bb.f, %bb.g, %bb.a
  %i.s = phi ptr [ null, %bb.a ], [ null, %bb.g ], [ %i.f, %bb.f ]
  ret ptr %i.s
}
...
bb.b:                                             ; preds = %bb.a
  %i.a = tail call ptr @getenv(ptr noundef %1) #13 ; 3 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c, %bb.a
  %.1 = phi ptr [ null, %bb.a ], [ null, %bb.d ], [ %i.a, %bb.c ]
  ret ptr %.1
}
...
bb.a:
  ...
  store <4 x i32> <i32 1, i32 0, i32 0, i32 1>, ptr %i.a, align 4, !tbaa !7
...
preconfig_read.exit:                              ; preds = %bb.at, %.thread13.i.i, %bb.ap
  ...
  %i.ei = icmp ne i32 %.0104170, 0
  %or.cond = select i1 %i.eh, i1 true, i1 %i.ei   ; 3 uses
  br i1 %or.cond, label %bb.aw, label %bb.av

bb.av:                                            ; preds = %preconfig_read.exit
  %i.ej = call i32 @_Py_CoerceLegacyLocale(i32 noundef 0) #13 ; 0 uses
  br label %bb.aw

bb.aw:                                            ; preds = %bb.av, %preconfig_read.exit
  %.1105 = phi i32 [ %.0104170, %preconfig_read.exit ], [ 1, %bb.av ]
  %i.ek = icmp eq i32 %i.bk, -1
  %i.el = load i32, ptr %i.ao, align 4, !tbaa !66 ; 4 uses
  br i1 %i.ek, label %bb.ax, label %bb.ay

bb.ax:                                            ; preds = %bb.aw
  %i.em = icmp ne i32 %i.el, 1
  %or.cond165 = and i1 %or.cond, %i.em
  br i1 %or.cond165, label %.thread146, label %.thread

bb.ay:                                            ; preds = %bb.aw
  %.not116 = icmp eq i32 %i.el, %i.bk
  %or.cond164 = and i1 %or.cond, %.not116
  br i1 %or.cond164, label %.thread146, label %.thread

.thread:                                          ; preds = %bb.ax, %bb.ay
  %i.en = load i32, ptr %i.al, align 4, !tbaa !64 ; 2 uses
  ...
  store i32 %i.el, ptr %i.ao, align 4, !tbaa !66
  store i32 %i.en, ptr %i.al, align 4, !tbaa !64
...
.thread146:                                       ; preds = %bb.ax, %bb.ay, %bb.ao, %_Py_GetEnv.exit.tail.i23.i, %.tail.i.i, %bb.r, %bb.am, %bb.q, %.thread, %bb.au
  %i.eo = phi <2 x i32> [ <i32 1, i32 0>, %bb.au ], [ zeroinitializer, %bb.ay ], [ <i32 1, i32 0>, %bb.am ], [ %i.bq, %bb.r ], [ <i32 1, i32 0>, %.tail.i.i ], [ <i32 1, i32 0>, %_Py_GetEnv.exit.tail.i23.i ], [ <i32 1, i32 0>, %bb.ao ], [ <i32 1, i32 0>, %.thread ], [ %i.bn, %bb.q ], [ zeroinitializer, %bb.ax ]
  %i.ep = phi <2 x i32> [ zeroinitializer, %bb.au ], [ zeroinitializer, %bb.ay ], [ zeroinitializer, %bb.am ], [ %i.bs, %bb.r ], [ zeroinitializer, %.tail.i.i ], [ zeroinitializer, %_Py_GetEnv.exit.tail.i23.i ], [ zeroinitializer, %bb.ao ], [ zeroinitializer, %.thread ], [ %i.bp, %bb.q ], [ zeroinitializer, %bb.ax ]
  %i.eq = phi <2 x ptr> [ <ptr @__func__.preconfig_init_allocator, ptr @.str.30>, %bb.au ], [ splat (ptr null), %bb.ay ], [ <ptr @__func__.preconfig_init_utf8_mode, ptr @.str.25>, %bb.am ], [ %i.br, %bb.r ], [ <ptr @__func__.preconfig_init_utf8_mode, ptr @.str.28>, %.tail.i.i ], [ <ptr @__func__.preconfig_init_utf8_mode, ptr @.str.28>, %_Py_GetEnv.exit.tail.i23.i ], [ <ptr @__func__.preconfig_init_utf8_mode, ptr @.str.28>, %bb.ao ], [ <ptr @__func__._PyPreConfig_Read, ptr @.str.17>, %.thread ], [ %i.bo, %bb.q ], [ splat (ptr null), %bb.ax ]
  %i.er = call ptr @setlocale(i32 noundef 0, ptr noundef nonnull %i.y) #13 ; 0 uses
  ...
  store <2 x i32> %i.eo, ptr %0, align 8
  %.sroa.17.0..sroa_idx48 = getelementptr inbounds nuw i8, ptr %0, i64 8
  store <2 x ptr> %i.eq, ptr %.sroa.17.0..sroa_idx48, align 8, !tbaa !11
  %.sroa.19.0..sroa_idx72 = getelementptr inbounds nuw i8, ptr %0, i64 24
  store <2 x i32> %i.ep, ptr %.sroa.19.0..sroa_idx72, align 8
