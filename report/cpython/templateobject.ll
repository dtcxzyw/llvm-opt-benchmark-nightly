begin_hunk_0_@_PyTemplate_Concat:bb.a
  ...
  %i.o = tail call ptr @PyUnicode_Concat(ptr noundef %i.k, ptr noundef %i.n) #3 ; 5 uses
  %i.p = icmp eq ptr %i.o, null
  br i1 %i.p, label %template_concat_templates.exit, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.q = add i64 %.val.i.i, %i.i
  %i.r = tail call ptr @PyTuple_New(i64 noundef %i.q) #3 ; 12 uses
...
begin_hunk_1_@_PyTemplate_Concat:bb.a
  ...
  br i1 %niter.ncmp.1, label %._crit_edge.i.i.loopexit.unr-lcssa, label %bb.h, !llvm.loop !38
...
begin_hunk_2_@_PyTemplate_Concat:bb.a
  ...
  br i1 %niter29.ncmp.1, label %template_strings_concat.exit.i.loopexit.unr-lcssa, label %.lr.ph43.i.i, !llvm.loop !40
...
template_strings_concat.exit.i:                   ; preds = %_Py_NewRef.exit37.i.i.epil, %template_strings_concat.exit.i.loopexit.unr-lcssa, %._crit_edge.i.i
  ...
  %i.by = tail call ptr @PySequence_Concat(ptr noundef %i.bv, ptr noundef %i.bx) #3 ; 7 uses
...
bb.p:                                             ; preds = %template_strings_concat.exit.i
  %i.cd = tail call ptr @_PyObject_GC_New(ptr noundef nonnull @_PyTemplate_Type) #3 ; 7 uses
...
_Py_NewRef.exit9.i.i:                             ; preds = %bb.s, %_Py_NewRef.exit.i21.i
  ...
  store ptr %i.by, ptr %i.cm, align 8, !tbaa !41
  tail call void @PyObject_GC_Track(ptr noundef nonnull %i.cd) #3
...
bb.u:                                             ; preds = %bb.t
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.r) #3
...
Py_DECREF.exit18.sink.split.i:                    ; preds = %bb.v, %bb.o, %bb.f
  ...
  tail call void @_Py_Dealloc(ptr noundef nonnull %.sink.i) #3
...
begin_hunk_11_@template_new:bb.a
  ...
  %.val143 = load i64, ptr %i.g, align 8, !tbaa !42
...
begin_hunk_12_@template_new:bb.a
  ...
  br i1 %exitcond.not, label %._crit_edge.loopexit, label %bb.d, !llvm.loop !43
...
begin_hunk_13_@template_new:bb.a
  ...
  %.val142 = load i64, ptr %i.aa, align 8, !tbaa !42
...
begin_hunk_14_@template_new:bb.a
  ...
  br i1 %exitcond196.not, label %._crit_edge192, label %bb.l, !llvm.loop !44
...
.thread157.thread:                                ; preds = %bb.ac, %bb.ab
  ...
  br i1 %exitcond196.not218, label %._crit_edge192.thread, label %.outer, !llvm.loop !44
...
bb.ad:                                            ; preds = %._crit_edge192.thread, %._crit_edge192
  %i.bf = tail call ptr @_PyObject_GC_New(ptr noundef nonnull @_PyTemplate_Type) #3 ; 7 uses
...
_Py_NewRef.exit9.i:                               ; preds = %bb.ag, %_Py_NewRef.exit.i
  ...
  store ptr %i.p, ptr %i.bo, align 8, !tbaa !41
  tail call void @PyObject_GC_Track(ptr noundef nonnull %i.bf) #3
...
_Py_NewRef.exit9:                                 ; preds = %_Py_NewRef.exit, %bb.d
  ...
  store ptr %1, ptr %i.j, align 8, !tbaa !41
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.h = load ptr, ptr %i.a, align 8, !tbaa !41
...
begin_hunk_21_@template_values_get:bb.a
  ...
  br i1 %exitcond.not, label %.loopexit, label %bb.b, !llvm.loop !45
