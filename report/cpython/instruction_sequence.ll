...
bb.a:
  %i.a = tail call ptr @_PyObject_GC_New(ptr noundef nonnull @_PyInstructionSequence_Type) #8 ; 7 uses
...
begin_hunk_1_@_PyInstructionSequence_New:bb.a
  ...
  tail call void @PyObject_GC_Track(ptr noundef nonnull %i.a) #8
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_PyInstructionSequence_Type, i64 296), align 8, !tbaa !49 ; 2 uses
...
.thread21..thread20_crit_edge:                    ; preds = %.thread21
  ...
  %.pre24 = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_PyInstructionSequence_Type, i64 296), align 8, !tbaa !49
  br label %.thread20
...
bb.f:                                             ; preds = %bb.e, %.thread, %.thread20
  %i.n = tail call ptr @_PyObject_GC_New(ptr noundef nonnull @_PyInstructionSequence_Type) #8 ; 7 uses
...
begin_hunk_6_@inst_seq_new:bb.a
  ...
  tail call void @PyObject_GC_Track(ptr noundef nonnull %i.n) #8
...
.thread:                                          ; preds = %bb.a, %bb.b
  ...
  %.val5.i = load ptr, ptr %i.h, align 8, !tbaa !57 ; 2 uses
  %.not.i = icmp eq ptr %.val5.i, @_PyInstructionSequence_Type
  br i1 %.not.i, label %bb.d, label %bb.c

bb.c:                                             ; preds = %.thread
  %i.i = load ptr, ptr @PyExc_TypeError, align 8, !tbaa !48
  %i.j = call ptr (ptr, ptr, ...) @PyErr_Format(ptr noundef %i.i, ptr noundef nonnull @.str.16, ptr noundef %.val5.i) #8 ; 0 uses
...
bb.e:                                             ; preds = %bb.d
  %i.n = call ptr @PyList_New(i64 noundef 0) #8   ; 3 uses
...
_PyInstructionSequence_AddNested.exit.i:          ; preds = %bb.e, %bb.d
  ...
  %i.q = call i32 @PyList_Append(ptr noundef nonnull %i.p, ptr noundef nonnull %i.g) #8
  %.fr.i = freeze i32 %i.q
...
begin_hunk_16_@InstructionSequenceType_get_instructions:bb.a
  ...
  br i1 %i.al, label %bb.h, label %InstructionSequenceType_get_instructions_impl.exit, !llvm.loop !58
...
!48 = !{!17, !17, i64 0}
!49 = !{!50, !15, i64 296}
!50 = !{!"_typeobject", !51, i64 0, !52, i64 24, !23, i64 32, !23, i64 40, !15, i64 48, !23, i64 56, !15, i64 64, !15, i64 72, !15, i64 80, !15, i64 88, !15, i64 96, !15, i64 104, !15, i64 112, !15, i64 120, !15, i64 128, !15, i64 136, !15, i64 144, !15, i64 152, !15, i64 160, !23, i64 168, !52, i64 176, !15, i64 184, !15, i64 192, !15, i64 200, !23, i64 208, !15, i64 216, !15, i64 224, !53, i64 232, !54, i64 240, !55, i64 248, !14, i64 256, !17, i64 264, !15, i64 272, !15, i64 280, !23, i64 288, !15, i64 296, !15, i64 304, !15, i64 312, !15, i64 320, !15, i64 328, !17, i64 336, !17, i64 344, !17, i64 352, !15, i64 360, !17, i64 368, !15, i64 376, !8, i64 384, !15, i64 392, !15, i64 400, !9, i64 408, !56, i64 410}
!51 = !{!"PyVarObject", !13, i64 0, !23, i64 16}
!52 = !{!"p1 omnipotent char", !15, i64 0}
!53 = !{!"p1 _ZTS11PyMethodDef", !15, i64 0}
!54 = !{!"p1 _ZTS11PyMemberDef", !15, i64 0}
!55 = !{!"p1 _ZTS11PyGetSetDef", !15, i64 0}
!56 = !{!"short", !9, i64 0}
!57 = !{!13, !14, i64 8}
!58 = distinct !{!58, !29}
end_hunk_17
