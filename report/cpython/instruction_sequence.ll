Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/cpython/original/instruction_sequence?download=true
...
.preheader:                                       ; preds = %instr_sequence_next_inst.exit
  %.02532 = add i32 %i.q, -1                      ; 2 uses
  %.not33 = icmp slt i32 %.02532, %1
...
.lr.ph:                                           ; preds = %.preheader, %.lr.ph
  %.02535 = phi i32 [ %.025, %.lr.ph ], [ %.02532, %.preheader ] ; 3 uses
  %.025.in34 = phi i32 [ %.02535, %.lr.ph ], [ %i.q, %.preheader ]
  %i.ad = load ptr, ptr %i.a, align 8, !tbaa !30  ; 2 uses
  %i.ae = sext i32 %.025.in34 to i64
  %i.af = getelementptr [44 x i8], ptr %i.ad, i64 %i.ae
  %i.ag = sext i32 %.02535 to i64
  ...
  %.025 = add i32 %.02535, -1                     ; 2 uses
  %.not = icmp slt i32 %.025, %1
...
.loopexit:                                        ; preds = %bb.d, %._crit_edge, %instr_sequence_next_inst.exit.thread, %instr_sequence_next_inst.exit
  %.026 = phi i32 [ -1, %instr_sequence_next_inst.exit ], [ -1, %instr_sequence_next_inst.exit.thread ], [ 0, %._crit_edge ], [ 0, %bb.d ]
  ret i32 %.026
}
...
bb.b:                                             ; preds = %bb.f, %.lr.ph.i.i
  ...
  %.fr27.i.i = freeze i32 %i.o
  %i.p = and i32 %.fr27.i.i, 8
...
bb.k:                                             ; preds = %bb.j, %bb.i
  %.0.i = phi ptr [ %i.aw, %bb.i ], [ %i.ax, %bb.j ] ; 5 uses
  %i.ay = icmp eq ptr %.0.i, null
...
bb.m:                                             ; preds = %bb.l
  ...
  store i32 %i.bb, ptr %.0.i, align 8, !tbaa !46
  %i.bc = icmp eq i32 %i.bb, 0
  br i1 %i.bc, label %bb.n, label %Py_DECREF.exit.i

bb.n:                                             ; preds = %bb.m
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i) #7
...
InstructionSequenceType_get_instructions_impl.exit: ; preds = %bb.g, %_PyInstructionSequence_ApplyLabelMap.exit.i, %.preheader.i, %bb.o, %bb.p, %bb.q
  %.027.i = phi ptr [ null, %bb.q ], [ null, %_PyInstructionSequence_ApplyLabelMap.exit.i ], [ null, %bb.o ], [ null, %bb.p ], [ %i.ad, %.preheader.i ], [ %i.ad, %bb.g ]
  ret ptr %.027.i
}
