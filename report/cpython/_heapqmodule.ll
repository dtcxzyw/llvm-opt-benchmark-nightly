...
_Py_NewRef.exit.i.i:                              ; preds = %bb.h, %bb.g
  ...
  %i.r = tail call i32 @siftup(ptr noundef nonnull readonly %i.b, i64 noundef 0) #2, !callees !32
...
_Py_NewRef.exit.i.i:                              ; preds = %bb.h, %bb.g
  %i.q = phi ptr [ %i.l, %bb.g ], [ %.pre.i.i, %bb.h ]
  store ptr %i.g, ptr %i.q, align 8, !tbaa !10
  %i.r = tail call i32 @siftup_max(ptr noundef nonnull readonly %i.b, i64 noundef 0) #2, !callees !32
  %.not.i.i = icmp eq i32 %i.r, 0
...
begin_hunk_2_@siftdown:bb.a
  ...
  br i1 %i.ae, label %.lr.ph, label %.loopexit, !llvm.loop !33
...
begin_hunk_3_@siftup:bb.a
  ...
  br i1 %i.al, label %.lr.ph, label %._crit_edge, !llvm.loop !35
...
begin_hunk_4_@heapify_internal:bb.a
  ...
  br i1 %i.g, label %.lr.ph.i.i, label %._crit_edge.loopexit.i.i, !llvm.loop !36
...
.preheader34.i:                                   ; preds = %._crit_edge.loopexit.i.i, %bb.d
  ...
  %i.m = tail call i32 %1(ptr noundef %0, i64 noundef %.02340.i) #2, !callees !32
...
bb.c:                                             ; preds = %.lr.ph.i
  ...
  %i.o = tail call i32 %1(ptr noundef %0, i64 noundef %i.n) #2, !callees !32
...
bb.d:                                             ; preds = %.lr.ph.i
  ...
  br i1 %.not.not.i, label %.preheader34.i, label %.preheader32.i, !llvm.loop !37

.loopexit31.i:                                    ; preds = %.lr.ph43.i
  %.1.i = add i64 %.146.i, -1                     ; 2 uses
  %.not26.i = icmp slt i64 %.1.i, %i.j
  br i1 %.not26.i, label %cache_friendly_heapify.exit, label %.preheader.i, !llvm.loop !38

.preheader.i:                                     ; preds = %.loopexit31.i, %.preheader.preheader.i
  %.146.i = phi i64 [ %.1.i, %.loopexit31.i ], [ %.144.i, %.preheader.preheader.i ] ; 3 uses
  %i.r = tail call i32 %1(ptr noundef %0, i64 noundef %.146.i) #2, !callees !32
...
bb.e:                                             ; preds = %.lr.ph43.i
  ...
  %i.t = tail call i32 %1(ptr noundef %0, i64 noundef %i.s) #2, !callees !32
...
bb.g:                                             ; preds = %.lr.ph
  ...
  br i1 %i.x, label %.lr.ph, label %cache_friendly_heapify.exit, !llvm.loop !39
...
.lr.ph:                                           ; preds = %bb.f, %bb.g
  ...
  br i1 %.not, label %bb.g, label %.cache_friendly_heapify.exit.loopexit37_crit_edge, !llvm.loop !39

.cache_friendly_heapify.exit.loopexit37_crit_edge: ; preds = %.lr.ph
  br label %cache_friendly_heapify.exit, !llvm.loop !39
...
begin_hunk_9_@siftdown_max:bb.a
  ...
  store ptr %i.ab, ptr %i.ac, align 8, !tbaa !10
  %i.ae = icmp sgt i64 %i.h, %1
  br i1 %i.ae, label %.lr.ph, label %.loopexit, !llvm.loop !40
...
begin_hunk_10_@siftup_max:bb.a
  ...
  store ptr %i.ai, ptr %i.aj, align 8, !tbaa !10
  %i.al = icmp slt i64 %.145, %i.d
  br i1 %i.al, label %.lr.ph, label %._crit_edge, !llvm.loop !41
