...
bb.z:                                             ; preds = %bb.x
  ...
  store ptr %i.bg, ptr %i.bj, align 8, !tbaa !142
  %i.bk = getelementptr inbounds nuw i8, ptr %4, i64 40
  store i64 %.lcssa, ptr %i.bk, align 8, !tbaa !143
  ...
  %i.bn = load i64, ptr %i.bm, align 8, !tbaa !201 ; 3 uses
...
.peel.next.i:                                     ; preds = %.peel.next.i.preheader, %bb.af
  ...
  %i.ch = load i64, ptr %i.cg, align 8, !tbaa !201 ; 5 uses
...
bb.ad:                                            ; preds = %cmsg_min_space.exit.i
  store i64 %i.cz, ptr %i.cs, align 8, !tbaa !47
...
bb.af:                                            ; preds = %bb.ae
  %i.dm = load i32, ptr %i.ce, align 8, !tbaa !202
  %i.dn = getelementptr i8, ptr %i.cs, i64 8
  store i32 %i.dm, ptr %i.dn, align 8, !tbaa !9
  %i.do = getelementptr i8, ptr %i.ce, i64 4
  %i.dp = load i32, ptr %i.do, align 4, !tbaa !203
  %i.dq = getelementptr i8, ptr %i.cs, i64 12
  store i32 %i.dp, ptr %i.dq, align 4, !tbaa !9
  %i.dr = load ptr, ptr %i.cf, align 8, !tbaa !204
  ...
  br i1 %exitcond197.not.i, label %.loopexit.i, label %.peel.next.i, !llvm.loop !197
...
.loopexit.i:                                      ; preds = %bb.af, %bb.ab, %._crit_edge
  ...
  store i32 %.017, ptr %i.dt, align 8, !tbaa !147
  %i.du = getelementptr i8, ptr %0, i64 40
  %i.dv = load i64, ptr %i.du, align 8, !tbaa !76
...
bb.ag:                                            ; preds = %.loopexit.i
  ...
  %i.dz = load i64, ptr %i.dy, align 8, !tbaa !148
...
.lr.ph.i:                                         ; preds = %.thread144.i, %.lr.ph.i
  ...
  br i1 %exitcond200.not.i, label %._crit_edge.i, label %.lr.ph.i, !llvm.loop !198
...
Py_XDECREF.exit.i:                                ; preds = %bb.aj, %bb.ai, %bb.ah, %._crit_edge.i
  ...
  %i.ei = load ptr, ptr %i.eh, align 8, !tbaa !149
  call void @PyMem_Free(ptr noundef %i.ei) #11
  %i.ej = load i64, ptr %i.a, align 8, !tbaa !47  ; 2 uses
  %i.ek = icmp sgt i64 %i.ej, 0
  %.pre.i = load ptr, ptr %i.b, align 8, !tbaa !137 ; 2 uses
...
.lr.ph183.i:                                      ; preds = %Py_XDECREF.exit.i, %.lr.ph183.i
  ...
  br i1 %exitcond201.not.i, label %._crit_edge184.i, label %.lr.ph183.i, !llvm.loop !199
...
bb.j:                                             ; preds = %bb.i, %bb.f
  ...
  %i.u = load ptr, ptr %3, align 8, !tbaa !34
...
bb.l:                                             ; preds = %bb.j
  ...
  store i64 %.1, ptr %i.af, align 8, !tbaa !143
  %i.ag = getelementptr inbounds nuw i8, ptr %4, i64 32 ; 2 uses
  store ptr %i.ac, ptr %i.ag, align 8, !tbaa !142
...
._crit_edge79:                                    ; preds = %bb.m
  %.pre = load i64, ptr %i.af, align 8, !tbaa !143
...
bb.p:                                             ; preds = %bb.n
  ...
  store i32 279, ptr %i.aq, align 8, !tbaa !9
  %i.ar = getelementptr i8, ptr %i.ak, i64 12
  store i32 3, ptr %i.ar, align 4, !tbaa !9
  store i64 20, ptr %i.ak, align 8, !tbaa !47
end_hunk_0
