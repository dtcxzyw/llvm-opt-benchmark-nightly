...
bb.l:                                             ; preds = %bb.k
  ...
  br label %Py_DECREF.exit255.thread330.i
...
_Py_asdl_stmt_seq_new.exit.i:                     ; preds = %bb.o
  ...
  %.pre396.i = load ptr, ptr %i.c, align 8, !tbaa !11 ; 3 uses
  br i1 %.not.not.i.i, label %._crit_edge385.i, label %.lr.ph384.i

.lr.ph384.i:                                      ; preds = %_Py_asdl_stmt_seq_new.exit.i
...
bb.q:                                             ; preds = %bb.w, %.lr.ph384.i
  %i.by = phi ptr [ %.pre396.i, %.lr.ph384.i ], [ %i.cq, %bb.w ]
  %.0172383.i = phi i64 [ 0, %.lr.ph384.i ], [ %i.cv, %bb.w ] ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d) #9
  %i.bz = getelementptr i8, ptr %i.by, i64 24
  %i.ca = load ptr, ptr %i.bz, align 8, !tbaa !111
  %i.cb = getelementptr [8 x i8], ptr %i.ca, i64 %.0172383.i
...
_Py_EnterRecursiveCall.exit.i:                    ; preds = %_Py_NewRef.exit.i
  ...
  %.not377.i = icmp eq i32 %i.cl, 0
  br i1 %.not377.i, label %_Py_EnterRecursiveCall.exit.thread.i, label %.thread.i
...
bb.w:                                             ; preds = %bb.u
  ...
  %i.cu = getelementptr [8 x i8], ptr %i.bt, i64 %.0172383.i
  store ptr %i.ct, ptr %i.cu, align 8, !tbaa !154
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #9
  %i.cv = add nuw nsw i64 %.0172383.i, 1          ; 2 uses
  %exitcond392.not.i = icmp eq i64 %i.cv, %.val285.i
  br i1 %exitcond392.not.i, label %._crit_edge385.thread.i, label %bb.q, !llvm.loop !156

._crit_edge385.i:                                 ; preds = %_Py_asdl_stmt_seq_new.exit.i
  %.not224.i = icmp eq ptr %.pre396.i, null
  br i1 %.not224.i, label %bb.z, label %._crit_edge385.thread.i

._crit_edge385.thread.i:                          ; preds = %bb.w, %._crit_edge385.i
  %i.cw = phi ptr [ %.pre396.i, %._crit_edge385.i ], [ %i.cq, %bb.w ] ; 3 uses
...
bb.x:                                             ; preds = %._crit_edge385.thread.i
...
bb.z:                                             ; preds = %bb.y, %bb.x, %._crit_edge385.thread.i, %._crit_edge385.i
...
bb.ae:                                            ; preds = %bb.ac
  ...
  br i1 %i.dr, label %Py_DECREF.exit255.thread330.i, label %.preheader.i

.preheader.i:                                     ; preds = %bb.ae
  %i.ds = icmp sgt i64 %.val283.i, 0
  %.pre397.i = load ptr, ptr %i.c, align 8, !tbaa !11 ; 3 uses
  br i1 %i.ds, label %.lr.ph387.i, label %._crit_edge388.i

.lr.ph387.i:                                      ; preds = %.preheader.i
...
bb.af:                                            ; preds = %bb.bi, %.lr.ph387.i
  %i.ea = phi ptr [ %.pre397.i, %.lr.ph387.i ], [ %i.go, %bb.bi ]
  %.0171386.i = phi i64 [ 0, %.lr.ph387.i ], [ %i.gs, %bb.bi ] ; 3 uses
  %i.eb = getelementptr i8, ptr %i.ea, i64 24
  %i.ec = load ptr, ptr %i.eb, align 8, !tbaa !111
  %i.ed = getelementptr [8 x i8], ptr %i.ec, i64 %.0171386.i
...
_Py_EnterRecursiveCall.exit289.i:                 ; preds = %_Py_NewRef.exit286.i
  ...
  %.not376.i = icmp eq i32 %i.en, 0
  br i1 %.not376.i, label %_Py_EnterRecursiveCall.exit289.thread.i, label %Py_DECREF.exit255.thread330.i
...
Py_DECREF.exit48.i.i:                             ; preds = %Py_DECREF.exit48.sink.split.i.i, %bb.az, %bb.ar, %bb.ai
  %.1310.i = phi ptr [ undef, %bb.ai ], [ undef, %Py_DECREF.exit48.sink.split.i.i ], [ undef, %bb.ar ], [ %i.gc, %bb.az ]
...
obj2ast_type_ignore.exit.i:                       ; preds = %bb.bd, %bb.bc, %bb.bb, %bb.ba, %.thread.i.i, %Py_DECREF.exit48.i.i, %bb.ah, %_Py_EnterRecursiveCall.exit289.thread.i
  %.2311.i = phi ptr [ undef, %.thread.i.i ], [ %.1310.i, %Py_DECREF.exit48.i.i ], [ null, %bb.ba ], [ null, %bb.bd ], [ null, %bb.bc ], [ null, %bb.bb ], [ undef, %bb.ah ], [ null, %_Py_EnterRecursiveCall.exit289.thread.i ]
  %.135.i.i = phi i1 [ false, %.thread.i.i ], [ %i.gf, %Py_DECREF.exit48.i.i ], [ false, %bb.ba ], [ false, %bb.bd ], [ false, %bb.bc ], [ false, %bb.bb ], [ false, %bb.ah ], [ true, %_Py_EnterRecursiveCall.exit289.thread.i ]
...
Py_DECREF.exit253.i:                              ; preds = %bb.bf, %bb.be, %obj2ast_type_ignore.exit.i
  br i1 %.135.i.i, label %bb.bg, label %Py_DECREF.exit255.thread330.i
...
bb.bi:                                            ; preds = %bb.bg
  %i.gr = getelementptr [8 x i8], ptr %i.dz, i64 %.0171386.i
  store ptr %.2311.i, ptr %i.gr, align 8, !tbaa !160
  %i.gs = add nuw nsw i64 %.0171386.i, 1          ; 2 uses
  %exitcond393.not.i = icmp eq i64 %i.gs, %.val283.i
  br i1 %exitcond393.not.i, label %._crit_edge388.thread.i, label %bb.af, !llvm.loop !162

._crit_edge388.i:                                 ; preds = %.preheader.i
  %.not229.i = icmp eq ptr %.pre397.i, null
  br i1 %.not229.i, label %bb.bl, label %._crit_edge388.thread.i

._crit_edge388.thread.i:                          ; preds = %bb.bi, %._crit_edge388.i
  %i.gt = phi ptr [ %.pre397.i, %._crit_edge388.i ], [ %i.go, %bb.bi ] ; 3 uses
  store ptr null, ptr %i.c, align 8, !tbaa !11
  %i.gu = load i32, ptr %i.gt, align 8, !tbaa !14 ; 2 uses
  %.not.i250.i = icmp sgt i32 %i.gu, -1
  br i1 %.not.i250.i, label %bb.bj, label %bb.bl

bb.bj:                                            ; preds = %._crit_edge388.thread.i
...
bb.bl:                                            ; preds = %bb.bk, %bb.bj, %._crit_edge388.thread.i, %._crit_edge388.i
  %i.gx = call ptr @_PyArena_Malloc(ptr noundef %1, i64 noundef 24) #9 ; 5 uses
  %.not.i292.i = icmp eq ptr %i.gx, null
  br i1 %.not.i292.i, label %Py_DECREF.exit255.thread330.i, label %_PyAST_Module.exit.i
...
bb.bs:                                            ; preds = %bb.bq
  ...
  %or.cond.i293.i = icmp ugt i64 %.val281.i, 2305843009213693952
  br i1 %or.cond.i293.i, label %bb.bt, label %bb.bu
...
bb.bu:                                            ; preds = %bb.bs
  %.not.not.i294.i = icmp eq i64 %.val281.i, 0    ; 2 uses
  %i.hu = shl i64 %.val281.i, 3
  %i.hv = add i64 %i.hu, -8
  %i.hw = select i1 %.not.not.i294.i, i64 0, i64 %i.hv ; 2 uses
...
bb.bw:                                            ; preds = %bb.bu
  ...
  %.not20.i295.i = icmp eq ptr %i.ia, null
  br i1 %.not20.i295.i, label %bb.bx, label %_Py_asdl_stmt_seq_new.exit297.i

bb.bx:                                            ; preds = %bb.bw
  %i.ib = call ptr @PyErr_NoMemory() #9           ; 0 uses
  br label %Py_DECREF.exit255.thread330.i

_Py_asdl_stmt_seq_new.exit297.i:                  ; preds = %bb.bw
  ...
  %.pre395.i = load ptr, ptr %i.c, align 8, !tbaa !11 ; 3 uses
  br i1 %.not.not.i294.i, label %._crit_edge382.i, label %.lr.ph381.i

.lr.ph381.i:                                      ; preds = %_Py_asdl_stmt_seq_new.exit297.i
...
bb.by:                                            ; preds = %bb.ce, %.lr.ph381.i
  %i.ih = phi ptr [ %.pre395.i, %.lr.ph381.i ], [ %i.iz, %bb.ce ]
  %.0169380.i = phi i64 [ 0, %.lr.ph381.i ], [ %i.je, %bb.ce ] ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e) #9
  %i.ii = getelementptr i8, ptr %i.ih, i64 24
  %i.ij = load ptr, ptr %i.ii, align 8, !tbaa !111
  %i.ik = getelementptr [8 x i8], ptr %i.ij, i64 %.0169380.i
  ...
  br i1 %i.in, label %_Py_NewRef.exit298.i, label %bb.bz

bb.bz:                                            ; preds = %bb.by
  %i.io = add nuw i32 %i.im, 1
  store i32 %i.io, ptr %i.il, align 8, !tbaa !14
  br label %_Py_NewRef.exit298.i

_Py_NewRef.exit298.i:                             ; preds = %bb.bz, %bb.by
  %i.ip = load ptr, ptr %i.ie, align 8, !tbaa !136 ; 2 uses
  %i.iq = getelementptr i8, ptr %i.ip, i64 952
  %.val.i.i299.i = load i64, ptr %i.iq, align 8, !tbaa !138 ; 2 uses
  %i.ir = icmp ule i64 %.val.i.i299.i, %i.ig
  %i.is = add i64 %.val.i.i299.i, -32768
  %i.it = icmp ugt i64 %i.is, %i.ig
  %narrow.i.not.i.i300.i = or i1 %i.ir, %i.it
  br i1 %narrow.i.not.i.i300.i, label %_Py_EnterRecursiveCall.exit301.thread.i, label %_Py_EnterRecursiveCall.exit301.i

_Py_EnterRecursiveCall.exit301.i:                 ; preds = %_Py_NewRef.exit298.i
  %i.iu = call i32 @_Py_CheckRecursiveCall(ptr noundef nonnull %i.ip, ptr noundef nonnull @.str.422) #9
  %.not375.i = icmp eq i32 %i.iu, 0
  br i1 %.not375.i, label %_Py_EnterRecursiveCall.exit301.thread.i, label %.thread337.i

_Py_EnterRecursiveCall.exit301.thread.i:          ; preds = %_Py_EnterRecursiveCall.exit301.i, %_Py_NewRef.exit298.i
...
._crit_edge:                                      ; preds = %Py_DECREF.exit150, %.preheader249
  %.093.lcssa = phi i32 [ 0, %.preheader249 ], [ %i.ah, %Py_DECREF.exit150 ] ; 2 uses
...
bb.p:                                             ; preds = %.lr.ph268, %bb.o
  %.091266 = phi ptr [ null, %.lr.ph268 ], [ %.2, %bb.o ] ; 6 uses
...
bb.u:                                             ; preds = %bb.t, %bb.s
  %.192 = phi ptr [ %i.bh, %bb.t ], [ %.091266, %bb.s ] ; 5 uses
  %i.bj = load ptr, ptr %i.b, align 8, !tbaa !11
  %i.bk = call i32 @PySequence_Contains(ptr noundef nonnull %.192, ptr noundef %i.bj) #9 ; 2 uses
...
bb.w:                                             ; preds = %bb.u, %bb.v, %bb.q
  %.2 = phi ptr [ %.091266, %bb.q ], [ %.192, %bb.v ], [ %.192, %bb.u ] ; 3 uses
...
.loopexit:                                        ; preds = %bb.o, %bb.n, %._crit_edge
  %.6 = phi i32 [ %.093.lcssa, %._crit_edge ], [ %.093.lcssa, %bb.n ], [ %i.bt, %bb.o ] ; 3 uses
  %.4 = phi ptr [ null, %._crit_edge ], [ null, %bb.n ], [ %.2, %bb.o ] ; 7 uses
...
bb.aa:                                            ; preds = %.lr.ph273, %.thread203
  %.0272 = phi i64 [ 0, %.lr.ph273 ], [ %i.dh, %.thread203 ] ; 2 uses
  %.7271 = phi i32 [ %.6, %.lr.ph273 ], [ %.10207, %.thread203 ] ; 3 uses
  %i.cf = load ptr, ptr %i.cc, align 8, !tbaa !111
  %i.cg = getelementptr [8 x i8], ptr %i.cf, i64 %.0272
...
.thread203:                                       ; preds = %bb.ad, %bb.al, %bb.am, %bb.aj, %bb.ac
  ...
  %i.dh = add nuw nsw i64 %.0272, 1               ; 2 uses
...
Py_DECREF.exit:                                   ; preds = %bb.w, %bb.q, %bb.p, %bb.r, %bb.as, %bb.ar, %Py_DECREF.exit144, %bb.x, %.loopexit, %bb.y, %.split106
  %.12 = phi i32 [ -1, %bb.x ], [ -1, %.split106 ], [ %.10207, %Py_DECREF.exit144 ], [ %.10207, %bb.ar ], [ %.10207, %bb.as ], [ %.6, %bb.y ], [ %.6, %.loopexit ], [ -1, %bb.r ], [ %i.az, %bb.q ], [ %i.ax, %bb.p ], [ %i.bt, %bb.w ] ; 2 uses
  %.5 = phi ptr [ %.4, %bb.x ], [ %.4, %.split106 ], [ %.4, %Py_DECREF.exit144 ], [ %.4, %bb.ar ], [ %.4, %bb.as ], [ %.4, %bb.y ], [ %.4, %.loopexit ], [ %.091266, %bb.r ], [ %.091266, %bb.q ], [ %.091266, %bb.p ], [ %.2, %bb.w ] ; 2 uses
...
Py_DECREF.exit.thread222:                         ; preds = %bb.u, %bb.v, %Py_DECREF.exit
  %.5228 = phi ptr [ %.5, %Py_DECREF.exit ], [ %.192, %bb.v ], [ %.192, %bb.u ] ; 3 uses
  %.12227 = phi i32 [ %.12, %Py_DECREF.exit ], [ %i.bk, %bb.u ], [ -1, %bb.v ] ; 3 uses
  %i.ds = load i32, ptr %.5228, align 8, !tbaa !14 ; 2 uses
...
bb.at:                                            ; preds = %Py_DECREF.exit.thread222
  ...
  store i32 %i.dt, ptr %.5228, align 8, !tbaa !14
  %i.du = icmp eq i32 %i.dt, 0
  br i1 %i.du, label %bb.au, label %Py_XDECREF.exit169.thread

bb.au:                                            ; preds = %bb.at
  call void @_Py_Dealloc(ptr noundef nonnull %.5228) #9
  br label %Py_XDECREF.exit169.thread
...
Py_XDECREF.exit169.thread:                        ; preds = %bb.f, %Py_DECREF.exit148, %bb.t, %bb.au, %bb.at, %Py_DECREF.exit.thread222, %Py_DECREF.exit, %bb.b, %bb.c, %bb.e, %bb.h, %bb.i, %bb.j
  %.12219239 = phi i32 [ %.12227, %bb.at ], [ -1, %bb.e ], [ %.12227, %Py_DECREF.exit.thread222 ], [ -1, %bb.h ], [ -1, %bb.i ], [ -1, %bb.j ], [ -1, %bb.t ], [ -1, %bb.b ], [ -1, %bb.c ], [ %.12227, %bb.au ], [ %.12, %Py_DECREF.exit ], [ -1, %bb.f ], [ %i.ah, %Py_DECREF.exit148 ] ; 4 uses
  %.090220237 = phi ptr [ %i.s, %bb.at ], [ %i.s, %bb.e ], [ %i.s, %Py_DECREF.exit.thread222 ], [ %i.s, %bb.h ], [ %i.s, %bb.i ], [ %i.s, %bb.j ], [ %i.s, %bb.t ], [ null, %bb.b ], [ null, %bb.c ], [ %i.s, %bb.au ], [ %i.s, %Py_DECREF.exit ], [ %i.s, %Py_DECREF.exit148 ], [ %i.s, %bb.f ] ; 4 uses
...
Py_XDECREF.exit175:                               ; preds = %get_ast_state.exit.thread176, %bb.az, %bb.ay, %bb.ax, %Py_XDECREF.exit172
  %.089 = phi i32 [ -1, %get_ast_state.exit.thread176 ], [ %.12219239, %Py_XDECREF.exit172 ], [ %.12219239, %bb.ax ], [ %.12219239, %bb.ay ], [ %.12219239, %bb.az ]
...
get_ast_state.exit.thread:                        ; preds = %_PyOnceFlag_CallOnce.exit.i, %Py_XDECREF.exit175
  %.1 = phi i32 [ %.089, %Py_XDECREF.exit175 ], [ -1, %_PyOnceFlag_CallOnce.exit.i ]
  ret i32 %.1
}
...
bb.s:                                             ; preds = %Py_DECREF.exit86
  %i.ba = add nuw nsw i64 %.063168, 1             ; 2 uses
...
bb.t:                                             ; preds = %.lr.ph169, %bb.s
  %.063168 = phi i64 [ 0, %.lr.ph169 ], [ %i.ba, %bb.s ] ; 3 uses
  %i.bb = load ptr, ptr %i.b, align 8, !tbaa !11
  %i.bc = call ptr @PySequence_GetItem(ptr noundef %i.bb, i64 noundef %.063168) #9 ; 17 uses
...
.lr.ph:                                           ; preds = %.preheader, %bb.q
  %.080 = phi i64 [ %i.as, %bb.q ], [ 0, %.preheader ] ; 2 uses
  %i.ad = load ptr, ptr %i.b, align 8, !tbaa !11
  %i.ae = call ptr @PySequence_GetItem(ptr noundef %i.ad, i64 noundef %.080) #9 ; 5 uses
...
bb.q:                                             ; preds = %Py_DECREF.exit
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #9
  %i.as = add nuw nsw i64 %.080, 1                ; 2 uses
...
Py_DECREF.exit53:                                 ; preds = %.lr.ph, %bb.i, %.thread70, %bb.s, %bb.f, %bb.g, %bb.h, %.thread77, %bb.u, %bb.t, %bb.c
  %.131 = phi ptr [ null, %bb.c ], [ null, %bb.u ], [ null, %bb.t ], [ %i.ab, %bb.s ], [ null, %bb.i ], [ %i.ab, %.thread77 ], [ %i.ab, %.thread70 ], [ null, %bb.f ], [ null, %bb.g ], [ null, %bb.h ], [ %i.ab, %.lr.ph ] ; 4 uses
  %.2.a = phi ptr [ null, %bb.c ], [ %i.ay, %bb.u ], [ %i.ax, %bb.t ], [ %i.av, %bb.s ], [ null, %bb.i ], [ null, %.thread77 ], [ null, %.thread70 ], [ null, %bb.f ], [ null, %bb.g ], [ null, %bb.h ], [ null, %.lr.ph ] ; 4 uses
