...
Py_DECREF.exit:                                   ; preds = %bb.w, %bb.q, %bb.p, %bb.r, %bb.as, %bb.ar, %Py_DECREF.exit144, %bb.x, %.loopexit, %bb.y, %.split106
  ...
  %.5 = phi ptr [ %.4, %bb.x ], [ %.4, %.split106 ], [ %.4, %Py_DECREF.exit144 ], [ %.4, %bb.ar ], [ %.4, %bb.as ], [ %.4, %bb.y ], [ %.4, %.loopexit ], [ %.099266, %bb.r ], [ %.099266, %bb.q ], [ %.099266, %bb.p ], [ %.2101, %bb.w ] ; 2 uses
...
Py_DECREF.exit.thread222:                         ; preds = %bb.u, %bb.v, %Py_DECREF.exit
  %.5228 = phi ptr [ %.5, %Py_DECREF.exit ], [ %.1100, %bb.v ], [ %.1100, %bb.u ] ; 3 uses
...
Py_XDECREF.exit175:                               ; preds = %get_ast_state.exit.thread176, %bb.az, %bb.ay, %bb.ax, %Py_XDECREF.exit172
  %.0 = phi i32 [ -1, %get_ast_state.exit.thread176 ], [ %.12219239, %Py_XDECREF.exit172 ], [ %.12219239, %bb.ax ], [ %.12219239, %bb.ay ], [ %.12219239, %bb.az ]
