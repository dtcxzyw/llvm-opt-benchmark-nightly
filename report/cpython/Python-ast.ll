...
bb.af:                                            ; preds = %bb.bi, %.lr.ph387.i
  ...
  %.0310390.i = phi ptr [ undef, %.lr.ph387.i ], [ %.2311.i, %bb.bi ] ; 10 uses
...
Py_DECREF.exit48.i.i:                             ; preds = %Py_DECREF.exit48.sink.split.i.i, %bb.az, %bb.ar, %bb.ai
  %.1310.i = phi ptr [ %.0310390.i, %bb.ai ], [ %.0310390.i, %Py_DECREF.exit48.sink.split.i.i ], [ %.0310390.i, %bb.ar ], [ %i.gc, %bb.az ]
...
obj2ast_type_ignore.exit.i:                       ; preds = %bb.bd, %bb.bc, %bb.bb, %bb.ba, %.thread.i.i, %Py_DECREF.exit48.i.i, %bb.ah, %_Py_EnterRecursiveCall.exit289.thread.i
  %.2311.i = phi ptr [ %.0310390.i, %.thread.i.i ], [ %.1310.i, %Py_DECREF.exit48.i.i ], [ %.2312.i, %bb.ba ], [ %.2312.i, %bb.bd ], [ %.2312.i, %bb.bc ], [ %.2312.i, %bb.bb ], [ %.0310390.i, %bb.ah ], [ null, %_Py_EnterRecursiveCall.exit289.thread.i ] ; 2 uses
...
.loopexit:                                        ; preds = %bb.o, %bb.n, %._crit_edge
  %.4103 = phi ptr [ null, %._crit_edge ], [ null, %bb.n ], [ %.2, %bb.o ] ; 7 uses
  %.698 = phi i32 [ %.093.lcssa, %._crit_edge ], [ %.093.lcssa, %bb.n ], [ %i.bt, %bb.o ] ; 3 uses
...
Py_DECREF.exit:                                   ; preds = %bb.w, %bb.q, %bb.p, %bb.r, %bb.as, %bb.ar, %Py_DECREF.exit144, %bb.x, %.loopexit, %bb.y, %.split106
  %.5104 = phi ptr [ %.4103, %bb.x ], [ %.4103, %.split106 ], [ %.4103, %Py_DECREF.exit144 ], [ %.4103, %bb.ar ], [ %.4103, %bb.as ], [ %.4103, %bb.y ], [ %.4103, %.loopexit ], [ %.091266, %bb.r ], [ %.091266, %bb.q ], [ %.091266, %bb.p ], [ %.2, %bb.w ] ; 2 uses
...
Py_DECREF.exit.thread222:                         ; preds = %bb.u, %bb.v, %Py_DECREF.exit
  ...
  %.5104228 = phi ptr [ %.5104, %Py_DECREF.exit ], [ %.192, %bb.v ], [ %.192, %bb.u ] ; 3 uses
...
Py_XDECREF.exit175:                               ; preds = %get_ast_state.exit.thread176, %bb.az, %bb.ay, %bb.ax, %Py_XDECREF.exit172
  %.089 = phi i32 [ -1, %get_ast_state.exit.thread176 ], [ %.12220237, %Py_XDECREF.exit172 ], [ %.12220237, %bb.ax ], [ %.12220237, %bb.ay ], [ %.12220237, %bb.az ]
...
Py_DECREF.exit53:                                 ; preds = %.lr.ph, %bb.i, %.thread70, %bb.s, %bb.f, %bb.g, %bb.h, %.thread77, %bb.u, %bb.t, %bb.c
  %.131 = phi ptr [ null, %bb.c ], [ %i.ay, %bb.u ], [ %i.ax, %bb.t ], [ null, %.thread70 ], [ null, %bb.i ], [ null, %.thread77 ], [ %i.av, %bb.s ], [ null, %bb.f ], [ null, %bb.g ], [ null, %bb.h ], [ null, %.lr.ph ] ; 4 uses
  %.2.a = phi ptr [ null, %bb.c ], [ null, %bb.u ], [ null, %bb.t ], [ %i.ab, %.thread70 ], [ null, %bb.i ], [ %i.ab, %.thread77 ], [ %i.ab, %bb.s ], [ null, %bb.f ], [ null, %bb.g ], [ null, %bb.h ], [ %i.ab, %.lr.ph ] ; 4 uses
