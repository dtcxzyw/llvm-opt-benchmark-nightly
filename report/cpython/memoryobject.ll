...
bb.k:                                             ; preds = %init_suboffsets.exit
  ...
  %2 = or disjoint i32 %spec.select.i23, 4
...
init_flags.exit.i:                                ; preds = %init_strides_from_shape.exit.i
  ...
  %3 = or disjoint i32 %spec.select.i.i, 4
