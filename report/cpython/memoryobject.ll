...
; Function Attrs: nounwind uwtable
define internal i32 @mbuf_traverse(ptr nofree noundef readonly captures(none) %0, ptr nofree noundef readonly captures(none) %1, ptr noundef %2) #0 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.af = add i64 %i.ae, 1
end_hunk_0
begin_hunk_1_@tolist_base:bb.a
...
bb.c:                                             ; preds = %switch.hole_check, %bb.b, %switch.lookup
  %i.l = load ptr, ptr @PyExc_ValueError, align 8, !tbaa !38
...
get_native_fmtchar.exit:                          ; preds = %switch.lookup
  ...
  %i.q = load i8, ptr %spec.select.i40, align 1, !tbaa !36 ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  %i.aa = load ptr, ptr @PyExc_TypeError, align 8, !tbaa !38
...
bb.k:                                             ; preds = %bb.j
  %i.ab = select i1 %i.e, ptr @.str.84, ptr @.str.85
  br label %init_flags.exit

bb.l:                                             ; preds = %bb.j
  %i.ac = select i1 %i.e, ptr @.str.86, ptr @.str.87
  br label %init_flags.exit

bb.m:                                             ; preds = %bb.j
  %i.ad = select i1 %i.e, ptr @.str.88, ptr @.str.12
  br label %init_flags.exit

bb.n:                                             ; preds = %bb.j
  %i.ae = select i1 %i.e, ptr @.str.89, ptr @.str.90
  br label %init_flags.exit

bb.o:                                             ; preds = %bb.j
  %i.af = select i1 %i.e, ptr @.str.91, ptr @.str.92
  br label %init_flags.exit

bb.p:                                             ; preds = %bb.j
  %i.ag = select i1 %i.e, ptr @.str.93, ptr @.str.94
  br label %init_flags.exit

bb.q:                                             ; preds = %bb.j
  %i.ah = select i1 %i.e, ptr @.str.95, ptr @.str.96
  br label %init_flags.exit

bb.r:                                             ; preds = %bb.j
  %i.ai = select i1 %i.e, ptr @.str.97, ptr @.str.98
  br label %init_flags.exit

bb.s:                                             ; preds = %bb.j
  %i.aj = select i1 %i.e, ptr @.str.99, ptr @.str.100
  br label %init_flags.exit

bb.t:                                             ; preds = %bb.j
  %i.ak = select i1 %i.e, ptr @.str.101, ptr @.str.102
  br label %init_flags.exit

bb.u:                                             ; preds = %bb.j
  %i.al = select i1 %i.e, ptr @.str.103, ptr @.str.104
  br label %init_flags.exit

bb.v:                                             ; preds = %bb.j
  %i.am = select i1 %i.e, ptr @.str.105, ptr @.str.106
  br label %init_flags.exit

bb.w:                                             ; preds = %bb.j
  %i.an = select i1 %i.e, ptr @.str.107, ptr @.str.108
  br label %init_flags.exit

bb.x:                                             ; preds = %bb.j
  %i.ao = select i1 %i.e, ptr @.str.109, ptr @.str.110
  br label %init_flags.exit

bb.y:                                             ; preds = %bb.j
  %i.ap = select i1 %i.e, ptr @.str.111, ptr @.str.112
  br label %init_flags.exit

bb.z:                                             ; preds = %bb.j
  %i.aq = select i1 %i.e, ptr @.str.113, ptr @.str.114
  br label %init_flags.exit

bb.aa:                                            ; preds = %bb.j
  %i.ar = select i1 %i.e, ptr @.str.115, ptr @.str.116
  br label %init_flags.exit

bb.ab:                                            ; preds = %bb.j
  %i.as = select i1 %i.e, ptr @.str.117, ptr @.str.118
  br label %init_flags.exit

bb.ac:                                            ; preds = %bb.j
  store ptr null, ptr %i.m, align 8, !tbaa !54
  %i.at = load ptr, ptr @PyExc_RuntimeError, align 8, !tbaa !38
  tail call void @PyErr_SetString(ptr noundef %i.at, ptr noundef nonnull @.str.83) #15
  br label %bb.ad

init_flags.exit:                                  ; preds = %bb.aa, %bb.z, %bb.y, %bb.x, %bb.w, %bb.v, %bb.u, %bb.t, %bb.s, %bb.r, %bb.q, %bb.p, %bb.o, %bb.n, %bb.m, %bb.l, %bb.k, %bb.ab
  ...
  %i.az = load i64, ptr %i.au, align 8, !tbaa !66
  %i.ba = getelementptr i8, ptr %0, i64 112
  %i.bb = load ptr, ptr %i.ba, align 8, !tbaa !65
  store i64 %i.az, ptr %i.bb, align 8, !tbaa !52
  %i.bc = getelementptr i8, ptr %0, i64 120
  store ptr null, ptr %i.bc, align 8, !tbaa !56
  %i.bd = getelementptr i8, ptr %0, i64 40
  store i32 6, ptr %i.bd, align 8, !tbaa !44
  br label %bb.ad

bb.ad:                                            ; preds = %init_flags.exit, %bb.ac, %bb.i, %bb.g, %bb.c
  %.0 = phi i32 [ -1, %bb.c ], [ -1, %bb.i ], [ -1, %bb.ac ], [ 0, %init_flags.exit ], [ -1, %bb.g ] ; 3 uses
  %i.be = load i32, ptr %i.a, align 8, !tbaa !36  ; 2 uses
  %.not.i = icmp sgt i32 %i.be, -1
  br i1 %.not.i, label %bb.ae, label %Py_DECREF.exit

bb.ae:                                            ; preds = %bb.ad
  %i.bf = add nsw i32 %i.be, -1                   ; 2 uses
  store i32 %i.bf, ptr %i.a, align 8, !tbaa !36
  %i.bg = icmp eq i32 %i.bf, 0
  br i1 %i.bg, label %bb.af, label %Py_DECREF.exit

bb.af:                                            ; preds = %bb.ae
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.a) #15
  br label %Py_DECREF.exit

Py_DECREF.exit:                                   ; preds = %bb.af, %bb.ae, %bb.ad, %bb.a
  %.036 = phi i32 [ -1, %bb.a ], [ %.0, %bb.ad ], [ %.0, %bb.ae ], [ %.0, %bb.af ]
  ret i32 %.036
}

; Function Attrs: nounwind uwtable
define internal fastcc range(i32 -1, 1) i32 @cast_to_ND(ptr noundef nonnull initializes((92, 96)) %0, ptr nofree noundef nonnull readonly captures(none) %1, i32 noundef %2) unnamed_addr #0 {
bb.a:
