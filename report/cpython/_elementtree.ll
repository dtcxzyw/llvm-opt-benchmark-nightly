...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph.i
  %.03356.i17 = phi i64 [ %i.aj, %.lr.ph.i ], [ 0, %.lr.ph.preheader ] ; 5 uses
...
Py_DECREF.exit46.i..critedge.i.loopexit_crit_edge: ; preds = %Py_DECREF.exit46.i
  %.03356.i17.lcssa103 = phi i64 [ %.03356.i17, %Py_DECREF.exit46.i ]
  br label %.critedge.i.loopexit

.critedge.i.loopexit:                             ; preds = %.critedge.i.loopexitsplit, %Py_DECREF.exit46.i..critedge.i.loopexit_crit_edge
  %.lcssa97 = phi i32 [ %i.ae, %Py_DECREF.exit46.i..critedge.i.loopexit_crit_edge ], [ %i.ae, %.critedge.i.loopexitsplit ]
  %.033.lcssa.ph.i.ph = phi i64 [ %.03356.i17.lcssa103, %Py_DECREF.exit46.i..critedge.i.loopexit_crit_edge ], [ %.lcssa100, %.critedge.i.loopexitsplit ]
  br label %.critedge.i
...
bb.u:                                             ; preds = %.lr.ph, %bb.ad
  ...
  %.081153 = phi i64 [ 0, %.lr.ph ], [ %i.dd, %bb.ad ] ; 9 uses
...
.._crit_edge.loopexit_crit_edge:                  ; preds = %bb.u
  %.081153.lcssa.a = phi i64 [ %.081153, %bb.u ]
  br label %._crit_edge.loopexit

._crit_edge.loopexit:                             ; preds = %._crit_edge.loopexitsplit, %.._crit_edge.loopexit_crit_edge
  %.081.lcssa.ph = phi i64 [ %.081153.lcssa.a, %.._crit_edge.loopexit_crit_edge ], [ %.lcssa, %._crit_edge.loopexitsplit ]
  br label %._crit_edge
