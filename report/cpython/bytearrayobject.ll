...
fastsearch.exit.thread.i.i:                       ; preds = %fastsearch.exit.i.i, %bb.cp, %bb.ck, %.lr.ph.i21.i, %.preheader.i20.i
  %.05130.i.i = phi i64 [ %.val16.i, %.preheader.i20.i ], [ %.val16.i, %.lr.ph.i21.i ], [ %.05157.i.i, %bb.cp ], [ %.05157.i.i, %bb.ck ], [ %.05157.i.i, %fastsearch.exit.i.i ] ; 2 uses
  %.021.i.i = phi i64 [ 0, %.preheader.i20.i ], [ 0, %.lr.ph.i21.i ], [ %.058.i.i, %bb.cp ], [ %.058.i.i, %bb.ck ], [ %.058.i.i, %fastsearch.exit.i.i ]
