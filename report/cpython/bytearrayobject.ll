...
bb.d:                                             ; preds = %.thread53
  %i.j = load ptr, ptr %i.h, align 8, !tbaa !20   ; 3 uses
...
.thread58:                                        ; preds = %Py_DECREF.exit.thread, %Py_DECREF.exit, %bb.e, %.thread53
  ...
  %.val.i = load ptr, ptr %i.w, align 8, !tbaa !30 ; 10 uses
  %i.x = getelementptr i8, ptr %0, i64 16
  %.val16.i = load i64, ptr %i.x, align 8, !tbaa !32 ; 16 uses
...
bb.j:                                             ; preds = %.thread58
  ...
  %i.ab = call ptr @PyList_New(i64 noundef %i.aa) #17, !inline_history !204 ; 10 uses
...
bb.k:                                             ; preds = %.lr.ph.i.i
  ...
  br i1 %exitcond.not.i.i, label %.critedge._crit_edge.thread.i.i, label %.lr.ph.i.i, !llvm.loop !205
...
.preheader4.i.i:                                  ; preds = %.lr.ph
  ...
  br i1 %exitcond25.not.i.i, label %.critedge2.i.i, label %.lr.ph, !llvm.loop !206
...
.lr.ph:                                           ; preds = %.preheader4.preheader.i.i, %.preheader4.i.i
  ...
  br i1 %.not72.i.i, label %.preheader4.i.i, label %..critedge2.i.i_crit_edge, !llvm.loop !206

..critedge2.i.i_crit_edge:                        ; preds = %.lr.ph
  br label %.critedge2.i.i, !llvm.loop !206
...
bb.l:                                             ; preds = %.critedge2.i.i
  %i.ay = load ptr, ptr @PyExc_SystemError, align 8, !tbaa !20
  call void @PyErr_SetString(ptr noundef %i.ay, ptr noundef nonnull @.str) #17, !inline_history !207
  br label %Py_DECREF.exit84.i.i

bb.m:                                             ; preds = %.critedge2.i.i
  %i.az = call ptr @_PyObject_New(ptr noundef nonnull @PyByteArray_Type) #17, !inline_history !207 ; 17 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.bc = call ptr @PyBytes_FromStringAndSize(ptr noundef null, i64 noundef %i.aw) #17, !inline_history !207 ; 3 uses
...
bb.t:                                             ; preds = %PyByteArray_FromStringAndSize.exit.i.i
  %.val89.i.i = load ptr, ptr %i.ad, align 8, !tbaa !72
  %i.bq = getelementptr [8 x i8], ptr %.val89.i.i, i64 %.017.i.i
  store ptr %i.az, ptr %i.bq, align 8, !tbaa !20
  br label %Py_DECREF.exit82.i.i

bb.u:                                             ; preds = %PyByteArray_FromStringAndSize.exit.i.i
  %i.br = call i32 @PyList_Append(ptr noundef nonnull %i.ab, ptr noundef nonnull %i.az) #17, !inline_history !204
  %.not73.i.i = icmp eq i32 %i.br, 0
  %i.bs = load i32, ptr %i.az, align 8, !tbaa !29 ; 3 uses
...
bb.w:                                             ; preds = %bb.v
  ...
  store i32 %i.bt, ptr %i.az, align 8, !tbaa !29
  %i.bu = icmp eq i32 %i.bt, 0
  br i1 %i.bu, label %bb.x, label %Py_DECREF.exit84.i.i

bb.x:                                             ; preds = %bb.w
  call void @_Py_Dealloc(ptr noundef nonnull %i.az) #17, !inline_history !204
  br label %Py_DECREF.exit84.i.i
...
bb.z:                                             ; preds = %bb.y
  ...
  store i32 %i.bv, ptr %i.az, align 8, !tbaa !29
...
Py_DECREF.exit82.i.i:                             ; preds = %bb.aa, %bb.z, %bb.y, %bb.t
  ...
  br i1 %exitcond26.not.i.i, label %.critedge._crit_edge.i.i, label %.preheader5.i.i, !llvm.loop !208
...
bb.ab:                                            ; preds = %.preheader.i.i
  ...
  br i1 %exitcond27.not.i.i, label %.critedge._crit_edge.thread.i.i, label %.preheader.i.i, !llvm.loop !209
...
bb.ad:                                            ; preds = %bb.ac
  %i.ci = load ptr, ptr @PyExc_SystemError, align 8, !tbaa !20
  call void @PyErr_SetString(ptr noundef %i.ci, ptr noundef nonnull @.str) #17, !inline_history !207
  br label %Py_DECREF.exit84.i.i

bb.ae:                                            ; preds = %bb.ac
  %i.cj = call ptr @_PyObject_New(ptr noundef nonnull @PyByteArray_Type) #17, !inline_history !207 ; 17 uses
  %i.ck = icmp eq ptr %i.cj, null
  br i1 %i.ck, label %Py_DECREF.exit84.i.i, label %bb.af

bb.af:                                            ; preds = %bb.ae
  %i.cl = getelementptr i8, ptr %i.cj, i64 48
  store i64 0, ptr %i.cl, align 8, !tbaa !27
  %i.cm = call ptr @PyBytes_FromStringAndSize(ptr noundef null, i64 noundef %i.cg) #17, !inline_history !207 ; 3 uses
  %i.cn = getelementptr i8, ptr %i.cj, i64 56
  store ptr %i.cm, ptr %i.cn, align 8, !tbaa !28
  %i.co = icmp eq ptr %i.cm, null
  br i1 %i.co, label %bb.ag, label %PyByteArray_FromStringAndSize.exit93.i.i

bb.ag:                                            ; preds = %bb.af
  %i.cp = load i32, ptr %i.cj, align 8, !tbaa !29 ; 2 uses
...
bb.ah:                                            ; preds = %bb.ag
  ...
  store i32 %i.cq, ptr %i.cj, align 8, !tbaa !29
  %i.cr = icmp eq i32 %i.cq, 0
  br i1 %i.cr, label %bb.ai, label %Py_DECREF.exit84.i.i

bb.ai:                                            ; preds = %bb.ah
  call void @_Py_Dealloc(ptr noundef nonnull %i.cj) #17, !inline_history !207
  br label %Py_DECREF.exit84.i.i
...
PyByteArray_FromStringAndSize.exit93.i.i:         ; preds = %bb.af
  ...
  store ptr %i.cs, ptr %i.ct, align 8, !tbaa !30
  %i.cu = getelementptr i8, ptr %i.cj, i64 32
  store ptr %i.cs, ptr %i.cu, align 8, !tbaa !31
  %i.cv = getelementptr i8, ptr %i.cj, i64 16
  store i64 %i.cg, ptr %i.cv, align 8, !tbaa !32
  %i.cw = getelementptr i8, ptr %i.cj, i64 24
  store i64 %i.cg, ptr %i.cw, align 8, !tbaa !33
...
bb.aj:                                            ; preds = %PyByteArray_FromStringAndSize.exit93.i.i
  ...
  %.val.i.i = load ptr, ptr %i.cy, align 8, !tbaa !72
  %i.cz = getelementptr [8 x i8], ptr %.val.i.i, i64 %spec.store.select.i
  store ptr %i.cj, ptr %i.cz, align 8, !tbaa !20
  br label %Py_DECREF.exit78.i.i

bb.ak:                                            ; preds = %PyByteArray_FromStringAndSize.exit93.i.i
  %i.da = call i32 @PyList_Append(ptr noundef nonnull %i.ab, ptr noundef nonnull %i.cj) #17, !inline_history !204
  %.not76.i.i = icmp eq i32 %i.da, 0
  %i.db = load i32, ptr %i.cj, align 8, !tbaa !29 ; 3 uses
...
bb.am:                                            ; preds = %bb.al
  ...
  store i32 %i.dc, ptr %i.cj, align 8, !tbaa !29
  %i.dd = icmp eq i32 %i.dc, 0
  br i1 %i.dd, label %bb.an, label %Py_DECREF.exit84.i.i

bb.an:                                            ; preds = %bb.am
  call void @_Py_Dealloc(ptr noundef nonnull %i.cj) #17, !inline_history !204
  br label %Py_DECREF.exit84.i.i
...
bb.ap:                                            ; preds = %bb.ao
  ...
  store i32 %i.de, ptr %i.cj, align 8, !tbaa !29
...
.critedge._crit_edge.thread.i.i:                  ; preds = %.critedge.i.i, %bb.k, %bb.ab, %Py_DECREF.exit78.i.i, %.critedge._crit_edge.i.i
  ...
  store i64 %.1.i.i, ptr %i.dh, align 8, !tbaa !32
...
Py_DECREF.exit84.i.i:                             ; preds = %bb.m, %bb.an, %bb.am, %bb.al, %bb.ai, %bb.ah, %bb.ag, %bb.ae, %bb.ad, %bb.x, %bb.w, %bb.v, %bb.q, %bb.p, %bb.o, %bb.l
  %i.di = load i32, ptr %i.ab, align 8, !tbaa !29 ; 2 uses
...
bb.ar:                                            ; preds = %Py_DECREF.exit84.i.i
  ...
  store i32 %i.dj, ptr %i.ab, align 8, !tbaa !29
  %i.dk = icmp eq i32 %i.dj, 0
  br i1 %i.dk, label %bb.as, label %bytearray_split_impl.exit

bb.as:                                            ; preds = %bb.ar
  call void @_Py_Dealloc(ptr noundef nonnull %i.ab) #17, !inline_history !204
  br label %bytearray_split_impl.exit

bb.at:                                            ; preds = %.thread58
  %i.dl = call i32 @PyObject_GetBuffer(ptr noundef %.135, ptr noundef nonnull %4, i32 noundef 0) #17, !inline_history !210
  %.not.i50 = icmp eq i32 %i.dl, 0
  br i1 %.not.i50, label %bb.au, label %bytearray_split_impl.exit

bb.au:                                            ; preds = %bb.at
  %i.dm = load ptr, ptr %4, align 8, !tbaa !45    ; 2 uses
  %i.dn = getelementptr inbounds nuw i8, ptr %4, i64 16
  %i.do = load i64, ptr %i.dn, align 8, !tbaa !36 ; 3 uses
...
bb.av:                                            ; preds = %bb.au
  %i.dp = load ptr, ptr @PyExc_ValueError, align 8, !tbaa !20
  call void @PyErr_SetString(ptr noundef %i.dp, ptr noundef nonnull @.str.103) #17, !inline_history !211
  br label %stringlib_split.exit.i

bb.aw:                                            ; preds = %bb.au
  %i.dq = load i8, ptr %i.dm, align 1, !tbaa !29
  %i.dr = call i64 @llvm.umin.i64(i64 %.1, i64 11)
  %i.ds = add nuw nsw i64 %i.dr, 1
  %i.dt = call ptr @PyList_New(i64 noundef %i.ds) #17, !inline_history !212 ; 10 uses
...
bb.ax:                                            ; preds = %Py_DECREF.exit66.i.i.i
  ...
  br i1 %i.dx, label %.preheader.i.i.i, label %.critedge.i.i.i, !llvm.loop !213
...
bb.az:                                            ; preds = %bb.ay
  %i.ef = load ptr, ptr @PyExc_SystemError, align 8, !tbaa !20
  call void @PyErr_SetString(ptr noundef %i.ef, ptr noundef nonnull @.str) #17, !inline_history !214
  br label %Py_DECREF.exit68.i.i.i

bb.ba:                                            ; preds = %bb.ay
  %i.eg = call ptr @_PyObject_New(ptr noundef nonnull @PyByteArray_Type) #17, !inline_history !214 ; 17 uses
  %i.eh = icmp eq ptr %i.eg, null
  br i1 %i.eh, label %Py_DECREF.exit68.i.i.i, label %bb.bb

bb.bb:                                            ; preds = %bb.ba
  %i.ei = getelementptr i8, ptr %i.eg, i64 48
  store i64 0, ptr %i.ei, align 8, !tbaa !27
  %i.ej = call ptr @PyBytes_FromStringAndSize(ptr noundef null, i64 noundef %i.ed) #17, !inline_history !214 ; 3 uses
  %i.ek = getelementptr i8, ptr %i.eg, i64 56
  store ptr %i.ej, ptr %i.ek, align 8, !tbaa !28
  %i.el = icmp eq ptr %i.ej, null
  br i1 %i.el, label %bb.bc, label %bb.bf

bb.bc:                                            ; preds = %bb.bb
  %i.em = load i32, ptr %i.eg, align 8, !tbaa !29 ; 2 uses
...
bb.bd:                                            ; preds = %bb.bc
  ...
  store i32 %i.en, ptr %i.eg, align 8, !tbaa !29
  %i.eo = icmp eq i32 %i.en, 0
  br i1 %i.eo, label %bb.be, label %Py_DECREF.exit68.i.i.i

bb.be:                                            ; preds = %bb.bd
  call void @_Py_Dealloc(ptr noundef nonnull %i.eg) #17, !inline_history !214
  br label %Py_DECREF.exit68.i.i.i
...
bb.bf:                                            ; preds = %bb.bb
  ...
  store ptr %i.ep, ptr %i.er, align 8, !tbaa !31
  %i.es = getelementptr i8, ptr %i.eg, i64 16
  store i64 %i.ed, ptr %i.es, align 8, !tbaa !32
  %i.et = getelementptr i8, ptr %i.eg, i64 24
  store i64 %i.ed, ptr %i.et, align 8, !tbaa !33
...
bb.bh:                                            ; preds = %PyByteArray_FromStringAndSize.exit.i.i.i
  %.val73.i.i.i = load ptr, ptr %i.dw, align 8, !tbaa !72
  %i.ex = getelementptr [8 x i8], ptr %.val73.i.i.i, i64 %.019.i.i.i263
  store ptr %i.eg, ptr %i.ex, align 8, !tbaa !20
  br label %Py_DECREF.exit66.i.i.i

bb.bi:                                            ; preds = %PyByteArray_FromStringAndSize.exit.i.i.i
  %i.ey = call i32 @PyList_Append(ptr noundef nonnull %i.dt, ptr noundef nonnull %i.eg) #17, !inline_history !212
  %.not60.i.i.i = icmp eq i32 %i.ey, 0
  %i.ez = load i32, ptr %i.eg, align 8, !tbaa !29 ; 3 uses
...
bb.bk:                                            ; preds = %bb.bj
  ...
  store i32 %i.fa, ptr %i.eg, align 8, !tbaa !29
  %i.fb = icmp eq i32 %i.fa, 0
  br i1 %i.fb, label %bb.bl, label %Py_DECREF.exit68.i.i.i

bb.bl:                                            ; preds = %bb.bk
  call void @_Py_Dealloc(ptr noundef nonnull %i.eg) #17, !inline_history !212
  br label %Py_DECREF.exit68.i.i.i
...
bb.bn:                                            ; preds = %bb.bm
  ...
  store i32 %i.fc, ptr %i.eg, align 8, !tbaa !29
...
Py_DECREF.exit66.i.i.i:                           ; preds = %bb.bo, %bb.bn, %bb.bm, %bb.bh
  ...
  br i1 %i.fg, label %bb.ax, label %.loopexit.i.i.i..critedge.i.i.i.loopexit232_crit_edge, !llvm.loop !213

bb.bp:                                            ; preds = %.lr.ph.i.i.i
  %i.fh = add nsw i64 %.14815.i.i.i, 1            ; 2 uses
  %exitcond.not.i.i.i = icmp eq i64 %i.fh, %.val16.i
  br i1 %exitcond.not.i.i.i, label %.critedge.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !215

.loopexit.i.i.i..critedge.i.i.i.loopexit232_crit_edge: ; preds = %Py_DECREF.exit66.i.i.i
  br label %.critedge.i.i.i, !llvm.loop !213
