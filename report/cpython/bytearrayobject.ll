...
.lr.ph:                                           ; preds = %bb.k, %bb.l
  %.0.i.i.i.i38 = phi ptr [ %i.u, %bb.l ], [ %i.r, %bb.k ]
  %i.u = getelementptr i8, ptr %.0.i.i.i.i38, i64 -1 ; 4 uses
...
.lr.ph.i75.i.i.i.prol.loopexit:                   ; preds = %.lr.ph.i75.i.i.i.prol, %bb.n
  ...
  %.lcssa42.unr = phi i64 [ poison, %bb.n ], [ %i.ak, %.lr.ph.i75.i.i.i.prol ]
  ...
  br i1 %i.an, label %.lr.ph66.split.us.i.preheader.i.i.i, label %.lr.ph.i75.i.i.i
...
.lr.ph66.split.us.i.i.i.i:                        ; preds = %bb.t, %.lr.ph66.split.us.i.preheader.i.i.i
  %.14865.us.i.i.i.i = phi i64 [ %i.bm, %bb.t ], [ %i.ao, %.lr.ph66.split.us.i.preheader.i.i.i ] ; 5 uses
...
.lr.ph.i75.i.i.i:                                 ; preds = %.lr.ph.i75.i.i.i.prol.loopexit, %.lr.ph.i75.i.i.i
  ...
  br i1 %i.ce, label %.lr.ph.i75.i.i.i, label %.lr.ph66.split.us.i.preheader.i.i.i, !llvm.loop !6
...
.critedge.i.i.i:                                  ; preds = %.loopexit.i.i.i, %bb.bp, %bb.ay
  %.044.lcssa.i.i.i = phi i64 [ %i.dy, %bb.ay ], [ %.04418.i.i.i360, %bb.bp ], [ %i.fi, %.loopexit.i.i.i ] ; 2 uses
  %.0.lcssa.i.i.i = phi i64 [ 0, %bb.ay ], [ %.019.i.i.i359, %bb.bp ], [ %i.fh, %.loopexit.i.i.i ] ; 2 uses
...
.lr.ph.i75.i.i.i.prol.loopexit:                   ; preds = %.lr.ph.i75.i.i.i.prol, %.lr.ph.i21.split.i
  ...
  %.lcssa388.unr = phi i64 [ poison, %.lr.ph.i21.split.i ], [ %i.ho, %.lr.ph.i75.i.i.i.prol ]
  %spec.select.i76.i.i.i.lcssa.unr = phi i64 [ poison, %.lr.ph.i21.split.i ], [ %spec.select.i76.i.i.i.prol, %.lr.ph.i75.i.i.i.prol ]
  br i1 %i.hf, label %.lr.ph66.split.us.i.preheader.i.i.i, label %.lr.ph.i75.i.i.i
...
.lr.ph:                                           ; preds = %bb.n, %bb.o
  %.0.i140 = phi ptr [ %i.ad, %bb.o ], [ %i.aa, %bb.n ]
  %i.ad = getelementptr i8, ptr %.0.i140, i64 -1  ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi141 = phi <2 x i64> [ zeroinitializer, %vector.ph ], [ %i.as, %vector.body ]
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %stringlib_find_char.exit, label %.lr.ph.i68.preheader143
...
.lr.ph.i68:                                       ; preds = %.lr.ph.i68.preheader143, %.lr.ph.i68
  %.09.i = phi i64 [ %i.az, %.lr.ph.i68 ], [ %.09.i.ph, %.lr.ph.i68.preheader143 ] ; 2 uses
...
.lr.ph.i73.epil.preheader:                        ; preds = %._crit_edge.i.unr-lcssa, %bb.w
  ...
  %lcmp.mod160 = trunc i64 %i.bk to i1
...
._crit_edge.i:                                    ; preds = %._crit_edge.i.unr-lcssa, %.lr.ph.i73.epil.preheader
  ...
  %i.cc = or i64 %.lcssa157, %i.cb                ; 2 uses
...
.lr.ph.i75.prol.loopexit:                         ; preds = %.lr.ph.i75.prol, %bb.am
  ...
  %.lcssa154.unr = phi i64 [ poison, %bb.am ], [ %i.es, %.lr.ph.i75.prol ]
  %spec.select.i76.lcssa.unr = phi i64 [ poison, %bb.am ], [ %spec.select.i76.prol, %.lr.ph.i75.prol ]
  %i.ev = icmp eq i64 %3, 2
  br i1 %i.ev, label %.lr.ph66.split.us.i.preheader, label %.lr.ph.i75
...
.lr.ph66.split.us.i:                              ; preds = %.lr.ph66.split.us.i.preheader, %bb.as
  %.14865.us.i = phi i64 [ %i.fu, %bb.as ], [ %i.ew, %.lr.ph66.split.us.i.preheader ] ; 5 uses
...
.lr.ph.i75:                                       ; preds = %.lr.ph.i75.prol.loopexit, %.lr.ph.i75
  ...
  br i1 %i.gm, label %.lr.ph.i75, label %.lr.ph66.split.us.i.preheader, !llvm.loop !6
