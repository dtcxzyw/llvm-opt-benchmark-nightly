...
begin_hunk_0_@zlib_compress:bb.a
  ...
  %i.ax = sub i64 %.038.i, %spec.select5.i.i      ; 2 uses
...
.preheader.preheader.i:                           ; preds = %bb.p
  ...
  %i.at = sub nsw i64 %spec.store.select.i, %i.ai
...
begin_hunk_2_@zlib_decompress:bb.a
  ...
  %.sroa.0.0.i = phi i64 [ %.sroa.0.2.lcssa82.i, %.loopexit94.i ], [ %i.at, %.preheader.preheader.i ] ; 5 uses
  ...
  %i.bf = sub i64 %.051.i, %spec.select5.i.i      ; 3 uses
...
begin_hunk_3_@zlib_decompress:bb.a
  ...
  %i.bu = sub nsw i64 %.sroa.0.0.i, %spec.select.i36.peel.i
...
begin_hunk_4_@zlib_decompress:bb.a
  ...
  %.sroa.0.2.peel.i = phi i64 [ %.sroa.0.0.i, %OutputBuffer_WindowGrow.exit.peel.i ], [ %.sroa.0.0.i, %.preheader.i ], [ %i.bu, %OutputBuffer_WindowGrow.exit.thread.peel.i ] ; 2 uses
...
begin_hunk_5_@zlib_decompress:bb.a
  ...
  %.sroa.0.1.i = phi i64 [ %.sroa.0.2.i, %bb.ak ], [ %.sroa.0.2.peel.i, %bb.ab ] ; 4 uses
...
begin_hunk_6_@zlib_decompress:bb.a
  ...
  %i.cc = sub nsw i64 %.sroa.0.1.i, %spec.select.i36.i
...
begin_hunk_7_@zlib_decompress:bb.a
  ...
  %.sroa.0.2.i = phi i64 [ %.sroa.0.1.i, %OutputBuffer_WindowGrow.exit.i ], [ %i.cc, %OutputBuffer_WindowGrow.exit.thread.i ] ; 2 uses
...
bb.ap:                                            ; preds = %bb.an
  ...
  %i.dn = add i64 %.sroa.0.2.lcssa82.i, %i.dm
...
begin_hunk_9_@zlib_Compress_compress:bb.a
  ...
  %i.w = sub i64 %.034.i, %spec.select5.i.i       ; 2 uses
...
begin_hunk_10_@zlib_Decompress_decompress:bb.a
  ...
  %i.aq = sub i64 %.062.us.i, %spec.select5.i.us.i ; 2 uses
  br label %bb.n
...
begin_hunk_11_@zlib_Decompress_decompress:bb.a
  ...
  %i.bq = sub i64 %.062.i, %spec.select5.i.i      ; 2 uses
  br label %bb.u
...
begin_hunk_13_@zlib_Decompress_flush:bb.a
  ...
  %spec.select.i.i = trunc nuw i64 %spec.select5.i.i to i32
  store i32 %spec.select.i.i, ptr %i.aq, align 8, !tbaa !48
  %i.ar = sub i64 %.0.i, %spec.select5.i.i        ; 3 uses
...
begin_hunk_14_@zlib_Decompress_flush:bb.a
  ...
  %.sroa.0.1.i = phi i64 [ %.sroa.0.2.i, %bb.s ], [ %.sroa.0.0.i, %bb.o ] ; 4 uses
...
begin_hunk_15_@zlib_Decompress_flush:bb.a
  ...
  %i.ba = sub nsw i64 %.sroa.0.1.i, %spec.select.i46.i
...
begin_hunk_16_@zlib_Decompress_flush:bb.a
  ...
  %.sroa.0.2.i = phi i64 [ %.sroa.0.1.i, %OutputBuffer_WindowGrow.exit.i ], [ %i.ba, %OutputBuffer_WindowGrow.exit.thread.i ] ; 3 uses
...
bb.w:                                             ; preds = %bb.u, %bb.t
  ...
  %i.ce = add i64 %.sroa.0.285.i, %i.cd
...
begin_hunk_18_@zlib__ZlibDecompressor_decompress:bb.a
  ...
  %i.bt = sub i64 %i.bs, %spec.select5.i.i.i.i
