...
PyObject_TypeCheck.exit:                          ; preds = %bb.b
  %i.c = tail call i32 @PyType_IsSubtype(ptr noundef %.val9, ptr noundef nonnull @_PyNamespace_Type) #3, !inline_history !36
...
PyObject_TypeCheck.exit11:                        ; preds = %PyObject_TypeCheck.exit.thread
  %i.e = tail call i32 @PyType_IsSubtype(ptr noundef %.val, ptr noundef nonnull @_PyNamespace_Type) #3, !inline_history !36
...
bb.a:
  %i.a = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_PyNamespace_Type, i64 304), align 8, !tbaa !37
  %i.b = tail call ptr %i.a(ptr noundef nonnull @_PyNamespace_Type, i64 noundef 0) #3, !inline_history !38 ; 9 uses
