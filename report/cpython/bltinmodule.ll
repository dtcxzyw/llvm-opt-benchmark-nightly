...
bb.ap:                                            ; preds = %bb.am, %bb.ak, %bb.aj, %bb.ai
  %.066.i.a = phi i32 [ 2, %bb.ak ], [ 0, %bb.ai ], [ 1, %bb.aj ], [ 3, %bb.am ] ; 2 uses
...
bb.bd:                                            ; preds = %bb.bc
  %5 = zext nneg i32 %.066.i.a to i64
  %i.cq = getelementptr [4 x i8], ptr @__const.builtin_compile_impl.start, i64 %5
