...
bb.aa:                                            ; preds = %delta_cmp.exit.thread
  ...
  %i.cs = load i8, ptr %i.cr, align 2, !tbaa !35
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %i.dw = load i8, ptr %i.dv, align 4, !tbaa !35
  ...
  %i.ef = load i8, ptr %i.ee, align 2, !tbaa !35
  ...
  %i.es = load i8, ptr %i.er, align 2, !tbaa !35
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.o = load i8, ptr %i.n, align 8, !tbaa !35
  %i.p = and i8 %i.o, 120
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.au = load i8, ptr %i.at, align 2, !tbaa !35
  ...
  %i.bb = load i8, ptr %i.ba, align 4, !tbaa !35
...
Py_DECREF.exit85:                                 ; preds = %bb.f, %_Py_NewRef.exit, %Py_DECREF.exit87, %bb.ad, %bb.ae
  ...
  %i.bx = load i8, ptr %i.bw, align 2, !tbaa !35
  ...
  %i.cd = load i8, ptr %i.cc, align 4, !tbaa !35
...
ymd_to_ord.exit:                                  ; preds = %Py_DECREF.exit85, %is_leap.exit.thread6.i.i, %is_leap.exit.i.i, %is_leap.exit.thread.i.i
  ...
  %i.cx = load i8, ptr %i.cw, align 2, !tbaa !35
  ...
  %i.dd = load i8, ptr %i.dc, align 4, !tbaa !35
...
ymd_to_ord.exit122:                               ; preds = %ymd_to_ord.exit, %is_leap.exit.thread6.i.i119, %is_leap.exit.i.i120, %is_leap.exit.thread.i.i117
  ...
  %i.eg = load i8, ptr %i.ef, align 2, !tbaa !35
  ...
  %i.ex = load i8, ptr %i.ew, align 8, !tbaa !35
  ...
  %i.fk = load i8, ptr %i.fj, align 8, !tbaa !35
  ...
  %i.ft = load i8, ptr %i.fs, align 2, !tbaa !35
