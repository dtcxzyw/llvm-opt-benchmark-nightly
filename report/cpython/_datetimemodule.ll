...
bb.i:                                             ; preds = %ord_to_ymd.exit
  %i.ay = tail call ptr @new_date_ex(i32 noundef %.09, i32 noundef %.1, i32 noundef %storemerge.i, ptr noundef nonnull %0), !inline_history !2
...
bb.k:                                             ; preds = %bb.j
  %i.ba = tail call ptr @new_datetime_ex2(i32 noundef %.09, i32 noundef %.1, i32 noundef %storemerge.i, i32 noundef 0, i32 noundef 0, i32 noundef 0, i32 noundef 0, ptr noundef nonnull @_Py_NoneStruct, i32 noundef 0, ptr noundef nonnull %0), !inline_history !3
  br label %new_date_subclass_ex.exit

bb.l:                                             ; preds = %bb.j
  %i.bb = tail call ptr (ptr, ptr, ...) @PyObject_CallFunction(ptr noundef %0, ptr noundef nonnull @.str.47, i32 noundef %.09, i32 noundef %.1, i32 noundef %storemerge.i) #16, !inline_history !2
  br label %new_date_subclass_ex.exit
...
.lr.ph.i.1:                                       ; preds = %.lr.ph.i
  ...
  %i.f = load i32, ptr %2, align 4, !tbaa !15
  %i.g = mul i32 %i.f, 10
  %i.h = add i32 %i.g, %i.c                       ; 2 uses
  store i32 %i.h, ptr %2, align 4, !tbaa !15
...
.lr.ph.i.2:                                       ; preds = %.lr.ph.i.1
  ...
  store i32 %i.o, ptr %2, align 4, !tbaa !15
...
.lr.ph.i.3:                                       ; preds = %.lr.ph.i.2
  ...
  store i32 %i.v, ptr %2, align 4, !tbaa !15
...
parse_digits.exit:                                ; preds = %.lr.ph.i.3
  ...
  store i32 %i.ac, ptr %2, align 4, !tbaa !15
...
.lr.ph.i51.1:                                     ; preds = %.lr.ph.i51.preheader
  ...
  %i.bn = load i32, ptr %3, align 4, !tbaa !15
  %i.bo = mul i32 %i.bn, 10
  %i.bp = add i32 %i.bo, %i.ak                    ; 2 uses
  store i32 %i.bp, ptr %3, align 4, !tbaa !15
...
parse_digits.exit55:                              ; preds = %.lr.ph.i51.1
  ...
  store i32 %i.bw, ptr %3, align 4, !tbaa !15
...
.lr.ph.i56.1:                                     ; preds = %.lr.ph.i56
  ...
  %i.cf = load i32, ptr %4, align 4, !tbaa !15
  %i.cg = mul i32 %i.cf, 10
  %i.ch = add i32 %i.cg, %i.cc                    ; 2 uses
  store i32 %i.ch, ptr %4, align 4, !tbaa !15
...
bb.h:                                             ; preds = %.lr.ph.i56.1
  ...
  store i32 %i.co, ptr %4, align 4, !tbaa !15
...
bb.b:                                             ; preds = %bb.a
  %i.e = load ptr, ptr @PyExc_ValueError, align 8, !tbaa !41
  %i.f = load i32, ptr %i.a, align 4, !tbaa !15
...
bb.e:                                             ; preds = %bb.a
  %i.m = load i32, ptr %i.a, align 4, !tbaa !15   ; 3 uses
  %i.n = load i32, ptr %i.c, align 4, !tbaa !15   ; 3 uses
  %i.o = load i32, ptr %i.b, align 4, !tbaa !15   ; 3 uses
  %i.p = icmp eq ptr %0, @PyDateTime_DateType
  br i1 %i.p, label %bb.f, label %bb.g

bb.f:                                             ; preds = %bb.e
  %i.q = tail call ptr @new_date_ex(i32 noundef %i.m, i32 noundef %i.n, i32 noundef %i.o, ptr noundef nonnull %0), !inline_history !2
  br label %new_date_subclass_ex.exit
...
bb.h:                                             ; preds = %bb.g
  %i.s = tail call ptr @new_datetime_ex2(i32 noundef %i.m, i32 noundef %i.n, i32 noundef %i.o, i32 noundef 0, i32 noundef 0, i32 noundef 0, i32 noundef 0, ptr noundef nonnull @_Py_NoneStruct, i32 noundef 0, ptr noundef nonnull %0), !inline_history !3
  br label %new_date_subclass_ex.exit

bb.i:                                             ; preds = %bb.g
  %i.t = tail call ptr (ptr, ptr, ...) @PyObject_CallFunction(ptr noundef %0, ptr noundef nonnull @.str.47, i32 noundef %i.m, i32 noundef %i.n, i32 noundef %i.o) #16, !inline_history !2
  br label %new_date_subclass_ex.exit
...
bb.c:                                             ; preds = %bb.b
  ...
  %.val = load i64, ptr %i.i, align 8, !tbaa !57  ; 5 uses
