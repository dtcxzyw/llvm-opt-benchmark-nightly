...
Py_XDECREF.exit3241:                              ; preds = %bb.l
  tail call void @PyErr_Clear() #4
  %i.ab = tail call ptr (ptr, ...) @PyUnicode_FromFormat(ptr noundef nonnull @.str.93, i32 noundef 0, i32 noundef 0) #4 ; 2 uses
  %.not.i3242 = icmp eq ptr %i.ab, null
  br i1 %.not.i3242, label %bb.n, label %bb.m

bb.m:                                             ; preds = %Py_XDECREF.exit3241
  %2 = load ptr, ptr @PyExc_AssertionError, align 8, !tbaa !13
  %3 = tail call ptr (ptr, ptr, ...) @PyErr_Format(ptr noundef %2, ptr noundef nonnull @.str.351, ptr noundef nonnull @.str.93) #4 ; 0 uses
  br label %Py_XDECREF.exit3221.thread

bb.n:                                             ; preds = %Py_XDECREF.exit3241
  %4 = load ptr, ptr @PyExc_SystemError, align 8, !tbaa !13
  %5 = tail call i32 @PyErr_ExceptionMatches(ptr noundef %4) #4
  %.not2.i3244 = icmp eq i32 %5, 0
  br i1 %.not2.i3244, label %Py_XDECREF.exit4531, label %Py_XDECREF.exit3247.a

Py_XDECREF.exit3247.a:                            ; preds = %bb.n
  tail call void @PyErr_Clear() #4
  %6 = tail call ptr (ptr, ...) @PyUnicode_FromFormat(ptr noundef nonnull @.str.94, i32 noundef 0, i32 noundef 0) #4 ; 2 uses
  %.not.i3248 = icmp eq ptr %6, null
  br i1 %.not.i3248, label %bb.p, label %bb.o

bb.o:                                             ; preds = %Py_XDECREF.exit3247.a
  %7 = load ptr, ptr @PyExc_AssertionError, align 8, !tbaa !13
  %8 = tail call ptr (ptr, ptr, ...) @PyErr_Format(ptr noundef %7, ptr noundef nonnull @.str.351, ptr noundef nonnull @.str.94) #4 ; 0 uses
  br label %Py_XDECREF.exit3221.thread

bb.p:                                             ; preds = %Py_XDECREF.exit3247.a
  %9 = load ptr, ptr @PyExc_SystemError, align 8, !tbaa !13
  %10 = tail call i32 @PyErr_ExceptionMatches(ptr noundef %9) #4
  %.not2.i3250 = icmp eq i32 %10, 0
  br i1 %.not2.i3250, label %Py_XDECREF.exit4531, label %Py_XDECREF.exit3253

Py_XDECREF.exit3253:                              ; preds = %bb.p
  tail call void @PyErr_Clear() #4
  ...
  %.not2898 = icmp eq i32 %i.ad, 0
  br i1 %.not2898, label %Py_XDECREF.exit3221, label %bb.q
...
Py_XDECREF.exit3267.a:                            ; preds = %bb.y
  ...
  %.not2902 = icmp eq i32 %i.ax, 0
  br i1 %.not2902, label %Py_XDECREF.exit3221, label %bb.ab
...
Py_XDECREF.exit3269:                              ; preds = %bb.ab, %bb.ac
  ...
  %.not2903 = icmp eq i32 %i.az, 0
  br i1 %.not2903, label %Py_XDECREF.exit3221, label %bb.ad
...
Py_XDECREF.exit3271.a:                            ; preds = %bb.ad, %bb.ae
  ...
  %.not2904 = icmp eq i32 %i.bb, 0
  br i1 %.not2904, label %Py_XDECREF.exit3221, label %bb.af
...
Py_XDECREF.exit3273:                              ; preds = %bb.af, %bb.ag
  ...
  %.not2905 = icmp eq i32 %i.bd, 0
  br i1 %.not2905, label %Py_XDECREF.exit3221, label %bb.ah
