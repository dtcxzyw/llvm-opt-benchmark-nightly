...
bb.i:                                             ; preds = %block_len.exit212
  ...
  br i1 %i.x, label %switch.lookup414, label %16
...
block_len.exit238.thread317:                      ; preds = %block_len.exit236.thread303, %block_len.exit236
  ...
  %i.ay = mul nuw i32 %.ph316, 104                ; 2 uses
  %7 = zext i32 %i.ay to i64
...
block_len.exit238.thread321:                      ; preds = %block_len.exit236.thread307, %block_len.exit236
  ...
  %i.az = mul nuw i32 %.ph320, 72                 ; 2 uses
  %9 = zext i32 %i.az to i64
...
block_len.exit238.thread325:                      ; preds = %block_len.exit236.thread311, %block_len.exit236
  ...
  %11 = zext i32 %i.ba to i64
  %12 = getelementptr i8, ptr %1, i64 %11
  br label %block_len.exit240

block_len.exit238:                                ; preds = %block_len.exit236, %block_len.exit236
  %i.bb = mul nuw i32 %i.aw, 136                  ; 6 uses
  %13 = zext i32 %i.bb to i64
  %14 = getelementptr i8, ptr %1, i64 %13         ; 5 uses
...
block_len.exit240:                                ; preds = %block_len.exit238.thread325, %block_len.exit238.thread321, %block_len.exit238.thread317, %block_len.exit238.thread, %block_len.exit238, %bb.k, %bb.l, %bb.m, %bb.n
  %15 = phi ptr [ %14, %block_len.exit238 ], [ %14, %bb.k ], [ %6, %block_len.exit238.thread ], [ %14, %bb.l ], [ %14, %bb.m ], [ %8, %block_len.exit238.thread317 ], [ %10, %block_len.exit238.thread321 ], [ %12, %block_len.exit238.thread325 ], [ %14, %bb.n ]
  %i.bc = phi i32 [ %i.bb, %block_len.exit238 ], [ %i.bb, %bb.k ], [ %i.ax, %block_len.exit238.thread ], [ %i.bb, %bb.l ], [ %i.bb, %bb.m ], [ %i.ay, %block_len.exit238.thread317 ], [ %i.az, %block_len.exit238.thread321 ], [ %i.ba, %block_len.exit238.thread325 ], [ %i.bb, %bb.n ] ; 2 uses
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %.sroa.6104.0.copyload, ptr align 1 %15, i64 %i.bf, i1 false)
...
block_len.exit242.thread:                         ; preds = %16
  %17 = sub nsw i32 144, %.0194272                ; 2 uses
  %18 = zext i32 %17 to i64                       ; 2 uses
  %19 = getelementptr i8, ptr %1, i64 %18
  br label %block_len.exit244

block_len.exit242.thread330:                      ; preds = %16
  %20 = sub nsw i32 104, %.0194272                ; 2 uses
  %21 = zext i32 %20 to i64                       ; 2 uses
  %22 = getelementptr i8, ptr %1, i64 %21
  br label %block_len.exit244

block_len.exit242.thread334:                      ; preds = %16
  %23 = sub nsw i32 72, %.0194272                 ; 2 uses
  %24 = zext i32 %23 to i64                       ; 2 uses
  %25 = getelementptr i8, ptr %1, i64 %24
  br label %block_len.exit244

block_len.exit242.thread338:                      ; preds = %16
  %26 = sub nuw nsw i32 168, %.0194272            ; 2 uses
  %27 = zext nneg i32 %26 to i64                  ; 2 uses
  %28 = getelementptr i8, ptr %1, i64 %27
  br label %block_len.exit244

default.unreachable374:                           ; preds = %16
  unreachable

block_len.exit242:                                ; preds = %16, %16
  %29 = sub nsw i32 136, %.0194272                ; 6 uses
  %30 = zext i32 %29 to i64                       ; 6 uses
  %31 = getelementptr i8, ptr %1, i64 %30         ; 5 uses
...
32:                                               ; preds = %block_len.exit242, %block_len.exit242
  br label %block_len.exit244

33:                                               ; preds = %block_len.exit242
  br label %block_len.exit244

34:                                               ; preds = %block_len.exit242
  br label %block_len.exit244

35:                                               ; preds = %block_len.exit242
  br label %block_len.exit244

default.unreachable389:                           ; preds = %block_len.exit242
  unreachable

block_len.exit244:                                ; preds = %block_len.exit242.thread338, %block_len.exit242.thread334, %block_len.exit242.thread330, %block_len.exit242.thread, %block_len.exit242, %32, %33, %34, %35
  %36 = phi ptr [ %31, %block_len.exit242 ], [ %31, %32 ], [ %19, %block_len.exit242.thread ], [ %31, %33 ], [ %31, %34 ], [ %22, %block_len.exit242.thread330 ], [ %25, %block_len.exit242.thread334 ], [ %28, %block_len.exit242.thread338 ], [ %31, %35 ] ; 2 uses
  %37 = phi i64 [ %30, %block_len.exit242 ], [ %30, %32 ], [ %18, %block_len.exit242.thread ], [ %30, %33 ], [ %30, %34 ], [ %21, %block_len.exit242.thread330 ], [ %24, %block_len.exit242.thread334 ], [ %27, %block_len.exit242.thread338 ], [ %30, %35 ] ; 2 uses
  %38 = phi i32 [ %29, %block_len.exit242 ], [ %29, %32 ], [ %17, %block_len.exit242.thread ], [ %29, %33 ], [ %29, %34 ], [ %20, %block_len.exit242.thread330 ], [ %23, %block_len.exit242.thread334 ], [ %26, %block_len.exit242.thread338 ], [ %29, %35 ] ; 2 uses
  %.0.i243 = phi i64 [ 144, %block_len.exit242 ], [ 136, %32 ], [ 144, %block_len.exit242.thread ], [ 104, %33 ], [ 72, %34 ], [ 104, %block_len.exit242.thread330 ], [ 72, %block_len.exit242.thread334 ], [ 168, %block_len.exit242.thread338 ], [ 168, %35 ]
  %i.bh = urem i64 %.sroa.5162.0.copyload, %.0.i243
...
switch.lookup430:                                 ; preds = %block_len.exit244
  %switch.gep431 = getelementptr inbounds nuw [8 x i8], ptr @switch.table.digest_.19, i64 %i.bj
  %switch.load432 = load i64, ptr %switch.gep431, align 8
  br label %block_len.exit246

switch.lookup434:                                 ; preds = %block_len.exit244
  %switch.gep435.a = getelementptr inbounds nuw [8 x i8], ptr @switch.table.digest_.19, i64 %i.bj
...
block_len.exit246:                                ; preds = %switch.lookup430, %switch.lookup434
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.bl, ptr align 1 %1, i64 %37, i1 false)
  %i.bm = add i64 %37, %.sroa.5162.0.copyload     ; 5 uses
...
begin_hunk_17_@_Py_LibHacl_Hacl_Hash_SHA3_update:bb.a
  ...
  %i.bp = getelementptr [8 x i8], ptr @switch.table.digest_.19, i64 %i.bo
...
switch.lookup442:                                 ; preds = %block_len.exit246
  ...
  %i.bu = getelementptr [8 x i8], ptr @switch.table.digest_.19, i64 %i.bt
...
switch.lookup456:                                 ; preds = %block_len.exit268
  ...
  %i.dc = getelementptr i8, ptr %36, i64 %i.db
  ...
  tail call void @_Py_LibHacl_Hacl_Hash_SHA3_update_multi_sha3(i8 noundef zeroext %.sroa.0.0.copyload, ptr noundef %.sroa.5.0.copyload, ptr noundef %36, i32 noundef %i.df)
...
switch.lookup118:                                 ; preds = %block_len.exit67
  ...
  %switch.gep119 = getelementptr inbounds nuw [4 x i8], ptr @switch.table.digest_.20, i64 %i.al
