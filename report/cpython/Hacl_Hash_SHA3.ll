...
begin_hunk_1_@absorb_inner_32:.preheader
  ...
  %.val617 = load i64, ptr %i.u, align 1
  %i.v = load i64, ptr %1, align 8, !tbaa !15
  %3 = xor i64 %.val641, %i.v                     ; 2 uses
  %i.w = getelementptr i8, ptr %1, i64 8          ; 4 uses
  %4 = getelementptr i8, ptr %1, i64 16           ; 3 uses
  %i.x = load <2 x i64>, ptr %i.a, align 1
  %i.y = load <2 x i64>, ptr %i.w, align 8, !tbaa !15
  %i.z = xor <2 x i64> %i.x, %i.y
  %i.aa = getelementptr i8, ptr %1, i64 24        ; 4 uses
  %i.ab = getelementptr i8, ptr %1, i64 32        ; 2 uses
  %i.ac = load <2 x i64>, ptr %2, align 1
  store i64 %3, ptr %1, align 8, !tbaa !15
  store <2 x i64> %i.z, ptr %i.w, align 8, !tbaa !15
  %5 = load <2 x i64>, ptr %i.aa, align 8, !tbaa !15
  %6 = xor <2 x i64> %i.ac, %5
  store <2 x i64> %6, ptr %i.aa, align 8, !tbaa !15
...
begin_hunk_2_@absorb_inner_32:.preheader
  ...
  %i.ck = xor i64 %.val617, %i.cj
  %.promoted = load i64, ptr %i.w, align 8, !tbaa !15
  %.promoted657 = load i64, ptr %4, align 8, !tbaa !15
  %.promoted658 = load i64, ptr %i.aa, align 8, !tbaa !15
  %.promoted659 = load i64, ptr %i.ab, align 8, !tbaa !15
  br label %bb.b
...
begin_hunk_3_@absorb_inner_32:.preheader
  ...
  %i.dj = phi i64 [ %3, %.preheader ], [ %i.jk, %bb.b ] ; 2 uses
...
begin_hunk_4_@absorb_inner_32:.preheader
  ...
  store i64 %i.eu, ptr %4, align 8, !tbaa !15
...
begin_hunk_5_@absorb_inner_32:.preheader
  ...
  store i64 %i.gs, ptr %4, align 8, !tbaa !15
  store i64 %i.gv, ptr %i.aa, align 8, !tbaa !15
  store i64 %i.gy, ptr %i.ab, align 8, !tbaa !15
  %i.gz = xor i64 %i.gj, -1
...
begin_hunk_7_@_Py_LibHacl_Hacl_Hash_SHA3_absorb_inner_32:.preheader
  ...
  %.val617 = load i64, ptr %i.u, align 1
  %i.v = load i64, ptr %2, align 8, !tbaa !15
  %4 = xor i64 %.val641, %i.v                     ; 2 uses
  %i.w = getelementptr i8, ptr %2, i64 8          ; 4 uses
  %5 = getelementptr i8, ptr %2, i64 16           ; 3 uses
  %i.x = load <2 x i64>, ptr %i.a, align 1
  %i.y = load <2 x i64>, ptr %i.w, align 8, !tbaa !15
  %i.z = xor <2 x i64> %i.x, %i.y
  %i.aa = getelementptr i8, ptr %2, i64 24        ; 4 uses
  %i.ab = getelementptr i8, ptr %2, i64 32        ; 2 uses
  %i.ac = load <2 x i64>, ptr %3, align 1
  store i64 %4, ptr %2, align 8, !tbaa !15
  store <2 x i64> %i.z, ptr %i.w, align 8, !tbaa !15
  %6 = load <2 x i64>, ptr %i.aa, align 8, !tbaa !15
  %7 = xor <2 x i64> %i.ac, %6
  store <2 x i64> %7, ptr %i.aa, align 8, !tbaa !15
...
begin_hunk_8_@_Py_LibHacl_Hacl_Hash_SHA3_absorb_inner_32:.preheader
  ...
  %i.ck = xor i64 %.val617, %i.cj
  %.promoted = load i64, ptr %i.w, align 8, !tbaa !15
  %.promoted657 = load i64, ptr %5, align 8, !tbaa !15
  %.promoted658 = load i64, ptr %i.aa, align 8, !tbaa !15
  %.promoted659 = load i64, ptr %i.ab, align 8, !tbaa !15
  br label %bb.b
...
begin_hunk_9_@_Py_LibHacl_Hacl_Hash_SHA3_absorb_inner_32:.preheader
  ...
  %i.dh = phi i64 [ %i.au, %.preheader ], [ %i.hq, %bb.b ] ; 2 uses
  %i.di = phi i64 [ %i.af, %.preheader ], [ %i.hb, %bb.b ] ; 2 uses
  %i.dj = phi i64 [ %4, %.preheader ], [ %i.jk, %bb.b ] ; 2 uses
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %bb.b ] ; 2 uses
  %i.dk = xor i64 %i.di, %i.dj
  %i.dl = xor i64 %i.dk, %i.dh
end_hunk_9
begin_hunk_10_@_Py_LibHacl_Hacl_Hash_SHA3_absorb_inner_32:.preheader
  ...
  %i.et = xor i64 %i.es, %i.dr                    ; 5 uses
  %i.eu = xor i64 %i.et, %i.cn                    ; 3 uses
  store i64 %i.eu, ptr %5, align 8, !tbaa !15
  %i.ev = xor i64 %i.et, %i.da                    ; 2 uses
  %i.ew = xor i64 %i.et, %i.cz                    ; 2 uses
  %i.ex = xor i64 %i.et, %i.cy                    ; 2 uses
end_hunk_10
begin_hunk_11_@_Py_LibHacl_Hacl_Hash_SHA3_absorb_inner_32:.preheader
  ...
  %i.gy = xor i64 %i.fy, %i.gx                    ; 2 uses
  store i64 %i.gp, ptr %i.w, align 8, !tbaa !15
  store i64 %i.gs, ptr %5, align 8, !tbaa !15
  store i64 %i.gv, ptr %i.aa, align 8, !tbaa !15
  store i64 %i.gy, ptr %i.ab, align 8, !tbaa !15
  %i.gz = xor i64 %i.gj, -1
  %i.ha = and i64 %i.fo, %i.gz
