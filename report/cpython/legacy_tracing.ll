...
begin_hunk_2_@sys_profile_return:bb.a
  ...
  %i.s = tail call i32 %i.n(ptr noundef %i.p, ptr noundef nonnull %i.h, i32 noundef %i.r, ptr noundef %i.b) #4, !inline_history !127
...
begin_hunk_3_@sys_profile_unwind:bb.a
  ...
  %i.o = getelementptr i8, ptr %0, i64 24
  %i.p = load i32, ptr %i.o, align 8, !tbaa !113
  %i.q = tail call i32 %i.l(ptr noundef %i.n, ptr noundef nonnull %i.f, i32 noundef %i.p, ptr noundef null) #4, !inline_history !127
  %i.r = load i32, ptr %i.f, align 8, !tbaa !36   ; 2 uses
  %.not.i.i = icmp sgt i32 %i.r, -1
  br i1 %.not.i.i, label %bb.f, label %Py_DECREF.exit.i
end_hunk_3
begin_hunk_4_@sys_profile_call_or_return:bb.a
  ...
  %.val22 = load ptr, ptr %i.c, align 8, !tbaa !128 ; 2 uses
...
begin_hunk_5_@sys_profile_call_or_return:bb.a
  ...
  %i.u = tail call i32 %i.p(ptr noundef %i.r, ptr noundef nonnull %i.j, i32 noundef %i.t, ptr noundef nonnull %i.b) #4, !inline_history !127
...
bb.h:                                             ; preds = %PyObject_TypeCheck.exit
  %.val21 = load ptr, ptr %i.c, align 8, !tbaa !128
...
bb.j:                                             ; preds = %bb.i
  %i.ac = load ptr, ptr getelementptr inbounds nuw (i8, ptr @PyMethodDescr_Type, i64 272), align 8, !tbaa !129
  %i.ad = getelementptr i8, ptr %i.aa, i64 8
  %.val = load ptr, ptr %i.ad, align 8, !tbaa !128
...
begin_hunk_8_@sys_profile_call_or_return:bb.a
  ...
  %i.aw = tail call i32 %i.ar(ptr noundef %i.at, ptr noundef nonnull %i.al, i32 noundef %i.av, ptr noundef nonnull %i.ae) #4, !inline_history !127
...
begin_hunk_9_@sys_trace_exception_func:bb.a
  ...
  %.val = load ptr, ptr %i.c, align 8, !tbaa !128
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.m = load i8, ptr %i.l, align 4, !tbaa !135
...
Py_INCREF.exit.i:                                 ; preds = %bb.f, %bb.e
  ...
  store i32 %i.h, ptr %i.r, align 8, !tbaa !136
  ...
  %i.x = tail call i32 %i.s(ptr noundef %i.u, ptr noundef nonnull %i.i, i32 noundef %i.w, ptr noundef nonnull @_Py_NoneStruct) #4, !inline_history !137
  store i32 0, ptr %i.r, align 8, !tbaa !136
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.v = load i8, ptr %i.u, align 4, !tbaa !135
...
Py_INCREF.exit.i:                                 ; preds = %bb.h, %bb.g
  ...
  store i32 %i.p, ptr %i.aa, align 8, !tbaa !136
  ...
  %i.ag = tail call i32 %i.ab(ptr noundef %i.ad, ptr noundef nonnull %i.r, i32 noundef %i.af, ptr noundef nonnull @_Py_NoneStruct) #4, !inline_history !137
  store i32 0, ptr %i.aa, align 8, !tbaa !136
