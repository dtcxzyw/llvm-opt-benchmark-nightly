...
.thread88:                                        ; preds = %bb.m
  %4 = load i32, ptr %i.d, align 4, !tbaa !7
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #19
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #19
  br label %bb.w
...
bb.r:                                             ; preds = %bb.q, %bb.p
  ...
  br i1 %.not69, label %.thread80, label %bb.s

bb.s:                                             ; preds = %bb.r, %bb.q, %bb.o
  %.148 = phi ptr [ %.047, %bb.r ], [ %.047, %bb.q ], [ %i.aj, %bb.o ] ; 2 uses
  %.1 = phi ptr [ %.046, %bb.r ], [ %i.am, %bb.q ], [ @_Py_NoneStruct, %bb.o ] ; 2 uses
  %5 = load i32, ptr %i.d, align 4, !tbaa !7      ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #19
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #19
...
bb.w:                                             ; preds = %.thread88, %bb.v, %bb.u
  ...
  %i.av = phi i32 [ %5, %bb.u ], [ %5, %bb.v ], [ %4, %.thread88 ]
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %.not29, label %os_pidfd_open_impl.exit, label %bb.h

bb.h:                                             ; preds = %bb.g, %bb.f
  %4 = load i32, ptr %i.b, align 4, !tbaa !7
