...
.lr.ph114.i:                                      ; preds = %._crit_edge.i, %.thread99.i
  ...
  %4 = getelementptr i8, ptr %0, i64 %.158112.i   ; 3 uses
  %5 = load i32, ptr %4, align 1
  %6 = xor i32 %5, 1768189795
  %i.k = getelementptr i8, ptr %4, i64 4
  %7 = load i16, ptr %i.k, align 1
  %8 = zext i16 %7 to i32
  %9 = xor i32 %8, 26478
  %10 = or i32 %6, %9
  %11 = icmp ne i32 %10, 0
  %12 = zext i1 %11 to i32
  %i.l = icmp eq i32 %12, 0
  br i1 %i.l, label %bb.e, label %.thread99.i

bb.e:                                             ; preds = %.lr.ph114.i
  %i.m = getelementptr i8, ptr %4, i64 6          ; 2 uses
...
begin_hunk_29
  ...
  %i.aa = add i64 %i.z, 1
  %i.ab = tail call ptr @PyMem_Malloc(i64 noundef %i.aa) #8 ; 19 uses
...
bb.af:                                            ; preds = %.sink.split.i.i, %bb.ad, %bb.ab, %bb.z, %bb.x, %bb.v, %bb.t, %bb.r, %bb.p, %bb.n, %bb.l, %bb.j, %bb.h
  ...
  %13 = load i32, ptr %i.a, align 1
  %14 = xor i32 %13, 761689205
  %15 = getelementptr i8, ptr %i.a, i64 4
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %32 = icmp ne i64 %31, 13842226097709420
  %33 = zext i1 %32 to i32
  %i.cn = icmp eq i32 %33, 0
  br i1 %i.cn, label %get_normal_name.exit.i, label %bb.ai

bb.ai:                                            ; preds = %bb.ah
  %34 = load i64, ptr %i.a, align 1
  %35 = xor i64 %34, 4122262847859159913
  %36 = getelementptr i8, ptr %i.a, i64 3
  %37 = load i64, ptr %36, align 1
  %38 = xor i64 %37, 13841997588084781
  %39 = or i64 %35, %38
  %40 = icmp ne i64 %39, 0
  %41 = zext i1 %40 to i32
  %i.co = icmp eq i32 %41, 0
  br i1 %i.co, label %get_normal_name.exit.i, label %bb.aj

bb.aj:                                            ; preds = %bb.ai
  %42 = load i64, ptr %i.a, align 1
  %43 = xor i64 %42, 7598805588527510377
  %44 = getelementptr i8, ptr %i.a, i64 8
  %45 = load i32, ptr %44, align 1
  %46 = zext i32 %45 to i64
  %47 = xor i64 %46, 3222894
  %48 = or i64 %43, %47
  %49 = icmp ne i64 %48, 0
  %50 = zext i1 %49 to i32
  %i.cp = icmp eq i32 %50, 0
  br i1 %i.cp, label %get_normal_name.exit.i, label %bb.ak

bb.ak:                                            ; preds = %bb.aj
  %51 = load i64, ptr %i.a, align 1
  %52 = icmp ne i64 %51, 3256433957804466540
  %53 = zext i1 %52 to i32
  %i.cq = icmp eq i32 %53, 0
  br i1 %i.cq, label %get_normal_name.exit.i, label %bb.al

bb.al:                                            ; preds = %bb.ak
  %54 = load i64, ptr %i.a, align 1
  %55 = xor i64 %54, 4122262847859159913
  %56 = getelementptr i8, ptr %i.a, i64 3
  %57 = load i64, ptr %56, align 1
  %58 = xor i64 %57, 3256433729294841901
  %59 = or i64 %55, %58
  %60 = icmp ne i64 %59, 0
  %61 = zext i1 %60 to i32
  %i.cr = icmp eq i32 %61, 0
  br i1 %i.cr, label %get_normal_name.exit.i, label %bb.am

bb.am:                                            ; preds = %bb.al
  %62 = load i64, ptr %i.a, align 1
  %63 = xor i64 %62, 7598805588527510377
  %64 = getelementptr i8, ptr %i.a, i64 8
  %65 = load i32, ptr %64, align 1
  %66 = zext i32 %65 to i64
  %67 = xor i64 %66, 758197614
  %68 = or i64 %63, %67
  %69 = icmp ne i64 %68, 0
  %70 = zext i1 %69 to i32
  %i.cs = icmp eq i32 %70, 0
...
bb.an:                                            ; preds = %get_normal_name.exit.i
  ...
  %i.ct = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %.012.i.i) #9 ; 3 uses
  %i.cu = add i64 %i.ct, 1
  %i.cv = tail call ptr @PyMem_Malloc(i64 noundef %i.cu) #8 ; 4 uses
...
bb.ar:                                            ; preds = %bb.aq
  %i.di = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %.053.ph.ph, ptr noundef nonnull dereferenceable(6) @.str.3) #9
  %.not44 = icmp eq i32 %i.di, 0
  br i1 %.not44, label %bb.au, label %bb.as

bb.as:                                            ; preds = %bb.ar
  %i.dj = tail call i32 %3(ptr noundef nonnull %2, ptr noundef nonnull %.053.ph.ph) #8
...
bb.at:                                            ; preds = %bb.as
  ...
  %i.dm = tail call ptr (ptr, ptr, ...) @PyErr_Format(ptr noundef %i.dl, ptr noundef nonnull @.str.4, ptr noundef nonnull %.053.ph.ph) #8 ; 0 uses
...
bb.av:                                            ; preds = %bb.aq
  %i.dn = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %i.dg, ptr noundef nonnull dereferenceable(1) %.053.ph.ph) #9
...
bb.az:                                            ; preds = %bb.ay
  tail call void @PyMem_Free(ptr noundef nonnull %i.dx) #8
