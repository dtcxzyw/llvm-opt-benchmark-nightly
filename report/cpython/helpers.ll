...
begin_hunk_27_@_PyTokenizer_check_coding_spec:bb.a
  ...
  %i.aj = add i64 %i.ai, 1
  %i.ak = tail call ptr @PyMem_Malloc(i64 noundef %i.aj) #9 ; 19 uses
...
bb.an:                                            ; preds = %get_normal_name.exit.i
  tail call void @PyMem_Free(ptr noundef nonnull %i.ak) #9
  %i.fi = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %.012.i.i) #10 ; 3 uses
  %i.fj = add i64 %i.fi, 1
  %i.fk = tail call ptr @PyMem_Malloc(i64 noundef %i.fj) #9 ; 4 uses
...
bb.ar:                                            ; preds = %bb.aq
  %i.fx = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %.053.ph.ph, ptr noundef nonnull dereferenceable(6) @.str.3) #10
  %.not44 = icmp eq i32 %i.fx, 0
  br i1 %.not44, label %bb.au, label %bb.as

bb.as:                                            ; preds = %bb.ar
  %i.fy = tail call i32 %3(ptr noundef nonnull %2, ptr noundef nonnull %.053.ph.ph) #9
...
bb.at:                                            ; preds = %bb.as
  ...
  %i.gb = tail call ptr (ptr, ptr, ...) @PyErr_Format(ptr noundef %i.ga, ptr noundef nonnull @.str.4, ptr noundef nonnull %.053.ph.ph) #9 ; 0 uses
...
bb.av:                                            ; preds = %bb.aq
  %i.gc = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %i.fv, ptr noundef nonnull dereferenceable(1) %.053.ph.ph) #10
...
bb.az:                                            ; preds = %bb.ay
  tail call void @PyMem_Free(ptr noundef nonnull %i.gm) #9
