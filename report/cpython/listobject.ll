...
bb.q:                                             ; preds = %.epil.preheader
  ...
  %2 = add nuw i64 %1, %i.ax
  %i.ay = add i64 %2, -1                          ; 2 uses
...
bb.t:                                             ; preds = %_Py_RefcntAdd.exit
  ...
  %i.bx = add i64 %i.bw, %invariant.op40          ; 2 uses
