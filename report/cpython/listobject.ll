...
bb.a:
  ...
  %.val8 = load ptr, ptr %i.a, align 8, !tbaa !46 ; 2 uses
  %i.b = getelementptr i8, ptr %.val8, i64 168
  %.val9 = load i64, ptr %i.b, align 8, !tbaa !53
  %i.c = and i64 %.val9, 33554432
  %.not = icmp eq i64 %i.c, 0
  br i1 %.not, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %i.d = load ptr, ptr @PyExc_TypeError, align 8, !tbaa !54
...
bb.c:                                             ; preds = %bb.a
  ...
  %.val35.i = load i64, ptr %i.h, align 8, !tbaa !33
  %i.i = getelementptr i8, ptr %1, i64 16         ; 3 uses
  %.val34.i = load i64, ptr %i.i, align 8, !tbaa !33
  %i.j = add i64 %.val34.i, %.val35.i             ; 5 uses
  %i.k = icmp eq i64 %i.j, 0
  %i.l = tail call ptr @PyList_New(i64 noundef 0), !inline_history !158 ; 9 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.q = tail call ptr @PyMem_Malloc(i64 noundef %i.p) #13, !inline_history !159 ; 3 uses
...
bb.j:                                             ; preds = %list_new_prealloc.exit._crit_edge.i, %list_new_prealloc.exit.thread38.i
  ...
  %.val3341.i = load i64, ptr %i.h, align 8, !tbaa !33 ; 3 uses
...
.lr.ph.i:                                         ; preds = %bb.j, %_Py_NewRef.exit.i
  ...
  %i.af = load ptr, ptr %i.ae, align 8, !tbaa !54 ; 3 uses
  %i.ag = load i32, ptr %i.af, align 8, !tbaa !32 ; 2 uses
  %i.ah = icmp ugt i32 %i.ag, -1073741825
  br i1 %i.ah, label %_Py_NewRef.exit.i, label %bb.k

bb.k:                                             ; preds = %.lr.ph.i
  %i.ai = add nuw i32 %i.ag, 1
  store i32 %i.ai, ptr %i.af, align 8, !tbaa !32
  %.val33.pre.i = load i64, ptr %i.h, align 8, !tbaa !33
...
_Py_NewRef.exit.i:                                ; preds = %bb.k, %.lr.ph.i
  ...
  store ptr %i.af, ptr %i.aj, align 8, !tbaa !54
  %i.ak = add nuw nsw i64 %.02942.i, 1            ; 2 uses
  %i.al = icmp slt i64 %i.ak, %.val33.i
  br i1 %i.al, label %.lr.ph.i, label %._crit_edge.loopexit.i, !llvm.loop !160

._crit_edge.loopexit.i:                           ; preds = %_Py_NewRef.exit.i
  %.pre51.i = load ptr, ptr %i.ac, align 8, !tbaa !31
...
._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %bb.j
  ...
  %.val43.i = load i64, ptr %i.i, align 8, !tbaa !33 ; 2 uses
...
.lr.ph46.i:                                       ; preds = %._crit_edge.i, %_Py_NewRef.exit36.i
  ...
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !54 ; 3 uses
  %i.at = load i32, ptr %i.as, align 8, !tbaa !32 ; 2 uses
...
bb.l:                                             ; preds = %.lr.ph46.i
  ...
  store i32 %i.av, ptr %i.as, align 8, !tbaa !32
  %.val.pre.i = load i64, ptr %i.i, align 8, !tbaa !33
...
bb.a:
  %i.a = getelementptr i8, ptr %0, i64 16
  %.val.i = load i64, ptr %i.a, align 8, !tbaa !33 ; 8 uses
...
bb.b:                                             ; preds = %bb.a
  %i.d = tail call ptr @PyList_New(i64 noundef 0), !inline_history !162
...
bb.d:                                             ; preds = %bb.c
  %i.g = tail call ptr @PyErr_NoMemory() #13, !inline_history !162
  br label %list_repeat_lock_held.exit

bb.e:                                             ; preds = %bb.c
  %i.h = mul i64 %.val.i, %1                      ; 6 uses
  %i.i = tail call ptr @PyList_New(i64 noundef 0), !inline_history !163 ; 8 uses
...
bb.k:                                             ; preds = %list_new_prealloc.exit._crit_edge.i, %list_new_prealloc.exit.thread45.i
  %i.w = phi ptr [ %i.n, %list_new_prealloc.exit.thread45.i ], [ %.pre.i, %list_new_prealloc.exit._crit_edge.i ] ; 7 uses
  ...
  %i.aa = load ptr, ptr %i.z, align 8, !tbaa !31  ; 7 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  store i32 %i.ah, ptr %i.ab, align 8, !tbaa !32
...
_Py_RefcntAdd.exit.i:                             ; preds = %bb.m, %bb.l
  ...
  br i1 %i.aj, label %.lr.ph52.i, label %_Py_memory_repeat.exit.i

.lr.ph52.i:                                       ; preds = %_Py_RefcntAdd.exit.i, %.lr.ph52.i
  %.03651.i = phi ptr [ %i.ak, %.lr.ph52.i ], [ %i.w, %_Py_RefcntAdd.exit.i ] ; 2 uses
  %i.ak = getelementptr i8, ptr %.03651.i, i64 8  ; 2 uses
  store ptr %i.ab, ptr %.03651.i, align 8, !tbaa !54
  %i.al = icmp ult ptr %i.ak, %i.ai
  br i1 %i.al, label %.lr.ph52.i, label %_Py_memory_repeat.exit.i, !llvm.loop !164

bb.n:                                             ; preds = %bb.k
  %i.am = getelementptr [8 x i8], ptr %i.aa, i64 %.val.i ; 2 uses
  %i.an = icmp ult ptr %i.aa, %i.am
  br i1 %i.an, label %.lr.ph.i.preheader, label %._crit_edge.i
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader
  %2 = load ptr, ptr %i.aa, align 8, !tbaa !54    ; 3 uses
  %3 = load i32, ptr %2, align 8, !tbaa !32       ; 2 uses
  %.not.i42.i.prol = icmp sgt i32 %3, -1
  br i1 %.not.i42.i.prol, label %4, label %_Py_RefcntAdd.exit43.i.prol

4:                                                ; preds = %.lr.ph.i.prol
  %5 = zext nneg i32 %3 to i64
  %6 = add nuw i64 %1, %5                         ; 2 uses
  %7 = icmp sgt i64 %6, 2147483647
  %8 = trunc i64 %6 to i32
  %9 = select i1 %7, i32 -1073741824, i32 %8
  store i32 %9, ptr %2, align 8, !tbaa !32
  %.pre54.i.prol = load ptr, ptr %i.aa, align 8, !tbaa !54
  br label %_Py_RefcntAdd.exit43.i.prol

_Py_RefcntAdd.exit43.i.prol:                      ; preds = %4, %.lr.ph.i.prol
  %10 = phi ptr [ %2, %.lr.ph.i.prol ], [ %.pre54.i.prol, %4 ]
  %11 = getelementptr i8, ptr %i.aa, i64 8
  %12 = getelementptr i8, ptr %i.w, i64 8
  store ptr %10, ptr %i.w, align 8, !tbaa !54
  br label %.lr.ph.i.prol.loopexit

.lr.ph.i.prol.loopexit:                           ; preds = %_Py_RefcntAdd.exit43.i.prol, %.lr.ph.i.preheader
  %.050.i.unr = phi ptr [ %i.aa, %.lr.ph.i.preheader ], [ %11, %_Py_RefcntAdd.exit43.i.prol ]
  %.149.i.unr = phi ptr [ %i.w, %.lr.ph.i.preheader ], [ %12, %_Py_RefcntAdd.exit43.i.prol ]
  %13 = and i64 %.val.i, 2305843009213693951
  %14 = icmp eq i64 %13, 1
  br i1 %14, label %._crit_edge.loopexit.i, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %_Py_RefcntAdd.exit43.i.a
  %.050.i = phi ptr [ %i.aw, %_Py_RefcntAdd.exit43.i.a ], [ %.050.i.unr, %.lr.ph.i.prol.loopexit ] ; 4 uses
  %.149.i = phi ptr [ %i.ax, %_Py_RefcntAdd.exit43.i.a ], [ %.149.i.unr, %.lr.ph.i.prol.loopexit ] ; 3 uses
  %i.ao = load ptr, ptr %.050.i, align 8, !tbaa !54 ; 3 uses
  %i.ap = load i32, ptr %i.ao, align 8, !tbaa !32 ; 2 uses
  %.not.i42.i = icmp sgt i32 %i.ap, -1
  br i1 %.not.i42.i, label %15, label %_Py_RefcntAdd.exit43.i

15:                                               ; preds = %.lr.ph.i
  %16 = zext nneg i32 %i.ap to i64
  %17 = add nuw i64 %1, %16                       ; 2 uses
  %18 = icmp sgt i64 %17, 2147483647
  %19 = trunc i64 %17 to i32
  %20 = select i1 %18, i32 -1073741824, i32 %19
  store i32 %20, ptr %i.ao, align 8, !tbaa !32
  %.pre54.i = load ptr, ptr %.050.i, align 8, !tbaa !54
  br label %_Py_RefcntAdd.exit43.i

_Py_RefcntAdd.exit43.i:                           ; preds = %15, %.lr.ph.i
  %21 = phi ptr [ %i.ao, %.lr.ph.i ], [ %.pre54.i, %15 ]
  %22 = getelementptr i8, ptr %.050.i, i64 8      ; 2 uses
  %23 = getelementptr i8, ptr %.149.i, i64 8
  store ptr %21, ptr %.149.i, align 8, !tbaa !54
  %24 = load ptr, ptr %22, align 8, !tbaa !54     ; 3 uses
  %25 = load i32, ptr %24, align 8, !tbaa !32     ; 2 uses
  %.not.i42.i.1 = icmp sgt i32 %25, -1
  br i1 %.not.i42.i.1, label %bb.o, label %_Py_RefcntAdd.exit43.i.a

bb.o:                                             ; preds = %_Py_RefcntAdd.exit43.i
  %i.aq = zext nneg i32 %25 to i64
  ...
  store i32 %i.au, ptr %24, align 8, !tbaa !32
  %.pre54.i.a = load ptr, ptr %22, align 8, !tbaa !54
  br label %_Py_RefcntAdd.exit43.i.a

_Py_RefcntAdd.exit43.i.a:                         ; preds = %bb.o, %_Py_RefcntAdd.exit43.i
  %i.av = phi ptr [ %24, %_Py_RefcntAdd.exit43.i ], [ %.pre54.i.a, %bb.o ]
  %i.aw = getelementptr i8, ptr %.050.i, i64 16   ; 2 uses
  %i.ax = getelementptr i8, ptr %.149.i, i64 16
  store ptr %i.av, ptr %23, align 8, !tbaa !54
  %i.ay = icmp ult ptr %i.aw, %i.am
  br i1 %i.ay, label %.lr.ph.i, label %._crit_edge.loopexit.i, !llvm.loop !165

._crit_edge.loopexit.i:                           ; preds = %_Py_RefcntAdd.exit43.i.a, %.lr.ph.i.prol.loopexit
  %.pre55.i = load ptr, ptr %i.x, align 8, !tbaa !31
  br label %._crit_edge.i
...
.lr.ph.i.i:                                       ; preds = %._crit_edge.i, %.lr.ph.i.i
  ...
  br i1 %i.bh, label %.lr.ph.i.i, label %_Py_memory_repeat.exit.i, !llvm.loop !3

_Py_memory_repeat.exit.i:                         ; preds = %.lr.ph.i.i, %.lr.ph52.i, %._crit_edge.i, %_Py_RefcntAdd.exit.i
  %i.bi = getelementptr i8, ptr %.0.i47.i, i64 16
  store i64 %i.h, ptr %i.bi, align 8, !tbaa !33
  br label %list_repeat_lock_held.exit
...
bb.b:                                             ; preds = %bb.a
  %i.b = load ptr, ptr @PyExc_IndexError, align 8, !tbaa !54
...
bb.a:
  ...
  %.val23.i = load i64, ptr %i.a, align 8, !tbaa !33 ; 2 uses
...
.lr.ph.preheader.i:                               ; preds = %.preheader.i
  ...
  %i.k = sub nuw i64 %i.h, %1
  %i.l = shl nuw i64 %i.k, 3
  tail call void @llvm.memmove.p0.p0.i64(ptr align 8 %scevgep.i, ptr align 8 %scevgep25.i, i64 %i.l, i1 false), !tbaa !54
  br label %._crit_edge.i
...
bb.d:                                             ; preds = %bb.c
  %i.m = load i32, ptr %2, align 8, !tbaa !32     ; 2 uses
  %i.n = icmp ugt i32 %i.m, -1073741825
  br i1 %i.n, label %_Py_NewRef.exit.i, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.o = add nuw i32 %i.m, 1
  store i32 %i.o, ptr %2, align 8, !tbaa !32
  %.pre.i = load ptr, ptr %i.c, align 8, !tbaa !31
  br label %_Py_NewRef.exit.i
...
bb.a:
  %i.a = getelementptr i8, ptr %0, i64 16         ; 2 uses
  %.val.i22 = load i64, ptr %i.a, align 8, !tbaa !33
...
bb.b:                                             ; preds = %list_get_item_ref.exit
  ...
  %.val.i = load i64, ptr %i.a, align 8, !tbaa !33
