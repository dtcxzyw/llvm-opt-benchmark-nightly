...
.lr.ph.i.i93.i:                                   ; preds = %sortslice_advance.exit.i, %.lr.ph.i.i93.i
  ...
  %i.fl = load ptr, ptr %.012.i.i95.i, align 8, !tbaa !54
  %i.fm = load ptr, ptr %.01013.i.i94.i, align 8, !tbaa !54
  store ptr %i.fm, ptr %.012.i.i95.i, align 8, !tbaa !54
  store ptr %i.fl, ptr %.01013.i.i94.i, align 8, !tbaa !54
  ...
  br i1 %i.fo, label %.lr.ph.i.i93.i, label %reverse_slice.exit.i85.i, !llvm.loop !1
...
.lr.ph.i7.i89.i:                                  ; preds = %reverse_slice.exit.i85.i, %.lr.ph.i7.i89.i
  ...
  %i.fr = load ptr, ptr %.012.i9.i91.i, align 8, !tbaa !54
  %i.fs = load ptr, ptr %.01013.i8.i90.i, align 8, !tbaa !54
  store ptr %i.fs, ptr %.012.i9.i91.i, align 8, !tbaa !54
  store ptr %i.fr, ptr %.01013.i8.i90.i, align 8, !tbaa !54
  ...
  br i1 %i.fu, label %.lr.ph.i7.i89.i, label %sortslice_reverse.exit97.i, !llvm.loop !1

bb.ap:                                            ; preds = %bb.an
  %i.fv = load ptr, ptr %i.dt, align 8, !tbaa !62
  %i.fw = load ptr, ptr %i.fb, align 8, !tbaa !54
  %i.fx = load ptr, ptr %i.ez, align 8, !tbaa !54
  %i.fy = call i32 %i.fv(ptr noundef %i.fw, ptr noundef %i.fx, ptr noundef nonnull %3) #13, !inline_history !101 ; 2 uses
...
.lr.ph.i.i109.i:                                  ; preds = %sortslice_advance.exit99.i, %.lr.ph.i.i109.i
  ...
  %i.gh = load ptr, ptr %.012.i.i111.i, align 8, !tbaa !54
  %i.gi = load ptr, ptr %.01013.i.i110.i, align 8, !tbaa !54
  store ptr %i.gi, ptr %.012.i.i111.i, align 8, !tbaa !54
  store ptr %i.gh, ptr %.01013.i.i110.i, align 8, !tbaa !54
  ...
  br i1 %i.gk, label %.lr.ph.i.i109.i, label %reverse_slice.exit.i101.i, !llvm.loop !1
...
.lr.ph.i7.i105.i:                                 ; preds = %reverse_slice.exit.i101.i, %.lr.ph.i7.i105.i
  ...
  %i.gn = load ptr, ptr %.012.i9.i107.i, align 8, !tbaa !54
  %i.go = load ptr, ptr %.01013.i8.i106.i, align 8, !tbaa !54
  store ptr %i.go, ptr %.012.i9.i107.i, align 8, !tbaa !54
  store ptr %i.gn, ptr %.01013.i8.i106.i, align 8, !tbaa !54
  ...
  br i1 %i.gq, label %.lr.ph.i7.i105.i, label %sortslice_reverse.exit113.i, !llvm.loop !1
...
.lr.ph.i.i123.i:                                  ; preds = %sortslice_reverse.exit113.i, %.lr.ph.i.i123.i
  ...
  %i.gt = load ptr, ptr %.012.i.i125.i, align 8, !tbaa !54
  %i.gu = load ptr, ptr %.01013.i.i124.i, align 8, !tbaa !54
  store ptr %i.gu, ptr %.012.i.i125.i, align 8, !tbaa !54
  store ptr %i.gt, ptr %.01013.i.i124.i, align 8, !tbaa !54
  ...
  br i1 %i.gw, label %.lr.ph.i.i123.i, label %reverse_slice.exit.i115.i, !llvm.loop !1
...
.lr.ph.i7.i119.i:                                 ; preds = %reverse_slice.exit.i115.i, %.lr.ph.i7.i119.i
  ...
  %i.gz = load ptr, ptr %.012.i9.i121.i, align 8, !tbaa !54
  %i.ha = load ptr, ptr %.01013.i8.i120.i, align 8, !tbaa !54
  store ptr %i.ha, ptr %.012.i9.i121.i, align 8, !tbaa !54
  store ptr %i.gz, ptr %.01013.i8.i120.i, align 8, !tbaa !54
  ...
  br i1 %i.hc, label %.lr.ph.i7.i119.i, label %sortslice_reverse.exit127.i, !llvm.loop !1
...
.lr.ph158.i:                                      ; preds = %sortslice_reverse.exit127.i, %bb.at
  ...
  %i.he = load ptr, ptr %i.dt, align 8, !tbaa !62
  ...
  %i.hi = load ptr, ptr %i.hh, align 8, !tbaa !54
  %i.hj = call i32 %i.he(ptr noundef %i.hg, ptr noundef %i.hi, ptr noundef nonnull %3) #13, !inline_history !101 ; 2 uses
...
count_run.exit.thread275:                         ; preds = %._crit_edge.thread182.i, %bb.ak, %count_run.exit
  ...
  %i.hn = load i64, ptr %i.cv, align 8, !tbaa !113
  %i.ho = load i64, ptr %i.df, align 8, !tbaa !117
  %i.hp = add i64 %i.ho, %i.hn                    ; 2 uses
  %i.hq = load i64, ptr %i.da, align 8, !tbaa !115
  %i.hr = ashr i64 %i.hp, %i.hq                   ; 2 uses
  %i.hs = load i64, ptr %i.de, align 8, !tbaa !116
  %i.ht = and i64 %i.hs, %i.hp
  store i64 %i.ht, ptr %i.df, align 8, !tbaa !117
...
.lr.ph10.split.us.i:                              ; preds = %.lr.ph10.i, %._crit_edge.us.i
  ...
  %i.hy = load ptr, ptr %i.hx, align 8, !tbaa !54 ; 2 uses
  br label %bb.av
...
bb.av:                                            ; preds = %bb.aw, %.lr.ph10.split.us.i
  ...
  %i.ib = load ptr, ptr %i.dt, align 8, !tbaa !62
  %i.ic = getelementptr [8 x i8], ptr %.sroa.0.1, i64 %i.ia
  %i.id = load ptr, ptr %i.ic, align 8, !tbaa !54
  %i.ie = call i32 %i.ib(ptr noundef %i.hy, ptr noundef %i.id, ptr noundef nonnull %3) #13, !inline_history !105 ; 2 uses
...
.lr.ph.us.preheader.i:                            ; preds = %.preheader.us.i
  ...
  %i.in = shl i64 %i.im, 3
  call void @llvm.memmove.p0.p0.i64(ptr align 8 %scevgep23.i, ptr align 8 %scevgep24.i, i64 %i.in, i1 false), !tbaa !54
...
.lr.ph10.split.i:                                 ; preds = %._crit_edge6.i, %.lr.ph10.split.preheader.i
  ...
  %i.ip = load ptr, ptr %i.io, align 8, !tbaa !54 ; 3 uses
  br label %bb.ax
...
bb.ax:                                            ; preds = %bb.ay, %.lr.ph10.split.i
  ...
  %i.is = load ptr, ptr %i.dt, align 8, !tbaa !62
  %i.it = getelementptr [8 x i8], ptr %.sroa.0.1, i64 %i.ir
  %i.iu = load ptr, ptr %i.it, align 8, !tbaa !54
  %i.iv = call i32 %i.is(ptr noundef %i.ip, ptr noundef %i.iu, ptr noundef nonnull %3) #13, !inline_history !105 ; 2 uses
...
bb.ay:                                            ; preds = %bb.ax
  ...
  br i1 %i.iy, label %bb.ax, label %.preheader.i, !llvm.loop !106
...
._crit_edge.i211:                                 ; preds = %.preheader.i
  ...
  store ptr %i.ip, ptr %i.ja, align 8, !tbaa !54
...
.lr.ph5.preheader.i:                              ; preds = %.preheader.i
  ...
  call void @llvm.memmove.p0.p0.i64(ptr align 8 %scevgep15.i, ptr align 8 %scevgep16.i, i64 %i.jf, i1 false), !tbaa !54
  %i.jg = getelementptr [8 x i8], ptr %.sroa.0.1, i64 %.149.i
  store ptr %i.ip, ptr %i.jg, align 8, !tbaa !54
  %i.jh = getelementptr [8 x i8], ptr %.8.val.fr.i, i64 %.1537.i
  %i.ji = load ptr, ptr %i.jh, align 8, !tbaa !54
  %scevgep19.i = getelementptr i8, ptr %scevgep17.i, i64 %i.jd
  %scevgep20.i = getelementptr i8, ptr %.8.val.fr.i, i64 %i.jd
  call void @llvm.memmove.p0.p0.i64(ptr align 8 %scevgep19.i, ptr align 8 %scevgep20.i, i64 %i.jf, i1 false), !tbaa !54
  br label %._crit_edge6.i
...
._crit_edge6.i:                                   ; preds = %.lr.ph5.preheader.i, %._crit_edge.i211
  ...
  store ptr %i.jj, ptr %i.jk, align 8, !tbaa !54
  %i.jl = add nuw nsw i64 %.1537.i, 1             ; 2 uses
  %exitcond.not.i212 = icmp eq i64 %i.jl, %i.hv
  br i1 %exitcond.not.i212, label %binarysort.exit.thread, label %.lr.ph10.split.i, !llvm.loop !107
...
binarysort.exit.thread:                           ; preds = %._crit_edge6.i, %._crit_edge.us.i, %bb.au, %count_run.exit.thread275
  ...
  %i.jm = load i32, ptr %i.cu, align 8, !tbaa !69 ; 2 uses
...
bb.az:                                            ; preds = %binarysort.exit.thread
  ...
  %i.jq = load ptr, ptr %i.jp, align 8, !tbaa !118
  %i.jr = load ptr, ptr %i.cw, align 8, !tbaa !114
  %i.js = ptrtoint ptr %i.jq to i64
  %i.jt = ptrtoint ptr %i.jr to i64
  %i.ju = sub i64 %i.js, %i.jt
  %i.jv = getelementptr i8, ptr %i.jp, i64 16
  %i.jw = load i64, ptr %i.jv, align 8, !tbaa !72 ; 2 uses
  %i.jx = load i64, ptr %i.cv, align 8, !tbaa !113 ; 4 uses
...
powerloop.exit.i:                                 ; preds = %bb.bc, %bb.bf
  %i.kh = load i32, ptr %i.cu, align 8, !tbaa !69 ; 4 uses
...
bb.be:                                            ; preds = %powerloop.exit.i
  ...
  %i.kn = load i32, ptr %i.km, align 8, !tbaa !119
...
bb.bf:                                            ; preds = %bb.be
  ...
  br i1 %i.kq, label %found_new_run.exit.thread283, label %powerloop.exit.i, !llvm.loop !108
...
.thread.i:                                        ; preds = %bb.be, %powerloop.exit.i
  ...
  store i32 %i.kc, ptr %i.ku, align 8, !tbaa !119
...
found_new_run.exit:                               ; preds = %binarysort.exit.thread, %.thread.i
  ...
  store ptr %.sroa.0.1, ptr %i.kx, align 8, !tbaa !73
  %.sroa.23.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.kx, i64 8
  store ptr %.8.val.fr.i, ptr %.sroa.23.0..sroa_idx, align 8, !tbaa !73
  %i.ky = getelementptr i8, ptr %i.kx, i64 16
  store i64 %.1, ptr %i.ky, align 8, !tbaa !72
  %i.kz = add i32 %i.kv, 1
  store i32 %i.kz, ptr %i.cu, align 8, !tbaa !69
  ...
  br i1 %.not181, label %.preheader437, label %bb.ag, !llvm.loop !109

.preheader437:                                    ; preds = %found_new_run.exit, %bb.bi
  %i.ld = load i32, ptr %i.cu, align 8, !tbaa !69 ; 2 uses
...
bb.bi:                                            ; preds = %bb.bh, %bb.bg
  ...
  br i1 %i.lp, label %.preheader437, label %found_new_run.exit.thread283, !llvm.loop !110
...
.lr.ph338:                                        ; preds = %found_new_run.exit.thread283, %Py_DECREF.exit
  ...
  %i.lt = load ptr, ptr %i.ls, align 8, !tbaa !54 ; 3 uses
  %i.lu = load i32, ptr %i.lt, align 8, !tbaa !32 ; 2 uses
  %.not.i = icmp sgt i32 %i.lu, -1
  br i1 %.not.i, label %bb.bj, label %Py_DECREF.exit

bb.bj:                                            ; preds = %.lr.ph338
  %i.lv = add nsw i32 %i.lu, -1                   ; 2 uses
  store i32 %i.lv, ptr %i.lt, align 8, !tbaa !32
...
Py_DECREF.exit:                                   ; preds = %.lr.ph338, %bb.bj, %bb.bk
  ...
  br i1 %exitcond364.not, label %._crit_edge339, label %.lr.ph338, !llvm.loop !111
...
.lr.ph.i222:                                      ; preds = %bb.bn, %.lr.ph.i222
  ...
  %i.mf = load ptr, ptr %.012.i224, align 8, !tbaa !54
  %i.mg = load ptr, ptr %.01013.i223, align 8, !tbaa !54
  store ptr %i.mg, ptr %.012.i224, align 8, !tbaa !54
  store ptr %i.mf, ptr %.01013.i223, align 8, !tbaa !54
  ...
  br i1 %i.mi, label %.lr.ph.i222, label %reverse_slice.exit226, !llvm.loop !1

reverse_slice.exit226:                            ; preds = %.lr.ph.i222, %bb.bn
  %i.mj = load ptr, ptr %i.ct, align 8, !tbaa !68 ; 2 uses
