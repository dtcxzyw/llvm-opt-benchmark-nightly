...
.lr.ph52.i.preheader:                             ; preds = %_Py_RefcntAdd.exit.i
  ...
  %7 = xor i64 %2, -1
  %i.ak = add i64 %6, %7                          ; 2 uses
  %8 = lshr i64 %i.ak, 3
  %i.al = add nuw nsw i64 %8, 1                   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <2 x ptr> %broadcast.splat, ptr %i.ap, align 8, !tbaa !54
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.aq = icmp eq i64 %index.next, %n.vec
  br i1 %i.aq, label %middle.block, label %vector.body, !llvm.loop !164
...
.lr.ph52.i:                                       ; preds = %.lr.ph52.i.preheader21, %.lr.ph52.i
  ...
  br i1 %i.as, label %.lr.ph52.i, label %_Py_memory_repeat.exit.i, !llvm.loop !165
...
.lr.ph.i:                                         ; preds = %bb.n, %_Py_RefcntAdd.exit43.i.a
  %.050.i = phi ptr [ %i.bd, %_Py_RefcntAdd.exit43.i.a ], [ %i.aa, %bb.n ] ; 3 uses
  %.149.i = phi ptr [ %i.be, %_Py_RefcntAdd.exit43.i.a ], [ %i.w, %bb.n ] ; 2 uses
  %i.av = load ptr, ptr %.050.i, align 8, !tbaa !54 ; 3 uses
  %i.aw = load i32, ptr %i.av, align 8, !tbaa !32 ; 2 uses
...
bb.o:                                             ; preds = %.lr.ph.i
  ...
  store i32 %i.bb, ptr %i.av, align 8, !tbaa !32
  %.pre54.i.a = load ptr, ptr %.050.i, align 8, !tbaa !54
  br label %_Py_RefcntAdd.exit43.i.a

_Py_RefcntAdd.exit43.i.a:                         ; preds = %bb.o, %.lr.ph.i
  %i.bc = phi ptr [ %i.av, %.lr.ph.i ], [ %.pre54.i.a, %bb.o ]
  %i.bd = getelementptr i8, ptr %.050.i, i64 8    ; 2 uses
  %i.be = getelementptr i8, ptr %.149.i, i64 8
  store ptr %i.bc, ptr %.149.i, align 8, !tbaa !54
  %i.bf = icmp ult ptr %i.bd, %i.at
  br i1 %i.bf, label %.lr.ph.i, label %._crit_edge.loopexit.i, !llvm.loop !166
...
.lr.ph.i.i:                                       ; preds = %._crit_edge.i, %.lr.ph.i.i
  ...
  br i1 %i.bo, label %.lr.ph.i.i, label %_Py_memory_repeat.exit.i, !llvm.loop !3
...
_Py_memory_repeat.exit.i:                         ; preds = %.lr.ph.i.i, %.lr.ph52.i, %middle.block, %._crit_edge.i, %_Py_RefcntAdd.exit.i
  ...
  store i64 %i.h, ptr %i.bp, align 8, !tbaa !33
  br label %list_repeat_lock_held.exit
