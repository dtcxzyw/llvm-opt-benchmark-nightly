...
bb.e:                                             ; preds = %bb.dd, %bb.d
  ...
  %.037 = phi i64 [ 0, %bb.d ], [ %i.gk, %bb.dd ] ; 4 uses
...
bb.q:                                             ; preds = %._crit_edge.i
  ...
  %4 = icmp ne ptr %i.au, null
  %i.av = icmp ne i32 %.032.lcssa.i, 0
  %or.cond.i = select i1 %4, i1 %i.av, i1 false
...
_PyUnicode_DATA.exit.i.i.us.us.i:                 ; preds = %.backedge.i.us.us.i, %.lr.ph.i.split.us.split.us.i
  %.049.us.us.i = phi i32 [ 0, %.lr.ph.i.split.us.split.us.i ], [ %i.bx, %.backedge.i.us.us.i ] ; 2 uses
  %.066158.i.us.us.i = phi i64 [ %i.bm, %.lr.ph.i.split.us.split.us.i ], [ %i.bw, %.backedge.i.us.us.i ] ; 3 uses
  ...
  switch i8 %i.bv, label %.split.us.loopexit132.i [
    i8 45, label %bb.ah
...
.backedge.i.us.us.i:                              ; preds = %bb.ah, %bb.ag, %bb.af, %bb.ae, %_PyUnicode_DATA.exit.i.i.us.us.i
  ...
  %i.bx = or i32 %.sink178.i.us.us.i, %.049.us.us.i
...
_PyUnicode_DATA.exit.i.i.us.i:                    ; preds = %.lr.ph.i.split.us.i, %.backedge.i.us.i
  %.049.us.i = phi i32 [ %i.cb, %.backedge.i.us.i ], [ 0, %.lr.ph.i.split.us.i ] ; 2 uses
  %.066158.i.us.i = phi i64 [ %i.ca, %.backedge.i.us.i ], [ %i.bm, %.lr.ph.i.split.us.i ] ; 3 uses
  %i.by = getelementptr i8, ptr %.0.i.i14.i.i.i, i64 %.066158.i.us.i
  %i.bz = load i8, ptr %i.by, align 1, !tbaa !24  ; 2 uses
  %i.ca = add i64 %.066158.i.us.i, 1              ; 3 uses
  switch i8 %i.bz, label %.split.us.loopexit134.i [
    i8 45, label %bb.al
...
.backedge.i.us.i:                                 ; preds = %bb.al, %bb.ak, %bb.aj, %bb.ai, %_PyUnicode_DATA.exit.i.i.us.i
  ...
  %i.cb = or i32 %.sink178.i.us.i, %.049.us.i
  %exitcond.not.i.us.i = icmp eq i64 %i.ca, %.val
...
_PyUnicode_DATA.exit17.i.i.us.us.i:               ; preds = %.backedge.i.us80.us.i, %.lr.ph.i.split.us75.split.us.i
  %.049.us76.us.i = phi i32 [ 0, %.lr.ph.i.split.us75.split.us.i ], [ %i.cf, %.backedge.i.us80.us.i ] ; 2 uses
  %.066158.i.us77.us.i = phi i64 [ %i.bm, %.lr.ph.i.split.us75.split.us.i ], [ %i.ce, %.backedge.i.us80.us.i ] ; 3 uses
  %i.cc = getelementptr [2 x i8], ptr %.val4.i16.i.i.us.us.i, i64 %.066158.i.us77.us.i
  %i.cd = load i16, ptr %i.cc, align 2, !tbaa !126 ; 2 uses
  %i.ce = add i64 %.066158.i.us77.us.i, 1         ; 3 uses
  switch i16 %i.cd, label %.split.us.loopexit136.i [
    i16 45, label %bb.ap
