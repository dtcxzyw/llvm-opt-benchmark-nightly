...
inline.NumDeleted: 7
begin_hunk_0_@_Py_LibHacl_Hacl_Hash_Blake2s_Simd128_update_last_no_inline:bb.a
...
bb.a:
  ...
  store <4 x i8> <i8 32, i8 0, i8 1, i8 1>, ptr %0, align 8, !tbaa !10
  %.sroa.7.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %0, i64 4
  ...
  store ptr %i.a, ptr %.sroa.12.0..sroa_idx.i, align 8, !tbaa !17
  %.sroa.13.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %0, i64 32
  store ptr %i.b, ptr %.sroa.13.0..sroa_idx.i, align 8, !tbaa !17
  %i.c = call noundef ptr @_Py_LibHacl_Hacl_Hash_Blake2s_Simd128_malloc_with_params_and_key(ptr noundef nonnull %0, i1 noundef zeroext false, ptr noundef null)
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = getelementptr i8, ptr %.sroa.8118.0.copyload.i, i64 %i.d
  %i.f = sub nsw i64 64, %i.d
  %i.g = and i64 %i.f, 4294967295
  tail call void @llvm.memset.p0.i64(ptr align 1 %i.e, i8 0, i64 %i.g, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %.sroa.8118.0.copyload.i, ptr readonly align 1 %2, i64 %i.d, i1 false)
