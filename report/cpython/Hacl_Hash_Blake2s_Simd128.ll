...
inline.NumDeleted: 7
begin_hunk_0_@_Py_LibHacl_Hacl_Hash_Blake2s_Simd128_copy_internal_state:bb.a
; Function Attrs: mustprogress nounwind willreturn memory(readwrite, target_mem: none) uwtable
define hidden noalias noundef ptr @_Py_LibHacl_Hacl_Hash_Blake2s_Simd128_malloc_with_params_and_key(ptr noundef readonly captures(none) %0, i1 noundef zeroext %1, ptr noundef readonly captures(none) %2) local_unnamed_addr #12 {
bb.a:
  ...
  %i.a = tail call noalias dereferenceable_or_null(64) ptr @calloc(i64 noundef 64, i64 noundef 1) #25 ; 5 uses
  %i.b = icmp eq ptr %i.a, null
  br i1 %i.b, label %malloc_raw.exit, label %bb.b
end_hunk_0
begin_hunk_1_@_Py_LibHacl_Hacl_Hash_Blake2s_Simd128_malloc_with_params_and_key:bb.a
bb.g:                                             ; preds = %bb.f
