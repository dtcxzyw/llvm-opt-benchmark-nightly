...
hamt_node_collision_find_index.exit.i:            ; preds = %bb.bu
  %lsr.iv.lcssa125 = phi i64 [ %lsr.iv, %bb.bu ]
  %.01319.i.i.lcssa124 = phi i64 [ %.01319.i.i, %bb.bu ]
...
begin_hunk_1_@hamt_node_without:bb.a
  ...
  %exitcond.not.i.1 = icmp eq i64 %.01319.i.i.lcssa124, %i.nx
...
.lr.ph70.i:                                       ; preds = %.lr.ph70.i.preheader, %_Py_NewRef.exit55.i
  %lsr.iv124 = phi i64 [ %lsr.iv.lcssa125, %.lr.ph70.i.preheader ], [ %lsr.iv.next125, %_Py_NewRef.exit55.i ] ; 3 uses
...
bb.au:                                            ; preds = %bb.at
  %i.en = tail call ptr @_PyObject_GC_New(ptr noundef nonnull @_PyHamt_ArrayNode_Type) #12 ; 12 uses
...
.thread.loopexitsplit:                            ; preds = %hamt_hash.exit, %bb.bb
  %.0158.ph.ph.ph = phi ptr [ null, %bb.bb ], [ null, %hamt_hash.exit ]
  br label %.thread.loopexit

..thread.loopexit_crit_edge:                      ; preds = %bb.bd
  %split = phi ptr [ %i.en, %bb.bd ]              ; 0 uses
  br label %.thread.loopexit, !llvm.loop !81

.thread.loopexit:                                 ; preds = %.thread.loopexitsplit, %..thread.loopexit_crit_edge
  %.0158.ph.ph = phi ptr [ %i.en, %..thread.loopexit_crit_edge ], [ %.0158.ph.ph.ph, %.thread.loopexitsplit ]
  br label %.thread
