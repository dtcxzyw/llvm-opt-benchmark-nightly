...
.lr.ph.i.epil.preheader:                          ; preds = %._crit_edge.i.loopexit.unr-lcssa, %.lr.ph.i.preheader
  ...
  %i.o = sub i64 %i.n, %.025.i.epil.init
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %.lr.ph.i.preheader.new
  ...
  %.01724.i = phi i64 [ 0, %.lr.ph.i.preheader.new ], [ %i.ad, %.lr.ph.i ] ; 3 uses
  %niter = phi i64 [ 0, %.lr.ph.i.preheader.new ], [ %niter.next.1, %.lr.ph.i ]
  %i.u = getelementptr [64 x i8], ptr %i.j, i64 %.01724.i
  %i.v = load atomic i64, ptr %i.u seq_cst, align 8 ; 3 uses
  %.not19.i = icmp ne i64 %i.v, 0
  %i.w = sub i64 %i.v, %.025.i
  %i.x = icmp slt i64 %i.w, 0
  %or.cond.i = select i1 %.not19.i, i1 %i.x, i1 false
  %.1.i = select i1 %or.cond.i, i64 %i.v, i64 %.025.i ; 2 uses
  %i.y = getelementptr [64 x i8], ptr %i.j, i64 %.01724.i
...
qsbr_poll_scan.exit:                              ; preds = %._crit_edge.i, %bb.c
  %.022.i = phi i64 [ %i.r, %._crit_edge.i ], [ %.0.lcssa.i, %bb.c ]
