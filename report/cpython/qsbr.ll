...
.lr.ph.i.epil.preheader:                          ; preds = %._crit_edge.i.loopexit.unr-lcssa, %.lr.ph.i.preheader
  ...
  %.01724.i.epil.init = phi i64 [ 0, %.lr.ph.i.preheader ], [ %i.ae, %._crit_edge.i.loopexit.unr-lcssa ]
  %lcmp.mod7 = trunc i64 %i.l to i1
  tail call void @llvm.assume(i1 %lcmp.mod7)
  %i.n = getelementptr [64 x i8], ptr %i.j, i64 %.01724.i.epil.init
  %i.o = load atomic i64, ptr %i.n seq_cst, align 8 ; 3 uses
  %.not19.i.epil = icmp ne i64 %i.o, 0
  %i.p = sub i64 %i.o, %.025.i.epil.init
  %i.q = icmp slt i64 %i.p, 0
  %or.cond.i.epil = select i1 %.not19.i.epil, i1 %i.q, i1 false
  %.1.i.epil = select i1 %or.cond.i.epil, i64 %i.o, i64 %.025.i.epil.init
...
._crit_edge.i:                                    ; preds = %.lr.ph.i.epil.preheader, %._crit_edge.i.loopexit.unr-lcssa, %bb.b
  ...
  %i.r = getelementptr i8, ptr %i.g, i64 8        ; 2 uses
  %i.s = load atomic i64, ptr %i.r seq_cst, align 8 ; 3 uses
  %i.t = sub i64 %i.s, %.0.lcssa.i
  %i.u = icmp slt i64 %i.t, 0
  br i1 %i.u, label %bb.c, label %qsbr_poll_scan.exit

.lr.ph.i:                                         ; preds = %.lr.ph.i, %.lr.ph.i.preheader.new
  %.025.i = phi i64 [ %i.h, %.lr.ph.i.preheader.new ], [ %.1.i.1, %.lr.ph.i ] ; 2 uses
  %.01724.i = phi i64 [ 0, %.lr.ph.i.preheader.new ], [ %i.ae, %.lr.ph.i ] ; 3 uses
  %niter = phi i64 [ 0, %.lr.ph.i.preheader.new ], [ %niter.next.1, %.lr.ph.i ]
  %i.v = getelementptr [64 x i8], ptr %i.j, i64 %.01724.i
  %i.w = load atomic i64, ptr %i.v seq_cst, align 8 ; 3 uses
  %.not19.i = icmp ne i64 %i.w, 0
  %i.x = sub i64 %i.w, %.025.i
  %i.y = icmp slt i64 %i.x, 0
  %or.cond.i = select i1 %.not19.i, i1 %i.y, i1 false
  %.1.i = select i1 %or.cond.i, i64 %i.w, i64 %.025.i ; 2 uses
  %i.z = getelementptr [64 x i8], ptr %i.j, i64 %.01724.i
  %i.aa = getelementptr i8, ptr %i.z, i64 64
  %i.ab = load atomic i64, ptr %i.aa seq_cst, align 8 ; 3 uses
  %.not19.i.1 = icmp ne i64 %i.ab, 0
  %i.ac = sub i64 %i.ab, %.1.i
  %i.ad = icmp slt i64 %i.ac, 0
  %or.cond.i.1 = select i1 %.not19.i.1, i1 %i.ad, i1 false
  %.1.i.1 = select i1 %or.cond.i.1, i64 %i.ab, i64 %.1.i ; 3 uses
  %i.ae = add nuw i64 %.01724.i, 2                ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.i.loopexit.unr-lcssa, label %.lr.ph.i, !llvm.loop !24

bb.c:                                             ; preds = %._crit_edge.i
  %i.af = cmpxchg ptr %i.r, i64 %i.s, i64 %.0.lcssa.i seq_cst seq_cst, align 8 ; 0 uses
  br label %qsbr_poll_scan.exit

qsbr_poll_scan.exit:                              ; preds = %._crit_edge.i, %bb.c
  %.022.i = phi i64 [ %i.s, %._crit_edge.i ], [ %.0.lcssa.i, %bb.c ]
  %i.ag = sub i64 %1, %.022.i
  %i.ah = icmp slt i64 %i.ag, 1
  br label %bb.d

bb.d:                                             ; preds = %bb.a, %qsbr_poll_scan.exit
  %.0 = phi i1 [ %i.ah, %qsbr_poll_scan.exit ], [ true, %bb.a ]
  ret i1 %.0
}
...
!87 = !{!"_Py_freelists", !88, i64 0, !88, i64 16, !88, i64 32, !9, i64 48, !88, i64 368, !88, i64 384, !88, i64 400, !88, i64 416, !88, i64 432, !88, i64 448, !88, i64 464, !88, i64 480, !88, i64 496, !88, i64 512, !88, i64 528, !88, i64 544, !88, i64 560, !88, i64 576, !88, i64 592, !88, i64 608, !88, i64 624, !88, i64 640}
!88 = !{!"_Py_freelist", !15, i64 0, !13, i64 8}
!89 = !{!"_Py_unicode_state", !90, i64 0, !15, i64 32, !92, i64 40}
!90 = !{!"_Py_unicode_fs_codec", !91, i64 0, !8, i64 8, !91, i64 16, !8, i64 24}
!91 = !{!"p1 omnipotent char", !15, i64 0}
!92 = !{!"_Py_unicode_ids", !13, i64 0, !40, i64 8}
!93 = !{!"_Py_long_state", !8, i64 0}
!94 = !{!"_dtoa_state", !9, i64 0, !9, i64 64, !9, i64 128, !95, i64 2432}
!95 = !{!"p1 double", !15, i64 0}
!96 = !{!"_py_func_state", !8, i64 0, !9, i64 8}
!97 = !{!"_py_code_state", !22, i64 0, !98, i64 8}
!98 = !{!"p1 _ZTS15_Py_hashtable_t", !15, i64 0}
!99 = !{!"_Py_dict_state", !8, i64 0, !9, i64 8}
!100 = !{!"_Py_exc_state", !37, i64 0, !15, i64 8, !8, i64 16, !37, i64 24}
!101 = !{!"_Py_mem_interp_free_queue", !8, i64 0, !22, i64 4, !49, i64 8}
!102 = !{!"ast_state", !84, i64 0, !8, i64 4, !37, i64 8, !37, i64 16, !37, i64 24, !37, i64 32, !37, i64 40, !37, i64 48, !37, i64 56, !37, i64 64, !37, i64 72, !37, i64 80, !37, i64 88, !37, i64 96, !37, i64 104, !37, i64 112, !37, i64 120, !37, i64 128, !37, i64 136, !37, i64 144, !37, i64 152, !37, i64 160, !37, i64 168, !37, i64 176, !37, i64 184, !37, i64 192, !37, i64 200, !37, i64 208, !37, i64 216, !37, i64 224, !37, i64 232, !37, i64 240, !37, i64 248, !37, i64 256, !37, i64 264, !37, i64 272, !37, i64 280, !37, i64 288, !37, i64 296, !37, i64 304, !37, i64 312, !37, i64 320, !37, i64 328, !37, i64 336, !37, i64 344, !37, i64 352, !37, i64 360, !37, i64 368, !37, i64 376, !37, i64 384, !37, i64 392, !37, i64 400, !37, i64 408, !37, i64 416, !37, i64 424, !37, i64 432, !37, i64 440, !37, i64 448, !37, i64 456, !37, i64 464, !37, i64 472, !37, i64 480, !37, i64 488, !37, i64 496, !37, i64 504, !37, i64 512, !37, i64 520, !37, i64 528, !37, i64 536, !37, i64 544, !37, i64 552, !37, i64 560, !37, i64 568, !37, i64 576, !37, i64 584, !37, i64 592, !37, i64 600, !37, i64 608, !37, i64 616, !37, i64 624, !37, i64 632, !37, i64 640, !37, i64 648, !37, i64 656, !37, i64 664, !37, i64 672, !37, i64 680, !37, i64 688, !37, i64 696, !37, i64 704, !37, i64 712, !37, i64 720, !37, i64 728, !37, i64 736, !37, i64 744, !37, i64 752, !37, i64 760, !37, i64 768, !37, i64 776, !37, i64 784, !37, i64 792, !37, i64 800, !37, i64 808, !37, i64 816, !37, i64 824, !37, i64 832, !37, i64 840, !37, i64 848, !37, i64 856, !37, i64 864, !37, i64 872, !37, i64 880, !37, i64 888, !37, i64 896, !37, i64 904, !37, i64 912, !37, i64 920, !37, i64 928, !37, i64 936, !37, i64 944, !37, i64 952, !37, i64 960, !37, i64 968, !37, i64 976, !37, i64 984, !37, i64 992, !37, i64 1000, !37, i64 1008, !37, i64 1016, !37, i64 1024, !37, i64 1032, !37, i64 1040, !37, i64 1048, !37, i64 1056, !37, i64 1064, !37, i64 1072, !37, i64 1080, !37, i64 1088, !37, i64 1096, !37, i64 1104, !37, i64 1112, !37, i64 1120, !37, i64 1128, !37, i64 1136, !37, i64 1144, !37, i64 1152, !37, i64 1160, !37, i64 1168, !37, i64 1176, !37, i64 1184, !37, i64 1192, !37, i64 1200, !37, i64 1208, !37, i64 1216, !37, i64 1224, !37, i64 1232, !37, i64 1240, !37, i64 1248, !37, i64 1256, !37, i64 1264, !37, i64 1272, !37, i64 1280, !37, i64 1288, !37, i64 1296, !37, i64 1304, !37, i64 1312, !37, i64 1320, !37, i64 1328, !37, i64 1336, !37, i64 1344, !37, i64 1352, !37, i64 1360, !37, i64 1368, !37, i64 1376, !37, i64 1384, !37, i64 1392, !37, i64 1400, !37, i64 1408, !37, i64 1416, !37, i64 1424, !37, i64 1432, !37, i64 1440, !37, i64 1448, !37, i64 1456, !37, i64 1464, !37, i64 1472, !37, i64 1480, !37, i64 1488, !37, i64 1496, !37, i64 1504, !37, i64 1512, !37, i64 1520, !37, i64 1528, !37, i64 1536, !37, i64 1544, !37, i64 1552, !37, i64 1560, !37, i64 1568, !37, i64 1576, !37, i64 1584, !37, i64 1592, !37, i64 1600, !37, i64 1608, !37, i64 1616, !37, i64 1624, !37, i64 1632, !37, i64 1640, !37, i64 1648, !37, i64 1656, !37, i64 1664, !37, i64 1672, !37, i64 1680, !37, i64 1688, !37, i64 1696, !37, i64 1704, !37, i64 1712, !37, i64 1720, !37, i64 1728, !37, i64 1736, !37, i64 1744, !37, i64 1752, !37, i64 1760, !37, i64 1768, !37, i64 1776, !37, i64 1784, !37, i64 1792, !37, i64 1800, !37, i64 1808, !37, i64 1816, !37, i64 1824, !37, i64 1832, !37, i64 1840, !37, i64 1848, !37, i64 1856, !37, i64 1864, !37, i64 1872, !37, i64 1880, !37, i64 1888, !37, i64 1896, !37, i64 1904, !37, i64 1912, !37, i64 1920, !37, i64 1928, !37, i64 1936, !37, i64 1944, !37, i64 1952, !37, i64 1960, !37, i64 1968, !37, i64 1976}
!103 = !{!"types_state", !8, i64 0, !104, i64 8, !105, i64 98312, !106, i64 108016, !22, i64 108512, !9, i64 108520}
!104 = !{!"type_cache", !9, i64 0}
!105 = !{!"", !13, i64 0, !9, i64 8}
!106 = !{!"", !13, i64 0, !13, i64 8, !9, i64 16}
!107 = !{!"callable_cache", !37, i64 0, !37, i64 8, !37, i64 16, !37, i64 24}
!108 = !{!"_PyOptimizationConfig", !48, i64 0, !48, i64 2, !48, i64 4, !48, i64 6, !17, i64 8, !17, i64 9}
!109 = !{!"p1 _ZTS17_PyExecutorObject", !15, i64 0}
!110 = !{!"_rare_events", !9, i64 0, !9, i64 1, !9, i64 2, !9, i64 3, !9, i64 4}
!111 = !{!"_Py_GlobalMonitors", !9, i64 0}
!112 = !{!"_Py_interp_cached_objects", !37, i64 0, !37, i64 8, !113, i64 16, !113, i64 24, !113, i64 32, !113, i64 40, !113, i64 48, !113, i64 56, !113, i64 64, !37, i64 72, !37, i64 80}
!113 = !{!"p1 _ZTS11_typeobject", !15, i64 0}
!114 = !{!"_Py_interp_static_objects", !115, i64 0}
!115 = !{!"", !8, i64 0, !64, i64 8, !116, i64 24, !118, i64 64}
!116 = !{!"", !117, i64 0, !15, i64 16, !37, i64 24, !13, i64 32}
!117 = !{!"_object", !9, i64 0, !113, i64 8}
!118 = !{!"", !117, i64 0, !37, i64 16, !37, i64 24, !37, i64 32, !37, i64 40, !37, i64 48, !37, i64 56, !9, i64 64}
!119 = !{!33, !34, i64 16}
!120 = distinct !{!120, !25}
end_hunk_0
