...
bb.ac:                                            ; preds = %bb.ac, %.lr.ph.new
  %.0.i155 = phi i64 [ 0, %.lr.ph.new ], [ %i.cf, %bb.ac ] ; 6 uses
  %niter = phi i64 [ 0, %.lr.ph.new ], [ %niter.next.3, %bb.ac ]
  %i.bm = getelementptr [8 x i8], ptr %.058.i, i64 %.0.i155
  %i.bn = load ptr, ptr %i.bm, align 8, !tbaa !31
  %i.bo = load ptr, ptr %i.bj, align 8, !tbaa !43
  %i.bp = getelementptr [8 x i8], ptr %i.bo, i64 %.0.i155
  store ptr %i.bn, ptr %i.bp, align 8, !tbaa !31
  %i.bq = or disjoint i64 %.0.i155, 1             ; 2 uses
  %i.br = getelementptr [8 x i8], ptr %.058.i, i64 %i.bq
  %i.bs = load ptr, ptr %i.br, align 8, !tbaa !31
  %i.bt = load ptr, ptr %i.bj, align 8, !tbaa !43
  %i.bu = getelementptr [8 x i8], ptr %i.bt, i64 %i.bq
  store ptr %i.bs, ptr %i.bu, align 8, !tbaa !31
  %i.bv = or disjoint i64 %.0.i155, 2             ; 2 uses
  %i.bw = getelementptr [8 x i8], ptr %.058.i, i64 %i.bv
  %i.bx = load ptr, ptr %i.bw, align 8, !tbaa !31
  %i.by = load ptr, ptr %i.bj, align 8, !tbaa !43
  %i.bz = getelementptr [8 x i8], ptr %i.by, i64 %i.bv
  store ptr %i.bx, ptr %i.bz, align 8, !tbaa !31
  %i.ca = or disjoint i64 %.0.i155, 3             ; 2 uses
  %i.cb = getelementptr [8 x i8], ptr %.058.i, i64 %i.ca
  %i.cc = load ptr, ptr %i.cb, align 8, !tbaa !31
  %i.cd = load ptr, ptr %i.bj, align 8, !tbaa !43
  %i.ce = getelementptr [8 x i8], ptr %i.cd, i64 %i.ca
  store ptr %i.cc, ptr %i.ce, align 8, !tbaa !31
  %i.cf = add nuw nsw i64 %.0.i155, 4             ; 2 uses
  %niter.next.3 = add i64 %niter, 4               ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %._crit_edge.loopexit.unr-lcssa, label %bb.ac, !llvm.loop !152
...
.epil.preheader:                                  ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph
  %.0.i155.epil.init = phi i64 [ 0, %.lr.ph ], [ %i.cf, %._crit_edge.loopexit.unr-lcssa ]
  %lcmp.mod197 = icmp ne i64 %xtraiter, 0
  tail call void @llvm.assume(i1 %lcmp.mod197)
  br label %bb.ad

bb.ad:                                            ; preds = %bb.ad, %.epil.preheader
  %.0.i155.epil = phi i64 [ %.0.i155.epil.init, %.epil.preheader ], [ %i.ck, %bb.ad ] ; 3 uses
  %epil.iter = phi i64 [ 0, %.epil.preheader ], [ %epil.iter.next, %bb.ad ]
  %i.cg = getelementptr [8 x i8], ptr %.058.i, i64 %.0.i155.epil
  %i.ch = load ptr, ptr %i.cg, align 8, !tbaa !31
  %i.ci = load ptr, ptr %i.bj, align 8, !tbaa !43
  %i.cj = getelementptr [8 x i8], ptr %i.ci, i64 %.0.i155.epil
  store ptr %i.ch, ptr %i.cj, align 8, !tbaa !31
  %i.ck = add nuw nsw i64 %.0.i155.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %._crit_edge, label %bb.ad, !llvm.loop !153

._crit_edge:                                      ; preds = %._crit_edge.loopexit.unr-lcssa, %bb.ad, %.preheader
  tail call void @PyMem_Free(ptr noundef %.058.i) #6, !inline_history !149
  ...
  %i.cm = load i32, ptr %i.g, align 8, !tbaa !27
  %.not94 = icmp eq i32 %i.cm, 0
  br i1 %.not94, label %bb.ae, label %.thread131
...
bb.ae:                                            ; preds = %._crit_edge
  ...
  br i1 %i.co, label %.thread124, label %bb.af
...
CHECK_CALL.exit:                                  ; preds = %bb.af, %bb.ag
  %i.cv = load ptr, ptr %i.bf, align 8, !tbaa !38
  ...
  br i1 %i.cx, label %bb.ah, label %.thread124

bb.ah:                                            ; preds = %CHECK_CALL.exit
  %i.cy = tail call ptr @PyErr_Occurred() #6
  %.not95 = icmp eq ptr %i.cy, null
  br i1 %.not95, label %.thread124, label %bb.ai

bb.ai:                                            ; preds = %bb.ah
  store i32 1, ptr %i.g, align 8, !tbaa !27
  br label %.thread124

_loop1_56_rule.exit.thread.sink.split:            ; preds = %bb.p, %bb.m, %_loop1_56_rule.exit.thread119, %bb.o, %bb.aa, %bb.y
...
CHECK_CALL.exit103:                               ; preds = %bb.am, %bb.an
  ...
  br i1 %i.do, label %bb.ao, label %.thread124

bb.ao:                                            ; preds = %CHECK_CALL.exit103
  %i.dp = tail call ptr @PyErr_Occurred() #6
  %.not99 = icmp eq ptr %i.dp, null
  br i1 %.not99, label %.thread124, label %bb.ap
...
bb.aq:                                            ; preds = %bb.ak, %bb.aj
  ...
  %.not100 = icmp eq i32 %i.dq, 0
  br i1 %.not100, label %bb.ar, label %.thread124

bb.ar:                                            ; preds = %bb.aq
  %i.dr = tail call fastcc ptr @star_expression_rule(ptr noundef nonnull %0) ; 2 uses
  %.not101 = icmp eq ptr %i.dr, null
  br i1 %.not101, label %bb.as, label %.thread124

bb.as:                                            ; preds = %bb.ar
  store i32 %i.j, ptr %i.i, align 8, !tbaa !28
  br label %.thread124

.thread124:                                       ; preds = %bb.ar, %bb.as, %bb.ah, %CHECK_CALL.exit, %bb.ao, %CHECK_CALL.exit103, %bb.aq, %bb.al, %_loop1_56_rule.exit.thread, %.thread131, %bb.ae, %bb.h, %bb.d, %bb.ap, %bb.ai, %bb.g
  %.8 = phi ptr [ null, %bb.ap ], [ null, %bb.g ], [ null, %bb.d ], [ null, %bb.aq ], [ null, %bb.ae ], [ null, %bb.ai ], [ null, %bb.al ], [ null, %bb.h ], [ null, %_loop1_56_rule.exit.thread ], [ null, %.thread131 ], [ %i.dr, %bb.ar ], [ %i.cw, %CHECK_CALL.exit ], [ null, %bb.as ], [ null, %bb.ah ], [ null, %bb.ao ], [ %i.dn, %CHECK_CALL.exit103 ]
  %i.ds = load i32, ptr %i.a, align 8, !tbaa !26
  %i.dt = add i32 %i.ds, -1
  store i32 %i.dt, ptr %i.a, align 8, !tbaa !26
  ret ptr %.8
}
...
bb.h:                                             ; preds = %bb.f
  ...
  %i.q = load i32, ptr %i.p, align 8, !tbaa !28   ; 5 uses
...
bb.p:                                             ; preds = %bb.o
  %i.ao = load i32, ptr %i.b, align 8, !tbaa !26
  %i.ap = add i32 %i.ao, -1
  store i32 %i.ap, ptr %i.b, align 8, !tbaa !26
  br label %.thread
...
bb.r:                                             ; preds = %bb.q
  ...
  br i1 %.not57, label %..thread63_crit_edge, label %bb.s
...
bb.s:                                             ; preds = %bb.r
  store i32 1, ptr %i.h, align 8, !tbaa !27
  %i.az = load i32, ptr %i.b, align 8, !tbaa !26
  %i.ba = add i32 %i.az, -1
  store i32 %i.ba, ptr %i.b, align 8, !tbaa !26
  br label %.thread

bb.t:                                             ; preds = %bb.n, %bb.m
  store i32 %i.q, ptr %i.p, align 8, !tbaa !28
  %i.bb = load i32, ptr %i.h, align 8, !tbaa !27
  %.not58 = icmp eq i32 %i.bb, 0
  br i1 %.not58, label %bb.v, label %bb.u

bb.u:                                             ; preds = %bb.t
  %i.bc = load i32, ptr %i.b, align 8, !tbaa !26
  %i.bd = add i32 %i.bc, -1
  store i32 %i.bd, ptr %i.b, align 8, !tbaa !26
  br label %.thread

bb.v:                                             ; preds = %bb.t
  %i.be = call ptr @expression_rule(ptr noundef nonnull %0) ; 3 uses
  %.not59 = icmp eq ptr %i.be, null
  br i1 %.not59, label %bb.x, label %bb.w

bb.w:                                             ; preds = %bb.v
  store ptr %i.be, ptr %i.a, align 8, !tbaa !75
  br label %.thread63
...
.thread63:                                        ; preds = %..thread63_crit_edge, %bb.q, %bb.w, %bb.x
  ...
  %i.bh = load i32, ptr %i.b, align 8, !tbaa !26
  %i.bi = add i32 %i.bh, -1
  store i32 %i.bi, ptr %i.b, align 8, !tbaa !26
  %i.bj = load ptr, ptr %i.a, align 8, !tbaa !75
  br label %.thread
