...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  br i1 %.not72, label %Py_DECREF.exit90.thread, label %bb.d
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %i.h, label %bb.f, label %Py_DECREF.exit90

bb.f:                                             ; preds = %bb.e
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.d) #6
  br label %Py_DECREF.exit90

Py_DECREF.exit90:                                 ; preds = %bb.f, %bb.e, %bb.d
  %i.i = icmp eq i64 %i.e, -1
  br i1 %i.i, label %Py_DECREF.exit90.thread, label %bb.g

Py_DECREF.exit90.thread:                          ; preds = %bb.c, %Py_DECREF.exit90
  %i.j = tail call ptr @PyErr_Occurred() #6
  %.not73 = icmp eq ptr %i.j, null
  br i1 %.not73, label %bb.g, label %bb.af

bb.g:                                             ; preds = %Py_DECREF.exit90.thread, %Py_DECREF.exit90
  %.05794.ph = phi i64 [ %i.e, %Py_DECREF.exit90 ], [ -1, %Py_DECREF.exit90.thread ]
...
bb.t:                                             ; preds = %bb.s
  ...
  br i1 %.not78, label %Py_DECREF.exit88.thread, label %bb.u
...
bb.v:                                             ; preds = %bb.u
  ...
  br i1 %i.ap, label %bb.w, label %Py_DECREF.exit88

bb.w:                                             ; preds = %bb.v
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.al) #6
  br label %Py_DECREF.exit88

Py_DECREF.exit88:                                 ; preds = %bb.w, %bb.v, %bb.u
  %i.aq = icmp eq i64 %i.am, -1
  br i1 %i.aq, label %Py_DECREF.exit88.thread, label %bb.x

Py_DECREF.exit88.thread:                          ; preds = %bb.t, %Py_DECREF.exit88
  %i.ar = tail call ptr @PyErr_Occurred() #6
  %.not79 = icmp eq ptr %i.ar, null
  br i1 %.not79, label %bb.x, label %bb.af

bb.x:                                             ; preds = %Py_DECREF.exit88.thread, %Py_DECREF.exit88
  %.061.ph = phi i64 [ %i.am, %Py_DECREF.exit88 ], [ -1, %Py_DECREF.exit88.thread ] ; 3 uses
...
bb.ac:                                            ; preds = %Py_DECREF.exit.thread, %Py_DECREF.exit
  %.059.ph = phi i64 [ %i.aw, %Py_DECREF.exit ], [ -1, %Py_DECREF.exit.thread ] ; 2 uses
...
bb.ae:                                            ; preds = %bb.ad, %bb.ac, %bb.x, %bb.s, %bb.p, %bb.m, %bb.j, %bb.g
  %.066 = phi i32 [ 1, %bb.g ], [ %i.n, %bb.j ], [ %i.n, %bb.m ], [ %i.n, %bb.p ], [ %i.n, %bb.s ], [ %i.n, %bb.x ], [ %i.n, %bb.ac ], [ %i.n, %bb.ad ]
  %.065 = phi i32 [ 0, %bb.g ], [ 0, %bb.j ], [ %i.t, %bb.m ], [ %i.t, %bb.p ], [ %i.t, %bb.s ], [ %i.t, %bb.x ], [ %i.t, %bb.ac ], [ %i.t, %bb.ad ]
  %.064 = phi i32 [ 1000, %bb.g ], [ 1000, %bb.j ], [ 1000, %bb.m ], [ %i.z, %bb.p ], [ %i.z, %bb.s ], [ %i.z, %bb.x ], [ %i.z, %bb.ac ], [ %i.z, %bb.ad ]
  %.063 = phi i32 [ 1, %bb.g ], [ 1, %bb.j ], [ 1, %bb.m ], [ 1, %bb.p ], [ %i.af, %bb.s ], [ %i.af, %bb.x ], [ %i.af, %bb.ac ], [ %i.af, %bb.ad ]
  %.162 = phi i64 [ 0, %bb.g ], [ 0, %bb.j ], [ 0, %bb.m ], [ 0, %bb.p ], [ 0, %bb.s ], [ %.061.ph, %bb.x ], [ %.061.ph, %bb.ac ], [ %.061.ph, %bb.ad ]
  %.160 = phi i64 [ 1, %bb.g ], [ 1, %bb.j ], [ 1, %bb.m ], [ 1, %bb.p ], [ 1, %bb.s ], [ 1, %bb.x ], [ %.059.ph, %bb.ac ], [ %.059.ph, %bb.ad ]
  %.058 = phi i32 [ 0, %bb.g ], [ 0, %bb.j ], [ 0, %bb.m ], [ 0, %bb.p ], [ 0, %bb.s ], [ 0, %bb.x ], [ 0, %bb.ac ], [ %i.bf, %bb.ad ]
  %i.bh = tail call fastcc ptr @_testinternalcapi_benchmark_locks_impl(i64 noundef %.05794.ph, i32 noundef %.066, i32 noundef %.065, i32 noundef %.064, i32 noundef %.063, i64 noundef %.162, i64 noundef %.160, i32 noundef %.058)
  br label %bb.af

bb.af:                                            ; preds = %Py_DECREF.exit.thread, %Py_DECREF.exit88.thread, %Py_DECREF.exit90.thread, %bb.ae, %bb.b, %bb.i, %bb.l, %bb.o, %bb.r, %bb.ad
  %.053 = phi ptr [ %i.bh, %bb.ae ], [ null, %bb.i ], [ null, %bb.l ], [ null, %bb.o ], [ null, %bb.r ], [ null, %bb.ad ], [ null, %Py_DECREF.exit88.thread ], [ null, %Py_DECREF.exit90.thread ], [ null, %bb.b ], [ null, %Py_DECREF.exit.thread ]
  ret ptr %.053
}
