...
PyUnicode_READ.exit.us:                           ; preds = %PyUnicode_READ.exit.us.preheader, %bb.cy
  ...
  %.177207.us = phi i32 [ %i.fs, %bb.cy ], [ 0, %PyUnicode_READ.exit.us.preheader ] ; 3 uses
...
PyUnicode_READ.exit.us222:                        ; preds = %PyUnicode_READ.exit.us222.preheader, %bb.cz
  ...
  %.177207.us221 = phi i32 [ %i.fy, %bb.cz ], [ 0, %PyUnicode_READ.exit.us222.preheader ] ; 3 uses
...
PyUnicode_READ.exit:                              ; preds = %PyUnicode_READ.exit.preheader, %bb.da
  ...
  %.177207 = phi i32 [ %i.ge, %bb.da ], [ 0, %PyUnicode_READ.exit.preheader ] ; 3 uses
...
PyUnicode_READ.exit._crit_edge.loopexitsplit:     ; preds = %bb.da
  ...
  %.lcssa.ph.ph = phi i64 [ %i.gf, %bb.da ]
...
PyUnicode_READ.exit.PyUnicode_READ.exit._crit_edge.loopexit_crit_edge: ; preds = %PyUnicode_READ.exit
  %.177207.lcssa = phi i32 [ %.177207, %PyUnicode_READ.exit ]
  %.177207.lcssa.a = phi i32 [ %.177207, %PyUnicode_READ.exit ] ; 0 uses
  %split337 = phi i64 [ %i.gb, %PyUnicode_READ.exit ]
  br label %PyUnicode_READ.exit._crit_edge.loopexit
...
PyUnicode_READ.exit._crit_edge.loopexit:          ; preds = %PyUnicode_READ.exit._crit_edge.loopexitsplit, %PyUnicode_READ.exit.PyUnicode_READ.exit._crit_edge.loopexit_crit_edge
  %.177.lcssa.ph = phi i32 [ %.177207.lcssa, %PyUnicode_READ.exit.PyUnicode_READ.exit._crit_edge.loopexit_crit_edge ], [ %.lcssa335, %PyUnicode_READ.exit._crit_edge.loopexitsplit ]
  %.lcssa.ph = phi i64 [ %split337, %PyUnicode_READ.exit.PyUnicode_READ.exit._crit_edge.loopexit_crit_edge ], [ %.lcssa.ph.ph, %PyUnicode_READ.exit._crit_edge.loopexitsplit ]
...
PyUnicode_READ.exit._crit_edge.loopexit323split:  ; preds = %bb.cy
  ...
  %.lcssa.ph325.ph = phi i64 [ %i.ft, %bb.cy ]
...
PyUnicode_READ.exit.us.PyUnicode_READ.exit._crit_edge.loopexit323_crit_edge: ; preds = %PyUnicode_READ.exit.us
  %.177207.us.lcssa = phi i32 [ %.177207.us, %PyUnicode_READ.exit.us ]
  %.177207.us.lcssa.a = phi i32 [ %.177207.us, %PyUnicode_READ.exit.us ] ; 0 uses
  %split334 = phi i64 [ %i.fp, %PyUnicode_READ.exit.us ]
  br label %PyUnicode_READ.exit._crit_edge.loopexit323
...
PyUnicode_READ.exit._crit_edge.loopexit323:       ; preds = %PyUnicode_READ.exit._crit_edge.loopexit323split, %PyUnicode_READ.exit.us.PyUnicode_READ.exit._crit_edge.loopexit323_crit_edge
  %.177.lcssa.ph324 = phi i32 [ %.177207.us.lcssa, %PyUnicode_READ.exit.us.PyUnicode_READ.exit._crit_edge.loopexit323_crit_edge ], [ %.lcssa333, %PyUnicode_READ.exit._crit_edge.loopexit323split ]
  %.lcssa.ph325 = phi i64 [ %split334, %PyUnicode_READ.exit.us.PyUnicode_READ.exit._crit_edge.loopexit323_crit_edge ], [ %.lcssa.ph325.ph, %PyUnicode_READ.exit._crit_edge.loopexit323split ]
  br label %PyUnicode_READ.exit._crit_edge

PyUnicode_READ.exit._crit_edge.loopexit326split:  ; preds = %bb.cz
  %.lcssa331 = phi i32 [ %i.fy, %bb.cz ]
  %.lcssa.ph328.ph = phi i64 [ %i.fz, %bb.cz ]
...
PyUnicode_READ.exit.us222.PyUnicode_READ.exit._crit_edge.loopexit326_crit_edge: ; preds = %PyUnicode_READ.exit.us222
  %.177207.us221.lcssa = phi i32 [ %.177207.us221, %PyUnicode_READ.exit.us222 ]
  %.177207.us221.lcssa.a = phi i32 [ %.177207.us221, %PyUnicode_READ.exit.us222 ] ; 0 uses
  %split331 = phi i64 [ %i.fv, %PyUnicode_READ.exit.us222 ]
  br label %PyUnicode_READ.exit._crit_edge.loopexit326
...
PyUnicode_READ.exit._crit_edge.loopexit326:       ; preds = %PyUnicode_READ.exit._crit_edge.loopexit326split, %PyUnicode_READ.exit.us222.PyUnicode_READ.exit._crit_edge.loopexit326_crit_edge
  %.177.lcssa.ph327 = phi i32 [ %.177207.us221.lcssa, %PyUnicode_READ.exit.us222.PyUnicode_READ.exit._crit_edge.loopexit326_crit_edge ], [ %.lcssa331, %PyUnicode_READ.exit._crit_edge.loopexit326split ]
  %.lcssa.ph328 = phi i64 [ %split331, %PyUnicode_READ.exit.us222.PyUnicode_READ.exit._crit_edge.loopexit326_crit_edge ], [ %.lcssa.ph328.ph, %PyUnicode_READ.exit._crit_edge.loopexit326split ]
  br label %PyUnicode_READ.exit._crit_edge
...
.preheader118.i:                                  ; preds = %.preheader
  %.059122.i.lcssa = phi i64 [ %.059122.i, %.preheader ]
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  %lsr.iv = phi i64 [ %.059122.i.lcssa, %.lr.ph.i.preheader ], [ %lsr.iv.next, %.lr.ph.i ] ; 2 uses
