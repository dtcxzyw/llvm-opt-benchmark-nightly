...
begin_hunk_2_@mark_stacks:bb.a
  ...
  %.1174.lcssa = phi i32 [ %.0173273, %.lr.ph275 ], [ %i.ah, %._crit_edge256.loopexit ] ; 5 uses
...
begin_hunk_3_@mark_stacks:bb.a
  ...
  %i.at = add i32 %.1174.lcssa, %i.as
  %i.au = add i32 %i.at, 1                        ; 18 uses
