...
.lr.ph.split.us:                                  ; preds = %.lr.ph.split.us.preheader, %framelocalsproxy_getval.exit.thread111.us
  %indvars.iv190 = phi i64 [ %indvars.iv.next191, %framelocalsproxy_getval.exit.thread111.us ], [ 0, %.lr.ph.split.us.preheader ] ; 7 uses
...
.select.unfold.i_crit_edge:                       ; preds = %bb.c
  %indvars.iv190.lcssa279 = phi i64 [ %indvars.iv190, %bb.c ]
  br label %select.unfold.i

select.unfold.i:                                  ; preds = %select.unfold.isplit, %.select.unfold.i_crit_edge
  %indvars.iv190.lcssa = phi i64 [ %indvars.iv190.lcssa279, %.select.unfold.i_crit_edge ], [ %indvars.iv190.lcssa280, %select.unfold.isplit ]
  %.lcssa272 = phi ptr [ %i.u, %.select.unfold.i_crit_edge ], [ %i.u, %select.unfold.isplit ] ; 3 uses
...
.lr.ph162.split.us:                               ; preds = %.lr.ph162.split.us.preheader, %framelocalsproxy_getval.exit104.thread125.us
  %indvars.iv197 = phi i64 [ %indvars.iv.next198, %framelocalsproxy_getval.exit104.thread125.us ], [ 0, %.lr.ph162.split.us.preheader ] ; 7 uses
...
.select.unfold.i97_crit_edge:                     ; preds = %bb.o
  %indvars.iv197.lcssa286 = phi i64 [ %indvars.iv197, %bb.o ]
  br label %select.unfold.i97

select.unfold.i97:                                ; preds = %select.unfold.i97split, %.select.unfold.i97_crit_edge
  %indvars.iv197.lcssa269 = phi i64 [ %indvars.iv197.lcssa286, %.select.unfold.i97_crit_edge ], [ %indvars.iv197.lcssa287.a, %select.unfold.i97split ]
  %.lcssa = phi ptr [ %i.bl, %.select.unfold.i97_crit_edge ], [ %i.bl, %select.unfold.i97split ] ; 3 uses
