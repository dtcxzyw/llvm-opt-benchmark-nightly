...
bb.o:                                             ; preds = %bb.n
  ...
  %5 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %4, <2 x double> <double f0x3F49615AC0B7ACE9, double f0x3E120D3F686439E4>, <2 x double> <double f0x3F9744EB6C45EC67, double f0x3F41F18CBFDF2728>)
  %6 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %5, <2 x double> %4, <2 x double> <double f0x3FCEF2ABB9B85C37, double f0x3F8F207A7EAB17BF>)
  %7 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> %4, <2 x double> <double f0x3FF453CC085375B2, double f0x3FC2F5123394F040>)
  %8 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %7, <2 x double> %4, <2 x double> <double f0x400D2ECB1A3D02C4, double f0x3FE61292F23385C9>)
  %9 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %8, <2 x double> %4, <2 x double> <double f0x401713F71462256A, double f0x3FFAD278E6526633>)
  %10 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %9, <2 x double> %4, <2 x double> <double f0x4012857748CAB19B, double f0x40006CEFBB46A449>)
  %11 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %10, <2 x double> %4, <2 x double> <double f0x3FF6C665FDE9526A, double 1.000000e+00>)
  br label %bb.q
...
bb.p:                                             ; preds = %bb.n
  ...
  %14 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %13, <2 x double> <double f0x3E8AFB74D693BF93, double f0x3CE269BFF1F8C190>, <2 x double> <double f0x3EFC6EC6CC59E02A, double f0x3E831446F740B9E0>)
  %15 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %14, <2 x double> %13, <2 x double> <double f0x3F545C1908425345, double f0x3EF35C2C496374BF>)
  %16 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %15, <2 x double> %13, <2 x double> <double f0x3F9B2B41193B4EE7, double f0x3F49C8BC979DC5D7>)
  %17 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %16, <2 x double> %13, <2 x double> <double f0x3FD2FAD9315255CF, double f0x3F8E76F93215462A>)
  %18 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %17, <2 x double> %13, <2 x double> <double f0x3FFC8EA6461FA445, double f0x3FC186EB183443FB>)
  %19 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %18, <2 x double> %13, <2 x double> <double f0x4015DAEA6E875003, double f0x3FE331D34FC7D77F>)
  %20 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %19, <2 x double> %13, <2 x double> <double f0x401AA1B1C13EE526, double 1.000000e+00>)
  br label %bb.q
