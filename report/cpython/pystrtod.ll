...
bb.j:                                             ; preds = %bb.a, %bb.d, %bb.g, %bb.f, %bb.c
  ...
  %i.h = tail call zeroext i16 @_Py_get_387controlword() #11 ; 3 uses
...
.thread.i:                                        ; preds = %bb.j
  %i.k = call ptr @_Py_dg_dtoa(double noundef %0, i32 noundef range(i32 0, 4) %.0, i32 noundef %.020, ptr noundef nonnull %i.b, ptr noundef nonnull %i.c, ptr noundef nonnull %i.a) #11
  br label %bb.l

bb.k:                                             ; preds = %bb.j
  tail call void @_Py_set_387controlword(i16 noundef zeroext %i.j) #11
  ...
  call void @_Py_set_387controlword(i16 noundef zeroext %i.h) #11
  br label %bb.l

bb.l:                                             ; preds = %bb.k, %.thread.i
  %i.m = phi ptr [ %i.k, %.thread.i ], [ %i.l, %bb.k ] ; 10 uses
  %i.n = load i32, ptr %i.b, align 4, !tbaa !7
  %.fr262.i = freeze i32 %i.n                     ; 5 uses
  %i.o = sext i32 %.fr262.i to i64                ; 5 uses
  %i.p = icmp eq ptr %i.m, null
  br i1 %i.p, label %bb.ay, label %bb.m
...
bb.t:                                             ; preds = %bb.s, %bb.r
  %i.ae = call ptr @PyMem_Malloc(i64 noundef 5) #11 ; 8 uses
  %i.af = icmp eq ptr %i.ae, null
  br i1 %i.af, label %bb.u, label %bb.v

bb.u:                                             ; preds = %bb.t
  %i.ag = call ptr @PyErr_NoMemory() #11          ; 0 uses
  br label %bb.az
...
bb.x:                                             ; preds = %.sink.split.i, %bb.w
  %.0159.i = phi ptr [ %i.ae, %bb.w ], [ %i.aj, %.sink.split.i ] ; 4 uses
  %i.ak = load i8, ptr %i.m, align 1, !tbaa !11   ; 2 uses
  switch i8 %i.ak, label %bb.aa [
    i8 105, label %bb.y
    i8 73, label %bb.y
    i8 110, label %bb.ab
  ]
...
bb.y:                                             ; preds = %bb.x, %bb.x
  ...
  %i.am = call ptr @strncpy(ptr noundef nonnull dereferenceable(1) %.0159.i, ptr noundef nonnull dereferenceable(1) %i.al, i64 noundef 3) #11 ; 0 uses
  %i.an = getelementptr i8, ptr %.0159.i, i64 3   ; 2 uses
...
.thread252.i:                                     ; preds = %bb.ah
  %.not189253.i = icmp eq i32 %i.f, 0
  %i.ba = sext i32 %.020 to i64
  %spec.select254.i = select i1 %.not189253.i, i64 %i.t, i64 %i.ba
  br label %bb.ak

bb.ai:                                            ; preds = %bb.ah, %bb.ag
  %.not189.i = icmp eq i32 %i.f, 0
  %i.bb = sext i32 %.020 to i64
  %spec.select.i = select i1 %.not189.i, i64 %i.t, i64 %i.bb
  br label %.thread40
...
.thread202.i:                                     ; preds = %bb.aq
  ...
  %.not192204.i = icmp sgt i64 %i.bm, %i.t
  %i.cf = call ptr @strncpy(ptr noundef %i.ce, ptr noundef nonnull %i.m, i64 noundef %i.t) #11 ; 0 uses
  %i.cg = getelementptr i8, ptr %i.ce, i64 %i.t   ; 2 uses
...
bb.ar:                                            ; preds = %bb.aq
  ...
  %.not192.i = icmp sgt i64 %i.bm, %i.t
  br i1 %.not192.i, label %bb.at, label %bb.as

bb.as:                                            ; preds = %bb.ar
  %i.cj = call ptr @strncpy(ptr noundef %i.ci, ptr noundef nonnull %i.m, i64 noundef %i.bm) #11 ; 0 uses
  ...
  %i.cm = getelementptr i8, ptr %i.m, i64 %i.bm
  %i.cn = sub nsw i64 %i.t, %i.bm                 ; 2 uses
...
bb.at:                                            ; preds = %bb.ar
  %i.cq = call ptr @strncpy(ptr noundef %i.ci, ptr noundef nonnull %i.m, i64 noundef %i.t) #11 ; 0 uses
  %i.cr = getelementptr i8, ptr %i.ci, i64 %i.t
  br label %bb.au

bb.au:                                            ; preds = %bb.at, %.thread202.i
  %.3209.i = phi ptr [ %i.cg, %.thread202.i ], [ %i.cr, %bb.at ] ; 2 uses
  %i.cs = sub i64 %i.bm, %i.t                     ; 2 uses
...
bb.av:                                            ; preds = %bb.au, %bb.as, %.thread202.i
  %.sink261.i = phi i64 [ %i.bm, %bb.au ], [ %i.t, %bb.as ], [ %i.t, %.thread202.i ]
...
bb.ax:                                            ; preds = %bb.aw, %bb.av, %bb.ac, %bb.ab, %bb.z, %bb.y
  %.6.ph.i = phi ptr [ %i.as, %bb.ab ], [ %i.as, %bb.ac ], [ %i.an, %bb.y ], [ %i.an, %bb.z ], [ %spec.select199.i, %bb.av ], [ %i.dh, %bb.aw ]
  %.0.ph.i = phi ptr [ %i.ae, %bb.ab ], [ %i.ae, %bb.ac ], [ %i.ae, %bb.y ], [ %i.ae, %bb.z ], [ %i.bu, %bb.av ], [ %i.bu, %bb.aw ]
...
bb.az:                                            ; preds = %bb.ax, %bb.an, %bb.u
  ...
  call void @_Py_dg_freedtoa(ptr noundef nonnull %i.m) #11
  br label %format_float_short.exit
