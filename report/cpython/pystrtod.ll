...
bb.l:                                             ; preds = %bb.k, %.thread.i
  ...
  br i1 %i.q, label %bb.ax, label %bb.m
...
bb.af:                                            ; preds = %bb.ae
  ...
  br i1 %i.aw, label %bb.ah, label %bb.ag
...
bb.ag:                                            ; preds = %bb.af
  ...
  br i1 %i.az, label %bb.ah, label %.thread252.i

.thread252.i:                                     ; preds = %bb.ag
...
bb.aj:                                            ; preds = %bb.ai, %.thread252.i, %.thread233.i
  %.0160239.i = phi i64 [ %i.u, %bb.ai ], [ %i.av, %.thread233.i ], [ %spec.select254.i, %.thread252.i ] ; 2 uses
  %.1165237.i = phi i1 [ %or.cond3.i, %bb.ai ], [ true, %.thread233.i ], [ true, %.thread252.i ] ; 3 uses
  %i.bd = phi i64 [ %spec.select255.i, %bb.ai ], [ %i.p, %.thread233.i ], [ %i.p, %.thread252.i ] ; 5 uses
  ...
  br i1 %or.cond5.i, label %.thread, label %bb.ak
...
.thread40:                                        ; preds = %.thread241.i, %bb.ah
  %.0160239249.i.ph = phi i64 [ %spec.select.i, %bb.ah ], [ %i.at, %.thread241.i ]
...
bb.al:                                            ; preds = %bb.ak, %.thread, %.thread40
  %.1161.i38 = phi i64 [ %i.bk, %.thread40 ], [ %i.bl, %bb.ak ], [ %i.bj, %.thread ] ; 2 uses
  %.1165237250.i36 = phi i1 [ false, %.thread40 ], [ %.1165237.i, %bb.ak ], [ true, %.thread ]
  %i.bm = phi i64 [ 1, %.thread40 ], [ %i.bd, %bb.ak ], [ %i.bd, %.thread ] ; 10 uses
  %i.bn = phi i1 [ false, %.thread40 ], [ %i.be, %bb.ak ], [ %i.be, %.thread ]
  %i.bo = phi i64 [ 1, %.thread40 ], [ %i.bf, %bb.ak ], [ %i.bf, %.thread ] ; 2 uses
  %i.bp = phi i64 [ 0, %.thread40 ], [ %i.bg, %bb.ak ], [ %i.bg, %.thread ]
  %i.bq = phi i64 [ 8, %.thread40 ], [ %spec.select43, %bb.ak ], [ 3, %.thread ]
...
bb.an:                                            ; preds = %bb.al
  ...
  br i1 %i.by, label %.sink.split256.i, label %bb.ao

bb.ao:                                            ; preds = %bb.an
  %.not191.i = icmp eq i32 %i.e, 0
  br i1 %.not191.i, label %bb.ap, label %.sink.split256.i

.sink.split256.i:                                 ; preds = %bb.ao, %bb.an
  %.sink257.i = phi i8 [ 45, %bb.an ], [ 43, %bb.ao ]
  %i.bz = getelementptr i8, ptr %i.bu, i64 1
  store i8 %.sink257.i, ptr %i.bu, align 1, !tbaa !11
  br label %bb.ap

bb.ap:                                            ; preds = %.sink.split256.i, %bb.ao
  %.1.i = phi ptr [ %i.bu, %bb.ao ], [ %i.bz, %.sink.split256.i ] ; 4 uses
  br i1 %i.bn, label %.thread202.i, label %bb.aq

.thread202.i:                                     ; preds = %bb.ap
...
bb.at:                                            ; preds = %bb.as, %.thread202.i
  %.3209.i = phi ptr [ %i.cg, %.thread202.i ], [ %i.cr, %bb.as ] ; 2 uses
...
bb.au:                                            ; preds = %bb.at, %bb.ar, %.thread202.i
  %.sink261.i = phi i64 [ %i.bm, %bb.at ], [ %i.u, %bb.ar ], [ %i.u, %.thread202.i ]
  %.3210.sink259.i = phi ptr [ %i.cu, %bb.at ], [ %i.cp, %bb.ar ], [ %i.cg, %.thread202.i ] ; 2 uses
  ...
  br i1 %.1165237250.i36, label %bb.aw, label %bb.av
...
bb.aw:                                            ; preds = %bb.av, %bb.au, %bb.ab, %bb.aa, %bb.z, %bb.y
  %.6.ph.i = phi ptr [ %i.as, %bb.aa ], [ %i.as, %bb.ab ], [ %i.ao, %bb.y ], [ %i.ao, %bb.z ], [ %spec.select199.i, %bb.au ], [ %i.dh, %bb.av ]
  %.0.ph.i = phi ptr [ %i.af, %bb.aa ], [ %i.af, %bb.ab ], [ %i.af, %bb.y ], [ %i.af, %bb.z ], [ %i.bu, %bb.au ], [ %i.bu, %bb.av ]
