...
bb.am:                                            ; preds = %bb.ak
  %i.bx = load i32, ptr %i.c, align 4, !tbaa !10
...
bb.ap:                                            ; preds = %bb.ao
  %5 = xor i64 %i.bo, 1                           ; 2 uses
  call void @llvm.memset.p0.i64(ptr align 1 %.1164.i, i8 48, i64 %5, i1 false)
  %i.ch = getelementptr i8, ptr %.1164.i, i64 %5  ; 4 uses
  %.not192.i = icmp sgt i64 %i.bm, %i.u
  br i1 %.not192.i, label %bb.aq, label %.split.i

.split.i:                                         ; preds = %bb.ap
  %i.ci = call ptr @strncpy(ptr noundef %i.ch, ptr noundef nonnull %i.n, i64 noundef %i.bm) #10 ; 0 uses
  %i.cj = getelementptr i8, ptr %i.ch, i64 %i.bm  ; 2 uses
  %i.ck = getelementptr i8, ptr %i.cj, i64 1      ; 2 uses
  store i8 46, ptr %i.cj, align 1, !tbaa !11
  %i.cl = getelementptr i8, ptr %i.n, i64 %i.bm
  %i.cm = sub nuw nsw i64 %i.u, %i.bm             ; 2 uses
...
bb.aq:                                            ; preds = %bb.ap
  %i.cp = call ptr @strncpy(ptr noundef %i.ch, ptr noundef nonnull %i.n, i64 noundef %i.u) #10 ; 0 uses
  %i.cq = getelementptr i8, ptr %i.ch, i64 %i.u
  br label %bb.ar

bb.ar:                                            ; preds = %bb.aq, %.thread202.i
  %.3209.i = phi ptr [ %i.cg, %.thread202.i ], [ %i.cq, %bb.aq ] ; 2 uses
  %i.cr = sub i64 %i.bm, %i.u                     ; 2 uses
...
bb.as:                                            ; preds = %bb.ar, %.split.i, %.thread202.i
  ...
  %.3210.sink260.i = phi ptr [ %i.ct, %bb.ar ], [ %i.co, %.split.i ], [ %i.cg, %.thread202.i ] ; 2 uses
...
bb.at:                                            ; preds = %bb.as
  ...
  %i.de = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %i.dd, ptr noundef nonnull dereferenceable(1) @.str.11, i32 noundef %i.br) #10
...
bb.au:                                            ; preds = %bb.at, %bb.as, %bb.ab, %bb.aa, %bb.z, %bb.y
  ...
  %.6.ph.i = phi ptr [ %i.as, %bb.aa ], [ %i.as, %bb.ab ], [ %i.ao, %bb.y ], [ %i.ao, %bb.z ], [ %spec.select199.i, %bb.as ], [ %i.dg, %bb.at ]
