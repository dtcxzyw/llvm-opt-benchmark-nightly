...
bb.a:
  ...
  %.val14 = load i64, ptr %i.b, align 8, !tbaa !51
...
vector.body147:                                   ; preds = %vector.body147, %vector.ph145
  ...
  %wide.load151 = load <8 x i8>, ptr %next.gep149, align 1, !tbaa !23, !alias.scope !65
  %wide.load152 = load <8 x i8>, ptr %i.bg, align 1, !tbaa !23, !alias.scope !65
  ...
  store <8 x i16> %i.bh, ptr %next.gep150, align 2, !tbaa !39, !alias.scope !66, !noalias !65
  store <8 x i16> %i.bi, ptr %i.bj, align 2, !tbaa !39, !alias.scope !66, !noalias !65
  %index.next153 = add nuw i64 %index148, 16      ; 2 uses
  %i.bk = icmp eq i64 %index.next153, %n.vec146
  br i1 %i.bk, label %middle.block154, label %vector.body147, !llvm.loop !55
...
vec.epilog.iter.check:                            ; preds = %middle.block154
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph108.preheader, label %vec.epilog.ph, !prof !67
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load162 = load <4 x i8>, ptr %next.gep160, align 1, !tbaa !23, !alias.scope !65
  %i.bp = zext <4 x i8> %wide.load162 to <4 x i16>
  store <4 x i16> %i.bp, ptr %next.gep161, align 2, !tbaa !39, !alias.scope !66, !noalias !65
...
.lr.ph103:                                        ; preds = %.lr.ph103.prol.loopexit, %.lr.ph103
  ...
  br i1 %i.ch, label %.lr.ph103, label %.preheader.loopexit, !llvm.loop !57
...
.lr.ph108:                                        ; preds = %.lr.ph108.preheader, %.lr.ph108
  ...
  br i1 %exitcond116.not, label %.loopexit, label %.lr.ph108, !llvm.loop !58
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.de, label %middle.block, label %vector.body, !llvm.loop !62
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  br i1 %i.dv, label %.lr.ph, label %.preheader93.loopexit, !llvm.loop !63
...
.lr.ph100:                                        ; preds = %.lr.ph100.preheader168, %.lr.ph100
  ...
  br i1 %exitcond.not, label %.loopexit, label %.lr.ph100, !llvm.loop !64
...
bb.d:                                             ; preds = %.preheader.i
  %i.g = load i64, ptr %.017.i, align 8, !tbaa !44
