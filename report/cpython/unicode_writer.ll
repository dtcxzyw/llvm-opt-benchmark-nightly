...
bb.b:                                             ; preds = %bb.a
  ...
  %.val36 = load i64, ptr %i.b, align 8, !tbaa !36
...
bb.a:
  ...
  %.val14 = load i64, ptr %i.b, align 8, !tbaa !52
...
bb.e:                                             ; preds = %bb.c
  ...
  %.val = load i64, ptr %i.j, align 8, !tbaa !36
...
.lr.ph103.prol:                                   ; preds = %.lr.ph103.preheader
  ...
  %6 = zext i8 %5 to i16
  store i16 %6, ptr %i.ar, align 2, !tbaa !39
...
vector.body147:                                   ; preds = %vector.body147, %vector.ph145
  ...
  %wide.load151 = load <8 x i8>, ptr %next.gep149, align 1, !tbaa !23, !alias.scope !66
  %wide.load152 = load <8 x i8>, ptr %i.bg, align 1, !tbaa !23, !alias.scope !66
  ...
  store <8 x i16> %i.bh, ptr %next.gep150, align 2, !tbaa !39, !alias.scope !67, !noalias !66
  store <8 x i16> %i.bi, ptr %i.bj, align 2, !tbaa !39, !alias.scope !67, !noalias !66
  %index.next153 = add nuw i64 %index148, 16      ; 2 uses
  %i.bk = icmp eq i64 %index.next153, %n.vec146
  br i1 %i.bk, label %middle.block154, label %vector.body147, !llvm.loop !56
...
vec.epilog.iter.check:                            ; preds = %middle.block154
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph108.preheader, label %vec.epilog.ph, !prof !44
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load162 = load <4 x i8>, ptr %next.gep160, align 1, !tbaa !23, !alias.scope !66
  %i.bp = zext <4 x i8> %wide.load162 to <4 x i16>
  store <4 x i16> %i.bp, ptr %next.gep161, align 2, !tbaa !39, !alias.scope !67, !noalias !66
...
.lr.ph103:                                        ; preds = %.lr.ph103.prol.loopexit, %.lr.ph103
  ...
  store i16 %34, ptr %35, align 2, !tbaa !39
  ...
  store i16 %i.bs, ptr %37, align 2, !tbaa !39
  ...
  store i16 %i.bz, ptr %i.ca, align 2, !tbaa !39
...
.lr.ph108:                                        ; preds = %.lr.ph108.preheader, %.lr.ph108
  ...
  store i16 %i.ck, ptr %.186106, align 2, !tbaa !39
  %exitcond116.not = icmp eq ptr %i.ci, %scevgep115
  br i1 %exitcond116.not, label %.loopexit, label %.lr.ph108, !llvm.loop !59
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader
  ...
  store i32 %41, ptr %i.cm, align 4, !tbaa !10
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i8>, ptr %next.gep, align 1, !tbaa !23, !alias.scope !68
  %wide.load135 = load <4 x i8>, ptr %i.da, align 1, !tbaa !23, !alias.scope !68
  ...
  store <4 x i32> %i.db, ptr %next.gep134, align 4, !tbaa !10, !alias.scope !69, !noalias !68
  store <4 x i32> %i.dc, ptr %i.dd, align 4, !tbaa !10, !alias.scope !69, !noalias !68
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.de = icmp eq i64 %index.next, %n.vec
  br i1 %i.de, label %middle.block, label %vector.body, !llvm.loop !63
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  store i32 %58, ptr %.08195, align 4, !tbaa !10
...
.lr.ph100:                                        ; preds = %.lr.ph100.preheader168, %.lr.ph100
  ...
  store i32 %i.dy, ptr %.18298, align 4, !tbaa !10
  %exitcond.not = icmp eq ptr %i.dw, %scevgep
  br i1 %exitcond.not, label %.loopexit, label %.lr.ph100, !llvm.loop !65
...
bb.d:                                             ; preds = %.preheader.i
  %i.g = load i64, ptr %.017.i, align 8, !tbaa !45
