...
_Py_XNewRef.exit.cont41.thread.i:                 ; preds = %_Py_XNewRef.exit.i
  %.sroa.0.sroa.0.0.insert.ext48.i = zext i32 %7 to i64
  %.sroa.0.sroa.0.0.insert.insert49.i = or disjoint i64 %.sroa.0.sroa.0.0.insert.ext48.i, 64424509440
...
_Py_XNewRef.exit.i.a:                             ; preds = %_Py_XNewRef.exit.else.i, %_Py_XNewRef.exit.cont41.thread.i
  ...
  %10 = phi i64 [ %.sroa.0.sroa.0.0.insert.insert49.i, %_Py_XNewRef.exit.cont41.thread.i ], [ %.else.val.i, %_Py_XNewRef.exit.else.i ]
  %i.o = getelementptr i8, ptr %i.a, i64 36
  store i64 %10, ptr %i.o, align 4
  %i.p = icmp eq i32 %3, -1
  br i1 %i.p, label %bb.i, label %bb.j

bb.i:                                             ; preds = %_Py_XNewRef.exit.i.a
  %i.q = tail call ptr @_Py_GetConfig() #11
  %i.r = getelementptr i8, ptr %i.q, i64 196
  %i.s = load i32, ptr %i.r, align 4, !tbaa !112
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %_Py_XNewRef.exit.i.a
  %i.t = phi i32 [ %i.s, %bb.i ], [ %3, %_Py_XNewRef.exit.i.a ] ; 2 uses
  ...
  %i.w = tail call i32 @_PyAST_Preprocess(ptr noundef %0, ptr noundef %4, ptr noundef nonnull %1, i32 noundef %i.t, i32 noundef %9, i32 noundef 0, i32 noundef 1, ptr noundef %5) #11
  %.not39.i = icmp eq i32 %i.w, 0
  br i1 %.not39.i, label %bb.n, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.x = tail call ptr @_PySymtable_Build(ptr noundef %0, ptr noundef nonnull %1, ptr noundef nonnull %i.j) #11 ; 2 uses
...
bb.l:                                             ; preds = %bb.k
  %i.aa = tail call ptr @PyErr_Occurred() #11
  %.not40.i = icmp eq ptr %i.aa, null
  br i1 %.not40.i, label %bb.m, label %bb.n

bb.m:                                             ; preds = %bb.l
  %i.ab = load ptr, ptr @PyExc_SystemError, align 8, !tbaa !35
  tail call void @PyErr_SetString(ptr noundef %i.ab, ptr noundef nonnull @.str.16) #11
  br label %bb.n
...
.preheader98:                                     ; preds = %.critedge, %.critedge2
  %.071100 = phi i64 [ %.172, %.critedge2 ], [ 9223372036854775807, %.critedge ] ; 2 uses
end_hunk_1
