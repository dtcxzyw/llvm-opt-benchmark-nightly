...
bb.e:                                             ; preds = %.lr.ph
  %.019 = add nsw i64 %.01930, -1
  %i.m = icmp sgt i64 %.01930, 0
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = getelementptr i8, ptr %i.f, i64 944
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !48
  %i.i = tail call i64 @_PyCompile_DictAddObj(ptr noundef %i.h, ptr noundef nonnull %i.c) ; 3 uses
  %i.j = load i32, ptr %i.c, align 8, !tbaa !11   ; 2 uses
...
Py_DECREF.exit:                                   ; preds = %bb.d, %bb.c, %bb.b, %bb.a
  %.0 = phi i64 [ -1, %bb.a ], [ %i.i, %bb.b ], [ %i.i, %bb.c ], [ %i.i, %bb.d ]
  ret i64 %.0
}

; Function Attrs: nounwind uwtable
define hidden range(i32 -1, 1) i32 @_PyCompile_EnterScope(ptr nofree noundef captures(none) %0, ptr noundef %1, i32 noundef %2, ptr noundef %3, i32 noundef %4, ptr noundef %5, ptr nofree noundef readonly captures(address_is_null) %6) local_unnamed_addr #0 {
bb.a:
  %i.a = tail call ptr @PyMem_Calloc(i64 noundef 1, i64 noundef 1024) #11 ; 42 uses
  %.not = icmp eq ptr %i.a, null
  br i1 %.not, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %i.b = tail call ptr @PyErr_NoMemory() #11      ; 0 uses
  br label %bb.be

bb.c:                                             ; preds = %bb.a
  %i.c = getelementptr i8, ptr %i.a, i64 8
  store i32 %2, ptr %i.c, align 8, !tbaa !36
  %.not102 = icmp eq ptr %6, null
  br i1 %.not102, label %bb.e, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.d = getelementptr i8, ptr %i.a, i64 928
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(96) %i.d, ptr noundef nonnull align 8 dereferenceable(96) %6, i64 96, i1 false), !tbaa.struct !49
  br label %bb.f

bb.e:                                             ; preds = %bb.c
  %i.e = getelementptr i8, ptr %i.a, i64 992
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %i.h = tail call ptr @_PySymtable_Lookup(ptr noundef %i.g, ptr noundef %3) #11 ; 3 uses
  store ptr %i.h, ptr %i.a, align 8, !tbaa !52
  %.not103 = icmp eq ptr %i.h, null
  br i1 %.not103, label %bb.g, label %bb.h

bb.g:                                             ; preds = %bb.f
  tail call fastcc void @compiler_unit_free(ptr noundef nonnull %i.a)
  br label %bb.be

bb.h:                                             ; preds = %bb.f
  %i.i = load i32, ptr %1, align 8, !tbaa !11     ; 2 uses
  %i.j = icmp ugt i32 %i.i, -1073741825
  br i1 %i.j, label %_Py_NewRef.exit, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.k = add nuw i32 %i.i, 1
  store i32 %i.k, ptr %1, align 8, !tbaa !11
  %.pre = load ptr, ptr %i.a, align 8, !tbaa !52
  br label %_Py_NewRef.exit

_Py_NewRef.exit:                                  ; preds = %bb.h, %bb.i
  %i.l = phi ptr [ %i.h, %bb.h ], [ %.pre, %bb.i ]
  %i.m = getelementptr i8, ptr %i.a, i64 928
  store ptr %1, ptr %i.m, align 8, !tbaa !53
end_hunk_0
begin_hunk_1_@PyList_Append
declare i32 @PyList_Append(ptr noundef, ptr noundef) local_unnamed_addr #2

; Function Attrs: nounwind uwtable
define internal fastcc range(i32 -1, 1) i32 @compiler_set_qualname(ptr nofree noundef readonly captures(none) %0) unnamed_addr #0 {
bb.a:
  %i.a = alloca ptr, align 8                      ; 5 uses
  %i.b = getelementptr i8, ptr %0, i64 64
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !47   ; 6 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #11
  %i.d = getelementptr i8, ptr %0, i64 72         ; 2 uses
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !14   ; 2 uses
  %i.f = getelementptr i8, ptr %i.e, i64 16
  %.val = load i64, ptr %i.f, align 8, !tbaa !24  ; 4 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.j = getelementptr [8 x i8], ptr %i.i, i64 %.val
  %i.k = getelementptr i8, ptr %i.j, i64 -8
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !35
  %i.m = tail call ptr @PyCapsule_GetPointer(ptr noundef %i.l, ptr noundef nonnull @.str.1) #11 ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  %i.q = icmp eq i64 %.val, 2
  br i1 %i.q, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  %i.r = getelementptr i8, ptr %i.c, i64 928
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !53   ; 3 uses
  %i.t = load i32, ptr %i.s, align 8, !tbaa !11   ; 2 uses
  %i.u = icmp ugt i32 %i.t, -1073741825
  br i1 %i.u, label %_Py_NewRef.exit57.sink.split, label %_Py_NewRef.exit57.sink.split.sink.split

bb.e:                                             ; preds = %bb.c
  %i.v = load ptr, ptr %i.d, align 8, !tbaa !14
  %i.w = getelementptr i8, ptr %i.v, i64 24
  %i.x = load ptr, ptr %i.w, align 8, !tbaa !31
  %i.y = getelementptr [8 x i8], ptr %i.x, i64 %.val
  %i.z = getelementptr i8, ptr %i.y, i64 -16
  %i.aa = load ptr, ptr %i.z, align 8, !tbaa !35
  %i.ab = tail call ptr @PyCapsule_GetPointer(ptr noundef %i.aa, ptr noundef nonnull @.str.1) #11
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.b
  %.039 = phi ptr [ %i.ab, %bb.e ], [ %i.m, %bb.b ] ; 4 uses
  %i.ac = getelementptr i8, ptr %i.c, i64 8
  %i.ad = load i32, ptr %i.ac, align 8, !tbaa !36
  %.off = add i32 %i.ad, -1
  %switch = icmp ult i32 %.off, 3
  br i1 %switch, label %bb.g, label %bb.k

bb.g:                                             ; preds = %bb.f
  %i.ae = getelementptr i8, ptr %.039, i64 16
  %i.af = load ptr, ptr %i.ae, align 8, !tbaa !69
  %i.ag = getelementptr i8, ptr %i.c, i64 928
  %i.ah = load ptr, ptr %i.ag, align 8, !tbaa !53
  %i.ai = tail call ptr @_Py_Mangle(ptr noundef %i.af, ptr noundef %i.ah) #11 ; 5 uses
  %.not = icmp eq ptr %i.ai, null
  br i1 %.not, label %_Py_NewRef.exit57, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.aj = load ptr, ptr %.039, align 8, !tbaa !52
  %i.ak = tail call i32 @_PyST_GetScope(ptr noundef %i.aj, ptr noundef nonnull %i.ai) #11 ; 2 uses
  %i.al = load i32, ptr %i.ai, align 8, !tbaa !11 ; 2 uses
  %.not.i54 = icmp sgt i32 %i.al, -1
  br i1 %.not.i54, label %bb.i, label %Py_DECREF.exit55

bb.i:                                             ; preds = %bb.h
  %i.am = add nsw i32 %i.al, -1                   ; 2 uses
  store i32 %i.am, ptr %i.ai, align 8, !tbaa !11
  %i.an = icmp eq i32 %i.am, 0
  br i1 %i.an, label %bb.j, label %Py_DECREF.exit55

bb.j:                                             ; preds = %bb.i
  tail call void @_Py_Dealloc(ptr noundef nonnull %i.ai) #11
  br label %Py_DECREF.exit55

Py_DECREF.exit55:                                 ; preds = %bb.h, %bb.i, %bb.j
  switch i32 %i.ak, label %bb.k [
    i32 -1, label %_Py_NewRef.exit57
    i32 2, label %.thread
  ]

bb.k:                                             ; preds = %bb.f, %Py_DECREF.exit55
  %i.ao = getelementptr i8, ptr %.039, i64 8
  %i.ap = load i32, ptr %i.ao, align 8, !tbaa !36
  %.off52 = add i32 %i.ap, -2
  %switch53 = icmp ult i32 %.off52, 3
  %i.aq = getelementptr i8, ptr %.039, i64 936
  %i.ar = load ptr, ptr %i.aq, align 8, !tbaa !73 ; 5 uses
  br i1 %switch53, label %bb.l, label %bb.m

bb.l:                                             ; preds = %bb.k
  %i.as = tail call ptr @PyUnicode_Concat(ptr noundef %i.ar, ptr noundef nonnull getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 60120)) #11 ; 2 uses
  %i.at = icmp eq ptr %i.as, null
  br i1 %i.at, label %_Py_NewRef.exit57, label %bb.o

bb.m:                                             ; preds = %bb.k
  %i.au = load i32, ptr %i.ar, align 8, !tbaa !11 ; 2 uses
  %i.av = icmp ugt i32 %i.au, -1073741825
  br i1 %i.av, label %bb.o, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.aw = add nuw i32 %i.au, 1
  store i32 %i.aw, ptr %i.ar, align 8, !tbaa !11
  br label %bb.o

bb.o:                                             ; preds = %bb.l, %bb.n, %bb.m
  %.142.ph.ph = phi ptr [ %i.ar, %bb.n ], [ %i.ar, %bb.m ], [ %i.as, %bb.l ] ; 4 uses
  %i.ax = tail call ptr @PyUnicode_Concat(ptr noundef nonnull %.142.ph.ph, ptr noundef nonnull getelementptr inbounds nuw (i8, ptr @_PyRuntime, i64 107296)) #11 ; 2 uses
  store ptr %i.ax, ptr %i.a, align 8, !tbaa !35
  %i.ay = load i32, ptr %.142.ph.ph, align 8, !tbaa !11 ; 2 uses
  %.not.i = icmp sgt i32 %i.ay, -1
  br i1 %.not.i, label %bb.p, label %Py_DECREF.exit

bb.p:                                             ; preds = %bb.o
  %i.az = add nsw i32 %i.ay, -1                   ; 2 uses
  store i32 %i.az, ptr %.142.ph.ph, align 8, !tbaa !11
  %i.ba = icmp eq i32 %i.az, 0
  br i1 %i.ba, label %bb.q, label %Py_DECREF.exit

bb.q:                                             ; preds = %bb.p
  tail call void @_Py_Dealloc(ptr noundef nonnull %.142.ph.ph) #11
  br label %Py_DECREF.exit

Py_DECREF.exit:                                   ; preds = %bb.p, %bb.q, %bb.o
  %i.bb = icmp eq ptr %i.ax, null
  br i1 %i.bb, label %_Py_NewRef.exit57, label %bb.r

bb.r:                                             ; preds = %Py_DECREF.exit
  %i.bc = getelementptr i8, ptr %i.c, i64 928
  %i.bd = load ptr, ptr %i.bc, align 8, !tbaa !53
  call void @PyUnicode_Append(ptr noundef nonnull %i.a, ptr noundef %i.bd) #11
  %i.be = load ptr, ptr %i.a, align 8, !tbaa !35  ; 2 uses
  %i.bf = icmp eq ptr %i.be, null
  br i1 %i.bf, label %_Py_NewRef.exit57, label %_Py_NewRef.exit57.sink.split

.thread:                                          ; preds = %bb.a, %Py_DECREF.exit55
  %i.bg = getelementptr i8, ptr %i.c, i64 928
  %i.bh = load ptr, ptr %i.bg, align 8, !tbaa !53 ; 3 uses
  %i.bi = load i32, ptr %i.bh, align 8, !tbaa !11 ; 2 uses
  %i.bj = icmp ugt i32 %i.bi, -1073741825
  br i1 %i.bj, label %_Py_NewRef.exit57.sink.split, label %_Py_NewRef.exit57.sink.split.sink.split

_Py_NewRef.exit57.sink.split.sink.split:          ; preds = %.thread, %bb.d
  %.sink78 = phi i32 [ %i.t, %bb.d ], [ %i.bi, %.thread ]
  %.sink77 = phi ptr [ %i.s, %bb.d ], [ %i.bh, %.thread ] ; 2 uses
  %i.bk = add nuw i32 %.sink78, 1
  store i32 %i.bk, ptr %.sink77, align 8, !tbaa !11
  br label %_Py_NewRef.exit57.sink.split

_Py_NewRef.exit57.sink.split:                     ; preds = %_Py_NewRef.exit57.sink.split.sink.split, %bb.r, %.thread, %bb.d
  %.sink = phi ptr [ %i.bh, %.thread ], [ %i.s, %bb.d ], [ %i.be, %bb.r ], [ %.sink77, %_Py_NewRef.exit57.sink.split.sink.split ]
  %i.bl = getelementptr i8, ptr %i.c, i64 936
  store ptr %.sink, ptr %i.bl, align 8, !tbaa !73
  br label %_Py_NewRef.exit57

_Py_NewRef.exit57:                                ; preds = %_Py_NewRef.exit57.sink.split, %bb.g, %Py_DECREF.exit55, %bb.l, %bb.r, %Py_DECREF.exit
  %.1 = phi i32 [ -1, %bb.r ], [ -1, %Py_DECREF.exit ], [ -1, %bb.l ], [ %i.ak, %Py_DECREF.exit55 ], [ -1, %bb.g ], [ 0, %_Py_NewRef.exit57.sink.split ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #11
  ret i32 %.1
}

; Function Attrs: nounwind uwtable
define hidden void @_PyCompile_ExitScope(ptr nofree noundef captures(none) %0) local_unnamed_addr #0 {
bb.a:
  %i.a = tail call ptr @PyErr_GetRaisedException() #11
  %i.b = getelementptr i8, ptr %0, i64 80
  %i.c = load i8, ptr %i.b, align 8, !tbaa !74, !range !75, !noundef !76
  %i.d = trunc nuw i8 %i.c to i1
  br i1 %i.d, label %bb.b, label %Py_INCREF.exit

bb.b:                                             ; preds = %bb.a
  %i.e = getelementptr i8, ptr %0, i64 64
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !47
  %i.g = getelementptr i8, ptr %i.f, i64 56
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !67   ; 4 uses
  %i.i = load i32, ptr %i.h, align 8, !tbaa !11   ; 2 uses
  %i.j = icmp ugt i32 %i.i, -1073741825
  br i1 %i.j, label %Py_INCREF.exit, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.k = add nuw i32 %i.i, 1
  store i32 %i.k, ptr %i.h, align 8, !tbaa !11
  br label %Py_INCREF.exit

Py_INCREF.exit:                                   ; preds = %bb.c, %bb.b, %bb.a
  %.0 = phi ptr [ null, %bb.a ], [ %i.h, %bb.b ], [ %i.h, %bb.c ] ; 6 uses
  %i.l = getelementptr i8, ptr %0, i64 64         ; 4 uses
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !47
  tail call fastcc void @compiler_unit_free(ptr noundef %i.m)
...
bb.d:                                             ; preds = %Py_INCREF.exit
  ...
  %i.y = tail call i32 @PySequence_DelItem(ptr noundef %i.x, i64 noundef %i.q) #11
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  br i1 %.not, label %Py_XDECREF.exit, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.aa = load ptr, ptr %i.l, align 8, !tbaa !47
  %i.ab = getelementptr i8, ptr %i.aa, i64 56
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !67
  %i.ad = tail call i32 @_PyInstructionSequence_AddNested(ptr noundef %i.ac, ptr noundef nonnull %.0) #11
...
; Function Attrs: nounwind uwtable
define hidden range(i32 -1, 1) i32 @_PyCompile_PushFBlock(ptr nofree noundef captures(none) %0, i64 %1, i64 %2, i32 noundef %3, i32 %4, i32 %5, ptr noundef %6) local_unnamed_addr #0 {
bb.a:
  %i.a = getelementptr i8, ptr %0, i64 64
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !47   ; 2 uses
  %i.c = getelementptr i8, ptr %i.b, i64 72       ; 2 uses
  %i.d = load i32, ptr %i.c, align 8, !tbaa !63   ; 3 uses
  %i.e = icmp sgt i32 %i.d, 20
  br i1 %i.e, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %i.f = tail call i32 (ptr, i64, i64, ptr, ...) @_PyCompile_Error(ptr noundef nonnull %0, i64 %1, i64 %2, ptr noundef nonnull @.str.4) ; 0 uses
  br label %bb.e

bb.c:                                             ; preds = %bb.a
  %i.g = getelementptr i8, ptr %i.b, i64 88
  %i.h = add nsw i32 %i.d, 1
  store i32 %i.h, ptr %i.c, align 8, !tbaa !63
  %i.i = sext i32 %i.d to i64
  %i.j = getelementptr [40 x i8], ptr %i.g, i64 %i.i ; 6 uses
  store i32 %3, ptr %i.j, align 8, !tbaa !77
  %i.k = getelementptr i8, ptr %i.j, i64 4
  store i32 %4, ptr %i.k, align 4, !tbaa !7
  %i.l = getelementptr i8, ptr %i.j, i64 8
  store i64 %1, ptr %i.l, align 8
  %.sroa.3.0..sroa_idx = getelementptr i8, ptr %i.j, i64 16
  store i64 %2, ptr %.sroa.3.0..sroa_idx, align 8
  %i.m = getelementptr i8, ptr %i.j, i64 24
  store i32 %5, ptr %i.m, align 8, !tbaa !7
  %i.n = getelementptr i8, ptr %i.j, i64 32
  store ptr %6, ptr %i.n, align 8, !tbaa !80
  %i.o = icmp eq i32 %3, 5
  br i1 %i.o, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  %i.p = getelementptr i8, ptr %0, i64 84         ; 2 uses
  %i.q = load i32, ptr %i.p, align 4, !tbaa !81
  %i.r = add i32 %i.q, 1
  store i32 %i.r, ptr %i.p, align 4, !tbaa !81
  br label %bb.e
...
; Function Attrs: nounwind uwtable
define hidden noundef i32 @_PyCompile_Error(ptr nofree noundef readonly captures(none) %0, i64 %1, i64 %2, ptr noundef %3, ...) local_unnamed_addr #0 {
bb.a:
  %4 = alloca [1 x %struct.__va_list_tag], align 16 ; 5 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #11
  call void @llvm.va_start.p0(ptr nonnull %4)
  %i.a = call ptr @PyUnicode_FromFormatV(ptr noundef %3, ptr noundef nonnull %4) #11 ; 5 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = add i32 %.sroa.3.8.extract.trunc, 1
  %i.e = add i32 %.sroa.5.8.extract.trunc, 1
  call void @_PyErr_RaiseSyntaxError(ptr noundef nonnull %i.a, ptr noundef %i.c, i32 noundef %.sroa.0.0.extract.trunc, i32 noundef %i.d, i32 noundef %.sroa.2.0.extract.trunc, i32 noundef %i.e) #11
  %i.f = load i32, ptr %i.a, align 8, !tbaa !11   ; 2 uses
  %.not.i = icmp sgt i32 %i.f, -1
  br i1 %.not.i, label %bb.c, label %Py_DECREF.exit

bb.c:                                             ; preds = %bb.b
  %i.g = add nsw i32 %i.f, -1                     ; 2 uses
  store i32 %i.g, ptr %i.a, align 8, !tbaa !11
  %i.h = icmp eq i32 %i.g, 0
  br i1 %i.h, label %bb.d, label %Py_DECREF.exit

bb.d:                                             ; preds = %bb.c
  call void @_Py_Dealloc(ptr noundef nonnull %i.a) #11
  br label %Py_DECREF.exit
...
define hidden void @_PyCompile_PopFBlock(ptr nofree noundef captures(none) %0, i32 noundef %1, i32 %2) local_unnamed_addr #3 {
bb.a:
  %i.a = getelementptr i8, ptr %0, i64 64
  ...
  %i.e = add i32 %i.d, -1
  store i32 %i.e, ptr %i.c, align 8, !tbaa !63
  %i.f = icmp eq i32 %1, 5
  br i1 %i.f, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %i.g = getelementptr i8, ptr %0, i64 84         ; 2 uses
  %i.h = load i32, ptr %i.g, align 4, !tbaa !81
  %i.i = add i32 %i.h, -1
  store i32 %i.i, ptr %i.g, align 4, !tbaa !81
  br label %bb.c
...
define hidden ptr @_PyCompile_TopFBlock(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #4 {
bb.a:
  %i.a = getelementptr i8, ptr %0, i64 64
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !47   ; 2 uses
  ...
  %i.f = getelementptr i8, ptr %i.b, i64 88
  %i.g = add i32 %i.d, -1
  %i.h = sext i32 %i.g to i64
  %i.i = getelementptr [40 x i8], ptr %i.f, i64 %i.h
  %.0 = select i1 %i.e, ptr null, ptr %i.i
  ret ptr %.0
}

; Function Attrs: nofree norecurse nosync nounwind memory(read, inaccessiblemem: none, target_mem: none) uwtable
define hidden noundef zeroext i1 @_PyCompile_InExceptionHandler(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #5 {
bb.a:
  %i.a = getelementptr i8, ptr %0, i64 64
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !47   ; 2 uses
  %i.c = getelementptr i8, ptr %i.b, i64 72
