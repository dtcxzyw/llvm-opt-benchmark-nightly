...
bb.d:                                             ; preds = %bb.e, %bb.c
  %i.g = load ptr, ptr %i.e, align 8, !tbaa !212
  %i.h = load ptr, ptr %i.f, align 8, !tbaa !149
  %i.i = call i32 %i.g(ptr noundef %1, ptr noundef nonnull %i.a, ptr noundef %3, ptr noundef nonnull %i.b, ptr noundef %i.h) #22, !inline_history !8
...
poolAppend.exit:                                  ; preds = %bb.d
  ...
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !150
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a)
  %.not = icmp eq ptr %i.l, null
  br i1 %.not, label %bb.i, label %bb.f

bb.f:                                             ; preds = %poolAppend.exit
  %i.m = load ptr, ptr %i.b, align 8, !tbaa !148  ; 2 uses
  %i.n = load ptr, ptr %i.f, align 8, !tbaa !149
...
bb.h:                                             ; preds = %._crit_edge, %bb.f
  ...
  store ptr %i.r, ptr %i.b, align 8, !tbaa !148
  store i8 0, ptr %i.q, align 1, !tbaa !22
  %i.s = load ptr, ptr %i.k, align 8, !tbaa !150
  br label %bb.i
...
bb.c:                                             ; preds = %bb.b
  ...
  store i8 6, ptr %i.d, align 8, !tbaa !69
  store i64 64, ptr %i.a, align 8, !tbaa !107
  ...
  store ptr %i.g, ptr %1, align 8, !tbaa !70
  %.not168 = icmp eq ptr %i.g, null
  br i1 %.not168, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  store i64 0, ptr %i.a, align 8, !tbaa !107
  br label %.thread
...
bb.e:                                             ; preds = %bb.c
  ...
  %i.i = load i64, ptr %i.a, align 8, !tbaa !107
  %i.j = add i64 %i.i, -1
  %i.k = and i64 %i.j, %i.h
  br label %keyeq.exit
...
bb.f:                                             ; preds = %bb.a
  ...
  %i.m = load i64, ptr %i.a, align 8, !tbaa !107  ; 3 uses
...
.lr.ph:                                           ; preds = %bb.f
  %i.s = load i8, ptr %2, align 1, !tbaa !22      ; 2 uses
  %i.t = sub i64 0, %i.m
  %i.u = and i64 %i.l, %i.t
...
bb.g:                                             ; preds = %.lr.ph, %bb.j
  ...
  %.0125186 = phi i8 [ 0, %.lr.ph ], [ %.1126, %bb.j ] ; 2 uses
  %.1133185 = phi i64 [ %i.o, %.lr.ph ], [ %.2134, %bb.j ] ; 2 uses
...
bb.h:                                             ; preds = %.lr.ph.i
  ...
  %i.af = load i8, ptr %i.ad, align 1, !tbaa !22  ; 2 uses
  %i.ag = load i8, ptr %i.ae, align 1, !tbaa !22
  %i.ah = icmp eq i8 %i.af, %i.ag
  br i1 %i.ah, label %.lr.ph.i, label %.loopexit, !llvm.loop !3

.loopexit:                                        ; preds = %bb.h, %bb.g
  %.not166 = icmp eq i8 %.0125186, 0
  br i1 %.not166, label %bb.i, label %bb.j

bb.i:                                             ; preds = %.loopexit
  %i.ai = load i8, ptr %i.v, align 8, !tbaa !69
...
bb.j:                                             ; preds = %bb.i, %.loopexit
  %.1126 = phi i8 [ %.0125186, %.loopexit ], [ %i.ap, %bb.i ] ; 2 uses
  %i.aq = zext i8 %.1126 to i64                   ; 2 uses
  %i.ar = icmp ult i64 %.1133185, %i.aq
  %.2134.p.v = select i1 %i.ar, i64 %i.m, i64 0
  %.2134.p = sub i64 %.1133185, %i.aq
  %.2134 = add i64 %.2134.p, %.2134.p.v           ; 3 uses
  %i.as = getelementptr [8 x i8], ptr %i.p, i64 %.2134
  %i.at = load ptr, ptr %i.as, align 8, !tbaa !56 ; 2 uses
  %.not = icmp eq ptr %i.at, null
  br i1 %.not, label %._crit_edge, label %bb.g, !llvm.loop !4

._crit_edge:                                      ; preds = %bb.j, %bb.f
  %.1133.lcssa = phi i64 [ %i.o, %bb.f ], [ %.2134, %bb.j ]
  %.not157 = icmp eq i64 %3, 0
  br i1 %.not157, label %.thread, label %bb.k

bb.k:                                             ; preds = %._crit_edge
  %i.au = getelementptr i8, ptr %1, i64 24
  %i.av = load i64, ptr %i.au, align 8, !tbaa !111
  %i.aw = getelementptr i8, ptr %1, i64 8         ; 2 uses
  %i.ax = load i8, ptr %i.aw, align 8, !tbaa !69  ; 2 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.bm = load i64, ptr %i.a, align 8, !tbaa !107 ; 2 uses
...
bb.p:                                             ; preds = %.lr.ph196, %bb.s
  ...
  %.3135194 = phi i64 [ 0, %.lr.ph196 ], [ %i.co, %bb.s ] ; 3 uses
  %i.bs = load ptr, ptr %1, align 8, !tbaa !70
  %i.bt = getelementptr [8 x i8], ptr %i.bs, i64 %.3135194
  %i.bu = load ptr, ptr %i.bt, align 8, !tbaa !56 ; 2 uses
  %.not162 = icmp eq ptr %i.bu, null
  br i1 %.not162, label %bb.s, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.bv = load ptr, ptr %i.bu, align 8, !tbaa !159
...
bb.r:                                             ; preds = %.lr.ph191, %bb.r
  ...
  %.2188 = phi i8 [ 0, %.lr.ph191 ], [ %spec.select, %bb.r ] ; 2 uses
  %.not164 = icmp eq i8 %.2188, 0
  %spec.select = select i1 %.not164, i8 %i.ce, i8 %.2188 ; 2 uses
  ...
  br i1 %.not163, label %._crit_edge192, label %bb.r, !llvm.loop !332

._crit_edge192:                                   ; preds = %bb.r, %bb.q
  %.0.lcssa = phi i64 [ %i.bx, %bb.q ], [ %.1, %bb.r ]
  %i.cj = getelementptr [8 x i8], ptr %i.bl, i64 %.0.lcssa
  %i.ck = load ptr, ptr %1, align 8, !tbaa !70
  %i.cl = getelementptr [8 x i8], ptr %i.ck, i64 %.3135194
  %i.cm = load ptr, ptr %i.cl, align 8, !tbaa !56
  store ptr %i.cm, ptr %i.cj, align 8, !tbaa !56
  %.pre = load i64, ptr %i.a, align 8, !tbaa !107
  br label %bb.s

bb.s:                                             ; preds = %bb.p, %._crit_edge192
  %i.cn = phi i64 [ %i.br, %bb.p ], [ %.pre, %._crit_edge192 ] ; 2 uses
  %i.co = add nuw i64 %.3135194, 1                ; 2 uses
  %i.cp = icmp ult i64 %i.co, %i.cn
  br i1 %i.cp, label %bb.p, label %._crit_edge197, !llvm.loop !333

._crit_edge197:                                   ; preds = %bb.s, %bb.o
  %i.cq = load ptr, ptr %i.bj, align 8, !tbaa !71
  %i.cr = load ptr, ptr %1, align 8, !tbaa !70
  tail call fastcc void @expat_free(ptr noundef %i.cq, ptr noundef %i.cr, i32 noundef 7901)
  store ptr %i.bl, ptr %1, align 8, !tbaa !70
  store i8 %i.bb, ptr %i.aw, align 8, !tbaa !69
  store i64 %i.bf, ptr %i.a, align 8, !tbaa !107
...
bb.t:                                             ; preds = %.lr.ph202, %bb.t
  %.4200 = phi i8 [ 0, %.lr.ph202 ], [ %spec.select204, %bb.t ] ; 2 uses
  %.4136199 = phi i64 [ %i.cs, %.lr.ph202 ], [ %.5137, %bb.t ] ; 2 uses
  %.not161 = icmp eq i8 %.4200, 0
  %spec.select204 = select i1 %.not161, i8 %i.dd, i8 %.4200 ; 2 uses
  %i.de = zext i8 %spec.select204 to i64          ; 2 uses
  %i.df = icmp ult i64 %.4136199, %i.de
  %.5137.p.v = select i1 %i.df, i64 %i.bf, i64 0
  %.5137.p = sub i64 %.4136199, %i.de
  %.5137 = add i64 %.5137.p, %.5137.p.v           ; 3 uses
  %i.dg = getelementptr [8 x i8], ptr %i.bl, i64 %.5137
  %i.dh = load ptr, ptr %i.dg, align 8, !tbaa !56
  %.not160 = icmp eq ptr %i.dh, null
  br i1 %.not160, label %keyeq.exit, label %bb.t, !llvm.loop !334

keyeq.exit:                                       ; preds = %bb.t, %._crit_edge197, %bb.k, %bb.e
  %.11 = phi i64 [ %i.k, %bb.e ], [ %.1133.lcssa, %bb.k ], [ %i.cs, %._crit_edge197 ], [ %.5137, %bb.t ] ; 3 uses
  ...
  %i.dl = load ptr, ptr %1, align 8, !tbaa !70
  %i.dm = getelementptr [8 x i8], ptr %i.dl, i64 %.11
  store ptr %i.dk, ptr %i.dm, align 8, !tbaa !56
  %i.dn = load ptr, ptr %1, align 8, !tbaa !70
...
bb.a:
  ...
  %i.g = load i8, ptr %i.f, align 4, !tbaa !205
...
bb.b:                                             ; preds = %bb.a
  ...
  %.04563.i = load ptr, ptr %i.k, align 8, !tbaa !244 ; 2 uses
  %.not64.i = icmp eq ptr %.04563.i, null
  br i1 %.not64.i, label %storeRawNames.exit, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %bb.b, %bb.k
  %.04565.i = phi ptr [ %.045.i, %bb.k ], [ %.04563.i, %bb.b ] ; 8 uses
  %i.l = getelementptr i8, ptr %.04565.i, i64 24  ; 2 uses
  %i.m = getelementptr i8, ptr %.04565.i, i64 48
  %i.n = load i32, ptr %i.m, align 8, !tbaa !245
  %i.o = add i32 %i.n, 1
  %i.p = sext i32 %i.o to i64                     ; 4 uses
  %i.q = getelementptr i8, ptr %.04565.i, i64 64  ; 3 uses
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !22   ; 3 uses
  %i.s = getelementptr i8, ptr %i.r, i64 %i.p     ; 2 uses
  %i.t = getelementptr i8, ptr %.04565.i, i64 8   ; 3 uses
end_hunk_0
