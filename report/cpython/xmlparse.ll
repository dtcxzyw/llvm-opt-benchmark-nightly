...
define internal fastcc i64 @hash(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(address) %1) unnamed_addr #19 {
bb.a:
...
keylen.exit:                                      ; preds = %copy_salt_to_sipkey.exit, %.lr.ph.preheader.i
  %.0.lcssa.i = phi i64 [ 0, %copy_salt_to_sipkey.exit ], [ %i.n, %.lr.ph.preheader.i ]
  %i.o = getelementptr i8, ptr %1, i64 %.0.lcssa.i ; 2 uses
  br label %bb.c

bb.c:                                             ; preds = %sip_round.exit.i, %keylen.exit
  %.0.i = phi ptr [ %1, %keylen.exit ], [ %.1.lcssa.i15, %sip_round.exit.i ] ; 2 uses
  %i.p = icmp ult ptr %.0.i, %i.o
  br i1 %i.p, label %.lr.ph.i, label %sip24_update.exit

.lr.ph.i:                                         ; preds = %bb.c, %bb.d
  %.134.i = phi ptr [ %i.r, %bb.d ], [ %.0.i, %bb.c ] ; 3 uses
...
bb.d:                                             ; preds = %.lr.ph.i
  %i.r = getelementptr i8, ptr %.134.i, i64 1     ; 3 uses
  ...
  %3 = icmp ult ptr %i.r, %i.o
  br i1 %3, label %.lr.ph.i, label %.critedge.i, !llvm.loop !334
...
sip_round.exit.i:                                 ; preds = %.lr.ph.i, %.critedge.i
  %.1.lcssa.i15 = phi ptr [ %i.r, %.critedge.i ], [ %.134.i, %.lr.ph.i ]
...
bb.c:                                             ; preds = %.lr.ph
  ...
  %3 = icmp ult ptr %i.j, %i.a
  br i1 %3, label %.lr.ph, label %.critedge, !llvm.loop !334

.critedge:                                        ; preds = %.lr.ph, %bb.c, %bb.b
  %.1.lcssa = phi ptr [ %.0, %bb.b ], [ %i.j, %bb.c ], [ %.134, %.lr.ph ]
