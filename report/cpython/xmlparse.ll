...
bb.d:                                             ; preds = %bb.a, %bb.c, %bb.b
  ...
  %i.b = getelementptr i8, ptr %0, i64 %.sink45   ; 2 uses
  %i.c = getelementptr i8, ptr %0, i64 %.sink     ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  store ptr %i.f, ptr %i.c, align 8, !tbaa !321
  br label %bb.g

bb.f:                                             ; preds = %bb.d
  %i.g = tail call fastcc ptr @expat_malloc(ptr noundef %0, i64 noundef 48, i32 noundef 6382) ; 2 uses
...
entityTrackingOnOpen.exit:                        ; preds = %bb.j, %bb.k
  ...
  %i.ak = load ptr, ptr %i.b, align 8, !tbaa !321
  %i.al = getelementptr i8, ptr %.036, i64 16
  store ptr %i.ak, ptr %i.al, align 8, !tbaa !90
  store ptr %.036, ptr %i.b, align 8, !tbaa !321
