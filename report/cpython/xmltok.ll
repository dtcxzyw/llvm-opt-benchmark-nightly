...
bb.ai:                                            ; preds = %bb.ah, %bb.ae, %bb.ab, %bb.y, %bb.y
  %.sink.i.i = phi i64 [ 3, %bb.ae ], [ 2, %bb.ab ], [ 1, %bb.y ], [ 1, %bb.y ], [ 4, %bb.ah ]
...
bb.ax:                                            ; preds = %bb.as, %bb.ap, %bb.am, %bb.aj, %bb.aj, %bb.aj, %bb.aj, %bb.aj, %bb.aj
  %.sink161.i.i = phi i64 [ 4, %bb.as ], [ 3, %bb.ap ], [ 2, %bb.am ], [ 1, %bb.aj ], [ 1, %bb.aj ], [ 1, %bb.aj ], [ 1, %bb.aj ], [ 1, %bb.aj ], [ 1, %bb.aj ]
...
bb.az:                                            ; preds = %bb.p, %bb.l, %bb.h, %bb.d, %bb.d
  %.sink.i = phi i64 [ 3, %bb.l ], [ 2, %bb.h ], [ 1, %bb.d ], [ 1, %bb.d ], [ 4, %bb.p ]
...
.loopexit:                                        ; preds = %.lr.ph318.i, %.lr.ph318.i, %bb.cs, %bb.co, %bb.ck
  %.sink = phi i64 [ 4, %bb.co ], [ 3, %bb.ck ], [ 5, %bb.cs ], [ 2, %.lr.ph318.i ], [ 2, %.lr.ph318.i ]
...
bb.da:                                            ; preds = %bb.cd, %bb.bz, %bb.bv, %bb.br, %bb.br, %bb.bm, %bb.bi, %bb.be, %bb.ba, %bb.ba, %bb.ba, %bb.ba, %bb.ba
  %.sink439.i = phi i64 [ 4, %bb.bm ], [ 2, %bb.br ], [ 3, %bb.bv ], [ 4, %bb.bz ], [ 3, %bb.bi ], [ 2, %bb.be ], [ 1, %bb.ba ], [ 1, %bb.ba ], [ 1, %bb.ba ], [ 1, %bb.ba ], [ 1, %bb.ba ], [ 2, %bb.br ], [ 5, %bb.cd ]
  %.1.i = phi i32 [ %.0300.i, %bb.bm ], [ 1, %bb.br ], [ 1, %bb.bv ], [ 1, %bb.bz ], [ %.0300.i, %bb.bi ], [ %.0300.i, %bb.be ], [ %.0300.i, %bb.ba ], [ %.0300.i, %bb.ba ], [ %.0300.i, %bb.ba ], [ %.0300.i, %bb.ba ], [ %.0300.i, %bb.ba ], [ 1, %bb.br ], [ 1, %bb.cd ]
...
bb.q:                                             ; preds = %bb.n, %bb.j, %bb.f, %bb.b, %bb.b
  %.sink = phi i64 [ 3, %bb.j ], [ 2, %bb.f ], [ 1, %bb.b ], [ 1, %bb.b ], [ 4, %bb.n ]
...
bb.bl:                                            ; preds = %bb.ad, %bb.z, %bb.v, %bb.r, %bb.r, %bb.r, %bb.r, %bb.r
  %.sink248 = phi i64 [ 3, %bb.z ], [ 2, %bb.v ], [ 1, %bb.r ], [ 1, %bb.r ], [ 1, %bb.r ], [ 1, %bb.r ], [ 1, %bb.r ], [ 4, %bb.ad ]
...
bb.m:                                             ; preds = %bb.k, %bb.h, %bb.e, %bb.b, %bb.b
  %.sink = phi i64 [ 3, %bb.h ], [ 2, %bb.e ], [ 1, %bb.b ], [ 1, %bb.b ], [ 4, %bb.k ]
...
bb.y:                                             ; preds = %bb.w, %bb.t, %bb.q, %bb.n, %bb.n, %bb.n, %bb.n, %bb.n
  %.sink130 = phi i64 [ 3, %bb.t ], [ 2, %bb.q ], [ 1, %bb.n ], [ 1, %bb.n ], [ 1, %bb.n ], [ 1, %bb.n ], [ 1, %bb.n ], [ 4, %bb.w ]
...
bb.w:                                             ; preds = %bb.v, %bb.s, %bb.p, %bb.m, %bb.m, %bb.m, %bb.m, %bb.m
  %.sink128 = phi i64 [ 3, %bb.s ], [ 2, %bb.p ], [ 1, %bb.m ], [ 1, %bb.m ], [ 1, %bb.m ], [ 1, %bb.m ], [ 1, %bb.m ], [ 4, %bb.v ]
...
bb.af:                                            ; preds = %bb.ad, %bb.aa, %bb.x, %bb.u, %bb.u, %bb.u, %bb.u, %bb.u
  %.sink166 = phi i64 [ 3, %bb.aa ], [ 2, %bb.x ], [ 1, %bb.u ], [ 1, %bb.u ], [ 1, %bb.u ], [ 1, %bb.u ], [ 1, %bb.u ], [ 4, %bb.ad ]
...
bb.b:                                             ; preds = %.lr.ph, %bb.k
  ...
  %.04868.a = phi ptr [ %i.a, %.lr.ph ], [ %.250, %bb.k ] ; 14 uses
...
begin_hunk_15_@utf8_toUtf16:bb.a
  ...
  %5 = getelementptr i8, ptr %.04868.a, i64 2
  store i16 %i.w, ptr %.04868.a, align 2, !tbaa !16
  %6 = getelementptr i8, ptr %.04769, i64 2
  br label %bb.k
...
begin_hunk_16_@utf8_toUtf16:bb.a
  ...
  %7 = getelementptr i8, ptr %.04868.a, i64 2
  store i16 %i.am, ptr %.04868.a, align 2, !tbaa !16
  %8 = getelementptr i8, ptr %.04769, i64 3
  br label %bb.k
...
begin_hunk_17_@utf8_toUtf16:bb.a
  ...
  %9 = getelementptr i8, ptr %.04868.a, i64 4
  %10 = getelementptr i8, ptr %.04769, i64 4
  br label %bb.k

bb.j:                                             ; preds = %bb.b
  %11 = getelementptr i8, ptr %.04769, i64 1
  %i.bu = sext i8 %i.i to i16
  %12 = getelementptr i8, ptr %.04868.a, i64 2
  store i16 %i.bu, ptr %.04868.a, align 2, !tbaa !16
  br label %bb.k

bb.k:                                             ; preds = %bb.i, %bb.j, %bb.f, %bb.d
  %.250 = phi ptr [ %12, %bb.j ], [ %5, %bb.d ], [ %7, %bb.f ], [ %9, %bb.i ] ; 3 uses
  %.2 = phi ptr [ %11, %bb.j ], [ %6, %bb.d ], [ %8, %bb.f ], [ %10, %bb.i ] ; 3 uses
...
unicode_byte_type.exit98.thread118:               ; preds = %unicode_byte_type.exit98, %bb.v, %bb.u, %unicode_byte_type.exit98.thread121, %bb.w
  %.sink = phi i64 [ 4, %unicode_byte_type.exit98.thread121 ], [ 3, %bb.w ], [ 2, %bb.u ], [ 2, %bb.v ], [ 2, %unicode_byte_type.exit98 ]
