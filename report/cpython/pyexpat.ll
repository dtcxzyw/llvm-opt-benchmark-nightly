...
.lr.ph.i:                                         ; preds = %bb.c, %bb.d
  ...
  %i.m = phi ptr [ %i.j, %bb.d ], [ @handler_info, %bb.c ] ; 5 uses
  %.01923.i = phi i32 [ %i.h, %bb.d ], [ 0, %bb.c ]
  %1 = getelementptr i8, ptr %i.m, i64 24         ; 2 uses
  store ptr %i.l, ptr %1, align 8, !tbaa !92
  %i.n = getelementptr i8, ptr %i.m, i64 32
  store ptr @xmlparse_handler_getter, ptr %i.n, align 8, !tbaa !93
  %i.o = getelementptr i8, ptr %i.m, i64 40
  store ptr @xmlparse_handler_setter, ptr %i.o, align 8, !tbaa !94
  %i.p = getelementptr i8, ptr %i.m, i64 56
  store ptr %i.m, ptr %i.p, align 8, !tbaa !95
  %i.q = load ptr, ptr %i.a, align 8, !tbaa !10
  %i.r = tail call ptr @PyDescr_NewGetSet(ptr noundef %i.q, ptr noundef nonnull %1) #9 ; 6 uses
...
bb.v:                                             ; preds = %bb.t
  ...
  store ptr @.str.91, ptr %i.bj, align 8, !tbaa !99
  store <4 x i32> <i32 216, i32 2, i32 7, i32 4>, ptr %i.bm, align 8, !tbaa !6
  %i.bn = getelementptr i8, ptr %i.bj, i64 24
  store ptr @PyExpat_XML_ErrorString, ptr %i.bn, align 8, !tbaa !101
  %i.bo = getelementptr i8, ptr %i.bj, i64 32
  store ptr @PyExpat_XML_GetErrorCode, ptr %i.bo, align 8, !tbaa !102
  %i.bp = getelementptr i8, ptr %i.bj, i64 40
  store ptr @PyExpat_XML_GetCurrentColumnNumber, ptr %i.bp, align 8, !tbaa !103
  %i.bq = getelementptr i8, ptr %i.bj, i64 48
  store ptr @PyExpat_XML_GetCurrentLineNumber, ptr %i.bq, align 8, !tbaa !104
  %i.br = getelementptr i8, ptr %i.bj, i64 56
  store ptr @PyExpat_XML_Parse, ptr %i.br, align 8, !tbaa !105
  %i.bs = getelementptr i8, ptr %i.bj, i64 64
  store ptr @PyExpat_XML_ParserCreate_MM, ptr %i.bs, align 8, !tbaa !106
  %i.bt = getelementptr i8, ptr %i.bj, i64 72
  store ptr @PyExpat_XML_ParserFree, ptr %i.bt, align 8, !tbaa !107
  %i.bu = getelementptr i8, ptr %i.bj, i64 80
  store ptr @PyExpat_XML_SetCharacterDataHandler, ptr %i.bu, align 8, !tbaa !108
  %i.bv = getelementptr i8, ptr %i.bj, i64 88
  store ptr @PyExpat_XML_SetCommentHandler, ptr %i.bv, align 8, !tbaa !109
  %i.bw = getelementptr i8, ptr %i.bj, i64 96
  store ptr @PyExpat_XML_SetDefaultHandlerExpand, ptr %i.bw, align 8, !tbaa !110
  %i.bx = getelementptr i8, ptr %i.bj, i64 104
  store ptr @PyExpat_XML_SetElementHandler, ptr %i.bx, align 8, !tbaa !111
  %i.by = getelementptr i8, ptr %i.bj, i64 112
  store ptr @PyExpat_XML_SetNamespaceDeclHandler, ptr %i.by, align 8, !tbaa !112
  %i.bz = getelementptr i8, ptr %i.bj, i64 120
  store ptr @PyExpat_XML_SetProcessingInstructionHandler, ptr %i.bz, align 8, !tbaa !113
  %i.ca = getelementptr i8, ptr %i.bj, i64 128
  store ptr @PyExpat_XML_SetUnknownEncodingHandler, ptr %i.ca, align 8, !tbaa !114
  %i.cb = getelementptr i8, ptr %i.bj, i64 136
  store ptr @PyExpat_XML_SetUserData, ptr %i.cb, align 8, !tbaa !115
  %i.cc = getelementptr i8, ptr %i.bj, i64 144
  store ptr @PyExpat_XML_SetStartDoctypeDeclHandler, ptr %i.cc, align 8, !tbaa !116
  %i.cd = getelementptr i8, ptr %i.bj, i64 152
  store ptr @PyExpat_XML_SetEncoding, ptr %i.cd, align 8, !tbaa !117
  %i.ce = getelementptr i8, ptr %i.bj, i64 160
  store ptr @PyUnknownEncodingHandler, ptr %i.ce, align 8, !tbaa !118
  %i.cf = getelementptr i8, ptr %i.bj, i64 168
  store ptr @PyExpat_XML_SetHashSalt, ptr %i.cf, align 8, !tbaa !119
  %i.cg = getelementptr i8, ptr %i.bj, i64 176
  store ptr @PyExpat_XML_SetReparseDeferralEnabled, ptr %i.cg, align 8, !tbaa !120
  %i.ch = getelementptr i8, ptr %i.bj, i64 184
  store ptr @PyExpat_XML_SetAllocTrackerActivationThreshold, ptr %i.ch, align 8, !tbaa !121
  %i.ci = getelementptr i8, ptr %i.bj, i64 192
  store ptr @PyExpat_XML_SetAllocTrackerMaximumAmplification, ptr %i.ci, align 8, !tbaa !122
  %i.cj = getelementptr i8, ptr %i.bj, i64 200
  store ptr @PyExpat_XML_SetBillionLaughsAttackProtectionActivationThreshold, ptr %i.cj, align 8, !tbaa !123
  %i.ck = getelementptr i8, ptr %i.bj, i64 208
  store ptr @PyExpat_XML_SetBillionLaughsAttackProtectionMaximumAmplification, ptr %i.ck, align 8, !tbaa !124
...
.preheader.peel.next:                             ; preds = %bb.c, %bb.r
  ...
  %i.h = load ptr, ptr %i.g, align 16, !tbaa !125
...
bb.r:                                             ; preds = %add_error.exit
  ...
  br i1 %exitcond.not, label %.loopexit37, label %.preheader.peel.next, !llvm.loop !128
...
begin_hunk_6_@xmlparse_dealloc:bb.a
  ...
  tail call void %.val.us.i.i(ptr noundef %i.k, ptr noundef null) #9, !inline_history !135
...
bb.h:                                             ; preds = %bb.g
  %i.z = load ptr, ptr %5, align 8, !tbaa !137
  %i.aa = getelementptr inbounds nuw i8, ptr %5, i64 16
  %i.ab = load i64, ptr %i.aa, align 8, !tbaa !140 ; 2 uses
...
begin_hunk_10_@pyexpat_xmlparser_Parse:bb.a
  ...
  br i1 %i.aj, label %bb.j, label %._crit_edge.i, !llvm.loop !141
...
.loopexit.i:                                      ; preds = %bb.j, %._crit_edge.i
  ...
  %i.ao = load ptr, ptr %5, align 8, !tbaa !137
...
PyObject_TypeCheck.exit.thread.i.i:               ; preds = %PyObject_TypeCheck.exit.i.i, %bb.m
  ...
  %.val26.i.i = load ptr, ptr %i.ak, align 8, !tbaa !142
  br label %bb.o
...
begin_hunk_14_@pyexpat_xmlparser_ExternalEntityParserCreate:bb.a
  ...
  %i.av = load i32, ptr %i.au, align 4, !tbaa !145
  %i.aw = getelementptr i8, ptr %i.ag, i64 44
  store i32 %i.av, ptr %i.aw, align 4, !tbaa !145
...
begin_hunk_15_@pyexpat_xmlparser_ExternalEntityParserCreate:bb.a
  ...
  br i1 %.not62.i, label %bb.ah, label %bb.ag, !llvm.loop !146
...
begin_hunk_16_@pyexpat_xmlparser_ExternalEntityParserCreate:bb.a
  ...
  call void %.sroa.3.0.copyload.i(ptr noundef %i.dg, ptr noundef %.sroa.4.0.copyload.i) #9, !inline_history !147
  br label %bb.as
...
begin_hunk_17_@pyexpat_xmlparser_ExternalEntityParserCreate:bb.a
  ...
  br i1 %.not64.i, label %._crit_edge.i, label %bb.ap, !llvm.loop !148
...
bb.c:                                             ; preds = %.thread
  %i.j = load i64, ptr %i.b, align 8, !tbaa !149
  %i.k = getelementptr i8, ptr %0, i64 16         ; 2 uses
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !44
  %i.m = call zeroext i8 @PyExpat_XML_SetBillionLaughsAttackProtectionActivationThreshold(ptr noundef %i.l, i64 noundef %i.j) #9, !callees !151, !inline_history !152
...
bb.c:                                             ; preds = %.thread
  ...
  %.val26 = load double, ptr %i.i, align 8, !tbaa !153
...
begin_hunk_20_@pyexpat_xmlparser_SetBillionLaughsAttackProtectionMaximumAmplification:bb.a
  ...
  %i.q = call zeroext i8 @PyExpat_XML_SetBillionLaughsAttackProtectionMaximumAmplification(ptr noundef %i.p, float noundef %.0) #9, !callees !156, !inline_history !157
...
bb.c:                                             ; preds = %.thread
  ...
  %i.k = getelementptr i8, ptr %0, i64 16         ; 2 uses
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !44
  %i.m = call zeroext i8 @PyExpat_XML_SetAllocTrackerActivationThreshold(ptr noundef %i.l, i64 noundef %i.j) #9, !callees !151, !inline_history !152
  %i.n = icmp eq i8 %i.m, 1
...
begin_hunk_23_@pyexpat_xmlparser_SetAllocTrackerMaximumAmplification:bb.a
  ...
  %i.o = getelementptr i8, ptr %0, i64 16         ; 2 uses
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !44
  %i.q = call zeroext i8 @PyExpat_XML_SetAllocTrackerMaximumAmplification(ptr noundef %i.p, float noundef %.0) #9, !callees !156, !inline_history !157
  %i.r = icmp eq i8 %i.q, 1
...
bb.a:
  ...
  %.val = load i8, ptr %i.a, align 8, !tbaa !43, !range !158, !noundef !159
...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 4, !tbaa !145
...
bb.d:                                             ; preds = %bb.c
  ...
  store i32 %i.c, ptr %i.e, align 4, !tbaa !145
...
begin_hunk_27_@xmlparse_handler_setter:bb.a
  ...
  %i.y = load ptr, ptr %i.x, align 16, !tbaa !160
  br label %.thread26
...
begin_hunk_28_@xmlparse_handler_setter:bb.a
  ...
  tail call void %.val(ptr noundef %i.aj, ptr noundef %.1) #9, !inline_history !161
  br label %bb.l
...
!124 = !{!100, !13, i64 208}
!125 = !{!126, !27, i64 0}
!126 = !{!"ErrorInfo", !27, i64 0, !27, i64 8}
!127 = !{!126, !27, i64 8}
!128 = distinct !{!128, !50, !129}
!129 = !{!"llvm.loop.peeled.count", i32 1}
!130 = !{!131, !7, i64 0}
!131 = !{!"", !7, i64 0, !27, i64 8, !23, i64 16}
!132 = distinct !{!132, !50}
!133 = !{!131, !27, i64 8}
!134 = !{!131, !23, i64 16}
!135 = distinct !{ptr @xmlparse_clear, null, null}
!136 = distinct !{!136, !50}
!137 = !{!138, !13, i64 0}
!138 = !{!"", !13, i64 0, !14, i64 8, !23, i64 16, !23, i64 24, !7, i64 32, !7, i64 36, !27, i64 40, !139, i64 48, !139, i64 56, !139, i64 64, !13, i64 72}
!139 = !{!"p1 long", !13, i64 0}
!140 = !{!138, !23, i64 16}
!141 = distinct !{!141, !50}
!142 = !{!143, !27, i64 40}
!143 = !{!"", !21, i64 0, !23, i64 24, !27, i64 32, !27, i64 40, !23, i64 48, !14, i64 56}
!144 = !{!26, !27, i64 24}
!145 = !{!34, !7, i64 44}
!146 = distinct !{!146, !50}
...
!148 = distinct !{!148, !50}
!149 = !{!150, !150, i64 0}
!150 = !{!"long long", !8, i64 0}
!151 = !{ptr @PyExpat_XML_SetAllocTrackerActivationThreshold, ptr @PyExpat_XML_SetBillionLaughsAttackProtectionActivationThreshold}
!152 = distinct !{null}
!153 = !{!154, !155, i64 16}
!154 = !{!"", !22, i64 0, !155, i64 16}
!155 = !{!"double", !8, i64 0}
!156 = !{ptr @PyExpat_XML_SetAllocTrackerMaximumAmplification, ptr @PyExpat_XML_SetBillionLaughsAttackProtectionMaximumAmplification}
!157 = distinct !{null}
!158 = !{i8 0, i8 2}
!159 = !{}
!160 = !{!47, !13, i64 16}
