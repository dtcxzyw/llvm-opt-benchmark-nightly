...
bb.a:
  ...
  store <4 x i8> <i8 1, i8 122, i8 82, i8 0>, ptr %i.d, align 4, !tbaa !225
  %i.g = getelementptr i8, ptr %i.a, i64 13       ; 2 uses
  store i8 1, ptr %i.f, align 4, !tbaa !225
  store ptr %i.g, ptr %0, align 8, !tbaa !39
  %i.h = getelementptr i8, ptr %i.a, i64 21
...
._crit_edge:                                      ; preds = %.lr.ph.preheader, %bb.a
  ...
  store ptr %.0.lcssa, ptr %i.u, align 8, !tbaa !230
  %i.v = getelementptr i8, ptr %.0.lcssa, i64 4   ; 2 uses
  %i.w = ptrtoint ptr %i.v to i64
  %i.x = sub i64 %i.w, %i.b
  %i.y = trunc i64 %i.x to i32
  store i32 %i.y, ptr %i.v, align 4, !tbaa !7
  %i.z = getelementptr i8, ptr %.0.lcssa, i64 8   ; 2 uses
  %i.aa = getelementptr i8, ptr %0, i64 24        ; 2 uses
  store ptr %i.z, ptr %i.aa, align 8, !tbaa !41
  store i32 0, ptr %i.z, align 4, !tbaa !7
  %i.ab = getelementptr i8, ptr %.0.lcssa, i64 12
  %i.ac = getelementptr i8, ptr %0, i64 32        ; 2 uses
  %i.ad = load i32, ptr %i.ac, align 8, !tbaa !36
  store i32 %i.ad, ptr %i.ab, align 4, !tbaa !7
  %i.ae = getelementptr i8, ptr %.0.lcssa, i64 16
  %i.af = getelementptr i8, ptr %.0.lcssa, i64 20
  store <4 x i8> <i8 0, i8 65, i8 14, i8 16>, ptr %i.ae, align 4, !tbaa !225
  %i.ag = getelementptr i8, ptr %.0.lcssa, i64 21
  store i8 -122, ptr %i.af, align 4, !tbaa !225
  %i.ah = getelementptr i8, ptr %.0.lcssa, i64 22 ; 2 uses
  store i8 2, ptr %i.ag, align 1, !tbaa !225
  store ptr %i.ah, ptr %0, align 8, !tbaa !39
  %i.ai = getelementptr i8, ptr %.0.lcssa, i64 26
  store <4 x i8> <i8 67, i8 13, i8 6, i8 67>, ptr %i.ah, align 2, !tbaa !225
  %i.aj = getelementptr i8, ptr %.0.lcssa, i64 27
  store i8 12, ptr %i.ai, align 2, !tbaa !225
  %i.ak = getelementptr i8, ptr %.0.lcssa, i64 28
  store i8 7, ptr %i.aj, align 1, !tbaa !225
  %i.al = getelementptr i8, ptr %.0.lcssa, i64 29 ; 3 uses
  store i8 8, ptr %i.ak, align 4, !tbaa !225
  %i.am = ptrtoint ptr %i.al to i64               ; 2 uses
  %i.an = and i64 %i.am, 7
  %.not102112 = icmp eq i64 %i.an, 0
...
._crit_edge116:                                   ; preds = %.lr.ph115.preheader, %._crit_edge
  %.1.lcssa = phi ptr [ %i.al, %._crit_edge ], [ %scevgep125, %.lr.ph115.preheader ]
  %.lcssa = phi i64 [ %i.am, %._crit_edge ], [ %i.at, %.lr.ph115.preheader ]
  %i.au = sub i64 %.lcssa, %.lcssa108
  %i.av = trunc i64 %i.au to i32
  %i.aw = add i32 %i.av, -4
  store i32 %i.aw, ptr %.0.lcssa, align 4, !tbaa !7
  store ptr %.1.lcssa, ptr %0, align 8, !tbaa !39
  %i.ax = load ptr, ptr %i.aa, align 8, !tbaa !41 ; 3 uses
  %.not103 = icmp eq ptr %i.ax, null
  br i1 %.not103, label %bb.c, label %bb.b

bb.b:                                             ; preds = %._crit_edge116
  %i.ay = load ptr, ptr %i.e, align 8, !tbaa !40
  %i.az = ptrtoint ptr %i.ax to i64
  %i.ba = ptrtoint ptr %i.ay to i64
  %.neg = sub i64 %i.ba, %i.az
  %.neg104 = trunc i64 %.neg to i32
  %i.bb = load i32, ptr %i.ac, align 8, !tbaa !36 ; 3 uses
  %i.bc = and i32 %i.bb, 7
  %i.bd = icmp eq i32 %i.bc, 0
  %narrow.neg = or i32 %i.bb, -8
  %narrow106.neg119 = select i1 %i.bd, i32 0, i32 %narrow.neg
  %.0.i.neg = sub i32 %.neg104, %i.bb
  %.neg105 = add i32 %.0.i.neg, %narrow106.neg119
  store i32 %.neg105, ptr %i.ax, align 4, !tbaa !7
  br label %bb.c
