...
bb.g:                                             ; preds = %.sink.split, %bb.d, %bb.f
  %.015 = phi ptr [ %1, %bb.f ], [ %i.b, %bb.d ], [ %.sink, %.sink.split ]
  %.0 = phi ptr [ null, %bb.f ], [ null, %bb.d ], [ %i.g, %.sink.split ]
  tail call void @Py_EndInterpreter(ptr noundef %.015) #15
