...
bb.c:                                             ; preds = %bb.b
  ...
  %.pre = load i64, ptr %i.a, align 8, !tbaa !36
  br label %bb.l
...
bb.e:                                             ; preds = %bb.d
  ...
  %.val32 = load i64, ptr %i.j, align 8, !tbaa !37 ; 2 uses
  store i64 %.val32, ptr %i.a, align 8, !tbaa !36
  br label %bb.l
...
begin_hunk_2_@PyFloat_FromString:bb.a
  ...
  %.val34 = load i64, ptr %i.m, align 8, !tbaa !37 ; 2 uses
  store i64 %.val34, ptr %i.a, align 8, !tbaa !36
  br label %bb.l
...
bb.l:                                             ; preds = %bb.e, %bb.j, %PyObject_TypeCheck.exit.thread, %bb.c
  %2 = phi i64 [ %.pre, %bb.c ], [ %.val32, %bb.e ], [ %.val34, %PyObject_TypeCheck.exit.thread ], [ %i.r, %bb.j ]
...
bb.e:                                             ; preds = %bb.d, %bb.c, %bb.b
  ...
  %.val20 = load i64, ptr %i.h, align 8, !tbaa !37 ; 3 uses
...
thread-pre-split:                                 ; preds = %bb.f
  %.val.pr = load i64, ptr %i.h, align 8, !tbaa !37
  br label %bb.g
...
bb.b:                                             ; preds = %bb.a
  %i.e = load i64, ptr %i.b, align 8, !tbaa !36
  br label %bb.c
