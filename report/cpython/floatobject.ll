...
bb.ao:                                            ; preds = %bb.an
  %i.cj = tail call double @llvm.floor.f64(double %.0100102105)
  %i.ck = fcmp une double %.0100102105, %i.cj
...
begin_hunk_2_@float_as_integer_ratio:bb.a
  ...
  %i.aa = tail call double @llvm.floor.f64(double %i.w)
  %i.ab = fcmp une double %i.w, %i.aa
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.g = tail call double @llvm.floor.f64(double %i.a)
