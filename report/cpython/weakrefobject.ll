...
PyObject_TypeCheck.exit:                          ; preds = %bb.b
  %i.c = tail call i32 @PyType_IsSubtype(ptr noundef %.val45, ptr noundef nonnull @_PyWeakref_RefType) #6
...
PyObject_TypeCheck.exit48:                        ; preds = %PyObject_TypeCheck.exit.thread
  %i.e = tail call i32 @PyType_IsSubtype(ptr noundef %.val44, ptr noundef nonnull @_PyWeakref_RefType) #6
...
bb.o:                                             ; preds = %bb.g, %get_basic_refs.exit.i, %bb.l
  ...
  %i.ag = tail call ptr %i.af(ptr noundef %0, i64 noundef 0) #6 ; 15 uses
...
begin_hunk_5_@get_or_create_weakref:bb.a
  ...
  store ptr @weakref_vectorcall, ptr %i.ap, align 8, !tbaa !43
...
bb.aa:                                            ; preds = %_PyObject_GET_WEAKREFS_LISTPTR.exit
  ...
  %i.bk = tail call ptr %i.bj(ptr noundef %0, i64 noundef 0) #6 ; 15 uses
...
begin_hunk_7_@get_or_create_weakref:bb.a
  ...
  store ptr @weakref_vectorcall, ptr %i.bt, align 8, !tbaa !43
...
PyObject_TypeCheck.exit:                          ; preds = %bb.c
  %i.c = tail call i32 @PyType_IsSubtype(ptr noundef %.val10, ptr noundef nonnull @_PyWeakref_RefType) #6
...
PyObject_TypeCheck.exit:                          ; preds = %bb.c
  %i.c = tail call i32 @PyType_IsSubtype(ptr noundef %.val14, ptr noundef nonnull @_PyWeakref_RefType) #6
...
PyObject_TypeCheck.exit:                          ; preds = %bb.b
  %i.c = tail call i32 @PyType_IsSubtype(ptr noundef %.val15, ptr noundef nonnull @_PyWeakref_RefType) #6
...
begin_hunk_11_@PyObject_ClearWeakRefs:bb.a
  ...
  br i1 %spec.select, label %bb.m, label %.split.us, !llvm.loop !44
...
_PyWeakref_ClearRef.exit.i:                       ; preds = %bb.ae, %.lr.ph.i78
  ...
  br i1 %.not.i80, label %_PyWeakref_ClearWeakRefsNoCallbacks.exit, label %.lr.ph.i78, !llvm.loop !46
...
begin_hunk_13_@PyObject_ClearWeakRefs:bb.a
  ...
  br i1 %.not120, label %.preheader, label %.preheader116.splitthread-pre-split, !llvm.loop !47
...
handle_callback.exit:                             ; preds = %bb.az, %bb.ay, %bb.ax, %bb.aw, %.lr.ph
  ...
  br i1 %i.eo, label %.lr.ph, label %._crit_edge, !llvm.loop !48
...
_PyWeakref_ClearRef.exit.i:                       ; preds = %bb.k, %bb.c
  ...
  br i1 %.not.i, label %_PyWeakref_ClearWeakRefsNoCallbacks.exit, label %bb.c, !llvm.loop !46
