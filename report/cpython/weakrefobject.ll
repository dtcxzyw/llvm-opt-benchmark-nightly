...
bb.l:                                             ; preds = %bb.k
  ...
  br i1 %i.r, label %Py_XDECREF.exit.a, label %Py_XDECREF.exit57

Py_XDECREF.exit.a:                                ; preds = %bb.l
...
bb.m:                                             ; preds = %_PyWeakref_GET_REF.exit52
  ...
  br i1 %.not.i.i56, label %Py_XDECREF.exit57.sink.split, label %Py_XDECREF.exit57

Py_XDECREF.exit57.sink.split:                     ; preds = %bb.m
  %4 = add nsw i32 %3, -1
  store i32 %4, ptr %.val42, align 8, !tbaa !37
  br label %Py_XDECREF.exit57

Py_XDECREF.exit57:                                ; preds = %Py_XDECREF.exit57.sink.split, %bb.l, %bb.k, %Py_XDECREF.exit.a, %_PyWeakref_GET_REF.exit52.thread, %bb.m
  %i.s = icmp eq ptr %0, %1
  %i.t = icmp eq i32 %2, 3
