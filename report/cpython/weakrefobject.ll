...
_PyWeakref_GET_REF.exit52:                        ; preds = %bb.i, %bb.j
  ...
  br i1 %i.o, label %bb.m, label %bb.o
...
begin_hunk_3
  ...
  br i1 %i.r, label %bb.n, label %Py_XDECREF.exit57

bb.m:                                             ; preds = %_PyWeakref_GET_REF.exit52
  %3 = load i32, ptr %.val42, align 8, !tbaa !37  ; 2 uses
  %.not.i.i56 = icmp sgt i32 %3, -1
  br i1 %.not.i.i56, label %Py_XDECREF.exit, label %Py_XDECREF.exit57

Py_XDECREF.exit:                                  ; preds = %bb.m
  %4 = add nsw i32 %3, -1                         ; 2 uses
  store i32 %4, ptr %.val42, align 8, !tbaa !37
  %5 = icmp eq i32 %4, 0
  br i1 %5, label %bb.n, label %Py_XDECREF.exit57

bb.n:                                             ; preds = %Py_XDECREF.exit, %bb.l
  %.0.i.sink = phi ptr [ %.0.i, %bb.l ], [ %.val42, %Py_XDECREF.exit ]
  tail call void @_Py_Dealloc(ptr noundef nonnull %.0.i.sink) #6
  br label %Py_XDECREF.exit57

Py_XDECREF.exit57:                                ; preds = %bb.n, %bb.k, %bb.l, %_PyWeakref_GET_REF.exit52.thread, %bb.m, %Py_XDECREF.exit
  %i.s = icmp eq ptr %0, %1
  %i.t = icmp eq i32 %2, 3
