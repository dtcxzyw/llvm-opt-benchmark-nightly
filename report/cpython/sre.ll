...
Py_UNICODE_ISALNUM.exit:                          ; preds = %bb.ad, %bb.ae, %bb.af, %bb.ag
  %i.cc = phi i1 [ true, %bb.af ], [ true, %bb.ae ], [ true, %bb.ad ], [ %i.cb, %bb.ag ]
  %i.cd = icmp eq i32 %1, 95
...
bb.al:                                            ; preds = %bb.a
  %i.cm = tail call i32 @_PyUnicode_IsLinebreak(i32 noundef %1) #13
  br label %Py_UNICODE_ISSPACE.exit
...
Py_UNICODE_ISSPACE.exit:                          ; preds = %bb.z, %bb.y, %bb.a, %bb.t, %bb.u, %bb.q, %bb.r, %bb.l, %bb.m, %bb.j, %bb.k, %bb.h, %bb.i, %bb.f, %bb.g, %bb.d, %bb.e, %bb.b, %bb.c, %bb.am, %bb.al, %Py_UNICODE_ISALNUM.exit55, %Py_UNICODE_ISALNUM.exit, %Py_UNICODE_ISSPACE.exit51, %bb.w, %bb.v, %bb.o, %bb.n
  %.0 = phi i32 [ 0, %bb.t ], [ %i.co, %bb.am ], [ %.lobit49, %bb.c ], [ %i.k, %bb.e ], [ %.lobit47, %bb.g ], [ %i.v, %bb.i ], [ %i.ae, %bb.k ], [ %i.ao, %bb.n ], [ %i.aq, %bb.o ], [ %i.am, %bb.m ], [ 1, %bb.q ], [ %i.bh, %bb.v ], [ %i.bj, %bb.w ], [ 0, %bb.a ], [ %i.bw, %Py_UNICODE_ISSPACE.exit51 ], [ %i.cf, %Py_UNICODE_ISALNUM.exit ], [ %i.cl, %Py_UNICODE_ISALNUM.exit55 ], [ %i.cm, %bb.al ], [ 0, %bb.b ], [ 1, %bb.d ], [ 0, %bb.f ], [ 1, %bb.h ], [ 0, %bb.j ], [ 1, %bb.l ], [ %i.ay, %bb.r ], [ %i.bg, %bb.u ], [ %i.bo, %bb.y ], [ %i.bp, %bb.z ]
  ret i32 %.0
}

; Function Attrs: inlinehint nounwind uwtable
define internal fastcc range(i32 0, 2) i32 @sre_ucs1_charset(ptr noundef readonly captures(none) %0, i32 noundef %1) unnamed_addr #6 {
bb.a:
