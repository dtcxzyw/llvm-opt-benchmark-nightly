...
_Py_NewRef.exit:                                  ; preds = %bb.s, %bb.r, %_Py_NewRef.exit163, %bb.l, %bb.m, %bb.o, %bb.c, %bb.b
  %.293 = phi ptr [ %2, %bb.c ], [ %2, %bb.b ], [ %i.x, %bb.s ], [ %i.x, %bb.r ], [ %i.x, %_Py_NewRef.exit163 ], [ %2, %bb.l ], [ %2, %bb.m ], [ %i.t, %bb.o ] ; 18 uses
  %.not113 = phi i1 [ false, %bb.c ], [ false, %bb.b ], [ true, %bb.s ], [ true, %bb.r ], [ true, %_Py_NewRef.exit163 ], [ true, %bb.l ], [ true, %bb.m ], [ false, %bb.o ]
  %i.ae = phi i1 [ false, %bb.c ], [ false, %bb.b ], [ false, %bb.s ], [ false, %bb.r ], [ false, %_Py_NewRef.exit163 ], [ false, %bb.l ], [ false, %bb.m ], [ true, %bb.o ]
...
bb.cm:                                            ; preds = %Py_DECREF.exit129
  %8 = load i64, ptr %i.a, align 8, !tbaa !70
  %i.fn = call ptr (ptr, ...) @Py_BuildValue(ptr noundef nonnull @.str.73, ptr noundef nonnull %.3, i64 noundef %8) #14
  br label %.critedge
