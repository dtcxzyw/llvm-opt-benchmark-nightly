...
bb.b:                                             ; preds = %bb.a
  store ptr @_ZTIZN8LightGBM9PredictorC1EPNS_8BoostingEiibbbbidEUlRKSt6vectorISt4pairIidESaIS5_EEPdE2_, ptr %0, align 8, !tbaa !213
...
bb.a:
  ...
  %i.a = load ptr, ptr %0, align 8, !tbaa !568    ; 7 uses
  %i.b = tail call i32 @omp_get_thread_num()
  %i.c = getelementptr inbounds nuw i8, ptr %i.a, i64 112 ; 2 uses
  %i.d = load i32, ptr %i.c, align 8, !tbaa !264  ; 2 uses
  %i.e = icmp sgt i32 %i.d, 100000
  %.pre = load ptr, ptr %1, align 8, !tbaa !276   ; 3 uses
  %i.f = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !276  ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.m = load i64, ptr %i.l, align 8, !tbaa !569
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.o = load ptr, ptr %i.a, align 8, !tbaa !262  ; 2 uses
  %i.p = getelementptr inbounds nuw i8, ptr %i.a, i64 72
  %i.q = load ptr, ptr %i.o, align 8, !tbaa !118
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.u = load ptr, ptr %i.t, align 8, !tbaa !278  ; 2 uses
...
.lr.ph.i.i.i.i:                                   ; preds = %bb.d, %.lr.ph.i.i.i.i
  ...
  %i.v = load ptr, ptr %.06.i.i.i.i, align 8, !tbaa !162 ; 2 uses
  call void @_ZdlPvm(ptr noundef nonnull %.06.i.i.i.i, i64 noundef 24) #29
  %.not.i.i.i.i = icmp eq ptr %i.v, null
  br i1 %.not.i.i.i.i, label %_ZNSt10_HashtableIiSt4pairIKidESaIS2_ENSt8__detail10_Select1stESt8equal_toIiESt4hashIiENS4_18_Mod_range_hashingENS4_20_Default_ranged_hashENS4_20_Prime_rehash_policyENS4_17_Hashtable_traitsILb0ELb0ELb1EEEE5clearEv.exit.i.i, label %.lr.ph.i.i.i.i, !llvm.loop !18
...
_ZNSt10_HashtableIiSt4pairIKidESaIS2_ENSt8__detail10_Select1stESt8equal_toIiESt4hashIiENS4_18_Mod_range_hashingENS4_20_Default_ranged_hashENS4_20_Prime_rehash_policyENS4_17_Hashtable_traitsILb0ELb0ELb1EEEE5clearEv.exit.i.i: ; preds = %.lr.ph.i.i.i.i, %bb.d
  %i.w = load ptr, ptr %3, align 8, !tbaa !279
  ...
  %i.aa = load ptr, ptr %3, align 8, !tbaa !279   ; 2 uses
...
bb.e:                                             ; preds = %_ZNSt10_HashtableIiSt4pairIKidESaIS2_ENSt8__detail10_Select1stESt8equal_toIiESt4hashIiENS4_18_Mod_range_hashingENS4_20_Default_ranged_hashENS4_20_Prime_rehash_policyENS4_17_Hashtable_traitsILb0ELb0ELb1EEEE5clearEv.exit.i.i
  %i.ad = load i64, ptr %i.x, align 8, !tbaa !280
  %i.ae = shl i64 %i.ad, 3
...
._crit_edge:                                      ; preds = %bb.a, %bb.b
  ...
  %i.ai = load ptr, ptr %i.ag, align 8, !tbaa !270
  %i.aj = getelementptr inbounds nuw [24 x i8], ptr %i.ai, i64 %i.ah
  %i.ak = load ptr, ptr %i.aj, align 8, !tbaa !266 ; 2 uses
...
_ZN8LightGBM9Predictor19CopyToPredictBufferEPdRKSt6vectorISt4pairIidESaIS4_EE.exit: ; preds = %bb.h, %._crit_edge
  %i.at = load ptr, ptr %i.a, align 8, !tbaa !262 ; 2 uses
  %i.au = getelementptr inbounds nuw i8, ptr %i.a, i64 72
  %i.av = load ptr, ptr %i.at, align 8, !tbaa !118
  ...
  %i.ay = load ptr, ptr %i.ag, align 8, !tbaa !270
  %i.az = getelementptr inbounds nuw [24 x i8], ptr %i.ay, i64 %i.ah ; 2 uses
  %i.ba = load ptr, ptr %i.az, align 8, !tbaa !266 ; 3 uses
  %i.bb = getelementptr inbounds nuw i8, ptr %i.az, i64 8
  %i.bc = load ptr, ptr %i.bb, align 8, !tbaa !268
  %i.bd = ptrtoint ptr %i.bc to i64
  %i.be = ptrtoint ptr %i.ba to i64
  %i.bf = sub i64 %i.bd, %i.be                    ; 2 uses
  %i.bg = ashr exact i64 %i.bf, 3
  %i.bh = load ptr, ptr %i.al, align 8, !tbaa !285 ; 3 uses
  %i.bi = load ptr, ptr %1, align 8, !tbaa !286   ; 3 uses
...
.lr.ph.i12:                                       ; preds = %.preheader.i
  %i.bp = load i32, ptr %i.c, align 8, !tbaa !264
  br label %bb.j
...
bb.j:                                             ; preds = %bb.l, %.lr.ph.i12
  ...
  %i.bq = load i32, ptr %.sroa.010.014.i, align 8, !tbaa !282 ; 2 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  store double 0.000000e+00, ptr %i.bt, align 8, !tbaa !122
  br label %bb.l
...
bb.b:                                             ; preds = %bb.d, %.lr.ph.i.new
  ...
  %i.c = load i32, ptr %.01417.i, align 4, !tbaa !116
  %i.d = load i32, ptr %.01417.i.a, align 4, !tbaa !116
...
9:                                                ; preds = %8, %bb.b
  ...
  %12 = load i32, ptr %10, align 4, !tbaa !116
...
bb.d:                                             ; preds = %bb.c, %9
  ...
  br i1 %niter.ncmp.1.not, label %_ZZN8LightGBM7Network17GlobalSyncUpByMinIiEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit.loopexit.unr-lcssa, label %bb.b, !llvm.loop !570

_ZZN8LightGBM7Network17GlobalSyncUpByMinIiEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit.loopexit.unr-lcssa: ; preds = %bb.d
  %15 = and i32 %5, 1
  %lcmp.mod.not.not = icmp eq i32 %15, 0
  br i1 %lcmp.mod.not.not, label %.epil.preheader, label %_ZZN8LightGBM7Network17GlobalSyncUpByMinIiEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit

.epil.preheader:                                  ; preds = %_ZZN8LightGBM7Network17GlobalSyncUpByMinIiEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit.loopexit.unr-lcssa, %.lr.ph.i
  %.01417.i.epil.init = phi ptr [ %0, %.lr.ph.i ], [ %i.f, %_ZZN8LightGBM7Network17GlobalSyncUpByMinIiEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit.loopexit.unr-lcssa ] ; 2 uses
  %.01516.i.epil.init = phi ptr [ %1, %.lr.ph.i ], [ %i.g, %_ZZN8LightGBM7Network17GlobalSyncUpByMinIiEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit.loopexit.unr-lcssa ] ; 2 uses
  %lcmp.mod4 = trunc i32 %6 to i1
  tail call void @llvm.assume(i1 %lcmp.mod4)
  %16 = load i32, ptr %.01417.i.epil.init, align 4, !tbaa !116
  %17 = load i32, ptr %.01516.i.epil.init, align 4, !tbaa !116
  %18 = icmp slt i32 %16, %17
  br i1 %18, label %19, label %_ZZN8LightGBM7Network17GlobalSyncUpByMinIiEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit
...
19:                                               ; preds = %.epil.preheader
  ...
  br label %_ZZN8LightGBM7Network17GlobalSyncUpByMinIiEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit

_ZZN8LightGBM7Network17GlobalSyncUpByMinIiEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit: ; preds = %_ZZN8LightGBM7Network17GlobalSyncUpByMinIiEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit.loopexit.unr-lcssa, %19, %.epil.preheader, %bb.a
  ret void
}
...
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !287    ; 9 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 3 uses
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !287  ; 3 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %next.gep32, align 8, !tbaa !171, !alias.scope !576
  %wide.load33 = load <2 x i64>, ptr %i.x, align 8, !tbaa !171, !alias.scope !576
  %i.y = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 8, !tbaa !171, !alias.scope !577, !noalias !576
  store <2 x i64> %wide.load33, ptr %i.y, align 8, !tbaa !171, !alias.scope !577, !noalias !576
  %i.z = getelementptr i8, ptr %next.gep32, i64 16
  store <2 x ptr> splat (ptr null), ptr %next.gep32, align 8, !tbaa !171, !alias.scope !576
  store <2 x ptr> splat (ptr null), ptr %i.z, align 8, !tbaa !171, !alias.scope !576
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.aa = icmp eq i64 %index.next, %n.vec
  br i1 %i.aa, label %middle.block, label %vector.body, !llvm.loop !574
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %.lr.ph.i.i.i.i.i.i.preheader35, %.lr.ph.i.i.i.i.i.i
  ...
  %i.ab = load i64, ptr %.sroa.08.011.i.i.i.i.i.i, align 8, !tbaa !171
  store i64 %i.ab, ptr %.012.i.i.i.i.i.i, align 8, !tbaa !171
  store ptr null, ptr %.sroa.08.011.i.i.i.i.i.i, align 8, !tbaa !171
  ...
  br i1 %.not.i.i.i.i.i.i, label %_ZNSt6vectorISt10unique_ptrIN8LightGBM6MetricESt14default_deleteIS2_EESaIS5_EEC2ISt13move_iteratorIN9__gnu_cxx17__normal_iteratorIPS5_S7_EEEvEET_SF_RKS6_.exit, label %.lr.ph.i.i.i.i.i.i, !llvm.loop !575
...
_ZNSt6vectorISt10unique_ptrIN8LightGBM6MetricESt14default_deleteIS2_EESaIS5_EEC2ISt13move_iteratorIN9__gnu_cxx17__normal_iteratorIPS5_S7_EEEvEET_SF_RKS6_.exit: ; preds = %.lr.ph.i.i.i.i.i.i, %middle.block
  ...
  %.pre = load ptr, ptr %0, align 8, !tbaa !168   ; 4 uses
  %.pre18 = load ptr, ptr %i.b, align 8, !tbaa !169 ; 2 uses
  %i.ah = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.ai = load ptr, ptr %i.ah, align 8, !tbaa !172 ; 2 uses
  store ptr %i.k, ptr %0, align 8, !tbaa !168
  store ptr %.lcssa, ptr %i.b, align 8, !tbaa !169
  store ptr %i.ag, ptr %i.ah, align 8, !tbaa !172
...
.lr.ph.i.i.i:                                     ; preds = %_ZNSt6vectorISt10unique_ptrIN8LightGBM6MetricESt14default_deleteIS2_EESaIS5_EEC2ISt13move_iteratorIN9__gnu_cxx17__normal_iteratorIPS5_S7_EEEvEET_SF_RKS6_.exit, %_ZSt8_DestroyISt10unique_ptrIN8LightGBM6MetricESt14default_deleteIS2_EEEvPT_.exit.i.i.i
  ...
  %i.aj = load ptr, ptr %.05.i.i.i, align 8, !tbaa !171 ; 3 uses
...
begin_hunk_1_@_ZSt16__do_uninit_copyIN9__gnu_cxx17__normal_iteratorIPKSt6vectorIdSaIdEES2_IS4_SaIS4_EEEEPS4_ET0_T_SC_SB_:bb.a
  ...
  store ptr %i.k, ptr %i.l, align 8, !tbaa !130
  %i.m = load ptr, ptr %.sroa.09.016, align 8, !tbaa !272 ; 3 uses
  %i.n = load ptr, ptr %i.a, align 8, !tbaa !272
  %i.o = ptrtoint ptr %i.n to i64
  %i.p = ptrtoint ptr %i.m to i64
  %i.q = sub i64 %i.o, %i.p                       ; 4 uses
  %i.r = icmp sgt i64 %i.q, 8
  br i1 %i.r, label %bb.c, label %bb.d, !prof !273
...
bb.e:                                             ; preds = %bb.d
  %i.t = load double, ptr %i.m, align 8, !tbaa !122
  store double %i.t, ptr %i.i, align 8, !tbaa !122
  br label %bb.f
...
.lr.ph:                                           ; preds = %bb.a, %bb.f
  ...
  %i.c = load ptr, ptr %.sroa.09.016, align 8, !tbaa !127 ; 2 uses
  %i.d = ptrtoint ptr %i.b to i64
...
bb.b:                                             ; preds = %.lr.ph
  ...
  br i1 %i.g, label %.noexc.i.i.i, label %_ZNSt15__new_allocatorIiE8allocateEmPKv.exit.i.i.i.i.i, !prof !160
...
.noexc8:                                          ; preds = %_ZNSt15__new_allocatorIiE8allocateEmPKv.exit.i.i.i.i.i, %.lr.ph
  ...
  store ptr %i.i, ptr %.017, align 8, !tbaa !127
  %i.j = getelementptr inbounds nuw i8, ptr %.017, i64 8 ; 2 uses
  store ptr %i.i, ptr %i.j, align 8, !tbaa !294
  %i.k = getelementptr inbounds nuw i8, ptr %i.i, i64 %i.f
  %i.l = getelementptr inbounds nuw i8, ptr %.017, i64 16
  store ptr %i.k, ptr %i.l, align 8, !tbaa !128
  %i.m = load ptr, ptr %.sroa.09.016, align 8, !tbaa !295 ; 3 uses
  %i.n = load ptr, ptr %i.a, align 8, !tbaa !295
  %i.o = ptrtoint ptr %i.n to i64
  %i.p = ptrtoint ptr %i.m to i64
  %i.q = sub i64 %i.o, %i.p                       ; 4 uses
...
bb.e:                                             ; preds = %bb.d
  %i.t = load i32, ptr %i.m, align 4, !tbaa !116
  store i32 %i.t, ptr %i.i, align 4, !tbaa !116
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.d, %bb.c
  %i.u = getelementptr inbounds i8, ptr %i.i, i64 %i.q
  store ptr %i.u, ptr %i.j, align 8, !tbaa !294
  %i.v = getelementptr inbounds nuw i8, ptr %.sroa.09.016, i64 24 ; 2 uses
  %i.w = getelementptr inbounds nuw i8, ptr %.017, i64 24 ; 2 uses
  %.not = icmp eq ptr %i.v, %1
...
bb.b:                                             ; preds = %bb.d, %.lr.ph.i.new
  ...
  %.01417.i.a = phi ptr [ %1, %.lr.ph.i.new ], [ %i.g, %bb.d ] ; 3 uses
  %niter = phi i32 [ 0, %.lr.ph.i.new ], [ %i.h, %bb.d ]
  %i.c = load double, ptr %.01417.i, align 8, !tbaa !122
  %i.d = load double, ptr %.01417.i.a, align 8, !tbaa !122
...
9:                                                ; preds = %8, %bb.b
  %10 = getelementptr inbounds i8, ptr %.01417.i, i64 %i.b ; 3 uses
  %11 = getelementptr inbounds i8, ptr %.01417.i.a, i64 %i.b ; 3 uses
  %12 = load double, ptr %10, align 8, !tbaa !122
  %13 = load double, ptr %11, align 8, !tbaa !122
...
bb.d:                                             ; preds = %bb.c, %9
  ...
  %i.h = add i32 %niter, 2                        ; 2 uses
  %niter.ncmp.1.not = icmp eq i32 %i.h, %unroll_iter
  br i1 %niter.ncmp.1.not, label %_ZZN8LightGBM7Network17GlobalSyncUpByMinIdEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit.loopexit.unr-lcssa, label %bb.b, !llvm.loop !611

_ZZN8LightGBM7Network17GlobalSyncUpByMinIdEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit.loopexit.unr-lcssa: ; preds = %bb.d
  %15 = and i32 %5, 1
  %lcmp.mod.not.not = icmp eq i32 %15, 0
  br i1 %lcmp.mod.not.not, label %.epil.preheader, label %_ZZN8LightGBM7Network17GlobalSyncUpByMinIdEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit

.epil.preheader:                                  ; preds = %_ZZN8LightGBM7Network17GlobalSyncUpByMinIdEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit.loopexit.unr-lcssa, %.lr.ph.i
  %.01417.i.epil.init = phi ptr [ %0, %.lr.ph.i ], [ %i.f, %_ZZN8LightGBM7Network17GlobalSyncUpByMinIdEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit.loopexit.unr-lcssa ] ; 2 uses
  %.01516.i.epil.init = phi ptr [ %1, %.lr.ph.i ], [ %i.g, %_ZZN8LightGBM7Network17GlobalSyncUpByMinIdEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit.loopexit.unr-lcssa ] ; 2 uses
  %lcmp.mod4 = trunc i32 %6 to i1
  tail call void @llvm.assume(i1 %lcmp.mod4)
  %16 = load double, ptr %.01417.i.epil.init, align 8, !tbaa !122
  %17 = load double, ptr %.01516.i.epil.init, align 8, !tbaa !122
  %18 = fcmp olt double %16, %17
  br i1 %18, label %19, label %_ZZN8LightGBM7Network17GlobalSyncUpByMinIdEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit
...
19:                                               ; preds = %.epil.preheader
  ...
  br label %_ZZN8LightGBM7Network17GlobalSyncUpByMinIdEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit

_ZZN8LightGBM7Network17GlobalSyncUpByMinIdEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit: ; preds = %_ZZN8LightGBM7Network17GlobalSyncUpByMinIdEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit.loopexit.unr-lcssa, %19, %.epil.preheader, %bb.a
  ret void
}
...
._crit_edge.i.i:
  ...
  %i.d = load i32, ptr %i.c, align 4, !tbaa !612
  ...
  %i.i = load ptr, ptr %i.a, align 8, !tbaa !119  ; 2 uses
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 832
  %i.k = load i32, ptr %i.j, align 8, !tbaa !297
  %i.l = load ptr, ptr %i.e, align 8, !tbaa !115
  ...
  store ptr %i.q, ptr %1, align 8, !tbaa !113
  ...
  store i64 3, ptr %i.r, align 8, !tbaa !110
  %i.s = getelementptr inbounds nuw i8, ptr %1, i64 19
  store i8 0, ptr %i.s, align 1, !tbaa !114
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.n = load i8, ptr %i.m, align 1, !tbaa !614, !range !187, !noundef !188
  %i.o = trunc nuw i8 %i.n to i1
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 1147
  %i.q = load i8, ptr %i.p, align 1, !tbaa !615, !range !187, !noundef !188
  %i.r = trunc nuw i8 %i.q to i1
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 1097
  %i.t = load i8, ptr %i.s, align 1, !tbaa !616, !range !187, !noundef !188
...
bb.c:                                             ; preds = %bb.b
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #21
  %i.v = load ptr, ptr %i.k, align 8, !tbaa !115
  store ptr %i.v, ptr %3, align 8, !tbaa !299
  ...
  store i64 %i.aj, ptr %1, align 8, !tbaa !304
  store ptr @_ZNSt17_Function_handlerIFviPKcmEZN8LightGBM10TextReaderIiE12ReadAllLinesEvEUliS1_mE_E9_M_invokeERKSt9_Any_dataOiOS1_Om, ptr %i.ah, align 8, !tbaa !306
  store ptr @_ZNSt17_Function_handlerIFviPKcmEZN8LightGBM10TextReaderIiE12ReadAllLinesEvEUliS1_mE_E10_M_managerERSt9_Any_dataRKS8_St18_Manager_operation, ptr %i.ag, align 8, !tbaa !158
...
bb.d:                                             ; preds = %bb.c
  %i.al = load ptr, ptr %i.ag, align 8, !tbaa !158 ; 2 uses
...
bb.g:                                             ; preds = %bb.c
  %i.ap = landingpad { ptr, i32 }
          cleanup
  %i.aq = load ptr, ptr %i.ag, align 8, !tbaa !158 ; 2 uses
...
bb.j:                                             ; preds = %bb.e, %bb.d
  ...
  %i.av = load ptr, ptr %i.au, align 8, !tbaa !184 ; 2 uses
  %i.aw = load ptr, ptr %i.w, align 8, !tbaa !148 ; 3 uses
