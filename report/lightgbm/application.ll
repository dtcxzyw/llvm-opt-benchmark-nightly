...
bb.b:                                             ; preds = %bb.d, %.lr.ph.i
  ...
  %i.c = load i32, ptr %.01417.i.a, align 4, !tbaa !116
  %i.d = load i32, ptr %.01516.i, align 4, !tbaa !116
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  br i1 %4, label %bb.b, label %_ZZN8LightGBM7Network17GlobalSyncUpByMinIiEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit, !llvm.loop !570
...
bb.b:                                             ; preds = %bb.d, %.lr.ph.i
  ...
  %.01417.i.a = phi ptr [ %0, %.lr.ph.i ], [ %i.f, %bb.d ] ; 3 uses
  %.01516.i = phi ptr [ %1, %.lr.ph.i ], [ %i.g, %bb.d ] ; 3 uses
  %i.c = load double, ptr %.01417.i.a, align 8, !tbaa !122
  %i.d = load double, ptr %.01516.i, align 8, !tbaa !122
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %i.h = add nsw i32 %.018.i, %2                  ; 2 uses
  %4 = icmp slt i32 %i.h, %3
  br i1 %4, label %bb.b, label %_ZZN8LightGBM7Network17GlobalSyncUpByMinIdEET_S2_ENKUlPKcPciiE_clES4_S5_ii.exit, !llvm.loop !611
