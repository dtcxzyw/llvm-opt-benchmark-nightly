...
bb.b:                                             ; preds = %bb.b, %.lr.ph.i
  ...
  br i1 %4, label %bb.b, label %_ZZN8LightGBM7Network9GlobalSumIdEESt6vectorIT_SaIS3_EEPS5_ENKUlPKcPciiE_clES8_S9_ii.exit, !llvm.loop !2339
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.i
  ...
  %i.h = add nsw i32 %.015.i, %2                  ; 2 uses
  %4 = icmp slt i32 %i.h, %3
  br i1 %4, label %bb.b, label %_ZZN8LightGBM7Network9GlobalSumIiEESt6vectorIT_SaIS3_EEPS5_ENKUlPKcPciiE_clES8_S9_ii.exit, !llvm.loop !2340
...
bb.g:                                             ; preds = %bb.f, %_ZN8LightGBM6CommonL12FindInBitsetIiEEbPKjiT_.exit.i, %_ZN8LightGBM6CommonL12FindInBitsetIiEEbPKjiT_.exit.thread.i
  ...
  br i1 %exitcond.not.i, label %_ZNK8LightGBM29CostEfficientGradientBoosting22CalculateOndemandCostsEiii.exit, label %bb.e, !llvm.loop !2341
...
bb.d:                                             ; preds = %bb.d, %.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge, label %bb.d, !llvm.loop !2342
...
bb.e:                                             ; preds = %bb.e, %.lr.ph.new
  ...
  br i1 %niter.ncmp.3, label %._crit_edge.loopexit.unr-lcssa, label %bb.e, !llvm.loop !2343
