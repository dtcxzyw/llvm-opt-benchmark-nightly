...
bb.b:                                             ; preds = %bb.d, %.lr.ph.i
  %.018.i = phi i32 [ 0, %.lr.ph.i ], [ %niter.next.1, %bb.d ]
  %.01516.i.a = phi ptr [ %0, %.lr.ph.i ], [ %i.f, %bb.d ] ; 3 uses
  %.01516.i = phi ptr [ %1, %.lr.ph.i ], [ %i.g, %bb.d ] ; 3 uses
  %i.c = load i32, ptr %.01516.i.a, align 4, !tbaa !134
  %i.d = load i32, ptr %.01516.i, align 4, !tbaa !134
  %i.e = icmp sgt i32 %i.c, %i.d
  br i1 %i.e, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %.01516.i, ptr nonnull align 4 %.01516.i.a, i64 %i.b, i1 false)
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %i.f = getelementptr inbounds i8, ptr %.01516.i.a, i64 %i.b
  %i.g = getelementptr inbounds i8, ptr %.01516.i, i64 %i.b
  %niter.next.1 = add nsw i32 %.018.i, %2         ; 2 uses
  %4 = icmp slt i32 %niter.next.1, %3
