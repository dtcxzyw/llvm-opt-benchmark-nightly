...
bb.a:
  ...
  %20 = alloca %"class.std::vector.19", align 8   ; 16 uses
...
bb.ch:                                            ; preds = %bb.bz
  ...
  %i.ph = sext i32 %2 to i64                      ; 4 uses
  %i.pi = icmp slt i32 %2, 0
  br i1 %i.pi, label %bb.ci, label %bb.cj

bb.ci:                                            ; preds = %bb.ch
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.31) #36
          to label %.noexc221 unwind label %bb.cl
...
bb.cj:                                            ; preds = %bb.ch
  ...
  %.not.i.i.i.i220 = icmp ne i32 %2, 0
  call void @llvm.assume(i1 %.not.i.i.i.i220)
  %23 = shl nuw nsw i64 %i.ph, 2                  ; 5 uses
  %i.pj = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %23) #37
          to label %.noexc230.a unwind label %bb.cl ; 5 uses

.noexc230.a:                                      ; preds = %bb.cj
  store ptr %i.pj, ptr %19, align 8, !tbaa !215
  ...
  %.idx.i.i.i.i.i.i.i = add nsw i64 %23, -4       ; 2 uses
  call void @llvm.memset.p0.i64(ptr align 4 %i.pm, i8 0, i64 %.idx.i.i.i.i.i.i.i, i1 false), !tbaa !134
  %24 = getelementptr i8, ptr %i.pj, i64 %23
  %25 = getelementptr inbounds nuw i8, ptr %19, i64 8
  store ptr %24, ptr %25, align 8, !tbaa !214
  call void @llvm.lifetime.start.p0(ptr nonnull %20) #20
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %20, i8 0, i64 24, i1 false)
  %26 = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %23) #37
          to label %bb.ck unwind label %bb.cm     ; 14 uses

bb.ck:                                            ; preds = %.noexc230.a
  store ptr %26, ptr %20, align 8, !tbaa !215
  %27 = getelementptr inbounds nuw [4 x i8], ptr %26, i64 %i.ph
  %28 = getelementptr inbounds nuw i8, ptr %20, i64 16
  store ptr %27, ptr %28, align 8, !tbaa !216
  store i32 0, ptr %26, align 4, !tbaa !134
  %29 = getelementptr i8, ptr %26, i64 4
  call void @llvm.memset.p0.i64(ptr align 4 %29, i8 0, i64 %.idx.i.i.i.i.i.i.i, i1 false), !tbaa !134
  %30 = getelementptr i8, ptr %26, i64 %23
  %.pre588 = load ptr, ptr %19, align 8, !tbaa !215 ; 14 uses
  %i.pn = getelementptr inbounds nuw i8, ptr %20, i64 8
  store ptr %30, ptr %i.pn, align 8, !tbaa !214
  ...
  store i32 0, ptr %.pre588, align 4, !tbaa !134
  br i1 %i.hl, label %.lver.check, label %._crit_edge536

.lver.check:                                      ; preds = %bb.ck
  %wide.trip.count = zext nneg i32 %i.pp to i64   ; 5 uses
  %i.ps = shl nuw nsw i64 %wide.trip.count, 2     ; 2 uses
  %scevgep784.a = getelementptr i8, ptr %26, i64 %i.ps
  %i.pt = getelementptr i8, ptr %.pre588, i64 %i.ps
  %scevgep785 = getelementptr i8, ptr %i.pt, i64 4
  %bound0786 = icmp ult ptr %26, %scevgep785
  %bound1787 = icmp ult ptr %.pre588, %scevgep784.a
...
.ph.lver.orig:                                    ; preds = %.ph.lver.orig, %.ph.lver.orig.preheader.new
  ...
  %i.px = getelementptr inbounds nuw [4 x i8], ptr %.pre588, i64 %indvars.iv562.lver.orig
  %i.py = sub nsw i32 %i.pw, %i.pv
  %.sroa.speculated.lver.orig = call i32 @llvm.smin.i32(i32 %i.py, i32 %spec.store.select) ; 2 uses
  %i.pz = getelementptr inbounds nuw [4 x i8], ptr %26, i64 %indvars.iv562.lver.orig
  ...
  %i.qc = getelementptr inbounds nuw [4 x i8], ptr %.pre588, i64 %indvars.iv.next563.lver.orig
  store i32 %i.qb, ptr %i.qc, align 4, !tbaa !134
  %i.qd = load i32, ptr %i.hk, align 4, !tbaa !253
  %i.qe = getelementptr inbounds nuw [4 x i8], ptr %.pre588, i64 %indvars.iv.next563.lver.orig
  %i.qf = sub nsw i32 %i.qd, %i.qb
  %.sroa.speculated.lver.orig.1 = call i32 @llvm.smin.i32(i32 %i.qf, i32 %spec.store.select) ; 2 uses
  %i.qg = getelementptr inbounds nuw [4 x i8], ptr %26, i64 %indvars.iv.next563.lver.orig
  ...
  %i.qj = getelementptr inbounds nuw [4 x i8], ptr %.pre588, i64 %indvars.iv.next563.lver.orig.1
...
.ph:                                              ; preds = %.lver.check
  %load_initial = load i32, ptr %.pre588, align 4 ; 2 uses
...
.ph.lver.orig.epil.preheader:                     ; preds = %._crit_edge536.loopexit.unr-lcssa, %.ph.lver.orig.preheader
  %.epil.init803 = phi i32 [ 0, %.ph.lver.orig.preheader ], [ %i.qi, %._crit_edge536.loopexit.unr-lcssa ]
  ...
  %lcmp.mod805 = trunc i32 %i.pp to i1
  call void @llvm.assume(i1 %lcmp.mod805)
  %i.qn = load i32, ptr %i.hk, align 4, !tbaa !253
  %i.qo = getelementptr inbounds nuw [4 x i8], ptr %.pre588, i64 %indvars.iv562.lver.orig.epil.init
  %i.qp = sub nsw i32 %i.qn, %.epil.init803
  %.sroa.speculated.lver.orig.epil = call i32 @llvm.smin.i32(i32 %i.qp, i32 %spec.store.select) ; 2 uses
  %i.qq = getelementptr inbounds nuw [4 x i8], ptr %26, i64 %indvars.iv562.lver.orig.epil.init
...
.epil.preheader:                                  ; preds = %._crit_edge536.loopexit798.unr-lcssa, %.ph
  ...
  %i.qx = getelementptr inbounds nuw [4 x i8], ptr %26, i64 %indvars.iv562.epil.init
  store i32 %.sroa.speculated.epil, ptr %i.qx, align 4, !tbaa !134
  %i.qy = add nsw i32 %store_forwarded.epil.init, %.sroa.speculated.epil
  %i.qz = getelementptr inbounds nuw [4 x i8], ptr %.pre588, i64 %indvars.iv562.epil.init
  %i.ra = getelementptr inbounds nuw i8, ptr %i.qz, i64 4
  store i32 %i.qy, ptr %i.ra, align 4, !tbaa !134
  br label %._crit_edge536

._crit_edge536:                                   ; preds = %.epil.preheader, %._crit_edge536.loopexit798.unr-lcssa, %.ph.lver.orig.epil.preheader, %._crit_edge536.loopexit.unr-lcssa, %bb.ck
  %i.rb = load i32, ptr %i.hk, align 4, !tbaa !253
  %i.rc = sext i32 %i.pp to i64                   ; 4 uses
  %i.rd = getelementptr inbounds nuw [4 x i8], ptr %.pre588, i64 %i.rc
  %i.re = load i32, ptr %i.rd, align 4, !tbaa !134
  %i.rf = sub nsw i32 %i.rb, %i.re
  %i.rg = getelementptr inbounds nuw [4 x i8], ptr %26, i64 %i.rc
...
bb.cn:                                            ; preds = %bb.cn, %.ph.new
  %store_forwarded = phi i32 [ %load_initial, %.ph.new ], [ %i.rr, %bb.cn ]
  %i.ri = phi i32 [ 0, %.ph.new ], [ %i.rr, %bb.cn ]
  %indvars.iv562 = phi i64 [ 0, %.ph.new ], [ %indvars.iv.next563.1, %bb.cn ] ; 3 uses
  %niter = phi i64 [ 0, %.ph.new ], [ %niter.next.1, %bb.cn ]
  ...
  %i.rl = getelementptr inbounds nuw [4 x i8], ptr %26, i64 %indvars.iv562
  ...
  %i.rn = getelementptr inbounds nuw [4 x i8], ptr %.pre588, i64 %indvars.iv.next563
  ...
  %i.rq = getelementptr inbounds nuw [4 x i8], ptr %26, i64 %indvars.iv.next563
  ...
  %i.rs = getelementptr inbounds nuw [4 x i8], ptr %.pre588, i64 %indvars.iv.next563.1
  store i32 %i.rr, ptr %i.rs, align 4, !tbaa !134
  %niter.next.1 = add nuw i64 %niter, 2           ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge536.loopexit798.unr-lcssa, label %bb.cn, !llvm.loop !562

bb.co:                                            ; preds = %._crit_edge536
...
_ZNSt15__exception_ptr13exception_ptrC2ERKS0_.exit.i234: ; preds = %bb.co
...
bb.cp:                                            ; preds = %_ZNSt15__exception_ptr13exception_ptrC2ERKS0_.exit.i234
  unreachable
...
._crit_edge540:                                   ; preds = %.loopexit506
  ...
  br i1 %i.sh, label %bb.cs, label %_ZNSt6vectorIcSaIcEE17_S_check_init_lenEmRKS0_.exit.i

bb.cs:                                            ; preds = %._crit_edge540
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.31) #36
          to label %.noexc242 unwind label %bb.de
...
_ZNSt6vectorIcSaIcEE17_S_check_init_lenEmRKS0_.exit.i: ; preds = %._crit_edge540
  ...
  br i1 %.not.i.i.i.i240, label %_ZNSt6vectorIcSaIcEEC2EmRKS0_.exit, label %bb.ct

bb.ct:                                            ; preds = %_ZNSt6vectorIcSaIcEE17_S_check_init_lenEmRKS0_.exit.i
  %i.si = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.sg) #37
          to label %.noexc243 unwind label %bb.de ; 5 uses
...
.noexc243:                                        ; preds = %bb.ct
  ...
  br i1 %i.sl, label %_ZNSt6vectorIcSaIcEEC2EmRKS0_.exit, label %bb.cu

bb.cu:                                            ; preds = %.noexc243
...
bb.cv:                                            ; preds = %._crit_edge536
  %i.sn = landingpad { ptr, i32 }
          cleanup
  br label %.body237

bb.cw:                                            ; preds = %.lr.ph539, %.loopexit506
  ...
  br i1 %.not.not.i.i.i, label %.preheader558, label %bb.cy

.preheader558:                                    ; preds = %bb.cw, %bb.cx
  %.sroa.06.0.in.i.i.i = phi ptr [ %.sroa.06.0.i.i.i, %bb.cx ], [ %i.sf, %bb.cw ]
  %.sroa.06.0.i.i.i = load ptr, ptr %.sroa.06.0.in.i.i.i, align 8, !tbaa !137 ; 3 uses
  %.not.i.i.i245 = icmp eq ptr %.sroa.06.0.i.i.i, null
  br i1 %.not.i.i.i245, label %.loopexit505, label %bb.cx

bb.cx:                                            ; preds = %.preheader558
...
bb.cy:                                            ; preds = %bb.cw
  ...
  br i1 %.not.i.i.i.i.i, label %.loopexit505, label %bb.cz
...
.lr.ph.i.i.i.i.i:                                 ; preds = %bb.cz, %bb.da
  %.020.i.i.i.i.i = phi ptr [ %i.tl, %bb.da ], [ %i.tg, %bb.cz ]
  %i.tl = load ptr, ptr %.020.i.i.i.i.i, align 8, !tbaa !137 ; 3 uses
  %.not18.i.i.i.i.i = icmp eq ptr %i.tl, null
  br i1 %.not18.i.i.i.i.i, label %.loopexit505, label %bb.db

bb.db:                                            ; preds = %.lr.ph.i.i.i.i.i
  ...
  br i1 %.not19.i.i.i.i.i, label %bb.da, label %..loopexit_crit_edge21.i.i.i.i.i, !llvm.loop !7

..loopexit_crit_edge21.i.i.i.i.i:                 ; preds = %bb.db
  br label %.loopexit505, !llvm.loop !7

.loopexit505:                                     ; preds = %.lr.ph.i.i.i.i.i, %.preheader558, %..loopexit_crit_edge21.i.i.i.i.i, %bb.cy
...
bb.dc:                                            ; preds = %.loopexit505
  %i.tu = trunc i64 %i.tt to i32
  %i.tv = add nsw i32 %.096537, %i.tu
  %.pre588.a = load i32, ptr %i.f, align 4, !tbaa !134
  %.pre589 = load ptr, ptr %20, align 8, !tbaa !215
  br label %.loopexit506

.loopexit506:                                     ; preds = %bb.da, %bb.cx, %bb.cz, %bb.dc
  %i.tw = phi ptr [ %.pre589, %bb.dc ], [ %i.so, %bb.cx ], [ %i.so, %bb.cz ], [ %i.so, %bb.da ] ; 2 uses
  %i.tx = phi i32 [ %.pre588.a, %bb.dc ], [ %i.sp, %bb.cx ], [ %i.sp, %bb.cz ], [ %i.sp, %bb.da ] ; 2 uses
  %.197 = phi i32 [ %i.tv, %bb.dc ], [ %.096537, %bb.cx ], [ %.096537, %bb.cz ], [ %.096537, %bb.da ] ; 6 uses
  ...
  br i1 %i.uc, label %bb.cw, label %._crit_edge540, !llvm.loop !563
...
_ZNSt6vectorIcSaIcEEC2EmRKS0_.exit:               ; preds = %_ZN21ThreadExceptionHelper7ReThrowEv.exit239, %bb.cu, %.noexc243, %_ZNSt6vectorIcSaIcEE17_S_check_init_lenEmRKS0_.exit.i
  %.096.lcssa726729 = phi i32 [ %.197, %bb.cu ], [ %.197, %.noexc243 ], [ 0, %_ZNSt6vectorIcSaIcEE17_S_check_init_lenEmRKS0_.exit.i ], [ 0, %_ZN21ThreadExceptionHelper7ReThrowEv.exit239 ]
  %.sroa.0447.0 = phi ptr [ %i.si, %bb.cu ], [ %i.si, %.noexc243 ], [ null, %_ZNSt6vectorIcSaIcEE17_S_check_init_lenEmRKS0_.exit.i ], [ null, %_ZN21ThreadExceptionHelper7ReThrowEv.exit239 ] ; 8 uses
  %.sroa.11452.0 = phi ptr [ %i.sj, %bb.cu ], [ %i.sj, %.noexc243 ], [ null, %_ZNSt6vectorIcSaIcEE17_S_check_init_lenEmRKS0_.exit.i ], [ null, %_ZN21ThreadExceptionHelper7ReThrowEv.exit239 ] ; 2 uses
