...
bb.b:                                             ; preds = %bb.d, %.lr.ph.i.new
  ...
  %.01516.i.a = phi ptr [ %1, %.lr.ph.i.new ], [ %i.g, %bb.d ] ; 3 uses
  %niter = phi i32 [ 0, %.lr.ph.i.new ], [ %niter.next.1, %bb.d ]
  %i.c = load i32, ptr %.01417.i, align 4, !tbaa !134
  %i.d = load i32, ptr %.01516.i.a, align 4, !tbaa !134
  %i.e = icmp sgt i32 %i.c, %i.d
  br i1 %i.e, label %8, label %9

8:                                                ; preds = %bb.b
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %.01516.i.a, ptr nonnull align 4 %.01417.i, i64 %i.b, i1 false)
  br label %9

9:                                                ; preds = %8, %bb.b
  %10 = getelementptr inbounds i8, ptr %.01417.i, i64 %i.b ; 3 uses
  %11 = getelementptr inbounds i8, ptr %.01516.i.a, i64 %i.b ; 3 uses
