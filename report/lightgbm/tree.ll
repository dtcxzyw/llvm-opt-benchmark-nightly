...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = uitofp nneg <2 x i32> %i.y to <2 x double>
...
.lr.ph.split.us:                                  ; preds = %.lr.ph.split.us.preheader, %.lr.ph.split.us
  ...
  %i.as = sub i32 %1, %i.ar
  %4 = uitofp nneg i32 %i.as to double
...
.lr.ph.split:                                     ; preds = %.lr.ph.split.preheader75, %.lr.ph.split
  ...
  %i.bm = sub i32 %1, %i.bl
  %5 = uitofp nneg i32 %i.bm to double
...
.lr.ph.split.us:                                  ; preds = %.lr.ph.split.us.preheader, %.lr.ph.split.us
  ...
  %i.ah = sub i32 %1, %i.ag
  %3 = uitofp nneg i32 %i.ah to double
...
.lr.ph.split:                                     ; preds = %.lr.ph.split.prol.loopexit, %.lr.ph.split
  ...
  %i.ar = sub i32 %1, %i.aq
  %4 = uitofp nneg i32 %i.ar to double
...
.lr.ph.split.us.i:                                ; preds = %.lr.ph.split.us.i, %.lr.ph.split.us.preheader.i
  ...
  %9 = uitofp nneg i32 %i.cj to double
...
.lr.ph.split.i:                                   ; preds = %.lr.ph.split.i.prol.loopexit, %.lr.ph.split.i
  ...
  %10 = uitofp nneg i32 %i.cs to double
  ...
  %11 = uitofp nneg i32 %i.da to double
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %12 = uitofp nneg <2 x i32> %i.hp to <2 x double>
...
.lr.ph.split.us.i93:                              ; preds = %.lr.ph.split.us.i93, %.lr.ph.split.us.preheader.i92
  ...
  %13 = uitofp nneg i32 %i.ij to double
...
.lr.ph.split.i88:                                 ; preds = %.lr.ph.split.i88.preheader, %.lr.ph.split.i88
  ...
  %14 = uitofp nneg i32 %i.jc to double
...
.lr.ph.split.us.i:                                ; preds = %.lr.ph.split.us.i, %.lr.ph.split.us.preheader.i
  ...
  %9 = uitofp nneg i32 %i.cl to double
...
.lr.ph.split.i:                                   ; preds = %.lr.ph.split.i.prol.loopexit, %.lr.ph.split.i
  ...
  %10 = uitofp nneg i32 %i.cu to double
  ...
  %11 = uitofp nneg i32 %i.dc to double
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %12 = uitofp nneg <2 x i32> %i.ke to <2 x double>
...
.lr.ph.split.us.i110:                             ; preds = %.lr.ph.split.us.i110, %.lr.ph.split.us.preheader.i109
  ...
  %13 = uitofp nneg i32 %i.ky to double
...
.lr.ph.split.i105:                                ; preds = %.lr.ph.split.i105.preheader, %.lr.ph.split.i105
  ...
  %14 = uitofp nneg i32 %i.lr to double
