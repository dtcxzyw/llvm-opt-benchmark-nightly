...
bb.c:                                             ; preds = %bb.a
  %1 = load <2 x i16>, ptr %.sroa.7.sroa.13.sroa.0.sroa.0.sroa.7.0..sroa.7.sroa.13.0..sroa.7.0..sroa_idx.sroa_idx.sroa_idx, align 2, !dbg !10058
  ...
  %i.af = insertelement <8 x i16> %i.ae, i16 %i.ac, i64 0, !dbg !10050
  %i.ag = insertelement <8 x i16> %i.af, i16 %i.aa, i64 1, !dbg !10050
  %i.ah = insertelement <8 x i16> %i.ag, i16 %i.y, i64 2, !dbg !10050
  %i.ai = insertelement <8 x i16> %i.ah, i16 %.sroa.7.sroa.0.sroa.7.sroa.7.sroa.7.sroa.7.sroa.7.sroa.7.sroa.7.sroa.8.0.copyload, i64 3, !dbg !10050
...
bb.d:                                             ; preds = %bb.a
  %2 = load <4 x i16>, ptr %.sroa.7.sroa.13.sroa.0.sroa.0.sroa.7.0..sroa.7.sroa.13.0..sroa.7.0..sroa_idx.sroa_idx.sroa_idx, align 2, !dbg !10058
  %3 = insertelement <4 x i16> %2, i16 0, i64 3, !dbg !10050
  %4 = insertelement <4 x i16> %3, i16 %.sroa.7.sroa.13.sroa.0.sroa.7.0.copyload, i64 2, !dbg !10050
...
_RINvNtCskKLDkoKarTP_4core3ptr9drop_glueNtNtNtCs8Nb2mar7w9E_7inquire2ui14frame_renderer11RenderStateECsjfnSKV9Rz3v_3h3i.exit: ; preds = %bb.c, %bb.d, %bb.a
  ...
  %.sroa.7.sroa.0.sroa.7.sroa.7.sroa.7.sroa.7.sroa.7.sroa.7.sroa.7.sroa.7.sroa.8.0 = phi i16 [ %.sroa.7.sroa.0.sroa.7.sroa.7.sroa.7.sroa.7.sroa.7.sroa.7.sroa.7.sroa.8.0.copyload, %bb.d ], [ %i.ad, %bb.c ], [ 25973, %bb.a ], !dbg !10050
  ...
  %i.ba = phi <8 x i16> [ %i.e, %bb.d ], [ %i.ai, %bb.c ], [ <i16 28787, i16 28005, i16 29551, i16 29281, i16 28261, i16 26469, i16 27769, i16 28525>, %bb.a ], !dbg !10050
  %i.bb = phi <8 x i16> [ %i.f, %bb.d ], [ %i.am, %bb.c ], [ <i16 28260, i16 29281, i16 25711, i16 25971, i16 31092, i16 25698, i16 29797, i16 0>, %bb.a ], !dbg !10050
  ...
  %5 = phi <4 x i16> [ %4, %bb.d ], [ %i.az, %bb.c ], [ <i16 undef, i16 undef, i16 0, i16 0>, %bb.a ], !dbg !10050
  %i.bf = phi <4 x i16> [ %i.q, %bb.d ], [ %i.u, %bb.c ], [ %i.q, %bb.a ], !dbg !10050
  %6 = phi <2 x i16> [ zeroinitializer, %bb.d ], [ %1, %bb.c ], [ zeroinitializer, %bb.a ], !dbg !10050
  ...
  store <4 x i16> %5, ptr %.sroa.7.sroa.11.sroa.7.0..sroa.7.sroa.11.0..sroa.7.0..sroa_idx.sroa_idx.sroa_idx, align 2, !dbg !10062
  store <2 x i16> %6, ptr %.sroa.7.sroa.13.sroa.0.sroa.0.sroa.7.0..sroa.7.sroa.13.0..sroa.7.0..sroa_idx.sroa_idx.sroa_idx, align 2, !dbg !10062
