...
.critedge1535:                                    ; preds = %bb.j
  ...
  %i.gk = sitofp i64 %i.gg to double
  %i.gl = sitofp i64 %i.gi to double
  ...
  %i.gp = insertelement <2 x double> poison, double %i.gk, i64 0
  ...
  %i.hb = sitofp i64 %i.gy to double
  %i.hc = sitofp i64 %i.gz to double
  ...
  %i.hg = insertelement <2 x double> poison, double %i.hb, i64 0
  %i.hh = insertelement <2 x double> %i.hg, double %i.hc, i64 1
  ...
  %i.hs = sitofp i64 %i.hp to double
  %i.ht = sitofp i64 %i.hq to double
  ...
  %i.ik = sitofp i64 %i.ig to double
  %i.il = sitofp i64 %i.ii to double
  ...
  %i.iq = insertelement <2 x double> %i.ip, double %i.il, i64 1
  ...
  %i.jb = sitofp i64 %i.iy to double
  %i.jc = sitofp i64 %i.iz to double
  ...
  %i.jg = insertelement <2 x double> poison, double %i.jb, i64 0
  ...
  %i.js = sitofp i64 %i.jp to double
  %i.jt = sitofp i64 %i.jq to double
  ...
  %i.jx = insertelement <2 x double> poison, double %i.js, i64 0
