...
begin_hunk_0_@_ZN4bzla8bitblast19BitblasterInterfaceINS0_7AigNodeEE13bv_mul_squareERKSt6vectorIS2_SaIS2_EE:bb.a
  ...
  %i.g = ashr exact i64 %i.f, 3                   ; 10 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.l = invoke noundef ptr @_ZNSt6vectorIN4bzla8bitblast7AigNodeESaIS2_EE20_M_allocate_and_copyIPKS2_EEPS2_mT_S9_(ptr noundef nonnull align 8 dereferenceable(24) %0, i64 noundef %i.g, ptr noundef null, ptr noundef null)
          to label %.noexc71 unwind label %bb.f   ; 3 uses

.noexc71:                                         ; preds = %bb.d
  %i.m = load ptr, ptr %0, align 8, !tbaa !265    ; 3 uses
...
bb.u:                                             ; preds = %.lr.ph104, %._crit_edge101
  %.046103 = phi i64 [ %i.ba, %.lr.ph104 ], [ %i.bs, %._crit_edge101 ] ; 4 uses
  %.047102 = phi i64 [ 1, %.lr.ph104 ], [ %i.br, %._crit_edge101 ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #24
  store i64 0, ptr %5, align 8, !tbaa !293
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #24
  %i.bf = load ptr, ptr %2, align 8, !tbaa !265
  %i.bg = getelementptr inbounds nuw [8 x i8], ptr %i.bf, i64 %.046103
  invoke void @_ZN4bzla8bitblast7AigNodeC1ERKS1_(ptr noundef nonnull align 8 dereferenceable(8) %6, ptr noundef nonnull align 8 dereferenceable(8) %i.bg)
          to label %bb.v unwind label %bb.x

bb.v:                                             ; preds = %bb.u
  %i.bh = shl nuw nsw i64 %.047102, 1
  %i.bi = sub i64 %i.h, %i.bh                     ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #24
  %i.bj = load ptr, ptr %0, align 8, !tbaa !265
  %i.bk = getelementptr inbounds nuw [8 x i8], ptr %i.bj, i64 %i.bi
  invoke void @_ZN4bzla8bitblast19BitblasterInterfaceINS0_7AigNodeEE10half_adderERKS2_S5_(ptr dead_on_unwind nonnull writable sret(%"struct.std::pair.706") align 8 %7, ptr noundef nonnull align 8 dereferenceable(120) %1, ptr noundef nonnull align 8 dereferenceable(8) %i.bk, ptr noundef nonnull align 8 dereferenceable(8) %6)
          to label %bb.w unwind label %bb.y

bb.w:                                             ; preds = %bb.v
  %i.bl = load ptr, ptr %0, align 8, !tbaa !265
  %i.bm = getelementptr inbounds nuw [8 x i8], ptr %i.bl, i64 %i.bi
  %i.bn = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZN4bzla8bitblast7AigNodeaSEOS1_(ptr noundef nonnull align 8 dereferenceable(8) %i.bm, ptr noundef nonnull align 8 dereferenceable(16) %7)
          to label %.noexc83 unwind label %bb.z   ; 0 uses

.noexc83:                                         ; preds = %bb.w
  %i.bo = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZN4bzla8bitblast7AigNodeaSEOS1_(ptr noundef nonnull align 8 dereferenceable(8) %5, ptr noundef nonnull align 8 dereferenceable(8) %i.bb)
...
_ZNSt5tupleIJRN4bzla8bitblast7AigNodeES3_EEaSIS2_S2_EENSt9enable_ifIXcl12__assignableIT_T0_EEERS4_E4typeEOSt4pairIS7_S8_E.exit: ; preds = %.noexc83
  call void @_ZN4bzla8bitblast7AigNodeD1Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %i.bb) #24
  call void @_ZN4bzla8bitblast7AigNodeD1Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(16) %7) #24
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #24
  %i.bp = sub i64 %i.g, %i.bi                     ; 2 uses
  %i.bq = icmp ult i64 %i.bp, %i.g
  br i1 %i.bq, label %.lr.ph100, label %._crit_edge101
...
bb.aa:                                            ; preds = %bb.z, %bb.y
  %.pn61 = phi { ptr, i32 } [ %i.bv, %bb.z ], [ %i.bu, %bb.y ]
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #24
  br label %bb.aj
...
.lr.ph100:                                        ; preds = %_ZNSt5tupleIJRN4bzla8bitblast7AigNodeES3_EEaSIS2_S2_EENSt9enable_ifIXcl12__assignableIT_T0_EEERS4_E4typeEOSt4pairIS7_S8_E.exit, %_ZNSt5tupleIJRN4bzla8bitblast7AigNodeES3_EEaSIS2_S2_EENSt9enable_ifIXcl12__assignableIT_T0_EEERS4_E4typeEOSt4pairIS7_S8_E.exit91
  %.04599.in = phi i64 [ %.04599, %_ZNSt5tupleIJRN4bzla8bitblast7AigNodeES3_EEaSIS2_S2_EENSt9enable_ifIXcl12__assignableIT_T0_EEERS4_E4typeEOSt4pairIS7_S8_E.exit91 ], [ %i.bi, %_ZNSt5tupleIJRN4bzla8bitblast7AigNodeES3_EEaSIS2_S2_EENSt9enable_ifIXcl12__assignableIT_T0_EEERS4_E4typeEOSt4pairIS7_S8_E.exit ]
  %.098 = phi i64 [ %i.cg, %_ZNSt5tupleIJRN4bzla8bitblast7AigNodeES3_EEaSIS2_S2_EENSt9enable_ifIXcl12__assignableIT_T0_EEERS4_E4typeEOSt4pairIS7_S8_E.exit91 ], [ %.046103, %_ZNSt5tupleIJRN4bzla8bitblast7AigNodeES3_EEaSIS2_S2_EENSt9enable_ifIXcl12__assignableIT_T0_EEERS4_E4typeEOSt4pairIS7_S8_E.exit ] ; 3 uses
  %.04497 = phi i64 [ %i.cf, %_ZNSt5tupleIJRN4bzla8bitblast7AigNodeES3_EEaSIS2_S2_EENSt9enable_ifIXcl12__assignableIT_T0_EEERS4_E4typeEOSt4pairIS7_S8_E.exit91 ], [ %i.bp, %_ZNSt5tupleIJRN4bzla8bitblast7AigNodeES3_EEaSIS2_S2_EENSt9enable_ifIXcl12__assignableIT_T0_EEERS4_E4typeEOSt4pairIS7_S8_E.exit ]
  %.04599 = add i64 %.04599.in, -1                ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #24
  %i.bw = icmp eq i64 %.098, %.046103
  br i1 %i.bw, label %bb.ab, label %bb.ac

bb.ab:                                            ; preds = %.lr.ph100
  invoke void @_ZN4bzla8bitblast7AigNodeC1ERKS1_(ptr noundef nonnull align 8 dereferenceable(8) %8, ptr noundef nonnull align 8 dereferenceable(8) %i.bd)
          to label %_ZN4bzla8bitblast12BitInterfaceINS0_7AigNodeEE8mk_falseEv.exit86 unwind label %bb.ae

bb.ac:                                            ; preds = %.lr.ph100
  %i.bx = load ptr, ptr %2, align 8, !tbaa !265
  %i.by = getelementptr inbounds nuw [8 x i8], ptr %i.bx, i64 %.098
  invoke void @_ZN4bzla8bitblast10AigManager11rewrite_andERKNS0_7AigNodeES4_(ptr dead_on_unwind nonnull writable sret(%"class.bzla::bitblast::AigNode") align 8 %8, ptr noundef nonnull align 8 dereferenceable(112) %i.bc, ptr noundef nonnull align 8 dereferenceable(8) %i.by, ptr noundef nonnull align 8 dereferenceable(8) %6)
          to label %_ZN4bzla8bitblast12BitInterfaceINS0_7AigNodeEE8mk_falseEv.exit86 unwind label %bb.ae
...
_ZN4bzla8bitblast12BitInterfaceINS0_7AigNodeEE8mk_falseEv.exit86: ; preds = %bb.ac, %bb.ab
  ...
  %i.ca = getelementptr inbounds nuw [8 x i8], ptr %i.bz, i64 %.04599
  invoke void @_ZN4bzla8bitblast19BitblasterInterfaceINS0_7AigNodeEE10full_adderERKS2_S5_S5_(ptr dead_on_unwind nonnull writable sret(%"struct.std::pair.706") align 8 %9, ptr noundef nonnull align 8 dereferenceable(120) %1, ptr noundef nonnull align 8 dereferenceable(8) %i.ca, ptr noundef nonnull align 8 dereferenceable(8) %8, ptr noundef nonnull align 8 dereferenceable(8) %5)
...
bb.ad:                                            ; preds = %_ZN4bzla8bitblast12BitInterfaceINS0_7AigNodeEE8mk_falseEv.exit86
  ...
  %i.cd = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZN4bzla8bitblast7AigNodeaSEOS1_(ptr noundef nonnull align 8 dereferenceable(8) %i.cc, ptr noundef nonnull align 8 dereferenceable(16) %9)
          to label %.noexc89 unwind label %bb.ag  ; 0 uses

.noexc89:                                         ; preds = %bb.ad
  %i.ce = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZN4bzla8bitblast7AigNodeaSEOS1_(ptr noundef nonnull align 8 dereferenceable(8) %5, ptr noundef nonnull align 8 dereferenceable(8) %i.be)
...
_ZNSt5tupleIJRN4bzla8bitblast7AigNodeES3_EEaSIS2_S2_EENSt9enable_ifIXcl12__assignableIT_T0_EEERS4_E4typeEOSt4pairIS7_S8_E.exit91: ; preds = %.noexc89
  call void @_ZN4bzla8bitblast7AigNodeD1Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %i.be) #24
  ...
  %i.cf = add i64 %.04497, 1                      ; 2 uses
  %i.cg = add i64 %.098, -1
  %exitcond106.not = icmp eq i64 %i.cf, %i.g
...
bb.ah:                                            ; preds = %bb.ag, %bb.af
  %.pn63 = phi { ptr, i32 } [ %i.cj, %bb.ag ], [ %i.ci, %bb.af ]
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #24
  call void @_ZN4bzla8bitblast7AigNodeD1Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %8) #24
  br label %bb.ai

bb.ai:                                            ; preds = %bb.ah, %bb.ae
  %.pn63.pn = phi { ptr, i32 } [ %.pn63, %bb.ah ], [ %i.ch, %bb.ae ]
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #24
  br label %bb.aj
...
bb.ak:                                            ; preds = %bb.aj, %bb.x
  %.pn63.pn.pn.pn = phi { ptr, i32 } [ %.pn63.pn.pn, %bb.aj ], [ %i.bt, %bb.x ]
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #24
  call void @_ZN4bzla8bitblast7AigNodeD1Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %5) #24
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #24
  br label %bb.al
...
_ZSt8_DestroyIPN4bzla8bitblast7AigNodeEEvT_S4_.exit.i: ; preds = %_ZSt8_DestroyIPN4bzla8bitblast7AigNodeEEvT_S4_.exitthread-pre-split.i, %.noexc16
  %i.o = phi ptr [ %.pr.i, %_ZSt8_DestroyIPN4bzla8bitblast7AigNodeEEvT_S4_.exitthread-pre-split.i ], [ %i.l, %.noexc16 ] ; 3 uses
  %.not.i.i = icmp eq ptr %i.o, null
  br i1 %.not.i.i, label %_ZNSt6vectorIN4bzla8bitblast7AigNodeESaIS2_EE7reserveEm.exit, label %bb.e

bb.e:                                             ; preds = %_ZSt8_DestroyIPN4bzla8bitblast7AigNodeEEvT_S4_.exit.i
  %i.p = load ptr, ptr %i.i, align 8, !tbaa !267
  %i.q = ptrtoint ptr %i.p to i64
  %i.r = ptrtoint ptr %i.o to i64
  %i.s = sub i64 %i.q, %i.r
  tail call void @_ZdlPvm(ptr noundef nonnull %i.o, i64 noundef %i.s) #25
  br label %_ZNSt6vectorIN4bzla8bitblast7AigNodeESaIS2_EE7reserveEm.exit

_ZNSt6vectorIN4bzla8bitblast7AigNodeESaIS2_EE7reserveEm.exit: ; preds = %_ZSt8_DestroyIPN4bzla8bitblast7AigNodeEEvT_S4_.exit.i, %bb.e
  store ptr %i.k, ptr %0, align 8, !tbaa !265
  store ptr %i.k, ptr %i.j, align 8, !tbaa !266
  %i.t = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.f
  store ptr %i.t, ptr %i.i, align 8, !tbaa !267
  %.pre = load ptr, ptr %i.a, align 8, !tbaa !266
  %.pre21 = load ptr, ptr %3, align 8, !tbaa !265 ; 2 uses
  %i.u = icmp eq ptr %.pre, %.pre21
