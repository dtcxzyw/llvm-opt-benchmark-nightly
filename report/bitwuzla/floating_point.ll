...
.lr.ph.split.us:                                  ; preds = %.lr.ph, %.lr.ph.split.us
  ...
  %i.bw = add nsw i64 %.066107.us, 1              ; 2 uses
  ...
  %i.cb = add nsw i64 %spec.store.select.us, 1    ; 2 uses
  ...
  %i.cr = add nsw i64 %spec.store.select2.us, 1   ; 2 uses
  ...
  %i.cw = add nsw i64 %spec.store.select1.us, 1   ; 2 uses
...
.lr.ph.split:                                     ; preds = %.lr.ph, %.lr.ph.split
  ...
  %i.dn = add nsw i64 %.066107, 1                 ; 2 uses
  ...
  %i.ds = add nsw i64 %spec.store.select, 1       ; 2 uses
