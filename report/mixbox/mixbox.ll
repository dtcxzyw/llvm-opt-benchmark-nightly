...
begin_hunk_0_@mixbox_lerp:bb.a
  ...
  %i.pz = insertelement <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, float %i.kz, i64 0
  %10 = shufflevector <4 x float> %i.pz, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 0>
  %11 = shufflevector <2 x float> %i.py, <2 x float> poison, <3 x i32> <i32 0, i32 1, i32 poison>
  %12 = shufflevector <3 x float> %11, <3 x float> <float poison, float poison, float 0.000000e+00>, <4 x i32> <i32 0, i32 1, i32 5, i32 0>
  %i.qa = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %10, <4 x float> <float f0x3EA7C333, float f0x4023707E, float 0.000000e+00, float f0x3EA7C333>, <4 x float> %12)
  ...
  %13 = shufflevector <2 x float> %i.lr, <2 x float> <float poison, float -0.000000e+00>, <4 x i32> <i32 0, i32 0, i32 3, i32 0>
  %i.qg = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %13, <4 x float> <float f0x400998DE, float f0xBFB3B903, float 0.000000e+00, float f0x400998DE>, <4 x float> %i.qf)
  ...
  %i.se = insertelement <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, float %i.nu, i64 0
  %14 = shufflevector <4 x float> %i.se, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 0>
  %15 = shufflevector <2 x float> %i.sd, <2 x float> poison, <3 x i32> <i32 0, i32 1, i32 poison>
  %16 = shufflevector <3 x float> %15, <3 x float> <float poison, float poison, float 0.000000e+00>, <4 x i32> <i32 0, i32 1, i32 5, i32 0>
  %i.sf = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %14, <4 x float> <float f0x3F96801B, float f0x4033F7FD, float 0.000000e+00, float f0x3F96801B>, <4 x float> %16)
  ...
  %.scalar53 = fsub float 1.000000e+00, %6        ; 5 uses
  %17 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %.scalar53, i64 0
  %i.to = shufflevector <2 x float> %17, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 0> ; 2 uses
  %i.tp = tail call float @llvm.fmuladd.f32(float %.scalar53, float %i.kr, float %i.nw) ; 6 uses
  %i.tq = tail call float @llvm.fmuladd.f32(float %.scalar53, float %i.ig, float %i.nx) ; 9 uses
  %i.tr = tail call float @llvm.fmuladd.f32(float %.scalar53, float %i.jp, float %i.ny) ; 10 uses
  ...
  %18 = insertelement <2 x float> <float f0x40C00672, float poison>, float %.scalar53, i64 1
  %i.tv = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.tu, <2 x float> %18, <2 x float> %i.tt) ; 3 uses
  ...
  %19 = shufflevector <4 x float> <float poison, float f0x40C00672, float poison, float poison>, <4 x float> %i.to, <2 x i32> <i32 4, i32 1>
  %i.vv = insertelement <2 x float> poison, float %i.tw, i64 0
  %i.vw = insertelement <2 x float> %i.vv, float %i.vq, i64 1
  %i.vx = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.vu, <2 x float> %19, <2 x float> %i.vw) ; 2 uses
  %20 = shufflevector <2 x float> %i.vx, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %21 = insertelement <2 x float> %20, float %6, i64 0
  %22 = shufflevector <2 x float> %21, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 0>
  %i.vy = fmul <4 x float> %22, %i.tn
  ...
  %i.xe = insertelement <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, float %i.uz, i64 0
  %23 = shufflevector <4 x float> %i.xe, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 0>
  %i.xf = shufflevector <2 x float> %i.xd, <2 x float> %i.vx, <4 x i32> <i32 0, i32 1, i32 3, i32 0>
  %i.xg = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %23, <4 x float> <float f0x3F84550C, float f0x3F500D42, float 0.000000e+00, float f0x3F84550C>, <4 x float> %i.xf)
  ...
  %24 = shufflevector <2 x float> %i.vt, <2 x float> <float poison, float -0.000000e+00>, <4 x i32> <i32 1, i32 1, i32 3, i32 1>
  %i.yf = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %24, <4 x float> <float f0x3FF42585, float f0x40238DA6, float 0.000000e+00, float f0x3FF42585>, <4 x float> %i.ye)
