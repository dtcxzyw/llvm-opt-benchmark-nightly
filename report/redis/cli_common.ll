...
bb.o:                                             ; preds = %bb.n
  ...
  %i.aj = tail call i64 @__isoc23_strtol(ptr noundef nonnull %i.ai, ptr noundef null, i32 noundef 10) #12
  %i.ak = trunc i64 %i.aj to i32
  %i.al = getelementptr inbounds nuw i8, ptr %2, i64 8
  store i32 %i.ak, ptr %i.al, align 8, !tbaa !48
  br label %bb.p
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.ap = tail call i64 @__isoc23_strtol(ptr noundef nonnull %i.ao, ptr noundef null, i32 noundef 10) #12
  %i.aq = trunc i64 %i.ap to i32
  %i.ar = getelementptr inbounds nuw i8, ptr %2, i64 8
  store i32 %i.aq, ptr %i.ar, align 8, !tbaa !48
...
bb.s:                                             ; preds = %bb.q, %bb.r, %bb.m, %bb.p
  ...
  %i.at = load ptr, ptr %2, align 8, !tbaa !49
  ...
  store ptr %i.ay, ptr %2, align 8, !tbaa !49
  br label %bb.t
...
bb.u:                                             ; preds = %bb.t
  %i.bc = tail call i64 @__isoc23_strtol(ptr noundef nonnull %i.az, ptr noundef null, i32 noundef 10) #12
...
begin_hunk_4_@percentDecode:bb.a
  ...
  br i1 %i.aw, label %bb.b, label %._crit_edge, !llvm.loop !55
