...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.h
  %.198 = phi ptr [ %i.w, %bb.h ], [ %.0, %.lr.ph.preheader ] ; 4 uses
...
.critedge.isplit:                                 ; preds = %bb.h
  %.lcssa223.ph = phi i1 [ %i.r, %bb.h ]
  %.078.lcssa.ph.ph = phi i64 [ %i.v, %bb.h ]
  %.1.lcssa.ph.ph = phi ptr [ %scevgep, %bb.h ]
  br label %.critedge.i

.lr.ph..critedge.i_crit_edge:                     ; preds = %.lr.ph
  %.198.lcssa = phi ptr [ %.198, %.lr.ph ]
  %split = phi i1 [ %i.r, %.lr.ph ]
  %split224 = phi i64 [ %.07897, %.lr.ph ]
  %.198.lcssa.a = phi ptr [ %.198, %.lr.ph ]      ; 0 uses
  br label %.critedge.i

.critedge.i:                                      ; preds = %.critedge.isplit, %.lr.ph..critedge.i_crit_edge
  %.lcssa223 = phi i1 [ %split, %.lr.ph..critedge.i_crit_edge ], [ %.lcssa223.ph, %.critedge.isplit ]
  %.078.lcssa.ph = phi i64 [ %split224, %.lr.ph..critedge.i_crit_edge ], [ %.078.lcssa.ph.ph, %.critedge.isplit ] ; 4 uses
  %.1.lcssa.ph = phi ptr [ %.198.lcssa, %.lr.ph..critedge.i_crit_edge ], [ %.1.lcssa.ph.ph, %.critedge.isplit ] ; 7 uses
...
.lr.ph116:                                        ; preds = %.lr.ph116.preheader, %bb.n
  %.10115 = phi ptr [ %i.bf, %bb.n ], [ %.11.lcssa, %.lr.ph116.preheader ] ; 4 uses
...
.critedge3.i.loopexitsplit:                       ; preds = %bb.n
  %.684.lcssa.ph.ph = phi i64 [ %i.bi, %bb.n ]
  %.10.lcssa.ph.ph = phi ptr [ %scevgep157, %bb.n ]
  br label %.critedge3.i.loopexit

.lr.ph116..critedge3.i.loopexit_crit_edge:        ; preds = %.lr.ph116
  %.10115.lcssa = phi ptr [ %.10115, %.lr.ph116 ]
  %split229 = phi i64 [ %.684114, %.lr.ph116 ]
  %.10115.lcssa.a = phi ptr [ %.10115, %.lr.ph116 ] ; 0 uses
  br label %.critedge3.i.loopexit

.critedge3.i.loopexit:                            ; preds = %.critedge3.i.loopexitsplit, %.lr.ph116..critedge3.i.loopexit_crit_edge
  %.684.lcssa.ph = phi i64 [ %split229, %.lr.ph116..critedge3.i.loopexit_crit_edge ], [ %.684.lcssa.ph.ph, %.critedge3.i.loopexitsplit ]
  %.10.lcssa.ph = phi ptr [ %.10115.lcssa, %.lr.ph116..critedge3.i.loopexit_crit_edge ], [ %.10.lcssa.ph.ph, %.critedge3.i.loopexitsplit ] ; 2 uses
...
.lr.ph125:                                        ; preds = %.lr.ph125.preheader, %bb.ac
  ...
  %.9123 = phi ptr [ %i.cm, %bb.ac ], [ %.4, %.lr.ph125.preheader ] ; 4 uses
...
.critedge7.isplit:                                ; preds = %bb.ac
  %.9.lcssa.ph.ph = phi ptr [ %scevgep159, %bb.ac ]
  %.081.i.lcssa.ph.ph = phi i64 [ %.182.i, %bb.ac ]
  br label %.critedge7.i

.lr.ph125..critedge7.i_crit_edge:                 ; preds = %.lr.ph125
  %.9123.lcssa = phi ptr [ %.9123, %.lr.ph125 ]
  %.9123.lcssa.a = phi ptr [ %.9123, %.lr.ph125 ] ; 0 uses
  %split233 = phi i64 [ %.081.i124, %.lr.ph125 ]
  br label %.critedge7.i

.critedge7.i:                                     ; preds = %.critedge7.isplit, %.lr.ph125..critedge7.i_crit_edge
  %.9.lcssa.ph = phi ptr [ %.9123.lcssa, %.lr.ph125..critedge7.i_crit_edge ], [ %.9.lcssa.ph.ph, %.critedge7.isplit ]
  %.081.i.lcssa.ph = phi i64 [ %split233, %.lr.ph125..critedge7.i_crit_edge ], [ %.081.i.lcssa.ph.ph, %.critedge7.isplit ] ; 2 uses
...
_ZN10fast_float10skip_zerosIcEEvRPKT_S3_.exit75:  ; preds = %_ZN10fast_float10skip_zerosIcEEvRPKT_S3_.exit75split, %.lr.ph329._ZN10fast_float10skip_zerosIcEEvRPKT_S3_.exit75_crit_edge
  %.10.lcssa = phi ptr [ %.10327.lcssa, %.lr.ph329._ZN10fast_float10skip_zerosIcEEvRPKT_S3_.exit75_crit_edge ], [ %.10.lcssa.ph, %_ZN10fast_float10skip_zerosIcEEvRPKT_S3_.exit75split ] ; 2 uses
...
_ZN10fast_float10skip_zerosIcEEvRPKT_S3_.exit.loopexit: ; preds = %_ZN10fast_float10skip_zerosIcEEvRPKT_S3_.exit.loopexitsplit, %.lr.ph384._ZN10fast_float10skip_zerosIcEEvRPKT_S3_.exit.loopexit_crit_edge
  %.3.ph = phi ptr [ %.8382.lcssa, %.lr.ph384._ZN10fast_float10skip_zerosIcEEvRPKT_S3_.exit.loopexit_crit_edge ], [ %.3.ph.ph, %_ZN10fast_float10skip_zerosIcEEvRPKT_S3_.exit.loopexitsplit ]
