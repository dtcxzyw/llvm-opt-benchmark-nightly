...
bb.c:                                             ; preds = %.lr.ph328
  ...
  br i1 %.not8.i71, label %_ZN10fast_float10skip_zerosIcEEvRPKT_S3_.exit75, label %.lr.ph328, !llvm.loop !48

_ZN10fast_float10skip_zerosIcEEvRPKT_S3_.exit75:  ; preds = %.lr.ph328, %bb.c
...
.preheader301:                                    ; preds = %.preheader301.lr.ph, %_ZN10fast_float6bigint3addEm.exit132
  %.0356 = phi ptr [ %.10.lcssa, %.preheader301.lr.ph ], [ %.2.lcssa, %_ZN10fast_float6bigint3addEm.exit132 ] ; 5 uses
...
._crit_edge357:                                   ; preds = %_ZN10fast_float6bigint3addEm.exit132, %._crit_edge, %_ZN10fast_float10skip_zerosIcEEvRPKT_S3_.exit75
  %i.ig = getelementptr inbounds nuw i8, ptr %1, i64 48
  %i.ih = load ptr, ptr %i.ig, align 8, !tbaa !58 ; 6 uses
...
bb.o:                                             ; preds = %._crit_edge357
  ...
  %i.ij = load i64, ptr %i.ii, align 8, !tbaa !46 ; 3 uses
...
._crit_edge376:                                   ; preds = %bb.p, %.lr.ph376.._crit_edge377.loopexit_crit_edge, %.preheader296
  ...
  br i1 %.not8.i380, label %_ZN10fast_float12is_truncatedIcEEbPKT_S3_.exit, label %.lr.ph384.preheader
...
bb.q:                                             ; preds = %.lr.ph383
  ...
  br i1 %.not8.i, label %_ZN10fast_float10skip_zerosIcEEvRPKT_S3_.exit, label %.lr.ph383, !llvm.loop !48

_ZN10fast_float10skip_zerosIcEEvRPKT_S3_.exit:    ; preds = %bb.q, %.lr.ph383, %bb.o
...
bb.t:                                             ; preds = %._crit_edge.i49.us
  ...
  br i1 %i.dc, label %_ZN10fast_float8stackvecILt62EE8try_pushEm.exit.thread.i.i.us.a, label %.critedge.i.i.us

bb.u:                                             ; preds = %_ZN10fast_float8stackvecILt62EE8try_pushEm.exit.thread.i.i.us.a
  %i.dd = add i64 %.01421.i.i.us103, 1            ; 2 uses
  %exitcond.not.i.i.us = icmp eq i64 %i.dd, %umax.i.i.us
  br i1 %exitcond.not.i.i.us, label %.critedge.i.i.us, label %_ZN10fast_float8stackvecILt62EE8try_pushEm.exit.thread.i.i.us.a, !llvm.loop !77

_ZN10fast_float8stackvecILt62EE8try_pushEm.exit.thread.i.i.us.a: ; preds = %bb.t, %bb.u
  ...
  %5 = load i64, ptr %i.de, align 8, !tbaa !25
  %6 = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %5, i64 1) ; 2 uses
  %7 = extractvalue { i64, i1 } %6, 1
  %8 = extractvalue { i64, i1 } %6, 0
  store i64 %8, ptr %i.de, align 8, !tbaa !25
  br i1 %7, label %bb.u, label %.critedge.us, !llvm.loop !77

.critedge.i.i.us:                                 ; preds = %bb.u, %bb.t
  %9 = icmp ult i16 %i.co, 62
  br i1 %9, label %.lr.ph104, label %_ZN10fast_float8stackvecILt62EE10try_extendENS_4spanImEE.exit

.lr.ph104:                                        ; preds = %.critedge.i.i.us
  %i.df = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %i.db
  store i64 1, ptr %i.df, align 8, !tbaa !25
  %10 = add nuw nsw i16 %i.co, 1                  ; 2 uses
  store i16 %10, ptr %i.a, align 8, !tbaa !50
  br label %.critedge.us

.critedge.us:                                     ; preds = %_ZN10fast_float8stackvecILt62EE8try_pushEm.exit.thread.i.i.us.a, %.lr.ph104, %._crit_edge.i49.us, %bb.q, %.lr.ph.split.us
  %i.dg = phi i16 [ %i.aq, %.lr.ph.split.us ], [ %i.co, %bb.q ], [ %10, %.lr.ph104 ], [ %i.co, %._crit_edge.i49.us ], [ %i.co, %_ZN10fast_float8stackvecILt62EE8try_pushEm.exit.thread.i.i.us.a ]
