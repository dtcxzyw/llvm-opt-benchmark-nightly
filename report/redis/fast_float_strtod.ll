...
begin_hunk_3_@_ZN10fast_float19from_chars_advancedIdcEENS_19from_chars_result_tIT0_EERNS_22parsed_number_string_tIS2_EERT_:bb.a
  ...
  %i.cd = sub nsw i32 %i.cc, %i.ay
  %i.ce = add nsw i32 %i.cd, %i.by                ; 4 uses
  %i.cf = icmp slt i32 %i.ce, -1085
  br i1 %i.cf, label %bb.r, label %bb.t

bb.r:                                             ; preds = %_ZN10fast_float29compute_product_approximationILi55EEENS_8value128Elm.exit103
  %3 = icmp samesign ult i32 %i.ce, -1148
  br i1 %3, label %_ZN10fast_float13compute_floatINS_13binary_formatIdEEEENS_17adjusted_mantissaElm.exit92, label %bb.s

bb.s:                                             ; preds = %bb.r
  %4 = sub nuw nsw i32 -1085, %i.ce
...
begin_hunk_4_@_ZN10fast_float19from_chars_advancedIdcEENS_19from_chars_result_tIT0_EERNS_22parsed_number_string_tIS2_EERT_:bb.a
  ...
  %.not22.i81 = icmp samesign ult i64 %i.cw, 18014398509481984 ; 2 uses
  %spec.select167.v = select i1 %.not22.i81, i32 1086, i32 1087
  %spec.select167 = add nsw i32 %spec.select167.v, %i.ce ; 2 uses
  %i.cy = and i64 %i.cx, 9218868437227405311
  %.not23.i82 = icmp samesign ult i32 %spec.select167, 2047
  %5 = and i1 %.not22.i81, %.not23.i82
  %spec.select175 = select i1 %5, i64 %i.cy, i64 0
  %spec.select176 = tail call i32 @llvm.umin.i32(i32 %spec.select167, i32 2047)
...
begin_hunk_5_@_ZN10fast_float19from_chars_advancedIdcEENS_19from_chars_result_tIT0_EERNS_22parsed_number_string_tIS2_EERT_:bb.a
  ...
  %i.el = sub nsw i32 %i.ek, %i.dg
  %i.em = add nsw i32 %i.el, %i.eg                ; 4 uses
  %i.en = icmp slt i32 %i.em, -1085
...
bb.y:                                             ; preds = %_ZN10fast_float29compute_product_approximationILi55EEENS_8value128Elm.exit108
  %6 = icmp samesign ult i32 %i.em, -1148
  br i1 %6, label %_ZN10fast_float13compute_floatINS_13binary_formatIdEEEENS_17adjusted_mantissaElm.exit, label %bb.z

bb.z:                                             ; preds = %bb.y
  %7 = sub nuw nsw i32 -1085, %i.em
  %i.eo = zext nneg i32 %7 to i64
...
begin_hunk_6_@_ZN10fast_float19from_chars_advancedIdcEENS_19from_chars_result_tIT0_EERNS_22parsed_number_string_tIS2_EERT_:bb.a
  ...
  %.not22.i = icmp samesign ult i64 %i.fe, 18014398509481984 ; 2 uses
  %spec.select173.v = select i1 %.not22.i, i32 1086, i32 1087
  %spec.select173 = add nsw i32 %spec.select173.v, %i.em ; 2 uses
  %i.fg = and i64 %i.ff, 9218868437227405311
  %.not23.i = icmp samesign ult i32 %spec.select173, 2047
  %8 = and i1 %.not22.i, %.not23.i
  %spec.select177 = select i1 %8, i64 %i.fg, i64 0
...
begin_hunk_7_@_ZN10fast_float19from_chars_advancedIdcEENS_19from_chars_result_tIT0_EERNS_22parsed_number_string_tIS2_EERT_:bb.a
  ...
  %i.hi = sub i32 %.2.i.lcssa.i, %i.hh
  %9 = add i32 %i.hi, 1                           ; 3 uses
  %i.hj = icmp sgt i32 %9, -1
...
bb.ah:                                            ; preds = %_ZN10fast_float19scientific_exponentIcEEiRNS_22parsed_number_string_tIT_EE.exit.i
  %i.hk = call { i64, i32 } @_ZN10fast_float19positive_digit_compIdEENS_17adjusted_mantissaERNS_6bigintEi(ptr noundef nonnull align 8 dereferenceable(504) %2, i32 noundef %9) #11
...
bb.ai:                                            ; preds = %_ZN10fast_float19scientific_exponentIcEEiRNS_22parsed_number_string_tIT_EE.exit.i
  ...
  %i.hm = call { i64, i32 } @_ZN10fast_float19negative_digit_compIdEENS_17adjusted_mantissaERNS_6bigintES1_i(ptr noundef nonnull align 8 dereferenceable(504) %2, i64 %i.go, i32 %i.hl, i32 noundef %9) #11
  br label %_ZN10fast_float10digit_compIdcEENS_17adjusted_mantissaERNS_22parsed_number_string_tIT0_EES1_.exit
...
begin_hunk_9_@_ZN10fast_float14parse_mantissaIcEEvRNS_6bigintERNS_22parsed_number_string_tIT_EEmRm:bb.a
  ...
  %i.ku = add i64 %i.kr, %i.kt
  %i.kv = add i64 %i.ku, -48                      ; 2 uses
