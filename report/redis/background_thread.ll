...
vector.main.loop.iter.check:                      ; preds = %vector.scevcheck
  %min.iters.check68 = icmp ult i64 %i.a, 32
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec69 = and i64 %i.a, 8589934584             ; 4 uses
  %2 = trunc i64 %n.vec69 to i32
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index70 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next71, %vec.epilog.vector.body ] ; 2 uses
  %i.l = getelementptr inbounds nuw i8, ptr %i.b, i64 %index70
  store <8 x i8> zeroinitializer, ptr %i.l, align 8, !tbaa !38
  %index.next71 = add nuw i64 %index70, 8         ; 2 uses
  %i.m = icmp eq i64 %index.next71, %n.vec69
  br i1 %i.m, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !44

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n72 = icmp eq i64 %i.a, %n.vec69
...
.lr.ph.preheader:                                 ; preds = %vector.scevcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv.ph = phi i64 [ 0, %iter.check ], [ 0, %vector.scevcheck ], [ %n.vec, %vec.epilog.iter.check ], [ %n.vec69, %vec.epilog.middle.block ]
...
._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %vec.epilog.middle.block, %bb.a
  ...
  %i.n = tail call i32 @je_narenas_total_get() #12 ; 4 uses
  %i.o = icmp ugt i32 %i.n, 1
  br i1 %i.o, label %.lr.ph44.preheader, label %._crit_edge45

.lr.ph44.preheader:                               ; preds = %._crit_edge
  %wide.trip.count = zext i32 %i.n to i64
  %.pre62 = load i64, ptr @je_max_background_threads, align 8, !tbaa !21
  br label %.lr.ph44

.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %indvars.iv.a = phi i64 [ %4, %.lr.ph ], [ %indvars.iv.ph, %.lr.ph.preheader ]
  %.03340 = phi i32 [ %3, %.lr.ph ], [ %.03340.ph, %.lr.ph.preheader ]
  %i.p = getelementptr inbounds nuw i8, ptr %i.b, i64 %indvars.iv.a
...
.lr.ph44:                                         ; preds = %.lr.ph44.preheader, %bb.f
  %i.r = phi i64 [ %.pre62, %.lr.ph44.preheader ], [ %i.bc, %bb.f ] ; 2 uses
  %indvars.iv52.a = phi i64 [ 1, %.lr.ph44.preheader ], [ %indvars.iv.next53.a, %bb.f ] ; 5 uses
  %.03441 = phi i32 [ 0, %.lr.ph44.preheader ], [ %.1, %bb.f ] ; 3 uses
  %i.s = urem i64 %indvars.iv52.a, %i.r
...
bb.b:                                             ; preds = %.lr.ph44
  %i.w = getelementptr inbounds nuw [8 x i8], ptr @je_arenas, i64 %indvars.iv52.a
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.aa = urem i64 %indvars.iv52.a, %.pre
...
bb.f:                                             ; preds = %malloc_mutex_lock.exit, %.lr.ph44, %bb.b
  ...
  %.1 = phi i32 [ %.03441, %.lr.ph44 ], [ %.03441, %bb.b ], [ %i.ba, %malloc_mutex_lock.exit ]
  %indvars.iv.next53.a = add nuw nsw i64 %indvars.iv52.a, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next53.a, %wide.trip.count
...
.lr.ph47.preheader:                               ; preds = %._crit_edge45
  %wide.trip.count60 = zext i32 %i.n to i64
  br label %.lr.ph47

.lr.ph47:                                         ; preds = %.lr.ph47.preheader, %bb.h
  %indvars.iv56 = phi i64 [ 0, %.lr.ph47.preheader ], [ %indvars.iv.next57, %bb.h ] ; 2 uses
  %i.bf = getelementptr inbounds nuw [8 x i8], ptr @je_arenas, i64 %indvars.iv56
...
bb.h:                                             ; preds = %bb.g, %.lr.ph47
  ...
  br i1 %exitcond61.not, label %.loopexit, label %.lr.ph47, !llvm.loop !47
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <16 x i8> zeroinitializer, ptr %i.p, align 1, !tbaa !38
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.q = icmp eq i64 %index.next, %n.vec
  br i1 %i.q, label %middle.block, label %vector.body, !llvm.loop !72
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec66 = and i64 %i.d, -8                     ; 4 uses
  %i.r = or disjoint i64 %n.vec66, 1
  %i.s = trunc i64 %n.vec66 to i32
  %i.t = or disjoint i32 %i.s, 1
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index67 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next68, %vec.epilog.vector.body ] ; 2 uses
  %i.u = getelementptr inbounds nuw i8, ptr %i.b, i64 %index67
  %i.v = getelementptr inbounds nuw i8, ptr %i.u, i64 1
  store <8 x i8> zeroinitializer, ptr %i.v, align 1, !tbaa !38
  %index.next68 = add nuw i64 %index67, 8         ; 2 uses
  %i.w = icmp eq i64 %index.next68, %n.vec66
  br i1 %i.w, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !73

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n69 = icmp eq i64 %i.d, %n.vec66
  br i1 %cmp.n69, label %.preheader35, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %vector.scevcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.ph = phi i64 [ 1, %iter.check ], [ 1, %vector.scevcheck ], [ %i.k, %vec.epilog.iter.check ], [ %i.r, %vec.epilog.middle.block ]
  %.040.ph = phi i32 [ 1, %iter.check ], [ 1, %vector.scevcheck ], [ %i.m, %vec.epilog.iter.check ], [ %i.t, %vec.epilog.middle.block ]
  br label %.lr.ph

.preheader35:                                     ; preds = %.lr.ph, %middle.block, %vec.epilog.middle.block, %bb.a
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 832
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 1 ; 4 uses
  br label %.outer

.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %i.z = phi i64 [ %i.ac, %.lr.ph ], [ %.ph, %.lr.ph.preheader ]
  %.040 = phi i32 [ %i.ab, %.lr.ph ], [ %.040.ph, %.lr.ph.preheader ]
  %i.aa = getelementptr inbounds nuw i8, ptr %i.b, i64 %i.z
  store i8 0, ptr %i.aa, align 1, !tbaa !38
  %i.ab = add i32 %.040, 1                        ; 2 uses
  %i.ac = zext i32 %i.ab to i64                   ; 2 uses
  %i.ad = icmp ugt i64 %i.a, %i.ac
  br i1 %i.ad, label %.lr.ph, label %.preheader35, !llvm.loop !74
...
.preheader:                                       ; preds = %.backedge
  %i.ah = load i64, ptr @je_max_background_threads, align 8, !tbaa !21
  %i.ai = icmp ugt i64 %i.ah, 1
  br i1 %i.ai, label %.lr.ph43, label %._crit_edge

background_thread_pause_check.exit:               ; preds = %.backedge
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ae, i64 56
  %i.ak = getelementptr inbounds nuw i8, ptr %i.ae, i64 160
  store atomic i8 0, ptr %i.ak monotonic, align 8
  %i.al = getelementptr inbounds nuw i8, ptr %i.ae, i64 120
  %i.am = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull %i.al) #12 ; 0 uses
  tail call fastcc void @malloc_mutex_lock(ptr noundef %0, ptr noundef nonnull @je_background_thread_lock)
  store atomic i8 0, ptr getelementptr inbounds nuw (i8, ptr @je_background_thread_lock, i64 104) monotonic, align 8
  %i.an = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull getelementptr inbounds nuw (i8, ptr @je_background_thread_lock, i64 64)) #12 ; 0 uses
  tail call fastcc void @malloc_mutex_lock(ptr noundef %0, ptr noundef nonnull %i.aj)
  br label %.backedge.backedge

bb.b:                                             ; preds = %.backedge
  %i.ao = load i64, ptr @je_n_background_threads, align 8, !tbaa !21
  %i.ap = icmp eq i64 %i.ao, %i.co
  br i1 %i.ap, label %check_background_thread_creation.exit.thread, label %bb.c, !prof !68

bb.c:                                             ; preds = %bb.b
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ae, i64 160
  store atomic i8 0, ptr %i.aq monotonic, align 8
  %i.ar = getelementptr inbounds nuw i8, ptr %i.ae, i64 120
  %i.as = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull %i.ar) #12, !inline_history !75 ; 0 uses
  %i.at = load i64, ptr @je_max_background_threads, align 8, !tbaa !21 ; 2 uses
  %i.au = icmp ugt i64 %i.at, 1
  br i1 %i.au, label %.lr.ph.i, label %check_background_thread_creation.exit.thread33

.lr.ph.i:                                         ; preds = %bb.c, %bb.m
  %i.av = phi i64 [ %i.cg, %bb.m ], [ %i.at, %bb.c ]
  %i.aw = phi i64 [ %i.ci, %bb.m ], [ 1, %bb.c ]  ; 4 uses
  %.039.i = phi i32 [ %i.ch, %bb.m ], [ 1, %bb.c ]
  %i.ax = getelementptr inbounds nuw i8, ptr %i.b, i64 %i.aw
  %i.ay = load i8, ptr %i.ax, align 1, !tbaa !38, !range !24, !noundef !25
  %i.az = trunc nuw i8 %i.ay to i1
  br i1 %i.az, label %bb.m, label %bb.d

bb.d:                                             ; preds = %.lr.ph.i
  %i.ba = load ptr, ptr @je_background_thread_info, align 8, !tbaa !22
  %i.bb = getelementptr inbounds nuw [208 x i8], ptr %i.ba, i64 %i.aw ; 9 uses
  %i.bc = getelementptr inbounds nuw i8, ptr %i.bb, i64 120 ; 2 uses
  %i.bd = tail call i32 @pthread_mutex_trylock(ptr noundef nonnull %i.bc) #12
  %.not.i23 = icmp eq i32 %i.bd, 0
  br i1 %.not.i23, label %bb.e, label %atomic_store_b.exit.i24

atomic_store_b.exit.i24:                          ; preds = %bb.d
  %i.be = getelementptr inbounds nuw i8, ptr %i.bb, i64 56
  tail call void @je_malloc_mutex_lock_slow(ptr noundef nonnull %i.be) #12
  %i.bf = getelementptr inbounds nuw i8, ptr %i.bb, i64 160
  store atomic i8 1, ptr %i.bf monotonic, align 1
  br label %bb.e

bb.e:                                             ; preds = %atomic_store_b.exit.i24, %bb.d
  %i.bg = getelementptr inbounds nuw i8, ptr %i.bb, i64 112 ; 2 uses
  %i.bh = load i64, ptr %i.bg, align 8, !tbaa !13
  %i.bi = add i64 %i.bh, 1
  store i64 %i.bi, ptr %i.bg, align 8, !tbaa !13
  %i.bj = getelementptr inbounds nuw i8, ptr %i.bb, i64 104 ; 2 uses
  %i.bk = load ptr, ptr %i.bj, align 8, !tbaa !19
  %.not.i.i25 = icmp eq ptr %i.bk, %0
  br i1 %.not.i.i25, label %malloc_mutex_lock.exit26, label %bb.f

bb.f:                                             ; preds = %bb.e
  store ptr %0, ptr %i.bj, align 8, !tbaa !19
  %i.bl = getelementptr inbounds nuw i8, ptr %i.bb, i64 96 ; 2 uses
  %i.bm = load i64, ptr %i.bl, align 8, !tbaa !20
  %i.bn = add i64 %i.bm, 1
  store i64 %i.bn, ptr %i.bl, align 8, !tbaa !20
  br label %malloc_mutex_lock.exit26

malloc_mutex_lock.exit26:                         ; preds = %bb.e, %bb.f
  %i.bo = getelementptr inbounds nuw i8, ptr %i.bb, i64 168
  %i.bp = load i32, ptr %i.bo, align 8, !tbaa !26
  %.not.i = icmp eq i32 %i.bp, 1
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bb, i64 160
  store atomic i8 0, ptr %i.bq monotonic, align 8
  %i.br = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull %i.bc) #12, !inline_history !75 ; 0 uses
...
bb.g:                                             ; preds = %malloc_mutex_lock.exit26
  %i.bs = getelementptr inbounds nuw i8, ptr %i.b, i64 %i.aw
  %i.bt = load i8, ptr %i.x, align 8, !tbaa !31
  %i.bu = icmp eq i8 %i.bt, 0
  %i.bv = load i8, ptr %i.y, align 1, !tbaa !31
  %i.bw = add i8 %i.bv, 1
  store i8 %i.bw, ptr %i.y, align 1, !tbaa !31
  br i1 %i.bu, label %bb.h, label %pre_reentrancy.exit.i
...
pre_reentrancy.exit.i:                            ; preds = %bb.h, %bb.g
  %i.bx = inttoptr i64 %i.aw to ptr
  %i.by = tail call fastcc i32 @background_thread_create_signals_masked(ptr noundef nonnull %i.bb, ptr noundef %i.bx), !inline_history !75 ; 2 uses
  %i.bz = load i8, ptr %i.y, align 1, !tbaa !31
  %i.ca = add i8 %i.bz, -1                        ; 2 uses
  store i8 %i.ca, ptr %i.y, align 1, !tbaa !31
  %i.cb = icmp eq i8 %i.ca, 0
  br i1 %i.cb, label %bb.i, label %post_reentrancy.exit.i
...
bb.j:                                             ; preds = %post_reentrancy.exit.i
  %i.cd = add i32 %.028.ph, 1
  store i8 1, ptr %i.bs, align 1, !tbaa !38
  br label %check_background_thread_creation.exit

bb.k:                                             ; preds = %post_reentrancy.exit.i
  tail call void (ptr, ...) @je_malloc_printf(ptr noundef nonnull @.str.5, i32 noundef %i.by) #12, !inline_history !75
  %i.ce = load i8, ptr @je_opt_abort, align 1, !tbaa !38, !range !24, !noundef !25
  %i.cf = trunc nuw i8 %i.ce to i1
  br i1 %i.cf, label %bb.l, label %check_background_thread_creation.exit
...
bb.m:                                             ; preds = %._crit_edge.i, %.lr.ph.i
  %i.cg = phi i64 [ %.pre.i, %._crit_edge.i ], [ %i.av, %.lr.ph.i ] ; 2 uses
  %i.ch = add i32 %.039.i, 1                      ; 2 uses
  %i.ci = zext i32 %i.ch to i64                   ; 2 uses
  %i.cj = icmp ugt i64 %i.cg, %i.ci
  br i1 %i.cj, label %.lr.ph.i, label %check_background_thread_creation.exit.thread33, !llvm.loop !76

check_background_thread_creation.exit.thread33:   ; preds = %bb.m, %bb.c
  %i.ck = load ptr, ptr @je_background_thread_info, align 8, !tbaa !22
  %i.cl = getelementptr inbounds nuw i8, ptr %i.ck, i64 56
  tail call fastcc void @malloc_mutex_lock(ptr noundef %0, ptr noundef nonnull %i.cl), !inline_history !75
...
check_background_thread_creation.exit:            ; preds = %bb.j, %bb.k
  %.129 = phi i32 [ %.028.ph, %bb.k ], [ %i.cd, %bb.j ]
  %i.cm = load ptr, ptr @je_background_thread_info, align 8, !tbaa !22
  %i.cn = getelementptr inbounds nuw i8, ptr %i.cm, i64 56
  tail call fastcc void @malloc_mutex_lock(ptr noundef nonnull %0, ptr noundef nonnull %i.cn), !inline_history !75
...
.outer:                                           ; preds = %.preheader35, %check_background_thread_creation.exit
  ...
  %i.co = zext i32 %.028.ph to i64
  br label %.backedge

check_background_thread_creation.exit.thread:     ; preds = %bb.b, %check_background_thread_creation.exit.thread33
  %i.cp = phi ptr [ %i.ae, %bb.b ], [ %.pre46, %check_background_thread_creation.exit.thread33 ]
...
.lr.ph43:                                         ; preds = %.preheader, %bb.t
  %i.cq = phi i64 [ %i.dq, %bb.t ], [ 1, %.preheader ] ; 2 uses
  %.142 = phi i32 [ %i.dp, %bb.t ], [ 1, %.preheader ]
  %i.cr = load ptr, ptr @je_background_thread_info, align 8, !tbaa !22
  %i.cs = getelementptr inbounds nuw [208 x i8], ptr %i.cr, i64 %i.cq ; 9 uses
  %i.ct = getelementptr inbounds nuw i8, ptr %i.b, i64 %i.cq
  %i.cu = load i8, ptr %i.ct, align 1, !tbaa !38, !range !24, !noundef !25
  %i.cv = trunc nuw i8 %i.cu to i1
  br i1 %i.cv, label %bb.n, label %bb.o

bb.n:                                             ; preds = %.lr.ph43
  %i.cw = tail call fastcc zeroext i1 @background_threads_disable_single(ptr noundef %0, ptr noundef %i.cs) ; 0 uses
  br label %bb.t

bb.o:                                             ; preds = %.lr.ph43
  %i.cx = getelementptr inbounds nuw i8, ptr %i.cs, i64 120 ; 2 uses
  %i.cy = tail call i32 @pthread_mutex_trylock(ptr noundef nonnull %i.cx) #12
  %.not.i21 = icmp eq i32 %i.cy, 0
  br i1 %.not.i21, label %bb.p, label %atomic_store_b.exit.i

atomic_store_b.exit.i:                            ; preds = %bb.o
  %i.cz = getelementptr inbounds nuw i8, ptr %i.cs, i64 56
  tail call void @je_malloc_mutex_lock_slow(ptr noundef nonnull %i.cz) #12
  %i.da = getelementptr inbounds nuw i8, ptr %i.cs, i64 160
  store atomic i8 1, ptr %i.da monotonic, align 1
  br label %bb.p

bb.p:                                             ; preds = %atomic_store_b.exit.i, %bb.o
  %i.db = getelementptr inbounds nuw i8, ptr %i.cs, i64 112 ; 2 uses
  %i.dc = load i64, ptr %i.db, align 8, !tbaa !13
  %i.dd = add i64 %i.dc, 1
  store i64 %i.dd, ptr %i.db, align 8, !tbaa !13
  %i.de = getelementptr inbounds nuw i8, ptr %i.cs, i64 104 ; 2 uses
  %i.df = load ptr, ptr %i.de, align 8, !tbaa !19
  %.not.i.i = icmp eq ptr %i.df, %0
  br i1 %.not.i.i, label %malloc_mutex_lock.exit, label %bb.q

bb.q:                                             ; preds = %bb.p
  store ptr %0, ptr %i.de, align 8, !tbaa !19
  %i.dg = getelementptr inbounds nuw i8, ptr %i.cs, i64 96 ; 2 uses
...
malloc_mutex_lock.exit:                           ; preds = %bb.p, %bb.q
  %i.dj = getelementptr inbounds nuw i8, ptr %i.cs, i64 168 ; 2 uses
  %i.dk = load i32, ptr %i.dj, align 8, !tbaa !26
  %.not20 = icmp eq i32 %i.dk, 0
  br i1 %.not20, label %bb.s, label %bb.r

bb.r:                                             ; preds = %malloc_mutex_lock.exit
  %i.dl = load i64, ptr @je_n_background_threads, align 8, !tbaa !21
  %i.dm = add i64 %i.dl, -1
  store i64 %i.dm, ptr @je_n_background_threads, align 8, !tbaa !21
  store i32 0, ptr %i.dj, align 8, !tbaa !26
  br label %bb.s

bb.s:                                             ; preds = %bb.r, %malloc_mutex_lock.exit
  %i.dn = getelementptr inbounds nuw i8, ptr %i.cs, i64 160
  store atomic i8 0, ptr %i.dn monotonic, align 8
  %i.do = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull %i.cx) #12 ; 0 uses
  br label %bb.t

bb.t:                                             ; preds = %bb.s, %bb.n
  %i.dp = add i32 %.142, 1                        ; 2 uses
  %i.dq = zext i32 %i.dp to i64                   ; 2 uses
  %i.dr = load i64, ptr @je_max_background_threads, align 8, !tbaa !21
  %i.ds = icmp ugt i64 %i.dr, %i.dq
  br i1 %i.ds, label %.lr.ph43, label %._crit_edge.loopexit, !llvm.loop !78
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader
  %i.dt = phi ptr [ %.pre, %._crit_edge.loopexit ], [ %i.ae, %.preheader ]
  %i.du = getelementptr inbounds nuw i8, ptr %i.dt, i64 168
  store i32 0, ptr %i.du, align 8, !tbaa !26
  ret void
}
...
bb.e:                                             ; preds = %._crit_edge
  %i.ad = call i64 @llvm.umax.i64(i64 %.023.lcssa, i64 100000000) ; 2 uses
...
.lr.ph.split:                                     ; preds = %.lr.ph, %bb.j
  %.02227 = phi i32 [ %i.bd, %bb.j ], [ %2, %.lr.ph ] ; 2 uses
  %.02326 = phi i64 [ %.2, %bb.j ], [ -1, %.lr.ph ] ; 4 uses
  %i.av = zext i32 %.02227 to i64
...
bb.h:                                             ; preds = %.lr.ph.split
  ...
  %i.ay = icmp ult i64 %.02326, 100000001
...
bb.i:                                             ; preds = %bb.h
  ...
  %spec.select = tail call i64 @llvm.umin.i64(i64 %i.ba, i64 %.02326)
  br label %bb.j
...
bb.j:                                             ; preds = %bb.h, %.lr.ph.split, %bb.i
  ...
  %i.bd = add i32 %.02227, %i.bc                  ; 2 uses
