...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec69 = and i64 %i.a, 8589934588             ; 3 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  store <4 x i8> zeroinitializer, ptr %i.l, align 4, !tbaa !38
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.w, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !74
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.ad, label %.lr.ph, label %.preheader35, !llvm.loop !75
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.as = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull %i.ar) #12, !inline_history !76 ; 0 uses
...
malloc_mutex_lock.exit26:                         ; preds = %bb.e, %bb.f
  ...
  %i.br = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull %i.bc) #12, !inline_history !76 ; 0 uses
...
pre_reentrancy.exit.i:                            ; preds = %bb.h, %bb.g
  ...
  %i.by = tail call fastcc i32 @background_thread_create_signals_masked(ptr noundef nonnull %i.bb, ptr noundef %i.bx), !inline_history !76 ; 2 uses
...
bb.k:                                             ; preds = %post_reentrancy.exit.i
  tail call void (ptr, ...) @je_malloc_printf(ptr noundef nonnull @.str.5, i32 noundef %i.by) #12, !inline_history !76
...
bb.m:                                             ; preds = %._crit_edge.i, %.lr.ph.i
  ...
  br i1 %i.cj, label %.lr.ph.i, label %check_background_thread_creation.exit.thread33, !llvm.loop !77
...
check_background_thread_creation.exit.thread33:   ; preds = %bb.m, %bb.c
  ...
  tail call fastcc void @malloc_mutex_lock(ptr noundef %0, ptr noundef nonnull %i.cl), !inline_history !76
...
check_background_thread_creation.exit:            ; preds = %bb.j, %bb.k
  ...
  tail call fastcc void @malloc_mutex_lock(ptr noundef nonnull %0, ptr noundef nonnull %i.cn), !inline_history !76
...
bb.t:                                             ; preds = %bb.s, %bb.n
  ...
  br i1 %i.ds, label %.lr.ph43, label %._crit_edge.loopexit, !llvm.loop !79
