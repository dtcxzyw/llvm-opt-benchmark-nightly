...
.tail.thread:                                     ; preds = %sub_0, %.tail
  ...
  %i.j = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.a, i64 noundef 1024, ptr noundef nonnull @.str.1, i32 noundef %i.f, i32 noundef %i.i) #15 ; 0 uses
  %i.k = load i64, ptr @epos, align 8, !tbaa !14
  %i.l = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @error, i64 noundef 1044, ptr noundef nonnull @.str.2, i64 noundef %i.k, ptr noundef nonnull %i.a) #15 ; 0 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.k = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.d, i64 noundef 1024, ptr noundef nonnull @.str.3, i32 noundef %i.i, i32 noundef %i.j) #15 ; 0 uses
  %i.l = load i64, ptr @epos, align 8, !tbaa !14
  %i.m = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @error, i64 noundef 1044, ptr noundef nonnull @.str.2, i64 noundef %i.l, ptr noundef nonnull %i.d) #15 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #15
  br label %consumeNewline.exit

bb.d:                                             ; preds = %bb.b
  %i.n = getelementptr inbounds nuw i8, ptr %i.b, i64 1
  %i.o = call i64 @__isoc23_strtol(ptr noundef nonnull %i.n, ptr noundef nonnull %i.c, i32 noundef 10) #15
...
.tail.thread.i:                                   ; preds = %bb.d
  ...
  %i.w = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.a, i64 noundef 1024, ptr noundef nonnull @.str.1, i32 noundef %i.u, i32 noundef %i.v) #15 ; 0 uses
  %i.x = load i64, ptr @epos, align 8, !tbaa !14
  %i.y = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @error, i64 noundef 1044, ptr noundef nonnull @.str.2, i64 noundef %i.x, ptr noundef nonnull %i.a) #15 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #15
  br label %consumeNewline.exit
...
bb.b:                                             ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #15
  %i.d = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.a, i64 noundef 1024, ptr noundef nonnull @.str.4, i64 noundef %2, i64 noundef %i.c) #15 ; 0 uses
  %i.e = load i64, ptr @epos, align 8, !tbaa !14
  %i.f = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @error, i64 noundef 1044, ptr noundef nonnull @.str.2, i64 noundef %i.e, ptr noundef nonnull %i.a) #15 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #15
  br label %bb.c
...
bb.c:                                             ; preds = %bb.b
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d) #15
  %i.g = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.d, i64 noundef 1024, ptr noundef nonnull @.str.5, i64 noundef %i.f) #15 ; 0 uses
  %i.h = load i64, ptr @epos, align 8, !tbaa !14
  %i.i = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @error, i64 noundef 1044, ptr noundef nonnull @.str.2, i64 noundef %i.h, ptr noundef nonnull %i.d) #15 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #15
  br label %bb.g

bb.d:                                             ; preds = %bb.b
  %i.j = add nuw nsw i64 %i.f, 2                  ; 4 uses
  %i.k = tail call noalias ptr @zmalloc(i64 noundef %i.j) #16 ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #15
  %i.n = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.b, i64 noundef 1024, ptr noundef nonnull @.str.4, i64 noundef %i.j, i64 noundef %i.m) #15 ; 0 uses
  %i.o = load i64, ptr @epos, align 8, !tbaa !14
  %i.p = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @error, i64 noundef 1044, ptr noundef nonnull @.str.2, i64 noundef %i.o, ptr noundef nonnull %i.b) #15 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #15
  %i.q = load ptr, ptr %1, align 8, !tbaa !18
  call void @zfree(ptr noundef %i.q) #15
  store ptr null, ptr %1, align 8, !tbaa !18
  br label %bb.g
...
readBytes.exit._crit_edge:                        ; preds = %readBytes.exit
  ...
  %i.z = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.a, i64 noundef 1024, ptr noundef nonnull @.str.1, i32 noundef %i.x, i32 noundef %i.y) #15 ; 0 uses
  %i.aa = load i64, ptr @epos, align 8, !tbaa !14
  %i.ab = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @error, i64 noundef 1044, ptr noundef nonnull @.str.2, i64 noundef %i.aa, ptr noundef nonnull %i.a) #15 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #15
  %i.ac = load ptr, ptr %1, align 8, !tbaa !18
  call void @zfree(ptr noundef %i.ac) #15
  store ptr null, ptr %1, align 8, !tbaa !18
  br label %bb.g
...
bb.b:                                             ; preds = %.lr.ph.preheader
  ...
  %i.i = tail call i32 @strcasecmp(ptr noundef %i.h, ptr noundef nonnull @.str.6) #17
  %i.j = icmp eq i32 %i.i, 0
  br i1 %i.j, label %bb.e, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.k = tail call i32 @strcasecmp(ptr noundef %i.h, ptr noundef nonnull @.str.8) #17
...
bb.f:                                             ; preds = %bb.e, %bb.d, %bb.c
  tail call void @zfree(ptr noundef %i.h) #15
...
bb.g:                                             ; preds = %bb.e
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #15
  %i.r = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.c, i64 noundef 1024, ptr noundef nonnull @.str.7, ptr noundef %1) #15 ; 0 uses
  %i.s = load i64, ptr @epos, align 8, !tbaa !14
  %i.t = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @error, i64 noundef 1044, ptr noundef nonnull @.str.2, i64 noundef %i.s, ptr noundef nonnull %i.c) #15 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #15
  br label %.loopexit.sink.split

bb.h:                                             ; preds = %bb.d
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d) #15
  %i.u = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.d, i64 noundef 1024, ptr noundef nonnull @.str.9, ptr noundef %1) #15 ; 0 uses
  %i.v = load i64, ptr @epos, align 8, !tbaa !14
  %i.w = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @error, i64 noundef 1044, ptr noundef nonnull @.str.2, i64 noundef %i.v, ptr noundef nonnull %i.d) #15 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #15
  br label %.loopexit.sink.split

bb.i:                                             ; preds = %.lr.ph
  %.pre33 = load ptr, ptr %i.b, align 8, !tbaa !18
  tail call void @zfree(ptr noundef %.pre33) #15
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %i.f
  br i1 %exitcond.not, label %.loopexit, label %.lr.ph, !llvm.loop !21

.loopexit.sink.split:                             ; preds = %bb.h, %bb.g
  call void @zfree(ptr noundef %i.h) #15
  br label %.loopexit
...
bb.d:                                             ; preds = %bb.c
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #15
  %i.h = tail call ptr @__errno_location() #19    ; 2 uses
  store i32 0, ptr %i.h, align 4, !tbaa !9
  %i.i = getelementptr inbounds nuw i8, ptr %i.a, i64 4
  %i.j = call i64 @__isoc23_strtol(ptr noundef nonnull %i.i, ptr noundef nonnull %i.b, i32 noundef 10) #15
...
bb.l:                                             ; preds = %bb.j
  %i.s = call i32 @fileno(ptr noundef %0) #15
  %i.t = load i64, ptr @epos, align 8, !tbaa !14
  %i.u = call i32 @ftruncate64(i32 noundef %i.s, i64 noundef %i.t) #15
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.l = tail call i32 @fileno(ptr noundef nonnull %i.f) #15
  %i.m = call i32 @fstat64(i32 noundef %i.l, ptr noundef nonnull %5) #15
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.v = call i32 @redis_check_rdb_main(i32 noundef 2, ptr noundef nonnull %i.c, ptr noundef nonnull %i.f) #15
...
bb.m:                                             ; preds = %bb.l
  %i.aa = call i32 @feof(ptr noundef nonnull %i.f) #15
...
bb.p:                                             ; preds = %bb.o
  %i.ae = tail call ptr @__errno_location() #19
...
.loopexit:                                        ; preds = %bb.t, %bb.m, %bb.u
  ...
  %i.ao = call i32 @feof(ptr noundef nonnull %i.f) #15
...
bb.v:                                             ; preds = %.loopexit
  ...
  %i.at = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @error, i64 noundef 1044, ptr noundef nonnull @.str.2, i64 noundef %i.as, ptr noundef nonnull %i.d) #15 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #15
...
bb.af:                                            ; preds = %bb.ae
  %i.bj = call i32 @strncasecmp(ptr noundef nonnull %i.e, ptr noundef nonnull @.str.32, i64 noundef 1) #17
...
bb.ah:                                            ; preds = %bb.af
  %i.bk = call i32 @fileno(ptr noundef nonnull %i.f) #15
  %i.bl = call i32 @ftruncate64(i32 noundef %i.bk, i64 noundef %.1) #15
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = tail call ptr @strerror(i32 noundef %i.e) #15
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.h = tail call i32 @fileno(ptr noundef nonnull %i.b) #15
  %i.i = call i32 @fstat64(i32 noundef %i.h, ptr noundef nonnull %1) #15
...
bb.i:                                             ; preds = %bb.h
  %bcmp = call i32 @bcmp(ptr noundef nonnull dereferenceable(5) %i.a, ptr noundef nonnull dereferenceable(5) @.str.39, i64 5)
...
bb.i:                                             ; preds = %bb.h
  %i.s = call i32 @feof(ptr noundef nonnull %i.b) #15
...
bb.a:
  ...
  %i.a = tail call ptr @aofLoadManifestFromFile(ptr noundef %1) #15 ; 3 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.j = tail call ptr @makePath(ptr noundef %0, ptr noundef %i.i) #15 ; 3 uses
  %i.k = icmp eq i32 %.1, 1
...
printAofStyle.exit:                               ; preds = %bb.e, %bb.f, %bb.g, %bb.h
  tail call void @sdsfree(ptr noundef %i.j) #15
...
bb.j:                                             ; preds = %bb.i
  ...
  call void @listRewind(ptr noundef %i.y, ptr noundef nonnull %3) #15
  %i.z = call ptr @listNext(ptr noundef nonnull %3) #15 ; 2 uses
...
begin_hunk_42
  ...
  %i.ae = call ptr @makePath(ptr noundef %0, ptr noundef %i.ad) #15 ; 2 uses
...
printAofStyle.exit49:                             ; preds = %bb.k, %bb.l, %bb.m, %bb.n
  call void @sdsfree(ptr noundef %i.ae) #15
  %i.ao = call ptr @listNext(ptr noundef nonnull %3) #15 ; 2 uses
...
bb.o:                                             ; preds = %._crit_edge, %bb.i
  call void @aofManifestFree(ptr noundef nonnull %i.a) #15
...
.tail.thread:                                     ; preds = %sub_1, %sub_0, %.tail
  %i.l = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %i.e, ptr noundef nonnull dereferenceable(10) @.str.57) #17
  %.not33 = icmp eq i32 %i.l, 0
  br i1 %.not33, label %bb.c, label %bb.k

bb.c:                                             ; preds = %.tail.thread, %.tail
  %i.m = tail call ptr @getVersion() #15          ; 2 uses
  %i.n = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.58, ptr noundef %i.m) ; 0 uses
  tail call void @sdsfree(ptr noundef %i.m) #15
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.q = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %i.p, ptr noundef nonnull dereferenceable(6) @.str.59) #17
...
bb.f:                                             ; preds = %bb.b
  ...
  %i.v = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %i.u, ptr noundef nonnull dereferenceable(24) @.str.60) #17
  %.not = icmp eq i32 %i.v, 0
  br i1 %.not, label %bb.g, label %bb.q

bb.g:                                             ; preds = %bb.f
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #15
  %i.w = tail call ptr @__errno_location() #19    ; 2 uses
  store i32 0, ptr %i.w, align 4, !tbaa !9
  %i.x = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.y = load ptr, ptr %i.x, align 8, !tbaa !18
  %i.z = call i64 @__isoc23_strtol(ptr noundef %i.y, ptr noundef nonnull %i.b, i32 noundef 10) #15
...
bb.k:                                             ; preds = %.tail.thread, %bb.j, %bb.e
  ...
  %i.af = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %.0) #17 ; 2 uses
...
bb.m:                                             ; preds = %bb.k
  ...
  %i.ai = call ptr @dirname(ptr noundef nonnull %i.a) #15
