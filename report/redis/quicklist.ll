...
begin_hunk_1_@quicklistRotate:bb.a
  ...
  %i.u = tail call ptr @lpSeek(ptr noundef %i.t, i64 noundef -1) #22 ; 3 uses
...
begin_hunk_2_@quicklistRotate:bb.a
  ...
  %i.ao = call ptr @lpSeek(ptr noundef %i.an, i64 noundef -1) #22 ; 2 uses
  store ptr %i.ao, ptr %i.a, align 8, !tbaa !36
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %bb.h
  %1 = phi ptr [ %i.ao, %bb.i ], [ %i.u, %bb.h ]
...
begin_hunk_3_@quicklistRotate:bb.a
  ...
  %i.ay = call ptr @lpDelete(ptr noundef %i.ax, ptr noundef %1, ptr noundef nonnull %i.a) #22 ; 2 uses
...
begin_hunk_5_@quicklistPopCustom:bb.a
  ...
  %i.ab = tail call ptr @lpSeek(ptr noundef %i.z, i64 noundef %i.aa) #22 ; 3 uses
