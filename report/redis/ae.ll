...
usUntilEarliestTimer.exit:                        ; preds = %bb.j
  ...
  %i.w = tail call i64 %i.v() #17, !inline_history !65
...
begin_hunk_1_@aeProcessEvents:bb.a
  ...
  %i.ax = load i32, ptr %i.au, align 1, !tbaa !52, !alias.scope !66
  %i.ay = load i32, ptr %i.aw, align 1, !tbaa !52, !alias.scope !66
...
begin_hunk_2_@aeProcessEvents:bb.a
  ...
  %i.bk = load i32, ptr %i.bi, align 1, !tbaa !48, !alias.scope !66
  %i.bl = load i32, ptr %i.bj, align 1, !tbaa !48, !alias.scope !66
  ...
  store <4 x i32> %interleaved.vec, ptr %i.bo, align 4, !tbaa !9, !alias.scope !69, !noalias !66
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.bp = icmp eq i64 %index.next, %n.vec
  br i1 %i.bp, label %scalar.ph.preheader, label %vector.body, !llvm.loop !71
...
begin_hunk_3_@aeProcessEvents:bb.a
  ...
  store i32 %i.bx, ptr %i.by, align 4, !tbaa !74
  %i.bz = getelementptr inbounds nuw i8, ptr %i.by, i64 4
  store i32 %.3.i, ptr %i.bz, align 4, !tbaa !76
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %aeApiPoll.exit, label %scalar.ph, !llvm.loop !77
...
begin_hunk_4_@aeProcessEvents:bb.a
  ...
  %i.cf = load ptr, ptr %i.ce, align 8, !tbaa !78 ; 2 uses
...
begin_hunk_5_@aeProcessEvents:bb.a
  ...
  %i.co = load i32, ptr %i.cn, align 4, !tbaa !74 ; 4 uses
  ...
  %i.ct = load i32, ptr %i.cs, align 4, !tbaa !76 ; 7 uses
...
.thread130:                                       ; preds = %bb.t, %.thread117, %bb.w, %bb.y, %bb.z, %bb.v
  ...
  br i1 %i.ee, label %bb.q, label %._crit_edge.loopexit, !llvm.loop !79
...
begin_hunk_7_@aeProcessEvents:bb.a
  ...
  %i.ek = tail call i64 %i.ej() #17, !inline_history !80
...
begin_hunk_8_@aeProcessEvents:bb.a
  ...
  br i1 %.not54.i, label %bb.ac, label %bb.ar, !llvm.loop !81
...
bb.ai:                                            ; preds = %bb.ah
  ...
  tail call void %i.ex(ptr noundef nonnull %0, ptr noundef %i.ez) #17, !inline_history !80
  %i.fa = load ptr, ptr @getMonotonicUs, align 8, !tbaa !56
  %i.fb = tail call i64 %i.fa() #17, !inline_history !80
  br label %bb.aj

bb.aj:                                            ; preds = %bb.ai, %bb.ah
  %.144.i = phi i64 [ %i.fb, %bb.ai ], [ %.04359.i, %bb.ah ]
  tail call void @zfree(ptr noundef nonnull %.04060.i) #17
  br label %bb.ar, !llvm.loop !81
...
begin_hunk_11_@aeProcessEvents:bb.a
  ...
  %i.fn = tail call i32 %i.fk(ptr noundef nonnull %0, i64 noundef %i.el, ptr noundef %i.fm) #17, !inline_history !80 ; 2 uses
  ...
  %i.fs = tail call i64 %i.fr() #17, !inline_history !80 ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  store i16 1, ptr %i.b, align 4, !tbaa !85
  br label %bb.c
...
bb.d:                                             ; preds = %bb.c
  ...
  store i16 %i.c, ptr %i.e, align 4, !tbaa !85
  br label %bb.e
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.j = load i16, ptr %i.i, align 2, !tbaa !86   ; 3 uses
  %i.k = and i16 %i.j, 1
  %i.l = lshr i16 %i.j, 1
  %i.m = and i16 %i.l, 2
end_hunk_14
begin_hunk_15_@aeMain:bb.a
  ...
  br i1 %.not, label %bb.b, label %bb.c, !llvm.loop !87
...
!69 = !{!70}
!70 = distinct !{!70, !68}
!71 = distinct !{!71, !35, !72, !73}
!72 = !{!"llvm.loop.isvectorized", i32 1}
!73 = !{!"llvm.loop.unroll.runtime.disable"}
!74 = !{!75, !10, i64 0}
!75 = !{!"aeFiredEvent", !10, i64 0, !10, i64 4}
!76 = !{!75, !10, i64 4}
!77 = distinct !{!77, !35, !72}
!78 = !{!14, !17, i64 72}
!79 = distinct !{!79, !35}
!80 = distinct !{null}
!81 = distinct !{!81, !35}
!82 = !{!83, !10, i64 0}
!83 = !{!"pollfd", !10, i64 0, !84, i64 4, !84, i64 6}
!84 = !{!"short", !11, i64 0}
!85 = !{!83, !84, i64 4}
!86 = !{!83, !84, i64 6}
!87 = distinct !{!87, !35}
