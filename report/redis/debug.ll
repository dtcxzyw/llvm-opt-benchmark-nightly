...
begin_hunk_1_@xorObjectDigest:bb.a
  ...
  %i.bg = call ptr @lpSeek(ptr noundef %i.bf, i64 noundef 0) #24 ; 3 uses
...
begin_hunk_2_@xorObjectDigest:bb.a
  ...
  br i1 %.not79, label %bb.n, label %.preheader, !prof !26

.preheader:                                       ; preds = %bb.m
  %33 = load ptr, ptr %i.n, align 8, !tbaa !24    ; 2 uses
  %.not80108 = icmp eq ptr %33, null
  br i1 %.not80108, label %._crit_edge110, label %.lr.ph109
...
bb.o:                                             ; preds = %.lr.ph109, %bb.r
  %i.bm = phi ptr [ %33, %.lr.ph109 ], [ %i.cs, %bb.r ]
...
._crit_edge110:                                   ; preds = %bb.r, %.preheader
