...
.lr.ph47:                                         ; preds = %bb.d
  %4 = shl nuw nsw i64 %i.a, 1
  br label %.lr.ph47.split

.lr.ph47.split.us:                                ; preds = %.lr.ph47.split.us.preheader, %bb.b
  %.146.us = phi ptr [ %i.n, %bb.b ], [ %0, %.lr.ph47.split.us.preheader ] ; 4 uses
  %.13145.us = phi i64 [ %i.o, %bb.b ], [ 0, %.lr.ph47.split.us.preheader ]
...
.lr.ph47.split:                                   ; preds = %.lr.ph47, %bb.h
  %.146 = phi ptr [ %i.ah, %bb.h ], [ %0, %.lr.ph47 ] ; 4 uses
  %.13145 = phi i64 [ %i.av, %bb.h ], [ 0, %.lr.ph47 ] ; 3 uses
