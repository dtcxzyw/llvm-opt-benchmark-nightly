...
.preheader:                                       ; preds = %bb.a
  %.not.a = icmp eq i64 %i.b, 0
  %i.e = sext i8 %4 to i32
  br i1 %.not.a, label %.split.us, label %.preheader.split.us
...
.lr.ph.us.us:                                     ; preds = %.preheader.split.us, %._crit_edge.split.us45.us
  ...
  %i.h = getelementptr inbounds nuw [8 x i8], ptr %i.g, i64 %i.a
  %i.i = and i64 %.041.us.us, 1
  %.not.us.us = icmp eq i64 %i.i, 0
  %i.j = select i1 %.not.us.us, i64 %2, i64 %3    ; 4 uses
  %i.k = shl i64 %i.j, 16
  %i.l = shl i64 %i.j, 32
  %i.m = shl i64 %i.j, 48
  %i.n = or i64 %i.l, %i.k
  ...
  %i.q = mul nuw nsw i64 %.041.us.us, %i.b
  br label %bb.b

bb.b:                                             ; preds = %.lr.ph.us.us, %bb.d
  %.03440.us42.us = phi ptr [ %i.h, %.lr.ph.us.us ], [ %i.s, %bb.d ] ; 2 uses
  %.03539.us43.us = phi ptr [ %i.g, %.lr.ph.us.us ], [ %i.r, %bb.d ] ; 2 uses
  %.03638.us44.us = phi i64 [ 0, %.lr.ph.us.us ], [ %i.ag, %bb.d ] ; 3 uses
  store i64 %i.p, ptr %.03440.us42.us, align 8, !tbaa !19
  store i64 %i.p, ptr %.03539.us43.us, align 8, !tbaa !19
  %i.r = getelementptr inbounds nuw i8, ptr %.03539.us43.us, i64 4096
  %i.s = getelementptr inbounds nuw i8, ptr %.03440.us42.us, i64 4096
  %i.t = and i64 %.03638.us44.us, 65535
  %i.u = icmp eq i64 %i.t, 0
  br i1 %i.u, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  %i.v = add nuw nsw i64 %.03638.us44.us, %i.q
  ...
  %.not.i.us.us = icmp eq i64 %i.y, %i.z
  br i1 %.not.i.us.us, label %memtest_progress_step.exit.us.us, label %.lr.ph.i.us.us

.lr.ph.i.us.us:                                   ; preds = %bb.c, %.lr.ph.i.us.us
  %.07.i.us.us = phi i64 [ %i.aa, %.lr.ph.i.us.us ], [ 0, %bb.c ]
  %putchar.i.us.us = tail call i32 @putchar(i32 %i.e) ; 0 uses
  %i.aa = add nuw i64 %.07.i.us.us, 1             ; 2 uses
  %i.ab = load i64, ptr @progress_printed, align 8, !tbaa !19
  %i.ac = sub i64 %i.y, %i.ab
  %i.ad = icmp ult i64 %i.aa, %i.ac
  br i1 %i.ad, label %.lr.ph.i.us.us, label %memtest_progress_step.exit.us.us, !llvm.loop !24
...
bb.d:                                             ; preds = %memtest_progress_step.exit.us.us, %bb.b
  %i.ag = add nuw nsw i64 %.03638.us44.us, 1      ; 2 uses
  %exitcond.not = icmp eq i64 %i.ag, %i.b
  br i1 %exitcond.not, label %._crit_edge.split.us45.us, label %bb.b, !llvm.loop !34

._crit_edge.split.us45.us:                        ; preds = %bb.d
  %i.ah = add nuw nsw i64 %.041.us.us, 1          ; 2 uses
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %._crit_edge.split.us.us
  ...
  %i.ak = and i64 %.041.us, 1
  %.not.us = icmp eq i64 %i.ak, 0
  %i.al = select i1 %.not.us, i64 %2, i64 %3      ; 4 uses
  ...
  br i1 %i.f, label %.epil.preheader, label %.lr.ph.us.new

.lr.ph.us.new:                                    ; preds = %.lr.ph.us, %.lr.ph.us.new
  %.03440.us.us = phi ptr [ %i.bh, %.lr.ph.us.new ], [ %i.aj, %.lr.ph.us ] ; 9 uses
  %.03539.us.us = phi ptr [ %i.bg, %.lr.ph.us.new ], [ %i.ai, %.lr.ph.us ] ; 9 uses
  %niter = phi i64 [ %niter.next.7, %.lr.ph.us.new ], [ 0, %.lr.ph.us ]
  store i64 %i.ar, ptr %.03440.us.us, align 8, !tbaa !19
  store i64 %i.ar, ptr %.03539.us.us, align 8, !tbaa !19
  %i.as = getelementptr inbounds nuw i8, ptr %.03539.us.us, i64 4096
  %i.at = getelementptr inbounds nuw i8, ptr %.03440.us.us, i64 4096
  store i64 %i.ar, ptr %i.at, align 8, !tbaa !19
  store i64 %i.ar, ptr %i.as, align 8, !tbaa !19
  %i.au = getelementptr inbounds nuw i8, ptr %.03539.us.us, i64 8192
  %i.av = getelementptr inbounds nuw i8, ptr %.03440.us.us, i64 8192
  store i64 %i.ar, ptr %i.av, align 8, !tbaa !19
  store i64 %i.ar, ptr %i.au, align 8, !tbaa !19
  %i.aw = getelementptr inbounds nuw i8, ptr %.03539.us.us, i64 12288
  %i.ax = getelementptr inbounds nuw i8, ptr %.03440.us.us, i64 12288
  store i64 %i.ar, ptr %i.ax, align 8, !tbaa !19
  store i64 %i.ar, ptr %i.aw, align 8, !tbaa !19
  %i.ay = getelementptr inbounds nuw i8, ptr %.03539.us.us, i64 16384
  %i.az = getelementptr inbounds nuw i8, ptr %.03440.us.us, i64 16384
  store i64 %i.ar, ptr %i.az, align 8, !tbaa !19
  store i64 %i.ar, ptr %i.ay, align 8, !tbaa !19
  %i.ba = getelementptr inbounds nuw i8, ptr %.03539.us.us, i64 20480
  %i.bb = getelementptr inbounds nuw i8, ptr %.03440.us.us, i64 20480
  store i64 %i.ar, ptr %i.bb, align 8, !tbaa !19
  store i64 %i.ar, ptr %i.ba, align 8, !tbaa !19
  %i.bc = getelementptr inbounds nuw i8, ptr %.03539.us.us, i64 24576
  %i.bd = getelementptr inbounds nuw i8, ptr %.03440.us.us, i64 24576
  store i64 %i.ar, ptr %i.bd, align 8, !tbaa !19
  store i64 %i.ar, ptr %i.bc, align 8, !tbaa !19
  %i.be = getelementptr inbounds nuw i8, ptr %.03539.us.us, i64 28672
  %i.bf = getelementptr inbounds nuw i8, ptr %.03440.us.us, i64 28672
  store i64 %i.ar, ptr %i.bf, align 8, !tbaa !19
  store i64 %i.ar, ptr %i.be, align 8, !tbaa !19
  %i.bg = getelementptr inbounds nuw i8, ptr %.03539.us.us, i64 32768 ; 2 uses
  %i.bh = getelementptr inbounds nuw i8, ptr %.03440.us.us, i64 32768 ; 2 uses
  %niter.next.7 = add i64 %niter, 8               ; 2 uses
  %niter.ncmp.7 = icmp eq i64 %niter.next.7, %unroll_iter
  br i1 %niter.ncmp.7, label %._crit_edge.split.us.us.unr-lcssa, label %.lr.ph.us.new, !llvm.loop !34

._crit_edge.split.us.us.unr-lcssa:                ; preds = %.lr.ph.us.new
  br i1 %lcmp.mod.not, label %._crit_edge.split.us.us, label %.epil.preheader

.epil.preheader:                                  ; preds = %._crit_edge.split.us.us.unr-lcssa, %.lr.ph.us
  %.03440.us.us.epil.init = phi ptr [ %i.aj, %.lr.ph.us ], [ %i.bh, %._crit_edge.split.us.us.unr-lcssa ]
  %.03539.us.us.epil.init = phi ptr [ %i.ai, %.lr.ph.us ], [ %i.bg, %._crit_edge.split.us.us.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod60)
  br label %bb.e

bb.e:                                             ; preds = %bb.e, %.epil.preheader
  %.03440.us.us.epil = phi ptr [ %.03440.us.us.epil.init, %.epil.preheader ], [ %i.bj, %bb.e ] ; 2 uses
  %.03539.us.us.epil = phi ptr [ %.03539.us.us.epil.init, %.epil.preheader ], [ %i.bi, %bb.e ] ; 2 uses
  %epil.iter = phi i64 [ 0, %.epil.preheader ], [ %epil.iter.next, %bb.e ]
  store i64 %i.ar, ptr %.03440.us.us.epil, align 8, !tbaa !19
  store i64 %i.ar, ptr %.03539.us.us.epil, align 8, !tbaa !19
  %i.bi = getelementptr inbounds nuw i8, ptr %.03539.us.us.epil, i64 4096
  %i.bj = getelementptr inbounds nuw i8, ptr %.03440.us.us.epil, i64 4096
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %._crit_edge.split.us.us, label %bb.e, !llvm.loop !36

._crit_edge.split.us.us:                          ; preds = %bb.e, %._crit_edge.split.us.us.unr-lcssa
