...
define internal range(i32 0, 2) i32 @expirySamplingShouldSkipDict(ptr nofree noundef readonly captures(none) %0, i32 noundef %1) #5 {
bb.a:
...
; Function Attrs: nounwind uwtable
define dso_local void @rememberSlaveKeyWithExpire(ptr nofree noundef readonly captures(none) %0, ptr noundef %1) local_unnamed_addr #0 {
bb.a:
...
; Function Attrs: nounwind uwtable
define dso_local range(i32 -1, 1) i32 @parseExtendedExpireArgumentsOrReply(ptr noundef %0, ptr nofree noundef captures(none) %1) local_unnamed_addr #0 {
bb.a:
