...
begin_hunk_0_@__redisAsyncCommand:bb.a
  %i.gv = phi ptr [ %i.gf, %.lr.ph.split.us.i.i ], [ %.pre.pre.i, %.dictFind.exit.loopexit32_crit_edge.i ], [ %i.gm, %bb.am ] ; 2 uses
  %.016.i.i = phi ptr [ %.022.us.i.i, %.lr.ph.split.us.i.i ], [ %.022.i.i, %.dictFind.exit.loopexit32_crit_edge.i ], [ %.022.i.i, %bb.am ]
  %.sroa.3.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %.016.i.i, i64 8 ; 2 uses
  %.sroa.3.0.copyload.i = load ptr, ptr %.sroa.3.0..sroa_idx.i, align 8, !tbaa !15
  %i.gw = getelementptr inbounds nuw i8, ptr %i.gv, i64 16
  %i.gx = load ptr, ptr %i.gw, align 8, !tbaa !170 ; 2 uses
  %.not.i98 = icmp eq ptr %i.gx, null
  br i1 %.not.i98, label %bb.ap, label %bb.ao

bb.ao:                                            ; preds = %dictFind.exit.i
  %i.gy = load ptr, ptr %i.ge, align 8, !tbaa !29
  %i.gz = call ptr %i.gx(ptr noundef %i.gy, ptr noundef nonnull %5) #16, !inline_history !172
  %.pre39.i = load ptr, ptr %i.ft, align 8, !tbaa !28
  br label %bb.ap

bb.ap:                                            ; preds = %bb.ao, %dictFind.exit.i
  %i.ha = phi ptr [ %.pre39.i, %bb.ao ], [ %i.gv, %dictFind.exit.i ]
  %storemerge.i = phi ptr [ %i.gz, %bb.ao ], [ %5, %dictFind.exit.i ]
  store ptr %storemerge.i, ptr %.sroa.3.0..sroa_idx.i, align 8, !tbaa !43
  %i.hb = getelementptr inbounds nuw i8, ptr %i.ha, i64 40
  %i.hc = load ptr, ptr %i.hb, align 8, !tbaa !42 ; 2 uses
  %.not20.i = icmp eq ptr %i.hc, null
  br i1 %.not20.i, label %.loopexit, label %bb.aq

bb.aq:                                            ; preds = %bb.ap
  %i.hd = load ptr, ptr %i.ge, align 8, !tbaa !29
  call void %i.hc(ptr noundef %i.hd, ptr noundef %.sroa.3.0.copyload.i) #16, !inline_history !172
  br label %.loopexit

dictReplace.exit:                                 ; preds = %bb.ah, %bb.ai
  %.sink.i.i = phi ptr [ %i.fq, %bb.ai ], [ %5, %bb.ah ]
  %i.he = getelementptr inbounds nuw i8, ptr %i.fa, i64 8
  store ptr %.sink.i.i, ptr %i.he, align 8, !tbaa !43
  %i.hf = getelementptr inbounds nuw i8, ptr %.066, i64 32 ; 2 uses
  %i.hg = load i64, ptr %i.hf, align 8, !tbaa !33
  %i.hh = add i64 %i.hg, 1
  store i64 %i.hh, ptr %i.hf, align 8, !tbaa !33
  br label %.backedge

.backedge:                                        ; preds = %dictReplace.exit, %.loopexit
  br label %bb.j

.loopexit:                                        ; preds = %bb.an, %bb.ak, %bb.ap, %bb.aq, %.loopexit.i, %bb.aj
  call void @hi_sdsfree(ptr noundef nonnull %i.aq) #16
  br label %.backedge

bb.ar:                                            ; preds = %bb.h, %bb.g
  %i.hi = tail call i32 @strncasecmp(ptr noundef nonnull %i.ab, ptr noundef nonnull @.str.15, i64 noundef 13) #19
  %i.hj = icmp eq i32 %i.hi, 0
  br i1 %i.hj, label %bb.as, label %bb.bo

bb.as:                                            ; preds = %bb.ar
  %i.hk = load i32, ptr %i.a, align 8, !tbaa !47
  %i.hl = and i32 %i.hk, 32
  %.not82 = icmp eq i32 %i.hl, 0
  br i1 %.not82, label %__redisAsyncCopyError.exit, label %bb.at

bb.at:                                            ; preds = %bb.as
  %.167.in.v = select i1 %i.z, i64 440, i64 432
  %.167.in = getelementptr inbounds nuw i8, ptr %0, i64 %.167.in.v
  %.167.a = load ptr, ptr %.167.in, align 8, !tbaa !128 ; 7 uses
  %i.hm = getelementptr inbounds nuw i8, ptr %.167.a, i64 16 ; 3 uses
  br i1 %i.s, label %.preheader, label %.preheader202.outer

.preheader:                                       ; preds = %bb.at
  %i.hn = getelementptr inbounds nuw i8, ptr %.167.a, i64 8 ; 3 uses
  %i.ho = getelementptr inbounds nuw i8, ptr %.167.a, i64 24
  %i.hp = getelementptr inbounds nuw i8, ptr %.167.a, i64 40
  %i.hq = getelementptr inbounds nuw i8, ptr %0, i64 448 ; 4 uses
  br label %bb.au

bb.au:                                            ; preds = %.preheader, %bb.bh
  %i.hr = phi i8 [ %.pre, %bb.bh ], [ 36, %.preheader ]
  %.165 = phi ptr [ %i.ia, %bb.bh ], [ %i.q, %.preheader ] ; 2 uses
  %.not.i100 = icmp eq i8 %i.hr, 36
  br i1 %.not.i100, label %bb.aw, label %bb.av

bb.av:                                            ; preds = %bb.au
  %i.hs = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %.165, i32 noundef 36) #19 ; 2 uses
  %i.ht = icmp eq ptr %i.hs, null
  br i1 %i.ht, label %nextArgument.exit95.thread, label %bb.aw

bb.aw:                                            ; preds = %bb.av, %bb.au
  %.0.i101 = phi ptr [ %i.hs, %bb.av ], [ %.165, %bb.au ] ; 2 uses
...
bb.ba:                                            ; preds = %bb.az
  ...
  %i.il = load ptr, ptr %.167.a, align 8, !tbaa !22
  %i.im = zext i32 %i.ik to i64
  %i.in = getelementptr inbounds nuw [8 x i8], ptr %i.il, i64 %i.im
  %.020.i106 = load ptr, ptr %i.in, align 8, !tbaa !34 ; 3 uses
  %.not21.i107 = icmp eq ptr %.020.i106, null
...
.lr.ph.split.us.i117:                             ; preds = %.lr.ph.i108, %bb.bb
  %.022.us.i118 = phi ptr [ %.0.us.i119, %bb.bb ], [ %.020.i106, %.lr.ph.i108 ] ; 3 uses
  %i.is = load ptr, ptr %.022.us.i118, align 8, !tbaa !40
  %i.it = icmp eq ptr %i.ib, %i.is
  br i1 %i.it, label %dictFind.exit121, label %bb.bb

bb.bb:                                            ; preds = %.lr.ph.split.us.i117
  %i.iu = getelementptr inbounds nuw i8, ptr %.022.us.i118, i64 16
  %.0.us.i119 = load ptr, ptr %i.iu, align 8, !tbaa !34 ; 2 uses
  %.not.us.i120 = icmp eq ptr %.0.us.i119, null
  br i1 %.not.us.i120, label %.loopexit195, label %.lr.ph.split.us.i117

.lr.ph.split.i109:                                ; preds = %.lr.ph.i108, %bb.be
  %.022.i110 = phi ptr [ %.0.i115, %bb.be ], [ %.020.i106, %.lr.ph.i108 ] ; 5 uses
...
bb.bc:                                            ; preds = %.lr.ph.split.i109
  ...
  %i.iz = load ptr, ptr %.022.i110, align 8, !tbaa !40
...
bb.bd:                                            ; preds = %.lr.ph.split.i109
  %i.jb = load ptr, ptr %.022.i110, align 8, !tbaa !40
  %i.jc = icmp eq ptr %i.ib, %i.jb
  br i1 %i.jc, label %dictFind.exit121, label %bb.be

bb.be:                                            ; preds = %bb.bd, %bb.bc
  %i.jd = getelementptr inbounds nuw i8, ptr %.022.i110, i64 16
  %.0.i115 = load ptr, ptr %i.jd, align 8, !tbaa !34 ; 2 uses
...
dictFind.exit121:                                 ; preds = %bb.bd, %bb.bc, %.lr.ph.split.us.i117
  %.016.i114 = phi ptr [ %.022.us.i118, %.lr.ph.split.us.i117 ], [ %.022.i110, %bb.bc ], [ %.022.i110, %bb.bd ]
  %i.je = getelementptr inbounds nuw i8, ptr %.016.i114, i64 8
...
bb.bj:                                            ; preds = %bb.bi
  %i.jq = load ptr, ptr %.167.a, align 8, !tbaa !22
...
.lr.ph.preheader:                                 ; preds = %.peel.next.i
  %i.jw = load ptr, ptr %.167.a, align 8, !tbaa !22
  br label %.lr.ph
