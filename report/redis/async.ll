...
begin_hunk_0_@redisProcessCallbacks:bb.a
  ...
  %.sroa.10.sroa.0.0.copyload = load <2 x i32>, ptr %.sroa.10.0..sroa_idx, align 8
  ...
  %i.cq = load ptr, ptr getelementptr inbounds nuw (i8, ptr @hiredisAllocFns, i64 32), align 8, !tbaa !44
end_hunk_0
begin_hunk_1_@redisProcessCallbacks:bb.a
  ...
  %.sroa.10.sroa.0.0.copyload86 = load <2 x i32>, ptr %.sroa.10.0..sroa_idx76, align 8
...
dictFind.exit.thread.i:                           ; preds = %bb.aq, %bb.an, %dictFind.exit.i, %bb.am, %bb.al, %bb.aj
  ...
  %.sroa.10.sroa.0.2 = phi <2 x i32> [ zeroinitializer, %bb.al ], [ zeroinitializer, %bb.am ], [ %.sroa.10.sroa.0.0.copyload86, %dictFind.exit.i ], [ zeroinitializer, %bb.aj ], [ zeroinitializer, %bb.an ], [ zeroinitializer, %bb.aq ]
...
begin_hunk_2_@redisProcessCallbacks:bb.a
  ...
  %.sroa.10.sroa.0.0.copyload87 = load <2 x i32>, ptr %.sroa.10.0..sroa_idx77, align 8
  ...
  %i.ke = load ptr, ptr getelementptr inbounds nuw (i8, ptr @hiredisAllocFns, i64 32), align 8, !tbaa !44
end_hunk_2
...
__redisGetSubscribeCallback.exit:                 ; preds = %bb.bz, %bb.bw, %__redisShiftCallback.exit.thread
  ...
  %.sroa.10.sroa.0.0 = phi <2 x i32> [ %.sroa.10.sroa.0.0.copyload, %__redisShiftCallback.exit.thread ], [ %.sroa.10.sroa.0.2, %bb.bw ], [ %.sroa.10.sroa.0.0.copyload87, %bb.bz ] ; 2 uses
...
__redisGetSubscribeCallback.exit.thread:          ; preds = %bb.ca, %.thread.i, %__redisGetSubscribeCallback.exit
  ...
  %.sroa.1079.0114 = phi ptr [ %.sroa.1079.0, %__redisGetSubscribeCallback.exit ], [ null, %.thread.i ], [ null, %bb.ca ]
  %.sroa.10.sroa.0.0112 = phi <2 x i32> [ %.sroa.10.sroa.0.0, %__redisGetSubscribeCallback.exit ], [ zeroinitializer, %.thread.i ], [ zeroinitializer, %bb.ca ]
  %i.ku = load ptr, ptr %i.o, align 8, !tbaa !120
  %i.kv = getelementptr inbounds nuw i8, ptr %i.ku, i64 200
  %i.kw = load ptr, ptr %i.kv, align 8, !tbaa !121
end_hunk_4
...
bb.cd:                                            ; preds = %bb.cc, %__redisGetSubscribeCallback.exit.thread
  ...
  %.sroa.1079.0113 = phi ptr [ %.sroa.1079.0, %bb.cc ], [ %.sroa.1079.0114, %__redisGetSubscribeCallback.exit.thread ]
  %.sroa.10.sroa.0.0111 = phi <2 x i32> [ %.sroa.10.sroa.0.0, %bb.cc ], [ %.sroa.10.sroa.0.0112, %__redisGetSubscribeCallback.exit.thread ]
...
begin_hunk_6_@redisProcessCallbacks:bb.a
  ...
  store <2 x i32> %.sroa.10.sroa.0.0111, ptr %.sroa.10.0..sroa_idx78, align 8
  %.sroa.1079.0..sroa_idx84 = getelementptr inbounds nuw i8, ptr %i.lc, i64 24
  store ptr %.sroa.1079.0113, ptr %.sroa.1079.0..sroa_idx84, align 8
  store ptr null, ptr %i.lc, align 8, !tbaa !84
  %i.le = load ptr, ptr %i.d, align 8, !tbaa !83
