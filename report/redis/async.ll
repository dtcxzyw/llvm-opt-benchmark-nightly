...
dictFind.exit.thread.i:                           ; preds = %bb.aq, %bb.an, %dictFind.exit.i, %bb.am, %bb.al, %bb.aj
  ...
  %.sroa.10.2 = phi i64 [ 0, %bb.al ], [ 0, %bb.am ], [ %i.gc, %dictFind.exit.i ], [ 0, %bb.aj ], [ 0, %bb.an ], [ 0, %bb.aq ]
...
__redisGetSubscribeCallback.exit:                 ; preds = %bb.bz, %bb.bw, %__redisShiftCallback.exit.thread
  ...
  %.sroa.10.0 = phi i64 [ %i.cq, %__redisShiftCallback.exit.thread ], [ %.sroa.10.2, %bb.bw ], [ %i.kg, %bb.bz ] ; 2 uses
...
__redisGetSubscribeCallback.exit.thread:          ; preds = %bb.ca, %.thread.i, %__redisGetSubscribeCallback.exit
  %i.kw = phi ptr [ %.pre144, %__redisGetSubscribeCallback.exit ], [ %i.q, %.thread.i ], [ %.pre143, %bb.ca ]
  %.sroa.1082.0114 = phi ptr [ %.sroa.1079.0, %__redisGetSubscribeCallback.exit ], [ null, %.thread.i ], [ null, %bb.ca ]
  %.sroa.10.0112 = phi i64 [ %.sroa.10.0, %__redisGetSubscribeCallback.exit ], [ 0, %.thread.i ], [ 0, %bb.ca ]
...
bb.cd:                                            ; preds = %bb.cc, %__redisGetSubscribeCallback.exit.thread
  %i.lc = phi i32 [ %i.ku, %bb.cc ], [ %.pre145, %__redisGetSubscribeCallback.exit.thread ]
  %.sroa.1082.0113 = phi ptr [ %.sroa.1079.0, %bb.cc ], [ %.sroa.1082.0114, %__redisGetSubscribeCallback.exit.thread ]
  %.sroa.10.0111 = phi i64 [ %.sroa.10.0, %bb.cc ], [ %.sroa.10.0112, %__redisGetSubscribeCallback.exit.thread ]
...
bb.cf:                                            ; preds = %bb.ce
  ...
  store i64 %.sroa.10.0111, ptr %.sroa.10.0..sroa_idx78, align 8
