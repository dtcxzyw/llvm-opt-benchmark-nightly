...
begin_hunk_0_@sendTrackingMessage:bb.a
  ...
  %i.az = tail call i32 %i.ay(ptr noundef nonnull %i.av, ptr noundef nonnull @sendReplyToClient, i32 noundef 0) #9, !inline_history !112 ; 0 uses
  br label %bb.aa
...
bb.e:                                             ; preds = %bb.d, %bb.c
  %i.j = load ptr, ptr %i.f, align 8, !tbaa !113
...
begin_hunk_3_@trackingInvalidateKey:bb.a
  ...
  br i1 %i.ae, label %bb.x, label %bb.m, !llvm.loop !115
...
bb.m:                                             ; preds = %bb.l
  ...
  br i1 %or.cond, label %bb.n, label %bb.x, !llvm.loop !115
...
begin_hunk_4_@trackingInvalidateKey:bb.a
  ...
  br i1 %or.cond33, label %bb.x, label %bb.o, !llvm.loop !115
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.ao = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 7904), align 8, !tbaa !116
...
bb.a:
  ...
  %i.a = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 7904), align 8, !tbaa !116 ; 2 uses
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 40
  %i.c = load i64, ptr %i.b, align 8, !tbaa !117
...
.lr.ph:                                           ; preds = %bb.b, %bb.r
  ...
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !119  ; 3 uses
  %i.k = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 1496), align 8, !tbaa !120 ; 4 uses
...
._crit_edge:                                      ; preds = %bb.r, %bb.b
  %i.az = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 7904), align 8, !tbaa !116
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.b = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 1440), align 8, !tbaa !122
...
.lr.ph:                                           ; preds = %bb.b, %bb.k
  ...
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !119  ; 4 uses
...
bb.c:                                             ; preds = %.lr.ph
  %i.j = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 1496), align 8, !tbaa !120
  %i.k = icmp eq ptr %i.f, %i.j
  br i1 %i.k, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  %i.l = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 7904), align 8, !tbaa !116
...
bb.k:                                             ; preds = %bb.d, %sdslen.exit, %.lr.ph
  ...
  br i1 %.not8, label %._crit_edge, label %.lr.ph, !llvm.loop !123
...
bb.d:                                             ; preds = %.lr.ph, %bb.d
  ...
  br i1 %.not, label %._crit_edge, label %bb.d, !llvm.loop !125
...
bb.f:                                             ; preds = %bb.g
  ...
  br i1 %i.x, label %bb.g, label %.split35.us37, !llvm.loop !126
...
begin_hunk_16_@trackingBuildBroadcastReply:bb.a
  ...
  br label %.outer.us, !llvm.loop !126
...
begin_hunk_17_@trackingBuildBroadcastReply:bb.a
  ...
  br i1 %.not28.us, label %.split.us, label %.split35.us, !llvm.loop !126
...
bb.c:                                             ; preds = %.lr.ph28, %bb.t
  %i.j = load ptr, ptr %i.h, align 8, !tbaa !113  ; 6 uses
  %i.k = load ptr, ptr %i.j, align 8, !tbaa !52
...
bb.s:                                             ; preds = %bb.f, %sdslen.exit, %sdslen.exit24
  ...
  br i1 %.not19, label %._crit_edge, label %bb.e, !llvm.loop !127
...
begin_hunk_20_@trackingBroadcastInvalidationMessages:bb.a
  ...
  br i1 %.not, label %._crit_edge29, label %bb.c, !llvm.loop !128
...
!116 = !{!56, !29, i64 7904}
!117 = !{!118, !18, i64 40}
!118 = !{!"list", !36, i64 0, !36, i64 8, !15, i64 16, !15, i64 24, !15, i64 32, !18, i64 40}
!119 = !{!38, !15, i64 16}
!120 = !{!56, !14, i64 1496}
!121 = distinct !{!121, !54}
!122 = !{!56, !29, i64 1440}
