...
begin_hunk_0_@raxRecursiveShow:bb.a
  ...
  %i.ap = tail call noundef i32 @putc(i32 noundef 10, ptr noundef %i.ao) ; 0 uses
  br label %bb.g

bb.g:                                             ; preds = %.lr.ph.us.us, %bb.g
  %.03443.us.us = phi i32 [ 0, %.lr.ph.us.us ], [ %i.as, %bb.g ]
  %i.aq = load ptr, ptr @stdout, align 8, !tbaa !56
  %i.ar = tail call noundef i32 @putc(i32 noundef 32, ptr noundef %i.aq) ; 0 uses
  %i.as = add nuw nsw i32 %.03443.us.us, 1        ; 2 uses
  %exitcond54.not = icmp eq i32 %i.as, %.0
  br i1 %exitcond54.not, label %._crit_edge.us.us, label %bb.g, !llvm.loop !58
...
.lr.ph47.split.us.split:                          ; preds = %.lr.ph47.split.us, %.lr.ph47.split.us.split
  ...
  %i.az = tail call noundef i32 @putc(i32 noundef 10, ptr noundef %i.ay) ; 0 uses
...
begin_hunk_3_@raxShow:bb.a
  ...
  %i.c = tail call noundef i32 @putc(i32 noundef 10, ptr noundef %i.b) ; 0 uses
  ret void
}
...
._crit_edge:                                      ; preds = %.lr.ph, %bb.b
  ...
  %i.ai = tail call noundef i32 @putc(i32 noundef 10, ptr noundef %i.ah) ; 0 uses
...
begin_hunk_5_@raxTouch:bb.a
  ...
  br i1 %exitcond.not, label %._crit_edge, label %.lr.ph.split.us, !llvm.loop !61
