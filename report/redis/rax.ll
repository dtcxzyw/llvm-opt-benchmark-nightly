...
bb.s:                                             ; preds = %.thread.i124, %bb.o
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr align 1 %i.bp, ptr nonnull readonly align 1 %i.at, i64 %spec.select121, i1 false)
...
bb.l:                                             ; preds = %.thread.i, %bb.h
  ...
  %i.bp = getelementptr inbounds nuw i8, ptr %i.bn, i64 %i.bo
  tail call void @llvm.memmove.p0.p0.i64(ptr align 1 %i.bp, ptr nonnull readonly align 1 %i.ba, i64 %i.bc, i1 false)
