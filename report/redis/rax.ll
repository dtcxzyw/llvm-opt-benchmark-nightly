...
bb.a:
  ...
  %.not3340 = icmp eq i32 %spec.select, 0
  br i1 %.not3340, label %select.unfold._crit_edge, label %select.unfold.preheader
...
select.unfold.preheader:                          ; preds = %bb.a
  ...
  %i.t = and i32 %.fr38, 3
  %.not39 = icmp eq i32 %i.t, 1
  %i.u = select i1 %.not39, i64 -12, i64 -4
  %i.v = getelementptr inbounds i8, ptr %i.s, i64 %i.u
  br label %select.unfold

select.unfold:                                    ; preds = %select.unfold.preheader, %select.unfold
  %.042 = phi i32 [ %i.w, %select.unfold ], [ %spec.select, %select.unfold.preheader ]
  %.02441 = phi ptr [ %i.x, %select.unfold ], [ %i.v, %select.unfold.preheader ] ; 2 uses
  %i.w = add nsw i32 %.042, -1                    ; 2 uses
  %.0.copyload = load ptr, ptr %.02441, align 8
  tail call void @raxRecursiveFree(ptr noundef %0, ptr noundef %.0.copyload, ptr noundef %2)
  %i.x = getelementptr inbounds i8, ptr %.02441, i64 -8
...
bb.a:
  ...
  %spec.select = select i1 %.not, i32 %i.d, i32 1 ; 2 uses
  %.not3542 = icmp eq i32 %spec.select, 0
  br i1 %.not3542, label %select.unfold._crit_edge, label %select.unfold.preheader
...
select.unfold.preheader:                          ; preds = %bb.a
  ...
  %i.s = getelementptr inbounds nuw i8, ptr %i.m, i64 %i.r
  %i.t = and i32 %.fr40, 3
  %.not41 = icmp eq i32 %i.t, 1
  %i.u = select i1 %.not41, i64 -12, i64 -4
  %i.v = getelementptr inbounds i8, ptr %i.s, i64 %i.u
  br label %select.unfold

select.unfold:                                    ; preds = %select.unfold.preheader, %select.unfold
  %.044 = phi i32 [ %i.w, %select.unfold ], [ %spec.select, %select.unfold.preheader ]
  %.02643 = phi ptr [ %i.x, %select.unfold ], [ %i.v, %select.unfold.preheader ] ; 2 uses
  %i.w = add nsw i32 %.044, -1                    ; 2 uses
  %.0.copyload = load ptr, ptr %.02643, align 8
