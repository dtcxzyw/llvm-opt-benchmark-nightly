...
begin_hunk_0_@raxAddChild:bb.a
  ...
  %i.e = load i32, ptr %1, align 4                ; 5 uses
  %i.f = and i32 %i.e, 4
...
begin_hunk_3_@raxRemoveChild:bb.a
  ...
  %3 = and i32 %i.au, -8
  %i.av = add i32 %3, -8                          ; 2 uses
  %4 = and i32 %i.au, 7                           ; 2 uses
  %5 = or disjoint i32 %i.av, %4
  store i32 %5, ptr %1, align 4
  %i.aw = lshr exact i32 %i.av, 3                 ; 2 uses
