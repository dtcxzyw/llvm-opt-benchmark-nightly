...
._crit_edge.thread:                               ; preds = %bb.k, %._crit_edge
  %.0233.lcssa404 = phi i1 [ %i.bb, %._crit_edge ], [ false, %bb.k ] ; 2 uses
  %.0236.lcssa403 = phi i1 [ %i.bc, %._crit_edge ], [ false, %bb.k ] ; 2 uses
  %.0242.lcssa402 = phi i32 [ %.2244.ph, %._crit_edge ], [ 0, %bb.k ] ; 2 uses
...
.preheader.preheader:                             ; preds = %bb.al
  ...
  %umax374 = call i64 @llvm.umax.i64(i64 %i.cy, i64 1)
  %i.dg = shl nuw nsw i64 %umax374, 2
  %i.dh = add i32 %i.cg, 1
  %umax381 = call i32 @llvm.umax.i32(i32 %i.dh, i32 1)
  %wide.trip.count382 = zext i32 %umax381 to i64
...
.preheader:                                       ; preds = %.preheader.preheader, %.split.us
  %indvars.iv378 = phi i64 [ 0, %.preheader.preheader ], [ %indvars.iv.next379, %.split.us ] ; 3 uses
  %i.di = icmp eq i64 %indvars.iv378, 0
  %i.dj = trunc nuw i64 %indvars.iv378 to i32     ; 2 uses
...
bb.an:                                            ; preds = %.split.us
  ...
  %i.du = getelementptr inbounds nuw [4 x i8], ptr %i.df, i64 %i.dt ; 3 uses
  %i.dv = load i32, ptr %i.du, align 4, !tbaa !9  ; 2 uses
...
.split.us:                                        ; preds = %bb.aq, %bb.am, %.preheader.split.us.preheader
  ...
  %exitcond383 = icmp eq i64 %indvars.iv.next379, %wide.trip.count382
  br i1 %exitcond383, label %bb.an, label %.preheader, !llvm.loop !119
...
bb.ar:                                            ; preds = %bb.an
  ...
  br i1 %.0236.lcssa403, label %bb.as, label %.thread298
...
.thread298:                                       ; preds = %bb.as, %bb.ar
  ...
  br i1 %i.fb, label %.lr.ph368, label %._crit_edge369

.lr.ph368:                                        ; preds = %.thread298
  %i.fc = icmp ne ptr %.0228, null
  %.old10.not = icmp eq ptr %.0228, null
  %i.fd = add nuw nsw i32 %.0242.lcssa402, 2
  %i.fe = zext nneg i32 %i.fd to i64
  %.not264 = icmp eq i32 %.0242.lcssa402, 0
  br label %bb.at
...
bb.az:                                            ; preds = %bb.ay
  ...
  br i1 %or.cond11, label %bb.bb, label %.thread326

bb.ba:                                            ; preds = %bb.ay
  br i1 %.old10.not, label %.thread326, label %bb.bb
...
._crit_edge369.loopexit:                          ; preds = %.thread326
  %i.gz = zext i32 %.2214 to i64
  br label %._crit_edge369

._crit_edge369:                                   ; preds = %._crit_edge369.loopexit, %.thread298
  %.0212.lcssa = phi i64 [ 0, %.thread298 ], [ %i.gz, %._crit_edge369.loopexit ]
  %.not261 = icmp eq ptr %.0228, null
  br i1 %.not261, label %._crit_edge369.thread, label %bb.be

bb.be:                                            ; preds = %._crit_edge369
  call void @addReplyBulkCString(ptr noundef %0, ptr noundef nonnull @.str.33) #10
  %1 = load i32, ptr %i.du, align 4, !tbaa !9
  %i.ha = zext i32 %1 to i64
...
._crit_edge369.thread:                            ; preds = %bb.an, %._crit_edge369
  %.0229300408431 = phi ptr [ %i.ex, %._crit_edge369 ], [ null, %bb.an ] ; 2 uses
  br i1 %.0233.lcssa404, label %bb.bf, label %bb.bg

bb.bf:                                            ; preds = %._crit_edge369.thread
  %2 = load i32, ptr %i.du, align 4, !tbaa !9
  %i.hb = zext i32 %2 to i64
  call void @addReplyLongLong(ptr noundef %0, i64 noundef %i.hb) #10
  br label %bb.bh

bb.bg:                                            ; preds = %._crit_edge369.thread
  call void @addReplyBulkSds(ptr noundef %0, ptr noundef %.0229300408431) #10
  br label %bb.bh

bb.bh:                                            ; preds = %bb.bf, %bb.bg, %bb.be
  %.1230 = phi ptr [ %i.ex, %bb.be ], [ %.0229300408431, %bb.bf ], [ null, %bb.bg ]
...
bb.bl:                                            ; preds = %.thread341, %bb.bj, %bb.bk
...
!49 = !{!"p2 omnipotent char", !24, i64 0}
!50 = !{!"p1 _ZTS11aeEventLoop", !19, i64 0}
!51 = !{!"connListener", !11, i64 0, !10, i64 64, !49, i64 72, !10, i64 80, !10, i64 84, !52, i64 88, !19, i64 96}
!52 = !{!"p1 _ZTS14ConnectionType", !19, i64 0}
!53 = !{!"p1 _ZTS6client", !19, i64 0}
!54 = !{!"pendingCommandPool", !32, i64 0, !10, i64 8, !10, i64 12, !10, i64 16}
!55 = !{!"double", !11, i64 0}
!56 = !{!"malloc_stats", !17, i64 0, !17, i64 8, !17, i64 16, !17, i64 24, !17, i64 32, !17, i64 40, !17, i64 48, !17, i64 56, !17, i64 64, !17, i64 72, !17, i64 80}
!57 = !{!"p1 _ZTS11hotkeyStats", !19, i64 0}
!58 = !{!"p1 double", !19, i64 0}
!59 = !{!"p1 _ZTS9saveparam", !19, i64 0}
!60 = !{!"p2 _ZTS10connection", !24, i64 0}
!61 = !{!"redisOpArray", !62, i64 0, !10, i64 8, !10, i64 12}
!62 = !{!"p1 _ZTS7redisOp", !19, i64 0}
!63 = !{!"p1 _ZTS11replBacklog", !19, i64 0}
!64 = !{!"replDataBuf", !29, i64 0, !17, i64 8, !17, i64 16, !17, i64 24, !17, i64 32, !17, i64 40}
!65 = !{!"p1 _ZTS8_kvstore", !19, i64 0}
!66 = !{!"p1 _ZTS12clusterState", !19, i64 0}
!67 = !{!"aclInfo", !14, i64 0, !14, i64 8, !14, i64 16, !14, i64 24, !14, i64 32}
!68 = !{!"redisTLSContextConfig", !22, i64 0, !22, i64 8, !22, i64 16, !22, i64 24, !22, i64 32, !22, i64 40, !10, i64 48, !22, i64 56, !22, i64 64, !22, i64 72, !22, i64 80, !22, i64 88, !22, i64 96, !10, i64 104, !10, i64 108, !10, i64 112, !10, i64 116}
!69 = !{!"p1 _ZTS14sentinelConfig", !19, i64 0}
!70 = !{!71, !10, i64 72}
!71 = !{!"redisDb", !65, i64 0, !65, i64 8, !72, i64 16, !34, i64 24, !34, i64 32, !34, i64 40, !34, i64 48, !34, i64 56, !34, i64 64, !10, i64 72, !14, i64 80, !17, i64 88}
!72 = !{!"p1 _ZTS7_estore", !19, i64 0}
!73 = !{!16, !28, i64 192}
end_hunk_0
