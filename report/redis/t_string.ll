...
.lr.ph:                                           ; preds = %bb.k, %bb.s
  ...
  %.0205354 = phi i32 [ %i.ay, %bb.s ], [ 3, %bb.k ] ; 5 uses
  %.0233353 = phi i32 [ %.2235.ph, %bb.s ], [ 0, %bb.k ] ; 4 uses
  %.0236352 = phi i32 [ %.2238.ph, %bb.s ], [ 0, %bb.k ] ; 4 uses
  %.0242351 = phi i32 [ %.2244.ph, %bb.s ], [ 0, %bb.k ] ; 4 uses
  %i.af = load ptr, ptr %i.d, align 8, !tbaa !15  ; 2 uses
  %i.ag = zext i32 %.0205354 to i64
  ...
  %.neg = add nuw i32 %.0205354, 1                ; 4 uses
...
bb.s:                                             ; preds = %bb.p, %bb.q, %bb.m, %bb.l, %.lr.ph
  %.2244.ph = phi i32 [ %.0242351, %bb.p ], [ %.0242351, %bb.q ], [ %.0242351, %.lr.ph ], [ %.0242351, %bb.l ], [ 1, %bb.m ] ; 2 uses
  %.2238.ph = phi i32 [ %.0236352, %bb.p ], [ %.0236352, %bb.q ], [ 1, %.lr.ph ], [ %.0236352, %bb.l ], [ %.0236352, %bb.m ] ; 2 uses
  %.2235.ph = phi i32 [ %.0233353, %bb.p ], [ %.0233353, %bb.q ], [ %.0233353, %.lr.ph ], [ 1, %bb.l ], [ %.0233353, %bb.m ] ; 2 uses
  %.2207.ph = phi i32 [ %.neg, %bb.p ], [ %.neg, %bb.q ], [ %.0205354, %.lr.ph ], [ %.0205354, %bb.l ], [ %.0205354, %bb.m ]
...
bb.at:                                            ; preds = %.lr.ph368, %.thread326
  ...
  %.0224361 = phi i32 [ %i.cg, %.lr.ph368 ], [ %.3227, %.thread326 ] ; 9 uses
...
bb.aw:                                            ; preds = %bb.av, %bb.au
  ...
  br i1 %cond.fr, label %.thread303, label %.thread326

.thread:                                          ; preds = %bb.av
  %i.fw = icmp eq i32 %.0224361, 0
  %i.fx = icmp eq i32 %.0218363, 0
  %or.cond9415 = select i1 %i.fw, i1 true, i1 %i.fx
  %cond.fr417 = freeze i1 %or.cond9415
  br i1 %cond.fr417, label %.thread303, label %.thread421
...
bb.ax:                                            ; preds = %bb.at
  ...
  br i1 %cond.fr302, label %.thread326, label %.thread303
...
.thread326:                                       ; preds = %bb.aw, %bb.ax, %bb.az, %bb.bd, %bb.ba
  ...
  %.3227 = phi i32 [ %.0224361, %bb.ax ], [ %i.cg, %bb.ba ], [ %i.cg, %bb.bd ], [ %i.cg, %bb.az ], [ %i.ff, %bb.aw ]
