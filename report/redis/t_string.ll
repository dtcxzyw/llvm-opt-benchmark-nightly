...
bb.at:                                            ; preds = %.lr.ph368, %.thread326
  %.0367 = phi i32 [ 0, %.lr.ph368 ], [ %.2214, %.thread326 ] ; 5 uses
  %.3366 = phi i32 [ %i.cg, %.lr.ph368 ], [ %.2325, %.thread326 ] ; 4 uses
  %.0212365 = phi i32 [ 0, %.lr.ph368 ], [ %.5323, %.thread326 ] ; 5 uses
  %.0215364 = phi i32 [ 0, %.lr.ph368 ], [ %.2217321, %.thread326 ] ; 7 uses
  %.0218363 = phi i32 [ 0, %.lr.ph368 ], [ %.2220319, %.thread326 ] ; 6 uses
  %.0221362 = phi i32 [ %i.cg, %.lr.ph368 ], [ %.3227, %.thread326 ] ; 8 uses
  %.0224361 = phi i32 [ %i.dv, %.lr.ph368 ], [ %.2223317, %.thread326 ] ; 3 uses
  %.0231360 = phi i32 [ %i.cu, %.lr.ph368 ], [ %.1232314, %.thread326 ] ; 4 uses
  %i.ff = add i32 %.3366, -1                      ; 11 uses
  %i.fg = zext i32 %i.ff to i64
  %i.fh = getelementptr inbounds nuw i8, ptr %i.y, i64 %i.fg
  %i.fi = load i8, ptr %i.fh, align 1, !tbaa !84  ; 2 uses
  %i.fj = add i32 %.0231360, -1                   ; 9 uses
...
bb.ax:                                            ; preds = %bb.at
  ...
  %.4 = select i1 %i.gj, i32 %.0231360, i32 %i.fj ; 2 uses
  %.1 = select i1 %i.gj, i32 %i.ff, i32 %.3366    ; 2 uses
  %.not262 = icmp eq i32 %.0221362, %i.cg
  br i1 %.not262, label %.thread326, label %.thread303

.thread303:                                       ; preds = %.thread, %bb.ax, %bb.aw
  %.1232.ph = phi i32 [ %.4, %bb.ax ], [ %i.fj, %bb.aw ], [ %i.fj, %.thread ]
  %.2226.ph = phi i32 [ %.0224361, %bb.ax ], [ %i.fo, %bb.aw ], [ %i.fo, %.thread ]
  %.2223.ph = phi i32 [ %.0221362, %bb.ax ], [ %i.ff, %bb.aw ], [ %.0221362, %.thread ] ; 2 uses
  %.2220.ph = phi i32 [ %.0218363, %bb.ax ], [ %.1218, %bb.aw ], [ %.0218363, %.thread ] ; 2 uses
  %.2217.ph = phi i32 [ %.0215364, %bb.ax ], [ %.1222, %bb.aw ], [ %.0215364, %.thread ]
  %.5.ph = phi i32 [ %.0212365, %bb.ax ], [ %.1216, %bb.aw ], [ %.0212365, %.thread ]
  %.2.ph = phi i32 [ %.1, %bb.ax ], [ %i.ff, %bb.aw ], [ %i.ff, %.thread ]
  %i.gk = sub i32 %.2220.ph, %.2223.ph
  br label %bb.ay

bb.ay:                                            ; preds = %.thread421, %.thread303
  %.in = phi i32 [ %i.gk, %.thread303 ], [ %i.fy, %.thread421 ]
  %.2324 = phi i32 [ %.2.ph, %.thread303 ], [ %i.ff, %.thread421 ] ; 3 uses
  %.5322 = phi i32 [ %.5.ph, %.thread303 ], [ %.0212365, %.thread421 ] ; 4 uses
  %.2217320 = phi i32 [ %.2217.ph, %.thread303 ], [ %.0215364, %.thread421 ] ; 4 uses
  %.2220318 = phi i32 [ %.2220.ph, %.thread303 ], [ %.0218363, %.thread421 ] ; 4 uses
  %.2223316 = phi i32 [ %.2223.ph, %.thread303 ], [ %.0221362, %.thread421 ]
  %.2226315 = phi i32 [ %.2226.ph, %.thread303 ], [ %i.fo, %.thread421 ] ; 3 uses
  %.1232313 = phi i32 [ %.1232.ph, %.thread303 ], [ %i.fj, %.thread421 ] ; 3 uses
...
.thread326:                                       ; preds = %bb.aw, %bb.ax, %bb.az, %bb.bd, %bb.ba
  ...
  %.5323 = phi i32 [ %.0212365, %bb.ax ], [ %.5322, %bb.ba ], [ %.5322, %bb.bd ], [ %.5322, %bb.az ], [ %.1216, %bb.aw ]
  %.2217321 = phi i32 [ %.0215364, %bb.ax ], [ %.2217320, %bb.ba ], [ %.2217320, %bb.bd ], [ %.2217320, %bb.az ], [ %.1222, %bb.aw ]
  %.2220319 = phi i32 [ %.0218363, %bb.ax ], [ %.2220318, %bb.ba ], [ %.2220318, %bb.bd ], [ %.2220318, %bb.az ], [ %.1218, %bb.aw ]
  %.2223317 = phi i32 [ %.0224361, %bb.ax ], [ %.2226315, %bb.ba ], [ %.2226315, %bb.bd ], [ %.2226315, %bb.az ], [ %i.fo, %bb.aw ]
  %.1232314 = phi i32 [ %.4, %bb.ax ], [ %.1232313, %bb.ba ], [ %.1232313, %bb.bd ], [ %.1232313, %bb.az ], [ %i.fj, %bb.aw ] ; 2 uses
  %.3227 = phi i32 [ %i.cg, %bb.ax ], [ %i.cg, %bb.ba ], [ %i.cg, %bb.bd ], [ %i.cg, %bb.az ], [ %i.ff, %bb.aw ]
  %.2214 = phi i32 [ %.0367, %bb.ax ], [ %.0367, %bb.ba ], [ %i.gv, %bb.bd ], [ %.0367, %bb.az ], [ %.0367, %bb.aw ] ; 2 uses
  %i.gw = icmp ne i32 %.2325, 0
  %i.gx = icmp ne i32 %.1232314, 0
