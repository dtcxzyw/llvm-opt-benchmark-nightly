...
begin_hunk_0_@_pqsort:bb.a
  ...
  %n.vec840 = and i64 %i.d, 2305843009213693948   ; 3 uses
  %i.h = shl nuw i64 %n.vec840, 3                 ; 2 uses
  %i.i = and i64 %i.d, 3
...
begin_hunk_1_@_pqsort:bb.a
  ...
  %n.vec766 = and i64 %i.d, 2305843009213693948   ; 3 uses
  %i.l = shl nuw i64 %n.vec766, 3                 ; 2 uses
  %i.m = and i64 %i.d, 3
...
begin_hunk_2_@_pqsort:bb.a
  ...
  %n.vec690 = and i64 %i.d, 2305843009213693948   ; 3 uses
  %i.p = shl nuw i64 %n.vec690, 3                 ; 2 uses
  %i.q = and i64 %i.d, 3
...
begin_hunk_3_@_pqsort:bb.a
  ...
  %n.vec616 = and i64 %i.d, 2305843009213693948   ; 3 uses
  %i.t = shl nuw i64 %n.vec616, 3                 ; 2 uses
  %i.u = and i64 %i.d, 3
...
begin_hunk_4_@_pqsort:bb.a
  ...
  %n.vec960 = and i64 %i.d, 2305843009213693948   ; 3 uses
  %i.aq = shl nuw i64 %n.vec960, 3                ; 2 uses
  %i.ar = and i64 %i.d, 3
...
vector.ph958:                                     ; preds = %vector.memcheck945
  %i.be = getelementptr i8, ptr %i.bb, i64 %i.aq
...
vector.body961:                                   ; preds = %vector.body961, %vector.ph958
  %index962 = phi i64 [ 0, %vector.ph958 ], [ %index.next971, %vector.body961 ] ; 2 uses
  %offset.idx963 = shl i64 %index962, 3           ; 2 uses
  %next.gep964 = getelementptr i8, ptr %i.bb, i64 %offset.idx963 ; 3 uses
  %next.gep966 = getelementptr i8, ptr %.0223363.us366.us, i64 %offset.idx963 ; 3 uses
...
vector.ph838:                                     ; preds = %vector.memcheck830
  %i.gf = getelementptr i8, ptr %.2227, i64 %i.h
  %i.gg = getelementptr i8, ptr %.0, i64 %i.h
  br label %vector.body841

vector.body841:                                   ; preds = %vector.body841, %vector.ph838
  %index842 = phi i64 [ 0, %vector.ph838 ], [ %index.next851, %vector.body841 ] ; 2 uses
  %offset.idx843 = shl i64 %index842, 3           ; 2 uses
  %next.gep844 = getelementptr i8, ptr %.2227, i64 %offset.idx843 ; 3 uses
  %next.gep846 = getelementptr i8, ptr %.0, i64 %offset.idx843 ; 3 uses
...
vector.ph764:                                     ; preds = %vector.memcheck754
  %i.jg = getelementptr i8, ptr %.1217340, i64 %i.l
  %i.jh = getelementptr i8, ptr %.1342, i64 %i.l
  br label %vector.body767

vector.body767:                                   ; preds = %vector.body767, %vector.ph764
  %index768 = phi i64 [ 0, %vector.ph764 ], [ %index.next777, %vector.body767 ] ; 2 uses
  %offset.idx769 = shl i64 %index768, 3           ; 2 uses
  %next.gep770 = getelementptr i8, ptr %.1217340, i64 %offset.idx769 ; 3 uses
  %next.gep772 = getelementptr i8, ptr %.1342, i64 %offset.idx769 ; 3 uses
...
vector.ph688:                                     ; preds = %vector.memcheck680
  %i.ma = getelementptr i8, ptr %.1221351, i64 %i.p
  %i.mb = getelementptr i8, ptr %.1219352, i64 %i.p
  br label %vector.body691

vector.body691:                                   ; preds = %vector.body691, %vector.ph688
  %index692 = phi i64 [ 0, %vector.ph688 ], [ %index.next701, %vector.body691 ] ; 2 uses
  %offset.idx693 = shl i64 %index692, 3           ; 2 uses
  %next.gep694 = getelementptr i8, ptr %.1221351, i64 %offset.idx693 ; 3 uses
  %next.gep696 = getelementptr i8, ptr %.1219352, i64 %offset.idx693 ; 3 uses
...
vector.ph614:                                     ; preds = %vector.memcheck606
  %i.or = getelementptr i8, ptr %.1219352, i64 %i.t
  %i.os = getelementptr i8, ptr %.1217.lcssa, i64 %i.t
  br label %vector.body617

vector.body617:                                   ; preds = %vector.body617, %vector.ph614
  %index618 = phi i64 [ 0, %vector.ph614 ], [ %index.next627, %vector.body617 ] ; 2 uses
  %offset.idx619 = shl i64 %index618, 3           ; 2 uses
  %next.gep620 = getelementptr i8, ptr %.1219352, i64 %offset.idx619 ; 3 uses
  %next.gep622 = getelementptr i8, ptr %.1217.lcssa, i64 %offset.idx619 ; 3 uses
...
vector.ph541:                                     ; preds = %vector.memcheck533
  %n.vec543 = and i64 %i.rm, 2305843009213693948  ; 3 uses
  %i.rp = shl nuw i64 %n.vec543, 3                ; 2 uses
  %i.rq = getelementptr i8, ptr %i.qu, i64 %i.rp
  %i.rr = getelementptr i8, ptr %.0, i64 %i.rp
  %i.rs = and i64 %i.rm, 3
  br label %vector.body544

vector.body544:                                   ; preds = %vector.body544, %vector.ph541
  %index545 = phi i64 [ 0, %vector.ph541 ], [ %index.next554, %vector.body544 ] ; 2 uses
  %offset.idx546 = shl i64 %index545, 3           ; 2 uses
  %next.gep547 = getelementptr i8, ptr %i.qu, i64 %offset.idx546 ; 3 uses
  %next.gep549 = getelementptr i8, ptr %.0, i64 %offset.idx546 ; 3 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.uk, 2305843009213693948     ; 3 uses
  %i.uo = shl nuw i64 %n.vec, 3                   ; 2 uses
  %i.up = getelementptr i8, ptr %i.ts, i64 %i.uo
  %i.uq = getelementptr i8, ptr %.1217.lcssa, i64 %i.uo
  %i.ur = and i64 %i.uk, 3
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep490 = getelementptr i8, ptr %.1217.lcssa, i64 %offset.idx ; 3 uses
