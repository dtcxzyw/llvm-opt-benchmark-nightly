...
.lr.ph.split.preheader:                           ; preds = %.lr.ph
  %i.ii = getelementptr i8, ptr %.0216, i64 %i.e
...
vector.memcheck754:                               ; preds = %.preheader386.preheader
  %scevgep755 = getelementptr i8, ptr %.1342, i64 %i.e
...
vector.memcheck680:                               ; preds = %.preheader384.preheader
  %scevgep682 = getelementptr i8, ptr %.1221351, i64 %i.e
...
vector.memcheck606:                               ; preds = %.preheader388.preheader
  %scevgep607 = getelementptr i8, ptr %.1217.lcssa, i64 %i.e
  %i.ou = mul i64 %2, %indvar
  %i.ov = sub i64 %i.e, %i.ou
