...
begin_hunk_0_@streamGetEdgeID:streamIteratorStart.exit
...
bb.b:                                             ; preds = %bb.a, %streamIteratorStart.exit
  call void @raxStop(ptr noundef nonnull %i.g) #19
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #19
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #19
end_hunk_0
begin_hunk_1_@streamTrim:bb.a
...
end_hunk_1
begin_hunk_2_@streamRewriteTrimArgument:bb.a
bb.a:
...
end_hunk_2
begin_hunk_3_@streamRewriteTrimArgument:bb.a
...
end_hunk_3
begin_hunk_4_@streamRewriteTrimArgument:bb.a
...
createObjectFromStreamID.exit:                    ; preds = %streamGetEdgeID.exit, %bb.e, %bb.f, %bb.g, %bb.h, %bb.i
  ...
  %i.ab = call ptr (ptr, ptr, ...) @sdscatfmt(ptr noundef nonnull %i.r, ptr noundef nonnull @.str.17, i64 noundef %i.y, i64 noundef %i.aa) #19
end_hunk_4
begin_hunk_5_@xdelCommand:bb.a
