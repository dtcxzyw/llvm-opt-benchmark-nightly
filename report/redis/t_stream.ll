...
end_hunk_0
begin_hunk_1_@streamIteratorGetField:bb.a
  br label %bb.d

bb.c:                                             ; preds = %bb.a
  %i.l = getelementptr inbounds nuw i8, ptr %0, i64 632 ; 3 uses
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !126
  %i.n = tail call ptr @lpGet(ptr noundef %i.m, ptr noundef %3, ptr noundef nonnull %i.d) #18
  store ptr %i.n, ptr %1, align 8, !tbaa !151
  %i.o = load ptr, ptr %i.e, align 8, !tbaa !128
  %i.p = load ptr, ptr %i.l, align 8, !tbaa !126
  %i.q = tail call ptr @lpNext(ptr noundef %i.o, ptr noundef %i.p) #18 ; 2 uses
  store ptr %i.q, ptr %i.l, align 8, !tbaa !126
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %i.r = phi ptr [ %i.q, %bb.c ], [ %.pre, %bb.b ]
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 632 ; 2 uses
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 669
  %i.u = tail call ptr @lpGet(ptr noundef %i.r, ptr noundef %4, ptr noundef nonnull %i.t) #18
  store ptr %i.u, ptr %2, align 8, !tbaa !151
  %i.v = getelementptr inbounds nuw i8, ptr %0, i64 616
  %i.w = load ptr, ptr %i.v, align 8, !tbaa !128
  %i.x = load ptr, ptr %i.s, align 8, !tbaa !126
  %i.y = tail call ptr @lpNext(ptr noundef %i.w, ptr noundef %i.x) #18
  store ptr %i.y, ptr %i.s, align 8, !tbaa !126
  ret void
}
...
bb.a:
  ...
  %2 = alloca %struct.streamID, align 8           ; 6 uses
  %3 = alloca %struct.streamID, align 8           ; 6 uses
  %i.h = load ptr, ptr %0, align 8, !tbaa !118    ; 6 uses
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 616 ; 2 uses
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !128  ; 2 uses
  %i.k = tail call i64 @lpBytes(ptr noundef %i.j) #18 ; 2 uses
  %i.l = getelementptr inbounds nuw i8, ptr %0, i64 640 ; 2 uses
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !137
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e) #18
  %i.n = call ptr @lpGet(ptr noundef %i.m, ptr noundef nonnull %i.e, ptr noundef null) #18 ; 2 uses
  %i.o = icmp eq ptr %i.n, null
  br i1 %i.o, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %i.p = load i64, ptr %i.e, align 8, !tbaa !13
  br label %lpGetIntegerIfValid.exit

bb.c:                                             ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f) #18
  store i64 0, ptr %i.f, align 8, !tbaa !21
  %i.q = load i64, ptr %i.e, align 8, !tbaa !13
  %i.r = call i32 @string2ll(ptr noundef nonnull %i.n, i64 noundef %i.q, ptr noundef nonnull %i.f) #18
  %.not11.i = icmp eq i32 %i.r, 0
  br i1 %.not11.i, label %bb.d, label %bb.e, !prof !63
...
lpGetIntegerIfValid.exit:                         ; preds = %bb.b, %bb.e
  %.0.i = phi i64 [ %i.p, %bb.b ], [ %i.s, %bb.e ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e) #18
  %i.t = or i64 %.0.i, 1
  %i.u = call ptr @lpReplaceInteger(ptr noundef %i.j, ptr noundef nonnull %i.l, i64 noundef %i.t) #18 ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.g) #18
  %i.v = call ptr @lpFirst(ptr noundef %i.u) #18  ; 2 uses
  store ptr %i.v, ptr %i.g, align 8, !tbaa !151
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #18
  %i.w = call ptr @lpGet(ptr noundef %i.v, ptr noundef nonnull %i.c, ptr noundef null) #18 ; 2 uses
  %i.x = icmp eq ptr %i.w, null
  br i1 %i.x, label %bb.f, label %bb.g

bb.f:                                             ; preds = %lpGetIntegerIfValid.exit
  %i.y = load i64, ptr %i.c, align 8, !tbaa !13
  br label %lpGetIntegerIfValid.exit44

bb.g:                                             ; preds = %lpGetIntegerIfValid.exit
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d) #18
  store i64 0, ptr %i.d, align 8, !tbaa !21
  %i.z = load i64, ptr %i.c, align 8, !tbaa !13
  %i.aa = call i32 @string2ll(ptr noundef nonnull %i.w, i64 noundef %i.z, ptr noundef nonnull %i.d) #18
  %.not11.i42 = icmp eq i32 %i.aa, 0
  br i1 %.not11.i42, label %bb.h, label %bb.i, !prof !63
...
lpGetIntegerIfValid.exit44:                       ; preds = %bb.f, %bb.i
  %.0.i43 = phi i64 [ %i.y, %bb.f ], [ %i.ab, %bb.i ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #18
  %i.ac = icmp eq i64 %.0.i43, 1
  br i1 %i.ac, label %bb.j, label %bb.k

bb.j:                                             ; preds = %lpGetIntegerIfValid.exit44
  %i.ad = getelementptr inbounds nuw i8, ptr %i.h, i64 72 ; 2 uses
  %i.ae = load i64, ptr %i.ad, align 8, !tbaa !15
  %i.af = sub i64 %i.ae, %i.k
  store i64 %i.af, ptr %i.ad, align 8, !tbaa !15
  call void @lpFree(ptr noundef %i.u) #18
  %i.ag = load ptr, ptr %i.h, align 8, !tbaa !20
  ...
  %i.al = call i32 @raxRemove(ptr noundef %i.ag, ptr noundef %i.ai, i64 noundef %i.ak, ptr noundef null) #18 ; 0 uses
  br label %bb.q

bb.k:                                             ; preds = %lpGetIntegerIfValid.exit44
  %i.am = add nsw i64 %.0.i43, -1
  %i.an = call ptr @lpReplaceInteger(ptr noundef %i.u, ptr noundef nonnull %i.g, i64 noundef %i.am) #18 ; 2 uses
  %i.ao = load ptr, ptr %i.g, align 8, !tbaa !151
  %i.ap = call ptr @lpNext(ptr noundef %i.an, ptr noundef %i.ao) #18 ; 2 uses
  store ptr %i.ap, ptr %i.g, align 8, !tbaa !151
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #18
  %i.aq = call ptr @lpGet(ptr noundef %i.ap, ptr noundef nonnull %i.a, ptr noundef null) #18 ; 2 uses
  %i.ar = icmp eq ptr %i.aq, null
  br i1 %i.ar, label %bb.l, label %bb.m

bb.l:                                             ; preds = %bb.k
  %i.as = load i64, ptr %i.a, align 8, !tbaa !13
  br label %lpGetIntegerIfValid.exit47

bb.m:                                             ; preds = %bb.k
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #18
  store i64 0, ptr %i.b, align 8, !tbaa !21
  %i.at = load i64, ptr %i.a, align 8, !tbaa !13
  %i.au = call i32 @string2ll(ptr noundef nonnull %i.aq, i64 noundef %i.at, ptr noundef nonnull %i.b) #18
  %.not11.i45 = icmp eq i32 %i.au, 0
  br i1 %.not11.i45, label %bb.n, label %bb.o, !prof !63
...
bb.o:                                             ; preds = %bb.m
  %i.av = load i64, ptr %i.b, align 8, !tbaa !21
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #18
  br label %lpGetIntegerIfValid.exit47

lpGetIntegerIfValid.exit47:                       ; preds = %bb.l, %bb.o
  %.0.i46 = phi i64 [ %i.as, %bb.l ], [ %i.av, %bb.o ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #18
  %i.aw = add nsw i64 %.0.i46, 1
  %i.ax = call ptr @lpReplaceInteger(ptr noundef %i.an, ptr noundef nonnull %i.g, i64 noundef %i.aw) #18 ; 3 uses
  %i.ay = getelementptr inbounds nuw i8, ptr %i.h, i64 72 ; 4 uses
  %i.az = load i64, ptr %i.ay, align 8, !tbaa !15
  %i.ba = sub i64 %i.az, %i.k
  store i64 %i.ba, ptr %i.ay, align 8, !tbaa !15
  %i.bb = call i64 @lpBytes(ptr noundef %i.ax) #18
  %i.bc = load i64, ptr %i.ay, align 8, !tbaa !15
  %i.bd = add i64 %i.bc, %i.bb
  store i64 %i.bd, ptr %i.ay, align 8, !tbaa !15
  %i.be = load ptr, ptr %i.i, align 8, !tbaa !128
  %.not = icmp eq ptr %i.be, %i.ax
  br i1 %.not, label %bb.q, label %bb.p

bb.p:                                             ; preds = %lpGetIntegerIfValid.exit47
  %i.bf = load ptr, ptr %i.h, align 8, !tbaa !20
  ...
  %i.bj = load i64, ptr %i.bi, align 8, !tbaa !129
  %i.bk = call i32 @raxInsert(ptr noundef %i.bf, ptr noundef %i.bh, i64 noundef %i.bj, ptr noundef %i.ax, ptr noundef null) #18 ; 0 uses
  br label %bb.q

bb.q:                                             ; preds = %lpGetIntegerIfValid.exit47, %bb.p, %bb.j
  %i.bl = getelementptr inbounds nuw i8, ptr %i.h, i64 8 ; 2 uses
  %i.bm = load i64, ptr %i.bl, align 8, !tbaa !48
  %i.bn = add i64 %i.bm, -1
  store i64 %i.bn, ptr %i.bl, align 8, !tbaa !48
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #18
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #18
  %i.bo = getelementptr inbounds nuw i8, ptr %0, i64 52 ; 2 uses
  %i.bp = load i32, ptr %i.bo, align 4, !tbaa !120
...
bb.r:                                             ; preds = %bb.q
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %1, i64 16, i1 false), !tbaa.struct !51
  br label %bb.t
...
bb.t:                                             ; preds = %bb.s, %bb.r
  ...
  %i.bz = load i32, ptr %i.bo, align 4, !tbaa !120
  call void @streamIteratorStart(ptr noundef nonnull %0, ptr noundef nonnull %i.h, ptr noundef nonnull %2, ptr noundef nonnull %3, i32 noundef %i.bz)
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #18
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #18
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g) #18
  ret void
...
bb.a:
  %2 = alloca %struct.streamIterator, align 8     ; 5 uses
  %3 = alloca %struct.streamID, align 8           ; 5 uses
  %i.a = alloca i64, align 8                      ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #18
  call void @streamIteratorStart(ptr noundef nonnull %2, ptr noundef %0, ptr noundef %1, ptr noundef %1, i32 noundef 0)
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #18
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #18
  %i.b = call i32 @streamIteratorGetID(ptr noundef nonnull %2, ptr noundef nonnull %3, ptr noundef nonnull %i.a)
  %i.c = getelementptr inbounds nuw i8, ptr %2, i64 128
  call void @raxStop(ptr noundef nonnull %i.c) #18
  %.not = icmp eq i32 %i.b, 0
  br i1 %.not, label %bb.d, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.d = load i64, ptr %1, align 8, !tbaa !50
  %i.e = load i64, ptr %3, align 8, !tbaa !50
  %or.cond.not = icmp eq i64 %i.d, %i.e
  br i1 %or.cond.not, label %bb.c, label %streamCompareID.exit.thread
...
bb.c:                                             ; preds = %bb.b
  ...
  %or.cond.not7 = icmp eq i64 %i.g, %i.i
  br i1 %or.cond.not7, label %bb.d, label %streamCompareID.exit.thread, !prof !169

streamCompareID.exit.thread:                      ; preds = %bb.b, %bb.c
  call void @_serverAssert(ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.1, i32 noundef 1585) #18
  call void @abort() #19
  unreachable

bb.d:                                             ; preds = %bb.c, %bb.a
  %.0 = phi i32 [ 0, %bb.a ], [ 1, %bb.c ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #18
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #18
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #18
  ret i32 %.0
...
bb.a:
  %2 = alloca %struct.streamIterator, align 8     ; 6 uses
  %3 = alloca %struct.streamID, align 8           ; 4 uses
  %i.a = alloca i64, align 8                      ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #18
  call void @streamIteratorStart(ptr noundef nonnull %2, ptr noundef %0, ptr noundef %1, ptr noundef %1, i32 noundef 0)
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #18
...
bb.b:                                             ; preds = %bb.a
  call void @streamIteratorRemoveEntry(ptr noundef nonnull %2, ptr noundef nonnull %3)
  br label %bb.c
...
bb.a:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.c, i8 -1, i64 16, i1 false)
  ...
  %i.f = getelementptr inbounds nuw i8, ptr %2, i64 128 ; 3 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.e, i8 -1, i64 16, i1 false)
  %i.g = load ptr, ptr %0, align 8, !tbaa !20
  call void @raxStart(ptr noundef nonnull %i.f, ptr noundef %i.g) #18
  %i.h = call i32 @raxSeek(ptr noundef nonnull %i.f, ptr noundef nonnull @.str.8, ptr noundef null, i64 noundef 0) #18 ; 0 uses
  store ptr %0, ptr %2, align 8, !tbaa !118
  %i.i = getelementptr inbounds nuw i8, ptr %2, i64 616
  ...
  store i32 1, ptr %i.j, align 4, !tbaa !120
  %i.k = getelementptr inbounds nuw i8, ptr %2, i64 56
  store i32 1, ptr %i.k, align 8, !tbaa !121
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #18
  %i.l = call i32 @streamIteratorGetID(ptr noundef nonnull %2, ptr noundef %1, ptr noundef nonnull %i.a)
...
bb.b:                                             ; preds = %bb.a
  ...
  %.not4 = icmp eq i64 %i.n, 0
  br i1 %.not4, label %bb.d, label %bb.c

bb.c:                                             ; preds = %bb.b
  call void (ptr, i32, ptr, ...) @_serverPanic(ptr noundef nonnull @.str.1, i32 noundef 1612, ptr noundef nonnull @.str.16, i64 noundef %i.n) #18
  call void @abort() #19
  unreachable

bb.d:                                             ; preds = %bb.b, %bb.a
  call void @raxStop(ptr noundef nonnull %i.f) #18
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #18
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #18
  ret void
}
...
bb.a:
  %i.a = load ptr, ptr @SDS_NOINIT, align 8, !tbaa !151
  %i.b = tail call ptr @sdsnewlen(ptr noundef %i.a, i64 noundef 44) #18 ; 6 uses
  %i.c = getelementptr i8, ptr %i.b, i64 -1       ; 2 uses
  %.val.i = load i8, ptr %i.c, align 1, !tbaa !69
  %i.d = and i8 %.val.i, 7
  switch i8 %i.d, label %sdssetlen.exit [
    i8 0, label %bb.b
    i8 1, label %bb.c
    i8 2, label %bb.d
    i8 3, label %bb.e
...
bb.c:                                             ; preds = %bb.a
  %i.e = getelementptr inbounds i8, ptr %i.b, i64 -3
  store i8 0, ptr %i.e, align 1, !tbaa !69
  br label %sdssetlen.exit

bb.d:                                             ; preds = %bb.a
  %i.f = getelementptr inbounds i8, ptr %i.b, i64 -5
  store i16 0, ptr %i.f, align 1, !tbaa !77
  br label %sdssetlen.exit

bb.e:                                             ; preds = %bb.a
  %i.g = getelementptr inbounds i8, ptr %i.b, i64 -9
  store i32 0, ptr %i.g, align 1, !tbaa !9
  br label %sdssetlen.exit

bb.f:                                             ; preds = %bb.a
  %i.h = getelementptr inbounds i8, ptr %i.b, i64 -17
  store i64 0, ptr %i.h, align 1, !tbaa !13
  br label %sdssetlen.exit

sdssetlen.exit:                                   ; preds = %bb.a, %bb.b, %bb.c, %bb.d, %bb.e, %bb.f
  %i.i = load i64, ptr %0, align 8, !tbaa !50
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.k = load i64, ptr %i.j, align 8, !tbaa !49
  %i.l = tail call ptr (ptr, ptr, ...) @sdscatfmt(ptr noundef nonnull %i.b, ptr noundef nonnull @.str.17, i64 noundef %i.i, i64 noundef %i.k) #18
  ret ptr %i.l
}
...
bb.a:
  ...
  %i.b = tail call ptr @sdsnewlen(ptr noundef %i.a, i64 noundef 44) #18 ; 6 uses
  %i.c = getelementptr i8, ptr %i.b, i64 -1       ; 2 uses
  %.val.i.i = load i8, ptr %i.c, align 1, !tbaa !69
  %i.d = and i8 %.val.i.i, 7
  switch i8 %i.d, label %createStreamIDString.exit [
    i8 0, label %bb.b
    i8 1, label %bb.c
end_hunk_1
begin_hunk_2_@streamPropagateGroupID:bb.a
...
end_hunk_2
begin_hunk_3_@xreadCommand:bb.a
...
bb.an:                                            ; preds = %bb.am
  ...
  %i.el = getelementptr i8, ptr %.pre663, i64 -1
...
bb.ap:                                            ; preds = %bb.an
  %i.ep = getelementptr inbounds i8, ptr %.pre663, i64 -3
  %i.eq = load i8, ptr %i.ep, align 1, !tbaa !69
  %i.er = zext i8 %i.eq to i64
  br label %streamLookupCG.exit

bb.aq:                                            ; preds = %bb.an
  %i.es = getelementptr inbounds i8, ptr %.pre663, i64 -5
  %i.et = load i16, ptr %i.es, align 1, !tbaa !77
  %i.eu = zext i16 %i.et to i64
  br label %streamLookupCG.exit

bb.ar:                                            ; preds = %bb.an
  %i.ev = getelementptr inbounds i8, ptr %.pre663, i64 -9
  %i.ew = load i32, ptr %i.ev, align 1, !tbaa !9
  %i.ex = zext i32 %i.ew to i64
  br label %streamLookupCG.exit

bb.as:                                            ; preds = %bb.an
  %i.ey = getelementptr inbounds i8, ptr %.pre663, i64 -17
...
streamLookupCG.exit:                              ; preds = %bb.an, %bb.ao, %bb.ap, %bb.aq, %bb.ar, %bb.as
  ...
  %i.fa = call i32 @raxFind(ptr noundef nonnull %i.ej, ptr noundef nonnull %.pre663, i64 noundef %.0.i.i, ptr noundef nonnull %i.d) #18 ; 0 uses
...
streamLookupCG.exit.thread:                       ; preds = %bb.am, %bb.al, %streamLookupCG.exit.streamLookupCG.exit.thread_crit_edge
  %i.fd = phi ptr [ %.pre, %streamLookupCG.exit.streamLookupCG.exit.thread_crit_edge ], [ %.pre663, %bb.al ], [ %.pre663, %bb.am ]
...
sub_0:                                            ; preds = %bb.at, %bb.ak
  ...
  switch i8 %i.fn, label %.tail521.thread [
    i8 36, label %.tail
    i8 43, label %.tail517
    i8 62, label %.tail521
  ]
...
.tail:                                            ; preds = %sub_0
  ...
  br i1 %i.fq, label %bb.au, label %.tail521.thread
...
.tail517:                                         ; preds = %sub_0
  ...
  br i1 %i.ga, label %bb.az, label %.tail521.thread
...
.tail521:                                         ; preds = %sub_0
  ...
  br i1 %i.gs, label %bb.bj, label %.tail521.thread
...
.tail521.thread:                                  ; preds = %sub_0, %.tail517, %.tail, %.tail521
...
bb.bm:                                            ; preds = %.lr.ph601, %streamDecrID.exit
  %indvars.iv655 = phi i64 [ 0, %.lr.ph601 ], [ %indvars.iv.next656, %streamDecrID.exit ] ; 7 uses
  %.0333599 = phi i64 [ 9223372036854775807, %.lr.ph601 ], [ %.5, %streamDecrID.exit ] ; 7 uses
  %.0338598 = phi ptr [ null, %.lr.ph601 ], [ %.3341, %streamDecrID.exit ] ; 4 uses
  %.0342597 = phi i64 [ 0, %.lr.ph601 ], [ %.2344, %streamDecrID.exit ] ; 5 uses
  %i.hb = load ptr, ptr %i.dh, align 8, !tbaa !174
  %i.hc = load ptr, ptr %i.i, align 8, !tbaa !204
  %i.hd = add nsw i64 %indvars.iv655, %i.dv       ; 8 uses
...
bb.bn:                                            ; preds = %bb.bm
  ...
  %i.hk = getelementptr inbounds nuw [16 x i8], ptr %.0309, i64 %indvars.iv655 ; 6 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #18
  ...
  store ptr %.0324587, ptr %i.di, align 8, !tbaa !199
...
bb.bp:                                            ; preds = %bb.bo
  %i.hp = getelementptr inbounds nuw [8 x i8], ptr %.0323, i64 %indvars.iv655
  %i.hq = load ptr, ptr %i.hp, align 8, !tbaa !234
  %i.hr = getelementptr inbounds nuw i8, ptr %i.hq, i64 32
  %.0310593 = load ptr, ptr %i.hr, align 8, !tbaa !166 ; 2 uses
  %.not382594 = icmp eq ptr %.0310593, null
  br i1 %.not382594, label %.loopexit, label %.lr.ph596

.lr.ph596:                                        ; preds = %bb.bp, %bb.bs
  %.0310595 = phi ptr [ %.0310, %bb.bs ], [ %.0310593, %bb.bp ] ; 5 uses
  %i.hs = getelementptr inbounds nuw i8, ptr %.0310595, i64 32 ; 3 uses
...
bb.br:                                            ; preds = %bb.bq
  %i.hw = getelementptr inbounds nuw i8, ptr %.0310595, i64 40
...
bb.bs:                                            ; preds = %.lr.ph596
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #18
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #18
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #18
  %i.hz = getelementptr inbounds nuw i8, ptr %.0310595, i64 56
  %.0310 = load ptr, ptr %i.hz, align 8, !tbaa !166 ; 2 uses
  %.not382 = icmp eq ptr %.0310, null
  br i1 %.not382, label %.loopexit, label %.lr.ph596, !llvm.loop !236

bb.bt:                                            ; preds = %bb.br
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #18
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #18
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #18
  %i.ia = load i64, ptr %.0310595, align 8, !tbaa !64
  %spec.select = call i64 @llvm.smin.i64(i64 %i.ia, i64 %.0333599)
  %i.ib = call i64 @commandTimeSnapshot() #18
  %i.ic = load i64, ptr %.0310595, align 8, !tbaa !64
...
bb.bw:                                            ; preds = %bb.bv
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #18
  %i.ik = getelementptr inbounds nuw [8 x i8], ptr %.0323, i64 %indvars.iv655
...
bb.ca:                                            ; preds = %.loopexit, %bb.bu, %bb.bv, %streamCompareID.exit
  ...
  %i.iv = getelementptr inbounds nuw [8 x i8], ptr %.0323, i64 %indvars.iv655 ; 2 uses
...
bb.cj:                                            ; preds = %bb.ci
  ...
  store ptr %.0324587, ptr %i.dp, align 8, !tbaa !144
...
bb.ck:                                            ; preds = %bb.bn
  ...
  br i1 %.not380, label %.thread476.thread.thread, label %bb.cl
...
bb.cn:                                            ; preds = %bb.cm
  ...
  %spec.select516 = zext i1 %i.lf to i32
  br label %streamCompareID.exit411

streamCompareID.exit411:                          ; preds = %bb.cn, %bb.cl, %bb.cm
  %i.lg = phi i32 [ 1, %bb.cl ], [ 0, %bb.cm ], [ %spec.select516, %bb.cn ]
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #18
  br label %.thread476.thread
...
bb.co:                                            ; preds = %streamLookupConsumer.exit, %bb.cj, %bb.ci
  ...
  br i1 %i.iu, label %.thread476, label %bb.cp
end_hunk_3
