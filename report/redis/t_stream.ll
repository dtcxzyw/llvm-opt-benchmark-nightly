...
bb.h:                                             ; preds = %._crit_edge163, %bb.d
  ...
  %.097 = phi i32 [ 3, %bb.d ], [ 5, %._crit_edge163 ] ; 2 uses
  %5 = zext nneg i32 %.097 to i64                 ; 3 uses
  %i.ag = getelementptr inbounds nuw [8 x i8], ptr %i.af, i64 %5
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %i.ao = getelementptr inbounds nuw [8 x i8], ptr %i.an, i64 %5
...
streamIncrID.exit.thread:                         ; preds = %streamIncrID.exit.thread.sink.split, %bb.l
  ...
  %i.ba = getelementptr inbounds nuw [8 x i8], ptr %i.az, i64 %5
...
streamDecrID.exit.thread:                         ; preds = %streamDecrID.exit.thread.sink.split, %bb.r
  %6 = add nuw nsw i32 %.097, 3                   ; 2 uses
...
bb.x:                                             ; preds = %streamDecrID.exit.thread
  ...
  %i.bo = getelementptr inbounds nuw [8 x i8], ptr %.pre164, i64 %7
