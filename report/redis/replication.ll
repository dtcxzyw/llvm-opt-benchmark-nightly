...
useDisklessLoad.exit:                             ; preds = %bb.b, %bb.c, %.thread.i, %bb.e, %bb.f, %bb.g, %bb.h, %.thread6.sink.split.i
  %i.o = phi i1 [ false, %bb.g ], [ true, %bb.b ], [ false, %bb.f ], [ true, %bb.c ], [ true, %bb.e ], [ true, %bb.h ], [ false, %.thread.i ], [ true, %.thread6.sink.split.i ] ; 3 uses
  %i.p = phi i1 [ true, %bb.g ], [ false, %bb.b ], [ true, %bb.f ], [ false, %bb.c ], [ false, %bb.e ], [ false, %bb.h ], [ true, %.thread.i ], [ false, %.thread6.sink.split.i ] ; 3 uses
...
bb.u:                                             ; preds = %bb.t
  %i.bd = select i1 %i.o, ptr @.str.132, ptr @.str.131
...
bb.w:                                             ; preds = %bb.v
  %i.bh = select i1 %i.o, ptr @.str.132, ptr @.str.131
...
bb.x:                                             ; preds = %useDisklessLoad.exit
  br i1 %i.p, label %bb.bf, label %bb.y
...
bb.bi:                                            ; preds = %bb.bh
  ...
  %or.cond6 = select i1 %i.p, i1 true, i1 %i.ek
...
bb.bl:                                            ; preds = %bb.bk, %bb.bh
  ...
  %or.cond4 = select i1 %i.o, i1 true, i1 %i.eo
...
bb.bp:                                            ; preds = %bb.bn, %bb.bo
  ...
  br i1 %i.p, label %bb.bq, label %bb.cy
