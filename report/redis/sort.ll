...
bb.bw:                                            ; preds = %.critedge540, %bb.bv
  ...
  %or.cond862.not = select i1 %.0408.lcssa, i1 true, i1 %i.lc
  br i1 %or.cond862.not, label %._crit_edge800, label %bb.bx
...
bb.fb:                                            ; preds = %bb.fa
  ...
  %sext746.a = shl i64 %.1398, 32
  %i.ts = ashr exact i64 %sext746.a, 32           ; 2 uses
...
._crit_edge737:                                   ; preds = %.lr.ph736, %.loopexit
  ...
  br i1 %or.cond742, label %._crit_edge741, label %.lr.ph740.split.preheader
...
._crit_edge741:                                   ; preds = %bb.fw, %._crit_edge737
