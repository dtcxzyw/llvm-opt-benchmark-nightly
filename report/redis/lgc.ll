...
.thread.i:                                        ; preds = %bb.d, %bb.c
  %.pr113.i = phi ptr [ %.pr.pre.i, %bb.d ], [ %i.k, %bb.c ] ; 2 uses
  %i.p = getelementptr inbounds nuw i8, ptr %.pr113.i, i64 10
...
bb.e:                                             ; preds = %.thread.i
  ...
  %i.u = tail call ptr @luaT_gettm(ptr noundef nonnull %.pr113.i, i32 noundef 3, ptr noundef %i.t) #6 ; 3 uses
...
.thread78.i:                                      ; preds = %bb.i, %bb.g, %bb.f, %bb.e, %.thread.i, %bb.d, %bb.b
  %.057.shrunk7683.i = phi i1 [ %i.ab, %bb.i ], [ false, %bb.b ], [ false, %.thread.i ], [ false, %bb.d ], [ false, %bb.e ], [ false, %bb.f ], [ false, %bb.g ]
