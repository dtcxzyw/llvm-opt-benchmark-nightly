...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %.not43, label %.split.us, label %thread-pre-split
...
thread-pre-split:                                 ; preds = %bb.e, %bb.h
  %.02849 = phi i32 [ %9, %bb.h ], [ 0, %bb.e ]   ; 2 uses
  %5 = phi ptr [ %.pr, %bb.h ], [ %i.k, %bb.e ]   ; 3 uses
  %6 = load i8, ptr %5, align 1, !tbaa !13
  %.not37.a = icmp eq i8 %6, -1
  br i1 %.not37.a, label %.critedge, label %.split

.split:                                           ; preds = %thread-pre-split
  %7 = call i32 @lpValidateNext(ptr noundef nonnull %0, ptr noundef nonnull %i.a, i64 noundef %1)
  %.not38 = icmp eq i32 %7, 0
  br i1 %.not38, label %.thread, label %bb.g

bb.g:                                             ; preds = %.split
  %8 = tail call i32 %3(ptr noundef nonnull %5, i32 noundef %i.j, ptr noundef %4) #22
  %.not42 = icmp eq i32 %8, 0
  br i1 %.not42, label %.thread, label %bb.h

bb.h:                                             ; preds = %bb.g
  %9 = add i32 %.02849, 1                         ; 2 uses
  %.pr = load ptr, ptr %i.a, align 8, !tbaa !19   ; 2 uses
  %.not44 = icmp eq ptr %.pr, null
  br i1 %.not44, label %.critedge, label %thread-pre-split, !llvm.loop !47

.critedge:                                        ; preds = %thread-pre-split, %bb.h, %.split.us, %thread-pre-split.us
  %.us-phi = phi ptr [ %i.l, %.split.us ], [ null, %thread-pre-split.us ], [ null, %bb.h ], [ %5, %thread-pre-split ]
  %.us-phi50 = phi i32 [ %.02849.us, %.split.us ], [ %i.o, %thread-pre-split.us ], [ %9, %bb.h ], [ %.02849, %thread-pre-split ]
...
.thread:                                          ; preds = %bb.g, %.split, %bb.f, %bb.i, %.critedge
  %.2 = phi i32 [ %spec.select, %bb.i ], [ 0, %.critedge ], [ 0, %bb.f ], [ 0, %.split ], [ 0, %bb.g ]
...
bb.au:                                            ; preds = %lpGetValue.exit43, %bb.ac
  ...
  br i1 %i.eh, label %bb.i, label %._crit_edge.loopexit, !llvm.loop !62
...
.backedge:                                        ; preds = %bb.g, %bb.h
  ...
  %i.y = and i1 %i.w, %i.x
  br i1 %i.y, label %bb.g, label %.loopexit, !llvm.loop !63
