begin_hunk_0
  ...
  br i1 %.not43, label %.split.us, label %.split.a
...
.split.a:                                         ; preds = %bb.e, %bb.j
  %.02849 = phi i32 [ %9, %bb.j ], [ 0, %bb.e ]   ; 2 uses
  %5 = phi ptr [ %.pr, %bb.j ], [ %i.k, %bb.e ]   ; 3 uses
  %6 = load i8, ptr %5, align 1, !tbaa !13
  %.not38.a = icmp eq i8 %6, -1
...
bb.h:                                             ; preds = %.split.a
  ...
  %.not42.a = icmp eq i32 %7, 0
  br i1 %.not42.a, label %.critedge46, label %bb.i

bb.i:                                             ; preds = %bb.h
  %8 = tail call i32 %3(ptr noundef nonnull %5, i32 noundef %i.j, ptr noundef %4) #23
...
bb.j:                                             ; preds = %bb.i
  ...
  br i1 %.not37, label %.critedge, label %.split.a, !llvm.loop !47

.critedge:                                        ; preds = %.split.a, %bb.j, %.split.us, %bb.g
  %.us-phi = phi ptr [ %i.l, %.split.us ], [ null, %bb.g ], [ null, %bb.j ], [ %5, %.split.a ]
  %.us-phi50 = phi i32 [ %.02849.us, %.split.us ], [ %i.o, %bb.g ], [ %9, %bb.j ], [ %.02849, %.split.a ]
