...
bb.bg:                                            ; preds = %bb.bf
  ...
  store float %i.ic, ptr %i.hz, align 4, !tbaa !84
...
define dso_local i32 @VDIM_RedisCommand(ptr noundef %0, ptr noundef readonly captures(none) %1, i32 noundef %2) #0 {
bb.a:
...
; Function Attrs: nounwind uwtable
define dso_local i32 @VCARD_RedisCommand(ptr noundef %0, ptr noundef readonly captures(none) %1, i32 noundef %2) #0 {
bb.a:
  %i.a = load ptr, ptr @RedisModule_AutoMemory, align 8, !tbaa !13
  tail call void %i.a(ptr noundef %0) #22
  %.not = icmp eq i32 %2, 2
