...
bb.a:
  ...
  %3 = icmp ne i32 %0, 0
  %or.cond = and i1 %2, %3
  br i1 %or.cond, label %.preheader.us, label %._crit_edge22.split

.preheader.us:                                    ; preds = %bb.a, %._crit_edge
  %.021.us = phi i32 [ %4, %._crit_edge ], [ 0, %bb.a ] ; 3 uses
...
._crit_edge:                                      ; preds = %bit_count.exit.us
  %4 = add nuw i32 %.021.us, 1                    ; 2 uses
  %exitcond24.not = icmp eq i32 %4, %1
  br i1 %exitcond24.not, label %._crit_edge22.split, label %.preheader.us, !llvm.loop !83
...
.lr.ph.i.us:                                      ; preds = %bb.b, %.lr.ph.i.us
  ...
  br i1 %.not.i.us, label %bit_count.exit.us.loopexit, label %.lr.ph.i.us, !llvm.loop !84
...
bit_count.exit.us:                                ; preds = %bit_count.exit.us.loopexit, %bb.b
  ...
  store float %.0.lcssa.i.us, ptr %i.v, align 4, !tbaa !85
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
