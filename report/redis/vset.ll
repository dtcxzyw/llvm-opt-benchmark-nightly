...
bb.b:                                             ; preds = %.preheader, %bit_count.exit
  ...
  %i.l = add i32 %i.j, %i.k
  %i.m = and i32 %.021, %i.k                      ; 2 uses
  %.not6.i = icmp eq i32 %i.m, 0
  br i1 %.not6.i, label %bit_count.exit, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %bb.b, %.lr.ph.i
  %.08.i = phi i32 [ %i.n, %.lr.ph.i ], [ 0, %bb.b ]
  %.057.i = phi i32 [ %i.o, %.lr.ph.i ], [ %i.m, %bb.b ] ; 2 uses
...
bit_count.exit:                                   ; preds = %bit_count.exit.loopexit, %bb.b
