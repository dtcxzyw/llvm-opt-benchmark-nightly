...
begin_hunk_1
  ...
  %i.i = call i64 @luaZ_read(ptr noundef %1, ptr noundef nonnull %i.b, i64 noundef 12) #6
  %.not.i.i = icmp eq i64 %i.i, 0
  br i1 %.not.i.i, label %LoadBlock.exit.i, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.j = call ptr (ptr, ptr, ...) @luaO_pushfstring(ptr noundef %0, ptr noundef nonnull @.str.5, ptr noundef nonnull %.str.1.sink, ptr noundef nonnull @.str.4) #6 ; 0 uses
  call void @luaD_throw(ptr noundef %0, i32 noundef 3) #6
  br label %LoadBlock.exit.i

LoadBlock.exit.i:                                 ; preds = %bb.e, %bb.d
  %5 = load i64, ptr %i.a, align 4
  %6 = load i64, ptr %i.b, align 1
  %7 = xor i64 %5, %6
  %8 = getelementptr i8, ptr %i.a, i64 8
  %9 = getelementptr i8, ptr %i.b, i64 8
...
bb.f:                                             ; preds = %LoadBlock.exit.i
  %i.k = call ptr (ptr, ptr, ...) @luaO_pushfstring(ptr noundef %0, ptr noundef nonnull @.str.5, ptr noundef nonnull %.str.1.sink, ptr noundef nonnull @.str.3) #6 ; 0 uses
  call void @luaD_throw(ptr noundef %0, i32 noundef 3) #6
...
LoadHeader.exit:                                  ; preds = %LoadBlock.exit.i, %bb.f
  ...
  %i.l = call ptr @luaS_newlstr(ptr noundef %0, ptr noundef nonnull @.str.2, i64 noundef 2) #6
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.o = tail call ptr (ptr, ptr, ...) @luaO_pushfstring(ptr noundef nonnull %i.h, ptr noundef nonnull @.str.5, ptr noundef %i.n, ptr noundef nonnull @.str.6) #6 ; 0 uses
  %i.p = load ptr, ptr %0, align 8, !tbaa !16
  tail call void @luaD_throw(ptr noundef %i.p, i32 noundef 3) #6
  %.pre = load ptr, ptr %0, align 8, !tbaa !16
  br label %bb.c

bb.c:                                             ; preds = %bb.b, %bb.a
  %i.q = phi ptr [ %.pre, %bb.b ], [ %i.h, %bb.a ]
  %i.r = tail call ptr @luaF_newproto(ptr noundef %i.q) #6 ; 30 uses
...
bb.d:                                             ; preds = %bb.c
  tail call void @luaD_growstack(ptr noundef nonnull %i.w, i32 noundef 1) #6
...
begin_hunk_4
  ...
  %i.as = call i64 @luaZ_read(ptr noundef %i.ar, ptr noundef nonnull %i.g, i64 noundef 1) #6
...
begin_hunk_5
  ...
  %i.aw = call ptr (ptr, ptr, ...) @luaO_pushfstring(ptr noundef %i.at, ptr noundef nonnull @.str.5, ptr noundef %i.av, ptr noundef nonnull @.str.4) #6 ; 0 uses
  %i.ax = load ptr, ptr %0, align 8, !tbaa !16
  call void @luaD_throw(ptr noundef %i.ax, i32 noundef 3) #6
...
bb.n:                                             ; preds = %LoadCode.exit
  ...
  %i.cx = call ptr @luaM_realloc_(ptr noundef %i.cu, ptr noundef null, i64 noundef 0, i64 noundef %i.cw) #6 ; 10 uses
...
.preheader56:                                     ; preds = %LoadCode.exit
  %i.dc = call ptr @luaM_toobig(ptr noundef %i.cu) #6
...
bb.r:                                             ; preds = %LoadChar.exit55
  ...
  %i.ej = call i64 @luaZ_read(ptr noundef %i.ei, ptr noundef nonnull %i.b, i64 noundef 1) #6
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.em = call ptr (ptr, ptr, ...) @luaO_pushfstring(ptr noundef %i.ek, ptr noundef nonnull @.str.5, ptr noundef %i.el, ptr noundef nonnull @.str.4) #6 ; 0 uses
  %i.en = load ptr, ptr %0, align 8, !tbaa !16
  call void @luaD_throw(ptr noundef %i.en, i32 noundef 3) #6
...
bb.t:                                             ; preds = %LoadChar.exit55
  ...
  %i.et = call i64 @luaZ_read(ptr noundef %i.es, ptr noundef nonnull %i.c, i64 noundef 8) #6
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.ew = call ptr (ptr, ptr, ...) @luaO_pushfstring(ptr noundef %i.eu, ptr noundef nonnull @.str.5, ptr noundef %i.ev, ptr noundef nonnull @.str.4) #6 ; 0 uses
  %i.ex = load ptr, ptr %0, align 8, !tbaa !16
  call void @luaD_throw(ptr noundef %i.ex, i32 noundef 3) #6
...
bb.w:                                             ; preds = %LoadChar.exit55
  ...
  %i.fe = call ptr (ptr, ptr, ...) @luaO_pushfstring(ptr noundef %i.fc, ptr noundef nonnull @.str.5, ptr noundef %i.fd, ptr noundef nonnull @.str.9) #6 ; 0 uses
  %i.ff = load ptr, ptr %0, align 8, !tbaa !16
  call void @luaD_throw(ptr noundef %i.ff, i32 noundef 3) #6
  br label %bb.x
...
bb.y:                                             ; preds = %._crit_edge
  ...
  %i.fl = call ptr @luaM_realloc_(ptr noundef %i.fi, ptr noundef null, i64 noundef 0, i64 noundef %i.fk) #6 ; 2 uses
...
.preheader:                                       ; preds = %._crit_edge
  %i.fp = call ptr @luaM_toobig(ptr noundef %i.fi) #6
...
bb.z:                                             ; preds = %LoadConstants.exit
  ...
  %i.gd = call ptr @luaM_realloc_(ptr noundef %i.ga, ptr noundef null, i64 noundef 0, i64 noundef %i.gc) #6
  br label %bb.ab

bb.aa:                                            ; preds = %LoadConstants.exit
  %i.ge = call ptr @luaM_toobig(ptr noundef %i.ga) #6
...
begin_hunk_21
  ...
  %i.gj = call i64 @luaZ_read(ptr noundef %i.gi, ptr noundef %i.gf, i64 noundef %.pre-phi81.i) #6
...
begin_hunk_22
  ...
  %i.gn = call ptr (ptr, ptr, ...) @luaO_pushfstring(ptr noundef %i.gk, ptr noundef nonnull @.str.5, ptr noundef %i.gm, ptr noundef nonnull @.str.4) #6 ; 0 uses
  %i.go = load ptr, ptr %0, align 8, !tbaa !16
  call void @luaD_throw(ptr noundef %i.go, i32 noundef 3) #6
  br label %LoadBlock.exit.i
...
bb.ad:                                            ; preds = %LoadBlock.exit.i
  ...
  %i.gu = call ptr @luaM_realloc_(ptr noundef %i.gr, ptr noundef null, i64 noundef 0, i64 noundef %i.gt) #6 ; 6 uses
...
.preheader56.i:                                   ; preds = %LoadBlock.exit.i
  %i.gz = call ptr @luaM_toobig(ptr noundef %i.gr) #6
...
bb.ae:                                            ; preds = %._crit_edge.i
  ...
  %i.ia = call ptr @luaM_realloc_(ptr noundef %i.hx, ptr noundef null, i64 noundef 0, i64 noundef %i.hz) #6 ; 2 uses
...
.preheader.i:                                     ; preds = %._crit_edge.i
  %i.ie = call ptr @luaM_toobig(ptr noundef %i.hx) #6
...
LoadDebug.exit:                                   ; preds = %.lr.ph64.i, %bb.ae, %.preheader.i
  %i.im = call i32 @luaG_checkcode(ptr noundef nonnull %i.r) #6
...
begin_hunk_28
  ...
  %i.iq = call ptr (ptr, ptr, ...) @luaO_pushfstring(ptr noundef %i.in, ptr noundef nonnull @.str.5, ptr noundef %i.ip, ptr noundef nonnull @.str.7) #6 ; 0 uses
  %i.ir = load ptr, ptr %0, align 8, !tbaa !16
  call void @luaD_throw(ptr noundef %i.ir, i32 noundef 3) #6
  br label %bb.ag
...
bb.a:
  ...
  %i.d = call i64 @luaZ_read(ptr noundef %i.c, ptr noundef nonnull %i.a, i64 noundef 8) #6
...
begin_hunk_30
  ...
  %i.h = call ptr (ptr, ptr, ...) @luaO_pushfstring(ptr noundef %i.e, ptr noundef nonnull @.str.5, ptr noundef %i.g, ptr noundef nonnull @.str.4) #6 ; 0 uses
  %i.i = load ptr, ptr %0, align 8, !tbaa !16
  call void @luaD_throw(ptr noundef %i.i, i32 noundef 3) #6
...
begin_hunk_31
  ...
  %i.o = call ptr @luaZ_openspace(ptr noundef %i.l, ptr noundef %i.n, i64 noundef %i.j) #6 ; 2 uses
  %i.p = load i64, ptr %i.a, align 8, !tbaa !77
  %i.q = load ptr, ptr %i.b, align 8, !tbaa !17
  %i.r = call i64 @luaZ_read(ptr noundef %i.q, ptr noundef %i.o, i64 noundef %i.p) #6
...
begin_hunk_32
  ...
  %i.v = call ptr (ptr, ptr, ...) @luaO_pushfstring(ptr noundef %i.s, ptr noundef nonnull @.str.5, ptr noundef %i.u, ptr noundef nonnull @.str.4) #6 ; 0 uses
  %i.w = load ptr, ptr %0, align 8, !tbaa !16
  call void @luaD_throw(ptr noundef %i.w, i32 noundef 3) #6
...
LoadBlock.exit10:                                 ; preds = %bb.c, %bb.d
  ...
  %i.z = add i64 %i.y, -1
  %i.aa = call ptr @luaS_newlstr(ptr noundef %i.x, ptr noundef %i.o, i64 noundef %i.z) #6
  br label %bb.e
...
bb.a:
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !17
  %i.d = call i64 @luaZ_read(ptr noundef %i.c, ptr noundef nonnull %i.a, i64 noundef 4) #6
  %.not.i = icmp eq i64 %i.d, 0
  br i1 %.not.i, label %LoadBlock.exit, label %bb.b
...
begin_hunk_35
  ...
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.n = load ptr, ptr %i.m, align 8, !tbaa !9
  %i.o = call ptr (ptr, ptr, ...) @luaO_pushfstring(ptr noundef %i.l, ptr noundef nonnull @.str.5, ptr noundef %i.n, ptr noundef nonnull @.str.8) #6 ; 0 uses
  %i.p = load ptr, ptr %0, align 8, !tbaa !16
  call void @luaD_throw(ptr noundef %i.p, i32 noundef 3) #6
