...
bb.e:                                             ; preds = %bb.d
  ...
  %i.v = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 8193, -2305843009213693952) %i.u, i1 true)
  %4 = sub nuw nsw i64 60, %i.v
  %notmask.i31 = shl nsw i64 -1, %4               ; 2 uses
  %5 = xor i64 %notmask.i31, -1
  %i.w = add nuw nsw i64 %i.j, %5
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ad = add i64 %i.ac, -1
  %i.ae = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 8193, -2305843009213693952) %i.ad, i1 true)
  %6 = sub nuw nsw i64 60, %i.ae
  %notmask.i = shl nsw i64 -1, %6                 ; 2 uses
  %7 = xor i64 %notmask.i, -1
  %i.af = add nuw nsw i64 %i.d, %7
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.v = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 8193, -2305843009213693952) %i.u, i1 true)
  %4 = sub nuw nsw i64 60, %i.v
  %notmask.i24 = shl nsw i64 -1, %4               ; 2 uses
  %5 = xor i64 %notmask.i24, -1
  %i.w = add nuw nsw i64 %i.j, %5
...
sz_s2u.exit20:                                    ; preds = %bb.g
  ...
  %i.ad = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 8193, -2305843009213693952) %i.ac, i1 true)
  %6 = sub nuw nsw i64 60, %i.ad
  %notmask.i = shl nsw i64 -1, %6                 ; 2 uses
  %7 = xor i64 %notmask.i, -1
  %i.ae = add nuw nsw i64 %i.c, %7
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.l = add i64 %i.k, -1
  %i.m = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 8193, -2305843009213693952) %i.l, i1 true)
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.ad = sub nuw nsw i64 60, %i.y                ; 2 uses
  %4 = shl nsw i64 -1, %i.ad
