...
bb.j:                                             ; preds = %bb.h, %bb.i
  %i.s = phi ptr [ %i.p, %bb.h ], [ %.pre, %bb.i ] ; 3 uses
...
bb.k:                                             ; preds = %bb.j
  call void (ptr, ...) @rdbCheckError(ptr noundef nonnull @.str.3, ptr noundef %i.s) #20
...
begin_hunk_4_@rdbSaveLen:bb.a
  ...
  %i.cn = call i64 @llvm.bswap.i64(i64 %1)
