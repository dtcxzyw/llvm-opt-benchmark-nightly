...
inline.NumDeleted: 5
begin_hunk_0_@connSocketAcceptHandler:bb.a
...
define internal range(i32 -1, 1) i32 @connSocketAddr(ptr nofree noundef captures(none) %0, ptr noundef %1, i64 noundef %2, ptr noundef %3, i32 noundef %4) #0 {
bb.a:
...
; Function Attrs: nounwind uwtable
define internal range(i32 -1, 2) i32 @connSocketIsLocal(ptr nofree noundef captures(none) %0) #0 {
bb.a:
...
; Function Attrs: nounwind uwtable
define internal noalias noundef ptr @connCreateAcceptedSocket(ptr noundef %0, i32 noundef %1, ptr nofree readnone captures(none) %2) #0 {
bb.a:
...
; Function Attrs: nounwind uwtable
define internal void @connSocketShutdown(ptr nofree noundef readonly captures(none) %0) #0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16
...
; Function Attrs: nounwind uwtable
define internal range(i32 -1, 1) i32 @connSocketAccept(ptr noundef %0, ptr nofree noundef readonly captures(address_is_null) %1) #0 {
bb.a:
...
define internal noundef i32 @connSocketWrite(ptr nofree noundef captures(none) %0, ptr nofree noundef readonly captures(none) %1, i64 noundef %2) #3 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.b = load i32, ptr %i.a, align 8, !tbaa !13
...
; Function Attrs: nounwind uwtable
define internal i32 @connSocketWritev(ptr nofree noundef captures(none) %0, ptr noundef %1, i32 noundef %2) #0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.b = load i32, ptr %i.a, align 8, !tbaa !13
...
; Function Attrs: nofree nounwind uwtable
define internal noundef i32 @connSocketRead(ptr nofree noundef captures(none) %0, ptr nofree noundef captures(none) %1, i64 noundef %2) #3 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.b = load i32, ptr %i.a, align 8, !tbaa !13
