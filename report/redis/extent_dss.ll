...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  br i1 %i.be, label %.thread116, label %bb.n
...
bb.n:                                             ; preds = %bb.m
  ...
  br i1 %i.bj, label %.thread117, label %.thread89

.thread116:                                       ; preds = %bb.m
  %i.bk = load i8, ptr %5, align 1, !tbaa !16, !range !14, !noundef !15
  %i.bl = trunc nuw i8 %i.bk to i1
  br i1 %i.bl, label %.thread117, label %.thread89
...
.thread117:                                       ; preds = %bb.n, %.thread116
  ...
  %i.br = select i1 %.not94, i64 0, i64 4096
...
.thread89:                                        ; preds = %bb.n, %.thread116, %bb.p, %bb.b, %bb.a, %.thread
  %.4 = phi ptr [ null, %bb.b ], [ null, %bb.a ], [ null, %.thread ], [ %i.ba, %bb.p ], [ %i.ba, %.thread116 ], [ %i.ba, %bb.n ]
  ret ptr %.4
}
