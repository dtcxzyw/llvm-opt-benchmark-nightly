...
define hidden ptr @je_extent_alloc_dss(ptr noundef %0, ptr noundef %1, ptr noundef readnone captures(address) %2, i64 noundef %3, i64 noundef %4, ptr noundef readonly captures(none) %5, ptr noundef captures(none) %6) local_unnamed_addr #2 {
bb.a:
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.aq = select i1 %.not.i82, i64 246423552, i64 17592432467968
  %i.ar = or disjoint i64 %i.aq, %.masked.i
  %i.as = or i64 %i.ar, %i.al
  store i64 %i.as, ptr %i.d, align 8, !tbaa !72
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.g
  %i.at = add i64 %i.ag, %3                       ; 2 uses
  %i.au = icmp ult i64 %i.ag, %i.ac
  %i.av = icmp ult i64 %i.at, %i.ac
...
atomic_store_p.exit:                              ; preds = %bb.j
  %i.ba = inttoptr i64 %i.ag to ptr               ; 6 uses
  %i.bb = inttoptr i64 %i.at to ptr
...
bb.k:                                             ; preds = %atomic_store_p.exit
  %i.bc = tail call ptr @je_arena_get_ehooks(ptr noundef %1) #6
  tail call void @je_extent_dalloc_gap(ptr noundef %0, ptr noundef nonnull %i.u, ptr noundef %i.bc, ptr noundef nonnull %i.d) #6
  br label %bb.m
...
bb.m:                                             ; preds = %bb.l, %bb.k
  %i.bd = load i8, ptr %6, align 1, !tbaa !16, !range !14, !noundef !15
  %i.be = trunc nuw i8 %i.bd to i1
  br i1 %i.be, label %.thread114, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.bf = tail call zeroext i1 @je_pages_decommit(ptr noundef %i.ba, i64 noundef %3) #6 ; 2 uses
  %i.bg = zext i1 %i.bf to i8
  store i8 %i.bg, ptr %6, align 1, !tbaa !16
  %i.bh = load i8, ptr %5, align 1, !tbaa !16, !range !14, !noundef !15
  %i.bi = trunc nuw i8 %i.bh to i1
  %i.bj = select i1 %i.bi, i1 %i.bf, i1 false
  br i1 %i.bj, label %.thread115, label %.thread89

.thread114:                                       ; preds = %bb.m
  %i.bk = load i8, ptr %5, align 1, !tbaa !16, !range !14, !noundef !15
  %i.bl = trunc nuw i8 %i.bk to i1
  br i1 %i.bl, label %.thread115, label %.thread89

.thread115:                                       ; preds = %bb.n, %.thread114
  ...
  %i.bn = tail call ptr @je_arena_get_ehooks(ptr noundef nonnull %1) #6
  %.val = load i32, ptr %i.t, align 8, !tbaa !18
  %.not93 = icmp eq i64 %3, 0
  %i.bo = getelementptr inbounds nuw i8, ptr %7, i64 8
  store ptr %i.ba, ptr %i.bo, align 8, !tbaa !74
  %i.bp = getelementptr inbounds nuw i8, ptr %7, i64 16
  store i64 %3, ptr %i.bp, align 8, !tbaa !75
  %i.bq = and i32 %.val, -268431361
  %.masked.i83 = zext i32 %i.bq to i64
  %i.br = select i1 %.not93, i64 0, i64 4096
  %i.bs = getelementptr inbounds nuw i8, ptr %7, i64 32
  store i64 235, ptr %i.bs, align 8, !tbaa !76
  %.not.i84 = icmp eq i8 %i.ab, 0
  %i.bt = select i1 %.not.i84, i64 8192, i64 17592186052608
  %i.bu = or disjoint i64 %i.bt, %i.br
  %i.bv = or disjoint i64 %i.bu, %.masked.i83
  store i64 %i.bv, ptr %7, align 8, !tbaa !72
  %i.bw = call zeroext i1 @je_extent_purge_forced_wrapper(ptr noundef %0, ptr noundef %i.bn, ptr noundef nonnull %7, i64 noundef 0, i64 noundef %3) #6
  br i1 %i.bw, label %bb.o, label %bb.p

bb.o:                                             ; preds = %.thread115
  call void @llvm.memset.p0.i64(ptr align 1 %i.ba, i8 0, i64 %3, i1 false)
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %.thread115
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #6
  br label %.thread89

bb.q:                                             ; preds = %bb.j
  %i.bx = icmp eq ptr %i.ay, inttoptr (i64 -1 to ptr)
...
.thread89:                                        ; preds = %bb.n, %.thread114, %bb.p, %bb.b, %bb.a, %.thread
  %.4 = phi ptr [ null, %bb.b ], [ null, %bb.a ], [ null, %.thread ], [ %i.ba, %bb.p ], [ %i.ba, %.thread114 ], [ %i.ba, %bb.n ]
  ret ptr %.4
}
