...
bb.a:
  ...
  %i.b = tail call zeroext i1 %i.a() #9, !inline_history !24
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.e, label %bb.c, label %decay_maybe_update_time.exit, !prof !25
...
begin_hunk_2_@je_decay_maybe_advance_epoch:bb.a
  ...
  br i1 %i.af, label %decay_backlog_npages_limit.exit, label %vector.body, !llvm.loop !27
...
decay_backlog_npages_limit.exit:                  ; preds = %vector.body
  ...
  store i64 %i.ah, ptr %i.ai, align 8, !tbaa !30
  %. = call i64 @llvm.umax.i64(i64 %i.ah, i64 %2)
  store i64 %., ptr %i.u, align 8, !tbaa !26
...
bb.h:                                             ; preds = %bb.g
  ...
  br i1 %exitcond.not.4, label %.loopexit, label %bb.c, !llvm.loop !31
...
begin_hunk_4_@je_decay_ns_until_purge:bb.a
  ...
  br i1 %i.ap, label %.preheader.i, label %vector.body, !llvm.loop !32
...
begin_hunk_5_@je_decay_ns_until_purge:bb.a
  ...
  br i1 %i.bj, label %decay_npurge_after_interval.exit64, label %vector.body110, !llvm.loop !33
...
begin_hunk_6_@je_decay_ns_until_purge:bb.a
  ...
  br i1 %i.cb, label %middle.block151, label %vector.body142, !llvm.loop !34
...
begin_hunk_7_@je_decay_ns_until_purge:bb.a
  ...
  br i1 %i.ct, label %middle.block135, label %vector.body123, !llvm.loop !35
...
begin_hunk_8_@je_decay_ns_until_purge:bb.a
  ...
  br i1 %exitcond.not.i67, label %.preheader.i68, label %scalar.ph137, !llvm.loop !36
...
begin_hunk_9_@je_decay_ns_until_purge:bb.a
  ...
  br i1 %exitcond26.not.i71, label %decay_npurge_after_interval.exit72, label %.lr.ph22.i, !llvm.loop !37
...
begin_hunk_10_@je_decay_ns_until_purge:bb.a
  ...
  br i1 %i.dt, label %.lr.ph.i, label %._crit_edge.loopexit, !llvm.loop !38
...
!30 = !{!17, !13, i64 160}
!31 = distinct !{!31, !15}
!32 = distinct !{!32, !15, !28, !29}
!33 = distinct !{!33, !15, !28, !29}
!34 = distinct !{!34, !15, !28, !29}
!35 = distinct !{!35, !15, !28, !29}
!36 = distinct !{!36, !15, !29, !28}
!37 = distinct !{!37, !15, !29, !28}
!38 = distinct !{!38, !15}
end_hunk_11
