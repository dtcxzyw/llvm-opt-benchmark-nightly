...
bb.d:                                             ; preds = %bb.c
  %i.j = shl nuw i64 %2, 1
  %i.k = add i64 %i.j, -1
  %i.l = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 0, -2305843009213693952) %i.k, i1 true) ; 2 uses
...
begin_hunk_1_@je_arena_extent_alloc_large:bb.a
  ...
  %i.at = add i64 %i.as, -1
  %i.au = call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 0, -2305843009213693952) %i.at, i1 true) ; 2 uses
  %i.av = trunc nuw nsw i64 %i.au to i32
  %i.aw = sub nuw nsw i64 60, %i.au               ; 2 uses
  %6 = shl nsw i64 -1, %i.aw
...
begin_hunk_2_@je_arena_extent_dalloc_large_prep:bb.a
  ...
  %i.g = add i64 %i.f, -1
  %i.h = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 0, -2305843009213693952) %i.g, i1 true) ; 2 uses
  %i.i = trunc nuw nsw i64 %i.h to i32
  %i.j = sub nuw nsw i64 60, %i.h                 ; 2 uses
  %3 = shl nsw i64 -1, %i.j
...
begin_hunk_4_@je_arena_extent_ralloc_large_shrink:bb.a
  ...
  %i.y = add i64 %i.x, -1
  %i.z = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 0, -2305843009213693952) %i.y, i1 true) ; 2 uses
  %i.aa = trunc nuw nsw i64 %i.z to i32
  %i.ab = sub nuw nsw i64 60, %i.z                ; 2 uses
  %5 = shl nsw i64 -1, %i.ab
...
sz_size2index_compute.exit:                       ; preds = %bb.b
  ...
  %i.k = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 0, -2305843009213693952) %i.j, i1 true) ; 2 uses
...
sz_s2u_compute.exit:                              ; preds = %bb.d
  %i.n = shl nuw i64 %3, 1
  %i.o = add i64 %i.n, -1
  %i.p = call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 0, -2305843009213693952) %i.o, i1 true)
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ad = add i64 %i.ac, -1
  %i.ae = call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 0, -2305843009213693952) %i.ad, i1 true)
...
sz_size2index_compute.exit:                       ; preds = %bb.j
  ...
  %i.aw = call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 0, -2305843009213693952) %i.av, i1 true) ; 2 uses
...
sz_size2index_compute.exit45:                     ; preds = %sz_size2index.exit33
  ...
  %i.bo = call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 0, -2305843009213693952) %i.bn, i1 true) ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  %i.m = shl nuw i64 %4, 1
  %i.n = add i64 %i.m, -1
  %i.o = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 0, -2305843009213693952) %i.n, i1 true)
  %11 = sub nuw nsw i64 60, %i.o
  %notmask.i65 = shl nsw i64 -1, %11              ; 2 uses
  %12 = xor i64 %notmask.i65, -1
...
sz_s2u_compute.exit:                              ; preds = %bb.g
  ...
  %i.ah = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 0, -2305843009213693952) %i.ag, i1 true)
  %13 = sub nuw nsw i64 60, %i.ah
  %notmask.i = shl nsw i64 -1, %13                ; 2 uses
  %14 = xor i64 %notmask.i, -1
  %i.ai = add nuw nsw i64 %i.w, %14
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.ap = add i64 %i.ao, -1
  %i.aq = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 0, -2305843009213693952) %i.ap, i1 true)
  %15 = sub nuw nsw i64 60, %i.aq
  %notmask.i62 = shl nsw i64 -1, %15              ; 2 uses
  %16 = xor i64 %notmask.i62, -1
  %i.ar = add nuw nsw i64 %4, %16
...
bb.v:                                             ; preds = %bb.u
  ...
  %i.bw = add i64 %i.bv, -1
  %i.bx = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 0, -2305843009213693952) %i.bw, i1 true) ; 2 uses
  %i.by = trunc nuw nsw i64 %i.bx to i32
  %i.bz = sub nuw nsw i64 60, %i.bx               ; 2 uses
  %17 = shl nsw i64 -1, %i.bz
  %i.ca = add nsw i64 %i.bb, -1
  %i.cb = and i64 %17, %i.ca
...
bb.am:                                            ; preds = %bb.al
  ...
  %i.eb = add i64 %i.ea, -1
  %i.ec = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 0, -2305843009213693952) %i.eb, i1 true)
  %18 = sub nuw nsw i64 60, %i.ec
  %notmask.i.i = shl nsw i64 -1, %18              ; 2 uses
  %19 = xor i64 %notmask.i.i, -1
  %i.ed = add nuw nsw i64 %i.bb, %19
...
sz_s2u_compute.exit32.i:                          ; preds = %bb.as
  ...
  %i.fb = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 0, -2305843009213693952) %i.fa, i1 true)
  %20 = sub nuw nsw i64 60, %i.fb
  %notmask.i30.i = shl nsw i64 -1, %20            ; 2 uses
  %21 = xor i64 %notmask.i30.i, -1
  %i.fc = add nuw nsw i64 %i.eq, %21
...
sz_s2u_compute.exit35.i:                          ; preds = %bb.av
  ...
  %i.fi = add i64 %i.fh, -1
  %i.fj = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 0, -2305843009213693952) %i.fi, i1 true)
  %22 = sub nuw nsw i64 60, %i.fj
  %notmask.i33.i = shl nsw i64 -1, %22            ; 2 uses
  %23 = xor i64 %notmask.i33.i, -1
  %i.fk = add nuw nsw i64 %i.bb, %23
...
bb.ba:                                            ; preds = %bb.az
  ...
  %i.gr = add i64 %i.gq, -1
  %i.gs = call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 0, -2305843009213693952) %i.gr, i1 true) ; 2 uses
  %i.gt = trunc nuw nsw i64 %i.gs to i32
  %i.gu = sub nuw nsw i64 60, %i.gs               ; 2 uses
  %24 = shl nsw i64 -1, %i.gu
  %i.gv = add nsw i64 %3, -1
  %i.gw = and i64 %24, %i.gv
...
bb.d:                                             ; preds = %bb.c
  %i.h = shl nuw i64 %2, 1
  %i.i = add i64 %i.h, -1
  %i.j = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 0, -2305843009213693952) %i.i, i1 true) ; 2 uses
