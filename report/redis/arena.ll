...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ee = getelementptr inbounds nuw [8 x i8], ptr @je_sz_index2size_tab, i64 %index ; 2 uses
  %i.ef = getelementptr inbounds nuw i8, ptr %i.ee, i64 16
  %wide.load190 = load <2 x i64>, ptr %i.ee, align 16, !tbaa !20, !alias.scope !161 ; 2 uses
  %wide.load191 = load <2 x i64>, ptr %i.ef, align 16, !tbaa !20, !alias.scope !161 ; 2 uses
  ...
  %i.em = mul <2 x i64> %wide.load190, %i.ek
  %i.en = mul <2 x i64> %wide.load191, %i.el
