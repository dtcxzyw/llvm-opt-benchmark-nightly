...
inline.NumDeleted: 9
begin_hunk_0_@pauseIOThreadsRange:bb.a
.lr.ph41.preheader:                               ; preds = %bb.j
  %i.j = zext nneg i32 %0 to i64                  ; 4 uses
  %i.k = add i32 %1, %0
  %i.l = and i32 %i.k, 1
  %lcmp.mod.not.not = icmp eq i32 %i.l, 0
  br i1 %lcmp.mod.not.not, label %.lr.ph41.prol, label %.lr.ph41.prol.loopexit

.lr.ph41.prol:                                    ; preds = %.lr.ph41.preheader
  %i.m = getelementptr inbounds nuw [4 x i8], ptr @PausedIOThreads, i64 %i.j
  %i.n = load i32, ptr %i.m, align 4, !tbaa !9
  %i.o = icmp sgt i32 %i.n, 1
  br i1 %i.o, label %.loopexit.prol, label %.preheader.prol

.preheader.prol:                                  ; preds = %.lr.ph41.prol
  %i.p = getelementptr inbounds nuw [128 x i8], ptr @IOThreads, i64 %i.j
  %i.q = getelementptr inbounds nuw i8, ptr %i.p, i64 16
  br label %bb.f

bb.f:                                             ; preds = %bb.f, %.preheader.prol
  %i.r = load atomic i32, ptr %i.q seq_cst, align 16
  %.not31.prol = icmp eq i32 %i.r, 2
  br i1 %.not31.prol, label %.loopexit.prol, label %bb.f, !llvm.loop !127

.loopexit.prol:                                   ; preds = %bb.f, %.lr.ph41.prol
...
.lr.ph41.prol.loopexit:                           ; preds = %.loopexit.prol, %.lr.ph41.preheader
  ...
  %i.s = icmp eq i32 %1, %0
  br i1 %i.s, label %.loopexit35, label %.lr.ph41

.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.j
  %indvars.iv = phi i64 [ %i.i, %.lr.ph.preheader ], [ %indvars.iv.next, %bb.j ] ; 4 uses
  %i.t = getelementptr inbounds nuw [4 x i8], ptr @PausedIOThreads, i64 %indvars.iv ; 2 uses
  %i.u = load i32, ptr %i.t, align 4, !tbaa !9    ; 2 uses
  %i.v = add nsw i32 %i.u, 1
  store i32 %i.v, ptr %i.t, align 4, !tbaa !9
  %i.w = icmp sgt i32 %i.u, 0
  br i1 %i.w, label %bb.j, label %bb.g

bb.g:                                             ; preds = %.lr.ph
  %i.x = getelementptr inbounds nuw [128 x i8], ptr @IOThreads, i64 %indvars.iv ; 2 uses
  %i.y = getelementptr inbounds nuw i8, ptr %i.x, i64 16 ; 2 uses
  %i.z = load atomic i32, ptr %i.y seq_cst, align 16
  %i.aa = icmp eq i32 %i.z, 0
  br i1 %i.aa, label %bb.i, label %bb.h, !prof !42
...
bb.i:                                             ; preds = %bb.g
  store atomic i32 1, ptr %i.y seq_cst, align 16
  %i.ab = getelementptr inbounds nuw i8, ptr %i.x, i64 48
  %i.ac = load ptr, ptr %i.ab, align 16, !tbaa !128
  %i.ad = tail call i32 @triggerEventNotifier(ptr noundef %i.ac) #15 ; 0 uses
  br label %bb.j

bb.j:                                             ; preds = %.lr.ph, %bb.i
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %i.ae = trunc nuw i64 %indvars.iv to i32
  %.not29.not = icmp sgt i32 %1, %i.ae
...
.lr.ph41:                                         ; preds = %.lr.ph41.prol.loopexit, %.loopexit.1
  ...
  %i.af = getelementptr inbounds nuw [4 x i8], ptr @PausedIOThreads, i64 %indvars.iv43
...
.preheader:                                       ; preds = %.lr.ph41
  %i.ai = getelementptr inbounds nuw [128 x i8], ptr @IOThreads, i64 %indvars.iv43
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 16
  br label %bb.k

bb.k:                                             ; preds = %.preheader, %bb.k
  %i.ak = load atomic i32, ptr %i.aj seq_cst, align 16
  %.not31 = icmp eq i32 %i.ak, 2
  br i1 %.not31, label %.loopexit, label %bb.k, !llvm.loop !127

.loopexit:                                        ; preds = %bb.k, %.lr.ph41
  %indvars.iv.next44 = add nuw nsw i64 %indvars.iv43, 1 ; 3 uses
  %i.al = getelementptr inbounds nuw [4 x i8], ptr @PausedIOThreads, i64 %indvars.iv.next44
  %i.am = load i32, ptr %i.al, align 4, !tbaa !9
  %i.an = icmp sgt i32 %i.am, 1
  br i1 %i.an, label %.loopexit.1, label %.preheader.1

.preheader.1:                                     ; preds = %.loopexit
  %i.ao = getelementptr inbounds nuw [128 x i8], ptr @IOThreads, i64 %indvars.iv.next44
  %i.ap = getelementptr inbounds nuw i8, ptr %i.ao, i64 16
  br label %bb.l

bb.l:                                             ; preds = %bb.l, %.preheader.1
  %i.aq = load atomic i32, ptr %i.ap seq_cst, align 16
  %.not31.1 = icmp eq i32 %i.aq, 2
  br i1 %.not31.1, label %.loopexit.1, label %bb.l, !llvm.loop !127

.loopexit.1:                                      ; preds = %bb.l, %.loopexit
  %indvars.iv.next44.1 = add nuw nsw i64 %indvars.iv43, 2
  %i.ar = trunc nuw i64 %indvars.iv.next44 to i32
  %.not30.not.1 = icmp sgt i32 %1, %i.ar
...
define dso_local void @handlePauseAndResume(ptr noundef captures(none) %0) local_unnamed_addr #7 {
bb.a:
...
; Function Attrs: nounwind uwtable
define dso_local i32 @prefetchIOThreadCommands(ptr noundef readonly captures(none) %0) local_unnamed_addr #0 {
bb.a:
...
end_hunk_0
begin_hunk_1_@processClientsFromMainThread:bb.a
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  tail call void @aeSetDontWait(ptr noundef %i.i, i32 noundef %spec.select) #15
  %i.j = getelementptr inbounds nuw i8, ptr %i.b, i64 16 ; 4 uses
  %i.k = load atomic i32, ptr %i.j seq_cst, align 16
  %i.l = icmp eq i32 %i.k, 1
  br i1 %i.l, label %bb.d, label %handlePauseAndResume.exit

bb.d:                                             ; preds = %bb.c
  store atomic i32 2, ptr %i.j seq_cst, align 16
  br label %bb.e

bb.e:                                             ; preds = %bb.e, %bb.d
  %i.m = load atomic i32, ptr %i.j seq_cst, align 16
  %.not.i = icmp eq i32 %i.m, 3
  br i1 %.not.i, label %bb.f, label %bb.e, !llvm.loop !133

bb.f:                                             ; preds = %bb.e
  store atomic i32 0, ptr %i.j seq_cst, align 16
  br label %handlePauseAndResume.exit

handlePauseAndResume.exit:                        ; preds = %bb.c, %bb.f
  %i.n = getelementptr inbounds nuw i8, ptr %i.b, i64 96 ; 2 uses
  %i.o = load ptr, ptr %i.n, align 32, !tbaa !94
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 40
  %i.q = load i64, ptr %i.p, align 8, !tbaa !97
  %i.r = icmp eq i64 %i.q, 0
  br i1 %i.r, label %sendPendingClientsToMainThreadIfNeeded.exit, label %bb.g

bb.g:                                             ; preds = %handlePauseAndResume.exit
  %i.s = load i8, ptr %i.b, align 64, !tbaa !99
  %i.t = zext i8 %i.s to i64
  %i.u = getelementptr inbounds nuw [40 x i8], ptr @mainThreadPendingClientsMutexes, i64 %i.t
  %i.v = tail call i32 @pthread_mutex_lock(ptr noundef nonnull %i.u) #15 ; 0 uses
  %i.w = load i8, ptr %i.b, align 64, !tbaa !99
  %i.x = zext i8 %i.w to i64
  %i.y = getelementptr inbounds nuw [8 x i8], ptr @mainThreadPendingClients, i64 %i.x
  %i.z = load ptr, ptr %i.y, align 8, !tbaa !100  ; 2 uses
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 40
  %i.ab = load i64, ptr %i.aa, align 8, !tbaa !97
  %i.ac = load ptr, ptr %i.n, align 32, !tbaa !94
  tail call void @listJoin(ptr noundef %i.z, ptr noundef %i.ac) #15
  %i.ad = load i8, ptr %i.b, align 64, !tbaa !99
  %i.ae = zext i8 %i.ad to i64
  %i.af = getelementptr inbounds nuw [40 x i8], ptr @mainThreadPendingClientsMutexes, i64 %i.ae
  %i.ag = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull %i.af) #15 ; 0 uses
  %i.ah = and i64 %i.ab, 4294967295
  %.not.i11 = icmp eq i64 %i.ah, 0
  br i1 %.not.i11, label %bb.h, label %sendPendingClientsToMainThreadIfNeeded.exit

bb.h:                                             ; preds = %bb.g
  %i.ai = load atomic i32, ptr getelementptr inbounds nuw (i8, ptr @server, i64 264) seq_cst, align 8
  %.not18.i = icmp eq i32 %i.ai, 0
  br i1 %.not18.i, label %bb.i, label %sendPendingClientsToMainThreadIfNeeded.exit

bb.i:                                             ; preds = %bb.h
  %i.aj = load i8, ptr %i.b, align 64, !tbaa !99
  %i.ak = zext i8 %i.aj to i64
  %i.al = getelementptr inbounds nuw [8 x i8], ptr @mainThreadPendingClientsNotifiers, i64 %i.ak
  %i.am = load ptr, ptr %i.al, align 8, !tbaa !101
  %i.an = tail call i32 @triggerEventNotifier(ptr noundef %i.am) #15 ; 0 uses
  br label %sendPendingClientsToMainThreadIfNeeded.exit

sendPendingClientsToMainThreadIfNeeded.exit:      ; preds = %handlePauseAndResume.exit, %bb.g, %bb.h, %bb.i
  ret void
}
...
define dso_local void @IOThreadAfterSleep(ptr noundef readonly captures(none) %0) #10 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 88
...
; Function Attrs: nounwind uwtable
define dso_local void @IOThreadClientsCron(ptr noundef readonly captures(none) %0) local_unnamed_addr #0 {
bb.a:
...
; Function Attrs: nounwind uwtable
define dso_local noundef i32 @IOThreadCron(ptr readnone captures(none) %0, i64 %1, ptr noundef readonly captures(none) %2) #0 {
bb.a:
...
; Function Attrs: nounwind uwtable
define dso_local noalias noundef ptr @IOThreadMain(ptr noundef readonly captures(none) %0) #0 {
bb.a:
...
end_hunk_1
begin_hunk_2_@initThreadedIO:bb.a
