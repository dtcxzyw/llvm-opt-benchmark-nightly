...
bb.ar:                                            ; preds = %bb.ap, %bb.ao
  %.32 = phi ptr [ %i.dm, %bb.ap ], [ %i.c, %bb.ao ] ; 6 uses
  ...
  %i.du = getelementptr inbounds i8, ptr %.0158217, i64 %i.dt ; 31 uses
...
bb.aw:                                            ; preds = %bb.av
  %i.ec = add nuw nsw i32 %.0139, 2               ; 4 uses
...
.preheader.preheader.a:                           ; preds = %bb.aw
  %min.iters.check = icmp ult i32 %.0139, 30
...
begin_hunk_3_@lzf_decompress:bb.a
  ...
  br i1 %diff.check, label %.preheader.preheader229, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.ed, 2147483616              ; 11 uses
...
begin_hunk_4_@lzf_decompress:bb.a
  ...
  br i1 %i.eo, label %middle.block.a, label %vector.body.1
...
begin_hunk_5_@lzf_decompress:bb.a
  ...
  br i1 %i.er, label %middle.block.a, label %vector.body.2
...
begin_hunk_6_@lzf_decompress:bb.a
  ...
  br i1 %i.eu, label %middle.block.a, label %vector.body.3
...
begin_hunk_7_@lzf_decompress:bb.a
  ...
  br i1 %i.ex, label %middle.block.a, label %vector.body.4
...
begin_hunk_8_@lzf_decompress:bb.a
  ...
  br i1 %i.fa, label %middle.block.a, label %vector.body.5
...
begin_hunk_9_@lzf_decompress:bb.a
  ...
  br i1 %i.fd, label %middle.block.a, label %vector.body.6
...
begin_hunk_10_@lzf_decompress:bb.a
  ...
  br i1 %i.fg, label %middle.block.a, label %vector.body.7
...
middle.block.a:                                   ; preds = %vector.body.7, %vector.body.6, %vector.body.5, %vector.body.4, %vector.body.3, %vector.body.2, %vector.body.1, %vector.ph
  %cmp.n.a = icmp eq i64 %n.vec, %i.ed
  br i1 %cmp.n.a, label %.loopexit, label %.preheader.preheader229

.preheader.preheader229:                          ; preds = %vector.memcheck, %.preheader.preheader.a, %middle.block.a
  %.32190.ph = phi ptr [ %.0158217, %vector.memcheck ], [ %.0158217, %.preheader.preheader.a ], [ %i.ej, %middle.block.a ] ; 2 uses
  %.1140.ph = phi i32 [ %i.ec, %vector.memcheck ], [ %i.ec, %.preheader.preheader.a ], [ %i.ek, %middle.block.a ] ; 4 uses
  %.0.ph = phi ptr [ %i.du, %vector.memcheck ], [ %i.du, %.preheader.preheader.a ], [ %i.el, %middle.block.a ] ; 2 uses
...
begin_hunk_12_@lzf_decompress:bb.a
  ...
  br i1 %prol.iter.cmp.not, label %.preheader.prol.loopexit, label %.preheader.prol, !llvm.loop !14
...
begin_hunk_13_@lzf_decompress:bb.a
  ...
  br i1 %.not206.7, label %.loopexit, label %.preheader, !llvm.loop !16
...
.loopexit:                                        ; preds = %.preheader.prol.loopexit, %.preheader, %middle.block.a, %bb.ax, %bb.bg, %bb.al
  %.45 = phi ptr [ %i.fp, %bb.ax ], [ %i.hu, %bb.bg ], [ %i.de, %bb.al ], [ %i.ej, %middle.block.a ], [ %.lcssa.unr, %.preheader.prol.loopexit ], [ %i.gn, %.preheader ] ; 2 uses
  %.32.pn = phi ptr [ %.32, %bb.ax ], [ %.32, %bb.bg ], [ %.31, %bb.al ], [ %.32, %middle.block.a ], [ %.32, %.preheader ], [ %.32, %.preheader.prol.loopexit ]
