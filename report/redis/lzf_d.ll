...
.loopexit:                                        ; preds = %.preheader.prol.loopexit, %.preheader, %middle.block, %bb.ax, %bb.bg, %bb.al
  %.45 = phi ptr [ %i.fp, %bb.ax ], [ %i.hu, %bb.bg ], [ %i.de, %bb.al ], [ %i.ej, %middle.block ], [ %.lcssa.unr, %.preheader.prol.loopexit ], [ %i.gn, %.preheader ] ; 2 uses
  %.35.a = phi ptr [ %.32, %bb.ax ], [ %.32, %bb.bg ], [ %.31, %bb.al ], [ %.32, %middle.block ], [ %.32, %.preheader ], [ %.32, %.preheader.prol.loopexit ]
  %.35 = getelementptr inbounds nuw i8, ptr %.35.a, i64 1 ; 2 uses
...
.critedge:                                        ; preds = %bb.au, %bb.as, %bb.aq, %bb.an, %bb.e, %bb.c, %._crit_edge
