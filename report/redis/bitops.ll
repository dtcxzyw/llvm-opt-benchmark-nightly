...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %.loopexit, label %.lr.ph118.preheader171

.lr.ph118.preheader171:                           ; preds = %.lr.ph118.preheader, %middle.block
...
.lr.ph118:                                        ; preds = %.lr.ph118.preheader171, %.lr.ph118
  %.2117 = phi i64 [ %i.gb, %.lr.ph118 ], [ %.2117.ph, %.lr.ph118.preheader171 ] ; 2 uses
  %.186116 = phi i64 [ %i.hm, %.lr.ph118 ], [ %.186116.ph, %.lr.ph118.preheader171 ]
  %.093115 = phi ptr [ %i.ga, %.lr.ph118 ], [ %.093115.ph, %.lr.ph118.preheader171 ] ; 4 uses
  %i.fx = getelementptr inbounds nuw i8, ptr %.093115, i64 16
  %i.fy = getelementptr inbounds nuw i8, ptr %.093115, i64 20
  %i.fz = load i32, ptr %i.fx, align 4, !tbaa !9  ; 2 uses
  %i.ga = getelementptr inbounds nuw i8, ptr %.093115, i64 28 ; 2 uses
  %i.gb = add nsw i64 %.2117, -28                 ; 2 uses
  %i.gc = lshr i32 %i.fz, 1
  %i.gd = and i32 %i.gc, 1431655765
  %i.ge = sub i32 %i.fz, %i.gd                    ; 2 uses
  %i.gf = and i32 %i.ge, 858993459
  %i.gg = lshr i32 %i.ge, 2
  %i.gh = and i32 %i.gg, 858993459
  %i.gi = add nuw nsw i32 %i.gh, %i.gf            ; 2 uses
  %i.gj = load <4 x i32>, ptr %.093115, align 4, !tbaa !9 ; 2 uses
  %i.gk = lshr <4 x i32> %i.gj, splat (i32 1)
  %i.gl = and <4 x i32> %i.gk, splat (i32 1431655765)
  %i.gm = sub <4 x i32> %i.gj, %i.gl              ; 2 uses
  %i.gn = and <4 x i32> %i.gm, splat (i32 858993459)
  %i.go = lshr <4 x i32> %i.gm, splat (i32 2)
  %i.gp = and <4 x i32> %i.go, splat (i32 858993459)
  %i.gq = add nuw nsw <4 x i32> %i.gp, %i.gn      ; 2 uses
  %i.gr = lshr <4 x i32> %i.gq, splat (i32 4)
  %i.gs = add nuw nsw <4 x i32> %i.gr, %i.gq
  %i.gt = and <4 x i32> %i.gs, splat (i32 252645135)
  %i.gu = lshr i32 %i.gi, 4
  %i.gv = add nuw nsw i32 %i.gu, %i.gi
  %i.gw = and i32 %i.gv, 252645135
  %i.gx = load <2 x i32>, ptr %i.fy, align 4, !tbaa !9 ; 2 uses
  %i.gy = lshr <2 x i32> %i.gx, splat (i32 1)
  %i.gz = and <2 x i32> %i.gy, splat (i32 1431655765)
  %i.ha = sub <2 x i32> %i.gx, %i.gz              ; 2 uses
  %i.hb = and <2 x i32> %i.ha, splat (i32 858993459)
  %i.hc = lshr <2 x i32> %i.ha, splat (i32 2)
  %i.hd = and <2 x i32> %i.hc, splat (i32 858993459)
  ...
  %i.hm = add nuw nsw i64 %.186116, %i.hl         ; 2 uses
  %i.hn = icmp samesign ugt i64 %.2117, 55
  br i1 %i.hn, label %.lr.ph118, label %.loopexit, !llvm.loop !23

.loopexit:                                        ; preds = %.lr.ph118, %middle.block, %.preheader, %._crit_edge108
  %.291 = phi ptr [ %.190.lcssa, %._crit_edge108 ], [ %.089.lcssa, %.preheader ], [ %i.ae, %middle.block ], [ %i.ga, %.lr.ph118 ] ; 2 uses
  %.287 = phi i64 [ %i.fw, %._crit_edge108 ], [ %.085.lcssa, %.preheader ], [ %i.ez, %middle.block ], [ %i.hm, %.lr.ph118 ] ; 3 uses
  %.3 = phi i64 [ %.1.lcssa, %._crit_edge108 ], [ %.084.lcssa, %.preheader ], [ %i.ac, %middle.block ], [ %i.gb, %.lr.ph118 ] ; 5 uses
...
.lr.ph127.prol:                                   ; preds = %.lr.ph127.preheader, %.lr.ph127.prol
  %.4125.prol = phi i64 [ %i.ho, %.lr.ph127.prol ], [ %.3, %.lr.ph127.preheader ]
  %.388124.prol = phi i64 [ %i.hv, %.lr.ph127.prol ], [ %.287, %.lr.ph127.preheader ]
  %.392123.prol = phi ptr [ %i.hp, %.lr.ph127.prol ], [ %.291, %.lr.ph127.preheader ] ; 2 uses
  %prol.iter = phi i64 [ %prol.iter.next, %.lr.ph127.prol ], [ 0, %.lr.ph127.preheader ]
  %i.ho = add nsw i64 %.4125.prol, -1             ; 2 uses
  %i.hp = getelementptr inbounds nuw i8, ptr %.392123.prol, i64 1 ; 2 uses
  %i.hq = load i8, ptr %.392123.prol, align 1, !tbaa !13
  %i.hr = zext i8 %i.hq to i64
  %i.hs = getelementptr inbounds nuw i8, ptr @bitsinbyte, i64 %i.hr
  %i.ht = load i8, ptr %i.hs, align 1, !tbaa !13
  %i.hu = zext i8 %i.ht to i64
  %i.hv = add nsw i64 %.388124.prol, %i.hu        ; 3 uses
...
.lr.ph127.prol.loopexit:                          ; preds = %.lr.ph127.prol, %.lr.ph127.preheader
  %.lcssa.unr = phi i64 [ poison, %.lr.ph127.preheader ], [ %i.hv, %.lr.ph127.prol ]
  %.4125.unr = phi i64 [ %.3, %.lr.ph127.preheader ], [ %i.ho, %.lr.ph127.prol ]
  %.388124.unr = phi i64 [ %.287, %.lr.ph127.preheader ], [ %i.hv, %.lr.ph127.prol ]
  %.392123.unr = phi ptr [ %.291, %.lr.ph127.preheader ], [ %i.hp, %.lr.ph127.prol ]
  %i.hw = icmp ult i64 %.3, 4
  br i1 %i.hw, label %._crit_edge128, label %.lr.ph127

.lr.ph127:                                        ; preds = %.lr.ph127.prol.loopexit, %.lr.ph127
  %.4125 = phi i64 [ %i.is, %.lr.ph127 ], [ %.4125.unr, %.lr.ph127.prol.loopexit ]
  %.388124 = phi i64 [ %i.iz, %.lr.ph127 ], [ %.388124.unr, %.lr.ph127.prol.loopexit ]
  %.392123 = phi ptr [ %i.it, %.lr.ph127 ], [ %.392123.unr, %.lr.ph127.prol.loopexit ] ; 5 uses
  %i.hx = getelementptr inbounds nuw i8, ptr %.392123, i64 1
  %i.hy = load i8, ptr %.392123, align 1, !tbaa !13
  %i.hz = zext i8 %i.hy to i64
  %i.ia = getelementptr inbounds nuw i8, ptr @bitsinbyte, i64 %i.hz
  %i.ib = load i8, ptr %i.ia, align 1, !tbaa !13
  %i.ic = zext i8 %i.ib to i64
  %i.id = add nsw i64 %.388124, %i.ic
  %i.ie = getelementptr inbounds nuw i8, ptr %.392123, i64 2
  %i.if = load i8, ptr %i.hx, align 1, !tbaa !13
  %i.ig = zext i8 %i.if to i64
  %i.ih = getelementptr inbounds nuw i8, ptr @bitsinbyte, i64 %i.ig
  %i.ii = load i8, ptr %i.ih, align 1, !tbaa !13
  %i.ij = zext i8 %i.ii to i64
  %i.ik = add nsw i64 %i.id, %i.ij
  %i.il = getelementptr inbounds nuw i8, ptr %.392123, i64 3
  %i.im = load i8, ptr %i.ie, align 1, !tbaa !13
  %i.in = zext i8 %i.im to i64
  %i.io = getelementptr inbounds nuw i8, ptr @bitsinbyte, i64 %i.in
  %i.ip = load i8, ptr %i.io, align 1, !tbaa !13
  %i.iq = zext i8 %i.ip to i64
  %i.ir = add nsw i64 %i.ik, %i.iq
  %i.is = add nsw i64 %.4125, -4                  ; 2 uses
  %i.it = getelementptr inbounds nuw i8, ptr %.392123, i64 4
  %i.iu = load i8, ptr %i.il, align 1, !tbaa !13
  %i.iv = zext i8 %i.iu to i64
  %i.iw = getelementptr inbounds nuw i8, ptr @bitsinbyte, i64 %i.iv
  %i.ix = load i8, ptr %i.iw, align 1, !tbaa !13
  %i.iy = zext i8 %i.ix to i64
  %i.iz = add nsw i64 %i.ir, %i.iy                ; 2 uses
  %.not94.3 = icmp eq i64 %i.is, 0
...
._crit_edge128:                                   ; preds = %.lr.ph127.prol.loopexit, %.lr.ph127, %.loopexit
  %.388.lcssa = phi i64 [ %.287, %.loopexit ], [ %.lcssa.unr, %.lr.ph127.prol.loopexit ], [ %i.iz, %.lr.ph127 ]
  ret i64 %.388.lcssa
}
...
!156 = distinct !{!156, !15}
!157 = distinct !{!157, !15}
!158 = !{!"branch_weights", !"expected", i32 2126874249, i32 20609399}
end_hunk_1
