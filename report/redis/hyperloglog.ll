...
.lr.ph324:                                        ; preds = %.lr.ph324.preheader, %.outer.backedge
  ...
  %.0185.ph326 = phi i32 [ %i.jg, %.outer.backedge ], [ 5, %.lr.ph324.preheader ] ; 2 uses
...
bb.bi:                                            ; preds = %.lr.ph324, %bb.bp
  %lsr.iv394 = phi i32 [ %i.jc, %.lr.ph324 ], [ %lsr.iv.next395, %bb.bp ] ; 3 uses
  %lsr.iv = phi i64 [ %i.jb, %.lr.ph324 ], [ %lsr.iv.next, %bb.bp ] ; 2 uses
  %.1323 = phi ptr [ %.1.ph328, %.lr.ph324 ], [ %i.jy, %bb.bp ] ; 9 uses
  %.0185322 = phi i32 [ %.0185.ph326, %.lr.ph324 ], [ %3, %bb.bp ]
  %3 = add nsw i32 %.0185322, -1                  ; 6 uses
...
.outer.backedge.loopexitsplit:                    ; preds = %bb.bj, %bb.bl, %bb.bm, %bb.bn
  ...
  %lsr.iv394.lcssa397 = phi i32 [ %3, %bb.bj ], [ %3, %bb.bl ], [ %3, %bb.bm ], [ %3, %bb.bn ]
  br label %.outer.backedge.loopexit

..outer.backedge.loopexit_crit_edge:              ; preds = %bb.bo
  %.1323.lcssa396 = phi ptr [ %.1323, %bb.bo ]
  %.1323.lcssa401 = phi ptr [ %.1323, %bb.bo ]    ; 0 uses
  %lsr.iv394.lcssa398 = phi i32 [ %3, %bb.bo ]
  br label %.outer.backedge.loopexit

.outer.backedge.loopexit:                         ; preds = %.outer.backedge.loopexitsplit, %..outer.backedge.loopexit_crit_edge
  %.1323.lcssa391 = phi ptr [ %.1323.lcssa396, %..outer.backedge.loopexit_crit_edge ], [ %.1323.lcssa400, %.outer.backedge.loopexitsplit ]
