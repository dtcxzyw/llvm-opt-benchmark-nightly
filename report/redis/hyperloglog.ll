...
.loopexit:                                        ; preds = %.preheader, %bb.l, %bb.m, %bb.n, %bb.j, %bb.i
  %.sink = phi i64 [ 1, %bb.i ], [ 2, %bb.j ], [ 1, %bb.n ], [ 1, %bb.m ], [ 1, %bb.l ], [ 1, %.preheader ]
  %.2 = phi i32 [ %i.ad, %bb.i ], [ %i.am, %bb.j ], [ %i.bu, %.preheader ], [ %i.ct, %bb.l ], [ %i.ds, %bb.m ], [ %i.er, %bb.n ] ; 2 uses
...
bb.h:                                             ; preds = %bb.e, %bb.g, %bb.c
  %.sink = phi i64 [ 2, %bb.e ], [ 1, %bb.g ], [ 1, %bb.c ]
  %.142 = phi i32 [ %i.r, %bb.e ], [ %i.x, %bb.g ], [ %i.g, %bb.c ] ; 2 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %.04049, i64 %.sink ; 2 uses
...
bb.o:                                             ; preds = %bb.n, %bb.l, %bb.j
  %i.bb = phi i32 [ %i.ap, %bb.l ], [ %i.z, %bb.n ], [ %i.af, %bb.j ] ; 2 uses
  %.sink.i = phi i64 [ 2, %bb.l ], [ 1, %bb.n ], [ 1, %bb.j ]
  %.142.i = phi i32 [ %i.an, %bb.l ], [ %i.as, %bb.n ], [ %i.ad, %bb.j ] ; 2 uses
  %i.bc = getelementptr inbounds nuw i8, ptr %.04049.i, i64 %.sink.i ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.loopexit
  ...
  %.04761 = phi ptr [ %2, %.loopexit ], [ %i.ay, %.lr.ph.preheader ] ; 3 uses
...
.loopexit:                                        ; preds = %bb.p, %bb.s, %bb.v, %bb.y, %bb.m, %bb.l
  ...
  %2 = getelementptr inbounds nuw i8, ptr %.04761, i64 %.sink ; 2 uses
  %.2 = trunc i64 %.2.in to i32                   ; 2 uses
  %.not57 = icmp ult ptr %2, %i.ax
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.ae
  ...
  %.0118160 = phi ptr [ %.1119, %bb.ae ], [ %i.ch, %.lr.ph.preheader ] ; 5 uses
...
bb.ab:                                            ; preds = %.lr.ph
  ...
  %1 = getelementptr inbounds nuw i8, ptr %.0118160, i64 1
...
begin_hunk_7_@pfdebugCommand:bb.a
  ...
  %2 = getelementptr inbounds nuw i8, ptr %.0118160, i64 2
...
begin_hunk_8_@pfdebugCommand:bb.a
  ...
  %3 = getelementptr inbounds nuw i8, ptr %.0118160, i64 1
...
bb.ae:                                            ; preds = %bb.ac, %bb.ad, %bb.ab
  %.1119 = phi ptr [ %1, %bb.ab ], [ %2, %bb.ac ], [ %3, %bb.ad ] ; 2 uses
