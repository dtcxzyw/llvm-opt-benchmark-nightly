...
bb.b:                                             ; preds = %.lr.ph, %bb.f
  ...
  %.04674 = phi i32 [ 0, %.lr.ph ], [ %i.ar, %bb.f ] ; 4 uses
...
..loopexit.loopexit_crit_edge:                    ; preds = %bb.b
  %.04674.lcssa.a = phi i32 [ %.04674, %bb.b ]
  br label %.loopexit.loopexit

.loopexit.loopexit:                               ; preds = %.loopexit.loopexitsplit, %..loopexit.loopexit_crit_edge
  %.04671.ph = phi i32 [ %.04674.lcssa.a, %..loopexit.loopexit_crit_edge ], [ %.lcssa120, %.loopexit.loopexitsplit ]
  %.04368.ph = phi ptr [ %.04375, %..loopexit.loopexit_crit_edge ], [ %i.an, %.loopexit.loopexitsplit ] ; 2 uses
  %.04065.ph = phi ptr [ %.04076, %..loopexit.loopexit_crit_edge ], [ %i.y, %.loopexit.loopexitsplit ]
...
bb.d:                                             ; preds = %bb.i, %.lr.ph.i
  ...
  %.04167.i = phi i32 [ 0, %.lr.ph.i ], [ %i.aq, %bb.i ] ; 4 uses
  %.04466.i = phi ptr [ %.0.i.i, %.lr.ph.i ], [ %i.ag, %bb.i ] ; 6 uses
  %i.t = load ptr, ptr %1, align 8, !tbaa !16
  %i.u = tail call ptr %i.t(ptr noundef nonnull %.04466.i) #8, !inline_history !91 ; 7 uses
...
..thread.i.loopexitsplit_crit_edge:               ; preds = %bb.i
  %.lcssa210 = phi i32 [ %i.aq, %bb.i ]
  br label %.thread.i.loopexitsplit

.thread.i.loopexitsplit:                          ; preds = %.thread.i.loopexitsplitsplit, %..thread.i.loopexitsplit_crit_edge
  %.04466.i74.ph = phi ptr [ %.04466.i72, %..thread.i.loopexitsplit_crit_edge ], [ %.04466.i73, %.thread.i.loopexitsplitsplit ]
  %.04462.i.ph.ph = phi ptr [ null, %..thread.i.loopexitsplit_crit_edge ], [ %.04466.i, %.thread.i.loopexitsplitsplit ]
  %.04160.i.ph.ph = phi i32 [ %.lcssa210, %..thread.i.loopexitsplit_crit_edge ], [ %.04167.i.lcssa211, %.thread.i.loopexitsplitsplit ]
  br label %.thread.i.loopexit

..thread.i.loopexit_crit_edge:                    ; preds = %bb.d
  %.04167.i.lcssa.a = phi i32 [ %.04167.i, %bb.d ]
  br label %.thread.i.loopexit

.thread.i.loopexit:                               ; preds = %.thread.i.loopexitsplit, %..thread.i.loopexit_crit_edge
  %.lcssa205 = phi ptr [ %i.u, %..thread.i.loopexit_crit_edge ], [ %i.u, %.thread.i.loopexitsplit ]
  %.04466.i74 = phi ptr [ %.04466.i73, %..thread.i.loopexit_crit_edge ], [ %.04466.i74.ph, %.thread.i.loopexitsplit ] ; 2 uses
  %.04462.i.ph = phi ptr [ %.04466.i, %..thread.i.loopexit_crit_edge ], [ %.04462.i.ph.ph, %.thread.i.loopexitsplit ]
  %.04160.i.ph = phi i32 [ %.04167.i.lcssa.a, %..thread.i.loopexit_crit_edge ], [ %.04160.i.ph.ph, %.thread.i.loopexitsplit ]
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.d
  %lsr.iv.a = phi i64 [ 1, %.lr.ph.preheader ], [ %lsr.iv.next, %bb.d ] ; 3 uses
...
begin_hunk_6_@ebExpireDryRun:bb.a
  ...
  %lsr.iv.next = add i64 %lsr.iv.a, 1
...
.thread:                                          ; preds = %.thread.loopexit, %bb.g
  %.143.lcssa = phi i64 [ 0, %bb.g ], [ %.143.lcssa.ph, %.thread.loopexit ] ; 4 uses
...
.lr.ph87:                                         ; preds = %.lr.ph87.preheader, %bb.j
  %lsr.iv99 = phi i64 [ %i.bx, %.lr.ph87.preheader ], [ %lsr.iv.next100, %bb.j ] ; 3 uses
...
.loopexit.loopexitsplit:                          ; preds = %.lr.ph87
  %lsr.iv99.lcssa = phi i64 [ %lsr.iv99, %.lr.ph87 ]
  br label %.loopexit.loopexit
...
.loopexit65.loopexitsplit:                        ; preds = %bb.d
  %lsr.iv.lcssa98 = phi i64 [ %lsr.iv.a, %bb.d ]
  br label %.loopexit65.loopexit

.lr.ph..loopexit65.loopexit_crit_edge:            ; preds = %.lr.ph
  %lsr.iv.lcssa.a = phi i64 [ %lsr.iv.a, %.lr.ph ]
  br label %.loopexit65.loopexit

.loopexit65.loopexit:                             ; preds = %.loopexit65.loopexitsplit, %.lr.ph..loopexit65.loopexit_crit_edge
  %.lcssa97 = phi i64 [ %lsr.iv.lcssa.a, %.lr.ph..loopexit65.loopexit_crit_edge ], [ %lsr.iv.lcssa98, %.loopexit65.loopexitsplit ]
  br label %.loopexit65
