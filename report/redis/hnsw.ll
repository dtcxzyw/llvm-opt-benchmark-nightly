...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi620 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %i.er, %vector.body ]
  ...
  %wide.load621 = load <4 x i8>, ptr %i.eh, align 1, !tbaa !32
  %i.ei = sext <4 x i8> %wide.load to <4 x i32>
  %i.ej = sext <4 x i8> %wide.load621 to <4 x i32>
  %i.ek = getelementptr inbounds nuw i8, ptr %i.de, i64 %i.ef ; 2 uses
  %i.el = getelementptr inbounds nuw i8, ptr %i.ek, i64 4
  %wide.load622 = load <4 x i8>, ptr %i.ek, align 1, !tbaa !32
  %wide.load623 = load <4 x i8>, ptr %i.el, align 1, !tbaa !32
  %i.em = sext <4 x i8> %wide.load622 to <4 x i32>
  %i.en = sext <4 x i8> %wide.load623 to <4 x i32>
  %i.eo = mul nsw <4 x i32> %i.em, %i.ei
  %i.ep = mul nsw <4 x i32> %i.en, %i.ej
  %i.eq = add <4 x i32> %i.eo, %vec.phi           ; 2 uses
  %i.er = add <4 x i32> %i.ep, %vec.phi620        ; 2 uses
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.es = icmp eq i64 %index.next, %n.vec
  br i1 %i.es, label %middle.block, label %vector.body, !llvm.loop !185
...
.lr.ph92.i:                                       ; preds = %.lr.ph92.i.preheader, %.lr.ph92.i
  ...
  br i1 %exitcond.not.i, label %._crit_edge.i, label %.lr.ph92.i, !llvm.loop !186
...
hnsw_distance.exit:                               ; preds = %bb.x, %bb.w, %._crit_edge.i, %bb.u, %bb.t, %bb.r, %._crit_edge.i364, %bb.n, %bb.k, %bb.y
  ...
  %gep = getelementptr inbounds nuw [4 x i8], ptr %invariant.gep, i64 %indvars.iv465
  store float %.0.i, ptr %gep, align 4, !tbaa !27
  %i.ij = mul nuw nsw i64 %indvars.iv465, %i.c
  %gep586.a = getelementptr inbounds nuw [4 x i8], ptr %invariant.gep585.a, i64 %i.ij
  store float %.0.i, ptr %gep586.a, align 4, !tbaa !27
  %indvars.iv.next466 = add nuw nsw i64 %indvars.iv465, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next466, %i.c
  br i1 %exitcond.not, label %.loopexit382, label %bb.i, !llvm.loop !187
...
.preheader378.lr.ph:                              ; preds = %._crit_edge405
  ...
  br i1 %i.in, label %.preheader378.us.us, label %._crit_edge412.split.us424
...
.preheader378.us.us:                              ; preds = %.preheader378.lr.ph, %._crit_edge412.split.us.us.us
  ...
  %i.is = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv509
  %i.it = mul nuw nsw i64 %indvars.iv509, %i.c    ; 3 uses
  %i.iu = getelementptr inbounds nuw [4 x i8], ptr %i.k, i64 %indvars.iv509
  %invariant.gep591 = getelementptr inbounds nuw [4 x i8], ptr %i.il, i64 %i.it
  %i.iv = getelementptr inbounds nuw [4 x i8], ptr %i.il, i64 %indvars.iv509
  %i.iw = getelementptr inbounds nuw [4 x i8], ptr %i.iv, i64 %i.it
  br label %bb.aa

bb.aa:                                            ; preds = %bb.af, %.preheader378.us.us
  %indvars.iv504 = phi i64 [ %indvars.iv.next505, %bb.af ], [ 0, %.preheader378.us.us ] ; 6 uses
  %i.ix = icmp eq i64 %indvars.iv509, %indvars.iv504
  br i1 %i.ix, label %bb.ae, label %.preheader377.us.us.us
...
bb.ab:                                            ; preds = %bb.ac
  ...
  br i1 %exitcond503.not, label %.critedge.us.us.us, label %bb.ac, !llvm.loop !188

.critedge.us.us.us:                               ; preds = %bb.ab, %.preheader377.us.us.us
  %i.iy = add nuw nsw i64 %indvars.iv504, %i.it   ; 2 uses
  ...
  %i.jf = getelementptr inbounds nuw [4 x i8], ptr %i.k, i64 %indvars.iv504
...
bb.ac:                                            ; preds = %.lr.ph408.us.us.us, %bb.ab
  %indvars.iv499 = phi i64 [ 0, %.lr.ph408.us.us.us ], [ %indvars.iv.next500, %bb.ab ] ; 2 uses
  %i.jp = getelementptr inbounds nuw [8 x i8], ptr %i.jx, i64 %indvars.iv499
  %i.jq = load ptr, ptr %i.jp, align 8, !tbaa !26
  %i.jr = icmp eq ptr %i.jq, %i.jz
  br i1 %i.jr, label %bb.ad, label %bb.ab

bb.ad:                                            ; preds = %bb.ac
  %gep592 = getelementptr inbounds nuw [4 x i8], ptr %invariant.gep591, i64 %indvars.iv504
  store float -1.000000e+00, ptr %gep592, align 4, !tbaa !27
  br label %bb.af
...
bb.af:                                            ; preds = %bb.ae, %bb.ad, %.critedge.us.us.us
  %indvars.iv.next505 = add nuw nsw i64 %indvars.iv504, 1 ; 2 uses
  %exitcond508.not = icmp eq i64 %indvars.iv.next505, %i.c
  br i1 %exitcond508.not, label %._crit_edge412.split.us.us.us, label %bb.aa, !llvm.loop !189

.preheader377.us.us.us:                           ; preds = %bb.aa
  ...
  %.not343406.us.us.us.not = icmp eq i32 %i.jw, 0
  br i1 %.not343406.us.us.us.not, label %.critedge.us.us.us, label %.lr.ph408.us.us.us

.lr.ph408.us.us.us:                               ; preds = %.preheader377.us.us.us
  %i.jx = load ptr, ptr %i.ju, align 8, !tbaa !135
  %i.jy = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv504
  %i.jz = load ptr, ptr %i.jy, align 8, !tbaa !26
  %wide.trip.count502 = zext i32 %i.jw to i64
  br label %bb.ac

._crit_edge412.split.us.us.us:                    ; preds = %bb.af
  %indvars.iv.next510 = add nuw nsw i64 %indvars.iv509, 1 ; 2 uses
  %exitcond513.not = icmp eq i64 %indvars.iv.next510, %i.c
  br i1 %exitcond513.not, label %.preheader378.us, label %.preheader378.us.us, !llvm.loop !190

.preheader378.us:                                 ; preds = %._crit_edge412.split.us424, %._crit_edge415, %._crit_edge412.split.1, %._crit_edge412.split.us.us.us
  %4 = load ptr, ptr @hmalloc, align 8, !tbaa !15
  %5 = tail call ptr %4(i64 noundef %i.d) #34     ; 8 uses
  tail call void @llvm.memset.p0.i64(ptr align 4 %5, i8 0, i64 %i.d, i1 false)
  %cond.a = icmp eq ptr %5, null
  br i1 %cond.a, label %.sink.split.sink.split.sink.split, label %.preheader376

.preheader376:                                    ; preds = %.preheader378.us
  %6 = zext i32 %3 to i64                         ; 13 uses
  %wide.trip.count515 = zext nneg i32 %2 to i64   ; 2 uses
  br label %.lr.ph439

.preheader377.us420.1:                            ; preds = %._crit_edge415
  %7 = getelementptr inbounds nuw i8, ptr %1, i64 8
  %invariant.gep581.1 = getelementptr inbounds nuw [4 x i8], ptr %i.il, i64 %i.c
  %8 = getelementptr inbounds nuw i8, ptr %i.il, i64 4
  %9 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %i.c
  %i.ka = load ptr, ptr %7, align 8, !tbaa !26
  ...
  %.not343406.us421.not.1 = icmp eq i32 %i.ke, 0
  br i1 %.not343406.us421.not.1, label %.critedge.us418.1, label %.lr.ph408.us422.1

.lr.ph408.us422.1:                                ; preds = %.preheader377.us420.1
  %i.kf = load ptr, ptr %i.kc, align 8, !tbaa !135
  %i.kg = load ptr, ptr %1, align 8, !tbaa !26
  %wide.trip.count486.1 = zext i32 %i.ke to i64
  br label %bb.ag

bb.ag:                                            ; preds = %bb.ah, %.lr.ph408.us422.1
  %indvars.iv483.1 = phi i64 [ 0, %.lr.ph408.us422.1 ], [ %indvars.iv.next484.1, %bb.ah ] ; 2 uses
  %i.kh = getelementptr inbounds nuw [8 x i8], ptr %i.kf, i64 %indvars.iv483.1
  %i.ki = load ptr, ptr %i.kh, align 8, !tbaa !26
  %i.kj = icmp eq ptr %i.ki, %i.kg
  br i1 %i.kj, label %bb.ai, label %bb.ah

bb.ah:                                            ; preds = %bb.ag
  %indvars.iv.next484.1 = add nuw nsw i64 %indvars.iv483.1, 1 ; 2 uses
  %exitcond487.not.1 = icmp eq i64 %indvars.iv.next484.1, %wide.trip.count486.1
  br i1 %exitcond487.not.1, label %.critedge.us418.1, label %bb.ag, !llvm.loop !188

bb.ai:                                            ; preds = %bb.ag
  store float -1.000000e+00, ptr %invariant.gep581.1, align 4, !tbaa !27
  br label %._crit_edge412.split.1

.critedge.us418.1:                                ; preds = %bb.ah, %.preheader377.us420.1
  %10 = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.c
  %i.kk = load float, ptr %10, align 4, !tbaa !27
  ...
  store float %i.km, ptr %11, align 4, !tbaa !27
  br label %._crit_edge412.split.1

._crit_edge412.split.1:                           ; preds = %.critedge.us418.1, %bb.ai
  store float -1.000000e+00, ptr %9, align 4, !tbaa !27
  br label %.preheader378.us

._crit_edge412.split.us424:                       ; preds = %.preheader378.lr.ph
  store float -1.000000e+00, ptr %i.il, align 4, !tbaa !27
  %exitcond498.not = icmp eq i32 %2, 1
  br i1 %exitcond498.not, label %.preheader378.us, label %.preheader378.us.1

.preheader378.us.1:                               ; preds = %._crit_edge412.split.us424
  %i.kn = load ptr, ptr %1, align 8, !tbaa !26
  ...
  %.not343406.us421.not.1643 = icmp eq i32 %i.kr, 0
  br i1 %.not343406.us421.not.1643, label %.critedge.us418.1651, label %.lr.ph408.us422.1646

.lr.ph408.us422.1646:                             ; preds = %.preheader378.us.1
  %i.ks = load ptr, ptr %i.kp, align 8, !tbaa !135
  %12 = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.kt = load ptr, ptr %12, align 8, !tbaa !26
  %wide.trip.count486.1645 = zext i32 %i.kr to i64
  br label %bb.aj

bb.aj:                                            ; preds = %bb.ak, %.lr.ph408.us422.1646
  %indvars.iv483.1647 = phi i64 [ 0, %.lr.ph408.us422.1646 ], [ %indvars.iv.next484.1648, %bb.ak ] ; 2 uses
  %i.ku = getelementptr inbounds nuw [8 x i8], ptr %i.ks, i64 %indvars.iv483.1647
  %i.kv = load ptr, ptr %i.ku, align 8, !tbaa !26
  %i.kw = icmp eq ptr %i.kv, %i.kt
  br i1 %i.kw, label %bb.al, label %bb.ak

bb.ak:                                            ; preds = %bb.aj
  %indvars.iv.next484.1648 = add nuw nsw i64 %indvars.iv483.1647, 1 ; 2 uses
  %exitcond487.not.1649 = icmp eq i64 %indvars.iv.next484.1648, %wide.trip.count486.1645
  br i1 %exitcond487.not.1649, label %.critedge.us418.1651, label %bb.aj, !llvm.loop !188

bb.al:                                            ; preds = %bb.aj
  %gep582.1 = getelementptr inbounds nuw i8, ptr %i.il, i64 4
  store float -1.000000e+00, ptr %gep582.1, align 4, !tbaa !27
  br label %._crit_edge415

.critedge.us418.1651:                             ; preds = %bb.ak, %.preheader378.us.1
  %13 = getelementptr inbounds nuw i8, ptr %i.f, i64 4
  %i.kx = load float, ptr %13, align 4, !tbaa !27
  %i.ky = fsub float 2.000000e+00, %i.kx
  %i.kz = tail call float @llvm.fmuladd.f32(float %i.ky, float f0x3F333333, float 0.000000e+00)
  %14 = getelementptr inbounds nuw i8, ptr %i.il, i64 4
  store float %i.kz, ptr %14, align 4, !tbaa !27
  br label %._crit_edge415

._crit_edge415:                                   ; preds = %.critedge.us418.1651, %bb.al
  %.not327 = icmp eq i32 %2, 1
  br i1 %.not327, label %.preheader378.us, label %.preheader377.us420.1

.lr.ph439:                                        ; preds = %.lr.ph439.backedge, %.preheader376
  %indvars.iv520 = phi i64 [ 0, %.preheader376 ], [ %indvars.iv520.be, %.lr.ph439.backedge ] ; 6 uses
  %.0293435.us = phi i32 [ -1, %.preheader376 ], [ %.0293435.us.be, %.lr.ph439.backedge ] ; 3 uses
  %.0296434.us = phi i32 [ -1, %.preheader376 ], [ %.0296434.us.be, %.lr.ph439.backedge ] ; 3 uses
  %.0302433.us = phi float [ -1.000000e+00, %.preheader376 ], [ %.0302433.us.be, %.lr.ph439.backedge ] ; 3 uses
  %i.la = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %indvars.iv520
  %i.lb = load i32, ptr %i.la, align 4, !tbaa !9
  %.not339.us = icmp eq i32 %i.lb, 0
  br i1 %.not339.us, label %bb.am, label %..loopexit_crit_edge.us

bb.am:                                            ; preds = %.lr.ph439
  %i.lc = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv520
  %i.ld = load ptr, ptr %i.lc, align 8, !tbaa !26
  %i.le = getelementptr inbounds nuw i8, ptr %i.ld, i64 312
  %i.lf = getelementptr inbounds nuw [24 x i8], ptr %i.le, i64 %6 ; 2 uses
...
..loopexit_crit_edge.us:                          ; preds = %bb.as, %bb.am, %.lr.ph439
  %.5307.us = phi float [ %.0302433.us, %.lr.ph439 ], [ %.0302433.us, %bb.am ], [ %.4306.us, %bb.as ]
  %.5301.us = phi i32 [ %.0296434.us, %.lr.ph439 ], [ %.0296434.us, %bb.am ], [ %.4300.us, %bb.as ] ; 4 uses
  %.5.us = phi i32 [ %.0293435.us, %.lr.ph439 ], [ %.0293435.us, %bb.am ], [ %.4.us, %bb.as ] ; 3 uses
  %indvars.iv.next521 = add nuw nsw i64 %indvars.iv520, 1 ; 2 uses
  %exitcond524.not = icmp eq i64 %indvars.iv.next521, %wide.trip.count515
  br i1 %exitcond524.not, label %._crit_edge440.split.us, label %.lr.ph439.backedge

.lr.ph439.backedge:                               ; preds = %..loopexit_crit_edge.us, %hnsw_update_worst_neighbor_on_add.exit346
  %indvars.iv520.be = phi i64 [ %indvars.iv.next521, %..loopexit_crit_edge.us ], [ 0, %hnsw_update_worst_neighbor_on_add.exit346 ]
  %.0293435.us.be = phi i32 [ %.5.us, %..loopexit_crit_edge.us ], [ -1, %hnsw_update_worst_neighbor_on_add.exit346 ]
  %.0296434.us.be = phi i32 [ %.5301.us, %..loopexit_crit_edge.us ], [ -1, %hnsw_update_worst_neighbor_on_add.exit346 ]
  %.0302433.us.be = phi float [ %.5307.us, %..loopexit_crit_edge.us ], [ -1.000000e+00, %hnsw_update_worst_neighbor_on_add.exit346 ]
  br label %.lr.ph439, !llvm.loop !191

bb.an:                                            ; preds = %.preheader.us, %bb.as
  %indvars.iv514 = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next515, %bb.as ] ; 6 uses
  %.1294428.us = phi i32 [ %.0293435.us, %.preheader.us ], [ %.4.us, %bb.as ] ; 4 uses
  %.1297427.us = phi i32 [ %.0296434.us, %.preheader.us ], [ %.4300.us, %bb.as ] ; 4 uses
  %.1303426.us = phi float [ %.0302433.us, %.preheader.us ], [ %.4306.us, %bb.as ] ; 5 uses
  %i.lk = icmp eq i64 %indvars.iv520, %indvars.iv514
  br i1 %i.lk, label %bb.as, label %bb.ao

bb.ao:                                            ; preds = %bb.an
  %i.ll = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %indvars.iv514
  %i.lm = load i32, ptr %i.ll, align 4, !tbaa !9
  %.not341.us = icmp eq i32 %i.lm, 0
  br i1 %.not341.us, label %bb.ap, label %bb.as

bb.ap:                                            ; preds = %bb.ao
  %gep594 = getelementptr inbounds nuw [4 x i8], ptr %invariant.gep593, i64 %indvars.iv514
  %i.ln = load float, ptr %gep594, align 4, !tbaa !27 ; 3 uses
  %i.lo = fcmp uge float %i.ln, 0.000000e+00
  %i.lp = fcmp ogt float %i.ln, %.1303426.us
  %or.cond.us = select i1 %i.lo, i1 %i.lp, i1 false
  br i1 %or.cond.us, label %bb.aq, label %bb.as

bb.aq:                                            ; preds = %bb.ap
  %i.lq = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv514
  %i.lr = load ptr, ptr %i.lq, align 8, !tbaa !26
  %i.ls = getelementptr inbounds nuw i8, ptr %i.lr, i64 312
  %i.lt = getelementptr inbounds nuw [24 x i8], ptr %i.ls, i64 %6 ; 2 uses
...
bb.ar:                                            ; preds = %bb.aq
  %i.lz = trunc nuw nsw i64 %indvars.iv514 to i32
  br label %bb.as

bb.as:                                            ; preds = %bb.ar, %bb.aq, %bb.ap, %bb.ao, %bb.an
  %.4306.us = phi float [ %.1303426.us, %bb.an ], [ %.1303426.us, %bb.ao ], [ %.1303426.us, %bb.ap ], [ %i.ln, %bb.ar ], [ %.1303426.us, %bb.aq ] ; 2 uses
  %.4300.us = phi i32 [ %.1297427.us, %bb.an ], [ %.1297427.us, %bb.ao ], [ %.1297427.us, %bb.ap ], [ %i.lz, %bb.ar ], [ %.1297427.us, %bb.aq ] ; 2 uses
  %.4.us = phi i32 [ %.1294428.us, %bb.an ], [ %.1294428.us, %bb.ao ], [ %.1294428.us, %bb.ap ], [ %i.mb, %bb.ar ], [ %.1294428.us, %bb.aq ] ; 2 uses
  %indvars.iv.next515 = add nuw nsw i64 %indvars.iv514, 1 ; 2 uses
  %exitcond519.not = icmp eq i64 %indvars.iv.next515, %wide.trip.count515
  br i1 %exitcond519.not, label %..loopexit_crit_edge.us, label %bb.an, !llvm.loop !192

.preheader.us:                                    ; preds = %bb.am
  %i.ma = mul nuw nsw i64 %indvars.iv520, %i.c
  %i.mb = trunc nuw nsw i64 %indvars.iv520 to i32
  %invariant.gep593 = getelementptr inbounds nuw [4 x i8], ptr %i.il, i64 %i.ma
  br label %bb.an
...
bb.at:                                            ; preds = %._crit_edge440.split.us
  ...
  %i.mg = getelementptr inbounds nuw [24 x i8], ptr %i.mf, i64 %6 ; 2 uses
  ...
  %i.mq = getelementptr inbounds nuw [24 x i8], ptr %i.mp, i64 %6
  ...
  %i.na = getelementptr inbounds nuw [24 x i8], ptr %i.mz, i64 %6 ; 3 uses
...
hnsw_update_worst_neighbor_on_add.exit:           ; preds = %bb.au, %bb.av
  ...
  %i.ni = getelementptr inbounds nuw [24 x i8], ptr %i.nh, i64 %6 ; 2 uses
  ...
  %i.np = getelementptr inbounds nuw [24 x i8], ptr %i.no, i64 %6
  ...
  %i.nu = getelementptr inbounds nuw [24 x i8], ptr %i.nt, i64 %6 ; 3 uses
...
hnsw_update_worst_neighbor_on_add.exit346:        ; preds = %bb.aw, %bb.ax
  %i.ob = getelementptr inbounds [4 x i8], ptr %5, i64 %i.mj
  store i32 1, ptr %i.ob, align 4, !tbaa !9
  %i.oc = getelementptr inbounds [4 x i8], ptr %5, i64 %i.mc
...
.lr.ph446:                                        ; preds = %bb.bb
  ...
  %i.ox = mul nuw nsw i64 %indvars.iv530, %i.c
  %invariant.gep595 = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.ox
  br label %bb.bc

._crit_edge447:                                   ; preds = %pq_push.exit
  %.pre535 = load i32, ptr %i.ov, align 8, !tbaa !19
  %i.oy = load ptr, ptr %i.oj, align 8, !tbaa !26 ; 2 uses
  %i.oz = getelementptr inbounds nuw [24 x i8], ptr %i.oy, i64 %6
...
bb.bc:                                            ; preds = %.lr.ph446, %pq_push.exit
  %i.pd = phi ptr [ %i.ou, %.lr.ph446 ], [ %i.qx, %pq_push.exit ] ; 5 uses
  %i.pe = phi ptr [ %i.ou, %.lr.ph446 ], [ %i.qy, %pq_push.exit ] ; 5 uses
...
bb.bd:                                            ; preds = %bb.bc
  %i.pf = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv525
  %i.pg = load ptr, ptr %i.pf, align 8, !tbaa !26 ; 3 uses
  %i.ph = getelementptr inbounds nuw i8, ptr %i.pg, i64 312
  %i.pi = getelementptr inbounds nuw [24 x i8], ptr %i.ph, i64 %6 ; 2 uses
...
bb.be:                                            ; preds = %bb.bd
  ...
  %i.po = load float, ptr %gep596, align 4, !tbaa !27 ; 5 uses
...
pq_push.exit:                                     ; preds = %.critedge2.i, %bb.bg, %.critedge.i, %bb.bc, %bb.bd
  ...
  br i1 %exitcond529.not, label %._crit_edge447, label %bb.bc, !llvm.loop !193
...
bb.bi:                                            ; preds = %._crit_edge447
  ...
  %.pre536 = load ptr, ptr %i.oj, align 8, !tbaa !26
  %.phi.trans.insert = getelementptr inbounds nuw [24 x i8], ptr %.pre536, i64 %6
  %.phi.trans.insert537 = getelementptr inbounds nuw i8, ptr %.phi.trans.insert, i64 320
  %.pre538 = load i32, ptr %.phi.trans.insert537, align 8, !tbaa !132
  %i.qz = icmp eq i32 %.pre538, %i.pc
...
pq_free.exit:                                     ; preds = %._crit_edge447, %bb.bi
  ...
  br i1 %i.rf, label %.lr.ph450, label %._crit_edge451
...
.lr.ph450:                                        ; preds = %pq_free.exit, %bb.bl
  %.0280449 = phi i32 [ %i.rq, %bb.bl ], [ %i.re, %pq_free.exit ] ; 2 uses
  %.0281448 = phi ptr [ %.2, %bb.bl ], [ %i.rd, %pq_free.exit ] ; 3 uses
  %i.rg = load ptr, ptr %i.oj, align 8, !tbaa !26
  %i.rh = tail call ptr @search_layer_with_filter(ptr noundef nonnull %0, ptr noundef readonly %i.rg, ptr noundef %.0281448, i32 noundef 1, i32 noundef %.0280449, i32 noundef 0, ptr noundef null, ptr noundef null, i32 noundef 0) ; 4 uses
...
bb.bl:                                            ; preds = %pq_free.exit351, %.lr.ph450
  ...
  %i.rq = add i32 %.0280449, -1                   ; 2 uses
  %i.rr = icmp ugt i32 %i.rq, %3
  br i1 %i.rr, label %.lr.ph450, label %._crit_edge451, !llvm.loop !194
...
pq_free.exit353:                                  ; preds = %bb.bm
  ...
  %i.rv = getelementptr inbounds nuw [24 x i8], ptr %i.ru, i64 %6
...
pq_new.exit.thread.sink.split.sink.split:         ; preds = %bb.bi, %pq_free.exit353
  %.sink602 = phi ptr [ %i.rt, %pq_free.exit353 ], [ %i.os, %bb.bi ] ; 2 uses
  %i.sc = load ptr, ptr @hfree, align 8, !tbaa !15
  %i.sd = load ptr, ptr %.sink602, align 8, !tbaa !17
...
pq_new.exit.thread.sink.split:                    ; preds = %pq_new.exit.thread.sink.split.sink.split, %bb.bb
  %.sink = phi ptr [ %i.os, %bb.bb ], [ %.sink602, %pq_new.exit.thread.sink.split.sink.split ]
...
pq_new.exit.thread:                               ; preds = %pq_new.exit.thread.sink.split, %bb.ba, %._crit_edge451, %bb.bm, %bb.az, %bb.ay
  ...
  br i1 %exitcond534.not, label %.critedge375._crit_edge, label %bb.ay, !llvm.loop !195

.sink.split.sink.split.sink.split:                ; preds = %.preheader378.us, %.critedge375._crit_edge
  %.sink605 = phi ptr [ %i.k, %.critedge375._crit_edge ], [ %i.f, %.preheader378.us ]
  %.sink603.ph = phi ptr [ %i.il, %.critedge375._crit_edge ], [ %i.k, %.preheader378.us ]
  %.sink598.ph.ph = phi ptr [ %5, %.critedge375._crit_edge ], [ %i.il, %.preheader378.us ]
  %i.sf = load ptr, ptr @hfree, align 8, !tbaa !15
  tail call void %i.sf(ptr noundef nonnull %.sink605) #34
...
.sink.split.sink.split:                           ; preds = %.sink.split.sink.split.sink.split, %._crit_edge405
  ...
  tail call void %i.sg(ptr noundef nonnull %.sink603) #34
  br label %.sink.split
...
.sink.split:                                      ; preds = %.sink.split.sink.split, %._crit_edge
  ...
  tail call void %i.sh(ptr noundef nonnull %.sink598) #34
  br label %bb.bn
...
._crit_edge:                                      ; preds = %hnsw_update_worst_neighbor_on_remove.exit, %.preheader
  ...
  br i1 %.not, label %bb.c, label %.preheader, !llvm.loop !196
