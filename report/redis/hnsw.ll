...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.al = add nuw i64 %index, %i.ah               ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.bo = add nuw i64 %index112, %i.ah            ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.as = add nuw i64 %index, %i.ao               ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.bv = add nuw i64 %index110, %i.ao            ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.w = add nuw i64 %index, %i.s                 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.v = add nuw i64 %index, %i.r                 ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.ay = add nuw i64 %index72, %i.r              ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.u = add nuw i64 %index, %i.q                 ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.ax = add nuw i64 %index63, %i.q              ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.eh = add nuw i64 %index, %i.ed               ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.er = add nuw i64 %index, %i.en               ; 2 uses
