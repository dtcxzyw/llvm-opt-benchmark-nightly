...
bb.b:                                             ; preds = %bb.a
  ...
  %i.c = zext nneg i32 %2 to i64                  ; 20 uses
...
.preheader381.us:                                 ; preds = %.preheader381.us.preheader, %._crit_edge403.us
  %indvars.iv471 = phi i64 [ %indvars.iv.next472, %._crit_edge403.us ], [ 0, %.preheader381.us.preheader ] ; 6 uses
...
._crit_edge403.us.unr-lcssa:                      ; preds = %bb.f
  br i1 %lcmp.mod635.not, label %._crit_edge403.us, label %.epil.preheader
...
._crit_edge403.us:                                ; preds = %.epil.preheader, %bb.g, %._crit_edge403.us.unr-lcssa
  ...
  %exitcond475.not = icmp eq i64 %indvars.iv.next472, %i.c
...
._crit_edge.i365:                                 ; preds = %.lr.ph73.i.prol.loopexit, %.lr.ph73.i, %.preheader.i363
  %.158.lcssa.i = phi float [ %i.bc, %.preheader.i363 ], [ %.lcssa633.unr, %.lr.ph73.i.prol.loopexit ], [ %i.cy, %.lr.ph73.i ]
...
.critedge.us.us:                                  ; preds = %bb.aa, %.preheader378.us.us
  ...
  %i.kc = fdiv <2 x float> %i.kb, %i.iy           ; 2 uses
  %shift617 = shufflevector <2 x float> %i.kc, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop618 = fadd <2 x float> %i.kc, %shift617
  %i.kd = extractelement <2 x float> %foldExtExtBinop618, i64 0
...
.preheader379.1:                                  ; preds = %._crit_edge413.split
  ...
  %.not343407.not.1639 = icmp eq i32 %i.kt, 0
...
.lr.ph409.1642:                                   ; preds = %.preheader379.1
  ...
  %wide.trip.count479.1641 = zext i32 %i.kt to i64
  br label %bb.ae

bb.ae:                                            ; preds = %bb.af, %.lr.ph409.1642
  %indvars.iv476.1643 = phi i64 [ 0, %.lr.ph409.1642 ], [ %indvars.iv.next477.1644, %bb.af ] ; 2 uses
  %i.kw = getelementptr inbounds nuw [8 x i8], ptr %i.ku, i64 %indvars.iv476.1643
...
bb.aq:                                            ; preds = %bb.ap, %bb.ao, %bb.an, %bb.am, %bb.al
  ...
  %exitcond512.not = icmp eq i64 %indvars.iv.next508, %i.c
...
..loopexit_crit_edge.us:                          ; preds = %bb.aq, %bb.ak, %.lr.ph432
  ...
  %exitcond517.not = icmp eq i64 %indvars.iv.next514, %i.c
