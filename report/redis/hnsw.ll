...
bb.ab:                                            ; preds = %bb.ac
  ...
  br i1 %exitcond503.not, label %.critedge.us.us.us, label %bb.ac, !llvm.loop !171
...
bb.af:                                            ; preds = %bb.ae, %bb.ad, %.critedge.us.us.us
  ...
  br i1 %exitcond508.not, label %._crit_edge412.split.us.us.us, label %bb.aa, !llvm.loop !172
...
._crit_edge412.split.us.us.us:                    ; preds = %bb.af
  ...
  br i1 %exitcond513.not, label %.preheader378.us, label %.preheader378.us.us, !llvm.loop !173
...
bb.ah:                                            ; preds = %bb.ag
  ...
  br i1 %exitcond487.not.1, label %.critedge.us418.1, label %bb.ag, !llvm.loop !171
...
bb.ak:                                            ; preds = %bb.aj
  ...
  br i1 %exitcond487.not.1649, label %.critedge.us418.1651, label %bb.aj, !llvm.loop !171
...
.lr.ph439.backedge:                               ; preds = %..loopexit_crit_edge.us, %hnsw_update_worst_neighbor_on_add.exit346
  ...
  br label %.lr.ph439, !llvm.loop !174
...
bb.as:                                            ; preds = %bb.ar, %bb.aq, %bb.ap, %bb.ao, %bb.an
  ...
  br i1 %exitcond519.not, label %..loopexit_crit_edge.us, label %bb.an, !llvm.loop !175
...
pq_push.exit:                                     ; preds = %.critedge2.i, %bb.bg, %.critedge.i, %bb.bc, %bb.bd
  ...
  br i1 %exitcond529.not, label %._crit_edge447, label %bb.bc, !llvm.loop !176
...
bb.bl:                                            ; preds = %pq_free.exit351, %.lr.ph450
  ...
  br i1 %i.rr, label %.lr.ph450, label %._crit_edge451, !llvm.loop !177
...
pq_new.exit.thread:                               ; preds = %pq_new.exit.thread.sink.split, %bb.ba, %._crit_edge451, %bb.bm, %bb.az, %bb.ay
  ...
  br i1 %exitcond534.not, label %.critedge375._crit_edge, label %bb.ay, !llvm.loop !178
