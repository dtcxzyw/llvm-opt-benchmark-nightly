...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %3 = shufflevector <8 x float> %i.y, <8 x float> poison, <2 x i32> <i32 5, i32 1>
  %i.aa = shufflevector <8 x float> %i.z, <8 x float> poison, <2 x i32> <i32 5, i32 1>
  %4 = fmul <2 x float> %3, %i.aa
  ...
  %i.ad = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ab, <2 x float> %i.ac, <2 x float> %4)
...
.lr.ph.i368:                                      ; preds = %.lr.ph.i368, %.lr.ph.preheader.i367
  ...
  %4 = shufflevector <8 x float> %i.bo, <8 x float> poison, <2 x i32> <i32 5, i32 1>
  %i.bq = shufflevector <8 x float> %i.bp, <8 x float> poison, <2 x i32> <i32 5, i32 1>
  %5 = fmul <2 x float> %4, %i.bq
  ...
  %i.bt = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.br, <2 x float> %i.bs, <2 x float> %5)
...
.lr.ph.i111:                                      ; preds = %.lr.ph.i111, %.lr.ph.preheader.i110
  ...
  %2 = shufflevector <8 x float> %i.ca, <8 x float> poison, <2 x i32> <i32 5, i32 1>
  %i.cc = shufflevector <8 x float> %i.cb, <8 x float> poison, <2 x i32> <i32 5, i32 1>
  %3 = fmul <2 x float> %2, %i.cc
  ...
  %i.cf = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cd, <2 x float> %i.ce, <2 x float> %3)
