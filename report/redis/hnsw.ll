...
begin_hunk_0_@vectors_distance_float_avx2:bb.a
  ...
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 32 ; 3 uses
...
begin_hunk_2_@vectors_distance_float_avx2:bb.a
  ...
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil.init, 16
...
._crit_edge.loopexit:                             ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph.epil.preheader
  ...
  %3 = trunc nuw i64 %indvars.iv.next.lcssa to i32
...
.lr.ph64.preheader:                               ; preds = %._crit_edge
  %i.ax = zext i32 %.038.lcssa to i64             ; 4 uses
  %wide.trip.count = zext i32 %2 to i64           ; 3 uses
  %4 = sub nsw i64 %wide.trip.count, %i.ax
  %xtraiter84 = and i64 %4, 3                     ; 2 uses
...
.lr.ph73.preheader:                               ; preds = %.preheader
  %i.m = zext i32 %.0.lcssa to i64                ; 4 uses
  %wide.trip.count = zext i32 %2 to i64           ; 3 uses
  %4 = sub nsw i64 %wide.trip.count, %i.m
...
iter.check:                                       ; preds = %._crit_edge
  ...
  %i.an = sub nsw i64 %wide.trip.count, %i.am     ; 7 uses
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec109.a = and i64 %i.an, -4                 ; 3 uses
  %i.bq = add nsw i64 %n.vec109.a, %i.am
...
begin_hunk_11_@vectors_distance_q8_avx2:bb.a
  ...
  %i.bz = icmp eq i64 %index.next114, %n.vec109.a
...
vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  ...
  %cmp.n115 = icmp eq i64 %i.an, %n.vec109.a
...
.lr.ph92.preheader:                               ; preds = %.preheader
  ...
  %wide.trip.count = zext i32 %2 to i64           ; 2 uses
  %i.r = sub nsw i64 %wide.trip.count, %i.q       ; 3 uses
...
vector.ph:                                        ; preds = %.lr.ph92.preheader
  %n.vec.a = and i64 %i.r, -8                     ; 3 uses
  %i.s = add nsw i64 %n.vec.a, %i.q
...
begin_hunk_14_@vectors_distance_q8:bb.a
  ...
  %i.ag = icmp eq i64 %index.next, %n.vec.a
...
.lr.ph48.preheader:                               ; preds = %.preheader
  %i.d = zext i32 %.0.lcssa to i64                ; 4 uses
  %wide.trip.count = zext i32 %2 to i64           ; 3 uses
  %4 = sub nsw i64 %wide.trip.count, %i.d
  %xtraiter = and i64 %4, 3                       ; 2 uses
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.aa = load i32, ptr %i.r, align 8, !tbaa !74  ; 7 uses
...
.lr.ph48.preheader.i:                             ; preds = %.preheader.i
  ...
  %8 = sub nsw i64 %wide.trip.count.i, %i.ae
...
begin_hunk_23_@hnsw_init_tmp_node:bb.a
  ...
  %i.m = load i32, ptr %i.c, align 8, !tbaa !74   ; 7 uses
...
.lr.ph48.preheader.i:                             ; preds = %.preheader.i
  %i.q = zext i32 %.0.lcssa.i to i64              ; 4 uses
  %wide.trip.count.i = zext i32 %i.m to i64       ; 3 uses
  %5 = sub nsw i64 %wide.trip.count.i, %i.q
...
begin_hunk_27_@hnsw_reconnect_nodes:bb.a
  ...
  %i.ap = load i32, ptr %i.h, align 8, !tbaa !74  ; 7 uses
...
.preheader.loopexit.i371:                         ; preds = %.lr.ph.i368
  %4 = trunc nuw i64 %indvars.iv.next.i370 to i32
...
.lr.ph73.preheader.i:                             ; preds = %.preheader.i362
  %i.bc = zext i32 %.0.lcssa.i363 to i64          ; 4 uses
  %wide.trip.count.i365 = zext i32 %i.ap to i64   ; 3 uses
  %5 = sub nsw i64 %wide.trip.count.i365, %i.bc
  %xtraiter = and i64 %5, 3                       ; 2 uses
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
...
begin_hunk_30_@hnsw_reconnect_nodes:bb.a
  ...
  %indvars.iv.next.i370 = add nuw nsw i64 %indvars.iv.i369, 8 ; 3 uses
...
begin_hunk_31_@hnsw_reconnect_nodes:bb.a
  ...
  %i.de = load i32, ptr %i.h, align 8, !tbaa !74  ; 8 uses
...
.preheader.loopexit.i:                            ; preds = %.lr.ph.i357
  %6 = trunc nuw i64 %indvars.iv.next.i359 to i32
...
.preheader.i356:                                  ; preds = %.preheader.loopexit.i, %bb.v
  ...
  %.070.lcssa.i = phi i32 [ 0, %bb.v ], [ %6, %.preheader.loopexit.i ] ; 2 uses
...
.lr.ph92.preheader.i:                             ; preds = %.preheader.i356
  ...
  %wide.trip.count.i = zext i32 %i.de to i64      ; 2 uses
  %i.ea = sub nsw i64 %wide.trip.count.i, %i.dz   ; 3 uses
...
vector.ph:                                        ; preds = %.lr.ph92.preheader.i
  %n.vec.a = and i64 %i.ea, -8                    ; 3 uses
  %i.eb = add nsw i64 %n.vec.a, %i.dz
...
begin_hunk_33_@hnsw_reconnect_nodes:bb.a
  ...
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ep = icmp eq i64 %index.next, %n.vec.a
...
middle.block:                                     ; preds = %vector.body
  ...
  %cmp.n = icmp eq i64 %i.ea, %n.vec.a
...
begin_hunk_34_@hnsw_reconnect_nodes:bb.a
  ...
  %indvars.iv.next.i359 = add nuw nsw i64 %indvars.iv.i358, 8 ; 3 uses
...
begin_hunk_35_@hnsw_unlink_node:bb.a
  ...
  %i.bb = load i32, ptr %i.g, align 8, !tbaa !74  ; 7 uses
...
.preheader.loopexit.i114:                         ; preds = %.lr.ph.i111
  %2 = trunc nuw i64 %indvars.iv.next.i113 to i32
...
.lr.ph73.preheader.i:                             ; preds = %.preheader.i105
  %i.bo = zext i32 %.0.lcssa.i106 to i64          ; 4 uses
  %wide.trip.count.i108 = zext i32 %i.bb to i64   ; 3 uses
  %3 = sub nsw i64 %wide.trip.count.i108, %i.bo
...
begin_hunk_38_@hnsw_unlink_node:bb.a
  ...
  %indvars.iv.next.i113 = add nuw nsw i64 %indvars.iv.i112, 8 ; 3 uses
...
begin_hunk_39_@hnsw_unlink_node:bb.a
  ...
  %i.dp = load i32, ptr %i.g, align 8, !tbaa !74  ; 8 uses
...
.preheader.loopexit.i:                            ; preds = %.lr.ph.i99
  %4 = trunc nuw i64 %indvars.iv.next.i101 to i32
  br label %.preheader.i
...
.preheader.i:                                     ; preds = %.preheader.loopexit.i, %bb.u
  ...
  %.070.lcssa.i = phi i32 [ 0, %bb.u ], [ %4, %.preheader.loopexit.i ] ; 2 uses
...
.lr.ph92.preheader.i:                             ; preds = %.preheader.i
  ...
  %wide.trip.count.i = zext i32 %i.dp to i64      ; 2 uses
  %i.ek = sub nsw i64 %wide.trip.count.i, %i.ej   ; 3 uses
  %min.iters.check = icmp ult i64 %i.ek, 8
  br i1 %min.iters.check, label %.lr.ph92.i.preheader, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph92.preheader.i
  %n.vec.a = and i64 %i.ek, -8                    ; 3 uses
  %i.el = add nsw i64 %n.vec.a, %i.ej
...
begin_hunk_41_@hnsw_unlink_node:bb.a
  ...
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ez = icmp eq i64 %index.next, %n.vec.a
...
middle.block:                                     ; preds = %vector.body
  ...
  %cmp.n = icmp eq i64 %i.ek, %n.vec.a
  br i1 %cmp.n, label %._crit_edge.i, label %.lr.ph92.i.preheader
...
begin_hunk_42_@hnsw_unlink_node:bb.a
  ...
  %indvars.iv.next.i101 = add nuw nsw i64 %indvars.iv.i100, 8 ; 3 uses
