...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i8>, ptr %i.ej, align 1, !tbaa !43
  %wide.load613 = load <4 x i8>, ptr %i.ek, align 1, !tbaa !43
  ...
  %wide.load614 = load <4 x i8>, ptr %i.en, align 1, !tbaa !43
  %wide.load615 = load <4 x i8>, ptr %i.eo, align 1, !tbaa !43
  ...
  br i1 %i.ev, label %middle.block, label %vector.body, !llvm.loop !181
...
.lr.ph.i358:                                      ; preds = %.lr.ph.i358, %.lr.ph.preheader.i
  ...
  %i.ez = load i8, ptr %i.ey, align 1, !tbaa !43
  ...
  %i.fk = load i8, ptr %i.fj, align 1, !tbaa !43
  ...
  %i.ga = load i8, ptr %i.fz, align 1, !tbaa !43
...
.preheader378.us.us:                              ; preds = %bb.y
  %i.iy = load ptr, ptr %i.is, align 8, !tbaa !38
  %i.iz = getelementptr inbounds nuw i8, ptr %i.iy, i64 312
  %i.ja = getelementptr inbounds nuw [24 x i8], ptr %i.iz, i64 %i.ip ; 2 uses
  %i.jb = getelementptr inbounds nuw i8, ptr %i.ja, i64 8
  %i.jc = load i32, ptr %i.jb, align 8, !tbaa !63 ; 2 uses
  %.not343407.us.us.not = icmp eq i32 %i.jc, 0
...
.lr.ph409.us.us:                                  ; preds = %.preheader378.us.us
  ...
  %i.je = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv497
  %i.jf = load ptr, ptr %i.je, align 8, !tbaa !38
  %wide.trip.count495 = zext i32 %i.jc to i64
  br label %bb.z

bb.z:                                             ; preds = %bb.aa, %.lr.ph409.us.us
  %indvars.iv492 = phi i64 [ %indvars.iv.next493, %bb.aa ], [ 0, %.lr.ph409.us.us ] ; 2 uses
  %i.jg = getelementptr inbounds nuw [8 x i8], ptr %i.jd, i64 %indvars.iv492
  %i.jh = load ptr, ptr %i.jg, align 8, !tbaa !38
  %i.ji = icmp eq ptr %i.jh, %i.jf
  br i1 %i.ji, label %bb.ab, label %bb.aa
...
.critedge.us.us:                                  ; preds = %bb.aa, %.preheader378.us.us
  %i.jj = add nuw nsw i64 %indvars.iv497, %i.it   ; 2 uses
  %i.jk = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.jj
  %i.jl = load float, ptr %i.jk, align 4, !tbaa !39 ; 2 uses
  %i.jm = load float, ptr %i.iu, align 4, !tbaa !39
  %i.jn = fneg float %i.jl
  %i.jo = getelementptr inbounds nuw [4 x i8], ptr %i.k, i64 %indvars.iv497
  %i.jp = load float, ptr %i.jo, align 4, !tbaa !39
  %i.jq = insertelement <2 x float> poison, float %i.jm, i64 0
  ...
  %i.ju = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.jr, <2 x float> %i.ir, <2 x float> %i.jt)
  %i.jv = fdiv <2 x float> %i.ju, %10             ; 2 uses
  %shift617 = shufflevector <2 x float> %i.jv, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop618 = fadd <2 x float> %i.jv, %shift617
  %i.jw = extractelement <2 x float> %foldExtExtBinop618, i64 0
  %i.jx = fmul float %i.jw, 5.000000e-01
  %i.jy = fmul float %i.jx, 3.000000e-01
  %i.jz = fsub float 2.000000e+00, %i.jl
  %i.ka = tail call float @llvm.fmuladd.f32(float %i.jz, float f0x3F333333, float %i.jy)
  %i.kb = getelementptr inbounds nuw [4 x i8], ptr %i.io, i64 %i.jj
  store float %i.ka, ptr %i.kb, align 4, !tbaa !39
  br label %bb.ad
...
bb.ac:                                            ; preds = %bb.y
  store float -1.000000e+00, ptr %i.iw, align 4, !tbaa !39
  br label %bb.ad
...
._crit_edge416.split:                             ; preds = %.preheader379, %._crit_edge413.split, %._crit_edge413.split.1, %._crit_edge413.split.us.us
  %i.kc = load ptr, ptr @hmalloc, align 8, !tbaa !29
...
.preheader379.1:                                  ; preds = %._crit_edge413.split
  ...
  %i.ki = load ptr, ptr %i.kf, align 8, !tbaa !38
  ...
  %i.km = load i32, ptr %i.kl, align 8, !tbaa !63 ; 2 uses
...
.lr.ph409.1642:                                   ; preds = %.preheader379.1
  %i.kn = load ptr, ptr %i.kk, align 8, !tbaa !66
  %i.ko = load ptr, ptr %1, align 8, !tbaa !38
...
bb.ae:                                            ; preds = %bb.af, %.lr.ph409.1642
  ...
  %i.kq = load ptr, ptr %i.kp, align 8, !tbaa !38
...
bb.af:                                            ; preds = %bb.ae
  ...
  br i1 %exitcond480.not.1645, label %.critedge.1647, label %bb.ae, !llvm.loop !184
...
.critedge.1647:                                   ; preds = %bb.af, %.preheader379.1
  ...
  store float %i.kv, ptr %i.kw, align 4, !tbaa !39
  br label %._crit_edge413.split.1

._crit_edge413.split.1:                           ; preds = %.critedge.1647, %bb.ag
  store float -1.000000e+00, ptr %i.kh, align 4, !tbaa !39
...
.preheader378.1:                                  ; preds = %.preheader379
  %i.kx = load ptr, ptr %1, align 8, !tbaa !38
...
bb.ah:                                            ; preds = %bb.ai, %.lr.ph409.1
  ...
  %i.lg = load ptr, ptr %i.lf, align 8, !tbaa !38
...
.critedge.1:                                      ; preds = %bb.ai, %.preheader378.1
  ...
  %i.lj = load float, ptr %i.li, align 4, !tbaa !39
  ...
  store float %i.ll, ptr %i.lm, align 4, !tbaa !39
  br label %._crit_edge413.split
...
bb.ak:                                            ; preds = %.lr.ph432
  ...
  %i.lu = load i32, ptr %i.lt, align 8, !tbaa !63
...
.preheader.us:                                    ; preds = %bb.ak
  %i.lx = mul nuw nsw i64 %indvars.iv513, %i.c
  %i.ly = trunc nuw nsw i64 %indvars.iv513 to i32
  %invariant.gep585 = getelementptr inbounds nuw [4 x i8], ptr %i.io, i64 %i.lx
  br label %bb.al
...
bb.al:                                            ; preds = %.preheader.us, %bb.aq
  ...
  %i.lz = icmp eq i64 %indvars.iv513, %indvars.iv507
  br i1 %i.lz, label %bb.aq, label %bb.am

bb.am:                                            ; preds = %bb.al
  %i.ma = getelementptr inbounds nuw [4 x i8], ptr %i.kd, i64 %indvars.iv507
  %i.mb = load i32, ptr %i.ma, align 4, !tbaa !25
  %.not341.us = icmp eq i32 %i.mb, 0
  br i1 %.not341.us, label %bb.an, label %bb.aq

bb.an:                                            ; preds = %bb.am
  %gep586 = getelementptr inbounds nuw [4 x i8], ptr %invariant.gep585, i64 %indvars.iv507
  %i.mc = load float, ptr %gep586, align 4, !tbaa !39 ; 3 uses
  %i.md = fcmp uge float %i.mc, 0.000000e+00
  %i.me = fcmp ogt float %i.mc, %.1297419.us
  %or.cond.us = select i1 %i.md, i1 %i.me, i1 false
  br i1 %or.cond.us, label %bb.ao, label %bb.aq

bb.ao:                                            ; preds = %bb.an
  %i.mf = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv507
  %i.mg = load ptr, ptr %i.mf, align 8, !tbaa !38
  %i.mh = getelementptr inbounds nuw i8, ptr %i.mg, i64 312
  %i.mi = getelementptr inbounds nuw [24 x i8], ptr %i.mh, i64 %i.ke ; 2 uses
  %i.mj = getelementptr inbounds nuw i8, ptr %i.mi, i64 8
  %i.mk = load i32, ptr %i.mj, align 8, !tbaa !63
  %i.ml = getelementptr inbounds nuw i8, ptr %i.mi, i64 12
  %i.mm = load i32, ptr %i.ml, align 4, !tbaa !62
end_hunk_0
