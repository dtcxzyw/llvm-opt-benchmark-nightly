...
.lr.ph316.preheader:                              ; preds = %.preheader
  ...
  %.neg344 = add i64 %.4215319.pre-phi, 1
...
.lr.ph316.prol.loopexit:                          ; preds = %.lr.ph316.prol, %bb.ag, %.lr.ph316.preheader
  ...
  %.7.lcssa.unr.a = phi ptr [ %.4215, %.lr.ph316.preheader ], [ %i.gq, %bb.ag ], [ %i.gq, %.lr.ph316.prol ]
...
.lr.ph316:                                        ; preds = %.lr.ph316.prol.loopexit, %bb.aj
  ...
  %.5216314 = phi ptr [ %i.hh, %bb.aj ], [ %.7.lcssa.unr.a, %.lr.ph316.prol.loopexit ] ; 3 uses
