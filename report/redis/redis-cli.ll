...
begin_hunk_0_@cliInitHelp:bb.a
  ...
  %i.bb = getelementptr [88 x i8], ptr %i.ay, i64 %i.ba ; 11 uses
...
bb.s:                                             ; preds = %bb.r, %._crit_edge73.i
  ...
  store ptr @.str.514, ptr %i.cu, align 8, !tbaa !44
  %i.cv = getelementptr i8, ptr %i.bb, i64 -40
  store ptr @.str.515, ptr %i.cv, align 8, !tbaa !45
  %1 = getelementptr i8, ptr %i.bb, i64 -48
  store ptr @.str.516, ptr %1, align 8, !tbaa !46
...
begin_hunk_3_@main:bb.a
  ...
  %36 = getelementptr inbounds nuw i8, ptr %i.n, i64 8
...
begin_hunk_4_@main:bb.a
  ...
  store ptr @.str.843, ptr %i.n, align 16, !tbaa !29
  store ptr @.str.844, ptr %36, align 8, !tbaa !29
...
begin_hunk_5_@clusterManagerMoveSlot:bb.a
  ...
  %i.cc = call noalias ptr @zcalloc(i64 noundef %i.cb) #38 ; 9 uses
  %i.cd = call noalias ptr @zcalloc(i64 noundef %i.cb) #38 ; 9 uses
  store ptr @.str.343, ptr %i.cc, align 8, !tbaa !29
  store i64 5, ptr %i.cd, align 8, !tbaa !26
  %7 = getelementptr inbounds nuw i8, ptr %i.cc, i64 8
  store ptr @.str.344, ptr %7, align 8, !tbaa !29
...
bb.b:                                             ; preds = %.lr.ph.split.us.split.us
  ...
  store ptr @.str.796, ptr %i.d, align 16, !tbaa !29
  store ptr @.str.797, ptr %6, align 8, !tbaa !29
...
bb.d:                                             ; preds = %.lr.ph.split.us.split
  ...
  store ptr @.str.796, ptr %i.f, align 16, !tbaa !29
  store ptr @.str.797, ptr %5, align 8, !tbaa !29
