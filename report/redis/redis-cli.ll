...
pred.store.if856:                                 ; preds = %pred.store.continue
  %i.tw = getelementptr i8, ptr %i.d, i64 %index
...
pred.store.if858:                                 ; preds = %pred.store.continue857
  %i.tz = getelementptr i8, ptr %i.d, i64 %index
...
pred.store.if860:                                 ; preds = %pred.store.continue859
  %i.uc = getelementptr i8, ptr %i.d, i64 %index
  %i.ud = getelementptr i8, ptr %i.uc, i64 3
...
pred.store.if862:                                 ; preds = %pred.store.continue861
  %i.uf = getelementptr i8, ptr %i.d, i64 %index
...
pred.store.if864:                                 ; preds = %pred.store.continue863
  %i.ui = getelementptr i8, ptr %i.d, i64 %index
  %i.uj = getelementptr i8, ptr %i.ui, i64 5
...
pred.store.if866:                                 ; preds = %pred.store.continue865
  %i.ul = getelementptr i8, ptr %i.d, i64 %index
  %i.um = getelementptr i8, ptr %i.ul, i64 6
...
pred.store.if868:                                 ; preds = %pred.store.continue867
  %i.uo = getelementptr i8, ptr %i.d, i64 %index
  %i.up = getelementptr i8, ptr %i.uo, i64 7
