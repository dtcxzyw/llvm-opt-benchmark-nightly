...
.lr.ph372:                                        ; preds = %bb.gk, %.lr.ph372
  ...
  br i1 %.not141, label %._crit_edge373, label %.lr.ph372, !llvm.loop !514
...
; Function Attrs: nounwind uwtable
define internal fastcc void @getKeyTypes(ptr noundef %0, ptr noundef readonly captures(none) %1, ptr noundef writeonly captures(none) %2) unnamed_addr #0 {
bb.a:
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  br i1 %i.w, label %bb.b, label %.preheader, !llvm.loop !570
...
bb.l:                                             ; preds = %bb.j, %bb.k, %bb.i
  ...
  br i1 %i.br, label %.lr.ph39, label %._crit_edge, !llvm.loop !571
...
; Function Attrs: nounwind uwtable
define internal fastcc void @getKeySizes(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(none) %1, ptr noundef writeonly captures(none) %2, i32 noundef range(i32 0, 2) %3, i64 noundef %4) unnamed_addr #0 {
bb.a:
...
bb.c:                                             ; preds = %bb.b, %.lr.ph.split.us.split.us
  ...
  br i1 %i.an, label %.lr.ph.split.us.split.us, label %.preheader, !llvm.loop !572
...
bb.j:                                             ; preds = %hi_sdslen.exit.us, %.lr.ph.split.us.split
  ...
  br i1 %i.bw, label %.lr.ph.split.us.split, label %.preheader, !llvm.loop !572
...
bb.m:                                             ; preds = %bb.l, %.lr.ph.split, %bb.k
  ...
  br i1 %i.ct, label %.lr.ph.split, label %.preheader, !llvm.loop !572
...
bb.y:                                             ; preds = %bb.x, %bb.p
  ...
  br i1 %i.ek, label %bb.n, label %._crit_edge, !llvm.loop !573
...
.lr.ph.i:                                         ; preds = %bb.a, %.lr.ph.i
  ...
  br i1 %.not.i, label %displayKeyStatsTopSizes.exit, label %.lr.ph.i, !llvm.loop !574
...
bb.c:                                             ; preds = %bb.b, %.lr.ph.i17
  ...
  br i1 %.not.i18, label %displayKeyStatsSizeType.exit, label %.lr.ph.i17, !llvm.loop !575
