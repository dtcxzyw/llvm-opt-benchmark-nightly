...
bb.a:
  ...
  %3 = fdiv double %i.c, f0x41DFFFFFFFC00000
  %i.d = sitofp i64 %i.a to double
  %i.e = fadd double %2, 1.000000e+00             ; 3 uses
  %4 = tail call double @pow(double noundef %i.d, double noundef %i.e) #32, !tbaa !9
  %5 = sitofp i64 %0 to double
  %i.f = tail call double @pow(double noundef %5, double noundef %i.e) #32, !tbaa !9 ; 2 uses
  %i.g = fsub double %4, %i.f
  %i.h = tail call double @llvm.fmuladd.f64(double %i.g, double %3, double %i.f)
  %6 = fdiv double 1.000000e+00, %i.e
  %i.i = tail call double @pow(double noundef %i.h, double noundef %6) #32, !tbaa !9
...
bb.acy:                                           ; preds = %bb.acq
  ...
  %i.cyt = uitofp nneg i64 %i.cyq to double       ; 2 uses
  %36 = fdiv double %i.cys, %i.cyt
  %37 = fmul double %36, 1.000000e+02
  %38 = select i1 %i.cyr, double %37, double 0.000000e+00
  %39 = sitofp i64 %.027.i to double
  %40 = fdiv double %39, %i.cyt
  %i.cyu = fmul double %40, 1.000000e+02
  %i.cyv = select i1 %i.cyr, double %i.cyu, double 0.000000e+00
  %i.cyw = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.876, i64 noundef %i.cyq, i64 noundef %.030.i, double noundef %38, i64 noundef %.027.i, double noundef %i.cyv) ; 0 uses
  br label %bb.acp
...
bb.be:                                            ; preds = %.lr.ph213, %bb.bg
  ...
  %i.hv = call ptr @dictGetVal(ptr noundef nonnull %i.hu) #32 ; 4 uses
  %i.hw = getelementptr inbounds nuw i8, ptr %i.hv, i64 32
  %6 = load i64, ptr %i.hw, align 8, !tbaa !363   ; 3 uses
  %i.hx = load ptr, ptr %i.hv, align 8, !tbaa !226
  %7 = getelementptr inbounds nuw i8, ptr %i.hv, i64 40
  %8 = load i64, ptr %7, align 8, !tbaa !364      ; 2 uses
...
bb.bg:                                            ; preds = %bb.be, %bb.bf
  ...
  %9 = uitofp i64 %6 to double                    ; 2 uses
  %10 = fmul nnan double %9, 1.000000e+02
  %11 = fdiv double %10, %i.gu
  %12 = select i1 %.not163, double 0.000000e+00, double %11
  %.not164 = icmp eq i64 %6, 0
  %13 = uitofp i64 %8 to double
  %14 = fdiv double %13, %9
  %i.ib = select i1 %.not164, double 0.000000e+00, double %14
  %i.ic = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.777, i64 noundef %6, ptr noundef %i.hx, i64 noundef %8, ptr noundef %i.ia, double noundef %12, double noundef %i.ib) ; 0 uses
