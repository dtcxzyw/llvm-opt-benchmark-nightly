...
begin_hunk_2_@main:bb.a
  ...
  %36 = getelementptr inbounds nuw i8, ptr %i.p, i64 8 ; 4 uses
  ...
  %37 = getelementptr inbounds nuw i8, ptr %i.p, i64 16 ; 3 uses
  %38 = getelementptr inbounds nuw i8, ptr %i.p, i64 24 ; 3 uses
  %39 = getelementptr inbounds nuw i8, ptr %i.p, i64 32 ; 3 uses
  %40 = getelementptr inbounds nuw i8, ptr %i.p, i64 40 ; 3 uses
  %41 = getelementptr inbounds nuw i8, ptr %i.p, i64 48 ; 3 uses
  %42 = getelementptr inbounds nuw i8, ptr %i.p, i64 56 ; 3 uses
  %43 = getelementptr inbounds nuw i8, ptr %i.p, i64 64 ; 3 uses
  %44 = getelementptr inbounds nuw i8, ptr %i.p, i64 72 ; 3 uses
  %45 = getelementptr inbounds nuw i8, ptr %i.p, i64 80 ; 3 uses
  %46 = getelementptr inbounds nuw i8, ptr %i.p, i64 88 ; 3 uses
  %47 = getelementptr inbounds nuw i8, ptr %i.p, i64 96 ; 3 uses
  %48 = getelementptr inbounds nuw i8, ptr %i.p, i64 104 ; 3 uses
  %49 = getelementptr inbounds nuw i8, ptr %i.p, i64 112 ; 3 uses
...
._crit_edge153.i:                                 ; preds = %bb.xc, %bb.xb, %bb.xa, %bb.wz, %bb.wy, %bb.wx, %bb.ww, %bb.wv, %bb.wu, %bb.wt, %bb.ws, %bb.wr, %bb.wq, %bb.wp
  %.076125.lcssa.wide.ph.ph.i = phi i32 [ 1, %bb.wp ], [ 2, %bb.wq ], [ 3, %bb.wr ], [ 4, %bb.ws ], [ 5, %bb.wt ], [ 6, %bb.wu ], [ 7, %bb.wv ], [ 8, %bb.ww ], [ 9, %bb.wx ], [ 10, %bb.wy ], [ 11, %bb.wz ], [ 12, %bb.xa ], [ 13, %bb.xb ], [ 14, %bb.xc ] ; 2 uses
  %.phi.trans.insert.i121 = zext nneg i32 %.076125.lcssa.wide.ph.ph.i to i64
  %.phi.trans.insert154.i = getelementptr inbounds nuw [8 x i8], ptr %i.p, i64 %.phi.trans.insert.i121
  %.pre.i122 = load i64, ptr %.phi.trans.insert154.i, align 8, !tbaa !339
  br label %.thread.i123

.thread.i123:                                     ; preds = %._crit_edge153.i, %bb.xc
  %i.cbe = phi i64 [ %.pre.i122, %._crit_edge153.i ], [ %i.cbc, %bb.xc ]
  %i.cbf = phi i32 [ %.076125.lcssa.wide.ph.ph.i, %._crit_edge153.i ], [ 15, %bb.xc ] ; 2 uses
...
begin_hunk_5_@main:bb.a
  ...
  call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(1) %i.p, ptr noundef nonnull align 8 dereferenceable(1) %36, i64 %i.cbn, i1 false)
...
bb.xr:                                            ; preds = %bb.xq, %displayKeyStatsProgressbar.exit.i
  ...
  %i.cdx = load i64, ptr %49, align 16, !tbaa !339 ; 2 uses
...
bb.xt:                                            ; preds = %bb.xs, %bb.xr
  ...
  %i.ceb = load i64, ptr %48, align 8, !tbaa !339 ; 2 uses
...
bb.xv:                                            ; preds = %bb.xu, %bb.xt
  ...
  %i.cef = load i64, ptr %47, align 16, !tbaa !339 ; 2 uses
...
bb.xx:                                            ; preds = %bb.xw, %bb.xv
  ...
  %i.cej = load i64, ptr %46, align 8, !tbaa !339 ; 2 uses
...
bb.xz:                                            ; preds = %bb.xy, %bb.xx
  ...
  %i.cen = load i64, ptr %45, align 16, !tbaa !339 ; 2 uses
...
bb.yb:                                            ; preds = %bb.ya, %bb.xz
  ...
  %i.cer = load i64, ptr %44, align 8, !tbaa !339 ; 2 uses
...
bb.yd:                                            ; preds = %bb.yc, %bb.yb
  ...
  %i.cev = load i64, ptr %43, align 16, !tbaa !339 ; 2 uses
...
bb.yf:                                            ; preds = %bb.ye, %bb.yd
  ...
  %i.cez = load i64, ptr %42, align 8, !tbaa !339 ; 2 uses
...
bb.yh:                                            ; preds = %bb.yg, %bb.yf
  ...
  %i.cfd = load i64, ptr %41, align 16, !tbaa !339 ; 2 uses
...
bb.yj:                                            ; preds = %bb.yi, %bb.yh
  ...
  %i.cfh = load i64, ptr %40, align 8, !tbaa !339 ; 2 uses
...
bb.yl:                                            ; preds = %bb.yk, %bb.yj
  ...
  %i.cfl = load i64, ptr %39, align 16, !tbaa !339 ; 2 uses
...
bb.yn:                                            ; preds = %bb.ym, %bb.yl
  ...
  %i.cfp = load i64, ptr %38, align 8, !tbaa !339 ; 2 uses
...
bb.yp:                                            ; preds = %bb.yo, %bb.yn
  ...
  %i.cft = load i64, ptr %37, align 16, !tbaa !339 ; 2 uses
...
bb.yr:                                            ; preds = %bb.yq, %bb.yp
  ...
  %i.cfx = load i64, ptr %36, align 8, !tbaa !339 ; 2 uses
...
bb.zl:                                            ; preds = %bb.zk, %bb.zj
  %i.cij = load i64, ptr %49, align 16, !tbaa !339 ; 2 uses
...
bb.zn:                                            ; preds = %bb.zm, %bb.zl
  %i.cim = load i64, ptr %48, align 8, !tbaa !339 ; 2 uses
...
bb.zp:                                            ; preds = %bb.zo, %bb.zn
  %i.cip = load i64, ptr %47, align 16, !tbaa !339 ; 2 uses
...
bb.zr:                                            ; preds = %bb.zq, %bb.zp
  %i.cis = load i64, ptr %46, align 8, !tbaa !339 ; 2 uses
...
bb.zt:                                            ; preds = %bb.zs, %bb.zr
  %i.civ = load i64, ptr %45, align 16, !tbaa !339 ; 2 uses
...
bb.zv:                                            ; preds = %bb.zu, %bb.zt
  %i.ciy = load i64, ptr %44, align 8, !tbaa !339 ; 2 uses
...
bb.zx:                                            ; preds = %bb.zw, %bb.zv
  %i.cjb = load i64, ptr %43, align 16, !tbaa !339 ; 2 uses
...
bb.zz:                                            ; preds = %bb.zy, %bb.zx
  %i.cje = load i64, ptr %42, align 8, !tbaa !339 ; 2 uses
...
bb.aab:                                           ; preds = %bb.aaa, %bb.zz
  %i.cjh = load i64, ptr %41, align 16, !tbaa !339 ; 2 uses
...
bb.aad:                                           ; preds = %bb.aac, %bb.aab
  %i.cjk = load i64, ptr %40, align 8, !tbaa !339 ; 2 uses
...
bb.aaf:                                           ; preds = %bb.aae, %bb.aad
  %i.cjn = load i64, ptr %39, align 16, !tbaa !339 ; 2 uses
...
bb.aah:                                           ; preds = %bb.aag, %bb.aaf
  %i.cjq = load i64, ptr %38, align 8, !tbaa !339 ; 2 uses
...
bb.aaj:                                           ; preds = %bb.aai, %bb.aah
  %i.cjt = load i64, ptr %37, align 16, !tbaa !339 ; 2 uses
...
bb.aal:                                           ; preds = %bb.aak, %bb.aaj
  %i.cjw = load i64, ptr %36, align 8, !tbaa !339 ; 2 uses
...
bb.ae:                                            ; preds = %bb.z, %bb.aa, %bb.ac
  %.056.a = phi i32 [ 1, %bb.ac ], [ 0, %bb.aa ], [ 0, %bb.z ] ; 3 uses
  %.054 = phi i64 [ %i.bm, %bb.ac ], [ 1, %bb.aa ], [ 1, %bb.z ]
  %i.bz = sub nsw i32 %i.bn, %.056.a              ; 9 uses
  %5 = zext nneg i32 %.056.a to i64
  %i.ca = getelementptr inbounds nuw [8 x i8], ptr %.0.i8295, i64 %5 ; 11 uses
