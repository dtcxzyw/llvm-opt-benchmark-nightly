begin_hunk_0
  ...
  %i.d = alloca [16384 x i8], align 16            ; 13 uses
...
vector.body:                                      ; preds = %pred.store.continue869, %.lr.ph.i155
  %index = phi i64 [ 0, %.lr.ph.i155 ], [ %index.next, %pred.store.continue869 ] ; 11 uses
...
begin_hunk_2
  ...
  %i.to = getelementptr i8, ptr %i.d, i64 %index  ; 2 uses
...
pred.store.if:                                    ; preds = %vector.body
  %21 = getelementptr i8, ptr %i.d, i64 %index
