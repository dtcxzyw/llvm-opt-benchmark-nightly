...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = tail call ptr %i.e(ptr noundef %0, ptr noundef nonnull %i.d, i64 noundef %2, i64 noundef %3, i1 noundef zeroext %6, i1 noundef zeroext false, i1 noundef zeroext %4, ptr noundef %8) #4 ; 2 uses
...
.thread:                                          ; preds = %bb.a, %tsdn_witness_tsdp_get.exit, %bb.b
  ...
  %i.j = tail call ptr %i.i(ptr noundef %0, ptr noundef nonnull %i.h, i64 noundef %2, i64 noundef %3, i1 noundef zeroext %6, i1 noundef zeroext %7, i1 noundef zeroext %4, ptr noundef %8) #4 ; 2 uses
...
begin_hunk_1_@je_pa_alloc:tsdn_witness_tsdp_get.exit
  ...
  %i.p = load i64, ptr %.142, align 8, !tbaa !63
  ...
  %i.v = or i64 %i.u, %i.q
  store i64 %i.v, ptr %.142, align 8, !tbaa !63
...
bb.a:
  %.val = load i64, ptr %2, align 8, !tbaa !63    ; 2 uses
...
begin_hunk_3_@je_pa_expand:bb.a
  ...
  %i.g = tail call zeroext i1 %i.f(ptr noundef %0, ptr noundef nonnull %i.d, ptr noundef nonnull %2, i64 noundef %3, i64 noundef %4, i1 noundef zeroext %6, ptr noundef %7) #4
...
begin_hunk_6_@je_pa_shrink:bb.a
  ...
  %i.g = tail call zeroext i1 %i.f(ptr noundef %0, ptr noundef nonnull %i.d, ptr noundef nonnull %2, i64 noundef %3, i64 noundef %4, ptr noundef %6) #4
  br i1 %i.g, label %bb.d, label %bb.c
...
begin_hunk_8_@je_pa_dalloc:bb.a
  ...
  %.val18 = load i64, ptr %2, align 8, !tbaa !63  ; 2 uses
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %.val19 = load ptr, ptr %i.f, align 8, !tbaa !67
  ...
  tail call void %i.t(ptr noundef %0, ptr noundef nonnull %i.r, ptr noundef nonnull %2, ptr noundef %3) #4
  ret void
}
...
bb.a:
  ...
  %i.d = tail call i64 %i.c(ptr noundef %0, ptr noundef nonnull %i.a) #4 ; 3 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.l = tail call i64 %i.k(ptr noundef %0, ptr noundef nonnull %i.i) #4
...
!62 = !{!20, !14, i64 0}
!63 = !{!64, !16, i64 0}
!64 = !{!"edata_s", !16, i64 0, !14, i64 8, !9, i64 16, !47, i64 24, !16, i64 32, !9, i64 40, !9, i64 64}
!65 = !{!20, !14, i64 16}
!66 = !{!20, !14, i64 24}
!67 = !{!64, !14, i64 8}
!68 = !{!9, !9, i64 0}
