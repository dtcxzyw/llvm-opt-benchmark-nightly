...
begin_hunk_0_@linenoise:bb.a
  ...
  call void %i.co(ptr noundef %i.cq, ptr noundef nonnull %1) #25
...
bb.y:                                             ; preds = %.preheader.i.i.i
  ...
  %.sroa.41.0.copyload.i.i.i = load i64, ptr %i.ax, align 8, !tbaa !58
  %.sroa.52.0.copyload.i.i.i = load i64, ptr %i.ay, align 8, !tbaa !58
...
begin_hunk_3_@linenoise:bb.a
  ...
  br i1 %i.eh, label %.lr.ph.i.i.i, label %._crit_edge.i.i.i, !llvm.loop !60
...
begin_hunk_4_@linenoise:bb.a
  ...
  %i.fb = load ptr, ptr %i.cj, align 8, !tbaa !61
...
begin_hunk_5_@linenoise:bb.a
  ...
  store ptr %i.gb, ptr %i.cj, align 8, !tbaa !61
...
begin_hunk_6_@linenoise:bb.a
  ...
  store i64 0, ptr %i.ax, align 8, !tbaa !30
  store i1 false, ptr @reverse_search_mode_enabled, align 4
  %i.gd = load ptr, ptr %i.cj, align 8, !tbaa !61
...
begin_hunk_7_@linenoise:bb.a
  ...
  store i64 0, ptr %i.ax, align 8, !tbaa !30
  store i1 false, ptr @reverse_search_mode_enabled, align 4
  %i.gk = load ptr, ptr %i.cj, align 8, !tbaa !61
...
begin_hunk_8_@linenoiseHistoryAdd:bb.a
  ...
  store ptr %i.k, ptr @history_sensitive, align 8, !tbaa !62
...
begin_hunk_9_@linenoiseHistoryAdd:bb.a
  ...
  %.pre = load ptr, ptr @history_sensitive, align 8, !tbaa !62 ; 3 uses
...
begin_hunk_11_@linenoiseHistorySetMaxLen:bb.a
  ...
  %i.u = load ptr, ptr @history_sensitive, align 8, !tbaa !62 ; 2 uses
  ...
  store ptr %i.h, ptr @history_sensitive, align 8, !tbaa !62
  br label %bb.g
...
.lr.ph.preheader:                                 ; preds = %bb.b
  %.pre14 = load ptr, ptr @history_sensitive, align 8, !tbaa !62
  br label %.lr.ph
...
begin_hunk_13_@linenoiseHistorySave:bb.a
  ...
  %.pre = load ptr, ptr @history_sensitive, align 8, !tbaa !62
...
begin_hunk_14_@linenoiseHistorySave:bb.a
  ...
  br i1 %i.t, label %.lr.ph, label %._crit_edge, !llvm.loop !65
...
begin_hunk_16_@searchInHistory:bb.a
  ...
  store i32 %i.ab, ptr %0, align 8, !tbaa !67
...
._crit_edge.i:                                    ; preds = %.lr.ph.i, %.preheader.i
  tail call void @free(ptr noundef nonnull %i.b) #25
  %i.g = load ptr, ptr @history_sensitive, align 8, !tbaa !62
...
bb.b:                                             ; preds = %bb.c
  ...
  br i1 %exitcond.not, label %bb.d, label %.preheader, !llvm.loop !69
