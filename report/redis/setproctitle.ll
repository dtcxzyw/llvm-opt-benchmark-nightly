...
.critedge2._crit_edge:                            ; preds = %.critedge2._crit_edge.loopexit, %.critedge2.preheader
  ...
  %.1.lcssa = phi i64 [ 8, %.critedge2.preheader ], [ %i.w, %.critedge2._crit_edge.loopexit ] ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ac = tail call noalias ptr @malloc(i64 noundef %.1.lcssa) #16 ; 7 uses
  %.not31.i = icmp eq ptr %i.ac, null
  br i1 %.not31.i, label %spt_copyenv.exit.thread, label %bb.i

bb.i:                                             ; preds = %bb.h
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.ac, ptr nonnull align 8 %i.a, i64 %.1.lcssa, i1 false)
