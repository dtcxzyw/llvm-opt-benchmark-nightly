...
bb.f:                                             ; preds = %bb.b, %bb.c, %bb.d, %bb.e
  ...
  %.016.i = phi i64 [ 10, %bb.e ], [ 4, %bb.d ], [ 4, %bb.c ], [ 2, %bb.b ]
...
mstrAllocLen.exit61:                              ; preds = %bb.j, %bb.k, %bb.l, %bb.m
  ...
  %.016.i48 = phi i64 [ 10, %bb.m ], [ 4, %bb.l ], [ 4, %bb.k ], [ 2, %bb.j ]
  %i.ax = add i64 %.0.i4372, %.016.i48
...
bb.n:                                             ; preds = %.preheader, %._crit_edge87
  ...
  %.03581 = phi i16 [ %i.f, %.preheader ], [ %i.cj, %._crit_edge87 ] ; 2 uses
  %i.az = add nuw i64 %indvars.iv84, 1            ; 2 uses
  %i.ba = and i16 %.03581, 1
...
switch.lookup:
  ...
  %i.d = zext nneg i8 %i.c to i64
  %switch.gep15 = getelementptr inbounds nuw [8 x i8], ptr @switch.table.mstrGetStartAlloc.8, i64 %i.d
...
mstrSumMetaLen.exit:                              ; preds = %bb.a, %mstrSumMetaLen.exit.loopexit, %switch.lookup
  ...
  %i.q = getelementptr inbounds i8, ptr %0, i64 %switch.load16
