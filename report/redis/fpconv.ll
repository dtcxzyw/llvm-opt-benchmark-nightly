Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/redis/original/fpconv?download=true
inline.NumInlined: 4
inline.NumDeleted: 4
begin_hunk_0
...
@.str.1 = private unnamed_addr constant [34 x i8] c"1 <= precision && precision <= 14\00", align 1
@.str.2 = private unnamed_addr constant [9 x i8] c"fpconv.c\00", align 1
@__PRETTY_FUNCTION__.set_number_format = private unnamed_addr constant [36 x i8] c"void set_number_format(char *, int)\00", align 1
...
define dso_local double @fpconv_strtod(ptr noundef %0, ptr nofree noundef captures(none) %1) local_unnamed_addr #0 {
bb.a:
...
bb.h:                                             ; preds = %bb.e, %bb.f
  %.0 = phi ptr [ %i.r, %bb.f ], [ %i.a, %bb.e ]  ; 6 uses
  %sext = shl i64 %i.m, 32
  %i.u = ashr exact i64 %sext, 32                 ; 2 uses
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %.0, ptr align 1 %0, i64 %i.u, i1 false)
  %i.v = getelementptr inbounds i8, ptr %.0, i64 %i.u
  store i8 0, ptr %i.v, align 1, !tbaa !8
  %i.w = call ptr @strchr(ptr noundef nonnull dereferenceable(1) %.0, i32 noundef 46) #15 ; 2 uses
...
bb.j:                                             ; preds = %bb.i, %bb.h
  %i.x = call double @strtod(ptr noundef nonnull %.0, ptr noundef nonnull %i.b) #11 ; 2 uses
  %i.y = load ptr, ptr %i.b, align 8, !tbaa !11
...
bb.l:                                             ; preds = %bb.j, %bb.k, %bb.d, %bb.b
  %.024 = phi double [ %i.e, %bb.b ], [ 0.000000e+00, %bb.d ], [ %i.x, %bb.k ], [ %i.x, %bb.j ]
...
; Function Attrs: nounwind uwtable
define dso_local noundef i32 @fpconv_g_fmt(ptr nofree noundef writeonly captures(none) %0, double noundef %1, i32 noundef %2) local_unnamed_addr #0 {
bb.a:
...
fpconv_update_locale.exit:                        ; preds = %bb.a
  ...
  store i8 %i.n, ptr @locale_decimal_point, align 1, !tbaa !8
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #11
  ret void
}
