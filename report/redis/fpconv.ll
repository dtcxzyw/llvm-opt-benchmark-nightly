...
bb.a:
  ...
  %.0.i.sroa.gep.a = getelementptr inbounds nuw i8, ptr %i.b, i64 3
  %.0.i.sroa.gep12.a = getelementptr inbounds nuw i8, ptr %i.b, i64 2 ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  store i8 49, ptr %.0.i.sroa.gep12.a, align 1, !tbaa !8
  br label %set_number_format.exit

set_number_format.exit:                           ; preds = %bb.c, %bb.d
  %.0.i.sroa.phi.a = phi ptr [ %.0.i.sroa.gep.a, %bb.d ], [ %.0.i.sroa.gep12.a, %bb.c ] ; 3 uses
  %.urem.i = add nuw nsw i32 %2, 246
  %i.e = select i1 %.not.i, i32 %2, i32 %.urem.i
  %i.f = trunc i32 %i.e to i8
  %i.g = or disjoint i8 %i.f, 48
  store i8 %i.g, ptr %.0.i.sroa.phi.a, align 1, !tbaa !8
  %3 = getelementptr inbounds nuw i8, ptr %.0.i.sroa.phi.a, i64 1
  store i8 103, ptr %3, align 1, !tbaa !8
  %4 = getelementptr inbounds nuw i8, ptr %.0.i.sroa.phi.a, i64 2
