...
.loopexit:                                        ; preds = %bb.v, %bb.i
  ...
  %.071.lcssa75 = phi ptr [ %1, %bb.i ], [ %4, %bb.v ]
  %.0.sroa.phi70.lcssa73 = phi ptr [ %.0.sroa.gep, %bb.i ], [ %.0.sroa.gep56, %bb.v ]
...
begin_hunk_5
  ...
  %i.bz = load i64, ptr %.071.lcssa75, align 8, !tbaa !10
  store i64 %i.bz, ptr %i.by, align 8, !tbaa !10
  %i.ca = load i32, ptr %.0.sroa.phi70.lcssa73, align 8, !tbaa !8
...
.critedge:                                        ; preds = %.thread, %bb.s, %bb.r, %bb.q, %callTM.exit, %.loopexit79
