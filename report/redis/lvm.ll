...
bb.fc:                                            ; preds = %bb.fb, %bb.fa, %bb.ez, %bb.ey
  ...
  br i1 %i.aap, label %bb.ey, label %.critedge.backedge, !llvm.loop !45
...
bb.ff:                                            ; preds = %.lr.ph866, %bb.fi
  ...
  %i.abe = load i32, ptr %.10729864, align 4, !tbaa !7 ; 2 uses
...
bb.fi:                                            ; preds = %bb.fg, %bb.fh
  ...
  br i1 %exitcond890.not, label %._crit_edge, label %bb.ff, !llvm.loop !46
...
._crit_edge:                                      ; preds = %bb.fi, %bb.fe
  ...
  store i32 6, ptr %i.abp, align 8, !tbaa !9
  store ptr %.10729.lcssa, ptr %i.d, align 8, !tbaa !48
  %i.abq = load ptr, ptr %i.m, align 8, !tbaa !29 ; 2 uses
  %i.abr = getelementptr inbounds nuw i8, ptr %i.abq, i64 120
  %i.abs = load i64, ptr %i.abr, align 8, !tbaa !78
  %i.abt = getelementptr inbounds nuw i8, ptr %i.abq, i64 112
  %i.abu = load i64, ptr %i.abt, align 8, !tbaa !79
...
bb.fk:                                            ; preds = %bb.fj, %._crit_edge
  %i.abv = load ptr, ptr %i.f, align 8, !tbaa !35
  br label %.critedge.backedge

bb.fl:                                            ; preds = %bb.l
  %i.abw = lshr i32 %i.ad, 23                     ; 2 uses
  %i.abx = add nsw i32 %i.abw, -1
  %i.aby = load ptr, ptr %i.e, align 8, !tbaa !49 ; 3 uses
  %i.abz = load ptr, ptr %i.aby, align 8, !tbaa !82
  %i.aca = getelementptr inbounds nuw i8, ptr %i.aby, i64 8
  %i.acb = load ptr, ptr %i.aca, align 8, !tbaa !51
  ...
  %i.ach = load ptr, ptr %i.w, align 8, !tbaa !54
  %i.aci = getelementptr inbounds nuw i8, ptr %i.ach, i64 113
  %i.acj = load i8, ptr %i.aci, align 1, !tbaa !89
...
bb.fm:                                            ; preds = %bb.fl
  store ptr %i.ac, ptr %i.d, align 8, !tbaa !48
  %i.aco = load ptr, ptr %i.k, align 8, !tbaa !34
  %i.acp = load ptr, ptr %i.l, align 8, !tbaa !33
...
bb.fo:                                            ; preds = %bb.fm, %bb.fn
  %i.acv = load ptr, ptr %i.f, align 8, !tbaa !35 ; 2 uses
  ...
  store ptr %i.acy, ptr %i.l, align 8, !tbaa !33
  br label %bb.fp
...
.lr.ph:                                           ; preds = %bb.fp
  %i.ada = sext i32 %i.acm to i64                 ; 2 uses
...
bb.fq:                                            ; preds = %.lr.ph, %bb.fs
  ...
  %i.adc = icmp slt i64 %indvars.iv, %i.ada
  br i1 %i.adc, label %bb.fr, label %bb.fs

bb.fr:                                            ; preds = %bb.fq
  %i.add = load ptr, ptr %i.aby, align 8, !tbaa !82
  %i.ade = getelementptr inbounds [16 x i8], ptr %i.add, i64 %i.adb
  %i.adf = getelementptr inbounds nuw [16 x i8], ptr %i.ade, i64 %indvars.iv ; 2 uses
  %i.adg = getelementptr inbounds nuw [16 x i8], ptr %.0736, i64 %indvars.iv
  %i.adh = load i64, ptr %i.adf, align 8, !tbaa !10
  store i64 %i.adh, ptr %i.adg, align 8, !tbaa !10
  %i.adi = getelementptr inbounds nuw i8, ptr %i.adf, i64 8
  %i.adj = load i32, ptr %i.adi, align 8, !tbaa !9
  br label %bb.fs

bb.fs:                                            ; preds = %bb.fq, %bb.fr
  %.sink951 = phi i32 [ %i.adj, %bb.fr ], [ 0, %bb.fq ]
  %i.adk = getelementptr inbounds nuw [16 x i8], ptr %.0736, i64 %indvars.iv
  %i.adl = getelementptr inbounds nuw i8, ptr %i.adk, i64 8
  store i32 %.sink951, ptr %i.adl, align 8, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.critedge.backedge, label %bb.fq, !llvm.loop !47
...
bb.f:                                             ; preds = %._crit_edge
  ...
  store i32 3, ptr %i.q, align 8, !tbaa !9
  br label %bb.o
...
bb.g:                                             ; preds = %._crit_edge
  ...
  store i32 3, ptr %i.s, align 8, !tbaa !9
  br label %bb.o
...
bb.h:                                             ; preds = %._crit_edge
  ...
  store i32 3, ptr %i.u, align 8, !tbaa !9
  br label %bb.o
...
bb.i:                                             ; preds = %._crit_edge
  ...
  store i32 3, ptr %i.w, align 8, !tbaa !9
  br label %bb.o
...
bb.j:                                             ; preds = %._crit_edge
  ...
  store i32 3, ptr %i.ab, align 8, !tbaa !9
  br label %bb.o

bb.k:                                             ; preds = %._crit_edge
  %i.ac = call double @pow(double noundef %i.o, double noundef %i.n) #8, !tbaa !7
  store double %i.ac, ptr %1, align 8, !tbaa !10
  %i.ad = getelementptr inbounds nuw i8, ptr %1, i64 8
  store i32 3, ptr %i.ad, align 8, !tbaa !9
  br label %bb.o
...
bb.l:                                             ; preds = %._crit_edge
  ...
  store i32 3, ptr %i.af, align 8, !tbaa !9
  br label %bb.o
