...
begin_hunk_0_@symbexec:bb.a
  ...
  %invariant.op = add nuw nsw i32 %i.f, 1
  %invariant.op313 = add nuw nsw i32 %i.f, 1
  br label %bb.f

bb.f:                                             ; preds = %.lr.ph284, %bb.bf
  %.0162282 = phi i32 [ 0, %.lr.ph284 ], [ %i.fc, %bb.bf ] ; 29 uses
...
bb.u:                                             ; preds = %bb.g
  ...
  %i.bz = add nsw i32 %i.by, -131071              ; 4 uses
  %i.ca = and i32 %i.ay, 48
  %i.cb = icmp eq i32 %i.ca, 32
  br i1 %i.cb, label %bb.v, label %.critedge

bb.v:                                             ; preds = %bb.u
  %i.cc = add i32 %i.bz, %.0162282                ; 2 uses
  %i.cd = add i32 %i.cc, 1                        ; 5 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.x
  ...
  %i.cg = getelementptr inbounds [4 x i8], ptr %i.aa, i64 %4
  %i.ch = load i32, ptr %i.cg, align 4, !tbaa !4
  %i.ci = and i32 %i.ch, 8372287
  %or.cond221 = icmp eq i32 %i.ci, 34
  br i1 %or.cond221, label %bb.x, label %._crit_edge.split.loop.exit311
...
._crit_edge.split.loop.exit311:                   ; preds = %.lr.ph
  %5 = trunc nuw nsw i64 %indvars.iv to i32
  br label %._crit_edge

._crit_edge:                                      ; preds = %bb.x, %._crit_edge.split.loop.exit311
  %.0178.lcssa.ph = phi i32 [ %5, %._crit_edge.split.loop.exit311 ], [ %i.cd, %bb.x ]
...
.critedge:                                        ; preds = %bb.r, %bb.q, %bb.o, %bb.n, %checkArgMode.exit, %bb.w, %._crit_edge, %bb.u, %bb.s, %bb.t, %bb.g
  ...
  %.0179 = phi i32 [ %i.bz, %bb.w ], [ %i.bt, %bb.t ], [ %i.bt, %bb.s ], [ 0, %bb.g ], [ %i.bz, %bb.u ], [ %i.bz, %._crit_edge ], [ %i.ba, %checkArgMode.exit ], [ %i.ba, %bb.n ], [ %i.ba, %bb.o ], [ %i.ba, %bb.q ], [ %i.ba, %bb.r ] ; 15 uses
  %i.cl = and i8 %i.ax, 64
  %.not197 = icmp ne i8 %i.cl, 0
  %i.cm = icmp eq i32 %i.as, %2
  %or.cond222 = and i1 %i.cm, %.not197
  %.1169 = select i1 %or.cond222, i32 %.0162282, i32 %.0168281 ; 16 uses
...
bb.ao:                                            ; preds = %bb.an, %bb.aa
  %i.dp = add i32 %.0179, %.0162282               ; 2 uses
  ...
  %i.dt = select i1 %or.cond227, i32 %.0162282, i32 %i.dp
  br label %bb.bf
...
bb.au:                                            ; preds = %bb.aa
  %6 = icmp sgt i32 %.0179, 1
  %i.ec = add nuw nsw i32 %i.as, %.0179
  %.not205 = icmp sgt i32 %i.ec, %invariant.op313
  %or.cond314 = select i1 %6, i1 %.not205, i1 false
  br i1 %or.cond314, label %precheck.exit.thread, label %bb.bf
...
bb.be:                                            ; preds = %bb.bc
  %.old = add nsw i32 %.0179, %i.as
  %.not202.old = icmp sgt i32 %.old, %invariant.op
  br i1 %.not202.old, label %precheck.exit.thread, label %bb.bf

bb.bf:                                            ; preds = %luaG_checkopenop.exit241, %._crit_edge280, %bb.ae, %bb.at, %bb.am, %bb.ai, %bb.aa, %bb.be, %bb.aw, %bb.ax, %bb.au, %bb.aj, %bb.ag, %bb.af, %bb.ab, %bb.ad, %bb.ao
  %.2170 = phi i32 [ %.1169, %bb.aa ], [ %.1169, %bb.ad ], [ %.1169, %bb.be ], [ %.1169, %bb.ab ], [ %.1169, %bb.au ], [ %.1169, %._crit_edge280 ], [ %.1169, %luaG_checkopenop.exit241 ], [ %.1169, %bb.af ], [ %.1169, %bb.ag ], [ %.1169, %bb.aw ], [ %spec.select231, %bb.ae ], [ %.1169, %bb.aj ], [ %spec.select, %bb.ai ], [ %.1169, %bb.ax ], [ %.1169, %bb.ao ], [ %spec.select225, %bb.am ], [ %spec.select228, %bb.at ] ; 2 uses
  %.4166 = phi i32 [ %.0162282, %bb.aa ], [ %.0162282, %bb.ad ], [ %.0162282, %bb.be ], [ %.0162282, %bb.ab ], [ %.0162282, %bb.au ], [ %spec.select229, %._crit_edge280 ], [ %.0162282, %luaG_checkopenop.exit241 ], [ %.0162282, %bb.af ], [ %.0162282, %bb.ag ], [ %.0162282, %bb.aw ], [ %.0162282, %bb.ae ], [ %.0162282, %bb.aj ], [ %.0162282, %bb.ai ], [ %i.eh, %bb.ax ], [ %i.dt, %bb.ao ], [ %.0162282, %bb.am ], [ %.0162282, %bb.at ]
