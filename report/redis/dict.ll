...
begin_hunk_0_@dictCombineStats:vector.memcheck
  %i.cd = getelementptr inbounds nuw i8, ptr %i.u, i64 304
  %wide.load.9 = load <2 x i64>, ptr %i.cc, align 8, !tbaa !20, !alias.scope !115
  %wide.load23.9 = load <2 x i64>, ptr %i.cd, align 8, !tbaa !20, !alias.scope !115
  %i.ce = getelementptr inbounds nuw i8, ptr %i.w, i64 288 ; 2 uses
  %i.cf = getelementptr inbounds nuw i8, ptr %i.w, i64 304 ; 2 uses
  %wide.load24.9 = load <2 x i64>, ptr %i.ce, align 8, !tbaa !20, !alias.scope !118, !noalias !115
  %wide.load25.9 = load <2 x i64>, ptr %i.cf, align 8, !tbaa !20, !alias.scope !118, !noalias !115
  %i.cg = add <2 x i64> %wide.load24.9, %wide.load.9
  %i.ch = add <2 x i64> %wide.load25.9, %wide.load23.9
...
bb.d:                                             ; preds = %bb.c
  ...
  %4 = load i64, ptr %i.s, align 8, !tbaa !125
  %5 = uitofp i64 %i.p to float
  %i.t = load i64, ptr %i.a, align 8, !tbaa !113
  %i.u = uitofp i64 %i.t to float
  %i.v = uitofp i64 %4 to float
  %6 = insertelement <2 x float> poison, float %i.v, i64 0
  %7 = insertelement <2 x float> %6, float %i.u, i64 1
  ...
  %i.w = fpext float %13 to double
  %i.x = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef %i.m, i64 noundef %i.n, ptr noundef nonnull @.str.15, i64 noundef %i.p, i64 noundef %i.r, double noundef %12, double noundef %i.w) #21
...
bb.e:                                             ; preds = %bb.d, %bb.h
  %.053 = phi i64 [ 0, %bb.d ], [ %i.aq, %bb.h ]  ; 3 uses
  %.04652 = phi i64 [ %i.z, %bb.d ], [ %.1, %bb.h ] ; 5 uses
  %i.ab = load ptr, ptr %i.aa, align 8, !tbaa !108
  %i.ac = getelementptr inbounds nuw [8 x i8], ptr %i.ab, i64 %.053
...
bb.g:                                             ; preds = %bb.f
  %i.af = getelementptr inbounds nuw i8, ptr %0, i64 %.04652
  %i.ag = sub nuw i64 %1, %.04652
  %i.ah = uitofp i64 %i.ad to float
  %i.ai = load i64, ptr %i.i, align 8, !tbaa !123
  %i.aj = uitofp i64 %i.ai to float
  %i.ak = fdiv float %i.ah, %i.aj
  %i.al = fmul float %i.ak, 1.000000e+02
  %i.am = fpext float %i.al to double
  %i.an = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef %i.af, i64 noundef %i.ag, ptr noundef nonnull @.str.16, i64 noundef %.053, i64 noundef %i.ad, double noundef %i.am) #21
  %i.ao = sext i32 %i.an to i64
  %i.ap = add i64 %.04652, %i.ao
  br label %bb.h

bb.h:                                             ; preds = %bb.e, %bb.g
  %.1 = phi i64 [ %.04652, %bb.e ], [ %i.ap, %bb.g ]
  %i.aq = add nuw nsw i64 %.053, 1                ; 2 uses
  %exitcond.not = icmp eq i64 %i.aq, 49
...
.loopexit:                                        ; preds = %bb.h, %bb.f, %bb.c
  ...
  %i.at = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #25
  br label %bb.i

bb.i:                                             ; preds = %.loopexit, %bb.b
  %.047 = phi i64 [ %i.h, %bb.b ], [ %i.at, %.loopexit ]
  ret i64 %.047
}
