...
begin_hunk_0_@dictGetSomeKeys:bb.a
  ...
  %spec.select122 = tail call i64 @llvm.umin.i64(i64 %i.e, i64 %i.f) ; 11 uses
...
bb.g:                                             ; preds = %bb.p
  ...
  br i1 %.not109, label %..critedge.loopexit148_crit_edge, label %.preheader124.preheader, !llvm.loop !97
...
.loopexit:                                        ; preds = %dictGetNext.exit, %dictGetNext.exit.thread
  %i.bp = phi i64 [ %i.bm, %dictGetNext.exit.thread ], [ %i.bo, %dictGetNext.exit ] ; 2 uses
  %.not113 = icmp ult i64 %i.bp, %spec.select122
  br i1 %.not113, label %.thread, label %.critedge

.thread:                                          ; preds = %.loopexit, %bb.m, %bb.l, %bb.j, %bb.i
  %.591 = phi i64 [ %.187135, %bb.j ], [ %.187135, %bb.i ], [ %.187135, %bb.m ], [ %.187135, %bb.l ], [ %i.bp, %.loopexit ] ; 4 uses
...
..critedge.loopexit148_crit_edge:                 ; preds = %bb.g
  %3 = tail call i64 @llvm.umin.i64(i64 %.591, i64 %spec.select122)
  br label %.critedge

..critedge.loopexit148_crit_edge163:              ; preds = %bb.p
  br label %.critedge, !llvm.loop !97

.critedge:                                        ; preds = %.loopexit, %.lr.ph143, %..critedge.loopexit148_crit_edge, %..critedge.loopexit148_crit_edge163, %bb.f
  %.6 = phi i64 [ 0, %.lr.ph143 ], [ 0, %bb.f ], [ %spec.select122, %..critedge.loopexit148_crit_edge163 ], [ %3, %..critedge.loopexit148_crit_edge ], [ %spec.select122, %.loopexit ]
  %i.br = trunc nuw i64 %.6 to i32
  ret i32 %i.br
}
