...
bb.c:                                             ; preds = %bb.d, %bb.b
  %.0 = phi i32 [ 0, %bb.b ], [ %i.f, %bb.d ]     ; 2 uses
...
..loopexit.loopexit_crit_edge:                    ; preds = %bb.c
  %.0.lcssa.a = phi i32 [ %.0, %bb.c ]
  br label %.loopexit.loopexit

.loopexit.loopexit:                               ; preds = %.loopexit.loopexitsplit, %..loopexit.loopexit_crit_edge
  %.05.ph = phi i32 [ %.0.lcssa.a, %..loopexit.loopexit_crit_edge ], [ %.lcssa, %.loopexit.loopexitsplit ]
  br label %.loopexit
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %lsr.iv30 = phi i64 [ %lsr.iv, %scalar.ph.preheader ], [ %lsr.iv.next31, %scalar.ph ] ; 13 uses
...
bb.e:                                             ; preds = %bb.d, %dictGetNext.exit
  %lsr.iv.a = phi i64 [ 1, %bb.d ], [ %lsr.iv.next, %dictGetNext.exit ] ; 3 uses
...
dictGetNext.exit.threadsplit:                     ; preds = %dictGetNext.exit
  %lsr.iv.lcssa54 = phi i64 [ %lsr.iv.a, %dictGetNext.exit ]
  br label %dictGetNext.exit.thread

.dictGetNext.exit.thread_crit_edge:               ; preds = %bb.e
  %lsr.iv.lcssa.a = phi i64 [ %lsr.iv.a, %bb.e ]
  br label %dictGetNext.exit.thread

dictGetNext.exit.thread:                          ; preds = %dictGetNext.exit.threadsplit, %.dictGetNext.exit.thread_crit_edge
  %.lcssa = phi i64 [ %lsr.iv.lcssa.a, %.dictGetNext.exit.thread_crit_edge ], [ %lsr.iv.lcssa54, %dictGetNext.exit.threadsplit ] ; 3 uses
...
bb.e:                                             ; preds = %dictGetNext.exit.i, %bb.d
  %lsr.iv.a = phi i64 [ %lsr.iv.next, %dictGetNext.exit.i ], [ 1, %bb.d ] ; 3 uses
...
dictGetNext.exit.thread.i:                        ; preds = %dictGetNext.exit.thread.isplit, %dictGetNext.exit.i.dictGetNext.exit.thread.i_crit_edge
  %.lcssa49 = phi i64 [ %lsr.iv.lcssa50.a, %dictGetNext.exit.i.dictGetNext.exit.thread.i_crit_edge ], [ %lsr.iv.lcssa, %dictGetNext.exit.thread.isplit ] ; 3 uses
...
bb.k:                                             ; preds = %dictGetNext.exit.i35, %bb.j
  %lsr.iv51 = phi i64 [ %lsr.iv.next52, %dictGetNext.exit.i35 ], [ 1, %bb.j ] ; 3 uses
...
dictGetNext.exit.i35:                             ; preds = %bb.k
  ...
  %lsr.iv.next52 = add i64 %lsr.iv51, 1
...
dictGetNext.exit.thread.i32split:                 ; preds = %bb.k
  %lsr.iv51.lcssa = phi i64 [ %lsr.iv51, %bb.k ]
...
dictGetNext.exit.i35.dictGetNext.exit.thread.i32_crit_edge: ; preds = %dictGetNext.exit.i35
  %lsr.iv51.lcssa53 = phi i64 [ %lsr.iv51, %dictGetNext.exit.i35 ]
...
dictGetNext.exit.thread.i32:                      ; preds = %dictGetNext.exit.thread.i32split, %dictGetNext.exit.i35.dictGetNext.exit.thread.i32_crit_edge
  %.lcssa = phi i64 [ %lsr.iv51.lcssa53, %dictGetNext.exit.i35.dictGetNext.exit.thread.i32_crit_edge ], [ %lsr.iv51.lcssa, %dictGetNext.exit.thread.i32split ] ; 3 uses
