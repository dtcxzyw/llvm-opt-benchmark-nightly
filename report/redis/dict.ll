...
bb.d:                                             ; preds = %bb.c
  ...
  %4 = fdiv float %i.u, %i.v
  %5 = fpext float %4 to double
  %6 = load i64, ptr %i.a, align 8, !tbaa !113
  %7 = uitofp i64 %6 to float
  %8 = fdiv float %7, %i.v
  %i.w = fpext float %8 to double
  %i.x = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef %i.m, i64 noundef %i.n, ptr noundef nonnull @.str.15, i64 noundef %i.p, i64 noundef %i.r, double noundef %5, double noundef %i.w) #21
