...
bb.d:                                             ; preds = %bb.c
  ...
  %4 = fpext <2 x float> %i.ac to <2 x double>    ; 2 uses
  %5 = extractelement <2 x double> %4, i64 0
  %6 = extractelement <2 x double> %4, i64 1
  %i.ad = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef %i.m, i64 noundef %i.n, ptr noundef nonnull @.str.15, i64 noundef %i.p, i64 noundef %i.r, double noundef %5, double noundef %6) #21
