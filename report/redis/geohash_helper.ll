...
bb.d:                                             ; preds = %bb.b, %bb.c
  ...
  %2 = fdiv double %i.r, f0x3F91DF46A2529D39      ; 2 uses
  %3 = fdiv double %i.q, f0x41584F6F63E51090
  %i.s = fadd double %i.d, %2                     ; 2 uses
  %i.t = fmul double %i.s, f0x3F91DF46A2529D39
  %i.u = tail call double @cos(double noundef %i.t) #10, !tbaa !9
  %i.v = fsub double %i.d, %2                     ; 2 uses
...
geohashBoundingBox.exit:                          ; preds = %bb.a, %bb.b
  ...
  %11 = fdiv double %i.s, f0x3F91DF46A2529D39     ; 2 uses
  %12 = fdiv double %i.r, f0x41584F6F63E51090
  %i.t = fadd double %i.e, %11                    ; 4 uses
  %i.u = fmul double %i.t, f0x3F91DF46A2529D39
  %i.v = tail call double @cos(double noundef %i.u) #10, !tbaa !9
  %i.w = fsub double %i.e, %11                    ; 4 uses
