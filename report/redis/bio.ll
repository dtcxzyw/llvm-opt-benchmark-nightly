...
switch.lookup:                                    ; preds = %bb.a
  %switch.offset.a = or disjoint i32 %0, 4        ; 2 uses
...
begin_hunk_1_@bioCreateCompRq:bb.a
  ...
  %4 = zext nneg i32 %switch.offset.a to i64      ; 2 uses
  %i.f = getelementptr inbounds nuw [4 x i8], ptr @bio_job_to_worker, i64 %4
...
begin_hunk_2_@bioCreateCompRq:bb.a
  ...
  %i.n = getelementptr inbounds nuw [8 x i8], ptr @bio_jobs_counter, i64 %4 ; 2 uses
