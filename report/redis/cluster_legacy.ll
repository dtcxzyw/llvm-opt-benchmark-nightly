...
.critedge.us:                                     ; preds = %.critedge.us.preheader, %bb.c
  ...
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %bb.c ], [ %i.a, %.critedge.us.preheader ] ; 6 uses
...
.lr.ph.split:                                     ; preds = %.lr.ph.split.preheader, %bb.e
  ...
  %indvars.iv = phi i64 [ %indvars.iv.next, %bb.e ], [ %i.a, %.lr.ph.split.preheader ] ; 6 uses
...
.loopexit.sink.split.loopexitsplit:               ; preds = %bb.b
  ...
  %.str.196.sink.ph.ph = phi ptr [ @.str.196, %bb.b ]
  br label %.loopexit.sink.split.loopexit

.critedge.us..loopexit.sink.split.loopexit_crit_edge: ; preds = %.critedge.us
  %indvars.iv34.lcssa69 = phi i64 [ %indvars.iv34, %.critedge.us ]
  %indvars.iv34.lcssa69.a = phi i64 [ %indvars.iv34, %.critedge.us ] ; 0 uses
  %split68 = phi ptr [ @.str.195, %.critedge.us ]
  br label %.loopexit.sink.split.loopexit

.loopexit.sink.split.loopexit:                    ; preds = %.loopexit.sink.split.loopexitsplit, %.critedge.us..loopexit.sink.split.loopexit_crit_edge
  %indvars.iv34.lcssa = phi i64 [ %indvars.iv34.lcssa69, %.critedge.us..loopexit.sink.split.loopexit_crit_edge ], [ %indvars.iv34.lcssa70, %.loopexit.sink.split.loopexitsplit ]
  %.str.196.sink.ph = phi ptr [ %split68, %.critedge.us..loopexit.sink.split.loopexit_crit_edge ], [ %.str.196.sink.ph.ph, %.loopexit.sink.split.loopexitsplit ]
  br label %.loopexit.sink.split

.loopexit.sink.split.loopexit58split:             ; preds = %bb.d
  %indvars.iv.lcssa64.a = phi i64 [ %indvars.iv, %bb.d ]
  %.str.196.sink.ph59.ph = phi ptr [ @.str.196, %bb.d ]
  br label %.loopexit.sink.split.loopexit58

.lr.ph.split..loopexit.sink.split.loopexit58_crit_edge: ; preds = %.lr.ph.split
  %indvars.iv.lcssa64 = phi i64 [ %indvars.iv, %.lr.ph.split ]
  %indvars.iv.lcssa63 = phi i64 [ %indvars.iv, %.lr.ph.split ] ; 0 uses
  %split63 = phi ptr [ @.str.194, %.lr.ph.split ]
  br label %.loopexit.sink.split.loopexit58
...
.loopexit.sink.split.loopexit58:                  ; preds = %.loopexit.sink.split.loopexit58split, %.lr.ph.split..loopexit.sink.split.loopexit58_crit_edge
  %indvars.iv.lcssa = phi i64 [ %indvars.iv.lcssa64, %.lr.ph.split..loopexit.sink.split.loopexit58_crit_edge ], [ %indvars.iv.lcssa64.a, %.loopexit.sink.split.loopexit58split ]
  %.str.196.sink.ph59 = phi ptr [ %split63, %.lr.ph.split..loopexit.sink.split.loopexit58_crit_edge ], [ %.str.196.sink.ph59.ph, %.loopexit.sink.split.loopexit58split ]
  br label %.loopexit.sink.split
...
.critedge.us.i379:                                ; preds = %.lr.ph.i, %bb.aq
  ...
  %indvars.iv34.i380 = phi i64 [ %indvars.iv.next35.i382, %bb.aq ], [ %i.gq, %.lr.ph.i ] ; 6 uses
...
.loopexit414.loopexitsplit:                       ; preds = %bb.al
  ...
  %.str.196.sink.i377.ph.ph = phi ptr [ @.str.196, %bb.al ]
  br label %.loopexit414.loopexit

.lr.ph.split.i369.us..loopexit414.loopexit_crit_edge: ; preds = %.lr.ph.split.i369.us
  %indvars.iv.i370.us.lcssa685 = phi i64 [ %indvars.iv.i370.us, %.lr.ph.split.i369.us ]
  %indvars.iv.i370.us.lcssa685.a = phi i64 [ %indvars.iv.i370.us, %.lr.ph.split.i369.us ] ; 0 uses
  %split684 = phi ptr [ @.str.194, %.lr.ph.split.i369.us ]
  br label %.loopexit414.loopexit

.loopexit414.loopexit:                            ; preds = %.loopexit414.loopexitsplit, %.lr.ph.split.i369.us..loopexit414.loopexit_crit_edge
  %indvars.iv.i370.us.lcssa = phi i64 [ %indvars.iv.i370.us.lcssa685, %.lr.ph.split.i369.us..loopexit414.loopexit_crit_edge ], [ %indvars.iv.i370.us.lcssa686, %.loopexit414.loopexitsplit ]
  %.str.196.sink.i377.ph = phi ptr [ %split684, %.lr.ph.split.i369.us..loopexit414.loopexit_crit_edge ], [ %.str.196.sink.i377.ph.ph, %.loopexit414.loopexitsplit ]
  br label %.loopexit414

.loopexit414.loopexit649split:                    ; preds = %bb.ap
  %indvars.iv34.i380.lcssa680.a = phi i64 [ %indvars.iv34.i380, %bb.ap ]
  %.str.196.sink.i377.ph650.ph = phi ptr [ @.str.196, %bb.ap ]
  br label %.loopexit414.loopexit649

.critedge.us.i379..loopexit414.loopexit649_crit_edge: ; preds = %.critedge.us.i379
  %indvars.iv34.i380.lcssa680 = phi i64 [ %indvars.iv34.i380, %.critedge.us.i379 ]
  %indvars.iv34.i380.lcssa679 = phi i64 [ %indvars.iv34.i380, %.critedge.us.i379 ] ; 0 uses
  %split679 = phi ptr [ @.str.195, %.critedge.us.i379 ]
  br label %.loopexit414.loopexit649

.loopexit414.loopexit649:                         ; preds = %.loopexit414.loopexit649split, %.critedge.us.i379..loopexit414.loopexit649_crit_edge
  %indvars.iv34.i380.lcssa = phi i64 [ %indvars.iv34.i380.lcssa680, %.critedge.us.i379..loopexit414.loopexit649_crit_edge ], [ %indvars.iv34.i380.lcssa680.a, %.loopexit414.loopexit649split ]
  %.str.196.sink.i377.ph650 = phi ptr [ %split679, %.critedge.us.i379..loopexit414.loopexit649_crit_edge ], [ %.str.196.sink.i377.ph650.ph, %.loopexit414.loopexit649split ]
  br label %.loopexit414
