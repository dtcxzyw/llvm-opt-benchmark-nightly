...
begin_hunk_0_@parseReply:bb.a
  ...
  %i.y = sub i64 %i.x, %i.o
  call void %i.v(ptr noundef %1, ptr noundef nonnull %i.i, i64 noundef %i.y) #6, !inline_history !22
...
begin_hunk_1_@parseReply:bb.a
  ...
  call void %i.ad(ptr noundef %1, ptr noundef %i.z, i64 noundef %i.s, ptr noundef nonnull %i.i, i64 noundef %i.af) #6, !inline_history !22
  br label %parseBulk.exit
...
begin_hunk_2_@parseReply:bb.a
  ...
  tail call void %i.ak(ptr noundef %1, ptr noundef nonnull %i.ag, i64 noundef %i.ao, ptr noundef nonnull %i.i, i64 noundef %i.aq) #6, !inline_history !25
  br label %bb.v
...
begin_hunk_3_@parseReply:bb.a
  ...
  tail call void %i.av(ptr noundef %1, ptr noundef nonnull %i.ar, i64 noundef %i.az, ptr noundef nonnull %i.i, i64 noundef %i.bb) #6, !inline_history !27
  br label %bb.v
...
begin_hunk_4_@parseReply:bb.a
  ...
  call void %i.bl(ptr noundef %1, i64 noundef %i.bm, ptr noundef nonnull %i.i, i64 noundef %i.bp) #6, !inline_history !29
...
bb.i:                                             ; preds = %bb.h
  ...
  call void %i.cb(ptr noundef %1, ptr noundef nonnull %i.i, i64 noundef %i.cd) #6, !inline_history !31
  br label %parseArray.exit

bb.j:                                             ; preds = %bb.h
  %i.ce = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.cf = load ptr, ptr %i.ce, align 8, !tbaa !32
  call void %i.cf(ptr noundef nonnull %0, ptr noundef %1, i64 noundef %i.by, ptr noundef nonnull %i.i) #6, !inline_history !31
  br label %parseArray.exit
...
begin_hunk_6_@parseReply:bb.a
  ...
  call void %i.cp(ptr noundef nonnull %0, ptr noundef %1, i64 noundef %i.cq, ptr noundef nonnull %i.i) #6, !inline_history !34
...
begin_hunk_7_@parseReply:bb.a
  ...
  call void %i.da(ptr noundef nonnull %0, ptr noundef %1, i64 noundef %i.db, ptr noundef nonnull %i.i) #6, !inline_history !36
...
begin_hunk_8_@parseReply:bb.a
  ...
  tail call void %i.dg(ptr noundef %1, i32 noundef %i.dj, ptr noundef nonnull %i.i, i64 noundef %i.dm) #6, !inline_history !38
  br label %bb.v
...
begin_hunk_9_@parseReply:bb.a
  ...
  call void %i.dz(ptr noundef %1, double noundef %.0.i, ptr noundef nonnull %i.i, i64 noundef %i.eb) #6, !inline_history !40
...
begin_hunk_10_@parseReply:bb.a
  ...
  tail call void %i.eg(ptr noundef %1, ptr noundef nonnull %i.i, i64 noundef %i.ej) #6, !inline_history !42
  br label %bb.v
...
begin_hunk_11_@parseReply:bb.a
  ...
  tail call void %i.eo(ptr noundef %1, ptr noundef nonnull %i.ek, i64 noundef %i.es, ptr noundef nonnull %i.i, i64 noundef %i.eu) #6, !inline_history !44
  br label %bb.v
...
begin_hunk_12_@parseReply:bb.a
  ...
  %i.fi = load ptr, ptr %i.fh, align 8, !tbaa !45
  ...
  call void %i.fi(ptr noundef %1, ptr noundef %i.fd, ptr noundef nonnull %i.fj, i64 noundef %i.fk, ptr noundef nonnull %i.i, i64 noundef %i.fm) #6, !inline_history !46
...
begin_hunk_13_@parseReply:bb.a
  ...
  call void %i.fw(ptr noundef nonnull %0, ptr noundef %1, i64 noundef %i.fx, ptr noundef nonnull %i.i) #6, !inline_history !48
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #6
  br label %bb.v

bb.t:                                             ; preds = %bb.a
  %i.fy = getelementptr inbounds nuw i8, ptr %0, i64 128
  %i.fz = load ptr, ptr %i.fy, align 8, !tbaa !49 ; 2 uses
