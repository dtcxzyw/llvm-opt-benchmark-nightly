...
bb.f:                                             ; preds = %zsetLength.exit
  ...
  %spec.select105 = select i1 %.not95, i64 %.080, i64 %i.af
...
bb.j:                                             ; preds = %.lr.ph185, %zzlPrev.exit
  %i.aw = phi i64 [ %i.ag, %.lr.ph185 ], [ %i.bs, %zzlPrev.exit ] ; 2 uses
  %.084184 = phi double [ 0.000000e+00, %.lr.ph185 ], [ %.185, %zzlPrev.exit ]
  %.0183 = phi ptr [ %i.at, %.lr.ph185 ], [ %.1160, %zzlPrev.exit ] ; 3 uses
  %.0161182 = phi ptr [ %i.as, %.lr.ph185 ], [ %.1162, %zzlPrev.exit ] ; 3 uses
  %i.ax = icmp ne ptr %.0161182, null
  %i.ay = icmp ne ptr %.0183, null
...
bb.l:                                             ; preds = %bb.j
  %i.ba = call ptr @lpGetValue(ptr noundef nonnull %.0161182, ptr noundef nonnull %i.d, ptr noundef nonnull %i.e) #17 ; 2 uses
  br i1 %.not104, label %bb.p, label %bb.m

bb.m:                                             ; preds = %bb.l
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #17
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #17
  %i.bb = call ptr @lpGetValue(ptr noundef nonnull %.0183, ptr noundef nonnull %i.b, ptr noundef nonnull %i.c) #17 ; 2 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  call void %i.bj(ptr noundef nonnull %0, i64 noundef %i.bk, double noundef %.185) #17
  br label %bb.s
...
bb.r:                                             ; preds = %bb.p
  ...
  call void %i.bl(ptr noundef nonnull %0, ptr noundef nonnull %i.ba, i64 noundef %i.bn, double noundef %.185) #17
  br label %bb.s
...
bb.t:                                             ; preds = %bb.s
  %i.bo = call ptr @lpPrev(ptr noundef %i.ap, ptr noundef nonnull %.0161182) #17 ; 3 uses
...
bb.w:                                             ; preds = %bb.s
  %i.bq = call ptr @lpNext(ptr noundef %i.ap, ptr noundef nonnull %.0183) #17 ; 3 uses
...
zzlPrev.exit:                                     ; preds = %bb.x, %bb.w, %bb.u, %bb.t
  %.1162 = phi ptr [ null, %bb.t ], [ %i.bp, %bb.u ], [ null, %bb.w ], [ %i.bq, %bb.x ]
  %.1160 = phi ptr [ null, %bb.t ], [ %i.bo, %bb.u ], [ null, %bb.w ], [ %i.br, %bb.x ]
...
zslGetElementByRank.exit:                         ; preds = %.critedge.i.i, %bb.ac, %.critedge.i.i130, %bb.af, %.critedge.i.thread.i146, %bb.ae, %.lr.ph.split.us.i.i134, %.critedge.thread.i.i, %.critedge.i.thread.i, %bb.ab, %bb.ad, %bb.aa
  %.079 = phi ptr [ %i.dh, %bb.ad ], [ %i.by, %bb.aa ], [ null, %.lr.ph.split.us.i.i134 ], [ null, %bb.ab ], [ %spec.select.i, %.critedge.i.thread.i ], [ %spec.select.i.i, %.critedge.thread.i.i ], [ %.120.lcssa.i.i131, %.critedge.i.i130 ], [ null, %bb.ae ], [ %spec.select.i149, %.critedge.i.thread.i146 ], [ null, %bb.af ], [ null, %bb.ac ], [ %.120.lcssa.i.i, %.critedge.i.i ]
  %.not99179 = icmp eq i64 %i.ah, 0
  br i1 %.not99179, label %.loopexit, label %.lr.ph
...
bb.ag:                                            ; preds = %.lr.ph, %sdslen.exit
  ...
  %.1180 = phi ptr [ %.079, %.lr.ph ], [ %i.fj, %sdslen.exit ] ; 5 uses
  %.not100 = icmp eq ptr %.1180, null
...
bb.ai:                                            ; preds = %bb.ag
  %i.eo = getelementptr inbounds nuw i8, ptr %.1180, i64 24
  %i.ep = load i16, ptr %i.eo, align 2, !tbaa !13
  %i.eq = zext i16 %i.ep to i64
  %i.er = getelementptr inbounds nuw i8, ptr %.1180, i64 %i.eq ; 6 uses
...
bb.j:                                             ; preds = %bb.i, %bb.h
  %.0158 = phi i64 [ %i.ac, %bb.i ], [ 0, %bb.h ]
  %i.ad = icmp eq i64 %.0, 1
...
bb.l:                                             ; preds = %bb.k
  ...
  %spec.select = shl nuw i64 %.0, %i.ah
  br label %bb.m
...
bb.ae:                                            ; preds = %bb.m
  %i.ch = tail call i64 @llvm.umin.i64(i64 %.0, i64 1000) ; 2 uses
...
bb.ag:                                            ; preds = %bb.af, %bb.ae
  %.0160 = phi ptr [ %i.ck, %bb.af ], [ null, %bb.ae ] ; 3 uses
...
bb.ah:                                            ; preds = %bb.ag, %bb.ah
  ...
  tail call fastcc void @zrandmemberReplyWithListpack(ptr noundef nonnull %0, i32 noundef %i.cq, ptr noundef %i.cj, ptr noundef %.0160)
...
bb.ak:                                            ; preds = %bb.aj
  ...
  %spec.select239 = shl nuw nsw i64 %i.dc, %i.dg
  br label %bb.al

bb.al:                                            ; preds = %bb.ak, %bb.aj
  %.sink = phi i64 [ %i.dc, %bb.aj ], [ %spec.select239, %bb.ak ]
...
bb.be:                                            ; preds = %bb.bd, %bb.bc
  %.0161 = phi ptr [ %i.eu, %bb.bd ], [ null, %bb.bc ] ; 3 uses
  %i.ev = getelementptr inbounds nuw i8, ptr %i.g, i64 8
  %i.ew = load ptr, ptr %i.ev, align 8, !tbaa !75
  %i.ex = trunc i64 %1 to i32                     ; 2 uses
  %i.ey = tail call i32 @lpRandomPairsUnique(ptr noundef %i.ew, i32 noundef %i.ex, ptr noundef %i.et, ptr noundef %.0161, i32 noundef 2) #17
...
bb.bg:                                            ; preds = %bb.be
  tail call fastcc void @zrandmemberReplyWithListpack(ptr noundef nonnull %0, i32 noundef %i.ex, ptr noundef %i.et, ptr noundef %.0161)
  tail call void @zfree(ptr noundef %i.et) #17
  tail call void @zfree(ptr noundef %.0161) #17
  call void @zuiClearIterator(ptr noundef nonnull %3)
  br label %.loopexit
end_hunk_3
