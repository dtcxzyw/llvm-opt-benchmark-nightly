...
begin_hunk_2_@zslInsertNode:bb.a
  ...
  %i.dz = sub i64 %2, %i.dv
  store i64 %i.dz, ptr %i.ds, align 8, !tbaa !26
...
._crit_edge315:                                   ; preds = %.lr.ph298.split.us, %.critedge2, %bb.j
  ...
  %.1.lcssa = phi i64 [ %.0.lcssa246, %bb.j ], [ %.1314, %.lr.ph298.split.us ], [ %.2.lcssa, %.critedge2 ] ; 2 uses
  %i.cs = add nsw i64 %.1.lcssa, %2               ; 2 uses
...
bb.n:                                             ; preds = %bb.m
  %4 = add nuw i64 %2, 1
  %i.do = sub i64 %4, %.0.lcssa246
  %i.dp = add i64 %i.do, %.1.lcssa                ; 7 uses
...
bb.p:                                             ; preds = %zslGetElementByRankFromNode.exit.thread186
  ...
  br i1 %.not214, label %zslIsInRange.exit.thread, label %5

5:                                                ; preds = %bb.p
  %6 = add nsw i64 %i.cs, 1
...
bb.s:                                             ; preds = %bb.r
  ...
  %8 = sub i64 %7, %.0.lcssa246
  %i.gd = add i64 %8, %.3.lcssa                   ; 7 uses
...
bb.v:                                             ; preds = %bb.u
  %9 = add nsw i64 %2, 1
  %i.hi = add nsw i64 %9, %.3.lcssa
  br label %zslIsInRange.exit.thread.sink.split

zslIsInRange.exit.thread.sink.split:              ; preds = %bb.v, %5
  %.sink = phi i64 [ %6, %5 ], [ %i.hi, %bb.v ]
  %.0103.ph = phi ptr [ %.4102188, %5 ], [ %.8206, %bb.v ]
...
._crit_edge381:                                   ; preds = %.critedge2, %bb.aj
  ...
  %.1.lcssa = phi i64 [ %.0.lcssa292, %bb.aj ], [ %.2.lcssa, %.critedge2 ] ; 2 uses
  %i.fw = add nsw i64 %.1.lcssa, %2               ; 2 uses
...
bb.bb:                                            ; preds = %bb.ba
  %4 = add nuw i64 %2, 1
  %i.gs = sub i64 %4, %.0.lcssa292
  %i.gt = add i64 %i.gs, %.1.lcssa                ; 7 uses
...
zslLexValueLteMax.exit.thread:                    ; preds = %bb.bl, %bb.bj, %bb.bi, %bb.bh, %bb.bf, %bb.be, %zslLexValueLteMax.exit
  ...
  br i1 %.not260, label %zslIsInLexRange.exit.thread, label %5

5:                                                ; preds = %zslLexValueLteMax.exit.thread
  %6 = add nsw i64 %i.fw, 1
...
bb.cg:                                            ; preds = %bb.cf
  %7 = add nuw nsw i64 %2, 1
  %8 = sub i64 %7, %.0.lcssa292
  %i.lu = add i64 %8, %.3.lcssa                   ; 7 uses
...
bb.cq:                                            ; preds = %zslLexValueGteMin.exit191.thread248
  %9 = add nsw i64 %2, 1
  %i.nt = add nsw i64 %9, %.3.lcssa
  br label %zslIsInLexRange.exit.thread.sink.split

zslIsInLexRange.exit.thread.sink.split:           ; preds = %bb.cq, %5
  %.sink = phi i64 [ %6, %5 ], [ %i.nt, %bb.cq ]
  %.0103.ph = phi ptr [ %.4102218, %5 ], [ %.8244, %bb.cq ]
  store i64 %.sink, ptr %3, align 8, !tbaa !24
...
begin_hunk_13_@zsetAllocSize:bb.a
  ...
  %1 = add i64 %i.p, 72
  %2 = tail call i64 @dictMemUsage(ptr noundef %i.l) #18
  %i.q = add i64 %1, %2
  br label %bb.g
...
.lr.ph258:                                        ; preds = %.thread203
  %2 = add nuw nsw i32 %.0170.lcssa, 1
...
begin_hunk_17_@zaddGenericCommand:bb.a
  ...
  %3 = getelementptr inbounds nuw i8, ptr %i.ch, i64 %.idx281
  %i.ci = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %i.ce
...
begin_hunk_22_@zdiff:bb.a
  ...
  %i.ev = add i64 %.0.i.i36.us.i, 1
  %i.ew = add i64 %i.ev, %.0.i28.i.us.i           ; 2 uses
...
begin_hunk_23_@zlexcountCommand:bb.a
  ...
  %.neg58 = add i64 %i.ap, 1
  %2 = sub i64 %.neg58, %i.aq                     ; 2 uses
...
bb.t:                                             ; preds = %bb.r, %bb.s, %bb.q
  %.2 = phi i64 [ %i.au, %bb.s ], [ %2, %bb.r ], [ 0, %bb.q ]
