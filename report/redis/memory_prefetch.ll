...
bb.ak:                                            ; preds = %bb.aj
  %i.ih = tail call ptr %i.ig(ptr noundef %i.ho) #10, !inline_history !111 ; 2 uses
...
prefetchBucket.exit.i:                            ; preds = %bb.an, %bb.am, %bb.ag, %bb.af, %prefetchEntry.exit.i, %bb.z, %bb.y
  ...
  br label %initBatchInfo.exit.i, !llvm.loop !112
...
bb.a:
  ...
  br i1 %.not, label %.loopexit, label %bb.b, !prof !113
...
begin_hunk_4_@addCommandToBatch:bb.a
  ...
  %.01833 = load ptr, ptr %.018.in32, align 8, !tbaa !115 ; 2 uses
...
begin_hunk_5_@addCommandToBatch:bb.a
  ...
  %i.v = load i32, ptr %i.u, align 8, !tbaa !116  ; 2 uses
  %i.w = and i32 %i.v, 1
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.aa = load i8, ptr %i.z, align 8, !tbaa !120
...
bb.j:                                             ; preds = %bb.i
  ...
  br i1 %.not29, label %bb.k, label %.preheader, !prof !113

.preheader:                                       ; preds = %bb.j
  %i.ac = getelementptr inbounds nuw i8, ptr %.01835, i64 40 ; 2 uses
  %i.ad = load i32, ptr %i.ac, align 8, !tbaa !121
...
.critedge:                                        ; preds = %bb.l, %bb.m, %.preheader
  ...
  %.018 = load ptr, ptr %.018.in, align 8, !tbaa !115 ; 2 uses
  %.not25 = icmp eq ptr %.018, null
  br i1 %.not25, label %.loopexit, label %bb.g, !llvm.loop !122

bb.m:                                             ; preds = %bb.l
  %i.ao = load ptr, ptr %i.af, align 8, !tbaa !123
  %i.ap = load ptr, ptr %i.ag, align 8, !tbaa !124
...
begin_hunk_7_@addCommandToBatch:bb.a
  ...
  %i.ay = load ptr, ptr %i.s, align 8, !tbaa !127
  %i.az = load ptr, ptr %i.ay, align 8, !tbaa !128
  %i.ba = load i32, ptr %i.ah, align 4, !tbaa !131
...
begin_hunk_8_@addCommandToBatch:bb.a
  ...
  %i.bj = load i32, ptr %i.ac, align 8, !tbaa !121
  %i.bk = sext i32 %i.bj to i64
  %i.bl = icmp slt i64 %indvars.iv.next, %i.bk
  br i1 %i.bl, label %bb.l, label %.critedge, !llvm.loop !132
...
!115 = !{!66, !66, i64 0}
!116 = !{!117, !10, i64 112}
!117 = !{!"pendingCommand", !10, i64 0, !10, i64 4, !64, i64 8, !18, i64 16, !35, i64 24, !68, i64 32, !118, i64 40, !35, i64 104, !10, i64 112, !10, i64 116, !11, i64 120, !66, i64 128, !66, i64 136}
!118 = !{!"", !10, i64 0, !10, i64 4, !11, i64 8, !15, i64 56}
!119 = !{!117, !68, i64 32}
!120 = !{!117, !11, i64 120}
!121 = !{!117, !10, i64 40}
!122 = distinct !{!122, !79}
...
!124 = !{!117, !15, i64 96}
!125 = !{!126, !10, i64 0}
!126 = !{!"", !10, i64 0, !10, i64 4}
!127 = !{!62, !31, i64 32}
!128 = !{!129, !53, i64 0}
!129 = !{!"redisDb", !53, i64 0, !53, i64 8, !130, i64 16, !32, i64 24, !32, i64 32, !32, i64 40, !32, i64 48, !32, i64 56, !32, i64 64, !10, i64 72, !35, i64 80, !18, i64 88}
!130 = !{!"p1 _ZTS7_estore", !15, i64 0}
!131 = !{!117, !10, i64 116}
!132 = distinct !{!132, !79}
end_hunk_9
