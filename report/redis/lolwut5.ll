...
.lr.ph.split.us:                                  ; preds = %.lr.ph.split.us.preheader, %.lr.ph.split.us
  ...
  %.not.us = trunc nuw i32 %i.ao to i1
  %i.ap = fneg float %i.al
  %.047.us = select i1 %.not.us, float %i.ap, float %i.al
  %i.aq = tail call i32 @rand() #6
  %i.ar = tail call i32 @rand() #6
  %i.as = sitofp i32 %i.ag to float
  %i.at = insertelement <2 x i32> poison, i32 %i.am, i64 0
  %i.au = insertelement <2 x i32> %i.at, i32 %i.an, i64 1
  %i.av = sitofp <2 x i32> %i.au to <2 x float>
  %i.aw = fmul nnan <2 x float> %i.av, splat (float f0x30000000)
  %i.ax = fdiv <2 x float> %i.aw, %i.s
  %i.ay = fmul <2 x float> %i.ax, %i.ac           ; 2 uses
  %3 = trunc i32 %i.aq to i1
  %4 = insertelement <2 x i1> poison, i1 %3, i64 0
  %5 = trunc i32 %i.ar to i1
  %6 = insertelement <2 x i1> %4, i1 %5, i64 1
  %i.az = fneg <2 x float> %i.ay
  %i.ba = select <2 x i1> %6, <2 x float> %i.az, <2 x float> %i.ay
  %i.bb = fmul <2 x float> %i.u, %i.ba
  %i.bc = fdiv <2 x float> %i.bb, splat (float 3.000000e+00) ; 2 uses
  %i.bd = extractelement <2 x float> %i.bc, i64 0
  %i.be = fadd float %i.bd, %i.as
  %i.bf = fptosi float %i.be to i32
  %i.bg = extractelement <2 x float> %i.bc, i64 1
  %i.bh = fadd float %i.bg, %i.aa
  %i.bi = fptosi float %i.bh to i32
  tail call void @lwDrawSquare(ptr noundef %i.m, i32 noundef %i.bf, i32 noundef %i.bi, float noundef %i.h, float noundef %.047.us, i32 noundef 1) #6
