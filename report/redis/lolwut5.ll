...
.preheader.us:                                    ; preds = %.preheader.lr.ph, %._crit_edge.us
  %.05256.us = phi i32 [ %8, %._crit_edge.us ], [ 0, %.preheader.lr.ph ] ; 3 uses
  ...
  br i1 %i.v, label %.lr.ph.split.us.us, label %.lr.ph.split.us60

.lr.ph.split.us60:                                ; preds = %.preheader.us, %.lr.ph.split.us60
  %.05155.us58 = phi i32 [ %7, %.lr.ph.split.us60 ], [ 0, %.preheader.us ] ; 2 uses
...
._crit_edge.us:                                   ; preds = %.lr.ph.split.us60, %.lr.ph.split.us.us
  %8 = add nuw nsw i32 %.05256.us, 1              ; 2 uses
  %exitcond64.not = icmp eq i32 %8, %2
  br i1 %exitcond64.not, label %._crit_edge57, label %.preheader.us, !llvm.loop !16
...
.lr.ph.split.us.us:                               ; preds = %.preheader.us, %.lr.ph.split.us.us
  ...
  br i1 %exitcond63.not, label %._crit_edge.us, label %.lr.ph.split.us.us, !llvm.loop !14

._crit_edge57:                                    ; preds = %._crit_edge.us, %.preheader.lr.ph, %bb.a
  ret ptr %i.m
}
