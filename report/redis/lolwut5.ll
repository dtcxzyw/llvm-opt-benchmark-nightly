...
.lr.ph.split.us:                                  ; preds = %.lr.ph.split.us.preheader, %.lr.ph.split.us
  ...
  %3 = and i32 %i.ao, 1
  %.not.us = icmp eq i32 %3, 0
  %i.ap = fneg float %i.al
  %.047.us = select i1 %.not.us, float %i.al, float %i.ap
  ...
  %4 = insertelement <2 x i32> poison, i32 %i.aq, i64 0
  %5 = insertelement <2 x i32> %4, i32 %i.ar, i64 1
  %6 = and <2 x i32> %5, splat (i32 1)
  %7 = icmp eq <2 x i32> %6, zeroinitializer
  %i.az = fneg <2 x float> %i.ay
  %i.ba = select <2 x i1> %7, <2 x float> %i.ay, <2 x float> %i.az
