...
bb.a:
  ...
  %.1.sroa.gep37 = getelementptr inbounds nuw i8, ptr %i.a, i64 2
...
bb.a:                                             ; preds = %bb.e, %lwDrawLine.exit.loopexit
  ...
  %.030.i.1 = phi i32 [ %i.br, %lwDrawLine.exit.loopexit ], [ %.2.i.1, %bb.e ] ; 2 uses
  %.0.i.1 = phi i32 [ %i.x, %lwDrawLine.exit.loopexit ], [ %.1.i.1, %bb.e ] ; 5 uses
  %i.bt = icmp slt i32 %.0.i.1, 0
  br i1 %i.bt, label %lwDrawPixel.exit.i.1, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.bu = load i32, ptr %0, align 8, !tbaa !47    ; 2 uses
  %i.bv = icmp sge i32 %.0.i.1, %i.bu
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.bz = mul nsw i32 %i.bu, %.032.i.1
  %i.ca = add nuw nsw i32 %i.bz, %.0.i.1
...
bb.e:                                             ; preds = %lwDrawPixel.exit.i.1
  %i.cf = shl nsw i32 %.030.i.1, 1                ; 2 uses
  %i.cg = icmp sgt i32 %i.cf, %i.bs               ; 2 uses
  %i.ch = select i1 %i.cg, i32 %i.bm, i32 0
  %.131.i.1 = sub i32 %.030.i.1, %i.ch
  %i.ci = select i1 %i.cg, i32 %i.bo, i32 0
  %.1.i.1 = add nsw i32 %i.ci, %.0.i.1
  ...
  %.2.i.1 = add nsw i32 %.131.i.1, %i.cl
  br label %bb.a
...
bb.f:                                             ; preds = %bb.j, %lwDrawLine.exit.loopexit.1
  ...
  %.030.i.2 = phi i32 [ %i.cu, %lwDrawLine.exit.loopexit.1 ], [ %.2.i.2, %bb.j ] ; 2 uses
  %.0.i.2 = phi i32 [ %i.ah, %lwDrawLine.exit.loopexit.1 ], [ %.1.i.2, %bb.j ] ; 5 uses
  %i.cw = icmp slt i32 %.0.i.2, 0
  br i1 %i.cw, label %lwDrawPixel.exit.i.2, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.cx = load i32, ptr %0, align 8, !tbaa !47    ; 2 uses
  %i.cy = icmp sge i32 %.0.i.2, %i.cx
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.dc = mul nsw i32 %i.cx, %.032.i.2
  %i.dd = add nuw nsw i32 %i.dc, %.0.i.2
...
bb.j:                                             ; preds = %lwDrawPixel.exit.i.2
  %i.di = shl nsw i32 %.030.i.2, 1                ; 2 uses
  %i.dj = icmp sgt i32 %i.di, %i.cv               ; 2 uses
  %i.dk = select i1 %i.dj, i32 %i.cp, i32 0
  %.131.i.2 = sub i32 %.030.i.2, %i.dk
  %i.dl = select i1 %i.dj, i32 %i.cr, i32 0
  %.1.i.2 = add nsw i32 %i.dl, %.0.i.2
  ...
  %.2.i.2 = add nsw i32 %.131.i.2, %i.do
  br label %bb.f
...
bb.k:                                             ; preds = %bb.o, %lwDrawLine.exit.loopexit.2
  ...
  %.030.i.3 = phi i32 [ %i.dx, %lwDrawLine.exit.loopexit.2 ], [ %.2.i.3, %bb.o ] ; 2 uses
  %.0.i.3 = phi i32 [ %i.ar, %lwDrawLine.exit.loopexit.2 ], [ %.1.i.3, %bb.o ] ; 5 uses
  %i.dz = icmp slt i32 %.0.i.3, 0
  br i1 %i.dz, label %lwDrawPixel.exit.i.3, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.ea = load i32, ptr %0, align 8, !tbaa !47    ; 2 uses
  %i.eb = icmp sge i32 %.0.i.3, %i.ea
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.ef = mul nsw i32 %i.ea, %.032.i.3
  %i.eg = add nuw nsw i32 %i.ef, %.0.i.3
...
bb.o:                                             ; preds = %lwDrawPixel.exit.i.3
  %i.el = shl nsw i32 %.030.i.3, 1                ; 2 uses
  %i.em = icmp sgt i32 %i.el, %i.dy               ; 2 uses
  %i.en = select i1 %i.em, i32 %i.ds, i32 0
  %.131.i.3 = sub i32 %.030.i.3, %i.en
  %i.eo = select i1 %i.em, i32 %i.du, i32 0
  %.1.i.3 = add nsw i32 %i.eo, %.0.i.3
  ...
  %.2.i.3 = add nsw i32 %.131.i.3, %i.er
  br label %bb.k
...
bb.p:                                             ; preds = %bb.t, %lwDrawLine.exit.preheader
  ...
  %.030.i = phi i32 [ %i.bh, %lwDrawLine.exit.preheader ], [ %.2.i, %bb.t ] ; 2 uses
  %.0.i = phi i32 [ %i.n, %lwDrawLine.exit.preheader ], [ %.1.i, %bb.t ] ; 5 uses
  %i.es = icmp slt i32 %.0.i, 0
  br i1 %i.es, label %lwDrawPixel.exit.i, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.et = load i32, ptr %0, align 8, !tbaa !47    ; 2 uses
  %i.eu = icmp sge i32 %.0.i, %i.et
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.ey = mul nsw i32 %i.et, %.032.i
  %i.ez = add nuw nsw i32 %i.ey, %.0.i
...
bb.t:                                             ; preds = %lwDrawPixel.exit.i
  %i.fe = shl nsw i32 %.030.i, 1                  ; 2 uses
  %i.ff = icmp sgt i32 %i.fe, %i.bi               ; 2 uses
  %i.fg = select i1 %i.ff, i32 %i.bc, i32 0
  %.131.i = sub i32 %.030.i, %i.fg
  %i.fh = select i1 %i.ff, i32 %i.be, i32 0
  %.1.i = add nsw i32 %i.fh, %.0.i
