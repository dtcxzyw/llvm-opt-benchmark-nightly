...
define dso_local range(i64 0, 4294967295001) i64 @estimateObjectIdleTime(ptr noundef readonly captures(none) %0) local_unnamed_addr #4 {
bb.a:
  %i.a = load i32, ptr getelementptr inbounds nuw (i8, ptr @server, i64 108), align 4, !tbaa !13
  %i.b = zext i32 %i.a to i64                     ; 2 uses
  %i.c = load i64, ptr %0, align 8
  %i.d = lshr i64 %i.c, 40                        ; 2 uses
  %.not = icmp samesign ugt i64 %i.d, %i.b
  %i.e = sub nsw i64 %i.b, %i.d
  %1 = mul nsw i64 %i.e, 1000                     ; 2 uses
  %.0.in = add nsw i64 %1, 16777215000
  %.0 = select i1 %.not, i64 %.0.in, i64 %1
  ret i64 %.0
}
...
begin_hunk_1_@evictionPoolPopulate:bb.a
  ...
  %i.ba = lshr i64 %i.az, 40                      ; 2 uses
  %.not.i = icmp samesign ugt i64 %i.ba, %i.ay
  %i.bb = sub nsw i64 %i.ay, %i.ba
  %3 = mul nsw i64 %i.bb, 1000                    ; 2 uses
  %.0.in.i = add nsw i64 %3, 16777215000
  %.0.i = select i1 %.not.i, i64 %.0.in.i, i64 %3
  br label %bb.k
