...
bb.s:                                             ; preds = %.lr.ph251, %bb.ar
  ...
  %.0124252 = phi i32 [ undef, %.lr.ph251 ], [ %.9209, %bb.ar ]
...
.preheader228:                                    ; preds = %bb.t, %.loopexit227
  %.0114248 = phi i32 [ %.0124252, %bb.t ], [ %.4118, %.loopexit227 ]
...
.loopexit227:                                     ; preds = %.thread, %bb.z
  ...
  %.4118 = phi i32 [ %i.bx, %bb.z ], [ %.2116, %.thread ] ; 3 uses
...
.thread202:                                       ; preds = %.thread202.loopexit, %bb.ae
  ...
  %.9209 = phi i32 [ %.4118, %.thread202.loopexit ], [ %i.cr, %bb.ae ]
