...
bb.b:                                             ; preds = %bb.a
  ...
  %1 = insertelement <2 x double> <double poison, double 1.000000e+00>, double %i.d, i64 0
  %2 = insertelement <2 x double> <double f0x41DFFFFFFFC00000, double poison>, double %i.j, i64 1
  %3 = fdiv <2 x double> %1, %2                   ; 2 uses
  %4 = extractelement <2 x double> %3, i64 0
  %5 = extractelement <2 x double> %3, i64 1
  %i.k = fcmp olt double %4, %5
