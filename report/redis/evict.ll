...
bb.q:                                             ; preds = %evictionTimeLimitUs.exit, %bb.p
  ...
  %i.ai = call i64 %i.ah() #14                    ; 2 uses
  %i.aj = load i32, ptr getelementptr inbounds nuw (i8, ptr @server, i64 7080), align 8, !tbaa !103
...
.preheader234:                                    ; preds = %bb.t, %.loopexit233
  ...
  %i.at = load i32, ptr getelementptr inbounds nuw (i8, ptr @server, i64 6516), align 4, !tbaa !104
...
begin_hunk_2_@performEvictions:bb.a
  ...
  %i.av = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 64), align 8, !tbaa !105
  ...
  %.0113 = load ptr, ptr %.0113.in, align 8, !tbaa !106 ; 3 uses
...
bb.v:                                             ; preds = %.lr.ph335
  ...
  br i1 %.not173, label %.loopexit, label %.lr.ph335, !llvm.loop !107
...
begin_hunk_4_@performEvictions:bb.a
  ...
  br i1 %or.cond176, label %..loopexit.loopexit_crit_edge, label %bb.v, !llvm.loop !107
...
.loopexit:                                        ; preds = %bb.v, %bb.u, %..loopexit.loopexit_crit_edge, %.lr.ph250
  ...
  %i.bm = load i32, ptr getelementptr inbounds nuw (i8, ptr @server, i64 6516), align 4, !tbaa !104
  %i.bn = sext i32 %i.bm to i64
  %i.bo = icmp slt i64 %indvars.iv.next, %i.bn
  br i1 %i.bo, label %.lr.ph250, label %._crit_edge, !llvm.loop !108
...
begin_hunk_5_@performEvictions:bb.a
  ...
  %.0106 = load ptr, ptr %.0106.in, align 8, !tbaa !106
...
begin_hunk_6_@performEvictions:bb.a
  ...
  br i1 %.not295, label %.loopexit233, label %.preheader, !llvm.loop !109
...
bb.ab:                                            ; preds = %bb.aa, %bb.aa
  %i.cm = load i32, ptr getelementptr inbounds nuw (i8, ptr @server, i64 6516), align 4, !tbaa !104 ; 2 uses
...
begin_hunk_8_@performEvictions:bb.a
  ...
  %i.cs = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 64), align 8, !tbaa !105
  ...
  %.0105 = load ptr, ptr %.0105.in, align 8, !tbaa !106 ; 2 uses
...
bb.ad:                                            ; preds = %.lr.ph, %bb.ac
  ...
  %i.db = load i32, ptr getelementptr inbounds nuw (i8, ptr @server, i64 6516), align 4, !tbaa !104 ; 2 uses
  %i.dc = icmp slt i32 %i.da, %i.db
  br i1 %i.dc, label %.lr.ph, label %.thread222, !llvm.loop !110
...
begin_hunk_10_@performEvictions:bb.a
  ...
  %i.df = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 64), align 8, !tbaa !105
...
begin_hunk_11_@performEvictions:bb.a
  ...
  %i.dx = load i64, ptr %i.c, align 8, !tbaa !111
...
bb.am:                                            ; preds = %bb.al, %bb.ak
  %i.ec = load i32, ptr getelementptr inbounds nuw (i8, ptr @server, i64 8360), align 8, !tbaa !112
...
bb.aq:                                            ; preds = %bb.ap
  ...
  %i.ek = call i64 @aeCreateTimeEvent(ptr noundef %i.ej, i64 noundef 0, ptr noundef nonnull @evictionTimeProc, ptr noundef null, ptr noundef null) #14 ; 0 uses
  br label %.thread220
...
begin_hunk_16_@performEvictions:bb.a
  ...
  br i1 %.not165, label %.critedge, label %bb.au, !llvm.loop !113
...
.thread224:                                       ; preds = %bb.g, %.thread307
  ...
  %i.fh = load i64, ptr getelementptr inbounds nuw (i8, ptr @server, i64 2640), align 8, !tbaa !114
...
bb.bd:                                            ; preds = %.thread229
  ...
  %i.fn = call i64 %i.fm() #14
  %i.fo = sub i64 %i.fn, %i.fl
  %i.fp = load i64, ptr getelementptr inbounds nuw (i8, ptr @server, i64 2632), align 8, !tbaa !115
  %i.fq = add i64 %i.fo, %i.fp
  store i64 %i.fq, ptr getelementptr inbounds nuw (i8, ptr @server, i64 2632), align 8, !tbaa !115
  br label %.sink.split
