...
.critedge.thread:                                 ; preds = %bb.ap, %bb.ao, %bb.an, %bb.am, %bb.al, %bb.ak, %bb.aj, %bb.ai, %bb.ah, %bb.ag, %bb.af, %bb.ae, %bb.ad, %bb.ac, %bb.ab, %bb.aa, %bb.z, %bb.y, %bb.x, %bb.w, %bb.v, %bb.u, %bb.t, %bb.s, %bb.r, %bb.q, %bb.p, %bb.o, %bb.n, %bb.m, %.critedge
  %.07493.lcssa104.a = phi i32 [ 0, %.critedge ], [ 15, %bb.ap ], [ 15, %bb.ao ], [ 14, %bb.an ], [ 14, %bb.am ], [ 13, %bb.al ], [ 13, %bb.ak ], [ 12, %bb.aj ], [ 12, %bb.ai ], [ 11, %bb.ah ], [ 11, %bb.ag ], [ 10, %bb.af ], [ 10, %bb.ae ], [ 9, %bb.ad ], [ 9, %bb.ac ], [ 8, %bb.ab ], [ 8, %bb.aa ], [ 7, %bb.z ], [ 7, %bb.y ], [ 6, %bb.x ], [ 6, %bb.w ], [ 5, %bb.v ], [ 5, %bb.u ], [ 4, %bb.t ], [ 4, %bb.s ], [ 3, %bb.r ], [ 3, %bb.q ], [ 2, %bb.p ], [ 2, %bb.o ], [ 1, %bb.n ], [ 1, %bb.m ] ; 6 uses
  %3 = zext nneg i32 %.07493.lcssa104.a to i64
  %i.du = getelementptr inbounds nuw [32 x i8], ptr %2, i64 %3
...
bb.aq:                                            ; preds = %.loopexit
  ...
  %4 = zext nneg i32 %.07493.lcssa104.a to i64    ; 2 uses
  %i.ea = getelementptr inbounds nuw [32 x i8], ptr %2, i64 %4 ; 2 uses
...
.sink.split:                                      ; preds = %bb.aq, %bb.as
  %i.ej = phi i64 [ %i.eh, %bb.as ], [ %4, %bb.aq ]
