...
bb.j:                                             ; preds = %bb.h
  ...
  %4 = sub nsw i64 %i.g, %i.x
  %5 = sitofp i64 %4 to float
  %6 = fdiv float %5, 1.000000e+03
  %i.y = sitofp i32 %i.i to float
  %7 = fdiv float %i.y, %6
  %8 = load i64, ptr getelementptr inbounds nuw (i8, ptr @config, i64 152), align 8, !tbaa !71
  %9 = sub nsw i64 %i.g, %8
  %10 = sitofp i64 %9 to float
  %11 = fdiv float %10, 1.000000e+03
  %i.z = sub nsw i32 %i.i, %i.j
  %12 = sitofp i32 %i.z to float
  %13 = fdiv float %12, %11
  ...
  %i.am = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.53, ptr noundef %i.ac, double noundef %14, double noundef %15, double noundef %i.ak, double noundef %i.al)
...
startBenchmarkThreads.exit:                       ; preds = %.lr.ph11.i, %.preheader.i, %bb.i, %bb.h
  ...
  %6 = fdiv float %i.bp, 1.000000e+03
  %i.bq = fdiv float %i.bn, %6                    ; 3 uses
  %i.br = load ptr, ptr getelementptr inbounds nuw (i8, ptr @config, i64 296), align 8, !tbaa !75
  %7 = tail call i64 @hdr_min(ptr noundef %i.br) #20
  %i.bs = load ptr, ptr getelementptr inbounds nuw (i8, ptr @config, i64 296), align 8, !tbaa !75
  %i.bt = tail call i64 @hdr_value_at_percentile(ptr noundef %i.bs, double noundef 5.000000e+01) #20
  %i.bu = sitofp i64 %i.bt to float
  %i.bv = sitofp i64 %7 to float
  ...
  %i.ca = tail call i64 @hdr_value_at_percentile(ptr noundef %i.bz, double noundef 9.500000e+01) #20
  %i.cb = load ptr, ptr getelementptr inbounds nuw (i8, ptr @config, i64 296), align 8, !tbaa !75
  %8 = tail call i64 @hdr_value_at_percentile(ptr noundef %i.cb, double noundef 9.900000e+01) #20
  %i.cc = sitofp i64 %8 to float
  ...
  %9 = load ptr, ptr getelementptr inbounds nuw (i8, ptr @config, i64 296), align 8, !tbaa !75
  %10 = tail call i64 @hdr_max(ptr noundef %9) #20
  %11 = sitofp i64 %10 to float
  %12 = fdiv float %11, 1.000000e+03              ; 2 uses
...
._crit_edge71.i:                                  ; preds = %bb.af, %._crit_edge.i
  ...
  %13 = fpext float %i.gy to double
  %i.gz = fpext float %12 to double
  %i.ha = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.224, double noundef %i.gr, double noundef %i.gt, double noundef %i.gv, double noundef %i.gx, double noundef %13, double noundef %i.gz) ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #20
  br label %showLatencyReport.exit

bb.ag:                                            ; preds = %startBenchmarkThreads.exit
  %i.hb = extractelement <2 x float> %i.by, i64 1
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.hg = extractelement <2 x float> %i.by, i64 0
  %i.hh = fpext float %i.hg to double
  %i.hi = extractelement <2 x float> %i.cg, i64 0
  %i.hj = fpext float %i.hi to double
  %i.hk = extractelement <2 x float> %i.cg, i64 1
  %i.hl = fpext float %i.hk to double
  %i.hm = fpext float %12 to double
