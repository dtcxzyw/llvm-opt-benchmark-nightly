...
bb.j:                                             ; preds = %bb.h
  ...
  %4 = load ptr, ptr getelementptr inbounds nuw (i8, ptr @config, i64 304), align 8, !tbaa !74
  %5 = tail call double @hdr_mean(ptr noundef %4) #20
  %i.ap = load ptr, ptr getelementptr inbounds nuw (i8, ptr @config, i64 296), align 8, !tbaa !75
  %i.aq = tail call double @hdr_mean(ptr noundef %i.ap) #20
  %6 = insertelement <2 x double> poison, double %5, i64 0
  %7 = insertelement <2 x double> %6, double %i.aq, i64 1
  %8 = fdiv <2 x double> %7, splat (double 1.000000e+03) ; 2 uses
  %9 = extractelement <2 x double> %8, i64 0
  %10 = extractelement <2 x double> %8, i64 1
  %i.ar = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.53, ptr noundef %i.am, double noundef %i.an, double noundef %i.ao, double noundef %9, double noundef %10)
...
startBenchmarkThreads.exit:                       ; preds = %.lr.ph11.i, %.preheader.i, %bb.i, %bb.h
  ...
  %7 = tail call i64 @hdr_value_at_percentile(ptr noundef %6, double noundef 5.000000e+01) #20
  %8 = sitofp i64 %7 to float
  %9 = sitofp i64 %i.bt to float
  %10 = insertelement <2 x float> poison, float %9, i64 0
  %11 = insertelement <2 x float> %10, float %8, i64 1
  %12 = fdiv <2 x float> %11, splat (float 1.000000e+03) ; 4 uses
  ...
  %13 = load ptr, ptr getelementptr inbounds nuw (i8, ptr @config, i64 296), align 8, !tbaa !75
  %14 = tail call i64 @hdr_value_at_percentile(ptr noundef %13, double noundef 9.900000e+01) #20
  %15 = sitofp i64 %14 to float
  %16 = sitofp i64 %i.bv to float
  %17 = insertelement <2 x float> poison, float %16, i64 0
  %18 = insertelement <2 x float> %17, float %15, i64 1
  %19 = fdiv <2 x float> %18, splat (float 1.000000e+03) ; 4 uses
...
._crit_edge71.i:                                  ; preds = %bb.af, %._crit_edge.i
  ...
  %i.gl = fpext float %20 to double
  %21 = extractelement <2 x float> %12, i64 1
  %i.gm = fpext float %21 to double
  %22 = extractelement <2 x float> %19, i64 0
  %i.gn = fpext float %22 to double
  %23 = extractelement <2 x float> %19, i64 1
  %i.go = fpext float %23 to double
...
bb.ag:                                            ; preds = %startBenchmarkThreads.exit
  ...
  %i.gr = fpext float %24 to double               ; 2 uses
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.gv = fpext float %25 to double
  %26 = extractelement <2 x float> %19, i64 0
  %i.gw = fpext float %26 to double
  %27 = extractelement <2 x float> %19, i64 1
  %i.gx = fpext float %27 to double
