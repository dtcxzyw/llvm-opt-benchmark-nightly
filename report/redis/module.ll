...
end_hunk_0
begin_hunk_1_@RM_GetDbIdFromDefragCtx:bb.a
}
...
.lr.ph:                                           ; preds = %.preheader, %bb.w
  ...
  %.03374 = phi i64 [ %i.aq, %bb.w ], [ 0, %.preheader ] ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  %i.o = getelementptr inbounds nuw [72 x i8], ptr %0, i64 %.03374
...
!155 = !{!154, !15, i64 8}
end_hunk_1
begin_hunk_2_@llvm.umin.i64/@llvm.usub.sat.i32
!390 = !{!16, !16, i64 0}
!391 = !{!65, !65, i64 0}
!392 = !{!44, !44, i64 0}
!393 = !{!394, !39, i64 0}
