...
begin_hunk_0_@moduleFireServerEvent:bb.a
  ...
  %6 = alloca %struct.RedisModuleReplicationInfo, align 8 ; 11 uses
...
modulePopulateReplicationInfoStructure.exit.thread: ; preds = %bb.q
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %i.y, i8 0, i64 24, i1 false)
  ...
  store i32 %i.cw, ptr %i.y, align 8, !tbaa !316
  %i.cx = select i1 %i.cv, ptr @.str.43, ptr %i.cu
  store ptr %i.cx, ptr %i.z, align 8, !tbaa !317
  %i.cy = load i32, ptr getelementptr inbounds nuw (i8, ptr @server, i64 7448), align 8, !tbaa !318
  store i32 %i.cy, ptr %i.aa, align 8, !tbaa !319
  store <2 x ptr> <ptr getelementptr inbounds nuw (i8, ptr @server, i64 7148), ptr getelementptr inbounds nuw (i8, ptr @server, i64 7189)>, ptr %i.ab, align 8, !tbaa !167
