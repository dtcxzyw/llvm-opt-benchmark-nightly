...
bb.ap:                                            ; preds = %bb.ao
  %lsr.iv363.lcssa = phi i64 [ %lsr.iv363, %bb.ao ]
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %lsr.iv365 = phi i64 [ %lsr.iv363.lcssa, %.lr.ph.preheader ], [ %lsr.iv.next366, %.lr.ph ]
...
bb.ba:                                            ; preds = %bb.az
  %lsr.iv406.lcssa = phi i64 [ %lsr.iv406, %bb.az ]
...
.lr.ph215:                                        ; preds = %.lr.ph215.preheader, %bb.bp
  ...
  %lsr.iv408 = phi i64 [ %lsr.iv406.lcssa, %.lr.ph215.preheader ], [ %lsr.iv.next409, %bb.bp ]
...
bb.c:                                             ; preds = %bb.b
  %lsr.iv79.lcssa = phi i64 [ %lsr.iv79, %bb.b ]
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.s
  ...
  %lsr.iv81 = phi i64 [ %lsr.iv79.lcssa, %.lr.ph.preheader ], [ %lsr.iv.next82, %bb.s ]
...
begin_hunk_6_@autoMemoryFreed:bb.a
  ...
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !112  ; 4 uses
...
bb.c:                                             ; preds = %.preheader.lr.ph, %.critedge40
  %lsr.iv64 = phi ptr [ %scevgep59, %.preheader.lr.ph ], [ %scevgep61, %.critedge40 ] ; 4 uses
  %lsr.iv60 = phi ptr [ %i.i, %.preheader.lr.ph ], [ %scevgep, %.critedge40 ] ; 4 uses
  %.03549 = phi i32 [ 0, %.preheader.lr.ph ], [ %i.y, %.critedge40 ] ; 4 uses
  %3 = xor i32 %.03549, -1
  %4 = add nsw i32 %i.e, %3
  %scevgep62 = getelementptr i8, ptr %lsr.iv64, i64 8
  %i.m = load i32, ptr %scevgep62, align 8, !tbaa !115
  %i.n = icmp eq i32 %i.m, %1
  br i1 %i.n, label %bb.d, label %bb.g

bb.d:                                             ; preds = %bb.c
  %i.o = load ptr, ptr %lsr.iv64, align 8, !tbaa !113
  %i.p = icmp eq ptr %i.o, %2
  br i1 %i.p, label %split.a, label %bb.g

split.a:                                          ; preds = %bb.d
  %.lcssa53.ph = phi i32 [ %4, %bb.d ]
  %.lcssa.ph = phi ptr [ %lsr.iv64, %bb.d ]
  br label %bb.e

._crit_edge:                                      ; preds = %bb.h
  %lsr.iv.lcssa70 = phi ptr [ %lsr.iv60, %bb.h ]
  %.03549.lcssa68 = phi i32 [ %.03549, %bb.h ]
  %split59 = phi ptr [ %6, %bb.h ]                ; 0 uses
  br label %bb.e

bb.e:                                             ; preds = %split.a, %._crit_edge
  %.lcssa53 = phi i32 [ %.03549.lcssa68, %._crit_edge ], [ %.lcssa53.ph, %split.a ]
  %.lcssa = phi ptr [ %lsr.iv.lcssa70, %._crit_edge ], [ %.lcssa.ph, %split.a ] ; 2 uses
...
bb.g:                                             ; preds = %bb.c, %bb.d
  %5 = zext nneg i32 %.03549 to i64
  %6 = getelementptr inbounds nuw [16 x i8], ptr %i.i, i64 %5
  %scevgep58 = getelementptr i8, ptr %lsr.iv60, i64 8
  %i.u = load i32, ptr %scevgep58, align 8, !tbaa !115
  %i.v = icmp eq i32 %i.u, %1
  br i1 %i.v, label %bb.h, label %.critedge40

bb.h:                                             ; preds = %bb.g
  %i.w = load ptr, ptr %lsr.iv60, align 8, !tbaa !113
...
.critedge40:                                      ; preds = %bb.h, %bb.g
  ...
  %scevgep = getelementptr i8, ptr %lsr.iv60, i64 16
  %scevgep61 = getelementptr i8, ptr %lsr.iv64, i64 -16
...
.preheader:                                       ; preds = %bb.b
  %.0104.lcssa174 = phi ptr [ %.0104, %bb.b ]
...
.lr.ph140:                                        ; preds = %.lr.ph140.preheader, %.lr.ph140
  ...
  %scevgep174 = getelementptr i8, ptr %.0104.lcssa174, i64 %i.fd
