...
begin_hunk_0_@luaD_precall:bb.a
  ...
  call void %i.hw(ptr noundef nonnull %0, ptr noundef nonnull %4) #9, !inline_history !88
...
begin_hunk_1_@luaD_precall:bb.a
  ...
  call void %i.ld(ptr noundef nonnull %0, ptr noundef nonnull %3) #9, !inline_history !88
...
begin_hunk_2_@luaD_poscall:bb.a
  ...
  call void %i.g(ptr noundef nonnull %0, ptr noundef nonnull %3) #9, !inline_history !89
...
begin_hunk_3_@luaD_poscall:bb.a
  ...
  call void %i.br(ptr noundef nonnull %0, ptr noundef nonnull %2) #9, !inline_history !89
...
begin_hunk_4_@luaD_poscall:bb.a
  ...
  br i1 %.not8.i, label %callrethooks.exit, label %bb.g, !llvm.loop !90
...
begin_hunk_5_@luaD_poscall:bb.a
  ...
  br i1 %.not29, label %._crit_edge, label %.lr.ph, !llvm.loop !91
...
begin_hunk_6_@luaD_poscall:bb.a
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph40.prol.loopexit, label %.lr.ph40.prol, !llvm.loop !92
...
begin_hunk_7_@luaD_poscall:bb.a
  ...
  br i1 %i.en, label %.lr.ph40, label %._crit_edge, !llvm.loop !93
...
begin_hunk_8_@luaD_pcall:bb.a
  ...
  store i64 %4, ptr %i.i, align 8, !tbaa !94
...
restore_stack_limit.exit:                         ; preds = %bb.f, %luaD_seterrorobj.exit, %bb.a
  store i64 %i.j, ptr %i.i, align 8, !tbaa !94
  ret i32 %i.k
}
...
bb.a:
  ...
  store ptr %2, ptr %i.a, align 8, !tbaa !98
...
begin_hunk_11_@luaD_protectedparser:bb.a
  ...
  %i.o = load i64, ptr %i.c, align 8, !tbaa !100
...
bb.c:                                             ; preds = %bb.b, %bb.a
  %i.i = load ptr, ptr %1, align 8, !tbaa !95
  ...
  %i.o = load i8, ptr %i.n, align 8, !tbaa !101
  ...
  %i.u = load i8, ptr %i.n, align 8, !tbaa !101
...
begin_hunk_14_@f_parser:bb.a
  ...
  %i.y = load i8, ptr %i.n, align 8, !tbaa !101
  %i.z = zext i8 %i.y to i64
  %i.aa = icmp samesign ult i64 %indvars.iv.next, %i.z
  br i1 %i.aa, label %bb.d, label %._crit_edge, !llvm.loop !102
...
!86 = distinct !{!86, !51}
!87 = !{!10, !6, i64 100}
!88 = !{ptr @luaD_callhook}
!89 = distinct !{null, ptr @luaD_callhook}
!90 = distinct !{!90, !51}
!91 = distinct !{!91, !51}
!92 = distinct !{!92, !77}
!93 = distinct !{!93, !51}
!94 = !{!10, !20, i64 176}
!95 = !{!96, !97, i64 0}
!96 = !{!"SParser", !97, i64 0, !32, i64 8, !33, i64 32}
!97 = !{!"p1 _ZTS3Zio", !12, i64 0}
!98 = !{!96, !33, i64 32}
!99 = !{!96, !33, i64 8}
!100 = !{!96, !20, i64 24}
!101 = !{!69, !6, i64 112}
