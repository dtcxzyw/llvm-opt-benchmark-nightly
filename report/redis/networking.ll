...
bb.b:                                             ; preds = %bb.a
  %i.c = load i32, ptr getelementptr inbounds nuw (i8, ptr @server, i64 2432), align 8, !tbaa !277 ; 4 uses
  %0 = icmp sgt i32 %i.c, 33
  %1 = sdiv i32 %i.c, 2
  %2 = select i1 %0, i32 %1, i32 16               ; 4 uses
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %bb.b
  ...
  store i32 %2, ptr getelementptr inbounds nuw (i8, ptr @server, i64 2436), align 4, !tbaa !278
