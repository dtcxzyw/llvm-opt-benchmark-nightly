...
bb.j:                                             ; preds = %.thread99, %bb.i, %bb.h
  ...
  %.pre-phi102 = phi i64 [ %i.aj, %.thread99 ], [ %.pre87, %bb.i ], [ %.pre87, %bb.h ] ; 6 uses
...
.preheader:                                       ; preds = %bb.j
  %i.ar = load i32, ptr %i.ab, align 8, !tbaa !275 ; 6 uses
...
vector.memcheck:                                  ; preds = %.lr.ph
  %8 = sub nsw i64 %.pre-phi102, %3
  %9 = shl nsw i64 %8, 3
  %10 = add nsw i64 %9, -1
  %diff.check = icmp ult i64 %10, 31
  br i1 %diff.check, label %scalar.ph.preheader, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %7, 8589934588                 ; 4 uses
  %11 = add nsw i64 %.pre-phi102, %n.vec
  %12 = add nsw i64 %n.vec, %3
  %invariant.gep = getelementptr [8 x i8], ptr %.pre88, i64 %3
  %13 = getelementptr [8 x i8], ptr %.pre88, i64 %.pre-phi102
  br label %.lr.ph.a

.lr.ph.a:                                         ; preds = %.lr.ph.a, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %.lr.ph.a ] ; 3 uses
  %gep = getelementptr [8 x i8], ptr %invariant.gep, i64 %index ; 2 uses
  %14 = getelementptr inbounds nuw i8, ptr %gep, i64 16
  %wide.load = load <2 x ptr>, ptr %gep, align 8, !tbaa !173
  %wide.load108 = load <2 x ptr>, ptr %14, align 8, !tbaa !173
  %15 = getelementptr [8 x i8], ptr %13, i64 %index ; 2 uses
  %16 = getelementptr inbounds nuw i8, ptr %15, i64 16
  store <2 x ptr> %wide.load, ptr %15, align 8, !tbaa !173
  store <2 x ptr> %wide.load108, ptr %16, align 8, !tbaa !173
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %lcmp.mod.not.a = icmp eq i64 %index.next, %n.vec
  br i1 %lcmp.mod.not.a, label %middle.block, label %.lr.ph.a, !llvm.loop !364
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph, %middle.block
  %indvars.iv82.ph = phi i64 [ %.pre-phi102, %vector.memcheck ], [ %.pre-phi102, %.lr.ph ], [ %11, %middle.block ] ; 2 uses
  %indvars.iv.ph = phi i64 [ %3, %vector.memcheck ], [ %3, %.lr.ph ], [ %12, %middle.block ] ; 3 uses
  %17 = trunc i64 %indvars.iv.ph to i32           ; 2 uses
  %18 = sub i32 %i.ar, %17
  %xtraiter = and i32 %18, 3                      ; 2 uses
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %scalar.ph.preheader, %.prol.preheader
  %indvars.iv.prol.a = phi i64 [ %indvars.iv.next.prol.a, %.prol.preheader ], [ %indvars.iv82.ph, %scalar.ph.preheader ] ; 2 uses
  %.0.in80.prol = phi i64 [ %indvars.iv.next.prol, %.prol.preheader ], [ %indvars.iv.ph, %scalar.ph.preheader ] ; 2 uses
  %prol.iter = phi i32 [ %prol.iter.next, %.prol.preheader ], [ 0, %scalar.ph.preheader ]
  %i.at = getelementptr inbounds [8 x i8], ptr %.pre88, i64 %.0.in80.prol
  %i.au = load ptr, ptr %i.at, align 8, !tbaa !173
  %i.av = getelementptr inbounds [8 x i8], ptr %.pre88, i64 %indvars.iv.prol.a
  store ptr %i.au, ptr %i.av, align 8, !tbaa !173
  %indvars.iv.next.prol = add nsw i64 %.0.in80.prol, 1 ; 2 uses
  %indvars.iv.next.prol.a = add nsw i64 %indvars.iv.prol.a, 1 ; 2 uses
  %prol.iter.next = add i32 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.prol.loopexit, label %.prol.preheader, !llvm.loop !367

.prol.loopexit:                                   ; preds = %.prol.preheader, %scalar.ph.preheader
  %indvars.iv.unr.a = phi i64 [ %indvars.iv82.ph, %scalar.ph.preheader ], [ %indvars.iv.next.prol.a, %.prol.preheader ]
  %.0.in80.unr = phi i64 [ %indvars.iv.ph, %scalar.ph.preheader ], [ %indvars.iv.next.prol, %.prol.preheader ]
  %19 = sub i32 %17, %i.ar
  %20 = icmp ugt i32 %19, -4
  br i1 %20, label %._crit_edge, label %.lr.ph.new
...
._crit_edge:                                      ; preds = %.prol.loopexit, %.lr.ph.new, %middle.block, %.preheader
...
.lr.ph.new:                                       ; preds = %.prol.loopexit, %.lr.ph.new
  %indvars.iv.a = phi i64 [ %indvars.iv.next.3.a, %.lr.ph.new ], [ %indvars.iv.unr.a, %.prol.loopexit ] ; 5 uses
  %.0.in80 = phi i64 [ %indvars.iv.next.3, %.lr.ph.new ], [ %.0.in80.unr, %.prol.loopexit ] ; 5 uses
  %i.bf = getelementptr inbounds [8 x i8], ptr %.pre88, i64 %.0.in80
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !173
  %i.bh = getelementptr inbounds [8 x i8], ptr %.pre88, i64 %indvars.iv.a
  store ptr %i.bg, ptr %i.bh, align 8, !tbaa !173
  %21 = getelementptr [8 x i8], ptr %.pre88, i64 %.0.in80
  %22 = getelementptr i8, ptr %21, i64 8
  %i.bi = load ptr, ptr %22, align 8, !tbaa !173
  %i.bj = getelementptr [8 x i8], ptr %.pre88, i64 %indvars.iv.a
  %23 = getelementptr i8, ptr %i.bj, i64 8
  store ptr %i.bi, ptr %23, align 8, !tbaa !173
  %24 = getelementptr [8 x i8], ptr %.pre88, i64 %.0.in80
  %25 = getelementptr i8, ptr %24, i64 16
  %i.bk = load ptr, ptr %25, align 8, !tbaa !173
  %i.bl = getelementptr [8 x i8], ptr %.pre88, i64 %indvars.iv.a
  %26 = getelementptr i8, ptr %i.bl, i64 16
  store ptr %i.bk, ptr %26, align 8, !tbaa !173
  %27 = getelementptr [8 x i8], ptr %.pre88, i64 %.0.in80
  %28 = getelementptr i8, ptr %27, i64 24
  %i.bm = load ptr, ptr %28, align 8, !tbaa !173
  %i.bn = getelementptr [8 x i8], ptr %.pre88, i64 %indvars.iv.a
  %29 = getelementptr i8, ptr %i.bn, i64 24
  store ptr %i.bm, ptr %29, align 8, !tbaa !173
  %indvars.iv.next.3 = add nsw i64 %.0.in80, 4    ; 2 uses
  %indvars.iv.next.3.a = add nsw i64 %indvars.iv.a, 4
  %lftr.wideiv.3 = trunc i64 %indvars.iv.next.3 to i32
  %exitcond.not.3 = icmp eq i32 %i.ar, %lftr.wideiv.3
  br i1 %exitcond.not.3, label %._crit_edge, label %.lr.ph.new, !llvm.loop !369
...
.split:                                           ; preds = %bb.b
  ...
  br i1 %i.k, label %bb.m, label %clientHasPendingReplies.exit.clientHasPendingReplies.exit.thread_crit_edge, !llvm.loop !374
...
clientHasPendingReplies.exit:                     ; preds = %bb.c
  ...
  br i1 %.not30, label %bb.m, label %clientHasPendingReplies.exit.clientHasPendingReplies.exit.thread_crit_edge, !llvm.loop !374
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %.not124, label %.critedge142, label %.thread, !prof !397
...
bb.f:                                             ; preds = %.thread
  ...
  %.pre164 = load i32, ptr %i.h, align 4, !tbaa !392
  %.pre165 = load i32, ptr %i.g, align 8, !tbaa !391
  br label %bb.g
...
bb.x:                                             ; preds = %bb.v, %bb.w, %bb.s
  ...
  br i1 %.not128, label %.critedge.loopexit, label %.peel.next, !llvm.loop !399
