...
bb.a:
  ...
  %.phi.trans.insert830.a = getelementptr inbounds nuw i8, ptr %.pre, i64 8
  %.pre831.a = load ptr, ptr %.phi.trans.insert830.a, align 8, !tbaa !173
  %.phi.trans.insert832 = getelementptr inbounds nuw i8, ptr %.pre831.a, i64 8
  %.pre833.a = load ptr, ptr %.phi.trans.insert832, align 8, !tbaa !14 ; 18 uses
  br i1 %i.k, label %bb.d, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.l = tail call i32 @strcasecmp(ptr noundef %.pre833.a, ptr noundef nonnull @.str.106) #33
...
bb.d:                                             ; preds = %bb.a
  ...
  %i.n = tail call i32 @strcasecmp(ptr noundef %.pre833.a, ptr noundef nonnull @.str.161) #33
  %.not508 = icmp eq i32 %i.n, 0
  br i1 %.not508, label %.thread639, label %bb.e

.thread:                                          ; preds = %bb.b
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 96
  %i.p = tail call i32 @strcasecmp(ptr noundef %.pre833.a, ptr noundef nonnull @.str.161) #33
  %.not508864 = icmp eq i32 %i.p, 0
  br i1 %.not508864, label %.thread865, label %bb.e

.thread865:                                       ; preds = %.thread
...
bb.e:                                             ; preds = %.thread, %bb.d
  ...
  %i.s = tail call i32 @strcasecmp(ptr noundef %.pre833.a, ptr noundef nonnull @.str.162) #33
...
.thread639:                                       ; preds = %bb.d, %bb.e
  ...
  %i.am = tail call i32 @strcasecmp(ptr noundef %.pre833.a, ptr noundef nonnull @.str.164) #33
...
..thread641_crit_edge:                            ; preds = %bb.s
  %.phi.trans.insert839.a = getelementptr inbounds nuw i8, ptr %.pre, i64 16
  %.pre840.a = load ptr, ptr %.phi.trans.insert839.a, align 8, !tbaa !173
  %.phi.trans.insert841 = getelementptr inbounds nuw i8, ptr %.pre840.a, i64 8
  %.pre842 = load ptr, ptr %.phi.trans.insert841, align 8, !tbaa !14
  br label %.thread641

.thread641:                                       ; preds = %..thread641_crit_edge, %bb.m
  %i.bd = phi ptr [ %.pre842, %..thread641_crit_edge ], [ %i.ar, %bb.m ]
...
bb.t:                                             ; preds = %.thread641
  ...
  %.not515812 = icmp sgt i32 %i.bg, 3
  br i1 %.not515812, label %.lr.ph816, label %._crit_edge817

.lr.ph816:                                        ; preds = %bb.t, %bb.w
  %indvars.iv826 = phi i64 [ %indvars.iv.next827, %bb.w ], [ 3, %bb.t ] ; 2 uses
  %.0411814 = phi ptr [ %.2413.ph, %bb.w ], [ %i.bf, %bb.t ] ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #29
  %i.bh = load ptr, ptr %i.al, align 8, !tbaa !186
  %i.bi = getelementptr inbounds nuw [8 x i8], ptr %i.bh, i64 %indvars.iv826
...
bb.v:                                             ; preds = %bb.u
  %i.bq = call ptr @catClientInfoString(ptr noundef %.0411814, ptr noundef nonnull %i.bp)
  %i.br = call ptr @sdscatlen(ptr noundef %i.bq, ptr noundef nonnull @.str.98, i64 noundef 1) #29
  br label %bb.w

.thread645:                                       ; preds = %.lr.ph816
  call void @sdsfree(ptr noundef %.0411814) #29
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #29
  br label %.critedge

bb.w:                                             ; preds = %bb.u, %bb.v
  %.2413.ph = phi ptr [ %.0411814, %bb.u ], [ %i.br, %bb.v ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #29
  %indvars.iv.next827 = add nuw nsw i64 %indvars.iv826, 1 ; 2 uses
  %i.bs = load i32, ptr %i.i, align 8, !tbaa !275
  %i.bt = sext i32 %i.bs to i64
  %.not515 = icmp slt i64 %indvars.iv.next827, %i.bt
  br i1 %.not515, label %.lr.ph816, label %._crit_edge817, !llvm.loop !337
...
.thread649:                                       ; preds = %bb.r, %bb.n, %bb.o, %bb.p, %bb.q, %bb.x, %._crit_edge817
  %.0410653 = phi i32 [ -1, %._crit_edge817 ], [ -1, %bb.x ], [ 2, %bb.q ], [ 0, %bb.n ], [ 1, %bb.o ], [ 1, %bb.p ], [ 3, %bb.r ]
  %i.cn = call ptr @getAllClientsInfoString(i32 noundef %.0410653)
  br label %bb.ad

bb.ad:                                            ; preds = %.thread649, %._crit_edge817
  %.5 = phi ptr [ %.0411.lcssa, %._crit_edge817 ], [ %i.cn, %.thread649 ] ; 7 uses
...
bb.aj:                                            ; preds = %.thread639
  %i.dd = tail call i32 @strcasecmp(ptr noundef %.pre833.a, ptr noundef nonnull @.str.168) #33
  %.not518 = icmp eq i32 %i.dd, 0
  %i.de = icmp eq i32 %i.j, 3                     ; 4 uses
  %or.cond699.a = and i1 %i.de, %.not518
  br i1 %or.cond699.a, label %bb.ak, label %bb.as
...
bb.as:                                            ; preds = %bb.aj
  %i.dy = tail call i32 @strcasecmp(ptr noundef %.pre833.a, ptr noundef nonnull @.str.172) #33
  %.not523 = icmp eq i32 %i.dy, 0
  %or.cond700.a = and i1 %i.de, %.not523
  br i1 %or.cond700.a, label %bb.at, label %bb.ay
...
bb.ay:                                            ; preds = %bb.as
  %i.ep = tail call i32 @strcasecmp(ptr noundef %.pre833.a, ptr noundef nonnull @.str.173) #33
...
bb.bb:                                            ; preds = %bb.az
  ...
  br i1 %i.eu, label %.lr.ph796, label %bb.ca

.lr.ph796:                                        ; preds = %bb.bb, %getClientTypeByName.exit631.thread
  ...
  %.0423795 = phi ptr [ %.1424, %getClientTypeByName.exit631.thread ], [ null, %bb.bb ] ; 11 uses
  %.0444794 = phi ptr [ %.1445, %getClientTypeByName.exit631.thread ], [ null, %bb.bb ] ; 11 uses
  %.0450793 = phi ptr [ %.1451, %getClientTypeByName.exit631.thread ], [ null, %bb.bb ] ; 11 uses
  %.0455792 = phi i32 [ %.1456, %getClientTypeByName.exit631.thread ], [ -1, %bb.bb ] ; 7 uses
  %.0467790 = phi i32 [ %.1468, %getClientTypeByName.exit631.thread ], [ 1, %bb.bb ] ; 10 uses
  %.0472789 = phi i64 [ %.2474, %getClientTypeByName.exit631.thread ], [ 0, %bb.bb ] ; 11 uses
  %.0478788 = phi i64 [ %.2480, %getClientTypeByName.exit631.thread ], [ 0, %bb.bb ] ; 11 uses
...
getClientTypeByName.exit631.thread:               ; preds = %bb.bn, %bb.bj, %bb.bk, %bb.bl, %bb.bm, %bb.bc, %bb.br, %bb.bt, %bb.bp, %bb.bw, %bb.bx, %bb.bh
  %.2480 = phi i64 [ %i.fj, %bb.bc ], [ %.0478788, %bb.bh ], [ %.0478788, %bb.bx ], [ %.0478788, %bb.bp ], [ %.0478788, %bb.br ], [ %.0478788, %bb.bt ], [ %.0478788, %bb.bw ], [ %.0478788, %bb.bm ], [ %.0478788, %bb.bl ], [ %.0478788, %bb.bk ], [ %.0478788, %bb.bj ], [ %.0478788, %bb.bn ] ; 2 uses
  %.2474 = phi i64 [ %.0472789, %bb.bc ], [ %i.fp, %bb.bh ], [ %.0472789, %bb.bx ], [ %.0472789, %bb.bp ], [ %.0472789, %bb.br ], [ %.0472789, %bb.bt ], [ %.0472789, %bb.bw ], [ %.0472789, %bb.bm ], [ %.0472789, %bb.bl ], [ %.0472789, %bb.bk ], [ %.0472789, %bb.bj ], [ %.0472789, %bb.bn ] ; 2 uses
  %.1468 = phi i32 [ %.0467790, %bb.bc ], [ %.0467790, %bb.bh ], [ 0, %bb.bx ], [ %.0467790, %bb.bp ], [ %.0467790, %bb.br ], [ %.0467790, %bb.bt ], [ 1, %bb.bw ], [ %.0467790, %bb.bm ], [ %.0467790, %bb.bl ], [ %.0467790, %bb.bk ], [ %.0467790, %bb.bj ], [ %.0467790, %bb.bn ] ; 2 uses
  %.1456 = phi i32 [ %.0455792, %bb.bc ], [ %.0455792, %bb.bh ], [ %.0455792, %bb.bx ], [ %.0455792, %bb.bp ], [ %.0455792, %bb.br ], [ %.0455792, %bb.bt ], [ %.0455792, %bb.bw ], [ 2, %bb.bm ], [ 1, %bb.bl ], [ 1, %bb.bk ], [ 0, %bb.bj ], [ 3, %bb.bn ] ; 2 uses
  %.1451 = phi ptr [ %.0450793, %bb.bc ], [ %.0450793, %bb.bh ], [ %.0450793, %bb.bx ], [ %.0450793, %bb.bp ], [ %.0450793, %bb.br ], [ %i.gv, %bb.bt ], [ %.0450793, %bb.bw ], [ %.0450793, %bb.bm ], [ %.0450793, %bb.bl ], [ %.0450793, %bb.bk ], [ %.0450793, %bb.bj ], [ %.0450793, %bb.bn ] ; 2 uses
  %.1445 = phi ptr [ %.0444794, %bb.bc ], [ %.0444794, %bb.bh ], [ %.0444794, %bb.bx ], [ %.0444794, %bb.bp ], [ %i.gn, %bb.br ], [ %.0444794, %bb.bt ], [ %.0444794, %bb.bw ], [ %.0444794, %bb.bm ], [ %.0444794, %bb.bl ], [ %.0444794, %bb.bk ], [ %.0444794, %bb.bj ], [ %.0444794, %bb.bn ] ; 2 uses
  %.1424 = phi ptr [ %.0423795, %bb.bc ], [ %.0423795, %bb.bh ], [ %.0423795, %bb.bx ], [ %i.gh, %bb.bp ], [ %.0423795, %bb.br ], [ %.0423795, %bb.bt ], [ %.0423795, %bb.bw ], [ %.0423795, %bb.bm ], [ %.0423795, %bb.bl ], [ %.0423795, %bb.bk ], [ %.0423795, %bb.bj ], [ %.0423795, %bb.bn ] ; 2 uses
  ...
  br i1 %.not531, label %.lr.ph796, label %.loopexit.loopexit, !llvm.loop !339
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %bb.ba
  ...
  %.not532804 = icmp eq ptr %i.ij, null
  br i1 %.not532804, label %._crit_edge809.thread, label %.lr.ph808

.lr.ph808:                                        ; preds = %.loopexit
...
bb.cg:                                            ; preds = %.lr.ph808, %bb.cy
  %i.ik = phi ptr [ %i.ij, %.lr.ph808 ], [ %i.ji, %bb.cy ]
  %.0462806 = phi i32 [ 0, %.lr.ph808 ], [ %.2464, %bb.cy ] ; 8 uses
  %.0465805 = phi i32 [ 0, %.lr.ph808 ], [ %.1466, %bb.cy ] ; 8 uses
