...
begin_hunk_0_@replaceClientCommandVector:bb.a
  ...
  store ptr null, ptr %i.bd, align 8, !tbaa !277
  %i.be = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  store i32 0, ptr %i.be, align 8, !tbaa !278
  %i.bf = getelementptr inbounds nuw i8, ptr %0, i64 96 ; 6 uses
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !186
  tail call void @zfree(ptr noundef %i.bg) #30
...
bb.f:                                             ; preds = %bb.e
  ...
  %.pre91.a = add nsw i32 %1, 1                   ; 3 uses
  br i1 %.not74, label %.thread99, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.af = sext i32 %.pre91.a to i64
  ...
  store i32 %.pre91.a, ptr %i.ad, align 8, !tbaa !278
  br label %.thread99

.thread99:                                        ; preds = %bb.f, %bb.g
  %i.ai = phi ptr [ %i.ah, %bb.g ], [ %.pre, %bb.f ]
  store i32 %.pre91.a, ptr %i.ab, align 8, !tbaa !275
...
.preheader:                                       ; preds = %bb.j
  %i.ar = load i32, ptr %i.ab, align 8, !tbaa !275 ; 5 uses
  %.079 = add nsw i32 %1, 1                       ; 2 uses
  %i.as = icmp slt i32 %.079, %i.ar
  %.pre88 = load ptr, ptr %i.aq, align 8, !tbaa !186 ; 11 uses
  br i1 %i.as, label %.lr.ph.a, label %._crit_edge

.lr.ph.a:                                         ; preds = %.preheader
  %3 = sext i32 %.079 to i64                      ; 2 uses
  ...
  br i1 %lcmp.mod.not.a, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.lr.ph.a, %.prol.preheader
  %indvars.iv.prol.a = phi i64 [ %indvars.iv.next.prol.a, %.prol.preheader ], [ %3, %.lr.ph.a ] ; 4 uses
  %.0.in80.prol = phi i64 [ %indvars.iv.prol.a, %.prol.preheader ], [ %4, %.lr.ph.a ]
  %prol.iter = phi i32 [ %prol.iter.next, %.prol.preheader ], [ 0, %.lr.ph.a ]
  %i.at = getelementptr inbounds [8 x i8], ptr %.pre88, i64 %indvars.iv.prol.a
  %i.au = load ptr, ptr %i.at, align 8, !tbaa !173
  %i.av = getelementptr inbounds [8 x i8], ptr %.pre88, i64 %.0.in80.prol
  store ptr %i.au, ptr %i.av, align 8, !tbaa !173
  %indvars.iv.next.prol.a = add nsw i64 %indvars.iv.prol.a, 1 ; 2 uses
  %prol.iter.next = add i32 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.prol.loopexit, label %.prol.preheader, !llvm.loop !364

.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph.a
  %indvars.iv.unr.a = phi i64 [ %3, %.lr.ph.a ], [ %indvars.iv.next.prol.a, %.prol.preheader ]
  %.0.in80.unr = phi i64 [ %4, %.lr.ph.a ], [ %indvars.iv.prol.a, %.prol.preheader ]
  %9 = icmp ult i32 %8, 3
  br i1 %9, label %._crit_edge, label %.lr.ph.new

bb.k:                                             ; preds = %bb.j
  %i.aw = load ptr, ptr %i.aq, align 8, !tbaa !186
  %i.ax = getelementptr inbounds [8 x i8], ptr %i.aw, i64 %.pre-phi102
  store ptr %2, ptr %i.ax, align 8, !tbaa !173
  tail call void @incrRefCount(ptr noundef nonnull %2) #30
  %i.ay = tail call i64 @getStringObjectLen(ptr noundef nonnull %2)
  %i.az = getelementptr inbounds nuw i8, ptr %0, i64 120 ; 2 uses
  %i.ba = load i64, ptr %i.az, align 8, !tbaa !201
  %i.bb = add i64 %i.ba, %i.ay
  store i64 %i.bb, ptr %i.az, align 8, !tbaa !201
  br label %bb.l

._crit_edge:                                      ; preds = %.prol.loopexit, %.lr.ph.new, %.preheader
  %i.bc = add nsw i32 %i.ar, -1                   ; 2 uses
  store i32 %i.bc, ptr %i.ab, align 8, !tbaa !275
  %i.bd = sext i32 %i.bc to i64
  %i.be = getelementptr inbounds [8 x i8], ptr %.pre88, i64 %i.bd
  store ptr null, ptr %i.be, align 8, !tbaa !173
  br label %bb.l

.lr.ph.new:                                       ; preds = %.prol.loopexit, %.lr.ph.new
  %indvars.iv.a = phi i64 [ %indvars.iv.next.3.a, %.lr.ph.new ], [ %indvars.iv.unr.a, %.prol.loopexit ] ; 6 uses
  %.0.in80 = phi i64 [ %indvars.iv.next.2, %.lr.ph.new ], [ %.0.in80.unr, %.prol.loopexit ]
  %i.bf = getelementptr inbounds [8 x i8], ptr %.pre88, i64 %indvars.iv.a
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !173
  %i.bh = getelementptr inbounds [8 x i8], ptr %.pre88, i64 %.0.in80
  store ptr %i.bg, ptr %i.bh, align 8, !tbaa !173
  %indvars.iv.next = add nsw i64 %indvars.iv.a, 1 ; 2 uses
  %10 = getelementptr inbounds [8 x i8], ptr %.pre88, i64 %indvars.iv.next
  %i.bi = load ptr, ptr %10, align 8, !tbaa !173
  %i.bj = getelementptr inbounds [8 x i8], ptr %.pre88, i64 %indvars.iv.a
  store ptr %i.bi, ptr %i.bj, align 8, !tbaa !173
  %indvars.iv.next.1 = add nsw i64 %indvars.iv.a, 2 ; 2 uses
  %11 = getelementptr inbounds [8 x i8], ptr %.pre88, i64 %indvars.iv.next.1
  %i.bk = load ptr, ptr %11, align 8, !tbaa !173
  %i.bl = getelementptr inbounds [8 x i8], ptr %.pre88, i64 %indvars.iv.next
  store ptr %i.bk, ptr %i.bl, align 8, !tbaa !173
  %indvars.iv.next.2 = add nsw i64 %indvars.iv.a, 3 ; 2 uses
  %12 = getelementptr inbounds [8 x i8], ptr %.pre88, i64 %indvars.iv.next.2
  %i.bm = load ptr, ptr %12, align 8, !tbaa !173
  %i.bn = getelementptr inbounds [8 x i8], ptr %.pre88, i64 %indvars.iv.next.1
  store ptr %i.bm, ptr %i.bn, align 8, !tbaa !173
  %indvars.iv.next.3.a = add nsw i64 %indvars.iv.a, 4 ; 2 uses
  %lftr.wideiv.3 = trunc i64 %indvars.iv.next.3.a to i32
  %exitcond.not.3 = icmp eq i32 %i.ar, %lftr.wideiv.3
  br i1 %exitcond.not.3, label %._crit_edge, label %.lr.ph.new, !llvm.loop !366
...
bb.n:                                             ; preds = %bb.m
  %i.bo = load ptr, ptr %i.aq, align 8, !tbaa !186
  %i.bp = getelementptr inbounds nuw i8, ptr %i.u, i64 8
  store ptr %i.bo, ptr %i.bp, align 8, !tbaa !269
  %i.bq = load i32, ptr %i.ab, align 8, !tbaa !275
  store i32 %i.bq, ptr %i.u, align 8, !tbaa !272
  %i.br = getelementptr inbounds nuw i8, ptr %0, i64 104
  %i.bs = load i32, ptr %i.br, align 8, !tbaa !278
  %i.bt = getelementptr inbounds nuw i8, ptr %i.u, i64 4
  store i32 %i.bs, ptr %i.bt, align 4, !tbaa !287
  br label %bb.p

bb.o:                                             ; preds = %.thread
  %i.bu = load ptr, ptr %i.aq, align 8, !tbaa !186
  %i.bv = getelementptr inbounds nuw i8, ptr %i.u, i64 8
  store ptr %i.bu, ptr %i.bv, align 8, !tbaa !269
  %i.bw = load i32, ptr %i.ab, align 8, !tbaa !275
  store i32 %i.bw, ptr %i.u, align 8, !tbaa !272
  %i.bx = getelementptr inbounds nuw i8, ptr %0, i64 104
  %i.by = load i32, ptr %i.bx, align 8, !tbaa !278
  %i.bz = getelementptr inbounds nuw i8, ptr %i.u, i64 4
  store i32 %i.by, ptr %i.bz, align 4, !tbaa !287
  %i.ca = tail call i64 @getStringObjectLen(ptr noundef nonnull %i.ap)
  %i.cb = getelementptr inbounds nuw i8, ptr %i.u, i64 16 ; 2 uses
  %i.cc = load i64, ptr %i.cb, align 8, !tbaa !292
  %i.cd = sub i64 %i.cc, %i.ca
  store i64 %i.cd, ptr %i.cb, align 8, !tbaa !292
  br label %bb.p
...
bb.q:                                             ; preds = %bb.p
  %i.ce = tail call i64 @getStringObjectLen(ptr noundef nonnull %2)
  %i.cf = getelementptr inbounds nuw i8, ptr %i.u, i64 16 ; 2 uses
  %i.cg = load i64, ptr %i.cf, align 8, !tbaa !292
  %i.ch = add i64 %i.cg, %i.ce
  store i64 %i.ch, ptr %i.cf, align 8, !tbaa !292
  br label %bb.r

bb.r:                                             ; preds = %.thread, %bb.p, %bb.q, %bb.m
  %i.ci = icmp eq i32 %1, 0
  br i1 %i.ci, label %bb.s, label %bb.w

bb.s:                                             ; preds = %bb.r
  %i.cj = load ptr, ptr %i.aq, align 8, !tbaa !186
  %i.ck = load i32, ptr %i.ab, align 8, !tbaa !275
  %i.cl = tail call ptr @lookupCommandOrOriginal(ptr noundef %i.cj, i32 noundef %i.ck) #30 ; 3 uses
  %i.cm = getelementptr inbounds nuw i8, ptr %0, i64 192
  store ptr %i.cl, ptr %i.cm, align 8, !tbaa !154
...
bb.v:                                             ; preds = %bb.u
  ...
  store ptr %i.cl, ptr %i.cn, align 8, !tbaa !329
  br label %bb.w
...
getClientType.exit:                               ; preds = %bb.f, %bb.g, %getClientOutputBufferMemoryUsage.exit.thread
  ...
  %i.ax = load i64, ptr %i.aw, align 8, !tbaa !367 ; 3 uses
  ...
  %.0 = select i1 %or.cond, i64 %spec.select, i64 %i.ax
  %.not32 = icmp uge i64 %.0.i43, %.0
  %or.cond37.not = select i1 %i.az, i1 %.not32, i1 false ; 3 uses
  %i.bb = getelementptr inbounds nuw i8, ptr %i.aw, i64 8
  %i.bc = load i64, ptr %i.bb, align 8, !tbaa !369
  %i.bd = add i64 %i.bc, -1
...
bb.i:                                             ; preds = %.critedge
  ...
  %i.bl = load i64, ptr %i.bk, align 8, !tbaa !370
...
bb.l:                                             ; preds = %authRequired.exit, %bb.k
  %.027 = phi i32 [ %i.bn, %bb.k ], [ 1, %authRequired.exit ]
  ret i32 %.027
}
...
.lr.ph:                                           ; preds = %bb.a, %bb.m
  %i.c = phi ptr [ %i.ba, %bb.m ], [ %i.b, %bb.a ]
...
bb.b:                                             ; preds = %.lr.ph
  ...
  br i1 %.not.i, label %.split, label %bb.c, !prof !142

.split:                                           ; preds = %bb.b
  %i.j = call fastcc i32 @_clientHasPendingRepliesSlave(ptr noundef nonnull readonly %i.e)
  %i.k = icmp eq i32 %i.j, 0
  br i1 %i.k, label %bb.m, label %clientHasPendingReplies.exit.clientHasPendingReplies.exit.thread_crit_edge, !llvm.loop !371
...
clientHasPendingReplies.exit:                     ; preds = %bb.c
  ...
  br i1 %.not30, label %bb.m, label %clientHasPendingReplies.exit.clientHasPendingReplies.exit.thread_crit_edge, !llvm.loop !371

clientHasPendingReplies.exit.clientHasPendingReplies.exit.thread_crit_edge: ; preds = %.split, %clientHasPendingReplies.exit
  %.pre = load i64, ptr %i.h, align 8, !tbaa !99
  br label %clientHasPendingReplies.exit.thread, !llvm.loop !371

clientHasPendingReplies.exit.thread:              ; preds = %clientHasPendingReplies.exit.clientHasPendingReplies.exit.thread_crit_edge, %bb.c
  %i.r = phi i64 [ %.pre, %clientHasPendingReplies.exit.clientHasPendingReplies.exit.thread_crit_edge ], [ %.val.i, %bb.c ] ; 2 uses
  %i.s = and i64 %i.r, 2097152
  %.not.i20 = icmp eq i64 %i.s, 0
  br i1 %.not.i20, label %bb.d, label %putClientInPendingWriteQueue.exit

bb.d:                                             ; preds = %clientHasPendingReplies.exit.thread
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %.not7.i, label %bb.f, label %putClientInPendingWriteQueue.exit
...
putClientInPendingWriteQueue.exit:                ; preds = %bb.f, %bb.e, %bb.d, %clientHasPendingReplies.exit.thread, %.lr.ph
...
bb.g:                                             ; preds = %putClientInPendingWriteQueue.exit
...
bb.h:                                             ; preds = %bb.g, %putClientInPendingWriteQueue.exit
  %i.ah = phi i1 [ true, %putClientInPendingWriteQueue.exit ], [ %i.ag, %bb.g ]
  %i.ai = getelementptr inbounds nuw i8, ptr %i.e, i64 356
  %i.aj = load i32, ptr %i.ai, align 4, !tbaa !111
  switch i32 %i.aj, label %bb.m [
    i32 9, label %bb.i
    i32 12, label %bb.i
  ]
...
clientHasPendingReplies.exit25:                   ; preds = %bb.l
  ...
  br i1 %.not32, label %bb.m, label %clientHasPendingReplies.exit25.thread

clientHasPendingReplies.exit25.thread:            ; preds = %.split35, %bb.l, %clientHasPendingReplies.exit25
  %i.az = call i32 @writeToClient(ptr noundef nonnull %i.e, i32 noundef 0) ; 0 uses
  br label %bb.m

bb.m:                                             ; preds = %.split35, %.split, %bb.i, %bb.j, %clientHasPendingReplies.exit25, %clientHasPendingReplies.exit25.thread, %bb.h, %clientHasPendingReplies.exit
...
bb.a:
  ...
  %i.b = load i64, ptr getelementptr inbounds nuw (i8, ptr @server, i64 8064), align 8, !tbaa !372 ; 4 uses
...
bb.n:                                             ; preds = %bb.m
  call void @llvm.lifetime.start.p0(ptr nonnull %0) #30
  %i.y = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 1552), align 8, !tbaa !373
...
.lr.ph.i:                                         ; preds = %bb.n, %.lr.ph.i
  ...
  br i1 %.not.i, label %unblockPostponedClients.exit, label %.lr.ph.i, !llvm.loop !374
...
bb.a:
  %0 = alloca %struct.listIter, align 8           ; 5 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %0) #30
  %i.a = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 1552), align 8, !tbaa !373
  call void @listRewind(ptr noundef %i.a, ptr noundef nonnull %0) #30
  %i.b = call ptr @listNext(ptr noundef nonnull %0) #30 ; 2 uses
...
bb.a:
  ...
  %i.a = load i64, ptr getelementptr inbounds nuw (i8, ptr @server, i64 8096), align 8, !tbaa !375
  %i.b = load i64, ptr getelementptr inbounds nuw (i8, ptr @server, i64 8064), align 8, !tbaa !372
  store i64 %i.b, ptr getelementptr inbounds nuw (i8, ptr @server, i64 8096), align 8, !tbaa !375
  ...
  %i.e = load i64, ptr getelementptr inbounds nuw (i8, ptr @server, i64 2456), align 8, !tbaa !376
  %i.f = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 88), align 8, !tbaa !377
  %i.g = tail call i32 @aeProcessEvents(ptr noundef %i.f, i32 noundef 29) #30
  %i.h = sext i32 %i.g to i64
  %i.i = load i64, ptr getelementptr inbounds nuw (i8, ptr @server, i64 2456), align 8, !tbaa !376
  %i.j = add nsw i64 %i.i, %i.h                   ; 3 uses
  store i64 %i.j, ptr getelementptr inbounds nuw (i8, ptr @server, i64 2456), align 8, !tbaa !376
  %.not7 = icmp eq i64 %i.j, %i.e
  br i1 %.not7, label %bb.e, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.k = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 88), align 8, !tbaa !377
  %i.l = tail call i32 @aeProcessEvents(ptr noundef %i.k, i32 noundef 29) #30
  %i.m = sext i32 %i.l to i64
  %i.n = load i64, ptr getelementptr inbounds nuw (i8, ptr @server, i64 2456), align 8, !tbaa !376
  %i.o = add nsw i64 %i.n, %i.m                   ; 3 uses
  store i64 %i.o, ptr getelementptr inbounds nuw (i8, ptr @server, i64 2456), align 8, !tbaa !376
  %.not7.1 = icmp eq i64 %i.o, %i.j
  br i1 %.not7.1, label %bb.e, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.p = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 88), align 8, !tbaa !377
  %i.q = tail call i32 @aeProcessEvents(ptr noundef %i.p, i32 noundef 29) #30
  %i.r = sext i32 %i.q to i64
  %i.s = load i64, ptr getelementptr inbounds nuw (i8, ptr @server, i64 2456), align 8, !tbaa !376
  %i.t = add nsw i64 %i.s, %i.r                   ; 2 uses
  store i64 %i.t, ptr getelementptr inbounds nuw (i8, ptr @server, i64 2456), align 8, !tbaa !376
  %.not7.2 = icmp eq i64 %i.t, %i.o
  br i1 %.not7.2, label %bb.e, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.u = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 88), align 8, !tbaa !377
  %i.v = tail call i32 @aeProcessEvents(ptr noundef %i.u, i32 noundef 29) #30
  %i.w = sext i32 %i.v to i64
  %i.x = load i64, ptr getelementptr inbounds nuw (i8, ptr @server, i64 2456), align 8, !tbaa !376
  %i.y = add nsw i64 %i.x, %i.w
  store i64 %i.y, ptr getelementptr inbounds nuw (i8, ptr @server, i64 2456), align 8, !tbaa !376
  br label %bb.e
...
bb.g:                                             ; preds = %bb.e
  store i64 %i.a, ptr getelementptr inbounds nuw (i8, ptr @server, i64 8096), align 8, !tbaa !375
  ret void
}
...
bb.a:
  %i.a = load i64, ptr getelementptr inbounds nuw (i8, ptr @server, i64 7760), align 8, !tbaa !378 ; 4 uses
...
bb.e:                                             ; preds = %bb.c, %bb.d
  %.06 = phi i64 [ %spec.store.select, %bb.d ], [ 0, %bb.c ]
  ret i64 %.06
}
...
bb.a:
  %0 = alloca %struct.listIter, align 8           ; 5 uses
  %i.a = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 1512), align 8, !tbaa !379 ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load i64, ptr getelementptr inbounds nuw (i8, ptr @server, i64 7760), align 8, !tbaa !378 ; 4 uses
...
.lr.ph:                                           ; preds = %getClientEvictionLimit.exit, %bb.n
  %.02438 = phi i32 [ %.2, %bb.n ], [ 18, %getClientEvictionLimit.exit ] ; 6 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.ad = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 1512), align 8, !tbaa !379
  %i.ae = sext i32 %.02438 to i64
...
bb.i:                                             ; preds = %bb.h, %.thread
  ...
  %i.al = load i64, ptr getelementptr inbounds nuw (i8, ptr @server, i64 2616), align 8, !tbaa !380
  %i.am = add nsw i64 %i.al, 1
  store i64 %i.am, ptr getelementptr inbounds nuw (i8, ptr @server, i64 2616), align 8, !tbaa !380
  br i1 %.not32, label %bb.n, label %.thread43

.thread43:                                        ; preds = %bb.g, %bb.i
  call void @resumeIOThread(i32 noundef %i.w) #30
  %i.an = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 1512), align 8, !tbaa !379
  %i.ao = sext i32 %.02438 to i64
  %i.ap = getelementptr inbounds [16 x i8], ptr %i.an, i64 %i.ao
  br label %.sink.split

bb.j:                                             ; preds = %.lr.ph
  %i.aq = icmp slt i32 %.02438, 1
...
bb.m:                                             ; preds = %bb.j
  %i.at = add nsw i32 %.02438, -1                 ; 2 uses
  %i.au = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 1512), align 8, !tbaa !379
...
.sink.split:                                      ; preds = %.thread43, %bb.m
  ...
  %.2.ph = phi i32 [ %i.at, %bb.m ], [ %.02438, %.thread43 ]
...
bb.n:                                             ; preds = %.sink.split, %bb.i
  %.2 = phi i32 [ %.02438, %bb.i ], [ %.2.ph, %.sink.split ]
...
bb.f:                                             ; preds = %freePendingCommand.exit, %.lr.ph
  ...
  br i1 %i.ag, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !381
...
bb.f:                                             ; preds = %ioDeferFreeRobj.exit.us, %bb.c, %.lr.ph.split.us
  ...
  br i1 %i.y, label %.lr.ph.split.us, label %._crit_edge, !llvm.loop !383
...
bb.i:                                             ; preds = %.lr.ph.split, %bb.g, %bb.h
  ...
  br i1 %i.af, label %.lr.ph.split, label %._crit_edge, !llvm.loop !383
...
bb.a:
  ...
  %i.e = load i16, ptr %i.d, align 8, !tbaa !384
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not122, label %bb.c, label %bb.d, !prof !13
...
bb.c:                                             ; preds = %bb.b
  ...
  store ptr %i.r, ptr %5, align 16, !tbaa !391
  %i.s = sub i64 %i.k, %i.q                       ; 2 uses
  %i.t = getelementptr inbounds nuw i8, ptr %5, i64 8
  store i64 %i.s, ptr %i.t, align 8, !tbaa !393
  store i32 1, ptr %i.h, align 4, !tbaa !389
  store i64 %i.s, ptr %i.i, align 8, !tbaa !390
  br label %bb.g
...
bb.d:                                             ; preds = %bb.b
  ...
  br i1 %.not123, label %.thread, label %bb.e

bb.e:                                             ; preds = %bb.d
  %.not124 = icmp ult ptr %i.v, %i.x
  br i1 %.not124, label %.critedge142, label %.thread, !prof !394
...
.thread:                                          ; preds = %bb.d, %bb.e
  ...
  br i1 %i.aa, label %bb.f, label %.critedge142, !prof !13

.critedge142:                                     ; preds = %bb.e, %.thread
...
bb.f:                                             ; preds = %.thread
  ...
  %.pre164 = load i32, ptr %i.h, align 4, !tbaa !389
  %.pre165 = load i32, ptr %i.g, align 8, !tbaa !388
  br label %bb.g

bb.g:                                             ; preds = %bb.c, %bb.f, %bb.a
  %i.ad = phi i32 [ %spec.select, %bb.c ], [ %.pre165, %bb.f ], [ %spec.select, %bb.a ]
  %i.ae = phi i32 [ 1, %bb.c ], [ %.pre164, %bb.f ], [ 0, %bb.a ] ; 6 uses
...
replyIOVReachLimit.exit:                          ; preds = %bb.g
  %i.af = load i64, ptr %i.i, align 8, !tbaa !390 ; 2 uses
...
bb.h:                                             ; preds = %replyIOVReachLimit.exit
  ...
  %.not126 = icmp eq i64 %i.ah, 0
  br i1 %.not126, label %bb.i, label %bb.j
...
bb.j:                                             ; preds = %bb.h, %bb.i
  ...
  %.not128158 = icmp eq ptr %i.aq, null
  br i1 %.not128158, label %.critedge, label %bb.k
...
bb.l:                                             ; preds = %bb.k
  ...
  %.not130.peel = icmp eq i8 %i.ay, 0
  %.not131.peel = icmp eq ptr %i.an, null         ; 2 uses
  br i1 %.not130.peel, label %bb.n, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.az = getelementptr inbounds nuw i8, ptr %i.at, i64 17 ; 2 uses
  %i.ba = select i1 %.not131.peel, ptr %i.az, ptr %i.an
...
bb.n:                                             ; preds = %bb.l
  br i1 %.not131.peel, label %bb.o, label %bb.u, !prof !13
...
bb.o:                                             ; preds = %bb.n
  ...
  store ptr %i.bd, ptr %i.bf, align 16, !tbaa !391
  %i.bg = sub i64 %i.av, %i.am                    ; 2 uses
  %i.bh = getelementptr inbounds nuw i8, ptr %i.bf, i64 8
  store i64 %i.bg, ptr %i.bh, align 8, !tbaa !393
  %i.bi = add nsw i32 %i.ae, 1
  store i32 %i.bi, ptr %i.h, align 4, !tbaa !389
  %i.bj = add i64 %i.af, %i.bg
  store i64 %i.bj, ptr %i.i, align 8, !tbaa !390
  br label %bb.q
...
bb.p:                                             ; preds = %bb.k
  ...
  br label %bb.q, !llvm.loop !395

bb.q:                                             ; preds = %bb.p, %bb.o, %bb.m
  %i.bo = call ptr @listNext(ptr noundef nonnull %3) #30 ; 2 uses
  %.not128.peel = icmp eq ptr %i.bo, null
  br i1 %.not128.peel, label %.critedge.loopexit, label %.peel.next

.peel.next:                                       ; preds = %bb.q, %bb.x
  %i.bp = phi ptr [ %i.cm, %bb.x ], [ %i.bo, %bb.q ] ; 2 uses
  %i.bq = load i32, ptr %i.h, align 4, !tbaa !389 ; 3 uses
  %i.br = load i32, ptr %i.g, align 8, !tbaa !388
  %.not.i144 = icmp slt i32 %i.bq, %i.br
  %i.bs = load i64, ptr %i.i, align 8             ; 2 uses
  %i.bt = icmp ult i64 %i.bs, 65536
  %or.cond = select i1 %.not.i144, i1 %i.bt, i1 false
...
bb.v:                                             ; preds = %bb.t
  ...
  store ptr %i.cf, ptr %i.ch, align 16, !tbaa !391
  %i.ci = getelementptr inbounds nuw i8, ptr %i.ch, i64 8
  store i64 %i.bx, ptr %i.ci, align 8, !tbaa !393
  %i.cj = add nsw i32 %i.bq, 1
  store i32 %i.cj, ptr %i.h, align 4, !tbaa !389
  %i.ck = add i64 %i.bs, %i.bx
  store i64 %i.ck, ptr %i.i, align 8, !tbaa !390
  br label %bb.x
...
bb.x:                                             ; preds = %bb.v, %bb.w, %bb.s
  ...
  %.not128 = icmp eq ptr %i.cm, null
  br i1 %.not128, label %.critedge.loopexit, label %.peel.next, !llvm.loop !396

.critedge.loopexit:                               ; preds = %.peel.next, %bb.x, %bb.q
  %.pr.pre.pre = load i32, ptr %i.h, align 4, !tbaa !389
  br label %.critedge
...
bb.y:                                             ; preds = %replyIOVReachLimit.exit.thread
  ...
  %i.cs = load ptr, ptr %i.cr, align 8, !tbaa !398
  %i.ct = call i32 %i.cs(ptr noundef nonnull %i.cp, ptr noundef nonnull %5, i32 noundef range(i32 1, 0) %i.cn) #30, !inline_history !399 ; 2 uses
...
bb.z:                                             ; preds = %bb.y
  ...
  %.not133 = icmp eq i64 %i.cw, 0
  br i1 %.not133, label %.thread194, label %bb.aa

.thread194:                                       ; preds = %bb.z
...
bb.aa:                                            ; preds = %bb.z
  ...
  %.not134 = icmp eq i8 %i.da, 0
  br i1 %.not134, label %bb.ab, label %bb.ae, !prof !13
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %.not137 = icmp sgt i64 %i.df, %i.cu
  br i1 %.not137, label %bb.ad, label %bb.ac
...
bb.ae:                                            ; preds = %bb.aa
  ...
  %.not136 = icmp eq ptr %i.dn, null
  br i1 %.not136, label %bb.af, label %thread-pre-split148
...
thread-pre-split148:                              ; preds = %bb.af, %bb.ae
  %.old.pr = load i64, ptr %i.a, align 8, !tbaa !20
  br label %bb.ag

bb.ag:                                            ; preds = %thread-pre-split148, %bb.ad
  %.old = phi i64 [ %.old.pr, %thread-pre-split148 ], [ %i.dg, %bb.ad ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #30
  ...
  %.old143 = icmp sgt i64 %.old, 0
  br i1 %.old143, label %.preheader, label %.thread151

.preheader:                                       ; preds = %.thread194, %bb.ag
  %i.dq = phi ptr [ %i.cx, %.thread194 ], [ %i.do, %bb.ag ] ; 2 uses
  %.old197 = phi i64 [ %i.cu, %.thread194 ], [ %.old, %bb.ag ]
...
bb.ah:                                            ; preds = %.preheader, %bb.am
  %i.du = phi i64 [ %.old197, %.preheader ], [ %i.ew, %bb.am ] ; 3 uses
  ...
  %.not138 = icmp eq i8 %i.dz, 0
  br i1 %.not138, label %bb.ai, label %bb.al
...
bb.al:                                            ; preds = %bb.ah
  ...
  %.not139 = icmp eq ptr %i.el, null
  %i.em = getelementptr inbounds nuw i8, ptr %i.dx, i64 17 ; 2 uses
  %i.en = select i1 %.not139, ptr %i.em, ptr %i.el
  ...
  %.not140 = icmp eq ptr %i.er, null
  br i1 %.not140, label %.thread149, label %.thread151

.thread149:                                       ; preds = %bb.al
  ...
  store i64 0, ptr %i.ds, align 8, !tbaa !98
  %.pre170 = load i64, ptr %i.a, align 8
  br label %bb.am

bb.am:                                            ; preds = %bb.ak, %.thread149
  %i.ew = phi i64 [ %i.eg, %bb.ak ], [ %.pre170, %.thread149 ] ; 2 uses
  %i.ex = icmp sgt i64 %i.ew, 0
  br i1 %i.ex, label %bb.ah, label %.thread151

.thread151:                                       ; preds = %bb.al, %bb.am, %bb.aj, %bb.ag
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #30
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #30
  br label %bb.an

bb.an:                                            ; preds = %bb.y, %replyIOVReachLimit.exit.thread, %.thread151
  %.0 = phi i32 [ 0, %.thread151 ], [ 0, %replyIOVReachLimit.exit.thread ], [ -1, %bb.y ]
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %i.e = load i32, ptr %i.d, align 8, !tbaa !388  ; 6 uses
  %.promoted = load i32, ptr %i.a, align 4, !tbaa !389 ; 6 uses
...
replyIOVReachLimit.exit.peel:                     ; preds = %.lr.ph
  %i.f = load i64, ptr %i.b, align 8, !tbaa !390  ; 4 uses
...
bb.j:                                             ; preds = %replyIOVReachLimit.exit83.peel, %bb.i
  ...
  %.171.peel = phi i64 [ 0, %replyIOVReachLimit.exit83.peel ], [ %i.ah, %bb.i ] ; 4 uses
  %i.at = icmp ult i64 %.171.peel, %.0.i.peel
  br i1 %i.at, label %bb.l, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.au = sub nuw i64 %.171.peel, %.0.i.peel      ; 2 uses
...
.thread.peel:                                     ; preds = %bb.l
  %i.ax = getelementptr inbounds nuw i8, ptr %i.q, i64 %.171.peel
  %i.ay = load ptr, ptr %0, align 8, !tbaa !385
  %i.az = sext i32 %i.as to i64
  %i.ba = getelementptr inbounds [16 x i8], ptr %i.ay, i64 %i.az ; 2 uses
  store ptr %i.ax, ptr %i.ba, align 8, !tbaa !391
  %i.bb = sub i64 %.0.i.peel, %.171.peel          ; 2 uses
  %i.bc = getelementptr inbounds nuw i8, ptr %i.ba, i64 8
  store i64 %i.bb, ptr %i.bc, align 8, !tbaa !393
  %i.bd = add nsw i32 %i.as, 1                    ; 2 uses
  store i32 %i.bd, ptr %i.a, align 4, !tbaa !389
  %i.be = add i64 %i.ar, %i.bb                    ; 2 uses
  store i64 %i.be, ptr %i.b, align 8, !tbaa !390
  br label %bb.m
...
.sink.split:                                      ; preds = %bb.n, %bb.o
  ...
  store i64 %.sink, ptr %i.b, align 8, !tbaa !390
  br label %bb.p
...
.peel.next:                                       ; preds = %bb.p, %bb.ac
  ...
  %.06894 = phi ptr [ %i.et, %bb.ac ], [ %i.ce, %bb.p ] ; 8 uses
...
bb.q:                                             ; preds = %.peel.next
  %i.cj = getelementptr inbounds nuw i8, ptr %.06894, i64 8
  %i.ck = load i8, ptr %i.cj, align 1, !tbaa !156
  %i.cl = icmp eq i8 %i.ck, 0
  %i.cm = getelementptr inbounds nuw i8, ptr %.06894, i64 9 ; 2 uses
  br i1 %i.cl, label %bb.r, label %bb.s

bb.r:                                             ; preds = %bb.q
  %i.cn = load ptr, ptr %0, align 8, !tbaa !385
  %i.co = sext i32 %i.ch to i64
  %i.cp = getelementptr inbounds [16 x i8], ptr %i.cn, i64 %i.co ; 2 uses
  store ptr %i.cm, ptr %i.cp, align 8, !tbaa !391
  %i.cq = load i64, ptr %.06894, align 1, !tbaa !158 ; 2 uses
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cp, i64 8
  store i64 %i.cq, ptr %i.cr, align 8, !tbaa !393
  %i.cs = add nsw i32 %i.ch, 1                    ; 2 uses
  store i32 %i.cs, ptr %i.a, align 4, !tbaa !389
  %i.ct = add i64 %i.cg, %i.cq
  br label %bb.ac

bb.s:                                             ; preds = %bb.q
  %i.cu = getelementptr inbounds nuw i8, ptr %.06894, i64 17
...
replyIOVReachLimit.exit83:                        ; preds = %sdslen.exit
  %i.dp = getelementptr inbounds nuw i8, ptr %.06894, i64 21
  %i.dq = load ptr, ptr %0, align 8, !tbaa !385
  %i.dr = sext i32 %i.ch to i64
  %i.ds = getelementptr inbounds [16 x i8], ptr %i.dq, i64 %i.dr ; 2 uses
  store ptr %i.dp, ptr %i.ds, align 8, !tbaa !391
  %i.dt = getelementptr inbounds nuw i8, ptr %i.ds, i64 8
  store i64 %i.cw, ptr %i.dt, align 8, !tbaa !393
  %i.du = add nsw i32 %i.ch, 1                    ; 2 uses
  store i32 %i.du, ptr %i.a, align 4, !tbaa !389
  %i.dv = add nuw nsw i64 %i.cg, %i.cw            ; 2 uses
  store i64 %i.dv, ptr %i.b, align 8, !tbaa !390
  br label %bb.y
...
.thread:                                          ; preds = %bb.z
  %i.dz = load ptr, ptr %0, align 8, !tbaa !385
  %i.ea = sext i32 %i.dx to i64
  %i.eb = getelementptr inbounds [16 x i8], ptr %i.dz, i64 %i.ea ; 2 uses
  store ptr %i.cz, ptr %i.eb, align 8, !tbaa !391
  %i.ec = getelementptr inbounds nuw i8, ptr %i.eb, i64 8
  store i64 %.0.i, ptr %i.ec, align 8, !tbaa !393
  %i.ed = add nsw i32 %i.dx, 1                    ; 2 uses
  store i32 %i.ed, ptr %i.a, align 4, !tbaa !389
  %i.ee = add i64 %i.dw, %.0.i                    ; 2 uses
  store i64 %i.ee, ptr %i.b, align 8, !tbaa !390
  br label %bb.aa
...
bb.ab:                                            ; preds = %bb.aa
  %i.ei = getelementptr inbounds nuw i8, ptr %.06894, i64 45
  %i.ej = load ptr, ptr %0, align 8, !tbaa !385
  %i.ek = sext i32 %i.eg to i64
  %i.el = getelementptr inbounds [16 x i8], ptr %i.ej, i64 %i.ek ; 2 uses
  store ptr %i.ei, ptr %i.el, align 8, !tbaa !391
  %i.em = getelementptr inbounds nuw i8, ptr %i.el, i64 8
  store i64 2, ptr %i.em, align 8, !tbaa !393
  %i.en = add nsw i32 %i.eg, 1                    ; 2 uses
  store i32 %i.en, ptr %i.a, align 4, !tbaa !389
...
bb.ac:                                            ; preds = %bb.ab, %bb.r
  ...
  store i64 %i.ep, ptr %i.b, align 8, !tbaa !390
  %i.er = load i64, ptr %.06894, align 1, !tbaa !158
  %i.es = getelementptr i8, ptr %.06894, i64 %i.er
  %i.et = getelementptr i8, ptr %i.es, i64 9      ; 2 uses
  %i.eu = icmp ult ptr %i.et, %2
  br i1 %i.eu, label %.peel.next, label %.critedge, !llvm.loop !400
...
bb.n:                                             ; preds = %bb.m, %ioDeferFreeRobj.exit.us
  ...
  br i1 %i.bg, label %.lr.ph.split.us, label %.critedge, !llvm.loop !401
...
bb.y:                                             ; preds = %bb.q, %bb.x
  ...
  br i1 %i.cx, label %.lr.ph.split, label %.critedge, !llvm.loop !401
...
!367 = !{!368, !31, i64 0}
!368 = !{!"clientBufferLimitsConfig", !31, i64 0, !31, i64 8, !21, i64 16}
!369 = !{!368, !31, i64 8}
!370 = !{!368, !21, i64 16}
!371 = distinct !{!371, !175}
!372 = !{!23, !31, i64 8064}
!373 = !{!23, !32, i64 1552}
...
!379 = !{!23, !16, i64 1512}
!380 = !{!23, !31, i64 2616}
!381 = distinct !{!381, !175}
!382 = !{!"branch_weights", i32 1, i32 2001, i32 2000}
!383 = distinct !{!383, !175}
!384 = !{!77, !19, i64 24}
!385 = !{!386, !387, i64 0}
!386 = !{!"ReplyIOV", !387, i64 0, !10, i64 8, !10, i64 12, !21, i64 16}
!387 = !{!"p1 _ZTS5iovec", !16, i64 0}
!388 = !{!386, !10, i64 8}
!389 = !{!386, !10, i64 12}
!390 = !{!386, !21, i64 16}
!391 = !{!392, !16, i64 0}
!392 = !{!"iovec", !16, i64 0, !21, i64 8}
!393 = !{!392, !21, i64 8}
!394 = !{!"branch_weights", !"expected", i32 1717127, i32 2145766521}
!395 = distinct !{!395, !175}
!396 = distinct !{!396, !397}
!397 = !{!"llvm.loop.peeled.count", i32 1}
!398 = !{!79, !16, i64 136}
!399 = distinct !{null}
!400 = distinct !{!400, !175, !397}
!401 = distinct !{!401, !175}
end_hunk_1
