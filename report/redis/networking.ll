...
bb.m:                                             ; preds = %bb.l, %tryAddPayload.exit.i
  ...
  %4 = add i64 %3, %.sink32.i                     ; 3 uses
  store i64 %4, ptr %i.ak, align 8, !tbaa !20
...
bb.n:                                             ; preds = %bb.m
  store i64 %4, ptr %i.bb, align 8, !tbaa !89
...
begin_hunk_15_@processInputBuffer:bb.a
  ...
  %12 = add i64 %i.hq, 3
  %13 = load i64, ptr %i.gg, align 8, !tbaa !316
  %i.kb = add i64 %12, %13
...
begin_hunk_16_@processInputBuffer:bb.a
  ...
  %14 = add nsw i64 %i.ms, 2
  %15 = load i64, ptr %i.l, align 8, !tbaa !124
  %i.mx = add i64 %14, %15
...
sdslen.exit:                                      ; preds = %bb.r, %bb.s, %bb.t, %bb.u, %bb.v, %bb.w
  ...
  %i.cn = add nuw nsw i64 %i.bt, 2
  %7 = add i64 %i.cn, %.0.i
  %8 = sub i64 %7, %i.cm                          ; 2 uses
