...
begin_hunk_0_@luaM_growaux_:bb.a
  ...
  %i.r = tail call ptr %i.o(ptr noundef %i.q, ptr noundef %1, i64 noundef %i.i, i64 noundef %i.k) #3, !inline_history !30 ; 2 uses
...
luaM_realloc_.exit:                               ; preds = %bb.f, %bb.g
  ...
  %i.w = sub i64 %i.k, %i.i
  %i.x = add i64 %i.w, %i.v
  store i64 %i.x, ptr %i.u, align 8, !tbaa !31
  br label %bb.i
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.l = sub i64 %3, %2
  %i.m = add i64 %i.l, %i.k
  store i64 %i.m, ptr %i.j, align 8, !tbaa !31
  ret ptr %i.g
}
