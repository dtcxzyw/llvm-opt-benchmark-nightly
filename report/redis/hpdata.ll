...
begin_hunk_0_@je_hpdata_init:bb.a
bb.a:
...
.lr.ph.preheader:                                 ; preds = %fb_set_range.exit
  ...
  %i.bz = sub nsw i64 %i.a, %i.by
  %i.ca = add nsw i64 %i.bz, %i.am
  %i.cb = add nsw i64 %i.ca, -65                  ; 2 uses
  %i.cc = lshr i64 %i.cb, 6
  %i.cd = add nuw nsw i64 %i.cc, 1                ; 2 uses
  %min.iters.check = icmp ult i64 %i.cb, 192
  br i1 %min.iters.check, label %.lr.ph.preheader238, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph.preheader
  %n.vec = and i64 %i.cd, 576460752303423484      ; 4 uses
  %i.ce = add nuw nsw i64 %.029.i9.i, %n.vec      ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.cl = tail call range(i64 0, 65) <2 x i64> @llvm.ctpop.v2i64(<2 x i64> %wide.load)
  %i.cm = tail call range(i64 0, 65) <2 x i64> @llvm.ctpop.v2i64(<2 x i64> %wide.load221)
  %i.cn = add <2 x i64> %i.cl, %vec.phi           ; 2 uses
  %i.co = add <2 x i64> %i.cm, %vec.phi220        ; 2 uses
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.cp = icmp eq i64 %index.next, %n.vec
  br i1 %i.cp, label %middle.block, label %vector.body, !llvm.loop !38

middle.block:                                     ; preds = %vector.body
  %bin.rdx = add <2 x i64> %i.co, %i.cn
  %i.cq = tail call i64 @llvm.vector.reduce.add.v2i64(<2 x i64> %bin.rdx) ; 2 uses
...
.lr.ph.preheader238:                              ; preds = %.lr.ph.preheader, %middle.block
  %.029.i.i129.ph = phi i64 [ %.029.i9.i, %.lr.ph.preheader ], [ %i.ce, %middle.block ]
  %.0.i.i128.ph = phi i64 [ %i.ax, %.lr.ph.preheader ], [ %i.cg, %middle.block ]
  %.097127.ph = phi i64 [ %i.bx, %.lr.ph.preheader ], [ %i.cq, %middle.block ]
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader238, %.lr.ph
  %.029.i.i129 = phi i64 [ %.029.i.i, %.lr.ph ], [ %.029.i.i129.ph, %.lr.ph.preheader238 ] ; 2 uses
  %.0.i.i128 = phi i64 [ %i.cv, %.lr.ph ], [ %.0.i.i128.ph, %.lr.ph.preheader238 ]
  %.097127 = phi i64 [ %i.cu, %.lr.ph ], [ %.097127.ph, %.lr.ph.preheader238 ]
  %i.cr = getelementptr inbounds nuw [8 x i8], ptr %i.bt, i64 %.029.i.i129
  %i.cs = load i64, ptr %i.cr, align 8, !tbaa !35
  %i.ct = tail call range(i64 0, 65) i64 @llvm.ctpop.i64(i64 %i.cs)
  %i.cu = add i64 %i.ct, %.097127                 ; 2 uses
  %i.cv = add i64 %.0.i.i128, -64                 ; 3 uses
  %.029.i.i = add nuw nsw i64 %.029.i.i129, 1     ; 2 uses
  %i.cw = icmp ugt i64 %i.cv, 64
  br i1 %i.cw, label %.lr.ph, label %fb_scount.exit, !llvm.loop !41
...
fb_scount.exit.thread:                            ; preds = %._crit_edge
  %i.cx = or i64 %i.bv, %i.at
  store i64 %i.cx, ptr %i.bu, align 8, !tbaa !35
  br label %._crit_edge.i47

fb_scount.exit:                                   ; preds = %.lr.ph, %middle.block, %._crit_edge
  %.029.i.i.lcssa173 = phi i64 [ %.029.i9.i, %._crit_edge ], [ %i.ce, %middle.block ], [ %.029.i.i, %.lr.ph ]
  %.0.i.i.lcssa172 = phi i64 [ %i.ax, %._crit_edge ], [ %i.cg, %middle.block ], [ %i.cv, %.lr.ph ]
  %.097.lcssa171 = phi i64 [ %i.bx, %._crit_edge ], [ %i.cq, %middle.block ], [ %i.cu, %.lr.ph ]
  %i.cy = sub nuw nsw i64 64, %.0.i.i.lcssa172
  %i.cz = lshr i64 -1, %i.cy
  %i.da = getelementptr inbounds nuw [8 x i8], ptr %i.bt, i64 %.029.i.i.lcssa173
  %i.db = load i64, ptr %i.da, align 8, !tbaa !35
  %i.dc = and i64 %i.db, %i.cz
  %i.dd = tail call range(i64 0, 65) i64 @llvm.ctpop.i64(i64 %i.dc)
  %i.de = add i64 %i.dd, %.097.lcssa171           ; 2 uses
  %i.df = or i64 %i.bv, %i.at
  store i64 %i.df, ptr %i.bu, align 8, !tbaa !35
...
fb_assign_visitor.exit.preheader.i52:             ; preds = %fb_scount.exit
  %i.dg = shl nuw nsw i64 %i.al, 3
  %i.dh = getelementptr i8, ptr %i.bt, i64 %i.dg
  %scevgep.i53 = getelementptr i8, ptr %i.dh, i64 8
  %i.di = add nsw i64 %i.an, -65
  %umin.i54 = tail call i64 @llvm.umin.i64(i64 %i.an, i64 64) ; 2 uses
  %i.dj = sub nsw i64 %i.di, %umin.i54            ; 2 uses
  %i.dk = lshr i64 %i.dj, 6                       ; 2 uses
  %i.dl = shl nuw nsw i64 %i.dk, 3
  %i.dm = add nuw nsw i64 %i.dl, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep.i53, i8 -1, i64 %i.dm, i1 false), !tbaa !35
  %i.dn = and i64 %i.dj, -64
  %.neg115 = add nsw i64 %i.an, -64
  %i.do = add nsw i64 %umin.i54, %i.dn
  %i.dp = sub nsw i64 %.neg115, %i.do
  %i.dq = add nuw nsw i64 %i.al, 2
  %i.dr = add nuw nsw i64 %i.dq, %i.dk
  br label %._crit_edge.i47

._crit_edge.i47:                                  ; preds = %fb_scount.exit.thread, %fb_assign_visitor.exit.preheader.i52, %fb_scount.exit
  %.pn = phi i64 [ %i.de, %fb_scount.exit ], [ %i.de, %fb_assign_visitor.exit.preheader.i52 ], [ %i.bx, %fb_scount.exit.thread ]
  %.0.i.lcssa.i48 = phi i64 [ %i.ax, %fb_scount.exit ], [ %i.dp, %fb_assign_visitor.exit.preheader.i52 ], [ %i.ax, %fb_scount.exit.thread ] ; 2 uses
  %.029.i.lcssa.i49 = phi i64 [ %.029.i9.i, %fb_scount.exit ], [ %i.dr, %fb_assign_visitor.exit.preheader.i52 ], [ %.029.i9.i, %fb_scount.exit.thread ]
  %i.ds = sub i64 %i.a, %.pn
...
fb_assign_visitor.exit4.i51:                      ; preds = %._crit_edge.i47
  %i.dt = sub nuw nsw i64 64, %.0.i.lcssa.i48
  %i.du = lshr i64 -1, %i.dt
  %i.dv = getelementptr inbounds nuw [8 x i8], ptr %i.bt, i64 %.029.i.lcssa.i49 ; 2 uses
  %i.dw = load i64, ptr %i.dv, align 8, !tbaa !35
  %i.dx = or i64 %i.dw, %i.du
  store i64 %i.dx, ptr %i.dv, align 8, !tbaa !35
  br label %fb_set_range.exit55

fb_set_range.exit55:                              ; preds = %._crit_edge.i47, %fb_assign_visitor.exit4.i51
  %i.dy = getelementptr inbounds nuw i8, ptr %0, i64 176 ; 2 uses
  %i.dz = load i64, ptr %i.dy, align 8, !tbaa !42
  %i.ea = add i64 %i.ds, %i.dz
  store i64 %i.ea, ptr %i.dy, align 8, !tbaa !42
  %i.eb = getelementptr i8, ptr %0, i64 96        ; 2 uses
  %.val42 = load i64, ptr %i.eb, align 8, !tbaa !34
  %i.ec = icmp eq i64 %.291, %.val42
  br i1 %i.ec, label %bb.f, label %bb.i

bb.f:                                             ; preds = %fb_set_range.exit55
  %i.ed = add i64 %.295, %i.a                     ; 2 uses
  %i.ee = icmp ult i64 %i.ed, 512
  br i1 %i.ee, label %.lr.ph135, label %.thread107

.lr.ph135:                                        ; preds = %bb.f, %bb.h
  %.2133 = phi i64 [ %i.fk, %bb.h ], [ %i.ed, %bb.f ] ; 2 uses
  %.335132 = phi i64 [ %spec.select40, %bb.h ], [ %.032, %bb.f ] ; 4 uses
  %i.ef = lshr i64 %.2133, 6                      ; 3 uses
  %i.eg = and i64 %.2133, 63
  %i.eh = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %i.ef
  %i.ei = load i64, ptr %i.eh, align 8, !tbaa !35
  %i.ej = xor i64 %i.ei, -1
  %notmask.i4.i56 = shl nsw i64 -1, %i.eg
  %.040.i5.i57 = and i64 %notmask.i4.i56, %i.ej   ; 2 uses
  %i.ek = icmp eq i64 %.040.i5.i57, 0
  br i1 %i.ek, label %.lr.ph.i71.preheader, label %bb.g

.lr.ph.i71.preheader:                             ; preds = %.lr.ph135
  %i.el = add nuw nsw i64 %i.ef, 1                ; 2 uses
  %i.em = icmp eq i64 %i.el, 8
  br i1 %i.em, label %.thread107, label %.lr.ph213

.lr.ph.i71:                                       ; preds = %.lr.ph213
  %i.en = add nuw nsw i64 %i.ep, 1                ; 2 uses
  %i.eo = icmp eq i64 %i.en, 8
  br i1 %i.eo, label %.thread107, label %.lr.ph213, !llvm.loop !36

.lr.ph213:                                        ; preds = %.lr.ph.i71.preheader, %.lr.ph.i71
  %i.ep = phi i64 [ %i.en, %.lr.ph.i71 ], [ %i.el, %.lr.ph.i71.preheader ] ; 3 uses
  %i.eq = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %i.ep
  %i.er = load i64, ptr %i.eq, align 8, !tbaa !35 ; 2 uses
  %i.es = icmp eq i64 %i.er, -1
  br i1 %i.es, label %.lr.ph.i71, label %._crit_edge.loopexit.i73, !llvm.loop !36
...
bb.g:                                             ; preds = %.lr.ph135, %._crit_edge.loopexit.i73
  %.141.i6.lcssa.i59 = phi i64 [ %.040.i5.i57, %.lr.ph135 ], [ %i.et, %._crit_edge.loopexit.i73 ]
  %.039.i7.lcssa.i60 = phi i64 [ %i.ef, %.lr.ph135 ], [ %i.ep, %._crit_edge.loopexit.i73 ] ; 4 uses
  %i.eu = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, 0) %.141.i6.lcssa.i59, i1 true) ; 2 uses
  %i.ev = shl nuw nsw i64 %.039.i7.lcssa.i60, 6
  %i.ew = or disjoint i64 %i.ev, %i.eu            ; 2 uses
  %i.ex = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %.039.i7.lcssa.i60
  %i.ey = load i64, ptr %i.ex, align 8, !tbaa !35
  %notmask.i.i62 = shl nsw i64 -1, %i.eu
  %.040.i.i63 = and i64 %i.ey, %notmask.i.i62     ; 2 uses
  %i.ez = icmp eq i64 %.040.i.i63, 0
  br i1 %i.ez, label %.lr.ph19.i69.preheader, label %.loopexit

.lr.ph19.i69.preheader:                           ; preds = %bb.g
  %i.fa = add nuw nsw i64 %.039.i7.lcssa.i60, 1   ; 2 uses
  %i.fb = icmp eq i64 %i.fa, 8
  br i1 %i.fb, label %.loopexit.thread, label %.lr.ph215

.lr.ph19.i69:                                     ; preds = %.lr.ph215
  %i.fc = add nuw nsw i64 %i.fe, 1                ; 2 uses
  %i.fd = icmp eq i64 %i.fc, 8
  br i1 %i.fd, label %.loopexit.thread, label %.lr.ph215, !llvm.loop !36

.lr.ph215:                                        ; preds = %.lr.ph19.i69.preheader, %.lr.ph19.i69
  %i.fe = phi i64 [ %i.fc, %.lr.ph19.i69 ], [ %i.fa, %.lr.ph19.i69.preheader ] ; 3 uses
  %i.ff = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %i.fe
  %i.fg = load i64, ptr %i.ff, align 8, !tbaa !35 ; 2 uses
  %i.fh = icmp eq i64 %i.fg, 0
  br i1 %i.fh, label %.lr.ph19.i69, label %.loopexit, !llvm.loop !36

.loopexit:                                        ; preds = %.lr.ph215, %bb.g
  %.141.i.lcssa.i65 = phi i64 [ %.040.i.i63, %bb.g ], [ %i.fg, %.lr.ph215 ]
  %.039.i.lcssa.i66 = phi i64 [ %.039.i7.lcssa.i60, %bb.g ], [ %i.fe, %.lr.ph215 ] ; 2 uses
  %i.fi = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, 0) %.141.i.lcssa.i65, i1 true)
  %i.fj = shl nuw nsw i64 %.039.i.lcssa.i66, 6
  %i.fk = or disjoint i64 %i.fj, %i.fi            ; 2 uses
  %i.fl = sub nsw i64 %i.fk, %i.ew                ; 2 uses
  %i.fm = icmp eq i64 %i.fl, %.291
  br i1 %i.fm, label %.thread107, label %bb.h

.loopexit.thread:                                 ; preds = %.lr.ph19.i69.preheader, %.lr.ph19.i69
  %i.fn = sub nsw i64 512, %i.ew                  ; 2 uses
  %i.fo = icmp eq i64 %i.fn, %.291
  br i1 %i.fo, label %.thread107, label %.thread

.thread:                                          ; preds = %.loopexit.thread
  %spec.select40178 = tail call i64 @llvm.umax.i64(i64 %i.fn, i64 %.335132)
  br label %.thread107

bb.h:                                             ; preds = %.loopexit
  %spec.select40 = tail call i64 @llvm.umax.i64(i64 %i.fl, i64 %.335132) ; 2 uses
  %i.fp = icmp ult i64 %.039.i.lcssa.i66, 8
  br i1 %i.fp, label %.lr.ph135, label %.thread107

.thread107:                                       ; preds = %bb.h, %.loopexit, %.lr.ph.i71.preheader, %.lr.ph.i71, %.loopexit.thread, %.thread, %bb.f
end_hunk_0
