...
begin_hunk_0_@zipmapSet:bb.a
  ...
  %6 = zext i8 %i.aa to i32
  %7 = add i32 %.0.i46.us.i, %6
  %i.ab = add i32 %7, 1
...
begin_hunk_3_@zipmapSet:bb.a
  ...
  %i.co = add i32 %.0.i.i4.i, %i.cb
  %i.cp = add i32 %i.co, %i.cn
  %i.cq = add i32 %i.cp, %i.cj                    ; 3 uses
...
begin_hunk_5_@zipmapSet:bb.a
  ...
  %.neg96 = xor i32 %i.cq, -1
  %i.di = sub i32 %i.bf, %i.cv
  %10 = add i32 %i.di, %.neg96
  %i.dj = zext i32 %10 to i64
...
begin_hunk_10_@zipmapGet:bb.a
  ...
  %5 = zext i8 %i.u to i32
  %6 = add i32 %.0.i46.us66.i, %5
  %i.v = add i32 %6, 1
...
begin_hunk_11_@zipmapExists:bb.a
  ...
  %i.t = getelementptr inbounds nuw i8, ptr %i.m, i64 %i.s ; 2 uses
  %i.u = load i8, ptr %i.t, align 1, !tbaa !13
  %3 = zext i8 %i.u to i32
  %4 = add i32 %.0.i46.us66.i, %3
  %i.v = add i32 %4, 1
  %i.w = zext i32 %i.v to i64
  %i.x = getelementptr inbounds nuw i8, ptr %i.t, i64 %i.w
  br label %.split.split.us.i, !llvm.loop !14
...
zipmapDecodeLength.exit78:                        ; preds = %bb.j, %bb.k
  ...
  %3 = add nuw i64 %.add63, %i.t
  %.add65 = add nuw i64 %3, 1                     ; 2 uses
