...
begin_hunk_0_@lua_newstate:bb.a
  ...
  %i.bt = tail call ptr %i.bq(ptr noundef %i.bs, ptr noundef nonnull %i.a, i64 noundef 616, i64 noundef 0) #3, !inline_history !76 ; 0 uses
  br label %bb.d
...
begin_hunk_3_@lua_close:bb.a
  ...
  %i.aw = tail call ptr %i.at(ptr noundef %i.av, ptr noundef nonnull %i.d, i64 noundef 616, i64 noundef 0) #3, !inline_history !76 ; 0 uses
  ret void
}
