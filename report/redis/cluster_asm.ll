...
sdslen.exit:                                      ; preds = %bb.d, %bb.e, %bb.f, %bb.g, %bb.h, %bb.i
  ...
  %i.y = tail call ptr @createStringObject(ptr noundef nonnull %i.i, i64 noundef %.0.i) #20
  br label %bb.j

bb.j:                                             ; preds = %sdslen.exit, %bb.c
  %.0 = phi ptr [ %i.y, %sdslen.exit ], [ %1, %bb.c ] ; 4 uses
  %i.z = tail call i32 @dbDelete(ptr noundef %0, ptr noundef %.0) #20 ; 0 uses
  tail call void @keyModified(ptr noundef null, ptr noundef %0, ptr noundef %.0, ptr noundef null, i32 noundef 1) #20
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 72
  %i.ab = load i32, ptr %i.aa, align 8, !tbaa !209
  tail call void @moduleNotifyKeyspaceEvent(i32 noundef 131072, ptr noundef nonnull @.str.213, ptr noundef %.0, i32 noundef %i.ab) #20
  ...
  br i1 %i.g, label %2, label %bb.k

2:                                                ; preds = %bb.j
  tail call void @decrRefCount(ptr noundef %.0) #20
  br label %bb.k
