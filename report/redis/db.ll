...
begin_hunk_2
  ...
  %or.cond11 = select i1 %16, i1 %134, i1 false
...
.split384.us.preheader:                           ; preds = %.thread, %146
  %.0225448 = phi i32 [ %145, %.thread ], [ -1, %146 ]
...
begin_hunk_4
  ...
  %149 = call i64 @kvstoreScan(ptr noundef %148, i64 noundef %.0.us, i32 noundef %.0225448, ptr noundef nonnull @scanCallback, ptr noundef nonnull @scanShouldSkipDict, ptr noundef nonnull %5) #21 ; 4 uses
...
begin_hunk_5
  ...
  %9 = load i32, ptr %8, align 8, !tbaa !92       ; 9 uses
...
.lr.ph.split.us:                                  ; preds = %.lr.ph, %selectDb.exit116.us
  %16 = phi i32 [ %44, %selectDb.exit116.us ], [ %9, %.lr.ph ]
...
.lr.ph.split:                                     ; preds = %.lr.ph, %selectDb.exit116
  %48 = phi i32 [ %80, %selectDb.exit116 ], [ %9, %.lr.ph ]
...
._crit_edge:                                      ; preds = %selectDb.exit116.us, %selectDb.exit116, %1
  %84 = phi i32 [ %9, %1 ], [ %80, %selectDb.exit116 ], [ %44, %selectDb.exit116.us ] ; 2 uses
...
108:                                              ; preds = %._crit_edge135, %91
  %109 = phi i32 [ %.pre136, %._crit_edge135 ], [ %84, %91 ]
  %110 = icmp ne i32 %9, 0
...
.preheader:                                       ; preds = %.preheader.lr.ph, %.loopexit
  %.043 = phi i32 [ 2, %.preheader.lr.ph ], [ %.pre-phi, %.loopexit ] ; 3 uses
...
26:                                               ; preds = %16, %22, %20, %12
  ...
  %27 = add nsw i32 %.245.ph, 1                   ; 2 uses
