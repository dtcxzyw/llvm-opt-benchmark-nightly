...
bb.i:                                             ; preds = %bb.h
  ...
  %4 = shl nuw nsw i32 %i.m, 3
  %5 = zext nneg i32 %4 to i64                    ; 2 uses
  br i1 %.not23.i, label %bb.k, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.w = tail call ptr @zrealloc(ptr noundef nonnull %i.r, i64 noundef %5) #25 ; 2 uses
  store ptr %i.w, ptr %i.n, align 8, !tbaa !118
  br label %bb.m

bb.k:                                             ; preds = %bb.i
  %i.x = tail call noalias ptr @zmalloc(i64 noundef %5) #23 ; 4 uses
