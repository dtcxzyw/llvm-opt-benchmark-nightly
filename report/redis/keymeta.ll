...
bb.c:                                             ; preds = %bb.p, %bb.b
  ...
  %.041 = phi i32 [ %i.au, %bb.p ], [ %i.f, %bb.b ] ; 2 uses
...
bb.n:                                             ; preds = %bb.l
  ...
  call void @sdssubstr(ptr noundef %i.an, i64 noundef 0, i64 noundef %i.as) #16
  store i64 %i.as, ptr %i.r, align 8, !tbaa !13
  br label %.thread63

.thread63:                                        ; preds = %bb.m, %bb.n
  %.346.ph = phi i32 [ %.043, %bb.n ], [ %i.ar, %bb.m ]
...
bb.o:                                             ; preds = %bb.f, %bb.g, %.thread63
  ...
  %i.at = getelementptr inbounds i8, ptr %.138, i64 -8
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %bb.c
  %.7 = phi i32 [ %.5, %bb.o ], [ %.043, %bb.c ]  ; 3 uses
  %.340 = phi ptr [ %i.at, %bb.o ], [ %.138, %bb.c ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %i.au = lshr i32 %.041, 1                       ; 2 uses
  %.not56 = icmp eq i32 %i.au, 0
  br i1 %.not56, label %bb.q, label %bb.c, !llvm.loop !107

bb.q:                                             ; preds = %bb.p
  %i.av = icmp eq i32 %.7, 0
  br i1 %i.av, label %bb.u, label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.aw = call i32 @rdbSaveType(ptr noundef %0, i8 noundef zeroext -13) #16
  %i.ax = icmp eq i32 %i.aw, -1
  br i1 %i.ax, label %.thread68, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.ay = sext i32 %.7 to i64
  %i.az = call i32 @rdbSaveLen(ptr noundef %0, i64 noundef %i.ay) #16
  %i.ba = icmp eq i32 %i.az, -1
  br i1 %i.ba, label %.thread68, label %bb.t

bb.t:                                             ; preds = %bb.s
  %i.bb = load ptr, ptr %i.j, align 8, !tbaa !13  ; 2 uses
  %i.bc = call fastcc i64 @sdslen(ptr noundef %i.bb)
  %i.bd = call i64 @rdbWriteRaw(ptr noundef %0, ptr noundef %i.bb, i64 noundef %i.bc) #16
  %i.be = icmp eq i64 %i.bd, -1
  br i1 %i.be, label %.thread68, label %bb.u
...
bb.u:                                             ; preds = %bb.t, %bb.q, %.thread68
  ...
  %i.bf = load ptr, ptr %i.j, align 8, !tbaa !13
  call void @sdsfree(ptr noundef %i.bf) #16
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #16
  br label %bb.v
