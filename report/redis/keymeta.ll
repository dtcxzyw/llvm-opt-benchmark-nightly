...
.lr.ph.i47:                                       ; preds = %bb.w
  ...
  %invariant.op = sub nuw nsw i32 31, %i.bk
  br label %bb.x
...
begin_hunk_3_@rdbLoadKeyMetadata:bb.a
  ...
  %6 = icmp samesign ugt i32 %i.dn, %invariant.op
  br i1 %6, label %.thread.loopexit.split.loop.exit.i56, label %bb.y
