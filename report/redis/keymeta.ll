...
bb.c:                                             ; preds = %.lr.ph, %bb.g
  ...
  %i.i = tail call range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %.027, i1 true)
  %i.j = xor i32 %i.i, 31                         ; 2 uses
...
begin_hunk_2_@rdbLoadKeyMetadata:bb.a
  ...
  %i.cp = call range(i32 16, 33) i32 @llvm.ctlz.i32(i32 %i.co, i1 true)
  %i.cq = xor i32 %i.cp, 31                       ; 2 uses
...
begin_hunk_4_@rdbLoadKeyMetadata:bb.a
  ...
  %i.dn = call range(i32 16, 33) i32 @llvm.ctlz.i32(i32 %i.dm, i1 true)
  %i.do = xor i32 %i.dn, 31                       ; 2 uses
...
bb.af:                                            ; preds = %bb.aj, %.lr.ph.i58
  ...
  %i.ep = call range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %.027.i, i1 true)
