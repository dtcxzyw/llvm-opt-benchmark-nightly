...
bb.d:                                             ; preds = %.lr.ph, %bb.m
  ...
  %.070 = phi i64 [ 0, %.lr.ph ], [ %i.am, %bb.m ] ; 4 uses
...
..thread_crit_edge:                               ; preds = %bb.j
  %.070.lcssa101.a = phi i64 [ %.070, %bb.j ]
  br label %.thread

.thread:                                          ; preds = %.threadsplit, %..thread_crit_edge
  %.070.lcssa97 = phi i64 [ %.070.lcssa101.a, %..thread_crit_edge ], [ %.070.lcssa100, %.threadsplit ]
...
..critedge.loopexit_crit_edge:                    ; preds = %bb.d
  %.070.lcssa.a = phi i64 [ %.070, %bb.d ]
  br label %.critedge.loopexit

.critedge.loopexit:                               ; preds = %.critedge.loopexitsplit, %..critedge.loopexit_crit_edge
  %.067.ph = phi i64 [ %.070.lcssa.a, %..critedge.loopexit_crit_edge ], [ %.lcssa, %.critedge.loopexitsplit ]
  br label %.critedge
