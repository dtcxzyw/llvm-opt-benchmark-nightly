...
.critedge.us.us:                                  ; preds = %.lr.ph.split.us, %.critedge.us.us
  ...
  %.idx232 = shl i64 %indvars.iv212, 4
  %78 = getelementptr i8, ptr %77, i64 %.idx232
...
.lr.ph.split.us.split:                            ; preds = %.lr.ph.split.us, %.critedge.us
  %indvars.iv207 = phi i64 [ %indvars.iv.next208, %.critedge.us ], [ 0, %.lr.ph.split.us ] ; 2 uses
  ...
  %.idx231 = shl i64 %indvars.iv207, 4
  %93 = getelementptr i8, ptr %92, i64 %.idx231
...
begin_hunk_4
  ...
  %exitcond211.not = icmp eq i64 %indvars.iv.next208, %wide.trip.count215
...
.loopexit.thread:                                 ; preds = %.critedge.us159, %.critedge.us.us, %.preheader, %.loopexit
  %.1105241 = phi i32 [ %.1105, %.loopexit ], [ %90, %.critedge.us.us ], [ 0, %.preheader ], [ %121, %.critedge.us159 ] ; 2 uses
  %.1115239 = phi i32 [ %.1115, %.loopexit ], [ %91, %.critedge.us.us ], [ 0, %.preheader ], [ %122, %.critedge.us159 ]
  %138 = icmp eq i32 %.1115239, %70
  %139 = and i32 %.fr, 64
...
.thread:                                          ; preds = %.loopexit.thread, %67
  %.2106 = phi i32 [ 0, %67 ], [ %.1105241, %.loopexit.thread ] ; 4 uses
...
.lr.ph180.split.preheader:                        ; preds = %.thread242
  %160 = and i32 %.fr, 47
  %.not129243 = icmp eq i32 %160, 0
  %spec.select244 = select i1 %.not129243, i32 0, i32 4
  %161 = load i64, ptr %6, align 8
  %162 = sext i32 %144 to i64
  %wide.trip.count220 = zext nneg i32 %158 to i64
  br label %.lr.ph180.split

.lr.ph180.split.us.preheader:                     ; preds = %149
  %163 = lshr exact i32 %.fr, 3
  %spec.select = and i32 %163, 4
  %164 = sext i32 %144 to i64
  %wide.trip.count225 = zext nneg i32 %150 to i64
  br label %.lr.ph180.split.us

.lr.ph180.split.us:                               ; preds = %.lr.ph180.split.us.preheader, %.lr.ph180.split.us
  %indvars.iv222 = phi i64 [ 0, %.lr.ph180.split.us.preheader ], [ %indvars.iv.next223, %.lr.ph180.split.us ] ; 2 uses
  %165 = load ptr, ptr %17, align 8, !tbaa !148
  %.idx234 = shl i64 %indvars.iv222, 4
  %166 = getelementptr i8, ptr %165, i64 %.idx234
...
.lr.ph180.split:                                  ; preds = %.lr.ph180.split.preheader, %.lr.ph180.split
  %indvars.iv217 = phi i64 [ 0, %.lr.ph180.split.preheader ], [ %indvars.iv.next218, %.lr.ph180.split ] ; 2 uses
  ...
  %.idx233 = shl i64 %indvars.iv217, 4
  %181 = getelementptr i8, ptr %180, i64 %.idx233
...
begin_hunk_9
  ...
  %192 = call i32 @hashTypeSet(ptr noundef %190, ptr noundef %191, ptr noundef %185, ptr noundef %189, i32 noundef %spec.select244)
...
.thread135:                                       ; preds = %._crit_edge.loopexit191, %.thread242
  %.0.lcssa253 = phi i1 [ false, %.thread242 ], [ %178, %._crit_edge.loopexit191 ] ; 3 uses
  %.0100.lcssa248 = phi i1 [ true, %.thread242 ], [ %179, %._crit_edge.loopexit191 ]
...
216:                                              ; preds = %207, %210, %208, %._crit_edge, %.loopexit.thread, %.loopexit
  ...
  %.3 = phi i32 [ %.1105241, %.loopexit.thread ], [ %.1105, %.loopexit ], [ %.2106, %._crit_edge ], [ %.2106, %208 ], [ %.2106, %210 ], [ %.2106, %207 ]
  %.2102 = phi i1 [ false, %.loopexit.thread ], [ false, %.loopexit ], [ false, %._crit_edge ], [ false, %208 ], [ false, %210 ], [ true, %207 ] ; 2 uses
  %.2 = phi i1 [ false, %.loopexit.thread ], [ false, %.loopexit ], [ false, %._crit_edge ], [ %.0.lcssa253, %208 ], [ %.0.lcssa253, %210 ], [ %.0.lcssa253, %207 ]
...
hashTypeLength.exit:                              ; preds = %36, %48, %41
  ...
  %.fr = freeze i32 %57                           ; 3 uses
  %.not121 = icmp eq i32 %.fr, 0                  ; 3 uses
