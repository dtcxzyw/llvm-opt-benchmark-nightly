...
hashTypeGetMinExpire.exit:                        ; preds = %.critedge.thread, %bb.s, %bb.u, %bb.v
  %.2.i = phi i64 [ %i.bi, %bb.v ], [ %i.be, %bb.s ], [ 281474976710656, %.critedge.thread ], [ 281474976710656, %bb.u ]
...
.critedge:                                        ; preds = %bb.e, %bb.m, %bb.l, %bb.i, %bb.g, %bb.b, %bb.j, %bb.h
  %.2 = phi i64 [ 281474976710656, %bb.g ], [ %i.r, %bb.j ], [ 281474976710656, %bb.i ], [ 281474976710656, %bb.l ], [ 281474976710656, %bb.b ], [ %i.q, %bb.h ], [ %i.w, %bb.m ], [ 281474976710656, %bb.e ]
  ret i64 %.2
}
...
.critedge:                                        ; preds = %bb.q, %bb.l, %bb.m, %bb.n, %bb.i, %bb.g, %bb.d, %bb.s, %bb.v, %bb.c, %bb.a
  %.3 = phi i32 [ -2, %bb.a ], [ 1, %bb.g ], [ 0, %bb.c ], [ 2, %bb.s ], [ 1, %bb.v ], [ 0, %bb.i ], [ 1, %bb.d ], [ 0, %bb.q ], [ 0, %bb.l ], [ 0, %bb.m ], [ 1, %bb.n ]
...
hashTypeGetMinExpire.exit:                        ; preds = %bb.g, %bb.h, %bb.j, %bb.k
  %.2.i = phi i64 [ %i.an, %bb.k ], [ %i.ai, %bb.h ], [ 281474976710656, %bb.g ], [ 281474976710656, %bb.j ] ; 6 uses
...
begin_hunk_6
  ...
  %i.fa = shl i64 %.1.i, 4
  %i.fb = tail call noalias ptr @zmalloc(i64 noundef %i.fa) #16 ; 5 uses
...
.lr.ph242:                                        ; preds = %._crit_edge237, %.preheader230
  %.0176.lcssa257 = phi i64 [ %i.fp, %.preheader230 ], [ %.1.i, %._crit_edge237 ]
...
begin_hunk_8
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.fo, ptr noundef nonnull align 8 dereferenceable(16) %i.fq, i64 16, i1 false), !tbaa.struct !180
  %i.fr = icmp ugt i64 %i.fp, %.0
  br i1 %i.fr, label %.lr.ph240, label %.preheader230, !llvm.loop !181

6:                                                ; preds = %.lr.ph242, %sdslen.exit223
  %.1185236 = phi i64 [ 0, %.lr.ph242 ], [ %i.hc, %sdslen.exit223 ] ; 2 uses
  br i1 %.not196, label %bb.bg, label %.lr.ph242.split

.lr.ph242.split:                                  ; preds = %6
...
bb.bg:                                            ; preds = %bb.bf, %.lr.ph242.split, %6
  %i.fu = getelementptr inbounds nuw [16 x i8], ptr %i.fb, i64 %.1185236 ; 2 uses
  %i.fv = load ptr, ptr %i.fu, align 8, !tbaa !182 ; 6 uses
  %i.fw = getelementptr i8, ptr %i.fv, i64 -1
  %.val.i218 = load i8, ptr %i.fw, align 1, !tbaa !73 ; 2 uses
  %i.fx = and i8 %.val.i218, 7
  switch i8 %i.fx, label %sdslen.exit218 [
    i8 0, label %bb.bh
    i8 1, label %bb.bi
    i8 2, label %bb.bj
end_hunk_9
...
sdslen.exit218:                                   ; preds = %bb.bg, %bb.bh, %bb.bi, %bb.bj, %bb.bk, %bb.bl
  %.0.i217 = phi i64 [ %i.gk, %bb.bl ], [ %i.fz, %bb.bh ], [ %i.gc, %bb.bi ], [ %i.gf, %bb.bj ], [ %i.gi, %bb.bk ], [ 0, %bb.bg ]
  call void @addReplyBulkCBuffer(ptr noundef nonnull %0, ptr noundef nonnull %i.fv, i64 noundef %.0.i217) #14
  br i1 %.not196, label %sdslen.exit223, label %bb.bm

bb.bm:                                            ; preds = %sdslen.exit218
  %i.gl = getelementptr inbounds nuw i8, ptr %i.fu, i64 8
  %i.gm = load ptr, ptr %i.gl, align 8, !tbaa !184 ; 6 uses
  %i.gn = getelementptr i8, ptr %i.gm, i64 -1
  %.val.i221 = load i8, ptr %i.gn, align 1, !tbaa !73 ; 2 uses
  %i.go = and i8 %.val.i221, 7
  switch i8 %i.go, label %sdslen.exit221 [
    i8 0, label %bb.bn
    i8 1, label %bb.bo
    i8 2, label %bb.bp
end_hunk_10
...
sdslen.exit221:                                   ; preds = %bb.bm, %bb.bn, %bb.bo, %bb.bp, %bb.bq, %bb.br
  %.0.i220 = phi i64 [ %i.hb, %bb.br ], [ %i.gq, %bb.bn ], [ %i.gt, %bb.bo ], [ %i.gw, %bb.bp ], [ %i.gz, %bb.bq ], [ 0, %bb.bm ]
  call void @addReplyBulkCBuffer(ptr noundef nonnull %0, ptr noundef nonnull %i.gm, i64 noundef %.0.i220) #14
  br label %sdslen.exit223

sdslen.exit223:                                   ; preds = %sdslen.exit218, %sdslen.exit221
  %i.hc = add nuw i64 %.1185236, 1                ; 2 uses
  %exitcond.not = icmp eq i64 %i.hc, %.0176.lcssa257
  br i1 %exitcond.not, label %._crit_edge243, label %6, !llvm.loop !185

._crit_edge243:                                   ; preds = %sdslen.exit223, %.preheader230
...
hashTypeGetMinExpire.exit:                        ; preds = %bb.a, %bb.b, %bb.d, %bb.e
  %.2.i = phi i64 [ %i.k, %bb.e ], [ %i.f, %bb.b ], [ 281474976710656, %bb.a ], [ 281474976710656, %bb.d ]
...
!180 = !{i64 0, i64 8, !95, i64 8, i64 8, !95}
!181 = distinct !{!181, !100}
!182 = !{!183, !32, i64 0}
!183 = !{!"FieldValPair", !32, i64 0, !32, i64 8}
!184 = !{!183, !32, i64 8}
