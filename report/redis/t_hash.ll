...
bb.af:                                            ; preds = %bb.ae, %bb.ad
  ...
  %.0106 = phi ptr [ %i.ei, %bb.ad ], [ %i.er, %bb.ae ] ; 4 uses
  %.0105 = phi i64 [ 2, %bb.ad ], [ 3, %bb.ae ]
  %2 = phi i64 [ 3, %bb.ad ], [ 4, %bb.ae ]
  %3 = phi i64 [ 4, %bb.ad ], [ 5, %bb.ae ]
  %i.ez = load ptr, ptr getelementptr inbounds nuw (i8, ptr @shared, i64 744), align 8, !tbaa !164 ; 2 uses
  %i.fa = getelementptr inbounds nuw [8 x i8], ptr %.0106, i64 %.0105
  ...
  %4 = getelementptr inbounds nuw [8 x i8], ptr %.0106, i64 %2
  store ptr %i.fb, ptr %4, align 8, !tbaa !72
