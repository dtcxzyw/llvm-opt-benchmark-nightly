...
vector.ph:                                        ; preds = %.lr.ph.i73
  %n.mod.vf = and i64 %i.cc, -8                   ; 3 uses
  %i.cd = add nsw i64 %n.mod.vf, %i.bz
...
begin_hunk_1_@newkey:bb.a
  ...
  %i.dq = icmp eq i64 %index.next, %n.mod.vf
...
middle.block:                                     ; preds = %vector.body
  ...
  %cmp.n = icmp eq i64 %i.cc, %n.mod.vf
...
._crit_edge.loopexit.i:                           ; preds = %scalar.ph, %middle.block
  %spec.select.i.lcssa = phi i32 [ %i.dr, %middle.block ], [ %spec.select.i, %scalar.ph ]
