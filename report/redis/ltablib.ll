...
.lr.ph:                                           ; preds = %bb.a, %bb.x
  %.087111 = phi i32 [ %.087..185, %bb.x ], [ %2, %bb.a ] ; 11 uses
  %.090110 = phi i32 [ %..090, %bb.x ], [ %1, %bb.a ] ; 11 uses
...
bb.k:                                             ; preds = %bb.w, %bb.j
  %.lcssa.sink = phi i32 [ %i.f, %bb.j ], [ %i.k, %bb.w ]
  %.lcssa119.sink = phi i32 [ %i.j, %bb.j ], [ %i.q, %bb.w ] ; 2 uses
  %.084 = phi i32 [ %.090110, %bb.j ], [ %i.k, %bb.w ]
...
bb.l:                                             ; preds = %bb.q, %bb.k
  %.185 = phi i32 [ %.084, %bb.k ], [ %i.k, %bb.q ] ; 5 uses
  ...
  br i1 %i.m, label %bb.n, label %bb.m
...
sort_comp.exit:                                   ; preds = %bb.m, %bb.n
  %.0.i = phi i32 [ %i.o, %bb.n ], [ %i.n, %bb.m ]
  %.not99 = icmp eq i32 %.0.i, 0
  br i1 %.not99, label %.preheader, label %bb.o

bb.o:                                             ; preds = %sort_comp.exit
...
bb.q:                                             ; preds = %bb.p, %bb.o
  tail call void @lua_settop(ptr noundef %0, i32 noundef -2) #3
  br label %bb.l, !llvm.loop !17

.preheader:                                       ; preds = %sort_comp.exit, %bb.v
  %.1 = phi i32 [ %i.q, %bb.v ], [ %.lcssa119.sink, %sort_comp.exit ] ; 3 uses
...
sort_comp.exit105:                                ; preds = %bb.r, %bb.s
  %.0.i104 = phi i32 [ %i.u, %bb.s ], [ %i.t, %bb.r ]
  %.not100 = icmp eq i32 %.0.i104, 0
  br i1 %.not100, label %bb.w, label %bb.t

bb.t:                                             ; preds = %sort_comp.exit105
  %.not102 = icmp sgt i32 %.1, %.090110
  br i1 %.not102, label %bb.v, label %bb.u
...
bb.w:                                             ; preds = %sort_comp.exit105
  %.not101 = icmp sgt i32 %.1, %i.k
  br i1 %.not101, label %bb.k, label %bb.x
...
.thread:                                          ; preds = %bb.x, %bb.d, %bb.i, %bb.a
  ret void
}
