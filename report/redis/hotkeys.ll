...
.lr.ph474:                                        ; preds = %bb.al
  ...
  %invariant.op = add i32 %.1254483, 2
  br label %bb.am
...
bb.am:                                            ; preds = %.lr.ph474, %.critedge352
  ...
  %2 = trunc nuw nsw i64 %indvars.iv543 to i32
  %.reass.reass = add i32 %2, %invariant.op
  %3 = sext i32 %.reass.reass to i64
  %4 = getelementptr inbounds [8 x i8], ptr %i.ct, i64 %3
  %i.cu = load ptr, ptr %4, align 8, !tbaa !97
...
begin_hunk_7_@hotkeysCommand:bb.a
  ...
  %.8261.a = phi i32 [ %.1254483, %.thread367 ], [ %.1254483, %bb.ab ], [ %.1254483, %.thread ], [ %i.dh, %.critedge354 ]
  %.8261 = add i32 %.8261.a, 2                    ; 2 uses
  %i.di = load i32, ptr %i.i, align 8, !tbaa !105 ; 2 uses
  %.not385 = icmp slt i32 %.8261, %i.di
