...
aligned_usize_get.exit.i17.thread:                ; preds = %bb.y, %bb.v, %sz_s2u_compute.exit29.i, %bb.t, %compute_size_with_overflow.exit, %imalloc_no_sample.exit, %aligned_usize_get.exit.i17, %bb.ad
  %.0.i.ph.a = phi i32 [ 12, %imalloc_no_sample.exit ], [ 12, %aligned_usize_get.exit.i17 ], [ 22, %compute_size_with_overflow.exit ], [ 12, %bb.v ], [ 0, %bb.ad ], [ 12, %bb.t ], [ 12, %sz_s2u_compute.exit29.i ], [ 12, %bb.y ] ; 2 uses
...
begin_hunk_1_@je_posix_memalign:bb.a
  ...
  %5 = zext nneg i32 %.0.i.ph.a to i64
  call void @je_hook_invoke_alloc(i32 noundef 1, ptr noundef %i.eu, i64 noundef %5, ptr noundef nonnull %i.a) #21
