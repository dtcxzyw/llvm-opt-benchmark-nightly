...
sz_size2index.exit:                               ; preds = %bb.d, %bb.c, %bb.b
  %.0.i = phi i32 [ %i.i, %bb.b ], [ %9, %bb.d ], [ 235, %bb.c ]
...
begin_hunk_5_@je_bootstrap_calloc:bb.a
  ...
  %i.w = and i32 %i.v, 3
  %5 = or disjoint i32 %i.w, %4
  br label %sz_size2index.exit.i

sz_size2index.exit.i:                             ; preds = %bb.f, %bb.e, %bb.d
  %.0.i.i = phi i32 [ %i.k, %bb.d ], [ %5, %bb.f ], [ 235, %bb.e ]
...
begin_hunk_7_@je_malloc_default:bb.a
  ...
  %i.z = and i32 %i.y, 3
  %7 = or disjoint i32 %i.z, %6
  br label %sz_size2index.exit.i

sz_size2index.exit.i:                             ; preds = %bb.d, %bb.b
  %.0.i50.i = phi i32 [ %i.n, %bb.b ], [ %7, %bb.d ] ; 7 uses
...
begin_hunk_11_@je_calloc_internal:bb.a
  ...
  %i.ad = and i32 %i.ac, 3
  %8 = or disjoint i32 %i.ad, %7
  br label %sz_size2index.exit.i

sz_size2index.exit.i:                             ; preds = %bb.f, %.thread
  %.0.i50.i = phi i32 [ %i.r, %.thread ], [ %8, %bb.f ] ; 7 uses
...
begin_hunk_15_@je_mallocx:bb.a
  ...
  %i.an = and i32 %i.am, 3
  %7 = or disjoint i32 %i.an, %6
  br label %sz_size2index.exit.i

sz_size2index.exit.i:                             ; preds = %bb.i, %bb.g
  %.0.i50.i = phi i32 [ %i.ab, %bb.g ], [ %7, %bb.i ] ; 3 uses
...
begin_hunk_19_@do_rallocx:bb.a
  ...
  %i.ft = and i32 %i.fs, 3
  %15 = or disjoint i32 %i.ft, %14
  br label %sz_size2index.exit.i

sz_size2index.exit.i:                             ; preds = %bb.ad, %bb.ab
  %.0.i.i84 = phi i32 [ %i.fh, %bb.ab ], [ %15, %bb.ad ] ; 4 uses
...
bb.ai:                                            ; preds = %sz_size2index.exit.i.thread
  ...
  %i.gu = zext i32 %.0.i.i84114 to i64            ; 2 uses
...
begin_hunk_22_@je_realloc_internal:bb.a
  ...
  %i.af = and i32 %i.ae, 3
  %9 = or disjoint i32 %i.af, %8
  br label %sz_size2index.exit.i

sz_size2index.exit.i:                             ; preds = %bb.h, %bb.f
  %.0.i50.i = phi i32 [ %i.t, %bb.f ], [ %9, %bb.h ] ; 7 uses
...
bb.ab:                                            ; preds = %sz_size2index.exit.i36.thread
  ...
  %i.dx = zext i32 %.0.i.i3776 to i64             ; 2 uses
...
begin_hunk_29_@je_sdallocx_default:bb.a
  ...
  %i.gf = and i32 %i.ge, 3
  %14 = or disjoint i32 %i.gf, %13
  br label %sz_size2index.exit.i

sz_size2index.exit.i:                             ; preds = %bb.aj, %bb.ah
  %.0.i.i35 = phi i32 [ %i.fu, %bb.ah ], [ %14, %bb.aj ] ; 4 uses
...
bb.ao:                                            ; preds = %sz_size2index.exit.i.thread
  ...
  %i.hg = zext i32 %.0.i.i3580 to i64             ; 2 uses
...
begin_hunk_32_@je_batch_alloc:bb.a
  ...
  %i.ci = and i32 %i.ch, 3
  %8 = or disjoint i32 %i.ci, %7
  br label %sz_size2index.exit

sz_size2index.exit:                               ; preds = %bb.o, %sz_size2index_compute.exit
  %.0.i118 = phi i32 [ %i.bx, %bb.o ], [ %8, %sz_size2index_compute.exit ] ; 4 uses
  %i.cj = and i32 %3, 64
  ...
  %i.co = icmp ugt i32 %.0.i118, 38               ; 2 uses
