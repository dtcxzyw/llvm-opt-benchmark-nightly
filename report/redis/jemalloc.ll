...
bb.f:                                             ; preds = %bb.e
  ...
  %i.s = sub nuw nsw i64 60, %i.n
  %1 = ashr exact i64 -1152921504606846976, %i.n
  %i.t = add nsw i64 %.0, -1
  %i.u = and i64 %1, %i.t
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.t = sub nuw nsw i64 60, %i.o
  %2 = ashr exact i64 -1152921504606846976, %i.o
  %i.u = add nsw i64 %.0, -1
  %i.v = and i64 %2, %i.u
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.w = sub nuw nsw i64 60, %i.r
  %4 = ashr exact i64 -1152921504606846976, %i.r
  %i.x = add nsw i64 %0, -1
  %i.y = and i64 %4, %i.x
...
begin_hunk_4_@je_malloc_default:bb.a
  ...
  %notmask.i.i45 = ashr exact i64 -1152921504606846976, %i.bz
  %5 = lshr i64 1152921504606846975, %i.bz
  %i.ca = add nuw nsw i64 %0, %5
...
bb.aa:                                            ; preds = %bb.z
  ...
  %i.dq = sub nuw nsw i64 60, %i.dl
  %6 = ashr exact i64 -1152921504606846976, %i.dl
...
begin_hunk_6_@je_malloc_default:bb.a
  ...
  %i.gd = add i64 %i.gc, -1
  %i.ge = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 8193, -2305843009213693952) %i.gd, i1 true) ; 2 uses
  %notmask.i.i = ashr exact i64 -1152921504606846976, %i.ge
  %7 = lshr i64 1152921504606846975, %i.ge
...
sz_s2u_compute.exit.i102:                         ; preds = %bb.e
  ...
  %notmask.i.i101 = ashr exact i64 -1152921504606846976, %i.aa
...
sz_s2u_compute.exit.i91:                          ; preds = %bb.r
  ...
  %7 = lshr i64 1152921504606846975, %i.cl
  %i.cm = add nuw nsw i64 %i.ca, %7
...
sz_s2u_compute.exit29.i:                          ; preds = %bb.v
  ...
  %i.ct = add i64 %i.cs, -1
  %i.cu = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 8193, -2305843009213693952) %i.ct, i1 true) ; 2 uses
  %notmask.i27.i = ashr exact i64 -1152921504606846976, %i.cu
  %8 = lshr i64 1152921504606846975, %i.cu
  %i.cv = add nuw nsw i64 %.016.i.i15, %8
...
sz_s2u_compute.exit.i89:                          ; preds = %bb.s
  ...
  %notmask.i.i88 = ashr exact i64 -1152921504606846976, %i.cj
  %6 = lshr i64 1152921504606846975, %i.cj
  %i.ck = add nuw nsw i64 %i.by, %6
...
sz_s2u_compute.exit29.i:                          ; preds = %bb.w
  ...
  %i.cr = add i64 %i.cq, -1
  %i.cs = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 8193, -2305843009213693952) %i.cr, i1 true) ; 2 uses
  %notmask.i27.i = ashr exact i64 -1152921504606846976, %i.cs
  %7 = lshr i64 1152921504606846975, %i.cs
  %i.ct = add nuw nsw i64 %.016.i.i13, %7
...
bb.f:                                             ; preds = %bb.e
  ...
  %5 = ashr exact i64 -1152921504606846976, %i.v
...
begin_hunk_16_@je_calloc_internal:bb.a
  ...
  %6 = lshr i64 1152921504606846975, %i.ce
  %i.cf = add nuw nsw i64 %mul.val264, %6
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.dx = sub nuw nsw i64 60, %i.ds
  %7 = ashr exact i64 -1152921504606846976, %i.ds
...
begin_hunk_18_@je_calloc_internal:bb.a
  ...
  %i.gk = add i64 %i.gj, -1
  %i.gl = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 8193, -2305843009213693952) %i.gk, i1 true) ; 2 uses
  %notmask.i.i = ashr exact i64 -1152921504606846976, %i.gl
  %8 = lshr i64 1152921504606846975, %i.gl
  %i.gm = add nuw nsw i64 %mul.val, %8
...
sz_s2u_compute.exit.i100:                         ; preds = %bb.c
  ...
  %notmask.i.i99 = ashr exact i64 -1152921504606846976, %i.x
  %4 = lshr i64 1152921504606846975, %i.x
  %i.y = add nuw nsw i64 %i.m, %4
...
bb.h:                                             ; preds = %bb.g
  ...
  %notmask.i27.i91 = ashr exact i64 -1152921504606846976, %i.ag
  %5 = lshr i64 1152921504606846975, %i.ag
  %i.ah = add nuw nsw i64 %1, %5
...
sz_s2u_compute.exit.i89:                          ; preds = %bb.o
  ...
  %notmask.i.i88 = ashr exact i64 -1152921504606846976, %i.cf
  %6 = lshr i64 1152921504606846975, %i.cf
  %i.cg = add nuw nsw i64 %i.bu, %6
...
bb.t:                                             ; preds = %bb.s
  ...
  %notmask.i27.i = ashr exact i64 -1152921504606846976, %i.co
  %7 = lshr i64 1152921504606846975, %i.co
  %i.cp = add nuw nsw i64 %1, %7
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.z = add i64 %i.y, -1
  %i.aa = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 8193, -2305843009213693952) %i.z, i1 true) ; 2 uses
  %notmask.i27.i89 = ashr exact i64 -1152921504606846976, %i.aa
...
sz_s2u_compute.exit.i87:                          ; preds = %bb.m
  ...
  %i.bq = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 8193, -2305843009213693952) %i.bp, i1 true) ; 2 uses
  %notmask.i.i86 = ashr exact i64 -1152921504606846976, %i.bq
  %5 = lshr i64 1152921504606846975, %i.bq
  %i.br = add nuw nsw i64 %i.bg, %5
...
bb.q:                                             ; preds = %bb.p
  ...
  %notmask.i27.i = ashr exact i64 -1152921504606846976, %i.by
  %6 = lshr i64 1152921504606846975, %i.by
  %i.bz = add nuw nsw i64 %0, %6
...
sz_s2u_compute.exit.i107:                         ; preds = %bb.k
  ...
  %notmask.i.i106 = ashr exact i64 -1152921504606846976, %i.bl
...
bb.p:                                             ; preds = %bb.o
  ...
  %notmask.i27.i98 = ashr exact i64 -1152921504606846976, %i.bu
...
bb.an:                                            ; preds = %bb.am
  ...
  %7 = lshr i64 1152921504606846975, %i.er
  %i.es = add nuw nsw i64 %0, %7
...
bb.ba:                                            ; preds = %bb.az
  ...
  %i.gk = sub nuw nsw i64 60, %i.gf
  %8 = ashr exact i64 -1152921504606846976, %i.gf
...
sz_s2u_compute.exit.i96:                          ; preds = %bb.bc
  ...
  %9 = lshr i64 1152921504606846975, %i.hl
  %i.hm = add nuw nsw i64 %i.ha, %9
...
bb.bh:                                            ; preds = %bb.bg
  ...
  %i.ht = add i64 %i.hs, -1
  %i.hu = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 8193, -2305843009213693952) %i.ht, i1 true) ; 2 uses
  %notmask.i27.i = ashr exact i64 -1152921504606846976, %i.hu
  %10 = lshr i64 1152921504606846975, %i.hu
  %i.hv = add nuw nsw i64 %0, %10
...
bb.cf:                                            ; preds = %bb.ce
  ...
  %i.kv = add i64 %i.ku, -1
  %i.kw = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 8193, -2305843009213693952) %i.kv, i1 true) ; 2 uses
  %notmask.i.i = ashr exact i64 -1152921504606846976, %i.kw
  %11 = lshr i64 1152921504606846975, %i.kw
  %i.kx = add nuw nsw i64 %0, %11
...
bb.l:                                             ; preds = %bb.k
  ...
  %12 = lshr i64 1152921504606846975, %i.bb
  %i.bc = add nuw nsw i64 %1, %12
...
sz_s2u_compute.exit.i77:                          ; preds = %bb.n
  ...
  %notmask.i.i76 = ashr exact i64 -1152921504606846976, %i.bu
  %13 = lshr i64 1152921504606846975, %i.bu
...
bb.s:                                             ; preds = %bb.r
  ...
  %notmask.i27.i69 = ashr exact i64 -1152921504606846976, %i.cd
  %14 = lshr i64 1152921504606846975, %i.cd
  %i.ce = add nuw nsw i64 %1, %14
...
sz_s2u_compute.exit.i:                            ; preds = %bb.u
  ...
  %i.dm = call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 8193, -2305843009213693952) %i.dl, i1 true) ; 2 uses
  %notmask.i.i = ashr exact i64 -1152921504606846976, %i.dm
  %15 = lshr i64 1152921504606846975, %i.dm
  %i.dn = add nuw nsw i64 %i.db, %15
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.dt = add i64 %i.ds, -1
  %i.du = call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 8193, -2305843009213693952) %i.dt, i1 true) ; 2 uses
  %notmask.i27.i = ashr exact i64 -1152921504606846976, %i.du
  %16 = lshr i64 1152921504606846975, %i.du
  %i.dv = add nuw nsw i64 %1, %16
...
bb.ad:                                            ; preds = %bb.ac
  ...
  %i.fa = add i64 %i.ez, -1
  %i.fb = call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 8193, -2305843009213693952) %i.fa, i1 true) ; 3 uses
  %i.fc = trunc nuw nsw i64 %i.fb to i32
  %i.fd = shl nuw nsw i32 %i.fc, 2
  %i.fe = xor i32 %i.fd, 252
  %i.ff = add nsw i32 %i.fe, -20
  %i.fg = sub nuw nsw i64 60, %i.fb
  %17 = ashr exact i64 -1152921504606846976, %i.fb
  %i.fh = add nsw i64 %i.ao, -1
  %i.fi = and i64 %17, %i.fh
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ac = sub nuw nsw i64 60, %i.x
  %6 = ashr exact i64 -1152921504606846976, %i.x
...
begin_hunk_42_@je_realloc_internal:bb.a
  ...
  %i.ce = add i64 %i.cd, -1
  %i.cf = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 8193, -2305843009213693952) %i.ce, i1 true) ; 2 uses
  %notmask.i.i68 = ashr exact i64 -1152921504606846976, %i.cf
  %7 = lshr i64 1152921504606846975, %i.cf
  %i.cg = add nuw nsw i64 %1, %7
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.dw = sub nuw nsw i64 60, %i.dr
  %8 = ashr exact i64 -1152921504606846976, %i.dr
...
begin_hunk_44_@je_realloc_internal:bb.a
  ...
  %9 = lshr i64 1152921504606846975, %i.gk
  %i.gl = add nuw nsw i64 %1, %9
...
bb.aj:                                            ; preds = %bb.ai
  ...
  %i.fz = sub nuw nsw i64 60, %i.fu
  %11 = ashr exact i64 -1152921504606846976, %i.fu
  %i.ga = add nsw i64 %storemerge.i, -1
  %i.gb = and i64 %11, %i.ga
