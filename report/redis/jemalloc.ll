...
begin_hunk_19_@do_rallocx:bb.a
  ...
  %i.fo = and i32 %i.fn, 3
  %15 = or disjoint i32 %i.fo, %14
  br label %sz_size2index.exit.i

sz_size2index.exit.i:                             ; preds = %bb.ad, %bb.ab
  %.0.i.i84 = phi i32 [ %i.fc, %bb.ab ], [ %15, %bb.ad ] ; 4 uses
...
bb.ai:                                            ; preds = %sz_size2index.exit.i.thread
  ...
  %i.gp = zext i32 %.0.i.i84114 to i64            ; 2 uses
...
bb.ab:                                            ; preds = %sz_size2index.exit.i36.thread
  ...
  %i.du = zext i32 %.0.i.i3776 to i64             ; 2 uses
...
begin_hunk_29_@je_sdallocx_default:bb.a
  ...
  %i.gc = and i32 %i.gb, 3
  %14 = or disjoint i32 %i.gc, %13
  br label %sz_size2index.exit.i

sz_size2index.exit.i:                             ; preds = %bb.aj, %bb.ah
  %.0.i.i35 = phi i32 [ %i.fr, %bb.ah ], [ %14, %bb.aj ] ; 4 uses
...
bb.ao:                                            ; preds = %sz_size2index.exit.i.thread
  ...
  %i.hd = zext i32 %.0.i.i3580 to i64             ; 2 uses
...
begin_hunk_32_@je_batch_alloc:bb.a
  ...
  %i.cf = and i32 %i.ce, 3
  %8 = or disjoint i32 %i.cf, %7
  br label %sz_size2index.exit

sz_size2index.exit:                               ; preds = %bb.o, %sz_size2index_compute.exit
  %.0.i118 = phi i32 [ %i.bu, %bb.o ], [ %8, %sz_size2index_compute.exit ] ; 4 uses
  %i.cg = and i32 %3, 64
  ...
  %i.cl = icmp ugt i32 %.0.i118, 38               ; 2 uses
