...
bb.a:
  ...
  %i.f = getelementptr inbounds nuw i8, ptr %i.c, i64 24
  store i16 1024, ptr %i.f, align 8, !tbaa !82
  %i.g = tail call ptr @SSL_new(ptr noundef %i.b) #16, !inline_history !78 ; 3 uses
  %i.h = getelementptr inbounds nuw i8, ptr %i.c, i64 80 ; 3 uses
  store ptr %i.g, ptr %i.h, align 8, !tbaa !13
  store i32 %1, ptr %i.d, align 8, !tbaa !80
  store ptr %0, ptr %i.e, align 8, !tbaa !81
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.k = getelementptr inbounds nuw i8, ptr %i.c, i64 88 ; 3 uses
...
updateTLSError.exit:                              ; preds = %bb.b, %bb.c
  %i.m = tail call noalias dereferenceable_or_null(512) ptr @zmalloc(i64 noundef 512) #19
  store ptr %i.m, ptr %i.k, align 8, !tbaa !85
  %i.n = tail call i64 @ERR_get_error() #16
  %3 = load ptr, ptr %i.k, align 8, !tbaa !85
  tail call void @ERR_error_string_n(i64 noundef %i.n, ptr noundef %3, i64 noundef 512) #16
...
bb.d:                                             ; preds = %bb.a
  ...
  %4 = load ptr, ptr %i.h, align 8, !tbaa !13
  %5 = load i32, ptr %i.d, align 8, !tbaa !80
  %i.o = tail call i32 @SSL_set_fd(ptr noundef %4, i32 noundef %5) #16 ; 0 uses
  %6 = load ptr, ptr %i.h, align 8, !tbaa !13
  tail call void @SSL_set_accept_state(ptr noundef %6) #16
  br label %bb.e
