...
bb.k:                                             ; preds = %bb.v, %bb.j
  %indvars.iv = phi i64 [ %indvars.iv.next, %bb.v ], [ 0, %bb.j ] ; 9 uses
...
..thread.loopexit_crit_edge:                      ; preds = %bb.n
  %indvars.iv.lcssa106 = phi i64 [ %indvars.iv, %bb.n ]
  br label %.thread.loopexit

.thread.loopexit:                                 ; preds = %.thread.loopexitsplit, %..thread.loopexit_crit_edge
  %indvars.iv.next.lcssa.sink = phi i64 [ %indvars.iv.lcssa106, %..thread.loopexit_crit_edge ], [ %indvars.iv.next.lcssa.sink.ph, %.thread.loopexitsplit ]
...
..thread73.loopexit_crit_edge:                    ; preds = %bb.m
  %indvars.iv.lcssa105.a = phi i64 [ %indvars.iv, %bb.m ]
  br label %.thread73.loopexit

.thread73.loopexit:                               ; preds = %.thread73.loopexitsplit, %..thread73.loopexit_crit_edge
  %indvars.iv.lcssa102 = phi i64 [ %indvars.iv.lcssa105.a, %..thread73.loopexit_crit_edge ], [ %indvars.iv.lcssa104, %.thread73.loopexitsplit ]
