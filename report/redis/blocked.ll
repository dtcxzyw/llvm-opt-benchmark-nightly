...
begin_hunk_1_@handleClientsBlockedOnKeys:bb.a
  ...
  br i1 %.not11, label %._crit_edge, label %.lr.ph, !llvm.loop !113
...
begin_hunk_2_@handleClientsBlockedOnKeys:bb.a
  ...
  br i1 %.not, label %._crit_edge27, label %.lr.ph26, !llvm.loop !114
...
bb.d:                                             ; preds = %.lr.ph.split.us
  %i.m = load ptr, ptr %i.j, align 8, !tbaa !115
  call void @incrRefCount(ptr noundef %i.m) #5
  %i.n = load ptr, ptr %i.h, align 8, !tbaa !116
  %i.o = getelementptr inbounds nuw i8, ptr %i.n, i64 24
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !108
  %i.q = load ptr, ptr %i.j, align 8, !tbaa !115
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.w = load ptr, ptr %i.j, align 8, !tbaa !115
  call void @incrRefCount(ptr noundef %i.w) #5
  br label %bb.g

bb.f:                                             ; preds = %bb.d
  %i.x = load ptr, ptr %i.a, align 8, !tbaa !117
...
bb.i:                                             ; preds = %.lr.ph.split
  %i.ah = load ptr, ptr %i.ae, align 8, !tbaa !115
  call void @incrRefCount(ptr noundef %i.ah) #5
  %i.ai = load ptr, ptr %i.h, align 8, !tbaa !116
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 24
  %i.ak = load ptr, ptr %i.aj, align 8, !tbaa !108
  %i.al = load ptr, ptr %i.ae, align 8, !tbaa !115
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.ao = load ptr, ptr %i.h, align 8, !tbaa !116
  ...
  %i.ar = load ptr, ptr %i.ae, align 8, !tbaa !115
  call void @incrRefCount(ptr noundef %i.ar) #5
  br label %bb.l

bb.k:                                             ; preds = %bb.i
  %i.as = load ptr, ptr %i.a, align 8, !tbaa !117
...
begin_hunk_7_@blockForReplication:bb.a
  ...
  %i.e = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 7696), align 8, !tbaa !121
...
begin_hunk_8_@blockForAofFsync:bb.a
  ...
  store i32 %3, ptr %i.e, align 4, !tbaa !122
  %i.f = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 7696), align 8, !tbaa !121
...
begin_hunk_10_@blockPostponeClient:bb.a
  ...
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !118
...
bb.a:
  ...
  %i.a = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 7696), align 8, !tbaa !121
...
bb.f:                                             ; preds = %bb.e
  %i.q = load ptr, ptr %i.c, align 8, !tbaa !116
...
.sink.split:                                      ; preds = %bb.h, %bb.d
  %i.v = load ptr, ptr %i.c, align 8, !tbaa !116
