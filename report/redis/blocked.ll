...
define dso_local void @blockClient(ptr noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  ...
  %4 = load i64, ptr %3, align 8, !tbaa !45       ; 3 uses
  %5 = and i64 %4, 2
...
.lr.ph.split.us:                                  ; preds = %.lr.ph, %42
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %42 ], [ 0, %.lr.ph ] ; 2 uses
  %17 = load ptr, ptr %15, align 8, !tbaa !40
  %18 = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv58 ; 4 uses
...
42:                                               ; preds = %37, %.lr.ph.split.us
  ...
  %exitcond62.not = icmp eq i64 %indvars.iv.next59, %wide.trip.count62
...
begin_hunk_4
  ...
  %80 = load i64, ptr %8, align 8, !tbaa !45      ; 6 uses
...
.split40:                                         ; preds = %._crit_edge
  %89 = or i64 %80, 1073741824
  store i64 %89, ptr %8, align 8, !tbaa !45
  %90 = and i64 %80, 2
  %.not15.i50 = icmp eq i64 %90, 0
...
begin_hunk_7
  ...
  %12 = load i64, ptr %11, align 8, !tbaa !45     ; 3 uses
  %13 = and i64 %12, 2
...
begin_hunk_9
  ...
  %14 = load i64, ptr %13, align 8, !tbaa !45     ; 3 uses
  %15 = and i64 %14, 2
...
begin_hunk_11
  ...
  %8 = load i64, ptr %7, align 8, !tbaa !45       ; 2 uses
  %9 = or i64 %8, 16
...
define dso_local void @blockClientShutdown(ptr noundef %0) local_unnamed_addr #0 {
  ...
  %3 = load i64, ptr %2, align 8, !tbaa !45       ; 3 uses
  %4 = and i64 %3, 2
