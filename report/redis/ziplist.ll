...
bb.f:                                             ; preds = %.lr.ph, %ziplistNext.exit64
  ...
  %13 = sitofp i32 %i.ak to double
  %14 = uitofp i32 %.0113 to double
  %i.an = insertelement <2 x double> poison, double %13, i64 0
  %i.ao = insertelement <2 x double> %i.an, double %14, i64 1
