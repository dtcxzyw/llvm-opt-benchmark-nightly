...
begin_hunk_7_@match:bb.a
  ...
  br i1 %exitcond.not.i, label %start_capture.exit, label %.lr.ph.i, !llvm.loop !47
...
singlematch.exit186.thread:                       ; preds = %matchbracketclass.exit.i175.loopexit, %bb.dl, %bb.du, %bb.dk, %singlematch.exit186
  ...
  %i.mk = tail call fastcc ptr @match(ptr noundef nonnull %0, ptr noundef nonnull %i.mj, ptr noundef nonnull %i.ih), !inline_history !50 ; 2 uses
...
.start_capture.exit.loopexit_crit_edge:           ; preds = %.lr.ph532
  br label %start_capture.exit, !llvm.loop !52
