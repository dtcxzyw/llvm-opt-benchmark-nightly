...
.lr.ph37:                                         ; preds = %.lr.ph37.preheader, %bb.h
  %.02636 = phi ptr [ %i.ab, %bb.h ], [ %3, %.lr.ph37.preheader ] ; 3 uses
  %i.y = load i8, ptr %.02636, align 1, !tbaa !17
  %i.z = sext i8 %i.y to i32
  %i.aa = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %1, i32 noundef %i.z) #23
  %.not29 = icmp eq ptr %i.aa, null
  br i1 %.not29, label %.critedge2, label %bb.h

bb.h:                                             ; preds = %.lr.ph37
  %i.ab = getelementptr inbounds i8, ptr %.02636, i64 -1 ; 2 uses
  %i.ac = icmp ugt ptr %i.ab, %.0.lcssa
  br i1 %i.ac, label %.lr.ph37, label %.critedge2, !llvm.loop !30
...
bb.i:                                             ; preds = %.critedge2
  tail call void @llvm.memmove.p0.p0.i64(ptr align 1 %0, ptr align 1 %.0.lcssa, i64 %i.af, i1 false)
  br label %bb.j
...
bb.j:                                             ; preds = %bb.i, %.critedge2
  ...
  %i.ah = and i8 %.val.i31, 7
  switch i8 %i.ah, label %sdssetlen.exit [
    i8 0, label %bb.k
    i8 1, label %bb.l
    i8 2, label %bb.m
    i8 3, label %bb.n
...
bb.k:                                             ; preds = %bb.j
  %.tr.i = trunc i64 %i.af to i8
  %i.ai = shl i8 %.tr.i, 3
  store i8 %i.ai, ptr %i.a, align 1, !tbaa !17
  br label %sdssetlen.exit

bb.l:                                             ; preds = %bb.j
  %i.aj = trunc i64 %i.af to i8
  %i.ak = getelementptr inbounds i8, ptr %0, i64 -3
  store i8 %i.aj, ptr %i.ak, align 1, !tbaa !17
  br label %sdssetlen.exit

bb.m:                                             ; preds = %bb.j
  %i.al = trunc i64 %i.af to i16
  %i.am = getelementptr inbounds i8, ptr %0, i64 -5
  store i16 %i.al, ptr %i.am, align 1, !tbaa !18
  br label %sdssetlen.exit

bb.n:                                             ; preds = %bb.j
  %i.an = trunc i64 %i.af to i32
  %i.ao = getelementptr inbounds i8, ptr %0, i64 -9
  store i32 %i.an, ptr %i.ao, align 1, !tbaa !9
  br label %sdssetlen.exit

bb.o:                                             ; preds = %bb.j
  %i.ap = getelementptr inbounds i8, ptr %0, i64 -17
  store i64 %i.af, ptr %i.ap, align 1, !tbaa !14
  br label %sdssetlen.exit
