...
sdsReqType.exit:                                  ; preds = %bb.a, %bb.b, %bb.c, %bb.d
  %.0.i = phi i8 [ 2, %bb.c ], [ 0, %bb.a ], [ 1, %bb.b ], [ %..i, %bb.d ] ; 3 uses
  %i.f = icmp eq i8 %.0.i, 0
  %i.g = icmp eq i64 %1, 0
  %or.cond = and i1 %i.g, %i.f
  %spec.store.select = select i1 %or.cond, i8 1, i8 %.0.i ; 3 uses
...
adjustTypeIfNeeded.exit:                          ; preds = %bb.j, %sdsReqType.exit.i, %bb.k, %switch.lookup
  %.1 = phi i8 [ %.0.i, %bb.j ], [ %spec.store.select, %switch.lookup ], [ %..i.i, %sdsReqType.exit.i ], [ 2, %bb.k ]
...
sdsReqType.exit:                                  ; preds = %bb.b, %bb.c, %bb.d, %bb.e
  %.0.i62 = phi i8 [ 2, %bb.d ], [ 0, %bb.b ], [ 1, %bb.c ], [ %..i, %bb.e ] ; 3 uses
  %i.ai = icmp ne i32 %2, 0
  %i.aj = icmp eq i8 %.0.i62, 0
  %or.cond = and i1 %i.ai, %i.aj
  %spec.store.select = select i1 %or.cond, i8 1, i8 %.0.i62 ; 6 uses
...
adjustTypeIfNeeded.exit79:                        ; preds = %bb.r, %sdsReqType.exit.i73, %bb.s, %switch.lookup175
  %.1111 = phi i8 [ %.0.i62, %bb.r ], [ %spec.store.select, %switch.lookup175 ], [ %..i.i74, %sdsReqType.exit.i73 ], [ 2, %bb.s ] ; 2 uses
