...
@switch.table._sdsnewlen.2 = private unnamed_addr constant [5 x i64] [i64 -2, i64 -4, i64 -6, i64 -10, i64 -18], align 8
@switch.table.sdsnewplacement.4 = private unnamed_addr constant [5 x i64] [i64 1, i64 3, i64 5, i64 9, i64 17], align 8
@switch.table.sdsResize = private unnamed_addr constant [5 x i32] [i32 1, i32 3, i32 5, i32 9, i32 17], align 4
@switch.table.sdsResize.7 = private unnamed_addr constant [3 x i64] [i64 255, i64 65535, i64 4294967295], align 8
@switch.table.sdstemplate.10 = private unnamed_addr constant [5 x i64] [i64 -1, i64 -3, i64 -5, i64 -9, i64 -17], align 8
...
begin_hunk_1_@_sdsnewlen:bb.a
  ...
  %spec.store.select = select i1 %or.cond, i8 1, i8 %.0.i ; 5 uses
  %i.h = zext nneg i8 %spec.store.select to i64
  %switch.gep = getelementptr inbounds nuw [8 x i8], ptr @switch.table.sdsnewplacement.4, i64 %i.h
  %switch.load = load i64, ptr %switch.gep, align 8
  %3 = zext nneg i8 %spec.store.select to i64
  %switch.gep27 = getelementptr inbounds nuw [8 x i8], ptr @switch.table._sdsnewlen.2, i64 %3
  %switch.load28 = load i64, ptr %switch.gep27, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #25
  %i.i = add i64 %1, 1
  %i.j = add i64 %i.i, %switch.load               ; 3 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.q = add i64 %i.p, %switch.load28             ; 3 uses
...
switch.lookup:                                    ; preds = %bb.j
  ...
  %switch.gep27.a = getelementptr inbounds nuw [8 x i8], ptr @switch.table.sdsResize.7, i64 %i.s
...
switch.lookup:                                    ; preds = %bb.a
  ...
  %switch.gep = getelementptr inbounds nuw [8 x i8], ptr @switch.table.sdsnewplacement.4, i64 %i.c
  %switch.load = load i64, ptr %switch.gep, align 8
...
switch.lookup57:                                  ; preds = %bb.c
  ...
  %switch.gep58 = getelementptr inbounds nuw [8 x i8], ptr @switch.table.sdsnewplacement.4, i64 %i.g
...
switch.lookup:                                    ; preds = %bb.b
  ...
  %switch.gep = getelementptr inbounds nuw [8 x i8], ptr @switch.table.sdstemplate.10, i64 %i.f
  %switch.load = load i64, ptr %switch.gep, align 8
  br label %sdsHdrSize.exit
...
bb.n:                                             ; preds = %bb.m
  %i.ay = icmp ult i64 %.047, 4294967287
  br i1 %i.ay, label %sdsHdrSize.exit60, label %3
...
sdsHdrSize.exit60:                                ; preds = %bb.l, %bb.n, %bb.m, %3
  %4 = phi i1 [ true, %bb.m ], [ false, %3 ], [ true, %bb.n ], [ true, %bb.l ]
  %.0.i58153 = phi i64 [ 2, %bb.m ], [ 4, %3 ], [ 3, %bb.n ], [ 1, %bb.l ]
  %5 = phi i8 [ 2, %bb.m ], [ 4, %3 ], [ 3, %bb.n ], [ 1, %bb.l ] ; 4 uses
  %.0.i59 = phi i64 [ 5, %bb.m ], [ 17, %3 ], [ 9, %bb.n ], [ 3, %bb.l ] ; 4 uses
  %6 = phi i32 [ 5, %bb.m ], [ 17, %3 ], [ 9, %bb.n ], [ 3, %bb.l ] ; 7 uses
  %i.az = add i64 %.047, 1
  %i.ba = add i64 %i.az, %.0.i59                  ; 3 uses
...
bb.r:                                             ; preds = %bb.q
  %i.bf = getelementptr inbounds nuw i8, ptr %i.bd, i64 %.0.i59 ; 4 uses
...
switch.lookup:                                    ; preds = %bb.r
  ...
  %switch.gep = getelementptr inbounds nuw [8 x i8], ptr @switch.table.sdsResize.7, i64 %i.bl
  %switch.load = load i64, ptr %switch.gep, align 8
...
bb.v:                                             ; preds = %bb.p
  %i.ca = call ptr @zmalloc_usable(i64 noundef %i.ba, ptr noundef nonnull %i.a) #25 ; 8 uses
...
adjustTypeIfNeeded.exit73.thread128:              ; preds = %bb.w
  %i.cg = getelementptr inbounds nuw i8, ptr %i.ca, i64 %.0.i59 ; 2 uses
...
switch.lookup191:                                 ; preds = %bb.w
  %i.ck = getelementptr [8 x i8], ptr @switch.table.sdsResize.7, i64 %.0.i58153
  ...
  %7 = add nuw i64 %.0.i5697, 1                   ; 4 uses
...
sdsReqType.exit.i67:                              ; preds = %bb.x
  %i.cp = icmp ult i64 %i.cf, 4294967287
...
adjustTypeIfNeeded.exit73.thread161:              ; preds = %sdsReqType.exit.i67
  %8 = getelementptr inbounds nuw i8, ptr %i.ca, i64 17 ; 2 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %8, ptr noundef nonnull align 1 dereferenceable(1) %0, i64 %7, i1 false)
  br label %adjustTypeIfNeeded.exit.thread.thread176

adjustTypeIfNeeded.exit73.thread165:              ; preds = %sdsReqType.exit.i67
  %9 = getelementptr inbounds nuw i8, ptr %i.ca, i64 9 ; 2 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %9, ptr noundef nonnull align 1 dereferenceable(1) %0, i64 %7, i1 false)
  call void @zfree(ptr noundef nonnull %i.ap) #25
  %10 = getelementptr inbounds nuw i8, ptr %i.ca, i64 8
...
adjustTypeIfNeeded.exit73:                        ; preds = %switch.lookup191
  %i.cq = getelementptr inbounds nuw i8, ptr %i.ca, i64 %.0.i59 ; 6 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %i.cq, ptr noundef nonnull align 1 dereferenceable(1) %0, i64 %7, i1 false)
  call void @zfree(ptr noundef nonnull %i.ap) #25
  %i.cr = getelementptr inbounds i8, ptr %i.cq, i64 -1
  store i8 %5, ptr %i.cr, align 1, !tbaa !17
  switch i8 %5, label %default.unreachable151 [
...
bb.y:                                             ; preds = %adjustTypeIfNeeded.exit73.thread, %adjustTypeIfNeeded.exit73
  ...
  %.2126 = phi i32 [ 5, %adjustTypeIfNeeded.exit73.thread ], [ %6, %adjustTypeIfNeeded.exit73 ]
...
adjustTypeIfNeeded.exit.thread.thread180:         ; preds = %adjustTypeIfNeeded.exit73, %adjustTypeIfNeeded.exit73.thread165
  %i.dd = phi ptr [ %9, %adjustTypeIfNeeded.exit73.thread165 ], [ %i.cq, %adjustTypeIfNeeded.exit73 ] ; 2 uses
  %.2169 = phi i32 [ 9, %adjustTypeIfNeeded.exit73.thread165 ], [ %6, %adjustTypeIfNeeded.exit73 ]
...
adjustTypeIfNeeded.exit.thread.thread176:         ; preds = %adjustTypeIfNeeded.exit73.thread128, %adjustTypeIfNeeded.exit73.thread161
  %i.dk = phi ptr [ %i.cg, %adjustTypeIfNeeded.exit73.thread128 ], [ %8, %adjustTypeIfNeeded.exit73.thread161 ] ; 3 uses
  %.0.i58153.sink = phi i8 [ %5, %adjustTypeIfNeeded.exit73.thread128 ], [ 4, %adjustTypeIfNeeded.exit73.thread161 ]
  %.2132 = phi i64 [ %i.cj, %adjustTypeIfNeeded.exit73.thread128 ], [ -18, %adjustTypeIfNeeded.exit73.thread161 ]
  call void @zfree(ptr noundef nonnull %i.ap) #25
  %11 = getelementptr inbounds i8, ptr %i.dk, i64 -1
  store i8 %.0.i58153.sink, ptr %11, align 1, !tbaa !17
...
adjustTypeIfNeeded.exit.thread:                   ; preds = %switch.lookup, %bb.t, %bb.u
  ...
  %.092 = phi i32 [ 9, %bb.t ], [ 17, %bb.u ], [ %6, %switch.lookup ]
...
switch.lookup:                                    ; preds = %bb.m
  ...
  %switch.gep175 = getelementptr inbounds nuw [8 x i8], ptr @switch.table.sdsResize.7, i64 %i.bs
...
switch.lookup178:                                 ; preds = %bb.r
  ...
  %switch.gep179 = getelementptr inbounds nuw [8 x i8], ptr @switch.table.sdsResize.7, i64 %i.cs
...
switch.lookup:                                    ; preds = %bb.a
  ...
  %switch.gep = getelementptr inbounds nuw [8 x i8], ptr @switch.table.sdstemplate.10, i64 %i.e
  %switch.load = load i64, ptr %switch.gep, align 8
  br label %sdsHdrSize.exit
...
switch.lookup:                                    ; preds = %bb.o
  ...
  %switch.gep = getelementptr inbounds nuw [8 x i8], ptr @switch.table.sdstemplate.10, i64 %i.bq
  %switch.load = load i64, ptr %switch.gep, align 8
  br label %sdsHdrSize.exit.i
...
switch.lookup:                                    ; preds = %bb.b
  ...
  %switch.gep = getelementptr inbounds nuw [8 x i8], ptr @switch.table.sdstemplate.10, i64 %i.i
  %switch.load = load i64, ptr %switch.gep, align 8
  br label %sdsHdrSize.exit.i
...
switch.lookup:                                    ; preds = %bb.cq
  ...
  %switch.gep = getelementptr inbounds nuw [8 x i8], ptr @switch.table.sdstemplate.10, i64 %i.jg
  %switch.load = load i64, ptr %switch.gep, align 8
  br label %sdsHdrSize.exit.i
...
switch.lookup238:                                 ; preds = %bb.cr
  ...
  %switch.gep239 = getelementptr inbounds nuw [8 x i8], ptr @switch.table.sdstemplate.10, i64 %i.jo
...
switch.lookup:                                    ; preds = %bb.aq
  ...
  %switch.gep = getelementptr inbounds nuw [8 x i8], ptr @switch.table.sdstemplate.10, i64 %i.dq
  %switch.load = load i64, ptr %switch.gep, align 8
  br label %sdsHdrSize.exit.i
...
switch.lookup112:                                 ; preds = %sdscat.exit64
  ...
  %switch.gep113 = getelementptr inbounds nuw [8 x i8], ptr @switch.table.sdstemplate.10, i64 %i.fb
...
switch.lookup115:                                 ; preds = %bb.be
  ...
  %switch.gep116 = getelementptr inbounds nuw [8 x i8], ptr @switch.table.sdstemplate.10, i64 %i.fk
