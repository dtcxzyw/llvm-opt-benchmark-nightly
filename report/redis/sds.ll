...
._crit_edge.loopexit.peel.begin:                  ; preds = %.lr.ph, %sdscat.exit18
  ...
  %8 = call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %7) #26 ; 3 uses
...
50:                                               ; preds = %sdscat.exit.peel
  %51 = call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %2) #26 ; 3 uses
