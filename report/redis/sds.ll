...
adjustTypeIfNeeded.exit.thread114:                ; preds = %bb.s
  ...
  br label %adjustTypeIfNeeded.exit.thread.thread171
...
switch.lookup193:                                 ; preds = %bb.w
  ...
  %switch.gep194 = getelementptr i8, ptr %i.cm, i64 -8
  %switch.load195 = load i64, ptr %switch.gep194, align 8
  %i.cn = icmp ugt i64 %i.cg, %switch.load195
  br i1 %i.cn, label %bb.x, label %adjustTypeIfNeeded.exit73

bb.x:                                             ; preds = %switch.lookup193
...
sdsReqType.exit.i67:                              ; preds = %bb.x
  ...
  br i1 %i.cs, label %adjustTypeIfNeeded.exit73.thread166, label %adjustTypeIfNeeded.exit73.thread162

adjustTypeIfNeeded.exit73.thread162:              ; preds = %sdsReqType.exit.i67
  store i8 4, ptr %i.cv, align 1, !tbaa !17
  br label %adjustTypeIfNeeded.exit.thread.thread177

adjustTypeIfNeeded.exit73.thread166:              ; preds = %sdsReqType.exit.i67
  store i8 3, ptr %i.cv, align 1, !tbaa !17
  br label %adjustTypeIfNeeded.exit.thread.thread181

adjustTypeIfNeeded.exit73:                        ; preds = %switch.lookup193
  ...
  switch i8 %.0.i58153, label %default.unreachable151 [
    i8 3, label %adjustTypeIfNeeded.exit.thread.thread181
    i8 1, label %adjustTypeIfNeeded.exit.thread.thread186
    i8 2, label %bb.y
  ]

adjustTypeIfNeeded.exit.thread.thread186:         ; preds = %adjustTypeIfNeeded.exit73
...
sdsTypeMaxSize.exit:                              ; preds = %adjustTypeIfNeeded.exit.thread.thread181, %adjustTypeIfNeeded.exit.thread.thread171, %adjustTypeIfNeeded.exit.thread.thread186, %adjustTypeIfNeeded.exit.thread, %bb.z, %bb.aa
  %i.eb = phi i64 [ %i.ea, %bb.z ], [ %i.de, %adjustTypeIfNeeded.exit.thread.thread186 ], [ %i.ea, %adjustTypeIfNeeded.exit.thread ], [ %i.dw, %adjustTypeIfNeeded.exit.thread.thread171 ], [ %i.dq, %adjustTypeIfNeeded.exit.thread.thread181 ], [ %i.ea, %bb.aa ] ; 2 uses
  %.046176 = phi ptr [ %.046, %bb.z ], [ %i.cw, %adjustTypeIfNeeded.exit.thread.thread186 ], [ %.046, %adjustTypeIfNeeded.exit.thread ], [ %.046.ph, %adjustTypeIfNeeded.exit.thread.thread171 ], [ %i.dk, %adjustTypeIfNeeded.exit.thread.thread181 ], [ %.046, %bb.aa ]
  %.0.i77 = phi i64 [ 65535, %bb.z ], [ 255, %adjustTypeIfNeeded.exit.thread.thread186 ], [ 255, %adjustTypeIfNeeded.exit.thread ], [ 65535, %adjustTypeIfNeeded.exit.thread.thread171 ], [ 4294967295, %adjustTypeIfNeeded.exit.thread.thread181 ], [ 4294967295, %bb.aa ]
...
.critedge:                                        ; preds = %bb.r, %adjustTypeIfNeeded.exit.thread.thread177, %adjustTypeIfNeeded.exit.thread, %sdsTypeMaxSize.exit
  %i.ec = phi i64 [ %i.eb, %sdsTypeMaxSize.exit ], [ %i.ea, %adjustTypeIfNeeded.exit.thread ], [ %i.bk, %bb.r ], [ %i.du, %adjustTypeIfNeeded.exit.thread.thread177 ] ; 4 uses
  %.046137 = phi ptr [ %.046176, %sdsTypeMaxSize.exit ], [ %.046, %adjustTypeIfNeeded.exit.thread ], [ %i.bg, %bb.r ], [ %i.dr, %adjustTypeIfNeeded.exit.thread.thread177 ] ; 10 uses
