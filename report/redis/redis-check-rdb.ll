...
begin_hunk_11
  ...
  %i.v = call i64 %i.u(ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef %.0273.i, i64 noundef %i.t) #13
...
bb.g:                                             ; preds = %bb.f
  call void %i.z(ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef %.0273.i, i64 noundef %i.t) #13
  br label %bb.h
...
rioRead.exit:                                     ; preds = %bb.h
  ...
  %3 = load i32, ptr %i.a, align 16
  %4 = xor i32 %3, 1229210962
...
bb.j:                                             ; preds = %rioRead.exit
  ...
  %i.ag = call i64 @__isoc23_strtol(ptr noundef nonnull %i.af, ptr noundef null, i32 noundef 10) #13
...
begin_hunk_15
  ...
  %i.aj = call i32 @rdbLoadType(ptr noundef nonnull @redis_check_rdb.rdb) #13 ; 6 uses
...
bb.l:                                             ; preds = %.preheader165
  ...
  %i.ak = call i64 @rdbLoadTime(ptr noundef nonnull @redis_check_rdb.rdb) #13
...
bb.m:                                             ; preds = %.preheader165
  store i32 2, ptr getelementptr inbounds nuw (i8, ptr @rdbstate, i64 56), align 8, !tbaa !25
  %i.ao = call i64 @rdbLoadMillisecondTime(ptr noundef nonnull @redis_check_rdb.rdb, i32 noundef %i.ah) #13
...
.preheader.i115:                                  ; preds = %bb.n
  ...
  %i.au = call i64 %i.at(ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef nonnull %i.b, i64 noundef 1) #13
...
bb.p:                                             ; preds = %bb.o
  call void %i.ay(ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef nonnull %i.b, i64 noundef 1) #13
...
bb.q:                                             ; preds = %.preheader165
  %i.bc = call i64 @rdbLoadLen(ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef null) #13
  %i.bd = icmp eq i64 %i.bc, -1
  br i1 %i.bd, label %rioRead.exit.thread, label %.preheader165.backedge

bb.r:                                             ; preds = %.preheader165
  %i.be = call i64 @rdbLoadLen(ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef null) #13 ; 2 uses
...
begin_hunk_22
  ...
  %i.bl = call i64 %i.bk(ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef %.0273.i127, i64 noundef %i.bj) #13
...
bb.t:                                             ; preds = %bb.s
  call void %i.bp(ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef %.0273.i127, i64 noundef %i.bj) #13
  br label %bb.u
...
rioRead.exit132:                                  ; preds = %bb.u
  %i.bu = call ptr @rdbLoadCheckModuleValue(ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef nonnull @.str.52) #13 ; 2 uses
  %i.bv = icmp eq ptr %i.bu, null
  br i1 %i.bv, label %rioRead.exit132.thread, label %bb.v

bb.v:                                             ; preds = %rioRead.exit132
  call void @decrRefCount(ptr noundef nonnull %i.bu) #13
...
bb.w:                                             ; preds = %.preheader165
  ...
  %i.bx = call i64 @rdbLoadLen(ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef null) #13 ; 3 uses
...
bb.y:                                             ; preds = %.preheader165
  store i32 6, ptr getelementptr inbounds nuw (i8, ptr @rdbstate, i64 56), align 8, !tbaa !25
  %i.ca = call i64 @rdbLoadLen(ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef null) #13
  %i.cb = icmp eq i64 %i.ca, -1
  br i1 %i.cb, label %rioRead.exit.thread, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.cc = call i64 @rdbLoadLen(ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef null) #13
  %i.cd = icmp eq i64 %i.cc, -1
  br i1 %i.cd, label %rioRead.exit.thread, label %.preheader165.backedge

bb.aa:                                            ; preds = %.preheader165
  %i.ce = call i64 @rdbLoadLen(ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef null) #13
  %i.cf = icmp eq i64 %i.ce, -1
  br i1 %i.cf, label %rioRead.exit.thread, label %bb.ab

bb.ab:                                            ; preds = %bb.aa
  %i.cg = call i64 @rdbLoadLen(ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef null) #13
...
bb.ad:                                            ; preds = %.preheader165
  ...
  %i.ck = call ptr @rdbLoadStringObject(ptr noundef nonnull @redis_check_rdb.rdb) #13 ; 4 uses
  %i.cl = icmp eq ptr %i.ck, null
  br i1 %i.cl, label %rioRead.exit.thread, label %bb.ae

bb.ae:                                            ; preds = %bb.ad
  %i.cm = call ptr @rdbLoadStringObject(ptr noundef nonnull @redis_check_rdb.rdb) #13 ; 3 uses
  %i.cn = icmp eq ptr %i.cm, null
  br i1 %i.cn, label %bb.af, label %bb.ag

bb.af:                                            ; preds = %bb.ae
  call void @decrRefCount(ptr noundef nonnull %i.ck) #13
  br label %rioRead.exit.thread
...
begin_hunk_26
  ...
  call void @decrRefCount(ptr noundef nonnull %i.ck) #13
  call void @decrRefCount(ptr noundef nonnull %i.cm) #13
...
bb.ah:                                            ; preds = %.preheader165
  ...
  %i.cs = call i64 @rdbLoadLen(ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef null) #13 ; 2 uses
  %i.ct = icmp eq i64 %i.cs, -1
  br i1 %i.ct, label %rioRead.exit.thread, label %bb.ai

bb.ai:                                            ; preds = %bb.ah
  %i.cu = call i64 @rdbLoadLen(ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef null) #13 ; 2 uses
  %i.cv = icmp eq i64 %i.cu, -1
  br i1 %i.cv, label %rioRead.exit.thread, label %bb.aj

bb.aj:                                            ; preds = %bb.ai
  %i.cw = call i64 @rdbLoadLen(ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef null) #13
...
bb.am:                                            ; preds = %bb.ak
  ...
  call void @moduleTypeNameByID(ptr noundef nonnull %i.d, i64 noundef %i.cs) #13
  call void (ptr, ...) @rdbCheckInfo(ptr noundef nonnull @.str.56, ptr noundef nonnull %i.d)
  %i.cy = call ptr @rdbLoadCheckModuleValue(ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef nonnull %i.d) #13
  call void @decrRefCount(ptr noundef %i.cy) #13
...
bb.ao:                                            ; preds = %.preheader165
  ...
  %i.cz = call i32 @rdbFunctionLoad(ptr noundef nonnull @redis_check_rdb.rdb, i32 noundef %i.ah, ptr noundef null, i32 noundef 0, ptr noundef nonnull %i.e) #13
...
begin_hunk_29
  ...
  call void @sdsfree(ptr noundef %i.db) #13
  br label %bb.aq
...
bb.at:                                            ; preds = %bb.ar
  ...
  %i.dd = call ptr @rdbLoadStringObject(ptr noundef nonnull @redis_check_rdb.rdb) #13 ; 4 uses
...
begin_hunk_31
  ...
  %i.dj = call ptr @rdbLoadObject(i32 noundef %i.aj, ptr noundef nonnull @redis_check_rdb.rdb, ptr noundef %i.di, i32 noundef %.078, ptr noundef null) #13 ; 4 uses
...
bb.az:                                            ; preds = %bb.ay
  %i.dt = call i64 @hashTypeGetMinExpire(ptr noundef nonnull %i.dj, i32 noundef 1) #13
...
bb.bb:                                            ; preds = %bb.ba, %bb.az, %bb.ay
  ...
  call void @decrRefCount(ptr noundef nonnull %i.dd) #13
