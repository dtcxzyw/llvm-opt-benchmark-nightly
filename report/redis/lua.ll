...
bb.ad:                                            ; preds = %.preheader
  %lsr.iv250.lcssa253 = phi i32 [ %lsr.iv250, %.preheader ]
  %lsr.iv250.lcssa = phi i32 [ %lsr.iv250, %.preheader ]
...
.lr.ph.preheader.i.i:                             ; preds = %bb.ad
  ...
  %i.cn = zext i32 %lsr.iv250.lcssa to i64
  br label %.lr.ph.i.i
...
.lr.ph30.preheader.i.i:                           ; preds = %._crit_edge.i.i
  %i.cq = zext i32 %lsr.iv250.lcssa253 to i64
