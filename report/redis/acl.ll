...
vector.body:                                      ; preds = %.critedge
  ...
  %i.cs = xor <4 x i8> %wide.load29, %wide.load
  %i.ct = xor <4 x i8> %wide.load30, %wide.load28
  ...
  %wide.load29.1 = load <4 x i8>, ptr %i.cu, align 1, !tbaa !25
  %wide.load30.1 = load <4 x i8>, ptr %i.cv, align 1, !tbaa !25
  %i.cw = xor <4 x i8> %wide.load29.1, %wide.load.1
  %i.cx = xor <4 x i8> %wide.load30.1, %wide.load28.1
  %i.cy = or <4 x i8> %i.cs, %i.cw
  %i.cz = or <4 x i8> %i.ct, %i.cx
  %wide.load.2 = load <4 x i8>, ptr %i.cc, align 1, !tbaa !25
  %wide.load28.2 = load <4 x i8>, ptr %i.cd, align 1, !tbaa !25
  %i.da = getelementptr inbounds nuw i8, ptr %i.cq, i64 16
  %i.db = getelementptr inbounds nuw i8, ptr %i.cq, i64 20
  %wide.load29.2 = load <4 x i8>, ptr %i.da, align 1, !tbaa !25
  %wide.load30.2 = load <4 x i8>, ptr %i.db, align 1, !tbaa !25
  %i.dc = xor <4 x i8> %wide.load29.2, %wide.load.2
  %i.dd = xor <4 x i8> %wide.load30.2, %wide.load28.2
  %i.de = or <4 x i8> %i.cy, %i.dc
  %i.df = or <4 x i8> %i.cz, %i.dd
  %wide.load.3 = load <4 x i8>, ptr %i.ce, align 1, !tbaa !25
  %wide.load28.3 = load <4 x i8>, ptr %i.cf, align 1, !tbaa !25
  %i.dg = getelementptr inbounds nuw i8, ptr %i.cq, i64 24
  %i.dh = getelementptr inbounds nuw i8, ptr %i.cq, i64 28
  %wide.load29.3 = load <4 x i8>, ptr %i.dg, align 1, !tbaa !25
  %wide.load30.3 = load <4 x i8>, ptr %i.dh, align 1, !tbaa !25
  %i.di = xor <4 x i8> %wide.load29.3, %wide.load.3
  %i.dj = xor <4 x i8> %wide.load30.3, %wide.load28.3
  %i.dk = or <4 x i8> %i.de, %i.di
  %i.dl = or <4 x i8> %i.df, %i.dj
  %wide.load.4 = load <4 x i8>, ptr %i.cg, align 1, !tbaa !25
  %wide.load28.4 = load <4 x i8>, ptr %i.ch, align 1, !tbaa !25
  %i.dm = getelementptr inbounds nuw i8, ptr %i.cq, i64 32
  %i.dn = getelementptr inbounds nuw i8, ptr %i.cq, i64 36
  %wide.load29.4 = load <4 x i8>, ptr %i.dm, align 1, !tbaa !25
  %wide.load30.4 = load <4 x i8>, ptr %i.dn, align 1, !tbaa !25
  %i.do = xor <4 x i8> %wide.load29.4, %wide.load.4
  %i.dp = xor <4 x i8> %wide.load30.4, %wide.load28.4
  %i.dq = or <4 x i8> %i.dk, %i.do
  %i.dr = or <4 x i8> %i.dl, %i.dp
  %wide.load.5 = load <4 x i8>, ptr %i.ci, align 1, !tbaa !25
  %wide.load28.5 = load <4 x i8>, ptr %i.cj, align 1, !tbaa !25
  %i.ds = getelementptr inbounds nuw i8, ptr %i.cq, i64 40
  %i.dt = getelementptr inbounds nuw i8, ptr %i.cq, i64 44
  %wide.load29.5 = load <4 x i8>, ptr %i.ds, align 1, !tbaa !25
  %wide.load30.5 = load <4 x i8>, ptr %i.dt, align 1, !tbaa !25
  %i.du = xor <4 x i8> %wide.load29.5, %wide.load.5
  %i.dv = xor <4 x i8> %wide.load30.5, %wide.load28.5
  %i.dw = or <4 x i8> %i.dq, %i.du
  %i.dx = or <4 x i8> %i.dr, %i.dv
  %wide.load.6 = load <4 x i8>, ptr %i.ck, align 1, !tbaa !25
  %wide.load28.6 = load <4 x i8>, ptr %i.cl, align 1, !tbaa !25
  %i.dy = getelementptr inbounds nuw i8, ptr %i.cq, i64 48
  %i.dz = getelementptr inbounds nuw i8, ptr %i.cq, i64 52
  %wide.load29.6 = load <4 x i8>, ptr %i.dy, align 1, !tbaa !25
  %wide.load30.6 = load <4 x i8>, ptr %i.dz, align 1, !tbaa !25
  %i.ea = xor <4 x i8> %wide.load29.6, %wide.load.6
  %i.eb = xor <4 x i8> %wide.load30.6, %wide.load28.6
  %i.ec = or <4 x i8> %i.dw, %i.ea
  %i.ed = or <4 x i8> %i.dx, %i.eb
  %wide.load.7 = load <4 x i8>, ptr %i.cm, align 1, !tbaa !25
  %wide.load28.7 = load <4 x i8>, ptr %i.cn, align 1, !tbaa !25
  %i.ee = getelementptr inbounds nuw i8, ptr %i.cq, i64 56
  %i.ef = getelementptr inbounds nuw i8, ptr %i.cq, i64 60
  %wide.load29.7 = load <4 x i8>, ptr %i.ee, align 1, !tbaa !25
  %wide.load30.7 = load <4 x i8>, ptr %i.ef, align 1, !tbaa !25
  %i.eg = xor <4 x i8> %wide.load29.7, %wide.load.7
  %i.eh = xor <4 x i8> %wide.load30.7, %wide.load28.7
  %i.ei = or <4 x i8> %i.ec, %i.eg
...
bb.s:                                             ; preds = %.critedge
  ...
  %i.el = tail call ptr @__errno_location() #28
  store i32 22, ptr %i.el, align 4, !tbaa !9
  br label %bb.t
