...
vector.body:                                      ; preds = %.critedge
  ...
  %4 = xor <4 x i8> %wide.load29, %wide.load
  %5 = xor <4 x i8> %wide.load30, %wide.load28
  ...
  %wide.load29.1.a = load <4 x i8>, ptr %i.cs, align 1, !tbaa !25
  %wide.load30.1.a = load <4 x i8>, ptr %i.ct, align 1, !tbaa !25
  %6 = xor <4 x i8> %wide.load29.1.a, %wide.load.1
  %7 = xor <4 x i8> %wide.load30.1.a, %wide.load28.1
  %8 = or <4 x i8> %4, %6
  %9 = or <4 x i8> %5, %7
  ...
  %10 = xor <4 x i8> %wide.load29.2.a, %wide.load.2
  %11 = xor <4 x i8> %wide.load30.2.a, %wide.load28.2
  %12 = or <4 x i8> %8, %10
  %13 = or <4 x i8> %9, %11
  %wide.load.3 = load <4 x i8>, ptr %i.ce, align 1, !tbaa !25
  %wide.load28.3 = load <4 x i8>, ptr %i.cf, align 1, !tbaa !25
  %14 = getelementptr inbounds nuw i8, ptr %i.cq, i64 24
  %15 = getelementptr inbounds nuw i8, ptr %i.cq, i64 28
  %wide.load29.3 = load <4 x i8>, ptr %14, align 1, !tbaa !25
  %wide.load30.3 = load <4 x i8>, ptr %15, align 1, !tbaa !25
  %16 = xor <4 x i8> %wide.load29.3, %wide.load.3
  %17 = xor <4 x i8> %wide.load30.3, %wide.load28.3
  %18 = or <4 x i8> %12, %16
  %19 = or <4 x i8> %13, %17
  %wide.load.4.a = load <4 x i8>, ptr %i.cg, align 1, !tbaa !25
  %wide.load28.4.a = load <4 x i8>, ptr %i.ch, align 1, !tbaa !25
  %i.cw = getelementptr inbounds nuw i8, ptr %i.cq, i64 32
  %i.cx = getelementptr inbounds nuw i8, ptr %i.cq, i64 36
  %wide.load29.4 = load <4 x i8>, ptr %i.cw, align 1, !tbaa !25
  %wide.load30.4 = load <4 x i8>, ptr %i.cx, align 1, !tbaa !25
  %20 = xor <4 x i8> %wide.load29.4, %wide.load.4.a
  %21 = xor <4 x i8> %wide.load30.4, %wide.load28.4.a
  %22 = or <4 x i8> %18, %20
  %23 = or <4 x i8> %19, %21
  %wide.load.5 = load <4 x i8>, ptr %i.ci, align 1, !tbaa !25
  %wide.load28.5 = load <4 x i8>, ptr %i.cj, align 1, !tbaa !25
  %24 = getelementptr inbounds nuw i8, ptr %i.cq, i64 40
  %25 = getelementptr inbounds nuw i8, ptr %i.cq, i64 44
  %wide.load29.5 = load <4 x i8>, ptr %24, align 1, !tbaa !25
  %wide.load30.5 = load <4 x i8>, ptr %25, align 1, !tbaa !25
  %26 = xor <4 x i8> %wide.load29.5, %wide.load.5
  %27 = xor <4 x i8> %wide.load30.5, %wide.load28.5
  %28 = or <4 x i8> %22, %26
  %29 = or <4 x i8> %23, %27
  %wide.load.6 = load <4 x i8>, ptr %i.ck, align 1, !tbaa !25
  %wide.load28.6 = load <4 x i8>, ptr %i.cl, align 1, !tbaa !25
  %30 = getelementptr inbounds nuw i8, ptr %i.cq, i64 48
  %31 = getelementptr inbounds nuw i8, ptr %i.cq, i64 52
  %wide.load29.6 = load <4 x i8>, ptr %30, align 1, !tbaa !25
  %wide.load30.6 = load <4 x i8>, ptr %31, align 1, !tbaa !25
  %32 = xor <4 x i8> %wide.load29.6, %wide.load.6
  %33 = xor <4 x i8> %wide.load30.6, %wide.load28.6
  %34 = or <4 x i8> %28, %32
  %35 = or <4 x i8> %29, %33
  %wide.load.7 = load <4 x i8>, ptr %i.cm, align 1, !tbaa !25
  %wide.load28.7 = load <4 x i8>, ptr %i.cn, align 1, !tbaa !25
  %36 = getelementptr inbounds nuw i8, ptr %i.cq, i64 56
  %37 = getelementptr inbounds nuw i8, ptr %i.cq, i64 60
  %wide.load29.7 = load <4 x i8>, ptr %36, align 1, !tbaa !25
  %wide.load30.7 = load <4 x i8>, ptr %37, align 1, !tbaa !25
  %38 = xor <4 x i8> %wide.load29.7, %wide.load.7
  %39 = xor <4 x i8> %wide.load30.7, %wide.load28.7
  %40 = or <4 x i8> %34, %38
  %41 = or <4 x i8> %35, %39
  %bin.rdx32 = or <4 x i8> %41, %40
  %bin.rdx = sext <4 x i8> %bin.rdx32 to <4 x i32>
  %42 = call i32 @llvm.vector.reduce.umax.v4i32(<4 x i32> %bin.rdx)
  %.not19.not = icmp eq i32 %42, 0
