...
bb.ap:                                            ; preds = %sdslen.exit156
  ...
  switch i32 %i.fb, label %ACLSetUserStringError.exit.thread [
    i32 2, label %ACLSetUserStringError.exit.thread178
    i32 22, label %ACLSetUserStringError.exit.a
    i32 17, label %bb.aq
    i32 21, label %bb.ar
    i32 19, label %bb.as
end_hunk_0
...
ACLSetUserStringError.exit.thread:                ; preds = %bb.av, %bb.au, %bb.at, %bb.as, %bb.ar, %bb.aq, %bb.ap, %ACLSetUserStringError.exit.a
  %.0.i157177 = phi ptr [ @.str.79, %bb.ap ], [ @.str.87, %bb.av ], [ @.str.86, %bb.au ], [ @.str.85, %bb.at ], [ @.str.84, %bb.as ], [ @.str.83, %bb.ar ], [ @.str.82, %bb.aq ], [ @.str.81, %ACLSetUserStringError.exit.a ]
