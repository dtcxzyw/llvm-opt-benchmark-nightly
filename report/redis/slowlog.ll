...
bb.k:                                             ; preds = %sdslen.exit
  ...
  %.val.i57 = load i8, ptr %i.ar, align 1, !tbaa !26 ; 2 uses
  %i.as = and i8 %.val.i57, 7
  switch i8 %i.as, label %sdslen.exit59 [
    i8 0, label %bb.l
    i8 1, label %bb.m
    i8 2, label %bb.n
    i8 3, label %bb.o
...
sdslen.exit59:                                    ; preds = %bb.k, %bb.l, %bb.m, %bb.n, %bb.o, %bb.p
  %.0.i58 = phi i64 [ %i.bf, %bb.p ], [ %i.au, %bb.l ], [ %i.ax, %bb.m ], [ %i.ba, %bb.n ], [ %i.bd, %bb.o ], [ 0, %bb.k ]
  %i.bg = add i64 %.0.i58, -128
...
bb.s:                                             ; preds = %bb.c, %bb.q, %bb.r, %sdslen.exit59
