...
bb.a:
  ...
  br i1 %or.cond, label %.preheader.us, label %.loopexit23

.preheader.us:                                    ; preds = %bb.a, %._crit_edge.us
  %.01526.us = phi i64 [ %i.g, %._crit_edge.us ], [ 0, %bb.a ] ; 3 uses
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 %.01526.us
  %i.b = load i8, ptr %i.a, align 1, !tbaa !13
  br label %bb.c

bb.b:                                             ; preds = %bb.c
  %i.c = add nuw i64 %.025.us, 1                  ; 2 uses
  %exitcond.not = icmp eq i64 %i.c, %3
  br i1 %exitcond.not, label %._crit_edge.us, label %bb.c, !llvm.loop !33

bb.c:                                             ; preds = %.preheader.us, %bb.b
  %.025.us = phi i64 [ 0, %.preheader.us ], [ %i.c, %bb.b ] ; 2 uses
  %i.d = getelementptr inbounds nuw i8, ptr %2, i64 %.025.us
...
._crit_edge.us:                                   ; preds = %bb.b
  %i.g = add nuw i64 %.01526.us, 1                ; 2 uses
  %exitcond29.not = icmp eq i64 %i.g, %1
  br i1 %exitcond29.not, label %.loopexit23, label %.preheader.us, !llvm.loop !34

.loopexit23.loopexit:                             ; preds = %bb.c
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 %.01526.us
  br label %.loopexit23

.loopexit23:                                      ; preds = %._crit_edge.us, %.loopexit23.loopexit, %bb.a
  %i.i = phi ptr [ %i.h, %.loopexit23.loopexit ], [ null, %bb.a ], [ null, %._crit_edge.us ]
  ret ptr %i.i
}
