...
bb.aa:                                            ; preds = %bb.z, %bb.y
  %.073 = phi i32 [ 1, %bb.z ], [ %i.at, %bb.y ]  ; 3 uses
  ...
  %i.ax = add nuw nsw i32 %.073, %3               ; 3 uses
...
.lr.ph:                                           ; preds = %bb.aa, %.lr.ph
  %.06992 = phi i32 [ %spec.select, %.lr.ph ], [ %i.ax, %bb.aa ] ; 3 uses
...
._crit_edge:                                      ; preds = %.lr.ph, %bb.aa
  ...
  %.069.lcssa = phi i32 [ %i.ax, %bb.aa ], [ %spec.select, %.lr.ph ] ; 2 uses
