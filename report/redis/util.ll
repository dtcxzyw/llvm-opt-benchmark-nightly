...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.d
  ...
  %.01519 = phi i32 [ %i.o, %bb.d ], [ 0, %.lr.ph.preheader ] ; 3 uses
...
._crit_edge.loopexitsplit:                        ; preds = %bb.d
  %.015.lcssa.ph.ph = phi i32 [ %i.j, %bb.d ]
  br label %._crit_edge.loopexit

.lr.ph.._crit_edge.loopexit_crit_edge:            ; preds = %.lr.ph
  %.01519.lcssa = phi i32 [ %.01519, %.lr.ph ]
  %.01519.lcssa.a = phi i32 [ %.01519, %.lr.ph ]  ; 0 uses
  br label %._crit_edge.loopexit

._crit_edge.loopexit:                             ; preds = %._crit_edge.loopexitsplit, %.lr.ph.._crit_edge.loopexit_crit_edge
  %.015.lcssa.ph = phi i32 [ %.01519.lcssa, %.lr.ph.._crit_edge.loopexit_crit_edge ], [ %.015.lcssa.ph.ph, %._crit_edge.loopexitsplit ]
