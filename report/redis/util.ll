...
pred.store.continue144:                           ; preds = %pred.store.continue, %pred.store.if143
...
i2string_async_signal_safe.exit:                  ; preds = %pred.store.if171, %pred.store.continue170, %bb.ae
  %.3.i = phi ptr [ %.151.i, %bb.ae ], [ %i.h, %pred.store.continue170 ], [ %i.h, %pred.store.if171 ]
