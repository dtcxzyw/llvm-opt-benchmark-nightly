...
begin_hunk_1_@je_large_ralloc_no_move:bb.a
  ...
  %i.dh = and i32 %i.dg, 3
  %8 = or disjoint i32 %i.dh, %7
  br label %sz_size2index.exit.i

sz_size2index.exit.i:                             ; preds = %bb.t, %bb.s, %bb.r
  %.0.i.i = phi i32 [ %i.cv, %bb.r ], [ %8, %bb.t ], [ 235, %bb.s ]
  %i.di = call zeroext i1 @je_pa_shrink(ptr noundef %0, ptr noundef nonnull %i.cn, ptr noundef nonnull %1, i64 noundef %i.cd, i64 noundef %i.cp, i32 noundef %.0.i.i, ptr noundef nonnull %i.a) #10
...
begin_hunk_3_@large_ralloc_no_move_expand:bb.a
  ...
  %i.ad = and i32 %i.ac, 3
  %7 = or disjoint i32 %i.ad, %6
  br label %sz_size2index.exit

sz_size2index.exit:                               ; preds = %bb.d, %bb.c, %bb.b
  %.0.i = phi i32 [ %i.r, %bb.b ], [ %7, %bb.d ], [ 235, %bb.c ]
...
begin_hunk_5_@je_large_ralloc:bb.a
  ...
  %i.ar = and i32 %i.aq, 3
  %15 = or disjoint i32 %i.ar, %14
  br label %sz_size2index.exit.i

sz_size2index.exit.i:                             ; preds = %bb.j, %bb.h
  %.0.i.i = phi i32 [ %i.af, %bb.h ], [ %15, %bb.j ] ; 4 uses
...
begin_hunk_7_@arena_sdalloc_no_tcache:bb.a
  ...
  %i.r = and i32 %i.q, 3
  %6 = or disjoint i32 %i.r, %5
  br label %sz_size2index.exit

sz_size2index.exit:                               ; preds = %bb.d, %bb.b
  %.0.i = phi i32 [ %i.f, %bb.b ], [ %6, %bb.d ]
