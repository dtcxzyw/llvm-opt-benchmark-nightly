...
bb.e:                                             ; preds = %bb.d
  ...
  %5 = lshr i64 1152921504606846975, %i.r
  %i.s = add nuw nsw i64 %i.f, %5
...
bb.i:                                             ; preds = %bb.h
  ...
  %notmask.i = ashr exact i64 -1152921504606846976, %i.aa
  %6 = lshr i64 1152921504606846975, %i.aa
  %i.ab = add nuw nsw i64 %2, %6
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.de = sub nuw nsw i64 60, %i.cz
  %5 = ashr exact i64 -1152921504606846976, %i.cz
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.ao = sub nuw nsw i64 60, %i.aj
  %12 = ashr exact i64 -1152921504606846976, %i.aj
