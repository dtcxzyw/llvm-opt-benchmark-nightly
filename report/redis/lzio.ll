...
begin_hunk_0_@luaZ_lookahead:bb.a
  ...
  %i.j = call ptr %i.g(ptr noundef %i.e, ptr noundef %i.i, ptr noundef nonnull %i.a) #7 ; 3 uses
...
begin_hunk_1_@luaZ_read:bb.a
  ...
  %i.k = call ptr %i.i(ptr noundef %i.h, ptr noundef %i.j, ptr noundef nonnull %i.a) #7 ; 3 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  store ptr %i.i, ptr %1, align 8, !tbaa !21
  store i64 %spec.store.select, ptr %i.a, align 8, !tbaa !19
  br label %bb.f
...
!18 = !{!6, !6, i64 0}
!19 = !{!20, !10, i64 16}
!20 = !{!"Mbuffer", !11, i64 0, !10, i64 8, !10, i64 16}
!21 = !{!20, !11, i64 0}
end_hunk_5
