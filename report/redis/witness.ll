Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/redis/original/witness?download=true
inline.NumInlined: 5
inline.NumDeleted: 4
begin_hunk_0
...
define hidden void @je_witness_init(ptr nofree noundef writeonly captures(none) initializes((0, 12), (16, 32)) %0, ptr noundef %1, i32 noundef %2, ptr noundef %3, ptr noundef %4) local_unnamed_addr #0 {
bb.a:
...
define internal void @witness_lock_error_impl(ptr nofree noundef readonly captures(none) %0, ptr nofree noundef readonly captures(none) %1) #1 {
bb.a:
...
; Function Attrs: cold noreturn nounwind uwtable
define internal void @witness_owner_error_impl(ptr nofree noundef readonly captures(none) %0) #1 {
bb.a:
...
; Function Attrs: cold noreturn nounwind uwtable
define internal void @witness_not_owner_error_impl(ptr nofree noundef readonly captures(none) %0) #1 {
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !11
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.c = load i32, ptr %i.b, align 8, !tbaa !17
...
; Function Attrs: cold noreturn nounwind uwtable
define internal void @witness_depth_error_impl(ptr nofree noundef readonly captures(none) %0, i32 noundef %1, i32 noundef %2) #1 {
bb.a:
  %.not = icmp eq i32 %2, 1
...
define hidden void @je_witnesses_cleanup(ptr nofree noundef readnone captures(none) %0) local_unnamed_addr #2 {
bb.a:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define hidden void @je_witness_prefork(ptr nofree noundef readnone captures(none) %0) local_unnamed_addr #2 {
bb.a:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define hidden void @je_witness_postfork_parent(ptr nofree noundef readnone captures(none) %0) local_unnamed_addr #2 {
bb.a:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define hidden void @je_witness_postfork_child(ptr nofree noundef readnone captures(none) %0) local_unnamed_addr #2 {
bb.a:
  ret void
}
...
define internal fastcc void @witness_print_witnesses(ptr nofree noundef readonly captures(none) %0) unnamed_addr #4 {
bb.a:
