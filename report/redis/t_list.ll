...
listTypeLength.exit:                              ; preds = %bb.v, %bb.w
  %.0.i = phi i64 [ %i.cd, %bb.v ], [ %i.cg, %bb.w ] ; 2 uses
...
begin_hunk_1_@lposCommand:bb.a
  ...
  %.078115.us138 = phi i64 [ %i.dy, %bb.ak ], [ 0, %.lr.ph118.split.split.us.preheader ] ; 2 uses
...
.lr.ph118.split.split:                            ; preds = %.lr.ph118.split.split.preheader, %bb.ap
  ...
  %.078115 = phi i64 [ %i.em, %bb.ap ], [ 0, %.lr.ph118.split.split.preheader ] ; 4 uses
...
.critedge.loopexit193:                            ; preds = %.critedge.loopexit193split, %..critedge.loopexit193_crit_edge
  %.175.ph = phi i64 [ %lsr.iv203.lcssa205, %..critedge.loopexit193_crit_edge ], [ -1, %.critedge.loopexit193split ]
  %.2.ph = phi i64 [ %i.dt, %..critedge.loopexit193_crit_edge ], [ %.2.ph.ph, %.critedge.loopexit193split ]
  br label %.critedge
...
..critedge.loopexit194_crit_edge:                 ; preds = %bb.ao
  %.078115.lcssa202 = phi i64 [ %.078115, %bb.ao ]
  br label %.critedge.loopexit194

.critedge.loopexit194:                            ; preds = %.critedge.loopexit194split, %..critedge.loopexit194_crit_edge
  %.175.ph195 = phi i64 [ %.078115.lcssa202, %..critedge.loopexit194_crit_edge ], [ -1, %.critedge.loopexit194split ]
  %.2.ph196 = phi i64 [ %i.eh, %..critedge.loopexit194_crit_edge ], [ %.2.ph196.ph, %.critedge.loopexit194split ]
  br label %.critedge
