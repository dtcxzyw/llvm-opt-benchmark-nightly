...
bb.e:                                             ; preds = %bb.c
  ...
  %i.k = load ptr, ptr %i.j, align 8, !tbaa !14   ; 7 uses
...
bb.g:                                             ; preds = %bb.f
  %i.r = load i32, ptr getelementptr inbounds nuw (i8, ptr @server, i64 8032), align 8, !tbaa !21
...
bb.h:                                             ; preds = %bb.g
  ...
  store i64 %i.s, ptr %i.a, align 8, !tbaa !17
  %i.t = load i32, ptr %i.b, align 4, !tbaa !9
  %i.u = lshr i32 %i.t, 1
  store i32 %i.u, ptr %i.b, align 4, !tbaa !9
  br label %bb.i
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  %i.y = load i64, ptr %i.x, align 8, !tbaa !53   ; 2 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %.pre19.i = load ptr, ptr %i.k, align 8, !tbaa !19 ; 2 uses
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  store ptr %i.ai, ptr %i.j, align 8, !tbaa !14
  ...
  store i64 %i.al, ptr %i.aj, align 8, !tbaa !17
...
bb.r:                                             ; preds = %.lr.ph.i, %.lr.ph.i
  ...
  %i.bc = load ptr, ptr %i.bb, align 8, !tbaa !14 ; 5 uses
  %i.bd = getelementptr i8, ptr %i.bc, i64 -1
  %.val.i.i = load i8, ptr %i.bd, align 1, !tbaa !59 ; 2 uses
...
bb.u:                                             ; preds = %bb.r
  ...
  %i.bl = load i16, ptr %i.bk, align 1, !tbaa !60
...
bb.y:                                             ; preds = %._crit_edge.i, %bb.q
  %.029.i = phi i64 [ %i.au, %._crit_edge.i ], [ 0, %bb.q ]
  %.2.i = phi i64 [ %.0.lcssa.i, %._crit_edge.i ], [ 0, %bb.q ]
  %i.bt = load i32, ptr getelementptr inbounds nuw (i8, ptr @server, i64 8032), align 8, !tbaa !21
  ...
  %i.by = load ptr, ptr %i.bu, align 8, !tbaa !14
  %i.bz = tail call i64 @lpLength(ptr noundef %i.by) #8
  %i.ca = add i64 %i.bz, %.029.i
  %i.cb = trunc i64 %i.ca to i32
  %i.cc = tail call i32 @quicklistNodeExceedsLimit(i32 noundef %i.bt, i64 noundef %i.bx, i32 noundef %i.cb) #8
...
bb.ab:                                            ; preds = %bb.aa, %bb.z
  %i.cd = load i32, ptr getelementptr inbounds nuw (i8, ptr @server, i64 8032), align 8, !tbaa !21
  %i.ce = load i32, ptr getelementptr inbounds nuw (i8, ptr @server, i64 8036), align 4, !tbaa !65
  %i.cf = tail call ptr @quicklistNew(i32 noundef %i.cd, i32 noundef %i.ce) #8 ; 2 uses
  %i.cg = load ptr, ptr %i.bu, align 8, !tbaa !14
  %i.ch = tail call i64 @lpLength(ptr noundef %i.cg) #8
  %.not37.i = icmp eq i64 %i.ch, 0
  %i.ci = load ptr, ptr %i.bu, align 8, !tbaa !14 ; 2 uses
  br i1 %.not37.i, label %bb.ad, label %bb.ac

bb.ac:                                            ; preds = %bb.ab
  tail call void @quicklistAppendListpack(ptr noundef %i.cf, ptr noundef %i.ci) #8
  br label %bb.ae

bb.ad:                                            ; preds = %bb.ab
  tail call void @lpFree(ptr noundef %i.ci) #8
  br label %bb.ae

bb.ae:                                            ; preds = %bb.ad, %bb.ac
  store ptr %i.cf, ptr %i.bu, align 8, !tbaa !14
  %i.cj = load i64, ptr %0, align 8
  %i.ck = and i64 %i.cj, -241
  %i.cl = or disjoint i64 %i.ck, 144
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.u = load ptr, ptr %i.t, align 8, !tbaa !14   ; 6 uses
  %i.v = getelementptr i8, ptr %i.u, i64 -1
  %.val.i = load i8, ptr %i.v, align 1, !tbaa !59 ; 2 uses
  %i.w = and i8 %.val.i, 7
