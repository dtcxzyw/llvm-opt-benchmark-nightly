...
begin_hunk_0_@io_close:bb.a
  ...
  %i.h = tail call i32 %i.g(ptr noundef %0) #9, !inline_history !11
  ret i32 %i.h
}
...
begin_hunk_9_@g_read:bb.a
  ...
  br i1 %i.bc, label %bb.d, label %.loopexit, !llvm.loop !21
