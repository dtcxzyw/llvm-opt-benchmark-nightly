...
bb.c:                                             ; preds = %bb.b
  ...
  %i.h = and i32 %2, 4
  %.not29 = icmp eq i32 %i.h, 0                   ; 2 uses
  %i.i = and i32 %2, 2
  %.not30 = icmp eq i32 %i.i, 0                   ; 2 uses
  br i1 %.not28, label %bb.e, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.j = icmp sle i64 %1, %0
  %or.cond39 = or i1 %i.j, %.not29
  %.1 = select i1 %or.cond39, i32 %spec.select, i32 1
  %i.k = icmp sge i64 %1, %0
  %or.cond40 = or i1 %i.k, %.not30
  br i1 %or.cond40, label %select.unfold, label %.critedge

bb.e:                                             ; preds = %bb.c
  %i.l = icmp ule i64 %1, %0
  %or.cond41 = or i1 %i.l, %.not29
  %.2 = select i1 %or.cond41, i32 %spec.select, i32 1
  %i.m = icmp uge i64 %1, %0
  %or.cond42 = or i1 %i.m, %.not30
...
end_hunk_0
begin_hunk_1_@UnityAssertEqualDoubleArray:bb.a
  unreachable
