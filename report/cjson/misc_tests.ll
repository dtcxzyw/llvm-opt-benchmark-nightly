...
begin_hunk_0_@parse_string:bb.a
  ...
  %i.bm = load i8, ptr %i.bl, align 1, !tbaa !40  ; 4 uses
...
bb.i:                                             ; preds = %bb.v, %bb.h
  ...
  %i.ac = tail call ptr %.val(i64 noundef 64) #29, !inline_history !38 ; 11 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  store ptr %.070, ptr %i.ae, align 8, !tbaa !56
  br label %bb.l
...
bb.u:                                             ; preds = %.lr.ph.i195
  ...
  store i64 %i.by, ptr %i.e, align 8, !tbaa !39
...
bb.w:                                             ; preds = %bb.v
  %i.ce = load i64, ptr %i.a, align 8, !tbaa !54
  %i.cf = add i64 %i.ce, -1
  store i64 %i.cf, ptr %i.a, align 8, !tbaa !54
  %i.cg = getelementptr inbounds nuw i8, ptr %.172, i64 8
  store ptr %i.ac, ptr %i.cg, align 8, !tbaa !56
  br label %bb.x
...
bb.x:                                             ; preds = %.thread114, %bb.w
  ...
  store i32 64, ptr %i.ci, align 8, !tbaa !15
  %i.cj = getelementptr inbounds nuw i8, ptr %0, i64 16
  store ptr %.374118, ptr %i.cj, align 8, !tbaa !28
  %i.ck = add nuw i64 %i.ch, 1
  store i64 %i.ck, ptr %i.e, align 8, !tbaa !39
  br label %.critedge.thread119
