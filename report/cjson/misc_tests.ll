...
.lr.ph.preheader.i:                               ; preds = %bb.ai, %bb.ah, %bb.ag, %.thread83.i
  ...
  store i8 %i.cq, ptr %i.cr, align 1, !tbaa !53
...
.lr.ph.i.1:                                       ; preds = %.lr.ph.preheader.i
  ...
  store i8 %i.cx, ptr %i.cy, align 1, !tbaa !53
...
.lr.ph.i.2:                                       ; preds = %.lr.ph.i.1
  ...
  store i8 %i.dd, ptr %i.de, align 1, !tbaa !53
...
utf16_literal_to_utf8.exit:                       ; preds = %bb.aj, %bb.ak
  ...
  store i8 %i.di, ptr %.090119, align 1, !tbaa !53
...
.critedge._crit_edge:                             ; preds = %.critedge, %.critedge.preheader
  ...
  store i32 16, ptr %i.dm, align 8, !tbaa !36
  %i.dn = getelementptr inbounds nuw i8, ptr %0, i64 32
  store ptr %i.u, ptr %i.dn, align 8, !tbaa !37
  %i.do = load ptr, ptr %1, align 8, !tbaa !48
...
utf16_literal_to_utf8.exit.thread:                ; preds = %bb.ae, %bb.ad, %bb.ac, %bb.ab, %parse_hex4.exit.i, %bb.ai, %bb.o, %bb.h, %bb.g
  ...
  tail call void %i.dt(ptr noundef nonnull %i.u) #29
  br label %.thread103
...
.thread103:                                       ; preds = %bb.b, %bb.d, %.preheader, %bb.e, %bb.a, %utf16_literal_to_utf8.exit.thread
  ...
  %i.du = load ptr, ptr %1, align 8, !tbaa !48
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.h = load i64, ptr %i.g, align 8, !tbaa !49   ; 6 uses
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %i.ah = load i64, ptr %i.g, align 8, !tbaa !49  ; 4 uses
...
bb.o:                                             ; preds = %buffer_skip_whitespace.exit97
  ...
  %.pre159 = load i64, ptr %i.g, align 8, !tbaa !49 ; 9 uses
...
bb.p:                                             ; preds = %.lr.ph.i99
  ...
  store i64 %i.az, ptr %i.e, align 8, !tbaa !52
...
.critedge.thread.i101:                            ; preds = %bb.p, %.critedge.i100
  ...
  store i64 %i.ba, ptr %i.e, align 8, !tbaa !52
...
buffer_skip_whitespace.exit103:                   ; preds = %bb.o, %.critedge.i100, %.critedge.thread.i101
  ...
  store ptr %i.bd, ptr %i.be, align 8, !tbaa !44
...
bb.s:                                             ; preds = %.lr.ph.i105
  ...
  store i64 %i.bo, ptr %i.e, align 8, !tbaa !52
...
.critedge.thread.i107:                            ; preds = %bb.s, %.critedge.i106
  ...
  store i64 %i.bp, ptr %i.e, align 8, !tbaa !52
...
bb.t:                                             ; preds = %buffer_skip_whitespace.exit109
  %i.br = load ptr, ptr %1, align 8, !tbaa !48    ; 3 uses
  %i.bs = icmp ne ptr %i.br, null
  %.pre232 = load i64, ptr %i.e, align 8, !tbaa !52 ; 3 uses
  %.pre233 = load i64, ptr %i.g, align 8, !tbaa !49 ; 5 uses
...
bb.u:                                             ; preds = %.lr.ph.i195
  ...
  store i64 %i.by, ptr %i.e, align 8, !tbaa !52
...
.critedge.thread.i197:                            ; preds = %bb.u, %.critedge.i196
  ...
  store i64 %i.bz, ptr %i.e, align 8, !tbaa !52
...
bb.v:                                             ; preds = %buffer_skip_whitespace.exit199
  %i.cc = getelementptr inbounds nuw i8, ptr %i.br, i64 %i.ca
  %i.cd = load i8, ptr %i.cc, align 1, !tbaa !53
  switch i8 %i.cd, label %.critedge.thread123 [
    i8 44, label %bb.i
    i8 125, label %bb.w
  ]

bb.w:                                             ; preds = %bb.v
  %i.ce = load i64, ptr %i.a, align 8, !tbaa !62
  %i.cf = add i64 %i.ce, -1
  store i64 %i.cf, ptr %i.a, align 8, !tbaa !62
  %i.cg = getelementptr inbounds nuw i8, ptr %.172, i64 8
  store ptr %i.ac, ptr %i.cg, align 8, !tbaa !63
  br label %bb.x

bb.x:                                             ; preds = %.thread114, %bb.w
  %i.ch = phi i64 [ %i.u, %.thread114 ], [ %i.ca, %bb.w ]
  %.374118 = phi ptr [ null, %.thread114 ], [ %.172, %bb.w ]
  %i.ci = getelementptr inbounds nuw i8, ptr %0, i64 24
  store i32 64, ptr %i.ci, align 8, !tbaa !36
  %i.cj = getelementptr inbounds nuw i8, ptr %0, i64 16
  store ptr %.374118, ptr %i.cj, align 8, !tbaa !43
  %i.ck = add nuw i64 %i.ch, 1
  store i64 %i.ck, ptr %i.e, align 8, !tbaa !52
  br label %.critedge.thread119
...
bb.a:
  %i.a = load i8, ptr %0, align 1, !tbaa !53      ; 4 uses
...
bb.d:                                             ; preds = %bb.c, %bb.b, %bb.a
  ...
  %i.h = load i8, ptr %i.g, align 1, !tbaa !53    ; 4 uses
...
bb.g:                                             ; preds = %bb.d, %bb.e, %bb.f
  ...
  %i.r = load i8, ptr %i.q, align 1, !tbaa !53    ; 4 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load i64, ptr %i.c, align 8, !tbaa !66   ; 3 uses
