...
bb.z:                                             ; preds = %bb.q
  ...
  %i.gd = load i64, ptr %i.bv, align 8, !noalias !122, !noundef !4 ; 3 uses
...
.lr.ph89.i.us:                                    ; preds = %bb.z
  %4 = trunc i64 %i.gd to i32                     ; 2 uses
  %5 = add i32 %4, 8
  %.98.neg91.i.us = select i1 %i.gl, i32 27, i32 29
  %6 = add i32 %5, %.98.neg91.i.us
  %i.gw = and i32 %6, 31
...
bb.z:                                             ; preds = %bb.q
  ...
  %.sroa.5.0.extract.shift.i.us = lshr i48 %.sroa.028.0.copyload.us, 32
  %.sroa.5.0.extract.trunc.i.us = trunc i48 %.sroa.5.0.extract.shift.i.us to i8
  %i.gg = load i64, ptr %i.bv, align 8, !noalias !232, !noundef !4 ; 3 uses
...
.lr.ph89.i.us:                                    ; preds = %bb.z
  %4 = trunc i64 %i.gg to i32                     ; 2 uses
  %5 = add i32 %4, 8
  %.98.neg91.i.us = select i1 %i.go, i32 27, i32 29
  %6 = add i32 %5, %.98.neg91.i.us
  %i.gz = and i32 %6, 31
