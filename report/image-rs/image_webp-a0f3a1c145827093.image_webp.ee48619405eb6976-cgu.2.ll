...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %i.q, align 4, !alias.scope !7
  %wide.load52 = load <4 x i32>, ptr %i.r, align 4, !alias.scope !7
  %i.s = getelementptr inbounds nuw i8, ptr %i.p, i64 4 ; 2 uses
  %wide.load53 = load <4 x i8>, ptr %i.p, align 1, !alias.scope !10, !noalias !7
  %wide.load54 = load <4 x i8>, ptr %i.s, align 1, !alias.scope !10, !noalias !7
  ...
  store <4 x i8> %i.ab, ptr %i.p, align 1, !alias.scope !10, !noalias !7
  store <4 x i8> %i.ac, ptr %i.s, align 1, !alias.scope !10, !noalias !7
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ad = icmp eq i64 %index.next, %n.vec
  br i1 %i.ad, label %middle.block, label %vector.body, !llvm.loop !12
...
vector.body67:                                    ; preds = %vector.body67, %vector.ph65
  ...
  %wide.load69 = load <4 x i32>, ptr %i.bv, align 4, !alias.scope !16
  %wide.load70 = load <4 x i32>, ptr %i.bw, align 4, !alias.scope !16
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bu, i64 4 ; 2 uses
  %wide.load71 = load <4 x i8>, ptr %i.bu, align 1, !alias.scope !19, !noalias !16
  %wide.load72 = load <4 x i8>, ptr %i.bx, align 1, !alias.scope !19, !noalias !16
  ...
  store <4 x i8> %i.cg, ptr %i.bu, align 1, !alias.scope !19, !noalias !16
  store <4 x i8> %i.ch, ptr %i.bx, align 1, !alias.scope !19, !noalias !16
  %index.next73 = add nuw i64 %index68, 8         ; 2 uses
  %i.ci = icmp eq i64 %index.next73, %n.vec66
  br i1 %i.ci, label %middle.block74, label %vector.body67, !llvm.loop !21
...
vector.body89:                                    ; preds = %vector.body89, %vector.ph87
  ...
  %wide.load91 = load <4 x i32>, ptr %i.ea, align 4, !alias.scope !23
  %wide.load92 = load <4 x i32>, ptr %i.eb, align 4, !alias.scope !23
  %i.ec = getelementptr inbounds nuw i8, ptr %i.dz, i64 4 ; 2 uses
  %wide.load93 = load <4 x i8>, ptr %i.dz, align 1, !alias.scope !26, !noalias !23
  %wide.load94 = load <4 x i8>, ptr %i.ec, align 1, !alias.scope !26, !noalias !23
  ...
  store <4 x i8> %i.el, ptr %i.dz, align 1, !alias.scope !26, !noalias !23
  store <4 x i8> %i.em, ptr %i.ec, align 1, !alias.scope !26, !noalias !23
  %index.next95 = add nuw i64 %index90, 8         ; 2 uses
  %i.en = icmp eq i64 %index.next95, %n.vec88
  br i1 %i.en, label %middle.block96, label %vector.body89, !llvm.loop !28
...
vector.body111:                                   ; preds = %vector.body111, %vector.ph109
  ...
  %wide.load113 = load <4 x i32>, ptr %i.gf, align 4, !alias.scope !30
  %wide.load114 = load <4 x i32>, ptr %i.gg, align 4, !alias.scope !30
  %i.gh = getelementptr inbounds nuw i8, ptr %i.ge, i64 4 ; 2 uses
  %wide.load115 = load <4 x i8>, ptr %i.ge, align 1, !alias.scope !33, !noalias !30
  %wide.load116 = load <4 x i8>, ptr %i.gh, align 1, !alias.scope !33, !noalias !30
  ...
  store <4 x i8> %i.gq, ptr %i.ge, align 1, !alias.scope !33, !noalias !30
  store <4 x i8> %i.gr, ptr %i.gh, align 1, !alias.scope !33, !noalias !30
  %index.next117 = add nuw i64 %index112, 8       ; 2 uses
  %i.gs = icmp eq i64 %index.next117, %n.vec110
  br i1 %i.gs, label %middle.block118, label %vector.body111, !llvm.loop !35
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  tail call void @_RNvNtNtCsj6eKBz9Db1c_4core5slice5index16slice_index_fail(i64 noundef %i.d, i64 noundef %.sroa.03.0.i, i64 noundef range(i64 0, -9223372036854775808) %2, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) @6) #13, !noalias !37
  unreachable
...
bb.e:                                             ; preds = %.lr.ph40
  ...
  br i1 %.not, label %bb.g, label %.lr.ph.i, !prof !60
...
.lr.ph.i:                                         ; preds = %bb.e
  ...
  tail call void @llvm.memset.p0.i64(ptr nonnull align 1 %i.ah, i8 %storemerge, i64 %2, i1 false), !alias.scope !135, !noalias !138
...
bb.b:                                             ; preds = %bb.a
  tail call void @_RNvNtCsj6eKBz9Db1c_4core9panicking9panic_fmt(ptr noundef nonnull @0, ptr noundef nonnull inttoptr (i64 19 to ptr), ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) @28) #13, !noalias !141
  unreachable
...
bb.h:                                             ; preds = %bb.g
  ...
  br i1 %.not, label %bb.j, label %bb.k, !prof !60
...
bb.k:                                             ; preds = %bb.h
  ...
  %.val.i = load i64, ptr %i.q, align 8, !alias.scope !145, !noalias !148, !noundef !4 ; 9 uses
  %.val6.i = load i64, ptr %i.r, align 8, !alias.scope !145, !noalias !148, !noundef !4 ; 4 uses
...
iter.check:                                       ; preds = %bb.k
  %.val.i.i = load ptr, ptr %i.a, align 8, !alias.scope !150, !noalias !148, !nonnull !4, !noundef !4 ; 6 uses
  %.val1.i.i = load ptr, ptr %i.s, align 8, !alias.scope !150, !noalias !148, !nonnull !4, !noundef !4 ; 6 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.aj, align 1, !noalias !153
  ...
  store <16 x i8> %i.ao, ptr %i.ai, align 1, !alias.scope !154, !noalias !153
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.ap = icmp eq i64 %index.next, %n.vec
  br i1 %i.ap, label %middle.block, label %vector.body, !llvm.loop !159
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load50 = load <4 x i8>, ptr %i.as, align 1, !noalias !153
  ...
  store <4 x i8> %i.ax, ptr %i.ar, align 1, !alias.scope !154, !noalias !153
  %index.next51 = add nuw i64 %index49, 4         ; 2 uses
  %i.ay = icmp eq i64 %index.next51, %n.vec46
  br i1 %i.ay, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !161
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader
  ...
  %.val8.i.prol = load i8, ptr %i.bf, align 1, !noalias !153, !noundef !4
  ...
  store i8 %i.bj, ptr %i.be, align 1, !alias.scope !154, !noalias !153
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph, %vec.epilog.scalar.ph.preheader.new
  ...
  %.val8.i = load i8, ptr %i.bn, align 1, !noalias !153, !noundef !4
  ...
  store i8 %i.br, ptr %i.bm, align 1, !alias.scope !154, !noalias !153
  ...
  %.val8.i.1 = load i8, ptr %i.bu, align 1, !noalias !153, !noundef !4
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter7IterMuthEINtBZ_4IterhEEINtB5_7ZipImplBW_B1r_E4nextCsksn9slvsHfS_10image_webp.exit.preheader, label %vec.epilog.ph, !prof !124
