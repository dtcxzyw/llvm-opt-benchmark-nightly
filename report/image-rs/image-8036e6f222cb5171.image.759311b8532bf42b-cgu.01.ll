...
bb.fp:                                            ; preds = %bb.fn
  ...
  %i.ada = and i64 %i.acl, 63
  %8 = getelementptr inbounds nuw [8 x i8], ptr @10, i64 %i.ada
  %i.adb = load i64, ptr %8, align 8, !noundef !5
...
bb.dd:                                            ; preds = %bb.db
  ...
  %i.or = and i64 %i.oa, 63
  %5 = getelementptr inbounds nuw [8 x i8], ptr @10, i64 %i.or
  %i.os = load i64, ptr %5, align 8, !noundef !5
...
.preheader1358.a:                                 ; preds = %bb.cj, %bb.ft
  ...
  %5 = getelementptr inbounds nuw [8 x i8], ptr @10, i64 %i.qk
  %i.ql = load i64, ptr %5, align 8, !noundef !5
...
bb.fv:                                            ; preds = %.loopexit1359.a
  ...
  %6 = getelementptr inbounds nuw [8 x i8], ptr @10, i64 %i.acl
  %i.acm = load i64, ptr %6, align 8, !noundef !5
...
bb.io:                                            ; preds = %.lr.ph1762, %_RINvMNtCsaXAyoiiLu3Y_9zune_jpeg9bitstreamNtB3_9BitStream6refillINtNtNtNtCslN0b76tEcC3_9zune_core10bytestream6reader14no_std_readers7ZCursorINtNtCs4wP2HXfJTCR_5alloc3vec3VechEEECsa5QsYiPB8Gl_5image.exit.thread
  ...
  %7 = getelementptr inbounds nuw [8 x i8], ptr @10, i64 %i.aot
  %i.aou = load i64, ptr %7, align 8, !noundef !5
