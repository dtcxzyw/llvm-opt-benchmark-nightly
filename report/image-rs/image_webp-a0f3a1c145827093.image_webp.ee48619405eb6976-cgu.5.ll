...
bb.a:
  %i.a = load ptr, ptr %0, align 8, !nonnull !4, !align !231, !noundef !4
...
bb.b:                                             ; preds = %bb.a
  tail call void @_RNvNtNtCsj6eKBz9Db1c_4core9panicking11panic_const23panic_const_div_by_zero(ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @47) #17, !noalias !312
  unreachable
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.h = load i64, ptr %i.b, align 8, !range !74, !noundef !4
  %i.i = trunc nuw i64 %i.h to i1
  %i.j = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %i.k = load i64, ptr %i.j, align 8, !range !75, !noundef !4 ; 3 uses
  %i.l = getelementptr inbounds nuw i8, ptr %i.b, i64 16 ; 2 uses
  br i1 %i.i, label %bb.d, label %_RNvMs_NtCs4wP2HXfJTCR_5alloc3vecINtB4_3VecAhj4_E7reserveCsksn9slvsHfS_10image_webp.exit.i.i, !prof !11
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %next.gep, align 1, !alias.scope !320, !noalias !323
  %wide.load9 = load <4 x i32>, ptr %i.ad, align 1, !alias.scope !320, !noalias !323
  %i.ae = getelementptr inbounds nuw [4 x i8], ptr %i.n, i64 %index ; 2 uses
  %i.af = getelementptr inbounds nuw i8, ptr %i.ae, i64 16
  store <4 x i32> %wide.load, ptr %i.ae, align 1, !noalias !338
  store <4 x i32> %wide.load9, ptr %i.af, align 1, !noalias !338
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ag = icmp eq i64 %index.next, %n.vec
  br i1 %i.ag, label %middle.block, label %vector.body, !llvm.loop !343
...
.lr.ph.split.i.i.i.i.i:                           ; preds = %.lr.ph.i.i.i.i.i
  ...
  invoke void @_RNvNtCsj6eKBz9Db1c_4core6result13unwrap_failed(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @7, i64 noundef 43, ptr noundef nonnull %i.a, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @6, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @4) #17
          to label %.noexc.i.i.i.i.i unwind label %.body, !noalias !345
...
.body:                                            ; preds = %.lr.ph.split.i.i.i.i.i
  %i.ao = landingpad { ptr, i32 }
          cleanup
  store i64 0, ptr %i.r, align 8, !alias.scope !346, !noalias !345
...
.loopexit:                                        ; preds = %_RNCINvNtNtNtCsj6eKBz9Db1c_4core4iter8adapters3map8map_foldRShAhj4_uNCNvNtCsksn9slvsHfS_10image_webp18lossless_transform30apply_color_indexing_transform0NCINvNvNtNtNtB8_6traits8iterator8Iterator8for_each4callBX_NCINvMsk_NtCs4wP2HXfJTCR_5alloc3vecINtB3v_3VecBX_E14extend_trustedINtB4_3MapINtNtNtBa_5slice4iter11ChunksExacthEB13_EE0E0E0B19_.exit.us.i.i.i.i.i, %middle.block, %_RNvMs_NtCs4wP2HXfJTCR_5alloc3vecINtB4_3VecAhj4_E7reserveCsksn9slvsHfS_10image_webp.exit.i.i
  ...
  store i64 %.val8.i.i.i.i.i, ptr %i.r, align 8, !alias.scope !346, !noalias !345
...
bb.a:
  ...
  %i.g = load i64, ptr %i.a, align 8, !range !74, !noundef !4
  %i.h = trunc nuw i64 %i.g to i1
  %i.i = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  %i.j = load i64, ptr %i.i, align 8, !range !75, !noundef !4 ; 3 uses
  %i.k = getelementptr inbounds nuw i8, ptr %i.a, i64 16 ; 2 uses
  br i1 %i.h, label %bb.b, label %_RNvMs_NtCs4wP2HXfJTCR_5alloc3vecINtB4_3VecTjmEE7reserveCsksn9slvsHfS_10image_webp.exit.i.i, !prof !11
...
.preheader.i.i:                                   ; preds = %.preheader.i.i, %.preheader.i.i.preheader.new
  ...
  %.val15.i.i.i.i.i.i = load i32, ptr %i.s, align 4, !noalias !349, !noundef !4
  %i.t = getelementptr inbounds nuw [16 x i8], ptr %i.m, i64 %i.q ; 2 uses
  store i64 %i.r, ptr %i.t, align 8, !noalias !364
  %i.u = getelementptr inbounds nuw i8, ptr %i.t, i64 8
  store i32 %.val15.i.i.i.i.i.i, ptr %i.u, align 8, !noalias !364
  %i.v = or disjoint i64 %i.q, 1                  ; 2 uses
  %i.w = add i64 %i.r, 1
  %i.x = getelementptr inbounds nuw [4 x i8], ptr %.val, i64 %i.v
  %.val15.i.i.i.i.i.i.1 = load i32, ptr %i.x, align 4, !noalias !349, !noundef !4
  %i.y = getelementptr inbounds nuw [16 x i8], ptr %i.m, i64 %i.v ; 2 uses
  store i64 %i.w, ptr %i.y, align 8, !noalias !364
  %i.z = getelementptr inbounds nuw i8, ptr %i.y, i64 8
  store i32 %.val15.i.i.i.i.i.i.1, ptr %i.z, align 8, !noalias !364
...
.preheader.i.i.epil.preheader:                    ; preds = %.loopexit.loopexit.unr-lcssa, %.preheader.i.i.preheader
  ...
  %.val15.i.i.i.i.i.i.epil = load i32, ptr %i.ac, align 4, !noalias !349, !noundef !4
  %i.ad = getelementptr inbounds nuw [16 x i8], ptr %i.m, i64 %.epil.init ; 2 uses
  store i64 %.epil.init7, ptr %i.ad, align 8, !noalias !364
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 8
  store i32 %.val15.i.i.i.i.i.i.epil, ptr %i.ae, align 8, !noalias !364
  br label %.loopexit
