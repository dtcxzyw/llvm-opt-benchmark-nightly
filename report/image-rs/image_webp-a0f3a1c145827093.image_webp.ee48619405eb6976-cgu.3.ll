...
.lr.ph867.preheader:                              ; preds = %.lr.ph869
  ...
  %8 = mul nsw i64 %i.az, -4                      ; 2 uses
  %scevgep3224 = getelementptr i8, ptr %1, i64 %8
  ...
  %invariant.op4620 = add i64 %i.bf, 4
...
.lr.ph.i39.preheader:                             ; preds = %.preheader.split.i38
  ...
  %9 = sub i64 %i.fb, %i.bf
  %umax3074 = call i64 @llvm.umax.i64(i64 %2, i64 %9)
  %i.gq = add i64 %umax3074, %i.bf
...
.lr.ph.i44.preheader:                             ; preds = %.preheader.split.i43
  ...
  %i.hy = add i64 %umax3100, %invariant.op4624
...
.lr.ph.i49.preheader:                             ; preds = %.preheader.split.i48
  ...
  %.reass4640 = add i64 %i.fb, %invariant.op
  %umax3126 = call i64 @llvm.umax.i64(i64 %2, i64 %.reass4640)
  %i.jg = add i64 %umax3126, %invariant.op4620
...
.lr.ph.i57.preheader:                             ; preds = %.preheader.split.i56
  ...
  %.reass4638 = add i64 %i.fb, -4                 ; 2 uses
  %10 = sub i64 %.reass4638, %i.bf
  %umax3161 = call i64 @llvm.umax.i64(i64 %2, i64 %10)
  %i.og = add i64 %umax3161, %invariant.op4616
  %i.oh = sub i64 %i.og, %i.fb
  %umax3162 = call i64 @llvm.umax.i64(i64 %2, i64 %.reass4638)
...
bb.bk:                                            ; preds = %.lr.ph.i57
  %.reass.reass.i59.reass.reass.reass = add i64 %.sroa.0.015.i, %invariant.op4637 ; 3 uses
...
.lr.ph.i75.preheader:                             ; preds = %.preheader.split.i73
  ...
  %i.ve = add i64 %umax3200, %invariant.op4614
  %i.vf = sub i64 %i.ve, %i.fb
  %11 = sub i64 %i.fb, %i.bf
  %umax3201 = call i64 @llvm.umax.i64(i64 %2, i64 %11)
  %i.vg = add i64 %umax3201, %i.bf
...
.lr.ph.i80.preheader:                             ; preds = %.preheader.split.i78
  ...
  %i.xh = add i64 %umax3239, %invariant.op4610
  %i.xi = sub i64 %i.xh, %i.fb
  %i.xj = sub i64 %i.fb, %i.bf
  %umax3240 = call i64 @llvm.umax.i64(i64 %2, i64 %i.xj)
  %i.xk = add i64 %umax3240, %i.bf
