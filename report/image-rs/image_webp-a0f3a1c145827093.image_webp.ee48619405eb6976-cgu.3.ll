...
_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResulttNtNtNtB4_3num5error15TryFromIntErrorE6unwrapCsksn9slvsHfS_10image_webp.exit: ; preds = %bb.a
  ...
  %i.az = zext i16 %3 to i64                      ; 12 uses
...
.lr.ph869:                                        ; preds = %.loopexit168
  ...
  %i.bn = and i8 %5, 63
  %i.bo = zext nneg i8 %i.bn to i64               ; 16 uses
...
.lr.ph867:                                        ; preds = %.lr.ph867.preheader, %..loopexit_crit_edge
  ...
  %i.es = mul nuw nsw i64 %.sroa.012.0868, %i.az  ; 9 uses
  br label %bb.f

bb.f:                                             ; preds = %.lr.ph867, %_RNvNtCsksn9slvsHfS_10image_webp18lossless_transform27apply_predictor_transform_0.exit
  %.sroa.014.0866 = phi i64 [ 0, %.lr.ph867 ], [ %i.et, %_RNvNtCsksn9slvsHfS_10image_webp18lossless_transform27apply_predictor_transform_0.exit ] ; 16 uses
  %8 = shl i64 %.sroa.014.0866, %i.bo
  %umax3248 = call i64 @llvm.umax.i64(i64 %8, i64 1)
  %9 = add i64 %i.es, %umax3248
  %10 = shl i64 %9, 2
  %scevgep3249 = getelementptr i8, ptr %scevgep3235, i64 %10
  %11 = shl i64 %.sroa.014.0866, %i.bo
  %umax3211 = call i64 @llvm.umax.i64(i64 %11, i64 1) ; 2 uses
  %12 = add i64 %i.es, %umax3211
  %13 = shl i64 %12, 2                            ; 8 uses
  %scevgep3212 = getelementptr i8, ptr %1, i64 %13 ; 2 uses
  %14 = add i64 %i.eg, %13
  %umax3214 = call i64 @llvm.umax.i64(i64 %2, i64 %14)
  %15 = add i64 %i.ef, %umax3214
  %16 = sub i64 %15, %13
  %17 = add i64 %i.eh, %13
  %umax3215 = call i64 @llvm.umax.i64(i64 %2, i64 %17)
  %18 = add i64 %i.bf, %umax3215
  %19 = sub i64 %18, %13
  %umin3216 = call i64 @llvm.umin.i64(i64 %16, i64 %19)
  %20 = add nuw i64 %.sroa.014.0866, 1
  %21 = shl i64 %20, %i.bo
  %umin3217 = call i64 @llvm.umin.i64(i64 %21, i64 %i.az)
  %22 = shl nuw nsw i64 %umin3217, 2
  %23 = shl i64 %umax3211, 2
  %24 = xor i64 %23, -1
  %25 = add i64 %22, %24
  %umin3218 = call i64 @llvm.umin.i64(i64 %umin3216, i64 %25)
  %26 = add i64 %umin3218, %13                    ; 3 uses
  %scevgep3219 = getelementptr i8, ptr %scevgep3202, i64 %26 ; 2 uses
  %scevgep3221 = getelementptr i8, ptr %scevgep3208, i64 %13
  %scevgep3223 = getelementptr i8, ptr %scevgep3210, i64 %26
  %scevgep3225 = getelementptr i8, ptr %scevgep3212.a, i64 %13
  %scevgep3227 = getelementptr i8, ptr %scevgep3214, i64 %26
  %27 = shl i64 %.sroa.014.0866, %i.bo
  %umax3174 = call i64 @llvm.umax.i64(i64 %27, i64 1) ; 2 uses
  %28 = add i64 %i.es, %umax3174
  %29 = shl i64 %28, 2                            ; 8 uses
  %scevgep3175 = getelementptr i8, ptr %1, i64 %29 ; 2 uses
  %30 = add i64 %i.eb, %29
  %umax3177 = call i64 @llvm.umax.i64(i64 %2, i64 %30)
  %31 = add i64 %i.ea, %umax3177
  %32 = sub i64 %31, %29
  %33 = add i64 %i.ec, %29
  %umax3178 = call i64 @llvm.umax.i64(i64 %2, i64 %33)
  %34 = add i64 %i.bf, %umax3178
  %35 = sub i64 %34, %29
  %umin3179 = call i64 @llvm.umin.i64(i64 %32, i64 %35)
  %36 = add nuw i64 %.sroa.014.0866, 1
  %37 = shl i64 %36, %i.bo
  %umin3180 = call i64 @llvm.umin.i64(i64 %37, i64 %i.az)
  %38 = shl nuw nsw i64 %umin3180, 2
  %39 = shl i64 %umax3174, 2
  %40 = xor i64 %39, -1
  %41 = add i64 %38, %40
  %umin3181 = call i64 @llvm.umin.i64(i64 %umin3179, i64 %41)
  %42 = add i64 %umin3181, %29                    ; 3 uses
  %scevgep3182 = getelementptr i8, ptr %scevgep3167, i64 %42 ; 2 uses
  %scevgep3184 = getelementptr i8, ptr %scevgep3173, i64 %29
  %scevgep3186 = getelementptr i8, ptr %scevgep3175.a, i64 %42
  %scevgep3188 = getelementptr i8, ptr %scevgep3177, i64 %29
  %scevgep3190 = getelementptr i8, ptr %scevgep3179, i64 %42
  %43 = shl i64 %.sroa.014.0866, %i.bo
  %umax3138 = call i64 @llvm.umax.i64(i64 %43, i64 1) ; 2 uses
  %44 = add i64 %i.es, %umax3138
  %45 = shl i64 %44, 2                            ; 8 uses
  %scevgep3139 = getelementptr i8, ptr %1, i64 %45 ; 2 uses
  %46 = add i64 %i.dy, %45
  %umax3141 = call i64 @llvm.umax.i64(i64 %2, i64 %46)
  %47 = add i64 %i.dx, %umax3141
  %48 = sub i64 %47, %45
  %49 = add nuw i64 %.sroa.014.0866, 1
  %50 = shl i64 %49, %i.bo
  %umin3142 = call i64 @llvm.umin.i64(i64 %50, i64 %i.az)
  %51 = shl nuw nsw i64 %umin3142, 2
  %52 = shl i64 %umax3138, 2
  %53 = xor i64 %52, -1
  %54 = add i64 %51, %53
  %umin3143 = call i64 @llvm.umin.i64(i64 %48, i64 %54)
  %55 = add i64 %45, -4
  %umax3144 = call i64 @llvm.umax.i64(i64 %2, i64 %55)
  %56 = add i64 %umax3144, 4
  %57 = sub i64 %56, %45
  %umin3145 = call i64 @llvm.umin.i64(i64 %umin3143, i64 %57)
  %58 = add i64 %umin3145, %45                    ; 3 uses
  %scevgep3146 = getelementptr i8, ptr %scevgep3133, i64 %58 ; 2 uses
  %scevgep3148 = getelementptr i8, ptr %scevgep3139.a, i64 %45
  %scevgep3150 = getelementptr i8, ptr %scevgep3141, i64 %58
  %scevgep3152 = getelementptr i8, ptr %scevgep3143, i64 %45
  %scevgep3154 = getelementptr i8, ptr %scevgep3145, i64 %58
  %59 = shl i64 %.sroa.014.0866, %i.bo
  %umax3112 = call i64 @llvm.umax.i64(i64 %59, i64 1) ; 2 uses
  %60 = add i64 %i.es, %umax3112
  %61 = shl i64 %60, 2                            ; 5 uses
  %scevgep3113 = getelementptr i8, ptr %1, i64 %61
  %62 = add i64 %i.dv, %61
  %umax3115 = call i64 @llvm.umax.i64(i64 %2, i64 %62)
  %63 = add i64 %i.du, %umax3115
  %64 = sub i64 %63, %61
  %65 = add nuw i64 %.sroa.014.0866, 1
  %66 = shl i64 %65, %i.bo
  %umin3116 = call i64 @llvm.umin.i64(i64 %66, i64 %i.az)
  %67 = shl nuw nsw i64 %umin3116, 2
  %68 = shl i64 %umax3112, 2
  %69 = xor i64 %68, -1
  %70 = add i64 %67, %69
  %umin3117 = call i64 @llvm.umin.i64(i64 %64, i64 %70)
  %71 = add i64 %umin3117, %61                    ; 2 uses
  %scevgep3118 = getelementptr i8, ptr %scevgep3109, i64 %71
  %scevgep3120 = getelementptr i8, ptr %scevgep3113.a, i64 %61
  %scevgep3122 = getelementptr i8, ptr %scevgep3115, i64 %71
  %72 = shl i64 %.sroa.014.0866, %i.bo
  %umax3086 = call i64 @llvm.umax.i64(i64 %72, i64 1) ; 2 uses
  %73 = add i64 %i.es, %umax3086
  %74 = shl i64 %73, 2                            ; 5 uses
  %scevgep3087 = getelementptr i8, ptr %1, i64 %74
  %75 = add i64 %i.ds, %74
  %umax3089 = call i64 @llvm.umax.i64(i64 %2, i64 %75)
  %76 = add i64 %i.dr, %umax3089
  %77 = sub i64 %76, %74
  %78 = add nuw i64 %.sroa.014.0866, 1
  %79 = shl i64 %78, %i.bo
  %umin3090 = call i64 @llvm.umin.i64(i64 %79, i64 %i.az)
  %80 = shl nuw nsw i64 %umin3090, 2
  %81 = shl i64 %umax3086, 2
  %82 = xor i64 %81, -1
  %83 = add i64 %80, %82
  %umin3091 = call i64 @llvm.umin.i64(i64 %77, i64 %83)
  %84 = add i64 %umin3091, %74                    ; 2 uses
  %scevgep3092 = getelementptr i8, ptr %scevgep3085, i64 %84
  %scevgep3094 = getelementptr i8, ptr %scevgep3089, i64 %74
  %scevgep3096 = getelementptr i8, ptr %scevgep3091, i64 %84
  %85 = shl i64 %.sroa.014.0866, %i.bo
  %umax = call i64 @llvm.umax.i64(i64 %85, i64 1) ; 2 uses
  %86 = add i64 %i.es, %umax
  %87 = shl i64 %86, 2                            ; 5 uses
  %scevgep = getelementptr i8, ptr %1, i64 %87
  %88 = add i64 %i.dp, %87
  %umax3067 = call i64 @llvm.umax.i64(i64 %2, i64 %88)
  %89 = add i64 %i.bf, %umax3067
  %90 = sub i64 %89, %87
  %91 = add nuw i64 %.sroa.014.0866, 1
  %92 = shl i64 %91, %i.bo
  %umin = call i64 @llvm.umin.i64(i64 %92, i64 %i.az)
  %93 = shl nuw nsw i64 %umin, 2
  %94 = shl i64 %umax, 2
  %95 = xor i64 %94, -1
  %96 = add i64 %93, %95
  %umin3068 = call i64 @llvm.umin.i64(i64 %90, i64 %96)
  %97 = add i64 %umin3068, %87                    ; 2 uses
  %scevgep3069 = getelementptr i8, ptr %scevgep3066, i64 %97
  %scevgep3071 = getelementptr i8, ptr %scevgep3068, i64 %87
  %scevgep3073 = getelementptr i8, ptr %scevgep3070, i64 %97
...
bb.g:                                             ; preds = %bb.f
  ...
  %..i = call noundef range(i64 1, 0) i64 @llvm.umax.i64(i64 %i.fa, i64 1) ; 8 uses
  %i.fb = add i64 %..i, %i.es
  %i.fc = shl i64 %i.fb, 2                        ; 121 uses
  %i.fd = shl i64 %i.et, %i.bo
  %..i28 = call noundef range(i64 0, 65536) i64 @llvm.umin.i64(i64 range(i64 0, 65536) %i.az, i64 %i.fd) ; 8 uses
...
vector.ph3058:                                    ; preds = %.lr.ph.i33.preheader
  ...
  %load_initial = load <4 x i8>, ptr %scevgep3249, align 1
...
.lr.ph.i39.preheader:                             ; preds = %.preheader.split.i38
  %98 = sub i64 %i.fc, %i.bf
  %99 = call i64 @llvm.umax.i64(i64 %2, i64 %98)
  %100 = add i64 %99, %i.bf
  %101 = sub i64 %100, %i.fc
  %102 = shl nuw nsw i64 %..i28, 2
  %103 = shl i64 %..i, 2
  %104 = xor i64 %103, -1
  %105 = add i64 %102, %104
  %i.gp = call i64 @llvm.umin.i64(i64 %101, i64 %105)
...
vector.memcheck:                                  ; preds = %.lr.ph.i39.preheader
  ...
  %bound1 = icmp ult ptr %scevgep3071, %scevgep3069
...
.lr.ph.i44.preheader:                             ; preds = %.preheader.split.i43
  %.reass4636 = add i64 %i.fc, %invariant.op4622
  %106 = call i64 @llvm.umax.i64(i64 %2, i64 %.reass4636)
  %.reass4638 = add i64 %106, %invariant.op4624
  %107 = sub i64 %.reass4638, %i.fc
  %108 = shl nuw nsw i64 %..i28, 2
  %109 = shl i64 %..i, 2
  %110 = xor i64 %109, -1
  %111 = add i64 %108, %110
  %i.hk = call i64 @llvm.umin.i64(i64 %107, i64 %111)
...
vector.memcheck3083:                              ; preds = %.lr.ph.i44.preheader
  %bound03093 = icmp ult ptr %scevgep3087, %scevgep3096
  %bound13094 = icmp ult ptr %scevgep3094, %scevgep3092
...
.lr.ph.i49.preheader:                             ; preds = %.preheader.split.i48
  %.reass4632 = add i64 %i.fc, %invariant.op4618
  %112 = call i64 @llvm.umax.i64(i64 %2, i64 %.reass4632)
  %.reass4634 = add i64 %112, %invariant.op4620.a
  %113 = sub i64 %.reass4634, %i.fc
  %114 = shl nuw nsw i64 %..i28, 2
  %115 = shl i64 %..i, 2
  %116 = xor i64 %115, -1
  %117 = add i64 %114, %116
  %i.if = call i64 @llvm.umin.i64(i64 %113, i64 %117)
...
vector.memcheck3107:                              ; preds = %.lr.ph.i49.preheader
  %bound03117 = icmp ult ptr %scevgep3113, %scevgep3122
  %bound13118 = icmp ult ptr %scevgep3120, %scevgep3118
...
.lr.ph.i57.preheader:                             ; preds = %.preheader.split.i56
  %118 = add i64 %i.fc, -4                        ; 2 uses
  %119 = sub i64 %118, %i.bf
  %120 = call i64 @llvm.umax.i64(i64 %2, i64 %119)
  %i.ms = add i64 %120, %invariant.op4616
  %121 = sub i64 %i.ms, %i.fc
  %122 = shl nuw nsw i64 %..i28, 2
  %123 = shl i64 %..i, 2
  %124 = xor i64 %123, -1
  %125 = add i64 %122, %124
  %i.mt = call i64 @llvm.umax.i64(i64 %2, i64 %118)
  %i.mu = add i64 %i.mt, 4
  %i.mv = sub i64 %i.mu, %i.fc
  %i.mw = call i64 @llvm.umin.i64(i64 %121, i64 %125)
  %i.mx = call i64 @llvm.umin.i64(i64 %i.mw, i64 %i.mv)
  %i.my = add i64 %i.mx, 1                        ; 3 uses
  %min.iters.check3154 = icmp ult i64 %i.my, 5
...
vector.memcheck3131:                              ; preds = %.lr.ph.i57.preheader
  %bound03147 = icmp ult ptr %scevgep3139, %scevgep3150
  %bound13148 = icmp ult ptr %scevgep3148, %scevgep3146
  %found.conflict3149 = and i1 %bound03147, %bound13148
  %bound03150 = icmp ult ptr %scevgep3139, %scevgep3154
  %bound13151 = icmp ult ptr %scevgep3152, %scevgep3146
...
.lr.ph.i75.preheader:                             ; preds = %.preheader.split.i73
  %.reass4626 = add i64 %i.fc, %invariant.op4612
  %126 = call i64 @llvm.umax.i64(i64 %2, i64 %.reass4626)
  %.reass4628 = add i64 %126, %invariant.op4614
  %127 = sub i64 %.reass4628, %i.fc
  %128 = sub i64 %i.fc, %i.bf
  %i.td = call i64 @llvm.umax.i64(i64 %2, i64 %128)
  %.reass4615 = add i64 %i.td, %i.bf
  %i.te = sub i64 %.reass4615, %i.fc
  %129 = shl nuw nsw i64 %..i28, 2
  %130 = shl i64 %..i, 2
  %131 = xor i64 %130, -1
  %132 = add i64 %129, %131
  %i.tf = call i64 @llvm.umin.i64(i64 %127, i64 %i.te)
  %i.tg = call i64 @llvm.umin.i64(i64 %i.tf, i64 %132)
...
vector.memcheck3165:                              ; preds = %.lr.ph.i75.preheader
  %bound03181 = icmp ult ptr %scevgep3175, %scevgep3186
  %bound13182 = icmp ult ptr %scevgep3184, %scevgep3182
  %found.conflict3183 = and i1 %bound03181, %bound13182
  %bound03184 = icmp ult ptr %scevgep3175, %scevgep3190
  %bound13185 = icmp ult ptr %scevgep3188, %scevgep3182
...
.lr.ph.i80.preheader:                             ; preds = %.preheader.split.i78
  ...
  %133 = call i64 @llvm.umax.i64(i64 %2, i64 %.reass)
  %.reass4624 = add i64 %133, %invariant.op4610
  %134 = sub i64 %.reass4624, %i.fc
  %135 = sub i64 %i.fc, %i.bf
  %i.ur = call i64 @llvm.umax.i64(i64 %2, i64 %135)
  %.reass4611 = add i64 %i.ur, %i.bf
  %i.us = sub i64 %.reass4611, %i.fc
  %136 = shl nuw nsw i64 %..i28, 2
  %137 = shl i64 %..i, 2
  %138 = xor i64 %137, -1
  %139 = add i64 %136, %138
  %i.ut = call i64 @llvm.umin.i64(i64 %134, i64 %i.us)
  %i.uu = call i64 @llvm.umin.i64(i64 %i.ut, i64 %139)
...
vector.memcheck3200:                              ; preds = %.lr.ph.i80.preheader
  %bound03216 = icmp ult ptr %scevgep3212, %scevgep3223
  %bound13217 = icmp ult ptr %scevgep3221, %scevgep3219
  %found.conflict3218 = and i1 %bound03216, %bound13217
  %bound03219 = icmp ult ptr %scevgep3212, %scevgep3227
  %bound13220 = icmp ult ptr %scevgep3225, %scevgep3219
