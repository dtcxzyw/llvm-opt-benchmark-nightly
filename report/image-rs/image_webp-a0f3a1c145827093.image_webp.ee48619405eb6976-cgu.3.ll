...
begin_hunk_0_@_RNvNtCsksn9slvsHfS_10image_webp18lossless_transform25apply_predictor_transform:bb.a
  store i8 %i.aqs, ptr %i.aqn, align 1
  %exitcond.not = icmp eq i64 %i.ek, %i.ba
  br i1 %exitcond.not, label %.lr.ph869, label %.lr.ph
}
...
bb.b:                                             ; preds = %bb.a
  tail call void @_RNvNtCsj6eKBz9Db1c_4core9panicking5panic(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @165, i64 noundef 32, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @166) #14
  unreachable
