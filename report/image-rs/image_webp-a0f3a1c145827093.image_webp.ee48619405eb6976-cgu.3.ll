...
begin_hunk_0_@_RNvNtCsksn9slvsHfS_10image_webp18lossless_transform25apply_predictor_transform:bb.a
  store i8 %i.aqi, ptr %i.aqd, align 1
  %exitcond.not = icmp eq i64 %i.ej, %i.ba
  br i1 %exitcond.not, label %.split.lr.ph, label %.lr.ph
}

; Function Attrs: nonlazybind uwtable
define void @_RNvNtCsksn9slvsHfS_10image_webp18lossless_transform30apply_color_indexing_transform(ptr noalias nofree noundef nonnull %0, i64 noundef range(i64 0, -9223372036854775808) %1, i16 noundef %2, i16 noundef %3, i16 noundef %4, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %5, i64 noundef range(i64 0, -9223372036854775808) %6) unnamed_addr #0 personality ptr @rust_eh_personality {
bb.a:
  ...
  %i.al = alloca [56 x i8], align 8               ; 11 uses
  %i.am = alloca [24 x i8], align 8               ; 13 uses
...
bb.b:                                             ; preds = %bb.a
  tail call void @_RNvNtCsj6eKBz9Db1c_4core9panicking5panic(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @164, i64 noundef 32, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @165) #14
  unreachable

bb.c:                                             ; preds = %bb.a
  %i.at = icmp ugt i16 %4, 16
  br i1 %i.at, label %bb.e, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.au = trunc nuw nsw i16 %4 to i8              ; 3 uses
  %i.av = icmp samesign ult i16 %4, 3
...
bb.e:                                             ; preds = %bb.c
  ...
  %i.aw = and i64 %6, 3
  %i.ax = and i64 %6, 9223372036854775804         ; 2 uses
...
bb.g:                                             ; preds = %bb.d
  ...
  store i8 %i.au, ptr %i.aq, align 1, !noalias !424
  call void @llvm.lifetime.start.p0(ptr nonnull %i.ap), !noalias !424
  store i8 1, ptr %i.ap, align 1, !noalias !424
  call void @llvm.lifetime.start.p0(ptr nonnull %i.ao), !noalias !424
  store i8 1, ptr %i.ao, align 1, !noalias !424
  call void @llvm.lifetime.start.p0(ptr nonnull %i.an), !noalias !424
  store i64 8, ptr %i.an, align 8, !noalias !424
  call void @llvm.lifetime.start.p0(ptr nonnull %i.am), !noalias !424
  call void @llvm.lifetime.start.p0(ptr nonnull %i.al), !noalias !424
  %i.ba = getelementptr inbounds nuw i8, ptr %i.al, i64 48
  store i16 0, ptr %i.ba, align 8, !noalias !424
  %i.bb = getelementptr inbounds nuw i8, ptr %i.al, i64 50
  store i16 256, ptr %i.bb, align 2, !noalias !424
  store ptr %i.an, ptr %i.al, align 8, !noalias !424
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.al, i64 8
  store ptr %i.ap, ptr %.sroa.4.0..sroa_idx.i, align 8, !noalias !424
  %.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.al, i64 16
  store ptr %i.ao, ptr %.sroa.5.0..sroa_idx.i, align 8, !noalias !424
  %.sroa.6.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.al, i64 24
  store ptr %i.aq, ptr %.sroa.6.0..sroa_idx.i, align 8, !noalias !424
  %.sroa.7.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.al, i64 32
  store ptr %5, ptr %.sroa.7.0..sroa_idx.i, align 8, !noalias !424
  %.sroa.8.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.al, i64 40
  store i64 %6, ptr %.sroa.8.0..sroa_idx.i, align 8, !noalias !424
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.al), !noalias !424
  %i.bc = getelementptr inbounds nuw i8, ptr %i.am, i64 16
  %i.bd = load i64, ptr %i.bc, align 8, !noalias !424, !noundef !5
  %.not90.i = icmp eq i64 %i.bd, 256
  %i.be = getelementptr inbounds nuw i8, ptr %i.am, i64 8
  %i.bf = load ptr, ptr %i.be, align 8, !noalias !424, !nonnull !5 ; 2 uses
  br i1 %.not90.i, label %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultRAAhj20_j100_NtNtB4_5array17TryFromSliceErrorE6unwrapCsksn9slvsHfS_10image_webp.exit.i, label %bb.h, !prof !7
...
bb.p:                                             ; preds = %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultRAAhj20_j100_NtNtB4_5array17TryFromSliceErrorE6unwrapCsksn9slvsHfS_10image_webp.exit.i
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.af), !noalias !427
...
.noexc43.i:                                       ; preds = %bb.p
  %i.bx = load i64, ptr %i.af, align 8, !range !428, !noalias !427, !noundef !5
  %i.by = trunc nuw i64 %i.bx to i1
  %i.bz = getelementptr inbounds nuw i8, ptr %i.af, i64 8
  %i.ca = load i64, ptr %i.bz, align 8, !range !429, !noalias !427, !noundef !5 ; 2 uses
...
bb.q:                                             ; preds = %.noexc43.i
  %i.cc = load i64, ptr %i.cb, align 8, !noalias !427
...
.lr.ph139.i:                                      ; preds = %.noexc43.i
  %i.cd = load ptr, ptr %i.cb, align 8, !noalias !427, !nonnull !5, !noundef !5
  call void @llvm.lifetime.end.p0(ptr nonnull %i.af), !noalias !427
  store i64 %i.ca, ptr %i.ak, align 8, !alias.scope !426, !noalias !424
  %i.ce = getelementptr inbounds nuw i8, ptr %i.ak, i64 8 ; 4 uses
  store ptr %i.cd, ptr %i.ce, align 8, !alias.scope !426, !noalias !424
  %i.cf = getelementptr inbounds nuw i8, ptr %i.ak, i64 16 ; 4 uses
  store i64 %i.bm, ptr %i.cf, align 8, !alias.scope !426, !noalias !424
...
_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc3vec3VechEECsksn9slvsHfS_10image_webp.exit.i: ; preds = %bb.s
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ak), !noalias !424
  invoke void @_RNvXsp_NtCs4wP2HXfJTCR_5alloc3vecINtB5_3VecAhj20_ENtNtNtCsj6eKBz9Db1c_4core3ops4drop4Drop4dropCsksn9slvsHfS_10image_webp(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %i.am)
...
bb.x:                                             ; preds = %bb.u
  ...
  br i1 %.not33.i, label %.invoke.i, label %bb.ab, !prof !6
...
bb.ab:                                            ; preds = %bb.x
  ...
  %i.dh = load ptr, ptr %i.ce, align 8, !noalias !424, !nonnull !5, !noundef !5 ; 2 uses
  %i.di = load i64, ptr %i.cf, align 8, !noalias !424, !noundef !5
  %i.dj = getelementptr inbounds nuw i8, ptr %i.dh, i64 %i.di
  call void @llvm.lifetime.start.p0(ptr nonnull %i.ae), !noalias !430
  store ptr %i.df, ptr %i.ae, align 8, !noalias !431
  store i64 %i.bw, ptr %.sroa.4.0..sroa_idx64.i, align 8, !noalias !431
  store ptr %i.dg, ptr %.sroa.5.0..sroa_idx65.i, align 8, !noalias !431
  store i64 0, ptr %.sroa.6.0..sroa_idx66.i, align 8, !noalias !431
  store i64 4, ptr %.sroa.7.0..sroa_idx67.i, align 8, !noalias !431
...
bb.ac:                                            ; preds = %bb.ab
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ae), !noalias !430
  call void @llvm.lifetime.start.p0(ptr nonnull %i.ai), !noalias !424
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(72) %i.ai, ptr noundef nonnull align 8 dereferenceable(72) %i.aj, i64 72, i1 false), !noalias !424
  %i.dk = load i64, ptr %i.ch, align 8, !alias.scope !432, !noalias !433, !noundef !5 ; 2 uses
  %i.dl = load i64, ptr %i.ci, align 8, !alias.scope !432, !noalias !433, !noundef !5
...
.lr.ph.i:                                         ; preds = %bb.ac, %bb.ao
  ...
  store i64 %i.do, ptr %i.ch, align 8, !alias.scope !432, !noalias !433
...
_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter11ChunksExacthEINtBZ_7IterMuthEEINtB5_7ZipImplBW_B1w_E4nextCsksn9slvsHfS_10image_webp.exit.i: ; preds = %.lr.ph.i
  ...
  %.val.i.i = load ptr, ptr %i.cj, align 8, !alias.scope !432, !noalias !433, !nonnull !5, !noundef !5
...
_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter11ChunksExacthEINtBZ_7IterMuthEEINtB5_7ZipImplBW_B1w_E4nextCsksn9slvsHfS_10image_webp.exit.thread.i: ; preds = %bb.ao, %_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter11ChunksExacthEINtBZ_7IterMuthEEINtB5_7ZipImplBW_B1w_E4nextCsksn9slvsHfS_10image_webp.exit.i, %bb.ac
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ai), !noalias !424
...
bb.ae:                                            ; preds = %_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter11ChunksExacthEINtBZ_7IterMuthEEINtB5_7ZipImplBW_B1w_E4nextCsksn9slvsHfS_10image_webp.exit.thread.i
  ...
  br i1 %.not35.i, label %.invoke.i, label %bb.af, !prof !6
...
bb.ah:                                            ; preds = %bb.af
  ...
  %i.dz = load ptr, ptr %i.ce, align 8, !noalias !424, !nonnull !5, !noundef !5 ; 2 uses
  %i.ea = load i64, ptr %i.cf, align 8, !noalias !424, !noundef !5
  %i.eb = getelementptr inbounds nuw i8, ptr %i.dz, i64 %i.ea
  call void @llvm.lifetime.start.p0(ptr nonnull %i.ad), !noalias !434
  store ptr %i.dy, ptr %i.ad, align 8, !noalias !435
  store i64 0, ptr %.sroa.475.0..sroa_idx.i, align 8, !noalias !435
  store ptr %i.dx, ptr %.sroa.576.0..sroa_idx.i, align 8, !noalias !435
  store i64 %i.bu, ptr %.sroa.677.0..sroa_idx.i, align 8, !noalias !435
  store i64 32, ptr %.sroa.778.0..sroa_idx.i, align 8, !noalias !435
...
bb.ai:                                            ; preds = %bb.ah
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ad), !noalias !434
  call void @llvm.lifetime.start.p0(ptr nonnull %i.ag), !noalias !424
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(72) %i.ag, ptr noundef nonnull align 8 dereferenceable(72) %i.ah, i64 72, i1 false), !noalias !424
  %i.ec = load i64, ptr %i.ck, align 8, !alias.scope !436, !noalias !437, !noundef !5 ; 2 uses
  %i.ed = load i64, ptr %i.cl, align 8, !alias.scope !436, !noalias !437, !noundef !5
...
.lr.ph137.i:                                      ; preds = %bb.ai, %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultQAhj20_NtNtB4_5array17TryFromSliceErrorE6unwrapCsksn9slvsHfS_10image_webp.exit.i
  ...
  store i64 %i.eg, ptr %i.ck, align 8, !alias.scope !436, !noalias !437
...
bb.aj:                                            ; preds = %_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter14ChunksExactMuthEINtBZ_4IterhEEINtB5_7ZipImplBW_B1z_E4nextCsksn9slvsHfS_10image_webp.exit.i
  ...
  br i1 %.not91.i, label %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultQAhj20_NtNtB4_5array17TryFromSliceErrorE6unwrapCsksn9slvsHfS_10image_webp.exit.i, label %bb.ak, !prof !7
...
_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter14ChunksExactMuthEINtBZ_4IterhEEINtB5_7ZipImplBW_B1z_E4nextCsksn9slvsHfS_10image_webp.exit.thread.i: ; preds = %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultQAhj20_NtNtB4_5array17TryFromSliceErrorE6unwrapCsksn9slvsHfS_10image_webp.exit.i, %_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter14ChunksExactMuthEINtBZ_4IterhEEINtB5_7ZipImplBW_B1z_E4nextCsksn9slvsHfS_10image_webp.exit.i, %bb.ai
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ag), !noalias !424
  %i.ek = load i64, ptr %i.cf, align 8, !noalias !424, !noundef !5 ; 2 uses
...
bb.am:                                            ; preds = %_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter14ChunksExactMuthEINtBZ_4IterhEEINtB5_7ZipImplBW_B1z_E4nextCsksn9slvsHfS_10image_webp.exit.thread.i
  br i1 %i.co, label %bb.an, label %.invoke.i, !prof !438

bb.an:                                            ; preds = %bb.am
  %i.ep = load ptr, ptr %i.ce, align 8, !noalias !424, !nonnull !5, !noundef !5
...
_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultQAhj20_NtNtB4_5array17TryFromSliceErrorE6unwrapCsksn9slvsHfS_10image_webp.exit.i: ; preds = %bb.aj
  %.val.i60.i = load ptr, ptr %i.cm, align 8, !alias.scope !436, !noalias !437, !nonnull !5, !noundef !5
  ...
  %i.ey = load i64, ptr %i.ck, align 8, !alias.scope !436, !noalias !437, !noundef !5 ; 2 uses
  %i.ez = load i64, ptr %i.cl, align 8, !alias.scope !436, !noalias !437, !noundef !5
...
bb.ao:                                            ; preds = %bb.ad
  ...
  %i.fd = load i64, ptr %i.ch, align 8, !alias.scope !432, !noalias !433, !noundef !5 ; 2 uses
  %i.fe = load i64, ptr %i.ci, align 8, !alias.scope !432, !noalias !433, !noundef !5
...
_RINvNtCsksn9slvsHfS_10image_webp18lossless_transform42apply_color_indexing_transform_small_tableKh3_Kj20_EB4_.exit: ; preds = %bb.m, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc3vec3VechEECsksn9slvsHfS_10image_webp.exit.i
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.am), !noalias !424
  call void @llvm.lifetime.end.p0(ptr nonnull %i.an), !noalias !424
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ao), !noalias !424
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ap), !noalias !424
...
bb.aq:                                            ; preds = %bb.f
  ...
  store i8 %i.au, ptr %i.ac, align 1, !noalias !439
  call void @llvm.lifetime.start.p0(ptr nonnull %i.ab), !noalias !439
  store i8 4, ptr %i.ab, align 1, !noalias !439
  call void @llvm.lifetime.start.p0(ptr nonnull %i.aa), !noalias !439
  store i8 15, ptr %i.aa, align 1, !noalias !439
  call void @llvm.lifetime.start.p0(ptr nonnull %i.z), !noalias !439
  store i64 2, ptr %i.z, align 8, !noalias !439
  call void @llvm.lifetime.start.p0(ptr nonnull %i.y), !noalias !439
  call void @llvm.lifetime.start.p0(ptr nonnull %i.x), !noalias !439
  %i.fh = getelementptr inbounds nuw i8, ptr %i.x, i64 48
  store i16 0, ptr %i.fh, align 8, !noalias !439
  %i.fi = getelementptr inbounds nuw i8, ptr %i.x, i64 50
  store i16 256, ptr %i.fi, align 2, !noalias !439
  store ptr %i.z, ptr %i.x, align 8, !noalias !439
  %.sroa.4.0..sroa_idx.i9 = getelementptr inbounds nuw i8, ptr %i.x, i64 8
  store ptr %i.ab, ptr %.sroa.4.0..sroa_idx.i9, align 8, !noalias !439
  %.sroa.5.0..sroa_idx.i10 = getelementptr inbounds nuw i8, ptr %i.x, i64 16
  store ptr %i.aa, ptr %.sroa.5.0..sroa_idx.i10, align 8, !noalias !439
  %.sroa.6.0..sroa_idx.i11 = getelementptr inbounds nuw i8, ptr %i.x, i64 24
  store ptr %i.ac, ptr %.sroa.6.0..sroa_idx.i11, align 8, !noalias !439
  %.sroa.7.0..sroa_idx.i12 = getelementptr inbounds nuw i8, ptr %i.x, i64 32
  store ptr %5, ptr %.sroa.7.0..sroa_idx.i12, align 8, !noalias !439
  %.sroa.8.0..sroa_idx.i13 = getelementptr inbounds nuw i8, ptr %i.x, i64 40
  store i64 %6, ptr %.sroa.8.0..sroa_idx.i13, align 8, !noalias !439
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.x), !noalias !439
  %i.fj = getelementptr inbounds nuw i8, ptr %i.y, i64 16
  %i.fk = load i64, ptr %i.fj, align 8, !noalias !439, !noundef !5
  %.not92.i = icmp eq i64 %i.fk, 256
  %i.fl = getelementptr inbounds nuw i8, ptr %i.y, i64 8
  %i.fm = load ptr, ptr %i.fl, align 8, !noalias !439, !nonnull !5 ; 2 uses
  br i1 %.not92.i, label %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultRAAhj8_j100_NtNtB4_5array17TryFromSliceErrorE6unwrapCsksn9slvsHfS_10image_webp.exit.i, label %bb.ar, !prof !7
...
bb.az:                                            ; preds = %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultRAAhj8_j100_NtNtB4_5array17TryFromSliceErrorE6unwrapCsksn9slvsHfS_10image_webp.exit.i
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.r), !noalias !442
...
.noexc45.i:                                       ; preds = %bb.az
  %i.gc = load i64, ptr %i.r, align 8, !range !428, !noalias !442, !noundef !5
  %i.gd = trunc nuw i64 %i.gc to i1
  %i.ge = getelementptr inbounds nuw i8, ptr %i.r, i64 8
  %i.gf = load i64, ptr %i.ge, align 8, !range !429, !noalias !442, !noundef !5 ; 2 uses
...
bb.ba:                                            ; preds = %.noexc45.i
  %i.gh = load i64, ptr %i.gg, align 8, !noalias !442
...
.lr.ph140.i:                                      ; preds = %.noexc45.i
  %i.gi = load ptr, ptr %i.gg, align 8, !noalias !442, !nonnull !5, !noundef !5
  call void @llvm.lifetime.end.p0(ptr nonnull %i.r), !noalias !442
  store i64 %i.gf, ptr %i.w, align 8, !alias.scope !441, !noalias !439
  %i.gj = getelementptr inbounds nuw i8, ptr %i.w, i64 8 ; 4 uses
  store ptr %i.gi, ptr %i.gj, align 8, !alias.scope !441, !noalias !439
  %i.gk = getelementptr inbounds nuw i8, ptr %i.w, i64 16 ; 4 uses
  store i64 %i.fr, ptr %i.gk, align 8, !alias.scope !441, !noalias !439
...
_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc3vec3VechEECsksn9slvsHfS_10image_webp.exit.i33: ; preds = %bb.bc
  call void @llvm.lifetime.end.p0(ptr nonnull %i.w), !noalias !439
  invoke void @_RNvXsp_NtCs4wP2HXfJTCR_5alloc3vecINtB5_3VecAhj8_ENtNtNtCsj6eKBz9Db1c_4core3ops4drop4Drop4dropCsksn9slvsHfS_10image_webp(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %i.y)
...
bb.bh:                                            ; preds = %bb.be
  ...
  br i1 %.not35.i21, label %.invoke.i29, label %bb.bl, !prof !6
...
bb.bl:                                            ; preds = %bb.bh
  ...
  %i.hm = load ptr, ptr %i.gj, align 8, !noalias !439, !nonnull !5, !noundef !5 ; 2 uses
  %i.hn = load i64, ptr %i.gk, align 8, !noalias !439, !noundef !5
  %i.ho = getelementptr inbounds nuw i8, ptr %i.hm, i64 %i.hn
  call void @llvm.lifetime.start.p0(ptr nonnull %i.q), !noalias !443
  store ptr %i.hk, ptr %i.q, align 8, !noalias !444
  store i64 %i.gb, ptr %.sroa.4.0..sroa_idx66.i, align 8, !noalias !444
  store ptr %i.hl, ptr %.sroa.5.0..sroa_idx67.i, align 8, !noalias !444
  store i64 0, ptr %.sroa.6.0..sroa_idx68.i, align 8, !noalias !444
  store i64 4, ptr %.sroa.7.0..sroa_idx69.i, align 8, !noalias !444
...
bb.bm:                                            ; preds = %bb.bl
  call void @llvm.lifetime.end.p0(ptr nonnull %i.q), !noalias !443
  call void @llvm.lifetime.start.p0(ptr nonnull %i.u), !noalias !439
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(72) %i.u, ptr noundef nonnull align 8 dereferenceable(72) %i.v, i64 72, i1 false), !noalias !439
  %i.hp = load i64, ptr %i.gm, align 8, !alias.scope !445, !noalias !446, !noundef !5 ; 2 uses
  %i.hq = load i64, ptr %i.gn, align 8, !alias.scope !445, !noalias !446, !noundef !5
...
.lr.ph.i39:                                       ; preds = %bb.bm, %bb.by
  ...
  store i64 %i.ht, ptr %i.gm, align 8, !alias.scope !445, !noalias !446
...
_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter11ChunksExacthEINtBZ_7IterMuthEEINtB5_7ZipImplBW_B1w_E4nextCsksn9slvsHfS_10image_webp.exit.i41: ; preds = %.lr.ph.i39
  ...
  %.val.i.i42 = load ptr, ptr %i.go, align 8, !alias.scope !445, !noalias !446, !nonnull !5, !noundef !5
...
_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter11ChunksExacthEINtBZ_7IterMuthEEINtB5_7ZipImplBW_B1w_E4nextCsksn9slvsHfS_10image_webp.exit.thread.i25: ; preds = %bb.by, %_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter11ChunksExacthEINtBZ_7IterMuthEEINtB5_7ZipImplBW_B1w_E4nextCsksn9slvsHfS_10image_webp.exit.i41, %bb.bm
  call void @llvm.lifetime.end.p0(ptr nonnull %i.u), !noalias !439
...
bb.bo:                                            ; preds = %_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter11ChunksExacthEINtBZ_7IterMuthEEINtB5_7ZipImplBW_B1w_E4nextCsksn9slvsHfS_10image_webp.exit.thread.i25
  ...
  br i1 %.not37.i, label %.invoke.i29, label %bb.bp, !prof !6
...
bb.br:                                            ; preds = %bb.bp
  ...
  %i.ie = load ptr, ptr %i.gj, align 8, !noalias !439, !nonnull !5, !noundef !5 ; 2 uses
  %i.if = load i64, ptr %i.gk, align 8, !noalias !439, !noundef !5
  %i.ig = getelementptr inbounds nuw i8, ptr %i.ie, i64 %i.if
  call void @llvm.lifetime.start.p0(ptr nonnull %i.p), !noalias !447
  store ptr %i.id, ptr %i.p, align 8, !noalias !448
  store i64 0, ptr %.sroa.477.0..sroa_idx.i, align 8, !noalias !448
  store ptr %i.ic, ptr %.sroa.578.0..sroa_idx.i, align 8, !noalias !448
  store i64 %i.fz, ptr %.sroa.679.0..sroa_idx.i, align 8, !noalias !448
  store i64 8, ptr %.sroa.780.0..sroa_idx.i, align 8, !noalias !448
...
bb.bs:                                            ; preds = %bb.br
  call void @llvm.lifetime.end.p0(ptr nonnull %i.p), !noalias !447
  call void @llvm.lifetime.start.p0(ptr nonnull %i.s), !noalias !439
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(72) %i.s, ptr noundef nonnull align 8 dereferenceable(72) %i.t, i64 72, i1 false), !noalias !439
  %i.ih = load i64, ptr %i.gp, align 8, !alias.scope !449, !noalias !450, !noundef !5 ; 2 uses
  %i.ii = load i64, ptr %i.gq, align 8, !alias.scope !449, !noalias !450, !noundef !5
...
.lr.ph138.i:                                      ; preds = %bb.bs, %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultQAhj8_NtNtB4_5array17TryFromSliceErrorE6unwrapCsksn9slvsHfS_10image_webp.exit.i
  ...
  store i64 %i.il, ptr %i.gp, align 8, !alias.scope !449, !noalias !450
...
bb.bt:                                            ; preds = %_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter14ChunksExactMuthEINtBZ_4IterhEEINtB5_7ZipImplBW_B1z_E4nextCsksn9slvsHfS_10image_webp.exit.i36
  ...
  br i1 %.not.i37, label %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultQAhj8_NtNtB4_5array17TryFromSliceErrorE6unwrapCsksn9slvsHfS_10image_webp.exit.i, label %bb.bu, !prof !7
...
_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter14ChunksExactMuthEINtBZ_4IterhEEINtB5_7ZipImplBW_B1z_E4nextCsksn9slvsHfS_10image_webp.exit.thread.i26: ; preds = %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultQAhj8_NtNtB4_5array17TryFromSliceErrorE6unwrapCsksn9slvsHfS_10image_webp.exit.i, %_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter14ChunksExactMuthEINtBZ_4IterhEEINtB5_7ZipImplBW_B1z_E4nextCsksn9slvsHfS_10image_webp.exit.i36, %bb.bs
  call void @llvm.lifetime.end.p0(ptr nonnull %i.s), !noalias !439
  %i.ip = load i64, ptr %i.gk, align 8, !noalias !439, !noundef !5 ; 2 uses
...
bb.bw:                                            ; preds = %_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter14ChunksExactMuthEINtBZ_4IterhEEINtB5_7ZipImplBW_B1z_E4nextCsksn9slvsHfS_10image_webp.exit.thread.i26
  br i1 %i.gt, label %bb.bx, label %.invoke.i29, !prof !438

bb.bx:                                            ; preds = %bb.bw
  %i.iu = load ptr, ptr %i.gj, align 8, !noalias !439, !nonnull !5, !noundef !5
  %i.iv = getelementptr inbounds nuw i8, ptr %i.iu, i64 %i.gs
  %i.iw = load i8, ptr %i.iv, align 1, !noundef !5
...
_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultQAhj8_NtNtB4_5array17TryFromSliceErrorE6unwrapCsksn9slvsHfS_10image_webp.exit.i: ; preds = %bb.bt
  %.val.i62.i = load ptr, ptr %i.gr, align 8, !alias.scope !449, !noalias !450, !nonnull !5, !noundef !5
  %i.iz = getelementptr inbounds nuw i8, ptr %.val.i62.i, i64 %i.ik
  %i.ja = load i8, ptr %i.iz, align 1, !noundef !5
  ...
  %i.jd = load i64, ptr %i.gp, align 8, !alias.scope !449, !noalias !450, !noundef !5 ; 2 uses
  %i.je = load i64, ptr %i.gq, align 8, !alias.scope !449, !noalias !450, !noundef !5
...
bb.by:                                            ; preds = %bb.bn
  ...
  %i.jh = load i8, ptr %i.jg, align 1, !noundef !5
  store i8 %i.jh, ptr %i.hw, align 1
  %i.ji = load i64, ptr %i.gm, align 8, !alias.scope !445, !noalias !446, !noundef !5 ; 2 uses
  %i.jj = load i64, ptr %i.gn, align 8, !alias.scope !445, !noalias !446, !noundef !5
...
_RINvNtCsksn9slvsHfS_10image_webp18lossless_transform42apply_color_indexing_transform_small_tableKh1_Kj8_EB4_.exit: ; preds = %bb.aw, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc3vec3VechEECsksn9slvsHfS_10image_webp.exit.i33
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.y), !noalias !439
  call void @llvm.lifetime.end.p0(ptr nonnull %i.z), !noalias !439
  call void @llvm.lifetime.end.p0(ptr nonnull %i.aa), !noalias !439
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ab), !noalias !439
...
bb.ca:                                            ; preds = %bb.f
  ...
  store i8 %i.au, ptr %i.o, align 1, !noalias !451
  call void @llvm.lifetime.start.p0(ptr nonnull %i.n), !noalias !451
  store i8 2, ptr %i.n, align 1, !noalias !451
  call void @llvm.lifetime.start.p0(ptr nonnull %i.m), !noalias !451
  store i8 3, ptr %i.m, align 1, !noalias !451
  call void @llvm.lifetime.start.p0(ptr nonnull %i.l), !noalias !451
  store i64 4, ptr %i.l, align 8, !noalias !451
  call void @llvm.lifetime.start.p0(ptr nonnull %i.k), !noalias !451
  call void @llvm.lifetime.start.p0(ptr nonnull %i.j), !noalias !451
  %i.jm = getelementptr inbounds nuw i8, ptr %i.j, i64 48
  store i16 0, ptr %i.jm, align 8, !noalias !451
  %i.jn = getelementptr inbounds nuw i8, ptr %i.j, i64 50
  store i16 256, ptr %i.jn, align 2, !noalias !451
  store ptr %i.l, ptr %i.j, align 8, !noalias !451
  %.sroa.4.0..sroa_idx.i44 = getelementptr inbounds nuw i8, ptr %i.j, i64 8
  store ptr %i.n, ptr %.sroa.4.0..sroa_idx.i44, align 8, !noalias !451
  %.sroa.5.0..sroa_idx.i45 = getelementptr inbounds nuw i8, ptr %i.j, i64 16
  store ptr %i.m, ptr %.sroa.5.0..sroa_idx.i45, align 8, !noalias !451
  %.sroa.6.0..sroa_idx.i46 = getelementptr inbounds nuw i8, ptr %i.j, i64 24
  store ptr %i.o, ptr %.sroa.6.0..sroa_idx.i46, align 8, !noalias !451
  %.sroa.7.0..sroa_idx.i47 = getelementptr inbounds nuw i8, ptr %i.j, i64 32
  store ptr %5, ptr %.sroa.7.0..sroa_idx.i47, align 8, !noalias !451
  %.sroa.8.0..sroa_idx.i48 = getelementptr inbounds nuw i8, ptr %i.j, i64 40
  store i64 %6, ptr %.sroa.8.0..sroa_idx.i48, align 8, !noalias !451
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.j), !noalias !451
  %i.jo = getelementptr inbounds nuw i8, ptr %i.k, i64 16
  %i.jp = load i64, ptr %i.jo, align 8, !noalias !451, !noundef !5
  %.not90.i49 = icmp eq i64 %i.jp, 256
  %i.jq = getelementptr inbounds nuw i8, ptr %i.k, i64 8
  %i.jr = load ptr, ptr %i.jq, align 8, !noalias !451, !nonnull !5 ; 2 uses
  br i1 %.not90.i49, label %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultRAAhj10_j100_NtNtB4_5array17TryFromSliceErrorE6unwrapCsksn9slvsHfS_10image_webp.exit.i, label %bb.cb, !prof !7
...
.noexc43.i59:                                     ; preds = %bb.cj
  %i.kj = load i64, ptr %i.d, align 8, !range !428, !noalias !454, !noundef !5
  %i.kk = trunc nuw i64 %i.kj to i1
  %i.kl = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  %i.km = load i64, ptr %i.kl, align 8, !range !429, !noalias !454, !noundef !5 ; 2 uses
...
bb.ck:                                            ; preds = %.noexc43.i59
  %i.ko = load i64, ptr %i.kn, align 8, !noalias !454
...
.lr.ph139.i60:                                    ; preds = %.noexc43.i59
  %i.kp = load ptr, ptr %i.kn, align 8, !noalias !454, !nonnull !5, !noundef !5
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !454
  store i64 %i.km, ptr %i.i, align 8, !alias.scope !453, !noalias !451
  %i.kq = getelementptr inbounds nuw i8, ptr %i.i, i64 8 ; 4 uses
  store ptr %i.kp, ptr %i.kq, align 8, !alias.scope !453, !noalias !451
  %i.kr = getelementptr inbounds nuw i8, ptr %i.i, i64 16 ; 4 uses
  store i64 %i.jy, ptr %i.kr, align 8, !alias.scope !453, !noalias !451
...
bb.cr:                                            ; preds = %bb.co
  ...
  br i1 %.not33.i71, label %.invoke.i83, label %bb.cv, !prof !6
...
bb.cv:                                            ; preds = %bb.cr
  ...
  %i.lt = load ptr, ptr %i.kq, align 8, !noalias !451, !nonnull !5, !noundef !5 ; 2 uses
  %i.lu = load i64, ptr %i.kr, align 8, !noalias !451, !noundef !5
  %i.lv = getelementptr inbounds nuw i8, ptr %i.lt, i64 %i.lu
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !455
  store ptr %i.lr, ptr %i.c, align 8, !noalias !456
  store i64 %i.ki, ptr %.sroa.4.0..sroa_idx64.i61, align 8, !noalias !456
  store ptr %i.ls, ptr %.sroa.5.0..sroa_idx65.i62, align 8, !noalias !456
  store i64 0, ptr %.sroa.6.0..sroa_idx66.i63, align 8, !noalias !456
  store i64 4, ptr %.sroa.7.0..sroa_idx67.i64, align 8, !noalias !456
...
bb.cw:                                            ; preds = %bb.cv
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(72) %i.g, ptr noundef nonnull align 8 dereferenceable(72) %i.h, i64 72, i1 false), !noalias !451
  %i.lw = load i64, ptr %i.kt, align 8, !alias.scope !457, !noalias !458, !noundef !5 ; 2 uses
  %i.lx = load i64, ptr %i.ku, align 8, !alias.scope !457, !noalias !458, !noundef !5
...
.lr.ph.i97:                                       ; preds = %bb.cw, %bb.di
  ...
  store i64 %i.ma, ptr %i.kt, align 8, !alias.scope !457, !noalias !458
...
_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter11ChunksExacthEINtBZ_7IterMuthEEINtB5_7ZipImplBW_B1w_E4nextCsksn9slvsHfS_10image_webp.exit.i100: ; preds = %.lr.ph.i97
  ...
  %.val.i.i101 = load ptr, ptr %i.kv, align 8, !alias.scope !457, !noalias !458, !nonnull !5, !noundef !5
...
bb.cy:                                            ; preds = %_RNvXs3_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3zipINtB5_3ZipINtNtNtBb_5slice4iter11ChunksExacthEINtBZ_7IterMuthEEINtB5_7ZipImplBW_B1w_E4nextCsksn9slvsHfS_10image_webp.exit.thread.i76
  ...
  br i1 %.not35.i77, label %.invoke.i83, label %bb.cz, !prof !6
...
bb.db:                                            ; preds = %bb.cz
  ...
  %i.ml = load ptr, ptr %i.kq, align 8, !noalias !451, !nonnull !5, !noundef !5 ; 2 uses
  %i.mm = load i64, ptr %i.kr, align 8, !noalias !451, !noundef !5
  %i.mn = getelementptr inbounds nuw i8, ptr %i.ml, i64 %i.mm
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !459
  store ptr %i.mk, ptr %i.b, align 8, !noalias !460
  store i64 0, ptr %.sroa.475.0..sroa_idx.i66, align 8, !noalias !460
  store ptr %i.mj, ptr %.sroa.576.0..sroa_idx.i67, align 8, !noalias !460
  store i64 %i.kg, ptr %.sroa.677.0..sroa_idx.i68, align 8, !noalias !460
  store i64 16, ptr %.sroa.778.0..sroa_idx.i69, align 8, !noalias !460
...
bb.dc:                                            ; preds = %bb.db
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e), !noalias !451
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(72) %i.e, ptr noundef nonnull align 8 dereferenceable(72) %i.f, i64 72, i1 false), !noalias !451
  %i.mo = load i64, ptr %i.kw, align 8, !alias.scope !461, !noalias !462, !noundef !5 ; 2 uses
  %i.mp = load i64, ptr %i.kx, align 8, !alias.scope !461, !noalias !462, !noundef !5
...
.lr.ph137.i88:                                    ; preds = %bb.dc, %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultQAhj10_NtNtB4_5array17TryFromSliceErrorE6unwrapCsksn9slvsHfS_10image_webp.exit.i
  ...
  store i64 %i.ms, ptr %i.kw, align 8, !alias.scope !461, !noalias !462
