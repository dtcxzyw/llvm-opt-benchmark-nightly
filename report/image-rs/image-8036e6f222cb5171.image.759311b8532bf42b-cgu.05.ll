...
bb.gw:                                            ; preds = %bb.gv, %bb.gt
  ...
  br i1 %i.se, label %bb.gx, label %.thread1155.i
...
bb.gy:                                            ; preds = %bb.gx
  ...
  br i1 %i.so, label %bb.ha, label %.invoke1370.i, !prof !382
...
bb.ha:                                            ; preds = %bb.gy
  ...
  br i1 %i.sr, label %bb.hb, label %.invoke1372.i
...
_RNvMNtCsksn9slvsHfS_10image_webp8losslessINtB2_15LosslessDecoderINtNtNtCsj6eKBz9Db1c_4core2io4util4TakeQINtNtB15_6cursor6CursorRShEEE22plane_code_to_distanceCsa5QsYiPB8Gl_5image.exit.i: ; preds = %bb.hm, %bb.hl
  ...
  %i.uk = sub nuw nsw i64 %i.nj, %.sroa.0.0853.i
...
bb.ho:                                            ; preds = %bb.hn
  ...
  br i1 %i.up, label %.invoke1370.i, label %bb.hq, !prof !6
...
_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCsa5QsYiPB8Gl_5image.exit524.i: ; preds = %bb.hq
  ...
  br i1 %exitcond1070.not.i1520, label %._crit_edge1523, label %.lr.ph1522

bb.hr:                                            ; preds = %bb.hu
  %exitcond1070.not.i = icmp eq i64 %i.ux, %.sroa.7.0.ph.i.fr
  br i1 %exitcond1070.not.i, label %._crit_edge1523, label %.lr.ph1522
...
bb.hs:                                            ; preds = %.lr.ph1522
  %exitcond1071.not.i = icmp eq i64 %.sroa.0386.0.i1521, %i.uw
  br i1 %exitcond1071.not.i, label %bb.ht, label %bb.hu, !prof !6

bb.ht:                                            ; preds = %bb.hs
  %i.vb = sub nuw nsw i64 %6, %i.uz
  br label %.invoke1370.i
...
bb.hv:                                            ; preds = %bb.hp
  %i.vy = sub nuw nsw i64 %.sroa.0.0853.i, %.sroa.0.0.i564.i
  %i.vz = shl nuw nsw i64 %i.vy, 2                ; 4 uses
...
.noexc567.i:                                      ; preds = %bb.hv
  ...
  br i1 %.not.i566.i, label %.loopexit1067.invoke.i, label %bb.hy, !prof !6
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %bb.hx
  ...
  br i1 %i.wk, label %bb.hw, label %.invoke1372.i

.thread610.i:                                     ; preds = %_RINvMNtCsj6eKBz9Db1c_4core5sliceSh11copy_withinINtNtNtB5_3ops5range5RangejEECsa5QsYiPB8Gl_5image.exit576.i, %bb.hx, %_RINvMNtCsj6eKBz9Db1c_4core5sliceSh11copy_withinINtNtNtB5_3ops5range5RangejEECsa5QsYiPB8Gl_5image.exit576.i.preheader, %.preheader.peel.i, %bb.hy
...
bb.hw:                                            ; preds = %scalar.ph
  ...
  br i1 %i.wm, label %bb.hx, label %.invoke1372.i
...
bb.hx:                                            ; preds = %bb.hw
  ...
  %exitcond1069.not.i = icmp eq i64 %i.wh, %i.vd
  br i1 %exitcond1069.not.i, label %.thread610.i, label %scalar.ph, !llvm.loop !1035
...
bb.hy:                                            ; preds = %.noexc567.i
  ...
  br i1 %or.cond.i41, label %.preheader.peel.i, label %.thread610.i

.preheader.peel.i:                                ; preds = %bb.hy
...
bb.hz:                                            ; preds = %.preheader.peel.i
  %i.wy = add nuw nsw i64 %..i569.i, %i.vz        ; 2 uses
  %i.wz = add nuw nsw i64 %i.wy, 16
...
.noexc574.peel.i:                                 ; preds = %bb.hz
  ...
  br i1 %.not.i573.peel.i, label %.loopexit1067.invoke.i, label %_RINvMNtCsj6eKBz9Db1c_4core5sliceSh11copy_withinINtNtNtB5_3ops5range5RangejEECsa5QsYiPB8Gl_5image.exit576.i.preheader, !prof !6
...
bb.ia:                                            ; preds = %.lr.ph1519, %_RINvMNtCsj6eKBz9Db1c_4core5sliceSh11copy_withinINtNtNtB5_3ops5range5RangejEECsa5QsYiPB8Gl_5image.exit576.i
  ...
  %i.xm = add nuw i64 %.sroa.5591.0.i1517, %i.vz  ; 2 uses
...
.noexc574.i:                                      ; preds = %bb.ia
  ...
  br i1 %.not.i573.i, label %.loopexit1067.invoke.i, label %_RINvMNtCsj6eKBz9Db1c_4core5sliceSh11copy_withinINtNtNtB5_3ops5range5RangejEECsa5QsYiPB8Gl_5image.exit576.i, !prof !6, !llvm.loop !1046

.loopexit1067.invoke.i:                           ; preds = %.noexc574.peel.i, %.noexc567.i, %.noexc574.i
  ...
  invoke void @_RNvNtCsj6eKBz9Db1c_4core9panicking9panic_fmt(ptr noundef nonnull @0, ptr noundef nonnull inttoptr (i64 43 to ptr), ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.xu) #23
          to label %.loopexit1067.cont.i unwind label %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.i, !noalias !1007

.loopexit1067.cont.i:                             ; preds = %.loopexit1067.invoke.i
  unreachable

bb.ib:                                            ; preds = %.thread610.i
  %i.xv = shl nuw nsw i64 %.sroa.0.0853.i, 2      ; 4 uses
  %i.xw = icmp samesign ugt i64 %i.xv, %6
  br i1 %i.xw, label %.invoke1370.i, label %bb.ic, !prof !6

bb.ic:                                            ; preds = %bb.ib
  %i.xx = sub nuw nsw i64 %6, %i.xv               ; 2 uses
  %i.xy = shl nuw nsw i64 %.sroa.7.0.ph.i.fr, 2   ; 3 uses
  %.not506.i = icmp samesign ugt i64 %i.xy, %i.xx
  br i1 %.not506.i, label %.invoke1370.i, label %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCsa5QsYiPB8Gl_5image.exit.lr.ph.i, !prof !46
...
bb.hx:                                            ; preds = %bb.hw
  ...
  %exitcond1069.not.i = icmp eq i64 %i.wh, %i.vd
  br i1 %exitcond1069.not.i, label %.thread610.i, label %scalar.ph, !llvm.loop !1279
...
.noexc574.i:                                      ; preds = %bb.ia
  ...
  %i.xt = sub i64 %6, %i.xs
  %.not.i573.i = icmp ugt i64 %i.xp, %i.xt
  br i1 %.not.i573.i, label %.loopexit1067.invoke.i, label %_RINvMNtCsj6eKBz9Db1c_4core5sliceSh11copy_withinINtNtNtB5_3ops5range5RangejEECsa5QsYiPB8Gl_5image.exit576.i, !prof !6, !llvm.loop !1290

.loopexit1067.invoke.i:                           ; preds = %.noexc574.peel.i, %.noexc567.i, %.noexc574.i
  %i.xu = phi ptr [ @78, %.noexc574.i ], [ @78, %.noexc574.peel.i ], [ @75, %.noexc567.i ]
  invoke void @_RNvNtCsj6eKBz9Db1c_4core9panicking9panic_fmt(ptr noundef nonnull @0, ptr noundef nonnull inttoptr (i64 43 to ptr), ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.xu) #23
          to label %.loopexit1067.cont.i unwind label %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.i, !noalias !1251
