...
begin_hunk_0_@_RINvNtCsksn9slvsHfS_10image_webp8extended16read_alpha_chunkINtNtNtCsj6eKBz9Db1c_4core2io4util4TakeQINtNtB10_6cursor6CursorRShEEECsa5QsYiPB8Gl_5image:bb.a
  %i.fy = add nuw nsw i32 %i.ft, %i.fx
  %i.fz = lshr i32 %i.fy, %i.fr                   ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.o), !noalias !566
  %narrow.i.i = mul nuw nsw i32 %i.fv, %i.fz
...
bb.bo:                                            ; preds = %bb.bn, %bb.bm, %bb.bl
  ...
  %i.gz = trunc nuw i32 %i.gx to i16
  br i1 %i.gy, label %bb.bp, label %bb.bq, !prof !6
...
bb.bq:                                            ; preds = %bb.bo
  %i.ha = load ptr, ptr %i.ca, align 8, !noalias !566, !nonnull !4, !noundef !4 ; 3 uses
  %i.hb = load i64, ptr %i.cb, align 8, !noalias !566, !noundef !4 ; 3 uses
  %i.hc = icmp samesign ugt i64 %i.hb, 4
  br i1 %i.hc, label %.lr.ph.preheader.i.i.i.preheader, label %_RNvMNtCsksn9slvsHfS_10image_webp8losslessINtB2_15LosslessDecoderQINtNtNtCsj6eKBz9Db1c_4core2io4util4TakeQINtNtB16_6cursor6CursorRShEEE16adjust_color_mapCsa5QsYiPB8Gl_5image.exit.i.i

.lr.ph.preheader.i.i.i.preheader:                 ; preds = %bb.bq
  %i.hd = add i64 %i.hb, -4                       ; 3 uses
...
vector.ph:                                        ; preds = %.lr.ph.preheader.i.i.i.preheader
  %n.vec = and i64 %i.hd, -4                      ; 3 uses
  %i.he = add i64 %n.vec, 4
  %load_initial = load <4 x i8>, ptr %i.ha, align 1
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %store_forwarded = phi <4 x i8> [ %load_initial, %vector.ph ], [ %i.hh, %vector.body ]
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.hf = getelementptr inbounds nuw i8, ptr %i.ha, i64 %index
  %i.hg = getelementptr inbounds nuw i8, ptr %i.hf, i64 4 ; 2 uses
  %wide.load = load <4 x i8>, ptr %i.hg, align 1, !alias.scope !618, !noalias !577
  %i.hh = add <4 x i8> %store_forwarded, %wide.load ; 2 uses
  store <4 x i8> %i.hh, ptr %i.hg, align 1, !alias.scope !618, !noalias !577
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.hi = icmp eq i64 %index.next, %n.vec
  br i1 %i.hi, label %middle.block, label %vector.body, !llvm.loop !621
...
.lr.ph.preheader.i.i.i.preheader542:              ; preds = %.lr.ph.preheader.i.i.i.preheader, %middle.block
  %.sroa.01.04.i.i.i.ph = phi i64 [ 4, %.lr.ph.preheader.i.i.i.preheader ], [ %i.he, %middle.block ]
  br label %.lr.ph.preheader.i.i.i

.lr.ph.preheader.i.i.i:                           ; preds = %.lr.ph.preheader.i.i.i.preheader542, %.lr.ph.preheader.i.i.i
  %.sroa.01.04.i.i.i = phi i64 [ %i.hk, %.lr.ph.preheader.i.i.i ], [ %.sroa.01.04.i.i.i.ph, %.lr.ph.preheader.i.i.i.preheader542 ] ; 2 uses
  %i.hj = getelementptr inbounds nuw i8, ptr %i.ha, i64 %.sroa.01.04.i.i.i ; 3 uses
  %i.hk = add nuw nsw i64 %.sroa.01.04.i.i.i, 1   ; 2 uses
  %i.hl = load i8, ptr %i.hj, align 1, !alias.scope !618, !noalias !577, !noundef !4
  %i.hm = getelementptr i8, ptr %i.hj, i64 -4
  %i.hn = load i8, ptr %i.hm, align 1, !alias.scope !618, !noalias !577, !noundef !4
  %i.ho = add i8 %i.hn, %i.hl
  store i8 %i.ho, ptr %i.hj, align 1, !alias.scope !618, !noalias !577
  %exitcond.not.i.i.i = icmp eq i64 %i.hk, %i.hb
...
.loopexit.i:                                      ; preds = %bb.an, %bb.aj, %bb.af, %.thread220.i.i, %bb.z, %bb.v, %.noexc67, %.noexc65, %.noexc62, %bb.ao, %bb.ak, %bb.ag, %bb.aa, %bb.w
  %.sroa.21.0.ph.i = phi i16 [ %.sroa.11.i.sroa.0.0.copyload.i, %bb.w ], [ %.sroa.21.0.copyload.i, %.noexc67 ], [ %.sroa.11197.i.sroa.0.0.copyload.i, %bb.aa ], [ %.sroa.21.0.copyload187.i, %.noexc65 ], [ %.sroa.11200.i.sroa.0.0.copyload.i, %bb.ag ], [ %.sroa.21.0.copyload189.i, %.noexc62 ], [ %.sroa.11203.i.sroa.0.0.copyload.i, %bb.ak ], [ %.sroa.9206.0.copyload.i.i, %bb.ao ], [ undef, %.thread220.i.i ], [ undef, %bb.v ], [ undef, %bb.z ], [ undef, %bb.af ], [ undef, %bb.aj ], [ %.sroa.9206.0.i.i, %bb.an ]
  %.sroa.15.0.ph.i = phi i8 [ %.sroa.8194.0.copyload.i.i, %bb.w ], [ %.sroa.15.0.copyload.i, %.noexc67 ], [ %.sroa.8196.0.copyload.i.i, %bb.aa ], [ %.sroa.15.0.copyload183.i, %.noexc65 ], [ %.sroa.8199.0.copyload.i.i, %bb.ag ], [ %.sroa.15.0.copyload185.i, %.noexc62 ], [ %.sroa.8202.0.copyload.i.i, %bb.ak ], [ %.sroa.8205.0.copyload.i.i, %bb.ao ], [ undef, %.thread220.i.i ], [ 1, %bb.v ], [ %.sroa.8196.0.i.i, %bb.z ], [ %.sroa.8199.0.i.i, %bb.af ], [ %.sroa.8202.0.i.i, %bb.aj ], [ undef, %bb.an ]
  %.sroa.0.0.ph.i = phi i8 [ %i.cm, %bb.w ], [ %i.gn, %.noexc67 ], [ %i.cu, %bb.aa ], [ %i.gi, %.noexc65 ], [ %i.dn, %bb.ag ], [ %i.fg, %.noexc62 ], [ %i.dr, %bb.ak ], [ %i.dv, %bb.ao ], [ 16, %.thread220.i.i ], [ 15, %bb.v ], [ 15, %bb.z ], [ 15, %bb.af ], [ 15, %bb.aj ], [ 15, %bb.an ]
...
bb.bt:                                            ; preds = %.thread.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.819.i.i)
  %i.hq = zext i16 %.sroa.058.0.i.i to i64
  %i.hr = load i16, ptr %i.bd, align 2, !alias.scope !548, !noalias !551, !noundef !4 ; 2 uses
  %i.hs = zext i16 %i.hr to i64
  %i.ht = shl nuw nsw i64 %i.hq, 2
  %i.hu = mul nuw nsw i64 %i.ht, %i.hs            ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.s), !noalias !567
  %.not173.i = icmp samesign ugt i64 %i.hu, %i.bh
  br i1 %.not173.i, label %.invoke443, label %bb.bu, !prof !46

bb.bu:                                            ; preds = %bb.bt
  invoke fastcc void @_RNvMNtCsksn9slvsHfS_10image_webp8losslessINtB2_15LosslessDecoderQINtNtNtCsj6eKBz9Db1c_4core2io4util4TakeQINtNtB16_6cursor6CursorRShEEE19decode_image_streamCsa5QsYiPB8Gl_5image(ptr noalias nofree noundef align 8 captures(address) dereferenceable(32) %i.s, ptr noalias nofree noundef nonnull align 8 dereferenceable(184) %i.ab, i16 noundef %.sroa.058.0.i.i, i16 noundef %i.hr, i1 noundef zeroext true, ptr noalias nofree noundef nonnull %i.bv, i64 noundef %i.hu)
          to label %.noexc69 unwind label %.loopexit.split-lp150.loopexit.split-lp

.noexc69:                                         ; preds = %bb.bu
  %i.hv = load i8, ptr %i.s, align 8, !range !304, !noalias !567, !noundef !4 ; 2 uses
  %.not174.i = icmp eq i8 %i.hv, -1
...
bb.bw:                                            ; preds = %.noexc69
  call void @llvm.lifetime.end.p0(ptr nonnull %i.s), !noalias !567
  %i.hw = load ptr, ptr %.sroa.436.0..sroa_idx, align 8, !alias.scope !548, !noalias !551, !nonnull !4, !noundef !4 ; 2 uses
  %i.hx = load i64, ptr %.sroa.537.0..sroa_idx, align 8, !alias.scope !548, !noalias !551, !noundef !4 ; 2 uses
  %i.hy = icmp samesign eq i64 %i.hx, 0
  br i1 %i.hy, label %.loopexit154, label %.lr.ph.preheader.i

.lr.ph.preheader.i:                               ; preds = %bb.bw
  %i.hz = getelementptr inbounds nuw i8, ptr %i.hw, i64 %i.hx
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.noexc72, %.lr.ph.preheader.i
  %.sroa.598.0394.i = phi ptr [ %i.ia, %.noexc72 ], [ %i.hz, %.lr.ph.preheader.i ]
  %.sroa.090.0393.i = phi i64 [ %.sroa.090.1.i, %.noexc72 ], [ %i.hu, %.lr.ph.preheader.i ] ; 12 uses
  %.sroa.084.0392.i = phi i16 [ %.sroa.084.1.i, %.noexc72 ], [ %.sroa.058.0.i.i, %.lr.ph.preheader.i ] ; 5 uses
  %i.ia = getelementptr inbounds i8, ptr %.sroa.598.0394.i, i64 -1 ; 3 uses
  %i.ib = load i8, ptr %i.ia, align 1, !noalias !626, !noundef !4 ; 2 uses
  %i.ic = zext i8 %i.ib to i64                    ; 2 uses
  %i.id = icmp ult i8 %i.ib, 4
  br i1 %i.id, label %bb.bx, label %bb.by

bb.bx:                                            ; preds = %.lr.ph.i
  %i.ie = getelementptr inbounds nuw [32 x i8], ptr %i.bb, i64 %i.ic ; 10 uses
  %i.if = load i8, ptr %i.ie, align 8, !range !479, !alias.scope !548, !noalias !551, !noundef !4
...
bb.by:                                            ; preds = %.lr.ph.i
  invoke void @_RNvNtCsj6eKBz9Db1c_4core9panicking18panic_bounds_check(i64 noundef %i.ic, i64 noundef 4, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @52) #23
...
bb.ca:                                            ; preds = %bb.bx
  ...
  %.not178.i = icmp ugt i64 %.sroa.090.0393.i, %i.bh
  br i1 %.not178.i, label %.invoke443, label %bb.ce, !prof !46

bb.cb:                                            ; preds = %bb.bx
  %.not177.i = icmp ugt i64 %.sroa.090.0393.i, %i.bh
  br i1 %.not177.i, label %.invoke443, label %bb.ch, !prof !46

bb.cc:                                            ; preds = %bb.bx
  %.not176.i = icmp ugt i64 %.sroa.090.0393.i, %i.bh
  br i1 %.not176.i, label %.invoke443, label %bb.ci, !prof !46

bb.cd:                                            ; preds = %bb.bx
  %i.ig = load i16, ptr %i.bc, align 8, !alias.scope !548, !noalias !551, !noundef !4 ; 3 uses
  %i.ih = zext i16 %i.ig to i64
  %i.ii = load i16, ptr %i.bd, align 2, !alias.scope !548, !noalias !551, !noundef !4 ; 2 uses
  %i.ij = zext i16 %i.ii to i64
  %i.ik = shl nuw nsw i64 %i.ih, 2
  %i.il = mul nuw nsw i64 %i.ik, %i.ij
  %i.im = getelementptr inbounds nuw i8, ptr %i.ie, i64 2
  %i.in = load i16, ptr %i.im, align 2, !alias.scope !548, !noalias !551, !noundef !4
  %i.io = getelementptr inbounds nuw i8, ptr %i.ie, i64 16
  %i.ip = load ptr, ptr %i.io, align 8, !alias.scope !548, !noalias !551, !nonnull !4, !noundef !4
  %i.iq = getelementptr inbounds nuw i8, ptr %i.ie, i64 24
  %i.ir = load i64, ptr %i.iq, align 8, !alias.scope !548, !noalias !551, !noundef !4
  invoke void @_RNvNtCsksn9slvsHfS_10image_webp18lossless_transform30apply_color_indexing_transform(ptr noalias nofree noundef nonnull %i.bv, i64 noundef range(i64 0, -9223372036854775808) %i.bh, i16 noundef %i.ig, i16 noundef %i.ii, i16 noundef %i.in, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.ip, i64 noundef %i.ir)
          to label %.noexc72 unwind label %.loopexit149

bb.ce:                                            ; preds = %bb.ca
  %i.is = load i16, ptr %i.bd, align 2, !alias.scope !548, !noalias !551, !noundef !4
  %i.it = getelementptr inbounds nuw i8, ptr %i.ie, i64 1
  %i.iu = load i8, ptr %i.it, align 1, !alias.scope !548, !noalias !551, !noundef !4
  %i.iv = getelementptr inbounds nuw i8, ptr %i.ie, i64 16
  %i.iw = load ptr, ptr %i.iv, align 8, !alias.scope !548, !noalias !551, !nonnull !4, !noundef !4
  %i.ix = getelementptr inbounds nuw i8, ptr %i.ie, i64 24
  %i.iy = load i64, ptr %i.ix, align 8, !alias.scope !548, !noalias !551, !noundef !4
  invoke void @_RNvNtCsksn9slvsHfS_10image_webp18lossless_transform25apply_predictor_transform(ptr noalias nofree noundef nonnull sret([32 x i8]) align 8 captures(none) dereferenceable(32) %i.r, ptr noalias nofree noundef nonnull %i.bv, i64 noundef %.sroa.090.0393.i, i16 noundef %.sroa.084.0392.i, i16 noundef %i.is, i8 noundef %i.iu, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.iw, i64 noundef %i.iy)
          to label %.noexc74 unwind label %.loopexit149

.noexc74:                                         ; preds = %bb.ce
  %i.iz = load i8, ptr %i.r, align 8, !range !304, !noalias !567, !noundef !4 ; 2 uses
  %.not179.i = icmp eq i8 %i.iz, -1
...
.noexc72:                                         ; preds = %bb.ci, %bb.ch, %bb.cd, %bb.cg
  %.sroa.084.1.i = phi i16 [ %.sroa.084.0392.i, %bb.cg ], [ %i.ig, %bb.cd ], [ %.sroa.084.0392.i, %bb.ch ], [ %.sroa.084.0392.i, %bb.ci ]
  %.sroa.090.1.i = phi i64 [ %.sroa.090.0393.i, %bb.cg ], [ %i.il, %bb.cd ], [ %.sroa.090.0393.i, %bb.ch ], [ %.sroa.090.0393.i, %bb.ci ]
  %i.ja = icmp eq ptr %i.hw, %i.ia
  br i1 %i.ja, label %.loopexit154, label %.lr.ph.i

bb.ch:                                            ; preds = %bb.cb
  %i.jb = getelementptr inbounds nuw i8, ptr %i.ie, i64 1
  %i.jc = load i8, ptr %i.jb, align 1, !alias.scope !548, !noalias !551, !noundef !4
  %i.jd = getelementptr inbounds nuw i8, ptr %i.ie, i64 16
  %i.je = load ptr, ptr %i.jd, align 8, !alias.scope !548, !noalias !551, !nonnull !4, !noundef !4
  %i.jf = getelementptr inbounds nuw i8, ptr %i.ie, i64 24
  %i.jg = load i64, ptr %i.jf, align 8, !alias.scope !548, !noalias !551, !noundef !4
  invoke void @_RNvNtCsksn9slvsHfS_10image_webp18lossless_transform21apply_color_transform(ptr noalias nofree noundef nonnull %i.bv, i64 noundef %.sroa.090.0393.i, i16 noundef %.sroa.084.0392.i, i8 noundef %i.jc, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.je, i64 noundef %i.jg)
          to label %.noexc72 unwind label %.loopexit149

.invoke443:                                       ; preds = %bb.cc, %bb.cb, %bb.ca, %bb.bt
  %i.jh = phi i64 [ %i.hu, %bb.bt ], [ %.sroa.090.0393.i, %bb.ca ], [ %.sroa.090.0393.i, %bb.cb ], [ %.sroa.090.0393.i, %bb.cc ]
  %i.ji = phi ptr [ @57, %bb.bt ], [ @56, %bb.cc ], [ @55, %bb.cb ], [ @54, %bb.ca ]
  invoke void @_RNvNtNtCsj6eKBz9Db1c_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %i.jh, i64 noundef range(i64 0, -9223372036854775808) %i.bh, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.ji) #23
...
begin_hunk_1_@_RNvMNtCsksn9slvsHfS_10image_webp8losslessINtB2_15LosslessDecoderINtNtNtCsj6eKBz9Db1c_4core2io4util4TakeQINtNtB15_6cursor6CursorRShEEE15read_transformsCsa5QsYiPB8Gl_5image:bb.a
  ...
  %i.dw = lshr i32 %i.dv, %i.ds                   ; 2 uses
  %i.dx = load i16, ptr %i.ab, align 2, !noundef !4
...
.loopexit248:                                     ; preds = %bb.x, %bb.y
  %.sroa.9206.3.ph = phi i16 [ %.sroa.9206.0.copyload, %bb.y ], [ %.sroa.9206.0, %bb.x ]
  %.sroa.8205.2.ph = phi i8 [ %.sroa.8205.0.copyload, %bb.y ], [ undef, %bb.x ]
  ...
  store i8 %.sroa.8205.2.ph, ptr %.sroa.4120.0..sroa_idx, align 1
  %.sroa.5121.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 2
  store i16 %.sroa.9206.3.ph, ptr %.sroa.5121.0..sroa_idx, align 2
...
bb.ay:                                            ; preds = %bb.aw, %bb.ax, %bb.av
  ...
  %i.fa = trunc nuw i32 %i.ey to i16
  br i1 %i.ez, label %bb.az, label %bb.ba, !prof !6
...
bb.ba:                                            ; preds = %bb.ay
  %i.fb = load ptr, ptr %i.z, align 8, !nonnull !4, !noundef !4 ; 3 uses
  %i.fc = load i64, ptr %i.aa, align 8, !noundef !4 ; 3 uses
  %i.fd = icmp samesign ugt i64 %i.fc, 4
  br i1 %i.fd, label %.lr.ph.preheader.i.preheader, label %_RNvMNtCsksn9slvsHfS_10image_webp8losslessINtB2_15LosslessDecoderINtNtNtCsj6eKBz9Db1c_4core2io4util4TakeQINtNtB15_6cursor6CursorRShEEE16adjust_color_mapCsa5QsYiPB8Gl_5image.exit

.lr.ph.preheader.i.preheader:                     ; preds = %bb.ba
  %i.fe = add i64 %i.fc, -4                       ; 3 uses
  %min.iters.check = icmp ult i64 %i.fe, 4
  br i1 %min.iters.check, label %.lr.ph.preheader.i.preheader963, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph.preheader.i.preheader
  %n.vec = and i64 %i.fe, -4                      ; 3 uses
  %i.ff = add i64 %n.vec, 4
  %load_initial = load <4 x i8>, ptr %i.fb, align 1
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %store_forwarded = phi <4 x i8> [ %load_initial, %vector.ph ], [ %i.fi, %vector.body ]
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.fg = getelementptr inbounds nuw i8, ptr %i.fb, i64 %index
  %i.fh = getelementptr inbounds nuw i8, ptr %i.fg, i64 4 ; 2 uses
  %wide.load = load <4 x i8>, ptr %i.fh, align 1, !alias.scope !813
  %i.fi = add <4 x i8> %store_forwarded, %wide.load ; 2 uses
  store <4 x i8> %i.fi, ptr %i.fh, align 1, !alias.scope !813
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.fj = icmp eq i64 %index.next, %n.vec
  br i1 %i.fj, label %middle.block, label %vector.body, !llvm.loop !816

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %i.fe, %n.vec
  br i1 %cmp.n, label %_RNvMNtCsksn9slvsHfS_10image_webp8losslessINtB2_15LosslessDecoderINtNtNtCsj6eKBz9Db1c_4core2io4util4TakeQINtNtB15_6cursor6CursorRShEEE16adjust_color_mapCsa5QsYiPB8Gl_5image.exit, label %.lr.ph.preheader.i.preheader963

.lr.ph.preheader.i.preheader963:                  ; preds = %.lr.ph.preheader.i.preheader, %middle.block
  %.sroa.01.04.i.ph = phi i64 [ 4, %.lr.ph.preheader.i.preheader ], [ %i.ff, %middle.block ]
  br label %.lr.ph.preheader.i

.lr.ph.preheader.i:                               ; preds = %.lr.ph.preheader.i.preheader963, %.lr.ph.preheader.i
  %.sroa.01.04.i = phi i64 [ %i.fl, %.lr.ph.preheader.i ], [ %.sroa.01.04.i.ph, %.lr.ph.preheader.i.preheader963 ] ; 2 uses
  %i.fk = getelementptr inbounds nuw i8, ptr %i.fb, i64 %.sroa.01.04.i ; 3 uses
  %i.fl = add nuw nsw i64 %.sroa.01.04.i, 1       ; 2 uses
  %i.fm = load i8, ptr %i.fk, align 1, !alias.scope !813, !noundef !4
  %i.fn = getelementptr i8, ptr %i.fk, i64 -4
  %i.fo = load i8, ptr %i.fn, align 1, !alias.scope !813, !noundef !4
  %i.fp = add i8 %i.fo, %i.fm
  store i8 %i.fp, ptr %i.fk, align 1, !alias.scope !813
  %exitcond.not.i = icmp eq i64 %i.fl, %i.fc
...
bb.a:
  ...
  %i.be = getelementptr inbounds nuw i8, ptr %1, i64 152 ; 29 uses
