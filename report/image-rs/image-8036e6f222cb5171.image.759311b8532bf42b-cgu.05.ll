...
bb.z:                                             ; preds = %bb.cu, %bb.cm, %bb.ce, %bb.bx, %bb.bt, %bb.bm, %bb.bi, %bb.az, %bb.aw, %bb.as, %bb.aj, %bb.af, %bb.ad, %bb.p, %bb.o, %bb.j
  ...
  %.sroa.31.sroa.0.0.a = phi i32 [ undef, %bb.j ], [ undef, %bb.ad ], [ undef, %bb.af ], [ %.sroa.03.0.i615, %bb.aj ], [ %.sroa.03.0.i659, %bb.as ], [ undef, %bb.o ], [ undef, %bb.p ], [ undef, %bb.aw ], [ %.sroa.03.0.i530, %bb.az ], [ %.sroa.03.0.i644, %bb.bi ], [ %.sroa.03.0.i491.a, %bb.bm ], [ undef, %bb.bt ], [ %.sroa.03.0.i591, %bb.bx ], [ undef, %bb.ce ], [ undef, %bb.cm ], [ undef, %bb.cu ]
  %.sroa.31.sroa.0.0 = phi i64 [ undef, %bb.j ], [ %i.eo, %bb.ad ], [ undef, %bb.af ], [ undef, %bb.aj ], [ %.sroa.31.sroa.0.0.insert.ext, %bb.as ], [ undef, %bb.o ], [ undef, %bb.p ], [ undef, %bb.aw ], [ undef, %bb.az ], [ %.sroa.31.sroa.0.0.insert.ext53, %bb.bi ], [ undef, %bb.bm ], [ %.sroa.03.0.i636, %bb.bt ], [ undef, %bb.bx ], [ %.sroa.04.0.i672, %bb.ce ], [ %.sroa.04.0.i651, %bb.cm ], [ %.sroa.04.0.i666, %bb.cu ]
  ...
  store i32 %.sroa.31.sroa.0.0.a, ptr %.sroa.25.0..sroa_idx, align 4
  %.sroa.31.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i64 %.sroa.31.sroa.0.0, ptr %.sroa.31.0..sroa_idx, align 8
...
bb.aa:                                            ; preds = %bb.k
  ...
  %i.eo = load i64, ptr %i.en, align 8, !range !118, !noundef !4 ; 2 uses
...
bb.as:                                            ; preds = %bb.aq
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !131
  %.sroa.31.sroa.0.0.insert.ext = zext i32 %.sroa.03.0.i655 to i64
  br label %bb.z
...
bb.bi:                                            ; preds = %bb.bg
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g), !noalias !146
  %.sroa.31.sroa.0.0.insert.ext53 = zext i32 %.sroa.03.0.i640 to i64
  br label %bb.z
...
bb.bt:                                            ; preds = %bb.br
  ...
  %.sroa.03.0.i636 = select i1 %i.ib, i64 %i.ic, i64 %.sroa.05.0.copyload.i634
  call void @llvm.lifetime.end.p0(ptr nonnull %i.h), !noalias !154
  br label %bb.z
...
bb.ce:                                            ; preds = %bb.cc
  ...
  %.sroa.04.0.i672 = select i1 %i.ix, i64 %i.iy, i64 %.sroa.06.0.copyload.i670
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !159
  br label %bb.z
...
bb.cm:                                            ; preds = %bb.ck
  ...
  %.sroa.04.0.i651 = select i1 %i.jn, i64 %i.jo, i64 %.sroa.06.0.copyload.i649
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e), !noalias !163
  br label %bb.z
...
bb.cu:                                            ; preds = %bb.cs
  ...
  %.sroa.04.0.i666 = select i1 %i.kd, i64 %i.ke, i64 %.sroa.06.0.copyload.i664
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !167
  br label %bb.z
...
bb.dh:                                            ; preds = %.noexc562
  ...
  %.sroa.12.sroa.0.0.insert.ext = zext i32 %.sroa.03.0.i561 to i64
...
bb.di:                                            ; preds = %bb.eb, %bb.dy, %bb.dv, %bb.ds, %bb.do, %bb.dh
  %.sroa.12.sroa.10.0 = phi i64 [ %.sroa.12.sroa.0.0.insert.ext, %bb.dh ], [ %.sroa.12.sroa.0.0.insert.ext19, %bb.do ], [ %.sroa.03.0.i497, %bb.ds ], [ %.sroa.04.0.i630, %bb.dv ], [ %.sroa.04.0.i, %bb.dy ], [ %.sroa.04.0.i623, %bb.eb ]
  ...
  store i64 %.sroa.12.sroa.10.0, ptr %.sroa.12.0..sroa_idx, align 8
  store i64 0, ptr %0, align 8
  br label %bb.c
...
bb.do:                                            ; preds = %.noexc519
  ...
  %.sroa.12.sroa.0.0.insert.ext19 = zext i32 %.sroa.03.0.i518 to i64
...
bb.ds:                                            ; preds = %.noexc498
  ...
  %.sroa.03.0.i497 = select i1 %i.lo, i64 %i.lp, i64 %.sroa.05.0.copyload.i495
...
bb.dv:                                            ; preds = %.noexc631
  ...
  %.sroa.04.0.i630 = select i1 %i.lu, i64 %i.lv, i64 %.sroa.06.0.copyload.i628
...
bb.dy:                                            ; preds = %.noexc535
  ...
  %.sroa.04.0.i = select i1 %i.ma, i64 %i.mb, i64 %.sroa.06.0.copyload.i
...
bb.eb:                                            ; preds = %.noexc624
  ...
  %.sroa.04.0.i623 = select i1 %i.mg, i64 %i.mh, i64 %.sroa.06.0.copyload.i621
...
.noexc50:                                         ; preds = %bb.dx, %bb.cz, %bb.dw, %.noexc49
  %.sroa.50.sroa.0.0 = phi i16 [ %.sroa.50.0.copyload56, %bb.dw ], [ undef, %bb.cz ], [ undef, %.noexc49 ], [ undef, %bb.dx ]
  %.sroa.78.1.a = phi i64 [ %.sroa.5061.0.copyload63, %bb.dw ], [ undef, %bb.cz ], [ %i.hu, %.noexc49 ], [ undef, %bb.dx ]
  %.sroa.70.1 = phi ptr [ %.sroa.70.0.copyload67, %bb.dw ], [ undef, %bb.cz ], [ undef, %.noexc49 ], [ undef, %bb.dx ]
  %.sroa.78.1 = phi i64 [ %.sroa.78.0.copyload74, %bb.dw ], [ undef, %bb.cz ], [ undef, %.noexc49 ], [ undef, %bb.dx ]
...
.thread143:                                       ; preds = %bb.bf, %.noexc50, %bb.dl, %bb.dm, %bb.bd, %.noexc38, %.noexc36, %.noexc35, %.noexc34, %.noexc33
  %.sroa.50.sroa.0.1 = phi i16 [ undef, %bb.bf ], [ %.sroa.50.sroa.0.0, %.noexc50 ], [ undef, %bb.dl ], [ %.sroa.50.1.copyload59, %bb.dm ], [ undef, %.noexc38 ], [ undef, %.noexc36 ], [ undef, %.noexc35 ], [ undef, %.noexc34 ], [ undef, %.noexc33 ], [ %.sroa.50.1.copyload, %bb.bd ]
  %.sroa.78.0.ph.a = phi i64 [ %i.dx, %bb.bf ], [ %.sroa.78.1.a, %.noexc50 ], [ %i.hh, %bb.dl ], [ %.sroa.5410.0.copyload.i, %bb.dm ], [ undef, %.noexc38 ], [ undef, %.noexc36 ], [ undef, %.noexc35 ], [ undef, %.noexc34 ], [ undef, %.noexc33 ], [ %.sroa.5061.1.copyload, %bb.bd ]
  %.sroa.70.0.ph = phi ptr [ undef, %bb.bf ], [ %.sroa.70.1, %.noexc50 ], [ undef, %bb.dl ], [ %i.hi, %bb.dm ], [ undef, %.noexc38 ], [ undef, %.noexc36 ], [ undef, %.noexc35 ], [ undef, %.noexc34 ], [ undef, %.noexc33 ], [ %.sroa.70.1.copyload, %bb.bd ]
  %.sroa.78.0.ph = phi i64 [ undef, %bb.bf ], [ %.sroa.78.1, %.noexc50 ], [ undef, %bb.dl ], [ %.sroa.8413.0.copyload.i, %bb.dm ], [ undef, %.noexc38 ], [ undef, %.noexc36 ], [ undef, %.noexc35 ], [ undef, %.noexc34 ], [ undef, %.noexc33 ], [ %.sroa.78.1.copyload, %bb.bd ]
  %.sroa.0.0.ph = phi i8 [ 0, %bb.bf ], [ %.sroa.0.1, %.noexc50 ], [ 0, %bb.dl ], [ %.lcssa.i, %bb.dm ], [ 3, %.noexc38 ], [ 3, %.noexc36 ], [ 3, %.noexc35 ], [ 3, %.noexc34 ], [ 3, %.noexc33 ], [ %i.bm, %bb.bd ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.x), !noalias !1546
  br label %.sink.split

.thread151:                                       ; preds = %bb.bo, %bb.ch, %bb.br, %bb.cf, %bb.cd, %bb.by, %bb.bt
  %.sroa.50.sroa.0.2 = phi i16 [ undef, %bb.ch ], [ undef, %bb.br ], [ undef, %bb.cf ], [ undef, %bb.cd ], [ %.sroa.50.1.copyload60, %bb.by ], [ undef, %bb.bt ], [ undef, %bb.bo ]
  %.sroa.78.2.ph.a = phi i64 [ %i.fh, %bb.ch ], [ %i.ep, %bb.br ], [ %i.fg, %bb.cf ], [ %i.fe, %bb.cd ], [ %.sroa.5362.0.copyload.i, %bb.by ], [ %i.er, %bb.bt ], [ undef, %bb.bo ]
  %.sroa.70.2.ph = phi ptr [ undef, %bb.ch ], [ undef, %bb.br ], [ undef, %bb.cf ], [ undef, %bb.cd ], [ %i.fb, %bb.by ], [ undef, %bb.bt ], [ undef, %bb.bo ]
  %.sroa.78.2.ph = phi i64 [ undef, %bb.ch ], [ undef, %bb.br ], [ undef, %bb.cf ], [ undef, %bb.cd ], [ %.sroa.8365.0.copyload.i, %bb.by ], [ undef, %bb.bt ], [ undef, %bb.bo ]
  %.sroa.0.2.ph = phi i8 [ 0, %bb.ch ], [ 0, %bb.br ], [ 0, %bb.cf ], [ 0, %bb.cd ], [ %i.fa, %bb.by ], [ 0, %bb.bt ], [ 27, %bb.bo ]
...
.sink.split:                                      ; preds = %bb.h, %bb.i, %_RNvMNtCsksn9slvsHfS_10image_webp7decoderNtB2_13WebPRiffChunk9to_fourcc.exit.i, %bb.z, %bb.av, %bb.ay, %bb.az, %bb.bc, %bb.ak, %bb.e, %bb.au, %bb.af, %bb.ab, %.thread143, %.thread151
  %.sroa.50.sroa.0.3.ph = phi i16 [ %.sroa.50.sroa.0.2, %.thread151 ], [ %.sroa.50.sroa.0.1, %.thread143 ], [ undef, %bb.ab ], [ undef, %bb.af ], [ undef, %bb.au ], [ undef, %bb.e ], [ undef, %bb.ak ], [ undef, %bb.bc ], [ undef, %bb.az ], [ undef, %bb.ay ], [ undef, %bb.av ], [ undef, %bb.z ], [ undef, %_RNvMNtCsksn9slvsHfS_10image_webp7decoderNtB2_13WebPRiffChunk9to_fourcc.exit.i ], [ undef, %bb.i ], [ undef, %bb.h ]
  %.sroa.0.4128.ph = phi i8 [ %.sroa.0.2.ph, %.thread151 ], [ %.sroa.0.0.ph, %.thread143 ], [ 4, %bb.ab ], [ 0, %bb.af ], [ %.sroa.0.3, %bb.au ], [ 0, %bb.e ], [ 24, %bb.ak ], [ 12, %bb.bc ], [ 0, %bb.az ], [ 11, %bb.ay ], [ 0, %bb.av ], [ 0, %bb.z ], [ 2, %_RNvMNtCsksn9slvsHfS_10image_webp7decoderNtB2_13WebPRiffChunk9to_fourcc.exit.i ], [ 0, %bb.i ], [ 4, %bb.h ]
  %.sroa.5061.4131.ph = phi i64 [ %.sroa.78.2.ph, %.thread151 ], [ %.sroa.78.0.ph, %.thread143 ], [ 19, %bb.ab ], [ 19, %bb.af ], [ 19, %bb.au ], [ 19, %bb.e ], [ 19, %bb.ak ], [ 19, %bb.bc ], [ 19, %bb.az ], [ 19, %bb.ay ], [ 19, %bb.av ], [ 19, %bb.z ], [ 19, %_RNvMNtCsksn9slvsHfS_10image_webp7decoderNtB2_13WebPRiffChunk9to_fourcc.exit.i ], [ 19, %bb.i ], [ 19, %bb.h ]
  %.sroa.70.3126.ph = phi ptr [ %.sroa.70.2.ph, %.thread151 ], [ %.sroa.70.0.ph, %.thread143 ], [ undef, %bb.ab ], [ undef, %bb.af ], [ undef, %bb.au ], [ null, %bb.e ], [ %i.cb, %bb.ak ], [ undef, %bb.bc ], [ undef, %bb.az ], [ undef, %bb.ay ], [ undef, %bb.av ], [ null, %bb.z ], [ undef, %_RNvMNtCsksn9slvsHfS_10image_webp7decoderNtB2_13WebPRiffChunk9to_fourcc.exit.i ], [ undef, %bb.i ], [ undef, %bb.h ]
  %.sroa.5057.sroa.0.4125.ph = phi i64 [ %.sroa.78.2.ph.a, %.thread151 ], [ %.sroa.78.0.ph.a, %.thread143 ], [ undef, %bb.ab ], [ %i.bp, %bb.af ], [ %.sroa.5061.3, %bb.au ], [ %.sroa.9.0.ph.i, %bb.e ], [ %i.bx, %bb.ak ], [ undef, %bb.bc ], [ %i.cu, %bb.az ], [ undef, %bb.ay ], [ %i.cq, %bb.av ], [ %.sroa.9538.0.ph.i, %bb.z ], [ undef, %_RNvMNtCsksn9slvsHfS_10image_webp7decoderNtB2_13WebPRiffChunk9to_fourcc.exit.i ], [ %i.ay, %bb.i ], [ undef, %bb.h ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.p)
  br label %bb.eb

bb.eb:                                            ; preds = %.sink.split, %.loopexit158
  %.sroa.50.sroa.0.3 = phi i16 [ %.sroa.50.0.copyload58, %.loopexit158 ], [ %.sroa.50.sroa.0.3.ph, %.sink.split ]
  %.sroa.0.4128 = phi i8 [ %.sroa.0.0.copyload52, %.loopexit158 ], [ %.sroa.0.4128.ph, %.sink.split ]
  %.sroa.5061.4131 = phi i64 [ %.sroa.78.0.copyload76, %.loopexit158 ], [ %.sroa.5061.4131.ph, %.sink.split ]
  %.sroa.70.3126 = phi ptr [ %.sroa.70.0.copyload69, %.loopexit158 ], [ %.sroa.70.3126.ph, %.sink.split ]
  %.sroa.5057.sroa.0.4125 = phi i64 [ %.sroa.5061.0.copyload65, %.loopexit158 ], [ %.sroa.5057.sroa.0.4125.ph, %.sink.split ]
  ...
  store i8 %.sroa.0.4128, ptr %i.hw, align 8
  %.sroa.5119.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 14
  store i16 %.sroa.50.sroa.0.3, ptr %.sroa.5119.0..sroa_idx, align 2
  %.sroa.6120.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i64 %.sroa.5057.sroa.0.4125, ptr %.sroa.6120.0..sroa_idx, align 8
  %.sroa.7121.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 24
  store ptr %.sroa.70.3126, ptr %.sroa.7121.0..sroa_idx, align 8
  %.sroa.8122.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 32
  store i64 %.sroa.5061.4131, ptr %.sroa.8122.0..sroa_idx, align 8
