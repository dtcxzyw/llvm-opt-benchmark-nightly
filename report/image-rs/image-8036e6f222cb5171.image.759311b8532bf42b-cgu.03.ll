...
.lr.ph45.i56:                                     ; preds = %.lr.ph45.i56, %.lr.ph45.i56.preheader.new
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.gi, ptr noundef nonnull align 8 dereferenceable(16) %i.gh, i64 16, i1 false), !alias.scope !1384
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.gn, ptr noundef nonnull align 8 dereferenceable(16) %i.gl, i64 16, i1 false), !alias.scope !1384
...
.lr.ph45.i56.epil.preheader:                      ; preds = %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable9quicksort16stable_partitionNtNtNtCsa5QsYiPB8Gl_5image6images4flat3DimNCINvB2_9quicksortB1d_NvYB1d_NtNtBa_3cmp10PartialOrd2ltE0EB1j_.exit.unr-lcssa, %.lr.ph45.i56.preheader
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.gq, ptr noundef nonnull align 8 dereferenceable(16) %i.gp, i64 16, i1 false), !alias.scope !1384
...
_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable9quicksort16stable_partitionNtNtNtCsa5QsYiPB8Gl_5image6images4flat3DimNCINvB2_9quicksortB1d_NvYB1d_NtNtBa_3cmp10PartialOrd2ltE0EB1j_.exit: ; preds = %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable9quicksort16stable_partitionNtNtNtCsa5QsYiPB8Gl_5image6images4flat3DimNCINvB2_9quicksortB1d_NvYB1d_NtNtBa_3cmp10PartialOrd2ltE0EB1j_.exit.unr-lcssa, %.lr.ph45.i56.epil.preheader
  ...
  br i1 %i.gr, label %bb.y, label %.outer, !prof !18
...
bb.e:                                             ; preds = %.lr.ph
  ...
  %.val = load i64, ptr %i.l, align 8, !alias.scope !27, !noalias !28, !noundef !7
  %.val11 = load i64, ptr %i.m, align 8, !alias.scope !28, !noalias !27, !noundef !7
...
bb.f:                                             ; preds = %bb.e, %.lr.ph
  ...
  %.val12 = load i64, ptr %i.q, align 8, !alias.scope !27, !noalias !28, !noundef !7
  %.val13 = load i64, ptr %i.r, align 8, !alias.scope !28, !noalias !27, !noundef !7
...
bb.c:                                             ; preds = %bb.b
  %i.e = load i64, ptr %0, align 8, !range !11, !alias.scope !1393, !noundef !7 ; 2 uses
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !1393
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %.val13.i = load ptr, ptr %i.i, align 8, !alias.scope !1393
  call fastcc void @_RNvMs5_NtCs4wP2HXfJTCR_5alloc7raw_vecNtB5_11RawVecInner11finish_growCsa5QsYiPB8Gl_5image(ptr noalias nofree noundef align 8 captures(none) dereferenceable(24) %i.a, i64 %i.e, ptr %.val13.i, i64 noundef %..i14.i, i64 noundef range(i64 1, -9223372036854775807) %3, i64 noundef %4), !noalias !1393
  %i.j = load i64, ptr %i.a, align 8, !range !19, !noalias !1393, !noundef !7
  %i.k = trunc nuw i64 %i.j to i1
  %i.l = getelementptr inbounds nuw i8, ptr %i.a, i64 8 ; 2 uses
  br i1 %i.k, label %bb.d, label %bb.f

bb.d:                                             ; preds = %bb.c
  %i.m = load i64, ptr %i.l, align 8, !range !32, !noalias !1393, !noundef !7
  %i.n = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  %i.o = load i64, ptr %i.n, align 8, !noalias !1393
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !1393
  br label %bb.e
...
bb.f:                                             ; preds = %bb.c
  %i.p = load ptr, ptr %i.l, align 8, !noalias !1393, !nonnull !7, !noundef !7
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !1393
  store ptr %i.p, ptr %i.i, align 8, !alias.scope !1393
  %i.q = icmp sgt i64 %..i14.i, -1
  tail call void @llvm.assume(i1 %i.q)
  store i64 %..i14.i, ptr %0, align 8, !alias.scope !1393
  ret void
}
...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !alias.scope !1409, !noalias !1410, !noundef !7 ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.d = load i64, ptr %i.c, align 8, !alias.scope !1409, !noalias !1410, !noundef !7 ; 2 uses
  %.sroa.0.0.copyload.i = load ptr, ptr %1, align 8, !alias.scope !1410, !noalias !1409 ; 2 uses
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %1, i64 8
  %.sroa.4.0.copyload.i = load i64, ptr %.sroa.4.0..sroa_idx.i, align 8, !alias.scope !1410, !noalias !1409 ; 2 uses
  %.sroa.6.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %1, i64 16
  %.sroa.6.0.copyload.i = load ptr, ptr %.sroa.6.0..sroa_idx.i, align 8, !alias.scope !1410, !noalias !1409
  %.sroa.7.24.copyload.i = load ptr, ptr %0, align 8, !alias.scope !1409, !noalias !1410 ; 2 uses
  %.sroa.9.24..sroa_idx.i = getelementptr inbounds nuw i8, ptr %0, i64 8
  %.sroa.9.24.copyload.i = load i64, ptr %.sroa.9.24..sroa_idx.i, align 8, !alias.scope !1409, !noalias !1410
  %.sroa.10.24..sroa_idx.i = getelementptr inbounds nuw i8, ptr %0, i64 16
  %.sroa.10.24.copyload.i = load i64, ptr %.sroa.10.24..sroa_idx.i, align 8, !alias.scope !1409, !noalias !1410
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.i.i
  ...
  %i.h = load i64, ptr %.sroa.7.24.copyload.i, align 8, !noalias !1411, !noundef !7
  ...
  %i.j = load float, ptr %.sroa.speculated.i, align 4, !noalias !1411, !noundef !7
  ...
  store i64 %.sroa.0.0.i.i.i.i.i, ptr %i.n, align 8, !noalias !1412
...
_RINvXs0_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3mapINtB6_3MapINtNtNtBc_3ops5range5RangejENCNvNtNtCsa5QsYiPB8Gl_5image8imageops9fast_blur15boxes_for_gauss0ENtNtNtBa_6traits8iterator8Iterator4folduNCINvB6_8map_foldjjuNCB1r_s_0NCINvNvB2t_8for_each4calljNCINvMsk_NtCs4wP2HXfJTCR_5alloc3vecINtB49_3VecjE14extend_trustedIBO_BN_B3r_EE0E0E0EB1x_.exit: ; preds = %bb.b, %bb.a
  ...
  store i64 %.val6.i.i, ptr %.sroa.0.0.copyload.i, align 8, !noalias !1413
  ret void
}
...
bb.a:
  ...
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.c = load ptr, ptr %i.b, align 8, !noundef !7
...
; Function Attrs: nonlazybind uwtable
define hidden void @_RINvXs0_NtNtNtCsj6eKBz9Db1c_4core4iter8adapters3mapINtB6_3MapINtNtB8_6copied6CopiedINtNtNtBc_5slice4iter4ItertEENvYfINtNtCsa5QsYiPB8Gl_5image5color13FromPrimitivetE14from_primitiveENtNtNtBa_6traits8iterator8Iterator4folduNCINvNvB2T_8for_each4callfNCINvMsk_NtCs4wP2HXfJTCR_5alloc3vecINtB46_3VecfE14extend_trustedBN_E0E0EB1V_(ptr noundef nonnull %0, ptr noundef %1, ptr noalias nofree noundef readonly align 8 captures(none) dead_on_return dereferenceable(24) %2) unnamed_addr #0 {
end_hunk_0
