...
bb.g:                                             ; preds = %bb.f
  tail call void @_RNvNtCsj6eKBz9Db1c_4core9panicking5panic(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @72, i64 noundef 56, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @73) #28, !noalias !963
  unreachable
...
_RNvNtNtCsa5QsYiPB8Gl_5image6codecs3dxt17decode_dxt3_block.exit: ; preds = %bb.f
  ...
  %i.ah = load <8 x i8>, ptr %.sroa.0.023, align 1, !alias.scope !958, !noalias !961
  ...
  store i8 %i.an, ptr %i.g, align 1, !alias.scope !961, !noalias !958
  %i.ao = extractelement <16 x i8> %i.am, i64 1
  store i8 %i.ao, ptr %i.h, align 1, !alias.scope !961, !noalias !958
  %i.ap = extractelement <16 x i8> %i.am, i64 2
  store i8 %i.ap, ptr %i.i, align 1, !alias.scope !961, !noalias !958
  %i.aq = extractelement <16 x i8> %i.am, i64 3
  store i8 %i.aq, ptr %i.j, align 1, !alias.scope !961, !noalias !958
  %i.ar = extractelement <16 x i8> %i.am, i64 4
  store i8 %i.ar, ptr %i.k, align 1, !alias.scope !961, !noalias !958
  %i.as = extractelement <16 x i8> %i.am, i64 5
  store i8 %i.as, ptr %i.l, align 1, !alias.scope !961, !noalias !958
  %i.at = extractelement <16 x i8> %i.am, i64 6
  store i8 %i.at, ptr %i.m, align 1, !alias.scope !961, !noalias !958
  %i.au = extractelement <16 x i8> %i.am, i64 7
  store i8 %i.au, ptr %i.n, align 1, !alias.scope !961, !noalias !958
  %i.av = extractelement <16 x i8> %i.am, i64 8
  store i8 %i.av, ptr %i.o, align 1, !alias.scope !961, !noalias !958
  %i.aw = extractelement <16 x i8> %i.am, i64 9
  store i8 %i.aw, ptr %i.p, align 1, !alias.scope !961, !noalias !958
  %i.ax = extractelement <16 x i8> %i.am, i64 10
  store i8 %i.ax, ptr %i.q, align 1, !alias.scope !961, !noalias !958
  %i.ay = extractelement <16 x i8> %i.am, i64 11
  store i8 %i.ay, ptr %i.r, align 1, !alias.scope !961, !noalias !958
  %i.az = extractelement <16 x i8> %i.am, i64 12
  store i8 %i.az, ptr %i.s, align 1, !alias.scope !961, !noalias !958
  %i.ba = extractelement <16 x i8> %i.am, i64 13
  store i8 %i.ba, ptr %i.t, align 1, !alias.scope !961, !noalias !958
  %i.bb = extractelement <16 x i8> %i.am, i64 14
  store i8 %i.bb, ptr %i.u, align 1, !alias.scope !961, !noalias !958
  %i.bc = extractelement <16 x i8> %i.am, i64 15
  store i8 %i.bc, ptr %i.v, align 1, !alias.scope !961, !noalias !958
...
bb.i:                                             ; preds = %_RNvNtNtCsa5QsYiPB8Gl_5image6codecs3dxt17decode_dxt3_block.exit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %i.bf, ptr noundef nonnull readonly align 1 dereferenceable(16) %i.a, i64 16, i1 false), !alias.scope !964, !noalias !968
...
bb.j:                                             ; preds = %bb.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %i.bj, ptr noundef nonnull readonly align 1 dereferenceable(16) %i.x, i64 16, i1 false), !alias.scope !964, !noalias !968
...
bb.k:                                             ; preds = %bb.j
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %i.bm, ptr noundef nonnull readonly align 1 dereferenceable(16) %i.z, i64 16, i1 false), !alias.scope !964, !noalias !968
...
.loopexit:                                        ; preds = %bb.k
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %i.bq, ptr noundef nonnull readonly align 1 dereferenceable(16) %i.ab, i64 16, i1 false), !alias.scope !964, !noalias !968
...
.lr.ph.i.preheader.i:                             ; preds = %bb.f
  ...
  %.val.i.i = load i8, ptr %.ptr.i, align 1, !alias.scope !970, !noalias !973, !noundef !5
  %.ptr.1.i = getelementptr inbounds nuw i8, ptr %.sroa.0.023, i64 6
  %.val.i.1.i = load i8, ptr %.ptr.1.i, align 1, !alias.scope !970, !noalias !973, !noundef !5
  %.ptr.2.i = getelementptr inbounds nuw i8, ptr %.sroa.0.023, i64 5
  %.val.i.2.i = load i8, ptr %.ptr.2.i, align 1, !alias.scope !970, !noalias !973, !noundef !5
  %.ptr.3.i = getelementptr inbounds nuw i8, ptr %.sroa.0.023, i64 4
  %.val.i.3.i = load i8, ptr %.ptr.3.i, align 1, !alias.scope !970, !noalias !973, !noundef !5
  %.ptr.4.i = getelementptr inbounds nuw i8, ptr %.sroa.0.023, i64 3
  %.val.i.4.i = load i8, ptr %.ptr.4.i, align 1, !alias.scope !970, !noalias !973, !noundef !5
  %.ptr.5.i = getelementptr inbounds nuw i8, ptr %.sroa.0.023, i64 2
  %.val.i.5.i = load i8, ptr %.ptr.5.i, align 1, !alias.scope !970, !noalias !973, !noundef !5
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !975
  %4 = load <2 x i8>, ptr %.sroa.0.023, align 1, !alias.scope !970, !noalias !973 ; 3 uses
  %5 = extractelement <2 x i8> %4, i64 1          ; 4 uses
  %6 = extractelement <2 x i8> %4, i64 0          ; 4 uses
  %7 = icmp ugt i8 %6, %5
  %8 = zext i8 %5 to i64                          ; 5 uses
  %9 = shufflevector <2 x i8> %4, <2 x i8> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
  %10 = zext <4 x i8> %9 to <4 x i16>             ; 2 uses
  %11 = zext i8 %6 to i64                         ; 3 uses
  %12 = shl nuw nsw i64 %8, 1                     ; 2 uses
  %13 = shl nuw nsw i64 %8, 2                     ; 2 uses
  br i1 %7, label %.preheader.i.i, label %.preheader9.i.i

bb.g:                                             ; preds = %bb.f
  tail call void @_RNvNtCsj6eKBz9Db1c_4core9panicking5panic(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @72, i64 noundef 56, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @74) #28, !noalias !975
  unreachable

.preheader9.i.i:                                  ; preds = %.lr.ph.i.preheader.i
  %14 = mul nuw nsw <4 x i16> %10, <i16 1, i16 3, i16 3, i16 4>
  %15 = trunc nuw nsw i64 %13 to i16
  %i.ah = insertelement <4 x i16> poison, i16 %15, i64 0
  %.tr = zext i8 %6 to i16
  %16 = shl nuw nsw i16 %.tr, 1
  %17 = insertelement <4 x i16> %i.ah, i16 %16, i64 1
  %18 = trunc nuw nsw i64 %12 to i16
  %i.ai = insertelement <4 x i16> %17, i16 %18, i64 2
  %19 = zext i8 %5 to i16
  %i.aj = insertelement <4 x i16> %i.ai, i16 %19, i64 3
  %i.ak = add <4 x i16> %i.aj, %14
...
.preheader.i.i:                                   ; preds = %.lr.ph.i.preheader.i
  %20 = mul nuw nsw <4 x i16> %10, <i16 3, i16 3, i16 5, i16 6>
  %21 = trunc nuw nsw i64 %13 to i16
  %22 = insertelement <4 x i16> poison, i16 %21, i64 0
  %.tr27 = zext i8 %6 to i16
  %23 = shl nuw nsw i16 %.tr27, 2
  %24 = insertelement <4 x i16> %22, i16 %23, i64 1
  %25 = trunc nuw nsw i64 %12 to i16
  %26 = insertelement <4 x i16> %24, i16 %25, i64 2
  %27 = zext i8 %5 to i16
  %i.am = insertelement <4 x i16> %26, i16 %27, i64 3
  %i.an = add <4 x i16> %20, %i.am
  %i.ao = udiv <4 x i16> %i.an, splat (i16 7)
  %28 = shl nuw nsw i64 %11, 1
  %29 = mul nuw nsw i64 %8, 5
  %30 = add nuw nsw i64 %29, %28
  %31 = trunc nuw nsw i64 %30 to i16
  %i.ap = udiv i16 %31, 7
  %32 = mul nuw nsw i64 %8, 6
...
_RNvNtNtCsa5QsYiPB8Gl_5image6codecs3dxt17decode_dxt5_block.exit: ; preds = %.preheader9.i.i, %.preheader.i.i
  ...
  %.sroa.3.0.insert.shift.i.i.a = shl nuw nsw i64 %8, 8
  %35 = or disjoint i64 %.sroa.12.0.insert.shift.i.i, %.sroa.3.0.insert.shift.i.i.a
  %.sroa.9.0.insert.insert.masked.masked.masked.i.i = or disjoint i64 %35, %11
  %.sroa.3.0.insert.mask.masked.masked.i.i = or i64 %.sroa.15.0.insert.insert.i.i, %.sroa.9.0.insert.shift.i.i
  %.sroa.2.0.insert.mask.masked.i.i = or i64 %.sroa.3.0.insert.mask.masked.masked.i.i, %.sroa.6.0.insert.shift.i.i
  %.sroa.0.0.insert.mask.i.i = or i64 %.sroa.2.0.insert.mask.masked.i.i, %.sroa.9.0.insert.insert.masked.masked.masked.i.i
  ...
  %i.bt = load i8, ptr %i.bs, align 1, !noalias !975, !noundef !5
  store i8 %i.bt, ptr %i.h, align 1, !alias.scope !973, !noalias !970
  %i.bu = lshr i64 %i.bl, 3
  %i.bv = and i64 %i.bu, 7
  %i.bw = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.bv
  %i.bx = load i8, ptr %i.bw, align 1, !noalias !975, !noundef !5
  store i8 %i.bx, ptr %i.i, align 1, !alias.scope !973, !noalias !970
  %i.by = lshr i64 %i.bm, 6
  %i.bz = and i64 %i.by, 7
  %i.ca = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.bz
  %i.cb = load i8, ptr %i.ca, align 1, !noalias !975, !noundef !5
  store i8 %i.cb, ptr %i.j, align 1, !alias.scope !973, !noalias !970
  %i.cc = lshr i64 %i.bh, 1
  %i.cd = and i64 %i.cc, 7
  %i.ce = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.cd
  %i.cf = load i8, ptr %i.ce, align 1, !noalias !975, !noundef !5
  store i8 %i.cf, ptr %i.k, align 1, !alias.scope !973, !noalias !970
  %i.cg = lshr i64 %i.bh, 4
  %i.ch = and i64 %i.cg, 7
  %i.ci = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.ch
  %i.cj = load i8, ptr %i.ci, align 1, !noalias !975, !noundef !5
  store i8 %i.cj, ptr %i.l, align 1, !alias.scope !973, !noalias !970
  %i.ck = lshr i64 %i.bj, 7
  %i.cl = and i64 %i.ck, 7
  %i.cm = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.cl
  %i.cn = load i8, ptr %i.cm, align 1, !noalias !975, !noundef !5
  store i8 %i.cn, ptr %i.m, align 1, !alias.scope !973, !noalias !970
  %i.co = lshr i64 %i.bf, 2
  %i.cp = and i64 %i.co, 7
  %i.cq = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.cp
  %i.cr = load i8, ptr %i.cq, align 1, !noalias !975, !noundef !5
  store i8 %i.cr, ptr %i.n, align 1, !alias.scope !973, !noalias !970
  ...
  store i8 %i.cu, ptr %i.o, align 1, !alias.scope !973, !noalias !970
  %i.cv = and i64 %i.bc, 7
  %i.cw = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.cv
  %i.cx = load i8, ptr %i.cw, align 1, !noalias !975, !noundef !5
  store i8 %i.cx, ptr %i.p, align 1, !alias.scope !973, !noalias !970
  %i.cy = lshr i64 %i.bc, 3
  %i.cz = and i64 %i.cy, 7
  %i.da = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.cz
  %i.db = load i8, ptr %i.da, align 1, !noalias !975, !noundef !5
  store i8 %i.db, ptr %i.q, align 1, !alias.scope !973, !noalias !970
  %i.dc = lshr i64 %i.bd, 6
  %i.dd = and i64 %i.dc, 7
  %i.de = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.dd
  %i.df = load i8, ptr %i.de, align 1, !noalias !975, !noundef !5
  store i8 %i.df, ptr %i.r, align 1, !alias.scope !973, !noalias !970
  %i.dg = lshr i64 %i.az, 1
  %i.dh = and i64 %i.dg, 7
  %i.di = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.dh
  %i.dj = load i8, ptr %i.di, align 1, !noalias !975, !noundef !5
  store i8 %i.dj, ptr %i.s, align 1, !alias.scope !973, !noalias !970
  %i.dk = lshr i64 %i.az, 4
  %i.dl = and i64 %i.dk, 7
  %i.dm = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.dl
  %i.dn = load i8, ptr %i.dm, align 1, !noalias !975, !noundef !5
  store i8 %i.dn, ptr %i.t, align 1, !alias.scope !973, !noalias !970
  %i.do = lshr i64 %i.bb, 15
  %i.dp = and i64 %i.do, 7
  %i.dq = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.dp
  %i.dr = load i8, ptr %i.dq, align 1, !noalias !975, !noundef !5
  store i8 %i.dr, ptr %i.u, align 1, !alias.scope !973, !noalias !970
  ...
  store i8 %i.dv, ptr %i.v, align 1, !alias.scope !973, !noalias !970
  ...
  store i8 %i.dy, ptr %i.w, align 1, !alias.scope !973, !noalias !970
...
bb.i:                                             ; preds = %_RNvNtNtCsa5QsYiPB8Gl_5image6codecs3dxt17decode_dxt5_block.exit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %i.eb, ptr noundef nonnull readonly align 1 dereferenceable(16) %i.b, i64 16, i1 false), !alias.scope !976, !noalias !980
...
bb.j:                                             ; preds = %bb.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %i.ef, ptr noundef nonnull readonly align 1 dereferenceable(16) %i.y, i64 16, i1 false), !alias.scope !976, !noalias !980
...
bb.k:                                             ; preds = %bb.j
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %i.ei, ptr noundef nonnull readonly align 1 dereferenceable(16) %i.aa, i64 16, i1 false), !alias.scope !976, !noalias !980
...
.loopexit:                                        ; preds = %bb.k
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %i.em, ptr noundef nonnull readonly align 1 dereferenceable(16) %i.ac, i64 16, i1 false), !alias.scope !976, !noalias !980
