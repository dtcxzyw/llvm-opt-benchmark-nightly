...
.preheader9.i.i:                                  ; preds = %.lr.ph.i.preheader.i
  ...
  %i.au = shufflevector <4 x i16> %i.ar, <4 x i16> poison, <4 x i32> <i32 1, i32 poison, i32 poison, i32 0>
  %i.av = insertelement <4 x i16> %i.au, i16 %i.ap, i64 1
  %i.aw = insertelement <4 x i16> %i.av, i16 %i.an, i64 2
  %i.ax = add nuw nsw <4 x i16> %i.at, %i.aw
  %i.ay = udiv <4 x i16> %i.ax, splat (i16 5)
  br label %_RNvNtNtCsa5QsYiPB8Gl_5image6codecs3dxt17decode_dxt5_block.exit

.preheader.i.i:                                   ; preds = %.lr.ph.i.preheader.i
  %i.az = insertelement <2 x i16> poison, i16 %i.ao, i64 0
  %i.ba = insertelement <2 x i16> %i.az, i16 %i.ap, i64 1
  %i.bb = mul nuw nsw <2 x i16> %i.ba, <i16 3, i16 1>
  %i.bc = insertelement <4 x i16> poison, i16 %i.ak, i64 0
  %i.bd = insertelement <4 x i16> %i.bc, i16 %i.ao, i64 1
  %i.be = shufflevector <4 x i16> %i.bd, <4 x i16> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
  %i.bf = mul nuw nsw <4 x i16> %i.be, <i16 4, i16 4, i16 5, i16 6>
  %i.bg = shufflevector <2 x i16> %i.bb, <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.bh = insertelement <4 x i16> %i.bg, i16 %i.an, i64 2
  %i.bi = insertelement <4 x i16> %i.bh, i16 %i.ak, i64 3
  %i.bj = add nuw nsw <4 x i16> %i.bi, %i.bf
...
_RNvNtNtCsa5QsYiPB8Gl_5image6codecs3dxt17decode_dxt5_block.exit: ; preds = %.preheader9.i.i, %.preheader.i.i
  %.sroa.15.0.insert.insert.i.i = phi i64 [ %4, %.preheader.i.i ], [ -72057594037927936, %.preheader9.i.i ]
  %i.bw = phi <4 x i16> [ %i.bk, %.preheader.i.i ], [ %i.ay, %.preheader9.i.i ] ; 4 uses
  %i.bx = zext i8 %.val.i.i to i64                ; 3 uses
  %i.by = shl nuw nsw i64 %i.bx, 16
  %i.bz = zext i8 %.val.i.1.i to i64              ; 3 uses
  %i.ca = shl nuw nsw i64 %i.bz, 8
  %i.cb = or disjoint i64 %i.ca, %i.by            ; 2 uses
  %i.cc = zext i8 %.val.i.2.i to i64              ; 3 uses
  %i.cd = or disjoint i64 %i.cb, %i.cc            ; 2 uses
  %i.ce = shl nuw nsw i64 %i.cd, 16
  %i.cf = zext i8 %.val.i.3.i to i64              ; 3 uses
  %i.cg = shl nuw nsw i64 %i.cf, 8
  %i.ch = zext i8 %.val.i.4.i to i64              ; 3 uses
  %i.ci = or disjoint i64 %i.cg, %i.ce
  %i.cj = or disjoint i64 %i.ci, %i.ch            ; 2 uses
  %i.ck = shl nuw nsw i64 %i.cj, 8
  %i.cl = zext i8 %.val.i.5.i to i64              ; 3 uses
  %i.cm = or disjoint i64 %i.ck, %i.cl
  %i.cn = extractelement <4 x i16> %i.bw, i64 0
  %.sroa.12.0.insert.ext.i.i = zext nneg i16 %i.cn to i64
  %.sroa.12.0.insert.shift.i.i = shl nuw nsw i64 %.sroa.12.0.insert.ext.i.i, 40
  %i.co = extractelement <4 x i16> %i.bw, i64 1
  %.sroa.9.0.insert.ext.i.i = zext nneg i16 %i.co to i64
  %.sroa.9.0.insert.shift.i.i = shl nuw nsw i64 %.sroa.9.0.insert.ext.i.i, 32
  %i.cp = extractelement <4 x i16> %i.bw, i64 2
  %.sroa.6.0.insert.ext.i.i = zext nneg i16 %i.cp to i64
  %.sroa.6.0.insert.shift.i.i = shl nuw nsw i64 %.sroa.6.0.insert.ext.i.i, 24
  %i.cq = extractelement <4 x i16> %i.bw, i64 3
  %.sroa.3.0.insert.ext.i.i = zext nneg i16 %i.cq to i64
  ...
  %i.ct = load i8, ptr %i.cs, align 1, !noalias !984, !noundef !5
  store i8 %i.ct, ptr %i.h, align 1, !alias.scope !983, !noalias !982
  %i.cu = lshr i64 %i.cl, 3
  %i.cv = and i64 %i.cu, 7
  %i.cw = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.cv
  %i.cx = load i8, ptr %i.cw, align 1, !noalias !984, !noundef !5
  store i8 %i.cx, ptr %i.i, align 1, !alias.scope !983, !noalias !982
  %i.cy = lshr i64 %i.cm, 6
  %i.cz = and i64 %i.cy, 7
  %i.da = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.cz
  %i.db = load i8, ptr %i.da, align 1, !noalias !984, !noundef !5
  store i8 %i.db, ptr %i.j, align 1, !alias.scope !983, !noalias !982
  %i.dc = lshr i64 %i.ch, 1
  %i.dd = and i64 %i.dc, 7
  %i.de = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.dd
  %i.df = load i8, ptr %i.de, align 1, !noalias !984, !noundef !5
  store i8 %i.df, ptr %i.k, align 1, !alias.scope !983, !noalias !982
  %i.dg = lshr i64 %i.ch, 4
  %i.dh = and i64 %i.dg, 7
  %i.di = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.dh
  %i.dj = load i8, ptr %i.di, align 1, !noalias !984, !noundef !5
  store i8 %i.dj, ptr %i.l, align 1, !alias.scope !983, !noalias !982
  %i.dk = lshr i64 %i.cj, 7
  %i.dl = and i64 %i.dk, 7
  %i.dm = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.dl
  %i.dn = load i8, ptr %i.dm, align 1, !noalias !984, !noundef !5
  store i8 %i.dn, ptr %i.m, align 1, !alias.scope !983, !noalias !982
  %i.do = lshr i64 %i.cf, 2
  %i.dp = and i64 %i.do, 7
  %i.dq = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.dp
  %i.dr = load i8, ptr %i.dq, align 1, !noalias !984, !noundef !5
  store i8 %i.dr, ptr %i.n, align 1, !alias.scope !983, !noalias !982
  %i.ds = lshr i64 %i.cf, 5
  %i.dt = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.ds
  %i.du = load i8, ptr %i.dt, align 1, !noalias !984, !noundef !5
  store i8 %i.du, ptr %i.o, align 1, !alias.scope !983, !noalias !982
  %i.dv = and i64 %i.cc, 7
  %i.dw = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.dv
  %i.dx = load i8, ptr %i.dw, align 1, !noalias !984, !noundef !5
  store i8 %i.dx, ptr %i.p, align 1, !alias.scope !983, !noalias !982
  %i.dy = lshr i64 %i.cc, 3
  %i.dz = and i64 %i.dy, 7
  %i.ea = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.dz
  %i.eb = load i8, ptr %i.ea, align 1, !noalias !984, !noundef !5
  store i8 %i.eb, ptr %i.q, align 1, !alias.scope !983, !noalias !982
  %i.ec = lshr i64 %i.cd, 6
  %i.ed = and i64 %i.ec, 7
  %i.ee = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.ed
  %i.ef = load i8, ptr %i.ee, align 1, !noalias !984, !noundef !5
  store i8 %i.ef, ptr %i.r, align 1, !alias.scope !983, !noalias !982
  %i.eg = lshr i64 %i.bz, 1
  %i.eh = and i64 %i.eg, 7
  %i.ei = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.eh
  %i.ej = load i8, ptr %i.ei, align 1, !noalias !984, !noundef !5
  store i8 %i.ej, ptr %i.s, align 1, !alias.scope !983, !noalias !982
  %i.ek = lshr i64 %i.bz, 4
  %i.el = and i64 %i.ek, 7
  %i.em = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.el
  %i.en = load i8, ptr %i.em, align 1, !noalias !984, !noundef !5
  store i8 %i.en, ptr %i.t, align 1, !alias.scope !983, !noalias !982
  %i.eo = lshr i64 %i.cb, 15
  %i.ep = and i64 %i.eo, 7
  %i.eq = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.ep
  %i.er = load i8, ptr %i.eq, align 1, !noalias !984, !noundef !5
  store i8 %i.er, ptr %i.u, align 1, !alias.scope !983, !noalias !982
  %i.es = lshr i64 %i.bx, 2
  %i.et = and i64 %i.es, 7
  %i.eu = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.et
  %i.ev = load i8, ptr %i.eu, align 1, !noalias !984, !noundef !5
  store i8 %i.ev, ptr %i.v, align 1, !alias.scope !983, !noalias !982
  %i.ew = lshr i64 %i.bx, 5
  %i.ex = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.ew
  %i.ey = load i8, ptr %i.ex, align 1, !noalias !984, !noundef !5
  store i8 %i.ey, ptr %i.w, align 1, !alias.scope !983, !noalias !982
  ...
  %i.ez = shl nuw nsw i64 %.sroa.10.021, 4        ; 2 uses
...
bb.h:                                             ; preds = %bb.k, %bb.j, %bb.i, %_RNvNtNtCsa5QsYiPB8Gl_5image6codecs3dxt17decode_dxt5_block.exit
  %.lcssa = phi i64 [ %i.ez, %_RNvNtNtCsa5QsYiPB8Gl_5image6codecs3dxt17decode_dxt5_block.exit ], [ %i.fd, %bb.i ], [ %i.fh, %bb.j ], [ %i.fk, %bb.k ] ; 2 uses
  %i.fa = add i64 %.lcssa, 16
  tail call void @_RNvNtNtCsj6eKBz9Db1c_4core5slice5index16slice_index_fail(i64 noundef %.lcssa, i64 noundef %i.fa, i64 noundef %3, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @69) #28
  unreachable

bb.i:                                             ; preds = %_RNvNtNtCsa5QsYiPB8Gl_5image6codecs3dxt17decode_dxt5_block.exit
  %i.fb = getelementptr inbounds nuw i8, ptr %2, i64 %i.ez
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %i.fb, ptr noundef nonnull readonly align 1 dereferenceable(16) %i.b, i64 16, i1 false), !alias.scope !985, !noalias !986
  %i.fc = add nuw nsw i64 %i.e, %.sroa.10.021
  %i.fd = shl nuw i64 %i.fc, 4                    ; 3 uses
  %i.fe = or disjoint i64 %i.fd, 15
  %or.cond.not.1 = icmp ult i64 %i.fe, %3
  br i1 %or.cond.not.1, label %bb.j, label %bb.h, !prof !25

bb.j:                                             ; preds = %bb.i
  %i.ff = getelementptr inbounds nuw i8, ptr %2, i64 %i.fd
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %i.ff, ptr noundef nonnull readonly align 1 dereferenceable(16) %i.y, i64 16, i1 false), !alias.scope !985, !noalias !986
  %i.fg = add nuw nsw i64 %i.z, %.sroa.10.021
  %i.fh = shl i64 %i.fg, 4                        ; 3 uses
  %or.cond.not.2 = icmp ult i64 %i.fh, %invariant.op
  br i1 %or.cond.not.2, label %bb.k, label %bb.h, !prof !25

bb.k:                                             ; preds = %bb.j
  %i.fi = getelementptr inbounds nuw i8, ptr %2, i64 %i.fh
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %i.fi, ptr noundef nonnull readonly align 1 dereferenceable(16) %i.aa, i64 16, i1 false), !alias.scope !985, !noalias !986
  %i.fj = add nuw nsw i64 %i.ab, %.sroa.10.021
  %i.fk = shl i64 %i.fj, 4                        ; 3 uses
  %i.fl = or disjoint i64 %i.fk, 15
  %or.cond.not.3 = icmp ult i64 %i.fl, %3
  br i1 %or.cond.not.3, label %.loopexit, label %bb.h, !prof !25

.loopexit:                                        ; preds = %bb.k
  %i.fm = getelementptr inbounds nuw i8, ptr %2, i64 %i.fk
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %i.fm, ptr noundef nonnull readonly align 1 dereferenceable(16) %i.ac, i64 16, i1 false), !alias.scope !985, !noalias !986
  %i.fn = icmp eq i64 %i.ae, 0
  br i1 %i.fn, label %._crit_edge, label %bb.f
}
