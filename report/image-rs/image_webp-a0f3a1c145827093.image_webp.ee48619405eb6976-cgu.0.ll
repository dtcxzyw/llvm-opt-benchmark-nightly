...
.lr.ph250:                                        ; preds = %bb.an, %.backedge
  %.sroa.8136.0248 = phi i64 [ %i.dy, %.backedge ], [ 0, %bb.an ] ; 3 uses
  %.sroa.0134.0247 = phi ptr [ %i.dx, %.backedge ], [ %i.dt, %bb.an ] ; 2 uses
  %i.dx = getelementptr inbounds nuw i8, ptr %.sroa.0134.0247, i64 2 ; 2 uses
  %i.dy = add nuw i64 %.sroa.8136.0248, 1
  %i.dz = load i16, ptr %.sroa.0134.0247, align 2, !noundef !4 ; 7 uses
...
bb.at:                                            ; preds = %bb.ar
  ...
  %i.ev = trunc i64 %.sroa.8136.0248 to i32
...
bb.bg:                                            ; preds = %bb.ba
  %i.gg = trunc i64 %.sroa.8136.0248 to i16
...
bb.bh:                                            ; preds = %.lr.ph244
  ...
  %i.gj = getelementptr inbounds nuw [16 x i8], ptr %i.gi, i64 %.sroa.026.1241 ; 4 uses
...
.invoke406:                                       ; preds = %._crit_edge245, %bb.as, %bb.aq, %bb.bt, %.lr.ph244
  %i.ho = phi i64 [ %.sroa.023.0237, %bb.bt ], [ %.sroa.026.1241, %.lr.ph244 ], [ %i.ep, %bb.as ], [ %i.ef, %bb.aq ], [ %.sroa.026.1.lcssa, %._crit_edge245 ]
