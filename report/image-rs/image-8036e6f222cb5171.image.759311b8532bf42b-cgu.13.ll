...
bb.an:                                            ; preds = %bb.bi, %.lr.ph227.i
  ...
  %i.dk = add nuw nsw i64 %.sroa.038.0225.i, 256  ; 2 uses
  ...
  %i.dm = sub nsw i64 %..i.i, %.sroa.038.0225.i   ; 10 uses
...
bb.ao:                                            ; preds = %bb.bj, %.lr.ph227.i
  ...
  %i.fb = add nuw nsw i64 %.sroa.038.0225.i, 256  ; 2 uses
  ...
  %i.fd = sub nsw i64 %..i.i, %.sroa.038.0225.i   ; 10 uses
...
bb.an:                                            ; preds = %bb.bi, %.lr.ph227.i
  ...
  %i.dm = add nuw nsw i64 %.sroa.038.0225.i, 256  ; 2 uses
  ...
  %i.do = sub nsw i64 %..i.i, %.sroa.038.0225.i   ; 10 uses
