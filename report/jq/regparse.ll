...
begin_hunk_0_@onig_parse_tree:bb.a
bb.k:                                             ; preds = %bb.j
  ...
  %.pre66 = load i32, ptr %i.az, align 8, !tbaa !91 ; 2 uses
  %i.bg = icmp sgt i32 %.pre66, 0
  br i1 %i.bg, label %.lr.ph48.i, label %setup_ext_callout_list_values.exit

.lr.ph48.i:                                       ; preds = %bb.j, %bb.k
  %i.bh = phi i32 [ %.pre66, %bb.k ], [ %i.ba, %bb.j ]
  %i.bi = getelementptr inbounds nuw i8, ptr %i.ay, i64 32
  %i.bj = ptrtoint ptr %5 to i64
  br label %bb.l

bb.l:                                             ; preds = %.loopexit.i, %.lr.ph48.i
  %i.bk = phi i32 [ %i.bh, %.lr.ph48.i ], [ %i.co, %.loopexit.i ] ; 2 uses
  %indvars.iv51.i = phi i64 [ 0, %.lr.ph48.i ], [ %indvars.iv.next52.i, %.loopexit.i ] ; 2 uses
  %i.bl = load ptr, ptr %i.bi, align 8, !tbaa !92
  %i.bm = getelementptr inbounds nuw [144 x i8], ptr %i.bl, i64 %indvars.iv51.i ; 4 uses
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bm, i64 4
  %i.bo = load i32, ptr %i.bn, align 4, !tbaa !114
  %i.bp = icmp eq i32 %i.bo, 1
  br i1 %i.bp, label %.preheader.i, label %.loopexit.i

.preheader.i:                                     ; preds = %bb.l
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bm, i64 56 ; 2 uses
  %i.br = load i32, ptr %i.bq, align 8, !tbaa !28 ; 2 uses
  %i.bs = icmp sgt i32 %i.br, 0
  br i1 %i.bs, label %.lr.ph.i, label %.loopexit.i
...
bb.m:                                             ; preds = %bb.r, %.lr.ph.i
  %i.bv = phi i32 [ %i.br, %.lr.ph.i ], [ %i.cl, %bb.r ]
  %indvars.iv.i = phi i64 [ 0, %.lr.ph.i ], [ %indvars.iv.next.i, %bb.r ] ; 3 uses
  %i.bw = getelementptr inbounds nuw [4 x i8], ptr %i.bt, i64 %indvars.iv.i
  %i.bx = load i32, ptr %i.bw, align 4, !tbaa !28
  %i.by = icmp eq i32 %i.bx, 16
  br i1 %i.by, label %bb.n, label %bb.r

bb.n:                                             ; preds = %bb.m
  %i.bz = getelementptr inbounds nuw [16 x i8], ptr %i.bu, i64 %indvars.iv.i ; 2 uses
  %i.ca = load <2 x ptr>, ptr %i.bz, align 8, !tbaa !28
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #26
  %i.cb = load ptr, ptr %i.ax, align 8, !tbaa !89 ; 2 uses
  %i.cc = icmp eq ptr %i.cb, null
  br i1 %i.cc, label %onig_get_callout_num_by_tag.exit.thread.i, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.cd = getelementptr inbounds nuw i8, ptr %i.cb, i64 16
  %i.ce = load ptr, ptr %i.cd, align 8, !tbaa !98 ; 2 uses
  %i.cf = icmp eq ptr %i.ce, null
  br i1 %i.cf, label %onig_get_callout_num_by_tag.exit.thread.i, label %bb.p

bb.p:                                             ; preds = %bb.o
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #26
  store <2 x ptr> %i.ca, ptr %5, align 16, !tbaa !131
  %i.cg = call i32 @onig_st_lookup(ptr noundef nonnull %i.ce, i64 noundef %i.bj, ptr noundef nonnull %i.a) #26
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #26
  %i.ch = icmp eq i32 %i.cg, 0
  br i1 %i.ch, label %onig_get_callout_num_by_tag.exit.thread.i, label %onig_get_callout_num_by_tag.exit.i

onig_get_callout_num_by_tag.exit.thread.i:        ; preds = %bb.p, %bb.o, %bb.n
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #26
  br label %setup_ext_callout_list_values.exit

onig_get_callout_num_by_tag.exit.i:               ; preds = %bb.p
  %i.ci = load i64, ptr %i.a, align 8, !tbaa !100
  %i.cj = trunc i64 %i.ci to i32                  ; 3 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #26
  %i.ck = icmp sgt i32 %i.cj, -1
  br i1 %i.ck, label %bb.q, label %setup_ext_callout_list_values.exit

bb.q:                                             ; preds = %onig_get_callout_num_by_tag.exit.i
  store i32 %i.cj, ptr %i.bz, align 8, !tbaa !28
  %.pre.i = load i32, ptr %i.bq, align 8, !tbaa !28
  br label %bb.r

bb.r:                                             ; preds = %bb.q, %bb.m
  %i.cl = phi i32 [ %.pre.i, %bb.q ], [ %i.bv, %bb.m ] ; 2 uses
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %i.cm = sext i32 %i.cl to i64
  %i.cn = icmp slt i64 %indvars.iv.next.i, %i.cm
  br i1 %i.cn, label %bb.m, label %.loopexit.loopexit.i, !llvm.loop !206

.loopexit.loopexit.i:                             ; preds = %bb.r
  %.pre54.i = load i32, ptr %i.az, align 8, !tbaa !91
  br label %.loopexit.i

.loopexit.i:                                      ; preds = %.loopexit.loopexit.i, %.preheader.i, %bb.l
  %i.co = phi i32 [ %.pre54.i, %.loopexit.loopexit.i ], [ %i.bk, %.preheader.i ], [ %i.bk, %bb.l ] ; 2 uses
  %indvars.iv.next52.i = add nuw nsw i64 %indvars.iv51.i, 1 ; 2 uses
  %i.cp = sext i32 %i.co to i64
  %i.cq = icmp slt i64 %indvars.iv.next52.i, %i.cp
  br i1 %i.cq, label %bb.l, label %setup_ext_callout_list_values.exit, !llvm.loop !207

setup_ext_callout_list_values.exit:               ; preds = %.loopexit.i, %onig_get_callout_num_by_tag.exit.i, %bb.e, %onig_node_free.exit.i, %onig_get_callout_num_by_tag.exit.thread.i, %bb.k, %prs_regexp.exit.thread, %bb.h, %bb.i, %prs_regexp.exit, %names_clear.exit
  %.149 = phi i32 [ -400, %names_clear.exit ], [ %i.cj, %onig_get_callout_num_by_tag.exit.i ], [ 0, %bb.h ], [ %i.ah, %prs_regexp.exit ], [ %i.af, %prs_regexp.exit.thread ], [ 0, %bb.i ], [ 0, %bb.k ], [ -231, %onig_get_callout_num_by_tag.exit.thread.i ], [ -11, %onig_node_free.exit.i ], [ -5, %bb.e ], [ 0, %.loopexit.i ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #26
  ret i32 %.149
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write) uwtable
define dso_local void @onig_scan_env_set_error_string(ptr nofree noundef writeonly captures(none) initializes((56, 72)) %0, i32 noundef %1, ptr noundef %2, ptr noundef %3) local_unnamed_addr #17 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 56
  store ptr %2, ptr %i.a, align 8, !tbaa !139
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 64
  store ptr %3, ptr %i.b, align 8, !tbaa !140
  ret void
}
...
define internal fastcc i32 @fetch_token(ptr nofree noundef nonnull %0, ptr nofree noundef nonnull captures(none) %1, ptr noundef %2, ptr noundef %3) unnamed_addr #2 {
bb.a:
  ...
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !125  ; 40 uses
  %i.q = getelementptr inbounds nuw i8, ptr %3, i64 16 ; 2 uses
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !126  ; 48 uses
  %i.s = load ptr, ptr %1, align 8, !tbaa !131    ; 4 uses
  store ptr %i.s, ptr %i.c, align 8, !tbaa !131
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 4 ; 3 uses
  %i.u = load i32, ptr %i.t, align 4, !tbaa !133
  %.not = icmp eq i32 %i.u, 0
  br i1 %.not, label %bb.i, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.v = getelementptr inbounds nuw i8, ptr %0, i64 12
  %i.w = load i32, ptr %i.v, align 4, !tbaa !141
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #26
  %i.x = getelementptr inbounds nuw i8, ptr %i.p, i64 32
  br label %bb.c

bb.c:                                             ; preds = %bb.e, %bb.b
  %i.y = phi ptr [ %i.ae, %bb.e ], [ %i.s, %bb.b ] ; 5 uses
  %.not.i = icmp ult ptr %i.y, %2
  br i1 %.not.i, label %bb.d, label %.loopexit.i

bb.d:                                             ; preds = %bb.c
  %i.z = load ptr, ptr %i.x, align 8, !tbaa !83
  %i.aa = tail call i32 %i.z(ptr noundef %i.y, ptr noundef nonnull %2) #26, !inline_history !1
  %i.ab = load ptr, ptr %i.p, align 8, !tbaa !84
  %i.ac = tail call i32 %i.ab(ptr noundef %i.y) #26, !inline_history !1
  %i.ad = sext i32 %i.ac to i64
  %i.ae = getelementptr inbounds i8, ptr %i.y, i64 %i.ad ; 3 uses
  switch i32 %i.aa, label %.loopexit.i [
    i32 32, label %bb.e
    i32 10, label %bb.e
...
bb.e:                                             ; preds = %bb.d, %bb.d
  ...
  br i1 %i.af, label %bb.c, label %get_next_code_point.exit.thread, !llvm.loop !2

get_next_code_point.exit.thread:                  ; preds = %bb.e
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #26
  br label %.thread750

.loopexit.i:                                      ; preds = %bb.d, %bb.c
  store ptr %i.y, ptr %i.a, align 8
  %i.ag = call fastcc i32 @scan_number_of_base(ptr noundef %i.a, ptr noundef %2, ptr noundef readonly %i.p, ptr noundef nonnull %i.b, i32 noundef %i.w) ; 2 uses
  %.not26.i = icmp eq i32 %i.ag, 0
  br i1 %.not26.i, label %bb.f, label %get_next_code_point.exit

bb.f:                                             ; preds = %.loopexit.i
  %i.ah = load ptr, ptr %i.a, align 8, !tbaa !131
  br label %.loopexit27.sink.split.i

.loopexit27.sink.split.i:                         ; preds = %bb.d, %bb.f
  %.sink.i = phi ptr [ %i.ah, %bb.f ], [ %i.ae, %bb.d ] ; 2 uses
  %.0.ph.i = phi i32 [ 0, %bb.f ], [ 1, %bb.d ]
  store ptr %.sink.i, ptr %i.c, align 8, !tbaa !131
  br label %get_next_code_point.exit

get_next_code_point.exit:                         ; preds = %.loopexit.i, %.loopexit27.sink.split.i
  %i.ai = phi ptr [ %.sink.i, %.loopexit27.sink.split.i ], [ %i.s, %.loopexit.i ]
  %.0.i = phi i32 [ %.0.ph.i, %.loopexit27.sink.split.i ], [ %i.ag, %.loopexit.i ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #26
  switch i32 %.0.i, label %.thread750 [
    i32 1, label %bb.g
    i32 0, label %bb.h
  ]

bb.g:                                             ; preds = %get_next_code_point.exit
  store i32 0, ptr %i.t, align 4, !tbaa !133
  br label %bb.i

bb.h:                                             ; preds = %get_next_code_point.exit
  store i32 4, ptr %0, align 8, !tbaa !142
  %i.aj = load i32, ptr %i.b, align 4, !tbaa !26
  %i.ak = getelementptr inbounds nuw i8, ptr %0, i64 24
  store i32 %i.aj, ptr %i.ak, align 8, !tbaa !28
  br label %.thread747

bb.i:                                             ; preds = %bb.g, %bb.a
  %i.al = phi ptr [ %i.ai, %bb.g ], [ %i.s, %bb.a ] ; 2 uses
  %i.am = icmp ult ptr %i.al, %2
  br i1 %i.am, label %.lr.ph945, label %._crit_edge

.lr.ph945:                                        ; preds = %bb.i
  %i.an = getelementptr inbounds nuw i8, ptr %0, i64 12 ; 6 uses
  %i.ao = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 3 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %i.p, i64 32 ; 26 uses
  %i.aq = getelementptr inbounds nuw i8, ptr %i.r, i64 16 ; 2 uses
  %i.ar = getelementptr inbounds nuw i8, ptr %i.r, i64 4 ; 19 uses
  %i.as = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 36 uses
  %i.at = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.au = getelementptr inbounds nuw i8, ptr %i.r, i64 20
  %i.av = getelementptr inbounds nuw i8, ptr %i.r, i64 24
  %i.aw = getelementptr inbounds nuw i8, ptr %i.r, i64 28
  %i.ax = getelementptr inbounds nuw i8, ptr %i.r, i64 32
  %i.ay = getelementptr inbounds nuw i8, ptr %i.r, i64 36
  %i.az = getelementptr inbounds nuw i8, ptr %i.p, i64 88 ; 5 uses
  br label %bb.j

._crit_edge.loopexit:                             ; preds = %.backedge
  store ptr %i.xd, ptr %i.c, align 8
  br label %._crit_edge
...
bb.j:                                             ; preds = %.lr.ph945, %.backedge
  %i.ba = phi ptr [ %i.al, %.lr.ph945 ], [ %i.xd, %.backedge ] ; 5 uses
  store i32 3, ptr %0, align 8, !tbaa !142
  store i32 0, ptr %i.an, align 4, !tbaa !141
  store ptr %i.ba, ptr %i.ao, align 8, !tbaa !143
  %i.bb = load ptr, ptr %i.ap, align 8, !tbaa !83
  %i.bc = tail call i32 %i.bb(ptr noundef %i.ba, ptr noundef nonnull %2) #26 ; 9 uses
...
bb.k:                                             ; preds = %bb.j
  %i.bj = load i32, ptr %i.ar, align 4, !tbaa !145
  %i.bk = and i32 %i.bj, 1048576
  %.not637 = icmp eq i32 %i.bk, 0
...
bb.m:                                             ; preds = %bb.l
  store ptr %i.bg, ptr %i.ao, align 8, !tbaa !143
  %i.bm = load ptr, ptr %i.ap, align 8, !tbaa !83
  %i.bn = tail call i32 %i.bm(ptr noundef %i.bg, ptr noundef nonnull %2) #26 ; 5 uses
  %i.bo = load ptr, ptr %i.p, align 8, !tbaa !84
  %i.bp = tail call i32 %i.bo(ptr noundef %i.bg) #26
  %i.bq = sext i32 %i.bp to i64
  %i.br = getelementptr inbounds i8, ptr %i.bg, i64 %i.bq ; 31 uses
  store ptr %i.br, ptr %i.c, align 8, !tbaa !131
  store i32 %i.bn, ptr %i.as, align 8, !tbaa !28
  store i32 1, ptr %i.at, align 8, !tbaa !146
  switch i32 %i.bn, label %bb.fw [
    i32 42, label %bb.n
    i32 43, label %bb.o
    i32 63, label %bb.p
    i32 123, label %bb.ad
...
bb.n:                                             ; preds = %bb.m
  %i.bs = load i32, ptr %i.r, align 4, !tbaa !147
  %i.bt = and i32 %i.bs, 8
  %.not689 = icmp eq i32 %i.bt, 0
  br i1 %.not689, label %.thread747, label %.loopexit773

bb.o:                                             ; preds = %bb.m
  %i.bu = load i32, ptr %i.r, align 4, !tbaa !147
  %i.bv = and i32 %i.bu, 32
  %.not688 = icmp eq i32 %i.bv, 0
  br i1 %.not688, label %.thread747, label %.loopexit773

bb.p:                                             ; preds = %bb.m
  %i.bw = load i32, ptr %i.r, align 4, !tbaa !147
  %i.bx = and i32 %i.bw, 128
  %.not687 = icmp eq i32 %i.bx, 0
  br i1 %.not687, label %.thread747, label %.loopexit773

.loopexit773.sink.split:                          ; preds = %bb.gf, %bb.gg, %bb.ge
  %i.by = phi <2 x i32> [ <i32 1, i32 -1>, %bb.gg ], [ <i32 0, i32 -1>, %bb.ge ], [ <i32 0, i32 1>, %bb.gf ]
  store ptr %i.bg, ptr %i.c, align 8
  br label %.loopexit773

.loopexit773:                                     ; preds = %.loopexit773.sink.split, %bb.p, %bb.o, %bb.n, %bb.gn, %bb.gm, %bb.gl
  %i.bz = phi <2 x i32> [ <i32 1, i32 -1>, %bb.gm ], [ <i32 0, i32 -1>, %bb.gl ], [ <i32 0, i32 1>, %bb.gn ], [ <i32 1, i32 -1>, %bb.o ], [ <i32 0, i32 -1>, %bb.n ], [ <i32 0, i32 1>, %bb.p ], [ %i.by, %.loopexit773.sink.split ]
  store i32 10, ptr %0, align 8, !tbaa !142
  store <2 x i32> %i.bz, ptr %i.as, align 8, !tbaa !28
  %i.ca = getelementptr inbounds nuw i8, ptr %0, i64 36
  store i32 0, ptr %i.ca, align 4, !tbaa !28
  br label %bb.q

bb.q:                                             ; preds = %bb.gq, %bb.af, %bb.gr, %bb.ag, %.loopexit773
  %i.cb = load ptr, ptr %i.c, align 8, !tbaa !131 ; 5 uses
  %i.cc = icmp ult ptr %i.cb, %2
  br i1 %i.cc, label %bb.r, label %bb.v

bb.r:                                             ; preds = %bb.q
  %i.cd = load ptr, ptr %i.ap, align 8, !tbaa !83
  %i.ce = tail call i32 %i.cd(ptr noundef %i.cb, ptr noundef nonnull %2) #26
  %i.cf = icmp eq i32 %i.ce, 63
  br i1 %i.cf, label %bb.s, label %bb.v

bb.s:                                             ; preds = %bb.r
  %i.cg = load i32, ptr %i.r, align 4, !tbaa !147
  %i.ch = and i32 %i.cg, 33554432
  %.not727 = icmp eq i32 %i.ch, 0
  br i1 %.not727, label %bb.v, label %bb.t

bb.t:                                             ; preds = %bb.s
  %i.ci = getelementptr inbounds nuw i8, ptr %0, i64 36 ; 2 uses
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !28
  %i.ck = icmp eq i32 %i.cj, 0
  br i1 %i.ck, label %bb.u, label %bb.v

bb.u:                                             ; preds = %bb.t
  %i.cl = load ptr, ptr %i.ap, align 8, !tbaa !83
  %i.cm = tail call i32 %i.cl(ptr noundef %i.cb, ptr noundef nonnull %2) #26 ; 0 uses
  %i.cn = load ptr, ptr %i.p, align 8, !tbaa !84
  %i.co = tail call i32 %i.cn(ptr noundef %i.cb) #26
  %i.cp = sext i32 %i.co to i64
  %i.cq = getelementptr inbounds i8, ptr %i.cb, i64 %i.cp
  store ptr %i.cq, ptr %i.c, align 8, !tbaa !131
  %i.cr = getelementptr inbounds nuw i8, ptr %0, i64 32
  store i32 0, ptr %i.cr, align 8, !tbaa !28
  store i32 0, ptr %i.ci, align 4, !tbaa !28
  br label %.thread747

bb.v:                                             ; preds = %bb.gr, %bb.ag, %bb.r, %bb.s, %bb.t, %bb.q
  %i.cs = getelementptr inbounds nuw i8, ptr %0, i64 32
  store i32 1, ptr %i.cs, align 8, !tbaa !28
  %i.ct = load ptr, ptr %i.c, align 8, !tbaa !131 ; 5 uses
  %i.cu = icmp ult ptr %i.ct, %2
  br i1 %i.cu, label %bb.w, label %.thread747

bb.w:                                             ; preds = %bb.v
  %i.cv = load ptr, ptr %i.ap, align 8, !tbaa !83
  %i.cw = tail call i32 %i.cv(ptr noundef %i.ct, ptr noundef nonnull %2) #26
  %i.cx = icmp eq i32 %i.cw, 43
  br i1 %i.cx, label %bb.x, label %.thread747

bb.x:                                             ; preds = %bb.w
  %i.cy = load i32, ptr %i.ar, align 4, !tbaa !145 ; 2 uses
  %i.cz = and i32 %i.cy, 16
  %.not728 = icmp eq i32 %i.cz, 0
  br i1 %.not728, label %bb.z, label %bb.y

bb.y:                                             ; preds = %bb.x
  %i.da = load i32, ptr %0, align 8, !tbaa !142
  %.not729 = icmp eq i32 %i.da, 11
  br i1 %.not729, label %bb.z, label %bb.ab

bb.z:                                             ; preds = %bb.y, %bb.x
  %i.db = and i32 %i.cy, 32
  %.not730 = icmp eq i32 %i.db, 0
  br i1 %.not730, label %.thread747, label %bb.aa

bb.aa:                                            ; preds = %bb.z
  %i.dc = load i32, ptr %0, align 8, !tbaa !142
  %i.dd = icmp eq i32 %i.dc, 11
  br i1 %i.dd, label %bb.ab, label %.thread747

bb.ab:                                            ; preds = %bb.aa, %bb.y
  %i.de = getelementptr inbounds nuw i8, ptr %0, i64 36 ; 2 uses
  %i.df = load i32, ptr %i.de, align 4, !tbaa !28
  %i.dg = icmp eq i32 %i.df, 0
  br i1 %i.dg, label %bb.ac, label %.thread747

bb.ac:                                            ; preds = %bb.ab
  %i.dh = load ptr, ptr %i.ap, align 8, !tbaa !83
  %i.di = tail call i32 %i.dh(ptr noundef %i.ct, ptr noundef nonnull %2) #26 ; 0 uses
  %i.dj = load ptr, ptr %i.p, align 8, !tbaa !84
  %i.dk = tail call i32 %i.dj(ptr noundef %i.ct) #26
  %i.dl = sext i32 %i.dk to i64
  %i.dm = getelementptr inbounds i8, ptr %i.ct, i64 %i.dl
  store ptr %i.dm, ptr %i.c, align 8, !tbaa !131
  store i32 1, ptr %i.de, align 4, !tbaa !28
  br label %.thread747

bb.ad:                                            ; preds = %bb.m
  %i.dn = load i32, ptr %i.r, align 4, !tbaa !147
  %i.do = and i32 %i.dn, 512
  %.not685 = icmp eq i32 %i.do, 0
  br i1 %.not685, label %.thread747, label %bb.ae

bb.ae:                                            ; preds = %bb.ad
  %i.dp = call fastcc i32 @fetch_interval(ptr noundef %i.c, ptr noundef nonnull %2, ptr noundef %0, ptr noundef %3) ; 3 uses
  %i.dq = icmp slt i32 %i.dp, 0
  br i1 %i.dq, label %.thread750, label %bb.af

bb.af:                                            ; preds = %bb.ae
  switch i32 %i.dp, label %.thread747 [
    i32 0, label %bb.q
end_hunk_0
...
bb.gz:                                            ; preds = %bb.gy
  ...
  br i1 %i.sl, label %.lr.ph, label %.thread750.loopexit1102
...
bb.hd:                                            ; preds = %bb.hc, %bb.hb, %bb.ha
  ...
  br i1 %i.te, label %.lr.ph, label %..thread750.loopexit770_crit_edge942
...
bb.hp:                                            ; preds = %bb.ho
  ...
  switch i32 %i.um, label %._crit_edge1036 [
    i32 0, label %.critedge734.thread
    i32 2, label %bb.hq
  ]

._crit_edge1036:                                  ; preds = %bb.hp
...
bb.ht:                                            ; preds = %._crit_edge1036, %backref_rel_to_abs.exit744
  %i.va = phi i32 [ %.pre, %._crit_edge1036 ], [ %.0.i742, %backref_rel_to_abs.exit744 ]
...
.critedge734.thread762.sink.split:                ; preds = %bb.ht, %bb.hh
  %.sink1220 = phi ptr [ %i.tk, %bb.hh ], [ %i.sa, %bb.ht ]
  store ptr %.sink1220, ptr %i.as, align 8, !tbaa !28
...
.critedge734.thread762:                           ; preds = %.critedge734.thread762.sink.split, %bb.hj
  %.sink1218 = phi ptr [ %i.tu, %bb.hj ], [ %i.vd, %.critedge734.thread762.sink.split ]
  %i.ve = getelementptr inbounds nuw i8, ptr %0, i64 32
  store ptr %.sink1218, ptr %i.ve, align 8, !tbaa !28
  call void @llvm.lifetime.end.p0(ptr nonnull %i.n) #26
  call void @llvm.lifetime.end.p0(ptr nonnull %i.m) #26
  call void @llvm.lifetime.end.p0(ptr nonnull %i.l) #26
  br label %.thread747
...
.loopexit776:                                     ; preds = %.loopexit776.loopexit, %.critedge734, %.loopexit777, %4
  ...
  br i1 %.not719, label %.thread747, label %bb.hy

bb.hy:                                            ; preds = %.loopexit776
...
bb.hz:                                            ; preds = %bb.gj
  ...
  br i1 %.not706, label %.thread747, label %bb.ia
...
bb.ib:                                            ; preds = %bb.gj
  ...
  br i1 %.not702, label %.thread747, label %bb.ic
...
bb.ic:                                            ; preds = %bb.ib
  ...
  br i1 %.not703, label %bb.ie, label %bb.id
...
bb.id:                                            ; preds = %bb.ic
  ...
  br i1 %.not704, label %.thread747, label %bb.ie
...
bb.if:                                            ; preds = %bb.gj
  ...
  br i1 %.not698, label %.thread747, label %bb.ig
...
bb.ig:                                            ; preds = %bb.if
  ...
  br i1 %.not699, label %bb.ii, label %bb.ih
...
bb.ih:                                            ; preds = %bb.ig
  ...
  br i1 %.not700, label %.thread747, label %bb.ii
...
bb.ij:                                            ; preds = %bb.gj
  ...
  br i1 %.not697, label %.thread747, label %bb.ik
...
bb.il:                                            ; preds = %bb.gj
  ...
  br i1 %i.wr, label %bb.im, label %.thread747
...
.preheader771:                                    ; preds = %bb.in, %bb.io
  %i.wu = phi ptr [ %i.xa, %bb.io ], [ %i.bg, %bb.in ] ; 5 uses
  %.not695 = icmp ult ptr %i.wu, %2
  br i1 %.not695, label %bb.io, label %.backedge

bb.io:                                            ; preds = %.preheader771
...
.backedge:                                        ; preds = %.preheader771, %bb.io, %bb.hc, %bb.ip
  %i.xd = phi ptr [ %i.ss, %bb.hc ], [ %i.bg, %bb.ip ], [ %i.wu, %.preheader771 ], [ %i.xa, %bb.io ] ; 3 uses
  %i.xe = icmp ult ptr %i.xd, %2
  br i1 %i.xe, label %bb.j, label %._crit_edge.loopexit

bb.ip:                                            ; preds = %bb.gj, %bb.gj, %bb.gj, %bb.gj, %bb.gj
  %i.xf = load i32, ptr %3, align 8, !tbaa !123
  %i.xg = and i32 %i.xf, 2
  %.not693 = icmp eq i32 %i.xg, 0
  br i1 %.not693, label %.thread747.loopexit, label %.backedge

.thread747.loopexit:                              ; preds = %bb.in, %bb.ip, %bb.gj, %bb.gb
  store ptr %i.bg, ptr %i.c, align 8
  br label %.thread747

.thread747:                                       ; preds = %.thread747.loopexit, %.thread, %.critedge734.thread762, %bb.ga, %bb.ey, %bb.ex, %bb.gq, %bb.af, %bb.fp, %bb.fq, %bb.fo, %bb.fu, %bb.fv, %bb.fr, %bb.fs, %bb.fm, %bb.fn, %bb.fb, %bb.fa, %bb.fl, %bb.fk, %bb.ee, %bb.ed, %bb.er, %bb.ez, %bb.eb, %bb.ec, %bb.dp, %bb.do, %bb.dl, %bb.dn, %bb.dk, %bb.dg, %bb.df, %bb.dj, %bb.dh, %bb.cs, %bb.cm, %bb.cn, %bb.cl, %bb.ck, %bb.cj, %bb.ch, %bb.cf, %bb.cc, %bb.bz, %bb.bx, %bb.bv, %bb.bt, %bb.br, %bb.bp, %bb.bn, %bb.bl, %bb.bj, %bb.bh, %bb.bf, %bb.bd, %bb.bb, %bb.az, %bb.ax, %bb.av, %bb.at, %bb.ar, %bb.ap, %bb.an, %bb.al, %bb.aj, %bb.ah, %bb.ad, %bb.u, %bb.v, %bb.ac, %bb.ab, %bb.aa, %bb.z, %bb.w, %bb.p, %bb.o, %bb.n, %bb.dy, %bb.dw, %bb.ci, %bb.cg, %bb.cd, %bb.ca, %bb.by, %bb.bw, %bb.bu, %bb.bs, %bb.bq, %bb.bo, %bb.bm, %bb.bk, %bb.bi, %bb.bg, %bb.be, %bb.bc, %bb.ba, %bb.ay, %bb.aw, %bb.au, %bb.as, %bb.aq, %bb.ao, %bb.am, %bb.ak, %bb.ai, %bb.il, %bb.im, %bb.ij, %bb.ih, %bb.if, %bb.id, %bb.ib, %bb.hz, %.loopexit776, %bb.gs, %bb.go, %bb.gn, %bb.gm, %bb.gl, %bb.gk, %bb.ik, %bb.ii, %bb.ie, %bb.ia, %bb.hy, %bb.gt, %.loopexit772, %bb.gi, %bb.h
  %i.xh = load ptr, ptr %i.c, align 8, !tbaa !131
  store ptr %i.xh, ptr %1, align 8, !tbaa !131
  %i.xi = load i32, ptr %0, align 8, !tbaa !142
  br label %.thread750
...
..thread750.loopexit770_crit_edge942:             ; preds = %bb.hd
  store ptr %i.sa, ptr %i.c, align 8
  br label %.thread750

.thread750.loopexit1102:                          ; preds = %bb.gz
  store ptr %i.sa, ptr %i.c, align 8
  br label %.thread750

.thread750:                                       ; preds = %bb.ew, %bb.ev, %.thread750.loopexit1102, %..thread750.loopexit770_crit_edge942, %bb.es, %.critedge734.thread, %get_next_code_point.exit.thread, %bb.hw, %bb.gp, %.critedge732, %bb.ff, %bb.fd, %bb.ep, %bb.eq, %backref_rel_to_abs.exit, %bb.ej, %bb.eh, %bb.ea, %bb.du, %bb.dv, %bb.dm, %bb.di, %bb.dd, %bb.dc, %bb.cz, %bb.cx, %bb.cu, %bb.cr, %bb.co, %bb.ce, %bb.ae, %bb.l, %get_next_code_point.exit, %.thread747, %backref_rel_to_abs.exit739.thread, %._crit_edge
  %.5 = phi i32 [ %i.xi, %.thread747 ], [ %.0.i741755, %.critedge732 ], [ %i.rl, %bb.gp ], [ %.4582.ph, %.critedge734.thread ], [ -200, %bb.ea ], [ %i.ls, %bb.eh ], [ -208, %bb.ej ], [ -208, %backref_rel_to_abs.exit ], [ -118, %bb.hw ], [ -208, %bb.ep ], [ %i.ol, %bb.fd ], [ -218, %backref_rel_to_abs.exit739.thread ], [ -118, %.thread750.loopexit1102 ], [ -400, %get_next_code_point.exit.thread ], [ -104, %bb.l ], [ %i.dp, %bb.ae ], [ -213, %bb.ce ], [ %i.gv, %bb.co ], [ -400, %bb.cz ], [ %i.ip, %bb.dc ], [ -212, %bb.cx ], [ -212, %bb.cr ], [ %i.hp, %bb.cu ], [ -400, %bb.dd ], [ %i.iu, %bb.di ], [ -208, %bb.du ], [ %phi.call, %bb.dm ], [ %.0.i, %get_next_code_point.exit ], [ 0, %._crit_edge ], [ -208, %bb.dv ], [ -208, %bb.eq ], [ -218, %bb.ff ], [ -217, %bb.es ], [ -118, %..thread750.loopexit770_crit_edge942 ], [ -208, %bb.ev ], [ -208, %bb.ew ]
...
bb.e:                                             ; preds = %bb.h, %.lr.ph.i
  ...
  %i.s = tail call i32 %i.r(ptr noundef %.030.i) #26, !inline_history !150
  %i.t = sext i32 %i.s to i64
  %i.u = getelementptr inbounds i8, ptr %.030.i, i64 %i.t ; 3 uses
  %i.v = icmp ult i32 %i.q, 128
  br i1 %i.v, label %bb.f, label %scan_number.exit

bb.f:                                             ; preds = %bb.e
  %i.w = load ptr, ptr %i.o, align 8, !tbaa !148
end_hunk_1
