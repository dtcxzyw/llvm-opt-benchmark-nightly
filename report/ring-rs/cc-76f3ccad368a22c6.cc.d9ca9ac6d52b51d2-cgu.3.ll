...
bb.a:
  ...
  %i.b = tail call ptr %i.a(ptr align 8 null), !inline_history !7 ; 2 uses
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %wide.load = load <2 x i64>, ptr %i.c, align 1, !alias.scope !13, !noalias !14
  %wide.load3 = load <2 x i64>, ptr %i.e, align 1, !alias.scope !13, !noalias !14
  %i.f = getelementptr inbounds nuw i8, ptr %i.d, i64 16 ; 2 uses
  %wide.load4 = load <2 x i64>, ptr %i.d, align 1, !alias.scope !14
  %wide.load5 = load <2 x i64>, ptr %i.f, align 1, !alias.scope !14
  store <2 x i64> %wide.load4, ptr %i.c, align 1, !alias.scope !13, !noalias !14
  store <2 x i64> %wide.load5, ptr %i.e, align 1, !alias.scope !13, !noalias !14
  store <2 x i64> %wide.load, ptr %i.d, align 1, !alias.scope !14
  store <2 x i64> %wide.load3, ptr %i.f, align 1, !alias.scope !14
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.g = icmp eq i64 %index.next, %i.a
  br i1 %i.g, label %_RNvNtCs3oUPovFnLWP_4core3ptr25swap_nonoverlapping_bytesCsiHivYpkJ4Hu_2cc.exit, label %vector.body, !llvm.loop !11
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.i.i.preheader
  ...
  br i1 %exitcond.not.i.i.1, label %_RNvNtCs3oUPovFnLWP_4core3ptr25swap_nonoverlapping_bytesCsiHivYpkJ4Hu_2cc.exit, label %.lr.ph.i.i, !llvm.loop !12
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.b, align 1, !alias.scope !20, !noalias !21
  %wide.load5 = load <2 x i64>, ptr %i.d, align 1, !alias.scope !20, !noalias !21
  %i.e = getelementptr inbounds nuw i8, ptr %i.c, i64 16 ; 2 uses
  %wide.load6 = load <2 x i64>, ptr %i.c, align 1, !alias.scope !21
  %wide.load7 = load <2 x i64>, ptr %i.e, align 1, !alias.scope !21
  store <2 x i64> %wide.load6, ptr %i.b, align 1, !alias.scope !20, !noalias !21
  store <2 x i64> %wide.load7, ptr %i.d, align 1, !alias.scope !20, !noalias !21
  store <2 x i64> %wide.load, ptr %i.c, align 1, !alias.scope !21
  store <2 x i64> %wide.load5, ptr %i.e, align 1, !alias.scope !21
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.f = icmp eq i64 %index.next, %n.vec
  br i1 %i.f, label %middle.block, label %vector.body, !llvm.loop !18
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  br i1 %exitcond.not.1, label %._crit_edge, label %.lr.ph, !llvm.loop !19
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.f = getelementptr inbounds nuw i8, ptr %i.d, i64 16 ; 2 uses
  %wide.load = load <2 x i64>, ptr %i.d, align 1, !alias.scope !27, !noalias !28
  %wide.load9 = load <2 x i64>, ptr %i.f, align 1, !alias.scope !27, !noalias !28
  %i.g = getelementptr inbounds nuw i8, ptr %i.e, i64 16 ; 2 uses
  %wide.load10 = load <2 x i64>, ptr %i.e, align 1, !alias.scope !28
  %wide.load11 = load <2 x i64>, ptr %i.g, align 1, !alias.scope !28
  store <2 x i64> %wide.load10, ptr %i.d, align 1, !alias.scope !27, !noalias !28
  store <2 x i64> %wide.load11, ptr %i.f, align 1, !alias.scope !27, !noalias !28
  store <2 x i64> %wide.load, ptr %i.e, align 1, !alias.scope !28
  store <2 x i64> %wide.load9, ptr %i.g, align 1, !alias.scope !28
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.h = icmp eq i64 %index.next, %n.vec
  br i1 %i.h, label %middle.block, label %vector.body, !llvm.loop !25
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  br i1 %exitcond.not.i.1, label %_RINvNvNtCs3oUPovFnLWP_4core3ptr25swap_nonoverlapping_bytes26swap_nonoverlapping_chunksKj8_ECsiHivYpkJ4Hu_2cc.exit, label %.lr.ph.i, !llvm.loop !26
