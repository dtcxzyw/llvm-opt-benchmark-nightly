...
._crit_edge.i:                                    ; preds = %bb.m, %bb.l
  ...
  %.not17.i = trunc i8 %.sroa.0.0.lcssa.i to i1
  br i1 %.not17.i, label %.thread, label %bb.n

._crit_edge.i.thread:                             ; preds = %bb.h
  %.not17.i50 = trunc i8 %spec.select20.i to i1
  br i1 %.not17.i50, label %.thread.thread, label %bb.n
