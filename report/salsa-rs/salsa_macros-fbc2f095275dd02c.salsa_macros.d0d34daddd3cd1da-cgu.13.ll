...
bb.a:
  ...
  call void @_RNvXs2y_NtNtCs3Eghgi3KVFH_3syn3gen5cloneNtNtBa_2ty4TypeNtNtCs4NRVxsYgnAr_4core5clone5Clone5clone(ptr nonnull sret([248 x i8]) align 8 %i.b, ptr align 8 %2), !noalias !49
  store ptr %i.e, ptr %i.a, align 8, !noalias !49
  %i.g = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store i64 %i.f, ptr %i.g, align 8, !noalias !49
  invoke void @_RINvNtNtCs3Eghgi3KVFH_3syn3gen9visit_mut14visit_type_mutNtNvNtCshVzvyy7iigg_12salsa_macros9supertype29replace_lifetimes_with_static16LifetimeReplacerEBY_(ptr nonnull align 8 %i.a, ptr nonnull align 8 %i.b)
          to label %_RNvNtCshVzvyy7iigg_12salsa_macros9supertype29replace_lifetimes_with_static.exit unwind label %bb.b, !noalias !49
...
bb.c:                                             ; preds = %bb.b
  %i.i = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCs4NRVxsYgnAr_4core9panicking16panic_in_cleanup() #17, !noalias !49
  unreachable
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.d, align 1, !alias.scope !55, !noalias !56
  %wide.load9 = load <2 x i64>, ptr %i.f, align 1, !alias.scope !55, !noalias !56
  %i.g = getelementptr inbounds nuw i8, ptr %i.e, i64 16 ; 2 uses
  %wide.load10 = load <2 x i64>, ptr %i.e, align 1, !alias.scope !56
  %wide.load11 = load <2 x i64>, ptr %i.g, align 1, !alias.scope !56
  store <2 x i64> %wide.load10, ptr %i.d, align 1, !alias.scope !55, !noalias !56
  store <2 x i64> %wide.load11, ptr %i.f, align 1, !alias.scope !55, !noalias !56
  store <2 x i64> %wide.load, ptr %i.e, align 1, !alias.scope !56
  store <2 x i64> %wide.load9, ptr %i.g, align 1, !alias.scope !56
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  br i1 %exitcond.not.i.1, label %_RINvNvNtCs4NRVxsYgnAr_4core3ptr25swap_nonoverlapping_bytes26swap_nonoverlapping_chunksKj8_ECshVzvyy7iigg_12salsa_macros.exit, label %.lr.ph.i, !llvm.loop !54
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %4 = trunc i64 %2 to i1
  br i1 %4, label %bb.g, label %_RNvNvNtCs4NRVxsYgnAr_4core3ptr25swap_nonoverlapping_bytes25swap_nonoverlapping_shortCshVzvyy7iigg_12salsa_macros.exit
