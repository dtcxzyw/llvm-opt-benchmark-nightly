...
._crit_edge.i18.unr-lcssa:                        ; preds = %bb.l
  ...
  br i1 %4, label %.epil.preheader, label %._crit_edge.i18
...
._crit_edge.i17.unr-lcssa:                        ; preds = %bb.k
  %3 = trunc i64 %.sroa.05.0.i.i.i to i1
  br i1 %3, label %.epil.preheader, label %._crit_edge.i17
...
._crit_edge.i18.unr-lcssa:                        ; preds = %bb.l
  %5 = trunc i64 %.sroa.05.0.i.i.i to i1
  br i1 %5, label %.epil.preheader, label %._crit_edge.i18
...
._crit_edge.i17.unr-lcssa:                        ; preds = %bb.k
  %4 = trunc i64 %.sroa.05.0.i.i.i to i1
  br i1 %4, label %.epil.preheader, label %._crit_edge.i17
...
._crit_edge.i18.unr-lcssa:                        ; preds = %bb.n
  %3 = trunc i64 %.sroa.05.0.i.i.i to i1
  br i1 %3, label %.epil.preheader, label %._crit_edge.i18
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %3 = trunc i64 %2 to i1
  br i1 %3, label %bb.g, label %_RNvNvNtCs4NRVxsYgnAr_4core3ptr25swap_nonoverlapping_bytes25swap_nonoverlapping_short.exit
