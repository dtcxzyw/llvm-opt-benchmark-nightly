...
.preheader.lr.ph:                                 ; preds = %bb.h
  ...
  %i.ap = getelementptr i8, ptr %6, i64 %i.ak
  %i.aq = getelementptr i8, ptr %i.ap, i64 16
  %i.ar = getelementptr i8, ptr %6, i64 %i.ak
...
.preheader:                                       ; preds = %.preheader.lr.ph, %._crit_edge387.thread
  ...
  %scevgep485 = getelementptr i8, ptr %i.aq, i64 %i.au ; 2 uses
