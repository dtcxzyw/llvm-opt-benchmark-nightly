...
bb.a:
  ...
  %i.q = load i32, ptr %5, align 4, !tbaa !42     ; 33 uses
  ...
  %i.v = load i32, ptr %9, align 4, !tbaa !42     ; 9 uses
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.ae = load i32, ptr %3, align 4, !tbaa !42    ; 3 uses
  %i.af = add nsw i32 %i.ae, 1                    ; 5 uses
  store i32 %i.af, ptr %i.n, align 4, !tbaa !42
  %i.ag = add nsw i32 %i.ae, -1
  store i32 %i.ag, ptr %i.p, align 4, !tbaa !42
  %i.ah = load i32, ptr %5, align 4, !tbaa !42
  %i.ai = add nsw i32 %i.ah, -1
  store i32 %i.ai, ptr %i.j, align 4, !tbaa !42
...
bb.k:                                             ; preds = %bb.j
  %.pr = load i32, ptr %11, align 4, !tbaa !42    ; 2 uses
...
.thread:                                          ; preds = %.thread.sink.split, %bb.k
  ...
  store i32 %i.at, ptr %i.d, align 4, !tbaa !42
...
bb.n:                                             ; preds = %bb.m
  ...
  %.pre890 = load i32, ptr %2, align 4, !tbaa !42
  %.pre891 = load i32, ptr %3, align 4, !tbaa !42
  br label %bb.o
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  store i32 %i.az, ptr %i.h, align 4, !tbaa !42
  %i.ba = add i32 %i.ax, -1
...
bb.r:                                             ; preds = %.lr.ph761.us, %._crit_edge.us
  %indvars.iv846 = phi i64 [ %12, %.lr.ph761.us ], [ %indvars.iv.next847, %._crit_edge.us ] ; 6 uses
  ...
  %i.bl = load i32, ptr %i.m, align 4, !tbaa !42
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.bv = load i32, ptr %i.m, align 4, !tbaa !42  ; 2 uses
  %i.bw = load i32, ptr %3, align 4, !tbaa !42    ; 3 uses
  %i.bx = shl i32 %i.bw, 1
...
bb.t:                                             ; preds = %bb.s
  ...
  store i32 %i.bz, ptr %i.e, align 4, !tbaa !42
...
bb.u:                                             ; preds = %.lr.ph.us, %bb.u
  ...
  %i.ca = load i32, ptr %i.e, align 4, !tbaa !42
  %i.cb = sext i32 %i.ca to i64
  %.not689.us.not = icmp slt i64 %indvars.iv, %i.cb
  br i1 %.not689.us.not, label %bb.u, label %.loopexit731.us, !llvm.loop !8

bb.v:                                             ; preds = %bb.s
  %i.cc = add nsw i32 %i.bv, -1
  %i.cd = load i32, ptr %i.n, align 4, !tbaa !42  ; 3 uses
  %i.ce = mul nsw i32 %i.cd, %i.cc                ; 3 uses
  %i.cf = add nsw i32 %i.ce, %i.bj
  store i32 %i.cf, ptr %i.e, align 4, !tbaa !42
  store i32 %i.cd, ptr %i.f, align 4, !tbaa !42
...
.lr.ph738.us:                                     ; preds = %bb.v, %.lr.ph738.us
  ...
  %i.cv = load i32, ptr %i.f, align 4, !tbaa !42  ; 2 uses
  ...
  br i1 %.in688.us, label %.lr.ph738.us, label %.loopexit731.us, !llvm.loop !9
...
bb.w:                                             ; preds = %.loopexit731.us
  %i.dc = load i32, ptr %2, align 4, !tbaa !42
  %i.dd = add i32 %i.bh, %i.dc
  %13 = trunc nuw i64 %indvars.iv846 to i32       ; 4 uses
  %.not691.us = icmp slt i32 %i.dd, %13
  br i1 %.not691.us, label %bb.y, label %bb.x

bb.x:                                             ; preds = %bb.w
  %i.de = load i32, ptr %3, align 4, !tbaa !42
  %i.df = sub nsw i32 %i.de, %13                  ; 2 uses
  %i.dg = add nuw nsw i64 %indvars.iv846, %indvars.iv849
  %14 = trunc nuw i64 %i.dg to i32                ; 2 uses
  %15 = add nsw i32 %14, -2
  %16 = mul nsw i32 %15, %i.q                     ; 3 uses
  %i.dh = add i32 %16, 3
  %i.di = add i32 %i.dh, %i.df
  %i.dj = sext i32 %i.di to i64
  %i.dk = getelementptr inbounds [8 x i8], ptr %i.s, i64 %i.dj
  %17 = add nsw i32 %14, -1                       ; 2 uses
  %18 = mul nsw i32 %17, %i.q                     ; 2 uses
  %i.dl = add i32 %18, 2
  %i.dm = add i32 %i.dl, %i.df
  %i.dn = sext i32 %i.dm to i64
  %i.do = getelementptr inbounds [8 x i8], ptr %i.s, i64 %i.dn
  %19 = zext nneg i32 %17 to i64                  ; 2 uses
  %i.dp = getelementptr inbounds nuw [8 x i8], ptr %i.t, i64 %19 ; 2 uses
  %i.dq = getelementptr inbounds nuw [8 x i8], ptr %i.y, i64 %19 ; 2 uses
  ...
  %i.dr = load double, ptr %i.k, align 8, !tbaa !45
  %i.ds = load i32, ptr %3, align 4, !tbaa !42
  %i.dt = sub nsw i32 %i.ds, %13                  ; 2 uses
  %i.du = add nsw i32 %i.dt, 3                    ; 2 uses
  %20 = add nsw i32 %i.du, %16
  %21 = sext i32 %20 to i64
  %i.dv = getelementptr inbounds [8 x i8], ptr %i.s, i64 %21
  store double %i.dr, ptr %i.dv, align 8, !tbaa !45
  %i.dw = add nsw i32 %13, -3
  store i32 %i.dw, ptr %i.f, align 4, !tbaa !42
  %i.dx = add i32 %16, 4
  %i.dy = add i32 %i.dx, %i.dt
  %i.dz = sext i32 %i.dy to i64
  %i.ea = getelementptr inbounds [8 x i8], ptr %i.s, i64 %i.dz
  %22 = add nsw i32 %i.du, %18
  %23 = sext i32 %22 to i64
  %i.eb = getelementptr inbounds [8 x i8], ptr %i.s, i64 %23
...
bb.y:                                             ; preds = %bb.x, %bb.w
  %i.ec = load i32, ptr %i.m, align 4, !tbaa !42
  %i.ed = add nsw i32 %i.ec, 1                    ; 2 uses
  store i32 %i.ed, ptr %i.m, align 4, !tbaa !42
  %i.ee = add nsw i32 %.1613758.us, -1
  br label %bb.z

thread-pre-split708.us:                           ; preds = %.loopexit731.us
  %.pr709.us = load i32, ptr %i.m, align 4, !tbaa !42
  br label %bb.z
...
bb.aa:                                            ; preds = %bb.z
  %i.eh = load i32, ptr %i.n, align 4, !tbaa !42  ; 2 uses
  ...
  %i.er = load i32, ptr %3, align 4, !tbaa !42
  ...
  %.pre892 = load i32, ptr %i.m, align 4, !tbaa !42 ; 4 uses
  %i.ey = icmp sgt i32 %.pre892, 0
  br i1 %i.ey, label %bb.ab, label %.loopexit730.us

bb.ab:                                            ; preds = %bb.aa
  %i.ez = load i32, ptr %3, align 4, !tbaa !42    ; 3 uses
  %i.fa = shl i32 %i.ez, 1
...
bb.ac:                                            ; preds = %bb.ab
  ...
  store i32 %i.fb, ptr %i.f, align 4, !tbaa !42
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %.pre895 = load i32, ptr %i.f, align 4, !tbaa !42
  br label %bb.af
...
bb.af:                                            ; preds = %bb.ae, %bb.ad
  ...
  br i1 %.not696.us.not, label %bb.ad, label %.loopexit730.us, !llvm.loop !10

bb.ag:                                            ; preds = %bb.ab
  %i.fw = load i32, ptr %i.n, align 4, !tbaa !42  ; 3 uses
...
bb.ah:                                            ; preds = %bb.ag
  store i32 %i.fz, ptr %i.f, align 4, !tbaa !42
  store i32 %i.fw, ptr %i.e, align 4, !tbaa !42
...
.lr.ph744.us:                                     ; preds = %bb.ah, %.lr.ph744.us
  ...
  %i.gc = load i32, ptr %3, align 4, !tbaa !42    ; 2 uses
  %i.gd = add nsw i32 %i.gc, -1                   ; 2 uses
  store i32 %i.gd, ptr %i.g, align 4, !tbaa !42
  ...
  %i.gp = load i32, ptr %i.e, align 4, !tbaa !42  ; 2 uses
  ...
  br i1 %.in694.us, label %.lr.ph744.us, label %.loopexit729.us, !llvm.loop !11

.loopexit729.us:                                  ; preds = %.lr.ph744.us, %bb.ah, %bb.ag
  %i.gv = load i32, ptr %i.p, align 4, !tbaa !42
  %i.gw = load i32, ptr %2, align 4, !tbaa !42
  %i.gx = sub nsw i32 %i.gw, %i.bk                ; 2 uses
  store i32 %i.gx, ptr %i.f, align 4, !tbaa !42
  %i.gy = call i32 @llvm.smin.i32(i32 %i.gv, i32 %i.gx) ; 2 uses
  store i32 %i.gy, ptr %i.i, align 4, !tbaa !42
  %i.gz = icmp sgt i32 %i.gy, 0
  br i1 %i.gz, label %bb.ai, label %.loopexit730.us

bb.ai:                                            ; preds = %.loopexit729.us
  %i.ha = load i32, ptr %i.n, align 4, !tbaa !42
  %i.hb = add nsw i32 %i.ha, %i.fz                ; 2 uses
  %i.hc = load i32, ptr %3, align 4, !tbaa !42
...
bb.ak:                                            ; preds = %bb.aj
  ...
  %i.hp = load i32, ptr %3, align 4, !tbaa !42    ; 2 uses
  store i32 %i.bk, ptr %i.e, align 4, !tbaa !42
  %i.hq = load i32, ptr %i.n, align 4, !tbaa !42  ; 2 uses
  store i32 %i.hq, ptr %i.f, align 4, !tbaa !42
...
.lr.ph749.us.preheader:                           ; preds = %bb.ak
  %i.hu = trunc nuw i64 %indvars.iv846 to i32
  ...
  %24 = call i32 @llvm.smax.i32(i32 %i.hu, i32 3)
  %25 = add nsw i32 %24, -3
...
.lr.ph749.us:                                     ; preds = %.lr.ph749.us.preheader, %.lr.ph749.us
  ...
  %.0618747.us = phi i32 [ %i.ib, %.lr.ph749.us ], [ %25, %.lr.ph749.us.preheader ] ; 2 uses
  %.0632746.us = phi i32 [ %i.iw, %.lr.ph749.us ], [ %.2614.us, %.lr.ph749.us.preheader ] ; 5 uses
  %i.hz = load i32, ptr %i.p, align 4, !tbaa !42
  ...
  store i32 %i.if, ptr %i.l, align 4, !tbaa !42
  %i.ig = load i32, ptr %3, align 4, !tbaa !42
  %i.ih = add nsw i32 %i.ig, %.1748.us            ; 2 uses
  store i32 %i.ih, ptr %i.g, align 4, !tbaa !42
  ...
  %i.iv = load i32, ptr %i.f, align 4, !tbaa !42  ; 2 uses
  ...
  br i1 %.in700.us, label %.lr.ph749.us, label %.loopexit727.us, !llvm.loop !12

bb.al:                                            ; preds = %bb.aj
  store i32 %i.bk, ptr %i.f, align 4, !tbaa !42
  %i.jb = load i32, ptr %i.n, align 4, !tbaa !42  ; 2 uses
  store i32 %i.jb, ptr %i.e, align 4, !tbaa !42
...
.lr.ph752.us:                                     ; preds = %bb.al, %.lr.ph752.us
  ...
  %i.jr = load i32, ptr %i.e, align 4, !tbaa !42  ; 2 uses
  ...
  br i1 %.in697.us, label %.lr.ph752.us, label %.loopexit727.us, !llvm.loop !13
...
.loopexit727.us:                                  ; preds = %.lr.ph749.us, %.lr.ph752.us, %bb.ak, %bb.al, %.loopexit730.us
  ...
  %i.jy = load i32, ptr %2, align 4, !tbaa !42    ; 2 uses
  %i.jz = icmp sgt i32 %i.jx, %i.jy
  br i1 %i.jz, label %bb.am, label %bb.an

bb.am:                                            ; preds = %.loopexit727.us
  %i.ka = load i32, ptr %i.m, align 4, !tbaa !42
  %i.kb = add nsw i32 %i.ka, -1
  store i32 %i.kb, ptr %i.m, align 4, !tbaa !42
  %i.kc = add nsw i32 %.1609759.us, -1
  br label %bb.an

bb.an:                                            ; preds = %bb.am, %.loopexit727.us
  %.2610.us = phi i32 [ %i.kc, %bb.am ], [ %i.bk, %.loopexit727.us ] ; 6 uses
  store i32 %.2610.us, ptr %i.e, align 4, !tbaa !42
  %i.kd = load i32, ptr %i.n, align 4, !tbaa !42  ; 4 uses
  store i32 %i.kd, ptr %i.f, align 4, !tbaa !42
...
bb.ao:                                            ; preds = %.lr.ph755.us, %bb.ao
  ...
  %i.ki = load double, ptr %i.kh, align 8, !tbaa !45
  ...
  %i.kn = load double, ptr %i.km, align 8, !tbaa !45
  %i.ko = fmul double %i.ki, %i.kn
  %i.kp = getelementptr inbounds [8 x i8], ptr %i.y, i64 %i.kj
  store double %i.ko, ptr %i.kp, align 8, !tbaa !45
  %i.kq = getelementptr inbounds [8 x i8], ptr %i.t, i64 %indvars.iv843
  %i.kr = load double, ptr %i.kq, align 8, !tbaa !45
  %i.ks = load double, ptr %i.km, align 8, !tbaa !45
  %i.kt = fmul double %i.kr, %i.ks
  store double %i.kt, ptr %i.km, align 8, !tbaa !45
  ...
  br i1 %.in701.us, label %bb.ao, label %._crit_edge.us, !llvm.loop !14

._crit_edge.us:                                   ; preds = %bb.ao, %bb.an
  %indvars.iv.next847 = add nsw i64 %indvars.iv846, -1
  %26 = trunc nuw i64 %indvars.iv846 to i32
  %i.kw = icmp sgt i32 %26, 2
  br i1 %i.kw, label %bb.r, label %._crit_edge762.us, !llvm.loop !15
...
.lr.ph755.us:                                     ; preds = %bb.an
  %i.lc = load i32, ptr %3, align 4, !tbaa !42
...
._crit_edge762.us:                                ; preds = %._crit_edge.us
  ...
  %i.lh = trunc nuw nsw i64 %indvars.iv849 to i32
  %i.li = xor i32 %i.lh, -1
  %.not683.us.not = icmp slt i64 %indvars.iv849, %i.bg
  br i1 %.not683.us.not, label %.lr.ph761.us, label %.loopexit733.loopexit, !llvm.loop !16

.loopexit733.loopexit:                            ; preds = %._crit_edge762.us
  %.pre896 = load i32, ptr %3, align 4, !tbaa !42
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x double>, ptr %i.lz, align 8, !tbaa !45
  %wide.load966 = load <4 x double>, ptr %i.ma, align 8, !tbaa !45
  %wide.load967 = load <4 x double>, ptr %i.mb, align 8, !tbaa !45
  %wide.load968 = load <4 x double>, ptr %i.mc, align 8, !tbaa !45
  ...
  store <4 x double> %wide.load, ptr %i.md, align 8, !tbaa !45
  store <4 x double> %wide.load966, ptr %i.me, align 8, !tbaa !45
  store <4 x double> %wide.load967, ptr %i.mf, align 8, !tbaa !45
  store <4 x double> %wide.load968, ptr %i.mg, align 8, !tbaa !45
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.mh = icmp eq i64 %index.next, %n.vec
  br i1 %i.mh, label %middle.block, label %vector.body, !llvm.loop !17
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph777.preheader, label %vec.epilog.ph, !prof !48
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load971 = load <4 x double>, ptr %i.mk, align 8, !tbaa !45
  %i.ml = getelementptr [8 x i8], ptr %7, i64 %index970
  store <4 x double> %wide.load971, ptr %i.ml, align 8, !tbaa !45
  %index.next972 = add nuw i64 %index970, 4       ; 2 uses
  %i.mm = icmp eq i64 %index.next972, %n.vec969
  br i1 %i.mm, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !18
...
.lr.ph777.prol:                                   ; preds = %.lr.ph777.preheader, %.lr.ph777.prol
  ...
  %i.mp = load double, ptr %gep943.prol, align 8, !tbaa !45
  %i.mq = getelementptr inbounds nuw [8 x i8], ptr %i.u, i64 %indvars.iv856.prol
  store double %i.mp, ptr %i.mq, align 8, !tbaa !45
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph777.prol.loopexit, label %.lr.ph777.prol, !llvm.loop !19
...
.lr.ph777:                                        ; preds = %.lr.ph777.prol.loopexit, %.lr.ph777
  ...
  %i.mu = load double, ptr %gep943, align 8, !tbaa !45
  %i.mv = getelementptr inbounds nuw [8 x i8], ptr %i.u, i64 %indvars.iv856
  store double %i.mu, ptr %i.mv, align 8, !tbaa !45
  ...
  %i.mx = load double, ptr %gep943.1, align 8, !tbaa !45
  %i.my = getelementptr [8 x i8], ptr %7, i64 %indvars.iv856
  store double %i.mx, ptr %i.my, align 8, !tbaa !45
  ...
  %i.na = load double, ptr %gep943.2, align 8, !tbaa !45
  %i.nb = getelementptr inbounds nuw [8 x i8], ptr %i.u, i64 %indvars.iv.next857.1
  store double %i.na, ptr %i.nb, align 8, !tbaa !45
  ...
  %i.nd = load double, ptr %gep943.3, align 8, !tbaa !45
  %i.ne = getelementptr inbounds nuw [8 x i8], ptr %i.u, i64 %indvars.iv.next857.2
  store double %i.nd, ptr %i.ne, align 8, !tbaa !45
  ...
  %i.ng = load double, ptr %gep943.4, align 8, !tbaa !45
  %i.nh = getelementptr inbounds nuw [8 x i8], ptr %i.u, i64 %indvars.iv.next857.3
  store double %i.ng, ptr %i.nh, align 8, !tbaa !45
  ...
  %i.nj = load double, ptr %gep943.5, align 8, !tbaa !45
  %i.nk = getelementptr inbounds nuw [8 x i8], ptr %i.u, i64 %indvars.iv.next857.4
  store double %i.nj, ptr %i.nk, align 8, !tbaa !45
  ...
  %i.nm = load double, ptr %gep943.6, align 8, !tbaa !45
  %i.nn = getelementptr inbounds nuw [8 x i8], ptr %i.u, i64 %indvars.iv.next857.5
  store double %i.nm, ptr %i.nn, align 8, !tbaa !45
  ...
  %i.np = load double, ptr %gep943.7, align 8, !tbaa !45
  %i.nq = getelementptr inbounds nuw [8 x i8], ptr %i.u, i64 %indvars.iv.next857.6
  store double %i.np, ptr %i.nq, align 8, !tbaa !45
  %exitcond.not.7 = icmp eq i64 %indvars.iv.next857.7, %wide.trip.count
  br i1 %exitcond.not.7, label %iter.check994, label %.lr.ph777, !llvm.loop !20
...
.lr.ph.preheader:                                 ; preds = %bb.ap
  ...
  call void @llvm.memset.p0.i64(ptr align 8 %7, i8 0, i64 %i.nt, i1 false), !tbaa !45
...
begin_hunk_1_@dsbtrd_:bb.a
  ...
  %i.pd = icmp ult i64 %i.oz, 7
  br i1 %i.pd, label %.loopexit, label %vec.epilog.scalar.ph995
...
vec.epilog.scalar.ph995:                          ; preds = %vec.epilog.scalar.ph995.prol.loopexit, %vec.epilog.scalar.ph995
  ...
  %i.pe = mul nsw i64 %indvars.iv859, %i.ny
  %gep945 = getelementptr [8 x i8], ptr %invariant.gep944, i64 %i.pe
  %i.pf = load double, ptr %gep945, align 8, !tbaa !45
  %i.pg = getelementptr inbounds nuw [8 x i8], ptr %i.t, i64 %indvars.iv859
  store double %i.pf, ptr %i.pg, align 8, !tbaa !45
  %indvars.iv.next860 = add nuw nsw i64 %indvars.iv859, 1
  %i.ph = mul nsw i64 %indvars.iv.next860, %i.ny
  %gep945.1 = getelementptr [8 x i8], ptr %invariant.gep944, i64 %i.ph
  %i.pi = load double, ptr %gep945.1, align 8, !tbaa !45
  %i.pj = getelementptr [8 x i8], ptr %6, i64 %indvars.iv859
  store double %i.pi, ptr %i.pj, align 8, !tbaa !45
  %indvars.iv.next860.1 = add nuw nsw i64 %indvars.iv859, 2 ; 2 uses
  %i.pk = mul nsw i64 %indvars.iv.next860.1, %i.ny
  %gep945.2 = getelementptr [8 x i8], ptr %invariant.gep944, i64 %i.pk
  %i.pl = load double, ptr %gep945.2, align 8, !tbaa !45
  %i.pm = getelementptr inbounds nuw [8 x i8], ptr %i.t, i64 %indvars.iv.next860.1
  store double %i.pl, ptr %i.pm, align 8, !tbaa !45
  %indvars.iv.next860.2 = add nuw nsw i64 %indvars.iv859, 3 ; 2 uses
  %i.pn = mul nsw i64 %indvars.iv.next860.2, %i.ny
  %gep945.3 = getelementptr [8 x i8], ptr %invariant.gep944, i64 %i.pn
  %i.po = load double, ptr %gep945.3, align 8, !tbaa !45
  %i.pp = getelementptr inbounds nuw [8 x i8], ptr %i.t, i64 %indvars.iv.next860.2
  store double %i.po, ptr %i.pp, align 8, !tbaa !45
  %indvars.iv.next860.3 = add nuw nsw i64 %indvars.iv859, 4 ; 2 uses
  %i.pq = mul nsw i64 %indvars.iv.next860.3, %i.ny
  %gep945.4 = getelementptr [8 x i8], ptr %invariant.gep944, i64 %i.pq
  %i.pr = load double, ptr %gep945.4, align 8, !tbaa !45
  %i.ps = getelementptr inbounds nuw [8 x i8], ptr %i.t, i64 %indvars.iv.next860.3
  store double %i.pr, ptr %i.ps, align 8, !tbaa !45
  %indvars.iv.next860.4 = add nuw nsw i64 %indvars.iv859, 5 ; 2 uses
  %i.pt = mul nsw i64 %indvars.iv.next860.4, %i.ny
  %gep945.5 = getelementptr [8 x i8], ptr %invariant.gep944, i64 %i.pt
  %i.pu = load double, ptr %gep945.5, align 8, !tbaa !45
  %i.pv = getelementptr inbounds nuw [8 x i8], ptr %i.t, i64 %indvars.iv.next860.4
  store double %i.pu, ptr %i.pv, align 8, !tbaa !45
  %indvars.iv.next860.5 = add nuw nsw i64 %indvars.iv859, 6 ; 2 uses
  %i.pw = mul nsw i64 %indvars.iv.next860.5, %i.ny
  %gep945.6 = getelementptr [8 x i8], ptr %invariant.gep944, i64 %i.pw
  %i.px = load double, ptr %gep945.6, align 8, !tbaa !45
  %i.py = getelementptr inbounds nuw [8 x i8], ptr %i.t, i64 %indvars.iv.next860.5
  store double %i.px, ptr %i.py, align 8, !tbaa !45
  %indvars.iv.next860.6 = add nuw nsw i64 %indvars.iv859, 7 ; 2 uses
  %i.pz = mul nsw i64 %indvars.iv.next860.6, %i.ny
  %gep945.7 = getelementptr [8 x i8], ptr %invariant.gep944, i64 %i.pz
  %i.qa = load double, ptr %gep945.7, align 8, !tbaa !45
  %i.qb = getelementptr inbounds nuw [8 x i8], ptr %i.t, i64 %indvars.iv.next860.6
  store double %i.qa, ptr %i.qb, align 8, !tbaa !45
...
.lr.ph810.us.preheader:                           ; preds = %bb.ar
  %i.qc = add nsw i32 %i.ax, -2
  %i.qd = add i32 %., 1
  %i.qe = add nsw i32 %., 2
  %i.qf = sext i32 %i.q to i64                    ; 3 uses
  %i.qg = sext i32 %i.qd to i64
  %i.qh = sext i32 %i.qc to i64
  br label %.lr.ph810.us

.lr.ph810.us:                                     ; preds = %.lr.ph810.us.preheader, %._crit_edge811.us
  %i.qi = phi i32 [ %i.af, %.lr.ph810.us.preheader ], [ %i.zg, %._crit_edge811.us ]
  %indvars.iv873 = phi i64 [ 1, %.lr.ph810.us.preheader ], [ %indvars.iv.next874, %._crit_edge811.us ] ; 6 uses
  %.4642.neg819.us = phi i32 [ -1, %.lr.ph810.us.preheader ], [ %i.aal, %._crit_edge811.us ] ; 2 uses
  %.3611818.us = phi i32 [ 1, %.lr.ph810.us.preheader ], [ %.5.us, %._crit_edge811.us ]
  %.3615817.us = phi i32 [ %i.qe, %.lr.ph810.us.preheader ], [ %.5617.us, %._crit_edge811.us ]
  %.3623816.us = phi i32 [ 1, %.lr.ph810.us.preheader ], [ %.5625.us, %._crit_edge811.us ]
  %i.qj = add nsw i32 %.4642.neg819.us, 1
  %i.qk = mul nsw i64 %indvars.iv873, %i.qf       ; 2 uses
  %indvars.iv.next874 = add nuw nsw i64 %indvars.iv873, 1 ; 2 uses
  %i.ql = mul nsw i64 %indvars.iv.next874, %i.qf  ; 2 uses
  %i.qm = add i64 %i.ql, 4294967294
  %invariant.gep950 = getelementptr [8 x i8], ptr %i.s, i64 %i.qk
  %invariant.gep952 = getelementptr [8 x i8], ptr %i.s, i64 %i.qk
  %i.qn = add nuw i64 %indvars.iv873, 4294967295
  %invariant.gep954 = getelementptr [8 x i8], ptr %i.s, i64 %i.ql
  %i.qo = trunc nuw nsw i64 %indvars.iv873 to i32
  br label %bb.as

bb.as:                                            ; preds = %.lr.ph810.us, %._crit_edge.us822
  %i.qp = phi i32 [ %i.qi, %.lr.ph810.us ], [ %i.zg, %._crit_edge.us822 ] ; 2 uses
  %indvars.iv870 = phi i64 [ %i.qg, %.lr.ph810.us ], [ %indvars.iv.next871, %._crit_edge.us822 ] ; 11 uses
  ...
  %i.qq = add nsw i32 %.4616807.us, %.            ; 6 uses
  %i.qr = add nsw i32 %.4808.us, %.               ; 11 uses
  %i.qs = load i32, ptr %i.m, align 4, !tbaa !42
  %i.qt = icmp sgt i32 %i.qs, 0
  br i1 %i.qt, label %bb.at, label %.loopexit722.us

bb.at:                                            ; preds = %bb.as
  %i.qu = sub nsw i32 %i.qq, %i.qp
  %i.qv = mul nsw i32 %i.qu, %i.q
  %i.qw = add nsw i32 %i.qv, %i.qp
  %i.qx = sext i32 %i.qw to i64
  %i.qy = getelementptr inbounds [8 x i8], ptr %i.s, i64 %i.qx
  %i.qz = sext i32 %i.qq to i64                   ; 2 uses
  %i.ra = getelementptr inbounds [8 x i8], ptr %i.y, i64 %i.qz ; 2 uses
  %i.rb = getelementptr inbounds [8 x i8], ptr %i.t, i64 %i.qz ; 2 uses
  call void @dlargv_(ptr noundef nonnull %i.m, ptr noundef %i.qy, ptr noundef nonnull %i.h, ptr noundef nonnull %i.ra, ptr noundef nonnull %i.n, ptr noundef nonnull %i.rb, ptr noundef nonnull %i.n) #5
  %i.rc = load i32, ptr %i.m, align 4, !tbaa !42  ; 2 uses
  %i.rd = load i32, ptr %3, align 4, !tbaa !42    ; 3 uses
  %i.re = shl i32 %i.rd, 1
  %.not668.us = icmp slt i32 %i.rc, %i.re
  br i1 %.not668.us, label %bb.av, label %bb.au

bb.au:                                            ; preds = %bb.at
  %i.rf = add nsw i32 %i.rd, -1
  store i32 %i.rf, ptr %i.f, align 4, !tbaa !42
  %.not669781.us = icmp slt i32 %i.rd, 2
  br i1 %.not669781.us, label %.loopexit722.us, label %.lr.ph783.us

.lr.ph783.us:                                     ; preds = %bb.au, %.lr.ph783.us
  %.2628782.us = phi i32 [ %i.rr, %.lr.ph783.us ], [ 1, %bb.au ] ; 4 uses
  %i.rg = load i32, ptr %i.n, align 4, !tbaa !42  ; 2 uses
  %i.rh = sub nsw i32 %i.rg, %.2628782.us
  %i.ri = add i32 %.2628782.us, %i.qq
  %i.rj = sub i32 %i.ri, %i.rg
  %i.rk = mul nsw i32 %i.rj, %i.q
  %i.rl = add i32 %i.rk, %i.rh                    ; 2 uses
  %i.rm = sext i32 %i.rl to i64
  %i.rn = getelementptr inbounds [8 x i8], ptr %i.s, i64 %i.rm
  %i.ro = add i32 %i.rl, 1
  %i.rp = sext i32 %i.ro to i64
  %i.rq = getelementptr inbounds [8 x i8], ptr %i.s, i64 %i.rp
  call void @dlartv_(ptr noundef nonnull %i.m, ptr noundef %i.rn, ptr noundef nonnull %i.h, ptr noundef %i.rq, ptr noundef nonnull %i.h, ptr noundef nonnull %i.rb, ptr noundef nonnull %i.ra, ptr noundef nonnull %i.n) #5
  %i.rr = add nuw nsw i32 %.2628782.us, 1
  %i.rs = load i32, ptr %i.f, align 4, !tbaa !42
  %.not669.us.not = icmp slt i32 %.2628782.us, %i.rs
  br i1 %.not669.us.not, label %.lr.ph783.us, label %.loopexit722.us, !llvm.loop !25

bb.av:                                            ; preds = %bb.at
  %i.rt = load i32, ptr %i.n, align 4, !tbaa !42  ; 3 uses
  %i.ru = add nsw i32 %i.rc, -1
  %i.rv = mul nsw i32 %i.rt, %i.ru                ; 3 uses
  %i.rw = add nsw i32 %i.rv, %i.qq
  store i32 %i.rw, ptr %i.f, align 4, !tbaa !42
  store i32 %i.rt, ptr %i.e, align 4, !tbaa !42
  %i.rx = icmp slt i32 %i.rt, 0
  %i.ry = icmp slt i32 %i.rv, 1
  %i.rz = icmp sgt i32 %i.rv, -1
  %.in784.us = select i1 %i.rx, i1 %i.ry, i1 %i.rz
  br i1 %.in784.us, label %.lr.ph786.us, label %.loopexit722.us

.lr.ph786.us:                                     ; preds = %bb.av, %.lr.ph786.us
  %.1646785.us = phi i32 [ %i.so, %.lr.ph786.us ], [ %i.qq, %bb.av ] ; 3 uses
  %i.sa = load i32, ptr %3, align 4, !tbaa !42    ; 2 uses
  %i.sb = sub nsw i32 %.1646785.us, %i.sa
  %i.sc = mul nsw i32 %i.sb, %i.q                 ; 2 uses
  %i.sd = add nsw i32 %i.sc, %i.sa
  %i.se = sext i32 %i.sd to i64
  %i.sf = getelementptr inbounds [8 x i8], ptr %i.s, i64 %i.se
  %i.sg = load i32, ptr %i.n, align 4, !tbaa !42
  %i.sh = add nsw i32 %i.sc, %i.sg
  %i.si = sext i32 %i.sh to i64
  %i.sj = getelementptr inbounds [8 x i8], ptr %i.s, i64 %i.si
  %i.sk = sext i32 %.1646785.us to i64            ; 2 uses
  %i.sl = getelementptr inbounds [8 x i8], ptr %i.t, i64 %i.sk
  %i.sm = getelementptr inbounds [8 x i8], ptr %i.y, i64 %i.sk
  call void @drot_(ptr noundef nonnull %i.p, ptr noundef %i.sf, ptr noundef nonnull %i.j, ptr noundef %i.sj, ptr noundef nonnull %i.j, ptr noundef nonnull %i.sl, ptr noundef nonnull %i.sm) #5
  %i.sn = load i32, ptr %i.e, align 4, !tbaa !42  ; 2 uses
  %i.so = add nsw i32 %i.sn, %.1646785.us         ; 3 uses
  %i.sp = icmp slt i32 %i.sn, 0
  %i.sq = load i32, ptr %i.f, align 4             ; 2 uses
  %i.sr = icmp sge i32 %i.so, %i.sq
  %i.ss = icmp sle i32 %i.so, %i.sq
  %.in.us = select i1 %i.sp, i1 %i.sr, i1 %i.ss
  br i1 %.in.us, label %.lr.ph786.us, label %.loopexit722.us, !llvm.loop !26

.loopexit722.us:                                  ; preds = %.lr.ph783.us, %.lr.ph786.us, %bb.av, %bb.au, %bb.as
  %i.st = icmp eq i64 %indvars.iv870, 2           ; 2 uses
  br i1 %i.st, label %thread-pre-split710.us, label %bb.aw

bb.aw:                                            ; preds = %.loopexit722.us
  %i.su = load i32, ptr %2, align 4, !tbaa !42
  %i.sv = add i32 %i.qj, %i.su
  %i.sw = sext i32 %i.sv to i64
  %.not671.us = icmp sgt i64 %indvars.iv870, %i.sw
  br i1 %.not671.us, label %bb.ay, label %bb.ax

bb.ax:                                            ; preds = %bb.aw
  %i.sx = add nsw i64 %indvars.iv870, -1          ; 2 uses
  %gep951 = getelementptr [8 x i8], ptr %invariant.gep950, i64 %i.sx ; 2 uses
  %gep953 = getelementptr [8 x i8], ptr %invariant.gep952, i64 %indvars.iv870
  %i.sy = add i64 %i.qn, %indvars.iv870
  %27 = and i64 %i.sy, 4294967295                 ; 2 uses
  %i.sz = getelementptr inbounds nuw [8 x i8], ptr %i.t, i64 %27 ; 2 uses
  %i.ta = getelementptr inbounds nuw [8 x i8], ptr %i.y, i64 %27 ; 2 uses
  call void @dlartg_(ptr noundef %gep951, ptr noundef %gep953, ptr noundef nonnull %i.sz, ptr noundef nonnull %i.ta, ptr noundef nonnull %i.k) #5
  %i.tb = load double, ptr %i.k, align 8, !tbaa !45
  store double %i.tb, ptr %gep951, align 8, !tbaa !45
  %i.tc = trunc i64 %indvars.iv870 to i32
  %i.td = add i32 %i.tc, -3
  store i32 %i.td, ptr %i.e, align 4, !tbaa !42
  %i.te = load i32, ptr %5, align 4, !tbaa !42
  %i.tf = add nsw i32 %i.te, -1                   ; 2 uses
  store i32 %i.tf, ptr %i.f, align 4, !tbaa !42
  store i32 %i.tf, ptr %i.g, align 4, !tbaa !42
  %i.tg = add i64 %i.qm, %indvars.iv870
  %sext923 = shl i64 %i.tg, 32
  %i.th = ashr exact i64 %sext923, 29
  %i.ti = getelementptr inbounds i8, ptr %i.s, i64 %i.th
  %gep955 = getelementptr [8 x i8], ptr %invariant.gep954, i64 %i.sx
  call void @drot_(ptr noundef nonnull %i.e, ptr noundef %i.ti, ptr noundef nonnull %i.f, ptr noundef %gep955, ptr noundef nonnull %i.g, ptr noundef nonnull %i.sz, ptr noundef nonnull %i.ta) #5
  br label %bb.ay

bb.ay:                                            ; preds = %bb.ax, %bb.aw
  %i.tj = load i32, ptr %i.m, align 4, !tbaa !42
  %i.tk = add nsw i32 %i.tj, 1                    ; 2 uses
  store i32 %i.tk, ptr %i.m, align 4, !tbaa !42
  %i.tl = add nsw i32 %.4616807.us, -1
  br label %bb.az

thread-pre-split710.us:                           ; preds = %.loopexit722.us
  %.pr711.us = load i32, ptr %i.m, align 4, !tbaa !42
  br label %bb.az

bb.az:                                            ; preds = %thread-pre-split710.us, %bb.ay
  %i.tm = phi i32 [ %.pr711.us, %thread-pre-split710.us ], [ %i.tk, %bb.ay ]
  %.5617.us = phi i32 [ %i.qq, %thread-pre-split710.us ], [ %i.tl, %bb.ay ] ; 19 uses
  %i.tn = icmp sgt i32 %i.tm, 0
  br i1 %i.tn, label %bb.ba, label %.loopexit720.us

bb.ba:                                            ; preds = %bb.az
  %i.to = add nsw i32 %.5617.us, -1
  %i.tp = mul nsw i32 %i.to, %i.q
  %i.tq = sext i32 %i.tp to i64
  %i.tr = getelementptr [8 x i8], ptr %i.s, i64 %i.tq ; 2 uses
  %i.ts = getelementptr i8, ptr %i.tr, i64 8
  %i.tt = mul nsw i32 %.5617.us, %i.q
  %i.tu = sext i32 %i.tt to i64
  %i.tv = getelementptr [8 x i8], ptr %i.s, i64 %i.tu
  %i.tw = getelementptr i8, ptr %i.tv, i64 8
  %i.tx = getelementptr i8, ptr %i.tr, i64 16
  %i.ty = sext i32 %.5617.us to i64               ; 2 uses
  %i.tz = getelementptr inbounds [8 x i8], ptr %i.t, i64 %i.ty
  %i.ua = getelementptr inbounds [8 x i8], ptr %i.y, i64 %i.ty
  call void @dlar2v_(ptr noundef nonnull %i.m, ptr noundef %i.ts, ptr noundef %i.tw, ptr noundef %i.tx, ptr noundef nonnull %i.h, ptr noundef nonnull %i.tz, ptr noundef nonnull %i.ua, ptr noundef nonnull %i.n) #5
  %.pre897 = load i32, ptr %i.m, align 4, !tbaa !42 ; 4 uses
  %i.ub = icmp sgt i32 %.pre897, 0
  br i1 %i.ub, label %bb.bb, label %.loopexit720.us

bb.bb:                                            ; preds = %bb.ba
  %i.uc = load i32, ptr %3, align 4, !tbaa !42    ; 3 uses
  %i.ud = shl i32 %i.uc, 1
  %.not672.us = icmp slt i32 %.pre897, %i.ud
  br i1 %.not672.us, label %bb.bg, label %bb.bc

bb.bc:                                            ; preds = %bb.bb
  %i.ue = add nsw i32 %i.uc, -1                   ; 2 uses
  store i32 %i.ue, ptr %i.e, align 4, !tbaa !42
  %.not676787.us = icmp slt i32 %i.uc, 2
  br i1 %.not676787.us, label %.loopexit720.us, label %.lr.ph789.us

bb.bd:                                            ; preds = %.lr.ph789.us, %bb.bf
  %i.uf = phi i32 [ %i.ue, %.lr.ph789.us ], [ %i.uu, %bb.bf ]
  %i.ug = phi i32 [ %.pre897, %.lr.ph789.us ], [ %i.uv, %bb.bf ] ; 2 uses
  %indvars.iv864 = phi i64 [ 1, %.lr.ph789.us ], [ %indvars.iv.next865, %bb.bf ] ; 4 uses
  %i.uh = add nsw i64 %indvars.iv864, %i.aae
  %i.ui = load i32, ptr %2, align 4, !tbaa !42
  %i.uj = sext i32 %i.ui to i64
  %i.uk = icmp sgt i64 %i.uh, %i.uj
  %i.ul = sext i1 %i.uk to i32
  %storemerge.us = add nsw i32 %i.ug, %i.ul       ; 2 uses
  store i32 %storemerge.us, ptr %i.o, align 4, !tbaa !42
  %i.um = icmp sgt i32 %storemerge.us, 0
  br i1 %i.um, label %bb.be, label %bb.bf

bb.be:                                            ; preds = %bb.bd
  %i.un = trunc nuw nsw i64 %indvars.iv864 to i32 ; 2 uses
  %i.uo = add i32 %i.zy, %i.un
  %i.up = sext i32 %i.uo to i64
  %i.uq = getelementptr inbounds [8 x i8], ptr %i.s, i64 %i.up
  %i.ur = add i32 %i.aaa, %i.un
  %i.us = sext i32 %i.ur to i64
  %i.ut = getelementptr inbounds [8 x i8], ptr %i.s, i64 %i.us
  call void @dlartv_(ptr noundef nonnull %i.o, ptr noundef %i.uq, ptr noundef nonnull %i.h, ptr noundef %i.ut, ptr noundef nonnull %i.h, ptr noundef nonnull %i.aac, ptr noundef nonnull %i.aad, ptr noundef nonnull %i.n) #5
  %.pre898 = load i32, ptr %i.m, align 4
  %.pre900 = load i32, ptr %i.e, align 4, !tbaa !42
  br label %bb.bf

bb.bf:                                            ; preds = %bb.be, %bb.bd
  %i.uu = phi i32 [ %.pre900, %bb.be ], [ %i.uf, %bb.bd ] ; 2 uses
  %i.uv = phi i32 [ %.pre898, %bb.be ], [ %i.ug, %bb.bd ]
  %indvars.iv.next865 = add nuw nsw i64 %indvars.iv864, 1
  %i.uw = sext i32 %i.uu to i64
  %.not676.us.not = icmp slt i64 %indvars.iv864, %i.uw
  br i1 %.not676.us.not, label %bb.bd, label %.loopexit720.us, !llvm.loop !27

bb.bg:                                            ; preds = %bb.bb
  %i.ux = load i32, ptr %i.n, align 4, !tbaa !42  ; 3 uses
  %i.uy = add nsw i32 %.pre897, -2
  %i.uz = mul nsw i32 %i.ux, %i.uy                ; 3 uses
  %i.va = add nsw i32 %i.uz, %.5617.us            ; 2 uses
  %.not673.us = icmp slt i32 %i.uz, 0
  br i1 %.not673.us, label %.loopexit719.us, label %bb.bh

bb.bh:                                            ; preds = %bb.bg
  store i32 %i.va, ptr %i.e, align 4, !tbaa !42
  store i32 %i.ux, ptr %i.f, align 4, !tbaa !42
  %i.vb = icmp sgt i32 %i.ux, -1
  %i.vc = icmp eq i32 %i.uz, 0
  %.in674790.us = or i1 %i.vb, %i.vc
  br i1 %.in674790.us, label %.lr.ph792.us, label %.loopexit719.us

.lr.ph792.us:                                     ; preds = %bb.bh, %.lr.ph792.us
  %.0644791.us = phi i32 [ %i.vq, %.lr.ph792.us ], [ %.5617.us, %bb.bh ] ; 4 uses
  %i.vd = add nsw i32 %.0644791.us, -1
  %i.ve = mul nsw i32 %i.vd, %i.q
  %i.vf = sext i32 %i.ve to i64
  %i.vg = getelementptr [8 x i8], ptr %i.s, i64 %i.vf
  %i.vh = getelementptr i8, ptr %i.vg, i64 24
  %i.vi = mul nsw i32 %.0644791.us, %i.q
  %i.vj = sext i32 %i.vi to i64
  %i.vk = getelementptr [8 x i8], ptr %i.s, i64 %i.vj
  %i.vl = getelementptr i8, ptr %i.vk, i64 16
  %i.vm = sext i32 %.0644791.us to i64            ; 2 uses
  %i.vn = getelementptr inbounds [8 x i8], ptr %i.t, i64 %i.vm
  %i.vo = getelementptr inbounds [8 x i8], ptr %i.y, i64 %i.vm
  call void @drot_(ptr noundef nonnull %i.p, ptr noundef %i.vh, ptr noundef nonnull @c__1, ptr noundef %i.vl, ptr noundef nonnull @c__1, ptr noundef nonnull %i.vn, ptr noundef nonnull %i.vo) #5
  %i.vp = load i32, ptr %i.f, align 4, !tbaa !42  ; 2 uses
  %i.vq = add nsw i32 %i.vp, %.0644791.us         ; 3 uses
  %i.vr = icmp slt i32 %i.vp, 0
  %i.vs = load i32, ptr %i.e, align 4             ; 2 uses
  %i.vt = icmp sge i32 %i.vq, %i.vs
  %i.vu = icmp sle i32 %i.vq, %i.vs
  %.in674.us = select i1 %i.vr, i1 %i.vt, i1 %i.vu
  br i1 %.in674.us, label %.lr.ph792.us, label %.loopexit719.us, !llvm.loop !28

.loopexit719.us:                                  ; preds = %.lr.ph792.us, %bb.bh, %bb.bg
  %i.vv = load i32, ptr %i.p, align 4, !tbaa !42  ; 2 uses
  store i32 %i.vv, ptr %i.f, align 4, !tbaa !42
  %i.vw = load i32, ptr %2, align 4, !tbaa !42
  %i.vx = sub nsw i32 %i.vw, %i.qr                ; 2 uses
  store i32 %i.vx, ptr %i.e, align 4, !tbaa !42
  %i.vy = call i32 @llvm.smin.i32(i32 %i.vv, i32 %i.vx) ; 2 uses
  store i32 %i.vy, ptr %i.i, align 4, !tbaa !42
  %i.vz = icmp sgt i32 %i.vy, 0
  br i1 %i.vz, label %bb.bi, label %.loopexit720.us

bb.bi:                                            ; preds = %.loopexit719.us
  %i.wa = load i32, ptr %i.n, align 4, !tbaa !42
  %i.wb = add nsw i32 %i.wa, %i.va                ; 3 uses
  %i.wc = add nsw i32 %i.wb, -1
  %i.wd = mul nsw i32 %i.wc, %i.q
  %i.we = sext i32 %i.wd to i64
  %i.wf = getelementptr [8 x i8], ptr %i.s, i64 %i.we
  %i.wg = getelementptr i8, ptr %i.wf, i64 24
  %i.wh = mul nsw i32 %i.wb, %i.q
  %i.wi = sext i32 %i.wh to i64
  %i.wj = getelementptr [8 x i8], ptr %i.s, i64 %i.wi
  %i.wk = getelementptr i8, ptr %i.wj, i64 16
  %i.wl = sext i32 %i.wb to i64                   ; 2 uses
  %i.wm = getelementptr inbounds [8 x i8], ptr %i.t, i64 %i.wl
  %i.wn = getelementptr inbounds [8 x i8], ptr %i.y, i64 %i.wl
  call void @drot_(ptr noundef nonnull %i.i, ptr noundef %i.wg, ptr noundef nonnull @c__1, ptr noundef %i.wk, ptr noundef nonnull @c__1, ptr noundef nonnull %i.wm, ptr noundef nonnull %i.wn) #5
  br label %.loopexit720.us

.loopexit720.us:                                  ; preds = %bb.bf, %bb.az, %bb.bc, %bb.bi, %.loopexit719.us, %bb.ba
  br i1 %i.ac, label %bb.bj, label %.loopexit718.us

bb.bj:                                            ; preds = %.loopexit720.us
  br i1 %.not, label %bb.bl, label %bb.bk

bb.bk:                                            ; preds = %bb.bj
  %i.wo = call i32 @llvm.smax.i32(i32 %.4624806.us, i32 %i.qr) ; 4 uses
  %i.wp = load i32, ptr %3, align 4, !tbaa !42    ; 2 uses
  store i32 %i.qr, ptr %i.f, align 4, !tbaa !42
  %i.wq = load i32, ptr %i.n, align 4, !tbaa !42  ; 2 uses
  store i32 %i.wq, ptr %i.e, align 4, !tbaa !42
  %i.wr = icmp slt i32 %i.wq, 0
  %i.ws = icmp sge i32 %.5617.us, %i.qr
  %i.wt = icmp sle i32 %.5617.us, %i.qr
  %.in680793.us = select i1 %i.wr, i1 %i.ws, i1 %i.wt
  br i1 %.in680793.us, label %.lr.ph797.us.preheader, label %.loopexit718.us

.lr.ph797.us.preheader:                           ; preds = %bb.bk
  %i.wu = trunc i64 %indvars.iv870 to i32
  %i.wv = add i32 %i.wu, -3
  %i.ww = mul nsw i32 %i.wp, %i.qo
  %i.wx = add nsw i32 %i.ww, 1
  %i.wy = select i1 %i.st, i32 %i.wp, i32 0
  %spec.select706.us = add nsw i32 %i.wx, %i.wy
  %i.wz = call i32 @llvm.smin.i32(i32 %spec.select706.us, i32 %i.wo)
  %i.xa = icmp slt i64 %indvars.iv870, 4
  %i.xb = select i1 %i.xa, i32 0, i32 %i.wv
