...
bb.a:
  ...
  %i.q = load i32, ptr %5, align 4, !tbaa !42     ; 31 uses
...
bb.ax:                                            ; preds = %bb.aw
  ...
  %sext = shl i64 %i.sy, 32
  %28 = ashr exact i64 %sext, 32                  ; 2 uses
  %i.sz = getelementptr inbounds [8 x i8], ptr %i.t, i64 %28 ; 2 uses
  %i.ta = getelementptr inbounds [8 x i8], ptr %i.y, i64 %28 ; 2 uses
