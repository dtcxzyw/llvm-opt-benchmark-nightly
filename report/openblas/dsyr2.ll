Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/openblas/original/dsyr2?download=true
inline.NumInlined: 1
inline.NumDeleted: 1
begin_hunk_0
...
bb.h:                                             ; preds = %bb.d
  ...
  %.0108.idx = select i1 %i.au, i64 %i.ay, i64 0
  %.0108 = getelementptr inbounds [8 x i8], ptr %3, i64 %.0108.idx ; 2 uses
  %i.az = icmp slt i32 %i.g, 0
  %i.ba = mul nsw i32 %i.g, %i.av
  %i.bb = sext i32 %i.ba to i64
  %i.bc = sub nsw i64 0, %i.bb
  %.0111.idx = select i1 %i.az, i64 %i.bc, i64 0
  %.0111 = getelementptr inbounds [8 x i8], ptr %5, i64 %.0111.idx ; 2 uses
...
bb.j:                                             ; preds = %num_cpu_avail.exit
  ...
  %i.bs = tail call i32 %i.br(i64 noundef %i.bm, double noundef %i.d, ptr noundef %.0108, i64 noundef %i.bn, ptr noundef %.0111, i64 noundef %i.bo, ptr noundef %7, i64 noundef %i.bp, ptr noundef %i.bd) #4 ; 0 uses
  br label %bb.l
...
bb.k:                                             ; preds = %num_cpu_avail.exit
  ...
  %i.bv = tail call i32 %i.bu(i64 noundef %i.bm, double noundef %i.d, ptr noundef %.0108, i64 noundef %i.bn, ptr noundef %.0111, i64 noundef %i.bo, ptr noundef %7, i64 noundef %i.bp, ptr noundef %i.bd, i32 noundef %spec.store.select8) #4 ; 0 uses
  br label %bb.l
