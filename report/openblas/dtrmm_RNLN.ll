...
bb.j:                                             ; preds = %.lr.ph, %bb.j
  ...
  %i.am = sub nuw nsw i64 %i.aj, %.0236255
  ...
  %i.aq = mul nuw nsw i64 %.0236255, %spec.store.select1
...
.lr.ph257:                                        ; preds = %.preheader252, %.lr.ph257
  ...
  %i.ba = sub nuw nsw i64 %spec.store.select1, %.1256
  %spec.store.select3 = tail call i64 @llvm.smin.i64(i64 %i.ba, i64 12) ; 3 uses
  %i.bb = add nuw nsw i64 %.1256, %.0240260       ; 2 uses
  %i.bc = add nuw nsw i64 %.1256, %i.aj
  %i.bd = mul nuw nsw i64 %i.bc, %spec.store.select1
...
bb.m:                                             ; preds = %.lr.ph265, %bb.m
  ...
  %i.cc = sub nuw nsw i64 %i.aa, %.2263
