...
.lr.ph195:                                        ; preds = %bb.h, %.lr.ph195
  %.0165194 = phi i32 [ %i.v, %.lr.ph195 ], [ 0, %bb.h ] ; 2 uses
  %storemerge179193 = phi i32 [ %i.ap, %.lr.ph195 ], [ 1, %bb.h ]
  %i.u = add nsw i32 %.0165194, 1
  %i.v = add nsw i32 %.0165194, %storemerge179193 ; 2 uses
...
.lr.ph199:                                        ; preds = %bb.i, %bb.k
  ...
  %.0163197 = phi i32 [ %i.br, %bb.k ], [ 1, %bb.i ] ; 9 uses
  %i.aq = load i32, ptr %2, align 4, !tbaa !8     ; 3 uses
  %reass.sub200 = sub i32 %.0198, %.0163197
  ...
  %i.az = icmp slt i32 %.0163197, %i.aq
  br i1 %i.az, label %bb.j, label %bb.k

bb.j:                                             ; preds = %.lr.ph199
  %i.ba = sub nsw i32 %i.aq, %.0163197
...
bb.k:                                             ; preds = %bb.j, %.lr.ph199
  %i.br = add nuw nsw i32 %.0163197, 1
  %.not178.not = icmp slt i32 %.0163197, %i.n
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %.1164186 = phi i32 [ 0, %.lr.ph.preheader ], [ %i.bv, %.lr.ph ] ; 2 uses
  %i.bt = add nuw nsw i32 %.1164186, 1
  %i.bu = trunc nuw nsw i64 %indvars.iv to i32
  %i.bv = add nuw nsw i32 %.1164186, %i.bu        ; 2 uses
