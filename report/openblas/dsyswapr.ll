...
.lr.ph:                                           ; preds = %bb.b
  ...
  %min.iters.check = icmp ugt i32 %i.ag, 24
...
.lr.ph161:                                        ; preds = %bb.c
  ...
  %i.ei = add nsw i64 %wide.trip.count177, -1     ; 2 uses
  %min.iters.check244 = icmp ugt i32 %i.eh, 24
