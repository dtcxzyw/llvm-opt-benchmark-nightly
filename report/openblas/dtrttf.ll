...
.lr.ph574.preheader:                              ; preds = %.thread461
  ...
  %i.zv = lshr exact i64 %i.zu, 1                 ; 6 uses
  %i.zw = sext i32 %i.d to i64                    ; 3 uses
...
iter.check1434:                                   ; preds = %.lr.ph574.preheader, %._crit_edge569
  ...
  %i.aag = add nuw nsw i64 %indvars.iv829, %i.zy  ; 2 uses
  %i.aah = sext i32 %.16573 to i64                ; 7 uses
  %invariant.gep1017 = getelementptr [8 x i8], ptr %3, i64 %i.aag ; 3 uses
...
vec.epilog.scalar.ph1435.preheader:               ; preds = %vector.memcheck1407, %iter.check1434, %vec.epilog.iter.check1436, %vec.epilog.middle.block1445
  %indvars.iv825.in.ph = phi i32 [ %.16573, %iter.check1434 ], [ %.16573, %vector.memcheck1407 ], [ %i.abf, %vec.epilog.iter.check1436 ], [ %i.abn, %vec.epilog.middle.block1445 ]
  %indvars.iv821.ph = phi i64 [ %i.zv, %iter.check1434 ], [ %i.zv, %vector.memcheck1407 ], [ %i.aap, %vec.epilog.iter.check1436 ], [ %i.abg, %vec.epilog.middle.block1445 ]
  %indvars.iv819.ph = phi i64 [ %i.aah, %iter.check1434 ], [ %i.aah, %vector.memcheck1407 ], [ %i.aaq, %vec.epilog.iter.check1436 ], [ %i.abh, %vec.epilog.middle.block1445 ]
...
.preheader474:                                    ; preds = %vec.epilog.scalar.ph1435, %vec.epilog.middle.block1445, %middle.block1426
  %indvars.iv825.lcssa = phi i32 [ %i.abn, %vec.epilog.middle.block1445 ], [ %i.abf, %middle.block1426 ], [ %indvars.iv825, %vec.epilog.scalar.ph1435 ]
  %indvars.iv.next820.lcssa = phi i64 [ %i.abh, %vec.epilog.middle.block1445 ], [ %i.aaq, %middle.block1426 ], [ %indvars.iv.next820, %vec.epilog.scalar.ph1435 ]
...
iter.check1391:                                   ; preds = %.preheader474
  ...
  %i.abp = sext i32 %indvars.iv825.lcssa to i64   ; 7 uses
...
vector.body1380:                                  ; preds = %vector.body1380, %vector.ph1378
  ...
  br i1 %i.ace, label %middle.block1387, label %vector.body1380, !llvm.loop !64
...
vec.epilog.vector.body1397:                       ; preds = %vec.epilog.vector.body1397, %vec.epilog.ph1395
  ...
  br i1 %i.acj, label %vec.epilog.middle.block1401, label %vec.epilog.vector.body1397, !llvm.loop !65
...
vec.epilog.scalar.ph1435:                         ; preds = %vec.epilog.scalar.ph1435.preheader, %vec.epilog.scalar.ph1435
  ...
  %.not434.not = icmp samesign ult i64 %indvars.iv821, %i.aag
...
vector.body1635:                                  ; preds = %vector.body1635, %vector.ph1633
  ...
  br i1 %i.afn, label %middle.block1646, label %vector.body1635, !llvm.loop !70
...
vec.epilog.vector.body1659:                       ; preds = %vec.epilog.vector.body1659, %vec.epilog.ph1657
  ...
  br i1 %i.aft, label %vec.epilog.middle.block1664, label %vec.epilog.vector.body1659, !llvm.loop !71
...
vector.body1603:                                  ; preds = %vector.body1603, %vector.ph1601
  ...
  br i1 %i.ahy, label %middle.block1610, label %vector.body1603, !llvm.loop !74
...
vec.epilog.vector.body1620:                       ; preds = %vec.epilog.vector.body1620, %vec.epilog.ph1618
  ...
  br i1 %i.aib, label %vec.epilog.middle.block1624, label %vec.epilog.vector.body1620, !llvm.loop !75
...
vector.body1458:                                  ; preds = %vector.body1458, %vector.ph1456
  ...
  br i1 %i.aki, label %middle.block1465, label %vector.body1458, !llvm.loop !79
...
vec.epilog.vector.body1474:                       ; preds = %vec.epilog.vector.body1474, %vec.epilog.ph1472
  ...
  br i1 %i.akl, label %vec.epilog.middle.block1478, label %vec.epilog.vector.body1474, !llvm.loop !80
...
vector.body1523:                                  ; preds = %vector.body1523, %vector.ph1521
  ...
  br i1 %i.amb, label %middle.block1534, label %vector.body1523, !llvm.loop !82
...
vec.epilog.vector.body1547:                       ; preds = %vec.epilog.vector.body1547, %vec.epilog.ph1545
  ...
  br i1 %i.amj, label %vec.epilog.middle.block1552, label %vec.epilog.vector.body1547, !llvm.loop !83
...
vector.body1489:                                  ; preds = %vector.body1489, %vector.ph1487
  ...
  br i1 %i.anz, label %middle.block1496, label %vector.body1489, !llvm.loop !86
...
vec.epilog.vector.body1506:                       ; preds = %vec.epilog.vector.body1506, %vec.epilog.ph1504
  ...
  br i1 %i.aoc, label %vec.epilog.middle.block1510, label %vec.epilog.vector.body1506, !llvm.loop !87
...
vector.body1568:                                  ; preds = %vector.body1568, %vector.ph1566
  ...
  br i1 %i.aqn, label %middle.block1575, label %vector.body1568, !llvm.loop !91
...
vec.epilog.vector.body1584:                       ; preds = %vec.epilog.vector.body1584, %vec.epilog.ph1582
  ...
  br i1 %i.aqs, label %vec.epilog.middle.block1588, label %vec.epilog.vector.body1584, !llvm.loop !92
...
vector.body1679:                                  ; preds = %vector.body1679, %vector.ph1677
  ...
  br i1 %i.atd, label %middle.block1686, label %vector.body1679, !llvm.loop !96
...
vec.epilog.vector.body1696:                       ; preds = %vec.epilog.vector.body1696, %vec.epilog.ph1694
  ...
  br i1 %i.ath, label %vec.epilog.middle.block1700, label %vec.epilog.vector.body1696, !llvm.loop !97
...
vector.body1745:                                  ; preds = %vector.body1745, %vector.ph1743
  ...
  br i1 %i.auz, label %middle.block1756, label %vector.body1745, !llvm.loop !100
...
vec.epilog.vector.body1769:                       ; preds = %vec.epilog.vector.body1769, %vec.epilog.ph1767
  ...
  br i1 %i.avh, label %vec.epilog.middle.block1774, label %vec.epilog.vector.body1769, !llvm.loop !101
...
vector.body1713:                                  ; preds = %vector.body1713, %vector.ph1711
  ...
  br i1 %i.axk, label %middle.block1720, label %vector.body1713, !llvm.loop !104
...
vec.epilog.vector.body1730:                       ; preds = %vec.epilog.vector.body1730, %vec.epilog.ph1728
  ...
  br i1 %i.axn, label %vec.epilog.middle.block1734, label %vec.epilog.vector.body1730, !llvm.loop !105
...
vector.body1786:                                  ; preds = %vector.body1786, %vector.ph1784
  ...
  br i1 %i.azu, label %middle.block1793, label %vector.body1786, !llvm.loop !109
...
vec.epilog.vector.body1802:                       ; preds = %vec.epilog.vector.body1802, %vec.epilog.ph1800
  ...
  br i1 %i.azz, label %vec.epilog.middle.block1806, label %vec.epilog.vector.body1802, !llvm.loop !110
