...
.lr.ph853.preheader:                              ; preds = %.lr.ph858
  ...
  %wide.trip.count1068 = zext i32 %i.avn to i64   ; 4 uses
  %invariant.gep1284 = getelementptr [8 x i8], ptr %i.l, i64 %i.avo
  %i.avr = add nsw i64 %wide.trip.count1068, -2
  %9 = shl nsw i64 %i.avm, 3                      ; 2 uses
  %i.avs = shl nsw i64 %i.avo, 3                  ; 2 uses
  %10 = getelementptr i8, ptr %2, i64 %9
  %scevgep2161 = getelementptr i8, ptr %10, i64 %i.avs
  %11 = shl nuw nsw i64 %wide.trip.count1073, 3
  %i.avt = shl nuw nsw i64 %wide.trip.count1068, 3 ; 2 uses
  %12 = getelementptr i8, ptr %scevgep2162, i64 %9
  %13 = getelementptr i8, ptr %12, i64 %i.avs
  %14 = getelementptr i8, ptr %13, i64 %11
  %scevgep2163 = getelementptr i8, ptr %14, i64 %i.avt
...
.lr.ph875:                                        ; preds = %.lr.ph875.preheader, %._crit_edge871
  ...
  %i.ayz = add nsw i64 %indvar2041, -1
...
.lr.ph932.preheader:                              ; preds = %.lr.ph937
  ...
  %wide.trip.count1161 = zext i32 %i.bql to i64   ; 4 uses
  %invariant.gep1316 = getelementptr [8 x i8], ptr %i.l, i64 %i.bqm
  %i.bqp = add nsw i64 %wide.trip.count1161, -2
  %15 = shl nsw i64 %i.bqk, 3                     ; 2 uses
  %i.bqq = shl nsw i64 %i.bqm, 3                  ; 2 uses
  %16 = getelementptr i8, ptr %2, i64 %15
  %scevgep1774 = getelementptr i8, ptr %16, i64 %i.bqq
  %17 = shl nuw nsw i64 %wide.trip.count1166, 3
  %i.bqr = shl nuw nsw i64 %wide.trip.count1161, 3 ; 2 uses
  %18 = getelementptr i8, ptr %scevgep1775, i64 %15
  %19 = getelementptr i8, ptr %18, i64 %i.bqq
  %20 = getelementptr i8, ptr %19, i64 %17
  %scevgep1776 = getelementptr i8, ptr %20, i64 %i.bqr
