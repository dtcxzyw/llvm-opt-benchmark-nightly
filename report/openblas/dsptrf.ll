...
.lr.ph698:                                        ; preds = %bb.v, %bb.ap
  ...
  %.1531691 = phi i32 [ %i.wa, %bb.ap ], [ 1, %bb.v ] ; 27 uses
...
bb.am:                                            ; preds = %bb.al
  ...
  %i.sk = sub nsw i32 %i.sj, %.1531691
  %5 = insertelement <2 x i32> poison, i32 %i.sk, i64 0
  %6 = insertelement <2 x i32> %5, i32 %.1531691, i64 1 ; 2 uses
  %7 = add nsw <2 x i32> %6, splat (i32 -1)
  %8 = shufflevector <2 x i32> %6, <2 x i32> poison, <2 x i32> <i32 1, i32 0>
  %9 = mul nsw <2 x i32> %7, %8
  %10 = sdiv <2 x i32> %9, splat (i32 2)          ; 2 uses
  %11 = extractelement <2 x i32> %10, i64 1       ; 3 uses
  %i.sl = add nsw i32 %11, %i.si
  %12 = sext i32 %i.sl to i64
  %13 = getelementptr inbounds [8 x i8], ptr %i.e, i64 %12
  %14 = load double, ptr %13, align 8, !tbaa !31  ; 3 uses
  %15 = extractelement <2 x i32> %10, i64 0       ; 2 uses
  %i.sm = add nsw i32 %15, %i.si
  %i.sn = sext i32 %i.sm to i64
  %i.so = getelementptr inbounds [8 x i8], ptr %i.e, i64 %i.sn
  %i.sp = load double, ptr %i.so, align 8, !tbaa !31
  %i.sq = fdiv double %i.sp, %14                  ; 2 uses
  %i.sr = add nsw i32 %11, %.1531691
  %i.ss = sext i32 %i.sr to i64
  %i.st = getelementptr inbounds [8 x i8], ptr %i.e, i64 %i.ss
  %i.su = load double, ptr %i.st, align 8, !tbaa !31
  %i.sv = fdiv double %i.su, %14                  ; 2 uses
  %i.sw = call double @llvm.fmuladd.f64(double %i.sq, double %i.sv, double -1.000000e+00)
  %i.sx = fdiv double 1.000000e+00, %i.sw
  %i.sy = fdiv double %i.sx, %14                  ; 2 uses
...
.lr.ph689:                                        ; preds = %bb.am
  ...
  %i.tf = sext i32 %11 to i64                     ; 3 uses
  %i.tg = sext i32 %15 to i64                     ; 3 uses
