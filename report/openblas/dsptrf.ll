...
vector.memcheck:                                  ; preds = %.lr.ph662
  %i.hy = mul nsw i64 %indvar, -8                 ; 5 uses
  %scevgep785 = getelementptr i8, ptr %i.gu, i64 %i.hy
  %scevgep783 = getelementptr i8, ptr %i.gx, i64 %i.hy
  ...
  %scevgep782 = getelementptr i8, ptr %i.gz, i64 %i.hy
  %scevgep780 = getelementptr i8, ptr %i.hc, i64 %i.hy
  %scevgep781 = getelementptr i8, ptr %scevgep780, i64 %i.ic
  %5 = shl nsw i64 %indvars.iv707, 3
  %scevgep778 = getelementptr i8, ptr %2, i64 %5
...
bb.an:                                            ; preds = %.lr.ph689, %.loopexit841
  ...
  %indvars.iv723 = phi i64 [ %i.tm, %.lr.ph689 ], [ %indvars.iv.next724, %.loopexit841 ] ; 13 uses
...
vector.memcheck803:                               ; preds = %bb.an
  %i.ux = shl nuw nsw i64 %indvar804, 3           ; 3 uses
  %scevgep812 = getelementptr i8, ptr %i.ua, i64 %i.ux
  ...
  %scevgep810 = getelementptr i8, ptr %i.ud, i64 %i.ux
  %scevgep811 = getelementptr i8, ptr %scevgep810, i64 %i.va
  %6 = shl nuw nsw i64 %indvars.iv723, 3
  %scevgep808 = getelementptr i8, ptr %2, i64 %6
