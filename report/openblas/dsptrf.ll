...
vector.memcheck:                                  ; preds = %.lr.ph662
  %i.hx = mul nsw i64 %indvar, -8                 ; 6 uses
  %scevgep783 = getelementptr i8, ptr %i.gt, i64 %i.hx
  %scevgep781 = getelementptr i8, ptr %i.gw, i64 %i.hx
  ...
  %scevgep780 = getelementptr i8, ptr %i.gy, i64 %i.hx
  %scevgep778 = getelementptr i8, ptr %i.hb, i64 %i.hx
  %scevgep779 = getelementptr i8, ptr %scevgep778, i64 %i.ib
  %scevgep776 = getelementptr i8, ptr %i.hc, i64 %i.hx
...
bb.an:                                            ; preds = %.lr.ph689, %.loopexit841
  ...
  %indvars.iv721 = phi i64 [ %i.tm, %.lr.ph689 ], [ %indvars.iv.next722, %.loopexit841 ] ; 12 uses
...
vector.memcheck802:                               ; preds = %bb.an
  %i.uw = shl nuw nsw i64 %indvar803, 3           ; 4 uses
  %scevgep811 = getelementptr i8, ptr %i.ty, i64 %i.uw
  ...
  %scevgep809 = getelementptr i8, ptr %i.ub, i64 %i.uw
  %scevgep810 = getelementptr i8, ptr %scevgep809, i64 %i.uz
  %scevgep807 = getelementptr i8, ptr %i.ud, i64 %i.uw
