...
.lr.ph698:                                        ; preds = %bb.v, %bb.ap
  ...
  %.1531691 = phi i32 [ %i.wi, %bb.ap ], [ 1, %bb.v ] ; 28 uses
...
vector.memcheck802:                               ; preds = %bb.an
  ...
  %scevgep805 = getelementptr i8, ptr %i.ui, i64 %i.uz
  %i.vd = shl nsw i64 %i.uy, 3                    ; 2 uses
  %scevgep806 = getelementptr i8, ptr %scevgep805, i64 %i.vd ; 2 uses
  %i.ve = getelementptr i8, ptr %scevgep807, i64 %i.vc
  %scevgep808 = getelementptr i8, ptr %i.ve, i64 %i.vd ; 2 uses
  %bound0813 = icmp ult ptr %scevgep806, %scevgep810.a
  %bound1814 = icmp ult ptr %gep768, %scevgep808
  %found.conflict815 = and i1 %bound0813, %bound1814
  %bound0816 = icmp ult ptr %scevgep806, %scevgep812.a
