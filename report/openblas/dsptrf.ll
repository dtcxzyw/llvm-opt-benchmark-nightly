...
.lr.ph662:                                        ; preds = %.lr.ph662.preheader, %.loopexit844
  %scev.check.iv = phi i64 [ %i.gq, %.lr.ph662.preheader ], [ %scev.check.iv.next, %.loopexit844 ] ; 2 uses
  %indvar = phi i64 [ 0, %.lr.ph662.preheader ], [ %indvar.next, %.loopexit844 ] ; 3 uses
  %indvars.iv707 = phi i64 [ %i.gl, %.lr.ph662.preheader ], [ %indvars.iv.next708, %.loopexit844 ] ; 12 uses
  ...
  %reass.sub845 = shl i64 %i.hk, 1
  %i.hl = add i64 %reass.sub845, -4294967294
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %.loopexit844, label %scalar.ph.preheader
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %i.jl, label %scalar.ph, label %.loopexit844, !llvm.loop !27

.loopexit844:                                     ; preds = %scalar.ph, %middle.block
...
.loopexit647:                                     ; preds = %.loopexit844, %bb.s
...
.lr.ph698:                                        ; preds = %bb.v, %bb.ap
  %i.ka = phi i32 [ %i.wp, %bb.ap ], [ %i.h, %bb.v ] ; 2 uses
  %.1531.neg696 = phi i32 [ %.1531.neg, %bb.ap ], [ -1, %bb.v ] ; 5 uses
  %.1525694 = phi i32 [ %i.ws, %bb.ap ], [ 1, %bb.v ] ; 12 uses
  %.1531691 = phi i32 [ %i.wo, %bb.ap ], [ 1, %bb.v ] ; 28 uses
...
.lr.ph675:                                        ; preds = %bb.ab
  ...
  %xtraiter849 = and i64 %i.lg, 3                 ; 2 uses
  %lcmp.mod850.not = icmp eq i64 %xtraiter849, 0
  br i1 %lcmp.mod850.not, label %.prol.loopexit, label %.prol.preheader
...
.prol.preheader:                                  ; preds = %.lr.ph675, %.prol.preheader
  ...
  %prol.iter851 = phi i64 [ %prol.iter851.next, %.prol.preheader ], [ 0, %.lr.ph675 ]
  ...
  br i1 %prol.iter851.cmp.not, label %.prol.loopexit, label %.prol.preheader, !llvm.loop !29
...
.lr.ph675.new:                                    ; preds = %.prol.loopexit, %.lr.ph675.new
  ...
  %.neg857 = xor i32 %i.mn, -1
  %i.mo = add i32 %i.me, %.neg857
...
.lr.ph683:                                        ; preds = %bb.aj
  ...
  %xtraiter854 = and i64 %i.pm, 3                 ; 2 uses
  %lcmp.mod855.not = icmp eq i64 %xtraiter854, 0
  br i1 %lcmp.mod855.not, label %.prol.loopexit853, label %.prol.preheader852

.prol.preheader852:                               ; preds = %.lr.ph683, %.prol.preheader852
  %indvars.iv718.prol = phi i64 [ %indvars.iv.next719.prol, %.prol.preheader852 ], [ %i.pk, %.lr.ph683 ] ; 2 uses
  %.3519681.prol = phi i32 [ %.reass.prol, %.prol.preheader852 ], [ %i.ph, %.lr.ph683 ]
  %prol.iter856 = phi i64 [ %prol.iter856.next, %.prol.preheader852 ], [ 0, %.lr.ph683 ]
  ...
  br i1 %prol.iter856.cmp.not, label %.prol.loopexit853, label %.prol.preheader852, !llvm.loop !31

.prol.loopexit853:                                ; preds = %.prol.preheader852, %.lr.ph683
  %indvars.iv718.unr = phi i64 [ %i.pk, %.lr.ph683 ], [ %indvars.iv.next719.prol, %.prol.preheader852 ]
  %.3519681.unr = phi i32 [ %i.ph, %.lr.ph683 ], [ %.reass.prol, %.prol.preheader852 ]
  %i.pv = sub nsw i64 %i.pk, %i.pl
  %i.pw = icmp ugt i64 %i.pv, -4
  br i1 %i.pw, label %._crit_edge684, label %.lr.ph683.new

.lr.ph683.new:                                    ; preds = %.prol.loopexit853, %.lr.ph683.new
  %indvars.iv718 = phi i64 [ %indvars.iv.next719.3, %.lr.ph683.new ], [ %indvars.iv718.unr, %.prol.loopexit853 ] ; 5 uses
  %.3519681 = phi i32 [ %.reass.3, %.lr.ph683.new ], [ %.3519681.unr, %.prol.loopexit853 ]
...
._crit_edge684:                                   ; preds = %.prol.loopexit853, %.lr.ph683.new, %bb.aj
...
.lr.ph689:                                        ; preds = %bb.am
  ...
  %i.tu = shl nuw nsw i64 %i.tt, 3                ; 6 uses
  %i.tv = shl nsw i64 %i.to, 3                    ; 2 uses
  %i.tw = shl nsw i64 %i.tp, 3                    ; 2 uses
  ...
  %i.uc = getelementptr i8, ptr %2, i64 %i.tw
  %i.ud = getelementptr i8, ptr %i.uc, i64 8
  %i.ue = getelementptr i8, ptr %i.ud, i64 %i.tu
  %i.uf = getelementptr i8, ptr %2, i64 %i.tv
  %i.ug = getelementptr i8, ptr %i.uf, i64 16
  %i.uh = getelementptr i8, ptr %i.ug, i64 %i.tu
  %i.ui = getelementptr i8, ptr %2, i64 %i.tv
  %i.uj = getelementptr i8, ptr %i.ui, i64 8
  %i.uk = getelementptr i8, ptr %i.uj, i64 %i.tu
  %i.ul = getelementptr i8, ptr %2, i64 %i.tu
  %i.um = getelementptr i8, ptr %i.ul, i64 16
  %i.un = getelementptr i8, ptr %2, i64 %i.tu
  %i.uo = getelementptr i8, ptr %i.un, i64 8
  br label %bb.an

bb.an:                                            ; preds = %.lr.ph689, %.loopexit843
  %indvar803 = phi i64 [ 0, %.lr.ph689 ], [ %indvar.next804, %.loopexit843 ] ; 4 uses
  %indvars.iv721 = phi i64 [ %i.tn, %.lr.ph689 ], [ %indvars.iv.next722, %.loopexit843 ] ; 12 uses
  %smax822 = call i64 @llvm.smax.i64(i64 %indvars.iv721, i64 %i.tq)
  %i.up = sub i64 %i.ty, %indvar803
  %i.uq = add i64 %smax822, %i.up                 ; 3 uses
  %indvars726 = trunc i64 %indvars.iv721 to i32
  %gep768 = getelementptr [8 x i8], ptr %invariant.gep767, i64 %indvars.iv721 ; 2 uses
  %i.ur = load double, ptr %gep768, align 8, !tbaa !9 ; 2 uses
  %gep770 = getelementptr [8 x i8], ptr %invariant.gep769, i64 %indvars.iv721
  %i.us = load double, ptr %gep770, align 8, !tbaa !9 ; 2 uses
  %i.ut = fneg double %i.us
  %i.uu = call double @llvm.fmuladd.f64(double %i.sz, double %i.ur, double %i.ut)
  %i.uv = fmul double %i.th, %i.uu                ; 3 uses
  %i.uw = fneg double %i.ur
  %i.ux = call double @llvm.fmuladd.f64(double %i.te, double %i.us, double %i.uw)
  %i.uy = fmul double %i.th, %i.ux                ; 3 uses
  %i.uz = sub nsw i32 %i.sk, %indvars726
  %i.va = trunc i64 %indvars.iv721 to i32
  %i.vb = add i32 %i.va, -1
  %i.vc = mul nsw i32 %i.vb, %i.uz
  %i.vd = sdiv i32 %i.vc, 2
  %i.ve = sext i32 %i.vd to i64                   ; 2 uses
  %invariant.gep761 = getelementptr [8 x i8], ptr %i.e, i64 %i.ve ; 2 uses
  %min.iters.check824 = icmp ult i64 %i.uq, 8
  br i1 %min.iters.check824, label %scalar.ph823.preheader, label %vector.memcheck802

vector.memcheck802:                               ; preds = %bb.an
  %i.vf = shl nuw nsw i64 %indvar803, 3           ; 6 uses
  %scevgep813.a = getelementptr i8, ptr %i.ub, i64 %i.vf
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv721, i64 %i.tq)
  %i.vg = add i64 %indvar803, %i.tt
  %reass.sub846 = sub i64 %smax, %i.vg
  %i.vh = shl i64 %reass.sub846, 3
  %i.vi = add i64 %i.vh, -16                      ; 3 uses
  %scevgep814.a = getelementptr i8, ptr %scevgep813.a, i64 %i.vi
  %scevgep812.a = getelementptr i8, ptr %i.ue, i64 %i.vf
  %scevgep810.a = getelementptr i8, ptr %i.uh, i64 %i.vf
  %scevgep811.a = getelementptr i8, ptr %scevgep810.a, i64 %i.vi
  %scevgep809.a = getelementptr i8, ptr %i.uk, i64 %i.vf
  %scevgep807 = getelementptr i8, ptr %i.um, i64 %i.vf
  %scevgep805 = getelementptr i8, ptr %i.uo, i64 %i.vf
  %i.vj = shl nsw i64 %i.ve, 3                    ; 2 uses
  %scevgep806 = getelementptr i8, ptr %scevgep805, i64 %i.vj ; 2 uses
  %i.vk = getelementptr i8, ptr %scevgep807, i64 %i.vi
  %scevgep808 = getelementptr i8, ptr %i.vk, i64 %i.vj ; 2 uses
  %bound0815 = icmp ult ptr %scevgep806, %scevgep811.a
  %bound1816 = icmp ult ptr %scevgep809.a, %scevgep808
  %found.conflict817 = and i1 %bound0815, %bound1816
  %bound0818 = icmp ult ptr %scevgep806, %scevgep814.a
  %bound1819 = icmp ult ptr %scevgep812.a, %scevgep808
  %found.conflict820 = and i1 %bound0818, %bound1819
  %conflict.rdx821 = or i1 %found.conflict817, %found.conflict820
  br i1 %conflict.rdx821, label %scalar.ph823.preheader, label %vector.ph825

vector.ph825:                                     ; preds = %vector.memcheck802
  %n.vec826 = and i64 %i.uq, -8                   ; 3 uses
  %i.vl = add i64 %indvars.iv721, %n.vec826
  %broadcast.splatinsert827 = insertelement <4 x double> poison, double %i.uv, i64 0
  %broadcast.splat828 = shufflevector <4 x double> %broadcast.splatinsert827, <4 x double> poison, <4 x i32> zeroinitializer ; 2 uses
  %broadcast.splatinsert829 = insertelement <4 x double> poison, double %i.uy, i64 0
  %broadcast.splat830 = shufflevector <4 x double> %broadcast.splatinsert829, <4 x double> poison, <4 x i32> zeroinitializer ; 2 uses
  br label %vector.body831

vector.body831:                                   ; preds = %vector.body831, %vector.ph825
  %index832 = phi i64 [ 0, %vector.ph825 ], [ %index.next839, %vector.body831 ] ; 2 uses
  %i.vm = add nuw i64 %indvars.iv721, %index832   ; 3 uses
  %i.vn = getelementptr [8 x i8], ptr %invariant.gep761, i64 %i.vm ; 3 uses
  %i.vo = getelementptr i8, ptr %i.vn, i64 32     ; 2 uses
  %wide.load833 = load <4 x double>, ptr %i.vn, align 8, !tbaa !9, !alias.scope !33, !noalias !36
  %wide.load834 = load <4 x double>, ptr %i.vo, align 8, !tbaa !9, !alias.scope !33, !noalias !36
  %i.vp = getelementptr [8 x i8], ptr %invariant.gep763, i64 %i.vm ; 2 uses
  %i.vq = getelementptr i8, ptr %i.vp, i64 32
  %wide.load835 = load <4 x double>, ptr %i.vp, align 8, !tbaa !9, !alias.scope !39
  %wide.load836 = load <4 x double>, ptr %i.vq, align 8, !tbaa !9, !alias.scope !39
  %i.vr = fneg <4 x double> %wide.load835
  %i.vs = fneg <4 x double> %wide.load836
  %i.vt = call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %i.vr, <4 x double> %broadcast.splat828, <4 x double> %wide.load833)
  %i.vu = call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %i.vs, <4 x double> %broadcast.splat828, <4 x double> %wide.load834)
  %i.vv = getelementptr [8 x i8], ptr %invariant.gep765, i64 %i.vm ; 2 uses
  %i.vw = getelementptr i8, ptr %i.vv, i64 32
  %wide.load837 = load <4 x double>, ptr %i.vv, align 8, !tbaa !9, !alias.scope !40
  %wide.load838 = load <4 x double>, ptr %i.vw, align 8, !tbaa !9, !alias.scope !40
  %i.vx = fneg <4 x double> %wide.load837
  %i.vy = fneg <4 x double> %wide.load838
  %i.vz = call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %i.vx, <4 x double> %broadcast.splat830, <4 x double> %i.vt)
  %i.wa = call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %i.vy, <4 x double> %broadcast.splat830, <4 x double> %i.vu)
  store <4 x double> %i.vz, ptr %i.vn, align 8, !tbaa !9, !alias.scope !33, !noalias !36
  store <4 x double> %i.wa, ptr %i.vo, align 8, !tbaa !9, !alias.scope !33, !noalias !36
  %index.next839 = add nuw i64 %index832, 8       ; 2 uses
  %i.wb = icmp eq i64 %index.next839, %n.vec826
  br i1 %i.wb, label %middle.block840, label %vector.body831, !llvm.loop !41

middle.block840:                                  ; preds = %vector.body831
  %cmp.n841 = icmp eq i64 %i.uq, %n.vec826
  br i1 %cmp.n841, label %.loopexit843, label %scalar.ph823.preheader

scalar.ph823.preheader:                           ; preds = %vector.memcheck802, %bb.an, %middle.block840
  %indvars.iv723.ph = phi i64 [ %indvars.iv721, %vector.memcheck802 ], [ %indvars.iv721, %bb.an ], [ %i.vl, %middle.block840 ]
  br label %scalar.ph823

scalar.ph823:                                     ; preds = %scalar.ph823.preheader, %scalar.ph823
  %indvars.iv723 = phi i64 [ %indvars.iv.next724, %scalar.ph823 ], [ %indvars.iv723.ph, %scalar.ph823.preheader ] ; 5 uses
  %gep762 = getelementptr [8 x i8], ptr %invariant.gep761, i64 %indvars.iv723 ; 2 uses
  %i.wc = load double, ptr %gep762, align 8, !tbaa !9
  %gep764 = getelementptr [8 x i8], ptr %invariant.gep763, i64 %indvars.iv723
  %i.wd = load double, ptr %gep764, align 8, !tbaa !9
  %i.we = fneg double %i.wd
  %i.wf = call double @llvm.fmuladd.f64(double %i.we, double %i.uv, double %i.wc)
  %gep766 = getelementptr [8 x i8], ptr %invariant.gep765, i64 %indvars.iv723
  %i.wg = load double, ptr %gep766, align 8, !tbaa !9
  %i.wh = fneg double %i.wg
  %i.wi = call double @llvm.fmuladd.f64(double %i.wh, double %i.uy, double %i.wf)
  store double %i.wi, ptr %gep762, align 8, !tbaa !9
  %indvars.iv.next724 = add nuw nsw i64 %indvars.iv723, 1
  %.not559.not = icmp slt i64 %indvars.iv723, %i.tq
  br i1 %.not559.not, label %scalar.ph823, label %.loopexit843, !llvm.loop !42

.loopexit843:                                     ; preds = %scalar.ph823, %middle.block840
  store double %i.uv, ptr %gep768, align 8, !tbaa !9
  %gep772 = getelementptr [8 x i8], ptr %invariant.gep771, i64 %indvars.iv721
  store double %i.uy, ptr %gep772, align 8, !tbaa !9
...
bb.ao:                                            ; preds = %bb.ak, %.thread620, %bb.z, %bb.y
  ...
  %i.wj = zext nneg i32 %.1531691 to i64
  %i.wk = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %i.wj
  store i32 %.3523.ph, ptr %i.wk, align 4, !tbaa !8
  br label %bb.ap

.loopexit:                                        ; preds = %.loopexit843, %bb.am, %bb.al
  %i.wl = zext nneg i32 %.1531691 to i64
  %i.wm = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %i.wl ; 2 uses
  store i32 %i.ku, ptr %i.wm, align 4, !tbaa !8
  %i.wn = getelementptr inbounds nuw i8, ptr %i.wm, i64 4
  store i32 %i.ku, ptr %i.wn, align 4, !tbaa !8
  br label %bb.ap

bb.ap:                                            ; preds = %.loopexit, %bb.ao
  %.3507640 = phi i32 [ %.2506748, %.loopexit ], [ %.3507.ph, %bb.ao ]
  %.3529637 = phi i32 [ 2, %.loopexit ], [ 1, %bb.ao ]
  %i.wo = add nuw nsw i32 %.3529637, %.1531691    ; 4 uses
  %i.wp = load i32, ptr %1, align 4, !tbaa !8     ; 3 uses
  %i.wq = add i32 %.3507640, 2
  %i.wr = add i32 %i.wq, %i.wp
  %i.ws = sub i32 %i.wr, %i.wo
  %.1531.neg = sub nsw i32 0, %i.wo
  %i.wt = icmp sgt i32 %i.wo, %i.wp
  br i1 %i.wt, label %.loopexit646, label %.lr.ph698
