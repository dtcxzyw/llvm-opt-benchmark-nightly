...
.lr.ph698:                                        ; preds = %bb.v, %bb.ap
  ...
  %.1531691 = phi i32 [ %i.wo, %bb.ap ], [ 1, %bb.v ] ; 31 uses
...
bb.an:                                            ; preds = %.lr.ph689, %.loopexit843
  %scev.check.iv806 = phi i32 [ %8, %.lr.ph689 ], [ %scev.check.iv.next807, %.loopexit843 ] ; 2 uses
  %indvar803 = phi i64 [ 0, %.lr.ph689 ], [ %indvar.next804, %.loopexit843 ] ; 5 uses
...
vector.memcheck802:                               ; preds = %bb.an
  ...
  %i.vj = shl nsw i64 %14, 3                      ; 2 uses
  %15 = getelementptr i8, ptr %scevgep807, i64 %i.vi
  %scevgep806 = getelementptr i8, ptr %15, i64 %i.vj ; 2 uses
  %i.vk = getelementptr i8, ptr %i.uo, i64 %i.vf
  %scevgep808 = getelementptr i8, ptr %i.vk, i64 %i.vj ; 2 uses
  %bound0815 = icmp ult ptr %scevgep808, %scevgep811.a
  %bound1816 = icmp ult ptr %scevgep809.a, %scevgep806
  %found.conflict817 = and i1 %bound0815, %bound1816
  %bound0818 = icmp ult ptr %scevgep808, %scevgep814.a
  %bound1819 = icmp ult ptr %scevgep812.a, %scevgep806
