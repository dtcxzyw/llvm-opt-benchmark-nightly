...
bb.a:
  ...
  %i.h = sext i32 %narrow509 to i64               ; 3 uses
...
.lr.ph645:                                        ; preds = %bb.q
  ...
  %i.ax = sext i32 %i.g to i64                    ; 15 uses
  ...
  %i.bb = shl nsw i64 %i.ax, 3                    ; 3 uses
  %i.bc = shl nsw i64 %i.h, 3                     ; 2 uses
  %16 = add nsw i64 %i.bb, %i.bc                  ; 2 uses
  %17 = shl nsw i64 %i.ax, 3
  %18 = add nsw i64 %16, 8                        ; 2 uses
  %scevgep1001 = getelementptr i8, ptr %13, i64 -8
  %i.bd = add nsw i64 %i.bb, 8
  ...
  %i.bs = getelementptr i8, ptr %5, i64 %i.bh
  %i.bt = getelementptr i8, ptr %i.bs, i64 16
  %i.bu = getelementptr i8, ptr %5, i64 %i.bi
  %i.bv = getelementptr i8, ptr %5, i64 %i.bi
  %i.bw = getelementptr i8, ptr %5, i64 %i.bi
  %i.bx = getelementptr i8, ptr %5, i64 %i.bb
  %i.by = getelementptr i8, ptr %i.bx, i64 %i.bc
  %i.bz = getelementptr i8, ptr %5, i64 %18
  %i.ca = getelementptr i8, ptr %5, i64 %16
  %i.cb = getelementptr i8, ptr %5, i64 %18
...
vector.memcheck1095:                              ; preds = %iter.check1127
  ...
  %scevgep1100 = getelementptr i8, ptr %i.bt, i64 %i.fp
  %i.fq = mul i64 %i.bl, %indvar1096
  %scevgep1099 = getelementptr i8, ptr %i.bu, i64 %i.fq
...
.lr.ph574:                                        ; preds = %.lr.ph574.preheader, %._crit_edge571
  ...
  %scevgep1051 = getelementptr i8, ptr %i.bv, i64 %i.is
  %i.it = mul i64 %i.bk, %indvar1048
  %scevgep1052 = getelementptr i8, ptr %i.bw, i64 %i.it
...
.lr.ph578.preheader:                              ; preds = %.preheader554
  ...
  %i.me = getelementptr i8, ptr %i.by, i64 %i.mb
...
vector.memcheck997:                               ; preds = %iter.check1031
  ...
  %scevgep1003 = getelementptr i8, ptr %i.bz, i64 %i.mq
...
.lr.ph586:                                        ; preds = %.lr.ph586.preheader, %._crit_edge583
  ...
  %i.qa = mul i64 %17, %indvar952                 ; 2 uses
  %scevgep954 = getelementptr i8, ptr %i.ca, i64 %i.qa
...
.preheader543:                                    ; preds = %.preheader543.preheader, %.epilog-lcssa
  ...
  %i.tl = add i64 %indvar1203, 1                  ; 2 uses
