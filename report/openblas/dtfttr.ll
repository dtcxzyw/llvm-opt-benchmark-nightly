...
.lr.ph574.preheader:                              ; preds = %.thread461
  ...
  %i.zp = lshr exact i64 %i.zo, 1                 ; 7 uses
  %i.zq = sext i32 %i.d to i64                    ; 7 uses
  %i.zr = zext nneg i32 %i.i to i64
  %i.zs = zext nneg i32 %i.v to i64
  %wide.trip.count839 = zext nneg i32 %i.v to i64 ; 2 uses
  %invariant.gep1031 = getelementptr [8 x i8], ptr %4, i64 %i.zs
  %i.zt = shl nsw i64 %i.zq, 3
  %7 = add nsw i64 %i.zt, 8
  %i.zu = add nuw nsw i64 %wide.trip.count839, 1
  %ident.check1406.not = icmp eq i32 %i.d, 1
  br label %iter.check1434

iter.check1434:                                   ; preds = %.lr.ph574.preheader, %._crit_edge569
  %indvars.iv842.in = phi i64 [ %i.zp, %.lr.ph574.preheader ], [ %i.zy, %._crit_edge569 ] ; 3 uses
  ...
  %8 = add nuw i64 %i.zu, %indvars.iv829
  %i.zv = add nuw i64 %indvars.iv829, 1           ; 5 uses
  %i.zw = sub nsw i64 %i.zo, %indvars.iv829       ; 7 uses
  %i.zx = mul i64 %7, %indvars.iv829
  %i.zy = add nuw nsw i64 %indvars.iv842.in, 1
...
vec.epilog.scalar.ph1435.preheader:               ; preds = %vector.memcheck1407, %iter.check1434, %vec.epilog.iter.check1436, %vec.epilog.middle.block1445
  %indvars.iv825.in.ph = phi i32 [ %.16573, %iter.check1434 ], [ %.16573, %vector.memcheck1407 ], [ %i.aax, %vec.epilog.iter.check1436 ], [ %i.abf, %vec.epilog.middle.block1445 ] ; 2 uses
  %indvars.iv821.ph = phi i64 [ %i.zp, %iter.check1434 ], [ %i.zp, %vector.memcheck1407 ], [ %i.aah, %vec.epilog.iter.check1436 ], [ %i.aay, %vec.epilog.middle.block1445 ] ; 4 uses
  %indvars.iv819.ph = phi i64 [ %i.zz, %iter.check1434 ], [ %i.zz, %vector.memcheck1407 ], [ %i.aai, %vec.epilog.iter.check1436 ], [ %i.aaz, %vec.epilog.middle.block1445 ] ; 2 uses
...
vec.epilog.scalar.ph1446.prol:                    ; preds = %vec.epilog.scalar.ph1435.preheader, %vec.epilog.scalar.ph1446.prol
  ...
  %11 = getelementptr inbounds [8 x i8], ptr %3, i64 %indvars.iv819.prol
  %12 = load double, ptr %11, align 8, !tbaa !9
  %13 = mul nsw i64 %indvars.iv821.prol, %i.zq
  %gep1028.prol = getelementptr [8 x i8], ptr %invariant.gep1017, i64 %13
  store double %12, ptr %gep1028.prol, align 8, !tbaa !9
...
.preheader474:                                    ; preds = %vec.epilog.scalar.ph1446.prol.loopexit, %vec.epilog.scalar.ph1435, %vec.epilog.middle.block1445, %middle.block1426
  %indvars.iv829.lcssa = phi i32 [ %i.abf, %vec.epilog.middle.block1445 ], [ %i.aax, %middle.block1426 ], [ %indvars.iv829.lcssa1871.unr, %vec.epilog.scalar.ph1446.prol.loopexit ], [ %indvars.iv825, %vec.epilog.scalar.ph1435 ]
  %indvars.iv.next820.lcssa = phi i64 [ %i.aaz, %vec.epilog.middle.block1445 ], [ %i.aai, %middle.block1426 ], [ %indvars.iv.next820.lcssa1870.unr, %vec.epilog.scalar.ph1446.prol.loopexit ], [ %indvars.iv.next820, %vec.epilog.scalar.ph1435 ]
...
iter.check1391:                                   ; preds = %.preheader474
  ...
  %i.abh = sext i32 %indvars.iv829.lcssa to i64   ; 7 uses
...
vector.body1380:                                  ; preds = %vector.body1380, %vector.ph1378
  ...
  br i1 %i.abx, label %middle.block1387, label %vector.body1380, !llvm.loop !65
...
vec.epilog.vector.body1397:                       ; preds = %vec.epilog.vector.body1397, %vec.epilog.ph1395
  ...
  br i1 %i.acc, label %vec.epilog.middle.block1401, label %vec.epilog.vector.body1397, !llvm.loop !66
...
vec.epilog.scalar.ph1435:                         ; preds = %vec.epilog.scalar.ph1446.prol.loopexit, %vec.epilog.scalar.ph1435
  ...
  %15 = getelementptr inbounds [8 x i8], ptr %3, i64 %indvars.iv819
  %16 = load double, ptr %15, align 8, !tbaa !9
  %17 = mul nsw i64 %indvars.iv821, %i.zq
  %gep1028 = getelementptr [8 x i8], ptr %invariant.gep1017, i64 %17
  store double %16, ptr %gep1028, align 8, !tbaa !9
  %indvars.iv.next822 = add nuw nsw i64 %indvars.iv821, 1
  %18 = getelementptr [8 x i8], ptr %3, i64 %indvars.iv819
  %19 = getelementptr i8, ptr %18, i64 8
  %20 = load double, ptr %19, align 8, !tbaa !9
  %21 = mul nsw i64 %indvars.iv.next822, %i.zq
  %gep1028.1 = getelementptr [8 x i8], ptr %invariant.gep1017, i64 %21
  store double %20, ptr %gep1028.1, align 8, !tbaa !9
  %indvars.iv.next822.1 = add nuw nsw i64 %indvars.iv821, 2
  %22 = getelementptr [8 x i8], ptr %3, i64 %indvars.iv819
  %23 = getelementptr i8, ptr %22, i64 16
  %24 = load double, ptr %23, align 8, !tbaa !9
  %25 = mul nsw i64 %indvars.iv.next822.1, %i.zq
  %gep1028.2 = getelementptr [8 x i8], ptr %invariant.gep1017, i64 %25
  store double %24, ptr %gep1028.2, align 8, !tbaa !9
  %indvars.iv.next822.2 = add nuw nsw i64 %indvars.iv821, 3 ; 2 uses
  %indvars.iv825 = add i32 %indvars.iv825.in, 4   ; 2 uses
  %i.aci = getelementptr [8 x i8], ptr %3, i64 %indvars.iv819
  %26 = getelementptr i8, ptr %i.aci, i64 24
  %i.acj = load double, ptr %26, align 8, !tbaa !9
  %i.ack = mul nsw i64 %indvars.iv.next822.2, %i.zq
...
vector.body1635:                                  ; preds = %vector.body1635, %vector.ph1633
  ...
  br i1 %i.afg, label %middle.block1646, label %vector.body1635, !llvm.loop !71
...
vec.epilog.vector.body1659:                       ; preds = %vec.epilog.vector.body1659, %vec.epilog.ph1657
  ...
  br i1 %i.afm, label %vec.epilog.middle.block1664, label %vec.epilog.vector.body1659, !llvm.loop !72
...
vector.body1603:                                  ; preds = %vector.body1603, %vector.ph1601
  ...
  br i1 %i.aho, label %middle.block1610, label %vector.body1603, !llvm.loop !75
...
vec.epilog.vector.body1620:                       ; preds = %vec.epilog.vector.body1620, %vec.epilog.ph1618
  ...
  br i1 %i.ahr, label %vec.epilog.middle.block1624, label %vec.epilog.vector.body1620, !llvm.loop !76
...
vector.body1458:                                  ; preds = %vector.body1458, %vector.ph1456
  ...
  br i1 %i.ajy, label %middle.block1465, label %vector.body1458, !llvm.loop !80
...
vec.epilog.vector.body1474:                       ; preds = %vec.epilog.vector.body1474, %vec.epilog.ph1472
  ...
  br i1 %i.akb, label %vec.epilog.middle.block1478, label %vec.epilog.vector.body1474, !llvm.loop !81
...
vector.body1523:                                  ; preds = %vector.body1523, %vector.ph1521
  ...
  br i1 %i.alv, label %middle.block1534, label %vector.body1523, !llvm.loop !83
...
vec.epilog.vector.body1547:                       ; preds = %vec.epilog.vector.body1547, %vec.epilog.ph1545
  ...
  br i1 %i.amd, label %vec.epilog.middle.block1552, label %vec.epilog.vector.body1547, !llvm.loop !84
...
vector.body1489:                                  ; preds = %vector.body1489, %vector.ph1487
  ...
  br i1 %i.ano, label %middle.block1496, label %vector.body1489, !llvm.loop !87
...
vec.epilog.vector.body1506:                       ; preds = %vec.epilog.vector.body1506, %vec.epilog.ph1504
  ...
  br i1 %i.anr, label %vec.epilog.middle.block1510, label %vec.epilog.vector.body1506, !llvm.loop !88
...
vector.body1568:                                  ; preds = %vector.body1568, %vector.ph1566
  ...
  br i1 %i.aqc, label %middle.block1575, label %vector.body1568, !llvm.loop !92
...
vec.epilog.vector.body1584:                       ; preds = %vec.epilog.vector.body1584, %vec.epilog.ph1582
  ...
  br i1 %i.aqh, label %vec.epilog.middle.block1588, label %vec.epilog.vector.body1584, !llvm.loop !93
...
vector.body1679:                                  ; preds = %vector.body1679, %vector.ph1677
  ...
  br i1 %i.asr, label %middle.block1686, label %vector.body1679, !llvm.loop !97
...
vec.epilog.vector.body1696:                       ; preds = %vec.epilog.vector.body1696, %vec.epilog.ph1694
  ...
  br i1 %i.asv, label %vec.epilog.middle.block1700, label %vec.epilog.vector.body1696, !llvm.loop !98
...
vector.body1745:                                  ; preds = %vector.body1745, %vector.ph1743
  ...
  br i1 %i.aun, label %middle.block1756, label %vector.body1745, !llvm.loop !101
...
vec.epilog.vector.body1769:                       ; preds = %vec.epilog.vector.body1769, %vec.epilog.ph1767
  ...
  br i1 %i.auv, label %vec.epilog.middle.block1774, label %vec.epilog.vector.body1769, !llvm.loop !102
...
vector.body1713:                                  ; preds = %vector.body1713, %vector.ph1711
  ...
  br i1 %i.awx, label %middle.block1720, label %vector.body1713, !llvm.loop !105
...
vec.epilog.vector.body1730:                       ; preds = %vec.epilog.vector.body1730, %vec.epilog.ph1728
  ...
  br i1 %i.axa, label %vec.epilog.middle.block1734, label %vec.epilog.vector.body1730, !llvm.loop !106
...
vector.body1786:                                  ; preds = %vector.body1786, %vector.ph1784
  ...
  br i1 %i.azh, label %middle.block1793, label %vector.body1786, !llvm.loop !110
...
vec.epilog.vector.body1802:                       ; preds = %vec.epilog.vector.body1802, %vec.epilog.ph1800
  ...
  br i1 %i.azm, label %vec.epilog.middle.block1806, label %vec.epilog.vector.body1802, !llvm.loop !111
