...
bb.q:                                             ; preds = %bb.p, %bb.o
  ...
  %i.be = shl nsw i64 %i.o, 3                     ; 12 uses
  %scevgep = getelementptr i8, ptr %5, i64 %i.be
  %i.bf = add nsw i64 %i.be, 8                    ; 8 uses
  %scevgep4279.a = getelementptr i8, ptr %5, i64 %i.bf
  %i.bg = shl nsw i64 %i.r, 3                     ; 7 uses
  %scevgep4283.a = getelementptr i8, ptr %7, i64 %i.bg
  %i.bh = add i32 %i.ab, 1
  %13 = add nsw i64 %i.bg, 8                      ; 5 uses
  %scevgep4285.a = getelementptr i8, ptr %7, i64 %13
  %scevgep4287.a = getelementptr i8, ptr %5, i64 %i.be
  %scevgep4289 = getelementptr i8, ptr %5, i64 %i.bf
  %i.bi = add i32 %i.ab, 1
  %scevgep4338.a = getelementptr i8, ptr %5, i64 %i.be
  %scevgep4341.a = getelementptr i8, ptr %7, i64 %i.bg
  %14 = add i32 %i.ab, 1
  %scevgep4343.a = getelementptr i8, ptr %7, i64 %13
  %scevgep4344 = getelementptr i8, ptr %7, i64 %i.bg
  %scevgep4347 = getelementptr i8, ptr %5, i64 %i.be
  %scevgep4345.a = getelementptr i8, ptr %5, i64 %i.bf
  %scevgep4347.a = getelementptr i8, ptr %5, i64 %i.be
  %scevgep4349 = getelementptr i8, ptr %5, i64 %i.bf
  %scevgep4352.a = getelementptr i8, ptr %5, i64 %i.bf
  %scevgep4354 = getelementptr i8, ptr %7, i64 %i.bg
  %scevgep4356 = getelementptr i8, ptr %scevgep4354, i64 8
  %scevgep4358 = getelementptr i8, ptr %5, i64 %i.be
  %scevgep4361 = getelementptr i8, ptr %scevgep4358, i64 8
  br label %.outer2886

.outer2886:                                       ; preds = %.loopexit2884, %bb.q
  %.pre3787.a = phi i32 [ %.pre3787.pre, %.loopexit2884 ], [ %i.aw, %bb.q ] ; 6 uses
  %i.bj = phi i32 [ %i.bve, %.loopexit2884 ], [ %i.av, %bb.q ] ; 5 uses
...
.lr.ph:                                           ; preds = %.outer2886
  ...
  %i.bl = add i32 %.02605.ph, -2                  ; 11 uses
  %i.bm = call i32 @llvm.smin.i32(i32 %i.bj, i32 %i.bl) ; 13 uses
  ...
  %i.bp = sub i32 %i.bk, %i.bm                    ; 15 uses
...
.lr.ph2983:                                       ; preds = %._crit_edge2959
  ...
  %15 = zext i32 %i.bp to i64                     ; 5 uses
  ...
  %i.hc = mul i32 %.0255729803502, %i.bp
  ...
  %i.hj = mul i32 %.0255729803502, %i.bp          ; 3 uses
  ...
  %i.ia = add i32 %.02605.ph, -1
  %i.ib = add i32 %i.ia, %i.bq
  %i.ic = add i32 %i.ib, %i.hj
  %i.id = sub i32 %i.ic, %i.bm
  %i.ie = add i32 %i.bi, %i.bs
  %i.if = sub i32 %i.ie, %i.bm                    ; 2 uses
  %i.ig = add i32 %i.bq, %i.gp
  %i.ih = sub i32 %i.ig, %i.bm                    ; 2 uses
  %i.ii = add i32 %.02605.ph, -1
  %i.ij = add i32 %i.ii, %i.bq
  %i.ik = add i32 %i.ij, %i.hj
  %i.il = sub i32 %i.ik, %i.bm
  %i.im = add i32 %14, %i.bs
  %i.in = sub i32 %i.im, %i.bm                    ; 2 uses
  %i.io = sext i32 %i.in to i64
  %i.ip = shl nsw i64 %i.io, 3                    ; 2 uses
  %scevgep4350.a = getelementptr i8, ptr %scevgep4344, i64 %i.ip
  %i.iq = add i32 %i.bq, %i.gp
  %i.ir = sub i32 %i.iq, %i.bm                    ; 2 uses
  %i.is = sext i32 %i.ir to i64
  %i.it = shl nsw i64 %i.is, 3                    ; 2 uses
  %scevgep4359 = getelementptr i8, ptr %scevgep4347.a, i64 %i.it
  %i.iu = shl nsw i64 %i.gr, 3
  %scevgep4362 = getelementptr i8, ptr %scevgep4349, i64 %i.iu
  %16 = getelementptr i8, ptr %scevgep4356, i64 %i.ip
  %17 = getelementptr i8, ptr %scevgep4361, i64 %i.it
...
bb.t:                                             ; preds = %._crit_edge2973, %.lr.ph2983
  %indvar4336 = phi i64 [ %indvar.next4337, %._crit_edge2973 ], [ 0, %.lr.ph2983 ] ; 6 uses
  %indvar = phi i32 [ %indvar.next, %._crit_edge2973 ], [ 0, %.lr.ph2983 ] ; 9 uses
  %indvars.iv3565 = phi i64 [ %indvars.iv.next3566, %._crit_edge2973 ], [ %15, %.lr.ph2983 ] ; 4 uses
  %indvars.iv3558 = phi i32 [ %indvars.iv.next3559, %._crit_edge2973 ], [ %i.gx, %.lr.ph2983 ] ; 3 uses
  %18 = trunc i64 %indvar4336 to i32
  %i.jb = add i32 %i.bp, %18
  %i.jc = add i64 %indvar4336, 1                  ; 3 uses
  %i.jd = mul i32 %.0255729803502, %indvar
  %i.je = add i32 %i.il, %i.jd
  %i.jf = sext i32 %i.je to i64
  %i.jg = shl nsw i64 %i.jf, 3                    ; 2 uses
  %scevgep4340 = getelementptr i8, ptr %scevgep4338.a, i64 %i.jg ; 5 uses
  %19 = shl nuw nsw i64 %indvar4336, 3            ; 3 uses
  %scevgep4338 = getelementptr i8, ptr %scevgep4352.a, i64 %19
  %i.jh = getelementptr i8, ptr %scevgep4338, i64 %i.jg ; 5 uses
  %20 = trunc i64 %indvar4336 to i32
  %i.ji = add i32 %i.in, %20
  %i.jj = sext i32 %i.ji to i64
  %i.jk = shl nsw i64 %i.jj, 3                    ; 2 uses
  %scevgep4344.a = getelementptr i8, ptr %scevgep4341.a, i64 %i.jk
  %scevgep4346.a = getelementptr i8, ptr %scevgep4343.a, i64 %i.jk
  %scevgep4351 = getelementptr i8, ptr %16, i64 %19
  %21 = trunc i64 %indvar4336 to i32
  %i.jl = add i32 %i.ir, %21
  %i.jm = sext i32 %i.jl to i64
  %i.jn = shl nsw i64 %i.jm, 3                    ; 2 uses
  %scevgep4353.a = getelementptr i8, ptr %scevgep4347, i64 %i.jn
  %scevgep4355 = getelementptr i8, ptr %scevgep4345.a, i64 %i.jn
  %scevgep4360 = getelementptr i8, ptr %17, i64 %19
  %22 = mul i32 %.0255729803502, %indvar
  %i.jo = add i32 %i.hk, %22
  %23 = sext i32 %i.jo to i64
  %24 = shl nsw i64 %23, 3                        ; 2 uses
  %scevgep4275 = getelementptr i8, ptr %scevgep, i64 %24 ; 2 uses
  %scevgep4279 = getelementptr i8, ptr %scevgep4281.a, i64 %24 ; 2 uses
  %i.jp = add i32 %i.hp, %indvar
  %i.jq = sext i32 %i.jp to i64
  %i.jr = shl nsw i64 %i.jq, 3                    ; 2 uses
  %scevgep4278 = getelementptr i8, ptr %scevgep4283.a, i64 %i.jr
  %scevgep4282 = getelementptr i8, ptr %scevgep4285.a, i64 %i.jr
  %25 = mul i32 %.0255729803502, %indvar
  %26 = add i32 %i.hd, %25                        ; 2 uses
  %27 = trunc i64 %indvars.iv3565 to i32
  %28 = mul i32 %.0255729803501, %27
  %i.js = add i32 %28, %i.bq                      ; 4 uses
  %29 = trunc i64 %indvars.iv3565 to i32
  %30 = sub i32 %29, %i.bk                        ; 2 uses
  %31 = add i32 %i.gq, %30
  %32 = sext i32 %31 to i64
  %33 = getelementptr inbounds [8 x i8], ptr %i.p, i64 %32 ; 4 uses
  %i.jt = add i32 %i.bv, %30
  %34 = sext i32 %i.jt to i64
  %35 = getelementptr inbounds [8 x i8], ptr %i.s, i64 %34 ; 4 uses
  %min.iters.check4376 = icmp ult i64 %i.jc, 8
  br i1 %min.iters.check4376, label %scalar.ph4383.preheader, label %vector.scevcheck4335

vector.scevcheck4335:                             ; preds = %bb.t
  %36 = mul i32 %.0255729803502, %indvar
  %37 = add i32 %i.id, %36                        ; 2 uses
  %i.ju = add i32 %37, %indvar
  %i.jv = icmp slt i32 %i.ju, %37
  %i.jw = add i32 %i.if, %indvar
  %i.jx = icmp slt i32 %i.jw, %i.if
  %i.jy = add i32 %i.ih, %indvar
...
vector.memcheck4337:                              ; preds = %vector.scevcheck4335
  ...
  %bound14371 = icmp ult ptr %scevgep4353.a, %i.jh
  ...
  %bound14375 = icmp ult ptr %scevgep4359, %i.jh
  ...
  %bound14379 = icmp ult ptr %i.gs, %i.jh
...
vector.ph4385:                                    ; preds = %vector.memcheck4337
  %n.vec4386 = and i64 %i.jc, -8                  ; 3 uses
  %i.kc = add i64 %n.vec4386, %15
  %i.kd = load double, ptr %33, align 8, !tbaa !9, !alias.scope !22
  ...
  %i.ke = load double, ptr %35, align 8, !tbaa !9, !alias.scope !25
...
scalar.ph4383.preheader:                          ; preds = %vector.memcheck4337, %vector.scevcheck4335, %bb.t, %middle.block4402
  %indvars.iv3555.ph = phi i64 [ %15, %vector.memcheck4337 ], [ %15, %vector.scevcheck4335 ], [ %15, %bb.t ], [ %i.kc, %middle.block4402 ] ; 5 uses
...
scalar.ph4383.prol:                               ; preds = %scalar.ph4383.preheader
  %i.lj = trunc i64 %indvars.iv3555.ph to i32
  %.reass2966.prol = add i32 %i.js, %i.lj
  ...
  %indvars.iv.next3556.prol = add i64 %indvars.iv3555.ph, 1
...
scalar.ph4383:                                    ; preds = %scalar.ph4383.prol.loopexit, %scalar.ph4383
  ...
  %i.mh = trunc i64 %indvars.iv3555 to i32
  %.reass2966 = add i32 %i.js, %i.mh
  ...
  %indvars.iv.next3556 = add i64 %indvars.iv3555, 1 ; 2 uses
  %i.ne = trunc i64 %indvars.iv.next3556 to i32
  %.reass2966.1 = add i32 %i.js, %i.ne
...
._crit_edge2964:                                  ; preds = %scalar.ph4383.prol.loopexit, %scalar.ph4383, %middle.block4402
  br i1 %.not26972969, label %._crit_edge2973, label %iter.check4319

iter.check4319:                                   ; preds = %._crit_edge2964
  %i.ob = trunc i64 %indvars.iv3565 to i32        ; 2 uses
...
vector.scevcheck4274:                             ; preds = %iter.check4319
  %i.of = add i32 %26, %i.iv
  %i.og = icmp slt i32 %i.of, %26
...
vector.memcheck4276:                              ; preds = %vector.scevcheck4274
  %bound0 = icmp ult ptr %scevgep4275, %scevgep4282
  %bound1 = icmp ult ptr %scevgep4278, %scevgep4279
  %found.conflict = and i1 %bound0, %bound1
  %bound04291 = icmp ult ptr %scevgep4275, %scevgep4290
  %bound14292 = icmp ult ptr %scevgep4288, %scevgep4279
...
._crit_edge2973:                                  ; preds = %vec.epilog.scalar.ph4320, %middle.block4315, %vec.epilog.middle.block4332, %._crit_edge2964
  ...
  %indvar.next4337 = add i64 %indvar4336, 1
...
.lr.ph3026:                                       ; preds = %._crit_edge3010
  ...
  %i.ast = sext i32 %i.bp to i64                  ; 7 uses
...
.lr.ph3014:                                       ; preds = %._crit_edge3022, %.lr.ph3026
  %indvar4700 = phi i32 [ %indvar.next4709, %._crit_edge3022 ], [ 0, %.lr.ph3026 ] ; 3 uses
  %indvars.iv3599 = phi i64 [ %indvars.iv.next3600, %._crit_edge3022 ], [ %i.ast, %.lr.ph3026 ] ; 9 uses
  %indvars.iv3592 = phi i32 [ %indvars.iv.next3593, %._crit_edge3022 ], [ %i.asv, %.lr.ph3026 ] ; 2 uses
...
.prol.loopexit4707:                               ; preds = %.prol.loopexit4707.unr-lcssa, %.lr.ph3014
  ...
  %i.aue = icmp eq i32 %indvar4700, 0
...
._crit_edge3015:                                  ; preds = %.lr.ph3014.new, %.prol.loopexit4707
...
._crit_edge3022:                                  ; preds = %bb.bp, %._crit_edge3015
  ...
  %indvar.next4709 = add i32 %indvar4700, 1
  br i1 %exitcond3603.not, label %._crit_edge3027, label %.lr.ph3014, !llvm.loop !77
...
.outer.us.preheader:                              ; preds = %.loopexit2888
  ...
  %i.bvg = add i32 %i.n, -1
  %scevgep4523.a = getelementptr i8, ptr %5, i64 %i.be
  %scevgep4527 = getelementptr i8, ptr %7, i64 %i.bg
  %scevgep4529 = getelementptr i8, ptr %7, i64 %13
  %scevgep4531 = getelementptr i8, ptr %5, i64 %i.be
  %scevgep4585.a = getelementptr i8, ptr %5, i64 %i.be
  %scevgep4587.a = getelementptr i8, ptr %5, i64 %i.bf
  %scevgep4590.a = getelementptr i8, ptr %7, i64 %i.bg
  %scevgep4592.a = getelementptr i8, ptr %7, i64 %13
  %scevgep4594.a = getelementptr i8, ptr %7, i64 %13
  %scevgep4596 = getelementptr i8, ptr %5, i64 %i.be
  %scevgep4598 = getelementptr i8, ptr %5, i64 %i.bf
  %scevgep4600 = getelementptr i8, ptr %5, i64 %i.bf
  %i.bvh = getelementptr i8, ptr %5, i64 %i.be
