...
bb.ca:                                            ; preds = %._crit_edge3878, %bb.by, %bb.bz
  %i.bcp = phi i32 [ %.pre3882, %._crit_edge3878 ], [ %i.bal, %bb.by ], [ %i.bbo, %bb.bz ] ; 6 uses
  %i.bcq = phi i32 [ %.pre3881, %._crit_edge3878 ], [ %i.bao, %bb.by ], [ %i.bbn, %bb.bz ] ; 4 uses
  %i.bcr = phi i32 [ %.pre3879, %._crit_edge3878 ], [ %.pre3880, %bb.by ], [ %i.bbz, %bb.bz ] ; 9 uses
  %i.bcs = sub nsw i64 %indvars.iv3645, %i.baj    ; 2 uses
  %i.bct = trunc i64 %i.bcs to i32
  %i.bcu = add i32 %i.bct, 2
  %i.bcv = trunc i64 %indvars.iv3645 to i32
