...
bb.q:                                             ; preds = %bb.p, %bb.o
  ...
  %scevgep4283.a = getelementptr i8, ptr %7, i64 %13
  %i.bh = add i32 %i.ab, 1
  %scevgep4285.a = getelementptr i8, ptr %5, i64 %i.be
  %scevgep4287 = getelementptr i8, ptr %5, i64 %i.bf
  %i.bi = add i32 %i.ab, 1
  %scevgep4336.a = getelementptr i8, ptr %5, i64 %i.be
  %scevgep4339.a = getelementptr i8, ptr %7, i64 %13
  %14 = add i32 %i.ab, 1
  %scevgep4340 = getelementptr i8, ptr %7, i64 %i.bg
  %scevgep4341.a = getelementptr i8, ptr %5, i64 %i.bf
  %scevgep4345 = getelementptr i8, ptr %5, i64 %i.be
  %scevgep4343 = getelementptr i8, ptr %5, i64 %i.bf
  %scevgep4345.a = getelementptr i8, ptr %5, i64 %i.bf
  %scevgep4348 = getelementptr i8, ptr %7, i64 %i.bg
  %scevgep4350 = getelementptr i8, ptr %scevgep4348, i64 8
  %scevgep4352 = getelementptr i8, ptr %5, i64 %i.be
  %scevgep4355 = getelementptr i8, ptr %scevgep4352, i64 8
  br label %.outer2886

.outer2886:                                       ; preds = %.loopexit2884, %bb.q
  %.pre3787.a = phi i32 [ %.pre3787.pre, %.loopexit2884 ], [ %i.aw, %bb.q ] ; 6 uses
  %i.bj = phi i32 [ %i.bvf, %.loopexit2884 ], [ %i.av, %bb.q ] ; 5 uses
...
.lr.ph2983:                                       ; preds = %._crit_edge2959
  ...
  %scevgep4346.a = getelementptr i8, ptr %scevgep4340, i64 %i.ip
  %i.iq = add i32 %i.bq, %i.gp
  %i.ir = sub i32 %i.iq, %i.bm                    ; 2 uses
  %i.is = sext i32 %i.ir to i64
  %i.it = shl nsw i64 %i.is, 3                    ; 2 uses
  %scevgep4353 = getelementptr i8, ptr %scevgep4345, i64 %i.it
  %i.iu = shl nsw i64 %i.gr, 3
  %scevgep4356 = getelementptr i8, ptr %scevgep4343, i64 %i.iu
  %16 = getelementptr i8, ptr %scevgep4350, i64 %i.ip
  %17 = getelementptr i8, ptr %scevgep4355, i64 %i.it
...
bb.t:                                             ; preds = %._crit_edge2973, %.lr.ph2983
  %indvar4334 = phi i64 [ %indvar.next4335, %._crit_edge2973 ], [ 0, %.lr.ph2983 ] ; 6 uses
  ...
  %18 = trunc i64 %indvar4334 to i32
  %i.jb = add i32 %i.bp, %18
  %i.jc = add i64 %indvar4334, 1                  ; 3 uses
  %i.jd = mul i32 %.0255729803502, %indvar
  %i.je = add i32 %i.il, %i.jd
  %i.jf = sext i32 %i.je to i64
  %19 = shl nsw i64 %i.jf, 3                      ; 2 uses
  %scevgep4333 = getelementptr i8, ptr %scevgep4336.a, i64 %19 ; 5 uses
  %i.jg = shl nuw nsw i64 %indvar4334, 3          ; 3 uses
  %scevgep4336 = getelementptr i8, ptr %scevgep4345.a, i64 %i.jg
  %scevgep4338 = getelementptr i8, ptr %scevgep4336, i64 %19 ; 5 uses
  %20 = trunc i64 %indvar4334 to i32
  %i.jh = add i32 %i.in, %20
  %21 = sext i32 %i.jh to i64
  %i.ji = shl nsw i64 %21, 3
  %i.jj = getelementptr i8, ptr %scevgep4339.a, i64 %i.ji
  %scevgep4340.a = getelementptr i8, ptr %16, i64 %i.jg
  %22 = trunc i64 %indvar4334 to i32
  %i.jk = add i32 %i.ir, %22
  %i.jl = sext i32 %i.jk to i64
  %i.jm = shl nsw i64 %i.jl, 3
  %scevgep4342 = getelementptr i8, ptr %scevgep4341.a, i64 %i.jm
  %scevgep4347 = getelementptr i8, ptr %17, i64 %i.jg
  %23 = mul i32 %.0255729803502, %indvar
  %i.jn = add i32 %i.hk, %23
  %i.jo = sext i32 %i.jn to i64
  %i.jp = shl nsw i64 %i.jo, 3                    ; 2 uses
  %scevgep4349 = getelementptr i8, ptr %scevgep, i64 %i.jp ; 2 uses
  %scevgep4354 = getelementptr i8, ptr %scevgep4281.a, i64 %i.jp ; 2 uses
  %i.jq = add i32 %i.hp, %indvar
  %24 = sext i32 %i.jq to i64
  %25 = shl nsw i64 %24, 3
  %scevgep4281 = getelementptr i8, ptr %scevgep4283.a, i64 %25
  %i.jr = mul i32 %.0255729803502, %indvar
  %i.js = add i32 %i.hd, %i.jr                    ; 2 uses
  %26 = trunc i64 %indvars.iv3565 to i32
  %27 = mul i32 %.0255729803501, %26
  %invariant.op2965 = add i32 %27, %i.bq          ; 4 uses
  %28 = trunc i64 %indvars.iv3565 to i32
  %29 = sub i32 %28, %i.bk                        ; 2 uses
  %i.jt = add i32 %i.gq, %29
  %i.ju = sext i32 %i.jt to i64
  %30 = getelementptr inbounds [8 x i8], ptr %i.p, i64 %i.ju ; 5 uses
  %31 = add i32 %i.bv, %29
  %32 = sext i32 %31 to i64
  %33 = getelementptr inbounds [8 x i8], ptr %i.s, i64 %32 ; 5 uses
  %min.iters.check4370 = icmp ult i64 %i.jc, 8
  br i1 %min.iters.check4370, label %scalar.ph4377.preheader, label %vector.scevcheck4333

vector.scevcheck4333:                             ; preds = %bb.t
  %34 = mul i32 %.0255729803502, %indvar
  %35 = add i32 %i.id, %34                        ; 2 uses
  %i.jv = add i32 %35, %indvar
  %i.jw = icmp slt i32 %i.jv, %35
  %i.jx = add i32 %i.if, %indvar
  %i.jy = icmp slt i32 %i.jx, %i.if
  %i.jz = add i32 %i.ih, %indvar
...
vector.memcheck4335:                              ; preds = %vector.scevcheck4333
  %bound04357.a = icmp ult ptr %scevgep4333, %i.jj
  %bound14358.a = icmp ult ptr %33, %scevgep4338
  %found.conflict4359.a = and i1 %bound04357.a, %bound14358.a
  %bound04360 = icmp ult ptr %scevgep4333, %scevgep4340.a
  %bound14361 = icmp ult ptr %scevgep4346.a, %scevgep4338
  %found.conflict4362 = and i1 %bound04360, %bound14361
  %conflict.rdx4363 = or i1 %found.conflict4359.a, %found.conflict4362
  %bound04364 = icmp ult ptr %scevgep4333, %scevgep4342
  %bound14365 = icmp ult ptr %30, %scevgep4338
  %found.conflict4366 = and i1 %bound04364, %bound14365
  %conflict.rdx4367 = or i1 %conflict.rdx4363, %found.conflict4366
  %bound04368 = icmp ult ptr %scevgep4333, %scevgep4347
  %bound14369 = icmp ult ptr %scevgep4353, %scevgep4338
  %found.conflict4370 = and i1 %bound04368, %bound14369
  %conflict.rdx4371 = or i1 %conflict.rdx4367, %found.conflict4370
  %bound04372 = icmp ult ptr %scevgep4333, %scevgep4356
  %bound14373 = icmp ult ptr %i.gs, %scevgep4338
...
vector.ph4379:                                    ; preds = %vector.memcheck4335
  %n.vec4380 = and i64 %i.jc, -8                  ; 3 uses
  %i.kd = add i64 %n.vec4380, %15
  %i.ke = load double, ptr %30, align 8, !tbaa !9, !alias.scope !22
  ...
  %i.kf = load double, ptr %33, align 8, !tbaa !9, !alias.scope !25
...
scalar.ph4377.preheader:                          ; preds = %vector.memcheck4335, %vector.scevcheck4333, %bb.t, %middle.block4396
  %indvars.iv3555.ph = phi i64 [ %15, %vector.memcheck4335 ], [ %15, %vector.scevcheck4333 ], [ %15, %bb.t ], [ %i.kd, %middle.block4396 ] ; 5 uses
...
scalar.ph4377.prol:                               ; preds = %scalar.ph4377.preheader
  %i.lk = trunc i64 %indvars.iv3555.ph to i32
...
scalar.ph4377:                                    ; preds = %scalar.ph4377.prol.loopexit, %scalar.ph4377
  ...
  %i.mi = trunc i64 %indvars.iv3555 to i32
  ...
  %i.nf = trunc i64 %indvars.iv.next3556 to i32
...
iter.check4317:                                   ; preds = %._crit_edge2964
  %i.oc = trunc i64 %indvars.iv3565 to i32        ; 2 uses
...
vector.scevcheck4274:                             ; preds = %iter.check4317
  %i.og = add i32 %i.js, %i.iv
  %i.oh = icmp slt i32 %i.og, %i.js
...
vector.memcheck4276:                              ; preds = %vector.scevcheck4274
  %bound0 = icmp ult ptr %scevgep4349, %scevgep4281
  %bound1 = icmp ult ptr %i.oe, %scevgep4354
  %found.conflict = and i1 %bound0, %bound1
  %bound04289 = icmp ult ptr %scevgep4349, %scevgep4288
  %bound14290 = icmp ult ptr %scevgep4286, %scevgep4354
...
._crit_edge2973:                                  ; preds = %vec.epilog.scalar.ph4318, %middle.block4313, %vec.epilog.middle.block4330, %._crit_edge2964
  ...
  %indvar.next4335 = add i64 %indvar4334, 1
...
.lr.ph3026:                                       ; preds = %._crit_edge3010
  ...
  %i.asu = sext i32 %i.bp to i64                  ; 7 uses
...
.lr.ph3014:                                       ; preds = %._crit_edge3022, %.lr.ph3026
  %indvar4692 = phi i32 [ %indvar.next4701, %._crit_edge3022 ], [ 0, %.lr.ph3026 ] ; 3 uses
  %indvars.iv3599 = phi i64 [ %indvars.iv.next3600, %._crit_edge3022 ], [ %i.asu, %.lr.ph3026 ] ; 9 uses
  %indvars.iv3592 = phi i32 [ %indvars.iv.next3593, %._crit_edge3022 ], [ %i.asw, %.lr.ph3026 ] ; 2 uses
...
.prol.loopexit4699:                               ; preds = %.prol.loopexit4699.unr-lcssa, %.lr.ph3014
  ...
  %i.auf = icmp eq i32 %indvar4692, 0
...
._crit_edge3015:                                  ; preds = %.lr.ph3014.new, %.prol.loopexit4699
...
._crit_edge3022:                                  ; preds = %bb.bp, %._crit_edge3015
  ...
  %indvar.next4701 = add i32 %indvar4692, 1
...
.outer.us.preheader:                              ; preds = %.loopexit2888
  ...
  %i.bvh = add i32 %i.n, -1
  %scevgep4517.a = getelementptr i8, ptr %5, i64 %i.be
  %scevgep4521 = getelementptr i8, ptr %7, i64 %13
  ...
  %scevgep4584.a = getelementptr i8, ptr %7, i64 %13
  %scevgep4586.a = getelementptr i8, ptr %7, i64 %13
  ...
  %i.bvi = getelementptr i8, ptr %5, i64 %i.be
