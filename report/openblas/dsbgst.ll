...
vec.epilog.scalar.ph4557:                         ; preds = %vec.epilog.scalar.ph4557.preheader, %vec.epilog.scalar.ph4557
  ...
  %.not2728.not.us = icmp slt i64 %indvars.iv.next3738, %i.dct
...
iter.check4556:                                   ; preds = %.loopexit
  ...
  %i.dbb = getelementptr inbounds [8 x i8], ptr %i.s, i64 %i.dba ; 4 uses
...
vec.epilog.scalar.ph4557.preheader:               ; preds = %vector.memcheck4516, %vector.scevcheck4513, %iter.check4556, %vec.epilog.iter.check4558, %vec.epilog.middle.block4569
  %indvars.iv3737.ph = phi i64 [ %i.dcs, %iter.check4556 ], [ %i.dcs, %vector.scevcheck4513 ], [ %i.dcs, %vector.memcheck4516 ], [ %i.ddz, %vec.epilog.iter.check4558 ], [ %i.dea, %vec.epilog.middle.block4569 ]
...
.lr.ph3396.us:                                    ; preds = %._crit_edge3378.us
  ...
  %i.dcq = add i32 %reass.sub3514, 1              ; 3 uses
  %i.dcr = sext i32 %i.bzv to i64                 ; 4 uses
  %i.dcs = sext i32 %i.bzu to i64                 ; 14 uses
  %i.dct = sext i32 %i.byy to i64                 ; 5 uses
...
vector.body4503:                                  ; preds = %vector.body4503, %vector.ph4501
  ...
  br i1 %i.dhc, label %middle.block4510, label %vector.body4503, !llvm.loop !149
...
scalar.ph4499.prol:                               ; preds = %scalar.ph4499.preheader, %scalar.ph4499.prol
  ...
  br i1 %prol.iter4737.cmp.not, label %scalar.ph4499.prol.loopexit, label %scalar.ph4499.prol, !llvm.loop !150
...
vector.body4465:                                  ; preds = %vector.body4465, %vector.ph4461
  ...
  br i1 %i.djf, label %middle.block4472, label %vector.body4465, !llvm.loop !151
...
vec.epilog.vector.body4484:                       ; preds = %vec.epilog.vector.body4484, %vec.epilog.ph4480
  ...
  br i1 %i.djl, label %vec.epilog.middle.block4488, label %vec.epilog.vector.body4484, !llvm.loop !152
...
vec.epilog.scalar.ph4477.prol:                    ; preds = %vec.epilog.scalar.ph4477.preheader, %vec.epilog.scalar.ph4477.prol
  ...
  br i1 %prol.iter4706.cmp.not, label %vec.epilog.scalar.ph4477.prol.loopexit, label %vec.epilog.scalar.ph4477.prol, !llvm.loop !153
...
.prol.preheader4707:                              ; preds = %.lr.ph3233, %.prol.preheader4707
  ...
  br i1 %prol.iter4711.cmp.not, label %.prol.loopexit4708, label %.prol.preheader4707, !llvm.loop !155
...
.lr.ph3245.new:                                   ; preds = %.prol.loopexit4720, %.lr.ph3245.new
  ...
  %.not2755.not.1 = icmp slt i64 %indvars.iv.next3679.1, %i.dnk
...
bb.hc:                                            ; preds = %.lr.ph3308, %bb.hb
  ...
  br i1 %i.ega, label %.lr.ph3308, label %._crit_edge3309, !llvm.loop !167
...
bb.hh:                                            ; preds = %._crit_edge3324, %bb.hg, %bb.hf
  ...
  br i1 %i.eis, label %bb.gx, label %._crit_edge3334, !llvm.loop !170
...
.loopexit2873:                                    ; preds = %.lr.ph3351, %bb.ho, %._crit_edge3347
  ...
  br i1 %i.eod, label %bb.hi, label %._crit_edge3355, !llvm.loop !174
...
bb.hs:                                            ; preds = %bb.hq, %bb.hr
  ...
  br i1 %i.epr, label %bb.hq, label %._crit_edge3359.loopexit, !llvm.loop !175
...
vector.body4446:                                  ; preds = %vector.body4446, %vector.ph4444
  ...
  br i1 %i.eqy, label %middle.block4453, label %vector.body4446, !llvm.loop !177
...
scalar.ph4442.prol:                               ; preds = %scalar.ph4442.preheader, %scalar.ph4442.prol
  ...
  br i1 %prol.iter4726.cmp.not, label %scalar.ph4442.prol.loopexit, label %scalar.ph4442.prol, !llvm.loop !178
