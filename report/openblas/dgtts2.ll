...
.preheader355:                                    ; preds = %bb.d
  ...
  %11 = icmp ne i32 %i.v, 0                       ; 2 uses
  %umin488 = zext i1 %11 to i64
  %12 = add nsw i64 %umin488, %i.y
  %13 = add nsw i64 %12, %i.g
  %14 = shl nsw i64 %13, 3
  %scevgep = getelementptr i8, ptr %8, i64 %14    ; 5 uses
  ...
  %15 = getelementptr i8, ptr %8, i64 %i.am
  %i.ap = getelementptr i8, ptr %15, i64 %i.an
  %i.aq = getelementptr i8, ptr %i.ap, i64 %i.ao
  %scevgep489.a = getelementptr i8, ptr %i.aq, i64 8 ; 5 uses
  %16 = select i1 %11, i64 8, i64 0               ; 2 uses
  %17 = add nsw i64 %16, -8                       ; 3 uses
  %scevgep490.a = getelementptr i8, ptr %5, i64 %17
  %scevgep491.a = getelementptr i8, ptr %5, i64 %i.ao
  %i.ar = add nsw i64 %16, %i.an
  ...
  %scevgep494 = getelementptr i8, ptr %8, i64 %i.az
  %scevgep496.a = getelementptr i8, ptr %6, i64 %17
  ...
  %scevgep500 = getelementptr i8, ptr %8, i64 %i.az
  %scevgep502 = getelementptr i8, ptr %4, i64 %17
  ...
  %18 = icmp ne i32 %i.v, 0
  %.neg = sext i1 %18 to i64
  %19 = add nsw i64 %i.x, 1
  %20 = add nsw i64 %19, %.neg                    ; 3 uses
  ...
  %bound1 = icmp ult ptr %scevgep490.a, %scevgep489.a
  ...
  %bound1509 = icmp ult ptr %scevgep496.a, %scevgep489.a
...
.lr.ph393:                                        ; preds = %bb.f
  ...
  %i.fj = zext i32 %i.cb to i64                   ; 9 uses
  %i.fk = sext i32 %i.f to i64
  %invariant.gep483 = getelementptr [8 x i8], ptr %i.h, i64 %i.fk ; 2 uses
  %22 = icmp ne i32 %i.cb, 0
  %.neg679 = sext i1 %22 to i64
  %23 = add nuw nsw i64 %i.fj, 1
  %24 = add nsw i64 %23, %.neg679                 ; 3 uses
  %min.iters.check651 = icmp ult i64 %24, 32
  br i1 %min.iters.check651, label %scalar.ph650.preheader, label %vector.scevcheck614

vector.scevcheck614:                              ; preds = %.lr.ph393
  %25 = icmp ne i32 %i.cb, 0
  %umin615.neg = sext i1 %25 to i64
  %i.fl = add nsw i64 %umin615.neg, %i.fj         ; 2 uses
...
vector.memcheck617:                               ; preds = %vector.scevcheck614
  %26 = icmp ne i32 %i.cb, 0                      ; 2 uses
  %umin618 = zext i1 %26 to i64
  %27 = add nsw i64 %umin618, %i.ch
  %28 = add nsw i64 %27, %i.g
  %i.fx = shl nsw i64 %28, 3
  %scevgep619.a = getelementptr i8, ptr %8, i64 %i.fx ; 5 uses
  %29 = shl nsw i64 %i.g, 3                       ; 4 uses
  %i.fy = or i64 %i.ch, %i.g
  %i.fz = shl nuw nsw i64 %i.fj, 3                ; 5 uses
  %i.ga = add nsw i64 %i.fy, %i.fj
  %i.gb = shl nsw i64 %i.ga, 3
  %30 = getelementptr i8, ptr %8, i64 %i.gb
  %scevgep620.a = getelementptr i8, ptr %30, i64 8 ; 5 uses
  %31 = select i1 %26, i64 8, i64 0               ; 3 uses
  %32 = add nsw i64 %31, -8                       ; 3 uses
  %scevgep621.a = getelementptr i8, ptr %5, i64 %32
  %scevgep622 = getelementptr i8, ptr %5, i64 %i.fz
  %i.gc = add i32 %i.f, %i.i
  %i.gd = add i32 %i.gc, -1
  %i.ge = sext i32 %i.gd to i64
  %33 = shl nsw i64 %i.ge, 3                      ; 2 uses
  %34 = add nsw i64 %31, %33
  %i.gf = add nsw i64 %34, %29
  %i.gg = sub nsw i64 %i.gf, %i.fz
  %scevgep623 = getelementptr i8, ptr %8, i64 %i.gg
  %35 = getelementptr i8, ptr %8, i64 %33
  %36 = getelementptr i8, ptr %35, i64 %29
  %scevgep624 = getelementptr i8, ptr %36, i64 8
  %scevgep625 = getelementptr i8, ptr %6, i64 %32
  %scevgep626 = getelementptr i8, ptr %6, i64 %i.fz
  %i.gh = add i32 %i.f, %i.i
  %i.gi = sext i32 %i.gh to i64
  %37 = shl nsw i64 %i.gi, 3                      ; 2 uses
  %38 = add nsw i64 %31, %37
  %i.gj = add nsw i64 %38, %29
  %i.gk = sub nsw i64 %i.gj, %i.fz
  %scevgep627 = getelementptr i8, ptr %8, i64 %i.gk
  %39 = getelementptr i8, ptr %8, i64 %37
  %40 = getelementptr i8, ptr %39, i64 %29
  %scevgep628 = getelementptr i8, ptr %40, i64 8
  %scevgep629 = getelementptr i8, ptr %4, i64 %32
  %scevgep630 = getelementptr i8, ptr %4, i64 %i.fz
  %bound0631 = icmp ult ptr %scevgep619.a, %scevgep622
  %bound1632 = icmp ult ptr %scevgep621.a, %scevgep620.a
  %found.conflict633 = and i1 %bound0631, %bound1632
  %bound0634 = icmp ult ptr %scevgep619.a, %scevgep624
  ...
  %bound0638 = icmp ult ptr %scevgep619.a, %scevgep626
  ...
  %bound0642 = icmp ult ptr %scevgep619.a, %scevgep628
  ...
  %bound0646 = icmp ult ptr %scevgep619.a, %scevgep630
...
vector.ph652:                                     ; preds = %vector.memcheck617
  %n.vec653 = and i64 %24, -4                     ; 3 uses
  %41 = sub nsw i64 %i.fj, %n.vec653
...
middle.block670:                                  ; preds = %vector.body654
  %cmp.n671 = icmp eq i64 %24, %n.vec653
...
scalar.ph650.preheader:                           ; preds = %vector.memcheck617, %vector.scevcheck614, %.lr.ph393, %middle.block670
  %indvars.iv431.ph = phi i64 [ %i.fj, %vector.memcheck617 ], [ %i.fj, %vector.scevcheck614 ], [ %i.fj, %.lr.ph393 ], [ %41, %middle.block670 ]
...
vector.memcheck:                                  ; preds = %vector.scevcheck
  ...
  %bound1505 = icmp ult ptr %scevgep493.a, %scevgep489.a
  ...
  %bound1514 = icmp ult ptr %scevgep499, %scevgep489.a
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %vector.scevcheck, %.lr.ph383, %middle.block
  %indvars.iv418.ph = phi i64 [ %i.x, %vector.memcheck ], [ %i.x, %vector.scevcheck ], [ %i.x, %.lr.ph383 ], [ %21, %middle.block ]
  br label %scalar.ph
