...
.lr.ph81:                                         ; preds = %bb.b
  ...
  %7 = shl nsw i64 %i.k, 3                        ; 2 uses
  %i.m = shl nsw i64 %i.e, 3                      ; 2 uses
  %i.n = shl nsw i64 %i.k, 3
  %8 = shl nsw i64 %i.j, 3                        ; 2 uses
  %i.o = shl nsw i64 %i.b, 3                      ; 2 uses
  %i.p = shl nsw i64 %i.j, 3
  %9 = getelementptr i8, ptr %5, i64 %7
  %10 = getelementptr i8, ptr %9, i64 %i.m
  %11 = getelementptr i8, ptr %10, i64 8
  %12 = getelementptr i8, ptr %5, i64 %7
  %i.q = getelementptr i8, ptr %12, i64 %i.m
...
bb.c:                                             ; preds = %.lr.ph81, %._crit_edge
  ...
  %scevgep = getelementptr i8, ptr %11, i64 %i.ad
  %scevgep152 = getelementptr i8, ptr %i.q, i64 %i.ad
  ...
  %scevgep155 = getelementptr i8, ptr %i.t, i64 %i.ai
