...
.preheader.lr.ph:                                 ; preds = %bb.l
  ...
  %i.bb = getelementptr i8, ptr %11, i64 %i.aw
  %i.bc = getelementptr i8, ptr %i.bb, i64 16
  %i.bd = getelementptr i8, ptr %11, i64 %i.aw
  %i.be = getelementptr i8, ptr %13, i64 %i.az
  %i.bf = getelementptr i8, ptr %i.be, i64 8
  %i.bg = getelementptr i8, ptr %11, i64 %i.ar
  %i.bh = getelementptr i8, ptr %i.bg, i64 16
  %i.bi = getelementptr i8, ptr %11, i64 %i.ar
...
.preheader:                                       ; preds = %.preheader.lr.ph, %._crit_edge521.thread
  ...
  %scevgep786 = getelementptr i8, ptr %i.bc, i64 %i.bl
  %scevgep787 = getelementptr i8, ptr %i.bd, i64 %i.bl
  %i.bm = mul i64 %i.ba, %indvar
  %scevgep791 = getelementptr i8, ptr %i.bf, i64 %i.bm ; 2 uses
  %i.bn = mul i64 %i.as, %indvar                  ; 2 uses
  %scevgep737 = getelementptr i8, ptr %i.bh, i64 %i.bn
