...
.lr.ph1610:                                       ; preds = %.lr.ph1610.preheader, %.lr.ph1610._crit_edge
  ...
  %indvars.iv1776 = phi i64 [ %i.bmi, %.lr.ph1610.preheader ], [ %.pre1889, %.lr.ph1610._crit_edge ] ; 29 uses
  ...
  %indvars1778 = trunc i64 %indvars.iv1776 to i32 ; 3 uses
...
bb.eb:                                            ; preds = %bb.ea, %.thread1454
  ...
  %15 = trunc i64 %indvars.iv1776 to i32
  %i.bnv = add i32 %15, -2                        ; 2 uses
...
bb.eg:                                            ; preds = %bb.ef, %bb.ee
  ...
  %16 = trunc nsw i64 %indvars.iv1776 to i32
  %i.bsp = add i32 %16, -2                        ; 4 uses
