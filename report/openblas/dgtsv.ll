...
.preheader:                                       ; preds = %bb.ae
  ...
  %i.nh = add nsw i64 %i.nf, -1                   ; 4 uses
  ...
  %scevgep732.a = getelementptr i8, ptr %10, i64 8 ; 10 uses
  ...
  %i.nw = shl i64 %i.nv, 3
  %scevgep733.a = getelementptr i8, ptr %5, i64 %i.nw
  %scevgep734.a = getelementptr i8, ptr %scevgep733.a, i64 8 ; 10 uses
  %scevgep735.a = getelementptr i8, ptr %4, i64 %i.nu ; 2 uses
  %i.nx = add nsw i64 %i.ns, 8
  ...
  %scevgep740 = getelementptr i8, ptr %5, i64 %i.of ; 2 uses
  ...
  %scevgep746 = getelementptr i8, ptr %5, i64 %i.of ; 2 uses
  ...
  %scevgep739 = getelementptr i8, ptr %scevgep740, i64 %i.oj
  %i.ok = sext i35 %i.oi to i64                   ; 2 uses
  %scevgep743 = getelementptr i8, ptr %scevgep742, i64 %i.ok
  %scevgep745 = getelementptr i8, ptr %scevgep746, i64 %i.ok
...
vector.memcheck730:                               ; preds = %vector.scevcheck723
  ...
  %bound1758 = icmp ult ptr %2, %scevgep734.a
  ...
  %bound1763 = icmp ult ptr %scevgep743, %scevgep734.a
  ...
  %bound1768 = icmp ult ptr %3, %scevgep734.a
...
vector.ph774:                                     ; preds = %vector.memcheck730
  %n.vec775 = and i64 %i.nf, 8589934588           ; 2 uses
  %11 = and i64 %i.nf, 3
...
vector.memcheck730.1:                             ; preds = %vector.scevcheck723.1
  ...
  %bound1758.1 = icmp ult ptr %2, %scevgep734.a
  ...
  %bound1763.1 = icmp ult ptr %scevgep743.1, %scevgep734.a
  ...
  %bound1768.1 = icmp ult ptr %3, %scevgep734.a
...
vector.ph774.1:                                   ; preds = %vector.memcheck730.1
  %n.vec775.1 = and i64 %i.nf, 8589934588         ; 2 uses
  %12 = and i64 %i.nf, 3
...
scalar.ph772.preheader.1:                         ; preds = %middle.block792.1, %vector.memcheck730.1, %vector.scevcheck723.1, %.lr.ph516.1
  %indvars.iv556.ph.1 = phi i64 [ %i.nf, %vector.memcheck730.1 ], [ %i.nf, %vector.scevcheck723.1 ], [ %i.nf, %.lr.ph516.1 ], [ %12, %middle.block792.1 ]
...
bb.ai:                                            ; preds = %bb.ae
  ...
  %i.tw = add nsw i32 %i.h, -2                    ; 4 uses
  %i.tx = icmp samesign ugt i32 %i.h, 2
  %i.ty = sext i32 %i.tw to i64                   ; 9 uses
  ...
  %i.ub = add nsw i64 %i.ty, -1                   ; 2 uses
  ...
  %scevgep663.a = getelementptr i8, ptr %15, i64 8 ; 5 uses
  ...
  %i.up = getelementptr i8, ptr %5, i64 %i.um
  %i.uq = getelementptr i8, ptr %i.up, i64 %i.un
  %scevgep664.a = getelementptr i8, ptr %i.uq, i64 %i.uo
  %scevgep665.a = getelementptr i8, ptr %scevgep664.a, i64 8 ; 5 uses
  %scevgep666.a = getelementptr i8, ptr %4, i64 %i.uo
  %i.ur = add nsw i64 %i.un, 8
  ...
  %scevgep671.a = getelementptr i8, ptr %5, i64 %i.uz
  ...
  %scevgep677 = getelementptr i8, ptr %5, i64 %i.uz
  %scevgep678 = getelementptr i8, ptr %3, i64 %i.uo
  %min.iters.check702 = icmp ult i32 %i.tw, 16
  ...
  %bound1680 = icmp ult ptr %4, %scevgep665.a
  ...
  %bound1687 = icmp ult ptr %2, %scevgep665.a
  ...
  %bound1697 = icmp ult ptr %3, %scevgep665.a
  %found.conflict698 = and i1 %bound0696, %bound1697
  %n.vec704 = and i64 %i.ty, 8589934588           ; 2 uses
  %16 = and i64 %i.ty, 3
  %cmp.n721 = icmp eq i64 %n.vec704, %i.ty
  br label %bb.aj
...
vector.memcheck661:                               ; preds = %vector.scevcheck660
  ...
  %bound1683 = icmp ult ptr %scevgep668.a, %scevgep665.a
  ...
  %bound1692 = icmp ult ptr %scevgep674, %scevgep665.a
...
scalar.ph701.preheader:                           ; preds = %vector.memcheck661, %vector.scevcheck660, %.lr.ph511, %middle.block720
  %indvars.iv548.ph = phi i64 [ %i.ty, %vector.memcheck661 ], [ %i.ty, %vector.scevcheck660 ], [ %i.ty, %.lr.ph511 ], [ %16, %middle.block720 ]
