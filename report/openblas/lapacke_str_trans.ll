...
.preheader:                                       ; preds = %.preheader.preheader, %.loopexit
  ...
  %scevgep141 = getelementptr i8, ptr %scevgep139, i64 %i.al
  %i.am = mul i64 %i.ah, %indvar
  %scevgep142 = getelementptr i8, ptr %i.ai, i64 %i.am
  %scevgep143 = getelementptr i8, ptr %scevgep142, i64 %i.al
  %indvars.iv.next107 = add nuw nsw i64 %indvars.iv106, 1 ; 3 uses
  %i.an = add i64 %indvars.iv.next107, %.neg
  %i.ao = trunc nuw nsw i64 %i.an to i32
  %.79 = tail call i32 @llvm.smin.i32(i32 %i.ao, i32 %5)
  %i.ap = icmp sgt i32 %.79, 0
  br i1 %i.ap, label %iter.check162, label %.loopexit

iter.check162:                                    ; preds = %.preheader
  %smin = tail call i32 @llvm.smin.i32(i32 %5, i32 %indvars.iv102) ; 3 uses
  %i.aq = mul nsw i64 %indvars.iv106, %i.ae
  %wide.trip.count104 = zext i32 %smin to i64     ; 8 uses
  %invariant.gep117 = getelementptr [4 x i8], ptr %4, i64 %i.aq ; 12 uses
...
vector.ph150:                                     ; preds = %vector.main.loop.iter.check148
  %i.ar = and i64 %wide.trip.count104, 28
...
vector.body152:                                   ; preds = %vector.body152, %vector.ph150
  ...
  %i.as = getelementptr [4 x i8], ptr %invariant.gep117, i64 %index153 ; 4 uses
  %i.at = getelementptr i8, ptr %i.as, i64 32
  %i.au = getelementptr i8, ptr %i.as, i64 64
  %i.av = getelementptr i8, ptr %i.as, i64 96
  %wide.load154 = load <8 x float>, ptr %i.as, align 4, !tbaa !10, !alias.scope !12
  %wide.load155 = load <8 x float>, ptr %i.at, align 4, !tbaa !10, !alias.scope !12
  %wide.load156 = load <8 x float>, ptr %i.au, align 4, !tbaa !10, !alias.scope !12
  %wide.load157 = load <8 x float>, ptr %i.av, align 4, !tbaa !10, !alias.scope !12
  %i.aw = getelementptr [4 x i8], ptr %invariant.gep119, i64 %index153 ; 4 uses
  %i.ax = getelementptr i8, ptr %i.aw, i64 32
  %i.ay = getelementptr i8, ptr %i.aw, i64 64
  %i.az = getelementptr i8, ptr %i.aw, i64 96
  store <8 x float> %wide.load154, ptr %i.aw, align 4, !tbaa !10, !alias.scope !15, !noalias !12
  store <8 x float> %wide.load155, ptr %i.ax, align 4, !tbaa !10, !alias.scope !15, !noalias !12
  store <8 x float> %wide.load156, ptr %i.ay, align 4, !tbaa !10, !alias.scope !15, !noalias !12
  store <8 x float> %wide.load157, ptr %i.az, align 4, !tbaa !10, !alias.scope !15, !noalias !12
  %index.next158 = add nuw i64 %index153, 32      ; 2 uses
  %i.ba = icmp eq i64 %index.next158, %n.vec151
  br i1 %i.ba, label %middle.block159, label %vector.body152, !llvm.loop !17
...
vec.epilog.iter.check164:                         ; preds = %middle.block159
  %min.epilog.iters.check165 = icmp eq i64 %i.ar, 0
...
vec.epilog.vector.body168:                        ; preds = %vec.epilog.vector.body168, %vec.epilog.ph166
  ...
  %i.bb = getelementptr [4 x i8], ptr %invariant.gep117, i64 %index169
  %wide.load170 = load <4 x float>, ptr %i.bb, align 4, !tbaa !10, !alias.scope !12
  %i.bc = getelementptr [4 x i8], ptr %invariant.gep119, i64 %index169
  store <4 x float> %wide.load170, ptr %i.bc, align 4, !tbaa !10, !alias.scope !15, !noalias !12
  %index.next171 = add nuw i64 %index169, 4       ; 2 uses
  %i.bd = icmp eq i64 %index.next171, %n.vec167
  br i1 %i.bd, label %vec.epilog.middle.block172, label %vec.epilog.vector.body168, !llvm.loop !21
...
vec.epilog.scalar.ph163.preheader:                ; preds = %vector.memcheck138, %iter.check162, %vec.epilog.iter.check164, %vec.epilog.middle.block172
  ...
  %i.be = sub nsw i64 %wide.trip.count104, %indvars.iv99.ph
  %xtraiter177 = and i64 %i.be, 7                 ; 2 uses
...
vec.epilog.scalar.ph163.prol:                     ; preds = %vec.epilog.scalar.ph163.preheader, %vec.epilog.scalar.ph163.prol
  ...
  %i.bf = load float, ptr %gep118.prol, align 4, !tbaa !10
  %i.bg = mul nsw i64 %indvars.iv99.prol, %i.ac
  %gep120.prol = getelementptr [4 x i8], ptr %invariant.gep119, i64 %i.bg
  store float %i.bf, ptr %gep120.prol, align 4, !tbaa !10
...
vec.epilog.scalar.ph163.prol.loopexit:            ; preds = %vec.epilog.scalar.ph163.prol, %vec.epilog.scalar.ph163.preheader
  ...
  %i.bh = sub nsw i64 %indvars.iv99.ph, %wide.trip.count104
  %i.bi = icmp ugt i64 %i.bh, -8
  br i1 %i.bi, label %.loopexit, label %vec.epilog.scalar.ph163
...
vec.epilog.scalar.ph163:                          ; preds = %vec.epilog.scalar.ph163.prol.loopexit, %vec.epilog.scalar.ph163
  ...
  %i.bj = load float, ptr %gep118, align 4, !tbaa !10
  %i.bk = mul nsw i64 %indvars.iv99, %i.ac
  %gep120 = getelementptr [4 x i8], ptr %invariant.gep119, i64 %i.bk
  store float %i.bj, ptr %gep120, align 4, !tbaa !10
  %indvars.iv.next100 = add nuw nsw i64 %indvars.iv99, 1 ; 2 uses
  %gep118.1 = getelementptr [4 x i8], ptr %invariant.gep117, i64 %indvars.iv.next100
  %i.bl = load float, ptr %gep118.1, align 4, !tbaa !10
  %i.bm = mul nsw i64 %indvars.iv.next100, %i.ac
  %gep120.1 = getelementptr [4 x i8], ptr %invariant.gep119, i64 %i.bm
  store float %i.bl, ptr %gep120.1, align 4, !tbaa !10
  ...
  %i.bn = load float, ptr %gep118.2, align 4, !tbaa !10
  %i.bo = mul nsw i64 %indvars.iv.next100.1, %i.ac
  %gep120.2 = getelementptr [4 x i8], ptr %invariant.gep119, i64 %i.bo
  store float %i.bn, ptr %gep120.2, align 4, !tbaa !10
  ...
  %i.bp = load float, ptr %gep118.3, align 4, !tbaa !10
  %i.bq = mul nsw i64 %indvars.iv.next100.2, %i.ac
  %gep120.3 = getelementptr [4 x i8], ptr %invariant.gep119, i64 %i.bq
  store float %i.bp, ptr %gep120.3, align 4, !tbaa !10
  ...
  %i.br = load float, ptr %gep118.4, align 4, !tbaa !10
  %i.bs = mul nsw i64 %indvars.iv.next100.3, %i.ac
  %gep120.4 = getelementptr [4 x i8], ptr %invariant.gep119, i64 %i.bs
  store float %i.br, ptr %gep120.4, align 4, !tbaa !10
  ...
  %i.bt = load float, ptr %gep118.5, align 4, !tbaa !10
  %i.bu = mul nsw i64 %indvars.iv.next100.4, %i.ac
  %gep120.5 = getelementptr [4 x i8], ptr %invariant.gep119, i64 %i.bu
  store float %i.bt, ptr %gep120.5, align 4, !tbaa !10
  ...
  %i.bv = load float, ptr %gep118.6, align 4, !tbaa !10
  %i.bw = mul nsw i64 %indvars.iv.next100.5, %i.ac
  %gep120.6 = getelementptr [4 x i8], ptr %invariant.gep119, i64 %i.bw
  store float %i.bv, ptr %gep120.6, align 4, !tbaa !10
  ...
  %i.bx = load float, ptr %gep118.7, align 4, !tbaa !10
  %i.by = mul nsw i64 %indvars.iv.next100.6, %i.ac
  %gep120.7 = getelementptr [4 x i8], ptr %invariant.gep119, i64 %i.by
  store float %i.bx, ptr %gep120.7, align 4, !tbaa !10
...
bb.h:                                             ; preds = %.lr.ph86, %._crit_edge
  ...
  %i.bz = add nuw i64 %indvars.iv94, %i.o
  %i.ca = sub i64 %wide.trip.count, %i.bz         ; 7 uses
  %i.cb = shl nuw nsw i64 %indvars.iv94, 3
  %scevgep = getelementptr i8, ptr %i.x, i64 %i.cb
  %i.cc = add nuw i64 %indvars.iv94, %wide.trip.count
  %i.cd = shl i64 %i.cc, 2
  %scevgep123 = getelementptr i8, ptr %6, i64 %i.cd
  %i.ce = mul i64 %i.v, %indvars.iv94
  %scevgep124 = getelementptr i8, ptr %i.y, i64 %i.ce
  %i.cf = mul i64 %i.w, %indvars.iv94
  %scevgep125 = getelementptr i8, ptr %i.z, i64 %i.cf
  %i.cg = icmp slt i64 %indvars.iv94, %invariant.op
  br i1 %i.cg, label %iter.check, label %._crit_edge

iter.check:                                       ; preds = %bb.h
  %i.ch = mul nsw i64 %indvars.iv94, %i.r
  %invariant.gep = getelementptr [4 x i8], ptr %4, i64 %i.ch ; 11 uses
  %invariant.gep115 = getelementptr [4 x i8], ptr %6, i64 %indvars.iv94 ; 11 uses
  %min.iters.check = icmp ugt i64 %i.ca, 7
...
vector.main.loop.iter.check:                      ; preds = %vector.memcheck
  %min.iters.check126 = icmp ult i64 %i.ca, 32
end_hunk_0
