...
.lr.ph1333:                                       ; preds = %bb.cl
  ...
  %17 = zext nneg i32 %i.uy to i64
  %18 = add nsw i32 %i.uz, 1
  br label %bb.cm

bb.cm:                                            ; preds = %.lr.ph1333, %._crit_edge1329
  %indvar1960 = phi i64 [ 0, %.lr.ph1333 ], [ %indvar.next1961, %._crit_edge1329 ] ; 3 uses
  %indvar1957 = phi i32 [ 0, %.lr.ph1333 ], [ %indvar.next1958, %._crit_edge1329 ] ; 2 uses
  %indvars.iv1620 = phi i64 [ 1, %.lr.ph1333 ], [ %indvars.iv.next1621, %._crit_edge1329 ] ; 4 uses
  %19 = add i32 %18, %indvar1957
  %20 = sext i32 %19 to i64
  %smin1959 = call i64 @llvm.smin.i64(i64 %17, i64 %20) ; 2 uses
...
.lr.ph1328:                                       ; preds = %bb.cm
  %i.vf = sub i64 %smin1959, %indvar1960
...
bb.dl:                                            ; preds = %.lr.ph1535, %.epilog-lcssa
  ...
  %i.ahv = add i64 %indvar1985, 1                 ; 2 uses
...
bb.dx:                                            ; preds = %.lr.ph1503, %._crit_edge1499
  ...
  %i.alz = add i64 %i.alv, %indvar1878            ; 2 uses
  ...
  %i.ame = add i64 %i.alv, %indvar1878
  ...
  %i.amp = add i64 %i.aln, %indvar1878            ; 2 uses
