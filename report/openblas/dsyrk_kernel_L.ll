...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %._crit_edge
  ...
  %i.ak = shl i64 %smin, 3                        ; 3 uses
  %i.al = add i64 %i.ak, 8
  %smin157 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 32) ; 5 uses
  %smax.a = call i64 @llvm.smax.i64(i64 %smin157, i64 1)
  %i.am = sub nsw i64 %.1135, %.0129155           ; 2 uses
  %i.an = call i64 @llvm.smin.i64(i64 %i.am, i64 32) ; 10 uses
...
.preheader.preheader:                             ; preds = %.lr.ph
  ...
  %10 = shl i64 %smin, 3
  %11 = getelementptr i8, ptr %i.a, i64 %i.ak
  %i.ax = getelementptr i8, ptr %.1137, i64 %i.aj
  %i.ay = getelementptr i8, ptr %i.ax, i64 %i.ak
  %i.az = getelementptr i8, ptr %.1137, i64 %i.aj
  br label %iter.check

iter.check:                                       ; preds = %.preheader.preheader, %.loopexit186
  %.0127154 = phi ptr [ %i.cf, %.loopexit186 ], [ %i.a, %.preheader.preheader ] ; 12 uses
  %.0128153 = phi ptr [ %i.cg, %.loopexit186 ], [ %i.aw, %.preheader.preheader ] ; 12 uses
  %.0130152 = phi i64 [ %i.ch, %.loopexit186 ], [ 0, %.preheader.preheader ] ; 12 uses
  %i.ba = sub i64 %smin157, %.0130152             ; 7 uses
  %min.iters.check = icmp ult i64 %i.ba, 4
  br i1 %min.iters.check, label %vec.epilog.scalar.ph.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %iter.check
  %i.bb = mul i64 %10, %.0130152
  %scevgep170 = getelementptr i8, ptr %11, i64 %i.bb
  %12 = mul i64 %i.al, %.0130152
  %scevgep169 = getelementptr i8, ptr %i.a, i64 %12
  %i.bc = mul i64 %9, %.0130152
  %scevgep168.a = getelementptr i8, ptr %i.ay, i64 %i.bc
  %13 = mul i64 %i.ai, %.0130152
  %scevgep = getelementptr i8, ptr %i.az, i64 %13
  %bound0 = icmp ult ptr %scevgep, %scevgep170
  %bound1 = icmp ult ptr %scevgep169, %scevgep168.a
...
vec.epilog.scalar.ph.preheader:                   ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.0131151.ph = phi i64 [ %.0130152, %iter.check ], [ %.0130152, %vector.memcheck ], [ %i.be, %vec.epilog.iter.check ], [ %i.bt, %vec.epilog.middle.block ] ; 4 uses
  %14 = sub i64 %smin157, %.0131151.ph
  %xtraiter = and i64 %14, 7                      ; 2 uses
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %vec.epilog.scalar.ph.prol.loopexit, label %vec.epilog.scalar.ph.prol

vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph.prol
  %.0131151.prol = phi i64 [ %20, %vec.epilog.scalar.ph.prol ], [ %.0131151.ph, %vec.epilog.scalar.ph.preheader ] ; 3 uses
  %prol.iter = phi i64 [ %prol.iter.next, %vec.epilog.scalar.ph.prol ], [ 0, %vec.epilog.scalar.ph.preheader ]
  %15 = getelementptr inbounds nuw [8 x i8], ptr %.0127154, i64 %.0131151.prol
  %16 = load double, ptr %15, align 8, !tbaa !8
  %17 = getelementptr inbounds nuw [8 x i8], ptr %.0128153, i64 %.0131151.prol ; 2 uses
  %18 = load double, ptr %17, align 8, !tbaa !8
  %19 = fadd double %16, %18
  store double %19, ptr %17, align 8, !tbaa !8
  %20 = add nuw nsw i64 %.0131151.prol, 1         ; 2 uses
...
vec.epilog.scalar.ph.prol.loopexit:               ; preds = %vec.epilog.scalar.ph.prol, %vec.epilog.scalar.ph.preheader
  %.0131151.unr = phi i64 [ %.0131151.ph, %vec.epilog.scalar.ph.preheader ], [ %20, %vec.epilog.scalar.ph.prol ]
  %21 = sub i64 %.0131151.ph, %smin157
  %22 = icmp ugt i64 %21, -8
  br i1 %22, label %.loopexit186, label %vec.epilog.scalar.ph

vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  %.0131151 = phi i64 [ %i.ce, %vec.epilog.scalar.ph ], [ %.0131151.unr, %vec.epilog.scalar.ph.prol.loopexit ] ; 10 uses
  %23 = getelementptr inbounds nuw [8 x i8], ptr %.0127154, i64 %.0131151
  %24 = load double, ptr %23, align 8, !tbaa !8
  %25 = getelementptr inbounds nuw [8 x i8], ptr %.0128153, i64 %.0131151 ; 2 uses
  %26 = load double, ptr %25, align 8, !tbaa !8
  %27 = fadd double %24, %26
  store double %27, ptr %25, align 8, !tbaa !8
  %28 = add nuw nsw i64 %.0131151, 1              ; 2 uses
  %29 = getelementptr inbounds nuw [8 x i8], ptr %.0127154, i64 %28
  %30 = load double, ptr %29, align 8, !tbaa !8
  %31 = getelementptr inbounds nuw [8 x i8], ptr %.0128153, i64 %28 ; 2 uses
  %32 = load double, ptr %31, align 8, !tbaa !8
  %33 = fadd double %30, %32
  store double %33, ptr %31, align 8, !tbaa !8
  %34 = add nuw nsw i64 %.0131151, 2              ; 2 uses
  %35 = getelementptr inbounds nuw [8 x i8], ptr %.0127154, i64 %34
  %36 = load double, ptr %35, align 8, !tbaa !8
  %37 = getelementptr inbounds nuw [8 x i8], ptr %.0128153, i64 %34 ; 2 uses
  %38 = load double, ptr %37, align 8, !tbaa !8
  %39 = fadd double %36, %38
  store double %39, ptr %37, align 8, !tbaa !8
  %40 = add nuw nsw i64 %.0131151, 3              ; 2 uses
  %41 = getelementptr inbounds nuw [8 x i8], ptr %.0127154, i64 %40
  %42 = load double, ptr %41, align 8, !tbaa !8
  %43 = getelementptr inbounds nuw [8 x i8], ptr %.0128153, i64 %40 ; 2 uses
  %44 = load double, ptr %43, align 8, !tbaa !8
  %45 = fadd double %42, %44
  store double %45, ptr %43, align 8, !tbaa !8
  %46 = add nuw nsw i64 %.0131151, 4              ; 2 uses
  %47 = getelementptr inbounds nuw [8 x i8], ptr %.0127154, i64 %46
  %48 = load double, ptr %47, align 8, !tbaa !8
  %49 = getelementptr inbounds nuw [8 x i8], ptr %.0128153, i64 %46 ; 2 uses
  %50 = load double, ptr %49, align 8, !tbaa !8
  %51 = fadd double %48, %50
  store double %51, ptr %49, align 8, !tbaa !8
  %52 = add nuw nsw i64 %.0131151, 5              ; 2 uses
  %53 = getelementptr inbounds nuw [8 x i8], ptr %.0127154, i64 %52
  %54 = load double, ptr %53, align 8, !tbaa !8
  %55 = getelementptr inbounds nuw [8 x i8], ptr %.0128153, i64 %52 ; 2 uses
  %56 = load double, ptr %55, align 8, !tbaa !8
  %57 = fadd double %54, %56
  store double %57, ptr %55, align 8, !tbaa !8
  %58 = add nuw nsw i64 %.0131151, 6              ; 2 uses
  %59 = getelementptr inbounds nuw [8 x i8], ptr %.0127154, i64 %58
  %60 = load double, ptr %59, align 8, !tbaa !8
  %61 = getelementptr inbounds nuw [8 x i8], ptr %.0128153, i64 %58 ; 2 uses
  %62 = load double, ptr %61, align 8, !tbaa !8
  %63 = fadd double %60, %62
  store double %63, ptr %61, align 8, !tbaa !8
  %64 = add nuw nsw i64 %.0131151, 7              ; 2 uses
  %i.bz = getelementptr inbounds nuw [8 x i8], ptr %.0127154, i64 %64
  %i.ca = load double, ptr %i.bz, align 8, !tbaa !8
  %i.cb = getelementptr inbounds nuw [8 x i8], ptr %.0128153, i64 %64 ; 2 uses
  %i.cc = load double, ptr %i.cb, align 8, !tbaa !8
  %i.cd = fadd double %i.ca, %i.cc
  store double %i.cd, ptr %i.cb, align 8, !tbaa !8
  %i.ce = add nuw nsw i64 %.0131151, 8            ; 2 uses
  %exitcond.not.7 = icmp eq i64 %i.ce, %smin157
  br i1 %exitcond.not.7, label %.loopexit186, label %vec.epilog.scalar.ph, !llvm.loop !23

.loopexit186:                                     ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %vec.epilog.middle.block, %middle.block
  ...
  br i1 %exitcond158.not, label %._crit_edge, label %iter.check, !llvm.loop !24
...
._crit_edge:                                      ; preds = %.loopexit186, %.lr.ph
  ...
  br i1 %i.ct, label %.lr.ph, label %.loopexit, !llvm.loop !25
