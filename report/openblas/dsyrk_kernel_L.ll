...
iter.check:                                       ; preds = %.preheader.preheader, %.loopexit189
  ...
  %smax173 = call i64 @llvm.smax.i64(i64 %i.ap, i64 %i.bc)
  %i.bd = sub nsw i64 %smax173, %.0128153         ; 7 uses
...
vector.memcheck:                                  ; preds = %iter.check
  ...
  %smax = call i64 @llvm.smax.i64(i64 %i.ap, i64 %i.bg)
  %i.bh = xor i64 %.0128153, -1
  %i.bi = add nsw i64 %smax, %i.bh
