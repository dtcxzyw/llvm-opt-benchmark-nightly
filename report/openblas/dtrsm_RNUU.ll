...
bb.j:                                             ; preds = %.lr.ph, %bb.j
  ...
  %i.ak = sub nsw i64 %i.ab, %.0229249            ; 2 uses
...
bb.k:                                             ; preds = %.lr.ph257, %bb.k
  ...
  %i.by = sub nsw i64 %i.bq, %.1230255            ; 2 uses
  %spec.store.select5 = tail call i64 @llvm.smin.i64(i64 %i.by, i64 2)
  %.inv = icmp slt i64 %i.by, 6
  %.1 = select i1 %.inv, i64 %spec.store.select5, i64 6 ; 3 uses
  %i.bz = add nsw i64 %i.bs, %.1230255            ; 2 uses
  %i.ca = mul nsw i64 %i.bz, %i.i
  %i.cb = getelementptr [8 x i8], ptr %i.bt, i64 %i.ca
  %i.cc = add nsw i64 %.1230255, %spec.store.select4
  %i.cd = mul nsw i64 %i.cc, %spec.store.select4
