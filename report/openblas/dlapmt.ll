...
.lr.ph138.preheader:                              ; preds = %bb.d
  ...
  %i.ce = shl nsw i64 %i.b, 3                     ; 2 uses
  %6 = or i64 %i.cc, %i.b
  %7 = shl nsw i64 %6, 3                          ; 2 uses
  %8 = shl nsw i64 %i.cc, 3
  %i.cf = getelementptr i8, ptr %3, i64 %i.ce
  %scevgep214.a = getelementptr i8, ptr %i.cf, i64 8
  %scevgep216 = getelementptr i8, ptr %3, i64 %i.ce
  %i.cg = getelementptr i8, ptr %3, i64 %7
  %i.ch = getelementptr i8, ptr %i.cg, i64 8
  %i.ci = getelementptr i8, ptr %3, i64 %7
  br label %.lr.ph138
...
.lr.ph138:                                        ; preds = %.lr.ph138.preheader, %.loopexit
  ...
  %i.cj = mul i64 %8, %indvar                     ; 2 uses
  %scevgep211 = getelementptr i8, ptr %i.ch, i64 %i.cj
...
vector.memcheck210:                               ; preds = %.lr.ph129
  ...
  %scevgep215 = getelementptr i8, ptr %scevgep214.a, i64 %i.cx
  %i.cy = getelementptr i8, ptr %scevgep216, i64 %i.cx
