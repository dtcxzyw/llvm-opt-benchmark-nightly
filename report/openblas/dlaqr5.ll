...
.lr.ph1503:                                       ; preds = %bb.u
  ...
  %i.iz = sext i32 %i.iy to i64                   ; 8 uses
  %i.ja = sext i32 %i.is to i64
  %i.jb = sext i32 %.01387 to i64                 ; 4 uses
  ...
  %i.jd = add nsw i64 %i.jb, 1
  %i.je = sub nsw i64 %i.jd, %i.iz                ; 3 uses
...
vector.ph2143:                                    ; preds = %vector.memcheck2119
  ...
  %i.jn = add nsw i64 %n.vec2144, %i.iz
