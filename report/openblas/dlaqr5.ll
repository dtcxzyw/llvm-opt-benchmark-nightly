...
vector.memcheck2073:                              ; preds = %.lr.ph1508
  %25 = add nsw i64 %i.sg, %i.sh
  %i.sn = shl nsw i64 %25, 3                      ; 2 uses
  %scevgep2075 = getelementptr i8, ptr %scevgep2074, i64 %i.sn ; 2 uses
  %i.so = sub i32 %i.rw, %i.rx
  %i.sp = zext i32 %i.so to i64
  %i.sq = shl nuw nsw i64 %i.sp, 3                ; 2 uses
  %i.sr = getelementptr i8, ptr %scevgep2076, i64 %i.sn
  %scevgep2077.a = getelementptr i8, ptr %i.sr, i64 %i.sq ; 2 uses
  %26 = add nsw i64 %i.sg, %i.si
  %i.ss = shl nsw i64 %26, 3                      ; 2 uses
  %scevgep2079.a = getelementptr i8, ptr %scevgep2078, i64 %i.ss ; 2 uses
  %i.st = getelementptr i8, ptr %scevgep2080, i64 %i.ss
