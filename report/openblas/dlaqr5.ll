...
.lr.ph1575:                                       ; preds = %bb.g
  ...
  %i.bu = lshr i32 %i.w, 1
  %i.bv = zext nneg i32 %i.bu to i64              ; 8 uses
...
.lr.ph1521:                                       ; preds = %.loopexit1489
  ...
  %i.vi = sext i32 %i.ez to i64                   ; 2 uses
  ...
  %smin1980 = call i64 @llvm.smin.i64(i64 %i.bv, i64 %i.vj)
  %smin1981 = call i64 @llvm.smin.i64(i64 %smin1980, i64 %i.vi)
  %i.vt = mul i64 %i.dc, %smin1981
...
.lr.ph1531:                                       ; preds = %.thread1693, %bb.bu
  ...
  %i.aja = sext i32 %i.ez to i64                  ; 4 uses
...
.lr.ph1548:                                       ; preds = %.preheader
  ...
  %smin1768 = call i64 @llvm.smin.i64(i64 %i.bv, i64 %i.ajb)
  %smin1769 = call i64 @llvm.smin.i64(i64 %smin1768, i64 %i.aja)
  %i.amu = mul i64 %i.cd, %smin1769
...
.lr.ph1536.preheader:                             ; preds = %.lr.ph1540
  ...
  %smin1830 = call i64 @llvm.smin.i64(i64 %i.bv, i64 %i.ajb)
  %smin1831 = call i64 @llvm.smin.i64(i64 %smin1830, i64 %i.aja)
  %i.aqu = mul i64 %i.cm, %smin1831
