...
begin_hunk_0_@sgemm_small_kernel_nn:bb.a
  ...
  br i1 %niter4548.ncmp.7, label %._crit_edge3398.us.unr-lcssa, label %.preheader3158.us.new, !llvm.loop !27
...
bb.g:                                             ; preds = %bb.g, %.epil.preheader4541
  ...
  %i.adc = load <16 x float>, ptr %gep3394.us.epil, align 1, !tbaa !67
  %gep3401.us.epil = getelementptr [4 x i8], ptr %invariant.gep3400.us, i64 %.828983396.us.epil
  %i.add = load float, ptr %gep3401.us.epil, align 1, !tbaa !67
  ...
  br i1 %epil.iter4543.cmp.not, label %._crit_edge3398.us, label %bb.g, !llvm.loop !28
...
._crit_edge3398.us:                               ; preds = %bb.g, %._crit_edge3398.us.unr-lcssa
  ...
  %i.adk = tail call <16 x float> asm "vfmadd231ps ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3403.us, <16 x float> %i.m, <16 x float> %i.adi) #9, !srcloc !122
  store <16 x float> %i.adk, ptr %gep3403.us, align 1, !tbaa !67
  %i.adl = add i64 %.83404.us, 1                  ; 2 uses
  %exitcond3848.not = icmp eq i64 %i.adl, %1
  br i1 %exitcond3848.not, label %._crit_edge3405, label %.preheader3158.us, !llvm.loop !29
...
.lr.ph3383.new:                                   ; preds = %.lr.ph3383, %.lr.ph3383.new
  ...
  %i.adx = load float, ptr %i.adw, align 1, !tbaa !67
  ...
  %i.aee = load <16 x float>, ptr %gep3379.1, align 1, !tbaa !67 ; 2 uses
  %i.aef = getelementptr [4 x i8], ptr %6, i64 %i.aec ; 2 uses
  %i.aeg = getelementptr [4 x i8], ptr %i.aef, i64 %i.adm
  %i.aeh = load float, ptr %i.aeg, align 1, !tbaa !67
  ...
  %i.ael = load float, ptr %i.aek, align 1, !tbaa !67
  ...
  %i.aes = load <16 x float>, ptr %gep3379.2, align 1, !tbaa !67 ; 2 uses
  %i.aet = getelementptr [4 x i8], ptr %6, i64 %i.aeq ; 2 uses
  %i.aeu = getelementptr [4 x i8], ptr %i.aet, i64 %i.adm
  %i.aev = load float, ptr %i.aeu, align 1, !tbaa !67
  ...
  %i.aez = load float, ptr %i.aey, align 1, !tbaa !67
  ...
  %i.afg = load <16 x float>, ptr %gep3379.3, align 1, !tbaa !67 ; 2 uses
  %i.afh = getelementptr [4 x i8], ptr %6, i64 %i.afe ; 2 uses
  %i.afi = getelementptr [4 x i8], ptr %i.afh, i64 %i.adm
  %i.afj = load float, ptr %i.afi, align 1, !tbaa !67
  ...
  %i.afn = load float, ptr %i.afm, align 1, !tbaa !67
  ...
  br i1 %niter4540.ncmp.3, label %._crit_edge3384.loopexit.unr-lcssa, label %.lr.ph3383.new, !llvm.loop !30
...
bb.h:                                             ; preds = %bb.h, %.epil.preheader4532
  ...
  %i.agb = load float, ptr %i.aga, align 1, !tbaa !67
  ...
  br i1 %epil.iter4534.cmp.not, label %._crit_edge3384.loopexit, label %bb.h, !llvm.loop !31
...
._crit_edge3384:                                  ; preds = %.preheader3159.._crit_edge3384_crit_edge, %._crit_edge3384.loopexit
  ...
  %i.agi = tail call <16 x float> asm "vfmadd231ps ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3388, <16 x float> %i.m, <16 x float> %.pre-phi3880) #9, !srcloc !123
  store <16 x float> %i.agi, ptr %gep3388, align 1, !tbaa !67
  %i.agj = mul nsw i64 %.pre-phi3914, %10
  %gep3390 = getelementptr [4 x i8], ptr %invariant.gep3364, i64 %i.agj ; 2 uses
  %i.agk = tail call <16 x float> asm "vfmadd231ps ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3390, <16 x float> %i.m, <16 x float> %.pre-phi3882) #9, !srcloc !124
  store <16 x float> %i.agk, ptr %gep3390, align 1, !tbaa !67
  %i.agl = add nuw nsw i64 %.73391, 2             ; 3 uses
  %i.agm = icmp slt i64 %i.agl, %i.i
  br i1 %i.agm, label %.preheader3159, label %.preheader3161, !llvm.loop !32
...
.preheader3158:                                   ; preds = %.preheader3158.lr.ph, %.preheader3158
  ...
  %i.ago = tail call <16 x float> asm "vfmadd231ps ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3403, <16 x float> %i.m, <16 x float> %i.lt) #9, !srcloc !122
  store <16 x float> %i.ago, ptr %gep3403, align 1, !tbaa !67
  %i.agp = add i64 %.83404, 1                     ; 2 uses
  %exitcond3846.not = icmp eq i64 %i.agp, %1
  br i1 %exitcond3846.not, label %._crit_edge3405, label %.preheader3158, !llvm.loop !29
...
._crit_edge3405:                                  ; preds = %.preheader3158, %._crit_edge3398.us, %.preheader3161
  ...
  br i1 %i.agr, label %.preheader3163, label %._crit_edge3407, !llvm.loop !33

._crit_edge3407:                                  ; preds = %._crit_edge3405, %.preheader3164
  %.2.lcssa = phi i64 [ %.1.lcssa, %.preheader3164 ], [ %i.agq, %._crit_edge3405 ] ; 9 uses
...
.lr.ph3634.new:                                   ; preds = %.lr.ph3634, %.lr.ph3634.new
  ...
  %i.ahx = load float, ptr %i.ahw, align 1, !tbaa !67
  ...
  %i.aib = load float, ptr %i.aia, align 1, !tbaa !67
  ...
  %i.aif = load float, ptr %i.aie, align 1, !tbaa !67
  ...
  %i.aij = load float, ptr %i.aii, align 1, !tbaa !67
  ...
  %i.ain = load float, ptr %i.aim, align 1, !tbaa !67
  ...
  %i.air = load float, ptr %i.aiq, align 1, !tbaa !67
  ...
  %i.ajf = load float, ptr %i.aje, align 1, !tbaa !67
  ...
  %i.ajj = load float, ptr %i.aji, align 1, !tbaa !67
  ...
  %i.ajn = load float, ptr %i.ajm, align 1, !tbaa !67
  ...
  %i.ajr = load float, ptr %i.ajq, align 1, !tbaa !67
  ...
  %i.ajv = load float, ptr %i.aju, align 1, !tbaa !67
  ...
  %i.ajz = load float, ptr %i.ajy, align 1, !tbaa !67
  ...
  br i1 %niter4568.ncmp.1, label %._crit_edge3635.loopexit.unr-lcssa, label %.lr.ph3634.new, !llvm.loop !34
...
.epil.preheader4556:                              ; preds = %._crit_edge3635.loopexit.unr-lcssa, %.lr.ph3634
  ...
  %i.akn = load float, ptr %i.akm, align 1, !tbaa !67
  ...
  %i.akr = load float, ptr %i.akq, align 1, !tbaa !67
  ...
  %i.akv = load float, ptr %i.aku, align 1, !tbaa !67
  ...
  %i.akz = load float, ptr %i.aky, align 1, !tbaa !67
  ...
  %i.ald = load float, ptr %i.alc, align 1, !tbaa !67
  ...
  %i.alh = load float, ptr %i.alg, align 1, !tbaa !67
...
begin_hunk_1_@sgemm_small_kernel_nn:bb.a
  ...
  %i.aom = load float, ptr %i.aol, align 1, !tbaa !67
  ...
  %i.aoq = load float, ptr %i.aop, align 1, !tbaa !67
  ...
  br i1 %niter4577.ncmp.3, label %._crit_edge3662.loopexit.unr-lcssa, label %.lr.ph3661.new, !llvm.loop !36
...
bb.k:                                             ; preds = %bb.k, %.epil.preheader4569
  ...
  %i.apa = load float, ptr %i.aoz, align 1, !tbaa !67
  ...
  %i.ape = load float, ptr %i.apd, align 1, !tbaa !67
  ...
  br i1 %epil.iter4571.cmp.not, label %._crit_edge3662, label %bb.k, !llvm.loop !37
...
._crit_edge3662:                                  ; preds = %._crit_edge3662.loopexit.unr-lcssa, %bb.k, %.preheader3133.._crit_edge3662_crit_edge
  ...
  %i.apm = tail call <16 x float> asm "vfmadd231ps ($1), $2, $0 {$3}", "=v,r,v,^Yk,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3666, <16 x float> %i.m, i16 %i.agy, <16 x float> %i.apk) #9, !srcloc !131
  ...
  %i.app = tail call <16 x float> asm "vfmadd231ps ($1), $2, $0 {$3}", "=v,r,v,^Yk,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3668, <16 x float> %i.m, i16 %i.agy, <16 x float> %i.apn) #9, !srcloc !132
  ...
  br i1 %i.apr, label %.preheader3133, label %.preheader3132, !llvm.loop !38
...
.lr.ph3675.new:                                   ; preds = %.lr.ph3675, %.lr.ph3675.new
  ...
  %i.apv = load float, ptr %gep3679, align 1, !tbaa !67
  ...
  %i.aqc = load float, ptr %gep3679.1, align 1, !tbaa !67
  ...
  %i.aqj = load float, ptr %gep3679.2, align 1, !tbaa !67
  ...
  %i.aqq = load float, ptr %gep3679.3, align 1, !tbaa !67
  ...
  %i.aqx = load float, ptr %gep3679.4, align 1, !tbaa !67
  ...
  %i.are = load float, ptr %gep3679.5, align 1, !tbaa !67
  ...
  %i.arl = load float, ptr %gep3679.6, align 1, !tbaa !67
  ...
  %i.ars = load float, ptr %gep3679.7, align 1, !tbaa !67
  ...
  br i1 %niter4585.ncmp.7, label %._crit_edge3676.loopexit.unr-lcssa, label %.lr.ph3675.new, !llvm.loop !39
...
bb.l:                                             ; preds = %bb.l, %.epil.preheader4578
  ...
  %i.arz = load float, ptr %gep3679.epil, align 1, !tbaa !67
  ...
  br i1 %epil.iter4580.cmp.not, label %._crit_edge3676, label %bb.l, !llvm.loop !40
...
._crit_edge3676:                                  ; preds = %._crit_edge3676.loopexit.unr-lcssa, %bb.l, %.preheader
  ...
  %i.asg = tail call <16 x float> asm "vfmadd231ps ($1), $2, $0 {$3}", "=v,r,v,^Yk,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3681, <16 x float> %i.m, i16 %i.agy, <16 x float> %i.ase) #9, !srcloc !133
  ...
  br i1 %exitcond3868.not, label %.loopexit, label %.preheader, !llvm.loop !41
...
.lr.ph3413:                                       ; preds = %bb.i
  ...
  %12 = xor i8 %11, -1
  %13 = and i64 %2, 9223372036854775800
  %invariant.gep3409 = getelementptr [4 x i8], ptr %i.ask, i64 %2
  %i.asm = getelementptr [4 x i8], ptr %3, i64 %.2.lcssa ; 9 uses
  %i.asn = bitcast i8 %12 to <8 x i1>             ; 8 uses
...
.preheader3156.lr.ph:                             ; preds = %bb.v
  %14 = and i64 %2, 9223372036854775792           ; 9 uses
  %15 = icmp slt i64 %i.auv, %2
  %i.aso = icmp sgt i32 %i.agt, 0
  %or.cond4199 = and i1 %15, %i.aso
  br i1 %or.cond4199, label %.preheader3156.preheader, label %._crit_edge3431.split
...
iter.check:                                       ; preds = %.preheader3156.preheader, %._crit_edge3429
  ...
  %i.auy = getelementptr [4 x i8], ptr %i.asm, i64 %i.aux ; 9 uses
...
bb.w:                                             ; preds = %bb.w, %.epil.preheader4549
  ...
  br i1 %epil.iter4551.cmp.not, label %._crit_edge3429, label %bb.w, !llvm.loop !43

._crit_edge3429:                                  ; preds = %bb.w, %._crit_edge3429.unr-lcssa
  %i.ave = add nuw nsw i64 %.1329033430, 1        ; 2 uses
  %16 = icmp slt i64 %i.ave, %2
  br i1 %16, label %iter.check, label %._crit_edge3431.split, !llvm.loop !44
...
bb.x:                                             ; preds = %.lr.ph3449, %bb.x
  ...
  %i.azy = load <16 x float>, ptr %i.azx, align 1, !tbaa !67 ; 4 uses
  %i.azz = getelementptr inbounds nuw [4 x i8], ptr %i.axm, i64 %.1429043448
  %i.baa = load <16 x float>, ptr %i.azz, align 1, !tbaa !67 ; 4 uses
  %i.bab = getelementptr inbounds nuw [4 x i8], ptr %i.axp, i64 %.1429043448
  %i.bac = load <16 x float>, ptr %i.bab, align 1, !tbaa !67 ; 4 uses
  %i.bad = getelementptr inbounds nuw [4 x i8], ptr %i.axs, i64 %.1429043448
  %i.bae = load <16 x float>, ptr %i.bad, align 1, !tbaa !67 ; 4 uses
  %i.baf = getelementptr [4 x i8], ptr %i.azn, i64 %.1429043448
  %i.bag = load <16 x float>, ptr %i.baf, align 1, !tbaa !67 ; 4 uses
  %i.bah = getelementptr [4 x i8], ptr %i.azq, i64 %.1429043448
  %i.bai = load <16 x float>, ptr %i.bah, align 1, !tbaa !67 ; 4 uses
  %i.baj = getelementptr [4 x i8], ptr %i.azt, i64 %.1429043448
  %i.bak = load <16 x float>, ptr %i.baj, align 1, !tbaa !67 ; 4 uses
  %i.bal = getelementptr [4 x i8], ptr %i.azw, i64 %.1429043448
  %i.bam = load <16 x float>, ptr %i.bal, align 1, !tbaa !67 ; 4 uses
  ...
  %i.bbe = icmp samesign ult i64 %i.bbd, %14
  br i1 %i.bbe, label %bb.x, label %._crit_edge3450, !llvm.loop !46
...
bb.z:                                             ; preds = %._crit_edge3450._crit_edge, %bb.y
  ...
  %i.bde = tail call <4 x float> asm "vfmadd231ps ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3469, <4 x float> %i.awm, <4 x float> %i.bdc) #9, !srcloc !137
  ...
  %i.bdz = tail call <4 x float> asm "vfmadd231ps ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3471, <4 x float> %i.awm, <4 x float> %i.bdx) #9, !srcloc !138
  ...
  %i.beu = tail call <4 x float> asm "vfmadd231ps ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3473, <4 x float> %i.awm, <4 x float> %i.bes) #9, !srcloc !139
  ...
  %i.bfp = tail call <4 x float> asm "vfmadd231ps ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3475, <4 x float> %i.awm, <4 x float> %i.bfn) #9, !srcloc !140
  store <4 x float> %i.bfp, ptr %gep3475, align 1
  %i.bfq = add nuw nsw i64 %.123476, 4            ; 3 uses
  %i.bfr = icmp slt i64 %i.bfq, %i.h
  br i1 %i.bfr, label %.lr.ph3449, label %.preheader3154, !llvm.loop !47
...
bb.aa:                                            ; preds = %.lr.ph3487, %bb.aa
  ...
  %i.bgo = load <16 x float>, ptr %i.bgn, align 1, !tbaa !67 ; 2 uses
  %i.bgp = getelementptr inbounds nuw [4 x i8], ptr %i.azb, i64 %.1529053486
  %i.bgq = load <16 x float>, ptr %i.bgp, align 1, !tbaa !67 ; 2 uses
  %i.bgr = getelementptr inbounds nuw [4 x i8], ptr %i.aze, i64 %.1529053486
  %i.bgs = load <16 x float>, ptr %i.bgr, align 1, !tbaa !67 ; 2 uses
  %i.bgt = getelementptr inbounds nuw [4 x i8], ptr %i.azh, i64 %.1529053486
  %i.bgu = load <16 x float>, ptr %i.bgt, align 1, !tbaa !67 ; 2 uses
  %i.bgv = getelementptr [4 x i8], ptr %i.bgj, i64 %.1529053486
  %i.bgw = load <16 x float>, ptr %i.bgv, align 1, !tbaa !67 ; 4 uses
  %i.bgx = getelementptr [4 x i8], ptr %i.bgm, i64 %.1529053486
  %i.bgy = load <16 x float>, ptr %i.bgx, align 1, !tbaa !67 ; 4 uses
  ...
  %i.bhi = icmp samesign ult i64 %i.bhh, %14
  br i1 %i.bhi, label %bb.aa, label %._crit_edge3488, !llvm.loop !48
...
bb.ac:                                            ; preds = %._crit_edge3488._crit_edge, %bb.ab
  ...
  %i.biu = tail call <4 x float> asm "vfmadd231ps ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3499, <4 x float> %i.awm, <4 x float> %i.bis) #9, !srcloc !141
  ...
  %i.bjp = tail call <4 x float> asm "vfmadd231ps ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3501, <4 x float> %i.awm, <4 x float> %i.bjn) #9, !srcloc !142
  store <4 x float> %i.bjp, ptr %gep3501, align 1
  %i.bjq = add nuw nsw i64 %.133502, 2            ; 3 uses
  %i.bjr = icmp slt i64 %i.bjq, %i.i
  br i1 %i.bjr, label %.lr.ph3487, label %.preheader3153, !llvm.loop !49
...
bb.ad:                                            ; preds = %.lr.ph3509, %bb.ad
  ...
  %i.bkj = icmp samesign ult i64 %i.bki, %14
  br i1 %i.bkj, label %bb.ad, label %._crit_edge3510, !llvm.loop !50
...
bb.af:                                            ; preds = %bb.ae, %._crit_edge3510
  ...
  %i.blo = tail call <4 x float> asm "vfmadd231ps ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3517, <4 x float> %i.awm, <4 x float> %i.blm) #9, !srcloc !143
  store <4 x float> %i.blo, ptr %gep3517, align 1
  %i.blp = add i64 %.143518, 1                    ; 2 uses
  %exitcond3852.not = icmp eq i64 %i.blp, %1
  br i1 %exitcond3852.not, label %._crit_edge3519, label %.lr.ph3509, !llvm.loop !51
...
._crit_edge3519:                                  ; preds = %bb.af, %.preheader3153
  ...
  br i1 %i.blr, label %.preheader3155, label %.preheader3149.loopexit, !llvm.loop !52
...
bb.ag:                                            ; preds = %.lr.ph3533, %bb.ag
  ...
  %i.bnk = load <16 x float>, ptr %i.bnj, align 1, !tbaa !67 ; 4 uses
  %i.bnl = getelementptr inbounds nuw [4 x i8], ptr %i.blw, i64 %.1729073532
  %i.bnm = load <16 x float>, ptr %i.bnl, align 1, !tbaa !67 ; 4 uses
  %i.bnn = getelementptr [4 x i8], ptr %i.bmz, i64 %.1729073532
  %i.bno = load <16 x float>, ptr %i.bnn, align 1, !tbaa !67 ; 2 uses
  %i.bnp = getelementptr [4 x i8], ptr %i.bnc, i64 %.1729073532
  %i.bnq = load <16 x float>, ptr %i.bnp, align 1, !tbaa !67 ; 2 uses
  %i.bnr = getelementptr [4 x i8], ptr %i.bnf, i64 %.1729073532
  %i.bns = load <16 x float>, ptr %i.bnr, align 1, !tbaa !67 ; 2 uses
  %i.bnt = getelementptr [4 x i8], ptr %i.bni, i64 %.1729073532
  %i.bnu = load <16 x float>, ptr %i.bnt, align 1, !tbaa !67 ; 2 uses
  ...
  %i.boe = icmp samesign ult i64 %i.bod, %14
  br i1 %i.boe, label %bb.ag, label %._crit_edge3534, !llvm.loop !53
...
bb.ai:                                            ; preds = %bb.ah, %._crit_edge3534
  ...
  br i1 %i.bqt, label %.lr.ph3533, label %.preheader3147, !llvm.loop !54
...
bb.aj:                                            ; preds = %.lr.ph3553, %bb.aj
  ...
  %i.bri = load <16 x float>, ptr %i.brh, align 1, !tbaa !67 ; 2 uses
  %i.brj = getelementptr inbounds nuw [4 x i8], ptr %i.bmv, i64 %.1829083552
  %i.brk = load <16 x float>, ptr %i.brj, align 1, !tbaa !67 ; 2 uses
  %i.brl = getelementptr [4 x i8], ptr %i.brd, i64 %.1829083552
  %i.brm = load <16 x float>, ptr %i.brl, align 1, !tbaa !67 ; 2 uses
  %i.brn = getelementptr [4 x i8], ptr %i.brg, i64 %.1829083552
  %i.bro = load <16 x float>, ptr %i.brn, align 1, !tbaa !67 ; 2 uses
  ...
  %i.bru = icmp samesign ult i64 %i.brt, %14
  br i1 %i.bru, label %bb.aj, label %._crit_edge3554, !llvm.loop !55
...
bb.al:                                            ; preds = %._crit_edge3554._crit_edge, %bb.ak
  ...
  %i.bsj = load <2 x float>, ptr %gep3561, align 4, !tbaa !135
  ...
  store <2 x float> %i.bsn, ptr %gep3561, align 4, !tbaa !135
  ...
  %i.bsr = load <2 x float>, ptr %gep3563, align 4, !tbaa !135
  ...
  store <2 x float> %i.bsv, ptr %gep3563, align 4, !tbaa !135
  %i.bsw = add nuw nsw i64 %.163564, 2            ; 3 uses
  %i.bsx = icmp slt i64 %i.bsw, %i.i
  br i1 %i.bsx, label %.lr.ph3553, label %.preheader3146, !llvm.loop !56
...
bb.am:                                            ; preds = %.lr.ph3569, %bb.am
  ...
  %i.btb = load <16 x float>, ptr %i.bta, align 1, !tbaa !67
  %i.btc = getelementptr inbounds nuw [4 x i8], ptr %i.bqz, i64 %.1929093568
  %i.btd = load <16 x float>, ptr %i.btc, align 1, !tbaa !67
  %i.bte = getelementptr [4 x i8], ptr %i.bsz, i64 %.1929093568
  %i.btf = load <16 x float>, ptr %i.bte, align 1, !tbaa !67 ; 2 uses
  ...
  %i.btj = icmp samesign ult i64 %i.bti, %14
  br i1 %i.btj, label %bb.am, label %._crit_edge3570, !llvm.loop !57
...
bb.ao:                                            ; preds = %bb.an, %._crit_edge3570
  ...
  %i.btt = load <2 x float>, ptr %gep3575, align 4, !tbaa !135
  ...
  store <2 x float> %i.btx, ptr %gep3575, align 4, !tbaa !135
  %i.bty = add nuw nsw i64 %.173576, 1            ; 2 uses
  %exitcond3856.not = icmp eq i64 %i.bty, %1
  br i1 %exitcond3856.not, label %._crit_edge3577, label %.lr.ph3569, !llvm.loop !58
...
._crit_edge3577:                                  ; preds = %bb.ao, %.preheader3146
  ...
  br i1 %i.bua, label %.preheader3148, label %.preheader3142.loopexit, !llvm.loop !59
...
bb.ap:                                            ; preds = %.lr.ph3587, %bb.ap
  ...
  %i.buu = load <16 x float>, ptr %i.but, align 1, !tbaa !67 ; 4 uses
  %i.buv = getelementptr [4 x i8], ptr %i.buj, i64 %.2029103586
  %i.buw = load <16 x float>, ptr %i.buv, align 1, !tbaa !67
  %i.bux = getelementptr [4 x i8], ptr %i.bum, i64 %.2029103586
  %i.buy = load <16 x float>, ptr %i.bux, align 1, !tbaa !67
  %i.buz = getelementptr [4 x i8], ptr %i.bup, i64 %.2029103586
  %i.bva = load <16 x float>, ptr %i.buz, align 1, !tbaa !67
  %i.bvb = getelementptr [4 x i8], ptr %i.bus, i64 %.2029103586
  %i.bvc = load <16 x float>, ptr %i.bvb, align 1, !tbaa !67
  ...
  %i.bvi = icmp samesign ult i64 %i.bvh, %14
  br i1 %i.bvi, label %bb.ap, label %._crit_edge3588, !llvm.loop !60
...
bb.ar:                                            ; preds = %bb.aq, %._crit_edge3588
  ...
  br i1 %i.bww, label %.lr.ph3587, label %.preheader3140, !llvm.loop !61
...
bb.as:                                            ; preds = %.lr.ph3601, %bb.as
  ...
  %i.bxh = load <16 x float>, ptr %i.bxg, align 1, !tbaa !67 ; 2 uses
  %i.bxi = getelementptr [4 x i8], ptr %i.bxc, i64 %.213600
  %i.bxj = load <16 x float>, ptr %i.bxi, align 1, !tbaa !67
  %i.bxk = getelementptr [4 x i8], ptr %i.bxf, i64 %.213600
  %i.bxl = load <16 x float>, ptr %i.bxk, align 1, !tbaa !67
  ...
  %i.bxp = icmp samesign ult i64 %i.bxo, %14
  br i1 %i.bxp, label %bb.as, label %._crit_edge3602, !llvm.loop !62
...
bb.av:                                            ; preds = %.lr.ph3614, %bb.av
  ...
  %i.byn = load <16 x float>, ptr %i.bym, align 1, !tbaa !67
  %i.byo = getelementptr [4 x i8], ptr %i.byl, i64 %.223613
  %i.byp = load <16 x float>, ptr %i.byo, align 1, !tbaa !67
  ...
  %i.bys = icmp samesign ult i64 %i.byr, %14
  br i1 %i.bys, label %bb.av, label %._crit_edge3615, !llvm.loop !64
...
._crit_edge3621.a:                                ; preds = %bb.ax, %.preheader3139
  ...
  br i1 %exitcond3864.not, label %._crit_edge3624, label %.preheader3141, !llvm.loop !66
