Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/openblas/original/dtrsm_RNLN?download=true
begin_hunk_0
...
bb.a:
  ...
  %i.d = load i64, ptr %i.c, align 8, !tbaa !19   ; 9 uses
...
bb.j:                                             ; preds = %bb.i, %bb.j
  ...
  br i1 %i.bh, label %bb.j, label %.preheader263, !llvm.loop !8
...
.lr.ph:                                           ; preds = %.preheader263, %.lr.ph
  ...
  br i1 %i.bp, label %.lr.ph, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %.lr.ph, %.preheader263
  %i.bq = add nuw nsw i64 %.0247267, 384          ; 2 uses
  %i.br = icmp slt i64 %i.bq, %i.d
  br i1 %i.br, label %bb.i, label %._crit_edge270, !llvm.loop !10
...
bb.l:                                             ; preds = %.lr.ph273, %bb.l
  ...
  br i1 %i.cs, label %bb.l, label %.preheader, !llvm.loop !11
...
.lr.ph275:                                        ; preds = %.preheader, %.lr.ph275
  ...
  br i1 %i.db, label %.lr.ph275, label %._crit_edge276, !llvm.loop !12

._crit_edge276:                                   ; preds = %.lr.ph275, %.preheader
  %i.dc = add nsw i64 %.1248278, -384             ; 2 uses
  %.not261 = icmp slt i64 %i.dc, %.pre-phi
  br i1 %.not261, label %._crit_edge280, label %bb.k, !llvm.loop !13
...
._crit_edge280:                                   ; preds = %._crit_edge276, %._crit_edge270
  ...
  br i1 %i.de, label %bb.h, label %.loopexit, !llvm.loop !14
