...
bb.ai:                                            ; preds = %.lr.ph1165, %.loopexit1039
  ...
  %i.hu = add i32 %i.ht, 2
  %i.hv = add nsw i64 %i.hi, %indvar1680
  %i.hw = add nsw i64 %i.he, %indvar1680
...
bb.ak:                                            ; preds = %.lr.ph1065, %bb.al
  ...
  %i.ke = add nsw i64 %smax1971, %i.jg
...
.lr.ph1083:                                       ; preds = %.lr.ph1083.preheader, %bb.ao
  ...
  %i.ob = add nsw i64 %smax1934, %i.me
...
.lr.ph1122:                                       ; preds = %._crit_edge1111
  ...
  %i.sy = add nsw i64 %i.hv, %i.sr                ; 2 uses
  ...
  %i.tk = add nsw i64 %i.hw, %i.sr                ; 2 uses
  ...
  %i.ts = add nsw i64 %indvars.iv1392, %i.sr      ; 2 uses
...
.lr.ph1237:                                       ; preds = %._crit_edge1184
  ...
  %i.aoi = add i32 %i.anh, 1
  br label %bb.bo

bb.bo:                                            ; preds = %.lr.ph1237, %bb.bv
  %indvar = phi i32 [ 0, %.lr.ph1237 ], [ %indvar.next, %bb.bv ] ; 3 uses
...
bb.bp:                                            ; preds = %.lr.ph1197, %bb.bq
  %indvar1645 = phi i32 [ 0, %.lr.ph1197 ], [ %indvar.next1646, %bb.bq ] ; 2 uses
  %indvars.iv1404 = phi i64 [ %i.aom, %.lr.ph1197 ], [ %indvars.iv.next1405, %bb.bq ] ; 6 uses
  ...
  %smax1658 = call i64 @llvm.smax.i64(i64 %indvars.iv1404, i64 1) ; 2 uses
  %i.aov = mul i32 %indvar1645, %i.anl
  %i.aow = add i32 %i.aoj, %i.aov
  %i.aox = sext i32 %i.aow to i64                 ; 2 uses
  %i.aoy = shl nsw i64 %i.aox, 3                  ; 2 uses
  %scevgep1647 = getelementptr i8, ptr %scevgep1644, i64 %i.aoy
  %16 = call i64 @llvm.smax.i64(i64 %indvars.iv1404, i64 1)
  %i.aoz = add nsw i64 %16, %i.aox                ; 2 uses
  %i.apa = add nsw i64 %i.aoz, %i.anq
...
.lr.ph1189.preheader:                             ; preds = %bb.bp
  %min.iters.check1660 = icmp slt i64 %indvars.iv1404, 8
...
vector.ph1661:                                    ; preds = %vector.memcheck1642
  %n.vec1662 = and i64 %smax1658, 9223372036854775800 ; 3 uses
...
middle.block1676:                                 ; preds = %vector.body1667
  ...
  %cmp.n1677 = icmp eq i64 %smax1658, %n.vec1662
...
.lr.ph1206.preheader:                             ; preds = %.lr.ph1215
  ...
  %i.arj = sub nsw i64 %i.ari, %i.arf             ; 3 uses
