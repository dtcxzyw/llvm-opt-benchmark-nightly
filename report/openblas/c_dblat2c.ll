...
bb.af:                                            ; preds = %bb.ae
  ...
  %i.op = icmp eq i32 %i.ol, %i.om
  %i.oq = icmp eq i32 %i.on, %i.oo
  %i.or = insertelement <2 x i1> poison, i1 %i.op, i64 0
  %i.os = insertelement <2 x i1> %i.or, i1 %i.oq, i64 1
...
bb.n:                                             ; preds = %._crit_edge188
  ...
  %i.jl = icmp eq i32 %i.jh, %i.ji
  %i.jm = icmp eq i32 %i.jj, %i.jk
  %i.jn = insertelement <2 x i1> poison, i1 %i.jl, i64 0
  %i.jo = insertelement <2 x i1> %i.jn, i1 %i.jm, i64 1
