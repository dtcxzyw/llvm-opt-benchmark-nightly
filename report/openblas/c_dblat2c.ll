...
.lr.ph293:                                        ; preds = %bb.b
  ...
  %i.ap = shl nsw i64 %i.r, 3                     ; 2 uses
  %i.aq = add i64 %i.ao, %i.ap
  %30 = add nsw i64 %i.an, %i.ap                  ; 2 uses
  %i.ar = getelementptr i8, ptr %27, i64 %30
  %scevgep = getelementptr i8, ptr %i.ar, i64 8
  %scevgep405 = getelementptr i8, ptr %27, i64 %30
  %scevgep407 = getelementptr i8, ptr %22, i64 8
  %i.as = shl nsw i64 %i.al, 3                    ; 2 uses
  %i.at = add i64 %i.as, %i.i
  %i.au = shl nsw i64 %i.r, 3                     ; 2 uses
  %i.av = add i64 %i.at, %i.au
  %31 = add nsw i64 %i.as, %i.au                  ; 2 uses
  %i.aw = getelementptr i8, ptr %27, i64 %31
  %scevgep473 = getelementptr i8, ptr %i.aw, i64 8
  %scevgep474 = getelementptr i8, ptr %27, i64 %31
...
vector.memcheck472:                               ; preds = %iter.check501
  ...
  %bound0479 = icmp ult ptr %scevgep473, %scevgep478
...
vector.memcheck404:                               ; preds = %iter.check428
  ...
  %bound0 = icmp ult ptr %scevgep, %scevgep409
...
bb.y:                                             ; preds = %.lr.ph357, %._crit_edge352
  ...
  %i.iw = add i32 %.fr407, %indvar797             ; 7 uses
