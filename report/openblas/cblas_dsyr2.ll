...
bb.g:                                             ; preds = %.lr.ph135, %bb.g
  ...
  %.0117133 = phi ptr [ %8, %.lr.ph135 ], [ %i.aj, %bb.g ] ; 3 uses
  ...
  %i.ae = tail call i32 @daxpy_k(i64 noundef %indvars.iv.next139, i64 noundef 0, i64 noundef 0, double noundef %i.ad, ptr noundef %6, i64 noundef 1, ptr noundef %.0117133, i64 noundef 1, ptr noundef null, i64 noundef 0) #4 ; 0 uses
  ...
  %i.ai = tail call i32 @daxpy_k(i64 noundef %indvars.iv.next139, i64 noundef 0, i64 noundef 0, double noundef %i.ah, ptr noundef %4, i64 noundef 1, ptr noundef %.0117133, i64 noundef 1, ptr noundef null, i64 noundef 0) #4 ; 0 uses
  %i.aj = getelementptr inbounds [8 x i8], ptr %.0117133, i64 %i.aa
...
bb.h:                                             ; preds = %.lr.ph, %bb.h
  ...
  %.1118131 = phi ptr [ %8, %.lr.ph ], [ %i.au, %bb.h ] ; 3 uses
  ...
  %i.ap = tail call i32 @daxpy_k(i64 noundef %i.ak, i64 noundef 0, i64 noundef 0, double noundef %i.an, ptr noundef %i.ao, i64 noundef 1, ptr noundef %.1118131, i64 noundef 1, ptr noundef null, i64 noundef 0) #4 ; 0 uses
  %i.aq = load double, ptr %i.ao, align 8, !tbaa !9
  %i.ar = fmul double %3, %i.aq
  %i.as = tail call i32 @daxpy_k(i64 noundef %i.ak, i64 noundef 0, i64 noundef 0, double noundef %i.ar, ptr noundef nonnull %i.al, i64 noundef 1, ptr noundef %.1118131, i64 noundef 1, ptr noundef null, i64 noundef 0) #4 ; 0 uses
  %i.at = getelementptr [8 x i8], ptr %.1118131, i64 %i.z
...
bb.i:                                             ; preds = %bb.e
  ...
  %.0116.idx = select i1 %i.ba, i64 %i.bd, i64 0
  %.0116 = getelementptr inbounds [8 x i8], ptr %6, i64 %.0116.idx ; 2 uses
...
bb.k:                                             ; preds = %num_cpu_avail.exit
  ...
  %i.bu = tail call i32 %i.bt(i64 noundef %i.bo, double noundef %3, ptr noundef %.0115, i64 noundef %i.bp, ptr noundef %.0116, i64 noundef %i.bq, ptr noundef %8, i64 noundef %i.br, ptr noundef %i.be) #4 ; 0 uses
  br label %bb.m
...
bb.l:                                             ; preds = %num_cpu_avail.exit
  ...
  %i.bx = tail call i32 %i.bw(i64 noundef %i.bo, double noundef %3, ptr noundef %.0115, i64 noundef %i.bp, ptr noundef %.0116, i64 noundef %i.bq, ptr noundef %8, i64 noundef %i.br, ptr noundef %i.be, i32 noundef %spec.store.select6) #4 ; 0 uses
  br label %bb.m
