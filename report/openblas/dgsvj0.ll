...
bb.r:                                             ; preds = %.lr.ph1526, %.loopexit1415
  ...
  %i.by = sub nsw i32 %.0, %.012361524            ; 3 uses
  store i32 %i.by, ptr %i.c, align 4, !tbaa !8
  %17 = call i32 @llvm.smin.i32(i32 %i.by, i32 1)
...
.lr.ph1463:                                       ; preds = %.lr.ph1463.preheader, %._crit_edge
  ...
  %.012551458 = phi i32 [ 0, %.lr.ph1463.preheader ], [ %i.pn, %._crit_edge ] ; 4 uses
...
._crit_edge:                                      ; preds = %bb.bw, %.lr.ph1463
  ...
  %i.pn = add nuw nsw i32 %.012551458, 1
...
._crit_edge1497:                                  ; preds = %bb.ea, %.lr.ph1509
  ...
  %i.acr = add nuw nsw i32 %.012381507, 1
