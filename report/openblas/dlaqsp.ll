...
bb.a:
  ...
  %i.c = load i32, ptr %1, align 4, !tbaa !24
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = load double, ptr %4, align 8, !tbaa !26
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.k = load double, ptr %5, align 8, !tbaa !26  ; 2 uses
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %i.o = load i32, ptr %1, align 4, !tbaa !24     ; 5 uses
...
iter.check:                                       ; preds = %.lr.ph.preheader, %.loopexit173
  ...
  %i.r = load double, ptr %i.q, align 8, !tbaa !26 ; 11 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x double>, ptr %i.z, align 8, !tbaa !26, !alias.scope !27
  %wide.load108 = load <4 x double>, ptr %i.aa, align 8, !tbaa !26, !alias.scope !27
  %wide.load109 = load <4 x double>, ptr %i.ab, align 8, !tbaa !26, !alias.scope !27
  %wide.load110 = load <4 x double>, ptr %i.ac, align 8, !tbaa !26, !alias.scope !27
  ...
  %wide.load111 = load <4 x double>, ptr %i.ah, align 8, !tbaa !26, !alias.scope !28, !noalias !27
  %wide.load112 = load <4 x double>, ptr %i.ai, align 8, !tbaa !26, !alias.scope !28, !noalias !27
  %wide.load113 = load <4 x double>, ptr %i.aj, align 8, !tbaa !26, !alias.scope !28, !noalias !27
  %wide.load114 = load <4 x double>, ptr %i.ak, align 8, !tbaa !26, !alias.scope !28, !noalias !27
  ...
  store <4 x double> %i.al, ptr %i.ah, align 8, !tbaa !26, !alias.scope !28, !noalias !27
  store <4 x double> %i.am, ptr %i.ai, align 8, !tbaa !26, !alias.scope !28, !noalias !27
  store <4 x double> %i.an, ptr %i.aj, align 8, !tbaa !26, !alias.scope !28, !noalias !27
  store <4 x double> %i.ao, ptr %i.ak, align 8, !tbaa !26, !alias.scope !28, !noalias !27
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load119 = load <4 x double>, ptr %i.ar, align 8, !tbaa !26, !alias.scope !27
  %i.as = fmul <4 x double> %broadcast.splat117, %wide.load119
  %i.at = getelementptr [8 x i8], ptr %invariant.gep, i64 %index118 ; 2 uses
  %wide.load120 = load <4 x double>, ptr %i.at, align 8, !tbaa !26, !alias.scope !28, !noalias !27
  %i.au = fmul <4 x double> %i.as, %wide.load120
  store <4 x double> %i.au, ptr %i.at, align 8, !tbaa !26, !alias.scope !28, !noalias !27
  %index.next121 = add nuw i64 %index118, 4       ; 2 uses
  %i.av = icmp eq i64 %index.next121, %n.vec115
  br i1 %i.av, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !12
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph.prol
  ...
  %i.bc = load double, ptr %i.bb, align 8, !tbaa !26
  %i.bd = fmul double %i.ba, %i.bc
  store double %i.bd, ptr %i.bb, align 8, !tbaa !26
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv.prol, 1 ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %vec.epilog.scalar.ph.prol.loopexit, label %vec.epilog.scalar.ph.prol, !llvm.loop !13
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  ...
  store double %i.bq, ptr %i.bo, align 8, !tbaa !26
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %i.br = getelementptr inbounds nuw [8 x i8], ptr %i.a, i64 %indvars.iv.next.1
  %i.bs = load double, ptr %i.br, align 8, !tbaa !26
  ...
  store double %i.cc, ptr %i.ca, align 8, !tbaa !26
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4 ; 2 uses
  %i.cd = getelementptr inbounds nuw [8 x i8], ptr %i.a, i64 %indvars.iv.next.3
  %i.ce = load double, ptr %i.cd, align 8, !tbaa !26
  ...
  %i.ch = load double, ptr %i.cg, align 8, !tbaa !26
  %i.ci = fmul double %i.cf, %i.ch
  store double %i.ci, ptr %i.cg, align 8, !tbaa !26
  ...
  %i.ck = load double, ptr %i.cj, align 8, !tbaa !26
  ...
  store double %i.cu, ptr %i.cs, align 8, !tbaa !26
  ...
  %i.cz = load double, ptr %i.cy, align 8, !tbaa !26
  %i.da = fmul double %i.cx, %i.cz
  store double %i.da, ptr %i.cy, align 8, !tbaa !26
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8 ; 2 uses
  %exitcond.not.7 = icmp eq i64 %indvars.iv.next.7, %indvars.iv83
  br i1 %exitcond.not.7, label %.loopexit173, label %vec.epilog.scalar.ph, !llvm.loop !14
...
.loopexit173:                                     ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %vec.epilog.middle.block, %middle.block
  ...
  br i1 %exitcond91.not, label %.loopexit, label %iter.check, !llvm.loop !15
