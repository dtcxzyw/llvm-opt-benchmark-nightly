...
bb.h:                                             ; preds = %bb.d
  ...
  %.077.idx = select i1 %i.ah, i64 %i.al, i64 0
...
bb.j:                                             ; preds = %num_cpu_avail.exit
  ...
  %i.az = tail call i32 %i.ay(i64 noundef %i.av, double noundef %i.d, ptr noundef %.077, i64 noundef %i.aw, ptr noundef %5, ptr noundef %i.am) #3 ; 0 uses
  br label %bb.l
...
bb.k:                                             ; preds = %num_cpu_avail.exit
  ...
  %i.bc = tail call i32 %i.bb(i64 noundef %i.av, double noundef %i.d, ptr noundef %.077, i64 noundef %i.aw, ptr noundef %5, ptr noundef %i.am, i32 noundef %spec.store.select7) #3 ; 0 uses
  br label %bb.l
