...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %.056 = phi ptr [ %5, %bb.b ], [ %3, %bb.a ]    ; 3 uses
  %i.h = icmp sgt i64 %0, 0
  br i1 %i.h, label %.lr.ph, label %._crit_edge

.lr.ph:                                           ; preds = %bb.c, %.loopexit
  %.05562 = phi i64 [ %i.al, %.loopexit ], [ %0, %bb.c ] ; 11 uses
  %umin = tail call i64 @llvm.umin.i64(i64 %.05562, i64 32) ; 4 uses
  %.not70 = icmp eq i64 %0, %.05562
  br i1 %.not70, label %bb.e, label %bb.d

bb.d:                                             ; preds = %.lr.ph
  %i.i = sub nuw nsw i64 %0, %.05562
  %i.j = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.05562
  %i.k = sub nsw i64 %.05562, %umin
  %i.l = mul nsw i64 %i.k, %2
  %i.m = getelementptr inbounds [8 x i8], ptr %i.j, i64 %i.l
  %i.n = getelementptr inbounds nuw [8 x i8], ptr %.056, i64 %.05562 ; 2 uses
  %i.o = sub nsw i64 0, %umin
  %i.p = getelementptr inbounds [8 x i8], ptr %i.n, i64 %i.o
  %i.q = tail call i32 @dgemv_t(i64 noundef %i.i, i64 noundef %umin, i64 noundef 0, double noundef -1.000000e+00, ptr noundef nonnull %i.m, i64 noundef %2, ptr noundef nonnull %i.n, i64 noundef 1, ptr noundef nonnull %i.p, i64 noundef 1, ptr noundef %.057) #3 ; 0 uses
  br label %bb.e

bb.e:                                             ; preds = %bb.d, %.lr.ph
  %i.r = add nsw i64 %.05562, -1                  ; 3 uses
  %i.s = getelementptr inbounds [8 x i8], ptr %.056, i64 %i.r ; 2 uses
...
.peel.next:                                       ; preds = %bb.e, %.peel.next
  %.061 = phi i64 [ %i.ak, %.peel.next ], [ 1, %bb.e ] ; 3 uses
  %i.x = xor i64 %.061, -1
  %i.y = add nsw i64 %.05562, %i.x                ; 3 uses
  ...
  %i.ac = getelementptr inbounds [8 x i8], ptr %.056, i64 %i.y ; 4 uses
  %i.ad = getelementptr inbounds nuw i8, ptr %i.ab, i64 8
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ac, i64 8
  %i.af = tail call double @ddot_k(i64 noundef %.061, ptr noundef nonnull %i.ad, i64 noundef 1, ptr noundef nonnull %i.ae, i64 noundef 1) #3
...
.loopexit:                                        ; preds = %.peel.next
  %i.al = add nsw i64 %.05562, -32
  %i.am = icmp sgt i64 %.05562, 32
