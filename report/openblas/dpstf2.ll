...
begin_hunk_0_@dpstf2_:bb.a
  ...
  store i32 %i.ai, ptr %i.ah, align 4, !tbaa !49
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %._crit_edge, label %.lr.ph, !llvm.loop !10

._crit_edge:                                      ; preds = %.lr.ph, %vec.epilog.middle.block, %middle.block
  %.pre = load i32, ptr %1, align 4, !tbaa !49    ; 3 uses
  %i.aj = load double, ptr %2, align 8, !tbaa !55 ; 4 uses
  store double %i.aj, ptr %i.e, align 8, !tbaa !55
...
bb.g:                                             ; preds = %bb.o, %.lr.ph363.new
  ...
  %i.au = load double, ptr %i.at, align 8, !tbaa !55 ; 3 uses
  %i.av = fcmp ogt double %i.au, %i.ap
  br i1 %i.av, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g
  store double %i.au, ptr %i.e, align 8, !tbaa !55
  br label %bb.i
...
bb.i:                                             ; preds = %bb.g, %bb.h
  ...
  %i.bc = load double, ptr %i.bb, align 8, !tbaa !55 ; 3 uses
  %i.bd = fcmp ogt double %i.bc, %i.aw
  br i1 %i.bd, label %bb.j, label %bb.k

bb.j:                                             ; preds = %bb.i
  store double %i.bc, ptr %i.e, align 8, !tbaa !55
  br label %bb.k
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %i.bk = load double, ptr %i.bj, align 8, !tbaa !55 ; 3 uses
  %i.bl = fcmp ogt double %i.bk, %i.be
  br i1 %i.bl, label %bb.l, label %bb.m

bb.l:                                             ; preds = %bb.k
  store double %i.bk, ptr %i.e, align 8, !tbaa !55
  br label %bb.m
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  %i.bs = load double, ptr %i.br, align 8, !tbaa !55 ; 3 uses
  %i.bt = fcmp ogt double %i.bs, %i.bm
  br i1 %i.bt, label %bb.n, label %bb.o

bb.n:                                             ; preds = %bb.m
  store double %i.bs, ptr %i.e, align 8, !tbaa !55
  br label %bb.o
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  br i1 %niter.ncmp.3, label %._crit_edge364.loopexit.unr-lcssa, label %bb.g, !llvm.loop !11
...
bb.p:                                             ; preds = %bb.r, %.epil.preheader
  ...
  %i.ca = load double, ptr %i.bz, align 8, !tbaa !55 ; 3 uses
  %i.cb = fcmp ogt double %i.ca, %i.bv
  br i1 %i.cb, label %bb.q, label %bb.r

bb.q:                                             ; preds = %bb.p
  store double %i.ca, ptr %i.e, align 8, !tbaa !55
  br label %bb.r
...
bb.r:                                             ; preds = %bb.q, %bb.p
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge364, label %bb.p, !llvm.loop !12
...
._crit_edge369.thread:                            ; preds = %bb.w
  ...
  call void @llvm.memset.p0.i64(ptr align 8 %7, i8 0, i64 %i.cq, i1 false), !tbaa !55
...
bb.x:                                             ; preds = %.lr.ph380, %bb.ae
  %indvar = phi i64 [ 0, %.lr.ph380 ], [ %indvar.next, %bb.ae ] ; 14 uses
  %indvars.iv406 = phi i64 [ 1, %.lr.ph380 ], [ %indvars.iv.next407.pre-phi, %bb.ae ] ; 36 uses
  %.2378 = phi i32 [ %.0.lcssa, %.lr.ph380 ], [ %.3, %bb.ae ] ; 5 uses
  %i.da = xor i64 %indvar, -1
  %i.db = shl nuw nsw i64 %indvar, 3              ; 2 uses
  %scevgep560 = getelementptr i8, ptr %7, i64 %i.db ; 2 uses
  %9 = getelementptr i8, ptr %7, i64 %i.db
  %scevgep562 = getelementptr i8, ptr %9, i64 8   ; 2 uses
  ...
  %i.dl = shl nuw nsw i64 %indvar, 3              ; 2 uses
  %scevgep = getelementptr i8, ptr %7, i64 %i.dl  ; 4 uses
  %10 = getelementptr i8, ptr %7, i64 %i.dl
  %scevgep520 = getelementptr i8, ptr %10, i64 8  ; 2 uses
  ...
  %indvar.tr780 = trunc i64 %indvar to i32
  %i.dr = shl i32 %indvar.tr780, 1
  %12 = add i32 %i.dr, 2                          ; 2 uses
  %i.ds = load i32, ptr %1, align 4, !tbaa !49    ; 5 uses
...
vector.body588:                                   ; preds = %vector.body588, %vector.ph581
  ...
  %wide.masked.gather = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !55, !alias.scope !57
  %wide.masked.gather597 = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep594, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !55, !alias.scope !57
  %wide.masked.gather598 = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep595, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !55, !alias.scope !57
  %wide.masked.gather599 = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep596, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !55, !alias.scope !57
  ...
  %wide.load600 = load <4 x double>, ptr %i.fc, align 8, !tbaa !55, !alias.scope !58
  %wide.load601 = load <4 x double>, ptr %i.fd, align 8, !tbaa !55, !alias.scope !58
  %wide.load602 = load <4 x double>, ptr %i.fe, align 8, !tbaa !55, !alias.scope !58
  %wide.load603 = load <4 x double>, ptr %i.ff, align 8, !tbaa !55, !alias.scope !58
  ...
  store <4 x double> %i.fg, ptr %i.fk, align 8, !tbaa !55, !alias.scope !59, !noalias !60
  store <4 x double> %i.fh, ptr %i.fl, align 8, !tbaa !55, !alias.scope !59, !noalias !60
  store <4 x double> %i.fi, ptr %i.fm, align 8, !tbaa !55, !alias.scope !59, !noalias !60
  store <4 x double> %i.fj, ptr %i.fn, align 8, !tbaa !55, !alias.scope !59, !noalias !60
  ...
  br i1 %i.fo, label %middle.block606, label %vector.body588, !llvm.loop !17
...
vec.epilog.iter.check612:                         ; preds = %middle.block606
  ...
  br i1 %min.epilog.iters.check613, label %.lr.ph373.split.preheader, label %vec.epilog.ph614, !prof !61
...
vec.epilog.vector.body621:                        ; preds = %vec.epilog.vector.body621, %vec.epilog.ph614
  ...
  %wide.masked.gather625 = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep624, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !55, !alias.scope !57
  %i.fu = getelementptr inbounds nuw [8 x i8], ptr %i.f, i64 %i.fr
  %wide.load626 = load <4 x double>, ptr %i.fu, align 8, !tbaa !55, !alias.scope !58
  %i.fv = fsub <4 x double> %wide.masked.gather625, %wide.load626
  %i.fw = getelementptr [8 x i8], ptr %invariant.gep, i64 %i.fr
  store <4 x double> %i.fv, ptr %i.fw, align 8, !tbaa !55, !alias.scope !59, !noalias !60
  ...
  br i1 %i.fx, label %vec.epilog.middle.block629, label %vec.epilog.vector.body621, !llvm.loop !18
...
.lr.ph373.split.prol:                             ; preds = %.lr.ph373.split.preheader, %.lr.ph373.split.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph373.split.prol.loopexit, label %.lr.ph373.split.prol, !llvm.loop !19
...
vector.scevcheck:                                 ; preds = %.lr.ph373.split.us.preheader
  ...
  %mul.result = shl i32 %i.gn, 1
  %13 = add i32 %12, %mul.result
  %i.go = icmp slt i32 %13, %12
...
vector.body549:                                   ; preds = %vector.body549, %vector.ph547
  ...
  %wide.load = load <4 x double>, ptr %i.he, align 8, !tbaa !55, !alias.scope !62 ; 2 uses
  %i.hf = getelementptr inbounds nuw [8 x i8], ptr %i.f, i64 %i.hc ; 2 uses
  %wide.load551 = load <4 x double>, ptr %i.hf, align 8, !tbaa !55, !alias.scope !63, !noalias !64
  %i.hg = call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %wide.load, <4 x double> %wide.load, <4 x double> %wide.load551) ; 2 uses
  store <4 x double> %i.hg, ptr %i.hf, align 8, !tbaa !55, !alias.scope !63, !noalias !64
  %i.hh = mul i32 %i.cr, %i.hd
  %i.hi = sext i32 %i.hh to i64
  %i.hj = getelementptr inbounds [8 x i8], ptr %i.j, i64 %i.hi
  %wide.vec = load <8 x double>, ptr %i.hj, align 8, !tbaa !55, !alias.scope !65
  ...
  store <4 x double> %i.hk, ptr %i.hl, align 8, !tbaa !55, !alias.scope !66, !noalias !67
  %index.next552 = add nuw i64 %index550, 4       ; 2 uses
  %i.hm = icmp eq i64 %index.next552, %n.vec548
  br i1 %i.hm, label %.lr.ph373.split.us.preheader794, label %vector.body549, !llvm.loop !25
...
.lr.ph373.split.us:                               ; preds = %.lr.ph373.split.us.prol.loopexit, %.lr.ph373.split.us
  ...
  store double %i.iz, ptr %gep482.1, align 8, !tbaa !55
  ...
  br i1 %exitcond417.not.1, label %._crit_edge374.split.us, label %.lr.ph373.split.us, !llvm.loop !26
...
._crit_edge374.split.us:                          ; preds = %.lr.ph373.split.us, %.lr.ph373.split.us.prol.loopexit
  ...
  store double %.lcssa797, ptr %i.d, align 8, !tbaa !55
...
.lr.ph373.split:                                  ; preds = %.lr.ph373.split.prol.loopexit, %.lr.ph373.split
  ...
  %i.je = load double, ptr %i.jd, align 8, !tbaa !55
  ...
  store double %i.jh, ptr %gep, align 8, !tbaa !55
  ...
  br i1 %exitcond412.not.3, label %._crit_edge374.thread, label %.lr.ph373.split, !llvm.loop !27
...
begin_hunk_1_@dpstf2_:bb.a
  ...
  %spec.select18.i.4 = select i1 %i.ln, i32 %i.lo, i32 %spec.select18.i.3
  %indvars.iv.next.i.5 = add nsw i64 %indvars.iv.i, 6 ; 2 uses
  %i.lp = getelementptr inbounds [8 x i8], ptr %7, i64 %indvars.iv.next.i.4
  %i.lq = load double, ptr %i.lp, align 8, !tbaa !55 ; 2 uses
  %i.lr = fcmp ogt double %i.lq, %spec.select.i.4 ; 2 uses
  %spec.select.i.5 = select i1 %i.lr, double %i.lq, double %spec.select.i.4 ; 2 uses
  %i.ls = trunc nsw i64 %indvars.iv.next.i.5 to i32
  %spec.select18.i.5 = select i1 %i.lr, i32 %i.ls, i32 %spec.select18.i.4
  %indvars.iv.next.i.6 = add nsw i64 %indvars.iv.i, 7 ; 2 uses
  %i.lt = getelementptr inbounds [8 x i8], ptr %7, i64 %indvars.iv.next.i.5
  %i.lu = load double, ptr %i.lt, align 8, !tbaa !55 ; 2 uses
  %i.lv = fcmp ogt double %i.lu, %spec.select.i.5 ; 2 uses
  %spec.select.i.6 = select i1 %i.lv, double %i.lu, double %spec.select.i.5 ; 2 uses
  %i.lw = trunc nsw i64 %indvars.iv.next.i.6 to i32
  %spec.select18.i.6 = select i1 %i.lv, i32 %i.lw, i32 %spec.select18.i.5
  %indvars.iv.next.i.7 = add nsw i64 %indvars.iv.i, 8 ; 3 uses
  %i.lx = getelementptr inbounds [8 x i8], ptr %7, i64 %indvars.iv.next.i.6
  %i.ly = load double, ptr %i.lx, align 8, !tbaa !55 ; 2 uses
  %i.lz = fcmp ogt double %i.ly, %spec.select.i.6 ; 2 uses
  %spec.select.i.7 = select i1 %i.lz, double %i.ly, double %spec.select.i.6
  %i.ma = trunc nsw i64 %indvars.iv.next.i.7 to i32
  %spec.select18.i.7 = select i1 %i.lz, i32 %i.ma, i32 %spec.select18.i.6 ; 2 uses
...
dmaxloc_.exit:                                    ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i, %bb.y
  %.0.lcssa.i = phi i32 [ %i.ki, %bb.y ], [ %spec.select18.i.lcssa.unr, %.lr.ph.i.prol.loopexit ], [ %spec.select18.i.7, %.lr.ph.i ]
  ...
  %i.mf = load double, ptr %i.me, align 8, !tbaa !55 ; 3 uses
  store double %i.mf, ptr %i.e, align 8, !tbaa !55
...
._crit_edge432:                                   ; preds = %bb.z
  %.pre433 = load double, ptr %i.e, align 8, !tbaa !55
  br label %split
...
bb.aa:                                            ; preds = %._crit_edge374.thread
  ...
  %i.mk = load double, ptr %i.mj, align 8, !tbaa !55
  ...
  store double %i.mk, ptr %i.mo, align 8, !tbaa !55
  %i.mp = trunc i64 %indvars.iv406 to i32
  %i.mq = add i32 %i.mp, -1
  store i32 %i.mq, ptr %i.b, align 4, !tbaa !49
...
bb.ac:                                            ; preds = %bb.ab, %bb.aa
  ...
  %i.ni = xor i32 %i.nh, -1
  %i.nj = add i32 %.3, %i.ni
  store i32 %i.nj, ptr %i.b, align 4, !tbaa !49
  ...
  %i.nr = load double, ptr %i.nq, align 8, !tbaa !55
  %i.ns = sext i32 %.3 to i64                     ; 2 uses
  %i.nt = getelementptr inbounds [8 x i8], ptr %i.f, i64 %i.ns ; 2 uses
  %i.nu = load double, ptr %i.nt, align 8, !tbaa !55
  store double %i.nu, ptr %i.nq, align 8, !tbaa !55
  store double %i.nr, ptr %i.nt, align 8, !tbaa !55
  ...
  store i32 %i.ny, ptr %i.nv, align 4, !tbaa !49
  store i32 %i.nw, ptr %i.nx, align 4, !tbaa !49
  br label %._crit_edge438

._crit_edge438:                                   ; preds = %._crit_edge374.thread, %bb.ac
  %i.nz = load double, ptr %i.e, align 8, !tbaa !55
  %i.oa = call double @sqrt(double noundef %i.nz) #8 ; 2 uses
  store double %i.oa, ptr %i.e, align 8, !tbaa !55
  %i.ob = getelementptr inbounds [8 x i8], ptr %i.j, i64 %.pre447
  store double %i.oa, ptr %i.ob, align 8, !tbaa !55
  %i.oc = load i32, ptr %1, align 4, !tbaa !49    ; 2 uses
...
bb.ad:                                            ; preds = %._crit_edge438
  ...
  %i.og = add i32 %i.of, -1
  store i32 %i.og, ptr %i.b, align 4, !tbaa !49
  %i.oh = trunc nuw nsw i64 %indvars.iv406 to i32 ; 2 uses
  %i.oi = sub nuw nsw i32 %i.oc, %i.oh
  store i32 %i.oi, ptr %i.c, align 4, !tbaa !49
  ...
  %i.or = load i32, ptr %1, align 4, !tbaa !49
  %i.os = sub nsw i32 %i.or, %i.oh
  store i32 %i.os, ptr %i.b, align 4, !tbaa !49
  %i.ot = load double, ptr %i.e, align 8, !tbaa !55
  %i.ou = fdiv double 1.000000e+00, %i.ot
  store double %i.ou, ptr %i.d, align 8, !tbaa !55
...
bb.ae:                                            ; preds = %._crit_edge437, %bb.ad
  ...
  br i1 %.not335.not, label %bb.x, label %.loopexit, !llvm.loop !30
...
bb.af:                                            ; preds = %.lr.ph392, %bb.am
  ...
  %indvars.iv419 = phi i64 [ 1, %.lr.ph392 ], [ %indvars.iv.next420.pre-phi, %bb.am ] ; 36 uses
  %.4390 = phi i32 [ %.0.lcssa, %.lr.ph392 ], [ %.5, %bb.am ] ; 5 uses
  %i.po = xor i64 %indvar633, -1
  %i.pp = shl nuw nsw i64 %indvar633, 3           ; 2 uses
  %scevgep704 = getelementptr i8, ptr %7, i64 %i.pp ; 2 uses
  %14 = getelementptr i8, ptr %7, i64 %i.pp
  %scevgep706 = getelementptr i8, ptr %14, i64 8  ; 2 uses
  ...
  %15 = getelementptr i8, ptr %7, i64 %i.pz
  %scevgep640 = getelementptr i8, ptr %15, i64 8  ; 2 uses
  ...
  %i.qj = load i32, ptr %1, align 4, !tbaa !49    ; 5 uses
...
vector.body734:                                   ; preds = %vector.body734, %vector.ph727
  ...
  %wide.masked.gather744 = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep740, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !55, !alias.scope !68
  %wide.masked.gather745 = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep741, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !55, !alias.scope !68
  %wide.masked.gather746 = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep742, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !55, !alias.scope !68
  %wide.masked.gather747 = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep743, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !55, !alias.scope !68
  ...
  %wide.load748 = load <4 x double>, ptr %i.rt, align 8, !tbaa !55, !alias.scope !69
  %wide.load749 = load <4 x double>, ptr %i.ru, align 8, !tbaa !55, !alias.scope !69
  %wide.load750 = load <4 x double>, ptr %i.rv, align 8, !tbaa !55, !alias.scope !69
  %wide.load751 = load <4 x double>, ptr %i.rw, align 8, !tbaa !55, !alias.scope !69
  ...
  store <4 x double> %i.rx, ptr %i.sb, align 8, !tbaa !55, !alias.scope !70, !noalias !71
  store <4 x double> %i.ry, ptr %i.sc, align 8, !tbaa !55, !alias.scope !70, !noalias !71
  store <4 x double> %i.rz, ptr %i.sd, align 8, !tbaa !55, !alias.scope !70, !noalias !71
  store <4 x double> %i.sa, ptr %i.se, align 8, !tbaa !55, !alias.scope !70, !noalias !71
  ...
  br i1 %i.sf, label %middle.block754, label %vector.body734, !llvm.loop !35
...
vec.epilog.iter.check760:                         ; preds = %middle.block754
  ...
  br i1 %min.epilog.iters.check761, label %.lr.ph384.split.preheader, label %vec.epilog.ph762, !prof !61
...
vec.epilog.vector.body769:                        ; preds = %vec.epilog.vector.body769, %vec.epilog.ph762
  ...
  %wide.masked.gather773 = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep772, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !55, !alias.scope !68
  %i.sl = getelementptr inbounds nuw [8 x i8], ptr %i.f, i64 %i.si
  %wide.load774 = load <4 x double>, ptr %i.sl, align 8, !tbaa !55, !alias.scope !69
  %i.sm = fsub <4 x double> %wide.masked.gather773, %wide.load774
  %i.sn = getelementptr [8 x i8], ptr %invariant.gep483, i64 %i.si
  store <4 x double> %i.sm, ptr %i.sn, align 8, !tbaa !55, !alias.scope !70, !noalias !71
  ...
  br i1 %i.so, label %vec.epilog.middle.block777, label %vec.epilog.vector.body769, !llvm.loop !36
...
.lr.ph384.split.prol:                             ; preds = %.lr.ph384.split.preheader, %.lr.ph384.split.prol
  ...
  br i1 %prol.iter816.cmp.not, label %.lr.ph384.split.prol.loopexit, label %.lr.ph384.split.prol, !llvm.loop !37
end_hunk_1
