...
begin_hunk_0_@dgemm_small_kernel_nn:bb.a
  ...
  br i1 %niter4401.ncmp.7, label %._crit_edge3259.us.unr-lcssa, label %.preheader3019.us.new, !llvm.loop !27
...
bb.g:                                             ; preds = %bb.g, %.epil.preheader4394
  ...
  %i.adc = load <8 x double>, ptr %gep3255.us.epil, align 1, !tbaa !67
  %gep3262.us.epil = getelementptr [8 x i8], ptr %invariant.gep3261.us, i64 %.827633257.us.epil
  %i.add = load double, ptr %gep3262.us.epil, align 1, !tbaa !67
  ...
  br i1 %epil.iter4396.cmp.not, label %._crit_edge3259.us, label %bb.g, !llvm.loop !28
...
._crit_edge3259.us:                               ; preds = %bb.g, %._crit_edge3259.us.unr-lcssa
  ...
  %i.adk = tail call <8 x double> asm "vfmadd231pd ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3264.us, <8 x double> %i.m, <8 x double> %i.adi) #9, !srcloc !122
  store <8 x double> %i.adk, ptr %gep3264.us, align 1, !tbaa !67
  %i.adl = add i64 %.83265.us, 1                  ; 2 uses
  %exitcond3701.not = icmp eq i64 %i.adl, %1
  br i1 %exitcond3701.not, label %._crit_edge3266, label %.preheader3019.us, !llvm.loop !29
...
.lr.ph3244.new:                                   ; preds = %.lr.ph3244, %.lr.ph3244.new
  ...
  %i.adq = load <8 x double>, ptr %gep3240, align 1, !tbaa !67 ; 2 uses
  %i.adr = getelementptr [8 x i8], ptr %6, i64 %.727623243 ; 2 uses
  %i.ads = getelementptr [8 x i8], ptr %i.adr, i64 %i.adm
  %i.adt = load double, ptr %i.ads, align 1, !tbaa !67
  ...
  %i.adx = load double, ptr %i.adw, align 1, !tbaa !67
  ...
  %i.aee = load <8 x double>, ptr %gep3240.1, align 1, !tbaa !67 ; 2 uses
  %i.aef = getelementptr [8 x i8], ptr %6, i64 %i.aec ; 2 uses
  %i.aeg = getelementptr [8 x i8], ptr %i.aef, i64 %i.adm
  %i.aeh = load double, ptr %i.aeg, align 1, !tbaa !67
  ...
  %i.ael = load double, ptr %i.aek, align 1, !tbaa !67
  ...
  %i.aes = load <8 x double>, ptr %gep3240.2, align 1, !tbaa !67 ; 2 uses
  %i.aet = getelementptr [8 x i8], ptr %6, i64 %i.aeq ; 2 uses
  %i.aeu = getelementptr [8 x i8], ptr %i.aet, i64 %i.adm
  %i.aev = load double, ptr %i.aeu, align 1, !tbaa !67
  ...
  %i.aez = load double, ptr %i.aey, align 1, !tbaa !67
  ...
  %i.afg = load <8 x double>, ptr %gep3240.3, align 1, !tbaa !67 ; 2 uses
  %i.afh = getelementptr [8 x i8], ptr %6, i64 %i.afe ; 2 uses
  %i.afi = getelementptr [8 x i8], ptr %i.afh, i64 %i.adm
  %i.afj = load double, ptr %i.afi, align 1, !tbaa !67
  ...
  %i.afn = load double, ptr %i.afm, align 1, !tbaa !67
  ...
  br i1 %niter4393.ncmp.3, label %._crit_edge3245.loopexit.unr-lcssa, label %.lr.ph3244.new, !llvm.loop !30
...
bb.h:                                             ; preds = %bb.h, %.epil.preheader4385
  ...
  %i.afu = load <8 x double>, ptr %gep3240.epil, align 1, !tbaa !67 ; 2 uses
  %i.afv = getelementptr [8 x i8], ptr %6, i64 %.727623243.epil ; 2 uses
  %i.afw = getelementptr [8 x i8], ptr %i.afv, i64 %i.adm
  %i.afx = load double, ptr %i.afw, align 1, !tbaa !67
  ...
  %i.agb = load double, ptr %i.aga, align 1, !tbaa !67
  ...
  br i1 %epil.iter4387.cmp.not, label %._crit_edge3245.loopexit, label %bb.h, !llvm.loop !31
...
._crit_edge3245:                                  ; preds = %.preheader3020.._crit_edge3245_crit_edge, %._crit_edge3245.loopexit
  ...
  %i.agi = tail call <8 x double> asm "vfmadd231pd ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3249, <8 x double> %i.m, <8 x double> %.pre-phi3733) #9, !srcloc !123
  store <8 x double> %i.agi, ptr %gep3249, align 1, !tbaa !67
  %i.agj = mul nsw i64 %.pre-phi3767, %10
  %gep3251 = getelementptr [8 x i8], ptr %invariant.gep3225, i64 %i.agj ; 2 uses
  %i.agk = tail call <8 x double> asm "vfmadd231pd ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3251, <8 x double> %i.m, <8 x double> %.pre-phi3735) #9, !srcloc !124
  store <8 x double> %i.agk, ptr %gep3251, align 1, !tbaa !67
  %i.agl = add nuw nsw i64 %.73252, 2             ; 3 uses
  %i.agm = icmp slt i64 %i.agl, %i.i
  br i1 %i.agm, label %.preheader3020, label %.preheader3022, !llvm.loop !32
...
.preheader3019:                                   ; preds = %.preheader3019.lr.ph, %.preheader3019
  ...
  %i.ago = tail call <8 x double> asm "vfmadd231pd ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3264, <8 x double> %i.m, <8 x double> %i.lt) #9, !srcloc !122
  store <8 x double> %i.ago, ptr %gep3264, align 1, !tbaa !67
  %i.agp = add i64 %.83265, 1                     ; 2 uses
  %exitcond3699.not = icmp eq i64 %i.agp, %1
  br i1 %exitcond3699.not, label %._crit_edge3266, label %.preheader3019, !llvm.loop !29
...
._crit_edge3266:                                  ; preds = %.preheader3019, %._crit_edge3259.us, %.preheader3022
  ...
  br i1 %i.agr, label %.preheader3024, label %._crit_edge3268, !llvm.loop !33

._crit_edge3268:                                  ; preds = %._crit_edge3266, %.preheader3025
  %.2.lcssa = phi i64 [ %.1.lcssa, %.preheader3025 ], [ %i.agq, %._crit_edge3266 ] ; 9 uses
...
.lr.ph3487.new:                                   ; preds = %.lr.ph3487, %.lr.ph3487.new
  ...
  %i.ahx = load double, ptr %i.ahw, align 1, !tbaa !67
  ...
  %i.aib = load double, ptr %i.aia, align 1, !tbaa !67
  ...
  %i.aif = load double, ptr %i.aie, align 1, !tbaa !67
  ...
  %i.aij = load double, ptr %i.aii, align 1, !tbaa !67
  ...
  %i.ain = load double, ptr %i.aim, align 1, !tbaa !67
  ...
  %i.air = load double, ptr %i.aiq, align 1, !tbaa !67
  ...
  %i.ajf = load double, ptr %i.aje, align 1, !tbaa !67
  ...
  %i.ajj = load double, ptr %i.aji, align 1, !tbaa !67
  ...
  %i.ajn = load double, ptr %i.ajm, align 1, !tbaa !67
  ...
  %i.ajr = load double, ptr %i.ajq, align 1, !tbaa !67
  ...
  %i.ajv = load double, ptr %i.aju, align 1, !tbaa !67
  ...
  %i.ajz = load double, ptr %i.ajy, align 1, !tbaa !67
  ...
  br i1 %niter4421.ncmp.1, label %._crit_edge3488.loopexit.unr-lcssa, label %.lr.ph3487.new, !llvm.loop !34
...
.epil.preheader4409:                              ; preds = %._crit_edge3488.loopexit.unr-lcssa, %.lr.ph3487
  ...
  %i.akn = load double, ptr %i.akm, align 1, !tbaa !67
  ...
  %i.akr = load double, ptr %i.akq, align 1, !tbaa !67
  ...
  %i.akv = load double, ptr %i.aku, align 1, !tbaa !67
  ...
  %i.akz = load double, ptr %i.aky, align 1, !tbaa !67
  ...
  %i.ald = load double, ptr %i.alc, align 1, !tbaa !67
  ...
  %i.alh = load double, ptr %i.alg, align 1, !tbaa !67
...
begin_hunk_1_@dgemm_small_kernel_nn:bb.a
  ...
  %i.aom = load double, ptr %i.aol, align 1, !tbaa !67
  ...
  %i.aoq = load double, ptr %i.aop, align 1, !tbaa !67
  ...
  br i1 %niter4430.ncmp.3, label %._crit_edge3515.loopexit.unr-lcssa, label %.lr.ph3514.new, !llvm.loop !36
...
bb.k:                                             ; preds = %bb.k, %.epil.preheader4422
  ...
  %i.apa = load double, ptr %i.aoz, align 1, !tbaa !67
  ...
  %i.ape = load double, ptr %i.apd, align 1, !tbaa !67
  ...
  br i1 %epil.iter4424.cmp.not, label %._crit_edge3515, label %bb.k, !llvm.loop !37
...
._crit_edge3515:                                  ; preds = %._crit_edge3515.loopexit.unr-lcssa, %bb.k, %.preheader2994.._crit_edge3515_crit_edge
  ...
  %i.apm = tail call <8 x double> asm "vfmadd231pd ($1), $2, $0 {$3}", "=v,r,v,^Yk,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3519, <8 x double> %i.m, i8 %i.agy, <8 x double> %i.apk) #9, !srcloc !131
  ...
  %i.app = tail call <8 x double> asm "vfmadd231pd ($1), $2, $0 {$3}", "=v,r,v,^Yk,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3521, <8 x double> %i.m, i8 %i.agy, <8 x double> %i.apn) #9, !srcloc !132
  ...
  br i1 %i.apr, label %.preheader2994, label %.preheader2993, !llvm.loop !38
...
.lr.ph3528.new:                                   ; preds = %.lr.ph3528, %.lr.ph3528.new
  ...
  %i.apv = load double, ptr %gep3532, align 1, !tbaa !67
  ...
  %i.aqc = load double, ptr %gep3532.1, align 1, !tbaa !67
  ...
  %i.aqj = load double, ptr %gep3532.2, align 1, !tbaa !67
  ...
  %i.aqq = load double, ptr %gep3532.3, align 1, !tbaa !67
  ...
  %i.aqx = load double, ptr %gep3532.4, align 1, !tbaa !67
  ...
  %i.are = load double, ptr %gep3532.5, align 1, !tbaa !67
  ...
  %i.arl = load double, ptr %gep3532.6, align 1, !tbaa !67
  ...
  %i.ars = load double, ptr %gep3532.7, align 1, !tbaa !67
  ...
  br i1 %niter4438.ncmp.7, label %._crit_edge3529.loopexit.unr-lcssa, label %.lr.ph3528.new, !llvm.loop !39
...
bb.l:                                             ; preds = %bb.l, %.epil.preheader4431
  ...
  %i.arz = load double, ptr %gep3532.epil, align 1, !tbaa !67
  ...
  br i1 %epil.iter4433.cmp.not, label %._crit_edge3529, label %bb.l, !llvm.loop !40
...
._crit_edge3529:                                  ; preds = %._crit_edge3529.loopexit.unr-lcssa, %bb.l, %.preheader
  ...
  %i.asg = tail call <8 x double> asm "vfmadd231pd ($1), $2, $0 {$3}", "=v,r,v,^Yk,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3534, <8 x double> %i.m, i8 %i.agy, <8 x double> %i.ase) #9, !srcloc !133
  ...
  br i1 %exitcond3721.not, label %.loopexit, label %.preheader, !llvm.loop !41
...
.lr.ph3274:                                       ; preds = %bb.i
  ...
  %i.asl = and i64 %i.ags, 4294967295
  %notmask = shl nsw i64 -1, %i.asl
  %11 = trunc i64 %notmask to i8
  %12 = xor i8 %11, -1
  %13 = and i64 %2, 9223372036854775804
  %invariant.gep3270 = getelementptr [8 x i8], ptr %i.ask, i64 %2
  %i.asm = getelementptr [8 x i8], ptr %3, i64 %.2.lcssa ; 5 uses
  %i.asn = bitcast i8 %12 to <8 x i1>
...
.preheader3017.lr.ph:                             ; preds = %bb.r
  %14 = and i64 %2, 9223372036854775800           ; 9 uses
  %15 = icmp slt i64 %i.atq, %2
  %i.asp = icmp sgt i32 %i.agt, 0
  %or.cond4052 = and i1 %15, %i.asp
  br i1 %or.cond4052, label %.preheader3017.preheader, label %._crit_edge3284.split
...
iter.check:                                       ; preds = %.preheader3017.preheader, %._crit_edge3282
  ...
  %i.att = getelementptr [8 x i8], ptr %i.asm, i64 %i.ats ; 9 uses
...
bb.s:                                             ; preds = %bb.s, %.epil.preheader4402
  ...
  br i1 %epil.iter4404.cmp.not, label %._crit_edge3282, label %bb.s, !llvm.loop !43

._crit_edge3282:                                  ; preds = %bb.s, %._crit_edge3282.unr-lcssa
  %i.atz = add nuw nsw i64 %.1327683283, 1        ; 2 uses
  %16 = icmp slt i64 %i.atz, %2
  br i1 %16, label %iter.check, label %._crit_edge3284.split, !llvm.loop !44
...
bb.t:                                             ; preds = %.lr.ph3302, %bb.t
  ...
  %i.ayu = load <8 x double>, ptr %i.ayt, align 1, !tbaa !67 ; 4 uses
  %i.ayv = getelementptr inbounds nuw [8 x i8], ptr %i.awi, i64 %.1427693301
  %i.ayw = load <8 x double>, ptr %i.ayv, align 1, !tbaa !67 ; 4 uses
  %i.ayx = getelementptr inbounds nuw [8 x i8], ptr %i.awl, i64 %.1427693301
  %i.ayy = load <8 x double>, ptr %i.ayx, align 1, !tbaa !67 ; 4 uses
  %i.ayz = getelementptr inbounds nuw [8 x i8], ptr %i.awo, i64 %.1427693301
  %i.aza = load <8 x double>, ptr %i.ayz, align 1, !tbaa !67 ; 4 uses
  %i.azb = getelementptr [8 x i8], ptr %i.ayj, i64 %.1427693301
  %i.azc = load <8 x double>, ptr %i.azb, align 1, !tbaa !67 ; 4 uses
  %i.azd = getelementptr [8 x i8], ptr %i.aym, i64 %.1427693301
  %i.aze = load <8 x double>, ptr %i.azd, align 1, !tbaa !67 ; 4 uses
  %i.azf = getelementptr [8 x i8], ptr %i.ayp, i64 %.1427693301
  %i.azg = load <8 x double>, ptr %i.azf, align 1, !tbaa !67 ; 4 uses
  %i.azh = getelementptr [8 x i8], ptr %i.ays, i64 %.1427693301
  %i.azi = load <8 x double>, ptr %i.azh, align 1, !tbaa !67 ; 4 uses
  ...
  %i.baa = icmp samesign ult i64 %i.azz, %14
  br i1 %i.baa, label %bb.t, label %._crit_edge3303, !llvm.loop !46
...
bb.v:                                             ; preds = %._crit_edge3303._crit_edge, %bb.u
  ...
  %i.bbw = tail call <4 x double> asm "vfmadd231pd ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3322, <4 x double> %i.avj, <4 x double> %i.bbu) #9, !srcloc !137
  store <4 x double> %i.bbw, ptr %gep3322, align 1, !tbaa !67
  ...
  %i.bcn = tail call <4 x double> asm "vfmadd231pd ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3324, <4 x double> %i.avj, <4 x double> %i.bcl) #9, !srcloc !138
  store <4 x double> %i.bcn, ptr %gep3324, align 1, !tbaa !67
  ...
  %i.bde = tail call <4 x double> asm "vfmadd231pd ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3326, <4 x double> %i.avj, <4 x double> %i.bdc) #9, !srcloc !139
  store <4 x double> %i.bde, ptr %gep3326, align 1, !tbaa !67
  ...
  %i.bdv = tail call <4 x double> asm "vfmadd231pd ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3328, <4 x double> %i.avj, <4 x double> %i.bdt) #9, !srcloc !140
  store <4 x double> %i.bdv, ptr %gep3328, align 1, !tbaa !67
  %i.bdw = add nuw nsw i64 %.123329, 4            ; 3 uses
  %i.bdx = icmp slt i64 %i.bdw, %i.h
  br i1 %i.bdx, label %.lr.ph3302, label %.preheader3015, !llvm.loop !47
...
bb.w:                                             ; preds = %.lr.ph3340, %bb.w
  ...
  %i.beu = load <8 x double>, ptr %i.bet, align 1, !tbaa !67 ; 2 uses
  %i.bev = getelementptr inbounds nuw [8 x i8], ptr %i.axx, i64 %.1527703339
  %i.bew = load <8 x double>, ptr %i.bev, align 1, !tbaa !67 ; 2 uses
  %i.bex = getelementptr inbounds nuw [8 x i8], ptr %i.aya, i64 %.1527703339
  %i.bey = load <8 x double>, ptr %i.bex, align 1, !tbaa !67 ; 2 uses
  %i.bez = getelementptr inbounds nuw [8 x i8], ptr %i.ayd, i64 %.1527703339
  %i.bfa = load <8 x double>, ptr %i.bez, align 1, !tbaa !67 ; 2 uses
  %i.bfb = getelementptr [8 x i8], ptr %i.bep, i64 %.1527703339
  %i.bfc = load <8 x double>, ptr %i.bfb, align 1, !tbaa !67 ; 4 uses
  %i.bfd = getelementptr [8 x i8], ptr %i.bes, i64 %.1527703339
  %i.bfe = load <8 x double>, ptr %i.bfd, align 1, !tbaa !67 ; 4 uses
  ...
  %i.bfo = icmp samesign ult i64 %i.bfn, %14
  br i1 %i.bfo, label %bb.w, label %._crit_edge3341, !llvm.loop !48
...
bb.y:                                             ; preds = %._crit_edge3341._crit_edge, %bb.x
  ...
  %i.bgw = tail call <4 x double> asm "vfmadd231pd ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3352, <4 x double> %i.avj, <4 x double> %i.bgu) #9, !srcloc !141
  store <4 x double> %i.bgw, ptr %gep3352, align 1, !tbaa !67
  ...
  %i.bhn = tail call <4 x double> asm "vfmadd231pd ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3354, <4 x double> %i.avj, <4 x double> %i.bhl) #9, !srcloc !142
  store <4 x double> %i.bhn, ptr %gep3354, align 1, !tbaa !67
  %i.bho = add nuw nsw i64 %.133355, 2            ; 3 uses
  %i.bhp = icmp slt i64 %i.bho, %i.i
  br i1 %i.bhp, label %.lr.ph3340, label %.preheader3014, !llvm.loop !49
...
bb.z:                                             ; preds = %.lr.ph3362, %bb.z
  ...
  %i.bih = icmp samesign ult i64 %i.big, %14
  br i1 %i.bih, label %bb.z, label %._crit_edge3363, !llvm.loop !50
...
bb.ab:                                            ; preds = %bb.aa, %._crit_edge3363
  ...
  %i.bji = tail call <4 x double> asm "vfmadd231pd ($1), $2, $0", "=v,r,v,0,~{dirflag},~{fpsr},~{flags}"(ptr %gep3370, <4 x double> %i.avj, <4 x double> %i.bjg) #9, !srcloc !143
  store <4 x double> %i.bji, ptr %gep3370, align 1, !tbaa !67
  %i.bjj = add i64 %.143371, 1                    ; 2 uses
  %exitcond3705.not = icmp eq i64 %i.bjj, %1
  br i1 %exitcond3705.not, label %._crit_edge3372, label %.lr.ph3362, !llvm.loop !51
...
._crit_edge3372:                                  ; preds = %bb.ab, %.preheader3014
  ...
  br i1 %i.bjl, label %.preheader3016, label %.preheader3010.loopexit, !llvm.loop !52
...
bb.ac:                                            ; preds = %.lr.ph3386, %bb.ac
  ...
  %i.ble = load <8 x double>, ptr %i.bld, align 1, !tbaa !67 ; 4 uses
  %i.blf = getelementptr inbounds nuw [8 x i8], ptr %i.bjq, i64 %.1727723385
  %i.blg = load <8 x double>, ptr %i.blf, align 1, !tbaa !67 ; 4 uses
  %i.blh = getelementptr [8 x i8], ptr %i.bkt, i64 %.1727723385
  %i.bli = load <8 x double>, ptr %i.blh, align 1, !tbaa !67 ; 2 uses
  %i.blj = getelementptr [8 x i8], ptr %i.bkw, i64 %.1727723385
  %i.blk = load <8 x double>, ptr %i.blj, align 1, !tbaa !67 ; 2 uses
  %i.bll = getelementptr [8 x i8], ptr %i.bkz, i64 %.1727723385
  %i.blm = load <8 x double>, ptr %i.bll, align 1, !tbaa !67 ; 2 uses
  %i.bln = getelementptr [8 x i8], ptr %i.blc, i64 %.1727723385
  %i.blo = load <8 x double>, ptr %i.bln, align 1, !tbaa !67 ; 2 uses
  ...
  %i.bly = icmp samesign ult i64 %i.blx, %14
  br i1 %i.bly, label %bb.ac, label %._crit_edge3387, !llvm.loop !53
...
bb.ae:                                            ; preds = %bb.ad, %._crit_edge3387
  ...
  br i1 %i.bof, label %.lr.ph3386, label %.preheader3008, !llvm.loop !54
...
bb.af:                                            ; preds = %.lr.ph3406, %bb.af
  ...
  %i.bou = load <8 x double>, ptr %i.bot, align 1, !tbaa !67 ; 2 uses
  %i.bov = getelementptr inbounds nuw [8 x i8], ptr %i.bkp, i64 %.1827733405
  %i.bow = load <8 x double>, ptr %i.bov, align 1, !tbaa !67 ; 2 uses
  %i.box = getelementptr [8 x i8], ptr %i.bop, i64 %.1827733405
  %i.boy = load <8 x double>, ptr %i.box, align 1, !tbaa !67 ; 2 uses
  %i.boz = getelementptr [8 x i8], ptr %i.bos, i64 %.1827733405
  %i.bpa = load <8 x double>, ptr %i.boz, align 1, !tbaa !67 ; 2 uses
  ...
  %i.bpg = icmp samesign ult i64 %i.bpf, %14
  br i1 %i.bpg, label %bb.af, label %._crit_edge3407, !llvm.loop !55
...
bb.ah:                                            ; preds = %._crit_edge3407._crit_edge, %bb.ag
  ...
  %i.bpv = load <2 x double>, ptr %gep3414, align 8, !tbaa !135
  ...
  store <2 x double> %i.bpz, ptr %gep3414, align 8, !tbaa !135
  ...
  %i.bqd = load <2 x double>, ptr %gep3416, align 8, !tbaa !135
  ...
  store <2 x double> %i.bqh, ptr %gep3416, align 8, !tbaa !135
  %i.bqi = add nuw nsw i64 %.163417, 2            ; 3 uses
  %i.bqj = icmp slt i64 %i.bqi, %i.i
  br i1 %i.bqj, label %.lr.ph3406, label %.preheader3007, !llvm.loop !56
...
bb.ai:                                            ; preds = %.lr.ph3422, %bb.ai
  ...
  %i.bqn = load <8 x double>, ptr %i.bqm, align 1, !tbaa !67
  %i.bqo = getelementptr inbounds nuw [8 x i8], ptr %i.bol, i64 %.1927743421
  %i.bqp = load <8 x double>, ptr %i.bqo, align 1, !tbaa !67
  %i.bqq = getelementptr [8 x i8], ptr %i.bql, i64 %.1927743421
  %i.bqr = load <8 x double>, ptr %i.bqq, align 1, !tbaa !67 ; 2 uses
  ...
  %i.bqv = icmp samesign ult i64 %i.bqu, %14
  br i1 %i.bqv, label %bb.ai, label %._crit_edge3423, !llvm.loop !57
...
bb.ak:                                            ; preds = %bb.aj, %._crit_edge3423
  ...
  %i.brf = load <2 x double>, ptr %gep3428, align 8, !tbaa !135
  ...
  store <2 x double> %i.brj, ptr %gep3428, align 8, !tbaa !135
  %i.brk = add nuw nsw i64 %.173429, 1            ; 2 uses
  %exitcond3709.not = icmp eq i64 %i.brk, %1
  br i1 %exitcond3709.not, label %._crit_edge3430, label %.lr.ph3422, !llvm.loop !58
...
._crit_edge3430:                                  ; preds = %bb.ak, %.preheader3007
  ...
  br i1 %i.brm, label %.preheader3009, label %.preheader3003.loopexit, !llvm.loop !59
...
bb.al:                                            ; preds = %.lr.ph3440, %bb.al
  ...
  %i.bsg = load <8 x double>, ptr %i.bsf, align 1, !tbaa !67 ; 4 uses
  %i.bsh = getelementptr [8 x i8], ptr %i.brv, i64 %.2027753439
  %i.bsi = load <8 x double>, ptr %i.bsh, align 1, !tbaa !67
  %i.bsj = getelementptr [8 x i8], ptr %i.bry, i64 %.2027753439
  %i.bsk = load <8 x double>, ptr %i.bsj, align 1, !tbaa !67
  %i.bsl = getelementptr [8 x i8], ptr %i.bsb, i64 %.2027753439
  %i.bsm = load <8 x double>, ptr %i.bsl, align 1, !tbaa !67
  %i.bsn = getelementptr [8 x i8], ptr %i.bse, i64 %.2027753439
  %i.bso = load <8 x double>, ptr %i.bsn, align 1, !tbaa !67
  ...
  %i.bsu = icmp samesign ult i64 %i.bst, %14
  br i1 %i.bsu, label %bb.al, label %._crit_edge3441, !llvm.loop !60
...
bb.an:                                            ; preds = %bb.am, %._crit_edge3441
  ...
  br i1 %i.bue, label %.lr.ph3440, label %.preheader3001, !llvm.loop !61
...
bb.ao:                                            ; preds = %.lr.ph3454, %bb.ao
  ...
  %i.bup = load <8 x double>, ptr %i.buo, align 1, !tbaa !67 ; 2 uses
  %i.buq = getelementptr [8 x i8], ptr %i.buk, i64 %.213453
  %i.bur = load <8 x double>, ptr %i.buq, align 1, !tbaa !67
  %i.bus = getelementptr [8 x i8], ptr %i.bun, i64 %.213453
  %i.but = load <8 x double>, ptr %i.bus, align 1, !tbaa !67
  ...
  %i.bux = icmp samesign ult i64 %i.buw, %14
  br i1 %i.bux, label %bb.ao, label %._crit_edge3455, !llvm.loop !62
...
bb.ar:                                            ; preds = %.lr.ph3467, %bb.ar
  ...
  %i.bvv = load <8 x double>, ptr %i.bvu, align 1, !tbaa !67
  %i.bvw = getelementptr [8 x i8], ptr %i.bvt, i64 %.223466
  %i.bvx = load <8 x double>, ptr %i.bvw, align 1, !tbaa !67
  ...
  %i.bwa = icmp samesign ult i64 %i.bvz, %14
  br i1 %i.bwa, label %bb.ar, label %._crit_edge3468, !llvm.loop !64
...
._crit_edge3474.a:                                ; preds = %bb.at, %.preheader3000
  ...
  br i1 %exitcond3717.not, label %._crit_edge3477, label %.preheader3002, !llvm.loop !66
