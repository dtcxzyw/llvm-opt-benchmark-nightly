...
bb.o:                                             ; preds = %.lr.ph534, %._crit_edge528
  ...
  %i.jh = mul i64 %i.ja, %indvar1162
  %scevgep.a = getelementptr i8, ptr %4, i64 %i.jh ; 5 uses
...
vector.memcheck1161:                              ; preds = %iter.check1197
  ...
  %scevgep1166 = getelementptr i8, ptr %scevgep.a, i64 %i.kc ; 4 uses
  %6 = icmp ult ptr %scevgep.a, %scevgep1166
  %umin1167 = select i1 %6, ptr %scevgep.a, ptr %scevgep1166
  %7 = icmp ugt ptr %scevgep.a, %scevgep1166
  %umax1168 = select i1 %7, ptr %scevgep.a, ptr %scevgep1166
...
vector.memcheck1288:                              ; preds = %iter.check1337
  ...
  %i.qy = shl nuw nsw i64 %indvars.iv810, 3
  %scevgep1289 = getelementptr nuw i8, ptr %4, i64 %i.qy ; 5 uses
  %8 = udiv i64 %i.qx, %i.pn
  %9 = add i64 %8, %umin1291                      ; 2 uses
  %10 = mul i64 %i.pp, %9
  %scevgep1293.a = getelementptr i8, ptr %scevgep1289, i64 %10 ; 4 uses
  %11 = icmp ult ptr %scevgep1289, %scevgep1293.a
  %umin1294 = select i1 %11, ptr %scevgep1289, ptr %scevgep1293.a
  %12 = icmp ugt ptr %scevgep1289, %scevgep1293.a
  %umax1295 = select i1 %12, ptr %scevgep1289, ptr %scevgep1293.a
...
bb.w:                                             ; preds = %.lr.ph582, %.loopexit427
  ...
  %13 = shl nsw i64 %i.zk, 3                      ; 2 uses
  %scevgep1365 = getelementptr i8, ptr %4, i64 %13 ; 4 uses
...
vector.memcheck1361:                              ; preds = %iter.check1408
  ...
  %14 = getelementptr i8, ptr %4, i64 %i.aaf
  %scevgep1364 = getelementptr i8, ptr %14, i64 %13 ; 4 uses
  %15 = icmp ult ptr %scevgep1364, %scevgep1365
  %umin1366 = select i1 %15, ptr %scevgep1364, ptr %scevgep1365
  %16 = icmp ugt ptr %scevgep1364, %scevgep1365
  %umax1367 = select i1 %16, ptr %scevgep1364, ptr %scevgep1365
...
vector.memcheck1499:                              ; preds = %iter.check1548
  %i.agz = shl i64 %indvars.iv864, 3
  %scevgep1500.a = getelementptr i8, ptr %4, i64 %i.agz ; 5 uses
  ...
  %scevgep1504 = getelementptr i8, ptr %scevgep1500.a, i64 %i.ahe ; 4 uses
  %17 = icmp ult ptr %scevgep1500.a, %scevgep1504
  %umin1505 = select i1 %17, ptr %scevgep1500.a, ptr %scevgep1504
  %18 = icmp ugt ptr %scevgep1500.a, %scevgep1504
  %umax1506 = select i1 %18, ptr %scevgep1500.a, ptr %scevgep1504
