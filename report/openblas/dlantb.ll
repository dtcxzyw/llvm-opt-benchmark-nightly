...
bb.at:                                            ; preds = %.lr.ph578, %.loopexit479
  ...
  %i.ri = add nsw i64 %i.rf, %indvar1037
  ...
  %i.ro = add nsw i64 %i.qz, %indvar1037
  ...
  %i.rx = add nsw i64 %i.qv, %indvar1037
...
.lr.ph593:                                        ; preds = %bb.au
  ...
  %8 = sext i32 %i.us to i64
  %9 = add nsw i64 %8, 1
  %10 = zext nneg i32 %i.ix to i64
  %i.uu = add i32 %i.e, 1
  %11 = sext i32 %i.us to i64
  %12 = add nsw i64 %11, 1
  ...
  %14 = sext i32 %i.us to i64
  %15 = add nsw i64 %14, 1
  %16 = zext nneg i32 %i.ix to i64
  br label %bb.av

bb.av:                                            ; preds = %.lr.ph593, %._crit_edge588
  %indvar1092 = phi i64 [ 0, %.lr.ph593 ], [ %indvar.next1093, %._crit_edge588 ] ; 10 uses
  %indvars.iv762 = phi i64 [ 1, %.lr.ph593 ], [ %indvars.iv.next763, %._crit_edge588 ] ; 9 uses
  %i.uy = add nsw i64 %15, %indvar1092
  %smin1106 = tail call i64 @llvm.smin.i64(i64 %i.uy, i64 %16)
  %i.uz = sub nsw i64 %smin1106, %indvar1092      ; 7 uses
  ...
  %i.vc = add nsw i64 %12, %indvar1092
  %smin1097 = tail call i64 @llvm.smin.i64(i64 %i.vc, i64 %13)
  %i.vd = xor i64 %indvar1092, -1
  %i.ve = add nsw i64 %smin1097, %i.vd
  ...
  %17 = add nsw i64 %9, %indvar1092
  %smin1091 = tail call i64 @llvm.smin.i64(i64 %17, i64 %10)
  %i.vm = xor i64 %indvar1092, -1
  %i.vn = add nsw i64 %smin1091, %i.vm            ; 2 uses
