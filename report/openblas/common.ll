...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.masked.gather = tail call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> align 4 %wide.gep, <8 x i1> splat (i1 true), <8 x float> poison), !tbaa !9, !alias.scope !65
  %wide.gep76 = getelementptr i8, <8 x ptr> %wide.gep, i64 4 ; 2 uses
  %wide.masked.gather77 = tail call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> align 4 %wide.gep76, <8 x i1> splat (i1 true), <8 x float> poison), !tbaa !9, !alias.scope !66
  ...
  %wide.masked.gather82 = tail call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> align 4 %wide.gep76, <8 x i1> splat (i1 true), <8 x float> poison), !tbaa !9, !alias.scope !66
  %wide.masked.gather83 = tail call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> align 4 %wide.gep, <8 x i1> splat (i1 true), <8 x float> poison), !tbaa !9, !alias.scope !65
  %i.ce = fmul <8 x float> %broadcast.splat85, %wide.masked.gather83
  %i.cf = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %broadcast.splat87, <8 x float> %wide.masked.gather82, <8 x float> %i.ce)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.masked.gather = tail call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !12, !alias.scope !78
  %wide.gep76 = getelementptr i8, <4 x ptr> %wide.gep, i64 8 ; 2 uses
  %wide.masked.gather77 = tail call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep76, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !12, !alias.scope !79
  ...
  %wide.masked.gather82 = tail call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep76, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !12, !alias.scope !79
  %wide.masked.gather83 = tail call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !12, !alias.scope !78
  %i.cd = fmul <4 x double> %broadcast.splat85, %wide.masked.gather83
  %i.ce = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %broadcast.splat87, <4 x double> %wide.masked.gather82, <4 x double> %i.cd)
