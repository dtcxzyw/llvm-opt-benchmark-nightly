...
.preheader.preheader:                             ; preds = %.preheader.lr.ph
  ...
  %mul.result52 = shl nsw i64 %i.l, 2             ; 2 uses
...
vector.scevcheck:                                 ; preds = %.preheader
  ...
  %i.bb = getelementptr i8, ptr %scevgep, i64 %mul.result52
...
.preheader.preheader:                             ; preds = %.preheader.lr.ph
  ...
  %mul.result52 = shl nsw i64 %i.l, 3             ; 2 uses
...
.preheader.preheader:                             ; preds = %.preheader.lr.ph
  ...
  %mul.result52 = shl nsw i64 %i.k, 2             ; 4 uses
...
vector.scevcheck:                                 ; preds = %.preheader
  ...
  %i.ak = getelementptr i8, ptr %scevgep, i64 %mul.result52
  %i.al = icmp ult ptr %i.ak, %scevgep
  %i.am = getelementptr i8, ptr %scevgep50, i64 %mul.result52
  %i.an = icmp ult ptr %i.am, %scevgep50
  %8 = getelementptr i8, ptr %scevgep54, i64 %mul.result52
  %9 = icmp ult ptr %8, %scevgep54
  %10 = or i1 %9, %mul.overflow53
  %i.ao = getelementptr i8, ptr %scevgep58, i64 %mul.result52
  %i.ap = icmp ult ptr %i.ao, %scevgep58
  %i.aq = or i1 %i.an, %i.al
  %i.ar = or i1 %i.aq, %10
...
.preheader.preheader:                             ; preds = %.preheader.lr.ph
  ...
  %i.y = add nuw i64 %i.x, 1                      ; 2 uses
  %min.iters.check = icmp ult i64 %i.w, 30
  %mul.result52 = shl nsw i64 %i.k, 3             ; 4 uses
