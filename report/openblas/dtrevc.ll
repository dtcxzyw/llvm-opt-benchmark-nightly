...
.lr.ph1263:                                       ; preds = %.lr.ph1263.preheader, %.epilog-lcssa
  ...
  %i.cu = add nuw nsw i64 %indvar, 1              ; 2 uses
...
.lr.ph1331:                                       ; preds = %bb.dj
  ...
  %i.atx = sext i32 %i.atq to i64                 ; 5 uses
...
vector.memcheck1718:                              ; preds = %.lr.ph1331
  %i.aug = shl nsw i64 %i.aua, 3                  ; 2 uses
  %14 = shl nsw i64 %i.atx, 3                     ; 8 uses
  %15 = getelementptr i8, ptr %scevgep1719, i64 %i.aug
  %scevgep1720 = getelementptr i8, ptr %15, i64 %14 ; 5 uses
  ...
  %16 = getelementptr i8, ptr %12, i64 %i.aug
  %i.aul = getelementptr i8, ptr %16, i64 %14
  %scevgep1721 = getelementptr i8, ptr %i.aul, i64 %i.auk ; 5 uses
  %scevgep1723 = getelementptr i8, ptr %scevgep1722, i64 %14 ; 5 uses
  %i.aum = getelementptr i8, ptr %scevgep1724, i64 %14
  ...
  %17 = shl nsw i64 %i.atz, 3                     ; 2 uses
  %18 = getelementptr i8, ptr %scevgep1727, i64 %14
  %scevgep1728 = getelementptr i8, ptr %18, i64 %17 ; 2 uses
  %i.auo = getelementptr i8, ptr %scevgep1729, i64 %14
  %scevgep1730.a = getelementptr i8, ptr %i.auo, i64 %17
  %scevgep1730 = getelementptr i8, ptr %scevgep1730.a, i64 %i.auk ; 2 uses
  %i.aup = shl nsw i64 %i.aty, 3                  ; 2 uses
  %19 = getelementptr i8, ptr %scevgep1731, i64 %i.aup
  %scevgep1732 = getelementptr i8, ptr %19, i64 %14 ; 2 uses
  %scevgep1732.a = getelementptr i8, ptr %scevgep1733, i64 %i.aup
  %i.auq = getelementptr i8, ptr %scevgep1732.a, i64 %14
  ...
  %bound01743 = icmp ult ptr %scevgep1720, %scevgep1730
  ...
  %bound11748 = icmp ult ptr %scevgep1732, %scevgep1721
  ...
  %bound01759 = icmp ult ptr %scevgep1723, %scevgep1730
  ...
  %bound11764 = icmp ult ptr %scevgep1732, %scevgep1725
