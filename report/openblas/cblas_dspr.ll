...
.lr.ph100:                                        ; preds = %.lr.ph100.preheader, %.lr.ph100._crit_edge
  ...
  %.08298 = phi ptr [ %6, %.lr.ph100.preheader ], [ %i.z, %.lr.ph100._crit_edge ] ; 2 uses
...
bb.g:                                             ; preds = %.lr.ph100
  ...
  %i.y = tail call i32 @daxpy_k(i64 noundef %i.w, i64 noundef 0, i64 noundef 0, double noundef %i.x, ptr noundef nonnull %4, i64 noundef 1, ptr noundef %.08298, i64 noundef 1, ptr noundef null, i64 noundef 0) #4 ; 0 uses
  br label %.lr.ph100._crit_edge

.lr.ph100._crit_edge:                             ; preds = %.lr.ph100, %bb.g
  %i.z = getelementptr inbounds nuw [8 x i8], ptr %.08298, i64 %i.w
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph._crit_edge
  ...
  %.18396 = phi ptr [ %6, %.lr.ph.preheader ], [ %i.ag, %.lr.ph._crit_edge ] ; 2 uses
...
bb.h:                                             ; preds = %.lr.ph
  ...
  %i.af = tail call i32 @daxpy_k(i64 noundef %i.ad, i64 noundef 0, i64 noundef 0, double noundef %i.ae, ptr noundef nonnull %i.aa, i64 noundef 1, ptr noundef %.18396, i64 noundef 1, ptr noundef null, i64 noundef 0) #4 ; 0 uses
  br label %.lr.ph._crit_edge

.lr.ph._crit_edge:                                ; preds = %.lr.ph, %bb.h
  %i.ag = getelementptr inbounds nuw [8 x i8], ptr %.18396, i64 %i.ad
...
bb.i:                                             ; preds = %bb.e
  ...
  %.081.idx = select i1 %i.ah, i64 %i.al, i64 0
  %.081 = getelementptr inbounds [8 x i8], ptr %4, i64 %.081.idx ; 2 uses
...
bb.k:                                             ; preds = %num_cpu_avail.exit
  ...
  %i.ba = tail call i32 %i.az(i64 noundef %i.aw, double noundef %3, ptr noundef %.081, i64 noundef %i.ax, ptr noundef %6, ptr noundef %i.am) #4 ; 0 uses
  br label %bb.m
...
bb.l:                                             ; preds = %num_cpu_avail.exit
  ...
  %i.bd = tail call i32 %i.bc(i64 noundef %i.aw, double noundef %3, ptr noundef %.081, i64 noundef %i.ax, ptr noundef %6, ptr noundef %i.am, i32 noundef %spec.store.select8) #4 ; 0 uses
  br label %bb.m
