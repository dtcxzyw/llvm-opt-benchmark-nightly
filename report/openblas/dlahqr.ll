...
bb.ab:                                            ; preds = %bb.ac
  ...
  br i1 %.not789.not, label %.lr.ph988, label %._crit_edge989.loopexit, !llvm.loop !11
...
.lr.ph988:                                        ; preds = %bb.aa, %bb.ab
  ...
  %i.nj = load double, ptr %i.ni, align 8, !tbaa !44 ; 4 uses
  ...
  %i.nr = fdiv double %i.ml, %i.mx                ; 2 uses
  %i.ns = call double @llvm.fmuladd.f64(double %i.nr, double %i.nc, double %i.ne)
  %i.nt = call double @llvm.fmuladd.f64(double %i.me, double %i.nf, double %i.ns) ; 4 uses
  %i.nu = insertelement <2 x double> poison, double %i.nm, i64 0
  %i.nv = insertelement <2 x double> %i.nu, double %i.nq, i64 1
  %i.nw = insertelement <2 x double> poison, double %i.nr, i64 0
  %i.nx = shufflevector <2 x double> %i.nw, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ny = fmul <2 x double> %i.nv, %i.nx          ; 3 uses
  %i.nz = fcmp oge double %i.nt, 0.000000e+00
  %i.oa = fneg double %i.nt
  %i.ob = select i1 %i.nz, double %i.nt, double %i.oa
  %i.oc = extractelement <2 x double> %i.ny, i64 0 ; 3 uses
  %i.od = fcmp oge double %i.oc, 0.000000e+00
  %i.oe = fneg double %i.oc
  %i.of = select i1 %i.od, double %i.oc, double %i.oe
  %i.og = fadd double %i.of, %i.ob
  %i.oh = extractelement <2 x double> %i.ny, i64 1 ; 3 uses
  ...
  %i.om = fdiv double %i.nt, %i.ol                ; 5 uses
  ...
  %i.op = fdiv <2 x double> %i.ny, %i.oo          ; 5 uses
...
bb.ac:                                            ; preds = %.lr.ph988
  ...
  %i.ou = load double, ptr %i.ot, align 8, !tbaa !44 ; 3 uses
  ...
  %i.pj = load double, ptr %i.pi, align 8, !tbaa !44 ; 3 uses
  ...
  %i.pr = fcmp oge double %i.nj, 0.000000e+00
  %i.ps = fneg double %i.nj
  %i.pt = select i1 %i.pr, double %i.nj, double %i.ps
  %i.pu = fadd double %i.pt, %i.pq
  %i.pv = fmul double %i.pg, %i.pu
  %i.pw = fcmp ugt double %i.pc, %i.pv
  br i1 %i.pw, label %bb.ab, label %._crit_edge990, !llvm.loop !11

._crit_edge990:                                   ; preds = %bb.ac
  store double %i.om, ptr %i.b, align 16, !tbaa !44
  store <2 x double> %i.op, ptr %i.cv, align 8, !tbaa !44
  br label %._crit_edge989, !llvm.loop !11
...
bb.ad:                                            ; preds = %.lr.ph852, %.loopexit
  %indvar = phi i64 [ 0, %.lr.ph852 ], [ %indvar.next, %.loopexit ] ; 10 uses
  %indvars.iv887 = phi i64 [ %i.py, %.lr.ph852 ], [ %indvars.iv.next888, %.loopexit ] ; 39 uses
  ...
  %i.sv = shl nsw i64 %indvars.iv887, 4
  %14 = getelementptr i8, ptr %5, i64 %i.sv
  %scevgep1140 = getelementptr i8, ptr %14, i64 -8
  %15 = add i64 %indvar, %i.py
  %i.sw = shl i64 %15, 4
  %16 = getelementptr i8, ptr %5, i64 %i.sw
  %scevgep1135 = getelementptr i8, ptr %16, i64 -16
  ...
  store i32 %i.ti, ptr %i.f, align 4, !tbaa !42
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.tp = load double, ptr %i.b, align 16, !tbaa !44
  %i.tq = add nsw i64 %indvars.iv887, -1
  %i.tr = mul nsw i64 %i.tq, %i.cx                ; 2 uses
  store double %i.tp, ptr %i.to, align 8, !tbaa !44
  ...
  store double 0.000000e+00, ptr %i.tu, align 8, !tbaa !44
...
bb.af:                                            ; preds = %bb.ae
  ...
  store double 0.000000e+00, ptr %i.ty, align 8, !tbaa !44
  br label %bb.ai
...
bb.ah:                                            ; preds = %bb.ag
  %i.tz = load double, ptr %i.c, align 8, !tbaa !44
  ...
  %i.ug = load double, ptr %i.uf, align 8, !tbaa !44
  %i.uh = fmul double %i.ug, %i.ua
  store double %i.uh, ptr %i.uf, align 8, !tbaa !44
  br label %bb.ai

bb.ai:                                            ; preds = %bb.ag, %bb.ah, %bb.ae, %bb.af
  %i.ui = load double, ptr %i.cv, align 8, !tbaa !44 ; 35 uses
  %i.uj = load double, ptr %i.c, align 8, !tbaa !44 ; 36 uses
  %i.uk = fmul double %i.ui, %i.uj                ; 34 uses
  %i.ul = load i32, ptr %i.f, align 4, !tbaa !42
...
.ph.lver.orig.prol:                               ; preds = %.ph.lver.orig.preheader, %.ph.lver.orig.prol
  ...
  %i.up = load double, ptr %gep.lver.orig.prol, align 8, !tbaa !44 ; 2 uses
  %i.uq = getelementptr [8 x i8], ptr %i.un, i64 %i.uo ; 2 uses
  %i.ur = load double, ptr %i.uq, align 8, !tbaa !44 ; 2 uses
  ...
  store double %i.uu, ptr %gep.lver.orig.prol, align 8, !tbaa !44
  %i.uv = call double @llvm.fmuladd.f64(double %i.ut, double %i.uk, double %i.ur)
  store double %i.uv, ptr %i.uq, align 8, !tbaa !44
  ...
  br i1 %prol.iter1157.cmp.not, label %.ph.lver.orig.prol.loopexit, label %.ph.lver.orig.prol, !llvm.loop !12
...
.ph.lver.orig:                                    ; preds = %.ph.lver.orig.prol.loopexit, %.ph.lver.orig
  ...
  %i.uy = load double, ptr %gep.lver.orig, align 8, !tbaa !44 ; 2 uses
  %i.uz = getelementptr [8 x i8], ptr %i.un, i64 %i.ux ; 2 uses
  %i.va = load double, ptr %i.uz, align 8, !tbaa !44 ; 2 uses
  ...
  store double %i.vd, ptr %gep.lver.orig, align 8, !tbaa !44
  %i.ve = call double @llvm.fmuladd.f64(double %i.vc, double %i.uk, double %i.va)
  store double %i.ve, ptr %i.uz, align 8, !tbaa !44
  ...
  %i.vg = load double, ptr %gep.lver.orig.1, align 8, !tbaa !44 ; 2 uses
  %i.vh = getelementptr [8 x i8], ptr %i.un, i64 %i.vf ; 2 uses
  %i.vi = load double, ptr %i.vh, align 8, !tbaa !44 ; 2 uses
  ...
  store double %i.vl, ptr %gep.lver.orig.1, align 8, !tbaa !44
  %i.vm = call double @llvm.fmuladd.f64(double %i.vk, double %i.uk, double %i.vi)
  store double %i.vm, ptr %i.vh, align 8, !tbaa !44
  ...
  %i.vo = load double, ptr %gep.lver.orig.2, align 8, !tbaa !44 ; 2 uses
  %i.vp = getelementptr [8 x i8], ptr %i.un, i64 %i.vn ; 2 uses
  %i.vq = load double, ptr %i.vp, align 8, !tbaa !44 ; 2 uses
  ...
  store double %i.vt, ptr %gep.lver.orig.2, align 8, !tbaa !44
  %i.vu = call double @llvm.fmuladd.f64(double %i.vs, double %i.uk, double %i.vq)
  store double %i.vu, ptr %i.vp, align 8, !tbaa !44
  ...
  %i.vw = load double, ptr %gep.lver.orig.3, align 8, !tbaa !44 ; 2 uses
  %i.vx = getelementptr [8 x i8], ptr %i.un, i64 %i.vv ; 2 uses
  %i.vy = load double, ptr %i.vx, align 8, !tbaa !44 ; 2 uses
  ...
  store double %i.wb, ptr %gep.lver.orig.3, align 8, !tbaa !44
  %i.wc = call double @llvm.fmuladd.f64(double %i.wa, double %i.uk, double %i.vy)
  store double %i.wc, ptr %i.vx, align 8, !tbaa !44
  ...
  br i1 %exitcond894.not.lver.orig.3, label %.preheader, label %.ph.lver.orig, !llvm.loop !13
...
.prol.preheader:                                  ; preds = %.ph, %.prol.preheader
  ...
  %i.wf = load double, ptr %i.we, align 8, !tbaa !44 ; 2 uses
  ...
  store double %i.wi, ptr %gep.prol, align 8, !tbaa !44
  %i.wj = call double @llvm.fmuladd.f64(double %i.wh, double %i.uk, double %i.wf) ; 3 uses
  store double %i.wj, ptr %i.we, align 8, !tbaa !44
