...
.preheader184:                                    ; preds = %.preheader184.preheader, %._crit_edge199
  ...
  %scevgep346 = getelementptr i8, ptr %i.bz, i64 %i.ch
  %scevgep348 = getelementptr i8, ptr %8, i64 %i.cf
...
iter.check385:                                    ; preds = %.preheader184
  ...
  %i.cp = getelementptr inbounds nuw [8 x i8], ptr %i.i, i64 %indvars.iv237 ; 7 uses
...
vector.memcheck343:                               ; preds = %iter.check385
  %bound0349 = icmp ult ptr %9, %scevgep346
  ...
  %bound0356 = icmp ult ptr %9, %scevgep348
