...
bb.j:                                             ; preds = %bb.r, %.lr.ph458.new
  ...
  %i.az = load double, ptr %i.ay, align 8, !tbaa !57 ; 3 uses
  %i.ba = fcmp ogt double %i.az, %i.au
  br i1 %i.ba, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  store double %i.az, ptr %i.g, align 8, !tbaa !57
  br label %bb.l
...
bb.l:                                             ; preds = %bb.j, %bb.k
  ...
  %i.bh = load double, ptr %i.bg, align 8, !tbaa !57 ; 3 uses
  %i.bi = fcmp ogt double %i.bh, %i.bb
  br i1 %i.bi, label %bb.m, label %bb.n

bb.m:                                             ; preds = %bb.l
  store double %i.bh, ptr %i.g, align 8, !tbaa !57
  br label %bb.n
...
bb.n:                                             ; preds = %bb.m, %bb.l
  ...
  %i.bp = load double, ptr %i.bo, align 8, !tbaa !57 ; 3 uses
  %i.bq = fcmp ogt double %i.bp, %i.bj
  br i1 %i.bq, label %bb.o, label %bb.p

bb.o:                                             ; preds = %bb.n
  store double %i.bp, ptr %i.g, align 8, !tbaa !57
  br label %bb.p
...
bb.p:                                             ; preds = %bb.o, %bb.n
  ...
  %i.bx = load double, ptr %i.bw, align 8, !tbaa !57 ; 3 uses
  %i.by = fcmp ogt double %i.bx, %i.br
  br i1 %i.by, label %bb.q, label %bb.r

bb.q:                                             ; preds = %bb.p
  store double %i.bx, ptr %i.g, align 8, !tbaa !57
  br label %bb.r
...
bb.r:                                             ; preds = %bb.q, %bb.p
  ...
  br i1 %niter.ncmp.3, label %._crit_edge459.loopexit.unr-lcssa, label %bb.j, !llvm.loop !11
...
bb.s:                                             ; preds = %bb.u, %.epil.preheader
  ...
  %i.cf = load double, ptr %i.ce, align 8, !tbaa !57 ; 3 uses
  %i.cg = fcmp ogt double %i.cf, %i.ca
  br i1 %i.cg, label %bb.t, label %bb.u

bb.t:                                             ; preds = %bb.s
  store double %i.cf, ptr %i.g, align 8, !tbaa !57
  br label %bb.u
...
bb.u:                                             ; preds = %bb.t, %bb.s
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge459, label %bb.s, !llvm.loop !12
...
bb.ab:                                            ; preds = %.lr.ph483, %bb.ak
  ...
  %i.ea = mul i64 %i.dm, %indvar                  ; 2 uses
  ...
  %i.ei = mul i64 %i.dc, %indvar                  ; 2 uses
...
.lr.ph463.preheader:                              ; preds = %bb.ab
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep, i8 0, i64 %i.fe, i1 false), !tbaa !57
...
._crit_edge464:                                   ; preds = %.lr.ph463.preheader, %bb.ab
  ...
  store i32 %i.fh, ptr %i.b, align 4, !tbaa !51
...
.lr.ph475.preheader:                              ; preds = %._crit_edge464
  ...
  %9 = getelementptr i8, ptr %7, i64 %i.ea
  %i.fj = getelementptr i8, ptr %7, i64 %i.ea
  %10 = getelementptr i8, ptr %i.fj, i64 8
  %11 = getelementptr i8, ptr %7, i64 %i.ei
  %i.fk = getelementptr i8, ptr %7, i64 %i.ei
  %12 = getelementptr i8, ptr %i.fk, i64 8
...
.lr.ph475:                                        ; preds = %.lr.ph475.preheader, %bb.ai
  ...
  %indvars.iv529 = phi i64 [ %indvars.iv527, %.lr.ph475.preheader ], [ %indvars.iv.next530.pre-phi, %bb.ai ] ; 33 uses
  %.3473 = phi i32 [ %.2481, %.lr.ph475.preheader ], [ %.4, %bb.ai ]
  %i.fq = xor i64 %indvar665, -1
  %i.fr = add i64 %i.dz, %i.fq
  %i.fs = trunc i64 %i.fr to i32
  %i.ft = shl nuw nsw i64 %indvar665, 3           ; 2 uses
  %scevgep708 = getelementptr i8, ptr %9, i64 %i.ft ; 2 uses
  %scevgep710 = getelementptr i8, ptr %10, i64 %i.ft ; 2 uses
  ...
  %i.gj = shl nuw nsw i64 %indvar665, 3           ; 2 uses
  %scevgep667 = getelementptr i8, ptr %11, i64 %i.gj ; 4 uses
  %scevgep668 = getelementptr i8, ptr %12, i64 %i.gj ; 2 uses
  ...
  %i.gu = load i32, ptr %1, align 4, !tbaa !51    ; 16 uses
  store i32 %i.gu, ptr %i.c, align 4, !tbaa !51
...
vector.body736:                                   ; preds = %vector.body736, %vector.ph729
  ...
  %wide.masked.gather = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !57, !alias.scope !59
  %wide.masked.gather745 = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep742, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !57, !alias.scope !59
  %wide.masked.gather746 = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep743, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !57, !alias.scope !59
  %wide.masked.gather747 = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep744, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !57, !alias.scope !59
  ...
  %wide.load748 = load <4 x double>, ptr %i.id, align 8, !tbaa !57, !alias.scope !60
  %wide.load749 = load <4 x double>, ptr %i.ie, align 8, !tbaa !57, !alias.scope !60
  %wide.load750 = load <4 x double>, ptr %i.if, align 8, !tbaa !57, !alias.scope !60
  %wide.load751 = load <4 x double>, ptr %i.ig, align 8, !tbaa !57, !alias.scope !60
  ...
  store <4 x double> %i.ih, ptr %i.il, align 8, !tbaa !57, !alias.scope !61, !noalias !62
  store <4 x double> %i.ii, ptr %i.im, align 8, !tbaa !57, !alias.scope !61, !noalias !62
  store <4 x double> %i.ij, ptr %i.in, align 8, !tbaa !57, !alias.scope !61, !noalias !62
  store <4 x double> %i.ik, ptr %i.io, align 8, !tbaa !57, !alias.scope !61, !noalias !62
  ...
  br i1 %i.ip, label %middle.block754, label %vector.body736, !llvm.loop !17
...
vec.epilog.iter.check760:                         ; preds = %middle.block754
  ...
  br i1 %min.epilog.iters.check761, label %.lr.ph468.split.preheader, label %vec.epilog.ph762, !prof !63
...
vec.epilog.vector.body769:                        ; preds = %vec.epilog.vector.body769, %vec.epilog.ph762
  ...
  %wide.masked.gather773 = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep772, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !57, !alias.scope !59
  %i.iv = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %i.is
  %wide.load774 = load <4 x double>, ptr %i.iv, align 8, !tbaa !57, !alias.scope !60
  %i.iw = fsub <4 x double> %wide.masked.gather773, %wide.load774
  %i.ix = getelementptr [8 x i8], ptr %invariant.gep, i64 %i.is
  store <4 x double> %i.iw, ptr %i.ix, align 8, !tbaa !57, !alias.scope !61, !noalias !62
  ...
  br i1 %i.iy, label %vec.epilog.middle.block777, label %vec.epilog.vector.body769, !llvm.loop !18
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.preheader.i, %.lr.ph.i.prol
  ...
  %.04.i.prol = phi i32 [ %spec.select18.i.prol, %.lr.ph.i.prol ], [ %i.no, %.lr.ph.preheader.i ]
  %.0152.i.prol = phi double [ %spec.select.i.prol, %.lr.ph.i.prol ], [ %i.nt, %.lr.ph.preheader.i ] ; 2 uses
  ...
  %i.nw = load double, ptr %i.nv, align 8, !tbaa !57 ; 2 uses
  %i.nx = fcmp ogt double %i.nw, %.0152.i.prol    ; 2 uses
  %spec.select.i.prol = select i1 %i.nx, double %i.nw, double %.0152.i.prol ; 2 uses
  %i.ny = trunc nsw i64 %indvars.iv.next.i.prol to i32
  %spec.select18.i.prol = select i1 %i.nx, i32 %i.ny, i32 %.04.i.prol ; 3 uses
  %prol.iter963.next = add i64 %prol.iter963, 1   ; 2 uses
  %prol.iter963.cmp.not = icmp eq i64 %prol.iter963.next, %xtraiter961
  br i1 %prol.iter963.cmp.not, label %.lr.ph.i.prol.loopexit, label %.lr.ph.i.prol, !llvm.loop !28

.lr.ph.i.prol.loopexit:                           ; preds = %.lr.ph.i.prol, %.lr.ph.preheader.i
  %spec.select18.i.lcssa.unr = phi i32 [ poison, %.lr.ph.preheader.i ], [ %spec.select18.i.prol, %.lr.ph.i.prol ]
  %indvars.iv.i.unr = phi i64 [ %i.nq, %.lr.ph.preheader.i ], [ %indvars.iv.next.i.prol, %.lr.ph.i.prol ]
  %.04.i.unr = phi i32 [ %i.no, %.lr.ph.preheader.i ], [ %spec.select18.i.prol, %.lr.ph.i.prol ]
  %.0152.i.unr = phi double [ %i.nt, %.lr.ph.preheader.i ], [ %spec.select.i.prol, %.lr.ph.i.prol ]
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %.04.i = phi i32 [ %spec.select18.i.7, %.lr.ph.i ], [ %.04.i.unr, %.lr.ph.i.prol.loopexit ]
  %.0152.i = phi double [ %spec.select.i.7, %.lr.ph.i ], [ %.0152.i.unr, %.lr.ph.i.prol.loopexit ] ; 2 uses
  %indvars.iv.next.i = add nsw i64 %indvars.iv.i, 1 ; 2 uses
  %i.ob = getelementptr inbounds [8 x i8], ptr %7, i64 %indvars.iv.i
  %i.oc = load double, ptr %i.ob, align 8, !tbaa !57 ; 2 uses
  %i.od = fcmp ogt double %i.oc, %.0152.i         ; 2 uses
  %spec.select.i = select i1 %i.od, double %i.oc, double %.0152.i ; 2 uses
  %i.oe = trunc nsw i64 %indvars.iv.next.i to i32
  %spec.select18.i = select i1 %i.od, i32 %i.oe, i32 %.04.i
  %indvars.iv.next.i.1 = add nsw i64 %indvars.iv.i, 2 ; 2 uses
  %i.of = getelementptr inbounds [8 x i8], ptr %7, i64 %indvars.iv.next.i
  %i.og = load double, ptr %i.of, align 8, !tbaa !57 ; 2 uses
  %i.oh = fcmp ogt double %i.og, %spec.select.i   ; 2 uses
  %spec.select.i.1 = select i1 %i.oh, double %i.og, double %spec.select.i ; 2 uses
  %i.oi = trunc nsw i64 %indvars.iv.next.i.1 to i32
  %spec.select18.i.1 = select i1 %i.oh, i32 %i.oi, i32 %spec.select18.i
  %indvars.iv.next.i.2 = add nsw i64 %indvars.iv.i, 3 ; 2 uses
  %i.oj = getelementptr inbounds [8 x i8], ptr %7, i64 %indvars.iv.next.i.1
  %i.ok = load double, ptr %i.oj, align 8, !tbaa !57 ; 2 uses
  %i.ol = fcmp ogt double %i.ok, %spec.select.i.1 ; 2 uses
  %spec.select.i.2 = select i1 %i.ol, double %i.ok, double %spec.select.i.1 ; 2 uses
  %i.om = trunc nsw i64 %indvars.iv.next.i.2 to i32
  %spec.select18.i.2 = select i1 %i.ol, i32 %i.om, i32 %spec.select18.i.1
  %indvars.iv.next.i.3 = add nsw i64 %indvars.iv.i, 4 ; 2 uses
  %i.on = getelementptr inbounds [8 x i8], ptr %7, i64 %indvars.iv.next.i.2
  %i.oo = load double, ptr %i.on, align 8, !tbaa !57 ; 2 uses
  %i.op = fcmp ogt double %i.oo, %spec.select.i.2 ; 2 uses
  %spec.select.i.3 = select i1 %i.op, double %i.oo, double %spec.select.i.2 ; 2 uses
  %i.oq = trunc nsw i64 %indvars.iv.next.i.3 to i32
  %spec.select18.i.3 = select i1 %i.op, i32 %i.oq, i32 %spec.select18.i.2
  %indvars.iv.next.i.4 = add nsw i64 %indvars.iv.i, 5 ; 2 uses
  %i.or = getelementptr inbounds [8 x i8], ptr %7, i64 %indvars.iv.next.i.3
  %i.os = load double, ptr %i.or, align 8, !tbaa !57 ; 2 uses
  %i.ot = fcmp ogt double %i.os, %spec.select.i.3 ; 2 uses
  %spec.select.i.4 = select i1 %i.ot, double %i.os, double %spec.select.i.3 ; 2 uses
  %i.ou = trunc nsw i64 %indvars.iv.next.i.4 to i32
  %spec.select18.i.4 = select i1 %i.ot, i32 %i.ou, i32 %spec.select18.i.3
  %indvars.iv.next.i.5 = add nsw i64 %indvars.iv.i, 6 ; 2 uses
  %i.ov = getelementptr inbounds [8 x i8], ptr %7, i64 %indvars.iv.next.i.4
  %i.ow = load double, ptr %i.ov, align 8, !tbaa !57 ; 2 uses
  %i.ox = fcmp ogt double %i.ow, %spec.select.i.4 ; 2 uses
  %spec.select.i.5 = select i1 %i.ox, double %i.ow, double %spec.select.i.4 ; 2 uses
  %i.oy = trunc nsw i64 %indvars.iv.next.i.5 to i32
  %spec.select18.i.5 = select i1 %i.ox, i32 %i.oy, i32 %spec.select18.i.4
  %indvars.iv.next.i.6 = add nsw i64 %indvars.iv.i, 7 ; 2 uses
  %i.oz = getelementptr inbounds [8 x i8], ptr %7, i64 %indvars.iv.next.i.5
  %i.pa = load double, ptr %i.oz, align 8, !tbaa !57 ; 2 uses
  %i.pb = fcmp ogt double %i.pa, %spec.select.i.5 ; 2 uses
  %spec.select.i.6 = select i1 %i.pb, double %i.pa, double %spec.select.i.5 ; 2 uses
  %i.pc = trunc nsw i64 %indvars.iv.next.i.6 to i32
  %spec.select18.i.6 = select i1 %i.pb, i32 %i.pc, i32 %spec.select18.i.5
  %indvars.iv.next.i.7 = add nsw i64 %indvars.iv.i, 8 ; 3 uses
  %i.pd = getelementptr inbounds [8 x i8], ptr %7, i64 %indvars.iv.next.i.6
  %i.pe = load double, ptr %i.pd, align 8, !tbaa !57 ; 2 uses
  %i.pf = fcmp ogt double %i.pe, %spec.select.i.6 ; 2 uses
  %spec.select.i.7 = select i1 %i.pf, double %i.pe, double %spec.select.i.6
  %i.pg = trunc nsw i64 %indvars.iv.next.i.7 to i32
  %spec.select18.i.7 = select i1 %i.pf, i32 %i.pg, i32 %spec.select18.i.6 ; 2 uses
  %exitcond.not.i.7 = icmp eq i64 %indvars.iv.next.i.7, %wide.trip.count.i
  br i1 %exitcond.not.i.7, label %dmaxloc_.exit, label %.lr.ph.i, !llvm.loop !29

dmaxloc_.exit:                                    ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i, %bb.ac
  %.0.lcssa.i = phi i32 [ %i.no, %bb.ac ], [ %spec.select18.i.lcssa.unr, %.lr.ph.i.prol.loopexit ], [ %spec.select18.i.7, %.lr.ph.i ]
  ...
  %i.pl = load double, ptr %i.pk, align 8, !tbaa !57 ; 3 uses
  store double %i.pl, ptr %i.g, align 8, !tbaa !57
...
._crit_edge560:                                   ; preds = %bb.ad
  %.pre561 = load double, ptr %i.g, align 8, !tbaa !57
  br label %split
...
bb.ae:                                            ; preds = %._crit_edge469._crit_edge
  ...
  store double %i.pr, ptr %i.pv, align 8, !tbaa !57
  %i.pw = trunc i64 %indvars.iv529 to i32
  %i.px = add i32 %i.pw, -1
  store i32 %i.px, ptr %i.c, align 4, !tbaa !51
...
bb.ag:                                            ; preds = %bb.af, %bb.ae
  %i.qo = xor i32 %i.nn, -1
  %i.qp = add i32 %.4, %i.qo
  store i32 %i.qp, ptr %i.c, align 4, !tbaa !51
  ...
  %i.qx = load double, ptr %i.qw, align 8, !tbaa !57
  %i.qy = sext i32 %.4 to i64                     ; 2 uses
  %i.qz = getelementptr inbounds [8 x i8], ptr %i.h, i64 %i.qy ; 2 uses
  %i.ra = load double, ptr %i.qz, align 8, !tbaa !57
  store double %i.ra, ptr %i.qw, align 8, !tbaa !57
  store double %i.qx, ptr %i.qz, align 8, !tbaa !57
  %i.rb = getelementptr inbounds [4 x i8], ptr %i.i, i64 %i.qy ; 2 uses
  %i.rc = load i32, ptr %i.rb, align 4, !tbaa !51
  %i.rd = getelementptr inbounds nuw [4 x i8], ptr %i.i, i64 %indvars.iv529 ; 2 uses
  %i.re = load i32, ptr %i.rd, align 4, !tbaa !51
  store i32 %i.re, ptr %i.rb, align 4, !tbaa !51
  store i32 %i.rc, ptr %i.rd, align 4, !tbaa !51
  br label %._crit_edge570

._crit_edge570:                                   ; preds = %._crit_edge469._crit_edge, %bb.ag
  %i.rf = load double, ptr %i.g, align 8, !tbaa !57
  %i.rg = call double @sqrt(double noundef %i.rf) #8 ; 2 uses
  store double %i.rg, ptr %i.g, align 8, !tbaa !57
  %i.rh = getelementptr inbounds [8 x i8], ptr %i.l, i64 %.pre583
  store double %i.rg, ptr %i.rh, align 8, !tbaa !57
  %i.ri = load i32, ptr %1, align 4, !tbaa !51    ; 2 uses
...
bb.ah:                                            ; preds = %._crit_edge570
  ...
  %i.rs = load i32, ptr %1, align 4, !tbaa !51
  %i.rt = sub nsw i32 %i.rs, %i.nn
  store i32 %i.rt, ptr %i.c, align 4, !tbaa !51
  %i.ru = load double, ptr %i.g, align 8, !tbaa !57
  %i.rv = fdiv double 1.000000e+00, %i.ru
  store double %i.rv, ptr %i.e, align 8, !tbaa !57
...
bb.ai:                                            ; preds = %._crit_edge569, %bb.ah
  ...
  %i.rw = load i32, ptr %i.b, align 4, !tbaa !51
  ...
  br i1 %.not427.not, label %.lr.ph475, label %._crit_edge476.loopexit, !llvm.loop !30

._crit_edge476.loopexit:                          ; preds = %bb.ai
  %i.ry = trunc nsw i64 %indvars.iv.next530.pre-phi to i32
  %.pre562 = load i32, ptr %i.f, align 4, !tbaa !51
  %.pre563 = load i32, ptr %1, align 4, !tbaa !51
...
bb.aj:                                            ; preds = %._crit_edge476
  ...
  store i32 %i.sc, ptr %i.b, align 4, !tbaa !51
...
bb.ak:                                            ; preds = %._crit_edge476, %bb.aj
  ...
  br i1 %.not424, label %.loopexit, label %bb.ab, !llvm.loop !31
...
bb.am:                                            ; preds = %.lr.ph508, %bb.aw
  ...
  %i.uc = mul i64 %i.ti, %indvar789               ; 2 uses
  ...
  %i.uk = mul i64 %i.sq, %indvar789               ; 2 uses
  ...
  %i.us = load i32, ptr %1, align 4, !tbaa !51    ; 3 uses
  %i.ut = sub i32 %i.us, %.1390505                ; 2 uses
  %i.uu = add nsw i32 %i.ut, 1                    ; 2 uses
  store i32 %i.uu, ptr %i.c, align 4, !tbaa !51
  %i.uv = call i32 @llvm.smin.i32(i32 %i.w, i32 %i.uu) ; 3 uses
  store i32 %i.uv, ptr %i.f, align 4, !tbaa !51
...
.lr.ph487.preheader:                              ; preds = %bb.am
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep543, i8 0, i64 %i.va, i1 false), !tbaa !57
...
._crit_edge488:                                   ; preds = %.lr.ph487.preheader, %bb.am
  ...
  store i32 %i.vc, ptr %i.b, align 4, !tbaa !51
...
.lr.ph500:                                        ; preds = %._crit_edge488
  ...
  %13 = getelementptr i8, ptr %7, i64 %i.uc
  %i.vg = getelementptr i8, ptr %7, i64 %i.uc
  %14 = getelementptr i8, ptr %i.vg, i64 8
  %15 = getelementptr i8, ptr %7, i64 %i.uk
  %i.vh = getelementptr i8, ptr %7, i64 %i.uk
  %16 = getelementptr i8, ptr %i.vh, i64 8
...
bb.an:                                            ; preds = %.lr.ph500, %bb.au
  ...
  %indvars.iv547 = phi i64 [ %i.ve, %.lr.ph500 ], [ %indvars.iv.next548.pre-phi, %bb.au ] ; 33 uses
  %.6498 = phi i32 [ %.5506, %.lr.ph500 ], [ %.7, %bb.au ]
  %i.vk = xor i64 %indvar791, -1
  %i.vl = add i64 %i.ub, %i.vk
  %i.vm = trunc i64 %i.vl to i32
  %i.vn = shl nuw nsw i64 %indvar791, 3           ; 2 uses
  %scevgep858 = getelementptr i8, ptr %13, i64 %i.vn ; 2 uses
  %scevgep860 = getelementptr i8, ptr %14, i64 %i.vn ; 2 uses
  ...
  %i.wd = shl nuw nsw i64 %indvar791, 3           ; 2 uses
  %scevgep793 = getelementptr i8, ptr %15, i64 %i.wd ; 4 uses
  %scevgep794 = getelementptr i8, ptr %16, i64 %i.wd ; 2 uses
  ...
  %i.wp = load i32, ptr %1, align 4, !tbaa !51    ; 16 uses
  store i32 %i.wp, ptr %i.c, align 4, !tbaa !51
...
vector.body888:                                   ; preds = %vector.body888, %vector.ph881
  ...
  %wide.masked.gather898 = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep894, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !57, !alias.scope !70
  %wide.masked.gather899 = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep895, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !57, !alias.scope !70
  %wide.masked.gather900 = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep896, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !57, !alias.scope !70
  %wide.masked.gather901 = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep897, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !57, !alias.scope !70
  ...
  %wide.load902 = load <4 x double>, ptr %i.xy, align 8, !tbaa !57, !alias.scope !71
  %wide.load903 = load <4 x double>, ptr %i.xz, align 8, !tbaa !57, !alias.scope !71
  %wide.load904 = load <4 x double>, ptr %i.ya, align 8, !tbaa !57, !alias.scope !71
  %wide.load905 = load <4 x double>, ptr %i.yb, align 8, !tbaa !57, !alias.scope !71
  ...
  store <4 x double> %i.yc, ptr %i.yg, align 8, !tbaa !57, !alias.scope !72, !noalias !73
  store <4 x double> %i.yd, ptr %i.yh, align 8, !tbaa !57, !alias.scope !72, !noalias !73
  store <4 x double> %i.ye, ptr %i.yi, align 8, !tbaa !57, !alias.scope !72, !noalias !73
  store <4 x double> %i.yf, ptr %i.yj, align 8, !tbaa !57, !alias.scope !72, !noalias !73
  ...
  br i1 %i.yk, label %middle.block908, label %vector.body888, !llvm.loop !36
...
vec.epilog.iter.check914:                         ; preds = %middle.block908
  ...
  br i1 %min.epilog.iters.check915, label %.lr.ph492.split.preheader, label %vec.epilog.ph916, !prof !63
...
vec.epilog.vector.body923:                        ; preds = %vec.epilog.vector.body923, %vec.epilog.ph916
  ...
  %wide.masked.gather927 = call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %wide.gep926, <4 x i1> splat (i1 true), <4 x double> poison), !tbaa !57, !alias.scope !70
  %i.yq = getelementptr inbounds [8 x i8], ptr %i.h, i64 %i.yn
  %wide.load928 = load <4 x double>, ptr %i.yq, align 8, !tbaa !57, !alias.scope !71
  %i.yr = fsub <4 x double> %wide.masked.gather927, %wide.load928
  %i.ys = getelementptr [8 x i8], ptr %invariant.gep626, i64 %i.yn
  store <4 x double> %i.yr, ptr %i.ys, align 8, !tbaa !57, !alias.scope !72, !noalias !73
  ...
  br i1 %i.yt, label %vec.epilog.middle.block931, label %vec.epilog.vector.body923, !llvm.loop !37
...
begin_hunk_2_@dpstrf_:bb.a
  ...
  %i.ael = load double, ptr %i.aek, align 8, !tbaa !57 ; 2 uses
...
.lr.ph.i437.prol:                                 ; preds = %.lr.ph.preheader.i435, %.lr.ph.i437.prol
  ...
  %.04.i439.prol = phi i32 [ %spec.select18.i443.prol, %.lr.ph.i437.prol ], [ %i.aeg, %.lr.ph.preheader.i435 ]
  %.0152.i440.prol = phi double [ %spec.select.i442.prol, %.lr.ph.i437.prol ], [ %i.ael, %.lr.ph.preheader.i435 ] ; 2 uses
  ...
  %i.aeo = load double, ptr %i.aen, align 8, !tbaa !57 ; 2 uses
  %i.aep = fcmp ogt double %i.aeo, %.0152.i440.prol ; 2 uses
  %spec.select.i442.prol = select i1 %i.aep, double %i.aeo, double %.0152.i440.prol ; 2 uses
  %i.aeq = trunc nsw i64 %indvars.iv.next.i441.prol to i32
  %spec.select18.i443.prol = select i1 %i.aep, i32 %i.aeq, i32 %.04.i439.prol ; 3 uses
  %prol.iter972.next = add i64 %prol.iter972, 1   ; 2 uses
  %prol.iter972.cmp.not = icmp eq i64 %prol.iter972.next, %xtraiter970
  br i1 %prol.iter972.cmp.not, label %.lr.ph.i437.prol.loopexit, label %.lr.ph.i437.prol, !llvm.loop !48

.lr.ph.i437.prol.loopexit:                        ; preds = %.lr.ph.i437.prol, %.lr.ph.preheader.i435
  %spec.select18.i443.lcssa.unr = phi i32 [ poison, %.lr.ph.preheader.i435 ], [ %spec.select18.i443.prol, %.lr.ph.i437.prol ]
  %indvars.iv.i438.unr = phi i64 [ %i.aei, %.lr.ph.preheader.i435 ], [ %indvars.iv.next.i441.prol, %.lr.ph.i437.prol ]
  %.04.i439.unr = phi i32 [ %i.aeg, %.lr.ph.preheader.i435 ], [ %spec.select18.i443.prol, %.lr.ph.i437.prol ]
  %.0152.i440.unr = phi double [ %i.ael, %.lr.ph.preheader.i435 ], [ %spec.select.i442.prol, %.lr.ph.i437.prol ]
...
.lr.ph.i437:                                      ; preds = %.lr.ph.i437.prol.loopexit, %.lr.ph.i437
  ...
  %.04.i439 = phi i32 [ %spec.select18.i443.7, %.lr.ph.i437 ], [ %.04.i439.unr, %.lr.ph.i437.prol.loopexit ]
  %.0152.i440 = phi double [ %spec.select.i442.7, %.lr.ph.i437 ], [ %.0152.i440.unr, %.lr.ph.i437.prol.loopexit ] ; 2 uses
  %indvars.iv.next.i441 = add nsw i64 %indvars.iv.i438, 1 ; 2 uses
  %i.aet = getelementptr inbounds [8 x i8], ptr %7, i64 %indvars.iv.i438
  %i.aeu = load double, ptr %i.aet, align 8, !tbaa !57 ; 2 uses
  %i.aev = fcmp ogt double %i.aeu, %.0152.i440    ; 2 uses
  %spec.select.i442 = select i1 %i.aev, double %i.aeu, double %.0152.i440 ; 2 uses
  %i.aew = trunc nsw i64 %indvars.iv.next.i441 to i32
  %spec.select18.i443 = select i1 %i.aev, i32 %i.aew, i32 %.04.i439
  ...
  %i.aey = load double, ptr %i.aex, align 8, !tbaa !57 ; 2 uses
  %i.aez = fcmp ogt double %i.aey, %spec.select.i442 ; 2 uses
  %spec.select.i442.1 = select i1 %i.aez, double %i.aey, double %spec.select.i442 ; 2 uses
  %i.afa = trunc nsw i64 %indvars.iv.next.i441.1 to i32
  %spec.select18.i443.1 = select i1 %i.aez, i32 %i.afa, i32 %spec.select18.i443
  ...
  %i.afc = load double, ptr %i.afb, align 8, !tbaa !57 ; 2 uses
  %i.afd = fcmp ogt double %i.afc, %spec.select.i442.1 ; 2 uses
  %spec.select.i442.2 = select i1 %i.afd, double %i.afc, double %spec.select.i442.1 ; 2 uses
  %i.afe = trunc nsw i64 %indvars.iv.next.i441.2 to i32
  %spec.select18.i443.2 = select i1 %i.afd, i32 %i.afe, i32 %spec.select18.i443.1
  ...
  %i.afg = load double, ptr %i.aff, align 8, !tbaa !57 ; 2 uses
  %i.afh = fcmp ogt double %i.afg, %spec.select.i442.2 ; 2 uses
  %spec.select.i442.3 = select i1 %i.afh, double %i.afg, double %spec.select.i442.2 ; 2 uses
  %i.afi = trunc nsw i64 %indvars.iv.next.i441.3 to i32
  %spec.select18.i443.3 = select i1 %i.afh, i32 %i.afi, i32 %spec.select18.i443.2
  ...
  %i.afk = load double, ptr %i.afj, align 8, !tbaa !57 ; 2 uses
  %i.afl = fcmp ogt double %i.afk, %spec.select.i442.3 ; 2 uses
  %spec.select.i442.4 = select i1 %i.afl, double %i.afk, double %spec.select.i442.3 ; 2 uses
  %i.afm = trunc nsw i64 %indvars.iv.next.i441.4 to i32
  %spec.select18.i443.4 = select i1 %i.afl, i32 %i.afm, i32 %spec.select18.i443.3
  ...
  %i.afo = load double, ptr %i.afn, align 8, !tbaa !57 ; 2 uses
  %i.afp = fcmp ogt double %i.afo, %spec.select.i442.4 ; 2 uses
  %spec.select.i442.5 = select i1 %i.afp, double %i.afo, double %spec.select.i442.4 ; 2 uses
  %i.afq = trunc nsw i64 %indvars.iv.next.i441.5 to i32
  %spec.select18.i443.5 = select i1 %i.afp, i32 %i.afq, i32 %spec.select18.i443.4
  ...
  %i.afs = load double, ptr %i.afr, align 8, !tbaa !57 ; 2 uses
  %i.aft = fcmp ogt double %i.afs, %spec.select.i442.5 ; 2 uses
  %spec.select.i442.6 = select i1 %i.aft, double %i.afs, double %spec.select.i442.5 ; 2 uses
  %i.afu = trunc nsw i64 %indvars.iv.next.i441.6 to i32
  %spec.select18.i443.6 = select i1 %i.aft, i32 %i.afu, i32 %spec.select18.i443.5
  ...
  %i.afw = load double, ptr %i.afv, align 8, !tbaa !57 ; 2 uses
  %i.afx = fcmp ogt double %i.afw, %spec.select.i442.6 ; 2 uses
  %spec.select.i442.7 = select i1 %i.afx, double %i.afw, double %spec.select.i442.6
  %i.afy = trunc nsw i64 %indvars.iv.next.i441.7 to i32
  %spec.select18.i443.7 = select i1 %i.afx, i32 %i.afy, i32 %spec.select18.i443.6 ; 2 uses
  %exitcond.not.i444.7 = icmp eq i64 %indvars.iv.next.i441.7, %wide.trip.count.i436
  br i1 %exitcond.not.i444.7, label %dmaxloc_.exit445, label %.lr.ph.i437, !llvm.loop !29

dmaxloc_.exit445:                                 ; preds = %.lr.ph.i437.prol.loopexit, %.lr.ph.i437, %bb.ao
  %.0.lcssa.i433 = phi i32 [ %i.aeg, %bb.ao ], [ %spec.select18.i443.lcssa.unr, %.lr.ph.i437.prol.loopexit ], [ %spec.select18.i443.7, %.lr.ph.i437 ]
  ...
  %i.agd = load double, ptr %i.agc, align 8, !tbaa !57 ; 3 uses
  store double %i.agd, ptr %i.g, align 8, !tbaa !57
...
._crit_edge564:                                   ; preds = %bb.ap
  %.pre566 = load double, ptr %i.g, align 8, !tbaa !57
  br label %split565
...
bb.aq:                                            ; preds = %._crit_edge493._crit_edge
  ...
  %i.agj = load double, ptr %i.agi, align 8, !tbaa !57
  ...
  store double %i.agj, ptr %i.agn, align 8, !tbaa !57
  %i.ago = trunc i64 %indvars.iv547 to i32
  %i.agp = add i32 %i.ago, -1
  store i32 %i.agp, ptr %i.c, align 4, !tbaa !51
...
bb.as:                                            ; preds = %bb.ar, %bb.aq
  ...
  store i32 %i.ahe, ptr %i.c, align 4, !tbaa !51
  ...
  %i.ahn = load double, ptr %i.ahm, align 8, !tbaa !57
  %i.aho = getelementptr inbounds [8 x i8], ptr %i.h, i64 %i.ahj ; 2 uses
  %i.ahp = load double, ptr %i.aho, align 8, !tbaa !57
  store double %i.ahp, ptr %i.ahm, align 8, !tbaa !57
  store double %i.ahn, ptr %i.aho, align 8, !tbaa !57
  %i.ahq = getelementptr inbounds [4 x i8], ptr %i.i, i64 %i.ahj ; 2 uses
  %i.ahr = load i32, ptr %i.ahq, align 4, !tbaa !51
  %i.ahs = getelementptr inbounds [4 x i8], ptr %i.i, i64 %indvars.iv547 ; 2 uses
  %i.aht = load i32, ptr %i.ahs, align 4, !tbaa !51
  store i32 %i.aht, ptr %i.ahq, align 4, !tbaa !51
  store i32 %i.ahr, ptr %i.ahs, align 4, !tbaa !51
  br label %._crit_edge572

._crit_edge572:                                   ; preds = %._crit_edge493._crit_edge, %bb.as
  %i.ahu = load double, ptr %i.g, align 8, !tbaa !57
  %i.ahv = call double @sqrt(double noundef %i.ahu) #8 ; 2 uses
  store double %i.ahv, ptr %i.g, align 8, !tbaa !57
  %i.ahw = getelementptr inbounds [8 x i8], ptr %i.l, i64 %.pre576
  store double %i.ahv, ptr %i.ahw, align 8, !tbaa !57
  %i.ahx = load i32, ptr %1, align 4, !tbaa !51   ; 2 uses
...
bb.at:                                            ; preds = %._crit_edge572
  ...
  %i.aig = load i32, ptr %1, align 4, !tbaa !51
  %i.aih = sub nsw i32 %i.aig, %i.aef
  store i32 %i.aih, ptr %i.c, align 4, !tbaa !51
  %i.aii = load double, ptr %i.g, align 8, !tbaa !57
  %i.aij = fdiv double 1.000000e+00, %i.aii
  store double %i.aij, ptr %i.e, align 8, !tbaa !57
...
bb.au:                                            ; preds = %._crit_edge571, %bb.at
  ...
  %i.aik = load i32, ptr %i.b, align 4, !tbaa !51
  ...
  br i1 %.not419.not, label %bb.an, label %._crit_edge501.loopexit, !llvm.loop !49

._crit_edge501.loopexit:                          ; preds = %bb.au
  %i.aim = trunc nsw i64 %indvars.iv.next548.pre-phi to i32
  %.pre567 = load i32, ptr %i.f, align 4, !tbaa !51
  %.pre568 = load i32, ptr %1, align 4, !tbaa !51
...
bb.av:                                            ; preds = %._crit_edge501
  ...
  store i32 %i.aiq, ptr %i.b, align 4, !tbaa !51
...
bb.aw:                                            ; preds = %._crit_edge501, %bb.av
  ...
  br i1 %.not608, label %.loopexit, label %bb.am, !llvm.loop !50

.loopexit:                                        ; preds = %bb.ak, %bb.aw, %bb.aa, %bb.al
  %i.aiz = load i32, ptr %1, align 4, !tbaa !51
  store i32 %i.aiz, ptr %5, align 4, !tbaa !51
  br label %bb.ay
...
bb.ax:                                            ; preds = %split565, %split
  ...
  store double %.sink638, ptr %i.ajb, align 8, !tbaa !57
  %i.ajc = add nsw i32 %.2393, -1
  store i32 %i.ajc, ptr %5, align 4, !tbaa !51
  store i32 1, ptr %8, align 4, !tbaa !51
  br label %bb.ay
...
!7 = !{!6, !5, i64 0}
!8 = distinct !{!8, !52, !53, !54}
!9 = distinct !{!9, !52, !53, !54}
!10 = distinct !{!10, !52, !54, !53}
!11 = distinct !{!11, !52}
!12 = distinct !{!12, !58}
...
!15 = distinct !{!15, !13}
!16 = distinct !{!16, !13}
!17 = distinct !{!17, !52, !53, !54}
!18 = distinct !{!18, !52, !53, !54}
!19 = distinct !{!19, !58}
...
!23 = distinct !{!23, !20}
!24 = distinct !{!24, !20}
!25 = distinct !{!25, !52, !53, !54}
!26 = distinct !{!26, !52, !53}
!27 = distinct !{!27, !52, !53}
!28 = distinct !{!28, !58}
!29 = distinct !{!29, !52}
!30 = distinct !{!30, !52}
!31 = distinct !{!31, !52}
