...
.lr.ph1763.preheader.new:                         ; preds = %.lr.ph1763.preheader
  ...
  %i.abj = icmp uge <2 x i64> %broadcast.splat2671, <i64 0, i64 1> ; 2 uses
  ...
  %i.abl = icmp uge <2 x i64> %broadcast.splat2671.1, <i64 0, i64 1> ; 2 uses
  ...
  %i.abn = icmp uge <2 x i64> %broadcast.splat2671.2, <i64 0, i64 1> ; 2 uses
  ...
  %i.abp = icmp uge <2 x i64> %broadcast.splat2671.3, <i64 0, i64 1> ; 2 uses
  br label %.lr.ph1763
...
.lr.ph1763.epil.preheader:                        ; preds = %.lr.ph1775.loopexit3135.unr-lcssa, %.lr.ph1763.preheader
  ...
  %i.ahc = icmp uge <2 x i64> %broadcast.splat2671.epil, <i64 0, i64 1> ; 2 uses
...
vector.body2662:                                  ; preds = %.lr.ph1775
  ...
  %i.ahp = icmp uge <2 x i64> %broadcast.splat2653, <i64 0, i64 1> ; 2 uses
...
vector.body2647:                                  ; preds = %.lr.ph1775
  ...
  %i.ahx = icmp uge <2 x i64> %broadcast.splat2642, <i64 0, i64 1>
...
.lr.ph1963:                                       ; preds = %.loopexit1688
  ...
  %i.aqf = zext i32 %i.aqb to i64                 ; 3 uses
...
.lr.ph1884.us.preheader:                          ; preds = %.lr.ph1889.split.us
  ...
  %16 = trunc nuw nsw i64 %i.bwd to i32
...
.lr.ph1884.us:                                    ; preds = %.lr.ph1884.us.preheader, %..loopexit_crit_edge.us
  ...
  %17 = trunc nuw nsw i64 %indvars.iv2200 to i32
  %18 = add i32 %16, %17                          ; 2 uses
  %i.bwm = mul nsw i32 %18, %i.y
  %i.bwn = fneg double %i.bwk
  %i.bwo = fmul double %i.bvv, %i.bwn             ; 2 uses
  %i.bwp = mul nsw i32 %18, %i.ab
...
.lr.ph1880.preheader:                             ; preds = %.lr.ph1889.split
  ...
  %19 = trunc nuw nsw i64 %i.bwd to i32
...
.lr.ph1880:                                       ; preds = %.lr.ph1880.preheader, %..loopexit1670_crit_edge
  ...
  %20 = trunc nuw nsw i64 %indvars.iv2190 to i32
  %21 = add i32 %19, %20                          ; 2 uses
  %i.byj = mul nsw i32 %21, %i.y
  %i.byk = fneg double %i.bya
  %i.byl = fmul double %i.bvv, %i.byk             ; 2 uses
  %i.bym = mul nsw i32 %21, %i.ab
