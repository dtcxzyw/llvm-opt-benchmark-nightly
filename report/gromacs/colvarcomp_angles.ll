...
bb.a:
  ...
  %i.h = load <2 x double>, ptr %i.d, align 8, !tbaa !89, !noalias !109 ; 7 uses
  %i.i = extractelement <2 x double> %i.h, i64 0  ; 2 uses
  %i.j = load <2 x double>, ptr %i.f, align 8, !tbaa !89, !noalias !253 ; 3 uses
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #19
  %i.s = load <2 x double>, ptr %i.c, align 8, !tbaa !89, !noalias !256 ; 3 uses
  %i.t = load double, ptr %i.e, align 8, !tbaa !94, !noalias !256 ; 2 uses
  %i.u = fneg double %i.t
  %i.v = load <2 x double>, ptr %i.b, align 8, !tbaa !89, !noalias !256 ; 9 uses
  ...
  %5 = shufflevector <2 x double> %i.v, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 3 uses
  %6 = extractelement <2 x double> %i.v, i64 1    ; 2 uses
  %i.z = extractelement <2 x double> %i.v, i64 0  ; 2 uses
  %7 = fneg double %i.z
  %i.aa = fneg <2 x double> %i.s
  %8 = shufflevector <2 x double> %i.aa, <2 x double> %i.v, <2 x i32> <i32 0, i32 3>
  %9 = fmul <2 x double> %i.v, %8
  %10 = shufflevector <2 x double> %i.h, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ab = fneg <2 x double> %i.v
  %11 = shufflevector <2 x double> %i.h, <2 x double> %i.ab, <2 x i32> <i32 1, i32 3>
  %i.ac = fmul <2 x double> %i.h, %11
  %i.ad = insertelement <2 x double> poison, double %7, i64 0
  %12 = shufflevector <2 x double> %i.ad, <2 x double> %i.v, <2 x i32> <i32 0, i32 2>
  %i.ae = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %12, <2 x double> %i.k, <2 x double> %i.ac) ; 7 uses
  %13 = extractelement <2 x double> %i.ae, i64 1
  %14 = load double, ptr %i.a, align 8, !tbaa !113, !noalias !256 ; 3 uses
  %15 = fneg double %14
  %i.af = insertelement <2 x double> %5, double %14, i64 0
  %16 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.af, <2 x double> %5, <2 x double> %9) ; 2 uses
  %17 = insertelement <2 x double> %i.w, double %15, i64 0
  %i.ag = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %17, <2 x double> %10, <2 x double> %i.y) ; 5 uses
  %18 = tail call double @llvm.fmuladd.f64(double %6, double %i.o, double %i.n) ; 4 uses
  %i.ah = fmul <2 x double> %i.ag, %i.ag
  %19 = shufflevector <2 x double> %i.h, <2 x double> %i.ag, <2 x i32> <i32 0, i32 3> ; 2 uses
  %20 = shufflevector <2 x double> %16, <2 x double> %i.ah, <2 x i32> <i32 1, i32 2>
  %i.ai = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %19, <2 x double> %19, <2 x double> %20) ; 2 uses
  %21 = extractelement <2 x double> %i.ai, i64 0
  %sqrt.i = tail call noundef double @llvm.sqrt.f64(double %21) ; 3 uses
  %i.aj = extractelement <2 x double> %16, i64 0  ; 4 uses
  %22 = extractelement <2 x double> %i.ai, i64 1
  %23 = tail call noundef double @llvm.fmuladd.f64(double %i.aj, double %i.aj, double %22) ; 2 uses
  %24 = shufflevector <2 x double> %i.ae, <2 x double> %i.s, <2 x i32> <i32 0, i32 2>
  %25 = shufflevector <2 x double> %i.ae, <2 x double> %i.v, <2 x i32> <i32 0, i32 3>
  %26 = fmul <2 x double> %24, %25
  %27 = insertelement <2 x double> poison, double %18, i64 0
  %28 = insertelement <2 x double> %27, double %14, i64 1
  %29 = insertelement <2 x double> %5, double %18, i64 0
  ...
  %i.al = fdiv double %i.ak, %23                  ; 2 uses
  ...
  %i.ap = fmul double %i.aj, %i.al                ; 2 uses
  %31 = shufflevector <2 x double> %i.ae, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %32 = insertelement <2 x double> %31, double %i.t, i64 1
  %33 = shufflevector <2 x double> %i.ae, <2 x double> %i.h, <2 x i32> <i32 1, i32 2>
  %34 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %32, <2 x double> %33, <2 x double> %30) ; 2 uses
  %i.aq = fmul double %sqrt.i, %23
  %35 = extractelement <2 x double> %34, i64 1
  %36 = fdiv double %35, %i.aq                    ; 2 uses
  %37 = fmul double %i.aj, %36
  %38 = fmul double %6, %i.m
  %39 = tail call double @llvm.fmuladd.f64(double %i.p, double %i.z, double %38)
  %40 = tail call noundef double @llvm.fmuladd.f64(double %i.o, double %i.i, double %39)
  %41 = extractelement <2 x double> %34, i64 0    ; 2 uses
  %42 = fmul double %sqrt.i, %41
  %43 = fdiv double %40, %42                      ; 2 uses
  %44 = fmul double %13, %43
  %45 = fadd double %37, %44
  %46 = fmul double %45, f0x404CA5DC1A63C1F8      ; 2 uses
  %47 = fdiv double %i.ak, %41                    ; 2 uses
  %48 = fmul double %18, %47                      ; 2 uses
  %i.ar = insertelement <2 x double> poison, double %47, i64 0
  %i.as = shufflevector <2 x double> %i.ar, <2 x double> poison, <2 x i32> zeroinitializer
  %i.at = fmul <2 x double> %i.ae, %i.as          ; 3 uses
  store double %48, ptr %1, align 8, !tbaa !113, !alias.scope !259
  store <2 x double> %i.at, ptr %i.g, align 8, !tbaa !89, !alias.scope !259
  %49 = fneg <2 x double> %i.ao
  %50 = fneg double %i.ap
  %51 = shufflevector <2 x double> %49, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  store <2 x double> %51, ptr %2, align 16, !tbaa !89, !alias.scope !262
  %52 = getelementptr inbounds nuw i8, ptr %2, i64 16
  store double %50, ptr %52, align 16, !tbaa !94, !alias.scope !262
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #19
  %55 = fadd double %i.ap, %46
  %i.au = insertelement <2 x double> poison, double %36, i64 0
  %i.av = shufflevector <2 x double> %i.au, <2 x double> poison, <2 x i32> zeroinitializer
  %i.aw = fmul <2 x double> %i.ag, %i.av
  %56 = insertelement <2 x double> %i.ae, double %18, i64 1
  %57 = insertelement <2 x double> poison, double %43, i64 0
  %58 = shufflevector <2 x double> %57, <2 x double> poison, <2 x i32> zeroinitializer
  %59 = fmul <2 x double> %56, %58
  %60 = fadd <2 x double> %i.aw, %59
  %61 = fmul <2 x double> %60, splat (double f0x404CA5DC1A63C1F8) ; 2 uses
  %i.ax = fadd <2 x double> %i.ao, %61
  ...
  store double %55, ptr %i.az, align 16, !tbaa !94, !alias.scope !265
  call void @_ZN12colvarmodule10atom_group21set_weighted_gradientERKNS_7rvectorE(ptr noundef nonnull align 8 dereferenceable(1712) %54, ptr noundef nonnull align 8 dereferenceable(24) %3)
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #19
  %i.ba = getelementptr inbounds nuw i8, ptr %0, i64 1624
  %i.bb = load ptr, ptr %i.ba, align 8, !tbaa !236
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #19
  %i.bc = extractelement <2 x double> %i.at, i64 1
  %i.bd = fneg double %i.bc
  %i.be = shufflevector <2 x double> %61, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.bf = fsub double %i.bd, %46
  %i.bg = shufflevector <2 x double> %i.at, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %i.bh = insertelement <2 x double> %i.bg, double %48, i64 0
...
bb.a:
  ...
  %4 = load double, ptr %i.x, align 8, !tbaa !113, !noalias !277 ; 2 uses
  %5 = shufflevector <2 x double> <double poison, double 0.000000e+00>, <2 x double> %i.v, <2 x i32> <i32 3, i32 1>
  %6 = insertelement <2 x double> poison, double %i.ad, i64 0
  %i.af = insertelement <2 x double> %6, double %4, i64 1
  ...
  %7 = fneg double %i.ah                          ; 2 uses
  %i.ai = fneg double %i.ae                       ; 2 uses
  ...
  %8 = insertelement <2 x double> %i.ag, double -0.000000e+00, i64 1
  %9 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %5, <2 x double> %8, <2 x double> %i.af) ; 3 uses
  %i.an = shufflevector <2 x double> %i.v, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %i.ao = insertelement <2 x double> %i.an, double %7, i64 0
  %i.ap = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ao, <2 x double> %i.ag, <2 x double> %i.am) ; 3 uses
  %i.aq = shufflevector <2 x double> %i.ap, <2 x double> %i.z, <2 x i32> <i32 0, i32 2> ; 2 uses
  %i.ar = fmul <2 x double> %i.aq, %i.aq
  %i.as = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %9, <2 x double> %9, <2 x double> %i.ar)
  %10 = shufflevector <2 x double> %i.z, <2 x double> %i.ap, <2 x i32> <i32 3, i32 1> ; 2 uses
  %i.at = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %10, <2 x double> %10, <2 x double> %i.as) ; 2 uses
  %11 = fcmp ogt <2 x double> %i.at, zeroinitializer ; 3 uses
  %12 = extractelement <2 x i1> %11, i64 1
  %13 = shufflevector <2 x i1> %11, <2 x i1> poison, <2 x i32> <i32 1, i32 1>
  %14 = tail call <2 x double> @llvm.sqrt.v2f64(<2 x double> %i.at) ; 4 uses
  %15 = shufflevector <2 x double> %14, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.au = fdiv <2 x double> %i.z, %15
  %16 = insertelement <2 x double> %9, double %4, i64 1
  %17 = fdiv <2 x double> %16, %14                ; 2 uses
  %18 = extractelement <2 x double> %17, i64 1
  %.sink4.i15 = select i1 %12, double %18, double 1.000000e+00 ; 2 uses
  %i.av = select <2 x i1> %13, <2 x double> %i.au, <2 x double> zeroinitializer ; 5 uses
  %19 = shufflevector <2 x double> %14, <2 x double> poison, <2 x i32> zeroinitializer
  %20 = fdiv <2 x double> %i.ap, %19              ; 2 uses
  %21 = extractelement <2 x i1> %11, i64 0        ; 3 uses
  %i.aw = extractelement <2 x double> %17, i64 0
  %.sink4.i20 = select i1 %21, double %i.aw, double 1.000000e+00 ; 2 uses
  %i.ax = extractelement <2 x double> %20, i64 0
  %.sink3.i21 = select i1 %21, double %i.ax, double 0.000000e+00 ; 2 uses
  %i.ay = extractelement <2 x double> %20, i64 1
  %.sink.i22 = select i1 %21, double %i.ay, double 0.000000e+00 ; 2 uses
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.cj = insertelement <2 x double> %i.w, double %i.ai, i64 0
  ...
  %i.cp = insertelement <2 x double> %i.cg, double %7, i64 1
  ...
  %i.dc = extractelement <2 x double> %14, i64 1
...
!262 = !{!263}
!263 = distinct !{!263, !264, !"_ZngRKN12colvarmodule7rvectorE: argument 0"}
!264 = distinct !{!264, !"_ZngRKN12colvarmodule7rvectorE"}
!265 = !{!266}
