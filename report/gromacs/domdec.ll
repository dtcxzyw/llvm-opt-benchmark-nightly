...
bb.q:                                             ; preds = %.lr.ph81, %bb.v
  ...
  %.05879 = phi i32 [ 0, %.lr.ph81 ], [ %i.hk, %bb.v ] ; 5 uses
  ...
  %i.gi = sdiv i32 %.05879, %i.gh                 ; 2 uses
  store i32 %i.gi, ptr %.sroa.0, align 4, !tbaa !9
  %i.gj = sdiv i32 %.05879, %i.gg
...
bb.s:                                             ; preds = %bb.q
  ...
  %i.gn = mul nsw i32 %.val6072, %.05879
...
bb.v:                                             ; preds = %bb.u, %bb.r
  ...
  %i.hk = add nuw nsw i32 %.05879, 1              ; 2 uses
...
.preheader:                                       ; preds = %bb.e
  ...
  br i1 %i.g, label %.lr.ph79, label %.loopexit70
