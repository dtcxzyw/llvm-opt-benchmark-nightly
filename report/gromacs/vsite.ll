...
.noexc12.i:                                       ; preds = %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i.i
  ...
  tail call void @llvm.memset.p0.i64(ptr nonnull align 4 %i.u, i8 0, i64 %i.t, i1 false), !tbaa !90, !noalias !272
  %i.w = getelementptr inbounds nuw i8, ptr %i.u, i64 %i.t
  %.pre.i = load ptr, ptr %i.n, align 8, !tbaa !115, !noalias !272
  %.pre32.i = load ptr, ptr %i.k, align 8, !tbaa !18, !noalias !272
...
.lr.ph.i:                                         ; preds = %_ZSt4fillIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiEvT_S7_RKT0_.exit.i, %.lr.ph.preheader.i
  ...
  %i.aj = load i32, ptr %i.ai, align 4, !tbaa !90, !noalias !272 ; 3 uses
  %i.ak = getelementptr i8, ptr %i.ai, i64 4
  %i.al = load i32, ptr %i.ak, align 4, !tbaa !90, !noalias !272 ; 3 uses
...
bb.d:                                             ; preds = %.lr.ph.i
  invoke void @_ZN3gmx8internal13assertHandlerEPKcS2_S2_S2_i(ptr noundef nonnull @.str.62, ptr noundef nonnull @.str.63, ptr noundef nonnull @__PRETTY_FUNCTION__._ZZN3gmx5RangeIiEC1EiiENKUlvE_clEv, ptr noundef nonnull @.str.64, i32 noundef 111) #32
          to label %.noexc18.i unwind label %bb.f, !noalias !272
...
vector.body491:                                   ; preds = %vector.body491, %vector.ph487
  ...
  store <8 x i32> %broadcast.splat490, ptr %next.gep, align 4, !tbaa !90, !noalias !272
  store <8 x i32> %broadcast.splat490, ptr %i.bb, align 4, !tbaa !90, !noalias !272
  store <8 x i32> %broadcast.splat490, ptr %i.bc, align 4, !tbaa !90, !noalias !272
  store <8 x i32> %broadcast.splat490, ptr %i.bd, align 4, !tbaa !90, !noalias !272
  %index.next493 = add nuw i64 %index492, 32      ; 2 uses
  %i.be = icmp eq i64 %index.next493, %n.vec488
  br i1 %i.be, label %middle.block494, label %vector.body491, !llvm.loop !236
...
vec.epilog.vector.body505:                        ; preds = %vec.epilog.vector.body505, %vec.epilog.ph501
  ...
  store <8 x i32> %broadcast.splat504, ptr %next.gep507, align 4, !tbaa !90, !noalias !272
  %index.next508 = add nuw i64 %index506, 8       ; 2 uses
  %i.bi = icmp eq i64 %index.next508, %n.vec502
  br i1 %i.bi, label %vec.epilog.middle.block509, label %vec.epilog.vector.body505, !llvm.loop !237
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i.preheader, %.lr.ph.i.i.i.i.i
  ...
  store i32 %i.aq, ptr %.06.i.i.i.i.i, align 4, !tbaa !90, !noalias !272
  %i.bj = getelementptr inbounds nuw i8, ptr %.06.i.i.i.i.i, i64 4 ; 2 uses
  %.not.i.i.i.i19.i = icmp eq ptr %i.bj, %i.an
  br i1 %.not.i.i.i.i19.i, label %_ZSt4fillIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiEvT_S7_RKT0_.exit.i, label %.lr.ph.i.i.i.i.i, !llvm.loop !238
...
_ZSt4fillIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiEvT_S7_RKT0_.exit.i: ; preds = %.lr.ph.i.i.i.i.i, %middle.block494, %vec.epilog.middle.block509, %bb.e
  ...
  br i1 %exitcond.not.i, label %_ZNSt6vectorIiSaIiEED2Ev.exit, label %.lr.ph.i, !llvm.loop !239
...
bb.g:                                             ; preds = %bb.f
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.0.0, i64 noundef %i.bm) #30, !noalias !272
...
._crit_edge.split.us.us:                          ; preds = %.critedge.us.us, %middle.block461, %vec.epilog.middle.block480, %_ZNSt6vectorIiSaIiEED2Ev.exit.split.us.preheader
  ...
  %i.cc = load ptr, ptr %i.cb, align 8, !tbaa !115
  %i.cd = load ptr, ptr %i.ca, align 8, !tbaa !18
...
iter.check430:                                    ; preds = %._crit_edge.split.us.us
  %i.ck = load i32, ptr getelementptr inbounds nuw (i8, ptr @interaction_function, i64 2128), align 8, !tbaa !89
  %i.cl = add nsw i32 %i.ck, 1                    ; 5 uses
  %i.cm = load i32, ptr %i.bp, align 4, !tbaa !116 ; 3 uses
  %smax408 = tail call i32 @llvm.smax.i32(i32 %i.cl, i32 %i.ci)
  %i.cn = add nsw i32 %smax408, -1
...
vector.body416:                                   ; preds = %vector.body416, %vector.ph412
  ...
  br i1 %i.cx, label %middle.block423, label %vector.body416, !llvm.loop !240
...
vec.epilog.vector.body438:                        ; preds = %vec.epilog.vector.body438, %vec.epilog.ph434
  ...
  br i1 %i.dc, label %vec.epilog.middle.block442, label %vec.epilog.vector.body438, !llvm.loop !241
...
.critedge.us.us.1:                                ; preds = %.critedge.us.us.1.preheader, %.critedge.us.us.1
  ...
  br i1 %i.dg, label %.critedge.us.us.1, label %._crit_edge.split.us.us.1, !llvm.loop !242
...
._crit_edge.split.us.us.1:                        ; preds = %.critedge.us.us.1, %middle.block423, %vec.epilog.middle.block442, %._crit_edge.split.us.us
  ...
  %i.dj = load ptr, ptr %i.di, align 8, !tbaa !115
  %i.dk = load ptr, ptr %i.dh, align 8, !tbaa !18
...
iter.check392:                                    ; preds = %._crit_edge.split.us.us.1
  %i.dr = load i32, ptr getelementptr inbounds nuw (i8, ptr @interaction_function, i64 2160), align 8, !tbaa !89
  %i.ds = add nsw i32 %i.dr, 1                    ; 5 uses
  %i.dt = load i32, ptr %i.bp, align 4, !tbaa !116 ; 3 uses
  %smax370 = tail call i32 @llvm.smax.i32(i32 %i.ds, i32 %i.dp)
  %i.du = add nsw i32 %smax370, -1
...
vector.body378:                                   ; preds = %vector.body378, %vector.ph374
  ...
  br i1 %i.ee, label %middle.block385, label %vector.body378, !llvm.loop !243
...
vec.epilog.vector.body400:                        ; preds = %vec.epilog.vector.body400, %vec.epilog.ph396
  ...
  br i1 %i.ej, label %vec.epilog.middle.block404, label %vec.epilog.vector.body400, !llvm.loop !244
...
.critedge.us.us.2:                                ; preds = %.critedge.us.us.2.preheader, %.critedge.us.us.2
  ...
  br i1 %i.en, label %.critedge.us.us.2, label %._crit_edge.split.us.us.2, !llvm.loop !245
...
._crit_edge.split.us.us.2:                        ; preds = %.critedge.us.us.2, %middle.block385, %vec.epilog.middle.block404, %._crit_edge.split.us.us.1
  ...
  %i.eq = load ptr, ptr %i.ep, align 8, !tbaa !115
  %i.er = load ptr, ptr %i.eo, align 8, !tbaa !18
...
iter.check354:                                    ; preds = %._crit_edge.split.us.us.2
  %i.ey = load i32, ptr getelementptr inbounds nuw (i8, ptr @interaction_function, i64 2192), align 8, !tbaa !89
  %i.ez = add nsw i32 %i.ey, 1                    ; 5 uses
  %i.fa = load i32, ptr %i.bp, align 4, !tbaa !116 ; 3 uses
  %smax332 = tail call i32 @llvm.smax.i32(i32 %i.ez, i32 %i.ew)
  %i.fb = add nsw i32 %smax332, -1
...
vector.body340:                                   ; preds = %vector.body340, %vector.ph336
  ...
  br i1 %i.fl, label %middle.block347, label %vector.body340, !llvm.loop !246
...
vec.epilog.vector.body362:                        ; preds = %vec.epilog.vector.body362, %vec.epilog.ph358
  ...
  br i1 %i.fq, label %vec.epilog.middle.block366, label %vec.epilog.vector.body362, !llvm.loop !247
...
.critedge.us.us.3:                                ; preds = %.critedge.us.us.3.preheader, %.critedge.us.us.3
  ...
  br i1 %i.fu, label %.critedge.us.us.3, label %._crit_edge.split.us.us.3, !llvm.loop !248
...
._crit_edge.split.us.us.3:                        ; preds = %.critedge.us.us.3, %middle.block347, %vec.epilog.middle.block366, %._crit_edge.split.us.us.2
  ...
  %i.fx = load ptr, ptr %i.fw, align 8, !tbaa !115
  %i.fy = load ptr, ptr %i.fv, align 8, !tbaa !18
...
iter.check316:                                    ; preds = %._crit_edge.split.us.us.3
  %i.gf = load i32, ptr getelementptr inbounds nuw (i8, ptr @interaction_function, i64 2224), align 8, !tbaa !89
  %i.gg = add nsw i32 %i.gf, 1                    ; 5 uses
  %i.gh = load i32, ptr %i.bp, align 4, !tbaa !116 ; 3 uses
  %smax294 = tail call i32 @llvm.smax.i32(i32 %i.gg, i32 %i.gd)
  %i.gi = add nsw i32 %smax294, -1
...
vector.body302:                                   ; preds = %vector.body302, %vector.ph298
  ...
  br i1 %i.gs, label %middle.block309, label %vector.body302, !llvm.loop !249
...
vec.epilog.vector.body324:                        ; preds = %vec.epilog.vector.body324, %vec.epilog.ph320
  ...
  br i1 %i.gx, label %vec.epilog.middle.block328, label %vec.epilog.vector.body324, !llvm.loop !250
...
.critedge.us.us.4:                                ; preds = %.critedge.us.us.4.preheader, %.critedge.us.us.4
  ...
  br i1 %i.hb, label %.critedge.us.us.4, label %._crit_edge.split.us.us.4, !llvm.loop !251
...
._crit_edge.split.us.us.4:                        ; preds = %.critedge.us.us.4, %middle.block309, %vec.epilog.middle.block328, %._crit_edge.split.us.us.3
  ...
  %i.he = load ptr, ptr %i.hd, align 8, !tbaa !115
  %i.hf = load ptr, ptr %i.hc, align 8, !tbaa !18
...
iter.check278:                                    ; preds = %._crit_edge.split.us.us.4
  %i.hm = load i32, ptr getelementptr inbounds nuw (i8, ptr @interaction_function, i64 2256), align 8, !tbaa !89
  %i.hn = add nsw i32 %i.hm, 1                    ; 5 uses
  %i.ho = load i32, ptr %i.bp, align 4, !tbaa !116 ; 3 uses
  %smax256 = tail call i32 @llvm.smax.i32(i32 %i.hn, i32 %i.hk)
  %i.hp = add nsw i32 %smax256, -1
...
vector.body264:                                   ; preds = %vector.body264, %vector.ph260
  ...
  br i1 %i.hz, label %middle.block271, label %vector.body264, !llvm.loop !252
...
vec.epilog.vector.body286:                        ; preds = %vec.epilog.vector.body286, %vec.epilog.ph282
  ...
  br i1 %i.ie, label %vec.epilog.middle.block290, label %vec.epilog.vector.body286, !llvm.loop !253
...
.critedge.us.us.5:                                ; preds = %.critedge.us.us.5.preheader, %.critedge.us.us.5
  ...
  br i1 %i.ii, label %.critedge.us.us.5, label %._crit_edge.split.us.us.5, !llvm.loop !254
...
._crit_edge.split.us.us.5:                        ; preds = %.critedge.us.us.5, %middle.block271, %vec.epilog.middle.block290, %._crit_edge.split.us.us.4
  ...
  %i.il = load ptr, ptr %i.ik, align 8, !tbaa !115
  %i.im = load ptr, ptr %i.ij, align 8, !tbaa !18
...
iter.check240:                                    ; preds = %._crit_edge.split.us.us.5
  %i.it = load i32, ptr getelementptr inbounds nuw (i8, ptr @interaction_function, i64 2288), align 8, !tbaa !89
  %i.iu = add nsw i32 %i.it, 1                    ; 5 uses
  %i.iv = load i32, ptr %i.bp, align 4, !tbaa !116 ; 3 uses
  %smax218 = tail call i32 @llvm.smax.i32(i32 %i.iu, i32 %i.ir)
  %i.iw = add nsw i32 %smax218, -1
...
vector.body226:                                   ; preds = %vector.body226, %vector.ph222
  ...
  br i1 %i.jg, label %middle.block233, label %vector.body226, !llvm.loop !255
...
vec.epilog.vector.body248:                        ; preds = %vec.epilog.vector.body248, %vec.epilog.ph244
  ...
  br i1 %i.jl, label %vec.epilog.middle.block252, label %vec.epilog.vector.body248, !llvm.loop !256
...
.critedge.us.us.6:                                ; preds = %.critedge.us.us.6.preheader, %.critedge.us.us.6
  ...
  br i1 %i.jp, label %.critedge.us.us.6, label %._crit_edge.split.us.us.6, !llvm.loop !257
...
._crit_edge.split.us.us.6:                        ; preds = %.critedge.us.us.6, %middle.block233, %vec.epilog.middle.block252, %._crit_edge.split.us.us.5
  ...
  %i.js = load ptr, ptr %i.jr, align 8, !tbaa !115
  %i.jt = load ptr, ptr %i.jq, align 8, !tbaa !18
...
iter.check202:                                    ; preds = %._crit_edge.split.us.us.6
  %i.ka = load i32, ptr getelementptr inbounds nuw (i8, ptr @interaction_function, i64 2320), align 8, !tbaa !89
  %i.kb = add nsw i32 %i.ka, 1                    ; 5 uses
  %i.kc = load i32, ptr %i.bp, align 4, !tbaa !116 ; 3 uses
  %smax180 = tail call i32 @llvm.smax.i32(i32 %i.kb, i32 %i.jy)
  %i.kd = add nsw i32 %smax180, -1
...
vector.body188:                                   ; preds = %vector.body188, %vector.ph184
  ...
  br i1 %i.kn, label %middle.block195, label %vector.body188, !llvm.loop !258
...
vec.epilog.vector.body210:                        ; preds = %vec.epilog.vector.body210, %vec.epilog.ph206
  ...
  br i1 %i.ks, label %vec.epilog.middle.block214, label %vec.epilog.vector.body210, !llvm.loop !259
...
.critedge.us.us.7:                                ; preds = %.critedge.us.us.7.preheader, %.critedge.us.us.7
  ...
  br i1 %i.kw, label %.critedge.us.us.7, label %._crit_edge.split.us.us.7, !llvm.loop !260
...
._crit_edge.split.us.us.7:                        ; preds = %.critedge.us.us.7, %middle.block195, %vec.epilog.middle.block214, %._crit_edge.split.us.us.6
  ...
  %i.kz = load ptr, ptr %i.ky, align 8, !tbaa !115
  %i.la = load ptr, ptr %i.kx, align 8, !tbaa !18
...
iter.check164:                                    ; preds = %._crit_edge.split.us.us.7
  %i.lh = load i32, ptr getelementptr inbounds nuw (i8, ptr @interaction_function, i64 2352), align 8, !tbaa !89
  %i.li = add nsw i32 %i.lh, 1                    ; 5 uses
  %i.lj = load i32, ptr %i.bp, align 4, !tbaa !116 ; 3 uses
  %smax142 = tail call i32 @llvm.smax.i32(i32 %i.li, i32 %i.lf)
  %i.lk = add nsw i32 %smax142, -1
...
vector.body150:                                   ; preds = %vector.body150, %vector.ph146
  ...
  br i1 %i.lu, label %middle.block157, label %vector.body150, !llvm.loop !261
...
vec.epilog.vector.body172:                        ; preds = %vec.epilog.vector.body172, %vec.epilog.ph168
  ...
  br i1 %i.lz, label %vec.epilog.middle.block176, label %vec.epilog.vector.body172, !llvm.loop !262
...
.critedge.us.us.8:                                ; preds = %.critedge.us.us.8.preheader, %.critedge.us.us.8
  ...
  br i1 %i.md, label %.critedge.us.us.8, label %._crit_edge.split.us.us.8, !llvm.loop !263
...
._crit_edge.split.us.us.8:                        ; preds = %.critedge.us.us.8, %middle.block157, %vec.epilog.middle.block176, %._crit_edge.split.us.us.7
  ...
  %i.mg = load ptr, ptr %i.mf, align 8, !tbaa !115
  %i.mh = load ptr, ptr %i.me, align 8, !tbaa !18
...
iter.check:                                       ; preds = %._crit_edge.split.us.us.8
  %i.mo = load i32, ptr getelementptr inbounds nuw (i8, ptr @interaction_function, i64 2384), align 8, !tbaa !89
  %i.mp = add nsw i32 %i.mo, 1                    ; 5 uses
  %i.mq = load i32, ptr %i.bp, align 4, !tbaa !116 ; 3 uses
  %smax126 = tail call i32 @llvm.smax.i32(i32 %i.mp, i32 %i.mm)
  %i.mr = add nsw i32 %smax126, -1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.nb, label %middle.block, label %vector.body, !llvm.loop !264
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.ng, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !265
...
.critedge.us.us.9:                                ; preds = %.critedge.us.us.9.preheader, %.critedge.us.us.9
  ...
  br i1 %i.nk, label %.critedge.us.us.9, label %.split.us, !llvm.loop !266

iter.check468:                                    ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit.split.us.preheader
  %i.nl = load i32, ptr getelementptr inbounds nuw (i8, ptr @interaction_function, i64 2096), align 8, !tbaa !89
  %i.nm = add nsw i32 %i.nl, 1                    ; 5 uses
  %i.nn = load i32, ptr %i.bp, align 4, !tbaa !116 ; 3 uses
  %smax446 = tail call i32 @llvm.smax.i32(i32 %i.nm, i32 %i.by)
  %i.no = add nsw i32 %smax446, -1
...
vector.body454:                                   ; preds = %vector.body454, %vector.ph450
  ...
  br i1 %i.ny, label %middle.block461, label %vector.body454, !llvm.loop !267
...
vec.epilog.vector.body476:                        ; preds = %vec.epilog.vector.body476, %vec.epilog.ph472
  ...
  br i1 %i.od, label %vec.epilog.middle.block480, label %vec.epilog.vector.body476, !llvm.loop !268
...
.critedge.us.us:                                  ; preds = %.critedge.us.us.preheader, %.critedge.us.us
  ...
  br i1 %i.oh, label %.critedge.us.us, label %._crit_edge.split.us.us, !llvm.loop !269
...
bb.j:                                             ; preds = %.lr.ph125
  ...
  br i1 %exitcond.not, label %.loopexit, label %.lr.ph125, !llvm.loop !270
...
.lr.ph125:                                        ; preds = %bb.i, %bb.j
  ...
  br i1 %.not36, label %bb.j, label %.critedge.loopexit, !llvm.loop !270
...
.loopexit:                                        ; preds = %bb.j, %bb.i, %.critedge.loopexit
  ...
  br i1 %i.pr, label %bb.i, label %._crit_edge.split, !llvm.loop !271
}
...
bb.a:
  ...
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !280  ; 2 uses
