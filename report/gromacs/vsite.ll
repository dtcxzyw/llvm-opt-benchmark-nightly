...
bb.a:
  ...
  %i.c = alloca [3 x float], align 16             ; 8 uses
  %i.d = alloca [3 x float], align 16             ; 8 uses
  %i.e = alloca [3 x float], align 16             ; 8 uses
  ...
  %i.ba = alloca [3 x float], align 4             ; 5 uses
  %i.bb = alloca [3 x float], align 8             ; 5 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %.phi.trans.insert33.i.i = getelementptr inbounds nuw i8, ptr %i.bb, i64 8
...
bb.r:                                             ; preds = %.lr.ph.split.i
  ...
  %i.ru = getelementptr inbounds [12 x i8], ptr %0, i64 %i.rt ; 3 uses
  %i.rv = sext i32 %i.ro to i64                   ; 2 uses
  %i.rw = getelementptr inbounds [12 x i8], ptr %0, i64 %i.rv ; 3 uses
...
bb.s:                                             ; preds = %bb.r
  ...
  %.pre.i89.i = load float, ptr %.phi.trans.insert33.i.i, align 8, !tbaa !92
  %10 = load <2 x float>, ptr %i.bb, align 8, !tbaa !92
  %11 = load <2 x float>, ptr %.phi.trans.insert35.i.i, align 4, !tbaa !92
  %.pre36.i.i = load float, ptr %i.ba, align 4, !tbaa !92
...
bb.t:                                             ; preds = %bb.r
  ...
  %13 = sext i32 %i.rs to i64                     ; 2 uses
  %14 = getelementptr inbounds [12 x i8], ptr %0, i64 %13 ; 2 uses
  %15 = load <3 x float>, ptr %i.rw, align 4, !tbaa !92 ; 3 uses
  %16 = shufflevector <3 x float> %15, <3 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 2>
  %17 = extractelement <3 x float> %15, i64 0
  %i.sd = fsub float %i.sb, %17
  %18 = load <2 x float>, ptr %i.sc, align 4, !tbaa !92
  %i.se = load <2 x float>, ptr %14, align 4, !tbaa !92
  %19 = shufflevector <2 x float> %i.se, <2 x float> %18, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %20 = fsub <4 x float> %19, %16
  %21 = getelementptr inbounds nuw i8, ptr %14, i64 8
  %22 = load float, ptr %21, align 4, !tbaa !92
  %23 = extractelement <3 x float> %15, i64 2
  %24 = fsub float %22, %23
  br label %_ZN3gmxL16spread_vsite3OUTILNS_19VirtualSitesHandler14VirialHandlingE0EEEvPKifffNS_8ArrayRefIKNS_11BasicVectorIfEEEENS5_IS7_EESA_PA3_fPK5t_pbc.exit.i
...
_ZN3gmxL16spread_vsite3OUTILNS_19VirtualSitesHandler14VirialHandlingE0EEEvPKifffNS_8ArrayRefIKNS_11BasicVectorIfEEEENS5_IS7_EESA_PA3_fPK5t_pbc.exit.i: ; preds = %bb.t, %bb.s
  %i.sf = phi float [ %.pre36.i.i, %bb.s ], [ %i.sd, %bb.t ] ; 2 uses
  %i.sg = phi float [ %.pre.i89.i, %bb.s ], [ %24, %bb.t ] ; 2 uses
  %i.sh = phi i64 [ %i.ry, %bb.s ], [ %13, %bb.t ]
  %25 = phi <4 x float> [ %12, %bb.s ], [ %20, %bb.t ] ; 4 uses
  ...
  %26 = extractelement <4 x float> %25, i64 0     ; 2 uses
  %i.sl = fneg float %26
  %i.sm = extractelement <4 x float> %25, i64 1   ; 2 uses
  %i.sn = fneg float %i.sm
  %27 = extractelement <4 x float> %25, i64 2     ; 2 uses
  %i.so = fneg float %27
  %28 = extractelement <4 x float> %25, i64 3     ; 2 uses
  %i.sp = fneg float %28
  ...
  %i.ts = fmul float %i.sf, %i.tf
  %i.tt = fmul float %i.ri, %i.td
  %i.tu = call float @llvm.fmuladd.f32(float %27, float %i.sy, float %i.ts)
  ...
  %i.tx = call float @llvm.fmuladd.f32(float %i.sf, float %i.tb, float %i.tv) ; 2 uses
...
bb.cb:                                            ; preds = %.thread, %bb.b
  ...
  %.phi.trans.insert.i107.i43 = getelementptr inbounds nuw i8, ptr %i.d, i64 4
  %.phi.trans.insert171.i.i = getelementptr inbounds nuw i8, ptr %i.d, i64 8 ; 2 uses
  %.phi.trans.insert174.i.i = getelementptr inbounds nuw i8, ptr %i.e, i64 4
  %.phi.trans.insert176.i.i = getelementptr inbounds nuw i8, ptr %i.e, i64 8 ; 2 uses
  %.phi.trans.insert179.i.i = getelementptr inbounds nuw i8, ptr %i.c, i64 4
  %.phi.trans.insert181.i.i = getelementptr inbounds nuw i8, ptr %i.c, i64 8 ; 2 uses
...
_ZN3gmxL12pbc_rvec_subEPK5t_pbcPKfS4_Pf.exit55.i.i71: ; preds = %bb.cy, %bb.cx
  ...
  %i.ddx = getelementptr inbounds nuw i8, ptr %i.ddw, i64 4
  ...
  %29 = load <3 x float>, ptr %i.ddw, align 4, !tbaa !92 ; 3 uses
  %30 = shufflevector <3 x float> %29, <3 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 0, i32 1, i32 2, i32 0, i32 1>
  %31 = load float, ptr %i.ddx, align 4, !tbaa !92 ; 4 uses
  %i.deg = extractelement <3 x float> %29, i64 0  ; 4 uses
  %i.deh = fmul float %i.dco, %i.deg              ; 4 uses
  %i.dei = fmul float %i.dco, %31                 ; 3 uses
  %32 = extractelement <3 x float> %29, i64 2     ; 5 uses
  %i.dej = fmul float %i.dco, %32                 ; 4 uses
  ...
  %i.deo = call float @llvm.fmuladd.f32(float %i.ckf, float %32, float %i.den) ; 4 uses
  ...
  %i.des = call float @llvm.fmuladd.f32(float %i.dcm, float %32, float %i.der) ; 4 uses
  %i.det = getelementptr inbounds [12 x i8], ptr %1, i64 %i.dcz ; 3 uses
  %i.deu = fsub float %32, %i.deo
  ...
  %i.dfm = call float @llvm.fmuladd.f32(float %i.dep, float %i.dej, float %i.dfk) ; 3 uses
  %i.dfn = call float @llvm.fmuladd.f32(float %i.ded, float %i.dej, float %i.dfl) ; 3 uses
  %i.dfo = fmul float %i.ckf, %31
  ...
  %i.dfs = call float @llvm.fmuladd.f32(float %i.ddz, float %i.dej, float %i.dfq) ; 3 uses
  %i.dft = call float @llvm.fmuladd.f32(float %i.dea, float %i.dej, float %i.dfr) ; 3 uses
  %33 = fsub float %31, %i.dfs
  %34 = fsub float %i.deg, %i.dft
  %35 = fsub float %33, %i.dfm
  %36 = fsub float %34, %i.dfn
  %i.dfu = insertelement <2 x float> poison, float %36, i64 0
  %37 = insertelement <2 x float> %i.dfu, float %35, i64 1
  %i.dfv = fadd <2 x float> %i.dfh, %37
  store <2 x float> %i.dfv, ptr %i.det, align 4, !tbaa !92
  %i.dfw = load <2 x float>, ptr %i.dez, align 4, !tbaa !92
  %38 = insertelement <2 x float> poison, float %i.dft, i64 0
  %39 = insertelement <2 x float> %38, float %i.dfs, i64 1
  %i.dfx = fadd <2 x float> %39, %i.dfw
  store <2 x float> %i.dfx, ptr %i.dez, align 4, !tbaa !92
  %i.dfy = load <2 x float>, ptr %i.dfd, align 4, !tbaa !92
  %40 = insertelement <2 x float> poison, float %i.dfn, i64 0
  %41 = insertelement <2 x float> %40, float %i.dfm, i64 1
  %i.dfz = fadd <2 x float> %41, %i.dfy
...
_ZN3gmxL16spread_vsite3OUTILNS_19VirtualSitesHandler14VirialHandlingE2EEEvPKifffNS_8ArrayRefIKNS_11BasicVectorIfEEEENS5_IS7_EESA_PA3_fPK5t_pbc.exit.i: ; preds = %bb.da, %bb.cz
  ...
  %i.dgu = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.dgo, <8 x float> %30, <8 x float> %i.dgt)
  ...
  %i.dhf = call float @llvm.fmuladd.f32(float %i.dhe, float %32, float %i.dhd)
...
bb.dg:                                            ; preds = %.lr.ph.split.i61
  ...
  %i.dnj = getelementptr inbounds [12 x i8], ptr %1, i64 %i.dni ; 2 uses
  %i.dnk = load float, ptr %i.dmx, align 4, !tbaa !81
  %i.dnl = load float, ptr %i.dmw, align 4, !tbaa !81 ; 8 uses
  %42 = load <3 x float>, ptr %i.dnj, align 4, !tbaa !92 ; 3 uses
  %43 = shufflevector <3 x float> %42, <3 x float> poison, <8 x i32> <i32 1, i32 0, i32 2, i32 1, i32 0, i32 2, i32 1, i32 0>
  %i.dnm = load float, ptr %i.dnj, align 4, !tbaa !92 ; 2 uses
...
bb.dh:                                            ; preds = %bb.dg
  ...
  %.pre.i106.i62 = load float, ptr %i.d, align 16, !tbaa !92
  %.pre175.i.i = load float, ptr %.phi.trans.insert174.i.i, align 4, !tbaa !92
  %.pre173.i.i = load float, ptr %i.e, align 16, !tbaa !92
  %.pre180.i.i = load float, ptr %.phi.trans.insert179.i.i, align 4, !tbaa !92
  %.pre178.i.i = load float, ptr %i.c, align 16, !tbaa !92
...
bb.di:                                            ; preds = %bb.dg
  ...
  store <2 x float> %i.doo, ptr %i.c, align 16, !tbaa !92
  ...
  store <2 x float> %i.dor, ptr %i.d, align 16, !tbaa !92
  ...
  store <2 x float> %i.dot, ptr %i.e, align 16, !tbaa !92
...
_ZN3gmxL12pbc_rvec_subEPK5t_pbcPKfS4_Pf.exit112.i.i: ; preds = %bb.di, %bb.dh
  ...
  %44 = fneg float %i.dqj
  %i.drh = fmul float %i.dqv, %44
  %45 = call float @llvm.fmuladd.f32(float %i.dqt, float %i.dqi, float %i.drh)
  %i.dri = fmul float %i.dnl, %i.dra              ; 3 uses
  %46 = fmul float %45, %i.dri                    ; 2 uses
  %i.drj = fmul float %i.drf, %i.drg              ; 2 uses
  %i.drk = fmul float %i.drc, %i.dra              ; 3 uses
  %i.drl = fmul float %i.dnk, %i.dqz              ; 3 uses
  %47 = extractelement <3 x float> %42, i64 1     ; 2 uses
  %i.drm = fmul float %47, %i.drl                 ; 9 uses
  ...
  %i.dsa = call float @llvm.fmuladd.f32(float %i.drd, float %i.drk, float %i.dqd)
  %i.dsb = call float @llvm.fmuladd.f32(float %i.drd, float %i.drs, float %i.dqe)
  %i.dsc = call float @llvm.fmuladd.f32(float %i.drw, float %i.drk, float %i.dqg)
  %i.dsd = call float @llvm.fmuladd.f32(float %i.drw, float %i.drt, float %i.dqc)
  %i.dse = fmul float %i.drm, %i.dsc
  %i.dsf = fmul float %i.drm, %i.dsd
  %i.dsg = fmul float %i.drm, %i.drx
  %i.dsh = call float @llvm.fmuladd.f32(float %i.dsa, float %i.drn, float %i.dse)
  %i.dsi = call float @llvm.fmuladd.f32(float %i.dru, float %i.drn, float %i.dsf)
  %i.dsj = call float @llvm.fmuladd.f32(float %i.dsb, float %i.drn, float %i.dsg)
  %i.dsk = fmul float %i.dqk, %i.drv
  %i.dsl = fmul float %i.dql, %i.drw
  %48 = call float @llvm.fmuladd.f32(float %i.dql, float %i.dqt, float %i.dsk)
  %i.dsm = call float @llvm.fmuladd.f32(float %i.dqm, float %i.dqu, float %i.dsl)
  %49 = fmul float %48, %i.drg                    ; 2 uses
  %i.dsn = fmul float %i.dsm, %i.drg              ; 2 uses
  %50 = fneg float %49                            ; 2 uses
  %i.dso = fneg float %i.dsn                      ; 2 uses
  %i.dsp = fneg float %i.dqh
  %51 = fneg float %i.dqi
  %i.dsq = fmul float %i.dqt, %i.dsp
  %i.dsr = fmul float %i.dqu, %51
  %52 = call float @llvm.fmuladd.f32(float %i.dqu, float %i.dqj, float %i.dsq)
  %53 = call float @llvm.fmuladd.f32(float %i.dqv, float %i.dqh, float %i.dsr)
  %i.dss = fmul float %52, %i.dri                 ; 2 uses
  %i.dst = fmul float %53, %i.dri                 ; 2 uses
  %54 = fneg float %i.dss                         ; 2 uses
  %55 = fneg float %i.dst                         ; 2 uses
  %i.dsu = fmul float %46, %i.drv
  %i.dsv = fmul float %i.dqu, %55
  %56 = fmul float %i.dqu, %54
  %57 = fmul float %i.drj, %i.drv
  %i.dsw = fmul float %i.dqu, %i.dso
  %i.dsx = fmul float %i.dqu, %50
  %i.dsy = fmul float %i.drk, %i.drv
  %58 = extractelement <3 x float> %42, i64 2     ; 3 uses
  %i.dsz = fmul float %58, %i.drl                 ; 9 uses
  %i.dta = call float @llvm.fmuladd.f32(float %i.dsy, float %i.dsz, float %i.dsh) ; 4 uses
  %i.dtb = call float @llvm.fmuladd.f32(float %i.drz, float %i.dsz, float %i.dsi) ; 3 uses
  %i.dtc = call float @llvm.fmuladd.f32(float %i.dry, float %i.dsz, float %i.dsj) ; 3 uses
  %i.dtd = fmul float %i.dsn, %i.drd
  %i.dte = fmul float %i.dqv, %i.dso
  %i.dtf = fmul float %i.dqt, %50
  %i.dtg = fmul float %49, %i.drw
  %i.dth = call float @llvm.fmuladd.f32(float %i.ckf, float %i.dqm, float %i.dsw)
  %i.dti = call float @llvm.fmuladd.f32(float %i.dqa, float %i.dqk, float %i.dsx)
  %i.dtj = fneg float %i.drj                      ; 2 uses
  ...
  %i.dtr = fmul float %i.drm, %i.dtp
  %i.dts = fmul float %i.drm, %i.dtg
  %i.dtt = call float @llvm.fmuladd.f32(float %i.dtl, float %i.drn, float %i.dtq)
  %i.dtu = call float @llvm.fmuladd.f32(float %i.dtd, float %i.drn, float %i.dtr)
  %i.dtv = call float @llvm.fmuladd.f32(float %i.dtm, float %i.drn, float %i.dts)
  %i.dtw = call float @llvm.fmuladd.f32(float %57, float %i.dsz, float %i.dtt) ; 4 uses
  %i.dtx = call float @llvm.fmuladd.f32(float %i.dth, float %i.dsz, float %i.dtu) ; 3 uses
  %i.dty = call float @llvm.fmuladd.f32(float %i.dti, float %i.dsz, float %i.dtv) ; 3 uses
  %i.dtz = fmul float %i.dst, %i.drd
  %i.dua = fmul float %i.dqv, %55
  %i.dub = fmul float %i.dqt, %54
  %i.duc = fmul float %i.dss, %i.drw
  %i.dud = call float @llvm.fmuladd.f32(float %i.dpy, float %i.dqi, float %i.dsv)
  %i.due = call float @llvm.fmuladd.f32(float %i.dnl, float %i.dqj, float %56)
  %i.duf = fneg float %46                         ; 2 uses
  ...
  %i.dun = fmul float %i.drm, %i.dul
  %i.duo = fmul float %i.drm, %i.duc
  %i.dup = call float @llvm.fmuladd.f32(float %i.duh, float %i.drn, float %i.dum)
  %i.duq = call float @llvm.fmuladd.f32(float %i.dtz, float %i.drn, float %i.dun)
  %i.dur = call float @llvm.fmuladd.f32(float %i.dui, float %i.drn, float %i.duo)
  %i.dus = call float @llvm.fmuladd.f32(float %i.dsu, float %i.dsz, float %i.dup) ; 4 uses
  %i.dut = call float @llvm.fmuladd.f32(float %i.dud, float %i.dsz, float %i.duq) ; 3 uses
  %i.duu = call float @llvm.fmuladd.f32(float %i.due, float %i.dsz, float %i.dur) ; 3 uses
  %i.duv = fsub float %47, %i.dtc
  %i.duw = fsub float %i.dnm, %i.dtb
  %i.dux = fsub float %i.duv, %i.dty
  %i.duy = fsub float %i.duw, %i.dtx
  %i.duz = fsub float %i.dux, %i.duu
  %i.dva = fsub float %i.duy, %i.dut
  ...
  %i.dvj = insertelement <2 x float> poison, float %i.dtb, i64 0
  %i.dvk = insertelement <2 x float> %i.dvj, float %i.dtc, i64 1
  ...
  %i.dvp = insertelement <2 x float> poison, float %i.dtx, i64 0
  %i.dvq = insertelement <2 x float> %i.dvp, float %i.dty, i64 1
...
_ZN3gmxL16spread_vsite4FDNILNS_19VirtualSitesHandler14VirialHandlingE2EEEvPKifffNS_8ArrayRefIKNS_11BasicVectorIfEEEENS5_IS7_EESA_PA3_fPK5t_pbc.exit.i: ; preds = %bb.dk, %bb.dj
  ...
  %i.dwp = phi <2 x float> [ %i.dwf, %bb.dj ], [ %i.dwm, %bb.dk ]
  %59 = shufflevector <2 x float> %i.dwp, <2 x float> poison, <3 x i32> <i32 poison, i32 1, i32 0>
  %60 = insertelement <3 x float> %59, float %i.dwo, i64 0
  %61 = fneg <3 x float> %60                      ; 2 uses
  %62 = shufflevector <3 x float> %61, <3 x float> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 1, i32 2, i32 2, i32 2>
  %63 = load <3 x float>, ptr %i.c, align 16, !tbaa !92 ; 2 uses
  %64 = shufflevector <3 x float> %63, <3 x float> poison, <8 x i32> <i32 2, i32 2, i32 1, i32 1, i32 1, i32 0, i32 0, i32 0>
  %65 = load <3 x float>, ptr %i.d, align 16, !tbaa !92 ; 2 uses
  %66 = shufflevector <3 x float> %65, <3 x float> poison, <8 x i32> <i32 2, i32 2, i32 1, i32 1, i32 1, i32 0, i32 0, i32 0>
  %67 = load <3 x float>, ptr %i.e, align 16, !tbaa !92 ; 2 uses
  %68 = shufflevector <3 x float> %67, <3 x float> poison, <8 x i32> <i32 2, i32 2, i32 1, i32 1, i32 1, i32 0, i32 0, i32 0>
  %69 = insertelement <8 x float> poison, float %i.dtc, i64 0
  %70 = insertelement <8 x float> %69, float %i.dtb, i64 1
  %71 = insertelement <8 x float> %70, float %i.dta, i64 2
  %72 = shufflevector <8 x float> %71, <8 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 0, i32 1, i32 2, i32 0, i32 1>
  %73 = fmul <8 x float> %72, %64
  %74 = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %62, <8 x float> %43, <8 x float> %73)
  %75 = insertelement <8 x float> poison, float %i.dty, i64 0
  %76 = insertelement <8 x float> %75, float %i.dtx, i64 1
  %77 = insertelement <8 x float> %76, float %i.dtw, i64 2
  %78 = shufflevector <8 x float> %77, <8 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 0, i32 1, i32 2, i32 0, i32 1>
  %79 = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %66, <8 x float> %78, <8 x float> %74)
  %80 = insertelement <8 x float> poison, float %i.duu, i64 0
  %81 = insertelement <8 x float> %80, float %i.dut, i64 1
  %82 = insertelement <8 x float> %81, float %i.dus, i64 2
  %83 = shufflevector <8 x float> %82, <8 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 0, i32 1, i32 2, i32 0, i32 1>
  %84 = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %68, <8 x float> %83, <8 x float> %79)
  %i.dwq = load <8 x float>, ptr %3, align 4, !tbaa !92
  %85 = shufflevector <8 x float> %84, <8 x float> poison, <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  %86 = fadd <8 x float> %i.dwq, %85
  store <8 x float> %86, ptr %3, align 4, !tbaa !92
  %87 = extractelement <3 x float> %63, i64 2
  %88 = fmul float %i.dta, %87
  %89 = extractelement <3 x float> %61, i64 0
  %90 = call float @llvm.fmuladd.f32(float %89, float %58, float %88)
  %91 = extractelement <3 x float> %65, i64 2
  %i.dwr = call float @llvm.fmuladd.f32(float %91, float %i.dtw, float %90)
  %92 = extractelement <3 x float> %67, i64 2
  %i.dws = call float @llvm.fmuladd.f32(float %92, float %i.dus, float %i.dwr)
