...
vector.body353:                                   ; preds = %vector.body353, %vector.ph345
  ...
  %i.yo = sub nsw <8 x i64> %broadcast.splat350, %vec.ind355 ; 2 uses
  ...
  %i.ys = trunc nsw <8 x i64> %i.yo to <8 x i32>
  %9 = sitofp <8 x i32> %i.ys to <8 x float>
...
.lr.ph263.i:                                      ; preds = %.lr.ph263.i.preheader509, %.lr.ph263.i
  ...
  %i.abf = sub nsw i64 %i.hw, %indvars.iv339.i    ; 2 uses
  ...
  %i.abj = trunc nsw i64 %i.abf to i32
  %10 = sitofp i32 %i.abj to float
...
vector.body258:                                   ; preds = %vector.body258, %vector.ph250
  ...
  %i.agr = sub nsw <8 x i64> %broadcast.splat255, %vec.ind260 ; 2 uses
  ...
  %i.agv = trunc nsw <8 x i64> %i.agr to <8 x i32>
  %11 = sitofp <8 x i32> %i.agv to <8 x float>
...
.lr.ph263.1.i:                                    ; preds = %.lr.ph263.1.i.preheader508, %.lr.ph263.1.i
  ...
  %i.ahf = sub nsw i64 %i.hw, %indvars.iv339.1.i  ; 2 uses
  ...
  %i.ahj = trunc nsw i64 %i.ahf to i32
  %12 = sitofp i32 %i.ahj to float
...
vector.body167:                                   ; preds = %vector.body167, %vector.ph159
  ...
  %i.ang = sub nsw <8 x i64> %broadcast.splat164, %vec.ind ; 2 uses
  ...
  %i.ank = trunc nsw <8 x i64> %i.ang to <8 x i32>
  %13 = sitofp <8 x i32> %i.ank to <8 x float>
...
.lr.ph263.2.i:                                    ; preds = %.lr.ph263.2.i.preheader507, %.lr.ph263.2.i
  ...
  %i.anu = sub nsw i64 %i.hw, %indvars.iv339.2.i  ; 2 uses
  ...
  %i.any = trunc nsw i64 %i.anu to i32
  %14 = sitofp i32 %i.any to float
