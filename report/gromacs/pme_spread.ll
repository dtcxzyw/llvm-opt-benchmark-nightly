...
.lr.ph272.i:                                      ; preds = %bb.j
  ...
  %i.hw = sext i32 %i.he to i64                   ; 8 uses
...
.lr.ph272.split.preheader.i:                      ; preds = %.lr.ph272.i
  %i.ij = zext i32 %i.he to i64                   ; 15 uses
  ...
  %broadcast.splatinsert349 = insertelement <8 x i64> poison, i64 %i.hw, i64 0
  ...
  %broadcast.splatinsert254 = insertelement <8 x i64> poison, i64 %i.hw, i64 0
  ...
  %broadcast.splatinsert163 = insertelement <8 x i64> poison, i64 %i.hw, i64 0
...
.lr.ph263.i:                                      ; preds = %.lr.ph263.i.preheader508, %.lr.ph263.i
  ...
  %i.abg = sub nuw nsw i64 %i.hw, %indvars.iv339.i ; 2 uses
...
.lr.ph263.1.i:                                    ; preds = %.lr.ph263.1.i.preheader507, %.lr.ph263.1.i
  ...
  %i.ahi = sub nuw nsw i64 %i.hw, %indvars.iv339.1.i ; 2 uses
