...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %_ZL22calc_interpolation_idxPK9gmx_pme_tP11PmeAtomCommiRK10pmegrids_tii.exit
  ...
  %i.o = load i32, ptr %i.n, align 8, !tbaa !180  ; 2 uses
  %i.p = trunc nsw i64 %indvars.iv to i32
  %6 = mul nsw i32 %i.o, %i.p
  %7 = load i32, ptr %2, align 4, !tbaa !105      ; 2 uses
  %8 = sdiv i32 %6, %7                            ; 3 uses
  %indvars.iv.next = add nsw i64 %indvars.iv, 1   ; 2 uses
  %9 = trunc nsw i64 %indvars.iv.next to i32
  %10 = mul nsw i32 %i.o, %9
  %11 = sdiv i32 %10, %7                          ; 3 uses
...
.lr.ph129.i:                                      ; preds = %._crit_edge126.i
  ...
  %i.fi = sext i32 %8 to i64                      ; 4 uses
  %wide.trip.count145.i = sext i32 %11 to i64     ; 3 uses
