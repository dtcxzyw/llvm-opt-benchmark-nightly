...
bb.p:                                             ; preds = %bb.n, %bb.o
  %i.apf = phi ptr [ %i.ape, %bb.o ], [ %i.apb, %bb.n ] ; 6 uses
  ...
  %i.apm = getelementptr inbounds nuw i8, ptr %i.apf, i64 24
  %9 = load <2 x i32>, ptr %i.apl, align 4, !tbaa !105 ; 5 uses
  %10 = load <2 x i32>, ptr %i.apm, align 8, !tbaa !105 ; 4 uses
  %11 = getelementptr inbounds nuw i8, ptr %i.apf, i64 32
  %12 = load i32, ptr %11, align 8, !tbaa !105    ; 4 uses
  %13 = extractelement <2 x i32> %9, i64 0        ; 5 uses
  %14 = extractelement <2 x i32> %9, i64 1        ; 13 uses
  %i.apn = mul i32 %14, %13                       ; 5 uses
...
.lr.ph423.i:                                      ; preds = %._crit_edge.i41
  ...
  %i.aqg = sext i32 %14 to i64                    ; 5 uses
  %i.aqh = shl nsw i32 %14, 1
  %i.aqi = sext i32 %i.aqh to i64                 ; 5 uses
  %i.aqj = mul nsw i32 %14, 3
  %i.aqk = sext i32 %i.aqj to i64                 ; 5 uses
  %i.aql = shl nsw i32 %14, 2
...
.lr.ph423.split.us425.i.preheader:                ; preds = %.lr.ph423.i
  %i.aqo = shufflevector <2 x i32> %9, <2 x i32> poison, <4 x i32> zeroinitializer
  %15 = shufflevector <2 x i32> %9, <2 x i32> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
...
.lr.ph423.split.preheader.i:                      ; preds = %.lr.ph423.i
  ...
  %i.aqw = zext i32 %14 to i64
  %scevgep121 = getelementptr i8, ptr %i.apr, i64 %i.aqs
  %i.aqx = extractelement <2 x i32> %10, i64 0
  %i.aqy = extractelement <2 x i32> %10, i64 1    ; 2 uses
...
.loopexit406.us.loopexit.i:                       ; preds = %.lr.ph423.split.us.i
  ...
  %i.asu = sub nsw <2 x i32> %i.ast, %10          ; 3 uses
  %i.asv = extractelement <2 x i32> %i.asu, i64 1 ; 3 uses
  %i.asw = mul nsw i32 %i.asv, %14
  %i.asx = sext i32 %i.asw to i64                 ; 4 uses
  %i.asy = add nsw <2 x i32> %i.asu, splat (i32 1) ; 2 uses
  %foldExtExtBinop = mul nsw <2 x i32> %i.asy, %9
  %16 = extractelement <2 x i32> %foldExtExtBinop, i64 1
  %i.asz = sext i32 %16 to i64                    ; 4 uses
  %i.ata = add nsw i32 %i.asv, 2
  %i.atb = mul nsw i32 %i.ata, %14
  %i.atc = sext i32 %i.atb to i64                 ; 4 uses
  %i.atd = add nsw i32 %i.asv, 3
  %i.ate = mul nsw i32 %i.atd, %14
...
.loopexit407.us.loopexit.i:                       ; preds = %.lr.ph423.split.us425.i
  ...
  %i.axc = sub nsw i32 %i.axb, %12                ; 2 uses
  ...
  %i.aza = sub nsw <2 x i32> %i.ayz, %10          ; 4 uses
...
.lr.ph417.i.preheader:                            ; preds = %.preheader.i46
  ...
  %i.bfz = sub i32 %i.bfq, %12
  %i.bga = sub i32 %i.bfn, %i.aqy
  %i.bgb = mul i32 %13, %i.bfl
  %i.bgc = add i32 %i.bga, %i.bgb
  %i.bgd = mul i32 %14, %i.bgc
