...
bb.ab:                                            ; preds = %_ZNSt10filesystem7__cxx114pathD2Ev.exit.i
  ...
  %i.de = add nsw i32 %i.dd, 1                    ; 19 uses
  ...
  %.0236 = select i1 %i.ds, i32 1, i32 %i.dk      ; 24 uses
...
.noexc35:                                         ; preds = %bb.ab
  ...
  %i.ef = insertelement <2 x i32> %i.ee, i32 %i.de, i64 1 ; 2 uses
...
._crit_edge184.i:                                 ; preds = %.lr.ph183.i, %.preheader.i
  ...
  %i.hm = fdiv <2 x float> %i.hl, %i.ey
  %32 = fptosi <2 x float> %i.hm to <2 x i32>
  %33 = srem <2 x i32> %32, %i.ef                 ; 2 uses
