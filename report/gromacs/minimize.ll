...
bb.z:                                             ; preds = %bb.s
  ...
  %i.bn = sext i32 %i.bi to i64                   ; 12 uses
...
bb.ab:                                            ; preds = %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i
  ...
  %i.bq = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.bp) #35
          to label %.noexc623 unwind label %bb.ag ; 5 uses

.noexc623:                                        ; preds = %bb.ab
  %i.br = getelementptr inbounds nuw [4 x i8], ptr %i.bq, i64 %i.bn ; 2 uses
  store float 0.000000e+00, ptr %i.bq, align 4, !tbaa !333
  %i.bs = add nsw i64 %i.bn, -1                   ; 2 uses
  %19 = icmp eq i64 %i.bs, 0
  br i1 %19, label %_ZNSt6vectorIfSaIfEEC2EmRKS0_.exit, label %_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i

_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i: ; preds = %.noexc623
  %20 = getelementptr i8, ptr %i.bq, i64 4
  %.idx.i.i.i.i.i.i.i = shl nuw nsw i64 %i.bs, 2
  call void @llvm.memset.p0.i64(ptr align 4 %20, i8 0, i64 %.idx.i.i.i.i.i.i.i, i1 false), !tbaa !333
  br label %_ZNSt6vectorIfSaIfEEC2EmRKS0_.exit

_ZNSt6vectorIfSaIfEEC2EmRKS0_.exit:               ; preds = %_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i, %.noexc623, %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i
  %.sroa.16.0 = phi ptr [ %i.br, %_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i ], [ %i.br, %.noexc623 ], [ null, %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i ] ; 2 uses
  %.sroa.0824.0 = phi ptr [ %i.bq, %_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i ], [ %i.bq, %.noexc623 ], [ null, %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i ] ; 67 uses
  %.sroa.0824.01714 = ptrtoaddr ptr %.sroa.0824.0 to i64
  %i.bt = sext i32 %i.bm to i64                   ; 8 uses
  %i.bu = icmp slt i32 %i.bm, 0
  br i1 %i.bu, label %bb.ac, label %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i624
...
bb.ad:                                            ; preds = %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i624
  %i.bv = shl nuw nsw i64 %i.bt, 2                ; 2 uses
  %i.bw = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.bv) #35
          to label %.noexc631 unwind label %bb.ah ; 7 uses

.noexc631:                                        ; preds = %bb.ad
  %i.bx = getelementptr inbounds nuw [4 x i8], ptr %i.bw, i64 %i.bt ; 4 uses
  store float 0.000000e+00, ptr %i.bw, align 4, !tbaa !333
  %i.by = add nsw i64 %i.bt, -1                   ; 3 uses
  %i.bz = icmp eq i64 %i.by, 0                    ; 2 uses
  br i1 %i.bz, label %bb.ae, label %_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i626

_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i626: ; preds = %.noexc631
  %i.ca = getelementptr i8, ptr %i.bw, i64 4
  %.idx.i.i.i.i.i.i.i627 = shl nuw nsw i64 %i.by, 2
  call void @llvm.memset.p0.i64(ptr align 4 %i.ca, i8 0, i64 %.idx.i.i.i.i.i.i.i627, i1 false), !tbaa !333
  br label %bb.ae

bb.ae:                                            ; preds = %.noexc631, %_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i626
  %i.cb = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.bv) #35
          to label %.noexc640 unwind label %_ZNSt6vectorIfSaIfEED2Ev.exit751.thread ; 6 uses

.noexc640:                                        ; preds = %bb.ae
  %i.cc = getelementptr inbounds nuw [4 x i8], ptr %i.cb, i64 %i.bt ; 3 uses
  store float 0.000000e+00, ptr %i.cb, align 4, !tbaa !333
  br i1 %i.bz, label %.lr.ph.preheader.i.i.i.i.i, label %_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i635

_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i635: ; preds = %.noexc640
  %i.cd = getelementptr i8, ptr %i.cb, i64 4
  %.idx.i.i.i.i.i.i.i636 = shl nuw nsw i64 %i.by, 2
  call void @llvm.memset.p0.i64(ptr align 4 %i.cd, i8 0, i64 %.idx.i.i.i.i.i.i.i636, i1 false), !tbaa !333
...
.lr.ph.preheader.i.i.i.i.i:                       ; preds = %.noexc640, %_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i635
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #23
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %6, i8 0, i64 24, i1 false)
  %i.ci = mul nuw nsw i64 %i.bt, 24               ; 3 uses
...
bb.af:                                            ; preds = %.lr.ph.preheader.i.i.i.i.i
  store ptr %i.cj, ptr %6, align 8, !tbaa !659
  %i.ck = getelementptr inbounds nuw [24 x i8], ptr %i.cj, i64 %i.bt
  call void @llvm.memset.p0.i64(ptr nonnull align 8 %i.cj, i8 0, i64 %i.ci, i1 false)
  %scevgep.i.i.i.i.i = getelementptr i8, ptr %i.cj, i64 %i.ci ; 2 uses
  %i.cl = getelementptr inbounds nuw i8, ptr %6, i64 8 ; 2 uses
  %i.cm = getelementptr inbounds nuw i8, ptr %6, i64 16 ; 2 uses
  store ptr %i.ck, ptr %i.cm, align 8, !tbaa !660
  store ptr %scevgep.i.i.i.i.i, ptr %i.cl, align 8, !tbaa !661
  br label %.lr.ph

_ZNSt6vectorIS_IfSaIfEESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i645: ; preds = %_ZNSt6vectorIfSaIfEE6resizeEm.exit
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #23
  %i.cn = mul nuw nsw i64 %i.bt, 24               ; 3 uses
  %i.co = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.cn) #35
          to label %bb.al unwind label %.thread1467 ; 5 uses
...
.lr.ph:                                           ; preds = %bb.af, %_ZNSt6vectorIfSaIfEE6resizeEm.exit
  %.sroa.0802.01016 = phi ptr [ %i.de, %_ZNSt6vectorIfSaIfEE6resizeEm.exit ], [ %i.cj, %bb.af ] ; 4 uses
  %i.ct = getelementptr inbounds nuw i8, ptr %.sroa.0802.01016, i64 8 ; 2 uses
  %i.cu = load ptr, ptr %i.ct, align 8, !tbaa !509 ; 2 uses
  %i.cv = load ptr, ptr %.sroa.0802.01016, align 8, !tbaa !505 ; 2 uses
  %i.cw = ptrtoint ptr %i.cu to i64
  %i.cx = ptrtoint ptr %i.cv to i64
  %i.cy = sub i64 %i.cw, %i.cx
  %i.cz = ashr exact i64 %i.cy, 2                 ; 3 uses
  %i.da = icmp ult i64 %i.cz, %i.bn
  br i1 %i.da, label %bb.ai, label %bb.aj

bb.ai:                                            ; preds = %.lr.ph
  %i.db = sub nuw nsw i64 %i.bn, %i.cz
  invoke void @_ZNSt6vectorIfSaIfEE17_M_default_appendEm(ptr noundef nonnull align 8 dereferenceable(24) %.sroa.0802.01016, i64 noundef %i.db)
          to label %_ZNSt6vectorIfSaIfEE6resizeEm.exit unwind label %.thread1460

bb.aj:                                            ; preds = %.lr.ph
  %i.dc = icmp ugt i64 %i.cz, %i.bn
  br i1 %i.dc, label %bb.ak, label %_ZNSt6vectorIfSaIfEE6resizeEm.exit

bb.ak:                                            ; preds = %bb.aj
  %i.dd = getelementptr inbounds nuw [4 x i8], ptr %i.cv, i64 %i.bn ; 2 uses
  %.not.i.i = icmp eq ptr %i.cu, %i.dd
...
bb.al:                                            ; preds = %_ZNSt6vectorIS_IfSaIfEESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i645
  store ptr %i.co, ptr %7, align 8, !tbaa !659
  %i.dg = getelementptr inbounds nuw [24 x i8], ptr %i.co, i64 %i.bt
  call void @llvm.memset.p0.i64(ptr nonnull align 8 %i.co, i8 0, i64 %i.cn, i1 false)
  %scevgep.i.i.i.i.i648 = getelementptr i8, ptr %i.co, i64 %i.cn ; 2 uses
  %i.dh = getelementptr inbounds nuw i8, ptr %7, i64 8 ; 2 uses
  %i.di = getelementptr inbounds nuw i8, ptr %7, i64 16 ; 2 uses
  store ptr %i.dg, ptr %i.di, align 8, !tbaa !660
  store ptr %scevgep.i.i.i.i.i648, ptr %i.dh, align 8, !tbaa !661
  br label %.lr.ph1019
...
._crit_edge:                                      ; preds = %_ZNSt6vectorIfSaIfEE6resizeEm.exit659, %_ZNSt6vectorIS_IfSaIfEESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i645.thread
  %i.dj = phi ptr [ %i.ch, %_ZNSt6vectorIS_IfSaIfEESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i645.thread ], [ %i.di, %_ZNSt6vectorIfSaIfEE6resizeEm.exit659 ]
  %i.dk = phi ptr [ %i.cg, %_ZNSt6vectorIS_IfSaIfEESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i645.thread ], [ %i.dh, %_ZNSt6vectorIfSaIfEE6resizeEm.exit659 ]
  %i.dl = phi ptr [ %i.ce, %_ZNSt6vectorIS_IfSaIfEESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i645.thread ], [ %i.cm, %_ZNSt6vectorIfSaIfEE6resizeEm.exit659 ]
  %i.dm = phi ptr [ %i.cf, %_ZNSt6vectorIS_IfSaIfEESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i645.thread ], [ %i.cl, %_ZNSt6vectorIfSaIfEE6resizeEm.exit659 ]
  %.sroa.0815.0881887139814181446 = phi ptr [ null, %_ZNSt6vectorIS_IfSaIfEESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i645.thread ], [ %i.bw, %_ZNSt6vectorIfSaIfEE6resizeEm.exit659 ] ; 9 uses
  %.sroa.12821.0859889137914201445 = phi ptr [ null, %_ZNSt6vectorIS_IfSaIfEESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i645.thread ], [ %i.bx, %_ZNSt6vectorIfSaIfEE6resizeEm.exit659 ] ; 2 uses
  %.sroa.12.0910136014221444 = phi ptr [ null, %_ZNSt6vectorIS_IfSaIfEESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i645.thread ], [ %i.cc, %_ZNSt6vectorIfSaIfEE6resizeEm.exit659 ] ; 2 uses
  %.sroa.0807.0931134114241443 = phi ptr [ null, %_ZNSt6vectorIS_IfSaIfEESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i645.thread ], [ %i.cb, %_ZNSt6vectorIfSaIfEE6resizeEm.exit659 ] ; 7 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #23
  %i.dn = getelementptr inbounds nuw i8, ptr %0, i64 240
  %i.do = load ptr, ptr %i.dn, align 8, !tbaa !192
  invoke void @_ZN3gmx25ObservablesReducerBuilder5buildEv(ptr dead_on_unwind nonnull writable sret(%"class.gmx::ObservablesReducer") align 8 %8, ptr noundef nonnull align 8 dereferenceable(8) %i.do)
          to label %bb.aq unwind label %bb.bk

.thread1467:                                      ; preds = %_ZNSt6vectorIS_IfSaIfEESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i645
...
.lr.ph1019:                                       ; preds = %bb.al, %_ZNSt6vectorIfSaIfEE6resizeEm.exit659
  %.sroa.0797.01018 = phi ptr [ %i.eb, %_ZNSt6vectorIfSaIfEE6resizeEm.exit659 ], [ %i.co, %bb.al ] ; 4 uses
  %i.dq = getelementptr inbounds nuw i8, ptr %.sroa.0797.01018, i64 8 ; 2 uses
  %i.dr = load ptr, ptr %i.dq, align 8, !tbaa !509 ; 2 uses
  %i.ds = load ptr, ptr %.sroa.0797.01018, align 8, !tbaa !505 ; 2 uses
  %i.dt = ptrtoint ptr %i.dr to i64
  %i.du = ptrtoint ptr %i.ds to i64
  %i.dv = sub i64 %i.dt, %i.du
  %i.dw = ashr exact i64 %i.dv, 2                 ; 3 uses
  %i.dx = icmp ult i64 %i.dw, %i.bn
  br i1 %i.dx, label %bb.am, label %bb.an

bb.am:                                            ; preds = %.lr.ph1019
  %i.dy = sub nuw nsw i64 %i.bn, %i.dw
  invoke void @_ZNSt6vectorIfSaIfEE17_M_default_appendEm(ptr noundef nonnull align 8 dereferenceable(24) %.sroa.0797.01018, i64 noundef %i.dy)
          to label %_ZNSt6vectorIfSaIfEE6resizeEm.exit659 unwind label %bb.ap

bb.an:                                            ; preds = %.lr.ph1019
  %i.dz = icmp ugt i64 %i.dw, %i.bn
  br i1 %i.dz, label %bb.ao, label %_ZNSt6vectorIfSaIfEE6resizeEm.exit659

bb.ao:                                            ; preds = %bb.an
end_hunk_0
begin_hunk_1_@_ZN3gmx15LegacySimulator8do_lbfgsEv:bb.a
  %i.bnm = load ptr, ptr @stderr, align 8, !tbaa !236
  %i.bnn = load ptr, ptr %i.bj, align 8, !tbaa !80
  %i.bno = getelementptr inbounds nuw i8, ptr %i.bnn, i64 504
  %i.bnp = load float, ptr %i.bno, align 8, !tbaa !237
  %i.bnq = trunc nuw i8 %.6 to i1                 ; 2 uses
  %sext = shl i64 %i.hr, 32
  %i.bnr = ashr exact i64 %sext, 32               ; 2 uses
  invoke fastcc void @_ZL15print_convergedP8_IO_FILEPKcflblPK8em_stated(ptr noundef %i.bnm, ptr noundef nonnull @.str.102, float noundef %i.bnp, i64 noundef %i.bmp, i1 noundef zeroext %i.bnq, i64 noundef %i.bnr, ptr noundef nonnull %1, double noundef %i.bnl)
          to label %bb.gp unwind label %bb.gs

bb.gp:                                            ; preds = %bb.go
  %i.bns = load ptr, ptr %i.i, align 8, !tbaa !193
  %i.bnt = load ptr, ptr %i.bj, align 8, !tbaa !80
  %i.bnu = getelementptr inbounds nuw i8, ptr %i.bnt, i64 504
  %i.bnv = load float, ptr %i.bnu, align 8, !tbaa !237
  invoke fastcc void @_ZL15print_convergedP8_IO_FILEPKcflblPK8em_stated(ptr noundef %i.bns, ptr noundef nonnull @.str.102, float noundef %i.bnv, i64 noundef %i.bmp, i1 noundef zeroext %i.bnq, i64 noundef %i.bnr, ptr noundef nonnull %1, double noundef %i.bnl)
          to label %bb.gq unwind label %bb.gs

bb.gq:                                            ; preds = %bb.gp
  %i.bnw = load ptr, ptr %i.i, align 8, !tbaa !193
  %i.bnx = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.bnw, ptr noundef nonnull @.str.19, i32 noundef %.5479) #23 ; 0 uses
  br label %bb.gt
...
bb.gt:                                            ; preds = %bb.gq, %bb.gn
  %i.boa = load ptr, ptr %i.j, align 8, !tbaa !63
  %i.bob = load ptr, ptr %i.gt, align 8, !tbaa !210
  %i.boc = load ptr, ptr %i.fp, align 8, !tbaa !208
  %i.bod = getelementptr i8, ptr %i.boa, i64 16
  %.val612 = load ptr, ptr %i.bod, align 8, !tbaa !391
  invoke fastcc void @_ZL9finish_emPK9t_commrecP10gmx_mdoutfP23gmx_walltime_accountingP13gmx_wallcycle(ptr %.val612, ptr noundef %i.ft, ptr noundef %i.bob, ptr noundef %i.boc)
          to label %bb.gu unwind label %bb.gr

bb.gu:                                            ; preds = %bb.gt
  %i.boe = load ptr, ptr %i.gt, align 8, !tbaa !210
  invoke void @_Z35walltime_accounting_set_nsteps_doneP23gmx_walltime_accountingl(ptr noundef %i.boe, i64 noundef %i.bmp)
...
bb.gv:                                            ; preds = %bb.gu
  ...
  %.val615 = load ptr, ptr %i.mq, align 8, !tbaa !496 ; 3 uses
  %.not.i.i.i.i727 = icmp eq ptr %.val615, null
  br i1 %.not.i.i.i.i727, label %_ZN12_GLOBAL__N_115EnergyEvaluatorD2Ev.exit, label %bb.gw

bb.gw:                                            ; preds = %bb.gv
  %i.bof = getelementptr inbounds nuw i8, ptr %14, i64 192
  %.val616 = load ptr, ptr %i.bof, align 8
  %i.bog = ptrtoint ptr %.val616 to i64
  %i.boh = ptrtoint ptr %.val615 to i64
  %i.boi = sub i64 %i.bog, %i.boh
  call void @_ZdlPvm(ptr noundef nonnull %.val615, i64 noundef %i.boi) #32
...
bb.gx:                                            ; preds = %_ZN12_GLOBAL__N_115EnergyEvaluatorD2Ev.exit
  %i.boj = ptrtoint ptr %.sroa.17793.0 to i64
  %i.bok = ptrtoint ptr %.sroa.0785.0 to i64
  %i.bol = sub i64 %i.boj, %i.bok                 ; 2 uses
  %i.bom = ashr exact i64 %i.bol, 3
  %i.bon = sub nsw i64 0, %i.bom
  %i.boo = getelementptr inbounds [8 x i8], ptr %.sroa.17793.0, i64 %i.bon
  call void @_ZdlPvm(ptr noundef %i.boo, i64 noundef %i.bol) #32
  br label %_ZNSt13_Bvector_baseISaIbEED2Ev.exit

_ZNSt13_Bvector_baseISaIbEED2Ev.exit:             ; preds = %_ZN12_GLOBAL__N_115EnergyEvaluatorD2Ev.exit, %bb.gx
  call void @_ZN3gmx12ForceBuffersD1Ev(ptr noundef nonnull align 8 dead_on_return(137) dereferenceable(137) %i.gi) #23
  call void @_ZN7t_stateD2Ev(ptr noundef nonnull align 8 dead_on_return(840) dereferenceable(1000) %13) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %13) #23
  call void @_ZN3gmx12ForceBuffersD1Ev(ptr noundef nonnull align 8 dead_on_return(137) dereferenceable(137) %i.gg) #23
  call void @_ZN7t_stateD2Ev(ptr noundef nonnull align 8 dead_on_return(840) dereferenceable(1000) %12) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %12) #23
  call void @_ZN3gmx12ForceBuffersD1Ev(ptr noundef nonnull align 8 dead_on_return(137) dereferenceable(137) %i.gd) #23
  call void @_ZN7t_stateD2Ev(ptr noundef nonnull align 8 dead_on_return(840) dereferenceable(1000) %11) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %11) #23
  call void @_ZN3gmx12ForceBuffersD1Ev(ptr noundef nonnull align 8 dead_on_return(137) dereferenceable(137) %i.gb) #23
  ...
  %i.bop = load ptr, ptr %7, align 8, !tbaa !659  ; 5 uses
  %i.boq = load ptr, ptr %i.dk, align 8, !tbaa !661 ; 2 uses
  %.not4.i.i.i = icmp eq ptr %i.bop, %i.boq
...
.lr.ph.i.i.i:                                     ; preds = %_ZNSt13_Bvector_baseISaIbEED2Ev.exit, %_ZSt8_DestroyISt6vectorIfSaIfEEEvPT_.exit.i.i.i
  %.05.i.i.i = phi ptr [ %i.box, %_ZSt8_DestroyISt6vectorIfSaIfEEEvPT_.exit.i.i.i ], [ %i.bop, %_ZNSt13_Bvector_baseISaIbEED2Ev.exit ] ; 3 uses
  %i.bor = load ptr, ptr %.05.i.i.i, align 8, !tbaa !505 ; 3 uses
  %.not.i.i.i.i.i.i.i = icmp eq ptr %i.bor, null
  br i1 %.not.i.i.i.i.i.i.i, label %_ZSt8_DestroyISt6vectorIfSaIfEEEvPT_.exit.i.i.i, label %bb.gy

bb.gy:                                            ; preds = %.lr.ph.i.i.i
  %i.bos = getelementptr inbounds nuw i8, ptr %.05.i.i.i, i64 16
  %i.bot = load ptr, ptr %i.bos, align 8, !tbaa !506
  %i.bou = ptrtoint ptr %i.bot to i64
  %i.bov = ptrtoint ptr %i.bor to i64
  %i.bow = sub i64 %i.bou, %i.bov
  call void @_ZdlPvm(ptr noundef nonnull %i.bor, i64 noundef %i.bow) #32
  br label %_ZSt8_DestroyISt6vectorIfSaIfEEEvPT_.exit.i.i.i

_ZSt8_DestroyISt6vectorIfSaIfEEEvPT_.exit.i.i.i:  ; preds = %bb.gy, %.lr.ph.i.i.i
  %i.box = getelementptr inbounds nuw i8, ptr %.05.i.i.i, i64 24 ; 2 uses
  %.not.i.i.i729 = icmp eq ptr %i.box, %i.boq
...
_ZSt8_DestroyIPSt6vectorIfSaIfEES2_EvT_S4_RSaIT0_E.exit.i: ; preds = %_ZSt8_DestroyISt6vectorIfSaIfEEEvPT_.exit.i.i.i, %_ZNSt13_Bvector_baseISaIbEED2Ev.exit
  %.not.i.i1.i = icmp eq ptr %i.bop, null
...
bb.gz:                                            ; preds = %_ZSt8_DestroyIPSt6vectorIfSaIfEES2_EvT_S4_RSaIT0_E.exit.i
  %i.boy = load ptr, ptr %i.dj, align 8, !tbaa !660
  %i.boz = ptrtoint ptr %i.boy to i64
  %i.bpa = ptrtoint ptr %i.bop to i64
  %i.bpb = sub i64 %i.boz, %i.bpa
  call void @_ZdlPvm(ptr noundef nonnull %i.bop, i64 noundef %i.bpb) #32
  br label %_ZNSt6vectorIS_IfSaIfEESaIS1_EED2Ev.exit

_ZNSt6vectorIS_IfSaIfEESaIS1_EED2Ev.exit:         ; preds = %_ZSt8_DestroyIPSt6vectorIfSaIfEES2_EvT_S4_RSaIT0_E.exit.i, %bb.gz
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #23
  %i.bpc = load ptr, ptr %6, align 8, !tbaa !659  ; 5 uses
  %i.bpd = load ptr, ptr %i.dm, align 8, !tbaa !661 ; 2 uses
  %.not4.i.i.i730 = icmp eq ptr %i.bpc, %i.bpd
...
.lr.ph.i.i.i731:                                  ; preds = %_ZNSt6vectorIS_IfSaIfEESaIS1_EED2Ev.exit, %_ZSt8_DestroyISt6vectorIfSaIfEEEvPT_.exit.i.i.i734
  %.05.i.i.i732 = phi ptr [ %i.bpk, %_ZSt8_DestroyISt6vectorIfSaIfEEEvPT_.exit.i.i.i734 ], [ %i.bpc, %_ZNSt6vectorIS_IfSaIfEESaIS1_EED2Ev.exit ] ; 3 uses
  %i.bpe = load ptr, ptr %.05.i.i.i732, align 8, !tbaa !505 ; 3 uses
  %.not.i.i.i.i.i.i.i733 = icmp eq ptr %i.bpe, null
...
bb.ha:                                            ; preds = %.lr.ph.i.i.i731
  %i.bpf = getelementptr inbounds nuw i8, ptr %.05.i.i.i732, i64 16
  %i.bpg = load ptr, ptr %i.bpf, align 8, !tbaa !506
  %i.bph = ptrtoint ptr %i.bpg to i64
  %i.bpi = ptrtoint ptr %i.bpe to i64
  %i.bpj = sub i64 %i.bph, %i.bpi
  call void @_ZdlPvm(ptr noundef nonnull %i.bpe, i64 noundef %i.bpj) #32
...
_ZSt8_DestroyISt6vectorIfSaIfEEEvPT_.exit.i.i.i734: ; preds = %bb.ha, %.lr.ph.i.i.i731
  %i.bpk = getelementptr inbounds nuw i8, ptr %.05.i.i.i732, i64 24 ; 2 uses
  %.not.i.i.i735 = icmp eq ptr %i.bpk, %i.bpd
...
_ZSt8_DestroyIPSt6vectorIfSaIfEES2_EvT_S4_RSaIT0_E.exit.i738: ; preds = %_ZSt8_DestroyISt6vectorIfSaIfEEEvPT_.exit.i.i.i734, %_ZNSt6vectorIS_IfSaIfEESaIS1_EED2Ev.exit
  %.not.i.i1.i739 = icmp eq ptr %i.bpc, null
...
bb.hb:                                            ; preds = %_ZSt8_DestroyIPSt6vectorIfSaIfEES2_EvT_S4_RSaIT0_E.exit.i738
  %i.bpl = load ptr, ptr %i.dl, align 8, !tbaa !660
  %i.bpm = ptrtoint ptr %i.bpl to i64
  %i.bpn = ptrtoint ptr %i.bpc to i64
  %i.bpo = sub i64 %i.bpm, %i.bpn
  call void @_ZdlPvm(ptr noundef nonnull %i.bpc, i64 noundef %i.bpo) #32
...
_ZNSt6vectorIS_IfSaIfEESaIS1_EED2Ev.exit740:      ; preds = %_ZSt8_DestroyIPSt6vectorIfSaIfEES2_EvT_S4_RSaIT0_E.exit.i738, %bb.hb
  ...
  %.not.i.i.i741 = icmp eq ptr %.sroa.0807.0931134114241443, null
...
bb.hc:                                            ; preds = %_ZNSt6vectorIS_IfSaIfEESaIS1_EED2Ev.exit740
  %i.bpp = ptrtoint ptr %.sroa.12.0910136014221444 to i64
  %i.bpq = ptrtoint ptr %.sroa.0807.0931134114241443 to i64
  %i.bpr = sub i64 %i.bpp, %i.bpq
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0807.0931134114241443, i64 noundef %i.bpr) #32
  br label %_ZNSt6vectorIfSaIfEED2Ev.exit

_ZNSt6vectorIfSaIfEED2Ev.exit:                    ; preds = %_ZNSt6vectorIS_IfSaIfEESaIS1_EED2Ev.exit740, %bb.hc
  %.not.i.i.i742 = icmp eq ptr %.sroa.0815.0881887139814181446, null
  br i1 %.not.i.i.i742, label %_ZNSt6vectorIfSaIfEED2Ev.exit743, label %bb.hd

bb.hd:                                            ; preds = %_ZNSt6vectorIfSaIfEED2Ev.exit
  %i.bps = ptrtoint ptr %.sroa.12821.0859889137914201445 to i64
  %i.bpt = ptrtoint ptr %.sroa.0815.0881887139814181446 to i64
  %i.bpu = sub i64 %i.bps, %i.bpt
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0815.0881887139814181446, i64 noundef %i.bpu) #32
...
bb.he:                                            ; preds = %_ZNSt6vectorIfSaIfEED2Ev.exit743
  %21 = ptrtoint ptr %.sroa.16.0 to i64
  %i.bpv = ptrtoint ptr %.sroa.0824.0 to i64
  %i.bpw = sub i64 %21, %i.bpv
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0824.0, i64 noundef %i.bpw) #32
...
bb.hf:                                            ; preds = %bb.gr, %bb.gs, %bb.fz, %bb.fx, %bb.ct, %bb.cs
  %.pn567.pn = phi { ptr, i32 } [ %i.nb, %bb.cs ], [ %i.nc, %bb.ct ], [ %i.bny, %bb.gr ], [ %i.bnz, %bb.gs ], [ %.pn551.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn, %bb.fx ], [ %i.blx, %bb.fz ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #23
  %.val613 = load ptr, ptr %i.mq, align 8, !tbaa !496 ; 3 uses
...
bb.hg:                                            ; preds = %bb.hf
  %i.bpx = getelementptr inbounds nuw i8, ptr %14, i64 192
  %.val614 = load ptr, ptr %i.bpx, align 8
  %i.bpy = ptrtoint ptr %.val614 to i64
  %i.bpz = ptrtoint ptr %.val613 to i64
  %i.bqa = sub i64 %i.bpy, %i.bpz
  call void @_ZdlPvm(ptr noundef nonnull %.val613, i64 noundef %i.bqa) #32
...
bb.hh:                                            ; preds = %_ZN12_GLOBAL__N_115EnergyEvaluatorD2Ev.exit747, %bb.cl
  %.pn570 = phi { ptr, i32 } [ %i.lp, %bb.cl ], [ %.pn567.pn, %_ZN12_GLOBAL__N_115EnergyEvaluatorD2Ev.exit747 ] ; 2 uses
  %.not.i.i748 = icmp eq ptr %.sroa.0785.0, null
  br i1 %.not.i.i748, label %.body, label %bb.hi

bb.hi:                                            ; preds = %bb.hh
  %i.bqb = ptrtoint ptr %.sroa.17793.0 to i64
  %i.bqc = ptrtoint ptr %.sroa.0785.0 to i64
  %i.bqd = sub i64 %i.bqb, %i.bqc                 ; 2 uses
  %i.bqe = ashr exact i64 %i.bqd, 3
  %i.bqf = sub nsw i64 0, %i.bqe
  %i.bqg = getelementptr inbounds [8 x i8], ptr %.sroa.17793.0, i64 %i.bqf
  call void @_ZdlPvm(ptr noundef %i.bqg, i64 noundef %i.bqd) #32
  br label %.body

.body:                                            ; preds = %_ZNSt13_Bvector_baseISaIbEED2Ev.exit.i.i, %bb.hh, %bb.hi, %bb.bw
  %.pn570.pn.pn = phi { ptr, i32 } [ %i.iv, %bb.bw ], [ %i.hz, %_ZNSt13_Bvector_baseISaIbEED2Ev.exit.i.i ], [ %.pn570, %bb.hi ], [ %.pn570, %bb.hh ]
  call void @_ZN3gmx12ForceBuffersD1Ev(ptr noundef nonnull align 8 dead_on_return(137) dereferenceable(137) %i.gi) #23
  call void @_ZN7t_stateD2Ev(ptr noundef nonnull align 8 dead_on_return(840) dereferenceable(1000) %13) #23
  br label %bb.hj

bb.hj:                                            ; preds = %.body, %bb.bv, %bb.bu
  %.pn570.pn.pn.pn = phi { ptr, i32 } [ %.pn570.pn.pn, %.body ], [ %i.iu, %bb.bv ], [ %i.it, %bb.bu ]
  call void @llvm.lifetime.end.p0(ptr nonnull %13) #23
  call void @_ZN3gmx12ForceBuffersD1Ev(ptr noundef nonnull align 8 dead_on_return(137) dereferenceable(137) %i.gg) #23
  call void @_ZN7t_stateD2Ev(ptr noundef nonnull align 8 dead_on_return(840) dereferenceable(1000) %12) #23
  br label %bb.hk
...
bb.hk:                                            ; preds = %bb.hj, %bb.bt, %bb.bs
  %.pn570.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn570.pn.pn.pn, %bb.hj ], [ %i.is, %bb.bt ], [ %i.ir, %bb.bs ]
  call void @llvm.lifetime.end.p0(ptr nonnull %12) #23
  call void @_ZN3gmx12ForceBuffersD1Ev(ptr noundef nonnull align 8 dead_on_return(137) dereferenceable(137) %i.gd) #23
  call void @_ZN7t_stateD2Ev(ptr noundef nonnull align 8 dead_on_return(840) dereferenceable(1000) %11) #23
  br label %bb.hl
...
bb.hl:                                            ; preds = %bb.hk, %bb.br, %bb.bq
  %.pn570.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn570.pn.pn.pn.pn, %bb.hk ], [ %i.iq, %bb.br ], [ %i.ip, %bb.bq ]
  call void @llvm.lifetime.end.p0(ptr nonnull %11) #23
  call void @_ZN3gmx12ForceBuffersD1Ev(ptr noundef nonnull align 8 dead_on_return(137) dereferenceable(137) %i.gb) #23
  call void @_ZN7t_stateD2Ev(ptr noundef nonnull align 8 dead_on_return(840) dereferenceable(1000) %10) #23
  br label %bb.hm
...
bb.hm:                                            ; preds = %bb.hl, %bb.bp, %bb.bo
  %.pn570.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn570.pn.pn.pn.pn.pn, %bb.hl ], [ %i.io, %bb.bp ], [ %i.in, %bb.bo ]
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #23
  call void @_ZN3gmx12EnergyOutputD1Ev(ptr noundef nonnull align 8 dead_on_return(392) dereferenceable(392) %9) #23
  br label %bb.hn

bb.hn:                                            ; preds = %bb.hm, %bb.bn
  %.pn570.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn570.pn.pn.pn.pn.pn.pn, %bb.hm ], [ %i.im, %bb.bn ]
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #23
  br label %bb.ho

bb.ho:                                            ; preds = %bb.bm, %bb.hn, %bb.bl
  %.pn570.pn.pn.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %i.ik, %bb.bl ], [ %.pn570.pn.pn.pn.pn.pn.pn.pn, %bb.hn ], [ %i.il, %bb.bm ]
  call void @_ZN3gmx18ObservablesReducerD1Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %8) #23
  br label %bb.hp

bb.hp:                                            ; preds = %bb.ho, %bb.bk
  %.pn570.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn570.pn.pn.pn.pn.pn.pn.pn.pn.pn, %bb.ho ], [ %i.ij, %bb.bk ]
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #23
  br label %bb.hq

bb.hq:                                            ; preds = %bb.ap, %bb.hp
  %.sroa.0815.08818871401 = phi ptr [ %i.bw, %bb.ap ], [ %.sroa.0815.0881887139814181446, %bb.hp ] ; 2 uses
  %.sroa.12821.08598891382 = phi ptr [ %i.bx, %bb.ap ], [ %.sroa.12821.0859889137914201445, %bb.hp ] ; 2 uses
  %.sroa.12.09101363 = phi ptr [ %i.cc, %bb.ap ], [ %.sroa.12.0910136014221444, %bb.hp ]
  %.sroa.0807.09311344 = phi ptr [ %i.cb, %bb.ap ], [ %.sroa.0807.0931134114241443, %bb.hp ] ; 2 uses
  %.pn582 = phi { ptr, i32 } [ %i.ec, %bb.ap ], [ %.pn570.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn, %bb.hp ] ; 2 uses
  call void @_ZNSt6vectorIS_IfSaIfEESaIS1_EED2Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %7) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #23
  call void @_ZNSt6vectorIS_IfSaIfEESaIS1_EED2Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %6) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #23
  %.not.i.i.i750 = icmp eq ptr %.sroa.0807.09311344, null
  br i1 %.not.i.i.i750, label %_ZNSt6vectorIfSaIfEED2Ev.exit751, label %bb.hr

.sink.split:                                      ; preds = %.thread952, %.thread1460, %.thread1467
  %.pn585.pn965.ph = phi { ptr, i32 } [ %i.dp, %.thread1467 ], [ %i.df, %.thread1460 ], [ %i.cs, %.thread952 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #23
  br label %bb.hr

bb.hr:                                            ; preds = %.sink.split, %bb.hq
  %.pn585.pn965 = phi { ptr, i32 } [ %.pn582, %bb.hq ], [ %.pn585.pn965.ph, %.sink.split ]
  %.sroa.12821.0840963 = phi ptr [ %.sroa.12821.08598891382, %bb.hq ], [ %i.bx, %.sink.split ]
  %.sroa.0815.0862961 = phi ptr [ %.sroa.0815.08818871401, %bb.hq ], [ %i.bw, %.sink.split ]
  %.sroa.12.0891960 = phi ptr [ %.sroa.12.09101363, %bb.hq ], [ %i.cc, %.sink.split ]
  %.sroa.0807.0912959 = phi ptr [ %.sroa.0807.09311344, %bb.hq ], [ %i.cb, %.sink.split ] ; 2 uses
  %i.bqh = ptrtoint ptr %.sroa.12.0891960 to i64
  %i.bqi = ptrtoint ptr %.sroa.0807.0912959 to i64
  %i.bqj = sub i64 %i.bqh, %i.bqi
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0807.0912959, i64 noundef %i.bqj) #32
  br label %_ZNSt6vectorIfSaIfEED2Ev.exit751

_ZNSt6vectorIfSaIfEED2Ev.exit751:                 ; preds = %bb.hr, %bb.hq
  %.sroa.0815.0861 = phi ptr [ %.sroa.0815.0862961, %bb.hr ], [ %.sroa.0815.08818871401, %bb.hq ] ; 2 uses
  %.sroa.12821.0839 = phi ptr [ %.sroa.12821.0840963, %bb.hr ], [ %.sroa.12821.08598891382, %bb.hq ]
...
bb.hs:                                            ; preds = %_ZNSt6vectorIfSaIfEED2Ev.exit751.thread, %_ZNSt6vectorIfSaIfEED2Ev.exit751
  %.pn585.pn.pn973 = phi { ptr, i32 } [ %i.cr, %_ZNSt6vectorIfSaIfEED2Ev.exit751.thread ], [ %.pn585.pn.pn, %_ZNSt6vectorIfSaIfEED2Ev.exit751 ]
  %.sroa.12821.0839972 = phi ptr [ %i.bx, %_ZNSt6vectorIfSaIfEED2Ev.exit751.thread ], [ %.sroa.12821.0839, %_ZNSt6vectorIfSaIfEED2Ev.exit751 ]
  %.sroa.0815.0861971 = phi ptr [ %i.bw, %_ZNSt6vectorIfSaIfEED2Ev.exit751.thread ], [ %.sroa.0815.0861, %_ZNSt6vectorIfSaIfEED2Ev.exit751 ] ; 2 uses
  %i.bqk = ptrtoint ptr %.sroa.12821.0839972 to i64
  %i.bql = ptrtoint ptr %.sroa.0815.0861971 to i64
  %i.bqm = sub i64 %i.bqk, %i.bql
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0815.0861971, i64 noundef %i.bqm) #32
  br label %_ZNSt6vectorIfSaIfEED2Ev.exit753

_ZNSt6vectorIfSaIfEED2Ev.exit753:                 ; preds = %bb.hs, %_ZNSt6vectorIfSaIfEED2Ev.exit751, %bb.ah
  %.pn585.pn.pn.pn = phi { ptr, i32 } [ %i.cq, %bb.ah ], [ %.pn585.pn.pn, %_ZNSt6vectorIfSaIfEED2Ev.exit751 ], [ %.pn585.pn.pn973, %bb.hs ] ; 2 uses
...
bb.ht:                                            ; preds = %_ZNSt6vectorIfSaIfEED2Ev.exit753
  %22 = ptrtoint ptr %.sroa.16.0 to i64
  %i.bqn = ptrtoint ptr %.sroa.0824.0 to i64
  %i.bqo = sub i64 %22, %i.bqn
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0824.0, i64 noundef %i.bqo) #32
  br label %_ZNSt6vectorIfSaIfEED2Ev.exit755
...
_ZNSt6vectorIfSaIfEED2Ev.exit755:                 ; preds = %bb.ag, %_ZNSt6vectorIfSaIfEED2Ev.exit753, %bb.ht, %_ZN3gmx14LogEntryWriterD2Ev.exit621, %bb.y, %bb.r, %bb.k
  %.pn595.pn = phi { ptr, i32 } [ %.pn595, %bb.k ], [ %.pn593, %bb.r ], [ %.pn591, %bb.y ], [ %.pn585.pn.pn.pn, %bb.ht ], [ %i.am, %_ZN3gmx14LogEntryWriterD2Ev.exit621 ], [ %i.cp, %bb.ag ], [ %.pn585.pn.pn.pn, %_ZNSt6vectorIfSaIfEED2Ev.exit753 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #23
  call void @_ZN3gmx12ForceBuffersD1Ev(ptr noundef nonnull align 8 dead_on_return(137) dereferenceable(137) %i.q) #23
  call void @_ZN7t_stateD2Ev(ptr noundef nonnull align 8 dead_on_return(840) dereferenceable(1000) %1) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #23
