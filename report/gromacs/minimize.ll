...
bb.gt:                                            ; preds = %bb.gq, %bb.gn
  ...
  %i.boa = load ptr, ptr %i.gt, align 8, !tbaa !210
  %i.bob = load ptr, ptr %i.fp, align 8, !tbaa !208
  %i.boc = getelementptr i8, ptr %i.bnz, i64 16
  %.val612 = load ptr, ptr %i.boc, align 8, !tbaa !391
  invoke fastcc void @_ZL9finish_emPK9t_commrecP10gmx_mdoutfP23gmx_walltime_accountingP13gmx_wallcycle(ptr %.val612, ptr noundef %i.ft, ptr noundef %i.boa, ptr noundef %i.bob)
          to label %bb.gu unwind label %bb.gr

bb.gu:                                            ; preds = %bb.gt
  %i.bod = load ptr, ptr %i.gt, align 8, !tbaa !210
...
_ZNSt13_Bvector_baseISaIbEED2Ev.exit:             ; preds = %_ZN12_GLOBAL__N_115EnergyEvaluatorD2Ev.exit, %bb.gx
  ...
  %i.bop = load ptr, ptr %i.dk, align 8, !tbaa !661 ; 2 uses
...
bb.gz:                                            ; preds = %_ZSt8_DestroyIPSt6vectorIfSaIfEES2_EvT_S4_RSaIT0_E.exit.i
  %i.box = load ptr, ptr %i.dj, align 8, !tbaa !660
...
_ZNSt6vectorIS_IfSaIfEESaIS1_EED2Ev.exit:         ; preds = %_ZSt8_DestroyIPSt6vectorIfSaIfEES2_EvT_S4_RSaIT0_E.exit.i, %bb.gz
  ...
  %i.bpc = load ptr, ptr %i.dm, align 8, !tbaa !661 ; 2 uses
...
bb.hb:                                            ; preds = %_ZSt8_DestroyIPSt6vectorIfSaIfEES2_EvT_S4_RSaIT0_E.exit.i738
  %i.bpk = load ptr, ptr %i.dl, align 8, !tbaa !660
...
bb.hc:                                            ; preds = %_ZNSt6vectorIS_IfSaIfEESaIS1_EED2Ev.exit740
  %i.bpo = ptrtoint ptr %.sroa.12.0910136014221444 to i64
  %i.bpp = ptrtoint ptr %.sroa.0807.0931134114241443 to i64
  %i.bpq = sub i64 %i.bpo, %i.bpp
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0807.0931134114241443, i64 noundef %i.bpq) #32
...
bb.hd:                                            ; preds = %_ZNSt6vectorIfSaIfEED2Ev.exit
  %i.bpr = ptrtoint ptr %.sroa.12821.0859889137914201445 to i64
  %i.bps = ptrtoint ptr %.sroa.0815.0881887139814181446 to i64
  %i.bpt = sub i64 %i.bpr, %i.bps
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0815.0881887139814181446, i64 noundef %i.bpt) #32
...
bb.hf:                                            ; preds = %bb.gr, %bb.gs, %bb.fz, %bb.fx, %bb.ct, %bb.cs
  %.pn567.pn = phi { ptr, i32 } [ %i.nb, %bb.cs ], [ %i.nc, %bb.ct ], [ %i.bnx, %bb.gr ], [ %i.bny, %bb.gs ], [ %.pn551.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn, %bb.fx ], [ %i.blx, %bb.fz ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #23
