...
bb.w:                                             ; preds = %bb.v, %bb.u
  ...
  %sqrt.i202.us.us.us.i.i = tail call float @llvm.sqrt.f32(float %i.ahx) ; 5 uses
  %sqrt95.i200.us.us.us.i.i = tail call float @llvm.sqrt.f32(float %i.ahy) ; 2 uses
  %2 = insertelement <2 x float> poison, float %sqrt95.i200.us.us.us.i.i, i64 0
  %i.ahz = shufflevector <2 x float> %2, <2 x float> poison, <2 x i32> zeroinitializer
  %i.aia = fdiv <2 x float> %i.ahf, %i.ahz
  %i.aib = fdiv float %i.ahg, %sqrt95.i200.us.us.us.i.i
  ...
  %i.aik = fdiv float %sqrt.i202.us.us.us.i.i, %i.aij ; 2 uses
...
bb.y:                                             ; preds = %bb.x, %bb.w
  ...
  %i.aiw = fdiv float %i.aiv, %sqrt.i202.us.us.us.i.i ; 2 uses
  %i.aix = fpext float %i.ais to double
  %i.aiy = fsub double 1.000000e+00, %i.aix       ; 2 uses
  %i.aiz = fpext float %sqrt.i202.us.us.us.i.i to double ; 2 uses
  ...
  %i.ajn = fdiv float %i.ajm, %sqrt.i202.us.us.us.i.i
  ...
  %3 = insertelement <2 x float> poison, float %sqrt.i202.us.us.us.i.i, i64 0
  %4 = shufflevector <2 x float> %3, <2 x float> poison, <2 x i32> zeroinitializer
  %i.akt = fdiv <2 x float> %i.aks, %4
  ...
  %sqrt.i206.us.us.us.i.i = tail call float @llvm.sqrt.f32(float %i.aln) ; 5 uses
  %sqrt95.i204.us.us.us.i.i = tail call float @llvm.sqrt.f32(float %i.alo) ; 2 uses
  %5 = insertelement <2 x float> poison, float %sqrt95.i204.us.us.us.i.i, i64 0
  %i.alp = shufflevector <2 x float> %5, <2 x float> poison, <2 x i32> zeroinitializer
  %i.alq = fdiv <2 x float> %i.akw, %i.alp
  %i.alr = fdiv float %i.akx, %sqrt95.i204.us.us.us.i.i
  ...
  %i.amc = fdiv float %sqrt.i206.us.us.us.i.i, %i.amb ; 2 uses
...
bb.aa:                                            ; preds = %bb.z, %bb.y
  ...
  %i.amo = fdiv float %i.amn, %sqrt.i206.us.us.us.i.i ; 2 uses
  %i.amp = fpext float %i.amk to double
  %i.amq = fsub double 1.000000e+00, %i.amp       ; 2 uses
  %i.amr = fpext float %sqrt.i206.us.us.us.i.i to double ; 2 uses
  ...
  %i.anf = fdiv float %i.ane, %sqrt.i206.us.us.us.i.i
  ...
  %6 = insertelement <2 x float> poison, float %sqrt.i206.us.us.us.i.i, i64 0
  %7 = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> zeroinitializer
  %i.aok = fdiv <2 x float> %i.aoj, %7
...
bb.az:                                            ; preds = %bb.ay, %bb.ax
  ...
  %sqrt.i304.us.us.us.i.i = tail call float @llvm.sqrt.f32(float %i.cah) ; 5 uses
  %sqrt95.i302.us.us.us.i.i = tail call float @llvm.sqrt.f32(float %i.cai) ; 2 uses
  %8 = insertelement <2 x float> poison, float %sqrt95.i302.us.us.us.i.i, i64 0
  %i.caj = shufflevector <2 x float> %8, <2 x float> poison, <2 x i32> zeroinitializer
  %i.cak = fdiv <2 x float> %i.bzp, %i.caj
  %i.cal = fdiv float %i.bzq, %sqrt95.i302.us.us.us.i.i
  ...
  %i.cau = fdiv float %sqrt.i304.us.us.us.i.i, %i.cat ; 2 uses
...
bb.bb:                                            ; preds = %bb.ba, %bb.az
  ...
  %i.cbg = fdiv float %i.cbf, %sqrt.i304.us.us.us.i.i ; 2 uses
  %i.cbh = fpext float %i.cbc to double
  %i.cbi = fsub double 1.000000e+00, %i.cbh       ; 2 uses
  %i.cbj = fpext float %sqrt.i304.us.us.us.i.i to double ; 2 uses
  ...
  %i.cbx = fdiv float %i.cbw, %sqrt.i304.us.us.us.i.i
  ...
  %9 = insertelement <2 x float> poison, float %sqrt.i304.us.us.us.i.i, i64 0
  %10 = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> zeroinitializer
  %i.cdd = fdiv <2 x float> %i.cdc, %10
  ...
  %sqrt.i308.us.us.us.i.i = tail call float @llvm.sqrt.f32(float %i.cdx) ; 5 uses
  %sqrt95.i306.us.us.us.i.i = tail call float @llvm.sqrt.f32(float %i.cdy) ; 2 uses
  %11 = insertelement <2 x float> poison, float %sqrt95.i306.us.us.us.i.i, i64 0
  %i.cdz = shufflevector <2 x float> %11, <2 x float> poison, <2 x i32> zeroinitializer
  %i.cea = fdiv <2 x float> %i.cdg, %i.cdz
  %i.ceb = fdiv float %i.cdh, %sqrt95.i306.us.us.us.i.i
  ...
  %i.cem = fdiv float %sqrt.i308.us.us.us.i.i, %i.cel ; 2 uses
...
bb.bd:                                            ; preds = %bb.bc, %bb.bb
  ...
  %i.cey = fdiv float %i.cex, %sqrt.i308.us.us.us.i.i ; 2 uses
  %i.cez = fpext float %i.ceu to double
  %i.cfa = fsub double 1.000000e+00, %i.cez       ; 2 uses
  %i.cfb = fpext float %sqrt.i308.us.us.us.i.i to double ; 2 uses
  ...
  %i.cfp = fdiv float %i.cfo, %sqrt.i308.us.us.us.i.i
  ...
  %12 = insertelement <2 x float> poison, float %sqrt.i308.us.us.us.i.i, i64 0
  %13 = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> zeroinitializer
  %i.cgu = fdiv <2 x float> %i.cgt, %13
