...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x float>, ptr %gep, align 4, !tbaa !40, !alias.scope !43 ; 3 uses
  ...
  %i.cx = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %broadcast.splat249, <8 x float> %wide.load, <8 x float> %strided.vec253) ; 2 uses
...
vector.body305:                                   ; preds = %vector.body305, %vector.ph282
  ...
  %i.gu = getelementptr inbounds [4 x i8], ptr %i.fn, i64 %i.gt ; 2 uses
  %i.gv = getelementptr inbounds [4 x i8], ptr %i.fp, i64 %i.gt
  ...
  %wide.load309 = load <8 x float>, ptr %i.gu, align 4, !tbaa !40, !alias.scope !50 ; 3 uses
  %wide.load310 = load <8 x float>, ptr %i.gv, align 4, !tbaa !40, !alias.scope !51 ; 3 uses
  ...
  %i.ha = fmul <8 x float> %broadcast.splat297.a, %wide.load310
  %i.hb = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %broadcast.splat295.a, <8 x float> %wide.load309, <8 x float> %i.ha)
  %i.hc = fsub <8 x float> %strided.vec313, %i.hb
  %i.hd = fmul <8 x float> %broadcast.splat301.a, %wide.load310
  %i.he = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %broadcast.splat299.a, <8 x float> %wide.load309, <8 x float> %i.hd)
