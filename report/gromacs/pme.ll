...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader
  ...
  %i.bf = trunc nuw nsw i64 %indvars.iv.next195.prol to i32
  %i.bg = trunc nuw nsw i64 %indvars.iv194.ph to i32
  %i.bh = mul i32 %5, %i.bf
  %i.bi = add i32 %i.ap, %i.bh
  %i.bj = mul i32 %5, %i.bg
...
scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader.new
  ...
  %i.ca = trunc i64 %indvars.iv.next195 to i32
  %i.cb = trunc i64 %indvars.iv194 to i32
  %i.cc = mul i32 %5, %i.ca
  %i.cd = add i32 %i.ap, %i.cc
  %i.ce = mul i32 %5, %i.cb
  %i.cf = insertelement <2 x i32> poison, i32 %i.ce, i64 0
  %i.cg = insertelement <2 x i32> %i.cf, i32 %i.cd, i64 1
  ...
  %i.cn = trunc i64 %indvars.iv.next195.1 to i32
  %i.co = trunc i64 %indvars.iv.next195 to i32
  %i.cp = mul i32 %5, %i.cn
  %i.cq = add i32 %i.ap, %i.cp
  %i.cr = mul i32 %5, %i.co
  %i.cs = insertelement <2 x i32> poison, i32 %i.cr, i64 0
  %i.ct = insertelement <2 x i32> %i.cs, i32 %i.cq, i64 1
...
.lr.ph.split:                                     ; preds = %.lr.ph.split.preheader, %bb.j
  ...
  %i.dn = trunc i64 %indvars.iv.next to i32
  %i.do = trunc i64 %indvars.iv to i32
  %i.dp = mul i32 %5, %i.dn
  %i.dq = add i32 %i.aj, %i.dp
  %i.dr = mul i32 %5, %i.do
  %i.ds = insertelement <2 x i32> poison, i32 %i.dr, i64 0
  %i.dt = insertelement <2 x i32> %i.ds, i32 %i.dq, i64 1
