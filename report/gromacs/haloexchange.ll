...
.preheader49:                                     ; preds = %bb.a
  ...
  %8 = load i32, ptr %i.d, align 4, !tbaa !98
  %9 = load i32, ptr %6, align 8, !tbaa !98
  %10 = load i32, ptr %7, align 4, !tbaa !98
  %11 = sitofp i32 %8 to float                    ; 2 uses
  %12 = sitofp i32 %9 to float                    ; 2 uses
  %13 = sitofp i32 %10 to float                   ; 2 uses
  %14 = insertelement <2 x float> poison, float %11, i64 0
  %15 = shufflevector <2 x float> %14, <2 x float> poison, <2 x i32> zeroinitializer
  %16 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %15, <2 x float> %i.k, <2 x float> zeroinitializer)
  %i.l = tail call float @llvm.fmuladd.f32(float %11, float %i.f, float 0.000000e+00)
  %i.m = load <2 x float>, ptr %i.g, align 4, !tbaa !50
  %17 = insertelement <2 x float> poison, float %12, i64 0
  %18 = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> zeroinitializer
  %19 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %18, <2 x float> %i.m, <2 x float> %16)
  %i.n = tail call float @llvm.fmuladd.f32(float %12, float %i.i, float %i.l)
  %i.o = load <2 x float>, ptr %i.j, align 4, !tbaa !50
  %20 = insertelement <2 x float> poison, float %13, i64 0
  %21 = shufflevector <2 x float> %20, <2 x float> poison, <2 x i32> zeroinitializer
  %i.p = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %21, <2 x float> %i.o, <2 x float> %19)
  %i.q = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.r = load float, ptr %i.q, align 4, !tbaa !50
  %i.s = tail call float @llvm.fmuladd.f32(float %13, float %i.r, float %i.n)
  br label %.loopexit
