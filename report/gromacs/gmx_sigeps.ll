...
bb.i:                                             ; preds = %bb.h, %bb.d, %bb.f
  ...
  %i.x = load i32, ptr @_ZZ10gmx_sigepsiPPcE4npow, align 4, !tbaa !9 ; 2 uses
  %i.y = sitofp i32 %i.x to float
  %i.z = fdiv float %i.y, %i.w
  %8 = insertelement <2 x i32> poison, i32 %i.x, i64 0
  %9 = shufflevector <2 x i32> %8, <2 x i32> poison, <2 x i32> zeroinitializer
  %10 = add nsw <2 x i32> %9, <i32 0, i32 -6>
  %11 = fpext float %i.z to double
  %12 = sitofp <2 x i32> %10 to <2 x double>      ; 3 uses
  %13 = extractelement <2 x double> %12, i64 1
  %14 = call noundef double @pow(double noundef %11, double noundef %13) #12
  %i.aa = fdiv <2 x double> <double 6.000000e+00, double 1.000000e+00>, %12 ; 2 uses
  %i.ab = extractelement <2 x double> %i.aa, i64 0
  %i.ac = fmul double %i.ab, %14
  ...
  %i.ao = call noundef double @pow(double noundef %i.an, double noundef %15) #12
...
bb.n:                                             ; preds = %bb.k, %bb.m
  ...
  %i.bb = load i32, ptr @_ZZ10gmx_sigepsiPPcE4npow, align 4, !tbaa !9 ; 2 uses
...
bb.u:                                             ; preds = %bb.p, %bb.r, %bb.t
  ...
  %i.bn = load i32, ptr @_ZZ10gmx_sigepsiPPcE4npow, align 4, !tbaa !9 ; 2 uses
...
bb.v:                                             ; preds = %bb.t
  ...
  %.pre98 = load i32, ptr @_ZZ10gmx_sigepsiPPcE4npow, align 4, !tbaa !9
...
bb.w:                                             ; preds = %bb.n, %bb.v, %bb.u
  ...
  %16 = phi i32 [ %i.bb, %bb.n ], [ %.pre98, %bb.v ], [ %i.bn, %bb.u ]
  %i.cc = phi float [ %i.az, %bb.n ], [ %.pre, %bb.v ], [ %i.bl, %bb.u ]
  %i.cd = fpext float %i.cc to double
  %i.ce = fpext float %i.cb to double
  %i.cf = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.30, double noundef %i.cd, i32 noundef %16, double noundef %i.ce) ; 0 uses
  ...
  %i.cl = load i32, ptr @_ZZ10gmx_sigepsiPPcE4npow, align 4, !tbaa !9 ; 3 uses
  ...
  %i.dt = sitofp i32 %i.ds to float               ; 3 uses
  ...
  %i.ec = call noundef float @expf(float noundef %i.dt) #12
...
.peel.next:                                       ; preds = %bb.ac, %bb.ab
  ...
  %i.gj = load i32, ptr @_ZZ10gmx_sigepsiPPcE4npow, align 4, !tbaa !9 ; 3 uses
  ...
  %i.hb = call noundef double @pow(double noundef %i.gt, double noundef %18) #12
...
bb.ag:                                            ; preds = %.peel.next, %bb.aj
  ...
  %i.is = load i32, ptr @_ZZ10gmx_sigepsiPPcE4npow, align 4, !tbaa !9 ; 3 uses
  ...
  %i.jt = call noundef double @pow(double noundef %i.jn, double noundef %20) #12
