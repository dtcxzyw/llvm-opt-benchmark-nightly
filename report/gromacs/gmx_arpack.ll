...
.preheader.lr.ph.i.i:                             ; preds = %.preheader3.i.i
  ...
  %17 = shl nsw i64 %i.fb, 3                      ; 2 uses
  %i.aod = shl nsw i64 %i.anm, 3                  ; 2 uses
  %18 = add nsw i64 %17, %i.aod                   ; 2 uses
  %scevgep518 = getelementptr i8, ptr %14, i64 %18
  %19 = add nsw i64 %17, %i.aod
  %i.aoe = add nsw i64 %19, -8                    ; 2 uses
  %scevgep520 = getelementptr i8, ptr %14, i64 %i.aoe
  %scevgep522 = getelementptr i8, ptr %14, i64 %18
...
.preheader.lr.ph.i.i:                             ; preds = %.preheader3.i.i
  ...
  %17 = shl nsw i64 %i.fb, 2                      ; 2 uses
  %i.aov = shl nsw i64 %i.aoe, 2                  ; 2 uses
  %18 = add nsw i64 %17, %i.aov                   ; 2 uses
  %scevgep541 = getelementptr i8, ptr %14, i64 %18
  %19 = add nsw i64 %17, %i.aov
  %i.aow = add nsw i64 %19, -4                    ; 2 uses
  %scevgep543 = getelementptr i8, ptr %14, i64 %i.aow
  %scevgep545 = getelementptr i8, ptr %14, i64 %18
