...
bb.db:                                            ; preds = %bb.cx, %_ZNK3gmx21TestParticleInsertion17checkEnergyGroupsENS_8ArrayRefIKNS_27AtomInfoWithinMoleculeBlockEEEP8_IO_FILE.exit
  %.0206 = phi ptr [ null, %_ZNK3gmx21TestParticleInsertion17checkEnergyGroupsENS_8ArrayRefIKNS_27AtomInfoWithinMoleculeBlockEEEP8_IO_FILE.exit ], [ %i.yh, %bb.cx ] ; 7 uses
...
bb.dc:                                            ; preds = %.lr.ph608, %bb.eb
  %.0201606 = phi double [ 0.000000e+00, %.lr.ph608 ], [ %i.afl, %bb.eb ]
  %.0202605 = phi double [ 0.000000e+00, %.lr.ph608 ], [ %i.afo, %bb.eb ]
  %.0205603 = phi i32 [ 0, %.lr.ph608 ], [ %i.afk, %bb.eb ] ; 2 uses
