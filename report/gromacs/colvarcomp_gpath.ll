...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  %i.bg = getelementptr inbounds nuw [24 x i8], ptr %i.x, i64 %.010 ; 3 uses
  %1 = getelementptr inbounds nuw i8, ptr %i.bg, i64 8
  %2 = getelementptr inbounds nuw i8, ptr %i.bg, i64 16
  ...
  %3 = load double, ptr %1, align 8, !tbaa !169
  %4 = load double, ptr %i.bg, align 8, !tbaa !168
  %5 = load double, ptr %2, align 8, !tbaa !167   ; 2 uses
  %6 = shufflevector <2 x double> %i.bh, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %7 = insertelement <2 x double> %6, double %3, i64 1 ; 2 uses
  %8 = shufflevector <2 x double> %7, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.bs = shufflevector <2 x double> %7, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.bt = fmul <2 x double> %8, %i.bs
  %9 = insertelement <2 x double> %6, double %4, i64 0 ; 2 uses
  %i.bu = shufflevector <2 x double> %9, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bv = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %9, <2 x double> %i.bu, <2 x double> %i.bt)
  %10 = insertelement <2 x double> poison, double %5, i64 0
  %11 = insertelement <2 x double> %i.bj, double %5, i64 0
  %12 = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bw = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %11, <2 x double> %12, <2 x double> %i.bv)
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %1 = fmul double %i.ed, 2.000000e+00            ; 2 uses
  %2 = fmul double %i.dz, 2.000000e+00            ; 2 uses
