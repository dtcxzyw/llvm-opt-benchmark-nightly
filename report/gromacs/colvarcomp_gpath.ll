...
scalar.ph796:                                     ; preds = %scalar.ph796.preheader, %scalar.ph796
  ...
  %i.vh = getelementptr inbounds nuw [24 x i8], ptr %i.sy, i64 %.588483 ; 3 uses
  %9 = getelementptr inbounds nuw i8, ptr %i.vh, i64 8
  %10 = getelementptr inbounds nuw i8, ptr %i.vh, i64 16
  ...
  %11 = load double, ptr %9, align 8, !tbaa !169, !noalias !432 ; 2 uses
  %12 = load double, ptr %i.vh, align 8, !tbaa !168, !noalias !432 ; 2 uses
  %i.vm = load double, ptr %10, align 8, !tbaa !167, !noalias !432 ; 2 uses
  %13 = insertelement <2 x double> poison, double %11, i64 0
  %14 = shufflevector <2 x double> %13, <2 x double> poison, <2 x i32> zeroinitializer
  %i.vn = fmul <2 x double> %i.ve, %14
  %15 = insertelement <2 x double> poison, double %12, i64 0
  %i.vo = shufflevector <2 x double> %15, <2 x double> poison, <2 x i32> zeroinitializer
  %i.vp = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.vg, <2 x double> %i.vo, <2 x double> %i.vn)
  %16 = insertelement <2 x double> poison, double %i.vm, i64 0
  %17 = shufflevector <2 x double> %16, <2 x double> poison, <2 x i32> zeroinitializer
  %18 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.sl, <2 x double> %17, <2 x double> %i.vp)
  %i.vq = fmul double %i.su, %11
  %i.vr = call double @llvm.fmuladd.f64(double %i.ss, double %12, double %i.vq)
  %i.vs = call double @llvm.fmuladd.f64(double %i.rx, double %i.vm, double %i.vr)
  %i.vt = load <2 x double>, ptr %i.vi, align 8, !tbaa !145, !noalias !434
  %i.vu = fsub <2 x double> %18, %i.vt
...
scalar.ph758:                                     ; preds = %scalar.ph758.preheader, %scalar.ph758
  ...
  %i.alu = getelementptr inbounds nuw [24 x i8], ptr %i.ajk, i64 %.1093435 ; 3 uses
  %19 = getelementptr inbounds nuw i8, ptr %i.alu, i64 8
  %20 = getelementptr inbounds nuw i8, ptr %i.alu, i64 16
  ...
  %21 = load double, ptr %19, align 8, !tbaa !169, !noalias !443 ; 2 uses
  %22 = load double, ptr %i.alu, align 8, !tbaa !168, !noalias !443 ; 2 uses
  %i.aly = load double, ptr %20, align 8, !tbaa !167, !noalias !443 ; 2 uses
  %23 = insertelement <2 x double> poison, double %21, i64 0
  %24 = shufflevector <2 x double> %23, <2 x double> poison, <2 x i32> zeroinitializer
  %i.alz = fmul <2 x double> %i.alq, %24
  %25 = insertelement <2 x double> poison, double %22, i64 0
  %i.ama = shufflevector <2 x double> %25, <2 x double> poison, <2 x i32> zeroinitializer
  %i.amb = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.als, <2 x double> %i.ama, <2 x double> %i.alz)
  %26 = insertelement <2 x double> poison, double %i.aly, i64 0
  %27 = shufflevector <2 x double> %26, <2 x double> poison, <2 x i32> zeroinitializer
  %28 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.aix, <2 x double> %27, <2 x double> %i.amb)
  %i.amc = fmul double %i.ajg, %21
  %i.amd = call double @llvm.fmuladd.f64(double %i.aje, double %22, double %i.amc)
  %i.ame = call double @llvm.fmuladd.f64(double %i.aij, double %i.aly, double %i.amd)
  %i.amf = load <2 x double>, ptr %i.alt, align 8, !tbaa !145, !noalias !445
  %i.amg = fsub <2 x double> %i.amf, %28
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.we = getelementptr inbounds nuw [24 x i8], ptr %i.nq, i64 %.476355 ; 3 uses
  %7 = getelementptr inbounds nuw i8, ptr %i.we, i64 8
  %8 = getelementptr inbounds nuw i8, ptr %i.we, i64 16
  ...
  %9 = load double, ptr %7, align 8, !tbaa !169, !noalias !626 ; 2 uses
  %10 = load double, ptr %i.we, align 8, !tbaa !168, !noalias !626 ; 2 uses
  %i.wj = load double, ptr %8, align 8, !tbaa !167, !noalias !626 ; 2 uses
  %11 = insertelement <2 x double> poison, double %9, i64 0
  %12 = shufflevector <2 x double> %11, <2 x double> poison, <2 x i32> zeroinitializer
  %i.wk = fmul <2 x double> %i.ux, %12
  %13 = insertelement <2 x double> poison, double %10, i64 0
  %i.wl = shufflevector <2 x double> %13, <2 x double> poison, <2 x i32> zeroinitializer
  %i.wm = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.uz, <2 x double> %i.wl, <2 x double> %i.wk)
  %14 = insertelement <2 x double> poison, double %i.wj, i64 0
  %15 = shufflevector <2 x double> %14, <2 x double> poison, <2 x i32> zeroinitializer
  %16 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.me, <2 x double> %15, <2 x double> %i.wm)
  %i.wn = fmul double %i.mn, %9
  %i.wo = call double @llvm.fmuladd.f64(double %i.ml, double %10, double %i.wn)
  %i.wp = call double @llvm.fmuladd.f64(double %i.lq, double %i.wj, double %i.wo)
  %i.wq = load <2 x double>, ptr %i.wf, align 8, !tbaa !145, !noalias !628
  %i.wr = fsub <2 x double> %16, %i.wq
...
scalar.ph714:                                     ; preds = %scalar.ph714.preheader, %scalar.ph714
  ...
  %i.aji = getelementptr inbounds nuw [24 x i8], ptr %i.agy, i64 %.981390 ; 3 uses
  %17 = getelementptr inbounds nuw i8, ptr %i.aji, i64 8
  %18 = getelementptr inbounds nuw i8, ptr %i.aji, i64 16
  ...
  %19 = load double, ptr %17, align 8, !tbaa !169, !noalias !635 ; 2 uses
  %20 = load double, ptr %i.aji, align 8, !tbaa !168, !noalias !635 ; 2 uses
  %i.ajm = load double, ptr %18, align 8, !tbaa !167, !noalias !635 ; 2 uses
  %21 = insertelement <2 x double> poison, double %19, i64 0
  %22 = shufflevector <2 x double> %21, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ajn = fmul <2 x double> %i.aje, %22
  %23 = insertelement <2 x double> poison, double %20, i64 0
  %i.ajo = shufflevector <2 x double> %23, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ajp = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ajg, <2 x double> %i.ajo, <2 x double> %i.ajn)
  %24 = insertelement <2 x double> poison, double %i.ajm, i64 0
  %25 = shufflevector <2 x double> %24, <2 x double> poison, <2 x i32> zeroinitializer
  %26 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.agl, <2 x double> %25, <2 x double> %i.ajp)
  %i.ajq = fmul double %i.agu, %19
  %i.ajr = call double @llvm.fmuladd.f64(double %i.ags, double %20, double %i.ajq)
  %i.ajs = call double @llvm.fmuladd.f64(double %i.afx, double %i.ajm, double %i.ajr)
  %i.ajt = load <2 x double>, ptr %i.ajh, align 8, !tbaa !145, !noalias !637
  %i.aju = fsub <2 x double> %i.ajt, %26
