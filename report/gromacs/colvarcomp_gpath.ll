...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  %1 = shufflevector <3 x double> %i.bs, <3 x double> %i.bt, <2 x i32> <i32 1, i32 4>
  %i.bu = shufflevector <3 x double> %i.bs, <3 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.bv = fmul <2 x double> %1, %i.bu
  ...
  %2 = shufflevector <3 x double> %i.bs, <3 x double> poison, <2 x i32> <i32 2, i32 poison>
  %3 = shufflevector <2 x double> %2, <2 x double> %i.bj, <2 x i32> <i32 0, i32 3>
  %i.bz = shufflevector <3 x double> %i.bs, <3 x double> poison, <2 x i32> <i32 2, i32 2>
  %i.ca = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %3, <2 x double> %i.bz, <2 x double> %i.by)
