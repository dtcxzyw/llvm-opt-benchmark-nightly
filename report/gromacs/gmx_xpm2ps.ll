...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i385: ; preds = %bb.ke
  ...
  call void @_ZdlPvm(ptr noundef %i.ave, i64 noundef %i.avh) #28
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit387

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit387: ; preds = %bb.ke, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i385
  call void @llvm.lifetime.end.p0(ptr nonnull %40) #26
  br label %bb.kf

bb.kf:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit387, %_ZL14draw_zerolinesP8t_psdatafffN3gmx8ArrayRefI8t_matrixEEP7t_psrec.exit
  invoke void @_Z8ps_closeP8t_psdata(ptr noundef nonnull %34)
          to label %bb.kg unwind label %.loopexit.split-lp499.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp

bb.kg:                                            ; preds = %bb.kf
  %i.avi = getelementptr inbounds nuw i8, ptr %34, i64 8
  %i.avj = load ptr, ptr %i.avi, align 8, !tbaa !256 ; 3 uses
  %.not.i.i.i.i388 = icmp eq ptr %i.avj, null
  br i1 %.not.i.i.i.i388, label %_ZN8t_psdataD2Ev.exit, label %bb.kh

bb.kh:                                            ; preds = %bb.kg
  %i.avk = getelementptr inbounds nuw i8, ptr %34, i64 24
  %i.avl = load ptr, ptr %i.avk, align 8, !tbaa !257
  %i.avm = ptrtoint ptr %i.avl to i64
  %i.avn = ptrtoint ptr %i.avj to i64
  %i.avo = sub i64 %i.avm, %i.avn
  call void @_ZdlPvm(ptr noundef nonnull %i.avj, i64 noundef %i.avo) #28
  br label %_ZN8t_psdataD2Ev.exit

_ZN8t_psdataD2Ev.exit:                            ; preds = %bb.kg, %bb.kh
  call void @llvm.lifetime.end.p0(ptr nonnull %34) #26
  call void @llvm.lifetime.end.p0(ptr nonnull %33) #26
  ret void

.body301:                                         ; preds = %.loopexit.split-lp499.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.loopexit, %.loopexit.split-lp499.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.loopexit.split-lp, %.loopexit509, %.loopexit.split-lp510, %.loopexit498, %.loopexit.split-lp499.loopexit.split-lp.loopexit, %.loopexit.split-lp499.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit, %.loopexit.split-lp499.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit, %.loopexit.split-lp499.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit, %.loopexit.split-lp499.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp, %.loopexit.split-lp499.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit, %.loopexit.split-lp499.loopexit.split-lp.loopexit.split-lp.loopexit, %.loopexit.split-lp499.loopexit, %bb.ht, %bb.ic, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit328, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit336, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit365
  %.pn230.pn = phi { ptr, i32 } [ %lpad.phi, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit365 ], [ %i.aiz, %bb.ic ], [ %lpad.loopexit.split-lp541, %.loopexit.split-lp499.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp ], [ %.pn224, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit336 ], [ %.pn222, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit328 ], [ %.pn186.pn.pn.i, %bb.ht ], [ %lpad.loopexit500, %.loopexit498 ], [ %lpad.loopexit503, %.loopexit.split-lp499.loopexit ], [ %lpad.loopexit506, %.loopexit.split-lp499.loopexit.split-lp.loopexit ], [ %lpad.loopexit524, %.loopexit.split-lp499.loopexit.split-lp.loopexit.split-lp.loopexit ], [ %lpad.loopexit527, %.loopexit.split-lp499.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit ], [ %lpad.loopexit.split-lp512, %.loopexit.split-lp510 ], [ %lpad.loopexit533, %.loopexit.split-lp499.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit ], [ %lpad.loopexit536, %.loopexit.split-lp499.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit ], [ %lpad.loopexit540, %.loopexit.split-lp499.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit ], [ %lpad.loopexit511, %.loopexit509 ], [ %lpad.loopexit789, %.loopexit.split-lp499.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.loopexit ], [ %lpad.loopexit.split-lp790, %.loopexit.split-lp499.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.loopexit.split-lp ] ; 2 uses
  %i.avp = getelementptr inbounds nuw i8, ptr %34, i64 8
  %i.avq = load ptr, ptr %i.avp, align 8, !tbaa !256 ; 3 uses
  %.not.i.i.i.i389 = icmp eq ptr %i.avq, null
  br i1 %.not.i.i.i.i389, label %_ZN8t_psdataD2Ev.exit390, label %bb.ki

bb.ki:                                            ; preds = %.body301
  %i.avr = getelementptr inbounds nuw i8, ptr %34, i64 24
  %i.avs = load ptr, ptr %i.avr, align 8, !tbaa !257
  %i.avt = ptrtoint ptr %i.avs to i64
  %i.avu = ptrtoint ptr %i.avq to i64
  %i.avv = sub i64 %i.avt, %i.avu
  call void @_ZdlPvm(ptr noundef nonnull %i.avq, i64 noundef %i.avv) #28
  br label %_ZN8t_psdataD2Ev.exit390

_ZN8t_psdataD2Ev.exit390:                         ; preds = %bb.ki, %.body301, %bb.hu
  %.pn230.pn.pn = phi { ptr, i32 } [ %i.ahv, %bb.hu ], [ %.pn230.pn, %.body301 ], [ %.pn230.pn, %bb.ki ]
  call void @llvm.lifetime.end.p0(ptr nonnull %34) #26
  br label %bb.kj

bb.kj:                                            ; preds = %bb.ct, %_ZN8t_psdataD2Ev.exit390, %.body
  %.merged = phi { ptr, i32 } [ %.pn230.pn.pn, %_ZN8t_psdataD2Ev.exit390 ], [ %.pn85.pn.pn.i, %.body ], [ %i.jx, %bb.ct ]
  call void @llvm.lifetime.end.p0(ptr nonnull %33) #26
...
bb.kk:                                            ; preds = %bb.ct
  ...
  call void @__clang_call_terminate(ptr %i.avx) #33
  unreachable
}
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.preheader.us
  ...
  %i.w = tail call noundef float @powf(float noundef 1.000000e+01, float noundef %i.v) #26
  %i.x = getelementptr inbounds nuw [4 x i8], ptr @__const._ZL12tick_spacingiPffcS_S_.major_fact, i64 %indvars.iv102
  %i.y = load float, ptr %i.x, align 4, !tbaa !22
  %i.z = fmul float %i.w, %i.y                    ; 2 uses
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.us.us
  ...
  %i.ae = tail call noundef zeroext i1 @_Z8bRmod_fddddb(double noundef %i.ad, double noundef %i.u, double noundef %i.aa, i1 noundef zeroext false)
  %i.af = zext i1 %i.ae to i32
  %spec.select.us.us = add nuw nsw i32 %.04576.us.us, %i.af ; 3 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %._crit_edge.us.us, label %bb.b, !llvm.loop !258

._crit_edge.us.us:                                ; preds = %bb.b
  %i.ag = icmp sge i32 %spec.select.us.us, %i.f
  %i.ah = icmp samesign ult i32 %spec.select.us.us, 5
  %i.ai = or i1 %i.ag, %i.ah                      ; 3 uses
  %indvars.iv.next103 = add nuw nsw i64 %indvars.iv102, 1
  %i.aj = icmp samesign ult i64 %indvars.iv102, 3
...
.split89.us:                                      ; preds = %.split.us.us
  ...
  br i1 %i.ai, label %.split89.us.thread, label %.split89.us._crit_edge
...
.split89.us.thread:                               ; preds = %.preheader, %.split89.us
  ...
  %i.av = tail call float @llvm.fmuladd.f32(float %i.as, float 1.000000e+01, float %i.au) ; 2 uses
  %i.aw = load float, ptr %i.i, align 4, !tbaa !22
  %i.ax = fsub float %i.aw, %i.at                 ; 2 uses
  %i.ay = fcmp olt float %i.av, %i.ax
  %.sroa.speculated58 = select i1 %i.ay, float %i.ax, float %i.av ; 2 uses
  %i.az = load ptr, ptr @stderr, align 8, !tbaa !39
  %i.ba = zext nneg i8 %3 to i32                  ; 2 uses
  %i.bb = fpext float %.sroa.speculated58 to double
  %i.bc = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.az, ptr noundef nonnull @.str.182, i32 noundef %i.ba, double noundef %i.bb) #29 ; 0 uses
  br label %bb.c

bb.c:                                             ; preds = %.split89.us._crit_edge, %.split89.us.thread
  %.us-phi91109 = phi i64 [ %i.ar, %.split89.us._crit_edge ], [ %.us-phi91110, %.split89.us.thread ]
  %.pre-phi = phi i32 [ %.pre, %.split89.us._crit_edge ], [ %i.ba, %.split89.us.thread ]
  %.2 = phi float [ %i.z, %.split89.us._crit_edge ], [ %.sroa.speculated58, %.split89.us.thread ] ; 2 uses
  store float %.2, ptr %4, align 4, !tbaa !22
  %i.bd = getelementptr inbounds nuw [4 x i8], ptr @__const._ZL12tick_spacingiPffcS_S_.minor_fact, i64 %.us-phi91109
  %i.be = load float, ptr %i.bd, align 4, !tbaa !22
  %i.bf = fdiv float %.2, %i.be                   ; 2 uses
  store float %i.bf, ptr %5, align 4, !tbaa !22
  %i.bg = load ptr, ptr @stderr, align 8, !tbaa !39
  %i.bh = load float, ptr %4, align 4, !tbaa !22
  %i.bi = fpext float %i.bh to double
  %i.bj = fpext float %i.bf to double
  %i.bk = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.bg, ptr noundef nonnull @.str.183, i32 noundef %.pre-phi, double noundef %i.bi, double noundef %i.bj) #29 ; 0 uses
  ret void
}
