...
.preheader135.i:                                  ; preds = %bb.j, %bb.i
  ...
  %4 = fptrunc <4 x double> %i.su to <4 x float>  ; 2 uses
  %5 = shufflevector <4 x float> %4, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 0, i32 2, i32 1, i32 3, i32 2, i32 1>
  %6 = insertelement <2 x double> poison, double %i.qn, i64 0
  %7 = insertelement <2 x double> %6, double %i.ql, i64 1
  %8 = fmul <2 x double> %7, splat (double f0x3FF6A09E667F3BCD)
  %9 = fptrunc <2 x double> %8 to <2 x float>     ; 3 uses
  ...
  %i.tj = shufflevector <4 x float> %4, <4 x float> poison, <5 x i32> <i32 2, i32 0, i32 poison, i32 3, i32 poison>
  %10 = shufflevector <2 x float> %9, <2 x float> poison, <5 x i32> <i32 0, i32 poison, i32 1, i32 poison, i32 poison>
  %11 = shufflevector <5 x float> %i.tj, <5 x float> %10, <8 x i32> <i32 0, i32 1, i32 5, i32 3, i32 3, i32 5, i32 7, i32 7>
  %i.tk = fmul <8 x float> %5, %11
  ...
  %foldExtExtBinop = fmul <2 x float> %shift, %9
  ...
  %i.tr = call float @llvm.fmuladd.f32(float %i.tp, float %i.tq, float %12) ; 2 uses
