...
begin_hunk_0_@_ZN3gmx19ThreeFry2x64GeneralILj13ELj64EEclEv:bb.a
  ...
  %.sroa.49.0.copyload.i = load i64, ptr %.sroa.49.0..sroa_idx.i, align 8, !tbaa !24
  %i.f = load i64, ptr %0, align 8, !tbaa !26     ; 4 uses
  %i.g = add i64 %i.f, %.sroa.020.0.copyload.i
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.i = load i64, ptr %i.h, align 8, !tbaa !26   ; 4 uses
  %i.j = xor i64 %i.f, %i.i
  ...
  store i64 %i.bh, ptr %.sroa.4.0..sroa_idx, align 8, !tbaa !24
  br label %bb.c

bb.c:                                             ; preds = %._crit_edge, %bb.b
  %i.bj = phi i64 [ %i.bf, %bb.b ], [ %.pre, %._crit_edge ]
  %i.bk = phi i32 [ 1, %bb.b ], [ %i.d, %._crit_edge ]
  store i32 %i.bk, ptr %i.a, align 8, !tbaa !29
  ret i64 %i.bj
}
...
bb.d:                                             ; preds = %bb.c
  ...
  store ptr @__PRETTY_FUNCTION__._ZN3gmx8internal14highBitCounter9incrementImLm2ELj64EEEvPSt5arrayIT_XT0_EE, ptr %i.f, align 8, !tbaa !23
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %3, i64 16
  store ptr @.str.17, ptr %.sroa.4.0..sroa_idx, align 8, !tbaa !23
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %3, i64 24
  store i32 280, ptr %.sroa.5.0..sroa_idx, align 8, !tbaa !54
...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 4, !tbaa !37   ; 17 uses
  %i.c = add nsw i32 %i.b, -1
  %i.d = mul nsw i32 %i.c, %i.b
  %.fr194 = freeze i32 %i.d                       ; 5 uses
  %i.e = sdiv i32 %.fr194, 2                      ; 3 uses
  %i.f = sext i32 %i.e to i64                     ; 3 uses
  %i.g = tail call noundef ptr @_Z11save_callocPKcS0_imm(ptr noundef nonnull @.str.26, ptr noundef nonnull @.str.27, i32 noundef 217, i64 noundef range(i64 -2147483648, 2147483648) %i.f, i64 noundef 12) ; 27 uses
  %i.h = icmp sgt i32 %i.b, 0                     ; 3 uses
  br i1 %i.h, label %.lr.ph173, label %._crit_edge

.lr.ph173:                                        ; preds = %bb.a
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.j = zext nneg i32 %i.b to i64                ; 3 uses
  %wide.trip.count208 = zext nneg i32 %i.b to i64 ; 5 uses
  %scevgep = getelementptr i8, ptr %i.g, i64 8
  %i.k = mul nuw nsw i64 %wide.trip.count208, 12
  %i.l = shl nuw nsw i64 %wide.trip.count208, 2
  %i.m = getelementptr i8, ptr %i.g, i64 %i.k
  %i.n = getelementptr i8, ptr %i.m, i64 -12
  br label %bb.b

.loopexit168.loopexit:                            ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  %indvars.iv.next.lcssa = phi i64 [ %i.ac, %middle.block ], [ %indvars.iv.next.lcssa262.unr, %scalar.ph.prol.loopexit ], [ %indvars.iv.next.3, %scalar.ph ]
  %i.o = trunc nsw i64 %indvars.iv.next.lcssa to i32
  br label %.loopexit168

.loopexit168:                                     ; preds = %.loopexit168.loopexit, %bb.b
  %.190.lcssa = phi i32 [ %.089172, %bb.b ], [ %i.o, %.loopexit168.loopexit ] ; 2 uses
  %indvars.iv.next199 = add nuw nsw i64 %indvars.iv198, 1
  %exitcond209.not = icmp eq i64 %indvars.iv.next206, %wide.trip.count208
  br i1 %exitcond209.not, label %._crit_edge, label %bb.b, !llvm.loop !112

bb.b:                                             ; preds = %.lr.ph173, %.loopexit168
  %indvars.iv205 = phi i64 [ 0, %.lr.ph173 ], [ %indvars.iv.next206, %.loopexit168 ] ; 6 uses
  %indvars.iv198 = phi i64 [ 1, %.lr.ph173 ], [ %indvars.iv.next199, %.loopexit168 ] ; 6 uses
  %.089172 = phi i32 [ 0, %.lr.ph173 ], [ %.190.lcssa, %.loopexit168 ] ; 2 uses
  %i.p = xor i64 %indvars.iv205, -1
  %i.q = add nsw i64 %i.p, %wide.trip.count208    ; 3 uses
  %i.r = mul nsw i64 %indvars.iv205, -12
  %scevgep253 = getelementptr i8, ptr %i.n, i64 %i.r
  %i.s = shl nuw nsw i64 %indvars.iv205, 2
  %indvars.iv.next206 = add nuw nsw i64 %indvars.iv205, 1 ; 3 uses
  %i.t = icmp samesign ult i64 %indvars.iv.next206, %i.j
  br i1 %i.t, label %.lr.ph, label %.loopexit168

.lr.ph:                                           ; preds = %bb.b
  %i.u = load ptr, ptr %i.i, align 8, !tbaa !40
  %i.v = getelementptr inbounds nuw [8 x i8], ptr %i.u, i64 %indvars.iv205
  %i.w = load ptr, ptr %i.v, align 8, !tbaa !41   ; 8 uses
  %i.x = sext i32 %.089172 to i64                 ; 5 uses
  %i.y = trunc nuw nsw i64 %indvars.iv205 to i32  ; 6 uses
  %min.iters.check = icmp ult i64 %i.q, 8
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph
  %i.z = mul nsw i64 %i.x, 12                     ; 2 uses
  %scevgep252 = getelementptr i8, ptr %scevgep, i64 %i.z
  %scevgep254 = getelementptr i8, ptr %scevgep253, i64 %i.z
  %i.aa = getelementptr nuw i8, ptr %i.w, i64 %i.s
  %scevgep255 = getelementptr nuw i8, ptr %i.aa, i64 4
  %scevgep256 = getelementptr i8, ptr %i.w, i64 %i.l
  %bound0 = icmp ult ptr %scevgep252, %scevgep256
  %bound1 = icmp ult ptr %scevgep255, %scevgep254
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %scalar.ph.preheader, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.q, -8                       ; 4 uses
  %i.ab = add i64 %indvars.iv198, %n.vec
  %i.ac = add i64 %n.vec, %i.x                    ; 2 uses
  %broadcast.splatinsert = insertelement <8 x i32> poison, i32 %i.y, i64 0
  %i.ad = trunc i64 %indvars.iv198 to i32
  %broadcast.splatinsert257 = insertelement <8 x i32> poison, i32 %i.ad, i64 0
  %broadcast.splat258 = shufflevector <8 x i32> %broadcast.splatinsert257, <8 x i32> poison, <8 x i32> zeroinitializer
  %induction = add <8 x i32> %broadcast.splat258, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %invariant.gep = getelementptr [12 x i8], ptr %i.g, i64 %i.x
  %i.ae = getelementptr inbounds nuw [4 x i8], ptr %i.w, i64 %indvars.iv198
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x float>, ptr %i.ah, align 4, !tbaa !42, !alias.scope !125
  ...
  store <24 x float> %interleaved.vec, ptr %gep, align 4, !tbaa !24
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %vec.ind.next = add <8 x i32> %vec.ind, splat (i32 8)
  %i.al = icmp eq i64 %index.next, %n.vec
  br i1 %i.al, label %middle.block, label %vector.body, !llvm.loop !115

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %i.q, %n.vec
  br i1 %cmp.n, label %.loopexit168.loopexit, label %scalar.ph.preheader

scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph, %middle.block
  %indvars.iv200.ph = phi i64 [ %indvars.iv198, %vector.memcheck ], [ %indvars.iv198, %.lr.ph ], [ %i.ab, %middle.block ] ; 4 uses
  %indvars.iv.ph = phi i64 [ %i.x, %vector.memcheck ], [ %i.x, %.lr.ph ], [ %i.ac, %middle.block ] ; 2 uses
  %i.am = sub i64 %i.j, %indvars.iv200.ph
  %xtraiter = and i64 %i.am, 3                    ; 2 uses
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol

scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  %indvars.iv200.prol = phi i64 [ %indvars.iv.next201.prol, %scalar.ph.prol ], [ %indvars.iv200.ph, %scalar.ph.preheader ] ; 3 uses
  ...
  store i32 %i.y, ptr %i.an, align 4, !tbaa !126
  %i.ao = getelementptr inbounds nuw i8, ptr %i.an, i64 4
  %i.ap = trunc nuw nsw i64 %indvars.iv200.prol to i32
  store i32 %i.ap, ptr %i.ao, align 4, !tbaa !62
  %i.aq = getelementptr inbounds nuw [4 x i8], ptr %i.w, i64 %indvars.iv200.prol
  %i.ar = load float, ptr %i.aq, align 4, !tbaa !42
  %i.as = getelementptr inbounds nuw i8, ptr %i.an, i64 8
  store float %i.ar, ptr %i.as, align 4, !tbaa !63
  %indvars.iv.next201.prol = add nuw nsw i64 %indvars.iv200.prol, 1 ; 2 uses
...
scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  %indvars.iv.next.lcssa262.unr = phi i64 [ poison, %scalar.ph.preheader ], [ %indvars.iv.next.prol, %scalar.ph.prol ]
  %indvars.iv200.unr = phi i64 [ %indvars.iv200.ph, %scalar.ph.preheader ], [ %indvars.iv.next201.prol, %scalar.ph.prol ]
  %indvars.iv.unr = phi i64 [ %indvars.iv.ph, %scalar.ph.preheader ], [ %indvars.iv.next.prol, %scalar.ph.prol ]
  %i.at = sub i64 %indvars.iv200.ph, %i.j
  %i.au = icmp ugt i64 %i.at, -4
  br i1 %i.au, label %.loopexit168.loopexit, label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  %indvars.iv200 = phi i64 [ %indvars.iv.next201.3, %scalar.ph ], [ %indvars.iv200.unr, %scalar.ph.prol.loopexit ] ; 6 uses
  ...
  store i32 %i.y, ptr %i.av, align 4, !tbaa !126
  %i.aw = getelementptr inbounds nuw i8, ptr %i.av, i64 4
  %i.ax = trunc nuw nsw i64 %indvars.iv200 to i32
  store i32 %i.ax, ptr %i.aw, align 4, !tbaa !62
  %i.ay = getelementptr inbounds nuw [4 x i8], ptr %i.w, i64 %indvars.iv200
  %i.az = load float, ptr %i.ay, align 4, !tbaa !42
  %i.ba = getelementptr inbounds nuw i8, ptr %i.av, i64 8
  store float %i.az, ptr %i.ba, align 4, !tbaa !63
  ...
  store i32 %i.y, ptr %i.bc, align 4, !tbaa !126
  %i.bd = getelementptr i8, ptr %i.bb, i64 16
  %i.be = trunc nuw nsw i64 %indvars.iv.next201 to i32
  store i32 %i.be, ptr %i.bd, align 4, !tbaa !62
  %i.bf = getelementptr inbounds nuw [4 x i8], ptr %i.w, i64 %indvars.iv.next201
  %i.bg = load float, ptr %i.bf, align 4, !tbaa !42
  %i.bh = getelementptr i8, ptr %i.bb, i64 20
  store float %i.bg, ptr %i.bh, align 4, !tbaa !63
  %indvars.iv.next201.1 = add nuw nsw i64 %indvars.iv200, 2 ; 2 uses
  %i.bi = getelementptr [12 x i8], ptr %i.g, i64 %indvars.iv ; 3 uses
  %i.bj = getelementptr i8, ptr %i.bi, i64 24
  store i32 %i.y, ptr %i.bj, align 4, !tbaa !126
  %i.bk = getelementptr i8, ptr %i.bi, i64 28
  %i.bl = trunc nuw nsw i64 %indvars.iv.next201.1 to i32
  store i32 %i.bl, ptr %i.bk, align 4, !tbaa !62
  %i.bm = getelementptr inbounds nuw [4 x i8], ptr %i.w, i64 %indvars.iv.next201.1
  %i.bn = load float, ptr %i.bm, align 4, !tbaa !42
  %i.bo = getelementptr i8, ptr %i.bi, i64 32
  store float %i.bn, ptr %i.bo, align 4, !tbaa !63
  %indvars.iv.next201.2 = add nuw nsw i64 %indvars.iv200, 3 ; 2 uses
  %i.bp = getelementptr [12 x i8], ptr %i.g, i64 %indvars.iv ; 3 uses
  %i.bq = getelementptr i8, ptr %i.bp, i64 36
  store i32 %i.y, ptr %i.bq, align 4, !tbaa !126
  %i.br = getelementptr i8, ptr %i.bp, i64 40
  %i.bs = trunc nuw nsw i64 %indvars.iv.next201.2 to i32
  store i32 %i.bs, ptr %i.br, align 4, !tbaa !62
  %i.bt = getelementptr inbounds nuw [4 x i8], ptr %i.w, i64 %indvars.iv.next201.2
  %i.bu = load float, ptr %i.bt, align 4, !tbaa !42
  %i.bv = getelementptr i8, ptr %i.bp, i64 44
  store float %i.bu, ptr %i.bv, align 4, !tbaa !63
  %indvars.iv.next201.3 = add nuw nsw i64 %indvars.iv200, 4 ; 2 uses
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4 ; 2 uses
  %exitcond.not.3 = icmp eq i64 %indvars.iv.next201.3, %wide.trip.count208
  br i1 %exitcond.not.3, label %.loopexit168.loopexit, label %scalar.ph, !llvm.loop !117

._crit_edge:                                      ; preds = %.loopexit168, %bb.a
  %.089.lcssa = phi i32 [ 0, %bb.a ], [ %.190.lcssa, %.loopexit168 ]
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  %i.by = load ptr, ptr %5, align 8, !tbaa !49    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.h
  %i.cb = load i64, ptr %i.bz, align 8, !tbaa !24
  %i.cc = add i64 %i.cb, 1
...
bb.l:                                             ; preds = %bb.q, %bb.k
  ...
  %i.cl = load float, ptr %i.ck, align 4, !tbaa !63 ; 4 uses
end_hunk_0
