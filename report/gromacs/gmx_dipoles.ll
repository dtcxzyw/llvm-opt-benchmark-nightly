...
.preheader101.i:                                  ; preds = %.preheader101.i, %.lr.ph113.i
  ...
  %83 = fpext float %i.acz to double              ; 2 uses
  %84 = fpext float %i.act to double              ; 4 uses
  %85 = fpext float %i.acp to double
  %86 = fneg double %83                           ; 3 uses
  %87 = insertelement <2 x double> poison, double %86, i64 0
  %88 = fmul double %83, -0.000000e+00            ; 4 uses
  %i.adl = fmul double %84, 3.000000e+00          ; 2 uses
  %89 = fmul double %85, 5.000000e-01             ; 4 uses
  %i.adm = insertelement <2 x double> %87, double %88, i64 1
  %i.adn = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ade, <2 x double> %i.ada, <2 x double> %i.adm)
  %90 = call double @llvm.fmuladd.f64(double %i.adc, double %84, double %88)
  %91 = insertelement <2 x double> poison, double %89, i64 0
  %i.ado = shufflevector <2 x double> %91, <2 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  ...
  %92 = insertelement <2 x double> poison, double %88, i64 0 ; 2 uses
  %i.adv = insertelement <2 x double> %92, double %86, i64 1
  ...
  %i.aeb = call double @llvm.fmuladd.f64(double %i.adi, double %84, double %88)
  %i.aec = fmul double %89, %i.aeb
  ...
  %i.aeg = shufflevector <2 x double> %92, <2 x double> poison, <2 x i32> zeroinitializer
  %95 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %94, <2 x double> %i.ada, <2 x double> %i.aeg)
  %i.aeh = fmul <2 x double> %i.ado, %95
  ...
  %i.ael = call double @llvm.fmuladd.f64(double %i.adl, double %84, double %86)
  %i.aem = fmul double %89, %i.ael
