...
.preheader101.i:                                  ; preds = %.preheader101.i, %.lr.ph113.i
  ...
  %83 = shufflevector <2 x double> %i.acy, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %84 = insertelement <2 x double> %83, double %i.acx, i64 0
  %85 = fmul <2 x double> %84, <double 5.000000e-01, double 3.000000e+00> ; 4 uses
  %86 = shufflevector <2 x double> %85, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.acz = shufflevector <2 x double> %85, <2 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  %i.ada = load <2 x double>, ptr %i.acg, align 8, !tbaa !149
  %87 = extractelement <2 x double> %85, i64 1
  %88 = extractelement <2 x double> %85, i64 0    ; 3 uses
  %89 = load double, ptr %i.ack, align 8, !tbaa !149
  %90 = extractelement <2 x double> %i.acy, i64 1 ; 2 uses
  %91 = fmul double %90, 3.000000e+00             ; 2 uses
  %i.adb = extractelement <2 x double> %i.acy, i64 0
  ...
  %i.adk = fmul double %i.adg, -0.000000e+00      ; 6 uses
  %i.adl = fmul double %i.adh, 3.000000e+00       ; 3 uses
  %i.adm = insertelement <2 x double> %i.adj, double %i.adk, i64 1
  %i.adn = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %86, <2 x double> %i.acy, <2 x double> %i.adm)
  %i.ado = fmul <2 x double> %i.acz, %i.adn
  ...
  %94 = call double @llvm.fmuladd.f64(double %87, double %i.adh, double %i.adk)
  %i.adr = fmul double %88, %94
  %i.ads = fmul double %i.adr, f0x39F44F5C45C6DEE9
  %i.adt = call double @llvm.fmuladd.f64(double %i.ads, double f0x460E457412875905, double %89)
  store double %i.adt, ptr %i.ack, align 8, !tbaa !149
  %i.adu = insertelement <2 x double> poison, double %i.adk, i64 0
  %i.adv = insertelement <2 x double> %i.adu, double %i.adi, i64 1
  %i.adw = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %93, <2 x double> %i.acy, <2 x double> %i.adv)
  %i.adx = fmul <2 x double> %i.acz, %i.adw
  ...
  %95 = call double @llvm.fmuladd.f64(double %i.adl, double %90, double %i.adk)
  %96 = call double @llvm.fmuladd.f64(double %i.adl, double %i.adb, double %i.adk)
  %97 = insertelement <2 x double> poison, double %96, i64 0
  %98 = insertelement <2 x double> %97, double %95, i64 1
  %i.aeg = fmul <2 x double> %i.acz, %98
