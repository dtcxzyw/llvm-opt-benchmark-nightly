...
bb.l:                                             ; preds = %.thread119, %bb.j
  ...
  %.0499122 = phi i32 [ %i.ej, %.thread119 ], [ %i.ef, %bb.j ] ; 8 uses
...
bb.ci:                                            ; preds = %bb.ch
  ...
  %83 = uitofp nneg i32 %31 to float              ; 2 uses
  ...
  %84 = uitofp nneg i32 %.0499122 to double       ; 2 uses
  ...
  %85 = sitofp i32 %.0499122 to double
...
_ZL8calc_epsdddd.exit:                            ; preds = %bb.fd, %bb.fe
  ...
  %i.bfx = fdiv double %.1487.lcssa, %85
