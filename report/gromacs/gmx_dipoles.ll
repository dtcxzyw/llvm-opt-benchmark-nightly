...
.preheader101.i:                                  ; preds = %.preheader101.i, %.lr.ph113.i
  ...
  %83 = fpext float %i.acq to double
  ...
  %84 = insertelement <2 x double> %i.acx, double %83, i64 0
  %85 = fmul <2 x double> %84, <double 5.000000e-01, double 3.000000e+00> ; 4 uses
  %86 = shufflevector <2 x double> %85, <2 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  %i.ade = extractelement <2 x double> %85, i64 0 ; 3 uses
  %87 = shufflevector <2 x double> %85, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %88 = extractelement <2 x double> %85, i64 1
  %foldExtExtBinop = fmul <2 x float> %i.acv, %i.acv
  %89 = extractelement <2 x float> %foldExtExtBinop, i64 1
  %90 = fsub float %i.act, %i.acf                 ; 3 uses
  %91 = call float @llvm.fmuladd.f32(float %i.acw, float %i.acw, float %89)
  %92 = call noundef float @llvm.fmuladd.f32(float %90, float %90, float %91)
  %93 = fpext float %92 to double                 ; 2 uses
  %94 = fpext float %90 to double                 ; 4 uses
  %i.adf = fneg double %93                        ; 3 uses
  %95 = insertelement <2 x double> poison, double %i.adf, i64 0
  %i.adg = fmul double %93, -0.000000e+00         ; 4 uses
  %96 = fmul double %94, 3.000000e+00             ; 2 uses
  %i.adh = insertelement <2 x double> %95, double %i.adg, i64 1
  %i.adi = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.adb, <2 x double> %i.acx, <2 x double> %i.adh)
  %i.adj = call double @llvm.fmuladd.f64(double %i.acz, double %94, double %i.adg)
  %i.adk = fmul <2 x double> %86, %i.adi
  ...
  %97 = insertelement <2 x double> poison, double %i.adg, i64 0 ; 2 uses
  %i.adq = insertelement <2 x double> %97, double %i.adf, i64 1
  %i.adr = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %87, <2 x double> %i.acx, <2 x double> %i.adq)
  %i.ads = fmul <2 x double> %86, %i.adr
  ...
  %i.adw = call double @llvm.fmuladd.f64(double %88, double %94, double %i.adg)
  %i.adx = fmul double %i.ade, %i.adw
  ...
  %i.aeb = shufflevector <2 x double> %97, <2 x double> poison, <2 x i32> zeroinitializer
  %100 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %99, <2 x double> %i.acx, <2 x double> %i.aeb)
  %i.aec = fmul <2 x double> %86, %100
  ...
  %i.aeg = call double @llvm.fmuladd.f64(double %96, double %94, double %i.adf)
  %i.aeh = fmul double %i.ade, %i.aeg
