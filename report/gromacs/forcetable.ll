...
bb.q:                                             ; preds = %bb.p
  ...
  %spec.select.peel = zext i1 %or.cond119.peel to i8
  %spec.select120.peel = select i1 %or.cond119.peel, double %i.bl, double %i.bt
  br label %.peel.next

.peel.next:                                       ; preds = %.thread, %bb.q
  %.2105.peel = phi i8 [ 1, %.thread ], [ %spec.select.peel, %bb.q ]
  %.2.peel = phi double [ 0.000000e+00, %.thread ], [ %spec.select120.peel, %bb.q ] ; 2 uses
  %i.bx = fmul double %.2.peel, -5.000000e-01
...
bb.r:                                             ; preds = %.peel.next, %bb.aa
  ...
  %.095150 = phi i32 [ %i.ak, %.peel.next ], [ %.196, %bb.aa ] ; 2 uses
  %.0101149 = phi double [ %.2.peel, %.peel.next ], [ %.2, %bb.aa ] ; 3 uses
  %.0103148 = phi i8 [ %.2105.peel, %.peel.next ], [ %.2105, %bb.aa ] ; 2 uses
  %.0107147 = phi double [ %i.as, %.peel.next ], [ %.1108, %bb.aa ] ; 2 uses
...
bb.s:                                             ; preds = %bb.r
  %i.cf = trunc nuw i8 %.0103148 to i1
...
bb.u:                                             ; preds = %bb.s
  %i.ch = sub nsw i32 %i.cb, %.095150
  %i.ci = sitofp i32 %i.ch to double
  %i.cj = fneg double %i.ci
  %i.ck = fmul double %.0101149, %i.cj
  %i.cl = tail call double @llvm.fmuladd.f64(double %i.ck, double %i.c, double %.0107147)
  br label %bb.v

bb.v:                                             ; preds = %bb.s, %bb.u
  %.0109 = phi double [ %i.cl, %bb.u ], [ %i.ce, %bb.s ]
  %.1108 = phi double [ %.0107147, %bb.u ], [ %i.ce, %bb.s ]
  %.196 = phi i32 [ %.095150, %bb.u ], [ %i.cb, %bb.s ]
  %i.cm = fptrunc double %.0109 to float
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.cw = trunc nuw i8 %.0103148 to i1
...
.thread174:                                       ; preds = %bb.x
  ...
  %i.db = tail call double @llvm.fmuladd.f64(double %.0101149, double -5.000000e-01, double %i.da)
...
bb.z:                                             ; preds = %bb.y
  ...
  %spec.select = zext i1 %or.cond119 to i8
  %spec.select120 = select i1 %or.cond119, double %i.dn, double %i.dx
  br label %bb.aa

bb.aa:                                            ; preds = %bb.z, %.thread174
  %.2105 = phi i8 [ 1, %.thread174 ], [ %spec.select, %bb.z ]
  %.2 = phi double [ %.0101149, %.thread174 ], [ %spec.select120, %bb.z ] ; 2 uses
  %i.eb = fmul double %.2, -5.000000e-01
