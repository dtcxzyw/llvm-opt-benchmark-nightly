...
.noexc56:                                         ; preds = %bb.h
  ...
  %7 = load double, ptr %i.r, align 8, !tbaa !13  ; 3 uses
  ...
  %11 = fneg <2 x double> %i.u
  %12 = shufflevector <2 x double> %11, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %13 = insertelement <2 x double> %12, double %i.w, i64 1
  %14 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.u, <2 x double> <double 4.000000e+00, double 1.100000e+01>, <2 x double> %13)
  %i.x = insertelement <2 x double> poison, double %7, i64 0
  %15 = shufflevector <2 x double> %i.x, <2 x double> poison, <2 x i32> zeroinitializer
  %i.y = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %15, <2 x double> <double 6.000000e+00, double 1.140000e+02>, <2 x double> %14)
  %16 = insertelement <2 x double> poison, double %9, i64 0
  %17 = shufflevector <2 x double> %16, <2 x double> poison, <2 x i32> zeroinitializer
  %18 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %17, <2 x double> <double -2.000000e+01, double -1.040000e+02>, <2 x double> %i.y)
  %19 = insertelement <2 x double> poison, double %10, i64 0
  %i.z = shufflevector <2 x double> %19, <2 x double> poison, <2 x i32> zeroinitializer
  %i.aa = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.z, <2 x double> <double 1.100000e+01, double 3.500000e+01>, <2 x double> %18)
...
vector.ph:                                        ; preds = %.lr.ph.preheader
  ...
  %vector.recur.init = insertelement <4 x double> poison, double %7, i64 3
