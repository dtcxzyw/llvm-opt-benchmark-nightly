...
._crit_edge.i.i:                                  ; preds = %._crit_edge.loopexit.i.i, %bb.ad
  ...
  store float %.sroa.10.0.lcssa.i.i, ptr %i.ky, align 4, !tbaa !61
  %i.kz = getelementptr inbounds nuw i8, ptr %i.ky, i64 4
  store <2 x float> %i.kw, ptr %i.kz, align 4, !tbaa !61
...
bb.af:                                            ; preds = %bb.ae
  ...
  %13 = fmul float %i.mm, %i.nf
  %i.ng = load float, ptr %i.jo, align 4, !tbaa !61
  %14 = fmul float %i.mm, %i.nc
  %i.nh = fmul float %i.mm, %i.ng
  %15 = tail call float @llvm.fmuladd.f32(float %i.ne, float %i.mn, float %13)
  %16 = load float, ptr %i.jm, align 4, !tbaa !61
  %17 = load float, ptr %i.jn, align 8, !tbaa !61
  %i.ni = tail call float @llvm.fmuladd.f32(float %i.nb, float %i.mn, float %14)
  %i.nj = tail call float @llvm.fmuladd.f32(float %17, float %i.mn, float %i.nh)
  %i.nk = tail call float @llvm.fmuladd.f32(float %16, float %i.mo, float %15) ; 2 uses
  %i.nl = load float, ptr %i.jp, align 8, !tbaa !61
  %i.nm = tail call float @llvm.fmuladd.f32(float %i.nd, float %i.mo, float %i.ni) ; 2 uses
  %i.nn = tail call float @llvm.fmuladd.f32(float %i.nl, float %i.mo, float %i.nj) ; 2 uses
  %i.no = load float, ptr %i.fb, align 8, !tbaa !61 ; 2 uses
  %i.np = fneg float %i.nk
  %18 = fmul float %i.no, %i.np
  %19 = load float, ptr %i.ex, align 4, !tbaa !61 ; 2 uses
  %20 = load float, ptr %i.ev, align 8, !tbaa !61 ; 2 uses
  %i.nq = tail call float @llvm.fmuladd.f32(float %19, float %i.nn, float %18) ; 3 uses
  %21 = fneg float %i.nm
  %i.nr = fneg float %i.nn
  %22 = fmul float %19, %21
  %i.ns = fmul float %20, %i.nr
  %23 = tail call float @llvm.fmuladd.f32(float %20, float %i.nk, float %22) ; 3 uses
  %i.nt = tail call float @llvm.fmuladd.f32(float %i.no, float %i.nm, float %i.ns) ; 3 uses
  %i.nu = fmul float %i.nt, %i.nt
  %i.nv = tail call float @llvm.fmuladd.f32(float %i.nq, float %i.nq, float %i.nu)
  %i.nw = tail call noundef float @llvm.fmuladd.f32(float %23, float %23, float %i.nv)
  ...
  %i.ob = fmul float %i.my, %i.oa
  %i.oc = tail call float @llvm.fmuladd.f32(float %i.ny, float %i.mx, float %i.ob)
  %i.od = tail call noundef float @llvm.fmuladd.f32(float %i.nz, float %i.mz, float %i.oc)
  %24 = fmul float %i.na, %i.od                   ; 2 uses
  %i.oe = fmul float %i.ny, %24
  %i.of = insertelement <2 x float> poison, float %i.oa, i64 0
  %i.og = insertelement <2 x float> %i.of, float %i.nz, i64 1
  %i.oh = insertelement <2 x float> poison, float %24, i64 0
  %i.oi = shufflevector <2 x float> %i.oh, <2 x float> poison, <2 x i32> zeroinitializer
  %i.oj = fmul <2 x float> %i.og, %i.oi
  %25 = fadd float %.sroa.10.084.i.i, %i.oe
