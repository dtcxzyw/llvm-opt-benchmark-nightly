...
_ZL27sort_collective_coordinatesP13gmx_enfrotgrpP16sort_along_vec_t.exit: ; preds = %bb.n, %"_ZSt4sortIP16sort_along_vec_tZL27sort_collective_coordinatesP13gmx_enfrotgrpS1_E3$_0EvT_S5_T0_.exit.i._ZL27sort_collective_coordinatesP13gmx_enfrotgrpP16sort_along_vec_t.exit_crit_edge"
  ...
  %i.fl = getelementptr inbounds nuw i8, ptr %2, i64 72 ; 15 uses
...
._crit_edge.i87:                                  ; preds = %bb.bb, %_ZL18shift_single_coordPA3_KfPfPKi.exit.i85
  %.sroa.12181.0.lcssa.i = phi float [ 0.000000e+00, %_ZL18shift_single_coordPA3_KfPfPKi.exit.i85 ], [ %.sroa.12181.1.i, %bb.bb ] ; 2 uses
  %.sroa.7178.0.lcssa.i = phi float [ 0.000000e+00, %_ZL18shift_single_coordPA3_KfPfPKi.exit.i85 ], [ %.sroa.12181.1.i.a, %bb.bb ] ; 2 uses
  %.sroa.0175.0.lcssa.i = phi float [ 0.000000e+00, %_ZL18shift_single_coordPA3_KfPfPKi.exit.i85 ], [ %.sroa.7178.1.i, %bb.bb ] ; 2 uses
  %.sroa.12.0.lcssa.i = phi float [ 0.000000e+00, %_ZL18shift_single_coordPA3_KfPfPKi.exit.i85 ], [ %.sroa.0175.1.i, %bb.bb ] ; 2 uses
  %.sroa.7.0.lcssa.i = phi float [ 0.000000e+00, %_ZL18shift_single_coordPA3_KfPfPKi.exit.i85 ], [ %.sroa.12.1.i, %bb.bb ] ; 2 uses
  %.sroa.0168.0.lcssa.i = phi float [ 0.000000e+00, %_ZL18shift_single_coordPA3_KfPfPKi.exit.i85 ], [ %.sroa.7.1.i, %bb.bb ] ; 2 uses
  %.1142.lcssa.i = phi float [ %.0141290.i, %_ZL18shift_single_coordPA3_KfPfPKi.exit.i85 ], [ %.sroa.0168.1.i, %bb.bb ] ; 2 uses
  %.0139.lcssa.i = phi float [ 0.000000e+00, %_ZL18shift_single_coordPA3_KfPfPKi.exit.i85 ], [ %.2.i90, %bb.bb ] ; 3 uses
  %.0138.lcssa.i = phi float [ 0.000000e+00, %_ZL18shift_single_coordPA3_KfPfPKi.exit.i85 ], [ %.1.i91, %bb.bb ] ; 3 uses
  %13 = load float, ptr %i.fl, align 8, !tbaa !61 ; 5 uses
  %i.arb = load float, ptr %i.fh, align 4, !tbaa !61 ; 5 uses
  %14 = fneg float %i.arb                         ; 2 uses
  %15 = fmul float %.sroa.12181.0.lcssa.i, %14
  %16 = tail call float @llvm.fmuladd.f32(float %.sroa.7178.0.lcssa.i, float %13, float %15)
  %i.arc = load float, ptr %i.ff, align 8, !tbaa !61 ; 5 uses
  %i.ard = fneg float %13                         ; 2 uses
  %i.are = fmul float %.sroa.0175.0.lcssa.i, %i.ard
  %i.arf = tail call float @llvm.fmuladd.f32(float %.sroa.12181.0.lcssa.i, float %i.arc, float %i.are)
  %i.arg = fneg float %i.arc                      ; 2 uses
  %17 = fmul float %.sroa.7178.0.lcssa.i, %i.arg
  %18 = tail call float @llvm.fmuladd.f32(float %.sroa.0175.0.lcssa.i, float %i.arb, float %17)
  %i.arh = fmul float %.sroa.12.0.lcssa.i, %14
  %i.ari = tail call float @llvm.fmuladd.f32(float %.sroa.7.0.lcssa.i, float %13, float %i.arh)
  %19 = fmul float %.sroa.0168.0.lcssa.i, %i.ard
  %i.arj = tail call float @llvm.fmuladd.f32(float %.sroa.12.0.lcssa.i, float %i.arc, float %19)
  %i.ark = fmul float %.sroa.7.0.lcssa.i, %i.arg
  %i.arl = tail call float @llvm.fmuladd.f32(float %.sroa.0168.0.lcssa.i, float %i.arb, float %i.ark)
  %i.arm = fmul float %.0139.lcssa.i, %i.arc
  %i.arn = fmul float %.0139.lcssa.i, %i.arb
  %20 = fmul float %.0139.lcssa.i, %13
  %21 = fmul float %.0138.lcssa.i, %i.arc
  %22 = fmul float %.0138.lcssa.i, %i.arb
  %i.aro = fmul float %.0138.lcssa.i, %13
  %23 = load ptr, ptr %2, align 8, !tbaa !77
  %24 = getelementptr inbounds nuw i8, ptr %23, i64 64 ; 3 uses
  %25 = load ptr, ptr %i.aox, align 8, !tbaa !59
  %26 = getelementptr inbounds nuw [12 x i8], ptr %25, i64 %.0137291.i ; 3 uses
  %27 = load float, ptr %24, align 8, !tbaa !131
  %28 = fpext float %27 to double
  %i.arp = fsub float %i.ari, %16
  %i.arq = fsub float %i.arp, %i.arm
  %i.arr = fpext float %i.arq to double
  %i.ars = fpext float %21 to double
  %i.art = tail call double @llvm.fmuladd.f64(double %i.ars, double 5.000000e-01, double %i.arr)
  %i.aru = fmul double %i.art, %28
  %i.arv = fptrunc double %i.aru to float
  store float %i.arv, ptr %26, align 4, !tbaa !61
  %i.arw = load float, ptr %24, align 8, !tbaa !131
  %i.arx = fpext float %i.arw to double
  %i.ary = fsub float %i.arj, %i.arf
  %i.arz = fsub float %i.ary, %i.arn
  %29 = fpext float %i.arz to double
  %30 = fpext float %22 to double
  %31 = tail call double @llvm.fmuladd.f64(double %30, double 5.000000e-01, double %29)
  %32 = fmul double %31, %i.arx
  %33 = fptrunc double %32 to float
  %34 = getelementptr inbounds nuw i8, ptr %26, i64 4
  store float %33, ptr %34, align 4, !tbaa !61
  %35 = load float, ptr %24, align 8, !tbaa !131
  %36 = fpext float %35 to double
  %37 = fsub float %i.arl, %18
  %38 = fsub float %37, %20
  %39 = fpext float %38 to double
  %i.asa = fpext float %i.aro to double
  %40 = tail call double @llvm.fmuladd.f64(double %i.asa, double 5.000000e-01, double %39)
  %i.asb = fmul double %40, %36
  %i.asc = fptrunc double %i.asb to float
  %i.asd = getelementptr inbounds nuw i8, ptr %26, i64 8
...
bb.ay:                                            ; preds = %bb.bb, %.lr.ph280.i
  ...
  %.0138278.i = phi float [ 0.000000e+00, %.lr.ph280.i ], [ %.1.i91, %bb.bb ] ; 2 uses
  %.1142276.i.a = phi float [ 0.000000e+00, %.lr.ph280.i ], [ %.2.i90, %bb.bb ] ; 2 uses
  %.sroa.0168.0275.i.a = phi float [ %.0141290.i, %.lr.ph280.i ], [ %.sroa.0168.1.i, %bb.bb ] ; 2 uses
  ...
  %.sroa.12181.0270.i = phi float [ 0.000000e+00, %.lr.ph280.i ], [ %.sroa.12181.1.i, %bb.bb ] ; 2 uses
  ...
  %i.aty = fsub float %i.asp, %i.att              ; 7 uses
  %41 = fsub float %i.asr, %i.atv                 ; 7 uses
  %42 = fsub float %i.ast, %i.atx                 ; 7 uses
  %i.atz = load float, ptr %i.aok, align 8, !tbaa !61
  %i.aua = load float, ptr %i.aol, align 4, !tbaa !61
  %i.aub = fmul float %41, %i.aua
  %43 = tail call float @llvm.fmuladd.f32(float %i.atz, float %i.aty, float %i.aub)
  %44 = load float, ptr %i.aom, align 8, !tbaa !61
  %45 = tail call float @llvm.fmuladd.f32(float %44, float %42, float %43) ; 3 uses
  %46 = load float, ptr %i.aon, align 4, !tbaa !61
  %i.auc = load float, ptr %i.aoo, align 8, !tbaa !61
  %47 = fmul float %41, %i.auc
  %48 = tail call float @llvm.fmuladd.f32(float %46, float %i.aty, float %47)
  %i.aud = load float, ptr %i.aop, align 4, !tbaa !61
  %i.aue = tail call float @llvm.fmuladd.f32(float %i.aud, float %42, float %48) ; 3 uses
  %49 = load float, ptr %i.aoq, align 8, !tbaa !61
  %50 = load float, ptr %i.aor, align 4, !tbaa !61
  %51 = fmul float %41, %50
  %i.auf = tail call float @llvm.fmuladd.f32(float %49, float %i.aty, float %51)
  %i.aug = load float, ptr %i.aos, align 8, !tbaa !61
  %i.auh = tail call float @llvm.fmuladd.f32(float %i.aug, float %42, float %i.auf) ; 3 uses
...
bb.az:                                            ; preds = %bb.ay
  %52 = load float, ptr %i.fh, align 4, !tbaa !61 ; 2 uses
  %i.auq = load float, ptr %i.fl, align 8, !tbaa !61 ; 2 uses
  %i.aur = fneg float %i.auj
  %i.aus = fmul float %i.auq, %i.aur
  %53 = tail call float @llvm.fmuladd.f32(float %52, float %i.auk, float %i.aus) ; 6 uses
  %i.aut = load float, ptr %i.ff, align 8, !tbaa !61 ; 2 uses
  %54 = fneg float %i.auk
  %i.auu = fmul float %i.aut, %54
  %i.auv = tail call float @llvm.fmuladd.f32(float %i.auq, float %i.aui, float %i.auu) ; 6 uses
  %55 = fneg float %i.aui
  %56 = fmul float %52, %55
  %i.auw = tail call float @llvm.fmuladd.f32(float %i.aut, float %i.auj, float %56) ; 6 uses
  %i.aux = fmul float %i.auv, %i.auv
  %i.auy = tail call float @llvm.fmuladd.f32(float %53, float %53, float %i.aux)
  ...
  %i.ave = fmul float %i.aue, %i.auv
  %i.avf = tail call float @llvm.fmuladd.f32(float %53, float %45, float %i.ave)
  ...
  %i.avt = fpext float %.sroa.0168.0275.i.a to double
...
vector.ph57:                                      ; preds = %vector.memcheck44
  ...
  %broadcast.splatinsert73 = insertelement <8 x float> poison, float %53, i64 0
...
scalar.ph55:                                      ; preds = %scalar.ph55.preheader, %scalar.ph55
  ...
  %i.axk = fmul float %41, %i.axj
  %i.axl = tail call float @llvm.fmuladd.f32(float %i.axh, float %i.aty, float %i.axk)
  %i.axm = getelementptr inbounds nuw i8, ptr %i.axg, i64 8
  %i.axn = load float, ptr %i.axm, align 4, !tbaa !61
  %i.axo = tail call float @llvm.fmuladd.f32(float %i.axn, float %42, float %i.axl)
  ...
  %i.axt = fmul float %41, %i.axs
  %i.axu = tail call float @llvm.fmuladd.f32(float %i.axq, float %i.aty, float %i.axt)
  %i.axv = getelementptr inbounds nuw i8, ptr %i.axg, i64 20
  %i.axw = load float, ptr %i.axv, align 4, !tbaa !61
  %i.axx = tail call float @llvm.fmuladd.f32(float %i.axw, float %42, float %i.axu)
  ...
  %i.ayc = fmul float %41, %i.ayb
  %i.ayd = tail call float @llvm.fmuladd.f32(float %i.axz, float %i.aty, float %i.ayc)
  %i.aye = getelementptr inbounds nuw i8, ptr %i.axg, i64 32
  %i.ayf = load float, ptr %i.aye, align 4, !tbaa !61
  %i.ayg = tail call float @llvm.fmuladd.f32(float %i.ayf, float %42, float %i.ayd)
  %i.ayh = fmul float %i.auv, %i.axx
  %i.ayi = tail call float @llvm.fmuladd.f32(float %53, float %i.axo, float %i.ayh)
...
.loopexit.i89:                                    ; preds = %scalar.ph55, %middle.block102, %.preheader.i92, %bb.az
  ...
  %57 = fdiv float 1.000000e+00, %sqrt.i145.i     ; 3 uses
  %i.ayy = fmul float %53, %57                    ; 3 uses
  %58 = fmul float %i.auv, %57                    ; 3 uses
  %59 = fmul float %i.auw, %57                    ; 3 uses
  %60 = fmul float %i.aue, %58
  %61 = tail call float @llvm.fmuladd.f32(float %i.ayy, float %45, float %60)
  %62 = tail call noundef float @llvm.fmuladd.f32(float %59, float %i.auh, float %61) ; 4 uses
  %i.ayz = fdiv float %sqrt.i145.i, %i.avd        ; 6 uses
  %i.aza = fmul float %45, %i.ayz
  %i.azb = fmul float %i.aue, %i.ayz
  %i.azc = fmul float %i.auh, %i.ayz
  %i.azd = fmul float %i.ayz, %i.ayz
  %i.aze = fmul float %sqrt.i145.i, %i.azd
  %i.azf = fmul float %i.aze, %62                 ; 3 uses
  %i.azg = fmul float %i.ayy, %i.azf
  %i.azh = fmul float %58, %i.azf
  %i.azi = fmul float %59, %i.azf
  %63 = fsub float %i.aza, %i.azg
  %64 = fsub float %i.azb, %i.azh
  %65 = fsub float %i.azc, %i.azi
  %i.azj = fmul float %i.apg, %i.ask              ; 2 uses
  %i.azk = fmul float %i.azj, %62                 ; 3 uses
  %i.azl = fmul float %i.azk, %63                 ; 3 uses
  %i.azm = fmul float %i.azk, %64                 ; 3 uses
  %i.azn = fmul float %i.azk, %65                 ; 3 uses
  %66 = fadd float %.sroa.7178.0271.i.a, %i.azl   ; 2 uses
  %67 = fadd float %.sroa.12181.0270.i.a, %i.azm  ; 2 uses
  %68 = fadd float %.sroa.12181.0270.i, %i.azn    ; 2 uses
  %69 = fmul float %i.ang, %i.atf
  %i.azo = fmul float %69, %sqrt.i145.i           ; 2 uses
  %i.azp = fmul float %i.azj, %i.azo
  %i.azq = fmul float %i.ayz, %i.azp
  %i.azr = fmul float %i.azq, %62
  %i.azs = fmul float %62, %i.azr                 ; 4 uses
  %70 = fadd float %.0138278.i, %i.azs            ; 2 uses
  %71 = fmul float %i.apf, %i.ask
  %72 = load ptr, ptr %i.aou, align 8, !tbaa !105
  %73 = getelementptr inbounds [4 x i8], ptr %72, i64 %i.ath
  %74 = load float, ptr %73, align 4, !tbaa !61
  %75 = fdiv float %71, %74                       ; 3 uses
  %76 = load ptr, ptr %i.aov, align 8, !tbaa !601
  %77 = getelementptr inbounds [12 x i8], ptr %76, i64 %i.ath ; 3 uses
  ...
  %i.azt = fmul float %75, %78                    ; 4 uses
  %i.azu = fmul float %75, %80                    ; 4 uses
  %i.azv = fmul float %75, %82                    ; 4 uses
  %i.azw = fadd float %.sroa.7.0274.i.a, %i.azt   ; 2 uses
  %i.azx = fadd float %.sroa.12.0273.i.a, %i.azu  ; 2 uses
  %i.azy = fadd float %.sroa.0175.0272.i.a, %i.azv ; 2 uses
  %83 = fmul float %58, %i.azu
  %84 = tail call float @llvm.fmuladd.f32(float %i.ayy, float %i.azt, float %83)
  %85 = tail call noundef float @llvm.fmuladd.f32(float %59, float %i.azv, float %84)
  %86 = fmul float %i.azo, %85                    ; 4 uses
  %87 = fadd float %.1142276.i.a, %86             ; 2 uses
...
bb.ba:                                            ; preds = %.loopexit.i89
  ...
  %i.bac = fmul float %i.azn, %i.bab
  %i.bad = tail call float @llvm.fmuladd.f32(float %i.azm, float %i.azz, float %i.bac)
  %i.bae = load float, ptr %i.ff, align 8, !tbaa !61 ; 6 uses
  %i.baf = fneg float %i.azz                      ; 2 uses
  %i.bag = fmul float %i.azl, %i.baf
  %i.bah = tail call float @llvm.fmuladd.f32(float %i.azn, float %i.bae, float %i.bag)
  %i.bai = fneg float %i.bae                      ; 2 uses
  %i.baj = fmul float %i.azm, %i.bai
  %i.bak = tail call float @llvm.fmuladd.f32(float %i.azl, float %i.baa, float %i.baj)
  %i.bal = fmul float %i.azv, %i.bab
  %i.bam = tail call float @llvm.fmuladd.f32(float %i.azu, float %i.azz, float %i.bal)
  %i.ban = fmul float %i.azt, %i.baf
  %i.bao = tail call float @llvm.fmuladd.f32(float %i.azv, float %i.bae, float %i.ban)
  %i.bap = fmul float %i.azu, %i.bai
  %i.baq = tail call float @llvm.fmuladd.f32(float %i.azt, float %i.baa, float %i.bap)
  %i.bar = fmul float %86, %i.bae
  %i.bas = fmul float %86, %i.baa
  %i.bat = fmul float %86, %i.azz
  %i.bau = fmul float %i.azs, %i.bae
  %i.bav = fmul float %i.azs, %i.baa
  %i.baw = fmul float %i.azs, %i.azz
...
bb.bb:                                            ; preds = %bb.ba, %.loopexit.i89, %bb.ay
  %.sroa.12181.1.i = phi float [ %.sroa.12181.0270.i, %bb.ay ], [ %68, %bb.ba ], [ %68, %.loopexit.i89 ] ; 2 uses
  %.sroa.12181.1.i.a = phi float [ %.sroa.12181.0270.i.a, %bb.ay ], [ %67, %bb.ba ], [ %67, %.loopexit.i89 ] ; 2 uses
  %.sroa.7178.1.i = phi float [ %.sroa.7178.0271.i.a, %bb.ay ], [ %66, %bb.ba ], [ %66, %.loopexit.i89 ] ; 2 uses
  %.sroa.0175.1.i = phi float [ %.sroa.0175.0272.i.a, %bb.ay ], [ %i.azy, %bb.ba ], [ %i.azy, %.loopexit.i89 ] ; 2 uses
  %.sroa.12.1.i = phi float [ %.sroa.12.0273.i.a, %bb.ay ], [ %i.azx, %bb.ba ], [ %i.azx, %.loopexit.i89 ] ; 2 uses
  %.sroa.7.1.i = phi float [ %.sroa.7.0274.i.a, %bb.ay ], [ %i.azw, %bb.ba ], [ %i.azw, %.loopexit.i89 ] ; 2 uses
  %.sroa.0168.1.i = phi float [ %.sroa.0168.0275.i.a, %bb.ay ], [ %i.avv, %bb.ba ], [ %i.avv, %.loopexit.i89 ] ; 2 uses
  %.2.i90 = phi float [ %.1142276.i.a, %bb.ay ], [ %87, %bb.ba ], [ %87, %.loopexit.i89 ] ; 2 uses
  %.1.i91 = phi float [ %.0138278.i, %bb.ay ], [ %70, %bb.ba ], [ %70, %.loopexit.i89 ] ; 2 uses
