...
_ZL13UpdateWeightsiP10t_expandedP12df_history_tiPKfS4_l.exit: ; preds = %_ZL24CheckIfDoneEquilibratingiPK10t_expandedPK12df_history_tl.exit.thread.thread.i, %_ZL24CheckIfDoneEquilibratingiPK10t_expandedPK12df_history_tl.exit.thread.i, %.lr.ph.i
  ...
  br i1 %.not190, label %bb.bm, label %bb.bl
...
bb.bq:                                            ; preds = %bb.bp
  ...
  %spec.select.i160 = select i1 %i.avb, i32 %3, i32 %i.ava
...
.lr.ph405.i:                                      ; preds = %bb.br
  ...
  %scevgep735 = getelementptr i8, ptr %i.ave, i64 8
  %i.avw = sub i64 %i.n, %i.avi
  %diff.check763 = icmp ugt i64 %i.avw, -128
  %i.avx = sub i64 %i.avk, %i.avj
  %diff.check = icmp ugt i64 %i.avx, -128
  %i.avy = sub i64 %i.n, %i.avk
  %diff.check696 = icmp ugt i64 %i.avy, -128
  %conflict.rdx697 = or i1 %diff.check, %diff.check696
  %i.avz = sub i64 %i.n, %i.avj
  %diff.check698 = icmp ugt i64 %i.avz, -128
  %conflict.rdx699 = or i1 %conflict.rdx697, %diff.check698
  %xtraiter935 = and i64 %i.avu, 1
  %i.awa = icmp eq i32 %i.h, 1
  %unroll_iter939 = and i64 %i.avu, 4294967294
  %lcmp.mod937.not = icmp eq i64 %xtraiter935, 0
  %lcmp.mod938 = trunc i32 %i.h to i1
  br label %bb.bs

bb.bs:                                            ; preds = %._crit_edge392.i, %.lr.ph405.i
  %indvars.iv461.i = phi i64 [ 0, %.lr.ph405.i ], [ %indvars.iv.next462.i, %._crit_edge392.i ] ; 2 uses
  %.0200402.i = phi i32 [ %3, %.lr.ph405.i ], [ %.5214.i, %._crit_edge392.i ] ; 17 uses
  %.0202401.i = phi float [ 0.000000e+00, %.lr.ph405.i ], [ %.9.i, %._crit_edge392.i ] ; 6 uses
...
.lr.ph.preheader.i.i140:                          ; preds = %bb.bv
  ...
  %i.azc = add nuw i32 %.0215.i, 1                ; 5 uses
  %i.azd = add i32 %.0215.i, 1
  %i.aze = sub i32 %i.azd, %.0216.i
  %i.azf = sub i32 %.0215.i, %.0216.i
  %xtraiter920 = and i32 %i.aze, 7                ; 2 uses
  %lcmp.mod921.not = icmp eq i32 %xtraiter920, 0
  br i1 %lcmp.mod921.not, label %.lr.ph.i.i141.prol.loopexit, label %.lr.ph.i.i141.prol

.lr.ph.i.i141.prol:                               ; preds = %.lr.ph.preheader.i.i140, %.lr.ph.i.i141.prol
  %indvars.iv.i.i142.prol = phi i64 [ %indvars.iv.next.i.i144.prol, %.lr.ph.i.i141.prol ], [ %i.ayz, %.lr.ph.preheader.i.i140 ] ; 2 uses
  %.038.i.i143.prol = phi float [ %.1.i.i.prol, %.lr.ph.i.i141.prol ], [ %i.azb, %.lr.ph.preheader.i.i140 ] ; 2 uses
  %prol.iter922 = phi i32 [ %prol.iter922.next, %.lr.ph.i.i141.prol ], [ 0, %.lr.ph.preheader.i.i140 ]
  ...
  %.1.i.i.prol = select i1 %i.azi, float %i.azh, float %.038.i.i143.prol ; 3 uses
  %indvars.iv.next.i.i144.prol = add nuw nsw i64 %indvars.iv.i.i142.prol, 1 ; 2 uses
  %prol.iter922.next = add i32 %prol.iter922, 1   ; 2 uses
  %prol.iter922.cmp.not = icmp eq i32 %prol.iter922.next, %xtraiter920
  br i1 %prol.iter922.cmp.not, label %.lr.ph.i.i141.prol.loopexit, label %.lr.ph.i.i141.prol, !llvm.loop !281

.lr.ph.i.i141.prol.loopexit:                      ; preds = %.lr.ph.i.i141.prol, %.lr.ph.preheader.i.i140
  %.1.i.i.lcssa.unr = phi float [ poison, %.lr.ph.preheader.i.i140 ], [ %.1.i.i.prol, %.lr.ph.i.i141.prol ]
  %indvars.iv.i.i142.unr = phi i64 [ %i.ayz, %.lr.ph.preheader.i.i140 ], [ %indvars.iv.next.i.i144.prol, %.lr.ph.i.i141.prol ]
  %.038.i.i143.unr = phi float [ %i.azb, %.lr.ph.preheader.i.i140 ], [ %.1.i.i.prol, %.lr.ph.i.i141.prol ]
  %i.azj = icmp ult i32 %i.azf, 7
  br i1 %i.azj, label %.lr.ph41.i.i147.preheader, label %.lr.ph.i.i141

.lr.ph.i.i141:                                    ; preds = %.lr.ph.i.i141.prol.loopexit, %.lr.ph.i.i141
  %indvars.iv.i.i142 = phi i64 [ %indvars.iv.next.i.i144.7, %.lr.ph.i.i141 ], [ %indvars.iv.i.i142.unr, %.lr.ph.i.i141.prol.loopexit ] ; 9 uses
  %.038.i.i143 = phi float [ %.1.i.i.7, %.lr.ph.i.i141 ], [ %.038.i.i143.unr, %.lr.ph.i.i141.prol.loopexit ] ; 2 uses
  ...
  %.1.i.i = select i1 %i.azm, float %i.azl, float %.038.i.i143 ; 2 uses
  ...
  %i.azq = fcmp ogt float %i.azp, %.1.i.i
  %.1.i.i.1 = select i1 %i.azq, float %i.azp, float %.1.i.i ; 2 uses
  ...
  %i.azu = fcmp ogt float %i.azt, %.1.i.i.1
  %.1.i.i.2 = select i1 %i.azu, float %i.azt, float %.1.i.i.1 ; 2 uses
  ...
  %i.azy = fcmp ogt float %i.azx, %.1.i.i.2
  %.1.i.i.3 = select i1 %i.azy, float %i.azx, float %.1.i.i.2 ; 2 uses
  ...
  %i.bac = fcmp ogt float %i.bab, %.1.i.i.3
  %.1.i.i.4 = select i1 %i.bac, float %i.bab, float %.1.i.i.3 ; 2 uses
  ...
  %i.bag = fcmp ogt float %i.baf, %.1.i.i.4
  %.1.i.i.5 = select i1 %i.bag, float %i.baf, float %.1.i.i.4 ; 2 uses
  ...
  %i.bak = fcmp ogt float %i.baj, %.1.i.i.5
  %.1.i.i.6 = select i1 %i.bak, float %i.baj, float %.1.i.i.5 ; 2 uses
  ...
  %i.bao = fcmp ogt float %i.ban, %.1.i.i.6
  %.1.i.i.7 = select i1 %i.bao, float %i.ban, float %.1.i.i.6 ; 2 uses
  %indvars.iv.next.i.i144.7 = add nuw nsw i64 %indvars.iv.i.i142, 8 ; 2 uses
  %lftr.wideiv.i.i.7 = trunc i64 %indvars.iv.next.i.i144.7 to i32
  %exitcond.not.i.i145.7 = icmp eq i32 %i.azc, %lftr.wideiv.i.i.7
  br i1 %exitcond.not.i.i145.7, label %.lr.ph41.i.i147.preheader, label %.lr.ph.i.i141, !llvm.loop !217

.lr.ph41.i.i147.preheader:                        ; preds = %.lr.ph.i.i141, %.lr.ph.i.i141.prol.loopexit
  %.1.i.i.lcssa = phi float [ %.1.i.i.lcssa.unr, %.lr.ph.i.i141.prol.loopexit ], [ %.1.i.i.7, %.lr.ph.i.i141 ] ; 2 uses
  br label %.lr.ph41.i.i147

.lr.ph41.i.i147:                                  ; preds = %.lr.ph41.i.i147.preheader, %.lr.ph41.i.i147
  %indvars.iv46.i.i148 = phi i64 [ %indvars.iv.next47.i.i149, %.lr.ph41.i.i147 ], [ %i.ayz, %.lr.ph41.i.i147.preheader ] ; 2 uses
  %i.bap = phi double [ %i.bav, %.lr.ph41.i.i147 ], [ 0.000000e+00, %.lr.ph41.i.i147.preheader ]
  %i.baq = getelementptr inbounds nuw [4 x i8], ptr %i.k, i64 %indvars.iv46.i.i148
  %i.bar = load float, ptr %i.baq, align 4, !tbaa !53
  %i.bas = fsub float %i.bar, %.1.i.i.lcssa
  ...
  %indvars.iv.next47.i.i149 = add nuw nsw i64 %indvars.iv46.i.i148, 1 ; 2 uses
  %lftr.wideiv49.i.i = trunc i64 %indvars.iv.next47.i.i149 to i32
  %exitcond50.not.i.i = icmp eq i32 %i.azc, %lftr.wideiv49.i.i
  br i1 %exitcond50.not.i.i, label %.lr.ph44.i.i151, label %.lr.ph41.i.i147, !llvm.loop !219

.lr.ph44.i.i151:                                  ; preds = %.lr.ph41.i.i147, %.lr.ph44.i.i151
  %indvars.iv51.i.i152 = phi i64 [ %indvars.iv.next52.i.i153, %.lr.ph44.i.i151 ], [ %i.ayz, %.lr.ph41.i.i147 ] ; 3 uses
  %i.baw = getelementptr inbounds nuw [4 x i8], ptr %i.k, i64 %indvars.iv51.i.i152
  %i.bax = load float, ptr %i.baw, align 4, !tbaa !53
  %i.bay = fsub float %i.bax, %.1.i.i.lcssa
  %i.baz = tail call noundef float @expf(float noundef %i.bay) #19
  %i.bba = fpext float %i.baz to double
  %i.bbb = fdiv double %i.bba, %i.bav
  %i.bbc = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %indvars.iv51.i.i152
  store double %i.bbb, ptr %i.bbc, align 8, !tbaa !70
  %indvars.iv.next52.i.i153 = add nuw nsw i64 %indvars.iv51.i.i152, 1 ; 2 uses
  %lftr.wideiv54.i.i = trunc i64 %indvars.iv.next52.i.i153 to i32
  %exitcond55.not.i.i = icmp eq i32 %i.azc, %lftr.wideiv54.i.i
  br i1 %exitcond55.not.i.i, label %_ZL26GenerateGibbsProbabilitiesPKfPdS1_ii.exit.thread.i, label %.lr.ph44.i.i151, !llvm.loop !220

_ZL26GenerateGibbsProbabilitiesPKfPdS1_ii.exit.i: ; preds = %bb.bv
  %i.bbd = icmp eq i32 %i.ayu, 3
  br i1 %i.bbd, label %.loopexit.i159, label %._crit_edge364.i

_ZL26GenerateGibbsProbabilitiesPKfPdS1_ii.exit.thread.i: ; preds = %.lr.ph44.i.i151
  ...
  %min.iters.check701 = icmp ult i64 %i.bbf, 4    ; 2 uses
  br i1 %i.bbe, label %iter.check717, label %iter.check781

iter.check781:                                    ; preds = %_ZL26GenerateGibbsProbabilitiesPKfPdS1_ii.exit.thread.i
  %or.cond836 = or i1 %min.iters.check701, %diff.check763
  br i1 %or.cond836, label %.lr.ph363.i.preheader, label %vector.main.loop.iter.check766

vector.main.loop.iter.check766:                   ; preds = %iter.check781
  %min.iters.check767 = icmp ult i64 %i.bbf, 16
  br i1 %min.iters.check767, label %vec.epilog.ph785, label %vector.ph768

vector.ph768:                                     ; preds = %vector.main.loop.iter.check766
  %i.bbg = and i64 %i.bbf, 12
  %n.vec769 = and i64 %i.bbf, -16                 ; 4 uses
  %i.bbh = add nsw i64 %n.vec769, %i.ayz
...
vector.body770:                                   ; preds = %vector.body770, %vector.ph768
  ...
  %i.bbi = add nuw i64 %index771, %i.ayz          ; 2 uses
  ...
  %wide.load772 = load <4 x double>, ptr %i.bbj, align 8, !tbaa !70
  %wide.load773 = load <4 x double>, ptr %i.bbk, align 8, !tbaa !70
  %wide.load774 = load <4 x double>, ptr %i.bbl, align 8, !tbaa !70
  %wide.load775 = load <4 x double>, ptr %i.bbm, align 8, !tbaa !70
  %i.bbn = fsub <4 x double> splat (double 1.000000e+00), %wide.load772
  %i.bbo = fsub <4 x double> splat (double 1.000000e+00), %wide.load773
  %i.bbp = fsub <4 x double> splat (double 1.000000e+00), %wide.load774
  %i.bbq = fsub <4 x double> splat (double 1.000000e+00), %wide.load775
  ...
  %index.next776 = add nuw i64 %index771, 16      ; 2 uses
  %i.bbv = icmp eq i64 %index.next776, %n.vec769
  br i1 %i.bbv, label %middle.block777, label %vector.body770, !llvm.loop !282

middle.block777:                                  ; preds = %vector.body770
  %cmp.n778 = icmp eq i64 %i.bbf, %n.vec769
  br i1 %cmp.n778, label %._crit_edge364.thread.i, label %vec.epilog.iter.check783

vec.epilog.iter.check783:                         ; preds = %middle.block777
  %min.epilog.iters.check784 = icmp eq i64 %i.bbg, 0
  br i1 %min.epilog.iters.check784, label %.lr.ph363.i.preheader, label %vec.epilog.ph785, !prof !59

vec.epilog.ph785:                                 ; preds = %vector.main.loop.iter.check766, %vec.epilog.iter.check783
  %vec.epilog.resume.val779 = phi i64 [ %n.vec769, %vec.epilog.iter.check783 ], [ 0, %vector.main.loop.iter.check766 ]
  %n.vec786 = and i64 %i.bbf, -4                  ; 3 uses
  %i.bbw = add nsw i64 %n.vec786, %i.ayz
  br label %vec.epilog.vector.body787

vec.epilog.vector.body787:                        ; preds = %vec.epilog.vector.body787, %vec.epilog.ph785
  %index788 = phi i64 [ %vec.epilog.resume.val779, %vec.epilog.ph785 ], [ %index.next790, %vec.epilog.vector.body787 ] ; 2 uses
  %i.bbx = add nuw i64 %index788, %i.ayz          ; 2 uses
  %i.bby = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %i.bbx
  %wide.load789 = load <4 x double>, ptr %i.bby, align 8, !tbaa !70
  %i.bbz = fsub <4 x double> splat (double 1.000000e+00), %wide.load789
  %i.bca = getelementptr inbounds nuw [8 x i8], ptr %i.ave, i64 %i.bbx
  store <4 x double> %i.bbz, ptr %i.bca, align 8, !tbaa !70
  %index.next790 = add nuw i64 %index788, 4       ; 2 uses
  %i.bcb = icmp eq i64 %index.next790, %n.vec786
  br i1 %i.bcb, label %vec.epilog.middle.block791, label %vec.epilog.vector.body787, !llvm.loop !283

vec.epilog.middle.block791:                       ; preds = %vec.epilog.vector.body787
  %cmp.n792 = icmp eq i64 %i.bbf, %n.vec786
  br i1 %cmp.n792, label %._crit_edge364.thread.i, label %.lr.ph363.i.preheader

.lr.ph363.i.preheader:                            ; preds = %iter.check781, %vec.epilog.iter.check783, %vec.epilog.middle.block791
  %indvars.iv.i154.ph = phi i64 [ %i.ayz, %iter.check781 ], [ %i.bbh, %vec.epilog.iter.check783 ], [ %i.bbw, %vec.epilog.middle.block791 ] ; 4 uses
  %i.bcc = sub nsw i64 %wide.trip.count449.i, %indvars.iv.i154.ph
  %i.bcd = zext i32 %.0215.i to i64
  %i.bce = sub nsw i64 %i.bcd, %indvars.iv.i154.ph
  %xtraiter923 = and i64 %i.bcc, 7                ; 2 uses
  %lcmp.mod924.not = icmp eq i64 %xtraiter923, 0
  br i1 %lcmp.mod924.not, label %.lr.ph363.i.prol.loopexit, label %.lr.ph363.i.prol

.lr.ph363.i.prol:                                 ; preds = %.lr.ph363.i.preheader, %.lr.ph363.i.prol
  %indvars.iv.i154.prol = phi i64 [ %indvars.iv.next.i155.prol, %.lr.ph363.i.prol ], [ %indvars.iv.i154.ph, %.lr.ph363.i.preheader ] ; 3 uses
  %prol.iter925 = phi i64 [ %prol.iter925.next, %.lr.ph363.i.prol ], [ 0, %.lr.ph363.i.preheader ]
  %i.bcf = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %indvars.iv.i154.prol
  %i.bcg = load double, ptr %i.bcf, align 8, !tbaa !70
  %i.bch = fsub double 1.000000e+00, %i.bcg
  %i.bci = getelementptr inbounds nuw [8 x i8], ptr %i.ave, i64 %indvars.iv.i154.prol
  store double %i.bch, ptr %i.bci, align 8, !tbaa !70
  %indvars.iv.next.i155.prol = add nuw nsw i64 %indvars.iv.i154.prol, 1 ; 2 uses
  %prol.iter925.next = add i64 %prol.iter925, 1   ; 2 uses
  %prol.iter925.cmp.not = icmp eq i64 %prol.iter925.next, %xtraiter923
  br i1 %prol.iter925.cmp.not, label %.lr.ph363.i.prol.loopexit, label %.lr.ph363.i.prol, !llvm.loop !284

.lr.ph363.i.prol.loopexit:                        ; preds = %.lr.ph363.i.prol, %.lr.ph363.i.preheader
  %indvars.iv.i154.unr = phi i64 [ %indvars.iv.i154.ph, %.lr.ph363.i.preheader ], [ %indvars.iv.next.i155.prol, %.lr.ph363.i.prol ]
  %i.bcj = icmp ult i64 %i.bce, 7
  br i1 %i.bcj, label %._crit_edge364.thread.i, label %.lr.ph363.i

iter.check717:                                    ; preds = %_ZL26GenerateGibbsProbabilitiesPKfPdS1_ii.exit.thread.i
  %brmerge = or i1 %min.iters.check701, %conflict.rdx699
  br i1 %brmerge, label %.lr.ph381.i.preheader, label %vector.main.loop.iter.check702

vector.main.loop.iter.check702:                   ; preds = %iter.check717
  %min.iters.check703 = icmp ult i64 %i.bbf, 16
  br i1 %min.iters.check703, label %vec.epilog.ph721, label %vector.ph704

vector.ph704:                                     ; preds = %vector.main.loop.iter.check702
  %i.bck = and i64 %i.bbf, 12
  %n.vec705 = and i64 %i.bbf, -16                 ; 4 uses
  %i.bcl = add nsw i64 %n.vec705, %i.ayz
  br label %vector.body706

vector.body706:                                   ; preds = %vector.body706, %vector.ph704
  %index707 = phi i64 [ 0, %vector.ph704 ], [ %index.next712, %vector.body706 ] ; 2 uses
  %i.bcm = add nuw i64 %index707, %i.ayz          ; 3 uses
  ...
  %wide.load708 = load <4 x double>, ptr %i.bcn, align 8, !tbaa !70
  %wide.load709 = load <4 x double>, ptr %i.bco, align 8, !tbaa !70
  %wide.load710 = load <4 x double>, ptr %i.bcp, align 8, !tbaa !70
  %wide.load711 = load <4 x double>, ptr %i.bcq, align 8, !tbaa !70
  ...
  store <4 x double> %wide.load708, ptr %i.bcr, align 8, !tbaa !70
  store <4 x double> %wide.load709, ptr %i.bcs, align 8, !tbaa !70
  store <4 x double> %wide.load710, ptr %i.bct, align 8, !tbaa !70
  store <4 x double> %wide.load711, ptr %i.bcu, align 8, !tbaa !70
  ...
  %index.next712 = add nuw i64 %index707, 16      ; 2 uses
  %i.bcz = icmp eq i64 %index.next712, %n.vec705
  br i1 %i.bcz, label %middle.block713, label %vector.body706, !llvm.loop !285

middle.block713:                                  ; preds = %vector.body706
  %cmp.n714 = icmp eq i64 %i.bbf, %n.vec705
  br i1 %cmp.n714, label %.lr.ph385.preheader.i, label %vec.epilog.iter.check719

vec.epilog.iter.check719:                         ; preds = %middle.block713
  %min.epilog.iters.check720 = icmp eq i64 %i.bck, 0
  br i1 %min.epilog.iters.check720, label %.lr.ph381.i.preheader, label %vec.epilog.ph721, !prof !59

vec.epilog.ph721:                                 ; preds = %vector.main.loop.iter.check702, %vec.epilog.iter.check719
  %vec.epilog.resume.val715 = phi i64 [ %n.vec705, %vec.epilog.iter.check719 ], [ 0, %vector.main.loop.iter.check702 ]
  %n.vec722 = and i64 %i.bbf, -4                  ; 3 uses
  %i.bda = add nsw i64 %n.vec722, %i.ayz
  br label %vec.epilog.vector.body723

vec.epilog.vector.body723:                        ; preds = %vec.epilog.vector.body723, %vec.epilog.ph721
  %index724 = phi i64 [ %vec.epilog.resume.val715, %vec.epilog.ph721 ], [ %index.next726, %vec.epilog.vector.body723 ] ; 2 uses
  %i.bdb = add nuw i64 %index724, %i.ayz          ; 3 uses
  %i.bdc = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %i.bdb
  %wide.load725 = load <4 x double>, ptr %i.bdc, align 8, !tbaa !70
  %i.bdd = getelementptr inbounds nuw [8 x i8], ptr %i.avc, i64 %i.bdb
  store <4 x double> %wide.load725, ptr %i.bdd, align 8, !tbaa !70
  ...
  %i.bdf = icmp eq i64 %index.next726, %n.vec722
  br i1 %i.bdf, label %vec.epilog.middle.block727, label %vec.epilog.vector.body723, !llvm.loop !286

vec.epilog.middle.block727:                       ; preds = %vec.epilog.vector.body723
  %cmp.n728 = icmp eq i64 %i.bbf, %n.vec722
  br i1 %cmp.n728, label %.lr.ph385.preheader.i, label %.lr.ph381.i.preheader

.lr.ph381.i.preheader:                            ; preds = %iter.check717, %vec.epilog.iter.check719, %vec.epilog.middle.block727
  %indvars.iv446.i.ph = phi i64 [ %i.ayz, %iter.check717 ], [ %i.bda, %vec.epilog.middle.block727 ], [ %i.bcl, %vec.epilog.iter.check719 ] ; 4 uses
  %i.bdg = sub nsw i64 %wide.trip.count449.i, %indvars.iv446.i.ph
  %i.bdh = zext i32 %.0215.i to i64
  %i.bdi = sub nsw i64 %i.bdh, %indvars.iv446.i.ph
  %xtraiter929 = and i64 %i.bdg, 7                ; 2 uses
  %lcmp.mod930.not = icmp eq i64 %xtraiter929, 0
  br i1 %lcmp.mod930.not, label %.lr.ph381.i.prol.loopexit, label %.lr.ph381.i.prol
...
.lr.ph381.i.prol:                                 ; preds = %.lr.ph381.i.preheader, %.lr.ph381.i.prol
  ...
  %prol.iter931 = phi i64 [ %prol.iter931.next, %.lr.ph381.i.prol ], [ 0, %.lr.ph381.i.preheader ]
  ...
  br i1 %prol.iter931.cmp.not, label %.lr.ph381.i.prol.loopexit, label %.lr.ph381.i.prol, !llvm.loop !287
...
.lr.ph385.preheader.i:                            ; preds = %.lr.ph381.i.prol.loopexit, %.lr.ph381.i, %vec.epilog.middle.block727, %middle.block713
...
.lr.ph385.i:                                      ; preds = %bb.bw, %.lr.ph385.preheader.i
  ...
  %.0204384.i = phi float [ %.013.i.i.i.i, %.lr.ph385.preheader.i ], [ %i.bfd, %bb.bw ]
  %i.bey = fpext float %.0204384.i to double      ; 2 uses
  ...
  br i1 %i.bfb, label %bb.bw, label %.loopexit.loopexit512.i
...
.lr.ph363.i:                                      ; preds = %.lr.ph363.i.prol.loopexit, %.lr.ph363.i
  %indvars.iv.i154 = phi i64 [ %indvars.iv.next.i155.7, %.lr.ph363.i ], [ %indvars.iv.i154.unr, %.lr.ph363.i.prol.loopexit ] ; 10 uses
  %i.bfe = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %indvars.iv.i154
  %i.bff = load double, ptr %i.bfe, align 8, !tbaa !70
  %i.bfg = fsub double 1.000000e+00, %i.bff
  %i.bfh = getelementptr inbounds nuw [8 x i8], ptr %i.ave, i64 %indvars.iv.i154
  store double %i.bfg, ptr %i.bfh, align 8, !tbaa !70
  %indvars.iv.next.i155 = add nuw nsw i64 %indvars.iv.i154, 1 ; 2 uses
  %i.bfi = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %indvars.iv.next.i155
  %i.bfj = load double, ptr %i.bfi, align 8, !tbaa !70
  %i.bfk = fsub double 1.000000e+00, %i.bfj
  %i.bfl = getelementptr inbounds nuw [8 x i8], ptr %i.ave, i64 %indvars.iv.next.i155
  store double %i.bfk, ptr %i.bfl, align 8, !tbaa !70
  %indvars.iv.next.i155.1 = add nuw nsw i64 %indvars.iv.i154, 2 ; 2 uses
  %i.bfm = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %indvars.iv.next.i155.1
  %i.bfn = load double, ptr %i.bfm, align 8, !tbaa !70
  %i.bfo = fsub double 1.000000e+00, %i.bfn
  %i.bfp = getelementptr inbounds nuw [8 x i8], ptr %i.ave, i64 %indvars.iv.next.i155.1
  store double %i.bfo, ptr %i.bfp, align 8, !tbaa !70
  %indvars.iv.next.i155.2 = add nuw nsw i64 %indvars.iv.i154, 3 ; 2 uses
  %i.bfq = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %indvars.iv.next.i155.2
  %i.bfr = load double, ptr %i.bfq, align 8, !tbaa !70
  %i.bfs = fsub double 1.000000e+00, %i.bfr
  %i.bft = getelementptr inbounds nuw [8 x i8], ptr %i.ave, i64 %indvars.iv.next.i155.2
  store double %i.bfs, ptr %i.bft, align 8, !tbaa !70
  %indvars.iv.next.i155.3 = add nuw nsw i64 %indvars.iv.i154, 4 ; 2 uses
  %i.bfu = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %indvars.iv.next.i155.3
  %i.bfv = load double, ptr %i.bfu, align 8, !tbaa !70
  %i.bfw = fsub double 1.000000e+00, %i.bfv
  %i.bfx = getelementptr inbounds nuw [8 x i8], ptr %i.ave, i64 %indvars.iv.next.i155.3
  store double %i.bfw, ptr %i.bfx, align 8, !tbaa !70
  %indvars.iv.next.i155.4 = add nuw nsw i64 %indvars.iv.i154, 5 ; 2 uses
  %i.bfy = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %indvars.iv.next.i155.4
  %i.bfz = load double, ptr %i.bfy, align 8, !tbaa !70
  %i.bga = fsub double 1.000000e+00, %i.bfz
  %i.bgb = getelementptr inbounds nuw [8 x i8], ptr %i.ave, i64 %indvars.iv.next.i155.4
  store double %i.bga, ptr %i.bgb, align 8, !tbaa !70
  %indvars.iv.next.i155.5 = add nuw nsw i64 %indvars.iv.i154, 6 ; 2 uses
  %i.bgc = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %indvars.iv.next.i155.5
  %i.bgd = load double, ptr %i.bgc, align 8, !tbaa !70
  %i.bge = fsub double 1.000000e+00, %i.bgd
  %i.bgf = getelementptr inbounds nuw [8 x i8], ptr %i.ave, i64 %indvars.iv.next.i155.5
  store double %i.bge, ptr %i.bgf, align 8, !tbaa !70
  %indvars.iv.next.i155.6 = add nuw nsw i64 %indvars.iv.i154, 7 ; 2 uses
  %i.bgg = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %indvars.iv.next.i155.6
  %i.bgh = load double, ptr %i.bgg, align 8, !tbaa !70
  %i.bgi = fsub double 1.000000e+00, %i.bgh
  %i.bgj = getelementptr inbounds nuw [8 x i8], ptr %i.ave, i64 %indvars.iv.next.i155.6
  store double %i.bgi, ptr %i.bgj, align 8, !tbaa !70
  %indvars.iv.next.i155.7 = add nuw nsw i64 %indvars.iv.i154, 8 ; 2 uses
  %exitcond.not.i156.7 = icmp eq i64 %indvars.iv.next.i155.7, %wide.trip.count449.i
  br i1 %exitcond.not.i156.7, label %._crit_edge364.thread.i, label %.lr.ph363.i, !llvm.loop !290
...
._crit_edge364.i:                                 ; preds = %_ZL26GenerateGibbsProbabilitiesPKfPdS1_ii.exit.i
  ...
  br i1 %i.bgn, label %.loopexit.i159, label %_ZN3gmx23UniformRealDistributionIfEclINS_12ThreeFry2x64ILj0EEEEEfRT_.exit271.i

._crit_edge364.thread.i:                          ; preds = %.lr.ph363.i.prol.loopexit, %.lr.ph363.i, %vec.epilog.middle.block791, %middle.block777
...
.lr.ph367.preheader.i:                            ; preds = %._crit_edge364.thread.i
  ...
  %min.iters.check745 = icmp ult i64 %i.bgt, 8
  br i1 %min.iters.check745, label %.lr.ph367.i.preheader, label %vector.memcheck730

vector.memcheck730:                               ; preds = %.lr.ph367.preheader.i
  %i.bgu = shl nuw nsw i64 %i.ayz, 3              ; 2 uses
  %scevgep731 = getelementptr i8, ptr %i.avc, i64 %i.bgu ; 2 uses
  %i.bgv = shl nuw nsw i64 %wide.trip.count449.i, 3 ; 2 uses
  %scevgep732 = getelementptr i8, ptr %i.avc, i64 %i.bgv ; 2 uses
  %scevgep733 = getelementptr i8, ptr %i.m, i64 %i.bgu
  %scevgep734 = getelementptr i8, ptr %i.m, i64 %i.bgv
  %i.bgw = shl nsw i64 %i.bgo, 3
  %scevgep736 = getelementptr i8, ptr %scevgep735, i64 %i.bgw
  %bound0737 = icmp ult ptr %scevgep731, %scevgep734
  %bound1738 = icmp ult ptr %scevgep733, %scevgep732
  %found.conflict739 = and i1 %bound0737, %bound1738
  %bound0740 = icmp ult ptr %scevgep731, %scevgep736
  %bound1741 = icmp ult ptr %i.bgp, %scevgep732
  %found.conflict742 = and i1 %bound0740, %bound1741
  %conflict.rdx743 = or i1 %found.conflict739, %found.conflict742
  br i1 %conflict.rdx743, label %.lr.ph367.i.preheader, label %vector.ph746

vector.ph746:                                     ; preds = %vector.memcheck730
  %n.vec747 = and i64 %i.bgt, -4                  ; 3 uses
  %i.bgx = add nsw i64 %n.vec747, %i.ayz
  %broadcast.splatinsert748 = insertelement <4 x i64> poison, i64 %i.bgs, i64 0
  %broadcast.splat749 = shufflevector <4 x i64> %broadcast.splatinsert748, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert750 = insertelement <4 x ptr> poison, ptr %i.bgp, i64 0
  %broadcast.splat751 = shufflevector <4 x ptr> %broadcast.splatinsert750, <4 x ptr> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert752 = insertelement <4 x i64> poison, i64 %i.ayz, i64 0
  %broadcast.splat753 = shufflevector <4 x i64> %broadcast.splatinsert752, <4 x i64> poison, <4 x i32> zeroinitializer
  %induction = add nuw nsw <4 x i64> %broadcast.splat753, <i64 0, i64 1, i64 2, i64 3>
  br label %vector.body754

vector.body754:                                   ; preds = %vector.body754, %vector.ph746
  %index755 = phi i64 [ 0, %vector.ph746 ], [ %index.next758, %vector.body754 ] ; 2 uses
  %vec.ind = phi <4 x i64> [ %induction, %vector.ph746 ], [ %vec.ind.next, %vector.body754 ] ; 2 uses
  %i.bgy = add nuw i64 %index755, %i.ayz          ; 2 uses
  %i.bgz = icmp ne <4 x i64> %vec.ind, %broadcast.splat749 ; 3 uses
  ...
  %wide.masked.gather756 = tail call <4 x double> @llvm.masked.gather.v4f64.v4p0(<4 x ptr> align 8 %broadcast.splat751, <4 x i1> %i.bgz, <4 x double> poison), !tbaa !70, !alias.scope !294
  %i.bhb = fdiv <4 x double> %wide.masked.load, %wide.masked.gather756
  %predphi757 = select <4 x i1> %i.bgz, <4 x double> %i.bhb, <4 x double> zeroinitializer
  %i.bhc = getelementptr inbounds nuw [8 x i8], ptr %i.avc, i64 %i.bgy
  store <4 x double> %predphi757, ptr %i.bhc, align 8, !tbaa !70, !alias.scope !296, !noalias !298
  %index.next758 = add nuw i64 %index755, 4       ; 2 uses
  %vec.ind.next = add nuw nsw <4 x i64> %vec.ind, splat (i64 4)
  %i.bhd = icmp eq i64 %index.next758, %n.vec747
  br i1 %i.bhd, label %middle.block759, label %vector.body754, !llvm.loop !299

middle.block759:                                  ; preds = %vector.body754
  %cmp.n760 = icmp eq i64 %i.bgt, %n.vec747
  br i1 %cmp.n760, label %_ZN3gmx23UniformRealDistributionIfEclINS_12ThreeFry2x64ILj0EEEEEfRT_.exit263.i, label %.lr.ph367.i.preheader

.lr.ph367.i.preheader:                            ; preds = %vector.memcheck730, %.lr.ph367.preheader.i, %middle.block759
  %indvars.iv432.i.ph = phi i64 [ %i.ayz, %vector.memcheck730 ], [ %i.ayz, %.lr.ph367.preheader.i ], [ %i.bgx, %middle.block759 ] ; 4 uses
  %i.bhe = sub nsw i64 %wide.trip.count449.i, %indvars.iv432.i.ph
  %i.bhf = zext i32 %.0215.i to i64
  %i.bhg = sub nsw i64 %i.bhf, %indvars.iv432.i.ph
  %xtraiter926 = and i64 %i.bhe, 3                ; 2 uses
  %lcmp.mod927.not = icmp eq i64 %xtraiter926, 0
  br i1 %lcmp.mod927.not, label %.lr.ph367.i.prol.loopexit, label %.lr.ph367.i.prol
...
.lr.ph367.i.prol:                                 ; preds = %.lr.ph367.i.preheader, %bb.by
  ...
  %prol.iter928 = phi i64 [ %prol.iter928.next, %bb.by ], [ 0, %.lr.ph367.i.preheader ]
...
bb.by:                                            ; preds = %bb.bx, %.lr.ph367.i.prol
  ...
  br i1 %prol.iter928.cmp.not, label %.lr.ph367.i.prol.loopexit, label %.lr.ph367.i.prol, !llvm.loop !300
