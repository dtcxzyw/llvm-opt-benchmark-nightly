...
bb.a:
  ...
  %i.et = load double, ptr %i.es, align 8, !tbaa !69 ; 2 uses
  %i.eu = load <3 x double>, ptr %i.v, align 8, !tbaa !69, !noalias !210 ; 5 uses
  ...
  %i.fa = extractelement <3 x double> %i.eu, i64 2
  ...
  %i.nk = load double, ptr %i.nj, align 8, !tbaa !69 ; 2 uses
  %i.nl = shufflevector <3 x double> %i.eu, <3 x double> poison, <2 x i32> <i32 2, i32 0> ; 3 uses
  ...
  %5 = insertelement <2 x double> %i.nl, double %i.ew, i64 1
  ...
  %6 = shufflevector <2 x double> %i.nm, <2 x double> %5, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %7 = shufflevector <2 x double> %i.no, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  ...
  %i.tc = load double, ptr %i.tb, align 8, !tbaa !69 ; 2 uses
  %i.td = insertelement <2 x double> poison, double %i.nk, i64 0
  %i.te = insertelement <2 x double> %i.td, double %i.tc, i64 1
  %9 = shufflevector <3 x double> %i.eu, <3 x double> poison, <2 x i32> <i32 poison, i32 2>
  %10 = insertelement <2 x double> %9, double %i.ew, i64 0
  %11 = insertelement <2 x double> poison, double %i.tc, i64 0
  ...
  %12 = shufflevector <2 x double> %i.nl, <2 x double> %10, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %13 = shufflevector <2 x double> %i.te, <2 x double> %11, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %14 = fmul <4 x double> %12, %13
  %i.tk = fadd <4 x double> %i.ta, %14
