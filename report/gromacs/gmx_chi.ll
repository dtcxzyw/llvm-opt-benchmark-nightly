...
bb.gy:                                            ; preds = %bb.gx
  ...
  %i.bcr = srem <2 x i32> %i.bcq, splat (i32 360) ; 2 uses
  %41 = bitcast <2 x i32> %i.bcr to <4 x i16>
  %.lhs.trunc.i.i = extractelement <4 x i16> %41, i64 0
  %42 = sdiv i16 %.lhs.trunc.i.i, 6
  %43 = bitcast <2 x i32> %i.bcr to <4 x i16>
  %.lhs.trunc3.i.i = extractelement <4 x i16> %43, i64 2
  %44 = sdiv i16 %.lhs.trunc3.i.i, 6
  %i.bcs = sext i16 %42 to i64
  %i.bct = getelementptr inbounds [8 x i8], ptr @_ZZL8bAllowedffE3map, i64 %i.bcs
  %i.bcu = load ptr, ptr %i.bct, align 8, !tbaa !22
  %i.bcv = sext i16 %44 to i64
