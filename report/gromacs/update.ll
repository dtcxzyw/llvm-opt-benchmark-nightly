...
bb.i:                                             ; preds = %.critedge.i
  ...
  store ptr %i.dm, ptr %i.ay, align 8, !tbaa !210, !noalias !702
  store ptr %i.dn, ptr %i.az, align 8, !tbaa !65, !noalias !702
  store ptr %i.ds, ptr %i.ba, align 8, !tbaa !65, !noalias !702
  store ptr %i.ao, ptr %i.bb, align 8, !tbaa !713, !noalias !702
  store ptr %i.du, ptr %i.bc, align 8, !tbaa !65, !noalias !702
  store ptr %i.dz, ptr %i.bd, align 8, !tbaa !65, !noalias !702
  store ptr %i.ea, ptr %i.be, align 8, !tbaa !714, !noalias !702
  store ptr %i.eb, ptr %i.bf, align 8, !tbaa !715, !noalias !702
  store ptr %i.co, ptr %i.bg, align 8, !tbaa !716, !noalias !702
  store ptr %i.cp, ptr %i.bh, align 8, !tbaa !717, !noalias !702
  store ptr %i.cr, ptr %i.bi, align 8, !tbaa !718, !noalias !702
  store ptr %i.cs, ptr %i.bj, align 8, !tbaa !719, !noalias !702
  store ptr %i.ed, ptr %i.bk, align 8, !tbaa !720, !noalias !702
  store i32 %i.cy, ptr %i.bl, align 8, !tbaa !721, !noalias !702
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %i.bm, ptr noundef nonnull align 8 dereferenceable(56) %i.fo, i64 36, i1 false), !tbaa.struct !722, !noalias !702
  store ptr %i.bm, ptr %i.bn, align 8, !tbaa !251, !noalias !702
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.fq = load ptr, ptr %i.fp, align 8, !tbaa !290, !noalias !728
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #20, !noalias !728
...
.noexc:                                           ; preds = %bb.j
  ...
  %i.fs = load ptr, ptr %i.fr, align 8, !tbaa !729, !noalias !728 ; 3 uses
  %i.ft = getelementptr inbounds nuw i8, ptr %i.fs, i64 24
  %i.fu = load double, ptr %i.ft, align 8, !tbaa !732, !noalias !733 ; 2 uses
  %i.fv = load <2 x double>, ptr %i.fs, align 8, !tbaa !252, !noalias !733
  ...
  %i.gb = load double, ptr %i.ga, align 8, !tbaa !252, !noalias !733
...
.lr.ph.i.i.i.i.i.i.i.i:                           ; preds = %.noexc
  ...
  %i.gk = load ptr, ptr %i.bn, align 8, !tbaa !251, !noalias !728 ; 5 uses
  %i.gl = getelementptr i8, ptr %i.gk, i64 16
  %i.gm = getelementptr i8, ptr %i.gk, i64 24
  %i.gn = load float, ptr %i.gm, align 4, !tbaa !179, !noalias !733
  %i.go = getelementptr i8, ptr %i.gk, i64 28
  %i.gp = load float, ptr %i.go, align 4, !tbaa !179, !noalias !733
  %i.gq = getelementptr i8, ptr %i.gk, i64 32
  %i.gr = load float, ptr %i.gq, align 4, !tbaa !179, !noalias !733
  %i.gs = sext i32 %i.cf to i64
  %wide.trip.count.i.i.i.i.i.i.i.i = sext i32 %spec.select.i to i64
  %i.gt = load <4 x float>, ptr %i.gk, align 4, !tbaa !179, !noalias !733 ; 3 uses
  %i.gu = load <2 x float>, ptr %i.gl, align 4, !tbaa !179, !noalias !733
  %i.gv = load <4 x float>, ptr %i.a, align 16, !tbaa !179, !noalias !728 ; 3 uses
  %i.gw = load <4 x float>, ptr %i.bv, align 16   ; 2 uses
  %i.gx = load float, ptr %i.bw, align 8, !tbaa !179, !noalias !728
  %i.gy = load float, ptr %i.bx, align 4, !tbaa !179, !noalias !728
  %i.gz = load float, ptr %i.by, align 16, !tbaa !179, !noalias !728
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.hm = load i16, ptr %i.hl, align 2, !tbaa !241, !noalias !728
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  %i.hr = load float, ptr %i.hq, align 4, !tbaa !353, !noalias !733 ; 2 uses
  ...
  %.sroa.11.0.copyload.i.i.i.i.i.i.i.i = load float, ptr %.sroa.11.0..sroa_idx.i.i.i.i.i.i.i.i, align 4, !tbaa !177, !alias.scope !734, !noalias !735
  ...
  %i.hu = load <2 x float>, ptr %i.hs, align 4, !alias.scope !734, !noalias !735
  %32 = load <2 x float>, ptr %i.ht, align 4, !tbaa !179, !alias.scope !736, !noalias !737 ; 5 uses
  %i.hv = load float, ptr %31, align 4, !tbaa !179, !alias.scope !736, !noalias !737 ; 3 uses
  %i.hw = shufflevector <2 x float> %32, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.hx = fmul <2 x float> %i.hc, %i.hw
  %i.hy = shufflevector <2 x float> %32, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.id = extractelement <2 x float> %32, i64 1
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.ij = load double, ptr %i.ii, align 8, !tbaa !252, !alias.scope !738, !noalias !739
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  %i.jf = load <2 x float>, ptr %i.iu, align 4, !tbaa !179, !alias.scope !740, !noalias !741
  %i.jg = load <2 x float>, ptr %i.iv, align 4, !tbaa !179, !noalias !728
  ...
  store <2 x float> %i.jt, ptr %i.hs, align 4, !tbaa !179, !alias.scope !734, !noalias !735
  %i.ju = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.jt, <2 x float> %i.he, <2 x float> %32)
  store <2 x float> %i.ju, ptr %i.ix, align 4, !tbaa !179, !alias.scope !742, !noalias !743
  %i.jv = getelementptr inbounds nuw i8, ptr %i.iu, i64 8
  %i.jw = load float, ptr %i.jv, align 4, !tbaa !179, !alias.scope !740, !noalias !741
  %i.jx = getelementptr inbounds nuw i8, ptr %i.iv, i64 8
  %i.jy = load float, ptr %i.jx, align 4, !tbaa !179, !noalias !728
  ...
  store float %i.kg, ptr %.sroa.11.0..sroa_idx.i.i.i.i.i.i.i.i, align 4, !tbaa !179, !alias.scope !734, !noalias !735
  %i.kh = call float @llvm.fmuladd.f32(float %i.kg, float %i.cu, float %i.hv)
  %i.ki = getelementptr inbounds nuw i8, ptr %i.ix, i64 8
  store float %i.kh, ptr %i.ki, align 4, !tbaa !179, !alias.scope !742, !noalias !743
...
"_ZZZN3gmx25dispatchTemplatedFunctionIZL12do_update_mdiiflPKNS_11BasicVectorIfEEPS2_S5_S4_19TemperatureCoupling16PressureCouplingiiNS_8ArrayRefIKtEE16AccelerationTypeSA_NS8_IS3_EEPA3_KfNS8_ISD_EESC_PK14gmx_ekindata_tSF_PKdRKNS_14BasicMatrix3x3IfEEbE3$_0SB_JEEEDaOT_T0_DpT1_ENKUlDpT_E_clIJEEEDaSX_ENKUlSR_E_clISt17integral_constantImLm3EEEEDaSR_.exit.i.i.i.i.i": ; preds = %bb.o, %.noexc
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #20, !noalias !728
...
bb.p:                                             ; preds = %bb.i
  ...
  %.val1.i.i.i.i.i.i.i.i = load float, ptr %i.kj, align 4, !tbaa !179, !noalias !702
  ...
  %i.kl = load ptr, ptr %i.kk, align 8, !tbaa !290, !noalias !749
...
.lr.ph.i.i.i.i.i.i.i.i.i:                         ; preds = %bb.p
  ...
  %i.kr = load float, ptr %i.kq, align 8, !tbaa !750, !noalias !749
  ...
  %i.kw = load float, ptr %i.bm, align 8, !tbaa !179, !noalias !749
  %i.kx = load float, ptr %i.bo, align 4, !tbaa !179, !noalias !749
  %i.ky = load float, ptr %i.bp, align 8, !tbaa !179, !noalias !749
  %i.kz = load <4 x float>, ptr %i.bq, align 4, !tbaa !179, !noalias !749 ; 3 uses
  ...
  %i.lc = load float, ptr %i.kp, align 8, !tbaa !751, !noalias !749
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.ll = load i16, ptr %i.lk, align 2, !tbaa !241, !noalias !749
...
bb.s:                                             ; preds = %bb.r, %bb.q
  ...
  %i.lq = load float, ptr %i.lp, align 4, !tbaa !353, !noalias !752 ; 2 uses
  %i.lr = getelementptr inbounds [12 x i8], ptr %i.cr, i64 %indvars.iv.i.i.i.i.i.i.i.i.i ; 3 uses
  %.sroa.010.0.copyload.i.i.i.i.i.i.i.i.i = load float, ptr %i.lr, align 4, !alias.scope !753, !noalias !754
  %.sroa.6.0..sroa_idx.i.i.i.i.i.i.i.i.i = getelementptr inbounds nuw i8, ptr %i.lr, i64 4 ; 2 uses
  %i.ls = load <2 x float>, ptr %.sroa.6.0..sroa_idx.i.i.i.i.i.i.i.i.i, align 4, !alias.scope !753, !noalias !754 ; 6 uses
  ...
  %i.lv = load float, ptr %i.lu, align 4, !tbaa !179, !alias.scope !755, !noalias !756 ; 2 uses
  %i.lw = fmul float %i.km, %i.lv
  %i.lx = call noundef float @cosf(float noundef %i.lw) #20, !noalias !752 ; 2 uses
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.mb = load double, ptr %i.ma, align 8, !tbaa !252, !alias.scope !757, !noalias !758
...
bb.u:                                             ; preds = %bb.t, %bb.s
  ...
  %i.ml = load float, ptr %i.mh, align 4, !tbaa !179, !alias.scope !759, !noalias !760
  %i.mm = load float, ptr %i.mi, align 4, !tbaa !179, !noalias !749
  ...
  store float %i.nc, ptr %i.lr, align 4, !tbaa !179, !alias.scope !753, !noalias !754
  ...
  %i.nl = load <2 x float>, ptr %i.nd, align 4, !tbaa !179, !alias.scope !759, !noalias !760
  %i.nm = load <2 x float>, ptr %i.ne, align 4, !tbaa !179, !noalias !749
  ...
  %i.nz = load <2 x float>, ptr %i.lt, align 4, !tbaa !179, !alias.scope !755, !noalias !756
  ...
  store <2 x float> %i.oc, ptr %i.mk, align 4, !tbaa !179, !alias.scope !761, !noalias !762
  store <2 x float> %i.ny, ptr %.sroa.6.0..sroa_idx.i.i.i.i.i.i.i.i.i, align 4, !tbaa !179, !alias.scope !753, !noalias !754
  ...
  store float %i.oe, ptr %i.of, align 4, !tbaa !179, !alias.scope !761, !noalias !762
...
.lr.ph.i.i.i.i.i.i.i.i.i.i:                       ; preds = %bb.v
  ...
  %i.oo = load <4 x float>, ptr %i.bm, align 8, !tbaa !179, !noalias !769 ; 3 uses
  %i.op = load <4 x float>, ptr %i.br, align 8    ; 2 uses
  %i.oq = load float, ptr %i.bs, align 8, !tbaa !179, !noalias !769
  %i.or = load float, ptr %i.bt, align 4, !tbaa !179, !noalias !769
  %i.os = load float, ptr %i.bu, align 8, !tbaa !179, !noalias !769
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.pc = load i16, ptr %i.pb, align 2, !tbaa !241, !noalias !769
