...
scalar.ph856:                                     ; preds = %scalar.ph856.preheader, %scalar.ph856
  ...
  %34 = load <3 x double>, ptr %i.abw, align 8, !tbaa !97, !noalias !470 ; 5 uses
  %i.aby = load double, ptr %i.abw, align 8, !tbaa !99, !noalias !470
  %35 = shufflevector <3 x double> %34, <3 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.abz = fmul <2 x double> %i.abt, %35
  %i.aca = shufflevector <3 x double> %34, <3 x double> poison, <2 x i32> zeroinitializer
  %i.acb = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.abv, <2 x double> %i.aca, <2 x double> %i.abz)
  %36 = shufflevector <3 x double> %34, <3 x double> poison, <2 x i32> <i32 2, i32 2>
  %37 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.zy, <2 x double> %36, <2 x double> %i.acb)
  %38 = extractelement <3 x double> %34, i64 1
  %i.acc = fmul double %i.aah, %38
  %i.acd = call double @llvm.fmuladd.f64(double %i.aaf, double %i.aby, double %i.acc)
  %39 = extractelement <3 x double> %34, i64 2
  %i.ace = call double @llvm.fmuladd.f64(double %i.zk, double %39, double %i.acd)
  store <2 x double> %37, ptr %i.abw, align 8, !tbaa !97
