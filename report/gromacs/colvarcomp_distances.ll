...
bb.a:
  ...
  %i.cd = load double, ptr %i.cc, align 8, !tbaa !95 ; 2 uses
  ...
  %i.hj = load double, ptr %i.hi, align 8, !tbaa !95 ; 2 uses
  %i.hk = shufflevector <3 x double> %i.ce, <3 x double> poison, <2 x i32> <i32 2, i32 0> ; 3 uses
  ...
  %5 = insertelement <2 x double> %i.hk, double %i.cg, i64 1
  ...
  %6 = shufflevector <2 x double> %i.hl, <2 x double> %5, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %7 = shufflevector <2 x double> %i.hn, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  ...
  %i.nb = load double, ptr %i.na, align 8, !tbaa !95 ; 2 uses
  %i.nc = insertelement <2 x double> poison, double %i.hj, i64 0
  %i.nd = insertelement <2 x double> %i.nc, double %i.nb, i64 1
  %9 = shufflevector <3 x double> %i.ce, <3 x double> poison, <2 x i32> <i32 poison, i32 2>
  %10 = insertelement <2 x double> %9, double %i.cg, i64 0
  ...
  %12 = shufflevector <2 x double> %i.hk, <2 x double> %10, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %13 = shufflevector <2 x double> %i.nd, <2 x double> %11, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %14 = fmul <4 x double> %12, %13
  %i.nj = fadd <4 x double> %i.mz, %14
