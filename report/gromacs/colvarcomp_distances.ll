...
vector.ph858:                                     ; preds = %.lr.ph547
  ...
  %34 = shufflevector <2 x double> %broadcast.splatinsert862, <2 x double> %broadcast.splatinsert868, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %35 = shufflevector <2 x double> %i.zy, <2 x double> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 1>
...
vector.body878:                                   ; preds = %vector.body878, %vector.ph858
  ...
  %36 = shufflevector <2 x double> %i.aas, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  ...
  %37 = shufflevector <2 x double> %i.abe, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %38 = shufflevector <2 x double> %i.aay, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %39 = fmul <4 x double> %i.aal, %38
  %40 = call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %34, <4 x double> %36, <4 x double> %39)
  %41 = fmul <2 x double> %broadcast.splat873, %i.aay
  %42 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat875, <2 x double> %i.aas, <2 x double> %41)
  %43 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat877, <2 x double> %i.abe, <2 x double> %42)
  %i.abf = call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %35, <4 x double> %37, <4 x double> %40)
  %i.abg = shufflevector <2 x double> %43, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
