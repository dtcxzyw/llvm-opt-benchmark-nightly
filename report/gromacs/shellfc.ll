...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.et = getelementptr inbounds nuw [4 x i8], ptr %i.ej, i64 %index
  ...
  %wide.load = load <8 x float>, ptr %i.et, align 4, !tbaa !84, !alias.scope !567 ; 3 uses
  ...
  %i.fl = fmul <8 x float> %strided.vec77, %wide.load
