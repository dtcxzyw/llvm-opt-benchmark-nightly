...
scalar.ph.prol:                                   ; preds = %scalar.ph.prol, %scalar.ph.prol.preheader
  ...
  %i.ir = trunc nsw i64 %indvars.iv19.prol to i32
  %i.is = trunc nsw i64 %indvars.iv.next20.prol to i32
  %i.it = insertelement <2 x i32> poison, i32 %i.ir, i64 0
  %i.iu = insertelement <2 x i32> %i.it, i32 %i.is, i64 1
...
scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader.new
  ...
  %i.jn = trunc nsw i64 %indvars.iv19 to i32
  %i.jo = trunc nsw i64 %indvars.iv.next20 to i32
  %i.jp = insertelement <2 x i32> poison, i32 %i.jn, i64 0
  %i.jq = insertelement <2 x i32> %i.jp, i32 %i.jo, i64 1
  ...
  %i.jw = trunc nsw i64 %indvars.iv.next20 to i32
  %i.jx = trunc nsw i64 %indvars.iv.next20.1 to i32
  %i.jy = insertelement <2 x i32> poison, i32 %i.jw, i64 0
  %i.jz = insertelement <2 x i32> %i.jy, i32 %i.jx, i64 1
  ...
  %i.kf = trunc nsw i64 %indvars.iv.next20.1 to i32
  %i.kg = trunc nsw i64 %indvars.iv.next20.2 to i32
  %i.kh = insertelement <2 x i32> poison, i32 %i.kf, i64 0
  %i.ki = insertelement <2 x i32> %i.kh, i32 %i.kg, i64 1
  ...
  %i.ko = trunc nsw i64 %indvars.iv.next20.2 to i32
  %i.kp = trunc nsw i64 %indvars.iv.next20.3 to i32
  %i.kq = insertelement <2 x i32> poison, i32 %i.ko, i64 0
  %i.kr = insertelement <2 x i32> %i.kq, i32 %i.kp, i64 1
