...
.thread:                                          ; preds = %bb.a, %bb.b
  ...
  %..i = select i1 %i.bt, ptr %i.av, ptr %i.ap
  %.val1139 = load float, ptr %..i, align 8, !tbaa !48 ; 2 uses
  %i.bu = fmul float %.val1139, %.val1139
...
_ZL7usingRFRK22CoulombInteractionType.exit:       ; preds = %bb.b, %bb.a
  ...
  %..i = select i1 %i.bp, ptr %i.ar, ptr %i.al
  %.val1011 = load float, ptr %..i, align 8, !tbaa !48 ; 2 uses
  %i.bq = fmul float %.val1011, %.val1011
...
.thread:                                          ; preds = %bb.a, %bb.b
  ...
  %i.bt = fcmp olt float %i.aq, %i.aw
  %..i = select i1 %i.bt, ptr %i.av, ptr %i.ap
  %.val1127 = load float, ptr %..i, align 8, !tbaa !48 ; 2 uses
  %i.bu = fmul float %.val1127, %.val1127
  %i.bv = fsub <2 x float> splat (float 1.000000e+00), %i.r ; 7 uses
...
_ZL7usingRFRK22CoulombInteractionType.exit:       ; preds = %bb.b, %bb.a
  ...
  %i.bp = fcmp olt float %i.am, %i.as
  %..i = select i1 %i.bp, ptr %i.ar, ptr %i.al
  %.val999 = load float, ptr %..i, align 8, !tbaa !48 ; 2 uses
  %i.bq = fmul float %.val999, %.val999
  %i.br = fsub <2 x float> splat (float 1.000000e+00), %i.r ; 7 uses
