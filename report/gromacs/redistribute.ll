...
._crit_edge621:                                   ; preds = %bb.eu, %.preheader483
  %.1282.lcssa = phi i32 [ %.0281623, %.preheader483 ], [ %.2283, %bb.eu ] ; 2 uses
...
bb.dc:                                            ; preds = %.lr.ph620, %bb.eu
  %i.ads = phi i64 [ %.pre-phi762, %.lr.ph620 ], [ %i.ash, %bb.eu ]
  %i.adt = phi i64 [ %.pre-phi764, %.lr.ph620 ], [ %i.asi, %bb.eu ]
  %indvars.iv706 = phi i64 [ 0, %.lr.ph620 ], [ %indvars.iv.next707, %bb.eu ] ; 3 uses
  %.0250618 = phi i32 [ 0, %.lr.ph620 ], [ %.3253, %bb.eu ] ; 4 uses
  %.1282617 = phi i32 [ %.0281623, %.lr.ph620 ], [ %.2283, %bb.eu ] ; 3 uses
...
bb.dm:                                            ; preds = %.lr.ph614, %bb.dw
  ...
  %.0246612 = phi i32 [ %i.ady, %.lr.ph614 ], [ %.3, %bb.dw ] ; 6 uses
...
bb.do:                                            ; preds = %bb.dn
  ...
  br i1 %.not302, label %bb.dp, label %bb.dt
...
bb.dq:                                            ; preds = %bb.dp
  ...
  br i1 %.not303, label %._crit_edge766, label %bb.dt
...
.lr.ph609.preheader:                              ; preds = %.preheader
  ...
  %xtraiter1194 = and i64 %i.agq, 7               ; 2 uses
  %lcmp.mod1195.not = icmp eq i64 %xtraiter1194, 0
  br i1 %lcmp.mod1195.not, label %.lr.ph609.prol.loopexit, label %.lr.ph609.prol
...
.lr.ph609.prol:                                   ; preds = %.lr.ph609.preheader, %.lr.ph609.prol
  ...
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter1194
...
.loopexit:                                        ; preds = %.lr.ph609.prol.loopexit, %.lr.ph609, %.preheader, %._crit_edge766
  ...
  br i1 %brmerge, label %bb.dr, label %bb.ds

bb.dr:                                            ; preds = %.loopexit
  %i.aig = getelementptr inbounds [4 x i8], ptr %i.k, i64 %i.afs
  %i.aih = load float, ptr %i.aig, align 4, !tbaa !168
  %i.aii = fcmp olt float %.1, %i.aih
  %spec.select477 = select i1 %i.aii, i32 %i.agg, i32 0
  br label %bb.ds

bb.ds:                                            ; preds = %.loopexit, %bb.dr
  %.pn = phi i32 [ %spec.select477, %bb.dr ], [ %i.agh, %.loopexit ]
  %.1247 = or i32 %i.agk, %.pn                    ; 2 uses
  store i32 %.1247, ptr %i.adx, align 4, !tbaa !169
  br label %bb.dt

bb.dt:                                            ; preds = %._crit_edge765, %bb.do, %bb.dq, %bb.ds
  %.pre-phi783 = phi i32 [ %.pre782, %._crit_edge765 ], [ %i.afz, %bb.do ], [ %i.agd, %bb.dq ], [ %i.agd, %bb.ds ] ; 4 uses
  %.3 = phi i32 [ %.0246612, %._crit_edge765 ], [ %.0246612, %bb.do ], [ %.0246612, %bb.dq ], [ %.1247, %bb.ds ] ; 3 uses
  %i.aij = shl nuw i32 65536, %.pre-phi783
  %i.aik = and i32 %.3, %i.aij
  %.not307 = icmp eq i32 %i.aik, 0
  br i1 %.not307, label %bb.du, label %._crit_edge615.thread874

bb.du:                                            ; preds = %bb.dt
  %i.ail = shl nuw i32 131072, %.pre-phi783
  %i.aim = and i32 %.3, %i.ail
  %.not308 = icmp eq i32 %i.aim, 0
  br i1 %.not308, label %bb.dw, label %bb.dv

bb.dv:                                            ; preds = %bb.du
  %i.ain = getelementptr inbounds nuw [4 x i8], ptr %i.afm, i64 %indvars.iv703
  %i.aio = load i32, ptr %i.ain, align 4, !tbaa !169
  %i.aip = sext i32 %i.aio to i64
  %i.aiq = getelementptr inbounds nuw [4 x i8], ptr %i.afo, i64 %i.aip
  %i.air = load i32, ptr %i.aiq, align 4, !tbaa !169
  %i.ais = icmp sgt i32 %i.air, 2
  %i.ait = zext i1 %i.ais to i32
  %spec.select478 = or disjoint i32 %.pre-phi783, %i.ait
  br label %bb.dw

bb.dw:                                            ; preds = %bb.dv, %bb.du
  %.1245 = phi i32 [ -1, %bb.du ], [ %spec.select478, %bb.dv ] ; 3 uses
  %indvars.iv.next704 = add nuw nsw i64 %indvars.iv703, 1 ; 2 uses
  %i.aiu = load i32, ptr %i.afb, align 8, !tbaa !259
  %i.aiv = trunc nuw i64 %indvars.iv.next704 to i32
  %i.aiw = icmp sgt i32 %i.aiu, %i.aiv
  %i.aix = icmp eq i32 %.1245, -1
  %i.aiy = select i1 %i.aiw, i1 %i.aix, i1 false
  br i1 %i.aiy, label %bb.dm, label %._crit_edge615, !llvm.loop !326

._crit_edge615:                                   ; preds = %bb.dw
  %i.aiz = icmp eq i32 %.1245, -1
  br i1 %i.aiz, label %.thread475, label %._crit_edge615.thread874

.thread475:                                       ; preds = %bb.dl, %._crit_edge615
  %i.aja = getelementptr inbounds nuw [4 x i8], ptr %i.aaj, i64 %i.adu
  %i.ajb = load i32, ptr %i.aja, align 4, !tbaa !169 ; 4 uses
  %i.ajc = getelementptr inbounds nuw i8, ptr %.pre740, i64 896 ; 2 uses
  %i.ajd = getelementptr inbounds nuw i8, ptr %.pre740, i64 904 ; 3 uses
  %i.aje = load ptr, ptr %i.ajd, align 8, !tbaa !163 ; 6 uses
  %i.ajf = getelementptr inbounds nuw i8, ptr %.pre740, i64 912 ; 3 uses
  %i.ajg = load ptr, ptr %i.ajf, align 8, !tbaa !305
  %.not.i385 = icmp eq ptr %i.aje, %i.ajg
  br i1 %.not.i385, label %bb.dy, label %bb.dx

bb.dx:                                            ; preds = %.thread475
  store i32 %i.ajb, ptr %i.aje, align 4, !tbaa !169
  %i.ajh = getelementptr inbounds nuw i8, ptr %i.aje, i64 4
  store ptr %i.ajh, ptr %i.ajd, align 8, !tbaa !163
  br label %_ZNSt6vectorIiN3gmx30DefaultInitializationAllocatorIiSaIiEEEE9push_backERKi.exit.preheader

bb.dy:                                            ; preds = %.thread475
  %i.aji = load ptr, ptr %i.ajc, align 8, !tbaa !164 ; 9 uses
  %i.ajj = ptrtoint ptr %i.aje to i64             ; 2 uses
  %i.ajk = ptrtoint ptr %i.aji to i64             ; 4 uses
  %i.ajl = sub i64 %i.ajj, %i.ajk                 ; 3 uses
  %i.ajm = icmp eq i64 %i.ajl, 9223372036854775804
  br i1 %i.ajm, label %bb.dz, label %_ZNKSt6vectorIiN3gmx30DefaultInitializationAllocatorIiSaIiEEEE12_M_check_lenEmPKc.exit.i.i

bb.dz:                                            ; preds = %bb.dy
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.35) #21
          to label %.noexc388 unwind label %.loopexit.split-lp491

.noexc388:                                        ; preds = %bb.dz
  unreachable

end_hunk_0
begin_hunk_1_@_Z18dd_redistribute_cgP8_IO_FILElP12gmx_domdec_tPiP7t_stateP10t_forcerecP6t_nrnb:bb.a
  %.pn322.pn.pn.pn = phi { ptr, i32 } [ %.pn322.pn.pn, %bb.ff ], [ %i.gj, %bb.y ]
