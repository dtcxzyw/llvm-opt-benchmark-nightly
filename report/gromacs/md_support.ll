...
.preheader66:                                     ; preds = %bb.e, %bb.d
  ...
  %i.bx = getelementptr inbounds [12 x i8], ptr %i.bw, i64 %indvars.iv90 ; 3 uses
  %9 = load float, ptr %i.bx, align 4, !tbaa !276
  %10 = getelementptr inbounds nuw i8, ptr %i.bx, i64 4
  %11 = load float, ptr %10, align 4, !tbaa !276
  %12 = getelementptr inbounds nuw i8, ptr %i.bx, i64 8
  %13 = load float, ptr %12, align 4, !tbaa !276
  ...
  %14 = load <8 x float>, ptr %8, align 4, !tbaa !276 ; 2 uses
  %15 = insertelement <3 x float> poison, float %11, i64 0
  %16 = shufflevector <3 x float> %15, <3 x float> poison, <3 x i32> zeroinitializer
  %i.cc = shufflevector <8 x float> %14, <8 x float> poison, <3 x i32> <i32 1, i32 4, i32 7>
  %i.cd = fmul <3 x float> %16, %i.cc
  %17 = insertelement <3 x float> poison, float %9, i64 0
  %i.ce = shufflevector <3 x float> %17, <3 x float> poison, <3 x i32> zeroinitializer
  %i.cf = shufflevector <8 x float> %14, <8 x float> poison, <3 x i32> <i32 0, i32 3, i32 6>
  ...
  %18 = insertelement <3 x float> poison, float %13, i64 0
  %19 = shufflevector <3 x float> %18, <3 x float> poison, <3 x i32> zeroinitializer
  %i.cj = call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %19, <3 x float> %i.ci, <3 x float> %i.cg)
