...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi198 = phi <8 x i32> [ splat (i32 1), %vector.ph ], [ %predphi214.a, %vector.body ]
  %vec.phi199 = phi <8 x i32> [ splat (i32 1), %vector.ph ], [ %predphi214, %vector.body ]
  ...
  %7 = call <8 x i32> @llvm.masked.load.v8i32.p0(ptr align 8 %i.bw, <8 x i1> %i.bs, <8 x i32> splat (i32 1)), !tbaa !120
  %i.ca = call <8 x i32> @llvm.masked.load.v8i32.p0(ptr align 8 %i.bx, <8 x i1> %i.bt, <8 x i32> splat (i32 1)), !tbaa !120
  ...
  %predphi214.a = mul <8 x i32> %vec.phi198, %7   ; 2 uses
  %predphi214 = mul <8 x i32> %vec.phi199, %i.ca  ; 2 uses
...
middle.block:                                     ; preds = %vector.body
  %bin.rdx = mul <8 x i32> %predphi214.a, %predphi
  %bin.rdx216 = mul <8 x i32> %predphi214, %bin.rdx
