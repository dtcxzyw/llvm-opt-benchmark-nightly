...
begin_hunk_0_@_Z11gmx_analyzeiPPc:bb.a
  %i.qu = load i32, ptr %i.y, align 4, !tbaa !132 ; 4 uses
  %i.qv = load float, ptr %i.aa, align 4, !tbaa !17 ; 2 uses
...
.noexc206:                                        ; preds = %bb.bm
  store double 1.000000e+00, ptr %i.rb, align 8, !tbaa !34
...
.lr.ph.i203:                                      ; preds = %.noexc206
  ...
  %xtraiter1157 = and i64 %i.rf, 3                ; 3 uses
  %i.rg = icmp ult i32 %i.qy, 4
  br i1 %i.rg, label %.epil.preheader1156, label %.lr.ph.i203.new

.lr.ph.i203.new:                                  ; preds = %.lr.ph.i203
  %unroll_iter1162 = and i64 %i.rf, -4
  br label %bb.bo

.preheader73.i:                                   ; preds = %.noexc206
  %.not6677.i = icmp slt i32 %i.qy, 0
  br i1 %.not6677.i, label %._crit_edge.i, label %iter.check932

iter.check932.loopexit.unr-lcssa:                 ; preds = %bb.bo
  %lcmp.mod1159.not = icmp eq i64 %xtraiter1157, 0
  br i1 %lcmp.mod1159.not, label %iter.check932, label %.epil.preheader1156

.epil.preheader1156:                              ; preds = %iter.check932.loopexit.unr-lcssa, %.lr.ph.i203
  %indvars.iv.i.epil.init = phi i64 [ 1, %.lr.ph.i203 ], [ %indvars.iv.next.i.3, %iter.check932.loopexit.unr-lcssa ]
  %.06076.i.epil.init = phi double [ 1.000000e+00, %.lr.ph.i203 ], [ %i.tc, %iter.check932.loopexit.unr-lcssa ]
  %lcmp.mod1161 = icmp ne i64 %xtraiter1157, 0
  call void @llvm.assume(i1 %lcmp.mod1161)
  br label %bb.bn

bb.bn:                                            ; preds = %bb.bn, %.epil.preheader1156
  %indvars.iv.i.epil = phi i64 [ %indvars.iv.i.epil.init, %.epil.preheader1156 ], [ %indvars.iv.next.i.epil, %bb.bn ] ; 3 uses
  %.06076.i.epil = phi double [ %.06076.i.epil.init, %.epil.preheader1156 ], [ %i.rn, %bb.bn ]
  %epil.iter1158 = phi i64 [ 0, %.epil.preheader1156 ], [ %epil.iter1158.next, %bb.bn ]
  ...
  store double %i.rl, ptr %i.rm, align 8, !tbaa !34
  ...
  br i1 %epil.iter1158.cmp.not, label %iter.check932, label %bb.bn, !llvm.loop !59

iter.check932:                                    ; preds = %iter.check932.loopexit.unr-lcssa, %bb.bn, %.preheader73.i
  %wide.trip.count114.i.pre-phi = phi i64 [ 1, %.preheader73.i ], [ %wide.trip.count.i, %bb.bn ], [ %wide.trip.count.i, %iter.check932.loopexit.unr-lcssa ] ; 8 uses
  %.060.lcssa146.i = phi double [ 1.000000e+00, %.preheader73.i ], [ %i.tc, %iter.check932.loopexit.unr-lcssa ], [ %i.rn, %bb.bn ] ; 3 uses
  %min.iters.check915 = icmp samesign ult i64 %wide.trip.count114.i.pre-phi, 4
  br i1 %min.iters.check915, label %.lr.ph79.i.preheader, label %vector.main.loop.iter.check916

vector.main.loop.iter.check916:                   ; preds = %iter.check932
  %min.iters.check917 = icmp samesign ult i64 %wide.trip.count114.i.pre-phi, 16
  br i1 %min.iters.check917, label %vec.epilog.ph936, label %vector.ph918

vector.ph918:                                     ; preds = %vector.main.loop.iter.check916
  %i.ro = and i64 %wide.trip.count114.i.pre-phi, 12
  %n.vec919 = and i64 %wide.trip.count114.i.pre-phi, 4294967280 ; 4 uses
  %broadcast.splatinsert920 = insertelement <4 x double> poison, double %.060.lcssa146.i, i64 0
  %broadcast.splat921 = shufflevector <4 x double> %broadcast.splatinsert920, <4 x double> poison, <4 x i32> zeroinitializer ; 4 uses
  br label %vector.body922

vector.body922:                                   ; preds = %vector.body922, %vector.ph918
  %index923 = phi i64 [ 0, %vector.ph918 ], [ %index.next928, %vector.body922 ] ; 2 uses
  %i.rp = getelementptr inbounds nuw [8 x i8], ptr %i.rb, i64 %index923 ; 5 uses
  ...
  %wide.load924 = load <4 x double>, ptr %i.rp, align 8, !tbaa !34
  %wide.load925 = load <4 x double>, ptr %i.rq, align 8, !tbaa !34
  %wide.load926 = load <4 x double>, ptr %i.rr, align 8, !tbaa !34
  %wide.load927 = load <4 x double>, ptr %i.rs, align 8, !tbaa !34
  %i.rt = fdiv <4 x double> %wide.load924, %broadcast.splat921
  %i.ru = fdiv <4 x double> %wide.load925, %broadcast.splat921
  %i.rv = fdiv <4 x double> %wide.load926, %broadcast.splat921
  %i.rw = fdiv <4 x double> %wide.load927, %broadcast.splat921
  store <4 x double> %i.rt, ptr %i.rp, align 8, !tbaa !34
  store <4 x double> %i.ru, ptr %i.rq, align 8, !tbaa !34
  store <4 x double> %i.rv, ptr %i.rr, align 8, !tbaa !34
  store <4 x double> %i.rw, ptr %i.rs, align 8, !tbaa !34
  %index.next928 = add nuw i64 %index923, 16      ; 2 uses
  %i.rx = icmp eq i64 %index.next928, %n.vec919
  br i1 %i.rx, label %middle.block929, label %vector.body922, !llvm.loop !60

middle.block929:                                  ; preds = %vector.body922
  %cmp.n930 = icmp eq i64 %wide.trip.count114.i.pre-phi, %n.vec919
  br i1 %cmp.n930, label %._crit_edge.i, label %vec.epilog.iter.check934

vec.epilog.iter.check934:                         ; preds = %middle.block929
  %min.epilog.iters.check935 = icmp eq i64 %i.ro, 0
  br i1 %min.epilog.iters.check935, label %.lr.ph79.i.preheader, label %vec.epilog.ph936, !prof !35

vec.epilog.ph936:                                 ; preds = %vector.main.loop.iter.check916, %vec.epilog.iter.check934
  %vec.epilog.resume.val931 = phi i64 [ %n.vec919, %vec.epilog.iter.check934 ], [ 0, %vector.main.loop.iter.check916 ]
  %n.vec937 = and i64 %wide.trip.count114.i.pre-phi, 4294967292 ; 3 uses
  %broadcast.splatinsert938 = insertelement <4 x double> poison, double %.060.lcssa146.i, i64 0
  %broadcast.splat939 = shufflevector <4 x double> %broadcast.splatinsert938, <4 x double> poison, <4 x i32> zeroinitializer
  br label %vec.epilog.vector.body940

vec.epilog.vector.body940:                        ; preds = %vec.epilog.vector.body940, %vec.epilog.ph936
  %index941 = phi i64 [ %vec.epilog.resume.val931, %vec.epilog.ph936 ], [ %index.next943, %vec.epilog.vector.body940 ] ; 2 uses
  %i.ry = getelementptr inbounds nuw [8 x i8], ptr %i.rb, i64 %index941 ; 2 uses
  %wide.load942 = load <4 x double>, ptr %i.ry, align 8, !tbaa !34
  %i.rz = fdiv <4 x double> %wide.load942, %broadcast.splat939
  store <4 x double> %i.rz, ptr %i.ry, align 8, !tbaa !34
  %index.next943 = add nuw i64 %index941, 4       ; 2 uses
  %i.sa = icmp eq i64 %index.next943, %n.vec937
  br i1 %i.sa, label %vec.epilog.middle.block944, label %vec.epilog.vector.body940, !llvm.loop !61

vec.epilog.middle.block944:                       ; preds = %vec.epilog.vector.body940
  %cmp.n945 = icmp eq i64 %wide.trip.count114.i.pre-phi, %n.vec937
  br i1 %cmp.n945, label %._crit_edge.i, label %.lr.ph79.i.preheader

.lr.ph79.i.preheader:                             ; preds = %iter.check932, %vec.epilog.iter.check934, %vec.epilog.middle.block944
  %indvars.iv111.i.ph = phi i64 [ 0, %iter.check932 ], [ %n.vec919, %vec.epilog.iter.check934 ], [ %n.vec937, %vec.epilog.middle.block944 ]
  br label %.lr.ph79.i
...
bb.bo:                                            ; preds = %bb.bo, %.lr.ph.i203.new
  ...
  %niter1163 = phi i64 [ 0, %.lr.ph.i203.new ], [ %niter1163.next.3, %bb.bo ]
  ...
  store double %i.sf, ptr %i.sg, align 8, !tbaa !34
  ...
  store double %i.sm, ptr %i.sn, align 8, !tbaa !34
  ...
  store double %i.st, ptr %i.su, align 8, !tbaa !34
  ...
  store double %i.ta, ptr %i.tb, align 8, !tbaa !34
  %i.tc = call double @llvm.fmuladd.f64(double %i.ta, double 2.000000e+00, double %i.sv) ; 3 uses
  %indvars.iv.next.i.3 = add nuw nsw i64 %indvars.iv.i, 4 ; 2 uses
  %niter1163.next.3 = add i64 %niter1163, 4       ; 2 uses
  %niter1163.ncmp.3 = icmp eq i64 %niter1163.next.3, %unroll_iter1162
  br i1 %niter1163.ncmp.3, label %iter.check932.loopexit.unr-lcssa, label %bb.bo, !llvm.loop !62
...
.lr.ph79.i:                                       ; preds = %.lr.ph79.i.preheader, %.lr.ph79.i
  ...
  %i.te = load double, ptr %i.td, align 8, !tbaa !34
  %i.tf = fdiv double %i.te, %.060.lcssa146.i
  store double %i.tf, ptr %i.td, align 8, !tbaa !34
  ...
  br i1 %exitcond115.not.i, label %._crit_edge.i, label %.lr.ph79.i, !llvm.loop !63

._crit_edge.i:                                    ; preds = %.lr.ph79.i, %middle.block929, %vec.epilog.middle.block944, %.preheader73.i
  %i.tg = load ptr, ptr @stdout, align 8, !tbaa !156
  ...
  %i.tk = load ptr, ptr @stdout, align 8, !tbaa !156
...
.preheader.us.preheader.i:                        ; preds = %.preheader.lr.ph.split.us.i
  ...
  %xtraiter1165 = and i64 %i.tt, 7                ; 3 uses
  %i.tu = icmp ult i32 %i.qy, 8
  %unroll_iter1170 = and i64 %i.tt, -8
...
.preheader.us.us.preheader.i:                     ; preds = %.preheader.lr.ph.split.us.i
  ...
  %xtraiter1172 = and i64 %i.ty, 3                ; 2 uses
  %lcmp.mod1173.not = icmp eq i64 %xtraiter1172, 0
...
.preheader.us.us.i:                               ; preds = %._crit_edge90.split.us.us.us.i, %.preheader.us.us.preheader.i
  ...
  %i.ub = load double, ptr %i.rb, align 8, !tbaa !34 ; 5 uses
  %i.uc = getelementptr inbounds nuw [8 x i8], ptr %i.cw, i64 %indvars.iv137.i
  %i.ud = load ptr, ptr %i.uc, align 8, !tbaa !25 ; 5 uses
  br i1 %lcmp.mod1173.not, label %.prol.loopexit, label %.prol.preheader
...
.prol.preheader:                                  ; preds = %.preheader.us.us.i, %.prol.preheader
  ...
  %prol.iter1174 = phi i64 [ %prol.iter1174.next, %.prol.preheader ], [ 0, %.preheader.us.us.i ]
  ...
  %prol.iter1174.next = add i64 %prol.iter1174, 1 ; 2 uses
  %prol.iter1174.cmp.not = icmp eq i64 %prol.iter1174.next, %xtraiter1172
  br i1 %prol.iter1174.cmp.not, label %.prol.loopexit, label %.prol.preheader, !llvm.loop !64

.prol.loopexit:                                   ; preds = %.prol.preheader, %.preheader.us.us.i
  %.lcssa1129.unr = phi double [ poison, %.preheader.us.us.i ], [ %i.uk, %.prol.preheader ]
...
.preheader.us.us.i.new:                           ; preds = %.prol.loopexit, %.preheader.us.us.i.new
  ...
  %i.uu = load float, ptr %i.ut, align 4, !tbaa !17
  ...
  %i.vc = load float, ptr %i.vb, align 4, !tbaa !17
  ...
  %i.vk = load float, ptr %i.vj, align 4, !tbaa !17
  ...
  br i1 %exitcond136.not.i.3, label %._crit_edge90.split.us.us.us.i, label %.preheader.us.us.i.new, !llvm.loop !65

._crit_edge90.split.us.us.us.i:                   ; preds = %.preheader.us.us.i.new, %.prol.loopexit
  %.lcssa1129 = phi double [ %.lcssa1129.unr, %.prol.loopexit ], [ %i.vp, %.preheader.us.us.i.new ]
  %i.vq = fdiv double %.lcssa1129, %i.tr          ; 2 uses
  %i.vr = fadd double %.093.us.us.i, %i.vq        ; 2 uses
  %i.vs = load ptr, ptr @stdout, align 8, !tbaa !156
  ...
  br i1 %exitcond141.not.i, label %._crit_edge94.i, label %.preheader.us.us.i, !llvm.loop !66

.preheader.us.i:                                  ; preds = %._crit_edge90.split.us99.i, %.preheader.us.preheader.i
  %indvars.iv127.i = phi i64 [ 0, %.preheader.us.preheader.i ], [ %indvars.iv.next128.i, %._crit_edge90.split.us99.i ] ; 2 uses
  %.093.us.i = phi double [ 0.000000e+00, %.preheader.us.preheader.i ], [ %i.xv, %._crit_edge90.split.us99.i ]
  %i.vw = load double, ptr %i.rb, align 8, !tbaa !34
  %i.vx = getelementptr inbounds nuw [8 x i8], ptr %i.cw, i64 %indvars.iv127.i
  %i.vy = load ptr, ptr %i.vx, align 8, !tbaa !25 ; 3 uses
...
.lr.ph84.us.i:                                    ; preds = %._crit_edge85.us.i, %.preheader.us.i
  %indvars.iv122.i = phi i64 [ %indvars.iv.next123.i, %._crit_edge85.us.i ], [ %i.ts, %.preheader.us.i ] ; 4 uses
  %.05888.us97.i = phi double [ %i.xt, %._crit_edge85.us.i ], [ 0.000000e+00, %.preheader.us.i ]
  %i.vz = getelementptr inbounds nuw [4 x i8], ptr %i.vy, i64 %indvars.iv122.i
  %i.wa = load float, ptr %i.vz, align 4, !tbaa !17
...
.lr.ph84.us.i.new:                                ; preds = %.lr.ph84.us.i, %.lr.ph84.us.i.new
  ...
  %niter1171 = phi i64 [ %niter1171.next.7, %.lr.ph84.us.i.new ], [ 0, %.lr.ph84.us.i ]
  %i.wj = getelementptr inbounds nuw [8 x i8], ptr %i.rb, i64 %indvars.iv117.i
  %i.wk = load double, ptr %i.wj, align 8, !tbaa !34
  ...
  %i.wo = load double, ptr %i.wn, align 8, !tbaa !34
  ...
  %i.ws = load double, ptr %i.wr, align 8, !tbaa !34
  ...
  %i.ww = load double, ptr %i.wv, align 8, !tbaa !34
  ...
  %i.xa = load double, ptr %i.wz, align 8, !tbaa !34
  ...
  %i.xe = load double, ptr %i.xd, align 8, !tbaa !34
  ...
  %i.xi = load double, ptr %i.xh, align 8, !tbaa !34
  ...
  %i.xm = load double, ptr %i.xl, align 8, !tbaa !34
  ...
  %niter1171.next.7 = add i64 %niter1171, 8       ; 2 uses
  %niter1171.ncmp.7 = icmp eq i64 %niter1171.next.7, %unroll_iter1170
  br i1 %niter1171.ncmp.7, label %._crit_edge85.us.i.unr-lcssa, label %.lr.ph84.us.i.new, !llvm.loop !67

._crit_edge85.us.i.unr-lcssa:                     ; preds = %.lr.ph84.us.i.new
  br i1 %lcmp.mod1167.not, label %._crit_edge85.us.i, label %.epil.preheader1164

.epil.preheader1164:                              ; preds = %._crit_edge85.us.i.unr-lcssa, %.lr.ph84.us.i
...
bb.bp:                                            ; preds = %bb.bp, %.epil.preheader1164
  %indvars.iv117.i.epil = phi i64 [ %indvars.iv.next118.i.epil, %bb.bp ], [ %indvars.iv117.i.epil.init, %.epil.preheader1164 ] ; 2 uses
  %.05982.us.i.epil = phi double [ %i.xq, %bb.bp ], [ %.05982.us.i.epil.init, %.epil.preheader1164 ]
  %epil.iter1166 = phi i64 [ %epil.iter1166.next, %bb.bp ], [ 0, %.epil.preheader1164 ]
  %i.xo = getelementptr inbounds nuw [8 x i8], ptr %i.rb, i64 %indvars.iv117.i.epil
  %i.xp = load double, ptr %i.xo, align 8, !tbaa !34
  ...
  br i1 %epil.iter1166.cmp.not, label %._crit_edge85.us.i, label %bb.bp, !llvm.loop !68

._crit_edge85.us.i:                               ; preds = %bb.bp, %._crit_edge85.us.i.unr-lcssa
  %.lcssa1132 = phi double [ %i.xn, %._crit_edge85.us.i.unr-lcssa ], [ %i.xq, %bb.bp ]
  %i.xr = fsub double %i.wb, %.lcssa1132          ; 2 uses
  %i.xs = fmul double %i.xr, %i.xr
  %i.xt = fadd double %.05888.us97.i, %i.xs       ; 2 uses
  ...
  br i1 %exitcond126.not.i, label %._crit_edge90.split.us99.i, label %.lr.ph84.us.i, !llvm.loop !65

._crit_edge90.split.us99.i:                       ; preds = %._crit_edge85.us.i
  %i.xu = fdiv double %i.xt, %i.tr                ; 2 uses
  %i.xv = fadd double %.093.us.i, %i.xu           ; 2 uses
  %i.xw = load ptr, ptr @stdout, align 8, !tbaa !156
  ...
  br i1 %exitcond131.not.i, label %._crit_edge94.i, label %.preheader.us.i, !llvm.loop !66
...
.preheader.i205:                                  ; preds = %.preheader.i205, %.preheader.lr.ph.split.i
  ...
  %i.yc = load ptr, ptr @stdout, align 8, !tbaa !156
  ...
  br i1 %exitcond116.not.i, label %._crit_edge94.i, label %.preheader.i205, !llvm.loop !66

._crit_edge94.i:                                  ; preds = %.preheader.i205, %._crit_edge90.split.us99.i, %._crit_edge90.split.us.us.us.i, %._crit_edge.i
  %.0.lcssa.i = phi double [ 0.000000e+00, %._crit_edge.i ], [ %i.xv, %._crit_edge90.split.us99.i ], [ %i.vr, %._crit_edge90.split.us.us.us.i ], [ %i.yb, %.preheader.i205 ]
  %i.yf = load ptr, ptr @stdout, align 8, !tbaa !156
  ...
  %i.yk = load ptr, ptr @stdout, align 8, !tbaa !156
...
_ZL6filterfiiPPff.exit:                           ; preds = %._crit_edge94.i, %_ZL13gmx_snew_implIdEvPKcS1_iRPT_m.exit202._crit_edge
  %i.yl = load ptr, ptr %i.ab, align 8, !tbaa !15
...
._crit_edge.i.i:                                  ; preds = %bb.bq
  ...
  store i64 13, ptr %i.yq, align 8, !tbaa !31
  %i.yr = getelementptr inbounds nuw i8, ptr %24, i64 29
  store i8 0, ptr %i.yr, align 1, !tbaa !23
  %i.ys = load ptr, ptr %i.ac, align 8, !tbaa !151
...
bb.br:                                            ; preds = %._crit_edge.i.i
  %i.yu = load ptr, ptr %24, align 8, !tbaa !22   ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.br
  %i.yw = load i64, ptr %i.yp, align 8, !tbaa !23
  %i.yx = add i64 %i.yw, 1
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.br, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
  ...
  %i.yy = load ptr, ptr %23, align 8, !tbaa !22   ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i214: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  %i.za = load i64, ptr %i.ym, align 8, !tbaa !23
  %i.zb = add i64 %i.za, 1
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit216: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i214
  ...
  %i.zd = load ptr, ptr %i.zc, align 8, !tbaa !19 ; 2 uses
...
_ZNSt10filesystem7__cxx114path5_ListD2Ev.exit.i218: ; preds = %bb.bs, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit216
  %i.ze = load ptr, ptr %22, align 8, !tbaa !22   ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i219: ; preds = %_ZNSt10filesystem7__cxx114path5_ListD2Ev.exit.i218
  %i.zh = load i64, ptr %i.zf, align 8, !tbaa !23
  %i.zi = add i64 %i.zh, 1
...
_ZNSt10filesystem7__cxx114pathD2Ev.exit222:       ; preds = %_ZNSt10filesystem7__cxx114path5_ListD2Ev.exit.i218, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i219
  ...
  %i.zj = load i32, ptr %i.y, align 4, !tbaa !132 ; 2 uses
  %i.zk = icmp sgt i32 %i.zj, 0
  br i1 %i.zk, label %.preheader433.lr.ph, label %._crit_edge502

.preheader433.lr.ph:                              ; preds = %_ZNSt10filesystem7__cxx114pathD2Ev.exit222
  %i.zl = load i32, ptr %i.x, align 4, !tbaa !132
  %i.zm = sitofp i32 %i.zl to float
  %i.zn = fmul nnan float %i.zm, 5.000000e-01
  %i.zo = fptosi float %i.zn to i32               ; 3 uses
  %.not193496 = icmp slt i32 %i.zo, 0
  %i.zp = add nuw i32 %i.zo, 1
  %wide.trip.count578 = zext i32 %i.zp to i64
  br label %.preheader433

.preheader433:                                    ; preds = %.preheader433.lr.ph, %bb.cd
  %i.zq = phi i32 [ %i.zj, %.preheader433.lr.ph ], [ %i.adi, %bb.cd ]
  %indvars.iv580 = phi i64 [ 0, %.preheader433.lr.ph ], [ %indvars.iv.next581, %bb.cd ] ; 3 uses
  br i1 %.not193496, label %._crit_edge499, label %.lr.ph498

.lr.ph498:                                        ; preds = %.preheader433
  %i.zr = getelementptr inbounds nuw [8 x i8], ptr %i.cw, i64 %indvars.iv580
  br label %bb.bt

bb.bt:                                            ; preds = %.lr.ph498, %._crit_edge493
  %indvars.iv575 = phi i64 [ 0, %.lr.ph498 ], [ %indvars.iv.next576, %._crit_edge493 ] ; 3 uses
  %indvars.iv571 = phi i32 [ 0, %.lr.ph498 ], [ %indvars.iv.next572, %._crit_edge493 ] ; 2 uses
  %i.zs = trunc nuw nsw i64 %indvars.iv575 to i32 ; 4 uses
  %i.zt = urem i32 %i.zs, 100
  %i.zu = icmp eq i32 %i.zt, 0
  br i1 %i.zu, label %bb.bu, label %bb.by

bb.bu:                                            ; preds = %bb.bt
  %i.zv = load ptr, ptr @stderr, align 8, !tbaa !156
  %i.zw = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.zv, ptr noundef nonnull @.str.168, i32 noundef %i.zs) #27 ; 0 uses
  %i.zx = load ptr, ptr @stderr, align 8, !tbaa !156
...
bb.bw:                                            ; preds = %._crit_edge.i.i
  %i.aaa = landingpad { ptr, i32 }
          cleanup
  %i.aab = load ptr, ptr %24, align 8, !tbaa !22  ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i223: ; preds = %bb.bw
  %i.aad = load i64, ptr %i.yp, align 8, !tbaa !23
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit225: ; preds = %bb.bw, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i223
  call void @llvm.lifetime.end.p0(ptr nonnull %24) #23
  %i.aaf = load ptr, ptr %23, align 8, !tbaa !22  ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i226: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit225
  %i.aah = load i64, ptr %i.ym, align 8, !tbaa !23
...
bb.by:                                            ; preds = %bb.bu, %bb.bt
  %i.aaj = load i32, ptr %i.x, align 4, !tbaa !132 ; 2 uses
