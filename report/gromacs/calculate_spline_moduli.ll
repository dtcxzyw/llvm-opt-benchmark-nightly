...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %8 = uitofp nneg <4 x i32> %i.af to <4 x double>
  %9 = uitofp nneg <4 x i32> %i.ag to <4 x double>
  %10 = uitofp nneg <4 x i32> %i.ah to <4 x double>
  %11 = uitofp nneg <4 x i32> %i.ai to <4 x double>
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %12 = uitofp nneg <4 x i32> %i.bt to <4 x double>
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  %13 = uitofp nneg i32 %i.cg to double
