...
_ZNK10do_fsplineclESt17integral_constantIiLi4EE.exit: ; preds = %bb.e
  ...
  %8 = load float, ptr %i.ca, align 4, !tbaa !101
  %9 = insertelement <16 x float> poison, float %8, i64 0
  %10 = shufflevector <16 x float> %9, <16 x float> poison, <16 x i32> zeroinitializer ; 2 uses
  %i.cs = load float, ptr %i.cg, align 4, !tbaa !101
  %i.ct = insertelement <16 x float> poison, float %i.cs, i64 0
  %i.cu = shufflevector <16 x float> %i.ct, <16 x float> poison, <16 x i32> zeroinitializer
  %11 = call noundef <16 x float> @llvm.masked.expandload.v16f32.p0(ptr readonly %i.cc, <16 x i1> <i1 true, i1 false, i1 false, i1 false, i1 true, i1 false, i1 false, i1 false, i1 true, i1 false, i1 false, i1 false, i1 true, i1 false, i1 false, i1 false>, <16 x float> zeroinitializer)
  %12 = shufflevector <16 x float> %11, <16 x float> poison, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4, i32 8, i32 8, i32 8, i32 8, i32 12, i32 12, i32 12, i32 12> ; 8 uses
  %13 = call noundef <16 x float> @llvm.masked.expandload.v16f32.p0(ptr readonly %i.ci, <16 x i1> <i1 true, i1 false, i1 false, i1 false, i1 true, i1 false, i1 false, i1 false, i1 true, i1 false, i1 false, i1 false, i1 true, i1 false, i1 false, i1 false>, <16 x float> zeroinitializer)
  %14 = shufflevector <16 x float> %13, <16 x float> poison, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4, i32 8, i32 8, i32 8, i32 8, i32 12, i32 12, i32 12, i32 12> ; 4 uses
  %i.cv = fmul <16 x float> %i.cu, %12
  %i.cw = fmul <16 x float> %10, %14
  %i.cx = fmul <16 x float> %10, %12
  ...
  %i.dg = fmul <16 x float> %12, %i.df
  %i.dh = fmul <16 x float> %14, %i.db
  %i.di = fmul <16 x float> %12, %i.db
  ...
  %i.dr = fmul <16 x float> %12, %i.dq
  %i.ds = fmul <16 x float> %14, %i.dm
  %i.dt = fmul <16 x float> %12, %i.dm
