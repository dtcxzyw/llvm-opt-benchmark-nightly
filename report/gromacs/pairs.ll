...
.preheader.preheader:                             ; preds = %bb.b, %bb.c
  ...
  %i.ea = tail call float @llvm.fmuladd.f32(float %i.dv, float %.sroa.016.0, float %i.dz)
  %i.eb = tail call float @llvm.fmuladd.f32(float %i.ea, float %i.b, float 0.000000e+00)
  ...
  %i.ek = tail call float @llvm.fmuladd.f32(float %i.ej, float %i.b, float %i.eb)
  %i.el = getelementptr inbounds nuw i8, ptr %12, i64 4
  %18 = getelementptr inbounds nuw i8, ptr %15, i64 8 ; 2 uses
  %i.em = load float, ptr %12, align 4, !tbaa !172 ; 2 uses
  %19 = load float, ptr %i.el, align 4, !tbaa !172 ; 2 uses
  %i.en = tail call float @llvm.fmuladd.f32(float %.sroa.0.0, float %i.em, float 0.000000e+00)
  %20 = tail call float @llvm.fmuladd.f32(float %.sroa.015.0, float %i.em, float 0.000000e+00)
  %21 = tail call float @llvm.fmuladd.f32(float %.sroa.6.0, float %19, float %i.en)
  %22 = tail call float @llvm.fmuladd.f32(float %.sroa.5.0, float %19, float %20)
  %23 = load <2 x float>, ptr %18, align 4, !tbaa !172
  %24 = insertelement <2 x float> poison, float %22, i64 0
  %25 = insertelement <2 x float> %24, float %21, i64 1
  %26 = fadd <2 x float> %25, %23
  store <2 x float> %26, ptr %18, align 4, !tbaa !172
