...
%"class.gmx::GromacsException" = type { %"class.std::exception", %"class.std::shared_ptr.174" }
...
%"class.gmx::ExceptionInitializer" = type { %"class.std::__cxx11::basic_string", %"class.std::vector.177" }
%"class.std::vector.177" = type { %"struct.std::_Vector_base.178" }
%"struct.std::_Vector_base.178" = type { %"struct.std::_Vector_base<std::__exception_ptr::exception_ptr, std::allocator<std::__exception_ptr::exception_ptr>>::_Vector_impl" }
...
@.str.1 = private unnamed_addr constant [61 x i8] c"/opt-bench/work/gromacs/gromacs/src/gromacs/mdlib/membed.cpp\00", align 1
...
bb.e:                                             ; preds = %bb.c, %bb.d, %bb.b
  ...
  br i1 %i.r, label %.preheader.lr.ph.i, label %_ZL6resizePA3_fS0_P9pos_ins_tPKf.exit
...
.preheader.lr.ph.i:                               ; preds = %bb.e
  ...
  %wide.trip.count44.i = zext nneg i32 %i.q to i64
  %i.w = getelementptr inbounds nuw i8, ptr %1, i64 20 ; 3 uses
...
.preheader.i:                                     ; preds = %._crit_edge.i, %.preheader.lr.ph.i
  ...
  %i.y = getelementptr inbounds nuw [4 x i8], ptr %i.t, i64 %indvars.iv41.i
...
.lr.ph.i:                                         ; preds = %.preheader.i
  ...
  %i.ac = getelementptr inbounds nuw [8 x i8], ptr %i.ab, i64 %indvars.iv41.i
  %i.ad = load ptr, ptr %i.ac, align 8, !tbaa !28 ; 3 uses
  %i.ae = load ptr, ptr %i.v, align 8, !tbaa !29
  %i.af = getelementptr inbounds nuw [12 x i8], ptr %i.ae, i64 %indvars.iv41.i ; 5 uses
  %i.ag = sext i32 %.033.i to i64                 ; 2 uses
  %wide.trip.count.i = zext nneg i32 %i.z to i64  ; 2 uses
  %i.ah = getelementptr inbounds nuw i8, ptr %i.af, i64 4 ; 3 uses
  %i.ai = getelementptr inbounds nuw i8, ptr %i.af, i64 8 ; 3 uses
  %xtraiter = and i64 %wide.trip.count.i, 1
  %i.aj = icmp eq i32 %i.z, 1
...
bb.f:                                             ; preds = %bb.f, %.lr.ph.i.new
  ...
  %indvars.iv.i = phi i64 [ %i.ag, %.lr.ph.i.new ], [ %indvars.iv.next.i.1, %bb.f ] ; 3 uses
  %niter = phi i64 [ 0, %.lr.ph.i.new ], [ %niter.next.1, %bb.f ]
  %i.ak = getelementptr inbounds nuw [4 x i8], ptr %i.ad, i64 %indvars.iv36.i
  %i.al = load i32, ptr %i.ak, align 4, !tbaa !26
  %i.am = getelementptr inbounds [12 x i8], ptr %i.l, i64 %indvars.iv.i ; 3 uses
  %i.an = sext i32 %i.al to i64
  %i.ao = getelementptr inbounds [12 x i8], ptr %2, i64 %i.an ; 3 uses
  %i.ap = load float, ptr %i.af, align 4, !tbaa !15 ; 2 uses
  %i.aq = load float, ptr %i.o, align 8, !tbaa !15
  %i.ar = load float, ptr %i.am, align 4, !tbaa !15
  %i.as = fsub float %i.ar, %i.ap
  %i.at = tail call float @llvm.fmuladd.f32(float %i.aq, float %i.as, float %i.ap)
  store float %i.at, ptr %i.ao, align 4, !tbaa !15
  %i.au = load float, ptr %i.ah, align 4, !tbaa !15 ; 2 uses
  %i.av = load float, ptr %i.w, align 4, !tbaa !15
  %i.aw = getelementptr inbounds nuw i8, ptr %i.am, i64 4
  %i.ax = load float, ptr %i.aw, align 4, !tbaa !15
  %i.ay = fsub float %i.ax, %i.au
  %i.az = tail call float @llvm.fmuladd.f32(float %i.av, float %i.ay, float %i.au)
  %i.ba = getelementptr inbounds nuw i8, ptr %i.ao, i64 4
  store float %i.az, ptr %i.ba, align 4, !tbaa !15
  %i.bb = load float, ptr %i.ai, align 4, !tbaa !15 ; 2 uses
  %i.bc = load float, ptr %i.x, align 8, !tbaa !15
  %i.bd = getelementptr inbounds nuw i8, ptr %i.am, i64 8
  %i.be = load float, ptr %i.bd, align 4, !tbaa !15
  %i.bf = fsub float %i.be, %i.bb
  %i.bg = tail call float @llvm.fmuladd.f32(float %i.bc, float %i.bf, float %i.bb)
  %i.bh = getelementptr inbounds nuw i8, ptr %i.ao, i64 8
  store float %i.bg, ptr %i.bh, align 4, !tbaa !15
  %i.bi = getelementptr inbounds nuw [4 x i8], ptr %i.ad, i64 %indvars.iv36.i
  %i.bj = getelementptr inbounds nuw i8, ptr %i.bi, i64 4
  %i.bk = load i32, ptr %i.bj, align 4, !tbaa !26
  %i.bl = getelementptr [12 x i8], ptr %i.l, i64 %indvars.iv.i ; 3 uses
  %i.bm = getelementptr i8, ptr %i.bl, i64 12
  %i.bn = sext i32 %i.bk to i64
  %i.bo = getelementptr inbounds [12 x i8], ptr %2, i64 %i.bn ; 3 uses
  %i.bp = load float, ptr %i.af, align 4, !tbaa !15 ; 2 uses
  %i.bq = load float, ptr %i.o, align 8, !tbaa !15
  %i.br = load float, ptr %i.bm, align 4, !tbaa !15
  %i.bs = fsub float %i.br, %i.bp
  %i.bt = tail call float @llvm.fmuladd.f32(float %i.bq, float %i.bs, float %i.bp)
  store float %i.bt, ptr %i.bo, align 4, !tbaa !15
  %i.bu = load float, ptr %i.ah, align 4, !tbaa !15 ; 2 uses
  %i.bv = load float, ptr %i.w, align 4, !tbaa !15
  %i.bw = getelementptr i8, ptr %i.bl, i64 16
  %i.bx = load float, ptr %i.bw, align 4, !tbaa !15
  %i.by = fsub float %i.bx, %i.bu
  %i.bz = tail call float @llvm.fmuladd.f32(float %i.bv, float %i.by, float %i.bu)
  %i.ca = getelementptr inbounds nuw i8, ptr %i.bo, i64 4
  store float %i.bz, ptr %i.ca, align 4, !tbaa !15
  %i.cb = load float, ptr %i.ai, align 4, !tbaa !15 ; 2 uses
  %i.cc = load float, ptr %i.x, align 8, !tbaa !15
  %i.cd = getelementptr i8, ptr %i.bl, i64 20
  %i.ce = load float, ptr %i.cd, align 4, !tbaa !15
  %i.cf = fsub float %i.ce, %i.cb
  %i.cg = tail call float @llvm.fmuladd.f32(float %i.cc, float %i.cf, float %i.cb)
  %i.ch = getelementptr inbounds nuw i8, ptr %i.bo, i64 8
  store float %i.cg, ptr %i.ch, align 4, !tbaa !15
...
.epil.preheader:                                  ; preds = %._crit_edge.loopexit.i.unr-lcssa, %.lr.ph.i
  ...
  %indvars.iv.i.epil.init = phi i64 [ %i.ag, %.lr.ph.i ], [ %indvars.iv.next.i.1, %._crit_edge.loopexit.i.unr-lcssa ] ; 2 uses
  %lcmp.mod20 = trunc i32 %i.z to i1
  tail call void @llvm.assume(i1 %lcmp.mod20)
  %i.ci = getelementptr inbounds nuw [4 x i8], ptr %i.ad, i64 %indvars.iv36.i.epil.init
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !26
  %i.ck = getelementptr inbounds [12 x i8], ptr %i.l, i64 %indvars.iv.i.epil.init ; 3 uses
  %i.cl = sext i32 %i.cj to i64
  %i.cm = getelementptr inbounds [12 x i8], ptr %2, i64 %i.cl ; 3 uses
  %i.cn = load float, ptr %i.af, align 4, !tbaa !15 ; 2 uses
  %i.co = load float, ptr %i.o, align 8, !tbaa !15
  %i.cp = load float, ptr %i.ck, align 4, !tbaa !15
  %i.cq = fsub float %i.cp, %i.cn
  %i.cr = tail call float @llvm.fmuladd.f32(float %i.co, float %i.cq, float %i.cn)
  store float %i.cr, ptr %i.cm, align 4, !tbaa !15
  %i.cs = load float, ptr %i.ah, align 4, !tbaa !15 ; 2 uses
  %i.ct = load float, ptr %i.w, align 4, !tbaa !15
  %i.cu = getelementptr inbounds nuw i8, ptr %i.ck, i64 4
  %i.cv = load float, ptr %i.cu, align 4, !tbaa !15
  %i.cw = fsub float %i.cv, %i.cs
  %i.cx = tail call float @llvm.fmuladd.f32(float %i.ct, float %i.cw, float %i.cs)
  %i.cy = getelementptr inbounds nuw i8, ptr %i.cm, i64 4
  store float %i.cx, ptr %i.cy, align 4, !tbaa !15
  %i.cz = load float, ptr %i.ai, align 4, !tbaa !15 ; 2 uses
  %i.da = load float, ptr %i.x, align 8, !tbaa !15
  %i.db = getelementptr inbounds nuw i8, ptr %i.ck, i64 8
  %i.dc = load float, ptr %i.db, align 4, !tbaa !15
  %i.dd = fsub float %i.dc, %i.cz
  %i.de = tail call float @llvm.fmuladd.f32(float %i.da, float %i.dd, float %i.cz)
...
._crit_edge.loopexit.i:                           ; preds = %._crit_edge.loopexit.i.unr-lcssa, %.epil.preheader
  ...
  %i.dg = trunc nsw i64 %indvars.iv.next.i.lcssa to i32
  br label %._crit_edge.i

._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %.preheader.i
  %.1.lcssa.i = phi i32 [ %.033.i, %.preheader.i ], [ %i.dg, %._crit_edge.loopexit.i ]
