...
begin_hunk_0_@_Z6lmmin2iPdS_S_iPKdPKvPFvS1_iS3_S_PiEPK17lm_control_structP16lm_status_struct:bb.a
  %i.akt = fdiv double %.lcssa1773, %i.aks
...
.lr.ph.i302.i:                                    ; preds = %.epilog-lcssa1844, %bb.ef
  %indvars.iv.i303.i = phi i64 [ %indvars.iv.next.i314.i, %bb.ef ], [ 0, %.epilog-lcssa1844 ] ; 2 uses
  %.076.i304.i = phi double [ %.1.i313.i, %bb.ef ], [ 0.000000e+00, %.epilog-lcssa1844 ] ; 8 uses
  %.06075.i305.i = phi double [ %.161.i312.i, %bb.ef ], [ 0.000000e+00, %.epilog-lcssa1844 ] ; 8 uses
  %.06274.i306.i = phi double [ %.163.i311.i, %bb.ef ], [ 0.000000e+00, %.epilog-lcssa1844 ] ; 6 uses
  %.06473.i307.i = phi double [ %.165.i310.i, %bb.ef ], [ 0.000000e+00, %.epilog-lcssa1844 ] ; 6 uses
  %.06672.i308.i = phi double [ %.167.i309.i, %bb.ef ], [ 0.000000e+00, %.epilog-lcssa1844 ] ; 6 uses
...
bb.em:                                            ; preds = %bb.el, %_Z8lm_enormiPKd.exit317.i
  ...
  %.inv.i = fcmp oge double %.1826, %.0253.i
  %.0253..i = select i1 %.inv.i, double %.1826, double %.0253.i ; 2 uses
...
bb.en:                                            ; preds = %bb.gj, %bb.em
  %.4829 = phi double [ %storemerge.i, %bb.em ], [ %..2255.i, %bb.gj ] ; 2 uses
  ...
  %i.amp = fcmp oeq double %.4829, 0.000000e+00
...
bb.ep:                                            ; preds = %bb.eo, %bb.en
  %i.amt = phi double [ %i.ams, %bb.eo ], [ %.4829, %bb.en ] ; 9 uses
  %i.amu = tail call double @sqrt(double noundef %i.amt) #11 ; 2 uses
  br i1 %min.iters.check1531, label %scalar.ph1530.preheader, label %vector.ph1532

vector.ph1532:                                    ; preds = %bb.ep
  %broadcast.splatinsert1534 = insertelement <2 x double> poison, double %i.amu, i64 0
...
vector.body1536:                                  ; preds = %vector.body1536, %vector.ph1532
  %index1537 = phi i64 [ 0, %vector.ph1532 ], [ %index.next1540, %vector.body1536 ] ; 3 uses
  %i.amv = getelementptr inbounds nuw [8 x i8], ptr %i.bj, i64 %index1537 ; 2 uses
  %i.amw = getelementptr inbounds nuw i8, ptr %i.amv, i64 16
  %wide.load1538 = load <2 x double>, ptr %i.amv, align 8, !tbaa !26
  %wide.load1539 = load <2 x double>, ptr %i.amw, align 8, !tbaa !26
  %i.amx = fmul <2 x double> %broadcast.splat1535, %wide.load1538
  %i.amy = fmul <2 x double> %broadcast.splat1535, %wide.load1539
  %i.amz = getelementptr inbounds nuw [8 x i8], ptr %i.bs, i64 %index1537 ; 2 uses
  ...
  %index.next1540 = add nuw i64 %index1537, 4     ; 2 uses
  %i.anb = icmp eq i64 %index.next1540, %n.vec1533
  br i1 %i.anb, label %middle.block1541, label %vector.body1536, !llvm.loop !110

middle.block1541:                                 ; preds = %vector.body1536
  br i1 %cmp.n1542, label %.preheader196.i.i.preheader, label %scalar.ph1530.preheader

scalar.ph1530.preheader:                          ; preds = %bb.ep, %middle.block1541
  %indvars.iv458.i.ph = phi i64 [ 0, %bb.ep ], [ %n.vec1533, %middle.block1541 ]
  br label %scalar.ph1530

scalar.ph1530:                                    ; preds = %scalar.ph1530.preheader, %scalar.ph1530
  %indvars.iv458.i = phi i64 [ %indvars.iv.next459.i, %scalar.ph1530 ], [ %indvars.iv458.i.ph, %scalar.ph1530.preheader ] ; 3 uses
  ...
  br i1 %exitcond462.not.i, label %.preheader196.i.i.preheader, label %scalar.ph1530, !llvm.loop !111

.preheader196.i.i.preheader:                      ; preds = %scalar.ph1530, %middle.block1541
  br label %.preheader196.i.i

.preheader196.i.i:                                ; preds = %.preheader196.i.i.preheader, %.loopexit1748
  %indvars.iv.i318.i = phi i64 [ %indvars.iv.next.i320.i, %.loopexit1748 ], [ 0, %.preheader196.i.i.preheader ] ; 11 uses
  ...
  %min.iters.check1519 = icmp ugt i64 %10, 3
  %or.cond1750 = and i1 %min.iters.check1519, %ident.check.not
  br i1 %or.cond1750, label %vector.ph1520, label %scalar.ph1518.preheader

vector.ph1520:                                    ; preds = %.preheader196.i.i
  %n.vec1521 = and i64 %10, -4                    ; 3 uses
  %i.ang = add i64 %indvars.iv.i318.i, %n.vec1521
  br label %vector.body1522

vector.body1522:                                  ; preds = %vector.body1522, %vector.ph1520
  %index1523 = phi i64 [ 0, %vector.ph1520 ], [ %index.next1526, %vector.body1522 ] ; 2 uses
  %i.anh = add nuw i64 %indvars.iv.i318.i, %index1523 ; 2 uses
  ...
  %wide.load1524 = load <2 x double>, ptr %i.ani, align 8, !tbaa !26
  %wide.load1525 = load <2 x double>, ptr %i.anj, align 8, !tbaa !26
  ...
  store <2 x double> %wide.load1524, ptr %i.ank, align 8, !tbaa !26
  store <2 x double> %wide.load1525, ptr %i.anl, align 8, !tbaa !26
  %index.next1526 = add nuw i64 %index1523, 4     ; 2 uses
  %i.anm = icmp eq i64 %index.next1526, %n.vec1521
  br i1 %i.anm, label %middle.block1527, label %vector.body1522, !llvm.loop !112

middle.block1527:                                 ; preds = %vector.body1522
  %cmp.n1528 = icmp eq i64 %10, %n.vec1521
  br i1 %cmp.n1528, label %.loopexit1748, label %scalar.ph1518.preheader

scalar.ph1518.preheader:                          ; preds = %.preheader196.i.i, %middle.block1527
  %indvars.iv220.i.i.ph = phi i64 [ %indvars.iv.i318.i, %.preheader196.i.i ], [ %i.ang, %middle.block1527 ] ; 4 uses
  %i.ann = sub i64 %i.bc, %indvars.iv220.i.i.ph
  %xtraiter1849 = and i64 %i.ann, 3               ; 2 uses
  %lcmp.mod1850.not = icmp eq i64 %xtraiter1849, 0
  br i1 %lcmp.mod1850.not, label %scalar.ph1518.prol.loopexit, label %scalar.ph1518.prol

scalar.ph1518.prol:                               ; preds = %scalar.ph1518.preheader, %scalar.ph1518.prol
  %indvars.iv220.i.i.prol = phi i64 [ %indvars.iv.next221.i.i.prol, %scalar.ph1518.prol ], [ %indvars.iv220.i.i.ph, %scalar.ph1518.preheader ] ; 3 uses
  %prol.iter1851 = phi i64 [ %prol.iter1851.next, %scalar.ph1518.prol ], [ 0, %scalar.ph1518.preheader ]
  ...
  %prol.iter1851.next = add i64 %prol.iter1851, 1 ; 2 uses
  %prol.iter1851.cmp.not = icmp eq i64 %prol.iter1851.next, %xtraiter1849
  br i1 %prol.iter1851.cmp.not, label %scalar.ph1518.prol.loopexit, label %scalar.ph1518.prol, !llvm.loop !113

scalar.ph1518.prol.loopexit:                      ; preds = %scalar.ph1518.prol, %scalar.ph1518.preheader
  %indvars.iv220.i.i.unr = phi i64 [ %indvars.iv220.i.i.ph, %scalar.ph1518.preheader ], [ %indvars.iv.next221.i.i.prol, %scalar.ph1518.prol ]
  %i.anq = sub i64 %indvars.iv220.i.i.ph, %i.bc
  %i.anr = icmp ugt i64 %i.anq, -4
  br i1 %i.anr, label %.loopexit1748, label %scalar.ph1518

scalar.ph1518:                                    ; preds = %scalar.ph1518.prol.loopexit, %scalar.ph1518
  %indvars.iv220.i.i = phi i64 [ %indvars.iv.next221.i.i.3, %scalar.ph1518 ], [ %indvars.iv220.i.i.unr, %scalar.ph1518.prol.loopexit ] ; 6 uses
  ...
  br i1 %exitcond.not.i319.i.3, label %.loopexit1748, label %scalar.ph1518, !llvm.loop !114

.loopexit1748:                                    ; preds = %scalar.ph1518.prol.loopexit, %scalar.ph1518, %middle.block1527
...
.preheader195.i.i:                                ; preds = %.loopexit1748, %.loopexit193.i.i
  %indvars.iv229.i.i = phi i64 [ %indvars.iv.next230.i.i, %.loopexit193.i.i ], [ 1, %.loopexit1748 ] ; 2 uses
  %indvar.i.i = phi i64 [ %indvar.next.i.i, %.loopexit193.i.i ], [ 0, %.loopexit1748 ] ; 12 uses
...
.lr.ph207.i.i:                                    ; preds = %.loopexit.i.i, %.lr.ph207.preheader.i.i
  ...
  %gep1917 = getelementptr i8, ptr %invariant.gep1916, i64 %i.ape
  %scevgep1494 = getelementptr i8, ptr %gep1917, i64 8
  %i.apf = mul i64 %i.ep, %indvar
  %scevgep1495 = getelementptr i8, ptr %i.apa, i64 %i.apf
  %i.apg = mul i64 %i.er, %indvar
  %scevgep1496 = getelementptr i8, ptr %i.apb, i64 %i.apg
...
.lr.ph203.preheader.i.i:                          ; preds = %bb.et
  ...
  %min.iters.check1501 = icmp ult i64 %i.apc, 2
  br i1 %min.iters.check1501, label %.lr.ph203.i.i.preheader, label %vector.memcheck1493

vector.memcheck1493:                              ; preds = %.lr.ph203.preheader.i.i
  %bound01497 = icmp ult ptr %scevgep1494, %scevgep1496
  %bound11498 = icmp ult ptr %scevgep1495, %i.br
  %found.conflict1499 = and i1 %bound01497, %bound11498
  br i1 %found.conflict1499, label %.lr.ph203.i.i.preheader, label %vector.ph1502

vector.ph1502:                                    ; preds = %vector.memcheck1493
  %n.vec1503 = and i64 %i.apc, -2                 ; 3 uses
  %i.aqm = add i64 %indvars.iv231.i.i, %n.vec1503
  %broadcast.splatinsert1504 = insertelement <2 x double> poison, double %.0172.i.i, i64 0
  %broadcast.splat1505 = shufflevector <2 x double> %broadcast.splatinsert1504, <2 x double> poison, <2 x i32> zeroinitializer
  %broadcast.splatinsert1506 = insertelement <2 x double> poison, double %.0.i.i, i64 0
  %broadcast.splat1507 = shufflevector <2 x double> %broadcast.splatinsert1506, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %broadcast.splatinsert1508 = insertelement <2 x double> poison, double %i.aqh, i64 0
  %broadcast.splat1509 = shufflevector <2 x double> %broadcast.splatinsert1508, <2 x double> poison, <2 x i32> zeroinitializer
  br label %vector.body1510

vector.body1510:                                  ; preds = %vector.body1510, %vector.ph1502
  %index1511 = phi i64 [ 0, %vector.ph1502 ], [ %index.next1514, %vector.body1510 ] ; 2 uses
  %i.aqn = add nuw i64 %indvars.iv231.i.i, %index1511 ; 2 uses
  %i.aqo = getelementptr [8 x i8], ptr %invariant.gep271.i.i, i64 %i.aqn ; 2 uses
  %wide.load1512 = load <2 x double>, ptr %i.aqo, align 8, !tbaa !26, !alias.scope !116 ; 2 uses
  %i.aqp = getelementptr inbounds nuw [8 x i8], ptr %i.bq, i64 %i.aqn ; 2 uses
  %wide.load1513 = load <2 x double>, ptr %i.aqp, align 8, !tbaa !26, !alias.scope !119, !noalias !116 ; 2 uses
  %i.aqq = fmul <2 x double> %broadcast.splat1505, %wide.load1513
  %i.aqr = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat1507, <2 x double> %wide.load1512, <2 x double> %i.aqq)
  %i.aqs = fmul <2 x double> %broadcast.splat1507, %wide.load1513
  %i.aqt = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat1509, <2 x double> %wide.load1512, <2 x double> %i.aqs)
  ...
  %index.next1514 = add nuw i64 %index1511, 2     ; 2 uses
  %i.aqu = icmp eq i64 %index.next1514, %n.vec1503
  br i1 %i.aqu, label %middle.block1515, label %vector.body1510, !llvm.loop !121

middle.block1515:                                 ; preds = %vector.body1510
  %cmp.n1516 = icmp eq i64 %i.apc, %n.vec1503
  br i1 %cmp.n1516, label %.loopexit.i.i, label %.lr.ph203.i.i.preheader

.lr.ph203.i.i.preheader:                          ; preds = %vector.memcheck1493, %.lr.ph203.preheader.i.i, %middle.block1515
  %indvars.iv233.i.i.ph = phi i64 [ %indvars.iv231.i.i, %vector.memcheck1493 ], [ %indvars.iv231.i.i, %.lr.ph203.preheader.i.i ], [ %i.aqm, %middle.block1515 ]
...
.loopexit.i.i:                                    ; preds = %.lr.ph203.i.i, %middle.block1515, %bb.et, %.lr.ph207..loopexit_crit_edge.i.i
  %indvars.iv.next239.pre-phi.i.i = phi i64 [ %.pre264.i.i, %.lr.ph207..loopexit_crit_edge.i.i ], [ %i.aqk, %bb.et ], [ %i.aqk, %middle.block1515 ], [ %i.aqk, %.lr.ph203.i.i ]
  %.1.i321.i = phi double [ %.0174205.i.i, %.lr.ph207..loopexit_crit_edge.i.i ], [ %i.aqj, %bb.et ], [ %i.aqj, %middle.block1515 ], [ %i.aqj, %.lr.ph203.i.i ]
