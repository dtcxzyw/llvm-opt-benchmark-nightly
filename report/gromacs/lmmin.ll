...
.preheader867:                                    ; preds = %bb.z
  ...
  %i.dy = shl nuw nsw i64 %i.bc, 4
  %10 = add nuw nsw i64 %i.dy, %i.bi              ; 3 uses
  %11 = shl nuw nsw i64 %i.bh, 3
  %i.dz = add nuw nsw i64 %i.bi, 8
  %i.ea = getelementptr i8, ptr %i.bf, i64 %10
  ...
  %i.hb = getelementptr i8, ptr %i.bf, i64 %10
  %i.hc = getelementptr i8, ptr %i.hb, i64 8
  %i.hd = getelementptr i8, ptr %i.bf, i64 %10
...
vector.memcheck:                                  ; preds = %.lr.ph973
  ...
  %scevgep1432 = getelementptr i8, ptr %i.hc, i64 %i.bdk
  %i.bdl = mul i64 %11, %indvars.iv1160
