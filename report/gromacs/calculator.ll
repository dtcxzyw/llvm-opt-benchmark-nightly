...
bb.b:                                             ; preds = %.lr.ph, %_ZN5nblib19dispatchInteractionINS_16ForceBufferProxyIN3gmx11BasicVectorIfEEEENS_14CrossBondAngleES4_S4_NS_5NoPbcETnPNSt9enable_ifIXtlNS_8ContainsIT0_NS_8TypeListIJNS_20AngleInteractionTypeINS_22HarmonicAngleParameterEEENS_16CosineParamAngleINS_17G96AngleParameterEEENS_12QuarticAngleENSF_INS_24RestrictedAngleParameterEEENS_13CrossBondBondES6_NS_23TwoParameterInteractionINS_20LinearAngleParameterEEEEEEEEEEvE4typeELPv0EEENS_12KernelEnergyINSt18remove_all_extentsINT1_8RawArrayEE4typeEEESt5arrayIiXpltlNS_7NCenterISA_vEEELi1EEENS2_8ArrayRefIKSA_EENS16_IKSX_EEPT_NS16_IT2_EERKT3_.exit
  ...
  %.sroa.7237.0.copyload = load float, ptr %.sroa.7237.0..sroa_idx, align 4, !tbaa !185
  ...
  %i.o = getelementptr inbounds [16 x i8], ptr %2, i64 %i.n ; 3 uses
  %.sroa.4225.0.copyload = load float, ptr %i.o, align 4, !tbaa !169 ; 2 uses
  %.sroa.5226.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.o, i64 4
  ...
  %i.q = fneg float %.sroa.4225.0.copyload        ; 2 uses
  ...
  %i.v = fsub <2 x float> %i.r, %i.t              ; 4 uses
  %i.w = fsub float %.sroa.7243.0.copyload, %.sroa.7.0.copyload ; 3 uses
  %foldExtExtBinop = fmul <2 x float> %i.v, %i.v
  %i.x = extractelement <2 x float> %foldExtExtBinop, i64 1
  %i.y = extractelement <2 x float> %i.v, i64 0   ; 2 uses
  ...
  %i.ab = fsub float %sqrt.i.i, %.sroa.6227.0.copyload ; 2 uses
  %9 = fmul float %.sroa.4225.0.copyload, %i.ab
  %10 = fmul float %i.ab, %i.q                    ; 2 uses
  %11 = fsub <2 x float> %i.r, %i.s               ; 3 uses
  %12 = load <2 x float>, ptr %.sroa.5226.0..sroa_idx, align 4, !tbaa !169
  %i.ac = insertelement <2 x float> poison, float %.sroa.7243.0.copyload, i64 0
  %i.ad = insertelement <2 x float> %i.ac, float %.sroa.7.0.copyload, i64 1
  %i.ae = insertelement <2 x float> poison, float %.sroa.7237.0.copyload, i64 0
  %13 = shufflevector <2 x float> %i.ae, <2 x float> poison, <2 x i32> zeroinitializer
  %i.af = fsub <2 x float> %i.ad, %13             ; 4 uses
  %i.ag = shufflevector <2 x float> %11, <2 x float> %i.u, <2 x i32> <i32 1, i32 3> ; 2 uses
  %i.ah = fmul <2 x float> %i.ag, %i.ag
  %i.ai = shufflevector <2 x float> %11, <2 x float> %i.u, <2 x i32> <i32 0, i32 2> ; 2 uses
  ...
  %14 = fdiv float %10, %i.am                     ; 2 uses
  %i.an = insertelement <2 x float> poison, float %14, i64 0
  %15 = shufflevector <2 x float> %i.an, <2 x float> poison, <2 x i32> zeroinitializer
  %16 = fmul <2 x float> %i.u, %15
  %17 = extractelement <2 x float> %i.af, i64 1
  %18 = fmul float %17, %14
  %19 = fsub <2 x float> %i.al, %12               ; 2 uses
  %shift = shufflevector <2 x float> %19, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop489 = fadd <2 x float> %19, %shift
  %i.ao = extractelement <2 x float> %foldExtExtBinop489, i64 0 ; 2 uses
  %i.ap = fmul float %i.ao, %9
  %20 = fmul float %i.ao, %i.q
  %i.aq = extractelement <2 x float> %i.al, i64 0
  %i.ar = fdiv float %10, %i.aq                   ; 2 uses
  %21 = fdiv float %20, %sqrt.i.i                 ; 2 uses
  ...
  %22 = extractelement <2 x float> %i.af, i64 0
  %23 = fmul float %22, %i.ar
  %24 = insertelement <2 x float> poison, float %21, i64 0
  %i.av = shufflevector <2 x float> %24, <2 x float> poison, <2 x i32> zeroinitializer
  %i.aw = fmul <2 x float> %i.v, %i.av            ; 2 uses
  %25 = fmul float %i.w, %21                      ; 2 uses
  %i.ax = fadd <2 x float> %i.au, %i.aw           ; 3 uses
  %i.ay = fadd float %23, %25                     ; 3 uses
  %26 = fsub <2 x float> %16, %i.aw               ; 3 uses
  %27 = fsub float %18, %25                       ; 3 uses
  %28 = fadd <2 x float> %i.ax, %26               ; 2 uses
  %29 = fadd float %i.ay, %27                     ; 2 uses
  %i.az = fadd <2 x float> %i.ax, zeroinitializer
  %30 = fadd float %i.ay, 0.000000e+00
  %31 = fsub <2 x float> zeroinitializer, %28
  %32 = fsub float 0.000000e+00, %29
  %33 = fadd <2 x float> %26, zeroinitializer
  %34 = fadd float %27, 0.000000e+00
  %35 = getelementptr inbounds nuw i8, ptr %i.g, i64 272 ; 2 uses
  %36 = load float, ptr %35, align 4, !tbaa !169
  %i.ba = fadd float %36, %i.ay
  %37 = fsub float %i.ba, %29
  %i.bb = load <2 x float>, ptr %i.p, align 4, !tbaa !169
  %i.bc = fadd <2 x float> %i.bb, %i.ax
  %i.bd = fsub <2 x float> %i.bc, %28
  %i.be = fadd <2 x float> %26, %i.bd
  %i.bf = fadd float %27, %37
  store <2 x float> %i.be, ptr %i.p, align 4
  store float %i.bf, ptr %35, align 4, !tbaa !185
...
_ZN5nblib16ForceBufferProxyIN3gmx11BasicVectorIfEEEixEi.exit26.i: ; preds = %_ZNSt13unordered_mapIiN3gmx11BasicVectorIfEESt4hashIiESt8equal_toIiESaISt4pairIKiS2_EEEixERS8_.exit72, %bb.c
  %.0.i25.i = phi ptr [ %i.bl, %bb.c ], [ %.1.i.i71, %_ZNSt13unordered_mapIiN3gmx11BasicVectorIfEESt4hashIiESt8equal_toIiESaISt4pairIKiS2_EEEixERS8_.exit72 ] ; 3 uses
  %i.do = load <2 x float>, ptr %.0.i25.i, align 4, !tbaa !169
  %i.dp = fadd <2 x float> %i.az, %i.do
  %38 = getelementptr inbounds nuw i8, ptr %.0.i25.i, i64 8 ; 2 uses
  %39 = load float, ptr %38, align 4, !tbaa !169
  %40 = fadd float %30, %39
  store <2 x float> %i.dp, ptr %.0.i25.i, align 4
  store float %40, ptr %38, align 4, !tbaa !185
...
_ZN5nblib16ForceBufferProxyIN3gmx11BasicVectorIfEEEixEi.exit22.i: ; preds = %_ZNSt13unordered_mapIiN3gmx11BasicVectorIfEESt4hashIiESt8equal_toIiESaISt4pairIKiS2_EEEixERS8_.exit110, %bb.p
  %.0.i21.i = phi ptr [ %i.dv, %bb.p ], [ %.1.i.i109, %_ZNSt13unordered_mapIiN3gmx11BasicVectorIfEESt4hashIiESt8equal_toIiESaISt4pairIKiS2_EEEixERS8_.exit110 ] ; 3 uses
  %i.fy = load <2 x float>, ptr %.0.i21.i, align 4, !tbaa !169
  %i.fz = fadd <2 x float> %31, %i.fy
  %41 = getelementptr inbounds nuw i8, ptr %.0.i21.i, i64 8 ; 2 uses
  %42 = load float, ptr %41, align 4, !tbaa !169
  %43 = fadd float %32, %42
  store <2 x float> %i.fz, ptr %.0.i21.i, align 4
  store float %43, ptr %41, align 4, !tbaa !185
...
_ZN5nblib19dispatchInteractionINS_16ForceBufferProxyIN3gmx11BasicVectorIfEEEENS_14CrossBondAngleES4_S4_NS_5NoPbcETnPNSt9enable_ifIXtlNS_8ContainsIT0_NS_8TypeListIJNS_20AngleInteractionTypeINS_22HarmonicAngleParameterEEENS_16CosineParamAngleINS_17G96AngleParameterEEENS_12QuarticAngleENSF_INS_24RestrictedAngleParameterEEENS_13CrossBondBondES6_NS_23TwoParameterInteractionINS_20LinearAngleParameterEEEEEEEEEEvE4typeELPv0EEENS_12KernelEnergyINSt18remove_all_extentsINT1_8RawArrayEE4typeEEESt5arrayIiXpltlNS_7NCenterISA_vEEELi1EEENS2_8ArrayRefIKSA_EENS16_IKSX_EEPT_NS16_IT2_EERKT3_.exit: ; preds = %bb.ac, %_ZNSt13unordered_mapIiN3gmx11BasicVectorIfEESt4hashIiESt8equal_toIiESaISt4pairIKiS2_EEEixERS8_.exit148
  %.0.i.i = phi ptr [ %i.gf, %bb.ac ], [ %.1.i.i147, %_ZNSt13unordered_mapIiN3gmx11BasicVectorIfEESt4hashIiESt8equal_toIiESaISt4pairIKiS2_EEEixERS8_.exit148 ] ; 3 uses
  %44 = load <2 x float>, ptr %.0.i.i, align 4, !tbaa !169
  %45 = fadd <2 x float> %33, %44
  %i.ii = getelementptr inbounds nuw i8, ptr %.0.i.i, i64 8 ; 2 uses
  %i.ij = load float, ptr %i.ii, align 4, !tbaa !169
  %i.ik = fadd float %34, %i.ij
  store <2 x float> %45, ptr %.0.i.i, align 4
...
bb.b:                                             ; preds = %.lr.ph, %_ZN5nblib19dispatchInteractionINS_16ForceBufferProxyIN3gmx11BasicVectorIfEEEENS_14CrossBondAngleES4_DnNS_5NoPbcETnPNSt9enable_ifIXtlNS_8ContainsIT0_NS_8TypeListIJNS_20AngleInteractionTypeINS_22HarmonicAngleParameterEEENS_16CosineParamAngleINS_17G96AngleParameterEEENS_12QuarticAngleENSF_INS_24RestrictedAngleParameterEEENS_13CrossBondBondES6_NS_23TwoParameterInteractionINS_20LinearAngleParameterEEEEEEEEEEvE4typeELPv0EEENS_12KernelEnergyINSt18remove_all_extentsINT1_8RawArrayEE4typeEEESt5arrayIiXpltlNS_7NCenterISA_vEEELi1EEENS2_8ArrayRefIKSA_EENS16_IKSX_EEPT_NS16_IT2_EERKT3_.exit
  ...
  %i.n = getelementptr inbounds [16 x i8], ptr %2, i64 %i.m ; 3 uses
  %.sroa.0220.0.copyload = load float, ptr %i.n, align 4, !tbaa !169 ; 2 uses
  %.sroa.5222.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.n, i64 4
  ...
  %9 = load <2 x float>, ptr %i.j, align 4        ; 2 uses
  %i.q = load <2 x float>, ptr %i.l, align 4      ; 2 uses
  %10 = fsub <2 x float> %i.q, %9                 ; 3 uses
  %11 = fsub <2 x float> %i.p, %i.q               ; 4 uses
  %12 = fsub float %.sroa.7239.0.copyload, %.sroa.7.0.copyload ; 3 uses
  %foldExtExtBinop = fmul <2 x float> %11, %11
  %13 = extractelement <2 x float> %foldExtExtBinop, i64 1
  %14 = extractelement <2 x float> %11, i64 0     ; 2 uses
  %15 = tail call float @llvm.fmuladd.f32(float %14, float %14, float %13)
  %16 = tail call noundef float @llvm.fmuladd.f32(float %12, float %12, float %15)
  %sqrt.i.i20 = tail call noundef float @llvm.sqrt.f32(float %16) ; 2 uses
  %17 = fsub float %sqrt.i.i20, %.sroa.6223.0.copyload ; 2 uses
  %18 = fmul float %.sroa.0220.0.copyload, %17
  %19 = fmul float %17, %i.o                      ; 2 uses
  %i.r = fsub <2 x float> %i.p, %9                ; 3 uses
  %20 = load <2 x float>, ptr %.sroa.5222.0..sroa_idx, align 4, !tbaa !169
  %i.s = insertelement <2 x float> poison, float %.sroa.7239.0.copyload, i64 0
  %21 = insertelement <2 x float> %i.s, float %.sroa.7.0.copyload, i64 1
  %22 = insertelement <2 x float> poison, float %.sroa.7233.0.copyload, i64 0
  %23 = shufflevector <2 x float> %22, <2 x float> poison, <2 x i32> zeroinitializer
  %24 = fsub <2 x float> %21, %23                 ; 4 uses
  %25 = shufflevector <2 x float> %i.r, <2 x float> %10, <2 x i32> <i32 1, i32 3> ; 2 uses
  %26 = fmul <2 x float> %25, %25
  %27 = shufflevector <2 x float> %i.r, <2 x float> %10, <2 x i32> <i32 0, i32 2> ; 2 uses
  %28 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %27, <2 x float> %27, <2 x float> %26)
  %29 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %24, <2 x float> %24, <2 x float> %28)
  %30 = tail call <2 x float> @llvm.sqrt.v2f32(<2 x float> %29) ; 3 uses
  %i.t = extractelement <2 x float> %30, i64 1
  %31 = fdiv float %19, %i.t                      ; 2 uses
  %32 = insertelement <2 x float> poison, float %31, i64 0
  %33 = shufflevector <2 x float> %32, <2 x float> poison, <2 x i32> zeroinitializer
  %34 = fmul <2 x float> %10, %33
  %35 = extractelement <2 x float> %24, i64 1
  %i.u = fmul float %35, %31
  %36 = fsub <2 x float> %30, %20                 ; 2 uses
  %shift = shufflevector <2 x float> %36, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop468 = fadd <2 x float> %36, %shift
  %37 = extractelement <2 x float> %foldExtExtBinop468, i64 0 ; 2 uses
  %i.v = fmul float %37, %18
  %i.w = fmul float %37, %i.o
  %i.x = extractelement <2 x float> %30, i64 0
  %38 = fdiv float %19, %i.x                      ; 2 uses
  %39 = fdiv float %i.w, %sqrt.i.i20              ; 2 uses
  %i.y = insertelement <2 x float> poison, float %38, i64 0
  %40 = shufflevector <2 x float> %i.y, <2 x float> poison, <2 x i32> zeroinitializer
  %41 = fmul <2 x float> %i.r, %40
  %42 = extractelement <2 x float> %24, i64 0
  %i.z = fmul float %42, %38
  %43 = insertelement <2 x float> poison, float %39, i64 0
  %44 = shufflevector <2 x float> %43, <2 x float> poison, <2 x i32> zeroinitializer
  %45 = fmul <2 x float> %11, %44                 ; 2 uses
  %i.aa = fmul float %12, %39                     ; 2 uses
  %46 = fadd <2 x float> %41, %45                 ; 2 uses
  %47 = fadd float %i.z, %i.aa                    ; 2 uses
  %48 = fsub <2 x float> %34, %45                 ; 2 uses
  %i.ab = fsub float %i.u, %i.aa                  ; 2 uses
  %49 = fadd <2 x float> %46, %48
  %i.ac = fadd float %47, %i.ab
  %50 = fadd <2 x float> %46, zeroinitializer
  %i.ad = fadd float %47, 0.000000e+00
  %51 = fsub <2 x float> zeroinitializer, %49
  %i.ae = fsub float 0.000000e+00, %i.ac
  %52 = fadd <2 x float> %48, zeroinitializer
...
_ZN5nblib16ForceBufferProxyIN3gmx11BasicVectorIfEEEixEi.exit26.i: ; preds = %_ZNSt13unordered_mapIiN3gmx11BasicVectorIfEESt4hashIiESt8equal_toIiESaISt4pairIKiS2_EEEixERS8_.exit68, %bb.c
  %.0.i25.i = phi ptr [ %i.al, %bb.c ], [ %.1.i.i67, %_ZNSt13unordered_mapIiN3gmx11BasicVectorIfEESt4hashIiESt8equal_toIiESaISt4pairIKiS2_EEEixERS8_.exit68 ] ; 3 uses
  %53 = load <2 x float>, ptr %.0.i25.i, align 4, !tbaa !169
  ...
  store <2 x float> %54, ptr %.0.i25.i, align 4
...
_ZN5nblib16ForceBufferProxyIN3gmx11BasicVectorIfEEEixEi.exit22.i: ; preds = %_ZNSt13unordered_mapIiN3gmx11BasicVectorIfEESt4hashIiESt8equal_toIiESaISt4pairIKiS2_EEEixERS8_.exit106, %bb.p
  %.0.i21.i = phi ptr [ %i.cw, %bb.p ], [ %.1.i.i105, %_ZNSt13unordered_mapIiN3gmx11BasicVectorIfEESt4hashIiESt8equal_toIiESaISt4pairIKiS2_EEEixERS8_.exit106 ] ; 3 uses
  %55 = load <2 x float>, ptr %.0.i21.i, align 4, !tbaa !169
  ...
  %i.fb = fadd float %i.ae, %i.fa
  store <2 x float> %56, ptr %.0.i21.i, align 4
...
_ZN5nblib19dispatchInteractionINS_16ForceBufferProxyIN3gmx11BasicVectorIfEEEENS_14CrossBondAngleES4_DnNS_5NoPbcETnPNSt9enable_ifIXtlNS_8ContainsIT0_NS_8TypeListIJNS_20AngleInteractionTypeINS_22HarmonicAngleParameterEEENS_16CosineParamAngleINS_17G96AngleParameterEEENS_12QuarticAngleENSF_INS_24RestrictedAngleParameterEEENS_13CrossBondBondES6_NS_23TwoParameterInteractionINS_20LinearAngleParameterEEEEEEEEEEvE4typeELPv0EEENS_12KernelEnergyINSt18remove_all_extentsINT1_8RawArrayEE4typeEEESt5arrayIiXpltlNS_7NCenterISA_vEEELi1EEENS2_8ArrayRefIKSA_EENS16_IKSX_EEPT_NS16_IT2_EERKT3_.exit: ; preds = %bb.ac, %_ZNSt13unordered_mapIiN3gmx11BasicVectorIfEESt4hashIiESt8equal_toIiESaISt4pairIKiS2_EEEixERS8_.exit144
  %.0.i.i = phi ptr [ %i.fh, %bb.ac ], [ %.1.i.i143, %_ZNSt13unordered_mapIiN3gmx11BasicVectorIfEESt4hashIiESt8equal_toIiESaISt4pairIKiS2_EEEixERS8_.exit144 ] ; 3 uses
  %57 = load <2 x float>, ptr %.0.i.i, align 4, !tbaa !169
