...
bb.du:                                            ; preds = %bb.du, %.lr.ph928.new
  ...
  %i.arz = mul nuw nsw i64 %.12410927, %.12410500
  %i.asa = getelementptr inbounds nuw [4 x i8], ptr %i.ph, i64 %i.arz
  %i.asb = load float, ptr %i.asa, align 4, !tbaa !52
  %i.asc = fadd float %.0435926, %i.asb
  %i.asd = or disjoint i64 %.12410927, 1
  %i.ase = mul nuw nsw i64 %i.asd, %.12410500
...
bb.dv:                                            ; preds = %bb.dv, %.epil.preheader1658
  ...
  %i.atp = mul nuw nsw i64 %.12410927.epil, %.12410500
  %i.atq = getelementptr inbounds nuw [4 x i8], ptr %i.ph, i64 %i.atp
