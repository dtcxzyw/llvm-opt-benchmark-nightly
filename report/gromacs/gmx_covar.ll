...
bb.du:                                            ; preds = %bb.du, %.lr.ph928.new
  ...
  %i.ase = mul i64 %.12410927, %.12410500
  ...
  %i.atn = mul i64 %i.atm, %.12410500
  %i.ato = getelementptr inbounds [4 x i8], ptr %i.ph, i64 %i.atn
...
bb.dv:                                            ; preds = %bb.dv, %.epil.preheader1668
  ...
  %i.atu = mul i64 %.12410927.epil, %.12410500
  %i.atv = getelementptr inbounds [4 x i8], ptr %i.ph, i64 %i.atu
