...
bb.cf:                                            ; preds = %.preheader647, %bb.cy
  ...
  %.0296 = phi i32 [ 0, %.preheader647 ], [ %i.akd, %bb.cy ]
  %.0275 = phi double [ 0.000000e+00, %.preheader647 ], [ %.1276, %bb.cy ] ; 2 uses
  %i.qi = phi <2 x double> [ zeroinitializer, %.preheader647 ], [ %i.ain, %bb.cy ]
...
.preheader.i:                                     ; preds = %.preheader.preheader.i, %._crit_edge.i.loopexit
  %indvar1172 = phi i32 [ 0, %.preheader.preheader.i ], [ %indvar.next1173, %._crit_edge.i.loopexit ] ; 2 uses
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %.preheader.i.new
  ...
  %shift1148 = shufflevector <2 x float> %i.sj, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop1149 = fadd <2 x float> %i.sj, %shift1148
  %i.sk = extractelement <2 x float> %foldExtExtBinop1149, i64 0
  ...
  %shift1148.1 = shufflevector <2 x float> %i.te, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop1149.1 = fadd <2 x float> %i.te, %shift1148.1
  %i.tf = extractelement <2 x float> %foldExtExtBinop1149.1, i64 0
...
.lr.ph.i.epil.preheader:                          ; preds = %._crit_edge.i.loopexit.unr-lcssa, %.lr.ph.preheader.i
  ...
  %shift1148.epil = shufflevector <2 x float> %i.tz, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop1149.epil = fadd <2 x float> %i.tz, %shift1148.epil
  %i.ua = extractelement <2 x float> %foldExtExtBinop1149.epil, i64 0
