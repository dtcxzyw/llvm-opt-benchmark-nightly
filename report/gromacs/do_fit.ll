...
.lr.ph182.us.epil.preheader:                      ; preds = %..loopexit_crit_edge.us.loopexit.unr-lcssa
  ...
  %broadcast.splatinsert326.epil.a = insertelement <4 x double> poison, double %i.av, i64 0
  %broadcast.splat327.epil.a = shufflevector <4 x double> %broadcast.splatinsert326.epil.a, <4 x double> poison, <4 x i32> zeroinitializer
  ...
  %i.bq = fmul <4 x double> %broadcast.splat327.epil.a, %i.bp
