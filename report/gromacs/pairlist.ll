...
bb.a:
  ...
  %.sink491.in.idx = select i1 %i.w, i64 0, i64 48
  %.sink491.in = getelementptr inbounds nuw i8, ptr %0, i64 %.sink491.in.idx
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 %.sink
  %.sink491 = load ptr, ptr %.sink491.in, align 8, !tbaa !301
  %.sink492 = load ptr, ptr %i.x, align 8, !tbaa !301
  %i.y = ptrtoint ptr %.sink492 to i64
  %i.z = ptrtoint ptr %.sink491 to i64
...
begin_hunk_1_@_ZN3gmx11PairlistSet18constructPairlistsENS_19InteractionLocalityERKNS_7GridSetENS_8ArrayRefINS_14PairsearchWorkEEEPNS_16nbnxn_atomdata_tERKNS_11ListOfListsIiEEbiP6t_nrnbPNS_19SearchCycleCountingE:bb.a
  %i.bco = getelementptr inbounds nuw i8, ptr %.sroa.011.015.i, i64 168 ; 2 uses
  %i.bcp = load ptr, ptr %i.bco, align 8, !tbaa !39
  store ptr %i.bcp, ptr %i.bcm, align 8, !tbaa !39
  %i.bcq = load <2 x ptr>, ptr %i.bck, align 8, !tbaa !182
  store ptr %i.bbz, ptr %i.bck, align 8, !tbaa !38
  store ptr %i.bcb, ptr %i.bcl, align 8, !tbaa !181
  store <2 x ptr> %i.bcq, ptr %i.bby, align 8, !tbaa !182
  store ptr %i.bcn, ptr %i.bco, align 8, !tbaa !39
  %i.bcr = getelementptr inbounds nuw i8, ptr %.sroa.011.015.i, i64 256 ; 2 uses
  %.not.i209 = icmp eq ptr %i.bcr, %i.bbs
  br i1 %.not.i209, label %_ZN3gmxL29prepareListsForDynamicPruningENS_8ArrayRefINS_16NbnxnPairlistCpuEEE.exit, label %.lr.ph.i208

_ZN3gmxL29prepareListsForDynamicPruningENS_8ArrayRefINS_16NbnxnPairlistCpuEEE.exit: ; preds = %bb.do, %bb.dl, %bb.dk, %.thread261
...
.lr.ph:                                           ; preds = %bb.b
  ...
  %.sroa.12.0..sroa_idx.i175 = getelementptr inbounds nuw i8, ptr %8, i64 6 ; 2 uses
  ...
  %.sroa.3.0..sroa_idx.i103 = getelementptr inbounds nuw i8, ptr %8, i64 5 ; 2 uses
