...
bb.bw:                                            ; preds = %bb.bv
  ...
  %i.xj = ptrtoint ptr %i.xg to i64
  %i.xk = ptrtoint ptr %i.xi to i64
  %i.xl = sub i64 %i.xk, %i.xj                    ; 2 uses
...
.lr.ph.preheader.i160:                            ; preds = %bb.ce
  %i.abv = ptrtoint ptr %i.abr to i64
  %i.abw = ptrtoint ptr %i.abt to i64
  %i.abx = sub i64 %i.abw, %i.abv                 ; 2 uses
...
bb.cn:                                            ; preds = %bb.ch
  %i.amn = ptrtoint ptr %i.adq to i64
  %i.amo = ptrtoint ptr %i.adt to i64
  %i.amp = sub i64 %i.amo, %i.amn
...
bb.dg:                                            ; preds = %_ZN3gmxL19print_nblist_sci_cjILNS_12PairlistTypeE3EEEvP8_IO_FILERKNS_16NbnxnPairlistGpuE.exit
  ...
  %i.avy = load ptr, ptr %i.avx, align 8, !tbaa !277 ; 5 uses
  %20 = ptrtoaddr ptr %i.avy to i64
...
_ZN3gmxL20print_reduction_costENS_8ArrayRefIKSt5arrayImLm2EEEEi.exit: ; preds = %.lr.ph63.split.i, %middle.block955, %vec.epilog.middle.block982, %bb.dg, %._crit_edge64.loopexit.i
  ...
  %21 = ptrtoint ptr %i.avy to i64
  %22 = sub i64 %21, %i.avz
  %i.baz = ashr exact i64 %22, 4                  ; 2 uses
...
bb.hi:                                            ; preds = %bb.hh, %bb.hg, %bb.he
  ...
  %i.brj = ptrtoint ptr %i.brh to i64
  %i.brk = ptrtoint ptr %i.bri to i64
  %i.brl = sub i64 %i.brk, %i.brj                 ; 2 uses
...
bb.hl:                                            ; preds = %.noexc81, %bb.hi, %bb.hc
  ...
  %i.brx = ptrtoint ptr %i.brv to i64
  %i.bry = ptrtoint ptr %i.brw to i64
  %i.brz = sub i64 %i.bry, %i.brx                 ; 2 uses
...
bb.og:                                            ; preds = %_ZN3gmxL18get_exclusion_maskEPNS_16NbnxnPairlistGpuEii.exit.i450.i
  ...
  %i.elv = ptrtoint ptr %i.elt to i64
  %i.elw = ptrtoint ptr %i.elu to i64
  %i.elx = sub i64 %i.elw, %i.elv                 ; 2 uses
