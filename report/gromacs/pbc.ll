...
begin_hunk_0_@_Z30calc_compact_unitcell_verticesiPA3_KfPA3_f:.preheader81.1142
  store float %i.em, ptr %i.q, align 4, !tbaa !23
  %i.en = shufflevector <8 x float> %i.dj, <8 x float> %i.bg, <2 x i32> <i32 0, i32 9>
  %i.eo = fadd <2 x float> %i.en, %i.cx
  %i.ep = fadd <2 x float> %i.eo, %i.cv
  store <2 x float> %i.ep, ptr %i.as, align 4, !tbaa !23
  %i.eq = fsub float %i.bs, %i.ek
  %i.er = fsub float %i.eq, %i.az
  store float %i.er, ptr %i.au, align 4, !tbaa !23
  %i.es = shufflevector <8 x float> %i.dj, <8 x float> poison, <8 x i32> <i32 poison, i32 poison, i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.et = shufflevector <8 x float> %i.aj, <8 x float> %i.es, <8 x i32> <i32 0, i32 1, i32 10, i32 0, i32 1, i32 10, i32 0, i32 1>
  %i.eu = fsub <8 x float> %i.dl, %i.et
  %i.ev = shufflevector <8 x float> %i.aw, <8 x float> %i.dk, <8 x i32> <i32 0, i32 1, i32 13, i32 14, i32 15, i32 5, i32 6, i32 7>
  %i.ew = fsub <8 x float> %i.eu, %i.ev
  store <8 x float> %i.ew, ptr %i.av, align 4, !tbaa !23
  %i.ex = shufflevector <4 x float> %i.bz, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.ey = shufflevector <8 x float> %i.bo, <8 x float> %i.di, <8 x i32> <i32 0, i32 1, i32 13, i32 8, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.ez = shufflevector <8 x float> %i.ey, <8 x float> %i.bp, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11> ; 2 uses
  %i.fa = shufflevector <4 x float> %i.ck, <4 x float> %i.bz, <8 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 5>
  %i.fb = shufflevector <3 x float> %i.ag, <3 x float> %i.y, <8 x i32> <i32 2, i32 3, i32 4, i32 5, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.fc = shufflevector <8 x float> %i.fb, <8 x float> %i.fa, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 15> ; 3 uses
  %i.fd = fsub <8 x float> %i.ca, %i.fc
  %i.fe = fadd <8 x float> %i.ca, %i.fc
  %i.ff = shufflevector <8 x float> %i.fd, <8 x float> %i.fe, <8 x i32> <i32 0, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 7> ; 2 uses
  %i.fg = shufflevector <4 x float> %i.bt, <4 x float> %i.l, <8 x i32> <i32 2, i32 poison, i32 poison, i32 poison, i32 4, i32 poison, i32 poison, i32 poison>
  %i.fh = shufflevector <4 x float> %i.by, <4 x float> poison, <8 x i32> <i32 0, i32 poison, i32 2, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.fi = shufflevector <8 x float> %i.fc, <8 x float> %i.fh, <8 x i32> <i32 poison, i32 4, i32 5, i32 6, i32 poison, i32 10, i32 8, i32 poison>
  %i.fj = shufflevector <8 x float> %i.fg, <8 x float> %i.fi, <8 x i32> <i32 0, i32 9, i32 10, i32 11, i32 4, i32 13, i32 14, i32 poison>
  %i.fk = shufflevector <3 x float> %i.ag, <3 x float> poison, <8 x i32> <i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.fl = shufflevector <8 x float> %i.fj, <8 x float> %i.fk, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 8> ; 2 uses
  %i.fm = fadd <8 x float> %i.ff, %i.fl
  %i.fn = fsub <8 x float> %i.ff, %i.fl
  %i.fo = shufflevector <8 x float> %i.fm, <8 x float> %i.fn, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 7>
  store <8 x float> %i.fo, ptr %i.bq, align 4, !tbaa !23
  %i.fp = getelementptr inbounds nuw i8, ptr %2, i64 244
  %i.fq = extractelement <4 x float> %i.bz, i64 0
  %i.fr = insertelement <2 x float> %i.ac, float %i.ay, i64 1
  %i.fs = shufflevector <4 x float> %i.bz, <4 x float> poison, <2 x i32> <i32 2, i32 0>
  %i.ft = fsub <2 x float> %i.fr, %i.fs
  %i.fu = shufflevector <3 x float> %i.ag, <3 x float> poison, <2 x i32> <i32 1, i32 2>
  %i.fv = fadd <2 x float> %i.ft, %i.fu
  store <2 x float> %i.fv, ptr %i.fp, align 4, !tbaa !23
  %i.fw = getelementptr inbounds nuw i8, ptr %2, i64 252
  %i.fx = insertelement <4 x float> %i.cb, float %i.bc, i64 3
  %i.fy = shufflevector <4 x float> %i.bt, <4 x float> %i.ck, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %i.fz = getelementptr inbounds nuw i8, ptr %2, i64 268
  %i.ga = fneg <3 x float> %i.y
  %i.gb = shufflevector <3 x float> %i.ga, <3 x float> poison, <2 x i32> <i32 1, i32 2> ; 2 uses
  %i.gc = shufflevector <2 x float> %i.gb, <2 x float> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.gd = shufflevector <8 x float> %i.bm, <8 x float> %i.gc, <8 x i32> <i32 0, i32 8, i32 9, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.ge = fsub float %i.aa, %i.br
  %i.gf = fadd float %i.ci, %i.ab                 ; 3 uses
  %i.gg = fadd float %i.ci, %i.gf
  %i.gh = fsub float %i.gg, %i.ba
  store float %i.gh, ptr %i.f, align 4, !tbaa !23
  %i.gi = insertelement <4 x float> %i.eg, float %i.gf, i64 0
  %i.gj = fsub <4 x float> %i.ef, %i.gi
  store <4 x float> %i.gj, ptr %i.o, align 4, !tbaa !23
  %i.gk = shufflevector <8 x float> %i.gd, <8 x float> %i.ex, <8 x i32> <i32 0, i32 1, i32 2, i32 9, i32 10, i32 8, i32 9, i32 10>
  %i.gl = fsub <8 x float> %i.gk, %i.dj           ; 2 uses
  %i.gm = fsub <8 x float> %i.gl, %i.ez
  %i.gn = fadd <8 x float> %i.gl, %i.ez
  %i.go = shufflevector <8 x float> %i.gm, <8 x float> %i.gn, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 14, i32 15>
  store <8 x float> %i.go, ptr %i.ax, align 4, !tbaa !23
  %i.gp = insertelement <4 x float> poison, float %i.ge, i64 0 ; 2 uses
  %i.gq = shufflevector <4 x float> %i.gp, <4 x float> %i.bz, <4 x i32> <i32 0, i32 6, i32 4, i32 0>
  %i.gr = fsub <4 x float> %i.fx, %i.gq
  %i.gs = fsub <4 x float> %i.gr, %i.fy
  store <4 x float> %i.gs, ptr %i.fw, align 4, !tbaa !23
  %i.gt = shufflevector <8 x float> %i.dl, <8 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 5, i32 6>
  %i.gu = shufflevector <2 x float> %i.gb, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.gv = shufflevector <4 x float> %i.gu, <4 x float> %i.gt, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.gw = shufflevector <4 x float> %i.bz, <4 x float> %i.gp, <4 x i32> <i32 2, i32 0, i32 4, i32 2>
  %i.gx = fsub <4 x float> %i.gv, %i.gw           ; 2 uses
  %i.gy = shufflevector <4 x float> %i.ck, <4 x float> %i.l, <4 x i32> <i32 poison, i32 2, i32 4, i32 poison>
  %i.gz = insertelement <4 x float> %i.gy, float %i.gf, i64 0
  %i.ha = shufflevector <4 x float> %i.gz, <4 x float> %i.ad, <4 x i32> <i32 0, i32 1, i32 2, i32 4> ; 2 uses
  %i.hb = fsub <4 x float> %i.gx, %i.ha
  %i.hc = fadd <4 x float> %i.gx, %i.ha
  %i.hd = shufflevector <4 x float> %i.hb, <4 x float> %i.hc, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  store <4 x float> %i.hd, ptr %i.fz, align 4, !tbaa !23
  %i.he = fsub float %i.eh, %i.fq
  %i.hf = fadd float %i.he, %i.ay
  %i.hg = getelementptr inbounds nuw i8, ptr %2, i64 284
  store float %i.hf, ptr %i.hg, align 4, !tbaa !23
  ...
  %i.hh = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %strided.vec, <8 x float> splat (float 2.500000e-01), <8 x float> %broadcast.splat)
  %i.hi = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %strided.vec199, <8 x float> splat (float 2.500000e-01), <8 x float> %broadcast.splat196)
  %i.hj = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %strided.vec200, <8 x float> splat (float 2.500000e-01), <8 x float> %broadcast.splat198)
  %i.hk = shufflevector <8 x float> %i.hh, <8 x float> %i.hi, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.hl = shufflevector <8 x float> %i.hj, <8 x float> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %interleaved.vec = shufflevector <16 x float> %i.hk, <16 x float> %i.hl, <24 x i32> <i32 0, i32 8, i32 16, i32 1, i32 9, i32 17, i32 2, i32 10, i32 18, i32 3, i32 11, i32 19, i32 4, i32 12, i32 20, i32 5, i32 13, i32 21, i32 6, i32 14, i32 22, i32 7, i32 15, i32 23>
  store <24 x float> %interleaved.vec, ptr %2, align 4, !tbaa !23
  %i.hm = getelementptr inbounds nuw i8, ptr %2, i64 96 ; 2 uses
  %wide.vec.1 = load <24 x float>, ptr %i.hm, align 4, !tbaa !23 ; 3 uses
  ...
  %i.hn = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %strided.vec.1, <8 x float> splat (float 2.500000e-01), <8 x float> %broadcast.splat)
  %i.ho = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %strided.vec199.1, <8 x float> splat (float 2.500000e-01), <8 x float> %broadcast.splat196)
  %i.hp = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %strided.vec200.1, <8 x float> splat (float 2.500000e-01), <8 x float> %broadcast.splat198)
  %i.hq = shufflevector <8 x float> %i.hn, <8 x float> %i.ho, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.hr = shufflevector <8 x float> %i.hp, <8 x float> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %interleaved.vec.1 = shufflevector <16 x float> %i.hq, <16 x float> %i.hr, <24 x i32> <i32 0, i32 8, i32 16, i32 1, i32 9, i32 17, i32 2, i32 10, i32 18, i32 3, i32 11, i32 19, i32 4, i32 12, i32 20, i32 5, i32 13, i32 21, i32 6, i32 14, i32 22, i32 7, i32 15, i32 23>
  store <24 x float> %interleaved.vec.1, ptr %i.hm, align 4, !tbaa !23
  %i.hs = getelementptr inbounds nuw i8, ptr %2, i64 192 ; 2 uses
  %wide.vec.2 = load <24 x float>, ptr %i.hs, align 4, !tbaa !23 ; 3 uses
  ...
  %i.ht = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %strided.vec.2, <8 x float> splat (float 2.500000e-01), <8 x float> %broadcast.splat)
  %i.hu = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %strided.vec199.2, <8 x float> splat (float 2.500000e-01), <8 x float> %broadcast.splat196)
  %i.hv = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %strided.vec200.2, <8 x float> splat (float 2.500000e-01), <8 x float> %broadcast.splat198)
  %i.hw = shufflevector <8 x float> %i.ht, <8 x float> %i.hu, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.hx = shufflevector <8 x float> %i.hv, <8 x float> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %interleaved.vec.2 = shufflevector <16 x float> %i.hw, <16 x float> %i.hx, <24 x i32> <i32 0, i32 8, i32 16, i32 1, i32 9, i32 17, i32 2, i32 10, i32 18, i32 3, i32 11, i32 19, i32 4, i32 12, i32 20, i32 5, i32 13, i32 21, i32 6, i32 14, i32 22, i32 7, i32 15, i32 23>
  store <24 x float> %interleaved.vec.2, ptr %i.hs, align 4, !tbaa !23
...
.loopexit:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block46
  ...
  br i1 %i.ai, label %bb.j, label %bb.i, !llvm.loop !104
...
vector.body44:                                    ; preds = %vector.body44, %vector.ph41
  ...
  %wide.load = load <2 x float>, ptr %i.av, align 4, !tbaa !23, !alias.scope !113
  %i.aw = getelementptr inbounds nuw [4 x i8], ptr %i.ah, i64 %index ; 2 uses
  %wide.load45 = load <2 x float>, ptr %i.aw, align 4, !tbaa !23, !alias.scope !114, !noalias !113
  %i.ax = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %broadcast.splat43, <2 x float> %wide.load, <2 x float> %wide.load45)
  store <2 x float> %i.ax, ptr %i.aw, align 4, !tbaa !23, !alias.scope !114, !noalias !113
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.ay = icmp eq i64 %index.next, %n.vec
  br i1 %i.ay, label %middle.block46, label %vector.body44, !llvm.loop !109
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  br i1 %prol.iter.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !110
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  br i1 %exitcond29.not.7, label %.loopexit, label %scalar.ph, !llvm.loop !111
...
bb.k:                                             ; preds = %bb.l, %.preheader6
  ...
  br i1 %exitcond24.not, label %.loopexit5, label %.preheader6, !llvm.loop !112
...
bb.a:
  ...
  %i.h = zext i1 %2 to i8
  store i8 %i.h, ptr %i.c, align 1, !tbaa !42
  store ptr %3, ptr %i.d, align 8, !tbaa !40
  store i32 %7, ptr %i.e, align 4, !tbaa !33
