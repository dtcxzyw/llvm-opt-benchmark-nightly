...
begin_hunk_0_@_ZL17getVdwDerivativesRK10t_inputrecf:bb.a
  store float %.sroa.553.0, ptr %.sroa.553.0..sroa_idx, align 4, !tbaa !28
  %.sroa.754.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 8
  store float %.sroa.754.0, ptr %.sroa.754.0..sroa_idx, align 4, !tbaa !28
  %.sroa.855.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 12
  store float %.sroa.855.0, ptr %.sroa.855.0..sroa_idx, align 4, !tbaa !28
  %i.eb = getelementptr inbounds nuw i8, ptr %0, i64 16
  store float 0.000000e+00, ptr %i.eb, align 4, !tbaa !28
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 20
  store float %.sroa.5.0, ptr %.sroa.5.0..sroa_idx, align 4, !tbaa !28
  %.sroa.7.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 24
  store float %.sroa.7.0, ptr %.sroa.7.0..sroa_idx, align 4, !tbaa !28
  %.sroa.8.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 28
  store float %.sroa.8.0, ptr %.sroa.8.0..sroa_idx, align 4, !tbaa !28
  ret void
...
._crit_edge114:                                   ; preds = %._crit_edge, %.preheader
  %.077.lcssa = phi double [ 0.000000e+00, %.preheader ], [ %i.gt, %._crit_edge ] ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph113, %._crit_edge
  ...
  %.077111 = phi double [ 0.000000e+00, %.lr.ph113 ], [ %i.gt, %._crit_edge ]
  %i.o = getelementptr inbounds nuw [32 x i8], ptr %0, i64 %.076112 ; 13 uses
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 12 ; 3 uses
  %i.q = load i16, ptr %i.p, align 4, !tbaa !27   ; 2 uses
  %i.r = icmp sgt i16 %i.q, 0
  %.pre.i = load i16, ptr %i.o, align 4, !tbaa !25 ; 2 uses
...
bb.c:                                             ; preds = %_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit.i
  ...
  %i.z = load float, ptr %i.y, align 4, !tbaa !23 ; 2 uses
...
_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit.thread.i: ; preds = %_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit.i, %._ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit.thread_crit_edge.i
  ...
  %i.ay = load float, ptr %i.ax, align 4, !tbaa !23
...
._crit_edge:                                      ; preds = %bb.l
  ...
  br i1 %exitcond116.not, label %._crit_edge114, label %bb.b, !llvm.loop !321

bb.d:                                             ; preds = %.lr.ph, %bb.l
  %.075110 = phi i64 [ %.076112, %.lr.ph ], [ %i.gu, %bb.l ] ; 3 uses
  %.1109 = phi double [ %.077111, %.lr.ph ], [ %i.gt, %bb.l ]
  ...
  %i.bk = load i16, ptr %i.bj, align 4, !tbaa !27 ; 2 uses
  %i.bl = icmp sgt i16 %i.bk, 0                   ; 2 uses
  %.pre.i81 = load i16, ptr %i.bi, align 4, !tbaa !25 ; 3 uses
...
_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit.i87: ; preds = %bb.d
  ...
  %i.bn = load i16, ptr %i.bm, align 2, !tbaa !24
...
bb.e:                                             ; preds = %_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit.i87
  ...
  %i.bt = load float, ptr %i.bs, align 4, !tbaa !23 ; 2 uses
  ...
  %i.ce = load float, ptr %i.cd, align 4, !tbaa !26
...
_ZL15get_atom_sigma2fRK33AtomNonbondedAndKineticPropertiesPfS2_.exit89: ; preds = %bb.e, %_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit.thread.i84
  ...
  %i.cx = load i32, ptr %i.bc, align 4, !tbaa !250
  %i.cy = load i32, ptr %2, align 8, !tbaa !323
  %i.cz = mul nsw i32 %i.cy, %i.cx
  %i.da = getelementptr inbounds nuw i8, ptr %i.bi, i64 4
  %i.db = load i32, ptr %i.da, align 4, !tbaa !250
...
bb.f:                                             ; preds = %_ZL15get_atom_sigma2fRK33AtomNonbondedAndKineticPropertiesPfS2_.exit89
  %i.dn = load i16, ptr %i.bd, align 2, !tbaa !24
  %i.do = sitofp i16 %i.dn to float
  %i.dp = fmul nnan float %i.do, 4.000000e-01
  %i.dq = load i16, ptr %i.o, align 4, !tbaa !25
...
bb.g:                                             ; preds = %_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit
  ...
  %i.dv = load i16, ptr %i.du, align 2, !tbaa !24
...
_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit90: ; preds = %_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit, %bb.g
  ...
  %i.ec = load float, ptr %i.be, align 4, !tbaa !251
  %i.ed = load i16, ptr %i.bf, align 4, !tbaa !254
  %i.ee = getelementptr inbounds nuw i8, ptr %i.bi, i64 20
  %i.ef = load float, ptr %i.ee, align 4, !tbaa !251
  %i.eg = getelementptr inbounds nuw i8, ptr %i.bi, i64 8
  %i.eh = load i16, ptr %i.eg, align 4, !tbaa !254
  %i.ei = load float, ptr %6, align 4, !tbaa !258
  %i.ej = sitofp i16 %i.ed to float
  %i.ek = sitofp i16 %i.eh to float
  %i.el = load <2 x float>, ptr %i.i, align 4, !tbaa !28
  %i.em = fmul float %i.ec, %i.ej                 ; 2 uses
  %i.en = fmul float %i.ef, %i.ek                 ; 2 uses
  %i.eo = fmul float %i.ei, %i.em
  %i.ep = insertelement <2 x float> poison, float %i.em, i64 0
  %i.eq = insertelement <2 x float> poison, float %i.en, i64 0
  %i.er = fmul float %i.eo, %i.en
  %i.es = insertelement <4 x float> <float poison, float poison, float poison, float 0.000000e+00>, float %i.er, i64 0
  %i.et = shufflevector <2 x float> %i.eq, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 poison, i32 poison>
  %i.eu = shufflevector <2 x float> %i.ep, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 poison, i32 poison>
  %i.ev = shufflevector <2 x float> %i.el, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.ew = fmul <4 x float> %i.eu, %i.ev
  %i.ex = fmul <4 x float> %i.et, %i.ew
  %i.ey = shufflevector <4 x float> %i.es, <4 x float> %i.ex, <4 x i32> <i32 0, i32 4, i32 5, i32 3>
  store <4 x float> %i.ey, ptr %13, align 16, !tbaa !28
  %i.ez = load i16, ptr %i.p, align 4, !tbaa !27
  %i.fa = icmp sgt i16 %i.ez, 0
  br i1 %i.fa, label %bb.h, label %_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit91

bb.h:                                             ; preds = %_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit90
  %i.fb = load i16, ptr %i.bd, align 2, !tbaa !24
  %i.fc = sitofp i16 %i.fb to float
  %i.fd = fmul nnan float %i.fc, 4.000000e-01
  %i.fe = load i16, ptr %i.o, align 4, !tbaa !25
  %i.ff = sitofp i16 %i.fe to float
...
_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit91: ; preds = %_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit90, %bb.h
  %i.fh = phi i1 [ false, %_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit90 ], [ %i.fg, %bb.h ]
  %i.fi = load i16, ptr %i.bj, align 4, !tbaa !27
  %i.fj = icmp sgt i16 %i.fi, 0
  br i1 %i.fj, label %bb.i, label %_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit92

bb.i:                                             ; preds = %_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit91
  %i.fk = getelementptr inbounds nuw i8, ptr %i.bi, i64 10
  %i.fl = load i16, ptr %i.fk, align 2, !tbaa !24
  %i.fm = sitofp i16 %i.fl to float
  %i.fn = fmul nnan float %i.fm, 4.000000e-01
  %i.fo = load i16, ptr %i.bi, align 4, !tbaa !25
  %i.fp = sitofp i16 %i.fo to float
  %i.fq = fcmp olt float %i.fn, %i.fp
...
_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit92: ; preds = %_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit91, %bb.i
  %i.fr = phi i1 [ false, %_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit91 ], [ %i.fq, %bb.i ]
  %i.fs = call fastcc noundef float @_ZL19energyDriftAtomPairbbffffPK17pot_derivatives_t(i1 noundef zeroext %i.fh, i1 noundef zeroext %i.fr, float noundef %i.cw, float noundef %.0107, float noundef %.0108, float noundef %i.j, ptr noundef %13)
  %i.ft = fadd float %i.eb, %i.fs
  %i.fu = icmp eq i64 %.075110, %.076112
  %i.fv = load i32, ptr %i.bg, align 4, !tbaa !256 ; 2 uses
  %i.fw = sitofp i32 %i.fv to double              ; 2 uses
  %i.fx = fpext float %i.ft to double
  br i1 %i.fu, label %bb.j, label %bb.k
...
bb.j:                                             ; preds = %_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit92
  ...
  %i.ga = fmul nnan double %i.fw, %i.fz
  %i.gb = fmul nnan double %i.ga, 5.000000e-01
  br label %bb.l

bb.k:                                             ; preds = %_ZNK33AtomNonbondedAndKineticProperties13hasConstraintEv.exit92
  %i.gc = getelementptr inbounds nuw i8, ptr %i.bi, i64 28
  %i.gd = load i32, ptr %i.gc, align 4, !tbaa !256
  %i.ge = sitofp i32 %i.gd to double
  %i.gf = fmul nnan double %i.fw, %i.ge
  br label %bb.l

bb.l:                                             ; preds = %bb.k, %bb.j
  %.sink = phi double [ %i.gf, %bb.k ], [ %i.gb, %bb.j ]
  %i.gg = fmul double %.sink, %i.fx
  %.0 = fptrunc double %i.gg to float
  %i.gh = tail call noundef float @sqrtf(float noundef %i.cw) #26
  %i.gi = fadd float %9, %i.gh                    ; 2 uses
  %i.gj = fmul float %i.gi, %i.gi
  %i.gk = fpext float %i.gj to double
  %i.gl = fmul double %i.gk, f0x402921FB54442D18
  %i.gm = fmul double %i.gl, %i.k
  %i.gn = fdiv double %i.gm, %i.l
  %i.go = fpext float %.0 to double
  ...
  %i.gt = fadd double %.1109, %i.gs               ; 3 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %13) #26
  call void @llvm.lifetime.end.p0(ptr nonnull %12) #26
  %i.gu = add nuw nsw i64 %.075110, 1             ; 2 uses
  %exitcond.not = icmp eq i64 %i.gu, %i.e
  br i1 %exitcond.not, label %._crit_edge, label %bb.d, !llvm.loop !322
...
bb.n:                                             ; preds = %._crit_edge114
  %i.gv = fptrunc double %.077.lcssa to float
  br label %bb.o

bb.o:                                             ; preds = %bb.a, %bb.n
  %.078 = phi float [ %i.gv, %bb.n ], [ 0.000000e+00, %bb.a ]
  ret float %.078
}
