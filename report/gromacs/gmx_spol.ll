...
._crit_edge:                                      ; preds = %bb.az, %bb.au, %.lr.ph317
  ...
  %i.lf = phi float [ %i.jb, %.lr.ph317 ], [ %i.jz, %bb.au ], [ %i.lc, %bb.az ] ; 5 uses
  %i.lg = phi float [ %i.jc, %.lr.ph317 ], [ %i.ka, %bb.au ], [ %i.ld, %bb.az ] ; 5 uses
...
bb.bc:                                            ; preds = %bb.bb
  ...
  %i.lw = fmul float %i.lg, %i.lv                 ; 2 uses
  %13 = insertelement <3 x float> poison, float %i.lv, i64 0
  %14 = shufflevector <3 x float> %13, <3 x float> poison, <3 x i32> zeroinitializer
  %15 = insertelement <3 x float> poison, float %.lcssa275, i64 0
  %16 = insertelement <3 x float> %15, float %i.lg, i64 1
  %17 = insertelement <3 x float> %16, float %i.lf, i64 2
  %18 = fmul <3 x float> %17, %14                 ; 4 uses
  %i.lx = fmul float %i.lf, %i.lv                 ; 2 uses
...
.preheader.1:                                     ; preds = %._crit_edge292..preheader249_crit_edge, %.preheader249.loopexit
  ...
  %i.rw = shufflevector <3 x float> %18, <3 x float> poison, <2 x i32> zeroinitializer
  ...
  %19 = shufflevector <3 x float> %18, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  ...
  %21 = extractelement <3 x float> %18, i64 0
  br label %bb.bd

bb.bd:                                            ; preds = %bb.bb, %.preheader.1
  %.promoted325336 = phi float [ %i.lx, %.preheader.1 ], [ %.promoted325337, %bb.bb ] ; 2 uses
  %.promoted331 = phi float [ %i.lw, %.preheader.1 ], [ %.promoted332, %bb.bb ] ; 2 uses
  %i.sw = phi float [ %i.lx, %.preheader.1 ], [ %i.lf, %bb.bb ]
  %i.sx = phi float [ %i.lw, %.preheader.1 ], [ %i.lg, %bb.bb ]
  %.lcssa275307 = phi float [ %21, %.preheader.1 ], [ %.lcssa275, %bb.bb ] ; 2 uses
