...
.lr.ph40:                                         ; preds = %bb.c
  ...
  %i.az = tail call double @llvm.fmuladd.f64(double %i.u, double %i.u, double %5)
  ...
  %i.bf = insertelement <2 x double> %4, double %i.bb, i64 0
  ...
  %i.bk = fmul double %7, 0.000000e+00
...
bb.d:                                             ; preds = %.lr.ph40, %_ZN17colvarproxy_atoms17get_atom_velocityEi.exit
  ...
  store i64 %i.bu, ptr %i.al, align 8, !tbaa !32, !noalias !750
  ...
  store i64 %i.bu, ptr %i.am, align 8, !tbaa !31, !noalias !750
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i: ; preds = %bb.e
  %i.bz = load i64, ptr %i.al, align 8, !tbaa !32, !noalias !750
  %i.ca = add i64 %i.bz, 1
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i3.i: ; preds = %bb.f
  %i.ce = load i64, ptr %i.al, align 8, !tbaa !32, !noalias !750
  %i.cf = add i64 %i.ce, 1
...
_ZN17colvarproxy_atoms17get_atom_velocityEi.exit: ; preds = %bb.e, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #28, !noalias !750
  %i.cg = load ptr, ptr %6, align 8, !tbaa !114
...
bb.d:                                             ; preds = %.lr.ph31, %bb.d
  ...
  %.sroa.6.0.copyload.a = load double, ptr %i.bm, align 8, !tbaa !109 ; 2 uses
  %.sroa.018.0.copyload = load double, ptr %.sroa.6.0..sroa_idx, align 8, !tbaa !109 ; 2 uses
  %.sroa.9.0.copyload = load double, ptr %.sroa.9.0..sroa_idx, align 8, !tbaa !109 ; 2 uses
  %i.bo = insertelement <2 x double> poison, double %.sroa.018.0.copyload, i64 0
  %i.bp = shufflevector <2 x double> %i.bo, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bq = fmul <2 x double> %i.bf, %i.bp
  %i.br = insertelement <2 x double> poison, double %.sroa.6.0.copyload.a, i64 0
  ...
  %i.ca = fmul double %i.bh, %.sroa.018.0.copyload
  %i.cb = tail call double @llvm.fmuladd.f64(double %i.bi, double %.sroa.6.0.copyload.a, double %i.ca)
...
bb.a:
  ...
  %i.bc = load double, ptr %i.b, align 8, !tbaa !109, !noalias !867 ; 2 uses
  %i.bd = load double, ptr %i.o, align 8, !tbaa !109, !noalias !868 ; 2 uses
  %i.be = load double, ptr %i.z, align 8, !tbaa !109, !noalias !869 ; 2 uses
  %i.bf = load double, ptr %i.ak, align 8, !tbaa !109, !noalias !870 ; 2 uses
  %i.bg = load double, ptr %2, align 8, !tbaa !109 ; 2 uses
  %3 = load double, ptr %i.c, align 8, !tbaa !109, !noalias !867 ; 2 uses
  %i.bh = fadd double %i.bb, %3
  %4 = load <2 x double>, ptr %i.e, align 8, !tbaa !109, !noalias !867 ; 2 uses
  %i.bi = extractelement <2 x double> %4, i64 0   ; 2 uses
  ...
  %5 = insertelement <4 x double> poison, double %i.bg, i64 0
  %6 = shufflevector <4 x double> %5, <4 x double> poison, <4 x i32> zeroinitializer ; 2 uses
  %i.bo = insertelement <4 x double> poison, double %i.bn, i64 0
  %7 = fsub double %i.bb, %3                      ; 2 uses
  ...
  %i.bz = insertelement <4 x double> %i.bo, double %i.by, i64 1
  ...
  %i.cm = fmul <4 x double> %6, %i.cl
  %i.cn = insertelement <2 x double> %i.bs, double %i.bc, i64 0
  %i.co = fadd <2 x double> %i.bp, %i.cn
  %i.cp = insertelement <4 x double> poison, double %7, i64 0
  ...
  %i.cs = insertelement <4 x double> %i.cr, double %8, i64 3
  %i.ct = shufflevector <2 x double> %4, <2 x double> %i.bv, <4 x i32> <i32 0, i32 1, i32 2, i32 1>
  ...
  %i.cy = fmul <4 x double> %6, %i.cx
  %i.cz = fsub double %7, %i.bi
  %i.da = fadd double %i.cz, %i.bm
  %i.db = fmul double %i.bg, %i.da
  %i.dc = fadd <4 x double> %i.cm, zeroinitializer
  %i.dd = fadd <4 x double> %i.cy, zeroinitializer
  %i.de = fadd double %i.db, 0.000000e+00
  %i.df = load double, ptr %i.m, align 8, !tbaa !109 ; 2 uses
  %i.dg = load double, ptr %i.n, align 8, !tbaa !109, !noalias !868 ; 2 uses
  %9 = load double, ptr %i.p, align 8, !tbaa !109, !noalias !868 ; 2 uses
  %i.dh = fadd double %i.dg, %9
  %10 = load <2 x double>, ptr %i.r, align 8, !tbaa !109, !noalias !868 ; 2 uses
  %i.di = extractelement <2 x double> %10, i64 0  ; 2 uses
  ...
  %i.do = insertelement <4 x double> poison, double %i.df, i64 0
  ...
  %i.ep = insertelement <2 x double> %i.du, double %i.bd, i64 0
  %i.eq = fadd <2 x double> %i.dr, %i.ep
  %i.er = insertelement <4 x double> poison, double %11, i64 0
  ...
  %i.eu = insertelement <4 x double> %i.et, double %12, i64 3
  %i.ev = shufflevector <2 x double> %10, <2 x double> %i.dx, <4 x i32> <i32 0, i32 1, i32 2, i32 1>
  ...
  %i.fb = fsub double %11, %i.di
  %i.fc = fadd double %i.fb, %i.dm
  %i.fd = fmul double %i.df, %i.fc
  %i.fe = fadd <4 x double> %i.dc, %i.eo
  %i.ff = fadd <4 x double> %i.dd, %i.fa
  %i.fg = fadd double %i.de, %i.fd
  %i.fh = load double, ptr %i.x, align 8, !tbaa !109 ; 2 uses
  %i.fi = load double, ptr %i.y, align 8, !tbaa !109, !noalias !869 ; 2 uses
  %13 = load double, ptr %i.aa, align 8, !tbaa !109, !noalias !869 ; 2 uses
  %i.fj = fadd double %i.fi, %13
  %14 = load <2 x double>, ptr %i.ac, align 8, !tbaa !109, !noalias !869 ; 2 uses
  %i.fk = extractelement <2 x double> %14, i64 0  ; 2 uses
  ...
  %i.fq = insertelement <4 x double> poison, double %i.fh, i64 0
  ...
  %i.gr = insertelement <2 x double> %i.fw, double %i.be, i64 0
  %i.gs = fadd <2 x double> %i.ft, %i.gr
  %i.gt = insertelement <4 x double> poison, double %15, i64 0
  ...
  %i.gx = shufflevector <2 x double> %14, <2 x double> %i.fz, <4 x i32> <i32 0, i32 1, i32 2, i32 1>
  ...
  %i.hd = fsub double %15, %i.fk
  %i.he = fadd double %i.hd, %i.fo
  %i.hf = fmul double %i.fh, %i.he
  %i.hg = fadd <4 x double> %i.fe, %i.gq
  %i.hh = fadd <4 x double> %i.ff, %i.hc
  %i.hi = fadd double %i.fg, %i.hf
  %17 = load double, ptr %i.ai, align 8, !tbaa !109 ; 2 uses
  %i.hj = load double, ptr %i.aj, align 8, !tbaa !109, !noalias !870 ; 2 uses
  %i.hk = load double, ptr %i.al, align 8, !tbaa !109, !noalias !870 ; 2 uses
  %18 = fadd double %i.hj, %i.hk
  %19 = load <2 x double>, ptr %i.an, align 8, !tbaa !109, !noalias !870 ; 2 uses
  %20 = extractelement <2 x double> %19, i64 0    ; 2 uses
  %21 = fsub double %18, %20
  %22 = load <3 x double>, ptr %i.ar, align 8, !tbaa !109, !noalias !870 ; 3 uses
  %23 = shufflevector <3 x double> %22, <3 x double> poison, <4 x i32> <i32 2, i32 1, i32 0, i32 1> ; 2 uses
  %i.hl = extractelement <3 x double> %22, i64 2  ; 2 uses
  %i.hm = fsub double %21, %i.hl
  %i.hn = insertelement <4 x double> poison, double %17, i64 0
  ...
  %24 = fsub double %i.hj, %i.hk                  ; 2 uses
  ...
  %i.ih = shufflevector <3 x double> %22, <3 x double> poison, <2 x i32> <i32 0, i32 poison>
  ...
  %i.io = insertelement <2 x double> %i.ht, double %i.bf, i64 0
  %i.ip = fadd <2 x double> %i.hq, %i.io
  %i.iq = insertelement <4 x double> poison, double %24, i64 0
  ...
  %i.it = insertelement <4 x double> %i.is, double %25, i64 3
  %i.iu = shufflevector <2 x double> %19, <2 x double> %i.hw, <4 x i32> <i32 0, i32 1, i32 2, i32 1>
  %i.iv = fadd <4 x double> %i.it, %i.iu          ; 2 uses
  %i.iw = fsub <4 x double> %i.iv, %23
  %i.ix = fadd <4 x double> %i.iv, %23
  %i.iy = shufflevector <4 x double> %i.iw, <4 x double> %i.ix, <4 x i32> <i32 0, i32 5, i32 6, i32 7>
  %i.iz = fmul <4 x double> %i.ho, %i.iy
  %i.ja = fsub double %24, %20
  %i.jb = fadd double %i.ja, %i.hl
  %i.jc = fmul double %17, %i.jb
