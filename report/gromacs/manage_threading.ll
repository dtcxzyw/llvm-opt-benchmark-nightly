...
bb.d:                                             ; preds = %bb.c, %bb.b, %._crit_edge.i.i.i.i
  ...
  store i64 %i.i, ptr %i.j, align 8, !tbaa !143
...
.noexc13:                                         ; preds = %.noexc3.i
  ...
  %.idx.i.i.i.i.i.i.i.i.a = add nsw i64 %i.l, -1  ; 2 uses
  %5 = icmp eq i64 %.idx.i.i.i.i.i.i.i.i.a, 0
...
_ZSt6fill_nIPimiET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i.i: ; preds = %.noexc13
  %.idx.i.i.i.i.i.i.i.i = shl nuw nsw i64 %.idx.i.i.i.i.i.i.i.i.a, 2 ; 2 uses
...
bb.b:                                             ; preds = %_ZSt6fill_nIPimiET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i.i, %.noexc13, %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i.i
  ...
  store ptr %.0.i.i.i.i.i.i, ptr %i.s, align 8, !tbaa !43
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 128
  store i32 2, ptr %i.t, align 8, !tbaa !45
  ...
  %i.v = invoke noalias noundef nonnull dereferenceable(760) ptr @_Znwm(i64 noundef 760) #26
          to label %bb.c unwind label %bb.g       ; 3 uses

bb.c:                                             ; preds = %bb.b
  store ptr %i.v, ptr %i.u, align 8, !tbaa !44
  %i.w = getelementptr inbounds nuw i8, ptr %i.v, i64 760 ; 2 uses
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 152 ; 2 uses
  store ptr %i.w, ptr %i.x, align 8, !tbaa !68
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 144
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(760) %i.v, i8 0, i64 760, i1 false)
  store ptr %i.w, ptr %i.y, align 8, !tbaa !43
  ...
  %i.aa = tail call ptr @getenv(ptr noundef nonnull @.str.7) #3 ; 2 uses
  %.not = icmp eq ptr %i.aa, null
  br i1 %.not, label %bb.h, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.ab = tail call i32 (ptr, ptr, ...) @__isoc23_sscanf(ptr noundef nonnull %i.aa, ptr noundef nonnull @.str.8, ptr noundef nonnull %i.f) #3 ; 0 uses
  %.not10 = icmp eq ptr %4, null
  br i1 %.not10, label %bb.i, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.ac = load i32, ptr %i.f, align 4, !tbaa !47
  %i.ad = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef nonnull %4, ptr noundef nonnull @.str.9, i32 noundef %i.ac) #3 ; 0 uses
  br label %bb.i

bb.f:                                             ; preds = %.noexc3.i, %.noexc.i
  %i.ae = landingpad { ptr, i32 }
          cleanup
  br label %_ZN12WorkDivisionD2Ev.exit22
...
bb.i:                                             ; preds = %bb.d, %bb.e, %bb.h
  %i.ag = sext i32 %1 to i64                      ; 4 uses
  %i.ah = getelementptr inbounds nuw i8, ptr %0, i64 168 ; 2 uses
  %i.ai = load ptr, ptr %i.ah, align 8, !tbaa !69 ; 3 uses
  %i.aj = load ptr, ptr %i.z, align 8, !tbaa !70  ; 2 uses
  %i.ak = ptrtoint ptr %i.ai to i64
  %i.al = ptrtoint ptr %i.aj to i64
  %i.am = sub i64 %i.ak, %i.al
  %i.an = sdiv exact i64 %i.am, 48                ; 3 uses
  %i.ao = icmp ult i64 %i.an, %i.ag
  br i1 %i.ao, label %bb.j, label %bb.k

bb.j:                                             ; preds = %bb.i
  %i.ap = sub nuw nsw i64 %i.ag, %i.an
  invoke void @_ZNSt6vectorI26CentersOfMassScaledBuffersSaIS0_EE17_M_default_appendEm(ptr noundef nonnull align 8 dereferenceable(24) %i.z, i64 noundef %i.ap)
          to label %_ZNSt6vectorI26CentersOfMassScaledBuffersSaIS0_EE6resizeEm.exit unwind label %bb.o

bb.k:                                             ; preds = %bb.i
  %i.aq = icmp ugt i64 %i.an, %i.ag
  br i1 %i.aq, label %bb.l, label %_ZNSt6vectorI26CentersOfMassScaledBuffersSaIS0_EE6resizeEm.exit

bb.l:                                             ; preds = %bb.k
  %i.ar = getelementptr inbounds nuw [48 x i8], ptr %i.aj, i64 %i.ag ; 3 uses
...
.lr.ph.i.i.i.i:                                   ; preds = %bb.l, %_ZSt8_DestroyI26CentersOfMassScaledBuffersEvPT_.exit.i.i.i.i
  %.05.i.i.i.i = phi ptr [ %i.bf, %_ZSt8_DestroyI26CentersOfMassScaledBuffersEvPT_.exit.i.i.i.i ], [ %i.ar, %bb.l ] ; 5 uses
  %i.as = getelementptr inbounds nuw i8, ptr %.05.i.i.i.i, i64 24
  %i.at = load ptr, ptr %i.as, align 8, !tbaa !71 ; 3 uses
...
bb.m:                                             ; preds = %.lr.ph.i.i.i.i
  %i.au = getelementptr inbounds nuw i8, ptr %.05.i.i.i.i, i64 40
...
_ZNSt6vectorIN3gmx11BasicVectorIfEESaIS2_EED2Ev.exit.i.i.i.i.i.i: ; preds = %bb.m, %.lr.ph.i.i.i.i
  %i.az = load ptr, ptr %.05.i.i.i.i, align 8, !tbaa !71 ; 3 uses
  %.not.i.i.i1.i.i.i.i.i.i = icmp eq ptr %i.az, null
...
bb.n:                                             ; preds = %_ZNSt6vectorIN3gmx11BasicVectorIfEESaIS2_EED2Ev.exit.i.i.i.i.i.i
  %i.ba = getelementptr inbounds nuw i8, ptr %.05.i.i.i.i, i64 16
  %i.bb = load ptr, ptr %i.ba, align 8, !tbaa !72
  %i.bc = ptrtoint ptr %i.bb to i64
  %i.bd = ptrtoint ptr %i.az to i64
  %i.be = sub i64 %i.bc, %i.bd
  tail call void @_ZdlPvm(ptr noundef nonnull %i.az, i64 noundef %i.be) #25
...
_ZSt8_DestroyI26CentersOfMassScaledBuffersEvPT_.exit.i.i.i.i: ; preds = %bb.n, %_ZNSt6vectorIN3gmx11BasicVectorIfEESaIS2_EED2Ev.exit.i.i.i.i.i.i
  ...
  %.not.i.i.i.i = icmp eq ptr %i.bf, %i.ai
...
_ZSt8_DestroyIP26CentersOfMassScaledBuffersS0_EvT_S2_RSaIT0_E.exit.i.i: ; preds = %_ZSt8_DestroyI26CentersOfMassScaledBuffersEvPT_.exit.i.i.i.i
  store ptr %i.ar, ptr %i.ah, align 8, !tbaa !69
...
bb.o:                                             ; preds = %bb.j
  %i.bg = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  tail call void @_ZNSt6vectorI26CentersOfMassScaledBuffersSaIS0_EED2Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %i.z) #3
  %i.bh = load ptr, ptr %i.u, align 8, !tbaa !44  ; 3 uses
  %.not.i.i.i.i20 = icmp eq ptr %i.bh, null
  br i1 %.not.i.i.i.i20, label %_ZN12WorkDivisionD2Ev.exit, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.bi = load ptr, ptr %i.x, align 8, !tbaa !68
  %i.bj = ptrtoint ptr %i.bi to i64
  %i.bk = ptrtoint ptr %i.bh to i64
  %i.bl = sub i64 %i.bj, %i.bk
  tail call void @_ZdlPvm(ptr noundef nonnull %i.bh, i64 noundef %i.bl) #25
  br label %_ZN12WorkDivisionD2Ev.exit

_ZN12WorkDivisionD2Ev.exit:                       ; preds = %bb.p, %bb.o, %bb.g
  %.pn = phi { ptr, i32 } [ %i.af, %bb.g ], [ %i.bg, %bb.o ], [ %i.bg, %bb.p ] ; 2 uses
  %i.bm = load ptr, ptr %i.j, align 8, !tbaa !44  ; 3 uses
  %.not.i.i.i.i21 = icmp eq ptr %i.bm, null
  br i1 %.not.i.i.i.i21, label %_ZN12WorkDivisionD2Ev.exit22, label %bb.q
...
bb.q:                                             ; preds = %_ZN12WorkDivisionD2Ev.exit
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %i.bm, i64 noundef %i.br) #25
  br label %_ZN12WorkDivisionD2Ev.exit22

_ZN12WorkDivisionD2Ev.exit22:                     ; preds = %bb.q, %_ZN12WorkDivisionD2Ev.exit, %bb.f
  %.pn.pn = phi { ptr, i32 } [ %i.ae, %bb.f ], [ %.pn, %_ZN12WorkDivisionD2Ev.exit ], [ %.pn, %bb.q ]
