...
begin_hunk_0_@Ptngc_writemanybits:bb.a
  ...
  store i32 %i.cb, ptr %i.bz, align 4, !tbaa !11
...
.lr.ph.i.i32:                                     ; preds = %.lr.ph.i.i32, %.lr.ph.preheader.i.i30
  ...
  store i32 %i.ch, ptr %i.bz, align 4, !tbaa !11
  %i.ci = shl i32 255, %i.ch
  %i.cj = xor i32 %i.ci, -1
  %i.ck = lshr i32 %i.cf, %i.ch
  %i.cl = trunc i32 %i.ck to i8
  store i8 %i.cl, ptr %i.ce, align 1, !tbaa !16
  %i.cm = load ptr, ptr %3, align 8, !tbaa !15
  %i.cn = getelementptr inbounds nuw i8, ptr %i.cm, i64 1 ; 2 uses
  store ptr %i.cn, ptr %3, align 8, !tbaa !15
  %i.co = load i32, ptr %0, align 4, !tbaa !12
  %i.cp = and i32 %i.co, %i.cj                    ; 2 uses
  store i32 %i.cp, ptr %0, align 4, !tbaa !12
  %i.cq = load i32, ptr %i.bz, align 4, !tbaa !11 ; 2 uses
  %i.cr = icmp sgt i32 %i.cq, 7
  br i1 %i.cr, label %.lr.ph.i.i32, label %Ptngc_writebits.exit33, !llvm.loop !0
...
vector.body560:                                   ; preds = %vector.body560, %vector.ph558
  ...
  %wide.load566 = load <8 x i32>, ptr %i.o, align 4, !tbaa !19
  %wide.load567 = load <8 x i32>, ptr %i.p, align 4, !tbaa !19
  %wide.load568 = load <8 x i32>, ptr %i.q, align 4, !tbaa !19
  %wide.load569 = load <8 x i32>, ptr %i.r, align 4, !tbaa !19
  ...
  br i1 %i.w, label %middle.block571, label %vector.body560, !llvm.loop !26
...
vec.epilog.iter.check580:                         ; preds = %middle.block571
  ...
  br i1 %min.epilog.iters.check581, label %.lr.ph289.preheader, label %vec.epilog.ph582, !prof !56
...
vec.epilog.vector.body586:                        ; preds = %vec.epilog.vector.body586, %vec.epilog.ph582
  ...
  %wide.load589 = load <4 x i32>, ptr %i.y, align 4, !tbaa !19
  ...
  br i1 %i.aa, label %vec.epilog.middle.block591, label %vec.epilog.vector.body586, !llvm.loop !27
...
.lr.ph289:                                        ; preds = %.lr.ph289.preheader, %.lr.ph289
  ...
  br i1 %exitcond351.not, label %._crit_edge, label %.lr.ph289, !llvm.loop !28
...
vector.body680:                                   ; preds = %vector.body680, %vector.ph672
  ...
  %wide.masked.gather684 = tail call <8 x i32> @llvm.masked.gather.v8i32.v8p0(<8 x ptr> align 4 %wide.gep683, <8 x i1> splat (i1 true), <8 x i32> poison), !tbaa !19, !alias.scope !57
  %i.co = sub nsw <8 x i32> %wide.masked.gather684, %broadcast.splat679
  %i.cp = getelementptr [4 x i8], ptr %i.cj, i64 %index681
  store <8 x i32> %i.co, ptr %i.cp, align 4, !tbaa !19, !alias.scope !58, !noalias !57
  ...
  br i1 %i.cq, label %middle.block687, label %vector.body680, !llvm.loop !32
...
scalar.ph670.prol:                                ; preds = %scalar.ph670.preheader, %scalar.ph670.prol
  ...
  %indvars.iv.next353.prol = add i64 %indvars.iv352.prol, 1 ; 3 uses
  %i.cx = getelementptr inbounds [4 x i8], ptr %i.j, i64 %indvars.iv352.prol
  store i32 %i.cw, ptr %i.cx, align 4, !tbaa !19
  ...
  br i1 %prol.iter.cmp.not, label %scalar.ph670.prol.loopexit, label %scalar.ph670.prol, !llvm.loop !33
...
scalar.ph670:                                     ; preds = %scalar.ph670.prol.loopexit, %scalar.ph670
  ...
  store i32 %i.dn, ptr %i.dp, align 4, !tbaa !19
  ...
  store i32 %i.dw, ptr %i.dy, align 4, !tbaa !19
  ...
  %indvars.iv.next353.3 = add i64 %indvars.iv352, 4 ; 2 uses
  %i.ef = getelementptr [4 x i8], ptr %i.j, i64 %indvars.iv352
  %i.eg = getelementptr i8, ptr %i.ef, i64 12
  store i32 %i.ee, ptr %i.eg, align 4, !tbaa !19
  ...
  br i1 %exitcond360.not.3, label %._crit_edge294.us.us.preheader, label %scalar.ph670, !llvm.loop !34
...
._crit_edge294.us.us.preheader:                   ; preds = %scalar.ph670.prol.loopexit, %scalar.ph670, %middle.block687
  ...
  %indvars.iv.next353.lcssa = phi i64 [ %i.ci, %middle.block687 ], [ %indvars.iv.next353.lcssa694.unr, %scalar.ph670.prol.loopexit ], [ %indvars.iv.next353.3, %scalar.ph670 ] ; 6 uses
...
vector.memcheck620:                               ; preds = %vector.scevcheck616
  %i.em = shl i64 %indvars.iv.next353.lcssa, 2
  %i.en = getelementptr i8, ptr %i.j, i64 %i.em
  %7 = add i64 %.0146299.us, %wide.trip.count359
  %8 = add i64 %7, %indvars.iv354.lcssa
  %9 = shl i64 %8, 2
  %i.eo = getelementptr i8, ptr %i.j, i64 %9
  %scevgep622 = getelementptr i8, ptr %i.eo, i64 4
  %bound0629 = icmp ult ptr %i.en, %scevgep628
...
vector.body642:                                   ; preds = %vector.body642, %vector.ph634
  ...
  %wide.masked.gather646 = tail call <8 x i32> @llvm.masked.gather.v8i32.v8p0(<8 x ptr> align 4 %wide.gep645, <8 x i1> splat (i1 true), <8 x i32> poison), !tbaa !19, !alias.scope !59
  %i.ew = sub nsw <8 x i32> %wide.masked.gather646, %broadcast.splat641
  %i.ex = getelementptr [4 x i8], ptr %i.eq, i64 %index643
  store <8 x i32> %i.ew, ptr %i.ex, align 4, !tbaa !19, !alias.scope !60, !noalias !59
  ...
  br i1 %i.ey, label %middle.block649, label %vector.body642, !llvm.loop !38
...
._crit_edge294.us.us.prol:                        ; preds = %._crit_edge294.us.us.preheader693, %._crit_edge294.us.us.prol
  ...
  %indvars.iv.next353.1.prol = add i64 %indvars.iv352.1.prol, 1 ; 3 uses
  %i.fg = getelementptr inbounds [4 x i8], ptr %i.j, i64 %indvars.iv352.1.prol
  store i32 %i.ff, ptr %i.fg, align 4, !tbaa !19
  ...
  br i1 %prol.iter784.cmp.not, label %._crit_edge294.us.us.prol.loopexit, label %._crit_edge294.us.us.prol, !llvm.loop !39
...
._crit_edge294.us.us:                             ; preds = %._crit_edge294.us.us.prol.loopexit, %._crit_edge294.us.us
  ...
  store i32 %i.fy, ptr %i.ga, align 4, !tbaa !19
  ...
  %i.gh = load i32, ptr %i.gg, align 4, !tbaa !19
  ...
  store i32 %i.gi, ptr %i.gk, align 4, !tbaa !19
  ...
  %indvars.iv.next353.1.3 = add i64 %indvars.iv352.1, 4 ; 2 uses
  %i.gs = getelementptr [4 x i8], ptr %i.j, i64 %indvars.iv352.1
  %i.gt = getelementptr i8, ptr %i.gs, i64 12
  store i32 %i.gr, ptr %i.gt, align 4, !tbaa !19
  ...
  br i1 %exitcond360.1.not.3, label %._crit_edge294.us.us.1.preheader, label %._crit_edge294.us.us, !llvm.loop !40
...
._crit_edge294.us.us.1.preheader:                 ; preds = %._crit_edge294.us.us.prol.loopexit, %._crit_edge294.us.us, %middle.block649
  ...
  %indvars.iv.next353.1.lcssa = phi i64 [ %i.ep, %middle.block649 ], [ %indvars.iv.next353.1.lcssa696.unr, %._crit_edge294.us.us.prol.loopexit ], [ %indvars.iv.next353.1.3, %._crit_edge294.us.us ] ; 6 uses
...
vector.memcheck:                                  ; preds = %vector.scevcheck
  %i.gz = shl i64 %indvars.iv.next353.1.lcssa, 2
  %i.ha = getelementptr i8, ptr %i.j, i64 %i.gz
  %10 = add i64 %.0146299.us, %wide.trip.count359
  %11 = add i64 %10, %indvars.iv354.lcssa
  %12 = add i64 %11, %indvars.iv354.1.lcssa
  %13 = shl i64 %12, 2
  %i.hb = getelementptr i8, ptr %i.j, i64 %13
  %scevgep595 = getelementptr i8, ptr %i.hb, i64 8
  %bound0 = icmp ult ptr %i.ha, %scevgep599
...
vector.body609:                                   ; preds = %vector.body609, %vector.ph601
  ...
  %wide.masked.gather = tail call <8 x i32> @llvm.masked.gather.v8i32.v8p0(<8 x ptr> align 4 %wide.gep, <8 x i1> splat (i1 true), <8 x i32> poison), !tbaa !19, !alias.scope !61
  %i.hj = sub nsw <8 x i32> %wide.masked.gather, %broadcast.splat608
  %i.hk = getelementptr [4 x i8], ptr %i.hd, i64 %index610
  store <8 x i32> %i.hj, ptr %i.hk, align 4, !tbaa !19, !alias.scope !62, !noalias !61
  ...
  br i1 %i.hl, label %middle.block612, label %vector.body609, !llvm.loop !44
...
._crit_edge294.us.us.1.prol:                      ; preds = %._crit_edge294.us.us.1.preheader692, %._crit_edge294.us.us.1.prol
  ...
  br i1 %prol.iter789.cmp.not, label %._crit_edge294.us.us.1.prol.loopexit, label %._crit_edge294.us.us.1.prol, !llvm.loop !45
...
._crit_edge294.us.us.1:                           ; preds = %._crit_edge294.us.us.1.prol.loopexit, %._crit_edge294.us.us.1
  ...
  store i32 %i.ic, ptr %i.id, align 4, !tbaa !19
  ...
  store i32 %i.il, ptr %i.in, align 4, !tbaa !19
  ...
  store i32 %i.iv, ptr %i.ix, align 4, !tbaa !19
  ...
  store i32 %i.jf, ptr %i.jh, align 4, !tbaa !19
  ...
  br i1 %exitcond360.2.not.3, label %._crit_edge294.us.us.2, label %._crit_edge294.us.us.1, !llvm.loop !46
...
._crit_edge294.us.us.2:                           ; preds = %._crit_edge294.us.us.1.prol.loopexit, %._crit_edge294.us.us.1, %middle.block612
  ...
  br i1 %exitcond362.not, label %._crit_edge300, label %.preheader237.us, !llvm.loop !47
...
bb.e:                                             ; preds = %bb.d, %bb.c
  %i.jl = load i32, ptr %2, align 4, !tbaa !19
  %i.jm = add nsw i32 %i.jl, 4
  store i32 %i.jm, ptr %2, align 4, !tbaa !19
...
bb.i:                                             ; preds = %bb.f
  ...
  store i32 0, ptr %i.jp, align 4, !tbaa !63
  %i.jq = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 3 uses
  store i32 0, ptr %i.jq, align 4, !tbaa !64
  %i.jr = load i32, ptr %2, align 4, !tbaa !19
  ...
  %i.jv = load i32, ptr %2, align 4, !tbaa !19    ; 7 uses
...
.preheader238..critedge165_crit_edge:             ; preds = %.preheader238
  %.pre = load i32, ptr %i.jx, align 4, !tbaa !11
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.fw = insertelement <2 x i32> poison, i32 %6, i64 0
  %i.fx = insertelement <2 x i32> %i.fw, i32 %3, i64 1
  %i.fy = insertelement <2 x i32> <i32 1, i32 poison>, i32 %6, i64 1
  %i.fz = sdiv <2 x i32> %i.fx, %i.fy             ; 2 uses
  %i.ga = extractelement <2 x i32> %i.fz, i64 1   ; 4 uses
  %i.gb = icmp sgt <2 x i32> %i.fz, <i32 0, i32 2> ; 2 uses
  %i.gc = extractelement <2 x i1> %i.gb, i64 0
  %i.gd = extractelement <2 x i1> %i.gb, i64 1
...
.preheader1.us.preheader.i:                       ; preds = %bb.m
  %i.ge = udiv i32 %i.ga, 3
  %wide.trip.count.i47 = zext nneg i32 %i.ge to i64 ; 20 uses
  %i.gf = add nsw i64 %wide.trip.count.i47, -1    ; 3 uses
  %i.gg = mul i32 %6, 3                           ; 3 uses
  %i.gh = mul i32 %6, -3
  %i.gi = sext i32 %i.gg to i64
  %i.gj = mul nsw i64 %i.gf, %i.gi
  %i.gk = shl i64 %i.gj, 2
  %scevgep64 = getelementptr i8, ptr %2, i64 %i.gk
  %i.gl = add nsw i64 %wide.trip.count.i47, -1    ; 5 uses
  %i.gm = mul i32 %6, 3                           ; 5 uses
  %i.gn = mul i32 %6, -3
  %i.go = sext i32 %i.gm to i64
  %i.gp = mul nsw i64 %i.gl, %i.go
  %i.gq = shl i64 %i.gp, 2                        ; 2 uses
  %scevgep80 = getelementptr i8, ptr %2, i64 %i.gq
  %i.gr = mul i32 %6, -3
  %i.gs = shl nuw nsw i64 %wide.trip.count.i47, 2
  %scevgep116 = getelementptr i8, ptr %i.ft, i64 %i.gs
  %scevgep118 = getelementptr i8, ptr %2, i64 %i.gq
  %min.iters.check128 = icmp ult i32 %i.ga, 72
  %i.gt = icmp slt i32 %i.gm, 0                   ; 2 uses
  %i.gu = select i1 %i.gt, i32 %i.gr, i32 %i.gm
  %i.gv = trunc nsw i64 %i.gl to i32
  %mul111 = tail call { i32, i1 } @llvm.umul.with.overflow.i32(i32 %i.gu, i32 %i.gv) ; 2 uses
  %mul.result112 = extractvalue { i32, i1 } %mul111, 0 ; 2 uses
  %mul.overflow113 = extractvalue { i32, i1 } %mul111, 1
  %i.gw = icmp ugt i64 %i.gl, 4294967295
  %invariant.op = or i1 %mul.overflow113, %i.gw
  ...
  %min.iters.check90 = icmp ult i32 %i.ga, 72
  %i.gx = icmp slt i32 %i.gm, 0                   ; 2 uses
  %i.gy = select i1 %i.gx, i32 %i.gn, i32 %i.gm
  %i.gz = trunc nsw i64 %i.gl to i32
  %mul74 = tail call { i32, i1 } @llvm.umul.with.overflow.i32(i32 %i.gy, i32 %i.gz) ; 2 uses
  %mul.result75 = extractvalue { i32, i1 } %mul74, 0 ; 2 uses
  %mul.overflow76 = extractvalue { i32, i1 } %mul74, 1
  %i.ha = icmp ugt i64 %i.gl, 4294967295
  %invariant.op201 = or i1 %mul.overflow76, %i.ha
  ...
  %min.iters.check = icmp ult i32 %i.ga, 72
  %i.hb = icmp slt i32 %i.gg, 0                   ; 2 uses
  %i.hc = select i1 %i.hb, i32 %i.gh, i32 %i.gg
  %i.hd = trunc nsw i64 %i.gf to i32
  %mul = tail call { i32, i1 } @llvm.umul.with.overflow.i32(i32 %i.hc, i32 %i.hd) ; 2 uses
  %mul.result = extractvalue { i32, i1 } %mul, 0  ; 2 uses
  %mul.overflow = extractvalue { i32, i1 } %mul, 1
  %i.he = icmp ugt i64 %i.gf, 4294967295
  %invariant.op203 = or i1 %mul.overflow, %i.he
...
.preheader1.us.i:                                 ; preds = %._crit_edge.us.us.2.i, %.preheader1.us.preheader.i
  %.07.us.i = phi i32 [ %i.pg, %._crit_edge.us.us.2.i ], [ 0, %.preheader1.us.preheader.i ] ; 24 uses
  %.0286.us.i = phi i64 [ %indvars.iv.next.2.i.lcssa, %._crit_edge.us.us.2.i ], [ 0, %.preheader1.us.preheader.i ] ; 8 uses
  %i.hf = mul i32 %.07.us.i, 3
  %i.hg = sext i32 %i.hf to i64
  %i.hh = shl nsw i64 %i.hg, 2                    ; 2 uses
  %scevgep119 = getelementptr i8, ptr %scevgep118, i64 %i.hh ; 4 uses
  %scevgep120 = getelementptr i8, ptr %2, i64 %i.hh ; 4 uses
  %i.hi = icmp ult ptr %scevgep119, %scevgep120
  %umin121 = select i1 %i.hi, ptr %scevgep119, ptr %scevgep120
  %i.hj = icmp ugt ptr %scevgep119, %scevgep120
  %umax122 = select i1 %i.hj, ptr %scevgep119, ptr %scevgep120
  %scevgep123 = getelementptr i8, ptr %umax122, i64 4
  %i.hk = mul i32 %.07.us.i, 3                    ; 5 uses
  %i.hl = add i32 %i.hk, 1
  %i.hm = sext i32 %i.hl to i64
  %i.hn = shl nsw i64 %i.hm, 2                    ; 2 uses
  %scevgep81 = getelementptr i8, ptr %scevgep80, i64 %i.hn ; 4 uses
  %scevgep82 = getelementptr i8, ptr %2, i64 %i.hn ; 4 uses
  %i.ho = icmp ult ptr %scevgep81, %scevgep82
  %umin83 = select i1 %i.ho, ptr %scevgep81, ptr %scevgep82
  %i.hp = icmp ugt ptr %scevgep81, %scevgep82
  %umax84 = select i1 %i.hp, ptr %scevgep81, ptr %scevgep82
  %scevgep85 = getelementptr i8, ptr %umax84, i64 4
  %i.hq = mul i32 %.07.us.i, 3
  %i.hr = add i32 %i.hq, 1                        ; 4 uses
  %i.hs = mul i32 %.07.us.i, 3
  %i.ht = add i32 %i.hs, 2
  %i.hu = sext i32 %i.ht to i64
  %i.hv = shl nsw i64 %i.hu, 2                    ; 2 uses
  %scevgep65 = getelementptr i8, ptr %scevgep64, i64 %i.hv ; 4 uses
  %scevgep66 = getelementptr i8, ptr %2, i64 %i.hv ; 4 uses
  %i.hw = icmp ult ptr %scevgep65, %scevgep66
  %umin = select i1 %i.hw, ptr %scevgep65, ptr %scevgep66
  %i.hx = icmp ugt ptr %scevgep65, %scevgep66
  %umax = select i1 %i.hx, ptr %scevgep65, ptr %scevgep66
  %scevgep67 = getelementptr i8, ptr %umax, i64 4
  %i.hy = mul i32 %.07.us.i, 3
  %i.hz = add i32 %i.hy, 2                        ; 4 uses
  br i1 %min.iters.check128, label %scalar.ph127.preheader, label %vector.scevcheck110

vector.scevcheck110:                              ; preds = %.preheader1.us.i
  %i.ia = add i32 %i.hk, %mul.result112
  %i.ib = sub i32 %i.hk, %mul.result112
  %i.ic = icmp slt i32 %i.ia, %i.hk
  %i.id = icmp sgt i32 %i.ib, %i.hk
  %i.ie = select i1 %i.gt, i1 %i.id, i1 %i.ic
  %.reass = or i1 %i.ie, %invariant.op
  br i1 %.reass, label %scalar.ph127.preheader, label %vector.memcheck114

vector.memcheck114:                               ; preds = %vector.scevcheck110
  %i.if = shl i64 %.0286.us.i, 2                  ; 2 uses
  %scevgep115 = getelementptr i8, ptr %i.ft, i64 %i.if
  %scevgep117 = getelementptr i8, ptr %scevgep116, i64 %i.if
...
vector.ph129:                                     ; preds = %vector.memcheck114
  %i.ig = add i64 %.0286.us.i, %n.vec130          ; 2 uses
  ...
  %i.ih = getelementptr [4 x i8], ptr %i.ft, i64 %.0286.us.i
...
vector.body137:                                   ; preds = %vector.body137, %vector.ph129
  ...
  %i.ii = getelementptr [4 x i8], ptr %i.ih, i64 %index138
  %wide.load140 = load <8 x i32>, ptr %i.ii, align 4, !tbaa !19, !alias.scope !95, !noalias !96
  %i.ij = sub nsw <8 x i32> %wide.load140, %broadcast.splat134
  %i.ik = mul <8 x i32> %broadcast.splat136, %vec.ind139
  %i.il = add <8 x i32> %i.ik, %broadcast.splat132
  %i.im = mul <8 x i32> %i.il, splat (i32 3)
  %i.in = sext <8 x i32> %i.im to <8 x i64>
  %wide.gep141 = getelementptr inbounds [4 x i8], ptr %2, <8 x i64> %i.in
  tail call void @llvm.masked.scatter.v8i32.v8p0(<8 x i32> %i.ij, <8 x ptr> align 4 %wide.gep141, <8 x i1> splat (i1 true)), !tbaa !19, !alias.scope !96
  %index.next142 = add nuw i64 %index138, 8       ; 2 uses
  %vec.ind.next143 = add <8 x i32> %vec.ind139, splat (i32 8)
  %i.io = icmp eq i64 %index.next142, %n.vec130
  br i1 %i.io, label %middle.block144, label %vector.body137, !llvm.loop !79
...
scalar.ph127.preheader:                           ; preds = %vector.memcheck114, %vector.scevcheck110, %.preheader1.us.i, %middle.block144
  ...
  %indvars.iv.i48.ph = phi i64 [ %.0286.us.i, %vector.memcheck114 ], [ %.0286.us.i, %vector.scevcheck110 ], [ %.0286.us.i, %.preheader1.us.i ], [ %i.ig, %middle.block144 ] ; 2 uses
...
scalar.ph127.prol:                                ; preds = %scalar.ph127.preheader, %scalar.ph127.prol
  ...
  %indvars.iv.next.i49.prol = add i64 %indvars.iv.i48.prol, 1 ; 3 uses
  %i.ip = getelementptr inbounds [4 x i8], ptr %i.ft, i64 %indvars.iv.i48.prol
  %i.iq = load i32, ptr %i.ip, align 4, !tbaa !19
  %i.ir = sub nsw i32 %i.iq, %i.fu
  %i.is = trunc nuw nsw i64 %indvars.iv9.i.prol to i32
  %i.it = mul i32 %6, %i.is
  %reass.add.us.us.i.prol = add i32 %i.it, %.07.us.i
  %reass.mul.us.us.i.prol = mul i32 %reass.add.us.us.i.prol, 3
  %i.iu = sext i32 %reass.mul.us.us.i.prol to i64
  %i.iv = getelementptr inbounds [4 x i8], ptr %2, i64 %i.iu
  store i32 %i.ir, ptr %i.iv, align 4, !tbaa !19
...
scalar.ph127.prol.loopexit:                       ; preds = %scalar.ph127.prol, %scalar.ph127.preheader
  ...
  %i.iw = sub nsw i64 %indvars.iv9.i.ph, %wide.trip.count.i47
  %i.ix = icmp ugt i64 %i.iw, -4
  br i1 %i.ix, label %._crit_edge.us.us.i.preheader, label %scalar.ph127
...
scalar.ph127:                                     ; preds = %scalar.ph127.prol.loopexit, %scalar.ph127
  ...
  %i.iy = getelementptr inbounds [4 x i8], ptr %i.ft, i64 %indvars.iv.i48
  %i.iz = load i32, ptr %i.iy, align 4, !tbaa !19
  %i.ja = sub nsw i32 %i.iz, %i.fu
  %i.jb = trunc nuw nsw i64 %indvars.iv9.i to i32
  %i.jc = mul i32 %6, %i.jb
  %reass.add.us.us.i = add i32 %i.jc, %.07.us.i
  %reass.mul.us.us.i = mul i32 %reass.add.us.us.i, 3
  %i.jd = sext i32 %reass.mul.us.us.i to i64
  %i.je = getelementptr inbounds [4 x i8], ptr %2, i64 %i.jd
  store i32 %i.ja, ptr %i.je, align 4, !tbaa !19
  %i.jf = getelementptr [4 x i8], ptr %i.ft, i64 %indvars.iv.i48
  %i.jg = getelementptr i8, ptr %i.jf, i64 4
  %i.jh = load i32, ptr %i.jg, align 4, !tbaa !19
  %i.ji = sub nsw i32 %i.jh, %i.fu
  %i.jj = trunc i64 %indvars.iv9.i to i32
  %i.jk = add i32 %i.jj, 1
  %i.jl = mul i32 %6, %i.jk
  %reass.add.us.us.i.1 = add i32 %i.jl, %.07.us.i
  %reass.mul.us.us.i.1 = mul i32 %reass.add.us.us.i.1, 3
  %i.jm = sext i32 %reass.mul.us.us.i.1 to i64
  %i.jn = getelementptr inbounds [4 x i8], ptr %2, i64 %i.jm
  store i32 %i.ji, ptr %i.jn, align 4, !tbaa !19
  %i.jo = getelementptr [4 x i8], ptr %i.ft, i64 %indvars.iv.i48
  %i.jp = getelementptr i8, ptr %i.jo, i64 8
  %i.jq = load i32, ptr %i.jp, align 4, !tbaa !19
  %i.jr = sub nsw i32 %i.jq, %i.fu
  %i.js = trunc i64 %indvars.iv9.i to i32
  %i.jt = add i32 %i.js, 2
  %i.ju = mul i32 %6, %i.jt
  %reass.add.us.us.i.2 = add i32 %i.ju, %.07.us.i
  %reass.mul.us.us.i.2 = mul i32 %reass.add.us.us.i.2, 3
  %i.jv = sext i32 %reass.mul.us.us.i.2 to i64
  %i.jw = getelementptr inbounds [4 x i8], ptr %2, i64 %i.jv
  store i32 %i.jr, ptr %i.jw, align 4, !tbaa !19
  %indvars.iv.next10.i.2 = add nuw nsw i64 %indvars.iv9.i, 3 ; 2 uses
  %indvars.iv.next.i49.3 = add i64 %indvars.iv.i48, 4 ; 2 uses
  %i.jx = getelementptr [4 x i8], ptr %i.ft, i64 %indvars.iv.i48
  %i.jy = getelementptr i8, ptr %i.jx, i64 12
  %i.jz = load i32, ptr %i.jy, align 4, !tbaa !19
  %i.ka = sub nsw i32 %i.jz, %i.fu
  %i.kb = trunc nuw nsw i64 %indvars.iv.next10.i.2 to i32
  %i.kc = mul i32 %6, %i.kb
  %reass.add.us.us.i.3 = add i32 %i.kc, %.07.us.i
  %reass.mul.us.us.i.3 = mul i32 %reass.add.us.us.i.3, 3
  %i.kd = sext i32 %reass.mul.us.us.i.3 to i64
  %i.ke = getelementptr inbounds [4 x i8], ptr %2, i64 %i.kd
  store i32 %i.ka, ptr %i.ke, align 4, !tbaa !19
...
._crit_edge.us.us.i.preheader:                    ; preds = %scalar.ph127.prol.loopexit, %scalar.ph127, %middle.block144
  ...
  %indvars.iv.next.i49.lcssa = phi i64 [ %i.ig, %middle.block144 ], [ %indvars.iv.next.i49.lcssa151.unr, %scalar.ph127.prol.loopexit ], [ %indvars.iv.next.i49.3, %scalar.ph127 ] ; 6 uses
...
vector.scevcheck73:                               ; preds = %._crit_edge.us.us.i.preheader
  %i.kf = add i32 %i.hr, %mul.result75
  %i.kg = sub i32 %i.hr, %mul.result75
  %i.kh = icmp slt i32 %i.kf, %i.hr
  %i.ki = icmp sgt i32 %i.kg, %i.hr
  %i.kj = select i1 %i.gx, i1 %i.ki, i1 %i.kh
  %.reass202 = or i1 %i.kj, %invariant.op201
  br i1 %.reass202, label %._crit_edge.us.us.i.preheader150, label %vector.memcheck77

vector.memcheck77:                                ; preds = %vector.scevcheck73
  %i.kk = shl i64 %indvars.iv.next.i49.lcssa, 2
  %i.kl = getelementptr i8, ptr %i.ft, i64 %i.kk
  %7 = add i64 %.0286.us.i, %wide.trip.count.i47
  %8 = add i64 %7, %indvars.iv9.i.lcssa
  %9 = shl i64 %8, 2
  %i.km = getelementptr i8, ptr %i.ft, i64 %9
  %scevgep79 = getelementptr i8, ptr %i.km, i64 4
  %bound086 = icmp ult ptr %i.kl, %scevgep85
...
vector.ph91:                                      ; preds = %vector.memcheck77
  %i.kn = add i64 %indvars.iv.next.i49.lcssa, %n.vec92 ; 2 uses
  ...
  %i.ko = getelementptr [4 x i8], ptr %i.ft, i64 %indvars.iv.next.i49.lcssa
...
vector.body99:                                    ; preds = %vector.body99, %vector.ph91
  ...
  %i.kp = getelementptr [4 x i8], ptr %i.ko, i64 %index100
  %wide.load102 = load <8 x i32>, ptr %i.kp, align 4, !tbaa !19, !alias.scope !97, !noalias !98
  %i.kq = sub nsw <8 x i32> %wide.load102, %broadcast.splat94
  %i.kr = mul <8 x i32> %broadcast.splat96, %vec.ind101
  %i.ks = add <8 x i32> %i.kr, %broadcast.splat98
  %i.kt = mul <8 x i32> %i.ks, splat (i32 3)
  %i.ku = add <8 x i32> %i.kt, splat (i32 1)
  %i.kv = sext <8 x i32> %i.ku to <8 x i64>
  %wide.gep103 = getelementptr inbounds [4 x i8], ptr %2, <8 x i64> %i.kv
  tail call void @llvm.masked.scatter.v8i32.v8p0(<8 x i32> %i.kq, <8 x ptr> align 4 %wide.gep103, <8 x i1> splat (i1 true)), !tbaa !19, !alias.scope !98
  %index.next104 = add nuw i64 %index100, 8       ; 2 uses
  %vec.ind.next105 = add <8 x i32> %vec.ind101, splat (i32 8)
  %i.kw = icmp eq i64 %index.next104, %n.vec92
  br i1 %i.kw, label %middle.block106, label %vector.body99, !llvm.loop !85
...
._crit_edge.us.us.i.preheader150:                 ; preds = %vector.memcheck77, %vector.scevcheck73, %._crit_edge.us.us.i.preheader, %middle.block106
  ...
  %indvars.iv.1.i.ph = phi i64 [ %indvars.iv.next.i49.lcssa, %vector.memcheck77 ], [ %indvars.iv.next.i49.lcssa, %vector.scevcheck73 ], [ %indvars.iv.next.i49.lcssa, %._crit_edge.us.us.i.preheader ], [ %i.kn, %middle.block106 ] ; 2 uses
...
._crit_edge.us.us.i.prol:                         ; preds = %._crit_edge.us.us.i.preheader150, %._crit_edge.us.us.i.prol
  ...
  %indvars.iv.next.1.i.prol = add i64 %indvars.iv.1.i.prol, 1 ; 3 uses
  %i.kx = getelementptr inbounds [4 x i8], ptr %i.ft, i64 %indvars.iv.1.i.prol
  %i.ky = load i32, ptr %i.kx, align 4, !tbaa !19
  %i.kz = sub nsw i32 %i.ky, %i.fu
  %i.la = trunc nuw nsw i64 %indvars.iv9.1.i.prol to i32
  %i.lb = mul i32 %6, %i.la
  %reass.add.us.us.1.i.prol = add i32 %i.lb, %.07.us.i
  %reass.mul.us.us.1.i.prol = mul i32 %reass.add.us.us.1.i.prol, 3
  %i.lc = add i32 %reass.mul.us.us.1.i.prol, 1
  %i.ld = sext i32 %i.lc to i64
  %i.le = getelementptr inbounds [4 x i8], ptr %2, i64 %i.ld
  store i32 %i.kz, ptr %i.le, align 4, !tbaa !19
  ...
  br i1 %prol.iter196.cmp.not, label %._crit_edge.us.us.i.prol.loopexit, label %._crit_edge.us.us.i.prol, !llvm.loop !86
...
._crit_edge.us.us.i.prol.loopexit:                ; preds = %._crit_edge.us.us.i.prol, %._crit_edge.us.us.i.preheader150
  ...
  %i.lf = sub nsw i64 %indvars.iv9.1.i.ph, %wide.trip.count.i47
  %i.lg = icmp ugt i64 %i.lf, -4
  br i1 %i.lg, label %._crit_edge.us.us.1.i.preheader, label %._crit_edge.us.us.i
...
._crit_edge.us.us.i:                              ; preds = %._crit_edge.us.us.i.prol.loopexit, %._crit_edge.us.us.i
  ...
  %i.lh = getelementptr inbounds [4 x i8], ptr %i.ft, i64 %indvars.iv.1.i
  %i.li = load i32, ptr %i.lh, align 4, !tbaa !19
  %i.lj = sub nsw i32 %i.li, %i.fu
  %i.lk = trunc nuw nsw i64 %indvars.iv9.1.i to i32
  %i.ll = mul i32 %6, %i.lk
  %reass.add.us.us.1.i = add i32 %i.ll, %.07.us.i
  %reass.mul.us.us.1.i = mul i32 %reass.add.us.us.1.i, 3
  %i.lm = add i32 %reass.mul.us.us.1.i, 1
  %i.ln = sext i32 %i.lm to i64
  %i.lo = getelementptr inbounds [4 x i8], ptr %2, i64 %i.ln
  store i32 %i.lj, ptr %i.lo, align 4, !tbaa !19
  %i.lp = getelementptr [4 x i8], ptr %i.ft, i64 %indvars.iv.1.i
  %i.lq = getelementptr i8, ptr %i.lp, i64 4
  %i.lr = load i32, ptr %i.lq, align 4, !tbaa !19
  %i.ls = sub nsw i32 %i.lr, %i.fu
  %i.lt = trunc i64 %indvars.iv9.1.i to i32
  %i.lu = add i32 %i.lt, 1
  %i.lv = mul i32 %6, %i.lu
  %reass.add.us.us.1.i.1 = add i32 %i.lv, %.07.us.i
  %reass.mul.us.us.1.i.1 = mul i32 %reass.add.us.us.1.i.1, 3
  %i.lw = add i32 %reass.mul.us.us.1.i.1, 1
  %i.lx = sext i32 %i.lw to i64
  %i.ly = getelementptr inbounds [4 x i8], ptr %2, i64 %i.lx
  store i32 %i.ls, ptr %i.ly, align 4, !tbaa !19
  %i.lz = getelementptr [4 x i8], ptr %i.ft, i64 %indvars.iv.1.i
  %i.ma = getelementptr i8, ptr %i.lz, i64 8
  %i.mb = load i32, ptr %i.ma, align 4, !tbaa !19
  %i.mc = sub nsw i32 %i.mb, %i.fu
  %i.md = trunc i64 %indvars.iv9.1.i to i32
  %i.me = add i32 %i.md, 2
  %i.mf = mul i32 %6, %i.me
  %reass.add.us.us.1.i.2 = add i32 %i.mf, %.07.us.i
  %reass.mul.us.us.1.i.2 = mul i32 %reass.add.us.us.1.i.2, 3
  %i.mg = add i32 %reass.mul.us.us.1.i.2, 1
  %i.mh = sext i32 %i.mg to i64
  %i.mi = getelementptr inbounds [4 x i8], ptr %2, i64 %i.mh
  store i32 %i.mc, ptr %i.mi, align 4, !tbaa !19
  %indvars.iv.next10.1.i.2 = add nuw nsw i64 %indvars.iv9.1.i, 3 ; 2 uses
  %indvars.iv.next.1.i.3 = add i64 %indvars.iv.1.i, 4 ; 2 uses
  %i.mj = getelementptr [4 x i8], ptr %i.ft, i64 %indvars.iv.1.i
  %i.mk = getelementptr i8, ptr %i.mj, i64 12
  %i.ml = load i32, ptr %i.mk, align 4, !tbaa !19
  %i.mm = sub nsw i32 %i.ml, %i.fu
  %i.mn = trunc nuw nsw i64 %indvars.iv.next10.1.i.2 to i32
  %i.mo = mul i32 %6, %i.mn
  %reass.add.us.us.1.i.3 = add i32 %i.mo, %.07.us.i
  %reass.mul.us.us.1.i.3 = mul i32 %reass.add.us.us.1.i.3, 3
  %i.mp = add i32 %reass.mul.us.us.1.i.3, 1
  %i.mq = sext i32 %i.mp to i64
  %i.mr = getelementptr inbounds [4 x i8], ptr %2, i64 %i.mq
  store i32 %i.mm, ptr %i.mr, align 4, !tbaa !19
...
._crit_edge.us.us.1.i.preheader:                  ; preds = %._crit_edge.us.us.i.prol.loopexit, %._crit_edge.us.us.i, %middle.block106
  ...
  %indvars.iv.next.1.i.lcssa = phi i64 [ %i.kn, %middle.block106 ], [ %indvars.iv.next.1.i.lcssa153.unr, %._crit_edge.us.us.i.prol.loopexit ], [ %indvars.iv.next.1.i.3, %._crit_edge.us.us.i ] ; 6 uses
...
vector.scevcheck:                                 ; preds = %._crit_edge.us.us.1.i.preheader
  %i.ms = add i32 %i.hz, %mul.result
  %i.mt = sub i32 %i.hz, %mul.result
  %i.mu = icmp slt i32 %i.ms, %i.hz
  %i.mv = icmp sgt i32 %i.mt, %i.hz
  %i.mw = select i1 %i.hb, i1 %i.mv, i1 %i.mu
  %.reass204 = or i1 %i.mw, %invariant.op203
  br i1 %.reass204, label %._crit_edge.us.us.1.i.preheader149, label %vector.memcheck

vector.memcheck:                                  ; preds = %vector.scevcheck
  %i.mx = shl i64 %indvars.iv.next.1.i.lcssa, 2
  %i.my = getelementptr i8, ptr %i.ft, i64 %i.mx
  %10 = add i64 %.0286.us.i, %wide.trip.count.i47
  %11 = add i64 %10, %indvars.iv9.i.lcssa
  %12 = add i64 %11, %indvars.iv9.1.i.lcssa
  %13 = shl i64 %12, 2
  %i.mz = getelementptr i8, ptr %i.ft, i64 %13
  %scevgep63 = getelementptr i8, ptr %i.mz, i64 8
  %bound0 = icmp ult ptr %i.my, %scevgep67
  %bound1 = icmp ult ptr %umin, %scevgep63
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %._crit_edge.us.us.1.i.preheader149, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %i.na = add i64 %indvars.iv.next.1.i.lcssa, %n.vec ; 2 uses
  ...
  %i.nb = getelementptr [4 x i8], ptr %i.ft, i64 %indvars.iv.next.1.i.lcssa
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.nc = getelementptr [4 x i8], ptr %i.nb, i64 %index
  %wide.load = load <8 x i32>, ptr %i.nc, align 4, !tbaa !19, !alias.scope !99, !noalias !100
  %i.nd = sub nsw <8 x i32> %wide.load, %broadcast.splat
  %i.ne = mul <8 x i32> %broadcast.splat69, %vec.ind
  %i.nf = add <8 x i32> %i.ne, %broadcast.splat71
  %i.ng = mul <8 x i32> %i.nf, splat (i32 3)
  %i.nh = add <8 x i32> %i.ng, splat (i32 2)
  %i.ni = sext <8 x i32> %i.nh to <8 x i64>
  %wide.gep = getelementptr inbounds [4 x i8], ptr %2, <8 x i64> %i.ni
  tail call void @llvm.masked.scatter.v8i32.v8p0(<8 x i32> %i.nd, <8 x ptr> align 4 %wide.gep, <8 x i1> splat (i1 true)), !tbaa !19, !alias.scope !100
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %vec.ind.next = add <8 x i32> %vec.ind, splat (i32 8)
  %i.nj = icmp eq i64 %index.next, %n.vec
  br i1 %i.nj, label %middle.block, label %vector.body, !llvm.loop !91
...
._crit_edge.us.us.1.i.preheader149:               ; preds = %vector.memcheck, %vector.scevcheck, %._crit_edge.us.us.1.i.preheader, %middle.block
  ...
  %indvars.iv.2.i.ph = phi i64 [ %indvars.iv.next.1.i.lcssa, %vector.memcheck ], [ %indvars.iv.next.1.i.lcssa, %vector.scevcheck ], [ %indvars.iv.next.1.i.lcssa, %._crit_edge.us.us.1.i.preheader ], [ %i.na, %middle.block ] ; 2 uses
...
._crit_edge.us.us.1.i.prol:                       ; preds = %._crit_edge.us.us.1.i.preheader149, %._crit_edge.us.us.1.i.prol
  ...
  %i.nk = getelementptr inbounds [4 x i8], ptr %i.ft, i64 %indvars.iv.2.i.prol
  %i.nl = load i32, ptr %i.nk, align 4, !tbaa !19
  %i.nm = sub nsw i32 %i.nl, %i.fu
  %i.nn = trunc nuw nsw i64 %indvars.iv9.2.i.prol to i32
  %i.no = mul i32 %6, %i.nn
  %reass.add.us.us.2.i.prol = add i32 %i.no, %.07.us.i
  %reass.mul.us.us.2.i.prol = mul i32 %reass.add.us.us.2.i.prol, 3
  %i.np = add i32 %reass.mul.us.us.2.i.prol, 2
  %i.nq = sext i32 %i.np to i64
  %i.nr = getelementptr inbounds [4 x i8], ptr %2, i64 %i.nq
  store i32 %i.nm, ptr %i.nr, align 4, !tbaa !19
...
._crit_edge.us.us.1.i.prol.loopexit:              ; preds = %._crit_edge.us.us.1.i.prol, %._crit_edge.us.us.1.i.preheader149
  ...
  %i.ns = sub nsw i64 %indvars.iv9.2.i.ph, %wide.trip.count.i47
  %i.nt = icmp ugt i64 %i.ns, -4
  br i1 %i.nt, label %._crit_edge.us.us.2.i, label %._crit_edge.us.us.1.i
...
._crit_edge.us.us.1.i:                            ; preds = %._crit_edge.us.us.1.i.prol.loopexit, %._crit_edge.us.us.1.i
  ...
  %i.nu = getelementptr inbounds [4 x i8], ptr %i.ft, i64 %indvars.iv.2.i
  %i.nv = load i32, ptr %i.nu, align 4, !tbaa !19
  %i.nw = sub nsw i32 %i.nv, %i.fu
  %i.nx = trunc nuw nsw i64 %indvars.iv9.2.i to i32
  %i.ny = mul i32 %6, %i.nx
  %reass.add.us.us.2.i = add i32 %i.ny, %.07.us.i
  %reass.mul.us.us.2.i = mul i32 %reass.add.us.us.2.i, 3
  %i.nz = add i32 %reass.mul.us.us.2.i, 2
  %i.oa = sext i32 %i.nz to i64
  %i.ob = getelementptr inbounds [4 x i8], ptr %2, i64 %i.oa
  store i32 %i.nw, ptr %i.ob, align 4, !tbaa !19
  %i.oc = getelementptr [4 x i8], ptr %i.ft, i64 %indvars.iv.2.i
  %i.od = getelementptr i8, ptr %i.oc, i64 4
  %i.oe = load i32, ptr %i.od, align 4, !tbaa !19
  %i.of = sub nsw i32 %i.oe, %i.fu
  %i.og = trunc i64 %indvars.iv9.2.i to i32
  %i.oh = add i32 %i.og, 1
  %i.oi = mul i32 %6, %i.oh
  %reass.add.us.us.2.i.1 = add i32 %i.oi, %.07.us.i
  %reass.mul.us.us.2.i.1 = mul i32 %reass.add.us.us.2.i.1, 3
  %i.oj = add i32 %reass.mul.us.us.2.i.1, 2
  %i.ok = sext i32 %i.oj to i64
  %i.ol = getelementptr inbounds [4 x i8], ptr %2, i64 %i.ok
  store i32 %i.of, ptr %i.ol, align 4, !tbaa !19
  %i.om = getelementptr [4 x i8], ptr %i.ft, i64 %indvars.iv.2.i
  %i.on = getelementptr i8, ptr %i.om, i64 8
  %i.oo = load i32, ptr %i.on, align 4, !tbaa !19
  %i.op = sub nsw i32 %i.oo, %i.fu
  %i.oq = trunc i64 %indvars.iv9.2.i to i32
  %i.or = add i32 %i.oq, 2
  %i.os = mul i32 %6, %i.or
  %reass.add.us.us.2.i.2 = add i32 %i.os, %.07.us.i
  %reass.mul.us.us.2.i.2 = mul i32 %reass.add.us.us.2.i.2, 3
  %i.ot = add i32 %reass.mul.us.us.2.i.2, 2
  %i.ou = sext i32 %i.ot to i64
  %i.ov = getelementptr inbounds [4 x i8], ptr %2, i64 %i.ou
  store i32 %i.op, ptr %i.ov, align 4, !tbaa !19
  %indvars.iv.next.2.i.3 = add nsw i64 %indvars.iv.2.i, 4 ; 2 uses
  %i.ow = getelementptr [4 x i8], ptr %i.ft, i64 %indvars.iv.2.i
  %i.ox = getelementptr i8, ptr %i.ow, i64 12
  %i.oy = load i32, ptr %i.ox, align 4, !tbaa !19
  %i.oz = sub nsw i32 %i.oy, %i.fu
  %i.pa = trunc i64 %indvars.iv9.2.i to i32
  %i.pb = add i32 %i.pa, 3
  %i.pc = mul i32 %6, %i.pb
  %reass.add.us.us.2.i.3 = add i32 %i.pc, %.07.us.i
  %reass.mul.us.us.2.i.3 = mul i32 %reass.add.us.us.2.i.3, 3
  %i.pd = add i32 %reass.mul.us.us.2.i.3, 2
  %i.pe = sext i32 %i.pd to i64
  %i.pf = getelementptr inbounds [4 x i8], ptr %2, i64 %i.pe
  store i32 %i.oz, ptr %i.pf, align 4, !tbaa !19
...
._crit_edge.us.us.2.i:                            ; preds = %._crit_edge.us.us.1.i.prol.loopexit, %._crit_edge.us.us.1.i, %middle.block
  %indvars.iv.next.2.i.lcssa = phi i64 [ %i.na, %middle.block ], [ %indvars.iv.next.2.i.lcssa155.unr, %._crit_edge.us.us.1.i.prol.loopexit ], [ %indvars.iv.next.2.i.3, %._crit_edge.us.us.1.i ]
  %i.pg = add nuw nsw i32 %.07.us.i, 1            ; 2 uses
  %exitcond15.not.i = icmp eq i32 %i.pg, %6
...
bb.n:                                             ; preds = %bb.l
  %i.ph = icmp eq i32 %4, 10
  br i1 %i.ph, label %bb.o, label %unpack_array_stop_bits.exit

bb.o:                                             ; preds = %bb.n
  %i.pi = tail call i32 @Ptngc_unpack_array_xtc3(ptr noundef %1, ptr noundef %2, i32 noundef %3, i32 noundef %6) #11
  br label %unpack_array_stop_bits.exit

unpack_array_stop_bits.exit:                      ; preds = %.split22.us.i, %bb.e, %._crit_edge.i42, %bb.b, %bb.n, %bb.o, %unpack_array_bwlzh.exit, %bb.k
  %.0 = phi i32 [ 1, %bb.n ], [ 0, %bb.e ], [ %i.fp, %bb.k ], [ 0, %unpack_array_bwlzh.exit ], [ %i.pi, %bb.o ], [ 0, %bb.b ], [ 0, %._crit_edge.i42 ], [ 0, %.split22.us.i ]
  ret i32 %.0
}
