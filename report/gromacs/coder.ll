...
bb.m:                                             ; preds = %bb.l
  ...
  %10 = sdiv <2 x i32> %8, %9                     ; 2 uses
  %11 = extractelement <2 x i32> %10, i64 1       ; 4 uses
  %12 = icmp sgt <2 x i32> %10, <i32 0, i32 2>    ; 2 uses
...
.preheader1.us.preheader.i:                       ; preds = %bb.m
  ...
  %min.iters.check128 = icmp ult i32 %11, 72
  ...
  %min.iters.check90 = icmp ult i32 %11, 72
  ...
  %min.iters.check = icmp ult i32 %11, 72
