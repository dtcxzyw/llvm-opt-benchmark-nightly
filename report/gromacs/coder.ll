...
vector.body137:                                   ; preds = %vector.body137, %vector.ph129
  ...
  %wide.load140 = load <8 x i32>, ptr %i.id, align 4, !tbaa !19, !alias.scope !95, !noalias !96
  ...
  tail call void @llvm.masked.scatter.v8i32.v8p0(<8 x i32> %i.ie, <8 x ptr> align 4 %wide.gep141, <8 x i1> splat (i1 true)), !tbaa !19, !alias.scope !96
  ...
  br i1 %i.ij, label %middle.block144, label %vector.body137, !llvm.loop !79
...
scalar.ph127.prol:                                ; preds = %scalar.ph127.preheader, %scalar.ph127.prol
  ...
  store i32 %i.im, ptr %i.iq, align 4, !tbaa !19
...
scalar.ph127:                                     ; preds = %scalar.ph127.prol.loopexit, %scalar.ph127
  ...
  store i32 %i.jm, ptr %i.jr, align 4, !tbaa !19
  ...
  store i32 %i.jv, ptr %i.jz, align 4, !tbaa !19
...
._crit_edge.us.us.i.preheader:                    ; preds = %scalar.ph127.prol.loopexit, %scalar.ph127, %middle.block144
  ...
  %indvars.iv.next.i49.lcssa = phi i64 [ %i.ib, %middle.block144 ], [ %indvars.iv.next.i49.lcssa151.unr, %scalar.ph127.prol.loopexit ], [ %indvars.iv.next.i49.3, %scalar.ph127 ] ; 6 uses
...
vector.memcheck77:                                ; preds = %vector.scevcheck73
  %i.kf = shl i64 %indvars.iv.next.i49.lcssa, 2
  %i.kg = getelementptr i8, ptr %i.ft, i64 %i.kf
  %7 = add i64 %.0286.us.i, %wide.trip.count.i47
  %8 = add i64 %7, %indvars.iv9.i.lcssa
  %9 = shl i64 %8, 2
  %i.kh = getelementptr i8, ptr %i.ft, i64 %9
  %scevgep79 = getelementptr i8, ptr %i.kh, i64 4
  %bound086 = icmp ult ptr %i.kg, %scevgep85
...
vector.body99:                                    ; preds = %vector.body99, %vector.ph91
  ...
  %wide.load102 = load <8 x i32>, ptr %i.kk, align 4, !tbaa !19, !alias.scope !97, !noalias !98
  ...
  tail call void @llvm.masked.scatter.v8i32.v8p0(<8 x i32> %i.kl, <8 x ptr> align 4 %wide.gep103, <8 x i1> splat (i1 true)), !tbaa !19, !alias.scope !98
  ...
  br i1 %i.kr, label %middle.block106, label %vector.body99, !llvm.loop !85
...
._crit_edge.us.us.i.prol:                         ; preds = %._crit_edge.us.us.i.preheader150, %._crit_edge.us.us.i.prol
  ...
  store i32 %i.ku, ptr %i.kz, align 4, !tbaa !19
...
._crit_edge.us.us.i:                              ; preds = %._crit_edge.us.us.i.prol.loopexit, %._crit_edge.us.us.i
  ...
  store i32 %i.le, ptr %i.lj, align 4, !tbaa !19
  ...
  store i32 %i.ln, ptr %i.lt, align 4, !tbaa !19
  ...
  store i32 %i.lx, ptr %i.md, align 4, !tbaa !19
  ...
  store i32 %i.mh, ptr %i.mm, align 4, !tbaa !19
...
._crit_edge.us.us.1.i.preheader:                  ; preds = %._crit_edge.us.us.i.prol.loopexit, %._crit_edge.us.us.i, %middle.block106
  ...
  %indvars.iv.next.1.i.lcssa = phi i64 [ %i.ki, %middle.block106 ], [ %indvars.iv.next.1.i.lcssa153.unr, %._crit_edge.us.us.i.prol.loopexit ], [ %indvars.iv.next.1.i.3, %._crit_edge.us.us.i ] ; 6 uses
...
vector.memcheck:                                  ; preds = %vector.scevcheck
  %i.ms = shl i64 %indvars.iv.next.1.i.lcssa, 2
  %i.mt = getelementptr i8, ptr %i.ft, i64 %i.ms
  %10 = add i64 %.0286.us.i, %wide.trip.count.i47
  %11 = add i64 %10, %indvars.iv9.i.lcssa
  %12 = add i64 %11, %indvars.iv9.1.i.lcssa
  %13 = shl i64 %12, 2
  %i.mu = getelementptr i8, ptr %i.ft, i64 %13
  %scevgep63 = getelementptr i8, ptr %i.mu, i64 8
  %bound0 = icmp ult ptr %i.mt, %scevgep67
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x i32>, ptr %i.mx, align 4, !tbaa !19, !alias.scope !99, !noalias !100
  ...
  tail call void @llvm.masked.scatter.v8i32.v8p0(<8 x i32> %i.my, <8 x ptr> align 4 %wide.gep, <8 x i1> splat (i1 true)), !tbaa !19, !alias.scope !100
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %vec.ind.next = add <8 x i32> %vec.ind, splat (i32 8)
  %i.ne = icmp eq i64 %index.next, %n.vec
  br i1 %i.ne, label %middle.block, label %vector.body, !llvm.loop !91
...
._crit_edge.us.us.1.i.prol:                       ; preds = %._crit_edge.us.us.1.i.preheader149, %._crit_edge.us.us.1.i.prol
  ...
  %i.ng = load i32, ptr %i.nf, align 4, !tbaa !19
  ...
  store i32 %i.nh, ptr %i.nm, align 4, !tbaa !19
...
._crit_edge.us.us.1.i:                            ; preds = %._crit_edge.us.us.1.i.prol.loopexit, %._crit_edge.us.us.1.i
  ...
  %i.nq = load i32, ptr %i.np, align 4, !tbaa !19
  ...
  store i32 %i.oa, ptr %i.og, align 4, !tbaa !19
  ...
  store i32 %i.ok, ptr %i.oq, align 4, !tbaa !19
  ...
  store i32 %i.ou, ptr %i.pa, align 4, !tbaa !19
