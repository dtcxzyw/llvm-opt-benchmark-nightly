...
_ZN12_GLOBAL__N_112pbc_rvec_subEPK5t_pbcPKfS4_Pf.exit61: ; preds = %bb.c, %bb.d
  ...
  %14 = insertelement <2 x double> poison, double %i.aw, i64 0
  %15 = insertelement <2 x double> %14, double %i.av, i64 1
  %16 = fadd <2 x double> %15, splat (double 1.000000e+00) ; 4 uses
  %17 = extractelement <2 x double> %16, i64 1
  %i.ch = fmul double %17, %i.bg
  %18 = extractelement <2 x double> %16, i64 0
  %i.ci = call double @llvm.fmuladd.f64(double %18, double %i.bb, double %i.ch)
...
_ZN12_GLOBAL__N_112pbc_rvec_subEPK5t_pbcPKfS4_Pf.exit66: ; preds = %bb.c, %bb.d
  ...
  %14 = insertelement <2 x double> poison, double %i.ba, i64 0
  %15 = insertelement <2 x double> %14, double %i.az, i64 1
  %16 = fadd <2 x double> %15, splat (double 1.000000e+00) ; 4 uses
  %17 = extractelement <2 x double> %16, i64 1
  %i.cl = fmul double %17, %i.bk
  %18 = extractelement <2 x double> %16, i64 0
  %i.cm = call double @llvm.fmuladd.f64(double %18, double %i.bf, double %i.cl)
  %i.cn = fmul double %i.ay, %i.cm
  %i.co = fptrunc double %i.cn to float           ; 2 uses
  %i.cp = fneg <2 x double> %i.bv
  %19 = shufflevector <2 x double> %16, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.cq = fmul <2 x double> %19, %i.cp
  %i.cr = shufflevector <2 x double> %16, <2 x double> poison, <2 x i32> zeroinitializer
