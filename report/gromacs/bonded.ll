...
_ZN12_GLOBAL__N_121cmap_setup_grid_indexEiiPiS0_S0_.exit286: ; preds = %bb.aj, %bb.ak, %bb.al
  ...
  %i.jl = getelementptr [4 x i8], ptr %i.ay, i64 %i.jk ; 3 uses
  ...
  %i.jz = getelementptr i8, ptr %i.jp, i64 4
  %i.ka = load float, ptr %i.jz, align 4, !tbaa !18
  %i.kb = getelementptr i8, ptr %i.jt, i64 4
  %i.kc = load float, ptr %i.kb, align 4, !tbaa !18
  %i.kd = getelementptr i8, ptr %i.jx, i64 4
  ...
  %i.ku = fptrunc double %i.kt to float           ; 16 uses
  ...
  %17 = getelementptr i8, ptr %i.jl, i64 4
  %18 = load <2 x float>, ptr %17, align 4, !tbaa !18
  %19 = insertelement <2 x float> poison, float %i.ku, i64 0
  %20 = shufflevector <2 x float> %19, <2 x float> poison, <2 x i32> zeroinitializer ; 3 uses
  %21 = fmul <2 x float> %18, %20                 ; 2 uses
  %broadcast.splat442 = shufflevector <2 x float> %21, <2 x float> poison, <8 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1> ; 2 uses
  %broadcast.splat440 = shufflevector <2 x float> %21, <2 x float> poison, <8 x i32> zeroinitializer ; 2 uses
  %broadcast.splatinsert437 = insertelement <8 x float> poison, float %i.jy, i64 0
  ...
  %i.ng = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.nf, <2 x float> %20, <2 x float> %i.ne)
  %i.nh = fdiv <2 x float> %i.ng, %20             ; 5 uses
