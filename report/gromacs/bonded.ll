...
.loopexit.loopexit:                               ; preds = %bb.b
  ...
  %i.bo = fmul float %i.bf, %i.bn                 ; 2 uses
  ...
  %14 = fdiv <2 x float> splat (float 1.000000e+00), %i.cd ; 2 uses
  %15 = extractelement <2 x float> %14, i64 0     ; 3 uses
  %16 = fmul float %i.bo, %15
  %17 = extractelement <2 x float> %14, i64 1     ; 3 uses
  %18 = fmul float %i.bo, %17
  %19 = fmul float %i.bn, %15
  %20 = fmul float %15, %16                       ; 2 uses
  %21 = fmul float %17, %18                       ; 2 uses
  %22 = fmul float %19, %17                       ; 3 uses
  %i.ce = fneg <2 x float> %i.bu
  %23 = insertelement <2 x float> poison, float %20, i64 0
  %24 = shufflevector <2 x float> %23, <2 x float> poison, <2 x i32> zeroinitializer
  %i.cf = fmul <2 x float> %24, %i.ce
  %25 = insertelement <2 x float> poison, float %22, i64 0
  %i.cg = shufflevector <2 x float> %25, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %i.ct = fmul float %20, %i.cs
  %i.cu = call float @llvm.fmuladd.f32(float %22, float %i.bq, float %i.ct) ; 2 uses
  %i.cv = fneg float %i.bq
  %i.cw = fmul float %21, %i.cv
  %i.cx = call float @llvm.fmuladd.f32(float %22, float %i.bp, float %i.cw) ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.bq = fmul float %i.bh, %i.bp                 ; 2 uses
  ...
  %i.bu = getelementptr inbounds [16 x i8], ptr %4, i64 %i.v ; 4 uses
  %i.bv = getelementptr inbounds [16 x i8], ptr %4, i64 %i.x ; 4 uses
  %i.bw = load <2 x float>, ptr %i.c, align 8, !tbaa !18 ; 4 uses
  %i.bx = load <2 x float>, ptr %i.d, align 8, !tbaa !18 ; 4 uses
  %i.by = shufflevector <2 x float> %i.bx, <2 x float> %i.bw, <2 x i32> <i32 1, i32 3> ; 2 uses
  %i.bz = fmul <2 x float> %i.by, %i.by
  %i.ca = shufflevector <2 x float> %i.bx, <2 x float> %i.bw, <2 x i32> <i32 0, i32 2> ; 2 uses
  %i.cb = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ca, <2 x float> %i.ca, <2 x float> %i.bz)
  %i.cc = insertelement <2 x float> poison, float %i.bs, i64 0
  ...
  %14 = fdiv <2 x float> splat (float 1.000000e+00), %i.cf ; 3 uses
  %15 = insertelement <2 x float> poison, float %i.bp, i64 0
  %16 = insertelement <2 x float> %15, float %i.bq, i64 1
  %17 = shufflevector <2 x float> %14, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %18 = fmul <2 x float> %16, %17
  %19 = fmul <2 x float> %18, %14                 ; 4 uses
  %20 = extractelement <2 x float> %14, i64 0     ; 2 uses
  %21 = fmul float %i.bq, %20
  %22 = fmul float %20, %21                       ; 2 uses
  %23 = extractelement <2 x float> %19, i64 0     ; 2 uses
  %i.cg = fneg <2 x float> %i.bw
  %i.ch = shufflevector <2 x float> %19, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.ci = fmul <2 x float> %i.ch, %i.cg
  %24 = shufflevector <2 x float> %19, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %25 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %24, <2 x float> %i.bx, <2 x float> %i.ci) ; 3 uses
  %i.cj = load <2 x float>, ptr %i.bt, align 4, !tbaa !18
  %i.ck = fsub <2 x float> %i.cj, %25
  store <2 x float> %i.ck, ptr %i.bt, align 4, !tbaa !18
  %26 = load float, ptr %i.bu, align 4, !tbaa !18
  %27 = getelementptr inbounds nuw i8, ptr %i.bu, i64 4 ; 2 uses
  %28 = load float, ptr %27, align 4, !tbaa !18
  %29 = getelementptr inbounds nuw i8, ptr %i.bv, i64 4 ; 2 uses
  %i.cl = fneg float %i.br
  %i.cm = extractelement <2 x float> %19, i64 1
  %i.cn = fmul float %i.cm, %i.cl
  %i.co = call float @llvm.fmuladd.f32(float %23, float %i.bs, float %i.cn) ; 3 uses
  %i.cp = fneg float %i.bs
  %i.cq = fmul float %22, %i.cp
  %i.cr = call float @llvm.fmuladd.f32(float %23, float %i.br, float %i.cq) ; 3 uses
  ...
  %30 = fneg <2 x float> %i.bx
  %31 = insertelement <2 x float> poison, float %22, i64 0
  %32 = shufflevector <2 x float> %31, <2 x float> poison, <2 x i32> zeroinitializer
  %33 = fmul <2 x float> %32, %30
  %34 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %24, <2 x float> %i.bw, <2 x float> %33) ; 4 uses
  %35 = fadd <2 x float> %34, %25                 ; 3 uses
  %36 = extractelement <2 x float> %35, i64 0
  %37 = fadd float %36, %26
  store float %37, ptr %i.bu, align 4, !tbaa !18
  %i.dg = load float, ptr %i.bv, align 4, !tbaa !18
  %38 = extractelement <2 x float> %34, i64 0
  %i.dh = fsub float %i.dg, %38
  store float %i.dh, ptr %i.bv, align 4, !tbaa !18
  %39 = extractelement <2 x float> %35, i64 1
  %40 = fadd float %39, %28
  store float %40, ptr %27, align 4, !tbaa !18
  %41 = load float, ptr %29, align 4, !tbaa !18
  %42 = extractelement <2 x float> %34, i64 1
  %43 = fsub float %41, %42
  store float %43, ptr %29, align 4, !tbaa !18
  %i.di = load float, ptr %i.df, align 4, !tbaa !18
  %44 = fsub float %i.di, %i.co
  %45 = load <2 x float>, ptr %i.de, align 4, !tbaa !18
  %46 = fsub <2 x float> %45, %25
  store <2 x float> %46, ptr %i.de, align 4, !tbaa !18
  store float %44, ptr %i.df, align 4, !tbaa !18
  %i.dj = load <2 x float>, ptr %i.j, align 4, !tbaa !18
  %i.dk = fadd <2 x float> %i.dj, %35
  %47 = load float, ptr %i.k, align 4, !tbaa !18
  %48 = fadd float %47, %i.cs
  store <2 x float> %i.dk, ptr %i.j, align 4, !tbaa !18
  store float %48, ptr %i.k, align 4, !tbaa !18
