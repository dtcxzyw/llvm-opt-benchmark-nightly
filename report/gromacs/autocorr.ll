...
.lr.ph:                                           ; preds = %bb.u
  ...
  %i.ap = zext i32 %.0147.fr to i64               ; 12 uses
  ...
  %i.bh = add nsw i64 %i.ap, -1                   ; 4 uses
...
.lr.ph137.us.us.us.i:                             ; preds = %.critedge.us.us.us.i, %.lr.ph137.us.us.us.preheader.i
  ...
  %umax1248 = call i64 @llvm.umax.i64(i64 %indvars.iv208.i, i64 %i.az)
  %27 = mul i64 %indvar, %i.bja
  %i.bnd = sub i64 %umax1248, %27
  %umin1249 = call i64 @llvm.umin.i64(i64 %i.bh, i64 %i.bnd)
  %i.bne = add nsw i64 %umin1249, 1               ; 3 uses
  %28 = getelementptr [4 x i8], ptr %i.eg, i64 %indvars.iv208.i ; 3 uses
...
vector.memcheck1235:                              ; preds = %.lr.ph137.us.us.us.i
  ...
  %bound11242 = icmp ult ptr %28, %scevgep1237
...
vector.ph1252:                                    ; preds = %vector.memcheck1235
  ...
  %i.bnn = load float, ptr %28, align 4, !tbaa !24, !alias.scope !227
...
bb.bu:                                            ; preds = %scalar.ph1250
  %i.bol = load float, ptr %28, align 4, !tbaa !24
...
.lr.ph137.us.i:                                   ; preds = %.critedge.us.i, %.lr.ph137.us.preheader.i
  ...
  %umax1286 = call i64 @llvm.umax.i64(i64 %indvars.iv192.i, i64 %i.az)
  %29 = mul i64 %indvar1272, %i.biq
  %i.bpp = sub i64 %umax1286, %29
  %umin1287 = call i64 @llvm.umin.i64(i64 %i.bh, i64 %i.bpp)
  %i.bpq = add nsw i64 %umin1287, 1               ; 3 uses
  %30 = getelementptr [4 x i8], ptr %i.eg, i64 %indvars.iv192.i ; 3 uses
...
vector.memcheck1269:                              ; preds = %.lr.ph137.us.i
  ...
  %bound11280 = icmp ult ptr %30, %scevgep1275
...
vector.ph1290:                                    ; preds = %vector.memcheck1269
  ...
  %i.bpz = load float, ptr %30, align 4, !tbaa !24, !alias.scope !237
...
bb.bz:                                            ; preds = %scalar.ph1288
  %i.bqo = load float, ptr %30, align 4, !tbaa !24
