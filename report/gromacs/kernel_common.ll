...
bb.b:                                             ; preds = %.preheader, %.loopexit
  ...
  %scevgep67 = getelementptr i8, ptr %2, i64 %i.y ; 5 uses
  %scevgep68.a = getelementptr i8, ptr %3, i64 %i.w ; 5 uses
  %scevgep69.a = getelementptr i8, ptr %3, i64 %i.y ; 5 uses
  %4 = shl nuw nsw i64 %indvars.iv56, 2
  %5 = add i64 %i.m, %4                           ; 2 uses
  %scevgep70.a = getelementptr i8, ptr %i.q, i64 %5 ; 4 uses
  %i.z = add i64 %i.i, %i.v                       ; 2 uses
  %scevgep71.a = getelementptr i8, ptr %i.q, i64 %i.z ; 4 uses
  %6 = icmp ult ptr %scevgep70.a, %scevgep71.a
  %umin = select i1 %6, ptr %scevgep70.a, ptr %scevgep71.a ; 2 uses
  %7 = icmp ugt ptr %scevgep70.a, %scevgep71.a
  %umax = select i1 %7, ptr %scevgep70.a, ptr %scevgep71.a
  %scevgep72 = getelementptr i8, ptr %umax, i64 4 ; 2 uses
  %scevgep73.a = getelementptr i8, ptr %i.q, i64 %i.w ; 2 uses
  %scevgep74.a = getelementptr i8, ptr %i.q, i64 %i.y ; 2 uses
  %scevgep75.a = getelementptr i8, ptr %i.s, i64 %5 ; 4 uses
  %scevgep76.a = getelementptr i8, ptr %i.s, i64 %i.z ; 4 uses
  %8 = icmp ult ptr %scevgep75.a, %scevgep76.a
  %umin77 = select i1 %8, ptr %scevgep75.a, ptr %scevgep76.a ; 2 uses
  %9 = icmp ugt ptr %scevgep75.a, %scevgep76.a
  %umax78 = select i1 %9, ptr %scevgep75.a, ptr %scevgep76.a
  %scevgep79 = getelementptr i8, ptr %umax78, i64 4 ; 2 uses
...
vector.memcheck:                                  ; preds = %.lr.ph.preheader
  %bound0 = icmp ult ptr %scevgep, %scevgep69.a
  %bound1 = icmp ult ptr %scevgep68.a, %scevgep67
  %found.conflict = and i1 %bound0, %bound1
  %bound082 = icmp ult ptr %scevgep, %scevgep72
  %bound183 = icmp ult ptr %umin, %scevgep67
  %found.conflict84 = and i1 %bound082, %bound183
  %conflict.rdx = or i1 %found.conflict, %found.conflict84
  %bound085.a = icmp ult ptr %scevgep, %scevgep74.a
  %bound186.a = icmp ult ptr %scevgep73.a, %scevgep67
  ...
  %bound190.a = icmp ult ptr %umin77, %scevgep67
