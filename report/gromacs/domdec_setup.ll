...
bb.ba:                                            ; preds = %bb.az
  ...
  %spec.select3334.i.i = tail call i32 @llvm.umin.i32(i32 %i.hm, i32 %i.ho) ; 2 uses
  %i.hq = icmp eq i32 %i.hm, %i.ho
  br i1 %i.hq, label %._crit_edge.i.i, label %.lr.ph.i.i

._crit_edge.i.i:                                  ; preds = %.lr.ph.i.i, %bb.ba
  %spec.select33.lcssa.i.i = phi i32 [ %spec.select3334.i.i, %bb.ba ], [ %spec.select33.i.i, %.lr.ph.i.i ]
  %i.hr = shl i32 %spec.select33.lcssa.i.i, %i.hp
  br label %_ZSt3gcdIiiENSt11common_typeIJT_T0_EE4typeES1_S2_.exit

.lr.ph.i.i:                                       ; preds = %bb.ba, %.lr.ph.i.i
  %spec.select3337.i.i = phi i32 [ %spec.select33.i.i, %.lr.ph.i.i ], [ %spec.select3334.i.i, %bb.ba ] ; 4 uses
  %.02736.i.i = phi i32 [ %spec.select3337.i.i, %.lr.ph.i.i ], [ %i.hm, %bb.ba ]
  %.02835.i.i = phi i32 [ %i.hu, %.lr.ph.i.i ], [ %i.ho, %bb.ba ]
  %spec.select.i.i = tail call i32 @llvm.umax.i32(i32 %.02736.i.i, i32 %.02835.i.i)
  %i.hs = sub i32 %spec.select.i.i, %spec.select3337.i.i ; 2 uses
  %i.ht = tail call range(i32 0, 33) i32 @llvm.cttz.i32(i32 %i.hs, i1 true)
  %i.hu = lshr exact i32 %i.hs, %i.ht             ; 3 uses
  %spec.select33.i.i = tail call i32 @llvm.umin.i32(i32 %spec.select3337.i.i, i32 %i.hu) ; 2 uses
  %i.hv = icmp eq i32 %spec.select3337.i.i, %i.hu
...
bb.bc:                                            ; preds = %bb.bb, %.critedge221
  %.1199 = phi float [ %i.ic, %bb.bb ], [ 0.000000e+00, %.critedge221 ] ; 2 uses
...
bb.bd:                                            ; preds = %bb.bc
  ...
  %i.iw = fadd float %.1199, %i.iv
  br label %bb.be

bb.be:                                            ; preds = %bb.bc, %bb.bd
  %.2200 = phi float [ %i.iw, %bb.bd ], [ %.1199, %bb.bc ] ; 2 uses
...
bb.bh:                                            ; preds = %bb.bg
  ...
  %spec.select3334.i.i.1 = tail call i32 @llvm.umin.i32(i32 %i.jc, i32 %i.je) ; 2 uses
  %i.jg = icmp eq i32 %i.jc, %i.je
  br i1 %i.jg, label %._crit_edge.i.i.1, label %.lr.ph.i.i.1

.lr.ph.i.i.1:                                     ; preds = %bb.bh, %.lr.ph.i.i.1
  %spec.select3337.i.i.1 = phi i32 [ %spec.select33.i.i.1, %.lr.ph.i.i.1 ], [ %spec.select3334.i.i.1, %bb.bh ] ; 4 uses
  %.02736.i.i.1 = phi i32 [ %spec.select3337.i.i.1, %.lr.ph.i.i.1 ], [ %i.jc, %bb.bh ]
  %.02835.i.i.1 = phi i32 [ %i.jj, %.lr.ph.i.i.1 ], [ %i.je, %bb.bh ]
  %spec.select.i.i.1 = tail call i32 @llvm.umax.i32(i32 %.02736.i.i.1, i32 %.02835.i.i.1)
  %i.jh = sub i32 %spec.select.i.i.1, %spec.select3337.i.i.1 ; 2 uses
  %i.ji = tail call range(i32 0, 33) i32 @llvm.cttz.i32(i32 %i.jh, i1 true)
  %i.jj = lshr exact i32 %i.jh, %i.ji             ; 3 uses
  %spec.select33.i.i.1 = tail call i32 @llvm.umin.i32(i32 %spec.select3337.i.i.1, i32 %i.jj) ; 2 uses
  %i.jk = icmp eq i32 %spec.select3337.i.i.1, %i.jj
  br i1 %i.jk, label %._crit_edge.i.i.1, label %.lr.ph.i.i.1, !llvm.loop !262

._crit_edge.i.i.1:                                ; preds = %.lr.ph.i.i.1, %bb.bh
  %spec.select33.lcssa.i.i.1 = phi i32 [ %spec.select3334.i.i.1, %bb.bh ], [ %spec.select33.i.i.1, %.lr.ph.i.i.1 ]
  %i.jl = shl i32 %spec.select33.lcssa.i.i.1, %i.jf
...
bb.bj:                                            ; preds = %bb.bi, %_ZSt3gcdIiiENSt11common_typeIJT_T0_EE4typeES1_S2_.exit.1
  ...
  %i.ju = tail call float @llvm.fmuladd.f32(float %i.ha, float %i.jt, float %.2200)
  br label %bb.bk

bb.bk:                                            ; preds = %bb.bj, %bb.be
  %.1199.1 = phi float [ %i.ju, %bb.bj ], [ %.2200, %bb.be ] ; 2 uses
...
bb.bm:                                            ; preds = %._crit_edge, %bb.bl
  ...
  %.2200.1 = phi float [ %.1199.1, %._crit_edge ], [ %i.ko, %bb.bl ]
