...
begin_hunk_0_@_Z11gmx_clusteriPPc:bb.a
  store float %i.acv, ptr %i.acw, align 4, !tbaa !27
  ...
  %i.acz = load float, ptr %i.acx, align 4, !tbaa !27
  store float %i.acz, ptr %i.acy, align 4, !tbaa !27
  %i.ada = getelementptr inbounds nuw i8, ptr %i.acx, i64 4
  %i.adb = load float, ptr %i.ada, align 4, !tbaa !27
  %i.adc = getelementptr inbounds nuw i8, ptr %i.acy, i64 4
  store float %i.adb, ptr %i.adc, align 4, !tbaa !27
  %i.add = getelementptr inbounds nuw i8, ptr %i.acx, i64 8
  %i.ade = load float, ptr %i.add, align 4, !tbaa !27
  %i.adf = getelementptr inbounds nuw i8, ptr %i.acy, i64 8
  store float %i.ade, ptr %i.adf, align 4, !tbaa !27
  ...
  %i.adi = load float, ptr %i.adg, align 4, !tbaa !27
  store float %i.adi, ptr %i.adh, align 4, !tbaa !27
  %i.adj = getelementptr inbounds nuw i8, ptr %i.adg, i64 4
  %i.adk = load float, ptr %i.adj, align 4, !tbaa !27
  %i.adl = getelementptr inbounds nuw i8, ptr %i.adh, i64 4
  store float %i.adk, ptr %i.adl, align 4, !tbaa !27
  %i.adm = getelementptr inbounds nuw i8, ptr %i.adg, i64 8
  %i.adn = load float, ptr %i.adm, align 4, !tbaa !27
  %i.ado = getelementptr inbounds nuw i8, ptr %i.adh, i64 8
  store float %i.adn, ptr %i.ado, align 4, !tbaa !27
  ...
  %i.adr = load float, ptr %i.adp, align 4, !tbaa !27
  store float %i.adr, ptr %i.adq, align 4, !tbaa !27
  %i.ads = getelementptr inbounds nuw i8, ptr %i.adp, i64 4
  %i.adt = load float, ptr %i.ads, align 4, !tbaa !27
  %i.adu = getelementptr inbounds nuw i8, ptr %i.adq, i64 4
  store float %i.adt, ptr %i.adu, align 4, !tbaa !27
  %i.adv = getelementptr inbounds nuw i8, ptr %i.adp, i64 8
  %i.adw = load float, ptr %i.adv, align 4, !tbaa !27
  %i.adx = getelementptr inbounds nuw i8, ptr %i.adq, i64 8
  store float %i.adw, ptr %i.adx, align 4, !tbaa !27
  ...
  br i1 %exitcond861.not.3, label %._crit_edge.us, label %scalar.ph, !llvm.loop !75
...
bb.ej:                                            ; preds = %bb.ei, %._crit_edge.us
  ...
  %i.aeb = load ptr, ptr %i.aea, align 8, !tbaa !32
...
bb.el:                                            ; preds = %bb.ek
  ...
  br i1 %exitcond866.not, label %_ZL13gmx_snew_implIA3_fEvPKcS2_iRPT_m.exit, label %.preheader726.us, !llvm.loop !76
...
.preheader726:                                    ; preds = %.preheader726.lr.ph, %bb.ep
  ...
  %i.aeg = load i8, ptr %i.x, align 1, !tbaa !14, !range !28, !noundef !29
...
bb.en:                                            ; preds = %bb.em, %.preheader726
  ...
  %i.ael = load ptr, ptr %i.aek, align 8, !tbaa !32
...
bb.ep:                                            ; preds = %bb.eo
  ...
  br i1 %exitcond856.not, label %_ZL13gmx_snew_implIA3_fEvPKcS2_iRPT_m.exit, label %.preheader726, !llvm.loop !76
...
_ZL13gmx_snew_implIA3_fEvPKcS2_iRPT_m.exit:       ; preds = %bb.ep, %bb.el, %bb.eh
  ...
  %i.aet = load ptr, ptr @stderr, align 8, !tbaa !19
  ...
  br i1 %exitcond871.not, label %_ZL14gmx_sfree_implIPfEvPKcS2_iPT_.exit.invoke, label %bb.eh, !llvm.loop !77
...
_ZL13gmx_snew_implIPfEvPKcS2_iRPT_m.exit422:      ; preds = %bb.er
  ...
  store ptr %i.afo, ptr %i.afp, align 8, !tbaa !32
  ...
  br i1 %exitcond876.not, label %.preheader723, label %.lr.ph783, !llvm.loop !78
...
bb.es:                                            ; preds = %.lr.ph790, %._crit_edge
  ...
  %i.afr = load ptr, ptr %i.afq, align 8, !tbaa !32 ; 9 uses
...
.loopexit.i432:                                   ; preds = %scalar.ph1093.prol.loopexit, %scalar.ph1093, %middle.block1110
  ...
  br i1 %exitcond25.not.i, label %_ZL9calc_distiPA3_fPPf.exit, label %.lr.ph.i429, !llvm.loop !79

.lr.ph.i429:                                      ; preds = %.lr.ph.i429.preheader, %.loopexit.i432
  %indvars.iv21.i = phi i64 [ %indvars.iv.next22.i, %.loopexit.i432 ], [ 0, %.lr.ph.i429.preheader ] ; 4 uses
  %indvars.iv.i430 = phi i64 [ %indvars.iv.next.i433, %.loopexit.i432 ], [ 1, %.lr.ph.i429.preheader ] ; 7 uses
  ...
  %i.afw = load ptr, ptr %i.afv, align 8, !tbaa !32 ; 6 uses
  %i.afx = xor i64 %indvars.iv21.i, -1
  %i.afy = add nsw i64 %i.afx, %wide.trip.count.i428 ; 3 uses
  %min.iters.check1094 = icmp ult i64 %i.afy, 8
  br i1 %min.iters.check1094, label %scalar.ph1093.preheader, label %vector.memcheck1080

vector.memcheck1080:                              ; preds = %.lr.ph.i429
  %i.afz = mul nuw nsw i64 %indvars.iv.i430, 12
  %scevgep1083 = getelementptr nuw i8, ptr %i.afr, i64 %i.afz
  %i.aga = shl nuw nsw i64 %indvars.iv.i430, 2
  %scevgep1081 = getelementptr nuw i8, ptr %i.afw, i64 %i.aga ; 2 uses
...
vector.ph1095:                                    ; preds = %vector.memcheck1080
  %n.vec1096 = and i64 %i.afy, -8                 ; 3 uses
  ...
  %i.agd = load float, ptr %i.aft, align 4, !tbaa !27, !alias.scope !202
  ...
  %i.age = load float, ptr %i.afu, align 4, !tbaa !27, !alias.scope !202
...
vector.body1097:                                  ; preds = %vector.body1097, %vector.ph1095
  ...
  %wide.vec1099 = load <24 x float>, ptr %i.agg, align 4, !tbaa !27, !alias.scope !203 ; 3 uses
  ...
  store <8 x float> %i.agn, ptr %i.ago, align 4, !tbaa !27, !alias.scope !204, !noalias !205
  %index.next1109 = add nuw i64 %index1098, 8     ; 2 uses
  %i.agp = icmp eq i64 %index.next1109, %n.vec1096
  br i1 %i.agp, label %middle.block1110, label %vector.body1097, !llvm.loop !84

middle.block1110:                                 ; preds = %vector.body1097
  %cmp.n1111 = icmp eq i64 %i.afy, %n.vec1096
...
scalar.ph1093.prol:                               ; preds = %scalar.ph1093.preheader
  ...
  %i.ags = load float, ptr %i.afs, align 4, !tbaa !27
  %i.agt = load float, ptr %i.agr, align 4, !tbaa !27
  %i.agu = fsub float %i.ags, %i.agt              ; 2 uses
  %i.agv = load float, ptr %i.aft, align 4, !tbaa !27
  %i.agw = getelementptr inbounds nuw i8, ptr %i.agr, i64 4
  %i.agx = load float, ptr %i.agw, align 4, !tbaa !27
  %i.agy = fsub float %i.agv, %i.agx              ; 2 uses
  %i.agz = load float, ptr %i.afu, align 4, !tbaa !27
  %i.aha = getelementptr inbounds nuw i8, ptr %i.agr, i64 8
  %i.ahb = load float, ptr %i.aha, align 4, !tbaa !27
  ...
  store float %sqrt.i.i.prol, ptr %i.ahg, align 4, !tbaa !27
...
scalar.ph1093:                                    ; preds = %scalar.ph1093.prol.loopexit, %scalar.ph1093
  ...
  %i.ahj = load float, ptr %i.afs, align 4, !tbaa !27
  %i.ahk = load float, ptr %i.ahi, align 4, !tbaa !27
  %i.ahl = fsub float %i.ahj, %i.ahk              ; 2 uses
  %i.ahm = load float, ptr %i.aft, align 4, !tbaa !27
  %i.ahn = getelementptr inbounds nuw i8, ptr %i.ahi, i64 4
  %i.aho = load float, ptr %i.ahn, align 4, !tbaa !27
  %i.ahp = fsub float %i.ahm, %i.aho              ; 2 uses
  %i.ahq = load float, ptr %i.afu, align 4, !tbaa !27
  %i.ahr = getelementptr inbounds nuw i8, ptr %i.ahi, i64 8
  %i.ahs = load float, ptr %i.ahr, align 4, !tbaa !27
  ...
  store float %sqrt.i.i, ptr %i.ahx, align 4, !tbaa !27
  ...
  %i.ahz = load float, ptr %i.afs, align 4, !tbaa !27
  %i.aia = load float, ptr %i.ahy, align 4, !tbaa !27
  %i.aib = fsub float %i.ahz, %i.aia              ; 2 uses
  %i.aic = load float, ptr %i.aft, align 4, !tbaa !27
  %i.aid = getelementptr inbounds nuw i8, ptr %i.ahy, i64 4
  %i.aie = load float, ptr %i.aid, align 4, !tbaa !27
  %i.aif = fsub float %i.aic, %i.aie              ; 2 uses
  %i.aig = load float, ptr %i.afu, align 4, !tbaa !27
  %i.aih = getelementptr inbounds nuw i8, ptr %i.ahy, i64 8
  %i.aii = load float, ptr %i.aih, align 4, !tbaa !27
  ...
  store float %sqrt.i.i.1, ptr %i.ain, align 4, !tbaa !27
  ...
  br i1 %exitcond.not.i431.1, label %.loopexit.i432, label %scalar.ph1093, !llvm.loop !85
...
.lr.ph17.preheader.i435.us:                       ; preds = %.lr.ph17.preheader.i435.us.preheader, %bb.et
  ...
  %i.aiu = load ptr, ptr %i.ait, align 8, !tbaa !32 ; 9 uses
...
.lr.ph.i438.us:                                   ; preds = %.loopexit.i446.us, %.lr.ph17.preheader.i435.us
  %indvars.iv21.i439.us = phi i64 [ 0, %.lr.ph17.preheader.i435.us ], [ %indvars.iv.next22.i441.us, %.loopexit.i446.us ] ; 4 uses
  %indvars.iv.i440.us = phi i64 [ 1, %.lr.ph17.preheader.i435.us ], [ %indvars.iv.next.i447.us, %.loopexit.i446.us ] ; 7 uses
  ...
  %i.aiz = load ptr, ptr %i.aiy, align 8, !tbaa !32 ; 6 uses
  %i.aja = xor i64 %indvars.iv21.i439.us, -1
  %i.ajb = add nsw i64 %i.aja, %wide.trip.count.i428 ; 3 uses
  %min.iters.check1063 = icmp ult i64 %i.ajb, 8
  br i1 %min.iters.check1063, label %scalar.ph1062.preheader, label %vector.memcheck1050

vector.memcheck1050:                              ; preds = %.lr.ph.i438.us
  %i.ajc = mul nuw nsw i64 %indvars.iv.i440.us, 12
  %scevgep1053 = getelementptr nuw i8, ptr %i.aiu, i64 %i.ajc
  %i.ajd = shl nuw nsw i64 %indvars.iv.i440.us, 2
  %scevgep1051 = getelementptr nuw i8, ptr %i.aiz, i64 %i.ajd ; 2 uses
...
vector.ph1064:                                    ; preds = %vector.memcheck1050
  %n.vec1065 = and i64 %i.ajb, -8                 ; 3 uses
  ...
  %i.ajg = load float, ptr %i.aiw, align 4, !tbaa !27, !alias.scope !206
  ...
  %i.ajh = load float, ptr %i.aix, align 4, !tbaa !27, !alias.scope !206
...
vector.body1066:                                  ; preds = %vector.body1066, %vector.ph1064
  ...
  %wide.vec1068 = load <24 x float>, ptr %i.ajj, align 4, !tbaa !27, !alias.scope !207 ; 3 uses
  ...
  store <8 x float> %i.ajq, ptr %i.ajr, align 4, !tbaa !27, !alias.scope !208, !noalias !209
  %index.next1076 = add nuw i64 %index1067, 8     ; 2 uses
  %i.ajs = icmp eq i64 %index.next1076, %n.vec1065
  br i1 %i.ajs, label %middle.block1077, label %vector.body1066, !llvm.loop !90

middle.block1077:                                 ; preds = %vector.body1066
  %cmp.n1078 = icmp eq i64 %i.ajb, %n.vec1065
...
scalar.ph1062.prol:                               ; preds = %scalar.ph1062.preheader
  ...
  %i.ajv = load float, ptr %i.aiv, align 4, !tbaa !27
  %i.ajw = load float, ptr %i.aju, align 4, !tbaa !27
  %i.ajx = fsub float %i.ajv, %i.ajw              ; 2 uses
  %i.ajy = load float, ptr %i.aiw, align 4, !tbaa !27
  %i.ajz = getelementptr inbounds nuw i8, ptr %i.aju, i64 4
  %i.aka = load float, ptr %i.ajz, align 4, !tbaa !27
  %i.akb = fsub float %i.ajy, %i.aka              ; 2 uses
  %i.akc = load float, ptr %i.aix, align 4, !tbaa !27
  %i.akd = getelementptr inbounds nuw i8, ptr %i.aju, i64 8
  %i.ake = load float, ptr %i.akd, align 4, !tbaa !27
  ...
  store float %sqrt.i.i443.us.prol, ptr %i.akj, align 4, !tbaa !27
...
scalar.ph1062:                                    ; preds = %scalar.ph1062.prol.loopexit, %scalar.ph1062
  ...
  %i.akm = load float, ptr %i.aiv, align 4, !tbaa !27
  %i.akn = load float, ptr %i.akl, align 4, !tbaa !27
  %i.ako = fsub float %i.akm, %i.akn              ; 2 uses
  %i.akp = load float, ptr %i.aiw, align 4, !tbaa !27
  %i.akq = getelementptr inbounds nuw i8, ptr %i.akl, i64 4
  %i.akr = load float, ptr %i.akq, align 4, !tbaa !27
  %i.aks = fsub float %i.akp, %i.akr              ; 2 uses
  %i.akt = load float, ptr %i.aix, align 4, !tbaa !27
  %i.aku = getelementptr inbounds nuw i8, ptr %i.akl, i64 8
  %i.akv = load float, ptr %i.aku, align 4, !tbaa !27
  ...
  store float %sqrt.i.i443.us, ptr %i.ala, align 4, !tbaa !27
  ...
  %i.alc = load float, ptr %i.aiv, align 4, !tbaa !27
  %i.ald = load float, ptr %i.alb, align 4, !tbaa !27
  %i.ale = fsub float %i.alc, %i.ald              ; 2 uses
  %i.alf = load float, ptr %i.aiw, align 4, !tbaa !27
  %i.alg = getelementptr inbounds nuw i8, ptr %i.alb, i64 4
  %i.alh = load float, ptr %i.alg, align 4, !tbaa !27
  %i.ali = fsub float %i.alf, %i.alh              ; 2 uses
  %i.alj = load float, ptr %i.aix, align 4, !tbaa !27
  %i.alk = getelementptr inbounds nuw i8, ptr %i.alb, i64 8
  %i.all = load float, ptr %i.alk, align 4, !tbaa !27
  ...
  store float %sqrt.i.i443.us.1, ptr %i.alq, align 4, !tbaa !27
  ...
  br i1 %exitcond.not.i445.us.1, label %.loopexit.i446.us, label %scalar.ph1062, !llvm.loop !91
...
.loopexit.i446.us:                                ; preds = %scalar.ph1062.prol.loopexit, %scalar.ph1062, %middle.block1077
  ...
  br i1 %exitcond25.not.i448.us, label %.lr.ph.i452.us, label %.lr.ph.i438.us, !llvm.loop !79
...
.lr.ph.i452.us:                                   ; preds = %.loopexit.i446.us, %.loopexit.i455.us
  ...
  %i.alw = load ptr, ptr %i.alv, align 8, !tbaa !32 ; 9 uses
...
.prol.preheader:                                  ; preds = %.lr.ph.i452.us, %.prol.preheader
  ...
  br i1 %prol.iter1274.cmp.not, label %.prol.loopexit, label %.prol.preheader, !llvm.loop !92
...
.lr.ph.i452.us.new:                               ; preds = %.prol.loopexit, %.lr.ph.i452.us.new
  ...
  %i.amh = load float, ptr %i.amg, align 4, !tbaa !27
  ...
  %i.amn = load float, ptr %i.amm, align 4, !tbaa !27
  ...
  %i.amt = load float, ptr %i.ams, align 4, !tbaa !27
  ...
  %i.amz = load float, ptr %i.amy, align 4, !tbaa !27
