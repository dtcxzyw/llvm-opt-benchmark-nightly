...
.preheader99.lr.ph.i.i:                           ; preds = %bb.ck, %..preheader99.lr.ph.i_crit_edge.i
  ...
  %34 = fsub float %i.qi, %i.pc
  %35 = call float @llvm.fmuladd.f32(float %i.pc, float 0.000000e+00, float %i.qi) ; 3 uses
  ...
  %i.qq = extractelement <2 x float> %i.pg, i64 1 ; 4 uses
  %i.qr = fmul <2 x float> %i.qo, zeroinitializer ; 4 uses
  %36 = extractelement <3 x float> %i.pd, i64 2   ; 3 uses
  %37 = fsub <2 x float> %i.qj, %i.qk
  %i.qs = extractelement <2 x float> %i.qr, i64 0
  %i.qt = fmul float %i.qq, 0.000000e+00
  ...
  %i.qx = insertelement <4 x float> %i.qw, float %i.qq, i64 3
  %38 = fmul <4 x float> %i.qx, <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 0.000000e+00> ; 2 uses
  ...
  %i.rb = fsub <4 x float> %38, %i.ra             ; 3 uses
  %i.rc = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.qn, <2 x float> zeroinitializer, <2 x float> %i.qr) ; 3 uses
  %i.rd = call float @llvm.fmuladd.f32(float %36, float 0.000000e+00, float %i.qt) ; 3 uses
  ...
  %39 = shufflevector <4 x float> %i.rg, <4 x float> %38, <4 x i32> <i32 0, i32 7, i32 2, i32 3> ; 2 uses
  %i.rh = fadd <4 x float> %39, %i.pe
  %i.ri = fsub <4 x float> %39, %i.pe
  %i.rj = fsub float %i.qq, %36                   ; 3 uses
  %i.rk = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.qn, <2 x float> zeroinitializer, <2 x float> %i.qo)
  %i.rl = call float @llvm.fmuladd.f32(float %36, float 0.000000e+00, float %i.qq)
  ...
  %i.sa = insertelement <8 x float> poison, float %34, i64 0
  ...
  %i.sd = shufflevector <2 x float> %37, <2 x float> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %i.sj = insertelement <8 x float> %i.se, float %35, i64 3
...
bb.cp:                                            ; preds = %bb.co
  ...
  %i.wc = insertelement <8 x float> %i.se, float %35, i64 3
...
.preheader97.1.1.i.i.2:                           ; preds = %.preheader97.1.1.i.i.1, %bb.cp
  ...
  %i.xh = insertelement <8 x float> %i.se, float %35, i64 3
