...
bb.a:
  ...
  store float 1.000000e-01, ptr %i.b, align 4, !tbaa !19
...
bb.a:
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %i.a, ptr noundef nonnull align 4 dereferenceable(12) %1, i64 12, i1 false), !tbaa.struct !24
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 28
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %i.b, ptr noundef nonnull align 4 dereferenceable(12) %2, i64 12, i1 false), !tbaa.struct !24
  ...
  %i.i = load float, ptr %i.c, align 4, !tbaa !25 ; 2 uses
  %i.j = load <2 x float>, ptr %2, align 4, !tbaa !25
  %i.k = load <2 x float>, ptr %1, align 4, !tbaa !25 ; 2 uses
  ...
  store float %i.aa, ptr %.sroa.4.0..sroa_idx, align 4, !tbaa !23
  ret void
}
...
bb.a:
  ...
  %.sroa.22.0.copyload = load float, ptr %.sroa.22.0..sroa_idx, align 4, !tbaa !23
...
bb.a:
  %i.a = load float, ptr %1, align 4, !tbaa !25
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 52
  store float %i.a, ptr %i.b, align 4, !tbaa !19
  ret void
}
...
bb.a:
  ...
  store i32 %i.a, ptr %i.b, align 4, !tbaa !20
  ret void
}
...
bb.a:
  ...
  %.sroa.227.0.copyload = load float, ptr %.sroa.227.0..sroa_idx, align 8, !tbaa !23 ; 4 uses
  ...
  %i.g = fdiv float 1.000000e+00, %sqrt.i.i       ; 3 uses
  ...
  %.sroa.221.0.copyload = load float, ptr %.sroa.221.0..sroa_idx, align 4, !tbaa !23 ; 3 uses
  ...
  %5 = fmul float %i.g, %i.m                      ; 2 uses
  %6 = fmul float %i.i, %i.g                      ; 2 uses
  %i.n = insertelement <2 x float> poison, float %5, i64 0
  %i.o = shufflevector <2 x float> %i.n, <2 x float> poison, <2 x i32> zeroinitializer
  %i.p = fmul <2 x float> %i.o, %.sroa.026.0.copyload
  %i.q = fmul float %.sroa.227.0.copyload, %5
  %i.r = fsub <2 x float> %.sroa.020.0.copyload, %i.p
  %i.s = fsub float %.sroa.221.0.copyload, %i.q
  %7 = insertelement <2 x float> poison, float %6, i64 0
  %8 = shufflevector <2 x float> %7, <2 x float> poison, <2 x i32> zeroinitializer
  %9 = fmul <2 x float> %8, %i.r                  ; 2 uses
  %i.t = fmul float %6, %i.s                      ; 2 uses
  %i.u = fsub <2 x float> %.sroa.020.0.copyload, %9
  %i.v = fsub float %.sroa.221.0.copyload, %i.t
  store <2 x float> %9, ptr %0, align 4
  %.sroa.6.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 8
  store float %i.t, ptr %.sroa.6.0..sroa_idx, align 4, !tbaa !23
  ...
  store float %i.v, ptr %.sroa.4.0..sroa_idx54, align 4, !tbaa !23
...
bb.a:
  ...
  %i.h = load ptr, ptr %i.e, align 8, !tbaa !38   ; 2 uses
...
_ZSt6fill_nIPimiET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i: ; preds = %.noexc117
  ...
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.s, i8 0, i64 %.idx.i.i.i.i.i.i.i, i1 false), !tbaa !26
...
_ZNSt6vectorIiSaIiEEC2EmRKS0_.exit:               ; preds = %_ZSt6fill_nIPimiET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i, %.noexc117, %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i
  ...
  %i.w = load ptr, ptr %i.t, align 8, !tbaa !42   ; 8 uses
...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  %i.ae = load i32, ptr %i.ad, align 4, !tbaa !166
  %i.af = load i32, ptr %i.ac, align 8, !tbaa !49
  ...
  br i1 %epil.iter.cmp.not, label %.lr.ph224, label %.lr.ph.epil, !llvm.loop !159
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  %i.as = load i32, ptr %i.ar, align 4, !tbaa !166
  %i.at = load i32, ptr %i.aq, align 8, !tbaa !49
  ...
  %i.bb = load i32, ptr %i.ba, align 4, !tbaa !166
  %i.bc = load i32, ptr %i.az, align 8, !tbaa !49
  ...
  %i.bk = load i32, ptr %i.bj, align 4, !tbaa !166
  %i.bl = load i32, ptr %i.bi, align 8, !tbaa !49
  ...
  store i32 %i.bp, ptr %i.bn, align 4, !tbaa !26
  ...
  %i.bt = load i32, ptr %i.bs, align 4, !tbaa !166
  %i.bu = load i32, ptr %i.br, align 8, !tbaa !49
  ...
  br i1 %niter.ncmp.3, label %.lr.ph224.unr-lcssa, label %.lr.ph, !llvm.loop !160
...
bb.e:                                             ; preds = %.lr.ph224, %._crit_edge219
  ...
  %i.cb = load ptr, ptr %i.b, align 8, !tbaa !30  ; 5 uses
