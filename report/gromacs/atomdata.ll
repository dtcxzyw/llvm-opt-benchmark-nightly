...
.lr.ph66:                                         ; preds = %.lr.ph66.preheader, %_ZN3gmxL32nbnxn_atomdata_reduce_reals_simdEPfbPPKfiii.exit
  ...
  %i.ao = mul nsw i32 %i.am, %i.an                ; 5 uses
...
.lr.ph54.split.preheader.i:                       ; preds = %.lr.ph54.i
  ...
  %i.ca = xor i32 %i.ao, -1
  %i.cb = add i32 %i.aq, %i.ca
  %i.cc = lshr i32 %i.cb, 4
  %i.cd = zext nneg i32 %i.cc to i64
  %i.ce = shl nuw nsw i64 %i.cd, 6
  %i.cf = add nuw nsw i64 %i.ce, 64
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 64 dereferenceable(1) %scevgep.i, ptr noundef nonnull align 64 dereferenceable(1) %scevgep61.i, i64 %i.cf, i1 false), !tbaa !99, !noalias !396
...
.lr.ph.us.i:                                      ; preds = %._crit_edge.us.i, %.lr.ph.us.preheader.i
  ...
  %.val42.us.i = load <16 x float>, ptr %i.ck, align 64, !tbaa !99, !noalias !397 ; 2 uses
...
.lr.ph.us.i.new:                                  ; preds = %.lr.ph.us.i, %.lr.ph.us.i.new
  ...
  %i.db = load ptr, ptr %i.da, align 8, !tbaa !92, !alias.scope !396, !noalias !395
  %i.dc = getelementptr inbounds [4 x i8], ptr %i.db, i64 %indvars.iv64.i
  %.val.us.i.3 = load <16 x float>, ptr %i.dc, align 64, !tbaa !99, !noalias !397
  ...
  %i.dg = load ptr, ptr %i.df, align 8, !tbaa !92, !alias.scope !396, !noalias !395
  %i.dh = getelementptr inbounds [4 x i8], ptr %i.dg, i64 %indvars.iv64.i
  %.val.us.i.4 = load <16 x float>, ptr %i.dh, align 64, !tbaa !99, !noalias !397
  ...
  %i.dl = load ptr, ptr %i.dk, align 8, !tbaa !92, !alias.scope !396, !noalias !395
  %i.dm = getelementptr inbounds [4 x i8], ptr %i.dl, i64 %indvars.iv64.i
  %.val.us.i.5 = load <16 x float>, ptr %i.dm, align 64, !tbaa !99, !noalias !397
  ...
  %i.dq = load ptr, ptr %i.dp, align 8, !tbaa !92, !alias.scope !396, !noalias !395
  %i.dr = getelementptr inbounds [4 x i8], ptr %i.dq, i64 %indvars.iv64.i
  %.val.us.i.6 = load <16 x float>, ptr %i.dr, align 64, !tbaa !99, !noalias !397
  ...
  %i.dv = load ptr, ptr %i.du, align 8, !tbaa !92, !alias.scope !396, !noalias !395
  %i.dw = getelementptr inbounds [4 x i8], ptr %i.dv, i64 %indvars.iv64.i
  %.val.us.i.7 = load <16 x float>, ptr %i.dw, align 64, !tbaa !99, !noalias !397
  ...
  br i1 %niter101.ncmp.7, label %._crit_edge.us.i.unr-lcssa, label %.lr.ph.us.i.new, !llvm.loop !388
...
bb.h:                                             ; preds = %bb.h, %.epil.preheader94
  ...
  %i.dz = load ptr, ptr %i.dy, align 8, !tbaa !92, !alias.scope !396, !noalias !395
  %i.ea = getelementptr inbounds [4 x i8], ptr %i.dz, i64 %indvars.iv64.i
  %.val.us.i.epil = load <16 x float>, ptr %i.ea, align 64, !tbaa !99, !noalias !397
  ...
  br i1 %epil.iter96.cmp.not, label %._crit_edge.us.i, label %bb.h, !llvm.loop !389
...
._crit_edge.us.i:                                 ; preds = %bb.h, %._crit_edge.us.i.unr-lcssa
  ...
  store <16 x float> %.lcssa91, ptr %i.ec, align 64, !tbaa !99, !alias.scope !395, !noalias !396
  %indvars.iv.next65.i = add nsw i64 %indvars.iv64.i, 16 ; 2 uses
  %i.ed = icmp slt i64 %indvars.iv.next65.i, %i.cg
  br i1 %i.ed, label %.lr.ph.us.i, label %_ZN3gmxL32nbnxn_atomdata_reduce_reals_simdEPfbPPKfiii.exit, !llvm.loop !390
...
.lr.ph.i:                                         ; preds = %.epilog-lcssa, %.lr.ph.preheader.i
  ...
  %.val44.i = load <16 x float>, ptr %i.eh, align 64, !tbaa !99, !alias.scope !395, !noalias !396 ; 2 uses
...
bb.i:                                             ; preds = %bb.i, %.epil.preheader
  ...
  %i.ej = load ptr, ptr %i.ei, align 8, !tbaa !92, !alias.scope !396, !noalias !395
  %i.ek = getelementptr inbounds [4 x i8], ptr %i.ej, i64 %indvars.iv72.i
  %.val43.i.epil = load <16 x float>, ptr %i.ek, align 64, !tbaa !99, !noalias !397
  ...
  br i1 %epil.iter.cmp.not, label %.epilog-lcssa, label %bb.i, !llvm.loop !391

.epilog-lcssa:                                    ; preds = %bb.i, %.unr-lcssa
  %.lcssa = phi <16 x float> [ %i.fz, %.unr-lcssa ], [ %i.el, %bb.i ]
  store <16 x float> %.lcssa, ptr %i.eh, align 64, !tbaa !99, !alias.scope !395, !noalias !396
  %indvars.iv.next73.i = add nsw i64 %indvars.iv72.i, 16 ; 2 uses
  %i.em = icmp slt i64 %indvars.iv.next73.i, %i.ef
  br i1 %i.em, label %.lr.ph.i, label %_ZN3gmxL32nbnxn_atomdata_reduce_reals_simdEPfbPPKfiii.exit, !llvm.loop !392
...
.lr.ph.i.new:                                     ; preds = %.lr.ph.i, %.lr.ph.i.new
  ...
  %i.fd = load ptr, ptr %i.fc, align 8, !tbaa !92, !alias.scope !396, !noalias !395
  %i.fe = getelementptr inbounds [4 x i8], ptr %i.fd, i64 %indvars.iv72.i
  %.val43.i.3 = load <16 x float>, ptr %i.fe, align 64, !tbaa !99, !noalias !397
  ...
  %i.fi = load ptr, ptr %i.fh, align 16, !tbaa !92, !alias.scope !396, !noalias !395
  %i.fj = getelementptr inbounds [4 x i8], ptr %i.fi, i64 %indvars.iv72.i
  %.val43.i.4 = load <16 x float>, ptr %i.fj, align 64, !tbaa !99, !noalias !397
  ...
  %i.fn = load ptr, ptr %i.fm, align 8, !tbaa !92, !alias.scope !396, !noalias !395
  %i.fo = getelementptr inbounds [4 x i8], ptr %i.fn, i64 %indvars.iv72.i
  %.val43.i.5 = load <16 x float>, ptr %i.fo, align 64, !tbaa !99, !noalias !397
end_hunk_0
