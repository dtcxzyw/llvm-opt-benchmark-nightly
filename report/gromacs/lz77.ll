...
.lr.ph200:                                        ; preds = %.lr.ph200.preheader, %bb.o
  ...
  %.0112199 = phi i32 [ 0, %.lr.ph200.preheader ], [ %.3, %bb.o ] ; 5 uses
  %.1131194 = phi i32 [ 0, %.lr.ph200.preheader ], [ %.3133, %bb.o ] ; 13 uses
  %.0134193 = phi i32 [ 0, %.lr.ph200.preheader ], [ %.2136, %bb.o ] ; 4 uses
  %i.l = tail call i32 @llvm.smax.i32(i32 %.1131194, i32 65535)
  %spec.store.select = add nsw i32 %i.l, -65535   ; 2 uses
  %.not = icmp eq i32 %.1131194, 0
  br i1 %.not, label %bb.m, label %bb.a

bb.a:                                             ; preds = %.lr.ph200
  %i.m = sext i32 %.1131194 to i64                ; 5 uses
...
.lr.ph.split.us:                                  ; preds = %.lr.ph.split.us.preheader, %._crit_edge173.split.us.us
  %.0113181.us = phi i32 [ %i.al, %._crit_edge173.split.us.us ], [ 0, %.lr.ph.split.us.preheader ] ; 2 uses
  %.0114180.us = phi i32 [ %.1115.lcssa.us, %._crit_edge173.split.us.us ], [ 0, %.lr.ph.split.us.preheader ] ; 3 uses
  %.0118179.us = phi i32 [ %.1119.lcssa.us, %._crit_edge173.split.us.us ], [ 0, %.lr.ph.split.us.preheader ] ; 3 uses
  %i.ab = xor i32 %.0113181.us, -1
...
._crit_edge173.split.us.us:                       ; preds = %bb.f, %.lr.ph169.us, %.preheader160.us
  %.1119.lcssa.us = phi i32 [ %.0118179.us, %.preheader160.us ], [ %.1119167.us.us, %.lr.ph169.us ], [ %.2120.us.us, %bb.f ] ; 2 uses
  %.1115.lcssa.us = phi i32 [ %.0114180.us, %.preheader160.us ], [ %.1115168.us.us, %.lr.ph169.us ], [ %.2116.us.us, %bb.f ] ; 2 uses
  %i.al = add nuw nsw i32 %.0113181.us, 1         ; 2 uses
...
.preheader160.us:                                 ; preds = %.lr.ph.split.us
  %i.am = icmp slt i32 %i.aj, %.1131194
...
.lr.ph169.us:                                     ; preds = %.lr.ph169.us.preheader, %bb.f
  ...
  %.1115168.us.us = phi i32 [ %.0114180.us, %.lr.ph169.us.preheader ], [ %.2116.us.us, %bb.f ] ; 4 uses
  %.1119167.us.us = phi i32 [ %.0118179.us, %.lr.ph169.us.preheader ], [ %.2120.us.us, %bb.f ] ; 5 uses
...
._crit_edge.us.us:                                ; preds = %bb.b, %._crit_edge.us.us.split.loop.exit241
  %.0123.lcssa.us.us = phi i32 [ %i.at, %._crit_edge.us.us.split.loop.exit241 ], [ %i.z, %bb.b ] ; 4 uses
  %i.au = icmp sgt i32 %.0123.lcssa.us.us, %.1119167.us.us
...
bb.c:                                             ; preds = %._crit_edge.us.us
  ...
  %i.ax = zext nneg i32 %.0123.lcssa.us.us to i64
  %.not145.us.us = icmp sgt i64 %i.aw, %i.ax
  br i1 %.not145.us.us, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  %i.ay = icmp samesign ugt i32 %.0123.lcssa.us.us, 4
...
bb.f:                                             ; preds = %bb.e, %bb.d, %._crit_edge.us.us, %9
  %.2120.us.us = phi i32 [ %.0123.lcssa.us.us, %bb.e ], [ %.1119167.us.us, %9 ], [ %.1119167.us.us, %bb.d ], [ %.1119167.us.us, %._crit_edge.us.us ] ; 2 uses
  %.2116.us.us = phi i32 [ %i.ba, %bb.e ], [ %.1115168.us.us, %9 ], [ %.1115168.us.us, %bb.d ], [ %.1115168.us.us, %._crit_edge.us.us ] ; 2 uses
...
.critedge:                                        ; preds = %._crit_edge173.split.us.us, %.lr.ph.split.us
  %.0118.lcssa = phi i32 [ %.1119.lcssa.us, %._crit_edge173.split.us.us ], [ %.0118179.us, %.lr.ph.split.us ] ; 2 uses
  %.0114.lcssa = phi i32 [ %.1115.lcssa.us, %._crit_edge173.split.us.us ], [ %.0114180.us, %.lr.ph.split.us ]
  %spec.store.select1 = tail call i32 @llvm.smin.i32(i32 %.0118.lcssa, i32 65535) ; 3 uses
  %.not146 = icmp eq i32 %.0118.lcssa, 0
  br i1 %.not146, label %.critedge.thread, label %bb.g

bb.g:                                             ; preds = %.critedge
  %i.bb = sub nsw i32 %.1131194, %.0114.lcssa     ; 2 uses
...
bb.i:                                             ; preds = %bb.g
  ...
  %i.be = add nsw i32 %.0112199, 1
  %i.bf = sext i32 %.0112199 to i64
...
.lr.ph192.preheader:                              ; preds = %bb.h, %bb.i
  %.1 = phi i32 [ %.0112199, %bb.h ], [ %i.be, %bb.i ]
  %i.bh = add nsw i32 %.0134193, 1
  %i.bi = sext i32 %.0134193 to i64
...
bb.k:                                             ; preds = %.critedge.thread
  ...
  store i32 %.1131194, ptr %i.cy, align 4, !tbaa !8
...
add_circular.exit150:                             ; preds = %.critedge.thread, %bb.k
  store i32 %.1131194, ptr %i.co, align 4, !tbaa !8
  br label %bb.l

bb.l:                                             ; preds = %add_circular.exit150, %._crit_edge
  %.1135 = phi i32 [ %i.bh, %._crit_edge ], [ %.0134193, %add_circular.exit150 ]
  %.2132 = phi i32 [ %i.ch, %._crit_edge ], [ %.1131194, %add_circular.exit150 ]
...
bb.o:                                             ; preds = %add_circular.exit154, %bb.l
  %.2136 = phi i32 [ %.1135, %bb.l ], [ %.0134193, %add_circular.exit154 ] ; 2 uses
  %.3133 = phi i32 [ %i.dc, %bb.l ], [ 1, %add_circular.exit154 ] ; 2 uses
  %.3 = phi i32 [ %.2, %bb.l ], [ %.0112199, %add_circular.exit154 ] ; 2 uses
  %indvars.iv.next229 = add nuw nsw i64 %indvars.iv228, 1 ; 2 uses
  %i.dx = icmp slt i32 %.3133, %1
...
._crit_edge201:                                   ; preds = %._crit_edge201.loopexit, %.preheader161
  ...
  %.0125.lcssa = phi i32 [ 0, %.preheader161 ], [ %i.dy, %._crit_edge201.loopexit ]
  %.0112.lcssa = phi i32 [ 0, %.preheader161 ], [ %.3, %._crit_edge201.loopexit ]
  store i32 %.0112.lcssa, ptr %7, align 4, !tbaa !8
  store i32 %.0125.lcssa, ptr %3, align 4, !tbaa !8
  store i32 %.0134.lcssa, ptr %5, align 4, !tbaa !8
