...
_Z18gmx_ana_index_copyP15gmx_ana_index_tS0_b.exit.thread: ; preds = %_Z26gmx_ana_index_check_sortedP15gmx_ana_index_t.exit
  ...
  %umax = tail call i64 @llvm.umax.i64(i64 %4, i64 2) ; 2 uses
  %i.bn = add nsw i64 %umax, -1                   ; 2 uses
  %i.bo = add nsw i64 %umax, -2
  %xtraiter = and i64 %i.bn, 3                    ; 3 uses
  %i.bp = icmp ult i64 %i.bo, 3
  br i1 %i.bp, label %.peel.next.i.epil.preheader, label %_Z18gmx_ana_index_copyP15gmx_ana_index_tS0_b.exit.thread.new
...
.peel.next.i:                                     ; preds = %bb.r, %_Z18gmx_ana_index_copyP15gmx_ana_index_tS0_b.exit.thread.new
  ...
  %i.bq = getelementptr [4 x i8], ptr %i.bg, i64 %indvars.iv.i10 ; 2 uses
  %i.br = getelementptr i8, ptr %i.bq, i64 -4
  %i.bs = load i32, ptr %i.br, align 4, !tbaa !35
  %i.bt = load i32, ptr %i.bq, align 4, !tbaa !35 ; 2 uses
  %.not.i11 = icmp eq i32 %i.bs, %i.bt
  br i1 %.not.i11, label %.peel.next.i.1, label %bb.n

bb.n:                                             ; preds = %.peel.next.i
  %i.bu = sext i32 %.01415.i to i64
  %i.bv = getelementptr inbounds [4 x i8], ptr %i.bg, i64 %i.bu
  store i32 %i.bt, ptr %i.bv, align 4, !tbaa !35
  %i.bw = add nsw i32 %.01415.i, 1
  br label %.peel.next.i.1

.peel.next.i.1:                                   ; preds = %bb.n, %.peel.next.i
  %.1.i12 = phi i32 [ %i.bw, %bb.n ], [ %.01415.i, %.peel.next.i ] ; 3 uses
  %i.bx = getelementptr [4 x i8], ptr %i.bg, i64 %indvars.iv.i10 ; 2 uses
  %i.by = getelementptr i8, ptr %i.bx, i64 4
  %i.bz = load i32, ptr %i.bx, align 4, !tbaa !35
  %i.ca = load i32, ptr %i.by, align 4, !tbaa !35 ; 2 uses
  %.not.i11.1 = icmp eq i32 %i.bz, %i.ca
  br i1 %.not.i11.1, label %.peel.next.i.2, label %bb.o

bb.o:                                             ; preds = %.peel.next.i.1
  %i.cb = sext i32 %.1.i12 to i64
  %i.cc = getelementptr inbounds [4 x i8], ptr %i.bg, i64 %i.cb
  store i32 %i.ca, ptr %i.cc, align 4, !tbaa !35
  %i.cd = add nsw i32 %.1.i12, 1
  br label %.peel.next.i.2

.peel.next.i.2:                                   ; preds = %bb.o, %.peel.next.i.1
  %.1.i12.1 = phi i32 [ %i.cd, %bb.o ], [ %.1.i12, %.peel.next.i.1 ] ; 3 uses
  %i.ce = getelementptr [4 x i8], ptr %i.bg, i64 %indvars.iv.i10 ; 2 uses
  %i.cf = getelementptr i8, ptr %i.ce, i64 8
  %i.cg = getelementptr i8, ptr %i.ce, i64 4
  %i.ch = load i32, ptr %i.cg, align 4, !tbaa !35
  %i.ci = load i32, ptr %i.cf, align 4, !tbaa !35 ; 2 uses
  %.not.i11.2 = icmp eq i32 %i.ch, %i.ci
  br i1 %.not.i11.2, label %.peel.next.i.3, label %bb.p

bb.p:                                             ; preds = %.peel.next.i.2
  %i.cj = sext i32 %.1.i12.1 to i64
  %i.ck = getelementptr inbounds [4 x i8], ptr %i.bg, i64 %i.cj
  store i32 %i.ci, ptr %i.ck, align 4, !tbaa !35
  %i.cl = add nsw i32 %.1.i12.1, 1
  br label %.peel.next.i.3

.peel.next.i.3:                                   ; preds = %bb.p, %.peel.next.i.2
  %.1.i12.2 = phi i32 [ %i.cl, %bb.p ], [ %.1.i12.1, %.peel.next.i.2 ] ; 3 uses
  %i.cm = getelementptr [4 x i8], ptr %i.bg, i64 %indvars.iv.i10 ; 2 uses
  %i.cn = getelementptr i8, ptr %i.cm, i64 12
  %i.co = getelementptr i8, ptr %i.cm, i64 8
  %i.cp = load i32, ptr %i.co, align 4, !tbaa !35
  %i.cq = load i32, ptr %i.cn, align 4, !tbaa !35 ; 2 uses
  %.not.i11.3 = icmp eq i32 %i.cp, %i.cq
  br i1 %.not.i11.3, label %bb.r, label %bb.q

bb.q:                                             ; preds = %.peel.next.i.3
  %i.cr = sext i32 %.1.i12.2 to i64
  %i.cs = getelementptr inbounds [4 x i8], ptr %i.bg, i64 %i.cr
  store i32 %i.cq, ptr %i.cs, align 4, !tbaa !35
  %i.ct = add nsw i32 %.1.i12.2, 1
  br label %bb.r

bb.r:                                             ; preds = %bb.q, %.peel.next.i.3
  %.1.i12.3 = phi i32 [ %i.ct, %bb.q ], [ %.1.i12.2, %.peel.next.i.3 ] ; 3 uses
...
.peel.next.i.epil:                                ; preds = %bb.t, %.peel.next.i.epil.preheader
  ...
  %i.cu = getelementptr [4 x i8], ptr %i.bg, i64 %indvars.iv.i10.epil ; 2 uses
  %i.cv = getelementptr i8, ptr %i.cu, i64 -4
  %i.cw = load i32, ptr %i.cv, align 4, !tbaa !35
  %i.cx = load i32, ptr %i.cu, align 4, !tbaa !35 ; 2 uses
  %.not.i11.epil = icmp eq i32 %i.cw, %i.cx
  br i1 %.not.i11.epil, label %bb.t, label %bb.s

bb.s:                                             ; preds = %.peel.next.i.epil
  %i.cy = sext i32 %.01415.i.epil to i64
  %i.cz = getelementptr inbounds [4 x i8], ptr %i.bg, i64 %i.cy
  store i32 %i.cx, ptr %i.cz, align 4, !tbaa !35
  %i.da = add nsw i32 %.01415.i.epil, 1
  br label %bb.t

bb.t:                                             ; preds = %bb.s, %.peel.next.i.epil
  %.1.i12.epil = phi i32 [ %i.da, %bb.s ], [ %.01415.i.epil, %.peel.next.i.epil ] ; 2 uses
...
_Z31gmx_ana_index_remove_duplicatesP15gmx_ana_index_t.exit: ; preds = %bb.t, %_Z31gmx_ana_index_remove_duplicatesP15gmx_ana_index_t.exit.unr-lcssa
  ...
  %i.db = icmp sgt i32 %.1.i12.lcssa, 0
  %.pre.i14 = load i32, ptr %1, align 8, !tbaa !85 ; 7 uses
  br i1 %i.db, label %.preheader.lr.ph.i.i31, label %_Z29gmx_ana_index_difference_sizeP15gmx_ana_index_tS0_.exit.i15
...
.preheader.i.i33:                                 ; preds = %bb.x, %.preheader.lr.ph.i.i31
  ...
  %i.de = icmp slt i32 %.01726.i.i36, %.pre.i14
  br i1 %i.de, label %.lr.ph.i.i46, label %.critedge.i.i37

.lr.ph.i.i46:                                     ; preds = %.preheader.i.i33
  %i.df = load ptr, ptr %i.dc, align 8, !tbaa !122
  %i.dg = getelementptr inbounds nuw [4 x i8], ptr %i.bg, i64 %indvars.iv30.i.i34
  %i.dh = load i32, ptr %i.dg, align 4, !tbaa !35
  %i.di = sext i32 %.01726.i.i36 to i64
  br label %bb.u

bb.u:                                             ; preds = %bb.v, %.lr.ph.i.i46
  %indvars.iv.i.i47 = phi i64 [ %i.di, %.lr.ph.i.i46 ], [ %indvars.iv.next.i.i49, %bb.v ] ; 3 uses
  %i.dj = getelementptr inbounds [4 x i8], ptr %i.df, i64 %indvars.iv.i.i47
  %i.dk = load i32, ptr %i.dj, align 4, !tbaa !35
  %i.dl = icmp slt i32 %i.dk, %i.dh
  br i1 %i.dl, label %bb.v, label %.critedge.loopexit.i.i48

bb.v:                                             ; preds = %bb.u
  %indvars.iv.next.i.i49 = add nsw i64 %indvars.iv.i.i47, 1 ; 2 uses
  %exitcond.not.i.i50 = icmp eq i64 %indvars.iv.next.i.i49, %i.dd
  br i1 %exitcond.not.i.i50, label %.critedge.thread.i.i40, label %bb.u, !llvm.loop !162

.critedge.loopexit.i.i48:                         ; preds = %bb.u
  %i.dm = trunc nsw i64 %indvars.iv.i.i47 to i32
  br label %.critedge.i.i37

.critedge.i.i37:                                  ; preds = %.critedge.loopexit.i.i48, %.preheader.i.i33
  %.118.lcssa.i.i38 = phi i32 [ %.01726.i.i36, %.preheader.i.i33 ], [ %i.dm, %.critedge.loopexit.i.i48 ] ; 4 uses
  %i.dn = icmp eq i32 %.118.lcssa.i.i38, %.pre.i14
  br i1 %i.dn, label %.critedge.thread.i.i40, label %bb.w

bb.w:                                             ; preds = %.critedge.i.i37
  %i.do = load ptr, ptr %i.dc, align 8, !tbaa !122
  %i.dp = sext i32 %.118.lcssa.i.i38 to i64
  %i.dq = getelementptr inbounds [4 x i8], ptr %i.do, i64 %i.dp
  %i.dr = load i32, ptr %i.dq, align 4, !tbaa !35
  %i.ds = getelementptr inbounds nuw [4 x i8], ptr %i.bg, i64 %indvars.iv30.i.i34
  %i.dt = load i32, ptr %i.ds, align 4, !tbaa !35
  %.not.i.i39 = icmp eq i32 %i.dr, %i.dt
...
bb.x:                                             ; preds = %.critedge.thread.i.i40, %bb.w
  ...
  %.1.i.i43 = phi i32 [ %i.du, %.critedge.thread.i.i40 ], [ %.027.i.i35, %bb.w ] ; 2 uses
...
_Z29gmx_ana_index_difference_sizeP15gmx_ana_index_tS0_.exit.i15: ; preds = %bb.x, %_Z31gmx_ana_index_remove_duplicatesP15gmx_ana_index_t.exit
  ...
  %i.dv = add nsw i32 %.0.lcssa.i.i16, %.pre.i14  ; 3 uses
  store i32 %i.dv, ptr %0, align 8, !tbaa !85
  %i.dw = icmp sgt i32 %i.dv, 0
  br i1 %i.dw, label %.lr.ph.i17, label %_Z19gmx_ana_index_unionP15gmx_ana_index_tS0_S0_.exit51

.lr.ph.i17:                                       ; preds = %_Z29gmx_ana_index_difference_sizeP15gmx_ana_index_tS0_.exit.i15
  %i.dx = add nsw i32 %.1.i12.lcssa, -1
  %i.dy = add nsw i32 %.pre.i14, -1
end_hunk_0
