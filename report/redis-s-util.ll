...
38:                                               ; preds = %35
  ...
  %40 = icmp eq i8 %39, 94                        ; [#uses=1 type=i1]
...
27:                                               ; preds = %22, %16
  %28 = phi double [ %23, %22 ], [ %17, %16 ]     ; [#uses=2 type=double]
...
30:                                               ; preds = %27
  %or.cond23 = call i1 @llvm.is.fpclass.f64(double %28, i32 615) ; [#uses=1 type=i1]
  br i1 %or.cond23, label %.critedge22.thread, label %.critedge, !prof !51

.critedge22:                                      ; preds = %27
  %.old = fcmp uno double %28, 0.000000e+00       ; [#uses=1 type=i1]
