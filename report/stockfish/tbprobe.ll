...
._crit_edge:                                      ; preds = %.lr.ph157, %.preheader146
  ...
  %.val105 = load i64, ptr %i.bg, align 1         ; 3 uses
  ...
  %2 = insertelement <8 x i64> %i.bo, i64 %.val105, i64 6
  %3 = insertelement <8 x i64> %2, i64 %.sroa.18.0.extract.shift.i, i64 7 ; 2 uses
  %4 = shufflevector <8 x i64> %3, <8 x i64> poison, <8 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 7, i32 6>
  %5 = shufflevector <4 x i64> %i.bj, <4 x i64> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %6 = shufflevector <8 x i64> %5, <8 x i64> %4, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 14, i32 15>
  %7 = shufflevector <2 x i64> %i.bl, <2 x i64> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %8 = shufflevector <8 x i64> %6, <8 x i64> %7, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 6, i32 7>
  %9 = and <8 x i64> %8, <i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 255>
  %10 = select i1 %i.bm, <8 x i64> %9, <8 x i64> %3
  %11 = shl <8 x i64> %10, <i64 48, i64 40, i64 32, i64 24, i64 16, i64 8, i64 0, i64 56>
  %12 = and <8 x i64> %11, <i64 71776119061217280, i64 280375465082880, i64 1095216660480, i64 4278190080, i64 16711680, i64 65280, i64 255, i64 -1>
  %13 = tail call i64 @llvm.vector.reduce.or.v8i64(<8 x i64> %12)
  %14 = getelementptr inbounds nuw i8, ptr %i.bg, i64 8
  %15 = getelementptr inbounds nuw i8, ptr %0, i64 80
  %16 = load ptr, ptr %15, align 8, !tbaa !281
  %17 = getelementptr inbounds nuw i8, ptr %0, i64 2
  %18 = load i8, ptr %17, align 2, !tbaa !487
  %19 = zext i8 %18 to i32
  %20 = getelementptr inbounds nuw i8, ptr %0, i64 24
  %21 = load ptr, ptr %20, align 8, !tbaa !490
  %22 = getelementptr inbounds nuw i8, ptr %0, i64 104
  %23 = load ptr, ptr %22, align 8, !tbaa !285    ; 3 uses
  br label %.outer
...
.outer:                                           ; preds = %_ZN9Stockfish12_GLOBAL__N_16numberIjLi0EEET_Pv.exit, %._crit_edge
  ...
  %.081.ph = phi ptr [ %i.cm, %_ZN9Stockfish12_GLOBAL__N_16numberIjLi0EEET_Pv.exit ], [ %14, %._crit_edge ] ; 2 uses
  %.078.ph = phi i64 [ %i.de, %_ZN9Stockfish12_GLOBAL__N_16numberIjLi0EEET_Pv.exit ], [ %13, %._crit_edge ]
  %.076.ph = phi i32 [ %i.cl, %_ZN9Stockfish12_GLOBAL__N_16numberIjLi0EEET_Pv.exit ], [ 64, %._crit_edge ]
  br label %bb.c
...
bb.d:                                             ; preds = %bb.d, %bb.c
  ...
  %i.bp = getelementptr inbounds nuw [8 x i8], ptr %16, i64 %indvars.iv
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.bu = add nuw i32 %i.bs, %19                  ; 3 uses
  %i.bv = sub i32 64, %i.bu
  %i.bw = zext nneg i32 %i.bv to i64
  %i.bx = lshr i64 %i.bt, %i.bw
  %i.by = trunc i64 %i.bx to i16
  %i.bz = getelementptr inbounds nuw [2 x i8], ptr %21, i64 %indvars.iv
  ...
  %i.cd = getelementptr inbounds nuw i8, ptr %23, i64 %i.cc
...
.lr.ph162:                                        ; preds = %.preheader, %bb.h
  ...
  %i.dn = getelementptr inbounds nuw i8, ptr %23, i64 %i.dm
...
bb.g:                                             ; preds = %.lr.ph162
  ...
  %.phi.trans.insert179 = getelementptr inbounds nuw i8, ptr %23, i64 %.pre177
