...
.prol.preheader:                                  ; preds = %.lr.ph, %.prol.preheader
  ...
  %indvars.iv.prol = phi i64 [ %indvars.iv.next.prol, %.prol.preheader ], [ %i.co, %.lr.ph ] ; 4 uses
  ...
  %.val84.prol = load i16, ptr %i.cs, align 1     ; 2 uses
  %.sroa.6.0.extract.shift.i85.prol = lshr i16 %.val84.prol, 8 ; 2 uses
  %3 = and i16 %.val84.prol, 255                  ; 2 uses
  %.sroa.6.0.insert.ext.i87.prol = select i1 %.not3.not.i86, i16 %3, i16 %.sroa.6.0.extract.shift.i85.prol
  %.sroa.6.0.insert.shift.i88.prol = shl nuw i16 %.sroa.6.0.insert.ext.i87.prol, 8
  %.sroa.0.0.insert.ext.i89.prol = select i1 %.not3.not.i86, i16 %.sroa.6.0.extract.shift.i85.prol, i16 %3
  %.sroa.0.0.insert.insert.i90.prol = or disjoint i16 %.sroa.6.0.insert.shift.i88.prol, %.sroa.0.0.insert.ext.i89.prol
  %4 = zext i16 %.sroa.0.0.insert.insert.i90.prol to i64
  %5 = add i64 %store_forwarded.prol, %4
  %6 = getelementptr inbounds nuw [2 x i8], ptr %i.cm, i64 %indvars.iv.prol
  %7 = getelementptr inbounds nuw i8, ptr %6, i64 2
  %.val83.prol = load i16, ptr %7, align 1        ; 2 uses
  %.sroa.6.0.extract.shift.i91.prol = lshr i16 %.val83.prol, 8 ; 2 uses
  %8 = and i16 %.val83.prol, 255                  ; 2 uses
  %.sroa.6.0.insert.ext.i93.prol = select i1 %.not3.not.i86, i16 %8, i16 %.sroa.6.0.extract.shift.i91.prol
  %.sroa.6.0.insert.shift.i94.prol = shl nuw i16 %.sroa.6.0.insert.ext.i93.prol, 8
  %.sroa.0.0.insert.ext.i95.prol = select i1 %.not3.not.i86, i16 %.sroa.6.0.extract.shift.i91.prol, i16 %8
  %.sroa.0.0.insert.insert.i96.prol = or disjoint i16 %.sroa.6.0.insert.shift.i94.prol, %.sroa.0.0.insert.ext.i95.prol
  %i.ct = zext i16 %.sroa.0.0.insert.insert.i96.prol to i64
  %i.cu = sub i64 %5, %i.ct
...
.lr.ph.new:                                       ; preds = %.prol.loopexit, %.lr.ph.new
  ...
  %indvars.iv = phi i64 [ %indvars.iv.next.3, %.lr.ph.new ], [ %indvars.iv.unr, %.prol.loopexit ] ; 7 uses
  %i.ea = getelementptr inbounds nuw [2 x i8], ptr %i.cm, i64 %indvars.iv
  %.val84 = load i16, ptr %i.ea, align 1          ; 2 uses
  %.sroa.6.0.extract.shift.i85 = lshr i16 %.val84, 8 ; 2 uses
  %9 = and i16 %.val84, 255                       ; 2 uses
  %.sroa.6.0.insert.ext.i87 = select i1 %.not3.not.i86, i16 %9, i16 %.sroa.6.0.extract.shift.i85
  %.sroa.6.0.insert.shift.i88 = shl nuw i16 %.sroa.6.0.insert.ext.i87, 8
  %.sroa.0.0.insert.ext.i89 = select i1 %.not3.not.i86, i16 %.sroa.6.0.extract.shift.i85, i16 %9
  %.sroa.0.0.insert.insert.i90 = or disjoint i16 %.sroa.6.0.insert.shift.i88, %.sroa.0.0.insert.ext.i89
  %10 = zext i16 %.sroa.0.0.insert.insert.i90 to i64
  %11 = add i64 %store_forwarded, %10
  %12 = getelementptr inbounds nuw [2 x i8], ptr %i.cm, i64 %indvars.iv
  %13 = getelementptr inbounds nuw i8, ptr %12, i64 2
  %.val83 = load i16, ptr %13, align 1            ; 2 uses
  %.sroa.6.0.extract.shift.i91 = lshr i16 %.val83, 8 ; 2 uses
  %14 = and i16 %.val83, 255                      ; 2 uses
  %.sroa.6.0.insert.ext.i93 = select i1 %.not3.not.i86, i16 %14, i16 %.sroa.6.0.extract.shift.i91
  %.sroa.6.0.insert.shift.i94 = shl nuw i16 %.sroa.6.0.insert.ext.i93, 8
  %.sroa.0.0.insert.ext.i95 = select i1 %.not3.not.i86, i16 %.sroa.6.0.extract.shift.i91, i16 %14
  %.sroa.0.0.insert.insert.i96 = or disjoint i16 %.sroa.6.0.insert.shift.i94, %.sroa.0.0.insert.ext.i95
  %i.eb = zext i16 %.sroa.0.0.insert.insert.i96 to i64
  %i.ec = sub i64 %11, %i.eb
  ...
  %.val84.1 = load i16, ptr %i.ef, align 1        ; 2 uses
  %.sroa.6.0.extract.shift.i85.1 = lshr i16 %.val84.1, 8 ; 2 uses
  %15 = and i16 %.val84.1, 255                    ; 2 uses
  %.sroa.6.0.insert.ext.i87.1 = select i1 %.not3.not.i86, i16 %15, i16 %.sroa.6.0.extract.shift.i85.1
  %.sroa.6.0.insert.shift.i88.1 = shl nuw i16 %.sroa.6.0.insert.ext.i87.1, 8
  %.sroa.0.0.insert.ext.i89.1 = select i1 %.not3.not.i86, i16 %.sroa.6.0.extract.shift.i85.1, i16 %15
  %.sroa.0.0.insert.insert.i90.1 = or disjoint i16 %.sroa.6.0.insert.shift.i88.1, %.sroa.0.0.insert.ext.i89.1
  %16 = zext i16 %.sroa.0.0.insert.insert.i90.1 to i64
  %17 = add nuw i64 %i.ed, %16
  %18 = getelementptr inbounds nuw [2 x i8], ptr %i.cm, i64 %indvars.iv.next
  %19 = getelementptr inbounds nuw i8, ptr %18, i64 2
  %.val83.1 = load i16, ptr %19, align 1          ; 2 uses
  %.sroa.6.0.extract.shift.i91.1 = lshr i16 %.val83.1, 8 ; 2 uses
  %20 = and i16 %.val83.1, 255                    ; 2 uses
  %.sroa.6.0.insert.ext.i93.1 = select i1 %.not3.not.i86, i16 %20, i16 %.sroa.6.0.extract.shift.i91.1
  %.sroa.6.0.insert.shift.i94.1 = shl nuw i16 %.sroa.6.0.insert.ext.i93.1, 8
  %.sroa.0.0.insert.ext.i95.1 = select i1 %.not3.not.i86, i16 %.sroa.6.0.extract.shift.i91.1, i16 %20
  %.sroa.0.0.insert.insert.i96.1 = or disjoint i16 %.sroa.6.0.insert.shift.i94.1, %.sroa.0.0.insert.ext.i95.1
  %i.eg = zext i16 %.sroa.0.0.insert.insert.i96.1 to i64
  %i.eh = sub i64 %17, %i.eg
  ...
  %.val84.2 = load i16, ptr %i.ek, align 1        ; 2 uses
  %.sroa.6.0.extract.shift.i85.2 = lshr i16 %.val84.2, 8 ; 2 uses
  %21 = and i16 %.val84.2, 255                    ; 2 uses
  %.sroa.6.0.insert.ext.i87.2 = select i1 %.not3.not.i86, i16 %21, i16 %.sroa.6.0.extract.shift.i85.2
  %.sroa.6.0.insert.shift.i88.2 = shl nuw i16 %.sroa.6.0.insert.ext.i87.2, 8
  %.sroa.0.0.insert.ext.i89.2 = select i1 %.not3.not.i86, i16 %.sroa.6.0.extract.shift.i85.2, i16 %21
  %.sroa.0.0.insert.insert.i90.2 = or disjoint i16 %.sroa.6.0.insert.shift.i88.2, %.sroa.0.0.insert.ext.i89.2
  %22 = zext i16 %.sroa.0.0.insert.insert.i90.2 to i64
  %23 = add nuw i64 %i.ei, %22
  %24 = getelementptr inbounds nuw [2 x i8], ptr %i.cm, i64 %indvars.iv.next.1
  %25 = getelementptr inbounds nuw i8, ptr %24, i64 2
  %.val83.2 = load i16, ptr %25, align 1          ; 2 uses
  %.sroa.6.0.extract.shift.i91.2 = lshr i16 %.val83.2, 8 ; 2 uses
  %26 = and i16 %.val83.2, 255                    ; 2 uses
  %.sroa.6.0.insert.ext.i93.2 = select i1 %.not3.not.i86, i16 %26, i16 %.sroa.6.0.extract.shift.i91.2
  %.sroa.6.0.insert.shift.i94.2 = shl nuw i16 %.sroa.6.0.insert.ext.i93.2, 8
  %.sroa.0.0.insert.ext.i95.2 = select i1 %.not3.not.i86, i16 %.sroa.6.0.extract.shift.i91.2, i16 %26
  %.sroa.0.0.insert.insert.i96.2 = or disjoint i16 %.sroa.6.0.insert.shift.i94.2, %.sroa.0.0.insert.ext.i95.2
  %i.el = zext i16 %.sroa.0.0.insert.insert.i96.2 to i64
  %i.em = sub i64 %23, %i.el
  ...
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, -3 ; 4 uses
  %i.ep = getelementptr inbounds nuw [2 x i8], ptr %i.cm, i64 %indvars.iv.next.2
  %.val84.3 = load i16, ptr %i.ep, align 1        ; 2 uses
  %.sroa.6.0.extract.shift.i85.3 = lshr i16 %.val84.3, 8 ; 2 uses
  %27 = and i16 %.val84.3, 255                    ; 2 uses
  %.sroa.6.0.insert.ext.i87.3 = select i1 %.not3.not.i86, i16 %27, i16 %.sroa.6.0.extract.shift.i85.3
  %.sroa.6.0.insert.shift.i88.3 = shl nuw i16 %.sroa.6.0.insert.ext.i87.3, 8
  %.sroa.0.0.insert.ext.i89.3 = select i1 %.not3.not.i86, i16 %.sroa.6.0.extract.shift.i85.3, i16 %27
  %.sroa.0.0.insert.insert.i90.3 = or disjoint i16 %.sroa.6.0.insert.shift.i88.3, %.sroa.0.0.insert.ext.i89.3
  %28 = zext i16 %.sroa.0.0.insert.insert.i90.3 to i64
  %29 = add nuw i64 %i.en, %28
  %30 = getelementptr inbounds nuw [2 x i8], ptr %i.cm, i64 %indvars.iv.next.2
  %31 = getelementptr inbounds nuw i8, ptr %30, i64 2
  %.val83.3 = load i16, ptr %31, align 1          ; 2 uses
  %.sroa.6.0.extract.shift.i91.3 = lshr i16 %.val83.3, 8 ; 2 uses
  %32 = and i16 %.val83.3, 255                    ; 2 uses
  %.sroa.6.0.insert.ext.i93.3 = select i1 %.not3.not.i86, i16 %32, i16 %.sroa.6.0.extract.shift.i91.3
  %.sroa.6.0.insert.shift.i94.3 = shl nuw i16 %.sroa.6.0.insert.ext.i93.3, 8
  %.sroa.0.0.insert.ext.i95.3 = select i1 %.not3.not.i86, i16 %.sroa.6.0.extract.shift.i91.3, i16 %32
  %.sroa.0.0.insert.insert.i96.3 = or disjoint i16 %.sroa.6.0.insert.shift.i94.3, %.sroa.0.0.insert.ext.i95.3
  %i.eq = zext i16 %.sroa.0.0.insert.insert.i96.3 to i64
  %i.er = sub i64 %29, %i.eq
