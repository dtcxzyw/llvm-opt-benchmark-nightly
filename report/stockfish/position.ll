...
bb.ab:                                            ; preds = %bb.z, %bb.aa
  ...
  store i8 %i.dp, ptr %i.c, align 1, !tbaa !29
  %i.dq = load ptr, ptr %2, align 8, !tbaa !30
  ...
  %i.dv = load i64, ptr %i.du, align 8, !tbaa !32
  %.not.i34 = icmp eq i64 %i.dv, 0
  br i1 %.not.i34, label %bb.ad, label %bb.ac

bb.ac:                                            ; preds = %bb.ab
  %i.dw = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %2, ptr noundef nonnull %i.c, i64 noundef 1) #26 ; 0 uses
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit36

bb.ad:                                            ; preds = %bb.ab
  %i.dx = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %2, i8 noundef signext %i.dp) #26 ; 0 uses
end_hunk_1
