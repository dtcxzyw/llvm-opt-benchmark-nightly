...
_ZN9Stockfish6Search6Worker7do_moveERNS_8PositionENS_4MoveERNS_9StateInfoEbPNS0_5StackE.exit: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %bb.bw, %bb.bv
  ...
  %16 = load i32, ptr %i.aaz, align 4, !tbaa !150
  %i.aba = load i32, ptr %i.se, align 8, !tbaa !258
  %i.abb = mul nsw i32 %16, %i.aay                ; 2 uses
  %17 = sub nsw i32 %4, %.0369.ph1010
  %18 = insertelement <2 x i32> poison, i32 %17, i64 0
  %19 = insertelement <2 x i32> %18, i32 %i.abb, i64 1
  %20 = mul nsw <2 x i32> %19, <i32 608, i32 119>
  %21 = insertelement <2 x i32> <i32 poison, i32 256>, i32 %i.aba, i64 0
  %22 = sdiv <2 x i32> %20, %21                   ; 2 uses
  %23 = extractelement <2 x i32> %22, i64 1
  %i.abc = select i1 %i.sc, i32 0, i32 %23
  %i.abd = add i32 %i.abb, 1182
  %24 = extractelement <2 x i32> %22, i64 0
  %i.abe = sub i32 %i.abd, %24
...
bb.a:
  ...
  %6 = insertelement <2 x i32> %5, i32 %i.h, i64 1
  %7 = mul nsw <2 x i32> %6, <i32 608, i32 119>
  %8 = insertelement <2 x i32> <i32 poison, i32 256>, i32 %i.j, i64 0
  %9 = sdiv <2 x i32> %7, %8                      ; 2 uses
  %10 = extractelement <2 x i32> %9, i64 1
  %i.k = select i1 %1, i32 0, i32 %10
  %i.l = add i32 %i.h, 1182
...
bb.dc:                                            ; preds = %bb.db
  ...
  %15 = load i32, ptr %i.xl, align 4, !tbaa !150
  %i.xm = load i32, ptr %i.vx, align 8, !tbaa !258
  %i.xn = mul nsw i32 %15, %i.xk                  ; 2 uses
  %16 = sub nsw i32 %.sroa.speculated819, %.11031.ph1247
  %17 = insertelement <2 x i32> poison, i32 %16, i64 0
  %18 = insertelement <2 x i32> %17, i32 %i.xn, i64 1
  %19 = mul nsw <2 x i32> %18, <i32 608, i32 119>
  %20 = insertelement <2 x i32> <i32 poison, i32 256>, i32 %i.xm, i64 0
  %21 = sdiv <2 x i32> %19, %20                   ; 2 uses
  %22 = extractelement <2 x i32> %21, i64 1
  %i.xo = select i1 %i.xh, i32 0, i32 %22
  %i.xp = add i32 %i.xn, 1182
  %23 = extractelement <2 x i32> %21, i64 0
  %i.xq = sub i32 %i.xp, %23
...
bb.ck:                                            ; preds = %bb.cj
  ...
  %15 = load i32, ptr %i.va, align 4, !tbaa !150
  %i.vb = load i32, ptr %i.tk, align 8, !tbaa !258
  %i.vc = mul nsw i32 %15, %i.uz                  ; 2 uses
  %16 = sub nsw i32 %.sroa.speculated720, %.5980.ph1215
  %17 = insertelement <2 x i32> poison, i32 %16, i64 0
  %18 = insertelement <2 x i32> %17, i32 %i.vc, i64 1
  %19 = mul nsw <2 x i32> %18, <i32 608, i32 119>
  %20 = insertelement <2 x i32> <i32 poison, i32 256>, i32 %i.vb, i64 0
  %21 = sdiv <2 x i32> %19, %20                   ; 2 uses
  %22 = extractelement <2 x i32> %21, i64 1
  %i.vd = select i1 %i.uw, i32 0, i32 %22
  %i.ve = add i32 %i.vc, 1182
  %23 = extractelement <2 x i32> %21, i64 0
  %i.vf = sub i32 %i.ve, %23
