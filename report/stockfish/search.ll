...
_ZN9Stockfish6Search6Worker7do_moveERNS_8PositionENS_4MoveERNS_9StateInfoEbPNS0_5StackE.exit: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %bb.bw, %bb.bv
  ...
  %17 = mul nsw i32 %i.aba, %i.aay                ; 2 uses
  %i.abc = insertelement <2 x i32> poison, i32 %16, i64 0
  %i.abd = insertelement <2 x i32> %i.abc, i32 %17, i64 1
...
bb.dc:                                            ; preds = %bb.db
  ...
  %16 = mul nsw i32 %i.xm, %i.xk                  ; 2 uses
  %i.xo = insertelement <2 x i32> poison, i32 %15, i64 0
  %i.xp = insertelement <2 x i32> %i.xo, i32 %16, i64 1
...
bb.ck:                                            ; preds = %bb.cj
  ...
  %16 = mul nsw i32 %i.vb, %i.uz                  ; 2 uses
  %i.vd = insertelement <2 x i32> poison, i32 %15, i64 0
  %i.ve = insertelement <2 x i32> %i.vd, i32 %16, i64 1
