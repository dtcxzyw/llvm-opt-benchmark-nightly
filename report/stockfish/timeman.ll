...
bb.g:                                             ; preds = %bb.d
  ...
  %9 = extractelement <2 x double> %i.cq, i64 0
  ...
  %i.cs = fadd double %9, 8.800000e-01
  %12 = fmul nnan double %10, 8.800000e-01
  %13 = insertelement <2 x double> poison, double %12, i64 0
  %14 = insertelement <2 x double> %13, double %i.cs, i64 1
  %15 = insertelement <2 x double> %i.cq, double %11, i64 0
  %16 = fdiv <2 x double> %14, %15                ; 2 uses
  %17 = extractelement <2 x double> %16, i64 0    ; 2 uses
  %18 = extractelement <2 x double> %16, i64 1    ; 2 uses
  %i.ct = fcmp olt double %17, %18
  %.sroa.speculated84 = select i1 %i.ct, double %17, double %18
  %i.cu = call nnan double @llvm.fmuladd.f64(double %i.cr, double 1.100000e-01, double 1.300000e+00)
  br label %._crit_edge.i.i78
