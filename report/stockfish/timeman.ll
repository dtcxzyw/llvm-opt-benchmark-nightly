...
bb.g:                                             ; preds = %bb.d
  ...
  %i.da = fcmp olt double %i.cy, %i.cz
  %.sroa.speculated84 = select i1 %i.da, double %i.cy, double %i.cz
  %i.db = call nnan double @llvm.fmuladd.f64(double %i.cs, double 1.100000e-01, double 1.300000e+00)
  br label %._crit_edge.i.i78
...
._crit_edge.i.i78:                                ; preds = %bb.g, %._crit_edge
  ...
  %i.dd = fptosi double %i.dc to i64              ; 2 uses
  %i.de = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 3 uses
  store i64 %i.dd, ptr %i.de, align 8, !tbaa !27
  %i.df = load i64, ptr %i.r, align 8, !tbaa !11
  %i.dg = sitofp i64 %i.df to double
  %i.dh = sitofp i64 %.0 to double
  %i.di = fneg double %i.dh
  %i.dj = call double @llvm.fmuladd.f64(double %i.dg, double 8.251790e-01, double %i.di) ; 2 uses
  %i.dk = sitofp i64 %i.dd to double
  %i.dl = fmul double %.062, %i.dk                ; 2 uses
  %i.dm = fcmp olt double %i.dl, %i.dj
  %.sroa.speculated = select i1 %i.dm, double %i.dl, double %i.dj
  %i.dn = fptosi double %.sroa.speculated to i64
  %i.do = add nsw i64 %i.dn, -10
  %i.dp = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i64 %i.do, ptr %i.dp, align 8, !tbaa !30
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #17
  %i.dq = getelementptr inbounds nuw i8, ptr %8, i64 16 ; 4 uses
  store ptr %i.dq, ptr %8, align 8, !tbaa !32
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(6) %i.dq, ptr noundef nonnull align 1 dereferenceable(6) @.str.3, i64 6, i1 false)
  %i.dr = getelementptr inbounds nuw i8, ptr %8, i64 8
  store i64 6, ptr %i.dr, align 8, !tbaa !35
  %i.ds = getelementptr inbounds nuw i8, ptr %8, i64 22
  store i8 0, ptr %i.ds, align 2, !tbaa !37
  %i.dt = call noundef nonnull align 8 dereferenceable(152) ptr @_ZNK9Stockfish10OptionsMapixERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(ptr noundef nonnull align 8 dereferenceable(80) %4, ptr noundef nonnull align 8 dereferenceable(32) %8) #17
  %i.du = call noundef i32 @_ZNK9Stockfish6OptioncviEv(ptr noundef nonnull align 8 dereferenceable(152) %i.dt) #17
  %.not65 = icmp eq i32 %i.du, 0
  %i.dv = load ptr, ptr %8, align 8, !tbaa !38    ; 2 uses
  %i.dw = icmp eq ptr %i.dv, %i.dq
  br i1 %i.dw, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit82, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i80

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i80: ; preds = %._crit_edge.i.i78
  %i.dx = load i64, ptr %i.dq, align 8, !tbaa !37
  %i.dy = add i64 %i.dx, 1
...
bb.h:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit82
  %i.dz = load i64, ptr %i.de, align 8, !tbaa !27 ; 2 uses
  %i.ea = sdiv i64 %i.dz, 4
  %i.eb = add nsw i64 %i.ea, %i.dz
  store i64 %i.eb, ptr %i.de, align 8, !tbaa !27
  br label %bb.i
