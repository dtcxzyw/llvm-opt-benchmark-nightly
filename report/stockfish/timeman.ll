...
begin_hunk_0_@_ZNK9Stockfish14TimeManagement7optimumEv:bb.a

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local noundef i64 @_ZNK9Stockfish14TimeManagement7maximumEv(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(33) %0) local_unnamed_addr #5 align 2 {
bb.a:
...
define dso_local void @_ZN9Stockfish14TimeManagement5clearEv(ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(33) initializes((24, 32)) %0) local_unnamed_addr #6 align 2 {
bb.a:
...
bb.a:
  ...
  store i64 %.sroa.speculated, ptr %i.a, align 8, !tbaa !24
  ret void
}
...
._crit_edge.i.i:
  ...
  store i64 9, ptr %i.b, align 8, !tbaa !36
...
._crit_edge.i.i66:                                ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  ...
  store ptr %i.u, ptr %7, align 8, !tbaa !34
  ...
  store i64 13, ptr %i.v, align 8, !tbaa !36
...
bb.a:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit70
  ...
  %i.ah = load i64, ptr %i.ag, align 8, !tbaa !24 ; 2 uses
  %i.ai = icmp eq i64 %i.ah, -1
  br i1 %i.ai, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %i.aj = load i64, ptr %i.r, align 8, !tbaa !12
  %i.ak = mul nsw i64 %i.aj, %i.f                 ; 2 uses
  store i64 %i.ak, ptr %i.ag, align 8, !tbaa !24
  br label %bb.c

bb.c:                                             ; preds = %bb.b, %bb.a
  %i.al = phi i64 [ %i.ak, %bb.b ], [ %i.ah, %bb.a ]
  store i64 %i.al, ptr %i.r, align 8, !tbaa !12
  ...
  store i64 %i.ap, ptr %i.an, align 8, !tbaa !12
...
bb.d:                                             ; preds = %bb.c, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit70
  ...
  %i.at = load i64, ptr %i.r, align 8, !tbaa !12  ; 4 uses
  ...
  %.061 = select i1 %i.az, i32 %i.bc, i32 %i.ay   ; 3 uses
  ...
  %i.bg = add nsw i32 %.061, -100
  %i.bh = sext i32 %i.bg to i64
  %i.bi = mul nsw i64 %i.bf, %i.bh
  %i.bj = add nsw i32 %.061, 200
...
bb.e:                                             ; preds = %bb.d
  %i.bp = load double, ptr %5, align 8, !tbaa !53 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  store double %i.bt, ptr %5, align 8, !tbaa !53
  br label %._crit_edge
...
bb.g:                                             ; preds = %bb.d
  ...
  %i.co = insertelement <2 x i32> %i.cn, i32 %.061, i64 1
  ...
  %10 = sitofp i64 %i.at to double
  %i.ct = fmul nnan double %10, 8.800000e-01
  %i.cu = uitofp nneg i64 %.sroa.speculated109 to double ; 2 uses
  %i.cv = insertelement <2 x double> poison, double %i.ct, i64 0
  %i.cw = insertelement <2 x double> %i.cv, double %9, i64 1
  %i.cx = insertelement <2 x double> %i.cq, double %i.cu, i64 0
  %i.cy = fdiv <2 x double> %i.cw, %i.cx          ; 2 uses
  ...
  %.sroa.speculated84 = select i1 %i.db, double %i.cz, double %i.da
  %i.dc = call nnan double @llvm.fmuladd.f64(double %i.cs, double 1.100000e-01, double 1.300000e+00)
  br label %._crit_edge.i.i78

._crit_edge.i.i78:                                ; preds = %bb.g, %._crit_edge
  %.pre-phi = phi double [ %i.cu, %bb.g ], [ %i.br, %._crit_edge ]
  %.063 = phi double [ %.sroa.speculated84, %bb.g ], [ %i.cj, %._crit_edge ]
  %.062 = phi double [ %i.dc, %bb.g ], [ %.sroa.speculated89, %._crit_edge ]
  %i.dd = fmul double %.063, %.pre-phi
  %i.de = fptosi double %i.dd to i64              ; 2 uses
  %i.df = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 3 uses
  store i64 %i.de, ptr %i.df, align 8, !tbaa !22
  %i.dg = load i64, ptr %i.r, align 8, !tbaa !12
  %i.dh = sitofp i64 %i.dg to double
  %i.di = sitofp i64 %.0 to double
  %i.dj = fneg double %i.di
  %i.dk = call double @llvm.fmuladd.f64(double %i.dh, double 8.251790e-01, double %i.dj) ; 2 uses
  %i.dl = sitofp i64 %i.de to double
  %i.dm = fmul double %.062, %i.dl                ; 2 uses
  %i.dn = fcmp olt double %i.dm, %i.dk
  %.sroa.speculated = select i1 %i.dn, double %i.dm, double %i.dk
  %i.do = fptosi double %.sroa.speculated to i64
  %i.dp = add nsw i64 %i.do, -10
  %i.dq = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i64 %i.dp, ptr %i.dq, align 8, !tbaa !23
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #17
  %i.dr = getelementptr inbounds nuw i8, ptr %8, i64 16 ; 4 uses
  store ptr %i.dr, ptr %8, align 8, !tbaa !34
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(6) %i.dr, ptr noundef nonnull align 1 dereferenceable(6) @.str.3, i64 6, i1 false)
  %i.ds = getelementptr inbounds nuw i8, ptr %8, i64 8
  store i64 6, ptr %i.ds, align 8, !tbaa !36
  %i.dt = getelementptr inbounds nuw i8, ptr %8, i64 22
  store i8 0, ptr %i.dt, align 2, !tbaa !37
  %i.du = call noundef nonnull align 8 dereferenceable(152) ptr @_ZNK9Stockfish10OptionsMapixERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(ptr noundef nonnull align 8 dereferenceable(80) %4, ptr noundef nonnull align 8 dereferenceable(32) %8) #17
  %i.dv = call noundef i32 @_ZNK9Stockfish6OptioncviEv(ptr noundef nonnull align 8 dereferenceable(152) %i.du) #17
  %.not65 = icmp eq i32 %i.dv, 0
  %i.dw = load ptr, ptr %8, align 8, !tbaa !38    ; 2 uses
  %i.dx = icmp eq ptr %i.dw, %i.dr
  br i1 %i.dx, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit82, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i80

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i80: ; preds = %._crit_edge.i.i78
  %i.dy = load i64, ptr %i.dr, align 8, !tbaa !37
  %i.dz = add i64 %i.dy, 1
...
bb.h:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit82
  %i.ea = load i64, ptr %i.df, align 8, !tbaa !22 ; 2 uses
  %i.eb = sdiv i64 %i.ea, 4
  %i.ec = add nsw i64 %i.eb, %i.ea
  store i64 %i.ec, ptr %i.df, align 8, !tbaa !22
  br label %bb.i
