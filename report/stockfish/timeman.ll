...
bb.d:                                             ; preds = %bb.c, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit70
  ...
  %.063 = select i1 %i.az, i32 %i.bc, i32 %i.ay   ; 3 uses
  ...
  %i.bg = add nsw i32 %.063, -100
  %i.bh = sext i32 %i.bg to i64
  %i.bi = mul nsw i64 %i.bf, %i.bh
  %i.bj = add nsw i32 %.063, 200
...
bb.g:                                             ; preds = %bb.d
  ...
  %i.co = insertelement <2 x i32> %i.cn, i32 %.063, i64 1
  %i.cp = sitofp <2 x i32> %i.co to <2 x double>
  %i.cq = fdiv <2 x double> %i.cp, <double 1.164000e+02, double 1.000000e+02> ; 2 uses
  %i.cr = extractelement <2 x double> %i.cq, i64 0
  %i.cs = fadd double %i.cr, 8.800000e-01
  %9 = extractelement <2 x double> %i.cq, i64 1   ; 2 uses
  %10 = fdiv double %i.cs, %9                     ; 2 uses
  %11 = sitofp i64 %i.at to double
  %12 = fmul nnan double %11, 8.800000e-01
  %13 = uitofp nneg i64 %.sroa.speculated109 to double ; 2 uses
  %14 = fdiv double %12, %13                      ; 2 uses
  %i.ct = fcmp olt double %14, %10
  %.sroa.speculated84 = select i1 %i.ct, double %14, double %10
  %i.cu = call nnan double @llvm.fmuladd.f64(double %9, double 1.100000e-01, double 1.300000e+00)
  br label %._crit_edge.i.i78

._crit_edge.i.i78:                                ; preds = %bb.g, %._crit_edge
  %.pre-phi = phi double [ %13, %bb.g ], [ %i.br, %._crit_edge ]
  %.062 = phi double [ %i.cu, %bb.g ], [ %.sroa.speculated89, %._crit_edge ]
  %.061 = phi double [ %.sroa.speculated84, %bb.g ], [ %i.cj, %._crit_edge ]
  %i.cv = fmul double %.061, %.pre-phi
  %i.cw = fptosi double %i.cv to i64              ; 2 uses
  %i.cx = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 3 uses
  store i64 %i.cw, ptr %i.cx, align 8, !tbaa !27
  %i.cy = load i64, ptr %i.r, align 8, !tbaa !11
  %i.cz = sitofp i64 %i.cy to double
  %i.da = sitofp i64 %.0 to double
  %i.db = fneg double %i.da
  %i.dc = call double @llvm.fmuladd.f64(double %i.cz, double 8.251790e-01, double %i.db) ; 2 uses
  %i.dd = sitofp i64 %i.cw to double
  %i.de = fmul double %.062, %i.dd                ; 2 uses
  %i.df = fcmp olt double %i.de, %i.dc
  %.sroa.speculated = select i1 %i.df, double %i.de, double %i.dc
  %i.dg = fptosi double %.sroa.speculated to i64
  %i.dh = add nsw i64 %i.dg, -10
  %i.di = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i64 %i.dh, ptr %i.di, align 8, !tbaa !30
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #17
  %i.dj = getelementptr inbounds nuw i8, ptr %8, i64 16 ; 4 uses
  store ptr %i.dj, ptr %8, align 8, !tbaa !32
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(6) %i.dj, ptr noundef nonnull align 1 dereferenceable(6) @.str.3, i64 6, i1 false)
  %i.dk = getelementptr inbounds nuw i8, ptr %8, i64 8
  store i64 6, ptr %i.dk, align 8, !tbaa !35
  %i.dl = getelementptr inbounds nuw i8, ptr %8, i64 22
  store i8 0, ptr %i.dl, align 2, !tbaa !37
  %i.dm = call noundef nonnull align 8 dereferenceable(152) ptr @_ZNK9Stockfish10OptionsMapixERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(ptr noundef nonnull align 8 dereferenceable(80) %4, ptr noundef nonnull align 8 dereferenceable(32) %8) #17
  %i.dn = call noundef i32 @_ZNK9Stockfish6OptioncviEv(ptr noundef nonnull align 8 dereferenceable(152) %i.dm) #17
  %.not65 = icmp eq i32 %i.dn, 0
  %i.do = load ptr, ptr %8, align 8, !tbaa !38    ; 2 uses
  %i.dp = icmp eq ptr %i.do, %i.dj
  br i1 %i.dp, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit82, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i80

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i80: ; preds = %._crit_edge.i.i78
  %i.dq = load i64, ptr %i.dj, align 8, !tbaa !37
  %i.dr = add i64 %i.dq, 1
...
bb.h:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit82
  %i.ds = load i64, ptr %i.cx, align 8, !tbaa !27 ; 2 uses
  %i.dt = sdiv i64 %i.ds, 4
  %i.du = add nsw i64 %i.dt, %i.ds
  store i64 %i.du, ptr %i.cx, align 8, !tbaa !27
  br label %bb.i
