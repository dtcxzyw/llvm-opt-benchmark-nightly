...
bb.c:                                             ; preds = %bb.b
  ...
  store i64 %.sroa.speculated, ptr @_ZN9Stockfish17SYSTEM_THREADS_NBE, align 8, !tbaa !45
...
.preheader:                                       ; preds = %bb.c, %_ZNSt3setImSt4lessImESaImEE6insertERKm.exit
  ...
  %1 = lshr i64 %i.l, %i.i
  %2 = trunc i64 %1 to i1
  br i1 %2, label %bb.f, label %_ZNSt3setImSt4lessImESaImEE6insertERKm.exit

bb.f:                                             ; preds = %.preheader
  %.02022.i.i.i = load ptr, ptr %i.b, align 8, !tbaa !56 ; 2 uses
...
.lr.ph.i.i.i:                                     ; preds = %bb.f, %.lr.ph.i.i.i
  ...
  %i.n = load i64, ptr %i.m, align 8, !tbaa !45   ; 2 uses
...
._crit_edge.thread.i.i.i:                         ; preds = %._crit_edge.i.i.i, %bb.f
  ...
  %i.p = load ptr, ptr %i.c, align 8, !tbaa !53
...
_ZNSt8_Rb_treeImmSt9_IdentityImESt4lessImESaImEE10_M_insert_IRKmNS5_11_Alloc_nodeEEESt17_Rb_tree_iteratorImEPSt18_Rb_tree_node_baseSD_OT_RT0_.exit.i.i: ; preds = %bb.i, %select.unfold.i.i
  ...
  store i64 %storemerge19, ptr %i.aa, align 8, !tbaa !45
  ...
  %i.ab = load i64, ptr %i.e, align 8, !tbaa !55
  %i.ac = add i64 %i.ab, 1
  store i64 %i.ac, ptr %i.e, align 8, !tbaa !55
...
_ZNSt3setImSt4lessImESaImEE6insertERKm.exit:      ; preds = %_ZNSt8_Rb_treeImmSt9_IdentityImESt4lessImESaImEE10_M_insert_IRKmNS5_11_Alloc_nodeEEESt17_Rb_tree_iteratorImEPSt18_Rb_tree_node_baseSD_OT_RT0_.exit.i.i, %bb.h, %.preheader
  ...
  br i1 %exitcond.not, label %bb.e, label %.preheader, !llvm.loop !279
}
...
bb.c:                                             ; preds = %bb.b
  ...
  store ptr %i.o, ptr %2, align 8, !tbaa !67
  %i.p = load i64, ptr %i.f, align 8, !tbaa !45
  store i64 %i.p, ptr %i.j, align 8, !tbaa !69
...
bb.d:                                             ; preds = %._crit_edge.i.i
  %i.r = load i8, ptr %i.k, align 1, !tbaa !69
  store i8 %i.r, ptr %i.q, align 1, !tbaa !69
  br label %.critedge6
