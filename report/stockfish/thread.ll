...
.lr.ph.i.i19:                                     ; preds = %.lr.ph.i.i19.preheader, %.lr.ph.i.i19
  %.01633.i.i = phi i64 [ %spec.select28.i.i, %.lr.ph.i.i19 ], [ %.01633.i.i.ph, %.lr.ph.i.i19.preheader ]
  %.sroa.025.032.i.i = phi ptr [ %i.ed, %.lr.ph.i.i19 ], [ %.sroa.025.032.i.i.ph, %.lr.ph.i.i19.preheader ] ; 2 uses
  %i.eb = getelementptr inbounds nuw i8, ptr %.sroa.025.032.i.i, i64 40
  %i.ec = load i64, ptr %i.eb, align 8, !tbaa !37
  %spec.select28.i.i = call i64 @llvm.umax.i64(i64 %i.ec, i64 %.01633.i.i) ; 3 uses
  %i.ed = getelementptr inbounds nuw i8, ptr %.sroa.025.032.i.i, i64 48 ; 2 uses
  %.not29.i.i = icmp eq ptr %i.ed, %i.bs
  br i1 %.not29.i.i, label %iter.check167, label %.lr.ph.i.i19, !llvm.loop !153

._crit_edge.i.i20:                                ; preds = %vec.epilog.scalar.ph168
  %i.ee = shl i64 %spec.select.i.i, 2
  %i.ef = icmp ugt i64 %i.ee, %i.an
  %i.eg = lshr i64 %spec.select28.i.i, 1
  %i.eh = icmp uge i64 %i.eg, %i.an
  %or.cond.i.i = select i1 %i.eh, i1 %i.ef, i1 false
  br i1 %or.cond.i.i, label %"_ZZN9Stockfish10ThreadPool3setERKNS_10NumaConfigENS_6Search11SharedStateERKNS4_13SearchManager13UpdateContextEENK3$_0clEv.exit", label %._crit_edge.thread.i.i

vec.epilog.scalar.ph168:                          ; preds = %vec.epilog.scalar.ph168.preheader, %vec.epilog.scalar.ph168
  %.01736.i.i = phi i64 [ %spec.select.i.i, %vec.epilog.scalar.ph168 ], [ %.01736.i.i.ph, %vec.epilog.scalar.ph168.preheader ]
  %.sroa.020.035.i.i = phi ptr [ %i.eo, %vec.epilog.scalar.ph168 ], [ %.sroa.020.035.i.i.ph, %vec.epilog.scalar.ph168.preheader ] ; 2 uses
  %i.ei = getelementptr inbounds nuw i8, ptr %.sroa.020.035.i.i, i64 40
  %i.ej = load i64, ptr %i.ei, align 8, !tbaa !37
  %i.ek = uitofp i64 %i.ej to double
  %i.el = fdiv double %i.ek, %i.co
  %i.em = fcmp ugt double %i.el, 6.000000e-01
  %i.en = zext i1 %i.em to i64
  %spec.select.i.i = add i64 %.01736.i.i, %i.en   ; 2 uses
  %i.eo = getelementptr inbounds nuw i8, ptr %.sroa.020.035.i.i, i64 48 ; 2 uses
  %.not30.i.i = icmp eq ptr %i.eo, %i.bs
  br i1 %.not30.i.i, label %._crit_edge.i.i20, label %vec.epilog.scalar.ph168, !llvm.loop !154

._crit_edge.thread.i.i:                           ; preds = %._crit_edge.i.i20, %bb.f
  %i.ep = ptrtoint ptr %i.bs to i64
  %i.eq = ptrtoint ptr %i.bq to i64
  %i.er = sub i64 %i.ep, %i.eq
  %i.es = sdiv exact i64 %i.er, 48
  %i.et = icmp ugt i64 %i.es, 1
  br label %"_ZZN9Stockfish10ThreadPool3setERKNS_10NumaConfigENS_6Search11SharedStateERKNS4_13SearchManager13UpdateContextEENK3$_0clEv.exit"

"_ZZN9Stockfish10ThreadPool3setERKNS_10NumaConfigENS_6Search11SharedStateERKNS4_13SearchManager13UpdateContextEENK3$_0clEv.exit": ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit18, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.i, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit3.i, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit3.thread.i, %bb.e, %._crit_edge.i.i20, %._crit_edge.thread.i.i
  %.0.i = phi i1 [ false, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.i ], [ true, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit18 ], [ true, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit3.i ], [ %i.et, %._crit_edge.thread.i.i ], [ false, %bb.e ], [ true, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit3.thread.i ], [ false, %._crit_edge.i.i20 ] ; 4 uses
  %i.eu = zext i1 %.0.i to i8
  store i8 %i.eu, ptr %i.b, align 1, !tbaa !155
  call void @llvm.lifetime.start.p0(ptr nonnull %16) #26
  %i.ev = getelementptr inbounds nuw i8, ptr %16, i64 8 ; 7 uses
  store i32 0, ptr %i.ev, align 8, !tbaa !28
  %i.ew = getelementptr inbounds nuw i8, ptr %16, i64 16 ; 5 uses
  store ptr null, ptr %i.ew, align 8, !tbaa !34
  %i.ex = getelementptr inbounds nuw i8, ptr %16, i64 24 ; 3 uses
  store ptr %i.ev, ptr %i.ex, align 8, !tbaa !35
  %i.ey = getelementptr inbounds nuw i8, ptr %16, i64 32 ; 2 uses
  store ptr %i.ev, ptr %i.ey, align 8, !tbaa !36
  %i.ez = getelementptr inbounds nuw i8, ptr %16, i64 40 ; 3 uses
  store i64 0, ptr %i.ez, align 8, !tbaa !37
  call void @llvm.lifetime.start.p0(ptr nonnull %17) #26
  br i1 %.0.i, label %bb.g, label %bb.h

bb.g:                                             ; preds = %"_ZZN9Stockfish10ThreadPool3setERKNS_10NumaConfigENS_6Search11SharedStateERKNS4_13SearchManager13UpdateContextEENK3$_0clEv.exit"
  call void @_ZNK9Stockfish10NumaConfig35distribute_threads_among_numa_nodesEm(ptr dead_on_unwind nonnull writable sret(%"class.std::vector.119") align 8 %17, ptr noundef nonnull align 8 dereferenceable(81) %1, i64 noundef %i.an)
  %i.fa = load <2 x ptr>, ptr %17, align 16, !tbaa !156
  %.phi.trans.insert65 = getelementptr inbounds nuw i8, ptr %17, i64 16
  %.pre66 = load ptr, ptr %.phi.trans.insert65, align 16, !tbaa !157
  br label %bb.h

bb.h:                                             ; preds = %"_ZZN9Stockfish10ThreadPool3setERKNS_10NumaConfigENS_6Search11SharedStateERKNS4_13SearchManager13UpdateContextEENK3$_0clEv.exit", %bb.g
  %i.fb = phi ptr [ %.pre66, %bb.g ], [ null, %"_ZZN9Stockfish10ThreadPool3setERKNS_10NumaConfigENS_6Search11SharedStateERKNS4_13SearchManager13UpdateContextEENK3$_0clEv.exit" ]
  %i.fc = phi <2 x ptr> [ %i.fa, %bb.g ], [ splat (ptr null), %"_ZZN9Stockfish10ThreadPool3setERKNS_10NumaConfigENS_6Search11SharedStateERKNS4_13SearchManager13UpdateContextEENK3$_0clEv.exit" ]
  %i.fd = getelementptr inbounds nuw i8, ptr %0, i64 40 ; 5 uses
  %i.fe = load ptr, ptr %i.fd, align 8, !tbaa !129 ; 3 uses
  %i.ff = getelementptr inbounds nuw i8, ptr %0, i64 48 ; 2 uses
  %i.fg = getelementptr inbounds nuw i8, ptr %0, i64 56 ; 2 uses
  %i.fh = load ptr, ptr %i.fg, align 8, !tbaa !157
  store <2 x ptr> %i.fc, ptr %i.fd, align 8, !tbaa !156
  %i.fi = getelementptr inbounds nuw i8, ptr %17, i64 16
  store ptr %i.fb, ptr %i.fg, align 8, !tbaa !157
  %.not.i.i.i.i.i = icmp eq ptr %i.fe, null
...
_ZNSt6vectorImSaImEEaSEOS1_.exit:                 ; preds = %bb.h
  %i.fj = ptrtoint ptr %i.fh to i64
  %i.fk = ptrtoint ptr %i.fe to i64
  %i.fl = sub i64 %i.fj, %i.fk
  call void @_ZdlPvm(ptr noundef nonnull %i.fe, i64 noundef %i.fl) #30
  %.pr = load ptr, ptr %17, align 16, !tbaa !129  ; 3 uses
  %.not.i.i.i21 = icmp eq ptr %.pr, null
  br i1 %.not.i.i.i21, label %_ZNSt6vectorImSaImEED2Ev.exit, label %bb.i

bb.i:                                             ; preds = %_ZNSt6vectorImSaImEEaSEOS1_.exit
  %i.fm = load ptr, ptr %i.fi, align 16, !tbaa !157
  %i.fn = ptrtoint ptr %i.fm to i64
  %i.fo = ptrtoint ptr %.pr to i64
  %i.fp = sub i64 %i.fn, %i.fo
  call void @_ZdlPvm(ptr noundef nonnull %.pr, i64 noundef %i.fp) #30
  br label %_ZNSt6vectorImSaImEED2Ev.exit

_ZNSt6vectorImSaImEED2Ev.exit:                    ; preds = %bb.h, %_ZNSt6vectorImSaImEEaSEOS1_.exit, %bb.i
  call void @llvm.lifetime.end.p0(ptr nonnull %17) #26
  %i.fq = load ptr, ptr %i.fd, align 8, !tbaa !156 ; 2 uses
  %i.fr = load ptr, ptr %i.ff, align 8, !tbaa !156
  %i.fs = icmp eq ptr %i.fq, %i.fr
  br i1 %i.fs, label %bb.j, label %.lr.ph

bb.j:                                             ; preds = %_ZNSt6vectorImSaImEED2Ev.exit
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #26
  store i64 0, ptr %i.c, align 8, !tbaa !26
  %i.ft = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSt3mapImmSt4lessImESaISt4pairIKmmEEEixEOm(ptr noundef nonnull align 8 dereferenceable(48) %16, ptr noundef nonnull align 8 dereferenceable(8) %i.c)
  store i64 %i.an, ptr %i.ft, align 8, !tbaa !26
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #26
  br label %.loopexit

.lr.ph:                                           ; preds = %_ZNSt6vectorImSaImEED2Ev.exit, %.lr.ph
  %i.fu = phi ptr [ %i.gb, %.lr.ph ], [ %i.fq, %_ZNSt6vectorImSaImEED2Ev.exit ]
  %.056 = phi i64 [ %i.fz, %.lr.ph ], [ 0, %_ZNSt6vectorImSaImEED2Ev.exit ] ; 2 uses
  %i.fv = getelementptr inbounds nuw [8 x i8], ptr %i.fu, i64 %.056
  %i.fw = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSt3mapImmSt4lessImESaISt4pairIKmmEEEixERS3_(ptr noundef nonnull align 8 dereferenceable(48) %16, ptr noundef nonnull align 8 dereferenceable(8) %i.fv) ; 2 uses
  %i.fx = load i64, ptr %i.fw, align 8, !tbaa !26
  %i.fy = add i64 %i.fx, 1
  store i64 %i.fy, ptr %i.fw, align 8, !tbaa !26
  %i.fz = add nuw i64 %.056, 1                    ; 2 uses
  %i.ga = load ptr, ptr %i.ff, align 8, !tbaa !132
  %i.gb = load ptr, ptr %i.fd, align 8, !tbaa !129 ; 2 uses
  ...
  br i1 %i.gg, label %.lr.ph, label %.loopexit, !llvm.loop !158

.loopexit:                                        ; preds = %.lr.ph, %bb.j
  %i.gh = getelementptr inbounds nuw i8, ptr %2, i64 24 ; 2 uses
  %i.gi = load ptr, ptr %i.gh, align 8, !tbaa !159, !nonnull !71, !align !72 ; 6 uses
  %i.gj = getelementptr inbounds nuw i8, ptr %i.gi, i64 16 ; 2 uses
  %i.gk = load ptr, ptr %i.gj, align 8, !tbaa !34
  call void @_ZNSt8_Rb_treeImSt4pairIKmN9Stockfish15SharedHistoriesEESt10_Select1stIS4_ESt4lessImESaIS4_EE8_M_eraseEPSt13_Rb_tree_nodeIS4_E(ptr noundef nonnull align 8 dereferenceable(48) %i.gi, ptr noundef %i.gk)
  %i.gl = getelementptr inbounds nuw i8, ptr %i.gi, i64 8 ; 2 uses
  store ptr null, ptr %i.gj, align 8, !tbaa !34
  %i.gm = getelementptr inbounds nuw i8, ptr %i.gi, i64 24
  store ptr %i.gl, ptr %i.gm, align 8, !tbaa !35
  %i.gn = getelementptr inbounds nuw i8, ptr %i.gi, i64 32
  store ptr %i.gl, ptr %i.gn, align 8, !tbaa !36
  %i.go = getelementptr inbounds nuw i8, ptr %i.gi, i64 40
  store i64 0, ptr %i.go, align 8, !tbaa !37
  %i.gp = load ptr, ptr %i.ex, align 8, !tbaa !35 ; 2 uses
  %.not5557 = icmp eq ptr %i.gp, %i.ev
  br i1 %.not5557, label %._crit_edge, label %.lr.ph59
...
._crit_edge:                                      ; preds = %bb.s, %.loopexit
  ...
  %i.gs = getelementptr inbounds nuw i8, ptr %19, i64 8 ; 4 uses
  store i32 0, ptr %i.gs, align 8, !tbaa !28
  %i.gt = getelementptr inbounds nuw i8, ptr %19, i64 16 ; 3 uses
  store ptr null, ptr %i.gt, align 8, !tbaa !34
  %i.gu = getelementptr inbounds nuw i8, ptr %19, i64 24 ; 2 uses
  store ptr %i.gs, ptr %i.gu, align 8, !tbaa !35
  %i.gv = getelementptr inbounds nuw i8, ptr %19, i64 32 ; 2 uses
  store ptr %i.gs, ptr %i.gv, align 8, !tbaa !36
  %i.gw = getelementptr inbounds nuw i8, ptr %19, i64 40 ; 2 uses
  store i64 0, ptr %i.gw, align 8, !tbaa !37
  %i.gx = load ptr, ptr %i.ew, align 8, !tbaa !34 ; 2 uses
  %.not.i.i22 = icmp eq ptr %i.gx, null
end_hunk_0
