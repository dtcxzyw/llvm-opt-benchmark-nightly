...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  %i.ec = getelementptr inbounds nuw [48 x i8], ptr %i.u, i64 %i.dx
  ...
  %i.ei = or disjoint i64 %.027, 7                ; 3 uses
  %i.ej = getelementptr inbounds nuw [8 x i8], ptr %.sroa.020.050, i64 %i.ei
  %i.ek = load i64, ptr %i.ej, align 8, !tbaa !26
  %i.el = add i64 %i.ek, 1
  %i.em = uitofp i64 %i.el to float
  %i.en = getelementptr inbounds nuw [48 x i8], ptr %i.u, i64 %i.ei
...
vector.memcheck:                                  ; preds = %iter.check
  ...
  %i.bo = and i64 %i.bn, -8
  %3 = add i64 %i.bo, 8                           ; 2 uses
  %scevgep.a = getelementptr i8, ptr %i.bf, i64 %3
  %scevgep30 = getelementptr i8, ptr %i.au, i64 %3
  %bound0 = icmp ult ptr %i.bf, %scevgep30
  %bound1 = icmp ult ptr %i.au, %scevgep.a
