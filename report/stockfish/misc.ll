...
bb.m:                                             ; preds = %.preheader90
  ...
  %i.bq = sitofp i64 %i.bn to double
  %0 = getelementptr inbounds nuw i8, ptr %i.bm, i64 8
  %1 = load atomic i64, ptr %0 seq_cst, align 8
  %2 = insertelement <2 x i64> poison, i64 %i.bp, i64 0
  %3 = insertelement <2 x i64> %2, i64 %1, i64 1
  %4 = sitofp <2 x i64> %3 to <2 x double>
  %5 = insertelement <2 x double> poison, double %i.bq, i64 0
  %6 = shufflevector <2 x double> %5, <2 x double> poison, <2 x i32> zeroinitializer
  %7 = fdiv <2 x double> %4, %6                   ; 3 uses
  %foldExtExtBinop = fmul <2 x double> %7, %7
  %shift = shufflevector <2 x double> %foldExtExtBinop, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop124 = fsub <2 x double> %7, %shift
  %8 = extractelement <2 x double> %foldExtExtBinop124, i64 0
  %i.br = tail call double @sqrt(double noundef %8) #23
...
bb.x:                                             ; preds = %.preheader
  ...
  %i.dy = sitofp i64 %i.dv to double              ; 2 uses
  ...
  %9 = insertelement <2 x i64> poison, i64 %i.dx, i64 0
  %10 = insertelement <2 x i64> %9, i64 %i.ed, i64 1
  %11 = sitofp <2 x i64> %10 to <2 x double>
  %12 = insertelement <2 x double> poison, double %i.dy, i64 0
  ...
  %i.eg = tail call double @llvm.fmuladd.f64(double %i.ef, double %16, double %15)
  %i.eh = getelementptr inbounds nuw i8, ptr %i.du, i64 16
  %17 = load atomic i64, ptr %i.eh seq_cst, align 8
  %i.ei = load atomic i64, ptr %i.dz seq_cst, align 8
  %18 = insertelement <2 x i64> poison, i64 %17, i64 0
  %19 = insertelement <2 x i64> %18, i64 %i.ei, i64 1
  %20 = sitofp <2 x i64> %19 to <2 x double>
  %21 = fdiv <2 x double> %20, %13                ; 3 uses
  %foldExtExtBinop126 = fmul <2 x double> %21, %21
  %shift128 = shufflevector <2 x double> %foldExtExtBinop126, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop129 = fsub <2 x double> %21, %shift128
  %22 = extractelement <2 x double> %foldExtExtBinop129, i64 0
  %i.ej = tail call double @sqrt(double noundef %22) #23
  %i.ek = getelementptr inbounds nuw i8, ptr %i.du, i64 32
  %23 = load atomic i64, ptr %i.ek seq_cst, align 8
  %i.el = load atomic i64, ptr %i.ec seq_cst, align 8
  %24 = insertelement <2 x i64> poison, i64 %23, i64 0
  %25 = insertelement <2 x i64> %24, i64 %i.el, i64 1
  %26 = sitofp <2 x i64> %25 to <2 x double>
  %27 = fdiv <2 x double> %26, %13                ; 3 uses
  %foldExtExtBinop131 = fmul <2 x double> %27, %27
  %shift133 = shufflevector <2 x double> %foldExtExtBinop131, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop134 = fsub <2 x double> %27, %shift133
  %28 = extractelement <2 x double> %foldExtExtBinop134, i64 0
  %i.em = tail call double @sqrt(double noundef %28) #23
