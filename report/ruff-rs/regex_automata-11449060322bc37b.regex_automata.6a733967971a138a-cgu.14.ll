...
bb.g:                                             ; preds = %._crit_edge
  ...
  %3 = load i8, ptr %i.o, align 1, !alias.scope !312, !noundef !3 ; 6 uses
  %4 = icmp sgt i8 %3, -1
...
bb.g:                                             ; preds = %._crit_edge
  ...
  %3 = load i8, ptr %i.u, align 1, !alias.scope !330, !noundef !3 ; 5 uses
  %4 = icmp sgt i8 %3, -1
...
bb.r:                                             ; preds = %._crit_edge112
  ...
  %7 = load i8, ptr %i.au, align 1, !alias.scope !343, !noundef !3 ; 6 uses
  %8 = icmp sgt i8 %7, -1
...
bb.v:                                             ; preds = %.thread21
  ...
  br i1 %i.bl, label %bb.x, label %bb.w, !prof !107
