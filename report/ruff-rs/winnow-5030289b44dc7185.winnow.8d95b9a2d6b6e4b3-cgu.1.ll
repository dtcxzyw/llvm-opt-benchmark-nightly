...
.lr.ph.i:                                         ; preds = %bb.b, %.critedge.backedge.i
  %i.c = phi i64 [ %i.d, %.critedge.backedge.i ], [ %.sroa.0.0.i, %bb.b ]
  %i.d = add nsw i64 %i.c, -1                     ; 4 uses
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 %i.d
  %i.f = load i8, ptr %i.e, align 1, !alias.scope !11, !noalias !12, !noundef !3
  %i.g = icmp sgt i8 %i.f, -65
  br i1 %i.g, label %_RINvYINtNtNtCs4NRVxsYgnAr_4core3ops5range5RangejENtNtNtNtBa_4iter6traits12double_ended19DoubleEndedIterator9try_rfolduNCINvNvBL_5rfind5checkjNCNvNtCsc9EtMejYXE5_6winnow5error13char_boundary0E0INtNtB8_12control_flow11ControlFlowjEEB2l_.exit, label %.critedge.backedge.i
...
_RNCNvNtCsc9EtMejYXE5_6winnow5error13char_boundarys_0B5_.exit.i.i: ; preds = %.lr.ph.i19
  ...
  %i.j = load i8, ptr %i.i, align 1, !alias.scope !13, !noalias !14, !noundef !3
...
_RINvYINtNtNtCs4NRVxsYgnAr_4core3ops5range5RangejENtNtNtNtBa_4iter6traits8iterator8Iterator8try_folduNCINvNvBL_4find5checkjNCNvNtCsc9EtMejYXE5_6winnow5error13char_boundarys_0E0INtNtB8_12control_flow11ControlFlowjEEB22_.exit: ; preds = %.critedge.backedge.i20, %_RNCNvNtCsc9EtMejYXE5_6winnow5error13char_boundarys_0B5_.exit.i.i, %_RINvYINtNtNtCs4NRVxsYgnAr_4core3ops5range5RangejENtNtNtNtBa_4iter6traits12double_ended19DoubleEndedIterator9try_rfolduNCINvNvBL_5rfind5checkjNCNvNtCsc9EtMejYXE5_6winnow5error13char_boundary0E0INtNtB8_12control_flow11ControlFlowjEEB2l_.exit, %bb.a
  ...
  %i.m = insertvalue { i64, i64 } %i.l, i64 %.sroa.3.0, 1
  ret { i64, i64 } %i.m
}
...
bb.a:
  ...
  %i.j = load i32, ptr %0, align 8, !range !19, !noundef !3
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.l = load i32, ptr %i.k, align 4, !range !20, !noundef !3 ; 9 uses
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.p = load ptr, ptr %i.o, align 8, !nonnull !3, !align !4, !noundef !3
...
bb.i:                                             ; preds = %bb.e
  ...
  %i.aa = load ptr, ptr %1, align 8, !nonnull !3, !noundef !3
  %i.ab = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.ac = load ptr, ptr %i.ab, align 8, !nonnull !3, !align !4, !noundef !3
...
bb.k:                                             ; preds = %bb.j
  store i8 92, ptr %i.i, align 4, !alias.scope !21
  %.sroa.044.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.i, i64 1
  store i8 48, ptr %.sroa.044.sroa.4.0..sroa_idx.i, align 1, !alias.scope !21
  %.sroa.044.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.i, i64 2
  store i64 0, ptr %.sroa.044.sroa.5.0..sroa_idx.i, align 2, !alias.scope !21
...
bb.l:                                             ; preds = %bb.j
  ...
  store i8 116, ptr %.sroa.033.sroa.4.0..sroa_idx.i, align 1, !alias.scope !21
  %.sroa.033.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.i, i64 2
  store i64 0, ptr %.sroa.033.sroa.5.0..sroa_idx.i, align 2, !alias.scope !21
  br label %_RNvMNtNtCs4NRVxsYgnAr_4core4char7methodsc16escape_debug_ext.exit

bb.m:                                             ; preds = %bb.j
  store i8 92, ptr %i.i, align 4, !alias.scope !21
  %.sroa.022.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.i, i64 1
  store i8 114, ptr %.sroa.022.sroa.4.0..sroa_idx.i, align 1, !alias.scope !21
  %.sroa.022.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.i, i64 2
  store i64 0, ptr %.sroa.022.sroa.5.0..sroa_idx.i, align 2, !alias.scope !21
  br label %_RNvMNtNtCs4NRVxsYgnAr_4core4char7methodsc16escape_debug_ext.exit

bb.n:                                             ; preds = %bb.j
  store i8 92, ptr %i.i, align 4, !alias.scope !21
  %.sroa.011.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.i, i64 1
  store i8 110, ptr %.sroa.011.sroa.4.0..sroa_idx.i, align 1, !alias.scope !21
  %.sroa.011.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.i, i64 2
  store i64 0, ptr %.sroa.011.sroa.5.0..sroa_idx.i, align 2, !alias.scope !21
  br label %_RNvMNtNtCs4NRVxsYgnAr_4core4char7methodsc16escape_debug_ext.exit

bb.o:                                             ; preds = %bb.j
  store i8 92, ptr %i.i, align 4, !alias.scope !21
  %.sroa.02.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.i, i64 1
  store i8 92, ptr %.sroa.02.sroa.4.0..sroa_idx.i, align 1, !alias.scope !21
  %.sroa.02.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.i, i64 2
  store i64 0, ptr %.sroa.02.sroa.5.0..sroa_idx.i, align 2, !alias.scope !21
  br label %_RNvMNtNtCs4NRVxsYgnAr_4core4char7methodsc16escape_debug_ext.exit

bb.p:                                             ; preds = %bb.j
  store i8 92, ptr %i.i, align 4, !alias.scope !21
  %.sroa.055.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.i, i64 1
  store i8 34, ptr %.sroa.055.sroa.4.0..sroa_idx.i, align 1, !alias.scope !21
  %.sroa.055.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.i, i64 2
  store i64 0, ptr %.sroa.055.sroa.5.0..sroa_idx.i, align 2, !alias.scope !21
  br label %_RNvMNtNtCs4NRVxsYgnAr_4core4char7methodsc16escape_debug_ext.exit

bb.q:                                             ; preds = %bb.j
  store i8 92, ptr %i.i, align 4, !alias.scope !21
  %.sroa.066.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.i, i64 1
  store i8 39, ptr %.sroa.066.sroa.4.0..sroa_idx.i, align 1, !alias.scope !21
  %.sroa.066.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.i, i64 2
  store i64 0, ptr %.sroa.066.sroa.5.0..sroa_idx.i, align 2, !alias.scope !21
  br label %_RNvMNtNtCs4NRVxsYgnAr_4core4char7methodsc16escape_debug_ext.exit

bb.r:                                             ; preds = %bb.j
  %i.ae = tail call noundef zeroext i1 @_RNvNtNtCs4NRVxsYgnAr_4core7unicode9printable12is_printable(i32 noundef range(i32 0, 1114112) %i.l), !noalias !21
  br i1 %i.ae, label %bb.t, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.af = or i32 %i.l, 1
  %i.ag = tail call range(i32 11, 32) i32 @llvm.ctlz.i32(i32 %i.af, i1 true)
  %i.ah = lshr i32 %i.ag, 2
  %i.ai = zext nneg i32 %i.ah to i64              ; 2 uses
  %i.aj = add nsw i64 %i.ai, -2                   ; 2 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(10) %i.a, i8 0, i64 3, i1 false), !noalias !21
  %i.ak = getelementptr inbounds nuw i8, ptr %i.a, i64 3
  %i.al = lshr i32 %i.l, 4
  %i.am = zext nneg i32 %i.al to i64
  %i.an = getelementptr inbounds nuw i8, ptr @0, i64 %i.am
  store i32 808464432, ptr %i.ak, align 1
  %i.ao = load i8, ptr %i.an, align 1, !range !22, !noalias !23, !noundef !3
