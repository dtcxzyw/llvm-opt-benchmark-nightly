...
.lr.ph.i:                                         ; preds = %bb.b, %.critedge.backedge.i
  ...
  %i.f = load i8, ptr %i.e, align 1, !alias.scope !3, !noalias !6, !noundef !8
...
bb.q:                                             ; preds = %bb.j
  ...
  store i64 0, ptr %.sroa.066.sroa.5.0..sroa_idx.i, align 2, !alias.scope !17
  br label %_RNvMNtNtCs4NRVxsYgnAr_4core4char7methodsc16escape_debug_ext.exit

bb.r:                                             ; preds = %bb.j
  %i.ae = tail call noundef zeroext i1 @_RNvNtNtCs4NRVxsYgnAr_4core7unicode9printable12is_printable(i32 noundef range(i32 0, 1114112) %i.l), !noalias !17
...
bb.s:                                             ; preds = %bb.r
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(10) %i.a, i8 0, i64 3, i1 false), !noalias !17
  ...
  %i.ao = load i8, ptr %i.an, align 1, !range !20, !noalias !21, !noundef !8
