...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %i.ac = trunc i16 %.sroa.028.0.copyload to i1   ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.o)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.n)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.m)
  %narrow = select i1 %i.ac, i16 %3, i16 3
  %.sroa.038.0.insert.ext = zext nneg i16 %narrow to i48
  %4 = zext i8 %.sroa.633.0.copyload to i48
  %5 = shl nuw nsw i48 %4, 8
  %.sroa.038.1.insert.shift = select i1 %i.ac, i48 %5, i48 3584
  %i.ad = or disjoint i48 %.sroa.038.1.insert.shift, %.sroa.038.0.insert.ext
  %.sroa.038.2.insert.insert = or disjoint i48 %i.ad, 13238272
