...
bb.i:                                             ; preds = %.lr.ph112, %._crit_edge108
  ...
  br i1 %i.ah, label %._crit_edge113, label %.lr.ph94

.lr.ph94:                                         ; preds = %bb.i, %bb.bh
  %.sroa.7.093 = phi i64 [ %.sroa.7.1, %bb.bh ], [ %.sroa.048.0111, %bb.i ] ; 2 uses
  %not..sroa.1418.092 = phi i64 [ 1, %bb.bh ], [ 0, %bb.i ]
  %i.ai = sub i64 %.sroa.7.093, %not..sroa.1418.092 ; 11 uses
...
bb.m:                                             ; preds = %bb.l, %bb.j
  ...
  %.sroa.7.1 = phi i64 [ %i.ai, %bb.j ], [ %i.ak, %bb.l ] ; 2 uses
  %i.al = icmp eq i64 %i.ai, 0
  br i1 %i.al, label %._crit_edge164.a, label %bb.ap
...
.lr.ph107:                                        ; preds = %.lr.ph107.preheader, %bb.ak
  ...
  %i.am = sub i64 %.sroa.726.0104, %not..sroa.1727.0105 ; 11 uses
...
bb.q:                                             ; preds = %bb.p, %bb.n
  ...
  %.sroa.12.1 = phi i1 [ true, %bb.n ], [ false, %bb.p ]
  %i.ap = icmp eq i64 %i.am, 0
  br i1 %i.ap, label %._crit_edge166.a, label %bb.r
...
._crit_edge166.a:                                 ; preds = %bb.q, %bb.v
  %.pre-phi = phi i64 [ %i.at, %bb.v ], [ %i.r, %bb.q ] ; 3 uses
  %i.aq = icmp ult i64 %.pre-phi, %i.t
  br i1 %i.aq, label %bb.aa, label %bb.ab
...
bb.ak:                                            ; preds = %bb.aj, %bb.am, %bb.ah
  %.not.i144 = icmp slt i64 %.sroa.726.1, 0
  %or.cond45 = or i1 %.sroa.12.1, %.not.i144
...
._crit_edge164.a:                                 ; preds = %bb.m, %bb.at
  %.pre-phi170 = phi i64 [ %i.cs, %bb.at ], [ %i.i, %bb.m ] ; 3 uses
...
bb.bh:                                            ; preds = %bb.bi, %bb.bk, %bb.bf
  %.not.i = icmp slt i64 %.sroa.7.1, 0
  %or.cond44 = or i1 %.sroa.11.1, %.not.i
...
bb.gt:                                            ; preds = %._crit_edge132.i, %.lr.ph136.i
  ...
  br i1 %i.adc, label %_RINvNtNtCsiqiOkcJdymw_7similar10algorithms5myers17find_middle_snakeINtNtCscdodAO9FK5_5alloc3vec3VecINtNtB4_5utils10UniqueItemINtB1C_12OffsetLookupmEEEB13_ECs56aZGHL6Dc6_7ruff_db.exit, label %.lr.ph119.i
...
bb.fy:                                            ; preds = %._crit_edge108.i, %.lr.ph112.i
  ...
  br i1 %i.yq, label %_RINvNtNtCsiqiOkcJdymw_7similar10algorithms5myers17find_middle_snakeINtNtCscdodAO9FK5_5alloc3vec3VecINtNtB4_5utils10UniqueItemINtNtB6_4text12TextDiffSideeEEEB13_ECs56aZGHL6Dc6_7ruff_db.exit, label %.lr.ph94.i
...
bb.fy:                                            ; preds = %._crit_edge132.i, %.lr.ph136.i
  %.sroa.048.0135.i = phi i64 [ 0, %.lr.ph136.i ], [ %i.acl, %._crit_edge132.i ] ; 8 uses
  ...
  br i1 %i.acm, label %_RINvNtNtCsiqiOkcJdymw_7similar10algorithms5myers17find_middle_snakeINtNtCscdodAO9FK5_5alloc3vec3VecINtNtB4_5utils10UniqueItemINtNtNtB6_4text6inline11MultiLookupeEEEB13_ECs56aZGHL6Dc6_7ruff_db.exit, label %.lr.ph118.i

.lr.ph118.i:                                      ; preds = %bb.fy, %bb.id
  %.sroa.7.0117.i = phi i64 [ %.sroa.7.1.i, %bb.id ], [ %.sroa.048.0135.i, %bb.fy ] ; 2 uses
  %not..sroa.1418.0116.i = phi i64 [ 1, %bb.id ], [ 0, %bb.fy ]
  %i.acn = sub i64 %.sroa.7.0117.i, %not..sroa.1418.0116.i ; 11 uses
  %.not.i.not.i.i = icmp sgt i64 %i.acn, %.sroa.7.0117.i
  br i1 %.not.i.not.i.i, label %.lr.ph131.i.preheader, label %bb.fz

.lr.ph131.i.preheader:                            ; preds = %bb.id, %bb.fz, %.lr.ph118.i
  br label %.lr.ph131.i

bb.fz:                                            ; preds = %.lr.ph118.i
  %i.aco = call noundef range(i8 -1, 2) i8 @llvm.scmp.i8.i64(i64 %i.acn, i64 0)
...
bb.gc:                                            ; preds = %bb.gb, %bb.fz
  ...
  %i.acq = icmp eq i64 %i.acn, 0
  br i1 %i.acq, label %._crit_edge216.i, label %bb.hi

.lr.ph131.i:                                      ; preds = %.lr.ph131.i.preheader, %bb.hd
  %not..sroa.1727.0129.i = phi i64 [ 1, %bb.hd ], [ 0, %.lr.ph131.i.preheader ]
  %.sroa.726.0128.i = phi i64 [ %.sroa.726.1.i, %bb.hd ], [ %.sroa.048.0135.i, %.lr.ph131.i.preheader ] ; 2 uses
...
bb.gd:                                            ; preds = %.lr.ph131.i
  %i.acs = call noundef range(i8 -1, 2) i8 @llvm.scmp.i8.i64(i64 %i.acr, i64 0)
...
._crit_edge218.i:                                 ; preds = %bb.gl, %bb.gg
  %.pre-phi.i = phi i64 [ %i.acy, %bb.gl ], [ %i.abw, %bb.gg ] ; 3 uses
...
bb.hd:                                            ; preds = %bb.hf, %bb.hc, %bb.ha
  %.not.i152.i = icmp slt i64 %.sroa.726.1.i, 0
  %or.cond45.i = or i1 %.sroa.12.1.i250, %.not.i152.i
...
._crit_edge216.i:                                 ; preds = %bb.hm, %bb.gc
  %.pre-phi222.i = phi i64 [ %i.afl, %bb.hm ], [ %i.abn, %bb.gc ] ; 3 uses
...
bb.id:                                            ; preds = %bb.ig, %bb.ie, %bb.ib
  %.not.i.i = icmp slt i64 %.sroa.7.1.i, 0
  %or.cond44.i = or i1 %.sroa.11.1.i, %.not.i.i
  br i1 %or.cond44.i, label %.lr.ph131.i.preheader, label %.lr.ph118.i
