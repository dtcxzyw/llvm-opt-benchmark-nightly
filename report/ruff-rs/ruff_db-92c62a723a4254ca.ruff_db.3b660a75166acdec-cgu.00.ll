...
bb.ft:                                            ; preds = %bb.fr
  ...
  %i.acd = lshr i64 %i.acc, 1
  %.sroa.047.0.i = sub nuw i64 %i.acc, %i.acd     ; 3 uses
...
bb.fy:                                            ; preds = %._crit_edge132.i, %.lr.ph136.i
  %.sroa.048.0135.i = phi i64 [ 0, %.lr.ph136.i ], [ %i.aci, %._crit_edge132.i ] ; 11 uses
  %i.aci = add nuw nsw i64 %.sroa.048.0135.i, 1
