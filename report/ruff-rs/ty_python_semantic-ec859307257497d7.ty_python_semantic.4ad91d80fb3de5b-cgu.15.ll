...
switch.lookup:                                    ; preds = %bb.a
  ...
  %i.az = call noundef i8 @_RNvXsp_NtCsoTR8nlGN3X_18ty_python_semantic5typesNtB5_4TypeNtNtB5_8variance17VarianceInferable11variance_of(ptr noalias noundef nonnull align 4 captures(address) dereferenceable(16) %i.b, ptr noundef nonnull %i.ar, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(272) %i.at, ptr noundef nonnull align 4 %i.c, ptr noalias noundef nonnull readonly align 4 captures(address) dereferenceable(28) %i.a), !noalias !119
