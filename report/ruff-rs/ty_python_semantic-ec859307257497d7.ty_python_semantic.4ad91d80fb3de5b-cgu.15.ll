...
bb.br:                                            ; preds = %.backedge.i, %.lr.ph356.i
  %.sroa.7205.0354.i = phi i64 [ 0, %.lr.ph356.i ], [ %i.jr, %.backedge.i ] ; 2 uses
  %.sroa.0203.0353.i = phi ptr [ %i.cw, %.lr.ph356.i ], [ %i.jq, %.backedge.i ] ; 2 uses
  %i.jq = getelementptr inbounds nuw i8, ptr %.sroa.0203.0353.i, i64 16 ; 2 uses
  %i.jr = add nuw nsw i64 %.sroa.7205.0354.i, 1
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.ar, ptr noundef nonnull align 4 dereferenceable(16) %.sroa.0203.0353.i, i64 16, i1 false), !noalias !9786
