...
bb.q:                                             ; preds = %bb.p
  ...
  %.val2.i = load i64, ptr %i.bg, align 8, !alias.scope !4952, !noalias !4955 ; 3 uses
  %.val3.i = load ptr, ptr %i.bf, align 8, !alias.scope !4955, !noalias !4952, !noundef !9 ; 3 uses
  %2 = getelementptr inbounds nuw i8, ptr %1, i64 24
  %.val4.i = load i64, ptr %2, align 8, !alias.scope !4955, !noalias !4952 ; 2 uses
  %i.bh = icmp ne ptr %.val.i, null               ; 2 uses
  %i.bi = icmp eq ptr %.val3.i, null              ; 3 uses
  %not..i.i = xor i1 %i.bi, true
  %i.bj = xor i1 %i.bh, %i.bi
  br i1 %i.bj, label %3, label %_RNvXs5t_NtCskLngH8kgpZI_15ruff_python_ast5nodesNtB6_6NumberNtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eq.exit
...
bb.r:                                             ; preds = %3
  ...
  %i.bk = icmp eq i64 %.val2.i, %.val4.i
...
bb.e:                                             ; preds = %bb.d
  ...
  %.not2.not = icmp eq i64 %i.o, 0
  br i1 %.not2.not, label %._crit_edge, label %.lr.ph

bb.f:                                             ; preds = %.lr.ph
  %i.w = add nuw i64 %.sroa.01.0.i3, 1            ; 2 uses
  %exitcond.not = icmp eq i64 %i.w, %i.o
  br i1 %exitcond.not, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %bb.e, %bb.f
  %.sroa.01.0.i3 = phi i64 [ %i.w, %bb.f ], [ 0, %bb.e ] ; 3 uses
  %i.x = getelementptr inbounds nuw [72 x i8], ptr %i.v, i64 %.sroa.01.0.i3
  %i.y = getelementptr inbounds nuw [72 x i8], ptr %i.t, i64 %.sroa.01.0.i3
  %i.z = tail call fastcc noundef zeroext i1 @_RNvXsbA_NtCskLngH8kgpZI_15ruff_python_ast9generatedNtB6_4ExprNtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eq(ptr noundef nonnull align 8 %i.x, ptr noundef nonnull align 8 %i.y), !inline_history !8512
  br i1 %i.z, label %bb.f, label %_RNvXs2_NtNtCs4NRVxsYgnAr_4core5slice3cmpNtNtCskLngH8kgpZI_15ruff_python_ast9generated4ExprINtB5_14SlicePartialEqBC_E17equal_same_lengthCsEhZmuQNqkz_11ruff_linter.exit

._crit_edge:                                      ; preds = %bb.f, %bb.e
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 36
  %i.ab = getelementptr inbounds nuw i8, ptr %1, i64 36
  %.val = load i8, ptr %i.aa, align 4, !range !4678, !noundef !9
  %.val1 = load i8, ptr %i.ab, align 4, !range !4678, !noundef !9
  %i.ac = icmp eq i8 %.val, %.val1
...
_RNvXs2_NtNtCs4NRVxsYgnAr_4core5slice3cmpNtNtCskLngH8kgpZI_15ruff_python_ast9generated4ExprINtB5_14SlicePartialEqBC_E17equal_same_lengthCsEhZmuQNqkz_11ruff_linter.exit: ; preds = %.lr.ph, %bb.c, %bb.a, %bb.b, %bb.d, %._crit_edge
  %.sroa.0.0 = phi i1 [ %i.ac, %._crit_edge ], [ false, %bb.d ], [ false, %bb.b ], [ false, %bb.a ], [ false, %bb.c ], [ false, %.lr.ph ]
  ret i1 %.sroa.0.0
}
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal fastcc noundef zeroext i1 @_RNvXsh_CsaSrGj5dYoxL_8thin_vecINtB5_7ThinVecNtNtCskLngH8kgpZI_15ruff_python_ast5nodes7KeywordENtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eqCsEhZmuQNqkz_11ruff_linter(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %0, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %1) unnamed_addr #2 {
bb.a:
  %i.a = tail call noundef ptr @_RNvMs3_CsaSrGj5dYoxL_8thin_vecINtB5_7ThinVecNtNtCskLngH8kgpZI_15ruff_python_ast5nodes7KeywordE8data_rawCsEhZmuQNqkz_11ruff_linter(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %0)
  %i.b = load ptr, ptr %0, align 8, !nonnull !9, !noundef !9
  %i.c = load i64, ptr %i.b, align 8, !noundef !9 ; 2 uses
  %i.d = tail call noundef ptr @_RNvMs3_CsaSrGj5dYoxL_8thin_vecINtB5_7ThinVecNtNtCskLngH8kgpZI_15ruff_python_ast5nodes7KeywordE8data_rawCsEhZmuQNqkz_11ruff_linter(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %1)
  %i.e = load ptr, ptr %1, align 8, !nonnull !9, !noundef !9
  %i.f = load i64, ptr %i.e, align 8, !noundef !9
  %i.g = icmp eq i64 %i.c, %i.f
  br i1 %i.g, label %bb.b, label %bb.c
...
bb.b:                                             ; preds = %bb.a
  %i.h = tail call noundef zeroext i1 @_RNvXs2_NtNtCs4NRVxsYgnAr_4core5slice3cmpNtNtCskLngH8kgpZI_15ruff_python_ast5nodes7KeywordINtB5_14SlicePartialEqBC_E17equal_same_lengthCsEhZmuQNqkz_11ruff_linter(ptr noundef %i.a, ptr noundef %i.d, i64 noundef %i.c)
  br label %bb.c
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal fastcc noundef zeroext i1 @_RNvXsh_CsaSrGj5dYoxL_8thin_vecINtB5_7ThinVecNtNtCskLngH8kgpZI_15ruff_python_ast9generated4ExprENtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eqCsEhZmuQNqkz_11ruff_linter(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %0, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %1) unnamed_addr #2 {
bb.a:
  %i.a = tail call noundef ptr @_RNvMs3_CsaSrGj5dYoxL_8thin_vecINtB5_7ThinVecNtNtCskLngH8kgpZI_15ruff_python_ast9generated4ExprE8data_rawCsEhZmuQNqkz_11ruff_linter(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %0)
  %i.b = load ptr, ptr %0, align 8, !nonnull !9, !noundef !9
  %i.c = load i64, ptr %i.b, align 8, !noundef !9 ; 3 uses
  %i.d = tail call noundef ptr @_RNvMs3_CsaSrGj5dYoxL_8thin_vecINtB5_7ThinVecNtNtCskLngH8kgpZI_15ruff_python_ast9generated4ExprE8data_rawCsEhZmuQNqkz_11ruff_linter(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %1)
  %i.e = load ptr, ptr %1, align 8, !nonnull !9, !noundef !9
  %i.f = load i64, ptr %i.e, align 8, !noundef !9
  %i.g = icmp eq i64 %i.c, %i.f
  br i1 %i.g, label %bb.b, label %_RNvXs2_NtNtCs4NRVxsYgnAr_4core5slice3cmpNtNtCskLngH8kgpZI_15ruff_python_ast9generated4ExprINtB5_14SlicePartialEqBC_E17equal_same_lengthCsEhZmuQNqkz_11ruff_linter.exit

bb.b:                                             ; preds = %bb.a
  %i.h = icmp eq i64 %i.c, 0
  br i1 %i.h, label %_RNvXs2_NtNtCs4NRVxsYgnAr_4core5slice3cmpNtNtCskLngH8kgpZI_15ruff_python_ast9generated4ExprINtB5_14SlicePartialEqBC_E17equal_same_lengthCsEhZmuQNqkz_11ruff_linter.exit, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %bb.b, %.lr.ph.i
  %.sroa.01.05.i = phi i64 [ %i.l, %.lr.ph.i ], [ 0, %bb.b ] ; 3 uses
  %i.i = getelementptr inbounds nuw [72 x i8], ptr %i.a, i64 %.sroa.01.05.i
  %i.j = getelementptr inbounds nuw [72 x i8], ptr %i.d, i64 %.sroa.01.05.i
  %i.k = tail call fastcc noundef zeroext i1 @_RNvXsbA_NtCskLngH8kgpZI_15ruff_python_ast9generatedNtB6_4ExprNtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eq(ptr noundef nonnull align 8 %i.i, ptr noundef nonnull align 8 %i.j), !inline_history !7612 ; 2 uses
  %i.l = add nuw i64 %.sroa.01.05.i, 1            ; 2 uses
  %exitcond.not.i = icmp ne i64 %i.l, %i.c
  %or.cond.not = select i1 %i.k, i1 %exitcond.not.i, i1 false
  br i1 %or.cond.not, label %.lr.ph.i, label %_RNvXs2_NtNtCs4NRVxsYgnAr_4core5slice3cmpNtNtCskLngH8kgpZI_15ruff_python_ast9generated4ExprINtB5_14SlicePartialEqBC_E17equal_same_lengthCsEhZmuQNqkz_11ruff_linter.exit

_RNvXs2_NtNtCs4NRVxsYgnAr_4core5slice3cmpNtNtCskLngH8kgpZI_15ruff_python_ast9generated4ExprINtB5_14SlicePartialEqBC_E17equal_same_lengthCsEhZmuQNqkz_11ruff_linter.exit: ; preds = %.lr.ph.i, %bb.b, %bb.a
  %.sroa.0.0 = phi i1 [ false, %bb.a ], [ true, %bb.b ], [ %i.k, %.lr.ph.i ]
  ret i1 %.sroa.0.0
}

; Function Attrs: inlinehint nonlazybind uwtable
define internal fastcc noundef zeroext i1 @_RNvXsh_CsaSrGj5dYoxL_8thin_vecINtB5_7ThinVecNtNtCskLngH8kgpZI_15ruff_python_ast9generated4StmtENtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eqCsEhZmuQNqkz_11ruff_linter(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %0, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %1) unnamed_addr #2 {
bb.a:
  %i.a = tail call noundef ptr @_RNvMs3_CsaSrGj5dYoxL_8thin_vecINtB5_7ThinVecNtNtCskLngH8kgpZI_15ruff_python_ast9generated4StmtE8data_rawCsEhZmuQNqkz_11ruff_linter(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %0)
  %i.b = load ptr, ptr %0, align 8, !nonnull !9, !noundef !9
  %i.c = load i64, ptr %i.b, align 8, !noundef !9 ; 3 uses
  %i.d = tail call noundef ptr @_RNvMs3_CsaSrGj5dYoxL_8thin_vecINtB5_7ThinVecNtNtCskLngH8kgpZI_15ruff_python_ast9generated4StmtE8data_rawCsEhZmuQNqkz_11ruff_linter(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %1)
  %i.e = load ptr, ptr %1, align 8, !nonnull !9, !noundef !9
  %i.f = load i64, ptr %i.e, align 8, !noundef !9
  %i.g = icmp eq i64 %i.c, %i.f
  br i1 %i.g, label %.preheader, label %_RNvXs2_NtNtCs4NRVxsYgnAr_4core5slice3cmpNtNtCskLngH8kgpZI_15ruff_python_ast9generated4StmtINtB5_14SlicePartialEqBC_E17equal_same_lengthCsEhZmuQNqkz_11ruff_linter.exit
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.y = load i32, ptr %i.x, align 8, !noundef !9
  %i.z = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.aa = load i32, ptr %i.z, align 8, !noundef !9
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ad = load i32, ptr %i.ac, align 4, !noundef !9
  %i.ae = getelementptr inbounds nuw i8, ptr %1, i64 20
  %i.af = load i32, ptr %i.ae, align 4, !noundef !9
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.al = load i64, ptr %i.ak, align 8, !noundef !9 ; 2 uses
...
bb.k:                                             ; preds = %bb.j
  %i.ap = load ptr, ptr %1, align 8, !nonnull !9, !noundef !9
  %i.aq = load ptr, ptr %0, align 8, !nonnull !9, !noundef !9
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.at = load i8, ptr %i.as, align 4, !noundef !9
  %i.au = getelementptr inbounds nuw i8, ptr %1, i64 28
  %i.av = load i8, ptr %i.au, align 4, !noundef !9
...
bb.f:                                             ; preds = %bb.e
  ...
  %.val2.i = load i64, ptr %i.s, align 8, !alias.scope !8543, !noalias !8546 ; 3 uses
  %.val3.i = load ptr, ptr %i.r, align 8, !alias.scope !8546, !noalias !8543, !noundef !9 ; 3 uses
  %2 = getelementptr inbounds nuw i8, ptr %1, i64 16
  %.val4.i = load i64, ptr %2, align 8, !alias.scope !8546, !noalias !8543 ; 2 uses
