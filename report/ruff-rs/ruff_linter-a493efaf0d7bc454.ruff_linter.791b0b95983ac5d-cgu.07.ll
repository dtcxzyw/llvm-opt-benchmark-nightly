...
bb.c:                                             ; preds = %bb.b
  ...
  %.val1.i.i = load i64, ptr %i.f, align 8, !noalias !8015 ; 2 uses
  %.val2.i.i = load ptr, ptr %.val2.i, align 8, !noalias !8015, !noundef !6 ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %.val3.i.i = load i64, ptr %2, align 8, !noalias !8015
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.z = load i32, ptr %i.y, align 8, !noundef !6
  %i.aa = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.ab = load i32, ptr %i.aa, align 8, !noundef !6
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.am = load i64, ptr %i.al, align 8, !noundef !6 ; 2 uses
...
bb.k:                                             ; preds = %bb.j
  %i.aq = load ptr, ptr %1, align 8, !nonnull !6, !noundef !6
  %i.ar = load ptr, ptr %0, align 8, !nonnull !6, !noundef !6
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.au = load i8, ptr %i.at, align 4, !noundef !6
  %i.av = getelementptr inbounds nuw i8, ptr %1, i64 28
  %i.aw = load i8, ptr %i.av, align 4, !noundef !6
...
bb.m:                                             ; preds = %bb.f
  ...
  %i.az = load ptr, ptr %i.ay, align 8, !nonnull !6, !noundef !6
...
bb.f:                                             ; preds = %bb.e
  ...
  %.val2.i = load i64, ptr %i.s, align 8, !alias.scope !8481, !noalias !8484 ; 2 uses
  %.val3.i = load ptr, ptr %i.r, align 8, !alias.scope !8484, !noalias !8481, !noundef !6 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %.val4.i = load i64, ptr %2, align 8, !alias.scope !8484, !noalias !8481
