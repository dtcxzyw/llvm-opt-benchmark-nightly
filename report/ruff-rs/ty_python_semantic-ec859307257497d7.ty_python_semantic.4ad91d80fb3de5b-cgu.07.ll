...
bb.k:                                             ; preds = %bb.i
  ...
  %.not.i14.i = icmp ne i32 %.val10.i, 0          ; 2 uses
  %i.bj = zext i32 %.val10.i to i64
  %i.bk = add nsw i64 %i.bj, -1
  %.sroa.3.0.i.i = select i1 %.not.i14.i, i64 %i.bk, i64 undef ; 2 uses
  %i.bl = icmp ult i64 %.sroa.3.0.i.i, 4294967295
  %or.cond6.not.i.i = select i1 %.not.i14.i, i1 %i.bl, i1 false
  %2 = trunc nuw i64 %.sroa.3.0.i.i to i32
  %3 = add i32 %2, 1
  %.sroa.02.0.i16.i = select i1 %or.cond6.not.i.i, i32 %3, i32 0, !prof !72
