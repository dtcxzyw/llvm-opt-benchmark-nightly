...
begin_hunk_0_@_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtCscdodAO9FK5_5alloc6string6StringECsiXichZnxgbf_6anyhow:bb.a
...
bb.a:
  ...
  %.val1 = load ptr, ptr %i.a, align 8, !nonnull !5, !align !8, !noundef !5 ; 5 uses
  %i.b = load ptr, ptr %.val1, align 8, !invariant.load !5 ; 2 uses
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.d = load i64, ptr %i.c, align 8, !range !6, !invariant.load !5 ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.g = load i64, ptr %i.f, align 8, !range !7, !invariant.load !5
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.val) ]
...
bb.e:                                             ; preds = %bb.b
  ...
  %i.j = load i64, ptr %i.i, align 8, !range !6, !invariant.load !5 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.m = load i64, ptr %i.l, align 8, !range !7, !invariant.load !5
...
bb.a:
  ...
  %i.b = load ptr, ptr %0, align 8, !alias.scope !45, !noalias !46, !nonnull !5, !noundef !5
  call void @_RNvMs6_NtCsiXichZnxgbf_6anyhow5errorNtB5_9ErrorImpl5chain(ptr noalias noundef nonnull sret([32 x i8]) align 8 captures(address) dereferenceable(32) %i.a, ptr noundef nonnull %i.b), !noalias !45
  call void @llvm.experimental.noalias.scope.decl(metadata !47)
  %i.c = getelementptr inbounds nuw i8, ptr %i.a, i64 8 ; 4 uses
  %i.d = getelementptr inbounds nuw i8, ptr %i.a, i64 16 ; 2 uses
  %i.e = load ptr, ptr %i.a, align 8, !alias.scope !48, !noundef !5
  %i.f = icmp eq ptr %i.e, null
  br i1 %i.f, label %.split.i.preheader, label %.split.us.i
...
.split.us.i:                                      ; preds = %bb.a
  ...
  %i.h = load ptr, ptr %i.g, align 8, !alias.scope !49, !nonnull !5, !noundef !5 ; 2 uses
  %.promoted.i = load ptr, ptr %i.c, align 8, !alias.scope !49 ; 2 uses
  %i.i = icmp eq ptr %.promoted.i, %i.h
  br i1 %i.i, label %.split7.us.i, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.split.us.i, %.lr.ph.i
  %i.j = phi ptr [ %i.k, %.lr.ph.i ], [ %.promoted.i, %.split.us.i ] ; 3 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !50)
  call void @llvm.experimental.noalias.scope.decl(metadata !51)
  %i.k = getelementptr inbounds nuw i8, ptr %i.j, i64 16 ; 3 uses
  %i.l = icmp eq ptr %i.k, %i.h
  br i1 %i.l, label %..split7.us_crit_edge.i, label %.lr.ph.i

..split7.us_crit_edge.i:                          ; preds = %.lr.ph.i
  store ptr %i.k, ptr %i.c, align 8, !alias.scope !49
  %i.m = load ptr, ptr %i.j, align 8, !noalias !49, !nonnull !5, !noundef !5
  %i.n = getelementptr inbounds nuw i8, ptr %i.j, i64 8
  %i.o = load ptr, ptr %i.n, align 8, !noalias !49, !nonnull !5, !align !8, !noundef !5
  br label %.split7.us.i

.split7.us.i:                                     ; preds = %..split7.us_crit_edge.i, %.split.us.i
  %.us-phi825.i = phi ptr [ null, %.split.us.i ], [ %i.m, %..split7.us_crit_edge.i ]
  %.us-phi23.i = phi ptr [ undef, %.split.us.i ], [ %i.o, %..split7.us_crit_edge.i ]
...
bb.b:                                             ; preds = %_RINvYNtCsiXichZnxgbf_6anyhow5ChainNtNtNtNtCs4NRVxsYgnAr_4core4iter6traits8iterator8Iterator4foldINtNtBE_6option6OptionRDNtNtBE_5error5ErrorEL_EINvNvBw_4last4someB1S_EEB5_.exit
  %i.v = insertvalue { ptr, ptr } poison, ptr %.us-phi826.i, 0
  %i.w = insertvalue { ptr, ptr } %i.v, ptr %.us-phi24.i, 1
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load ptr, ptr %i.c, align 8, !alias.scope !61, !nonnull !5, !noundef !5 ; 3 uses
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.f = load ptr, ptr %i.e, align 8, !alias.scope !61, !nonnull !5, !noundef !5
...
bb.c:                                             ; preds = %bb.b
  ...
  store ptr %i.h, ptr %i.c, align 8, !alias.scope !61
  %i.i = load ptr, ptr %i.h, align 8, !noalias !61, !nonnull !5, !noundef !5
  %i.j = getelementptr inbounds i8, ptr %i.d, i64 -8
  %i.k = load ptr, ptr %i.j, align 8, !noalias !61, !nonnull !5, !align !8, !noundef !5
...
._crit_edge:                                      ; preds = %_RNvMsF_NtCscdodAO9FK5_5alloc3vecINtB5_3VecRDNtNtCs4NRVxsYgnAr_4core5error5ErrorEL_E8push_mutCsiXichZnxgbf_6anyhow.exit
  ...
  %.pre43 = load i64, ptr %i.a, align 8, !range !6 ; 2 uses
...
bb.e:                                             ; preds = %._crit_edge
  ...
  %i.y = load ptr, ptr %i.x, align 8, !noalias !62, !nonnull !5, !noundef !5
  %i.z = getelementptr inbounds i8, ptr %i.v, i64 -8
  %i.aa = load ptr, ptr %i.z, align 8, !noalias !62, !nonnull !5, !align !8, !noundef !5
...
bb.f:                                             ; preds = %.lr.ph
  ...
  %i.ad = load i64, ptr %i.q, align 8, !alias.scope !63, !noalias !64, !noundef !5 ; 3 uses
  %i.ae = load i64, ptr %i.a, align 8, !range !6, !alias.scope !63, !noalias !64, !noundef !5
...
_RNvMsF_NtCscdodAO9FK5_5alloc3vecINtB5_3VecRDNtNtCs4NRVxsYgnAr_4core5error5ErrorEL_E8push_mutCsiXichZnxgbf_6anyhow.exit: ; preds = %bb.g, %bb.f
  %i.ag = load ptr, ptr %i.p, align 8, !alias.scope !63, !noalias !64, !nonnull !5, !noundef !5
  %i.ah = getelementptr inbounds nuw [16 x i8], ptr %i.ag, i64 %i.ad ; 2 uses
  store ptr %.sroa.01.028, ptr %i.ah, align 8, !noalias !64
  %i.ai = getelementptr inbounds nuw i8, ptr %i.ah, i64 8
  store ptr %.sroa.4.027, ptr %i.ai, align 8, !noalias !64
...
; Function Attrs: nonlazybind uwtable
define noundef i64 @_RNvXs1_NtCsiXichZnxgbf_6anyhow5chainNtB7_5ChainNtNtNtNtCs4NRVxsYgnAr_4core4iter6traits10exact_size17ExactSizeIterator3len(ptr noalias noundef readonly align 8 captures(none) dereferenceable(32) %0) unnamed_addr #1 {
bb.a:
end_hunk_0
