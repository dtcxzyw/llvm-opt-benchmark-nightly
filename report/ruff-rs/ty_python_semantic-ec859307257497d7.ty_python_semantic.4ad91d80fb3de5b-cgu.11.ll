...
begin_hunk_0_@_RNvXsh_NtNtCsoTR8nlGN3X_18ty_python_semantic5types8instanceNtB5_19NominalInstanceTypeNtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eq:bb.a
  %i.f = icmp ne i32 %i.e, 7
  tail call void @llvm.assume(i1 %i.f)
  %i.g = add nsw i32 %i.e, -5
  %i.h = icmp sgt i32 %i.e, 4
  %narrow1.i = select i1 %i.h, i32 %i.g, i32 2
  %i.i = icmp eq i32 %narrow.i, %narrow1.i
  br i1 %i.i, label %bb.b, label %_RNvXsI_NtNtCsoTR8nlGN3X_18ty_python_semantic5types8instanceNtB5_20NominalInstanceInnerNtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eq.exit

bb.b:                                             ; preds = %bb.a
  switch i32 %narrow.i, label %_RNvXsI_NtNtCsoTR8nlGN3X_18ty_python_semantic5types8instanceNtB5_20NominalInstanceInnerNtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eq.exit [
    i32 1, label %bb.c
    i32 2, label %bb.d
  ]
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.k = load i32, ptr %i.j, align 4, !alias.scope !20582, !noalias !20585, !noundef !3
  %i.l = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.m = load i32, ptr %i.l, align 4, !alias.scope !20585, !noalias !20582, !noundef !3
  %i.n = icmp eq i32 %i.k, %i.m
  br i1 %i.n, label %bb.x, label %_RNvXsI_NtNtCsoTR8nlGN3X_18ty_python_semantic5types8instanceNtB5_20NominalInstanceInnerNtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eq.exit

bb.d:                                             ; preds = %bb.b
  tail call void @llvm.experimental.noalias.scope.decl(metadata !20587)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !20590)
  %i.o = icmp eq i32 %i.a, -2                     ; 2 uses
  %i.p = icmp eq i32 %i.e, -2                     ; 3 uses
  %i.q = xor i1 %i.o, %i.p
  br i1 %i.q, label %_RNvXsI_NtNtCsoTR8nlGN3X_18ty_python_semantic5types8instanceNtB5_20NominalInstanceInnerNtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eq.exit, label %bb.e
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.s = load i32, ptr %i.r, align 4, !alias.scope !20592, !noalias !20593, !noundef !3
  %i.t = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.u = load i32, ptr %i.t, align 4, !alias.scope !20593, !noalias !20592, !noundef !3
  %i.v = icmp eq i32 %i.s, %i.u
  br i1 %i.v, label %bb.w, label %_RNvXsI_NtNtCsoTR8nlGN3X_18ty_python_semantic5types8instanceNtB5_20NominalInstanceInnerNtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eq.exit
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.x = icmp eq i32 %i.a, -1                     ; 2 uses
  %i.y = icmp eq i32 %i.e, -1                     ; 3 uses
  %i.z = xor i1 %i.x, %i.y
  br i1 %i.z, label %_RNvXsI_NtNtCsoTR8nlGN3X_18ty_python_semantic5types8instanceNtB5_20NominalInstanceInnerNtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eq.exit, label %bb.h
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ab = load i32, ptr %i.aa, align 4, !alias.scope !20599, !noalias !20600, !noundef !3
  %i.ac = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.ad = load i32, ptr %i.ac, align 4, !alias.scope !20600, !noalias !20599, !noundef !3
  %i.ae = icmp eq i32 %i.ab, %i.ad
  br i1 %i.ae, label %bb.v, label %_RNvXsI_NtNtCsoTR8nlGN3X_18ty_python_semantic5types8instanceNtB5_20NominalInstanceInnerNtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eq.exit

bb.j:                                             ; preds = %bb.h
  %i.af = xor i1 %i.y, true
  tail call void @llvm.assume(i1 %i.af)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !20601)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !20604)
  %i.ag = icmp eq i32 %i.a, %i.e
  br i1 %i.ag, label %bb.k, label %_RNvXsI_NtNtCsoTR8nlGN3X_18ty_python_semantic5types8instanceNtB5_20NominalInstanceInnerNtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eq.exit

bb.k:                                             ; preds = %bb.j
  %i.ah = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.ai = load i32, ptr %i.ah, align 4, !alias.scope !20606, !noalias !20607, !noundef !3
  %i.aj = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.ak = load i32, ptr %i.aj, align 4, !alias.scope !20607, !noalias !20606, !noundef !3
  %i.al = icmp eq i32 %i.ai, %i.ak                ; 5 uses
...
default.unreachable.i.i:                          ; preds = %bb.k
  unreachable

bb.l:                                             ; preds = %bb.k
  br i1 %i.al, label %bb.q, label %_RNvXsI_NtNtCsoTR8nlGN3X_18ty_python_semantic5types8instanceNtB5_20NominalInstanceInnerNtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eq.exit

bb.m:                                             ; preds = %bb.k
  br i1 %i.al, label %bb.r, label %_RNvXsI_NtNtCsoTR8nlGN3X_18ty_python_semantic5types8instanceNtB5_20NominalInstanceInnerNtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eq.exit

bb.n:                                             ; preds = %bb.k
  br i1 %i.al, label %bb.s, label %_RNvXsI_NtNtCsoTR8nlGN3X_18ty_python_semantic5types8instanceNtB5_20NominalInstanceInnerNtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eq.exit

bb.o:                                             ; preds = %bb.k
  br i1 %i.al, label %bb.t, label %_RNvXsI_NtNtCsoTR8nlGN3X_18ty_python_semantic5types8instanceNtB5_20NominalInstanceInnerNtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eq.exit

bb.p:                                             ; preds = %bb.k
  br i1 %i.al, label %bb.u, label %_RNvXsI_NtNtCsoTR8nlGN3X_18ty_python_semantic5types8instanceNtB5_20NominalInstanceInnerNtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eq.exit

bb.q:                                             ; preds = %bb.l
  %i.am = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.an = getelementptr inbounds nuw i8, ptr %0, i64 4
  %i.ao = load i32, ptr %i.an, align 4, !range !557, !alias.scope !20606, !noalias !20607, !noundef !3
  %i.ap = load i32, ptr %i.am, align 4, !range !557, !alias.scope !20607, !noalias !20606, !noundef !3
...
bb.r:                                             ; preds = %bb.m
  ...
  %i.at = load i32, ptr %i.as, align 4, !range !557, !alias.scope !20606, !noalias !20607, !noundef !3
  %i.au = load i32, ptr %i.ar, align 4, !range !557, !alias.scope !20607, !noalias !20606, !noundef !3
...
bb.s:                                             ; preds = %bb.n
  ...
  %i.ay = load i32, ptr %i.ax, align 4, !range !557, !alias.scope !20606, !noalias !20607, !noundef !3
...
bb.m:                                             ; preds = %bb.f
  ...
  %i.bb = tail call noundef zeroext i1 @_RNvXs2_NtNtCs4NRVxsYgnAr_4core5slice3cmpNtNtCskLngH8kgpZI_15ruff_python_ast5nodes12BytesLiteralINtB5_14SlicePartialEqBC_E17equal_same_lengthCsoTR8nlGN3X_18ty_python_semantic(ptr noundef nonnull %i.ba, ptr noundef nonnull %i.ay, i64 noundef %i.t)
  br label %_RNvXs4N_NtCskLngH8kgpZI_15ruff_python_ast5nodesNtB6_22BytesLiteralValueInnerNtNtCs4NRVxsYgnAr_4core3cmp9PartialEq2eq.exit
...
bb.f:                                             ; preds = %bb.e
  ...
  %.val2.i = load i64, ptr %i.s, align 8, !alias.scope !20608, !noalias !20611 ; 3 uses
  %.val3.i = load ptr, ptr %i.r, align 8, !alias.scope !20611, !noalias !20608, !noundef !3 ; 3 uses
  %2 = getelementptr inbounds nuw i8, ptr %1, i64 16
  %.val4.i = load i64, ptr %2, align 8, !alias.scope !20611, !noalias !20608 ; 2 uses
