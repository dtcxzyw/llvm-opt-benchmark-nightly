...
bb.ac:                                            ; preds = %bb.v
  ...
  call void @_RNvNtCs4NRVxsYgnAr_4core9panicking16panic_in_cleanup() #56, !noalias !5056
  unreachable

bb.ad:                                            ; preds = %bb.t, %bb.z, %bb.v
  %eh.lpad-body = phi { ptr, i32 } [ %i.bv, %bb.t ], [ %i.cm, %bb.z ], [ %i.cf, %bb.v ]
  %i.cq = load i64, ptr %0, align 8, !noundef !10
  %i.cr = add i64 %i.cq, 1
...
bb.af:                                            ; preds = %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtCsheqz6YZvxwl_8smallvec8IntoIterATNtNtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraints6NodeIdINtNtB4_6option6OptionNtB1e_13SourceOrderIdEhEj8_EEB1i_.exit.i
  ...
  %i.ct = load i64, ptr %0, align 8, !noundef !10
  %i.cu = add i64 %i.ct, 1
...
.lr.ph:                                           ; preds = %bb.as
  ...
  %i.cy = load i8, ptr %i.cx, align 4, !noundef !10
...
._crit_edge:                                      ; preds = %bb.as, %.lr.ph, %.lr.ph.preheader, %.preheader
  ...
  %i.da = load i64, ptr %.sink8.i.i, align 8, !alias.scope !5058, !noalias !5059, !noundef !10 ; 2 uses
  %i.db = icmp eq i64 %i.da, %.sink.i.i
  br i1 %i.db, label %bb.aj, label %bb.ak, !prof !20
...
.noexc44:                                         ; preds = %bb.aj
  %i.dc = load ptr, ptr %i.p, align 8, !alias.scope !5058, !noalias !5059, !nonnull !10, !noundef !10
  %.pre.i = load i64, ptr %i.al, align 8, !alias.scope !5058, !noalias !5059
  br label %bb.ak
...
bb.ak:                                            ; preds = %.noexc44, %._crit_edge
  ...
  %i.df = load i64, ptr %.sroa.01.0.i, align 8, !alias.scope !5058, !noalias !5059, !noundef !10
  %i.dg = add i64 %i.df, 1
  store i64 %i.dg, ptr %.sroa.01.0.i, align 8, !alias.scope !5058, !noalias !5059
  br label %bb.b
...
.lr.ph187:                                        ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.di = load i64, ptr %.sink8.i, align 8, !noundef !10 ; 2 uses
  %i.dj = icmp eq i64 %i.di, 0
  br i1 %i.dj, label %bb.al, label %bb.am, !prof !20
...
bb.am:                                            ; preds = %.lr.ph187
  ...
  %i.dm = load i64, ptr %0, align 8, !noundef !10
  %i.dn = icmp eq i64 %i.dm, 0
  br i1 %i.dn, label %bb.an, label %bb.ao, !prof !16
...
bb.ap:                                            ; preds = %bb.ar, %bb.an
  %i.dp = landingpad { ptr, i32 }
          cleanup
  %i.dq = load i64, ptr %0, align 8, !noundef !10
  %i.dr = add i64 %i.dq, 1
...
_RNvMs7_NtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraintsNtB5_20ConstraintSetStorage20ordered_source_order.exit: ; preds = %bb.aq, %_RNvYNvMsh_NtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraintsNtB8_6NodeId2orINtNtNtCs4NRVxsYgnAr_4core3ops8function5FnMutTB12_QNtB8_20ConstraintSetStorageB12_EE8call_mutBc_.exit, %bb.ar
  ...
  %i.dv = load i64, ptr %0, align 8, !noundef !10
  %i.dw = add i64 %i.dv, 1
...
bb.as:                                            ; preds = %_RNvMs7_NtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraintsNtB5_20ConstraintSetStorage20ordered_source_order.exit
  ...
  %i.dy = load i64, ptr %i.q, align 8, !alias.scope !5049, !noalias !5050, !noundef !10 ; 4 uses
  %i.dz = icmp ugt i64 %i.dy, 8                   ; 5 uses
  %i.ea = load ptr, ptr %i.p, align 8, !alias.scope !5049, !noalias !5050, !nonnull !10
  %i.eb = load i64, ptr %i.al, align 8, !alias.scope !5049, !noalias !5050
...
bb.a:
  ...
  store i64 0, ptr %i.g, align 8, !alias.scope !5088
...
_RNvXs_NtNtNtCs4NRVxsYgnAr_4core4iter8adapters5chainINtB4_5ChainINtNtB6_3zip3ZipINtNtNtBa_5slice4iter4IterNtNtCsoTR8nlGN3X_18ty_python_semantic5types4TypeEB1f_EBZ_ENtNtNtB8_6traits8iterator8Iterator4nextB1J_.exit.i: ; preds = %bb.c, %_RINvNtNtNtCs4NRVxsYgnAr_4core4iter8adapters5chain17and_then_or_clearINtNtB4_3zip3ZipINtNtNtB8_5slice4iter4IterNtNtCsoTR8nlGN3X_18ty_python_semantic5types4TypeEB1k_ETRB1K_B2D_ENvYB14_NtNtNtB6_6traits8iterator8Iterator4nextEB1O_.exit.i.i
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !5089
  call void @llvm.experimental.noalias.scope.decl(metadata !5090)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !5091
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.b, ptr noundef nonnull readonly align 4 dereferenceable(16) %.pn5.i.i.i, i64 16, i1 false), !noalias !5092
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !5091
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.a, ptr noundef nonnull readonly align 4 dereferenceable(16) %i.t, i64 16, i1 false), !noalias !5093
  %i.u = load ptr, ptr %.sroa.0.0.copyload, align 8, !alias.scope !5090, !noalias !5094, !nonnull !10, !align !11, !noundef !10
  %i.v = load ptr, ptr %i.h, align 8, !alias.scope !5090, !noalias !5094, !nonnull !10, !noundef !10
  %i.w = load ptr, ptr %i.i, align 8, !alias.scope !5090, !noalias !5094, !nonnull !10, !align !11, !noundef !10
...
bb.d:                                             ; preds = %_RNvXs_NtNtNtCs4NRVxsYgnAr_4core4iter8adapters5chainINtB4_5ChainINtNtB6_3zip3ZipINtNtNtBa_5slice4iter4IterNtNtCsoTR8nlGN3X_18ty_python_semantic5types4TypeEB1f_EBZ_ENtNtNtB8_6traits8iterator8Iterator4nextB1J_.exit.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !5091
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !5091
  %i.x = load i32, ptr %i.j, align 8, !noalias !5089, !noundef !10 ; 4 uses
  %i.y = load i32, ptr %i.k, align 4, !noalias !5089, !noundef !10 ; 4 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !5089
  %i.z = icmp eq i32 %i.x, %3
  br i1 %i.z, label %.loopexit78, label %.preheader

.preheader:                                       ; preds = %bb.d
  %i.aa = load i64, ptr %i.g, align 8, !alias.scope !5095, !noalias !5096, !noundef !10 ; 4 uses
  %i.ab = icmp ugt i64 %i.aa, 8                   ; 5 uses
  %i.ac = load ptr, ptr %i.f, align 8, !alias.scope !5095, !noalias !5096, !nonnull !10
  %i.ad = load i64, ptr %i.l, align 8, !alias.scope !5095, !noalias !5096
...
.lr.ph.preheader:                                 ; preds = %.preheader
  ...
  %i.ag = load i8, ptr %i.af, align 4, !noundef !10
...
bb.e:                                             ; preds = %_RINvNtNtNtCs4NRVxsYgnAr_4core4iter8adapters5chain17and_then_or_clearINtNtB4_3zip3ZipINtNtNtB8_5slice4iter4IterNtNtCsoTR8nlGN3X_18ty_python_semantic5types4TypeEB1k_ETRB1K_B2D_ENvYB14_NtNtNtB6_6traits8iterator8Iterator4nextEB1O_.exit.thread.i.i
  %i.ai = load i64, ptr %0, align 8, !noundef !10
  %.not76 = icmp eq i64 %i.ai, 0
  br i1 %.not76, label %bb.f, label %bb.g, !prof !16
...
bb.i:                                             ; preds = %bb.f
  ...
  %i.am = load i64, ptr %i.ak, align 8, !alias.scope !5098, !noalias !5099, !noundef !10 ; 2 uses
  %i.an = load i64, ptr %i.al, align 8, !alias.scope !5098, !noalias !5099, !noundef !10 ; 2 uses
...
.lr.ph.i:                                         ; preds = %bb.i
  ...
  %i.aq = load i64, ptr %i.ap, align 8, !alias.scope !5100, !noalias !5101, !noundef !10
  %i.ar = icmp ugt i64 %i.aq, 8
  %i.as = load ptr, ptr %i.e, align 8, !alias.scope !5100, !noalias !5101, !nonnull !10
...
bb.j:                                             ; preds = %bb.m, %bb.k
  ...
  invoke fastcc void @_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtCsheqz6YZvxwl_8smallvec8IntoIterATNtNtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraints6NodeIdINtNtB4_6option6OptionNtB1e_13SourceOrderIdEhEj8_EEB1i_(ptr noalias noundef nonnull align 8 dereferenceable(120) %i.e) #57
          to label %bb.r unwind label %bb.q, !noalias !5102
...
bb.k:                                             ; preds = %bb.p, %.lr.ph.i
  ...
  store i64 %i.av, ptr %i.ak, align 8, !alias.scope !5098, !noalias !5099
  %i.aw = getelementptr inbounds nuw [12 x i8], ptr %.sink10.i.i.i, i64 %i.au ; 2 uses
  %.sroa.5.sroa.0.0.copyload.i = load i32, ptr %i.aw, align 4, !noalias !5102
  %.sroa.5.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.aw, i64 4
  %.sroa.5.sroa.5.0.copyload.i = load i32, ptr %.sroa.5.sroa.5.0..sroa_idx.i, align 4, !noalias !5102 ; 4 uses
  %i.ax = invoke noundef i32 @_RNvMsh_NtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraintsNtB5_6NodeId3and(i32 noundef %.sroa.0.022.i, ptr noalias noundef nonnull align 8 dereferenceable(688) %i.m, i32 noundef %.sroa.5.sroa.0.0.copyload.i)
          to label %.noexc.i unwind label %bb.j, !noalias !5103 ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.az = invoke fastcc noundef i32 @_RNvMs7_NtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraintsNtB5_20ConstraintSetStorage19intern_source_order(ptr noalias noundef align 8 dereferenceable(688) %i.m, i64 %.sroa.013.0.insert.insert.i.i.i)
          to label %bb.p unwind label %bb.j, !noalias !5103
...
_RNvXsH_Csheqz6YZvxwl_8smallvecINtB5_8IntoIterATNtNtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraints6NodeIdINtNtCs4NRVxsYgnAr_4core6option6OptionNtBL_13SourceOrderIdEhEj8_ENtNtNtNtB1R_4iter6traits8iterator8Iterator4nextBP_.exit.i: ; preds = %bb.p, %bb.i
  ...
  invoke void @_RNvXsG_Csheqz6YZvxwl_8smallvecINtB5_8IntoIterATNtNtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraints6NodeIdINtNtCs4NRVxsYgnAr_4core6option6OptionNtBL_13SourceOrderIdEhEj8_ENtNtNtB1R_3ops4drop4Drop4dropBP_(ptr noalias noundef nonnull align 8 dereferenceable(120) %i.e)
          to label %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtCsheqz6YZvxwl_8smallvec8IntoIterATNtNtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraints6NodeIdINtNtB4_6option6OptionNtB1e_13SourceOrderIdEhEj8_EEB1i_.exit.i unwind label %bb.n, !noalias !5102
...
bb.n:                                             ; preds = %_RNvXsH_Csheqz6YZvxwl_8smallvecINtB5_8IntoIterATNtNtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraints6NodeIdINtNtCs4NRVxsYgnAr_4core6option6OptionNtBL_13SourceOrderIdEhEj8_ENtNtNtNtB1R_4iter6traits8iterator8Iterator4nextBP_.exit.i
  ...
  invoke void @_RNvXsw_Csheqz6YZvxwl_8smallvecINtB5_8SmallVecATNtNtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraints6NodeIdINtNtCs4NRVxsYgnAr_4core6option6OptionNtBL_13SourceOrderIdEhEj8_ENtNtNtB1R_3ops4drop4Drop4dropBP_(ptr noalias noundef nonnull align 8 dereferenceable(120) %i.e)
          to label %bb.r unwind label %bb.o, !noalias !5102

bb.o:                                             ; preds = %bb.n
  %i.bb = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCs4NRVxsYgnAr_4core9panicking16panic_in_cleanup() #56, !noalias !5102
  unreachable
...
bb.r:                                             ; preds = %bb.h, %bb.n, %bb.j
  ...
  %i.be = load i64, ptr %0, align 8, !noundef !10
  %i.bf = add i64 %i.be, 1
...
bb.t:                                             ; preds = %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtCsheqz6YZvxwl_8smallvec8IntoIterATNtNtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraints6NodeIdINtNtB4_6option6OptionNtB1e_13SourceOrderIdEhEj8_EEB1i_.exit.i
  ...
  %i.bh = load i64, ptr %0, align 8, !noundef !10
  %i.bi = add i64 %i.bh, 1
...
.lr.ph:                                           ; preds = %bb.ag
  ...
  %i.bm = load i8, ptr %i.bl, align 4, !noundef !10
...
._crit_edge:                                      ; preds = %bb.ag, %.lr.ph, %.lr.ph.preheader, %.preheader
  ...
  %i.bo = load i64, ptr %.sink8.i.i, align 8, !alias.scope !5104, !noalias !5105, !noundef !10 ; 2 uses
  %i.bp = icmp eq i64 %i.bo, %.sink.i.i
  br i1 %i.bp, label %bb.x, label %bb.y, !prof !20
...
.noexc38:                                         ; preds = %bb.x
  %i.bq = load ptr, ptr %i.f, align 8, !alias.scope !5104, !noalias !5105, !nonnull !10, !noundef !10
  %.pre.i = load i64, ptr %i.l, align 8, !alias.scope !5104, !noalias !5105
  br label %bb.y
...
bb.y:                                             ; preds = %.noexc38, %._crit_edge
  ...
  %i.bt = load i64, ptr %.sroa.01.0.i, align 8, !alias.scope !5104, !noalias !5105, !noundef !10
  %i.bu = add i64 %i.bt, 1
  store i64 %i.bu, ptr %.sroa.01.0.i, align 8, !alias.scope !5104, !noalias !5105
  br label %bb.b
...
.lr.ph175:                                        ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.bw = load i64, ptr %.sink8.i, align 8, !noundef !10 ; 2 uses
  %i.bx = icmp eq i64 %i.bw, 0
  br i1 %i.bx, label %bb.z, label %bb.aa, !prof !20
...
bb.aa:                                            ; preds = %.lr.ph175
  ...
  %.sroa.420.0.copyload = load i32, ptr %.sroa.420.0..sroa_idx, align 4 ; 4 uses
  %i.ca = load i64, ptr %0, align 8, !noundef !10
  %i.cb = icmp eq i64 %i.ca, 0
  br i1 %i.cb, label %bb.ab, label %bb.ac, !prof !16
...
bb.ad:                                            ; preds = %bb.af, %bb.ab
  %i.cd = landingpad { ptr, i32 }
          cleanup
  %i.ce = load i64, ptr %0, align 8, !noundef !10
  %i.cf = add i64 %i.ce, 1
...
_RNvMs7_NtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraintsNtB5_20ConstraintSetStorage20ordered_source_order.exit: ; preds = %bb.ae, %_RNvYNvMsh_NtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraintsNtB8_6NodeId3andINtNtNtCs4NRVxsYgnAr_4core3ops8function5FnMutTB12_QNtB8_20ConstraintSetStorageB12_EE8call_mutBc_.exit, %bb.af
  ...
  %i.cj = load i64, ptr %0, align 8, !noundef !10
  %i.ck = add i64 %i.cj, 1
...
bb.ag:                                            ; preds = %_RNvMs7_NtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraintsNtB5_20ConstraintSetStorage20ordered_source_order.exit
  ...
  %i.cm = load i64, ptr %i.g, align 8, !alias.scope !5095, !noalias !5096, !noundef !10 ; 4 uses
  %i.cn = icmp ugt i64 %i.cm, 8                   ; 5 uses
  %i.co = load ptr, ptr %i.f, align 8, !alias.scope !5095, !noalias !5096, !nonnull !10
  %i.cp = load i64, ptr %i.l, align 8, !alias.scope !5095, !noalias !5096
...
bb.a:
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f)
  %i.g = getelementptr inbounds nuw i8, ptr %i.f, i64 96 ; 5 uses
  store i64 0, ptr %i.g, align 8, !alias.scope !5134
  %.sroa.0.0.copyload = load ptr, ptr %1, align 8 ; 4 uses
  %.sroa.545.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 16
  %.sroa.545.0.copyload = load ptr, ptr %.sroa.545.0..sroa_idx, align 8
  %.sroa.746.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 32
...
_RNvXs_NtNtNtCs4NRVxsYgnAr_4core4iter8adapters5chainINtB4_5ChainINtNtB6_3zip3ZipINtNtNtBa_5slice4iter4IterNtNtCsoTR8nlGN3X_18ty_python_semantic5types4TypeEB1f_EBZ_ENtNtNtB8_6traits8iterator8Iterator4nextB1J_.exit.i: ; preds = %bb.c, %_RINvNtNtNtCs4NRVxsYgnAr_4core4iter8adapters5chain17and_then_or_clearINtNtB4_3zip3ZipINtNtNtB8_5slice4iter4IterNtNtCsoTR8nlGN3X_18ty_python_semantic5types4TypeEB1k_ETRB1K_B2D_ENvYB14_NtNtNtB6_6traits8iterator8Iterator4nextEB1O_.exit.i.i
  ...
  %i.t = getelementptr inbounds nuw [16 x i8], ptr %.sink12.i.sroa.phi.sroa.speculated, i64 %.sink.i
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.0.0.copyload) ]
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !5135
  call void @llvm.experimental.noalias.scope.decl(metadata !5136)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !5137
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.b, ptr noundef nonnull readonly align 4 dereferenceable(16) %.pn5.i.i.i, i64 16, i1 false), !noalias !5138
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !5137
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.a, ptr noundef nonnull readonly align 4 dereferenceable(16) %i.t, i64 16, i1 false), !noalias !5139
  %i.u = load ptr, ptr %.sroa.0.0.copyload, align 8, !alias.scope !5136, !noalias !5140, !nonnull !10, !align !11, !noundef !10
  %i.v = load ptr, ptr %i.h, align 8, !alias.scope !5136, !noalias !5140, !nonnull !10, !noundef !10
  %i.w = load ptr, ptr %i.i, align 8, !alias.scope !5136, !noalias !5140, !nonnull !10, !align !11, !noundef !10
  invoke void @_RNvMs2_NtNtCsoTR8nlGN3X_18ty_python_semantic5types8relationNtB5_19TypeRelationChecker15check_type_pair(ptr noalias noundef nonnull sret([16 x i8]) align 8 captures(address) dereferenceable(16) %i.c, ptr noundef nonnull align 8 %i.u, ptr noundef nonnull %i.v, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(272) %i.w, ptr noalias noundef nonnull readonly align 4 captures(address) dereferenceable(16) %i.b, ptr noalias noundef nonnull readonly align 4 captures(address) dereferenceable(16) %i.a)
          to label %bb.d unwind label %.loopexit
...
bb.d:                                             ; preds = %_RNvXs_NtNtNtCs4NRVxsYgnAr_4core4iter8adapters5chainINtB4_5ChainINtNtB6_3zip3ZipINtNtNtBa_5slice4iter4IterNtNtCsoTR8nlGN3X_18ty_python_semantic5types4TypeEB1f_EBZ_ENtNtNtB8_6traits8iterator8Iterator4nextB1J_.exit.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !5137
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !5137
  %i.x = load i32, ptr %i.j, align 8, !noalias !5135, !noundef !10 ; 4 uses
  %i.y = load i32, ptr %i.k, align 4, !noalias !5135, !noundef !10 ; 4 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !5135
  %i.z = icmp eq i32 %i.x, %3
  br i1 %i.z, label %.loopexit78, label %.preheader

.preheader:                                       ; preds = %bb.d
  %i.aa = load i64, ptr %i.g, align 8, !alias.scope !5141, !noalias !5142, !noundef !10 ; 4 uses
  %i.ab = icmp ugt i64 %i.aa, 8                   ; 5 uses
  %i.ac = load ptr, ptr %i.f, align 8, !alias.scope !5141, !noalias !5142, !nonnull !10
  %i.ad = load i64, ptr %i.l, align 8, !alias.scope !5141, !noalias !5142
  %.sink10.i121 = select i1 %i.ab, ptr %i.ac, ptr %i.f ; 4 uses
  %.sink9.i122 = select i1 %i.ab, i64 %i.ad, i64 %i.aa ; 2 uses
  %.not123 = icmp eq i64 %.sink9.i122, 0
  br i1 %.not123, label %._crit_edge, label %.lr.ph.preheader
...
bb.i:                                             ; preds = %bb.f
  ...
  %i.ak = getelementptr inbounds nuw i8, ptr %i.e, i64 104 ; 2 uses
  %i.al = getelementptr inbounds nuw i8, ptr %i.e, i64 112
  %i.am = load i64, ptr %i.ak, align 8, !alias.scope !5144, !noalias !5145, !noundef !10 ; 2 uses
  %i.an = load i64, ptr %i.al, align 8, !alias.scope !5144, !noalias !5145, !noundef !10 ; 2 uses
  %i.ao = icmp eq i64 %i.am, %i.an
  br i1 %i.ao, label %_RNvXsH_Csheqz6YZvxwl_8smallvecINtB5_8IntoIterATNtNtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraints6NodeIdINtNtCs4NRVxsYgnAr_4core6option6OptionNtBL_13SourceOrderIdEhEj8_ENtNtNtNtB1R_4iter6traits8iterator8Iterator4nextBP_.exit.i, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %bb.i
  %i.ap = getelementptr inbounds nuw i8, ptr %i.e, i64 96
  %i.aq = load i64, ptr %i.ap, align 8, !alias.scope !5146, !noalias !5147, !noundef !10
  %i.ar = icmp ugt i64 %i.aq, 8
  %i.as = load ptr, ptr %i.e, align 8, !alias.scope !5146, !noalias !5147, !nonnull !10
  %.sink10.i.i.i = select i1 %i.ar, ptr %i.as, ptr %i.e
  br label %bb.k
...
bb.j:                                             ; preds = %bb.m, %bb.k
  %i.at = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtCsheqz6YZvxwl_8smallvec8IntoIterATNtNtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraints6NodeIdINtNtB4_6option6OptionNtB1e_13SourceOrderIdEhEj8_EEB1i_(ptr noalias noundef nonnull align 8 dereferenceable(120) %i.e) #57
          to label %bb.r unwind label %bb.q, !noalias !5148
...
bb.k:                                             ; preds = %bb.p, %.lr.ph.i
  ...
  %.sroa.6.021.i = phi i32 [ 0, %.lr.ph.i ], [ %.sroa.011.0.i.i.i, %bb.p ] ; 4 uses
  %i.av = add i64 %i.au, 1                        ; 3 uses
  store i64 %i.av, ptr %i.ak, align 8, !alias.scope !5144, !noalias !5145
  %i.aw = getelementptr inbounds nuw [12 x i8], ptr %.sink10.i.i.i, i64 %i.au ; 2 uses
  %.sroa.5.sroa.0.0.copyload.i = load i32, ptr %i.aw, align 4, !noalias !5148
  %.sroa.5.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.aw, i64 4
  %.sroa.5.sroa.5.0.copyload.i = load i32, ptr %.sroa.5.sroa.5.0..sroa_idx.i, align 4, !noalias !5148 ; 4 uses
  %i.ax = invoke noundef i32 @_RNvMsh_NtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraintsNtB5_6NodeId3and(i32 noundef %.sroa.0.022.i, ptr noalias noundef nonnull align 8 dereferenceable(688) %i.m, i32 noundef %.sroa.5.sroa.0.0.copyload.i)
          to label %.noexc.i unwind label %bb.j, !noalias !5149 ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  %.sroa.013.0.insert.insert.i.i.i = or disjoint i64 %.sroa.414.0.insert.shift.i.i.i, %.sroa.013.0.insert.ext.i.i.i
  %i.az = invoke fastcc noundef i32 @_RNvMs7_NtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraintsNtB5_20ConstraintSetStorage19intern_source_order(ptr noalias noundef align 8 dereferenceable(688) %i.m, i64 %.sroa.013.0.insert.insert.i.i.i)
          to label %bb.p unwind label %bb.j, !noalias !5149

_RNvXsH_Csheqz6YZvxwl_8smallvecINtB5_8IntoIterATNtNtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraints6NodeIdINtNtCs4NRVxsYgnAr_4core6option6OptionNtBL_13SourceOrderIdEhEj8_ENtNtNtNtB1R_4iter6traits8iterator8Iterator4nextBP_.exit.i: ; preds = %bb.p, %bb.i
  %.sroa.6.0.lcssa.i = phi i32 [ 0, %bb.i ], [ %.sroa.011.0.i.i.i, %bb.p ]
  %.sroa.0.0.lcssa.i = phi i32 [ %2, %bb.i ], [ %i.ax, %bb.p ]
  invoke void @_RNvXsG_Csheqz6YZvxwl_8smallvecINtB5_8IntoIterATNtNtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraints6NodeIdINtNtCs4NRVxsYgnAr_4core6option6OptionNtBL_13SourceOrderIdEhEj8_ENtNtNtB1R_3ops4drop4Drop4dropBP_(ptr noalias noundef nonnull align 8 dereferenceable(120) %i.e)
          to label %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtCsheqz6YZvxwl_8smallvec8IntoIterATNtNtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraints6NodeIdINtNtB4_6option6OptionNtB1e_13SourceOrderIdEhEj8_EEB1i_.exit.i unwind label %bb.n, !noalias !5148

bb.n:                                             ; preds = %_RNvXsH_Csheqz6YZvxwl_8smallvecINtB5_8IntoIterATNtNtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraints6NodeIdINtNtCs4NRVxsYgnAr_4core6option6OptionNtBL_13SourceOrderIdEhEj8_ENtNtNtNtB1R_4iter6traits8iterator8Iterator4nextBP_.exit.i
  %i.ba = landingpad { ptr, i32 }
          cleanup
  invoke void @_RNvXsw_Csheqz6YZvxwl_8smallvecINtB5_8SmallVecATNtNtNtCsoTR8nlGN3X_18ty_python_semantic5types11constraints6NodeIdINtNtCs4NRVxsYgnAr_4core6option6OptionNtBL_13SourceOrderIdEhEj8_ENtNtNtB1R_3ops4drop4Drop4dropBP_(ptr noalias noundef nonnull align 8 dereferenceable(120) %i.e)
          to label %bb.r unwind label %bb.o, !noalias !5148

bb.o:                                             ; preds = %bb.n
  %i.bb = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCs4NRVxsYgnAr_4core9panicking16panic_in_cleanup() #56, !noalias !5148
  unreachable
