...
.lr.ph.i:                                         ; preds = %bb.b, %_RNCNCNvNtNtNtNtCsEhZmuQNqkz_11ruff_linter5rules11pep8_naming5rules30error_suffix_on_exception_name30error_suffix_on_exception_name00Bd_.exit.backedge.i
  ...
  %i.j = load i32, ptr %i.h, align 8, !range !102, !noalias !10760, !noundef !6
...
bb.c:                                             ; preds = %.lr.ph.i
  ...
  %i.n = load i8, ptr %i.m, align 1, !range !758, !alias.scope !10763, !noalias !10760, !noundef !6 ; 3 uses
  %i.o = getelementptr inbounds nuw i8, ptr %i.h, i64 16
  %i.p = load i64, ptr %i.o, align 8, !alias.scope !10763, !noalias !10760, !noundef !6
  ...
  %i.v = load ptr, ptr %i.l, align 8, !alias.scope !10763, !noalias !10760
...
.split.i:                                         ; preds = %bb.d, %bb.c
  %i.ah = tail call noundef zeroext i1 @_RNvMNtCs4NRVxsYgnAr_4core5sliceSh9ends_withCsEhZmuQNqkz_11ruff_linter(ptr noalias noundef nonnull readonly captures(address, read_provenance) %.sroa.01.0.i.i.i, i64 noundef %.sroa.0.0.i.i.i, ptr noalias noundef nonnull readonly captures(address, read_provenance) @30, i64 noundef 5), !noalias !10760
...
bb.h:                                             ; preds = %bb.g
  tail call void @_RNvCs9wFQrvczXsK_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #47, !noalias !10766
  %i.ak = tail call noundef ptr @_RNvCs9wFQrvczXsK_7___rustc12___rust_alloc(i64 noundef %4, i64 noundef range(i64 1, -9223372036854775807) 1) #47, !noalias !10766 ; 3 uses
...
bb.d:                                             ; preds = %bb.c
  %i.f = load i8, ptr %1, align 1, !noalias !10769, !noundef !6
  %i.g = zext i8 %i.f to i64
  %i.h = getelementptr inbounds nuw i8, ptr @454, i64 %i.g
  %i.i = load i8, ptr %i.h, align 1, !noalias !10769, !noundef !6
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.m = load i8, ptr %i.l, align 1, !noalias !10772, !noundef !6 ; 3 uses
...
bb.j:                                             ; preds = %bb.i
  tail call void @_RNvCs9wFQrvczXsK_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #47, !noalias !10775
  %i.z = tail call noundef ptr @_RNvCs9wFQrvczXsK_7___rustc12___rust_alloc(i64 noundef %2, i64 noundef range(i64 1, -9223372036854775807) 1) #47, !noalias !10775 ; 3 uses
...
bb.m:                                             ; preds = %bb.l
  tail call void @_RNvCs9wFQrvczXsK_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #47, !noalias !10778
  %i.ad = tail call noundef ptr @_RNvCs9wFQrvczXsK_7___rustc12___rust_alloc(i64 noundef %4, i64 noundef range(i64 1, -9223372036854775807) 1) #47, !noalias !10778 ; 3 uses
...
bb.s:                                             ; preds = %_RNvMs4_NtCscdodAO9FK5_5alloc7raw_vecNtB5_11RawVecInner15try_allocate_inCsEhZmuQNqkz_11ruff_linter.exit14.thread46
  ...
  %i.ar = load i8, ptr %i.aq, align 4, !range !7797, !noundef !6 ; 2 uses
