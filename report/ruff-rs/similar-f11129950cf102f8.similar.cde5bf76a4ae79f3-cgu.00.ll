...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %.sroa.7.1.peel = phi i64 [ %.sroa.047.0219, %bb.j ], [ %i.ao, %bb.k ] ; 2 uses
  %i.ap = icmp eq i64 %.sroa.047.0219, 0
  br i1 %i.ap, label %._crit_edge307, label %bb.m

bb.m:                                             ; preds = %bb.l
  %.pre324 = add i64 %i.ad, %.sroa.047.0219       ; 3 uses
  %i.aq = icmp ult i64 %.pre324, %i.k
  br i1 %i.aq, label %bb.n, label %.loopexit254
...
._crit_edge307:                                   ; preds = %bb.l
  br i1 %i.ah, label %bb.o, label %.loopexit255

bb.o:                                             ; preds = %._crit_edge307
  %i.au = load i64, ptr %i.ai, align 8, !noundef !10
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %bb.n
  %.sroa.04.0.peel = phi i64 [ %i.au, %bb.o ], [ %i.at, %bb.n ] ; 6 uses
...
bb.r:                                             ; preds = %bb.q, %bb.p
  %.sroa.04.1.peel = phi i64 [ %i.bc, %bb.q ], [ %.sroa.04.0.peel, %bb.p ] ; 2 uses
  %i.bd = add i64 %.sroa.047.0219, %i.h           ; 3 uses
  %i.be = icmp ult i64 %i.bd, %i.k
  br i1 %i.be, label %bb.s, label %.loopexit256
...
bb.u:                                             ; preds = %bb.t
  ...
  br i1 %i.bi, label %bb.v, label %.loopexit257
...
bb.aa:                                            ; preds = %bb.z, %.lr.ph215.preheader
  %.sroa.7160.1.peel = phi i64 [ %.sroa.047.0219, %.lr.ph215.preheader ], [ %i.br, %bb.z ] ; 2 uses
  %.sroa.12.1.peel = phi i1 [ true, %.lr.ph215.preheader ], [ false, %bb.z ]
  %i.bs = icmp eq i64 %.sroa.047.0219, 0
  br i1 %i.bs, label %._crit_edge311, label %bb.ab

bb.ab:                                            ; preds = %bb.aa
  %.pre316 = add i64 %i.ae, %.sroa.047.0219       ; 3 uses
  %i.bt = icmp ult i64 %.pre316, %i.t
  br i1 %i.bt, label %bb.ac, label %.loopexit279
...
._crit_edge311:                                   ; preds = %bb.aa
  br i1 %i.aj, label %bb.ad, label %.loopexit280
...
bb.ae:                                            ; preds = %bb.ad, %bb.ac
  %.sroa.014.0.peel = phi i64 [ %i.bx, %bb.ad ], [ %i.bw, %bb.ac ] ; 5 uses
...
bb.ag:                                            ; preds = %bb.af, %bb.ae
  %.sroa.020.0.peel = phi i64 [ %i.cf, %bb.af ], [ %i.by, %bb.ae ]
  %.sroa.014.1.peel = phi i64 [ %i.ce, %bb.af ], [ %.sroa.014.0.peel, %bb.ae ] ; 3 uses
  %i.cg = add i64 %.sroa.047.0219, %i.q           ; 3 uses
  %i.ch = icmp ult i64 %i.cg, %i.t
  br i1 %i.ch, label %bb.ah, label %.loopexit281
...
bb.aj:                                            ; preds = %bb.ai
  ...
  br i1 %i.cl, label %bb.ak, label %.loopexit282
...
._crit_edge309:                                   ; preds = %bb.ao, %bb.as
  %i.cu = icmp ult i64 %.pre314, %i.t
  br i1 %i.cu, label %bb.at, label %.loopexit279

bb.aq:                                            ; preds = %bb.ao
  %i.cv = icmp ult i64 %.pre314, %i.t
  br i1 %i.cv, label %bb.ar, label %.loopexit277

bb.ar:                                            ; preds = %bb.aq
  %i.cw = add i64 %i.q, %.sroa.7160.0212          ; 4 uses
  %i.cx = icmp ult i64 %i.cw, %i.t
  br i1 %i.cx, label %bb.as, label %.loopexit278

.loopexit277:                                     ; preds = %bb.aq
...
bb.as:                                            ; preds = %bb.ar
  ...
  br i1 %i.dc, label %bb.ap, label %._crit_edge309

.loopexit278:                                     ; preds = %bb.ar
...
bb.at:                                            ; preds = %._crit_edge309
  %i.dd = getelementptr inbounds nuw [8 x i8], ptr %i.w, i64 %.pre314
  %i.de = load i64, ptr %i.dd, align 8, !noundef !10
  %i.df = add i64 %i.de, 1
  br label %bb.au

.loopexit279:                                     ; preds = %bb.ab, %._crit_edge309
  %.lcssa240 = phi i64 [ %.pre314, %._crit_edge309 ], [ %.pre316, %bb.ab ]
...
bb.au:                                            ; preds = %bb.av, %bb.at
  %.sroa.014.0 = phi i64 [ %i.dk, %bb.av ], [ %i.df, %bb.at ] ; 5 uses
...
.loopexit280:                                     ; preds = %._crit_edge311, %bb.ap
  %.lcssa241 = phi i64 [ %.pre-phi313, %bb.ap ], [ %i.r, %._crit_edge311 ]
...
bb.aw:                                            ; preds = %bb.au, %bb.ax
  %.sroa.020.0 = phi i64 [ %i.dr, %bb.ax ], [ %i.dg, %bb.au ]
  %.sroa.014.1 = phi i64 [ %i.dq, %bb.ax ], [ %.sroa.014.0, %bb.au ] ; 3 uses
  %i.dl = add i64 %i.cp, %i.q                     ; 3 uses
  %i.dm = icmp ult i64 %i.dl, %i.t
  br i1 %i.dm, label %bb.ay, label %.loopexit281
...
.loopexit281:                                     ; preds = %bb.ag, %bb.aw
  %.lcssa242 = phi i64 [ %i.dl, %bb.aw ], [ %i.cg, %bb.ag ]
...
bb.bb:                                            ; preds = %bb.az
  ...
  br i1 %i.dv, label %bb.bc, label %.loopexit282
...
.loopexit282:                                     ; preds = %bb.aj, %bb.bb
  %.lcssa249 = phi i64 [ %i.du, %bb.bb ], [ %i.ck, %bb.aj ]
...
._crit_edge305:                                   ; preds = %bb.bd, %bb.bh
  ...
  br i1 %i.ec, label %bb.bi, label %.loopexit254

bb.bf:                                            ; preds = %bb.bd
  %i.ed = icmp ult i64 %.pre322, %i.k
  br i1 %i.ed, label %bb.bg, label %.loopexit252

bb.bg:                                            ; preds = %bb.bf
  %i.ee = add i64 %i.h, %.sroa.7.0208             ; 4 uses
  %i.ef = icmp ult i64 %i.ee, %i.k
  br i1 %i.ef, label %bb.bh, label %.loopexit253

.loopexit252:                                     ; preds = %bb.bf
...
bb.bh:                                            ; preds = %bb.bg
  ...
  br i1 %i.ek, label %bb.be, label %._crit_edge305

.loopexit253:                                     ; preds = %bb.bg
...
.loopexit254:                                     ; preds = %bb.m, %._crit_edge305
...
bb.bj:                                            ; preds = %bb.bk, %bb.bi
  %.sroa.04.0 = phi i64 [ %i.et, %bb.bk ], [ %i.en, %bb.bi ] ; 6 uses
...
.loopexit255:                                     ; preds = %._crit_edge307, %bb.be
  %.lcssa226 = phi i64 [ %.pre-phi321, %bb.be ], [ %i.i, %._crit_edge307 ]
...
bb.bl:                                            ; preds = %bb.bj, %bb.bm
  %.sroa.04.1 = phi i64 [ %i.ez, %bb.bm ], [ %.sroa.04.0, %bb.bj ] ; 2 uses
  %i.eu = add i64 %i.bm, %i.h                     ; 3 uses
  %i.ev = icmp ult i64 %i.eu, %i.k
  br i1 %i.ev, label %bb.bn, label %.loopexit256
...
.loopexit256:                                     ; preds = %bb.r, %bb.bl
  %.lcssa232 = phi i64 [ %i.eu, %bb.bl ], [ %i.bd, %bb.r ]
...
bb.bq:                                            ; preds = %bb.bp
  ...
  br i1 %i.fd, label %bb.br, label %.loopexit257
...
.loopexit257:                                     ; preds = %bb.u, %bb.bq
  %.lcssa235 = phi i64 [ %i.fc, %bb.bq ], [ %i.bh, %bb.u ]
...
.loopexit258:                                     ; preds = %bb.v, %bb.br
  ...
  %.lcssa229 = phi i64 [ %i.eo, %bb.br ], [ %i.av, %bb.v ]
  %i.fh = add i64 %.sroa.04.0.lcssa231, %2
  %i.fi = add i64 %.lcssa229, %5
  br label %._crit_edge221.sink.split

._crit_edge221.sink.split:                        ; preds = %.loopexit258, %.loopexit283
  %.sink480 = phi i64 [ %i.dz, %.loopexit283 ], [ %i.fh, %.loopexit258 ]
  %.sink478 = phi i64 [ %i.ea, %.loopexit283 ], [ %i.fi, %.loopexit258 ]
  %i.fj = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i64 %.sink480, ptr %i.fj, align 8
  %i.fk = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i64 %.sink478, ptr %i.fk, align 8
