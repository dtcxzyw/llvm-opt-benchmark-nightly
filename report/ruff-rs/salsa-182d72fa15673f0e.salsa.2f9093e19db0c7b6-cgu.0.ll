...
.lr.ph.i:                                         ; preds = %bb.ab, %.lr.ph.i
  %.sroa.19.111.i = phi ptr [ %i.ji, %.lr.ph.i ], [ %.sroa.19.0.i, %bb.ab ]
  %.sroa.5.110.i = phi ptr [ %i.jm, %.lr.ph.i ], [ %.sroa.5.0.i, %bb.ab ] ; 4 uses
  %.sroa.11.19.i = phi i64 [ %i.jl, %.lr.ph.i ], [ %.sroa.11.0.i, %bb.ab ] ; 2 uses
  %i.ir = getelementptr i8, ptr %.sroa.5.110.i, i64 8
  %.val.i = load ptr, ptr %i.ir, align 8, !alias.scope !3373, !noalias !3371, !nonnull !3, !noundef !3
  %i.is = getelementptr i8, ptr %.sroa.5.110.i, i64 32
  ...
  %i.ji = getelementptr inbounds i8, ptr %.sroa.19.111.i, i64 -40 ; 3 uses
end_hunk_2
