...
bb.az:                                            ; preds = %bb.bi, %.lr.ph99.i
  ...
  %i.ih = phi ptr [ %i.de, %.lr.ph99.i ], [ %i.ko, %bb.bi ] ; 3 uses
  %i.ii = phi i64 [ %i.dg, %.lr.ph99.i ], [ %i.kr, %bb.bi ] ; 8 uses
  %.sroa.01.098.i = phi i64 [ 0, %.lr.ph99.i ], [ %i.kp, %bb.bi ] ; 9 uses
...
._crit_edge.i.loopexit.split.loop.exit128:        ; preds = %.lr.ph.i
  %i.jb = add nuw nsw i64 %.sroa.01.186.i83140, 2
  br label %._crit_edge.i

._crit_edge.i:                                    ; preds = %.lr.ph84, %.lr.ph84.preheader, %._crit_edge.i.loopexit.split.loop.exit128, %.lr.ph.preheader.i, %.preheader.i
  %.lcssa84.i = phi i64 [ %i.ir, %.preheader.i ], [ %i.ir, %.lr.ph.preheader.i ], [ %i.jh, %._crit_edge.i.loopexit.split.loop.exit128 ], [ %i.iv, %.lr.ph84.preheader ], [ %i.iv, %.lr.ph84 ]
  %.sroa.018.0.lcssa.i = phi i64 [ %i.ir, %.preheader.i ], [ %i.ir, %.lr.ph.preheader.i ], [ %i.jb, %._crit_edge.i.loopexit.split.loop.exit128 ], [ %i.ii, %.lr.ph84.preheader ], [ %i.ii, %.lr.ph84 ]
  %.sroa.01.1.lcssa.i = phi i64 [ %.sroa.01.098.i, %.preheader.i ], [ %.sroa.01.098.i, %.lr.ph.preheader.i ], [ %i.jh, %._crit_edge.i.loopexit.split.loop.exit128 ], [ %i.iv, %.lr.ph84.preheader ], [ %i.iv, %.lr.ph84 ]
  %i.jc = getelementptr inbounds nuw [80 x i8], ptr %i.ik, i64 %.lcssa84.i
  %.sroa.020.0.le.i = getelementptr inbounds nuw i8, ptr %i.jc, i64 40 ; 9 uses
  %i.jd = load i64, ptr %i.r, align 8, !alias.scope !117, !noundef !4 ; 2 uses
  %i.je = icmp ult i64 %i.jd, 384307168202282326
  call void @llvm.assume(i1 %i.je)
  %i.jf = icmp ult i64 %.sroa.011.097.i, %i.jd
  br i1 %i.jf, label %bb.bd, label %bb.bc

.lr.ph.i:                                         ; preds = %.lr.ph84.preheader, %.lr.ph84
  %i.jg = phi i64 [ %i.jm, %.lr.ph84 ], [ %i.ja, %.lr.ph84.preheader ] ; 3 uses
  %i.jh = phi i64 [ %i.jg, %.lr.ph84 ], [ %i.it, %.lr.ph84.preheader ] ; 3 uses
  %.sroa.01.186.i83140 = phi i64 [ %i.jh, %.lr.ph84 ], [ %.sroa.01.098.i, %.lr.ph84.preheader ]
  %i.ji = getelementptr inbounds nuw [80 x i8], ptr %i.ik, i64 %i.jg
  %i.jj = getelementptr inbounds nuw i8, ptr %i.ji, i64 72
  %i.jk = load i8, ptr %i.jj, align 8, !range !7, !noundef !4
...
bb.bc:                                            ; preds = %bb.bf, %._crit_edge.i
  ...
  %i.jn = add i64 %.sroa.011.097.i, 1
  br label %bb.bi

bb.bd:                                            ; preds = %._crit_edge.i
  %i.jo = load ptr, ptr %i.x, align 8, !alias.scope !117, !nonnull !4, !noundef !4
  %i.jp = getelementptr inbounds nuw [24 x i8], ptr %i.jo, i64 %.sroa.011.097.i ; 4 uses
  %.sroa.021.0.copyload.i = load i64, ptr %i.jp, align 8 ; 2 uses
  %.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.jp, i64 8
  %.sroa.5.sroa.0.0.copyload.i = load ptr, ptr %.sroa.5.0..sroa_idx.i, align 8 ; 11 uses
  %.sroa.5.sroa.4.0..sroa.5.0..sroa_idx.sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.jp, i64 16
...
bb.be:                                            ; preds = %bb.bd
  %i.jq = icmp ult i64 %.sroa.5.sroa.4.0.copyload.i, 115292150460684698
...
.lr.ph95.i:                                       ; preds = %bb.be
  ...
  %i.jr = icmp samesign ult i64 %.sroa.5.sroa.4.0.copyload.i, 8
  br i1 %i.jr, label %.epil.preheader, label %.lr.ph95.i.new
...
.epil.preheader:                                  ; preds = %._crit_edge96.i.loopexit.unr-lcssa, %.lr.ph95.i
  %.sroa.024.093.i.epil.init = phi i64 [ 0, %.lr.ph95.i ], [ %i.kn, %._crit_edge96.i.loopexit.unr-lcssa ]
  %lcmp.mod148 = icmp ne i64 %xtraiter, 0
  call void @llvm.assume(i1 %lcmp.mod148)
  br label %bb.bg

bb.bg:                                            ; preds = %bb.bg, %.epil.preheader
  %.sroa.024.093.i.epil = phi i64 [ %.sroa.024.093.i.epil.init, %.epil.preheader ], [ %i.ju, %bb.bg ] ; 2 uses
  %epil.iter = phi i64 [ 0, %.epil.preheader ], [ %epil.iter.next, %bb.bg ]
  %i.js = getelementptr inbounds nuw [80 x i8], ptr %.sroa.5.sroa.0.0.copyload.i, i64 %.sroa.024.093.i.epil
  %i.jt = getelementptr inbounds nuw i8, ptr %i.js, i64 40
  call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.jt, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.020.0.le.i, i64 32, i1 false)
  %i.ju = add nuw nsw i64 %.sroa.024.093.i.epil, 1
...
._crit_edge96.i:                                  ; preds = %._crit_edge96.i.loopexit.unr-lcssa, %bb.bg, %bb.be
  %i.jv = load ptr, ptr %i.m, align 8, !alias.scope !117, !nonnull !4, !noundef !4
  %i.jw = getelementptr inbounds nuw i8, ptr %i.jv, i64 520
  ...
  call void @_RNvMNtNtCs2KzzoC5ewhj_8markdown4util8edit_mapNtB2_7EditMap3add(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.jw, i64 noundef %.sroa.018.0.lcssa.i, i64 noundef 0, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(24) %i.f)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f), !noalias !117
  br label %bb.bf

bb.bh:                                            ; preds = %bb.bh, %.lr.ph95.i.new
  %.sroa.024.093.i = phi i64 [ 0, %.lr.ph95.i.new ], [ %i.kn, %bb.bh ] ; 9 uses
  ...
  %i.ke = getelementptr inbounds nuw i8, ptr %i.kd, i64 280
  ...
  %i.kg = getelementptr inbounds nuw i8, ptr %i.kf, i64 360
  ...
  %i.ki = getelementptr inbounds nuw i8, ptr %i.kh, i64 440
  ...
  %i.kk = getelementptr inbounds nuw i8, ptr %i.kj, i64 520
  ...
  %i.kl = getelementptr inbounds nuw [80 x i8], ptr %.sroa.5.sroa.0.0.copyload.i, i64 %.sroa.024.093.i
  %i.km = getelementptr inbounds nuw i8, ptr %i.kl, i64 600
  call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.km, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.020.0.le.i, i64 32, i1 false)
  %i.kn = add nuw nsw i64 %.sroa.024.093.i, 8     ; 2 uses
...
bb.bi:                                            ; preds = %bb.bc, %bb.ba, %bb.az
  ...
  %i.ko = phi ptr [ %i.ih, %bb.ba ], [ %.pre.i, %bb.bc ], [ %i.ih, %bb.az ] ; 3 uses
  %.sroa.011.1.i = phi i64 [ %.sroa.011.097.i, %bb.ba ], [ %i.jn, %bb.bc ], [ %.sroa.011.097.i, %bb.az ] ; 2 uses
  %.sroa.01.2.i = phi i64 [ %.sroa.01.098.i, %bb.ba ], [ %.sroa.01.1.lcssa.i, %bb.bc ], [ %.sroa.01.098.i, %bb.az ]
  %i.kp = add i64 %.sroa.01.2.i, 1                ; 2 uses
  %i.kq = getelementptr inbounds nuw i8, ptr %i.ko, i64 488
  %i.kr = load i64, ptr %i.kq, align 8, !noundef !4 ; 3 uses
  %i.ks = icmp ult i64 %i.kr, 115292150460684698
  call void @llvm.assume(i1 %i.ks)
  %i.kt = icmp ult i64 %i.kp, %i.kr
  br i1 %i.kt, label %bb.az, label %._crit_edge100.i
...
bb.bk:                                            ; preds = %bb.g
  %i.ku = icmp sgt i64 %i.p, -1
  br i1 %i.ku, label %bb.bl, label %common.resume.i
