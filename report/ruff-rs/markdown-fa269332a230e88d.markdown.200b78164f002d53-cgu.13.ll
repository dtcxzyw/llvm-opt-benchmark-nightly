...
begin_hunk_0_@_RNvNtNtCs2KzzoC5ewhj_8markdown9construct8document5start:bb.a
  ...
  tail call void @_RNvCs9wFQrvczXsK_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #17, !noalias !89
  %i.r = tail call noundef align 8 dereferenceable_or_null(664) ptr @_RNvCs9wFQrvczXsK_7___rustc12___rust_alloc(i64 noundef 664, i64 noundef 8) #17, !noalias !89 ; 4 uses
  %i.s = icmp eq ptr %i.r, null
  br i1 %i.s, label %bb.b, label %_RNvMNtCscdodAO9FK5_5alloc5boxedINtB2_3BoxNtNtCs2KzzoC5ewhj_8markdown9tokenizer9TokenizerE3newBH_.exit, !prof !11
...
bb.e:                                             ; preds = %_RNvMNtCscdodAO9FK5_5alloc5boxedINtB2_3BoxNtNtCs2KzzoC5ewhj_8markdown9tokenizer9TokenizerE3newBH_.exit
  invoke fastcc void @_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtCs2KzzoC5ewhj_8markdown9tokenizer9TokenizerEBF_(ptr noalias noundef nonnull align 8 dereferenceable(664) %.val)
          to label %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtNtCscdodAO9FK5_5alloc5boxed3BoxNtNtCs2KzzoC5ewhj_8markdown9tokenizer9TokenizerEEB1d_.exit.i unwind label %.body, !inline_history !88

.body:                                            ; preds = %bb.e
  %i.x = landingpad { ptr, i32 }
          cleanup
  tail call void @_RNvCs9wFQrvczXsK_7___rustc14___rust_dealloc(ptr noundef nonnull %.val, i64 noundef 664, i64 noundef 8) #17, !inline_history !88
...
bb.a:
  ...
  br i1 %.not41, label %bb.c, label %bb.b, !prof !11
...
bb.e:                                             ; preds = %bb.d, %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtCs2KzzoC5ewhj_8markdown5state5StateEBF_.exit
  ...
  %i.s = load i64, ptr %i.r, align 8, !alias.scope !113, !noalias !114, !noundef !4 ; 3 uses
  %i.t = load i64, ptr %i.q, align 8, !range !10, !alias.scope !113, !noalias !114, !noundef !4
...
bb.f:                                             ; preds = %bb.e
  invoke void @_RNvMs3_NtCscdodAO9FK5_5alloc7raw_vecINtB5_6RawVecINtNtCs4NRVxsYgnAr_4core6option6OptionINtNtB7_3vec3VecNtNtCs2KzzoC5ewhj_8markdown5event5EventEEE8grow_oneB1H_(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.q)
          to label %bb.i unwind label %bb.g, !noalias !114
...
bb.i:                                             ; preds = %bb.f, %bb.e
  ...
  %i.y = load ptr, ptr %i.x, align 8, !alias.scope !113, !noalias !114, !nonnull !4, !noundef !4
  ...
  %i.aa = add i64 %i.s, 1
  store i64 %i.aa, ptr %i.r, align 8, !alias.scope !113, !noalias !114
  ...
  %i.ak = load i64, ptr %i.o, align 8, !range !6, !alias.scope !115, !noundef !4
...
bb.k:                                             ; preds = %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtNtB4_6option6OptionNtNtCs2KzzoC5ewhj_8markdown5state5StateEEB11_.exit
  ...
  %4 = load i8, ptr %3, align 1, !range !8, !noundef !4 ; 3 uses
...
.peel.next.preheader:                             ; preds = %switch.early.test
  ...
  %7 = load i8, ptr %6, align 1, !range !8, !noundef !4 ; 3 uses
...
.peel.next:                                       ; preds = %switch.early.test138
  ...
  %i.ax = load i8, ptr %i.aw, align 1, !range !8, !noundef !4 ; 3 uses
...
bb.l:                                             ; preds = %bb.n, %._crit_edge.thread, %._crit_edge
  ...
  %i.bi = load i8, ptr %i.bh, align 8, !range !7, !noundef !4
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.bw = load i8, ptr %i.bv, align 1, !range !8, !noundef !4
...
bb.p:                                             ; preds = %bb.n, %bb.n
  ...
  %i.ca = load i8, ptr %i.bz, align 8, !range !7, !noundef !4
...
bb.r:                                             ; preds = %bb.p
  ...
  %i.ci = load i8, ptr %i.ch, align 8, !range !7, !noundef !4
...
bb.t:                                             ; preds = %bb.l
  ...
  %i.cp = load i8, ptr %i.co, align 8, !range !7, !noundef !4
...
bb.u:                                             ; preds = %bb.q
  ...
  %i.cr = load i64, ptr %i.h, align 8, !range !3, !alias.scope !116, !noundef !4
...
bb.v:                                             ; preds = %bb.q, %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtNtB4_6result6ResultuNtNtCs2KzzoC5ewhj_8markdown7message7MessageEEB12_.exit
  ...
  %i.cu = load i8, ptr %i.ct, align 8, !range !7, !noundef !4
...
bb.ab:                                            ; preds = %bb.y
  ...
  %i.da = load ptr, ptr %i.m, align 8, !alias.scope !117, !align !5, !noundef !4 ; 5 uses
  %.not.i = icmp eq ptr %i.da, null
  br i1 %.not.i, label %.noexc48, label %.preheader74.i, !prof !11
...
._crit_edge100.i:                                 ; preds = %bb.bj, %.preheader74.i
  ...
  %i.di = load ptr, ptr %i.dh, align 8, !alias.scope !117, !nonnull !4, !noundef !4
  %i.dj = getelementptr inbounds nuw i8, ptr %1, i64 488 ; 6 uses
  %i.dk = load i64, ptr %i.dj, align 8, !alias.scope !117, !noundef !4 ; 3 uses
...
_RNvNtNtCs2KzzoC5ewhj_8markdown4util4skip2to.exit.i: ; preds = %bb.ac, %.lr.ph.i.i.i
  ...
  %.pre124.i = load i64, ptr %i.dj, align 8, !alias.scope !117 ; 4 uses
...
._crit_edge105.i:                                 ; preds = %bb.af, %_RNvNtNtCs2KzzoC5ewhj_8markdown4util4skip2to.exit66.i, %_RNvNtNtCs2KzzoC5ewhj_8markdown4util4skip2to.exit.i, %._crit_edge100.i
  ...
  %i.dr = load ptr, ptr %i.dh, align 8, !alias.scope !117, !nonnull !4, !noundef !4
  %i.ds = load ptr, ptr %i.m, align 8, !alias.scope !117, !nonnull !4, !noundef !4
  ...
  %i.dv = load i64, ptr %i.r, align 8, !alias.scope !117, !noundef !4 ; 2 uses
...
.lr.ph104.i:                                      ; preds = %_RNvNtNtCs2KzzoC5ewhj_8markdown4util4skip2to.exit.i, %_RNvNtNtCs2KzzoC5ewhj_8markdown4util4skip2to.exit66.i
  ...
  %i.dz = load ptr, ptr %i.dh, align 8, !alias.scope !117, !nonnull !4, !noundef !4 ; 2 uses
  %i.ea = getelementptr inbounds nuw [80 x i8], ptr %i.dz, i64 %.sroa.028.0103.i ; 2 uses
  %i.eb = load i64, ptr %i.ea, align 8, !range !14, !noundef !4
...
_RNvNtNtCs2KzzoC5ewhj_8markdown4util4skip2to.exit66.loopexit.i: ; preds = %bb.ae, %.lr.ph.i.i62.i
  ...
  %.pre125.i = load i64, ptr %i.dj, align 8, !alias.scope !117
...
bb.af:                                            ; preds = %.lr.ph104.i
  ...
  %i.el = load i8, ptr %i.ek, align 8, !range !118, !noundef !4
...
.noexc54:                                         ; preds = %bb.ah, %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtNtCscdodAO9FK5_5alloc3vec3VecNtNtCs2KzzoC5ewhj_8markdown5event5EventEEB1b_.exit.i, %._crit_edge105.i
  ...
  %i.em = load ptr, ptr %i.m, align 8, !alias.scope !117, !nonnull !4, !noundef !4 ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !119)
  call void @llvm.experimental.noalias.scope.decl(metadata !120)
  %i.en = getelementptr inbounds nuw i8, ptr %i.em, i64 560 ; 2 uses
  %i.eo = load i64, ptr %i.en, align 8, !alias.scope !120, !noalias !119, !noundef !4 ; 9 uses
  ...
  %i.eq = load i64, ptr %i.b, align 8, !range !12, !noalias !121, !noundef !4
  %i.er = trunc nuw i64 %i.eq to i1
  %i.es = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %i.et = load i64, ptr %i.es, align 8, !range !13, !noalias !121, !noundef !4 ; 3 uses
  %i.eu = getelementptr inbounds nuw i8, ptr %i.b, i64 16 ; 2 uses
  br i1 %i.er, label %.noexc55, label %_RNvMs_NtCscdodAO9FK5_5alloc3vecINtB4_3VecNtNtCs2KzzoC5ewhj_8markdown7resolve4NameE9split_offBH_.exit.i, !prof !11

.noexc55:                                         ; preds = %.noexc54
  %i.ev = load i64, ptr %i.eu, align 8, !noalias !121
...
_RNvMs_NtCscdodAO9FK5_5alloc3vecINtB4_3VecNtNtCs2KzzoC5ewhj_8markdown7resolve4NameE9split_offBH_.exit.i: ; preds = %.noexc54
  ...
  %i.ex = load ptr, ptr %i.eu, align 8, !noalias !121, !nonnull !4, !noundef !4 ; 3 uses
  %i.ey = icmp ule i64 %i.eo, %i.et
  call void @llvm.assume(i1 %i.ey)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !121
  store i64 %i.et, ptr %i.d, align 8, !alias.scope !119, !noalias !122
