...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.y = load i8, ptr %i.x, align 4, !range !4, !noundef !3 ; 2 uses
  %5 = trunc nuw i8 %i.y to i1
  ...
  %brmerge.i = or i1 %i.al, %4
  %6 = icmp ne i8 %i.y, %i.aa
  %or.cond.i = or i1 %brmerge.i, %6
  %brmerge1.i = or i1 %or.cond.i, %5
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.ad = load i8, ptr %i.ac, align 4, !range !4, !noalias !672, !noundef !3 ; 2 uses
  %4 = trunc nuw i8 %i.ad to i1
  ...
  %brmerge.i.i = or i1 %i.aq, %3
  %5 = icmp ne i8 %i.ad, %i.af
  %or.cond.i.i = or i1 %brmerge.i.i, %5
  %brmerge1.i.i = or i1 %or.cond.i.i, %4
