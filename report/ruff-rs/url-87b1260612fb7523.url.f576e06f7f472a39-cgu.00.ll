...
begin_hunk_0_@_RNvMs_Csl4BgoAJVhPh_3urlNtB4_3Url18restore_after_path:bb.a
  ...
  br i1 %i.g, label %bb.b, label %_RNvMNtCs4NRVxsYgnAr_4core6resultINtB2_6ResultmNtNtCsl4BgoAJVhPh_3url6parser10ParseErrorE6unwrapBM_.exit, !prof !9

bb.b:                                             ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !604
  store i8 9, ptr %i.a, align 1, !noalias !604
...
_RNvMNtCs4NRVxsYgnAr_4core6resultINtB2_6ResultmNtNtCsl4BgoAJVhPh_3url6parser10ParseErrorE6unwrapBM_.exit: ; preds = %bb.a
  ...
  %i.i = load i32, ptr %i.h, align 8, !range !13, !noundef !4
...
bb.d:                                             ; preds = %bb.c, %_RNvMNtCs4NRVxsYgnAr_4core6resultINtB2_6ResultmNtNtCsl4BgoAJVhPh_3url6parser10ParseErrorE6unwrapBM_.exit
  ...
  %i.p = load i32, ptr %i.o, align 8, !range !13, !noundef !4
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %i.v = load i64, ptr %i.b, align 8, !alias.scope !605, !noundef !4 ; 3 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.y = load ptr, ptr %i.x, align 8, !alias.scope !605, !nonnull !4, !noundef !4
  ...
  %.pre.i = load i64, ptr %i.b, align 8, !alias.scope !605
...
_RNvMs_NtCscdodAO9FK5_5alloc3vecINtB4_3VechE15append_elementsCsl4BgoAJVhPh_3url.exit: ; preds = %bb.f, %bb.g
  ...
  %i.ab = add i64 %i.aa, %3
  store i64 %i.ab, ptr %i.b, align 8, !alias.scope !605
  ret void
}
...
bb.a:
  ...
  %i.b = load i64, ptr %1, align 8, !range !7, !noundef !4
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load i32, ptr %i.c, align 8, !range !13, !noundef !4
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 36
  %.not9 = icmp eq i32 %i.d, 0
  br i1 %.not9, label %bb.h, label %bb.g, !prof !10

bb.c:                                             ; preds = %bb.n, %.noexc11
  %i.f = phi i64 [ %.pre.i, %bb.n ], [ %i.z, %.noexc11 ]
  %i.g = add i64 %i.f, %i.y
  store i64 %i.g, ptr %i.k, align 8, !alias.scope !614
  %.pr = load i64, ptr %1, align 8, !alias.scope !615
...
bb.h:                                             ; preds = %bb.b
  ...
  br i1 %i.p, label %bb.i, label %bb.l, !prof !9

bb.i:                                             ; preds = %bb.h
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !616
  store i8 9, ptr %i.a, align 1, !noalias !616
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.s = load ptr, ptr %i.r, align 8, !alias.scope !617, !nonnull !4, !noundef !4
  %i.t = getelementptr inbounds nuw i8, ptr %i.s, i64 %i.l
  store i8 35, ptr %i.t, align 1
  %i.u = add nuw i64 %i.l, 1
  store i64 %i.u, ptr %i.k, align 8, !alias.scope !617
...
.noexc11:                                         ; preds = %bb.m
  %i.z = load i64, ptr %i.k, align 8, !alias.scope !614, !noundef !4 ; 3 uses
...
bb.n:                                             ; preds = %.noexc11
  %i.ab = load ptr, ptr %i.r, align 8, !alias.scope !614, !nonnull !4, !noundef !4
  ...
  %.pre.i = load i64, ptr %i.k, align 8, !alias.scope !614
  br label %bb.c
...
bb.a:
  ...
  %i.d = load i32, ptr %i.c, align 4, !alias.scope !629, !noundef !4
  %i.e = add i32 %i.d, 1                          ; 2 uses
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 8
  %.val.i = load ptr, ptr %i.f, align 8, !alias.scope !629, !nonnull !4, !noundef !4 ; 6 uses
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 16
  %.val1.i = load i64, ptr %i.g, align 8, !alias.scope !629, !noundef !4 ; 11 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.l = load i8, ptr %i.k, align 1, !alias.scope !630, !noalias !629, !noundef !4
...
_RNvMs_Csl4BgoAJVhPh_3urlNtB4_3Url16cannot_be_a_base.exit: ; preds = %bb.a, %.split.i.i.i.i.i, %bb.c
  ...
  store i32 47, ptr %i.a, align 4, !noalias !629
  %i.p = call noundef zeroext i1 @_RNvMNtCs4NRVxsYgnAr_4core5sliceSh11starts_withCsl4BgoAJVhPh_3url(ptr noalias noundef nonnull readonly captures(address, read_provenance) %i.o, i64 noundef %i.n, ptr noalias noundef nonnull readonly captures(address, read_provenance) %i.a, i64 noundef 1), !noalias !629
...
bb.e:                                             ; preds = %_RNvMs_Csl4BgoAJVhPh_3urlNtB4_3Url16cannot_be_a_base.exit
  ...
  %i.r = load i32, ptr %i.q, align 8, !range !13, !noundef !4
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.t = load i32, ptr %i.s, align 8, !range !13, !noundef !4
...
.split.i:                                         ; preds = %bb.h, %bb.g
  call void @_RNvMs_NtCscdodAO9FK5_5alloc3vecINtB4_3VechE8truncateCsl4BgoAJVhPh_3url(ptr noalias noundef nonnull align 8 dereferenceable(24) %0, i64 noundef %i.ab), !noalias !631
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ae = load i8, ptr %i.ad, align 1, !noalias !632, !noundef !4
  %i.af = icmp sgt i8 %i.ae, -65
  br i1 %i.af, label %.split.i, label %bb.i, !prof !10
...
bb.a:
  ...
  %i.b = load i8, ptr %i.a, align 8, !range !14, !noundef !4
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.o = load i8, ptr %i.n, align 1, !alias.scope !640, !noundef !4
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.s = load i8, ptr %i.r, align 1, !alias.scope !640, !noundef !4
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.g = load i32, ptr %i.f, align 8, !range !13, !noundef !4
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.q = load i8, ptr %i.p, align 1, !alias.scope !653, !noundef !4
