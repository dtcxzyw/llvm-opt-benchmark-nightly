Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/ruff-rs/original/clap_builder-34152f4bce63195d.clap_builder.9b2a128d1b545da0-cgu.01?download=true
...
begin_hunk_0_@_RNvMs_NtNtCsdjW2DEjcQy2_12clap_builder6parser6parserNtB4_6Parser5react:bb.a
  ...
  %i.hb = load ptr, ptr %i.ha, align 8, !nonnull !4, !noundef !4 ; 4 uses
  %i.hc = load i64, ptr %5, align 8, !range !12, !noundef !4
  %i.hd = load i64, ptr %i.er, align 8, !noundef !4 ; 3 uses
...
_RNvXs4_NtNtCscdodAO9FK5_5alloc3vec9into_iterINtB5_8IntoIterNtNtNtCs2AWtUsOyxgP_3std3ffi6os_str8OsStringENtNtNtNtCs4NRVxsYgnAr_4core4iter6traits8iterator8Iterator4nextCsdjW2DEjcQy2_12clap_builder.exit.i: ; preds = %_RNvXs4_NtNtCscdodAO9FK5_5alloc3vec9into_iterINtB5_8IntoIterNtNtNtCs2AWtUsOyxgP_3std3ffi6os_str8OsStringENtNtNtNtCs4NRVxsYgnAr_4core4iter6traits8iterator8Iterator4nextCsdjW2DEjcQy2_12clap_builder.exit.i.lr.ph, %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtNtCs2AWtUsOyxgP_3std3ffi6os_str8OsStringECsdjW2DEjcQy2_12clap_builder.exit
  ...
  store ptr %i.hj, ptr %.sroa.024.sroa.2.0..sroa_idx, align 8, !alias.scope !1221, !noalias !1222
  %.sroa.0.0.copyload1.i = load i64, ptr %i.hi, align 8, !noalias !1223 ; 2 uses
...
bb.cc:                                            ; preds = %_RNvXs4_NtNtCscdodAO9FK5_5alloc3vec9into_iterINtB5_8IntoIterNtNtNtCs2AWtUsOyxgP_3std3ffi6os_str8OsStringENtNtNtNtCs4NRVxsYgnAr_4core4iter6traits8iterator8Iterator4nextCsdjW2DEjcQy2_12clap_builder.exit.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.9, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.7.0..sroa_idx2.i, i64 16, i1 false), !noalias !1219
  %i.hl = load i64, ptr %.sroa.2.0..sroa_idx, align 8, !alias.scope !1219, !noalias !1224, !noundef !4 ; 2 uses
  %i.hm = add i64 %i.hl, 1
  store i64 %i.hm, ptr %.sroa.2.0..sroa_idx, align 8, !alias.scope !1219, !noalias !1224
  ...
  %i.hn = load ptr, ptr %.sroa.9.8..sroa_idx, align 8, !nonnull !4, !noundef !4
  %i.ho = load i64, ptr %i.hh, align 8, !noundef !4
...
bb.cf:                                            ; preds = %bb.cj, %bb.ce
  ...
  %i.hr = load i64, ptr %i.gz, align 8, !alias.scope !1225, !noalias !1226, !noundef !4 ; 3 uses
  %i.hs = load i64, ptr %i.bi, align 8, !range !12, !alias.scope !1225, !noalias !1226, !noundef !4
...
bb.cg:                                            ; preds = %bb.cf
  invoke void @_RNvMs3_NtCscdodAO9FK5_5alloc7raw_vecINtB5_6RawVecNtNtNtCs2AWtUsOyxgP_3std3ffi6os_str8OsStringE8grow_oneBR_(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.bi)
          to label %bb.cp unwind label %bb.ch, !noalias !1226
...
bb.cj:                                            ; preds = %bb.ce
  %i.hw = load ptr, ptr %i.fd, align 8, !nonnull !4, !align !15, !noundef !4
...
bb.ck:                                            ; preds = %bb.cj
  ...
  %i.if = load ptr, ptr %.sroa.9.8..sroa_idx, align 8, !nonnull !4, !noundef !4
  %i.ig = load i64, ptr %i.hh, align 8, !noundef !4
...
_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtNtCs2AWtUsOyxgP_3std3ffi6os_str8OsStringECsdjW2DEjcQy2_12clap_builder.exit: ; preds = %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtNtNtCs2AWtUsOyxgP_3std3sys6os_str5bytes3BufECsdjW2DEjcQy2_12clap_builder.exit.i, %bb.cp
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.9)
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.9)
  %i.ij = load ptr, ptr %.sroa.024.sroa.4.0..sroa_idx, align 8, !alias.scope !1227, !noalias !1222, !nonnull !4, !noundef !4
  %i.ik = load ptr, ptr %.sroa.024.sroa.2.0..sroa_idx, align 8, !alias.scope !1227, !noalias !1222, !nonnull !4, !noundef !4 ; 2 uses
...
bb.cp:                                            ; preds = %bb.cg, %bb.cf
  %i.im = load ptr, ptr %i.gy, align 8, !alias.scope !1225, !noalias !1226, !nonnull !4, !noundef !4
  ...
  %i.io = add i64 %i.hr, 1
  store i64 %i.io, ptr %i.gz, align 8, !alias.scope !1225, !noalias !1226
...
bb.cr:                                            ; preds = %.body171, %.thread, %bb.hr, %.thread255, %bb.gr, %bb.gq, %.thread229, %bb.fk, %bb.fj, %bb.dx, %bb.dw, %bb.cq, %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtNtNtNtB4_4iter8adapters9enumerate9EnumerateINtNtNtCscdodAO9FK5_5alloc3vec9into_iter8IntoIterNtNtNtCs2AWtUsOyxgP_3std3ffi6os_str8OsStringEEECsdjW2DEjcQy2_12clap_builder.exit
...
bb.ct:                                            ; preds = %bb.bo, %bb.bp, %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtNtNtNtB4_4iter8adapters9enumerate9EnumerateINtNtNtCscdodAO9FK5_5alloc3vec9into_iter8IntoIterNtNtNtCs2AWtUsOyxgP_3std3ffi6os_str8OsStringEEECsdjW2DEjcQy2_12clap_builder.exit167
  ...
  %i.is = load i8, ptr %i.ir, align 4, !range !20, !alias.scope !1228, !noundef !4 ; 2 uses
...
bb.cu:                                            ; preds = %bb.ct
  ...
  %i.it = load i64, ptr %i.er, align 8, !noundef !4 ; 2 uses
...
bb.cv:                                            ; preds = %bb.ct
  ...
  %i.iw = load i64, ptr %i.er, align 8, !noundef !4 ; 2 uses
...
bb.cw:                                            ; preds = %bb.ct
  ...
  %i.iz = load i64, ptr %i.er, align 8, !noundef !4 ; 2 uses
...
bb.cx:                                            ; preds = %bb.ct
  ...
  %i.je = load ptr, ptr %i.jd, align 8, !nonnull !4, !align !15, !noundef !4
...
.noexc175:                                        ; preds = %bb.cx
  %i.jf = load ptr, ptr %i.jd, align 8, !nonnull !4, !align !15, !noundef !4
...
bb.cy:                                            ; preds = %bb.ct
  ...
  %i.ji = load ptr, ptr %i.jh, align 8, !nonnull !4, !align !15, !noundef !4
...
.noexc177:                                        ; preds = %bb.cy
  %i.jj = load ptr, ptr %i.jh, align 8, !nonnull !4, !align !15, !noundef !4
...
bb.cz:                                            ; preds = %bb.ct
  ...
  %i.jm = load ptr, ptr %i.jl, align 8, !nonnull !4, !align !15, !noundef !4
...
.noexc180:                                        ; preds = %bb.cz
  %i.jn = load ptr, ptr %i.jl, align 8, !nonnull !4, !align !15, !noundef !4
...
bb.da:                                            ; preds = %bb.ct
  ...
  %i.jr = load ptr, ptr %i.jq, align 8, !nonnull !4, !align !15, !noundef !4
...
.noexc183:                                        ; preds = %bb.da
  %i.js = load ptr, ptr %i.jq, align 8, !nonnull !4, !align !15, !noundef !4
...
bb.db:                                            ; preds = %bb.ct
  br i1 %.not291, label %switch.early.test, label %bb.dd
...
bb.dc:                                            ; preds = %switch.early.test
  ...
  %i.jv = load i64, ptr %i.ju, align 8, !noundef !4
  %i.jw = add i64 %i.jv, 1
...
bb.dg:                                            ; preds = %bb.de
  ...
  %i.jz = load ptr, ptr %i.jy, align 8, !nonnull !4, !align !15, !noundef !4
...
bb.dh:                                            ; preds = %bb.dg
  ...
  %i.kh = load ptr, ptr %i.kg, align 8, !nonnull !4, !noundef !4
  %i.ki = getelementptr inbounds nuw i8, ptr %4, i64 264
  %i.kj = load i64, ptr %i.ki, align 8, !noundef !4
...
bb.dj:                                            ; preds = %bb.di
  %i.kl = load ptr, ptr %i.jy, align 8, !nonnull !4, !align !15, !noundef !4
...
bb.do:                                            ; preds = %bb.dm
  ...
  %i.kr = load ptr, ptr %i.jy, align 8, !nonnull !4, !align !15, !noundef !4
...
bb.ec:                                            ; preds = %bb.ct
  br i1 %.not291, label %switch.early.test133, label %bb.ed
...
bb.ee:                                            ; preds = %switch.early.test133
  ...
  %i.kz = load i64, ptr %i.ky, align 8, !noundef !4
  %i.la = add i64 %i.kz, 1
