...
.lr.ph.i40:                                       ; preds = %bb.u, %.lr.ph.i40
  %.sroa.43.131.i = phi ptr [ %i.go, %.lr.ph.i40 ], [ %.sroa.43.0.i, %bb.u ] ; 4 uses
  %.sroa.9.130.i = phi ptr [ %i.gt, %.lr.ph.i40 ], [ %.sroa.9.0.i, %bb.u ] ; 6 uses
  %.sroa.27.129.i = phi i64 [ %i.gs, %.lr.ph.i40 ], [ %.sroa.27.0.i, %bb.u ] ; 2 uses
  %.val22.i = load i8, ptr %.sroa.9.130.i, align 4, !alias.scope !3517, !noalias !3520, !noundef !18
  %i.fs = icmp ult i8 %.val22.i, %i.fk            ; 2 uses
  %i.ft = getelementptr inbounds i8, ptr %.sroa.43.131.i, i64 -8
  %.sroa.01.0.i.i = select i1 %i.fs, ptr %2, ptr %i.ft
  %i.fu = getelementptr inbounds nuw [8 x i8], ptr %.sroa.01.0.i.i, i64 %.sroa.27.129.i
  %i.fv = load i64, ptr %.sroa.9.130.i, align 4, !alias.scope !3517, !noalias !3522
  store i64 %i.fv, ptr %i.fu, align 4, !alias.scope !3520, !noalias !3525
  %i.fw = zext i1 %i.fs to i64
  %i.fx = add i64 %.sroa.27.129.i, %i.fw          ; 2 uses
  %i.fy = getelementptr inbounds nuw i8, ptr %.sroa.9.130.i, i64 8 ; 2 uses
  %.val20.i = load i8, ptr %i.fy, align 4, !alias.scope !3517, !noalias !3520, !noundef !18
  %i.fz = icmp ult i8 %.val20.i, %i.fk            ; 2 uses
  %i.ga = getelementptr inbounds i8, ptr %.sroa.43.131.i, i64 -16
  ...
  %i.gf = getelementptr inbounds nuw i8, ptr %.sroa.9.130.i, i64 16 ; 2 uses
  %.val18.i = load i8, ptr %i.gf, align 4, !alias.scope !3517, !noalias !3520, !noundef !18
  %i.gg = icmp ult i8 %.val18.i, %i.fk            ; 2 uses
  %i.gh = getelementptr inbounds i8, ptr %.sroa.43.131.i, i64 -24
  ...
  %i.gm = getelementptr inbounds nuw i8, ptr %.sroa.9.130.i, i64 24 ; 2 uses
  %.val16.i = load i8, ptr %i.gm, align 4, !alias.scope !3517, !noalias !3520, !noundef !18
  %i.gn = icmp ult i8 %.val16.i, %i.fk            ; 2 uses
  %i.go = getelementptr inbounds i8, ptr %.sroa.43.131.i, i64 -32 ; 3 uses
  ...
  %i.gt = getelementptr inbounds nuw i8, ptr %.sroa.9.130.i, i64 32 ; 3 uses
...
.lr.ph38.i:                                       ; preds = %._crit_edge.i, %.lr.ph38.i
  %.sroa.43.236.i = phi ptr [ %i.gz, %.lr.ph38.i ], [ %.sroa.43.1.lcssa.i, %._crit_edge.i ]
  %.sroa.9.235.i = phi ptr [ %i.he, %.lr.ph38.i ], [ %.sroa.9.1.lcssa.i, %._crit_edge.i ] ; 3 uses
  %.sroa.27.234.i = phi i64 [ %i.hd, %.lr.ph38.i ], [ %.sroa.27.1.lcssa.i, %._crit_edge.i ] ; 2 uses
  %.val.i = load i8, ptr %.sroa.9.235.i, align 4, !alias.scope !3517, !noalias !3520, !noundef !18
  %i.gy = icmp ult i8 %.val.i, %i.fk              ; 2 uses
  %i.gz = getelementptr inbounds i8, ptr %.sroa.43.236.i, i64 -8 ; 3 uses
  %.sroa.01.0.i27.i = select i1 %i.gy, ptr %2, ptr %i.gz
  %i.ha = getelementptr inbounds nuw [8 x i8], ptr %.sroa.01.0.i27.i, i64 %.sroa.27.234.i
  %i.hb = load i64, ptr %.sroa.9.235.i, align 4, !alias.scope !3517, !noalias !3538
  store i64 %i.hb, ptr %i.ha, align 4, !alias.scope !3520, !noalias !3541
  %i.hc = zext i1 %i.gy to i64
  %i.hd = add i64 %.sroa.27.234.i, %i.hc          ; 2 uses
  %i.he = getelementptr inbounds nuw i8, ptr %.sroa.9.235.i, i64 8 ; 3 uses
...
bb.c:                                             ; preds = %bb.b
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !14215
  store i8 2, ptr %i.b, align 1, !noalias !14215
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.q = load i8, ptr %i.p, align 1, !alias.scope !14221, !noalias !14218, !noundef !18
...
bb.g:                                             ; preds = %bb.f
  %i.u = load i8, ptr %i.s, align 1, !noalias !14224, !noundef !18 ; 5 uses
...
_RNvXs2J_NtNtCs4NRVxsYgnAr_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsb6FLkjZuKG_18ruff_python_parser.exit12.i.i: ; preds = %bb.g
  ...
  %i.ab = load i8, ptr %i.w, align 1, !noalias !14224, !noundef !18
...
_RNvXs2J_NtNtCs4NRVxsYgnAr_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsb6FLkjZuKG_18ruff_python_parser.exit14.i.i: ; preds = %_RNvXs2J_NtNtCs4NRVxsYgnAr_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsb6FLkjZuKG_18ruff_python_parser.exit12.i.i
  ...
  %i.al = load i8, ptr %i.ai, align 1, !noalias !14224, !noundef !18
...
_RNvXs2J_NtNtCs4NRVxsYgnAr_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsb6FLkjZuKG_18ruff_python_parser.exit16.i.i: ; preds = %_RNvXs2J_NtNtCs4NRVxsYgnAr_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsb6FLkjZuKG_18ruff_python_parser.exit14.i.i
  ...
  %i.aw = load i8, ptr %i.at, align 1, !noalias !14224, !noundef !18
...
bb.j:                                             ; preds = %bb.e, %.split.i.i
  tail call void @_RNvNtCs4NRVxsYgnAr_4core3str16slice_error_fail(ptr noalias noundef nonnull readonly captures(address, read_provenance) %i.e, i64 noundef %i.g, i64 noundef %i.h, i64 noundef %i.g, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @199) #41, !noalias !14218
  unreachable
...
.noexc49:                                         ; preds = %bb.l
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !14227
  store i8 2, ptr %i.a, align 1, !noalias !14227
...
bb.q:                                             ; preds = %bb.i, %bb.h, %_RINvNtNtCs4NRVxsYgnAr_4core3str11validations15next_code_pointINtNtNtB6_5slice4iter4IterhEECsb6FLkjZuKG_18ruff_python_parser.exit.i, %_RINvNtNtCs4NRVxsYgnAr_4core3str11validations15next_code_pointINtNtNtB6_5slice4iter4IterhEECsb6FLkjZuKG_18ruff_python_parser.exit.thread.i
  ...
  store i64 %i.br, ptr %i.c, align 8, !alias.scope !14230
...
.thread22:                                        ; preds = %bb.f, %bb.g
  tail call void @_RNvCsaSrGj5dYoxL_8thin_vec17capacity_overflow() #41, !noalias !14235
  unreachable
...
_RINvCsaSrGj5dYoxL_8thin_vec6layoutNtNtCskLngH8kgpZI_15ruff_python_ast5nodes20ParameterWithDefaultECsb6FLkjZuKG_18ruff_python_parser.exit.i.i: ; preds = %_RNvXs_CsaSrGj5dYoxL_8thin_vecINtNtCs4NRVxsYgnAr_4core6result6ResultiNtNtNtBw_3num5error15TryFromIntErrorEINtB4_17UnwrapCapOverflowiE19unwrap_cap_overflowCsb6FLkjZuKG_18ruff_python_parser.exit.i.i.i.i
  ...
  tail call void @_RNvCs9wFQrvczXsK_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #42, !noalias !14235
  %i.o = tail call noundef align 8 ptr @_RNvCs9wFQrvczXsK_7___rustc12___rust_alloc(i64 noundef %i.n, i64 noundef 8) #42, !noalias !14235 ; 3 uses
...
bb.i:                                             ; preds = %_RINvCsaSrGj5dYoxL_8thin_vec6layoutNtNtCskLngH8kgpZI_15ruff_python_ast5nodes20ParameterWithDefaultECsb6FLkjZuKG_18ruff_python_parser.exit.i.i
  tail call void @_RNvNtCscdodAO9FK5_5alloc5alloc18handle_alloc_error(i64 noundef 8, i64 noundef %i.n) #41, !noalias !14235
  unreachable
...
_RINvCsaSrGj5dYoxL_8thin_vec20header_with_capacityNtNtCskLngH8kgpZI_15ruff_python_ast5nodes20ParameterWithDefaultECsb6FLkjZuKG_18ruff_python_parser.exit.i: ; preds = %_RINvCsaSrGj5dYoxL_8thin_vec6layoutNtNtCskLngH8kgpZI_15ruff_python_ast5nodes20ParameterWithDefaultECsb6FLkjZuKG_18ruff_python_parser.exit.i.i
  store i64 0, ptr %i.o, align 8, !noalias !14235
