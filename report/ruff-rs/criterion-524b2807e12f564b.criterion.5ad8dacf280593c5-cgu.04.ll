...
bb.l:                                             ; preds = %_RINvNtNtNtNtCs4NRVxsYgnAr_4core5slice4sort6shared5pivot12choose_pivotINtNtBa_6option6OptionReENCINvMB8_SB15_16sort_unstable_byNCNvMs1_NtCs7NzLGBMhIGf_9criterion4htmlNtB28_14BenchmarkGroup3news_0E0EB2a_.exit
  ...
  %i.ct = call { i64, double } @_RNvNvMs1_NtCs7NzLGBMhIGf_9criterion4htmlNtB7_14BenchmarkGroup3new9parse_opt(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %.sroa.023.094169), !noalias !426 ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !429
  %i.dd = load ptr, ptr %i.dc, align 8, !alias.scope !430, !noalias !431, !noundef !3
  %i.de = getelementptr inbounds nuw i8, ptr %.sroa.0.096167, i64 24
  %i.df = load i64, ptr %i.de, align 8, !alias.scope !430, !noalias !431
  store ptr %i.dd, ptr %i.a, align 8, !noalias !429
  store i64 %i.df, ptr %i.d, align 8, !noalias !429
...
bb.n:                                             ; preds = %.noexc.i.i54
  ...
  call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.022.1.i.i48, ptr noundef nonnull align 8 dereferenceable(16) %i.du, i64 16, i1 false), !alias.scope !430, !noalias !432
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.du, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.01.0.i.i49, i64 16, i1 false), !noalias !432
...
bb.o:                                             ; preds = %.noexc14.i.i64
  ...
  call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.022.043.i.i59, ptr noundef nonnull align 8 dereferenceable(16) %i.eh, i64 16, i1 false), !alias.scope !430, !noalias !433
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.eh, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.13.044.i.i58, i64 16, i1 false), !alias.scope !430, !noalias !433
...
_RNCINvNtNtNtNtCs4NRVxsYgnAr_4core5slice4sort8unstable9quicksort34partition_lomuto_branchless_cyclicINtNtBc_6option6OptionReENCINvB4_9quicksortB1z_NCINvMBa_SB1z_16sort_unstable_byNCNvMs1_NtCs7NzLGBMhIGf_9criterion4htmlNtB2Y_14BenchmarkGroup3news_0E0E0E0B30_.exit21.i.i: ; preds = %.noexc19.i.i65
  ...
  call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.13.044.i.i58, ptr noundef nonnull align 8 dereferenceable(16) %i.ev, i64 16, i1 false), !alias.scope !430, !noalias !434
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.ev, ptr noundef nonnull align 8 dereferenceable(16) %i.ek, i64 16, i1 false), !alias.scope !430, !noalias !434
...
bb.p:                                             ; preds = %.loopexit.split-lp.i.i61, %.loopexit.i.i50
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.022.2.i.i52, ptr noundef nonnull readonly align 8 dereferenceable(16) %i.a, i64 16, i1 false), !noalias !431
...
bb.d:                                             ; preds = %.lr.ph166
  %.val10.i = load ptr, ptr %.sroa.0.0105162, align 8, !alias.scope !520, !noalias !521, !noundef !3 ; 3 uses
  %i.n = getelementptr i8, ptr %.sroa.0.0105162, i64 8
  %.val11.i = load i64, ptr %i.n, align 8, !alias.scope !520, !noalias !521 ; 4 uses
  %.val12.i = load ptr, ptr %i.j, align 8, !alias.scope !520, !noalias !521 ; 5 uses
  %i.o = getelementptr i8, ptr %i.j, i64 8
  %.val13.i = load i64, ptr %i.o, align 8, !alias.scope !520, !noalias !521 ; 4 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.p = tail call i32 @memcmp(ptr nonnull readonly %.val10.i, ptr nonnull readonly %.val12.i, i64 %spec.store.select.i.i.i.i.i.i.i), !alias.scope !522, !noalias !523 ; 2 uses
  ...
  %.val829.i = load ptr, ptr %i.k, align 8, !alias.scope !520, !noalias !521 ; 2 uses
...
.thread.i:                                        ; preds = %bb.e
  %.val82941.i = load ptr, ptr %i.k, align 8, !alias.scope !520, !noalias !521 ; 2 uses
...
bb.g:                                             ; preds = %bb.d
  ...
  %.val8.i = load ptr, ptr %i.k, align 8, !alias.scope !520, !noalias !521 ; 2 uses
  %i.u = getelementptr i8, ptr %i.k, i64 8
  %.val9.i = load i64, ptr %i.u, align 8, !alias.scope !520, !noalias !521
...
bb.h:                                             ; preds = %.thread.i, %bb.f
  ...
  %.val93047.i = load i64, ptr %.val93047.in.i, align 8, !alias.scope !520, !noalias !521 ; 3 uses
  %spec.store.select.i.i.i.i.i.i16.i = tail call i64 @llvm.umin.i64(i64 %.val11.i, i64 %.val93047.i)
  %i.v = tail call i32 @memcmp(ptr nonnull readonly %.val10.i, ptr nonnull readonly %.val82946.i, i64 %spec.store.select.i.i.i.i.i.i16.i), !alias.scope !524, !noalias !523 ; 2 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.ab = tail call i32 @memcmp(ptr nonnull readonly %.val12.i, ptr nonnull readonly %.val834.i, i64 %spec.store.select.i.i.i.i.i.i23.i), !alias.scope !525, !noalias !523 ; 2 uses
...
bb.m:                                             ; preds = %.split, %_RINvNtNtNtNtCs4NRVxsYgnAr_4core5slice4sort6shared5pivot12choose_pivotINtNtBa_6option6OptionReENvYB15_NtNtBa_3cmp10PartialOrd2ltECs7NzLGBMhIGf_9criterion.exit, %_RNvYNvYINtNtCs4NRVxsYgnAr_4core6option6OptionReENtNtBa_3cmp10PartialOrd2ltINtNtNtBa_3ops8function5FnMutTRB5_B1E_EE8call_mutCs7NzLGBMhIGf_9criterion.exit
  ...
  %i.am = load ptr, ptr %i.al, align 8, !alias.scope !530, !noalias !528, !noundef !3
  %i.an = getelementptr inbounds nuw i8, ptr %.sroa.0.0105162, i64 24
  %i.ao = load i64, ptr %i.an, align 8, !alias.scope !530, !noalias !528
  store ptr %i.am, ptr %i.b, align 8, !noalias !529
  store i64 %i.ao, ptr %i.e, align 8, !noalias !529
  ...
  %.val2.i.pre.i.i = load ptr, ptr %.sroa.0.0105162, align 8, !alias.scope !531, !noalias !527
  %.pre.i.i = freeze ptr %.val2.i.pre.i.i         ; 5 uses
  %i.as = getelementptr inbounds nuw i8, ptr %.sroa.0.0105162, i64 8
  %.val3.i14.i.i = load i64, ptr %i.as, align 8, !alias.scope !531, !noalias !527 ; 6 uses
...
_RNCINvNtNtNtNtCs4NRVxsYgnAr_4core5slice4sort8unstable9quicksort34partition_lomuto_branchless_cyclicINtNtBc_6option6OptionReENvYB1z_NtNtBc_3cmp10PartialOrd2ltE0Cs7NzLGBMhIGf_9criterion.exit32.us.i.i.prol: ; preds = %_RNCINvNtNtNtNtCs4NRVxsYgnAr_4core5slice4sort8unstable9quicksort34partition_lomuto_branchless_cyclicINtNtBc_6option6OptionReENvYB1z_NtNtBc_3cmp10PartialOrd2ltE0Cs7NzLGBMhIGf_9criterion.exit32.us.i.i.preheader
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.al, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.13.051.i.i, i64 16, i1 false), !alias.scope !530, !noalias !532
  %6 = getelementptr inbounds nuw i8, ptr %.sroa.0.0105162, i64 48 ; 3 uses
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.13.051.i.i, ptr noundef nonnull align 8 dereferenceable(16) %i.al, i64 16, i1 false), !alias.scope !530, !noalias !533
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.al, ptr noundef nonnull align 8 dereferenceable(16) %6, i64 16, i1 false), !alias.scope !530, !noalias !533
...
_RNCINvNtNtNtNtCs4NRVxsYgnAr_4core5slice4sort8unstable9quicksort34partition_lomuto_branchless_cyclicINtNtBc_6option6OptionReENvYB1z_NtNtBc_3cmp10PartialOrd2ltE0Cs7NzLGBMhIGf_9criterion.exit32.us.i.i: ; preds = %.lr.ph.i.i.a, %_RNCINvNtNtNtNtCs4NRVxsYgnAr_4core5slice4sort8unstable9quicksort34partition_lomuto_branchless_cyclicINtNtBc_6option6OptionReENvYB1z_NtNtBc_3cmp10PartialOrd2ltE0Cs7NzLGBMhIGf_9criterion.exit32.us.i.i
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.033.053.us.i.i, ptr noundef nonnull align 8 dereferenceable(16) %i.al, i64 16, i1 false), !alias.scope !530, !noalias !532
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.al, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.13.054.us.i.i, i64 16, i1 false), !alias.scope !530, !noalias !532
  %8 = getelementptr inbounds nuw i8, ptr %.sroa.033.053.us.i.i, i64 32 ; 2 uses
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.13.054.us.i.i, ptr noundef nonnull align 8 dereferenceable(16) %i.al, i64 16, i1 false), !alias.scope !530, !noalias !533
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.al, ptr noundef nonnull align 8 dereferenceable(16) %8, i64 16, i1 false), !alias.scope !530, !noalias !533
  %.sroa.13.0.us.i.i = getelementptr inbounds nuw i8, ptr %.sroa.033.053.us.i.i, i64 48 ; 2 uses
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %8, ptr noundef nonnull align 8 dereferenceable(16) %i.al, i64 16, i1 false), !alias.scope !530, !noalias !532
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.al, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.13.0.us.i.i, i64 16, i1 false), !alias.scope !530, !noalias !532
  %i.at = getelementptr inbounds nuw i8, ptr %.sroa.033.053.us.i.i, i64 64 ; 3 uses
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.13.0.us.i.i, ptr noundef nonnull align 8 dereferenceable(16) %i.al, i64 16, i1 false), !alias.scope !530, !noalias !533
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.al, ptr noundef nonnull align 8 dereferenceable(16) %i.at, i64 16, i1 false), !alias.scope !530, !noalias !533
...
.preheader.split.us.i.i:                          ; preds = %.preheader.split.us.i.i, %.preheader.split.us.preheader.i.i
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.033.1.us.i.i, ptr noundef nonnull align 8 dereferenceable(16) %i.av, i64 16, i1 false), !alias.scope !530, !noalias !534
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.av, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.01.0.us.i.i, i64 16, i1 false), !noalias !534
...
.preheader.split.i.i:                             ; preds = %.preheader.i.i, %bb.o
  ...
  %.val.i.i.i = load ptr, ptr %.sroa.01.0.i.i, align 8, !noalias !534, !noundef !3 ; 2 uses
...
bb.n:                                             ; preds = %.preheader.split.i.i
  ...
  %.val1.i.i.i = load i64, ptr %.sroa.01.0.sroa.sel.i.i, align 8, !noalias !534 ; 2 uses
  %spec.store.select.i.i.i.i.i.i.i.i.i = tail call i64 @llvm.umin.i64(i64 %.val1.i.i.i, i64 %.val3.i14.i.i)
  %i.ay = tail call i32 @memcmp(ptr nonnull readonly %.val.i.i.i, ptr nonnull readonly %.pre.i.i, i64 %spec.store.select.i.i.i.i.i.i.i.i.i), !alias.scope !535, !noalias !536 ; 2 uses
...
bb.o:                                             ; preds = %bb.n, %.preheader.split.i.i
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.033.1.i.i, ptr noundef nonnull align 8 dereferenceable(16) %i.bc, i64 16, i1 false), !alias.scope !530, !noalias !534
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.bc, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.01.0.i.i, i64 16, i1 false), !noalias !534
...
.lr.ph.split.split.i.i:                           ; preds = %.lr.ph.i.i, %_RNCINvNtNtNtNtCs4NRVxsYgnAr_4core5slice4sort8unstable9quicksort34partition_lomuto_branchless_cyclicINtNtBc_6option6OptionReENvYB1z_NtNtBc_3cmp10PartialOrd2ltE0Cs7NzLGBMhIGf_9criterion.exit32.i.i
  ...
  %.val.i11.i.i = load ptr, ptr %.sroa.13.054.i.i, align 8, !alias.scope !530, !noalias !532, !noundef !3 ; 2 uses
...
bb.p:                                             ; preds = %.lr.ph.split.split.i.i
  ...
  %.val1.i12.i.i = load i64, ptr %i.be, align 8, !alias.scope !530, !noalias !532 ; 2 uses
  %spec.store.select.i.i.i.i.i.i.i17.i.i = tail call i64 @llvm.umin.i64(i64 %.val1.i12.i.i, i64 %.val3.i14.i.i)
  %i.bf = tail call i32 @memcmp(ptr nonnull readonly %.val.i11.i.i, ptr nonnull readonly %.pre.i.i, i64 %spec.store.select.i.i.i.i.i.i.i17.i.i), !alias.scope !537, !noalias !538 ; 2 uses
...
bb.q:                                             ; preds = %bb.p, %.lr.ph.split.split.i.i
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.033.053.i.i, ptr noundef nonnull align 8 dereferenceable(16) %i.bj, i64 16, i1 false), !alias.scope !530, !noalias !532
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.bj, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.13.054.i.i, i64 16, i1 false), !alias.scope !530, !noalias !532
  ...
  %.val.i22.i.i = load ptr, ptr %i.bl, align 8, !alias.scope !530, !noalias !533, !noundef !3 ; 2 uses
...
bb.r:                                             ; preds = %bb.q
  ...
  %.val1.i23.i.i = load i64, ptr %i.bm, align 8, !alias.scope !530, !noalias !533 ; 2 uses
  %spec.store.select.i.i.i.i.i.i.i28.i.i = tail call i64 @llvm.umin.i64(i64 %.val1.i23.i.i, i64 %.val3.i14.i.i)
  %i.bn = tail call i32 @memcmp(ptr nonnull readonly %.val.i22.i.i, ptr nonnull readonly %.pre.i.i, i64 %spec.store.select.i.i.i.i.i.i.i28.i.i), !alias.scope !539, !noalias !540 ; 2 uses
...
_RNCINvNtNtNtNtCs4NRVxsYgnAr_4core5slice4sort8unstable9quicksort34partition_lomuto_branchless_cyclicINtNtBc_6option6OptionReENvYB1z_NtNtBc_3cmp10PartialOrd2ltE0Cs7NzLGBMhIGf_9criterion.exit32.i.i: ; preds = %bb.r, %bb.q
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.13.054.i.i, ptr noundef nonnull align 8 dereferenceable(16) %i.br, i64 16, i1 false), !alias.scope !530, !noalias !533
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.br, ptr noundef nonnull align 8 dereferenceable(16) %i.bl, i64 16, i1 false), !alias.scope !530, !noalias !533
...
bb.t:                                             ; preds = %_RINvNtNtNtNtCs4NRVxsYgnAr_4core5slice4sort6shared5pivot12choose_pivotINtNtBa_6option6OptionReENvYB15_NtNtBa_3cmp10PartialOrd2ltECs7NzLGBMhIGf_9criterion.exit
  ...
  %.sroa.023.0.val = load ptr, ptr %.sroa.023.0103164, align 8, !noundef !3 ; 2 uses
...
.split:                                           ; preds = %bb.u
  ...
  %i.cb = tail call i32 @memcmp(ptr nonnull readonly %.sroa.023.0.val, ptr nonnull readonly %.val, i64 %spec.store.select.i.i.i.i.i.i), !alias.scope !541 ; 2 uses
...
_RNvYNvYINtNtCs4NRVxsYgnAr_4core6option6OptionReENtNtBa_3cmp10PartialOrd2ltINtNtNtBa_3ops8function5FnMutTRB5_B1E_EE8call_mutCs7NzLGBMhIGf_9criterion.exit.thread: ; preds = %bb.u, %_RNvYNvYINtNtCs4NRVxsYgnAr_4core6option6OptionReENtNtBa_3cmp10PartialOrd2ltINtNtNtBa_3ops8function5FnMutTRB5_B1E_EE8call_mutCs7NzLGBMhIGf_9criterion.exit, %.split
  ...
  %i.ch = load ptr, ptr %i.cg, align 8, !alias.scope !546, !noalias !544, !noundef !3
  %i.ci = getelementptr inbounds nuw i8, ptr %.sroa.0.0105162, i64 24
  %i.cj = load i64, ptr %i.ci, align 8, !alias.scope !546, !noalias !544
  store ptr %i.ch, ptr %i.a, align 8, !noalias !545
  store i64 %i.cj, ptr %i.d, align 8, !noalias !545
  ...
  %.val2.i.pre.i.i44 = load ptr, ptr %.sroa.0.0105162, align 8, !alias.scope !547, !noalias !543 ; 5 uses
  %i.cn = getelementptr inbounds nuw i8, ptr %.sroa.0.0105162, i64 8
  %.val3.i14.i.i45 = load i64, ptr %i.cn, align 8, !alias.scope !547, !noalias !543 ; 6 uses
...
_RNCINvNtNtNtNtCs4NRVxsYgnAr_4core5slice4sort8unstable9quicksort34partition_lomuto_branchless_cyclicINtNtBc_6option6OptionReENCINvB4_9quicksortB1z_NvYB1z_NtNtBc_3cmp10PartialOrd2ltE0E0Cs7NzLGBMhIGf_9criterion.exit32.us.i.i: ; preds = %.lr.ph.i.i67, %_RNCINvNtNtNtNtCs4NRVxsYgnAr_4core5slice4sort8unstable9quicksort34partition_lomuto_branchless_cyclicINtNtBc_6option6OptionReENCINvB4_9quicksortB1z_NvYB1z_NtNtBc_3cmp10PartialOrd2ltE0E0Cs7NzLGBMhIGf_9criterion.exit32.us.i.i
  ...
  %.val.i11.us.i.i = load ptr, ptr %.sroa.13.054.us.i.i76, align 8, !alias.scope !546, !noalias !548
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.033.053.us.i.i77, ptr noundef nonnull align 8 dereferenceable(16) %i.co, i64 16, i1 false), !alias.scope !546, !noalias !548
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.co, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.13.054.us.i.i76, i64 16, i1 false), !alias.scope !546, !noalias !548
  ...
  %.val.i22.us.i.i = load ptr, ptr %i.cr, align 8, !alias.scope !546, !noalias !549
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.13.054.us.i.i76, ptr noundef nonnull align 8 dereferenceable(16) %i.cs, i64 16, i1 false), !alias.scope !546, !noalias !549
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.cs, ptr noundef nonnull align 8 dereferenceable(16) %i.cr, i64 16, i1 false), !alias.scope !546, !noalias !549
...
.preheader.split.us.i.i62:                        ; preds = %.preheader.split.us.i.i62.preheader, %.preheader.split.us.i.i62
  ...
  %.val.i.us.i.i = load ptr, ptr %.sroa.01.0.us.i.i65, align 8, !noalias !550
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.033.1.us.i.i64, ptr noundef nonnull align 8 dereferenceable(16) %i.cx, i64 16, i1 false), !alias.scope !546, !noalias !550
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.cx, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.01.0.us.i.i65, i64 16, i1 false), !noalias !550
...
.preheader.split.i.i50:                           ; preds = %.preheader.i.i46, %bb.w
  ...
  %.val.i.i.i55 = load ptr, ptr %.sroa.01.0.i.i54, align 8, !noalias !550 ; 2 uses
...
bb.v:                                             ; preds = %.preheader.split.i.i50
  ...
  %.val1.i.i.i58 = load i64, ptr %.sroa.01.0.sroa.sel.i.i57, align 8, !noalias !550 ; 2 uses
  %spec.store.select.i.i.i.i.i.i.i.i.i.i = tail call i64 @llvm.umin.i64(i64 %.val3.i14.i.i45, i64 %.val1.i.i.i58)
  %i.db = tail call i32 @memcmp(ptr nonnull readonly %.val2.i.pre.i.i44, ptr nonnull readonly %.val.i.i.i55, i64 %spec.store.select.i.i.i.i.i.i.i.i.i.i), !alias.scope !551, !noalias !552 ; 2 uses
