...
bb.c:                                             ; preds = %bb.a
  ...
  %i.f = load i8, ptr %0, align 1, !alias.scope !7867, !noalias !7868, !noundef !5 ; 5 uses
  %i.g = add nsw i64 %1, -1                       ; 2 uses
  %i.h = tail call i64 @llvm.usub.sat.i64(i64 range(i64 3, 11) %1, i64 4) ; 4 uses
  %i.i = icmp samesign ult i64 %i.h, %1
  br i1 %i.i, label %_RNCINvNvNtNtNtNtCs4NRVxsYgnAr_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0CsEhZmuQNqkz_11ruff_linter.exit.i.i, label %_RNvNtNtCs4NRVxsYgnAr_4core3str7pattern13simd_contains.exit

4:                                                ; preds = %_RNCINvNvNtNtNtNtCs4NRVxsYgnAr_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0CsEhZmuQNqkz_11ruff_linter.exit.i.i
...
.lr.ph.1:                                         ; preds = %4
  ...
  %8 = load i8, ptr %7, align 1, !alias.scope !7867, !noalias !7869, !noundef !5 ; 2 uses
...
.lr.ph.a:                                         ; preds = %bb.d
  ...
  %11 = load i8, ptr %10, align 1, !alias.scope !7867, !noalias !7869, !noundef !5 ; 2 uses
...
bb.e:                                             ; preds = %.lr.ph.3
  ...
  %17 = load i8, ptr %16, align 1, !alias.scope !7867, !noalias !7869, !noundef !5 ; 2 uses
...
_RNCINvNvNtNtNtNtCs4NRVxsYgnAr_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0CsEhZmuQNqkz_11ruff_linter.exit.i.i: ; preds = %bb.c
  %18 = add nsw i64 %1, -1                        ; 3 uses
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 %18
  %i.l = load i8, ptr %i.k, align 1, !alias.scope !7867, !noalias !7869, !noundef !5 ; 2 uses
  %.not.i.not.i.i = icmp eq i8 %i.l, %i.f
  br i1 %.not.i.not.i.i, label %4, label %bb.f

19:                                               ; preds = %.lr.ph.3
  tail call void @_RNvNtCs4NRVxsYgnAr_4core9panicking18panic_bounds_check(i64 noundef %14, i64 noundef range(i64 3, 11) %1, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @55) #35, !noalias !7870
  unreachable

bb.f:                                             ; preds = %bb.e, %.lr.ph.a, %.lr.ph.1, %_RNCINvNvNtNtNtNtCs4NRVxsYgnAr_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0CsEhZmuQNqkz_11ruff_linter.exit.i.i
  %.lcssa317 = phi i8 [ %i.l, %_RNCINvNvNtNtNtNtCs4NRVxsYgnAr_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0CsEhZmuQNqkz_11ruff_linter.exit.i.i ], [ %8, %.lr.ph.1 ], [ %11, %.lr.ph.a ], [ %17, %bb.e ]
  %.lcssa315 = phi i64 [ %18, %_RNCINvNvNtNtNtNtCs4NRVxsYgnAr_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0CsEhZmuQNqkz_11ruff_linter.exit.i.i ], [ %6, %.lr.ph.1 ], [ %9, %.lr.ph.a ], [ %14, %bb.e ] ; 6 uses
...
!7867 = !{!7828}
!7868 = !{!7829}
!7869 = !{!7836, !7834, !7832, !7831, !7829}
!7870 = !{!7836, !7834, !7832, !7831, !7828, !7829}
!7871 = !{!7828, !7829}
!7872 = !{!7839, !7838}
!7873 = !{!7841, !7828}
!7874 = !{!7843, !7828}
