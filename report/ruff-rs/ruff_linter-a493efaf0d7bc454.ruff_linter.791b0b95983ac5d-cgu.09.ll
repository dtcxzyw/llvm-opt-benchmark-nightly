...
_RINvMNtCs4NRVxsYgnAr_4core6optionINtB3_6OptionIBw_RNtNtNtNtNtCsEhZmuQNqkz_11ruff_linter5rules11pycodestyle5rules13logical_lines16LogicalLineTokenEE18get_or_insert_withNCNvMs3_NtNtNtB5_4iter8adapters8peekableINtB2N_8PeekableINtNtNtB5_5slice4iter4IterBN_EE4peek0EBX_.exit126.thread: ; preds = %bb.ak
  store i64 0, ptr %.sroa.6, align 8, !alias.scope !7225, !noalias !7226
  br label %.cont
...
bb.aw:                                            ; preds = %bb.ak
  ...
  store i64 %i.dt, ptr %.sroa.6, align 8, !alias.scope !7225, !noalias !7226
  %i.du = getelementptr inbounds nuw i8, ptr %i.bp, i64 8
  %i.dv = load i8, ptr %i.du, align 4, !range !58, !noundef !5
...
bb.ay:                                            ; preds = %bb.ax
  %i.dx = load i32, ptr %.sroa.019.0, align 4, !noundef !5 ; 4 uses
...
bb.ba:                                            ; preds = %bb.az
  %i.dz = load i16, ptr %i.an, align 8, !range !57, !noundef !5
...
_RINvMNtCs4NRVxsYgnAr_4core6optionINtB3_6OptionIBw_RNtNtNtNtNtCsEhZmuQNqkz_11ruff_linter5rules11pycodestyle5rules13logical_lines16LogicalLineTokenEE18get_or_insert_withNCNvMs3_NtNtNtB5_4iter8adapters8peekableINtB2N_8PeekableINtNtNtB5_5slice4iter4IterBN_EE4peek0EBX_.exit123: ; preds = %bb.aw
  ...
  %i.ec = load i8, ptr %i.eb, align 4, !range !58, !noundef !5
...
bb.bi:                                            ; preds = %bb.bh
  %i.ee = load i32, ptr %.sroa.019.0, align 4, !noundef !5 ; 4 uses
...
bb.bk:                                            ; preds = %bb.bj
  %i.eg = load i16, ptr %i.aq, align 8, !range !57, !noundef !5
...
bb.bo:                                            ; preds = %bb.bl
  %i.eh = load i64, ptr %i.a, align 8, !range !8, !noundef !5
  %i.ei = trunc nuw i64 %i.eh to i1
  %i.ej = load i64, ptr %i.at, align 8, !range !9, !noundef !5 ; 3 uses
  br i1 %i.ei, label %bb.bp, label %bb.bq, !prof !6
...
bb.bq:                                            ; preds = %bb.bo
  %i.el = load ptr, ptr %i.au, align 8, !nonnull !5, !noundef !5 ; 2 uses
...
_RINvMNtCs4NRVxsYgnAr_4core6optionINtB3_6OptionIBw_RNtNtNtNtNtCsEhZmuQNqkz_11ruff_linter5rules11pycodestyle5rules13logical_lines16LogicalLineTokenEE18get_or_insert_withNCNvMs3_NtNtNtB5_4iter8adapters8peekableINtB2N_8PeekableINtNtNtB5_5slice4iter4IterBN_EE4peek0EBX_.exit126: ; preds = %_RINvMNtCs4NRVxsYgnAr_4core6optionINtB3_6OptionIBw_RNtNtNtNtNtCsEhZmuQNqkz_11ruff_linter5rules11pycodestyle5rules13logical_lines16LogicalLineTokenEE18get_or_insert_withNCNvMs3_NtNtNtB5_4iter8adapters8peekableINtB2N_8PeekableINtNtNtB5_5slice4iter4IterBN_EE4peek0EBX_.exit123
  ...
  %i.ep = load i8, ptr %i.eo, align 4, !range !58, !noalias !7227, !noundef !5
...
.else129:                                         ; preds = %bb.bx
  %.else.val130 = load ptr, ptr %.sroa.02.0.i166, align 8, !nonnull !5, !align !22, !noundef !5
  br label %.cont127

.cont127:                                         ; preds = %bb.bx, %.else129
  %i.ez = phi ptr [ %.sroa.019.0, %bb.bx ], [ %.else.val130, %.else129 ]
  %i.fa = load i32, ptr %i.ez, align 4, !noundef !5 ; 4 uses
...
bb.bz:                                            ; preds = %bb.by
  %i.fc = load i16, ptr %i.av, align 8, !range !57, !noundef !5
...
bb.ch:                                            ; preds = %bb.cg
  %i.fe = load i16, ptr %i.bb, align 8, !range !57, !noundef !5
...
bb.cp:                                            ; preds = %bb.co
  ...
  %i.fk = load i32, ptr %i.fj, align 4, !noundef !5 ; 4 uses
...
bb.cr:                                            ; preds = %bb.cq
  %i.fm = load i16, ptr %i.bh, align 8, !range !57, !noundef !5
...
bb.da:                                            ; preds = %bb.cz
  ...
  %i.fs = load i32, ptr %.sroa.019.0, align 4, !noundef !5 ; 4 uses
...
bb.dc:                                            ; preds = %bb.db
  %i.fu = load i16, ptr %i.be, align 8, !range !57, !noundef !5
