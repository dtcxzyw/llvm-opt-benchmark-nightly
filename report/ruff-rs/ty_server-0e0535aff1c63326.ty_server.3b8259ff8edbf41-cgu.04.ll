...
bb.a:
  ...
  %i.gc = alloca [1112 x i8], align 8             ; 47 uses
...
.critedge169.i:                                   ; preds = %.critedge167.i
  %6 = getelementptr inbounds nuw i8, ptr %i.gc, i64 708
  %.sroa.032.0.val.i = load i8, ptr %6, align 4, !range !2879, !alias.scope !2876, !noundef !11
  %7 = getelementptr inbounds nuw i8, ptr %i.gc, i64 709
  %.sroa.032.0.val183.i = load i8, ptr %7, align 1, !alias.scope !2876
  %.not.i210.i = icmp eq i8 %.sroa.032.0.val.i, -1
  %8 = and i8 %.sroa.032.0.val183.i, 1
  %or.cond7.not284.i = icmp eq i8 %8, 0
  %or.cond7.not.i = select i1 %.not.i210.i, i1 true, i1 %or.cond7.not284.i
  %i.qe = or i32 %.sroa.0.8.i, 8
  %spec.select296.i = select i1 %or.cond7.not.i, i32 %.sroa.0.8.i, i32 %i.qe ; 2 uses
  %9 = getelementptr inbounds nuw i8, ptr %i.gc, i64 706
  %.sroa.032.0.val184.i = load i8, ptr %9, align 2, !range !2879, !alias.scope !2876, !noundef !11
  %10 = getelementptr inbounds nuw i8, ptr %i.gc, i64 707
  %.sroa.032.0.val185.i = load i8, ptr %10, align 1, !alias.scope !2876
  %.not.i211.i = icmp eq i8 %.sroa.032.0.val184.i, -1
  %11 = and i8 %.sroa.032.0.val185.i, 1
  %or.cond9.not285.i = icmp eq i8 %11, 0
  %or.cond9.not.i = select i1 %.not.i211.i, i1 true, i1 %or.cond9.not285.i
  %12 = or i32 %spec.select296.i, 16
  %.sroa.0.10.i = select i1 %or.cond9.not.i, i32 %spec.select296.i, i32 %12 ; 2 uses
  %i.qf = getelementptr inbounds nuw i8, ptr %i.gc, i64 704
  %.sroa.032.0.val186.i = load i8, ptr %i.qf, align 8, !range !2879, !alias.scope !2876, !noundef !11
  %13 = getelementptr inbounds nuw i8, ptr %i.gc, i64 705
  %.sroa.032.0.val187.i = load i8, ptr %13, align 1, !alias.scope !2876
  %.not.i213.i = icmp eq i8 %.sroa.032.0.val186.i, -1
  %14 = and i8 %.sroa.032.0.val187.i, 1
  %or.cond11.not286.i = icmp eq i8 %14, 0
  %or.cond11.not.i = select i1 %.not.i213.i, i1 true, i1 %or.cond11.not286.i
  %15 = or i32 %.sroa.0.10.i, 32
  %spec.select296.i.a = select i1 %or.cond11.not.i, i32 %.sroa.0.10.i, i32 %15 ; 2 uses
  %16 = getelementptr inbounds nuw i8, ptr %i.gc, i64 710
  %.sroa.032.0.val188.i = load i8, ptr %16, align 2, !range !2879, !alias.scope !2876, !noundef !11
  %17 = getelementptr inbounds nuw i8, ptr %i.gc, i64 711
  %.sroa.032.0.val189.i = load i8, ptr %17, align 1, !alias.scope !2876
  %.not.i215.i = icmp eq i8 %.sroa.032.0.val188.i, -1
  %18 = and i8 %.sroa.032.0.val189.i, 1
  %or.cond13.not287.i = icmp eq i8 %18, 0
  %or.cond13.not.i = select i1 %.not.i215.i, i1 true, i1 %or.cond13.not287.i
  %19 = or i32 %spec.select296.i.a, 2097152
  %.sroa.0.12.i = select i1 %or.cond13.not.i, i32 %spec.select296.i.a, i32 %19 ; 6 uses
