...
.critedge169.i:                                   ; preds = %.critedge167.i
  ...
  %spec.select296.i.a = select i1 %13, i32 %.sroa.0.8.i, i32 %i.qe ; 2 uses
  %14 = or i32 %spec.select296.i.a, 16
  %15 = extractelement <4 x i1> %12, i64 1
  %.sroa.0.10.i = select i1 %15, i32 %spec.select296.i.a, i32 %14 ; 2 uses
