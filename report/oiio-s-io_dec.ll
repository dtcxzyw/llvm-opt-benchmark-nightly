begin_hunk_0
  ...
  %17 = load i32, ptr %16, align 4, !tbaa !87     ; [#uses=1 type=i32]
  %.fr52 = freeze i32 %17                         ; [#uses=5 type=i32]
...
WebPRescalerHasPendingOutput.exit.lr.ph:          ; preds = %3
  %21 = icmp sgt i32 %.fr52, 0                    ; [#uses=1 type=i1]
...
88:                                               ; preds = %WebPRescalerHasPendingOutput.exit.thread
  ...
  tail call void %89(ptr noundef %12, i32 noundef %.fr52, i32 noundef %.036.lcssa.ph, i32 noundef %90) #8
...
WebPRescalerHasPendingOutput.exit.thread.thread:  ; preds = %WebPRescalerHasPendingOutput.exit, %82, %3, %88, %WebPRescalerHasPendingOutput.exit.thread
  %.036.lcssa60 = phi i32 [ %.036.lcssa.ph, %WebPRescalerHasPendingOutput.exit.thread ], [ %.036.lcssa.ph, %88 ], [ 0, %3 ], [ %.03642, %WebPRescalerHasPendingOutput.exit ], [ %83, %82 ] ; [#uses=1 type=i32]
  ret i32 %.036.lcssa60
}
