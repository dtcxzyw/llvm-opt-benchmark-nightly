begin_hunk_0
  ...
  %.val13 = load i64, ptr %66, align 8            ; [#uses=1 type=i64]
  %.val13.fr = freeze i64 %.val13                 ; [#uses=7 type=i64]
...
begin_hunk_1
  ...
  %72 = icmp eq i64 %.val13.fr, 0                 ; [#uses=1 type=i1]
...
begin_hunk_2
  ...
  %81 = icmp eq i64 %80, %.val13.fr               ; [#uses=1 type=i1]
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit.i: ; preds = %.lr.ph.i
  ...
  %bcmp.i.i = call i32 @bcmp(ptr %82, ptr readonly %.val, i64 %.val13.fr) ; [#uses=1 type=i32]
...
begin_hunk_3
  ...
  %93 = icmp ugt i64 %.val13.fr, 15               ; [#uses=1 type=i1]
...
._crit_edge.i.i25:                                ; preds = %.noexc27, %90
  ...
  %cond = icmp eq i64 %.val13.fr, 1               ; [#uses=1 type=i1]
...
begin_hunk_6
  ...
  %.val45 = load i64, ptr %89, align 8            ; [#uses=1 type=i64]
  %.val45.fr = freeze i64 %.val45                 ; [#uses=3 type=i64]
...
begin_hunk_7
  ...
  %95 = icmp eq i64 %.val45.fr, 0                 ; [#uses=1 type=i1]
...
begin_hunk_8
  ...
  %104 = icmp eq i64 %103, %.val45.fr             ; [#uses=1 type=i1]
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit.i: ; preds = %.lr.ph.i
  ...
  %bcmp.i.i = call i32 @bcmp(ptr %105, ptr readonly %.val, i64 %.val45.fr) ; [#uses=1 type=i32]
...
begin_hunk_9
  ...
  %.val49 = load i64, ptr %115, align 8           ; [#uses=1 type=i64]
  %.val49.fr = freeze i64 %.val49                 ; [#uses=3 type=i64]
...
begin_hunk_10
  ...
  %121 = icmp eq i64 %.val49.fr, 0                ; [#uses=1 type=i1]
...
begin_hunk_11
  ...
  %130 = icmp eq i64 %129, %.val49.fr             ; [#uses=1 type=i1]
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit.i70: ; preds = %.lr.ph.i66
  ...
  %bcmp.i.i71 = call i32 @bcmp(ptr %131, ptr readonly %.val48, i64 %.val49.fr) ; [#uses=1 type=i32]
