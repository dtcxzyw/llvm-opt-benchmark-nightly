...
num_keys_cmp.exit305:                             ; preds = %bb.gx, %bb.hb
  ...
  %.not415 = icmp ult i32 %.017.i298, %.016.i301
  br i1 %.not415, label %.critedge.i, label %bb.hc
...
bb.hd:                                            ; preds = %bb.hc
  call void @exchange_one_int64(ptr noundef %.1178227.i, ptr noundef nonnull %.1184226.i, i64 noundef 8) #49, !inline_history !544
  %i.afp = add i64 %.1170229.i, 1
  %i.afq = getelementptr inbounds nuw i8, ptr %.1178227.i, i64 8
  br label %bb.he

bb.he:                                            ; preds = %bb.hd, %bb.hc
  %.2179.i = phi ptr [ %i.afq, %bb.hd ], [ %.1178227.i, %bb.hc ] ; 2 uses
  %.2171.i = phi i64 [ %i.afp, %bb.hd ], [ %.1170229.i, %bb.hc ] ; 2 uses
  %i.afr = add i64 %.1173228.i, 1                 ; 2 uses
  %i.afs = getelementptr inbounds nuw i8, ptr %.1184226.i, i64 8 ; 3 uses
  %i.aft = icmp ult ptr %i.afs, %.0180.i
  br i1 %i.aft, label %.lr.ph.i, label %.critedge.i, !llvm.loop !545

.critedge.i:                                      ; preds = %bb.he, %num_keys_cmp.exit305, %bb.gr
  %.1184.lcssa.i = phi ptr [ %.0183.i, %bb.gr ], [ %i.afs, %bb.he ], [ %.1184226.i, %num_keys_cmp.exit305 ] ; 7 uses
  %.1178.lcssa.i = phi ptr [ %.0177.i, %bb.gr ], [ %.2179.i, %bb.he ], [ %.1178227.i, %num_keys_cmp.exit305 ] ; 2 uses
  %.1173.lcssa.i = phi i64 [ %.0172.i, %bb.gr ], [ %i.afr, %bb.he ], [ %.1173228.i, %num_keys_cmp.exit305 ] ; 3 uses
  %.1170.lcssa.i = phi i64 [ %.0169.i, %bb.gr ], [ %.2171.i, %bb.he ], [ %.1170229.i, %num_keys_cmp.exit305 ] ; 2 uses
  %i.afu = getelementptr inbounds i8, ptr %.0180.i, i64 -8 ; 2 uses
  %i.afv = icmp ult ptr %.1184.lcssa.i, %i.afu
...
.lr.ph240.i:                                      ; preds = %.critedge.i, %bb.hr
  ...
  %.1168239.i = phi i64 [ %.2.i, %bb.hr ], [ %.0167.i, %.critedge.i ] ; 3 uses
  %.1175238.i = phi ptr [ %.2176.i, %bb.hr ], [ %.0174.i, %.critedge.i ] ; 3 uses
...
num_keys_cmp.exit294:                             ; preds = %bb.hk, %bb.ho
  ...
  %.not416 = icmp ugt i32 %.017.i287, %.016.i290
  br i1 %.not416, label %bb.hs, label %bb.hp
...
bb.hq:                                            ; preds = %bb.hp
  %i.ahb = add i64 %.1168239.i, -1
  %i.ahc = getelementptr inbounds i8, ptr %.1175238.i, i64 -8 ; 2 uses
...
bb.hr:                                            ; preds = %bb.hq, %bb.hp
  %.2176.i = phi ptr [ %i.ahc, %bb.hq ], [ %.1175238.i, %bb.hp ] ; 2 uses
  %.2.i = phi i64 [ %i.ahb, %bb.hq ], [ %.1168239.i, %bb.hp ] ; 2 uses
  %i.ahd = getelementptr inbounds i8, ptr %i.afw, i64 -8 ; 2 uses
  %i.ahe = icmp ult ptr %.1184.lcssa.i, %i.ahd
  br i1 %i.ahe, label %.lr.ph240.i, label %.critedge3.i, !llvm.loop !546

bb.hs:                                            ; preds = %num_keys_cmp.exit294
  call void @exchange_one_int64(ptr noundef %.1184.lcssa.i, ptr noundef nonnull %i.afw, i64 noundef 8) #49, !inline_history !544
  %i.ahf = add i64 %.1173.lcssa.i, 1
  %i.ahg = getelementptr inbounds nuw i8, ptr %.1184.lcssa.i, i64 8
  br label %bb.gr

.critedge3.i:                                     ; preds = %.critedge.i, %bb.hr
  %.1175.lcssa.i = phi ptr [ %.2176.i, %bb.hr ], [ %.0174.i, %.critedge.i ]
  %.1168.lcssa.i = phi i64 [ %.2.i, %bb.hr ], [ %.0167.i, %.critedge.i ]
  %i.ahh = ptrtoint ptr %.1178.lcssa.i to i64     ; 2 uses
  %i.ahi = ptrtoint ptr %.0186255.i1012 to i64
  %i.ahj = sub i64 %i.ahh, %i.ahi
  %i.ahk = ptrtoint ptr %.1184.lcssa.i to i64     ; 2 uses
  %i.ahl = sub i64 %i.ahk, %i.ahh
  %i.ahm = sub i64 %.1173.lcssa.i, %.1170.lcssa.i ; 3 uses
  %spec.select.i = call i64 @llvm.umin.i64(i64 %i.ahj, i64 %i.ahl) ; 2 uses
  %i.ahn = sub i64 0, %spec.select.i
  %i.aho = getelementptr inbounds i8, ptr %.1184.lcssa.i, i64 %i.ahn
  call void @exchange_int64s(ptr noundef nonnull %.0186255.i1012, ptr noundef %i.aho, i64 noundef %spec.select.i) #49, !inline_history !544
  %i.ahp = ptrtoint ptr %i.aei to i64
  %i.ahq = ptrtoint ptr %.1175.lcssa.i to i64     ; 2 uses
  ...
  %i.ahv = sub i64 %.1168.lcssa.i, %.1173.lcssa.i ; 3 uses
  %.1.i277 = call i64 @llvm.umin.i64(i64 %i.ahr, i64 %i.ahs) ; 2 uses
  %i.ahw = sub i64 0, %.1.i277
  %i.ahx = getelementptr inbounds i8, ptr %i.aei, i64 %i.ahw
  call void @exchange_int64s(ptr noundef %.1184.lcssa.i, ptr noundef nonnull %i.ahx, i64 noundef %.1.i277) #49, !inline_history !544
...
bb.hu:                                            ; preds = %bb.ht, %.critedge3.i
  %.sink285.i = phi ptr [ %i.ahu, %bb.ht ], [ %.0186255.i1012, %.critedge3.i ]
  %.sink.i = phi i64 [ %i.ahv, %bb.ht ], [ %i.ahm, %.critedge3.i ]
  %.1192.i = phi i64 [ %i.ahm, %bb.ht ], [ %i.ahv, %.critedge3.i ] ; 4 uses
  %.1187.i = phi ptr [ %.0186255.i1012, %bb.ht ], [ %i.ahu, %.critedge3.i ] ; 3 uses
  store ptr %.sink285.i, ptr %.1189254.i1013, align 8, !tbaa !533
  %i.ahz = getelementptr inbounds nuw i8, ptr %.1189254.i1013, i64 8
  store i64 %.sink.i, ptr %i.ahz, align 8, !tbaa !535
  %i.aia = getelementptr inbounds nuw i8, ptr %.1189254.i1013, i64 16
  store i32 %i.zf, ptr %i.aia, align 8, !tbaa !536
  %.2190.i = getelementptr inbounds nuw i8, ptr %.1189254.i1013, i64 24 ; 3 uses
  %i.aib = icmp ugt i64 %.1192.i, 6
  br i1 %i.aib, label %.lr.ph257.i, label %heapsortx.exit.i, !llvm.loop !538

heapsortx.exit.i:                                 ; preds = %bb.hu, %bb.de
  %.1189224.i = phi ptr [ %i.tc, %bb.de ], [ %.2190.i, %bb.hu ] ; 2 uses
  %.0186222.i = phi ptr [ %i.td, %bb.de ], [ %.1187.i, %bb.hu ] ; 4 uses
  %.2193.i = phi i64 [ %i.tf, %bb.de ], [ %.1192.i, %bb.hu ] ; 2 uses
  %i.aic = shl nuw nsw i64 %.2193.i, 3
  %i.aid = getelementptr inbounds nuw i8, ptr %.0186222.i, i64 %i.aic
  %i.aie = icmp samesign ugt i64 %.2193.i, 1
  br i1 %i.aie, label %.preheader.preheader.i, label %.loopexit.i

.preheader.preheader.i:                           ; preds = %heapsortx.exit.i
  %.2185264.i = getelementptr inbounds nuw i8, ptr %.0186222.i, i64 8
  br label %.preheader.i

.preheader.i:                                     ; preds = %.critedge5.i, %.preheader.preheader.i
  %.2185265.i = phi ptr [ %.2185.i, %.critedge5.i ], [ %.2185264.i, %.preheader.preheader.i ] ; 3 uses
  %6 = icmp ugt ptr %.2185265.i, %.0186222.i
  br i1 %6, label %.lr.ph262.i, label %.critedge5.i

.lr.ph262.i:                                      ; preds = %.preheader.i, %bb.if
  %.2182261.i = phi ptr [ %i.aif, %bb.if ], [ %.2185265.i, %.preheader.i ] ; 4 uses
  %i.aif = getelementptr inbounds i8, ptr %.2182261.i, i64 -8 ; 3 uses
  %i.aig = getelementptr inbounds i8, ptr %.2182261.i, i64 -4
  %i.aih = load i32, ptr %i.aig, align 4, !tbaa !522 ; 3 uses
  %i.aii = getelementptr inbounds nuw i8, ptr %.2182261.i, i64 4
...
bb.if:                                            ; preds = %num_keys_cmp.exit
  call void @exchange_one_int64(ptr noundef nonnull %.2182261.i, ptr noundef nonnull %i.aif, i64 noundef 8) #49, !inline_history !544
  %i.ajl = icmp ugt ptr %i.aif, %.0186222.i
  br i1 %i.ajl, label %.lr.ph262.i, label %.critedge5.i, !llvm.loop !547

.critedge5.i:                                     ; preds = %bb.if, %num_keys_cmp.exit, %.preheader.i
  %.2185.i = getelementptr inbounds nuw i8, ptr %.2185265.i, i64 8 ; 2 uses
  %i.ajm = icmp ult ptr %.2185.i, %i.aid
...
.critedge247:                                     ; preds = %js_free_prop_enum.exit, %._crit_edge513, %bb.be, %js_free_prop_enum.exit.thread406, %bb.n, %bb.ad, %bb.ig
  %.12 = phi i32 [ -1, %bb.n ], [ 0, %bb.ig ], [ -1, %js_free_prop_enum.exit.thread406 ], [ -1, %js_free_prop_enum.exit ], [ -1, %bb.ad ], [ -1, %bb.be ], [ -1, %._crit_edge513 ]
...
bb.a:
  ...
  br i1 %.not.i, label %js_free_prop_enum.exit, label %.preheader4

.preheader4:                                      ; preds = %bb.a
  %.not = icmp eq i32 %2, 0
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %.not.i2, label %._crit_edge10, label %bb.e

._crit_edge10:                                    ; preds = %bb.d
...
.preheader:                                       ; preds = %bb.e, %.preheader
  %.0.i3 = phi ptr [ %i.ao, %.preheader ], [ %i.ag, %bb.e ] ; 2 uses
  %i.ak = getelementptr inbounds nuw i8, ptr %.0.i3, i64 8
...
bb.g:                                             ; preds = %.preheader
  %i.aq = getelementptr inbounds nuw i8, ptr %.0.i3, i64 8
...
bb.h:                                             ; preds = %._crit_edge10, %bb.g, %bb.f
  %.pre-phi = phi i64 [ %.pre, %._crit_edge10 ], [ %i.am, %bb.g ], [ %i.ae, %bb.f ]
  %.1.i = phi i32 [ %i.r, %._crit_edge10 ], [ %i.al, %bb.g ], [ %i.ad, %bb.f ]
...
._crit_edge:                                      ; preds = %JS_FreeAtom.exit, %.preheader4
...
heapsortx.exit.i.i:                               ; preds = %bb.fr, %bb.ad
  ...
  %.0186222.i.i = phi ptr [ %i.di, %bb.ad ], [ %.1187.i.i, %bb.fr ] ; 4 uses
...
.preheader.i.i:                                   ; preds = %.critedge5.i.i, %.preheader.preheader.i.i
  %.2185265.i.i = phi ptr [ %.2185.i.i, %.critedge5.i.i ], [ %.2185264.i.i, %.preheader.preheader.i.i ] ; 3 uses
  %8 = icmp ugt ptr %.2185265.i.i, %.0186222.i.i
  br i1 %8, label %.lr.ph262.i.i, label %.critedge5.i.i

.lr.ph262.i.i:                                    ; preds = %.preheader.i.i, %bb.ho
...
.critedge5.i.i:                                   ; preds = %bb.ho, %JS_FreeValue.exit146.i, %.preheader.i.i
...
bb.hx:                                            ; preds = %.lr.ph.i.i132.i
  call void @abort() #50, !inline_history !891
  unreachable

.loopexit.i135.i:                                 ; preds = %bb.hw, %bb.hv
  %i.ass = call fastcc ptr @add_property(ptr noundef %0, ptr noundef %i.ac, i32 noundef %i.arx, i32 noundef 54), !inline_history !891 ; 3 uses
...
JS_DefineAutoInitProperty.exit.thread.i:          ; preds = %bb.hy, %bb.hu, %bb.ht, %bb.hp
  ...
  br i1 %exitcond476.not.i, label %._crit_edge443.i, label %bb.hp, !llvm.loop !892

._crit_edge443.i:                                 ; preds = %JS_DefineAutoInitProperty.exit.thread.i, %rqsort.exit.i
  %i.asw = load ptr, ptr %i.af, align 8, !tbaa !50
  call void @js_free_rt(ptr noundef %i.asw, ptr noundef %.pre484.i), !inline_history !858
...
bb.hz:                                            ; preds = %._crit_edge443.i
  %i.atf = getelementptr inbounds nuw i8, ptr %i.asz, i64 384
  %i.atg = load ptr, ptr %i.atf, align 8, !tbaa !155
  br label %bb.ia

bb.ia:                                            ; preds = %bb.hz, %._crit_edge443.i
  %.0.i.i136.i = phi ptr [ %i.atb, %._crit_edge443.i ], [ %i.atg, %bb.hz ] ; 2 uses
  ...
  %i.atp = call i32 @JS_DefineProperty(ptr noundef nonnull %0, i64 %i.y, i64 %i.z, i32 noundef 234, i64 %i.ath, i64 -7, ptr noundef nonnull byval(%struct.JSValue) align 8 %2, ptr noundef nonnull byval(%struct.JSValue) align 8 %3, i32 noundef 9984) #51, !inline_history !893 ; 0 uses
...
bb.ib:                                            ; preds = %bb.ia
  call fastcc void @js_free_value_rt(ptr noundef %i.atq, i64 %i.ath, i64 -7) #51, !inline_history !894
...
JS_DefineAutoInitProperty.exit.i:                 ; preds = %.loopexit.i135.i, %bb.hs, %bb.hr, %bb.u, %.JS_DefineAutoInitProperty.exit_crit_edge.i
  %i.atu = phi ptr [ %.pre486.i, %.JS_DefineAutoInitProperty.exit_crit_edge.i ], [ %i.al, %bb.u ], [ %.pre484.i, %bb.hr ], [ %.pre484.i, %bb.hs ], [ %.pre484.i, %.loopexit.i135.i ]
  %i.atv = load ptr, ptr %i.af, align 8, !tbaa !50
  call void @js_free_rt(ptr noundef %i.atv, ptr noundef %i.atu), !inline_history !858
...
begin_hunk_3_@js_async_module_execution_fulfilled:bb.a
  %i.cv = load i64, ptr %i.cu, align 8, !tbaa !1650
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.cx = shl i64 %.178.i.i, 1
  %i.cy = add i64 %i.cx, 8                        ; 2 uses
  %i.cz = icmp ult i64 %i.cy, %.18099.i.i
...
.lr.ph164:                                        ; preds = %.lr.ph257.preheader.i, %.lr.ph257.i
  ...
  %.0191253.i163 = phi i64 [ %.1192.i, %.lr.ph257.i ], [ %i.aq, %.lr.ph257.preheader.i ] ; 3 uses
  %.1189254.i162 = phi ptr [ %.2190.i, %.lr.ph257.i ], [ %i.an, %.lr.ph257.preheader.i ] ; 4 uses
  %.0186255.i161 = phi ptr [ %.1187.i, %.lr.ph257.i ], [ %i.ao, %.lr.ph257.preheader.i ] ; 12 uses
  %i.da = add nsw i32 %.in, 1                     ; 3 uses
  %i.db = shl i64 %.0191253.i163, 1
  %i.dc = and i64 %i.db, -8                       ; 3 uses
  %i.dd = getelementptr inbounds nuw i8, ptr %.0186255.i161, i64 %i.dc ; 3 uses
  %i.de = shl i64 %i.dc, 1
  %i.df = getelementptr inbounds nuw i8, ptr %.0186255.i161, i64 %i.de ; 3 uses
  %i.dg = mul i64 %i.dc, 3
  %i.dh = getelementptr inbounds nuw i8, ptr %.0186255.i161, i64 %i.dg ; 3 uses
  %i.di = load ptr, ptr %i.dd, align 8, !tbaa !865
  %i.dj = load ptr, ptr %i.df, align 8, !tbaa !865
  %i.dk = getelementptr inbounds nuw i8, ptr %i.di, i64 192
  %i.dl = load i64, ptr %i.dk, align 8, !tbaa !1650 ; 3 uses
  %i.dm = getelementptr inbounds nuw i8, ptr %i.dj, i64 192
  %i.dn = load i64, ptr %i.dm, align 8, !tbaa !1650 ; 3 uses
  %i.do = icmp slt i64 %i.dl, %i.dn
  %i.dp = load ptr, ptr %i.dh, align 8, !tbaa !865
  %i.dq = getelementptr inbounds nuw i8, ptr %i.dp, i64 192
  %i.dr = load i64, ptr %i.dq, align 8, !tbaa !1650 ; 4 uses
...
med3.exit.i:                                      ; preds = %bb.v, %bb.u, %bb.t, %bb.s
  ...
  call void %.0.i312.i(ptr noundef nonnull %.0186255.i161, ptr noundef nonnull %i.dy, i64 noundef 8) #49, !inline_history !544
  %i.dz = getelementptr inbounds nuw i8, ptr %.0186255.i161, i64 8 ; 2 uses
  %i.ea = shl i64 %.0191253.i163, 3
  %i.eb = getelementptr inbounds nuw i8, ptr %.0186255.i161, i64 %i.ea ; 5 uses
  br label %bb.w

bb.w:                                             ; preds = %bb.ad, %med3.exit.i
  %.0183.i = phi ptr [ %i.dz, %med3.exit.i ], [ %i.fe, %bb.ad ] ; 3 uses
  %.0180.i = phi ptr [ %i.eb, %med3.exit.i ], [ %i.er, %bb.ad ] ; 3 uses
  %.0177.i = phi ptr [ %i.dz, %med3.exit.i ], [ %.1178.lcssa.i, %bb.ad ] ; 2 uses
  %.0174.i = phi ptr [ %i.eb, %med3.exit.i ], [ %.1175238.i, %bb.ad ] ; 2 uses
  %.0172.i = phi i64 [ 1, %med3.exit.i ], [ %i.fd, %bb.ad ] ; 2 uses
  %.0169.i = phi i64 [ 1, %med3.exit.i ], [ %.1170.lcssa.i, %bb.ad ] ; 2 uses
  %.0167.i = phi i64 [ %.0191253.i163, %med3.exit.i ], [ %.1168239.i, %bb.ad ] ; 2 uses
  %i.ec = icmp ult ptr %.0183.i, %.0180.i
  br i1 %i.ec, label %.lr.ph.i, label %.critedge.i

.lr.ph.i:                                         ; preds = %bb.w, %bb.z
  %.1170229.i = phi i64 [ %.2171.i, %bb.z ], [ %.0169.i, %bb.w ] ; 3 uses
  %.1173228.i = phi i64 [ %i.em, %bb.z ], [ %.0172.i, %bb.w ] ; 2 uses
  %.1178227.i = phi ptr [ %.2179.i, %bb.z ], [ %.0177.i, %bb.w ] ; 4 uses
  %.1184226.i = phi ptr [ %i.en, %bb.z ], [ %.0183.i, %bb.w ] ; 4 uses
  %i.ed = load ptr, ptr %.0186255.i161, align 8, !tbaa !865
  %i.ee = load ptr, ptr %.1184226.i, align 8, !tbaa !865
  %i.ef = getelementptr inbounds nuw i8, ptr %i.ed, i64 192
  %i.eg = load i64, ptr %i.ef, align 8, !tbaa !1650 ; 2 uses
  %i.eh = getelementptr inbounds nuw i8, ptr %i.ee, i64 192
  %i.ei = load i64, ptr %i.eh, align 8, !tbaa !1650 ; 2 uses
...
bb.y:                                             ; preds = %bb.x
  call void %.0.i312.i(ptr noundef %.1178227.i, ptr noundef nonnull %.1184226.i, i64 noundef 8) #49, !inline_history !544
  %i.ek = add i64 %.1170229.i, 1
  %i.el = getelementptr inbounds nuw i8, ptr %.1178227.i, i64 8
  br label %bb.z

bb.z:                                             ; preds = %bb.y, %bb.x
  %.2179.i = phi ptr [ %i.el, %bb.y ], [ %.1178227.i, %bb.x ] ; 2 uses
  %.2171.i = phi i64 [ %i.ek, %bb.y ], [ %.1170229.i, %bb.x ] ; 2 uses
  %i.em = add i64 %.1173228.i, 1                  ; 2 uses
  %i.en = getelementptr inbounds nuw i8, ptr %.1184226.i, i64 8 ; 3 uses
  %i.eo = icmp ult ptr %i.en, %.0180.i
  br i1 %i.eo, label %.lr.ph.i, label %.critedge.i, !llvm.loop !545

.critedge.i:                                      ; preds = %bb.z, %.lr.ph.i, %bb.w
  %.1184.lcssa.i = phi ptr [ %.0183.i, %bb.w ], [ %.1184226.i, %.lr.ph.i ], [ %i.en, %bb.z ] ; 7 uses
  %.1178.lcssa.i = phi ptr [ %.0177.i, %bb.w ], [ %.1178227.i, %.lr.ph.i ], [ %.2179.i, %bb.z ] ; 2 uses
  %.1173.lcssa.i = phi i64 [ %.0172.i, %bb.w ], [ %.1173228.i, %.lr.ph.i ], [ %i.em, %bb.z ] ; 3 uses
  %.1170.lcssa.i = phi i64 [ %.0169.i, %bb.w ], [ %.1170229.i, %.lr.ph.i ], [ %.2171.i, %bb.z ] ; 2 uses
  %i.ep = getelementptr inbounds i8, ptr %.0180.i, i64 -8 ; 2 uses
  %i.eq = icmp ult ptr %.1184.lcssa.i, %i.ep
...
.lr.ph240.i:                                      ; preds = %.critedge.i, %bb.ac
  ...
  %.1168239.i = phi i64 [ %.2.i, %bb.ac ], [ %.0167.i, %.critedge.i ] ; 3 uses
  %.1175238.i = phi ptr [ %.2176.i, %bb.ac ], [ %.0174.i, %.critedge.i ] ; 3 uses
  %i.es = load ptr, ptr %.0186255.i161, align 8, !tbaa !865
  %i.et = load ptr, ptr %i.er, align 8, !tbaa !865
  %i.eu = getelementptr inbounds nuw i8, ptr %i.es, i64 192
  %i.ev = load i64, ptr %i.eu, align 8, !tbaa !1650 ; 2 uses
  %i.ew = getelementptr inbounds nuw i8, ptr %i.et, i64 192
  %i.ex = load i64, ptr %i.ew, align 8, !tbaa !1650 ; 2 uses
...
bb.ab:                                            ; preds = %bb.aa
  %i.ez = add i64 %.1168239.i, -1
  %i.fa = getelementptr inbounds i8, ptr %.1175238.i, i64 -8 ; 2 uses
  call void %.0.i312.i(ptr noundef nonnull %i.fa, ptr noundef nonnull %i.er, i64 noundef 8) #49, !inline_history !544
  br label %bb.ac

bb.ac:                                            ; preds = %bb.ab, %bb.aa
  %.2176.i = phi ptr [ %i.fa, %bb.ab ], [ %.1175238.i, %bb.aa ] ; 2 uses
  %.2.i = phi i64 [ %i.ez, %bb.ab ], [ %.1168239.i, %bb.aa ] ; 2 uses
  %i.fb = getelementptr inbounds i8, ptr %i.er, i64 -8 ; 2 uses
  %i.fc = icmp ult ptr %.1184.lcssa.i, %i.fb
  br i1 %i.fc, label %.lr.ph240.i, label %.critedge3.i, !llvm.loop !546

bb.ad:                                            ; preds = %.lr.ph240.i
  call void %.0.i312.i(ptr noundef %.1184.lcssa.i, ptr noundef nonnull %i.er, i64 noundef 8) #49, !inline_history !544
  %i.fd = add i64 %.1173.lcssa.i, 1
  %i.fe = getelementptr inbounds nuw i8, ptr %.1184.lcssa.i, i64 8
  br label %bb.w

.critedge3.i:                                     ; preds = %.critedge.i, %bb.ac
  %.1175.lcssa.i = phi ptr [ %.2176.i, %bb.ac ], [ %.0174.i, %.critedge.i ]
  %.1168.lcssa.i = phi i64 [ %.2.i, %bb.ac ], [ %.0167.i, %.critedge.i ]
  %i.ff = ptrtoint ptr %.1178.lcssa.i to i64      ; 2 uses
  %i.fg = ptrtoint ptr %.0186255.i161 to i64
  %i.fh = sub i64 %i.ff, %i.fg
  %i.fi = ptrtoint ptr %.1184.lcssa.i to i64      ; 2 uses
  %i.fj = sub i64 %i.fi, %i.ff
  %i.fk = sub i64 %.1173.lcssa.i, %.1170.lcssa.i  ; 3 uses
  %spec.select.i = call i64 @llvm.umin.i64(i64 %i.fh, i64 %i.fj) ; 2 uses
  %i.fl = sub i64 0, %spec.select.i
  %i.fm = getelementptr inbounds i8, ptr %.1184.lcssa.i, i64 %i.fl
  call void %.0.i210.i(ptr noundef nonnull %.0186255.i161, ptr noundef %i.fm, i64 noundef %spec.select.i) #49, !inline_history !544
  %i.fn = ptrtoint ptr %i.eb to i64
  %i.fo = ptrtoint ptr %.1175.lcssa.i to i64      ; 2 uses
  %i.fp = sub i64 %i.fn, %i.fo
  %i.fq = sub i64 %i.fo, %i.fi                    ; 2 uses
  %i.fr = sub i64 0, %i.fq
  %i.fs = getelementptr inbounds i8, ptr %i.eb, i64 %i.fr ; 2 uses
  %i.ft = sub i64 %.1168.lcssa.i, %.1173.lcssa.i  ; 3 uses
  %.1.i = call i64 @llvm.umin.i64(i64 %i.fp, i64 %i.fq) ; 2 uses
  %i.fu = sub i64 0, %.1.i
  %i.fv = getelementptr inbounds i8, ptr %i.eb, i64 %i.fu
  call void %.0.i210.i(ptr noundef %.1184.lcssa.i, ptr noundef nonnull %i.fv, i64 noundef %.1.i) #49, !inline_history !544
...
bb.af:                                            ; preds = %bb.ae, %.critedge3.i
  %.sink285.i = phi ptr [ %i.fs, %bb.ae ], [ %.0186255.i161, %.critedge3.i ]
  %.sink.i = phi i64 [ %i.ft, %bb.ae ], [ %i.fk, %.critedge3.i ]
  %.1192.i = phi i64 [ %i.fk, %bb.ae ], [ %i.ft, %.critedge3.i ] ; 4 uses
  %.1187.i = phi ptr [ %.0186255.i161, %bb.ae ], [ %i.fs, %.critedge3.i ] ; 3 uses
  store ptr %.sink285.i, ptr %.1189254.i162, align 8, !tbaa !533
  %i.fx = getelementptr inbounds nuw i8, ptr %.1189254.i162, i64 8
  store i64 %.sink.i, ptr %i.fx, align 8, !tbaa !535
  %i.fy = getelementptr inbounds nuw i8, ptr %.1189254.i162, i64 16
  store i32 %i.da, ptr %i.fy, align 8, !tbaa !536
  %.2190.i = getelementptr inbounds nuw i8, ptr %.1189254.i162, i64 24 ; 3 uses
  %i.fz = icmp ugt i64 %.1192.i, 6
  br i1 %i.fz, label %.lr.ph257.i, label %heapsortx.exit.i, !llvm.loop !538

heapsortx.exit.i:                                 ; preds = %bb.af, %bb.l
  %.1189224.i = phi ptr [ %i.an, %bb.l ], [ %.2190.i, %bb.af ] ; 2 uses
  %.0186222.i = phi ptr [ %i.ao, %bb.l ], [ %.1187.i, %bb.af ] ; 4 uses
  %.2193.i = phi i64 [ %i.aq, %bb.l ], [ %.1192.i, %bb.af ] ; 2 uses
  %i.ga = shl nuw nsw i64 %.2193.i, 3
  %i.gb = getelementptr inbounds nuw i8, ptr %.0186222.i, i64 %i.ga
  %i.gc = icmp samesign ugt i64 %.2193.i, 1
...
.preheader.i:                                     ; preds = %.critedge5.i, %.preheader.preheader.i
  %.2185265.i = phi ptr [ %.2185.i, %.critedge5.i ], [ %.2185264.i, %.preheader.preheader.i ] ; 3 uses
  %13 = icmp ugt ptr %.2185265.i, %.0186222.i
  br i1 %13, label %.lr.ph262.i, label %.critedge5.i

.lr.ph262.i:                                      ; preds = %.preheader.i, %bb.ag
  %.2182261.i = phi ptr [ %i.gd, %bb.ag ], [ %.2185265.i, %.preheader.i ] ; 3 uses
  %i.gd = getelementptr inbounds i8, ptr %.2182261.i, i64 -8 ; 4 uses
  %i.ge = load ptr, ptr %i.gd, align 8, !tbaa !865
  %i.gf = load ptr, ptr %.2182261.i, align 8, !tbaa !865
  %i.gg = getelementptr inbounds nuw i8, ptr %i.ge, i64 192
  %i.gh = load i64, ptr %i.gg, align 8, !tbaa !1650
  %i.gi = getelementptr inbounds nuw i8, ptr %i.gf, i64 192
  %i.gj = load i64, ptr %i.gi, align 8, !tbaa !1650
  %i.gk = icmp sgt i64 %i.gh, %i.gj
  br i1 %i.gk, label %bb.ag, label %.critedge5.i

bb.ag:                                            ; preds = %.lr.ph262.i
  call void %.0.i312.i(ptr noundef nonnull %.2182261.i, ptr noundef nonnull %i.gd, i64 noundef 8) #49, !inline_history !544
  %i.gl = icmp ugt ptr %i.gd, %.0186222.i
  br i1 %i.gl, label %.lr.ph262.i, label %.critedge5.i, !llvm.loop !547

.critedge5.i:                                     ; preds = %bb.ag, %.lr.ph262.i, %.preheader.i
  %.2185.i = getelementptr inbounds nuw i8, ptr %.2185265.i, i64 8 ; 2 uses
  %i.gm = icmp ult ptr %.2185.i, %i.gb
  br i1 %i.gm, label %.preheader.i, label %.loopexit.i, !llvm.loop !548

rqsort.exit.loopexit:                             ; preds = %.loopexit.i
  %.pre = load i32, ptr %i.z, align 8, !tbaa !1655
  %.pre83.pre = load ptr, ptr %10, align 8, !tbaa !1653
...
bb.ah:                                            ; preds = %.lr.ph, %bb.at
  ...
  %i.gt = load ptr, ptr %i.gs, align 8, !tbaa !865 ; 9 uses
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %i.gy = load i8, ptr %i.gx, align 8, !tbaa !1212, !range !58, !noundef !59
...
bb.aq:                                            ; preds = %bb.ap
  ...
  %i.id = call fastcc { i64, i64 } @JS_CallInternal(ptr noundef %0, i64 %i.ia, i64 %i.ic, i64 0, i64 3, i64 0, i64 3, i32 noundef 1, ptr noundef nonnull %7, i32 noundef 2), !inline_history !1651 ; 2 uses
...
bb.as:                                            ; preds = %bb.ar
  call fastcc void @js_free_value_rt(ptr noundef %i.ig, i64 %i.ie, i64 %i.if), !inline_history !1652
...
bb.at:                                            ; preds = %bb.aj, %js_set_module_evaluated.exit40, %bb.ah
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.sink.split, label %bb.ah, !llvm.loop !1656
...
bb.d:                                             ; preds = %bb.c
  ...
  store i8 1, ptr %i.l, align 8, !tbaa !907
