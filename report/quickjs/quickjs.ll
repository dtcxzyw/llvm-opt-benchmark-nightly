...
.lr.ph.i58:                                       ; preds = %.lr.ph.i58, %.lr.ph.i58.preheader.new
  ...
  %.028.i = phi i64 [ 0, %.lr.ph.i58.preheader.new ], [ %7, %.lr.ph.i58 ]
  ...
  %7 = add nuw i64 %i.es, 12                      ; 2 uses
  %i.fd = getelementptr inbounds nuw i8, ptr %i.el, i64 %i.es
...
.lr.ph.i58.epil.preheader:                        ; preds = %._crit_edge.loopexit.i.unr-lcssa, %.lr.ph.i58.preheader
  ...
  %.028.i.epil.init = phi i64 [ 0, %.lr.ph.i58.preheader ], [ %7, %._crit_edge.loopexit.i.unr-lcssa ]
...
.lr.ph.i58.epil:                                  ; preds = %.lr.ph.i58.epil, %.lr.ph.i58.epil.preheader
  ...
  %.028.i.epil = phi i64 [ %i.fi, %.lr.ph.i58.epil ], [ %.028.i.epil.init, %.lr.ph.i58.epil.preheader ]
  ...
  %i.fj = getelementptr inbounds nuw i8, ptr %i.el, i64 %.028.i.epil
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.i.i.preheader.new
  ...
  %.028.i.i = phi i64 [ 0, %.lr.ph.i.i.preheader.new ], [ %6, %.lr.ph.i.i ]
  ...
  %6 = add nuw nsw i64 %i.ao, 12                  ; 2 uses
  %i.az = getelementptr inbounds nuw i8, ptr %i.ai, i64 %i.ao
...
.lr.ph.i.i.epil.preheader:                        ; preds = %._crit_edge.loopexit.i.i.unr-lcssa, %.lr.ph.i.i.preheader
  ...
  %.028.i.i.epil.init = phi i64 [ 0, %.lr.ph.i.i.preheader ], [ %6, %._crit_edge.loopexit.i.i.unr-lcssa ]
...
.lr.ph.i.i.epil:                                  ; preds = %.lr.ph.i.i.epil, %.lr.ph.i.i.epil.preheader
  ...
  %.028.i.i.epil = phi i64 [ %i.be, %.lr.ph.i.i.epil ], [ %.028.i.i.epil.init, %.lr.ph.i.i.epil.preheader ]
  ...
  %i.bf = getelementptr inbounds nuw i8, ptr %i.ai, i64 %.028.i.i.epil
...
.lr.ph:                                           ; preds = %bb.b, %bb.f
  ...
  %.0138167 = phi i32 [ %i.g, %bb.f ], [ 0, %bb.b ]
  %.sroa.024.sroa.17.0166 = phi i32 [ %.sroa.024.sroa.17.1, %bb.f ], [ 0, %bb.b ] ; 2 uses
  %.sroa.024.sroa.0.0165 = phi i32 [ %.sroa.024.sroa.0.1, %bb.f ], [ 0, %bb.b ] ; 2 uses
  %.sroa.18.0164 = phi i64 [ %.sroa.18.1, %bb.f ], [ 2, %bb.b ] ; 3 uses
  %i.h = zext i32 %.0138167 to i64
...
bb.e:                                             ; preds = %bb.c
  %.sroa.024.sroa.17.0.insert.ext = zext i32 %.sroa.024.sroa.17.0166 to i64
  %.sroa.024.sroa.17.0.insert.shift = shl nuw i64 %.sroa.024.sroa.17.0.insert.ext, 32
  %.sroa.024.sroa.0.0.insert.ext = zext i32 %.sroa.024.sroa.0.0165 to i64
...
bb.f:                                             ; preds = %bb.d, %bb.e, %.lr.ph
  ...
  %.sroa.024.sroa.0.1 = phi i32 [ %.sroa.024.sroa.0.0165, %.lr.ph ], [ %.sroa.024.sroa.0.0.extract.trunc63, %bb.d ], [ %.sroa.024.sroa.0.0.extract.trunc62, %bb.e ] ; 2 uses
  %.sroa.024.sroa.17.1 = phi i32 [ %.sroa.024.sroa.17.0166, %.lr.ph ], [ %.sroa.024.sroa.17.0.extract.trunc102, %bb.d ], [ %.sroa.024.sroa.17.0.extract.trunc100, %bb.e ] ; 2 uses
...
.lr.ph:                                           ; preds = %.preheader238, %bb.c
  ...
  %.0155275 = phi i64 [ %i.f, %bb.c ], [ 0, %.preheader238 ] ; 2 uses
  %.0169274 = phi i64 [ %i.e, %bb.c ], [ 0, %.preheader238 ] ; 2 uses
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 %.0155275 ; 4 uses
...
bb.c:                                             ; preds = %.lr.ph
  ...
  %i.aw = getelementptr inbounds nuw i8, ptr %2, i64 %.0169274 ; 3 uses
...
.thread:                                          ; preds = %bb.c, %.lr.ph, %.preheader238
  %.0169.lcssa = phi i64 [ 0, %.preheader238 ], [ %.0169274, %.lr.ph ], [ %i.e, %bb.c ] ; 3 uses
  %.0155.lcssa = phi i64 [ 0, %.preheader238 ], [ %.0155275, %.lr.ph ], [ %i.f, %bb.c ] ; 2 uses
