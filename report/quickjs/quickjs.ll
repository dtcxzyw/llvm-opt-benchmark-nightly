...
bb.h:                                             ; preds = %js_dup.exit.i.i
  %i.y = tail call fastcc { i64, i64 } @JS_ToNumberHintFree(ptr noundef %0, i64 %.sroa.012.0.in.i.i.i, i64 %.sroa.6.0.i.i.i, i32 noundef 0), !inline_history !1238 ; 2 uses
...
JS_ToIndex.exit:                                  ; preds = %bb.f, %bb.i
  %i.ad = tail call { i64, i64 } (ptr, ptr, ...) @JS_ThrowRangeError(ptr noundef %0, ptr noundef nonnull @.str.54), !inline_history !1239 ; 0 uses
...
bb.j:                                             ; preds = %bb.i, %bb.e
  ...
  %i.ag = tail call fastcc { i64, i64 } @js_array_buffer_constructor3(ptr noundef %0, i64 0, i64 3, i64 noundef %i.af, ptr noundef null, i32 noundef 20, ptr noundef null, ptr noundef nonnull @js_array_buffer_realloc, ptr noundef null, i1 noundef zeroext true), !inline_history !1240 ; 2 uses
...
bb.r:                                             ; preds = %js_dup.exit.i.i136
  %i.bi = tail call fastcc { i64, i64 } @JS_ToNumberHintFree(ptr noundef %0, i64 %.sroa.012.0.in.i.i.i137, i64 %.sroa.6.0.i.i.i138, i32 noundef 0), !inline_history !1238 ; 2 uses
...
.thread.i141:                                     ; preds = %bb.s, %bb.p
  %i.bn = tail call { i64, i64 } (ptr, ptr, ...) @JS_ThrowRangeError(ptr noundef %0, ptr noundef nonnull @.str.54), !inline_history !1239 ; 0 uses
  br label %JS_FreeValue.exit
...
bb.t:                                             ; preds = %JS_ToIndex.exit149
  %i.bq = tail call { i64, i64 } (ptr, ptr, ...) @JS_ThrowTypeError(ptr noundef %0, ptr noundef nonnull @.str.965), !inline_history !1236 ; 0 uses
  br label %JS_FreeValue.exit
...
bb.y:                                             ; preds = %bb.x
  ...
  %.val = load i32, ptr %i.cc, align 4, !tbaa !1066
...
bb.ac:                                            ; preds = %bb.ab
  %i.cm = tail call { i64, i64 } (ptr, ptr, ...) @JS_ThrowTypeError(ptr noundef %0, ptr noundef nonnull @.str.965), !inline_history !1236 ; 0 uses
  br label %JS_FreeValue.exit
...
bb.aj:                                            ; preds = %bb.ah
  ...
  %i.dl = tail call fastcc { i64, i64 } @js_create_from_ctor(ptr noundef %0, i64 %1, i64 %2, i32 noundef %5), !inline_history !1241 ; 2 uses
...
bb.ak:                                            ; preds = %bb.aj
  %i.dq = tail call fastcc { i64, i64 } @JS_GetPropertyInternal(ptr noundef %0, i64 %i.ap, i64 %i.j, i32 noundef 228, i64 %i.ap, i64 %i.j, i1 noundef zeroext false), !inline_history !1242 ; 2 uses
...
bb.al:                                            ; preds = %bb.ak
  ...
  %i.dy = tail call fastcc { i64, i64 } @JS_NewObjectFromShape(ptr noundef %0, ptr noundef %i.du, i32 noundef 2, ptr noundef null), !inline_history !1243 ; 2 uses
...
bb.an:                                            ; preds = %bb.al
  %i.ed = tail call fastcc { i64, i64 } @JS_CallInternal(ptr noundef nonnull %0, i64 %i.dr, i64 %i.ds, i64 %i.ap, i64 %i.j, i64 0, i64 3, i32 noundef 0, ptr noundef null, i32 noundef 2), !inline_history !1244 ; 2 uses
...
bb.aq:                                            ; preds = %bb.ap
  tail call fastcc void @js_free_value_rt(ptr noundef %i.eh, i64 %i.ee, i64 %i.ef), !inline_history !1245
  br label %JS_GetIterator2.exit.thread.i.i

JS_GetIterator2.exit.thread.i.i:                  ; preds = %bb.aq, %bb.ap, %bb.ao
  %i.eo = tail call { i64, i64 } (ptr, ptr, ...) @JS_ThrowTypeError(ptr noundef nonnull %0, ptr noundef nonnull @.str.118), !inline_history !1246 ; 0 uses
  br label %.thread.i.i
...
bb.ar:                                            ; preds = %JS_GetIterator2.exit.i.i
  %i.er = tail call fastcc { i64, i64 } @JS_GetPropertyInternal(ptr noundef nonnull %0, i64 %i.ee, i64 %i.ef, i32 noundef 114, i64 %i.ee, i64 %i.ef, i1 noundef zeroext false), !inline_history !1247 ; 2 uses
...
.preheader.i.i:                                   ; preds = %bb.ar
  %i.ew = call fastcc { i64, i64 } @JS_IteratorNext(ptr noundef nonnull %0, i64 %i.ee, i64 %i.ef, i64 %i.es, i64 %i.et, i32 noundef 0, ptr noundef null, ptr noundef nonnull %i.a), !inline_history !1248 ; 2 uses
...
bb.at:                                            ; preds = %bb.as
  ...
  %i.fh = tail call i32 @JS_DefinePropertyValueValue(ptr noundef nonnull %0, i64 %i.dz, i64 %i.ea, i64 %.sroa.0.0.insert.ext.i.pn.i.i.i.i, i64 %.sroa.3.0.i.i.i.i, ptr noundef nonnull byval(%struct.JSValue) align 8 %6, i32 noundef 16391), !inline_history !1249
...
bb.au:                                            ; preds = %bb.at
  ...
  %i.fk = call fastcc { i64, i64 } @JS_IteratorNext(ptr noundef nonnull %0, i64 %i.ee, i64 %i.ef, i64 %i.es, i64 %i.et, i32 noundef 0, ptr noundef null, ptr noundef nonnull %i.a), !inline_history !1248 ; 2 uses
...
bb.bn:                                            ; preds = %bb.bm
  tail call fastcc void @js_free_value_rt(ptr noundef %i.is, i64 %.sroa.024.0.i, i64 %.sroa.9.0.i), !inline_history !1251
...
bb.bp:                                            ; preds = %bb.bo
  tail call fastcc void @js_free_value_rt(ptr noundef %i.jc, i64 %.sroa.024.1.i, i64 %.sroa.9.1.i), !inline_history !1251
  br label %JS_FreeValue.exit76.i
...
bb.br:                                            ; preds = %bb.bq
  tail call fastcc void @js_free_value_rt(ptr noundef %i.jl, i64 %i.dm, i64 %i.dn), !inline_history !1251
  br label %js_typed_array_constructor_obj.exit
...
JS_FreeValue.exit151:                             ; preds = %JS_FreeValue.exit150, %bb.ca, %bb.cb
  %i.ld = tail call { i64, i64 } (ptr, ptr, ...) @JS_ThrowTypeError(ptr noundef nonnull %0, ptr noundef nonnull @.str.965), !inline_history !1236 ; 0 uses
  br label %JS_FreeValue.exit
...
typed_array_is_oob.exit.thread:                   ; preds = %bb.e, %bb.c, %get_typed_array.exit, %typed_array_is_oob.exit
  %i.aq = tail call { i64, i64 } (ptr, ptr, ...) @JS_ThrowTypeError(ptr noundef %0, ptr noundef nonnull @.str.967), !inline_history !1256 ; 0 uses
  br label %bb.l
...
begin_hunk_2_@js_atof:bb.a
  br i1 %or.cond.i251.2, label %js_to_digit.exit256.thread352.2, label %.thread355

js_to_digit.exit256.thread352.2:                  ; preds = %js_to_digit.exit256.thread352.1
  %i.jf = getelementptr inbounds nuw i8, ptr %.2.i554, i64 3 ; 2 uses
  ...
  br i1 %or.cond.i251.3, label %js_to_digit.exit256.thread352.3, label %.thread355

js_to_digit.exit256.thread352.3:                  ; preds = %js_to_digit.exit256.thread352.2
  %i.jl = getelementptr inbounds nuw i8, ptr %.2.i554, i64 4 ; 2 uses
  ...
  br i1 %or.cond.i251.4, label %js_to_digit.exit256.thread352.4, label %.thread355

js_to_digit.exit256.thread352.4:                  ; preds = %js_to_digit.exit256.thread352.3
  %i.jr = getelementptr inbounds nuw i8, ptr %.2.i554, i64 5 ; 2 uses
  ...
  br i1 %or.cond.i251.5, label %js_to_digit.exit256.thread352.5, label %.thread355

js_to_digit.exit256.thread352.5:                  ; preds = %js_to_digit.exit256.thread352.4
  %i.jx = getelementptr inbounds nuw i8, ptr %.2.i554, i64 6 ; 2 uses
  ...
  br i1 %or.cond.i251.6, label %js_to_digit.exit256.thread352.6, label %.thread355

js_to_digit.exit256.thread352.6:                  ; preds = %js_to_digit.exit256.thread352.5
  %i.kd = getelementptr inbounds nuw i8, ptr %.2.i554, i64 7 ; 2 uses
  ...
  br i1 %or.cond.i251.7, label %js_to_digit.exit256.thread352.7, label %.thread355

js_to_digit.exit256.thread352.7:                  ; preds = %js_to_digit.exit256.thread352.6
  %i.kj = getelementptr inbounds nuw i8, ptr %.2.i554, i64 8 ; 2 uses
  ...
  br i1 %or.cond.i251.8, label %js_to_digit.exit256.thread352.8, label %.thread355

js_to_digit.exit256.thread352.8:                  ; preds = %js_to_digit.exit256.thread352.7
  %i.kp = mul nuw nsw i32 %i.kl, 10
  %i.kq = add nuw nsw i32 %i.ko, %i.kp
  br label %.thread355

.thread355:                                       ; preds = %js_to_digit.exit256.thread352, %js_to_digit.exit256.thread352.1, %js_to_digit.exit256.thread352.2, %js_to_digit.exit256.thread352.3, %js_to_digit.exit256.thread352.4, %js_to_digit.exit256.thread352.5, %js_to_digit.exit256.thread352.6, %js_to_digit.exit256.thread352.7, %js_to_digit.exit256.thread352.8
  %.091.i410 = phi i32 [ %i.kq, %js_to_digit.exit256.thread352.8 ], [ %i.kl, %js_to_digit.exit256.thread352.7 ], [ %i.kf, %js_to_digit.exit256.thread352.6 ], [ %i.jz, %js_to_digit.exit256.thread352.5 ], [ %i.jt, %js_to_digit.exit256.thread352.4 ], [ %i.jn, %js_to_digit.exit256.thread352.3 ], [ %i.jh, %js_to_digit.exit256.thread352.2 ], [ %i.jb, %js_to_digit.exit256.thread352.1 ], [ %i.iu, %js_to_digit.exit256.thread352 ] ; 4 uses
  %.088.i408 = phi i64 [ 9, %js_to_digit.exit256.thread352.8 ], [ 8, %js_to_digit.exit256.thread352.7 ], [ 7, %js_to_digit.exit256.thread352.6 ], [ 6, %js_to_digit.exit256.thread352.5 ], [ 5, %js_to_digit.exit256.thread352.4 ], [ 4, %js_to_digit.exit256.thread352.3 ], [ 3, %js_to_digit.exit256.thread352.2 ], [ 2, %js_to_digit.exit256.thread352.1 ], [ 1, %js_to_digit.exit256.thread352 ] ; 2 uses
  %.3.i406 = phi ptr [ %scevgep555, %js_to_digit.exit256.thread352.8 ], [ %i.kj, %js_to_digit.exit256.thread352.7 ], [ %i.kd, %js_to_digit.exit256.thread352.6 ], [ %i.jx, %js_to_digit.exit256.thread352.5 ], [ %i.jr, %js_to_digit.exit256.thread352.4 ], [ %i.jl, %js_to_digit.exit256.thread352.3 ], [ %i.jf, %js_to_digit.exit256.thread352.2 ], [ %i.iz, %js_to_digit.exit256.thread352.1 ], [ %i.iv, %js_to_digit.exit256.thread352 ] ; 2 uses
  switch i32 %.084.i553, label %.lr.ph.i [
    i32 1, label %bb.cs
    i32 0, label %js_mp_mul1.exit250
  ]

.lr.ph.i:                                         ; preds = %.thread355
  %i.kr = getelementptr inbounds nuw [4 x i8], ptr @js_pow_dec, i64 %.088.i408
  %i.ks = load i32, ptr %i.kr, align 4, !tbaa !8
  %i.kt = zext i32 %i.ks to i64                   ; 3 uses
  %i.ku = zext nneg i32 %.091.i410 to i64
  %wide.trip.count.i = zext i32 %.084.i553 to i64 ; 2 uses
  %xtraiter561 = and i64 %wide.trip.count.i, 1
  %unroll_iter565 = and i64 %wide.trip.count.i, 4294967294
  br label %bb.cr

bb.cr:                                            ; preds = %bb.cr, %.lr.ph.i
  %indvars.iv.i246 = phi i64 [ 0, %.lr.ph.i ], [ %indvars.iv.next.i248.1, %bb.cr ] ; 3 uses
  %.013.i247 = phi i64 [ %i.ku, %.lr.ph.i ], [ %i.lj, %bb.cr ]
  %niter566 = phi i64 [ 0, %.lr.ph.i ], [ %niter566.next.1, %bb.cr ]
  ...
  %i.kz = add nuw i64 %i.ky, %.013.i247           ; 2 uses
  ...
  br i1 %niter566.ncmp.1, label %._crit_edge.loopexit.i.unr-lcssa, label %bb.cr, !llvm.loop !1449

._crit_edge.loopexit.i.unr-lcssa:                 ; preds = %bb.cr
  %lcmp.mod562.not = icmp eq i64 %xtraiter561, 0
  br i1 %lcmp.mod562.not, label %._crit_edge.loopexit.i, label %.epil.preheader

.epil.preheader:                                  ; preds = %._crit_edge.loopexit.i.unr-lcssa
  %lcmp.mod564 = trunc i32 %.084.i553 to i1
...
.split92.i:                                       ; preds = %bb.cs
  %i.lu = getelementptr inbounds nuw [4 x i8], ptr @js_pow_dec, i64 %.088.i408
  %i.lv = load i32, ptr %i.lu, align 4, !tbaa !8
  %i.lw = zext i32 %i.lv to i64
  %i.lx = zext nneg i32 %.091.i410 to i64
...
bb.ct:                                            ; preds = %bb.cs
  store i32 %.091.i410, ptr %i.iq, align 4, !tbaa !8
  br label %bb.cv

js_mp_mul1.exit250:                               ; preds = %.thread355, %._crit_edge.loopexit.i, %.split92.i
  %phi.call.i = phi i32 [ %i.md, %.split92.i ], [ %.091.i410, %.thread355 ], [ %i.lr, %._crit_edge.loopexit.i ] ; 2 uses
  %.not98.i = icmp eq i32 %phi.call.i, 0
  br i1 %.not98.i, label %bb.cv, label %bb.cu

bb.cu:                                            ; preds = %js_mp_mul1.exit250
  %i.me = add nsw i32 %.084.i553, 1
  %i.mf = sext i32 %.084.i553 to i64
...
bb.cv:                                            ; preds = %bb.cu, %js_mp_mul1.exit250, %bb.ct
  %.185.i = phi i32 [ 1, %bb.ct ], [ %i.me, %bb.cu ], [ %.084.i553, %js_mp_mul1.exit250 ] ; 2 uses
  %i.mh = load i8, ptr %.3.i406, align 1, !tbaa !35
  %i.mi = zext i8 %i.mh to i32
  %i.mj = add nsw i32 %i.mi, -48                  ; 2 uses
  %or.cond.i251 = icmp ugt i32 %i.mj, 9
  br i1 %or.cond.i251, label %js_to_digit.exit256.thread, label %js_to_digit.exit256.thread352

js_to_digit.exit256.thread:                       ; preds = %bb.cv, %bb.cq
  %.084.i.lcssa = phi i32 [ 1, %bb.cq ], [ %.185.i, %bb.cv ] ; 3 uses
  %i.mk = sext i32 %.084.i.lcssa to i64
...
bb.cw:                                            ; preds = %js_to_digit.exit256.thread
  %i.mo = add nsw i32 %.084.i.lcssa, 1
  store i32 0, ptr %i.ml, align 4, !tbaa !8
  br label %bb.cx

bb.cx:                                            ; preds = %bb.cw, %js_to_digit.exit256.thread
  %.286.i = phi i32 [ %i.mo, %bb.cw ], [ %.084.i.lcssa, %js_to_digit.exit256.thread ] ; 2 uses
  store i32 %.286.i, ptr %i.hq, align 8, !tbaa !8
  br label %.loopexit
...
bb.dd:                                            ; preds = %bb.dc, %js_to_digit.exit244
  ...
  %exitcond470.not = icmp eq i64 %indvars.iv.next467, %i.gp
  br i1 %exitcond470.not, label %.loopexit, label %.lr.ph419, !llvm.loop !1450

.loopexit:                                        ; preds = %bb.dd, %bb.cy, %bb.cx
  %i.no = phi i32 [ %.286.i, %bb.cx ], [ %i.hb, %bb.cy ], [ %i.hb, %bb.dd ] ; 3 uses
  %i.np = getelementptr inbounds nuw i8, ptr %i.hq, i64 4
  %i.nq = icmp sgt i32 %i.no, 1
  br i1 %i.nq, label %.lr.ph425, label %js_bigint_normalize.exit

.lr.ph425:                                        ; preds = %.loopexit, %bb.df
  %.019.i.i423 = phi i32 [ %i.oa, %bb.df ], [ %i.no, %.loopexit ] ; 5 uses
  %i.nr = zext nneg i32 %.019.i.i423 to i64
  ...
  br i1 %or.cond.i.i, label %._crit_edge426, label %bb.de

bb.de:                                            ; preds = %.lr.ph425
  %i.nw = and i32 %i.nu, 1
  ...
  br i1 %.not.i.i238, label %bb.df, label %._crit_edge426

bb.df:                                            ; preds = %bb.de
  %i.oa = add nsw i32 %.019.i.i423, -1
  %i.ob = icmp sgt i32 %.019.i.i423, 2
  br i1 %i.ob, label %.lr.ph425, label %._crit_edge426, !llvm.loop !1451

._crit_edge426:                                   ; preds = %bb.df, %.lr.ph425, %bb.de
  %.019.i.i.lcssa = phi i32 [ %.019.i.i423, %bb.de ], [ 1, %bb.df ], [ %.019.i.i423, %.lr.ph425 ] ; 3 uses
  %.not21.i.i = icmp eq i32 %.019.i.i.lcssa, %i.no
  br i1 %.not21.i.i, label %js_bigint_normalize.exit, label %bb.dg

bb.dg:                                            ; preds = %._crit_edge426
  store i32 %.019.i.i.lcssa, ptr %i.hq, align 8, !tbaa !8
  %i.oc = zext nneg i32 %.019.i.i.lcssa to i64
  %i.od = shl nuw nsw i64 %i.oc, 2
  %i.oe = add nuw nsw i64 %i.od, 4
  %i.of = tail call ptr @js_realloc(ptr noundef %0, ptr noundef nonnull %i.hq, i64 noundef %i.oe), !inline_history !1452 ; 2 uses
  %.not22.i.i = icmp eq ptr %i.of, null
  %spec.select.i.i = select i1 %.not22.i.i, ptr %i.hq, ptr %i.of
  br label %js_bigint_normalize.exit

js_bigint_normalize.exit:                         ; preds = %.loopexit, %._crit_edge426, %bb.dg
  %.1.i.i = phi ptr [ %spec.select.i.i, %bb.dg ], [ %i.hq, %._crit_edge426 ], [ %i.hq, %.loopexit ] ; 3 uses
...
bb.dh:                                            ; preds = %js_bigint_normalize.exit
  ...
  %i.oh = call fastcc ptr @js_bigint_add(ptr noundef %0, ptr noundef nonnull %5, ptr noundef nonnull %.1.i.i, i32 noundef 1), !inline_history !1453
...
js_bigint_from_string.exit:                       ; preds = %js_bigint_normalize.exit, %bb.dh
  ...
  br i1 %.not195, label %.split366, label %bb.di
...
.split366:                                        ; preds = %bb.dk, %bb.dj, %bb.co, %bb.cn, %bb.cg, %bb.ce, %js_bigint_from_string.exit, %bb.ca
  ...
  br i1 %i.ex, label %bb.dn, label %.thread359
...
bb.dn:                                            ; preds = %.split366, %bb.dm
  %.sroa.8.1369 = phi i64 [ %spec.select201, %.split366 ], [ %.sroa.3.0.i, %bb.dm ]
  %i.op = phi i64 [ %spec.select, %.split366 ], [ %.sroa.0.0.insert.ext.i.pn.i, %bb.dm ]
  %.10367 = phi ptr [ %.9343, %.split366 ], [ %.8, %bb.dm ]
...
.thread359:                                       ; preds = %bb.dq, %bb.dp, %.critedge27, %js_to_digit.exit219.thread330, %js_to_digit.exit, %js__strstart.exit, %.split366, %bb.dn, %bb.dm
  %.sroa.8.1365 = phi i64 [ %spec.select201, %.split366 ], [ %.sroa.8.1369, %bb.dn ], [ %.sroa.3.0.i, %bb.dm ], [ 8, %js_to_digit.exit ], [ 8, %js_to_digit.exit219.thread330 ], [ 8, %.critedge27 ], [ 8, %js__strstart.exit ], [ 6, %bb.dp ], [ 6, %bb.dq ]
  %i.os = phi i64 [ %spec.select, %.split366 ], [ %i.op, %bb.dn ], [ %.sroa.0.0.insert.ext.i.pn.i, %bb.dm ], [ 9221120237041090560, %js_to_digit.exit ], [ 9221120237041090560, %js_to_digit.exit219.thread330 ], [ 9221120237041090560, %.critedge27 ], [ %i.ba, %js__strstart.exit ], [ 0, %bb.dp ], [ 0, %bb.dq ]
  %.10364 = phi ptr [ %.9343, %.split366 ], [ %.10367, %bb.dn ], [ %.8, %bb.dm ], [ %.2292, %js_to_digit.exit ], [ %i.dn, %js_to_digit.exit219.thread330 ], [ %.8, %.critedge27 ], [ %scevgep.i, %js__strstart.exit ], [ %.8, %bb.dp ], [ %.8, %bb.dq ]
  %.not197 = icmp eq ptr %2, null
  br i1 %.not197, label %bb.dr, label %bb.do

bb.do:                                            ; preds = %.thread359
  store ptr %.10364, ptr %2, align 8, !tbaa !255
  br label %bb.dr
...
bb.dp:                                            ; preds = %bb.bo
  ...
  br i1 %i.ow, label %.thread359, label %bb.dq
...
bb.dr:                                            ; preds = %.thread359, %bb.do
  ...
  %.fca.1.insert = insertvalue { i64, i64 } %.fca.0.insert, i64 %.sroa.8.1365, 1
  ret { i64, i64 } %.fca.1.insert
}
...
begin_hunk_3_@string_buffer_concat_value:bb.a
  ...
  %i.n = load i32, ptr %i.a, align 4, !tbaa !1074
  %.not = icmp eq i32 %i.n, 0
  br i1 %.not, label %.lr.ph, label %JS_FreeValueRT.exit

bb.c:                                             ; preds = %.lr.ph
  %i.o = load ptr, ptr %0, align 8, !tbaa !1069
...
bb.d:                                             ; preds = %bb.c
  %i.u = load ptr, ptr %0, align 8, !tbaa !1069
  %i.v = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.w = load ptr, ptr %i.v, align 8, !tbaa !1076
  ...
  store i32 -1, ptr %i.a, align 4, !tbaa !1074
...
bb.e:                                             ; preds = %bb.c
  ...
  %i.ae = load ptr, ptr %0, align 8, !tbaa !1069
...
str16.exit:                                       ; preds = %bb.k, %bb.l, %bb.m
  ...
  %i.bf = tail call fastcc i32 @string_buffer_write16(ptr noundef nonnull %0, ptr noundef %.0.i.i27, i32 noundef %i.aq), !inline_history !1473
  br label %JS_FreeValueRT.exit
...
str8.exit:                                        ; preds = %bb.p, %bb.q, %bb.r
  ...
  %i.bq = tail call fastcc i32 @string_buffer_write8(ptr noundef nonnull %0, ptr noundef %.0.i.i, i32 noundef %i.aq), !inline_history !1473
  br label %JS_FreeValueRT.exit
...
str8.exit:                                        ; preds = %bb.i, %bb.j, %bb.k
  ...
  %i.ak = load i32, ptr %i.aj, align 4, !tbaa !1071
  %i.al = icmp sgt i32 %i.ai, %i.ak
  br i1 %i.al, label %bb.m, label %bb.n

bb.m:                                             ; preds = %str8.exit
  %i.am = tail call fastcc i32 @string_buffer_realloc(ptr noundef nonnull %0, i32 noundef %i.ai, i32 noundef 0), !inline_history !1474
  %.not.i = icmp eq i32 %i.am, 0
  br i1 %.not.i, label %bb.n, label %string_buffer_write8.exit

bb.n:                                             ; preds = %bb.m, %str8.exit
  %i.an = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.ao = load i32, ptr %i.an, align 8, !tbaa !1073
...
.lr.ph:                                           ; preds = %.preheader
  ...
  %i.ar = load ptr, ptr %i.aq, align 8, !tbaa !1076 ; 3 uses
...
str16.exit23:                                     ; preds = %bb.o, %bb.p, %bb.q
  ...
  %i.bh = load i32, ptr %i.ag, align 8, !tbaa !1072
  ...
  br i1 %exitcond.not, label %.loopexit, label %bb.o, !llvm.loop !1475

bb.s:                                             ; preds = %bb.n
  %i.bm = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.bn = load ptr, ptr %i.bm, align 8, !tbaa !1076 ; 5 uses
...
str8.exit20:                                      ; preds = %bb.t, %bb.u, %bb.v
  ...
  %i.cc = load i32, ptr %i.ag, align 8, !tbaa !1072
...
.loopexit:                                        ; preds = %str16.exit23, %.preheader, %str8.exit20
  %.pn.i = load i32, ptr %i.ag, align 8, !tbaa !1072
  %storemerge.i = add nsw i32 %.pn.i, %i.af
  store i32 %storemerge.i, ptr %i.ag, align 8, !tbaa !1072
  br label %string_buffer_write8.exit
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.h, label %middle.block, label %vector.body, !llvm.loop !1476
...
bb.r:                                             ; preds = %.lr.ph.i.i
  ...
  br i1 %exitcond.not.i.i, label %memcmp16_8.exit.i, label %.lr.ph.i.i, !llvm.loop !1342
...
bb.u:                                             ; preds = %.lr.ph.i31.i
  ...
  br i1 %exitcond.not.i35.i, label %js_string_memcmp_pos.exit.thread, label %.lr.ph.i31.i, !llvm.loop !1342
...
bb.w:                                             ; preds = %.lr.ph.i40.i
  ...
  br i1 %exitcond.not.i44.i, label %js_string_memcmp_pos.exit.thread, label %.lr.ph.i40.i, !llvm.loop !1343
...
.lr.ph.i79:                                       ; preds = %bb.y, %.lr.ph.i79
  ...
  %i.du = load i32, ptr %i.o, align 8, !tbaa !1605 ; 2 uses
  %i.dv = add nsw i32 %i.du, 1
  store i32 %i.dv, ptr %i.o, align 8, !tbaa !1605
...
.lr.ph.i89:                                       ; preds = %bb.aa, %.lr.ph.i89
  ...
  %i.en = load i32, ptr %i.p, align 8, !tbaa !1605 ; 2 uses
  %i.eo = add nsw i32 %i.en, 1
  store i32 %i.eo, ptr %i.p, align 8, !tbaa !1605
...
string_rope_iter_next.exit95:                     ; preds = %.lr.ph.i89, %bb.aa, %bb.z, %string_rope_iter_next.exit85
  ...
  br i1 %.not54, label %._crit_edge, label %.lr.ph, !llvm.loop !1607
...
bb.m:                                             ; preds = %bb.j
  ...
  br label %JS_ToBigIntBuf.exit71
end_hunk_4
begin_hunk_5_@js_array_pop:bb.a
...
bb.r:                                             ; preds = %bb.q
  tail call fastcc void @js_free_value_rt(ptr noundef %i.bk, i64 %.sroa.09.3, i64 %.sroa.11.3), !inline_history !143
...
bb.s:                                             ; preds = %JS_FreeValue.exit61
  %i.bv = load ptr, ptr %i.bs, align 8, !tbaa !50
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  br i1 %exitcond130.not, label %._crit_edge, label %.lr.ph109.split.us.split.us, !llvm.loop !1774
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  br i1 %exitcond129.not, label %._crit_edge, label %.lr.ph109.split.us.split, !llvm.loop !1774
...
set_value.exit103:                                ; preds = %js_dup.exit99, %bb.y, %bb.z
  ...
  br i1 %exitcond.not, label %.loopexit, label %.lr.ph, !llvm.loop !1776
...
.loopexit:                                        ; preds = %set_value.exit103, %set_value.exit, %bb.w, %bb.s, %bb.ac, %bb.ad
  ...
  br i1 %i.di, label %.lr.ph109.split, label %._crit_edge, !llvm.loop !1774
...
JS_NewAtomInt64.exit:                             ; preds = %bb.d
  ...
  br i1 %.not, label %bb.j, label %bb.e, !prof !973
...
bb.r:                                             ; preds = %bb.m, %bb.q, %bb.k, %bb.j
  ...
  %.0 = phi ptr [ null, %bb.k ], [ %i.aq, %bb.m ], [ null, %bb.q ], [ null, %bb.j ] ; 3 uses
...
bb.t:                                             ; preds = %bb.r
  store ptr %0, ptr %6, align 8, !tbaa !1069
  %i.bf = getelementptr inbounds nuw i8, ptr %6, i64 20
  store i32 %.1.sink.i.i.ph, ptr %i.bf, align 4, !tbaa !1071
  %i.bg = getelementptr inbounds nuw i8, ptr %6, i64 16
  store i32 0, ptr %i.bg, align 8, !tbaa !1072
  %i.bh = getelementptr inbounds nuw i8, ptr %6, i64 24
  store i32 0, ptr %i.bh, align 8, !tbaa !1073
  %i.bi = getelementptr inbounds nuw i8, ptr %6, i64 28
  store i32 0, ptr %i.bi, align 4, !tbaa !1074
...
bb.u:                                             ; preds = %bb.t
  %i.bu = tail call fastcc ptr @js_arena_malloc(ptr noundef nonnull %i.bk, i64 noundef %i.bl), !inline_history !1744 ; 7 uses
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.ce = tail call i64 %i.cd(ptr noundef nonnull %i.bx) #49, !inline_history !1099 ; 2 uses
...
bb.aa:                                            ; preds = %bb.z
  ...
  %i.cq = tail call { i64, i64 } (ptr, ptr, ...) @JS_ThrowInternalError(ptr noundef nonnull %0, ptr noundef nonnull @.str.46) #51, !inline_history !1100 ; 0 uses
...
.lr.ph:                                           ; preds = %.preheader, %bb.ae
  ...
  %i.da = load i64, ptr %.0, align 8
  %i.db = trunc i64 %i.da to i32
  %i.dc = and i32 %i.db, 2147483647
  %i.dd = tail call i32 @llvm.umin.i32(i32 %.098121, i32 %i.dc) ; 2 uses
  %i.de = call fastcc i32 @string_buffer_concat(ptr noundef nonnull %6, ptr noundef nonnull %.0, i32 noundef 0, i32 noundef %i.dd)
...
.thread116:                                       ; preds = %.lr.ph, %bb.ag, %bb.af, %bb.ac
  %i.dz = load ptr, ptr %6, align 8, !tbaa !1069
  %i.ea = load ptr, ptr %i.cw, align 8, !tbaa !1076
...
JS_ToStringCheckObject.exit.thread:               ; preds = %bb.a
  %i.b = tail call { i64, i64 } (ptr, ptr, ...) @JS_ThrowTypeError(ptr noundef %0, ptr noundef nonnull @.str.194), !inline_history !1551 ; 0 uses
  br label %JS_FreeValue.exit

JS_ToStringCheckObject.exit:                      ; preds = %bb.a
  %i.c = tail call fastcc { i64, i64 } @JS_ToStringInternal(ptr noundef %0, i64 %1, i64 %2, i32 noundef 0), !inline_history !1552 ; 3 uses
