...
find_hashed_shape_proto.exit.i.i:                 ; preds = %bb.w
  ...
  %i.gx = load i32, ptr %i.gw, align 4, !tbaa !191
  %i.gy = add nsw i32 %i.gx, 1
  store i32 %i.gy, ptr %i.gw, align 4, !tbaa !191
  br label %bb.y
...
bb.y:                                             ; preds = %.loopexit.i.i, %find_hashed_shape_proto.exit.i.i
  ...
  %i.ha = tail call fastcc { i64, i64 } @JS_NewObjectFromShape(ptr noundef nonnull %i.l, ptr noundef nonnull %.0.i.i.i, i32 noundef 1, ptr noundef null) #51, !inline_history !363 ; 2 uses
...
JS_NewObjectProto.exit.i:                         ; preds = %bb.y, %.loopexit.i.i
  ...
  %i.he = load ptr, ptr %i.hd, align 8, !tbaa !364
  ...
  store i64 3, ptr %i.fh, align 8, !tbaa !365
  store i32 0, ptr %4, align 8, !tbaa !218
  store i32 0, ptr %i.fi, align 4
  store i64 3, ptr %i.fj, align 8, !tbaa !365
  %i.hi = tail call i32 @JS_DefineProperty(ptr noundef nonnull %i.l, i64 %.sroa.09.0.insert.insert.i.i.i, i64 %.sroa.4.0.i.i.i, i32 noundef 58, i64 %i.hg, i64 %i.hh, ptr noundef nonnull byval(%struct.JSValue) align 8 %3, ptr noundef nonnull byval(%struct.JSValue) align 8 %4, i32 noundef 9987) #51, !inline_history !366 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %3)
  call void @llvm.lifetime.end.p0(ptr nonnull %4)
  %i.hj = load ptr, ptr %i.br, align 8, !tbaa !232 ; 3 uses
...
bb.z:                                             ; preds = %JS_NewObjectProto.exit.i
  ...
  %i.ho = load i32, ptr %i.hn, align 4, !tbaa !191 ; 2 uses
  %i.hp = add nsw i32 %i.ho, -1
  store i32 %i.hp, ptr %i.hn, align 4, !tbaa !191
  %i.hq = icmp slt i32 %i.ho, 2
  br i1 %i.hq, label %bb.aa, label %bb.ab

bb.aa:                                            ; preds = %bb.z
  tail call fastcc void @js_free_value_rt(ptr noundef %i.hj, i64 %i.hg, i64 %i.hh) #51, !inline_history !367
  %.pre.i = load ptr, ptr %i.br, align 8, !tbaa !232
  br label %bb.ab
...
bb.ab:                                            ; preds = %bb.aa, %bb.z, %JS_NewObjectProto.exit.i
  ...
  %.val.i = load ptr, ptr %i.hs, align 8, !tbaa !297
  %i.ht = getelementptr i8, ptr %.val.i, i64 384
  %.val.val.i = load ptr, ptr %i.ht, align 8, !tbaa !299 ; 2 uses
  %i.hu = ptrtoint ptr %.val.val.i to i64         ; 2 uses
  %i.hv = getelementptr inbounds i8, ptr %.val.val.i, i64 -4 ; 4 uses
  %i.hw = load i32, ptr %i.hv, align 4, !tbaa !191
  %i.hx = add nsw i32 %i.hw, 1
  store i32 %i.hx, ptr %i.hv, align 4, !tbaa !191
  call void @llvm.lifetime.start.p0(ptr nonnull %1)
  call void @llvm.lifetime.start.p0(ptr nonnull %2)
  store i32 0, ptr %1, align 8, !tbaa !218
  store i32 0, ptr %i.fk, align 4
  store i64 3, ptr %i.fl, align 8, !tbaa !365
  store i32 0, ptr %2, align 8, !tbaa !218
  store i32 0, ptr %i.fm, align 4
  store i64 3, ptr %i.fn, align 8, !tbaa !365
  %i.hy = tail call i32 @JS_DefineProperty(ptr noundef nonnull %i.l, i64 %.sroa.09.0.insert.insert.i.i.i, i64 %.sroa.4.0.i.i.i, i32 noundef 52, i64 %i.hu, i64 -7, ptr noundef nonnull byval(%struct.JSValue) align 8 %1, ptr noundef nonnull byval(%struct.JSValue) align 8 %2, i32 noundef 9987) #51, !inline_history !366 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %1)
  call void @llvm.lifetime.end.p0(ptr nonnull %2)
  %i.hz = load ptr, ptr %i.br, align 8, !tbaa !232
  %i.ia = load i32, ptr %i.hv, align 4, !tbaa !191 ; 2 uses
  %i.ib = add nsw i32 %i.ia, -1
  store i32 %i.ib, ptr %i.hv, align 4, !tbaa !191
  %i.ic = icmp slt i32 %i.ia, 2
  br i1 %i.ic, label %bb.ac, label %JS_DefinePropertyValue.exit74.i

bb.ac:                                            ; preds = %bb.ab
  tail call fastcc void @js_free_value_rt(ptr noundef %i.hz, i64 %i.hu, i64 -7) #51, !inline_history !367
...
JS_DefinePropertyValue.exit74.i:                  ; preds = %bb.ac, %bb.ab
  ...
  store i64 %.sroa.09.0.insert.insert.i.i.i, ptr %i.id, align 8, !tbaa !218
  %.sroa.6.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.id, i64 8
  store i64 %.sroa.4.0.i.i.i, ptr %.sroa.6.0..sroa_idx.i, align 8, !tbaa !240
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 9
  br i1 %exitcond.not.i, label %bb.ad, label %bb.u, !llvm.loop !1032

bb.ad:                                            ; preds = %JS_DefinePropertyValue.exit74.i
  %i.ie = load ptr, ptr %i.bq, align 8, !tbaa !350 ; 4 uses
  ...
  %i.in = load ptr, ptr %i.br, align 8, !tbaa !232 ; 2 uses
  %i.io = getelementptr i8, ptr %i.in, i64 1436
  %.val.i.i = load i32, ptr %i.io, align 4, !tbaa !256
  %i.ip = getelementptr i8, ptr %i.in, i64 1448
  %.val13.i.i = load ptr, ptr %i.ip, align 8, !tbaa !259
  ...
  %.01.i.i76.i = load ptr, ptr %i.jb, align 8, !tbaa !362 ; 2 uses
...
.lr.ph.i.i78.i:                                   ; preds = %bb.ad, %bb.ag
  ...
  %i.jd = load i32, ptr %i.jc, align 4, !tbaa !191
...
bb.af:                                            ; preds = %bb.ae
  ...
  %i.jj = load i32, ptr %i.ji, align 8, !tbaa !191
...
bb.ag:                                            ; preds = %bb.af, %bb.ae, %.lr.ph.i.i78.i
  ...
  %.0.i14.i.i = load ptr, ptr %i.jl, align 8, !tbaa !362 ; 2 uses
  %.not.i.i.i = icmp eq ptr %.0.i14.i.i, null
  br i1 %.not.i.i.i, label %.loopexit.i80.i, label %.lr.ph.i.i78.i, !llvm.loop !15

find_hashed_shape_proto.exit.i81.i:               ; preds = %bb.af
  %i.jm = getelementptr inbounds i8, ptr %.03.i.i79.i, i64 -4 ; 2 uses
  %i.jn = load i32, ptr %i.jm, align 4, !tbaa !191
  %i.jo = add nsw i32 %i.jn, 1
  store i32 %i.jo, ptr %i.jm, align 4, !tbaa !191
  br label %bb.ah
...
bb.ah:                                            ; preds = %.loopexit.i80.i, %find_hashed_shape_proto.exit.i81.i
  ...
  %i.jq = tail call fastcc { i64, i64 } @JS_NewObjectFromShape(ptr noundef nonnull %i.l, ptr noundef nonnull %.0.i.i68, i32 noundef 2, ptr noundef null), !inline_history !368 ; 2 uses
...
JS_NewObjectProtoClass.exit.i:                    ; preds = %bb.ah, %.loopexit.i80.i
  ...
  store i64 %.sroa.09.0.insert.insert.i.i, ptr %i.if, align 8, !tbaa !218
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.ie, i64 40
  store i64 %.sroa.4.0.i.i, ptr %.sroa.4.0..sroa_idx.i, align 8, !tbaa !240
  ...
  %i.jx = load ptr, ptr %i.bq, align 8, !tbaa !350 ; 2 uses
  ...
  store ptr %i.kf, ptr %i.b, align 8, !tbaa !362
...
js_new_shape_with.exit.i:                         ; preds = %.preheader.i.i.preheader.i
  %.pre.i.i.i = load ptr, ptr %i.b, align 8, !tbaa !362 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #49
  store ptr %.pre.i.i.i, ptr %i.jw, align 8, !tbaa !362
...
bb.ai:                                            ; preds = %.preheader.i.i.preheader.i
  %i.kg = load ptr, ptr %i.br, align 8, !tbaa !232
  %i.kh = load ptr, ptr %i.b, align 8, !tbaa !362 ; 2 uses
  %i.ki = getelementptr inbounds i8, ptr %i.kh, i64 -4 ; 2 uses
  %i.kj = load i32, ptr %i.ki, align 4, !tbaa !191 ; 2 uses
  %i.kk = add nsw i32 %i.kj, -1
  store i32 %i.kk, ptr %i.ki, align 4, !tbaa !191
  %i.kl = icmp slt i32 %i.kj, 2
  br i1 %i.kl, label %bb.aj, label %js_new_shape_with.exit.thread.i, !prof !192

bb.aj:                                            ; preds = %bb.ai
  tail call fastcc void @js_free_shape0(ptr noundef %i.kg, ptr noundef nonnull %i.kh), !inline_history !16
  br label %js_new_shape_with.exit.thread.i

js_new_shape_with.exit.thread.i:                  ; preds = %bb.aj, %bb.ai, %JS_NewObjectProtoClass.exit.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #49
  store ptr null, ptr %i.jw, align 8, !tbaa !362
...
bb.ak:                                            ; preds = %js_new_shape_with.exit.i
  ...
  %i.kn = load ptr, ptr %i.bq, align 8, !tbaa !350 ; 2 uses
  ...
  store ptr %i.kv, ptr %i.a, align 8, !tbaa !362
...
js_new_shape_with.exit97.i:                       ; preds = %.preheader.i.i87.2.i
  %.pre.i.i96.i = load ptr, ptr %i.a, align 8, !tbaa !362 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #49
  store ptr %.pre.i.i96.i, ptr %i.km, align 8, !tbaa !362
...
bb.al:                                            ; preds = %.preheader.i.i87.2.i, %.preheader.i.i87.1.i, %.preheader.i.i87.preheader.i
  %i.kz = load ptr, ptr %i.br, align 8, !tbaa !232
  %i.la = load ptr, ptr %i.a, align 8, !tbaa !362 ; 2 uses
  %i.lb = getelementptr inbounds i8, ptr %i.la, i64 -4 ; 2 uses
  %i.lc = load i32, ptr %i.lb, align 4, !tbaa !191 ; 2 uses
  %i.ld = add nsw i32 %i.lc, -1
  store i32 %i.ld, ptr %i.lb, align 4, !tbaa !191
  %i.le = icmp slt i32 %i.lc, 2
  br i1 %i.le, label %bb.am, label %js_new_shape_with.exit97.thread.i, !prof !192

bb.am:                                            ; preds = %bb.al
  tail call fastcc void @js_free_shape0(ptr noundef %i.kz, ptr noundef nonnull %i.la), !inline_history !16
  br label %js_new_shape_with.exit97.thread.i

js_new_shape_with.exit97.thread.i:                ; preds = %bb.am, %bb.al, %bb.ak
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #49
  store ptr null, ptr %i.km, align 8, !tbaa !362
  br label %JS_AddIntrinsicBasicObjects.exit.thread

JS_AddIntrinsicBasicObjects.exit:                 ; preds = %js_new_shape_with.exit97.i
  %i.lf = getelementptr inbounds nuw i8, ptr %i.l, i64 64
  %i.lg = load ptr, ptr %i.bq, align 8, !tbaa !350 ; 2 uses
...
bb.a:
  ...
  store i32 %i.e, ptr %i.c, align 4, !tbaa !191
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !369  ; 2 uses
...
.lr.ph:                                           ; preds = %bb.b, %.lr.ph
  ...
  %.0.i = load ptr, ptr %.0.in.i, align 8, !tbaa !222 ; 2 uses
  %i.j = getelementptr inbounds i8, ptr %.011.i95, i64 -8
  tail call fastcc void @js_free_module_def(ptr noundef nonnull %0, ptr noundef nonnull %i.j), !inline_history !17
  %.not.i = icmp eq ptr %.0.i, %i.g
  br i1 %.not.i, label %js_free_modules.exit.loopexit, label %.lr.ph, !llvm.loop !18
...
bb.d:                                             ; preds = %bb.c
  tail call fastcc void @js_free_value_rt(ptr noundef %i.k, i64 %i.m, i64 %i.o), !inline_history !370
  %.pre101 = load ptr, ptr %i.a, align 8, !tbaa !232
...
bb.f:                                             ; preds = %bb.e
  tail call fastcc void @js_free_value_rt(ptr noundef %i.w, i64 %i.y, i64 %i.aa), !inline_history !370
  %.pre102 = load ptr, ptr %i.a, align 8, !tbaa !232
...
bb.h:                                             ; preds = %bb.g
  tail call fastcc void @js_free_value_rt(ptr noundef %i.ai, i64 %i.ak, i64 %i.am), !inline_history !370
  %.pre103 = load ptr, ptr %i.a, align 8, !tbaa !232
...
bb.j:                                             ; preds = %bb.i
  tail call fastcc void @js_free_value_rt(ptr noundef %i.au, i64 %i.aw, i64 %i.ay), !inline_history !370
  %.pre104 = load ptr, ptr %i.a, align 8, !tbaa !232
...
bb.l:                                             ; preds = %bb.k
  tail call fastcc void @js_free_value_rt(ptr noundef %i.bg, i64 %i.bi, i64 %i.bk), !inline_history !370
  %.pre105 = load ptr, ptr %i.a, align 8, !tbaa !232
...
bb.n:                                             ; preds = %bb.m
  tail call fastcc void @js_free_value_rt(ptr noundef %i.bs, i64 %i.bu, i64 %i.bw), !inline_history !370
  %.pre106 = load ptr, ptr %i.a, align 8, !tbaa !232
...
bb.o:                                             ; preds = %JS_FreeValueRT.exit76
  ...
  store i32 %i.co, ptr %i.cm, align 4, !tbaa !191
end_hunk_0
...
bb.bt:                                            ; preds = %JS_FreeValue.exit277
  %i.qs = load ptr, ptr %i.bl, align 8, !tbaa !350 ; 2 uses
  ...
  store i64 %i.qv, ptr %i.qt, align 8, !tbaa !218
  %.sroa.46.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.qs, i64 808
  store i64 %i.qw, ptr %.sroa.46.0..sroa_idx, align 8, !tbaa !240
  %i.qx = load ptr, ptr %i.bl, align 8, !tbaa !350 ; 2 uses
  ...
  %i.rd = load ptr, ptr %i.bl, align 8, !tbaa !350 ; 2 uses
  ...
  %i.rl = tail call fastcc { i64, i64 } @JS_GetPropertyInternal(ptr noundef nonnull %0, i64 %i.rj, i64 %i.rk, i32 noundef 62, i64 %i.rj, i64 %i.rk, i1 noundef zeroext false), !inline_history !373 ; 2 uses
  %i.rm = extractvalue { i64, i64 } %i.rl, 0
  %i.rn = extractvalue { i64, i64 } %i.rl, 1      ; 2 uses
  store i64 %i.rm, ptr %i.ri, align 8, !tbaa !218
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 488
  store i64 %i.rn, ptr %.sroa.4.0..sroa_idx, align 8, !tbaa !240
...
bb.bv:                                            ; preds = %bb.bu
  ...
  %i.rw = load i32, ptr %i.rv, align 4, !tbaa !191
  %i.rx = add nsw i32 %i.rw, 1
  store i32 %i.rx, ptr %i.rv, align 4, !tbaa !191
...
bb.a:
  ...
  store i64 3, ptr %i.b, align 8, !tbaa !365
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.n = load i32, ptr %i.m, align 4, !tbaa !191  ; 2 uses
  %i.o = add nsw i32 %i.n, -1
  store i32 %i.o, ptr %i.m, align 4, !tbaa !191
  %i.p = icmp slt i32 %i.n, 2
  br i1 %i.p, label %bb.d, label %JS_FreeValue.exit

bb.d:                                             ; preds = %bb.c
  tail call fastcc void @js_free_value_rt(ptr noundef %i.i, i64 %i.d, i64 %i.e), !inline_history !291
...
bb.a:
  ...
  store ptr @__JS_EvalInternal, ptr %i.a, align 8, !tbaa !371
  ret i32 0
}
...
bb.a:
  ...
  store i64 %i.f, ptr %i.d, align 8, !tbaa !218
  %.sroa.46.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.c, i64 312
  store i64 %i.g, ptr %.sroa.46.0..sroa_idx, align 8, !tbaa !240
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.l = tail call { i64, i64 } @JS_NewCFunction3(ptr noundef nonnull %0, ptr noundef nonnull @js_regexp_constructor, ptr noundef nonnull @.str.58, i32 noundef 2, i32 noundef 4, i32 noundef 0, ptr noundef nonnull byval(%struct.JSValue) align 8 %i.k, i32 noundef 0), !inline_history !374 ; 2 uses
...
js_dup.exit:                                      ; preds = %bb.d, %bb.e
  store i64 %i.m, ptr %i.q, align 8, !tbaa !218
  %.sroa.42.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 152
  store i64 %i.n, ptr %.sroa.42.0..sroa_idx, align 8, !tbaa !240
...
bb.f:                                             ; preds = %js_dup.exit
  ...
  store ptr %i.ab, ptr %i.a, align 8, !tbaa !362
...
js_new_shape_with.exit:                           ; preds = %.preheader.i.i.preheader
  %.pre.i.i = load ptr, ptr %i.a, align 8, !tbaa !362 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #49
  store ptr %.pre.i.i, ptr %i.y, align 8, !tbaa !362
...
bb.g:                                             ; preds = %.preheader.i.i.preheader
  ...
  %i.ae = load ptr, ptr %i.a, align 8, !tbaa !362 ; 2 uses
  ...
  br i1 %i.ai, label %bb.h, label %js_new_shape_with.exit.thread, !prof !192

bb.h:                                             ; preds = %bb.g
  tail call fastcc void @js_free_shape0(ptr noundef %i.ad, ptr noundef nonnull %i.ae), !inline_history !16
  br label %js_new_shape_with.exit.thread

js_new_shape_with.exit.thread:                    ; preds = %bb.h, %bb.g, %bb.f
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #49
  store ptr null, ptr %i.y, align 8, !tbaa !362
  br label %bb.m

bb.i:                                             ; preds = %js_new_shape_with.exit
  %i.aj = getelementptr inbounds nuw i8, ptr %0, i64 80
  %i.ak = load ptr, ptr %i.b, align 8, !tbaa !350 ; 2 uses
...
bb.j:                                             ; preds = %bb.i
  %i.aq = load ptr, ptr %i.b, align 8, !tbaa !350 ; 4 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  store ptr @js_compile_regexp, ptr %i.bh, align 8, !tbaa !375
  br label %bb.m
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !232  ; 4 uses
  %i.c = getelementptr inbounds nuw i8, ptr %i.b, i64 1120
  %i.d = load i32, ptr %i.c, align 8, !tbaa !294
...
JS_IsRegisteredClass.exit.thread:                 ; preds = %bb.a, %JS_IsRegisteredClass.exit
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %1, i8 0, i64 40, i1 false)
  store ptr @js_proxy_finalizer, ptr %i.j, align 8, !tbaa !377
  store ptr @js_proxy_mark, ptr %i.k, align 8, !tbaa !378
...
bb.b:                                             ; preds = %JS_IsRegisteredClass.exit.thread
  ...
  store ptr @js_proxy_exotic_methods, ptr %i.p, align 8, !tbaa !254
  %i.q = getelementptr inbounds nuw i8, ptr %i.o, i64 2064
  store ptr @js_proxy_call, ptr %i.q, align 8, !tbaa !255
  br label %bb.c
...
bb.f:                                             ; preds = %bb.e, %JS_SetConstructorBit.exit
  %i.ag = load ptr, ptr %i.a, align 8, !tbaa !232
...
bb.h:                                             ; preds = %bb.g
  tail call fastcc void @js_free_value_rt(ptr noundef %i.ag, i64 %i.t, i64 %i.u), !inline_history !291
  br label %JS_FreeValue.exit
...
bb.a:
  ...
  store i64 3, ptr %i.d, align 8, !tbaa !365
...
bb.b:                                             ; preds = %bb.a
  %i.k = load ptr, ptr %i.b, align 8, !tbaa !232  ; 3 uses
...
bb.d:                                             ; preds = %bb.c
  call fastcc void @js_free_value_rt(ptr noundef %i.k, i64 %i.g, i64 %i.h), !inline_history !291
  %.val.1.pre = load ptr, ptr %i.b, align 8, !tbaa !232
  br label %bb.e
...
bb.f:                                             ; preds = %bb.e
  %i.y = load ptr, ptr %i.b, align 8, !tbaa !232  ; 3 uses
