...
.lr.ph312:                                        ; preds = %.lr.ph312.preheader, %bb.cl
  %.0.i182311 = phi i32 [ %i.xt, %bb.cl ], [ %i.wo, %.lr.ph312.preheader ] ; 5 uses
...
._crit_edge313:                                   ; preds = %bb.cl, %.lr.ph312, %bb.ck, %js_mp_neg.exit181
  %.0.i182.lcssa = phi i32 [ %i.wo, %js_mp_neg.exit181 ], [ %.0.i182311, %bb.ck ], [ %.0.i182311, %.lr.ph312 ], [ %i.xj, %bb.cl ] ; 3 uses
...
bb.cm:                                            ; preds = %._crit_edge313
  ...
  br i1 %i.yc, label %bb.cn, label %js_realloc.exit, !prof !192
...
bb.cn:                                            ; preds = %bb.cm
  ...
  br i1 %i.yg, label %js_realloc.exit, label %bb.co
