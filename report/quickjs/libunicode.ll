...
bb.m:                                             ; preds = %bb.l, %bb.k
  %.178.i.i = phi i64 [ %i.aw, %bb.k ], [ %spec.select86.i.i, %bb.l ] ; 3 uses
  %i.be = getelementptr inbounds nuw i8, ptr %.018641.i.lcssa, i64 %.18.i.i ; 2 uses
  %i.bf = getelementptr inbounds nuw i8, ptr %.018641.i.lcssa, i64 %.178.i.i ; 2 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.bj = shl i64 %.178.i.i, 1                    ; 2 uses
  %i.bk = add i64 %i.bj, 8                        ; 2 uses
  %i.bl = icmp ult i64 %i.bk, %.18016.i.i
...
.lr.ph159:                                        ; preds = %.lr.ph43.preheader.i, %.lr.ph43.i
  ...
  %i.bn = shl i64 %.019139.i158, 1
  %i.bo = and i64 %i.bn, -8                       ; 3 uses
  %i.bp = getelementptr inbounds nuw i8, ptr %.018641.i156, i64 %i.bo ; 3 uses
  %i.bq = shl i64 %i.bo, 1
  %i.br = getelementptr inbounds nuw i8, ptr %.018641.i156, i64 %i.bq ; 3 uses
  %i.bs = mul i64 %i.bo, 3
  %i.bt = getelementptr inbounds nuw i8, ptr %.018641.i156, i64 %i.bs ; 3 uses
...
med3.exit.i:                                      ; preds = %bb.r, %bb.q, %bb.p, %bb.o
  ...
  call void %.0.i104.i(ptr noundef nonnull %.018641.i156, ptr noundef nonnull %i.ce, i64 noundef 8) #21, !inline_history !80
  %i.cf = getelementptr inbounds nuw i8, ptr %.018641.i156, i64 8 ; 2 uses
  %i.cg = shl i64 %.019139.i158, 3
  %i.ch = getelementptr inbounds nuw i8, ptr %.018641.i156, i64 %i.cg ; 5 uses
  br label %bb.s

bb.s:                                             ; preds = %bb.z, %med3.exit.i
  %.0183.i = phi ptr [ %i.cf, %med3.exit.i ], [ %i.dc, %bb.z ] ; 3 uses
  %.0180.i = phi ptr [ %i.ch, %med3.exit.i ], [ %i.ct, %bb.z ] ; 3 uses
  %.0177.i = phi ptr [ %i.cf, %med3.exit.i ], [ %.1178.lcssa.i, %bb.z ] ; 2 uses
  %.0174.i = phi ptr [ %i.ch, %med3.exit.i ], [ %.117524.i, %bb.z ] ; 2 uses
  %.0172.i = phi i64 [ 1, %med3.exit.i ], [ %i.db, %bb.z ] ; 2 uses
  %.0169.i = phi i64 [ 1, %med3.exit.i ], [ %.1170.lcssa.i, %bb.z ] ; 2 uses
  %.0167.i = phi i64 [ %.019139.i158, %med3.exit.i ], [ %.116825.i, %bb.z ] ; 2 uses
  %i.ci = icmp ult ptr %.0183.i, %.0180.i
  br i1 %i.ci, label %.lr.ph.i, label %.critedge.i

.lr.ph.i:                                         ; preds = %bb.s, %bb.v
  %.117015.i = phi i64 [ %.2171.i, %bb.v ], [ %.0169.i, %bb.s ] ; 3 uses
  %.117314.i = phi i64 [ %i.co, %bb.v ], [ %.0172.i, %bb.s ] ; 2 uses
  %.117813.i = phi ptr [ %.2179.i, %bb.v ], [ %.0177.i, %bb.s ] ; 4 uses
  %.118412.i = phi ptr [ %i.cp, %bb.v ], [ %.0183.i, %bb.s ] ; 4 uses
  %i.cj = load i32, ptr %.018641.i156, align 4, !tbaa !9 ; 2 uses
  %i.ck = load i32, ptr %.118412.i, align 4, !tbaa !9 ; 2 uses
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.cm = add i64 %.117015.i, 1
  %i.cn = getelementptr inbounds nuw i8, ptr %.117813.i, i64 8
  br label %bb.v

bb.v:                                             ; preds = %bb.u, %bb.t
  %.2179.i = phi ptr [ %i.cn, %bb.u ], [ %.117813.i, %bb.t ] ; 2 uses
  %.2171.i = phi i64 [ %i.cm, %bb.u ], [ %.117015.i, %bb.t ] ; 2 uses
  %i.co = add i64 %.117314.i, 1                   ; 2 uses
  %i.cp = getelementptr inbounds nuw i8, ptr %.118412.i, i64 8 ; 3 uses
  %i.cq = icmp ult ptr %i.cp, %.0180.i
  br i1 %i.cq, label %.lr.ph.i, label %.critedge.i, !llvm.loop !81

.critedge.i:                                      ; preds = %bb.v, %.lr.ph.i, %bb.s
  %.1184.lcssa.i = phi ptr [ %.0183.i, %bb.s ], [ %.118412.i, %.lr.ph.i ], [ %i.cp, %bb.v ] ; 7 uses
  %.1178.lcssa.i = phi ptr [ %.0177.i, %bb.s ], [ %.117813.i, %.lr.ph.i ], [ %.2179.i, %bb.v ] ; 2 uses
  %.1173.lcssa.i = phi i64 [ %.0172.i, %bb.s ], [ %.117314.i, %.lr.ph.i ], [ %i.co, %bb.v ] ; 3 uses
  %.1170.lcssa.i = phi i64 [ %.0169.i, %bb.s ], [ %.117015.i, %.lr.ph.i ], [ %.2171.i, %bb.v ] ; 2 uses
  %i.cr = getelementptr inbounds i8, ptr %.0180.i, i64 -8 ; 2 uses
  %i.cs = icmp ult ptr %.1184.lcssa.i, %i.cr
...
.lr.ph26.i:                                       ; preds = %.critedge.i, %bb.y
  ...
  %i.cu = load i32, ptr %.018641.i156, align 4, !tbaa !9 ; 2 uses
...
bb.x:                                             ; preds = %bb.w
  %i.cx = add i64 %.116825.i, -1
  %i.cy = getelementptr inbounds i8, ptr %.117524.i, i64 -8 ; 2 uses
  call void %.0.i104.i(ptr noundef nonnull %i.cy, ptr noundef nonnull %i.ct, i64 noundef 8) #21, !inline_history !80
  br label %bb.y

bb.y:                                             ; preds = %bb.x, %bb.w
  %.2176.i = phi ptr [ %i.cy, %bb.x ], [ %.117524.i, %bb.w ] ; 2 uses
  %.2.i = phi i64 [ %i.cx, %bb.x ], [ %.116825.i, %bb.w ] ; 2 uses
  %i.cz = getelementptr inbounds i8, ptr %i.ct, i64 -8 ; 2 uses
  %i.da = icmp ult ptr %.1184.lcssa.i, %i.cz
  br i1 %i.da, label %.lr.ph26.i, label %.critedge3.i, !llvm.loop !82

bb.z:                                             ; preds = %.lr.ph26.i
  call void %.0.i104.i(ptr noundef %.1184.lcssa.i, ptr noundef nonnull %i.ct, i64 noundef 8) #21, !inline_history !80
  %i.db = add i64 %.1173.lcssa.i, 1
  %i.dc = getelementptr inbounds nuw i8, ptr %.1184.lcssa.i, i64 8
  br label %bb.s
...
.critedge3.i:                                     ; preds = %.critedge.i, %bb.y
  ...
  %i.dd = ptrtoint ptr %.1178.lcssa.i to i64      ; 2 uses
  %i.de = ptrtoint ptr %.018641.i156 to i64
  %i.df = sub i64 %i.dd, %i.de
  %i.dg = ptrtoint ptr %.1184.lcssa.i to i64      ; 2 uses
  %i.dh = sub i64 %i.dg, %i.dd
  %i.di = sub i64 %.1173.lcssa.i, %.1170.lcssa.i  ; 3 uses
  %spec.select.i = call i64 @llvm.umin.i64(i64 %i.df, i64 %i.dh) ; 2 uses
  %i.dj = sub i64 0, %spec.select.i
  %i.dk = getelementptr inbounds i8, ptr %.1184.lcssa.i, i64 %i.dj
  call void %.0.i209.i(ptr noundef nonnull %.018641.i156, ptr noundef %i.dk, i64 noundef %spec.select.i) #21, !inline_history !80
  %i.dl = ptrtoint ptr %i.ch to i64
  %i.dm = ptrtoint ptr %.1175.lcssa.i to i64      ; 2 uses
  %i.dn = sub i64 %i.dl, %i.dm
  %i.do = sub i64 %i.dm, %i.dg                    ; 2 uses
  %i.dp = sub i64 0, %i.do
  %i.dq = getelementptr inbounds i8, ptr %i.ch, i64 %i.dp ; 2 uses
  %i.dr = sub i64 %.1168.lcssa.i, %.1173.lcssa.i  ; 3 uses
  %.1.i = call i64 @llvm.umin.i64(i64 %i.dn, i64 %i.do) ; 2 uses
  %i.ds = sub i64 0, %.1.i
  %i.dt = getelementptr inbounds i8, ptr %i.ch, i64 %i.ds
  call void %.0.i209.i(ptr noundef %.1184.lcssa.i, ptr noundef nonnull %i.dt, i64 noundef %.1.i) #21, !inline_history !80
...
bb.ab:                                            ; preds = %bb.aa, %.critedge3.i
  %.sink71.i = phi ptr [ %i.dq, %bb.aa ], [ %.018641.i156, %.critedge3.i ]
  %.sink.i = phi i64 [ %i.dr, %bb.aa ], [ %i.di, %.critedge3.i ]
  %.1192.i = phi i64 [ %i.di, %bb.aa ], [ %i.dr, %.critedge3.i ] ; 4 uses
  %.1187.i = phi ptr [ %.018641.i156, %bb.aa ], [ %i.dq, %.critedge3.i ] ; 3 uses
  store ptr %.sink71.i, ptr %.118940.i157, align 8, !tbaa !69
  %i.dv = getelementptr inbounds nuw i8, ptr %.118940.i157, i64 8
  store i64 %.sink.i, ptr %i.dv, align 8, !tbaa !71
  %i.dw = getelementptr inbounds nuw i8, ptr %.118940.i157, i64 16
  store i32 %i.bm, ptr %i.dw, align 8, !tbaa !72
  %.2190.i = getelementptr inbounds nuw i8, ptr %.118940.i157, i64 24 ; 3 uses
  %i.dx = icmp ugt i64 %.1192.i, 6
...
heapsortx.exit.i:                                 ; preds = %bb.ab, %bb.g
  ...
  %.01868.i = phi ptr [ %i.o, %bb.g ], [ %.1187.i, %bb.ab ] ; 4 uses
  %.2193.i = phi i64 [ %i.q, %bb.g ], [ %.1192.i, %bb.ab ] ; 2 uses
  %i.dy = shl nuw nsw i64 %.2193.i, 3
  %i.dz = getelementptr inbounds nuw i8, ptr %.01868.i, i64 %i.dy
  %i.ea = icmp samesign ugt i64 %.2193.i, 1
...
.preheader.i:                                     ; preds = %.critedge5.i, %.preheader.preheader.i
  ...
  %2 = icmp ugt ptr %.218551.i, %.01868.i
  br i1 %2, label %.lr.ph48.i, label %.critedge5.i

.lr.ph48.i:                                       ; preds = %.preheader.i, %bb.ac
  %.218247.i = phi ptr [ %i.eb, %bb.ac ], [ %.218551.i, %.preheader.i ] ; 3 uses
  %i.eb = getelementptr inbounds i8, ptr %.218247.i, i64 -8 ; 4 uses
  %i.ec = load i32, ptr %i.eb, align 4, !tbaa !9
  %i.ed = load i32, ptr %.218247.i, align 4, !tbaa !9
  %i.ee = icmp ugt i32 %i.ec, %i.ed
  br i1 %i.ee, label %bb.ac, label %.critedge5.i

bb.ac:                                            ; preds = %.lr.ph48.i
  call void %.0.i104.i(ptr noundef nonnull %.218247.i, ptr noundef nonnull %i.eb, i64 noundef 8) #21, !inline_history !80
  %i.ef = icmp ugt ptr %i.eb, %.01868.i
  br i1 %i.ef, label %.lr.ph48.i, label %.critedge5.i, !llvm.loop !83

.critedge5.i:                                     ; preds = %bb.ac, %.lr.ph48.i, %.preheader.i
  %.2185.i = getelementptr inbounds nuw i8, ptr %.218551.i, i64 8 ; 2 uses
  %i.eg = icmp ult ptr %.2185.i, %i.dz
