...
.lr.ph.i:                                         ; preds = %.preheader.i, %bb.x
  ...
  %i.dd = load i32, ptr %i.dc, align 4, !tbaa !9  ; 6 uses
...
.lr.ph.i.i37.i:                                   ; preds = %bb.n, %.lr.ph.i.i37.i
  ...
  br i1 %i.dt, label %.lr.ph.i.i37.i, label %get_index_pos.exit.i43.i, !llvm.loop !18
...
bb.o:                                             ; preds = %bb.s, %get_index_pos.exit.thread41.i45.i
  ...
  %i.em = load i8, ptr %.0.i49.i, align 1, !tbaa !12 ; 2 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.et = load i8, ptr %i.el, align 1, !tbaa !12
...
bb.x:                                             ; preds = %unicode_get_cc.exit55.i
  ...
  store i32 %i.dd, ptr %i.fv, align 4, !tbaa !9
...
unicode_get_cc.exit55._crit_edge.i:               ; preds = %unicode_get_cc.exit55.i, %bb.x, %.preheader.i
  ...
  store i32 %i.aj, ptr %i.fx, align 4, !tbaa !9
...
unicode_get_cc.exit.thread.i:                     ; preds = %unicode_get_cc.exit55._crit_edge.i, %unicode_get_cc.exit.thread.loopexit.split.loop.exit111.i, %unicode_get_cc.exit.thread.loopexit.split.loop.exit107.i, %unicode_get_cc.exit.thread.loopexit.split.loop.exit105.i, %unicode_get_cc.exit.thread.loopexit.split.loop.exit.i, %.preheader57.i, %.lr.ph78.i
  ...
  br i1 %i.gd, label %.lr.ph78.i, label %sort_cc.exit, !llvm.loop !50

sort_cc.exit:                                     ; preds = %unicode_get_cc.exit.thread.i
  %7 = icmp eq i32 %i.w, 1
  %.not71 = trunc i32 %3 to i1
  %or.cond = or i1 %7, %.not71
...
bb.am:                                            ; preds = %.critedge, %compose_pair.exit.thread
  ...
  br i1 %exitcond134.not, label %dbuf_claim.exit.thread, label %.peel.begin, !llvm.loop !54
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.i = load i8, ptr %i.h, align 8, !tbaa !44, !range !45, !noundef !46
  %i.j = trunc nuw i8 %i.i to i1
  br i1 %i.j, label %bb.g, label %bb.d

end_hunk_0
begin_hunk_1_@unicode_script:bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.20)
  store i32 0, ptr %.sroa.0284, align 8
  store i32 0, ptr %.sroa.5, align 4
  store ptr null, ptr %.sroa.7, align 8
  store ptr null, ptr %.sroa.15, align 8
  store ptr null, ptr %.sroa.20, align 8
  %i.a = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(8) @.str) #24
  %.not = icmp eq i32 %i.a, 0
  %.0.sroa.gep232 = getelementptr inbounds nuw i8, ptr %0, i64 8
  %.0.sroa.gep235 = getelementptr inbounds nuw i8, ptr %0, i64 4
  %.0.sroa.gep241 = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 2 uses
  %.0.sroa.gep244 = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  br i1 %.not, label %bb.k, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.b = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(5) @.str.1) #24
  %.not125 = icmp eq i32 %i.b, 0
  br i1 %.not125, label %bb.k, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.c = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %1) #24 ; 2 uses
  br label %.preheader.i

.preheader.i:                                     ; preds = %bb.j, %bb.c
  %.01829.i = phi i32 [ %i.l, %bb.j ], [ 0, %bb.c ] ; 2 uses
  %.01928.i = phi ptr [ %i.k, %bb.j ], [ @unicode_script_name_table, %bb.c ]
  br label %bb.d

bb.d:                                             ; preds = %bb.i, %.preheader.i
  %.1.i = phi ptr [ %i.k, %bb.i ], [ %.01928.i, %.preheader.i ] ; 5 uses
  %i.d = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %.1.i, i32 noundef 44) #24 ; 2 uses
  %.not23.i = icmp eq ptr %i.d, null              ; 2 uses
  br i1 %.not23.i, label %bb.e, label %bb.f

bb.e:                                             ; preds = %bb.d
  %i.e = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %.1.i) #24
  br label %bb.g
...
bb.g:                                             ; preds = %bb.f, %bb.e
  %.0.i = phi i64 [ %i.h, %bb.f ], [ %i.e, %bb.e ] ; 2 uses
  %i.i = icmp eq i64 %.0.i, %i.c
  br i1 %i.i, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g
  %bcmp.i = tail call i32 @bcmp(ptr nonnull %.1.i, ptr nonnull readonly %1, i64 %i.c)
  %.not24.i = icmp eq i32 %bcmp.i, 0
  br i1 %.not24.i, label %unicode_find_name.exit, label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.g
  %i.j = getelementptr i8, ptr %.1.i, i64 %.0.i
  %i.k = getelementptr i8, ptr %i.j, i64 1        ; 3 uses
  br i1 %.not23.i, label %bb.j, label %bb.d

bb.j:                                             ; preds = %bb.i
  %i.l = add nuw nsw i32 %.01829.i, 1
  %i.m = load i8, ptr %i.k, align 1, !tbaa !12
  %.not.i = icmp eq i8 %i.m, 0
  br i1 %.not.i, label %unicode_find_name.exit.thread, label %.preheader.i, !llvm.loop !58

unicode_find_name.exit:                           ; preds = %bb.h
  %i.n = add nuw nsw i32 %.01829.i, 1
  br label %bb.k

bb.k:                                             ; preds = %bb.a, %bb.b, %unicode_find_name.exit
  %.0108 = phi i32 [ %i.n, %unicode_find_name.exit ], [ 0, %bb.b ], [ 0, %bb.a ] ; 5 uses
  br i1 %2, label %bb.l, label %bb.m

bb.l:                                             ; preds = %bb.k
  %i.o = load ptr, ptr %.0.sroa.gep244, align 8, !tbaa !19 ; 2 uses
  %i.p = load ptr, ptr %.0.sroa.gep241, align 8, !tbaa !23 ; 2 uses
  store i32 0, ptr %.sroa.5, align 4
  store ptr %i.o, ptr %.sroa.15, align 8, !tbaa !19
  %.not.i151 = icmp eq ptr %i.p, null
  %i.q = select i1 %.not.i151, ptr @cr_default_realloc, ptr %i.p ; 2 uses
  store ptr %i.q, ptr %.sroa.20, align 8, !tbaa !23
  br label %bb.m

bb.m:                                             ; preds = %bb.k, %bb.l
  %.sroa.39.0 = phi ptr [ %i.o, %bb.l ], [ null, %bb.k ] ; 5 uses
  %.sroa.45.0 = phi ptr [ %i.q, %bb.l ], [ null, %bb.k ] ; 5 uses
  %.0.sroa.phi = phi ptr [ %.sroa.7, %bb.l ], [ %.0.sroa.gep232, %bb.k ] ; 11 uses
  %.0.sroa.phi233 = phi ptr [ %.sroa.5, %bb.l ], [ %.0.sroa.gep235, %bb.k ] ; 4 uses
  %.0.sroa.phi239 = phi ptr [ %.sroa.20, %bb.l ], [ %.0.sroa.gep241, %bb.k ] ; 4 uses
  %.0.sroa.phi242 = phi ptr [ %.sroa.15, %bb.l ], [ %.0.sroa.gep244, %bb.k ] ; 4 uses
  %.0 = phi ptr [ %.sroa.0284, %bb.l ], [ %0, %bb.k ] ; 10 uses
  %i.r = icmp eq i32 %.0108, 0                    ; 2 uses
  br label %bb.n

bb.n:                                             ; preds = %bb.m, %bb.v
  %.0104317 = phi i32 [ 0, %bb.m ], [ %i.bm, %bb.v ] ; 3 uses
  %.0106.idx316 = phi i64 [ 0, %bb.m ], [ %.2.idx288, %bb.v ] ; 4 uses
  %.0106.ptr = getelementptr inbounds nuw i8, ptr @unicode_script_table, i64 %.0106.idx316 ; 2 uses
  %.0106.add = add nuw nsw i64 %.0106.idx316, 1   ; 2 uses
  %i.s = load i8, ptr %.0106.ptr, align 1, !tbaa !12 ; 2 uses
  %i.t = and i8 %i.s, 127                         ; 3 uses
  %i.u = zext nneg i8 %i.t to i32                 ; 3 uses
  %i.v = icmp samesign ult i8 %i.t, 96
  br i1 %i.v, label %bb.r, label %bb.o

bb.o:                                             ; preds = %bb.n
  %.ptr128 = getelementptr inbounds nuw i8, ptr @unicode_script_table, i64 %.0106.add
  %i.w = icmp samesign ult i8 %i.t, 112
  %i.x = load i8, ptr %.ptr128, align 1, !tbaa !12
  %i.y = zext i8 %i.x to i32                      ; 2 uses
  br i1 %i.w, label %bb.p, label %bb.q

bb.p:                                             ; preds = %bb.o
  %i.z = shl nuw nsw i32 %i.u, 8
  %.add127 = add nuw nsw i64 %.0106.idx316, 2
  %i.aa = add nsw i32 %i.z, -24480
  %i.ab = add nuw nsw i32 %i.aa, %i.y
  br label %bb.r

bb.q:                                             ; preds = %bb.o
  %i.ac = shl nuw nsw i32 %i.u, 16
  %.ptr129 = getelementptr inbounds nuw i8, ptr %.0106.ptr, i64 2
  %i.ad = shl nuw nsw i32 %i.y, 8
  %.add126 = add nuw nsw i64 %.0106.idx316, 3
  %i.ae = load i8, ptr %.ptr129, align 1, !tbaa !12
  %i.af = zext i8 %i.ae to i32
  %i.ag = add nsw i32 %i.ac, -7335840
  %i.ah = add nuw nsw i32 %i.ag, %i.af
  %i.ai = add nuw nsw i32 %i.ah, %i.ad
  br label %bb.r

bb.r:                                             ; preds = %bb.p, %bb.q, %bb.n
  %.1107.idx = phi i64 [ %.0106.add, %bb.n ], [ %.add127, %bb.p ], [ %.add126, %bb.q ] ; 3 uses
  %.0103 = phi i32 [ %i.u, %bb.n ], [ %i.ab, %bb.p ], [ %i.ai, %bb.q ] ; 2 uses
  %i.aj = icmp sgt i8 %i.s, -1
  br i1 %i.aj, label %.thread, label %bb.s

.thread:                                          ; preds = %bb.r
  %i.ak = add i32 %.0104317, 1
  %i.al = add i32 %i.ak, %.0103
  br label %bb.v

bb.s:                                             ; preds = %bb.r
  %.1107.ptr = getelementptr inbounds nuw i8, ptr @unicode_script_table, i64 %.1107.idx
  %.1107.add = add nuw nsw i64 %.1107.idx, 1      ; 2 uses
  %i.am = load i8, ptr %.1107.ptr, align 1, !tbaa !12
  %i.an = zext i8 %i.am to i32
  %i.ao = add i32 %.0104317, 1
  %i.ap = add i32 %i.ao, %.0103                   ; 3 uses
  %i.aq = icmp eq i32 %.0108, %i.an
  %or.cond = or i1 %i.r, %i.aq
  br i1 %or.cond, label %bb.t, label %bb.v

bb.t:                                             ; preds = %bb.s
  %i.ar = load i32, ptr %.0, align 8, !tbaa !26   ; 2 uses
  %i.as = add nsw i32 %i.ar, 2                    ; 2 uses
  %i.at = load i32, ptr %.0.sroa.phi233, align 4, !tbaa !25 ; 2 uses
  %i.au = icmp sgt i32 %i.as, %i.at
  br i1 %i.au, label %bb.u, label %._crit_edge.i

._crit_edge.i:                                    ; preds = %bb.t
  %.pre.i = load ptr, ptr %.0.sroa.phi, align 8, !tbaa !24
  br label %cr_add_interval.exit.thread

bb.u:                                             ; preds = %bb.t
  %i.av = mul nsw i32 %i.at, 3
  %i.aw = sdiv i32 %i.av, 2
  %..i.i.i = tail call range(i32 -1073741824, -2147483648) i32 @llvm.smax.i32(i32 %i.as, i32 range(i32 -1073741824, 1073741824) %i.aw) ; 2 uses
  %i.ax = load ptr, ptr %.0.sroa.phi239, align 8, !tbaa !23
  %i.ay = load ptr, ptr %.0.sroa.phi242, align 8, !tbaa !19
  %i.az = load ptr, ptr %.0.sroa.phi, align 8, !tbaa !24
  %i.ba = sext i32 %..i.i.i to i64
  %i.bb = shl nsw i64 %i.ba, 2
  %i.bc = tail call ptr %i.ax(ptr noundef %i.ay, ptr noundef %i.az, i64 noundef %i.bb) #21, !inline_history !59 ; 3 uses
  %.not.i.i = icmp eq ptr %i.bc, null
  br i1 %.not.i.i, label %cr_add_interval.exit.preheader, label %cr_realloc.exit.thread.i

cr_realloc.exit.thread.i:                         ; preds = %bb.u
  store ptr %i.bc, ptr %.0.sroa.phi, align 8, !tbaa !24
  store i32 %..i.i.i, ptr %.0.sroa.phi233, align 4, !tbaa !25
  %.pre13.i = load i32, ptr %.0, align 8, !tbaa !26
  br label %cr_add_interval.exit.thread

cr_add_interval.exit.thread:                      ; preds = %._crit_edge.i, %cr_realloc.exit.thread.i
  %i.bd = phi i32 [ %i.ar, %._crit_edge.i ], [ %.pre13.i, %cr_realloc.exit.thread.i ] ; 2 uses
  %i.be = phi ptr [ %.pre.i, %._crit_edge.i ], [ %i.bc, %cr_realloc.exit.thread.i ] ; 2 uses
  ...
  store i32 %.0104317, ptr %i.bh, align 4, !tbaa !9
  ...
  store i32 %i.ap, ptr %i.bl, align 4, !tbaa !9
  br label %bb.v

bb.v:                                             ; preds = %cr_add_interval.exit.thread, %.thread, %bb.s
  %i.bm = phi i32 [ %i.ap, %cr_add_interval.exit.thread ], [ %i.ap, %bb.s ], [ %i.al, %.thread ]
  %.2.idx288 = phi i64 [ %.1107.add, %cr_add_interval.exit.thread ], [ %.1107.add, %bb.s ], [ %.1107.idx, %.thread ] ; 2 uses
  %i.bn = icmp slt i64 %.2.idx288, 2818
  br i1 %i.bn, label %bb.n, label %bb.w, !llvm.loop !60

bb.w:                                             ; preds = %bb.v
  br i1 %i.r, label %bb.x, label %bb.ac

bb.x:                                             ; preds = %bb.w
  %i.bo = load i32, ptr %.0, align 8, !tbaa !26   ; 4 uses
  %i.bp = add nsw i32 %i.bo, 2                    ; 4 uses
  %i.bq = load i32, ptr %.0.sroa.phi233, align 4, !tbaa !25 ; 2 uses
  %i.br = icmp sgt i32 %i.bp, %i.bq
  br i1 %i.br, label %bb.y, label %._crit_edge.i154

._crit_edge.i154:                                 ; preds = %bb.x
  %.pre.i156 = load ptr, ptr %.0.sroa.phi, align 8, !tbaa !24
  br label %bb.aa

bb.y:                                             ; preds = %bb.x
  %i.bs = mul nsw i32 %i.bq, 3
  %i.bt = sdiv i32 %i.bs, 2
  %..i.i.i158 = tail call range(i32 -1073741824, -2147483648) i32 @llvm.smax.i32(i32 %i.bp, i32 range(i32 -1073741824, 1073741824) %i.bt) ; 2 uses
  %i.bu = load ptr, ptr %.0.sroa.phi239, align 8, !tbaa !23
  %i.bv = load ptr, ptr %.0.sroa.phi242, align 8, !tbaa !19
  %i.bw = load ptr, ptr %.0.sroa.phi, align 8, !tbaa !24
  %i.bx = sext i32 %..i.i.i158 to i64
  %i.by = shl nsw i64 %i.bx, 2
  %i.bz = tail call ptr %i.bu(ptr noundef %i.bv, ptr noundef %i.bw, i64 noundef %i.by) #21, !inline_history !61 ; 3 uses
  %.not.i.i159 = icmp eq ptr %i.bz, null
  br i1 %.not.i.i159, label %cr_add_interval.exit.preheader, label %bb.z

bb.z:                                             ; preds = %bb.y
  store ptr %i.bz, ptr %.0.sroa.phi, align 8, !tbaa !24
  store i32 %..i.i.i158, ptr %.0.sroa.phi233, align 4, !tbaa !25
  br label %bb.aa

bb.aa:                                            ; preds = %bb.z, %._crit_edge.i154
  %i.ca = phi ptr [ %.pre.i156, %._crit_edge.i154 ], [ %i.bz, %bb.z ] ; 2 uses
  ...
  %i.ce = load ptr, ptr %.0.sroa.phi, align 8, !tbaa !24 ; 8 uses
  store i32 0, ptr %i.ce, align 4, !tbaa !9
  %i.cf = getelementptr [4 x i8], ptr %i.ce, i64 %i.cc
  %i.cg = getelementptr i8, ptr %i.cf, i64 4
  store i32 -1, ptr %i.cg, align 4, !tbaa !9
  store i32 %i.bp, ptr %.0, align 8, !tbaa !26
  %i.ch = icmp sgt i32 %i.bo, -1
  br i1 %i.ch, label %.lr.ph.preheader.i.i, label %cr_invert.exit.thread

.lr.ph.preheader.i.i:                             ; preds = %bb.aa
  %i.ci = zext nneg i32 %i.bo to i64
  %invariant.op.i.i = add nsw i64 %i.ci, -1       ; 2 uses
  br label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %bb.ab, %.lr.ph.preheader.i.i
  %i.cj = phi i32 [ %i.dh, %bb.ab ], [ 1, %.lr.ph.preheader.i.i ]
  %.034.i.i = phi i32 [ %.1.i.i, %bb.ab ], [ 0, %.lr.ph.preheader.i.i ] ; 3 uses
  %.02933.i.i = phi i32 [ %.130.i.i, %bb.ab ], [ 0, %.lr.ph.preheader.i.i ] ; 2 uses
  %i.ck = sext i32 %.02933.i.i to i64             ; 4 uses
  ...
  %i.co = getelementptr inbounds [4 x i8], ptr %i.ce, i64 %i.cn
  %i.cp = load i32, ptr %i.co, align 4, !tbaa !9
  %i.cq = icmp eq i32 %i.cm, %i.cp
  br i1 %i.cq, label %bb.ab, label %.preheader.i.i.preheader

.preheader.i.i.preheader:                         ; preds = %.lr.ph.i.i
  %i.cr = icmp sgt i64 %invariant.op.i.i, %i.ck
  br i1 %i.cr, label %.lr.ph361, label %.critedge.i.i

.preheader.i.i:                                   ; preds = %.lr.ph361
  %i.cs = icmp slt i64 %indvars.iv.next.i.i, %invariant.op.i.i
  br i1 %i.cs, label %.lr.ph361, label %.critedge.i.i, !llvm.loop !29

.lr.ph361:                                        ; preds = %.preheader.i.i.preheader, %.preheader.i.i
  %indvars.iv.i.i360 = phi i64 [ %indvars.iv.next.i.i, %.preheader.i.i ], [ %i.ck, %.preheader.i.i.preheader ] ; 3 uses
  %i.ct = getelementptr [4 x i8], ptr %i.ce, i64 %indvars.iv.i.i360
  %i.cu = getelementptr i8, ptr %i.ct, i64 4
  %i.cv = load i32, ptr %i.cu, align 4, !tbaa !9
  %indvars.iv.next.i.i = add nsw i64 %indvars.iv.i.i360, 2 ; 4 uses
  %i.cw = getelementptr inbounds [4 x i8], ptr %i.ce, i64 %indvars.iv.next.i.i
  %i.cx = load i32, ptr %i.cw, align 4, !tbaa !9
  %i.cy = icmp eq i32 %i.cv, %i.cx
  br i1 %i.cy, label %.preheader.i.i, label %..critedge.i.i_crit_edge, !llvm.loop !29

..critedge.i.i_crit_edge:                         ; preds = %.lr.ph361
  br label %.critedge.i.i, !llvm.loop !29

.critedge.i.i:                                    ; preds = %.preheader.i.i, %..critedge.i.i_crit_edge, %.preheader.i.i.preheader
  %indvars.iv.i.i.lcssa = phi i64 [ %indvars.iv.i.i360, %..critedge.i.i_crit_edge ], [ %i.ck, %.preheader.i.i.preheader ], [ %indvars.iv.next.i.i, %.preheader.i.i ] ; 2 uses
  %i.cz = trunc nsw i64 %indvars.iv.i.i.lcssa to i32
  %i.da = sext i32 %.034.i.i to i64
  %i.db = getelementptr inbounds [4 x i8], ptr %i.ce, i64 %i.da ; 2 uses
  store i32 %i.cm, ptr %i.db, align 4, !tbaa !9
  %i.dc = getelementptr [4 x i8], ptr %i.ce, i64 %indvars.iv.i.i.lcssa
  ...
  %i.dg = add nsw i32 %.034.i.i, 2
  br label %bb.ab

bb.ab:                                            ; preds = %.critedge.i.i, %.lr.ph.i.i
  %.130.in.i.i = phi i32 [ %i.cz, %.critedge.i.i ], [ %.02933.i.i, %.lr.ph.i.i ] ; 2 uses
  %.1.i.i = phi i32 [ %i.dg, %.critedge.i.i ], [ %.034.i.i, %.lr.ph.i.i ] ; 2 uses
  %.130.i.i = add nsw i32 %.130.in.i.i, 2
  %i.dh = add nsw i32 %.130.in.i.i, 3             ; 2 uses
  %i.di = icmp slt i32 %i.dh, %i.bp
  br i1 %i.di, label %.lr.ph.i.i, label %cr_invert.exit.thread, !llvm.loop !30

cr_invert.exit.thread:                            ; preds = %bb.ab, %bb.aa
  %.0.lcssa.i.i = phi i32 [ 0, %bb.aa ], [ %.1.i.i, %bb.ab ]
  store i32 %.0.lcssa.i.i, ptr %.0, align 8, !tbaa !26
  br label %bb.ac

bb.ac:                                            ; preds = %cr_invert.exit.thread, %bb.w
  br i1 %2, label %.preheader310, label %unicode_find_name.exit.thread

.preheader310:                                    ; preds = %bb.ac, %.loopexit309
  %.1105323 = phi i32 [ %i.ea, %.loopexit309 ], [ 0, %bb.ac ] ; 2 uses
  %.3.idx322 = phi i64 [ %.add133, %.loopexit309 ], [ 0, %bb.ac ] ; 4 uses
  %.sroa.25.1321 = phi ptr [ %.sroa.25.2, %.loopexit309 ], [ null, %bb.ac ] ; 9 uses
  %.sroa.19.1320 = phi i32 [ %.sroa.19.2, %.loopexit309 ], [ 0, %bb.ac ] ; 9 uses
  %.sroa.0.1319 = phi i32 [ %.sroa.0.2, %.loopexit309 ], [ 0, %bb.ac ] ; 6 uses
  %.3.ptr = getelementptr inbounds nuw i8, ptr @unicode_script_ext_table, i64 %.3.idx322 ; 2 uses
  %.3.add = add nuw nsw i64 %.3.idx322, 1         ; 2 uses
  %i.dj = load i8, ptr %.3.ptr, align 1, !tbaa !12 ; 3 uses
  %i.dk = zext i8 %i.dj to i32                    ; 3 uses
  %i.dl = icmp sgt i8 %i.dj, -1
  br i1 %i.dl, label %bb.ag, label %bb.ad

bb.ad:                                            ; preds = %.preheader310
  %.ptr139 = getelementptr inbounds nuw i8, ptr @unicode_script_ext_table, i64 %.3.add
  %i.dm = icmp samesign ult i8 %i.dj, -64
  %i.dn = load i8, ptr %.ptr139, align 1, !tbaa !12
  %i.do = zext i8 %i.dn to i32                    ; 2 uses
  br i1 %i.dm, label %bb.ae, label %bb.af

bb.ae:                                            ; preds = %bb.ad
  %i.dp = shl nuw nsw i32 %i.dk, 8
  %.add136 = add nuw nsw i64 %.3.idx322, 2
  %i.dq = add nsw i32 %i.dp, -32640
  %i.dr = add nuw nsw i32 %i.dq, %i.do
  br label %bb.ag

bb.af:                                            ; preds = %bb.ad
  %i.ds = shl nuw nsw i32 %i.dk, 16
  %.ptr140 = getelementptr inbounds nuw i8, ptr %.3.ptr, i64 2
  %i.dt = shl nuw nsw i32 %i.do, 8
  %.add135 = add nuw nsw i64 %.3.idx322, 3
  %i.du = load i8, ptr %.ptr140, align 1, !tbaa !12
  %i.dv = zext i8 %i.du to i32
  %i.dw = add nsw i32 %i.ds, -12566400
  %i.dx = add nuw nsw i32 %i.dw, %i.dv
  %i.dy = add nuw nsw i32 %i.dx, %i.dt
  br label %bb.ag

bb.ag:                                            ; preds = %.preheader310, %bb.ae, %bb.af
  %.4.idx = phi i64 [ %.add135, %bb.af ], [ %.add136, %bb.ae ], [ %.3.add, %.preheader310 ] ; 2 uses
  %.1 = phi i32 [ %i.dy, %bb.af ], [ %i.dr, %bb.ae ], [ %i.dk, %.preheader310 ]
  %.4.ptr = getelementptr inbounds nuw i8, ptr @unicode_script_ext_table, i64 %.4.idx
  %i.dz = add i32 %.1105323, 1
  %i.ea = add i32 %i.dz, %.1                      ; 2 uses
  %.4.add = add nuw nsw i64 %.4.idx, 1            ; 2 uses
  %.ptr137 = getelementptr inbounds nuw i8, ptr @unicode_script_ext_table, i64 %.4.add
  %i.eb = load i8, ptr %.4.ptr, align 1, !tbaa !12 ; 3 uses
  %.not324 = icmp eq i8 %i.eb, 0                  ; 2 uses
  switch i32 %.0108, label %.preheader [
    i32 59, label %bb.ah
    i32 26, label %bb.ah
  ]

.preheader:                                       ; preds = %bb.ag
  br i1 %.not324, label %.loopexit309, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %.preheader
  %wide.trip.count = zext i8 %i.eb to i64
  br label %.lr.ph

bb.ah:                                            ; preds = %bb.ag, %bb.ag
  br i1 %.not324, label %.loopexit309, label %bb.ai

bb.ai:                                            ; preds = %bb.ah
  %i.ec = add nsw i32 %.sroa.0.1319, 2            ; 4 uses
  %i.ed = icmp sgt i32 %i.ec, %.sroa.19.1320
  br i1 %i.ed, label %bb.aj, label %.loopexit309.sink.split

bb.aj:                                            ; preds = %bb.ai
  %i.ee = mul nsw i32 %.sroa.19.1320, 3
  %i.ef = sdiv i32 %i.ee, 2
  %..i.i.i164 = tail call range(i32 -1073741824, -2147483648) i32 @llvm.smax.i32(i32 %i.ec, i32 range(i32 -1073741824, 1073741824) %i.ef) ; 2 uses
  %i.eg = sext i32 %..i.i.i164 to i64
  %i.eh = shl nsw i64 %i.eg, 2
  %i.ei = tail call ptr %.sroa.45.0(ptr noundef %.sroa.39.0, ptr noundef %.sroa.25.1321, i64 noundef %i.eh) #21, !inline_history !59 ; 2 uses
  %.not.i.i165 = icmp eq ptr %i.ei, null
  br i1 %.not.i.i165, label %cr_add_interval.exit.preheader, label %.loopexit309.sink.split

bb.ak:                                            ; preds = %.lr.ph
end_hunk_1
begin_hunk_2_@cr_regexp_canonicalize:bb.a
...
bb.h:                                             ; preds = %bb.g
  %i.cu = load i32, ptr %i.a, align 4, !tbaa !9
...
bb.l:                                             ; preds = %._crit_edge
  ...
  br i1 %i.cv, label %bb.m, label %bb.n, !prof !64
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.dk = tail call ptr %i.g(ptr noundef %i.c, ptr noundef %.pre.i85119, i64 noundef %i.dj) #21, !inline_history !59 ; 2 uses
...
._crit_edge.i83:                                  ; preds = %bb.q, %bb.p
  ...
  store i32 %.153103, ptr %i.dm, align 4, !tbaa !9
  %i.dn = getelementptr i8, ptr %i.dm, i64 4
  store i32 %.1104, ptr %i.dn, align 4, !tbaa !9
...
cr_add_interval.exit:                             ; preds = %._crit_edge.i83, %bb.q, %bb.o, %lre_case_folding_entry.exit
  ...
  br i1 %exitcond.not, label %._crit_edge105, label %.preheader, !llvm.loop !65
...
bb.r:                                             ; preds = %._crit_edge105, %bb.f
  ...
  br i1 %i.ds, label %bb.f, label %._crit_edge128, !llvm.loop !66
...
bb.t:                                             ; preds = %._crit_edge128.thread
  ...
  %i.ec = load ptr, ptr %i.i, align 8, !tbaa !19
  %i.ed = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.ee = load ptr, ptr %i.ed, align 8, !tbaa !24
  %i.ef = tail call ptr %i.eb(ptr noundef %i.ec, ptr noundef %i.ee, i64 noundef 0) #21, !inline_history !33 ; 0 uses
  %i.eg = load ptr, ptr %i.h, align 8, !tbaa !23
  %i.eh = load ptr, ptr %i.f, align 8, !tbaa !19
  %i.ei = tail call ptr %i.eg(ptr noundef %i.eh, ptr noundef nonnull %i.ai, i64 noundef 0) #21, !inline_history !33 ; 0 uses
  %i.ej = load ptr, ptr %i.l, align 8, !tbaa !23
  %i.ek = load ptr, ptr %i.k, align 8, !tbaa !19
  %i.el = tail call ptr %i.ej(ptr noundef %i.ek, ptr noundef %i.dv, i64 noundef 0) #21, !inline_history !33 ; 0 uses
  %i.em = load ptr, ptr %i.n, align 8, !tbaa !23
  %i.en = load ptr, ptr %i.m, align 8, !tbaa !19
  %i.eo = tail call ptr %i.em(ptr noundef %i.en, ptr noundef %i.dy, i64 noundef 0) #21, !inline_history !33 ; 0 uses
  br label %bb.u
...
cr_invert.exit:                                   ; preds = %bb.a, %.cr_invert.exit_crit_edge143, %bb.d, %._crit_edge128.thread, %.loopexit, %bb.b
  ...
  %i.es = load ptr, ptr %i.i, align 8, !tbaa !19
  %i.et = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.eu = load ptr, ptr %i.et, align 8, !tbaa !24
  %i.ev = tail call ptr %i.er(ptr noundef %i.es, ptr noundef %i.eu, i64 noundef 0) #21, !inline_history !33 ; 0 uses
  %i.ew = load ptr, ptr %i.h, align 8, !tbaa !23
  %i.ex = load ptr, ptr %i.f, align 8, !tbaa !19
  %i.ey = tail call ptr %i.ew(ptr noundef %i.ex, ptr noundef %i.eq, i64 noundef 0) #21, !inline_history !33 ; 0 uses
  %i.ez = load ptr, ptr %i.l, align 8, !tbaa !23
  %i.fa = load ptr, ptr %i.k, align 8, !tbaa !19
  %i.fb = tail call ptr %i.ez(ptr noundef %i.fa, ptr noundef %i.ep, i64 noundef 0) #21, !inline_history !33 ; 0 uses
  %i.fc = load ptr, ptr %i.n, align 8, !tbaa !23
  %i.fd = load ptr, ptr %i.m, align 8, !tbaa !19
  %i.fe = getelementptr inbounds nuw i8, ptr %5, i64 8
  %i.ff = load ptr, ptr %i.fe, align 8, !tbaa !24
  %i.fg = tail call ptr %i.fc(ptr noundef %i.fd, ptr noundef %i.ff, i64 noundef 0) #21, !inline_history !33 ; 0 uses
  br label %bb.u
...
.preheader109.preheader:                          ; preds = %bb.a
  %.not59 = trunc i32 %1 to i1                    ; 4 uses
  %spec.select = select i1 %.not59, i32 11253, i32 0 ; 2 uses
  %i.b = and i32 %1, 2
  ...
  %i.f = and i32 %1, 6
  %.not52 = icmp ne i32 %i.f, 0
  %or.cond61.not = and i1 %.not52, %.not59        ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  br i1 %or.cond61.not, label %bb.p, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.q = add nuw nsw i32 %i.n, %2
...
bb.f:                                             ; preds = %.lr.ph
  ...
  %i.aa = load ptr, ptr %i.i, align 8, !tbaa !19
  %i.ab = load ptr, ptr %.phi.trans.insert.i63, align 8, !tbaa !24
  %i.ac = sext i32 %..i.i.i to i64
  %i.ad = shl nsw i64 %i.ac, 2
  %i.ae = tail call ptr %i.z(ptr noundef %i.aa, ptr noundef %i.ab, i64 noundef %i.ad) #21, !inline_history !59 ; 3 uses
...
bb.g:                                             ; preds = %._crit_edge.i, %cr_realloc.exit.thread.i
  ...
  store i32 %i.r, ptr %i.aj, align 4, !tbaa !9
  ...
  store i32 %i.s, ptr %i.an, align 4, !tbaa !9
  %i.ao = add nuw nsw i32 %.1112, 2               ; 2 uses
  %i.ap = icmp samesign ult i32 %i.ao, %i.p
  br i1 %i.ap, label %.lr.ph, label %.loopexit, !llvm.loop !67

bb.h:                                             ; preds = %bb.c
  br i1 %or.cond61.not, label %bb.p, label %bb.i
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.ay = load ptr, ptr %i.i, align 8, !tbaa !19
...
cr_add_interval.exit70.thread:                    ; preds = %._crit_edge.i62, %cr_realloc.exit.thread.i68
  ...
  %i.bg = sext i32 %i.bd to i64
  %i.bh = getelementptr inbounds [4 x i8], ptr %i.be, i64 %i.bg
  store i32 %i.n, ptr %i.bh, align 4, !tbaa !9
  %i.bi = load i32, ptr %0, align 8, !tbaa !26    ; 2 uses
  %i.bj = add nsw i32 %i.bi, 1
  store i32 %i.bj, ptr %0, align 8, !tbaa !26
  %i.bk = sext i32 %i.bi to i64
  %i.bl = getelementptr inbounds [4 x i8], ptr %i.be, i64 %i.bk
  store i32 %i.aq, ptr %i.bl, align 4, !tbaa !9
  br label %._crit_edge
...
bb.l:                                             ; preds = %._crit_edge
  ...
  %i.bu = load ptr, ptr %i.i, align 8, !tbaa !19
  %i.bv = load ptr, ptr %.phi.trans.insert.i63, align 8, !tbaa !24
  %i.bw = sext i32 %..i.i.i75 to i64
  %i.bx = shl nsw i64 %i.bw, 2
  %i.by = tail call ptr %i.bt(ptr noundef %i.bu, ptr noundef %i.bv, i64 noundef %i.bx) #21, !inline_history !59 ; 3 uses
...
bb.m:                                             ; preds = %._crit_edge.i71, %cr_realloc.exit.thread.i77
  ...
  store i32 %i.aq, ptr %i.cd, align 4, !tbaa !9
  ...
  store i32 %i.bm, ptr %i.ch, align 4, !tbaa !9
  br i1 %.not59, label %bb.n, label %.loopexit
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.cq = load ptr, ptr %i.i, align 8, !tbaa !19
  %i.cr = sext i32 %..i.i.i84 to i64
  %i.cs = shl nsw i64 %i.cr, 2
  %i.ct = tail call ptr %i.cp(ptr noundef %i.cq, ptr noundef nonnull %i.ca, i64 noundef %i.cs) #21, !inline_history !59 ; 3 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.dc = load ptr, ptr %i.i, align 8, !tbaa !19
  %i.dd = load ptr, ptr %.phi.trans.insert.i63, align 8, !tbaa !24
  %i.de = sext i32 %..i.i.i93 to i64
  %i.df = shl nsw i64 %i.de, 2
  %i.dg = tail call ptr %i.db(ptr noundef %i.dc, ptr noundef %i.dd, i64 noundef %i.df) #21, !inline_history !59 ; 3 uses
...
.loopexit.sink.split:                             ; preds = %cr_realloc.exit.thread.i95, %._crit_edge.i89, %cr_realloc.exit.thread.i86, %bb.n
  ...
  store i32 %.sink142, ptr %i.dj, align 4, !tbaa !9
...
bb.f:                                             ; preds = %exchange_func.exit210.i
  store ptr %i.b, ptr %1, align 16, !tbaa !69
  %i.j = getelementptr inbounds nuw i8, ptr %1, i64 8
  store i64 %i.e, ptr %i.j, align 8, !tbaa !71
  %i.k = getelementptr inbounds nuw i8, ptr %1, i64 16
  store i32 0, ptr %i.k, align 16, !tbaa !72
...
bb.g:                                             ; preds = %.loopexit.i, %bb.f
  ...
  %i.q = load i64, ptr %i.p, align 8, !tbaa !71   ; 4 uses
...
.lr.ph43.preheader.i:                             ; preds = %bb.g
  ...
  %i.t = load i32, ptr %i.s, align 8, !tbaa !72   ; 3 uses
...
end_hunk_2
begin_hunk_3_@unicode_general_category:bb.a
...
bb.b:                                             ; preds = %bb.a, %.loopexit
  ...
  %i.f = load i8, ptr %.042.ptr, align 1, !tbaa !12
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.w = load i8, ptr %.ptr53, align 1, !tbaa !12
...
bb.k:                                             ; preds = %.lr.ph
  ...
  %i.ao = load ptr, ptr %i.d, align 8, !tbaa !19
  %i.ap = load ptr, ptr %.phi.trans.insert.i60, align 8, !tbaa !24
  %i.aq = sext i32 %..i.i.i to i64
  %i.ar = shl nsw i64 %i.aq, 2
  %i.as = tail call ptr %i.an(ptr noundef %i.ao, ptr noundef %i.ap, i64 noundef %i.ar) #21, !inline_history !59 ; 3 uses
...
bb.l:                                             ; preds = %._crit_edge.i, %cr_realloc.exit.thread.i
  ...
  store i32 %.04073, ptr %i.ax, align 4, !tbaa !9
  ...
  store i32 %i.ag, ptr %i.bb, align 4, !tbaa !9
  %i.bc = add i32 %.04073, 2                      ; 2 uses
  %i.bd = icmp ult i32 %i.bc, %i.ac
  br i1 %i.bd, label %.lr.ph, label %.loopexit, !llvm.loop !87
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.bl = load ptr, ptr %i.d, align 8, !tbaa !19
  %i.bm = load ptr, ptr %.phi.trans.insert.i60, align 8, !tbaa !24
  %i.bn = sext i32 %..i.i.i63 to i64
  %i.bo = shl nsw i64 %i.bn, 2
  %i.bp = tail call ptr %i.bk(ptr noundef %i.bl, ptr noundef %i.bm, i64 noundef %i.bo) #21, !inline_history !59 ; 3 uses
...
cr_add_interval.exit67.thread:                    ; preds = %._crit_edge.i59, %cr_realloc.exit.thread.i65
  ...
  store i32 %.04175, ptr %i.bu, align 4, !tbaa !9
  ...
  store i32 %i.ac, ptr %i.by, align 4, !tbaa !9
  br label %.loopexit

.loopexit:                                        ; preds = %bb.l, %bb.j, %cr_add_interval.exit67.thread, %bb.i, %bb.m
  %i.bz = icmp slt i64 %.1.idx, 4122
  br i1 %i.bz, label %bb.b, label %cr_add_interval.exit, !llvm.loop !88
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.f, label %.loopexit, label %.preheader192

.preheader192:                                    ; preds = %bb.b
  %i.g = load i32, ptr %3, align 8, !tbaa !26     ; 2 uses
  %i.h = icmp sgt i32 %i.g, 0
  br i1 %i.h, label %.lr.ph276, label %._crit_edge277

.lr.ph276:                                        ; preds = %.preheader192
  %i.i = getelementptr inbounds nuw i8, ptr %3, i64 8 ; 2 uses
  %.pre344 = load ptr, ptr %i.i, align 8, !tbaa !24
  br label %bb.c

bb.c:                                             ; preds = %.lr.ph276, %._crit_edge274
  %i.j = phi i32 [ %i.g, %.lr.ph276 ], [ %i.w, %._crit_edge274 ]
  %i.k = phi ptr [ %.pre344, %.lr.ph276 ], [ %i.x, %._crit_edge274 ] ; 2 uses
  %indvars.iv333 = phi i64 [ 0, %.lr.ph276 ], [ %indvars.iv.next334, %._crit_edge274 ] ; 3 uses
  %i.l = getelementptr inbounds nuw [4 x i8], ptr %i.k, i64 %indvars.iv333 ; 2 uses
...
.lr.ph273:                                        ; preds = %bb.c, %.lr.ph273
  ...
  store i32 %.0170271, ptr %i.a, align 16, !tbaa !9
  ...
  %i.s = getelementptr inbounds nuw [4 x i8], ptr %i.r, i64 %indvars.iv333
  %i.t = getelementptr inbounds nuw i8, ptr %i.s, i64 4
  %i.u = load i32, ptr %i.t, align 4, !tbaa !9
  %i.v = icmp ult i32 %i.q, %i.u
  br i1 %i.v, label %.lr.ph273, label %._crit_edge274.loopexit, !llvm.loop !89
...
._crit_edge274:                                   ; preds = %._crit_edge274.loopexit, %bb.c
  ...
  %indvars.iv.next334 = add nuw nsw i64 %indvars.iv333, 2 ; 2 uses
  %i.y = trunc nuw i64 %indvars.iv.next334 to i32
  %i.z = icmp sgt i32 %i.w, %i.y
  br i1 %i.z, label %bb.c, label %._crit_edge277, !llvm.loop !90

._crit_edge277:                                   ; preds = %._crit_edge274, %.preheader192
...
.lr.ph283:                                        ; preds = %.preheader
  ...
  br label %bb.d
end_hunk_3
begin_hunk_4_@unicode_sequence_prop1:bb.a
  br label %bb.m
...
bb.n:                                             ; preds = %bb.m
  ...
  store i32 65039, ptr %i.ea, align 4, !tbaa !9
  br label %bb.o
...
bb.p:                                             ; preds = %bb.o
  ...
  store i32 8205, ptr %i.ee, align 4, !tbaa !9
  br label %bb.q
...
bb.q:                                             ; preds = %bb.o, %bb.p
  ...
  br i1 %exitcond.not, label %._crit_edge227, label %bb.k, !llvm.loop !98
...
.preheader198.us.us:                              ; preds = %.split241.us, %.preheader198.us.us
  ...
  store i32 %i.ep, ptr %i.el, align 4, !tbaa !9
  store i32 127995, ptr %i.eo, align 4, !tbaa !9
  call void %1(ptr noundef %2, ptr noundef nonnull %i.a, i32 noundef %.3) #21
  store i32 %i.ep, ptr %i.el, align 4, !tbaa !9
  store i32 127996, ptr %i.eo, align 4, !tbaa !9
  call void %1(ptr noundef %2, ptr noundef nonnull %i.a, i32 noundef %.3) #21
  store i32 %i.ep, ptr %i.el, align 4, !tbaa !9
  store i32 127997, ptr %i.eo, align 4, !tbaa !9
  call void %1(ptr noundef %2, ptr noundef nonnull %i.a, i32 noundef %.3) #21
  store i32 %i.ep, ptr %i.el, align 4, !tbaa !9
  store i32 127998, ptr %i.eo, align 4, !tbaa !9
  call void %1(ptr noundef %2, ptr noundef nonnull %i.a, i32 noundef %.3) #21
  store i32 %i.ep, ptr %i.el, align 4, !tbaa !9
  store i32 127999, ptr %i.eo, align 4, !tbaa !9
  call void %1(ptr noundef %2, ptr noundef nonnull %i.a, i32 noundef %.3) #21
  %i.eq = add nuw nsw i32 %.0148240.us.us, 1      ; 2 uses
  %exitcond325.not = icmp eq i32 %i.eq, %.
  br i1 %exitcond325.not, label %.loopexit199, label %.preheader198.us.us, !llvm.loop !99
...
.preheader198.us:                                 ; preds = %.split241.us, %.preheader198.us
  ...
  br i1 %exitcond323.not, label %.loopexit199, label %.preheader198.us, !llvm.loop !99
...
bb.s:                                             ; preds = %bb.s, %.preheader198.us247.us
  ...
  store i32 %i.fc, ptr %i.eu, align 4, !tbaa !9
  ...
  store i32 %i.fg, ptr %i.ey, align 4, !tbaa !9
  %i.fh = add nuw nsw i32 %i.fe, 127995
  store i32 %i.fh, ptr %i.fb, align 4, !tbaa !9
  call void %1(ptr noundef %2, ptr noundef nonnull %i.a, i32 noundef %.3) #21
  %i.fi = add nuw nsw i32 %.0149232.us234.us.us.us, 1 ; 2 uses
  %exitcond320.not = icmp eq i32 %i.fi, %.0151.ph
  br i1 %exitcond320.not, label %.split.split.us.us.split.us.us, label %bb.s, !llvm.loop !100
...
.split.split.us.us.split.us.us:                   ; preds = %bb.s
  ...
  br i1 %exitcond321.not, label %.loopexit199, label %.preheader198.us247.us, !llvm.loop !99
...
.preheader198.us251.us:                           ; preds = %.split241.us250, %.preheader198.us251.us
  ...
  store i32 %i.fu, ptr %i.ft, align 4, !tbaa !9
  call void %1(ptr noundef %2, ptr noundef nonnull %i.a, i32 noundef %.3) #21
  %i.fv = add nuw nsw i32 %.0148240.us252.us, 1   ; 2 uses
  %exitcond317.not = icmp eq i32 %i.fv, %.406
  br i1 %exitcond317.not, label %.loopexit199, label %.preheader198.us251.us, !llvm.loop !99
...
.preheader200:                                    ; preds = %bb.a, %._crit_edge214
  ...
  store i32 127988, ptr %i.a, align 16, !tbaa !9
  %i.fw = add nuw nsw i32 %.6216, 1
  %i.fx = zext nneg i32 %.6216 to i64             ; 3 uses
  %4 = lshr i64 133152, %i.fx
  %.not210 = trunc i64 %4 to i1
  br i1 %.not210, label %._crit_edge214, label %.lr.ph213.preheader
...
.lr.ph213:                                        ; preds = %.lr.ph213.preheader, %.lr.ph213
  ...
  %5 = lshr i64 133152, %indvars.iv299
  %.not = trunc i64 %5 to i1
  br i1 %.not, label %._crit_edge214.loopexit, label %.lr.ph213
...
._crit_edge214:                                   ; preds = %._crit_edge214.loopexit, %.preheader200
  ...
  store i32 917631, ptr %i.gj, align 4, !tbaa !9
  call void %1(ptr noundef %2, ptr noundef nonnull %i.a, i32 noundef %i.gh) #21
  %i.gk = icmp ult i32 %.lcssa, 18
  br i1 %i.gk, label %.preheader200, label %.loopexit, !llvm.loop !101
...
bb.w:                                             ; preds = %.lr.ph209, %._crit_edge
  ...
  %i.gv = load i32, ptr %i.gu, align 4, !tbaa !9  ; 2 uses
  %i.gw = getelementptr inbounds nuw i8, ptr %i.gu, i64 4
  %i.gx = load i32, ptr %i.gw, align 4, !tbaa !9
...
.lr.ph:                                           ; preds = %bb.w, %.lr.ph
  ...
  store i32 %.5175207, ptr %i.a, align 16, !tbaa !9
  store i32 65039, ptr %i.gq, align 4, !tbaa !9
  store i32 8419, ptr %i.gr, align 8, !tbaa !9
  call void %1(ptr noundef %2, ptr noundef nonnull %i.a, i32 noundef 3) #21
  ...
  br i1 %i.he, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !102
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %bb.w
  ...
  br i1 %i.hi, label %bb.w, label %.loopexit, !llvm.loop !103
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.k = load i8, ptr %i.i, align 1, !tbaa !12
  %.not.i = icmp eq i8 %i.k, 0
  br i1 %.not.i, label %cr_add_interval.exit, label %.preheader.i, !llvm.loop !58
...
end_hunk_4
begin_hunk_5_@__dbuf_put_u32:bb.a
bb.b:                                             ; preds = %bb.a
...
._crit_edge.i:                                    ; preds = %bb.b
  %.pre.i = load i64, ptr %i.a, align 8, !tbaa !47
  br label %bb.c
...
bb.a:
  ...
  %i.d = load i16, ptr %i.c, align 2, !tbaa !13   ; 2 uses
...
bb.e:                                             ; preds = %bb.f
  ...
  br i1 %exitcond210.not, label %.loopexit, label %bb.f, !llvm.loop !110
...
bb.g:                                             ; preds = %.lr.ph179
  ...
  store i32 %i.ak, ptr %i.al, align 4, !tbaa !9
  %i.am = add nsw i32 %.0178, 1
  %indvars.iv.next202 = add nuw nsw i64 %indvars.iv201, 1 ; 2 uses
  %exitcond205.not = icmp eq i64 %indvars.iv.next202, %wide.trip.count204
  br i1 %exitcond205.not, label %.loopexit, label %.lr.ph179, !llvm.loop !111
...
.lr.ph174:                                        ; preds = %.lr.ph174.preheader, %bb.j
  ...
  %i.at = load i8, ptr %i.as, align 1, !tbaa !12  ; 4 uses
...
bb.j:                                             ; preds = %unicode_get_short_code.exit.thread, %unicode_get_short_code.exit
  ...
  br i1 %exitcond200.not, label %.loopexit, label %.lr.ph174, !llvm.loop !112
...
vector.memcheck230:                               ; preds = %bb.l
  ...
  %scevgep231 = getelementptr i8, ptr %0, i64 %i.bp
  ...
  %bound1234 = icmp ult ptr %i.g, %scevgep231
...
vector.body244:                                   ; preds = %vector.body244, %vector.ph238
  ...
  %wide.load246 = load <4 x i16>, ptr %i.bt, align 1, !alias.scope !113
  ...
  store <4 x i32> %i.bx, ptr %i.by, align 4, !tbaa !9, !alias.scope !116, !noalias !113
  ...
  br i1 %i.bz, label %middle.block248, label %vector.body244, !llvm.loop !118
...
scalar.ph236.preheader:                           ; preds = %vector.memcheck230, %bb.l, %middle.block248
  ...
  %lcmp.mod259.not = trunc i32 %.0125 to i1
  br i1 %lcmp.mod259.not, label %scalar.ph236.prol, label %scalar.ph236.prol.loopexit
...
scalar.ph236.prol:                                ; preds = %scalar.ph236.preheader
  ...
  store i32 %.0127.prol, ptr %i.cf, align 4, !tbaa !9
...
scalar.ph236:                                     ; preds = %scalar.ph236.prol.loopexit, %scalar.ph236
  ...
  store i32 %.0127, ptr %i.cn, align 4, !tbaa !9
  ...
  store i32 %.0127.1, ptr %i.ct, align 4, !tbaa !9
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i8>, ptr %i.de, align 1, !tbaa !12, !alias.scope !122 ; 2 uses
  %wide.load229 = load <4 x i8>, ptr %i.df, align 1, !tbaa !12, !alias.scope !122 ; 2 uses
  ...
  store <4 x i32> %i.dm, ptr %i.do, align 4, !tbaa !9, !alias.scope !125, !noalias !122
  store <4 x i32> %i.dn, ptr %i.dp, align 4, !tbaa !9, !alias.scope !125, !noalias !122
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.dq = icmp eq i64 %index.next, %n.vec
  br i1 %i.dq, label %middle.block, label %vector.body, !llvm.loop !127
...
.lr.ph.preheader256:                              ; preds = %vector.memcheck, %.lr.ph.preheader, %middle.block
  ...
  %lcmp.mod.not = trunc i32 %.1126 to i1
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader256
  ...
  %i.ds = load i8, ptr %i.dr, align 1, !tbaa !12  ; 2 uses
  ...
  store i32 %.1128.prol, ptr %i.dw, align 4, !tbaa !9
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  %i.ea = load i8, ptr %i.dz, align 1, !tbaa !12  ; 2 uses
  ...
  store i32 %.1128, ptr %i.ee, align 4, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.ef = getelementptr inbounds nuw i8, ptr %i.da, i64 %indvars.iv.next
  %i.eg = load i8, ptr %i.ef, align 1, !tbaa !12  ; 2 uses
  ...
  store i32 %.1128.1, ptr %i.ek, align 4, !tbaa !9
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, %wide.trip.count
  br i1 %exitcond.not.1, label %.loopexit, label %.lr.ph, !llvm.loop !128
...
bb.r:                                             ; preds = %bb.p
  ...
  %i.ez = load i16, ptr %i.ey, align 2, !tbaa !13
...
unicode_get_short_code.exit158:                   ; preds = %bb.o, %bb.q, %bb.r
  ...
  store i32 %.0.i157, ptr %i.fb, align 4, !tbaa !9
  br label %.loopexit

bb.s:                                             ; preds = %bb.c
  %.val145 = load i16, ptr %i.g, align 1
  %i.fc = zext i16 %.val145 to i32
  store i32 %i.fc, ptr %0, align 4, !tbaa !9
  ...
  store i32 %i.fl, ptr %i.fm, align 4, !tbaa !9
  br label %.loopexit
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.fs = load i8, ptr %i.fr, align 1, !tbaa !12  ; 4 uses
...
bb.x:                                             ; preds = %bb.v
  ...
  %i.ga = load i16, ptr %i.fz, align 2, !tbaa !13
...
bb.aa:                                            ; preds = %bb.z
  ...
  %.0.i161 = add nuw nsw i32 %.0.v.i, %.0131
  br label %bb.ab

bb.ab:                                            ; preds = %bb.aa, %bb.z
  %.1132 = phi i32 [ %.0.i161, %bb.aa ], [ %.0131, %bb.z ]
  store i32 %.1132, ptr %0, align 4, !tbaa !9
  %i.gl = load i8, ptr %.0122, align 1, !tbaa !12 ; 4 uses
...
bb.ae:                                            ; preds = %bb.ac
  ...
  %i.gt = load i16, ptr %i.gs, align 2, !tbaa !13
...
unicode_get_short_code.exit163:                   ; preds = %bb.ab, %bb.ad, %bb.ae
  ...
  store i32 %.0.i162, ptr %i.gv, align 4, !tbaa !9
  br label %.loopexit
...
bb.a:
  %i.a = load i64, ptr %0, align 8, !tbaa !129
  %i.b = load i64, ptr %1, align 8, !tbaa !129
  store i64 %i.b, ptr %0, align 8, !tbaa !129
  store i64 %i.a, ptr %1, align 8, !tbaa !129
  ret void
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %next.gep15, align 8, !tbaa !129, !alias.scope !130, !noalias !133
  %wide.load16 = load <2 x i64>, ptr %i.h, align 8, !tbaa !129, !alias.scope !130, !noalias !133
  %i.i = getelementptr i8, ptr %next.gep, i64 16  ; 2 uses
  %wide.load17 = load <2 x i64>, ptr %next.gep, align 8, !tbaa !129, !alias.scope !133
  %wide.load18 = load <2 x i64>, ptr %i.i, align 8, !tbaa !129, !alias.scope !133
  store <2 x i64> %wide.load17, ptr %next.gep15, align 8, !tbaa !129, !alias.scope !130, !noalias !133
  store <2 x i64> %wide.load18, ptr %i.h, align 8, !tbaa !129, !alias.scope !130, !noalias !133
  store <2 x i64> %wide.load, ptr %next.gep, align 8, !tbaa !129, !alias.scope !133
  store <2 x i64> %wide.load16, ptr %i.i, align 8, !tbaa !129, !alias.scope !133
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.j = icmp eq i64 %index.next, %n.vec
  br i1 %i.j, label %middle.block, label %vector.body, !llvm.loop !135
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader21, %.lr.ph.prol
  ...
  %i.m = load i64, ptr %.0911.prol, align 8, !tbaa !129
  %i.n = load i64, ptr %.0812.prol, align 8, !tbaa !129
  %i.o = getelementptr inbounds nuw i8, ptr %.0911.prol, i64 8 ; 2 uses
  store i64 %i.n, ptr %.0911.prol, align 8, !tbaa !129
  %i.p = getelementptr inbounds nuw i8, ptr %.0812.prol, i64 8 ; 2 uses
  store i64 %i.m, ptr %.0812.prol, align 8, !tbaa !129
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol, !llvm.loop !136
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  %i.r = load i64, ptr %.0911, align 8, !tbaa !129
  %i.s = load i64, ptr %.0812, align 8, !tbaa !129
  %i.t = getelementptr inbounds nuw i8, ptr %.0911, i64 8 ; 2 uses
  store i64 %i.s, ptr %.0911, align 8, !tbaa !129
  %i.u = getelementptr inbounds nuw i8, ptr %.0812, i64 8 ; 2 uses
  store i64 %i.r, ptr %.0812, align 8, !tbaa !129
  %i.v = load i64, ptr %i.t, align 8, !tbaa !129
  %i.w = load i64, ptr %i.u, align 8, !tbaa !129
  %i.x = getelementptr inbounds nuw i8, ptr %.0911, i64 16 ; 2 uses
  store i64 %i.w, ptr %i.t, align 8, !tbaa !129
  %i.y = getelementptr inbounds nuw i8, ptr %.0812, i64 16 ; 2 uses
  store i64 %i.v, ptr %i.u, align 8, !tbaa !129
  %i.z = load i64, ptr %i.x, align 8, !tbaa !129
  %i.aa = load i64, ptr %i.y, align 8, !tbaa !129
  ...
  store i64 %i.z, ptr %i.y, align 8, !tbaa !129
  %i.ad = add nsw i64 %.013, -4                   ; 2 uses
  %i.ae = load i64, ptr %i.ab, align 8, !tbaa !129
  %i.af = load i64, ptr %i.ac, align 8, !tbaa !129
  %i.ag = getelementptr inbounds nuw i8, ptr %.0911, i64 32
  store i64 %i.af, ptr %i.ab, align 8, !tbaa !129
  %i.ah = getelementptr inbounds nuw i8, ptr %.0812, i64 32
  store i64 %i.ae, ptr %i.ac, align 8, !tbaa !129
  %.not.3 = icmp eq i64 %i.ad, 0
  br i1 %.not.3, label %._crit_edge, label %.lr.ph, !llvm.loop !138
