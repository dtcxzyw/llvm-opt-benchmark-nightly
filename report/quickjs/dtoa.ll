...
mp_div1.exit.us:                                  ; preds = %bb.b
  ...
  br i1 %i.ae, label %.lr.ph.preheader.i.us, label %mpb_renorm.exit.us

.lr.ph.preheader.i.us:                            ; preds = %mp_div1.exit.us
  %5 = zext nneg i32 %i.q to i64
  br label %.lr.ph.i59.us

.lr.ph.i59.us:                                    ; preds = %bb.c, %.lr.ph.preheader.i.us
  %indvars.iv.i60.us = phi i64 [ %5, %.lr.ph.preheader.i.us ], [ %indvars.iv.next.i61.us, %bb.c ] ; 3 uses
  %i.af = getelementptr [4 x i8], ptr %1, i64 %indvars.iv.i60.us
  %i.ag = load i32, ptr %i.af, align 4, !tbaa !14
  %i.ah = icmp eq i32 %i.ag, 0
  br i1 %i.ah, label %bb.c, label %mpb_renorm.exit.us

bb.c:                                             ; preds = %.lr.ph.i59.us
  %indvars.iv.next.i61.us = add nsw i64 %indvars.iv.i60.us, -1 ; 2 uses
  %6 = trunc nuw nsw i64 %indvars.iv.next.i61.us to i32
  store i32 %6, ptr %1, align 4, !tbaa !14
  %i.ai = icmp sgt i64 %indvars.iv.i60.us, 2
...
mp_div1.exit:                                     ; preds = %bb.g
  ...
  br i1 %i.bw, label %.lr.ph.preheader.i, label %mpb_renorm.exit

.lr.ph.preheader.i:                               ; preds = %mp_div1.exit
  %7 = zext nneg i32 %i.bi to i64
  br label %.lr.ph.i59

.lr.ph.i59:                                       ; preds = %bb.h, %.lr.ph.preheader.i
  %indvars.iv.i60 = phi i64 [ %7, %.lr.ph.preheader.i ], [ %indvars.iv.next.i61, %bb.h ] ; 3 uses
  %i.bx = getelementptr [4 x i8], ptr %1, i64 %indvars.iv.i60
...
bb.h:                                             ; preds = %.lr.ph.i59
  ...
  %8 = trunc nuw nsw i64 %indvars.iv.next.i61 to i32
  store i32 %8, ptr %1, align 4, !tbaa !14
  %i.ca = icmp sgt i64 %indvars.iv.i60, 2
...
pow_ui_inv.exit:                                  ; preds = %pow_ui.exit.i, %bb.u, %bb.s
  ...
  br i1 %i.ey, label %.lr.ph.preheader.i, label %mpb_renorm.exit

.lr.ph.preheader.i:                               ; preds = %pow_ui_inv.exit
  %6 = zext nneg i32 %.pr.i to i64
  br label %.lr.ph.i84

.lr.ph.i84:                                       ; preds = %bb.ac, %.lr.ph.preheader.i
  %indvars.iv.i85 = phi i64 [ %6, %.lr.ph.preheader.i ], [ %indvars.iv.next.i86, %bb.ac ] ; 3 uses
  %i.ez = getelementptr [4 x i8], ptr %0, i64 %indvars.iv.i85
...
bb.ac:                                            ; preds = %.lr.ph.i84
  ...
  %7 = trunc nuw nsw i64 %indvars.iv.next.i86 to i32
  store i32 %7, ptr %0, align 4, !tbaa !14
  %i.fc = icmp sgt i64 %indvars.iv.i85, 2
...
mp_shl.exit:                                      ; preds = %.epil.preheader, %mp_shl.exit.loopexit.unr-lcssa, %bb.d
  ...
  br i1 %i.ag, label %.lr.ph.preheader.i, label %mpb_renorm.exit

.lr.ph.preheader.i:                               ; preds = %mp_shl.exit
  %3 = zext nneg i32 %i.af to i64
  br label %.lr.ph.i104

.lr.ph.i104:                                      ; preds = %bb.f, %.lr.ph.preheader.i
  %indvars.iv.i = phi i64 [ %3, %.lr.ph.preheader.i ], [ %indvars.iv.next.i, %bb.f ] ; 3 uses
...
bb.f:                                             ; preds = %.lr.ph.i104
  ...
  %i.ak = icmp sgt i64 %indvars.iv.i, 2
...
.lr.ph134.a:                                      ; preds = %bb.g
  ...
  %invariant.gep164 = getelementptr [4 x i8], ptr %0, i64 %i.ao ; 2 uses
  %min.iters.check183 = icmp ult i32 %i.al, 8
  br i1 %min.iters.check183, label %scalar.ph182.preheader, label %vector.ph184

vector.ph184:                                     ; preds = %.lr.ph134.a
  %n.vec185 = and i64 %i.an, 2147483640           ; 2 uses
  %i.ap = and i64 %i.an, 7
...
vector.body186:                                   ; preds = %vector.body186, %vector.ph184
  ...
  %i.aq = sub i64 %i.an, %index187                ; 2 uses
  ...
  %wide.load188 = load <4 x i32>, ptr %i.as, align 4, !tbaa !14
  %wide.load189 = load <4 x i32>, ptr %i.at, align 4, !tbaa !14
  %i.au = getelementptr [4 x i8], ptr %invariant.gep164, i64 %i.aq ; 2 uses
  %i.av = getelementptr i8, ptr %i.au, i64 -12
  %i.aw = getelementptr i8, ptr %i.au, i64 -28
  store <4 x i32> %wide.load188, ptr %i.av, align 4, !tbaa !14
  store <4 x i32> %wide.load189, ptr %i.aw, align 4, !tbaa !14
  %index.next190 = add nuw i64 %index187, 8       ; 2 uses
  %i.ax = icmp eq i64 %index.next190, %n.vec185
  br i1 %i.ax, label %middle.block191, label %vector.body186, !llvm.loop !27

middle.block191:                                  ; preds = %vector.body186
  %cmp.n192 = icmp eq i64 %n.vec185, %i.an
  br i1 %cmp.n192, label %.preheader, label %scalar.ph182.preheader

scalar.ph182.preheader:                           ; preds = %.lr.ph134.a, %middle.block191
  %indvars.iv145.ph = phi i64 [ %i.an, %.lr.ph134.a ], [ %i.ap, %middle.block191 ]
...
scalar.ph182:                                     ; preds = %scalar.ph182.preheader, %scalar.ph182
  ...
  store i32 %i.bf, ptr %gep165, align 4, !tbaa !14
  %i.bg = icmp samesign ugt i64 %indvars.iv145, 1
  br i1 %i.bg, label %scalar.ph182, label %.preheader, !llvm.loop !30
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi168 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %i.bu, %vector.body ]
  ...
  %wide.load169 = load <4 x i32>, ptr %i.bs, align 4, !tbaa !14
  %i.bt = or <4 x i32> %wide.load, %vec.phi       ; 2 uses
  %i.bu = or <4 x i32> %wide.load169, %vec.phi168 ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader195, %.lr.ph
  ...
  %.085128 = phi i32 [ %i.bz, %.lr.ph ], [ %.085128.ph, %.lr.ph.preheader195 ]
...
bb.p:                                             ; preds = %bb.o
  %i.co = sub nsw i32 %.pre, %i.cl                ; 7 uses
  store i32 %i.co, ptr %0, align 4, !tbaa !14
  %i.cp = icmp sgt i32 %i.co, 0
  br i1 %i.cp, label %.lr.ph131, label %.loopexit

.lr.ph131:                                        ; preds = %bb.p
  %i.cq = getelementptr inbounds nuw i8, ptr %0, i64 4 ; 3 uses
  %i.cr = zext nneg i32 %i.cl to i64
  %wide.trip.count143 = zext nneg i32 %i.co to i64 ; 3 uses
  %invariant.gep = getelementptr inbounds nuw [4 x i8], ptr %i.cq, i64 %i.cr ; 2 uses
  %min.iters.check171 = icmp ult i32 %i.co, 8
...
vector.body174:                                   ; preds = %vector.body174, %vector.ph172
  ...
  %i.cs = getelementptr inbounds nuw [4 x i8], ptr %invariant.gep, i64 %index175 ; 2 uses
  %i.ct = getelementptr inbounds nuw i8, ptr %i.cs, i64 16
  %wide.load176 = load <4 x i32>, ptr %i.cs, align 4, !tbaa !14
  %wide.load177 = load <4 x i32>, ptr %i.ct, align 4, !tbaa !14
  %i.cu = getelementptr inbounds nuw [4 x i8], ptr %i.cq, i64 %index175 ; 2 uses
  %i.cv = getelementptr inbounds nuw i8, ptr %i.cu, i64 16
  store <4 x i32> %wide.load176, ptr %i.cu, align 4, !tbaa !14
  store <4 x i32> %wide.load177, ptr %i.cv, align 4, !tbaa !14
  %index.next178 = add nuw i64 %index175, 8       ; 2 uses
  %i.cw = icmp eq i64 %index.next178, %n.vec173
  br i1 %i.cw, label %middle.block179, label %vector.body174, !llvm.loop !33
...
scalar.ph170:                                     ; preds = %scalar.ph170.preheader, %scalar.ph170
  ...
  %i.cx = load i32, ptr %gep, align 4, !tbaa !14
  %i.cy = getelementptr inbounds nuw [4 x i8], ptr %i.cq, i64 %indvars.iv140
...
.loopexit:                                        ; preds = %scalar.ph170, %middle.block179, %bb.p, %bb.o
  %i.cz = phi i32 [ %.pre, %bb.o ], [ %i.co, %bb.p ], [ %i.co, %middle.block179 ], [ %i.co, %scalar.ph170 ] ; 4 uses
  %.not99 = icmp ne i32 %i.cm, 0
  %i.da = icmp sgt i32 %i.cz, 0
  %or.cond = select i1 %.not99, i1 %i.da, i1 false
...
.lr.ph.i109.preheader:                            ; preds = %.loopexit
  ...
  %xtraiter = and i64 %i.db, 3                    ; 3 uses
  %i.dc = icmp ult i32 %i.cz, 4
  br i1 %i.dc, label %.lr.ph.i109.epil.preheader, label %.lr.ph.i109.preheader.new

.lr.ph.i109.preheader.new:                        ; preds = %.lr.ph.i109.preheader
  %unroll_iter = and i64 %i.db, 2147483644
  br label %.lr.ph.i109

.lr.ph.i109:                                      ; preds = %.lr.ph.i109, %.lr.ph.i109.preheader.new
  %.016.i = phi i32 [ 0, %.lr.ph.i109.preheader.new ], [ %i.dq, %.lr.ph.i109 ]
  %.014.in15.i = phi i64 [ %i.db, %.lr.ph.i109.preheader.new ], [ %.014.i.3, %.lr.ph.i109 ] ; 5 uses
  ...
  %i.dg = getelementptr [4 x i8], ptr %0, i64 %.014.in15.i
  %i.dh = getelementptr i8, ptr %i.dg, i64 -4     ; 2 uses
  %i.di = load i32, ptr %i.dh, align 4, !tbaa !14 ; 2 uses
  %i.dj = tail call i32 @llvm.fshr.i32(i32 %i.de, i32 %i.di, i32 range(i32 1, 32) %1)
  store i32 %i.dj, ptr %i.dh, align 4, !tbaa !14
  %i.dk = getelementptr [4 x i8], ptr %0, i64 %.014.in15.i
  %i.dl = getelementptr i8, ptr %i.dk, i64 -8     ; 2 uses
  %i.dm = load i32, ptr %i.dl, align 4, !tbaa !14 ; 2 uses
  %i.dn = tail call i32 @llvm.fshr.i32(i32 %i.di, i32 %i.dm, i32 range(i32 1, 32) %1)
  store i32 %i.dn, ptr %i.dl, align 4, !tbaa !14
  %.014.i.3 = add nsw i64 %.014.in15.i, -4        ; 2 uses
  %i.do = getelementptr [4 x i8], ptr %0, i64 %.014.in15.i
  %i.dp = getelementptr i8, ptr %i.do, i64 -12    ; 2 uses
  %i.dq = load i32, ptr %i.dp, align 4, !tbaa !14 ; 3 uses
  %i.dr = tail call i32 @llvm.fshr.i32(i32 %i.dm, i32 %i.dq, i32 range(i32 1, 32) %1)
...
.lr.ph.i109.epil.preheader:                       ; preds = %mp_shr.exit.unr-lcssa, %.lr.ph.i109.preheader
  %.016.i.epil.init = phi i32 [ 0, %.lr.ph.i109.preheader ], [ %i.dq, %mp_shr.exit.unr-lcssa ]
  %.014.in15.i.epil.init = phi i64 [ %i.db, %.lr.ph.i109.preheader ], [ %.014.i.3, %mp_shr.exit.unr-lcssa ]
...
.lr.ph.i109.epil:                                 ; preds = %.lr.ph.i109.epil, %.lr.ph.i109.epil.preheader
  %.016.i.epil = phi i32 [ %i.dt, %.lr.ph.i109.epil ], [ %.016.i.epil.init, %.lr.ph.i109.epil.preheader ]
  ...
  %i.ds = getelementptr [4 x i8], ptr %0, i64 %.014.in15.i.epil ; 2 uses
  %i.dt = load i32, ptr %i.ds, align 4, !tbaa !14 ; 2 uses
  %i.du = tail call i32 @llvm.fshr.i32(i32 %.016.i.epil, i32 %i.dt, i32 range(i32 1, 32) %1)
...
mp_shr.exit:                                      ; preds = %.lr.ph.i109.epil, %mp_shr.exit.unr-lcssa
  %.pr.i110.pr = load i32, ptr %0, align 4, !tbaa !14 ; 4 uses
  %i.dv = icmp sgt i32 %.pr.i110.pr, 1
  br i1 %i.dv, label %.lr.ph.i111, label %mpb_renorm.exit112

.lr.ph.i111:                                      ; preds = %mp_shr.exit
  %i.dw = zext nneg i32 %.pr.i110.pr to i64       ; 2 uses
  %i.dx = getelementptr [4 x i8], ptr %0, i64 %i.dw
  %i.dy = load i32, ptr %i.dx, align 4, !tbaa !14
  %i.dz = icmp eq i32 %i.dy, 0
  br i1 %i.dz, label %bb.q, label %mpb_renorm.exit112

.lr.ph.i112:                                      ; preds = %bb.q
  %5 = getelementptr [4 x i8], ptr %0, i64 %indvars.iv.next.i114
  %6 = load i32, ptr %5, align 4, !tbaa !14
  %7 = icmp eq i32 %6, 0
  br i1 %7, label %bb.q, label %mpb_renorm.exit112, !llvm.loop !19

bb.q:                                             ; preds = %.lr.ph.i111, %.lr.ph.i112
  %indvars.iv.i113171 = phi i64 [ %indvars.iv.next.i114, %.lr.ph.i112 ], [ %i.dw, %.lr.ph.i111 ] ; 2 uses
  %indvars.iv.next.i114 = add nsw i64 %indvars.iv.i113171, -1 ; 3 uses
  %8 = trunc nuw nsw i64 %indvars.iv.next.i114 to i32 ; 3 uses
  store i32 %8, ptr %0, align 4, !tbaa !14
  %i.ea = icmp sgt i64 %indvars.iv.i113171, 2
  br i1 %i.ea, label %.lr.ph.i112, label %.mpb_renorm.exit115.loopexit_crit_edge, !llvm.loop !19

.mpb_renorm.exit115.loopexit_crit_edge:           ; preds = %bb.q
  br label %mpb_renorm.exit112, !llvm.loop !19

mpb_renorm.exit112:                               ; preds = %.lr.ph.i112, %.lr.ph.i111, %.mpb_renorm.exit115.loopexit_crit_edge, %mp_shr.exit, %.loopexit
  %9 = phi i32 [ %i.cz, %.loopexit ], [ %.pr.i110.pr, %mp_shr.exit ], [ %8, %.mpb_renorm.exit115.loopexit_crit_edge ], [ %.pr.i110.pr, %.lr.ph.i111 ], [ %8, %.lr.ph.i112 ] ; 3 uses
  %.not100 = icmp eq i32 %.0, 0
  br i1 %.not100, label %bb.s, label %bb.r

bb.r:                                             ; preds = %mpb_renorm.exit112
  %i.eb = getelementptr inbounds nuw i8, ptr %0, i64 4 ; 2 uses
  %i.ec = sext i32 %9 to i64                      ; 2 uses
  %i.ed = icmp eq i32 %9, 0
  br i1 %i.ed, label %mp_add_ui.exit.thread, label %.lr.ph.i113

.lr.ph.i113:                                      ; preds = %bb.r, %.lr.ph.i113
  %.01415.i = phi i64 [ %i.ei, %.lr.ph.i113 ], [ 0, %bb.r ] ; 2 uses
  %i.ee = getelementptr inbounds nuw [4 x i8], ptr %i.eb, i64 %.01415.i ; 2 uses
  ...
  %i.ei = add nuw i64 %.01415.i, 1                ; 2 uses
  %i.ej = icmp ult i64 %i.ei, %i.ec
  %or.cond.not.i = select i1 %i.ej, i1 %i.eh, i1 false
  br i1 %or.cond.not.i, label %.lr.ph.i113, label %mp_add_ui.exit, !llvm.loop !38

mp_add_ui.exit:                                   ; preds = %.lr.ph.i113
  br i1 %i.eh, label %mp_add_ui.exit.thread, label %bb.s

mp_add_ui.exit.thread:                            ; preds = %bb.r, %mp_add_ui.exit
  %i.ek = add nsw i32 %9, 1
  store i32 %i.ek, ptr %0, align 4, !tbaa !14
  %i.el = getelementptr inbounds [4 x i8], ptr %i.eb, i64 %i.ec
  store i32 1, ptr %i.el, align 4, !tbaa !14
  br label %bb.s
...
.lr.ph.i23.i:                                     ; preds = %bb.bp
  %5 = getelementptr [4 x i8], ptr %4, i64 %indvars.iv.next.i25.i
  %6 = load i32, ptr %5, align 4, !tbaa !14
  %7 = icmp eq i32 %6, 0
  br i1 %7, label %bb.bp, label %mpb_mul1_base.exit, !llvm.loop !19

bb.bp:                                            ; preds = %.lr.ph.i23.i.a, %.lr.ph.i23.i
  %indvars.iv.i24.i558 = phi i64 [ %indvars.iv.next.i25.i, %.lr.ph.i23.i ], [ %i.fp, %.lr.ph.i23.i.a ] ; 2 uses
  %indvars.iv.next.i25.i = add nsw i64 %indvars.iv.i24.i558, -1 ; 3 uses
  %8 = trunc nuw nsw i64 %indvars.iv.next.i25.i to i32 ; 7 uses
  store i32 %8, ptr %4, align 4, !tbaa !14
  %i.ft = icmp sgt i64 %indvars.iv.i24.i558, 2
  br i1 %i.ft, label %.lr.ph.i23.i, label %.mpb_mul1_base.exit.loopexit_crit_edge, !llvm.loop !19

.mpb_mul1_base.exit.loopexit_crit_edge:           ; preds = %bb.bp
  br label %mpb_mul1_base.exit, !llvm.loop !19

mpb_mul1_base.exit:                               ; preds = %.lr.ph.i23.i, %.lr.ph.i23.i.a, %.mpb_mul1_base.exit.loopexit_crit_edge, %bb.bo, %bb.bk, %bb.bh
  %.pr428514 = phi i32 [ %i.cn, %bb.bh ], [ %i.cn, %bb.bk ], [ %i.fn, %bb.bo ], [ %i.fn, %.lr.ph.i23.i.a ], [ %8, %.mpb_mul1_base.exit.loopexit_crit_edge ], [ %8, %.lr.ph.i23.i ]
  %9 = phi i32 [ %i.co, %bb.bh ], [ 1, %bb.bk ], [ %i.fn, %bb.bo ], [ %i.fn, %.lr.ph.i23.i.a ], [ %8, %.mpb_mul1_base.exit.loopexit_crit_edge ], [ %8, %.lr.ph.i23.i ]
  %.pr400509 = phi i32 [ %.pr397, %bb.bh ], [ 1, %bb.bk ], [ %i.fn, %bb.bo ], [ %i.fn, %.lr.ph.i23.i.a ], [ %8, %.mpb_mul1_base.exit.loopexit_crit_edge ], [ %8, %.lr.ph.i23.i ]
  %.1199 = phi i32 [ %i.ea, %bb.bh ], [ 0, %bb.bk ], [ 0, %bb.bo ], [ 0, %.lr.ph.i23.i.a ], [ 0, %.mpb_mul1_base.exit.loopexit_crit_edge ], [ 0, %.lr.ph.i23.i ]
  %.1188 = phi i32 [ %i.eb, %bb.bh ], [ 0, %bb.bk ], [ 0, %bb.bo ], [ 0, %.lr.ph.i23.i.a ], [ 0, %.mpb_mul1_base.exit.loopexit_crit_edge ], [ 0, %.lr.ph.i23.i ]
...
bb.br:                                            ; preds = %mpb_mul1_base.exit, %bb.bq
  %.pr425509 = phi i32 [ %.pr428514, %mpb_mul1_base.exit ], [ %i.cn, %bb.bq ]
  %i.fw = phi i32 [ %9, %mpb_mul1_base.exit ], [ %i.co, %bb.bq ]
  %.pr397505 = phi i32 [ %.pr400509, %mpb_mul1_base.exit ], [ %.pr397, %bb.bq ]
...
bb.cd:                                            ; preds = %mp_mul1.exit.i301, %._crit_edge.i305
  ...
  br i1 %i.iu, label %.lr.ph.preheader.i.i304, label %mpb_mul1_base.exit308

.lr.ph.preheader.i.i304:                          ; preds = %bb.cd
  %10 = zext nneg i32 %i.it to i64
  br label %.lr.ph.i23.i304

.lr.ph.i23.i304:                                  ; preds = %bb.ce, %.lr.ph.preheader.i.i304
  %indvars.iv.i24.i306 = phi i64 [ %10, %.lr.ph.preheader.i.i304 ], [ %indvars.iv.next.i25.i307, %bb.ce ] ; 3 uses
  %i.iv = getelementptr [4 x i8], ptr %4, i64 %indvars.iv.i24.i306
...
bb.ce:                                            ; preds = %.lr.ph.i23.i304
  %indvars.iv.next.i25.i307 = add nsw i64 %indvars.iv.i24.i306, -1 ; 2 uses
  %11 = trunc nuw nsw i64 %indvars.iv.next.i25.i307 to i32
  store i32 %11, ptr %4, align 4, !tbaa !14
  %i.iy = icmp sgt i64 %indvars.iv.i24.i306, 2
...
to_digit.exit326.thread433:                       ; preds = %to_digit.exit320.thread
  ...
  %or.cond473 = select i1 %.0166, i1 true, i1 %i.kd, !prof !40 ; 2 uses
  %i.ke = mul nsw i32 %.0178, 10
  %i.kf = add nsw i32 %i.kb, %i.ke
  %.1179 = select i1 %or.cond473, i32 %.0178, i32 %i.kf, !prof !40
  br label %.preheader
...
bb.cy:                                            ; preds = %bb.cx
  ...
  %i.kw = load i16, ptr %i.kv, align 2, !tbaa !41
