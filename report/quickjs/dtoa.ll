...
bb.q:                                             ; preds = %.lr.ph.i111
  ...
  %i.ea = icmp sgt i32 %6, 2
  br i1 %i.ea, label %.lr.ph.i111, label %mpb_renorm.exit112, !llvm.loop !19

mpb_renorm.exit112:                               ; preds = %bb.q, %.lr.ph.i111, %mp_shr.exit, %.loopexit
  %8 = phi i32 [ %i.cz, %.loopexit ], [ %.pr.i110.pr, %mp_shr.exit ], [ %6, %.lr.ph.i111 ], [ %7, %bb.q ] ; 3 uses
...
bb.r:                                             ; preds = %mpb_renorm.exit112
  ...
  %i.ec = sext i32 %8 to i64                      ; 2 uses
  %i.ed = icmp eq i32 %8, 0
