...
bb.d:                                             ; preds = %.preheader66, %bb.f
  ...
  %i.ax = getelementptr inbounds nuw i8, ptr %0, i64 %i.aw ; 3 uses
  %i.ay = icmp sgt i32 %..i, 0
  br i1 %i.ay, label %.lr.ph.i, label %u64toa_bin_len.exit

.lr.ph.i:                                         ; preds = %bb.d
  %i.az = load i32, ptr %i.k, align 4, !tbaa !18  ; 3 uses
  %i.ba = zext nneg i32 %..i to i64               ; 3 uses
  %xtraiter = and i64 %i.ba, 1
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.prol.loopexit, label %.prol.loopexit.unr-lcssa

.prol.loopexit.unr-lcssa:                         ; preds = %.lr.ph.i
  %indvars.iv.next.i.prol = add nsw i64 %i.ba, -1 ; 2 uses
  %5 = and i32 %i.az, %i.j                        ; 3 uses
  %6 = lshr i32 %i.az, %i.d
  ...
  %11 = getelementptr inbounds nuw i8, ptr %i.ax, i64 %indvars.iv.next.i.prol
  store i8 %10, ptr %11, align 1, !tbaa !15
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.prol.loopexit.unr-lcssa, %.lr.ph.i
  %indvars.iv.i.unr = phi i64 [ %i.ba, %.lr.ph.i ], [ %indvars.iv.next.i.prol, %.prol.loopexit.unr-lcssa ]
  %.01416.i.unr = phi i32 [ %i.az, %.lr.ph.i ], [ %6, %.prol.loopexit.unr-lcssa ]
  %12 = icmp eq i32 %..i, 1
...
bb.e:                                             ; preds = %.prol.loopexit, %bb.e
  ...
  %.01416.i = phi i32 [ %i.bc, %bb.e ], [ %.01416.i.unr, %.prol.loopexit ] ; 2 uses
...
.lr.ph.split:                                     ; preds = %.lr.ph, %limb_to_a.exit
  %.169 = phi i32 [ %i.bj, %limb_to_a.exit ], [ %3, %.lr.ph ] ; 2 uses
  %..i54 = tail call noundef i32 @llvm.smin.i32(i32 %.169, i32 %i.i) ; 3 uses
  %i.bj = sub nsw i32 %.169, %..i54               ; 3 uses
  %i.bk = load i32, ptr %1, align 4, !tbaa !18    ; 3 uses
  %.013.i55 = add i32 %i.bk, -1                   ; 2 uses
  %i.bl = icmp sgt i32 %.013.i55, -1
  br i1 %i.bl, label %.lr.ph.i56, label %mpb_renorm.exit

.lr.ph.i56:                                       ; preds = %.lr.ph.split
  %i.bm = load i32, ptr %i.n, align 4, !tbaa !18
  %i.bn = zext i32 %i.bm to i64                   ; 2 uses
  %i.bo = zext nneg i32 %.013.i55 to i64
  br label %bb.g

bb.g:                                             ; preds = %bb.g, %.lr.ph.i56
  %indvars.iv.i57 = phi i64 [ %i.bo, %.lr.ph.i56 ], [ %indvars.iv.next.i58, %bb.g ] ; 3 uses
  %.01214.i = phi i64 [ 0, %.lr.ph.i56 ], [ %i.bw, %bb.g ]
  %i.bp = shl nuw i64 %.01214.i, 32
  %i.bq = getelementptr inbounds nuw [4 x i8], ptr %i.m, i64 %indvars.iv.i57 ; 2 uses
  %i.br = load i32, ptr %i.bq, align 4, !tbaa !18
  %i.bs = zext i32 %i.br to i64
  %i.bt = or disjoint i64 %i.bp, %i.bs            ; 2 uses
  %i.bu = udiv i64 %i.bt, %i.bn
  %i.bv = trunc i64 %i.bu to i32
  store i32 %i.bv, ptr %i.bq, align 4, !tbaa !18
  %i.bw = urem i64 %i.bt, %i.bn                   ; 2 uses
...
mp_div1.exit:                                     ; preds = %bb.g
  %i.bx = trunc nuw i64 %i.bw to i32              ; 3 uses
  %i.by = icmp sgt i32 %i.bk, 1
  br i1 %i.by, label %.lr.ph.i59, label %mpb_renorm.exit

.lr.ph.i59:                                       ; preds = %mp_div1.exit, %bb.h
  %i.bz = phi i32 [ %i.ce, %bb.h ], [ %i.bk, %mp_div1.exit ] ; 3 uses
  %i.ca = zext nneg i32 %i.bz to i64
  %i.cb = getelementptr [4 x i8], ptr %1, i64 %i.ca
  %i.cc = load i32, ptr %i.cb, align 4, !tbaa !18
  %i.cd = icmp eq i32 %i.cc, 0
  br i1 %i.cd, label %bb.h, label %mpb_renorm.exit

bb.h:                                             ; preds = %.lr.ph.i59
  %i.ce = add nsw i32 %i.bz, -1                   ; 2 uses
  store i32 %i.ce, ptr %1, align 4, !tbaa !18
  %i.cf = icmp sgt i32 %i.bz, 2
  br i1 %i.cf, label %.lr.ph.i59, label %mpb_renorm.exit, !llvm.loop !4

mpb_renorm.exit:                                  ; preds = %.lr.ph.i59, %bb.h, %.lr.ph.split, %mp_div1.exit
  %.012.lcssa.i64 = phi i32 [ 0, %.lr.ph.split ], [ %i.bx, %mp_div1.exit ], [ %i.bx, %bb.h ], [ %i.bx, %.lr.ph.i59 ]
  %i.cg = zext nneg i32 %i.bj to i64
  %i.ch = getelementptr inbounds nuw i8, ptr %0, i64 %i.cg
  %i.ci = icmp sgt i32 %..i54, 0
  br i1 %i.ci, label %.lr.ph.preheader.i, label %limb_to_a.exit

.lr.ph.preheader.i:                               ; preds = %mpb_renorm.exit
  %i.cj = zext nneg i32 %..i54 to i64
  br label %.lr.ph.i60

.lr.ph.i60:                                       ; preds = %.lr.ph.i60, %.lr.ph.preheader.i
  %indvars.iv.i61 = phi i64 [ %i.cj, %.lr.ph.preheader.i ], [ %indvars.iv.next.i62, %.lr.ph.i60 ] ; 2 uses
  %.01721.i = phi i32 [ %.012.lcssa.i64, %.lr.ph.preheader.i ], [ %i.cl, %.lr.ph.i60 ] ; 2 uses
  %indvars.iv.next.i62 = add nsw i64 %indvars.iv.i61, -1 ; 2 uses
  %i.ck = urem i32 %.01721.i, %2                  ; 2 uses
  %i.cl = udiv i32 %.01721.i, %2
  %i.cm = icmp slt i32 %i.ck, 10
  %.016.v.i = select i1 %i.cm, i32 48, i32 87
  %.016.i = add nsw i32 %.016.v.i, %i.ck
  %i.cn = trunc i32 %.016.i to i8
  %i.co = getelementptr inbounds nuw i8, ptr %i.ch, i64 %indvars.iv.next.i62
