...
.peel.next1159:                                   ; preds = %bb.dx
  ...
  %5 = sub nsw i64 %i.ij, %i.ii
  %i.im = sub nsw i64 %i.ii, %i.ig
  %6 = sub nsw i64 %i.ig, %i.ie
  %7 = sitofp i64 %i.il to double
  %i.in = sitofp i64 %5 to double
  %8 = sitofp i64 %i.im to double
  %i.io = sitofp i64 %6 to double
  %i.ip = insertelement <4 x double> poison, double %i.io, i64 0
  %i.iq = insertelement <4 x double> %i.ip, double %8, i64 1
  %i.ir = insertelement <4 x double> %i.iq, double %i.in, i64 2
  %i.is = insertelement <4 x double> %i.ir, double %7, i64 3
...
.split.preheader:                                 ; preds = %.split.preheader, %.peel.next1159
  ...
  %9 = sub nsw i64 %i.jb, %i.ja
  %i.je = sub nsw i64 %i.ja, %i.iy
  %10 = sub nsw i64 %i.iy, %i.iw
  %11 = sitofp i64 %i.jd to double
  %i.jf = sitofp i64 %9 to double
  %12 = sitofp i64 %i.je to double
  %i.jg = sitofp i64 %10 to double
  %i.jh = insertelement <4 x double> poison, double %i.jg, i64 0
  %i.ji = insertelement <4 x double> %i.jh, double %12, i64 1
  %i.jj = insertelement <4 x double> %i.ji, double %i.jf, i64 2
  %i.jk = insertelement <4 x double> %i.jj, double %11, i64 3
