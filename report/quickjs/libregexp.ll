...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %i.ak, label %8, label %bb.d

8:                                                ; preds = %bb.c
  br label %bb.d

bb.d:                                             ; preds = %bb.b, %bb.c, %8, %._crit_edge
  %.1 = phi ptr [ %i.aa, %._crit_edge ], [ %i.ah, %8 ], [ %i.aa, %bb.c ], [ %i.aa, %bb.b ]
...
is_line_terminator.exit1283.i:                    ; preds = %is_line_terminator.exit1283.i.backedge, %bb.d
  ...
  %.0984.i = phi ptr [ %i.q, %bb.d ], [ %.0984.i.be, %is_line_terminator.exit1283.i.backedge ] ; 91 uses
  %.0946.i = phi ptr [ %i.q, %bb.d ], [ %.0946.i.be, %is_line_terminator.exit1283.i.backedge ] ; 89 uses
  %.0921.i = phi ptr [ %i.am, %bb.d ], [ %.0921.i.be, %is_line_terminator.exit1283.i.backedge ] ; 86 uses
  %i.ao = getelementptr inbounds nuw i8, ptr %.01070.i, i64 1 ; 37 uses
...
bb.gq:                                            ; preds = %bb.gp
  ...
  br i1 %i.ahl, label %9, label %is_line_terminator.exit1283.i.backedge

9:                                                ; preds = %bb.gq
  br label %is_line_terminator.exit1283.i.backedge

is_line_terminator.exit1283.i.backedge:           ; preds = %bb.ee, %bb.eu, %.preheader1557.i, %bb.cc, %.loopexit.i, %9, %bb.gq, %bb.gp, %bb.go, %bb.gl, %.loopexit1567.i, %bb.ed, %bb.ec, %bb.dl, %.thread1495.i.a, %bb.de, %bb.db, %bb.cy, %bb.cx, %bb.cq, %bb.cp, %.loopexit1555.i, %.thread1410.i, %bb.by, %bb.bu, %lre_is_space.exit1292.i, %lre_is_space.exit.i, %bb.bc, %bb.bb, %bb.ba, %bb.ax, %bb.aq, %bb.aq, %bb.aq, %bb.aq, %bb.aj, %bb.ai, %bb.ai, %bb.ai, %bb.ai, %bb.ab, %bb.aa, %bb.z, %bb.y, %.thread1342.i, %bb.t, %bb.h, %bb.g, %bb.f
  %.01070.i.be = phi ptr [ %i.ao, %bb.bb ], [ %i.zq, %bb.ed ], [ %i.dn, %bb.t ], [ %.51075.i, %.thread1342.i ], [ %i.fl, %bb.y ], [ %i.bc, %bb.g ], [ %i.ao, %bb.ab ], [ %i.gr, %bb.aa ], [ %i.ao, %bb.aj ], [ %i.ao, %bb.ai ], [ %i.ao, %bb.gp ], [ %i.ao, %bb.ba ], [ %i.bp, %bb.h ], [ %i.ao, %lre_is_space.exit.i ], [ %i.ao, %lre_is_space.exit1292.i ], [ %i.lj, %bb.bu ], [ %i.ao, %bb.ax ], [ %i.po, %.thread1410.i ], [ %i.ao, %bb.aq ], [ %i.sg, %bb.cq ], [ %i.vv, %.thread1495.i.a ], [ %i.xc, %bb.dl ], [ %i.ao, %bb.ec ], [ %i.mq, %bb.cc ], [ %i.afi, %.loopexit1567.i ], [ %i.agz, %bb.gl ], [ %i.ao, %bb.go ], [ %i.uc, %bb.cx ], [ %i.ao, %bb.bc ], [ %i.uc, %bb.cy ], [ %i.ao, %bb.gq ], [ %i.ao, %9 ], [ %i.bp, %.loopexit.i ], [ %i.mq, %bb.by ], [ %i.bc, %bb.f ], [ %i.gr, %bb.z ], [ %i.ao, %bb.ai ], [ %i.ao, %bb.ai ], [ %i.ao, %bb.ai ], [ %i.ao, %bb.aq ], [ %i.ao, %bb.aq ], [ %i.ao, %bb.aq ], [ %i.qy, %.loopexit1555.i ], [ %i.sg, %bb.cp ], [ %i.st, %bb.db ], [ %.81078.i, %bb.de ], [ %i.zq, %.preheader1557.i ], [ %i.zq, %bb.eu ], [ %i.zq, %bb.ee ]
  %.01051.i.be = phi ptr [ %i.jc, %bb.bb ], [ %.01051.i, %bb.ed ], [ %.41055.i, %bb.t ], [ %.01051.i, %.thread1342.i ], [ %.01051.i, %bb.y ], [ %i.be, %bb.g ], [ %.01051.i, %bb.ab ], [ %.01051.i, %bb.aa ], [ %.01051.i, %bb.aj ], [ %.01051.i, %bb.ai ], [ %i.ahd, %bb.gp ], [ %i.jb, %bb.ba ], [ %i.br, %bb.h ], [ %.610571358.i, %lre_is_space.exit.i ], [ %.710581370.i, %lre_is_space.exit1292.i ], [ %.01051.i, %bb.bu ], [ %.51056.i, %bb.ax ], [ %.01051.i, %.thread1410.i ], [ %.01051.i, %bb.aq ], [ %.01051.i, %bb.cq ], [ %.01051.i, %.thread1495.i.a ], [ %.01051.i, %bb.dl ], [ %.01051.i, %bb.ec ], [ %.01051.i, %bb.cc ], [ %.141065.i, %.loopexit1567.i ], [ %.161067.i, %bb.gl ], [ %i.ahc, %bb.go ], [ %.01051.i, %bb.cx ], [ %spec.select1549.i, %bb.bc ], [ %.01051.i, %bb.cy ], [ %i.ahd, %bb.gq ], [ %i.ahi, %9 ], [ %i.br, %.loopexit.i ], [ %.01051.i, %bb.by ], [ %i.be, %bb.f ], [ %.01051.i, %bb.z ], [ %.01051.i, %bb.ai ], [ %.01051.i, %bb.ai ], [ %.01051.i, %bb.ai ], [ %.01051.i, %bb.aq ], [ %.01051.i, %bb.aq ], [ %.01051.i, %bb.aq ], [ %.01051.i, %.loopexit1555.i ], [ %.01051.i, %bb.cp ], [ %.01051.i, %bb.db ], [ %.01051.i, %bb.de ], [ %.81059.i, %.preheader1557.i ], [ %.101061.i, %bb.eu ], [ %.01051.i, %bb.ee ]
  %.0984.i.be = phi ptr [ %.0984.i, %bb.bb ], [ %.0984.i, %bb.ed ], [ %.0984.i, %bb.t ], [ %i.fk, %.thread1342.i ], [ %i.go, %bb.y ], [ %i.bb, %bb.g ], [ %.0984.i, %bb.ab ], [ %.0984.i, %bb.aa ], [ %.0984.i, %bb.aj ], [ %.0984.i, %bb.ai ], [ %.0984.i, %bb.gp ], [ %.0984.i, %bb.ba ], [ %i.bo, %bb.h ], [ %.0984.i, %lre_is_space.exit.i ], [ %.0984.i, %lre_is_space.exit1292.i ], [ %i.ml, %bb.bu ], [ %.0984.i, %bb.ax ], [ %.281012.i, %.thread1410.i ], [ %.0984.i, %bb.aq ], [ %.321016.i, %bb.cq ], [ %.44.i, %.thread1495.i.a ], [ %.0984.i, %bb.dl ], [ %.0984.i, %bb.ec ], [ %i.ph, %bb.cc ], [ %.0984.i, %.loopexit1567.i ], [ %.0984.i, %bb.gl ], [ %.0984.i, %bb.go ], [ %.361020.i, %bb.cx ], [ %.0984.i, %bb.bc ], [ %.361020.i, %bb.cy ], [ %.0984.i, %bb.gq ], [ %.0984.i, %9 ], [ %.7991.lcssa.i, %.loopexit.i ], [ %.191003.i, %bb.by ], [ %i.bb, %bb.f ], [ %.0984.i, %bb.z ], [ %.0984.i, %bb.ai ], [ %.0984.i, %bb.ai ], [ %.0984.i, %bb.ai ], [ %.0984.i, %bb.aq ], [ %.0984.i, %bb.aq ], [ %.0984.i, %bb.aq ], [ %.321016.i, %.loopexit1555.i ], [ %.321016.i, %bb.cp ], [ %.361020.i, %bb.db ], [ %i.vp, %bb.de ], [ %.0984.i, %.preheader1557.i ], [ %.0984.i, %bb.eu ], [ %.0984.i, %bb.ee ]
  %.0946.i.be = phi ptr [ %.0946.i, %bb.bb ], [ %.0946.i, %bb.ed ], [ %.0946.i, %bb.t ], [ %i.fk, %.thread1342.i ], [ %i.go, %bb.y ], [ %i.bi, %bb.g ], [ %.0946.i, %bb.ab ], [ %.0946.i, %bb.aa ], [ %.0946.i, %bb.aj ], [ %.0946.i, %bb.ai ], [ %.0946.i, %bb.gp ], [ %.0946.i, %bb.ba ], [ %i.bw, %bb.h ], [ %.0946.i, %lre_is_space.exit.i ], [ %.0946.i, %lre_is_space.exit1292.i ], [ %.12958.i, %bb.bu ], [ %.0946.i, %bb.ax ], [ %.23969.i, %.thread1410.i ], [ %.0946.i, %bb.aq ], [ %.27973.i, %bb.cq ], [ %.39.i, %.thread1495.i.a ], [ %.0946.i, %bb.dl ], [ %.0946.i, %bb.ec ], [ %.19965.i, %bb.cc ], [ %.0946.i, %.loopexit1567.i ], [ %.0946.i, %bb.gl ], [ %.0946.i, %bb.go ], [ %.31977.i, %bb.cx ], [ %.0946.i, %bb.bc ], [ %.31977.i, %bb.cy ], [ %.0946.i, %bb.gq ], [ %.0946.i, %9 ], [ %i.bw, %.loopexit.i ], [ %.14960.i, %bb.by ], [ %i.bi, %bb.f ], [ %.0946.i, %bb.z ], [ %.0946.i, %bb.ai ], [ %.0946.i, %bb.ai ], [ %.0946.i, %bb.ai ], [ %.0946.i, %bb.aq ], [ %.0946.i, %bb.aq ], [ %.0946.i, %bb.aq ], [ %.27973.i, %.loopexit1555.i ], [ %.27973.i, %bb.cp ], [ %.31977.i, %bb.db ], [ %i.vp, %bb.de ], [ %.0946.i, %.preheader1557.i ], [ %.0946.i, %bb.eu ], [ %.0946.i, %bb.ee ]
  %.0921.i.be = phi ptr [ %.0921.i, %bb.bb ], [ %.0921.i, %bb.ed ], [ %.0921.i, %bb.t ], [ %.3924.i, %.thread1342.i ], [ %.6927.i, %bb.y ], [ %.1922.i, %bb.g ], [ %.0921.i, %bb.ab ], [ %.0921.i, %bb.aa ], [ %.0921.i, %bb.aj ], [ %.0921.i, %bb.ai ], [ %.0921.i, %bb.gp ], [ %.0921.i, %bb.ba ], [ %.0921.i, %bb.h ], [ %.0921.i, %lre_is_space.exit.i ], [ %.0921.i, %lre_is_space.exit1292.i ], [ %.8929.i, %bb.bu ], [ %.0921.i, %bb.ax ], [ %.19940.i, %.thread1410.i ], [ %.0921.i, %bb.aq ], [ %.23944.i, %bb.cq ], [ %.35.i, %.thread1495.i.a ], [ %.0921.i, %bb.dl ], [ %.0921.i, %bb.ec ], [ %.15936.i, %bb.cc ], [ %.0921.i, %.loopexit1567.i ], [ %.0921.i, %bb.gl ], [ %.0921.i, %bb.go ], [ %.27.i, %bb.cx ], [ %.0921.i, %bb.bc ], [ %.27.i, %bb.cy ], [ %.0921.i, %bb.gq ], [ %.0921.i, %9 ], [ %.0921.i, %.loopexit.i ], [ %.10931.i, %bb.by ], [ %.1922.i, %bb.f ], [ %.0921.i, %bb.z ], [ %.0921.i, %bb.ai ], [ %.0921.i, %bb.ai ], [ %.0921.i, %bb.ai ], [ %.0921.i, %bb.aq ], [ %.0921.i, %bb.aq ], [ %.0921.i, %bb.aq ], [ %.23944.i, %.loopexit1555.i ], [ %.23944.i, %bb.cp ], [ %.27.i, %bb.db ], [ %.30.i, %bb.de ], [ %.0921.i, %.preheader1557.i ], [ %.0921.i, %bb.eu ], [ %.0921.i, %bb.ee ]
  br label %is_line_terminator.exit1283.i
...
lre_exec_backtrack.exit:                          ; preds = %is_line_terminator.exit1283.i, %bb.g, %bb.v, %bb.x, %bb.aa, %bb.br, %bb.bt, %bb.bv, %bb.bx, %bb.ch, %bb.cn, %bb.cq, %bb.cv, %bb.cy, %bb.dd, %bb.dj, %bb.bz, %bb.cb, %bb.e
  %.411125.i = phi i32 [ -1, %bb.bz ], [ 0, %bb.e ], [ -1, %bb.cb ], [ 1, %is_line_terminator.exit1283.i ], [ -2, %bb.g ], [ -1, %bb.v ], [ -3, %bb.br ], [ -1, %bb.x ], [ -2, %bb.aa ], [ -1, %bb.cv ], [ -1, %bb.bt ], [ -1, %bb.ch ], [ -2, %bb.cy ], [ -2, %bb.cq ], [ -3, %bb.bv ], [ -1, %bb.bx ], [ -1, %bb.dd ], [ -1, %bb.dj ], [ -1, %bb.cn ]
