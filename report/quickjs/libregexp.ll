...
begin_hunk_0_@re_emit_string_list:bb.a
  %i.co = load i32, ptr %i.cn, align 4, !tbaa !38
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.cq = shl i64 %.180.i.i, 1                    ; 2 uses
  %i.cr = add i64 %i.cq, 8                        ; 2 uses
  %i.cs = icmp ult i64 %i.cr, %.116.i.i
...
.lr.ph288:                                        ; preds = %.lr.ph43.preheader.i, %.lr.ph43.i
  ...
  %.018039.i287 = phi ptr [ %.1181.i, %.lr.ph43.i ], [ %i.af, %.lr.ph43.preheader.i ] ; 12 uses
  %.116741.i286 = phi ptr [ %.2168.i, %.lr.ph43.i ], [ %i.ae, %.lr.ph43.preheader.i ] ; 4 uses
  %.042.i285 = phi i64 [ %.1.i, %.lr.ph43.i ], [ %i.ah, %.lr.ph43.preheader.i ] ; 3 uses
  %i.ct = add nsw i32 %.in, 1                     ; 3 uses
  %i.cu = shl i64 %.042.i285, 1
  %i.cv = and i64 %i.cu, -8                       ; 3 uses
  %i.cw = getelementptr inbounds nuw i8, ptr %.018039.i287, i64 %i.cv ; 3 uses
  %i.cx = shl i64 %i.cv, 1
  %i.cy = getelementptr inbounds nuw i8, ptr %.018039.i287, i64 %i.cx ; 3 uses
  %i.cz = mul i64 %i.cv, 3
  %i.da = getelementptr inbounds nuw i8, ptr %.018039.i287, i64 %i.cz ; 3 uses
...
med3.exit.i:                                      ; preds = %bb.x, %bb.w, %bb.v, %bb.u
  ...
  call void %.0.i104.i(ptr noundef nonnull %.018039.i287, ptr noundef nonnull %i.dr, i64 noundef 8) #20, !inline_history !110
  %i.ds = getelementptr inbounds nuw i8, ptr %.018039.i287, i64 8 ; 2 uses
  %i.dt = shl i64 %.042.i285, 3
  %i.du = getelementptr inbounds nuw i8, ptr %.018039.i287, i64 %i.dt ; 5 uses
  br label %bb.y

bb.y:                                             ; preds = %bb.af, %med3.exit.i
  %.0191.i = phi ptr [ %i.du, %med3.exit.i ], [ %i.ek, %bb.af ] ; 3 uses
  %.0188.i = phi ptr [ %i.ds, %med3.exit.i ], [ %.1189.lcssa.i, %bb.af ] ; 2 uses
  %.0185.i = phi ptr [ %i.du, %med3.exit.i ], [ %.118624.i, %bb.af ] ; 2 uses
  %.0182.i = phi ptr [ %i.ds, %med3.exit.i ], [ %i.ex, %bb.af ] ; 3 uses
  %.0178.i = phi i64 [ 1, %med3.exit.i ], [ %i.ew, %bb.af ] ; 2 uses
  %.0175.i = phi i64 [ 1, %med3.exit.i ], [ %.1176.lcssa.i, %bb.af ] ; 2 uses
  %.0172.i = phi i64 [ %.042.i285, %med3.exit.i ], [ %.117325.i, %bb.af ] ; 2 uses
  %i.dv = icmp ult ptr %.0182.i, %.0191.i
  br i1 %i.dv, label %.lr.ph.i, label %.critedge.i

.lr.ph.i:                                         ; preds = %bb.y, %bb.ab
  %.117615.i = phi i64 [ %.2177.i, %bb.ab ], [ %.0175.i, %bb.y ] ; 3 uses
  %.117914.i = phi i64 [ %i.ef, %bb.ab ], [ %.0178.i, %bb.y ] ; 2 uses
  %.118313.i = phi ptr [ %i.eg, %bb.ab ], [ %.0182.i, %bb.y ] ; 4 uses
  %.118912.i = phi ptr [ %.2190.i, %bb.ab ], [ %.0188.i, %bb.y ] ; 4 uses
  %i.dw = load ptr, ptr %.018039.i287, align 8, !tbaa !88
  %i.dx = load ptr, ptr %.118313.i, align 8, !tbaa !88
...
bb.aa:                                            ; preds = %bb.z
  call void %.0.i104.i(ptr noundef %.118912.i, ptr noundef nonnull %.118313.i, i64 noundef 8) #20, !inline_history !110
  %i.ed = add i64 %.117615.i, 1
  %i.ee = getelementptr inbounds nuw i8, ptr %.118912.i, i64 8
  br label %bb.ab

bb.ab:                                            ; preds = %bb.aa, %bb.z
  %.2190.i = phi ptr [ %i.ee, %bb.aa ], [ %.118912.i, %bb.z ] ; 2 uses
  %.2177.i = phi i64 [ %i.ed, %bb.aa ], [ %.117615.i, %bb.z ] ; 2 uses
  %i.ef = add i64 %.117914.i, 1                   ; 2 uses
  %i.eg = getelementptr inbounds nuw i8, ptr %.118313.i, i64 8 ; 3 uses
  %i.eh = icmp ult ptr %i.eg, %.0191.i
  br i1 %i.eh, label %.lr.ph.i, label %.critedge.i, !llvm.loop !111

.critedge.i:                                      ; preds = %bb.ab, %.lr.ph.i, %bb.y
  %.1189.lcssa.i = phi ptr [ %.0188.i, %bb.y ], [ %.118912.i, %.lr.ph.i ], [ %.2190.i, %bb.ab ] ; 2 uses
  %.1183.lcssa.i = phi ptr [ %.0182.i, %bb.y ], [ %.118313.i, %.lr.ph.i ], [ %i.eg, %bb.ab ] ; 7 uses
  %.1179.lcssa.i = phi i64 [ %.0178.i, %bb.y ], [ %.117914.i, %.lr.ph.i ], [ %i.ef, %bb.ab ] ; 3 uses
  %.1176.lcssa.i = phi i64 [ %.0175.i, %bb.y ], [ %.117615.i, %.lr.ph.i ], [ %.2177.i, %bb.ab ] ; 2 uses
  %i.ei = getelementptr inbounds i8, ptr %.0191.i, i64 -8 ; 2 uses
  %i.ej = icmp ult ptr %.1183.lcssa.i, %i.ei
...
.lr.ph26.i:                                       ; preds = %.critedge.i, %bb.ae
  ...
  %.117325.i = phi i64 [ %.2174.i, %bb.ae ], [ %.0172.i, %.critedge.i ] ; 3 uses
  %.118624.i = phi ptr [ %.2187.i, %bb.ae ], [ %.0185.i, %.critedge.i ] ; 3 uses
  %i.el = load ptr, ptr %.018039.i287, align 8, !tbaa !88
...
bb.ad:                                            ; preds = %bb.ac
  %i.es = add i64 %.117325.i, -1
  %i.et = getelementptr inbounds i8, ptr %.118624.i, i64 -8 ; 2 uses
  call void %.0.i104.i(ptr noundef nonnull %i.et, ptr noundef nonnull %i.ek, i64 noundef 8) #20, !inline_history !110
  br label %bb.ae

bb.ae:                                            ; preds = %bb.ad, %bb.ac
  %.2187.i = phi ptr [ %i.et, %bb.ad ], [ %.118624.i, %bb.ac ] ; 2 uses
  %.2174.i = phi i64 [ %i.es, %bb.ad ], [ %.117325.i, %bb.ac ] ; 2 uses
  %i.eu = getelementptr inbounds i8, ptr %i.ek, i64 -8 ; 2 uses
  %i.ev = icmp ult ptr %.1183.lcssa.i, %i.eu
  br i1 %i.ev, label %.lr.ph26.i, label %.critedge3.i, !llvm.loop !112

bb.af:                                            ; preds = %.lr.ph26.i
  call void %.0.i104.i(ptr noundef %.1183.lcssa.i, ptr noundef nonnull %i.ek, i64 noundef 8) #20, !inline_history !110
  %i.ew = add i64 %.1179.lcssa.i, 1
  %i.ex = getelementptr inbounds nuw i8, ptr %.1183.lcssa.i, i64 8
  br label %bb.y

.critedge3.i:                                     ; preds = %.critedge.i, %bb.ae
  %.1186.lcssa.i = phi ptr [ %.2187.i, %bb.ae ], [ %.0185.i, %.critedge.i ]
  %.1173.lcssa.i = phi i64 [ %.2174.i, %bb.ae ], [ %.0172.i, %.critedge.i ]
  %i.ey = ptrtoint ptr %.1189.lcssa.i to i64      ; 2 uses
  %i.ez = ptrtoint ptr %.018039.i287 to i64
  %i.fa = sub i64 %i.ey, %i.ez
  %i.fb = ptrtoint ptr %.1183.lcssa.i to i64      ; 2 uses
  %i.fc = sub i64 %i.fb, %i.ey
  %i.fd = sub i64 %.1179.lcssa.i, %.1176.lcssa.i  ; 3 uses
  %spec.select.i = call i64 @llvm.umin.i64(i64 %i.fa, i64 %i.fc) ; 2 uses
  %i.fe = sub i64 0, %spec.select.i
  %i.ff = getelementptr inbounds i8, ptr %.1183.lcssa.i, i64 %i.fe
  call void %.0.i209.i(ptr noundef nonnull %.018039.i287, ptr noundef %i.ff, i64 noundef %spec.select.i) #20, !inline_history !110
  %i.fg = ptrtoint ptr %i.du to i64
  %i.fh = ptrtoint ptr %.1186.lcssa.i to i64      ; 2 uses
  %i.fi = sub i64 %i.fg, %i.fh
  %i.fj = sub i64 %i.fh, %i.fb                    ; 2 uses
  %i.fk = sub i64 0, %i.fj
  %i.fl = getelementptr inbounds i8, ptr %i.du, i64 %i.fk ; 2 uses
  %i.fm = sub i64 %.1173.lcssa.i, %.1179.lcssa.i  ; 3 uses
  %.1171.i = call i64 @llvm.umin.i64(i64 %i.fi, i64 %i.fj) ; 2 uses
  %i.fn = sub i64 0, %.1171.i
  %i.fo = getelementptr inbounds i8, ptr %i.du, i64 %i.fn
  call void %.0.i209.i(ptr noundef %.1183.lcssa.i, ptr noundef nonnull %i.fo, i64 noundef %.1171.i) #20, !inline_history !110
...
bb.ah:                                            ; preds = %bb.ag, %.critedge3.i
  %.sink71.i = phi ptr [ %i.fl, %bb.ag ], [ %.018039.i287, %.critedge3.i ]
  %.sink.i = phi i64 [ %i.fm, %bb.ag ], [ %i.fd, %.critedge3.i ]
  %.1181.i = phi ptr [ %.018039.i287, %bb.ag ], [ %i.fl, %.critedge3.i ] ; 3 uses
  %.1.i = phi i64 [ %i.fd, %bb.ag ], [ %i.fm, %.critedge3.i ] ; 4 uses
  store ptr %.sink71.i, ptr %.116741.i286, align 8, !tbaa !99
  %i.fq = getelementptr inbounds nuw i8, ptr %.116741.i286, i64 8
  store i64 %.sink.i, ptr %i.fq, align 8, !tbaa !101
  %i.fr = getelementptr inbounds nuw i8, ptr %.116741.i286, i64 16
  store i32 %i.ct, ptr %i.fr, align 8, !tbaa !102
  %.2168.i = getelementptr inbounds nuw i8, ptr %.116741.i286, i64 24 ; 3 uses
  %i.fs = icmp ugt i64 %.1.i, 6
  br i1 %i.fs, label %.lr.ph43.i, label %heapsortx.exit.i, !llvm.loop !104

heapsortx.exit.i:                                 ; preds = %bb.ah, %bb.m
  %.018011.i = phi ptr [ %i.af, %bb.m ], [ %.1181.i, %bb.ah ] ; 4 uses
  %.11679.i = phi ptr [ %i.ae, %bb.m ], [ %.2168.i, %bb.ah ] ; 2 uses
  %.2.i = phi i64 [ %i.ah, %bb.m ], [ %.1.i, %bb.ah ] ; 2 uses
  %i.ft = shl nuw nsw i64 %.2.i, 3
  %i.fu = getelementptr inbounds nuw i8, ptr %.018011.i, i64 %i.ft
  %i.fv = icmp samesign ugt i64 %.2.i, 1
...
.preheader.i:                                     ; preds = %.critedge5.i, %.preheader.preheader.i
  %.218451.i = phi ptr [ %.2184.i, %.critedge5.i ], [ %.218450.i, %.preheader.preheader.i ] ; 3 uses
  %3 = icmp ugt ptr %.218451.i, %.018011.i
  br i1 %3, label %.lr.ph48.i, label %.critedge5.i

.lr.ph48.i:                                       ; preds = %.preheader.i, %bb.ai
  %.219347.i = phi ptr [ %i.fw, %bb.ai ], [ %.218451.i, %.preheader.i ] ; 3 uses
  %i.fw = getelementptr inbounds i8, ptr %.219347.i, i64 -8 ; 4 uses
  %i.fx = load ptr, ptr %i.fw, align 8, !tbaa !88
  %i.fy = load ptr, ptr %.219347.i, align 8, !tbaa !88
...
bb.ai:                                            ; preds = %.lr.ph48.i
  call void %.0.i104.i(ptr noundef nonnull %.219347.i, ptr noundef nonnull %i.fw, i64 noundef 8) #20, !inline_history !110
  %i.ge = icmp ugt ptr %i.fw, %.018011.i
