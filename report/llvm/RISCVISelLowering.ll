...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !203, !nonnull !51, !align !204
  %i.c = getelementptr inbounds nuw i8, ptr %i.b, i64 656
  %i.d = load i8, ptr %i.c, align 8, !tbaa !205, !range !50, !noundef !51
  ...
  %i.j = load i16, ptr %i.i, align 2, !tbaa !217
  %i.k = add i16 %1, -163
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = load i16, ptr %i.d, align 2, !tbaa !216
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !203, !nonnull !51, !align !204 ; 3 uses
  %i.d = getelementptr inbounds nuw i8, ptr %i.c, i64 349
  %i.e = load i8, ptr %i.d, align 1, !tbaa !1262, !range !50, !noundef !51 ; 3 uses
...
switch.lookup:                                    ; preds = %bb.b
  ...
  %i.n = load i16, ptr %i.m, align 2, !tbaa !216
...
bb.h:                                             ; preds = %_ZNK4llvm8TypeSizecvmEv.exit
  ...
  %i.aa = load i32, ptr %i.z, align 8, !tbaa !266
  br label %_ZNK4llvm14RISCVSubtarget14getRealMinVLenEv.exit
...
bb.a:
  ...
  %i.e = load i8, ptr %i.d, align 1, !tbaa !1263
...
.thread.i.i:                                      ; preds = %bb.b
  ...
  %i.q = icmp sgt i64 %.fca.0.extract8, 0
  %spec.select = select i1 %i.q, i64 9223372036854775807, i64 -9223372036854775808
...
bb.a:
  ...
  store ptr %i.b, ptr %4, align 8, !tbaa !377
  %i.c = getelementptr inbounds nuw i8, ptr %4, i64 8 ; 2 uses
  %i.d = getelementptr inbounds nuw i8, ptr %4, i64 16
  store i64 40, ptr %i.d, align 8, !tbaa !378
...
_ZN4llvm23SmallVectorTemplateBaseIbLb1EE13growAndAssignEmb.exit.i.i: ; preds = %bb.a
  store i64 0, ptr %i.c, align 8, !tbaa !379
  ...
  %i.f = load ptr, ptr %4, align 8, !tbaa !377
...
_ZN4llvm15SmallVectorImplIbE6assignEmb.exit.sink.split.i: ; preds = %_ZSt6fill_nIPbmbET_S1_T0_RKT1_.exit.i.i, %_ZN4llvm23SmallVectorTemplateBaseIbLb1EE13growAndAssignEmb.exit.i.i
  ...
  call void @llvm.memset.p0.i64(ptr align 1 %.sink.i, i8 1, i64 %i.a, i1 false), !tbaa !380
...
_ZN4llvm11SmallVectorIbLj40EEC2EmRKb.exit:        ; preds = %_ZSt6fill_nIPbmbET_S1_T0_RKT1_.exit.i.i, %_ZN4llvm15SmallVectorImplIbE6assignEmb.exit.sink.split.i
  ...
  store i64 %i.a, ptr %i.c, align 8, !tbaa !379
...
.lr.ph52:                                         ; preds = %.preheader45, %bb.d
  ...
  %i.v = load i8, ptr %i.u, align 1, !tbaa !380, !range !50, !noundef !51
...
bb.c:                                             ; preds = %bb.b
  ...
  store i32 %i.y, ptr %3, align 4, !tbaa !222
  br label %bb.d
...
bb.d:                                             ; preds = %.lr.ph52, %bb.c
  ...
  br i1 %exitcond.not, label %.critedge, label %.lr.ph52, !llvm.loop !1265
...
.critedge41.lr.ph:                                ; preds = %.preheader
  %i.ab = load i32, ptr %3, align 4, !tbaa !222
  br label %.critedge41
...
.critedge41:                                      ; preds = %.critedge41, %.critedge41.lr.ph
  ...
  %i.ag = load i32, ptr %i.af, align 4, !tbaa !222 ; 2 uses
  ...
  br i1 %or.cond68, label %.critedge41, label %.loopexit, !llvm.loop !1266
