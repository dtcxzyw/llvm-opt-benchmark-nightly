...
bb.e:                                             ; preds = %bb.d
  ...
  %i.au = icmp slt i32 %i.z, 0                    ; 3 uses
  %i.av = select i1 %i.au, i32 31, i32 30
  %i.aw = add nuw i32 %i.av, %i.ah                ; 2 uses
  %6 = lshr i32 %i.aw, 5
  %i.ax = udiv i32 %i.aw, 31
  %7 = select i1 %i.au, i32 %6, i32 %i.ax
  %i.ay = add nsw i32 %7, -1
