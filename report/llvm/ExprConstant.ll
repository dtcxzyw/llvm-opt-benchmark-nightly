...
bb.k:                                             ; preds = %bb.j
  ...
  %.not.i.i.i.i = icmp eq i16 %i.ak, 118          ; 2 uses
  ...
  %spec.select.i.i.i.i = select i1 %.not.i.i.i.i, ptr %3, ptr %i.al
  %i.am = load ptr, ptr %spec.select.i.i.i.i, align 8, !tbaa !821 ; 2 uses
...
.thread47:                                        ; preds = %..thread47_crit_edge, %bb.k, %bb.p
  ...
  %.not.i.i.i = icmp eq i16 %i.bb, 118            ; 2 uses
  ...
  %spec.select.i.i.i = select i1 %.not.i.i.i, ptr %4, ptr %i.bc
...
_ZN12_GLOBAL__N_19ScopeRAIIILNS_9ScopeKindE2EEC2ERNS_8EvalInfoE.exit: ; preds = %bb.r, %bb.s
  ...
  %i.cj = call fastcc noundef zeroext i1 @_ZL12EvaluateArgsN4llvm8ArrayRefIPKN5clang4ExprEEEN12_GLOBAL__N_17CallRefERNS6_8EvalInfoEPKNS1_12FunctionDeclEbPNS6_6LValueE(ptr nonnull %spec.select.i.i.i, i64 %i.bf, i64 %.sroa.2.8.insert.insert.i, ptr noundef nonnull align 8 dereferenceable(984) %i.bj, ptr noundef %i.bi, i1 noundef zeroext false, ptr noundef null)
