...
bb.a:
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 1448) (i8, ptr @_ZTVN4llvm3pdb22NativeInlineSiteSymbolE, i64 16), ptr %0, align 8, !tbaa !18
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.b = load i16, ptr %3, align 8, !tbaa !140
  store i16 %i.b, ptr %i.a, align 8, !tbaa !140
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.m, label %bb.c, label %_ZNSt15__new_allocatorIhE8allocateEmPKv.exit.i.i.i.i.i, !prof !25
...
_ZNSt12_Vector_baseIhSaIhEEC2EmRKS0_.exit.i.i:    ; preds = %_ZNSt15__new_allocatorIhE8allocateEmPKv.exit.i.i.i.i.i, %bb.a
  ...
  %i.s = load ptr, ptr %i.f, align 8, !tbaa !27   ; 3 uses
  %i.t = load ptr, ptr %i.g, align 8, !tbaa !27
  %i.u = ptrtoint ptr %i.t to i64
  %i.v = ptrtoint ptr %i.s to i64
  %i.w = sub i64 %i.u, %i.v                       ; 4 uses
  %i.x = icmp sgt i64 %i.w, 1
  br i1 %i.x, label %bb.d, label %bb.e, !prof !141
