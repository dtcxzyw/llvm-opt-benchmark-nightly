...
_ZSt7reverseIPcEvT_S1_.exit:                      ; preds = %bb.a
  ...
  %2 = load <8 x i8>, ptr %i.f, align 1, !tbaa !58 ; 2 uses
  ...
  %.sroa.0.5.insert.ext50 = zext i8 %18 to i64
  %.sroa.0.5.insert.shift51 = shl nuw nsw i64 %.sroa.0.5.insert.ext50, 40
  %19 = or disjoint i64 %17, %.sroa.0.5.insert.shift51
  %.ptr.6.a = getelementptr inbounds nuw i8, ptr %i.f, i64 13
  ...
  %.018.ptr.6.a = getelementptr inbounds nuw i8, ptr %i.f, i64 12
  ...
  %20 = load i8, ptr %.ptr.7, align 1, !tbaa !58  ; 2 uses
  %21 = sext i8 %20 to i32
  %isdigittmp20.7 = add nsw i32 %21, -48
  ...
  %23 = load i8, ptr %.018.ptr.7, align 1, !tbaa !58 ; 2 uses
  %24 = sext i8 %23 to i32
  %isdigittmp.7 = add nsw i32 %24, -48
  %isdigit.7 = icmp ult i32 %isdigittmp.7, 10
  %.v.7 = select i1 %isdigit.7, i8 0, i8 9
  %25 = add i8 %.v.7, %23
  %26 = shl i8 %25, 4
  %27 = add i8 %22, %26
  %.sroa.0.7.insert.ext = zext i8 %27 to i64
  %28 = shl nuw nsw i64 %.sroa.0.6.insert.ext, 8
  %29 = extractelement <4 x i8> %16, i64 1
  %.sroa.0.6.insert.ext55 = zext i8 %29 to i64
  %.sroa.0.6.insert.shift56 = shl nuw nsw i64 %.sroa.0.6.insert.ext55, 48
  %30 = or disjoint i64 %28, %.sroa.0.6.insert.shift56
  %31 = extractelement <4 x i8> %16, i64 0
  %.sroa.0.7.insert.ext60 = zext i8 %31 to i64
  %.sroa.0.7.insert.shift61 = shl nuw i64 %.sroa.0.7.insert.ext60, 56
  %32 = or disjoint i64 %.sroa.0.7.insert.shift61, %.sroa.0.7.insert.ext
  %.sroa.0.6.insert.insert58 = or disjoint i64 %30, %32
  %.sroa.0.5.insert.insert53 = or disjoint i64 %19, %.sroa.0.6.insert.insert58
  %.sroa.0.3.insert.insert43 = or disjoint i64 %.sroa.0.5.insert.insert53, %.sroa.0.4.insert.shift
  %33 = extractelement <4 x i8> %16, i64 3
  %.sroa.0.4.insert.ext45 = zext i8 %33 to i64
  %.sroa.0.4.insert.shift46 = shl nuw nsw i64 %.sroa.0.4.insert.ext45, 32
  %.sroa.0.4.insert.insert48 = or disjoint i64 %.sroa.0.3.insert.insert43, %.sroa.0.4.insert.shift46
