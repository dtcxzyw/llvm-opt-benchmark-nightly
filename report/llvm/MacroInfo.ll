...
bb.f:                                             ; preds = %bb.e, %bb.b
  ...
  %.sroa.6.8.insert.shift = select i1 %i.h, i64 %i.k, i64 4294967296
...
_ZNK5clang14MacroDirective7DefInfo11getLocationEv.exit.preheader: ; preds = %bb.b
  ...
  %.sroa.6.8.insert.shift.i.i32119 = select i1 %i.d, i64 %4, i64 4294967296
  %.sroa.3.8.insert.ext.i.i33120 = zext i32 %.sroa.024.041.i.i to i64
  %.sroa.3.8.insert.insert.i.i34121 = or disjoint i64 %.sroa.6.8.insert.shift.i.i32119, %.sroa.3.8.insert.ext.i.i33120 ; 2 uses
...
_ZNK5clang14MacroDirective7DefInfo11getLocationEv.exit.loopexit: ; preds = %.preheader.i
  ...
  %.sroa.6.8.insert.shift.i.i32 = select i1 %i.l, i64 %6, i64 4294967296
  %.sroa.3.8.insert.ext.i.i33 = zext i32 %.sroa.024.041.i.i23 to i64
  %.sroa.3.8.insert.insert.i.i34 = or disjoint i64 %.sroa.6.8.insert.shift.i.i32, %.sroa.3.8.insert.ext.i.i33 ; 2 uses
