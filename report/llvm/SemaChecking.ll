...
.lr.ph:                                           ; preds = %bb.c, %.lr.ph
  ...
  %.sroa.045.sroa.7.075 = phi i8 [ %.sroa.045.sroa.7.0.extract.trunc65, %.lr.ph ], [ %.sroa.045.sroa.7.0.extract.trunc61, %bb.c ] ; 2 uses
  ...
  %i.l = trunc nuw i8 %.sroa.045.sroa.7.075 to i1 ; 2 uses
  ...
  %.sroa.045.sroa.7.0.extract.trunc65 = select i1 %i.l, i8 %.sroa.2.0.extract.trunc.i, i8 0 ; 2 uses
...
bb.d:                                             ; preds = %bb.a
  ...
  %.sroa.29.0.extract.shift.i34 = lshr i64 %i.x, 32 ; 2 uses
  ...
  %.sroa.2.0.extract.shift.i37 = lshr i64 %i.z, 32
  %.sroa.2.0.extract.trunc.i38 = trunc nuw nsw i64 %.sroa.2.0.extract.shift.i37 to i8 ; 2 uses
  %i.aa = trunc nuw i64 %.sroa.29.0.extract.shift.i34 to i1 ; 2 uses
  %i.ab = xor i32 %.sroa.29.0.extract.trunc.i35, 1
  %i.ac = sub i32 %.sroa.08.0.extract.trunc.i33, %i.ab
  %3 = xor i8 %.sroa.2.0.extract.trunc.i38, 1
  %4 = zext nneg i8 %3 to i32                     ; 2 uses
  %i.ad = sub i32 %.sroa.0.0.extract.trunc.i36, %4
  %.sroa.speculated.i39 = tail call i32 @llvm.umax.i32(i32 %i.ac, i32 %i.ad)
  %i.ae = select i1 %i.aa, i32 %4, i32 1
  %i.af = add i32 %.sroa.speculated.i39, %i.ae
  %.sroa.045.sroa.7.0.extract.trunc63 = select i1 %i.aa, i8 %.sroa.2.0.extract.trunc.i38, i8 0
  br label %.loopexit
...
.loopexit:                                        ; preds = %.lr.ph, %bb.c, %bb.e, %bb.d, %bb.b
  ...
  %.sroa.045.sroa.7.1 = phi i8 [ %.sroa.045.sroa.7.0.extract.trunc, %bb.b ], [ %i.ak, %bb.e ], [ %.sroa.045.sroa.7.0.extract.trunc63, %bb.d ], [ %.sroa.045.sroa.7.0.extract.trunc61, %bb.c ], [ %.sroa.045.sroa.7.0.extract.trunc65, %.lr.ph ]
...
bb.a:
  ...
  %i.a = trunc i64 %.sroa.29.0.extract.shift to i1 ; 2 uses
  ...
  %i.m = and i64 %1, 4294967296
  %.sroa.215.0.insert.shift = select i1 %i.a, i64 %i.m, i64 0
