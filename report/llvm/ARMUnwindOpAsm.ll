...
begin_hunk_0_@_ZN4llvm21UnwindOpcodeAssembler11EmitRegSaveEj:bb.a
  ...
  %i.bw = getelementptr inbounds nuw i8, ptr %0, i64 68
  %i.bx = load i32, ptr %i.bw, align 4, !tbaa !19
  %.not.i1.i30 = icmp ult i32 %i.bq, %i.bx
  br i1 %.not.i1.i30, label %bb.r, label %bb.q, !prof !13

bb.q:                                             ; preds = %_ZN4llvm23SmallVectorTemplateBaseIhLb1EE9push_backEh.exit.i29
  tail call void @_ZN4llvm23SmallVectorTemplateBaseIjLb1EE15growAndPushBackEj(ptr noundef nonnull align 8 dereferenceable(16) %i.bn, i32 noundef %i.bv)
  br label %_ZN4llvm21UnwindOpcodeAssembler8EmitInt8Ej.exit31

bb.r:                                             ; preds = %_ZN4llvm23SmallVectorTemplateBaseIhLb1EE9push_backEh.exit.i29
  store i32 %i.bv, ptr %i.bs, align 4
  %i.by = load i32, ptr %i.bp, align 8, !tbaa !17
  %i.bz = add i32 %i.by, 1
  store i32 %i.bz, ptr %i.bp, align 8, !tbaa !17
  br label %_ZN4llvm21UnwindOpcodeAssembler8EmitInt8Ej.exit31

_ZN4llvm21UnwindOpcodeAssembler8EmitInt8Ej.exit31: ; preds = %bb.q, %bb.r
  %i.ca = and i32 %1, 15
  br label %bb.s

bb.s:                                             ; preds = %_ZN4llvm21UnwindOpcodeAssembler8EmitInt8Ej.exit27, %_ZN4llvm21UnwindOpcodeAssembler8EmitInt8Ej.exit31, %bb.h, %bb.g
  %.1 = phi i32 [ %1, %bb.g ], [ %i.bc, %_ZN4llvm21UnwindOpcodeAssembler8EmitInt8Ej.exit27 ], [ %i.ca, %_ZN4llvm21UnwindOpcodeAssembler8EmitInt8Ej.exit31 ], [ %1, %bb.h ] ; 4 uses
  %i.cb = and i32 %.1, 65520
  %.not22 = icmp eq i32 %i.cb, 0
  br i1 %.not22, label %_ZN4llvm21UnwindOpcodeAssembler9EmitInt16Ej.exit, label %bb.t

bb.t:                                             ; preds = %bb.s
  %i.cc = lshr i32 %.1, 4
  %i.cd = lshr i32 %.1, 12
  %i.ce = trunc i32 %i.cd to i8
  %i.cf = or i8 %i.ce, -128                       ; 2 uses
  %i.cg = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 6 uses
  ...
  %.not.i.i32 = icmp ult i64 %i.ch, %i.cj
  br i1 %.not.i.i32, label %bb.v, label %bb.u, !prof !13

bb.u:                                             ; preds = %bb.t
  tail call void @_ZN4llvm23SmallVectorTemplateBaseIhLb1EE15growAndPushBackEh(ptr noundef nonnull align 8 dereferenceable(105) %0, i8 noundef zeroext %i.cf)
  %.pre.i = load i64, ptr %i.cg, align 8, !tbaa !11
  br label %_ZN4llvm23SmallVectorTemplateBaseIhLb1EE9push_backEh.exit.i33

bb.v:                                             ; preds = %bb.t
  %i.ck = load ptr, ptr %0, align 8, !tbaa !14
  %i.cl = getelementptr inbounds nuw i8, ptr %i.ck, i64 %i.ch
  store i8 %i.cf, ptr %i.cl, align 1
  %i.cm = load i64, ptr %i.cg, align 8, !tbaa !11
  %i.cn = add i64 %i.cm, 1                        ; 2 uses
  store i64 %i.cn, ptr %i.cg, align 8, !tbaa !11
  br label %_ZN4llvm23SmallVectorTemplateBaseIhLb1EE9push_backEh.exit.i33

_ZN4llvm23SmallVectorTemplateBaseIhLb1EE9push_backEh.exit.i33: ; preds = %bb.v, %bb.u
  %i.co = phi i64 [ %.pre.i, %bb.u ], [ %i.cn, %bb.v ] ; 2 uses
  %i.cp = trunc i32 %i.cc to i8                   ; 2 uses
  %i.cq = load i64, ptr %i.ci, align 8, !tbaa !12
  %.not.i2.i = icmp ult i64 %i.co, %i.cq
  br i1 %.not.i2.i, label %bb.x, label %bb.w, !prof !13

bb.w:                                             ; preds = %_ZN4llvm23SmallVectorTemplateBaseIhLb1EE9push_backEh.exit.i33
  tail call void @_ZN4llvm23SmallVectorTemplateBaseIhLb1EE15growAndPushBackEh(ptr noundef nonnull align 8 dereferenceable(105) %0, i8 noundef zeroext %i.cp)
  br label %_ZN4llvm23SmallVectorTemplateBaseIhLb1EE9push_backEh.exit3.i

bb.x:                                             ; preds = %_ZN4llvm23SmallVectorTemplateBaseIhLb1EE9push_backEh.exit.i33
  %i.cr = load ptr, ptr %0, align 8, !tbaa !14
  %i.cs = getelementptr inbounds nuw i8, ptr %i.cr, i64 %i.co
  store i8 %i.cp, ptr %i.cs, align 1
  %i.ct = load i64, ptr %i.cg, align 8, !tbaa !11
  %i.cu = add i64 %i.ct, 1
  store i64 %i.cu, ptr %i.cg, align 8, !tbaa !11
  br label %_ZN4llvm23SmallVectorTemplateBaseIhLb1EE9push_backEh.exit3.i

_ZN4llvm23SmallVectorTemplateBaseIhLb1EE9push_backEh.exit3.i: ; preds = %bb.x, %bb.w
  %i.cv = getelementptr inbounds nuw i8, ptr %0, i64 56 ; 2 uses
  %i.cw = load ptr, ptr %i.cv, align 8, !tbaa !16
  %i.cx = getelementptr inbounds nuw i8, ptr %0, i64 64 ; 3 uses
  %i.cy = load i32, ptr %i.cx, align 8, !tbaa !17 ; 2 uses
  %i.cz = zext i32 %i.cy to i64
  %i.da = getelementptr inbounds nuw [4 x i8], ptr %i.cw, i64 %i.cz ; 2 uses
  %i.db = getelementptr inbounds i8, ptr %i.da, i64 -4
  %i.dc = load i32, ptr %i.db, align 4, !tbaa !18
  %i.dd = add i32 %i.dc, 2                        ; 2 uses
  %i.de = getelementptr inbounds nuw i8, ptr %0, i64 68
  %i.df = load i32, ptr %i.de, align 4, !tbaa !19
  %.not.i4.i = icmp ult i32 %i.cy, %i.df
  br i1 %.not.i4.i, label %bb.z, label %bb.y, !prof !13

bb.y:                                             ; preds = %_ZN4llvm23SmallVectorTemplateBaseIhLb1EE9push_backEh.exit3.i
  tail call void @_ZN4llvm23SmallVectorTemplateBaseIjLb1EE15growAndPushBackEj(ptr noundef nonnull align 8 dereferenceable(16) %i.cv, i32 noundef %i.dd)
