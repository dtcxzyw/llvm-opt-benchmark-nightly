...
bb.fz:                                            ; preds = %bb.fy
  ...
  %.fca.0.extract31.i = extractvalue { i64, i16 } %i.apz, 0 ; 5 uses
  ...
  %31 = bitcast i64 %.fca.0.extract31.i to <8 x i8>
  %32 = shufflevector <8 x i8> %31, <8 x i8> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %i.aqj = or <4 x i8> %i.aqi, %32
