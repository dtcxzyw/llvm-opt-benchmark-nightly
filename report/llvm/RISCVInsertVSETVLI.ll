...
bb.f:                                             ; preds = %bb.d, %bb.b, %bb.a
  ...
  %i.q = load ptr, ptr %i.p, align 8, !tbaa !513
  %i.r = getelementptr inbounds nuw i8, ptr %i.q, i64 24
  %i.s = load i64, ptr %i.r, align 8, !tbaa !514
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.w = tail call { i64, i16 } @_ZN4llvm5RISCV11getDemandedERKNS_12MachineInstrEPKNS_14RISCVSubtargetE(ptr noundef nonnull align 8 dereferenceable(80) %2, ptr noundef %i.v) #18 ; 2 uses
  %.fca.0.extract = extractvalue { i64, i16 } %i.w, 0
  %.fca.1.extract = extractvalue { i64, i16 } %i.w, 1
  ...
  call void @_ZNK4llvm5RISCV24RISCVVSETVLIInfoAnalysis19computeInfoForInstrERKNS_12MachineInstrE(ptr dead_on_unwind nonnull writable sret(%"class.llvm::RISCV::VSETVLIInfo") align 8 %4, ptr noundef nonnull align 8 dereferenceable(16) %i.x, ptr noundef nonnull align 8 dereferenceable(80) %2) #18
  %i.y = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 5 uses
  %i.z = load i8, ptr %i.y, align 8, !tbaa !361   ; 4 uses
  %.not69 = icmp eq i8 %i.z, 0
  br i1 %.not69, label %_ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit.thread.thread, label %bb.h

_ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit.thread.thread: ; preds = %bb.g
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #18
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %5, ptr noundef nonnull align 8 dereferenceable(24) %1, i64 24, i1 false), !tbaa.struct !416
  br label %bb.j
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ab = and i8 %i.z, -5
  %spec.select.i.not.i = icmp eq i8 %i.ab, 0
  br i1 %spec.select.i.not.i, label %_ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit.thread, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.ac = getelementptr inbounds nuw i8, ptr %1, i64 19
  %i.ad = load i8, ptr %i.ac, align 1
  %i.ae = and i8 %i.ad, 4
  %.not.i = icmp eq i8 %i.ae, 0
  br i1 %.not.i, label %_ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit, label %_ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit.thread

_ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit: ; preds = %bb.i
  %i.af = call noundef zeroext i1 @_ZNK4llvm5RISCV11VSETVLIInfo12isCompatibleERKNS0_14DemandedFieldsERKS1_PKNS_13LiveIntervalsE(ptr noundef nonnull align 8 dereferenceable(20) %1, ptr noundef nonnull align 1 dereferenceable(10) %3, ptr noundef nonnull align 8 dereferenceable(20) %4, ptr noundef %.val)
  br i1 %i.af, label %bb.ad, label %_ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit._ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit.thread_crit_edge

_ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit._ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit.thread_crit_edge: ; preds = %_ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit
  %.pre = load i8, ptr %i.y, align 8, !tbaa !361
  br label %_ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit.thread

_ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit.thread: ; preds = %_ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit._ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit.thread_crit_edge, %bb.i, %bb.h
  %i.ag = phi i8 [ %.pre, %_ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit._ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit.thread_crit_edge ], [ %i.z, %bb.i ], [ %i.z, %bb.h ]
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #18
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %5, ptr noundef nonnull align 8 dereferenceable(24) %1, i64 24, i1 false), !tbaa.struct !416
  %i.ah = and i8 %i.ag, -5
  %spec.select.i32.not = icmp eq i8 %i.ah, 0
  br i1 %spec.select.i32.not, label %bb.j, label %bb.k

bb.j:                                             ; preds = %_ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit.thread.thread, %_ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit.thread
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(20) %1, ptr noundef nonnull align 8 dereferenceable(20) %4, i64 20, i1 false), !tbaa.struct !416
  br label %bb.k

bb.k:                                             ; preds = %bb.j, %_ZNK12_GLOBAL__N_118RISCVInsertVSETVLI11needVSETVLIERKN4llvm5RISCV14DemandedFieldsERKNS2_11VSETVLIInfoES8_.exit.thread
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #18
  call void @llvm.experimental.noalias.scope.decl(metadata !722)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %6, ptr noundef nonnull readonly align 8 dereferenceable(24) %4, i64 24, i1 false), !tbaa.struct !416
  %i.ai = getelementptr inbounds nuw i8, ptr %3, i64 3 ; 3 uses
  %i.aj = load i8, ptr %i.ai, align 1, !tbaa !556, !noalias !722
  %.not.i33 = icmp ne i8 %i.aj, 0
  %i.ak = getelementptr inbounds nuw i8, ptr %3, i64 4 ; 2 uses
  %i.al = load i8, ptr %i.ak, align 4, !range !18, !noalias !722
  %i.am = trunc nuw i8 %i.al to i1
  %or.cond.i = select i1 %.not.i33, i1 true, i1 %i.am
  br i1 %or.cond.i, label %_ZL14adjustIncomingRKN4llvm5RISCV11VSETVLIInfoES3_RNS0_14DemandedFieldsE.exit, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.an = getelementptr inbounds nuw i8, ptr %5, i64 16
  %i.ao = load i8, ptr %i.an, align 8, !tbaa !361, !noalias !722
  %i.ap = and i8 %i.ao, -5
  %spec.select.i.not.i34 = icmp eq i8 %i.ap, 0
  br i1 %spec.select.i.not.i34, label %_ZL14adjustIncomingRKN4llvm5RISCV11VSETVLIInfoES3_RNS0_14DemandedFieldsE.exit, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.aq = getelementptr inbounds nuw i8, ptr %5, i64 18
  %i.ar = load i8, ptr %i.aq, align 2, !tbaa !364, !noalias !722
  %i.as = zext i8 %i.ar to i32
  %i.at = getelementptr inbounds nuw i8, ptr %5, i64 17
  %i.au = load i8, ptr %i.at, align 1, !tbaa !363, !noalias !722
  %i.av = call noundef i32 @_ZN4llvm10RISCVVType15getSEWLMULRatioEjNS0_5VLMULE(i32 noundef %i.as, i8 noundef zeroext %i.au) #18, !noalias !722
...
bb.ab:                                            ; preds = %bb.x
  ...
  %i.ei = select i1 %i.dt, i8 2, i8 0
  %i.ej = select i1 %i.eb, i8 8, i8 0
