...
bb.c:                                             ; preds = %bb.a
  ...
  br i1 %.not82, label %_ZNSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE7reserveEm.exit, label %_ZNSt12_Vector_baseISt4pairIN4llvm9StringRefEmESaIS3_EE13_M_deallocateEPS3_m.exit.i
...
_ZNSt12_Vector_baseISt4pairIN4llvm9StringRefEmESaIS3_EE13_M_deallocateEPS3_m.exit.i: ; preds = %bb.c
  ...
  %.pre127 = load ptr, ptr %i.a, align 8, !tbaa !13
...
_ZNSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE7reserveEm.exit: ; preds = %bb.c, %_ZNSt12_Vector_baseISt4pairIN4llvm9StringRefEmESaIS3_EE13_M_deallocateEPS3_m.exit.i
  %i.l = phi ptr [ %.pre127, %_ZNSt12_Vector_baseISt4pairIN4llvm9StringRefEmESaIS3_EE13_M_deallocateEPS3_m.exit.i ], [ %i.b, %bb.c ] ; 2 uses
  ...
  %.not83103 = icmp eq ptr %i.m, %i.l
  br i1 %.not83103, label %.critedge18, label %.lr.ph
...
bb.d:                                             ; preds = %.lr.ph, %_ZNSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE12emplace_backIJRS2_RmEEERS3_DpOT_.exit
  %.sroa.055.0108 = phi ptr [ %.sroa.16.1, %.lr.ph ], [ %.sroa.055.2, %_ZNSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE12emplace_backIJRS2_RmEEERS3_DpOT_.exit ] ; 7 uses
  %.sroa.16.0107 = phi ptr [ %.sroa.16.1, %.lr.ph ], [ %.sroa.16.2, %_ZNSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE12emplace_backIJRS2_RmEEERS3_DpOT_.exit ] ; 8 uses
  %.sroa.30.0106 = phi ptr [ %.sroa.30.1, %.lr.ph ], [ %.sroa.30.2, %_ZNSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE12emplace_backIJRS2_RmEEERS3_DpOT_.exit ] ; 3 uses
  %.078105 = phi i64 [ 0, %.lr.ph ], [ %i.bg, %_ZNSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE12emplace_backIJRS2_RmEEERS3_DpOT_.exit ] ; 3 uses
  %.sroa.050.0104 = phi ptr [ %i.m, %.lr.ph ], [ %i.bh, %_ZNSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE12emplace_backIJRS2_RmEEERS3_DpOT_.exit ] ; 3 uses
  %i.p = load ptr, ptr %.sroa.050.0104, align 8, !tbaa !14
  %i.q = getelementptr inbounds nuw i8, ptr %.sroa.050.0104, i64 8
...
_ZNK4llvm9StringRef5splitES0_.exit.i:             ; preds = %bb.f, %bb.e
  ...
  %i.ae = sub nuw i64 %i.ab, %.sroa.speculated4.i.i.i.i ; 2 uses
...
._crit_edge.i:                                    ; preds = %bb.i, %bb.g
  ...
  %.not.i20 = icmp eq ptr %.sroa.16.0107, %.sroa.30.0106
  br i1 %.not.i20, label %bb.k, label %bb.j

bb.j:                                             ; preds = %._crit_edge.i
  store ptr %i.ad, ptr %.sroa.16.0107, align 8, !tbaa !28
  %.sroa.6.0..sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.16.0107, i64 8
  store i64 %.sink.i, ptr %.sroa.6.0..sroa_idx, align 8, !tbaa !29
  %i.ap = getelementptr inbounds nuw i8, ptr %.sroa.16.0107, i64 16
  store i64 %.078105, ptr %i.ap, align 8, !tbaa !36
  br label %_ZNSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE12emplace_backIJRS2_RmEEERS3_DpOT_.exit

bb.k:                                             ; preds = %._crit_edge.i
  %i.aq = ptrtoint ptr %.sroa.16.0107 to i64
  %i.ar = ptrtoint ptr %.sroa.055.0108 to i64
...
_ZNKSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.k
  ...
  store i64 %.078105, ptr %i.bc, align 8, !tbaa !36
  %.not10.i.i.i.i.i = icmp eq ptr %.sroa.055.0108, %.sroa.16.0107
...
.lr.ph.i.i.i.i.i:                                 ; preds = %_ZNKSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE12_M_check_lenEmPKc.exit.i.i, %.lr.ph.i.i.i.i.i
  ...
  %.0911.i.i.i.i.i = phi ptr [ %i.bd, %.lr.ph.i.i.i.i.i ], [ %.sroa.055.0108, %_ZNKSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE12_M_check_lenEmPKc.exit.i.i ] ; 2 uses
  ...
  %.not.i.i.i.i.i = icmp eq ptr %i.bd, %.sroa.16.0107
...
_ZNSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit23.i.i: ; preds = %.lr.ph.i.i.i.i.i, %_ZNKSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE12_M_check_lenEmPKc.exit.i.i
  ...
  %.not.i24.i.i = icmp eq ptr %.sroa.055.0108, null
...
bb.m:                                             ; preds = %_ZNSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit23.i.i
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.055.0108, i64 noundef %i.as) #24
...
_ZNSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE12emplace_backIJRS2_RmEEERS3_DpOT_.exit: ; preds = %bb.j, %_ZNSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE17_M_realloc_insertIJRS2_RmEEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i
  %.sroa.30.2 = phi ptr [ %i.bf, %_ZNSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE17_M_realloc_insertIJRS2_RmEEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i ], [ %.sroa.30.0106, %bb.j ] ; 2 uses
  %.0.lcssa.i.i.i.i.i.pn = phi ptr [ %.0.lcssa.i.i.i.i.i, %_ZNSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE17_M_realloc_insertIJRS2_RmEEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i ], [ %.sroa.16.0107, %bb.j ]
  %.sroa.055.2 = phi ptr [ %i.ba, %_ZNSt6vectorISt4pairIN4llvm9StringRefEmESaIS3_EE17_M_realloc_insertIJRS2_RmEEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i ], [ %.sroa.055.0108, %bb.j ] ; 2 uses
  %.sroa.16.2 = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i.i.pn, i64 24 ; 2 uses
  %i.bg = add i64 %.078105, 1
  %i.bh = getelementptr inbounds nuw i8, ptr %.sroa.050.0104, i64 40 ; 2 uses
  %.not83 = icmp eq ptr %i.bh, %i.l
  br i1 %.not83, label %.critedge18, label %bb.d
