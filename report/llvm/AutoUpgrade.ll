...
begin_hunk_0_@_ZL25upgradeX86ALIGNIntrinsicsRN4llvm9IRBuilderINS_14ConstantFolderENS_24IRBuilderDefaultInserterEEEPNS_5ValueES6_S6_S6_S6_b:bb.a
  ...
  br i1 %i.bm, label %.preheader.us, label %._crit_edge, !llvm.loop !635
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader.new
  ...
  br i1 %niter.ncmp.1.not, label %._crit_edge.loopexit95.unr-lcssa, label %.preheader, !llvm.loop !635
...
._crit_edge:                                      ; preds = %.preheader.epil.preheader, %._crit_edge.loopexit95.unr-lcssa, %.preheader.us, %bb.e
  ...
  store i8 1, ptr %i.df, align 1, !tbaa !109
  store ptr @.str.1109, ptr %10, align 8, !tbaa !50
  store i8 3, ptr %i.de, align 8, !tbaa !108
  call void @llvm.lifetime.start.p0(ptr nonnull %9)
  %i.dg = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.dh = load ptr, ptr %i.dg, align 8, !tbaa !163, !nonnull !26, !align !99 ; 2 uses
  %i.di = load ptr, ptr %i.dh, align 8, !tbaa !19
  %i.dj = getelementptr inbounds nuw i8, ptr %i.di, i64 112
  %i.dk = load ptr, ptr %i.dj, align 8
  %i.dl = call noundef ptr %i.dk(ptr noundef nonnull align 8 dereferenceable(8) %i.dh, ptr noundef %.040, ptr noundef %.039, ptr nonnull %i.a, i64 %.pre-phi) #23, !inline_history !290 ; 2 uses
...
bb.f:                                             ; preds = %._crit_edge
  ...
  %i.dp = load ptr, ptr %i.do, align 8, !tbaa !164, !nonnull !26, !align !99 ; 2 uses
  ...
  call void %i.dt(ptr noundef nonnull align 8 dereferenceable(8) %i.dp, ptr noundef nonnull %i.dm, ptr noundef nonnull align 8 dereferenceable(34) %10, ptr %.sroa.0.0.copyload.i.i, i64 %.sroa.2.0.copyload.i.i) #23, !inline_history !4
...
bb.h:                                             ; preds = %bb.g, %_ZN4llvm13IRBuilderBase19CreateShuffleVectorEPNS_5ValueES2_NS_8ArrayRefIiEERKNS_5TwineE.exit
  ...
  %i.ea = load i32, ptr %i.dz, align 8, !tbaa !260
...
bb.a:
  ...
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !146, !nonnull !26, !align !99
  ...
  store i8 1, ptr %i.l, align 1, !tbaa !109
  store ptr @.str.35, ptr %5, align 8, !tbaa !50
  store i8 3, ptr %i.k, align 8, !tbaa !108
...
.preheader.lr.ph:                                 ; preds = %bb.b
  ...
  %i.p = shufflevector <4 x i32> %9, <4 x i32> poison, <4 x i32> zeroinitializer ; 4 uses
  %i.q = add <4 x i32> %i.p, <i32 0, i32 1, i32 2, i32 3> ; 2 uses
  %i.r = insertelement <4 x i32> poison, i32 %i.f, i64 0
  %i.s = shufflevector <4 x i32> %i.r, <4 x i32> poison, <4 x i32> zeroinitializer ; 4 uses
  %i.t = icmp ult <4 x i32> %i.q, %i.s
  %10 = insertelement <4 x i32> poison, i32 %.neg, i64 0
  %11 = shufflevector <4 x i32> %10, <4 x i32> poison, <4 x i32> zeroinitializer ; 4 uses
  %i.u = select <4 x i1> %i.t, <4 x i32> %11, <4 x i32> zeroinitializer
  %i.v = add <4 x i32> %i.q, %i.u                 ; 3 uses
  %i.w = add <4 x i32> %i.p, <i32 4, i32 5, i32 6, i32 7> ; 2 uses
  %i.x = icmp ult <4 x i32> %i.w, %i.s
  %i.y = select <4 x i1> %i.x, <4 x i32> %11, <4 x i32> zeroinitializer
  %i.z = add <4 x i32> %i.w, %i.y                 ; 3 uses
  %i.aa = add <4 x i32> %i.p, <i32 8, i32 9, i32 10, i32 11> ; 2 uses
  %i.ab = icmp ult <4 x i32> %i.aa, %i.s
  %i.ac = select <4 x i1> %i.ab, <4 x i32> %11, <4 x i32> zeroinitializer
  %i.ad = add <4 x i32> %i.aa, %i.ac              ; 3 uses
  %i.ae = add <4 x i32> %i.p, <i32 12, i32 13, i32 14, i32 15> ; 2 uses
  %i.af = icmp ult <4 x i32> %i.ae, %i.s
  %i.ag = select <4 x i1> %i.af, <4 x i32> %11, <4 x i32> zeroinitializer
...
.preheader:                                       ; preds = %.preheader, %.preheader.lr.ph.new
  ...
  br i1 %niter.ncmp.1, label %._crit_edge.loopexit.unr-lcssa, label %.preheader, !llvm.loop !636
...
._crit_edge:                                      ; preds = %.preheader.epil.preheader, %._crit_edge.loopexit.unr-lcssa, %bb.b
  ...
  %i.cg = load ptr, ptr %i.cf, align 8, !tbaa !163, !nonnull !26, !align !99 ; 2 uses
  %i.ch = load ptr, ptr %i.cg, align 8, !tbaa !19
  %i.ci = getelementptr inbounds nuw i8, ptr %i.ch, i64 112
  %i.cj = load ptr, ptr %i.ci, align 8
  %i.ck = call noundef ptr %i.cj(ptr noundef nonnull align 8 dereferenceable(8) %i.cg, ptr noundef %i.n, ptr noundef %i.m, ptr nonnull %i.a, i64 %i.cd) #23, !inline_history !290 ; 2 uses
...
bb.c:                                             ; preds = %._crit_edge
  ...
  %i.co = load ptr, ptr %i.cn, align 8, !tbaa !164, !nonnull !26, !align !99 ; 2 uses
  %i.cp = getelementptr inbounds nuw i8, ptr %0, i64 16
  %.sroa.0.0.copyload.i.i = load ptr, ptr %i.cp, align 8
  %.sroa.2.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %0, i64 24
  %.sroa.2.0.copyload.i.i = load i64, ptr %.sroa.2.0..sroa_idx.i.i, align 8
  %i.cq = load ptr, ptr %i.co, align 8, !tbaa !19
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cq, i64 16
  %i.cs = load ptr, ptr %i.cr, align 8
  call void %i.cs(ptr noundef nonnull align 8 dereferenceable(8) %i.co, ptr noundef nonnull %i.cl, ptr noundef nonnull align 8 dereferenceable(34) %6, ptr %.sroa.0.0.copyload.i.i, i64 %.sroa.2.0.copyload.i.i) #23, !inline_history !4
...
bb.d:                                             ; preds = %_ZN4llvm13IRBuilderBase19CreateShuffleVectorEPNS_5ValueES2_NS_8ArrayRefIiEERKNS_5TwineE.exit, %bb.a
  ...
  store i8 1, ptr %i.cu, align 1, !tbaa !109
  store ptr @.str.35, ptr %7, align 8, !tbaa !50
  store i8 3, ptr %i.ct, align 8, !tbaa !108
