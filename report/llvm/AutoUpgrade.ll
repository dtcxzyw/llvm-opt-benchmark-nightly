...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %.1 = phi i32 [ %i.q, %bb.d ], [ %.038, %bb.c ] ; 2 uses
...
.preheader.preheader:                             ; preds = %.preheader.lr.ph
  %i.s = add i32 %i.k, -16
  %i.t = insertelement <4 x i32> poison, i32 %.1, i64 0
  %i.u = shufflevector <4 x i32> %i.t, <4 x i32> poison, <4 x i32> zeroinitializer ; 8 uses
  %i.v = icmp samesign ult <4 x i32> %i.u, <i32 16, i32 15, i32 14, i32 13>
  ...
  %i.ad = icmp samesign ult <4 x i32> %i.u, <i32 12, i32 11, i32 10, i32 9>
  ...
  %i.ah = icmp samesign ult <4 x i32> %i.u, <i32 8, i32 7, i32 6, i32 5>
  ...
  %i.al = icmp ult <4 x i32> %i.u, <i32 4, i32 3, i32 2, i32 1>
  %i.am = select <4 x i1> %i.al, <4 x i32> zeroinitializer, <4 x i32> %i.y
