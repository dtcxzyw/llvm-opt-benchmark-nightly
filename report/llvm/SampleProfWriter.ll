...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = tail call noundef zeroext i1 %i.b(ptr noundef nonnull align 8 dereferenceable(32) %i.c, ptr noundef nonnull align 8 dereferenceable(32) %i.c, i32 noundef 3) #26, !inline_history !15 ; 0 uses
...
_ZNSt14_Function_baseD2Ev.exit:                   ; preds = %bb.a, %bb.b
  ...
  %i.f = load i8, ptr %i.e, align 8, !tbaa !16, !range !20, !noundef !21
...
bb.a:
  store ptr getelementptr inbounds nuw inrange(-16, 88) (i8, ptr @_ZTVN4llvm2cl3optImLb0ENS0_6parserImEEEE, i64 16), ptr %0, align 8, !tbaa !11
...
bb.a:
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN4llvm10sampleprof30DefaultFunctionPruningStrategyE, i64 16), ptr %0, align 8, !tbaa !11
...
_ZN4llvm10drop_beginIRSt6vectorISt4pairINS_9hash_codeEPKNS_10sampleprof15FunctionSamplesEESaIS8_EEEEDaOT_m.exit:
  ...
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !28, !nonnull !21, !align !29
  %i.h = getelementptr inbounds nuw i8, ptr %i.g, i64 24
  %i.i = load i64, ptr %i.h, align 8, !tbaa !30   ; 3 uses
  ...
  %i.t = load ptr, ptr %i.q, align 8, !tbaa !40   ; 3 uses
...
._crit_edge.loopexit:                             ; preds = %_ZN4llvm10sampleprof16SampleProfileMap5eraseERKNS_9hash_codeE.exit
  %.pre = load ptr, ptr %i.r, align 8, !tbaa !37  ; 2 uses
  %.pre31 = load ptr, ptr %i.q, align 8, !tbaa !40 ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  store ptr %i.ae, ptr %i.r, align 8, !tbaa !37
  br label %_ZNSt6vectorISt4pairIN4llvm9hash_codeEPKNS1_10sampleprof15FunctionSamplesEESaIS7_EE6resizeEm.exit
...
.lr.ph:                                           ; preds = %_ZN4llvm10drop_beginIRSt6vectorISt4pairINS_9hash_codeEPKNS_10sampleprof15FunctionSamplesEESaIS8_EEEEDaOT_m.exit, %_ZN4llvm10sampleprof16SampleProfileMap5eraseERKNS_9hash_codeE.exit
  ...
  %i.af = load ptr, ptr %i.f, align 8, !tbaa !28, !nonnull !21, !align !29 ; 6 uses
...
bb.e:                                             ; preds = %.lr.ph
  ...
  %i.aj = load ptr, ptr %i.ai, align 8, !tbaa !41 ; 4 uses
...
.preheader.i.i.i.i.i:                             ; preds = %bb.e
  %i.ak = load i64, ptr %.sroa.011.023, align 8, !tbaa !42 ; 2 uses
  %i.al = getelementptr inbounds nuw i8, ptr %i.aj, i64 8
  %i.am = load i64, ptr %i.al, align 8, !tbaa !42
...
bb.g:                                             ; preds = %.lr.ph
  %i.ay = load i64, ptr %.sroa.011.023, align 8, !tbaa !42 ; 5 uses
  %i.az = getelementptr inbounds nuw i8, ptr %i.af, i64 8
  %i.ba = load i64, ptr %i.az, align 8, !tbaa !46 ; 2 uses
  %i.bb = urem i64 %i.ay, %i.ba                   ; 4 uses
  %i.bc = load ptr, ptr %i.af, align 8, !tbaa !49
  %i.bd = getelementptr inbounds nuw [8 x i8], ptr %i.bc, i64 %i.bb
  %i.be = load ptr, ptr %i.bd, align 8, !tbaa !50 ; 3 uses
...
bb.j:                                             ; preds = %.lr.ph.i.i.i.i.i
  ...
  %i.bu = load i64, ptr %i.bt, align 8, !tbaa !47 ; 2 uses
  %i.bv = urem i64 %i.bu, %i.ba
  %.not19.i.i.i.i.i = icmp eq i64 %i.bv, %i.bb
  br i1 %.not19.i.i.i.i.i, label %bb.i, label %..loopexit_crit_edge21.i.i.i.i.i, !llvm.loop !51

..loopexit_crit_edge21.i.i.i.i.i:                 ; preds = %bb.j
  br label %_ZN4llvm10sampleprof16SampleProfileMap5eraseERKNS_9hash_codeE.exit, !llvm.loop !51
...
bb.d:                                             ; preds = %bb.f, %bb.c
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 112) (i8, ptr @_ZTVN4llvm19raw_svector_ostreamE, i64 16), ptr %i.n, align 8, !tbaa !11
  %i.s = getelementptr inbounds nuw i8, ptr %i.n, i64 48
  store ptr %4, ptr %i.s, align 8, !tbaa !65
  ...
  %i.t = load ptr, ptr %i.i, align 8, !tbaa !52   ; 3 uses
  store ptr %i.n, ptr %i.i, align 8, !tbaa !52
...
_ZNKSt14default_deleteIN4llvm11raw_ostreamEEclEPS1_.exit.i.i: ; preds = %bb.d
  ...
  call void %i.w(ptr noundef nonnull align 8 dereferenceable(48) %i.t) #26, !inline_history !67
...
bb.e:                                             ; preds = %_ZNSt10unique_ptrIN4llvm11raw_ostreamESt14default_deleteIS1_EE5resetEPS1_.exit
  %i.ac = load i64, ptr %i.l, align 8, !tbaa !57  ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.ag = load i64, ptr %i.h, align 8, !tbaa !30
  %.not13 = icmp eq i64 %i.ag, 0
  br i1 %.not13, label %.thread, label %bb.d, !llvm.loop !68

bb.g:                                             ; preds = %bb.e
  %.pr = load i64, ptr %i.h, align 8, !tbaa !30
