...
bb.s:                                             ; preds = %bb.p
  ...
  %i.ea = call { i64, ptr } %i.dz(ptr noundef nonnull align 8 dereferenceable(48) %5) #25 ; 0 uses
  %i.eb = getelementptr inbounds nuw i8, ptr %34, i64 8
  %i.ec = load ptr, ptr %i.eb, align 8, !tbaa !250 ; 2 uses
  %lhsv.i.i.i = load i64, ptr %34, align 8
