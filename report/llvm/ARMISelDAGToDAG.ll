...
bb.z:                                             ; preds = %bb.x, %bb.y
  ...
  %i.gw = load ptr, ptr %i.gv, align 8, !tbaa !790 ; 2 uses
  %i.gx = and i32 %i.da, 6
...
_ZNK4llvm6SDNode12getGluedUserEv.exit:            ; preds = %bb.ab, %bb.aa, %bb.ac
  ...
  %i.iu = load ptr, ptr %i.it, align 8, !tbaa !327 ; 2 uses
...
.lr.ph.i.i.i.i.preheader.i.i:                     ; preds = %_ZNSt6vectorIN4llvm7SDValueESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i.i
  ...
  %i.jd = call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.jc) #26 ; 2 uses
  br label %.lr.ph.i.i.i.i.i.i

.lr.ph.i.i.i.i.i.i:                               ; preds = %.lr.ph.i.i.i.i.i.i, %.lr.ph.i.i.i.i.preheader.i.i
  %.011.i.i.i.i.i.i = phi ptr [ %i.jf, %.lr.ph.i.i.i.i.i.i ], [ %i.jd, %.lr.ph.i.i.i.i.preheader.i.i ] ; 2 uses
  %.0810.i.i.i.i.i.i = phi ptr [ %i.je, %.lr.ph.i.i.i.i.i.i ], [ %i.iu, %.lr.ph.i.i.i.i.preheader.i.i ] ; 2 uses
  ...
  %i.je = getelementptr inbounds nuw i8, ptr %.0810.i.i.i.i.i.i, i64 40 ; 2 uses
  %i.jf = getelementptr inbounds nuw i8, ptr %.011.i.i.i.i.i.i, i64 16 ; 2 uses
  %.not.i.i.i.i.i.i = icmp eq ptr %i.je, %i.iz
  br i1 %.not.i.i.i.i.i.i, label %_ZNSt6vectorIN4llvm7SDValueESaIS1_EEC2IPNS0_5SDUseEvEET_S7_RKS2_.exit, label %.lr.ph.i.i.i.i.i.i, !llvm.loop !773

_ZNSt6vectorIN4llvm7SDValueESaIS1_EEC2IPNS0_5SDUseEvEET_S7_RKS2_.exit: ; preds = %.lr.ph.i.i.i.i.i.i, %_ZNSt6vectorIN4llvm7SDValueESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i.i
  %.sink = phi ptr [ null, %_ZNSt6vectorIN4llvm7SDValueESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i.i ], [ %i.jd, %.lr.ph.i.i.i.i.i.i ] ; 6 uses
  %.0.lcssa.i.i.i.i.i.i = phi ptr [ null, %_ZNSt6vectorIN4llvm7SDValueESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i.i ], [ %i.jf, %.lr.ph.i.i.i.i.i.i ] ; 4 uses
  %.idx708 = shl nuw nsw i64 %i.ja, 4
  %i.jg = getelementptr inbounds nuw i8, ptr %.sink, i64 %.idx708 ; 3 uses
  %.fca.0.extract69 = extractvalue { ptr, i32 } %i.is, 0 ; 2 uses
  %.not.i.i = icmp eq ptr %.0.lcssa.i.i.i.i.i.i, %i.jg
...
_ZNKSt6vectorIN4llvm7SDValueESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i: ; preds = %_ZNSt6vectorIN4llvm7SDValueESaIS1_EEC2IPNS0_5SDUseEvEET_S7_RKS2_.exit
  ...
  %i.jh = add nuw nsw i64 %.sroa.speculated.i.i.i.i, %i.ja
  %i.ji = call i64 @llvm.umin.i64(i64 %i.jh, i64 576460752303423487) ; 2 uses
  %i.jj = shl nuw nsw i64 %i.ji, 4
  %i.jk = call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.jj) #26 ; 6 uses
  %i.jl = getelementptr inbounds nuw i8, ptr %i.jk, i64 %.idx707 ; 2 uses
  store ptr %.fca.0.extract69, ptr %i.jl, align 8, !tbaa !329
  %.sroa.5380.0..sroa_idx381 = getelementptr inbounds nuw i8, ptr %i.jl, i64 8
...
.lr.ph.i.i.i.i.i.i266.preheader:                  ; preds = %_ZNKSt6vectorIN4llvm7SDValueESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i
  ...
  %30 = ptrtoint ptr %i.jg to i64
  %i.jm = add i64 %30, -16
  %i.jn = sub i64 %i.jm, %29
  %i.jo = and i64 %i.jn, -16                      ; 2 uses
  %i.jp = add i64 %i.jo, 16
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.jk, ptr align 8 %.sink, i64 %i.jp, i1 false), !alias.scope !791
  %scevgep = getelementptr i8, ptr %i.jk, i64 16
  %scevgep633 = getelementptr i8, ptr %scevgep, i64 %i.jo
...
_ZNSt6vectorIN4llvm7SDValueESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i.i: ; preds = %.lr.ph.i.i.i.i.i.i266.preheader, %_ZNKSt6vectorIN4llvm7SDValueESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i
  %.0.lcssa.i.i.i.i.i.i268 = phi ptr [ %i.jk, %_ZNKSt6vectorIN4llvm7SDValueESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i ], [ %scevgep633, %.lr.ph.i.i.i.i.i.i266.preheader ]
...
_ZNSt6vectorIN4llvm7SDValueESaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i: ; preds = %bb.af, %_ZNSt6vectorIN4llvm7SDValueESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i.i
  %i.jq = getelementptr inbounds nuw [16 x i8], ptr %i.jk, i64 %i.ji
  br label %_ZNSt6vectorIN4llvm7SDValueESaIS1_EE9push_backEOS1_.exit
...
_ZNSt6vectorIN4llvm7SDValueESaIS1_EE9push_backEOS1_.exit: ; preds = %bb.ae, %_ZNSt6vectorIN4llvm7SDValueESaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i
  %.sroa.14.1 = phi ptr [ %i.jq, %_ZNSt6vectorIN4llvm7SDValueESaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i ], [ %i.jg, %bb.ae ]
  ...
  %.sroa.0387.1 = phi ptr [ %i.jk, %_ZNSt6vectorIN4llvm7SDValueESaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i ], [ %.sink, %bb.ae ] ; 4 uses
  %.sroa.8390.0 = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i.i.i268.pn, i64 16
  %i.jr = load ptr, ptr %i.ao, align 8, !tbaa !314
  %i.js = ptrtoint ptr %.sroa.8390.0 to i64
  %i.jt = ptrtoint ptr %.sroa.0387.1 to i64       ; 2 uses
  %i.ju = sub i64 %i.js, %i.jt
  %i.jv = ashr exact i64 %i.ju, 4
  %i.jw = call noundef ptr @_ZN4llvm12SelectionDAG18UpdateNodeOperandsEPNS_6SDNodeENS_8ArrayRefINS_7SDValueEEE(ptr noundef nonnull align 8 dereferenceable(920) %i.jr, ptr noundef nonnull %i.hm, ptr %.sroa.0387.1, i64 %i.jv) #24 ; 0 uses
...
bb.ag:                                            ; preds = %_ZNSt6vectorIN4llvm7SDValueESaIS1_EE9push_backEOS1_.exit
  %i.jx = ptrtoint ptr %.sroa.14.1 to i64
  %i.jy = sub i64 %i.jx, %i.jt
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0387.1, i64 noundef %i.jy) #27
...
bb.ah:                                            ; preds = %bb.z
  ...
  %i.jz = load ptr, ptr %i.ao, align 8, !tbaa !314 ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %10)
  call void @llvm.lifetime.start.p0(ptr nonnull %12)
  store i16 249, ptr %10, align 8, !tbaa !430
  store ptr null, ptr %i.ap, align 8, !tbaa !432
  %i.ka = call { ptr, i32 } @_ZN4llvm12SelectionDAG9getVTListENS_3EVTES1_S1_(ptr noundef nonnull align 8 dereferenceable(920) %i.jz, i16 7, ptr null, i16 1, ptr null, ptr noundef nonnull byval(%"struct.llvm::EVT") align 8 %10) #24 ; 2 uses
  %i.kb = extractvalue { ptr, i32 } %i.ka, 0
  %i.kc = extractvalue { ptr, i32 } %i.ka, 1
  ...
  %i.kd = call { ptr, i32 } @_ZN4llvm12SelectionDAG11getRegisterENS_8RegisterENS_3EVTE(ptr noundef nonnull align 8 dereferenceable(920) %i.jz, i32 %.sroa.0.0.copyload.i, i16 7, ptr null) #24 ; 2 uses
  %.fca.0.extract3.i276 = extractvalue { ptr, i32 } %i.kd, 0
  %.fca.1.extract4.i277 = extractvalue { ptr, i32 } %i.kd, 1
  ...
  %i.ke = select i1 %.not.i279, i64 2, i64 3
  store ptr %11, ptr %12, align 8, !tbaa !361
  store i64 %i.ke, ptr %i.as, align 8, !tbaa !362
  %i.kf = call { ptr, i32 } @_ZN4llvm12SelectionDAG7getNodeEjRKNS_5SDLocENS_8SDVTListENS_8ArrayRefINS_7SDValueEEE(ptr noundef nonnull align 8 dereferenceable(920) %i.jz, i32 noundef 52, ptr noundef nonnull align 8 dereferenceable(12) %20, ptr %i.kb, i32 %i.kc, ptr noundef nonnull byval(%"class.llvm::ArrayRef") align 8 %12) #24 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %11) #24
  call void @llvm.lifetime.end.p0(ptr nonnull %10)
  call void @llvm.lifetime.end.p0(ptr nonnull %12)
  %.fca.0.extract57 = extractvalue { ptr, i32 } %i.kf, 0 ; 5 uses
  %.fca.1.extract58 = extractvalue { ptr, i32 } %i.kf, 1
  %i.kg = load ptr, ptr %i.ao, align 8, !tbaa !314 ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %7)
  call void @llvm.lifetime.start.p0(ptr nonnull %9)
  store i16 249, ptr %7, align 8, !tbaa !430
  store ptr null, ptr %i.at, align 8, !tbaa !432
  %i.kh = call { ptr, i32 } @_ZN4llvm12SelectionDAG9getVTListENS_3EVTES1_S1_(ptr noundef nonnull align 8 dereferenceable(920) %i.kg, i16 7, ptr null, i16 1, ptr null, ptr noundef nonnull byval(%"struct.llvm::EVT") align 8 %7) #24 ; 2 uses
  %i.ki = extractvalue { ptr, i32 } %i.kh, 0
  %i.kj = extractvalue { ptr, i32 } %i.kh, 1
  ...
  %i.kk = call { ptr, i32 } @_ZN4llvm12SelectionDAG11getRegisterENS_8RegisterENS_3EVTE(ptr noundef nonnull align 8 dereferenceable(920) %i.kg, i32 %.sroa.0.0.copyload.i239, i16 7, ptr null) #24 ; 2 uses
  %.fca.0.extract3.i286 = extractvalue { ptr, i32 } %i.kk, 0
  %.fca.1.extract4.i287 = extractvalue { ptr, i32 } %i.kk, 1
  ...
  %i.kl = select i1 %.not.i289, i64 2, i64 3
  store ptr %8, ptr %9, align 8, !tbaa !361
  store i64 %i.kl, ptr %i.aw, align 8, !tbaa !362
  %i.km = call { ptr, i32 } @_ZN4llvm12SelectionDAG7getNodeEjRKNS_5SDLocENS_8SDVTListENS_8ArrayRefINS_7SDValueEEE(ptr noundef nonnull align 8 dereferenceable(920) %i.kg, i32 noundef 52, ptr noundef nonnull align 8 dereferenceable(12) %20, ptr %i.ki, i32 %i.kj, ptr noundef nonnull byval(%"class.llvm::ArrayRef") align 8 %9) #24 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #24
  call void @llvm.lifetime.end.p0(ptr nonnull %7)
  call void @llvm.lifetime.end.p0(ptr nonnull %9)
  %.fca.0.extract45 = extractvalue { ptr, i32 } %i.km, 0 ; 4 uses
  %.fca.1.extract46 = extractvalue { ptr, i32 } %i.km, 1 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %6)
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #24
  %i.kn = getelementptr inbounds nuw i8, ptr %.fca.0.extract57, i64 72
  %i.ko = load i64, ptr %i.kn, align 8, !tbaa !353
  store i64 %i.ko, ptr %4, align 8, !tbaa !353
  %i.kp = getelementptr inbounds nuw i8, ptr %.fca.0.extract57, i64 68
  %i.kq = load i32, ptr %i.kp, align 4, !tbaa !354
  store i32 %i.kq, ptr %i.ax, align 8, !tbaa !356
  %i.kr = load ptr, ptr %i.ao, align 8, !tbaa !314
  %i.ks = call { ptr, i32 } @_ZN4llvm12SelectionDAG11getConstantEmRKNS_5SDLocENS_3EVTEbb(ptr noundef nonnull align 8 dereferenceable(920) %i.kr, i64 noundef 54, ptr noundef nonnull align 8 dereferenceable(12) %4, i16 7, ptr null, i1 noundef zeroext true, i1 noundef zeroext false) #24 ; 2 uses
  %.fca.0.extract12.i = extractvalue { ptr, i32 } %i.ks, 0
  %.fca.1.extract13.i = extractvalue { ptr, i32 } %i.ks, 1
  %i.kt = load ptr, ptr %i.ao, align 8, !tbaa !314
  %i.ku = call { ptr, i32 } @_ZN4llvm12SelectionDAG11getConstantEmRKNS_5SDLocENS_3EVTEbb(ptr noundef nonnull align 8 dereferenceable(920) %i.kt, i64 noundef 9, ptr noundef nonnull align 8 dereferenceable(12) %4, i16 7, ptr null, i1 noundef zeroext true, i1 noundef zeroext false) #24 ; 2 uses
  %.fca.0.extract5.i = extractvalue { ptr, i32 } %i.ku, 0
  %.fca.1.extract6.i = extractvalue { ptr, i32 } %i.ku, 1
  %i.kv = load ptr, ptr %i.ao, align 8, !tbaa !314
  %i.kw = call { ptr, i32 } @_ZN4llvm12SelectionDAG11getConstantEmRKNS_5SDLocENS_3EVTEbb(ptr noundef nonnull align 8 dereferenceable(920) %i.kv, i64 noundef 10, ptr noundef nonnull align 8 dereferenceable(12) %4, i16 7, ptr null, i1 noundef zeroext true, i1 noundef zeroext false) #24 ; 2 uses
  %.fca.0.extract.i = extractvalue { ptr, i32 } %i.kw, 0
  %.fca.1.extract.i = extractvalue { ptr, i32 } %i.kw, 1
  ...
  %i.kx = load ptr, ptr %i.ao, align 8, !tbaa !314
  store ptr %5, ptr %6, align 8, !tbaa !361
  store i64 5, ptr %i.bc, align 8, !tbaa !362
  %i.ky = call noundef ptr @_ZN4llvm12SelectionDAG14getMachineNodeEjRKNS_5SDLocENS_3EVTENS_8ArrayRefINS_7SDValueEEE(ptr noundef nonnull align 8 dereferenceable(920) %i.kx, i32 noundef 19, ptr noundef nonnull align 8 dereferenceable(12) %4, i16 251, ptr null, ptr noundef nonnull byval(%"class.llvm::ArrayRef") align 8 %6) #24 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #24
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #24
  call void @llvm.lifetime.end.p0(ptr nonnull %6)
  %i.kz = call i32 @_ZN4llvm19MachineRegisterInfo21createVirtualRegisterEPKNS_15MCRegisterClassENS_9StringRefE(ptr noundef nonnull align 8 dereferenceable(520) %i.gw, ptr noundef nonnull getelementptr inbounds nuw (i8, ptr @_ZN4llvm25ARMMCRegisterClassStorageE, i64 3456), ptr nonnull @.str.25, i64 0) #24 ; 2 uses
  %i.la = load ptr, ptr %i.ao, align 8, !tbaa !314
  %i.lb = call { ptr, i32 } @_ZN4llvm12SelectionDAG11getRegisterENS_8RegisterENS_3EVTE(ptr noundef nonnull align 8 dereferenceable(920) %i.la, i32 %i.kz, i16 251, ptr null) #24
  %i.lc = load ptr, ptr %i.ao, align 8, !tbaa !314 ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %3)
  %i.ld = call { ptr, i32 } @_ZN4llvm12SelectionDAG9getVTListENS_3EVTES1_(ptr noundef nonnull align 8 dereferenceable(920) %i.lc, i16 1, ptr null, i16 249, ptr null) #24 ; 2 uses
  %i.le = extractvalue { ptr, i32 } %i.ld, 0
  %i.lf = extractvalue { ptr, i32 } %i.ld, 1
  ...
  %i.lg = getelementptr inbounds nuw i8, ptr %i.ky, i64 48
  %i.lh = load ptr, ptr %i.lg, align 8, !tbaa !333 ; 2 uses
  %.sroa.0.0.copyload.i.i.i293 = load i16, ptr %i.lh, align 8, !tbaa !335
  %.sroa.21.0..sroa_idx.i.i.i294 = getelementptr inbounds nuw i8, ptr %i.lh, i64 8
  %.sroa.21.0.copyload.i.i.i295 = load ptr, ptr %.sroa.21.0..sroa_idx.i.i.i294, align 8, !tbaa !337
  %i.li = call { ptr, i32 } @_ZN4llvm12SelectionDAG11getRegisterENS_8RegisterENS_3EVTE(ptr noundef nonnull align 8 dereferenceable(920) %i.lc, i32 %i.kz, i16 %.sroa.0.0.copyload.i.i.i293, ptr %.sroa.21.0.copyload.i.i.i295) #24 ; 2 uses
  %.fca.0.extract3.i296 = extractvalue { ptr, i32 } %i.li, 0
  %.fca.1.extract4.i297 = extractvalue { ptr, i32 } %i.li, 1
  store ptr %.fca.0.extract3.i296, ptr %i.bd, align 16
  store i32 %.fca.1.extract4.i297, ptr %.sroa.26.0..sroa_idx.i298, align 8
  store ptr %i.ky, ptr %i.be, align 16, !tbaa !329
  ...
  %i.lj = select i1 %.not.i299, i64 3, i64 4
  store ptr %2, ptr %3, align 8, !tbaa !361
  store i64 %i.lj, ptr %i.bg, align 8, !tbaa !362
  %i.lk = call { ptr, i32 } @_ZN4llvm12SelectionDAG7getNodeEjRKNS_5SDLocENS_8SDVTListENS_8ArrayRefINS_7SDValueEEE(ptr noundef nonnull align 8 dereferenceable(920) %i.lc, i32 noundef 51, ptr noundef nonnull align 8 dereferenceable(12) %20, ptr %i.le, i32 %i.lf, ptr noundef nonnull byval(%"class.llvm::ArrayRef") align 8 %3) #24 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #24
  call void @llvm.lifetime.end.p0(ptr nonnull %3)
  %.fca.0.extract18 = extractvalue { ptr, i32 } %i.lk, 0 ; 2 uses
  %.fca.1.extract19 = extractvalue { ptr, i32 } %i.lk, 1
...
_ZNSt6vectorIN4llvm7SDValueESaIS1_EED2Ev.exit:    ; preds = %bb.ag, %_ZNSt6vectorIN4llvm7SDValueESaIS1_EE9push_backEOS1_.exit, %bb.ah
  %.pn = phi { ptr, i32 } [ %i.lb, %bb.ah ], [ %i.ha, %_ZNSt6vectorIN4llvm7SDValueESaIS1_EE9push_backEOS1_.exit ], [ %i.ha, %bb.ag ] ; 2 uses
...
bb.ai:                                            ; preds = %_ZNSt6vectorIN4llvm7SDValueESaIS1_EED2Ev.exit
  %i.ll = load i64, ptr %i.w, align 8, !tbaa !547
  %i.lm = load ptr, ptr %21, align 8, !tbaa !546
  %i.ln = getelementptr i8, ptr %i.lm, i64 %i.ll
  %i.lo = getelementptr i8, ptr %i.ln, i64 -1
  store i8 1, ptr %i.lo, align 1, !tbaa !470
  %i.lp = or disjoint i32 %.0, -2147483640
  %i.lq = or disjoint i32 %i.db, 3604488
  %.sroa.0466.0 = select i1 %.0188, i32 %i.lp, i32 %i.lq
  %i.lr = load ptr, ptr %i.ao, align 8, !tbaa !314
  %i.ls = zext i32 %.sroa.0466.0 to i64
  %i.lt = call { ptr, i32 } @_ZN4llvm12SelectionDAG11getConstantEmRKNS_5SDLocENS_3EVTEbb(ptr noundef nonnull align 8 dereferenceable(920) %i.lr, i64 noundef %i.ls, ptr noundef nonnull align 8 dereferenceable(12) %20, i16 7, ptr null, i1 noundef zeroext true, i1 noundef zeroext false) #24 ; 2 uses
  %.fca.0.extract6 = extractvalue { ptr, i32 } %i.lt, 0
  %.fca.1.extract7 = extractvalue { ptr, i32 } %i.lt, 1
  %i.lu = ptrtoint ptr %.sroa.19.6 to i64
end_hunk_0
