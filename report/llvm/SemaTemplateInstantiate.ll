...
begin_hunk_0_@_ZN5clang4Sema28getTemplateInstantiationArgsEPKNS_9NamedDeclEPKNS_11DeclContextEbSt8optionalIN4llvm8ArrayRefINS_16TemplateArgumentEEEEbPKNS_12FunctionDeclEbbb:bb.a
  ...
  %i.ov = call noundef ptr @_ZNK5clang24RedeclarableTemplateDecl12getCommonPtrEv(ptr noundef nonnull align 8 dereferenceable(88) %.013.i.i) #26, !noalias !2858
  %.0.copyload.i.i.i.i.i15.i.i = load i64, ptr %i.ov, align 8, !noalias !2858
  %.013.in.i.i = and i64 %.0.copyload.i.i.i.i.i15.i.i, -8 ; 2 uses
  %.not14.i.i = icmp eq i64 %.013.in.i.i, 0
  br i1 %.not14.i.i, label %_ZN12_GLOBAL__N_123TemplateInstArgsHelpers33getEnclosingTypeAliasTemplateDeclERN5clang4SemaE.exit.i, label %.lr.ph.i.i, !llvm.loop !1
...
bb.do:                                            ; preds = %_ZN12_GLOBAL__N_123TemplateInstArgsHelpers33getEnclosingTypeAliasTemplateDeclERN5clang4SemaE.exit.i
  ...
  %.val67.i = load ptr, ptr %i.ox, align 8, !tbaa !820
...
bb.dr:                                            ; preds = %bb.dp
  ...
  %i.pg = load ptr, ptr %i.pf, align 8, !tbaa !83
  br label %_ZN12_GLOBAL__N_123TemplateInstArgsHelpers30HandlePartialClassTemplateSpecEPKN5clang38ClassTemplatePartialSpecializationDeclERNS1_30MultiLevelTemplateArgumentListEb.exit.thread333.sink.split
...
bb.dt:                                            ; preds = %_ZNK5clang13CXXRecordDecl8isLambdaEv.exit.thread.i
  ...
  %i.pn = load ptr, ptr %i.pm, align 8, !tbaa !83
  br label %_ZN12_GLOBAL__N_123TemplateInstArgsHelpers30HandlePartialClassTemplateSpecEPKN5clang38ClassTemplatePartialSpecializationDeclERNS1_30MultiLevelTemplateArgumentListEb.exit.thread333.sink.split
...
bb.dv:                                            ; preds = %bb.du
  ...
  %i.pp = load i32, ptr %i.po, align 4, !tbaa !822
  %i.pq = zext i32 %i.pp to i64
  %i.pr = getelementptr inbounds nuw i8, ptr %.1285, i64 40
  call void @llvm.lifetime.start.p0(ptr nonnull %14) #26
  %i.ps = load ptr, ptr %.1285, align 8, !tbaa !77
  %i.pt = getelementptr inbounds nuw i8, ptr %i.ps, i64 32
  %i.pu = load ptr, ptr %i.pt, align 8
  %i.pv = call noundef ptr %i.pu(ptr noundef nonnull align 8 dereferenceable(33) %.1285) #26, !inline_history !2846
  %i.pw = ptrtoint ptr %i.pv to i64
  %i.px = and i64 %i.pw, -5
  store i64 %i.px, ptr %14, align 8
  store ptr %i.pr, ptr %i.bk, align 8, !tbaa !73
  store i64 %i.pq, ptr %.sroa.2.0..sroa_idx.i.i198, align 8, !tbaa !75
  %i.py = load i32, ptr %i.b, align 8, !tbaa !55  ; 2 uses
  %i.pz = load i32, ptr %i.c, align 4, !tbaa !56
  %.not.i.i.i199 = icmp ult i32 %i.py, %i.pz
  br i1 %.not.i.i.i199, label %bb.dx, label %bb.dw, !prof !79
...
bb.dx:                                            ; preds = %bb.dv
  ...
  %i.qb = load ptr, ptr %0, align 8, !tbaa !54
  ...
  %i.qd = load i32, ptr %i.b, align 8, !tbaa !55
  %i.qe = add i32 %i.qd, 1
  store i32 %i.qe, ptr %i.b, align 8, !tbaa !55
  br label %_ZN5clang30MultiLevelTemplateArgumentList25addOuterTemplateArgumentsEPNS_4DeclEN4llvm8ArrayRefINS_16TemplateArgumentEEEb.exit.i200
...
bb.ec:                                            ; preds = %bb.ea
  ...
  %i.qt = load ptr, ptr %i.qs, align 8, !tbaa !83
  br label %_ZNK5clang4Decl14getDeclContextEv.exit.i
...
bb.ed:                                            ; preds = %_ZNK5clang4Decl14getDeclContextEv.exit.i
  %i.qz = load ptr, ptr %i.bi, align 8, !tbaa !786, !nonnull !71, !align !787
  %i.ra = getelementptr inbounds nuw i8, ptr %.1285, i64 56
  %i.rb = load ptr, ptr %i.ra, align 8, !tbaa !798
  ...
  %i.rf = load ptr, ptr %.1285, align 8, !tbaa !77
  %i.rg = getelementptr inbounds nuw i8, ptr %i.rf, i64 32
  %i.rh = load ptr, ptr %i.rg, align 8
  %i.ri = call noundef ptr %i.rh(ptr noundef nonnull align 8 dereferenceable(33) %.1285) #26, !inline_history !2847
  %i.rj = ptrtoint ptr %i.ri to i64
  %i.rk = and i64 %i.rj, -5
  store i64 %i.rk, ptr %12, align 8
  store ptr %i.rd, ptr %i.bl, align 8, !tbaa !73
  store i64 %i.re, ptr %.sroa.2.0..sroa_idx.i.i207, align 8, !tbaa !75
  %i.rl = load i32, ptr %i.b, align 8, !tbaa !55  ; 2 uses
  %i.rm = load i32, ptr %i.c, align 4, !tbaa !56
  %.not.i.i.i208 = icmp ult i32 %i.rl, %i.rm
  br i1 %.not.i.i.i208, label %bb.ef, label %bb.ee, !prof !79
...
bb.ef:                                            ; preds = %bb.ed
  ...
  %i.ro = load ptr, ptr %0, align 8, !tbaa !54
  ...
  %i.rq = load i32, ptr %i.b, align 8, !tbaa !55
  %i.rr = add i32 %i.rq, 1
  store i32 %i.rr, ptr %i.b, align 8, !tbaa !55
  br label %_ZN5clang30MultiLevelTemplateArgumentList25addOuterTemplateArgumentsEPNS_4DeclEN4llvm8ArrayRefINS_16TemplateArgumentEEEb.exit.i209
...
_ZN5clang30MultiLevelTemplateArgumentList25addOuterTemplateArgumentsEPNS_4DeclEN4llvm8ArrayRefINS_16TemplateArgumentEEEb.exit.i209: ; preds = %bb.ef, %bb.ee
  ...
  %i.rt = load ptr, ptr %i.rs, align 8, !tbaa !820
...
_ZNK5clang14DeclaratorDecl12getQualifierEv.exit.i: ; preds = %_ZN5clang30MultiLevelTemplateArgumentList25addOuterTemplateArgumentsEPNS_4DeclEN4llvm8ArrayRefINS_16TemplateArgumentEEEb.exit.i209
  ...
  %.sroa.0.0.copyload.i.i.i = load i64, ptr %i.rx, align 8, !tbaa !75 ; 3 uses
...
_ZNK5clang4Type18getAsCXXRecordDeclEv.exit.i:     ; preds = %bb.eh
  ...
  %.sroa.0.0.copyload.i.i.i.i.i = load i64, ptr %i.su, align 8, !tbaa !105
  %i.sv = and i64 %.sroa.0.0.copyload.i.i.i.i.i, -16
  %i.sw = inttoptr i64 %i.sv to ptr
  %i.sx = load ptr, ptr %i.sw, align 16, !tbaa !824, !nonnull !71, !noundef !71 ; 2 uses
  ...
  %i.td = load ptr, ptr %i.tc, align 8, !tbaa !829 ; 2 uses
...
bb.ei:                                            ; preds = %_ZNK5clang4Type18getAsCXXRecordDeclEv.exit.i
  %i.tg = load ptr, ptr %i.bi, align 8, !tbaa !786, !nonnull !71, !align !787
  %i.th = getelementptr inbounds nuw i8, ptr %i.tf, i64 56
  %i.ti = load ptr, ptr %i.th, align 8, !tbaa !798
...
bb.ek:                                            ; preds = %bb.ej
  ...
  %.1.i51.i = load ptr, ptr %.1.in.i.i223, align 8, !tbaa !2852 ; 2 uses
  %i.tx = load i32, ptr %.1.i51.i, align 8, !tbaa !88
...
bb.em:                                            ; preds = %bb.el
  %i.uc = load ptr, ptr %i.ub, align 8, !tbaa !77
  %i.ud = getelementptr inbounds nuw i8, ptr %i.uc, i64 32
  %i.ue = load ptr, ptr %i.ud, align 8
  %i.uf = call noundef ptr %i.ue(ptr noundef nonnull align 8 dereferenceable(33) %i.ub) #26, !inline_history !2847
...
bb.en:                                            ; preds = %bb.em, %bb.el
  ...
  store ptr %.sroa.011.2.i, ptr %i.bm, align 8, !tbaa !73
  store i64 %.sroa.6.2.i, ptr %.sroa.2.0..sroa_idx.i54.i, align 8, !tbaa !75
  %i.uj = load i32, ptr %i.b, align 8, !tbaa !55  ; 2 uses
  %i.uk = load i32, ptr %i.c, align 4, !tbaa !56
  %.not.i.i55.i = icmp ult i32 %i.uj, %i.uk
  br i1 %.not.i.i55.i, label %bb.ep, label %bb.eo, !prof !79
...
bb.ep:                                            ; preds = %bb.en
  ...
  %i.um = load ptr, ptr %0, align 8, !tbaa !54
  ...
  %i.uo = load i32, ptr %i.b, align 8, !tbaa !55
  %i.up = add i32 %i.uo, 1
  store i32 %i.up, ptr %i.b, align 8, !tbaa !55
  br label %_ZN5clang30MultiLevelTemplateArgumentList25addOuterTemplateArgumentsEPNS_4DeclEN4llvm8ArrayRefINS_16TemplateArgumentEEEb.exit56.i
...
bb.eq:                                            ; preds = %_ZN5clang30MultiLevelTemplateArgumentList25addOuterTemplateArgumentsEPNS_4DeclEN4llvm8ArrayRefINS_16TemplateArgumentEEEb.exit56.i, %_ZNK5clang19NestedNameSpecifier7getKindEv.exit46.thread.i
  br i1 %or.cond79.not.i, label %.critedge.i213, label %bb.eg, !llvm.loop !2848
...
bb.es:                                            ; preds = %.critedge.i213
  ...
  %i.uw = load ptr, ptr %i.uv, align 8, !tbaa !84
  br label %_ZN12_GLOBAL__N_123TemplateInstArgsHelpers26HandleFunctionTemplateDeclERN5clang4SemaEPKNS1_20FunctionTemplateDeclERNS1_30MultiLevelTemplateArgumentListE.exit
...
bb.ev:                                            ; preds = %bb.et
  ...
  %i.vf = load ptr, ptr %i.ve, align 8, !tbaa !84
  br label %_ZNK5clang4Decl21getLexicalDeclContextEv.exit
...
bb.ez:                                            ; preds = %bb.ex
  ...
  %i.vo = load ptr, ptr %i.vn, align 8, !tbaa !83
  br label %_ZN12_GLOBAL__N_123TemplateInstArgsHelpers8Response34DontClearRelativeToPrimaryNextDeclEPKN5clang4DeclE.exit
...
bb.fc:                                            ; preds = %bb.fa
  ...
  %i.vv = load ptr, ptr %i.vu, align 8, !tbaa !83
  br label %_ZN12_GLOBAL__N_123TemplateInstArgsHelpers24HandleGenericDeclContextEPKN5clang4DeclE.exit
...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  store ptr %2, ptr %i.j, align 8, !tbaa !73
  %.sroa.2.0..sroa_idx = getelementptr inbounds nuw i8, ptr %5, i64 16
  store i64 %3, ptr %.sroa.2.0..sroa_idx, align 8, !tbaa !75
...
bb.e:                                             ; preds = %bb.c
  ...
  %i.r = load i32, ptr %i.k, align 8, !tbaa !55
  %i.s = add i32 %i.r, 1
  store i32 %i.s, ptr %i.k, align 8, !tbaa !55
  br label %_ZN4llvm23SmallVectorTemplateBaseIN5clang30MultiLevelTemplateArgumentList17ArgumentListLevelELb1EE9push_backERKS3_.exit
