...
.lr.ph.i.preheader:                               ; preds = %bb.c
  ...
  %or.cond144 = select i1 %.not.i5.i.i.i, i1 true, i1 %.not45.i.i.i.i
  br i1 %or.cond144, label %_ZN4llvm26MachineInstrBundleIteratorINS_12MachineInstrELb0EEmmEv.exit.i, label %_ZNK4llvm14ilist_iteratorINS_12ilist_detail12node_optionsINS_12MachineInstrELb1ELb1EvLb0EvEELb0ELb0EE5isEndEv.exit.i.i.i11.i
...
_ZNK4llvm14MCRegisterInfo22isSuperOrSubRegisterEqENS_10MCRegisterES1_.exit: ; preds = %.loopexit105, %bb.h
  %i.dt = add nuw i32 %.056112, 1                 ; 2 uses
...
_ZNK4llvm14MCRegisterInfo22isSuperOrSubRegisterEqENS_10MCRegisterES1_.exit._crit_edge: ; preds = %_ZNK4llvm14MCRegisterInfo22isSuperOrSubRegisterEqENS_10MCRegisterES1_.exit.thread91
  %.not145 = icmp eq i32 %.258.ph, 0
  br i1 %.not145, label %.loopexit, label %.preheader104
...
.lr.ph116:                                        ; preds = %.preheader104
  ...
  %i.ea = zext i32 %.258.ph to i64                ; 4 uses
