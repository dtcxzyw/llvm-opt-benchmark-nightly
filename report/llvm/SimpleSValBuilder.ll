...
bb.a:
  ...
  %.sroa.0598 = alloca i64, align 8               ; 5 uses
  %.sroa.0594 = alloca i64, align 8               ; 5 uses
...
.split689._crit_edge:                             ; preds = %.split689
  ...
  %.pre822.a = and i64 %.sroa.0.0.copyload.i.i.i.i.i.i.i.pre, -16
  %.pre824 = inttoptr i64 %.pre822.a to ptr
  br label %bb.l
...
bb.q:                                             ; preds = %bb.h, %_ZNK5clang4ento4SVal5getAsINS0_6NonLocEEESt8optionalIT_Ev.exit420
  ...
  %.4..4..4..sroa_idx938 = getelementptr inbounds nuw i8, ptr %.sroa.0598, i64 4
  %.4..4..4..sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.0594, i64 4
  br label %bb.r
...
_ZSt3maxIN5clang4ento10APSIntTypeEERKT_S5_S5_.exit: ; preds = %bb.bb, %_ZNK5clang4ento10APSIntTypeltERKS1_.exit.thread.i
  %i.hf = phi ptr [ %.sroa.0594, %_ZNK5clang4ento10APSIntTypeltERKS1_.exit.thread.i ], [ %.sroa.0598, %bb.bb ]
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.0594)
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.0598)
