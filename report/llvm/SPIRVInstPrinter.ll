...
bb.cb:                                            ; preds = %.critedge
  ...
  %i.je = load i32, ptr %i.jd, align 8, !tbaa !33 ; 2 uses
...
bb.cc:                                            ; preds = %bb.cb
  ...
  %i.jg = load ptr, ptr %i.jf, align 8, !tbaa !32 ; 3 uses
  %i.jh = getelementptr inbounds nuw i8, ptr %6, i64 24
  %i.ji = load ptr, ptr %i.jh, align 8, !tbaa !31
...
bb.ce:                                            ; preds = %bb.cc
  ...
  store ptr %i.jk, ptr %i.jf, align 8, !tbaa !32
  store i8 32, ptr %i.jg, align 1, !tbaa !24
  br label %_ZN4llvm11raw_ostreamlsEc.exit216
...
bb.cg:                                            ; preds = %_ZN4llvm11raw_ostreamlsEc.exit216
  ...
  store ptr %i.ju, ptr %14, align 8, !tbaa !80
  %i.jv = getelementptr inbounds nuw i8, ptr %14, i64 8 ; 3 uses
  store i64 0, ptr %i.jv, align 8, !tbaa !60
  store i8 0, ptr %i.ju, align 8, !tbaa !24
  %i.jw = getelementptr inbounds nuw i8, ptr %15, i64 16 ; 2 uses
  br label %bb.ci

bb.ch:                                            ; preds = %bb.cm
  %i.jx = load ptr, ptr %14, align 8, !tbaa !59
  %i.jy = load i64, ptr %i.jv, align 8, !tbaa !60
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i217: ; preds = %bb.ch
  %i.kc = load i64, ptr %i.ju, align 8, !tbaa !24
  %i.kd = add i64 %i.kc, 1
...
bb.cj:                                            ; preds = %bb.ci
  %i.kf = load i64, ptr %i.jv, align 8, !tbaa !60
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i220: ; preds = %bb.cl
  %i.kl = load i64, ptr %i.jw, align 8, !tbaa !24
  %i.km = add i64 %i.kl, 1
...
bb.co:                                            ; preds = %bb.cn
  ...
  %i.kt = load ptr, ptr %i.ks, align 8, !tbaa !32 ; 3 uses
  %i.ku = getelementptr inbounds nuw i8, ptr %6, i64 24
  %i.kv = load ptr, ptr %i.ku, align 8, !tbaa !31
...
bb.cq:                                            ; preds = %bb.co
  ...
  store ptr %i.kx, ptr %i.ks, align 8, !tbaa !32
  store i8 32, ptr %i.kt, align 1, !tbaa !24
  br label %_ZN4llvm11raw_ostreamlsEc.exit225
...
bb.cr:                                            ; preds = %.critedge, %.critedge
  ...
  %i.la = load i32, ptr %i.kz, align 8, !tbaa !33 ; 2 uses
...
bb.cs:                                            ; preds = %bb.cr
  ...
  %i.ld = load ptr, ptr %i.lc, align 8, !tbaa !32 ; 3 uses
...
bb.cu:                                            ; preds = %bb.cs
  ...
  store ptr %i.lh, ptr %i.lc, align 8, !tbaa !32
  store i8 32, ptr %i.ld, align 1, !tbaa !24
  br label %_ZN4llvm11raw_ostreamlsEc.exit228
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !81, !nonnull !52, !align !55
  ...
  %i.i = load i16, ptr %i.h, align 4, !tbaa !89   ; 6 uses
...
bb.d:                                             ; preds = %bb.b
  ...
  store i8 32, ptr %i.t, align 1, !tbaa !24
  br label %_ZN4llvm11raw_ostreamlsEc.exit
...
bb.e:                                             ; preds = %_ZN4llvm11raw_ostreamlsEc.exit
  %i.y = load i32, ptr %i.k, align 8, !tbaa !33
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.ab = load ptr, ptr %i.n, align 8, !tbaa !34
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i: ; preds = %bb.f
  %i.an = load i64, ptr %i.al, align 8, !tbaa !24
  %i.ao = add i64 %i.an, 1
...
bb.g:                                             ; preds = %_ZN4llvm11raw_ostreamlsEc.exit
  %i.ap = load i32, ptr %i.k, align 8, !tbaa !33
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.as = load ptr, ptr %i.n, align 8, !tbaa !34
  ...
  %i.az = load i64, ptr %i.ay, align 8, !tbaa !60
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i39: ; preds = %bb.h
  %i.be = load i64, ptr %i.bc, align 8, !tbaa !24
  %i.bf = add i64 %i.be, 1
...
bb.i:                                             ; preds = %_ZN4llvm11raw_ostreamlsEc.exit
  %i.bg = load i32, ptr %i.k, align 8, !tbaa !33
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.bj = load ptr, ptr %i.n, align 8, !tbaa !34
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i42: ; preds = %bb.j
  %i.bv = load i64, ptr %i.bt, align 8, !tbaa !24
  %i.bw = add i64 %i.bv, 1
...
bb.k:                                             ; preds = %_ZN4llvm11raw_ostreamlsEc.exit
  %i.bx = load i32, ptr %i.k, align 8, !tbaa !33
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.ca = load ptr, ptr %i.n, align 8, !tbaa !34
  %i.cb = getelementptr inbounds nuw [16 x i8], ptr %i.ca, i64 %i.bz
  %i.cc = getelementptr inbounds nuw i8, ptr %i.cb, i64 8
  %i.cd = load i64, ptr %i.cc, align 8, !tbaa !24
  ...
  %i.ch = load i64, ptr %i.cg, align 8, !tbaa !60
...
bb.m:                                             ; preds = %_ZN4llvm11raw_ostreamlsEc.exit
  %i.co = load i32, ptr %i.k, align 8, !tbaa !33
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.cr = load ptr, ptr %i.n, align 8, !tbaa !34
  ...
  %i.cy = load i64, ptr %i.cx, align 8, !tbaa !60
...
bb.p:                                             ; preds = %_ZN4llvm11raw_ostreamlsEc.exit
  ...
  %i.dg = load i32, ptr %i.k, align 8, !tbaa !33
...
bb.q:                                             ; preds = %bb.p
  %i.di = load ptr, ptr %i.s, align 8, !tbaa !32  ; 3 uses
  %i.dj = load ptr, ptr %i.u, align 8, !tbaa !31
...
bb.s:                                             ; preds = %bb.q
  ...
  store ptr %i.dl, ptr %i.s, align 8, !tbaa !32
  store i8 32, ptr %i.di, align 1, !tbaa !24
  br label %_ZN4llvm11raw_ostreamlsEc.exit53
...
bb.t:                                             ; preds = %_ZN4llvm11raw_ostreamlsEc.exit
  %i.dm = load i32, ptr %i.k, align 8, !tbaa !33  ; 3 uses
...
bb.u:                                             ; preds = %.lr.ph.i, %_ZN4llvm11raw_ostreamlsEc.exit.i
  ...
  %i.dp = load ptr, ptr %i.s, align 8, !tbaa !32  ; 3 uses
  %i.dq = load ptr, ptr %i.u, align 8, !tbaa !31
...
bb.w:                                             ; preds = %bb.u
  ...
  store ptr %i.ds, ptr %i.s, align 8, !tbaa !32
  store i8 32, ptr %i.dp, align 1, !tbaa !24
  br label %_ZN4llvm11raw_ostreamlsEc.exit.i
...
_ZN4llvm11raw_ostreamlsEc.exit.i:                 ; preds = %bb.w, %bb.v
  ...
  br i1 %exitcond24.not.i, label %_ZN4llvm16SPIRVInstPrinter20printSymbolicOperandILNS_5SPIRV15OperandCategory15OperandCategoryE2EEEvPKNS_6MCInstEjRNS_11raw_ostreamE.exit, label %bb.u, !llvm.loop !1
...
bb.a:
  ...
  %i.g = getelementptr inbounds [32 x i8], ptr %i.d, i64 %i.f
  %i.h = getelementptr inbounds nuw i8, ptr %i.g, i64 4
  %i.i = load i16, ptr %i.h, align 4, !tbaa !89
...
bb.d:                                             ; preds = %bb.b
  ...
  store ptr %i.s, ptr %i.n, align 8, !tbaa !32
  store i8 32, ptr %i.o, align 1, !tbaa !24
  br label %_ZN4llvm11raw_ostreamlsEc.exit

_ZN4llvm11raw_ostreamlsEc.exit:                   ; preds = %bb.c, %bb.d
  %i.t = load i32, ptr %i.k, align 8, !tbaa !33   ; 3 uses
...
bb.e:                                             ; preds = %.lr.ph.i, %_ZN4llvm11raw_ostreamlsEc.exit.i
  ...
  %i.w = load ptr, ptr %i.n, align 8, !tbaa !32   ; 3 uses
  %i.x = load ptr, ptr %i.p, align 8, !tbaa !31
...
bb.g:                                             ; preds = %bb.e
  ...
  store ptr %i.z, ptr %i.n, align 8, !tbaa !32
  store i8 32, ptr %i.w, align 1, !tbaa !24
  br label %_ZN4llvm11raw_ostreamlsEc.exit.i
...
_ZN4llvm11raw_ostreamlsEc.exit.i:                 ; preds = %bb.g, %bb.f
  ...
  br i1 %exitcond24.not.i, label %_ZN4llvm16SPIRVInstPrinter25printRemainingVariableOpsEPKNS_6MCInstEjRNS_11raw_ostreamEbb.exit, label %bb.e, !llvm.loop !1
...
bb.c:                                             ; preds = %bb.a
  ...
  store ptr %i.o, ptr %i.g, align 8, !tbaa !32
  br label %_ZN4llvm11raw_ostreamlsEPKc.exit
...
bb.e:                                             ; preds = %_ZN4llvm11raw_ostreamlsEPKc.exit
  ...
  %i.z = load ptr, ptr %i.s, align 8, !tbaa !32
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 2
  store ptr %i.aa, ptr %i.s, align 8, !tbaa !32
  br label %_ZN4llvm11raw_ostreamlsEPKc.exit17
...
bb.g:                                             ; preds = %_ZN4llvm11raw_ostreamlsEPKc.exit17
  ...
  %i.am = load ptr, ptr %i.af, align 8, !tbaa !32
  %i.an = getelementptr inbounds nuw i8, ptr %i.am, i64 2
  store ptr %i.an, ptr %i.af, align 8, !tbaa !32
  br label %_ZN4llvm11raw_ostreamlsEPKc.exit20
...
_ZN4llvm11raw_ostreamlsEPKc.exit20:               ; preds = %bb.f, %bb.g
  ...
  %i.ao = load ptr, ptr %i.e, align 8, !tbaa !31
  %i.ap = load ptr, ptr %i.g, align 8, !tbaa !32  ; 2 uses
...
bb.j:                                             ; preds = %_ZN4llvm11raw_ostreamlsEPKc.exit23
  %i.bf = load i32, ptr %i.c, align 8, !tbaa !33  ; 3 uses
...
bb.k:                                             ; preds = %.lr.ph.i, %_ZN4llvm11raw_ostreamlsEc.exit.i
  ...
  %i.bi = load ptr, ptr %i.g, align 8, !tbaa !32  ; 3 uses
  %i.bj = load ptr, ptr %i.e, align 8, !tbaa !31
...
bb.m:                                             ; preds = %bb.k
  ...
  store ptr %i.bl, ptr %i.g, align 8, !tbaa !32
  store i8 32, ptr %i.bi, align 1, !tbaa !24
  br label %_ZN4llvm11raw_ostreamlsEc.exit.i
...
_ZN4llvm11raw_ostreamlsEc.exit.i:                 ; preds = %bb.m, %bb.l
  ...
  br i1 %exitcond24.not.i, label %_ZN4llvm16SPIRVInstPrinter25printRemainingVariableOpsEPKNS_6MCInstEjRNS_11raw_ostreamEbb.exit, label %bb.k, !llvm.loop !1
...
bb.a:
  store ptr getelementptr inbounds nuw inrange(-16, 48) (i8, ptr @_ZTVN4llvm16SPIRVInstPrinterE, i64 16), ptr %0, align 8, !tbaa !26
end_hunk_0
