...
_ZNK4llvm6SDNode9hasOneUseEv.exit.thread:         ; preds = %_ZN4llvm12SelectionDAG9getSelectERKNS_5SDLocENS_3EVTENS_7SDValueES5_S5_NS_11SDNodeFlagsE.exit, %_ZNK4llvm6SDNode9hasOneUseEv.exit37, %bb.d, %bb.e, %_ZL11isConstZeroRKN4llvm7SDValueE.exit.thread, %bb.a, %bb.b, %_ZL11isConstZeroRKN4llvm7SDValueE.exit34, %_ZNK4llvm6SDNode9hasOneUseEv.exit
  %.sroa.10.1 = phi i32 [ 0, %_ZL11isConstZeroRKN4llvm7SDValueE.exit.thread ], [ 0, %_ZNK4llvm6SDNode9hasOneUseEv.exit ], [ 0, %_ZL11isConstZeroRKN4llvm7SDValueE.exit34 ], [ 0, %bb.b ], [ 0, %bb.a ], [ %.fca.1.extract, %_ZN4llvm12SelectionDAG9getSelectERKNS_5SDLocENS_3EVTENS_7SDValueES5_S5_NS_11SDNodeFlagsE.exit ], [ 0, %bb.d ], [ 0, %_ZNK4llvm6SDNode9hasOneUseEv.exit37 ], [ 0, %bb.e ]
  %.sroa.050.1 = phi ptr [ null, %_ZL11isConstZeroRKN4llvm7SDValueE.exit.thread ], [ null, %_ZNK4llvm6SDNode9hasOneUseEv.exit ], [ null, %_ZL11isConstZeroRKN4llvm7SDValueE.exit34 ], [ null, %bb.b ], [ null, %bb.a ], [ %.fca.0.extract, %_ZN4llvm12SelectionDAG9getSelectERKNS_5SDLocENS_3EVTENS_7SDValueES5_S5_NS_11SDNodeFlagsE.exit ], [ null, %bb.d ], [ null, %_ZNK4llvm6SDNode9hasOneUseEv.exit37 ], [ null, %bb.e ]
