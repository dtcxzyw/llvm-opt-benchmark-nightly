...
_ZN4llvm11raw_ostreamlsEPKc.exit99:               ; preds = %bb.bh, %bb.bi
  ...
  %i.ld = load i8, ptr %i.lc, align 1, !tbaa !410
...
bb.a:
  ...
  %i.a = load ptr, ptr %1, align 8, !tbaa !47, !nonnull !22, !align !23 ; 4 uses
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !31, !noalias !420
  %i.c = getelementptr inbounds nuw i8, ptr %i.b, i64 352
  %i.d = load ptr, ptr %i.c, align 8, !noalias !420
  %i.e = tail call { i64, ptr } %i.d(ptr noundef nonnull align 8 dereferenceable(48) %i.a) #17, !noalias !420, !inline_history !413 ; 2 uses
  %i.f = extractvalue { i64, ptr } %i.e, 0        ; 3 uses
  %i.g = extractvalue { i64, ptr } %i.e, 1        ; 3 uses
  %i.h = load ptr, ptr %i.a, align 8, !tbaa !31, !noalias !420
  %i.i = getelementptr inbounds nuw i8, ptr %i.h, i64 360
  %i.j = load ptr, ptr %i.i, align 8, !noalias !420
  %i.k = tail call { i64, ptr } %i.j(ptr noundef nonnull align 8 dereferenceable(48) %i.a) #17, !noalias !420, !inline_history !413 ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph62, %_ZNK4llvm9StringRef11starts_withES0_.exit.thread52
  ...
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !31, !noalias !421
  %i.t = getelementptr inbounds nuw i8, ptr %i.s, i64 144
  %i.u = load ptr, ptr %i.t, align 8, !noalias !421
  call void %i.u(ptr dead_on_unwind nonnull writable sret(%"class.llvm::Expected.74") align 8 %6, ptr noundef nonnull align 8 dereferenceable(48) %i.r, i64 %lhsv.i.i.i.i61) #17, !inline_history !416
...
_ZNSt10unique_ptrIN4llvm13ErrorInfoBaseESt14default_deleteIS1_EED2Ev.exit.i: ; preds = %bb.b
  %i.x = load i64, ptr %6, align 8, !tbaa !71, !noalias !422
  %i.y = inttoptr i64 %i.x to ptr
  store ptr null, ptr %6, align 8, !tbaa !71, !noalias !422
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #17
  call void @llvm.lifetime.start.p0(ptr nonnull %2)
  call void @llvm.lifetime.start.p0(ptr nonnull %3)
  store ptr %i.y, ptr %3, align 8, !tbaa !73
  ...
  %i.z = load ptr, ptr %3, align 8, !tbaa !73     ; 3 uses
...
bb.d:                                             ; preds = %_ZNSt10unique_ptrIN4llvm13ErrorInfoBaseESt14default_deleteIS1_EED2Ev.exit.i
  %i.ab = load ptr, ptr %i.z, align 8, !tbaa !31
  %i.ac = getelementptr inbounds nuw i8, ptr %i.ab, i64 8
  %i.ad = load ptr, ptr %i.ac, align 8
  call void %i.ad(ptr noundef nonnull align 8 dereferenceable(8) %i.z) #17, !inline_history !0
...
bb.f:                                             ; preds = %bb.e
  %i.ag = load ptr, ptr %6, align 8, !tbaa !71    ; 3 uses
...
_ZNKSt14default_deleteIN4llvm13ErrorInfoBaseEEclEPS1_.exit.i.i: ; preds = %bb.f
  ...
  call void %i.aj(ptr noundef nonnull align 8 dereferenceable(8) %i.ag) #17, !inline_history !1
...
_ZN4llvmneENS_9StringRefES0_.exit.thread50:       ; preds = %_ZNK4llvm9StringRef11starts_withES0_.exit, %_ZN4llvmneENS_9StringRefES0_.exit
  %i.bc = load ptr, ptr %1, align 8, !tbaa !47, !nonnull !22, !align !23
  ...
  %i.be = load ptr, ptr %1, align 8, !tbaa !47, !nonnull !22, !align !23
  ...
  %i.bf = load ptr, ptr %8, align 8, !tbaa !73    ; 2 uses
...
bb.g:                                             ; preds = %_ZN4llvmneENS_9StringRefES0_.exit.thread50
  store ptr %i.bf, ptr %9, align 8, !tbaa !73
  store ptr null, ptr %8, align 8, !tbaa !73
  %i.bg = load ptr, ptr %1, align 8, !tbaa !47, !nonnull !22, !align !23
...
.lr.ph:                                           ; preds = %bb.h, %.lr.ph
  ...
  %i.bp = load ptr, ptr %1, align 8, !tbaa !47, !nonnull !22, !align !23
...
_ZNK4llvm9StringRef11starts_withES0_.exit.thread52: ; preds = %_ZN4llvmneENS_9StringRefES0_.exit, %_ZN4llvmneENS_9StringRefES0_.exit.thread, %_ZNK4llvm9StringRef11starts_withES0_.exit, %.loopexit
  %i.bu = load ptr, ptr %i.n, align 8, !tbaa !107 ; 2 uses
  %i.bv = load ptr, ptr %i.bu, align 8, !tbaa !31
  %i.bw = getelementptr inbounds nuw i8, ptr %i.bv, i64 136
  %i.bx = load ptr, ptr %i.bw, align 8
  call void %i.bx(ptr noundef nonnull align 8 dereferenceable(48) %i.bu, ptr noundef nonnull align 8 dereferenceable(16) %5) #17, !inline_history !419
  %i.by = load ptr, ptr %i.n, align 8, !tbaa !107 ; 2 uses
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !424, !nonnull !22, !align !23 ; 3 uses
  %i.c = and i64 %2, 4294967295
  %i.d = load ptr, ptr %i.b, align 8, !tbaa !61
...
bb.a:
  %i.a = inttoptr i64 %0 to ptr
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !426, !nonnull !22, !align !23 ; 2 uses
  %i.c = and i64 %2, 4294967295
  %i.d = load ptr, ptr %i.b, align 8, !tbaa !68
  %i.e = getelementptr inbounds nuw i8, ptr %i.b, i64 8
...
bb.a:
  %i.a = inttoptr i64 %0 to ptr
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !428, !nonnull !22, !align !23 ; 3 uses
  %i.c = and i64 %2, 4294967295
  %i.d = load ptr, ptr %i.b, align 8, !tbaa !149
  %i.e = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %i.f = getelementptr inbounds nuw i8, ptr %i.b, i64 12
  %i.g = load i32, ptr %i.f, align 4, !tbaa !101
  %i.h = load i32, ptr %i.e, align 8, !tbaa !101
...
bb.a:
  %i.a = inttoptr i64 %0 to ptr
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !430, !nonnull !22, !align !431
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.j = load i32, ptr %0, align 4, !tbaa !101
...
.critedge:                                        ; preds = %bb.a
  %i.l = load i64, ptr %i.c, align 8, !tbaa !151  ; 3 uses
...
_ZNK4llvm9StringRef11starts_withEc.exit.i:        ; preds = %.critedge
  %i.n = load ptr, ptr %4, align 8, !tbaa !152    ; 2 uses
...
_ZNK4llvm9StringRef11starts_withES0_.exit.i:      ; preds = %_ZNK4llvm9StringRef11starts_withEc.exit.i, %_ZN4llvm9StringRef13consume_frontEc.exit
  ...
  %.pre.i = load ptr, ptr %4, align 8, !tbaa !152 ; 2 uses
...
_ZNK4llvm9StringRef11starts_withES0_.exit.i11:    ; preds = %_ZNK4llvm9StringRef11starts_withES0_.exit.i
  %.pre.i10 = load ptr, ptr %4, align 8, !tbaa !152 ; 2 uses
...
_ZNK4llvm9StringRef11starts_withES0_.exit.i17:    ; preds = %_ZNK4llvm9StringRef11starts_withES0_.exit.i11
  %.pre.i16 = load ptr, ptr %4, align 8, !tbaa !152 ; 2 uses
...
_ZNK4llvm9StringRef11starts_withES0_.exit.i23:    ; preds = %_ZNK4llvm9StringRef11starts_withES0_.exit.i17
  %.pre.i22 = load ptr, ptr %4, align 8, !tbaa !152 ; 2 uses
