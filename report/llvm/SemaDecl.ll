...
bb.r:                                             ; preds = %bb.n
  ...
  store ptr %i.bt, ptr %i.a, align 8, !tbaa !962
  ...
  store ptr %i.bv, ptr %i.b, align 8, !tbaa !962
...
_ZNK5clang15DeclarationName14getCXXNameTypeEv.exit: ; preds = %bb.u
  ...
  %i.ci = load i64, ptr %i.ch, align 8, !tbaa !834 ; 2 uses
  %i.cj = getelementptr inbounds nuw i8, ptr %0, i64 232
  %i.ck = load ptr, ptr %i.cj, align 8, !tbaa !804, !nonnull !805, !align !806
...
bb.w:                                             ; preds = %bb.v
  %i.da = load i32, ptr %5, align 4, !tbaa !857
...
bb.x:                                             ; preds = %bb.w
  ...
  %.sroa.016.0.copyload = load i32, ptr %5, align 8, !tbaa !813
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(9) %i.dc, i8 0, i64 9, i1 false), !alias.scope !3056
  %i.dd = getelementptr inbounds nuw i8, ptr %26, i64 24 ; 2 uses
  %i.de = getelementptr inbounds nuw i8, ptr %26, i64 40 ; 4 uses
  store ptr %i.de, ptr %i.dd, align 8, !tbaa !926, !alias.scope !3056
  %i.df = getelementptr inbounds nuw i8, ptr %26, i64 32
  store i64 0, ptr %i.df, align 8, !tbaa !927, !alias.scope !3056
  store i8 0, ptr %i.de, align 8, !tbaa !834, !alias.scope !3056
  %i.dg = getelementptr inbounds nuw i8, ptr %26, i64 56
  store i8 0, ptr %i.dg, align 8, !tbaa !930, !alias.scope !3056
  store i64 %.sroa.0123.0.insert.insert, ptr %26, align 8, !alias.scope !3056
  %.sroa.22.0..sroa_idx.i.i78 = getelementptr inbounds nuw i8, ptr %26, i64 8
  store i8 1, ptr %.sroa.22.0..sroa_idx.i.i78, align 8, !tbaa !882, !alias.scope !3056
  ...
  %i.di = load ptr, ptr %i.dd, align 8, !tbaa !858 ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i79: ; preds = %bb.x
  %i.dk = load i64, ptr %i.de, align 8, !tbaa !834
  %i.dl = add i64 %i.dk, 1
...
bb.y:                                             ; preds = %_ZN5clang9FixItHintD2Ev.exit81, %bb.w, %bb.v
  ...
  %.sroa.0.0.copyload.i.i = load i64, ptr %i.dm, align 8, !tbaa !835 ; 4 uses
  %i.dn = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.do = load ptr, ptr %i.dn, align 8, !tbaa !1869
  ...
  br i1 %or.cond.i, label %.lr.ph, label %._crit_edge
...
.lr.ph:                                           ; preds = %bb.y
  ...
  %37 = and i64 %.sroa.0.0.copyload.i.i, 8
  %.not.i83192 = icmp eq i64 %37, 0
  br i1 %.not.i83192, label %bb.z, label %._crit_edge

._crit_edge:                                      ; preds = %.thread146, %bb.z, %bb.ae, %.lr.ph, %bb.y, %bb.ad, %_ZN5clang9FixItHintD2Ev.exit109, %bb.af
  call void @llvm.lifetime.end.p0(ptr nonnull %27) #28
  br label %bb.ah

bb.z:                                             ; preds = %.lr.ph, %.thread146
  %.sroa.3.0.copyload.i = phi ptr [ %i.fc, %.thread146 ], [ %35, %.lr.ph ] ; 4 uses
  %i.dy = phi ptr [ %.0.copyload.i.i.i104, %.thread146 ], [ %.0.copyload.i.i.i, %.lr.ph ] ; 3 uses
  %38 = load ptr, ptr %.sroa.3.0.copyload.i, align 8, !tbaa !856 ; 2 uses
  %39 = getelementptr inbounds nuw i8, ptr %38, i64 16
  %40 = load i8, ptr %39, align 16
  switch i8 %40, label %._crit_edge [
    i8 50, label %bb.aa
    i8 15, label %bb.ad
    i8 37, label %bb.ad
    i8 20, label %bb.ae
...
bb.aa:                                            ; preds = %bb.z
  ...
  %.sroa.0.0.copyload.i88 = load i32, ptr %i.dz, align 8, !tbaa !813 ; 2 uses
  %i.ea = getelementptr inbounds nuw i8, ptr %.sroa.3.0.copyload.i, i64 17
...
bb.ab:                                            ; preds = %bb.aa
  %i.ed = getelementptr inbounds nuw i8, ptr %.sroa.3.0.copyload.i, i64 16
...
bb.ad:                                            ; preds = %bb.z, %bb.z
  %i.ei = getelementptr inbounds nuw i8, ptr %38, i64 16
  ...
  store i8 %i.el, ptr %i.c, align 1, !tbaa !882
...
bb.ae:                                            ; preds = %bb.z
  %i.eq = getelementptr inbounds nuw i8, ptr %.sroa.3.0.copyload.i, i64 32
  %.sroa.0.0.copyload.i.i95 = load i64, ptr %i.eq, align 16, !tbaa !835 ; 4 uses
...
bb.ag:                                            ; preds = %bb.af
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(9) %i.dt, i8 0, i64 9, i1 false), !alias.scope !3057
  store ptr %i.dv, ptr %i.du, align 8, !tbaa !926, !alias.scope !3057
  store i64 0, ptr %i.dw, align 8, !tbaa !927, !alias.scope !3057
  store i8 0, ptr %i.dv, align 8, !tbaa !834, !alias.scope !3057
  store i8 0, ptr %i.dx, align 8, !tbaa !930, !alias.scope !3057
  store i64 %.sroa.0.0.insert.insert, ptr %33, align 8, !alias.scope !3057
  store i8 1, ptr %.sroa.22.0..sroa_idx.i.i106, align 8, !tbaa !882, !alias.scope !3057
  ...
  %i.ev = load ptr, ptr %i.du, align 8, !tbaa !858 ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i107: ; preds = %bb.ag
  %i.ex = load i64, ptr %i.dv, align 8, !tbaa !834
  %i.ey = add i64 %i.ex, 1
...
.thread146:                                       ; preds = %bb.ae
  %i.ez = getelementptr inbounds nuw i8, ptr %i.dy, i64 8
  %i.fa = load ptr, ptr %i.ez, align 8, !tbaa !919
  %i.fb = and i64 %.sroa.0.0.copyload.i.i95, -8
  %i.fc = inttoptr i64 %i.fb to ptr               ; 2 uses
  %.0.copyload.i.i.i104 = load ptr, ptr %i.fa, align 1 ; 2 uses
  store ptr %i.fc, ptr %27, align 8, !tbaa !920
  store ptr %.0.copyload.i.i.i104, ptr %36, align 8
  %41 = and i64 %.sroa.0.0.copyload.i.i95, 8
  %.not154 = icmp eq i64 %41, 0
  br i1 %.not154, label %bb.z, label %._crit_edge, !llvm.loop !3054
...
bb.b:                                             ; preds = %bb.a
  %i.e = load ptr, ptr %1, align 8, !tbaa !962
...
_ZN5clang16CanonicalDeclPtrIKNS_12FunctionDeclEEC2EPS2_.exit: ; preds = %bb.d, %bb.e
  ...
  %i.ao = load ptr, ptr %1, align 8, !tbaa !962
...
bb.b:                                             ; preds = %bb.a
  %.sroa.0.0.copyload.i.i = load i64, ptr %1, align 8, !tbaa !835
  %i.e = load ptr, ptr %i.a, align 8, !tbaa !820  ; 2 uses
...
_ZNK5clang19StreamingDiagnostic10getStorageEv.exit.i.i.i.i: ; preds = %bb.b
  ...
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !821
  ...
  store ptr %i.h, ptr %i.a, align 8, !tbaa !820
...
_ZNK5clang8SemaBase20ImmediateDiagBuilderlsINS_19NestedNameSpecifierEvEERKS1_OT_.exit: ; preds = %bb.b, %_ZNK5clang19StreamingDiagnostic10getStorageEv.exit.i.i.i.i
  ...
  %i.k = load i8, ptr %i.i, align 8, !tbaa !833
  %i.l = zext i8 %i.k to i64
  %i.m = getelementptr inbounds nuw i8, ptr %i.j, i64 %i.l
  store i8 11, ptr %i.m, align 1, !tbaa !834
  %i.n = load ptr, ptr %i.a, align 8, !tbaa !820  ; 3 uses
  %i.o = getelementptr inbounds nuw i8, ptr %i.n, i64 16
  %i.p = load i8, ptr %i.n, align 8, !tbaa !833   ; 2 uses
  %i.q = add i8 %i.p, 1
  store i8 %i.q, ptr %i.n, align 8, !tbaa !833
  %i.r = zext i8 %i.p to i64
  %i.s = getelementptr inbounds nuw [8 x i8], ptr %i.o, i64 %i.r
  store i64 %.sroa.0.0.copyload.i.i, ptr %i.s, align 8, !tbaa !835
  br label %bb.f

bb.c:                                             ; preds = %bb.a
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 128
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 132
  %i.v = load i8, ptr %i.u, align 4, !tbaa !837, !range !816, !noundef !805
