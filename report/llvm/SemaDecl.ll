...
bb.y:                                             ; preds = %_ZN5clang9FixItHintD2Ev.exit81, %bb.w, %bb.v
  ...
  %.sroa.0.0.copyload.i.i = load i64, ptr %i.dm, align 8, !tbaa !728 ; 4 uses
...
bb.z:                                             ; preds = %.lr.ph, %.thread146
  ...
  %38 = load ptr, ptr %.sroa.3.0.copyload.i, align 8, !tbaa !748 ; 2 uses
...
bb.ae:                                            ; preds = %bb.z
  ...
  %.sroa.0.0.copyload.i.i95 = load i64, ptr %i.eq, align 16, !tbaa !728 ; 4 uses
...
.thread146:                                       ; preds = %bb.ae
  ...
  br i1 %.not154, label %bb.z, label %._crit_edge, !llvm.loop !2508
