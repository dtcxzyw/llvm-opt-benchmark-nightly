...
_ZN4llvm23SmallVectorTemplateBaseIPN5clang9NamedDeclELb1EE9push_backES3_.exit: ; preds = %bb.a, %bb.b, %bb.c
  ...
  %.sroa.0.0.copyload.i.i = load i64, ptr %i.j, align 8
  ...
  %i.ax = call noundef ptr @_ZN5clang9FieldDecl6CreateERKNS_10ASTContextEPNS_11DeclContextENS_14SourceLocationES6_PKNS_14IdentifierInfoENS_8QualTypeEPNS_14TypeSourceInfoEPNS_4ExprEbNS_16InClassInitStyleE(ptr noundef nonnull align 8 dereferenceable(23904) %i.aw, ptr noundef %i.ar, i32 %.sroa.0.0.copyload.i.i22, i32 %.sroa.0.0.copyload.i.i22, ptr noundef null, i64 %i.av, ptr noundef %i.ap, ptr noundef null, i1 noundef zeroext false, i32 noundef 0) #28 ; 6 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !1925 ; 5 uses
