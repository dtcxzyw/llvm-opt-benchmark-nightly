...
bb.y:                                             ; preds = %_ZN5clang9FixItHintD2Ev.exit81, %bb.w, %bb.v
  ...
  %.sroa.0.0.copyload.i.i = load i64, ptr %i.dm, align 8, !tbaa !835 ; 3 uses
...
_ZNK5clang7TypeLoc15getTypeLocClassEv.exit:       ; preds = %bb.z
  %39 = load ptr, ptr %i.dy, align 8, !tbaa !856  ; 2 uses
...
bb.ae:                                            ; preds = %_ZNK5clang7TypeLoc15getTypeLocClassEv.exit
  ...
  %.sroa.0.0.copyload.i.i95 = load i64, ptr %i.eq, align 16, !tbaa !835 ; 3 uses
...
.thread146:                                       ; preds = %bb.ae
  ...
  br i1 %.not154, label %._crit_edge, label %bb.z, !llvm.loop !3054
