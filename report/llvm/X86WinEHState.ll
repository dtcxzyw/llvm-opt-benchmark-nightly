...
bb.aj:                                            ; preds = %bb.ai, %bb.ah
  ...
  br i1 %.not524578.i, label %._crit_edge604.thread.i, label %.lr.ph581.i

.lr.ph581.i:                                      ; preds = %bb.aj
...
.preheader.i:                                     ; preds = %_ZNSt5dequeIPN4llvm10BasicBlockESaIS2_EE9push_backERKS2_.exit.i
  %.pre662.i = load ptr, ptr %i.wg, align 8, !tbaa !279
  %.pre663.i = load ptr, ptr %i.vu, align 8, !tbaa !279 ; 2 uses
  %i.xb = icmp eq ptr %.pre662.i, %.pre663.i
  br i1 %i.xb, label %._crit_edge587.i, label %.lr.ph586.i.a

.lr.ph586.i.a:                                    ; preds = %.preheader.i
...
bb.ak:                                            ; preds = %_ZNSt5dequeIPN4llvm10BasicBlockESaIS2_EE9push_backERKS2_.exit.i, %.lr.ph581.i
  %.sroa.0475.0579.i = phi ptr [ %i.wn, %.lr.ph581.i ], [ %i.xi, %_ZNSt5dequeIPN4llvm10BasicBlockESaIS2_EE9push_backERKS2_.exit.i ]
  %.0503579.i = phi i32 [ undef, %.lr.ph581.i ], [ %.1505.lcssa.i, %_ZNSt5dequeIPN4llvm10BasicBlockESaIS2_EE9push_backERKS2_.exit.i ]
  call void @llvm.lifetime.start.p0(ptr nonnull %i.m) #18
  %i.xi = getelementptr inbounds i8, ptr %.sroa.0475.0579.i, i64 -8 ; 3 uses
...
bb.am:                                            ; preds = %bb.al, %bb.ak
  %.0504.i = phi i32 [ %i.xn, %bb.al ], [ %.0503579.i, %bb.ak ] ; 2 uses
  %.0503.i = phi i32 [ %i.xn, %bb.al ], [ -2147483648, %bb.ak ] ; 2 uses
  ...
  br i1 %.not532571.i, label %._crit_edge.i, label %.lr.ph.i21

._crit_edge.i:                                    ; preds = %_ZN4llvm8dyn_castINS_8CallBaseENS_11InstructionEEEDcPT0_.exit.thread.i, %bb.am
  %.1505.lcssa.i = phi i32 [ %.0504.i, %bb.am ], [ %.2506.i, %_ZN4llvm8dyn_castINS_8CallBaseENS_11InstructionEEEDcPT0_.exit.thread.i ] ; 2 uses
  %.1.lcssa.i = phi i32 [ %.0503.i, %bb.am ], [ %.3.i, %_ZN4llvm8dyn_castINS_8CallBaseENS_11InstructionEEEDcPT0_.exit.thread.i ] ; 2 uses
  %i.xq = icmp eq i32 %.1.lcssa.i, -2147483648
  br i1 %i.xq, label %bb.bn, label %bb.bq

.lr.ph.i21:                                       ; preds = %bb.am, %_ZN4llvm8dyn_castINS_8CallBaseENS_11InstructionEEEDcPT0_.exit.thread.i
  ...
  %.1573.i = phi i32 [ %.3.i, %_ZN4llvm8dyn_castINS_8CallBaseENS_11InstructionEEEDcPT0_.exit.thread.i ], [ %.0503.i, %bb.am ] ; 6 uses
  %.1505572.i = phi i32 [ %.2506.i, %_ZN4llvm8dyn_castINS_8CallBaseENS_11InstructionEEEDcPT0_.exit.thread.i ], [ %.0504.i, %bb.am ] ; 4 uses
...
_ZN4llvm8dyn_castINS_8CallBaseENS_11InstructionEEEDcPT0_.exit.i: ; preds = %.lr.ph.i21, %.lr.ph.i21, %.lr.ph.i21
...
_ZNK4llvm8CallBase17getCalledFunctionEv.exit.i.i.i.i: ; preds = %_ZN4llvm16dyn_cast_or_nullINS_8FunctionENS_5ValueEEEDaPT0_.exit.i.i.i.i.i
  ...
  %.not.i.i.i.i32 = icmp eq i32 %i.yd, 0
  br i1 %.not.i.i.i.i32, label %_ZL13isSehScopeEndRKN4llvm8CallBaseE.exit.thread.i.i, label %_ZL15isSehScopeBeginRKN4llvm8CallBaseE.exit.i.i
...
_ZL15isSehScopeBeginRKN4llvm8CallBaseE.exit.i.i:  ; preds = %_ZNK4llvm8CallBase17getCalledFunctionEv.exit.i.i.i.i
  ...
  %i.yg = and i32 %i.yf, -2
  %switch.i33 = icmp eq i32 %i.yg, 340
  br i1 %switch.i33, label %_ZN12_GLOBAL__N_120WinEHStateFnPassImpl18isStateStoreNeededEN4llvm13EHPersonalityERNS1_8CallBaseE.exit.thread.i, label %_ZL13isSehScopeEndRKN4llvm8CallBaseE.exit.thread.i.i
...
bb.ar:                                            ; preds = %_ZL13isSehScopeEndRKN4llvm8CallBaseE.exit.i147.i
  ...
  %.fca.0.extract.i.i61 = extractvalue { ptr, i8 } %i.za, 0
  %i.zb = getelementptr inbounds nuw i8, ptr %.fca.0.extract.i.i61, i64 8
  %.0.copyload.i.i.i.i.i.i.i62 = load i64, ptr %i.zb, align 8 ; 3 uses
  %i.zc = and i64 %.0.copyload.i.i.i.i.i.i.i62, 4
  %i.zd = icmp eq i64 %i.zc, 0
  br i1 %i.zd, label %bb.as, label %bb.at

bb.as:                                            ; preds = %bb.ar
  %i.ze = inttoptr i64 %.0.copyload.i.i.i.i.i.i.i62 to ptr
  br label %_ZNK4llvm13TinyPtrVectorIPNS_10BasicBlockEE5frontEv.exit.i63

bb.at:                                            ; preds = %bb.ar
  %i.zf = and i64 %.0.copyload.i.i.i.i.i.i.i62, -5
  %i.zg = inttoptr i64 %i.zf to ptr
  %i.zh = load ptr, ptr %i.zg, align 8, !tbaa !258
  %i.zi = load ptr, ptr %i.zh, align 8, !tbaa !280
  br label %_ZNK4llvm13TinyPtrVectorIPNS_10BasicBlockEE5frontEv.exit.i63

_ZNK4llvm13TinyPtrVectorIPNS_10BasicBlockEE5frontEv.exit.i63: ; preds = %bb.at, %bb.as
  %.0.i.i64 = phi ptr [ %i.ze, %bb.as ], [ %i.zi, %bb.at ]
  %i.zj = call { ptr, i64 } @_ZNK4llvm10BasicBlock16getFirstNonPHIItEv(ptr noundef nonnull align 8 dereferenceable(80) %.0.i.i64) #18
  %.fca.0.extract.i65 = extractvalue { ptr, i64 } %i.zj, 0
  %i.zk = getelementptr inbounds i8, ptr %.fca.0.extract.i65, i64 -24 ; 3 uses
  %i.zl = load i8, ptr %i.zk, align 8, !tbaa !54
  %i.zm = add i8 %i.zl, -85
  %i.zn = icmp ult i8 %i.zm, -2                   ; 2 uses
  %spec.select.i.i.i.i66 = select i1 %i.zn, ptr null, ptr %i.zk
  br i1 %i.zn, label %_ZN12_GLOBAL__N_120WinEHStateFnPassImpl17getBaseStateForBBERN4llvm8DenseMapIPNS1_10BasicBlockENS1_13TinyPtrVectorIS4_EENS1_12DenseMapInfoIS4_vEENS1_6detail12DenseMapPairIS4_S6_EEEERNS1_13WinEHFuncInfoES4_.exit77, label %bb.au

bb.au:                                            ; preds = %_ZNK4llvm13TinyPtrVectorIPNS_10BasicBlockEE5frontEv.exit.i63
  ...
  br i1 %i.zr, label %.loopexit.i.i.i67, label %bb.av
...
bb.av:                                            ; preds = %bb.au
  ...
  br i1 %i.aaf, label %.lr.ph.i.i.i.i.i73, label %.loopexit.i.i.i67, !prof !303

.lr.ph.i.i.i.i.i73:                               ; preds = %bb.av, %bb.aw
  %i.aag = phi i64 [ %i.aam, %bb.aw ], [ %i.zz, %bb.av ]
  %.017.i.i.i.i.i74 = phi i32 [ %i.aal, %bb.aw ], [ %i.zy, %bb.av ]
  %i.aah = getelementptr inbounds nuw [16 x i8], ptr %i.zo, i64 %i.aag ; 2 uses
  %i.aai = load ptr, ptr %i.aah, align 8, !tbaa !304, !noalias !302
  %i.aaj = icmp eq ptr %spec.select.i.i.i.i66, %i.aai
  br i1 %i.aaj, label %_ZN4llvm12DenseMapBaseINS_8DenseMapIPKNS_14FuncletPadInstEiNS_12DenseMapInfoIS4_vEENS_6detail12DenseMapPairIS4_iEEEES4_iS6_S9_E4findES4_.exit.loopexit.i75, label %bb.aw, !prof !306

bb.aw:                                            ; preds = %.lr.ph.i.i.i.i.i73
  %i.aak = add nuw i32 %.017.i.i.i.i.i74, 1
  ...
  br i1 %i.aas, label %.lr.ph.i.i.i.i.i73, label %.loopexit.i.i.i67, !prof !307

.loopexit.i.i.i67:                                ; preds = %bb.aw, %bb.av, %bb.au
  %i.aat = zext i32 %i.zq to i64                  ; 2 uses
  %i.aau = getelementptr inbounds nuw [16 x i8], ptr %i.zo, i64 %i.aat
  br label %_ZN4llvm12DenseMapBaseINS_8DenseMapIPKNS_14FuncletPadInstEiNS_12DenseMapInfoIS4_vEENS_6detail12DenseMapPairIS4_iEEEES4_iS6_S9_E4findES4_.exit.i68

_ZN4llvm12DenseMapBaseINS_8DenseMapIPKNS_14FuncletPadInstEiNS_12DenseMapInfoIS4_vEENS_6detail12DenseMapPairIS4_iEEEES4_iS6_S9_E4findES4_.exit.loopexit.i75: ; preds = %.lr.ph.i.i.i.i.i73
  %.pre.i76 = zext i32 %i.zq to i64
  br label %_ZN4llvm12DenseMapBaseINS_8DenseMapIPKNS_14FuncletPadInstEiNS_12DenseMapInfoIS4_vEENS_6detail12DenseMapPairIS4_iEEEES4_iS6_S9_E4findES4_.exit.i68

_ZN4llvm12DenseMapBaseINS_8DenseMapIPKNS_14FuncletPadInstEiNS_12DenseMapInfoIS4_vEENS_6detail12DenseMapPairIS4_iEEEES4_iS6_S9_E4findES4_.exit.i68: ; preds = %_ZN4llvm12DenseMapBaseINS_8DenseMapIPKNS_14FuncletPadInstEiNS_12DenseMapInfoIS4_vEENS_6detail12DenseMapPairIS4_iEEEES4_iS6_S9_E4findES4_.exit.loopexit.i75, %.loopexit.i.i.i67
  %.pre-phi.i69 = phi i64 [ %.pre.i76, %_ZN4llvm12DenseMapBaseINS_8DenseMapIPKNS_14FuncletPadInstEiNS_12DenseMapInfoIS4_vEENS_6detail12DenseMapPairIS4_iEEEES4_iS6_S9_E4findES4_.exit.loopexit.i75 ], [ %i.aat, %.loopexit.i.i.i67 ]
  %.lcssa.sink.i.i.i70 = phi ptr [ %i.aah, %_ZN4llvm12DenseMapBaseINS_8DenseMapIPKNS_14FuncletPadInstEiNS_12DenseMapInfoIS4_vEENS_6detail12DenseMapPairIS4_iEEEES4_iS6_S9_E4findES4_.exit.loopexit.i75 ], [ %i.aau, %.loopexit.i.i.i67 ] ; 2 uses
  %i.aav = getelementptr inbounds nuw [16 x i8], ptr %i.zo, i64 %.pre-phi.i69
  %.not.i71 = icmp eq ptr %.lcssa.sink.i.i.i70, %i.aav
  br i1 %.not.i71, label %_ZN12_GLOBAL__N_120WinEHStateFnPassImpl17getBaseStateForBBERN4llvm8DenseMapIPNS1_10BasicBlockENS1_13TinyPtrVectorIS4_EENS1_12DenseMapInfoIS4_vEENS1_6detail12DenseMapPairIS4_S6_EEEERNS1_13WinEHFuncInfoES4_.exit77, label %bb.ax
