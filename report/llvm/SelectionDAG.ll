...
.critedge482.thread:                              ; preds = %bb.dl, %_ZN4llvm8dyn_castINS_14ConstantSDNodeENS_7SDValueEEEDcRT0_.exit619, %.split902, %_ZNK4llvm3EVT19isFixedLengthVectorEv.exit600
...
bb.s:                                             ; preds = %.lr.ph220
  ...
  br i1 %.not61, label %bb.t, label %11
...
select.unfold:                                    ; preds = %bb.t, %11
  %.sroa.21.1.ph.in.a = phi ptr [ %.sroa.6132.0..sroa_idx, %11 ], [ %.sroa.6136.0..sroa_idx, %bb.t ]
  %.sroa.0144.1.ph = phi ptr [ %.sroa.0130.0.copyload, %11 ], [ %.sroa.0134.0.copyload, %bb.t ] ; 4 uses
  %.056.ph = phi ptr [ %.sroa.0134.0.copyload, %11 ], [ %.sroa.0130.0.copyload, %bb.t ] ; 2 uses
  %.sroa.21.1.ph.in = load i64, ptr %.sroa.21.1.ph.in.a, align 8
  %.sroa.21.1.ph = trunc i64 %.sroa.21.1.ph.in to i32 ; 3 uses
...
.thread61:                                        ; preds = %bb.az, %bb.h
  %i.et = phi i8 [ %i.ap, %bb.h ], [ %i.eo, %bb.az ] ; 2 uses
  %.366 = phi i32 [ %.02773, %bb.h ], [ %.2, %bb.az ] ; 2 uses
  %.33165 = phi i32 [ %.02871, %bb.h ], [ %.230, %bb.az ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
