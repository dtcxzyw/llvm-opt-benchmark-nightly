...
bb.a:
  ...
  %i.f = load i16, ptr %i.e, align 2, !tbaa !17
  %i.g = lshr i16 %i.f, 4
...
bb.a:
  ...
  %i.b = load i16, ptr %i.a, align 2, !tbaa !17
  %i.c = lshr i16 %i.b, 4
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.j = getelementptr inbounds nuw i8, ptr %i.i, i64 2160
  %i.k = load ptr, ptr %i.j, align 8
  %i.l = tail call noundef i32 %i.k(ptr noundef nonnull align 8 dereferenceable(48) %0) #10, !inline_history !74
  br label %_ZNK4llvm15AMDGPUSubtarget27getDefaultFlatWorkGroupSizeEj.exit
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.p = load i32, ptr %i.o, align 8, !tbaa !24   ; 5 uses
...
begin_hunk_1_@_ZNK4llvm15AMDGPUSubtarget30getOccupancyWithWorkGroupSizesEjSt4pairIjjE:bb.a
  ...
  %i.af = load ptr, ptr %0, align 8, !tbaa !19, !noalias !82
  %i.ag = getelementptr inbounds nuw i8, ptr %i.af, i64 2144
  %i.ah = load ptr, ptr %i.ag, align 8, !noalias !82
  %i.ai = tail call noundef i32 %i.ah(ptr noundef nonnull align 8 dereferenceable(48) %0, i32 noundef %.sroa.4.0.extract.trunc) #10, !noalias !82, !inline_history !77
...
bb.a:
  ...
  %i.e = load ptr, ptr %1, align 8, !tbaa !201, !nonnull !32, !align !33 ; 2 uses
  %i.f = getelementptr inbounds nuw i8, ptr %i.e, i64 2
  %i.g = load i16, ptr %i.f, align 2, !tbaa !17
  %i.h = lshr i16 %i.g, 4
...
bb.b:                                             ; preds = %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a
  ...
  %i.k = load i8, ptr %i.j, align 8, !tbaa !12
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.q = tail call noundef i32 %i.p(ptr noundef nonnull align 8 dereferenceable(48) %0) #10, !inline_history !83
  br label %_ZNK4llvm15AMDGPUSubtarget27getDefaultFlatWorkGroupSizeEj.exit.i.i
...
bb.d:                                             ; preds = %_ZNK4llvm15AMDGPUSubtarget27getDefaultFlatWorkGroupSizeEj.exit.i.i
  ...
  %i.v = load ptr, ptr %i.u, align 8
  %i.w = tail call noundef i32 %i.v(ptr noundef nonnull align 8 dereferenceable(48) %0) #10, !inline_history !84
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ab = tail call noundef i32 %i.aa(ptr noundef nonnull align 8 dereferenceable(48) %0) #10, !inline_history !84
...
bb.a:
  %.sroa.021 = alloca i64, align 8                ; 3 uses
  %.sroa.07 = alloca i64, align 8                 ; 6 uses
  store i64 %1, ptr %.sroa.021, align 8
  ...
  %.4..4..4..sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.07, i64 4
  store i32 %.sroa.3.0.extract.trunc, ptr %.4..4..4..sroa_idx, align 4, !tbaa !35
  %i.f = tail call i32 @llvm.umin.i32(i32 %i.d, i32 %.sroa.3.0.extract.trunc) ; 2 uses
  store i32 %i.f, ptr %.sroa.07, align 8, !tbaa !36
...
bb.c:                                             ; preds = %bb.b
  ...
  %.4..4..4..sroa_idx26 = getelementptr inbounds nuw i8, ptr %.sroa.021, i64 4
  store i32 %i.q, ptr %.4..4..4..sroa_idx26, align 4, !tbaa !35
  br label %bb.d

bb.d:                                             ; preds = %bb.a, %bb.b, %bb.c
  %.sroa.02.0.in = phi ptr [ %.sroa.021, %bb.c ], [ %.sroa.07, %bb.b ], [ %.sroa.07, %bb.a ]
...
bb.a:
  %.sroa.021.i.i = alloca i64, align 8            ; 5 uses
  %.sroa.07.i.i = alloca i64, align 8             ; 6 uses
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 2
  %i.b = load i16, ptr %i.a, align 2, !tbaa !17
  %i.c = lshr i16 %i.b, 4
  %i.d = and i16 %i.c, 1023
...
_ZNK4llvm15AMDGPUSubtarget21getFlatWorkGroupSizesERKNS_8FunctionE.exit: ; preds = %_ZNK4llvm15AMDGPUSubtarget27getDefaultFlatWorkGroupSizeEj.exit.i, %bb.d, %bb.e
  ...
  %i.ac = load i32, ptr %i.ab, align 8, !tbaa !24
  ...
  store i64 %i.ad, ptr %.sroa.021.i.i, align 8
  ...
  %i.ae = load ptr, ptr %0, align 8, !tbaa !19
  %i.af = getelementptr inbounds nuw i8, ptr %i.ae, i64 2168
  %i.ag = load ptr, ptr %i.af, align 8
  %i.ah = tail call noundef i32 %i.ag(ptr noundef nonnull align 8 dereferenceable(48) %0, i32 noundef %.sroa.2.0.extract.trunc.i.i) #10, !inline_history !202
  ...
  %.4..4..4..4..4..4..4..sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.07.i.i, i64 4
  store i32 %.sroa.3.0.extract.trunc.i.i, ptr %.4..4..4..4..4..4..4..sroa_idx, align 4, !tbaa !35
  %i.aj = tail call i32 @llvm.umin.i32(i32 %i.ah, i32 %.sroa.3.0.extract.trunc.i.i) ; 2 uses
  store i32 %i.aj, ptr %.sroa.07.i.i, align 8, !tbaa !36
...
bb.f:                                             ; preds = %_ZNK4llvm15AMDGPUSubtarget21getFlatWorkGroupSizesERKNS_8FunctionE.exit
  %i.aq = load i32, ptr %i.ab, align 8, !tbaa !24
...
bb.g:                                             ; preds = %bb.f
  ...
  %.4..4..4..4..4..4..4..sroa_idx12 = getelementptr inbounds nuw i8, ptr %.sroa.021.i.i, i64 4
  store i32 %i.at, ptr %.4..4..4..4..4..4..4..sroa_idx12, align 4, !tbaa !35
...
_ZNK4llvm15AMDGPUSubtarget13getWavesPerEUESt4pairIjjEjRKNS_8FunctionE.exit: ; preds = %_ZNK4llvm15AMDGPUSubtarget21getFlatWorkGroupSizesERKNS_8FunctionE.exit, %bb.f, %bb.g
  %.sroa.02.0.in.i.i = phi ptr [ %.sroa.021.i.i, %bb.g ], [ %.sroa.07.i.i, %bb.f ], [ %.sroa.07.i.i, %_ZNK4llvm15AMDGPUSubtarget21getFlatWorkGroupSizesERKNS_8FunctionE.exit ]
...
bb.a:
  %.sroa.021.i = alloca i64, align 8              ; 5 uses
  %.sroa.07.i = alloca i64, align 8               ; 6 uses
  ...
  store i64 %i.c, ptr %.sroa.021.i, align 8
  ...
  %i.g = tail call noundef i32 %i.f(ptr noundef nonnull align 8 dereferenceable(48) %0, i32 noundef %.sroa.2.0.extract.trunc.i) #10, !inline_history !203
  ...
  %.4..4..4..4..4..sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.07.i, i64 4
  store i32 %.sroa.3.0.extract.trunc.i, ptr %.4..4..4..4..4..sroa_idx, align 4, !tbaa !35
  %i.i = tail call i32 @llvm.umin.i32(i32 %i.g, i32 %.sroa.3.0.extract.trunc.i) ; 2 uses
  store i32 %i.i, ptr %.sroa.07.i, align 8, !tbaa !36
...
bb.c:                                             ; preds = %bb.b
  ...
  %.4..4..4..4..4..sroa_idx11 = getelementptr inbounds nuw i8, ptr %.sroa.021.i, i64 4
  store i32 %i.s, ptr %.4..4..4..4..4..sroa_idx11, align 4, !tbaa !35
...
_ZNK4llvm15AMDGPUSubtarget22getEffectiveWavesPerEUESt4pairIjjES2_j.exit: ; preds = %bb.a, %bb.b, %bb.c
  %.sroa.02.0.in.i = phi ptr [ %.sroa.021.i, %bb.c ], [ %.sroa.07.i, %bb.b ], [ %.sroa.07.i, %bb.a ]
...
_ZNK4llvm6MDNode10getOperandEj.exit:              ; preds = %.thread, %bb.c
  ...
  %.0.i.i5 = load i64, ptr %spec.select.i.i, align 8, !tbaa !58
...
_ZNK4llvm6MDNode10getOperandEj.exit:              ; preds = %.thread, %bb.c
  ...
  %i.p = load ptr, ptr %.sroa.0.0.i.i, align 8, !tbaa !48
  ...
  %.0.i.i19 = load i64, ptr %spec.select.i.i, align 8, !tbaa !58
...
_ZNK4llvm6MDNode10getOperandEj.exit22:            ; preds = %bb.d, %bb.e
  ...
  %.0.i.i24 = load i64, ptr %spec.select.i.i23, align 8, !tbaa !58
...
_ZNK4llvm6MDNode10getOperandEj.exit27:            ; preds = %bb.f, %bb.g
  ...
  %i.aw = load ptr, ptr %i.av, align 8, !tbaa !55 ; 2 uses
  ...
  %.0.i.i29 = load i64, ptr %spec.select.i.i28, align 8, !tbaa !58
...
bb.h:                                             ; preds = %_ZN4llvm13isPowerOf2_32Ej.exit
  ...
  %i.bi = load i8, ptr %i.bh, align 8, !tbaa !12
