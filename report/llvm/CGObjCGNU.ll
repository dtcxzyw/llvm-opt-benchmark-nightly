...
.lr.ph221:                                        ; preds = %bb.aa, %bb.ai
  ...
  %i.ir = load ptr, ptr %.057219, align 8, !tbaa !2134 ; 2 uses
...
bb.ak:                                            ; preds = %bb.aj
  %i.jf = call noundef zeroext i1 %i.je(ptr noundef nonnull align 8 dereferenceable(32) %8, ptr noundef nonnull align 8 dereferenceable(32) %8, i32 noundef 3) #24, !inline_history !2126 ; 0 uses
...
bb.a:
  ...
  store ptr %15, ptr %16, align 8, !tbaa !525, !alias.scope !2139
  %i.as = getelementptr inbounds nuw i8, ptr %16, i64 8
  %i.at = getelementptr inbounds nuw i8, ptr %16, i64 40
  store i64 0, ptr %i.at, align 8, !tbaa !527, !alias.scope !2139
  ...
  store i8 1, ptr %i.au, align 8, !tbaa !539, !noalias !2139
  %i.av = getelementptr inbounds nuw i8, ptr %16, i64 48 ; 2 uses
  store ptr %i.ak, ptr %i.av, align 8, !tbaa !544, !alias.scope !2139
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.ax = load i32, ptr %i.aw, align 8, !noalias !2139
  %i.ay = getelementptr inbounds nuw i8, ptr %16, i64 34
  %i.az = lshr i32 %i.ax, 9
  %i.ba = trunc i32 %i.az to i8
  %i.bb = and i8 %i.ba, 1
  store i8 %i.bb, ptr %i.ay, align 2, !tbaa !1320, !alias.scope !2139
