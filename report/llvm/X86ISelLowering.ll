...
vector.body:                                      ; preds = %pred.store.continue668, %vector.ph
  ...
  %i.ka = select <4 x i1> %i.jz, <4 x i1> %i.jj, <4 x i1> zeroinitializer
  %i.kb = select <4 x i1> %i.jx, <4 x i1> %i.ja, <4 x i1> %i.ka ; 2 uses
  %i.kc = select <4 x i1> %i.jy, <4 x i1> %i.jd, <4 x i1> zeroinitializer
  %i.kd = select <4 x i1> %i.jw, <4 x i1> %i.iu, <4 x i1> %i.kc
  %i.ke = or <4 x i1> %i.kd, %i.kb                ; 4 uses
  %i.kf = zext <4 x i1> %i.kb to <4 x i32>
