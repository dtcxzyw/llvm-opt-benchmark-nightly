...
bb.i:                                             ; preds = %_ZNK4llvm3EVT16isScalableVectorEv.exit.i
  %i.av = call noundef i32 @_ZNK4llvm3EVT28getExtendedVectorNumElementsEv(ptr noundef nonnull align 8 dereferenceable(16) %12) #39
  br label %_ZNK4llvm3EVT20getVectorNumElementsEv.exit

_ZNK4llvm3EVT20getVectorNumElementsEv.exit:       ; preds = %_ZNK4llvm3MVT20getVectorNumElementsEv.exit.i, %bb.i
  %i.aw = phi i32 [ %i.au, %_ZNK4llvm3MVT20getVectorNumElementsEv.exit.i ], [ %i.av, %bb.i ]
  store i32 %i.aw, ptr %i.b, align 4, !tbaa !241
  %i.ax = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.ay = load ptr, ptr %i.ax, align 8, !tbaa !685 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %13) #38
  %i.az = getelementptr inbounds nuw i8, ptr %0, i64 72
  %i.ba = load i64, ptr %i.az, align 8, !tbaa !674
  store i64 %i.ba, ptr %13, align 8, !tbaa !674
  %i.bb = getelementptr inbounds nuw i8, ptr %13, i64 8
  %i.bc = getelementptr inbounds nuw i8, ptr %0, i64 68
  %i.bd = load i32, ptr %i.bc, align 4, !tbaa !675
  store i32 %i.bd, ptr %i.bb, align 8, !tbaa !677
  %i.be = getelementptr inbounds nuw i8, ptr %3, i64 360 ; 3 uses
  %i.bf = load i32, ptr %i.be, align 8, !tbaa !343
  %or.cond991 = icmp ne i32 %i.bf, 7
  %brmerge = or i1 %.not.i, %or.cond991
  br i1 %brmerge, label %_ZNK4llvm18TargetLoweringBase11isTypeLegalENS_3EVTE.exit.thread, label %_ZNK4llvm18TargetLoweringBase11isTypeLegalENS_3EVTE.exit

_ZNK4llvm18TargetLoweringBase11isTypeLegalENS_3EVTE.exit: ; preds = %_ZNK4llvm3EVT20getVectorNumElementsEv.exit
  %i.bg = getelementptr inbounds nuw i8, ptr %i.ay, i64 112
...
_ZNK4llvm3MVT20getVectorNumElementsEv.exit.i704:  ; preds = %bb.q
  ...
  %i.ee = load i16, ptr %i.ed, align 2, !tbaa !340 ; 5 uses
...
_ZNK4llvm3MVT20getVectorNumElementsEv.exit98.i:   ; preds = %_ZNK4llvm3MVT20getVectorNumElementsEv.exit.i704
  ...
  %i.ek = load i16, ptr %i.ej, align 2, !tbaa !340 ; 4 uses
