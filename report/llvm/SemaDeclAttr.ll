...
bb.k:                                             ; preds = %bb.j
  ...
  %i.ag = load i32, ptr %i.af, align 8, !tbaa !900
  %i.ah = load ptr, ptr %i.ae, align 8, !tbaa !899 ; 3 uses
  %i.ai = getelementptr inbounds nuw i8, ptr %i.ah, i64 12
  %i.aj = load i32, ptr %i.ai, align 4, !tbaa !904 ; 2 uses
  %.not12.i.i.i.i.i.i.i.i = icmp eq i32 %i.ag, %i.aj
  br i1 %.not12.i.i.i.i.i.i.i.i, label %bb.m, label %bb.l

bb.l:                                             ; preds = %bb.k
  store i32 %i.aj, ptr %i.af, align 8, !tbaa !900
  %i.ak = load ptr, ptr %i.ah, align 8, !tbaa !113
  %i.al = getelementptr i8, ptr %i.ak, i64 152, !nosanitize !79
  %i.am = load ptr, ptr %i.al, align 8, !nosanitize !79
  tail call void %i.am(ptr noundef nonnull align 8 dereferenceable(16) %i.ah, ptr noundef nonnull %i.d) #23, !inline_history !16
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %bb.k, %bb.j, %bb.c
  %i.an = load ptr, ptr %i.a, align 8, !tbaa !918 ; 2 uses
...
_ZL13normalizeNameRN4llvm9StringRefE.exit:        ; preds = %bb.a, %_ZNK4llvm9StringRef11starts_withES0_.exit.i, %_ZNK4llvm9StringRef9ends_withES0_.exit.i, %_ZNK4llvm9StringRef9ends_withES0_.exit.thread.i
  %.sroa.10.0 = phi i64 [ %i.y, %_ZNK4llvm9StringRef9ends_withES0_.exit.thread.i ], [ %i.l, %_ZNK4llvm9StringRef9ends_withES0_.exit.i ], [ %i.l, %_ZNK4llvm9StringRef11starts_withES0_.exit.i ], [ %i.l, %bb.a ] ; 5 uses
...
bb.c:                                             ; preds = %.critedge.thread, %.critedge
  ...
  %i.aj = phi i64 [ %.sroa.10.0, %.critedge.thread ], [ %i.af, %.critedge ] ; 2 uses
  ...
  store i64 %.0233, ptr %i.al, align 8
...
bb.f:                                             ; preds = %.split, %_ZNK4llvm5APInt10isPowerOf2Ev.exit
  %i.as = getelementptr inbounds nuw i8, ptr %.sroa.0170.0, i64 %i.aj
  %i.at = sub nuw i64 %.sroa.10.0, %i.aj
...
bb.s:                                             ; preds = %bb.r, %_ZNK5clang8EnumDecl14getIntegerTypeEv.exit.thread, %_ZNK5clang8EnumDecl14getIntegerTypeEv.exit, %bb.l
  %.sroa.0165.0 = phi i64 [ %.sroa.0.0.copyload.i104, %bb.r ], [ %.sroa.0.0.copyload.i, %_ZNK5clang8EnumDecl14getIntegerTypeEv.exit.thread ], [ %.sroa.06.1.i.in, %_ZNK5clang8EnumDecl14getIntegerTypeEv.exit ], [ %.sroa.0.0.i, %bb.l ] ; 3 uses
  %i.co = and i64 %.sroa.0165.0, -16
  %i.cp = inttoptr i64 %i.co to ptr               ; 2 uses
  %i.cq = load ptr, ptr %i.cp, align 16, !tbaa !144 ; 5 uses
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cq, i64 17
  %i.cs = load i16, ptr %i.cr, align 1
  %i.ct = and i16 %i.cs, 4
  %.not210 = icmp eq i16 %i.ct, 0
  br i1 %.not210, label %bb.w, label %bb.t

bb.t:                                             ; preds = %bb.s
  %i.cu = getelementptr inbounds nuw i8, ptr %0, i64 232 ; 2 uses
  %i.cv = load ptr, ptr %i.cu, align 8, !tbaa !832, !nonnull !79, !align !833 ; 3 uses
  %i.cw = getelementptr inbounds nuw i8, ptr %i.cv, i64 2632 ; 3 uses
  %i.cx = load ptr, ptr %i.cw, align 8, !tbaa !838 ; 2 uses
  %i.cy = ptrtoint ptr %i.cx to i64
  %i.cz = add i64 %i.cy, 48                       ; 2 uses
  %i.da = getelementptr inbounds nuw i8, ptr %i.cv, i64 2640
  %i.db = load i64, ptr %i.da, align 8, !tbaa !839
  %i.dc = icmp ult i64 %i.cz, %i.db
  br i1 %i.dc, label %bb.u, label %bb.v, !prof !840

bb.u:                                             ; preds = %bb.t
  %i.dd = inttoptr i64 %i.cz to ptr
  store ptr %i.dd, ptr %i.cw, align 8, !tbaa !838
  br label %_ZnwmRKN5clang10ASTContextEm.exit

bb.v:                                             ; preds = %bb.t
  %i.de = call noundef nonnull ptr @_ZN4llvm20BumpPtrAllocatorImplINS_15MallocAllocatorELm4096ELm4096ELm128ELm8EE12AllocateSlowEmmNS_5AlignE(ptr noundef nonnull align 8 dereferenceable(80) %i.cw, i64 noundef 48, i64 noundef 48, i8 3)
  %.pre = load ptr, ptr %i.cu, align 8, !tbaa !832
  br label %_ZnwmRKN5clang10ASTContextEm.exit

_ZnwmRKN5clang10ASTContextEm.exit:                ; preds = %bb.u, %bb.v
  %i.df = phi ptr [ %i.cv, %bb.u ], [ %.pre, %bb.v ]
  %.0.i.i.i.i = phi ptr [ %i.cx, %bb.u ], [ %i.de, %bb.v ] ; 2 uses
  %i.dg = load ptr, ptr %i.a, align 8, !tbaa !1353
  call void @_ZN5clang8ModeAttrC1ERNS_10ASTContextERKNS_19AttributeCommonInfoEPKNS_14IdentifierInfoE(ptr noundef nonnull align 8 dereferenceable(48) %.0.i.i.i.i, ptr noundef nonnull align 8 dereferenceable(23904) %i.df, ptr noundef nonnull align 8 dereferenceable(36) %2, ptr noundef %i.dg) #23
...
bb.w:                                             ; preds = %bb.s
  ...
  %i.dj = and i8 %i.di, -2
  %spec.select.i.i.i.i.i.i.i.i.not.i = icmp eq i8 %i.dj, 58
  br i1 %spec.select.i.i.i.i.i.i.i.i.not.i, label %_ZNK5clang4Type5getAsINS_10VectorTypeEEEPKT_v.exit.thread195, label %bb.x
end_hunk_0
