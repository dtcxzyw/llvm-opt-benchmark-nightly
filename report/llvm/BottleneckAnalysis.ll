...
bb.f:                                             ; preds = %bb.b
  ...
  %i.w = uitofp i32 %i.e to double
  %i.x = uitofp i32 %i.u to double
  %14 = load <2 x i32>, ptr %i.v, align 4, !tbaa !31
  %15 = uitofp <2 x i32> %14 to <2 x double>
  %i.y = insertelement <4 x double> poison, double %i.w, i64 0
  %i.z = insertelement <4 x double> %i.y, double %i.x, i64 1
  %16 = shufflevector <2 x double> %15, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %17 = shufflevector <4 x double> %i.z, <4 x double> %16, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %i.aa = fmul nnan <4 x double> %17, splat (double 1.000000e+02)
