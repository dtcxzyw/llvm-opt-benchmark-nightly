...
bb.k:                                             ; preds = %_ZN5clang7CodeGen11CallArgList3addENS0_6RValueENS_8QualTypeE.exit
  ...
  %.not.i.i.i.i = icmp eq i16 %i.cu, 118
  %spec.select.v.i.i.i.i = select i1 %.not.i.i.i.i, i64 48, i64 40
  %i.cv = getelementptr inbounds nuw i8, ptr %6, i64 %spec.select.v.i.i.i.i
  %i.cw = load ptr, ptr %i.cv, align 8, !tbaa !1261
...
_ZNK5clang4Type6castAsINS_17FunctionProtoTypeEEEPKT_v.exit: ; preds = %bb.o, %bb.p
  ...
  %.not.i.i.i.i39 = icmp eq i32 %i.eu, 118
  %spec.select.v.i.i.i.i40 = select i1 %.not.i.i.i.i39, i64 48, i64 40
  %i.ev = getelementptr inbounds nuw i8, ptr %6, i64 %spec.select.v.i.i.i.i40 ; 2 uses
  %i.ew = getelementptr inbounds nuw i8, ptr %6, i64 32
  %i.ex = load i32, ptr %i.ew, align 8, !tbaa !1266
  %i.ey = zext i32 %i.ex to i64
  %i.ez = getelementptr inbounds nuw [8 x i8], ptr %i.ev, i64 %i.ey
  %i.fa = getelementptr inbounds nuw i8, ptr %6, i64 16
  %i.fb = load ptr, ptr %i.fa, align 8, !tbaa !834
  call void @_ZN5clang7CodeGen15CodeGenFunction12EmitCallArgsERNS0_11CallArgListENS1_16PrototypeWrapperEN4llvm14iterator_rangeINS_4Stmt12CastIteratorINS_4ExprEKPKS9_KPKS7_EEEENS1_14AbstractCalleeEjNS1_15EvaluationOrderE(ptr noundef nonnull align 8 dereferenceable(6288) %0, ptr noundef nonnull align 8 dereferenceable(1560) %13, i64 %i.et, ptr nonnull %i.ev, ptr nonnull %i.ez, ptr %i.fb, i32 noundef 0, i32 noundef %.lobit) #15
...
_ZN5clang7CodeGen11CallArgList3addENS0_6RValueENS_8QualTypeE.exit25: ; preds = %bb.e, %bb.f
  ...
  %spec.select.v.i.i.i.i = select i1 %.not.i.i.i.i, i64 48, i64 40
  %i.bg = getelementptr inbounds nuw i8, ptr %4, i64 %spec.select.v.i.i.i.i ; 2 uses
