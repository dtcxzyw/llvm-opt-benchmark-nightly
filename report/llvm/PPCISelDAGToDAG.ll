...
.preheader.i:                                     ; preds = %thread-pre-split.i
  ...
  %narrow.i = select i1 %i.ay, i8 2, i8 %i.at     ; 2 uses
  %i.az = zext nneg i8 %narrow.i to i64
  ...
  %narrow416.i = select i1 %i.bc, i8 3, i8 %narrow.i ; 2 uses
  %i.bd = zext nneg i8 %narrow416.i to i64
  ...
  %narrow418.i = select i1 %i.bg, i8 4, i8 %narrow416.i ; 2 uses
  %i.bh = zext nneg i8 %narrow418.i to i64
  ...
  %narrow420.i = select i1 %i.bk, i8 5, i8 %narrow418.i ; 2 uses
  %i.bl = zext nneg i8 %narrow420.i to i64
  ...
  %narrow422.i = select i1 %i.bo, i8 6, i8 %narrow420.i ; 2 uses
  %i.bp = zext nneg i8 %narrow422.i to i64
