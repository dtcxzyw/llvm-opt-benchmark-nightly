...
@__const._ZN4mlir4tosa4IfOp27getODSOperandIndexAndLengthEj.isVariadic = private unnamed_addr constant [2 x i8] c"\00\01", align 1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = getelementptr inbounds nuw i8, ptr @__const._ZN4mlir4tosa4IfOp27getODSOperandIndexAndLengthEj.isVariadic, i64 %index ; 2 uses
  %4 = getelementptr inbounds nuw i8, ptr %3, i64 4
  %wide.load = load <4 x i8>, ptr %3, align 1, !tbaa !418
  %wide.load18 = load <4 x i8>, ptr %4, align 1, !tbaa !418
...
._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %bb.a
  ...
  %i.j = add i32 %i.i, %1
  %5 = getelementptr inbounds nuw i8, ptr @__const._ZN4mlir4tosa4IfOp27getODSOperandIndexAndLengthEj.isVariadic, i64 %.pre-phi
  %6 = load i8, ptr %5, align 1, !tbaa !418, !range !152, !noundef !153
...
.lr.ph:                                           ; preds = %.lr.ph.preheader19, %.lr.ph
  ...
  %8 = getelementptr inbounds nuw i8, ptr @__const._ZN4mlir4tosa4IfOp27getODSOperandIndexAndLengthEj.isVariadic, i64 %indvars.iv
  %9 = load i8, ptr %8, align 1, !tbaa !418, !range !152, !noundef !153
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %2 = getelementptr inbounds nuw i8, ptr @__const._ZN4mlir4tosa4IfOp27getODSOperandIndexAndLengthEj.isVariadic, i64 %index ; 2 uses
  %3 = getelementptr inbounds nuw i8, ptr %2, i64 4
  %wide.load = load <4 x i8>, ptr %2, align 1, !tbaa !418
  %wide.load17 = load <4 x i8>, ptr %3, align 1, !tbaa !418
  %i.a = zext nneg <4 x i8> %wide.load to <4 x i32>
...
_ZN4mlir9Operation14getNumOperandsEv.exit:        ; preds = %._crit_edge, %bb.b
  ...
  %i.q = add i32 %i.p, %1
  %4 = zext i32 %1 to i64
  %5 = getelementptr inbounds nuw i8, ptr @__const._ZN4mlir4tosa4IfOp27getODSOperandIndexAndLengthEj.isVariadic, i64 %4
  %6 = load i8, ptr %5, align 1, !tbaa !418, !range !152, !noundef !153
  %7 = trunc nuw i8 %6 to i1
