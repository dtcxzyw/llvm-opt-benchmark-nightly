...
begin_hunk_0_@_ZNK12lldb_private13DataExtractor7GetCStrEPm:bb.a
  %i.z = add nsw i64 %.047.i.i.i, -1
  %i.aa = icmp sgt i64 %.047.i.i.i, 1
  br i1 %i.aa, label %bb.c, label %._crit_edge.loopexit.i.i.i, !llvm.loop !126
...
bb.h:                                             ; preds = %._crit_edge.i.i.i
  %i.ac = load i8, ptr %.029.lcssa.i.i.i, align 1, !tbaa !38
...
._crit_edge._crit_edge.i.i.i:                     ; preds = %._crit_edge.i.i.i, %bb.i
  ...
  %i.af = load i8, ptr %.1.i.i.i, align 1, !tbaa !38
...
._crit_edge._crit_edge52.i.i.i:                   ; preds = %._crit_edge.i.i.i, %bb.j
  ...
  %i.ai = load i8, ptr %.2.i.i.i, align 1, !tbaa !38
...
bb.a:
  %i.a = load i64, ptr %1, align 8, !tbaa !48
...
bb.c:                                             ; preds = %bb.b
  %i.h = load i64, ptr %1, align 8, !tbaa !48
  %i.i = add i64 %i.h, %2
  store i64 %i.i, ptr %1, align 8, !tbaa !48
  br label %bb.d
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.l, label %_ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit, label %.lr.ph, !prof !58

bb.c:                                             ; preds = %bb.e
  %i.m = add i32 %.028.i10, 7
  %i.n = icmp eq ptr %i.x, %i.h
  br i1 %i.n, label %_ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit, label %.lr.ph, !prof !59, !llvm.loop !9

.lr.ph:                                           ; preds = %bb.b, %bb.c
  %.028.i10 = phi i32 [ %i.m, %bb.c ], [ 0, %bb.b ] ; 5 uses
  %.029.i9 = phi i64 [ %.130.i, %bb.c ], [ 0, %bb.b ]
  %.031.i8 = phi ptr [ %i.x, %bb.c ], [ %i.e, %bb.b ] ; 3 uses
  %i.o = load i8, ptr %.031.i8, align 1, !tbaa !38 ; 2 uses
  %i.p = and i8 %i.o, 127                         ; 3 uses
  %i.q = zext nneg i8 %i.p to i64
  %i.r = icmp ugt i32 %.028.i10, 62
  br i1 %i.r, label %bb.d, label %bb.e, !prof !45
...
bb.e:                                             ; preds = %bb.d, %.lr.ph
  %i.t = icmp ult i32 %.028.i10, 64
  %i.u = zext nneg i32 %.028.i10 to i64
  %i.v = shl i64 %i.q, %i.u
  %i.w = select i1 %i.t, i64 %i.v, i64 0, !prof !60
  %.130.i = add i64 %i.w, %.029.i9                ; 2 uses
  %i.x = getelementptr inbounds nuw i8, ptr %.031.i8, i64 1 ; 3 uses
  %i.y = icmp slt i8 %i.o, 0
  br i1 %i.y, label %bb.c, label %._ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit_crit_edge15, !llvm.loop !9

._ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit_crit_edge15: ; preds = %bb.e
  br label %_ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit, !llvm.loop !9

_ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit:        ; preds = %bb.c, %bb.d, %._ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit_crit_edge15, %bb.b
  %.132.i = phi ptr [ %i.x, %._ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit_crit_edge15 ], [ %scevgep.i, %bb.b ], [ %scevgep.i, %bb.c ], [ %.031.i8, %bb.d ]
  %.3.i = phi i64 [ %.130.i, %._ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit_crit_edge15 ], [ 0, %bb.b ], [ 0, %bb.d ], [ 0, %bb.c ]
  %i.z = ptrtoint ptr %.132.i to i64
  %i.aa = ptrtoint ptr %i.e to i64
  %i.ab = sub i64 %i.z, %i.aa
  %i.ac = and i64 %i.ab, 4294967295
  %i.ad = load i64, ptr %1, align 8, !tbaa !48
  %i.ae = add i64 %i.ac, %i.ad
  store i64 %i.ae, ptr %1, align 8, !tbaa !48
  br label %bb.f
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.i, label %_ZN4llvm13decodeSLEB128EPKhPjS1_PPKc.exit, label %.lr.ph, !prof !58

bb.c:                                             ; preds = %bb.e
  %i.j = icmp eq ptr %i.w, %i.h
  br i1 %i.j, label %_ZN4llvm13decodeSLEB128EPKhPjS1_PPKc.exit, label %.lr.ph, !prof !59, !llvm.loop !10

.lr.ph:                                           ; preds = %bb.b, %bb.c
  %.044.i31 = phi i32 [ %i.v, %bb.c ], [ 0, %bb.b ] ; 5 uses
  %.045.i30 = phi i64 [ %.146.i, %bb.c ], [ 0, %bb.b ] ; 2 uses
  %.050.i29 = phi ptr [ %i.w, %bb.c ], [ %i.e, %bb.b ] ; 4 uses
  %i.k = load i8, ptr %.050.i29, align 1, !tbaa !38 ; 4 uses
  %i.l = and i8 %i.k, 127
  %i.m = zext nneg i8 %i.l to i64                 ; 2 uses
  %i.n = icmp ugt i32 %.044.i31, 62
  br i1 %i.n, label %bb.d, label %bb.e, !prof !45

bb.d:                                             ; preds = %.lr.ph
  %i.o = icmp eq i32 %.044.i31, 63
  br i1 %i.o, label %switch.early.test.i, label %.critedge66.i

switch.early.test.i:                              ; preds = %bb.d
  switch i8 %i.k, label %_ZN4llvm13decodeSLEB128EPKhPjS1_PPKc.exit [
    i8 -1, label %bb.e
    i8 -128, label %bb.e
    i8 127, label %bb.e
    i8 0, label %bb.e
...
.critedge66.i:                                    ; preds = %bb.d
  %i.p = icmp slt i64 %.045.i30, 0
  %i.q = select i1 %i.p, i64 127, i64 0
  %.not58.i = icmp eq i64 %i.q, %i.m
  br i1 %.not58.i, label %bb.e, label %_ZN4llvm13decodeSLEB128EPKhPjS1_PPKc.exit

bb.e:                                             ; preds = %.critedge66.i, %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %.lr.ph
  %i.r = icmp ult i32 %.044.i31, 64
  %i.s = zext nneg i32 %.044.i31 to i64
  %i.t = shl i64 %i.m, %i.s
  %i.u = select i1 %i.r, i64 %i.t, i64 0, !prof !60
  %.146.i = or i64 %i.u, %.045.i30                ; 2 uses
  %i.v = add i32 %.044.i31, 7                     ; 3 uses
  %i.w = getelementptr inbounds nuw i8, ptr %.050.i29, i64 1 ; 3 uses
  %i.x = icmp slt i8 %i.k, 0
  br i1 %i.x, label %bb.c, label %bb.f, !llvm.loop !10

bb.f:                                             ; preds = %bb.e
  %i.y = icmp ugt i32 %i.v, 63
  %.not61.i = icmp samesign ult i8 %i.k, 64
  %or.cond.i = select i1 %i.y, i1 true, i1 %.not61.i
  %i.z = zext nneg i32 %i.v to i64
  %i.aa = shl nsw i64 -1, %i.z
  %i.ab = select i1 %or.cond.i, i64 0, i64 %i.aa
  %.3.i = or i64 %.146.i, %i.ab
  br label %_ZN4llvm13decodeSLEB128EPKhPjS1_PPKc.exit

_ZN4llvm13decodeSLEB128EPKhPjS1_PPKc.exit:        ; preds = %bb.c, %.critedge66.i, %switch.early.test.i, %bb.b, %bb.f
  %.050.lcssa80.sink.i = phi ptr [ %i.w, %bb.f ], [ %i.h, %bb.b ], [ %.050.i29, %switch.early.test.i ], [ %.050.i29, %.critedge66.i ], [ %i.h, %bb.c ]
  %.249.ph.i = phi i64 [ %.3.i, %bb.f ], [ 0, %bb.b ], [ 0, %switch.early.test.i ], [ 0, %.critedge66.i ], [ 0, %bb.c ]
  %2 = ptrtoint ptr %.050.lcssa80.sink.i to i64
  %i.ac = ptrtoint ptr %i.e to i64
  %i.ad = sub i64 %2, %i.ac
  %i.ae = and i64 %i.ad, 4294967295
  %i.af = load i64, ptr %1, align 8, !tbaa !48
  %i.ag = add i64 %i.ae, %i.af
  store i64 %i.ag, ptr %1, align 8, !tbaa !48
  br label %bb.g

bb.g:                                             ; preds = %bb.a, %_ZN4llvm13decodeSLEB128EPKhPjS1_PPKc.exit
...
.preheader:                                       ; preds = %.preheader.preheader, %bb.c
  ...
  %i.q = load i8, ptr %.020, align 1, !tbaa !38
...
bb.c:                                             ; preds = %.preheader
  ...
  br i1 %exitcond.not, label %.critedge, label %.preheader, !llvm.loop !127
...
.critedge:                                        ; preds = %bb.c, %.preheader
  ...
  %i.u = sub i64 %i.s, %i.t
  %i.v = load i64, ptr %1, align 8, !tbaa !48
  %i.w = add i64 %i.u, %i.v
  store i64 %i.w, ptr %1, align 8, !tbaa !48
  br label %bb.d
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = call noundef i64 %i.f(ptr noundef nonnull align 8 dereferenceable(48) %0) #17, !inline_history !0
...
bb.c:                                             ; preds = %.lr.ph, %bb.ae
  %.01945 = phi i32 [ 0, %.lr.ph ], [ %i.ea, %bb.ae ] ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ab = call noundef ptr %i.aa(ptr noundef nonnull align 8 dereferenceable(48) %0, ptr noundef nonnull %i.a, i64 noundef 1) #17, !inline_history !52 ; 2 uses
...
bb.k:                                             ; preds = %bb.h
  ...
  %i.ai = call noundef ptr %i.ah(ptr noundef nonnull align 8 dereferenceable(48) %0, ptr noundef nonnull %i.a, i64 noundef 1) #17, !inline_history !52 ; 2 uses
...
bb.m:                                             ; preds = %bb.h
  ...
  %i.ar = call noundef ptr %i.aq(ptr noundef nonnull align 8 dereferenceable(48) %0, ptr noundef nonnull %i.a, i64 noundef 2) #17, !inline_history !53 ; 2 uses
  %.not.i26 = icmp eq ptr %i.ar, null
  br i1 %.not.i26, label %_ZNK12lldb_private13DataExtractor6GetU16EPm.exit, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.as = load i32, ptr %i.o, align 8, !tbaa !32
...
bb.o:                                             ; preds = %bb.h
  ...
  %i.az = call noundef ptr %i.ay(ptr noundef nonnull align 8 dereferenceable(48) %0, ptr noundef nonnull %i.a, i64 noundef 4) #17, !inline_history !54 ; 2 uses
  %.not.i28 = icmp eq ptr %i.az, null
  br i1 %.not.i28, label %_ZNK12lldb_private13DataExtractor6GetU32EPm.exit, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.ba = load i32, ptr %i.o, align 8, !tbaa !32
...
bb.q:                                             ; preds = %bb.h
  ...
  %i.bg = call noundef ptr %i.bf(ptr noundef nonnull align 8 dereferenceable(48) %0, ptr noundef nonnull %i.a, i64 noundef 8) #17, !inline_history !55 ; 2 uses
  %.not.i32 = icmp eq ptr %i.bg, null
  br i1 %.not.i32, label %_ZNK12lldb_private13DataExtractor6GetU64EPm.exit, label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.bh = load i32, ptr %i.o, align 8, !tbaa !32
...
bb.s:                                             ; preds = %bb.h
  %i.bk = load i32, ptr %i.n, align 4, !tbaa !33
...
bb.t:                                             ; preds = %bb.h
  %i.bo = load i64, ptr %i.a, align 8, !tbaa !48
  %i.bp = load ptr, ptr %0, align 8, !tbaa !22
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bp, i64 96
  %i.br = load ptr, ptr %i.bq, align 8
  %i.bs = call noundef ptr %i.br(ptr noundef nonnull align 8 dereferenceable(48) %0, i64 noundef %i.bo, i64 noundef 1) #17, !inline_history !129 ; 6 uses
  %i.bt = icmp eq ptr %i.bs, null
  br i1 %i.bt, label %_ZNK12lldb_private13DataExtractor10GetULEB128EPm.exit, label %bb.u

bb.u:                                             ; preds = %bb.t
  %i.bu = load ptr, ptr %i.m, align 8, !tbaa !35  ; 3 uses
  ...
  br i1 %i.by, label %_ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit.i, label %.lr.ph81, !prof !58

bb.v:                                             ; preds = %bb.x
  %i.bz = add i32 %.028.i.i79, 7
  %i.ca = icmp eq ptr %i.ck, %i.bu
  br i1 %i.ca, label %_ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit.i, label %.lr.ph81, !prof !59, !llvm.loop !9

.lr.ph81:                                         ; preds = %bb.u, %bb.v
  %.028.i.i79 = phi i32 [ %i.bz, %bb.v ], [ 0, %bb.u ] ; 5 uses
  %.029.i.i78 = phi i64 [ %.130.i.i, %bb.v ], [ 0, %bb.u ]
  %.031.i.i77 = phi ptr [ %i.ck, %bb.v ], [ %i.bs, %bb.u ] ; 3 uses
  %i.cb = load i8, ptr %.031.i.i77, align 1, !tbaa !38 ; 2 uses
  %i.cc = and i8 %i.cb, 127                       ; 3 uses
  %i.cd = zext nneg i8 %i.cc to i64
  %i.ce = icmp ugt i32 %.028.i.i79, 62
  br i1 %i.ce, label %bb.w, label %bb.x, !prof !45

bb.w:                                             ; preds = %.lr.ph81
  %.not44.i.i = icmp eq i32 %.028.i.i79, 63
  %.not.i.i = icmp samesign ugt i8 %i.cc, 1
  %i.cf = icmp ne i8 %i.cc, 0
  %or.cond43.i.i = select i1 %.not44.i.i, i1 %.not.i.i, i1 %i.cf
  br i1 %or.cond43.i.i, label %_ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit.i, label %bb.x

bb.x:                                             ; preds = %bb.w, %.lr.ph81
  %i.cg = icmp ult i32 %.028.i.i79, 64
  %i.ch = zext nneg i32 %.028.i.i79 to i64
  %i.ci = shl i64 %i.cd, %i.ch
  %i.cj = select i1 %i.cg, i64 %i.ci, i64 0, !prof !60
  %.130.i.i = add i64 %i.cj, %.029.i.i78          ; 2 uses
  %i.ck = getelementptr inbounds nuw i8, ptr %.031.i.i77, i64 1 ; 3 uses
  %i.cl = icmp slt i8 %i.cb, 0
  br i1 %i.cl, label %bb.v, label %._ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit.i_crit_edge, !llvm.loop !9

._ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit.i_crit_edge: ; preds = %bb.x
  br label %_ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit.i, !llvm.loop !9

_ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit.i:      ; preds = %bb.v, %bb.w, %._ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit.i_crit_edge, %bb.u
  %.132.i.i = phi ptr [ %i.ck, %._ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit.i_crit_edge ], [ %scevgep.i.i, %bb.u ], [ %scevgep.i.i, %bb.v ], [ %.031.i.i77, %bb.w ]
  %.3.i.i = phi i64 [ %.130.i.i, %._ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit.i_crit_edge ], [ 0, %bb.u ], [ 0, %bb.w ], [ 0, %bb.v ]
  %i.cm = ptrtoint ptr %.132.i.i to i64
  %i.cn = ptrtoint ptr %i.bs to i64
  %i.co = sub i64 %i.cm, %i.cn
  %i.cp = and i64 %i.co, 4294967295
  %i.cq = load i64, ptr %i.a, align 8, !tbaa !48
  %i.cr = add i64 %i.cp, %i.cq
  store i64 %i.cr, ptr %i.a, align 8, !tbaa !48
...
_ZNK12lldb_private13DataExtractor10GetULEB128EPm.exit: ; preds = %bb.t, %_ZN4llvm13decodeULEB128EPKhPjS1_PPKc.exit.i
  ...
  %i.cs = call noundef i64 (ptr, ptr, ...) @_ZN12lldb_private6Stream6PrintfEPKcz(ptr noundef nonnull align 8 dereferenceable(88) %7, ptr noundef nonnull @.str.11, i64 noundef %.0.i37) #17 ; 0 uses
  br label %bb.ae

bb.y:                                             ; preds = %bb.h
  %i.ct = load i64, ptr %i.a, align 8, !tbaa !48
  %i.cu = load ptr, ptr %0, align 8, !tbaa !22
  %i.cv = getelementptr inbounds nuw i8, ptr %i.cu, i64 96
  %i.cw = load ptr, ptr %i.cv, align 8
  %i.cx = call noundef ptr %i.cw(ptr noundef nonnull align 8 dereferenceable(48) %0, i64 noundef %i.ct, i64 noundef 1) #17, !inline_history !130 ; 4 uses
  %i.cy = icmp eq ptr %i.cx, null
  br i1 %i.cy, label %_ZNK12lldb_private13DataExtractor10GetSLEB128EPm.exit, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.cz = load ptr, ptr %i.m, align 8, !tbaa !35  ; 4 uses
  %i.da = icmp eq ptr %i.cx, %i.cz
  br i1 %i.da, label %_ZN4llvm13decodeSLEB128EPKhPjS1_PPKc.exit.i, label %.lr.ph76, !prof !58

bb.aa:                                            ; preds = %bb.ac
  %i.db = icmp eq ptr %i.do, %i.cz
  br i1 %i.db, label %_ZN4llvm13decodeSLEB128EPKhPjS1_PPKc.exit.i, label %.lr.ph76, !prof !59, !llvm.loop !10

.lr.ph76:                                         ; preds = %bb.z, %bb.aa
  %.044.i.i74 = phi i32 [ %i.dn, %bb.aa ], [ 0, %bb.z ] ; 5 uses
  %.045.i.i73 = phi i64 [ %.146.i.i, %bb.aa ], [ 0, %bb.z ] ; 2 uses
  %.050.i.i72 = phi ptr [ %i.do, %bb.aa ], [ %i.cx, %bb.z ] ; 4 uses
  %i.dc = load i8, ptr %.050.i.i72, align 1, !tbaa !38 ; 4 uses
  %i.dd = and i8 %i.dc, 127
  %i.de = zext nneg i8 %i.dd to i64               ; 2 uses
  %i.df = icmp ugt i32 %.044.i.i74, 62
  br i1 %i.df, label %bb.ab, label %bb.ac, !prof !45

bb.ab:                                            ; preds = %.lr.ph76
  %i.dg = icmp eq i32 %.044.i.i74, 63
  br i1 %i.dg, label %switch.early.test.i.i, label %.critedge66.i.i

switch.early.test.i.i:                            ; preds = %bb.ab
  switch i8 %i.dc, label %_ZN4llvm13decodeSLEB128EPKhPjS1_PPKc.exit.i [
    i8 -1, label %bb.ac
    i8 -128, label %bb.ac
    i8 127, label %bb.ac
    i8 0, label %bb.ac
...
.critedge66.i.i:                                  ; preds = %bb.ab
  %i.dh = icmp slt i64 %.045.i.i73, 0
  %i.di = select i1 %i.dh, i64 127, i64 0
  %.not58.i.i = icmp eq i64 %i.di, %i.de
  br i1 %.not58.i.i, label %bb.ac, label %_ZN4llvm13decodeSLEB128EPKhPjS1_PPKc.exit.i

bb.ac:                                            ; preds = %.critedge66.i.i, %switch.early.test.i.i, %switch.early.test.i.i, %switch.early.test.i.i, %switch.early.test.i.i, %.lr.ph76
  %i.dj = icmp ult i32 %.044.i.i74, 64
  %i.dk = zext nneg i32 %.044.i.i74 to i64
  %i.dl = shl i64 %i.de, %i.dk
  %i.dm = select i1 %i.dj, i64 %i.dl, i64 0, !prof !60
  %.146.i.i = or i64 %i.dm, %.045.i.i73           ; 2 uses
  %i.dn = add i32 %.044.i.i74, 7                  ; 3 uses
  %i.do = getelementptr inbounds nuw i8, ptr %.050.i.i72, i64 1 ; 3 uses
  %i.dp = icmp slt i8 %i.dc, 0
  br i1 %i.dp, label %bb.aa, label %bb.ad, !llvm.loop !10

bb.ad:                                            ; preds = %bb.ac
  %i.dq = icmp ugt i32 %i.dn, 63
  %.not61.i.i = icmp samesign ult i8 %i.dc, 64
  %or.cond.i.i = select i1 %i.dq, i1 true, i1 %.not61.i.i
  %i.dr = zext nneg i32 %i.dn to i64
  %i.ds = shl nsw i64 -1, %i.dr
  %i.dt = select i1 %or.cond.i.i, i64 0, i64 %i.ds
  %.3.i.i38 = or i64 %.146.i.i, %i.dt
  br label %_ZN4llvm13decodeSLEB128EPKhPjS1_PPKc.exit.i

_ZN4llvm13decodeSLEB128EPKhPjS1_PPKc.exit.i:      ; preds = %bb.aa, %switch.early.test.i.i, %.critedge66.i.i, %bb.z, %bb.ad
  %.050.lcssa80.sink.i.i = phi ptr [ %i.do, %bb.ad ], [ %i.cz, %bb.z ], [ %.050.i.i72, %.critedge66.i.i ], [ %.050.i.i72, %switch.early.test.i.i ], [ %i.cz, %bb.aa ]
  %.249.ph.i.i = phi i64 [ %.3.i.i38, %bb.ad ], [ 0, %bb.z ], [ 0, %.critedge66.i.i ], [ 0, %switch.early.test.i.i ], [ 0, %bb.aa ]
  %8 = ptrtoint ptr %.050.lcssa80.sink.i.i to i64
  %i.du = ptrtoint ptr %i.cx to i64
  %i.dv = sub i64 %8, %i.du
  %i.dw = and i64 %i.dv, 4294967295
  %i.dx = load i64, ptr %i.a, align 8, !tbaa !48
  %i.dy = add i64 %i.dw, %i.dx
  store i64 %i.dy, ptr %i.a, align 8, !tbaa !48
...
_ZNK12lldb_private13DataExtractor10GetSLEB128EPm.exit: ; preds = %bb.y, %_ZN4llvm13decodeSLEB128EPKhPjS1_PPKc.exit.i
  ...
  %i.dz = call noundef i64 (ptr, ptr, ...) @_ZN12lldb_private6Stream6PrintfEPKcz(ptr noundef nonnull align 8 dereferenceable(88) %7, ptr noundef nonnull @.str.12, i64 noundef %.0.i39) #17 ; 0 uses
  br label %bb.ae

bb.ae:                                            ; preds = %bb.h, %_ZNK12lldb_private13DataExtractor5GetU8EPm.exit, %_ZNK12lldb_private13DataExtractor5GetU8EPm.exit25, %_ZNK12lldb_private13DataExtractor6GetU16EPm.exit, %_ZNK12lldb_private13DataExtractor6GetU32EPm.exit, %_ZNK12lldb_private13DataExtractor6GetU64EPm.exit, %bb.s, %_ZNK12lldb_private13DataExtractor10GetULEB128EPm.exit, %_ZNK12lldb_private13DataExtractor10GetSLEB128EPm.exit
  %i.ea = add i32 %.01945, 1
  %i.eb = load i64, ptr %i.a, align 8, !tbaa !48
  %i.ec = load ptr, ptr %0, align 8, !tbaa !22
  %i.ed = getelementptr inbounds nuw i8, ptr %i.ec, i64 24
  %i.ee = load ptr, ptr %i.ed, align 8
  %i.ef = call noundef i64 %i.ee(ptr noundef nonnull align 8 dereferenceable(48) %0) #17, !inline_history !0
  %i.eg = icmp ult i64 %i.eb, %i.ef
  %i.eh = load i64, ptr %i.a, align 8
  %i.ei = icmp ult i64 %i.eh, %i.c
  %i.ej = select i1 %i.eg, i1 %i.ei, i1 false
  br i1 %i.ej, label %bb.c, label %._crit_edge, !llvm.loop !128

._crit_edge:                                      ; preds = %bb.ae, %bb.b
  %i.ek = call noundef zeroext i1 @_ZNK12lldb_private12StreamString5EmptyEv(ptr noundef nonnull align 8 dereferenceable(120) %7) #17
  br i1 %i.ek, label %bb.ag, label %bb.af

bb.af:                                            ; preds = %._crit_edge
  %i.el = call { ptr, i64 } @_ZNK12lldb_private12StreamString9GetStringEv(ptr noundef nonnull align 8 dereferenceable(120) %7) #17 ; 2 uses
  %i.em = extractvalue { ptr, i64 } %i.el, 0
  %i.en = extractvalue { ptr, i64 } %i.el, 1
  call void @_ZN12lldb_private3Log9PutStringEN4llvm9StringRefE(ptr noundef nonnull align 8 dereferenceable(104) %1, ptr %i.em, i64 %i.en) #17
  br label %bb.ag

bb.ag:                                            ; preds = %bb.af, %._crit_edge
  %i.eo = load i64, ptr %i.a, align 8, !tbaa !48
...
bb.c:                                             ; preds = %bb.a
  ...
  store i32 1, ptr %i.p, align 8, !tbaa !43
  %i.q = getelementptr inbounds nuw i8, ptr %i.o, i64 12
  store i32 1, ptr %i.q, align 4, !tbaa !44
  store ptr getelementptr inbounds nuw inrange(-16, 40) (i8, ptr @_ZTVSt15_Sp_counted_ptrIPN12lldb_private14DataBufferHeapELN9__gnu_cxx12_Lock_policyE2EE, i64 16), ptr %i.o, align 8, !tbaa !22
  %i.r = getelementptr inbounds nuw i8, ptr %i.o, i64 16
  store ptr %i.m, ptr %i.r, align 8, !tbaa !63
  store ptr %i.o, ptr %i.n, align 8, !tbaa !37
  ...
  %i.w = load ptr, ptr %i.n, align 8, !tbaa !37   ; 8 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  call void %i.ae(ptr noundef nonnull align 8 dereferenceable(16) %i.w) #17, !inline_history !2
  %i.af = load ptr, ptr %i.w, align 8, !tbaa !22
  %i.ag = getelementptr inbounds nuw i8, ptr %i.af, i64 24
  %i.ah = load ptr, ptr %i.ag, align 8
  call void %i.ah(ptr noundef nonnull align 8 dereferenceable(16) %i.w) #17, !inline_history !2
  br label %_ZNSt12__shared_ptrIN12lldb_private10DataBufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit

bb.f:                                             ; preds = %bb.d
  %i.ai = load i8, ptr @__libc_single_threaded, align 1, !tbaa !38
  %.not.i.i.i = icmp eq i8 %i.ai, 0
  br i1 %.not.i.i.i, label %bb.h, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.aj = add nsw i32 %i.aa, -1
  store i32 %i.aj, ptr %i.x, align 8, !tbaa !39
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i: ; preds = %bb.h, %bb.g
  ...
  br i1 %i.al, label %bb.i, label %_ZNSt12__shared_ptrIN12lldb_private10DataBufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, !prof !45
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.m = tail call noundef i64 %i.l(ptr noundef nonnull align 8 dereferenceable(48) %0) #17
  %i.n = icmp eq i64 %i.m, 0
  br i1 %i.n, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  %i.o = tail call noundef i64 @_ZNK12lldb_private13DataExtractor4CopyERS0_(ptr noundef nonnull align 8 dereferenceable(48) %1, ptr noundef nonnull align 8 dereferenceable(48) %0)
