...
.lr.ph.i.i.i:                                     ; preds = %bb.a
  %i.i = load i8, ptr getelementptr inbounds nuw (i8, ptr @_ZN3lld4wasm3ctxE, i64 1050), align 2, !range !152 ; 5 uses
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.i.i.i.new
  ...
  %narrow.i.i.i = select i1 %i.o, i8 %i.i, i8 1
  %20 = zext nneg i8 %narrow.i.i.i to i64
  %spec.select.i.i.i = add nuw nsw i64 %.08.i.i.i, %20
  ...
  %narrow.i.i.i.1 = select i1 %i.r, i8 %i.i, i8 1
  %21 = zext nneg i8 %narrow.i.i.i.1 to i64
  %spec.select.i.i.i.1 = add nuw nsw i64 %spec.select.i.i.i, %21
  ...
  %narrow.i.i.i.2 = select i1 %i.u, i8 %i.i, i8 1
  %22 = zext nneg i8 %narrow.i.i.i.2 to i64
  %spec.select.i.i.i.2 = add nuw nsw i64 %spec.select.i.i.i.1, %22
  ...
  %narrow.i.i.i.3 = select i1 %i.x, i8 %i.i, i8 1
  %23 = zext nneg i8 %narrow.i.i.i.3 to i64
  %spec.select.i.i.i.3 = add nuw nsw i64 %spec.select.i.i.i.2, %23 ; 3 uses
...
bb.c:                                             ; preds = %bb.c, %.epil.preheader
  ...
  %narrow.i.i.i.epil = select i1 %i.aa, i8 %i.i, i8 1
  %24 = zext nneg i8 %narrow.i.i.i.epil to i64
  %spec.select.i.i.i.epil = add nuw nsw i64 %.08.i.i.i.epil, %24 ; 2 uses
