...
begin_hunk_0_@_ZN4mlir14BytecodeReader4Impl12parseRegionsERSt6vectorINS1_15RegionReadStateESaIS3_EERS3_:bb.a
  ...
  %.val.i.i.i.i.i.i.i.i = load i64, ptr %i.fq, align 8, !tbaa !218
  store i64 %.val.i.i.i.i.i.i.i.i, ptr %i.aej, align 8, !tbaa !218
  store ptr null, ptr %i.fq, align 8, !tbaa !218
  %i.aek = getelementptr inbounds nuw i8, ptr %i.aef, i64 56
  %i.ael = load i32, ptr %i.fr, align 8, !tbaa !379
  store i32 %i.ael, ptr %i.aek, align 8, !tbaa !379
  %i.aem = getelementptr inbounds nuw i8, ptr %i.aef, i64 64 ; 2 uses
  %i.aen = getelementptr inbounds nuw i8, ptr %i.aef, i64 80
  store ptr %i.aen, ptr %i.aem, align 8, !tbaa !185
  %i.aeo = getelementptr inbounds nuw i8, ptr %i.aef, i64 72
  store i32 0, ptr %i.aeo, align 8, !tbaa !182
  %i.aep = getelementptr inbounds nuw i8, ptr %i.aef, i64 76
  store i32 6, ptr %i.aep, align 4, !tbaa !183
  %i.aeq = load i32, ptr %i.fu, align 8, !tbaa !182
...
.loopexit:                                        ; preds = %_ZN4mlir14BytecodeReader4Impl15RegionReadStateC2EPNS_9OperationEPN12_GLOBAL__N_114EncodingReaderEb.exit, %bb.gc
  ...
  %i.aet = load ptr, ptr %i.gg, align 8, !tbaa !384 ; 10 uses
  %i.aeu = load ptr, ptr %i.gh, align 8, !tbaa !385
...
bb.gd:                                            ; preds = %.loopexit
  ...
  %.val.i.i.i.i.i.i = load i64, ptr %i.fq, align 8, !tbaa !218
  store i64 %.val.i.i.i.i.i.i, ptr %i.aev, align 8, !tbaa !218
  store ptr null, ptr %i.fq, align 8, !tbaa !218
  %i.aew = getelementptr inbounds nuw i8, ptr %i.aet, i64 32
  %i.aex = load i32, ptr %i.fr, align 8, !tbaa !379
  store i32 %i.aex, ptr %i.aew, align 8, !tbaa !379
  %i.aey = getelementptr inbounds nuw i8, ptr %i.aet, i64 40 ; 2 uses
  %i.aez = getelementptr inbounds nuw i8, ptr %i.aet, i64 56
  store ptr %i.aez, ptr %i.aey, align 8, !tbaa !185
  %i.afa = getelementptr inbounds nuw i8, ptr %i.aet, i64 48
  store i32 0, ptr %i.afa, align 8, !tbaa !182
  %i.afb = getelementptr inbounds nuw i8, ptr %i.aet, i64 52
  store i32 6, ptr %i.afb, align 4, !tbaa !183
  %i.afc = load i32, ptr %i.fu, align 8, !tbaa !182
...
_ZN4mlir14BytecodeReader4Impl15RegionReadStateC2EOS2_.exit.i.i: ; preds = %bb.ge, %bb.gd
  ...
  %i.aff = load ptr, ptr %i.gg, align 8, !tbaa !384
  %i.afg = getelementptr inbounds nuw i8, ptr %i.aff, i64 128
  store ptr %i.afg, ptr %i.gg, align 8, !tbaa !384
...
bb.gg:                                            ; preds = %_ZNSt6vectorIN4mlir14BytecodeReader4Impl15RegionReadStateESaIS3_EE9push_backEOS3_.exit
  %i.afh = load ptr, ptr %i.eq, align 8, !tbaa !388 ; 6 uses
  %i.afi = load ptr, ptr %i.gi, align 8, !tbaa !389
...
bb.gh:                                            ; preds = %bb.gg
  ...
  store ptr %i.afk, ptr %i.afj, align 8, !tbaa !185
  %i.afl = getelementptr inbounds nuw i8, ptr %i.afh, i64 36
  store i32 4, ptr %i.afl, align 4, !tbaa !183
  %i.afm = load ptr, ptr %i.eq, align 8, !tbaa !388
  %i.afn = getelementptr inbounds nuw i8, ptr %i.afm, i64 56
  store ptr %i.afn, ptr %i.eq, align 8, !tbaa !388
  br label %_ZNSt6vectorIN4mlir14BytecodeReader4Impl10ValueScopeESaIS3_EE12emplace_backIJEEERS3_DpOT_.exit.jt1
...
_ZNSt6vectorIN4mlir14BytecodeReader4Impl10ValueScopeESaIS3_EE12emplace_backIJEEERS3_DpOT_.exit.jt1: ; preds = %_ZNSt6vectorIN4mlir14BytecodeReader4Impl15RegionReadStateESaIS3_EE9push_backEOS3_.exit, %bb.gh, %bb.gi, %.thread.jt1
  ...
  %i.afv = load ptr, ptr %i.fs, align 8, !tbaa !185 ; 2 uses
...
_ZN4llvm11SmallVectorIPN4mlir5BlockELj6EED2Ev.exit.i.jt0: ; preds = %bb.gj, %_ZNSt6vectorIN4mlir14BytecodeReader4Impl10ValueScopeESaIS3_EE12emplace_backIJEEERS3_DpOT_.exit.jt0
  %i.afx = load ptr, ptr %i.fq, align 8, !tbaa !218 ; 2 uses
...
_ZN4llvm11SmallVectorIPN4mlir5BlockELj6EED2Ev.exit.i.jt1: ; preds = %bb.gk, %_ZNSt6vectorIN4mlir14BytecodeReader4Impl10ValueScopeESaIS3_EE12emplace_backIJEEERS3_DpOT_.exit.jt1
  %i.afy = load ptr, ptr %i.fq, align 8, !tbaa !218 ; 2 uses
...
.backedge:                                        ; preds = %_ZN4mlir14BytecodeReader4Impl15RegionReadStateD2Ev.exit.jt0, %bb.fo
  call void @llvm.lifetime.end.p0(ptr nonnull %58) #24
  %i.afz = load i64, ptr %i.v, align 8, !tbaa !557 ; 2 uses
  %i.aga = add i64 %i.afz, -1
  store i64 %i.aga, ptr %i.v, align 8, !tbaa !557
  %.not32 = icmp eq i64 %i.afz, 0
  br i1 %.not32, label %._crit_edge, label %.lr.ph, !llvm.loop !661

._crit_edge:                                      ; preds = %.backedge, %bb.f
  %i.agb = load ptr, ptr %i.t, align 8, !tbaa !525
  %i.agc = getelementptr inbounds nuw i8, ptr %i.agb, i64 8
  %i.agd = load ptr, ptr %i.agc, align 8, !tbaa !386 ; 2 uses
  store ptr %i.agd, ptr %i.t, align 8, !tbaa !525
  %i.age = load ptr, ptr %2, align 8, !tbaa !363  ; 4 uses
...
bb.gm:                                            ; preds = %._crit_edge
  ...
  br i1 %i.agh, label %bb.f, label %_ZNSt6vectorIN4mlir14BytecodeReader4Impl15RegionReadStateESaIS3_EE8pop_backEv.exit, !llvm.loop !662

bb.gn:                                            ; preds = %._crit_edge
  store i64 0, ptr %i.t, align 8
  %i.agi = load ptr, ptr %i.eq, align 8, !tbaa !390 ; 3 uses
  %i.agj = getelementptr inbounds i8, ptr %i.agi, i64 -56 ; 2 uses
  %i.agk = getelementptr inbounds i8, ptr %i.agi, i64 -48 ; 2 uses
  %i.agl = load ptr, ptr %i.agk, align 8, !tbaa !391 ; 2 uses
  %i.agm = load ptr, ptr %i.agj, align 8, !tbaa !394 ; 2 uses
  ...
  %i.agr = load i32, ptr %i.fk, align 8, !tbaa !379 ; 2 uses
...
bb.go:                                            ; preds = %bb.gn
  ...
  %.pre344.pre = load ptr, ptr %2, align 8, !tbaa !363
  br label %.thread262
...
bb.gr:                                            ; preds = %bb.gq
  store ptr %i.agw, ptr %i.agk, align 8, !tbaa !391
  br label %.thread262
...
.thread262:                                       ; preds = %bb.gr, %bb.gq, %bb.gp, %bb.go
  ...
  %i.agy = load i32, ptr %i.agx, align 8, !tbaa !182
  %i.agz = add i32 %i.agy, -1
  store i32 %i.agz, ptr %i.agx, align 8, !tbaa !182
  br label %bb.gs
...
bb.gs:                                            ; preds = %.thread262, %bb.d
  ...
  store ptr %i.ahb, ptr %2, align 8, !tbaa !363
  %i.ahc = load ptr, ptr %i.q, align 8, !tbaa !376
  %.not = icmp eq ptr %i.ahb, %i.ahc
  br i1 %.not, label %._crit_edge312, label %bb.b, !llvm.loop !663

._crit_edge312:                                   ; preds = %bb.gs, %bb.a
  %i.ahd = getelementptr inbounds nuw i8, ptr %2, i64 120
  %i.ahe = load i8, ptr %i.ahd, align 8, !tbaa !380, !range !34, !noundef !35
...
bb.gt:                                            ; preds = %._crit_edge312
  ...
  %i.ahh = load ptr, ptr %i.ahg, align 8, !tbaa !388 ; 4 uses
  %i.ahi = getelementptr inbounds i8, ptr %i.ahh, i64 -56 ; 2 uses
  store ptr %i.ahi, ptr %i.ahg, align 8, !tbaa !388
  %i.ahj = getelementptr inbounds i8, ptr %i.ahh, i64 -32
  %i.ahk = load ptr, ptr %i.ahj, align 8, !tbaa !185 ; 2 uses
...
_ZN4llvm11SmallVectorIjLj4EED2Ev.exit.i.i:        ; preds = %bb.gu, %bb.gt
  %i.ahn = load ptr, ptr %i.ahi, align 8, !tbaa !394 ; 3 uses
...
bb.gv:                                            ; preds = %_ZN4llvm11SmallVectorIjLj4EED2Ev.exit.i.i
  ...
  %i.ahp = load ptr, ptr %i.aho, align 8, !tbaa !664
...
_ZNSt6vectorIN4mlir14BytecodeReader4Impl10ValueScopeESaIS3_EE8pop_backEv.exit: ; preds = %bb.gv, %_ZN4llvm11SmallVectorIjLj4EED2Ev.exit.i.i, %._crit_edge312
  ...
  %i.ahu = load ptr, ptr %i.aht, align 8, !tbaa !384 ; 4 uses
  %i.ahv = getelementptr inbounds i8, ptr %i.ahu, i64 -128
  store ptr %i.ahv, ptr %i.aht, align 8, !tbaa !384
  %i.ahw = getelementptr inbounds i8, ptr %i.ahu, i64 -88
  %i.ahx = load ptr, ptr %i.ahw, align 8, !tbaa !185 ; 2 uses
...
_ZN4llvm11SmallVectorIPN4mlir5BlockELj6EED2Ev.exit.i.i: ; preds = %bb.gw, %_ZNSt6vectorIN4mlir14BytecodeReader4Impl10ValueScopeESaIS3_EE8pop_backEv.exit
  ...
  %i.aib = load ptr, ptr %i.aia, align 8, !tbaa !218 ; 2 uses
...
bb.a:
  ...
  %i.a = load ptr, ptr %3, align 8, !tbaa !24
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.j = load ptr, ptr %i.b, align 8, !tbaa !185
  ...
  %i.l = load i32, ptr %i.e, align 8, !tbaa !182
  %i.m = add i32 %i.l, 1
  store i32 %i.m, ptr %i.e, align 8, !tbaa !182
  br label %_ZN4mlir10Diagnostic6appendIRA54_KcEERS0_OT_.exit.i.i
...
bb.f:                                             ; preds = %bb.e, %_ZNO4mlir18InFlightDiagnostic6appendIJRA54_KcEEEOS0_DpOT_.exit
  ...
  %i.p = load i8, ptr %i.o, align 8, !tbaa !33, !range !34, !noundef !35
  %i.q = trunc nuw i8 %i.p to i1
  store i8 0, ptr %i.o, align 8, !tbaa !33
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.c = load ptr, ptr %4, align 8, !tbaa !396    ; 2 uses
  %i.d = load ptr, ptr %3, align 8, !tbaa !396    ; 2 uses
  %i.e = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  store ptr %4, ptr %i.e, align 8, !tbaa !386
  store ptr %i.d, ptr %4, align 8, !tbaa !396
  %i.f = load ptr, ptr %1, align 8, !tbaa !396    ; 2 uses
  %i.g = getelementptr inbounds nuw i8, ptr %i.c, i64 8
  store ptr %1, ptr %i.g, align 8, !tbaa !386
  store ptr %i.f, ptr %3, align 8, !tbaa !396
  %i.h = getelementptr inbounds nuw i8, ptr %i.f, i64 8
  store ptr %3, ptr %i.h, align 8, !tbaa !386
  store ptr %i.c, ptr %1, align 8, !tbaa !396
