...
bb.e:                                             ; preds = %.lr.ph.i.i.i.i
  ...
  br i1 %.not.i.i.i.i, label %_ZN5clang11DeclContext22specific_decl_iteratorINS_9FieldDeclEEppEv.exit.i.i, label %.lr.ph.i.i.i.i, !llvm.loop !503
...
_ZN5clang11DeclContext22specific_decl_iteratorINS_9FieldDeclEEppEv.exit.i.i: ; preds = %bb.e, %.lr.ph.i.i.i.i, %.lr.ph.i.i
  ...
  br i1 %.not.i.i, label %_ZNK5clang10RecordDecl12getNumFieldsEv.exit, label %.lr.ph.i.i, !llvm.loop !504
...
bb.f:                                             ; preds = %_ZNK5clang10RecordDecl12getNumFieldsEv.exit
  ...
  %.sroa.0.0.copyload.i7 = load i64, ptr %i.ao, align 8, !tbaa !18
  %i.ap = and i64 %.sroa.0.0.copyload.i7, -16
  %i.aq = inttoptr i64 %i.ap to ptr
  %i.ar = load ptr, ptr %i.aq, align 16, !tbaa !17
  %i.as = getelementptr inbounds nuw i8, ptr %i.ar, i64 8
  %.sroa.0.0.copyload.i.i.i38.i = load i64, ptr %i.as, align 8, !tbaa !18 ; 2 uses
  %i.at = and i64 %.sroa.0.0.copyload.i.i.i38.i, -16
  %i.au = inttoptr i64 %i.at to ptr
  %i.av = load ptr, ptr %i.au, align 16, !tbaa !17 ; 4 uses
...
.lr.ph.i._crit_edge:                              ; preds = %.lr.ph.i, %.lr.ph.i.preheader
  ...
  %i.bg = tail call noundef ptr @_ZNK5clang7TagDecl13getDefinitionEv(ptr noundef nonnull align 8 dereferenceable(164) %i.bf) #11, !inline_history !0 ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  %i.bp = load ptr, ptr %i.bo, align 16, !tbaa !17 ; 3 uses
...
tailrecurse.i:                                    ; preds = %.lr.ph
  ...
  %.sroa.0.0.copyload.i.i = load i64, ptr %i.bt, align 16, !tbaa !18
  %i.bu = and i64 %.sroa.0.0.copyload.i.i, -16
  %i.bv = inttoptr i64 %i.bu to ptr
  %i.bw = load ptr, ptr %i.bv, align 16, !tbaa !17
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bw, i64 8
  %.sroa.0.0.copyload.i.i.i.i10 = load i64, ptr %i.bx, align 8, !tbaa !18 ; 2 uses
  %i.by = and i64 %.sroa.0.0.copyload.i.i.i.i10, -16
  %i.bz = inttoptr i64 %i.by to ptr
  %i.ca = load ptr, ptr %i.bz, align 16, !tbaa !17 ; 4 uses
...
bb.a:
  ...
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !507
  %i.f = getelementptr inbounds nuw i8, ptr %i.c, i64 16
  %i.g = load i32, ptr %i.f, align 8, !tbaa !508
  ...
  %i.m = load i32, ptr %i.l, align 8, !tbaa !510  ; 2 uses
  store i32 %i.m, ptr %i.k, align 8, !tbaa !510
  %i.n = icmp ult i32 %i.m, 65
  br i1 %i.n, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %i.o = load i64, ptr %i.j, align 8, !tbaa !18
  store i64 %i.o, ptr %0, align 8, !tbaa !18
...
_ZN4llvm6APSIntC2ERKS0_.exit:                     ; preds = %bb.b, %bb.c
  ...
  %i.r = load i8, ptr %i.q, align 4, !tbaa !512, !range !513, !noundef !31
  store i8 %i.r, ptr %i.p, align 4, !tbaa !512
  ret void
}
...
bb.a:
  ...
  store i8 %1, ptr %i.b, align 1, !tbaa !32
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 4 uses
  %.val = load ptr, ptr %i.d, align 8, !tbaa !34  ; 5 uses
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 4 uses
  %.val11 = load i32, ptr %i.e, align 8, !tbaa !35 ; 3 uses
...
bb.b:                                             ; preds = %bb.f, %.lr.ph.i.i.i.i
  ...
  %.029.val39.i.i.i.i = load i8, ptr %.02950.i.i.i.i, align 8, !tbaa !516
...
bb.c:                                             ; preds = %bb.b
  ...
  %.val37.i.i.i.i = load i8, ptr %i.k, align 8, !tbaa !516
...
bb.d:                                             ; preds = %bb.c
  ...
  %.val35.i.i.i.i = load i8, ptr %i.m, align 8, !tbaa !516
...
bb.e:                                             ; preds = %bb.d
  ...
  %.val33.i.i.i.i = load i8, ptr %i.o, align 8, !tbaa !516
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.s, label %bb.b, label %._crit_edge.loopexit.i.i.i.i, !llvm.loop !514
...
bb.g:                                             ; preds = %._crit_edge.i.i.i.i
  %.029.val.i.i.i.i = load i8, ptr %.029.lcssa.i.i.i.i, align 8, !tbaa !516
...
._crit_edge._crit_edge.i.i.i.i:                   ; preds = %bb.h, %._crit_edge.i.i.i.i
  ...
  %.1.val.i.i.i.i = load i8, ptr %.1.i.i.i.i, align 8, !tbaa !516
...
._crit_edge._crit_edge57.i.i.i.i:                 ; preds = %bb.i, %._crit_edge.i.i.i.i
  ...
  %.2.val.i.i.i.i = load i8, ptr %.2.i.i.i.i, align 8, !tbaa !516
...
switch.lookup:                                    ; preds = %"_ZN4llvm7find_ifIRNS_11SmallVectorIN5clang22ComparisonCategoryInfo9ValueInfoELj5EEEZNKS3_15lookupValueInfoENS2_24ComparisonCategoryResultEE3$_0EEDaOT_T0_.exit"
  ...
  %i.ai = tail call noundef ptr %i.ah(ptr noundef nonnull align 8 dereferenceable(144) %i.ae) #11, !inline_history !1
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 64
  %i.ak = load ptr, ptr %0, align 8, !tbaa !48, !nonnull !31, !align !49
  %i.al = getelementptr inbounds nuw i8, ptr %i.ak, i64 17768
  %i.am = load ptr, ptr %i.al, align 8, !tbaa !445, !nonnull !31, !align !49 ; 4 uses
  ...
  store ptr null, ptr %i.a, align 8, !tbaa !447
  ...
  %i.aq = load ptr, ptr %.fca.0.extract.i, align 8, !tbaa !449 ; 2 uses
...
bb.k:                                             ; preds = %switch.lookup
  ...
  %i.au = load ptr, ptr %i.at, align 8, !tbaa !455 ; 3 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.ay = call noundef ptr %i.ax(ptr noundef nonnull align 8 dereferenceable(8) %i.au, ptr nonnull %switch.load65, i64 %switch.ext) #11, !inline_history !515 ; 3 uses
  store ptr %i.ay, ptr %i.ar, align 8, !tbaa !450
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  %i.ba = load ptr, ptr %i.az, align 8, !tbaa !456 ; 2 uses
  %i.bb = ptrtoint ptr %i.ba to i64
  %i.bc = add i64 %i.bb, 24                       ; 2 uses
  %i.bd = getelementptr inbounds nuw i8, ptr %i.am, i64 32
  %i.be = load i64, ptr %i.bd, align 8, !tbaa !457
  %i.bf = icmp ult i64 %i.bc, %i.be
  br i1 %i.bf, label %bb.n, label %bb.o, !prof !458

bb.n:                                             ; preds = %bb.m
  %i.bg = inttoptr i64 %i.bc to ptr
  store ptr %i.bg, ptr %i.az, align 8, !tbaa !456
...
_ZN4llvm13AllocatorBaseINS_20BumpPtrAllocatorImplINS_15MallocAllocatorELm4096ELm4096ELm128ELm8EEEE8AllocateIN5clang14IdentifierInfoEEEPT_m.exit.i: ; preds = %bb.o, %bb.n
  ...
  store ptr %.0.i.i.i.i.i, ptr %i.ar, align 8, !tbaa !450
  %i.bm = getelementptr inbounds nuw i8, ptr %.0.i.i.i.i.i, i64 16
  store ptr %i.aq, ptr %i.bm, align 8, !tbaa !461
...
_ZNK5clang23DeclContextLookupResult5frontEv.exit.thread: ; preds = %bb.p
  %i.by = load ptr, ptr %i.bs, align 8, !tbaa !469
...
bb.q:                                             ; preds = %_ZNK5clang23DeclContextLookupResult5frontEv.exit19
  ...
  %i.cs = load ptr, ptr %i.cr, align 8, !tbaa !24 ; 3 uses
...
_ZNK5clang4Type18getAsCXXRecordDeclEv.exit:       ; preds = %bb.r, %bb.q
  ...
  %i.da = load ptr, ptr %spec.select, align 8, !tbaa !47
  %i.db = getelementptr inbounds nuw i8, ptr %i.da, i64 32
  %i.dc = load ptr, ptr %i.db, align 8
  %i.dd = call noundef ptr %i.dc(ptr noundef nonnull align 8 dereferenceable(144) %spec.select) #11, !inline_history !1
  %i.de = load ptr, ptr %i.ad, align 8, !tbaa !45 ; 2 uses
  %i.df = load ptr, ptr %i.de, align 8, !tbaa !47
  %i.dg = getelementptr inbounds nuw i8, ptr %i.df, i64 32
  %i.dh = load ptr, ptr %i.dg, align 8
  %i.di = call noundef ptr %i.dh(ptr noundef nonnull align 8 dereferenceable(144) %i.de) #11, !inline_history !1
...
bb.s:                                             ; preds = %_ZNK5clang4Type18getAsCXXRecordDeclEv.exit
  %i.dj = load i32, ptr %i.e, align 8, !tbaa !35  ; 3 uses
  %i.dk = getelementptr inbounds nuw i8, ptr %0, i64 20
  %i.dl = load i32, ptr %i.dk, align 4, !tbaa !471
  %.not.i21 = icmp ult i32 %i.dj, %i.dl
  br i1 %.not.i21, label %bb.u, label %bb.t, !prof !458
...
bb.t:                                             ; preds = %bb.s
  ...
  %.pre42 = load i32, ptr %i.e, align 8, !tbaa !35
...
bb.u:                                             ; preds = %bb.s
  ...
  %i.do = load ptr, ptr %i.d, align 8, !tbaa !34  ; 2 uses
  %i.dp = getelementptr inbounds nuw [16 x i8], ptr %i.do, i64 %i.dn ; 2 uses
  store i8 %1, ptr %i.dp, align 8, !tbaa !516
  %i.dq = getelementptr inbounds nuw i8, ptr %i.dp, i64 8
  store ptr %i.ce, ptr %i.dq, align 8, !tbaa !28
  %i.dr = add nuw i32 %i.dj, 1                    ; 2 uses
  store i32 %i.dr, ptr %i.e, align 8, !tbaa !35
  br label %_ZN4llvm15SmallVectorImplIN5clang22ComparisonCategoryInfo9ValueInfoEE12emplace_backIJRNS1_24ComparisonCategoryResultERPNS1_7VarDeclEEEERS3_DpOT_.exit
...
bb.a:
  ...
  store i8 %1, ptr %i.b, align 1, !tbaa !472
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !473, !noalias !532 ; 3 uses
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !474, !noalias !532 ; 2 uses
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 28
  %i.j = load i32, ptr %i.i, align 4, !tbaa !475, !noalias !532 ; 4 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.r = load i32, ptr %i.q, align 4, !tbaa !476, !noalias !533
  %i.s = and i32 %.017.i.i.i.i, 31
  %i.t = lshr i32 %i.r, %i.s
  %i.u = trunc i32 %i.t to i1
  br i1 %i.u, label %.lr.ph.i.i.i.i, label %.loopexit.i.i, !prof !477
...
bb.c:                                             ; preds = %.lr.ph.i.i.i.i
  ...
  %i.z = load i32, ptr %i.y, align 4, !tbaa !476, !noalias !533
  %i.aa = and i32 %.0.i.i.i.i, 31
  %i.ab = lshr i32 %i.z, %i.aa
  %i.ac = trunc i32 %i.ab to i1
  br i1 %i.ac, label %.lr.ph.i.i.i.i, label %.loopexit.i.i, !prof !478
...
.lr.ph.i.i.i.i:                                   ; preds = %bb.b, %bb.c
  ...
  %i.af = load i8, ptr %i.ae, align 1, !tbaa !18, !noalias !533
  %i.ag = icmp eq i8 %1, %i.af
  br i1 %i.ag, label %_ZN4llvm12DenseMapBaseINS_8DenseMapIcN5clang22ComparisonCategoryInfoENS_12DenseMapInfoIcvEENS_6detail12DenseMapPairIcS3_EEEEcS3_S5_S8_E4findERKc.exit.loopexit, label %bb.c, !prof !458
...
bb.e:                                             ; preds = %_ZN4llvm12DenseMapBaseINS_8DenseMapIcN5clang22ComparisonCategoryInfoENS_12DenseMapInfoIcvEENS_6detail12DenseMapPairIcS3_EEEEcS3_S5_S8_E4findERKc.exit
  %i.al = load ptr, ptr %0, align 8, !tbaa !479, !nonnull !31, !align !49 ; 3 uses
  %i.am = getelementptr inbounds nuw i8, ptr %0, i64 32 ; 3 uses
  %i.an = load ptr, ptr %i.am, align 8, !tbaa !534 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.ap = load ptr, ptr %i.ao, align 8, !tbaa !535
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 80
  %i.ar = load ptr, ptr %i.aq, align 8, !tbaa !538 ; 4 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.bb = load ptr, ptr %i.ba, align 8, !tbaa !484 ; 2 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.bu = load i32, ptr %i.bt, align 8, !tbaa !487
  %i.bv = load ptr, ptr %i.bs, align 8, !tbaa !486 ; 3 uses
  %i.bw = getelementptr inbounds nuw i8, ptr %i.bv, i64 12
  %i.bx = load i32, ptr %i.bw, align 4, !tbaa !491 ; 2 uses
  %.not12.i.i.i.i.i.i = icmp eq i32 %i.bu, %i.bx
  br i1 %.not12.i.i.i.i.i.i, label %bb.q, label %bb.p

bb.p:                                             ; preds = %bb.o
  store i32 %i.bx, ptr %i.bt, align 8, !tbaa !487
  %i.by = load ptr, ptr %i.bv, align 8, !tbaa !47
  %i.bz = getelementptr i8, ptr %i.by, i64 152, !nosanitize !31
  %i.ca = load ptr, ptr %i.bz, align 8, !nosanitize !31
  tail call void %i.ca(ptr noundef nonnull align 8 dereferenceable(16) %i.bv, ptr noundef nonnull %i.ar) #11, !inline_history !525
  br label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.o
  %i.cb = getelementptr inbounds nuw i8, ptr %i.bs, i64 16
  %i.cc = load ptr, ptr %i.cb, align 8, !tbaa !488
