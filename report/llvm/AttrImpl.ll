...
bb.d:                                             ; preds = %_ZN4llvm16FoldingSetNodeID10AddBooleanEb.exit.i
  ...
  %3 = add nsw i32 %i.l, -1
  %4 = shl i32 %.sroa.0.0.copyload.i, 1
  %5 = ashr i32 %4, 31
  %i.m = add nsw i32 %3, %5                       ; 2 uses
...
bb.i:                                             ; preds = %_ZN4llvm16FoldingSetNodeID10AddBooleanEb.exit.i9
  ...
  %6 = add nsw i32 %i.ac, -1
  %7 = shl i32 %.sroa.0.0.copyload.i6, 1
  %8 = ashr i32 %7, 31
  %i.ad = add nsw i32 %6, %8                      ; 2 uses
...
bb.m:                                             ; preds = %_ZN4llvm16FoldingSetNodeID10AddBooleanEb.exit.i14
  ...
  %6 = add nsw i32 %i.aw, -1
  %7 = shl i32 %.sroa.0.0.copyload.i11, 1
  %8 = ashr i32 %7, 31
  %i.ax = add nsw i32 %6, %8                      ; 2 uses
