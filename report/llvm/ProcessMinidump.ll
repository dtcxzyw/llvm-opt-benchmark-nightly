...
bb.d:                                             ; preds = %bb.d, %_ZN12lldb_private6GetLogINS_7LLDBLogEEEPNS_3LogET_.exit
  ...
  %i.k = cmpxchg weak ptr %i.h, i32 %.06.i.i.i.i.i.i, i32 %i.j acq_rel monotonic, align 8, !noalias !881 ; 2 uses
  %i.l = extractvalue { i32, i1 } %i.k, 1
  %i.m = extractvalue { i32, i1 } %i.k, 0
  br i1 %i.l, label %_ZNKSt14__shared_countILN9__gnu_cxx12_Lock_policyE2EE16_M_get_use_countEv.exit.i.i.i.i, label %bb.d, !llvm.loop !6

_ZNKSt14__shared_countILN9__gnu_cxx12_Lock_policyE2EE16_M_get_use_countEv.exit.i.i.i.i: ; preds = %bb.d
  %i.n = load atomic i32, ptr %i.h monotonic, align 8, !noalias !881
...
bb.e:                                             ; preds = %_ZNKSt14__shared_countILN9__gnu_cxx12_Lock_policyE2EE16_M_get_use_countEv.exit.i.i.i.i
  ...
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !101, !noalias !881
...
bb.f:                                             ; preds = %_ZNKSt8weak_ptrIN12lldb_private6TargetEE4lockEv.exit.i
  ...
  store i32 0, ptr %i.u, align 4, !tbaa !44
  %i.v = load ptr, ptr %i.g, align 8, !tbaa !41
  %i.w = getelementptr inbounds nuw i8, ptr %i.v, i64 16
  %i.x = load ptr, ptr %i.w, align 8
  call void %i.x(ptr noundef nonnull align 8 dereferenceable(16) %i.g) #23, !inline_history !7
  %i.y = load ptr, ptr %i.g, align 8, !tbaa !41
  %i.z = getelementptr inbounds nuw i8, ptr %i.y, i64 24
  %i.aa = load ptr, ptr %i.z, align 8
  call void %i.aa(ptr noundef nonnull align 8 dereferenceable(16) %i.g) #23, !inline_history !7
...
bb.h:                                             ; preds = %bb.g
  ...
  store i32 %i.ac, ptr %i.h, align 8, !tbaa !50
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i: ; preds = %bb.i, %bb.h
  ...
  br i1 %i.ae, label %bb.j, label %_ZN12lldb_private7Process9GetTargetEv.exit, !prof !54
...
_ZN12lldb_private7Process9GetTargetEv.exit:       ; preds = %bb.f, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i, %bb.j
  ...
  %i.af = load ptr, ptr %0, align 8, !tbaa !110   ; 2 uses
...
bb.k:                                             ; preds = %_ZN12lldb_private7Process9GetTargetEv.exit
  %i.ag = load ptr, ptr %2, align 8, !tbaa !547   ; 3 uses
  %i.ah = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.ai = load i64, ptr %i.ah, align 8, !tbaa !546 ; 7 uses
  ...
  %i.ak = load ptr, ptr %i.aj, align 8, !tbaa !547
  %i.al = getelementptr inbounds nuw i8, ptr %i.aj, i64 8
  %i.am = load i64, ptr %i.al, align 8, !tbaa !546 ; 2 uses
...
bb.m:                                             ; preds = %.critedge
  ...
  store ptr @.str.10, ptr %8, align 8, !tbaa !70, !alias.scope !882
  %.sroa.22.0..sroa_idx.i.i.i.i.i = getelementptr inbounds nuw i8, ptr %8, i64 8
  store i64 27, ptr %.sroa.22.0..sroa_idx.i.i.i.i.i, align 8, !tbaa !103, !alias.scope !882
  %i.ar = getelementptr inbounds nuw i8, ptr %8, i64 16
  store ptr %i.aq, ptr %i.ar, align 8, !tbaa !529, !alias.scope !882
  %.sroa.2.0..sroa_idx.i.i.i.i.i = getelementptr inbounds nuw i8, ptr %8, i64 24
  store i64 1, ptr %.sroa.2.0..sroa_idx.i.i.i.i.i, align 8, !tbaa !103, !alias.scope !882
  %i.as = getelementptr inbounds nuw i8, ptr %8, i64 32
  store i8 1, ptr %i.as, align 8, !tbaa !533, !alias.scope !882
  %i.at = getelementptr inbounds nuw i8, ptr %8, i64 40 ; 2 uses
  store i64 %i.ap, ptr %i.at, align 8, !tbaa !590, !alias.scope !882
  %i.au = ptrtoint ptr %i.at to i64
  store ptr @_ZN4llvm12function_refIFvRNS_11raw_ostreamENS_9StringRefEEE11callback_fnINS_7support6detail13FormatFunctorIRS3_EEEEvlS2_S3_, ptr %i.aq, align 8, !alias.scope !882
  %.sroa.4.0..sroa_idx.i.i.i.i = getelementptr inbounds nuw i8, ptr %8, i64 56
  store i64 %i.au, ptr %.sroa.4.0..sroa_idx.i.i.i.i, align 8, !tbaa !28, !alias.scope !882
...
_ZN4llvmeqIhEEbNS_8ArrayRefIT_EES3_.exit.thread:  ; preds = %bb.l, %_ZN4llvmeqIhEEbNS_8ArrayRefIT_EES3_.exit
  %i.av = load ptr, ptr %0, align 8, !tbaa !110   ; 2 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.ax = load ptr, ptr %i.aw, align 8, !tbaa !53 ; 9 uses
...
bb.o:                                             ; preds = %bb.n
  %i.ba = load i32, ptr %i.ay, align 4, !tbaa !50
  %i.bb = add nsw i32 %i.ba, 1
  store i32 %i.bb, ptr %i.ay, align 4, !tbaa !50
...
_ZNSt10shared_ptrIN12lldb_private6ModuleEEC2ERKS2_.exit: ; preds = %_ZN4llvmeqIhEEbNS_8ArrayRefIT_EES3_.exit.thread, %bb.o, %bb.p
  %i.bd = load ptr, ptr %i.av, align 8, !tbaa !41
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 80
  %i.bf = load ptr, ptr %i.be, align 8
  %i.bg = call noundef ptr %i.bf(ptr noundef nonnull align 8 dereferenceable(952) %i.av) #23, !inline_history !871 ; 2 uses
...
bb.q:                                             ; preds = %_ZNSt10shared_ptrIN12lldb_private6ModuleEEC2ERKS2_.exit
  ...
  %i.bi = load ptr, ptr %6, align 8, !tbaa !593   ; 4 uses
...
_ZNSt6vectorIhSaIhEE14_M_fill_assignEmRKh.exit46.i: ; preds = %bb.q
  ...
  %i.bk = load i64, ptr %i.bj, align 8, !tbaa !883 ; 3 uses
  ...
  %i.br = load ptr, ptr %i.bq, align 8, !tbaa !884
  %i.bs = getelementptr inbounds nuw i8, ptr %i.bi, i64 104
  %i.bt = load i64, ptr %i.bs, align 8, !tbaa !885
  ...
  %i.cq = load ptr, ptr %7, align 8, !tbaa !605   ; 2 uses
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cq, i64 8
  %i.cs = load ptr, ptr %i.cr, align 8, !tbaa !887 ; 33 uses
  %i.ct = ptrtoaddr ptr %i.cs to i64              ; 4 uses
  %i.cu = getelementptr inbounds nuw i8, ptr %i.cq, i64 16
  %i.cv = load ptr, ptr %i.cu, align 8, !tbaa !888 ; 3 uses
...
iter.check:                                       ; preds = %_ZNSt6vectorIhSaIhEE14_M_fill_assignEmRKh.exit46.i
  ...
  %i.dn = load <16 x i8>, ptr %i.bv, align 1, !tbaa !28 ; 33 uses
  %11 = add i64 %i.ct, 16
  %umax183 = call i64 @llvm.umax.i64(i64 %i.cw, i64 %11)
  %i.do = xor i64 %i.ct, -1
  %i.dp = add i64 %umax183, %i.do                 ; 3 uses
...
vector.memcheck:                                  ; preds = %iter.check
  ...
  %12 = add i64 %i.ct, 16
  %umax = call i64 @llvm.umax.i64(i64 %i.cw, i64 %12)
  %i.ei = xor i64 %i.ct, -1
  %i.ej = add i64 %umax, %i.ei
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.fw = load i8, ptr %next.gep, align 1, !tbaa !28, !alias.scope !889
  %i.fx = load i8, ptr %next.gep216.a, align 1, !tbaa !28, !alias.scope !889
  %i.fy = load i8, ptr %next.gep217.a, align 1, !tbaa !28, !alias.scope !889
  %i.fz = load i8, ptr %next.gep218.a, align 1, !tbaa !28, !alias.scope !889
  %i.ga = load i8, ptr %next.gep219.a, align 1, !tbaa !28, !alias.scope !889
  %i.gb = load i8, ptr %next.gep220.a, align 1, !tbaa !28, !alias.scope !889
  %i.gc = load i8, ptr %next.gep221.a, align 1, !tbaa !28, !alias.scope !889
  %i.gd = load i8, ptr %next.gep222.a, align 1, !tbaa !28, !alias.scope !889
  %i.ge = load i8, ptr %next.gep223.a, align 1, !tbaa !28, !alias.scope !889
  %i.gf = load i8, ptr %next.gep224.a, align 1, !tbaa !28, !alias.scope !889
  %i.gg = load i8, ptr %next.gep225.a, align 1, !tbaa !28, !alias.scope !889
  %i.gh = load i8, ptr %next.gep226.a, align 1, !tbaa !28, !alias.scope !889
  %i.gi = load i8, ptr %next.gep227.a, align 1, !tbaa !28, !alias.scope !889
  %i.gj = load i8, ptr %next.gep228.a, align 1, !tbaa !28, !alias.scope !889
  %i.gk = load i8, ptr %next.gep229.a, align 1, !tbaa !28, !alias.scope !889
  %i.gl = load i8, ptr %next.gep230, align 1, !tbaa !28, !alias.scope !889
  ...
  %i.hd = load i8, ptr %next.gep, align 1, !tbaa !28, !alias.scope !889
  %i.he = load i8, ptr %next.gep216.a, align 1, !tbaa !28, !alias.scope !889
  %i.hf = load i8, ptr %next.gep217.a, align 1, !tbaa !28, !alias.scope !889
  %i.hg = load i8, ptr %next.gep218.a, align 1, !tbaa !28, !alias.scope !889
  %i.hh = load i8, ptr %next.gep219.a, align 1, !tbaa !28, !alias.scope !889
  %i.hi = load i8, ptr %next.gep220.a, align 1, !tbaa !28, !alias.scope !889
  %i.hj = load i8, ptr %next.gep221.a, align 1, !tbaa !28, !alias.scope !889
  %i.hk = load i8, ptr %next.gep222.a, align 1, !tbaa !28, !alias.scope !889
  %i.hl = load i8, ptr %next.gep223.a, align 1, !tbaa !28, !alias.scope !889
  %i.hm = load i8, ptr %next.gep224.a, align 1, !tbaa !28, !alias.scope !889
  %i.hn = load i8, ptr %next.gep225.a, align 1, !tbaa !28, !alias.scope !889
  %i.ho = load i8, ptr %next.gep226.a, align 1, !tbaa !28, !alias.scope !889
  %i.hp = load i8, ptr %next.gep227.a, align 1, !tbaa !28, !alias.scope !889
  %i.hq = load i8, ptr %next.gep228.a, align 1, !tbaa !28, !alias.scope !889
  %i.hr = load i8, ptr %next.gep229.a, align 1, !tbaa !28, !alias.scope !889
  %i.hs = load i8, ptr %next.gep230, align 1, !tbaa !28, !alias.scope !889
  ...
  %i.ja = load i8, ptr %i.ik, align 1, !tbaa !28, !alias.scope !889
  %i.jb = load i8, ptr %i.il, align 1, !tbaa !28, !alias.scope !889
  %i.jc = load i8, ptr %i.im, align 1, !tbaa !28, !alias.scope !889
  %i.jd = load i8, ptr %i.in, align 1, !tbaa !28, !alias.scope !889
  %i.je = load i8, ptr %i.io, align 1, !tbaa !28, !alias.scope !889
  %i.jf = load i8, ptr %i.ip, align 1, !tbaa !28, !alias.scope !889
  %i.jg = load i8, ptr %i.iq, align 1, !tbaa !28, !alias.scope !889
  %i.jh = load i8, ptr %i.ir, align 1, !tbaa !28, !alias.scope !889
end_hunk_0
