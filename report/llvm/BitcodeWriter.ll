...
bb.ak:                                            ; preds = %.lr.ph1077, %bb.ax
  ...
  %.not.i.i.i274 = icmp eq i32 %i.mr, 0           ; 2 uses
  %i.ms = trunc nuw nsw i32 %i.mr to i8
  %i.mt = add nsw i8 %i.ms, -1                    ; 2 uses
  %i.mu = trunc nuw i8 %.sroa.6922.01074 to i1
  %i.mv = call i8 @llvm.umax.i8(i8 %.sroa.0152.0.copyload10691072, i8 %i.mt)
  %.sroa.0152.0.copyload = select i1 %i.mu, i8 %i.mv, i8 %i.mt
