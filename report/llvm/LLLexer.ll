...
_ZN4llvm7LLLexer11HexIntToValEPKcS2_.exit:        ; preds = %bb.i, %bb.j
  %.2.i = phi i64 [ 0, %bb.j ], [ %i.z, %bb.i ]
  ...
  br i1 %i.ag, label %bb.k, label %_ZN4llvm5APIntD2Ev.exit

bb.k:                                             ; preds = %_ZN4llvm7LLLexer11HexIntToValEPKcS2_.exit
  %i.ah = load ptr, ptr %6, align 8, !tbaa !42    ; 2 uses
  %i.ai = icmp eq ptr %i.ah, null
  br i1 %i.ai, label %_ZN4llvm5APIntD2Ev.exit, label %bb.l

bb.l:                                             ; preds = %bb.k
  call void @_ZdaPv(ptr noundef nonnull %i.ah) #16
  br label %_ZN4llvm5APIntD2Ev.exit

_ZN4llvm5APIntD2Ev.exit:                          ; preds = %_ZN4llvm7LLLexer11HexIntToValEPKcS2_.exit, %bb.k, %bb.l
...
._crit_edge.i:                                    ; preds = %.lr.ph.i, %.lr.ph.i.1, %.lr.ph.i.2, %.lr.ph.i.3, %bb.o
  %.021.lcssa.i = phi ptr [ %i.aj, %bb.o ], [ %i.ar, %.lr.ph.i ], [ %i.ba, %.lr.ph.i.1 ], [ %i.bj, %.lr.ph.i.2 ], [ %i.bs, %.lr.ph.i.3 ] ; 2 uses
...
._crit_edge28.i:                                  ; preds = %.lr.ph27.i
  br i1 %i.cf, label %bb.p, label %_ZN4llvm7LLLexer16FP80HexToIntPairEPKcS2_Pm.exit
...
bb.s:                                             ; preds = %bb.m
  ...
  br i1 %i.cw, label %_ZN4llvm5APIntD2Ev.exit15, label %bb.t

bb.t:                                             ; preds = %bb.s
  %i.cx = load ptr, ptr %i.ct, align 8, !tbaa !42 ; 2 uses
  %i.cy = icmp eq ptr %i.cx, null
  br i1 %i.cy, label %_ZN4llvm5APIntD2Ev.exit15, label %bb.u
...
bb.v:                                             ; preds = %bb.m
  ...
  br i1 %i.dg, label %_ZN4llvm5APIntD2Ev.exit17, label %bb.w
