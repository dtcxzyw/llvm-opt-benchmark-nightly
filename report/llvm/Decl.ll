...
bb.d:                                             ; preds = %5
  ...
  %.pre = load i8, ptr %.phi.trans.insert, align 8, !tbaa !466
  br label %.thread.i
...
._crit_edge.i.i.i:                                ; preds = %.thread.i
  %.pre.i.i.i = load ptr, ptr %7, align 8, !tbaa !791
  br label %_ZNK5clang7VarDecl7getInitEv.exit
...
bb.h:                                             ; preds = %.thread.i
  ...
  %i.at = load i64, ptr %7, align 8, !tbaa !709
  ...
  store ptr %i.av, ptr %7, align 8, !tbaa !791
  br label %_ZNK5clang7VarDecl7getInitEv.exit
