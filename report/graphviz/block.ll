...
_ZNKSt6vectorIP8VariableSaIS1_EE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.c
  ...
  %i.r = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.q) #12 ; 4 uses
...
bb.f:                                             ; preds = %_ZNSt6vectorIP8VariableSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i
  ...
  %i.x = sub i64 %i.w, %i.i
  tail call void @_ZdlPvm(ptr noundef nonnull %i.g, i64 noundef %i.x) #13
...
_ZNKSt6vectorIP10ConstraintSaIS1_EE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.f
  ...
  %i.ap = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.ao) #12
...
_ZNKSt6vectorIP8VariableSaIS1_EE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.d
  ...
  %i.ao = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.an) #12 ; 4 uses
...
bb.g:                                             ; preds = %_ZNSt6vectorIP8VariableSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %i.ad, i64 noundef %i.au) #13
  br label %_ZNSt6vectorIP8VariableSaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i
...
_ZNKSt6vectorIP10ConstraintSaIS1_EE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.f
  ...
  %i.ad = select i1 %i.ab, i64 1152921504606846975, i64 %i.ac ; 2 uses
  %i.ae = shl nuw nsw i64 %i.ad, 3
  %i.af = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.ae) #12
...
_ZNKSt6vectorIP10ConstraintSaIS1_EE12_M_check_lenEmPKc.exit.i.i.i: ; preds = %bb.l
  ...
  %i.bh = select i1 %i.bf, i64 1152921504606846975, i64 %i.bg ; 2 uses
  %i.bi = shl nuw nsw i64 %i.bh, 3
  %i.bj = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.bi) #12
...
bb.o:                                             ; preds = %_ZNSt6vectorIP10ConstraintSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i.i
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %i.ay, i64 noundef %i.bp) #13
...
bb.ac:                                            ; preds = %bb.ab
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.024.0.lcssa127, i64 noundef %i.ia) #13
  br label %_ZNSt6vectorIP10ConstraintSaIS1_EED2Ev.exit
...
bb.ae:                                            ; preds = %bb.ad
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.024.060, i64 noundef %i.id) #13
