...
vector.memcheck:                                  ; preds = %.preheader.us.us
  ...
  %bound074 = icmp ult ptr %invariant.gep66, %scevgep73
...
.preheader.lr.ph.us.us:                           ; preds = %.preheader37.us.us
  ...
  %invariant.gep66 = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %i.aw ; 6 uses
  ...
  %bound0 = icmp ult ptr %invariant.gep66, %scevgep71
