...
begin_hunk_0_@fig_ellipse:fig_line_style.exit
  %i.l = tail call double @llvm.round.f64(double %i.d)
  %i.m = load double, ptr %1, align 8, !tbaa !45  ; 2 uses
  %i.n = tail call double @llvm.round.f64(double %i.m) ; 2 uses
  %i.o = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.p = load double, ptr %i.o, align 8, !tbaa !46 ; 2 uses
  %i.q = tail call double @llvm.round.f64(double %i.p) ; 2 uses
  %i.r = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.s = load double, ptr %i.r, align 8, !tbaa !45 ; 2 uses
...
fig_line_style.exit:
  ...
  %i.j = load i32, ptr @Depth, align 4, !tbaa !36
  %.not = icmp eq i32 %3, 0
  %i.k = select i1 %.not, i32 -1, i32 20
  %i.l = add i64 %2, 1
  %i.m = getelementptr i8, ptr %i.b, i64 168
  %.val = load i32, ptr %i.m, align 8, !tbaa !44  ; 2 uses
...
.lr.ph.i:                                         ; preds = %fig_line_style.exit, %.lr.ph.i
  ...
  %i.o = load double, ptr %i.n, align 8, !tbaa !45
...
._crit_edge:                                      ; preds = %.lr.ph, %bb.b
  %.053.lcssa = phi i32 [ 1, %bb.b ], [ %i.bl, %.lr.ph ] ; 4 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  call void (ptr, ptr, ...) @agxbprint(ptr noundef %5, ptr nonnull poison, double noundef %i.au, double noundef %i.av)
  %i.aw = call { double, double } @Bezier(ptr noundef nonnull %4, double noundef f0x3FD5555555555555, ptr noundef null, ptr noundef null) #16 ; 2 uses
  %i.ax = extractvalue { double, double } %i.aw, 0
  %i.ay = extractvalue { double, double } %i.aw, 1
  call void (ptr, ptr, ...) @agxbprint(ptr noundef %5, ptr nonnull poison, double noundef %i.ax, double noundef %i.ay)
  %i.az = call { double, double } @Bezier(ptr noundef nonnull %4, double noundef 5.000000e-01, ptr noundef null, ptr noundef null) #16 ; 2 uses
  %i.ba = extractvalue { double, double } %i.az, 0
  %i.bb = extractvalue { double, double } %i.az, 1
  call void (ptr, ptr, ...) @agxbprint(ptr noundef %5, ptr nonnull poison, double noundef %i.ba, double noundef %i.bb)
  %i.bc = call { double, double } @Bezier(ptr noundef nonnull %4, double noundef f0x3FE5555555555555, ptr noundef null, ptr noundef null) #16 ; 2 uses
  %i.bd = extractvalue { double, double } %i.bc, 0
  %i.be = extractvalue { double, double } %i.bc, 1
  call void (ptr, ptr, ...) @agxbprint(ptr noundef %5, ptr nonnull poison, double noundef %i.bd, double noundef %i.be)
  %i.bf = call { double, double } @Bezier(ptr noundef nonnull %4, double noundef f0x3FEAAAAAAAAAAAAB, ptr noundef null, ptr noundef null) #16 ; 2 uses
  %i.bg = extractvalue { double, double } %i.bf, 0
  %i.bh = extractvalue { double, double } %i.bf, 1
  call void (ptr, ptr, ...) @agxbprint(ptr noundef %5, ptr nonnull poison, double noundef %i.bg, double noundef %i.bh)
  %i.bi = call { double, double } @Bezier(ptr noundef nonnull %4, double noundef 1.000000e+00, ptr noundef null, ptr noundef null) #16 ; 2 uses
...
._crit_edge69:                                    ; preds = %bb.h, %agxbfree.exit
  %i.bo = call i32 @gvputs(ptr noundef nonnull %0, ptr noundef nonnull @.str.32) #16 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #16
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #16
  ret void

bb.h:                                             ; preds = %.lr.ph68, %bb.h
  %.067 = phi i32 [ 0, %.lr.ph68 ], [ %i.br, %bb.h ] ; 2 uses
  %i.bp = srem i32 %.067, %i.am
  %.not59 = icmp ne i32 %i.bp, 0
  %i.bq = zext i1 %.not59 to i32
  call void (ptr, ptr, ...) @gvprintf(ptr noundef nonnull %0, ptr noundef nonnull @.str.35, i32 noundef %i.bq) #16
  %i.br = add nuw nsw i32 %.067, 1                ; 2 uses
  %exitcond.not = icmp eq i32 %i.br, %.053.lcssa
