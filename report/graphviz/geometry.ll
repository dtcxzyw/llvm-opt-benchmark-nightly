Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/graphviz/original/geometry?download=true
inline.NumInlined: 1
begin_hunk_0
...
bb.a:
  ...
  store double %i.b, ptr %i.c, align 8, !tbaa !11
  ret void
}
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.l = insertelement <2 x double> poison, double %5, i64 0
  ...
  %i.s = fmul <2 x double> %i.r, %i.n
  %i.t = insertelement <2 x double> poison, double %0, i64 0 ; 2 uses
  ...
  %i.x = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.u, <2 x double> %i.w, <2 x double> %i.s) ; 2 uses
  %i.y = extractelement <2 x double> %i.x, i64 0
  %i.z = tail call double @llvm.fmuladd.f64(double %4, double %i.e, double %i.y)
  %i.aa = fneg double %i.z
  %i.ab = extractelement <2 x double> %i.x, i64 1
  %i.ac = tail call double @llvm.fmuladd.f64(double %6, double %9, double %i.ab)
  %i.ad = insertelement <2 x double> poison, double %i.ac, i64 0
  %i.ae = insertelement <2 x double> %i.ad, double %i.aa, i64 1
  %i.af = insertelement <2 x double> poison, double %i.h, i64 0
  %i.ag = shufflevector <2 x double> %i.af, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ah = fdiv <2 x double> %i.ae, %i.ag          ; 2 uses
  %i.ai = shufflevector <2 x double> %i.ah, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1> ; 2 uses
  %i.aj = shufflevector <2 x double> %i.ah, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ak = insertelement <2 x double> poison, double %i.p, i64 0
  %i.al = insertelement <2 x double> %i.ak, double %i.e, i64 1
  %i.am = insertelement <2 x double> %i.t, double %1, i64 1
  %i.an = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.aj, <2 x double> %i.al, <2 x double> %i.am)
  store <2 x double> %i.an, ptr %8, align 8, !tbaa !15
  %i.ao = fcmp ole <4 x double> %i.ai, <double 1.000000e+00, double 1.000000e+00, double 0.000000e+00, double 0.000000e+00>
  %i.ap = fcmp oge <4 x double> %i.ai, <double 1.000000e+00, double 1.000000e+00, double 0.000000e+00, double 0.000000e+00>
  %i.aq = shufflevector <4 x i1> %i.ao, <4 x i1> %i.ap, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.ar = freeze <4 x i1> %i.aq
  %i.as = bitcast <4 x i1> %i.ar to i4
  %i.at = icmp eq i4 %i.as, -1
  %. = zext i1 %i.at to i32
  br label %bb.c
