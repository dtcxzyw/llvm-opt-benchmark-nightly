...
.preheader550.us:                                 ; preds = %.preheader550.us.preheader, %._crit_edge569.us
  %indvars.iv729 = phi i64 [ 0, %.preheader550.us.preheader ], [ %indvars.iv.next730, %._crit_edge569.us ] ; 2 uses
  %.0413572.us = phi double [ 1.000000e+00, %.preheader550.us.preheader ], [ %.lcssa974, %._crit_edge569.us ] ; 2 uses
  %i.bm = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv729
  %i.bn = load ptr, ptr %i.bm, align 8, !tbaa !62 ; 2 uses
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.ph

vector.ph:                                        ; preds = %.preheader550.us
  %broadcast.splatinsert = insertelement <2 x double> poison, double %.0413572.us, i64 0
  %broadcast.splat = shufflevector <2 x double> %broadcast.splatinsert, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 3 uses
  %vec.phi = phi <2 x double> [ %broadcast.splat, %vector.ph ], [ %i.bs, %vector.body ] ; 2 uses
  %vec.phi976 = phi <2 x double> [ %broadcast.splat, %vector.ph ], [ %i.bt, %vector.body ] ; 2 uses
  %i.bo = getelementptr inbounds nuw [8 x i8], ptr %i.bn, i64 %index ; 2 uses
  %i.bp = getelementptr inbounds nuw i8, ptr %i.bo, i64 16
  %wide.load = load <2 x double>, ptr %i.bo, align 8, !tbaa !64
  %wide.load977 = load <2 x double>, ptr %i.bp, align 8, !tbaa !64
  %i.bq = tail call nsz <2 x double> @llvm.fabs.v2f64(<2 x double> %wide.load) ; 2 uses
  %i.br = tail call nsz <2 x double> @llvm.fabs.v2f64(<2 x double> %wide.load977) ; 2 uses
  %i.bs = tail call nsz <2 x double> @llvm.maxnum.v2f64(<2 x double> %vec.phi, <2 x double> %i.bq) ; 2 uses
  %i.bt = tail call nsz <2 x double> @llvm.maxnum.v2f64(<2 x double> %vec.phi976, <2 x double> %i.br) ; 2 uses
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.bu = fcmp uno <2 x double> %i.bq, %i.br
  %i.bv = freeze <2 x i1> %i.bu
  %i.bw = bitcast <2 x i1> %i.bv to i2
  %i.bx = icmp ne i2 %i.bw, 0                     ; 5 uses
  %i.by = icmp eq i64 %index.next, %n.vec
  %i.bz = or i1 %i.bx, %i.by
  br i1 %i.bz, label %middle.block, label %vector.body, !llvm.loop !11

middle.block:                                     ; preds = %vector.body
  %i.ca = select i1 %i.bx, <2 x double> %vec.phi, <2 x double> %i.bs
  %i.cb = select i1 %i.bx, <2 x double> %vec.phi976, <2 x double> %i.bt
  %i.cc = select i1 %i.bx, i64 %index, i64 %n.vec
  %rdx.minmax = tail call nsz <2 x double> @llvm.maxnum.v2f64(<2 x double> %i.ca, <2 x double> %i.cb)
  %i.cd = tail call nsz double @llvm.vector.reduce.fmax.v2f64(<2 x double> %rdx.minmax) ; 2 uses
  %.not1055 = or i1 %cmp.n, %i.bx
  br i1 %.not1055, label %scalar.ph.preheader, label %._crit_edge569.us

scalar.ph.preheader:                              ; preds = %.preheader550.us, %middle.block
  %indvars.iv724.ph = phi i64 [ 0, %.preheader550.us ], [ %i.cc, %middle.block ]
  %.1414566.us.ph = phi double [ %.0413572.us, %.preheader550.us ], [ %i.cd, %middle.block ]
  br label %scalar.ph
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %exitcond728.not, label %._crit_edge569.us, label %scalar.ph, !llvm.loop !12
...
._crit_edge569.us:                                ; preds = %scalar.ph, %middle.block
  ...
  br i1 %exitcond733.not, label %.preheader548.lr.ph, label %.preheader550.us, !llvm.loop !13
...
.preheader548:                                    ; preds = %.preheader548.lr.ph, %._crit_edge576
  ...
  %i.ck = load ptr, ptr %i.cj, align 8, !tbaa !62 ; 2 uses
...
vector.body984:                                   ; preds = %.preheader548, %vector.body984
  ...
  %wide.load986 = load <2 x double>, ptr %i.cl, align 8, !tbaa !64
  %wide.load987 = load <2 x double>, ptr %i.cm, align 8, !tbaa !64
  %i.cn = fmul <2 x double> %broadcast.splat983, %wide.load986
  %i.co = fmul <2 x double> %broadcast.splat983, %wide.load987
  store <2 x double> %i.cn, ptr %i.cl, align 8, !tbaa !64
  store <2 x double> %i.co, ptr %i.cm, align 8, !tbaa !64
  %index.next988 = add nuw i64 %index985, 4       ; 2 uses
  %i.cp = icmp eq i64 %index.next988, %n.vec981
  br i1 %i.cp, label %middle.block989, label %vector.body984, !llvm.loop !14
...
._crit_edge576:                                   ; preds = %scalar.ph978, %middle.block989
  ...
  br i1 %exitcond743.not, label %.lr.ph579.preheader, label %.preheader548, !llvm.loop !15
...
scalar.ph978:                                     ; preds = %scalar.ph978.preheader, %scalar.ph978
  ...
  store double %i.cs, ptr %i.cq, align 8, !tbaa !64
  ...
  br i1 %exitcond738.not, label %._crit_edge576, label %scalar.ph978, !llvm.loop !16
...
.lr.ph579:                                        ; preds = %.lr.ph579.preheader, %.lr.ph579
  ...
  br i1 %exitcond748.not, label %._crit_edge580, label %.lr.ph579, !llvm.loop !17

._crit_edge580:                                   ; preds = %.lr.ph579, %.preheader551
  %i.cv = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.cw = load ptr, ptr %i.cv, align 8, !tbaa !62 ; 3 uses
  %i.cx = load double, ptr %i.cw, align 8, !tbaa !64 ; 2 uses
...
vector.body998:                                   ; preds = %vector.body998, %vector.ph994
  ...
  %wide.load1000 = load <2 x double>, ptr %i.cy, align 8, !tbaa !64
  %wide.load1001 = load <2 x double>, ptr %i.cz, align 8, !tbaa !64
  %i.da = fsub <2 x double> %wide.load1000, %broadcast.splat997
  %i.db = fsub <2 x double> %wide.load1001, %broadcast.splat997
  store <2 x double> %i.da, ptr %i.cy, align 8, !tbaa !64
  store <2 x double> %i.db, ptr %i.cz, align 8, !tbaa !64
  %index.next1002 = add nuw i64 %index999, 4      ; 2 uses
  %i.dc = icmp eq i64 %index.next1002, %n.vec995
  br i1 %i.dc, label %middle.block1003, label %vector.body998, !llvm.loop !18
...
.lr.ph583:                                        ; preds = %.lr.ph583.preheader1067, %.lr.ph583
  ...
  store double %i.df, ptr %i.dd, align 8, !tbaa !64
  ...
  br i1 %exitcond753.not, label %._crit_edge584, label %.lr.ph583, !llvm.loop !19

._crit_edge584:                                   ; preds = %.lr.ph583, %middle.block1003, %._crit_edge580
  %i.dg = load i8, ptr @Verbose, align 1, !tbaa !58
  %.not481 = icmp eq i8 %i.dg, 0
  br i1 %.not481, label %bb.t, label %bb.s

bb.s:                                             ; preds = %._crit_edge584
  %i.dh = load ptr, ptr @stderr, align 8, !tbaa !60
...
bb.w:                                             ; preds = %bb.v
  %i.dv = load ptr, ptr @stderr, align 8, !tbaa !60
...
bb.y:                                             ; preds = %bb.x
  %i.dz = load ptr, ptr @stderr, align 8, !tbaa !60
...
.preheader546:                                    ; preds = %.preheader546.lr.ph, %._crit_edge589
  ...
  %i.ei = sub i32 %i.eg, %.6617                   ; 8 uses
  %i.ej = zext i32 %indvars.iv757 to i64
  %i.ek = shl nuw nsw i64 %i.ej, 2
  %i.el = icmp sgt i32 %i.do, %.6617
  br i1 %i.el, label %.lr.ph588, label %._crit_edge589

.lr.ph588:                                        ; preds = %.preheader546
  %i.em = icmp slt i32 %.6617, %1
  %i.en = sub nsw i32 %1, %.6617                  ; 12 uses
  %i.eo = and i32 %.6617, 1
  %.not488 = icmp eq i32 %i.eo, 0                 ; 2 uses
  %i.ep = sext i32 %.0407619 to i64               ; 12 uses
  br i1 %i.em, label %.lr.ph588.split, label %.lr.ph588.split.us
...
.lr.ph588.split.us.split.preheader:               ; preds = %.lr.ph588.split.us
  %indvars.iv.next755.peel = add nsw i64 %i.ep, 1 ; 2 uses
  %i.eq = getelementptr inbounds [4 x i8], ptr %i.ec, i64 %i.ep
  store float 0.000000e+00, ptr %i.eq, align 4, !tbaa !55
...
.lr.ph588.split.us.split.peel.next:               ; preds = %.lr.ph588.split.us.split.preheader
  %indvars.iv.next755.peel765 = add nsw i64 %i.ep, 2 ; 4 uses
  %i.er = getelementptr inbounds [4 x i8], ptr %i.ec, i64 %indvars.iv.next755.peel
  store float %.mux.peel, ptr %i.er, align 4, !tbaa !55
...
.lr.ph588.split.us.split.preheader966:            ; preds = %.lr.ph588.split.us.split.peel.next
  %i.es = zext i32 %i.ei to i64                   ; 2 uses
  %min.iters.check1007 = icmp ult i32 %i.ei, 8
...
vector.ph1008:                                    ; preds = %.lr.ph588.split.us.split.preheader966
  %n.vec1009 = and i64 %i.es, 4294967288          ; 4 uses
...
vector.body1010:                                  ; preds = %vector.body1010, %vector.ph1008
  ...
  store <4 x float> zeroinitializer, ptr %i.ex, align 4, !tbaa !55
  store <4 x float> zeroinitializer, ptr %i.ey, align 4, !tbaa !55
  %index.next1012 = add nuw i64 %index1011, 8     ; 2 uses
  %i.ez = icmp eq i64 %index.next1012, %n.vec1009
  br i1 %i.ez, label %middle.block1013, label %vector.body1010, !llvm.loop !20

middle.block1013:                                 ; preds = %vector.body1010
  %cmp.n1014 = icmp eq i64 %n.vec1009, %i.es
...
.lr.ph588.split.us.split.us.preheader:            ; preds = %.lr.ph588.split.us
  %i.fa = shl nsw i64 %i.ep, 2
  %scevgep = getelementptr i8, ptr %i.ec, i64 %i.fa
  tail call void @llvm.memset.p0.i64(ptr align 4 %scevgep, i8 0, i64 %i.ek, i1 false), !tbaa !55
...
.lr.ph588.split.us.split:                         ; preds = %.lr.ph588.split.us.split.preheader1064, %.lr.ph588.split.us.split
  ...
  store float 0.000000e+00, ptr %i.fd, align 4, !tbaa !55
  %i.fe = add nuw nsw i32 %.0405587.us, 1         ; 2 uses
  %exitcond759.not = icmp eq i32 %i.fe, %indvars.iv757
  br i1 %exitcond759.not, label %._crit_edge589.loopexit704, label %.lr.ph588.split.us.split, !llvm.loop !21
...
.lr.ph588.split.split.us:                         ; preds = %bb.ab, %.lr.ph588.split.split.us.preheader.new
  %indvars.iv798 = phi i64 [ %i.ep, %.lr.ph588.split.split.us.preheader.new ], [ %indvars.iv.next799.1, %bb.ab ] ; 3 uses
  ...
  %i.fg = icmp slt i32 %.0405587.us594, %i.en
...
bb.z:                                             ; preds = %.lr.ph588.split.split.us
  ...
  %i.fk = load float, ptr %i.fj, align 4, !tbaa !55
...
.lr.ph588.split.split.us.1:                       ; preds = %.lr.ph588.split.split.us, %bb.z
  ...
  store float %.0406.us599, ptr %i.fl, align 4, !tbaa !55
  %i.fm = or disjoint i32 %.0405587.us594, 1
  %i.fn = icmp slt i32 %i.fm, %i.en
...
bb.aa:                                            ; preds = %.lr.ph588.split.split.us.1
  ...
  %i.fr = load float, ptr %i.fq, align 4, !tbaa !55
  br label %bb.ab
...
bb.ab:                                            ; preds = %bb.aa, %.lr.ph588.split.split.us.1
  ...
  store float %.0406.us599.1, ptr %i.ft, align 4, !tbaa !55
  ...
  br i1 %niter1098.ncmp.1, label %._crit_edge589.loopexit.unr-lcssa, label %.lr.ph588.split.split.us, !llvm.loop !22

.lr.ph588.split.split:                            ; preds = %.lr.ph588.split
  %i.fv = icmp sgt i32 %i.en, 0                   ; 2 uses
...
bb.ac:                                            ; preds = %.lr.ph588.split.split.split.us.preheader
  ...
  %i.fz = load float, ptr %i.fy, align 4, !tbaa !55
  br label %bb.ad
...
bb.ad:                                            ; preds = %.lr.ph588.split.split.split.us.preheader, %bb.ac
  ...
  %indvars.iv.next775.peel = add nsw i64 %i.ep, 1 ; 2 uses
  %i.ga = getelementptr inbounds [4 x i8], ptr %i.ec, i64 %i.ep
  store float %.0406.us608.peel, ptr %i.ga, align 4, !tbaa !55
...
bb.ae:                                            ; preds = %.lr.ph588.split.split.split.us.peel.next
  ...
  %i.gf = load float, ptr %i.ge, align 4, !tbaa !55
  br label %bb.af
...
bb.af:                                            ; preds = %.lr.ph588.split.split.split.us.peel.next, %bb.ae
  ...
  %indvars.iv.next775.peel783 = add nsw i64 %i.ep, 2 ; 3 uses
  %i.gg = getelementptr inbounds [4 x i8], ptr %i.ec, i64 %indvars.iv.next775.peel
  store float %.0406.us608.peel782, ptr %i.gg, align 4, !tbaa !55
...
.lr.ph588.split.split.split.us.preheader1063:     ; preds = %bb.af
  %xtraiter1075 = and i32 %i.ei, 1
  %i.gh = icmp eq i32 %i.eh, %.6617
...
.lr.ph588.split.split.split.us.preheader1063.new: ; preds = %.lr.ph588.split.split.split.us.preheader1063
  %unroll_iter1081 = and i32 %i.ei, -2
