...
intersect.exit.i:                                 ; preds = %inBetween.exit42.i.i, %.split43.i.i, %bb.m
  ...
  %1 = extractelement <2 x double> %i.if, i64 1
  %2 = fcmp ogt double %1, 1.000000e-04
  %i.ig = fcmp olt <2 x double> %i.if, splat (double -1.000000e-04) ; 2 uses
  %3 = extractelement <2 x i1> %i.ig, i64 1
  %4 = sext i1 %3 to i32
  %5 = select i1 %2, i32 1, i32 %4
  %6 = extractelement <2 x double> %i.if, i64 0
  %7 = fcmp ogt double %6, 1.000000e-04
  %8 = extractelement <2 x i1> %i.ig, i64 0
  %9 = sext i1 %8 to i32
  %10 = select i1 %7, i32 1, i32 %9
  %11 = mul nsw i32 %i.hg, %i.gj
  %12 = icmp slt i32 %11, 0
  %13 = mul nsw i32 %5, %10
  %i.ih = icmp slt i32 %13, 0
  %i.ii = select i1 %12, i1 %i.ih, i1 false
...
.lr.ph.preheader.i:                               ; preds = %bb.i
  ...
  %i.cu = insertelement <2 x double> %i.bi, double %2, i64 1 ; 2 uses
...
.lr.ph27.i.preheader:                             ; preds = %.preheader.i.loopexit
  %5 = shufflevector <2 x double> %i.bi, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.cy = insertelement <2 x double> %5, double %3, i64 1
  br label %.lr.ph27.i
...
intersect.exit131:                                ; preds = %bb.l, %.split43.i125, %inBetween.exit42.i123
  ...
  %6 = shufflevector <2 x double> %i.df, <2 x double> poison, <2 x i32> zeroinitializer
  %i.fb = fsub <2 x double> %i.cu, %6
  %7 = shufflevector <2 x double> %i.df, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %8 = fsub <2 x double> %i.cv, %7
  %9 = extractelement <2 x double> %i.fa, i64 0
  %10 = fneg double %9
  %i.fc = insertelement <2 x double> poison, double %10, i64 0
  %i.fd = shufflevector <2 x double> %i.fc, <2 x double> poison, <2 x i32> zeroinitializer
  %i.fe = fmul <2 x double> %8, %i.fd
  %i.ff = shufflevector <2 x double> %i.fa, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.fg = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ff, <2 x double> %i.fb, <2 x double> %i.fe) ; 3 uses
...
intersect.exit:                                   ; preds = %bb.o, %.split43.i, %inBetween.exit42.i
  ...
  %i.ia = fsub <2 x double> %i.cu, %i.hz
  ...
  %i.ij = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ii, <2 x double> %i.ia, <2 x double> %i.ih) ; 3 uses
  %11 = extractelement <2 x double> %i.ij, i64 1
  %12 = fcmp ogt double %11, 1.000000e-04
  %i.ik = fcmp olt <2 x double> %i.ij, splat (double -1.000000e-04) ; 2 uses
  %13 = extractelement <2 x i1> %i.ik, i64 1
  %14 = sext i1 %13 to i32
  %15 = select i1 %12, i32 1, i32 %14
  %16 = extractelement <2 x double> %i.ij, i64 0
  %17 = fcmp ogt double %16, 1.000000e-04
  %18 = extractelement <2 x i1> %i.ik, i64 0
  %19 = sext i1 %18 to i32
  %20 = select i1 %17, i32 1, i32 %19
  %21 = mul nsw i32 %i.hk, %i.gn
  %22 = icmp slt i32 %21, 0
  %23 = mul nsw i32 %15, %20
  %i.il = icmp slt i32 %23, 0
  %i.im = select i1 %22, i1 %i.il, i1 false       ; 2 uses
...
bb.q:                                             ; preds = %.lr.ph191, %clear.exit119.thread179
  ...
  %24 = extractelement <2 x double> %i.iz, i64 0  ; 10 uses
...
.lr.ph.preheader.i113:                            ; preds = %bb.r
  %i.kk = fcmp une double %2, %24                 ; 2 uses
...
.preheader.i102:                                  ; preds = %bb.s, %bb.r
  %i.kp = fcmp une double %2, %24                 ; 2 uses
  %i.kq = insertelement <2 x double> %i.iz, double %2, i64 1
  %25 = shufflevector <2 x double> %i.iz, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.kr = insertelement <2 x double> %25, double %3, i64 1
...
.split.i149:                                      ; preds = %bb.t
  ...
  %i.lo = fcmp olt double %i.lm, %24
  %or.cond.i.i150 = and i1 %i.ln, %i.lo
  %i.lp = fcmp olt double %24, %i.lm
...
.split43.i145:                                    ; preds = %bb.v
  ...
  %i.mk = fcmp olt double %i.lc, %24
  %or.cond.i41.i146 = and i1 %i.mj, %i.mk
  %i.ml = fcmp olt double %24, %i.lc
...
intersect.exit151:                                ; preds = %bb.u, %.split43.i145, %inBetween.exit42.i143
  ...
  %26 = shufflevector <2 x double> %i.la, <2 x double> poison, <2 x i32> zeroinitializer
  %i.mw = fsub <2 x double> %i.kl, %26
  %27 = shufflevector <2 x double> %i.la, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %28 = fsub <2 x double> %i.km, %27
  %29 = extractelement <2 x double> %i.mv, i64 0
  %30 = fneg double %29
  %i.mx = insertelement <2 x double> poison, double %30, i64 0
  %i.my = shufflevector <2 x double> %i.mx, <2 x double> poison, <2 x i32> zeroinitializer
  %i.mz = fmul <2 x double> %28, %i.my
  %i.na = shufflevector <2 x double> %i.mv, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.nb = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.na, <2 x double> %i.mw, <2 x double> %i.mz) ; 3 uses
...
.split.i139:                                      ; preds = %bb.w
  ...
  %i.om = fcmp olt double %i.ok, %24
  %or.cond.i.i140 = and i1 %i.ol, %i.om
  %i.on = fcmp olt double %24, %i.ok
...
.split43.i135:                                    ; preds = %bb.y
  ...
  %i.pi = fcmp olt double %i.oa, %24
  %or.cond.i41.i136 = and i1 %i.ph, %i.pi
  %i.pj = fcmp olt double %24, %i.oa
...
intersect.exit141:                                ; preds = %bb.x, %.split43.i135, %inBetween.exit42.i133
  ...
  %i.qe = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.qd, <2 x double> %i.pv, <2 x double> %i.qc) ; 3 uses
  %31 = extractelement <2 x double> %i.qe, i64 1
  %32 = fcmp ogt double %31, 1.000000e-04
  %i.qf = fcmp olt <2 x double> %i.qe, splat (double -1.000000e-04) ; 2 uses
  %33 = extractelement <2 x i1> %i.qf, i64 1
  %34 = sext i1 %33 to i32
  %35 = select i1 %32, i32 1, i32 %34
  %36 = extractelement <2 x double> %i.qe, i64 0
  %37 = fcmp ogt double %36, 1.000000e-04
  %38 = extractelement <2 x i1> %i.qf, i64 0
  %39 = sext i1 %38 to i32
  %40 = select i1 %37, i32 1, i32 %39
  %41 = mul nsw i32 %i.pf, %i.oi
  %42 = icmp slt i32 %41, 0
  %43 = mul nsw i32 %35, %40
  %i.qg = icmp slt i32 %43, 0
  %i.qh = select i1 %42, i1 %i.qg, i1 false       ; 2 uses
