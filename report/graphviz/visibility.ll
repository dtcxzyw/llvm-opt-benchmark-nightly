...
bb.f:                                             ; preds = %bb.g, %bb.e
  ...
  br i1 %i.w, label %bb.g, label %polyhit.exit.thread155
...
polyhit.exit:                                     ; preds = %gv_calloc.exit
  ...
  br i1 %i.aj, label %bb.h, label %polyhit.exit.thread155

bb.h:                                             ; preds = %polyhit.exit.thread, %polyhit.exit
  %.0154 = phi i32 [ %i.ai, %polyhit.exit.thread ], [ %1, %polyhit.exit ]
  %i.ak = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.al = load ptr, ptr %i.ak, align 8, !tbaa !34
  %i.am = zext nneg i32 %.0154 to i64
  ...
  br label %polyhit.exit.thread155

polyhit.exit.thread155:                           ; preds = %bb.f, %polyhit.exit, %bb.h
  %.094 = phi i32 [ %i.ao, %bb.h ], [ %i.b, %polyhit.exit ], [ %i.b, %bb.f ] ; 6 uses
  %.093 = phi i32 [ %i.aq, %bb.h ], [ %i.b, %polyhit.exit ], [ %i.b, %bb.f ] ; 6 uses
  %i.ar = icmp sgt i32 %.094, 0                   ; 2 uses
  br i1 %i.ar, label %.lr.ph, label %.preheader184

.lr.ph:                                           ; preds = %polyhit.exit.thread155
  %wide.trip.count.i = zext nneg i32 %.094 to i64 ; 2 uses
  %i.as = icmp slt i32 %.093, %i.b
  %i.at = sext i32 %.093 to i64
...
.preheader184:                                    ; preds = %clear.exit.thread167, %polyhit.exit.thread155
  %i.az = icmp slt i32 %.094, %.093
  br i1 %i.az, label %.lr.ph190.preheader, label %.preheader

.lr.ph190.preheader:                              ; preds = %.preheader184
  %i.ba = sext i32 %.094 to i64
  %i.bb = shl nsw i64 %i.ba, 3
  %scevgep = getelementptr i8, ptr %i.n, i64 %i.bb
  %i.bc = xor i32 %.094, -1
  %i.bd = add i32 %.093, %i.bc
...
bb.i:                                             ; preds = %.lr.ph, %clear.exit.thread167
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %clear.exit.thread167 ] ; 5 uses
  ...
  %.0.i99 = select i1 %i.cp, i1 %i.cs, i1 %i.ct
...
.lr.ph.i:                                         ; preds = %bb.j, %.lr.ph.preheader.i
  %indvars.iv.i100 = phi i64 [ 0, %.lr.ph.preheader.i ], [ %indvars.iv.next.i101, %bb.j ] ; 3 uses
  %i.db = getelementptr inbounds nuw [16 x i8], ptr %i.d, i64 %indvars.iv.i100
  %i.dc = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %indvars.iv.i100
...
bb.l:                                             ; preds = %inBetween.exit.i128, %.split.i130, %.lr.ph.i
  ...
  br i1 %i.ep, label %bb.m, label %intersect.exit132

bb.m:                                             ; preds = %bb.l
  br i1 %i.cu, label %.split43.i126, label %inBetween.exit42.i124

.split43.i126:                                    ; preds = %bb.m
  %i.eq = fcmp olt double %2, %i.dj
  %i.er = fcmp olt double %i.dj, %i.bj
  %or.cond.i41.i127 = and i1 %i.eq, %i.er
  %i.es = fcmp olt double %i.bj, %i.dj
  %i.et = fcmp olt double %i.dj, %2
  %i.eu = and i1 %i.es, %i.et
  %i.ev = or i1 %or.cond.i41.i127, %i.eu
  br i1 %i.ev, label %clear.exit.thread167, label %intersect.exit132

inBetween.exit42.i124:                            ; preds = %bb.m
  %i.ew = fcmp olt double %3, %i.di
  %i.ex = fcmp olt double %i.di, %.sroa.10.0.copyload
  %or.cond20.i39.i125 = select i1 %i.ew, i1 %i.ex, i1 false
  %i.ey = fcmp olt double %.sroa.10.0.copyload, %i.di
  %i.ez = fcmp olt double %i.di, %3
  %i.fa = select i1 %i.ey, i1 %i.ez, i1 false
  %i.fb = select i1 %or.cond20.i39.i125, i1 true, i1 %i.fa
  br i1 %i.fb, label %clear.exit.thread167, label %intersect.exit132

intersect.exit132:                                ; preds = %bb.l, %.split43.i126, %inBetween.exit42.i124
...
.split.i:                                         ; preds = %bb.n
  ...
  br i1 %i.hc, label %clear.exit.thread167, label %bb.o
...
inBetween.exit.i:                                 ; preds = %bb.n
  ...
  br i1 %i.hj, label %clear.exit.thread167, label %bb.o
...
.split43.i:                                       ; preds = %bb.p
  ...
  br i1 %i.hy, label %clear.exit.thread167, label %intersect.exit
...
inBetween.exit42.i:                               ; preds = %bb.p
  ...
  br i1 %i.ie, label %clear.exit.thread167, label %intersect.exit
...
clear.exit:                                       ; preds = %intersect.exit
  br i1 %i.jg, label %clear.exit.thread167, label %clear.exit.thread165

clear.exit.thread165:                             ; preds = %.preheader.i, %clear.exit
  ...
  br label %clear.exit.thread167

clear.exit.thread167:                             ; preds = %intersect.exit132, %inBetween.exit.i128, %inBetween.exit42.i124, %.split.i130, %.split43.i126, %.split43.i, %.split.i, %inBetween.exit42.i, %inBetween.exit.i, %bb.i, %clear.exit, %clear.exit.thread165
  %sqrt.i.sink = phi double [ %sqrt.i, %clear.exit.thread165 ], [ 0.000000e+00, %bb.i ], [ 0.000000e+00, %.split43.i ], [ 0.000000e+00, %clear.exit ], [ 0.000000e+00, %inBetween.exit.i ], [ 0.000000e+00, %inBetween.exit42.i ], [ 0.000000e+00, %.split.i ], [ 0.000000e+00, %.split43.i126 ], [ 0.000000e+00, %.split.i130 ], [ 0.000000e+00, %inBetween.exit42.i124 ], [ 0.000000e+00, %inBetween.exit.i128 ], [ 0.000000e+00, %intersect.exit132 ]
  ...
  br i1 %exitcond.not, label %.preheader184, label %bb.i, !llvm.loop !37

.preheader:                                       ; preds = %.lr.ph190.preheader, %.preheader184
  %i.jl = icmp slt i32 %.093, %i.b
  br i1 %i.jl, label %.lr.ph192, label %.preheader.._crit_edge_crit_edge
...
.lr.ph192:                                        ; preds = %.preheader
  %wide.trip.count.i115 = zext nneg i32 %.094 to i64
  %i.jm = sext i32 %.093 to i64                   ; 2 uses
  %wide.trip.count204 = sext i32 %i.b to i64      ; 2 uses
...
bb.q:                                             ; preds = %.lr.ph192, %clear.exit120.thread180
  %indvars.iv201 = phi i64 [ %i.jm, %.lr.ph192 ], [ %indvars.iv.next202, %clear.exit120.thread180 ] ; 5 uses
  %i.js = getelementptr inbounds [16 x i8], ptr %i.d, i64 %indvars.iv201 ; 2 uses
  ...
  %i.jv = getelementptr inbounds [4 x i8], ptr %i.h, i64 %indvars.iv201
  ...
  %i.jz = getelementptr inbounds [4 x i8], ptr %i.f, i64 %indvars.iv201
  ...
  %.0.i102 = select i1 %i.la, i1 %i.ld, i1 %i.le
  br i1 %.0.i102, label %bb.r, label %clear.exit120.thread180

bb.r:                                             ; preds = %bb.q
  br i1 %i.ar, label %.lr.ph.preheader.i114, label %.lr.ph27.preheader.i105

.lr.ph.preheader.i114:                            ; preds = %bb.r
...
bb.s:                                             ; preds = %intersect.exit152
  %indvars.iv.next.i118 = add nuw nsw i64 %indvars.iv.i117, 1 ; 2 uses
  %exitcond.not.i119 = icmp eq i64 %indvars.iv.next.i118, %wide.trip.count.i115
  br i1 %exitcond.not.i119, label %.lr.ph27.preheader.i105, label %.lr.ph.i116, !llvm.loop !30

.lr.ph27.preheader.i105:                          ; preds = %bb.s, %bb.r
  ...
  br label %.lr.ph27.i106

.lr.ph.i116:                                      ; preds = %bb.s, %.lr.ph.preheader.i114
  %indvars.iv.i117 = phi i64 [ 0, %.lr.ph.preheader.i114 ], [ %indvars.iv.next.i118, %bb.s ] ; 3 uses
  %i.lq = getelementptr inbounds nuw [16 x i8], ptr %i.d, i64 %indvars.iv.i117
  %i.lr = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %indvars.iv.i117
...
bb.t:                                             ; preds = %.lr.ph.i116
  br i1 %i.lf, label %.split.i150, label %inBetween.exit.i148

.split.i150:                                      ; preds = %bb.t
  %i.mi = extractelement <2 x double> %i.lv, i64 0 ; 4 uses
  %i.mj = fcmp olt double %2, %i.mi
  %i.mk = fcmp olt double %i.mi, %i.ju
  %or.cond.i.i151 = and i1 %i.mj, %i.mk
