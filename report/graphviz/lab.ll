...
.lr.ph157:                                        ; preds = %.lr.ph157.preheader, %.critedge
  ...
  %.095155 = phi double [ %i.eu, %.critedge ], [ 0.000000e+00, %.lr.ph157.preheader ] ; 2 uses
  %.197154 = phi i32 [ %.2107.lcssa, %.critedge ], [ %i.dx, %.lr.ph157.preheader ] ; 4 uses
  %.0103153 = phi i32 [ %.1104, %.critedge ], [ 0, %.lr.ph157.preheader ] ; 2 uses
  %.1106152 = phi i32 [ %i.fg, %.critedge ], [ 0, %.lr.ph157.preheader ]
  %i.dy = sext i32 %.0103153 to i64               ; 2 uses
  %i.dz = getelementptr inbounds [24 x i8], ptr %i.l, i64 %i.dy ; 2 uses
  %i.ea = sext i32 %.197154 to i64                ; 3 uses
  ...
  %i.eu = fadd double %i.dt, %.095155             ; 2 uses
  %i.ev = getelementptr inbounds nuw i8, ptr %.0156, i64 24
  %i.ew = fcmp ogt double %i.eu, %i.eg
  %.1104 = select i1 %i.ew, i32 %.197154, i32 %.0103153 ; 2 uses
  %i.ex = icmp slt i32 %.197154, %i.ak
...
.critedge:                                        ; preds = %bb.n, %.critedge.loopexit.split.loop.exit, %.lr.ph157
  %.2107.lcssa = phi i32 [ %.197154, %.lr.ph157 ], [ %i.ff, %.critedge.loopexit.split.loop.exit ], [ %i.ak, %bb.n ]
  %i.fg = add nuw nsw i32 %.1106152, 1            ; 2 uses
