...
bb.g:                                             ; preds = %.preheader244, %bb.g
  ...
  %8 = fdiv <2 x double> splat (double 1.000000e+00), %7 ; 2 uses
  %9 = extractelement <2 x double> %8, i64 0
  %10 = fmul double %9, %i.ap
  ...
  %11 = shufflevector <2 x double> %8, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.au = insertelement <2 x double> %11, double %10, i64 1
