...
bb.ac:                                            ; preds = %bb.ab
  ...
  %6 = sext i32 %i.ji to i64
  %i.jj = getelementptr inbounds [4 x i8], ptr %i.jg, i64 %6 ; 5 uses
...
bb.aq:                                            ; preds = %bb.ap
  ...
  %i.ko = mul nsw i32 %i.kj, 3
  %7 = sext i32 %i.ko to i64
  %i.kp = getelementptr inbounds [4 x i8], ptr %i.km, i64 %7 ; 5 uses
...
bb.bd:                                            ; preds = %bb.bc
  ...
  %i.lt = mul nsw i32 %i.lo, 3
  %8 = sext i32 %i.lt to i64
  %i.lu = getelementptr inbounds [4 x i8], ptr %i.lr, i64 %8 ; 5 uses
...
._crit_edge.loopexit.unr-lcssa:                   ; preds = %bb.ah
