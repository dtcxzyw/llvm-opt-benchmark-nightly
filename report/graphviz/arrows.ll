...
begin_hunk_0_@arrow_length_normal:bb.a
  %.sroa.0.0.copyload = load double, ptr %i.f, align 16, !tbaa !19
...
bb.a:
  ...
  %.sroa.014.0.copyload = load double, ptr %i.e, align 16, !tbaa !19 ; 2 uses
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %4, i64 24
  %.sroa.5.0.copyload = load double, ptr %.sroa.5.0..sroa_idx, align 8, !tbaa !19
  %.sroa.3.0..sroa_idx = getelementptr inbounds nuw i8, ptr %4, i64 120
  %.sroa.3.0.copyload = load double, ptr %.sroa.3.0..sroa_idx, align 8, !tbaa !19
  %.sroa.011.0.copyload = load double, ptr %4, align 16, !tbaa !19
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  store <2 x double> %i.ak, ptr %8, align 16, !tbaa !19
  ...
  store double %i.am, ptr %i.an, align 16, !tbaa !23
  ...
  store <2 x double> %i.at, ptr %i.au, align 16, !tbaa !19
  ...
  store double %i.ax, ptr %i.ay, align 16, !tbaa !23
...
bb.d:                                             ; preds = %bb.c
  ...
  store double %i.al, ptr %8, align 16, !tbaa !19
  store double %i.ao, ptr %i.bd, align 8, !tbaa !19
  store double %i.aw, ptr %i.ay, align 16, !tbaa !19
  store double %i.az, ptr %i.bb, align 8, !tbaa !19
  br label %bb.g
...
bb.f:                                             ; preds = %bb.e
  store double %i.al, ptr %i.an, align 16, !tbaa !19
  store double %i.ao, ptr %i.aq, align 8, !tbaa !19
  store double %i.aw, ptr %i.au, align 16, !tbaa !19
  store double %i.az, ptr %i.av, align 8, !tbaa !19
  br label %bb.g

bb.g:                                             ; preds = %bb.e, %bb.f, %bb.d
  call void @gvrender_polygon(ptr noundef %0, ptr noundef nonnull %8, i64 noundef 4, i32 noundef 1) #11
  store <2 x double> %i.ae, ptr %8, align 16, !tbaa !19
  store double %.sroa.075.0, ptr %i.an, align 16, !tbaa !19
  store double %.sroa.5.0, ptr %i.aq, align 8, !tbaa !19
...
bb.a:
  ...
  %5 = fmul double %i.a, 1.000000e+01             ; 3 uses
  ...
  %11 = fadd double %5, %i.c
  %12 = extractelement <2 x double> %9, i64 1
  %13 = fadd double %12, %11
  %.1 = select i1 %10, double %13, double %5
  ret double %.1
}
...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  store double %i.ac, ptr %8, align 16, !tbaa !23
  ...
  store <2 x double> %i.an, ptr %i.ak, align 16, !tbaa !19
  %i.ao = getelementptr inbounds nuw i8, ptr %8, i64 48 ; 2 uses
  %i.ap = fadd <2 x double> %i.c, %i.am
  store <2 x double> %i.ap, ptr %i.ao, align 16, !tbaa !19
  %i.aq = and i32 %7, 64
...
bb.d:                                             ; preds = %bb.c
  ...
  store double %i.y, ptr %8, align 16, !tbaa !19
  store double %i.aa, ptr %i.af, align 8, !tbaa !19
  %i.as = extractelement <2 x double> %i.am, i64 0
  store double %i.as, ptr %i.ao, align 16, !tbaa !19
  %i.at = extractelement <2 x double> %i.am, i64 1
  store double %i.at, ptr %i.ar, align 8, !tbaa !19
  br label %bb.g
...
bb.f:                                             ; preds = %bb.e
  store double %i.y, ptr %i.ah, align 16, !tbaa !19
  store double %i.aa, ptr %i.aj, align 8, !tbaa !19
  %i.av = extractelement <2 x double> %i.am, i64 0
  store double %i.av, ptr %i.ak, align 16, !tbaa !19
  %i.aw = extractelement <2 x double> %i.am, i64 1
  store double %i.aw, ptr %i.al, align 8, !tbaa !19
  br label %bb.g
...
bb.g:                                             ; preds = %bb.e, %bb.f, %bb.d
  ...
  store double %i.bc, ptr %8, align 16, !tbaa !19
  %i.bd = extractelement <2 x double> %i.am, i64 1
  store double %i.bd, ptr %i.af, align 8, !tbaa !19
  %i.be = fsub <2 x double> %i.az, %i.w           ; 3 uses
  store <2 x double> %i.be, ptr %i.ah, align 16, !tbaa !19
  call void @gvrender_polyline(ptr noundef %0, ptr noundef nonnull %8, i64 noundef 2) #11
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #11
...
bb.a:
  ...
  %i.y = load <2 x double>, ptr %8, align 16, !tbaa !19
  ...
  store double %i.ad, ptr %i.t, align 16, !tbaa !19
  store double %i.ae, ptr %.sroa.781.0..sroa_idx.i, align 8, !tbaa !19
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %9, ptr noundef nonnull align 16 dereferenceable(16) %i.t, i64 16, i1 false), !tbaa.struct !22
  %i.af = fadd <2 x double> %i.c, %i.ac
  store <2 x double> %i.af, ptr %i.u, align 16, !tbaa !19
  %i.ag = getelementptr inbounds nuw i8, ptr %9, i64 32 ; 2 uses
  %i.ah = fsub <2 x double> %i.w, %i.z
  store <2 x double> %i.ah, ptr %i.ag, align 16, !tbaa !19
  %i.ai = getelementptr inbounds nuw i8, ptr %9, i64 48
  %i.aj = fsub <2 x double> %i.ac, %i.c
  store <2 x double> %i.aj, ptr %i.ai, align 16, !tbaa !19
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #11
  %i.ak = lshr i32 %7, 4
