...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  %i.v = mul nuw nsw i64 %indvars.iv.epil, %i.p
  %i.w = getelementptr inbounds nuw [4 x i8], ptr %.pre, i64 %i.v
  %i.x = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv.epil
...
.preheader.preheader:                             ; preds = %.preheader.preheader.loopexit.unr-lcssa, %.lr.ph.epil, %gv_calloc.exit40
  ...
  %i.y = add nsw i64 %wide.trip.count61, -1
  br label %.preheader

.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  %indvars.iv = phi i64 [ 1, %.lr.ph.preheader.new ], [ %indvars.iv.next.3, %.lr.ph ] ; 6 uses
  %niter = phi i64 [ 0, %.lr.ph.preheader.new ], [ %niter.next.3, %.lr.ph ]
  %i.z = mul nuw nsw i64 %indvars.iv, %i.p
  %i.aa = getelementptr inbounds nuw [4 x i8], ptr %.pre, i64 %i.z
  %i.ab = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv
  store ptr %i.aa, ptr %i.ab, align 8, !tbaa !11
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.ac = mul nuw nsw i64 %indvars.iv.next, %i.p
  %i.ad = getelementptr inbounds nuw [4 x i8], ptr %.pre, i64 %i.ac
  %i.ae = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv.next
  store ptr %i.ad, ptr %i.ae, align 8, !tbaa !11
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %i.af = mul nuw nsw i64 %indvars.iv.next.1, %i.p
  %i.ag = getelementptr inbounds nuw [4 x i8], ptr %.pre, i64 %i.af
  %i.ah = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv.next.1
  store ptr %i.ag, ptr %i.ah, align 8, !tbaa !11
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3 ; 2 uses
  %i.ai = mul nuw nsw i64 %indvars.iv.next.2, %i.p
  %i.aj = getelementptr inbounds nuw [4 x i8], ptr %.pre, i64 %i.ai
  %i.ak = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv.next.2
...
.preheader:                                       ; preds = %.preheader.preheader, %.unr-lcssa
  %indvars.iv51 = phi i64 [ 0, %.preheader.preheader ], [ %indvars.iv.next52, %.unr-lcssa ] ; 11 uses
  %.047 = phi i64 [ 0, %.preheader.preheader ], [ %indvars.iv.next50.lcssa, %.unr-lcssa ] ; 3 uses
  %i.al = sub nsw i64 %wide.trip.count61, %indvars.iv51
  %i.am = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv51
  %i.an = load ptr, ptr %i.am, align 8, !tbaa !11 ; 3 uses
  %xtraiter66 = and i64 %i.al, 1
...
.prol.loopexit.unr-lcssa:                         ; preds = %.preheader
  %i.ao = getelementptr inbounds [4 x i8], ptr %0, i64 %.047
  %i.ap = load float, ptr %i.ao, align 4, !tbaa !17 ; 2 uses
  %i.aq = getelementptr inbounds nuw [4 x i8], ptr %i.an, i64 %indvars.iv51
  store float %i.ap, ptr %i.aq, align 4, !tbaa !17
  %i.ar = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv51
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !11
  %i.at = getelementptr inbounds nuw [4 x i8], ptr %i.as, i64 %indvars.iv51
  store float %i.ap, ptr %i.at, align 4, !tbaa !17
  %indvars.iv.next54.prol = add nuw nsw i64 %indvars.iv51, 1
  %indvars.iv.next50.prol = add nsw i64 %.047, 1  ; 2 uses
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.unr-lcssa, %.preheader
  ...
  %indvars.iv53.unr = phi i64 [ %indvars.iv51, %.preheader ], [ %indvars.iv.next54.prol, %.prol.loopexit.unr-lcssa ]
  %indvars.iv49.unr = phi i64 [ %.047, %.preheader ], [ %indvars.iv.next50.prol, %.prol.loopexit.unr-lcssa ]
  %i.au = icmp eq i64 %indvars.iv51, %i.y
  br i1 %i.au, label %.unr-lcssa, label %.preheader.new

.preheader.new:                                   ; preds = %.prol.loopexit, %.preheader.new
  %indvars.iv53 = phi i64 [ %indvars.iv.next54.1, %.preheader.new ], [ %indvars.iv53.unr, %.prol.loopexit ] ; 4 uses
  %indvars.iv49 = phi i64 [ %indvars.iv.next50.1, %.preheader.new ], [ %indvars.iv49.unr, %.prol.loopexit ] ; 3 uses
  %i.av = getelementptr inbounds [4 x i8], ptr %0, i64 %indvars.iv49
  %i.aw = load float, ptr %i.av, align 4, !tbaa !17 ; 2 uses
  %i.ax = getelementptr inbounds nuw [4 x i8], ptr %i.an, i64 %indvars.iv53
  store float %i.aw, ptr %i.ax, align 4, !tbaa !17
  %i.ay = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv53
  %i.az = load ptr, ptr %i.ay, align 8, !tbaa !11
  %i.ba = getelementptr inbounds nuw [4 x i8], ptr %i.az, i64 %indvars.iv51
  store float %i.aw, ptr %i.ba, align 4, !tbaa !17
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1 ; 2 uses
  %i.bb = getelementptr [4 x i8], ptr %0, i64 %indvars.iv49
  %i.bc = getelementptr i8, ptr %i.bb, i64 4
  %i.bd = load float, ptr %i.bc, align 4, !tbaa !17 ; 2 uses
  %i.be = getelementptr inbounds nuw [4 x i8], ptr %i.an, i64 %indvars.iv.next54
  store float %i.bd, ptr %i.be, align 4, !tbaa !17
  %i.bf = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv.next54
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !11
  %i.bh = getelementptr inbounds nuw [4 x i8], ptr %i.bg, i64 %indvars.iv51
  store float %i.bd, ptr %i.bh, align 4, !tbaa !17
  %indvars.iv.next54.1 = add nuw nsw i64 %indvars.iv53, 2 ; 2 uses
  %indvars.iv.next50.1 = add nsw i64 %indvars.iv49, 2 ; 2 uses
  %exitcond59.not.1 = icmp eq i64 %indvars.iv.next54.1, %wide.trip.count61
...
._crit_edge:                                      ; preds = %.unr-lcssa, %.preheader42
  %i.bi = phi ptr [ %i.t, %.preheader42 ], [ %i.d, %.unr-lcssa ]
  ret ptr %i.bi
}
