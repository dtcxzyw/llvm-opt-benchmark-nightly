...
.lr.ph186.a:                                      ; preds = %.lr.ph186.preheader, %bb.k
  %.2184 = phi i32 [ %8, %bb.k ], [ 0, %.lr.ph186.preheader ] ; 3 uses
  %i.au = tail call fastcc i32 @fits(i32 noundef %7, i32 noundef %.2184, ptr noundef nonnull %1, ptr noundef %2, ptr noundef %3, i32 noundef %4, ptr noundef nonnull %6)
  %.not142.a = icmp eq i32 %i.au, 0
  br i1 %.not142.a, label %bb.k, label %.loopexit

bb.k:                                             ; preds = %.lr.ph186.a
  %8 = add nsw i32 %.2184, -1                     ; 5 uses
  %9 = icmp samesign ugt i32 %8, %7
  br i1 %9, label %.lr.ph186.a, label %.lr.ph189, !llvm.loop !183

.preheader150:                                    ; preds = %bb.l
  %.not236 = icmp sgt i32 %.2184, %.1
...
bb.l:                                             ; preds = %.lr.ph189
  ...
  br i1 %exitcond220.not, label %.preheader150, label %.lr.ph189, !llvm.loop !184

.lr.ph195.preheader:                              ; preds = %bb.m, %.preheader150
  %.3.lcssa = phi i32 [ %8, %.preheader150 ], [ %.1, %bb.m ] ; 3 uses
  br label %.lr.ph195

.lr.ph192:                                        ; preds = %.preheader150, %bb.m
  %.3191 = phi i32 [ %i.ay, %bb.m ], [ %8, %.preheader150 ] ; 2 uses
...
.loopexit:                                        ; preds = %bb.e, %.lr.ph, %.lr.ph177, %.lr.ph180, %.lr.ph183, %.lr.ph186.a, %.lr.ph189, %.lr.ph192, %.lr.ph195, %.lr.ph198, %bb.c, %bb.b
  ret void
}
