...
.lr.ph698.epil.preheader:                         ; preds = %._crit_edge699.loopexit.unr-lcssa, %.lr.ph698.preheader
  ...
  %i.qw = getelementptr inbounds [4 x i8], ptr %i.ny, i64 %indvars.iv865.epil.init ; 2 uses
...
.lr.ph698:                                        ; preds = %.lr.ph698, %.lr.ph698.preheader.new
  ...
  %i.rk = getelementptr inbounds [4 x i8], ptr %i.ny, i64 %indvars.iv865 ; 2 uses
  ...
  %i.ru = getelementptr [4 x i8], ptr %i.ny, i64 %indvars.iv865
...
.lr.ph709.epil.preheader:                         ; preds = %.preheader591.unr-lcssa, %.lr.ph709.preheader
  ...
  %i.sh = getelementptr inbounds [4 x i8], ptr %i.ny, i64 %i.sg
...
.lr.ph709:                                        ; preds = %.lr.ph709.preheader, %.lr.ph709
  ...
  %i.sm = getelementptr inbounds [4 x i8], ptr %i.ny, i64 %i.sl
  ...
  %i.su = getelementptr inbounds [4 x i8], ptr %i.ny, i64 %i.st
...
.lr.ph711:                                        ; preds = %.preheader591, %.lr.ph711
  ...
  call void @right_mult_with_vector_ff(ptr noundef nonnull %i.ny, i32 noundef %1, ptr noundef %i.sz, ptr noundef %i.tb) #11
