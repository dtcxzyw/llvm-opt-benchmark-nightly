...
bb.af:                                            ; preds = %bb.ae, %.thread559
  ...
  %i.fy = mul i32 %i.fx, %1
  %9 = sdiv i32 %i.fy, 2                          ; 3 uses
  %i.fz = add i32 %9, %1                          ; 9 uses
...
.lr.ph660.preheader:                              ; preds = %.lr.ph656, %.loopexit595
  ...
  %smax808 = call i32 @llvm.smax.i32(i32 %1, i32 1) ; 3 uses
  %wide.trip.count809 = zext nneg i32 %smax808 to i64 ; 12 uses
...
._crit_edge668:                                   ; preds = %._crit_edge665, %gv_calloc.exit517
  ...
  %11 = sitofp i32 %9 to double                   ; 2 uses
...
.lr.ph682.preheader:                              ; preds = %._crit_edge674
  %i.ku = add nsw i64 %wide.trip.count809, -1     ; 2 uses
  %xtraiter1131 = and i64 %wide.trip.count809, 1
...
.lr.ph682.preheader.new:                          ; preds = %.lr.ph682.preheader
  ...
  %unroll_iter1134 = and i64 %wide.trip.count809, 2147483646
  br label %.lr.ph682
...
.lr.ph682.epil.preheader:                         ; preds = %._crit_edge683.unr-lcssa, %.lr.ph682.preheader
  ...
  %lcmp.mod1133 = trunc i32 %smax808 to i1
...
bb.aw:                                            ; preds = %gv_calloc.exit537
  ...
  %.not.i543 = icmp eq i32 %i.fz, 0
  br i1 %.not.i543, label %.thread.i546, label %13

.thread.i546:                                     ; preds = %bb.aw
  %12 = call noalias ptr @calloc(i64 noundef 0, i64 noundef 4) #15
  br label %gv_calloc.exit547
...
bb.ay:                                            ; preds = %13
  %i.ny = call noalias ptr @calloc(i64 noundef range(i64 -2147483648, 2147483648) %i.nv, i64 noundef 4) #15 ; 2 uses
...
gv_calloc.exit547:                                ; preds = %.thread.i546, %bb.ay
  %14 = phi ptr [ %12, %.thread.i546 ], [ %i.ny, %bb.ay ] ; 9 uses
...
.lr.ph730:                                        ; preds = %gv_calloc.exit547
  ...
  %xtraiter1149 = and i64 %wide.trip.count809, 1
  %i.ol = icmp eq i64 %i.ku, 0
  %unroll_iter1153 = and i64 %wide.trip.count809, 2147483646
  %lcmp.mod1151.not = icmp eq i64 %xtraiter1149, 0
  %lcmp.mod1152 = trunc i32 %smax808 to i1
...
.preheader588:                                    ; preds = %._crit_edge727, %gv_calloc.exit547
  %.2441.lcssa = phi i32 [ 0, %gv_calloc.exit547 ], [ %i.ui, %._crit_edge727 ]
...
.lr.ph705.preheader:                              ; preds = %._crit_edge727, %.lr.ph730
  ...
  %.2441728 = phi i32 [ 0, %.lr.ph730 ], [ %i.ui, %._crit_edge727 ] ; 2 uses
  call void @set_vector_val(i32 noundef %1, double noundef 0.000000e+00, ptr noundef nonnull %i.kj) #11
  call void @sqrt_vecf(i32 noundef %i.fz, ptr noundef nonnull %.1477, ptr noundef %14) #11
  br label %.lr.ph705
...
.lr.ph705:                                        ; preds = %.lr.ph705.preheader, %._crit_edge699
  ...
  %indvars.iv861 = phi i32 [ %i.fx, %.lr.ph705.preheader ], [ %indvars.iv.next862, %._crit_edge699 ] ; 5 uses
  %.0432702 = phi i32 [ 0, %.lr.ph705.preheader ], [ %.1433.lcssa, %._crit_edge699 ] ; 2 uses
  %i.oy = trunc nuw nsw i64 %indvars.iv874 to i32
  %i.oz = xor i32 %i.oy, -1
  %i.pa = add nsw i32 %1, %i.oz                   ; 6 uses
...
._crit_edge690:                                   ; preds = %.lr.ph689, %.lr.ph705
  call void @invert_sqrt_vec(i32 noundef %i.pa, ptr noundef nonnull %i.nq) #11
  %i.pb = icmp sgt i32 %i.pa, 0
  br i1 %i.pb, label %.lr.ph693.preheader, label %.preheader589.thread
...
.lr.ph693.preheader:                              ; preds = %._crit_edge690
  %wide.trip.count863 = zext i32 %indvars.iv861 to i64 ; 5 uses
...
vector.body1067:                                  ; preds = %pred.store.continue1084, %vector.ph1065
  ...
  %i.pc = getelementptr inbounds nuw [4 x i8], ptr %i.nq, i64 %index1068 ; 3 uses
  %i.pd = getelementptr inbounds nuw i8, ptr %i.pc, i64 16
  %wide.load1069 = load <4 x float>, ptr %i.pc, align 4, !tbaa !47 ; 2 uses
  %wide.load1070 = load <4 x float>, ptr %i.pd, align 4, !tbaa !47 ; 2 uses
  %i.pe = fcmp oge <4 x float> %wide.load1069, splat (float f0x7F7FFFFF)
  %i.pf = fcmp oge <4 x float> %wide.load1070, splat (float f0x7F7FFFFF)
  %i.pg = fcmp olt <4 x float> %wide.load1069, zeroinitializer
  %i.ph = fcmp olt <4 x float> %wide.load1070, zeroinitializer
  %i.pi = or <4 x i1> %i.pe, %i.pg                ; 4 uses
  %i.pj = or <4 x i1> %i.pf, %i.ph                ; 4 uses
  %i.pk = extractelement <4 x i1> %i.pi, i64 0
  br i1 %i.pk, label %pred.store.if, label %pred.store.continue

pred.store.if:                                    ; preds = %vector.body1067
  store float 0.000000e+00, ptr %i.pc, align 4, !tbaa !47
  br label %pred.store.continue

pred.store.continue:                              ; preds = %pred.store.if, %vector.body1067
  %i.pl = extractelement <4 x i1> %i.pi, i64 1
  br i1 %i.pl, label %pred.store.if1071, label %pred.store.continue1072

pred.store.if1071:                                ; preds = %pred.store.continue
  %i.pm = getelementptr inbounds nuw [4 x i8], ptr %i.nq, i64 %index1068
  %i.pn = getelementptr inbounds nuw i8, ptr %i.pm, i64 4
  store float 0.000000e+00, ptr %i.pn, align 4, !tbaa !47
  br label %pred.store.continue1072

pred.store.continue1072:                          ; preds = %pred.store.if1071, %pred.store.continue
  %i.po = extractelement <4 x i1> %i.pi, i64 2
  br i1 %i.po, label %pred.store.if1073, label %pred.store.continue1074

pred.store.if1073:                                ; preds = %pred.store.continue1072
  %i.pp = getelementptr inbounds nuw [4 x i8], ptr %i.nq, i64 %index1068
  %i.pq = getelementptr inbounds nuw i8, ptr %i.pp, i64 8
  store float 0.000000e+00, ptr %i.pq, align 4, !tbaa !47
  br label %pred.store.continue1074

pred.store.continue1074:                          ; preds = %pred.store.if1073, %pred.store.continue1072
  %i.pr = extractelement <4 x i1> %i.pi, i64 3
  br i1 %i.pr, label %pred.store.if1075, label %pred.store.continue1076

pred.store.if1075:                                ; preds = %pred.store.continue1074
  %i.ps = getelementptr inbounds nuw [4 x i8], ptr %i.nq, i64 %index1068
  %i.pt = getelementptr inbounds nuw i8, ptr %i.ps, i64 12
  store float 0.000000e+00, ptr %i.pt, align 4, !tbaa !47
  br label %pred.store.continue1076

pred.store.continue1076:                          ; preds = %pred.store.if1075, %pred.store.continue1074
  %i.pu = extractelement <4 x i1> %i.pj, i64 0
  br i1 %i.pu, label %pred.store.if1077, label %pred.store.continue1078

pred.store.if1077:                                ; preds = %pred.store.continue1076
  %i.pv = getelementptr inbounds nuw [4 x i8], ptr %i.nq, i64 %index1068
  %i.pw = getelementptr inbounds nuw i8, ptr %i.pv, i64 16
  store float 0.000000e+00, ptr %i.pw, align 4, !tbaa !47
  br label %pred.store.continue1078

pred.store.continue1078:                          ; preds = %pred.store.if1077, %pred.store.continue1076
  %i.px = extractelement <4 x i1> %i.pj, i64 1
  br i1 %i.px, label %pred.store.if1079, label %pred.store.continue1080

pred.store.if1079:                                ; preds = %pred.store.continue1078
  %i.py = getelementptr inbounds nuw [4 x i8], ptr %i.nq, i64 %index1068
  %i.pz = getelementptr inbounds nuw i8, ptr %i.py, i64 20
  store float 0.000000e+00, ptr %i.pz, align 4, !tbaa !47
  br label %pred.store.continue1080

pred.store.continue1080:                          ; preds = %pred.store.if1079, %pred.store.continue1078
  %i.qa = extractelement <4 x i1> %i.pj, i64 2
  br i1 %i.qa, label %pred.store.if1081, label %pred.store.continue1082

pred.store.if1081:                                ; preds = %pred.store.continue1080
  %i.qb = getelementptr inbounds nuw [4 x i8], ptr %i.nq, i64 %index1068
  %i.qc = getelementptr inbounds nuw i8, ptr %i.qb, i64 24
  store float 0.000000e+00, ptr %i.qc, align 4, !tbaa !47
  br label %pred.store.continue1082

pred.store.continue1082:                          ; preds = %pred.store.if1081, %pred.store.continue1080
  %i.qd = extractelement <4 x i1> %i.pj, i64 3
  br i1 %i.qd, label %pred.store.if1083, label %pred.store.continue1084

pred.store.if1083:                                ; preds = %pred.store.continue1082
  %i.qe = getelementptr inbounds nuw [4 x i8], ptr %i.nq, i64 %index1068
  %i.qf = getelementptr inbounds nuw i8, ptr %i.qe, i64 28
  store float 0.000000e+00, ptr %i.qf, align 4, !tbaa !47
...
pred.store.continue1084:                          ; preds = %pred.store.if1083, %pred.store.continue1082
  ...
  %i.qg = icmp eq i64 %index.next1085, %n.vec1066
  br i1 %i.qg, label %middle.block1086, label %vector.body1067, !llvm.loop !64
...
.lr.ph689:                                        ; preds = %.lr.ph705, %.lr.ph689
  ...
  %i.qh = getelementptr inbounds nuw [8 x i8], ptr %i.jn, i64 %indvars.iv853 ; 2 uses
  %i.qi = load ptr, ptr %i.qh, align 8, !tbaa !55
  %i.qj = getelementptr inbounds nuw [4 x i8], ptr %i.qi, i64 %indvars.iv874
  %i.qk = load float, ptr %i.qj, align 4, !tbaa !47
  call void @set_vector_valf(i32 noundef %i.pa, float noundef %i.qk, ptr noundef nonnull %i.nl) #11
  %i.ql = load ptr, ptr %i.qh, align 8, !tbaa !55
  %i.qm = getelementptr inbounds nuw [4 x i8], ptr %i.ql, i64 %indvars.iv874
  %i.qn = getelementptr inbounds nuw i8, ptr %i.qm, i64 4
  call void @vectors_mult_additionf(i32 noundef %i.pa, ptr noundef nonnull %i.nl, float noundef -1.000000e+00, ptr noundef nonnull %i.qn) #11
  call void @square_vec(i32 noundef %i.pa, ptr noundef nonnull %i.nl) #11
  call void @vectors_additionf(i32 noundef %i.pa, ptr noundef nonnull %i.nl, ptr noundef nonnull %i.nq, ptr noundef nonnull %i.nq) #11
...
.lr.ph698.preheader:                              ; preds = %bb.bb, %middle.block1086
  ...
  %i.qo = sext i32 %.1433694 to i64               ; 2 uses
  %invariant.gep962 = getelementptr inbounds nuw [8 x i8], ptr %i.kj, i64 %indvars.iv874 ; 3 uses
  %xtraiter1141 = and i64 %wide.trip.count863, 1
  %i.qp = icmp eq i32 %indvars.iv861, 1
  br i1 %i.qp, label %.lr.ph698.epil.preheader, label %.lr.ph698.preheader.new

.lr.ph698.preheader.new:                          ; preds = %.lr.ph698.preheader
  %unroll_iter1147 = and i64 %wide.trip.count863, 4294967294
  br label %.lr.ph698
...
.lr.ph693:                                        ; preds = %.lr.ph693.preheader1106, %bb.bb
  ...
  %i.qq = getelementptr inbounds nuw [4 x i8], ptr %i.nq, i64 %indvars.iv858 ; 2 uses
  %i.qr = load float, ptr %i.qq, align 4, !tbaa !47 ; 2 uses
  %i.qs = fcmp oge float %i.qr, f0x7F7FFFFF
  %i.qt = fcmp olt float %i.qr, 0.000000e+00
  %or.cond = or i1 %i.qs, %i.qt
  br i1 %or.cond, label %bb.ba, label %bb.bb

bb.ba:                                            ; preds = %.lr.ph693
  store float 0.000000e+00, ptr %i.qq, align 4, !tbaa !47
  br label %bb.bb
...
.lr.ph698.epil.preheader:                         ; preds = %._crit_edge699.loopexit.unr-lcssa, %.lr.ph698.preheader
  ...
  %indvars.iv865.epil.init = phi i64 [ %i.qo, %.lr.ph698.preheader ], [ %indvars.iv.next866.1, %._crit_edge699.loopexit.unr-lcssa ] ; 2 uses
  %.0428695.epil.init = phi double [ 0.000000e+00, %.lr.ph698.preheader ], [ %i.rz, %._crit_edge699.loopexit.unr-lcssa ]
  %lcmp.mod1146 = trunc i32 %indvars.iv861 to i1
  call void @llvm.assume(i1 %lcmp.mod1146)
  %i.qu = getelementptr inbounds nuw [4 x i8], ptr %i.nq, i64 %indvars.iv867.epil.init
  %i.qv = load float, ptr %i.qu, align 4, !tbaa !47
  %i.qw = getelementptr inbounds [4 x i8], ptr %14, i64 %indvars.iv865.epil.init ; 2 uses
  %i.qx = load float, ptr %i.qw, align 4, !tbaa !47
  %i.qy = fmul float %i.qv, %i.qx                 ; 2 uses
  store float %i.qy, ptr %i.qw, align 4, !tbaa !47
  %i.qz = fpext float %i.qy to double             ; 2 uses
  %i.ra = fadd double %.0428695.epil.init, %i.qz
  %gep963.epil = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep962, i64 %indvars.iv867.epil.init
  %i.rb = getelementptr inbounds nuw i8, ptr %gep963.epil, i64 8 ; 2 uses
  %i.rc = load double, ptr %i.rb, align 8, !tbaa !28
  %i.rd = fsub double %i.rc, %i.qz
  store double %i.rd, ptr %i.rb, align 8, !tbaa !28
...
._crit_edge699.loopexit:                          ; preds = %._crit_edge699.loopexit.unr-lcssa, %.lr.ph698.epil.preheader
  %.lcssa = phi double [ %i.rz, %._crit_edge699.loopexit.unr-lcssa ], [ %i.ra, %.lr.ph698.epil.preheader ]
  ...
  %i.re = trunc nsw i64 %indvars.iv.next866.lcssa to i32
  br label %._crit_edge699
...
._crit_edge699:                                   ; preds = %.preheader589.thread, %._crit_edge699.loopexit
  ...
  %.1433.lcssa = phi i32 [ %.1433694951, %.preheader589.thread ], [ %i.re, %._crit_edge699.loopexit ]
  %i.rf = getelementptr inbounds nuw [8 x i8], ptr %i.kj, i64 %indvars.iv874 ; 2 uses
  %i.rg = load double, ptr %i.rf, align 8, !tbaa !28
  %i.rh = fsub double %i.rg, %.0428.lcssa
  store double %i.rh, ptr %i.rf, align 8, !tbaa !28
...
.lr.ph698:                                        ; preds = %.lr.ph698, %.lr.ph698.preheader.new
  ...
  %indvars.iv865 = phi i64 [ %i.qo, %.lr.ph698.preheader.new ], [ %indvars.iv.next866.1, %.lr.ph698 ] ; 3 uses
  %.0428695 = phi double [ 0.000000e+00, %.lr.ph698.preheader.new ], [ %i.rz, %.lr.ph698 ]
  %niter1148 = phi i64 [ 0, %.lr.ph698.preheader.new ], [ %niter1148.next.1, %.lr.ph698 ]
  %i.ri = getelementptr inbounds nuw [4 x i8], ptr %i.nq, i64 %indvars.iv867
  %i.rj = load float, ptr %i.ri, align 4, !tbaa !47
  %i.rk = getelementptr inbounds [4 x i8], ptr %14, i64 %indvars.iv865 ; 2 uses
  %i.rl = load float, ptr %i.rk, align 4, !tbaa !47
  %i.rm = fmul float %i.rj, %i.rl                 ; 2 uses
  store float %i.rm, ptr %i.rk, align 4, !tbaa !47
  %i.rn = fpext float %i.rm to double             ; 2 uses
  %i.ro = fadd double %.0428695, %i.rn
  %gep963 = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep962, i64 %indvars.iv867
  %i.rp = getelementptr inbounds nuw i8, ptr %gep963, i64 8 ; 2 uses
  %i.rq = load double, ptr %i.rp, align 8, !tbaa !28
  %i.rr = fsub double %i.rq, %i.rn
  store double %i.rr, ptr %i.rp, align 8, !tbaa !28
  %indvars.iv.next868 = or disjoint i64 %indvars.iv867, 1 ; 2 uses
  %i.rs = getelementptr inbounds nuw [4 x i8], ptr %i.nq, i64 %indvars.iv.next868
  %i.rt = load float, ptr %i.rs, align 4, !tbaa !47
  %i.ru = getelementptr [4 x i8], ptr %14, i64 %indvars.iv865
  %i.rv = getelementptr i8, ptr %i.ru, i64 4      ; 2 uses
  %i.rw = load float, ptr %i.rv, align 4, !tbaa !47
  %i.rx = fmul float %i.rt, %i.rw                 ; 2 uses
  store float %i.rx, ptr %i.rv, align 4, !tbaa !47
  %i.ry = fpext float %i.rx to double             ; 2 uses
  %i.rz = fadd double %i.ro, %i.ry                ; 3 uses
  %gep963.1 = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep962, i64 %indvars.iv.next868
  %i.sa = getelementptr inbounds nuw i8, ptr %gep963.1, i64 8 ; 2 uses
  %i.sb = load double, ptr %i.sa, align 8, !tbaa !28
  %i.sc = fsub double %i.sb, %i.ry
  store double %i.sc, ptr %i.sa, align 8, !tbaa !28
...
.lr.ph709.epil.preheader:                         ; preds = %.preheader591.unr-lcssa, %.lr.ph709.preheader
  ...
  %.0423707.epil.init = phi i32 [ 0, %.lr.ph709.preheader ], [ %i.sx, %.preheader591.unr-lcssa ]
  call void @llvm.assume(i1 %lcmp.mod1152)
  %i.sd = getelementptr inbounds nuw [8 x i8], ptr %i.kj, i64 %indvars.iv879.epil.init
  %i.se = load double, ptr %i.sd, align 8, !tbaa !28
  %i.sf = fptrunc double %i.se to float
  %i.sg = sext i32 %.0423707.epil.init to i64
  %i.sh = getelementptr inbounds [4 x i8], ptr %14, i64 %i.sg
  store float %i.sf, ptr %i.sh, align 4, !tbaa !47
...
.lr.ph709:                                        ; preds = %.lr.ph709.preheader, %.lr.ph709
  ...
  %.0423707 = phi i32 [ %i.sx, %.lr.ph709 ], [ 0, %.lr.ph709.preheader ] ; 2 uses
  %niter1154 = phi i64 [ %niter1154.next.1, %.lr.ph709 ], [ 0, %.lr.ph709.preheader ]
  %i.si = getelementptr inbounds nuw [8 x i8], ptr %i.kj, i64 %indvars.iv879
  %i.sj = load double, ptr %i.si, align 8, !tbaa !28
  %i.sk = fptrunc double %i.sj to float
  %i.sl = sext i32 %.0423707 to i64
  %i.sm = getelementptr inbounds [4 x i8], ptr %14, i64 %i.sl
  store float %i.sk, ptr %i.sm, align 4, !tbaa !47
  %i.sn = trunc nsw i64 %indvars.iv881 to i32
  %i.so = add nsw i32 %.0423707, %i.sn            ; 2 uses
  %i.sp = getelementptr inbounds nuw [8 x i8], ptr %i.kj, i64 %indvars.iv879
  ...
  %i.st = sext i32 %i.so to i64
  %i.su = getelementptr inbounds [4 x i8], ptr %14, i64 %i.st
  store float %i.ss, ptr %i.su, align 4, !tbaa !47
  %indvars.iv.next880.1 = add nuw nsw i64 %indvars.iv879, 2 ; 2 uses
  %i.sv = trunc i64 %indvars.iv881 to i32
  %i.sw = add i32 %i.sv, -1
  %i.sx = add nsw i32 %i.so, %i.sw                ; 2 uses
...
.lr.ph711:                                        ; preds = %.preheader591, %.lr.ph711
  ...
  %i.sy = getelementptr inbounds nuw [8 x i8], ptr %i.jn, i64 %indvars.iv889
  %i.sz = load ptr, ptr %i.sy, align 8, !tbaa !55
  %i.ta = getelementptr inbounds nuw [8 x i8], ptr %i.nk, i64 %indvars.iv889
  %i.tb = load ptr, ptr %i.ta, align 8, !tbaa !55
  call void @right_mult_with_vector_ff(ptr noundef nonnull %14, i32 noundef %1, ptr noundef %i.sz, ptr noundef %i.tb) #11
...
.lr.ph720.preheader:                              ; preds = %.lr.ph714
  %i.tc = fmul double %i.tj, 2.000000e+00
  %i.td = fadd double %i.tc, %11
  br label %.lr.ph720

.lr.ph714:                                        ; preds = %.lr.ph711, %.lr.ph714
  %indvars.iv894 = phi i64 [ %indvars.iv.next895, %.lr.ph714 ], [ 0, %.lr.ph711 ] ; 3 uses
  %.0420712 = phi double [ %i.tj, %.lr.ph714 ], [ 0.000000e+00, %.lr.ph711 ]
  %i.te = getelementptr inbounds nuw [8 x i8], ptr %i.jn, i64 %indvars.iv894
  %i.tf = load ptr, ptr %i.te, align 8, !tbaa !55
  %i.tg = getelementptr inbounds nuw [8 x i8], ptr %i.nk, i64 %indvars.iv894
  %i.th = load ptr, ptr %i.tg, align 8, !tbaa !55
  %i.ti = call double @vectors_inner_productf(i32 noundef %1, ptr noundef %i.tf, ptr noundef %i.th) #11
  %i.tj = fadd double %.0420712, %i.ti            ; 2 uses
...
._crit_edge721:                                   ; preds = %.lr.ph720, %.preheader591
  %.1.lcssa = phi double [ %11, %.preheader591 ], [ %i.uc, %.lr.ph720 ] ; 3 uses
  %i.tk = fsub double %.1.lcssa, %.0434729
  %i.tl = fadd double %.0434729, 1.000000e-10
  %i.tm = fdiv double %i.tk, %i.tl
  %i.tn = call double @llvm.fabs.f64(double %i.tm)
  %i.to = load double, ptr @Epsilon, align 8, !tbaa !28
  %i.tp = fcmp olt double %i.tn, %i.to
  %i.tq = icmp samesign ugt i32 %.2441728, 1
  %i.tr = fcmp ogt double %.1.lcssa, %.0434729
  %i.ts = select i1 %i.tq, i1 %i.tr, i1 false
  %i.tt = or i1 %i.ts, %i.tp
  br i1 %i.ih, label %bb.bc, label %._crit_edge727

bb.bc:                                            ; preds = %._crit_edge721
  %i.tu = load ptr, ptr %i.jn, align 8, !tbaa !55
  %i.tv = load ptr, ptr %i.nk, align 8, !tbaa !55
  %i.tw = call i32 @conjugate_gradient_mkernel(ptr noundef nonnull %.1477, ptr noundef %i.tu, ptr noundef %i.tv, i32 noundef %1, double noundef 1.000000e-03, i32 noundef %1) #11
  %.not509.peel = icmp eq i32 %i.tw, 0
...
bb.be:                                            ; preds = %bb.bd
  %i.tx = load ptr, ptr %i.oi, align 8, !tbaa !55
  call void @constrained_majorization_new_with_gaps(ptr noundef %i.og, ptr noundef %i.tx, ptr noundef nonnull %i.jn, i32 noundef 1, i32 noundef 15, float noundef %i.oj) #11
...
.lr.ph720:                                        ; preds = %.lr.ph720.preheader, %.lr.ph720
  ...
  %.1717 = phi double [ %i.td, %.lr.ph720.preheader ], [ %i.uc, %.lr.ph720 ]
  %i.ty = getelementptr inbounds nuw [8 x i8], ptr %i.jn, i64 %indvars.iv899 ; 2 uses
  %i.tz = load ptr, ptr %i.ty, align 8, !tbaa !55
  call void @right_mult_with_vector_ff(ptr noundef nonnull %.1477, i32 noundef %1, ptr noundef %i.tz, ptr noundef nonnull %i.nl) #11
  %i.ua = load ptr, ptr %i.ty, align 8, !tbaa !55
  %i.ub = call double @vectors_inner_productf(i32 noundef %1, ptr noundef %i.ua, ptr noundef nonnull %i.nl) #11
  %i.uc = fsub double %.1717, %i.ub               ; 2 uses
...
.lr.ph726.peel.next909:                           ; preds = %bb.be, %bb.bf
  ...
  %i.ud = getelementptr inbounds nuw [8 x i8], ptr %i.jn, i64 %indvars.iv904
  %i.ue = load ptr, ptr %i.ud, align 8, !tbaa !55
  %i.uf = getelementptr inbounds nuw [8 x i8], ptr %i.nk, i64 %indvars.iv904
  %i.ug = load ptr, ptr %i.uf, align 8, !tbaa !55
  %i.uh = call i32 @conjugate_gradient_mkernel(ptr noundef nonnull %.1477, ptr noundef %i.ue, ptr noundef %i.ug, i32 noundef %1, double noundef 1.000000e-03, i32 noundef %1) #11
  %.not509 = icmp eq i32 %i.uh, 0
...
._crit_edge727:                                   ; preds = %bb.bf, %bb.bd, %bb.be, %._crit_edge721
  %i.ui = add nuw nsw i32 %.2441728, 1            ; 3 uses
  %i.uj = icmp sge i32 %i.ui, %7
  %.not508 = select i1 %i.uj, i1 true, i1 %i.tt
...
.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge734
  ...
  %i.uk = getelementptr inbounds nuw [8 x i8], ptr %i.jn, i64 %indvars.iv922
  %i.ul = load ptr, ptr %i.uk, align 8, !tbaa !55 ; 2 uses
  %i.um = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv922
  %i.un = load ptr, ptr %i.um, align 8, !tbaa !26 ; 2 uses
...
vector.body1093:                                  ; preds = %.preheader, %vector.body1093
  ...
  %i.uo = getelementptr inbounds nuw [4 x i8], ptr %i.ul, i64 %index1094 ; 2 uses
  %i.up = getelementptr inbounds nuw i8, ptr %i.uo, i64 8
  %wide.load1095 = load <2 x float>, ptr %i.uo, align 4, !tbaa !47
  %wide.load1096 = load <2 x float>, ptr %i.up, align 4, !tbaa !47
  %i.uq = fpext <2 x float> %wide.load1095 to <2 x double>
  %i.ur = fpext <2 x float> %wide.load1096 to <2 x double>
  %i.us = getelementptr inbounds nuw [8 x i8], ptr %i.un, i64 %index1094 ; 2 uses
  %i.ut = getelementptr inbounds nuw i8, ptr %i.us, i64 16
  store <2 x double> %i.uq, ptr %i.us, align 8, !tbaa !28
  store <2 x double> %i.ur, ptr %i.ut, align 8, !tbaa !28
  %index.next1097 = add nuw i64 %index1094, 4     ; 2 uses
  %i.uu = icmp eq i64 %index.next1097, %n.vec1092
  br i1 %i.uu, label %middle.block1098, label %vector.body1093, !llvm.loop !76
...
scalar.ph1089:                                    ; preds = %scalar.ph1089.preheader, %scalar.ph1089
  ...
  %i.uv = getelementptr inbounds nuw [4 x i8], ptr %i.ul, i64 %indvars.iv916
  %i.uw = load float, ptr %i.uv, align 4, !tbaa !47
  %i.ux = fpext float %i.uw to double
  %i.uy = getelementptr inbounds nuw [8 x i8], ptr %i.un, i64 %indvars.iv916
  store double %i.ux, ptr %i.uy, align 8, !tbaa !28
...
bb.bh:                                            ; preds = %.loopexit, %bb.bg
  %i.uz = load ptr, ptr %i.nk, align 8, !tbaa !55
  call void @free(ptr noundef %i.uz) #11
...
.thread578:                                       ; preds = %bb.l, %.loopexit605, %bb.e, %bb.k, %bb.bh
  ...
  %i.va = load ptr, ptr %i.a, align 8, !tbaa !8
  call void @free(ptr noundef %i.va) #11
  %i.vb = load ptr, ptr %i.b, align 8, !tbaa !8
