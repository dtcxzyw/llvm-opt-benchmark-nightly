...
bb.f:                                             ; preds = %.split, %bb.e
  %i.aw = phi double [ %i.ai, %.split ], [ %i.an, %bb.e ] ; 3 uses
  %i.ax = phi double [ %i.ak, %.split ], [ %i.ap, %bb.e ] ; 3 uses
  %i.ay = phi double [ %i.aj, %.split ], [ %i.ao, %bb.e ] ; 2 uses
  ...
  %i.bd = fmul double %i.ax, %i.bb
  %2 = fmul double %i.ay, 2.000000e+00
  %i.be = fmul double %i.ax, %i.bc
  %3 = fdiv double %2, %i.bb
  %4 = insertelement <2 x double> poison, double %i.be, i64 0
  %5 = insertelement <2 x double> %4, double %3, i64 1
  %6 = fadd <2 x double> %5, <double -0.000000e+00, double 1.000000e+00>
  %7 = insertelement <2 x double> poison, double %i.ay, i64 0
  %8 = insertelement <2 x double> %7, double %i.aw, i64 1 ; 2 uses
  %9 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %8, <2 x double> %8, <2 x double> %6) ; 2 uses
  %10 = extractelement <2 x double> %9, i64 0
  %11 = fmul double %10, %i.aw
  %12 = extractelement <2 x double> %9, i64 1
  %i.bf = fmul double %i.bd, %12
  %i.bg = fcmp olt double %11, %i.bf
