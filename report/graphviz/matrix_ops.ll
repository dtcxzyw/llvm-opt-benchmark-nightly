...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.d = tail call nsz <2 x double> @llvm.fabs.v2f64(<2 x double> %wide.load) ; 2 uses
  %i.e = tail call nsz <2 x double> @llvm.fabs.v2f64(<2 x double> %wide.load11) ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.d = tail call nsz <4 x float> @llvm.fabs.v4f32(<4 x float> %wide.load) ; 2 uses
  %i.e = tail call nsz <4 x float> @llvm.fabs.v4f32(<4 x float> %wide.load11) ; 2 uses
