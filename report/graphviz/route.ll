...
bb.d:                                             ; preds = %bb.d, %.lr.ph.i
  ...
  %.sroa.17.0107.i = phi double [ 0.000000e+00, %.lr.ph.i ], [ %14, %bb.d ]
  %i.bc = phi <2 x double> [ zeroinitializer, %.lr.ph.i ], [ %i.cj, %bb.d ]
  %i.bd = phi <2 x double> [ zeroinitializer, %.lr.ph.i ], [ %i.cn, %bb.d ]
  %i.be = getelementptr inbounds nuw [40 x i8], ptr %i.f, i64 %indvars.iv.i ; 5 uses
  %8 = getelementptr inbounds nuw i8, ptr %i.be, i64 8
  %9 = getelementptr inbounds nuw i8, ptr %i.be, i64 16
  %i.bf = getelementptr inbounds nuw i8, ptr %i.be, i64 24
  %10 = load double, ptr %i.bf, align 8           ; 3 uses
  %i.bg = getelementptr inbounds nuw i8, ptr %i.be, i64 32
  %11 = load double, ptr %i.bg, align 8           ; 4 uses
  %12 = fmul double %11, %11
  %13 = tail call double @llvm.fmuladd.f64(double %10, double %10, double %12)
  %14 = fadd double %.sroa.17.0107.i, %13         ; 2 uses
  ...
  %i.cb = fsub double %i.bx, %i.ca                ; 2 uses
  %i.cc = load <2 x double>, ptr %8, align 8      ; 3 uses
  ...
  %18 = insertelement <2 x double> poison, double %11, i64 0
  %19 = insertelement <2 x double> %18, double %i.cb, i64 1
  %20 = fmul <2 x double> %17, %19
  %21 = insertelement <2 x double> %i.cc, double %i.bz, i64 1
  %i.ck = insertelement <2 x double> poison, double %10, i64 0
  %i.cl = shufflevector <2 x double> %i.ck, <2 x double> poison, <2 x i32> zeroinitializer
  %i.cm = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %21, <2 x double> %i.cl, <2 x double> %20)
...
._crit_edge.i:                                    ; preds = %bb.d, %.preheader
  %.sroa.17.0.lcssa.i = phi double [ 0.000000e+00, %.preheader ], [ %14, %bb.d ] ; 2 uses
...
.lr.ph.i.preheader.i:                             ; preds = %bb.f
  ...
  %foldExtExtBinop348.a = fsub <2 x double> %i.ea, %i.fi
  %i.fv = extractelement <2 x double> %foldExtExtBinop348.a, i64 1
...
.lr.ph71.i.i:                                     ; preds = %bb.g
  ...
  %foldExtExtBinop350 = fsub <2 x double> %i.gk, %shift
  %i.gl = extractelement <2 x double> %foldExtExtBinop350, i64 0 ; 2 uses
...
.lr.ph215:                                        ; preds = %.lr.ph215.preheader, %.lr.ph215
  ...
  %22 = fsub double 1.000000e+00, %i.rt
  %23 = fmul double %i.rt, 3.000000e+00
  %i.ru = insertelement <2 x double> poison, double %i.rt, i64 0
  %i.rv = insertelement <2 x double> %i.ru, double %22, i64 1 ; 5 uses
  %i.rw = insertelement <2 x double> poison, double %23, i64 0
  ...
  %24 = call double @llvm.fmuladd.f64(double %i.sl, double %i.qd, double %i.sk)
  %25 = extractelement <2 x double> %i.se, i64 0
  %i.sm = call double @llvm.fmuladd.f64(double %25, double %i.el, double %24)
  %26 = getelementptr inbounds nuw [16 x i8], ptr %2, i64 %indvars.iv254 ; 2 uses
  %27 = load double, ptr %26, align 8
  %28 = getelementptr inbounds nuw i8, ptr %26, i64 8
  %29 = load double, ptr %28, align 8
  %i.sn = extractelement <2 x double> %i.sj, i64 0
  %30 = fsub double %27, %i.sn
  %31 = fsub double %29, %i.sm
  %i.so = call double @hypot(double noundef %30, double noundef %31) #11 ; 2 uses
