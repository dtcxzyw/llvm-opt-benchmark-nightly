...
bb.d:                                             ; preds = %bb.d, %.lr.ph.i
  ...
  %.sroa.17.0107.i = phi double [ 0.000000e+00, %.lr.ph.i ], [ %13, %bb.d ]
  %i.bc = phi <2 x double> [ zeroinitializer, %.lr.ph.i ], [ %25, %bb.d ]
  ...
  %8 = load <4 x double>, ptr %i.bf, align 8      ; 7 uses
  %9 = load double, ptr %i.bg, align 8            ; 2 uses
  %10 = fmul double %9, %9
  %11 = extractelement <4 x double> %8, i64 2     ; 2 uses
  %12 = tail call double @llvm.fmuladd.f64(double %11, double %11, double %10)
  %13 = fadd double %.sroa.17.0107.i, %12         ; 2 uses
  %14 = shufflevector <4 x double> %8, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %15 = shufflevector <4 x double> %8, <4 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %16 = insertelement <2 x double> %15, double %i.by, i64 1
  %foldExtExtBinop.a = fmul <2 x double> %15, %16
  %17 = shufflevector <4 x double> %8, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %18 = shufflevector <4 x double> %8, <4 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %19 = insertelement <2 x double> %18, double %i.bx, i64 1
  %20 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %18, <2 x double> %19, <2 x double> %foldExtExtBinop.a)
  %21 = shufflevector <4 x double> %8, <4 x double> poison, <2 x i32> <i32 3, i32 poison>
  %22 = insertelement <2 x double> %21, double %i.by, i64 1
  %i.bz = fmul <2 x double> %14, %22
  %23 = shufflevector <4 x double> %8, <4 x double> poison, <2 x i32> <i32 2, i32 poison>
  %i.ca = insertelement <2 x double> %23, double %i.bx, i64 1
  %24 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %17, <2 x double> %i.ca, <2 x double> %i.bz)
  %25 = fadd <2 x double> %i.bc, %20              ; 2 uses
  %i.cb = fadd <2 x double> %i.bd, %24            ; 2 uses
...
._crit_edge.i:                                    ; preds = %bb.d, %.preheader
  %.sroa.17.0.lcssa.i = phi double [ 0.000000e+00, %.preheader ], [ %13, %bb.d ] ; 2 uses
  %i.cc = phi <2 x double> [ zeroinitializer, %.preheader ], [ %25, %bb.d ] ; 3 uses
