...
.lr.ph.i.i:                                       ; preds = %bb.ax, %.lr.ph.i.i
  ...
  %2 = srem i32 %i.lw, 10
  %3 = srem i32 %i.lv, 10
  %i.lx = insertelement <2 x i32> poison, i32 %3, i64 0
  %4 = insertelement <2 x i32> %i.lx, i32 %2, i64 1
  %i.ly = sub nsw <2 x i32> splat (i32 5), %4
...
.lr.ph.i45.i:                                     ; preds = %bb.bc, %.lr.ph.i45.i
  ...
  %5 = srem i32 %i.ox, 10
  %6 = srem i32 %i.ow, 10
  %i.oy = insertelement <2 x i32> poison, i32 %6, i64 0
  %7 = insertelement <2 x i32> %i.oy, i32 %5, i64 1
  %i.oz = sub nsw <2 x i32> splat (i32 5), %7
...
.lr.ph.i.i55:                                     ; preds = %bb.bm, %.lr.ph.i.i55
  ...
  %8 = srem i32 %i.rp, 10
  %9 = srem i32 %i.ro, 10
  %i.rq = insertelement <2 x i32> poison, i32 %9, i64 0
  %10 = insertelement <2 x i32> %i.rq, i32 %8, i64 1
  %i.rr = sub nsw <2 x i32> splat (i32 5), %10
...
.lr.ph.i:                                         ; preds = %bb.c, %.lr.ph.i
  ...
  %2 = srem i32 %i.x, 10
  %3 = srem i32 %i.w, 10
  %i.y = insertelement <2 x i32> poison, i32 %3, i64 0
  %4 = insertelement <2 x i32> %i.y, i32 %2, i64 1
  %i.z = sub nsw <2 x i32> splat (i32 5), %4
...
.lr.ph.i:                                         ; preds = %bb.c, %.lr.ph.i
  ...
  %4 = srem i32 %i.ab, 10
  %5 = srem i32 %i.aa, 10
  %i.ac = insertelement <2 x i32> poison, i32 %5, i64 0
  %6 = insertelement <2 x i32> %i.ac, i32 %4, i64 1
  %i.ad = sub nsw <2 x i32> splat (i32 5), %6
