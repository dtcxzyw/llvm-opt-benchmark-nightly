...
bb.s:                                             ; preds = %bb.s, %.new
  ...
  %i.cr = icmp slt i64 %.0114152, %sext
...
bb.t:                                             ; preds = %bb.t, %.new248
  ...
  %i.ds = icmp slt i64 %.0112154, %sext156
  ...
  %i.ed = icmp slt i64 %i.dy, %sext156
