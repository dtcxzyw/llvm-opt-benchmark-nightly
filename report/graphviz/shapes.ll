...
vector.body718:                                   ; preds = %vector.body718, %.lr.ph629
  ...
  %i.ra = fmul nsz <2 x double> %i.qz, splat (double 2.000000e+00) ; 2 uses
  ...
  %i.re = fmul nsz <2 x double> %i.rd, splat (double 2.000000e+00) ; 2 uses
  ...
  %i.rj = fmul nsz <2 x double> %i.ri, splat (double 2.000000e+00) ; 2 uses
  ...
  %i.rn = fmul nsz <2 x double> %i.rm, splat (double 2.000000e+00) ; 2 uses
  ...
  %2 = freeze <2 x i1> %i.rr
  %i.rs = bitcast <2 x i1> %2 to i2
