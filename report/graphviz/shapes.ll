...
bb.c:                                             ; preds = %bb.b
  %.sroa.0.0.copyload = load double, ptr %i.b, align 8, !tbaa !10
...
bb.d:                                             ; preds = %bb.c
  ...
  %.sroa.5.0.copyload = load double, ptr %.sroa.5.0..sroa_idx, align 8, !tbaa !10
...
bb.g:                                             ; preds = %bb.f
  ...
  store ptr %i.x, ptr %i.y, align 8, !tbaa !76
  ...
  %i.ad = load ptr, ptr @N_penwidth, align 8, !tbaa !56
  ...
  %i.af = load ptr, ptr %i.y, align 8, !tbaa !76
  %i.ag = getelementptr inbounds nuw i8, ptr %i.af, i64 8
  %i.ah = load i64, ptr %i.ag, align 8, !tbaa !50 ; 4 uses
...
bb.k:                                             ; preds = %bb.i, %bb.j, %bb.h
  ...
  store i64 %.sink, ptr %i.ao, align 8, !tbaa !76
  store ptr %i.c, ptr %i.s, align 8, !tbaa !76
  br label %bb.m
...
.lr.ph:                                           ; preds = %bb.m
  ...
  %i.aw = load i64, ptr %i.av, align 8, !tbaa !76
...
bb.n:                                             ; preds = %bb.n, %.lr.ph
  ...
  %.sroa.011.0.copyload = load double, ptr %gep, align 8, !tbaa !10 ; 2 uses
  %.sroa.412.0..sroa_idx = getelementptr inbounds nuw i8, ptr %gep, i64 8
  %.sroa.412.0.copyload = load double, ptr %.sroa.412.0..sroa_idx, align 8, !tbaa !10 ; 2 uses
  %i.az = add i64 %.075, 4
  %i.ba = urem i64 %i.az, %.057
  %gep79 = getelementptr [16 x i8], ptr %invariant.gep, i64 %i.ba ; 2 uses
  %.sroa.09.0.copyload = load double, ptr %gep79, align 8, !tbaa !10
  %.sroa.410.0..sroa_idx = getelementptr inbounds nuw i8, ptr %gep79, i64 8
  %.sroa.410.0.copyload = load double, ptr %.sroa.410.0..sroa_idx, align 8, !tbaa !10
...
bb.a:
  %.sroa.0.0.copyload = load double, ptr %1, align 8, !tbaa !10 ; 4 uses
  %.sroa.8.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 2 uses
  %.sroa.8.0.copyload = load double, ptr %.sroa.8.0..sroa_idx, align 8, !tbaa !10 ; 4 uses
...
bb.e:                                             ; preds = %bb.c, %bb.d, %bb.b
  ...
  store double %i.ab, ptr %i.g, align 8, !tbaa !18
  ...
  %i.ar = tail call double @llvm.fmuladd.f64(double %i.s, double f0xBFD3C6EF372FE953, double %i.u)
  %i.as = getelementptr inbounds nuw i8, ptr %0, i64 152
  store double %i.ar, ptr %i.as, align 8, !tbaa !17
  store double %.sroa.0.0, ptr %1, align 8, !tbaa !10
  store double %.sroa.8.0, ptr %.sroa.8.0..sroa_idx, align 8, !tbaa !10
  ret void
}
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  store double %.sroa.03.0, ptr %i.n, align 16, !tbaa !10
  %.sroa.6.0..sroa_idx = getelementptr inbounds nuw i8, ptr %3, i64 40
  store double %.sroa.6.0, ptr %.sroa.6.0..sroa_idx, align 8, !tbaa !10
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %i.m, ptr noundef nonnull align 16 dereferenceable(16) %i.n, i64 16, i1 false), !tbaa.struct !11
...
!15 = !{!14, !14, i64 0}
!16 = !{!"pointf_s", !9, i64 0, !9, i64 8}
!17 = !{!16, !9, i64 8}
!18 = !{!16, !9, i64 0}
!19 = !{!"long", !5, i64 0}
!20 = !{!"Agtag_s", !6, i64 0, !6, i64 0, !6, i64 0, !6, i64 0, !19, i64 8}
!21 = !{!"p1 _ZTS7Agrec_s", !13, i64 0}
!22 = !{!"Agobj_s", !20, i64 0, !21, i64 16}
!23 = !{!22, !21, i64 16}
!24 = !{!"p1 omnipotent char", !13, i64 0}
!25 = !{!"Agrec_s", !24, i64 0, !21, i64 8}
!26 = !{!"p1 _ZTS10shape_desc", !13, i64 0}
!27 = !{!"", !16, i64 0, !16, i64 16}
!28 = !{!"p1 _ZTS11textlabel_t", !13, i64 0}
!29 = !{!"_Bool", !5, i64 0}
!30 = !{!"p1 double", !13, i64 0}
!31 = !{!"p1 _ZTS8Agnode_s", !13, i64 0}
!32 = !{!"any p2 pointer", !13, i64 0}
!33 = !{!"p2 _ZTS8Agedge_s", !32, i64 0}
!34 = !{!"elist", !33, i64 0, !19, i64 8}
!35 = !{!"p1 _ZTS8Agraph_s", !13, i64 0}
!36 = !{!"p1 _ZTS8Agedge_s", !13, i64 0}
!37 = !{!"Agnodeinfo_t", !25, i64 0, !26, i64 16, !13, i64 24, !16, i64 32, !9, i64 48, !9, i64 56, !27, i64 64, !9, i64 96, !9, i64 104, !9, i64 112, !9, i64 120, !9, i64 128, !28, i64 136, !28, i64 144, !13, i64 152, !5, i64 160, !5, i64 161, !29, i64 162, !5, i64 163, !6, i64 164, !6, i64 168, !6, i64 172, !30, i64 176, !9, i64 184, !5, i64 192, !29, i64 193, !31, i64 200, !31, i64 208, !5, i64 216, !19, i64 224, !5, i64 232, !5, i64 233, !5, i64 234, !31, i64 240, !31, i64 248, !34, i64 256, !34, i64 272, !34, i64 288, !34, i64 304, !34, i64 320, !35, i64 336, !6, i64 344, !31, i64 352, !6, i64 360, !6, i64 364, !9, i64 368, !34, i64 376, !34, i64 392, !34, i64 408, !34, i64 424, !36, i64 440, !6, i64 448, !6, i64 452, !6, i64 456, !5, i64 464}
!38 = !{!37, !26, i64 16}
!39 = !{!"p1 _ZTS15shape_functions", !13, i64 0}
!40 = !{!"p1 _ZTS9polygon_t", !13, i64 0}
!41 = !{!"shape_desc", !24, i64 0, !39, i64 8, !40, i64 16, !29, i64 24}
end_hunk_0
