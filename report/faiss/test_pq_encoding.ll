Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/faiss/original/test_pq_encoding?download=true
...
bb.l:                                             ; preds = %.preheader167, %_ZNSt6vectorIhSaIhEED2Ev.exit86
  %.053214 = phi i32 [ 0, %.preheader167 ], [ %i.fn, %_ZNSt6vectorIhSaIhEED2Ev.exit86 ]
...
.preheader166:                                    ; preds = %bb.s
  ...
  invoke void @_ZN5faiss22pq4_set_packed_elementEPhhmmmm(ptr noundef %i.bb, i8 noundef zeroext %i.bf, i64 noundef %i.bh, i64 noundef 5, i64 noundef %i.ba, i64 noundef 0)
...
bb.u:                                             ; preds = %.preheader166
  ...
  invoke void @_ZN5faiss22pq4_set_packed_elementEPhhmmmm(ptr noundef %i.co, i8 noundef zeroext %i.ct, i64 noundef %i.cv, i64 noundef 5, i64 noundef %i.ba, i64 noundef 1)
...
bb.v:                                             ; preds = %bb.u
  ...
  invoke void @_ZN5faiss22pq4_set_packed_elementEPhhmmmm(ptr noundef %i.cw, i8 noundef zeroext %i.db, i64 noundef %i.dd, i64 noundef 5, i64 noundef %i.ba, i64 noundef 2)
...
bb.w:                                             ; preds = %bb.v
  ...
  invoke void @_ZN5faiss22pq4_set_packed_elementEPhhmmmm(ptr noundef %i.de, i8 noundef zeroext %i.dj, i64 noundef %i.dl, i64 noundef 5, i64 noundef %i.ba, i64 noundef 3)
...
bb.x:                                             ; preds = %bb.w
  ...
  invoke void @_ZN5faiss22pq4_set_packed_elementEPhhmmmm(ptr noundef %i.dm, i8 noundef zeroext %i.dr, i64 noundef %i.dt, i64 noundef 5, i64 noundef %i.ba, i64 noundef 4)
          to label %.preheader.preheader unwind label %bb.y

.preheader.preheader:                             ; preds = %bb.x
  %i.du = zext i32 %i.ax to i64
  br label %.preheader
...
.preheader:                                       ; preds = %.preheader.preheader, %.split212.us
  ...
  %i.dw = mul nuw nsw i64 %indvars.iv246, 5
  %i.dx = icmp eq i64 %indvars.iv246, %i.du
  %.fr = freeze i1 %i.dx
  %invariant.gep309 = getelementptr inbounds nuw i8, ptr %i.ay, i64 %i.dw ; 2 uses
...
.preheader.split.us:                              ; preds = %.preheader, %_ZN7testing15AssertionResultD2Ev.exit97.us
  ...
  %i.dy = load ptr, ptr %i.i, align 8, !tbaa !93
  %i.dz = load i32, ptr %i.j, align 4, !tbaa !95
  %i.ea = sext i32 %i.dz to i64
  %i.eb = invoke noundef zeroext i8 @_ZN5faiss22pq4_get_packed_elementEPKhmmmm(ptr noundef %i.dy, i64 noundef %i.ea, i64 noundef 5, i64 noundef %indvars.iv246, i64 noundef %indvars.iv242)
          to label %bb.z unwind label %.split.us  ; 2 uses

bb.z:                                             ; preds = %.preheader.split.us
  store i8 %i.eb, ptr %i.a, align 1, !tbaa !42
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #17
  %gep310 = getelementptr inbounds nuw i8, ptr %invariant.gep309, i64 %indvars.iv242
  %i.ec = load i8, ptr %gep310, align 1, !tbaa !42 ; 2 uses
  store i8 %i.ec, ptr %i.b, align 1, !tbaa !42
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #17
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #17
  %i.ed = add i8 %i.ec, 3
  %i.ee = and i8 %i.ed, 15                        ; 2 uses
  %i.ef = zext nneg i8 %i.ee to i32
  store i32 %i.ef, ptr %i.c, align 4, !tbaa !101
  %i.eg = icmp eq i8 %i.ee, %i.eb
  br i1 %i.eg, label %bb.ac, label %bb.aa
...
bb.ab:                                            ; preds = %_ZN7testing8internal33FormatForComparisonFailureMessageIihEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERKT_RKT0_.exit.i.us
  %i.eh = load ptr, ptr %4, align 8, !tbaa !53, !noalias !102 ; 2 uses
  %i.ei = icmp eq ptr %i.eh, %i.n
  br i1 %i.ei, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i.us, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.us

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.us: ; preds = %bb.ab
  %i.ej = load i64, ptr %i.n, align 8, !tbaa !42, !noalias !102
  %i.ek = add i64 %i.ej, 1
  call void @_ZdlPvm(ptr noundef %i.eh, i64 noundef %i.ek) #18
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i.us: ; preds = %bb.ab, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.us
  ...
  %i.el = load ptr, ptr %3, align 8, !tbaa !53, !noalias !102 ; 2 uses
  %i.em = icmp eq ptr %i.el, %i.o
  br i1 %i.em, label %.noexc87.us, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i9.i.us
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i9.i.us: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i.us
  %i.en = load i64, ptr %i.o, align 8, !tbaa !42, !noalias !102
  %i.eo = add i64 %i.en, 1
...
_ZN7testing8internal8EqHelper7CompareIhiTnPNSt9enable_ifIXoontsr3std11is_integralIT_EE5valuentsr3std10is_pointerIT0_EE5valueEvE4typeELPv0EEENS_15AssertionResultEPKcSC_RKS4_RKS5_.exit.us: ; preds = %bb.ac, %.noexc87.us
  ...
  %i.ep = load i8, ptr %6, align 8, !tbaa !57, !range !66, !noundef !67
  %i.eq = trunc nuw i8 %i.ep to i1
  br i1 %i.eq, label %bb.ai, label %bb.ad
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.er = load ptr, ptr %i.p, align 8, !tbaa !68  ; 2 uses
  %.not.i.i.us = icmp eq ptr %i.er, null
  br i1 %.not.i.i.us, label %_ZNK7testing15AssertionResult15failure_messageEv.exit.us, label %bb.af

bb.af:                                            ; preds = %bb.ae
  %i.es = load ptr, ptr %i.er, align 8, !tbaa !53
...
_ZNK7testing15AssertionResult15failure_messageEv.exit.us: ; preds = %bb.af, %bb.ae
  %i.et = phi ptr [ %i.es, %bb.af ], [ @.str.17, %bb.ae ]
  invoke void @_ZN7testing8internal12AssertHelperC1ENS_14TestPartResult4TypeEPKciS5_(ptr noundef nonnull align 8 dereferenceable(8) %8, i32 noundef 1, ptr noundef nonnull @.str.2, i32 noundef 138, ptr noundef %i.et)
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.eu = load ptr, ptr %7, align 8, !tbaa !69    ; 3 uses
  %.not.i.i88.us = icmp eq ptr %i.eu, null
...
_ZNKSt14default_deleteINSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEEEEclEPS5_.exit.i.i.us: ; preds = %bb.ah
  ...
  call void %i.ex(ptr noundef nonnull align 8 dereferenceable(128) %i.eu) #17, !inline_history !71
...
bb.ai:                                            ; preds = %_ZN7testing7MessageD2Ev.exit.us, %_ZN7testing8internal8EqHelper7CompareIhiTnPNSt9enable_ifIXoontsr3std11is_integralIT_EE5valuentsr3std10is_pointerIT0_EE5valueEvE4typeELPv0EEENS_15AssertionResultEPKcSC_RKS4_RKS5_.exit.us
  %i.ey = load ptr, ptr %i.p, align 8, !tbaa !68  ; 4 uses
  %.not.i.i93.us = icmp eq ptr %i.ey, null
...
bb.aj:                                            ; preds = %bb.ai
  ...
  br i1 %i.fb, label %_ZNKSt14default_deleteINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclEPS5_.exit.i.i95.us, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i94.us

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i94.us: ; preds = %bb.aj
  %i.fc = load i64, ptr %i.fa, align 8, !tbaa !42
  %i.fd = add i64 %i.fc, 1
  call void @_ZdlPvm(ptr noundef %i.ez, i64 noundef %i.fd) #18
...
_ZNKSt14default_deleteINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclEPS5_.exit.i.i95.us: ; preds = %bb.aj, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i94.us
  call void @_ZdlPvm(ptr noundef nonnull %i.ey, i64 noundef 32) #18
...
.split196.us:                                     ; preds = %_ZN7testing8internal33FormatForComparisonFailureMessageIihEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERKT_RKT0_.exit.i.us
  %i.fh = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.fi = load ptr, ptr %4, align 8, !tbaa !53, !noalias !102 ; 2 uses
  %i.fj = icmp eq ptr %i.fi, %i.n
  br i1 %i.fj, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit14.i, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i12.i
