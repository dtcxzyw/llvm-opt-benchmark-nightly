Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/faiss/original/test_super_kmeans_foundations?download=true
...
bb.ar:                                            ; preds = %bb.af, %_ZN7testing7MessageD2Ev.exit59
  ...
  %i.cb = load ptr, ptr %i.ca, align 8, !tbaa !30 ; 4 uses
...
_ZN7testing15AssertionResultD2Ev.exit67:          ; preds = %bb.ar, %_ZNKSt14default_deleteINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclEPS5_.exit.i.i65
  ...
  %i.ch = load float, ptr %.07.i.i.i.i.i.i.i.i.i.ptr.3, align 4, !tbaa !49
...
bb.at:                                            ; preds = %_ZN7testing15AssertionResultD2Ev.exit67
  %i.cj = load i8, ptr %10, align 8, !tbaa !27, !range !28, !noundef !29
...
bb.ay:                                            ; preds = %bb.ax
  %i.co = load ptr, ptr %i.cn, align 8, !tbaa !35
...
bb.ba:                                            ; preds = %bb.az
  ...
  %i.cq = load ptr, ptr %11, align 8, !tbaa !37   ; 3 uses
...
_ZNKSt14default_deleteINSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEEEEclEPS5_.exit.i.i71: ; preds = %bb.ba
  %i.cr = load ptr, ptr %i.cq, align 8, !tbaa !39
  %i.cs = getelementptr inbounds nuw i8, ptr %i.cr, i64 8
  %i.ct = load ptr, ptr %i.cs, align 8
  call void %i.ct(ptr noundef nonnull align 8 dereferenceable(128) %i.cq) #18, !inline_history !0
...
bb.be:                                            ; preds = %bb.bd, %bb.bc
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %12) #18
  %i.cx = load ptr, ptr %11, align 8, !tbaa !37   ; 3 uses
...
_ZNKSt14default_deleteINSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEEEEclEPS5_.exit.i.i74: ; preds = %bb.be
  ...
  call void %i.da(ptr noundef nonnull align 8 dereferenceable(128) %i.cx) #18, !inline_history !0
  br label %_ZN7testing7MessageD2Ev.exit75
...
bb.bf:                                            ; preds = %bb.at, %_ZN7testing7MessageD2Ev.exit72
  ...
  %i.dc = load ptr, ptr %i.db, align 8, !tbaa !30 ; 4 uses
  %.not.i.i76 = icmp eq ptr %i.dc, null
  br i1 %.not.i.i76, label %_ZNSt6vectorIfSaIfEED2Ev.exit84, label %bb.bg

bb.bg:                                            ; preds = %bb.bf
  %i.dd = load ptr, ptr %i.dc, align 8, !tbaa !35 ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i77: ; preds = %bb.bg
  %i.dg = load i64, ptr %i.de, align 8, !tbaa !40
  %i.dh = add i64 %i.dg, 1
...
_ZNSt6vectorIfSaIfEED2Ev.exit84:                  ; preds = %bb.bf, %_ZNKSt14default_deleteINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclEPS5_.exit.i.i78
...
_ZNSt6vectorIfSaIfEED2Ev.exit87:                  ; preds = %bb.bh, %bb.au, %bb.ag, %bb.s, %bb.e
...
_ZNSt6vectorIfSaIfEED2Ev.exit90:                  ; preds = %_ZNSt6vectorIfSaIfEED2Ev.exit87, %bb.d
  %.pn30.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn30.pn.pn.pn, %_ZNSt6vectorIfSaIfEED2Ev.exit87 ], [ %i.g, %bb.d ]
  call void @_ZdlPvm(ptr noundef nonnull %i.a, i64 noundef 128) #19
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %vector.ph
  ...
  %i.y = load float, ptr %i.x, align 4, !tbaa !49
  %i.z = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %indvars.iv.next.i
  %i.aa = load float, ptr %i.z, align 4, !tbaa !49
  ...
  %i.ae = load float, ptr %i.ad, align 4, !tbaa !49
  %i.af = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %indvars.iv.next.i.1
  %i.ag = load float, ptr %i.af, align 4, !tbaa !49
  ...
  %i.ak = load float, ptr %i.aj, align 4, !tbaa !49
  %i.al = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %indvars.iv.next.i.2
  %i.am = load float, ptr %i.al, align 4, !tbaa !49
  ...
  br i1 %exitcond.not.i.3, label %_ZN5faiss6detail8block_l2ILNS_9SIMDLevelE0EEEfPKfS4_i.exit, label %.lr.ph.i, !llvm.loop !1
...
bb.c:                                             ; preds = %_ZN5faiss6detail8block_l2ILNS_9SIMDLevelE0EEEfPKfS4_i.exit
  %i.ar = load i8, ptr %1, align 8, !tbaa !27, !range !28, !noundef !29
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ay = load ptr, ptr %2, align 8, !tbaa !37    ; 3 uses
...
_ZNKSt14default_deleteINSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEEEEclEPS5_.exit.i.i: ; preds = %bb.i
  ...
  call void %i.bb(ptr noundef nonnull align 8 dereferenceable(128) %i.ay) #18, !inline_history !0
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #18
  %i.bf = load ptr, ptr %2, align 8, !tbaa !37    ; 3 uses
...
_ZNKSt14default_deleteINSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEEEEclEPS5_.exit.i.i34: ; preds = %bb.m
  ...
  call void %i.bi(ptr noundef nonnull align 8 dereferenceable(128) %i.bf) #18, !inline_history !0
  br label %_ZN7testing7MessageD2Ev.exit35
...
bb.n:                                             ; preds = %bb.c, %_ZN7testing7MessageD2Ev.exit
  ...
  %i.bk = load ptr, ptr %i.bj, align 8, !tbaa !30 ; 4 uses
...
.lr.ph.i39:                                       ; preds = %.lr.ph.i39, %.lr.ph.preheader.i.new
  ...
  %i.bt = load float, ptr %i.bs, align 4, !tbaa !49
  %i.bu = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %indvars.iv.i40
  %i.bv = load float, ptr %i.bu, align 4, !tbaa !49
  ...
  %i.bz = load float, ptr %i.by, align 4, !tbaa !49
