...
bb.u:                                             ; preds = %_ZNSt6vectorIlSaIlEE9push_backEOl.exit
  %exitcond.not = icmp eq i64 %i.cy, 100
...
bb.ad:                                            ; preds = %bb.m
  %i.bk = landingpad { ptr, i32 }
          cleanup
  br label %_ZNSt6vectorIlSaIlEED2Ev.exit409.a
...
bb.ai:                                            ; preds = %.lr.ph.preheader.i.i.i.i.i238, %bb.t
  %i.bp = landingpad { ptr, i32 }
          cleanup
  br label %_ZNSt6vectorIS_IlSaIlEESaIS1_EED2Ev.exit392

bb.aj:                                            ; preds = %_ZNSt6vectorIS_IlSaIlEESaIS1_EEC2EmRKS2_.exit, %bb.u
  %.0146870 = phi i64 [ 0, %_ZNSt6vectorIS_IlSaIlEESaIS1_EEC2EmRKS2_.exit ], [ %i.cy, %bb.u ] ; 4 uses
  %i.bq = getelementptr inbounds nuw [8 x i8], ptr %i.v, i64 %.0146870
  %i.br = load i64, ptr %i.bq, align 8, !tbaa !57 ; 2 uses
  %i.bs = getelementptr inbounds nuw [24 x i8], ptr %.sroa.0464.0, i64 %i.br ; 4 uses
  %i.bt = add nuw nsw i64 %.0146870, 900          ; 2 uses
...
bb.ao:                                            ; preds = %_ZNSt6vectorIlSaIlEE11_S_relocateEPlS2_S2_RS0_.exit16.i.i.i
  %i.co = load ptr, ptr %i.bw, align 8, !tbaa !59
  %i.cp = ptrtoint ptr %i.co to i64
  %i.cq = sub i64 %i.cp, %i.cb
  tail call void @_ZdlPvm(ptr noundef nonnull %i.bz, i64 noundef %i.cq) #21
...
_ZNSt6vectorIlSaIlEE17_M_realloc_insertIJlEEEvN9__gnu_cxx17__normal_iteratorIPlS1_EEDpOT_.exit.i.i: ; preds = %bb.ao, %_ZNSt6vectorIlSaIlEE11_S_relocateEPlS2_S2_RS0_.exit16.i.i.i
  ...
  store ptr %i.cr, ptr %i.bw, align 8, !tbaa !59
  br label %_ZNSt6vectorIlSaIlEE9push_backEOl.exit
...
_ZNSt6vectorIlSaIlEE9push_backEOl.exit:           ; preds = %_ZNSt6vectorIlSaIlEE17_M_realloc_insertIJlEEEvN9__gnu_cxx17__normal_iteratorIPlS1_EEDpOT_.exit.i.i, %bb.ak
  %i.cs = getelementptr inbounds nuw [24 x i8], ptr %.sroa.0472.0578615, i64 %i.br ; 3 uses
  %i.ct = getelementptr inbounds nuw i8, ptr %i.cs, i64 8
  %i.cu = load ptr, ptr %i.ct, align 8, !tbaa !61
  %i.cv = load i64, ptr %i.ac, align 8, !tbaa !33 ; 2 uses
  %i.cw = mul i64 %i.cv, %.0146870
  %i.cx = getelementptr inbounds nuw i8, ptr %.sroa.0482.0, i64 %i.cw
  %i.cy = add nuw nsw i64 %.0146870, 1            ; 3 uses
  %i.cz = mul i64 %i.cv, %i.cy
  %i.da = getelementptr inbounds nuw i8, ptr %.sroa.0482.0, i64 %i.cz
  %i.db = load ptr, ptr %i.cs, align 8, !tbaa !61 ; 2 uses
  %i.dc = ptrtoint ptr %i.cu to i64
  %i.dd = ptrtoint ptr %i.db to i64
  %i.de = sub i64 %i.dc, %i.dd
  %i.df = getelementptr inbounds i8, ptr %i.db, i64 %i.de
  invoke void @_ZNSt6vectorIhSaIhEE15_M_range_insertIPhEEvN9__gnu_cxx17__normal_iteratorIS3_S1_EET_S7_St20forward_iterator_tag(ptr noundef nonnull align 8 dereferenceable(24) %i.cs, ptr %i.df, ptr noundef %i.cx, ptr noundef %i.da)
...
bb.aq:                                            ; preds = %bb.v
  %i.dh = load i64, ptr %i.n, align 8, !tbaa !23  ; 4 uses
  %i.di = trunc i64 %i.dh to i32
  %sext = mul i64 %i.dh, 429496729600             ; 4 uses
  %i.dj = ashr exact i64 %sext, 32                ; 3 uses
  %i.dk = icmp ugt i64 %i.dj, 2305843009213693951
  br i1 %i.dk, label %bb.ar, label %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i
...
bb.as:                                            ; preds = %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i
  %i.dl = ashr exact i64 %sext, 30                ; 2 uses
  %i.dm = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.dl) #23
          to label %bb.at unwind label %bb.ax     ; 5 uses

bb.at:                                            ; preds = %bb.as
  %i.dn = getelementptr inbounds nuw [4 x i8], ptr %i.dm, i64 %i.dj ; 2 uses
  store float 0.000000e+00, ptr %i.dm, align 4, !tbaa !63
  %i.do = getelementptr i8, ptr %i.dm, i64 4
  %.idx.i.i.i.i.i.i.i = add nsw i64 %i.dl, -4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %i.do, i8 0, i64 %.idx.i.i.i.i.i.i.i, i1 false), !tbaa !63
  %i.dp = ashr exact i64 %sext, 29                ; 2 uses
  %i.dq = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.dp) #23
          to label %.noexc257 unwind label %_ZNSt6vectorIlSaIlEED2Ev.exit376.thread ; 4 uses

.noexc257:                                        ; preds = %bb.at
  %i.dr = getelementptr inbounds nuw [8 x i8], ptr %i.dq, i64 %i.dj
  store i64 0, ptr %i.dq, align 8, !tbaa !57
  %i.ds = getelementptr i8, ptr %i.dq, i64 8
  %.idx.i.i.i.i.i.i.i254 = add nsw i64 %i.dp, -8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.ds, i8 0, i64 %.idx.i.i.i.i.i.i.i254, i1 false), !tbaa !57
...
_ZNSt6vectorIlSaIlEEC2EmRKS0_.exit258:            ; preds = %.noexc257, %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i
  %.sroa.11452.0637 = phi ptr [ %i.dn, %.noexc257 ], [ null, %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i ] ; 2 uses
  %.sroa.0447.0627 = phi ptr [ %i.dm, %.noexc257 ], [ null, %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i ] ; 7 uses
  %.sroa.0440.0 = phi ptr [ %i.dq, %.noexc257 ], [ null, %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i ] ; 8 uses
  %.sroa.11.0 = phi i64 [ %i.dt, %.noexc257 ], [ 0, %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i ] ; 2 uses
  %i.du = load ptr, ptr %i.x, align 8, !tbaa !32  ; 2 uses
  %sext189 = shl i64 %i.dh, 32
end_hunk_0
begin_hunk_1_@_ZN12_GLOBAL__N_122test_search_and_encodeEPKcN5faiss10MetricTypeE:bb.a
  %i.vp = fcmp ogt float %i.vk, %i.vo
  br i1 %i.vp, label %.lr.ph.i.i.us, label %bb.bj

.lr.ph.i.i.us:                                    ; preds = %bb.bf, %bb.bi
  %i.vq = phi i64 [ %i.wt, %bb.bi ], [ 3, %bb.bf ]
  %i.vr = phi i64 [ %i.ws, %bb.bi ], [ 2, %bb.bf ] ; 7 uses
  %.056.i.i.us = phi i64 [ %.1.i.i.us, %bb.bi ], [ 1, %bb.bf ] ; 6 uses
  %i.vs = icmp eq i64 %i.vr, 10
  br i1 %i.vs, label %.lr.ph._ZN5faiss4CMinIflE4cmp2Effll.exit.thread_crit_edge.i.i.us, label %bb.bg

bb.bg:                                            ; preds = %.lr.ph.i.i.us
  %i.vt = getelementptr inbounds nuw [4 x i8], ptr %i.ug, i64 %i.vr
  %i.vu = load float, ptr %i.vt, align 4, !tbaa !63 ; 4 uses
  %i.vv = getelementptr [4 x i8], ptr %i.ek, i64 %i.vr
  %i.vw = load float, ptr %i.vv, align 4, !tbaa !63 ; 5 uses
  %i.vx = getelementptr [8 x i8], ptr %i.el, i64 %i.vr
  %i.vy = load i64, ptr %i.vx, align 8, !tbaa !57 ; 3 uses
  %i.vz = fcmp olt float %i.vu, %i.vw
  br i1 %i.vz, label %_ZN5faiss4CMinIflE4cmp2Effll.exit.thread.i.i.us, label %_ZN5faiss4CMinIflE4cmp2Effll.exit.i.i.us

_ZN5faiss4CMinIflE4cmp2Effll.exit.i.i.us:         ; preds = %bb.bg
  %i.wa = getelementptr inbounds nuw [8 x i8], ptr %i.uh, i64 %i.vr
  %i.wb = load i64, ptr %i.wa, align 8, !tbaa !57
  %i.wc = fcmp oeq float %i.vu, %i.vw
  %i.wd = icmp slt i64 %i.wb, %i.vy
  %i.we = and i1 %i.wc, %i.wd
  br i1 %i.we, label %_ZN5faiss4CMinIflE4cmp2Effll.exit.thread.i.i.us, label %bb.bh

bb.bh:                                            ; preds = %_ZN5faiss4CMinIflE4cmp2Effll.exit.i.i.us
  %i.wf = fcmp olt float %i.vk, %i.vw
  br i1 %i.wf, label %_ZN5faiss19minheap_replace_topIfEEvmPT_PlS1_l.exit.us, label %_ZN5faiss4CMinIflE4cmp2Effll.exit55.i.i.us

_ZN5faiss4CMinIflE4cmp2Effll.exit55.i.i.us:       ; preds = %bb.bh
  %i.wg = fcmp oeq float %i.vk, %i.vw
  %i.wh = icmp slt i64 %i.vn, %i.vy
  %i.wi = and i1 %i.wg, %i.wh
  br i1 %i.wi, label %_ZN5faiss19minheap_replace_topIfEEvmPT_PlS1_l.exit.us, label %bb.bi
...
_ZN5faiss4CMinIflE4cmp2Effll.exit.thread.i.i.us:  ; preds = %.lr.ph._ZN5faiss4CMinIflE4cmp2Effll.exit.thread_crit_edge.i.i.us, %_ZN5faiss4CMinIflE4cmp2Effll.exit.i.i.us, %bb.bg
  %i.wj = phi float [ %.pre.i.i.us, %.lr.ph._ZN5faiss4CMinIflE4cmp2Effll.exit.thread_crit_edge.i.i.us ], [ %i.vu, %bb.bg ], [ %i.vu, %_ZN5faiss4CMinIflE4cmp2Effll.exit.i.i.us ] ; 3 uses
  %i.wk = fcmp olt float %i.vk, %i.wj
  br i1 %i.wk, label %_ZN5faiss19minheap_replace_topIfEEvmPT_PlS1_l.exit.us, label %_ZN5faiss4CMinIflE4cmp2Effll.exit54.i.i.us

_ZN5faiss4CMinIflE4cmp2Effll.exit54.i.i.us:       ; preds = %_ZN5faiss4CMinIflE4cmp2Effll.exit.thread.i.i.us
  %i.wl = getelementptr inbounds nuw [8 x i8], ptr %i.uh, i64 %i.vr
  %i.wm = load i64, ptr %i.wl, align 8, !tbaa !57 ; 2 uses
  %i.wn = fcmp oeq float %i.vk, %i.wj
  %i.wo = icmp slt i64 %i.vn, %i.wm
  %i.wp = and i1 %i.wn, %i.wo
  br i1 %i.wp, label %_ZN5faiss19minheap_replace_topIfEEvmPT_PlS1_l.exit.us, label %bb.bi

bb.bi:                                            ; preds = %_ZN5faiss4CMinIflE4cmp2Effll.exit54.i.i.us, %_ZN5faiss4CMinIflE4cmp2Effll.exit55.i.i.us
  %.sink71.i.i.us = phi float [ %i.wj, %_ZN5faiss4CMinIflE4cmp2Effll.exit54.i.i.us ], [ %i.vw, %_ZN5faiss4CMinIflE4cmp2Effll.exit55.i.i.us ]
  %.sink.i.i.us = phi i64 [ %i.wm, %_ZN5faiss4CMinIflE4cmp2Effll.exit54.i.i.us ], [ %i.vy, %_ZN5faiss4CMinIflE4cmp2Effll.exit55.i.i.us ]
  %.1.i.i.us = phi i64 [ %i.vr, %_ZN5faiss4CMinIflE4cmp2Effll.exit54.i.i.us ], [ %i.vq, %_ZN5faiss4CMinIflE4cmp2Effll.exit55.i.i.us ] ; 4 uses
  %i.wq = getelementptr inbounds nuw [4 x i8], ptr %i.ug, i64 %.056.i.i.us
  store float %.sink71.i.i.us, ptr %i.wq, align 4, !tbaa !63
  %i.wr = getelementptr inbounds nuw [8 x i8], ptr %i.uh, i64 %.056.i.i.us
  store i64 %.sink.i.i.us, ptr %i.wr, align 8, !tbaa !57
  %i.ws = shl nuw nsw i64 %.1.i.i.us, 1           ; 2 uses
  %i.wt = or disjoint i64 %i.ws, 1
  %i.wu = icmp ugt i64 %.1.i.i.us, 5
  br i1 %i.wu, label %_ZN5faiss19minheap_replace_topIfEEvmPT_PlS1_l.exit.us, label %.lr.ph.i.i.us, !llvm.loop !66
...
_ZN5faiss19minheap_replace_topIfEEvmPT_PlS1_l.exit.us: ; preds = %bb.bi, %_ZN5faiss4CMinIflE4cmp2Effll.exit54.i.i.us, %_ZN5faiss4CMinIflE4cmp2Effll.exit.thread.i.i.us, %_ZN5faiss4CMinIflE4cmp2Effll.exit55.i.i.us, %bb.bh
  ...
  %i.wv = getelementptr inbounds nuw [4 x i8], ptr %i.ug, i64 %.0.lcssa.i.i.us
  store float %i.vk, ptr %i.wv, align 4, !tbaa !63
  %i.ww = getelementptr inbounds nuw [8 x i8], ptr %i.uh, i64 %.0.lcssa.i.i.us
  store i64 %i.vn, ptr %i.ww, align 8, !tbaa !57
  br label %bb.bj

bb.bj:                                            ; preds = %_ZN5faiss19minheap_replace_topIfEEvmPT_PlS1_l.exit.us, %bb.bf
  %i.wx = add nuw i64 %.0143689.us, 1             ; 2 uses
  %exitcond705.not = icmp eq i64 %i.wx, %i.vb
  br i1 %exitcond705.not, label %.loopexit, label %.lr.ph.split.us, !llvm.loop !67
...
.lr.ph.split:                                     ; preds = %.lr.ph, %bb.bo
  %.0143689 = phi i64 [ %i.yv, %bb.bo ], [ 0, %.lr.ph ] ; 3 uses
  %i.xa = load ptr, ptr %i.vc, align 8, !tbaa !64
  %i.xb = load i64, ptr %i.ac, align 8, !tbaa !33
  %i.xc = mul i64 %i.xb, %.0143689
  %i.xd = getelementptr inbounds nuw i8, ptr %i.xa, i64 %i.xc
  %i.xe = load ptr, ptr %i.bc, align 8, !tbaa !10
  %i.xf = getelementptr inbounds nuw i8, ptr %i.xe, i64 16
  %i.xg = load ptr, ptr %i.xf, align 8
  %i.xh = invoke noundef float %i.xg(ptr noundef nonnull align 8 dereferenceable(40) %i.bc, ptr noundef %i.xd)
          to label %bb.bk unwind label %.split    ; 6 uses

bb.bk:                                            ; preds = %.lr.ph.split
  %i.xi = load ptr, ptr %i.uu, align 8, !tbaa !60
  %i.xj = getelementptr inbounds nuw [8 x i8], ptr %i.xi, i64 %.0143689
  %i.xk = load i64, ptr %i.xj, align 8, !tbaa !57 ; 3 uses
  %i.xl = load float, ptr %i.ek, align 4, !tbaa !63
  %i.xm = fcmp olt float %i.xh, %i.xl
  br i1 %i.xm, label %.lr.ph.i.i276, label %bb.bo
...
.lr.ph.i.i276:                                    ; preds = %bb.bk, %bb.bn
  %i.xo = phi i64 [ %i.yr, %bb.bn ], [ 3, %bb.bk ]
  %i.xp = phi i64 [ %i.yq, %bb.bn ], [ 2, %bb.bk ] ; 7 uses
  %.056.i.i277 = phi i64 [ %.1.i.i280, %bb.bn ], [ 1, %bb.bk ] ; 6 uses
  %i.xq = icmp eq i64 %i.xp, 10
  br i1 %i.xq, label %.lr.ph._ZN5faiss4CMaxIflE4cmp2Effll.exit.thread_crit_edge.i.i, label %bb.bl
...
bb.bl:                                            ; preds = %.lr.ph.i.i276
  %i.xr = getelementptr inbounds nuw [4 x i8], ptr %i.ug, i64 %i.xp
  %i.xs = load float, ptr %i.xr, align 4, !tbaa !63 ; 4 uses
  %i.xt = getelementptr [4 x i8], ptr %i.ek, i64 %i.xp
  %i.xu = load float, ptr %i.xt, align 4, !tbaa !63 ; 5 uses
  %i.xv = getelementptr [8 x i8], ptr %i.el, i64 %i.xp
  %i.xw = load i64, ptr %i.xv, align 8, !tbaa !57 ; 3 uses
  %i.xx = fcmp ogt float %i.xs, %i.xu
  br i1 %i.xx, label %_ZN5faiss4CMaxIflE4cmp2Effll.exit.thread.i.i, label %_ZN5faiss4CMaxIflE4cmp2Effll.exit.i.i

_ZN5faiss4CMaxIflE4cmp2Effll.exit.i.i:            ; preds = %bb.bl
  %i.xy = getelementptr inbounds nuw [8 x i8], ptr %i.uh, i64 %i.xp
  %i.xz = load i64, ptr %i.xy, align 8, !tbaa !57
  %i.ya = fcmp oeq float %i.xs, %i.xu
  %i.yb = icmp sgt i64 %i.xz, %i.xw
  %i.yc = and i1 %i.ya, %i.yb
  br i1 %i.yc, label %_ZN5faiss4CMaxIflE4cmp2Effll.exit.thread.i.i, label %bb.bm
...
_ZN5faiss4CMaxIflE4cmp2Effll.exit.thread.i.i:     ; preds = %_ZN5faiss4CMaxIflE4cmp2Effll.exit.i.i, %bb.bl, %.lr.ph._ZN5faiss4CMaxIflE4cmp2Effll.exit.thread_crit_edge.i.i
  %i.yd = phi float [ %.pre.i.i282, %.lr.ph._ZN5faiss4CMaxIflE4cmp2Effll.exit.thread_crit_edge.i.i ], [ %i.xs, %bb.bl ], [ %i.xs, %_ZN5faiss4CMaxIflE4cmp2Effll.exit.i.i ] ; 3 uses
  %i.ye = fcmp ogt float %i.xh, %i.yd
  br i1 %i.ye, label %_ZN5faiss19maxheap_replace_topIfEEvmPT_PlS1_l.exit, label %_ZN5faiss4CMaxIflE4cmp2Effll.exit54.i.i

_ZN5faiss4CMaxIflE4cmp2Effll.exit54.i.i:          ; preds = %_ZN5faiss4CMaxIflE4cmp2Effll.exit.thread.i.i
  %i.yf = getelementptr inbounds nuw [8 x i8], ptr %i.uh, i64 %i.xp
  %i.yg = load i64, ptr %i.yf, align 8, !tbaa !57 ; 2 uses
  %i.yh = fcmp oeq float %i.xh, %i.yd
  %i.yi = icmp sgt i64 %i.xk, %i.yg
  %i.yj = and i1 %i.yh, %i.yi
  br i1 %i.yj, label %_ZN5faiss19maxheap_replace_topIfEEvmPT_PlS1_l.exit, label %bb.bn

bb.bm:                                            ; preds = %_ZN5faiss4CMaxIflE4cmp2Effll.exit.i.i
  %i.yk = fcmp ogt float %i.xh, %i.xu
  br i1 %i.yk, label %_ZN5faiss19maxheap_replace_topIfEEvmPT_PlS1_l.exit, label %_ZN5faiss4CMaxIflE4cmp2Effll.exit55.i.i

_ZN5faiss4CMaxIflE4cmp2Effll.exit55.i.i:          ; preds = %bb.bm
  %i.yl = fcmp oeq float %i.xh, %i.xu
  %i.ym = icmp sgt i64 %i.xk, %i.xw
  %i.yn = and i1 %i.yl, %i.ym
  br i1 %i.yn, label %_ZN5faiss19maxheap_replace_topIfEEvmPT_PlS1_l.exit, label %bb.bn

bb.bn:                                            ; preds = %_ZN5faiss4CMaxIflE4cmp2Effll.exit55.i.i, %_ZN5faiss4CMaxIflE4cmp2Effll.exit54.i.i
  %.sink71.i.i278 = phi float [ %i.yd, %_ZN5faiss4CMaxIflE4cmp2Effll.exit54.i.i ], [ %i.xu, %_ZN5faiss4CMaxIflE4cmp2Effll.exit55.i.i ]
  %.sink.i.i279 = phi i64 [ %i.yg, %_ZN5faiss4CMaxIflE4cmp2Effll.exit54.i.i ], [ %i.xw, %_ZN5faiss4CMaxIflE4cmp2Effll.exit55.i.i ]
  %.1.i.i280 = phi i64 [ %i.xp, %_ZN5faiss4CMaxIflE4cmp2Effll.exit54.i.i ], [ %i.xo, %_ZN5faiss4CMaxIflE4cmp2Effll.exit55.i.i ] ; 4 uses
  %i.yo = getelementptr inbounds nuw [4 x i8], ptr %i.ug, i64 %.056.i.i277
  store float %.sink71.i.i278, ptr %i.yo, align 4, !tbaa !63
  %i.yp = getelementptr inbounds nuw [8 x i8], ptr %i.uh, i64 %.056.i.i277
  store i64 %.sink.i.i279, ptr %i.yp, align 8, !tbaa !57
  %i.yq = shl nuw nsw i64 %.1.i.i280, 1           ; 2 uses
  %i.yr = or disjoint i64 %i.yq, 1
  %i.ys = icmp ugt i64 %.1.i.i280, 5
  br i1 %i.ys, label %_ZN5faiss19maxheap_replace_topIfEEvmPT_PlS1_l.exit, label %.lr.ph.i.i276, !llvm.loop !68
...
_ZN5faiss19maxheap_replace_topIfEEvmPT_PlS1_l.exit: ; preds = %_ZN5faiss4CMaxIflE4cmp2Effll.exit.thread.i.i, %_ZN5faiss4CMaxIflE4cmp2Effll.exit54.i.i, %bb.bm, %_ZN5faiss4CMaxIflE4cmp2Effll.exit55.i.i, %bb.bn
  ...
  %i.yt = getelementptr inbounds nuw [4 x i8], ptr %i.ug, i64 %.0.lcssa.i.i281
  store float %i.xh, ptr %i.yt, align 4, !tbaa !63
  %i.yu = getelementptr inbounds nuw [8 x i8], ptr %i.uh, i64 %.0.lcssa.i.i281
  store i64 %i.xk, ptr %i.yu, align 8, !tbaa !57
  br label %bb.bo

bb.bo:                                            ; preds = %_ZN5faiss19maxheap_replace_topIfEEvmPT_PlS1_l.exit, %bb.bk
  %i.yv = add nuw i64 %.0143689, 1                ; 2 uses
  %exitcond703.not = icmp eq i64 %i.yv, %i.vb
...
.preheader865:                                    ; preds = %._crit_edge, %_ZN5faiss8heap_popINS_4CMinIflEEEEvmPNT_1TEPNS3_2TIE.exit.i.i
  %.041.i.i = phi i64 [ %spec.select.i.i, %_ZN5faiss8heap_popINS_4CMinIflEEEEvmPNT_1TEPNS3_2TIE.exit.i.i ], [ 0, %._crit_edge ] ; 4 uses
  %.03740.i.i = phi i64 [ %i.aar, %_ZN5faiss8heap_popINS_4CMinIflEEEEvmPNT_1TEPNS3_2TIE.exit.i.i ], [ 0, %._crit_edge ] ; 3 uses
  %i.yw = load float, ptr %i.ek, align 4, !tbaa !63
  %i.yx = load i64, ptr %i.el, align 8, !tbaa !57 ; 2 uses
  %i.yy = sub nuw nsw i64 10, %.03740.i.i         ; 4 uses
  %i.yz = getelementptr inbounds nuw [4 x i8], ptr %i.ui, i64 %i.yy ; 3 uses
  %i.za = load float, ptr %i.yz, align 4, !tbaa !63 ; 5 uses
  %i.zb = getelementptr inbounds nuw [8 x i8], ptr %i.uj, i64 %i.yy ; 2 uses
  %i.zc = load i64, ptr %i.zb, align 8, !tbaa !57 ; 3 uses
  %i.zd = icmp samesign ugt i64 %.03740.i.i, 8
  br i1 %i.zd, label %_ZN5faiss8heap_popINS_4CMinIflEEEEvmPNT_1TEPNS3_2TIE.exit.i.i, label %.lr.ph.i.i.i284

.lr.ph.i.i.i284:                                  ; preds = %.preheader865, %bb.br
  %i.ze = phi i64 [ %i.aah, %bb.br ], [ 3, %.preheader865 ]
  %i.zf = phi i64 [ %i.aag, %bb.br ], [ 2, %.preheader865 ] ; 7 uses
  %.062.i.i.i = phi i64 [ %.1.i.i.i, %bb.br ], [ 1, %.preheader865 ] ; 6 uses
  %i.zg = icmp eq i64 %i.zf, %i.yy
  br i1 %i.zg, label %.lr.ph._ZN5faiss4CMinIflE4cmp2Effll.exit.thread_crit_edge.i.i.i, label %bb.bp

.lr.ph._ZN5faiss4CMinIflE4cmp2Effll.exit.thread_crit_edge.i.i.i: ; preds = %.lr.ph.i.i.i284
  %.pre.i.i.i = load float, ptr %i.yz, align 4, !tbaa !63
  br label %_ZN5faiss4CMinIflE4cmp2Effll.exit.thread.i.i.i290

bb.bp:                                            ; preds = %.lr.ph.i.i.i284
  %i.zh = getelementptr inbounds nuw [4 x i8], ptr %i.ui, i64 %i.zf
  %i.zi = load float, ptr %i.zh, align 4, !tbaa !63 ; 4 uses
  %i.zj = getelementptr [4 x i8], ptr %i.ek, i64 %i.zf
  %i.zk = load float, ptr %i.zj, align 4, !tbaa !63 ; 5 uses
  %i.zl = getelementptr [8 x i8], ptr %i.el, i64 %i.zf
  %i.zm = load i64, ptr %i.zl, align 8, !tbaa !57 ; 3 uses
  %i.zn = fcmp olt float %i.zi, %i.zk
  br i1 %i.zn, label %_ZN5faiss4CMinIflE4cmp2Effll.exit.thread.i.i.i290, label %_ZN5faiss4CMinIflE4cmp2Effll.exit.i.i.i285

_ZN5faiss4CMinIflE4cmp2Effll.exit.i.i.i285:       ; preds = %bb.bp
  %i.zo = getelementptr inbounds nuw [8 x i8], ptr %i.uj, i64 %i.zf
  %i.zp = load i64, ptr %i.zo, align 8, !tbaa !57
  %i.zq = fcmp oeq float %i.zi, %i.zk
  %i.zr = icmp slt i64 %i.zp, %i.zm
  %i.zs = and i1 %i.zq, %i.zr
  br i1 %i.zs, label %_ZN5faiss4CMinIflE4cmp2Effll.exit.thread.i.i.i290, label %bb.bq
...
_ZN5faiss4CMinIflE4cmp2Effll.exit.thread.i.i.i290: ; preds = %_ZN5faiss4CMinIflE4cmp2Effll.exit.i.i.i285, %bb.bp, %.lr.ph._ZN5faiss4CMinIflE4cmp2Effll.exit.thread_crit_edge.i.i.i
  %i.zt = phi float [ %.pre.i.i.i, %.lr.ph._ZN5faiss4CMinIflE4cmp2Effll.exit.thread_crit_edge.i.i.i ], [ %i.zi, %bb.bp ], [ %i.zi, %_ZN5faiss4CMinIflE4cmp2Effll.exit.i.i.i285 ] ; 3 uses
  %i.zu = fcmp olt float %i.za, %i.zt
  br i1 %i.zu, label %_ZN5faiss4CMinIflE4cmp2Effll.exit60.thread.loopexit.i.i.i, label %_ZN5faiss4CMinIflE4cmp2Effll.exit60.i.i.i

_ZN5faiss4CMinIflE4cmp2Effll.exit60.i.i.i:        ; preds = %_ZN5faiss4CMinIflE4cmp2Effll.exit.thread.i.i.i290
  %i.zv = getelementptr inbounds nuw [8 x i8], ptr %i.uj, i64 %i.zf
  %i.zw = load i64, ptr %i.zv, align 8, !tbaa !57 ; 2 uses
  %i.zx = fcmp oeq float %i.za, %i.zt
  %i.zy = icmp slt i64 %i.zc, %i.zw
  %i.zz = and i1 %i.zx, %i.zy
  br i1 %i.zz, label %_ZN5faiss4CMinIflE4cmp2Effll.exit60.thread.loopexit.i.i.i, label %bb.br

bb.bq:                                            ; preds = %_ZN5faiss4CMinIflE4cmp2Effll.exit.i.i.i285
  %i.aaa = fcmp olt float %i.za, %i.zk
  br i1 %i.aaa, label %_ZN5faiss4CMinIflE4cmp2Effll.exit60.thread.loopexit.i.i.i, label %_ZN5faiss4CMinIflE4cmp2Effll.exit61.i.i.i

_ZN5faiss4CMinIflE4cmp2Effll.exit61.i.i.i:        ; preds = %bb.bq
  %i.aab = fcmp oeq float %i.za, %i.zk
  %i.aac = icmp slt i64 %i.zc, %i.zm
  %i.aad = and i1 %i.aab, %i.aac
  br i1 %i.aad, label %_ZN5faiss4CMinIflE4cmp2Effll.exit60.thread.loopexit.i.i.i, label %bb.br

bb.br:                                            ; preds = %_ZN5faiss4CMinIflE4cmp2Effll.exit61.i.i.i, %_ZN5faiss4CMinIflE4cmp2Effll.exit60.i.i.i
  %.sink79.i.i.i = phi float [ %i.zt, %_ZN5faiss4CMinIflE4cmp2Effll.exit60.i.i.i ], [ %i.zk, %_ZN5faiss4CMinIflE4cmp2Effll.exit61.i.i.i ]
  %.sink.i.i.i = phi i64 [ %i.zw, %_ZN5faiss4CMinIflE4cmp2Effll.exit60.i.i.i ], [ %i.zm, %_ZN5faiss4CMinIflE4cmp2Effll.exit61.i.i.i ]
  %.1.i.i.i = phi i64 [ %i.zf, %_ZN5faiss4CMinIflE4cmp2Effll.exit60.i.i.i ], [ %i.ze, %_ZN5faiss4CMinIflE4cmp2Effll.exit61.i.i.i ] ; 3 uses
  %i.aae = getelementptr inbounds nuw [4 x i8], ptr %i.ui, i64 %.062.i.i.i
  store float %.sink79.i.i.i, ptr %i.aae, align 4, !tbaa !63
  %i.aaf = getelementptr inbounds nuw [8 x i8], ptr %i.uj, i64 %.062.i.i.i
  store i64 %.sink.i.i.i, ptr %i.aaf, align 8, !tbaa !57
  %i.aag = shl i64 %.1.i.i.i, 1                   ; 3 uses
  %i.aah = or disjoint i64 %i.aag, 1
  %i.aai = icmp ugt i64 %i.aag, %i.yy
  br i1 %i.aai, label %_ZN5faiss4CMinIflE4cmp2Effll.exit60.thread.loopexit.i.i.i, label %.lr.ph.i.i.i284, !llvm.loop !70
...
_ZN5faiss4CMinIflE4cmp2Effll.exit60.thread.loopexit.i.i.i: ; preds = %bb.br, %_ZN5faiss4CMinIflE4cmp2Effll.exit61.i.i.i, %bb.bq, %_ZN5faiss4CMinIflE4cmp2Effll.exit60.i.i.i, %_ZN5faiss4CMinIflE4cmp2Effll.exit.thread.i.i.i290
  ...
  %.pre68.i.i.i = load float, ptr %i.yz, align 4, !tbaa !63
  %.pre69.i.i.i = load i64, ptr %i.zb, align 8, !tbaa !57
  br label %_ZN5faiss8heap_popINS_4CMinIflEEEEvmPNT_1TEPNS3_2TIE.exit.i.i

_ZN5faiss8heap_popINS_4CMinIflEEEEvmPNT_1TEPNS3_2TIE.exit.i.i: ; preds = %_ZN5faiss4CMinIflE4cmp2Effll.exit60.thread.loopexit.i.i.i, %.preheader865
  %i.aaj = phi i64 [ %i.zc, %.preheader865 ], [ %.pre69.i.i.i, %_ZN5faiss4CMinIflE4cmp2Effll.exit60.thread.loopexit.i.i.i ]
  %i.aak = phi float [ %i.za, %.preheader865 ], [ %.pre68.i.i.i, %_ZN5faiss4CMinIflE4cmp2Effll.exit60.thread.loopexit.i.i.i ]
  %.0.lcssa.i.i.i286 = phi i64 [ 1, %.preheader865 ], [ %.0.lcssa.ph.i.i.i, %_ZN5faiss4CMinIflE4cmp2Effll.exit60.thread.loopexit.i.i.i ] ; 2 uses
  %i.aal = getelementptr inbounds nuw [4 x i8], ptr %i.ui, i64 %.0.lcssa.i.i.i286
  store float %i.aak, ptr %i.aal, align 4, !tbaa !63
  %i.aam = getelementptr inbounds nuw [8 x i8], ptr %i.uj, i64 %.0.lcssa.i.i.i286
  store i64 %i.aaj, ptr %i.aam, align 8, !tbaa !57
  %i.aan = sub i64 9, %.041.i.i                   ; 2 uses
  %i.aao = getelementptr inbounds nuw [4 x i8], ptr %i.ek, i64 %i.aan
  store float %i.yw, ptr %i.aao, align 4, !tbaa !63
  %i.aap = getelementptr inbounds nuw [8 x i8], ptr %i.el, i64 %i.aan
  store i64 %i.yx, ptr %i.aap, align 8, !tbaa !57
  %.not.i.i287 = icmp ne i64 %i.yx, -1
  %i.aaq = zext i1 %.not.i.i287 to i64            ; 3 uses
  %spec.select.i.i = add i64 %.041.i.i, %i.aaq    ; 8 uses
  %i.aar = add nuw nsw i64 %.03740.i.i, 1         ; 2 uses
  %exitcond.not.i.i288 = icmp eq i64 %i.aar, 10
  br i1 %exitcond.not.i.i288, label %._crit_edge.i.i, label %.preheader865, !llvm.loop !71

._crit_edge.i.i:                                  ; preds = %_ZN5faiss8heap_popINS_4CMinIflEEEEvmPNT_1TEPNS3_2TIE.exit.i.i
  %i.aas = getelementptr inbounds nuw i8, ptr %i.ek, i64 40
  %i.aat = sub i64 0, %spec.select.i.i            ; 2 uses
  %i.aau = getelementptr inbounds [4 x i8], ptr %i.aas, i64 %i.aat
  %i.aav = shl i64 %spec.select.i.i, 2
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 4 %i.ek, ptr nonnull align 4 %i.aau, i64 %i.aav, i1 false)
  %i.aaw = getelementptr inbounds nuw i8, ptr %i.el, i64 80
  %i.aax = getelementptr inbounds [8 x i8], ptr %i.aaw, i64 %i.aat
  %i.aay = shl i64 %spec.select.i.i, 3            ; 2 uses
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.el, ptr nonnull align 8 %i.aax, i64 %i.aay, i1 false)
  %i.aaz = icmp ult i64 %spec.select.i.i, 10
  br i1 %i.aaz, label %.lr.ph44.i.i.preheader, label %_ZN5faiss15minheap_reorderIfEEmmPT_Pl.exit

.lr.ph44.i.i.preheader:                           ; preds = %._crit_edge.i.i
  %scevgep708 = getelementptr i8, ptr %i.el, i64 %i.aay
  %i.aba = add i64 %.041.i.i, %i.aaq
  %i.abb = shl i64 %i.aba, 3
  %i.abc = sub i64 80, %i.abb
  tail call void @llvm.memset.p0.i64(ptr align 8 %scevgep708, i8 -1, i64 %i.abc, i1 false), !tbaa !57
  %i.abd = add i64 %.041.i.i, %i.aaq
  %i.abe = sub i64 10, %i.abd                     ; 3 uses
  %min.iters.check = icmp ult i64 %i.abe, 8
  br i1 %min.iters.check, label %.lr.ph44.i.i.preheader883, label %vector.body

vector.body:                                      ; preds = %.lr.ph44.i.i.preheader
  %n.vec = and i64 %i.abe, -8                     ; 2 uses
  %i.abf = add i64 %spec.select.i.i, %n.vec
  %i.abg = getelementptr inbounds nuw [4 x i8], ptr %i.ek, i64 %spec.select.i.i ; 2 uses
  %i.abh = getelementptr inbounds nuw i8, ptr %i.abg, i64 16
  store <4 x float> splat (float f0xFF7FFFFF), ptr %i.abg, align 4, !tbaa !63
  store <4 x float> splat (float f0xFF7FFFFF), ptr %i.abh, align 4, !tbaa !63
  %cmp.n = icmp eq i64 %i.abe, %n.vec
  br i1 %cmp.n, label %_ZN5faiss15minheap_reorderIfEEmmPT_Pl.exit, label %.lr.ph44.i.i.preheader883

.lr.ph44.i.i.preheader883:                        ; preds = %.lr.ph44.i.i.preheader, %vector.body
  %.242.i.i.ph = phi i64 [ %spec.select.i.i, %.lr.ph44.i.i.preheader ], [ %i.abf, %vector.body ]
  br label %.lr.ph44.i.i

.lr.ph44.i.i:                                     ; preds = %.lr.ph44.i.i.preheader883, %.lr.ph44.i.i
  %.242.i.i = phi i64 [ %i.abj, %.lr.ph44.i.i ], [ %.242.i.i.ph, %.lr.ph44.i.i.preheader883 ] ; 2 uses
  %i.abi = getelementptr inbounds nuw [4 x i8], ptr %i.ek, i64 %.242.i.i
  store float f0xFF7FFFFF, ptr %i.abi, align 4, !tbaa !63
  %i.abj = add nuw i64 %.242.i.i, 1               ; 2 uses
  %exitcond47.not.i.i = icmp eq i64 %i.abj, 10
  br i1 %exitcond47.not.i.i, label %_ZN5faiss15minheap_reorderIfEEmmPT_Pl.exit, label %.lr.ph44.i.i, !llvm.loop !72

.preheader867:                                    ; preds = %._crit_edge, %_ZN5faiss8heap_popINS_4CMaxIflEEEEvmPNT_1TEPNS3_2TIE.exit.i.i
  %.041.i.i292 = phi i64 [ %spec.select.i.i305, %_ZN5faiss8heap_popINS_4CMaxIflEEEEvmPNT_1TEPNS3_2TIE.exit.i.i ], [ 0, %._crit_edge ] ; 4 uses
  %.03740.i.i293 = phi i64 [ %i.adf, %_ZN5faiss8heap_popINS_4CMaxIflEEEEvmPNT_1TEPNS3_2TIE.exit.i.i ], [ 0, %._crit_edge ] ; 3 uses
  %i.abk = load float, ptr %i.ek, align 4, !tbaa !63
  %i.abl = load i64, ptr %i.el, align 8, !tbaa !57 ; 2 uses
  %i.abm = sub nuw nsw i64 10, %.03740.i.i293     ; 4 uses
  %i.abn = getelementptr inbounds nuw [4 x i8], ptr %i.ui, i64 %i.abm ; 3 uses
  %i.abo = load float, ptr %i.abn, align 4, !tbaa !63 ; 5 uses
  %i.abp = getelementptr inbounds nuw [8 x i8], ptr %i.uj, i64 %i.abm ; 2 uses
  %i.abq = load i64, ptr %i.abp, align 8, !tbaa !57 ; 3 uses
  %i.abr = icmp samesign ugt i64 %.03740.i.i293, 8
  br i1 %i.abr, label %_ZN5faiss8heap_popINS_4CMaxIflEEEEvmPNT_1TEPNS3_2TIE.exit.i.i, label %.lr.ph.i.i.i294

.lr.ph.i.i.i294:                                  ; preds = %.preheader867, %bb.bu
  %i.abs = phi i64 [ %i.acv, %bb.bu ], [ 3, %.preheader867 ]
  %i.abt = phi i64 [ %i.acu, %bb.bu ], [ 2, %.preheader867 ] ; 7 uses
  %.062.i.i.i295 = phi i64 [ %.1.i.i.i299, %bb.bu ], [ 1, %.preheader867 ] ; 6 uses
  %i.abu = icmp eq i64 %i.abt, %i.abm
  br i1 %i.abu, label %.lr.ph._ZN5faiss4CMaxIflE4cmp2Effll.exit.thread_crit_edge.i.i.i, label %bb.bs

.lr.ph._ZN5faiss4CMaxIflE4cmp2Effll.exit.thread_crit_edge.i.i.i: ; preds = %.lr.ph.i.i.i294
  %.pre.i.i.i313 = load float, ptr %i.abn, align 4, !tbaa !63
  br label %_ZN5faiss4CMaxIflE4cmp2Effll.exit.thread.i.i.i312

bb.bs:                                            ; preds = %.lr.ph.i.i.i294
  %i.abv = getelementptr inbounds nuw [4 x i8], ptr %i.ui, i64 %i.abt
  %i.abw = load float, ptr %i.abv, align 4, !tbaa !63 ; 4 uses
  %i.abx = getelementptr [4 x i8], ptr %i.ek, i64 %i.abt
  %i.aby = load float, ptr %i.abx, align 4, !tbaa !63 ; 5 uses
  %i.abz = getelementptr [8 x i8], ptr %i.el, i64 %i.abt
  %i.aca = load i64, ptr %i.abz, align 8, !tbaa !57 ; 3 uses
  %i.acb = fcmp ogt float %i.abw, %i.aby
  br i1 %i.acb, label %_ZN5faiss4CMaxIflE4cmp2Effll.exit.thread.i.i.i312, label %_ZN5faiss4CMaxIflE4cmp2Effll.exit.i.i.i296

_ZN5faiss4CMaxIflE4cmp2Effll.exit.i.i.i296:       ; preds = %bb.bs
  %i.acc = getelementptr inbounds nuw [8 x i8], ptr %i.uj, i64 %i.abt
  %i.acd = load i64, ptr %i.acc, align 8, !tbaa !57
  %i.ace = fcmp oeq float %i.abw, %i.aby
  %i.acf = icmp sgt i64 %i.acd, %i.aca
  %i.acg = and i1 %i.ace, %i.acf
  br i1 %i.acg, label %_ZN5faiss4CMaxIflE4cmp2Effll.exit.thread.i.i.i312, label %bb.bt
...
_ZN5faiss4CMaxIflE4cmp2Effll.exit.thread.i.i.i312: ; preds = %_ZN5faiss4CMaxIflE4cmp2Effll.exit.i.i.i296, %bb.bs, %.lr.ph._ZN5faiss4CMaxIflE4cmp2Effll.exit.thread_crit_edge.i.i.i
  %i.ach = phi float [ %.pre.i.i.i313, %.lr.ph._ZN5faiss4CMaxIflE4cmp2Effll.exit.thread_crit_edge.i.i.i ], [ %i.abw, %bb.bs ], [ %i.abw, %_ZN5faiss4CMaxIflE4cmp2Effll.exit.i.i.i296 ] ; 3 uses
  %i.aci = fcmp ogt float %i.abo, %i.ach
  br i1 %i.aci, label %_ZN5faiss4CMaxIflE4cmp2Effll.exit60.thread.loopexit.i.i.i, label %_ZN5faiss4CMaxIflE4cmp2Effll.exit60.i.i.i

_ZN5faiss4CMaxIflE4cmp2Effll.exit60.i.i.i:        ; preds = %_ZN5faiss4CMaxIflE4cmp2Effll.exit.thread.i.i.i312
  %i.acj = getelementptr inbounds nuw [8 x i8], ptr %i.uj, i64 %i.abt
  %i.ack = load i64, ptr %i.acj, align 8, !tbaa !57 ; 2 uses
  %i.acl = fcmp oeq float %i.abo, %i.ach
  %i.acm = icmp sgt i64 %i.abq, %i.ack
  %i.acn = and i1 %i.acl, %i.acm
  br i1 %i.acn, label %_ZN5faiss4CMaxIflE4cmp2Effll.exit60.thread.loopexit.i.i.i, label %bb.bu

bb.bt:                                            ; preds = %_ZN5faiss4CMaxIflE4cmp2Effll.exit.i.i.i296
  %i.aco = fcmp ogt float %i.abo, %i.aby
  br i1 %i.aco, label %_ZN5faiss4CMaxIflE4cmp2Effll.exit60.thread.loopexit.i.i.i, label %_ZN5faiss4CMaxIflE4cmp2Effll.exit61.i.i.i

_ZN5faiss4CMaxIflE4cmp2Effll.exit61.i.i.i:        ; preds = %bb.bt
  %i.acp = fcmp oeq float %i.abo, %i.aby
  %i.acq = icmp sgt i64 %i.abq, %i.aca
  %i.acr = and i1 %i.acp, %i.acq
  br i1 %i.acr, label %_ZN5faiss4CMaxIflE4cmp2Effll.exit60.thread.loopexit.i.i.i, label %bb.bu
...
bb.bu:                                            ; preds = %_ZN5faiss4CMaxIflE4cmp2Effll.exit61.i.i.i, %_ZN5faiss4CMaxIflE4cmp2Effll.exit60.i.i.i
  ...
  store float %.sink79.i.i.i297, ptr %i.acs, align 4, !tbaa !63
  %i.act = getelementptr inbounds nuw [8 x i8], ptr %i.uj, i64 %.062.i.i.i295
  store i64 %.sink.i.i.i298, ptr %i.act, align 8, !tbaa !57
  %i.acu = shl i64 %.1.i.i.i299, 1                ; 3 uses
  %i.acv = or disjoint i64 %i.acu, 1
  %i.acw = icmp ugt i64 %i.acu, %i.abm
  br i1 %i.acw, label %_ZN5faiss4CMaxIflE4cmp2Effll.exit60.thread.loopexit.i.i.i, label %.lr.ph.i.i.i294, !llvm.loop !75
...
_ZN5faiss4CMaxIflE4cmp2Effll.exit60.thread.loopexit.i.i.i: ; preds = %bb.bu, %_ZN5faiss4CMaxIflE4cmp2Effll.exit61.i.i.i, %bb.bt, %_ZN5faiss4CMaxIflE4cmp2Effll.exit60.i.i.i, %_ZN5faiss4CMaxIflE4cmp2Effll.exit.thread.i.i.i312
  ...
  %.pre68.i.i.i301 = load float, ptr %i.abn, align 4, !tbaa !63
  %.pre69.i.i.i302 = load i64, ptr %i.abp, align 8, !tbaa !57
...
_ZN5faiss8heap_popINS_4CMaxIflEEEEvmPNT_1TEPNS3_2TIE.exit.i.i: ; preds = %_ZN5faiss4CMaxIflE4cmp2Effll.exit60.thread.loopexit.i.i.i, %.preheader867
  ...
  br i1 %exitcond.not.i.i306, label %._crit_edge.i.i307, label %.preheader867, !llvm.loop !76
...
.lr.ph44.i.i309.preheader:                        ; preds = %._crit_edge.i.i307
  ...
  tail call void @llvm.memset.p0.i64(ptr align 8 %scevgep, i8 -1, i64 %i.adq, i1 false), !tbaa !57
...
vector.body875:                                   ; preds = %.lr.ph44.i.i309.preheader
  ...
  store <4 x float> splat (float f0x7F7FFFFF), ptr %i.adu, align 4, !tbaa !63
  store <4 x float> splat (float f0x7F7FFFFF), ptr %i.adv, align 4, !tbaa !63
...
.lr.ph44.i.i309:                                  ; preds = %.lr.ph44.i.i309.preheader884, %.lr.ph44.i.i309
  ...
  store float f0x7F7FFFFF, ptr %i.adw, align 4, !tbaa !63
  %i.adx = add nuw i64 %.242.i.i310, 1            ; 2 uses
...
_ZN5faiss15minheap_reorderIfEEmmPT_Pl.exit:       ; preds = %.lr.ph44.i.i309, %.lr.ph44.i.i, %vector.body875, %vector.body, %._crit_edge.i.i307, %._crit_edge.i.i
  ...
  br i1 %exitcond709.not, label %bb.av, label %bb.ba, !llvm.loop !78
...
bb.bx:                                            ; preds = %bb.bw
  ...
  %i.aeb = load ptr, ptr %i.e, align 8, !tbaa !10
...
bb.bz:                                            ; preds = %_ZNSt13unordered_setIlSt4hashIlESt8equal_toIlESaIlEED2Ev.exit333
  %i.ael = load i32, ptr %i.a, align 4, !tbaa !79
  ...
  %i.aen = load i32, ptr %i.a, align 4, !tbaa !79, !noalias !80
...
_ZNSt13unordered_setIlSt4hashIlESt8equal_toIlESaIlEEC2IPKlEET_S9_mRKS1_RKS3_RKS4_.exit326: ; preds = %_ZNSt13unordered_setIlSt4hashIlESt8equal_toIlESaIlEEC2IPKlEET_S9_mRKS1_RKS3_RKS4_.exit
  ...
  %i.aew = load ptr, ptr %i.aee, align 8, !tbaa !83 ; 3 uses
...
.lr.ph695:                                        ; preds = %_ZNSt13unordered_setIlSt4hashIlESt8equal_toIlESaIlEEC2IPKlEET_S9_mRKS1_RKS3_RKS4_.exit326
  %i.aey = load i64, ptr %i.aef, align 8, !tbaa !85
...
bb.ch:                                            ; preds = %bb.cg
  ...
  %i.aff = load i64, ptr %i.afe, align 8, !tbaa !57
  %i.afg = icmp eq i64 %i.afc, %i.aff
  br i1 %i.afg, label %_ZNSt13unordered_setIlSt4hashIlESt8equal_toIlESaIlEE4findERKl.exit.loopexit.us, label %bb.cg, !llvm.loop !87
...
_ZNSt13unordered_setIlSt4hashIlESt8equal_toIlESaIlEE4findERKl.exit.loopexit.us: ; preds = %bb.ch, %bb.cg
  ...
  %i.afi = load ptr, ptr %.sroa.0424.0693.us, align 8, !tbaa !86 ; 2 uses
...
._crit_edge696:                                   ; preds = %_ZNSt13unordered_setIlSt4hashIlESt8equal_toIlESaIlEE4findERKl.exit, %_ZNSt13unordered_setIlSt4hashIlESt8equal_toIlESaIlEE4findERKl.exit.loopexit.us, %_ZNSt13unordered_setIlSt4hashIlESt8equal_toIlESaIlEEC2IPKlEET_S9_mRKS1_RKS3_RKS4_.exit326
  ...
  %i.afk = load i32, ptr %i.a, align 4, !tbaa !79
  %i.afl = add nsw i32 %i.afk, %.0.lcssa
  store i32 %i.afl, ptr %i.a, align 4, !tbaa !79
  %i.afm = load ptr, ptr %i.aeh, align 8, !tbaa !83 ; 2 uses
...
.lr.ph.i.i.i.i:                                   ; preds = %._crit_edge696, %.lr.ph.i.i.i.i
  ...
  %i.afn = load ptr, ptr %.06.i.i.i.i, align 8, !tbaa !86 ; 2 uses
...
_ZNSt10_HashtableIllSaIlENSt8__detail9_IdentityESt8equal_toIlESt4hashIlENS1_18_Mod_range_hashingENS1_20_Default_ranged_hashENS1_20_Prime_rehash_policyENS1_17_Hashtable_traitsILb0ELb1ELb1EEEE5clearEv.exit.i.i: ; preds = %.lr.ph.i.i.i.i, %._crit_edge696
  %i.afo = load ptr, ptr %6, align 8, !tbaa !89
  %i.afp = load i64, ptr %i.aeg, align 8, !tbaa !90
  ...
  %i.afr = load ptr, ptr %6, align 8, !tbaa !89   ; 2 uses
...
bb.ci:                                            ; preds = %_ZNSt10_HashtableIllSaIlENSt8__detail9_IdentityESt8equal_toIlESt4hashIlENS1_18_Mod_range_hashingENS1_20_Default_ranged_hashENS1_20_Prime_rehash_policyENS1_17_Hashtable_traitsILb0ELb1ELb1EEEE5clearEv.exit.i.i
  %i.aft = load i64, ptr %i.aeg, align 8, !tbaa !90
...
_ZNSt13unordered_setIlSt4hashIlESt8equal_toIlESaIlEED2Ev.exit: ; preds = %_ZNSt10_HashtableIllSaIlENSt8__detail9_IdentityESt8equal_toIlESt4hashIlENS1_18_Mod_range_hashingENS1_20_Default_ranged_hashENS1_20_Prime_rehash_policyENS1_17_Hashtable_traitsILb0ELb1ELb1EEEE5clearEv.exit.i.i, %bb.ci
  ...
  %i.afv = load ptr, ptr %i.aee, align 8, !tbaa !83 ; 2 uses
...
.lr.ph.i.i.i.i329:                                ; preds = %_ZNSt13unordered_setIlSt4hashIlESt8equal_toIlESaIlEED2Ev.exit, %.lr.ph.i.i.i.i329
  ...
  %i.afw = load ptr, ptr %.06.i.i.i.i330, align 8, !tbaa !86 ; 2 uses
end_hunk_1
begin_hunk_2_@_ZN12_GLOBAL__N_122test_search_and_encodeEPKcN5faiss10MetricTypeE:bb.a
  %i.ait = sub i64 %i.air, %i.ais
  call void @_ZdlPvm(ptr noundef nonnull %i.aio, i64 noundef %i.ait) #21
  br label %_ZSt8_DestroyISt6vectorIhSaIhEEEvPT_.exit.i.i.i

_ZSt8_DestroyISt6vectorIhSaIhEEEvPT_.exit.i.i.i:  ; preds = %bb.dg, %.lr.ph.i.i.i351
  %i.aiu = getelementptr inbounds nuw i8, ptr %.05.i.i.i352, i64 24 ; 2 uses
  %.not.i.i.i354 = icmp eq ptr %i.aiu, %.0.lcssa.i.i.i.i.i606611
  br i1 %.not.i.i.i354, label %_ZSt8_DestroyIPSt6vectorIhSaIhEES2_EvT_S4_RSaIT0_E.exit.i, label %.lr.ph.i.i.i351, !llvm.loop !115
...
_ZSt8_DestroyIPSt6vectorIhSaIhEES2_EvT_S4_RSaIT0_E.exit.i: ; preds = %_ZSt8_DestroyISt6vectorIhSaIhEEEvPT_.exit.i.i.i, %_ZNSt6vectorIS_IlSaIlEESaIS1_EED2Ev.exit
  %.not.i.i1.i356 = icmp eq ptr %.sroa.0472.0578615, null
  br i1 %.not.i.i1.i356, label %_ZNSt6vectorIS_IhSaIhEESaIS1_EED2Ev.exit, label %bb.dh

bb.dh:                                            ; preds = %_ZSt8_DestroyIPSt6vectorIhSaIhEES2_EvT_S4_RSaIT0_E.exit.i
  %i.aiv = ptrtoint ptr %.sink.i592613 to i64
  %i.aiw = ptrtoint ptr %.sroa.0472.0578615 to i64
  %i.aix = sub i64 %i.aiv, %i.aiw
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0472.0578615, i64 noundef %i.aix) #21
...
_ZNSt6vectorIS_IhSaIhEESaIS1_EED2Ev.exit:         ; preds = %_ZSt8_DestroyIPSt6vectorIhSaIhEES2_EvT_S4_RSaIT0_E.exit.i, %bb.dh
  %.not.i.i.i357 = icmp eq ptr %.sroa.0482.0, null
  br i1 %.not.i.i.i357, label %_ZNSt6vectorIfSaIfEED2Ev.exit370, label %bb.di

bb.di:                                            ; preds = %_ZNSt6vectorIS_IhSaIhEESaIS1_EED2Ev.exit
  %i.aiy = ptrtoint ptr %.sroa.0482.0 to i64
  %i.aiz = sub i64 %.sroa.12.0, %i.aiy
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0482.0, i64 noundef %i.aiz) #21
  br label %_ZNSt6vectorIfSaIfEED2Ev.exit370

_ZNSt6vectorIfSaIfEED2Ev.exit370:                 ; preds = %_ZNSt6vectorIS_IhSaIhEESaIS1_EED2Ev.exit, %bb.di
  ...
  %i.aja = load ptr, ptr %i.e, align 8, !tbaa !10
  %i.ajb = getelementptr inbounds nuw i8, ptr %i.aja, i64 8
  %i.ajc = load ptr, ptr %i.ajb, align 8
  call void %i.ajc(ptr noundef nonnull align 8 dereferenceable(273) %i.e) #20, !inline_history !116
  call void @_ZdlPvm(ptr noundef nonnull %i.c, i64 noundef 256000) #21
  ret void

bb.dj:                                            ; preds = %_ZN7testing7MessageD2Ev.exit340, %bb.cq
  %.pn.pn.pn = phi { ptr, i32 } [ %.pn.pn, %_ZN7testing7MessageD2Ev.exit340 ], [ %i.aha, %bb.cq ]
...
_ZNSt6vectorIlSaIlEED2Ev.exit372:                 ; preds = %bb.dk, %bb.ce
  %.pn193.pn.pn.pn = phi { ptr, i32 } [ %.pn193.pn.pn, %bb.dk ], [ %i.aeq, %bb.ce ]
  call void @_ZdlPvm(ptr noundef nonnull %i.aea, i64 noundef 8000) #21
  br label %_ZNSt6vectorIfSaIfEED2Ev.exit374

_ZNSt6vectorIfSaIfEED2Ev.exit374:                 ; preds = %_ZNSt6vectorIlSaIlEED2Ev.exit372, %bb.cd
  %.pn193.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn193.pn.pn.pn, %_ZNSt6vectorIlSaIlEED2Ev.exit372 ], [ %i.aep, %bb.cd ]
  call void @_ZdlPvm(ptr noundef nonnull %i.adz, i64 noundef 4000) #21
  br label %bb.dl

bb.dl:                                            ; preds = %.split, %.split.us, %bb.cc, %_ZNSt6vectorIfSaIfEED2Ev.exit374, %bb.az, %bb.bb, %bb.ay
  %.pn200.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %i.eh, %bb.ay ], [ %i.ei, %bb.az ], [ %i.aeo, %bb.cc ], [ %.pn193.pn.pn.pn.pn, %_ZNSt6vectorIfSaIfEED2Ev.exit374 ], [ %i.uk, %bb.bb ], [ %i.xn, %.split ], [ %i.wy, %.split.us ] ; 2 uses
  %.not.i.i.i375.a = icmp eq ptr %.sroa.0440.0, null
  br i1 %.not.i.i.i375.a, label %_ZNSt6vectorIlSaIlEED2Ev.exit376, label %bb.dm

bb.dm:                                            ; preds = %.thread, %bb.dl
  %.pn200.pn.pn.pn.pn.pn656 = phi { ptr, i32 } [ %i.wz, %.thread ], [ %.pn200.pn.pn.pn.pn.pn, %bb.dl ]
  %i.ajd = ptrtoint ptr %.sroa.0440.0 to i64
  %i.aje = sub i64 %.sroa.11.0, %i.ajd
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0440.0, i64 noundef %i.aje) #21
  br label %_ZNSt6vectorIlSaIlEED2Ev.exit376

_ZNSt6vectorIlSaIlEED2Ev.exit376:                 ; preds = %bb.dm, %bb.dl
  %.pn200.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn200.pn.pn.pn.pn.pn656, %bb.dm ], [ %.pn200.pn.pn.pn.pn.pn, %bb.dl ] ; 2 uses
  %.not.i.i.i377 = icmp eq ptr %.sroa.0447.0627, null
  br i1 %.not.i.i.i377, label %_ZNSt6vectorIfSaIfEED2Ev.exit378, label %bb.dn

bb.dn:                                            ; preds = %_ZNSt6vectorIlSaIlEED2Ev.exit376.thread, %_ZNSt6vectorIlSaIlEED2Ev.exit376
  %.pn200.pn.pn.pn.pn.pn.pn673 = phi { ptr, i32 } [ %i.eg, %_ZNSt6vectorIlSaIlEED2Ev.exit376.thread ], [ %.pn200.pn.pn.pn.pn.pn.pn, %_ZNSt6vectorIlSaIlEED2Ev.exit376 ]
  %.sroa.0447.0619666 = phi ptr [ %i.dm, %_ZNSt6vectorIlSaIlEED2Ev.exit376.thread ], [ %.sroa.0447.0627, %_ZNSt6vectorIlSaIlEED2Ev.exit376 ] ; 2 uses
  %.sroa.11452.0629665 = phi ptr [ %i.dn, %_ZNSt6vectorIlSaIlEED2Ev.exit376.thread ], [ %.sroa.11452.0637, %_ZNSt6vectorIlSaIlEED2Ev.exit376 ]
  %i.ajf = ptrtoint ptr %.sroa.11452.0629665 to i64
  %i.ajg = ptrtoint ptr %.sroa.0447.0619666 to i64
  %i.ajh = sub i64 %i.ajf, %i.ajg
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0447.0619666, i64 noundef %i.ajh) #21
  br label %_ZNSt6vectorIfSaIfEED2Ev.exit378

_ZNSt6vectorIfSaIfEED2Ev.exit378:                 ; preds = %bb.dn, %_ZNSt6vectorIlSaIlEED2Ev.exit376, %bb.ax
  %.pn200.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %i.ef, %bb.ax ], [ %.pn200.pn.pn.pn.pn.pn.pn, %_ZNSt6vectorIlSaIlEED2Ev.exit376 ], [ %.pn200.pn.pn.pn.pn.pn.pn673, %bb.dn ] ; 2 uses
  %.not.i379 = icmp eq ptr %i.bc, null
  br i1 %.not.i379, label %_ZNSt10unique_ptrIN5faiss19InvertedListScannerESt14default_deleteIS1_EED2Ev.exit381, label %_ZNKSt14default_deleteIN5faiss19InvertedListScannerEEclEPS1_.exit.i380

_ZNKSt14default_deleteIN5faiss19InvertedListScannerEEclEPS1_.exit.i380: ; preds = %_ZNSt6vectorIfSaIfEED2Ev.exit378
  %i.aji = load ptr, ptr %i.bc, align 8, !tbaa !10
  %i.ajj = getelementptr inbounds nuw i8, ptr %i.aji, i64 64
  %i.ajk = load ptr, ptr %i.ajj, align 8
  call void %i.ajk(ptr noundef nonnull align 8 dereferenceable(40) %i.bc) #20, !inline_history !112
  br label %_ZNSt10unique_ptrIN5faiss19InvertedListScannerESt14default_deleteIS1_EED2Ev.exit381

_ZNSt10unique_ptrIN5faiss19InvertedListScannerESt14default_deleteIS1_EED2Ev.exit381: ; preds = %.loopexit688, %.loopexit.split-lp, %bb.aw, %_ZNSt6vectorIfSaIfEED2Ev.exit378, %_ZNKSt14default_deleteIN5faiss19InvertedListScannerEEclEPS1_.exit.i380, %bb.ap
  %.pn210.pn = phi { ptr, i32 } [ %.pn200.pn.pn.pn.pn.pn.pn.pn, %_ZNKSt14default_deleteIN5faiss19InvertedListScannerEEclEPS1_.exit.i380 ], [ %i.dg, %bb.ap ], [ %i.ee, %bb.aw ], [ %.pn200.pn.pn.pn.pn.pn.pn.pn, %_ZNSt6vectorIfSaIfEED2Ev.exit378 ], [ %lpad.loopexit, %.loopexit688 ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ] ; 2 uses
  %.not4.i.i.i382 = icmp eq ptr %.sroa.0464.0, %.0.lcssa.i.i.i.i.i241
  br i1 %.not4.i.i.i382, label %_ZSt8_DestroyIPSt6vectorIlSaIlEES2_EvT_S4_RSaIT0_E.exit.i390, label %.lr.ph.i.i.i383

.lr.ph.i.i.i383:                                  ; preds = %_ZNSt10unique_ptrIN5faiss19InvertedListScannerESt14default_deleteIS1_EED2Ev.exit381, %_ZSt8_DestroyISt6vectorIlSaIlEEEvPT_.exit.i.i.i386
  %.05.i.i.i384 = phi ptr [ %i.ajr, %_ZSt8_DestroyISt6vectorIlSaIlEEEvPT_.exit.i.i.i386 ], [ %.sroa.0464.0, %_ZNSt10unique_ptrIN5faiss19InvertedListScannerESt14default_deleteIS1_EED2Ev.exit381 ] ; 3 uses
  %i.ajl = load ptr, ptr %.05.i.i.i384, align 8, !tbaa !60 ; 3 uses
  %.not.i.i.i.i.i.i.i.i385 = icmp eq ptr %i.ajl, null
  br i1 %.not.i.i.i.i.i.i.i.i385, label %_ZSt8_DestroyISt6vectorIlSaIlEEEvPT_.exit.i.i.i386, label %bb.do

bb.do:                                            ; preds = %.lr.ph.i.i.i383
  %i.ajm = getelementptr inbounds nuw i8, ptr %.05.i.i.i384, i64 16
  %i.ajn = load ptr, ptr %i.ajm, align 8, !tbaa !59
  %i.ajo = ptrtoint ptr %i.ajn to i64
  %i.ajp = ptrtoint ptr %i.ajl to i64
  %i.ajq = sub i64 %i.ajo, %i.ajp
  call void @_ZdlPvm(ptr noundef nonnull %i.ajl, i64 noundef %i.ajq) #21
  br label %_ZSt8_DestroyISt6vectorIlSaIlEEEvPT_.exit.i.i.i386

_ZSt8_DestroyISt6vectorIlSaIlEEEvPT_.exit.i.i.i386: ; preds = %bb.do, %.lr.ph.i.i.i383
  %i.ajr = getelementptr inbounds nuw i8, ptr %.05.i.i.i384, i64 24 ; 2 uses
  %.not.i.i.i387 = icmp eq ptr %i.ajr, %.0.lcssa.i.i.i.i.i241
  br i1 %.not.i.i.i387, label %_ZSt8_DestroyIPSt6vectorIlSaIlEES2_EvT_S4_RSaIT0_E.exit.i390, label %.lr.ph.i.i.i383, !llvm.loop !113

_ZSt8_DestroyIPSt6vectorIlSaIlEES2_EvT_S4_RSaIT0_E.exit.i390: ; preds = %_ZSt8_DestroyISt6vectorIlSaIlEEEvPT_.exit.i.i.i386, %_ZNSt10unique_ptrIN5faiss19InvertedListScannerESt14default_deleteIS1_EED2Ev.exit381
  %.not.i.i1.i391 = icmp eq ptr %.sroa.0464.0, null
  br i1 %.not.i.i1.i391, label %_ZNSt6vectorIS_IlSaIlEESaIS1_EED2Ev.exit392, label %bb.dp

bb.dp:                                            ; preds = %_ZSt8_DestroyIPSt6vectorIlSaIlEES2_EvT_S4_RSaIT0_E.exit.i390
  %i.ajs = ptrtoint ptr %.sroa.0464.0 to i64
  %i.ajt = sub i64 %.sink.i240, %i.ajs
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0464.0, i64 noundef %i.ajt) #21
  br label %_ZNSt6vectorIS_IlSaIlEESaIS1_EED2Ev.exit392

_ZNSt6vectorIS_IlSaIlEESaIS1_EED2Ev.exit392:      ; preds = %bb.dp, %_ZSt8_DestroyIPSt6vectorIlSaIlEES2_EvT_S4_RSaIT0_E.exit.i390, %bb.ai
  %.0.lcssa.i.i.i.i.i593 = phi ptr [ %scevgep.i.i.i.i.i, %bb.ai ], [ %.0.lcssa.i.i.i.i.i606611, %_ZSt8_DestroyIPSt6vectorIlSaIlEES2_EvT_S4_RSaIT0_E.exit.i390 ], [ %.0.lcssa.i.i.i.i.i606611, %bb.dp ] ; 2 uses
  %.sink.i579 = phi ptr [ %i.at, %bb.ai ], [ %.sink.i592613, %_ZSt8_DestroyIPSt6vectorIlSaIlEES2_EvT_S4_RSaIT0_E.exit.i390 ], [ %.sink.i592613, %bb.dp ]
  %.sroa.0472.0565 = phi ptr [ %i.as, %bb.ai ], [ %.sroa.0472.0578615, %_ZSt8_DestroyIPSt6vectorIlSaIlEES2_EvT_S4_RSaIT0_E.exit.i390 ], [ %.sroa.0472.0578615, %bb.dp ] ; 5 uses
  %.pn210.pn.pn = phi { ptr, i32 } [ %i.bp, %bb.ai ], [ %.pn210.pn, %_ZSt8_DestroyIPSt6vectorIlSaIlEES2_EvT_S4_RSaIT0_E.exit.i390 ], [ %.pn210.pn, %bb.dp ] ; 2 uses
  %.not4.i.i.i393 = icmp eq ptr %.sroa.0472.0565, %.0.lcssa.i.i.i.i.i593
  br i1 %.not4.i.i.i393, label %_ZSt8_DestroyIPSt6vectorIhSaIhEES2_EvT_S4_RSaIT0_E.exit.i401, label %.lr.ph.i.i.i394

.lr.ph.i.i.i394:                                  ; preds = %_ZNSt6vectorIS_IlSaIlEESaIS1_EED2Ev.exit392, %_ZSt8_DestroyISt6vectorIhSaIhEEEvPT_.exit.i.i.i397
  %.05.i.i.i395 = phi ptr [ %i.aka, %_ZSt8_DestroyISt6vectorIhSaIhEEEvPT_.exit.i.i.i397 ], [ %.sroa.0472.0565, %_ZNSt6vectorIS_IlSaIlEESaIS1_EED2Ev.exit392 ] ; 3 uses
  %i.aju = load ptr, ptr %.05.i.i.i395, align 8, !tbaa !64 ; 3 uses
  %.not.i.i.i.i.i.i.i.i396 = icmp eq ptr %i.aju, null
  br i1 %.not.i.i.i.i.i.i.i.i396, label %_ZSt8_DestroyISt6vectorIhSaIhEEEvPT_.exit.i.i.i397, label %bb.dq

bb.dq:                                            ; preds = %.lr.ph.i.i.i394
  %i.ajv = getelementptr inbounds nuw i8, ptr %.05.i.i.i395, i64 16
  %i.ajw = load ptr, ptr %i.ajv, align 8, !tbaa !114
  %i.ajx = ptrtoint ptr %i.ajw to i64
  %i.ajy = ptrtoint ptr %i.aju to i64
  %i.ajz = sub i64 %i.ajx, %i.ajy
  call void @_ZdlPvm(ptr noundef nonnull %i.aju, i64 noundef %i.ajz) #21
  br label %_ZSt8_DestroyISt6vectorIhSaIhEEEvPT_.exit.i.i.i397

_ZSt8_DestroyISt6vectorIhSaIhEEEvPT_.exit.i.i.i397: ; preds = %bb.dq, %.lr.ph.i.i.i394
  %i.aka = getelementptr inbounds nuw i8, ptr %.05.i.i.i395, i64 24 ; 2 uses
  %.not.i.i.i398 = icmp eq ptr %i.aka, %.0.lcssa.i.i.i.i.i593
  br i1 %.not.i.i.i398, label %_ZSt8_DestroyIPSt6vectorIhSaIhEES2_EvT_S4_RSaIT0_E.exit.i401, label %.lr.ph.i.i.i394, !llvm.loop !115

_ZSt8_DestroyIPSt6vectorIhSaIhEES2_EvT_S4_RSaIT0_E.exit.i401: ; preds = %_ZSt8_DestroyISt6vectorIhSaIhEEEvPT_.exit.i.i.i397, %_ZNSt6vectorIS_IlSaIlEESaIS1_EED2Ev.exit392
  %.not.i.i1.i402 = icmp eq ptr %.sroa.0472.0565, null
  br i1 %.not.i.i1.i402, label %_ZNSt6vectorIS_IhSaIhEESaIS1_EED2Ev.exit403, label %bb.dr

bb.dr:                                            ; preds = %_ZSt8_DestroyIPSt6vectorIhSaIhEES2_EvT_S4_RSaIT0_E.exit.i401
  %i.akb = ptrtoint ptr %.sink.i579 to i64
  %i.akc = ptrtoint ptr %.sroa.0472.0565 to i64
  %i.akd = sub i64 %i.akb, %i.akc
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0472.0565, i64 noundef %i.akd) #21
  br label %_ZNSt6vectorIS_IhSaIhEESaIS1_EED2Ev.exit403

_ZNSt6vectorIS_IhSaIhEESaIS1_EED2Ev.exit403:      ; preds = %bb.ah, %_ZSt8_DestroyIPSt6vectorIhSaIhEES2_EvT_S4_RSaIT0_E.exit.i401, %bb.dr, %bb.ag
  %.pn210.pn.pn.pn.pn = phi { ptr, i32 } [ %i.bn, %bb.ag ], [ %i.bo, %bb.ah ], [ %.pn210.pn.pn, %_ZSt8_DestroyIPSt6vectorIhSaIhEES2_EvT_S4_RSaIT0_E.exit.i401 ], [ %.pn210.pn.pn, %bb.dr ] ; 2 uses
  %.not.i.i.i404 = icmp eq ptr %.sroa.0482.0, null
  br i1 %.not.i.i.i404, label %_ZNSt6vectorIfSaIfEED2Ev.exit407, label %bb.ds

bb.ds:                                            ; preds = %_ZNSt6vectorIS_IhSaIhEESaIS1_EED2Ev.exit403
  %i.ake = ptrtoint ptr %.sroa.0482.0 to i64
  %i.akf = sub i64 %.sroa.12.0, %i.ake
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0482.0, i64 noundef %i.akf) #21
  br label %_ZNSt6vectorIfSaIfEED2Ev.exit407

_ZNSt6vectorIfSaIfEED2Ev.exit407:                 ; preds = %bb.af, %_ZNSt6vectorIS_IhSaIhEESaIS1_EED2Ev.exit403, %bb.ds, %bb.ae
  %.pn210.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %i.bl, %bb.ae ], [ %i.bm, %bb.af ], [ %.pn210.pn.pn.pn.pn, %_ZNSt6vectorIS_IhSaIhEESaIS1_EED2Ev.exit403 ], [ %.pn210.pn.pn.pn.pn, %bb.ds ]
  call void @_ZdlPvm(ptr noundef nonnull %i.w, i64 noundef 400) #21
  br label %_ZNSt6vectorIlSaIlEED2Ev.exit409.a

_ZNSt6vectorIlSaIlEED2Ev.exit409.a:               ; preds = %_ZNSt6vectorIfSaIfEED2Ev.exit407, %bb.ad
  %.pn210.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn210.pn.pn.pn.pn.pn.pn, %_ZNSt6vectorIfSaIfEED2Ev.exit407 ], [ %i.bk, %bb.ad ]
  call void @_ZdlPvm(ptr noundef nonnull %i.v, i64 noundef 800) #21
  br label %_ZNSt6vectorIlSaIlEED2Ev.exit411

_ZNSt6vectorIlSaIlEED2Ev.exit411:                 ; preds = %bb.ac, %_ZNSt6vectorIlSaIlEED2Ev.exit409.a, %bb.ab
  %.pn210.pn.pn.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %i.bi, %bb.ab ], [ %.pn210.pn.pn.pn.pn.pn.pn.pn, %_ZNSt6vectorIlSaIlEED2Ev.exit409.a ], [ %i.bj, %bb.ac ]
  call void @_ZdlPvm(ptr noundef nonnull %i.q, i64 noundef 8000) #21
  br label %bb.dt

.thread681:                                       ; preds = %bb.y, %bb.z
  %.pn210.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.ph = phi { ptr, i32 } [ %i.bg, %bb.z ], [ %i.bf, %bb.y ]
  tail call void @_ZdlPvm(ptr noundef nonnull %i.o, i64 noundef 25600) #21
  br label %_ZNKSt14default_deleteIN5faiss8IndexIVFEEclEPS1_.exit.i417

bb.dt:                                            ; preds = %bb.aa, %_ZNSt6vectorIlSaIlEED2Ev.exit411
  %.pn210.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn210.pn.pn.pn.pn.pn.pn.pn.pn.pn, %_ZNSt6vectorIlSaIlEED2Ev.exit411 ], [ %i.bh, %bb.aa ]
  call void @_ZdlPvm(ptr noundef nonnull %i.p, i64 noundef 4000) #21
  call void @_ZdlPvm(ptr noundef nonnull %i.o, i64 noundef 25600) #21
  br label %_ZNKSt14default_deleteIN5faiss8IndexIVFEEclEPS1_.exit.i417

_ZNKSt14default_deleteIN5faiss8IndexIVFEEclEPS1_.exit.i417: ; preds = %bb.dt, %bb.w, %bb.x, %.thread681
  %.pn210.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn678 = phi { ptr, i32 } [ %.pn210.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.ph, %.thread681 ], [ %.pn210.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn, %bb.dt ], [ %i.be, %bb.x ], [ %i.bd, %bb.w ]
  %i.akg = load ptr, ptr %i.e, align 8, !tbaa !10
  %i.akh = getelementptr inbounds nuw i8, ptr %i.akg, i64 8
  %i.aki = load ptr, ptr %i.akh, align 8
  call void %i.aki(ptr noundef nonnull align 8 dereferenceable(273) %i.e) #20, !inline_history !116
  br label %_ZNSt6vectorIfSaIfEED2Ev.exit420

_ZNSt6vectorIfSaIfEED2Ev.exit420:                 ; preds = %bb.e, %_ZNKSt14default_deleteIN5faiss8IndexIVFEEclEPS1_.exit.i417, %bb.d
  %.pn210.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %i.i, %bb.d ], [ %i.j, %bb.e ], [ %.pn210.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn678, %_ZNKSt14default_deleteIN5faiss8IndexIVFEEclEPS1_.exit.i417 ]
  call void @_ZdlPvm(ptr noundef nonnull %i.c, i64 noundef 256000) #21
...
.critedge:                                        ; preds = %.lr.ph.i.i, %bb.e, %..loopexit_crit_edge21.i.i, %.thread35
  ...
  %i.af = load i64, ptr %1, align 8, !tbaa !57
  store i64 %i.af, ptr %i.ae, align 8, !tbaa !57
  %i.ag = invoke ptr @_ZNSt10_HashtableIllSaIlENSt8__detail9_IdentityESt8equal_toIlESt4hashIlENS1_18_Mod_range_hashingENS1_20_Default_ranged_hashENS1_20_Prime_rehash_policyENS1_17_Hashtable_traitsILb0ELb1ELb1EEEE21_M_insert_unique_nodeEmmPNS1_10_Hash_nodeIlLb0EEEm(ptr noundef nonnull align 8 dereferenceable(56) %0, i64 noundef %i.ab, i64 noundef %i.ac, ptr noundef nonnull %i.ad, i64 noundef 1)
...
_ZNKSt10_HashtableIllSaIlENSt8__detail9_IdentityESt8equal_toIlESt4hashIlENS1_18_Mod_range_hashingENS1_20_Default_ranged_hashENS1_20_Prime_rehash_policyENS1_17_Hashtable_traitsILb0ELb1ELb1EEEE15_M_find_node_trIlEEPNS1_10_Hash_nodeIlLb0EEEmRKT_m.exit: ; preds = %bb.g, %bb.d, %.critedge, %bb.f
  %.sroa.031.1 = phi ptr [ %.sroa.028.0, %bb.d ], [ %i.ag, %.critedge ], [ %i.s, %bb.f ], [ %i.x, %bb.g ]
...
.lr.ph:                                           ; preds = %_ZNSt10_HashtableIllSaIlENSt8__detail9_IdentityESt8equal_toIlESt4hashIlENS1_18_Mod_range_hashingENS1_20_Default_ranged_hashENS1_20_Prime_rehash_policyENS1_17_Hashtable_traitsILb0ELb1ELb1EEEE19_M_allocate_bucketsEm.exit, %bb.j
  ...
  %i.i = load ptr, ptr %.02530, align 8, !tbaa !86 ; 2 uses
...
bb.g:                                             ; preds = %.lr.ph
  ...
  store ptr %i.o, ptr %.02530, align 8, !tbaa !86
  store ptr %.02530, ptr %i.g, align 8, !tbaa !83
  store ptr %i.g, ptr %i.m, align 8, !tbaa !92
  %i.p = load ptr, ptr %.02530, align 8, !tbaa !86
  %.not28 = icmp eq ptr %i.p, null
  br i1 %.not28, label %bb.j, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.q = getelementptr inbounds nuw [8 x i8], ptr %.0.i, i64 %.031
  store ptr %.02530, ptr %i.q, align 8, !tbaa !92
  br label %bb.j

bb.i:                                             ; preds = %.lr.ph
  %i.r = load ptr, ptr %i.n, align 8, !tbaa !86
  store ptr %i.r, ptr %.02530, align 8, !tbaa !86
  %i.s = load ptr, ptr %i.m, align 8, !tbaa !92
  store ptr %.02530, ptr %i.s, align 8, !tbaa !86
  br label %bb.j
