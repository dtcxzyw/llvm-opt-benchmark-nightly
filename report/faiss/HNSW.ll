...
.lr.ph.preheader.i.i.i.i:                         ; preds = %bb.bl
  %.phi.trans.insert.i.i.i.i = getelementptr inbounds nuw i8, ptr %i.jt, i64 8
  ...
  %14 = load <6 x float>, ptr %.phi.trans.insert.i.i.i.i, align 4, !tbaa !233, !alias.scope !538, !noalias !545 ; 6 uses
  %i.jw = shufflevector <2 x float> %i.ju, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 1, i32 0>
  %i.jx = shufflevector <6 x float> %14, <6 x float> poison, <4 x i32> zeroinitializer
...
.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i, %.lr.ph.preheader.i.i.i.i
  ...
  %i.me = fmul fast <4 x float> %i.md, %i.jx
  ...
  %i.mj = fmul fast <4 x float> %i.mi, %15
  ...
  %i.ms = fmul fast <4 x float> %i.mr, %16
  ...
  %i.mx = fmul fast <4 x float> %i.mw, %17
  ...
  %i.nc = fmul fast <4 x float> %i.nb, %18
  ...
  %i.nh = fmul fast <4 x float> %i.ng, %19
...
bb.bm:                                            ; preds = %.lr.ph833
  %i.oe = getelementptr inbounds nuw [4 x i8], ptr %i.fd, i64 %i.jp ; 5 uses
...
.lr.ph.preheader.i.i.i.i.i:                       ; preds = %bb.bm
  ...
  %20 = load <2 x float>, ptr %i.oe, align 4, !tbaa !233, !alias.scope !551, !noalias !558 ; 2 uses
  %21 = shufflevector <2 x float> %20, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %22 = load <3 x float>, ptr %i.of, align 4, !tbaa !233, !alias.scope !551, !noalias !558 ; 3 uses
  ...
  %23 = load <10 x float>, ptr %i.oi, align 4, !tbaa !233, !alias.scope !551, !noalias !558 ; 10 uses
  %i.oj = shufflevector <10 x float> %23, <10 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.om = shufflevector <2 x float> %20, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 1, i32 0>
  %i.on = shufflevector <3 x float> %22, <3 x float> poison, <4 x i32> zeroinitializer
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i, %.lr.ph.preheader.i.i.i.i.i
  ...
  %i.qh = fmul fast <4 x float> %i.qg, %21
  ...
  %i.qm = fmul fast <4 x float> %i.ql, %i.on
  ...
  %i.qr = fmul fast <4 x float> %i.qq, %33
  ...
  %i.qx = fmul fast <4 x float> %i.qw, %34
  ...
  %i.sh = fmul fast <4 x float> %i.sg, %i.oj
  ...
  %i.sm = fmul fast <4 x float> %i.sl, %24
  ...
  %i.sr = fmul fast <4 x float> %i.sq, %25
  ...
  %i.sw = fmul fast <4 x float> %i.sv, %26
  ...
  %i.tf = fmul fast <4 x float> %i.te, %27
  ...
  %i.tk = fmul fast <4 x float> %i.tj, %28
  ...
  %i.tp = fmul fast <4 x float> %i.to, %29
  ...
  %i.tu = fmul fast <4 x float> %i.tt, %30
  ...
  %i.uf = fmul fast <4 x float> %i.ue, %31
  ...
  %i.uk = fmul fast <4 x float> %i.uj, %32
