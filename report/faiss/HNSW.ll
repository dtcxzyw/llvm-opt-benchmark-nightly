...
.lr.ph.preheader.i.i.i.i:                         ; preds = %bb.bl
  ...
  %.pre.i.i.i.i = load float, ptr %i.ju, align 4, !tbaa !233, !alias.scope !538, !noalias !545
  ...
  %i.jy = shufflevector <4 x float> %28, <4 x float> poison, <4 x i32> zeroinitializer
...
.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i, %.lr.ph.preheader.i.i.i.i
  ...
  %i.mf = fmul fast <4 x float> %i.me, %25
  ...
  %i.mk = fmul fast <4 x float> %i.mj, %27
  ...
  %i.mt = fmul fast <4 x float> %i.ms, %i.jy
  ...
  %i.my = fmul fast <4 x float> %i.mx, %30
  ...
  %i.nd = fmul fast <4 x float> %i.nc, %32
  ...
  %i.ni = fmul fast <4 x float> %i.nh, %34
...
bb.bm:                                            ; preds = %.lr.ph833
  %i.of = getelementptr inbounds nuw [4 x i8], ptr %i.fd, i64 %i.jp ; 16 uses
...
.lr.ph.preheader.i.i.i.i.i:                       ; preds = %bb.bm
  %35 = load <2 x float>, ptr %i.of, align 4, !tbaa !233, !alias.scope !551, !noalias !558 ; 2 uses
  ...
  %37 = load float, ptr %i.og, align 4, !tbaa !233, !alias.scope !551, !noalias !558
  %38 = getelementptr inbounds nuw i8, ptr %i.of, i64 12
  %39 = load float, ptr %38, align 4, !tbaa !233, !alias.scope !551, !noalias !558
  %40 = getelementptr inbounds nuw i8, ptr %i.of, i64 16
  ...
  %i.ok = shufflevector <4 x float> %69, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.on = shufflevector <2 x float> %35, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 1, i32 0>
  ...
  %i.oo = shufflevector <4 x float> %82, <4 x float> poison, <4 x i32> zeroinitializer
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i, %.lr.ph.preheader.i.i.i.i.i
  ...
  %i.qi = fmul fast <4 x float> %i.qh, %36
  ...
  %i.qn = fmul fast <4 x float> %i.qm, %81
  ...
  %i.qs = fmul fast <4 x float> %i.qr, %i.oo
  ...
  %i.qy = fmul fast <4 x float> %i.qx, %84
  ...
  %i.si = fmul fast <4 x float> %i.sh, %62
  ...
  %i.sn = fmul fast <4 x float> %i.sm, %64
  ...
  %i.ss = fmul fast <4 x float> %i.sr, %66
  ...
  %i.sx = fmul fast <4 x float> %i.sw, %68
  ...
  %i.tg = fmul fast <4 x float> %i.tf, %i.ok
  ...
  %i.tl = fmul fast <4 x float> %i.tk, %71
  ...
  %i.tq = fmul fast <4 x float> %i.tp, %73
  ...
  %i.tv = fmul fast <4 x float> %i.tu, %75
  ...
  %i.ug = fmul fast <4 x float> %i.uf, %77
  ...
  %i.ul = fmul fast <4 x float> %i.uk, %79
