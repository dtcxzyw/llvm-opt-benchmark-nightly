...
bb.au:                                            ; preds = %_ZN5faiss12MinimaxHeapTINS_4CMaxIfiEEE11count_belowEf.exit
  %i.hm = icmp eq i64 %.02078211302, 0            ; 2 uses
  br i1 %i.hm, label %.thread656, label %bb.ba
...
bb.ay:                                            ; preds = %.preheader701.preheader
...
bb.ba:                                            ; preds = %bb.au
  invoke void @_ZN5faiss12MinimaxHeapTINS_4CMaxIfiEEE4pushEif(ptr noundef nonnull align 8 dereferenceable(64) %4, i32 noundef %i.gt, float noundef %i.gu)
          to label %.thread656 unwind label %bb.az

.thread656:                                       ; preds = %bb.au, %bb.ba
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #20
  br label %.critedge

bb.bb:                                            ; preds = %_ZN5faiss12MinimaxHeapTINS_4CMaxIfiEEE11count_belowEf.exit, %bb.as
  %i.hu = add i64 %.02078211302, 1                ; 3 uses
  ...
  br i1 %i.ii, label %.lr.ph816, label %._crit_edge817.thread

._crit_edge817.thread:                            ; preds = %bb.bb
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #20
  br label %.preheader701thread-pre-split

.lr.ph816:                                        ; preds = %bb.bb, %bb.bj
  %.1201814 = phi i64 [ %.3203.ph, %bb.bj ], [ %.02008221301, %bb.bb ] ; 5 uses
  %.0214813 = phi i64 [ %i.jf, %bb.bj ], [ %i.id, %bb.bb ] ; 2 uses
  %i.ij = load ptr, ptr %i.fw, align 8, !tbaa !154
  %i.ik = getelementptr inbounds nuw [4 x i8], ptr %i.ij, i64 %.0214813
  %i.il = load i32, ptr %i.ik, align 4, !tbaa !21 ; 3 uses
  %i.im = icmp sgt i32 %i.il, -1
  br i1 %i.im, label %bb.bc, label %._crit_edge817

bb.bc:                                            ; preds = %.lr.ph816
...
bb.be:                                            ; preds = %bb.bd
  %i.is = load ptr, ptr %.04721050, align 8, !tbaa !22
  %i.it = load ptr, ptr %i.is, align 8
  %i.iu = invoke noundef zeroext i1 %i.it(ptr noundef nonnull align 8 dereferenceable(8) %.04721050, i64 noundef %i.in)
...
bb.bg:                                            ; preds = %bb.bf
  ...
  %i.iz = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0531.0623629, i64 %.1201814
  store i32 %i.il, ptr %i.iz, align 4, !tbaa !21
  %i.ja = call float @llvm.fmuladd.f32(float %i.iy, float %i.iy, float %i.fo)
  %i.jb = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0456.0647, i64 %.1201814
  store float %i.ja, ptr %i.jb, align 4, !tbaa !201
  %i.jc = add i64 %.1201814, 1
  br label %bb.bj
...
bb.bj:                                            ; preds = %bb.bf, %bb.bg
  %.3203.ph = phi i64 [ %.1201814, %bb.bf ], [ %i.jc, %bb.bg ] ; 2 uses
  %i.jf = add i64 %.0214813, 1                    ; 2 uses
  %exitcond.not = icmp eq i64 %i.jf, %i.ih
  br i1 %exitcond.not, label %._crit_edge817, label %.lr.ph816, !llvm.loop !492

._crit_edge817:                                   ; preds = %.lr.ph816, %bb.bj
  %.1201.lcssa = phi i64 [ %.3203.ph, %bb.bj ], [ %.1201814, %.lr.ph816 ] ; 3 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #20
  %i.jg = icmp ult i64 %.1201.lcssa, 64
  br i1 %i.jg, label %.preheader701thread-pre-split, label %.critedge
...
.critedge:                                        ; preds = %._crit_edge817, %.preheader701thread-pre-split, %.thread656
  %.0207714 = phi i64 [ %.02078211302, %.thread656 ], [ %i.hu, %.preheader701thread-pre-split ], [ %i.hu, %._crit_edge817 ]
  %.0200709 = phi i64 [ %.02008221301, %.thread656 ], [ %.1201.lcssa, %._crit_edge817 ], [ %.1201.lcssa1064, %.preheader701thread-pre-split ] ; 4 uses
  %.6199 = phi i1 [ %i.hm, %.thread656 ], [ false, %.preheader701thread-pre-split ], [ false, %._crit_edge817 ]
  %i.jh = mul i64 %.0200709, %i.fg
  %i.ji = load i64, ptr %i.fx, align 8, !tbaa !493
  %i.jj = add i64 %i.ji, %i.jh
  store i64 %i.jj, ptr %i.fx, align 8, !tbaa !493
  %i.jk = icmp ne i64 %.0200709, 0
  %i.jl = and i1 %i.fy, %i.jk
  br i1 %i.jl, label %.lr.ph831, label %.preheader

.preheader:                                       ; preds = %._crit_edge826, %.critedge
  %.0605.lcssa = phi i64 [ %.0200709, %.critedge ], [ %.1183, %._crit_edge826 ] ; 2 uses
  %.1179.lcssa = phi i32 [ %.0178, %.critedge ], [ %i.esc, %._crit_edge826 ] ; 2 uses
  %.not842 = icmp eq i64 %.0605.lcssa, 0
  br i1 %.not842, label %._crit_edge838, label %.lr.ph837

.lr.ph831:                                        ; preds = %.critedge, %._crit_edge826
  %.1179830 = phi i32 [ %i.esc, %._crit_edge826 ], [ %.0178, %.critedge ]
  %.0192829 = phi i64 [ %i.jm, %._crit_edge826 ], [ 0, %.critedge ] ; 2 uses
  %.0605828 = phi i64 [ %.1183, %._crit_edge826 ], [ %.0200709, %.critedge ] ; 76 uses
  %i.jm = add nuw i64 %.0192829, 1                ; 5 uses
  %i.jn = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0449.0, i64 %i.jm
  %i.jo = load float, ptr %i.jn, align 4, !tbaa !201
  %i.jp = mul i64 %.0192829, %i.eg                ; 20 uses
...
.lr.ph.preheader.i.i.i.i:                         ; preds = %bb.bl
  ...
  %14 = shufflevector <2 x float> %i.ju, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 1, i32 0>
  ...
  %15 = insertelement <4 x float> poison, float %i.ke, i64 0
  %16 = shufflevector <4 x float> %15, <4 x float> poison, <4 x i32> zeroinitializer
  %17 = shufflevector <2 x float> %i.ju, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %i.kf = insertelement <4 x float> poison, float %i.jw, i64 0
  %i.kg = shufflevector <4 x float> %i.kf, <4 x float> poison, <4 x i32> zeroinitializer
  %i.kh = insertelement <4 x float> poison, float %i.jy, i64 0
  %i.ki = shufflevector <4 x float> %i.kh, <4 x float> poison, <4 x i32> zeroinitializer
  %i.kj = insertelement <4 x float> poison, float %.pre.i.i.i.i, i64 0
  %i.kk = shufflevector <4 x float> %i.kj, <4 x float> poison, <4 x i32> zeroinitializer
  %i.kl = insertelement <4 x float> poison, float %i.ka, i64 0
  %i.km = shufflevector <4 x float> %i.kl, <4 x float> poison, <4 x i32> zeroinitializer
  %i.kn = insertelement <4 x float> poison, float %i.kc, i64 0
...
.preheader.i.i.i.i:                               ; preds = %.lr.ph.i.i.i.i, %bb.bl
  %.070.lcssa.i.i.i.i = phi i64 [ 0, %bb.bl ], [ %i.lc, %.lr.ph.i.i.i.i ] ; 6 uses
  %i.kp = icmp ult i64 %.070.lcssa.i.i.i.i, %.0605828
  br i1 %i.kp, label %.lr.ph87.preheader.i.i.i.i, label %.lr.ph825
...
.lr.ph87.preheader.i.i.i.i:                       ; preds = %.preheader.i.i.i.i
  ...
  %.neg = or disjoint i64 %.070.lcssa.i.i.i.i, 1
  %xtraiter = and i64 %.0605828, 1
...
.lr.ph87.i.i.i.i.prol:                            ; preds = %.lr.ph87.preheader.i.i.i.i
  %i.kr = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0531.0623629, i64 %.070.lcssa.i.i.i.i
  ...
  %i.kz = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0, i64 %.070.lcssa.i.i.i.i
  store float %i.ky, ptr %i.kz, align 4, !tbaa !201, !alias.scope !499, !noalias !504
  %i.la = or disjoint i64 %.070.lcssa.i.i.i.i, 1
  br label %.lr.ph87.i.i.i.i.prol.loopexit

.lr.ph87.i.i.i.i.prol.loopexit:                   ; preds = %.lr.ph87.i.i.i.i.prol, %.lr.ph87.preheader.i.i.i.i
  %.186.i.i.i.i.unr = phi i64 [ %.070.lcssa.i.i.i.i, %.lr.ph87.preheader.i.i.i.i ], [ %i.la, %.lr.ph87.i.i.i.i.prol ]
  %i.lb = icmp eq i64 %.0605828, %.neg
  br i1 %i.lb, label %.lr.ph825, label %.lr.ph87.i.i.i.i

.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i, %.lr.ph.preheader.i.i.i.i
  %i.lc = phi i64 [ %i.oa, %.lr.ph.i.i.i.i ], [ 4, %.lr.ph.preheader.i.i.i.i ] ; 3 uses
  %.07083.i.i.i.i = phi i64 [ %i.lc, %.lr.ph.i.i.i.i ], [ 0, %.lr.ph.preheader.i.i.i.i ] ; 5 uses
  %i.ld = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0531.0623629, i64 %.07083.i.i.i.i
  ...
  %i.li = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0531.0623629, i64 %.07083.i.i.i.i
  ...
  %i.lo = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0531.0623629, i64 %.07083.i.i.i.i
  ...
  %i.lu = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0531.0623629, i64 %.07083.i.i.i.i
  ...
  %i.me = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0, i64 %.07083.i.i.i.i
  ...
  %i.mm = fmul fast <4 x float> %i.ml, %14
  ...
  %i.mq = fmul fast <4 x float> %i.mp, %17
  ...
  %i.mv = fmul fast <4 x float> %i.mu, %i.kg
  ...
  %i.na = fmul fast <4 x float> %i.mz, %i.ki
  ...
  %i.nj = fmul fast <4 x float> %i.ni, %i.kk
  ...
  %i.no = fmul fast <4 x float> %i.nn, %i.km
  ...
  %i.nt = fmul fast <4 x float> %i.ns, %i.ko
  ...
  %i.ny = fmul fast <4 x float> %i.nx, %16
  %i.nz = fadd fast <4 x float> %i.ny, %i.nu
  store <4 x float> %i.nz, ptr %i.me, align 4, !tbaa !201, !alias.scope !499, !noalias !504
  %i.oa = add i64 %i.lc, 4                        ; 2 uses
  %.not.i.i.i.i289 = icmp ugt i64 %i.oa, %.0605828
...
.lr.ph87.i.i.i.i:                                 ; preds = %.lr.ph87.i.i.i.i.prol.loopexit, %.lr.ph87.i.i.i.i
  ...
  %i.ob = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0531.0623629, i64 %.186.i.i.i.i
  ...
  %i.ol = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0531.0623629, i64 %i.ok
  ...
  %exitcond.not.i.i.i.i.1 = icmp eq i64 %i.ou, %.0605828
  br i1 %exitcond.not.i.i.i.i.1, label %.lr.ph825, label %.lr.ph87.i.i.i.i, !llvm.loop !506

bb.bm:                                            ; preds = %.lr.ph831
  %i.ov = getelementptr inbounds nuw [4 x i8], ptr %i.fd, i64 %i.jp ; 16 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !507)
  call void @llvm.experimental.noalias.scope.decl(metadata !510)
  call void @llvm.experimental.noalias.scope.decl(metadata !512)
  %.not82.i.i.i.i.i = icmp ult i64 %.0605828, 4
...
.lr.ph.preheader.i.i.i.i.i:                       ; preds = %bb.bm
  ...
  %18 = shufflevector <2 x float> %i.ow, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 1, i32 0>
  ...
  %19 = shufflevector <2 x float> %i.ow, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
...
.preheader.i.i.i.i.i:                             ; preds = %.lr.ph.i.i.i.i.i, %bb.bm
  %.070.lcssa.i.i.i.i.i = phi i64 [ 0, %bb.bm ], [ %i.rd, %.lr.ph.i.i.i.i.i ] ; 2 uses
  %i.rb = icmp ult i64 %.070.lcssa.i.i.i.i.i, %.0605828
  br i1 %i.rb, label %.lr.ph87.preheader.i.i.i.i.i, label %.lr.ph825
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i, %.lr.ph.preheader.i.i.i.i.i
  ...
  %.07083.i.i.i.i.i = phi i64 [ %i.rd, %.lr.ph.i.i.i.i.i ], [ 0, %.lr.ph.preheader.i.i.i.i.i ] ; 5 uses
  %i.re = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0531.0623629, i64 %.07083.i.i.i.i.i
  ...
  %i.rj = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0531.0623629, i64 %.07083.i.i.i.i.i
  ...
  %i.rp = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0531.0623629, i64 %.07083.i.i.i.i.i
  ...
  %i.rv = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0531.0623629, i64 %.07083.i.i.i.i.i
  ...
  %i.sq = fmul fast <4 x float> %i.sp, %18
  ...
  %i.su = fmul fast <4 x float> %i.st, %19
  %i.sv = fadd fast <4 x float> %i.sq, %i.su
  ...
  %i.ul = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0, i64 %.07083.i.i.i.i.i
  ...
  %i.uu = fmul fast <4 x float> %i.ut, %i.qc
  ...
  %i.uz = fmul fast <4 x float> %i.uy, %i.qe
  ...
  %i.ve = fmul fast <4 x float> %i.vd, %i.qg
  ...
  %i.vj = fmul fast <4 x float> %i.vi, %i.qi
  ...
  %i.vs = fmul fast <4 x float> %i.vr, %i.qk
  ...
  %i.vx = fmul fast <4 x float> %i.vw, %i.qm
  ...
  %i.wc = fmul fast <4 x float> %i.wb, %i.qo
  ...
  %i.wh = fmul fast <4 x float> %i.wg, %i.qq
  ...
  %i.ws = fmul fast <4 x float> %i.wr, %i.qs
  ...
  %i.wx = fmul fast <4 x float> %i.ww, %i.qa
  %i.wy = fadd fast <4 x float> %i.wx, %i.wt
  store <4 x float> %i.wy, ptr %i.ul, align 4, !tbaa !201, !alias.scope !512, !noalias !517
  %i.wz = add i64 %i.rd, 4                        ; 2 uses
  %.not.i.i.i.i.i = icmp ugt i64 %i.wz, %.0605828
...
.lr.ph87.i.i.i.i.i:                               ; preds = %.lr.ph87.i.i.i.i.i, %.lr.ph87.preheader.i.i.i.i.i
  %.186.i.i.i.i.i = phi i64 [ %i.xj, %.lr.ph87.i.i.i.i.i ], [ %.070.lcssa.i.i.i.i.i, %.lr.ph87.preheader.i.i.i.i.i ] ; 3 uses
  %i.xa = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0531.0623629, i64 %.186.i.i.i.i.i
  ...
  %exitcond.not.i.i.i.i.i = icmp eq i64 %i.xj, %.0605828
  br i1 %exitcond.not.i.i.i.i.i, label %.lr.ph825, label %.lr.ph87.i.i.i.i.i, !llvm.loop !519

bb.bn:                                            ; preds = %.lr.ph831
  %i.xk = getelementptr inbounds nuw [4 x i8], ptr %i.fd, i64 %i.jp ; 7 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !520)
  call void @llvm.experimental.noalias.scope.decl(metadata !523)
  call void @llvm.experimental.noalias.scope.decl(metadata !525)
  %.not82.i.i.i.i.i.i = icmp ult i64 %.0605828, 4
...
.lr.ph.i.i.i.i.i.i.preheader:                     ; preds = %bb.bn
  ...
  %wide.load1394 = load <4 x float>, ptr %i.xk, align 4, !tbaa !201, !alias.scope !520, !noalias !527 ; 4 uses
  %wide.load1395 = load <4 x float>, ptr %i.xl, align 4, !tbaa !201, !alias.scope !520, !noalias !527 ; 4 uses
  %i.xm = getelementptr inbounds nuw i8, ptr %i.xk, i64 32
  %i.xn = getelementptr inbounds nuw i8, ptr %i.xk, i64 48
  %wide.load1394.1 = load <4 x float>, ptr %i.xm, align 4, !tbaa !201, !alias.scope !520, !noalias !527 ; 4 uses
  %wide.load1395.1 = load <4 x float>, ptr %i.xn, align 4, !tbaa !201, !alias.scope !520, !noalias !527 ; 4 uses
  %i.xo = getelementptr inbounds nuw i8, ptr %i.xk, i64 64
  %i.xp = getelementptr inbounds nuw i8, ptr %i.xk, i64 80
  %wide.load1394.2 = load <4 x float>, ptr %i.xo, align 4, !tbaa !201, !alias.scope !520, !noalias !527 ; 4 uses
  %wide.load1395.2 = load <4 x float>, ptr %i.xp, align 4, !tbaa !201, !alias.scope !520, !noalias !527 ; 4 uses
  br label %.lr.ph.i.i.i.i.i.i

.preheader.i.i.i.i.i.i:                           ; preds = %.lr.ph.i.i.i.i.i.i, %bb.bn
  %.070.lcssa.i.i.i.i.i.i = phi i64 [ 0, %bb.bn ], [ %i.xs, %.lr.ph.i.i.i.i.i.i ] ; 2 uses
  %i.xq = icmp ult i64 %.070.lcssa.i.i.i.i.i.i, %.0605828
  br i1 %i.xq, label %.lr.ph87.preheader.i.i.i.i.i.i, label %.lr.ph825
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %.lr.ph.i.i.i.i.i.i.preheader, %.lr.ph.i.i.i.i.i.i
  ...
  %.07083.i.i.i.i.i.i = phi i64 [ %i.xs, %.lr.ph.i.i.i.i.i.i ], [ 0, %.lr.ph.i.i.i.i.i.i.preheader ] ; 5 uses
  %i.xt = or disjoint i64 %.07083.i.i.i.i.i.i, 3  ; 2 uses
  %i.xu = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0531.0623629, i64 %i.xt
  ...
  %i.xz = or disjoint i64 %.07083.i.i.i.i.i.i, 2  ; 2 uses
  %i.ya = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0531.0623629, i64 %i.xz
  ...
  %i.yf = or disjoint i64 %.07083.i.i.i.i.i.i, 1  ; 2 uses
  %i.yg = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0531.0623629, i64 %i.yf
  ...
  %i.yl = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0531.0623629, i64 %.07083.i.i.i.i.i.i
  ...
  %wide.load1396 = load <4 x float>, ptr %i.yp, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %wide.load1397 = load <4 x float>, ptr %i.yq, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %i.yr = fmul fast <4 x float> %wide.load1396, %wide.load1394
  %i.ys = fmul fast <4 x float> %wide.load1397, %wide.load1395
  %i.yt = getelementptr inbounds nuw i8, ptr %i.yk, i64 16
  %wide.load1398 = load <4 x float>, ptr %i.yk, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %wide.load1399 = load <4 x float>, ptr %i.yt, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %i.yu = fmul fast <4 x float> %wide.load1398, %wide.load1394
  %i.yv = fmul fast <4 x float> %wide.load1399, %wide.load1395
  %i.yw = getelementptr inbounds nuw i8, ptr %i.ye, i64 16
  %wide.load1400 = load <4 x float>, ptr %i.ye, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %wide.load1401 = load <4 x float>, ptr %i.yw, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %i.yx = fmul fast <4 x float> %wide.load1400, %wide.load1394
  %i.yy = fmul fast <4 x float> %wide.load1401, %wide.load1395
  %i.yz = getelementptr inbounds nuw i8, ptr %i.xy, i64 16
  %wide.load1402 = load <4 x float>, ptr %i.xy, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %wide.load1403 = load <4 x float>, ptr %i.yz, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %i.za = fmul fast <4 x float> %wide.load1402, %wide.load1394
  %i.zb = fmul fast <4 x float> %wide.load1403, %wide.load1395
  %i.zc = getelementptr inbounds nuw i8, ptr %i.yp, i64 32
  %i.zd = getelementptr inbounds nuw i8, ptr %i.yp, i64 48
  %wide.load1396.1 = load <4 x float>, ptr %i.zc, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %wide.load1397.1 = load <4 x float>, ptr %i.zd, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %i.ze = fmul fast <4 x float> %wide.load1396.1, %wide.load1394.1
  %i.zf = fmul fast <4 x float> %wide.load1397.1, %wide.load1395.1
  ...
  %wide.load1398.1 = load <4 x float>, ptr %i.zi, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %wide.load1399.1 = load <4 x float>, ptr %i.zj, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %i.zk = fmul fast <4 x float> %wide.load1398.1, %wide.load1394.1
  %i.zl = fmul fast <4 x float> %wide.load1399.1, %wide.load1395.1
  ...
  %wide.load1400.1 = load <4 x float>, ptr %i.zo, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %wide.load1401.1 = load <4 x float>, ptr %i.zp, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %i.zq = fmul fast <4 x float> %wide.load1400.1, %wide.load1394.1
  %i.zr = fmul fast <4 x float> %wide.load1401.1, %wide.load1395.1
  ...
  %wide.load1402.1 = load <4 x float>, ptr %i.zu, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %wide.load1403.1 = load <4 x float>, ptr %i.zv, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %i.zw = fmul fast <4 x float> %wide.load1402.1, %wide.load1394.1
  %i.zx = fmul fast <4 x float> %wide.load1403.1, %wide.load1395.1
  ...
  %wide.load1396.2 = load <4 x float>, ptr %i.aaa, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %wide.load1397.2 = load <4 x float>, ptr %i.aab, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %i.aac = fmul fast <4 x float> %wide.load1396.2, %wide.load1394.2
  %i.aad = fmul fast <4 x float> %wide.load1397.2, %wide.load1395.2
  ...
  %wide.load1398.2 = load <4 x float>, ptr %i.aag, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %wide.load1399.2 = load <4 x float>, ptr %i.aah, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %i.aai = fmul fast <4 x float> %wide.load1398.2, %wide.load1394.2
  %i.aaj = fmul fast <4 x float> %wide.load1399.2, %wide.load1395.2
  ...
  %wide.load1400.2 = load <4 x float>, ptr %i.aam, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %wide.load1401.2 = load <4 x float>, ptr %i.aan, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %i.aao = fmul fast <4 x float> %wide.load1400.2, %wide.load1394.2
  %i.aap = fmul fast <4 x float> %wide.load1401.2, %wide.load1395.2
  ...
  %wide.load1402.2 = load <4 x float>, ptr %i.aas, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %wide.load1403.2 = load <4 x float>, ptr %i.aat, align 4, !tbaa !201, !alias.scope !523, !noalias !529
  %i.aau = fmul fast <4 x float> %wide.load1402.2, %wide.load1394.2
  %i.aav = fmul fast <4 x float> %wide.load1403.2, %wide.load1395.2
  %i.aaw = fadd fast <4 x float> %i.aau, %i.zy
  %i.aax = fadd fast <4 x float> %i.aav, %i.zz
  %bin.rdx1409 = fadd fast <4 x float> %i.aal, %i.aak
  %i.aay = call fast float @llvm.vector.reduce.fadd.v4f32(float 0.000000e+00, <4 x float> %bin.rdx1409)
  %bin.rdx1408 = fadd fast <4 x float> %i.aar, %i.aaq
  %i.aaz = call fast float @llvm.vector.reduce.fadd.v4f32(float 0.000000e+00, <4 x float> %bin.rdx1408)
  %bin.rdx1407 = fadd fast <4 x float> %i.aax, %i.aaw
  %i.aba = call fast float @llvm.vector.reduce.fadd.v4f32(float 0.000000e+00, <4 x float> %bin.rdx1407)
  %bin.rdx1406 = fadd fast <4 x float> %i.aaf, %i.aae
  %i.abb = call fast float @llvm.vector.reduce.fadd.v4f32(float 0.000000e+00, <4 x float> %bin.rdx1406)
  %i.abc = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0, i64 %.07083.i.i.i.i.i.i
  store float %i.abb, ptr %i.abc, align 4, !tbaa !201, !alias.scope !525, !noalias !530
  %i.abd = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0, i64 %i.yf
  store float %i.aay, ptr %i.abd, align 4, !tbaa !201, !alias.scope !525, !noalias !530
  %i.abe = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0, i64 %i.xz
  store float %i.aaz, ptr %i.abe, align 4, !tbaa !201, !alias.scope !525, !noalias !530
  %i.abf = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0, i64 %i.xt
  store float %i.aba, ptr %i.abf, align 4, !tbaa !201, !alias.scope !525, !noalias !530
  %i.abg = add i64 %i.xs, 4                       ; 2 uses
  %.not.i.i.i.i.i.i = icmp ugt i64 %i.abg, %.0605828
...
.lr.ph87.i.i.i.i.i.i:                             ; preds = %.lr.ph87.i.i.i.i.i.i, %.lr.ph87.preheader.i.i.i.i.i.i
  %.186.i.i.i.i.i.i = phi i64 [ %i.abq, %.lr.ph87.i.i.i.i.i.i ], [ %.070.lcssa.i.i.i.i.i.i, %.lr.ph87.preheader.i.i.i.i.i.i ] ; 3 uses
  %i.abh = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0531.0623629, i64 %.186.i.i.i.i.i.i
  ...
  %exitcond94.not.i.i.i.i.i.i = icmp eq i64 %i.abq, %.0605828
  br i1 %exitcond94.not.i.i.i.i.i.i, label %.lr.ph825, label %.lr.ph87.i.i.i.i.i.i, !llvm.loop !532

bb.bo:                                            ; preds = %.lr.ph831
