Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/faiss/original/NSG?download=true
...
bb.a:
  ...
  %i.g = load ptr, ptr %0, align 8, !tbaa !51
...
bb.i:                                             ; preds = %bb.h
  ...
  store i8 %i.u, ptr %i.s, align 1, !tbaa !42
...
bb.l:                                             ; preds = %bb.k
  %i.y = load i8, ptr %3, align 1, !tbaa !42
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit26: ; preds = %bb.m, %bb.l, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit
  ...
  %.pre = load ptr, ptr %0, align 8, !tbaa !51    ; 3 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  store i8 %i.ad, ptr %i.aa, align 1, !tbaa !42
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i28: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit27
  %i.af = load i64, ptr %i.h, align 8, !tbaa !42
end_hunk_0
...
begin_hunk_2_@_ZNK5faiss3NSG15search_on_graphILb1ElEEvRKNS_3nsg5GraphIT0_EERNS_16DistanceComputerERNS_12VisitedTableEiiRSt6vectorINS2_8NeighborESaISD_EERSC_INS2_4NodeESaISH_EE:bb.a
  ...
  %i.ef = invoke noundef i64 %i.ee(ptr noundef nonnull align 8 dereferenceable(25) %1, i32 noundef %i.eb, ptr noundef %.sroa.0146.0)
          to label %.preheader unwind label %bb.af ; 2 uses

.preheader:                                       ; preds = %bb.ad
  %.not204 = icmp eq i64 %i.ef, 0
...
.lr.ph196:                                        ; preds = %.preheader, %bb.ay
  %.088195 = phi i64 [ %i.hl, %bb.ay ], [ 0, %.preheader ] ; 2 uses
  %.0194 = phi i32 [ %.2, %bb.ay ], [ %5, %.preheader ] ; 4 uses
  %i.ei = getelementptr inbounds nuw [8 x i8], ptr %.sroa.0146.0, i64 %.088195
  %i.ej = load i64, ptr %i.ei, align 8, !tbaa !59 ; 3 uses
  %i.ek = trunc i64 %i.ej to i32                  ; 6 uses
  %i.el = load i32, ptr %0, align 8, !tbaa !24
  %.not95 = icmp sgt i32 %i.el, %i.ek
  br i1 %.not95, label %bb.ag, label %bb.ay

bb.ag:                                            ; preds = %.lr.ph196
  %sext = shl i64 %i.ej, 32
  %i.em = ashr exact i64 %sext, 32                ; 3 uses
  %i.en = load ptr, ptr %3, align 8, !tbaa !15
  %i.eo = getelementptr inbounds nuw i8, ptr %i.en, i64 24
  %i.ep = load ptr, ptr %i.eo, align 8
  %i.eq = invoke noundef zeroext i1 %i.ep(ptr noundef nonnull align 8 dereferenceable(8) %3, i64 noundef %i.em)
          to label %bb.ah unwind label %bb.ai

bb.ah:                                            ; preds = %bb.ag
  br i1 %i.eq, label %bb.ay, label %bb.aj
...
bb.aj:                                            ; preds = %bb.ah
  %i.es = load ptr, ptr %3, align 8, !tbaa !15
  %i.et = getelementptr inbounds nuw i8, ptr %i.es, i64 16
  %i.eu = load ptr, ptr %i.et, align 8
  %i.ev = invoke noundef zeroext i1 %i.eu(ptr noundef nonnull align 8 dereferenceable(8) %3, i64 noundef %i.em)
          to label %bb.ak unwind label %bb.ai     ; 0 uses

bb.ak:                                            ; preds = %bb.aj
  %i.ew = load ptr, ptr %2, align 8, !tbaa !15
  %i.ex = getelementptr inbounds nuw i8, ptr %i.ew, i64 8
  %i.ey = load ptr, ptr %i.ex, align 8
  %i.ez = invoke noundef float %i.ey(ptr noundef nonnull align 8 dereferenceable(8) %2, i64 noundef %i.em)
          to label %bb.al unwind label %bb.ar     ; 7 uses

bb.al:                                            ; preds = %bb.ak
  %i.fa = load ptr, ptr %i.dq, align 8, !tbaa !169 ; 5 uses
  %i.fb = load ptr, ptr %i.dr, align 8, !tbaa !64
  %.not.i116 = icmp eq ptr %i.fa, %i.fb
  br i1 %.not.i116, label %bb.an, label %bb.am

bb.am:                                            ; preds = %bb.al
  store i32 %i.ek, ptr %i.fa, align 4, !tbaa !146
  %i.fc = getelementptr inbounds nuw i8, ptr %i.fa, i64 4
  store float %i.ez, ptr %i.fc, align 4, !tbaa !174
  %i.fd = getelementptr inbounds nuw i8, ptr %i.fa, i64 8
  store ptr %i.fd, ptr %i.dq, align 8, !tbaa !169
  br label %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE12emplace_backIJRiRfEEERS2_DpOT_.exit125

bb.an:                                            ; preds = %bb.al
  %i.fe = load ptr, ptr %7, align 8, !tbaa !61    ; 4 uses
  ...
  br i1 %i.fi, label %bb.ao, label %_ZNKSt6vectorIN5faiss3nsg4NodeESaIS2_EE12_M_check_lenEmPKc.exit.i.i117
...
_ZNKSt6vectorIN5faiss3nsg4NodeESaIS2_EE12_M_check_lenEmPKc.exit.i.i117: ; preds = %bb.an
  ...
  %.sroa.speculated.i.i.i118 = call i64 @llvm.umax.i64(i64 %i.fj, i64 1)
  %i.fk = add nsw i64 %.sroa.speculated.i.i.i118, %i.fj ; 2 uses
  ...
  %.not.i.i.i119 = icmp ne i64 %i.fn, 0
  call void @llvm.assume(i1 %.not.i.i.i119)
  %i.fo = shl nuw nsw i64 %i.fn, 3
  %i.fp = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.fo) #23
...
.noexc124:                                        ; preds = %_ZNKSt6vectorIN5faiss3nsg4NodeESaIS2_EE12_M_check_lenEmPKc.exit.i.i117
  ...
  store i32 %i.ek, ptr %i.fq, align 4, !tbaa !146
  %i.fr = getelementptr inbounds nuw i8, ptr %i.fq, i64 4
  store float %i.ez, ptr %i.fr, align 4, !tbaa !174
  %i.fs = icmp sgt i64 %i.fh, 0
  br i1 %i.fs, label %bb.ap, label %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit27.i.i120

bb.ap:                                            ; preds = %.noexc124
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 4 %i.fp, ptr align 4 %i.fe, i64 %i.fh, i1 false)
...
_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit27.i.i120: ; preds = %bb.ap, %.noexc124
  ...
  %.not.i28.i.i121 = icmp eq ptr %i.fe, null
...
bb.aq:                                            ; preds = %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit27.i.i120
  %i.fu = load ptr, ptr %i.dr, align 8, !tbaa !64
  %i.fv = ptrtoint ptr %i.fu to i64
  %i.fw = sub i64 %i.fv, %i.fg
  call void @_ZdlPvm(ptr noundef nonnull %i.fe, i64 noundef %i.fw) #24
...
_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE17_M_realloc_insertIJRiRfEEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i122: ; preds = %bb.aq, %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit27.i.i120
  store ptr %i.fp, ptr %7, align 8, !tbaa !61
  store ptr %i.ft, ptr %i.dq, align 8, !tbaa !169
  %i.fx = getelementptr inbounds nuw [8 x i8], ptr %i.fp, i64 %i.fn
  store ptr %i.fx, ptr %i.dr, align 8, !tbaa !64
  br label %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE12emplace_backIJRiRfEEERS2_DpOT_.exit125
...
_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE12emplace_backIJRiRfEEERS2_DpOT_.exit125: ; preds = %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE17_M_realloc_insertIJRiRfEEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i122, %bb.am
  %i.fy = load ptr, ptr %6, align 8, !tbaa !54    ; 10 uses
  %i.fz = getelementptr inbounds nuw [12 x i8], ptr %i.fy, i64 %i.dt
  %i.ga = getelementptr inbounds nuw i8, ptr %i.fz, i64 4
  %i.gb = load float, ptr %i.ga, align 4, !tbaa !60
  %i.gc = fcmp ult float %i.ez, %i.gb
...
bb.as:                                            ; preds = %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE12emplace_backIJRiRfEEERS2_DpOT_.exit125
  %i.ge = bitcast float %i.ez to i32
  %.sroa.0.sroa.5.0.insert.ext = zext i32 %i.ge to i64
  %.sroa.0.sroa.5.0.insert.shift = shl nuw i64 %.sroa.0.sroa.5.0.insert.ext, 32
  %.sroa.0.sroa.0.0.insert.ext = and i64 %i.ej, 4294967295
  %.sroa.0.sroa.0.0.insert.insert = or disjoint i64 %.sroa.0.sroa.5.0.insert.shift, %.sroa.0.sroa.0.0.insert.ext ; 2 uses
  %i.gf = getelementptr inbounds nuw i8, ptr %i.fy, i64 4
  %i.gg = load float, ptr %i.gf, align 4, !tbaa !60
  %i.gh = fcmp ogt float %i.gg, %i.ez
  br i1 %i.gh, label %bb.at, label %.preheader68.i

bb.at:                                            ; preds = %bb.as
  %i.gi = getelementptr inbounds nuw i8, ptr %i.fy, i64 12
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 4 %i.gi, ptr nonnull align 4 %i.fy, i64 %.idx, i1 false)
  store i64 %.sroa.0.sroa.0.0.insert.insert, ptr %i.fy, align 4
  br label %_ZN5faiss3nsg16insert_into_poolEPNS0_8NeighborEiS1_.exit.sink.split

.preheader68.i:                                   ; preds = %bb.as
  br i1 %i.du, label %.lr.ph.i, label %._crit_edge.i
...
.lr.ph74.i.preheader:                             ; preds = %.preheader.i
  %i.gj = zext nneg i32 %.063..i to i64
  br label %.lr.ph74.i

.lr.ph.i:                                         ; preds = %.preheader68.i, %.lr.ph.i
  %.071.i = phi i32 [ %..0.i, %.lr.ph.i ], [ %i.ds, %.preheader68.i ] ; 2 uses
  %.06370.i = phi i32 [ %.063..i, %.lr.ph.i ], [ 0, %.preheader68.i ] ; 2 uses
  %i.gk = add nuw nsw i32 %.06370.i, %.071.i
  %i.gl = lshr i32 %i.gk, 1                       ; 3 uses
  %i.gm = zext nneg i32 %i.gl to i64
  %i.gn = getelementptr inbounds nuw [12 x i8], ptr %i.fy, i64 %i.gm
  %i.go = getelementptr inbounds nuw i8, ptr %i.gn, i64 4
  %i.gp = load float, ptr %i.go, align 4, !tbaa !60
  %i.gq = fcmp ogt float %i.gp, %i.ez             ; 2 uses
  %.063..i = select i1 %i.gq, i32 %.06370.i, i32 %i.gl ; 4 uses
  %..0.i = select i1 %i.gq, i32 %i.gl, i32 %.071.i ; 5 uses
  %i.gr = add nsw i32 %..0.i, -1
...
.lr.ph74.i:                                       ; preds = %.lr.ph74.i.preheader, %bb.av
  ...
  %i.gv = load float, ptr %i.gu, align 4, !tbaa !60
  %i.gw = fcmp olt float %i.gv, %i.ez
  br i1 %i.gw, label %._crit_edge.i, label %bb.au

bb.au:                                            ; preds = %.lr.ph74.i
  %i.gx = load i32, ptr %i.gt, align 4, !tbaa !57
  %i.gy = icmp eq i32 %i.gx, %i.ek
  br i1 %i.gy, label %_ZN5faiss3nsg16insert_into_poolEPNS0_8NeighborEiS1_.exit, label %bb.av

bb.av:                                            ; preds = %bb.au
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %i.gz = icmp sgt i64 %indvars.iv, 1
  br i1 %i.gz, label %.lr.ph74.i, label %._crit_edge.i, !llvm.loop !79

._crit_edge.i:                                    ; preds = %bb.av, %.lr.ph74.i, %.preheader.i, %.preheader68.i
  %.0.lcssa80.i = phi i32 [ %..0.i, %.preheader.i ], [ %i.ds, %.preheader68.i ], [ %..0.i, %.lr.ph74.i ], [ %..0.i, %bb.av ] ; 3 uses
  %.2.lcssa.i = phi i64 [ 0, %.preheader.i ], [ 0, %.preheader68.i ], [ 0, %bb.av ], [ %indvars.iv, %.lr.ph74.i ]
  %i.ha = getelementptr inbounds [12 x i8], ptr %i.fy, i64 %.2.lcssa.i
  %i.hb = load i32, ptr %i.ha, align 4, !tbaa !57
  %i.hc = icmp eq i32 %i.hb, %i.ek
  br i1 %i.hc, label %_ZN5faiss3nsg16insert_into_poolEPNS0_8NeighborEiS1_.exit, label %bb.aw

bb.aw:                                            ; preds = %._crit_edge.i
  %i.hd = zext nneg i32 %.0.lcssa80.i to i64
  %i.he = getelementptr inbounds nuw [12 x i8], ptr %i.fy, i64 %i.hd ; 5 uses
  %i.hf = load i32, ptr %i.he, align 4, !tbaa !57
  %i.hg = icmp eq i32 %i.hf, %i.ek
  br i1 %i.hg, label %_ZN5faiss3nsg16insert_into_poolEPNS0_8NeighborEiS1_.exit, label %bb.ax

bb.ax:                                            ; preds = %bb.aw
  %i.hh = getelementptr i8, ptr %i.he, i64 12
  %i.hi = sub nsw i32 %5, %.0.lcssa80.i
  %i.hj = sext i32 %i.hi to i64
  %i.hk = mul nsw i64 %i.hj, 12
  call void @llvm.memmove.p0.p0.i64(ptr align 4 %i.hh, ptr nonnull align 4 %i.he, i64 %i.hk, i1 false)
  store i64 %.sroa.0.sroa.0.0.insert.insert, ptr %i.he, align 4
  br label %_ZN5faiss3nsg16insert_into_poolEPNS0_8NeighborEiS1_.exit.sink.split

_ZN5faiss3nsg16insert_into_poolEPNS0_8NeighborEiS1_.exit.sink.split: ; preds = %bb.ax, %bb.at
  %.sink = phi ptr [ %i.fy, %bb.at ], [ %i.he, %bb.ax ]
...
bb.ay:                                            ; preds = %_ZN5faiss3nsg16insert_into_poolEPNS0_8NeighborEiS1_.exit, %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE12emplace_backIJRiRfEEERS2_DpOT_.exit125, %.lr.ph196, %bb.ah
  ...
  %i.hl = add nuw i64 %.088195, 1                 ; 2 uses
  %exitcond208.not = icmp eq i64 %i.hl, %i.ef
...
.loopexit:                                        ; preds = %bb.ay, %.preheader, %bb.ac
  ...
  %i.hm = add nsw i32 %.089198, 1
  %i.hn = select i1 %.not, i32 %i.hm, i32 %.3     ; 2 uses
  %i.ho = icmp slt i32 %i.hn, %5
  br i1 %i.ho, label %bb.ac, label %._crit_edge200, !llvm.loop !177
...
bb.az:                                            ; preds = %._crit_edge200
  %i.hp = ptrtoint ptr %.sroa.13.0 to i64
  %i.hq = ptrtoint ptr %.sroa.0146.0 to i64
  %i.hr = sub i64 %i.hp, %i.hq
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0146.0, i64 noundef %i.hr) #24
  br label %_ZNSt6vectorIlSaIlEED2Ev.exit
...
bb.ba:                                            ; preds = %_ZNSt6vectorIlSaIlEED2Ev.exit
  %i.hs = ptrtoint ptr %.sroa.16.0 to i64
  %i.ht = sub i64 %i.hs, %i.ao
...
bb.bb:                                            ; preds = %.loopexit171, %.loopexit.split-lp172, %bb.af, %bb.ae, %bb.q, %bb.j
  %.pn101 = phi { ptr, i32 } [ %i.eh, %bb.af ], [ %i.bs, %bb.q ], [ %i.eg, %bb.ae ], [ %i.au, %bb.j ], [ %lpad.loopexit173, %.loopexit171 ], [ %lpad.loopexit.split-lp174, %.loopexit.split-lp172 ] ; 2 uses
...
.thread:                                          ; preds = %.loopexit169, %.loopexit.split-lp, %bb.n, %bb.ai, %bb.ar, %bb.bb
  %.pn101166 = phi { ptr, i32 } [ %.pn101, %bb.bb ], [ %i.gd, %bb.ar ], [ %i.bi, %bb.n ], [ %i.er, %bb.ai ], [ %lpad.loopexit, %.loopexit169 ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ]
  %i.hu = ptrtoint ptr %.sroa.13.0 to i64
  %i.hv = ptrtoint ptr %.sroa.0146.0 to i64
  %i.hw = sub i64 %i.hu, %i.hv
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0146.0, i64 noundef %i.hw) #24
...
bb.bc:                                            ; preds = %_ZNSt6vectorIlSaIlEED2Ev.exit129
  %i.hx = ptrtoint ptr %.sroa.16.0 to i64
  %i.hy = ptrtoint ptr %.sroa.0154.0 to i64
  %i.hz = sub i64 %i.hx, %i.hy
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0154.0, i64 noundef %i.hz) #24
...
_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPN5faiss3nsg4NodeESt6vectorIS4_SaIS4_EEEEEvT_SA_.exit: ; preds = %._crit_edge
  ...
  %.pre224 = load ptr, ptr %i.i, align 8, !tbaa !178 ; 2 uses
  %i.s = icmp eq ptr %.pre, %.pre224
...
.preheader:                                       ; preds = %._crit_edge, %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPN5faiss3nsg4NodeESt6vectorIS4_SaIS4_EEEEEvT_SA_.exit
  ...
  br i1 %i.v, label %.lr.ph193, label %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EED2Ev.exit
...
.lr.ph193:                                        ; preds = %.preheader
  ...
  %wide.trip.count222 = zext nneg i32 %i.u to i64 ; 2 uses
  %xtraiter297 = and i64 %wide.trip.count222, 7   ; 3 uses
  %i.ae = icmp ult i32 %i.u, 8
  br i1 %i.ae, label %.epil.preheader296, label %.lr.ph193.new

.lr.ph193.new:                                    ; preds = %.lr.ph193
  %unroll_iter301 = and i64 %wide.trip.count222, 2147483640
  br label %bb.k
...
bb.b:                                             ; preds = %.lr.ph, %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE12emplace_backIJRiRfEEERS2_DpOT_.exit
  ...
  %i.af = phi i32 [ %i.b, %.lr.ph ], [ %i.bw, %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE12emplace_backIJRiRfEEERS2_DpOT_.exit ]
...
begin_hunk_3_@_ZNK5faiss3NSG15search_on_graphILb1EiEEvRKNS_3nsg5GraphIT0_EERNS_16DistanceComputerERNS_12VisitedTableEiiRSt6vectorINS2_8NeighborESaISD_EERSC_INS2_4NodeESaISH_EE:bb.a
  %i.ea = load i32, ptr %i.dw, align 4, !tbaa !57
  %i.eb = load ptr, ptr %1, align 8, !tbaa !15
  %i.ec = getelementptr inbounds nuw i8, ptr %i.eb, i64 16
  %i.ed = load ptr, ptr %i.ec, align 8
  %i.ee = invoke noundef i64 %i.ed(ptr noundef nonnull align 8 dereferenceable(25) %1, i32 noundef %i.ea, ptr noundef %.sroa.0150.0)
          to label %.preheader unwind label %bb.af ; 2 uses

.preheader:                                       ; preds = %bb.ad
  %.not207 = icmp eq i64 %i.ee, 0
...
.lr.ph199:                                        ; preds = %.preheader, %bb.ay
  %.088198 = phi i64 [ %i.hj, %bb.ay ], [ 0, %.preheader ] ; 2 uses
  %.0197 = phi i32 [ %.2, %bb.ay ], [ %5, %.preheader ] ; 4 uses
  %i.eh = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0150.0, i64 %.088198
  %i.ei = load i32, ptr %i.eh, align 4, !tbaa !40 ; 8 uses
  %i.ej = load i32, ptr %0, align 8, !tbaa !24
  %.not95 = icmp slt i32 %i.ei, %i.ej
  br i1 %.not95, label %bb.ag, label %bb.ay

bb.ag:                                            ; preds = %.lr.ph199
  %i.ek = sext i32 %i.ei to i64                   ; 3 uses
  %i.el = load ptr, ptr %3, align 8, !tbaa !15
  %i.em = getelementptr inbounds nuw i8, ptr %i.el, i64 24
  %i.en = load ptr, ptr %i.em, align 8
  %i.eo = invoke noundef zeroext i1 %i.en(ptr noundef nonnull align 8 dereferenceable(8) %3, i64 noundef %i.ek)
          to label %bb.ah unwind label %bb.ai

bb.ah:                                            ; preds = %bb.ag
  br i1 %i.eo, label %bb.ay, label %bb.aj
...
bb.aj:                                            ; preds = %bb.ah
  %i.eq = load ptr, ptr %3, align 8, !tbaa !15
  %i.er = getelementptr inbounds nuw i8, ptr %i.eq, i64 16
  %i.es = load ptr, ptr %i.er, align 8
  %i.et = invoke noundef zeroext i1 %i.es(ptr noundef nonnull align 8 dereferenceable(8) %3, i64 noundef %i.ek)
          to label %bb.ak unwind label %bb.ai     ; 0 uses

bb.ak:                                            ; preds = %bb.aj
  %i.eu = load ptr, ptr %2, align 8, !tbaa !15
  %i.ev = getelementptr inbounds nuw i8, ptr %i.eu, i64 8
  %i.ew = load ptr, ptr %i.ev, align 8
  %i.ex = invoke noundef float %i.ew(ptr noundef nonnull align 8 dereferenceable(8) %2, i64 noundef %i.ek)
          to label %bb.al unwind label %bb.ar     ; 7 uses

bb.al:                                            ; preds = %bb.ak
  %i.ey = load ptr, ptr %i.dp, align 8, !tbaa !169 ; 5 uses
  %i.ez = load ptr, ptr %i.dq, align 8, !tbaa !64
  %.not.i119 = icmp eq ptr %i.ey, %i.ez
  br i1 %.not.i119, label %bb.an, label %bb.am

bb.am:                                            ; preds = %bb.al
  store i32 %i.ei, ptr %i.ey, align 4, !tbaa !146
  %i.fa = getelementptr inbounds nuw i8, ptr %i.ey, i64 4
  store float %i.ex, ptr %i.fa, align 4, !tbaa !174
  %i.fb = getelementptr inbounds nuw i8, ptr %i.ey, i64 8
  store ptr %i.fb, ptr %i.dp, align 8, !tbaa !169
  br label %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE12emplace_backIJRiRfEEERS2_DpOT_.exit128

bb.an:                                            ; preds = %bb.al
  %i.fc = load ptr, ptr %7, align 8, !tbaa !61    ; 4 uses
  ...
  br i1 %i.fg, label %bb.ao, label %_ZNKSt6vectorIN5faiss3nsg4NodeESaIS2_EE12_M_check_lenEmPKc.exit.i.i120
...
_ZNKSt6vectorIN5faiss3nsg4NodeESaIS2_EE12_M_check_lenEmPKc.exit.i.i120: ; preds = %bb.an
  ...
  %.sroa.speculated.i.i.i121 = call i64 @llvm.umax.i64(i64 %i.fh, i64 1)
  %i.fi = add nsw i64 %.sroa.speculated.i.i.i121, %i.fh ; 2 uses
  ...
  %.not.i.i.i122 = icmp ne i64 %i.fl, 0
  call void @llvm.assume(i1 %.not.i.i.i122)
  %i.fm = shl nuw nsw i64 %i.fl, 3
  %i.fn = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.fm) #23
...
.noexc127:                                        ; preds = %_ZNKSt6vectorIN5faiss3nsg4NodeESaIS2_EE12_M_check_lenEmPKc.exit.i.i120
  %i.fo = getelementptr inbounds i8, ptr %i.fn, i64 %i.ff ; 3 uses
  store i32 %i.ei, ptr %i.fo, align 4, !tbaa !146
  %i.fp = getelementptr inbounds nuw i8, ptr %i.fo, i64 4
  store float %i.ex, ptr %i.fp, align 4, !tbaa !174
  %i.fq = icmp sgt i64 %i.ff, 0
  br i1 %i.fq, label %bb.ap, label %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit27.i.i123
...
_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit27.i.i123: ; preds = %bb.ap, %.noexc127
  ...
  %.not.i28.i.i124 = icmp eq ptr %i.fc, null
...
bb.aq:                                            ; preds = %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit27.i.i123
  %i.fs = load ptr, ptr %i.dq, align 8, !tbaa !64
  %i.ft = ptrtoint ptr %i.fs to i64
  %i.fu = sub i64 %i.ft, %i.fe
  call void @_ZdlPvm(ptr noundef nonnull %i.fc, i64 noundef %i.fu) #24
...
_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE17_M_realloc_insertIJRiRfEEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i125: ; preds = %bb.aq, %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit27.i.i123
  store ptr %i.fn, ptr %7, align 8, !tbaa !61
  store ptr %i.fr, ptr %i.dp, align 8, !tbaa !169
  %i.fv = getelementptr inbounds nuw [8 x i8], ptr %i.fn, i64 %i.fl
  store ptr %i.fv, ptr %i.dq, align 8, !tbaa !64
  br label %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE12emplace_backIJRiRfEEERS2_DpOT_.exit128
...
_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE12emplace_backIJRiRfEEERS2_DpOT_.exit128: ; preds = %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE17_M_realloc_insertIJRiRfEEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i125, %bb.am
  %i.fw = load ptr, ptr %6, align 8, !tbaa !54    ; 10 uses
  %i.fx = getelementptr inbounds nuw [12 x i8], ptr %i.fw, i64 %i.ds
  %i.fy = getelementptr inbounds nuw i8, ptr %i.fx, i64 4
  %i.fz = load float, ptr %i.fy, align 4, !tbaa !60
  %i.ga = fcmp ult float %i.ex, %i.fz
...
bb.as:                                            ; preds = %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE12emplace_backIJRiRfEEERS2_DpOT_.exit128
  %i.gc = bitcast float %i.ex to i32
  %.sroa.0.sroa.5.0.insert.ext = zext i32 %i.gc to i64
  %.sroa.0.sroa.5.0.insert.shift = shl nuw i64 %.sroa.0.sroa.5.0.insert.ext, 32
  %.sroa.0.sroa.0.0.insert.ext = zext i32 %i.ei to i64
  %.sroa.0.sroa.0.0.insert.insert = or disjoint i64 %.sroa.0.sroa.5.0.insert.shift, %.sroa.0.sroa.0.0.insert.ext ; 2 uses
  %i.gd = getelementptr inbounds nuw i8, ptr %i.fw, i64 4
  %i.ge = load float, ptr %i.gd, align 4, !tbaa !60
  %i.gf = fcmp ogt float %i.ge, %i.ex
  br i1 %i.gf, label %bb.at, label %.preheader68.i

bb.at:                                            ; preds = %bb.as
  %i.gg = getelementptr inbounds nuw i8, ptr %i.fw, i64 12
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 4 %i.gg, ptr nonnull align 4 %i.fw, i64 %.idx, i1 false)
  store i64 %.sroa.0.sroa.0.0.insert.insert, ptr %i.fw, align 4
  br label %_ZN5faiss3nsg16insert_into_poolEPNS0_8NeighborEiS1_.exit.sink.split
...
.lr.ph74.i.preheader:                             ; preds = %.preheader.i
  %i.gh = zext nneg i32 %.063..i to i64
  br label %.lr.ph74.i

.lr.ph.i:                                         ; preds = %.preheader68.i, %.lr.ph.i
  %.071.i = phi i32 [ %..0.i, %.lr.ph.i ], [ %i.dr, %.preheader68.i ] ; 2 uses
  %.06370.i = phi i32 [ %.063..i, %.lr.ph.i ], [ 0, %.preheader68.i ] ; 2 uses
  %i.gi = add nuw nsw i32 %.06370.i, %.071.i
  %i.gj = lshr i32 %i.gi, 1                       ; 3 uses
  %i.gk = zext nneg i32 %i.gj to i64
  %i.gl = getelementptr inbounds nuw [12 x i8], ptr %i.fw, i64 %i.gk
  %i.gm = getelementptr inbounds nuw i8, ptr %i.gl, i64 4
  %i.gn = load float, ptr %i.gm, align 4, !tbaa !60
  %i.go = fcmp ogt float %i.gn, %i.ex             ; 2 uses
  %.063..i = select i1 %i.go, i32 %.06370.i, i32 %i.gj ; 4 uses
  %..0.i = select i1 %i.go, i32 %i.gj, i32 %.071.i ; 5 uses
  %i.gp = add nsw i32 %..0.i, -1
...
.lr.ph74.i:                                       ; preds = %.lr.ph74.i.preheader, %bb.av
  ...
  %i.gt = load float, ptr %i.gs, align 4, !tbaa !60
  %i.gu = fcmp olt float %i.gt, %i.ex
  br i1 %i.gu, label %._crit_edge.i, label %bb.au

bb.au:                                            ; preds = %.lr.ph74.i
  %i.gv = load i32, ptr %i.gr, align 4, !tbaa !57
  %i.gw = icmp eq i32 %i.gv, %i.ei
  br i1 %i.gw, label %_ZN5faiss3nsg16insert_into_poolEPNS0_8NeighborEiS1_.exit, label %bb.av

bb.av:                                            ; preds = %bb.au
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %i.gx = icmp sgt i64 %indvars.iv, 1
  br i1 %i.gx, label %.lr.ph74.i, label %._crit_edge.i, !llvm.loop !79

._crit_edge.i:                                    ; preds = %bb.av, %.lr.ph74.i, %.preheader.i, %.preheader68.i
  %.0.lcssa80.i = phi i32 [ %..0.i, %.preheader.i ], [ %i.dr, %.preheader68.i ], [ %..0.i, %.lr.ph74.i ], [ %..0.i, %bb.av ] ; 3 uses
  %.2.lcssa.i = phi i64 [ 0, %.preheader.i ], [ 0, %.preheader68.i ], [ 0, %bb.av ], [ %indvars.iv, %.lr.ph74.i ]
  %i.gy = getelementptr inbounds [12 x i8], ptr %i.fw, i64 %.2.lcssa.i
  %i.gz = load i32, ptr %i.gy, align 4, !tbaa !57
  %i.ha = icmp eq i32 %i.gz, %i.ei
  br i1 %i.ha, label %_ZN5faiss3nsg16insert_into_poolEPNS0_8NeighborEiS1_.exit, label %bb.aw

bb.aw:                                            ; preds = %._crit_edge.i
  %i.hb = zext nneg i32 %.0.lcssa80.i to i64
  %i.hc = getelementptr inbounds nuw [12 x i8], ptr %i.fw, i64 %i.hb ; 5 uses
  %i.hd = load i32, ptr %i.hc, align 4, !tbaa !57
  %i.he = icmp eq i32 %i.hd, %i.ei
  br i1 %i.he, label %_ZN5faiss3nsg16insert_into_poolEPNS0_8NeighborEiS1_.exit, label %bb.ax

bb.ax:                                            ; preds = %bb.aw
  %i.hf = getelementptr i8, ptr %i.hc, i64 12
  %i.hg = sub nsw i32 %5, %.0.lcssa80.i
  %i.hh = sext i32 %i.hg to i64
  %i.hi = mul nsw i64 %i.hh, 12
  call void @llvm.memmove.p0.p0.i64(ptr align 4 %i.hf, ptr nonnull align 4 %i.hc, i64 %i.hi, i1 false)
  store i64 %.sroa.0.sroa.0.0.insert.insert, ptr %i.hc, align 4
  br label %_ZN5faiss3nsg16insert_into_poolEPNS0_8NeighborEiS1_.exit.sink.split

_ZN5faiss3nsg16insert_into_poolEPNS0_8NeighborEiS1_.exit.sink.split: ; preds = %bb.ax, %bb.at
  %.sink = phi ptr [ %i.fw, %bb.at ], [ %i.hc, %bb.ax ]
  %.065.i.ph = phi i32 [ 0, %bb.at ], [ %.0.lcssa80.i, %bb.ax ]
  %.sroa.12.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %.sink, i64 8
  store i8 1, ptr %.sroa.12.0..sroa_idx.i, align 4, !tbaa !75
  br label %_ZN5faiss3nsg16insert_into_poolEPNS0_8NeighborEiS1_.exit
...
bb.ay:                                            ; preds = %_ZN5faiss3nsg16insert_into_poolEPNS0_8NeighborEiS1_.exit, %_ZNSt6vectorIN5faiss3nsg4NodeESaIS2_EE12emplace_backIJRiRfEEERS2_DpOT_.exit128, %.lr.ph199, %bb.ah
  ...
  %i.hj = add nuw i64 %.088198, 1                 ; 2 uses
  %exitcond211.not = icmp eq i64 %i.hj, %i.ee
  br i1 %exitcond211.not, label %.loopexit, label %.lr.ph199, !llvm.loop !238

.loopexit:                                        ; preds = %bb.ay, %.preheader, %bb.ac
  %.3 = phi i32 [ %5, %bb.ac ], [ %5, %.preheader ], [ %.2, %bb.ay ] ; 2 uses
  %.not = icmp sgt i32 %.3, %.089201
  %i.hk = add nsw i32 %.089201, 1
  %i.hl = select i1 %.not, i32 %i.hk, i32 %.3     ; 2 uses
  %i.hm = icmp slt i32 %i.hl, %5
  br i1 %i.hm, label %bb.ac, label %._crit_edge203, !llvm.loop !239
...
bb.az:                                            ; preds = %._crit_edge203
  %i.hn = ptrtoint ptr %.sroa.13.0 to i64
  %i.ho = ptrtoint ptr %.sroa.0150.0 to i64
  %i.hp = sub i64 %i.hn, %i.ho
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0150.0, i64 noundef %i.hp) #24
  br label %_ZNSt6vectorIiSaIiEED2Ev.exit
...
bb.ba:                                            ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit
  %i.hq = ptrtoint ptr %.sroa.16.0 to i64
  %i.hr = sub i64 %i.hq, %i.ao
...
bb.bb:                                            ; preds = %.loopexit174, %.loopexit.split-lp175, %bb.af, %bb.ae, %bb.q, %bb.j
  %.pn100 = phi { ptr, i32 } [ %i.eg, %bb.af ], [ %i.br, %bb.q ], [ %i.ef, %bb.ae ], [ %i.au, %bb.j ], [ %lpad.loopexit176, %.loopexit174 ], [ %lpad.loopexit.split-lp177, %.loopexit.split-lp175 ] ; 2 uses
...
.thread:                                          ; preds = %.loopexit172, %.loopexit.split-lp, %bb.n, %bb.ai, %bb.ar, %bb.bb
  %.pn100170 = phi { ptr, i32 } [ %.pn100, %bb.bb ], [ %i.gb, %bb.ar ], [ %i.bh, %bb.n ], [ %i.ep, %bb.ai ], [ %lpad.loopexit, %.loopexit172 ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ]
  %i.hs = ptrtoint ptr %.sroa.13.0 to i64
  %i.ht = ptrtoint ptr %.sroa.0150.0 to i64
  %i.hu = sub i64 %i.hs, %i.ht
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0150.0, i64 noundef %i.hu) #24
...
bb.bc:                                            ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit133
  %i.hv = ptrtoint ptr %.sroa.16.0 to i64
  %i.hw = ptrtoint ptr %.sroa.0158.0 to i64
  %i.hx = sub i64 %i.hv, %i.hw
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0158.0, i64 noundef %i.hx) #24
