...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.jk = shufflevector <4 x float> %i.gd, <4 x float> %i.gp, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.jl = shufflevector <4 x float> %i.cp, <4 x float> %i.db, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.jm = shufflevector <4 x float> %i.hb, <4 x float> %i.hn, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.jn = shufflevector <4 x float> %i.dn, <4 x float> %i.dz, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.jo = shufflevector <4 x float> %i.hz, <4 x float> %i.il, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.jp = shufflevector <4 x float> %i.el, <4 x float> %i.ex, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.jq = shufflevector <4 x float> %i.ix, <4 x float> %i.jj, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %interleaved.vec = shufflevector <16 x float> %i.ju, <16 x float> %i.jx, <32 x i32> <i32 0, i32 4, i32 8, i32 12, i32 16, i32 20, i32 24, i32 28, i32 1, i32 5, i32 9, i32 13, i32 17, i32 21, i32 25, i32 29, i32 2, i32 6, i32 10, i32 14, i32 18, i32 22, i32 26, i32 30, i32 3, i32 7, i32 11, i32 15, i32 19, i32 23, i32 27, i32 31>
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader110
  ...
  %i.ka = load <4 x float>, ptr %.03679.ph, align 1
  %i.kb = load <4 x float>, ptr %.03580.ph, align 1
  %i.kc = insertelement <4 x float> poison, float %2, i64 0
  %i.kd = shufflevector <4 x float> %i.kc, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %i.ke = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.kd, <4 x float> %i.kb, <4 x float> %i.ka)
  %.sroa.7.0..034.sroa_idx.prol = getelementptr inbounds nuw i8, ptr %.03481.ph, i64 16
  %i.kf = load <4 x float>, ptr %.sroa.770.0..036.sroa_idx.prol, align 1
  %i.kg = load <4 x float>, ptr %.sroa.762.0..035.sroa_idx.prol, align 1
  %i.kh = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.kd, <4 x float> %i.kg, <4 x float> %i.kf)
  store <4 x float> %i.ke, ptr %.03481.ph, align 1
  store <4 x float> %i.kh, ptr %.sroa.7.0..034.sroa_idx.prol, align 1
  %i.ki = getelementptr inbounds nuw i8, ptr %.03481.ph, i64 32
  %i.kj = getelementptr inbounds nuw i8, ptr %.03679.ph, i64 32
  %i.kk = getelementptr inbounds nuw i8, ptr %.03580.ph, i64 32
  %i.kl = or disjoint i64 %.082.ph, 1
  br label %.lr.ph.prol.loopexit

.lr.ph.prol.loopexit:                             ; preds = %.lr.ph.prol, %.lr.ph.preheader110
  %.082.unr = phi i64 [ %.082.ph, %.lr.ph.preheader110 ], [ %i.kl, %.lr.ph.prol ]
  %.03481.unr = phi ptr [ %.03481.ph, %.lr.ph.preheader110 ], [ %i.ki, %.lr.ph.prol ]
  %.03580.unr = phi ptr [ %.03580.ph, %.lr.ph.preheader110 ], [ %i.kk, %.lr.ph.prol ]
  %.03679.unr = phi ptr [ %.03679.ph, %.lr.ph.preheader110 ], [ %i.kj, %.lr.ph.prol ]
  %i.km = icmp eq i64 %i.bx, %.neg
  br i1 %i.km, label %._crit_edge, label %.lr.ph.preheader110.new

.lr.ph.preheader110.new:                          ; preds = %.lr.ph.prol.loopexit
  %i.kn = insertelement <4 x float> poison, float %2, i64 0
  %i.ko = shufflevector <4 x float> %i.kn, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %i.kp = insertelement <4 x float> poison, float %2, i64 0
  %i.kq = shufflevector <4 x float> %i.kp, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  br label %.lr.ph
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader110.new
  %.082 = phi i64 [ %.082.unr, %.lr.ph.preheader110.new ], [ %i.lj, %.lr.ph ]
  %.03481 = phi ptr [ %.03481.unr, %.lr.ph.preheader110.new ], [ %i.lg, %.lr.ph ] ; 5 uses
  %.03580 = phi ptr [ %.03580.unr, %.lr.ph.preheader110.new ], [ %i.li, %.lr.ph ] ; 5 uses
  %.03679 = phi ptr [ %.03679.unr, %.lr.ph.preheader110.new ], [ %i.lh, %.lr.ph ] ; 5 uses
  ...
  %i.kr = load <4 x float>, ptr %.03679, align 1
  %i.ks = load <4 x float>, ptr %.03580, align 1
  %i.kt = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ko, <4 x float> %i.ks, <4 x float> %i.kr)
  %.sroa.7.0..034.sroa_idx = getelementptr inbounds nuw i8, ptr %.03481, i64 16
  %i.ku = load <4 x float>, ptr %.sroa.770.0..036.sroa_idx, align 1
  %i.kv = load <4 x float>, ptr %.sroa.762.0..035.sroa_idx, align 1
  %i.kw = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ko, <4 x float> %i.kv, <4 x float> %i.ku)
  store <4 x float> %i.kt, ptr %.03481, align 1
  store <4 x float> %i.kw, ptr %.sroa.7.0..034.sroa_idx, align 1
  %i.kx = getelementptr inbounds nuw i8, ptr %.03481, i64 32
  %i.ky = getelementptr inbounds nuw i8, ptr %.03679, i64 32
  %i.kz = getelementptr inbounds nuw i8, ptr %.03580, i64 32
  ...
  %i.la = load <4 x float>, ptr %i.ky, align 1
  %i.lb = load <4 x float>, ptr %i.kz, align 1
  %i.lc = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.kq, <4 x float> %i.lb, <4 x float> %i.la)
  %.sroa.7.0..034.sroa_idx.1 = getelementptr inbounds nuw i8, ptr %.03481, i64 48
  %i.ld = load <4 x float>, ptr %.sroa.770.0..036.sroa_idx.1, align 1
  %i.le = load <4 x float>, ptr %.sroa.762.0..035.sroa_idx.1, align 1
  %i.lf = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.kq, <4 x float> %i.le, <4 x float> %i.ld)
  store <4 x float> %i.lc, ptr %i.kx, align 1
  store <4 x float> %i.lf, ptr %.sroa.7.0..034.sroa_idx.1, align 1
  %i.lg = getelementptr inbounds nuw i8, ptr %.03481, i64 64
  %i.lh = getelementptr inbounds nuw i8, ptr %.03679, i64 64
  %i.li = getelementptr inbounds nuw i8, ptr %.03580, i64 64
  %i.lj = add nuw nsw i64 %.082, 2                ; 2 uses
  %exitcond.not.1 = icmp eq i64 %i.lj, %i.bx
