...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %9 = shufflevector <4 x float> %i.cp, <4 x float> %i.db, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %10 = shufflevector <4 x float> %i.dn, <4 x float> %i.dz, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %12 = shufflevector <4 x float> %i.el, <4 x float> %i.ex, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %13 = shufflevector <4 x float> %i.fj, <4 x float> %i.fv, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %14 = shufflevector <8 x float> %12, <8 x float> %13, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  ...
  %15 = shufflevector <4 x float> %i.gd, <4 x float> %i.gp, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %16 = shufflevector <4 x float> %i.hb, <4 x float> %i.hn, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %17 = shufflevector <8 x float> %15, <8 x float> %16, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  ...
  %18 = shufflevector <4 x float> %i.hz, <4 x float> %i.il, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %i.jk = shufflevector <4 x float> %i.ix, <4 x float> %i.jj, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.jl = shufflevector <8 x float> %18, <8 x float> %i.jk, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.jm = tail call <16 x float> @llvm.fmuladd.v16f32(<16 x float> %i.cd, <16 x float> %17, <16 x float> %11)
  %i.jn = tail call <16 x float> @llvm.fmuladd.v16f32(<16 x float> %i.cd, <16 x float> %i.jl, <16 x float> %14)
