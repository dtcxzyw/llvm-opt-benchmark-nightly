...
.lr.ph.preheader:                                 ; preds = %bb.a
  ...
  %4 = load <3 x float>, ptr %i.a, align 4, !tbaa !99 ; 3 uses
  ...
  %i.q = shufflevector <10 x float> %i.g, <10 x float> poison, <4 x i32> zeroinitializer
  %5 = shufflevector <3 x float> %4, <3 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %6 = shufflevector <3 x float> %4, <3 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.r = shufflevector <3 x float> %4, <3 x float> poison, <4 x i32> zeroinitializer
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.kn = fmul fast <4 x float> %i.km, %6
  ...
  %i.kt = fmul fast <4 x float> %i.ks, %5
  ...
  %i.md = fmul fast <4 x float> %i.mc, %i.q
...
.lr.ph.preheader:                                 ; preds = %bb.a
  ...
  %i.b = load <2 x float>, ptr %0, align 4, !tbaa !99 ; 2 uses
  %i.c = shufflevector <2 x float> %i.b, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %5 = load <3 x float>, ptr %i.a, align 4, !tbaa !99 ; 3 uses
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 20
  %i.e = load float, ptr %i.d, align 4, !tbaa !99
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.g = load <10 x float>, ptr %i.f, align 4, !tbaa !99 ; 10 uses
  ...
  %i.p = shufflevector <10 x float> %i.g, <10 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.q = shufflevector <10 x float> %i.g, <10 x float> poison, <4 x i32> zeroinitializer
  %6 = shufflevector <3 x float> %5, <3 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %7 = shufflevector <3 x float> %5, <3 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.r = shufflevector <3 x float> %5, <3 x float> poison, <4 x i32> zeroinitializer
  %i.s = shufflevector <2 x float> %i.b, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 1, i32 0>
  %i.t = insertelement <4 x float> poison, float %i.e, i64 0
  %i.u = shufflevector <4 x float> %i.t, <4 x float> poison, <4 x i32> zeroinitializer
  br label %.lr.ph
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.bu = fmul fast <4 x float> %i.bt, %7
  ...
  %i.ca = fmul fast <4 x float> %i.bz, %6
  ...
  %i.dk = fmul fast <4 x float> %i.dj, %i.q
