...
_ZNSt10unique_ptrIN5faiss10CodePackerESt14default_deleteIS1_EED2Ev.exit: ; preds = %bb.q
  ...
  %i.da = load ptr, ptr %i.ar, align 8, !tbaa !15
  %i.db = getelementptr inbounds nuw i8, ptr %i.da, i64 48
  %i.dc = load ptr, ptr %i.db, align 8
  call void %i.dc(ptr noundef nonnull align 8 dereferenceable(32) %i.ar) #18, !inline_history !201
  %i.dd = load ptr, ptr %i.aj, align 8, !tbaa !15
...
bb.t:                                             ; preds = %bb.d, %_ZN5faiss13InvertedLists11ScopedCodesD2Ev.exit
  ...
  %i.dj = load i64, ptr %i.d, align 8, !tbaa !23
...
; Function Attrs: nounwind
declare !callback !159 void @__kmpc_fork_call(ptr, i32, ptr, ...) local_unnamed_addr #18
...
bb.a:
  ...
  %i.f = load i32, ptr %i.e, align 8, !tbaa !60   ; 3 uses
...
.noexc58:                                         ; preds = %bb.b
  ...
  store float 0.000000e+00, ptr %i.j, align 4, !tbaa !64
...
_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i: ; preds = %.noexc58
  ...
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.n, i8 0, i64 %.idx.i.i.i.i.i.i.i, i1 false), !tbaa !64
...
_ZNSt6vectorIfSaIfEEC2EmRKS0_.exit:               ; preds = %_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i, %.noexc58, %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i
  ...
  %.sroa.074.0116 = ptrtoaddr ptr %.sroa.074.0 to i64
  %i.o = load i64, ptr %3, align 8, !tbaa !23     ; 2 uses
  %i.p = icmp sgt i64 %i.o, 0
  %.pre99 = load i32, ptr %0, align 4, !tbaa !66  ; 3 uses
...
bb.c:                                             ; preds = %_ZNSt6vectorIfSaIfEEC2EmRKS0_.exit
  ...
  store i64 %i.q, ptr %i.b, align 8, !tbaa !23
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #18
  store i64 1, ptr %i.c, align 8, !tbaa !23
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d) #18
  store i32 0, ptr %i.d, align 4, !tbaa !66
  call void @__kmpc_for_static_init_8(ptr nonnull @1, i32 %.pre99, i32 34, ptr nonnull %i.d, ptr nonnull %i.a, ptr nonnull %i.b, ptr nonnull %i.c, i64 1, i64 1)
  %i.r = load i64, ptr %i.b, align 8, !tbaa !23
  %i.s = call i64 @llvm.smin.i64(i64 %i.r, i64 %i.q) ; 2 uses
  store i64 %i.s, ptr %i.b, align 8, !tbaa !23
  %i.t = load i64, ptr %i.a, align 8, !tbaa !23   ; 3 uses
  %.not90 = icmp sgt i64 %i.t, %i.s
...
bb.d:                                             ; preds = %.lr.ph93, %bb.p
  %indvar = phi i64 [ 0, %.lr.ph93 ], [ %indvar.next, %bb.p ] ; 2 uses
  %.05391 = phi i64 [ %i.t, %.lr.ph93 ], [ %i.en, %bb.p ] ; 5 uses
  %12 = add i64 %i.t, %indvar
  %i.x = shl i64 %12, 2
  %i.y = load ptr, ptr %4, align 8, !tbaa !67
  %i.z = getelementptr inbounds [8 x i8], ptr %i.y, i64 %.05391
  %i.aa = load i64, ptr %i.z, align 8, !tbaa !23  ; 3 uses
  %i.ab = icmp sgt i64 %i.aa, -1
  br i1 %i.ab, label %bb.e, label %bb.p

bb.e:                                             ; preds = %bb.d
  %i.ac = load ptr, ptr %5, align 8, !tbaa !26    ; 2 uses
  %i.ad = ptrtoaddr ptr %i.ac to i64
  %i.ae = load i32, ptr %i.e, align 8, !tbaa !60
  %i.af = sext i32 %i.ae to i64                   ; 2 uses
  %i.ag = mul nsw i64 %.05391, %i.af
  %i.ah = getelementptr inbounds [4 x i8], ptr %i.ac, i64 %i.ag ; 8 uses
  %i.ai = load ptr, ptr %6, align 8, !tbaa !24
  %i.aj = load i64, ptr %7, align 8, !tbaa !23
  %i.ak = mul i64 %i.aj, %.05391
  %i.al = getelementptr inbounds nuw i8, ptr %i.ai, i64 %i.ak ; 2 uses
  %i.am = load i64, ptr %8, align 8, !tbaa !23
  %i.an = getelementptr inbounds nuw i8, ptr %i.al, i64 %i.am ; 3 uses
  %i.ao = load ptr, ptr %i.u, align 8, !tbaa !143 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  %i.as = load i32, ptr %i.e, align 8, !tbaa !60  ; 3 uses
...
._crit_edge:                                      ; preds = %bb.h, %bb.f
  ...
  %i.aw = load i32, ptr %i.v, align 8, !tbaa !208
  %i.ax = load i64, ptr %9, align 8, !tbaa !23
...
.lr.ph:                                           ; preds = %bb.f, %bb.h
  ...
  %.05485 = phi i64 [ %i.bh, %bb.h ], [ 0, %bb.f ] ; 4 uses
  %i.bb = getelementptr inbounds nuw [4 x i8], ptr %i.ah, i64 %.05485
  %i.bc = load float, ptr %i.bb, align 4, !tbaa !64
  %i.bd = getelementptr inbounds nuw [4 x i8], ptr %.sroa.074.0, i64 %.05485
  %i.be = load float, ptr %i.bd, align 4, !tbaa !64
  %i.bf = fcmp ogt float %i.bc, %i.be
  br i1 %i.bf, label %bb.g, label %bb.h

bb.g:                                             ; preds = %.lr.ph
  invoke void @_ZN5faiss12rabitq_utils16set_bit_fastscanEPhm(ptr noundef %i.an, i64 noundef %.05485)
          to label %._crit_edge98 unwind label %.loopexit

._crit_edge98:                                    ; preds = %bb.g
  %.pre = load i32, ptr %i.e, align 8, !tbaa !60
  br label %bb.h

bb.h:                                             ; preds = %._crit_edge98, %.lr.ph
  %i.bg = phi i32 [ %.pre, %._crit_edge98 ], [ %i.ba, %.lr.ph ] ; 2 uses
  %i.bh = add nuw i64 %.05485, 1                  ; 2 uses
  %i.bi = sext i32 %i.bg to i64                   ; 2 uses
  %i.bj = icmp ult i64 %i.bh, %i.bi
  br i1 %i.bj, label %.lr.ph, label %._crit_edge, !llvm.loop !204

bb.i:                                             ; preds = %._crit_edge
  %.fca.0.extract = extractvalue { <2 x float>, float } %i.az, 0 ; 2 uses
  %i.bk = load i64, ptr %9, align 8, !tbaa !23
...
bb.k:                                             ; preds = %bb.i
  ...
  %i.bo = load i32, ptr %i.e, align 8, !tbaa !60  ; 3 uses
...
_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i59: ; preds = %bb.k
  ...
  br i1 %.not.i.i.i.i60, label %._crit_edge88, label %bb.l
...
bb.l:                                             ; preds = %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i59
  ...
  %i.bs = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.br) #34
          to label %.noexc66 unwind label %.loopexit.split-lp.loopexit ; 14 uses

.noexc66:                                         ; preds = %bb.l
  %i.bt = ptrtoaddr ptr %i.bs to i64              ; 2 uses
  %i.bu = getelementptr inbounds nuw [4 x i8], ptr %i.bs, i64 %i.bp ; 4 uses
  store float 0.000000e+00, ptr %i.bs, align 4, !tbaa !64
  %i.bv = add nsw i64 %i.bp, -1                   ; 2 uses
  %i.bw = icmp eq i64 %i.bv, 0
  br i1 %i.bw, label %_ZNSt6vectorIfSaIfEEC2EmRKS0_.exit67, label %_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i61
...
_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i61: ; preds = %.noexc66
  ...
  call void @llvm.memset.p0.i64(ptr align 4 %i.bx, i8 0, i64 %.idx.i.i.i.i.i.i.i62, i1 false), !tbaa !64
  br label %_ZNSt6vectorIfSaIfEEC2EmRKS0_.exit67

_ZNSt6vectorIfSaIfEEC2EmRKS0_.exit67:             ; preds = %_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i61, %.noexc66
  %.pr = load i32, ptr %i.e, align 8, !tbaa !60   ; 4 uses
  %i.by = sext i32 %.pr to i64                    ; 8 uses
  %.not96 = icmp eq i32 %.pr, 0
  br i1 %.not96, label %._crit_edge88, label %.lr.ph87.preheader

.lr.ph87.preheader:                               ; preds = %_ZNSt6vectorIfSaIfEEC2EmRKS0_.exit67
  %min.iters.check = icmp ult i32 %.pr, 8
  br i1 %min.iters.check, label %.lr.ph87.preheader121, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph87.preheader
  %i.bz = mul i64 %i.x, %i.af
  %i.ca = add i64 %i.bz, %i.ad
  %i.cb = sub i64 %i.ca, %i.bt
  %diff.check = icmp ugt i64 %i.cb, -32
  %i.cc = sub i64 %.sroa.074.0116, %i.bt
  %diff.check117 = icmp ugt i64 %i.cc, -32
  %conflict.rdx = or i1 %diff.check, %diff.check117
  br i1 %conflict.rdx, label %.lr.ph87.preheader121, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.cd = getelementptr inbounds nuw [4 x i8], ptr %i.ah, i64 %index ; 2 uses
  %i.ce = getelementptr inbounds nuw i8, ptr %i.cd, i64 16
  %wide.load = load <4 x float>, ptr %i.cd, align 4, !tbaa !64
  %wide.load118 = load <4 x float>, ptr %i.ce, align 4, !tbaa !64
  %i.cf = getelementptr inbounds nuw [4 x i8], ptr %.sroa.074.0, i64 %index ; 2 uses
  %i.cg = getelementptr inbounds nuw i8, ptr %i.cf, i64 16
  %wide.load119 = load <4 x float>, ptr %i.cf, align 4, !tbaa !64
  %wide.load120 = load <4 x float>, ptr %i.cg, align 4, !tbaa !64
  %i.ch = fsub <4 x float> %wide.load, %wide.load119
  %i.ci = fsub <4 x float> %wide.load118, %wide.load120
  %i.cj = getelementptr inbounds nuw [4 x i8], ptr %i.bs, i64 %index ; 2 uses
  %i.ck = getelementptr inbounds nuw i8, ptr %i.cj, i64 16
  store <4 x float> %i.ch, ptr %i.cj, align 4, !tbaa !64
  store <4 x float> %i.ci, ptr %i.ck, align 4, !tbaa !64
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.cl = icmp eq i64 %index.next, %n.vec
  br i1 %i.cl, label %middle.block, label %vector.body, !llvm.loop !205

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.vec, %i.by
  br i1 %cmp.n, label %._crit_edge88, label %.lr.ph87.preheader121

.lr.ph87.preheader121:                            ; preds = %vector.memcheck, %.lr.ph87.preheader, %middle.block
  %.086.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %.lr.ph87.preheader ], [ %n.vec, %middle.block ] ; 3 uses
  %xtraiter = and i64 %i.by, 3
  %i.cm = and i32 %.pr, 3
  %lcmp.mod.not = icmp eq i32 %i.cm, 0
  br i1 %lcmp.mod.not, label %.lr.ph87.prol.loopexit, label %.lr.ph87.prol

.lr.ph87.prol:                                    ; preds = %.lr.ph87.preheader121, %.lr.ph87.prol
  %.086.prol = phi i64 [ %i.ct, %.lr.ph87.prol ], [ %.086.ph, %.lr.ph87.preheader121 ] ; 4 uses
  %prol.iter = phi i64 [ %prol.iter.next, %.lr.ph87.prol ], [ 0, %.lr.ph87.preheader121 ]
  %i.cn = getelementptr inbounds nuw [4 x i8], ptr %i.ah, i64 %.086.prol
  %i.co = load float, ptr %i.cn, align 4, !tbaa !64
  %i.cp = getelementptr inbounds nuw [4 x i8], ptr %.sroa.074.0, i64 %.086.prol
  %i.cq = load float, ptr %i.cp, align 4, !tbaa !64
  %i.cr = fsub float %i.co, %i.cq
  %i.cs = getelementptr inbounds nuw [4 x i8], ptr %i.bs, i64 %.086.prol
  store float %i.cr, ptr %i.cs, align 4, !tbaa !64
  %i.ct = add nuw i64 %.086.prol, 1               ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph87.prol.loopexit, label %.lr.ph87.prol, !llvm.loop !206

.lr.ph87.prol.loopexit:                           ; preds = %.lr.ph87.prol, %.lr.ph87.preheader121
  %.086.unr = phi i64 [ %.086.ph, %.lr.ph87.preheader121 ], [ %i.ct, %.lr.ph87.prol ]
  %i.cu = sub nsw i64 %.086.ph, %i.by
  %i.cv = icmp ugt i64 %i.cu, -4
  br i1 %i.cv, label %._crit_edge88, label %.lr.ph87

._crit_edge88:                                    ; preds = %.lr.ph87.prol.loopexit, %.lr.ph87, %middle.block, %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i59, %_ZNSt6vectorIfSaIfEEC2EmRKS0_.exit67
  %i.cw = phi i64 [ 0, %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i59 ], [ 0, %_ZNSt6vectorIfSaIfEEC2EmRKS0_.exit67 ], [ %i.by, %middle.block ], [ %i.by, %.lr.ph87 ], [ %i.by, %.lr.ph87.prol.loopexit ] ; 2 uses
  %.sroa.9.0113 = phi ptr [ null, %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i59 ], [ %i.bu, %_ZNSt6vectorIfSaIfEEC2EmRKS0_.exit67 ], [ %i.bu, %middle.block ], [ %i.bu, %.lr.ph87 ], [ %i.bu, %.lr.ph87.prol.loopexit ]
  %.sroa.070.0112 = phi ptr [ null, %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i59 ], [ %i.bs, %_ZNSt6vectorIfSaIfEEC2EmRKS0_.exit67 ], [ %i.bs, %middle.block ], [ %i.bs, %.lr.ph87 ], [ %i.bs, %.lr.ph87.prol.loopexit ] ; 4 uses
  %i.cx = load i64, ptr %9, align 8, !tbaa !23
  %i.cy = getelementptr inbounds nuw i8, ptr %i.bn, i64 12 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %11) #18
  store <2 x float> zeroinitializer, ptr %11, align 8, !tbaa !64
  %i.cz = load i64, ptr %i.w, align 8, !tbaa !74
  %i.da = load i32, ptr %i.v, align 8, !tbaa !208
  invoke void @_ZN5faiss15rabitq_multibit16quantize_ex_bitsEPKfmmPhRNS_12rabitq_utils16ExtraBitsFactorsENS_10MetricTypeES2_(ptr noundef %.sroa.070.0112, i64 noundef %i.cw, i64 noundef %i.cz, ptr noundef nonnull %i.cy, ptr noundef nonnull align 1 dereferenceable(8) %11, i32 noundef %i.da, ptr noundef %.sroa.074.0)
          to label %bb.m unwind label %.loopexit.split-lp.loopexit

.lr.ph87:                                         ; preds = %.lr.ph87.prol.loopexit, %.lr.ph87
  %.086 = phi i64 [ %i.ec, %.lr.ph87 ], [ %.086.unr, %.lr.ph87.prol.loopexit ] ; 7 uses
  %i.db = getelementptr inbounds nuw [4 x i8], ptr %i.ah, i64 %.086
  %i.dc = load float, ptr %i.db, align 4, !tbaa !64
  %i.dd = getelementptr inbounds nuw [4 x i8], ptr %.sroa.074.0, i64 %.086
  %i.de = load float, ptr %i.dd, align 4, !tbaa !64
  %i.df = fsub float %i.dc, %i.de
  %i.dg = getelementptr inbounds nuw [4 x i8], ptr %i.bs, i64 %.086
  store float %i.df, ptr %i.dg, align 4, !tbaa !64
  %i.dh = add nuw i64 %.086, 1                    ; 3 uses
  %i.di = getelementptr inbounds nuw [4 x i8], ptr %i.ah, i64 %i.dh
  %i.dj = load float, ptr %i.di, align 4, !tbaa !64
  %i.dk = getelementptr inbounds nuw [4 x i8], ptr %.sroa.074.0, i64 %i.dh
  %i.dl = load float, ptr %i.dk, align 4, !tbaa !64
  %i.dm = fsub float %i.dj, %i.dl
  %i.dn = getelementptr inbounds nuw [4 x i8], ptr %i.bs, i64 %i.dh
  store float %i.dm, ptr %i.dn, align 4, !tbaa !64
  %i.do = add nuw i64 %.086, 2                    ; 3 uses
  %i.dp = getelementptr inbounds nuw [4 x i8], ptr %i.ah, i64 %i.do
  %i.dq = load float, ptr %i.dp, align 4, !tbaa !64
  %i.dr = getelementptr inbounds nuw [4 x i8], ptr %.sroa.074.0, i64 %i.do
  %i.ds = load float, ptr %i.dr, align 4, !tbaa !64
  %i.dt = fsub float %i.dq, %i.ds
  %i.du = getelementptr inbounds nuw [4 x i8], ptr %i.bs, i64 %i.do
  store float %i.dt, ptr %i.du, align 4, !tbaa !64
  %i.dv = add nuw i64 %.086, 3                    ; 3 uses
  %i.dw = getelementptr inbounds nuw [4 x i8], ptr %i.ah, i64 %i.dv
  %i.dx = load float, ptr %i.dw, align 4, !tbaa !64
  %i.dy = getelementptr inbounds nuw [4 x i8], ptr %.sroa.074.0, i64 %i.dv
  %i.dz = load float, ptr %i.dy, align 4, !tbaa !64
  %i.ea = fsub float %i.dx, %i.dz
  %i.eb = getelementptr inbounds nuw [4 x i8], ptr %i.bs, i64 %i.dv
  store float %i.ea, ptr %i.eb, align 4, !tbaa !64
  %i.ec = add nuw i64 %.086, 4                    ; 2 uses
  %exitcond.not.3 = icmp eq i64 %i.ec, %i.by
  br i1 %exitcond.not.3, label %._crit_edge88, label %.lr.ph87, !llvm.loop !207

bb.m:                                             ; preds = %._crit_edge88
  %i.ed = mul i64 %i.cx, %i.cw
  %i.ee = add i64 %i.ed, 7
  %i.ef = lshr i64 %i.ee, 3
  %i.eg = getelementptr inbounds nuw i8, ptr %i.cy, i64 %i.ef
  %i.eh = load i64, ptr %11, align 8
  store i64 %i.eh, ptr %i.eg, align 1
  call void @llvm.lifetime.end.p0(ptr nonnull %11) #18
  %.not.i.i.i = icmp eq ptr %.sroa.070.0112, null
  br i1 %.not.i.i.i, label %_ZNSt6vectorIfSaIfEED2Ev.exit, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.ei = ptrtoint ptr %.sroa.9.0113 to i64
  %i.ej = ptrtoint ptr %.sroa.070.0112 to i64
  %i.ek = sub i64 %i.ei, %i.ej
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.070.0112, i64 noundef %i.ek) #32
  br label %_ZNSt6vectorIfSaIfEED2Ev.exit

_ZNSt6vectorIfSaIfEED2Ev.exit:                    ; preds = %bb.n, %bb.m, %bb.j
  %i.el = load i8, ptr %10, align 1, !tbaa !68, !range !32, !noundef !33
...
bb.p:                                             ; preds = %_ZNSt6vectorIfSaIfEED2Ev.exit, %bb.o, %bb.d
  %i.en = add nsw i64 %.05391, 1
  %i.eo = load i64, ptr %i.b, align 8, !tbaa !23
  %.not.not = icmp slt i64 %.05391, %i.eo
  %indvar.next = add i64 %indvar, 1
  br i1 %.not.not, label %bb.d, label %._crit_edge94

._crit_edge94:                                    ; preds = %bb.p, %bb.c
  call void @__kmpc_for_static_fini(ptr nonnull @1, i32 %.pre99)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #18
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #18
...
bb.q:                                             ; preds = %._crit_edge94, %_ZNSt6vectorIfSaIfEEC2EmRKS0_.exit
  call void @__kmpc_barrier(ptr nonnull @3, i32 %.pre99)
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.eq = ptrtoint ptr %.sroa.074.0 to i64
  %i.er = sub i64 %i.ep, %i.eq
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.074.0, i64 noundef %i.er) #32
...
.loopexit.split-lp.loopexit:                      ; preds = %bb.l, %bb.o, %._crit_edge88, %._crit_edge, %bb.e
...
.loopexit.split-lp:                               ; preds = %.loopexit.split-lp.loopexit, %.loopexit.split-lp.loopexit.split-lp, %.loopexit
  ...
  %i.es = extractvalue { ptr, i32 } %lpad.phi, 0
  call void @__clang_call_terminate(ptr %i.es) #35
  unreachable
}
...
bb.a:
  ...
  %i.c = load i32, ptr %i.b, align 8, !tbaa !60   ; 5 uses
...
bb.d:                                             ; preds = %bb.c
  %i.k = load ptr, ptr %9, align 8, !tbaa !21
  %i.l = load i64, ptr %i.f, align 8, !tbaa !35
...
bb.i:                                             ; preds = %bb.h, %bb.e
  ...
  %i.q = load ptr, ptr %9, align 8, !tbaa !21     ; 2 uses
...
bb.j:                                             ; preds = %bb.a
  ...
  %i.w = load ptr, ptr %7, align 8, !tbaa !62     ; 2 uses
...
_ZSt8_DestroyIPffEvT_S1_RSaIT0_E.exit.i.i:        ; preds = %bb.m
  store ptr %i.ae, ptr %i.u, align 8, !tbaa !65
  br label %_ZNSt6vectorIfSaIfEE6resizeEm.exit
...
_ZNSt6vectorIfSaIfEE6resizeEm.exit:               ; preds = %bb.k, %bb.l, %bb.m, %_ZSt8_DestroyIPffEvT_S1_RSaIT0_E.exit.i.i
  ...
  %i.ah = load ptr, ptr %8, align 8, !tbaa !62    ; 2 uses
...
_ZSt8_DestroyIPffEvT_S1_RSaIT0_E.exit.i.i147:     ; preds = %bb.p
  store ptr %i.ap, ptr %i.af, align 8, !tbaa !65
  br label %_ZNSt6vectorIfSaIfEE6resizeEm.exit148
...
_ZN5faiss6rabitq29round_nonnegative_byte_scalarEf.exit.9: ; preds = %bb.u, %bb.t, %_ZN5faiss6rabitq29round_nonnegative_byte_scalarEf.exit.8
  ...
  store i8 %.0.i.i.9, ptr %i.ct, align 1, !tbaa !22
  %i.cu = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.cv = load float, ptr %i.cu, align 4, !tbaa !64
...
_ZN5faiss6rabitq29round_nonnegative_byte_scalarEf.exit.10: ; preds = %bb.w, %bb.v, %_ZN5faiss6rabitq29round_nonnegative_byte_scalarEf.exit.9
  ...
  store i8 %.0.i.i.10, ptr %i.dd, align 1, !tbaa !22
...
_ZN5faiss6rabitq29round_nonnegative_byte_scalarEf.exit.11: ; preds = %bb.y, %bb.x, %_ZN5faiss6rabitq29round_nonnegative_byte_scalarEf.exit.10
  ...
  store i8 %.0.i.i.11, ptr %i.dn, align 1, !tbaa !22
...
_ZN5faiss6rabitq29round_nonnegative_byte_scalarEf.exit.12: ; preds = %bb.aa, %bb.z, %_ZN5faiss6rabitq29round_nonnegative_byte_scalarEf.exit.11
  ...
  store i8 %.0.i.i.12, ptr %i.dx, align 1, !tbaa !22
...
_ZN5faiss6rabitq29round_nonnegative_byte_scalarEf.exit.13: ; preds = %bb.ac, %bb.ab, %_ZN5faiss6rabitq29round_nonnegative_byte_scalarEf.exit.12
  ...
  store i8 %.0.i.i.13, ptr %i.eh, align 1, !tbaa !22
  %i.ei = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.ej = load float, ptr %i.ei, align 4, !tbaa !64
...
_ZN5faiss6rabitq29round_nonnegative_byte_scalarEf.exit.14: ; preds = %bb.ae, %bb.ad, %_ZN5faiss6rabitq29round_nonnegative_byte_scalarEf.exit.13
  ...
  store i8 %.0.i.i.14, ptr %i.er, align 1, !tbaa !22
  %i.es = getelementptr inbounds nuw i8, ptr %0, i64 60
  %i.et = load float, ptr %i.es, align 4, !tbaa !64
...
_ZN5faiss6rabitq29round_nonnegative_byte_scalarEf.exit.15: ; preds = %bb.ag, %bb.af, %_ZN5faiss6rabitq29round_nonnegative_byte_scalarEf.exit.14
  ...
  store i8 %.0.i.i.15, ptr %i.fb, align 1, !tbaa !22
  ret void
}
...
bb.a:
  ...
  %i.e = load i32, ptr %i.a, align 8, !tbaa !60   ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.q = load i32, ptr %i.a, align 8, !tbaa !60
  %i.r = sext i32 %i.q to i64
  %i.s = icmp ult i64 %i.p, %i.r
  br i1 %i.s, label %.lr.ph, label %._crit_edge, !llvm.loop !2
}
...
bb.a:
  ...
  %i.c = alloca i64, align 8                      ; 4 uses
  %i.d = alloca i32, align 4                      ; 4 uses
  %i.e = load i64, ptr %2, align 8, !tbaa !23     ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  store i64 %i.j, ptr %i.b, align 8, !tbaa !23
  %i.k = load i64, ptr %i.a, align 8, !tbaa !23   ; 3 uses
...
bb.c:                                             ; preds = %.lr.ph42, %.loopexit
  %indvar = phi i64 [ 0, %.lr.ph42 ], [ %indvar.next, %.loopexit ] ; 2 uses
  %.03641 = phi i64 [ %i.k, %.lr.ph42 ], [ %i.do, %.loopexit ] ; 4 uses
  %11 = add i64 %i.k, %indvar
  %i.o = shl i64 %11, 2
  %i.p = load ptr, ptr %3, align 8, !tbaa !24
  %i.q = load i64, ptr %4, align 8, !tbaa !23
  %i.r = mul i64 %i.q, %.03641
  %i.s = getelementptr inbounds nuw i8, ptr %i.p, i64 %i.r ; 2 uses
  %i.t = load ptr, ptr %5, align 8, !tbaa !26     ; 2 uses
  %i.u = ptrtoaddr ptr %i.t to i64
  %i.v = load i32, ptr %i.l, align 8, !tbaa !60
...
bb.e:                                             ; preds = %bb.d
  %i.ab = load i64, ptr %i.n, align 8, !tbaa !156
  %i.ac = icmp slt i64 %i.z, %i.ab
  br i1 %i.ac, label %bb.f, label %bb.h

bb.f:                                             ; preds = %bb.e
  %i.ad = load ptr, ptr %i.m, align 8, !tbaa !143 ; 2 uses
  %i.ae = load ptr, ptr %7, align 8, !tbaa !62
  %i.af = load ptr, ptr %i.ad, align 8, !tbaa !15
...
.noexc:                                           ; preds = %.lr.ph.i
  ...
  store float %i.bb, ptr %i.bc, align 4, !tbaa !64
  %i.bd = add nuw i64 %.012.i, 1                  ; 2 uses
  %i.be = load i32, ptr %i.l, align 8, !tbaa !60  ; 5 uses
  %i.bf = sext i32 %i.be to i64                   ; 5 uses
  %i.bg = icmp ult i64 %i.bd, %i.bf
  br i1 %i.bg, label %.lr.ph.i, label %_ZNK5faiss22IndexIVFRaBitQFastScan27decode_fastscan_to_residualEPKhPff.exit, !llvm.loop !2
...
.lr.ph:                                           ; preds = %_ZNK5faiss22IndexIVFRaBitQFastScan27decode_fastscan_to_residualEPKhPff.exit
  %i.bi = load ptr, ptr %7, align 8, !tbaa !62    ; 7 uses
  %i.bj = load ptr, ptr %10, align 8, !tbaa !62   ; 7 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %i.bq, align 4, !tbaa !64
  %wide.load50 = load <4 x float>, ptr %i.br, align 4, !tbaa !64
  %i.bs = getelementptr inbounds nuw [4 x i8], ptr %i.bj, i64 %index ; 2 uses
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bs, i64 16
  %wide.load51 = load <4 x float>, ptr %i.bs, align 4, !tbaa !64
  %wide.load52 = load <4 x float>, ptr %i.bt, align 4, !tbaa !64
  ...
  store <4 x float> %i.bu, ptr %i.bw, align 4, !tbaa !64
  store <4 x float> %i.bv, ptr %i.bx, align 4, !tbaa !64
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.by = icmp eq i64 %index.next, %n.vec
  br i1 %i.by, label %middle.block, label %vector.body, !llvm.loop !233
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  %i.cb = load float, ptr %i.ca, align 4, !tbaa !64
  %i.cc = getelementptr inbounds nuw [4 x i8], ptr %i.bj, i64 %.039.prol
  %i.cd = load float, ptr %i.cc, align 4, !tbaa !64
  %i.ce = fadd float %i.cb, %i.cd
  %i.cf = getelementptr inbounds nuw [4 x i8], ptr %i.y, i64 %.039.prol
  store float %i.ce, ptr %i.cf, align 4, !tbaa !64
  %i.cg = add nuw i64 %.039.prol, 1               ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !234
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  store float %i.db, ptr %i.dc, align 4, !tbaa !64
  ...
  %i.dh = load float, ptr %i.dg, align 4, !tbaa !64
  %i.di = fadd float %i.df, %i.dh
  %i.dj = getelementptr inbounds nuw [4 x i8], ptr %i.y, i64 %i.dd
  store float %i.di, ptr %i.dj, align 4, !tbaa !64
  %i.dk = add nuw i64 %.039, 4                    ; 2 uses
  %exitcond.not.3 = icmp eq i64 %i.dk, %i.bh
  br i1 %exitcond.not.3, label %.loopexit, label %scalar.ph, !llvm.loop !235

bb.h:                                             ; preds = %bb.e, %bb.d
  %i.dl = load i32, ptr %i.l, align 8, !tbaa !60
...
.loopexit:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block, %bb.g, %_ZNK5faiss22IndexIVFRaBitQFastScan27decode_fastscan_to_residualEPKhPff.exit, %bb.h
  ...
  %i.dp = load i64, ptr %i.b, align 8, !tbaa !23
...
bb.a:
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !165, !nonnull !33, !align !166
  ...
  %i.j = load i8, ptr %i.i, align 8, !tbaa !129
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 49 ; 2 uses
  %i.l = load i8, ptr %i.k, align 1, !tbaa !130, !range !32, !noundef !33
  ...
  %i.p = load ptr, ptr %i.b, align 8, !tbaa !165, !nonnull !33, !align !166 ; 3 uses
  %i.q = getelementptr inbounds nuw i8, ptr %i.p, i64 280
  %i.r = load i64, ptr %i.q, align 8, !tbaa !131  ; 5 uses
  ...
  %i.v = load i64, ptr %i.u, align 8, !tbaa !151
  %i.w = icmp eq i64 %i.v, 16
  br i1 %i.w, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.x = load ptr, ptr @stderr, align 8, !tbaa !153
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !141 ; 2 uses
...
.lr.ph.i.i.i:                                     ; preds = %bb.c
  %i.ad = load ptr, ptr %i.g, align 8, !tbaa !140
  br label %bb.d
...
bb.d:                                             ; preds = %bb.d, %.lr.ph.i.i.i
  ...
  %i.al = load float, ptr %i.ak, align 4, !tbaa !64 ; 4 uses
  %i.am = getelementptr inbounds nuw i8, ptr %i.ak, i64 4
  %i.an = load float, ptr %i.am, align 4, !tbaa !64 ; 4 uses
  ...
  %i.at = load float, ptr %i.as, align 4, !tbaa !64 ; 4 uses
  ...
  %i.az = load float, ptr %i.ay, align 4, !tbaa !64 ; 4 uses
  ...
  %i.bf = load float, ptr %i.be, align 4, !tbaa !64 ; 4 uses
  ...
  %i.bl = load float, ptr %i.bk, align 4, !tbaa !64 ; 4 uses
  ...
  %i.br = load float, ptr %i.bq, align 4, !tbaa !64 ; 4 uses
  ...
  %i.bx = load float, ptr %i.bw, align 4, !tbaa !64 ; 4 uses
  ...
  %i.cd = load float, ptr %i.cc, align 4, !tbaa !64 ; 4 uses
  ...
  %i.cj = load float, ptr %i.ci, align 4, !tbaa !64 ; 4 uses
  ...
  %i.cp = load float, ptr %i.co, align 4, !tbaa !64 ; 4 uses
  ...
  %i.cv = load float, ptr %i.cu, align 4, !tbaa !64 ; 4 uses
  ...
  %i.db = load float, ptr %i.da, align 4, !tbaa !64 ; 4 uses
  ...
  %i.dh = load float, ptr %i.dg, align 4, !tbaa !64 ; 4 uses
  ...
  %i.dn = load float, ptr %i.dm, align 4, !tbaa !64 ; 4 uses
  ...
  %i.dt = load float, ptr %i.ds, align 4, !tbaa !64 ; 4 uses
