...
_ZN5faiss16scalar_quantizer16DCTurboQuantFullILi4ENS0_12SimilarityIPILNS_9SIMDLevelE0EEELS3_0EEC2EmRKSt6vectorIfSaIfEE.exit: ; preds = %bb.at
  ...
  store ptr null, ptr %i.et, align 8, !tbaa !243
  %i.eu = getelementptr inbounds nuw i8, ptr %i.eo, i64 224
  store i8 0, ptr %i.eu, align 8, !tbaa !244
  ...
  store float %i.fb, ptr %i.es, align 4, !tbaa !245
...
bb.av:                                            ; preds = %bb.a
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 120) (i8, ptr @_ZTVN5faiss16scalar_quantizer16DCTurboQuantFullILi5ENS0_12SimilarityIPILNS_9SIMDLevelE0EEELS3_0EEE, i64 16), ptr %i.fd, align 8, !tbaa !98
...
_ZN5faiss16scalar_quantizer16DCTurboQuantFullILi5ENS0_12SimilarityIPILNS_9SIMDLevelE0EEELS3_0EEC2EmRKSt6vectorIfSaIfEE.exit: ; preds = %bb.av
  ...
  store ptr null, ptr %i.fi, align 8, !tbaa !247
  %i.fj = getelementptr inbounds nuw i8, ptr %i.fd, i64 224
  store i8 0, ptr %i.fj, align 8, !tbaa !248
  ...
  store float %i.fq, ptr %i.fh, align 4, !tbaa !249
  br label %_ZN5faiss16scalar_quantizer10DCTemplateINS0_17QuantizerLloydMaxILi1ELNS_9SIMDLevelE0EEENS0_12SimilarityIPILS3_0EEELS3_0EEC2EmRKSt6vectorIfSaIfEE.exit
...
bb.ba:                                            ; preds = %bb.az, %bb.ay
  ...
  %i.fu = landingpad { ptr, i32 }
          cleanup                                 ; 4 uses
  %i.fv = load ptr, ptr %5, align 8, !tbaa !81    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i74: ; preds = %bb.ba
  %i.fy = load i64, ptr %i.fw, align 8, !tbaa !80
  %i.fz = add i64 %i.fy, 1
...
bb.a:
  ...
  %i.g = load ptr, ptr %0, align 8, !tbaa !98
...
bb.a:
  ...
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.d = load i64, ptr %i.c, align 8, !tbaa !252  ; 4 uses
  %i.e = mul i64 %i.d, %1
  %i.f = getelementptr inbounds nuw i8, ptr %i.b, i64 %i.e
  %i.g = mul i64 %i.d, %2
  ...
  %i.m = load ptr, ptr %0, align 8, !tbaa !98
...
bb.a:
  ...
  %i.j = load i64, ptr %i.i, align 8, !tbaa !254  ; 2 uses
...
.lr.ph.i:                                         ; preds = %bb.a
  ...
  %i.l = load <2 x float>, ptr %i.k, align 8, !tbaa !89 ; 2 uses
  %i.m = shufflevector <2 x float> %i.l, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.n = shufflevector <2 x float> %i.l, <2 x float> poison, <2 x i32> zeroinitializer
  br label %bb.b

bb.b:                                             ; preds = %bb.b, %.lr.ph.i
  %.010.i = phi i64 [ 0, %.lr.ph.i ], [ %i.aa, %bb.b ] ; 3 uses
  %.sroa.6.09.i = phi float [ 0.000000e+00, %.lr.ph.i ], [ %i.z, %bb.b ]
  ...
  %i.t = insertelement <2 x i8> %i.s, i8 %i.p, i64 1
  %i.u = uitofp <2 x i8> %i.t to <2 x float>
  %i.v = fadd <2 x float> %i.u, splat (float 5.000000e-01)
  %i.w = fdiv <2 x float> %i.v, splat (float 2.550000e+02)
  %i.x = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.w, <2 x float> %i.m, <2 x float> %i.n) ; 2 uses
  %shift = shufflevector <2 x float> %i.x, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop = fsub <2 x float> %shift, %i.x
  %i.y = extractelement <2 x float> %foldExtExtBinop, i64 0 ; 2 uses
  %i.z = tail call float @llvm.fmuladd.f32(float %i.y, float %i.y, float %.sroa.6.09.i) ; 2 uses
  %i.aa = add nuw i64 %.010.i, 1                  ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.aa, %i.j
  br i1 %exitcond.not.i, label %_ZNK5faiss16scalar_quantizer10DCTemplateINS0_17QuantizerTemplateINS0_9Codec8bitILNS_9SIMDLevelE0EEELNS0_24QuantizerTemplateScalingE0ELS4_0EEENS0_12SimilarityL2ILS4_0EEELS4_0EE21compute_code_distanceEPKhSC_.exit, label %bb.b, !llvm.loop !790
...
_ZNK5faiss16scalar_quantizer10DCTemplateINS0_17QuantizerTemplateINS0_9Codec8bitILNS_9SIMDLevelE0EEELNS0_24QuantizerTemplateScalingE0ELS4_0EEENS0_12SimilarityL2ILS4_0EEELS4_0EE21compute_code_distanceEPKhSC_.exit: ; preds = %bb.b, %bb.a
  %.sroa.6.0.lcssa.i = phi float [ 0.000000e+00, %bb.a ], [ %i.z, %bb.b ]
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i.i:
  ...
  store ptr %i.b, ptr %4, align 8, !tbaa !77
...
.noexc6:                                          ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i.i
  store ptr %i.c, ptr %4, align 8, !tbaa !81
  store i64 35, ptr %i.b, align 8, !tbaa !80
  ...
  store i64 35, ptr %i.d, align 8, !tbaa !79
  %i.e = getelementptr inbounds nuw i8, ptr %i.c, i64 35
  store i8 0, ptr %i.e, align 1, !tbaa !80
...
bb.b:                                             ; preds = %bb.a, %.noexc6
  ...
  %i.g = landingpad { ptr, i32 }
          cleanup                                 ; 4 uses
  %i.h = load ptr, ptr %4, align 8, !tbaa !81     ; 2 uses
  %i.i = icmp eq ptr %i.h, %i.b
  br i1 %i.i, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.b
  %i.j = load i64, ptr %i.b, align 8, !tbaa !80
  %i.k = add i64 %i.j, 1
...
bb.a:
  ...
  %i.e = load ptr, ptr %0, align 8, !tbaa !98
  ...
  %i.i = load ptr, ptr %0, align 8, !tbaa !98
  ...
  store float %i.d, ptr %5, align 4, !tbaa !89
  store float %i.h, ptr %6, align 4, !tbaa !89
  store float %i.l, ptr %7, align 4, !tbaa !89
  store float %i.p, ptr %8, align 4, !tbaa !89
  ret void
}
...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !tbaa !254  ; 5 uses
...
.lr.ph.i:                                         ; preds = %bb.a
  ...
  %i.f = load float, ptr %i.e, align 8, !tbaa !196 ; 3 uses
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 52
  %i.h = load float, ptr %i.g, align 4, !tbaa !195 ; 3 uses
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.i.new
  ...
  %i.q = load float, ptr %.sroa.4.08.i, align 4, !tbaa !89
  ...
  %i.ab = load float, ptr %i.p, align 4, !tbaa !89
  ...
  br i1 %niter.ncmp.1, label %_ZNK5faiss16scalar_quantizer10DCTemplateINS0_17QuantizerTemplateINS0_9Codec8bitILNS_9SIMDLevelE0EEELNS0_24QuantizerTemplateScalingE0ELS4_0EEENS0_12SimilarityL2ILS4_0EEELS4_0EE16compute_distanceEPKfPKh.exit.loopexit.unr-lcssa, label %bb.b, !llvm.loop !10
