...
bb.al:                                            ; preds = %bb.ak, %._crit_edge270.us
  ...
  %i.gq = tail call float @llvm.fmuladd.f32(float %i.gb, float %.lcssa370, float %i.gl)
  %i.gr = tail call float @llvm.fmuladd.f32(float %i.gb, float %i.gk, float %i.gp)
  ...
  %i.gv = insertelement <2 x float> %i.gu, float %i.gr, i64 1
