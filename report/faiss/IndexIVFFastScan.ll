...
bb.t:                                             ; preds = %bb.r, %bb.s
  ...
  %.val = load i32, ptr %12, align 8, !tbaa !142  ; 2 uses
  %.not.i76 = icmp eq i32 %.val, 0                ; 2 uses
  %i.fu = select i1 %.not.i76, i64 0, i64 2       ; 2 uses
  %17 = trunc i32 %.val to i16                    ; 2 uses
...
_ZN5faiss15BitstringReader4readEi.exit65.i:       ; preds = %._crit_edge.i50.i, %bb.y
  ...
  %18 = zext i8 %i.jh to i16
  %19 = mul i16 %18, %17
  %i.ji = add i16 %19, %.044.lcssa.i
...
_ZN5faiss15BitstringReader4readEi.exit65.i.1:     ; preds = %._crit_edge.i50.i.1, %bb.aa
  ...
  %20 = zext i8 %i.kq to i16
  %21 = mul i16 %20, %17
  %i.kr = add i16 %21, %i.ji
  br label %.loopexit.i
...
_ZN5faiss15BitstringReader4readEi.exit65.i:       ; preds = %._crit_edge.i50.i, %bb.y
  ...
  %18 = zext i8 %i.jv to i16
  %19 = mul i16 %18, %17
  %i.jw = add i16 %19, %.044.lcssa.i
...
_ZN5faiss15BitstringReader4readEi.exit65.i.1:     ; preds = %._crit_edge.i50.i.1, %bb.aa
  ...
  %20 = zext i8 %i.le to i16
  %21 = mul i16 %20, %17
  %i.lf = add i16 %21, %i.jw
  br label %.loopexit.i
