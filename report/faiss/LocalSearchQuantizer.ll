...
bb.a:
  ...
  %i.f = load ptr, ptr %0, align 8, !tbaa !128    ; 6 uses
...
_ZNSt12_Vector_baseIiSaIiEE11_M_allocateEm.exit.i: ; preds = %bb.b
  ...
  br i1 %i.m, label %bb.d, label %bb.e, !prof !126
...
bb.f:                                             ; preds = %bb.e
  %i.o = load i32, ptr %1, align 4, !tbaa !91
  store i32 %i.o, ptr %i.l, align 4, !tbaa !91
  br label %_ZNSt6vectorIiSaIiEE20_M_allocate_and_copyIPiEES3_mT_S4_.exit

_ZNSt6vectorIiSaIiEE20_M_allocate_and_copyIPiEES3_mT_S4_.exit: ; preds = %bb.d, %bb.e, %bb.f
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.q = load ptr, ptr %0, align 8, !tbaa !128    ; 3 uses
...
bb.g:                                             ; preds = %_ZNSt6vectorIiSaIiEE20_M_allocate_and_copyIPiEES3_mT_S4_.exit
  %i.r = load ptr, ptr %i.d, align 8, !tbaa !129
...
bb.i:                                             ; preds = %bb.h
  ...
  br i1 %i.aa, label %bb.j, label %bb.k, !prof !126

bb.j:                                             ; preds = %bb.i
  tail call void @llvm.memmove.p0.p0.i64(ptr align 4 %i.f, ptr align 4 %1, i64 %i.c, i1 false)
  %.pre = load ptr, ptr %i.w, align 8, !tbaa !207
  br label %_ZSt4copyIPiS0_ET0_T_S2_S1_.exit

bb.k:                                             ; preds = %bb.i
  %i.ab = icmp eq i64 %i.c, 4
  br i1 %i.ab, label %bb.l, label %_ZSt4copyIPiS0_ET0_T_S2_S1_.exit

bb.l:                                             ; preds = %bb.k
  %i.ac = load i32, ptr %1, align 4, !tbaa !91
  store i32 %i.ac, ptr %i.f, align 4, !tbaa !91
  br label %_ZSt4copyIPiS0_ET0_T_S2_S1_.exit
...
_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E.exit.i:          ; preds = %_ZSt4copyIPiS0_ET0_T_S2_S1_.exit
  store ptr %i.ae, ptr %i.w, align 8, !tbaa !207
  br label %_ZNSt6vectorIiSaIiEE15_M_erase_at_endEPi.exit
...
_ZSt9__advanceIPilEvRT_T0_St26random_access_iterator_tag.exit: ; preds = %bb.h
  ...
  br i1 %i.ag, label %bb.m, label %bb.n, !prof !126
...
bb.m:                                             ; preds = %_ZSt9__advanceIPilEvRT_T0_St26random_access_iterator_tag.exit
  ...
  %.pre21 = load ptr, ptr %i.w, align 8, !tbaa !207
...
bb.n:                                             ; preds = %_ZSt9__advanceIPilEvRT_T0_St26random_access_iterator_tag.exit
  ...
  br i1 %i.ah, label %bb.o, label %_ZSt4copyIPiS0_ET0_T_S2_S1_.exit17

bb.o:                                             ; preds = %bb.n
  %i.ai = load i32, ptr %1, align 4, !tbaa !91
  store i32 %i.ai, ptr %i.f, align 4, !tbaa !91
  br label %_ZSt4copyIPiS0_ET0_T_S2_S1_.exit17

_ZSt4copyIPiS0_ET0_T_S2_S1_.exit17:               ; preds = %bb.m, %bb.n, %bb.o
  %i.aj = phi ptr [ %.pre21, %bb.m ], [ %i.x, %bb.n ], [ %i.x, %bb.o ] ; 3 uses
  %i.ak = sub i64 %i.a, %i.af                     ; 4 uses
  %i.al = icmp sgt i64 %i.ak, 4
  br i1 %i.al, label %bb.p, label %bb.q, !prof !126
...
bb.q:                                             ; preds = %_ZSt4copyIPiS0_ET0_T_S2_S1_.exit17
  ...
  br i1 %i.am, label %bb.r, label %_ZSt22__uninitialized_copy_aIPiS0_iET0_T_S2_S1_RSaIT1_E.exit

bb.r:                                             ; preds = %bb.q
  %i.an = load i32, ptr %.sink.i, align 4, !tbaa !91
  store i32 %i.an, ptr %i.aj, align 4, !tbaa !91
  br label %_ZSt22__uninitialized_copy_aIPiS0_iET0_T_S2_S1_RSaIT1_E.exit
...
_ZSt22__uninitialized_copy_aIPiS0_iET0_T_S2_S1_RSaIT1_E.exit: ; preds = %bb.p, %bb.q, %bb.r
  ...
  store ptr %i.ao, ptr %i.w, align 8, !tbaa !207
  br label %_ZNSt6vectorIiSaIiEE15_M_erase_at_endEPi.exit
...
bb.a:
  ...
  %i.g = load i64, ptr %2, align 8, !tbaa !65     ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  store i64 1, ptr %i.c, align 8, !tbaa !65
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d) #16
  store i32 0, ptr %i.d, align 4, !tbaa !91
  %i.j = load i32, ptr %0, align 4, !tbaa !91     ; 4 uses
...
bb.c:                                             ; preds = %.lr.ph78, %.loopexit58
  %i.o = load i64, ptr %i.a, align 8, !tbaa !65   ; 3 uses
  %i.p = load i64, ptr %i.b, align 8, !tbaa !65, !llvm.access.group !208
...
.lr.ph75:                                         ; preds = %bb.c, %_ZNSt6vectorIfSaIfEED2Ev.exit
  ...
  %i.q = shl i64 %8, 2
  %i.r = load i64, ptr %i.l, align 8, !tbaa !60, !llvm.access.group !208 ; 5 uses
...
.noexc49:                                         ; preds = %bb.e
  ...
  store float 0.000000e+00, ptr %i.u, align 4, !tbaa !95, !llvm.access.group !208
...
_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i: ; preds = %.noexc49
  ...
  call void @llvm.memset.p0.i64(ptr align 4 %i.y, i8 0, i64 %.idx.i.i.i.i.i.i.i, i1 false), !tbaa !95, !llvm.access.group !208
...
_ZNSt6vectorIfSaIfEEC2EmRKS0_.exit:               ; preds = %_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i, %.noexc49, %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i
  ...
  %i.z = load i64, ptr %4, align 8, !tbaa !65, !llvm.access.group !208 ; 2 uses
...
.preheader56.lr.ph:                               ; preds = %_ZNSt6vectorIfSaIfEEC2EmRKS0_.exit
  %i.aa = load i64, ptr %i.m, align 8, !tbaa !57, !llvm.access.group !208 ; 2 uses
...
bb.f:                                             ; preds = %._crit_edge70
  ...
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.051.0, i64 noundef %i.af) #25, !llvm.access.group !208
  br label %_ZNSt6vectorIfSaIfEED2Ev.exit

_ZNSt6vectorIfSaIfEED2Ev.exit:                    ; preds = %._crit_edge70, %bb.f
  %i.ag = add nsw i64 %.072, 1
  %i.ah = load i64, ptr %i.b, align 8, !tbaa !65, !llvm.access.group !208
  %.not48.not = icmp slt i64 %.072, %i.ah
  %indvar.next = add i64 %indvar, 1
  br i1 %.not48.not, label %.lr.ph75, label %.loopexit58, !llvm.loop !209

._crit_edge.loopexit:                             ; preds = %_ZN5faiss24HeapWithBucketsCMaxFloatILj16ELj1ELNS_9SIMDLevelE0EE4addnEjPKfjPfPi.exit
  %.pre = load i64, ptr %4, align 8, !tbaa !65, !llvm.access.group !208
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader56
  ...
  br i1 %i.al, label %.preheader56, label %._crit_edge70, !llvm.loop !210
...
.lr.ph68:                                         ; preds = %.preheader56, %_ZN5faiss24HeapWithBucketsCMaxFloatILj16ELj1ELNS_9SIMDLevelE0EE4addnEjPKfjPfPi.exit
  ...
  %i.ao = load ptr, ptr %5, align 8, !tbaa !66, !llvm.access.group !208 ; 2 uses
  %i.ap = ptrtoaddr ptr %i.ao to i64
  %i.aq = load i64, ptr %2, align 8, !tbaa !65, !llvm.access.group !208 ; 2 uses
  %i.ar = mul i64 %i.aq, %.04567
  %i.as = load i64, ptr %i.l, align 8, !tbaa !60, !llvm.access.group !208
...
vector.body111:                                   ; preds = %vector.body111, %vector.ph109
  ...
  %wide.load113 = load <4 x float>, ptr %i.bc, align 4, !tbaa !95, !llvm.access.group !208
  %wide.load114 = load <4 x float>, ptr %i.bd, align 4, !tbaa !95, !llvm.access.group !208
  %i.be = getelementptr inbounds nuw [4 x i8], ptr %.sroa.051.0, i64 %index112 ; 2 uses
  %i.bf = getelementptr inbounds nuw i8, ptr %i.be, i64 16
  store <4 x float> %wide.load113, ptr %i.be, align 4, !tbaa !95, !llvm.access.group !208
  store <4 x float> %wide.load114, ptr %i.bf, align 4, !tbaa !95, !llvm.access.group !208
  %index.next115 = add nuw i64 %index112, 8       ; 2 uses
  %i.bg = icmp eq i64 %index.next115, %n.vec110
  br i1 %i.bg, label %middle.block116, label %vector.body111, !llvm.loop !211
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader119, %.lr.ph.prol
  ...
  %i.bi = load float, ptr %i.bh, align 4, !tbaa !95, !llvm.access.group !208
  %i.bj = getelementptr inbounds nuw [4 x i8], ptr %.sroa.051.0, i64 %.04462.prol
  store float %i.bi, ptr %i.bj, align 4, !tbaa !95, !llvm.access.group !208
  %i.bk = add nuw i64 %.04462.prol, 1             ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol, !llvm.loop !212
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.br = load float, ptr %i.bq, align 4, !tbaa !95, !llvm.access.group !208
  %i.bs = getelementptr inbounds nuw [4 x i8], ptr %.sroa.051.0, i64 %.04263.us ; 2 uses
  %i.bt = load float, ptr %i.bs, align 4, !tbaa !95, !llvm.access.group !208
  %i.bu = fadd float %i.br, %i.bt
  store float %i.bu, ptr %i.bs, align 4, !tbaa !95, !llvm.access.group !208
  %i.bv = add nuw i64 %.04263.us, 1               ; 2 uses
  %i.bw = getelementptr [4 x i8], ptr %i.da, i64 %i.bv
  %i.bx = load float, ptr %i.bw, align 4, !tbaa !95, !llvm.access.group !208
  %i.by = getelementptr inbounds nuw [4 x i8], ptr %.sroa.051.0, i64 %i.bv ; 2 uses
  %i.bz = load float, ptr %i.by, align 4, !tbaa !95, !llvm.access.group !208
  %i.ca = fadd float %i.bx, %i.bz
  store float %i.ca, ptr %i.by, align 4, !tbaa !95, !llvm.access.group !208
  %i.cb = add nuw i64 %.04263.us, 2               ; 2 uses
  %i.cc = getelementptr [4 x i8], ptr %i.da, i64 %i.cb
  %i.cd = load float, ptr %i.cc, align 4, !tbaa !95, !llvm.access.group !208
  %i.ce = getelementptr inbounds nuw [4 x i8], ptr %.sroa.051.0, i64 %i.cb ; 2 uses
  %i.cf = load float, ptr %i.ce, align 4, !tbaa !95, !llvm.access.group !208
  %i.cg = fadd float %i.cd, %i.cf
  store float %i.cg, ptr %i.ce, align 4, !tbaa !95, !llvm.access.group !208
  %i.ch = add nuw i64 %.04263.us, 3               ; 2 uses
  %i.ci = getelementptr [4 x i8], ptr %i.da, i64 %i.ch
  %i.cj = load float, ptr %i.ci, align 4, !tbaa !95, !llvm.access.group !208
  %i.ck = getelementptr inbounds nuw [4 x i8], ptr %.sroa.051.0, i64 %i.ch ; 2 uses
  %i.cl = load float, ptr %i.ck, align 4, !tbaa !95, !llvm.access.group !208
  %i.cm = fadd float %i.cj, %i.cl
  store float %i.cm, ptr %i.ck, align 4, !tbaa !95, !llvm.access.group !208
  %i.cn = add nuw i64 %.04263.us, 4               ; 2 uses
  %exitcond88.not.3 = icmp eq i64 %i.cn, %.fr84
  br i1 %exitcond88.not.3, label %..loopexit_crit_edge.us, label %scalar.ph, !llvm.loop !213
...
..loopexit_crit_edge.us:                          ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block, %.preheader55.split.us
  ...
  br i1 %exitcond89.not, label %.split.us, label %.preheader55.split.us, !llvm.loop !214

.preheader.us:                                    ; preds = %.preheader55.split.us
  %i.cp = load ptr, ptr %6, align 8, !tbaa !119, !llvm.access.group !208
  %i.cq = getelementptr [4 x i8], ptr %i.cp, i64 %i.bn
  %i.cr = getelementptr [4 x i8], ptr %i.cq, i64 %.04365.us
  %i.cs = load i32, ptr %i.cr, align 4, !tbaa !91, !llvm.access.group !208
  ...
  %i.cz = load ptr, ptr %7, align 8, !tbaa !66, !llvm.access.group !208 ; 2 uses
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %wide.load = load <4 x float>, ptr %i.de, align 4, !tbaa !95, !alias.scope !223, !llvm.access.group !208
  %wide.load102 = load <4 x float>, ptr %i.df, align 4, !tbaa !95, !alias.scope !223, !llvm.access.group !208
  ...
  %wide.load103 = load <4 x float>, ptr %i.dg, align 4, !tbaa !95, !alias.scope !224, !noalias !223, !llvm.access.group !208
  %wide.load104 = load <4 x float>, ptr %i.dh, align 4, !tbaa !95, !alias.scope !224, !noalias !223, !llvm.access.group !208
  %i.di = fadd <4 x float> %wide.load, %wide.load103
  %i.dj = fadd <4 x float> %wide.load102, %wide.load104
  store <4 x float> %i.di, ptr %i.dg, align 4, !tbaa !95, !alias.scope !224, !noalias !223, !llvm.access.group !208
  store <4 x float> %i.dj, ptr %i.dh, align 4, !tbaa !95, !alias.scope !224, !noalias !223, !llvm.access.group !208
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.dk = icmp eq i64 %index.next, %n.vec
  br i1 %i.dk, label %middle.block, label %vector.body, !llvm.loop !218
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  %i.dm = load float, ptr %i.dl, align 4, !tbaa !95, !llvm.access.group !208
  %i.dn = getelementptr inbounds nuw [4 x i8], ptr %.sroa.051.0, i64 %.04263.us.prol ; 2 uses
  %i.do = load float, ptr %i.dn, align 4, !tbaa !95, !llvm.access.group !208
end_hunk_0
