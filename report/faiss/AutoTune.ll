Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/faiss/original/AutoTune?download=true
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit: ; preds = %._crit_edge.i.i, %bb.d, %bb.e
  ...
  store i64 %4, ptr %i.p, align 8, !tbaa !153
...
bb.h:                                             ; preds = %bb.f
  ...
  %i.u = load ptr, ptr %i.t, align 8, !tbaa !157  ; 6 uses
  %i.v = getelementptr inbounds i8, ptr %i.u, i64 -56 ; 2 uses
  %i.w = load double, ptr %i.v, align 8, !tbaa !155 ; 2 uses
...
.preheader:                                       ; preds = %bb.k
  %i.aa = load ptr, ptr %i.s, align 8, !tbaa !150 ; 3 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.ag = load double, ptr %i.af, align 8, !tbaa !156
...
_ZN5faiss14OperatingPointaSERKS0_.exit:           ; preds = %bb.m
  %i.aj = load i64, ptr %i.p, align 8, !tbaa !153
  %i.ak = getelementptr inbounds i8, ptr %i.u, i64 -8
  store i64 %i.aj, ptr %i.ak, align 8, !tbaa !153
  br label %bb.ab
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.n
  ...
  %i.am = load double, ptr %i.al, align 8, !tbaa !155 ; 2 uses
...
bb.p:                                             ; preds = %bb.o
  %i.av = load ptr, ptr %6, align 8, !tbaa !46
  %i.aw = load i64, ptr %i.aq, align 8, !tbaa !44
...
bb.u:                                             ; preds = %bb.t, %bb.q
  ...
  %i.bb = load ptr, ptr %6, align 8, !tbaa !46    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.u
  %i.bd = load i64, ptr %i.ap, align 8, !tbaa !45
  %i.be = add i64 %i.bd, 1
...
bb.v:                                             ; preds = %.lr.ph
  ...
  %i.bg = load double, ptr %i.bf, align 8, !tbaa !156
...
_ZN5faiss14OperatingPointaSERKS0_.exit67:         ; preds = %bb.x
  %i.bk = load i64, ptr %i.p, align 8, !tbaa !153
  %i.bl = getelementptr inbounds nuw i8, ptr %i.al, i64 48
  store i64 %i.bk, ptr %i.bl, align 8, !tbaa !153
  br label %bb.ab
...
bb.ab:                                            ; preds = %_ZN5faiss14OperatingPointaSERKS0_.exit67, %bb.z, %_ZN5faiss14OperatingPointaSERKS0_.exit, %bb.i
  %i.bp = load ptr, ptr %i.t, align 8, !tbaa !151
  %i.bq = load ptr, ptr %i.s, align 8, !tbaa !150
...
.critedge:                                        ; preds = %_ZNSt6vectorIN5faiss14OperatingPointESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EE.exit, %bb.ab, %bb.l, %bb.v, %bb.f
  ...
  %i.cg = load ptr, ptr %i.b, align 8, !tbaa !46  ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i: ; preds = %.critedge
  %i.ci = load i64, ptr %i.c, align 8, !tbaa !45
  %i.cj = add i64 %i.ci, 1
...
bb.ae:                                            ; preds = %bb.j, %bb.ad, %bb.aa, %bb.y, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %bb.g
  ...
  %i.ck = load ptr, ptr %i.b, align 8, !tbaa !46  ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i68: ; preds = %bb.ae
  %i.cm = load i64, ptr %i.c, align 8, !tbaa !45
  %i.cn = add i64 %i.cm, 1
...
bb.a:
  ...
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !151  ; 7 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.m = load ptr, ptr %i.k, align 8, !tbaa !46   ; 2 uses
  %i.n = getelementptr inbounds nuw i8, ptr %2, i64 24
  %i.o = load i64, ptr %i.n, align 8, !tbaa !44   ; 8 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %i.s, label %.noexc6.i.i.i, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i.i.i.i, !prof !98
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i.i.i.i: ; preds = %bb.e
  ...
  store ptr %i.t, ptr %i.j, align 8, !tbaa !46
  store i64 %i.o, ptr %i.l, align 8, !tbaa !45
...
bb.f:                                             ; preds = %._crit_edge.i.i.i.i
  %i.v = load i8, ptr %i.m, align 1, !tbaa !45
...
_ZSt12construct_atIN5faiss14OperatingPointEJRKS1_EEDTgsnwcvPvLi0E_T_pispclsr3stdE7declvalIT0_EEEEPS5_DpOS6_.exit: ; preds = %._crit_edge.i.i.i.i, %bb.f, %bb.g
  ...
  store i64 %i.o, ptr %i.w, align 8, !tbaa !44
  ...
  %i.aa = load i64, ptr %i.z, align 8, !tbaa !153
  store i64 %i.aa, ptr %i.y, align 8, !tbaa !153
  %i.ab = load ptr, ptr %i.e, align 8, !tbaa !151
  %i.ac = getelementptr inbounds nuw i8, ptr %i.ab, i64 56
  store ptr %i.ac, ptr %i.e, align 8, !tbaa !151
  br label %bb.p
...
bb.h:                                             ; preds = %bb.b
  ...
  %i.ai = load ptr, ptr %i.ag, align 8, !tbaa !46 ; 2 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %2, i64 24
  %i.ak = load i64, ptr %i.aj, align 8, !tbaa !44 ; 8 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  br i1 %i.ao, label %.noexc6.i.i.i.i, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i.i.i.i.i, !prof !98
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i.i.i.i.i: ; preds = %bb.j
  ...
  store ptr %i.ap, ptr %i.af, align 8, !tbaa !46
  store i64 %i.ak, ptr %i.ah, align 8, !tbaa !45
...
bb.k:                                             ; preds = %._crit_edge.i.i.i.i.i
  %i.ar = load i8, ptr %i.ai, align 1, !tbaa !45
  store i8 %i.ar, ptr %i.aq, align 1, !tbaa !45
...
_ZNSt6vectorIN5faiss14OperatingPointESaIS1_EE16_Temporary_valueC2IJRKS1_EEEPS3_DpOT_.exit: ; preds = %._crit_edge.i.i.i.i.i, %bb.k, %bb.l
  ...
  store i64 %i.ak, ptr %i.as, align 8, !tbaa !44
  %i.at = getelementptr inbounds nuw i8, ptr %i.aq, i64 %i.ak
  store i8 0, ptr %i.at, align 1, !tbaa !45
  %i.au = getelementptr inbounds nuw i8, ptr %3, i64 56
  %i.av = getelementptr inbounds nuw i8, ptr %2, i64 48
  %i.aw = load i64, ptr %i.av, align 8, !tbaa !153
  store i64 %i.aw, ptr %i.au, align 8, !tbaa !153
...
bb.m:                                             ; preds = %_ZNSt6vectorIN5faiss14OperatingPointESaIS1_EE16_Temporary_valueC2IJRKS1_EEEPS3_DpOT_.exit
  %i.ax = load ptr, ptr %i.af, align 8, !tbaa !46 ; 2 uses
  %i.ay = icmp eq ptr %i.ax, %i.ah
  br i1 %i.ay, label %_ZNSt6vectorIN5faiss14OperatingPointESaIS1_EE16_Temporary_valueD2Ev.exit, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i: ; preds = %bb.m
  %i.az = load i64, ptr %i.ah, align 8, !tbaa !45
  %i.ba = add i64 %i.az, 1
