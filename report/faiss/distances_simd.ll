...
.lr.ph155:                                        ; preds = %.lr.ph155.preheader, %..loopexit_crit_edge
  %indvar = phi i32 [ 0, %.lr.ph155.preheader ], [ %indvar.next, %..loopexit_crit_edge ] ; 9 uses
  %indvars.iv = phi i64 [ 4, %.lr.ph155.preheader ], [ %indvars.iv.next, %..loopexit_crit_edge ] ; 9 uses
  %.068156 = phi i64 [ 0, %.lr.ph155.preheader ], [ %i.ac, %..loopexit_crit_edge ] ; 7 uses
  %8 = mul i32 %indvar, -4                        ; 2 uses
  %umin712 = tail call i64 @llvm.umin.i64(i64 %indvars.iv, i64 %i.c)
  %9 = trunc i64 %umin712 to i32                  ; 3 uses
  %10 = add i32 %8, %9
  %11 = add i32 %8, -1
  %12 = add i32 %11, %9
  %13 = mul i32 %indvar, -4                       ; 2 uses
  %umin704 = tail call i64 @llvm.umin.i64(i64 %indvars.iv, i64 %i.c)
  %14 = trunc i64 %umin704 to i32                 ; 3 uses
  %15 = add i32 %13, %14
  %16 = add i32 %13, -1
  %17 = add i32 %16, %14
  %18 = mul i32 %indvar, -4                       ; 2 uses
  %umin696 = tail call i64 @llvm.umin.i64(i64 %indvars.iv, i64 %i.c)
  %19 = trunc i64 %umin696 to i32                 ; 3 uses
  %20 = add i32 %18, %19
  %21 = add i32 %18, -1
  %22 = add i32 %21, %19
  %23 = mul i32 %indvar, -4                       ; 2 uses
  %umin688 = tail call i64 @llvm.umin.i64(i64 %indvars.iv, i64 %i.c)
  %24 = trunc i64 %umin688 to i32                 ; 3 uses
  %25 = add i32 %23, %24
  %26 = add i32 %23, -1
  %27 = add i32 %26, %24
  %28 = mul i32 %indvar, -4                       ; 2 uses
  %umin680 = tail call i64 @llvm.umin.i64(i64 %indvars.iv, i64 %i.c)
  %29 = trunc i64 %umin680 to i32                 ; 3 uses
  %30 = add i32 %28, %29
  %31 = add i32 %28, -1
  %32 = add i32 %31, %29
  %33 = mul i32 %indvar, -4                       ; 2 uses
  %umin672 = tail call i64 @llvm.umin.i64(i64 %indvars.iv, i64 %i.c)
  %34 = trunc i64 %umin672 to i32                 ; 3 uses
  %35 = add i32 %33, %34
  %36 = add i32 %33, -1
  %37 = add i32 %36, %34
  %38 = mul i32 %indvar, -4                       ; 2 uses
  %umin664 = tail call i64 @llvm.umin.i64(i64 %indvars.iv, i64 %i.c)
  %39 = trunc i64 %umin664 to i32                 ; 3 uses
  %40 = add i32 %38, %39
  %41 = add i32 %38, -1
  %42 = add i32 %41, %39
  %i.x = mul i32 %indvar, -4                      ; 2 uses
  %umin652 = tail call i64 @llvm.umin.i64(i64 %indvars.iv, i64 %i.c)
  %i.y = trunc i64 %umin652 to i32                ; 3 uses
  %i.z = add i32 %i.x, %i.y
  %i.aa = add i32 %i.x, -1
  ...
  %xtraiter665 = and i32 %39, 3                   ; 4 uses
  %i.aq = icmp ult i32 %42, 3
  %unroll_iter669 = sub i32 %40, %xtraiter665
  %lcmp.mod667.not = icmp eq i32 %xtraiter665, 0
  %lcmp.mod668 = icmp ne i32 %xtraiter665, 0
  %xtraiter673 = and i32 %34, 3                   ; 4 uses
  %i.ar = icmp ult i32 %37, 3
  %unroll_iter677 = sub i32 %35, %xtraiter673
  %lcmp.mod675.not = icmp eq i32 %xtraiter673, 0
  %lcmp.mod676 = icmp ne i32 %xtraiter673, 0
  %xtraiter681 = and i32 %29, 3                   ; 4 uses
  %i.as = icmp ult i32 %32, 3
  %unroll_iter685 = sub i32 %30, %xtraiter681
  %lcmp.mod683.not = icmp eq i32 %xtraiter681, 0
  %lcmp.mod684 = icmp ne i32 %xtraiter681, 0
  %xtraiter689 = and i32 %24, 3                   ; 4 uses
  %i.at = icmp ult i32 %27, 3
  %unroll_iter693 = sub i32 %25, %xtraiter689
  %lcmp.mod691.not = icmp eq i32 %xtraiter689, 0
  %lcmp.mod692 = icmp ne i32 %xtraiter689, 0
  %xtraiter697 = and i32 %19, 3                   ; 4 uses
  %i.au = icmp ult i32 %22, 3
  %unroll_iter701 = sub i32 %20, %xtraiter697
  %lcmp.mod699.not = icmp eq i32 %xtraiter697, 0
  %lcmp.mod700 = icmp ne i32 %xtraiter697, 0
  %xtraiter705 = and i32 %14, 3                   ; 4 uses
  %i.av = icmp ult i32 %17, 3
  %unroll_iter709 = sub i32 %15, %xtraiter705
  %lcmp.mod707.not = icmp eq i32 %xtraiter705, 0
  %lcmp.mod708 = icmp ne i32 %xtraiter705, 0
  %xtraiter713 = and i32 %9, 3                    ; 4 uses
  %i.aw = icmp ult i32 %12, 3
  %unroll_iter717 = sub i32 %10, %xtraiter713
