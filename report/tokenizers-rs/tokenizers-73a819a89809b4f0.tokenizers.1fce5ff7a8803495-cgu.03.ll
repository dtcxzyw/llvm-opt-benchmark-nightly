...
begin_hunk_0_@_RINvNtNtNtNtCs4NRVxsYgnAr_4core5slice4sort6stable9quicksort9quicksortTmcENCINvMNtCscdodAO9FK5_5alloc5sliceSB15_11sort_by_keyINtNtBa_3cmp7ReverseB15_ENCNvMs_NtNtNtCs2JiOgHzbbc7_10tokenizers6models7unigram7trainerNtB2u_14UnigramTrainer25make_seed_sentence_piecess0_0E0EB2A_:bb.a
  ...
  %.sroa.011.0.val.i.i = load i32, ptr %.sroa.011.07.i.i, align 4, !alias.scope !1330, !noalias !1326, !noundef !3 ; 2 uses
  %i.fh = getelementptr i8, ptr %.sroa.011.07.i.i, i64 4
  %.sroa.011.0.val24.i.i = load i32, ptr %i.fh, align 4, !range !6, !alias.scope !1330, !noalias !1326, !noundef !3
  %.sroa.06.0.val.i.i = load i32, ptr %.sroa.06.08.i.i, align 4, !alias.scope !1330, !noalias !1326, !noundef !3 ; 2 uses
  %i.fi = getelementptr i8, ptr %.sroa.06.08.i.i, i64 4
  %.sroa.06.0.val25.i.i = load i32, ptr %i.fi, align 4, !range !6, !alias.scope !1330, !noalias !1326, !noundef !3
  ...
  %i.fn = load i64, ptr %..i23.i.i, align 4, !alias.scope !1330, !noalias !1331
  store i64 %i.fn, ptr %.sroa.0.010.i.i, align 4, !alias.scope !1326, !noalias !1332
  ...
  %.sroa.017.0.val.i.i = load i32, ptr %.sroa.017.05.i.i, align 4, !alias.scope !1330, !noalias !1326, !noundef !3 ; 2 uses
  %i.ft = getelementptr i8, ptr %.sroa.017.05.i.i, i64 4
  %.sroa.017.0.val26.i.i = load i32, ptr %i.ft, align 4, !range !6, !alias.scope !1330, !noalias !1326, !noundef !3
  %.sroa.015.0.val.i.i = load i32, ptr %.sroa.015.06.i.i, align 4, !alias.scope !1330, !noalias !1326, !noundef !3 ; 2 uses
  %i.fu = getelementptr i8, ptr %.sroa.015.06.i.i, i64 4
  %.sroa.015.0.val27.i.i = load i32, ptr %i.fu, align 4, !range !6, !alias.scope !1330, !noalias !1326, !noundef !3
  ...
  %i.fz = load i64, ptr %..i.i.i, align 4, !alias.scope !1330, !noalias !1333
  store i64 %i.fz, ptr %.sroa.019.04.i.i, align 4, !alias.scope !1326, !noalias !1334
...
bb.k:                                             ; preds = %._crit_edge.i.i
  ...
  %i.ge = load i64, ptr %.sroa.06.0..sroa.011.0.i.i, align 4, !alias.scope !1330, !noalias !1326
  store i64 %i.ge, ptr %i.fs, align 4, !alias.scope !1326, !noalias !1330
...
bb.m:                                             ; preds = %bb.l
  invoke void @_RNvNtNtNtNtCs4NRVxsYgnAr_4core5slice4sort6shared9smallsort22panic_on_ord_violation() #22
          to label %.noexc.i unwind label %bb.n, !noalias !1335
...
bb.n:                                             ; preds = %bb.m
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %.sroa.0.0.ph.lcssa133, ptr nonnull align 4 %2, i64 %i.gn, i1 false), !alias.scope !1335, !noalias !1336
  resume { ptr, i32 } %i.gm
...
.lr.ph.i:                                         ; preds = %bb.j, %_RINvNtNtNtNtCs4NRVxsYgnAr_4core5slice4sort6shared9smallsort11insert_tailTmcENCINvMNtCscdodAO9FK5_5alloc5sliceSB18_11sort_by_keyINtNtBa_3cmp7ReverseB18_ENCNvMs_NtNtNtCs2JiOgHzbbc7_10tokenizers6models7unigram7trainerNtB2x_14UnigramTrainer25make_seed_sentence_piecess0_0E0EB2D_.exit.i
  ...
  %i.gq = load i64, ptr %i.go, align 4, !alias.scope !1326, !noalias !1327 ; 4 uses
  store i64 %i.gq, ptr %i.gp, align 4, !alias.scope !1327, !noalias !1326
  ...
  %.val13.i58.i = load i32, ptr %i.gr, align 4, !alias.scope !1327, !noalias !1326, !noundef !3 ; 2 uses
  %i.gv = getelementptr i8, ptr %i.gp, i64 -4
  %.val14.i59.i = load i32, ptr %i.gv, align 4, !range !6, !alias.scope !1327, !noalias !1326, !noundef !3
...
.preheader.i.preheader:                           ; preds = %.lr.ph.i
  %i.gz = load i64, ptr %i.gr, align 4, !alias.scope !1327, !noalias !1326
  store i64 %i.gz, ptr %i.gp, align 4, !alias.scope !1327, !noalias !1326
  %i.ha = icmp eq i64 %.sroa.05.08.i, 1
  br i1 %i.ha, label %._crit_edge322, label %.lr.ph321

.preheader.i:                                     ; preds = %.lr.ph321
  %i.hb = load i64, ptr %i.hd, align 4, !alias.scope !1327, !noalias !1326
  store i64 %i.hb, ptr %.sroa.0.0.i61.i320, align 4, !alias.scope !1327, !noalias !1326
...
.lr.ph321:                                        ; preds = %.preheader.i.preheader, %.preheader.i
  ...
  %.val9.i62.i = load i32, ptr %i.hd, align 4, !alias.scope !1327, !noalias !1326, !noundef !3 ; 2 uses
  %i.he = getelementptr i8, ptr %.sroa.0.0.i61.i320, i64 -4
  %.val10.i63.i = load i32, ptr %i.he, align 4, !range !6, !alias.scope !1327, !noalias !1326, !noundef !3
...
._crit_edge322:                                   ; preds = %.preheader.i, %.lr.ph321, %.preheader.i.preheader
  ...
  store i64 %i.gq, ptr %.sroa.0.0.i61.lcssa.i, align 4, !alias.scope !1327, !noalias !1328
...
bb.p:                                             ; preds = %.lr.ph316
  %.val10.i = load i32, ptr %.sroa.0.0.ph143, align 4, !alias.scope !1337, !noundef !3 ; 4 uses
  %.val11.i = load i32, ptr %i.d, align 4, !range !6, !alias.scope !1337, !noundef !3 ; 2 uses
  %.val12.i = load i32, ptr %i.hl, align 4, !alias.scope !1337, !noundef !3 ; 4 uses
  %i.hp = getelementptr i8, ptr %i.hl, i64 4
  %.val13.i = load i32, ptr %i.hp, align 4, !range !6, !alias.scope !1337, !noundef !3 ; 2 uses
  ...
  %.val8.i = load i32, ptr %i.hm, align 4, !alias.scope !1337, !noundef !3 ; 4 uses
  %i.ht = getelementptr i8, ptr %i.hm, i64 4
  %.val9.i = load i32, ptr %i.ht, align 4, !range !6, !alias.scope !1337, !noundef !3 ; 2 uses
...
.lr.ph.i72:                                       ; preds = %bb.ad
  ...
  %.val33.i79 = load i32, ptr %i.lo, align 4, !range !6, !alias.scope !1354, !noalias !1355, !noundef !3 ; 4 uses
  br label %bb.ae
...
bb.ae:                                            ; preds = %bb.ae, %.lr.ph.i72
  ...
  %.val31.i78 = load i32, ptr %i.lt, align 4, !range !6, !alias.scope !1354, !noalias !1355, !noundef !3
  ...
  %i.lz = load i64, ptr %.sroa.9.131.i74, align 4, !alias.scope !1354, !noalias !1356
  store i64 %i.lz, ptr %i.ly, align 4, !alias.scope !1355, !noalias !1357
  ...
  %.val26.i82 = load i32, ptr %i.mc, align 4, !alias.scope !1354, !noalias !1355, !noundef !3 ; 2 uses
  %i.md = getelementptr i8, ptr %.sroa.9.131.i74, i64 12
  %.val27.i83 = load i32, ptr %i.md, align 4, !range !6, !alias.scope !1354, !noalias !1355, !noundef !3
  %i.me = icmp eq i32 %.val26.i82, %.val32.i73
  %i.mf = icmp uge i32 %.val26.i82, %.val32.i73
  %i.mg = icmp samesign uge i32 %.val27.i83, %.val33.i79
  %.sroa.0.0.i.i.i.i34.i84 = select i1 %i.me, i1 %i.mg, i1 %i.mf ; 2 uses
  %i.mh = getelementptr inbounds i8, ptr %.sroa.43.129.i76, i64 -16
  %.sroa.01.0.i35.i85 = select i1 %.sroa.0.0.i.i.i.i34.i84, ptr %2, ptr %i.mh
  %i.mi = getelementptr inbounds nuw [8 x i8], ptr %.sroa.01.0.i35.i85, i64 %i.mb
  %i.mj = load i64, ptr %i.mc, align 4, !alias.scope !1354, !noalias !1358
  store i64 %i.mj, ptr %i.mi, align 4, !alias.scope !1355, !noalias !1359
  %i.mk = zext i1 %.sroa.0.0.i.i.i.i34.i84 to i64
  %i.ml = add i64 %i.mb, %i.mk                    ; 2 uses
  %i.mm = getelementptr inbounds nuw i8, ptr %.sroa.9.131.i74, i64 16 ; 2 uses
  %.val22.i86 = load i32, ptr %i.mm, align 4, !alias.scope !1354, !noalias !1355, !noundef !3 ; 2 uses
  %i.mn = getelementptr i8, ptr %.sroa.9.131.i74, i64 20
  %.val23.i87 = load i32, ptr %i.mn, align 4, !range !6, !alias.scope !1354, !noalias !1355, !noundef !3
  %i.mo = icmp eq i32 %.val22.i86, %.val32.i73
  %i.mp = icmp uge i32 %.val22.i86, %.val32.i73
  %i.mq = icmp samesign uge i32 %.val23.i87, %.val33.i79
  %.sroa.0.0.i.i.i.i36.i = select i1 %i.mo, i1 %i.mq, i1 %i.mp ; 2 uses
  %i.mr = getelementptr inbounds i8, ptr %.sroa.43.129.i76, i64 -24
  %.sroa.01.0.i37.i88 = select i1 %.sroa.0.0.i.i.i.i36.i, ptr %2, ptr %i.mr
  %i.ms = getelementptr inbounds nuw [8 x i8], ptr %.sroa.01.0.i37.i88, i64 %i.ml
  %i.mt = load i64, ptr %i.mm, align 4, !alias.scope !1354, !noalias !1360
  store i64 %i.mt, ptr %i.ms, align 4, !alias.scope !1355, !noalias !1361
  %i.mu = zext i1 %.sroa.0.0.i.i.i.i36.i to i64
  %i.mv = add i64 %i.ml, %i.mu                    ; 2 uses
  %i.mw = getelementptr inbounds nuw i8, ptr %.sroa.9.131.i74, i64 24 ; 2 uses
  %.val18.i89 = load i32, ptr %i.mw, align 4, !alias.scope !1354, !noalias !1355, !noundef !3 ; 2 uses
  %i.mx = getelementptr i8, ptr %.sroa.9.131.i74, i64 28
  %.val19.i90 = load i32, ptr %i.mx, align 4, !range !6, !alias.scope !1354, !noalias !1355, !noundef !3
  %i.my = icmp eq i32 %.val18.i89, %.val32.i73
  %i.mz = icmp uge i32 %.val18.i89, %.val32.i73
  %i.na = icmp samesign uge i32 %.val19.i90, %.val33.i79
  %.sroa.0.0.i.i.i.i38.i = select i1 %i.my, i1 %i.na, i1 %i.mz ; 2 uses
  %i.nb = getelementptr inbounds i8, ptr %.sroa.43.129.i76, i64 -32 ; 3 uses
  %.sroa.01.0.i39.i91 = select i1 %.sroa.0.0.i.i.i.i38.i, ptr %2, ptr %i.nb
  %i.nc = getelementptr inbounds nuw [8 x i8], ptr %.sroa.01.0.i39.i91, i64 %i.mv
  %i.nd = load i64, ptr %i.mw, align 4, !alias.scope !1354, !noalias !1362
  store i64 %i.nd, ptr %i.nc, align 4, !alias.scope !1355, !noalias !1363
  %i.ne = zext i1 %.sroa.0.0.i.i.i.i38.i to i64
  %i.nf = add i64 %i.mv, %i.ne                    ; 2 uses
  %i.ng = getelementptr inbounds nuw i8, ptr %.sroa.9.131.i74, i64 32 ; 3 uses
  %i.nh = icmp ult ptr %i.ng, %i.lr
  br i1 %i.nh, label %bb.ae, label %._crit_edge.i51

._crit_edge.i51:                                  ; preds = %bb.ae, %bb.ad
  %.sroa.43.1.lcssa.i52 = phi ptr [ %.sroa.43.0.i47, %bb.ad ], [ %i.nb, %bb.ae ] ; 2 uses
  %.sroa.27.1.lcssa.i53 = phi i64 [ %.sroa.27.0.i48, %bb.ad ], [ %i.nf, %bb.ae ] ; 2 uses
  %.sroa.9.1.lcssa.i54 = phi ptr [ %.sroa.9.0.i49, %bb.ad ], [ %i.ng, %bb.ae ] ; 3 uses
  %i.ni = getelementptr inbounds nuw [8 x i8], ptr %.sroa.0.0.ph143, i64 %.sroa.0.0.i50 ; 2 uses
  %i.nj = icmp ult ptr %.sroa.9.1.lcssa.i54, %i.ni
  br i1 %i.nj, label %.lr.ph38.i63.preheader, label %._crit_edge39.i55
