...
bb.e:                                             ; preds = %bb.d, %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtNtNtCscdodAO9FK5_5alloc3vec9into_iter8IntoIterTRemEEECs2JiOgHzbbc7_10tokenizers.exit56.i, %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtNtNtCscdodAO9FK5_5alloc3vec9into_iter8IntoIterTRemEEECs2JiOgHzbbc7_10tokenizers.exit126.i
  ...
  invoke fastcc void @_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtNtCs7oYvdc6j6uT_9daachorse11nfa_builder10NfaBuilderhmEECs2JiOgHzbbc7_10tokenizers(ptr noalias noundef align 8 dereferenceable(64) %i.ag)
          to label %.thread212 unwind label %.thread209

.thread212:                                       ; preds = %bb.e
...
.loopexit.i93.i:                                  ; preds = %bb.cg, %bb.cf, %bb.cd, %bb.by
  ...
  br i1 %i.ie, label %bb.ch, label %.invoke2347
...
.preheader.i.i:                                   ; preds = %bb.by, %bb.cg
  ...
  br i1 %i.ig, label %bb.ca, label %.invoke2347
...
bb.ca:                                            ; preds = %.preheader.i.i
  ...
  br i1 %i.ij, label %.noexc.i91.i, label %.invoke2349, !prof !22
...
bb.ce:                                            ; preds = %bb.cb
  ...
  br i1 %i.iv, label %bb.cf, label %.invoke2349, !prof !22

.invoke2349:                                      ; preds = %bb.ce, %bb.ca
  ...
  invoke void @_RNvNtCs4NRVxsYgnAr_4core4cell30panic_already_mutably_borrowed(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.iw) #24
          to label %.cont2350 unwind label %.loopexit.split-lp.i88.i, !noalias !176
...
.invoke2347:                                      ; preds = %.loopexit.i93.i, %.preheader.i.i
  ...
  invoke void @_RNvNtCs4NRVxsYgnAr_4core9panicking18panic_bounds_check(i64 noundef %i.je, i64 noundef %.val48.i, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.jf) #24
          to label %.cont2348 unwind label %.loopexit.split-lp.i88.i, !noalias !176

.cont2348:                                        ; preds = %.invoke2347
  unreachable
...
.lr.ph.i100.i:                                    ; preds = %bb.cm, %bb.cz
  %.sroa.0.063.i.i = phi ptr [ %i.ju, %bb.cz ], [ %i.jp, %bb.cm ] ; 2 uses
  %i.ju = getelementptr inbounds nuw i8, ptr %.sroa.0.063.i.i, i64 4 ; 2 uses
  %i.jv = load i32, ptr %.sroa.0.063.i.i, align 4, !alias.scope !197, !noalias !199, !noundef !4
...
bb.cr:                                            ; preds = %bb.cp
  ...
  br i1 %i.kj, label %bb.cs, label %bb.cu, !prof !23
...
bb.ct:                                            ; preds = %bb.cp
  ...
  br i1 %i.ko, label %bb.da, label %.invoke2351

bb.cu:                                            ; preds = %bb.cr
  %3 = trunc nuw i64 %i.kh to i32
  %4 = add nuw i32 %3, 1
  %i.kp = getelementptr inbounds nuw i8, ptr %i.ka, i64 44
  store i32 %4, ptr %i.kp, align 4, !noalias !200
  ...
  br i1 %i.ku, label %bb.cv, label %.invoke2351
...
bb.cv:                                            ; preds = %bb.cu
  ...
  br i1 %i.ky, label %bb.cw, label %.invoke2353, !prof !22
...
bb.da:                                            ; preds = %bb.ct
  ...
  br i1 %i.ln, label %bb.db, label %.invoke2353, !prof !22

.invoke2353:                                      ; preds = %bb.da, %bb.cv
  ...
  invoke void @_RNvNtCs4NRVxsYgnAr_4core4cell30panic_already_mutably_borrowed(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.lo) #24
          to label %.cont2354 unwind label %.loopexit.split-lp.i102.i, !noalias !200

.cont2354:                                        ; preds = %.invoke2353
  unreachable

.invoke2351:                                      ; preds = %bb.ct, %bb.cu
  ...
  invoke void @_RNvNtCs4NRVxsYgnAr_4core9panicking18panic_bounds_check(i64 noundef %i.lp, i64 noundef %i.lq, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.lr) #24
          to label %.cont2352 unwind label %.loopexit.split-lp.i102.i, !noalias !200
...
.loopexit.split-lp.i102.i:                        ; preds = %.invoke2353, %.invoke2351, %bb.cs
...
_RNvMs1_NtCs7oYvdc6j6uT_9daachorse11nfa_builderINtB5_10NfaBuilderhmE13build_outputsCs2JiOgHzbbc7_10tokenizers.exit.i: ; preds = %bb.cz, %bb.cm
  ...
  %.sroa.2797.0.copyload = load i64, ptr %i.am, align 8, !noalias !136
...
_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtNtCscdodAO9FK5_5alloc3vec3VecmEECs2JiOgHzbbc7_10tokenizers.exit.i: ; preds = %_RNvMs1_NtCs7oYvdc6j6uT_9daachorse11nfa_builderINtB5_10NfaBuilderhmE13build_outputsCs2JiOgHzbbc7_10tokenizers.exit.i
  invoke void @_RNvXs1_NtCscdodAO9FK5_5alloc7raw_vecINtB5_6RawVecmENtNtNtCs4NRVxsYgnAr_4core3ops4drop4Drop4dropCs2JiOgHzbbc7_10tokenizers(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.ae)
          to label %bb.ef unwind label %.thread209
...
bb.dh:                                            ; preds = %.invoke657.i, %.invoke655.i, %.invoke653.i
...
.lr.ph.i:                                         ; preds = %bb.di, %bb.ds
  %.sroa.0119.0.i278.i = phi ptr [ %i.mk, %bb.ds ], [ %.sroa.04.0.copyload.i, %bb.di ] ; 2 uses
  %.sroa.039.0.i277.i = phi i32 [ %.sroa.039.1.i.i, %bb.ds ], [ 0, %bb.di ]
  %i.mk = getelementptr inbounds nuw i8, ptr %.sroa.0119.0.i278.i, i64 1 ; 2 uses
  %i.ml = load i8, ptr %.sroa.0119.0.i278.i, align 1, !noalias !221, !noundef !4 ; 2 uses
  %i.mm = load i8, ptr %i.am, align 8, !range !3, !alias.scope !215, !noalias !222, !noundef !4
  %i.mn = icmp eq i8 %i.mm, 2
  %.pre436.i = load i64, ptr %.sroa.5.0..sroa_idx.i.i, align 8, !noalias !139 ; 3 uses
  %i.mo = zext i32 %.sroa.039.0.i277.i to i64     ; 9 uses
  br i1 %i.mn, label %bb.dl, label %.lr.ph._crit_edge.i

bb.dl:                                            ; preds = %.lr.ph.i
  %i.mp = icmp ugt i64 %.pre436.i, %i.mo
  br i1 %i.mp, label %bb.dm, label %.invoke655.i
...
begin_hunk_2_@_RINvMs_NtNtCs7oYvdc6j6uT_9daachorse8bytewise7builderNtB5_29DoubleArrayAhoCorasickBuilder17build_with_valuesINtNtCscdodAO9FK5_5alloc3vec3VecTRemEEB2e_mECs2JiOgHzbbc7_10tokenizers:bb.a
  ...
  br i1 %i.nc, label %.noexc32.i, label %.invoke653.i, !prof !22

.invoke653.i:                                     ; preds = %bb.dn, %bb.dm
  ...
  invoke void @_RNvNtCs4NRVxsYgnAr_4core4cell30panic_already_mutably_borrowed(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.nd) #24
          to label %.cont654.i unwind label %bb.dh, !noalias !139

.cont654.i:                                       ; preds = %.invoke653.i
  unreachable
...
.invoke655.i:                                     ; preds = %._crit_edge.i, %bb.dt, %.lr.ph._crit_edge.i, %bb.dl
  %i.nh = phi i64 [ %i.mo, %bb.dt ], [ %i.mo, %bb.dl ], [ %i.mo, %.lr.ph._crit_edge.i ], [ %i.or, %._crit_edge.i ]
  %i.ni = phi i64 [ %i.ns, %bb.dt ], [ %i.mx, %.lr.ph._crit_edge.i ], [ %.pre436.i, %bb.dl ], [ %i.os, %._crit_edge.i ]
  ...
  invoke void @_RNvNtCs4NRVxsYgnAr_4core9panicking18panic_bounds_check(i64 noundef %i.nh, i64 noundef %i.ni, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.nj) #24
          to label %.cont656.i unwind label %bb.dh, !noalias !139

.cont656.i:                                       ; preds = %.invoke655.i
  unreachable
...
bb.dt:                                            ; preds = %bb.dr
  ...
  br i1 %i.nx, label %bb.du, label %.invoke655.i
...
bb.du:                                            ; preds = %bb.dt
  ...
  br i1 %i.ob, label %bb.dv, label %.invoke657.i, !prof !22
...
._crit_edge.i:                                    ; preds = %bb.ds
  ...
  br i1 %i.ot, label %bb.ea, label %.invoke655.i
...
bb.ea:                                            ; preds = %._crit_edge.i
  ...
  br i1 %i.ox, label %bb.eb, label %.invoke657.i, !prof !22
...
.invoke657.i:                                     ; preds = %bb.ea, %bb.du
  ...
  invoke void @_RNvNtCs4NRVxsYgnAr_4core4cell22panic_already_borrowed(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.pb) #24
          to label %.cont658.i unwind label %bb.dh, !noalias !139

.cont658.i:                                       ; preds = %.invoke657.i
  unreachable
...
.loopexit.i:                                      ; preds = %bb.dr, %.noexc30.i, %bb.dk, %bb.dj
  ...
  %.sroa.17.1.ph.i = phi i64 [ 13, %bb.dj ], [ %.sroa.462.0.copyload.i, %.noexc30.i ], [ 13, %bb.dk ], [ 8, %bb.dr ]
  %.sroa.25.0.ph.i = phi i32 [ -1, %bb.dj ], [ undef, %.noexc30.i ], [ 1, %bb.dk ], [ undef, %bb.dr ]
  %.sroa.20.1.ph.i = phi ptr [ @106, %bb.dj ], [ %.sroa.563.0.copyload.i, %.noexc30.i ], [ @4, %bb.dk ], [ inttoptr (i64 4294967295 to ptr), %bb.dr ]
  %.sroa.11.1.ph.i = phi ptr [ %i.mi, %bb.dj ], [ %.sroa.061.0.copyload.i, %.noexc30.i ], [ %i.mj, %bb.dk ], [ @102, %bb.dr ]
...
.thread209:                                       ; preds = %bb.in, %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtNtCscdodAO9FK5_5alloc3vec3VecmEECs2JiOgHzbbc7_10tokenizers.exit.i, %bb.e
...
bb.eg:                                            ; preds = %.thread212, %bb.ef
  %.sroa.9.1228 = phi i64 [ %.sroa.9.0, %.thread212 ], [ %.sroa.9.0.copyload, %bb.ef ]
  %.sroa.14.1227 = phi ptr [ %.sroa.14.0, %.thread212 ], [ %.sroa.14.0.copyload, %bb.ef ]
  %.sroa.17.1226 = phi i64 [ %.sroa.17.0, %.thread212 ], [ %.sroa.17.0.copyload, %bb.ef ]
  %.sroa.23.1225 = phi i64 [ 2, %.thread212 ], [ %.sroa.23.0.copyload, %bb.ef ]
  %.sroa.25.1224 = phi i32 [ %.sroa.25.0, %.thread212 ], [ %.sroa.25.0.copyload, %bb.ef ]
  %.sroa.27.0223 = phi i32 [ undef, %.thread212 ], [ %.sroa.27.0.copyload, %bb.ef ]
  %.sroa.20.1222 = phi ptr [ %.sroa.20.0, %.thread212 ], [ %.sroa.20.0.copyload, %bb.ef ]
  %i.pq = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i64 %.sroa.9.1228, ptr %i.pq, align 8
  %.sroa.4151.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 16
  store ptr %.sroa.14.1227, ptr %.sroa.4151.0..sroa_idx, align 8
  %.sroa.5152.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 24
  store i64 %.sroa.17.1226, ptr %.sroa.5152.0..sroa_idx, align 8
  %.sroa.6153.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 32
  store ptr %.sroa.20.1222, ptr %.sroa.6153.0..sroa_idx, align 8
  %.sroa.7154.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 40
  store i64 %.sroa.23.1225, ptr %.sroa.7154.0..sroa_idx, align 8
  %.sroa.8155.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 48
  store i32 %.sroa.25.1224, ptr %.sroa.8155.0..sroa_idx, align 8
  %.sroa.9156.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 52
  store i32 %.sroa.27.0223, ptr %.sroa.9156.0..sroa_idx, align 4
...
bb.eh:                                            ; preds = %bb.ef
  ...
  store i64 %.sroa.2797.0.copyload, ptr %.sroa.5.0..sroa_idx, align 8
  ...
  invoke void @_RNvMs_NtNtCs7oYvdc6j6uT_9daachorse8bytewise7builderNtB4_29DoubleArrayAhoCorasickBuilder10init_array(ptr noalias noundef nonnull sret([56 x i8]) align 8 captures(none) dereferenceable(56) %i.m, ptr noalias noundef nonnull align 8 dereferenceable(32) %1)
          to label %.noexc81 unwind label %bb.ie
...
.noexc81:                                         ; preds = %bb.eh
  ...
  %.sroa.5.i.sroa.0.0.copyload183 = load i64, ptr %i.pv, align 8, !noalias !243 ; 3 uses
  %.sroa.5.i.sroa.7.0..sroa_idx186 = getelementptr inbounds nuw i8, ptr %i.m, i64 16
  %.sroa.5.i.sroa.7.0.copyload187 = load ptr, ptr %.sroa.5.i.sroa.7.0..sroa_idx186, align 8, !noalias !243 ; 2 uses
  %.sroa.5.i.sroa.8.0..sroa_idx190 = getelementptr inbounds nuw i8, ptr %i.m, i64 24
  %.sroa.5.i.sroa.8.0.copyload191 = load i64, ptr %.sroa.5.i.sroa.8.0..sroa_idx190, align 8, !noalias !243 ; 2 uses
  %.sroa.5.i.sroa.9.0..sroa_idx194 = getelementptr inbounds nuw i8, ptr %i.m, i64 32
  %.sroa.5.i.sroa.9.0.copyload195 = load i32, ptr %.sroa.5.i.sroa.9.0..sroa_idx194, align 8, !noalias !243 ; 2 uses
  %.sroa.5.i.sroa.10.0..sroa_idx197 = getelementptr inbounds nuw i8, ptr %i.m, i64 36
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %.sroa.5.i.sroa.10, ptr noundef nonnull align 4 dereferenceable(20) %.sroa.5.i.sroa.10.0..sroa_idx197, i64 20, i1 false), !noalias !243
  call void @llvm.lifetime.end.p0(ptr nonnull %i.m), !noalias !243
  br i1 %i.pu, label %bb.if, label %bb.ei

bb.ei:                                            ; preds = %.noexc81
  store i64 %.sroa.5.i.sroa.0.0.copyload183, ptr %i.n, align 8, !noalias !243
  %.sroa.5.i.sroa.7.0..sroa_idx184 = getelementptr inbounds nuw i8, ptr %i.n, i64 8 ; 4 uses
  store ptr %.sroa.5.i.sroa.7.0.copyload187, ptr %.sroa.5.i.sroa.7.0..sroa_idx184, align 8, !noalias !243
  %.sroa.5.i.sroa.8.0..sroa_idx188 = getelementptr inbounds nuw i8, ptr %i.n, i64 16 ; 4 uses
  store i64 %.sroa.5.i.sroa.8.0.copyload191, ptr %.sroa.5.i.sroa.8.0..sroa_idx188, align 8, !noalias !243
  %.sroa.5.i.sroa.9.0..sroa_idx192 = getelementptr inbounds nuw i8, ptr %i.n, i64 24 ; 4 uses
  store i32 %.sroa.5.i.sroa.9.0.copyload195, ptr %.sroa.5.i.sroa.9.0..sroa_idx192, align 8, !noalias !243
  %.sroa.5.i.sroa.10.0..sroa_idx196 = getelementptr inbounds nuw i8, ptr %i.n, i64 28 ; 4 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %.sroa.5.i.sroa.10.0..sroa_idx196, ptr noundef nonnull align 4 dereferenceable(20) %.sroa.5.i.sroa.10, i64 20, i1 false), !noalias !243
...
_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtNtCscdodAO9FK5_5alloc3vec3VecNtNtCs7oYvdc6j6uT_9daachorse12build_helper8ListItemEECs2JiOgHzbbc7_10tokenizers.exit.i.i: ; preds = %.body.i65
  invoke void @_RNvXs1_NtCscdodAO9FK5_5alloc7raw_vecINtB5_6RawVecNtNtCs7oYvdc6j6uT_9daachorse12build_helper8ListItemENtNtNtCs4NRVxsYgnAr_4core3ops4drop4Drop4dropCs2JiOgHzbbc7_10tokenizers(ptr noalias noundef nonnull align 8 dereferenceable(48) %i.n)
          to label %.body82 unwind label %bb.gq, !noalias !248
...
.invoke.i69:                                      ; preds = %bb.gr, %bb.fg, %.peel.next1215, %bb.ey
  %i.ul = phi i64 [ %.sroa.8.02002.i, %.peel.next1215 ], [ 0, %bb.ey ], [ %i.ta, %bb.fg ], [ %i.ta, %bb.gr ]
  %i.um = phi i64 [ %i.uc, %.peel.next1215 ], [ 0, %bb.ey ], [ %i.ps, %bb.fg ], [ %i.vz, %bb.gr ]
  %i.un = phi ptr [ @8, %.peel.next1215 ], [ @8, %bb.ey ], [ @14, %bb.fg ], [ @15, %bb.gr ]
...
.noexc161.i:                                      ; preds = %bb.gf
  ...
  br i1 %i.ut, label %bb.gh, label %.loopexit1221

.loopexit:                                        ; preds = %bb.gf, %bb.fa
  %.sroa.02.02003.i.lcssa775.a = phi ptr [ %i.pr, %bb.fa ], [ %.sroa.02.02003.i, %bb.gf ]
  %.lcssa761 = phi i64 [ %i.rm, %bb.fa ], [ %i.up, %bb.gf ]
  %.lcssa756 = phi i64 [ %i.ri, %bb.fa ], [ %i.uh, %bb.gf ]
  invoke void @_RNvNtCs4NRVxsYgnAr_4core9panicking18panic_bounds_check(i64 noundef %.lcssa756, i64 noundef %.lcssa761, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @10) #24
          to label %bb.ex unwind label %bb.gg, !noalias !248

bb.gg:                                            ; preds = %.loopexit1223, %.loopexit1222, %.loopexit1224, %.loopexit
  %.sroa.02.02003.i781 = phi ptr [ %.sroa.02.02003.i.lcssa778, %.loopexit1223 ], [ %.sroa.02.02003.i.lcssa777, %.loopexit1222 ], [ %.sroa.02.02003.i.lcssa779, %.loopexit1224 ], [ %.sroa.02.02003.i.lcssa775.a, %.loopexit ] ; 2 uses
  %i.uu = landingpad { ptr, i32 }
          cleanup
  %i.uv = load i64, ptr %.sroa.02.02003.i781, align 8, !noalias !243, !noundef !4
  %i.uw = add i64 %i.uv, -1
  store i64 %i.uw, ptr %.sroa.02.02003.i781, align 8, !noalias !243
  br label %bb.fh
...
bb.gi:                                            ; preds = %bb.gh
  ...
  br i1 %i.vi, label %.backedge.i, label %.loopexit1224

bb.gj:                                            ; preds = %bb.gh
  %i.vj = zext i32 %i.vf to i64                   ; 3 uses
  %i.vk = load i64, ptr %i.qn, align 8, !noalias !243, !noundef !4 ; 2 uses
  %i.vl = icmp ugt i64 %i.vk, %i.vj
  br i1 %i.vl, label %bb.gk, label %.loopexit1222

.loopexit1224:                                    ; preds = %bb.gi, %bb.ff
  %.sroa.02.02003.i.lcssa779 = phi ptr [ %i.pr, %bb.ff ], [ %.sroa.02.02003.i, %bb.gi ]
  %.lcssa766 = phi i64 [ %i.sj, %bb.ff ], [ %i.vh, %bb.gi ]
  %.lcssa760 = phi i64 [ %i.ri, %bb.ff ], [ %i.uh, %bb.gi ]
  invoke void @_RNvNtCs4NRVxsYgnAr_4core9panicking18panic_bounds_check(i64 noundef %.lcssa760, i64 noundef %.lcssa766, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @11) #24
          to label %bb.ex unwind label %bb.gg, !noalias !248

bb.gk:                                            ; preds = %bb.gj
  %i.vm = load i64, ptr %i.rc, align 8, !alias.scope !240, !noalias !248, !noundef !4 ; 2 uses
  %i.vn = icmp ugt i64 %i.vm, %i.uh
  br i1 %i.vn, label %bb.gl, label %.loopexit1223

.loopexit1222:                                    ; preds = %bb.gj, %bb.fc
  %.sroa.02.02003.i.lcssa777 = phi ptr [ %i.pr, %bb.fc ], [ %.sroa.02.02003.i, %bb.gj ]
  %.lcssa739.a = phi i64 [ %i.sb, %bb.fc ], [ %i.vj, %bb.gj ]
  %.lcssa = phi i64 [ %i.sc, %bb.fc ], [ %i.vk, %bb.gj ]
  invoke void @_RNvNtCs4NRVxsYgnAr_4core9panicking18panic_bounds_check(i64 noundef %.lcssa739.a, i64 noundef %.lcssa, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @12) #24
          to label %bb.ex unwind label %bb.gg, !noalias !248
...
.loopexit1223:                                    ; preds = %bb.gk, %bb.fd
  %.sroa.02.02003.i.lcssa778 = phi ptr [ %i.pr, %bb.fd ], [ %.sroa.02.02003.i, %bb.gk ]
  %.lcssa759 = phi i64 [ %i.ri, %bb.fd ], [ %i.uh, %bb.gk ]
  %.lcssa741 = phi i64 [ %i.se, %bb.fd ], [ %i.vm, %bb.gk ]
  invoke void @_RNvNtCs4NRVxsYgnAr_4core9panicking18panic_bounds_check(i64 noundef %.lcssa759, i64 noundef %.lcssa741, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @13) #24
          to label %bb.ex unwind label %bb.gg, !noalias !248
...
.backedge.i:                                      ; preds = %bb.gl, %bb.gi
  ...
  br i1 %i.vv, label %.thread.i79, label %.peel.next1215, !llvm.loop !258

.loopexit1221:                                    ; preds = %.noexc161.i, %.noexc161.i.peel
  %.sroa.02.02003.i.lcssa776 = phi ptr [ %i.pr, %.noexc161.i.peel ], [ %.sroa.02.02003.i, %.noexc161.i ]
  %.lcssa751 = phi i64 [ %i.rj, %.noexc161.i.peel ], [ %i.ui, %.noexc161.i ]
  store i64 %.lcssa751, ptr %.sroa.02.02003.i.lcssa776, align 8, !noalias !243
  br label %bb.gm

bb.gm:                                            ; preds = %bb.hv, %.loopexit1221
  %.sroa.11.0 = phi i32 [ 16777215, %.loopexit1221 ], [ %.sroa.11.0.copyload109, %bb.hv ]
  %.sroa.10.0 = phi i64 [ 10, %.loopexit1221 ], [ %.sroa.10.0.copyload106, %bb.hv ]
  %.sroa.9101.0 = phi ptr [ @116, %.loopexit1221 ], [ %.sroa.9101.0.copyload103, %bb.hv ]
  %.sroa.098.0 = phi i64 [ 2, %.loopexit1221 ], [ %i.zq, %bb.hv ]
...
.backedge90.i:                                    ; preds = %bb.hr, %bb.gt
  ...
  %i.wp = phi i64 [ %.pre.i77, %bb.hr ], [ %i.ss, %bb.gt ]
...
bb.gw:                                            ; preds = %bb.gv, %bb.gu
  %.sroa.013.sroa.5.sroa.6.0.i.a = phi i64 [ 1, %bb.gv ], [ 0, %bb.gu ] ; 2 uses
  %.sroa.013.sroa.0.0.i = phi i64 [ %i.ws, %bb.gv ], [ undef, %bb.gu ] ; 2 uses
  %.sroa.514.0.i = phi i64 [ %i.wl, %bb.gv ], [ 0, %bb.gu ]
  store i64 %.sroa.013.sroa.5.sroa.6.0.i.a, ptr %i.i, align 8, !noalias !243
  ...
  store i64 %.sroa.013.sroa.0.0.i, ptr %.sroa.013.sroa.5.sroa.6.0..sroa.013.sroa.5.0..sroa_idx.sroa_idx.i, align 8, !noalias !243
  store i64 %.sroa.013.sroa.5.sroa.6.0.i.a, ptr %.sroa.013.sroa.6.0..sroa_idx.i, align 8, !noalias !243
  ...
  store i64 %.sroa.013.sroa.0.0.i, ptr %.sroa.013.sroa.7.sroa.6.0..sroa.013.sroa.7.0..sroa_idx.sroa_idx.i, align 8, !noalias !243
...
.loopexit.split-lp80.loopexit.split-lp.loopexit.split-lp.i: ; preds = %.invoke2363, %.invoke2361, %.invoke2359, %.invoke2357, %.invoke2355
...
_RINvYINtNtNtNtCscdodAO9FK5_5alloc11collections5btree3map4KeyshmENtNtNtNtCs4NRVxsYgnAr_4core4iter6traits8iterator8Iterator4folduNCINvNvB10_8for_each4callRhNCINvMs_NtNtCs7oYvdc6j6uT_9daachorse8bytewise7builderNtB2A_29DoubleArrayAhoCorasickBuilder18build_double_arraymE0E0ECs2JiOgHzbbc7_10tokenizers.exit.i: ; preds = %.noexc263.i, %.noexc261.i
  ...
  %i.xg = load i32, ptr %.sroa.5.i.sroa.9.0..sroa_idx192, align 8, !range !277, !alias.scope !275, !noalias !278, !noundef !4
  %i.xh = load i32, ptr %.sroa.5.i.sroa.10.0..sroa_idx196, align 4, !alias.scope !275, !noalias !278 ; 9 uses
  ...
  %i.xp = load i64, ptr %.sroa.5.i.sroa.8.0..sroa_idx188, align 8, !noalias !243 ; 10 uses
  ...
  %i.xu = load ptr, ptr %.sroa.5.i.sroa.7.0..sroa_idx184, align 8, !noalias !243, !nonnull !4 ; 3 uses
...
.noexc189.us.i:                                   ; preds = %_RINvYINtNtNtNtCscdodAO9FK5_5alloc11collections5btree3map4KeyshmENtNtNtNtCs4NRVxsYgnAr_4core4iter6traits8iterator8Iterator4folduNCINvNvB10_8for_each4callRhNCINvMs_NtNtCs7oYvdc6j6uT_9daachorse8bytewise7builderNtB2A_29DoubleArrayAhoCorasickBuilder18build_double_arraymE0E0ECs2JiOgHzbbc7_10tokenizers.exit.split.us.i
  ...
  br i1 %.sroa.0.0.i265.us.i, label %.split351.us.i, label %.invoke2361, !prof !22
...
.noexc189.us486.i:                                ; preds = %_RINvYINtNtNtNtCscdodAO9FK5_5alloc11collections5btree3map4KeyshmENtNtNtNtCs4NRVxsYgnAr_4core4iter6traits8iterator8Iterator4folduNCINvNvB10_8for_each4callRhNCINvMs_NtNtCs7oYvdc6j6uT_9daachorse8bytewise7builderNtB2A_29DoubleArrayAhoCorasickBuilder18build_double_arraymE0E0ECs2JiOgHzbbc7_10tokenizers.exit.split.split.us.i
  ...
  br i1 %.sroa.0.0.i265.us488.i, label %.invoke2357, label %.invoke2361, !prof !22
...
.noexc189.us628.us.i:                             ; preds = %_RINvYINtNtNtNtCscdodAO9FK5_5alloc11collections5btree3map4KeyshmENtNtNtNtCs4NRVxsYgnAr_4core4iter6traits8iterator8Iterator4folduNCINvNvB10_8for_each4callRhNCINvMs_NtNtCs7oYvdc6j6uT_9daachorse8bytewise7builderNtB2A_29DoubleArrayAhoCorasickBuilder18build_double_arraymE0E0ECs2JiOgHzbbc7_10tokenizers.exit.split.split.split.us.i
  ...
  br i1 %.sroa.0.0.i265.us630.us.i, label %_RNvMNtCs4NRVxsYgnAr_4core6resultINtB2_6ResultmNtNtNtB4_3num5error15TryFromIntErrorE6unwrapCs2JiOgHzbbc7_10tokenizers.exit.i.i183.us631.us.i, label %.invoke2361, !prof !22
...
_RNvMNtCs4NRVxsYgnAr_4core6resultINtB2_6ResultmNtNtNtB4_3num5error15TryFromIntErrorE6unwrapCs2JiOgHzbbc7_10tokenizers.exit.i.i183.us631.us.i: ; preds = %.noexc189.us628.us.i
  ...
  br i1 %i.yc, label %.invoke2355, label %.split635.us.i
...
.noexc189.us628.i:                                ; preds = %_RINvYINtNtNtNtCscdodAO9FK5_5alloc11collections5btree3map4KeyshmENtNtNtNtCs4NRVxsYgnAr_4core4iter6traits8iterator8Iterator4folduNCINvNvB10_8for_each4callRhNCINvMs_NtNtCs7oYvdc6j6uT_9daachorse8bytewise7builderNtB2A_29DoubleArrayAhoCorasickBuilder18build_double_arraymE0E0ECs2JiOgHzbbc7_10tokenizers.exit.split.split.split.us.split.split.split.i
  ...
  br i1 %.sroa.0.0.i265.us630.i, label %_RNvMNtCs4NRVxsYgnAr_4core6resultINtB2_6ResultmNtNtNtB4_3num5error15TryFromIntErrorE6unwrapCs2JiOgHzbbc7_10tokenizers.exit.i.i183.us631.i, label %.invoke2361, !prof !22
...
_RNvMNtCs4NRVxsYgnAr_4core6resultINtB2_6ResultmNtNtNtB4_3num5error15TryFromIntErrorE6unwrapCs2JiOgHzbbc7_10tokenizers.exit.i.i183.us631.i: ; preds = %.noexc189.us628.i
  ...
  br i1 %i.yg, label %.noexc170.us.i, label %.invoke2355
...
.noexc170.us.i:                                   ; preds = %_RNvMNtCs4NRVxsYgnAr_4core6resultINtB2_6ResultmNtNtNtB4_3num5error15TryFromIntErrorE6unwrapCs2JiOgHzbbc7_10tokenizers.exit.i.i183.us631.i
  ...
  br i1 %.sroa.0.0.i269.us.i, label %_RNvMNtCs4NRVxsYgnAr_4core6resultINtB2_6ResultmNtNtNtB4_3num5error15TryFromIntErrorE6unwrapCs2JiOgHzbbc7_10tokenizers.exit.i7.i.i.us.i, label %.invoke2361, !prof !22
...
_RNvMNtCs4NRVxsYgnAr_4core6resultINtB2_6ResultmNtNtNtB4_3num5error15TryFromIntErrorE6unwrapCs2JiOgHzbbc7_10tokenizers.exit.i7.i.i.us.i: ; preds = %.noexc170.us.i
  ...
  br i1 %i.yp, label %bb.gy, label %.invoke2355
...
.noexc175.us.i:                                   ; preds = %bb.gy, %.preheader.i
  %.sroa.01.0.i.i.us.i2343 = phi ptr [ %i.yv, %.preheader.i ], [ %i.xe, %bb.gy ] ; 2 uses
  %i.yv = getelementptr inbounds nuw i8, ptr %.sroa.01.0.i.i.us.i2343, i64 1 ; 2 uses
  %i.yw = load i8, ptr %.sroa.01.0.i.i.us.i2343, align 1, !alias.scope !294, !noalias !295, !noundef !4
  ...
  br i1 %.sroa.0.0.i271.us.i, label %_RNvMNtCs7oYvdc6j6uT_9daachorse12build_helperNtB2_11BuildHelper6offset.exit.i.i.us.i, label %.invoke2361, !prof !22
...
_RNvMNtCs7oYvdc6j6uT_9daachorse12build_helperNtB2_11BuildHelper6offset.exit.i.i.us.i: ; preds = %.noexc175.us.i
  ...
  br i1 %i.zc, label %bb.gz, label %.invoke2355
...
_RINvMNtCs4NRVxsYgnAr_4core6optionINtB3_6OptionRNtNtNtB5_3str4iter5CharsE6map_orTjIBw_jEENvYBJ_NtNtNtNtB5_4iter6traits8iterator8Iterator9size_hintECs2JiOgHzbbc7_10tokenizers.exit68.i.i.i.i: ; preds = %bb.h, %_RINvMNtCs4NRVxsYgnAr_4core6optionINtB3_6OptionRNtNtNtB5_3str4iter5CharsE6map_orTjIBw_jEENvYBJ_NtNtNtNtB5_4iter6traits8iterator8Iterator9size_hintECs2JiOgHzbbc7_10tokenizers.exit.i.i.i.i
  %.sroa.8.0.i.i.i.i.a = phi i64 [ %.sroa.0.0.i.i.i67.i.i.i.i, %bb.h ], [ 0, %_RINvMNtCs4NRVxsYgnAr_4core6optionINtB3_6OptionRNtNtNtB5_3str4iter5CharsE6map_orTjIBw_jEENvYBJ_NtNtNtNtB5_4iter6traits8iterator8Iterator9size_hintECs2JiOgHzbbc7_10tokenizers.exit.i.i.i.i ]
  %.sroa.075.0.i.i.i.i = phi i64 [ %i.w, %bb.h ], [ 0, %_RINvMNtCs4NRVxsYgnAr_4core6optionINtB3_6OptionRNtNtNtB5_3str4iter5CharsE6map_orTjIBw_jEENvYBJ_NtNtNtNtB5_4iter6traits8iterator8Iterator9size_hintECs2JiOgHzbbc7_10tokenizers.exit.i.i.i.i ]
  ...
  %i.ad = add i64 %.sroa.075.0.i.i.i.i, %.sroa.7.0.i.i.i.i ; 2 uses
  ...
  %i.af = add nuw i64 %.sroa.8.0.i.i.i.i.a, %.sroa.0.0.i.i.i.i
...
_RINvMNtCs4NRVxsYgnAr_4core6optionINtB3_6OptionRNtNtNtB5_3str4iter5CharsE6map_orTjIBw_jEENvYBJ_NtNtNtNtB5_4iter6traits8iterator8Iterator9size_hintECs2JiOgHzbbc7_10tokenizers.exit68.i.i21.i.i: ; preds = %bb.k, %_RINvMNtCs4NRVxsYgnAr_4core6optionINtB3_6OptionRNtNtNtB5_3str4iter5CharsE6map_orTjIBw_jEENvYBJ_NtNtNtNtB5_4iter6traits8iterator8Iterator9size_hintECs2JiOgHzbbc7_10tokenizers.exit.i.i14.i.i
  %.sroa.8.0.i.i22.i.i = phi i64 [ %.sroa.0.0.i.i.i67.i.i20.i.i, %bb.k ], [ 0, %_RINvMNtCs4NRVxsYgnAr_4core6optionINtB3_6OptionRNtNtNtB5_3str4iter5CharsE6map_orTjIBw_jEENvYBJ_NtNtNtNtB5_4iter6traits8iterator8Iterator9size_hintECs2JiOgHzbbc7_10tokenizers.exit.i.i14.i.i ]
  %.sroa.075.0.i.i23.i.i = phi i64 [ %i.bf, %bb.k ], [ 0, %_RINvMNtCs4NRVxsYgnAr_4core6optionINtB3_6OptionRNtNtNtB5_3str4iter5CharsE6map_orTjIBw_jEENvYBJ_NtNtNtNtB5_4iter6traits8iterator8Iterator9size_hintECs2JiOgHzbbc7_10tokenizers.exit.i.i14.i.i ]
...
bb.l:                                             ; preds = %_RINvMNtCs4NRVxsYgnAr_4core6optionINtB3_6OptionRNtNtNtB5_3str4iter5CharsE6map_orTjIBw_jEENvYBJ_NtNtNtNtB5_4iter6traits8iterator8Iterator9size_hintECs2JiOgHzbbc7_10tokenizers.exit68.i.i21.i.i
  %i.bm = add i64 %.sroa.075.0.i.i23.i.i, %.sroa.7.0.i.i15.i.i ; 2 uses
...
_RNvXs1_NtNtNtCs4NRVxsYgnAr_4core4iter8adapters7flattenINtB5_7FlatMapINtNtNtBb_5slice4iter4IterTNtNtCscdodAO9FK5_5alloc6string6StringmEENtNtNtBb_3str4iter5CharsNCNvMs_NtNtNtCs2JiOgHzbbc7_10tokenizers6models7unigram7trainerNtB2E_14UnigramTrainer14required_chars0ENtNtNtB9_6traits8iterator8Iterator9size_hintB2K_.exit29.i.i: ; preds = %bb.l, %_RINvMNtCs4NRVxsYgnAr_4core6optionINtB3_6OptionRNtNtNtB5_3str4iter5CharsE6map_orTjIBw_jEENvYBJ_NtNtNtNtB5_4iter6traits8iterator8Iterator9size_hintECs2JiOgHzbbc7_10tokenizers.exit68.i.i21.i.i
  ...
  %i.bp = add nuw i64 %.sroa.8.0.i.i22.i.i, %.sroa.0.0.i.i16.i.i
...
bb.ab:                                            ; preds = %bb.t, %bb.aa
  %.sroa.745.0.a = phi i32 [ %.sroa.463.sroa.0.0.copyload, %bb.aa ], [ %.sroa.591.0.extract.trunc, %bb.t ]
  %.sroa.538.0 = phi i32 [ %.sroa.591.0.extract.trunc, %bb.aa ], [ undef, %bb.t ]
  store i64 %i.cz, ptr %0, align 8
  %.sroa.538.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i32 %.sroa.745.0.a, ptr %.sroa.538.0..sroa_idx, align 8
  ...
  store i32 %.sroa.538.0, ptr %.sroa.745.0..sroa_idx, align 8
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.7)
  br label %bb.ac
