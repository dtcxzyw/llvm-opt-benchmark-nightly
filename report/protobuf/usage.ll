...
.lr.ph:                                           ; preds = %_ZNK4absl12lts_2025051216strings_internal8SplitterINS0_9ByAnyCharENS0_9SkipEmptyESt17basic_string_viewIcSt11char_traitsIcEEE3endEv.exit.preheader, %_ZN4absl12lts_2025051216strings_internal13SplitIteratorINS1_8SplitterINS0_9ByAnyCharENS0_9SkipEmptyESt17basic_string_viewIcSt11char_traitsIcEEEEEppEv.exit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %13, ptr noundef nonnull align 8 dereferenceable(16) %i.v, i64 16, i1 false), !tbaa.struct !105
...
.noexc72:                                         ; preds = %_ZNKSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE12_M_check_lenEmPKc.exit.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.em, ptr noundef nonnull align 8 dereferenceable(16) %13, i64 16, i1 false), !tbaa.struct !105
...
14:                                               ; preds = %.loopexit.split-lp181, %.loopexit180
  %lpad.phi186 = phi { ptr, i32 } [ %lpad.loopexit182, %.loopexit180 ], [ %lpad.loopexit.split-lp183, %.loopexit.split-lp181 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %13)
  br label %bb.ai

bb.ai:                                            ; preds = %.loopexit, %.loopexit.split-lp, %14
  %.sroa.29.3 = phi ptr [ %.sroa.14.2283, %14 ], [ %.sroa.29.12, %.loopexit ], [ %.sroa.29.12, %.loopexit.split-lp ] ; 2 uses
  %.sroa.0150.3 = phi ptr [ %.sroa.0150.2284, %14 ], [ %.sroa.0150.12, %.loopexit ], [ %.sroa.0150.12, %.loopexit.split-lp ] ; 2 uses
  %.pn = phi { ptr, i32 } [ %lpad.phi186, %14 ], [ %lpad.loopexit, %.loopexit ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ] ; 2 uses
...
bb.r:                                             ; preds = %_ZNSt6vectorIPKN4absl12lts_2025051215CommandLineFlagESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit16.i.i.i.i.i.i
  %5 = load ptr, ptr %i.bb, align 8, !tbaa !142
  %6 = ptrtoint ptr %5 to i64
  %7 = sub i64 %6, %i.bg
  call void @_ZdlPvm(ptr noundef nonnull %i.be, i64 noundef %7) #24
