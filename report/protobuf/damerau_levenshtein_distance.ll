...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec129 = and i64 %i.j, 252                   ; 4 uses
  %i.r = trunc nuw i64 %n.vec129 to i8
  %i.s = getelementptr i8, ptr %5, i64 %n.vec129
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %vec.ind131 = phi <4 x i8> [ %induction, %vec.epilog.ph ], [ %vec.ind.next134, %vec.epilog.vector.body ] ; 2 uses
  %next.gep132 = getelementptr i8, ptr %5, i64 %index130
  store <4 x i8> %vec.ind131, ptr %next.gep132, align 4, !tbaa !7
  %index.next133 = add nuw i64 %index130, 4       ; 2 uses
  %vec.ind.next134 = add nuw nsw <4 x i8> %vec.ind131, splat (i8 4)
  %i.t = icmp eq i64 %index.next133, %n.vec129
  br i1 %i.t, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !9

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n135 = icmp eq i64 %i.j, %n.vec129
  br i1 %cmp.n135, label %_ZSt4iotaIPhiEvT_S1_T0_.exit, label %.lr.ph.i.preheader
...
.lr.ph:                                           ; preds = %bb.l
  ...
  %i.ax = icmp ugt i64 %.05794, 1
  %i.ay = add i64 %.05794, -2                     ; 2 uses
  %i.az = getelementptr inbounds nuw i8, ptr %.sroa.9.0, i64 %i.ay
  %i.ba = getelementptr inbounds nuw [102 x i8], ptr %5, i64 %i.ay
  br i1 %i.ax, label %.lr.ph.split.preheader, label %.lr.ph.split.us.preheader

.lr.ph.split.us.preheader:                        ; preds = %.lr.ph
  %scevgep138 = getelementptr i8, ptr %scevgep, i64 %.058
  %load_initial = load i8, ptr %scevgep138, align 1
  br label %.lr.ph.split.us

.lr.ph.split.preheader:                           ; preds = %.lr.ph
  %scevgep140 = getelementptr i8, ptr %scevgep139, i64 %.058
  %load_initial141 = load i8, ptr %scevgep140, align 1
  br label %.lr.ph.split

.lr.ph.split.us:                                  ; preds = %.lr.ph.split.us.preheader, %.lr.ph.split.us
  %store_forwarded = phi i8 [ %load_initial, %.lr.ph.split.us.preheader ], [ %.sroa.speculated103, %.lr.ph.split.us ]
  %.06093.us = phi i64 [ %.058, %.lr.ph.split.us.preheader ], [ %i.bu, %.lr.ph.split.us ] ; 4 uses
  %i.bb = getelementptr inbounds nuw i8, ptr %i.at, i64 %.06093.us
  %i.bc = load i8, ptr %i.bb, align 1, !tbaa !7
  %i.bd = add i8 %i.bc, 1                         ; 2 uses
  %i.be = add i64 %.06093.us, -1                  ; 2 uses
  %i.bf = add i8 %store_forwarded, 1              ; 3 uses
  %i.bg = getelementptr inbounds nuw i8, ptr %.sroa.11.0, i64 %i.be
  %i.bh = load i8, ptr %i.bg, align 1, !tbaa !7
  %i.bi = icmp ne i8 %i.aw, %i.bh
  %i.bj = getelementptr inbounds nuw i8, ptr %i.at, i64 %i.be
  %i.bk = load i8, ptr %i.bj, align 1, !tbaa !7
  %i.bl = zext i1 %i.bi to i8
  %i.bm = add i8 %i.bk, %i.bl                     ; 3 uses
  %i.bn = call i8 @llvm.umin.i8(i8 %i.bd, i8 %i.a) ; 2 uses
  %i.bo = icmp ult i8 %i.bf, %i.bn
  %i.bp = call i8 @llvm.umin.i8(i8 %i.bf, i8 %i.bn) ; 2 uses
  %i.bq = icmp ult i8 %i.bm, %i.bp
  %i.br = call i8 @llvm.umin.i8(i8 %i.bm, i8 %i.bp)
  %i.bs = icmp samesign ult i8 %i.a, %i.br
  %.sroa.speculate.load.false102.sroa.speculate.load.false.sroa.speculate.load.false.sroa.speculated = call i8 @llvm.umin.i8(i8 %i.bd, i8 %i.a)
  %.sroa.speculate.load.false102.sroa.speculate.load.false.sroa.speculated = select i1 %i.bo, i8 %i.bf, i8 %.sroa.speculate.load.false102.sroa.speculate.load.false.sroa.speculate.load.false.sroa.speculated
  %.sroa.speculate.load.false102.sroa.speculated = select i1 %i.bq, i8 %i.bm, i8 %.sroa.speculate.load.false102.sroa.speculate.load.false.sroa.speculated
  %.sroa.speculated103 = select i1 %i.bs, i8 %i.a, i8 %.sroa.speculate.load.false102.sroa.speculated ; 2 uses
  %i.bt = getelementptr inbounds nuw i8, ptr %i.au, i64 %.06093.us
  store i8 %.sroa.speculated103, ptr %i.bt, align 1, !tbaa !7
  %i.bu = add i64 %.06093.us, 1                   ; 2 uses
  %.not64.us = icmp ugt i64 %i.bu, %.059
  br i1 %.not64.us, label %._crit_edge, label %.lr.ph.split.us, !llvm.loop !14

._crit_edge:                                      ; preds = %.lr.ph.split.us, %.lr.ph.i.i, %bb.l
  %i.bv = add nuw i64 %.05794, 1
...
.lr.ph.split:                                     ; preds = %.lr.ph.split.preheader, %.lr.ph.i.i
  %store_forwarded142 = phi i8 [ %load_initial141, %.lr.ph.split.preheader ], [ %.sroa.speculated100, %.lr.ph.i.i ]
  %.06093 = phi i64 [ %.058, %.lr.ph.split.preheader ], [ %i.cz, %.lr.ph.i.i ] ; 7 uses
  %i.bw = getelementptr inbounds nuw i8, ptr %i.at, i64 %.06093
  %i.bx = load i8, ptr %i.bw, align 1, !tbaa !7
  %i.by = add i8 %i.bx, 1                         ; 2 uses
  %i.bz = add nsw i64 %.06093, -1                 ; 2 uses
  %i.ca = add i8 %store_forwarded142, 1           ; 3 uses
  %i.cb = getelementptr inbounds nuw i8, ptr %.sroa.11.0, i64 %i.bz
  %i.cc = load i8, ptr %i.cb, align 1, !tbaa !7   ; 2 uses
  %i.cd = icmp ne i8 %i.aw, %i.cc
  %i.ce = getelementptr inbounds nuw i8, ptr %i.at, i64 %i.bz
  %i.cf = load i8, ptr %i.ce, align 1, !tbaa !7
  %i.cg = zext i1 %i.cd to i8
  %i.ch = add i8 %i.cf, %i.cg                     ; 3 uses
  %i.ci = icmp ugt i64 %.06093, 1
  br i1 %i.ci, label %bb.m, label %.lr.ph.i.i

bb.m:                                             ; preds = %.lr.ph.split
  %i.cj = add nsw i64 %.06093, -2                 ; 2 uses
  %i.ck = getelementptr inbounds nuw i8, ptr %.sroa.11.0, i64 %i.cj
  %i.cl = load i8, ptr %i.ck, align 1, !tbaa !7
  %i.cm = icmp eq i8 %i.aw, %i.cl
  br i1 %i.cm, label %bb.n, label %.lr.ph.i.i

bb.n:                                             ; preds = %bb.m
  %i.cn = load i8, ptr %i.az, align 1, !tbaa !7
  %i.co = icmp eq i8 %i.cn, %i.cc
  br i1 %i.co, label %bb.o, label %.lr.ph.i.i

bb.o:                                             ; preds = %bb.n
  %i.cp = getelementptr inbounds nuw i8, ptr %i.ba, i64 %i.cj
  %i.cq = load i8, ptr %i.cp, align 1, !tbaa !7
  %i.cr = add i8 %i.cq, 1
  br label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %bb.o, %bb.n, %bb.m, %.lr.ph.split
  %.056 = phi i8 [ %i.cr, %bb.o ], [ %i.a, %bb.n ], [ %i.a, %bb.m ], [ %i.a, %.lr.ph.split ] ; 2 uses
  %i.cs = call i8 @llvm.umin.i8(i8 %i.by, i8 %i.a) ; 2 uses
  %i.ct = icmp ult i8 %i.ca, %i.cs
  %i.cu = call i8 @llvm.umin.i8(i8 %i.ca, i8 %i.cs) ; 2 uses
  %i.cv = icmp ult i8 %i.ch, %i.cu
  %i.cw = call i8 @llvm.umin.i8(i8 %i.ch, i8 %i.cu)
  %i.cx = icmp ult i8 %.056, %i.cw
  %.sroa.speculate.load.false.sroa.speculate.load.false.sroa.speculate.load.false.sroa.speculated = call i8 @llvm.umin.i8(i8 %i.by, i8 %i.a)
  %.sroa.speculate.load.false.sroa.speculate.load.false.sroa.speculated = select i1 %i.ct, i8 %i.ca, i8 %.sroa.speculate.load.false.sroa.speculate.load.false.sroa.speculate.load.false.sroa.speculated
  %.sroa.speculate.load.false.sroa.speculated = select i1 %i.cv, i8 %i.ch, i8 %.sroa.speculate.load.false.sroa.speculate.load.false.sroa.speculated
  %.sroa.speculated100 = select i1 %i.cx, i8 %.056, i8 %.sroa.speculate.load.false.sroa.speculated ; 2 uses
  %i.cy = getelementptr inbounds nuw i8, ptr %i.au, i64 %.06093
  store i8 %.sroa.speculated100, ptr %i.cy, align 1, !tbaa !7
  %i.cz = add nuw nsw i64 %.06093, 1
