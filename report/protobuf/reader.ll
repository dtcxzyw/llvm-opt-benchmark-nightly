...
upb_EpsCopyInputStream_HasErrorHandler.exit.i19:  ; preds = %bb.j
  %i.ap = tail call { ptr, i64 } @_upb_WireReader_ReadLongSize_dont_copy_me__upb_internal_use_only(ptr noundef nonnull %.0.i39, i64 noundef %i.an, ptr noundef nonnull %3) ; 2 uses
...
bb.l:                                             ; preds = %upb_WireReader_ReadSize.exit.i.thread, %upb_EpsCopyInputStream_HasErrorHandler.exit.i19
  %i.aw = tail call ptr @upb_EpsCopyInputStream_ReturnError_dont_copy_me__upb_internal_use_only(ptr noundef nonnull %3) #3
...
bb.n:                                             ; preds = %bb.e
  %i.ay = tail call ptr @_upb_WireReader_SkipGroup_dont_copy_me__upb_internal_use_only(ptr noundef nonnull %.0.i39, i32 noundef %.02538, i32 noundef range(i32 0, 2147483647) %i.a, ptr noundef nonnull %3)
  br label %_upb_WireReader_SkipValue.exit

bb.o:                                             ; preds = %bb.e
  %i.az = tail call ptr @upb_EpsCopyInputStream_ReturnError_dont_copy_me__upb_internal_use_only(ptr noundef nonnull %3) #3
  br label %_upb_WireReader_SkipValue.exit
