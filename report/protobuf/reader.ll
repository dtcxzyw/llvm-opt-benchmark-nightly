...
begin_hunk_0_@_upb_WireReader_ReadLongVarint_dont_copy_me__upb_internal_use_only:bb.a
  %i.aq = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.ar = load i8, ptr %i.aq, align 1, !tbaa !7   ; 2 uses
  %i.as = zext i8 %i.ar to i64
  %i.at = shl nuw i64 %i.as, 56
  %i.au = add i64 %i.at, -72057594037927936
  %i.av = add i64 %i.au, %i.ap                    ; 2 uses
  %.not.7 = icmp slt i8 %i.ar, 0
  br i1 %.not.7, label %bb.i, label %.loopexit

bb.i:                                             ; preds = %bb.h
  %i.aw = getelementptr inbounds nuw i8, ptr %0, i64 9
  %i.ax = load i8, ptr %i.aw, align 1, !tbaa !7   ; 2 uses
  %i.ay = xor i8 %i.ax, -1
  %i.az = zext i8 %i.ay to i64
  %i.ba = shl i64 %i.az, 63
  %i.bb = add i64 %i.ba, %i.av
  %.not.8 = icmp slt i8 %i.ax, 0
  br i1 %.not.8, label %bb.j, label %.loopexit

bb.j:                                             ; preds = %bb.i
  %i.bc = tail call ptr @upb_EpsCopyInputStream_ReturnError_dont_copy_me__upb_internal_use_only(ptr noundef %2) #3
  br label %bb.k

.loopexit:                                        ; preds = %bb.i, %bb.h, %bb.g, %bb.f, %bb.e, %bb.d, %bb.c, %bb.b, %bb.a
  %.lcssa23 = phi i64 [ 1, %bb.a ], [ 2, %bb.b ], [ 3, %bb.c ], [ 4, %bb.d ], [ 5, %bb.e ], [ 6, %bb.f ], [ 7, %bb.g ], [ 8, %bb.h ], [ 9, %bb.i ]
  %.lcssa = phi i64 [ %i.f, %bb.a ], [ %i.l, %bb.b ], [ %i.r, %bb.c ], [ %i.x, %bb.d ], [ %i.ad, %bb.e ], [ %i.aj, %bb.f ], [ %i.ap, %bb.g ], [ %i.av, %bb.h ], [ %i.bb, %bb.i ]
  %i.bd = getelementptr inbounds nuw i8, ptr %0, i64 %.lcssa23
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 1
  br label %bb.k

bb.k:                                             ; preds = %.loopexit, %bb.j
  %.sroa.0.3 = phi ptr [ %i.bc, %bb.j ], [ %i.be, %.loopexit ]
  %.sroa.3.3 = phi i64 [ 0, %bb.j ], [ %.lcssa, %.loopexit ]
  %.fca.0.insert = insertvalue { ptr, i64 } poison, ptr %.sroa.0.3, 0
  %.fca.1.insert = insertvalue { ptr, i64 } %.fca.0.insert, i64 %.sroa.3.3, 1
  ret { ptr, i64 } %.fca.1.insert
}

declare ptr @upb_EpsCopyInputStream_ReturnError_dont_copy_me__upb_internal_use_only(ptr noundef) local_unnamed_addr #1

; Function Attrs: noinline nounwind uwtable
define hidden { ptr, i64 } @_upb_WireReader_ReadLongTag_dont_copy_me__upb_internal_use_only(ptr noundef %0, i64 noundef %1, ptr noundef %2) local_unnamed_addr #0 {
bb.a:
...
bb.e:                                             ; preds = %bb.d, %bb.c, %bb.b, %bb.a
  ...
  %i.y = icmp ugt i64 %.lcssa, 4294967295
...
upb_EpsCopyInputStream_HasErrorHandler.exit.i19:  ; preds = %bb.j
  ...
  br i1 %.not.i16, label %bb.l, label %upb_WireReader_ReadSize.exit.i.thread
...
upb_WireReader_ReadSize.exit.i.thread:            ; preds = %bb.k, %upb_EpsCopyInputStream_HasErrorHandler.exit.i19
  ...
  %.not55 = icmp slt i64 %i.av, %i.as
  br i1 %.not55, label %bb.l, label %bb.m
...
bb.m:                                             ; preds = %upb_WireReader_ReadSize.exit.i.thread
  %i.ax = getelementptr inbounds i8, ptr %.0.i.i44, i64 %i.as
  br label %_upb_WireReader_SkipValue.exit
...
.thread48.sink.split:                             ; preds = %upb_EpsCopyInputStream_IsDone.exit, %bb.c, %upb_EpsCopyInputStream_HasErrorHandler.exit.i, %_upb_WireReader_SkipValue.exit, %bb.a
  %i.ba = tail call ptr @upb_EpsCopyInputStream_ReturnError_dont_copy_me__upb_internal_use_only(ptr noundef %3) #3
  br label %.thread48

.thread48:                                        ; preds = %upb_WireReader_ReadTag.exit.thread, %.thread48.sink.split
  %.3 = phi ptr [ %i.ba, %.thread48.sink.split ], [ %.0.i39, %upb_WireReader_ReadTag.exit.thread ]
  ret ptr %.3
}
