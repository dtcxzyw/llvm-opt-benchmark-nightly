...
begin_hunk_0_@_ZN4absl12lts_2025051212crc_internal7CRCImpl13FillWordTableEjjiPA256_j:bb.a
  store <4 x i32> %i.nb, ptr %i.my, align 4, !tbaa !3
  store <4 x i32> %i.nc, ptr %i.nd, align 4, !tbaa !3
  %i.ne = load i32, ptr %i.af, align 4, !tbaa !3
  ...
  %wide.load.12 = load <4 x i32>, ptr %i.ng, align 4, !tbaa !3
  %wide.load135.12 = load <4 x i32>, ptr %i.nh, align 4, !tbaa !3
  ...
  store <4 x i32> %i.ni, ptr %i.nf, align 4, !tbaa !3
  store <4 x i32> %i.nj, ptr %i.nk, align 4, !tbaa !3
  %i.nl = load i32, ptr %i.af, align 4, !tbaa !3
  ...
  %wide.load.13 = load <4 x i32>, ptr %i.nn, align 4, !tbaa !3
  %wide.load135.13 = load <4 x i32>, ptr %i.no, align 4, !tbaa !3
  ...
  store <4 x i32> %i.np, ptr %i.nm, align 4, !tbaa !3
  store <4 x i32> %i.nq, ptr %i.nr, align 4, !tbaa !3
  %i.ns = load i32, ptr %i.af, align 4, !tbaa !3
  ...
  %wide.load.14 = load <4 x i32>, ptr %i.nu, align 4, !tbaa !3
  %wide.load135.14 = load <4 x i32>, ptr %i.nv, align 4, !tbaa !3
  ...
  store <4 x i32> %i.nw, ptr %i.nt, align 4, !tbaa !3
  store <4 x i32> %i.nx, ptr %i.ny, align 4, !tbaa !3
  %i.nz = load i32, ptr %i.af, align 4, !tbaa !3  ; 2 uses
  ...
  store i32 %i.og, ptr %i.oh, align 4, !tbaa !3
  %i.oi = load i32, ptr %i.af, align 4, !tbaa !3  ; 2 uses
  ...
  store i32 %i.ol, ptr %i.om, align 4, !tbaa !3
  ...
  store i32 %i.op, ptr %i.oq, align 4, !tbaa !3
  %i.or = load i32, ptr %i.af, align 4, !tbaa !3  ; 2 uses
  ...
  store i32 %i.ou, ptr %i.ov, align 4, !tbaa !3
  ...
  %i.pa = load i32, ptr %i.af, align 4, !tbaa !3
  ...
  store i32 %i.pd, ptr %i.pe, align 4, !tbaa !3
...
.split.2:                                         ; preds = %.lr.ph
  ...
  %.pre95 = load i32, ptr %.phi.trans.insert94, align 4, !tbaa !3
  br label %.preheader
}
...
define noundef range(i32 -2147483648, 257) i32 @_ZN4absl12lts_2025051212crc_internal7CRCImpl15FillZeroesTableEjPA256_j(i32 noundef %0, ptr nofree noundef writeonly captures(none) %1) local_unnamed_addr #2 align 2 {
.preheader35:
  br label %bb.a
...
bb.a:                                             ; preds = %bb.a, %.preheader35
  ...
  br i1 %.not.i.154, label %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit, label %bb.a, !llvm.loop !9

_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit: ; preds = %bb.a, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit
  %.020.i.1 = phi i32 [ %i.v, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit ], [ -2147483648, %bb.a ] ; 3 uses
  %.01319.i.1 = phi i32 [ %.1.i.1.1, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit ], [ %spec.select.i.151, %bb.a ] ; 3 uses
  %.01418.i.1 = phi i32 [ %spec.select.i.1.1, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit ], [ 0, %bb.a ]
  ...
  br i1 %.not.i.1.1, label %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit.1, label %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit, !llvm.loop !9

_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit.1: ; preds = %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit.1
  %.020.i.2 = phi i32 [ %i.ah, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit.1 ], [ -2147483648, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit ] ; 3 uses
  %.01319.i.2 = phi i32 [ %.1.i.2.1, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit.1 ], [ %spec.select.i.1.1, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit ] ; 3 uses
  %.01418.i.2 = phi i32 [ %spec.select.i.2.1, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit.1 ], [ 0, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit ]
...
.preheader:                                       ; preds = %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit.1, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.14
  ...
  store i32 %.13341, ptr %i.ai, align 4, !tbaa !3
  br label %bb.b
...
bb.b:                                             ; preds = %bb.b, %.preheader
  ...
  br i1 %.not.i23.163, label %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24, label %bb.b, !llvm.loop !9

_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24: ; preds = %bb.b
  %i.av = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv
  %i.aw = getelementptr inbounds nuw i8, ptr %i.av, i64 4
  store i32 %spec.select.i20.160, ptr %i.aw, align 4, !tbaa !3
  br label %bb.c

bb.c:                                             ; preds = %bb.c, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24
  %.020.i16.1 = phi i32 [ -2147483648, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24 ], [ %i.bi, %bb.c ] ; 3 uses
  %.01319.i17.1 = phi i32 [ %.13341, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24 ], [ %.1.i22.1.1, %bb.c ] ; 3 uses
  %.01418.i18.1 = phi i32 [ 0, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24 ], [ %spec.select.i20.1.1, %bb.c ]
  ...
  br i1 %.not.i23.1.1, label %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.1, label %bb.c, !llvm.loop !9

_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.1: ; preds = %bb.c
  %i.bj = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv
  %i.bk = getelementptr inbounds nuw i8, ptr %i.bj, i64 8
  store i32 %spec.select.i20.1.1, ptr %i.bk, align 4, !tbaa !3
  br label %bb.d

bb.d:                                             ; preds = %bb.d, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.1
  %.020.i16.2 = phi i32 [ -2147483648, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.1 ], [ %i.bw, %bb.d ] ; 3 uses
  %.01319.i17.2 = phi i32 [ %.13341, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.1 ], [ %.1.i22.2.1, %bb.d ] ; 3 uses
  %.01418.i18.2 = phi i32 [ 0, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.1 ], [ %spec.select.i20.2.1, %bb.d ]
  ...
  br i1 %.not.i23.2.1, label %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.2, label %bb.d, !llvm.loop !9

_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.2: ; preds = %bb.d
  %i.bx = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv
  %i.by = getelementptr inbounds nuw i8, ptr %i.bx, i64 12
  store i32 %spec.select.i20.2.1, ptr %i.by, align 4, !tbaa !3
  br label %bb.e

bb.e:                                             ; preds = %bb.e, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.2
  %.020.i16.3 = phi i32 [ -2147483648, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.2 ], [ %i.ck, %bb.e ] ; 3 uses
  %.01319.i17.3 = phi i32 [ %.13341, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.2 ], [ %.1.i22.3.1, %bb.e ] ; 3 uses
  %.01418.i18.3 = phi i32 [ 0, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.2 ], [ %spec.select.i20.3.1, %bb.e ]
  ...
  br i1 %.not.i23.3.1, label %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.3, label %bb.e, !llvm.loop !9

_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.3: ; preds = %bb.e
  %i.cl = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv
  %i.cm = getelementptr inbounds nuw i8, ptr %i.cl, i64 16
  store i32 %spec.select.i20.3.1, ptr %i.cm, align 4, !tbaa !3
  br label %bb.f

bb.f:                                             ; preds = %bb.f, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.3
  %.020.i16.4 = phi i32 [ -2147483648, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.3 ], [ %i.cy, %bb.f ] ; 3 uses
  %.01319.i17.4 = phi i32 [ %.13341, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.3 ], [ %.1.i22.4.1, %bb.f ] ; 3 uses
  %.01418.i18.4 = phi i32 [ 0, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.3 ], [ %spec.select.i20.4.1, %bb.f ]
  ...
  br i1 %.not.i23.4.1, label %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.4, label %bb.f, !llvm.loop !9

_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.4: ; preds = %bb.f
  %i.cz = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 20
  store i32 %spec.select.i20.4.1, ptr %i.da, align 4, !tbaa !3
  br label %bb.g

bb.g:                                             ; preds = %bb.g, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.4
  %.020.i16.5 = phi i32 [ -2147483648, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.4 ], [ %i.dm, %bb.g ] ; 3 uses
  %.01319.i17.5 = phi i32 [ %.13341, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.4 ], [ %.1.i22.5.1, %bb.g ] ; 3 uses
  %.01418.i18.5 = phi i32 [ 0, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.4 ], [ %spec.select.i20.5.1, %bb.g ]
  ...
  br i1 %.not.i23.5.1, label %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.5, label %bb.g, !llvm.loop !9

_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.5: ; preds = %bb.g
  %i.dn = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv
end_hunk_0
begin_hunk_1_@_ZN4absl12lts_2025051212crc_internal7CRCImpl15FillZeroesTableEjPA256_j:.preheader35

_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.8: ; preds = %bb.j
  %i.fd = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv
  %i.fe = getelementptr inbounds nuw i8, ptr %i.fd, i64 36
  store i32 %spec.select.i20.8.1, ptr %i.fe, align 4, !tbaa !3
  br label %bb.k

bb.k:                                             ; preds = %bb.k, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.8
  %.020.i16.9 = phi i32 [ -2147483648, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.8 ], [ %i.fq, %bb.k ] ; 3 uses
  %.01319.i17.9 = phi i32 [ %.13341, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.8 ], [ %.1.i22.9.1, %bb.k ] ; 3 uses
  %.01418.i18.9 = phi i32 [ 0, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.8 ], [ %spec.select.i20.9.1, %bb.k ]
  ...
  br i1 %.not.i23.9.1, label %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.9, label %bb.k, !llvm.loop !9

_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.9: ; preds = %bb.k
  %i.fr = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv
  %i.fs = getelementptr inbounds nuw i8, ptr %i.fr, i64 40
  store i32 %spec.select.i20.9.1, ptr %i.fs, align 4, !tbaa !3
  br label %bb.l

bb.l:                                             ; preds = %bb.l, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.9
  %.020.i16.10 = phi i32 [ -2147483648, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.9 ], [ %i.ge, %bb.l ] ; 3 uses
  %.01319.i17.10 = phi i32 [ %.13341, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.9 ], [ %.1.i22.10.1, %bb.l ] ; 3 uses
  %.01418.i18.10 = phi i32 [ 0, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.9 ], [ %spec.select.i20.10.1, %bb.l ]
  ...
  br i1 %.not.i23.10.1, label %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.10, label %bb.l, !llvm.loop !9

_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.10: ; preds = %bb.l
  %i.gf = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv
  %i.gg = getelementptr inbounds nuw i8, ptr %i.gf, i64 44
  store i32 %spec.select.i20.10.1, ptr %i.gg, align 4, !tbaa !3
  br label %bb.m

bb.m:                                             ; preds = %bb.m, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.10
  %.020.i16.11 = phi i32 [ -2147483648, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.10 ], [ %i.gs, %bb.m ] ; 3 uses
  %.01319.i17.11 = phi i32 [ %.13341, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.10 ], [ %.1.i22.11.1, %bb.m ] ; 3 uses
  %.01418.i18.11 = phi i32 [ 0, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.10 ], [ %spec.select.i20.11.1, %bb.m ]
  ...
  br i1 %.not.i23.11.1, label %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.11, label %bb.m, !llvm.loop !9

_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.11: ; preds = %bb.m
  %i.gt = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv
  %i.gu = getelementptr inbounds nuw i8, ptr %i.gt, i64 48
  store i32 %spec.select.i20.11.1, ptr %i.gu, align 4, !tbaa !3
  br label %bb.n

bb.n:                                             ; preds = %bb.n, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.11
  %.020.i16.12 = phi i32 [ -2147483648, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.11 ], [ %i.hg, %bb.n ] ; 3 uses
  %.01319.i17.12 = phi i32 [ %.13341, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.11 ], [ %.1.i22.12.1, %bb.n ] ; 3 uses
  %.01418.i18.12 = phi i32 [ 0, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.11 ], [ %spec.select.i20.12.1, %bb.n ]
  ...
  br i1 %.not.i23.12.1, label %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.12, label %bb.n, !llvm.loop !9

_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.12: ; preds = %bb.n
  %i.hh = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv
  %i.hi = getelementptr inbounds nuw i8, ptr %i.hh, i64 52
  store i32 %spec.select.i20.12.1, ptr %i.hi, align 4, !tbaa !3
  br label %bb.o

bb.o:                                             ; preds = %bb.o, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.12
  %.020.i16.13 = phi i32 [ -2147483648, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.12 ], [ %i.hu, %bb.o ] ; 3 uses
  %.01319.i17.13 = phi i32 [ %.13341, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.12 ], [ %.1.i22.13.1, %bb.o ] ; 3 uses
  %.01418.i18.13 = phi i32 [ 0, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.12 ], [ %spec.select.i20.13.1, %bb.o ]
  ...
  br i1 %.not.i23.13.1, label %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.13, label %bb.o, !llvm.loop !9

_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.13: ; preds = %bb.o
  %i.hv = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv
  %i.hw = getelementptr inbounds nuw i8, ptr %i.hv, i64 56
  store i32 %spec.select.i20.13.1, ptr %i.hw, align 4, !tbaa !3
  br label %bb.p

bb.p:                                             ; preds = %bb.p, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.13
  %.020.i16.14 = phi i32 [ -2147483648, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.13 ], [ %i.ii, %bb.p ] ; 3 uses
  %.01319.i17.14 = phi i32 [ %.13341, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.13 ], [ %.1.i22.14.1, %bb.p ] ; 3 uses
  %.01418.i18.14 = phi i32 [ 0, %_ZN4absl12lts_2025051212crc_internal12_GLOBAL__N_112PolyMultiplyEPjjj.exit24.13 ], [ %spec.select.i20.14.1, %bb.p ]
...
define noundef nonnull ptr @_ZN4absl12lts_2025051212crc_internal7CRCImpl11NewInternalEv() local_unnamed_addr #3 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = tail call noundef ptr @_ZN4absl12lts_2025051212crc_internal36TryNewCRC32AcceleratedX86ARMCombinedEv() ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 64) (i8, ptr @_ZTVN4absl12lts_2025051212crc_internal5CRC32E, i64 16), ptr %i.c, align 8, !tbaa !11
  br label %bb.c

bb.c:                                             ; preds = %._crit_edge, %bb.b
  %i.d = phi ptr [ %.pre, %._crit_edge ], [ getelementptr inbounds nuw inrange(-16, 64) (i8, ptr @_ZTVN4absl12lts_2025051212crc_internal5CRC32E, i64 16), %bb.b ]
...
declare noundef ptr @_ZN4absl12lts_2025051212crc_internal36TryNewCRC32AcceleratedX86ARMCombinedEv() local_unnamed_addr #4
...
; Function Attrs: mustprogress uwtable
define void @_ZN4absl12lts_2025051212crc_internal5CRC3210InitTablesEv(ptr nofree noundef nonnull align 8 captures(none) dereferenceable(8200) initializes((8, 1032)) %0) unnamed_addr #3 align 2 {
.preheader39:
  %i.a = tail call noalias noundef nonnull dereferenceable(4096) ptr @_Znam(i64 noundef 4096) #18 ; 7 uses
  tail call void @_ZN4absl12lts_2025051212crc_internal7CRCImpl13FillWordTableEjjiPA256_j(i32 noundef -2097792136, i32 noundef -2097792136, i32 noundef 1, ptr noundef nonnull %i.a)
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 12 uses
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1024) %i.b, ptr noundef nonnull align 4 dereferenceable(1024) %i.a, i64 1024, i1 false), !tbaa !3
  ...
  tail call void @_ZN4absl12lts_2025051212crc_internal7CRCImpl13FillWordTableEjjiPA256_j(i32 noundef -2097792136, i32 noundef %i.bs, i32 noundef 4, ptr noundef nonnull %i.a)
  %scevgep49 = getelementptr inbounds nuw i8, ptr %0, i64 2056
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(4096) %scevgep49, ptr noundef nonnull align 4 dereferenceable(4096) %i.a, i64 4096, i1 false), !tbaa !3
  %i.bt = tail call noundef i32 @_ZN4absl12lts_2025051212crc_internal7CRCImpl15FillZeroesTableEjPA256_j(i32 noundef -2097792136, ptr noundef nonnull %i.a) ; 2 uses
...
.lr.ph:                                           ; preds = %.preheader39
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.bv, ptr nonnull align 4 %i.a, i64 %i.bx, i1 false), !tbaa !3
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %.lr.ph, %.preheader39
  ...
  tail call void @_ZN4absl12lts_2025051212crc_internal7CRCImpl13FillWordTableEjjiPA256_j(i32 noundef -1888602208, i32 noundef -1888602208, i32 noundef 1, ptr noundef nonnull %i.by)
  %i.bz = getelementptr inbounds nuw i8, ptr %0, i64 7176
  %i.ca = tail call noundef i32 @_ZN4absl12lts_2025051212crc_internal7CRCImpl15FillZeroesTableEjPA256_j(i32 noundef -1888602208, ptr noundef nonnull %i.bz) ; 0 uses
  ret void
}
...
define void @_ZNK4absl12lts_2025051212crc_internal5CRC326ExtendEPjPKvm(ptr nofree noundef nonnull readonly align 8 dereferenceable(8200) %0, ptr nofree noundef captures(none) %1, ptr noundef %2, i64 noundef %3) unnamed_addr #8 align 2 {
bb.a:
