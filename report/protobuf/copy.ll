...
default.unreachable:                              ; preds = %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i201, %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i, %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i.i.i, %bb.v, %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i.i
  unreachable

4:                                                ; preds = %upb_MiniTableField_CType.exit, %upb_MiniTableField_CType.exit
  br i1 %.not.i.i, label %bb.q, label %5
...
.critedge17.i:                                    ; preds = %bb.q, %5
  %i.bb = icmp eq i8 %.val151, 12
  tail call void @llvm.assume(i1 %i.bb)
  br label %upb_Message_GetString.exit

upb_Message_GetString.exit:                       ; preds = %5, %5, %bb.q, %.critedge17.i
  ...
  br i1 %.not130, label %.critedge, label %bb.r

bb.r:                                             ; preds = %upb_Message_GetString.exit
  ...
  br i1 %i.bl, label %bb.s, label %bb.t, !prof !27
...
upb_Clone_StringView.exit:                        ; preds = %bb.s, %bb.t
  %.0.i.i160 = phi ptr [ %i.bm, %bb.s ], [ %.val.i.i, %bb.t ] ; 9 uses
...
.critedge17.i.i:                                  ; preds = %bb.u, %7
  %i.br = icmp eq i8 %.val7.i8.i, 12
  tail call void @llvm.assume(i1 %i.br)
  br label %.critedge.i.i

.critedge.i.i:                                    ; preds = %.critedge17.i.i, %bb.u, %7, %7
  ...
  br i1 %.not.i.i.not.i, label %.critedge143, label %bb.v
...
9:                                                ; preds = %upb_Clone_StringView.exit
  br i1 %i.bq, label %bb.aa, label %10

10:                                               ; preds = %9
  switch i8 %.val7.i8.i, label %.critedge18.i.i [
    i8 9, label %.critedge.i11.i
    i8 12, label %.critedge.i11.i
  ]

bb.aa:                                            ; preds = %9
  %11 = icmp eq i8 %.val7.i8.i, 9
  br i1 %11, label %.critedge.i11.i, label %.critedge18.i.i

.critedge18.i.i:                                  ; preds = %bb.aa, %10
  %i.bz = icmp eq i8 %.val7.i8.i, 12
  tail call void @llvm.assume(i1 %i.bz)
  br label %.critedge.i11.i

.critedge.i11.i:                                  ; preds = %.critedge18.i.i, %bb.aa, %10, %10
  %i.ca = and i8 %.val.i161, 3
  %i.cb = icmp eq i8 %i.ca, 2
  tail call void @llvm.assume(i1 %i.cb)
  %i.cc = icmp slt i8 %.val.i161, -64
  tail call void @llvm.assume(i1 %i.cc)
  %i.cd = getelementptr i8, ptr %i.i, i64 6
  %.val6.i.i.i.i = load i16, ptr %i.cd, align 2, !tbaa !42 ; 5 uses
  %i.ce = icmp sgt i16 %.val6.i.i.i.i, 0
  br i1 %i.ce, label %bb.ab, label %bb.ac

bb.ab:                                            ; preds = %.critedge.i11.i
  %i.cf = lshr i16 %.val6.i.i.i.i, 3
  %i.cg = trunc i16 %.val6.i.i.i.i to i8
  %i.ch = and i8 %i.cg, 7
  %i.ci = shl nuw i8 1, %i.ch
  %i.cj = zext nneg i16 %i.cf to i64
  %i.ck = getelementptr inbounds nuw i8, ptr %0, i64 %i.cj ; 2 uses
  %i.cl = load i8, ptr %i.ck, align 1, !tbaa !21
  %i.cm = or i8 %i.cl, %i.ci
  store i8 %i.cm, ptr %i.ck, align 1, !tbaa !21
...
bb.ac:                                            ; preds = %.critedge.i11.i
  %i.cn = icmp slt i16 %.val6.i.i.i.i, 0
  br i1 %i.cn, label %bb.ad, label %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i.i.i

bb.ad:                                            ; preds = %bb.ac
  %.val8.i.i.i.i = load i32, ptr %i.i, align 4, !tbaa !43
  %i.co = xor i16 %.val6.i.i.i.i, -1
  %i.cp = zext nneg i16 %i.co to i64
  %i.cq = getelementptr inbounds nuw i8, ptr %0, i64 %i.cp
  store i32 %.val8.i.i.i.i, ptr %i.cq, align 4, !tbaa !3
  br label %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i.i.i

_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i.i.i: ; preds = %bb.ad, %bb.ac, %bb.ab
  %.val7.i.i.i = phi i8 [ %.val7.pre.i.i.i, %bb.ab ], [ %.val.i161, %bb.ac ], [ %.val.i161, %bb.ad ]
  %i.cr = getelementptr i8, ptr %i.i, i64 4
  %.val8.i.i.i163 = load i16, ptr %i.cr, align 4, !tbaa !44
  %i.cs = zext i16 %.val8.i.i.i163 to i64
  %i.ct = getelementptr inbounds nuw i8, ptr %0, i64 %i.cs ; 5 uses
  %i.cu = lshr i8 %.val7.i.i.i, 6
...
bb.ae:                                            ; preds = %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i.i.i
  ...
  %.sroa.0.0.extract.trunc17.i.i = trunc i64 %i.cv to i8
  store i8 %.sroa.0.0.extract.trunc17.i.i, ptr %i.ct, align 1
  br label %.critedge

bb.af:                                            ; preds = %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i.i.i
  %i.cw = ptrtoint ptr %.0.i.i160 to i64
  %.sroa.0.0.extract.trunc.i14.i = trunc i64 %i.cw to i32
  store i32 %.sroa.0.0.extract.trunc.i14.i, ptr %i.ct, align 1
  br label %.critedge

bb.ag:                                            ; preds = %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i.i.i
  %i.cx = ptrtoint ptr %.0.i.i160 to i64
  store i64 %i.cx, ptr %i.ct, align 1
  br label %.critedge

bb.ah:                                            ; preds = %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i.i.i
  store ptr %.0.i.i160, ptr %i.ct, align 1
  %.sroa.5.0..sroa_idx.i13.i = getelementptr inbounds nuw i8, ptr %i.ct, i64 8
  store i64 %i.be, ptr %.sroa.5.0..sroa_idx.i13.i, align 1
  br label %.critedge

bb.ai:                                            ; preds = %bb.b
  %i.cy = getelementptr i8, ptr %i.i, i64 6
  %i.cz = icmp ugt i8 %.val155, -65
  tail call void @llvm.assume(i1 %i.cz)
  %i.da = and i8 %.val155, 8
  %.not.i164 = icmp eq i8 %i.da, 0
  tail call void @llvm.assume(i1 %.not.i164)
  %i.db = getelementptr i8, ptr %i.i, i64 4       ; 2 uses
  %.val7.i165 = load i16, ptr %i.db, align 4, !tbaa !44
  %i.dc = zext i16 %.val7.i165 to i64
  %i.dd = getelementptr inbounds nuw i8, ptr %1, i64 %i.dc
  %i.de = load i64, ptr %i.dd, align 1            ; 2 uses
  %.not128 = icmp eq i64 %i.de, 0
  br i1 %.not128, label %.critedge, label %upb_MiniTableField_CType.exit197

upb_MiniTableField_CType.exit197:                 ; preds = %bb.ai
  %i.df = inttoptr i64 %i.de to ptr
  %i.dg = getelementptr inbounds nuw i8, ptr %i.i, i64 8
  %i.dh = load i16, ptr %i.dg, align 4, !tbaa !20
  %i.di = zext i16 %i.dh to i64
  %i.dj = shl nuw nsw i64 %i.di, 2
  %i.dk = getelementptr inbounds nuw i8, ptr %i.i, i64 %i.dj
  %i.dl = load ptr, ptr %i.dk, align 8, !tbaa !21
  %i.dm = tail call ptr @upb_Map_DeepClone(ptr noundef nonnull %i.df, i32 poison, i32 poison, ptr noundef nonnull %i.dl, ptr noundef %3), !inline_history !45 ; 5 uses
  %.not.i169 = icmp eq ptr %i.dm, null
  br i1 %.not.i169, label %.critedge143, label %bb.aj

bb.aj:                                            ; preds = %upb_MiniTableField_CType.exit197
  %.val.i186 = load i8, ptr %i.j, align 1, !tbaa !19 ; 3 uses
  %i.dn = and i8 %.val.i186, 8
  %.not.i187 = icmp eq i8 %i.dn, 0
  tail call void @llvm.assume(i1 %.not.i187)
  %.val6.i.i = load i16, ptr %i.cy, align 2, !tbaa !42 ; 5 uses
  %i.do = icmp sgt i16 %.val6.i.i, 0
  br i1 %i.do, label %bb.ak, label %bb.al

bb.ak:                                            ; preds = %bb.aj
  %i.dp = lshr i16 %.val6.i.i, 3
  %i.dq = trunc i16 %.val6.i.i to i8
  %i.dr = and i8 %i.dq, 7
  %i.ds = shl nuw i8 1, %i.dr
  %i.dt = zext nneg i16 %i.dp to i64
  %i.du = getelementptr inbounds nuw i8, ptr %0, i64 %i.dt ; 2 uses
  %i.dv = load i8, ptr %i.du, align 1, !tbaa !21
  %i.dw = or i8 %i.dv, %i.ds
  store i8 %i.dw, ptr %i.du, align 1, !tbaa !21
  %.val7.pre.i = load i8, ptr %i.j, align 1, !tbaa !19
  br label %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i

bb.al:                                            ; preds = %bb.aj
  %i.dx = icmp slt i16 %.val6.i.i, 0
  br i1 %i.dx, label %bb.am, label %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i

bb.am:                                            ; preds = %bb.al
  %.val8.i.i191 = load i32, ptr %i.i, align 4, !tbaa !43
  %i.dy = xor i16 %.val6.i.i, -1
  %i.dz = zext nneg i16 %i.dy to i64
  %i.ea = getelementptr inbounds nuw i8, ptr %0, i64 %i.dz
  store i32 %.val8.i.i191, ptr %i.ea, align 4, !tbaa !3
  br label %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i

_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i: ; preds = %bb.am, %bb.al, %bb.ak
  %.val7.i188 = phi i8 [ %.val7.pre.i, %bb.ak ], [ %.val.i186, %bb.al ], [ %.val.i186, %bb.am ]
  %.val8.i189 = load i16, ptr %i.db, align 4, !tbaa !44
  %i.eb = zext i16 %.val8.i189 to i64
  %i.ec = getelementptr inbounds nuw i8, ptr %0, i64 %i.eb ; 4 uses
  %i.ed = lshr i8 %.val7.i188, 6
...
bb.an:                                            ; preds = %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i
  %i.ee = ptrtoint ptr %i.dm to i64
  %.0.extract.trunc227 = trunc i64 %i.ee to i8
  store i8 %.0.extract.trunc227, ptr %i.ec, align 1
  br label %.critedge

bb.ao:                                            ; preds = %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i
  %i.ef = ptrtoint ptr %i.dm to i64
  %.0.extract.trunc = trunc i64 %i.ef to i32
  store i32 %.0.extract.trunc, ptr %i.ec, align 1
  br label %.critedge

bb.ap:                                            ; preds = %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i
  %i.eg = ptrtoint ptr %i.dm to i64
  store i64 %i.eg, ptr %i.ec, align 1
  br label %.critedge

bb.aq:                                            ; preds = %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i
  store ptr %i.dm, ptr %i.ec, align 1
  br label %.critedge

bb.ar:                                            ; preds = %bb.b
  %i.eh = getelementptr i8, ptr %i.i, i64 6
  %i.ei = icmp ugt i8 %.val155, -65
  tail call void @llvm.assume(i1 %i.ei)
  %12 = icmp eq i8 %i.k, 1
  tail call void @llvm.assume(i1 %12)
  %i.ej = and i8 %.val155, 8
  %.not.i172 = icmp eq i8 %i.ej, 0
  tail call void @llvm.assume(i1 %.not.i172)
  %i.ek = getelementptr i8, ptr %i.i, i64 4       ; 2 uses
  %.val7.i173 = load i16, ptr %i.ek, align 4, !tbaa !44
  %i.el = zext i16 %.val7.i173 to i64
  %i.em = getelementptr inbounds nuw i8, ptr %1, i64 %i.el
  %i.en = load i64, ptr %i.em, align 1            ; 2 uses
  %i.eo = inttoptr i64 %i.en to ptr
  %.not = icmp eq i64 %i.en, 0
  br i1 %.not, label %.critedge, label %bb.as

bb.as:                                            ; preds = %bb.ar
  %i.ep = getelementptr i8, ptr %i.i, i64 10
  %.val9.i176 = load i8, ptr %i.ep, align 2, !tbaa !16 ; 2 uses
  %i.eq = zext i8 %.val9.i176 to i64              ; 3 uses
  %i.er = and i8 %.val155, 16
  %.not.i.i211 = icmp eq i8 %i.er, 0
  br i1 %.not.i.i211, label %upb_MiniTableField_CType.exit213.thread238, label %bb.at

upb_MiniTableField_CType.exit213.thread238:       ; preds = %bb.as
...
upb_MiniTableField_CType.exit213.thread.thread:   ; preds = %bb.au, %bb.at
  %.0.i.i212.ph.pn.ph = phi i64 [ 8, %bb.au ], [ 13, %bb.at ]
  %.in249284 = getelementptr inbounds nuw [4 x i8], ptr @upb_FieldType_CType.c_type, i64 %.0.i.i212.ph.pn.ph
  %i.eu = load i32, ptr %.in249284, align 4, !tbaa !3
  br label %upb_Message_Array_DeepClone.exit

upb_MiniTableField_CType.exit213.thread:          ; preds = %bb.at
  %i.ev = add nuw nsw i64 %i.eq, 4294967295
  %i.ew = and i64 %i.ev, 4294967295
  %.pre268 = add nuw nsw i64 %i.eq, 4294967295
  %.pre270 = and i64 %.pre268, 4294967295
  br label %upb_MiniTableField_CType.exit210

upb_MiniTableField_CType.exit210:                 ; preds = %upb_MiniTableField_CType.exit213.thread238, %upb_MiniTableField_CType.exit213.thread
  %.pre-phi271 = phi i64 [ %.pre270, %upb_MiniTableField_CType.exit213.thread ], [ %i.et, %upb_MiniTableField_CType.exit213.thread238 ]
  %.pn = phi i64 [ %i.ew, %upb_MiniTableField_CType.exit213.thread ], [ %i.et, %upb_MiniTableField_CType.exit213.thread238 ]
  %.in290 = getelementptr inbounds nuw [4 x i8], ptr @upb_FieldType_CType.c_type, i64 %.pn
  %i.ex = load i32, ptr %.in290, align 4, !tbaa !3 ; 2 uses
  %i.ey = add nsw i64 %.pre-phi271, -9
  %i.ez = icmp ult i64 %i.ey, 2
  br i1 %i.ez, label %bb.av, label %upb_Message_Array_DeepClone.exit

bb.av:                                            ; preds = %upb_MiniTableField_CType.exit210
  %i.fa = getelementptr inbounds nuw i8, ptr %i.i, i64 8
  %i.fb = load i16, ptr %i.fa, align 4, !tbaa !20
  %i.fc = zext i16 %i.fb to i64
  %i.fd = shl nuw nsw i64 %i.fc, 2
  %i.fe = getelementptr inbounds nuw i8, ptr %i.i, i64 %i.fd
  %i.ff = load ptr, ptr %i.fe, align 8, !tbaa !21
  br label %upb_Message_Array_DeepClone.exit

upb_Message_Array_DeepClone.exit:                 ; preds = %upb_MiniTableField_CType.exit213.thread.thread, %upb_MiniTableField_CType.exit210, %bb.av
  %i.fg = phi i32 [ %i.ex, %bb.av ], [ %i.ex, %upb_MiniTableField_CType.exit210 ], [ %i.eu, %upb_MiniTableField_CType.exit213.thread.thread ]
  %i.fh = phi ptr [ %i.ff, %bb.av ], [ null, %upb_MiniTableField_CType.exit210 ], [ null, %upb_MiniTableField_CType.exit213.thread.thread ]
  %i.fi = tail call ptr @upb_Array_DeepClone(ptr noundef nonnull %i.eo, i32 noundef %i.fg, ptr noundef %i.fh, ptr noundef %3), !inline_history !46 ; 4 uses
  %.val.i198 = load i8, ptr %i.j, align 1, !tbaa !19 ; 3 uses
  %i.fj = and i8 %.val.i198, 8
  %.not.i199 = icmp eq i8 %i.fj, 0
  tail call void @llvm.assume(i1 %.not.i199)
  %.val6.i.i200 = load i16, ptr %i.eh, align 2, !tbaa !42 ; 5 uses
  %i.fk = icmp sgt i16 %.val6.i.i200, 0
  br i1 %i.fk, label %bb.aw, label %bb.ax

bb.aw:                                            ; preds = %upb_Message_Array_DeepClone.exit
  %i.fl = lshr i16 %.val6.i.i200, 3
  %i.fm = trunc i16 %.val6.i.i200 to i8
  %i.fn = and i8 %i.fm, 7
  %i.fo = shl nuw i8 1, %i.fn
  %i.fp = zext nneg i16 %i.fl to i64
  %i.fq = getelementptr inbounds nuw i8, ptr %0, i64 %i.fp ; 2 uses
  %i.fr = load i8, ptr %i.fq, align 1, !tbaa !21
  %i.fs = or i8 %i.fr, %i.fo
  store i8 %i.fs, ptr %i.fq, align 1, !tbaa !21
...
bb.ax:                                            ; preds = %upb_Message_Array_DeepClone.exit
  %i.ft = icmp slt i16 %.val6.i.i200, 0
  br i1 %i.ft, label %bb.ay, label %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i201

bb.ay:                                            ; preds = %bb.ax
  %.val8.i.i205 = load i32, ptr %i.i, align 4, !tbaa !43
  %i.fu = xor i16 %.val6.i.i200, -1
  %i.fv = zext nneg i16 %i.fu to i64
  %i.fw = getelementptr inbounds nuw i8, ptr %0, i64 %i.fv
  store i32 %.val8.i.i205, ptr %i.fw, align 4, !tbaa !3
  br label %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i201

_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i201: ; preds = %bb.ay, %bb.ax, %bb.aw
  %.val7.i202 = phi i8 [ %.val7.pre.i206, %bb.aw ], [ %.val.i198, %bb.ax ], [ %.val.i198, %bb.ay ]
  %.val8.i203 = load i16, ptr %i.ek, align 4, !tbaa !44
  %i.fx = zext i16 %.val8.i203 to i64
  %i.fy = getelementptr inbounds nuw i8, ptr %0, i64 %i.fx ; 4 uses
  %i.fz = lshr i8 %.val7.i202, 6
...
bb.az:                                            ; preds = %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i201
  %i.ga = ptrtoint ptr %i.fi to i64
  %.0.extract.trunc232 = trunc i64 %i.ga to i8
  store i8 %.0.extract.trunc232, ptr %i.fy, align 1
  br label %.critedge

bb.ba:                                            ; preds = %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i201
  %i.gb = ptrtoint ptr %i.fi to i64
  %.0.extract.trunc230 = trunc i64 %i.gb to i32
  store i32 %.0.extract.trunc230, ptr %i.fy, align 1
  br label %.critedge

bb.bb:                                            ; preds = %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i201
  %i.gc = ptrtoint ptr %i.fi to i64
  store i64 %i.gc, ptr %i.fy, align 1
  br label %.critedge

bb.bc:                                            ; preds = %_upb_Message_SetPresence_dont_copy_me__upb_internal_use_only.exit.i201
  store ptr %i.fi, ptr %i.fy, align 1
  br label %.critedge

.critedge:                                        ; preds = %bb.aq, %bb.ap, %bb.ao, %bb.an, %bb.ah, %bb.ag, %bb.af, %bb.ae, %bb.y, %bb.x, %bb.w, %bb.z, %bb.bc, %bb.bb, %bb.ba, %bb.az, %bb.p, %bb.o, %bb.n, %bb.m, %bb.ai, %upb_Message_GetString.exit, %bb.g, %bb.ar, %upb_MiniTableField_CType.exit
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %.val153 = load i16, ptr %i.g, align 2, !tbaa !40
  %i.gd = zext i16 %.val153 to i64
  %.not133 = icmp samesign ult i64 %indvars.iv.next, %i.gd
...
.critedge144:                                     ; preds = %.critedge, %bb.a
  ...
  %i.ge = and i64 %.val157, -2                    ; 2 uses
  %i.gf = inttoptr i64 %i.ge to ptr               ; 3 uses
  %.not134 = icmp eq i64 %i.ge, 0
  br i1 %.not134, label %.critedge143, label %.preheader

.preheader:                                       ; preds = %.critedge144
  %i.gg = load i32, ptr %i.gf, align 8, !tbaa !3
  %.not137254.not = icmp eq i32 %i.gg, 0
  br i1 %.not137254.not, label %.critedge143, label %.lr.ph256

.lr.ph256:                                        ; preds = %.preheader
  %i.gh = getelementptr inbounds nuw i8, ptr %i.gf, i64 8
  %i.gi = getelementptr i8, ptr %3, i64 8
  br label %bb.bd

bb.bd:                                            ; preds = %.lr.ph256, %.critedge148
  %.0119255 = phi i64 [ 0, %.lr.ph256 ], [ %i.iy, %.critedge148 ] ; 2 uses
  %i.gj = getelementptr inbounds nuw [8 x i8], ptr %i.gh, i64 %.0119255
  %.sroa.0.0.copyload = load i64, ptr %i.gj, align 8, !tbaa !11 ; 4 uses
  %i.gk = trunc i64 %.sroa.0.0.copyload to i1
  br i1 %i.gk, label %bb.be, label %bb.bu

bb.be:                                            ; preds = %bb.bd
  %i.gl = and i64 %.sroa.0.0.copyload, -4
  %i.gm = inttoptr i64 %i.gl to ptr               ; 5 uses
  %i.gn = load ptr, ptr %i.gm, align 8, !tbaa !48 ; 3 uses
  %i.go = tail call ptr @_upb_Message_GetOrCreateExtension_dont_copy_me__upb_internal_use_only(ptr noundef %0, ptr noundef %i.gn, ptr noundef %3) #7 ; 4 uses
  %.not135 = icmp eq ptr %i.go, null
  br i1 %.not135, label %.critedge143, label %bb.bf

bb.bf:                                            ; preds = %bb.be
  %i.gp = getelementptr i8, ptr %i.gn, i64 11
  %.val154 = load i8, ptr %i.gp, align 1, !tbaa !19 ; 2 uses
  %i.gq = and i8 %.val154, 3
  %i.gr = icmp eq i8 %i.gq, 2
  br i1 %i.gr, label %bb.bg, label %bb.bn

bb.bg:                                            ; preds = %bb.bf
  %i.gs = load ptr, ptr %i.gm, align 8, !tbaa !48 ; 3 uses
  %i.gt = getelementptr inbounds nuw i8, ptr %i.go, i64 8 ; 5 uses
  %i.gu = getelementptr inbounds nuw i8, ptr %i.gm, i64 8
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.gt, ptr noundef nonnull align 8 dereferenceable(16) %i.gu, i64 16, i1 false), !tbaa.struct !51
  %i.gv = getelementptr i8, ptr %i.gs, i64 10
  %.val.i179 = load i8, ptr %i.gv, align 2, !tbaa !16 ; 2 uses
  %i.gw = getelementptr i8, ptr %i.gs, i64 11
  %.val6.i = load i8, ptr %i.gw, align 1, !tbaa !19
  %i.gx = zext i8 %.val.i179 to i64               ; 3 uses
  %i.gy = and i8 %.val6.i, 16
  %.not.i.i.i225 = icmp eq i8 %i.gy, 0
  br i1 %.not.i.i.i225, label %upb_MiniTableExtension_CType.exit.thread240, label %bb.bh

upb_MiniTableExtension_CType.exit.thread240:      ; preds = %bb.bg
  %i.gz = add nuw nsw i64 %i.gx, 4294967295
