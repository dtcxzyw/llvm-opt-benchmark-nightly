...
bb.g:                                             ; preds = %bb.f
  ...
  %i.k = tail call ptr %i.j(ptr noundef nonnull @upb_alloc_global, ptr noundef null, i64 noundef 0, i64 noundef 16, ptr noundef null) #3, !inline_history !12 ; 8 uses
...
bb.j:                                             ; preds = %bb.i
  store ptr %i.m, ptr %i.k, align 8, !tbaa !13
  %i.q = getelementptr inbounds nuw i8, ptr %i.k, i64 8
  store ptr %i.o, ptr %i.q, align 8, !tbaa !17
  %.01933.i.i = load ptr, ptr @upb_generated_extension_list_dont_copy_me__upb_internal_use_only, align 8, !tbaa !18 ; 2 uses
...
.lr.ph38.i.i:                                     ; preds = %bb.j, %._crit_edge.i.i
  ...
  %i.r = load ptr, ptr %.01935.i.i, align 8, !tbaa !20 ; 2 uses
...
._crit_edge.i.i:                                  ; preds = %select.unfold.i.i, %.lr.ph38.i.i
  ...
  %.019.i.i = load ptr, ptr %i.ad, align 8, !tbaa !18 ; 2 uses
  %.not.i.i = icmp eq ptr %.019.i.i, null
  br i1 %.not.i.i, label %_upb_GeneratedRegistry_New.exit.thread37, label %.lr.ph38.i.i, !llvm.loop !30
...
_upb_GeneratedRegistry_AddAllLinkedExtensions.exit.thread23.thread30.i: ; preds = %bb.h, %_upb_GeneratedRegistry_AddAllLinkedExtensions.exit.thread26.i
  ...
  %i.af = tail call ptr %i.ae(ptr noundef nonnull @upb_alloc_global, ptr noundef nonnull %i.k, i64 noundef 0, i64 noundef 0, ptr noundef null) #3, !inline_history !31 ; 0 uses
...
bb.n:                                             ; preds = %_upb_GeneratedRegistry_New.exit.thread37
  %i.ai = load ptr, ptr %i.k, align 8, !tbaa !13
  tail call void @upb_Arena_Free(ptr noundef %i.ai) #3
  %i.aj = load ptr, ptr @upb_alloc_global, align 8, !tbaa !9
  %i.ak = tail call ptr %i.aj(ptr noundef nonnull @upb_alloc_global, ptr noundef nonnull %i.k, i64 noundef 0, i64 noundef 0, ptr noundef null) #3, !inline_history !32 ; 0 uses
  br label %.backedge
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.g = tail call ptr %i.f(ptr noundef nonnull @upb_alloc_global, ptr noundef nonnull %i.d, i64 noundef 0, i64 noundef 0, ptr noundef null) #3, !inline_history !32 ; 0 uses
  br label %bb.e
...
!13 = !{!14, !15, i64 0}
!14 = !{!"upb_GeneratedRegistryRef", !15, i64 0, !16, i64 8}
!15 = !{!"p1 _ZTS9upb_Arena", !11, i64 0}
!16 = !{!"p1 _ZTS21upb_ExtensionRegistry", !11, i64 0}
!17 = !{!14, !16, i64 8}
!18 = !{!19, !19, i64 0}
!19 = !{!"p1 _ZTS67upb_GeneratedExtensionListEntry_dont_copy_me__upb_internal_use_only", !11, i64 0}
!20 = !{!21, !22, i64 0}
!21 = !{!"upb_GeneratedExtensionListEntry_dont_copy_me__upb_internal_use_only", !22, i64 0, !22, i64 8, !19, i64 16}
!22 = !{!"p1 _ZTS22upb_MiniTableExtension", !11, i64 0}
!23 = !{!21, !22, i64 8}
!24 = !{!25, !4, i64 0}
!25 = !{!"upb_MiniTableExtension", !26, i64 0, !5, i64 16, !28, i64 24}
!26 = !{!"upb_MiniTableField", !4, i64 0, !27, i64 4, !27, i64 6, !27, i64 8, !5, i64 10, !5, i64 11}
!27 = !{!"short", !5, i64 0}
!28 = !{!"p1 _ZTS13upb_MiniTable", !11, i64 0}
!29 = distinct !{!29, !8}
!30 = distinct !{!30, !8}
