...
@_ZN4absl12lts_2025051214ascii_internal8kToUpperE = external local_unnamed_addr constant [256 x i8], align 16
@_ZN4absl12lts_2025051214ascii_internal8kToLowerE = external local_unnamed_addr constant [256 x i8], align 16

; Function Attrs: mustprogress nounwind uwtable
define noundef zeroext i1 @_ZN4absl12lts_2025051216EqualsIgnoreCaseESt17basic_string_viewIcSt11char_traitsIcEES4_(i64 %0, ptr %1, i64 %2, ptr %3) local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = icmp eq i64 %0, %2
  br i1 %i.a, label %bb.b, label %bb.d

bb.b:                                             ; preds = %bb.a
  %i.b = invoke noundef i32 @_ZN4absl12lts_2025051216strings_internal10memcasecmpEPKcS3_m(ptr noundef %1, ptr noundef %3, i64 noundef %0)
...
declare noundef i32 @_ZN4absl12lts_2025051216strings_internal10memcasecmpEPKcS3_m(ptr noundef, ptr noundef, i64 noundef) local_unnamed_addr #1
...
; Function Attrs: mustprogress nounwind uwtable
define noundef zeroext i1 @_ZN4absl12lts_2025051221StrContainsIgnoreCaseESt17basic_string_viewIcSt11char_traitsIcEES4_(i64 %0, ptr %1, i64 %2, ptr %3) local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
bb.a:
  %.not8.not = icmp ult i64 %0, %2
  br i1 %.not8.not, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %bb.a, %_ZN4absl12lts_2025051220StartsWithIgnoreCaseESt17basic_string_viewIcSt11char_traitsIcEES4_.exit
  %.sroa.5.010 = phi ptr [ %i.e, %_ZN4absl12lts_2025051220StartsWithIgnoreCaseESt17basic_string_viewIcSt11char_traitsIcEES4_.exit ], [ %1, %bb.a ] ; 2 uses
  %.sroa.04.09 = phi i64 [ %i.f, %_ZN4absl12lts_2025051220StartsWithIgnoreCaseESt17basic_string_viewIcSt11char_traitsIcEES4_.exit ], [ %0, %bb.a ]
  %i.a = invoke noundef i32 @_ZN4absl12lts_2025051216strings_internal10memcasecmpEPKcS3_m(ptr noundef %.sroa.5.010, ptr noundef %3, i64 noundef %2)
          to label %_ZN4absl12lts_2025051220StartsWithIgnoreCaseESt17basic_string_viewIcSt11char_traitsIcEES4_.exit unwind label %bb.b
...
._crit_edge:                                      ; preds = %_ZN4absl12lts_2025051220StartsWithIgnoreCaseESt17basic_string_viewIcSt11char_traitsIcEES4_.exit, %bb.a
  %.not.lcssa = phi i1 [ false, %bb.a ], [ %i.d, %_ZN4absl12lts_2025051220StartsWithIgnoreCaseESt17basic_string_viewIcSt11char_traitsIcEES4_.exit ]
  ret i1 %.not.lcssa
}

; Function Attrs: mustprogress nounwind uwtable
define noundef zeroext i1 @_ZN4absl12lts_2025051220StartsWithIgnoreCaseESt17basic_string_viewIcSt11char_traitsIcEES4_(i64 %0, ptr %1, i64 %2, ptr %3) local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
bb.a:
  %.not = icmp ult i64 %0, %2
  br i1 %.not, label %bb.d, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.a = invoke noundef i32 @_ZN4absl12lts_2025051216strings_internal10memcasecmpEPKcS3_m(ptr noundef %1, ptr noundef %3, i64 noundef %2)
          to label %_ZN4absl12lts_2025051216EqualsIgnoreCaseESt17basic_string_viewIcSt11char_traitsIcEES4_.exit unwind label %bb.c
...
bb.d:                                             ; preds = %_ZN4absl12lts_2025051216EqualsIgnoreCaseESt17basic_string_viewIcSt11char_traitsIcEES4_.exit, %bb.a
  %i.e = phi i1 [ false, %bb.a ], [ %i.d, %_ZN4absl12lts_2025051216EqualsIgnoreCaseESt17basic_string_viewIcSt11char_traitsIcEES4_.exit ]
  ret i1 %i.e
}
...
bb.a:
  ...
  %i.c = getelementptr inbounds nuw i8, ptr @_ZN4absl12lts_2025051214ascii_internal8kToUpperE, i64 %i.b
  %i.d = load i8, ptr %i.c, align 1, !tbaa !9     ; 2 uses
  %i.e = getelementptr inbounds nuw i8, ptr @_ZN4absl12lts_2025051214ascii_internal8kToLowerE, i64 %i.b
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not.i, label %_ZN4absl12lts_2025051211StrContainsESt17basic_string_viewIcSt11char_traitsIcEEc.exit, label %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i
...
; Function Attrs: mustprogress nounwind uwtable
define noundef zeroext i1 @_ZN4absl12lts_2025051218EndsWithIgnoreCaseESt17basic_string_viewIcSt11char_traitsIcEES4_(i64 %0, ptr %1, i64 %2, ptr %3) local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
bb.a:
  %.not = icmp ult i64 %0, %2
  br i1 %.not, label %bb.d, label %bb.b
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.c = invoke noundef i32 @_ZN4absl12lts_2025051216strings_internal10memcasecmpEPKcS3_m(ptr noundef %i.b, ptr noundef %3, i64 noundef %2)
          to label %_ZN4absl12lts_2025051216EqualsIgnoreCaseESt17basic_string_viewIcSt11char_traitsIcEES4_.exit unwind label %bb.c
...
bb.d:                                             ; preds = %_ZN4absl12lts_2025051216EqualsIgnoreCaseESt17basic_string_viewIcSt11char_traitsIcEES4_.exit, %bb.a
  %i.g = phi i1 [ false, %bb.a ], [ %i.f, %_ZN4absl12lts_2025051216EqualsIgnoreCaseESt17basic_string_viewIcSt11char_traitsIcEES4_.exit ]
  ret i1 %i.g
}
