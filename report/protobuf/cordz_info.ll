...
bb.e:                                             ; preds = %bb.c, %bb.d
  %.sink16 = phi i64 [ %i.n, %bb.d ], [ %i.l, %bb.c ]
  %.sink16.a = phi i64 [ 72, %bb.d ], [ 584, %bb.c ]
  %.sink.a = phi ptr [ %i.m, %bb.d ], [ %i.k, %bb.c ]
  %.sink = getelementptr inbounds nuw i8, ptr %2, i64 %.sink16.a
  %i.p = shl i64 %.sink16, 3
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.i, ptr nonnull readonly align 8 %.sink, i64 %i.p, i1 false)
  %.0.i.ph = load i64, ptr %.sink.a, align 8, !tbaa !36
