...
bb.b:                                             ; preds = %bb.a
  ...
  %3 = add nuw nsw i64 %spec.store.select.i.i.i, 13
  %.narrow.i.i.i = icmp ult i8 %i.a, 38
  %.0.i.i.i = select i1 %.narrow.i.i.i, i64 32, i64 %3 ; 2 uses
...
bb.x:                                             ; preds = %bb.v
  ...
  %.narrow.i.i = icmp ult i64 %i.bk, 19
  %.0.i.i = select i1 %.narrow.i.i, i64 32, i64 %i.bm ; 2 uses
...
_ZN4absl12lts_2025051210CordBuffer25CreateWithCustomLimitImplIJEEES1_mmDpT_.exit.i: ; preds = %bb.p, %bb.o, %_ZN4absl12lts_2025051210CordBuffer6IsPow2Em.exit.i.i, %bb.n, %bb.m
  ...
  %.narrow.i.i.i.i = icmp ult i64 %i.as, 19
  %.0.i.i.i.i = select i1 %.narrow.i.i.i.i, i64 32, i64 %6 ; 3 uses
...
bb.r:                                             ; preds = %bb.q
  ...
  %.narrow.i.i.i = icmp ult i64 %3, 19
  %.0.i.i.i = select i1 %.narrow.i.i.i, i64 32, i64 %i.bk ; 2 uses
...
_ZN4absl12lts_2025051210CordBuffer21CreateWithCustomLimitEmm.exit.i: ; preds = %bb.z, %bb.y, %_ZN4absl12lts_2025051210CordBuffer6IsPow2Em.exit.i.i.i, %bb.x, %bb.w
  ...
  %7 = add nuw nsw i64 %spec.store.select.i.i.i.i.i, 13
  %.narrow.i.i.i.i.i = icmp ult i64 %i.cp, 19
  %.0.i.i.i.i.i = select i1 %.narrow.i.i.i.i.i, i64 32, i64 %7 ; 3 uses
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %.narrow.i.i.i.i27 = icmp ult i64 %i.cd, 19
  %.0.i.i.i.i27 = select i1 %.narrow.i.i.i.i27, i64 32, i64 %i.dk ; 2 uses
...
bb.c:                                             ; preds = %bb.a
  ...
  %.narrow.i.i.i = icmp ult i64 %1, 19
  %.0.i.i.i = select i1 %.narrow.i.i.i, i64 32, i64 %i.k ; 2 uses
...
bb.c:                                             ; preds = %bb.a
  ...
  %.narrow.i.i.i = icmp ult i64 %1, 19
  %.0.i.i.i = select i1 %.narrow.i.i.i, i64 32, i64 %i.l ; 2 uses
...
.thread:                                          ; preds = %_ZNK4absl12lts_202505124Cord5emptyEv.exit.thread
  ...
  %.narrow.i.i.i = icmp ult i8 %i.a, 38
  %.0.i.i.i = select i1 %.narrow.i.i.i, i64 32, i64 %6 ; 2 uses
