...
bb.a:
  ...
  %i.c = alloca [2 x ptr], align 16               ; 7 uses
...
.critedge22:                                      ; preds = %.critedge
  ...
  %i.k = add i64 %i.j, 1
  %i.l = call noalias ptr @malloc(i64 noundef %i.k) #28 ; 6 uses
...
bb.m:                                             ; preds = %bb.l
  %i.aj = call i32 @execvp(ptr noundef %i.l, ptr noundef nonnull %i.c) #25 ; 0 uses
  br label %bb.o

bb.n:                                             ; preds = %bb.l
  %i.ak = call i32 @execv(ptr noundef %i.l, ptr noundef nonnull %i.c) #25 ; 0 uses
  br label %bb.o
...
bb.p:                                             ; preds = %_ZN6google8protobuf8compiler12_GLOBAL__N_115portable_strdupEPKc.exit
  call void @free(ptr noundef %i.l) #25
