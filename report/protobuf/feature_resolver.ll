Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/protobuf/original/feature_resolver?download=true
...
bb.f:                                             ; preds = %_ZZN4absl12lts_2025051218container_internal5btreeINS1_10set_paramsIN6google8protobuf7EditionESt4lessIS6_ESaIS6_ELi256ELb0EEEE16internal_emplaceIJRKS6_EEENS1_14btree_iteratorINS1_10btree_nodeISA_EESE_PSD_EESJ_DpOT_ENKUlhE_clEh.exit, %bb.e, %bb.b
  ...
  %i.bh = load i32, ptr %i.a, align 8, !tbaa !118 ; 3 uses
...
.lr.ph.i:                                         ; preds = %bb.g
  %i.cc = getelementptr inbounds nuw i8, ptr %i.bg, i64 256 ; 10 uses
  %i.cd = zext i8 %i.bw to i64                    ; 4 uses
  %i.ce = zext nneg i32 %i.ca to i64
  %.mask = and i32 %i.bh, 255
  %i.cf = zext nneg i32 %.mask to i64             ; 2 uses
  %i.cg = xor i64 %i.cf, -1
  %i.ch = add nsw i64 %i.cg, %i.cd
  %i.ci = add nsw i64 %i.cd, -2
  %i.cj = sub nsw i64 %i.ci, %i.cf
  %xtraiter = and i64 %i.ch, 3                    ; 2 uses
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.lr.ph.i, %.prol.preheader
  %indvars.iv.prol = phi i64 [ %i.ck, %.prol.preheader ], [ %i.cd, %.lr.ph.i ] ; 3 uses
  %prol.iter = phi i64 [ %prol.iter.next, %.prol.preheader ], [ 0, %.lr.ph.i ]
  %i.ck = add nsw i64 %indvars.iv.prol, -1        ; 3 uses
  %i.cl = getelementptr inbounds nuw [8 x i8], ptr %i.cc, i64 %i.ck
  %i.cm = load ptr, ptr %i.cl, align 8, !tbaa !60 ; 2 uses
  %i.cn = getelementptr inbounds nuw [8 x i8], ptr %i.cc, i64 %indvars.iv.prol
  store ptr %i.cm, ptr %i.cn, align 8, !tbaa !60
  %i.co = getelementptr inbounds nuw i8, ptr %i.cm, i64 8
  %i.cp = trunc nuw i64 %indvars.iv.prol to i8
  store i8 %i.cp, ptr %i.co, align 1, !tbaa !39
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.prol.loopexit, label %.prol.preheader, !llvm.loop !212

.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph.i
  %indvars.iv.unr = phi i64 [ %i.cd, %.lr.ph.i ], [ %i.ck, %.prol.preheader ]
  %i.cq = icmp ult i64 %i.cj, 3
  br i1 %i.cq, label %_ZN4absl12lts_2025051218container_internal10btree_nodeINS1_10set_paramsIN6google8protobuf7EditionESt4lessIS6_ESaIS6_ELi256ELb0EEEE13emplace_valueIJRKS6_EEEvhPS9_DpOT_.exit, label %.lr.ph.i.new

.lr.ph.i.new:                                     ; preds = %.prol.loopexit, %.lr.ph.i.new
  %indvars.iv = phi i64 [ %i.dj, %.lr.ph.i.new ], [ %indvars.iv.unr, %.prol.loopexit ] ; 6 uses
  %i.cr = add nsw i64 %indvars.iv, -1             ; 3 uses
  %i.cs = getelementptr inbounds nuw [8 x i8], ptr %i.cc, i64 %i.cr
  %i.ct = load ptr, ptr %i.cs, align 8, !tbaa !60 ; 2 uses
  %i.cu = getelementptr inbounds nuw [8 x i8], ptr %i.cc, i64 %indvars.iv
  store ptr %i.ct, ptr %i.cu, align 8, !tbaa !60
  %i.cv = getelementptr inbounds nuw i8, ptr %i.ct, i64 8
  %i.cw = trunc nuw i64 %indvars.iv to i8
  store i8 %i.cw, ptr %i.cv, align 1, !tbaa !39
  %i.cx = add nsw i64 %indvars.iv, -2             ; 3 uses
  %i.cy = getelementptr inbounds nuw [8 x i8], ptr %i.cc, i64 %i.cx
  %i.cz = load ptr, ptr %i.cy, align 8, !tbaa !60 ; 2 uses
  %i.da = getelementptr inbounds nuw [8 x i8], ptr %i.cc, i64 %i.cr
  store ptr %i.cz, ptr %i.da, align 8, !tbaa !60
  %i.db = getelementptr inbounds nuw i8, ptr %i.cz, i64 8
  %i.dc = trunc nuw i64 %i.cr to i8
  store i8 %i.dc, ptr %i.db, align 1, !tbaa !39
  %i.dd = add nsw i64 %indvars.iv, -3             ; 3 uses
  %i.de = getelementptr inbounds nuw [8 x i8], ptr %i.cc, i64 %i.dd
  %i.df = load ptr, ptr %i.de, align 8, !tbaa !60 ; 2 uses
  %i.dg = getelementptr inbounds nuw [8 x i8], ptr %i.cc, i64 %i.cx
  store ptr %i.df, ptr %i.dg, align 8, !tbaa !60
  %i.dh = getelementptr inbounds nuw i8, ptr %i.df, i64 8
  %i.di = trunc nuw i64 %i.cx to i8
  store i8 %i.di, ptr %i.dh, align 1, !tbaa !39
  %i.dj = add nsw i64 %indvars.iv, -4             ; 3 uses
  %i.dk = getelementptr inbounds nuw [8 x i8], ptr %i.cc, i64 %i.dj
  %i.dl = load ptr, ptr %i.dk, align 8, !tbaa !60 ; 2 uses
  %i.dm = getelementptr inbounds nuw [8 x i8], ptr %i.cc, i64 %i.dd
  store ptr %i.dl, ptr %i.dm, align 8, !tbaa !60
  %i.dn = getelementptr inbounds nuw i8, ptr %i.dl, i64 8
  %i.do = trunc nuw i64 %i.dd to i8
  store i8 %i.do, ptr %i.dn, align 1, !tbaa !39
  %.wide.3 = icmp ugt i64 %i.dj, %i.ce
  br i1 %.wide.3, label %.lr.ph.i.new, label %_ZN4absl12lts_2025051218container_internal10btree_nodeINS1_10set_paramsIN6google8protobuf7EditionESt4lessIS6_ESaIS6_ELi256ELb0EEEE13emplace_valueIJRKS6_EEEvhPS9_DpOT_.exit, !llvm.loop !126

_ZN4absl12lts_2025051218container_internal10btree_nodeINS1_10set_paramsIN6google8protobuf7EditionESt4lessIS6_ESaIS6_ELi256ELb0EEEE13emplace_valueIJRKS6_EEEvhPS9_DpOT_.exit: ; preds = %.prol.loopexit, %.lr.ph.i.new, %_ZN4absl12lts_2025051218container_internal10btree_nodeINS1_10set_paramsIN6google8protobuf7EditionESt4lessIS6_ESaIS6_ELi256ELb0EEEE19transfer_n_backwardEmmmPSB_PS9_.exit.i, %bb.g
  %i.dp = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.dq = load i64, ptr %i.dp, align 8, !tbaa !59
  %i.dr = add i64 %i.dq, 1
  store i64 %i.dr, ptr %i.dp, align 8, !tbaa !59
...
bb.a:
  ...
  %i.b = load ptr, ptr %1, align 8, !tbaa !60     ; 7 uses
...
bb.n:                                             ; preds = %bb.a
  ...
  %3 = load ptr, ptr %1, align 8, !tbaa !60       ; 3 uses
  ...
  store ptr %i.bo, ptr %3, align 8, !tbaa !60
...
bb.p:                                             ; preds = %bb.o
  ...
  store ptr %.083, ptr %i.by, align 8, !tbaa !60
  ...
  call void @_ZN4absl12lts_2025051218container_internal10btree_nodeINS1_10set_paramsIN6google8protobuf7EditionESt4lessIS6_ESaIS6_ELi256ELb0EEEE5splitEiPSB_PS9_(ptr noundef nonnull align 1 dereferenceable(1) %5, i32 noundef %i.cd, ptr noundef nonnull %i.by, ptr noundef nonnull %i.bx)
...
bb.r:                                             ; preds = %bb.o
  ...
  store ptr %.083, ptr %i.ch, align 8, !tbaa !60
  ...
  call void @_ZN4absl12lts_2025051218container_internal10btree_nodeINS1_10set_paramsIN6google8protobuf7EditionESt4lessIS6_ESaIS6_ELi256ELb0EEEE5splitEiPSB_PS9_(ptr noundef nonnull align 1 dereferenceable(1) %6, i32 noundef %i.cm, ptr noundef nonnull %i.ch, ptr noundef nonnull %i.bx)
  br label %bb.s

bb.s:                                             ; preds = %bb.p, %bb.q, %bb.r
  %.0 = phi ptr [ %i.by, %bb.q ], [ %i.by, %bb.p ], [ %i.ch, %bb.r ]
  %i.cn = load i32, ptr %i.a, align 8, !tbaa !3   ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %.not.i, label %.lr.ph, label %._crit_edge, !llvm.loop !213
...
.lr.ph66:                                         ; preds = %bb.d, %.lr.ph66
  ...
  br i1 %.not.i56, label %.lr.ph66, label %._crit_edge67, !llvm.loop !214
...
bb.f:                                             ; preds = %.preheader58
  ...
  br i1 %.not, label %bb.g, label %.preheader58, !llvm.loop !216
