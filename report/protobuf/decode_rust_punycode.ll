...
bb.g:                                             ; preds = %._crit_edge.i, %bb.f, %bb.b
  %.178.ph = phi ptr [ %i.a, %bb.b ], [ %i.ac, %bb.f ], [ %i.a, %._crit_edge.i ] ; 2 uses
  %.371.ph = phi i32 [ 0, %bb.b ], [ %.14451.i, %bb.f ], [ 0, %._crit_edge.i ] ; 5 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %1) #5
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(64) %1, i8 0, i64 64, i1 false), !tbaa !17
  %.not109 = icmp eq ptr %.178.ph, %i.c
  br i1 %.not109, label %._crit_edge118, label %.lr.ph117

.lr.ph117:                                        ; preds = %bb.g
  %i.ad = getelementptr inbounds nuw i8, ptr %2, i64 4
  %.phi.trans.insert.i = getelementptr inbounds nuw i8, ptr %1, i64 56
  %umax = tail call i32 @llvm.umax.i32(i32 %.371.ph, i32 256)
  %exitcond154 = icmp ugt i32 %.371.ph, 255
  br i1 %exitcond154, label %.thread, label %.lr.ph.i50.preheader

.lr.ph.i50.preheader:                             ; preds = %.lr.ph117
...
bb.h:                                             ; preds = %bb.r
  ...
  br i1 %exitcond, label %.thread, label %.lr.ph.i50, !llvm.loop !19

.lr.ph.i50:                                       ; preds = %.lr.ph.i50.preheader, %bb.h
  %.077110160 = phi ptr [ %i.aw, %bb.h ], [ %.178.ph, %.lr.ph.i50.preheader ]
  %.072111159 = phi i32 [ %i.ar, %bb.h ], [ 0, %.lr.ph.i50.preheader ] ; 3 uses
  %.0112158 = phi i32 [ %i.bu, %bb.h ], [ %.371.ph, %.lr.ph.i50.preheader ]
  %.046113157 = phi i32 [ %i.cf, %bb.h ], [ 128, %.lr.ph.i50.preheader ]
  %.043114156 = phi i32 [ %i.cd, %bb.h ], [ 72, %.lr.ph.i50.preheader ] ; 3 uses
  %.040115155 = phi i32 [ %i.hi, %bb.h ], [ %.371.ph, %.lr.ph.i50.preheader ] ; 2 uses
  %i.as = add i32 %.043114156, 1
  %i.at = add i32 %.043114156, 26
  br label %bb.i

bb.i:                                             ; preds = %bb.o, %.lr.ph.i50
  %.02551.i = phi i64 [ 1, %.lr.ph.i50 ], [ %i.bo, %bb.o ] ; 2 uses
  %.03350.i = phi i32 [ 36, %.lr.ph.i50 ], [ %i.bp, %bb.o ] ; 4 uses
  %i.au = phi ptr [ %.077110160, %.lr.ph.i50 ], [ %i.aw, %bb.o ] ; 2 uses
  %i.av = phi i32 [ %.072111159, %.lr.ph.i50 ], [ %i.bk, %bb.o ]
...
bb.m:                                             ; preds = %bb.k
  ...
  br i1 %or.cond.i, label %.thread, label %_ZN4absl12lts_2025051218debugging_internal12_GLOBAL__N_110DigitValueEc.exit.thread.i
...
_ZN4absl12lts_2025051218debugging_internal12_GLOBAL__N_110DigitValueEc.exit.thread.i: ; preds = %bb.m, %bb.l, %bb.j
  ...
  br i1 %i.bj, label %.thread, label %bb.n
...
bb.n:                                             ; preds = %_ZN4absl12lts_2025051218debugging_internal12_GLOBAL__N_110DigitValueEc.exit.thread.i
  ...
  %i.bl = sub i32 %.03350.i, %.043114156
...
.lr.ph:                                           ; preds = %_ZN4absl12lts_2025051218debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit, %.lr.ph
  %.037107 = phi i32 [ %i.by, %.lr.ph ], [ %i.bw, %_ZN4absl12lts_2025051218debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit ] ; 2 uses
  %.144106 = phi i32 [ %i.bz, %.lr.ph ], [ 0, %_ZN4absl12lts_2025051218debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit ]
  %i.by = udiv i32 %.037107, 35                   ; 2 uses
  %i.bz = add i32 %.144106, 36                    ; 2 uses
  %i.ca = icmp ugt i32 %.037107, 15959
...
._crit_edge:                                      ; preds = %.lr.ph, %_ZN4absl12lts_2025051218debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit
  ...
  %i.cf = add i32 %i.ce, %.046113157              ; 2 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  br i1 %.not42.i, label %.lr.ph48.i, label %.lr.ph.i52

.preheader.i:                                     ; preds = %.lr.ph.i52.6, %.lr.ph.i52.5, %.lr.ph.i52.4, %.lr.ph.i52.3, %.lr.ph.i52.2, %.lr.ph.i52.1, %.lr.ph.i52
  %.lcssa166 = phi <2 x i32> [ %i.dj, %.lr.ph.i52 ], [ %i.dt, %.lr.ph.i52.1 ], [ %i.ed, %.lr.ph.i52.2 ], [ %i.en, %.lr.ph.i52.3 ], [ %i.ex, %.lr.ph.i52.4 ], [ %i.fh, %.lr.ph.i52.5 ], [ %i.fr, %.lr.ph.i52.6 ] ; 2 uses
  %.not49.i = icmp eq i32 %i.cn, 7
  br i1 %.not49.i, label %bb.r, label %.lr.ph48.i

.lr.ph.i52:                                       ; preds = %bb.q
  ...
  %indvars.iv.next.i54 = add nsw i64 %i.cs, -1    ; 2 uses
  %i.dk = icmp eq i64 %indvars.iv.next.i54, 0
  br i1 %i.dk, label %.preheader.i, label %.lr.ph.i52.1

.lr.ph.i52.1:                                     ; preds = %.lr.ph.i52
  %i.dl = getelementptr [8 x i8], ptr %1, i64 %indvars.iv.next.i54
  ...
  %indvars.iv.next.i54.1 = add nsw i64 %i.cs, -2  ; 2 uses
  %i.du = icmp eq i64 %indvars.iv.next.i54.1, 0
  br i1 %i.du, label %.preheader.i, label %.lr.ph.i52.2

.lr.ph.i52.2:                                     ; preds = %.lr.ph.i52.1
  %i.dv = getelementptr [8 x i8], ptr %1, i64 %indvars.iv.next.i54.1
  ...
  %indvars.iv.next.i54.2 = add nsw i64 %i.cs, -3  ; 2 uses
  %i.ee = icmp eq i64 %indvars.iv.next.i54.2, 0
  br i1 %i.ee, label %.preheader.i, label %.lr.ph.i52.3

.lr.ph.i52.3:                                     ; preds = %.lr.ph.i52.2
  %i.ef = getelementptr [8 x i8], ptr %1, i64 %indvars.iv.next.i54.2
  ...
  %indvars.iv.next.i54.3 = add nsw i64 %i.cs, -4  ; 2 uses
  %i.eo = icmp eq i64 %indvars.iv.next.i54.3, 0
  br i1 %i.eo, label %.preheader.i, label %.lr.ph.i52.4

.lr.ph.i52.4:                                     ; preds = %.lr.ph.i52.3
  %i.ep = getelementptr [8 x i8], ptr %1, i64 %indvars.iv.next.i54.3
  ...
  %indvars.iv.next.i54.4 = add nsw i64 %i.cs, -5  ; 2 uses
  %i.ey = icmp eq i64 %indvars.iv.next.i54.4, 0
  br i1 %i.ey, label %.preheader.i, label %.lr.ph.i52.5

.lr.ph.i52.5:                                     ; preds = %.lr.ph.i52.4
  %i.ez = getelementptr [8 x i8], ptr %1, i64 %indvars.iv.next.i54.4
  ...
  %indvars.iv.next.i54.5 = add nsw i64 %i.cs, -6  ; 2 uses
  %i.fi = icmp eq i64 %indvars.iv.next.i54.5, 0
  br i1 %i.fi, label %.preheader.i, label %.lr.ph.i52.6

.lr.ph.i52.6:                                     ; preds = %.lr.ph.i52.5
  %i.fj = getelementptr [8 x i8], ptr %1, i64 %indvars.iv.next.i54.5
...
.lr.ph48.i:                                       ; preds = %bb.q, %.preheader.i
  %i.fs = phi <2 x i32> [ %.lcssa166, %.preheader.i ], [ %i.da, %bb.q ]
...
bb.r:                                             ; preds = %._crit_edge.loopexit.i, %.preheader.i
  ...
  %i.hi = add i32 %i.ci, %.040115155              ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #5
  %.not = icmp eq ptr %i.aw, %i.c
  br i1 %.not, label %._crit_edge118, label %bb.h, !llvm.loop !19

._crit_edge118:                                   ; preds = %bb.r, %bb.g
  %.040.lcssa = phi i32 [ %.371.ph, %bb.g ], [ %i.hi, %bb.r ]
  %i.hj = zext i32 %.040.lcssa to i64
...
_ZN4absl12lts_2025051218debugging_internal12_GLOBAL__N_126ConsumeOptionalAsciiPrefixERPKcS4_PcS6_Rj.exit: ; preds = %bb.c, %.thread, %bb.d, %bb.e, %bb.a
  %.5 = phi ptr [ null, %bb.a ], [ %.3, %.thread ], [ null, %bb.e ], [ null, %bb.d ], [ null, %bb.c ]
  ret ptr %.5
}
