...
.lr.ph.i51:                                       ; preds = %.lr.ph.i51.preheader, %bb.h
  ...
  %.046101145 = phi i32 [ %i.cf, %bb.h ], [ 128, %.lr.ph.i51.preheader ]
  %.043102144 = phi i32 [ %i.cd, %bb.h ], [ 72, %.lr.ph.i51.preheader ] ; 3 uses
  %.040103143 = phi i32 [ %i.hi, %bb.h ], [ %.1.ph, %.lr.ph.i51.preheader ] ; 2 uses
  %i.as = add i32 %.043102144, 1
  %i.at = add i32 %.043102144, 26
  %i.au = zext nneg i32 %.07299147 to i64
  br label %bb.i

bb.i:                                             ; preds = %bb.o, %.lr.ph.i51
  %.02551.i = phi i64 [ 1, %.lr.ph.i51 ], [ %i.bn, %bb.o ] ; 2 uses
  %.03350.i = phi i32 [ 36, %.lr.ph.i51 ], [ %i.bo, %bb.o ] ; 4 uses
...
bb.n:                                             ; preds = %_ZN4absl12lts_2025051218debugging_internal12_GLOBAL__N_110DigitValueEc.exit.thread.i
  ...
  %i.bk = sub i32 %.03350.i, %.043102144
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.bn = mul i64 %.02551.i, %i.bm
  %i.bo = add i32 %.03350.i, 36
...
.lr.ph:                                           ; preds = %_ZN4absl12lts_2025051218debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit, %.lr.ph
  ...
  %.14494 = phi i32 [ %i.bz, %.lr.ph ], [ 0, %_ZN4absl12lts_2025051218debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit ]
  %i.by = udiv i32 %.03795, 35                    ; 2 uses
  %i.bz = add i32 %.14494, 36                     ; 2 uses
...
._crit_edge:                                      ; preds = %.lr.ph, %_ZN4absl12lts_2025051218debugging_internal12_GLOBAL__N_113ScanNextDeltaERPKcS4_jRj.exit
  ...
  %i.cf = add i32 %i.ce, %.046101145              ; 2 uses
...
bb.p:                                             ; preds = %._crit_edge
  %i.cj = add i32 %.040103143, 1                  ; 2 uses
...
_ZN4absl12lts_2025051218debugging_internal25BoundedUtf8LengthSequenceILj256EE32InsertAndReturnSumOfPredecessorsEjj.exit: ; preds = %.preheader.i, %._crit_edge.loopexit.i
  ...
  %i.hi = add i32 %i.ci, %.040103143              ; 2 uses
...
._crit_edge106:                                   ; preds = %_ZN4absl12lts_2025051218debugging_internal25BoundedUtf8LengthSequenceILj256EE32InsertAndReturnSumOfPredecessorsEjj.exit, %bb.g
  %.040.lcssa = phi i32 [ %.1.ph, %bb.g ], [ %i.hi, %_ZN4absl12lts_2025051218debugging_internal25BoundedUtf8LengthSequenceILj256EE32InsertAndReturnSumOfPredecessorsEjj.exit ]
