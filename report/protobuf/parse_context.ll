...
begin_hunk_0_@_ZN6google8protobuf8internal18EpsCopyInputStream23ReadMicroStringFallbackEPKciRNS1_11MicroStringEPNS0_5ArenaE:bb.a
  %i.hb = or disjoint i64 %i.ha, %i.gw
...
bb.ai:                                            ; preds = %bb.al, %bb.ah
  ...
  %.021.i.i.i.i61.i = phi i32 [ %i.hh, %bb.ah ], [ %i.hv, %bb.al ]
  %.020.i.i.i.i62.i = phi ptr [ %i.hg, %bb.ah ], [ %i.ij, %bb.al ]
...
bb.aj:                                            ; preds = %bb.ai
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %.0.i.i60.i, ptr readonly align 1 %.020.i.i.i.i62.i, i64 %i.ht, i1 false)
  %i.hu = getelementptr inbounds nuw i8, ptr %.0.i.i60.i, i64 %i.ht ; 5 uses
  %i.hv = sub i32 %.021.i.i.i.i61.i, %.0.i.i.i.i63.i ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi16 = phi <2 x i64> [ zeroinitializer, %vector.ph ], [ %i.o, %vector.body ]
  %i.l = shl i64 %index, 3
  %next.gep = getelementptr i8, ptr %0, i64 %i.l  ; 2 uses
  %i.m = getelementptr i8, ptr %next.gep, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep, align 1
  %wide.load17 = load <2 x i64>, ptr %i.m, align 1
  %i.n = or <2 x i64> %wide.load, %vec.phi        ; 2 uses
  %i.o = or <2 x i64> %wide.load17, %vec.phi16    ; 2 uses
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.p = icmp eq i64 %index.next, %n.vec
  br i1 %i.p, label %middle.block, label %vector.body, !llvm.loop !80
...
.lr.ph.preheader18:                               ; preds = %.lr.ph.preheader, %middle.block
  %.014.ph = phi ptr [ %0, %.lr.ph.preheader ], [ %i.k, %middle.block ]
  %.01113.ph = phi i64 [ 0, %.lr.ph.preheader ], [ %i.q, %middle.block ]
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader18, %.lr.ph
  %.014 = phi ptr [ %i.s, %.lr.ph ], [ %.014.ph, %.lr.ph.preheader18 ] ; 2 uses
  %.01113 = phi i64 [ %i.r, %.lr.ph ], [ %.01113.ph, %.lr.ph.preheader18 ]
  %.0.copyload1 = load i64, ptr %.014, align 1
  %i.r = or i64 %.0.copyload1, %.01113            ; 2 uses
  %i.s = getelementptr inbounds nuw i8, ptr %.014, i64 8 ; 2 uses
  %i.t = icmp ult ptr %i.s, %i.a
  br i1 %i.t, label %.lr.ph, label %._crit_edge, !llvm.loop !81

._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %bb.a
  %.011.lcssa = phi i64 [ 0, %bb.a ], [ %i.q, %middle.block ], [ %i.r, %.lr.ph ]
  %.0.copyload = load i64, ptr %i.a, align 1
  %i.u = or i64 %.0.copyload, %.011.lcssa
  %i.v = and i64 %i.u, -72340172838076674
