...
upb_MiniTableExtension_CType.exit.i:              ; preds = %bb.s, %bb.r
  ...
  %9 = add nsw i64 %8, -9
  %10 = icmp ult i64 %9, 2
  br i1 %10, label %bb.t, label %upb_MiniTableExtension_GetSubMessage.exit
...
upb_MiniTableField_CType.exit.i:                  ; preds = %bb.v, %bb.u
  ...
  br i1 %15, label %bb.w, label %upb_MiniTableExtension_GetSubMessage.exit
