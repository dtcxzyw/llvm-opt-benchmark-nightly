...
.lr.ph16.i:                                       ; preds = %_ZNK6google8protobuf10Reflection26PopulateTcParseFastEntriesERKNS0_8internal17TailCallTableInfoEPNS2_16TcParseTableBase14FastFieldEntryE.exit, %._crit_edge.i
  ...
  %.sroa.05.013.i = phi ptr [ %i.pp, %._crit_edge.i ], [ %.val, %_ZNK6google8protobuf10Reflection26PopulateTcParseFastEntriesERKNS0_8internal17TailCallTableInfoEPNS2_16TcParseTableBase14FastFieldEntryE.exit ] ; 4 uses
  ...
  %9 = ptrtoint ptr %i.ov to i64                  ; 2 uses
  %i.ow = load ptr, ptr %i.ot, align 8, !tbaa !638 ; 9 uses
  %10 = ptrtoint ptr %i.ow to i64                 ; 2 uses
  ...
  %i.pc = getelementptr i8, ptr %.014.i, i64 6    ; 6 uses
  store i16 %i.pb, ptr %i.os, align 2, !tbaa !530
  %.not89.i = icmp eq ptr %i.ow, %i.ov
  br i1 %.not89.i, label %._crit_edge.i, label %.lr.ph.i104.preheader

.lr.ph.i104.preheader:                            ; preds = %.lr.ph16.i
  %i.pd = add i64 %9, -4
  %i.pe = sub i64 %i.pd, %10                      ; 2 uses
  %i.pf = lshr i64 %i.pe, 2
  %i.pg = add nuw nsw i64 %i.pf, 1                ; 2 uses
  %min.iters.check306 = icmp ult i64 %i.pe, 28
...
vector.memcheck:                                  ; preds = %.lr.ph.i104.preheader
  ...
  %scevgep304 = getelementptr i8, ptr %scevgep303, i64 %i.pj
  %bound0 = icmp ult ptr %i.pc, %scevgep304
  %bound1 = icmp ult ptr %i.ow, %scevgep302
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %.lr.ph.i104.preheader324, label %vector.ph307

vector.ph307:                                     ; preds = %vector.memcheck
  %n.vec309 = and i64 %i.pg, 9223372036854775804  ; 3 uses
  %i.pk = shl i64 %n.vec309, 2                    ; 2 uses
  %i.pl = getelementptr i8, ptr %i.pc, i64 %i.pk  ; 2 uses
  %i.pm = getelementptr i8, ptr %i.ow, i64 %i.pk
...
vector.body310:                                   ; preds = %vector.body310, %vector.ph307
  ...
  %i.pn = shl i64 %index311, 2                    ; 2 uses
  %next.gep312 = getelementptr i8, ptr %i.pc, i64 %i.pn
  %next.gep313 = getelementptr i8, ptr %i.ow, i64 %i.pn
  ...
  %i.po = icmp eq i64 %index.next315, %n.vec309
  br i1 %i.po, label %middle.block316, label %vector.body310, !llvm.loop !677

middle.block316:                                  ; preds = %vector.body310
  %cmp.n = icmp eq i64 %i.pg, %n.vec309
...
.lr.ph.i104.preheader324:                         ; preds = %vector.memcheck, %.lr.ph.i104.preheader, %middle.block316
  %.111.i.ph = phi ptr [ %i.pc, %vector.memcheck ], [ %i.pc, %.lr.ph.i104.preheader ], [ %i.pl, %middle.block316 ]
  %.sroa.01.010.i.ph = phi ptr [ %i.ow, %vector.memcheck ], [ %i.ow, %.lr.ph.i104.preheader ], [ %i.pm, %middle.block316 ]
  br label %.lr.ph.i104

._crit_edge.i:                                    ; preds = %.lr.ph.i104, %middle.block316, %.lr.ph16.i
  %.1.lcssa.i = phi ptr [ %i.pc, %.lr.ph16.i ], [ %i.pl, %middle.block316 ], [ %i.pq, %.lr.ph.i104 ] ; 2 uses
  %i.pp = getelementptr inbounds nuw i8, ptr %.sroa.05.013.i, i64 32 ; 2 uses
  %.not.i106 = icmp eq ptr %i.pp, %.val64
...
.lr.ph.i104:                                      ; preds = %.lr.ph.i104.preheader324, %.lr.ph.i104
  %.111.i = phi ptr [ %i.pq, %.lr.ph.i104 ], [ %.111.i.ph, %.lr.ph.i104.preheader324 ] ; 2 uses
  %.sroa.01.010.i = phi ptr [ %i.ps, %.lr.ph.i104 ], [ %.sroa.01.010.i.ph, %.lr.ph.i104.preheader324 ] ; 2 uses
  %i.pq = getelementptr inbounds nuw i8, ptr %.111.i, i64 4 ; 2 uses
  %i.pr = load <2 x i16>, ptr %.sroa.01.010.i, align 2, !tbaa !530
  store <2 x i16> %i.pr, ptr %.111.i, align 2, !tbaa !530
  %i.ps = getelementptr inbounds nuw i8, ptr %.sroa.01.010.i, i64 4 ; 2 uses
  %.not8.i105 = icmp eq ptr %i.ps, %i.ov
...
_ZN6google8protobufL26PopulateTcParseLookupTableERKNS0_8internal17TailCallTableInfoEPt.exit: ; preds = %._crit_edge.i, %_ZNK6google8protobuf10Reflection26PopulateTcParseFastEntriesERKNS0_8internal17TailCallTableInfoEPNS2_16TcParseTableBase14FastFieldEntryE.exit
  ...
  %i.pt = getelementptr inbounds nuw i8, ptr %.0.lcssa.i107, i64 2
  store i16 -1, ptr %.0.lcssa.i107, align 2, !tbaa !530
  store i16 -1, ptr %i.pt, align 2, !tbaa !530
  %i.pu = getelementptr inbounds nuw i8, ptr %3, i64 32
  %i.pv = load ptr, ptr %i.pu, align 8, !tbaa !521 ; 2 uses
  %i.pw = getelementptr inbounds nuw i8, ptr %3, i64 40
  %i.px = load ptr, ptr %i.pw, align 8, !tbaa !521 ; 2 uses
  %.not2527.i = icmp eq ptr %i.pv, %i.px
...
.lr.ph.i108:                                      ; preds = %_ZN6google8protobufL26PopulateTcParseLookupTableERKNS0_8internal17TailCallTableInfoEPt.exit
  %i.py = load i32, ptr %i.ls, align 8, !tbaa !660
  %i.pz = zext i32 %i.py to i64
  %i.qa = add i64 %i.pz, %i.on
  %i.qb = inttoptr i64 %i.qa to ptr
  %i.qc = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.qd = load ptr, ptr %i.qc, align 8, !tbaa !100
  %i.qe = getelementptr inbounds nuw i8, ptr %0, i64 64
  %i.qf = load i32, ptr %i.qe, align 8
  %i.qg = load i32, ptr %i.jw, align 8            ; 2 uses
  %.not26.i = icmp eq i32 %i.qg, -1
  %i.qh = shl i32 %i.qg, 3
  br label %bb.bi

bb.bi:                                            ; preds = %bb.bp, %.lr.ph.i108
  %.029.i = phi ptr [ %i.qb, %.lr.ph.i108 ], [ %i.sd, %bb.bp ] ; 4 uses
  %.sroa.022.028.i = phi ptr [ %i.pv, %.lr.ph.i108 ], [ %i.se, %bb.bp ] ; 4 uses
  %i.qi = load ptr, ptr %.sroa.022.028.i, align 8, !tbaa !523 ; 8 uses
  %i.qj = getelementptr inbounds nuw i8, ptr %i.qi, i64 3
  %i.qk = load i8, ptr %i.qj, align 1
  %i.ql = and i8 %i.qk, 8
  %.not.i.i109 = icmp eq i8 %i.ql, 0
  %.phi.trans.insert.i = getelementptr inbounds nuw i8, ptr %i.qi, i64 1
  %.pre.i = load i8, ptr %.phi.trans.insert.i, align 1
  br i1 %.not.i.i109, label %_ZNK6google8protobuf15FieldDescriptor21real_containing_oneofEv.exit.i, label %bb.bj

bb.bj:                                            ; preds = %bb.bi
  %i.qm = getelementptr inbounds nuw i8, ptr %i.qi, i64 40
  %i.qn = load ptr, ptr %i.qm, align 8, !nonnull !50
...
_ZNK6google8protobuf15FieldDescriptor21real_containing_oneofEv.exit.i: ; preds = %bb.bj, %bb.bi
  %.0.i.i111 = phi ptr [ %i.qn, %bb.bj ], [ null, %bb.bi ] ; 3 uses
  %i.qo = and i8 %.pre.i, 8
  %.not.i.i21.i = icmp eq i8 %i.qo, 0
...
bb.bk:                                            ; preds = %_ZNK6google8protobuf15FieldDescriptor21real_containing_oneofEv.exit.i
  %i.qp = getelementptr inbounds nuw i8, ptr %i.qi, i64 32
...
_ZNK6google8protobuf15FieldDescriptor15extension_scopeEv.exit.i.i.i112: ; preds = %_ZNK6google8protobuf15FieldDescriptor21real_containing_oneofEv.exit.i
  %i.qs = getelementptr inbounds nuw i8, ptr %i.qi, i64 40
  %i.qt = load ptr, ptr %i.qs, align 8, !tbaa !31 ; 2 uses
  %.not1.i.i.i113 = icmp eq ptr %i.qt, null
...
_ZNK6google8protobuf15FieldDescriptor5indexEv.exit.i.i115: ; preds = %bb.bl, %_ZNK6google8protobuf15FieldDescriptor15extension_scopeEv.exit4.i.i.i114, %bb.bk
  %.sink7.in.i.i.i116 = phi ptr [ %i.qx, %bb.bl ], [ %i.qu, %_ZNK6google8protobuf15FieldDescriptor15extension_scopeEv.exit4.i.i.i114 ], [ %i.qr, %bb.bk ]
  %.sink7.i.i.i117 = load ptr, ptr %.sink7.in.i.i.i116, align 8, !tbaa !33
  %i.qy = ptrtoint ptr %i.qi to i64
  %i.qz = ptrtoint ptr %.sink7.i.i.i117 to i64
  %i.ra = sub i64 %i.qy, %i.qz
  %.0.in.i.i.i118 = sdiv exact i64 %i.ra, 88
  %sext.i.i119 = shl i64 %.0.in.i.i.i118, 32
  %i.rb = ashr exact i64 %sext.i.i119, 30
  %i.rc = getelementptr inbounds i8, ptr %i.qd, i64 %i.rb
  %i.rd = load i32, ptr %i.rc, align 4, !tbaa !3
  %i.re = getelementptr inbounds nuw i8, ptr %i.qi, i64 2
  %i.rf = load i8, ptr %i.re, align 2, !tbaa !96
  %switch.tableidx319 = add i8 %i.rf, -9          ; 2 uses
  %i.rg = icmp ult i8 %switch.tableidx319, 4
  br i1 %i.rg, label %switch.lookup320, label %_ZNK6google8protobuf8internal16ReflectionSchema14GetFieldOffsetIvEEjPKNS0_15FieldDescriptorE.exit.i120

switch.lookup320:                                 ; preds = %_ZNK6google8protobuf15FieldDescriptor5indexEv.exit.i.i115
  %i.rh = zext nneg i8 %switch.tableidx319 to i64
  %switch.gep321 = getelementptr inbounds nuw [4 x i8], ptr @switch.table._ZNK6google8protobuf10Reflection18CreateTcParseTableEv.282, i64 %i.rh
...
_ZNK6google8protobuf8internal16ReflectionSchema14GetFieldOffsetIvEEjPKNS0_15FieldDescriptorE.exit.i120: ; preds = %_ZNK6google8protobuf15FieldDescriptor5indexEv.exit.i.i115, %switch.lookup320
  ...
  %i.ri = and i32 %.sink.i.i.i121, %i.rd
  store i32 %i.ri, ptr %.029.i, align 4, !tbaa !526
...
bb.bm:                                            ; preds = %_ZNK6google8protobuf8internal16ReflectionSchema14GetFieldOffsetIvEEjPKNS0_15FieldDescriptorE.exit.i120
  %i.rj = getelementptr inbounds nuw i8, ptr %.0.i.i111, i64 16
  %i.rk = load ptr, ptr %i.rj, align 8, !tbaa !51
  %i.rl = getelementptr inbounds nuw i8, ptr %i.rk, i64 72
  %i.rm = load ptr, ptr %i.rl, align 8, !tbaa !54
  %i.rn = ptrtoint ptr %.0.i.i111 to i64
  %i.ro = ptrtoint ptr %i.rm to i64
  %i.rp = sub i64 %i.rn, %i.ro
  %i.rq = sdiv exact i64 %i.rp, 56
  %i.rr = trunc i64 %i.rq to i32
  %i.rs = shl nsw i32 %i.rr, 2
  %i.rt = add nsw i32 %i.rs, %i.qf
  br label %bb.bp
...
bb.bo:                                            ; preds = %bb.bn
  %i.ru = getelementptr inbounds nuw i8, ptr %.sroa.022.028.i, i64 8
  %i.rv = load i32, ptr %i.ru, align 8, !tbaa !528 ; 2 uses
  %i.rw = icmp sgt i32 %i.rv, -1
  %i.rx = add i32 %i.rv, %i.qh
  %i.ry = select i1 %i.rw, i32 %i.rx, i32 -1
  br label %bb.bp

bb.bp:                                            ; preds = %bb.bo, %bb.bn, %bb.bm
  %.sink.i123 = phi i32 [ %i.ry, %bb.bo ], [ %i.rt, %bb.bm ], [ 0, %bb.bn ]
  %i.rz = getelementptr inbounds nuw i8, ptr %.029.i, i64 4
  store i32 %.sink.i123, ptr %i.rz, align 4, !tbaa !529
  %i.sa = getelementptr inbounds nuw i8, ptr %.sroa.022.028.i, i64 12
  %i.sb = getelementptr inbounds nuw i8, ptr %.029.i, i64 8
  %i.sc = load <2 x i16>, ptr %i.sa, align 4, !tbaa !530
  store <2 x i16> %i.sc, ptr %i.sb, align 4, !tbaa !530
  %i.sd = getelementptr inbounds nuw i8, ptr %.029.i, i64 12
  %i.se = getelementptr inbounds nuw i8, ptr %.sroa.022.028.i, i64 24 ; 2 uses
  %.not25.i = icmp eq ptr %i.se, %i.px
...
_ZNK6google8protobuf10Reflection22PopulateTcParseEntriesERNS0_8internal17TailCallTableInfoEPNS2_16TcParseTableBase10FieldEntryE.exit: ; preds = %bb.bp, %_ZN6google8protobufL26PopulateTcParseLookupTableERKNS0_8internal17TailCallTableInfoEPt.exit
  %i.sf = load i32, ptr %i.lv, align 8, !tbaa !663
  %i.sg = zext i32 %i.sf to i64
  %i.sh = add i64 %i.sg, %i.on
  %i.si = inttoptr i64 %i.sh to ptr
  invoke void @_ZNK6google8protobuf10Reflection23PopulateTcParseFieldAuxERKNS0_8internal17TailCallTableInfoEPNS2_16TcParseTableBase8FieldAuxE(ptr noundef nonnull align 8 dereferenceable(96) %0, ptr noundef nonnull align 8 dereferenceable(140) %3, ptr noundef %i.si)
          to label %bb.bq unwind label %bb.bt

bb.bq:                                            ; preds = %_ZNK6google8protobuf10Reflection22PopulateTcParseEntriesERNS0_8internal17TailCallTableInfoEPNS2_16TcParseTableBase10FieldEntryE.exit
end_hunk_1
