...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !515  ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph, %bb.i
  ...
  %i.l = load ptr, ptr %.sroa.022.028, align 8, !tbaa !517 ; 8 uses
...
_ZNK6google8protobuf8internal16ReflectionSchema14GetFieldOffsetIvEEjPKNS0_15FieldDescriptorE.exit: ; preds = %_ZNK6google8protobuf15FieldDescriptor5indexEv.exit.i, %switch.lookup
  ...
  store i32 %i.al, ptr %.029, align 4, !tbaa !520
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ay = load i32, ptr %i.ax, align 8, !tbaa !522 ; 2 uses
...
bb.i:                                             ; preds = %bb.g, %bb.h, %bb.f
  ...
  store i32 %.sink, ptr %i.bc, align 4, !tbaa !523
  %i.bd = getelementptr inbounds nuw i8, ptr %.sroa.022.028, i64 12
  %i.be = getelementptr inbounds nuw i8, ptr %.029, i64 8
  %i.bf = load <2 x i16>, ptr %i.bd, align 4, !tbaa !524
  store <2 x i16> %i.bf, ptr %i.be, align 4, !tbaa !524
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !525  ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 64
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !525  ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph, %bb.an
  ...
  %i.k = load i32, ptr %.sroa.025.052, align 8, !tbaa !527
...
bb.c:                                             ; preds = %bb.b
  ...
  store i64 0, ptr %.053, align 8, !tbaa !31
  br label %bb.an

bb.d:                                             ; preds = %bb.b
  %i.m = load i32, ptr %i.j, align 4, !tbaa !99
  %i.n = getelementptr inbounds nuw i8, ptr %.053, i64 8
  store i32 %i.m, ptr %.053, align 8, !tbaa !31
  br label %bb.an

bb.e:                                             ; preds = %bb.b
  %i.o = load i32, ptr %i.i, align 8, !tbaa !501
  %i.p = getelementptr inbounds nuw i8, ptr %.053, i64 8
  store i32 %i.o, ptr %.053, align 8, !tbaa !31
  br label %bb.an
...
bb.h:                                             ; preds = %bb.b
  %i.r = getelementptr inbounds nuw i8, ptr %.053, i64 8
  store i32 0, ptr %.053, align 8
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %.053, i64 4
  store i8 0, ptr %.sroa.5.0..sroa_idx, align 4, !tbaa !31
  br label %bb.an
...
bb.i:                                             ; preds = %bb.b
  ...
  %i.v = getelementptr inbounds nuw i8, ptr %.053, i64 8
  store ptr %i.u, ptr %.053, align 8, !tbaa !31
  br label %bb.an

bb.j:                                             ; preds = %bb.b
  %i.w = getelementptr inbounds nuw i8, ptr %.sroa.025.052, i64 8
  %i.x = getelementptr inbounds nuw i8, ptr %.053, i64 8
  %i.y = load <2 x i32>, ptr %i.w, align 8, !tbaa !31
  store <2 x i32> %i.y, ptr %.053, align 8, !tbaa !3
  br label %bb.an
...
bb.k:                                             ; preds = %bb.b
  ...
  %i.ad = load ptr, ptr %i.ac, align 8, !tbaa !530
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 24
  %i.af = load ptr, ptr %i.ae, align 8, !tbaa !531 ; 7 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #35
  store ptr %i.ab, ptr %3, align 8, !tbaa !540
  store ptr @"_ZZN6google8protobuf14DescriptorPool17MemoizeProjectionINS0_14EnumDescriptorEZNKS0_10Reflection23PopulateTcParseFieldAuxERKNS0_8internal17TailCallTableInfoEPNS5_16TcParseTableBase8FieldAuxEE3$_0EERKDaPKT_T0_E8type_key", ptr %i.e, align 8, !tbaa !542
  ...
  %i.ah = load ptr, ptr %i.ag, align 8, !tbaa !543
...
bb.q:                                             ; preds = %_ZN4absl12lts_2025051215ReaderMutexLockD2Ev.exit.i
  %i.ar = call noalias noundef nonnull dereferenceable(32) ptr @_Znwm(i64 noundef 32) #38, !noalias !547 ; 6 uses
  store ptr getelementptr inbounds nuw inrange(-16, 16) (i8, ptr @_ZTVN6google8protobuf14DescriptorPool8MemoDataISt6vectorIjSaIjEEEE, i64 16), ptr %i.ar, align 8, !tbaa !149, !noalias !547
  %i.as = getelementptr inbounds nuw i8, ptr %i.ar, i64 8 ; 3 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.as, i8 0, i64 24, i1 false), !noalias !547
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #35
  %i.at = getelementptr inbounds nuw i8, ptr %i.ab, i64 4 ; 3 uses
  %i.au = load i32, ptr %i.at, align 4, !tbaa !177, !noalias !550 ; 3 uses
...
bb.r:                                             ; preds = %bb.q
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.135) #40
          to label %.noexc.i.i.i unwind label %.thread, !noalias !550
...
_ZNSt12_Vector_baseIiSaIiEE11_M_allocateEm.exit.i.i.i.i: ; preds = %bb.s
  ...
  %i.ay = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.ax) #38
          to label %_ZNSt6vectorIiSaIiEE7reserveEm.exit.i.i.i unwind label %.loopexit, !noalias !550 ; 4 uses

_ZNSt6vectorIiSaIiEE7reserveEm.exit.i.i.i:        ; preds = %_ZNSt12_Vector_baseIiSaIiEE11_M_allocateEm.exit.i.i.i.i
  %i.az = getelementptr inbounds nuw [4 x i8], ptr %i.ay, i64 %i.av ; 2 uses
  %.pre.i.i.i = load i32, ptr %i.at, align 4, !tbaa !177, !noalias !550
  %i.ba = icmp sgt i32 %.pre.i.i.i, 0
  br i1 %i.ba, label %.lr.ph.i.i.i, label %._crit_edge._ZSt6uniqueIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEET_S7_S7_.exit.thread_crit_edge.i.i.i

.lr.ph.i.i.i:                                     ; preds = %_ZNSt6vectorIiSaIiEE7reserveEm.exit.i.i.i
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ab, i64 56
  br label %bb.u

._crit_edge.i.i.i:                                ; preds = %_ZNSt6vectorIiSaIiEE9push_backEOi.exit.i.i.i
  %.not.i.i.i.i.i.i = icmp eq ptr %.sroa.032.4.i.i.i, %.sroa.15.2.i.i.i
...
._crit_edge._ZSt6uniqueIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEET_S7_S7_.exit.thread_crit_edge.i.i.i: ; preds = %._crit_edge.i.i.i, %_ZNSt6vectorIiSaIiEE7reserveEm.exit.i.i.i, %bb.s
  %.sroa.032.0.lcssa106.i.i.i = phi ptr [ %.sroa.032.4.i.i.i, %._crit_edge.i.i.i ], [ %i.ay, %_ZNSt6vectorIiSaIiEE7reserveEm.exit.i.i.i ], [ null, %bb.s ] ; 2 uses
  %.sroa.28.0.lcssa101.i.i.i = phi ptr [ %.sroa.28.4.i.i.i, %._crit_edge.i.i.i ], [ %i.az, %_ZNSt6vectorIiSaIiEE7reserveEm.exit.i.i.i ], [ null, %bb.s ]
  %.pre85.i.i.i = ptrtoint ptr %.sroa.032.0.lcssa106.i.i.i to i64 ; 2 uses
  br label %_ZNSt6vectorIiSaIiEE5eraseEN9__gnu_cxx17__normal_iteratorIPKiS1_EES6_.exit.i.i.i

bb.t:                                             ; preds = %._crit_edge.i.i.i
  %i.bc = ptrtoint ptr %.sroa.15.2.i.i.i to i64   ; 3 uses
  ...
  invoke void @_ZSt16__introsort_loopIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEElNS0_5__ops15_Iter_less_iterEEvT_S9_T0_T1_(ptr %.sroa.032.4.i.i.i, ptr nonnull %.sroa.15.2.i.i.i, i64 noundef %i.bi)
          to label %.noexc16.i.i.i unwind label %.loopexit, !noalias !550

.noexc16.i.i.i:                                   ; preds = %bb.t
  invoke void @_ZSt22__final_insertion_sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_less_iterEEvT_S9_T0_(ptr %.sroa.032.4.i.i.i, ptr nonnull %.sroa.15.2.i.i.i)
          to label %.preheader.i.i.i.i.i.i unwind label %.loopexit, !noalias !550
...
.loopexit:                                        ; preds = %_ZNSt12_Vector_baseIiSaIiEE11_M_allocateEm.exit.i.i.i.i, %bb.t, %.noexc16.i.i.i, %_ZNSt6vectorIiSaIiEE5eraseEN9__gnu_cxx17__normal_iteratorIPKiS1_EES6_.exit.i.i.i
  %.sroa.28.1.i.i.i.ph = phi ptr [ null, %_ZNSt12_Vector_baseIiSaIiEE11_M_allocateEm.exit.i.i.i.i ], [ %.sroa.28.4.i.i.i, %bb.t ], [ %.sroa.28.4.i.i.i, %.noexc16.i.i.i ], [ %.sroa.28.0.lcssa99.i.i.i, %_ZNSt6vectorIiSaIiEE5eraseEN9__gnu_cxx17__normal_iteratorIPKiS1_EES6_.exit.i.i.i ]
  %.sroa.032.1.i.i.i.ph = phi ptr [ null, %_ZNSt12_Vector_baseIiSaIiEE11_M_allocateEm.exit.i.i.i.i ], [ %.sroa.032.4.i.i.i, %bb.t ], [ %.sroa.032.4.i.i.i, %.noexc16.i.i.i ], [ %.sroa.032.0.lcssa104.i.i.i, %_ZNSt6vectorIiSaIiEE5eraseEN9__gnu_cxx17__normal_iteratorIPKiS1_EES6_.exit.i.i.i ]
...
bb.u:                                             ; preds = %_ZNSt6vectorIiSaIiEE9push_backEOi.exit.i.i.i, %.lr.ph.i.i.i
  ...
  %.sroa.032.075.i.i.i = phi ptr [ %i.ay, %.lr.ph.i.i.i ], [ %.sroa.032.4.i.i.i, %_ZNSt6vectorIiSaIiEE9push_backEOi.exit.i.i.i ] ; 6 uses
  %.sroa.15.074.i.i.i = phi ptr [ %i.ay, %.lr.ph.i.i.i ], [ %.sroa.15.2.i.i.i, %_ZNSt6vectorIiSaIiEE9push_backEOi.exit.i.i.i ] ; 6 uses
  %.sroa.28.073.i.i.i = phi ptr [ %i.az, %.lr.ph.i.i.i ], [ %.sroa.28.4.i.i.i, %_ZNSt6vectorIiSaIiEE9push_backEOi.exit.i.i.i ] ; 2 uses
  %i.bj = load ptr, ptr %i.bb, align 8, !tbaa !182, !noalias !550
  %i.bk = getelementptr inbounds nuw [48 x i8], ptr %i.bj, i64 %indvars.iv.i.i.i
  %i.bl = getelementptr inbounds nuw i8, ptr %i.bk, i64 4
  %i.bm = load i32, ptr %i.bl, align 4, !tbaa !170, !noalias !550 ; 2 uses
  %.not.i.i.i.i.i = icmp eq ptr %.sroa.15.074.i.i.i, %.sroa.28.073.i.i.i
  br i1 %.not.i.i.i.i.i, label %bb.w, label %bb.v

bb.v:                                             ; preds = %bb.u
  store i32 %i.bm, ptr %.sroa.15.074.i.i.i, align 4, !tbaa !3, !noalias !550
  br label %_ZNSt6vectorIiSaIiEE9push_backEOi.exit.i.i.i

bb.w:                                             ; preds = %bb.u
  %i.bn = ptrtoint ptr %.sroa.15.074.i.i.i to i64
  %i.bo = ptrtoint ptr %.sroa.032.075.i.i.i to i64
...
bb.x:                                             ; preds = %bb.w
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.136) #40
          to label %.noexc18.i.i.i unwind label %.loopexit.split-lp.i.i.i, !noalias !550
...
_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc.exit.i.i.i.i.i.i: ; preds = %bb.w
  ...
  %.not.i.i.i.i.i.i.i = icmp ne i64 %i.bv, 0
  call void @llvm.assume(i1 %.not.i.i.i.i.i.i.i)
  %i.bw = shl nuw nsw i64 %i.bv, 2
  %i.bx = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.bw) #38
          to label %.noexc19.i.i.i unwind label %.loopexit.i.i.i, !noalias !550 ; 4 uses
...
.noexc19.i.i.i:                                   ; preds = %_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc.exit.i.i.i.i.i.i
  ...
  store i32 %i.bm, ptr %i.by, align 4, !tbaa !3, !noalias !550
  %i.bz = icmp sgt i64 %i.bp, 0
  br i1 %i.bz, label %bb.y, label %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i.i.i.i.i

bb.y:                                             ; preds = %.noexc19.i.i.i
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 4 %i.bx, ptr align 4 %.sroa.032.075.i.i.i, i64 %i.bp, i1 false), !noalias !550
...
_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i.i.i.i.i: ; preds = %bb.y, %.noexc19.i.i.i
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.032.075.i.i.i, i64 noundef %i.bp) #39, !noalias !550
  %i.ca = getelementptr inbounds nuw [4 x i8], ptr %i.bx, i64 %i.bv
  br label %_ZNSt6vectorIiSaIiEE9push_backEOi.exit.i.i.i
...
begin_hunk_1_@_ZNK6google8protobuf10Reflection23PopulateTcParseFieldAuxERKNS0_8internal17TailCallTableInfoEPNS2_16TcParseTableBase8FieldAuxE:bb.a
  %.pre.i.i = ptrtoint ptr %i.cp to i64
  br label %_ZNSt6vectorIiSaIiEE5eraseEN9__gnu_cxx17__normal_iteratorIPKiS1_EES6_.exit.i.i.i
...
_ZNSt6vectorIiSaIiEE5eraseEN9__gnu_cxx17__normal_iteratorIPKiS1_EES6_.exit.i.i.i: ; preds = %.preheader.i.i.i.i.i.i, %_ZSt4moveIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEES6_ET0_T_S8_S7_.exit.i.i.i.i.i, %_ZSt6uniqueIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEET_S7_S7_.exit.i.i.i, %._crit_edge._ZSt6uniqueIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEET_S7_S7_.exit.thread_crit_edge.i.i.i
  %.pre-phi.i.i = phi i64 [ %.pre85.i.i.i, %._crit_edge._ZSt6uniqueIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEET_S7_S7_.exit.thread_crit_edge.i.i.i ], [ %.pre.i.i, %_ZSt4moveIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEES6_ET0_T_S8_S7_.exit.i.i.i.i.i ], [ %i.bc, %_ZSt6uniqueIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEET_S7_S7_.exit.i.i.i ], [ %i.bc, %.preheader.i.i.i.i.i.i ]
  %.sroa.032.0.lcssa104.i.i.i = phi ptr [ %.sroa.032.0.lcssa106.i.i.i, %._crit_edge._ZSt6uniqueIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEET_S7_S7_.exit.thread_crit_edge.i.i.i ], [ %.sroa.032.4.i.i.i, %_ZSt4moveIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEES6_ET0_T_S8_S7_.exit.i.i.i.i.i ], [ %.sroa.032.4.i.i.i, %_ZSt6uniqueIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEET_S7_S7_.exit.i.i.i ], [ %.sroa.032.4.i.i.i, %.preheader.i.i.i.i.i.i ] ; 4 uses
  %.sroa.28.0.lcssa99.i.i.i = phi ptr [ %.sroa.28.0.lcssa101.i.i.i, %._crit_edge._ZSt6uniqueIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEET_S7_S7_.exit.thread_crit_edge.i.i.i ], [ %.sroa.28.4.i.i.i, %_ZSt4moveIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEES6_ET0_T_S8_S7_.exit.i.i.i.i.i ], [ %.sroa.28.4.i.i.i, %_ZSt6uniqueIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEET_S7_S7_.exit.i.i.i ], [ %.sroa.28.4.i.i.i, %.preheader.i.i.i.i.i.i ] ; 2 uses
  ...
  %i.cr = sub i64 %.pre-phi.i.i, %i.cq
  %i.cs = ashr exact i64 %i.cr, 2
  invoke void @_ZN6google8protobuf8internal16GenerateEnumDataEN4absl12lts_202505124SpanIKiEE(ptr dead_on_unwind nonnull writable sret(%"class.std::vector.150") align 8 %4, ptr %.sroa.032.0.lcssa104.i.i.i, i64 %i.cs)
...
bb.ac:                                            ; preds = %_ZNSt6vectorIiSaIiEE5eraseEN9__gnu_cxx17__normal_iteratorIPKiS1_EES6_.exit.i.i.i
  %.not.i.i.i24.i.i.i = icmp eq ptr %.sroa.032.0.lcssa104.i.i.i, null
...
bb.ad:                                            ; preds = %bb.ac
  %i.ct = ptrtoint ptr %.sroa.28.0.lcssa99.i.i.i to i64
  %i.cu = sub i64 %i.ct, %i.cq
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.032.0.lcssa104.i.i.i, i64 noundef %i.cu) #39
...
bb.ae:                                            ; preds = %.loopexit, %.loopexit.split-lp.i.i.i, %.loopexit.i.i.i
  %.sroa.28.2.i.i.i = phi ptr [ %.sroa.15.074.i.i.i, %.loopexit.split-lp.i.i.i ], [ %.sroa.15.074.i.i.i, %.loopexit.i.i.i ], [ %.sroa.28.1.i.i.i.ph, %.loopexit ]
  %.sroa.032.2.i.i.i = phi ptr [ %.sroa.032.075.i.i.i, %.loopexit.split-lp.i.i.i ], [ %.sroa.032.075.i.i.i, %.loopexit.i.i.i ], [ %.sroa.032.1.i.i.i.ph, %.loopexit ] ; 3 uses
...
.thread.i.i.i:                                    ; preds = %bb.ae
  %i.cv = ptrtoint ptr %.sroa.28.2.i.i.i to i64
  %i.cw = ptrtoint ptr %.sroa.032.2.i.i.i to i64
  %i.cx = sub i64 %i.cv, %i.cw
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.032.2.i.i.i, i64 noundef %i.cx) #39
  br label %.body.i
...
"_ZZNK6google8protobuf10Reflection23PopulateTcParseFieldAuxERKNS0_8internal17TailCallTableInfoEPNS2_16TcParseTableBase8FieldAuxEENK3$_0clIKNS0_14EnumDescriptorEEEDaPT_.exit.i": ; preds = %bb.ad, %bb.ac
  %i.cy = load ptr, ptr %i.as, align 8, !tbaa !558 ; 3 uses
  %i.cz = getelementptr inbounds nuw i8, ptr %i.ar, i64 24 ; 2 uses
  %i.da = load ptr, ptr %i.cz, align 8, !tbaa !560
  %i.db = load <2 x ptr>, ptr %4, align 16, !tbaa !202
  store <2 x ptr> %i.db, ptr %i.as, align 8, !tbaa !202
  %i.dc = load ptr, ptr %i.f, align 16, !tbaa !560
  store ptr %i.dc, ptr %i.cz, align 8, !tbaa !560
  %.not.i.i.i.i.i22.i = icmp eq ptr %i.cy, null
...
_ZNSt6vectorIjSaIjEEaSEOS1_.exit.i:               ; preds = %"_ZZNK6google8protobuf10Reflection23PopulateTcParseFieldAuxERKNS0_8internal17TailCallTableInfoEPNS2_16TcParseTableBase8FieldAuxEENK3$_0clIKNS0_14EnumDescriptorEEEDaPT_.exit.i"
  ...
  call void @_ZdlPvm(ptr noundef nonnull %i.cy, i64 noundef %i.df) #39
  %.pr.i = load ptr, ptr %4, align 16, !tbaa !558 ; 3 uses
  %.not.i.i.i.i = icmp eq ptr %.pr.i, null
  br i1 %.not.i.i.i.i, label %_ZNSt6vectorIjSaIjEED2Ev.exit.i, label %bb.af

bb.af:                                            ; preds = %_ZNSt6vectorIjSaIjEEaSEOS1_.exit.i
  %i.dg = load ptr, ptr %i.f, align 16, !tbaa !560
  %i.dh = ptrtoint ptr %i.dg to i64
  %i.di = ptrtoint ptr %.pr.i to i64
  %i.dj = sub i64 %i.dh, %i.di
  call void @_ZdlPvm(ptr noundef nonnull %.pr.i, i64 noundef %i.dj) #39
...
_ZN4absl12lts_202505129MutexLockC2EPNS0_5MutexE.exit.i: ; preds = %_ZNSt6vectorIjSaIjEED2Ev.exit.i
  ...
  %i.dk = load ptr, ptr %i.ag, align 8, !tbaa !543
...
_ZN4absl12lts_2025051218container_internal12raw_hash_setINS1_17FlatHashMapPolicyISt4pairIPKvS6_ESt10unique_ptrIN6google8protobuf14DescriptorPool8MemoBaseESt14default_deleteISC_EEEENS0_13hash_internal4HashIS7_EESt8equal_toIS7_ESaIS4_IKS7_SF_EEE6insertEOS4_IS7_SF_E.exit.thread.i: ; preds = %.noexc.i
  %.sroa.2.0.copyload.i.i.i.i.i.i.i.i = load ptr, ptr %.sroa.2.0..sroa_idx.i.i.i.i.i.i.i.i, align 8, !alias.scope !581 ; 2 uses
  ...
  %i.dn = getelementptr inbounds nuw i8, ptr %.sroa.2.0.copyload.i.i.i.i.i.i.i.i, i64 16
  %i.do = load i64, ptr %i.g, align 8, !tbaa !545, !noalias !586
  store i64 %i.do, ptr %i.dn, align 8, !tbaa !545
  br label %bb.ag
...
_ZN4absl12lts_2025051218container_internal12raw_hash_setINS1_17FlatHashMapPolicyISt4pairIPKvS6_ESt10unique_ptrIN6google8protobuf14DescriptorPool8MemoBaseESt14default_deleteISC_EEEENS0_13hash_internal4HashIS7_EESt8equal_toIS7_ESaIS4_IKS7_SF_EEE6insertEOS4_IS7_SF_E.exit.i: ; preds = %.noexc.i
  %.pr45.i = load ptr, ptr %i.g, align 8, !tbaa !545 ; 3 uses
...
_ZNKSt14default_deleteIN6google8protobuf14DescriptorPool8MemoBaseEEclEPS3_.exit.i.i.i: ; preds = %_ZN4absl12lts_2025051218container_internal12raw_hash_setINS1_17FlatHashMapPolicyISt4pairIPKvS6_ESt10unique_ptrIN6google8protobuf14DescriptorPool8MemoBaseESt14default_deleteISC_EEEENS0_13hash_internal4HashIS7_EESt8equal_toIS7_ESaIS4_IKS7_SF_EEE6insertEOS4_IS7_SF_E.exit.i
  %i.dp = load ptr, ptr %.pr45.i, align 8, !tbaa !149
  %i.dq = getelementptr inbounds nuw i8, ptr %i.dp, i64 8
  %i.dr = load ptr, ptr %i.dq, align 8
  call void %i.dr(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %.pr45.i) #35, !inline_history !587
  br label %bb.ag
...
bb.ag:                                            ; preds = %_ZNKSt14default_deleteIN6google8protobuf14DescriptorPool8MemoBaseEEclEPS3_.exit.i.i.i, %_ZN4absl12lts_2025051218container_internal12raw_hash_setINS1_17FlatHashMapPolicyISt4pairIPKvS6_ESt10unique_ptrIN6google8protobuf14DescriptorPool8MemoBaseESt14default_deleteISC_EEEENS0_13hash_internal4HashIS7_EESt8equal_toIS7_ESaIS4_IKS7_SF_EEE6insertEOS4_IS7_SF_E.exit.i, %_ZN4absl12lts_2025051218container_internal12raw_hash_setINS1_17FlatHashMapPolicyISt4pairIPKvS6_ESt10unique_ptrIN6google8protobuf14DescriptorPool8MemoBaseESt14default_deleteISC_EEEENS0_13hash_internal4HashIS7_EESt8equal_toIS7_ESaIS4_IKS7_SF_EEE6insertEOS4_IS7_SF_E.exit.thread.i
  ...
  %i.ds = getelementptr inbounds nuw i8, ptr %.sroa.4.0.copyload.i, i64 16
  %i.dt = load ptr, ptr %i.ds, align 8, !tbaa !545
...
bb.ak:                                            ; preds = %_ZN4absl12lts_202505129MutexLockC2EPNS0_5MutexE.exit.i
  %i.ea = landingpad { ptr, i32 }
          cleanup
  %i.eb = load ptr, ptr %i.g, align 8, !tbaa !545 ; 3 uses
  %.not.i.i25.i = icmp eq ptr %i.eb, null
...
_ZNKSt14default_deleteIN6google8protobuf14DescriptorPool8MemoBaseEEclEPS3_.exit.i.i26.i: ; preds = %bb.ak
  %i.ec = load ptr, ptr %i.eb, align 8, !tbaa !149
  %i.ed = getelementptr inbounds nuw i8, ptr %i.ec, i64 8
  %i.ee = load ptr, ptr %i.ed, align 8
  call void %i.ee(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %i.eb) #35, !inline_history !587
...
_ZNKSt14default_deleteIN6google8protobuf14DescriptorPool8MemoDataISt6vectorIjSaIjEEEEEclEPS7_.exit.i30.i: ; preds = %bb.aj, %.body.i
  %.pn17.pn.pn.ph.i = phi { ptr, i32 } [ %i.dz, %bb.aj ], [ %.pn13.i.i.i88, %.body.i ]
  %i.eh = load ptr, ptr %i.ar, align 8, !tbaa !149
  %i.ei = getelementptr inbounds nuw i8, ptr %i.eh, i64 8
  %i.ej = load ptr, ptr %i.ei, align 8
  call void %i.ej(ptr noundef nonnull align 8 dereferenceable(32) %i.ar) #35, !inline_history !588
...
_ZN4absl12lts_2025051215ReaderMutexLockD2Ev.exit24.i: ; preds = %_ZNKSt14default_deleteIN6google8protobuf14DescriptorPool8MemoDataISt6vectorIjSaIjEEEEEclEPS7_.exit.i30.i, %_ZNSt4pairIS_IPKvS1_ESt10unique_ptrIN6google8protobuf14DescriptorPool8MemoBaseESt14default_deleteIS7_EEED2Ev.exit27.i, %bb.n
  %.pn17.pn.pn.pn.i = phi { ptr, i32 } [ %i.ao, %bb.n ], [ %.pn17.pn.pn.ph.i, %_ZNKSt14default_deleteIN6google8protobuf14DescriptorPool8MemoDataISt6vectorIjSaIjEEEEEclEPS7_.exit.i30.i ], [ %i.ea, %_ZNSt4pairIS_IPKvS1_ESt10unique_ptrIN6google8protobuf14DescriptorPool8MemoBaseESt14default_deleteIS7_EEED2Ev.exit27.i ]
...
"_ZN6google8protobuf14DescriptorPool17MemoizeProjectionINS0_14EnumDescriptorEZNKS0_10Reflection23PopulateTcParseFieldAuxERKNS0_8internal17TailCallTableInfoEPNS5_16TcParseTableBase8FieldAuxEE3$_0EERKDaPKT_T0_.exit": ; preds = %_ZN4absl12lts_2025051215ReaderMutexLockD2Ev.exit.i, %bb.ag
  %.115.i = phi ptr [ %.014.i, %_ZN4absl12lts_2025051215ReaderMutexLockD2Ev.exit.i ], [ %i.du, %bb.ag ]
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #35
  %i.ek = load ptr, ptr %.115.i, align 8, !tbaa !558
  %i.el = getelementptr inbounds nuw i8, ptr %.053, i64 8
  store ptr %i.ek, ptr %.053, align 8, !tbaa !31
  br label %bb.an

bb.am:                                            ; preds = %bb.b
  %i.em = getelementptr inbounds nuw i8, ptr %.sroa.025.052, i64 8
  %i.en = load i32, ptr %i.em, align 8, !tbaa !31
  %i.eo = getelementptr inbounds nuw i8, ptr %.053, i64 8
  store i32 %i.en, ptr %.053, align 8, !tbaa !31
  br label %bb.an
...
bb.an:                                            ; preds = %bb.am, %"_ZN6google8protobuf14DescriptorPool17MemoizeProjectionINS0_14EnumDescriptorEZNKS0_10Reflection23PopulateTcParseFieldAuxERKNS0_8internal17TailCallTableInfoEPNS5_16TcParseTableBase8FieldAuxEE3$_0EERKDaPKT_T0_.exit", %bb.j, %bb.i, %bb.h, %bb.e, %bb.d, %bb.c, %bb.b
  %.1 = phi ptr [ %.053, %bb.b ], [ %i.l, %bb.c ], [ %i.n, %bb.d ], [ %i.p, %bb.e ], [ %i.r, %bb.h ], [ %i.v, %bb.i ], [ %i.x, %bb.j ], [ %i.el, %"_ZN6google8protobuf14DescriptorPool17MemoizeProjectionINS0_14EnumDescriptorEZNKS0_10Reflection23PopulateTcParseFieldAuxERKNS0_8internal17TailCallTableInfoEPNS5_16TcParseTableBase8FieldAuxEE3$_0EERKDaPKT_T0_.exit" ], [ %i.eo, %bb.am ]
  %i.ep = getelementptr inbounds nuw i8, ptr %.sroa.025.052, i64 16 ; 2 uses
  %.not = icmp eq ptr %i.ep, %i.d
...
_ZNSt6vectorIN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESaIS4_EE7reserveEm.exit: ; preds = %bb.b
  ...
  %.pre226 = load i32, ptr %.phi.trans.insert, align 8, !tbaa !204
  %i.j = icmp sgt i32 %.pre226, 0
...
._crit_edge:                                      ; preds = %_ZNSt6vectorIN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESaIS4_EE9push_backEOS4_.exit
  %.not.i.i = icmp eq ptr %.sroa.0155.3, %.sroa.16.2
...
"._crit_edge._ZSt4sortIN9__gnu_cxx17__normal_iteratorIPN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESt6vectorIS6_SaIS6_EEEEZNKS3_10Reflection18CreateTcParseTableEvE3$_0EvT_SE_T0_.exit_crit_edge": ; preds = %bb.b, %_ZNSt6vectorIN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESaIS4_EE7reserveEm.exit, %._crit_edge
  %.sroa.0155.0.lcssa283 = phi ptr [ %.sroa.0155.3, %._crit_edge ], [ %i.h, %_ZNSt6vectorIN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESaIS4_EE7reserveEm.exit ], [ null, %bb.b ] ; 2 uses
  %.sroa.16.0.lcssa280 = phi ptr [ %.sroa.16.2, %._crit_edge ], [ %i.h, %_ZNSt6vectorIN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESaIS4_EE7reserveEm.exit ], [ null, %bb.b ] ; 2 uses
  %.sroa.29.0.lcssa277 = phi ptr [ %.sroa.29.3, %._crit_edge ], [ %i.i, %_ZNSt6vectorIN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESaIS4_EE7reserveEm.exit ], [ null, %bb.b ]
  %.pre231 = ptrtoint ptr %.sroa.16.0.lcssa280 to i64
  %.pre232 = ptrtoint ptr %.sroa.0155.0.lcssa283 to i64 ; 2 uses
  %.pre234 = sub i64 %.pre231, %.pre232
  %.pre236 = sdiv exact i64 %.pre234, 24
...
bb.c:                                             ; preds = %._crit_edge
  %i.o = ptrtoint ptr %.sroa.16.2 to i64
...
.lr.ph.i.i.i.i:                                   ; preds = %bb.c, %bb.h
  ...
  %.val.i.i.i.i.i = load ptr, ptr %.sroa.0.020.i.ptr.i.i.i, align 8, !tbaa !589 ; 2 uses
  %.val1.i.i.i.i.i = load ptr, ptr %.sroa.0155.3, align 8, !tbaa !589
...
bb.d:                                             ; preds = %.lr.ph.i.i.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %2, ptr noundef nonnull align 8 dereferenceable(24) %.sroa.0.020.i.ptr.i.i.i, i64 24, i1 false), !tbaa.struct !592
...
bb.f:                                             ; preds = %bb.d
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.aa, ptr noundef nonnull align 8 dereferenceable(24) %.sroa.0155.3, i64 24, i1 false), !tbaa.struct !592
  br label %_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESt6vectorIS6_SaIS6_EEEESB_ET0_T_SD_SC_.exit.i.i.i.i
...
_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESt6vectorIS6_SaIS6_EEEESB_ET0_T_SD_SC_.exit.i.i.i.i: ; preds = %bb.f, %bb.e
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.sroa.0155.3, ptr noundef nonnull align 8 dereferenceable(24) %2, i64 24, i1 false), !tbaa.struct !592
...
bb.g:                                             ; preds = %.lr.ph.i.i.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.5.i.i.i.i.i, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.5.0..sroa_idx.i.i.i.i.i, i64 16, i1 false), !tbaa.struct !594
  %.val2.i11.i.i.i.i.i = load ptr, ptr %.pn19.i.i.i.i, align 8, !tbaa !589
...
.lr.ph.i.i.i.i.i:                                 ; preds = %bb.g, %.lr.ph.i.i.i.i.i
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.sroa.06.013.i.i.i.i.i, ptr noundef nonnull align 8 dereferenceable(24) %.sroa.0.014.i.i.i.i.i, i64 24, i1 false), !tbaa.struct !592
  ...
  %.val2.i.i.i.i.i.i = load ptr, ptr %.sroa.0.0.i.i.i.i.i, align 8, !tbaa !589
  ...
  br i1 %i.ae, label %.lr.ph.i.i.i.i.i, label %"_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESt6vectorIS6_SaIS6_EEEENS0_5__ops14_Val_comp_iterIZNKS3_10Reflection18CreateTcParseTableEvE3$_0EEEvT_T0_.exit.i.i.i.i", !llvm.loop !595
...
"_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESt6vectorIS6_SaIS6_EEEENS0_5__ops14_Val_comp_iterIZNKS3_10Reflection18CreateTcParseTableEvE3$_0EEEvT_T0_.exit.i.i.i.i": ; preds = %.lr.ph.i.i.i.i.i, %bb.g
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.5.0..sroa_idx5.i.i.i.i.i, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.5.i.i.i.i.i, i64 16, i1 false), !tbaa.struct !594
...
bb.h:                                             ; preds = %"_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESt6vectorIS6_SaIS6_EEEENS0_5__ops14_Val_comp_iterIZNKS3_10Reflection18CreateTcParseTableEvE3$_0EEEvT_T0_.exit.i.i.i.i", %_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESt6vectorIS6_SaIS6_EEEESB_ET0_T_SD_SC_.exit.i.i.i.i
  ...
  br i1 %.not.i.i.i.i, label %"_ZSt16__insertion_sortIN9__gnu_cxx17__normal_iteratorIPN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESt6vectorIS6_SaIS6_EEEENS0_5__ops15_Iter_comp_iterIZNKS3_10Reflection18CreateTcParseTableEvE3$_0EEEvT_SH_T0_.exit.i.i.i", label %.lr.ph.i.i.i.i, !llvm.loop !596
...
"_ZSt16__insertion_sortIN9__gnu_cxx17__normal_iteratorIPN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESt6vectorIS6_SaIS6_EEEENS0_5__ops15_Iter_comp_iterIZNKS3_10Reflection18CreateTcParseTableEvE3$_0EEEvT_SH_T0_.exit.i.i.i": ; preds = %bb.h
  ...
  %.not6.i.i.i.i = icmp eq ptr %i.af, %.sroa.16.2
...
.lr.ph.i13.i.i.i:                                 ; preds = %"_ZSt16__insertion_sortIN9__gnu_cxx17__normal_iteratorIPN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESt6vectorIS6_SaIS6_EEEENS0_5__ops15_Iter_comp_iterIZNKS3_10Reflection18CreateTcParseTableEvE3$_0EEEvT_SH_T0_.exit.i.i.i", %"_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESt6vectorIS6_SaIS6_EEEENS0_5__ops14_Val_comp_iterIZNKS3_10Reflection18CreateTcParseTableEvE3$_0EEEvT_T0_.exit.i17.i.i.i"
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.5.i.i12.i.i.i, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.5.0..sroa_idx.i.i14.i.i.i, i64 16, i1 false), !tbaa.struct !594
  ...
  %.val2.i11.i.i15.i.i.i = load ptr, ptr %.sroa.0.09.i.i.i.i.i, align 8, !tbaa !589
...
.lr.ph.i.i21.i.i.i:                               ; preds = %.lr.ph.i13.i.i.i, %.lr.ph.i.i21.i.i.i
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.sroa.06.013.i.i23.i.i.i, ptr noundef nonnull align 8 dereferenceable(24) %.sroa.0.014.i.i22.i.i.i, i64 24, i1 false), !tbaa.struct !592
  ...
  %.val2.i.i.i26.i.i.i = load ptr, ptr %.sroa.0.0.i.i24.i.i.i, align 8, !tbaa !589
  ...
  br i1 %i.ak, label %.lr.ph.i.i21.i.i.i, label %"_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESt6vectorIS6_SaIS6_EEEENS0_5__ops14_Val_comp_iterIZNKS3_10Reflection18CreateTcParseTableEvE3$_0EEEvT_T0_.exit.i17.i.i.i", !llvm.loop !595
...
"_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESt6vectorIS6_SaIS6_EEEENS0_5__ops14_Val_comp_iterIZNKS3_10Reflection18CreateTcParseTableEvE3$_0EEEvT_T0_.exit.i17.i.i.i": ; preds = %.lr.ph.i.i21.i.i.i, %.lr.ph.i13.i.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.5.0..sroa_idx5.i.i19.i.i.i, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.5.i.i12.i.i.i, i64 16, i1 false), !tbaa.struct !594
  ...
  br i1 %.not.i20.i.i.i, label %"_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPN6google8protobuf8internal17TailCallTableInfo12FieldOptionsESt6vectorIS6_SaIS6_EEEEZNKS3_10Reflection18CreateTcParseTableEvE3$_0EvT_SE_T0_.exit", label %.lr.ph.i13.i.i.i, !llvm.loop !597
...
.lr.ph.i32.i.i.i:                                 ; preds = %bb.i, %bb.o
  ...
  %.val.i.i35.i.i.i = load ptr, ptr %.sroa.0.020.i33.i.i.i, align 8, !tbaa !589 ; 2 uses
  %.val1.i.i36.i.i.i = load ptr, ptr %.sroa.0155.3, align 8, !tbaa !589
...
bb.f:                                             ; preds = %.lr.ph.i.i
  ...
  br i1 %i.bi, label %.lr.ph.i.i, label %_ZSt13__adjust_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEliNS0_5__ops15_Iter_less_iterEEvT_T0_SA_T1_T2_.exit, !llvm.loop !752
...
bb.a:
  ...
  %i.u = load i64, ptr %i.t, align 8, !tbaa !32, !noalias !761
  %i.v = and i64 %i.u, 65535
  %i.w = load i64, ptr %1, align 8, !tbaa !27, !noalias !761 ; 3 uses
  %i.x = lshr i64 %i.s, 7
  %i.y = xor i64 %i.x, %i.v
...
.lr.ph:                                           ; preds = %bb.b, %.critedge
  ...
  %i.ao = load ptr, ptr %i.an, align 8, !tbaa !540
...
bb.d:                                             ; preds = %.thread, %.critedge20
  ...
  store i8 %.sink, ptr %i.bj, align 8, !tbaa !578
  ret void
}
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader
  ...
  %i.c = load i64, ptr %i.b, align 8, !tbaa !545
  store i64 %i.c, ptr %i.a, align 8, !tbaa !545
  store ptr null, ptr %i.b, align 8, !tbaa !545
  %i.d = add nsw i64 %3, -1
...
.lr.ph.prol.loopexit:                             ; preds = %.lr.ph.prol, %.lr.ph.preheader
  %.014.unr.a = phi ptr [ %1, %.lr.ph.preheader ], [ %i.f, %.lr.ph.prol ]
  %.0913.unr = phi ptr [ %2, %.lr.ph.preheader ], [ %i.e, %.lr.ph.prol ]
  %.01012.unr = phi i64 [ %3, %.lr.ph.preheader ], [ %i.d, %.lr.ph.prol ]
  %i.g = icmp eq i64 %3, 1
  br i1 %i.g, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  %.014 = phi ptr [ %i.r, %.lr.ph ], [ %.014.unr.a, %.lr.ph.prol.loopexit ] ; 5 uses
  %.0913 = phi ptr [ %i.q, %.lr.ph ], [ %.0913.unr, %.lr.ph.prol.loopexit ] ; 5 uses
  %.01012 = phi i64 [ %i.p, %.lr.ph ], [ %.01012.unr, %.lr.ph.prol.loopexit ]
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.014, ptr noundef nonnull align 8 dereferenceable(24) %.0913, i64 16, i1 false)
  %i.h = getelementptr inbounds nuw i8, ptr %.014, i64 16
  %i.i = getelementptr inbounds nuw i8, ptr %.0913, i64 16 ; 2 uses
  %i.j = load i64, ptr %i.i, align 8, !tbaa !545
  store i64 %i.j, ptr %i.h, align 8, !tbaa !545
  store ptr null, ptr %i.i, align 8, !tbaa !545
  %i.k = getelementptr inbounds nuw i8, ptr %.0913, i64 24
  %i.l = getelementptr inbounds nuw i8, ptr %.014, i64 24
  ...
  %i.m = getelementptr inbounds nuw i8, ptr %.014, i64 40
  %i.n = getelementptr inbounds nuw i8, ptr %.0913, i64 40 ; 2 uses
  %i.o = load i64, ptr %i.n, align 8, !tbaa !545
  store i64 %i.o, ptr %i.m, align 8, !tbaa !545
  store ptr null, ptr %i.n, align 8, !tbaa !545
  %i.p = add i64 %.01012, -2                      ; 2 uses
  %i.q = getelementptr inbounds nuw i8, ptr %.0913, i64 48
  %i.r = getelementptr inbounds nuw i8, ptr %.014, i64 48
  %.not.1 = icmp eq i64 %i.p, 0
  br i1 %.not.1, label %._crit_edge, label %.lr.ph, !llvm.loop !764
...
._crit_edge:                                      ; preds = %bb.i, %bb.c
  ...
  br i1 %i.t, label %bb.c, label %bb.b, !llvm.loop !765
...
_ZN4absl12lts_2025051218container_internal29TryFindNewIndexWithoutProbingIvEEmmmmPNS1_6ctrl_tEm.exit: ; preds = %bb.g, %bb.d
  ...
  store i8 %i.as, ptr %i.bi, align 1, !tbaa !766
  ...
  store i64 %i.bm, ptr %i.bk, align 8, !tbaa !545
  store ptr null, ptr %i.bl, align 8, !tbaa !545
  br label %bb.i
...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 8, !tbaa !768
...
._crit_edge:                                      ; preds = %bb.b, %bb.a
  ...
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !769
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.h = load ptr, ptr %i.d, align 8, !tbaa !770
  ...
  %i.j = load i32, ptr %i.a, align 8, !tbaa !768
end_hunk_2
