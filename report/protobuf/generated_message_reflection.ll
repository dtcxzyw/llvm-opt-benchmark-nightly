...
begin_hunk_1_@_ZN6google8protobuf8internal19NameOfDenseEnumSlowB5cxx11EiPNS1_18DenseEnumCacheInfoE:bb.a
  ...
  %i.l = sub nsw i32 %i.k, %i.j                   ; 3 uses
...
begin_hunk_2_@_ZNK6google8protobuf10Reflection13SpaceUsedLongERKNS0_7MessageE:bb.a
  ...
  %i.aij = add i64 %.1450, %i.aii
  %i.aik = add i64 %i.aij, 32
...
begin_hunk_4_@_ZNK6google8protobuf10Reflection18CreateTcParseTableEv:bb.a
  ...
  %i.hw = add <2 x i32> %vec.phi, %i.ht
  %i.hx = add <2 x i32> %vec.phi298, %i.hv
  %i.hy = add <2 x i32> %i.hw, splat (i32 3)      ; 2 uses
  %i.hz = add <2 x i32> %i.hx, splat (i32 3)      ; 2 uses
...
begin_hunk_5_@_ZNK6google8protobuf10Reflection18CreateTcParseTableEv:bb.a
  ...
  %i.ik = add i32 %.010.i, %i.ij
  %i.il = add i32 %i.ik, 3                        ; 2 uses
...
vector.memcheck:                                  ; preds = %.lr.ph.i104.preheader
  %i.pg = sub i64 %i.ov, %i.ox
  %i.ph = and i64 %i.pg, -4                       ; 2 uses
  %scevgep302.a = getelementptr i8, ptr %.014.i, i64 6
  %scevgep303 = getelementptr i8, ptr %scevgep302.a, i64 %i.ph
  %scevgep304 = getelementptr i8, ptr %i.ow, i64 %i.ph
  %bound0 = icmp ult ptr %i.pd, %scevgep304
  %bound1 = icmp ult ptr %i.ow, %scevgep303
