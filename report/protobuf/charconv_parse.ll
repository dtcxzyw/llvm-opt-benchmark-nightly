...
bb.g:                                             ; preds = %_ZN4absl12lts_2025051212_GLOBAL__N_113ConsumeDigitsILi10EmEEiPKcS4_iPT0_Pb.exit
  ...
  %i.ar = sub nsw i32 19, %i.an
  %.089 = select i1 %4, i32 0, i32 %i.ar          ; 2 uses
...
bb.t:                                             ; preds = %bb.s, %bb.r
  ...
  %i.cz = and i32 %3, 3                           ; 2 uses
  %i.da = icmp ne i32 %i.cz, 2
  %i.db = icmp ult ptr %.3, %2
  %or.cond = and i1 %i.da, %i.db
  br i1 %or.cond, label %bb.u, label %.thread

bb.u:                                             ; preds = %bb.t
  %i.dc = load i8, ptr %.3, align 1, !tbaa !7
  %i.dd = and i8 %i.dc, -33
  %i.de = icmp eq i8 %i.dd, 69
  br i1 %i.de, label %bb.v, label %.thread

bb.v:                                             ; preds = %bb.u
  %i.df = getelementptr inbounds nuw i8, ptr %.3, i64 1 ; 4 uses
  %i.dg = icmp ult ptr %i.df, %2
  br i1 %i.dg, label %bb.w, label %.critedge104

bb.w:                                             ; preds = %bb.v
  %i.dh = load i8, ptr %i.df, align 1, !tbaa !7   ; 2 uses
...
bb.y:                                             ; preds = %bb.w
  ...
  %i.dl = getelementptr inbounds nuw i8, ptr %.3, i64 2
  %spec.select = select i1 %i.dk, ptr %i.dl, ptr %i.df
  br label %.critedge104

.critedge104:                                     ; preds = %bb.y, %bb.v, %bb.x
  %.080.not = phi i1 [ false, %bb.x ], [ true, %bb.v ], [ true, %bb.y ]
  %.4 = phi ptr [ %i.dj, %bb.x ], [ %i.df, %bb.v ], [ %spec.select, %bb.y ] ; 2 uses
  %i.dm = tail call fastcc noundef i32 @_ZN4absl12lts_2025051212_GLOBAL__N_113ConsumeDigitsILi10EiEEiPKcS4_iPT0_Pb(ptr noundef nonnull %.4, ptr noundef nonnull %2, ptr noundef nonnull %i.cy) ; 2 uses
  %i.dn = sext i32 %i.dm to i64
  %i.do = getelementptr inbounds i8, ptr %.4, i64 %i.dn ; 2 uses
  %.not158 = icmp eq i32 %i.dm, 0                 ; 2 uses
  %brmerge = or i1 %.080.not, %.not158
  br i1 %brmerge, label %bb.aa, label %bb.z

bb.z:                                             ; preds = %.critedge104
  %i.dp = load i32, ptr %i.cy, align 4, !tbaa !22
  %i.dq = sub nsw i32 0, %i.dp
  store i32 %i.dq, ptr %i.cy, align 4, !tbaa !22
  br label %bb.ab
...
.thread:                                          ; preds = %bb.u, %bb.t, %bb.aa
  ...
  br i1 %i.dr, label %bb.ac, label %bb.ab

bb.ab:                                            ; preds = %bb.z, %.thread, %bb.aa
  %.6154 = phi ptr [ %.3, %.thread ], [ %i.do, %bb.aa ], [ %i.do, %bb.z ]
  %i.ds = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i32 0, ptr %i.ds, align 8, !tbaa !23
  %i.dt = load i64, ptr %0, align 8, !tbaa !21
  %.not = icmp eq i64 %i.dt, 0
  %i.du = load i32, ptr %i.cy, align 4
  %i.dv = add nsw i32 %i.du, %.588
  %.sink = select i1 %.not, i32 0, i32 %i.dv
  %i.dw = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i32 %.sink, ptr %i.dw, align 8, !tbaa !24
  %i.dx = getelementptr inbounds nuw i8, ptr %0, i64 40
  store ptr %.6154, ptr %i.dx, align 8, !tbaa !25
  br label %bb.ac
...
bb.g:                                             ; preds = %_ZN4absl12lts_2025051212_GLOBAL__N_113ConsumeDigitsILi16EmEEiPKcS4_iPT0_Pb.exit
  ...
  %i.au = sub nsw i32 15, %i.aq
  %.087 = select i1 %4, i32 0, i32 %i.au          ; 2 uses
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.dj = and i8 %i.di, -33
  %i.dk = icmp eq i8 %i.dj, 80
  br i1 %i.dk, label %bb.t, label %.thread

bb.t:                                             ; preds = %bb.s
  %i.dl = getelementptr inbounds nuw i8, ptr %.3, i64 1 ; 4 uses
  %i.dm = icmp ult ptr %i.dl, %2
  br i1 %i.dm, label %bb.u, label %.critedge102
...
.critedge102:                                     ; preds = %bb.w, %bb.t, %bb.v
  ...
  %.4 = phi ptr [ %i.dp, %bb.v ], [ %i.dl, %bb.t ], [ %spec.select, %bb.w ] ; 2 uses
  ...
  %.not159 = icmp eq i32 %i.ds, 0                 ; 2 uses
...
.thread:                                          ; preds = %bb.s, %bb.r, %bb.y
  ...
  br i1 %i.dx, label %bb.aa, label %bb.z

bb.z:                                             ; preds = %bb.x, %.thread, %bb.y
  %.6154 = phi ptr [ %.3, %.thread ], [ %i.du, %bb.y ], [ %i.du, %bb.x ]
  ...
  %i.eb = shl nsw i32 %.586, 2
  %i.ec = add nsw i32 %i.ea, %i.eb
  %.sink = select i1 %.not, i32 0, i32 %i.ec
  %i.ed = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i32 %.sink, ptr %i.ed, align 8, !tbaa !24
  %i.ee = getelementptr inbounds nuw i8, ptr %0, i64 40
  store ptr %.6154, ptr %i.ee, align 8, !tbaa !25
  br label %bb.aa
