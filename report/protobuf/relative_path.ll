...
_ZN4absl12lts_202505129c_reverseISt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS6_EEEEvRT_.exit46: ; preds = %.lr.ph.i.i.i42, %_ZN4absl12lts_202505129c_reverseISt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS6_EEEEvRT_.exit
  %i.ad = load ptr, ptr %11, align 8, !tbaa !29   ; 5 uses
  %.promoted = load ptr, ptr %i.h, align 8, !tbaa !29 ; 2 uses
  %i.ae = icmp eq ptr %i.ad, %.promoted
  %.pre214 = load ptr, ptr %12, align 8, !tbaa !29 ; 4 uses
...
_ZStneIcSt11char_traitsIcEEbSt17basic_string_viewIT_T0_ES5_.exit.thread: ; preds = %_ZStneIcSt11char_traitsIcEEbSt17basic_string_viewIT_T0_ES5_.exit, %.lr.ph, %bb.h, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i, %_ZN4absl12lts_202505129c_reverseISt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS6_EEEEvRT_.exit46
  %i.ap = phi ptr [ %.pre, %_ZN4absl12lts_202505129c_reverseISt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS6_EEEEvRT_.exit46 ], [ %i.ah, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i ], [ %i.ah, %bb.h ], [ %.pre214, %.lr.ph ], [ %i.ak, %_ZStneIcSt11char_traitsIcEEbSt17basic_string_viewIT_T0_ES5_.exit ] ; 2 uses
  %i.aq = phi ptr [ %i.ad, %_ZN4absl12lts_202505129c_reverseISt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS6_EEEEvRT_.exit46 ], [ %i.ag, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i ], [ %i.ag, %bb.h ], [ %i.ag, %.lr.ph ], [ %i.ad, %_ZStneIcSt11char_traitsIcEEbSt17basic_string_viewIT_T0_ES5_.exit ]
...
_ZNSt12_Vector_baseISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE13_M_deallocateEPS3_m.exit.i: ; preds = %_ZNSt12_Vector_baseISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE11_M_allocateEm.exit.i
  ...
  %.pre221 = load ptr, ptr %12, align 8, !tbaa !29
  %.pre222 = load ptr, ptr %i.x, align 8, !tbaa !29
...
_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE7reserveEm.exit: ; preds = %_ZNSt12_Vector_baseISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE13_M_deallocateEPS3_m.exit.i, %bb.k
  %13 = phi ptr [ %.pre222, %_ZNSt12_Vector_baseISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE13_M_deallocateEPS3_m.exit.i ], [ %i.ap, %bb.k ] ; 2 uses
  %14 = phi ptr [ %.pre221, %_ZNSt12_Vector_baseISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE13_M_deallocateEPS3_m.exit.i ], [ %.pre214, %bb.k ] ; 2 uses
  ...
  %.not148185 = icmp eq ptr %14, %13
  br i1 %.not148185, label %.preheader, label %.lr.ph190

.preheader:                                       ; preds = %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE9push_backERKS3_.exit, %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE7reserveEm.exit
  %i.be = phi ptr [ %.sroa.32.4, %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE7reserveEm.exit ], [ %.sroa.32.5, %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE9push_backERKS3_.exit ] ; 2 uses
  %i.bf = phi ptr [ %.sroa.16.3, %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE7reserveEm.exit ], [ %.sroa.16.4, %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE9push_backERKS3_.exit ] ; 2 uses
  %.sroa.32.0.lcssa = phi ptr [ %.sroa.16.3, %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE7reserveEm.exit ], [ %.sroa.0109.5, %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE9push_backERKS3_.exit ] ; 2 uses
  %15 = load ptr, ptr %i.h, align 8, !tbaa !31
  %16 = load ptr, ptr %11, align 8, !tbaa !46
  %.not202 = icmp eq ptr %15, %16
...
begin_hunk_5_@_ZNK6google8protobuf8compiler4rust12RelativePath8RelativeB5cxx11ERKS3_:bb.a
  ...
  %.sroa.0106.0186 = phi ptr [ %i.bw, %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE9push_backERKS3_.exit ], [ %14, %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE7reserveEm.exit ] ; 3 uses
...
begin_hunk_6_@_ZNK6google8protobuf8compiler4rust12RelativePath8RelativeB5cxx11ERKS3_:bb.a
  ...
  %.not148 = icmp eq ptr %i.bw, %13
  br i1 %.not148, label %.preheader, label %.lr.ph190
...
._crit_edge:                                      ; preds = %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE9push_backEOS3_.exit, %.preheader
  %.sroa.32.1.lcssa = phi ptr [ %i.be, %.preheader ], [ %.sroa.32.6, %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE9push_backEOS3_.exit ] ; 8 uses
  %.sroa.16.1.lcssa = phi ptr [ %i.bf, %.preheader ], [ %.sroa.16.5, %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE9push_backEOS3_.exit ] ; 8 uses
  %.sroa.0109.1.lcssa = phi ptr [ %.sroa.32.0.lcssa, %.preheader ], [ %.sroa.0109.6, %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE9push_backEOS3_.exit ] ; 12 uses
...
.lr.ph198:                                        ; preds = %.preheader, %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE9push_backEOS3_.exit
  ...
  %.sroa.0109.1196 = phi ptr [ %.sroa.0109.6, %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE9push_backEOS3_.exit ], [ %.sroa.32.0.lcssa, %.preheader ] ; 8 uses
  %.sroa.16.1195 = phi ptr [ %.sroa.16.5, %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE9push_backEOS3_.exit ], [ %i.bf, %.preheader ] ; 9 uses
  %.sroa.32.1194 = phi ptr [ %.sroa.32.6, %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE9push_backEOS3_.exit ], [ %i.be, %.preheader ] ; 2 uses
...
_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE9push_backEOS3_.exit: ; preds = %_ZNSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS3_EE17_M_realloc_insertIJS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i.i, %bb.p
  ...
  %17 = load ptr, ptr %i.h, align 8, !tbaa !31
  %18 = load ptr, ptr %11, align 8, !tbaa !46
  %i.cr = ptrtoint ptr %17 to i64
  %i.cs = ptrtoint ptr %18 to i64
