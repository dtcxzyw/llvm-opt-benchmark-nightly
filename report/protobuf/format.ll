...
.lr.ph.i49:                                       ; preds = %.lr.ph.i49.preheader, %bb.c
  ...
  %scevgep164 = getelementptr i8, ptr %.sroa.6.0, i64 %lsr.iv
...
bb.c:                                             ; preds = %.lr.ph.i49
  ...
  %i.y = icmp eq i64 %.sroa.086.0, %lsr.iv.next
...
.lr.ph.i49.1:                                     ; preds = %bb.d, %.lr.ph.i49.preheader.1
  ...
  %scevgep167 = getelementptr i8, ptr %.sroa.6.0, i64 %lsr.iv165
...
bb.d:                                             ; preds = %.lr.ph.i49.1
  ...
  %i.ap = icmp eq i64 %.sroa.086.0, %lsr.iv.next166
