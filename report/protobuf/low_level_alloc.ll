...
bb.g:                                             ; preds = %_ZN4absl12lts_2025051213base_internalL7IntLog2Emm.exit.i
  ...
  %4 = call noundef range(i32 1, 30) i32 @llvm.umin.i32(i32 %spec.select.i, i32 29) ; 3 uses
  %i.ao = load i32, ptr %i.ad, align 8, !tbaa !26 ; 3 uses
  %.not78 = icmp sgt i32 %4, %i.ao
...
bb.h:                                             ; preds = %.preheader, %bb.o
  ...
  %.not.i93.not = icmp sgt i32 %4, %i.ar
  br i1 %.not.i93.not, label %.invoke207, label %bb.i, !prof !27

bb.i:                                             ; preds = %bb.h
  %i.as = getelementptr [8 x i8], ptr %.073, i64 %i.ap
  %i.at = getelementptr i8, ptr %i.as, i64 32
  %i.au = load ptr, ptr %i.at, align 8, !tbaa !36 ; 17 uses
  %.not17.i = icmp eq ptr %i.au, null
  br i1 %.not17.i, label %.critedge.thread, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.av = getelementptr inbounds nuw i8, ptr %i.au, i64 8
  %i.aw = load i64, ptr %i.av, align 8, !tbaa !39
  %i.ax = ptrtoint ptr %i.au to i64               ; 3 uses
  %i.ay = xor i64 %i.aw, %i.ax
  %.not18.i = icmp eq i64 %i.ay, -1283669654
...
bb.m:                                             ; preds = %bb.l
  %.not21.i = icmp ult ptr %.073, %i.au
  br i1 %.not21.i, label %bb.n, label %.invoke207, !prof !7

bb.n:                                             ; preds = %bb.m
  %i.bb = load i64, ptr %.073, align 8, !tbaa !38
  %i.bc = getelementptr inbounds nuw i8, ptr %.073, i64 %i.bb
  %.not22.i = icmp ult ptr %i.bc, %i.au
  br i1 %.not22.i, label %bb.o, label %.invoke207, !prof !7

.invoke207:                                       ; preds = %bb.n, %bb.m, %bb.k, %bb.j, %bb.h
  %i.bd = phi i32 [ 461, %bb.m ], [ 459, %bb.k ], [ 458, %bb.j ], [ 453, %bb.h ], [ 464, %bb.n ]
  %i.be = phi ptr [ @.str.43, %bb.m ], [ @.str.41, %bb.k ], [ @.str.39, %bb.j ], [ @.str.37, %bb.h ], [ @.str.45, %bb.n ]
  %i.bf = phi ptr [ @.str.44, %bb.m ], [ @.str.42, %bb.k ], [ @.str.40, %bb.j ], [ @.str.38, %bb.h ], [ @.str.46, %bb.n ]
  invoke void (i32, ptr, i32, ptr, ...) @_ZN4absl12lts_2025051216raw_log_internal6RawLogENS0_11LogSeverityEPKciS4_z(i32 noundef 3, ptr noundef nonnull getelementptr inbounds nuw (i8, ptr @.str, i64 74), i32 noundef %i.bd, ptr noundef nonnull @.str.1, ptr noundef nonnull %i.be, ptr noundef nonnull %i.bf)
...
bb.o:                                             ; preds = %bb.n, %bb.l
  %i.bg = load i64, ptr %i.au, align 8, !tbaa !38 ; 3 uses
  %i.bh = icmp ult i64 %i.bg, %i.y
  br i1 %i.bh, label %bb.h, label %.preheader.preheader.i.i, !llvm.loop !51
...
.critedge.thread:                                 ; preds = %bb.i, %bb.g
  %i.bk = load atomic i32, ptr %1 monotonic, align 8
  %i.bl = and i32 %i.bk, 2
  %i.bm = atomicrmw xchg ptr %1, i32 %i.bl release, align 4 ; 2 uses
  %.not4.i = icmp ult i32 %i.bm, 8
  br i1 %.not4.i, label %_ZN4absl12lts_2025051213base_internal8SpinLock6UnlockEv.exit, label %bb.r

bb.r:                                             ; preds = %.critedge.thread
  invoke void @_ZN4absl12lts_2025051213base_internal8SpinLock10SlowUnlockEj(ptr noundef nonnull align 4 dereferenceable(4) %1, i32 noundef %i.bm) #14
...
_ZN4absl12lts_2025051213base_internal8SpinLock6UnlockEv.exit: ; preds = %.critedge.thread, %bb.r
  %i.bn = load i64, ptr %i.ae, align 8, !tbaa !19
  %i.bo = shl i64 %i.bn, 4                        ; 2 uses
  %i.bp = add i64 %i.af, %i.bo                    ; 2 uses
  %.not.i.i100 = icmp ult i64 %i.bp, %i.y
...
bb.t:                                             ; preds = %_ZN4absl12lts_2025051213base_internal8SpinLock6UnlockEv.exit
  %i.bq = sub i64 0, %i.bo
  %i.br = and i64 %i.bp, %i.bq                    ; 4 uses
  %i.bs = load i32, ptr %i.d, align 4, !tbaa !18
  %i.bt = and i32 %i.bs, 2
  %.not80 = icmp eq i32 %i.bt, 0
  br i1 %.not80, label %bb.w, label %bb.u

bb.u:                                             ; preds = %bb.t
  %i.bu = call i64 (i64, ...) @syscall(i64 noundef 9, i64 noundef 0, i64 noundef %i.br, i64 noundef 3, i64 noundef 34, i64 noundef -1, i64 noundef 0) #13
...
bb.w:                                             ; preds = %bb.t
  %i.bx = call ptr @mmap(ptr noundef null, i64 noundef %i.br, i32 noundef 3, i32 noundef 34, i32 noundef -1, i64 noundef 0) #13
  br label %bb.x

bb.x:                                             ; preds = %bb.w, %bb.u
  %.065 = phi ptr [ %i.bv, %bb.u ], [ %i.bx, %bb.w ] ; 7 uses
  %i.by = icmp eq ptr %.065, inttoptr (i64 -1 to ptr)
  br i1 %i.by, label %bb.y, label %bb.ab

bb.y:                                             ; preds = %bb.x
  %i.bz = tail call ptr @__errno_location() #15
  %i.ca = load i32, ptr %i.bz, align 4, !tbaa !3
  invoke void (i32, ptr, i32, ptr, ...) @_ZN4absl12lts_2025051216raw_log_internal6RawLogENS0_11LogSeverityEPKciS4_z(i32 noundef 3, ptr noundef nonnull getelementptr inbounds nuw (i8, ptr @.str, i64 74), i32 noundef 570, ptr noundef nonnull @.str.31, i32 noundef %i.ca)
...
bb.ab:                                            ; preds = %bb.x
  %i.cc = call i32 (i32, ...) @prctl(i32 noundef 1398164801, i32 noundef 0, ptr noundef %.065, i64 noundef %i.br, ptr noundef nonnull @.str.32) #13 ; 0 uses
  %i.cd = load atomic i32, ptr %1 monotonic, align 8 ; 3 uses
  %i.ce = and i32 %i.cd, 1
...
_ZN4absl12lts_2025051213base_internal8SpinLock11TryLockImplEv.exit.i: ; preds = %bb.ab
  %i.cf = or disjoint i32 %i.cd, 1
  %i.cg = cmpxchg ptr %1, i32 %i.cd, i32 %i.cf acquire monotonic, align 4
  %i.ch = extractvalue { i32, i1 } %i.cg, 0
  %.pre.i.i = and i32 %i.ch, 1
  %i.ci = icmp eq i32 %.pre.i.i, 0
  br i1 %i.ci, label %_ZN4absl12lts_2025051213base_internal8SpinLock4LockEv.exit, label %_ZN4absl12lts_2025051213base_internal8SpinLock11TryLockImplEv.exit.thread.i
...
_ZN4absl12lts_2025051213base_internal8SpinLock4LockEv.exit: ; preds = %_ZN4absl12lts_2025051213base_internal8SpinLock11TryLockImplEv.exit.i, %_ZN4absl12lts_2025051213base_internal8SpinLock11TryLockImplEv.exit.thread.i
  store i64 %i.br, ptr %.065, align 8, !tbaa !38
  %i.cj = ptrtoint ptr %.065 to i64
  %i.ck = xor i64 %i.cj, 1283669653
  %i.cl = getelementptr inbounds nuw i8, ptr %.065, i64 8
  store i64 %i.ck, ptr %i.cl, align 8, !tbaa !39
  %i.cm = getelementptr inbounds nuw i8, ptr %.065, i64 16
  store ptr %1, ptr %i.cm, align 8, !tbaa !40
  %i.cn = getelementptr inbounds nuw i8, ptr %.065, i64 32
  invoke fastcc void @_ZN4absl12lts_2025051213base_internalL13AddToFreelistEPvPNS1_13LowLevelAlloc5ArenaE(ptr noundef nonnull %i.cn, ptr noundef nonnull %1)
...
.preheader.preheader.i.i:                         ; preds = %bb.o
  %i.cp = getelementptr inbounds nuw i8, ptr %i.au, i64 8 ; 2 uses
  %i.cq = getelementptr inbounds nuw i8, ptr %i.au, i64 16
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #13
  %i.cr = zext nneg i32 %i.ao to i64
  br label %.preheader.i.i

.preheader.i.i:                                   ; preds = %bb.ae, %.preheader.preheader.i.i
  %indvars.iv.i.i = phi i64 [ %i.cr, %.preheader.preheader.i.i ], [ %indvars.iv.next.i.i, %bb.ae ] ; 2 uses
...
bb.ad:                                            ; preds = %bb.ad, %.preheader.i.i
  %.1.i.i = phi ptr [ %i.cu, %bb.ad ], [ %.016.i.i, %.preheader.i.i ] ; 3 uses
  %i.cs = getelementptr inbounds nuw i8, ptr %.1.i.i, i64 40
  %i.ct = getelementptr inbounds nuw [8 x i8], ptr %i.cs, i64 %indvars.iv.next.i.i
  %i.cu = load ptr, ptr %i.ct, align 8, !tbaa !36 ; 3 uses
  %i.cv = icmp ne ptr %i.cu, null
  %i.cw = icmp ult ptr %i.cu, %i.au
  %i.cx = and i1 %i.cv, %i.cw
  br i1 %i.cx, label %bb.ad, label %bb.ae, !llvm.loop !47

bb.ae:                                            ; preds = %bb.ad
  %i.cy = getelementptr inbounds nuw [8 x i8], ptr %i.a, i64 %indvars.iv.next.i.i
  store ptr %.1.i.i, ptr %i.cy, align 8, !tbaa !36
end_hunk_0
