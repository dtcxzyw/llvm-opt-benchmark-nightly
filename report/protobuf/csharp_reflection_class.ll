...
begin_hunk_0_@_ZN4absl12lts_2025051218container_internal12raw_hash_setINS1_17FlatHashMapPolicyISt17basic_string_viewIcSt11char_traitsIcEES7_EENS1_10StringHashENS1_8StringEqESaISt4pairIKS7_S7_EEE46transfer_unprobed_elements_to_next_capacity_fnERNS1_12CommonFieldsEPKNS1_6ctrl_tEPvSL_PFvSL_hmmE:bb.a
  ...
  br i1 %.not26.i, label %bb.t, label %bb.s, !prof !23
...
.lr.ph:                                           ; preds = %bb.b
  %.sroa.0.0.copyload.i.i.i.i.i = load i64, ptr %2, align 8, !tbaa !107 ; 3 uses
  %.sroa.2.0.copyload.i.i.i.i.i = load ptr, ptr %.sroa.2.0..sroa_idx.i, align 8, !tbaa !147
...
.lr.ph.a:                                         ; preds = %.lr.ph, %.critedge
  ...
  %.sroa.01.0.copyload.i.i.i.i.i = load i64, ptr %i.aa, align 8, !tbaa !107
...
.thread:                                          ; preds = %.critedge18
  ...
  %i.am = load ptr, ptr %i.a, align 8, !tbaa !21, !nonnull !103, !noundef !103
...
bb.e:                                             ; preds = %.thread, %.critedge20
  ...
  store i8 %.sink, ptr %i.as, align 8, !tbaa !148
  ret void
}
