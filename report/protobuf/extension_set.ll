...
bb.d:                                             ; preds = %bb.d, %.lr.ph288.new
  ...
  %i.cq = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.cp, i1 true)
...
bb.e:                                             ; preds = %bb.e, %.lr.ph284.new
  ...
  %i.cy = or i64 %i.cx, 1
  %i.cz = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.cy, i1 true)
  ...
  %i.di = or i64 %i.dh, 1
  %i.dj = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.di, i1 true)
...
bb.f:                                             ; preds = %bb.f, %.lr.ph280.new
  ...
  %i.dr = or i32 %i.dq, 1
  %i.ds = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.dr, i1 true)
  ...
  %i.ec = or i32 %i.eb, 1
  %i.ed = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.ec, i1 true)
...
bb.g:                                             ; preds = %bb.g, %.lr.ph276.new
  ...
  %i.ew = or i64 %i.ev, 1
  %i.ex = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.ew, i1 true)
...
bb.h:                                             ; preds = %bb.h, %.lr.ph272.new
  ...
  %i.fi = or i32 %i.fh, 1
  %i.fj = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.fi, i1 true)
  ...
  %i.fw = or i32 %i.fv, 1
  %i.fx = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.fw, i1 true)
...
bb.i:                                             ; preds = %bb.i, %.lr.ph268.new
  ...
  %i.gj = or i64 %i.gi, 1
  %i.gk = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.gj, i1 true)
  ...
  %i.gw = or i64 %i.gv, 1
  %i.gx = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.gw, i1 true)
...
bb.j:                                             ; preds = %bb.j, %.lr.ph264.new
  ...
  %i.hh = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.hg, i1 true)
  ...
  %i.hs = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.hr, i1 true)
...
.epil.preheader613:                               ; preds = %.loopexit.loopexit.unr-lcssa, %.lr.ph288
  ...
  %i.jm = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.jl, i1 true)
...
.epil.preheader606:                               ; preds = %.loopexit.loopexit480.unr-lcssa, %.lr.ph284
  ...
  %i.ju = or i64 %i.jt, 1
  %i.jv = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.ju, i1 true)
...
.epil.preheader599:                               ; preds = %.loopexit.loopexit482.unr-lcssa, %.lr.ph280
  ...
  %i.kd = or i32 %i.kc, 1
  %i.ke = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.kd, i1 true)
...
.epil.preheader592:                               ; preds = %.loopexit.loopexit484.unr-lcssa, %.lr.ph276
  ...
  %i.kn = or i64 %i.km, 1
  %i.ko = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.kn, i1 true)
...
.epil.preheader585:                               ; preds = %.loopexit.loopexit486.unr-lcssa, %.lr.ph272
  ...
  %i.kz = or i32 %i.ky, 1
  %i.la = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.kz, i1 true)
...
.epil.preheader578:                               ; preds = %.loopexit.loopexit488.unr-lcssa, %.lr.ph268
  ...
  %i.lm = or i64 %i.ll, 1
  %i.ln = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.lm, i1 true)
...
.epil.preheader571:                               ; preds = %.loopexit.loopexit490.unr-lcssa, %.lr.ph264
  ...
  %i.lx = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.lw, i1 true)
...
bb.t:                                             ; preds = %.loopexit
  %i.mf = or i32 %i.me, 1
  %i.mg = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.mf, i1 true)
  ...
  %i.mo = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.mn, i1 true)
...
bb.u:                                             ; preds = %bb.b
  ...
  %i.my = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.mx, i1 true)
...
bb.w:                                             ; preds = %bb.w, %.lr.ph260.new
  ...
  %i.nw = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.nv, i1 true)
  ...
  %i.oh = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.og, i1 true)
...
bb.y:                                             ; preds = %bb.y, %.lr.ph256.new
  ...
  %i.pb = or i64 %i.pa, 1
  %i.pc = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.pb, i1 true)
  ...
  %i.pl = or i64 %i.pk, 1
  %i.pm = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.pl, i1 true)
...
bb.aa:                                            ; preds = %bb.aa, %.lr.ph252.new
  ...
  %i.qg = or i32 %i.qf, 1
  %i.qh = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.qg, i1 true)
  ...
  %i.qr = or i32 %i.qq, 1
  %i.qs = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.qr, i1 true)
...
bb.ac:                                            ; preds = %bb.ac, %.lr.ph248.new
  ...
  %i.rn = or i64 %i.rm, 1
  %i.ro = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.rn, i1 true)
  ...
  %i.rx = or i64 %i.rw, 1
  %i.ry = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.rx, i1 true)
...
bb.ae:                                            ; preds = %bb.ae, %.lr.ph244.new
  ...
  %i.sv = or i32 %i.su, 1
  %i.sw = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.sv, i1 true)
  ...
  %i.tj = or i32 %i.ti, 1
  %i.tk = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.tj, i1 true)
...
bb.ag:                                            ; preds = %bb.ag, %.lr.ph240.new
  ...
  %i.ui = or i64 %i.uh, 1
  %i.uj = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.ui, i1 true)
  ...
  %i.uv = or i64 %i.uu, 1
  %i.uw = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.uv, i1 true)
...
bb.ai:                                            ; preds = %bb.ai, %.lr.ph236.new
  ...
  %i.vv = or i32 %i.vu, 1
  %i.vw = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.vv, i1 true)
  ...
  %i.wk = or i32 %i.wj, 1
  %i.wl = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.wk, i1 true)
...
bb.ak:                                            ; preds = %bb.ak, %.lr.ph232.new
  ...
  %i.xm = or i32 %i.xl, 1
  %i.xn = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.xm, i1 true)
  ...
  %i.yb = or i32 %i.ya, 1
  %i.yc = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.yb, i1 true)
...
bb.am:                                            ; preds = %bb.am, %.lr.ph228.new
  ...
  %i.za = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.yz, i1 true)
  ...
  %i.zl = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.zk, i1 true)
...
.lr.ph:                                           ; preds = %bb.ao, %.lr.ph
  ...
  %i.abn = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.abm, i1 true)
...
bb.ax:                                            ; preds = %bb.aw
  ...
  %i.adx = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.adw, i1 true)
...
bb.ay:                                            ; preds = %bb.ax
  ...
  %i.aei = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.aeh, i1 true)
...
bb.az:                                            ; preds = %bb.ax
  ...
  %i.aeq = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.aep, i1 true)
...
bb.ba:                                            ; preds = %bb.ax
  ...
  %i.aey = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.aex, i1 true)
...
bb.bb:                                            ; preds = %bb.ax
  ...
  %i.afh = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.afg, i1 true)
...
bb.bc:                                            ; preds = %bb.ax
  ...
  %i.afs = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.afr, i1 true)
...
bb.bd:                                            ; preds = %bb.ax
  ...
  %i.age = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.agd, i1 true)
...
bb.be:                                            ; preds = %bb.ax
  ...
  %i.agp = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.ago, i1 true)
...
bb.bf:                                            ; preds = %bb.ax
  ...
  %i.ahc = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.ahb, i1 true)
...
bb.bg:                                            ; preds = %bb.ax
  ...
  %i.ahn = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.ahm, i1 true)
...
bb.bi:                                            ; preds = %bb.ax
  ...
  %i.aih = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.aig, i1 true)
...
.epil.preheader564:                               ; preds = %.loopexit209.loopexit.unr-lcssa, %.lr.ph260
  ...
  %i.aja = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.aiz, i1 true)
...
.epil.preheader557:                               ; preds = %.loopexit209.loopexit493.unr-lcssa, %.lr.ph256
  ...
  %i.ajj = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.aji, i1 true)
...
.epil.preheader543:                               ; preds = %.loopexit209.loopexit497.unr-lcssa, %.lr.ph248
  ...
  %i.akc = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.akb, i1 true)
...
.epil.preheader536:                               ; preds = %.loopexit209.loopexit499.unr-lcssa, %.lr.ph244
  ...
  %i.ako = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.akn, i1 true)
...
.epil.preheader529:                               ; preds = %.loopexit209.loopexit501.unr-lcssa, %.lr.ph240
  ...
  %i.alb = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.ala, i1 true)
...
.epil.preheader522:                               ; preds = %.loopexit209.loopexit503.unr-lcssa, %.lr.ph236
  ...
  %i.aln = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.alm, i1 true)
...
.epil.preheader515:                               ; preds = %.loopexit209.loopexit505.unr-lcssa, %.lr.ph232
  ...
  %i.amb = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.ama, i1 true)
...
bb.r:                                             ; preds = %bb.q
  %i.fd = or i32 %i.es, 1
  %i.fe = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.fd, i1 true)
