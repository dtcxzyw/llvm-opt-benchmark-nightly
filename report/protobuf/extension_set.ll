...
define { ptr, i8 } @_ZN6google8protobuf8internal12ExtensionSet6InsertEPNS0_5ArenaEi(ptr noundef nonnull align 8 captures(none) dereferenceable(16) %0, ptr noundef %1, i32 noundef %2) local_unnamed_addr #3 align 2 {
bb.a:
...
._crit_edge.loopexit:                             ; preds = %bb.d, %bb.e
  ...
  %5 = shl i64 %.0.lcssa.ph, 5
  %6 = and i64 %5, 2097120
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %bb.c
  %.0.lcssa = phi i64 [ 0, %bb.c ], [ %6, %._crit_edge.loopexit ] ; 2 uses
  %i.o = load i16, ptr %0, align 8, !tbaa !99
  %i.p = icmp eq i16 %i.b, %i.o
  br i1 %i.p, label %bb.f, label %bb.i

bb.f:                                             ; preds = %._crit_edge
  %narrow = add nuw i16 %i.b, 1
  %i.q = zext i16 %narrow to i64
  tail call void @_ZN6google8protobuf8internal12ExtensionSet12GrowCapacityEPNS0_5ArenaEm(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef %1, i64 noundef %i.q)
  %i.r = load i16, ptr %i.a, align 2, !tbaa !86   ; 2 uses
  %i.s = icmp slt i16 %i.r, 0
  br i1 %i.s, label %bb.g, label %bb.h, !prof !35

bb.g:                                             ; preds = %bb.f
  %i.t = tail call { ptr, i8 } @_ZN6google8protobuf8internal12ExtensionSet26InternalInsertIntoLargeMapEi(ptr noundef nonnull align 8 dereferenceable(16) %0, i32 noundef %2)
  br label %bb.m
...
bb.i:                                             ; preds = %bb.h, %._crit_edge
  %i.v = phi i16 [ %i.r, %bb.h ], [ %i.b, %._crit_edge ]
  %.029 = phi ptr [ %i.u, %bb.h ], [ %i.f, %._crit_edge ] ; 2 uses
  %i.w = getelementptr inbounds nuw i8, ptr %.029, i64 %.0.lcssa ; 4 uses
  %i.x = zext nneg i16 %i.v to i64
  %.idx = shl nuw nsw i64 %i.x, 5                 ; 2 uses
  %i.y = getelementptr inbounds nuw i8, ptr %.029, i64 %.idx ; 2 uses
  %gepdiff = sub nsw i64 %.idx, %.0.lcssa         ; 3 uses
  %i.z = ashr exact i64 %gepdiff, 5               ; 2 uses
  %i.aa = icmp sgt i64 %i.z, 1
  br i1 %i.aa, label %bb.j, label %bb.k, !prof !34

bb.j:                                             ; preds = %bb.i
  %i.ab = getelementptr inbounds nuw i8, ptr %i.y, i64 32
  %i.ac = sub nsw i64 0, %i.z
  %i.ad = getelementptr inbounds [32 x i8], ptr %i.ab, i64 %i.ac
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.ad, ptr align 8 %i.w, i64 %gepdiff, i1 false)
  br label %_ZSt13copy_backwardIPN6google8protobuf8internal12ExtensionSet8KeyValueES5_ET0_T_S7_S6_.exit

bb.k:                                             ; preds = %bb.i
  %i.ae = icmp eq i64 %gepdiff, 32
  br i1 %i.ae, label %bb.l, label %_ZSt13copy_backwardIPN6google8protobuf8internal12ExtensionSet8KeyValueES5_ET0_T_S7_S6_.exit

bb.l:                                             ; preds = %bb.k
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.y, ptr noundef nonnull align 8 dereferenceable(32) %i.w, i64 32, i1 false), !tbaa.struct !141
  br label %_ZSt13copy_backwardIPN6google8protobuf8internal12ExtensionSet8KeyValueES5_ET0_T_S7_S6_.exit
...
_ZSt13copy_backwardIPN6google8protobuf8internal12ExtensionSet8KeyValueES5_ET0_T_S7_S6_.exit: ; preds = %bb.j, %bb.k, %bb.l
  ...
  %i.ag = add i16 %i.af, 1
  store i16 %i.ag, ptr %i.a, align 2, !tbaa !86
  store i32 %2, ptr %i.w, align 8, !tbaa !109
  ...
  %i.ai = insertvalue { ptr, i8 } poison, ptr %i.ah, 0
  %i.aj = insertvalue { ptr, i8 } %i.ai, i8 1, 1
  br label %bb.m

bb.m:                                             ; preds = %.thread, %bb.g, %_ZSt13copy_backwardIPN6google8protobuf8internal12ExtensionSet8KeyValueES5_ET0_T_S7_S6_.exit, %bb.b
  %.fca.1.insert.merged = phi { ptr, i8 } [ %i.d, %bb.b ], [ %i.t, %bb.g ], [ %i.aj, %_ZSt13copy_backwardIPN6google8protobuf8internal12ExtensionSet8KeyValueES5_ET0_T_S7_S6_.exit ], [ %i.m, %.thread ]
  ret { ptr, i8 } %.fca.1.insert.merged
}

; Function Attrs: mustprogress uwtable
define noundef zeroext i1 @_ZNK6google8protobuf8internal12ExtensionSet13IsInitializedEPNS0_5ArenaEPKNS0_11MessageLiteE(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(16) %0, ptr noundef %1, ptr noundef %2) local_unnamed_addr #3 align 2 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  ...
  %.not3.i.not36 = select i1 %i.m, i1 %i.n, i1 false
  br i1 %.not3.i.not36, label %._crit_edge, label %.lr.ph38

.lr.ph38:                                         ; preds = %bb.b, %bb.c
...
bb.c:                                             ; preds = %.lr.ph38
  ...
  br i1 %.not3.i.not, label %._crit_edge, label %.lr.ph38

._crit_edge:                                      ; preds = %.lr.ph38, %bb.c, %bb.b
  %.not3.i.not.lcssa = phi i1 [ true, %bb.b ], [ %i.w, %bb.c ], [ %i.w, %.lr.ph38 ]
...
bb.e:                                             ; preds = %.lr.ph
  %i.ad = getelementptr inbounds nuw i8, ptr %.032, i64 32 ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.e
  %.032 = phi ptr [ %i.ad, %bb.e ], [ %i.ac, %.lr.ph.preheader ] ; 3 uses
  %i.ai = getelementptr inbounds nuw i8, ptr %.032, i64 8
  %i.aj = load i32, ptr %.032, align 8, !tbaa !109
...
; Function Attrs: mustprogress uwtable
define noundef zeroext i1 @_ZNK6google8protobuf8internal12ExtensionSet9Extension13IsInitializedEPKS2_PKNS0_11MessageLiteEiPNS0_5ArenaE(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(24) %0, ptr readnone captures(none) %1, ptr noundef %2, i32 noundef %3, ptr noundef %4) local_unnamed_addr #3 align 2 {
bb.a:
