Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/protobuf/original/build_enum?download=true
...
bb.a:
  ...
  store ptr %i.b, ptr %4, align 8, !tbaa !22
  %i.c = getelementptr inbounds nuw i8, ptr %4, i64 8
  store ptr %3, ptr %i.c, align 8, !tbaa !10
  %i.d = getelementptr inbounds nuw i8, ptr %4, i64 216
  store ptr %2, ptr %i.d, align 8, !tbaa !14
  %.val.i = load ptr, ptr %2, align 8, !tbaa !16  ; 4 uses
  %i.e = getelementptr i8, ptr %2, i64 8
  %.val11.i = load ptr, ptr %i.e, align 8, !tbaa !17
...
upb_Arena_Malloc.exit:                            ; preds = %bb.b, %bb.c
  ...
  store ptr %.0.i, ptr %i.l, align 8, !tbaa !19
  %i.m = getelementptr inbounds nuw i8, ptr %4, i64 240
  store i32 2, ptr %i.m, align 8, !tbaa !20
...
bb.c:                                             ; preds = %bb.b
  %i.c = load i8, ptr %1, align 1, !tbaa !26      ; 2 uses
...
bb.f:                                             ; preds = %bb.e, %bb.b
  %.041.i = phi ptr [ %i.e, %bb.e ], [ %1, %bb.b ] ; 2 uses
...
upb_MdDecoder_CheckOutOfMemory.exit.i:            ; preds = %bb.f
  store i32 64, ptr %i.g, align 4, !tbaa !6
...
bb.h:                                             ; preds = %.loopexit.i, %.lr.ph.i
  ...
  %.03895.i = phi i32 [ 0, %.lr.ph.i ], [ %.2.i, %.loopexit.i ] ; 2 uses
  %.03994.i = phi ptr [ %.041.i, %.lr.ph.i ], [ %.140.i, %.loopexit.i ] ; 2 uses
  %i.s = getelementptr inbounds nuw i8, ptr %.03994.i, i64 1 ; 5 uses
  %i.t = load i8, ptr %.03994.i, align 1, !tbaa !26 ; 6 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  %3 = getelementptr i8, ptr @_kUpb_FromBase92, i64 %i.w
  %i.x = getelementptr i8, ptr %3, i64 -32
...
_upb_FromBase92.exit.i:                           ; preds = %_upb_FromBase92.exit.i.preheader, %upb_MiniTableEnum_BuildValue.exit.i
  ...
  %.191.i = phi i32 [ %i.ee, %upb_MiniTableEnum_BuildValue.exit.i ], [ %.03895.i, %_upb_FromBase92.exit.i.preheader ] ; 6 uses
...
bb.k:                                             ; preds = %_upb_FromBase92.exit.i
  %i.ac = load i32, ptr %i.m, align 8, !tbaa !28
  %i.ad = add i32 %i.ac, 1                        ; 2 uses
  store i32 %i.ad, ptr %i.m, align 8, !tbaa !28
...
bb.m:                                             ; preds = %bb.l, %bb.k
  %i.aj = load i32, ptr %i.n, align 4, !tbaa !21  ; 9 uses
  %i.ak = load i32, ptr %i.o, align 8, !tbaa !20
...
bb.p:                                             ; preds = %bb.n
  ...
  %i.at = load ptr, ptr %i.p, align 8, !tbaa !14  ; 7 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  %.val13.i.i.i72.i = load ptr, ptr %i.ba, align 8, !tbaa !17
...
upb_Arena_TryExtend.exit.thread.i.i63.i:          ; preds = %bb.q
  ...
  br i1 %i.bl, label %upb_Arena_Malloc.exit.i.i70.i, label %upb_Arena_Malloc.exit.thread.i.i67.i, !prof !18
...
bb.s:                                             ; preds = %upb_Arena_Malloc.exit.i.i70.i, %upb_Arena_Malloc.exit.thread.i.i67.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %.0.i4448.i.i68.i, ptr noundef nonnull readonly align 4 dereferenceable(1) %i.aa, i64 %i.bo, i1 false)
  %.pre27.pre.i69.i = load i32, ptr %i.n, align 4, !tbaa !21
  br label %upb_MdDecoder_CheckOutOfMemory.exit.i57.i
...
upb_MdDecoder_CheckOutOfMemory.exit.i57.i:        ; preds = %bb.s, %upb_Arena_ShrinkLast.exit.i.i60.i, %.critedge.i.i55.i, %bb.r
  ...
  store ptr %.034.i.ph.i59.i, ptr %i.f, align 8, !tbaa !19
  store i32 %spec.select.i52.i, ptr %i.o, align 8, !tbaa !20
...
.lr.ph.i.i:                                       ; preds = %bb.u, %_upb_MiniTable_AddEnumDataMember.exit.i
  ...
  %i.cd = load i32, ptr %i.n, align 4, !tbaa !21  ; 9 uses
  %i.ce = load i32, ptr %i.o, align 8, !tbaa !20
...
bb.x:                                             ; preds = %bb.v
  ...
  %i.cn = load ptr, ptr %i.p, align 8, !tbaa !14  ; 9 uses
...
bb.aa:                                            ; preds = %bb.z
  ...
  %.val13.i.i.i.i = load ptr, ptr %i.cu, align 8, !tbaa !17
...
upb_Arena_TryExtend.exit.thread.i.i.i:            ; preds = %bb.aa, %bb.z, %.upb_Arena_TryExtend.exit.thread_crit_edge.i.i.i
  ...
  %.val11.i.i.i.i = load ptr, ptr %i.dd, align 8, !tbaa !17
  %i.de = ptrtoint ptr %.val11.i.i.i.i to i64
  %i.df = ptrtoint ptr %.val.i43.i.i.i to i64
  %i.dg = sub i64 %i.de, %i.df
  %i.dh = icmp ult i64 %i.dg, %.pre-phi54.i.i.i
  br i1 %i.dh, label %upb_Arena_Malloc.exit.i.i.i, label %upb_Arena_Malloc.exit.thread.i.i.i, !prof !18
...
bb.ac:                                            ; preds = %upb_Arena_Malloc.exit.i.i.i, %upb_Arena_Malloc.exit.thread.i.i.i
  ...
  %.pre27.pre.i.i = load i32, ptr %i.n, align 4, !tbaa !21
  br label %upb_MdDecoder_CheckOutOfMemory.exit.i.i
...
upb_MdDecoder_CheckOutOfMemory.exit.i.i:          ; preds = %bb.ac, %upb_Arena_ShrinkLast.exit.i.i.i, %.critedge.i.i.i, %bb.ab
  ...
  store ptr %.034.i.ph.i.i, ptr %i.f, align 8, !tbaa !19
  store i32 %spec.select.i.i, ptr %i.o, align 8, !tbaa !20
...
_upb_MiniTable_AddEnumDataMember.exit.i:          ; preds = %upb_MdDecoder_CheckOutOfMemory.exit.i.i, %.lr.ph.i.i
  ...
  %i.do = add i32 %i.dm, 1
  store i32 %i.do, ptr %i.n, align 4, !tbaa !21
  %i.dp = zext i32 %i.dm to i64
  %i.dq = getelementptr inbounds nuw [4 x i8], ptr %i.dn, i64 %i.dp
  store i32 0, ptr %i.dq, align 4, !tbaa !6
  %i.dr = load i32, ptr %.pre.i113.i, align 4, !tbaa !6
  %i.ds = add i32 %i.dr, 32                       ; 2 uses
  store i32 %i.ds, ptr %.pre.i113.i, align 4, !tbaa !6
  %i.dt = icmp ult i32 %i.ds, %i.bz
  br i1 %i.dt, label %.lr.ph.i.i, label %._crit_edge.i.i, !llvm.loop !23
...
upb_MiniTableEnum_BuildValue.exit.i:              ; preds = %._crit_edge.i.i, %_upb_MiniTable_AddEnumDataMember.exit77.i, %_upb_FromBase92.exit.i
  ...
  br i1 %exitcond.not.i, label %.loopexit.loopexit.i, label %_upb_FromBase92.exit.i, !llvm.loop !24
...
bb.af:                                            ; preds = %bb.ae
  ...
  %i.ej = load i8, ptr getelementptr (i8, ptr @_kUpb_FromBase92, i64 94), align 1, !tbaa !26
  %i.ek = sext i8 %i.ej to i32
  %i.el = load i8, ptr getelementptr (i8, ptr @_kUpb_FromBase92, i64 63), align 1, !tbaa !26
  ...
  %4 = zext nneg i8 %i.t to i64
  %5 = getelementptr i8, ptr @_kUpb_FromBase92, i64 %4
  %i.et = getelementptr i8, ptr %5, i64 -32
...
_upb_FromBase92.exit.i.i.i:                       ; preds = %bb.ag
  %i.ey = getelementptr inbounds nuw i8, ptr %.029.i.i.i69, i64 1 ; 2 uses
  %6 = zext nneg i8 %i.fh to i64
  %7 = getelementptr i8, ptr @_kUpb_FromBase92, i64 %6
  %i.ez = getelementptr i8, ptr %7, i64 -32
...
.lr.ph:                                           ; preds = %bb.af, %_upb_FromBase92.exit.i.i.i
  ...
  %.024.i.i.i70 = phi i32 [ %i.fj, %_upb_FromBase92.exit.i.i.i ], [ 0, %bb.af ]
  %.029.i.i.i69 = phi ptr [ %i.ey, %_upb_FromBase92.exit.i.i.i ], [ %i.s, %bb.af ] ; 3 uses
  %i.fh = load i8, ptr %.029.i.i.i69, align 1, !tbaa !26 ; 2 uses
...
bb.ag:                                            ; preds = %.lr.ph
  %i.fj = add nuw nsw i32 %.024.i.i.i70, %.0.i.i.i.i ; 3 uses
...
upb_MdDecoder_DecodeBase92Varint.exit.i:          ; preds = %_upb_FromBase92.exit.i.i.i, %.lr.ph, %bb.af
  ...
  %.029.lcssa.i.i.i = phi ptr [ %scevgep.i.i.i, %bb.af ], [ %scevgep.i.i.i, %_upb_FromBase92.exit.i.i.i ], [ %.029.i.i.i69, %.lr.ph ] ; 2 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.029.lcssa.i.i.i) ]
  %i.fl = add i32 %.lcssa, %.03895.i
  br label %.loopexit.i
...
.loopexit.i:                                      ; preds = %.loopexit.loopexit.i, %upb_MdDecoder_DecodeBase92Varint.exit.i
  ...
  %.140.i = phi ptr [ %.029.lcssa.i.i.i, %upb_MdDecoder_DecodeBase92Varint.exit.i ], [ %i.s, %.loopexit.loopexit.i ] ; 2 uses
  %.2.i = phi i32 [ %i.fl, %upb_MdDecoder_DecodeBase92Varint.exit.i ], [ %i.ee, %.loopexit.loopexit.i ]
  %i.fp = icmp ult ptr %.140.i, %i.fn
  br i1 %i.fp, label %bb.h, label %upb_MtDecoder_DoBuildMiniTableEnum.exit, !llvm.loop !25
...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 4, !tbaa !21   ; 9 uses
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.n = load ptr, ptr %i.m, align 8, !tbaa !14   ; 9 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %.val13.i.i = load ptr, ptr %i.w, align 8, !tbaa !17
...
upb_Arena_TryExtend.exit.thread.i:                ; preds = %bb.g, %bb.f, %.upb_Arena_TryExtend.exit.thread_crit_edge.i
  ...
  %.val11.i.i = load ptr, ptr %i.af, align 8, !tbaa !17
  %i.ag = ptrtoint ptr %.val11.i.i to i64
  %i.ah = ptrtoint ptr %.val.i43.i to i64
  %i.ai = sub i64 %i.ag, %i.ah
  %i.aj = icmp ult i64 %i.ai, %.pre-phi54.i
  br i1 %i.aj, label %upb_Arena_Malloc.exit.i, label %upb_Arena_Malloc.exit.thread.i, !prof !18
