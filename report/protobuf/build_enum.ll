...
bb.af:                                            ; preds = %bb.ae
  ...
  %i.es = call range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.er, i1 true)
  %i.et = sub nuw nsw i32 32, %i.es
  %.0.i.i.i.i = select i1 %i.eq, i32 0, i32 %i.et
  %i.eu = sub i64 %i.ek, %i.ej
  %scevgep.i.i.i = getelementptr i8, ptr %i.s, i64 %i.eu ; 2 uses
  %narrow = add nuw i8 %i.t, 96
  %i.ev = and i8 %narrow, 127
  %i.ew = zext nneg i8 %i.ev to i64
  %i.ex = getelementptr inbounds nuw i8, ptr @_kUpb_FromBase92, i64 %i.ew
  %i.ey = load i8, ptr %i.ex, align 1, !tbaa !22
  %i.ez = sext i8 %i.ey to i32
  %i.fa = sub nsw i32 %i.ez, %i.eo                ; 2 uses
  %i.fb = icmp eq ptr %i.s, %i.q
  br i1 %i.fb, label %upb_MdDecoder_DecodeBase92Varint.exit.i, label %.lr.ph

_upb_FromBase92.exit.i.i.i:                       ; preds = %bb.ag
  %i.fc = getelementptr inbounds nuw i8, ptr %.026.i.i.i70, i64 1 ; 2 uses
  %narrow74 = add nuw i8 %i.fn, 96
  %i.fd = and i8 %narrow74, 127
  %i.fe = zext nneg i8 %i.fd to i64
  %i.ff = getelementptr inbounds nuw i8, ptr @_kUpb_FromBase92, i64 %i.fe
  %i.fg = load i8, ptr %i.ff, align 1, !tbaa !22
  %i.fh = sext i8 %i.fg to i32
  %i.fi = sub nsw i32 %i.fh, %i.eo
  %i.fj = shl i32 %i.fi, %i.fp
  %i.fk = or i32 %i.fj, %i.fm                     ; 2 uses
  %i.fl = icmp eq ptr %i.fc, %i.q
  br i1 %i.fl, label %upb_MdDecoder_DecodeBase92Varint.exit.i, label %.lr.ph

.lr.ph:                                           ; preds = %bb.af, %_upb_FromBase92.exit.i.i.i
  %i.fm = phi i32 [ %i.fk, %_upb_FromBase92.exit.i.i.i ], [ %i.fa, %bb.af ] ; 2 uses
  %.026.i.i.i70 = phi ptr [ %i.fc, %_upb_FromBase92.exit.i.i.i ], [ %i.s, %bb.af ] ; 3 uses
  %.028.i.i.i69 = phi i32 [ %i.fp, %_upb_FromBase92.exit.i.i.i ], [ 0, %bb.af ]
  %i.fn = load i8, ptr %.026.i.i.i70, align 1, !tbaa !22 ; 2 uses
  %i.fo = add i8 %i.fn, -127
  %or.cond.i.i.i = icmp ult i8 %i.fo, -32
  br i1 %or.cond.i.i.i, label %upb_MdDecoder_DecodeBase92Varint.exit.i, label %bb.ag

bb.ag:                                            ; preds = %.lr.ph
  %i.fp = add nuw nsw i32 %.028.i.i.i69, %.0.i.i.i.i ; 3 uses
  %i.fq = icmp samesign ult i32 %i.fp, 32
  br i1 %i.fq, label %_upb_FromBase92.exit.i.i.i, label %bb.ah
...
upb_MdDecoder_DecodeBase92Varint.exit.i:          ; preds = %_upb_FromBase92.exit.i.i.i, %.lr.ph, %bb.af
  %.lcssa = phi i32 [ %i.fa, %bb.af ], [ %i.fk, %_upb_FromBase92.exit.i.i.i ], [ %i.fm, %.lr.ph ]
  ...
  %i.fr = add i32 %.lcssa, %.03995.i
  br label %.loopexit.i

bb.ai:                                            ; preds = %bb.ae
  %i.fs = zext nneg i8 %i.t to i32
  call void (ptr, ptr, ...) @upb_MdDecoder_ErrorJmp(ptr noundef nonnull %0, ptr noundef nonnull @.str.1, i32 noundef %i.fs) #13
  unreachable
...
.loopexit.i:                                      ; preds = %.loopexit.loopexit.i, %upb_MdDecoder_DecodeBase92Varint.exit.i
  %i.ft = phi ptr [ %i.q, %upb_MdDecoder_DecodeBase92Varint.exit.i ], [ %.pre.i, %.loopexit.loopexit.i ] ; 2 uses
  %.pre.i107.i = phi ptr [ %.pre.i106.i, %upb_MdDecoder_DecodeBase92Varint.exit.i ], [ %.pre.i110.i, %.loopexit.loopexit.i ] ; 2 uses
  %i.fu = phi ptr [ %i.r, %upb_MdDecoder_DecodeBase92Varint.exit.i ], [ %i.ee, %.loopexit.loopexit.i ]
  %.141.i = phi ptr [ %.026.lcssa.i.i.i, %upb_MdDecoder_DecodeBase92Varint.exit.i ], [ %i.s, %.loopexit.loopexit.i ] ; 2 uses
  %.2.i = phi i32 [ %i.fr, %upb_MdDecoder_DecodeBase92Varint.exit.i ], [ %i.eg, %.loopexit.loopexit.i ]
  %i.fv = icmp ult ptr %.141.i, %i.ft
  br i1 %i.fv, label %bb.h, label %upb_MtDecoder_DoBuildMiniTableEnum.exit, !llvm.loop !29
...
bb.i:                                             ; preds = %upb_Arena_Malloc.exit.i, %upb_Arena_Malloc.exit.thread.i
  ...
  %.pre27.pre = load i32, ptr %i.a, align 4, !tbaa !25
  br label %upb_MdDecoder_CheckOutOfMemory.exit

bb.j:                                             ; preds = %upb_Arena_Malloc.exit.i
  store ptr null, ptr %i.o, align 8, !tbaa !20
  tail call void (ptr, ptr, ...) @upb_MdDecoder_ErrorJmp(ptr noundef nonnull %0, ptr noundef nonnull @.str.3) #13
  unreachable

upb_MdDecoder_CheckOutOfMemory.exit:              ; preds = %bb.h, %.critedge.i, %upb_Arena_ShrinkLast.exit.i, %bb.i
  %.pre27 = phi i32 [ %.pre27.pre, %bb.i ], [ %i.b, %upb_Arena_ShrinkLast.exit.i ], [ %i.b, %.critedge.i ], [ %i.b, %bb.h ]
  %.034.i.ph = phi ptr [ %.0.i4448.i, %bb.i ], [ %i.p, %upb_Arena_ShrinkLast.exit.i ], [ %i.p, %.critedge.i ], [ %i.p, %bb.h ] ; 2 uses
  store ptr %.034.i.ph, ptr %i.o, align 8, !tbaa !20
  store i32 %spec.select, ptr %i.c, align 8, !tbaa !21
  br label %bb.k

bb.k:                                             ; preds = %._crit_edge, %upb_MdDecoder_CheckOutOfMemory.exit
  %i.ao = phi i32 [ %i.b, %._crit_edge ], [ %.pre27, %upb_MdDecoder_CheckOutOfMemory.exit ] ; 2 uses
  %i.ap = phi ptr [ %.pre, %._crit_edge ], [ %.034.i.ph, %upb_MdDecoder_CheckOutOfMemory.exit ] ; 2 uses
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 8
  %i.ar = add i32 %i.ao, 1
  store i32 %i.ar, ptr %i.a, align 4, !tbaa !25
...
declare void @upb_Status_SetErrorMessage(ptr noundef, ptr noundef) local_unnamed_addr #3

; Function Attrs: nocallback nofree nosync nounwind willreturn
declare void @llvm.va_start.p0(ptr) #6

declare void @upb_Status_VAppendErrorFormat(ptr noundef, ptr noundef, ptr noundef) local_unnamed_addr #3
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{!8, !9, i64 0}
!8 = !{!"", !9, i64 0, !10, i64 8, !5, i64 16}
!9 = !{!"p1 omnipotent char", !10, i64 0}
!10 = !{!"any pointer", !5, i64 0}
!11 = !{!8, !10, i64 8}
!12 = !{!13, !14, i64 216}
!13 = !{!"", !8, i64 0, !14, i64 216, !15, i64 224, !4, i64 232, !4, i64 236, !4, i64 240}
!14 = !{!"p1 _ZTS9upb_Arena", !10, i64 0}
!15 = !{!"p1 _ZTS17upb_MiniTableEnum", !10, i64 0}
!16 = !{!17, !9, i64 0}
!17 = !{!"upb_Arena", !9, i64 0, !9, i64 8}
!18 = !{!17, !9, i64 8}
