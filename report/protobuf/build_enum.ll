...
bb.h:                                             ; preds = %.loopexit.i, %.lr.ph.i
  %i.q = phi ptr [ %i.k, %.lr.ph.i ], [ %i.fr, %.loopexit.i ] ; 4 uses
  %.pre.i106.i = phi ptr [ %i.i, %.lr.ph.i ], [ %.pre.i107.i, %.loopexit.i ] ; 2 uses
  %i.r = phi ptr [ %i.i, %.lr.ph.i ], [ %i.fs, %.loopexit.i ] ; 2 uses
...
bb.af:                                            ; preds = %bb.ae
  ...
  %i.et = and i8 %narrow, 127
  %i.eu = zext nneg i8 %i.et to i64
  %i.ev = getelementptr inbounds nuw i8, ptr @_kUpb_FromBase92, i64 %i.eu
  %i.ew = load i8, ptr %i.ev, align 1, !tbaa !22
  %i.ex = sext i8 %i.ew to i32
  %i.ey = sub nsw i32 %i.ex, %i.em                ; 2 uses
  %i.ez = icmp eq ptr %i.s, %i.q
  br i1 %i.ez, label %upb_MdDecoder_DecodeBase92Varint.exit.i, label %.lr.ph

_upb_FromBase92.exit.i.i.i:                       ; preds = %bb.ag
  %i.fa = getelementptr inbounds nuw i8, ptr %.026.i.i.i70, i64 1 ; 2 uses
  %narrow74 = add nuw i8 %i.fl, 96
  %i.fb = and i8 %narrow74, 127
  %i.fc = zext nneg i8 %i.fb to i64
  %i.fd = getelementptr inbounds nuw i8, ptr @_kUpb_FromBase92, i64 %i.fc
  %i.fe = load i8, ptr %i.fd, align 1, !tbaa !22
  %i.ff = sext i8 %i.fe to i32
  %i.fg = sub nsw i32 %i.ff, %i.em
  %i.fh = shl i32 %i.fg, %i.fn
  %i.fi = or i32 %i.fh, %i.fk                     ; 2 uses
  %i.fj = icmp eq ptr %i.fa, %i.q
  br i1 %i.fj, label %upb_MdDecoder_DecodeBase92Varint.exit.i, label %.lr.ph

.lr.ph:                                           ; preds = %bb.af, %_upb_FromBase92.exit.i.i.i
  %i.fk = phi i32 [ %i.fi, %_upb_FromBase92.exit.i.i.i ], [ %i.ey, %bb.af ] ; 2 uses
  %.026.i.i.i70 = phi ptr [ %i.fa, %_upb_FromBase92.exit.i.i.i ], [ %i.s, %bb.af ] ; 3 uses
  %.028.i.i.i69 = phi i32 [ %i.fn, %_upb_FromBase92.exit.i.i.i ], [ 0, %bb.af ]
  %i.fl = load i8, ptr %.026.i.i.i70, align 1, !tbaa !22 ; 2 uses
  %i.fm = add i8 %i.fl, -127
  %or.cond.i.i.i = icmp ult i8 %i.fm, -32
  br i1 %or.cond.i.i.i, label %upb_MdDecoder_DecodeBase92Varint.exit.i, label %bb.ag

bb.ag:                                            ; preds = %.lr.ph
  %i.fn = add nuw nsw i32 %.028.i.i.i69, %.0.i.i.i.i ; 3 uses
  %i.fo = icmp samesign ult i32 %i.fn, 32
  br i1 %i.fo, label %_upb_FromBase92.exit.i.i.i, label %bb.ah
...
upb_MdDecoder_DecodeBase92Varint.exit.i:          ; preds = %_upb_FromBase92.exit.i.i.i, %.lr.ph, %bb.af
  %.lcssa = phi i32 [ %i.ey, %bb.af ], [ %i.fi, %_upb_FromBase92.exit.i.i.i ], [ %i.fk, %.lr.ph ]
  ...
  %i.fp = add i32 %.lcssa, %.03995.i
  br label %.loopexit.i

bb.ai:                                            ; preds = %bb.ae
  %i.fq = zext nneg i8 %i.t to i32
  call void (ptr, ptr, ...) @upb_MdDecoder_ErrorJmp(ptr noundef nonnull %0, ptr noundef nonnull @.str.1, i32 noundef %i.fq) #13
  unreachable
...
.loopexit.i:                                      ; preds = %.loopexit.loopexit.i, %upb_MdDecoder_DecodeBase92Varint.exit.i
  %i.fr = phi ptr [ %i.q, %upb_MdDecoder_DecodeBase92Varint.exit.i ], [ %.pre.i, %.loopexit.loopexit.i ] ; 2 uses
  %.pre.i107.i = phi ptr [ %.pre.i106.i, %upb_MdDecoder_DecodeBase92Varint.exit.i ], [ %.pre.i110.i, %.loopexit.loopexit.i ] ; 2 uses
  %i.fs = phi ptr [ %i.r, %upb_MdDecoder_DecodeBase92Varint.exit.i ], [ %i.ee, %.loopexit.loopexit.i ]
  %.141.i = phi ptr [ %.026.lcssa.i.i.i, %upb_MdDecoder_DecodeBase92Varint.exit.i ], [ %i.s, %.loopexit.loopexit.i ] ; 2 uses
  %.2.i = phi i32 [ %i.fp, %upb_MdDecoder_DecodeBase92Varint.exit.i ], [ %i.eg, %.loopexit.loopexit.i ]
  %i.ft = icmp ult ptr %.141.i, %i.fr
  br i1 %i.ft, label %bb.h, label %upb_MtDecoder_DoBuildMiniTableEnum.exit, !llvm.loop !29
