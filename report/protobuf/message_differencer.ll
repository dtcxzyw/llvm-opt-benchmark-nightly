...
vector.memcheck40:                                ; preds = %.lr.ph.i.i.i17.preheader
  %i.al = sub i64 %i.e, %i.a
  %i.am = and i64 %i.al, -8                       ; 2 uses
  %scevgep41.a = getelementptr i8, ptr %.0.lcssa.i.i.i, i64 %i.am
  %i.an = getelementptr i8, ptr %scevgep41.a, i64 8
  %scevgep42 = getelementptr i8, ptr %1, i64 %i.am
  %bound043 = icmp ult ptr %i.ai, %scevgep42
  %bound144 = icmp ult ptr %1, %i.an
