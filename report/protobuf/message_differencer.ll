...
bb.c:                                             ; preds = %bb.b
  ...
  %.sroa.0.0.copyload.i.i.pre.i = load <2 x i64>, ptr %2, align 16, !tbaa !106
  br label %_ZNSt8functionIFvPSt6vectorIiSaIiEES3_EEC2ERKS5_.exit.i

bb.d:                                             ; preds = %bb.b
  %i.g = landingpad { ptr, i32 }
          cleanup
  %i.h = load ptr, ptr %i.b, align 16, !tbaa !160 ; 2 uses
...
_ZNSt8functionIFvPSt6vectorIiSaIiEES3_EEC2ERKS5_.exit.i: ; preds = %bb.c, %bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(32) %i.a, i64 16, i1 false), !tbaa.struct !236
  store <2 x i64> %.sroa.0.0.copyload.i.i.i, ptr %i.a, align 8, !tbaa !106
  ...
  store <2 x ptr> %i.m, ptr %i.b, align 16, !tbaa !158
