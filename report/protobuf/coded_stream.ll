...
bb.c:                                             ; preds = %bb.a
  ...
  %i.k = load i32, ptr %i.h, align 8, !tbaa !13
...
bb.g:                                             ; preds = %bb.f
  ...
  store i32 %i.ai, ptr %i.m, align 8, !tbaa !29
  br label %bb.i

bb.h:                                             ; preds = %bb.f
  %i.aj = load i32, ptr %i.m, align 8, !tbaa !29
  %i.ak = add nsw i32 %i.aj, %i.g
  store i32 %i.ak, ptr %i.m, align 8, !tbaa !29
  br label %bb.i
...
bb.h:                                             ; preds = %bb.g
  %i.y = load i32, ptr %i.b, align 4, !tbaa !13   ; 5 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  br i1 %.not.i.i, label %bb.k, label %bb.j, !prof !41

bb.j:                                             ; preds = %bb.i
  %i.ae = load i32, ptr %i.i, align 8, !tbaa !29  ; 3 uses
...
bb.n:                                             ; preds = %bb.j
  %i.aj = sub nuw nsw i32 %i.ae, %i.af            ; 2 uses
  store i32 %i.aj, ptr %i.f, align 4, !tbaa !25
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  store i32 %storemerge, ptr %i.i, align 8, !tbaa !29
  %i.ao = load i32, ptr %i.c, align 4, !tbaa !24
  ...
  %i.at = load i32, ptr %i.k, align 8, !tbaa !13
...
bb.p:                                             ; preds = %bb.o
  ...
  store ptr %i.az, ptr %i.ad, align 8, !tbaa !22
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.h = load i32, ptr %i.e, align 8, !tbaa !13
...
.split24:                                         ; preds = %bb.h
  ...
  %i.ae = load i64, ptr %i.a, align 8, !tbaa !65
...
bb.j:                                             ; preds = %bb.g
  ...
  %i.ao = load i64, ptr %i.a, align 8, !tbaa !65
