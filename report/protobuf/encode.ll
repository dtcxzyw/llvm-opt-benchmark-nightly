...
.lr.ph368:                                        ; preds = %.critedge.preheader.i.lr.ph, %.critedge.preheader.i
  %umax.i376 = phi i64 [ %umax.i, %.critedge.preheader.i ], [ %i.p, %.critedge.preheader.i.lr.ph ]
...
.critedge.i:                                      ; preds = %bb.f
  %exitcond.not.i = icmp eq i64 %i.r, %umax.i376
  br i1 %exitcond.not.i, label %.loopexit153, label %bb.f

bb.f:                                             ; preds = %.lr.ph368, %.critedge.i
  %.017.i367 = phi i64 [ %.0108182371, %.lr.ph368 ], [ %i.r, %.critedge.i ] ; 2 uses
  %i.r = add i64 %.017.i367, 1                    ; 5 uses
...
begin_hunk_1_@encode_message:bb.a
  ...
  %umax.i = tail call i64 @llvm.umax.i64(i64 %i.r, i64 %i.p)
...
.critedge.preheader.i51:                          ; preds = %encode_reserve.exit, %bb.j
  ...
  %.1109187 = phi i64 [ %i.aq, %bb.j ], [ 0, %encode_reserve.exit ] ; 3 uses
  ...
  %umax.i52 = tail call i64 @llvm.umax.i64(i64 %.1109187, i64 %i.an)
...
.critedge.i53:                                    ; preds = %.lr.ph374
  %exitcond.not.i55 = icmp eq i64 %i.aq, %umax.i52
  br i1 %exitcond.not.i55, label %upb_Message_NextUnknown.exit60.thread, label %.lr.ph374
...
.lr.ph374:                                        ; preds = %.critedge.preheader.i51, %.critedge.i53
  ...
  %i.aq = add i64 %.017.i54373, 1                 ; 3 uses
