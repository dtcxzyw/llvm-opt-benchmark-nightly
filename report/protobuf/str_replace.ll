...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !tbaa !32   ; 4 uses
...
_ZNSt12_Vector_baseIN4absl12lts_2025051216strings_internal18ViableSubstitutionESaIS3_EE11_M_allocateEm.exit.i: ; preds = %bb.b
  ...
  %i.g = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.f) #15 ; 7 uses
  ...
  %.pre = load i64, ptr %i.a, align 8, !tbaa !32  ; 2 uses
  %i.i = load ptr, ptr %3, align 8, !tbaa !35     ; 2 uses
  %.idx = shl nuw nsw i64 %.pre, 5
  %i.j = getelementptr inbounds nuw i8, ptr %i.i, i64 %.idx
  %.not.i.i.a = icmp eq i64 %.pre, 0
  br i1 %.not.i.i.a, label %._crit_edge, label %.lr.ph70

.lr.ph70:                                         ; preds = %_ZNSt12_Vector_baseIN4absl12lts_2025051216strings_internal18ViableSubstitutionESaIS3_EE11_M_allocateEm.exit.i
...
.lr.ph70.split:                                   ; preds = %.lr.ph70, %.critedge
  %i.k = phi ptr [ %i.bq, %.critedge ], [ %i.g, %.lr.ph70 ] ; 16 uses
  %.02168 = phi ptr [ %i.bt, %.critedge ], [ %i.i, %.lr.ph70 ] ; 6 uses
  %i.l = phi ptr [ %i.bs, %.critedge ], [ %i.h, %.lr.ph70 ] ; 9 uses
  %i.m = phi ptr [ %i.br, %.critedge ], [ %i.g, %.lr.ph70 ] ; 16 uses
...
._crit_edge:                                      ; preds = %.critedge, %bb.b, %.lr.ph70, %_ZNSt12_Vector_baseIN4absl12lts_2025051216strings_internal18ViableSubstitutionESaIS3_EE11_M_allocateEm.exit.i
  %.lcssa64 = phi ptr [ %i.g, %_ZNSt12_Vector_baseIN4absl12lts_2025051216strings_internal18ViableSubstitutionESaIS3_EE11_M_allocateEm.exit.i ], [ null, %bb.b ], [ %i.g, %.lr.ph70 ], [ %i.br, %.critedge ]
  %.lcssa60 = phi ptr [ %i.h, %_ZNSt12_Vector_baseIN4absl12lts_2025051216strings_internal18ViableSubstitutionESaIS3_EE11_M_allocateEm.exit.i ], [ null, %bb.b ], [ %i.h, %.lr.ph70 ], [ %i.bs, %.critedge ]
