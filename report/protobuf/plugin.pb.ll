...
.lr.ph.split:                                     ; preds = %.lr.ph.split, %.lr.ph.split.preheader.new
  ...
  %i.au = or i32 %i.at, 1
  %i.av = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.au, i1 true)
  ...
  %i.bj = or i32 %i.bi, 1
  %i.bk = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.bj, i1 true)
...
.lr.ph.split.epil.preheader:                      ; preds = %.loopexit54.loopexit.unr-lcssa, %.lr.ph.split.preheader
  ...
  %i.bx = or i32 %i.bw, 1
  %i.by = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.bx, i1 true)
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.eg = or i32 %i.ef, 1
  %i.eh = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.eg, i1 true)
...
.lr.ph66:                                         ; preds = %bb.h, %.lr.ph66
  ...
  %i.fj = or i32 %i.fi, 1
  %i.fk = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.fj, i1 true)
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ap = or i32 %i.ao, 1
  %i.aq = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.ap, i1 true)
