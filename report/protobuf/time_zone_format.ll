...
.lr.ph:                                           ; preds = %._crit_edge.i.i, %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit361
  %.1171.ph791 = phi ptr [ %.0170, %._crit_edge.i.i ], [ %.13, %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit361 ] ; 2 uses
  %.0177.ph788 = phi i1 [ false, %._crit_edge.i.i ], [ %.3180, %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit361 ] ; 47 uses
  %.0181.ph786 = phi i1 [ false, %._crit_edge.i.i ], [ %.4185, %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit361 ] ; 47 uses
  %.0208.ph785 = phi ptr [ %i.t, %._crit_edge.i.i ], [ %.7215, %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit361 ] ; 2 uses
  %.0216.ph784 = phi i1 [ false, %._crit_edge.i.i ], [ %.6222, %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit361 ] ; 52 uses
  %.0223.ph783 = phi i1 [ false, %._crit_edge.i.i ], [ %.2225, %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit361 ] ; 48 uses
  %.0226.ph782 = phi i32 [ 6, %._crit_edge.i.i ], [ %.1227, %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit361 ] ; 41 uses
  %.0228.ph781 = phi i1 [ false, %._crit_edge.i.i ], [ %.2230, %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit361 ] ; 46 uses
  %.0.ph780 = phi i32 [ -1, %._crit_edge.i.i ], [ %.1, %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit361 ] ; 39 uses
  %.0661.ph779 = phi i64 [ 0, %._crit_edge.i.i ], [ %.1662, %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit361 ] ; 46 uses
  %i.aa = load i8, ptr %.0208.ph785, align 1, !tbaa !14 ; 2 uses
  %.not258.not1110 = icmp eq i8 %i.aa, 0          ; 25 uses
  br i1 %.not258.not1110, label %.critedge, label %.lr.ph1114
...
.lr.ph1114:                                       ; preds = %.lr.ph, %select.unfold.backedge
  ...
  br i1 %.not278, label %bb.c, label %.preheader698

.preheader698:                                    ; preds = %.lr.ph1114, %.preheader698
  %.2172 = phi ptr [ %i.ah, %.preheader698 ], [ %.11717481111, %.lr.ph1114 ] ; 3 uses
  ...
  br i1 %.not304, label %.preheader697, label %.preheader698, !llvm.loop !58

.preheader697:                                    ; preds = %.preheader698, %.preheader697
  %.1209 = phi ptr [ %i.ai, %.preheader697 ], [ %.02087471112, %.preheader698 ]
  ...
  br i1 %.not305, label %select.unfold.backedge, label %.preheader697, !llvm.loop !59

select.unfold.backedge:                           ; preds = %.preheader697, %bb.d
  %.0208.be = phi ptr [ %spec.select686, %bb.d ], [ %i.ai, %.preheader697 ] ; 2 uses
  %.1171.be = phi ptr [ %i.ap, %bb.d ], [ %.2172, %.preheader697 ] ; 2 uses
  %i.am = load i8, ptr %.0208.be, align 1, !tbaa !14 ; 2 uses
  %.not258.not = icmp eq i8 %i.am, 0
  br i1 %.not258.not, label %.critedge, label %.lr.ph1114, !llvm.loop !60

bb.c:                                             ; preds = %.lr.ph1114
  %.not279 = icmp eq i8 %i.ab, 37
  br i1 %.not279, label %bb.e, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.an = load i8, ptr %.11717481111, align 1, !tbaa !14
  %i.ao = icmp eq i8 %i.an, %i.ab                 ; 2 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %.11717481111, i64 1
  %spec.select686.idx = zext i1 %i.ao to i64
  %spec.select686 = getelementptr inbounds nuw i8, ptr %.02087471112, i64 %spec.select686.idx
  br i1 %i.ao, label %select.unfold.backedge, label %.critedge

bb.e:                                             ; preds = %bb.c
  %i.aq = getelementptr inbounds nuw i8, ptr %.02087471112, i64 1
  %i.ar = load i8, ptr %i.aq, align 1, !tbaa !14  ; 2 uses
  %i.as = icmp eq i8 %i.ar, 0
  br i1 %i.as, label %.critedge, label %bb.f, !llvm.loop !60

bb.f:                                             ; preds = %bb.e
  %i.at = getelementptr inbounds nuw i8, ptr %.02087471112, i64 2 ; 31 uses
...
bb.g:                                             ; preds = %bb.f
  %i.au = load i8, ptr %.11717481111, align 1, !tbaa !14 ; 2 uses
  %i.av = icmp eq i8 %i.au, 45                    ; 4 uses
  br i1 %i.av, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g
  %i.aw = getelementptr inbounds nuw i8, ptr %.11717481111, i64 1 ; 2 uses
  %.pre.i = load i8, ptr %i.aw, align 1, !tbaa !14
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.g
  %i.ax = phi i8 [ %.pre.i, %bb.h ], [ %i.au, %bb.g ]
  %.0.i = phi ptr [ %i.aw, %bb.h ], [ %.11717481111, %bb.g ] ; 3 uses
...
_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIlEEPKcS7_iT_S8_PS8_.exit: ; preds = %select.unfold.i, %bb.m
  ...
  %spec.select = select i1 %.not296, i1 true, i1 %.0177.ph788
  br label %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit361, !llvm.loop !60
...
select.unfold.i323:                               ; preds = %.lr.ph.i320.preheader.peel.newph, %bb.r, %.fold.split.peel, %.lr.ph.i320.peel, %select.unfold.i323.loopexit.loopexit.split.loop.exit1337, %bb.p, %bb.q
  ...
  %i.ce = icmp eq i32 %.255.ph.i324, 0
  %or.cond5.not.i328 = select i1 %i.bs, i1 %i.ce, i1 false
...
bb.s:                                             ; preds = %select.unfold.i323
  %i.cf = sub nsw i32 0, %.255.ph.i324
  %spec.select.i329 = select i1 %i.bs, i32 %.255.ph.i324, i32 %i.cf ; 2 uses
  %i.cg = add i32 %spec.select.i329, -13
  %or.cond77.i = icmp ult i32 %i.cg, -12
  br i1 %or.cond77.i, label %.critedge, label %bb.t, !llvm.loop !60

bb.t:                                             ; preds = %bb.s
  %i.ch = add nsw i32 %spec.select.i329, -1
  store i32 %i.ch, ptr %i.l, align 16, !tbaa !22
  br label %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit361, !llvm.loop !60

bb.u:                                             ; preds = %bb.f, %bb.f
  %i.ci = load i8, ptr %.11717481111, align 1, !tbaa !14 ; 2 uses
  %i.cj = icmp eq i8 %i.ci, 45                    ; 5 uses
  br i1 %i.cj, label %bb.v, label %bb.w

bb.v:                                             ; preds = %bb.u
  %i.ck = getelementptr inbounds nuw i8, ptr %.11717481111, i64 1 ; 2 uses
  %.pre.i360 = load i8, ptr %i.ck, align 1, !tbaa !14
  br label %bb.w

bb.w:                                             ; preds = %bb.v, %bb.u
  %i.cl = phi i8 [ %.pre.i360, %bb.v ], [ %i.ci, %bb.u ]
  %.0.i333 = phi ptr [ %i.ck, %bb.v ], [ %.11717481111, %bb.u ] ; 5 uses
  %i.cm = sext i8 %i.cl to i32
  %memchr95.i334 = call ptr @memchr(ptr noundef nonnull dereferenceable(1) @_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_17kDigitsE, i32 %i.cm, i64 11) ; 2 uses
...
.lr.ph.i336.peel:                                 ; preds = %bb.w
  %i.cn = ptrtoint ptr %memchr95.i334 to i64
  %i.co = trunc i64 %i.cn to i32
  %i.cp = sub i32 %i.co, ptrtoint (ptr @_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_17kDigitsE to i32) ; 3 uses
  %i.cq = icmp sgt i32 %i.cp, 9
  br i1 %i.cq, label %select.unfold.i345, label %bb.x

bb.x:                                             ; preds = %.lr.ph.i336.peel
  %i.cr = sub nsw i32 0, %i.cp                    ; 3 uses
  %i.cs = getelementptr inbounds nuw i8, ptr %.0.i333, i64 1 ; 4 uses
  br i1 %i.cj, label %select.unfold.i345, label %.fold.split688.peel

.fold.split688.peel:                              ; preds = %bb.x
  %i.ct = load i8, ptr %i.cs, align 1, !tbaa !14
  %i.cu = sext i8 %i.ct to i32
  %memchr.i343.peel = call ptr @memchr(ptr noundef nonnull dereferenceable(1) @_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_17kDigitsE, i32 %i.cu, i64 11) ; 2 uses
...
.lr.ph.i336.preheader.peel.newph:                 ; preds = %.fold.split688.peel
  %i.cv = mul i32 %i.cp, -10                      ; 2 uses
  %i.cw = ptrtoint ptr %memchr.i343.peel to i64
  %i.cx = trunc i64 %i.cw to i32
  %i.cy = sub i32 %i.cx, ptrtoint (ptr @_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_17kDigitsE to i32) ; 3 uses
  %i.cz = or disjoint i32 %i.cy, -2147483648
  %i.da = icmp sgt i32 %i.cy, 9                   ; 3 uses
  %i.db = icmp slt i32 %i.cv, %i.cz
  %brmerge1342 = select i1 %i.da, i1 true, i1 %i.db
  %.mux1343 = select i1 %i.da, i32 %i.cr, i32 -2147483640
  %.mux1344 = select i1 %i.da, i1 true, i1 false
  br i1 %brmerge1342, label %select.unfold.i345, label %select.unfold.i345.loopexit.loopexit.split.loop.exit1321

select.unfold.i345.loopexit.loopexit.split.loop.exit1321: ; preds = %.lr.ph.i336.preheader.peel.newph
  %i.dc = sub nsw i32 %i.cv, %i.cy
  %i.dd = getelementptr inbounds nuw i8, ptr %.0.i333, i64 2
  br label %select.unfold.i345

select.unfold.i345:                               ; preds = %.lr.ph.i336.preheader.peel.newph, %.lr.ph.i336.peel, %bb.x, %.fold.split688.peel, %select.unfold.i345.loopexit.loopexit.split.loop.exit1321, %bb.w
  %.255.ph.i346 = phi i32 [ 0, %bb.w ], [ 0, %.lr.ph.i336.peel ], [ %i.cr, %bb.x ], [ %i.cr, %.fold.split688.peel ], [ %.mux1343, %.lr.ph.i336.preheader.peel.newph ], [ %i.dc, %select.unfold.i345.loopexit.loopexit.split.loop.exit1321 ] ; 4 uses
  %.252.ph.not.i347 = phi i1 [ true, %bb.w ], [ true, %.lr.ph.i336.peel ], [ true, %bb.x ], [ true, %.fold.split688.peel ], [ %.mux1344, %.lr.ph.i336.preheader.peel.newph ], [ true, %select.unfold.i345.loopexit.loopexit.split.loop.exit1321 ]
  %.3.ph.i348 = phi ptr [ %.0.i333, %bb.w ], [ %.0.i333, %.lr.ph.i336.peel ], [ %i.cs, %bb.x ], [ %i.cs, %.fold.split688.peel ], [ %i.cs, %.lr.ph.i336.preheader.peel.newph ], [ %i.dd, %select.unfold.i345.loopexit.loopexit.split.loop.exit1321 ] ; 2 uses
  %i.de = icmp ne ptr %.3.ph.i348, %.0.i333
  %or.cond.not94.i349 = and i1 %.252.ph.not.i347, %i.de
  %i.df = icmp ne i32 %.255.ph.i346, -2147483648
  %or.cond3.i350 = select i1 %i.cj, i1 true, i1 %i.df
  %or.cond76.i351 = select i1 %or.cond.not94.i349, i1 %or.cond3.i350, i1 false
  %or.cond76.not.i352 = xor i1 %or.cond76.i351, true
  %i.dg = icmp eq i32 %.255.ph.i346, 0
  %or.cond5.not.i353 = select i1 %i.cj, i1 %i.dg, i1 false
  %or.cond80.i354 = select i1 %or.cond76.not.i352, i1 true, i1 %or.cond5.not.i353
  br i1 %or.cond80.i354, label %.critedge, label %bb.y, !llvm.loop !60

bb.y:                                             ; preds = %select.unfold.i345
  %i.dh = sub nsw i32 0, %.255.ph.i346
  %spec.select.i355 = select i1 %i.cj, i32 %.255.ph.i346, i32 %i.dh ; 2 uses
  %i.di = add i32 %spec.select.i355, -32
  %or.cond77.i358 = icmp ult i32 %i.di, -31
  br i1 %or.cond77.i358, label %.critedge, label %bb.z, !llvm.loop !60

bb.z:                                             ; preds = %bb.y
  store i32 %spec.select.i355, ptr %i.m, align 4, !tbaa !3
  br label %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit361, !llvm.loop !60

bb.aa:                                            ; preds = %bb.f
  %i.dj = load i8, ptr %.11717481111, align 1, !tbaa !14 ; 2 uses
  %i.dk = icmp eq i8 %i.dj, 45                    ; 4 uses
  br i1 %i.dk, label %bb.ab, label %bb.ac

bb.ab:                                            ; preds = %bb.aa
  %i.dl = getelementptr inbounds nuw i8, ptr %.11717481111, i64 1 ; 2 uses
  %.pre.i391 = load i8, ptr %i.dl, align 1, !tbaa !14
  br label %bb.ac

bb.ac:                                            ; preds = %bb.ab, %bb.aa
  %i.dm = phi i8 [ %.pre.i391, %bb.ab ], [ %i.dj, %bb.aa ]
  %.0.i364 = phi ptr [ %i.dl, %bb.ab ], [ %.11717481111, %bb.aa ] ; 3 uses
  %i.dn = sext i8 %i.dm to i32
  %memchr95.i365 = call ptr @memchr(ptr noundef nonnull dereferenceable(1) @_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_17kDigitsE, i32 %i.dn, i64 11) ; 2 uses
  %.not7396.i366 = icmp eq ptr %memchr95.i365, null
  br i1 %.not7396.i366, label %select.unfold.i376, label %.lr.ph.i367

.lr.ph.i367:                                      ; preds = %bb.ac, %bb.af
  %memchr100.i368 = phi ptr [ %memchr.i374, %bb.af ], [ %memchr95.i365, %bb.ac ]
  %.199.i369 = phi ptr [ %i.dx, %bb.af ], [ %.0.i364, %bb.ac ] ; 4 uses
  %.05397.i371 = phi i32 [ %i.dw, %bb.af ], [ 0, %bb.ac ] ; 4 uses
  %i.do = ptrtoint ptr %memchr100.i368 to i64
  %i.dp = trunc i64 %i.do to i32
  %i.dq = sub i32 %i.dp, ptrtoint (ptr @_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_17kDigitsE to i32) ; 3 uses
  %i.dr = icmp sgt i32 %i.dq, 9
  br i1 %i.dr, label %select.unfold.i376, label %bb.ad

bb.ad:                                            ; preds = %.lr.ph.i367
  %i.ds = icmp slt i32 %.05397.i371, -214748364
  br i1 %i.ds, label %select.unfold.i376, label %bb.ae

bb.ae:                                            ; preds = %bb.ad
  %i.dt = mul nsw i32 %.05397.i371, 10            ; 2 uses
  %i.du = or disjoint i32 %i.dq, -2147483648
  %i.dv = icmp slt i32 %i.dt, %i.du
  br i1 %i.dv, label %select.unfold.i376, label %bb.af

bb.af:                                            ; preds = %bb.ae
  %i.dw = sub nsw i32 %i.dt, %i.dq                ; 2 uses
  %i.dx = getelementptr inbounds nuw i8, ptr %.199.i369, i64 1 ; 3 uses
  %i.dy = load i8, ptr %i.dx, align 1, !tbaa !14
  %i.dz = sext i8 %i.dy to i32
  %memchr.i374 = call ptr @memchr(ptr noundef nonnull dereferenceable(1) @_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_17kDigitsE, i32 %i.dz, i64 11) ; 2 uses
  %.not73.i375 = icmp eq ptr %memchr.i374, null
  br i1 %.not73.i375, label %select.unfold.i376, label %.lr.ph.i367

select.unfold.i376:                               ; preds = %bb.af, %bb.ae, %bb.ad, %.lr.ph.i367, %bb.ac
  %.255.ph.i377 = phi i32 [ 0, %bb.ac ], [ %i.dw, %bb.af ], [ %.05397.i371, %.lr.ph.i367 ], [ %.05397.i371, %bb.ad ], [ -2147483640, %bb.ae ] ; 4 uses
  %.252.ph.not.i378 = phi i1 [ true, %bb.ac ], [ true, %bb.af ], [ true, %.lr.ph.i367 ], [ false, %bb.ad ], [ false, %bb.ae ]
  %.3.ph.i379 = phi ptr [ %.0.i364, %bb.ac ], [ %i.dx, %bb.af ], [ %.199.i369, %.lr.ph.i367 ], [ %.199.i369, %bb.ad ], [ %.199.i369, %bb.ae ] ; 2 uses
  %i.ea = icmp ne ptr %.3.ph.i379, %.0.i364
  %or.cond.not94.i380 = and i1 %.252.ph.not.i378, %i.ea
  %i.eb = icmp ne i32 %.255.ph.i377, -2147483648
  %or.cond3.i381 = select i1 %i.dk, i1 true, i1 %i.eb
  %or.cond76.i382 = select i1 %or.cond.not94.i380, i1 %or.cond3.i381, i1 false
  %or.cond76.not.i383 = xor i1 %or.cond76.i382, true
  %i.ec = icmp eq i32 %.255.ph.i377, 0
  %or.cond5.not.i384 = select i1 %i.dk, i1 %i.ec, i1 false
  %or.cond80.i385 = select i1 %or.cond76.not.i383, i1 true, i1 %or.cond5.not.i384
  br i1 %or.cond80.i385, label %.critedge, label %bb.ag, !llvm.loop !60

bb.ag:                                            ; preds = %select.unfold.i376
  %i.ed = sub nsw i32 0, %.255.ph.i377
  %spec.select.i386 = select i1 %i.dk, i32 %.255.ph.i377, i32 %i.ed ; 2 uses
  %or.cond77.i389 = icmp ugt i32 %spec.select.i386, 53
  br i1 %or.cond77.i389, label %.critedge, label %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit361, !llvm.loop !60

bb.ah:                                            ; preds = %bb.f
  %i.ee = load i8, ptr %.11717481111, align 1, !tbaa !14 ; 2 uses
  %i.ef = icmp eq i8 %i.ee, 45                    ; 4 uses
  br i1 %i.ef, label %bb.ai, label %bb.aj

bb.ai:                                            ; preds = %bb.ah
  %i.eg = getelementptr inbounds nuw i8, ptr %.11717481111, i64 1 ; 2 uses
  %.pre.i422 = load i8, ptr %i.eg, align 1, !tbaa !14
  br label %bb.aj

bb.aj:                                            ; preds = %bb.ai, %bb.ah
  %i.eh = phi i8 [ %.pre.i422, %bb.ai ], [ %i.ee, %bb.ah ]
  %.0.i395 = phi ptr [ %i.eg, %bb.ai ], [ %.11717481111, %bb.ah ] ; 3 uses
  %i.ei = sext i8 %i.eh to i32
  %memchr95.i396 = call ptr @memchr(ptr noundef nonnull dereferenceable(1) @_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_17kDigitsE, i32 %i.ei, i64 11) ; 2 uses
  %.not7396.i397 = icmp eq ptr %memchr95.i396, null
  br i1 %.not7396.i397, label %select.unfold.i407, label %.lr.ph.i398

.lr.ph.i398:                                      ; preds = %bb.aj, %bb.am
  %memchr100.i399 = phi ptr [ %memchr.i405, %bb.am ], [ %memchr95.i396, %bb.aj ]
  %.199.i400 = phi ptr [ %i.es, %bb.am ], [ %.0.i395, %bb.aj ] ; 4 uses
  %.05397.i402 = phi i32 [ %i.er, %bb.am ], [ 0, %bb.aj ] ; 4 uses
  %i.ej = ptrtoint ptr %memchr100.i399 to i64
  %i.ek = trunc i64 %i.ej to i32
  %i.el = sub i32 %i.ek, ptrtoint (ptr @_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_17kDigitsE to i32) ; 3 uses
  %i.em = icmp sgt i32 %i.el, 9
  br i1 %i.em, label %select.unfold.i407, label %bb.ak

bb.ak:                                            ; preds = %.lr.ph.i398
end_hunk_0
...
bb.fy:                                            ; preds = %bb.fk, %bb.fo, %bb.fw, %bb.ex
  %.pn273 = phi { ptr, i32 } [ %i.up, %bb.ex ], [ %.pn268, %bb.fw ], [ %i.vq, %bb.fk ], [ %.pn, %bb.fo ]
  call void @llvm.lifetime.end.p0(ptr nonnull %13) #18
  br label %bb.fz

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEPKc.exit640: ; preds = %bb.es, %bb.er, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEPKc.exit642
  %.5 = phi i1 [ %.4, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEPKc.exit642 ], [ false, %bb.er ], [ false, %bb.es ]
  call void @llvm.lifetime.end.p0(ptr nonnull %12) #18
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEPKc.exit

bb.fz:                                            ; preds = %bb.fy, %bb.eg
  %.pn273.pn = phi { ptr, i32 } [ %.pn273, %bb.fy ], [ %i.qn, %bb.eg ]
  call void @llvm.lifetime.end.p0(ptr nonnull %12) #18
  br label %bb.ga

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEPKc.exit: ; preds = %.invoke, %bb.dx, %.thread, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEPKc.exit640, %bb.dz
  %.6 = phi i1 [ %.5, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEPKc.exit640 ], [ false, %.thread ], [ true, %bb.dz ], [ false, %bb.dx ], [ false, %.invoke ]
  %i.vy = load ptr, ptr %8, align 8, !tbaa !36    ; 2 uses
  %i.vz = icmp eq ptr %i.vy, %i.q
  br i1 %i.vz, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit647, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i645

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i645: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEPKc.exit
  %i.wa = load i64, ptr %i.q, align 8, !tbaa !14
  %i.wb = add i64 %i.wa, 1
  call void @_ZdlPvm(ptr noundef %i.vy, i64 noundef %i.wb) #20
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit647

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit647: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEPKc.exit, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i645
...
bb.ga:                                            ; preds = %bb.n, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit634, %bb.fz, %bb.dv
  %.pn297.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn273.pn, %bb.fz ], [ %i.pw, %bb.dv ], [ %i.bq, %bb.n ], [ %.pn297.pn.pn, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit634 ]
  %i.wc = load ptr, ptr %8, align 8, !tbaa !36    ; 2 uses
  %i.wd = icmp eq ptr %i.wc, %i.q
  br i1 %i.wd, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit650, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i648

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i648: ; preds = %bb.ga
  %i.we = load i64, ptr %i.q, align 8, !tbaa !14
  %i.wf = add i64 %i.we, 1
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit650: ; preds = %bb.ga, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i648
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #18
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #18
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #18
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #18
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %memchr95.i69 = tail call ptr @memchr(ptr noundef nonnull dereferenceable(1) @_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_17kDigitsE, i32 %i.ag, i64 11) ; 2 uses
...
.lr.ph.i71.peel:                                  ; preds = %bb.k
  ...
  %i.aj = sub i32 %i.ai, ptrtoint (ptr @_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_17kDigitsE to i32) ; 3 uses
...
.fold.split16.peel:                               ; preds = %bb.l
  ...
  %memchr.i78.peel = tail call ptr @memchr(ptr noundef nonnull dereferenceable(1) @_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_17kDigitsE, i32 %i.ao, i64 11) ; 2 uses
...
.lr.ph.i71.preheader.peel.newph:                  ; preds = %.fold.split16.peel
  ...
  %i.as = sub i32 %i.ar, ptrtoint (ptr @_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_17kDigitsE to i32) ; 3 uses
...
select.unfold.i80:                                ; preds = %.lr.ph.i71.preheader.peel.newph, %.lr.ph.i71.peel, %bb.l, %.fold.split16.peel, %select.unfold.i80.loopexit.loopexit.split.loop.exit65, %bb.k
  ...
  br i1 %or.cond80.i89, label %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit96.thread, label %bb.m
...
_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit96: ; preds = %bb.m
  %i.bc = ptrtoint ptr %.3.ph.i83 to i64
  %i.bd = ptrtoint ptr %.041 to i64
  %i.be = sub i64 %i.bc, %i.bd
  %i.bf = icmp eq i64 %i.be, 2
  br i1 %i.bf, label %bb.n, label %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit96.thread

bb.n:                                             ; preds = %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit96
...
bb.r:                                             ; preds = %bb.q, %bb.p
  ...
  %memchr95.i100 = tail call ptr @memchr(ptr noundef nonnull dereferenceable(1) @_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_17kDigitsE, i32 %i.bm, i64 11) ; 2 uses
...
.lr.ph.i102.peel:                                 ; preds = %bb.r
  ...
  %i.bp = sub i32 %i.bo, ptrtoint (ptr @_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_17kDigitsE to i32) ; 3 uses
...
.fold.split17.peel:                               ; preds = %bb.s
  ...
  %memchr.i109.peel = tail call ptr @memchr(ptr noundef nonnull dereferenceable(1) @_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_17kDigitsE, i32 %i.bu, i64 11) ; 2 uses
...
select.unfold.i111:                               ; preds = %.lr.ph.i102.preheader.peel.newph, %.lr.ph.i102.peel, %bb.s, %.fold.split17.peel, %select.unfold.i111.loopexit.loopexit.split.loop.exit81, %bb.r
  ...
  br i1 %or.cond80.i120, label %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit127, label %bb.t
