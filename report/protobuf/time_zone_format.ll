...
begin_hunk_0_@_ZN4absl12lts_2025051213time_internal4cctz6detail6formatERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERKNSt6chrono10time_pointINSC_3_V212system_clockENSC_8durationIlSt5ratioILl1ELl1EEEEEERKNSG_IlSH_ILl1ELl1000000000000000EEEERKNS2_9time_zoneE:bb.a
  ...
  %i.bz = load ptr, ptr %1, align 8, !tbaa !36    ; 4 uses
  %i.ca = load i64, ptr %i.o, align 8, !tbaa !11  ; 2 uses
...
.preheader:                                       ; preds = %.preheader.lr.ph, %.thread800
  %.0268999 = phi ptr [ %i.bz, %.preheader.lr.ph ], [ %.6274, %.thread800 ] ; 5 uses
...
bb.k:                                             ; preds = %bb.j
  %i.dj = getelementptr inbounds nuw i8, ptr %.1269989, i64 1 ; 3 uses
...
.critedge:                                        ; preds = %bb.k, %bb.j
  %.1269.lcssa = phi ptr [ %i.dj, %bb.k ], [ %.1269989, %bb.j ] ; 8 uses
...
bb.n:                                             ; preds = %.critedge
  %21 = ptrtoint ptr %.1269.lcssa to i64
  %22 = ptrtoint ptr %.0268999 to i64
  %i.dn = sub i64 %21, %22                        ; 2 uses
...
begin_hunk_4_@_ZN4absl12lts_2025051213time_internal4cctz6detail6formatERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERKNSt6chrono10time_pointINSC_3_V212system_clockENSC_8durationIlSt5ratioILl1ELl1EEEEEERKNSG_IlSH_ILl1ELl1000000000000000EEEERKNS2_9time_zoneE:bb.a
  ...
  br i1 %.not324990, label %.critedge2, label %.lr.ph

.lr.ph:                                           ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKcm.exit, %bb.p
  %.2270991 = phi ptr [ %i.du, %bb.p ], [ %.1269.lcssa, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKcm.exit ] ; 3 uses
  %i.ds = load i8, ptr %.2270991, align 1, !tbaa !14
  %i.dt = icmp eq i8 %i.ds, 37                    ; 3 uses
  br i1 %i.dt, label %bb.p, label %.critedge2

bb.p:                                             ; preds = %.lr.ph
  %i.du = getelementptr inbounds nuw i8, ptr %.2270991, i64 1 ; 3 uses
...
.critedge2:                                       ; preds = %.lr.ph, %bb.p, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKcm.exit
  %.2270.lcssa = phi ptr [ %.1269.lcssa, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKcm.exit ], [ %i.du, %bb.p ], [ %.2270991, %.lr.ph ] ; 42 uses
...
bb.w:                                             ; preds = %bb.v
  ...
  %23 = ptrtoint ptr %.1269.lcssa to i64
  %i.ev = sub i64 %i.eu, %23
  %i.ew = and i64 %i.ev, 1
