...
.lr.ph:                                           ; preds = %._crit_edge.i.i, %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit362
  %.1171.ph798 = phi ptr [ %.0170, %._crit_edge.i.i ], [ %.13, %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit362 ]
  %.0177.ph795 = phi i1 [ false, %._crit_edge.i.i ], [ %.3180, %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit362 ] ; 46 uses
  ...
  %.1171.ph798.fr = freeze ptr %.1171.ph798       ; 2 uses
...
.lr.ph1133:                                       ; preds = %.lr.ph, %select.unfold.backedge
  ...
  %.11717551130 = phi ptr [ %.1171.be, %select.unfold.backedge ], [ %.1171.ph798.fr, %.lr.ph ] ; 59 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ao = icmp eq i8 %i.an, %i.ab
  %cond.fr = freeze i1 %i.ao                      ; 2 uses
  %i.ap = getelementptr i8, ptr %.11717551130, i64 1
  %.2210.idx = zext i1 %cond.fr to i64
  %.2210 = getelementptr inbounds nuw i8, ptr %.02087541131, i64 %.2210.idx
  br i1 %cond.fr, label %select.unfold.backedge, label %.critedge
...
bb.ag:                                            ; preds = %select.unfold.i378
  ...
  %spec.select.i388 = select i1 %i.dv, i32 %.255.ph.i379, i32 %i.eo
  %spec.select.i388.fr = freeze i32 %spec.select.i388 ; 2 uses
  %or.cond77.i391 = icmp ugt i32 %spec.select.i388.fr, 53 ; 2 uses
  %spec.select696 = select i1 %or.cond77.i391, i32 %.0.ph787, i32 %spec.select.i388.fr ; 2 uses
...
bb.an:                                            ; preds = %select.unfold.i410
  ...
  %spec.select.i420 = select i1 %i.eq, i32 %.255.ph.i411, i32 %i.fj
  %spec.select.i420.fr = freeze i32 %spec.select.i420 ; 2 uses
  %or.cond77.i423 = icmp ugt i32 %spec.select.i420.fr, 53 ; 2 uses
  %spec.select698 = select i1 %or.cond77.i423, i32 %.0.ph787, i32 %spec.select.i420.fr ; 2 uses
...
_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_19ParseZoneEPKcPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit: ; preds = %.lr.ph.i587.a, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9push_backEc.exit.i, %bb.bz
  ...
  %.fr1067 = freeze i64 %i.kw
  %i.kx = icmp eq i64 %.fr1067, 0
...
select.unfold.i603:                               ; preds = %bb.ci, %bb.ch, %bb.cg, %.lr.ph.i595, %bb.cf
  ...
  %cond.fr945 = freeze i1 %or.cond79.i612         ; 3 uses
  %i.lt = sub nsw i64 0, %.255.ph.i604
  %spec.select.i613 = select i1 %i.kz, i64 %.255.ph.i604, i64 %i.lt
  %.2671 = select i1 %cond.fr945, i64 %.0669.ph786, i64 %spec.select.i613 ; 2 uses
  %not.or.cond79.i612 = xor i1 %cond.fr945, true
  %spec.select307 = select i1 %not.or.cond79.i612, i1 true, i1 %.0228.ph788 ; 2 uses
  br i1 %cond.fr945, label %.critedge, label %_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18ParseIntIiEEPKcS7_iT_S8_PS8_.exit362, !llvm.loop !60
...
bb.cp:                                            ; preds = %bb.f
  ...
  %.fr1066 = freeze i8 %i.mj
  %i.mk = icmp eq i8 %.fr1066, 37
...
bb.dd:                                            ; preds = %bb.dc
  ...
  %.2179 = select i1 %.not801, i1 true, i1 %.0177.ph795 ; 2 uses
