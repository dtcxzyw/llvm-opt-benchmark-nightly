...
.preheader:                                       ; preds = %.preheader.lr.ph, %.thread804
  ...
  %.026810031022 = ptrtoaddr ptr %.02681003 to i64
...
.critedge:                                        ; preds = %bb.k, %bb.j
  %.1269.lcssa = phi ptr [ %scevgep1023, %bb.k ], [ %.1269993, %bb.j ] ; 10 uses
  %.1269.lcssa1025 = ptrtoaddr ptr %.1269.lcssa to i64
...
bb.n:                                             ; preds = %.critedge
  ...
  %24 = ptrtoint ptr %.02681003 to i64
  %i.do = sub i64 %23, %24                        ; 2 uses
...
bb.v:                                             ; preds = %bb.u
  ...
  %25 = ptrtoint ptr %.1269.lcssa to i64
  %i.ex = sub i64 %i.ew, %25
  %i.ey = and i64 %i.ex, 1
...
_ZN4absl12lts_2025051213time_internal4cctz6detail12_GLOBAL__N_18Format64EPcil.exit688: ; preds = %._crit_edge.i679, %bb.el
  ...
  %.4.i6811028 = ptrtoaddr ptr %.4.i681 to i64
