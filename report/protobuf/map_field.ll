...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i.i:   ; preds = %bb.p, %.lr.ph.i.i.i
  %.033.i.i.i = phi i64 [ %i.cm, %.lr.ph.i.i.i ], [ %i.cy, %bb.p ]
  %.02132.i.i.i = phi ptr [ %i.ck, %.lr.ph.i.i.i ], [ %i.cw, %bb.p ]
  %i.cp = add i64 %.033.i.i.i, -27
  %i.cq = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02132.i.i.i, i32 noundef 71, i64 noundef %i.cp) #25 ; 4 uses
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i.i150: ; preds = %bb.ai, %.lr.ph.i.i.i149
  ...
  %i.gk = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02132.i.i.i152, i32 noundef 71, i64 noundef %i.gj) #25 ; 4 uses
