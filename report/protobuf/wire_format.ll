...
bb.d:                                             ; preds = %bb.b
  ...
  %i.aj = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.ai, i1 true)
...
bb.f:                                             ; preds = %bb.b
  ...
  %i.bf = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.be, i1 true)
  ...
  %i.bq = or i32 %i.bp, 1
  %i.br = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.bq, i1 true)
...
bb.g:                                             ; preds = %bb.b
  ...
  %i.cd = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.cc, i1 true)
...
bb.an:                                            ; preds = %_ZN6google8protobuf2io16CodedInputStream12ReadVarint32EPj.exit76.i, %.thread107.i
  ...
  %i.dm = call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.dl, i1 true)
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.de = or i32 %i.dd, 1
  %i.df = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.de, i1 true)
...
.lr.ph280:                                        ; preds = %.preheader230, %.lr.ph280
  ...
  %i.ds = or i64 %i.dr, 1
  %i.dt = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.ds, i1 true)
...
.lr.ph272:                                        ; preds = %.preheader234, %.lr.ph272
  ...
  %i.fj = or i64 %i.fi, 1
  %i.fk = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.fj, i1 true)
...
.lr.ph264:                                        ; preds = %.preheader238, %.lr.ph264
  ...
  %i.hc = or i32 %i.hb, 1
  %i.hd = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.hc, i1 true)
...
bb.af:                                            ; preds = %bb.ae
  ...
  %i.hs = or i32 %i.hr, 1
  %i.ht = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.hs, i1 true)
...
bb.ag:                                            ; preds = %bb.ae
  ...
  %i.ig = or i32 %i.if, 1
  %i.ih = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.ig, i1 true)
...
.lr.ph260:                                        ; preds = %.preheader240, %.lr.ph260
  ...
  %i.iw = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.iv, i1 true)
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %i.ji = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.jh, i1 true)
...
bb.an:                                            ; preds = %bb.am, %bb.al
  ...
  %i.kb = or i32 %i.ka, 1
  %i.kc = call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.kb, i1 true)
...
bb.at:                                            ; preds = %bb.as, %bb.ar
  ...
  %i.kw = or i32 %i.kv, 1
  %i.kx = call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.kw, i1 true)
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.cg = or i32 %i.cf, 1
  %i.ch = call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.cg, i1 true)
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.am = or i32 %i.al, 1
  %i.an = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.am, i1 true)
...
bb.a:
  ...
  %i.s = or i32 %i.r, 1
  %i.t = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.s, i1 true)
  %i.u = xor i32 %i.t, 31
...
bb.j:                                             ; preds = %bb.a
  ...
  %i.bf = or i32 %i.be, 1
  %i.bg = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.bf, i1 true)
...
bb.h:                                             ; preds = %bb.a
  ...
  %i.aj = or i32 %i.ai, 1
  %i.ak = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.aj, i1 true)
...
bb.j:                                             ; preds = %bb.a
  ...
  %i.bd = or i32 %i.bc, 1
  %i.be = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.bd, i1 true)
...
bb.k:                                             ; preds = %bb.a
  ...
  %i.bo = or i32 %i.bn, 1
  %i.bp = tail call noundef range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.bo, i1 true)
