...
vector.body145:                                   ; preds = %vector.body145, %vector.ph142
  ...
  %wide.load149.a = load <2 x ptr>, ptr %next.gep148, align 8, !tbaa !170, !alias.scope !323, !noalias !326
  %wide.load150.a = load <2 x ptr>, ptr %i.x, align 8, !tbaa !170, !alias.scope !323, !noalias !326
  %i.y = getelementptr i8, ptr %next.gep147.a, i64 16 ; 2 uses
  %wide.load151.a = load <2 x ptr>, ptr %next.gep147.a, align 8, !tbaa !170, !alias.scope !326
  %wide.load152 = load <2 x ptr>, ptr %i.y, align 8, !tbaa !170, !alias.scope !326
  store <2 x ptr> %wide.load151.a, ptr %next.gep148, align 8, !tbaa !170, !alias.scope !323, !noalias !326
  store <2 x ptr> %wide.load152, ptr %i.x, align 8, !tbaa !170, !alias.scope !323, !noalias !326
  store <2 x ptr> %wide.load149.a, ptr %next.gep147.a, align 8, !tbaa !170, !alias.scope !326
  store <2 x ptr> %wide.load150.a, ptr %i.y, align 8, !tbaa !170, !alias.scope !326
  %index.next153 = add nuw i64 %index146, 4       ; 2 uses
  %i.z = icmp eq i64 %index.next153, %n.vec144
  br i1 %i.z, label %middle.block154, label %vector.body145, !llvm.loop !328
...
.lr.ph99.prol:                                    ; preds = %.lr.ph99.preheader159, %.lr.ph99.prol
  ...
  br i1 %prol.iter.cmp.not.a, label %.lr.ph99.prol.loopexit, label %.lr.ph99.prol, !llvm.loop !338
