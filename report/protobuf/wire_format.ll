...
vector.body144:                                   ; preds = %vector.body144, %vector.ph141
  ...
  %wide.load151 = load <2 x ptr>, ptr %11, align 8, !tbaa !170, !alias.scope !344
  %wide.load152 = load <2 x ptr>, ptr %12, align 8, !tbaa !170, !alias.scope !344
  store <2 x ptr> %wide.load151, ptr %9, align 8, !tbaa !170, !alias.scope !341, !noalias !344
  store <2 x ptr> %wide.load152, ptr %10, align 8, !tbaa !170, !alias.scope !341, !noalias !344
  ...
  br i1 %13, label %middle.block160, label %vector.body144, !llvm.loop !346
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader191, %.lr.ph.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol, !llvm.loop !347
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  br i1 %exitcond.not.3, label %._crit_edge, label %.lr.ph, !llvm.loop !349
