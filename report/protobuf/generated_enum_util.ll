...
_ZSt9__advanceIPKN6google8protobuf8internal9EnumEntryElEvRT_T0_St26random_access_iterator_tag.exit.i.i: ; preds = %bb.a, %_ZN6google8protobuf8internal12_GLOBAL__N_117EnumCompareByNameERKNS1_9EnumEntryES5_.exit
  %.017.i.i = phi ptr [ %.1.i.i, %_ZN6google8protobuf8internal12_GLOBAL__N_117EnumCompareByNameERKNS1_9EnumEntryES5_.exit ], [ %0, %bb.a ] ; 2 uses
  %.01116.i.i = phi i64 [ %.112.i.i, %_ZN6google8protobuf8internal12_GLOBAL__N_117EnumCompareByNameERKNS1_9EnumEntryES5_.exit ], [ %1, %bb.a ] ; 2 uses
  %i.b = lshr i64 %.01116.i.i, 1                  ; 3 uses
  %i.c = getelementptr inbounds nuw [24 x i8], ptr %.017.i.i, i64 %i.b ; 3 uses
...
begin_hunk_1_@_ZN6google8protobuf8internal15LookUpEnumValueEPKNS1_9EnumEntryEmSt17basic_string_viewIcSt11char_traitsIcEEPi:bb.a
  ...
  %i.j = xor i64 %i.b, -1
  %i.k = add nsw i64 %.01116.i.i, %i.j
  %.112.i.i = select i1 %i.h, i64 %i.k, i64 %i.b  ; 2 uses
  %.1.i.i = select i1 %i.h, ptr %i.i, ptr %.017.i.i ; 2 uses
  %i.l = icmp sgt i64 %.112.i.i, 0
...
_ZSt11lower_boundIPKN6google8protobuf8internal9EnumEntryES3_PFbRS4_S6_EET_S9_S9_RKT0_T1_.exit: ; preds = %_ZN6google8protobuf8internal12_GLOBAL__N_117EnumCompareByNameERKNS1_9EnumEntryES5_.exit, %bb.a
  %.0.lcssa.i.i = phi ptr [ %0, %bb.a ], [ %.1.i.i, %_ZN6google8protobuf8internal12_GLOBAL__N_117EnumCompareByNameERKNS1_9EnumEntryES5_.exit ] ; 4 uses
...
_ZSt9__advanceIPKilEvRT_T0_St26random_access_iterator_tag.exit.i.i: ; preds = %bb.a, %.thread
  %.05.i.i = phi ptr [ %5, %.thread ], [ %1, %bb.a ] ; 3 uses
  %.0114.i.i = phi i64 [ %4, %.thread ], [ %2, %bb.a ] ; 2 uses
  %i.d = lshr i64 %.0114.i.i, 1                   ; 4 uses
  %i.e = getelementptr inbounds nuw [4 x i8], ptr %.05.i.i, i64 %i.d ; 2 uses
...
begin_hunk_3_@_ZN6google8protobuf8internal14LookUpEnumNameEPKNS1_9EnumEntryEPKimi:bb.a
  ...
  %i.m = xor i64 %i.d, -1
  %i.n = add nsw i64 %.0114.i.i, %i.m
  %spec.select = select i1 %i.k, i64 %i.n, i64 %i.d
  %spec.select23 = select i1 %i.k, ptr %i.l, ptr %.05.i.i
  br label %.thread
...
.thread:                                          ; preds = %"_ZN9__gnu_cxx5__ops14_Iter_comp_valIZN6google8protobuf8internal14LookUpEnumNameEPKNS4_9EnumEntryEPKimiE3$_0EclIS9_S8_EEbT_RT0_.exit.i.i", %_ZSt9__advanceIPKilEvRT_T0_St26random_access_iterator_tag.exit.i.i
  %4 = phi i64 [ %i.d, %_ZSt9__advanceIPKilEvRT_T0_St26random_access_iterator_tag.exit.i.i ], [ %spec.select, %"_ZN9__gnu_cxx5__ops14_Iter_comp_valIZN6google8protobuf8internal14LookUpEnumNameEPKNS4_9EnumEntryEPKimiE3$_0EclIS9_S8_EEbT_RT0_.exit.i.i" ] ; 2 uses
  %5 = phi ptr [ %.05.i.i, %_ZSt9__advanceIPKilEvRT_T0_St26random_access_iterator_tag.exit.i.i ], [ %spec.select23, %"_ZN9__gnu_cxx5__ops14_Iter_comp_valIZN6google8protobuf8internal14LookUpEnumNameEPKNS4_9EnumEntryEPKimiE3$_0EclIS9_S8_EEbT_RT0_.exit.i.i" ] ; 2 uses
...
"_ZSt11lower_boundIPKiiZN6google8protobuf8internal14LookUpEnumNameEPKNS4_9EnumEntryES1_miE3$_0ET_S9_S9_RKT0_T1_.exit": ; preds = %.thread, %bb.a
  %.0.lcssa.i.i = phi ptr [ %1, %bb.a ], [ %5, %.thread ] ; 3 uses
  %.not = icmp eq ptr %.0.lcssa.i.i, %i.a
...
._crit_edge:                                      ; preds = %_ZNSt6vectorIiSaIiEE9push_backERKi.exit
  %i.b = ptrtoint ptr %.sroa.17.2.a to i64        ; 5 uses
  ...
  %i.h = icmp eq ptr %.sroa.0142.2, %.sroa.16.2.a
...
.lr.ph310:                                        ; preds = %bb.a, %_ZNSt6vectorIiSaIiEE9push_backERKi.exit
  ...
  %.sroa.20.0306 = phi ptr [ %.sroa.20.1, %_ZNSt6vectorIiSaIiEE9push_backERKi.exit ], [ null, %bb.a ] ; 10 uses
  %.sroa.0142.0305 = phi ptr [ %.sroa.0142.2, %_ZNSt6vectorIiSaIiEE9push_backERKi.exit ], [ null, %bb.a ] ; 18 uses
  %.sroa.16.0304 = phi ptr [ %.sroa.16.2.a, %_ZNSt6vectorIiSaIiEE9push_backERKi.exit ], [ null, %bb.a ] ; 14 uses
  %.sroa.27.0303 = phi ptr [ %.sroa.27.2.a, %_ZNSt6vectorIiSaIiEE9push_backERKi.exit ], [ null, %bb.a ] ; 11 uses
  ...
  %.sroa.27.0204298 = phi ptr [ %.sroa.27.2206.a, %_ZNSt6vectorIiSaIiEE9push_backERKi.exit ], [ null, %bb.a ] ; 16 uses
  %.sroa.17.0297 = phi ptr [ %.sroa.17.2.a, %_ZNSt6vectorIiSaIiEE9push_backERKi.exit ], [ null, %bb.a ] ; 13 uses
...
bb.c:                                             ; preds = %bb.b
  %.not.i = icmp eq ptr %.sroa.13.0307, %.sroa.20.0306
...
bb.m:                                             ; preds = %bb.k
  %i.av = ptrtoint ptr %.sroa.16.0304 to i64
...
bb.r:                                             ; preds = %_ZNSt6vectorIjSaIjEE11_S_relocateEPjS2_S2_RS0_.exit.i
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.0186.0299, i64 noundef %i.bx) #17
...
_ZNSt6vectorIjSaIjEE6resizeEm.exit:               ; preds = %bb.t, %bb.s, %_ZNSt12_Vector_baseIjSaIjEE13_M_deallocateEPjm.exit36.i, %_ZSt6fill_nIPjmjET_S1_T0_RKT1_.exit.loopexit.i.i.i.i, %bb.p
  %.sroa.17.3.a = phi ptr [ %.sroa.17.0297, %bb.s ], [ %spec.select, %bb.t ], [ %i.bl, %bb.p ], [ %i.bo, %_ZSt6fill_nIPjmjET_S1_T0_RKT1_.exit.loopexit.i.i.i.i ], [ %i.by, %_ZNSt12_Vector_baseIjSaIjEE13_M_deallocateEPjm.exit36.i ]
  %.sroa.27.3207.a = phi ptr [ %.sroa.27.0204298, %bb.s ], [ %.sroa.27.0204298, %bb.t ], [ %.sroa.27.0204298, %bb.p ], [ %.sroa.27.0204298, %_ZSt6fill_nIPjmjET_S1_T0_RKT1_.exit.loopexit.i.i.i.i ], [ %i.bz, %_ZNSt12_Vector_baseIjSaIjEE13_M_deallocateEPjm.exit36.i ]
  ...
  %.not223294 = icmp eq ptr %.sroa.0142.0305, %.sroa.16.0304
...
_ZNSt6vectorIiSaIiEE5clearEv.exit:                ; preds = %.lr.ph, %_ZNSt6vectorIjSaIjEE6resizeEm.exit
  %spec.select222 = phi ptr [ %.sroa.16.0304, %_ZNSt6vectorIjSaIjEE6resizeEm.exit ], [ %.sroa.0142.0305, %.lr.ph ]
...
.loopexit225:                                     ; preds = %_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc.exit.i.i64, %_ZNKSt6vectorIjSaIjEE12_M_check_lenEmPKc.exit.i
  %.sroa.27.0303.lcssa332 = phi ptr [ %.sroa.16.0304, %_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc.exit.i.i64 ], [ %.sroa.27.0303, %_ZNKSt6vectorIjSaIjEE12_M_check_lenEmPKc.exit.i ]
...
begin_hunk_12_@_ZN6google8protobuf8internal16GenerateEnumDataEN4absl12lts_202505124SpanIKiEE:bb.a
  ...
  %.not223 = icmp eq ptr %i.cs, %.sroa.16.0304
  br i1 %.not223, label %_ZNSt6vectorIiSaIiEE5clearEv.exit, label %.lr.ph

bb.u:                                             ; preds = %bb.m
  %.not.i63 = icmp eq ptr %.sroa.16.0304, %.sroa.27.0303
  br i1 %.not.i63, label %bb.w, label %bb.v

bb.v:                                             ; preds = %bb.u
  store i32 %i.i, ptr %.sroa.16.0304, align 4, !tbaa !3
  %i.ct = getelementptr inbounds nuw i8, ptr %.sroa.16.0304, i64 4
  br label %_ZNSt6vectorIiSaIiEE9push_backERKi.exit
...
_ZNSt6vectorIiSaIiEE9push_backERKi.exit:          ; preds = %bb.l, %_ZNSt6vectorIiSaIiEE5clearEv.exit, %bb.v, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i69, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i, %bb.d, %bb.j, %_ZNSt8optionalIsEaSIRiEENSt9enable_ifIX7__and_vISt6__not_ISt7is_sameIS0_NSt9remove_cvINSt16remove_referenceIT_E4typeEE4typeEEES4_ISt6__and_IJSt9is_scalarIsES5_IsNSt5decayIS8_E4typeEEEEESt16is_constructibleIsJS8_EESt13is_assignableIRsS8_EEERS0_E4typeEOS8_.exit
  ...
  %.sroa.20.1 = phi ptr [ %.sroa.20.0306, %bb.j ], [ %i.aa, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i ], [ %.sroa.20.0306, %_ZNSt8optionalIsEaSIRiEENSt9enable_ifIX7__and_vISt6__not_ISt7is_sameIS0_NSt9remove_cvINSt16remove_referenceIT_E4typeEE4typeEEES4_ISt6__and_IJSt9is_scalarIsES5_IsNSt5decayIS8_E4typeEEEEESt16is_constructibleIsJS8_EESt13is_assignableIRsS8_EEERS0_E4typeEOS8_.exit ], [ %.sroa.20.0306, %bb.d ], [ %.sroa.20.0306, %bb.l ], [ %.sroa.20.0306, %_ZNSt6vectorIiSaIiEE5clearEv.exit ], [ %.sroa.20.0306, %bb.v ], [ %.sroa.20.0306, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i69 ] ; 7 uses
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %i.dl = ptrtoint ptr %.sroa.16.2.a to i64       ; 2 uses
...
begin_hunk_14_@_ZN6google8protobuf8internal16GenerateEnumDataEN4absl12lts_202505124SpanIKiEE:bb.a
  ...
  %i.ec = icmp ne ptr %.sroa.010.1.i.i, %.sroa.16.2.a
...
_ZNSt6vectorIiSaIiEEaSEOS1_.exit:                 ; preds = %bb.a, %bb.aj, %bb.ai, %bb.ah, %bb.aa, %._crit_edge
  ...
  %.sroa.27.0204.lcssa379 = phi ptr [ %.sroa.27.2206.a, %bb.aa ], [ %.sroa.27.2206.a, %._crit_edge ], [ %.sroa.27.2206.a, %bb.ah ], [ %.sroa.27.2206.a, %bb.ai ], [ %.sroa.27.2206.a, %bb.aj ], [ null, %bb.a ] ; 3 uses
  %.sroa.17.0.lcssa378 = phi i64 [ %i.b, %bb.aa ], [ %i.b, %._crit_edge ], [ %i.b, %bb.ah ], [ %i.b, %bb.ai ], [ %i.b, %bb.aj ], [ 0, %bb.a ]
  %.sroa.27.3.a = phi ptr [ null, %bb.aa ], [ %.sroa.27.2.a, %._crit_edge ], [ %.sroa.27.2.a, %bb.ah ], [ %.sroa.27.2.a, %bb.ai ], [ %.sroa.27.2.a, %bb.aj ], [ null, %bb.a ] ; 3 uses
  ...
  %.sroa.18.0 = phi ptr [ %.sroa.16.2.a, %bb.aa ], [ %.sroa.13.1, %._crit_edge ], [ %.sroa.18.1, %bb.ah ], [ %.sroa.18.1, %bb.ai ], [ %.sroa.18.1, %bb.aj ], [ null, %bb.a ]
  %.sroa.29.0 = phi ptr [ %.sroa.27.2.a, %bb.aa ], [ %.sroa.20.1, %._crit_edge ], [ %.sroa.18.1, %bb.ah ], [ %.sroa.18.1, %bb.ai ], [ %.sroa.18.1, %bb.aj ], [ null, %bb.a ] ; 2 uses
...
bb.am:                                            ; preds = %_ZNSt12_Vector_baseIjSaIjEEC2EmRKS0_.exit.thread.i
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 4 %i.fo, ptr align 4 %.sroa.0186.0.lcssa381, i64 %i.eq, i1 false)
  br label %bb.aq
...
bb.ao:                                            ; preds = %bb.an
  %i.fr = load i32, ptr %.sroa.0186.0.lcssa381, align 4, !tbaa !3
...
_ZNSt6vectorIiSaIiEED2Ev.exit:                    ; preds = %bb.ar, %bb.as
  %.not.i.i.i81 = icmp eq ptr %.sroa.0186.0.lcssa381, null
  br i1 %.not.i.i.i81, label %_ZNSt6vectorIjSaIjEED2Ev.exit, label %bb.at

bb.at:                                            ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit
  %i.ga = ptrtoint ptr %.sroa.27.0204.lcssa379 to i64
  %i.gb = sub i64 %i.ga, %i.ep
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0186.0.lcssa381, i64 noundef %i.gb) #17
...
bb.au:                                            ; preds = %_ZNSt6vectorIjSaIjEED2Ev.exit
  %i.gc = ptrtoint ptr %.sroa.27.3.a to i64
...
bb.av:                                            ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit83
  %i.gf = ptrtoint ptr %.sroa.20.2 to i64
...
_ZNSt6vectorIiSaIiEED2Ev.exit89:                  ; preds = %.loopexit225, %.loopexit.split-lp226, %.loopexit, %.loopexit.split-lp, %bb.ax, %bb.aw, %.thread
  %.sroa.27.0204286 = phi ptr [ %.sroa.27.2206.a, %.thread ], [ %.sroa.27.0204.lcssa379, %bb.ax ], [ %.sroa.27.0204.lcssa379, %bb.aw ], [ %.sroa.27.0204298, %.loopexit.split-lp ], [ %.sroa.27.0204298, %.loopexit ], [ %.sroa.27.0204298, %.loopexit225 ], [ %.sroa.27.0204298, %.loopexit.split-lp226 ]
  %.sroa.0186.0278 = phi ptr [ %.sroa.0186.2, %.thread ], [ %.sroa.0186.0.lcssa381, %bb.ax ], [ %.sroa.0186.0.lcssa381, %bb.aw ], [ %.sroa.0186.0299, %.loopexit.split-lp ], [ %.sroa.0186.0299, %.loopexit ], [ %.sroa.0186.0299, %.loopexit225 ], [ %.sroa.0186.0299, %.loopexit.split-lp226 ] ; 3 uses
  %.sroa.27.5.a = phi ptr [ %.sroa.27.2.a, %.thread ], [ %.sroa.27.3.a, %bb.ax ], [ %.sroa.27.3.a, %bb.aw ], [ %.sroa.27.0303, %.loopexit.split-lp ], [ %.sroa.27.0303, %.loopexit ], [ %.sroa.27.0303.lcssa332, %.loopexit225 ], [ %.sroa.16.0304, %.loopexit.split-lp226 ]
  ...
  %.sroa.20.4 = phi ptr [ %.sroa.20.1, %.thread ], [ %.sroa.20.2, %bb.ax ], [ %.sroa.20.2, %bb.aw ], [ %.sroa.13.0307, %.loopexit.split-lp ], [ %.sroa.13.0307, %.loopexit ], [ %.sroa.20.0306, %.loopexit225 ], [ %.sroa.20.0306, %.loopexit.split-lp226 ]
  ...
  %.not.i.i.i90 = icmp eq ptr %.sroa.0186.0278, null
  br i1 %.not.i.i.i90, label %_ZNSt6vectorIjSaIjEED2Ev.exit91, label %bb.ay

bb.ay:                                            ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit89
  %i.go = ptrtoint ptr %.sroa.27.0204286 to i64
  %i.gp = ptrtoint ptr %.sroa.0186.0278 to i64
  %i.gq = sub i64 %i.go, %i.gp
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0186.0278, i64 noundef %i.gq) #17
...
bb.az:                                            ; preds = %_ZNSt6vectorIjSaIjEED2Ev.exit91
  %i.gr = ptrtoint ptr %.sroa.27.5.a to i64
...
bb.ba:                                            ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit93
  %i.gu = ptrtoint ptr %.sroa.20.4 to i64
