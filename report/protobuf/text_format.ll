...
.lr.ph.i.preheader:                               ; preds = %bb.c
  ...
  %min.iters.check141 = icmp ult i64 %i.m, 120
  br i1 %min.iters.check141, label %.lr.ph.i.preheader158, label %vector.memcheck134.a

vector.memcheck134.a:                             ; preds = %.lr.ph.i.preheader
  %i.p = add i64 %i.g, -8
  %i.q = sub i64 %i.p, %i.d
  %i.r = and i64 %i.q, -8
  %i.s = add i64 %i.r, 8                          ; 2 uses
  %scevgep135.a = getelementptr i8, ptr %0, i64 %i.s
  %scevgep136 = getelementptr i8, ptr %1, i64 %i.s
  %bound0137 = icmp ult ptr %0, %scevgep136
  %bound1138 = icmp ult ptr %1, %scevgep135.a
  %found.conflict139 = and i1 %bound0137, %bound1138
  br i1 %found.conflict139, label %.lr.ph.i.preheader158, label %vector.ph142

vector.ph142:                                     ; preds = %vector.memcheck134.a
  %n.vec144 = and i64 %i.o, 4611686018427387900   ; 3 uses
  %i.t = shl i64 %n.vec144, 3                     ; 2 uses
...
vector.body145:                                   ; preds = %vector.body145, %vector.ph142
  ...
  %i.w = shl i64 %index146, 3                     ; 2 uses
  %next.gep147.a = getelementptr i8, ptr %1, i64 %i.w ; 3 uses
  %next.gep148 = getelementptr i8, ptr %0, i64 %i.w ; 3 uses
  %i.x = getelementptr i8, ptr %next.gep148, i64 16 ; 2 uses
  %wide.load149.a = load <2 x ptr>, ptr %next.gep148, align 8, !tbaa !506, !alias.scope !946, !noalias !949
  %wide.load150.a = load <2 x ptr>, ptr %i.x, align 8, !tbaa !506, !alias.scope !946, !noalias !949
  %i.y = getelementptr i8, ptr %next.gep147.a, i64 16 ; 2 uses
  %wide.load151.a = load <2 x ptr>, ptr %next.gep147.a, align 8, !tbaa !506, !alias.scope !949
  %wide.load152 = load <2 x ptr>, ptr %i.y, align 8, !tbaa !506, !alias.scope !949
  store <2 x ptr> %wide.load151.a, ptr %next.gep148, align 8, !tbaa !506, !alias.scope !946, !noalias !949
  store <2 x ptr> %wide.load152, ptr %i.x, align 8, !tbaa !506, !alias.scope !946, !noalias !949
  store <2 x ptr> %wide.load149.a, ptr %next.gep147.a, align 8, !tbaa !506, !alias.scope !949
  store <2 x ptr> %wide.load150.a, ptr %i.y, align 8, !tbaa !506, !alias.scope !949
  %index.next153 = add nuw i64 %index146, 4       ; 2 uses
  %i.z = icmp eq i64 %index.next153, %n.vec144
  br i1 %i.z, label %middle.block154, label %vector.body145, !llvm.loop !951

middle.block154:                                  ; preds = %vector.body145
  %cmp.n155 = icmp eq i64 %i.o, %n.vec144
  br i1 %cmp.n155, label %_ZSt11swap_rangesIN9__gnu_cxx17__normal_iteratorIPPKN6google8protobuf7MessageESt6vectorIS6_SaIS6_EEEESB_ET0_T_SD_SC_.exit, label %.lr.ph.i.preheader158

.lr.ph.i.preheader158:                            ; preds = %vector.memcheck134.a, %.lr.ph.i.preheader, %middle.block154
  %.sroa.0.08.i.ph = phi ptr [ %1, %vector.memcheck134.a ], [ %1, %.lr.ph.i.preheader ], [ %i.u, %middle.block154 ]
  %.sroa.04.07.i.ph = phi ptr [ %0, %vector.memcheck134.a ], [ %0, %.lr.ph.i.preheader ], [ %i.v, %middle.block154 ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader158, %.lr.ph.i
  %.sroa.0.08.i = phi ptr [ %i.ad, %.lr.ph.i ], [ %.sroa.0.08.i.ph, %.lr.ph.i.preheader158 ] ; 3 uses
  %.sroa.04.07.i = phi ptr [ %i.ac, %.lr.ph.i ], [ %.sroa.04.07.i.ph, %.lr.ph.i.preheader158 ] ; 3 uses
...
.lr.ph99.preheader:                               ; preds = %bb.g
  ...
  br i1 %min.iters.check, label %.lr.ph99.preheader159, label %vector.memcheck
...
vector.memcheck:                                  ; preds = %.lr.ph99.preheader
  ...
  br i1 %found.conflict, label %.lr.ph99.preheader159, label %vector.ph
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge100, label %.lr.ph99.preheader159

.lr.ph99.preheader159:                            ; preds = %vector.memcheck, %.lr.ph99.preheader, %middle.block
  ...
  %i.az = sub i64 %.0, %.084
  %xtraiter167 = and i64 %i.az, 3                 ; 2 uses
  %lcmp.mod168.not = icmp eq i64 %xtraiter167, 0
  br i1 %lcmp.mod168.not, label %.lr.ph99.prol.loopexit, label %.lr.ph99.prol

.lr.ph99.prol:                                    ; preds = %.lr.ph99.preheader159, %.lr.ph99.prol
  %.02897.prol = phi i64 [ %i.be, %.lr.ph99.prol ], [ %.02897.ph, %.lr.ph99.preheader159 ]
  %.sroa.041.196.prol = phi ptr [ %i.bc, %.lr.ph99.prol ], [ %.sroa.041.196.ph, %.lr.ph99.preheader159 ] ; 3 uses
  %.sroa.038.095.prol = phi ptr [ %i.bd, %.lr.ph99.prol ], [ %.sroa.038.095.ph, %.lr.ph99.preheader159 ] ; 3 uses
  %prol.iter.a = phi i64 [ %prol.iter.next.a, %.lr.ph99.prol ], [ 0, %.lr.ph99.preheader159 ]
  ...
  %prol.iter.cmp.not.a = icmp eq i64 %prol.iter.next.a, %xtraiter167
  br i1 %prol.iter.cmp.not.a, label %.lr.ph99.prol.loopexit, label %.lr.ph99.prol, !llvm.loop !959

.lr.ph99.prol.loopexit:                           ; preds = %.lr.ph99.prol, %.lr.ph99.preheader159
  %.lcssa.unr = phi ptr [ poison, %.lr.ph99.preheader159 ], [ %i.bc, %.lr.ph99.prol ]
  %.02897.unr = phi i64 [ %.02897.ph, %.lr.ph99.preheader159 ], [ %i.be, %.lr.ph99.prol ]
  %.sroa.041.196.unr = phi ptr [ %.sroa.041.196.ph, %.lr.ph99.preheader159 ], [ %i.bc, %.lr.ph99.prol ]
  %.sroa.038.095.unr = phi ptr [ %.sroa.038.095.ph, %.lr.ph99.preheader159 ], [ %i.bd, %.lr.ph99.prol ]
...
vector.body144:                                   ; preds = %vector.body144, %.lr.ph.preheader.new
  ...
  %wide.load148 = load <2 x ptr>, ptr %9, align 8, !tbaa !506, !alias.scope !961, !noalias !964
  %wide.load149 = load <2 x ptr>, ptr %10, align 8, !tbaa !506, !alias.scope !961, !noalias !964
  %11 = getelementptr inbounds i8, ptr %next.gep146, i64 -16 ; 2 uses
  %12 = getelementptr inbounds i8, ptr %next.gep146, i64 -32 ; 2 uses
  %wide.load150 = load <2 x ptr>, ptr %11, align 8, !tbaa !506, !alias.scope !964
  %wide.load151 = load <2 x ptr>, ptr %12, align 8, !tbaa !506, !alias.scope !964
  store <2 x ptr> %wide.load150, ptr %9, align 8, !tbaa !506, !alias.scope !961, !noalias !964
  store <2 x ptr> %wide.load151, ptr %10, align 8, !tbaa !506, !alias.scope !961, !noalias !964
  store <2 x ptr> %wide.load148, ptr %11, align 8, !tbaa !506, !alias.scope !964
  store <2 x ptr> %wide.load149, ptr %12, align 8, !tbaa !506, !alias.scope !964
  %index.next152 = add nuw i64 %index145, 4       ; 2 uses
  %13 = icmp eq i64 %index.next152, %unroll_iter
  br i1 %13, label %._crit_edge.loopexit.unr-lcssa, label %vector.body144, !llvm.loop !966
...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil.preheader, %.lr.ph.epil
  ...
  %i.ct = load ptr, ptr %i.cr, align 8, !tbaa !506
  store ptr %i.ct, ptr %i.cq, align 8, !tbaa !506
  store ptr %i.cs, ptr %i.cr, align 8, !tbaa !506
  %14 = add nuw nsw i64 %.02794.prol, 1           ; 2 uses
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %.lr.ph.prol.loopexit, label %.lr.ph.epil, !llvm.loop !967
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  %i.cy = load ptr, ptr %i.cw, align 8, !tbaa !506
  store ptr %i.cy, ptr %i.cv, align 8, !tbaa !506
  store ptr %i.cx, ptr %i.cw, align 8, !tbaa !506
  ...
  %i.dc = load ptr, ptr %i.da, align 8, !tbaa !506
  store ptr %i.dc, ptr %i.cz, align 8, !tbaa !506
  ...
  %i.dg = load ptr, ptr %i.de, align 8, !tbaa !506
  store ptr %i.dg, ptr %i.dd, align 8, !tbaa !506
  store ptr %i.df, ptr %i.de, align 8, !tbaa !506
  ...
  %i.dk = load ptr, ptr %i.di, align 8, !tbaa !506
  store ptr %i.dk, ptr %i.dh, align 8, !tbaa !506
  store ptr %i.dj, ptr %i.di, align 8, !tbaa !506
  %niter.next.3 = add nuw nsw i64 %.02794, 4      ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %.084
  br i1 %niter.ncmp.3, label %._crit_edge, label %.lr.ph, !llvm.loop !969
