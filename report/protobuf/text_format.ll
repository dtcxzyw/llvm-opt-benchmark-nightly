...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.af, 4611686018427387900     ; 4 uses
  %i.ak = shl i64 %n.vec, 3
  %i.al = getelementptr i8, ptr %i.aa, i64 %i.ak  ; 2 uses
  %3 = shl i64 %n.vec, 3
  %i.am = getelementptr i8, ptr %i.p, i64 %3
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %offset.idx8 = shl i64 %index, 3
  %next.gep9 = getelementptr i8, ptr %i.p, i64 %offset.idx8 ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %offset.idx376 = shl i64 %index, 3
  %next.gep377 = getelementptr i8, ptr %i.bf, i64 %offset.idx376 ; 4 uses
...
vector.ph390:                                     ; preds = %vector.memcheck380
  %n.vec392 = and i64 %i.eg, 4611686018427387900  ; 4 uses
  %i.ek = shl i64 %n.vec392, 3
  %i.el = getelementptr i8, ptr %i.ea, i64 %i.ek  ; 2 uses
  %8 = shl i64 %n.vec392, 3
  %i.em = getelementptr i8, ptr %i.dp, i64 %8
  br label %vector.body393

vector.body393:                                   ; preds = %vector.body393, %vector.ph390
  %index394 = phi i64 [ 0, %vector.ph390 ], [ %index.next401, %vector.body393 ] ; 3 uses
  %offset.idx395 = shl i64 %index394, 3
  %next.gep396 = getelementptr i8, ptr %i.ea, i64 %offset.idx395 ; 2 uses
  %offset.idx397 = shl i64 %index394, 3
  %next.gep398 = getelementptr i8, ptr %i.dp, i64 %offset.idx397 ; 4 uses
