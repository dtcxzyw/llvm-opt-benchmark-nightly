...
.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph24.i
  ...
  %.lcssa99.unr = phi ptr [ poison, %.lr.ph24.i ], [ %11, %.prol.preheader ]
...
_ZN4absl12lts_2025051213cord_internal12_GLOBAL__N_115StackOperationsILNS1_12CordRepBtree8EdgeTypeE1EE10BuildStackEPS4_i.exit: ; preds = %.prol.loopexit, %.lr.ph24.i.new, %.critedge.thread.i, %.critedge.i
  ...
  %.115.lcssa.i = phi ptr [ %.014.lcssa.i, %.critedge.i ], [ %i.t, %.critedge.thread.i ], [ %.lcssa99.unr, %.prol.loopexit ], [ %i.ao, %.lr.ph24.i.new ] ; 6 uses
...
vector.body89:                                    ; preds = %vector.body89, %vector.ph86
  ...
  br i1 %i.dm, label %middle.block94, label %vector.body89, !llvm.loop !115
...
vector.body152:                                   ; preds = %vector.body152, %vector.ph149
  ...
  br i1 %i.aq, label %middle.block156, label %vector.body152, !llvm.loop !129
...
scalar.ph147:                                     ; preds = %scalar.ph147.preheader, %scalar.ph147
  ...
  br i1 %exitcond.not.i.i.i, label %_ZN4absl12lts_2025051213cord_internal12CordRepBtree3AddILNS2_8EdgeTypeE1EEEvPNS1_7CordRepE.exit.i.loopexit, label %scalar.ph147, !llvm.loop !130
