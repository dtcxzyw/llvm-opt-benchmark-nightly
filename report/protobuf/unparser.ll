...
.lr.ph.i53:                                       ; preds = %bb.dx, %.lr.ph.i53
  %.0115.i = phi i64 [ %i.pv, %.lr.ph.i53 ], [ 9, %bb.dx ]
  %.0112114.i = phi i32 [ %i.pu, %.lr.ph.i53 ], [ %i.pr, %bb.dx ]
  %i.pu = udiv i32 %.0112114.i, 1000              ; 3 uses
  %i.pv = add i64 %.0115.i, -3                    ; 2 uses
...
._crit_edge.i50:                                  ; preds = %.lr.ph.i53, %bb.dx
  %.0112.lcssa.i = phi i32 [ %i.pr, %bb.dx ], [ %i.pu, %.lr.ph.i53 ]
  %.0.lcssa.i = phi i64 [ 9, %bb.dx ], [ %i.pv, %.lr.ph.i53 ]
...
begin_hunk_1_@_ZN6google8protobuf13json_internal12_GLOBAL__N_112WriteMessageINS1_23UnparseProto2DescriptorEEEN4absl12lts_202505126StatusERNS1_10JsonWriterERKNT_3MsgERKNSA_4DescEb:bb.a
  ...
  %i.qk = inttoptr i64 %.0.lcssa.i to ptr
...
.lr.ph.i54:                                       ; preds = %bb.dn, %.lr.ph.i54
  %.0109.i = phi i64 [ %i.ru, %.lr.ph.i54 ], [ 9, %bb.dn ]
  %.0106108.i = phi i32 [ %i.rt, %.lr.ph.i54 ], [ %i.rq, %bb.dn ]
  %i.rt = udiv i32 %.0106108.i, 1000              ; 3 uses
  %i.ru = add i64 %.0109.i, -3                    ; 2 uses
...
._crit_edge.i51:                                  ; preds = %.lr.ph.i54, %bb.dn
  %.0106.lcssa.i = phi i32 [ %i.rq, %bb.dn ], [ %i.rt, %.lr.ph.i54 ]
  %.0.lcssa.i = phi i64 [ 9, %bb.dn ], [ %i.ru, %.lr.ph.i54 ]
...
begin_hunk_3_@_ZN6google8protobuf13json_internal12_GLOBAL__N_112WriteMessageINS1_17UnparseProto3TypeEEEN4absl12lts_202505126StatusERNS1_10JsonWriterERKNT_3MsgERKNSA_4DescEb:bb.a
  ...
  %i.sj = inttoptr i64 %.0.lcssa.i to ptr
...
.lr.ph.i.i.i.i.i:                                 ; preds = %bb.c, %_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPPKN6google8protobuf13json_internal12ResolverPool5FieldESt6vectorIS8_SaIS8_EEEESD_ET0_T_SF_SE_.exit.i.i.i.i.i
  ...
  %.pn20.i.i.i.i.i = phi ptr [ %.sroa.0.021.i.ptr.i.i.i.i, %_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPPKN6google8protobuf13json_internal12ResolverPool5FieldESt6vectorIS8_SaIS8_EEEESD_ET0_T_SF_SE_.exit.i.i.i.i.i ], [ %.sroa.0132.1, %bb.c ] ; 3 uses
  %.sroa.0.021.i.ptr.i.i.i.i = getelementptr inbounds nuw i8, ptr %.sroa.0132.1, i64 %.sroa.0.021.i.idx.i.i.i.i ; 4 uses
  %.val.i.i.i.i.i.i = load ptr, ptr %.sroa.0.021.i.ptr.i.i.i.i, align 8, !tbaa !413 ; 2 uses
  %.val1.i.i.i.i.i.i = load ptr, ptr %.sroa.0132.1, align 8, !tbaa !413 ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep.i.i.i.i, ptr noundef nonnull align 8 dereferenceable(1) %.sroa.0132.1, i64 %.sroa.0.021.i.idx.i.i.i.i, i1 false)
...
_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPPKN6google8protobuf13json_internal12ResolverPool5FieldESt6vectorIS8_SaIS8_EEEESD_ET0_T_SF_SE_.exit.i.i.i.i.i: ; preds = %.lr.ph.i.i.i.i.i.i, %bb.g, %bb.f, %bb.e
  %.sink.i.i.i.i.i = phi ptr [ %.sroa.0132.1, %bb.f ], [ %.sroa.0132.1, %bb.e ], [ %.sroa.0.021.i.ptr.i.i.i.i, %bb.g ], [ %.sroa.0.012.i.i.i.i.i.i, %.lr.ph.i.i.i.i.i.i ]
...
_ZSt16__insertion_sortIN9__gnu_cxx17__normal_iteratorIPPKN6google8protobuf13json_internal12ResolverPool5FieldESt6vectorIS8_SaIS8_EEEENS0_5__ops15_Iter_comp_iterIZNS4_12_GLOBAL__N_111WriteFieldsINS4_17UnparseProto3TypeEEEN4absl12lts_202505126StatusERNS4_10JsonWriterERKNT_3MsgERKNSO_4DescERbEUlRKSO_RKT0_E_EEEvSO_SO_SY_.exit.i.i.i.i: ; preds = %_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPPKN6google8protobuf13json_internal12ResolverPool5FieldESt6vectorIS8_SaIS8_EEEESD_ET0_T_SF_SE_.exit.i.i.i.i.i
  %i.al = getelementptr inbounds nuw i8, ptr %.sroa.0132.1, i64 128 ; 2 uses
...
.lr.ph.i30.i.i.i.i:                               ; preds = %bb.h, %_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPPKN6google8protobuf13json_internal12ResolverPool5FieldESt6vectorIS8_SaIS8_EEEESD_ET0_T_SF_SE_.exit.i42.i.i.i.i
  ...
  %.pn20.i32.i.i.i.i = phi ptr [ %.sroa.0.021.i31.i.i.i.i, %_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPPKN6google8protobuf13json_internal12ResolverPool5FieldESt6vectorIS8_SaIS8_EEEESD_ET0_T_SF_SE_.exit.i42.i.i.i.i ], [ %.sroa.0132.1, %bb.h ] ; 4 uses
  %.val.i.i33.i.i.i.i = load ptr, ptr %.sroa.0.021.i31.i.i.i.i, align 8, !tbaa !413 ; 2 uses
  %.val1.i.i34.i.i.i.i = load ptr, ptr %.sroa.0132.1, align 8, !tbaa !413 ; 2 uses
...
begin_hunk_8_@_ZN6google8protobuf13json_internal12_GLOBAL__N_111WriteFieldsINS1_17UnparseProto3TypeEEEN4absl12lts_202505126StatusERNS1_10JsonWriterERKNT_3MsgERKNSA_4DescERb:bb.a
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.bh, ptr noundef nonnull align 8 dereferenceable(1) %.sroa.0132.1, i64 %i.bc, i1 false)
...
_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPPKN6google8protobuf13json_internal12ResolverPool5FieldESt6vectorIS8_SaIS8_EEEESD_ET0_T_SF_SE_.exit.i42.i.i.i.i: ; preds = %.lr.ph.i.i46.i.i.i.i, %bb.m, %bb.l, %bb.k, %bb.j
  %.sink.i43.i.i.i.i = phi ptr [ %.sroa.0132.1, %bb.l ], [ %.sroa.0132.1, %bb.j ], [ %.sroa.0132.1, %bb.k ], [ %.sroa.0.021.i31.i.i.i.i, %bb.m ], [ %.sroa.0.012.i.i48.i.i.i.i, %.lr.ph.i.i46.i.i.i.i ]
...
bb.n:                                             ; preds = %.lr.ph, %_ZNSt6vectorIPKN6google8protobuf13json_internal12ResolverPool5FieldESaIS6_EE9push_backERKS6_.exit
  ...
  %.sroa.0132.0200 = phi ptr [ %i.n, %.lr.ph ], [ %.sroa.0132.1, %_ZNSt6vectorIPKN6google8protobuf13json_internal12ResolverPool5FieldESaIS6_EE9push_backERKS6_.exit ] ; 11 uses
  %.sroa.12.0199 = phi ptr [ %i.n, %.lr.ph ], [ %.sroa.12.1, %_ZNSt6vectorIPKN6google8protobuf13json_internal12ResolverPool5FieldESaIS6_EE9push_backERKS6_.exit ] ; 9 uses
  %.sroa.19.0198 = phi ptr [ %i.o, %.lr.ph ], [ %.sroa.19.1.a, %_ZNSt6vectorIPKN6google8protobuf13json_internal12ResolverPool5FieldESaIS6_EE9push_backERKS6_.exit ] ; 7 uses
...
.loopexit181:                                     ; preds = %bb.o, %_ZNKSt6vectorIPKN6google8protobuf13json_internal12ResolverPool5FieldESaIS6_EE12_M_check_lenEmPKc.exit.i.i
  %.sroa.19.0198.lcssa208 = phi ptr [ %.sroa.19.0198, %bb.o ], [ %.sroa.12.0199, %_ZNKSt6vectorIPKN6google8protobuf13json_internal12ResolverPool5FieldESaIS6_EE12_M_check_lenEmPKc.exit.i.i ]
...
_ZN6google8protobuf13json_internal10Proto3Type18IsImplicitPresenceEPKNS1_12ResolverPool5FieldE.exit.thread: ; preds = %bb.s, %bb.p, %_ZN6google8protobuf13json_internal10Proto3Type18IsImplicitPresenceEPKNS1_12ResolverPool5FieldE.exit, %bb.u
  %.not.i = icmp eq ptr %.sroa.12.0199, %.sroa.19.0198
...
bb.w:                                             ; preds = %_ZN6google8protobuf13json_internal10Proto3Type18IsImplicitPresenceEPKNS1_12ResolverPool5FieldE.exit.thread
  %i.cs = ptrtoint ptr %.sroa.12.0199 to i64
  %i.ct = ptrtoint ptr %.sroa.0132.0200 to i64
...
bb.y:                                             ; preds = %.noexc44
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.dc, ptr align 8 %.sroa.0132.0200, i64 %i.cu, i1 false)
...
_ZNSt6vectorIPKN6google8protobuf13json_internal12ResolverPool5FieldESaIS6_EE11_S_relocateEPS6_S9_S9_RS7_.exit16.i.i: ; preds = %bb.y, %.noexc44
  ...
  %.not.i17.i.i = icmp eq ptr %.sroa.0132.0200, null
...
bb.z:                                             ; preds = %_ZNSt6vectorIPKN6google8protobuf13json_internal12ResolverPool5FieldESaIS6_EE11_S_relocateEPS6_S9_S9_RS7_.exit16.i.i
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.0132.0200, i64 noundef %i.cu) #31
...
_ZNSt6vectorIPKN6google8protobuf13json_internal12ResolverPool5FieldESaIS6_EE9push_backERKS6_.exit: ; preds = %bb.s, %_ZNSt6vectorIPKN6google8protobuf13json_internal12ResolverPool5FieldESaIS6_EE17_M_realloc_insertIJRKS6_EEEvN9__gnu_cxx17__normal_iteratorIPS6_S8_EEDpOT_.exit.i, %bb.v, %_ZN6google8protobuf13json_internal10Proto3Type18IsImplicitPresenceEPKNS1_12ResolverPool5FieldE.exit, %bb.u
  %.sroa.19.1.a = phi ptr [ %.sroa.19.0198, %_ZN6google8protobuf13json_internal10Proto3Type18IsImplicitPresenceEPKNS1_12ResolverPool5FieldE.exit ], [ %.sroa.19.0198, %bb.u ], [ %i.dg, %_ZNSt6vectorIPKN6google8protobuf13json_internal12ResolverPool5FieldESaIS6_EE17_M_realloc_insertIJRKS6_EEEvN9__gnu_cxx17__normal_iteratorIPS6_S8_EEDpOT_.exit.i ], [ %.sroa.19.0198, %bb.v ], [ %.sroa.19.0198, %bb.s ] ; 8 uses
  ...
  %.sroa.0132.1 = phi ptr [ %.sroa.0132.0200, %_ZN6google8protobuf13json_internal10Proto3Type18IsImplicitPresenceEPKNS1_12ResolverPool5FieldE.exit ], [ %.sroa.0132.0200, %bb.u ], [ %i.dc, %_ZNSt6vectorIPKN6google8protobuf13json_internal12ResolverPool5FieldESaIS6_EE17_M_realloc_insertIJRKS6_EEEvN9__gnu_cxx17__normal_iteratorIPS6_S8_EEDpOT_.exit.i ], [ %.sroa.0132.0200, %bb.v ], [ %.sroa.0132.0200, %bb.s ] ; 26 uses
...
.noexc45:                                         ; preds = %.noexc45.lr.ph, %_ZN4absl12lts_202505126StatusD2Ev.exit
  %.sroa.0125.0205 = phi ptr [ %.sroa.0132.1, %.noexc45.lr.ph ], [ %i.ha, %_ZN4absl12lts_202505126StatusD2Ev.exit ] ; 2 uses
...
.critedge:                                        ; preds = %bb.bc, %.critedge37
  %.sroa.19.0.lcssa233243 = phi ptr [ %.sroa.19.0.lcssa233244, %.critedge37 ], [ %.sroa.19.1.a, %bb.bc ]
...
bb.bd:                                            ; preds = %.critedge
  ...
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0132.0.lcssa235241, i64 noundef %i.hd) #31
...
.body:                                            ; preds = %.loopexit, %.loopexit.split-lp.loopexit.split-lp, %.loopexit.split-lp.loopexit, %.loopexit181, %.loopexit.split-lp182, %bb.ac, %bb.t
  %.sroa.19.0196 = phi ptr [ %.sroa.12.0199, %.loopexit.split-lp182 ], [ %.sroa.19.1.a, %bb.ac ], [ %.sroa.19.0198, %bb.t ], [ %.sroa.19.0198.lcssa208, %.loopexit181 ], [ %.sroa.19.1.a, %.loopexit.split-lp.loopexit ], [ %.sroa.19.1.a, %.loopexit.split-lp.loopexit.split-lp ], [ %.sroa.19.1.a, %.loopexit ]
...
.body.thread168:                                  ; preds = %.body
  ...
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0132.0188, i64 noundef %i.hg) #31
