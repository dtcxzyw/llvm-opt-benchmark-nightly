...
bb.a:
  ...
  store i8 %i.f, ptr %i.c, align 1, !tbaa !52
  ret void
}
...
bb.a:
  ...
  %3 = or i1 %1, %2
  %4 = zext i1 %3 to i8
  store i8 %4, ptr %i.c, align 2, !tbaa !51
  ret void
}
...
.noexc.i:                                         ; preds = %bb.b
  ...
  store i64 25, ptr %i.f, align 8, !tbaa !53
  %i.v = invoke noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm(ptr noundef nonnull align 8 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(8) %i.f, i64 noundef 0)
          to label %.noexc unwind label %bb.c     ; 2 uses

.noexc:                                           ; preds = %.noexc.i
  store ptr %i.v, ptr %2, align 8, !tbaa !50
end_hunk_0
