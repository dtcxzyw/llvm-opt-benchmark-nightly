...
.lr.ph.i.preheader:                               ; preds = %.noexc101
  %21 = ptrtoint ptr %i.jd to i64
  %22 = ptrtoint ptr %i.jb to i64
  %i.je = sub i64 %21, %22
  %i.jf = add i64 %i.je, -32                      ; 2 uses
...
.lr.ph.i.preheader:                               ; preds = %.noexc144
  %28 = ptrtoint ptr %i.js to i64
  %29 = ptrtoint ptr %i.jq to i64
  %i.jt = sub i64 %28, %29
  %i.ju = add i64 %i.jt, -32                      ; 2 uses
