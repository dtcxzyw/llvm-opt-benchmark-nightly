...
begin_hunk_1_@_ZN6google8protobuf8compiler3cpp22ParseFunctionGenerator17GenerateDataDeclsEPNS0_2io7PrinterE:bb.a
  ...
  %i.kz = add <2 x i32> %vec.phi, splat (i32 3)
  %i.la = add <2 x i32> %vec.phi265, splat (i32 3)
  %i.lb = add <2 x i32> %i.kz, %i.kw              ; 2 uses
  %i.lc = add <2 x i32> %i.la, %i.ky              ; 2 uses
...
begin_hunk_2_@_ZN6google8protobuf8compiler3cpp22ParseFunctionGenerator17GenerateDataDeclsEPNS0_2io7PrinterE:bb.a
  ...
  %i.ln = add i32 %.010.i, 3
  %i.lo = add i32 %i.ln, %i.lm                    ; 2 uses
...
begin_hunk_4_@_ZN6google8protobuf8compiler3cpp22ParseFunctionGenerator21GenerateTailCallTableEPNS0_2io7PrinterE:bb.a
  ...
  %i.lo = add <2 x i32> %vec.phi, splat (i32 3)
  %i.lp = add <2 x i32> %vec.phi502, splat (i32 3)
  %i.lq = add <2 x i32> %i.lo, %i.ll              ; 2 uses
  %i.lr = add <2 x i32> %i.lp, %i.ln              ; 2 uses
  %index.next = add nuw i64 %index, 4             ; 2 uses
...
.lr.ph.i.i.i.prol.loopexit:                       ; preds = %.lr.ph.i.i.i.prol, %.lr.ph.i.i.i.preheader
  ...
  %5 = icmp ult i64 %4, 7
  br i1 %5, label %_ZZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE12_M_constructIPKhEEvT_S8_St20forward_iterator_tagEN6_GuardD2Ev.exit.loopexit.i.i, label %.lr.ph.i.i.i
