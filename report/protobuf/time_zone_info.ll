...
begin_hunk_0_@_ZN4absl12lts_2025051213time_internal4cctz12TimeZoneInfo17GetTransitionTypeElbRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPh:bb.a
...
bb.q:                                             ; preds = %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_110AllYearDSTERKNS2_13PosixTimeZoneE.exit
  %i.bk = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.bl = load ptr, ptr %i.bk, align 8, !tbaa !54
  %i.bm = getelementptr inbounds i8, ptr %i.bl, i64 -40
  %i.bn = load i8, ptr %i.bm, align 8, !tbaa !55  ; 2 uses
  %i.bo = load i8, ptr %i.b, align 1, !tbaa !33   ; 2 uses
  %6 = icmp eq i8 %i.bn, %i.bo
  br i1 %6, label %bb.ar, label %7

7:                                                ; preds = %bb.q
  %8 = getelementptr inbounds nuw i8, ptr %0, i64 32
  %9 = zext i8 %i.bn to i64
  %10 = load ptr, ptr %8, align 8, !tbaa !16      ; 2 uses
  %11 = getelementptr inbounds nuw [48 x i8], ptr %10, i64 %9 ; 3 uses
  %12 = zext i8 %i.bo to i64
  ...
  %.not.i50 = icmp eq i32 %14, %15
  br i1 %.not.i50, label %16, label %bb.ar

16:                                               ; preds = %7
  %17 = getelementptr inbounds nuw i8, ptr %11, i64 40
  %18 = load i8, ptr %17, align 8, !tbaa !24, !range !25, !noundef !26
  %19 = getelementptr inbounds nuw i8, ptr %13, i64 40
  %20 = load i8, ptr %19, align 8, !tbaa !24, !range !25, !noundef !26
  %.not11.i52 = icmp eq i8 %18, %20
  br i1 %.not11.i52, label %21, label %bb.ar
...
21:                                               ; preds = %16
  ...
  %.not12.i53 = icmp eq i8 %23, %25
  br label %bb.ar

_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_110AllYearDSTERKNS2_13PosixTimeZoneE.exit.thread: ; preds = %bb.p, %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_110AllYearDSTERKNS2_13PosixTimeZoneE.exit
  ...
  %i.bs = load ptr, ptr %i.bp, align 8, !tbaa !61
  %i.bt = ptrtoint ptr %i.br to i64
  %i.bu = ptrtoint ptr %i.bs to i64
  %i.bv = sub i64 %i.bt, %i.bu
  %i.bw = sdiv exact i64 %i.bv, 48
  %i.bx = add nsw i64 %i.bw, 804
  invoke void @_ZNSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE7reserveEm(ptr noundef nonnull align 8 dereferenceable(24) %i.bp, i64 noundef %i.bx)
          to label %bb.r unwind label %bb.o

bb.r:                                             ; preds = %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_110AllYearDSTERKNS2_13PosixTimeZoneE.exit.thread
  store i8 1, ptr %i.c, align 8, !tbaa !34
  %i.by = load ptr, ptr %i.bq, align 8, !tbaa !54 ; 2 uses
  %i.bz = getelementptr inbounds i8, ptr %i.by, i64 -48
  %i.ca = load i64, ptr %i.bz, align 8, !tbaa !62 ; 3 uses
  %i.cb = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.cc = getelementptr inbounds i8, ptr %i.by, i64 -40
  %i.cd = load i8, ptr %i.cc, align 8, !tbaa !55
  %i.ce = zext i8 %i.cd to i64
  %i.cf = load ptr, ptr %i.cb, align 8, !tbaa !16
  %i.cg = getelementptr inbounds nuw [48 x i8], ptr %i.cf, i64 %i.ce
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #24
  call void @_ZNK4absl12lts_2025051213time_internal4cctz12TimeZoneInfo9LocalTimeElRKNS2_14TransitionTypeE(ptr dead_on_unwind nonnull writable sret(%"struct.absl::lts_20250512::time_internal::cctz::time_zone::absolute_lookup") align 8 %2, ptr noundef nonnull align 8 dereferenceable(192) %0, i64 noundef %i.ca, ptr noundef nonnull align 8 dereferenceable(42) %i.cg)
  %i.ch = load i64, ptr %2, align 8, !tbaa !63    ; 6 uses
  %i.ci = getelementptr inbounds nuw i8, ptr %0, i64 168 ; 4 uses
  store i64 %i.ch, ptr %i.ci, align 8, !tbaa !64
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #24
  %i.cj = and i64 %i.ch, 3
  %i.ck = icmp eq i64 %i.cj, 0
  br i1 %i.ck, label %bb.s, label %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_16IsLeapEl.exit

bb.s:                                             ; preds = %bb.r
  %i.cl = srem i64 %i.ch, 100
  %.not.i50.a = icmp eq i64 %i.cl, 0
  br i1 %.not.i50.a, label %bb.t, label %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_16IsLeapEl.exit

bb.t:                                             ; preds = %bb.s
  %i.cm = srem i64 %i.ch, 400
  %i.cn = icmp eq i64 %i.cm, 0
  %i.co = zext i1 %i.cn to i8
  br label %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_16IsLeapEl.exit

_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_16IsLeapEl.exit: ; preds = %bb.r, %bb.s, %bb.t
  ...
  %i.cq = call noundef i64 @_ZN4absl12lts_2025051213time_internal4cctz6detailmiENS3_10civil_timeINS3_10second_tagEEES6_(i64 %i.ch, i64 %.sroa.2.0.copyload, i64 1970, i64 257) #24
  %i.cr = call noundef i32 @_ZN4absl12lts_2025051213time_internal4cctz6detail11get_weekdayERKNS3_10civil_timeINS3_10second_tagEEE(ptr noundef nonnull align 8 dereferenceable(16) %3) #24 ; 2 uses
  ...
  %i.cu = load i8, ptr %i.b, align 1, !tbaa !33
  store i8 %i.cu, ptr %i.ct, align 8, !tbaa !55
  %i.cv = getelementptr inbounds nuw i8, ptr %4, i64 16
  store i64 1970, ptr %i.cv, align 8, !tbaa !30
  %i.cw = getelementptr inbounds nuw i8, ptr %4, i64 24
  store <4 x i8> <i8 1, i8 1, i8 0, i8 0>, ptr %i.cw, align 8, !tbaa !33
  %i.cx = getelementptr inbounds nuw i8, ptr %4, i64 28
  store i8 0, ptr %i.cx, align 4, !tbaa !65
  %i.cy = getelementptr inbounds nuw i8, ptr %4, i64 32
  store i64 1970, ptr %i.cy, align 8, !tbaa !30
  %i.cz = getelementptr inbounds nuw i8, ptr %4, i64 40
  store <4 x i8> <i8 1, i8 1, i8 0, i8 0>, ptr %i.cz, align 8, !tbaa !33
  %i.da = getelementptr inbounds nuw i8, ptr %4, i64 44
  store i8 0, ptr %i.da, align 4, !tbaa !65
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #24
  %i.db = getelementptr inbounds nuw i8, ptr %5, i64 8
  %i.dc = load i8, ptr %i.a, align 1, !tbaa !33
  store i8 %i.dc, ptr %i.db, align 8, !tbaa !55
  %i.dd = getelementptr inbounds nuw i8, ptr %5, i64 16
  store i64 1970, ptr %i.dd, align 8, !tbaa !30
  %i.de = getelementptr inbounds nuw i8, ptr %5, i64 24
  store <4 x i8> <i8 1, i8 1, i8 0, i8 0>, ptr %i.de, align 8, !tbaa !33
  %i.df = getelementptr inbounds nuw i8, ptr %5, i64 28
  store i8 0, ptr %i.df, align 4, !tbaa !65
  %i.dg = getelementptr inbounds nuw i8, ptr %5, i64 32
  store i64 1970, ptr %i.dg, align 8, !tbaa !30
  %i.dh = getelementptr inbounds nuw i8, ptr %5, i64 40
  store <4 x i8> <i8 1, i8 1, i8 0, i8 0>, ptr %i.dh, align 8, !tbaa !33
  %i.di = getelementptr inbounds nuw i8, ptr %5, i64 44
  store i8 0, ptr %i.di, align 4, !tbaa !65
  %i.dj = load i64, ptr %i.ci, align 8, !tbaa !64
...
bb.u:                                             ; preds = %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_16IsLeapEl.exit82, %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_16IsLeapEl.exit
  %.039 = phi i64 [ %i.cq, %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_16IsLeapEl.exit ], [ %i.iu, %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_16IsLeapEl.exit82 ] ; 3 uses
  %.037 = phi i32 [ %.0.i, %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_16IsLeapEl.exit ], [ %i.iy, %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_16IsLeapEl.exit82 ] ; 3 uses
  %.035 = phi i8 [ %i.cp, %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_16IsLeapEl.exit ], [ %.136, %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_16IsLeapEl.exit82 ] ; 4 uses
  %i.dr = trunc nuw i8 %.035 to i1                ; 3 uses
  %i.ds = load i32, ptr %i.au, align 8, !tbaa !66
  switch i32 %i.ds, label %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_111TransOffsetEbiRKNS2_15PosixTransitionE.exit [
    i32 0, label %bb.v
    i32 1, label %bb.w
    i32 2, label %bb.x
  ]
...
bb.v:                                             ; preds = %bb.u
  %i.dt = load i64, ptr %i.aw, align 8, !tbaa !33 ; 2 uses
...
bb.w:                                             ; preds = %bb.u
  %i.dw = load i64, ptr %i.aw, align 8, !tbaa !33
  br label %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_111TransOffsetEbiRKNS2_15PosixTransitionE.exit

bb.x:                                             ; preds = %bb.u
  %i.dx = load i8, ptr %i.dm, align 1, !tbaa !33  ; 2 uses
  %i.dy = icmp eq i8 %i.dx, 5                     ; 2 uses
  %i.dz = zext nneg i8 %.035 to i64
  %i.ea = getelementptr inbounds nuw [28 x i8], ptr @_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_113kMonthOffsetsE, i64 %i.dz
  %i.eb = load i8, ptr %i.aw, align 8, !tbaa !33
  ...
  %i.eg = load i16, ptr %i.ef, align 2, !tbaa !67 ; 2 uses
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.em = load i8, ptr %i.dn, align 2, !tbaa !33
...
bb.z:                                             ; preds = %bb.x
  ...
  %i.es = load i8, ptr %i.dn, align 2, !tbaa !33
...
_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_111TransOffsetEbiRKNS2_15PosixTransitionE.exit: ; preds = %bb.u, %bb.v, %bb.w, %bb.y, %bb.z
  ...
  %i.fb = load i64, ptr %i.ay, align 8, !tbaa !69
  %i.fc = load i32, ptr %i.ba, align 8, !tbaa !66
  switch i32 %i.fc, label %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_111TransOffsetEbiRKNS2_15PosixTransitionE.exit62 [
    i32 0, label %bb.aa
    i32 1, label %bb.ab
    i32 2, label %bb.ac
  ]
...
bb.aa:                                            ; preds = %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_111TransOffsetEbiRKNS2_15PosixTransitionE.exit
  %i.fd = load i64, ptr %i.bc, align 8, !tbaa !33 ; 2 uses
...
bb.ab:                                            ; preds = %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_111TransOffsetEbiRKNS2_15PosixTransitionE.exit
  %i.fg = load i64, ptr %i.bc, align 8, !tbaa !33
  br label %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_111TransOffsetEbiRKNS2_15PosixTransitionE.exit62

bb.ac:                                            ; preds = %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_111TransOffsetEbiRKNS2_15PosixTransitionE.exit
  %i.fh = load i8, ptr %i.do, align 1, !tbaa !33  ; 2 uses
  %i.fi = icmp eq i8 %i.fh, 5                     ; 2 uses
  %i.fj = zext nneg i8 %.035 to i64
  %i.fk = getelementptr inbounds nuw [28 x i8], ptr @_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_113kMonthOffsetsE, i64 %i.fj
end_hunk_0
begin_hunk_1_@_ZN4absl12lts_2025051213time_internal4cctz12TimeZoneInfo17ExtendTransitionsEv:bb.a
  br i1 %i.ha, label %bb.ag, label %_ZNSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE9push_backERKS4_.exit
...
bb.ah:                                            ; preds = %bb.ag
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %.pre, ptr noundef nonnull align 8 dereferenceable(48) %i.gv, i64 48, i1 false), !tbaa.struct !71
  %i.hb = load ptr, ptr %i.bq, align 8, !tbaa !60
  %i.hc = getelementptr inbounds nuw i8, ptr %i.hb, i64 48 ; 2 uses
  store ptr %i.hc, ptr %i.bq, align 8, !tbaa !60
  %.pre91 = load ptr, ptr %i.dq, align 8, !tbaa !70
  br label %_ZNSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE9push_backERKS4_.exit

bb.ai:                                            ; preds = %bb.ag
  %i.hd = load ptr, ptr %i.bp, align 8, !tbaa !61 ; 5 uses
  ...
  br i1 %i.hh, label %.invoke, label %_ZNKSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE12_M_check_lenEmPKc.exit.i.i
...
.noexc64:                                         ; preds = %_ZNKSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE12_M_check_lenEmPKc.exit.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %i.hp, ptr noundef nonnull align 8 dereferenceable(48) %i.gv, i64 48, i1 false), !tbaa.struct !71
...
_ZNSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE17_M_realloc_insertIJRKS4_EEEvN9__gnu_cxx17__normal_iteratorIPS4_S6_EEDpOT_.exit.i: ; preds = %bb.aj, %_ZNSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit22.i.i
  store ptr %i.ho, ptr %i.bp, align 8, !tbaa !61
  store ptr %i.hs, ptr %i.bq, align 8, !tbaa !60
  %i.ht = getelementptr inbounds nuw [48 x i8], ptr %i.ho, i64 %i.hm ; 2 uses
  store ptr %i.ht, ptr %i.dq, align 8, !tbaa !70
  br label %_ZNSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE9push_backERKS4_.exit
...
_ZNSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE9push_backERKS4_.exit: ; preds = %_ZNSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE17_M_realloc_insertIJRKS4_EEEvN9__gnu_cxx17__normal_iteratorIPS4_S6_EEDpOT_.exit.i, %bb.ah, %bb.af
  %i.hu = phi ptr [ %i.ht, %_ZNSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE17_M_realloc_insertIJRKS4_EEEvN9__gnu_cxx17__normal_iteratorIPS4_S6_EEDpOT_.exit.i ], [ %.pre91, %bb.ah ], [ %.pre92, %bb.af ] ; 4 uses
  %i.hv = phi ptr [ %i.hs, %_ZNSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE17_M_realloc_insertIJRKS4_EEEvN9__gnu_cxx17__normal_iteratorIPS4_S6_EEDpOT_.exit.i ], [ %i.hc, %bb.ah ], [ %.pre, %bb.af ] ; 2 uses
...
bb.al:                                            ; preds = %_ZNSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE9push_backERKS4_.exit
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %i.hv, ptr noundef nonnull align 8 dereferenceable(48) %i.gw, i64 48, i1 false), !tbaa.struct !71
  %i.hw = load ptr, ptr %i.bq, align 8, !tbaa !60
  %i.hx = getelementptr inbounds nuw i8, ptr %i.hw, i64 48
  store ptr %i.hx, ptr %i.bq, align 8, !tbaa !60
...
bb.am:                                            ; preds = %_ZNSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE9push_backERKS4_.exit
  %i.hy = load ptr, ptr %i.bp, align 8, !tbaa !61 ; 5 uses
  ...
  br i1 %i.ic, label %.invoke, label %_ZNKSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE12_M_check_lenEmPKc.exit.i.i66
...
.noexc79:                                         ; preds = %_ZNKSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE12_M_check_lenEmPKc.exit.i.i66
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %i.ik, ptr noundef nonnull align 8 dereferenceable(48) %i.gw, i64 48, i1 false), !tbaa.struct !71
...
_ZNSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE17_M_realloc_insertIJRKS4_EEEvN9__gnu_cxx17__normal_iteratorIPS4_S6_EEDpOT_.exit.i77: ; preds = %bb.an, %_ZNSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit22.i.i74
  store ptr %i.ij, ptr %i.bp, align 8, !tbaa !61
  store ptr %i.in, ptr %i.bq, align 8, !tbaa !60
  %i.io = getelementptr inbounds nuw [48 x i8], ptr %i.ij, i64 %i.ih
  store ptr %i.io, ptr %i.dq, align 8, !tbaa !70
  br label %_ZNSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE9push_backERKS4_.exit80
...
_ZNSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE9push_backERKS4_.exit80: ; preds = %_ZNSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE17_M_realloc_insertIJRKS4_EEEvN9__gnu_cxx17__normal_iteratorIPS4_S6_EEDpOT_.exit.i77, %bb.al, %_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_111TransOffsetEbiRKNS2_15PosixTransitionE.exit62
  %i.ip = load i64, ptr %i.ci, align 8, !tbaa !64 ; 2 uses
...
bb.ao:                                            ; preds = %_ZNSt6vectorIN4absl12lts_2025051213time_internal4cctz10TransitionESaIS4_EE9push_backERKS4_.exit80
  ...
  %i.ir = getelementptr inbounds nuw [4 x i8], ptr @_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_112kSecsPerYearE, i64 %i.iq
  %i.is = load i32, ptr %i.ir, align 4, !tbaa !3
  %i.it = sext i32 %i.is to i64
  %i.iu = add nsw i64 %.039, %i.it
  %i.iv = getelementptr inbounds nuw [4 x i8], ptr @_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_112kDaysPerYearE, i64 %i.iq
...
_ZN4absl12lts_2025051213time_internal4cctz12_GLOBAL__N_16IsLeapEl.exit82: ; preds = %bb.ao, %bb.aq, %bb.ap
  ...
  store i64 %.pre93, ptr %i.ci, align 8, !tbaa !64
...
bb.ar:                                            ; preds = %21, %16, %7, %bb.q, %bb.n, %.critedge
  %.0 = phi i1 [ false, %bb.n ], [ true, %.critedge ], [ true, %bb.q ], [ false, %16 ], [ false, %7 ], [ %.not12.i53, %21 ]
...
bb.au:                                            ; preds = %bb.c, %_ZNK4absl12lts_2025051213time_internal4cctz12TimeZoneInfo16EquivTransitionsEhh.exit
  ...
  %i.jf = load ptr, ptr %i.j, align 8, !tbaa !17  ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i: ; preds = %bb.au
  %i.jh = load i64, ptr %i.k, align 8, !tbaa !33
  %i.ji = add i64 %i.jh, 1
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i: ; preds = %bb.au, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i
  %i.jj = load ptr, ptr %1, align 8, !tbaa !17    ; 2 uses
  %i.jk = icmp eq ptr %i.jj, %i.h
  br i1 %i.jk, label %_ZN4absl12lts_2025051213time_internal4cctz13PosixTimeZoneD2Ev.exit, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i1.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i1.i: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i
  %i.jl = load i64, ptr %i.h, align 8, !tbaa !33
  %i.jm = add i64 %i.jl, 1
...
bb.a:
  ...
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.v = load i32, ptr %3, align 8, !tbaa !23
  store i32 %i.v, ptr %i.u, align 8, !tbaa !87
  %i.w = getelementptr inbounds nuw i8, ptr %0, i64 20
  %i.x = getelementptr inbounds nuw i8, ptr %3, i64 40
  %i.y = load i8, ptr %i.x, align 8, !tbaa !24, !range !25, !noundef !26
  store i8 %i.y, ptr %i.w, align 4, !tbaa !89
  ...
  %i.ae = load ptr, ptr %i.aa, align 8, !tbaa !17
  %i.af = getelementptr inbounds nuw i8, ptr %i.ae, i64 %i.ad
  store ptr %i.af, ptr %i.z, align 8, !tbaa !90
  ret void
}
