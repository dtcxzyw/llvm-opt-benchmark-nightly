...
@.str.20 = private unnamed_addr constant [7 x i8] c"tzdata\00", align 1
...
bb.l:                                             ; preds = %bb.k
  %bcmp151 = call i32 @bcmp(ptr noundef nonnull dereferenceable(4) %2, ptr noundef nonnull dereferenceable(4) @.str, i64 4)
  %.not152 = icmp ne i32 %bcmp151, 0
...
begin_hunk_4
  ...
  %i.f = alloca [24 x i8], align 16               ; 17 uses
...
bb.t:                                             ; preds = %bb.s
  %bcmp.i20.i.i.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(6) %i.f, ptr noundef nonnull dereferenceable(6) @.str.20, i64 6), !noalias !280
  %.not55.i.i.i.i = icmp eq i32 %bcmp.i20.i.i.i, 0
