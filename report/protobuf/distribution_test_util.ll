...
common.ret195:                                    ; preds = %bb.n, %bb.k, %.loopexit, %bb.l, %bb.b
  %common.ret192.op = phi double [ %i.d, %bb.b ], [ %.1145162, %bb.n ], [ %i.cd, %bb.k ], [ %.1145162, %bb.l ], [ 0x7FF0000000000000, %.loopexit ]
...
begin_hunk_1
  ...
  %.sroa.speculated132 = select i1 %i.bx, double 0x3FEFFFFFFFFFFFA6, double %.sroa.speculated141
...
.lr.ph:                                           ; preds = %bb.j, %.loopexit
  %.1145162 = phi double [ %.sroa.speculated132, %bb.j ], [ %i.ct, %.loopexit ] ; 10 uses
