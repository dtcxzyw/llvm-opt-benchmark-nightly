...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ab = tail call double @sqrt(double noundef %i.aa) #13, !tbaa !3
...
bb.e:                                             ; preds = %bb.c
  ...
  %i.au = tail call double @sqrt(double noundef %i.as) #13, !tbaa !3
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.bc = tail call double @log(double noundef %i.bb) #13, !tbaa !3
  %i.bd = fadd double %2, %i.bc
  %i.be = fdiv double %i.bd, %1
  %i.bf = tail call double @exp(double noundef %i.be) #13, !tbaa !3
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.bm = tail call double @log(double noundef %i.bl) #13, !tbaa !3
  %i.bn = fadd double %2, %i.bm
  %i.bo = fdiv double %i.bn, %0
  %i.bp = tail call double @exp(double noundef %i.bo) #13, !tbaa !3
  br label %bb.j
...
.split:                                           ; preds = %bb.l, %bb.p
  ...
  br i1 %i.cr, label %bb.m, label %bb.p, !llvm.loop !37
