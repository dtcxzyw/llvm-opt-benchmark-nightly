...
bb.d:                                             ; preds = %bb.c
  ...
  %10 = insertelement <2 x double> <double poison, double 2.000000e+00>, double %i.p, i64 0
  %11 = insertelement <2 x double> %8, double 6.000000e+00, i64 0
  %12 = fdiv <2 x double> %10, %11                ; 2 uses
  %13 = shufflevector <2 x double> <double f0x3FEAAAAAAAAAAAAB, double poison>, <2 x double> %8, <2 x i32> <i32 0, i32 2>
  %14 = fadd <2 x double> %12, %13                ; 4 uses
  %shift190 = shufflevector <2 x double> %14, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop191 = fadd <2 x double> %shift190, %12
  %15 = extractelement <2 x double> %foldExtExtBinop191, i64 0
  %i.q = tail call double @sqrt(double noundef %15) #13, !tbaa !3
  %i.r = fmul double %i.m, %i.q
  %16 = fmul <2 x double> %14, <double poison, double 3.000000e+00>
  %17 = shufflevector <2 x double> %8, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %18 = insertelement <2 x double> %17, double %i.r, i64 0
  %19 = shufflevector <2 x double> %14, <2 x double> %16, <2 x i32> <i32 1, i32 3>
  %20 = fdiv <2 x double> %18, %19                ; 2 uses
  %shift193 = shufflevector <2 x double> %20, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop194 = fsub <2 x double> %14, %shift193
  %21 = extractelement <2 x double> %foldExtExtBinop194, i64 0
  %i.s = fneg double %9
  %22 = extractelement <2 x double> %20, i64 0
  %i.t = tail call double @llvm.fmuladd.f64(double %i.s, double %21, double %22) ; 2 uses
