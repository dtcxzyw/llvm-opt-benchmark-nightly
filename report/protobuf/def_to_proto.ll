...
bb.ba:                                            ; preds = %special_escape.exit43.i.i
  ...
  store i8 %i.io, ptr %3, align 1, !tbaa !19
  %i.iq = lshr i8 %i.ik, 3
  %i.ir = and i8 %i.iq, 7
...
begin_hunk_3_@fielddef_toproto:bb.a
  ...
  %4 = getelementptr inbounds nuw i8, ptr %.03757.i.i, i64 4
  store i8 %i.iv, ptr %i.it, align 1, !tbaa !19
  br label %bb.bb

bb.bb:                                            ; preds = %bb.ba, %bb.az, %special_escape.exit45.i.i
  %.138.i.i = phi ptr [ %2, %special_escape.exit45.i.i ], [ %3, %bb.az ], [ %4, %bb.ba ]
