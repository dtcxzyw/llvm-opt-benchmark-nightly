...
_ZNSt10unique_ptrIA_jSt14default_deleteIS0_EE5resetIPjvEEvT_.exit: ; preds = %bb.l, %bb.m
...
begin_hunk_1_@_ZN6google8protobuf21DynamicMessageFactory18GetPrototypeNoLockEPKNS0_10DescriptorE:bb.a
  ...
  %.pre = load i32, ptr %i.bq, align 8, !tbaa !82 ; 2 uses
  store i32 -1, ptr %i.aw, align 8, !tbaa !174
  %i.by = icmp sgt i32 %.pre, 0
...
._crit_edge140.thread:                            ; preds = %_ZNSt10unique_ptrIA_jSt14default_deleteIS0_EE5resetIPjvEEvT_.exit, %bb.s, %._crit_edge140
  ...
  %i.ds = phi i32 [ %i.dj, %bb.s ], [ %i.dj, %._crit_edge140 ], [ %.pre, %_ZNSt10unique_ptrIA_jSt14default_deleteIS0_EE5resetIPjvEEvT_.exit ] ; 2 uses
