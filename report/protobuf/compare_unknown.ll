...
upb_WireReader_ReadVarint.exit:                   ; preds = %upb_WireReader_ReadVarint.exit.backedge, %bb.a
  %.085 = phi ptr [ %i.b, %bb.a ], [ %.186, %upb_WireReader_ReadVarint.exit.backedge ] ; 11 uses
  %.081 = phi ptr [ %i.d, %bb.a ], [ %i.bz, %upb_WireReader_ReadVarint.exit.backedge ] ; 5 uses
  %.077 = phi ptr [ %i.f, %bb.a ], [ %.178, %upb_WireReader_ReadVarint.exit.backedge ] ; 3 uses
...
bb.o:                                             ; preds = %upb_UnknownFields_Grow.exit, %bb.e
  %.186 = phi ptr [ %.4, %upb_UnknownFields_Grow.exit ], [ %.085, %bb.e ]
  %.182 = phi ptr [ %i.bx, %upb_UnknownFields_Grow.exit ], [ %.081, %bb.e ] ; 8 uses
  %.178 = phi ptr [ %i.by, %upb_UnknownFields_Grow.exit ], [ %.077, %bb.e ]
  store i32 %.073, ptr %.182, align 8, !tbaa !41
  %i.bz = getelementptr inbounds nuw i8, ptr %.182, i64 24
...
upb_EpsCopyInputStream_ReadStringAlwaysAlias.exit: ; preds = %bb.x, %bb.y
  %.sroa.0.0 = phi ptr [ undef, %bb.x ], [ %i.dh, %bb.y ]
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  %.03846.sink.i = select i1 %.not.i, ptr %.03846.i, ptr %.04045.i
...
.sink.split.i:                                    ; preds = %._crit_edge.i
  %.040.lcssa.mux.i = select i1 %i.k, ptr %.141.i, ptr %.139.i
