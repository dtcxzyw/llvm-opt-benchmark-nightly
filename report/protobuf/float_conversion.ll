...
vec.epilog.iter.check178:                         ; preds = %middle.block172
  ...
  br i1 %min.epilog.iters.check179, label %.lr.ph.preheader, label %vec.epilog.ph180, !prof !172
...
vec.epilog.vector.body182:                        ; preds = %vec.epilog.vector.body182, %vec.epilog.ph180
  ...
  %wide.load186 = load <8 x i8>, ptr %i.dl, align 1, !tbaa !25, !alias.scope !176, !noalias !177
  %i.dm = getelementptr inbounds i8, ptr %next.gep184, i64 -8 ; 2 uses
  %wide.load187 = load <8 x i8>, ptr %i.dm, align 1, !tbaa !25, !alias.scope !177
  store <8 x i8> %wide.load187, ptr %i.dl, align 1, !tbaa !25, !alias.scope !176, !noalias !177
  store <8 x i8> %wide.load186, ptr %i.dm, align 1, !tbaa !25, !alias.scope !177
