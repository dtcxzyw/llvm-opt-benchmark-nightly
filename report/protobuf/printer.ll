...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i.a:   ; preds = %bb.t, %.lr.ph.i.i
  ...
  %i.cd = add i64 %.033.i.i, %invariant.op        ; 2 uses
  %.not26.i.i.a = icmp eq i64 %i.cd, 0
  br i1 %.not26.i.i.a, label %.thread283, label %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i

_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i:     ; preds = %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i.a
  %10 = call ptr @memchr(ptr noundef %.02132.i.i, i32 noundef %i.cb, i64 noundef %i.cd) #30 ; 4 uses
  %.not26.i.i = icmp eq ptr %10, null
...
.thread283:                                       ; preds = %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i, %bb.t, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i.a, %bb.u, %bb.s, %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findES2_m.exit, %bb.p
  %.sroa.0211.2 = phi i64 [ %.sroa.0211.0.copyload, %bb.p ], [ %.sroa.0211.0.copyload, %bb.s ], [ %.sroa.0211.0.copyload, %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findES2_m.exit ], [ %.sroa.speculated.i, %bb.u ], [ %.sroa.0211.0.copyload, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i.a ], [ %.sroa.0211.0.copyload, %bb.t ], [ %.sroa.0211.0.copyload, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i ] ; 5 uses
