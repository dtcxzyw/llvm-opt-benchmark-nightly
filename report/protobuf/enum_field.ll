...
.lr.ph.i.a:                                       ; preds = %.lr.ph.i, %.lr.ph.i.a
  ...
  %14 = load ptr, ptr %13, align 8, !tbaa !407    ; 2 uses
  %15 = getelementptr inbounds nuw [8 x i8], ptr %5, i64 %indvars.iv.prol
  store ptr %14, ptr %15, align 8, !tbaa !407
  %i.db = getelementptr inbounds nuw i8, ptr %14, i64 8
  %16 = trunc nuw i64 %indvars.iv.prol to i8
  store i8 %16, ptr %i.db, align 1, !tbaa !17
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.prol.loopexit, label %.lr.ph.i.a, !llvm.loop !419
...
bb.k:                                             ; preds = %.prol.loopexit, %bb.k
  ...
  %20 = load ptr, ptr %19, align 8, !tbaa !407    ; 2 uses
  %21 = getelementptr inbounds nuw [8 x i8], ptr %5, i64 %indvars.iv
  store ptr %20, ptr %21, align 8, !tbaa !407
  %22 = getelementptr inbounds nuw i8, ptr %20, i64 8
  %23 = trunc nuw i64 %indvars.iv to i8
  store i8 %23, ptr %22, align 1, !tbaa !17
  ...
  store ptr %i.dd, ptr %25, align 8, !tbaa !407
  ...
  br i1 %.wide.3, label %bb.k, label %_ZN4absl12lts_2025051218container_internal10btree_nodeINS1_10set_paramsINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4lessIS9_ESaIS9_ELi256ELb0EEEE13emplace_valueIJS9_EEEvhPSC_DpOT_.exit, !llvm.loop !421
...
.lr.ph.i27.a:                                     ; preds = %.lr.ph.i27, %.lr.ph.i27.a
  ...
  %13 = load ptr, ptr %12, align 8, !tbaa !407    ; 2 uses
  %14 = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %indvars.iv.prol
  store ptr %13, ptr %14, align 8, !tbaa !407
  %i.ch = getelementptr inbounds nuw i8, ptr %13, i64 8
  %15 = trunc nuw i64 %indvars.iv.prol to i8
  store i8 %15, ptr %i.ch, align 1, !tbaa !17
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.prol.loopexit, label %.lr.ph.i27.a, !llvm.loop !432
...
bb.i:                                             ; preds = %.prol.loopexit, %bb.i
  ...
  store ptr %i.cj, ptr %24, align 8, !tbaa !407
  %25 = getelementptr inbounds nuw i8, ptr %i.cj, i64 8
  %26 = trunc nuw i64 %17 to i8
  store i8 %26, ptr %25, align 1, !tbaa !17
  ...
  store ptr %29, ptr %i.ck, align 8, !tbaa !407
  %i.cl = getelementptr inbounds nuw i8, ptr %29, i64 8
  %30 = trunc nuw i64 %23 to i8
  store i8 %30, ptr %i.cl, align 1, !tbaa !17
  %31 = add nsw i64 %indvars.iv, -4               ; 3 uses
  %32 = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %31
  %33 = load ptr, ptr %32, align 8, !tbaa !407    ; 2 uses
  %34 = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %27
  store ptr %33, ptr %34, align 8, !tbaa !407
  %35 = getelementptr inbounds nuw i8, ptr %33, i64 8
  %36 = trunc nuw i64 %27 to i8
  store i8 %36, ptr %35, align 1, !tbaa !17
  %.wide.3 = icmp ugt i64 %31, %6
  br i1 %.wide.3, label %bb.i, label %_ZN4absl12lts_2025051218container_internal10btree_nodeINS1_10set_paramsINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4lessIS9_ESaIS9_ELi256ELb0EEEE13emplace_valueIJPS9_EEEvhPSC_DpOT_.exit, !llvm.loop !433
...
bb.k:                                             ; preds = %bb.j, %bb.k
  ...
  br i1 %.not, label %.loopexit, label %bb.k, !llvm.loop !434
