...
begin_hunk_0_@_ZN4absl12lts_2025051218debugging_internalL17ParseCVQualifiersEPNS1_5StateE:bb.a
  ...
  %.01257 = phi i32 [ 0, %.lr.ph ], [ %i.an, %.preheader ] ; 4 uses
...
._ZN4absl12lts_2025051218debugging_internalL17ParseOneCharTokenEPNS1_5StateEc.exit33.thread_crit_edge: ; preds = %bb.b
  %.01257.lcssa235 = phi i32 [ %.01257, %bb.b ]
  br label %_ZN4absl12lts_2025051218debugging_internalL17ParseOneCharTokenEPNS1_5StateEc.exit33.thread
...
_ZN4absl12lts_2025051218debugging_internalL17ParseOneCharTokenEPNS1_5StateEc.exit33.thread: ; preds = %_ZN4absl12lts_2025051218debugging_internalL17ParseOneCharTokenEPNS1_5StateEc.exit33.threadsplit, %._ZN4absl12lts_2025051218debugging_internalL17ParseOneCharTokenEPNS1_5StateEc.exit33.thread_crit_edge
  %.lcssa228 = phi i32 [ %i.p, %._ZN4absl12lts_2025051218debugging_internalL17ParseOneCharTokenEPNS1_5StateEc.exit33.thread_crit_edge ], [ %i.p, %_ZN4absl12lts_2025051218debugging_internalL17ParseOneCharTokenEPNS1_5StateEc.exit33.threadsplit ] ; 2 uses
  %.01257.lcssa = phi i32 [ %.01257.lcssa235, %._ZN4absl12lts_2025051218debugging_internalL17ParseOneCharTokenEPNS1_5StateEc.exit33.thread_crit_edge ], [ %.01257.lcssa236, %_ZN4absl12lts_2025051218debugging_internalL17ParseOneCharTokenEPNS1_5StateEc.exit33.threadsplit ]
  %.lcssa = phi i32 [ %i.s, %._ZN4absl12lts_2025051218debugging_internalL17ParseOneCharTokenEPNS1_5StateEc.exit33.thread_crit_edge ], [ %i.s, %_ZN4absl12lts_2025051218debugging_internalL17ParseOneCharTokenEPNS1_5StateEc.exit33.threadsplit ]
...
.lr.ph.i.i.preheader:                             ; preds = %bb.g
  %i.av = sext i32 %lsr.iv.next to i64
...
.lr.ph.i.i.i.preheader:                           ; preds = %bb.j
  %i.ba = sext i32 %lsr.iv.next to i64
...
bb.p:                                             ; preds = %bb.q, %.lr.ph.i.i
  %lsr.iv171 = phi i64 [ %lsr.iv.next172, %bb.q ], [ %lsr.iv169, %.lr.ph.i.i ] ; 2 uses
  %lsr.iv166 = phi i64 [ %lsr.iv.next167, %bb.q ], [ %lsr.iv165, %.lr.ph.i.i ]
...
bb.e:                                             ; preds = %bb.f, %.lr.ph.i
  %lsr.iv17 = phi i64 [ %lsr.iv.next18, %bb.f ], [ %lsr.iv15, %.lr.ph.i ] ; 2 uses
  %lsr.iv12 = phi i64 [ %lsr.iv.next13, %bb.f ], [ %lsr.iv11, %.lr.ph.i ]
...
bb.m:                                             ; preds = %bb.n, %.lr.ph.i.i
  %lsr.iv168 = phi i64 [ %lsr.iv.next169, %bb.n ], [ %lsr.iv166, %.lr.ph.i.i ] ; 2 uses
  %lsr.iv163 = phi i64 [ %lsr.iv.next164, %bb.n ], [ %lsr.iv162, %.lr.ph.i.i ]
