...
_upb_Decoder_Munge.exit:                          ; preds = %.lr.ph.i, %upb_WireReader_ReadVarint.exit, %bb.q, %upb_MiniTableEnum_CheckValue.exit, %bb.w, %bb.v, %bb.u
  %.sroa.0.0..sroa.0.0..sroa.0.0.179310 = phi i8 [ %i.dn, %bb.u ], [ %.sroa.0.0..sroa.0.0..sroa.0.0.179311, %upb_WireReader_ReadVarint.exit ], [ %.sroa.0.0..sroa.0.0..sroa.0.0.179311, %bb.q ], [ %.sroa.0.0..sroa.0.0..sroa.0.0.179311, %upb_MiniTableEnum_CheckValue.exit ], [ %i.dy, %bb.w ], [ %i.dt, %bb.v ], [ %.sroa.0.0..sroa.0.0..sroa.0.0.179311, %.lr.ph.i ]
...
begin_hunk_6_@_upb_Decoder_DecodeMessage:bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.oo, ptr align 1 %.sroa.0188.6, i64 %.sroa.4.6, i1 false)
...
_upb_Decoder_DecodeWireValue.exit.thread.thread285: ; preds = %_upb_Decoder_DecodeWireValue.exit.thread.thread285.backedge, %_upb_Decoder_DecodeWireValue.exit.thread.thread285.preheader
  %.sroa.5.4 = phi i64 [ %.sroa.5.0, %_upb_Decoder_DecodeWireValue.exit.thread.thread285.preheader ], [ %.sroa.5.4.be, %_upb_Decoder_DecodeWireValue.exit.thread.thread285.backedge ] ; 13 uses
  %.sroa.0197.4 = phi ptr [ %.sroa.0197.0, %_upb_Decoder_DecodeWireValue.exit.thread.thread285.preheader ], [ %.sroa.0197.4.be, %_upb_Decoder_DecodeWireValue.exit.thread.thread285.backedge ] ; 13 uses
  ...
  %.sroa.5.0.i64 = phi i64 [ 0, %_upb_Decoder_DecodeWireValue.exit.thread.thread285.preheader ], [ %.sroa.5.0.i64.be, %_upb_Decoder_DecodeWireValue.exit.thread.thread285.backedge ] ; 14 uses
...
bb.fm:                                            ; preds = %bb.fl
  ...
  call fastcc void @upb_Decoder_AddMessageSetItem(ptr noundef nonnull %0, ptr noundef %2, ptr noundef %3, i32 noundef %i.adx, ptr noundef %.sroa.0.0.i63, i32 noundef %5), !inline_history !78
  br label %_upb_Decoder_DecodeWireValue.exit.thread.thread285.backedge

bb.fn:                                            ; preds = %upb_WireReader_ReadTag.exit.i
  %i.adz = load i8, ptr %.0.i.i65, align 1, !tbaa !22 ; 2 uses
...
upb_WireReader_ReadSize.exit.i:                   ; preds = %upb_EpsCopyInputStream_HasErrorHandler.exit.i147, %bb.fo
  %.0208 = phi i64 [ %6, %bb.fo ], [ %i.aee, %upb_EpsCopyInputStream_HasErrorHandler.exit.i147 ]
...
upb_EpsCopyInputStream_ReadStringAlwaysAlias.exit: ; preds = %bb.fp, %bb.fq
  ...
  %.sroa.0197.6 = phi ptr [ %.sroa.0197.4, %bb.fp ], [ %i.aer, %bb.fq ] ; 5 uses
...
bb.fu:                                            ; preds = %bb.ft
  ...
  call fastcc void @upb_Decoder_AddMessageSetItem(ptr noundef nonnull %0, ptr noundef %2, ptr noundef %3, i32 noundef %.028.i, ptr noundef %.sroa.0197.6, i32 noundef %9), !inline_history !78
  br label %_upb_Decoder_DecodeWireValue.exit.thread.thread285.backedge
...
_upb_Decoder_DecodeWireValue.exit.thread.thread285.backedge: ; preds = %upb_EpsCopyInputStream_HasErrorHandler.exit.i.i.i, %bb.gf, %bb.ge, %bb.gd, %bb.gc, %bb.fz, %bb.fy, %bb.fx, %bb.fs, %bb.fu, %bb.ft, %upb_WireReader_ReadVarint.exit.i, %bb.fl, %bb.fm
  ...
  %.sroa.0197.4.be = phi ptr [ %.sroa.0197.4, %bb.gc ], [ %.sroa.0197.4, %bb.gd ], [ %.sroa.0197.6, %bb.fs ], [ %.sroa.0197.4, %bb.gf ], [ %.sroa.0197.4, %upb_WireReader_ReadVarint.exit.i ], [ %.sroa.0197.4, %bb.fm ], [ %.sroa.0197.4, %bb.fl ], [ %.sroa.0197.6, %bb.ft ], [ %.sroa.0197.6, %bb.fu ], [ %.sroa.0197.4, %bb.fx ], [ %.sroa.0197.4, %upb_EpsCopyInputStream_HasErrorHandler.exit.i.i.i ], [ %.sroa.0197.4, %bb.ge ], [ %.sroa.0197.4, %bb.fy ], [ %.sroa.0197.4, %bb.fz ]
  %.0209.be = phi ptr [ %i.afs, %bb.gc ], [ %i.aft, %bb.gd ], [ %.0.i145, %bb.fs ], [ %i.afw, %bb.gf ], [ %.0.i38.i, %upb_WireReader_ReadVarint.exit.i ], [ %.0.i38.i, %bb.fm ], [ %.0.i38.i, %bb.fl ], [ %.0.i145, %bb.ft ], [ %.0.i145, %bb.fu ], [ %i.afb, %bb.fx ], [ %i.afe, %upb_EpsCopyInputStream_HasErrorHandler.exit.i.i.i ], [ %i.afv, %bb.ge ], [ %i.aff, %bb.fy ], [ %i.afg, %bb.fz ]
  ...
  %.sroa.0.0.i63.be = phi ptr [ %.sroa.0.0.i63, %bb.gc ], [ %.sroa.0.0.i63, %bb.gd ], [ %.sroa.0.0.i63, %bb.fs ], [ %.sroa.0.0.i63, %bb.gf ], [ %.sroa.0.0.i63, %upb_WireReader_ReadVarint.exit.i ], [ %.sroa.0.0.i63, %bb.fm ], [ %.sroa.0.0.i63, %bb.fl ], [ %.sroa.0197.6, %bb.ft ], [ %.sroa.0.0.i63, %bb.fu ], [ %.sroa.0.0.i63, %bb.fx ], [ %.sroa.0.0.i63, %upb_EpsCopyInputStream_HasErrorHandler.exit.i.i.i ], [ %.sroa.0.0.i63, %bb.ge ], [ %.sroa.0.0.i63, %bb.fy ], [ %.sroa.0.0.i63, %bb.fz ]
...
_upb_Decoder_DecodeField.exit:                    ; preds = %upb_WireReader_ReadTag.exit.i, %bb.el, %bb.ek, %bb.ej, %_upb_Decoder_ReadString2.exit127, %bb.eb, %_upb_Decoder_RecurseSubMessage.exit52.i, %_upb_Decoder_RecurseSubMessage.exit.i56, %bb.ck, %_upb_Decoder_DecodeVarintPacked.exit.i, %_upb_Decoder_RecurseSubMessage.exit73.i, %_upb_Decoder_RecurseSubMessage.exit.i, %_upb_Decoder_ReadString2.exit, %bb.av, %bb.au, %_upb_Decoder_Reserve.exit83, %bb.bv, %_upb_Decoder_DecodeToMap.exit, %_upb_Message_AddUnknown_dont_copy_me__upb_internal_use_only.exit.thread.i, %_upb_Message_AddUnknown_dont_copy_me__upb_internal_use_only.exit.i
  %.sroa.5.3 = phi i64 [ %.sroa.5.0, %_upb_Message_AddUnknown_dont_copy_me__upb_internal_use_only.exit.i ], [ %.sroa.5.0, %_upb_Decoder_DecodeToMap.exit ], [ %.sroa.5.0, %bb.el ], [ %.sroa.5.0, %bb.ek ], [ %.sroa.5.0, %bb.ej ], [ %.sroa.5.0, %_upb_Decoder_ReadString2.exit127 ], [ %.sroa.5.0, %bb.eb ], [ %.sroa.5.0, %_upb_Decoder_RecurseSubMessage.exit52.i ], [ %.sroa.5.0, %_upb_Decoder_RecurseSubMessage.exit.i56 ], [ %.sroa.5.0, %bb.ck ], [ %.sroa.5.0, %_upb_Decoder_DecodeVarintPacked.exit.i ], [ %.sroa.5.0, %_upb_Decoder_RecurseSubMessage.exit73.i ], [ %.sroa.5.0, %_upb_Decoder_RecurseSubMessage.exit.i ], [ %.sroa.5.0, %_upb_Decoder_ReadString2.exit ], [ %.sroa.5.0, %bb.av ], [ %.sroa.5.0, %bb.au ], [ %.sroa.5.0, %_upb_Decoder_Reserve.exit83 ], [ %.sroa.5.0, %bb.bv ], [ %.sroa.5.0, %_upb_Message_AddUnknown_dont_copy_me__upb_internal_use_only.exit.thread.i ], [ %.sroa.5.4, %upb_WireReader_ReadTag.exit.i ]
  %.sroa.0197.3 = phi ptr [ %.sroa.0197.0, %_upb_Message_AddUnknown_dont_copy_me__upb_internal_use_only.exit.i ], [ %.sroa.0197.0, %_upb_Decoder_DecodeToMap.exit ], [ %.sroa.0197.0, %bb.el ], [ %.sroa.0197.0, %bb.ek ], [ %.sroa.0197.0, %bb.ej ], [ %.sroa.0197.0, %_upb_Decoder_ReadString2.exit127 ], [ %.sroa.0197.0, %bb.eb ], [ %.sroa.0197.0, %_upb_Decoder_RecurseSubMessage.exit52.i ], [ %.sroa.0197.0, %_upb_Decoder_RecurseSubMessage.exit.i56 ], [ %.sroa.0197.0, %bb.ck ], [ %.sroa.0197.0, %_upb_Decoder_DecodeVarintPacked.exit.i ], [ %.sroa.0197.0, %_upb_Decoder_RecurseSubMessage.exit73.i ], [ %.sroa.0197.0, %_upb_Decoder_RecurseSubMessage.exit.i ], [ %.sroa.0197.0, %_upb_Decoder_ReadString2.exit ], [ %.sroa.0197.0, %bb.av ], [ %.sroa.0197.0, %bb.au ], [ %.sroa.0197.0, %_upb_Decoder_Reserve.exit83 ], [ %.sroa.0197.0, %bb.bv ], [ %.sroa.0197.0, %_upb_Message_AddUnknown_dont_copy_me__upb_internal_use_only.exit.thread.i ], [ %.sroa.0197.4, %upb_WireReader_ReadTag.exit.i ]
  %.sroa.4.3 = phi i64 [ %.sroa.4.0, %_upb_Message_AddUnknown_dont_copy_me__upb_internal_use_only.exit.i ], [ %.sroa.4.0, %_upb_Decoder_DecodeToMap.exit ], [ %.sroa.4.0, %bb.el ], [ %.sroa.4.0, %bb.ek ], [ %.sroa.4.0, %bb.ej ], [ %.sroa.4.0, %_upb_Decoder_ReadString2.exit127 ], [ %.sroa.4.0, %bb.eb ], [ %.sroa.4.0, %_upb_Decoder_RecurseSubMessage.exit52.i ], [ %.sroa.4.0, %_upb_Decoder_RecurseSubMessage.exit.i56 ], [ %.sroa.4.0, %bb.ck ], [ %.sroa.4.0, %_upb_Decoder_DecodeVarintPacked.exit.i ], [ %.sroa.4.0, %_upb_Decoder_RecurseSubMessage.exit73.i ], [ %.sroa.4.0, %_upb_Decoder_RecurseSubMessage.exit.i ], [ %.sroa.4.0, %_upb_Decoder_ReadString2.exit ], [ %.sroa.4.0, %bb.av ], [ %.sroa.4.0, %bb.au ], [ %.sroa.4.6, %_upb_Decoder_Reserve.exit83 ], [ %.sroa.4.6, %bb.bv ], [ %.sroa.4.0, %_upb_Message_AddUnknown_dont_copy_me__upb_internal_use_only.exit.thread.i ], [ %.sroa.4.0, %upb_WireReader_ReadTag.exit.i ]
  %.sroa.0188.3 = phi ptr [ %.sroa.0188.0, %_upb_Message_AddUnknown_dont_copy_me__upb_internal_use_only.exit.i ], [ %.sroa.0188.0, %_upb_Decoder_DecodeToMap.exit ], [ %.sroa.0188.0, %bb.el ], [ %.sroa.0188.0, %bb.ek ], [ %.sroa.0188.0, %bb.ej ], [ %.sroa.0188.0, %_upb_Decoder_ReadString2.exit127 ], [ %.sroa.0188.0, %bb.eb ], [ %.sroa.0188.0, %_upb_Decoder_RecurseSubMessage.exit52.i ], [ %.sroa.0188.0, %_upb_Decoder_RecurseSubMessage.exit.i56 ], [ %.sroa.0188.0, %bb.ck ], [ %.sroa.0188.0, %_upb_Decoder_DecodeVarintPacked.exit.i ], [ %.sroa.0188.0, %_upb_Decoder_RecurseSubMessage.exit73.i ], [ %.sroa.0188.0, %_upb_Decoder_RecurseSubMessage.exit.i ], [ %.sroa.0188.0, %_upb_Decoder_ReadString2.exit ], [ %.sroa.0188.0, %bb.av ], [ %.sroa.0188.0, %bb.au ], [ %.sroa.0188.6, %_upb_Decoder_Reserve.exit83 ], [ %.sroa.0188.6, %bb.bv ], [ %.sroa.0188.0, %_upb_Message_AddUnknown_dont_copy_me__upb_internal_use_only.exit.thread.i ], [ %.sroa.0188.0, %upb_WireReader_ReadTag.exit.i ]
  %.0.i15 = phi ptr [ %.026.i, %_upb_Message_AddUnknown_dont_copy_me__upb_internal_use_only.exit.i ], [ %i.tv, %_upb_Decoder_DecodeToMap.exit ], [ %.1.i251, %bb.el ], [ %.1.i251, %bb.ek ], [ %.1.i251, %bb.ej ], [ %.0.i.i.i118, %_upb_Decoder_ReadString2.exit127 ], [ %i.yz, %bb.eb ], [ %i.yq, %_upb_Decoder_RecurseSubMessage.exit52.i ], [ %i.xp, %_upb_Decoder_RecurseSubMessage.exit.i56 ], [ %i.ri, %bb.ck ], [ %.1216254, %_upb_Decoder_DecodeVarintPacked.exit.i ], [ %i.mz, %_upb_Decoder_RecurseSubMessage.exit73.i ], [ %i.lz, %_upb_Decoder_RecurseSubMessage.exit.i ], [ %.0.i.i.i89, %_upb_Decoder_ReadString2.exit ], [ %i.ix, %bb.av ], [ %.1.i251, %bb.au ], [ %.0.i84, %_upb_Decoder_Reserve.exit83 ], [ %.0.i84, %bb.bv ], [ %.026.i, %_upb_Message_AddUnknown_dont_copy_me__upb_internal_use_only.exit.thread.i ], [ %.0.i.i65, %upb_WireReader_ReadTag.exit.i ] ; 2 uses
