...
bb.c:                                             ; preds = %_ZNK4absl12lts_2025051214flags_internal8FlagImpl9DataGuardEv.exit
  ...
  %i.i = icmp eq ptr %i.h, @_ZN4absl12lts_2025051213base_internal11FastTypeTagISt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS9_EEE9kDummyVarE
  %19 = bitcast <8 x i1> %14 to i8
  %20 = icmp ne i8 %19, 0
  %op.rdx = or i1 %20, %15
  %op.rdx60 = or i1 %16, %17
  %op.rdx61 = or i1 %18, %i.i
