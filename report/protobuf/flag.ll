...
bb.d:                                             ; preds = %bb.c
  ...
  %i.i = load ptr, ptr %i.f, align 8, !tbaa !25   ; 2 uses
  %i.j = invoke noundef ptr %i.i(i32 noundef 0, ptr noundef null, ptr noundef null, ptr noundef null)
          to label %.noexc unwind label %bb.k, !inline_history !113 ; 3 uses

.noexc:                                           ; preds = %bb.d
  %i.k = invoke noundef ptr %i.i(i32 noundef 3, ptr noundef %1, ptr noundef %i.j, ptr noundef null)
...
_ZN4absl12lts_2025051214flags_internal5CloneEPFPvNS1_6FlagOpEPKvS2_S2_ES5_.exit: ; preds = %.noexc
  ...
  invoke void @_ZN4absl12lts_2025051214flags_internal15DynValueDeleterC1EPFPvNS1_6FlagOpEPKvS3_S3_E(ptr noundef nonnull align 8 dereferenceable(8) %4, ptr noundef %i.l)
          to label %bb.e unwind label %bb.l

bb.e:                                             ; preds = %_ZN4absl12lts_2025051214flags_internal5CloneEPFPvNS1_6FlagOpEPKvS2_S2_ES5_.exit
  %i.m = load i64, ptr %4, align 8, !tbaa !65
  store i64 %i.m, ptr %3, align 8, !tbaa !65
  %i.n = getelementptr inbounds nuw i8, ptr %3, i64 8 ; 2 uses
  store ptr %i.j, ptr %i.n, align 8, !tbaa !60
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #23
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #23
  %i.o = getelementptr inbounds nuw i8, ptr %5, i64 16 ; 6 uses
  store ptr %i.o, ptr %5, align 8, !tbaa !81
  %i.p = getelementptr inbounds nuw i8, ptr %5, i64 8
  store i64 0, ptr %i.p, align 8, !tbaa !82
  store i8 0, ptr %i.o, align 8, !tbaa !24
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #23
  %i.q = load ptr, ptr %i.f, align 8, !tbaa !25
  %i.r = getelementptr inbounds nuw i8, ptr %6, i64 16 ; 7 uses
  store ptr %i.r, ptr %6, align 8, !tbaa !81, !alias.scope !141
  %i.s = getelementptr inbounds nuw i8, ptr %6, i64 8 ; 3 uses
  store i64 0, ptr %i.s, align 8, !tbaa !82, !alias.scope !141
  store i8 0, ptr %i.r, align 8, !tbaa !24, !alias.scope !141
  %i.t = invoke noundef ptr %i.q(i32 noundef 8, ptr noundef %1, ptr noundef nonnull align 8 %6, ptr noundef null)
...
bb.f:                                             ; preds = %bb.e
  %i.u = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.v = load ptr, ptr %6, align 8, !tbaa !52, !alias.scope !141 ; 2 uses
...
_ZN4absl12lts_2025051214flags_internal7UnparseB5cxx11EPFPvNS1_6FlagOpEPKvS2_S2_ES5_.exit: ; preds = %bb.e
  %i.x = load ptr, ptr %i.f, align 8, !tbaa !25
  %i.y = load ptr, ptr %6, align 8, !tbaa !52
  %i.z = load i64, ptr %i.s, align 8, !tbaa !82
  call void @llvm.lifetime.start.p0(ptr nonnull %2)
  store i64 %i.z, ptr %2, align 8
  %i.aa = getelementptr inbounds nuw i8, ptr %2, i64 8
  store ptr %i.y, ptr %i.aa, align 8
  %i.ab = invoke noundef ptr %i.x(i32 noundef 7, ptr noundef nonnull %2, ptr noundef %i.j, ptr noundef nonnull %5)
...
bb.h:                                             ; preds = %bb.g
  ...
  store ptr @.str.8, ptr %i.ac, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %9) #23
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.ae = load ptr, ptr %i.ad, align 8, !tbaa !48 ; 2 uses
  %i.af = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %i.ae) #23
  store i64 %i.af, ptr %9, align 8, !tbaa !49
  %.sroa.2.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %9, i64 8
  store ptr %i.ae, ptr %.sroa.2.0..sroa_idx.i, align 8, !tbaa !50
  call void @llvm.lifetime.start.p0(ptr nonnull %10) #23
  store i64 19, ptr %10, align 8
  %i.ag = getelementptr inbounds nuw i8, ptr %10, i64 8
  store ptr @.str.9, ptr %i.ag, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %11) #23
  %i.ah = load ptr, ptr %6, align 8, !tbaa !52
  %i.ai = load i64, ptr %i.s, align 8, !tbaa !82
  store i64 %i.ai, ptr %11, align 8
...
bb.i:                                             ; preds = %bb.h
  ...
  invoke void %i.ak(i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 608, ptr noundef nonnull align 8 dereferenceable(32) %7)
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %_ZNK4absl12lts_2025051213base_internal10AtomicHookIPFvNS0_11LogSeverityEPKciRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEclIJS3_RKS5_iSB_EEEvDpOT_.exit
  %i.ao = load i64, ptr %i.am, align 8, !tbaa !24
  %i.ap = add i64 %i.ao, 1
...
bb.o:                                             ; preds = %bb.i
  %i.av = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.aw = load ptr, ptr %7, align 8, !tbaa !52    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i27: ; preds = %bb.o
  %i.az = load i64, ptr %i.ax, align 8, !tbaa !24
  %i.ba = add i64 %i.az, 1
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit29: ; preds = %bb.o, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i27, %bb.n
  %.pn = phi { ptr, i32 } [ %i.au, %bb.n ], [ %i.av, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i27 ], [ %i.av, %bb.o ]
  call void @llvm.lifetime.end.p0(ptr nonnull %11) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #23
...
bb.p:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %bb.g
  %i.bb = load ptr, ptr %6, align 8, !tbaa !52    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i30: ; preds = %bb.p
  %i.bd = load i64, ptr %i.r, align 8, !tbaa !24
  %i.be = add i64 %i.bd, 1
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit32: ; preds = %bb.p, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i30
  ...
  %i.bf = load ptr, ptr %5, align 8, !tbaa !52    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i33: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit32
  %i.bh = load i64, ptr %i.o, align 8, !tbaa !24
  %i.bi = add i64 %i.bh, 1
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit35: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit32, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i33
  ...
  %i.bj = load ptr, ptr %i.n, align 8, !tbaa !65  ; 2 uses
...
bb.q:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit35
  ...
  br i1 %i.bl, label %_ZNSt10unique_ptrIvN4absl12lts_2025051214flags_internal15DynValueDeleterEED2Ev.exit, label %bb.r
