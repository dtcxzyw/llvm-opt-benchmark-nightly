...
_ZN4absl12lts_2025051218debugging_internal12_GLOBAL__N_116RustSymbolParser3EatEc.exit: ; preds = %bb.a, %bb.b
  %i.j = phi i8 [ %i.h, %bb.a ], [ %.pre88, %bb.b ]
...
_ZN4absl12lts_2025051218debugging_internal12_GLOBAL__N_116RustSymbolParser4EmitEPKc.exit.thread: ; preds = %bb.p, %bb.r, %bb.t, %bb.o, %bb.m, %bb.l, %bb.j
  %i.cg = icmp slt i32 %.0.ph, 1
  %i.ch = getelementptr inbounds nuw i8, ptr %0, i64 396
  %i.ci = load i32, ptr %i.ch, align 4
  %i.cj = icmp sgt i32 %i.ci, 0
  %or.cond73 = select i1 %i.cg, i1 true, i1 %i.cj
  br i1 %or.cond73, label %_ZN4absl12lts_2025051218debugging_internal12_GLOBAL__N_116RustSymbolParser4EmitEPKc.exit40.thread, label %bb.u
...
bb.u:                                             ; preds = %_ZN4absl12lts_2025051218debugging_internal12_GLOBAL__N_116RustSymbolParser4EmitEPKc.exit.thread
  ...
  br i1 %.not.i38, label %.critedge, label %bb.v
...
_ZN4absl12lts_2025051218debugging_internal12_GLOBAL__N_116RustSymbolParser4EmitEPKc.exit40.thread: ; preds = %bb.v, %_ZN4absl12lts_2025051218debugging_internal12_GLOBAL__N_116RustSymbolParser4EmitEPKc.exit.thread, %bb.h
  %.not2381 = icmp sgt i32 %.0.ph, 0
  %or.cond84 = select i1 %.not.i, i1 %.not2381, i1 false
  br i1 %or.cond84, label %.lr.ph, label %.critedge27
...
bb.w:                                             ; preds = %.lr.ph, %bb.aa
  %.01882 = phi i32 [ 0, %.lr.ph ], [ %i.dt, %bb.aa ]
  ...
  %spec.select.i.not78 = and i1 %i.dh, %i.dg
  %.not75 = and i1 %i.de, %spec.select.i.not78
  %i.di = icmp sgt i8 %i.db, -1
  %or.cond = and i1 %i.di, %.not75
  br i1 %or.cond, label %.critedge, label %bb.x

bb.x:                                             ; preds = %bb.w
  %i.dj = load i32, ptr %i.ct, align 4, !tbaa !18
  %i.dk = icmp sgt i32 %i.dj, 0
  br i1 %i.dk, label %bb.aa, label %bb.y
