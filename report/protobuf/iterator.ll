...
bb.k:                                             ; preds = %bb.i
  %5 = load i64, ptr %i.l, align 1
  %6 = load i64, ptr %i.a, align 16
  %7 = icmp ne i64 %5, %6
  %8 = zext i1 %7 to i32
  %i.au = icmp eq i32 %8, 0
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #5
...
_upb_MiniTableField_DataIsZero_dont_copy_me__upb_internal_use_only.exit: ; preds = %bb.i
  %9 = load i32, ptr %i.l, align 1
  %10 = load i32, ptr %i.a, align 16
  %11 = icmp ne i32 %9, %10
  %12 = zext i1 %11 to i32
  %i.aw = icmp eq i32 %12, 0
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #5
...
bb.o:                                             ; preds = %bb.m
  %i.ba = tail call i64 @upb_Map_Size(ptr noundef %.sroa.0.1) #5
