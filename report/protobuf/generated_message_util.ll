...
begin_hunk_0_@_ZN6google8protobuf8internal11GenericSwapEPNS0_11MessageLiteES3_:bb.a
  ...
  %i.g = load i32, ptr %i.e, align 8, !tbaa !67
...
bb.c:                                             ; preds = %bb.a
  %2 = load i32, ptr %i.e, align 8, !tbaa !67     ; 6 uses
  %3 = zext i32 %2 to i64                         ; 11 uses
  %i.p = icmp eq i8 %i.k, 0
  %i.q = icmp ult i32 %2, 33                      ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.w = getelementptr inbounds nuw i8, ptr %i.i, i64 %3
...
._crit_edge65.i15.i:                              ; preds = %.lr.ph64.i16.i, %.preheader.i14.i
  %i.y = getelementptr inbounds nuw i8, ptr %i.i, i64 %3
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ah = getelementptr inbounds nuw i8, ptr %i.f, i64 %3
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.an = getelementptr inbounds nuw i8, ptr %i.i, i64 %3
...
._crit_edge.i10.i:                                ; preds = %.lr.ph.i12.i, %.preheader61.i9.i
  %i.ar = getelementptr inbounds nuw i8, ptr %i.i, i64 %3
  %i.as = getelementptr inbounds i8, ptr %i.ar, i64 -64
  %i.at = getelementptr inbounds nuw i8, ptr %i.f, i64 %3
