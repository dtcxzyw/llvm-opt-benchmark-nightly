...
bb.a:
  ...
  %.promoted = load <16 x i8>, ptr %i.h, align 16
  %.promoted107 = load <16 x i8>, ptr %i.k, align 16
  %.promoted109 = load <16 x i8>, ptr %i.o, align 16
  br label %.preheader

.preheader:                                       ; preds = %bb.a, %_ZN12_GLOBAL__N_112FeistelRoundEPN4absl12lts_202505127uint128EPKS2_.exit
  %.sroa.094.0.copyload110 = phi <16 x i8> [ %.promoted109, %bb.a ], [ %.sroa.094.0.copyload, %_ZN12_GLOBAL__N_112FeistelRoundEPN4absl12lts_202505127uint128EPKS2_.exit ]
  %.sroa.098.0.copyload108 = phi <16 x i8> [ %.promoted107, %bb.a ], [ %.sroa.098.0.copyload, %_ZN12_GLOBAL__N_112FeistelRoundEPN4absl12lts_202505127uint128EPKS2_.exit ]
  %.sroa.0104.0.copyload106 = phi <16 x i8> [ %.promoted, %bb.a ], [ %.sroa.0104.0.copyload, %_ZN12_GLOBAL__N_112FeistelRoundEPN4absl12lts_202505127uint128EPKS2_.exit ]
...
_ZN12_GLOBAL__N_112FeistelRoundEPN4absl12lts_202505127uint128EPKS2_.exit: ; preds = %bb.b
  %.sroa.0104.0.copyload = load <16 x i8>, ptr %i.g, align 16 ; 2 uses
  %.sroa.0100.0.copyload = load <16 x i8>, ptr %1, align 16
  %.sroa.098.0.copyload = load <16 x i8>, ptr %i.j, align 16 ; 2 uses
  %.sroa.094.0.copyload = load <16 x i8>, ptr %i.l, align 16 ; 2 uses
  %.sroa.092.0.copyload = load <16 x i8>, ptr %i.n, align 16
  ...
  store <16 x i8> %.sroa.0104.0.copyload, ptr %i.h, align 16
  store <16 x i8> %.sroa.0104.0.copyload106, ptr %i.a, align 16
  ...
  store <16 x i8> %.sroa.0100.0.copyload, ptr %i.j, align 16
  store <16 x i8> %.sroa.098.0.copyload, ptr %i.k, align 16
  store <16 x i8> %.sroa.098.0.copyload108, ptr %i.e, align 16
  store <16 x i8> %.sroa.094.0.copyload, ptr %i.o, align 16
  ...
  store <16 x i8> %.sroa.092.0.copyload, ptr %i.m, align 16
  store <16 x i8> %.sroa.094.0.copyload110, ptr %i.i, align 16
