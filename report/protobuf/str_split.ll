...
bb.i:                                             ; preds = %bb.e
  %i.w = getelementptr inbounds nuw i8, ptr %2, i64 %1 ; 6 uses
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i.i.i.a: ; preds = %bb.k, %.lr.ph.i.i.i.i
  ...
  %reass.sub = sub i64 %.033.i.i.i.i, %i.b
  %i.ac = add i64 %reass.sub, 1
  %4 = tail call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02132.i.i.i.i, i32 noundef %i.aa, i64 noundef %i.ac) #11 ; 4 uses
  %.not26.i.i.i.i.a = icmp eq ptr %4, null
  br i1 %.not26.i.i.i.i.a, label %_ZN4absl12lts_2025051212_GLOBAL__N_111GenericFindINS1_13LiteralPolicyEEESt17basic_string_viewIcSt11char_traitsIcEES7_S7_mT_.exit, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i
