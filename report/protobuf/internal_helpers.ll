...
bb.a:
  ...
  %i.a = tail call noundef zeroext i1 @_ZNK6google8protobuf15FieldDescriptor11is_requiredEv(ptr noundef nonnull align 8 dereferenceable(88) %0)
  %i.b = select i1 %i.a, i32 256, i32 0           ; 3 uses
...
begin_hunk_2_@_ZN6google8protobuf8compiler4java28GetExperimentalJavaFieldTypeEPKNS0_15FieldDescriptorE:bb.a
  ...
  %3 = zext nneg i8 %i.ae to i32
  %4 = shl nuw nsw i32 %3, 9
  %spec.select = or disjoint i32 %4, %i.b
  br label %bb.f
