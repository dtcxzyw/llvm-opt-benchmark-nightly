...
.noexc20:                                         ; preds = %_ZNSt6vectorIN6google8protobuf8compiler9ZipWriter8FileInfoESaIS4_EE9push_backERKS4_.exit
  %i.ch = getelementptr inbounds nuw i8, ptr %4, i64 72
  ...
  %i.ci = load ptr, ptr %i.bt, align 8, !tbaa !29
  %i.cj = getelementptr inbounds nuw i8, ptr %i.ci, i64 16
  %i.ck = load ptr, ptr %i.cj, align 8
  %i.cl = invoke noundef zeroext i1 %i.ck(ptr noundef nonnull align 8 dereferenceable(8) %i.bt, ptr noundef nonnull %i.h, ptr noundef nonnull %i.i)
          to label %.noexc21 unwind label %bb.au, !inline_history !49

.noexc21:                                         ; preds = %.noexc20
  %i.cm = load i32, ptr %i.i, align 4             ; 3 uses
  %i.cn = icmp sgt i32 %i.cm, 0
  %i.co = select i1 %i.cl, i1 %i.cn, i1 false, !prof !52
  br i1 %i.co, label %bb.g, label %.noexc21._crit_edge, !prof !52

.noexc21._crit_edge:                              ; preds = %.noexc21
  %.pre = load ptr, ptr %i.bv, align 8, !tbaa !53
  %.pre67 = load ptr, ptr %4, align 8, !tbaa !39
  br label %bb.h

bb.g:                                             ; preds = %.noexc21
  %i.cp = load ptr, ptr %i.h, align 8, !tbaa !54  ; 3 uses
  %i.cq = icmp samesign ugt i32 %i.cm, 16         ; 3 uses
  ...
  %i.cu = getelementptr inbounds nuw i8, ptr %i.bw, i64 %i.cr
  %.sink9.i.i.i = select i1 %i.cq, ptr %i.ct, ptr %i.cu ; 2 uses
  %.sink.i.i.i = select i1 %i.cq, ptr null, ptr %i.cp
  %.0.i.i.i = select i1 %i.cq, ptr %i.cp, ptr %i.bw ; 2 uses
  store ptr %.sink9.i.i.i, ptr %4, align 8, !tbaa !39
  store ptr %.sink.i.i.i, ptr %i.bx, align 8, !tbaa !42
  store ptr %.0.i.i.i, ptr %i.bv, align 8, !tbaa !53
  br label %bb.h

bb.h:                                             ; preds = %.noexc21._crit_edge, %bb.g
  %i.cv = phi ptr [ %.pre67, %.noexc21._crit_edge ], [ %.sink9.i.i.i, %bb.g ]
  %i.cw = phi ptr [ %.pre, %.noexc21._crit_edge ], [ %.0.i.i.i, %bb.g ] ; 3 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.i) #16
  call void @llvm.lifetime.end.p0(ptr nonnull %i.h) #16
  %.not.i.i = icmp ult ptr %i.cw, %i.cv
  br i1 %.not.i.i, label %bb.j, label %bb.i, !prof !52
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  %i.cw = load ptr, ptr %1, align 8, !tbaa !39
  %i.cx = ptrtoint ptr %i.cw to i64
  %i.cy = ptrtoint ptr %.0.i.i.i28 to i64
  %i.cz = sub i64 %i.cx, %i.cy
  %i.da = icmp slt i64 %i.cz, 2
  br i1 %i.da, label %bb.n, label %bb.o, !prof !55

bb.n:                                             ; preds = %bb.m
  %i.db = invoke noundef ptr @_ZN6google8protobuf2io19EpsCopyOutputStream16WriteRawFallbackEPKviPh(ptr noundef nonnull align 8 dereferenceable(80) %1, ptr noundef nonnull %i.m, i32 noundef 2, ptr noundef %.0.i.i.i28)
          to label %bb.p unwind label %bb.ay

bb.o:                                             ; preds = %bb.m
  store i16 0, ptr %.0.i.i.i28, align 1
  %i.dc = getelementptr inbounds nuw i8, ptr %.0.i.i.i28, i64 2
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %bb.n
  %.0.i.i.i31 = phi ptr [ %i.dc, %bb.o ], [ %i.db, %bb.n ] ; 5 uses
  store ptr %.0.i.i.i31, ptr %i.aj, align 8, !tbaa !53
  ...
  %i.dd = load ptr, ptr %1, align 8, !tbaa !39
  %i.de = ptrtoint ptr %i.dd to i64
  %i.df = ptrtoint ptr %.0.i.i.i31 to i64
  %i.dg = sub i64 %i.de, %i.df
  %i.dh = icmp slt i64 %i.dg, 2
  br i1 %i.dh, label %bb.q, label %bb.r, !prof !55

bb.q:                                             ; preds = %bb.p
  %i.di = invoke noundef ptr @_ZN6google8protobuf2io19EpsCopyOutputStream16WriteRawFallbackEPKviPh(ptr noundef nonnull align 8 dereferenceable(80) %1, ptr noundef nonnull %i.l, i32 noundef 2, ptr noundef %.0.i.i.i31)
          to label %bb.s unwind label %bb.ay

bb.r:                                             ; preds = %bb.p
  store i16 0, ptr %.0.i.i.i31, align 1
  %i.dj = getelementptr inbounds nuw i8, ptr %.0.i.i.i31, i64 2
  br label %bb.s

bb.s:                                             ; preds = %bb.r, %bb.q
  %.0.i.i.i34 = phi ptr [ %i.dj, %bb.r ], [ %i.di, %bb.q ] ; 5 uses
  store ptr %.0.i.i.i34, ptr %i.aj, align 8, !tbaa !53
  call void @llvm.lifetime.end.p0(ptr nonnull %i.l) #16
  call void @llvm.lifetime.start.p0(ptr nonnull %i.k) #16
  store i16 33, ptr %i.k, align 2
  %i.dk = load ptr, ptr %1, align 8, !tbaa !39
  %i.dl = ptrtoint ptr %i.dk to i64
  %i.dm = ptrtoint ptr %.0.i.i.i34 to i64
  %i.dn = sub i64 %i.dl, %i.dm
  %i.do = icmp slt i64 %i.dn, 2
  br i1 %i.do, label %bb.t, label %bb.u, !prof !55

bb.t:                                             ; preds = %bb.s
  %i.dp = invoke noundef ptr @_ZN6google8protobuf2io19EpsCopyOutputStream16WriteRawFallbackEPKviPh(ptr noundef nonnull align 8 dereferenceable(80) %1, ptr noundef nonnull %i.k, i32 noundef 2, ptr noundef %.0.i.i.i34)
          to label %bb.v unwind label %bb.ay

bb.u:                                             ; preds = %bb.s
  store i16 33, ptr %.0.i.i.i34, align 1
  %i.dq = getelementptr inbounds nuw i8, ptr %.0.i.i.i34, i64 2
  br label %bb.v

bb.v:                                             ; preds = %bb.u, %bb.t
  %.0.i.i.i37 = phi ptr [ %i.dq, %bb.u ], [ %i.dp, %bb.t ] ; 4 uses
  store ptr %.0.i.i.i37, ptr %i.aj, align 8, !tbaa !53
  call void @llvm.lifetime.end.p0(ptr nonnull %i.k) #16
  %i.dr = load ptr, ptr %1, align 8, !tbaa !39
  %.not.i.i40 = icmp ult ptr %.0.i.i.i37, %i.dr
  br i1 %.not.i.i40, label %bb.x, label %bb.w, !prof !52

bb.w:                                             ; preds = %bb.v
  %i.ds = invoke noundef ptr @_ZN6google8protobuf2io19EpsCopyOutputStream19EnsureSpaceFallbackEPh(ptr noundef nonnull align 8 dereferenceable(80) %1, ptr noundef %.0.i.i.i37)
          to label %bb.x unwind label %bb.ay

bb.x:                                             ; preds = %bb.v, %bb.w
  %.0.i.i41 = phi ptr [ %.0.i.i.i37, %bb.v ], [ %i.ds, %bb.w ] ; 2 uses
  store i32 %i.bt, ptr %.0.i.i41, align 1
  %i.dt = getelementptr inbounds nuw i8, ptr %.0.i.i41, i64 4 ; 4 uses
  store ptr %i.dt, ptr %i.aj, align 8, !tbaa !53
  %i.du = load ptr, ptr %1, align 8, !tbaa !39
  %.not.i.i44 = icmp ult ptr %i.dt, %i.du
  br i1 %.not.i.i44, label %bb.z, label %bb.y, !prof !52

bb.y:                                             ; preds = %bb.x
  %i.dv = invoke noundef ptr @_ZN6google8protobuf2io19EpsCopyOutputStream19EnsureSpaceFallbackEPh(ptr noundef nonnull align 8 dereferenceable(80) %1, ptr noundef nonnull %i.dt)
          to label %bb.z unwind label %bb.ay

bb.z:                                             ; preds = %bb.x, %bb.y
  %.0.i.i45 = phi ptr [ %i.dt, %bb.x ], [ %i.dv, %bb.y ] ; 2 uses
  store i32 %i.bv, ptr %.0.i.i45, align 1
  %i.dw = getelementptr inbounds nuw i8, ptr %.0.i.i45, i64 4 ; 4 uses
  store ptr %i.dw, ptr %i.aj, align 8, !tbaa !53
  %i.dx = load ptr, ptr %1, align 8, !tbaa !39
  %.not.i.i48 = icmp ult ptr %i.dw, %i.dx
  br i1 %.not.i.i48, label %bb.ab, label %bb.aa, !prof !52

bb.aa:                                            ; preds = %bb.z
  %i.dy = invoke noundef ptr @_ZN6google8protobuf2io19EpsCopyOutputStream19EnsureSpaceFallbackEPh(ptr noundef nonnull align 8 dereferenceable(80) %1, ptr noundef nonnull %i.dw)
          to label %bb.ab unwind label %bb.ay

bb.ab:                                            ; preds = %bb.z, %bb.aa
  %.0.i.i49 = phi ptr [ %i.dw, %bb.z ], [ %i.dy, %bb.aa ] ; 3 uses
  store i32 %i.bv, ptr %.0.i.i49, align 1
  %i.dz = getelementptr inbounds nuw i8, ptr %.0.i.i49, i64 4 ; 4 uses
  store ptr %i.dz, ptr %i.aj, align 8, !tbaa !53
  call void @llvm.lifetime.start.p0(ptr nonnull %i.j) #16
  store i16 %i.br, ptr %i.j, align 2
  %i.ea = load ptr, ptr %1, align 8, !tbaa !39
  %i.eb = ptrtoint ptr %i.ea to i64
  %i.ec = ptrtoint ptr %i.dz to i64
  %i.ed = sub i64 %i.eb, %i.ec
end_hunk_1
begin_hunk_2_@_ZNSt6vectorIN6google8protobuf8compiler9ZipWriter8FileInfoESaIS4_EE17_M_realloc_insertIJRKS4_EEEvN9__gnu_cxx17__normal_iteratorIPS4_S6_EEDpOT_:bb.a
  store i64 %i.y, ptr %i.s, align 8, !tbaa !23
  br label %._crit_edge.i.i.i

._crit_edge.i.i.i:                                ; preds = %.noexc, %_ZNKSt6vectorIN6google8protobuf8compiler9ZipWriter8FileInfoESaIS4_EE12_M_check_lenEmPKc.exit
  %i.z = phi ptr [ %i.x, %.noexc ], [ %i.s, %_ZNKSt6vectorIN6google8protobuf8compiler9ZipWriter8FileInfoESaIS4_EE12_M_check_lenEmPKc.exit ] ; 2 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c, %._crit_edge.i.i.i
  ...
  store i64 %i.ab, ptr %i.ac, align 8, !tbaa !28
...
.lr.ph.i.i.i:                                     ; preds = %bb.e, %_ZSt19__relocate_object_aIN6google8protobuf8compiler9ZipWriter8FileInfoES4_SaIS4_EEvPT_PT0_RT1_.exit.i.i.i
  %.012.i.i.i = phi ptr [ %i.aw, %_ZSt19__relocate_object_aIN6google8protobuf8compiler9ZipWriter8FileInfoES4_SaIS4_EEvPT_PT0_RT1_.exit.i.i.i ], [ %i.q, %bb.e ] ; 6 uses
  %.0911.i.i.i = phi ptr [ %i.av, %_ZSt19__relocate_object_aIN6google8protobuf8compiler9ZipWriter8FileInfoES4_SaIS4_EEvPT_PT0_RT1_.exit.i.i.i ], [ %i.d, %bb.e ] ; 8 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !58)
  call void @llvm.experimental.noalias.scope.decl(metadata !61)
  %i.ah = getelementptr inbounds nuw i8, ptr %.012.i.i.i, i64 16 ; 3 uses
  store ptr %i.ah, ptr %.012.i.i.i, align 8, !tbaa !27, !alias.scope !58, !noalias !61
  %i.ai = load ptr, ptr %.0911.i.i.i, align 8, !tbaa !18, !alias.scope !61, !noalias !58 ; 2 uses
...
bb.f:                                             ; preds = %.lr.ph.i.i.i
  ...
  %i.am = load i64, ptr %i.al, align 8, !tbaa !28, !alias.scope !61, !noalias !58 ; 3 uses
  %i.an = icmp ult i64 %i.am, 16
  call void @llvm.assume(i1 %i.an)
  %i.ao = add nuw nsw i64 %i.am, 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.ah, ptr noundef nonnull align 8 dereferenceable(1) %i.aj, i64 %i.ao, i1 false), !alias.scope !63
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i: ; preds = %.lr.ph.i.i.i
  store ptr %i.ai, ptr %.012.i.i.i, align 8, !tbaa !18, !alias.scope !58, !noalias !61
  %i.ap = load i64, ptr %i.aj, align 8, !tbaa !23, !alias.scope !61, !noalias !58
  store i64 %i.ap, ptr %i.ah, align 8, !tbaa !23, !alias.scope !58, !noalias !61
...
_ZSt19__relocate_object_aIN6google8protobuf8compiler9ZipWriter8FileInfoES4_SaIS4_EEvPT_PT0_RT1_.exit.i.i.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i, %bb.f
  ...
  store i64 %i.aq, ptr %i.as, align 8, !tbaa !28, !alias.scope !58, !noalias !61
  store ptr %i.aj, ptr %.0911.i.i.i, align 8, !tbaa !18, !alias.scope !61, !noalias !58
  store i64 0, ptr %i.ar, align 8, !tbaa !28, !alias.scope !61, !noalias !58
  store i8 0, ptr %i.aj, align 8, !tbaa !23, !alias.scope !61, !noalias !58
  %i.at = getelementptr inbounds nuw i8, ptr %.012.i.i.i, i64 32
  %i.au = getelementptr inbounds nuw i8, ptr %.0911.i.i.i, i64 32
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(12) %i.at, ptr noundef nonnull align 8 dereferenceable(12) %i.au, i64 12, i1 false), !alias.scope !63
...
_ZNSt6vectorIN6google8protobuf8compiler9ZipWriter8FileInfoESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit: ; preds = %_ZSt19__relocate_object_aIN6google8protobuf8compiler9ZipWriter8FileInfoES4_SaIS4_EEvPT_PT0_RT1_.exit.i.i.i, %bb.e
  %.0.lcssa.i.i.i = phi ptr [ %i.q, %bb.e ], [ %i.aw, %_ZSt19__relocate_object_aIN6google8protobuf8compiler9ZipWriter8FileInfoES4_SaIS4_EEvPT_PT0_RT1_.exit.i.i.i ]
...
.lr.ph.i.i.i27:                                   ; preds = %_ZNSt6vectorIN6google8protobuf8compiler9ZipWriter8FileInfoESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit, %_ZSt19__relocate_object_aIN6google8protobuf8compiler9ZipWriter8FileInfoES4_SaIS4_EEvPT_PT0_RT1_.exit.i.i.i33
  %.012.i.i.i28 = phi ptr [ %i.bn, %_ZSt19__relocate_object_aIN6google8protobuf8compiler9ZipWriter8FileInfoES4_SaIS4_EEvPT_PT0_RT1_.exit.i.i.i33 ], [ %i.ax, %_ZNSt6vectorIN6google8protobuf8compiler9ZipWriter8FileInfoESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit ] ; 6 uses
  %.0911.i.i.i29 = phi ptr [ %i.bm, %_ZSt19__relocate_object_aIN6google8protobuf8compiler9ZipWriter8FileInfoES4_SaIS4_EEvPT_PT0_RT1_.exit.i.i.i33 ], [ %1, %_ZNSt6vectorIN6google8protobuf8compiler9ZipWriter8FileInfoESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit ] ; 8 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !65)
  call void @llvm.experimental.noalias.scope.decl(metadata !68)
  %i.ay = getelementptr inbounds nuw i8, ptr %.012.i.i.i28, i64 16 ; 3 uses
  store ptr %i.ay, ptr %.012.i.i.i28, align 8, !tbaa !27, !alias.scope !65, !noalias !68
  %i.az = load ptr, ptr %.0911.i.i.i29, align 8, !tbaa !18, !alias.scope !68, !noalias !65 ; 2 uses
  %i.ba = getelementptr inbounds nuw i8, ptr %.0911.i.i.i29, i64 16 ; 5 uses
  %i.bb = icmp eq ptr %i.az, %i.ba
  br i1 %i.bb, label %bb.g, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i30

bb.g:                                             ; preds = %.lr.ph.i.i.i27
  %i.bc = getelementptr inbounds nuw i8, ptr %.0911.i.i.i29, i64 8
  %i.bd = load i64, ptr %i.bc, align 8, !tbaa !28, !alias.scope !68, !noalias !65 ; 3 uses
  %i.be = icmp ult i64 %i.bd, 16
  call void @llvm.assume(i1 %i.be)
  %i.bf = add nuw nsw i64 %i.bd, 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.ay, ptr noundef nonnull align 8 dereferenceable(1) %i.ba, i64 %i.bf, i1 false), !alias.scope !70
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i30: ; preds = %.lr.ph.i.i.i27
  store ptr %i.az, ptr %.012.i.i.i28, align 8, !tbaa !18, !alias.scope !65, !noalias !68
  %i.bg = load i64, ptr %i.ba, align 8, !tbaa !23, !alias.scope !68, !noalias !65
  store i64 %i.bg, ptr %i.ay, align 8, !tbaa !23, !alias.scope !65, !noalias !68
...
_ZSt19__relocate_object_aIN6google8protobuf8compiler9ZipWriter8FileInfoES4_SaIS4_EEvPT_PT0_RT1_.exit.i.i.i33: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i30, %bb.g
  %i.bh = phi i64 [ %i.bd, %bb.g ], [ %.pre.i.i.i.i32, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i30 ]
  %i.bi = getelementptr inbounds nuw i8, ptr %.0911.i.i.i29, i64 8
  %i.bj = getelementptr inbounds nuw i8, ptr %.012.i.i.i28, i64 8
  store i64 %i.bh, ptr %i.bj, align 8, !tbaa !28, !alias.scope !65, !noalias !68
  store ptr %i.ba, ptr %.0911.i.i.i29, align 8, !tbaa !18, !alias.scope !68, !noalias !65
  store i64 0, ptr %i.bi, align 8, !tbaa !28, !alias.scope !68, !noalias !65
  store i8 0, ptr %i.ba, align 8, !tbaa !23, !alias.scope !68, !noalias !65
  %i.bk = getelementptr inbounds nuw i8, ptr %.012.i.i.i28, i64 32
  %i.bl = getelementptr inbounds nuw i8, ptr %.0911.i.i.i29, i64 32
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(12) %i.bk, ptr noundef nonnull align 8 dereferenceable(12) %i.bl, i64 12, i1 false), !alias.scope !70
...
_ZNSt6vectorIN6google8protobuf8compiler9ZipWriter8FileInfoESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit36: ; preds = %_ZSt19__relocate_object_aIN6google8protobuf8compiler9ZipWriter8FileInfoES4_SaIS4_EEvPT_PT0_RT1_.exit.i.i.i33, %_ZNSt6vectorIN6google8protobuf8compiler9ZipWriter8FileInfoESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit
  %.0.lcssa.i.i.i35 = phi ptr [ %i.ax, %_ZNSt6vectorIN6google8protobuf8compiler9ZipWriter8FileInfoESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit ], [ %i.bn, %_ZSt19__relocate_object_aIN6google8protobuf8compiler9ZipWriter8FileInfoES4_SaIS4_EEvPT_PT0_RT1_.exit.i.i.i33 ]
...
bb.h:                                             ; preds = %_ZNSt6vectorIN6google8protobuf8compiler9ZipWriter8FileInfoESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit36
  ...
  call void @_ZdlPvm(ptr noundef nonnull %i.d, i64 noundef %i.br) #15
...
bb.j:                                             ; preds = %.noexc.i.i
  ...
  %i.bw = call ptr @__cxa_begin_catch(ptr %i.bv) #16 ; 0 uses
  call void @_ZdlPvm(ptr noundef nonnull %i.q, i64 noundef %i.p) #15
