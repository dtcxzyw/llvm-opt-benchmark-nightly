...
@.str.26 = private unnamed_addr constant [31 x i8] c"google/protobuf/wrappers.proto\00", align 1
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit: ; preds = %bb.a
  %bcmp.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(4) %.pre, ptr noundef nonnull dereferenceable(4) @.str.18, i64 4)
...
_ZN6google8protobuf8compiler6csharp13IsWrapperTypeEPKNS0_15FieldDescriptorE.exit: ; preds = %bb.i
  %i.u = load ptr, ptr %i.q, align 8, !tbaa !15
  %bcmp.i.i = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(30) %i.u, ptr noundef nonnull dereferenceable(30) @.str.26, i64 30)
