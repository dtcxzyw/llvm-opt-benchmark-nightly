...
_ZNSt5dequeIPKN4absl12lts_2025051213time_internal4cctz9time_zone4ImplESaIS7_EE22_M_reserve_map_at_backEm.exit: ; preds = %bb.c, %bb.d
  ...
  store ptr %3, ptr %i.am, align 8, !tbaa !57
  ...
  store ptr %3, ptr %i.o, align 8, !tbaa !61
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !83   ; 8 uses
  ...
  %i.l = load i64, ptr %i.k, align 8, !tbaa !55   ; 5 uses
  %i.m = shl i64 %i.j, 1
...
bb.o:                                             ; preds = %bb.n
  %i.bb = load ptr, ptr %i.d, align 8, !tbaa !57
