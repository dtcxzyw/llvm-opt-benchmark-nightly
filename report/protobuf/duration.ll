...
bb.o:                                             ; preds = %bb.m, %bb.l, %bb.k, %bb.j, %.thread51.i, %bb.n
  %.sink = phi i64 [ 2, %bb.k ], [ 2, %bb.j ], [ 2, %bb.l ], [ 1, %bb.n ], [ 1, %.thread51.i ], [ 1, %bb.m ]
  %.sroa.12.0.ph = phi i32 [ 4000, %bb.k ], [ 4, %bb.j ], [ 4000000, %bb.l ], [ 0, %bb.n ], [ 0, %.thread51.i ], [ 0, %bb.m ] ; 2 uses
  %.sroa.0.0.ph = phi i64 [ 0, %bb.k ], [ 0, %bb.j ], [ 0, %bb.l ], [ 3600, %bb.n ], [ 60, %.thread51.i ], [ 1, %bb.m ] ; 2 uses
