...
.lr.ph.i.preheader:                               ; preds = %.lr.ph.i.preheader.lr.ph, %_ZN4absl12lts_202505128DurationpLES1_.exit97
  ...
  %.0136211 = phi ptr [ %.sroa.9.0151, %.lr.ph.i.preheader.lr.ph ], [ %i.ba, %_ZN4absl12lts_202505128DurationpLES1_.exit97 ] ; 4 uses
  %.0136211228 = ptrtoint ptr %.0136211 to i64
  %6 = getelementptr i8, ptr %.0136211, i64 %.sroa.0123.0148
  %scevgep = getelementptr i8, ptr %6, i64 %.sroa.9.0151224
  %7 = sub i64 0, %.0136211228
  %scevgep226 = getelementptr i8, ptr %scevgep, i64 %7 ; 2 uses
  br label %.lr.ph.i
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ac = getelementptr inbounds nuw i8, ptr %.1137, i64 1 ; 2 uses
