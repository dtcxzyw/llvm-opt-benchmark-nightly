...
begin_hunk_1_@_ZN4absl12lts_202505125Mutex10UnlockSlowEPNS0_15SynchWaitParamsE:bb.a
  ...
  br i1 %i.az, label %.thread, label %bb.o, !llvm.loop !99
...
begin_hunk_2_@_ZN4absl12lts_202505125Mutex10UnlockSlowEPNS0_15SynchWaitParamsE:bb.a
  ...
  br i1 %i.f, label %.thread.sink.split, label %bb.t
...
begin_hunk_4_@_ZN4absl12lts_202505125Mutex10UnlockSlowEPNS0_15SynchWaitParamsE:bb.a
  ...
  br i1 %i.f, label %.thread.sink.split, label %bb.aj
...
bb.bm:                                            ; preds = %bb.bk
  ...
  br i1 %.not190, label %.thread.sink.split, label %bb.bn
...
.thread.sink.split:                               ; preds = %bb.bm, %bb.bn, %bb.ai, %bb.aj, %bb.s, %bb.v
  ...
  store atomic i64 %.1150.sink, ptr %0 release, align 8
  br label %.thread

.thread:                                          ; preds = %_ZNSt13__atomic_baseIlE21compare_exchange_weakERllSt12memory_orderS2_.exit, %.thread.sink.split
  %.0..0..0.228 = load ptr, ptr %i.a, align 8, !tbaa !98
  %.not201 = icmp eq ptr %.0..0..0.228, inttoptr (i64 1 to ptr)
  br i1 %.not201, label %_ZNK4absl12lts_2025051213base_internal10AtomicHookIPFvlEEclIJRlEEEvDpOT_.exit, label %bb.bo
...
_ZN4absl12lts_202505125Mutex6WakeupEPNS0_13base_internal14PerThreadSynchE.exit: ; preds = %bb.bs, %bb.br
  %.1 = phi i64 [ %.0249, %bb.br ], [ %i.hi, %bb.bs ] ; 4 uses
  %i.hk = load ptr, ptr %i.gz, align 8, !tbaa !57 ; 3 uses
  store ptr null, ptr %i.gz, align 8, !tbaa !57
  %i.hl = getelementptr inbounds nuw i8, ptr %i.gz, i64 28
  store atomic i32 0, ptr %i.hl release, align 4
  tail call void @AbslInternalPerThreadSemPost_lts_20250512(ptr noundef nonnull %i.gz)
  store ptr %i.hk, ptr %i.a, align 8, !tbaa !98
  %.not202 = icmp eq ptr %i.hk, inttoptr (i64 1 to ptr)
...
begin_hunk_8_@_ZN4absl12lts_202505125Mutex10UnlockSlowEPNS0_15SynchWaitParamsE:bb.a
  tail call void %i.ho(i64 noundef %.1), !inline_history !110
  br label %_ZNK4absl12lts_2025051213base_internal10AtomicHookIPFvlEEclIJRlEEEvDpOT_.exit

_ZNK4absl12lts_2025051213base_internal10AtomicHookIPFvlEEclIJRlEEEvDpOT_.exit: ; preds = %_ZNSt13__atomic_baseIlE23compare_exchange_strongERllSt12memory_orderS2_.exit217, %_ZNSt13__atomic_baseIlE23compare_exchange_strongERllSt12memory_orderS2_.exit216, %_ZNK4absl12lts_2025051213base_internal10AtomicHookIPFvPKcPKvlEEclIJRA13_S3_PNS0_5MutexERlEEEvDpOT_.exit, %bb.bt, %.thread
