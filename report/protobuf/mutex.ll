...
.outer.loopexit:                                  ; preds = %_ZN4absl12lts_20250512L4SkipEPNS0_13base_internal14PerThreadSynchE.exit, %bb.an
  %.0151.ph.ph = phi i64 [ %.2153, %_ZN4absl12lts_20250512L4SkipEPNS0_13base_internal14PerThreadSynchE.exit ], [ 32, %bb.an ]
  %.0135.ph.ph = phi ptr [ %.2137, %_ZN4absl12lts_20250512L4SkipEPNS0_13base_internal14PerThreadSynchE.exit ], [ %.1142312, %bb.an ]
  %.0129.ph.ph = phi ptr [ %.2131, %_ZN4absl12lts_20250512L4SkipEPNS0_13base_internal14PerThreadSynchE.exit ], [ %.1145310, %bb.an ]
  br label %.outer

.outer:                                           ; preds = %.outer.preheader, %.outer.loopexit
  %.0151.ph = phi i64 [ %.0151.ph.ph, %.outer.loopexit ], [ 0, %.outer.preheader ] ; 2 uses
  %.0147.ph = phi ptr [ %i.bb, %.outer.loopexit ], [ null, %.outer.preheader ] ; 10 uses
  %.0135.ph = phi ptr [ %.0135.ph.ph, %.outer.loopexit ], [ null, %.outer.preheader ] ; 3 uses
  %.0129.ph = phi ptr [ %.0129.ph.ph, %.outer.loopexit ], [ null, %.outer.preheader ] ; 4 uses
  %.0127.ph = phi i32 [ %.0127, %.outer.loopexit ], [ 0, %.outer.preheader ]
  br label %bb.g

bb.g:                                             ; preds = %.outer, %_ZNSt13__atomic_baseIlE23compare_exchange_strongERllSt12memory_orderS2_.exit
  %.0127 = phi i32 [ %i.gq, %_ZNSt13__atomic_baseIlE23compare_exchange_strongERllSt12memory_orderS2_.exit ], [ %.0127.ph, %.outer ] ; 2 uses
...
_ZNSt13__atomic_baseIlE21compare_exchange_weakERllSt12memory_orderS2_.exit: ; preds = %bb.p, %bb.o
  %.0165 = phi ptr [ %i.ao, %bb.p ], [ null, %bb.o ] ; 2 uses
  %.1161 = phi i1 [ %i.ap, %bb.p ], [ false, %bb.o ]
...
.critedge211:                                     ; preds = %bb.x
  %i.br = getelementptr inbounds nuw i8, ptr %.0147.ph, i64 16 ; 2 uses
...
bb.z:                                             ; preds = %.critedge211
  ...
  %i.bu = getelementptr inbounds nuw i8, ptr %.0147.ph, i64 8 ; 2 uses
...
bb.ab:                                            ; preds = %bb.z
  %.not179 = icmp eq ptr %.0147.ph, %i.bb
  br i1 %.not179, label %.critedge211.thread, label %bb.ac

bb.ac:                                            ; preds = %bb.ab
  %i.bw = load ptr, ptr %.0147.ph, align 8, !tbaa !57 ; 2 uses
  %i.bx = tail call fastcc noundef zeroext i1 @_ZN4absl12lts_20250512L18MuEquivalentWaiterEPNS0_13base_internal14PerThreadSynchES3_(ptr noundef nonnull %.0147.ph, ptr noundef %i.bw)
...
bb.ag:                                            ; preds = %bb.af
  %i.ch = getelementptr inbounds nuw i8, ptr %.0129.ph, i64 32
...
.lr.ph:                                           ; preds = %bb.as, %.lr.ph.preheader
  %.1130314 = phi ptr [ %.2131, %bb.as ], [ %.0129.ph, %.lr.ph.preheader ] ; 4 uses
  %.1136313 = phi ptr [ %.2137, %bb.as ], [ %.0135.ph, %.lr.ph.preheader ] ; 3 uses
  %.1142312 = phi ptr [ %.2143, %bb.as ], [ %.0147.ph, %.lr.ph.preheader ] ; 2 uses
  %.1145310 = phi ptr [ %i.dx, %bb.as ], [ %.0144, %.lr.ph.preheader ] ; 8 uses
  %.1152309 = phi i64 [ %.2153, %bb.as ], [ %.0151.ph, %.lr.ph.preheader ] ; 3 uses
  %i.cx = getelementptr inbounds nuw i8, ptr %.1145310, i64 17 ; 4 uses
  store i8 0, ptr %i.cx, align 1, !tbaa !101
  %i.cy = getelementptr inbounds nuw i8, ptr %.1145310, i64 32 ; 3 uses
...
begin_hunk_10_@_ZN4absl12lts_202505125Mutex10UnlockSlowEPNS0_15SynchWaitParamsE:bb.a
  ...
  br i1 %i.dj, label %.outer.loopexit, label %bb.aq
...
bb.aq:                                            ; preds = %bb.ao, %bb.an, %bb.ap, %_ZN4absl12lts_20250512L20EvalConditionIgnoredEPNS0_5MutexEPKNS0_9ConditionE.exit
  %.2153 = phi i64 [ %.1152309, %bb.an ], [ %.1152309, %bb.ap ], [ %.1152309, %_ZN4absl12lts_20250512L20EvalConditionIgnoredEPNS0_5MutexEPKNS0_9ConditionE.exit ], [ 32, %bb.ao ] ; 2 uses
  %.2137 = phi ptr [ %.1142312, %bb.an ], [ %.1136313, %bb.ap ], [ %.1136313, %_ZN4absl12lts_20250512L20EvalConditionIgnoredEPNS0_5MutexEPKNS0_9ConditionE.exit ], [ %.1136313, %bb.ao ] ; 2 uses
  %.2131 = phi ptr [ %.1145310, %bb.an ], [ %.1130314, %bb.ap ], [ %.1130314, %_ZN4absl12lts_20250512L20EvalConditionIgnoredEPNS0_5MutexEPKNS0_9ConditionE.exit ], [ %.1130314, %bb.ao ] ; 2 uses
...
bb.ar:                                            ; preds = %bb.aq
  %i.dp = getelementptr inbounds nuw i8, ptr %.1145310, i64 8 ; 2 uses
...
.lr.ph.i:                                         ; preds = %.preheader.i, %.lr.ph.i
  ...
  %.01116.i = phi ptr [ %.017.i, %.lr.ph.i ], [ %.1145310, %.preheader.i ]
...
_ZN4absl12lts_20250512L4SkipEPNS0_13base_internal14PerThreadSynchE.exit: ; preds = %._crit_edge.i, %bb.ar, %bb.aq
  %.2143 = phi ptr [ %.1145310, %bb.aq ], [ %.0.lcssa.i, %._crit_edge.i ], [ %.1145310, %bb.ar ] ; 3 uses
  %.not183 = icmp eq ptr %.2143, %i.bb
  br i1 %.not183, label %.outer.loopexit, label %bb.as
...
bb.at:                                            ; preds = %bb.ag
  %i.dy = icmp eq ptr %.0135.ph, null
  %spec.select213 = select i1 %i.dy, ptr %i.bb, ptr %.0135.ph ; 2 uses
  %.pre = load ptr, ptr %spec.select213, align 8, !tbaa !57
  %i.dz = icmp eq ptr %.pre, %.0129.ph
  br i1 %i.dz, label %.preheader257.preheader, label %bb.au, !prof !103

.preheader257.preheader:                          ; preds = %.thread387, %bb.at
  %.4139392 = phi ptr [ %i.bb, %.thread387 ], [ %spec.select213, %bb.at ]
  %.4155391 = phi i64 [ 32, %.thread387 ], [ %.0151.ph, %bb.at ]
...
.preheader257:                                    ; preds = %.preheader257.preheader, %_ZN4absl12lts_20250512L4SkipEPNS0_13base_internal14PerThreadSynchE.exit.thread.i
  %.024.i = phi ptr [ %.12532.i, %_ZN4absl12lts_20250512L4SkipEPNS0_13base_internal14PerThreadSynchE.exit.thread.i ], [ %i.a, %.preheader257.preheader ] ; 4 uses
  %.022.i = phi ptr [ %.12333.i, %_ZN4absl12lts_20250512L4SkipEPNS0_13base_internal14PerThreadSynchE.exit.thread.i ], [ %.4139392, %.preheader257.preheader ] ; 8 uses
  ...
  %.021.i = load ptr, ptr %.022.i, align 8, !tbaa !57 ; 10 uses
...
bb.av:                                            ; preds = %.preheader257
  %i.ed = getelementptr inbounds nuw i8, ptr %.022.i, i64 8 ; 3 uses
...
bb.aw:                                            ; preds = %bb.av
  ...
  store ptr %i.ef, ptr %.022.i, align 8, !tbaa !57
  %i.eg = icmp eq ptr %.0.i, %.021.i
  %i.eh = icmp eq ptr %.022.i, %.0.i              ; 2 uses
  br i1 %i.eg, label %bb.ax, label %bb.ay

bb.ax:                                            ; preds = %bb.aw
  %i.ei = select i1 %i.eh, ptr null, ptr %.022.i
...
bb.az:                                            ; preds = %bb.ay
  %i.ej = getelementptr inbounds nuw i8, ptr %.022.i, i64 32
...
bb.ba:                                            ; preds = %bb.az
  %i.eq = getelementptr inbounds nuw i8, ptr %.022.i, i64 24
...
_ZN4absl12lts_20250512L7DequeueEPNS0_13base_internal14PerThreadSynchES3_.exit.i: ; preds = %bb.bh, %bb.bg, %_ZN4absl12lts_20250512L18MuEquivalentWaiterEPNS0_13base_internal14PerThreadSynchES3_.exit.i.i, %bb.be, %bb.bd, %bb.bc, %bb.ba, %bb.az, %bb.ay, %bb.ax
  ...
  %i.fs = load ptr, ptr %.024.i, align 8, !tbaa !98
...
_ZN4absl12lts_20250512L4SkipEPNS0_13base_internal14PerThreadSynchE.exit.thread.i: ; preds = %._crit_edge.i.i, %bb.bi, %_ZN4absl12lts_20250512L7DequeueEPNS0_13base_internal14PerThreadSynchES3_.exit.i
  ...
  %.12333.i = phi ptr [ %.022.i, %_ZN4absl12lts_20250512L7DequeueEPNS0_13base_internal14PerThreadSynchES3_.exit.i ], [ %.021.i, %bb.bi ], [ %.0.lcssa.i.i, %._crit_edge.i.i ] ; 2 uses
  %.12532.i = phi ptr [ %.021.i, %_ZN4absl12lts_20250512L7DequeueEPNS0_13base_internal14PerThreadSynchES3_.exit.i ], [ %.024.i, %bb.bi ], [ %.024.i, %._crit_edge.i.i ]
  %i.gg = icmp eq ptr %.12333.i, %.135.i
...
.critedge:                                        ; preds = %.critedge.backedge, %.critedge.preheader
  %.053 = phi i32 [ 0, %.critedge.preheader ], [ %.053.be, %.critedge.backedge ] ; 5 uses
  %.0.a = phi i32 [ %2, %.critedge.preheader ], [ %.5, %.critedge.backedge ] ; 13 uses
...
bb.l:                                             ; preds = %bb.k
  %i.av = tail call fastcc noundef ptr @_ZN4absl12lts_20250512L7EnqueueEPNS0_13base_internal14PerThreadSynchEPNS0_15SynchWaitParamsEli(ptr noundef null, ptr noundef nonnull %1, i64 noundef %i.o, i32 noundef %.0.a) ; 2 uses
...
bb.n:                                             ; preds = %bb.l
  %trunc.i97 = trunc i32 %.0.a to i1
  %..i98 = select i1 %trunc.i97, i64 185, i64 187
  %i.aw = and i64 %..i98, %i.o
...
bb.p:                                             ; preds = %bb.k
  ...
  %trunc.i99 = trunc i32 %.0.a to i1              ; 3 uses
...
bb.w:                                             ; preds = %bb.v
  ...
  %i.co = tail call fastcc noundef ptr @_ZN4absl12lts_20250512L7EnqueueEPNS0_13base_internal14PerThreadSynchEPNS0_15SynchWaitParamsEli(ptr noundef %i.cn, ptr noundef nonnull %1, i64 noundef %i.o, i32 noundef %.0.a) ; 2 uses
...
.thread150:                                       ; preds = %bb.h, %bb.v, %bb.q, %bb.o, %bb.t, %bb.u, %_ZNSt13__atomic_baseIlE23compare_exchange_strongERllSt12memory_orderS2_.exit92.thread, %bb.j
  %.558 = phi i32 [ 0, %bb.j ], [ %.053, %bb.v ], [ 0, %_ZNSt13__atomic_baseIlE23compare_exchange_strongERllSt12memory_orderS2_.exit92.thread ], [ %.053, %bb.q ], [ %.053, %bb.o ], [ %.053, %bb.u ], [ 0, %bb.t ], [ %.053, %bb.h ] ; 4 uses
  %.5 = phi i32 [ %i.as, %bb.j ], [ %.0.a, %bb.v ], [ %i.cz, %_ZNSt13__atomic_baseIlE23compare_exchange_strongERllSt12memory_orderS2_.exit92.thread ], [ %.0.a, %bb.q ], [ %.0.a, %bb.o ], [ %.0.a, %bb.u ], [ %i.cf, %bb.t ], [ %.0.a, %bb.h ]
