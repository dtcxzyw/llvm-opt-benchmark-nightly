...
begin_hunk_2_@upb_Message_IsEqual:bb.a
  ...
  %i.i = and i1 %i.g, %i.h
  br i1 %i.i, label %.lr.ph226, label %.thread

.lr.ph226:                                        ; preds = %bb.b, %.backedge.a
...
.backedge.sink.split:                             ; preds = %upb_MiniTableField_CType.exit, %bb.h, %bb.af, %upb_MessageValue_IsEqual.exit.i.thread
...
_upb_Message_ExtensionsAreEqual.exit.thread:      ; preds = %bb.ba, %.loopexit, %bb.av, %bb.ax, %bb.bc, %bb.bd, %bb.az, %bb.ay, %_upb_Message_BaseFieldsAreEqual.exit, %.thread.thread, %.thread, %bb.bf, %_upb_Message_ExtensionsAreEqual.exit, %bb.a, %bb.bg
  %.0 = phi i1 [ true, %bb.a ], [ %i.fi, %bb.bg ], [ false, %_upb_Message_ExtensionsAreEqual.exit ], [ false, %_upb_Message_BaseFieldsAreEqual.exit ], [ true, %bb.bf ], [ false, %.thread ], [ false, %.thread.thread ], [ false, %bb.ay ], [ false, %bb.az ], [ false, %bb.bd ], [ false, %bb.bc ], [ false, %bb.ax ], [ false, %bb.av ], [ false, %.loopexit ], [ false, %bb.ba ]
  ret i1 %.0
}
