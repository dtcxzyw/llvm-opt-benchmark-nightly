...
bb.d:                                             ; preds = %.lr.ph.a, %_ZNSt11_Deque_baseIN4absl12lts_2025051212crc_internal12CrcCordState9PrefixCrcESaIS4_EE16_M_allocate_nodeEv.exit
  %.01422 = phi i64 [ 1, %.lr.ph.a ], [ %i.an, %_ZNSt11_Deque_baseIN4absl12lts_2025051212crc_internal12CrcCordState9PrefixCrcESaIS4_EE16_M_allocate_nodeEv.exit ] ; 5 uses
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !25   ; 8 uses
  ...
  %i.l = load i64, ptr %i.k, align 8, !tbaa !30   ; 5 uses
  %i.m = shl i64 %i.j, 1
...
bb.o:                                             ; preds = %bb.n
  %i.bb = load ptr, ptr %i.d, align 8, !tbaa !27
...
.lr.ph:                                           ; preds = %_ZNSt5dequeIN4absl12lts_2025051212crc_internal12CrcCordState9PrefixCrcESaIS4_EE22_M_reserve_map_at_backEm.exit
  %2 = load ptr, ptr %i.c, align 8
  br label %bb.e

bb.e:                                             ; preds = %.lr.ph, %_ZNSt11_Deque_baseIN4absl12lts_2025051212crc_internal12CrcCordState9PrefixCrcESaIS4_EE16_M_allocate_nodeEv.exit
  %.01423 = phi i64 [ 1, %.lr.ph ], [ %i.ao, %_ZNSt11_Deque_baseIN4absl12lts_2025051212crc_internal12CrcCordState9PrefixCrcESaIS4_EE16_M_allocate_nodeEv.exit ] ; 5 uses
...
bb.e:                                             ; preds = %bb.c, %bb.d
  %3 = phi ptr [ %i.d, %bb.c ], [ %.pre, %bb.d ]
  %4 = tail call noalias noundef nonnull dereferenceable(512) ptr @_Znwm(i64 noundef 512) #15 ; 4 uses
  %i.am = getelementptr inbounds nuw i8, ptr %3, i64 8 ; 2 uses
  store ptr %4, ptr %i.am, align 8, !tbaa !27
...
begin_hunk_8_@_ZNSt5dequeIN4absl12lts_2025051212crc_internal12CrcCordState9PrefixCrcESaIS4_EE16_M_push_back_auxIJiNS1_8crc32c_tEEEEvDpOT_:bb.a
  ...
  store ptr %4, ptr %i.o, align 8, !tbaa !37
  ...
  store ptr %4, ptr %i.a, align 8, !tbaa !70
  ret void
}
