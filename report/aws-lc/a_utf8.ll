...
bb.m:                                             ; preds = %bb.l
  %i.ad = lshr i32 %2, 18
  %3 = trunc nuw nsw i32 %i.ad to i8
  %i.ae = lshr i32 %2, 12
  %i.af = trunc i32 %i.ae to i8
  %4 = lshr i32 %2, 6
  %i.ag = trunc i32 %4 to i8
  %i.ah = trunc i32 %2 to i8
  %i.ai = insertelement <4 x i8> poison, i8 %3, i64 0
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.av = trunc nuw nsw i32 %i.aq to i8
  %i.aw = trunc nuw i32 %i.ar to i8
  %i.ax = trunc i32 %i.as to i8
  %i.ay = trunc i32 %i.at to i8
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.bo = trunc nuw nsw i32 %i.bj to i8
