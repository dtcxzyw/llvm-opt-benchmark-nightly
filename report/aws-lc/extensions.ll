...
bb.ah:                                            ; preds = %bb.ag
  ...
  store i8 1, ptr %i.ck, align 8, !tbaa !330
...
bb.ai:                                            ; preds = %bb.ag
  ...
  store i8 1, ptr %i.cl, align 1, !tbaa !332
  br label %_ZNSt10unique_ptrI14ssl_session_stN4bssl8internal7DeleterEED2Ev.exit
...
bb.am:                                            ; preds = %bb.al
  ...
  store i8 %i.ct, ptr %i.cu, align 8, !tbaa !331
  br label %.thread107
...
bb.ap:                                            ; preds = %.thread107
  ...
  store i8 32, ptr %i.dc, align 1, !tbaa !337
...
_ZNK4bssl4SpanIKhE7subspanEmm.exit:               ; preds = %bb.b
  ...
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !338  ; 4 uses
...
.critedge:                                        ; preds = %.lr.ph.i, %.lr.ph.i.1, %.lr.ph.i.2, %.lr.ph.i.3, %_ZNK4bssl4SpanIKhE7subspanEmm.exit
  ...
  %i.ab = load ptr, ptr %i.aa, align 8, !tbaa !338 ; 4 uses
...
bb.e:                                             ; preds = %.lr.ph
  ...
  br i1 %exitcond.not, label %.critedge, label %.lr.ph, !llvm.loop !339
...
.critedge:                                        ; preds = %bb.e, %bb.c
  ...
  store ptr %.sroa.0.123, ptr %1, align 8, !tbaa !340
