...
bb.y:                                             ; preds = %bb.x
  %11 = zext i32 %i.cw to i64
  %sext117 = shl i64 %11, 48
  %12 = ashr exact i64 %sext117, 48
  %i.cx = mul i64 %12, %i.k
...
bb.a:
  ...
  %3 = trunc nuw nsw i128 %i.dr to i64
  ...
  %4 = trunc nuw nsw i128 %i.gx to i64
  ...
  %i.ih = trunc nuw nsw i128 %i.ig to i64
  ...
  %5 = trunc nuw nsw i128 %i.kd to i64
...
bb.a:
  ...
  %2 = trunc nuw nsw i128 %i.df to i64
  ...
  %3 = trunc nuw nsw i128 %i.ge to i64
  ...
  %i.hn = lshr i128 %i.hm, 64
  %i.ho = trunc nuw nsw i128 %i.hn to i64
  %i.hp = add nuw nsw i64 %i.ho, %3
  ...
  %4 = trunc nuw nsw i128 %i.ja to i64
  ...
  %i.ko = trunc nuw nsw i128 %i.kn to i64
...
bb.b:                                             ; preds = %ec_GFp_simple_is_at_infinity.exit
  ...
  %i.ab = lshr i128 %i.aa, 64
  %4 = trunc nuw nsw i128 %i.ab to i64
  ...
  %6 = trunc nuw nsw i128 %i.an to i64
  ...
  %i.bd = add nuw nsw i64 %4, %i.w
  %i.be = add nuw nsw i64 %i.bd, %5
  %i.bf = add nuw nsw i64 %i.be, %6
  ...
  %8 = trunc nuw nsw i128 %i.bu to i64
  ...
  %i.cs = lshr i128 %i.cr, 64
  %10 = trunc nuw nsw i128 %i.cs to i64
  ...
  %i.dn = lshr i128 %i.dm, 64
  %11 = trunc nuw nsw i128 %i.dn to i64
  ...
  %13 = trunc nuw nsw i128 %i.el to i64
