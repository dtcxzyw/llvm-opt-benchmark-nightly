Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/aws-lc/original/poly1305_vec?download=true
...
bb.a:
  ...
  store i32 %i.k, ptr %i.l, align 4, !tbaa !8
  %i.m = lshr i64 %i.f, 32
  ...
  store i32 %.0.copyload.i38, ptr %i.aa, align 4, !tbaa !8
  ...
  store i32 %.0.copyload.i39, ptr %i.ac, align 4, !tbaa !8
  ...
  store i32 %.0.copyload.i40, ptr %i.ae, align 4, !tbaa !8
  ...
  store i32 %.0.copyload.i41, ptr %i.ag, align 4, !tbaa !8
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = load i64, ptr %i.f, align 16, !tbaa !11
...
bb.d:                                             ; preds = %bb.c
  tail call fastcc void @poly1305_first_block(ptr noundef nonnull %i.d, ptr noundef %1)
...
bb.e:                                             ; preds = %bb.c
  ...
  br i1 %i.q, label %OPENSSL_memcpy.exit, label %bb.f
...
bb.h:                                             ; preds = %bb.g, %bb.d
  ...
  store i64 1, ptr %i.f, align 16, !tbaa !11
  br label %bb.i
...
bb.i:                                             ; preds = %bb.h, %bb.b
  ...
  %i.y = load i64, ptr %i.x, align 8, !tbaa !12   ; 5 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  br i1 %i.ac, label %OPENSSL_memcpy.exit71, label %bb.k
...
bb.k:                                             ; preds = %bb.j
  ...
  br label %OPENSSL_memcpy.exit71

OPENSSL_memcpy.exit71:                            ; preds = %bb.j, %bb.k
  %i.ae = add i64 %i.y, %i.aa                     ; 2 uses
  store i64 %i.ae, ptr %i.x, align 8, !tbaa !12
  %i.af = icmp ult i64 %i.ae, 64
  br i1 %i.af, label %bb.p, label %bb.l

bb.l:                                             ; preds = %OPENSSL_memcpy.exit71
  %i.ag = getelementptr inbounds nuw i8, ptr %.163, i64 %i.aa
  %i.ah = sub nuw i64 %.1, %i.aa
  tail call fastcc void @poly1305_blocks(ptr noundef nonnull %i.d, ptr noundef nonnull %i.ab, i64 noundef 64)
...
bb.n:                                             ; preds = %bb.m
  ...
  tail call fastcc void @poly1305_blocks(ptr noundef nonnull %i.d, ptr noundef %.264, i64 noundef %i.aj)
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  br i1 %.not70, label %bb.p, label %OPENSSL_memcpy.exit72

OPENSSL_memcpy.exit72:                            ; preds = %bb.o
  %i.am = getelementptr inbounds nuw i8, ptr %i.d, i64 384
  %i.an = load i64, ptr %i.x, align 8, !tbaa !12  ; 2 uses
  ...
  %i.ap = add i64 %i.an, %.3
  store i64 %i.ap, ptr %i.x, align 8, !tbaa !12
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %OPENSSL_memcpy.exit72, %OPENSSL_memcpy.exit71, %OPENSSL_memcpy.exit, %bb.a
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable
define internal fastcc void @poly1305_first_block(ptr nofree noundef captures(none) initializes((0, 148), (152, 156), (160, 164), (168, 172), (176, 180), (184, 188), (192, 196), (200, 204), (208, 212), (216, 220), (224, 368)) %0, ptr nofree noundef readonly captures(none) %1) unnamed_addr #2 {
bb.a:
  ...
  store <4 x i32> %i.cp, ptr %i.cq, align 16, !tbaa !8
  ...
  store <4 x i32> %i.cu, ptr %i.cv, align 16, !tbaa !8
  ...
  store <2 x i64> %i.cx, ptr %i.cy, align 16, !tbaa !8
  ...
  store <2 x i64> %i.da, ptr %i.db, align 16, !tbaa !8
  ...
  store <2 x i64> %i.dd, ptr %i.de, align 16, !tbaa !8
  ...
  store <2 x i64> %i.dg, ptr %i.dh, align 16, !tbaa !8
