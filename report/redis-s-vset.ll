...
.critedge2:                                       ; preds = %switch.early.test, %switch.early.test.1, %switch.early.test.peel
  %.0.lcssa24.wide = phi i64 [ 0, %switch.early.test.peel ], [ %indvars.iv, %switch.early.test ], [ %indvars.iv.next, %switch.early.test.1 ]
  %31 = getelementptr inbounds nuw i8, ptr %1, i64 %.0.lcssa24.wide
...
63:                                               ; preds = %70, %.lr.ph.i152
  %64 = phi ptr [ %59, %.lr.ph.i152 ], [ %71, %70 ] ; 2 uses
...
70:                                               ; preds = %63
  ...
  %exitcond.not.i154 = icmp eq ptr %71, %1
...
.lr.ph:                                           ; preds = %85, %jsonSkipWhiteSpaces.exit54
  %87 = phi ptr [ %136, %jsonSkipWhiteSpaces.exit54 ], [ %86, %85 ] ; 2 uses
  %.049.i86 = phi i64 [ %.251.i, %jsonSkipWhiteSpaces.exit54 ], [ 0, %85 ] ; 5 uses
  %88 = load i64, ptr %77, align 8, !tbaa !18     ; 2 uses
  %89 = icmp eq i64 %88, %.049.i86
...
90:                                               ; preds = %.lr.ph
  %.not64.i = icmp eq i64 %.049.i86, 0
  %91 = shl i64 %.049.i86, 1
  %92 = select i1 %.not64.i, i64 4, i64 %91       ; 3 uses
  %.not65.i = icmp ult i64 %92, %.049.i86
...
begin_hunk_9
  ...
  %.pre106 = load i64, ptr %77, align 8, !tbaa !18
  br label %98

98:                                               ; preds = %.lr.ph._crit_edge, %93
  %99 = phi i64 [ %.pre106, %93 ], [ %88, %.lr.ph._crit_edge ] ; 2 uses
  %100 = phi ptr [ %97, %93 ], [ %.pre, %.lr.ph._crit_edge ]
  %.251.i = phi i64 [ %92, %93 ], [ %.049.i86, %.lr.ph._crit_edge ]
  %101 = add i64 %99, 1
  ...
  %.promoted.i55 = load ptr, ptr %0, align 8, !tbaa !48 ; 3 uses
  %103 = icmp ult ptr %.promoted.i55, %1
...
106:                                              ; preds = %113, %.lr.ph.i57
  %107 = phi ptr [ %.promoted.i55, %.lr.ph.i57 ], [ %114, %113 ] ; 3 uses
...
113:                                              ; preds = %106
  ...
  %exitcond.not.i59 = icmp eq ptr %114, %1
...
jsonSkipWhiteSpaces.exit60:                       ; preds = %106, %113, %98
  %115 = phi ptr [ %.promoted.i55, %98 ], [ %114, %113 ], [ %107, %106 ] ; 4 uses
...
124:                                              ; preds = %131, %.lr.ph.i51
  %125 = phi ptr [ %120, %.lr.ph.i51 ], [ %132, %131 ] ; 2 uses
...
131:                                              ; preds = %124
  ...
  %exitcond.not.i53 = icmp eq ptr %132, %1
...
202:                                              ; preds = %jsonIsNumberChar.exit.thread.i, %.lr.ph.i47
  %indvars.iv.i = phi i64 [ 0, %.lr.ph.i47 ], [ %indvars.iv.next.i, %jsonIsNumberChar.exit.thread.i ] ; 4 uses
  %203 = phi ptr [ %17, %.lr.ph.i47 ], [ %210, %jsonIsNumberChar.exit.thread.i ] ; 2 uses
...
jsonParseStringToken.exit:                        ; preds = %26, %.outer68.outer.i, %.outer68.i, %.thread, %135, %133, %._crit_edge, %116, %190, %switch.early.test37.i44, %179, %176, %171, %switch.early.test37.i38, %160, %157, %151, %switch.early.test37.i, %140, %137, %83, %56, %20, %switch.early.test, %18, %jsonSkipWhiteSpaces.exit, %jsonParseNumberToken.exit
  %.0 = phi ptr [ null, %160 ], [ %.1.i46, %jsonParseNumberToken.exit ], [ null, %18 ], [ null, %switch.early.test ], [ null, %20 ], [ null, %jsonSkipWhiteSpaces.exit ], [ %73, %83 ], [ null, %140 ], [ null, %._crit_edge ], [ null, %.outer68.i ], [ %32, %56 ], [ null, %116 ], [ null, %179 ], [ null, %switch.early.test37.i ], [ null, %137 ], [ %153, %151 ], [ null, %switch.early.test37.i38 ], [ null, %157 ], [ %173, %171 ], [ null, %switch.early.test37.i44 ], [ null, %176 ], [ %192, %190 ], [ null, %.thread ], [ null, %135 ], [ %73, %133 ], [ null, %.outer68.outer.i ], [ null, %26 ]
  ret ptr %.0
}
...
begin_hunk_18
  ...
  %umin128 = tail call i64 @llvm.umin.i64(i64 %53, i64 %55) ; 4 uses
  %56 = add nuw nsw i64 %umin128, 1               ; 3 uses
...
89:                                               ; preds = %86, %83
  %exitcond129.not = icmp eq i64 %.08696.us, %umin128
...
begin_hunk_20
  ...
  %exitcond123.not = icmp eq i64 %.08696.us109, %umin128
...
begin_hunk_21
  ...
  %exitcond.not = icmp eq i64 %.08696, %umin128
