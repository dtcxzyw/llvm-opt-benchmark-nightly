...
.lr.ph:                                           ; preds = %bb.ej, %.thread1879
  %.0492.ph1350 = phi ptr [ %14, %.thread1879 ], [ %i.nl, %bb.ej ] ; 8 uses
  %.1515.ph1349 = phi i32 [ %.2516.ph, %.thread1879 ], [ %.05141369, %bb.ej ]
  ...
  switch i64 %i.ns, label %.thread815.a [
    i64 3, label %bb.ek
    i64 4, label %bb.em
  ]
...
bb.em:                                            ; preds = %.lr.ph
  ...
  br i1 %.not691.1, label %.thread1879, label %bb.en
...
bb.en:                                            ; preds = %bb.em
  ...
  br i1 %.not691.2, label %bb.el, label %.thread815.a
...
bb.ep:                                            ; preds = %bb.eo
  ...
  br i1 %.not691.4, label %bb.el, label %.thread815.a

.thread815.a:                                     ; preds = %.lr.ph, %bb.en, %bb.ep
  %11 = load ptr, ptr @stderr, align 8, !tbaa !11
  %12 = trunc i64 %i.ns to i32
  %13 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %11, ptr noundef nonnull @.str.77, i32 noundef %12, ptr noundef nonnull %.0492.ph1350) #14 ; 0 uses
  br label %.thread831

.thread1879:                                      ; preds = %bb.em, %bb.el
  %.2516.ph = phi i32 [ %i.nw, %bb.el ], [ 0, %bb.em ] ; 2 uses
  %14 = getelementptr inbounds nuw i8, ptr %spec.select, i64 1 ; 2 uses
  %.not6941345 = icmp ult ptr %14, %i.nn
...
.thread831:                                       ; preds = %.thread815.a, %.thread1884, %bb.et, %bb.g, %bb.dt, %bb.h
  %.5.ph = phi i32 [ 0, %bb.h ], [ 0, %bb.dt ], [ 1, %.thread815.a ], [ 0, %bb.g ], [ 1, %bb.et ], [ 1, %.thread1884 ]
