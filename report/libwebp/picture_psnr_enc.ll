...
.loopexit:                                        ; preds = %._crit_edge, %bb.f, %bb.d
  ...
  %i.ar = tail call double %i.d(ptr noundef nonnull %.174, i32 noundef %4, ptr noundef %.176, i32 noundef %4, i32 noundef %4, i32 noundef %5) #7, !callees !17
...
.lr.ph.split.us73:                                ; preds = %.lr.ph.split.us73.preheader, %.lr.ph.split.us73
  ...
  br i1 %niter.ncmp.7, label %._crit_edge.us.loopexit102.unr-lcssa, label %.lr.ph.split.us73, !llvm.loop !27
