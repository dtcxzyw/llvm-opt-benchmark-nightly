...
._crit_edge:                                      ; preds = %._crit_edge.unr-lcssa, %.epil.preheader
  ...
  br i1 %exitcond98.not, label %.loopexit, label %iter.check, !llvm.loop !15
...
.loopexit:                                        ; preds = %._crit_edge, %bb.f, %bb.d
  ...
  %i.at = load float, ptr %8, align 4, !tbaa !11  ; 3 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.bd = tail call double @log10(double noundef %i.bc) #7
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.bo = tail call double @log(double noundef %i.bn) #7
...
GetLogSSIM.exit:                                  ; preds = %bb.j, %bb.i, %bb.h, %bb.g
  ...
  store float %i.bq, ptr %9, align 4, !tbaa !11
  br label %.critedge
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.d = load ptr, ptr @VP8AccumulateSSE, align 8, !tbaa !13
...
!33 = !{!"p1 int", !12, i64 0}
!34 = !{!"p1 _ZTS12WebPAuxStats", !12, i64 0}
!35 = !{!"WebPPicture", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !32, i64 16, !32, i64 24, !32, i64 32, !5, i64 40, !5, i64 44, !32, i64 48, !5, i64 56, !4, i64 60, !33, i64 72, !5, i64 80, !4, i64 84, !12, i64 96, !12, i64 104, !5, i64 112, !32, i64 120, !34, i64 128, !5, i64 136, !12, i64 144, !12, i64 152, !4, i64 160, !32, i64 176, !32, i64 184, !4, i64 192, !12, i64 224, !12, i64 232, !4, i64 240}
!36 = !{!35, !5, i64 8}
!37 = !{!35, !5, i64 12}
!38 = !{!35, !5, i64 0}
!39 = !{!35, !5, i64 80}
