...
bb.b:                                             ; preds = %.lr.ph.us, %bb.n
  ...
  %7 = load i32, ptr %i.ac, align 4, !tbaa !23    ; 7 uses
  %i.ag = and i32 %7, 255                         ; 5 uses
  %i.ah = sub nsw i32 %i.ag, %i.af                ; 2 uses
...
bb.h:                                             ; preds = %IsNear.exit35.i.us
  ...
  %i.bk = sub nsw i32 %i.ag, %i.bj                ; 2 uses
...
bb.k:                                             ; preds = %IsNear.exit50.i.us
  ...
  %i.bw = sub nsw i32 %i.ag, %i.bv                ; 2 uses
...
IsSmooth.exit.thread.us:                          ; preds = %bb.b, %IsSmooth.exit.us, %bb.m, %bb.l, %bb.k, %IsNear.exit50.i.us, %bb.j, %bb.i, %bb.h, %IsNear.exit35.i.us, %bb.g, %bb.f, %bb.e, %IsNear.exit.i.us, %bb.d, %bb.c
  ...
  %11 = insertelement <4 x i32> %10, i32 %i.ag, i64 1
  %12 = insertelement <4 x i32> %11, i32 %8, i64 2
  %13 = insertelement <4 x i32> %12, i32 %i.aj, i64 3
  %14 = and <4 x i32> %13, <i32 -1, i32 -1, i32 255, i32 -1> ; 2 uses
  %15 = add nuw nsw <4 x i32> %14, %i.q
  %i.cf = lshr <4 x i32> %14, %i.s
  %i.cg = and <4 x i32> %i.cf, splat (i32 1)
  %i.ch = add nuw nsw <4 x i32> %15, %i.cg        ; 2 uses
