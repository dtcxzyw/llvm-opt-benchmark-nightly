...
bb.a:
  ...
  %i.c = load i32, ptr %i.b, align 4, !tbaa !10
  %i.d = load i32, ptr %1, align 4, !tbaa !10
...
bb.a:
  %i.a = load i32, ptr %1, align 4, !tbaa !10     ; 2 uses
  ...
  %i.h = bitcast <4 x i32> %i.e to <16 x i8>
  %i.i = bitcast <4 x i32> %i.g to <16 x i8>      ; 2 uses
  %i.j = tail call <2 x i64> @llvm.x86.sse2.psad.bw(<16 x i8> %i.h, <16 x i8> %i.i)
  %i.k = bitcast <4 x i32> %i.f to <16 x i8>
  %i.l = tail call <2 x i64> @llvm.x86.sse2.psad.bw(<16 x i8> %i.k, <16 x i8> %i.i)
  %i.m = bitcast <2 x i64> %i.l to <4 x i32>
  %i.n = bitcast <2 x i64> %i.j to <4 x i32>
  %i.o = icmp sgt <4 x i32> %i.m, %i.n
  %i.p = extractelement <4 x i1> %i.o, i64 0
  %i.q = select i1 %i.p, i32 %i.b, i32 %i.a
  ret i32 %i.q
}
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.c = load <16 x i8>, ptr %i.b, align 1, !tbaa !11
  ...
  store <16 x i8> %i.d, ptr %i.e, align 1, !tbaa !11
...
._crit_edge.loopexit:                             ; preds = %.lr.ph
  %i.f = add nuw i32 %2, 2147483644
  %i.g = and i32 %i.f, 2147483644
  %narrow = add nuw i32 %i.g, 4
  br label %._crit_edge
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.g = load <16 x i8>, ptr %i.f, align 1, !tbaa !11 ; 2 uses
  ...
  store <16 x i8> %i.m, ptr %i.n, align 1, !tbaa !11
...
._crit_edge.loopexit:                             ; preds = %.lr.ph
  %i.q = add nuw i32 %2, 2147483644
  %i.r = and i32 %i.q, 2147483644
  %narrow = add nuw i32 %i.r, 4
  br label %._crit_edge
...
bb.b:                                             ; preds = %._crit_edge
  %i.s = load ptr, ptr getelementptr inbounds nuw (i8, ptr @VP8LPredictorsAdd_C, i64 8), align 8, !tbaa !9
...
bb.b:                                             ; preds = %._crit_edge
  %i.j = load ptr, ptr getelementptr inbounds nuw (i8, ptr @VP8LPredictorsAdd_C, i64 16), align 16, !tbaa !9
...
bb.b:                                             ; preds = %._crit_edge
  %i.k = load ptr, ptr getelementptr inbounds nuw (i8, ptr @VP8LPredictorsAdd_C, i64 24), align 8, !tbaa !9
...
bb.b:                                             ; preds = %._crit_edge
  %i.k = load ptr, ptr getelementptr inbounds nuw (i8, ptr @VP8LPredictorsAdd_C, i64 32), align 16, !tbaa !9
  %i.l = zext nneg i32 %.0.lcssa to i64           ; 3 uses
  %i.m = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.l
  %i.n = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.l
  %i.o = sub nsw i32 %2, %.0.lcssa
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  store i32 %i.aj, ptr %i.b, align 4, !tbaa !10
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  store i32 %i.aa, ptr %i.b, align 4, !tbaa !10
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.q = load i32, ptr %i.p, align 4, !tbaa !10   ; 2 uses
  ...
  store i32 %i.z, ptr %i.b, align 4, !tbaa !10
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %indvars.iv = phi i64 [ 4, %.lr.ph.preheader ], [ %indvars.iv.next, %.lr.ph ]
  %i.b = getelementptr [4 x i8], ptr %1, i64 %indvars.iv31 ; 2 uses
  %i.c = getelementptr i8, ptr %i.b, i64 -4
  %i.d = load <2 x i64>, ptr %i.c, align 1, !tbaa !11 ; 2 uses
  %i.e = load <2 x i64>, ptr %i.b, align 1, !tbaa !11 ; 2 uses
  %i.f = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv31
  %i.g = load <16 x i8>, ptr %i.f, align 1, !tbaa !11
  ...
  %i.p = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %indvars.iv31
  store <16 x i8> %i.o, ptr %i.p, align 1, !tbaa !11
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 4 ; 2 uses
  %.not = icmp samesign ugt i64 %indvars.iv.next, %i.a
...
bb.b:                                             ; preds = %._crit_edge
  %i.s = load ptr, ptr getelementptr inbounds nuw (i8, ptr @VP8LPredictorsAdd_C, i64 64), align 16, !tbaa !9
  %i.t = zext nneg i32 %.0.lcssa to i64           ; 3 uses
  %i.u = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.t
  %i.v = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.t
  %i.w = sub nsw i32 %2, %.0.lcssa
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %indvars.iv31 = phi i64 [ 0, %.lr.ph.preheader ], [ %indvars.iv.next32, %.lr.ph ] ; 4 uses
  %indvars.iv = phi i64 [ 4, %.lr.ph.preheader ], [ %indvars.iv.next, %.lr.ph ]
  %i.b = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv31 ; 2 uses
...
bb.b:                                             ; preds = %._crit_edge
  %i.s = load ptr, ptr getelementptr inbounds nuw (i8, ptr @VP8LPredictorsAdd_C, i64 72), align 8, !tbaa !9
  %i.t = zext nneg i32 %.0.lcssa to i64           ; 3 uses
  %i.u = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.t
  %i.v = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.t
  %i.w = sub nsw i32 %2, %.0.lcssa
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %indvars.iv102 = phi i64 [ 0, %.lr.ph.preheader ], [ %indvars.iv.next103, %.lr.ph ] ; 5 uses
  %indvars.iv = phi i64 [ 4, %.lr.ph.preheader ], [ %indvars.iv.next, %.lr.ph ]
  %.098100 = phi <2 x i64> [ %i.d, %.lr.ph.preheader ], [ %i.bx, %.lr.ph ] ; 2 uses
  %i.f = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv102
  %i.g = load <16 x i8>, ptr %i.f, align 1, !tbaa !11 ; 2 uses
  %i.h = getelementptr [4 x i8], ptr %1, i64 %indvars.iv102 ; 2 uses
  %i.i = getelementptr i8, ptr %i.h, i64 -4
  %i.j = load <2 x i64>, ptr %i.i, align 1, !tbaa !11 ; 2 uses
  %i.k = load <2 x i64>, ptr %i.h, align 1, !tbaa !11 ; 2 uses
  %i.l = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv102
  %i.m = getelementptr inbounds nuw i8, ptr %i.l, i64 4
  %i.n = load <2 x i64>, ptr %i.m, align 1, !tbaa !11 ; 2 uses
  ...
  %i.ai = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %indvars.iv102 ; 2 uses
  ...
  store <2 x i32> %i.aw, ptr %i.ai, align 4, !tbaa !10
  ...
  store <2 x i32> %i.bz, ptr %i.bk, align 4, !tbaa !10
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 4 ; 2 uses
  %.not = icmp samesign ugt i64 %indvars.iv.next, %i.e
  %indvars.iv.next103 = add nuw nsw i64 %indvars.iv102, 4
  br i1 %.not, label %._crit_edge.loopexit, label %.lr.ph, !llvm.loop !23

._crit_edge.loopexit:                             ; preds = %.lr.ph
  %i.ca = add nuw i32 %2, 2147483644
  %i.cb = and i32 %i.ca, 2147483644
  %narrow = add nuw i32 %i.cb, 4
  br label %._crit_edge
...
bb.b:                                             ; preds = %._crit_edge
  %i.cc = load ptr, ptr getelementptr inbounds nuw (i8, ptr @VP8LPredictorsAdd_C, i64 80), align 16, !tbaa !9
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.g = load <2 x i64>, ptr %i.f, align 1, !tbaa !11 ; 2 uses
  %i.h = getelementptr i8, ptr %i.f, i64 -4
  %i.i = load <2 x i64>, ptr %i.h, align 1, !tbaa !11 ; 2 uses
  %i.j = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv128
  %i.k = load <16 x i8>, ptr %i.j, align 1, !tbaa !11 ; 2 uses
  ...
  store <2 x i32> %i.bh, ptr %i.al, align 4, !tbaa !10
  ...
  store <2 x i32> %i.ct, ptr %i.ca, align 4, !tbaa !10
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 4 ; 2 uses
  %.not = icmp samesign ugt i64 %indvars.iv.next, %i.e
...
._crit_edge.loopexit:                             ; preds = %.lr.ph
  %i.cu = add nuw i32 %2, 2147483644
  %i.cv = and i32 %i.cu, 2147483644
  %narrow = add nuw i32 %i.cv, 4
  br label %._crit_edge
...
bb.b:                                             ; preds = %._crit_edge
  %i.cw = load ptr, ptr getelementptr inbounds nuw (i8, ptr @VP8LPredictorsAdd_C, i64 88), align 8, !tbaa !9
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  store <2 x i32> %i.ak, ptr %i.ab, align 4, !tbaa !10
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.ae = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %i.ad, <8 x i16> %i.v)
  ...
  %i.ak = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %i.aj, <8 x i16> %i.x)
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %i.fu = bitcast <16 x i8> %i.fb to <8 x i16>
  %i.fv = and <8 x i16> %i.fu, splat (i16 255)
  %i.fw = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %i.fs, <8 x i16> %i.fv)
  %i.fx = lshr <8 x i16> %i.fc, splat (i16 8)
  %i.fy = lshr <8 x i16> %i.ff, splat (i16 8)
  %i.fz = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %i.fx, <8 x i16> %i.fy)
  %i.ga = lshr <8 x i16> %i.fj, splat (i16 8)
end_hunk_0
