...
bb.e:                                             ; preds = %bb.d, %bb.c
  %i.s = call ptr @VP8LAllocateHistogram(i32 noundef %3) #8 ; 11 uses
...
ConvertPopulationCountTableToBitEstimates.exit73.i.i: ; preds = %VP8LFastLog2.exit24.i69.i.i, %._crit_edge.thread.i72.i.i
  ...
  %9 = load <32 x i32>, ptr %i.gt, align 8, !tbaa !62 ; 33 uses
  %10 = extractelement <32 x i32> %9, i64 0
  %11 = extractelement <32 x i32> %9, i64 1
  %12 = add i32 %11, %10
  %13 = icmp ne <32 x i32> %9, zeroinitializer
  %14 = extractelement <32 x i32> %9, i64 2
  %15 = add i32 %12, %14
  %16 = extractelement <32 x i32> %9, i64 3
  %17 = add i32 %15, %16
  %18 = extractelement <32 x i32> %9, i64 4
  %19 = add i32 %17, %18
  %20 = extractelement <32 x i32> %9, i64 5
  %21 = add i32 %19, %20
  %22 = extractelement <32 x i32> %9, i64 6
  %23 = add i32 %21, %22
  %24 = extractelement <32 x i32> %9, i64 7
  %i.gu = add i32 %23, %24
  %25 = extractelement <32 x i32> %9, i64 8
  %i.gv = add i32 %i.gu, %25
  %26 = extractelement <32 x i32> %9, i64 9
  %i.gw = add i32 %i.gv, %26
  %27 = extractelement <32 x i32> %9, i64 10
  %i.gx = add i32 %i.gw, %27
  %i.gy = extractelement <32 x i32> %9, i64 11
  %i.gz = add i32 %i.gx, %i.gy
  %i.ha = extractelement <32 x i32> %9, i64 12
  %i.hb = add i32 %i.gz, %i.ha
  %i.hc = extractelement <32 x i32> %9, i64 13
  %i.hd = add i32 %i.hb, %i.hc
  %i.he = extractelement <32 x i32> %9, i64 14
  %i.hf = add i32 %i.hd, %i.he
  %i.hg = extractelement <32 x i32> %9, i64 15
  %i.hh = add i32 %i.hf, %i.hg
  %i.hi = extractelement <32 x i32> %9, i64 16
  %i.hj = add i32 %i.hh, %i.hi
  %i.hk = extractelement <32 x i32> %9, i64 17
  %i.hl = add i32 %i.hj, %i.hk
  %i.hm = extractelement <32 x i32> %9, i64 18
  %i.hn = add i32 %i.hl, %i.hm
  %i.ho = extractelement <32 x i32> %9, i64 19
  %i.hp = add i32 %i.hn, %i.ho
  %i.hq = extractelement <32 x i32> %9, i64 20
  %i.hr = add i32 %i.hp, %i.hq
  %i.hs = extractelement <32 x i32> %9, i64 21
  %i.ht = add i32 %i.hr, %i.hs
  %i.hu = extractelement <32 x i32> %9, i64 22
  %i.hv = add i32 %i.ht, %i.hu
  %i.hw = extractelement <32 x i32> %9, i64 23
  %i.hx = add i32 %i.hv, %i.hw
  %i.hy = extractelement <32 x i32> %9, i64 24
  %i.hz = add i32 %i.hx, %i.hy
  %i.ia = extractelement <32 x i32> %9, i64 25
  %i.ib = add i32 %i.hz, %i.ia
  %i.ic = extractelement <32 x i32> %9, i64 26
  %i.id = add i32 %i.ib, %i.ic
  %i.ie = extractelement <32 x i32> %9, i64 27
  %i.if = add i32 %i.id, %i.ie
  %i.ig = extractelement <32 x i32> %9, i64 28
  %i.ih = add i32 %i.if, %i.ig
  %i.ii = extractelement <32 x i32> %9, i64 29
  %i.ij = add i32 %i.ih, %i.ii
  %i.ik = extractelement <32 x i32> %9, i64 30
  %i.il = add i32 %i.ij, %i.ik
  %i.im = extractelement <32 x i32> %9, i64 31
  %i.in = add i32 %i.il, %i.im
  %28 = getelementptr inbounds nuw i8, ptr %i.s, i64 3208
  %29 = load <8 x i32>, ptr %28, align 8, !tbaa !62 ; 9 uses
  %i.io = extractelement <8 x i32> %29, i64 0
  %i.ip = add i32 %i.in, %i.io
  %30 = icmp ne <8 x i32> %29, zeroinitializer
  %i.iq = extractelement <8 x i32> %29, i64 1
  %i.ir = add i32 %i.ip, %i.iq
  %i.is = extractelement <8 x i32> %29, i64 2
  %i.it = add i32 %i.ir, %i.is
  %i.iu = extractelement <8 x i32> %29, i64 3
  %i.iv = add i32 %i.it, %i.iu
  %i.iw = extractelement <8 x i32> %29, i64 4
  %i.ix = add i32 %i.iv, %i.iw
  %i.iy = extractelement <8 x i32> %29, i64 5
  %i.iz = add i32 %i.ix, %i.iy
  %i.ja = extractelement <8 x i32> %29, i64 6
  %i.jb = add i32 %i.iz, %i.ja
  %i.jc = extractelement <8 x i32> %29, i64 7
  %i.jd = add i32 %i.jb, %i.jc                    ; 3 uses
  %31 = shufflevector <8 x i1> %30, <8 x i1> poison, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %rdx.op = shufflevector <32 x i1> %13, <32 x i1> %31, <40 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39>
  %i.je = bitcast <40 x i1> %rdx.op to i40
...
bb.ac:                                            ; preds = %bb.aa
  ...
  %i.jn = call i32 %i.jm(i32 noundef %i.jd) #8, !inline_history !40
  br label %.lr.ph30.preheader.i84.i.i
