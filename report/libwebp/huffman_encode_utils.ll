Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/libwebp/original/huffman_encode_utils?download=true
inline.NumInlined: 7
inline.NumDeleted: 7
...
bb.a:
  ...
  br i1 %i.b, label %.lr.ph53, label %._crit_edge
...
bb.b:                                             ; preds = %.lr.ph53, %CodeRepeatedZeros.exit
  %.02952 = phi i32 [ 0, %.lr.ph53 ], [ %.0.lcssa, %CodeRepeatedZeros.exit ] ; 3 uses
  %.03051 = phi i32 [ 8, %.lr.ph53 ], [ %.1, %CodeRepeatedZeros.exit ] ; 4 uses
  %.03150 = phi ptr [ %1, %.lr.ph53 ], [ %.132, %CodeRepeatedZeros.exit ] ; 6 uses
  %i.e = load ptr, ptr %i.c, align 8, !tbaa !13   ; 2 uses
  %i.f = zext nneg i32 %.02952 to i64             ; 2 uses
  %i.g = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.f
  %i.h = load i8, ptr %i.g, align 1, !tbaa !14    ; 7 uses
  %i.i = zext i8 %i.h to i32                      ; 6 uses
  %i.j = add nuw nsw i32 %.02952, 1
  %smax = tail call i32 @llvm.smax.i32(i32 %i.a, i32 %i.j) ; 2 uses
  %indvars.iv.next92 = add nuw nsw i64 %i.f, 1    ; 2 uses
  %i.k = icmp samesign ult i64 %indvars.iv.next92, %i.d
  br i1 %i.k, label %.lr.ph95, label %.critedge

bb.c:                                             ; preds = %.lr.ph95
  %indvars.iv.next = add nuw nsw i64 %indvars.iv.next93, 1 ; 2 uses
  %i.l = icmp samesign ult i64 %indvars.iv.next, %i.d
  br i1 %i.l, label %.lr.ph95, label %.critedge, !llvm.loop !23

.lr.ph95:                                         ; preds = %bb.b, %bb.c
  %indvars.iv.next93 = phi i64 [ %indvars.iv.next, %bb.c ], [ %indvars.iv.next92, %bb.b ] ; 3 uses
  %i.m = getelementptr inbounds nuw i8, ptr %i.e, i64 %indvars.iv.next93
...
.critedge.split.loop.exit79:                      ; preds = %.lr.ph95
  %i.p = trunc nuw nsw i64 %indvars.iv.next93 to i32
  br label %.critedge
...
.critedge:                                        ; preds = %bb.c, %bb.b, %.critedge.split.loop.exit79
  ...
  %i.q = sub nsw i32 %.0.lcssa, %.02952           ; 5 uses
  %i.r = icmp eq i8 %i.h, 0
  br i1 %i.r, label %.lr.ph.i.preheader.a, label %bb.g

.lr.ph.i.preheader.a:                             ; preds = %.critedge
  %i.s = icmp samesign ult i32 %i.q, 3
  br i1 %i.s, label %.lr.ph35.preheader.i, label %.lr.ph47

.lr.ph35.preheader.i:                             ; preds = %.lr.ph.i, %.lr.ph.i.preheader.a
  %.02232.i.lcssa = phi ptr [ %.03150, %.lr.ph.i.preheader.a ], [ %i.ah, %.lr.ph.i ] ; 2 uses
  %.02331.i.lcssa = phi i32 [ %i.q, %.lr.ph.i.preheader.a ], [ %i.ai, %.lr.ph.i ]
...
.lr.ph47:                                         ; preds = %.lr.ph.i.preheader.a, %.lr.ph.i
  %.02331.i46 = phi i32 [ %i.ai, %.lr.ph.i ], [ %i.q, %.lr.ph.i.preheader.a ] ; 6 uses
  %.02232.i45 = phi ptr [ %i.ah, %.lr.ph.i ], [ %.03150, %.lr.ph.i.preheader.a ] ; 8 uses
  %i.w = icmp samesign ult i32 %.02331.i46, 11
  br i1 %i.w, label %bb.d, label %bb.e

bb.d:                                             ; preds = %.lr.ph47
  store i8 17, ptr %.02232.i45, align 1, !tbaa !31
  %i.x = trunc nuw nsw i32 %.02331.i46 to i8
  %i.y = add nsw i8 %i.x, -3
  %i.z = getelementptr inbounds nuw i8, ptr %.02232.i45, i64 1
  store i8 %i.y, ptr %i.z, align 1, !tbaa !32
  %i.aa = getelementptr inbounds nuw i8, ptr %.02232.i45, i64 2
  br label %CodeRepeatedZeros.exit

bb.e:                                             ; preds = %.lr.ph47
  %i.ab = icmp samesign ult i32 %.02331.i46, 139
  store i8 18, ptr %.02232.i45, align 1, !tbaa !31
  br i1 %i.ab, label %bb.f, label %.lr.ph.i

bb.f:                                             ; preds = %bb.e
  %i.ac = trunc nuw i32 %.02331.i46 to i8
  %i.ad = add i8 %i.ac, -11
  %i.ae = getelementptr inbounds nuw i8, ptr %.02232.i45, i64 1
  store i8 %i.ad, ptr %i.ae, align 1, !tbaa !32
  %i.af = getelementptr inbounds nuw i8, ptr %.02232.i45, i64 2
  br label %CodeRepeatedZeros.exit

.lr.ph.i:                                         ; preds = %bb.e
  %i.ag = getelementptr inbounds nuw i8, ptr %.02232.i45, i64 1
  store i8 127, ptr %i.ag, align 1, !tbaa !32
  %i.ah = getelementptr i8, ptr %.02232.i45, i64 2 ; 2 uses
  %i.ai = add nsw i32 %.02331.i46, -138           ; 2 uses
  %i.aj = icmp slt i32 %.02331.i46, 141
  br i1 %i.aj, label %.lr.ph35.preheader.i, label %.lr.ph47

bb.g:                                             ; preds = %.critedge
  %.not.i = icmp eq i32 %.03051, %i.i
  br i1 %.not.i, label %bb.i, label %bb.h

bb.h:                                             ; preds = %bb.g
  store i8 %i.h, ptr %.03150, align 1, !tbaa !31
  %i.ak = getelementptr inbounds nuw i8, ptr %.03150, i64 1
  store i8 0, ptr %i.ak, align 1, !tbaa !32
  %i.al = getelementptr inbounds nuw i8, ptr %.03150, i64 2
  %i.am = add nsw i32 %i.q, -1
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.g
  %.026.i = phi ptr [ %i.al, %bb.h ], [ %.03150, %bb.g ] ; 6 uses
  %.025.i = phi i32 [ %i.am, %bb.h ], [ %i.q, %bb.g ] ; 7 uses
  %i.an = icmp sgt i32 %.025.i, 0
  br i1 %i.an, label %.lr.ph.i35.preheader, label %CodeRepeatedZeros.exit

.lr.ph.i35.preheader:                             ; preds = %bb.i
  %i.ao = icmp samesign ult i32 %.025.i, 3
  br i1 %i.ao, label %iter.check, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %.lr.ph.i35.preheader
  ...
  %min.iters.check110 = icmp samesign ult i32 %i.au, 16
  br i1 %min.iters.check110, label %.lr.ph.preheader120, label %vector.ph111

.lr.ph.preheader120:                              ; preds = %vector.body113, %.lr.ph.preheader
  %.12734.i43.ph = phi ptr [ %.026.i, %.lr.ph.preheader ], [ %i.ba, %vector.body113 ]
  %.135.i42.ph = phi i32 [ %.025.i, %.lr.ph.preheader ], [ %i.bd, %vector.body113 ]
  br label %.lr.ph

vector.ph111:                                     ; preds = %.lr.ph.preheader
  ...
  %n.vec112 = sub nsw i64 %i.av, %i.ay            ; 3 uses
  %i.az = shl nsw i64 %n.vec112, 1
  %i.ba = getelementptr i8, ptr %.026.i, i64 %i.az
  %i.bb = trunc i64 %n.vec112 to i32
  %i.bc = mul i32 %i.bb, -6
...
vector.body113:                                   ; preds = %vector.body113, %vector.ph111
  ...
  %i.be = shl i64 %index114, 1                    ; 2 uses
  %next.gep115 = getelementptr i8, ptr %.026.i, i64 %i.be
  %i.bf = getelementptr i8, ptr %.026.i, i64 %i.be
  %next.gep116 = getelementptr i8, ptr %i.bf, i64 16
  ...
  store <16 x i8> <i8 16, i8 3, i8 16, i8 3, i8 16, i8 3, i8 16, i8 3, i8 16, i8 3, i8 16, i8 3, i8 16, i8 3, i8 16, i8 3>, ptr %next.gep116, align 1, !tbaa !14
  %index.next117 = add nuw i64 %index114, 16      ; 2 uses
  %i.bg = icmp eq i64 %index.next117, %n.vec112
  br i1 %i.bg, label %.lr.ph.preheader120, label %vector.body113, !llvm.loop !24

iter.check:                                       ; preds = %.lr.ph.i35, %.lr.ph.i35.preheader
  %.135.i.lcssa = phi i32 [ %.025.i, %.lr.ph.i35.preheader ], [ %i.cg, %.lr.ph.i35 ] ; 2 uses
  %.12734.i.lcssa = phi ptr [ %.026.i, %.lr.ph.i35.preheader ], [ %i.cf, %.lr.ph.i35 ] ; 6 uses
...
vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check96 = icmp ult i32 %i.bh, 15
  br i1 %min.iters.check96, label %vec.epilog.ph, label %vector.ph.a
...
vector.body.a:                                    ; preds = %vector.body.a, %vector.ph.a
  ...
  %next.gep97 = getelementptr i8, ptr %i.bp, i64 16
  store <16 x i8> %interleaved.vec, ptr %next.gep.a, align 1, !tbaa !14
  store <16 x i8> %interleaved.vec, ptr %next.gep97, align 1, !tbaa !14
  %index.next.a = add nuw i64 %index.a, 16        ; 2 uses
  %i.bq = icmp eq i64 %index.next.a, %n.vec.a
  br i1 %i.bq, label %middle.block, label %vector.body.a, !llvm.loop !25
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec100 = and i64 %i.bj, 8589934588           ; 4 uses
  %i.br = trunc i64 %n.vec100 to i32
  %i.bs = shl nuw nsw i64 %n.vec100, 1
  %i.bt = getelementptr i8, ptr %.12734.i.lcssa, i64 %i.bs ; 2 uses
  %broadcast.splatinsert101 = insertelement <4 x i8> poison, i8 %i.h, i64 0
  %interleaved.vec105 = shufflevector <4 x i8> %broadcast.splatinsert101, <4 x i8> zeroinitializer, <8 x i32> <i32 0, i32 4, i32 0, i32 5, i32 0, i32 6, i32 0, i32 7>
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index103 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next106, %vec.epilog.vector.body ] ; 2 uses
  %i.bu = shl i64 %index103, 1
  %next.gep104 = getelementptr i8, ptr %.12734.i.lcssa, i64 %i.bu
  store <8 x i8> %interleaved.vec105, ptr %next.gep104, align 1, !tbaa !14
  %index.next106 = add nuw i64 %index103, 4       ; 2 uses
  %i.bv = icmp eq i64 %index.next106, %n.vec100
  br i1 %i.bv, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !26

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n107 = icmp eq i64 %i.bj, %n.vec100
  br i1 %cmp.n107, label %CodeRepeatedZeros.exit, label %vec.epilog.scalar.ph.preheader
...
.lr.ph:                                           ; preds = %.lr.ph.preheader120, %.lr.ph.i35
  %.12734.i43 = phi ptr [ %i.cf, %.lr.ph.i35 ], [ %.12734.i43.ph, %.lr.ph.preheader120 ] ; 5 uses
  %.135.i42 = phi i32 [ %i.cg, %.lr.ph.i35 ], [ %.135.i42.ph, %.lr.ph.preheader120 ] ; 4 uses
  %i.bz = icmp samesign ult i32 %.135.i42, 7
  store i8 16, ptr %.12734.i43, align 1, !tbaa !31
  br i1 %i.bz, label %bb.j, label %.lr.ph.i35

bb.j:                                             ; preds = %.lr.ph
  %i.ca = trunc nuw nsw i32 %.135.i42 to i8
  %i.cb = add nsw i8 %i.ca, -3
  %i.cc = getelementptr inbounds nuw i8, ptr %.12734.i43, i64 1
  store i8 %i.cb, ptr %i.cc, align 1, !tbaa !32
  %i.cd = getelementptr inbounds nuw i8, ptr %.12734.i43, i64 2
  br label %CodeRepeatedZeros.exit

.lr.ph.i35:                                       ; preds = %.lr.ph
  %i.ce = getelementptr inbounds nuw i8, ptr %.12734.i43, i64 1
  store i8 3, ptr %i.ce, align 1, !tbaa !32
  %i.cf = getelementptr inbounds nuw i8, ptr %.12734.i43, i64 2 ; 2 uses
  %i.cg = add nsw i32 %.135.i42, -6               ; 2 uses
  %i.ch = icmp samesign ult i32 %.135.i42, 9
...
CodeRepeatedZeros.exit:                           ; preds = %vec.epilog.scalar.ph, %middle.block, %vec.epilog.middle.block, %bb.j, %bb.i, %bb.f, %bb.d, %.lr.ph35.preheader.i
  %.132 = phi ptr [ %i.cd, %bb.j ], [ %scevgep.i, %.lr.ph35.preheader.i ], [ %i.aa, %bb.d ], [ %i.af, %bb.f ], [ %.026.i, %bb.i ], [ %i.bt, %vec.epilog.middle.block ], [ %i.bn, %middle.block ], [ %i.bx, %vec.epilog.scalar.ph ] ; 2 uses
  %.1 = phi i32 [ %i.i, %bb.j ], [ %.03051, %.lr.ph35.preheader.i ], [ %.03051, %bb.d ], [ %.03051, %bb.f ], [ %i.i, %bb.i ], [ %i.i, %vec.epilog.middle.block ], [ %i.i, %middle.block ], [ %i.i, %vec.epilog.scalar.ph ]
...
._crit_edge:                                      ; preds = %CodeRepeatedZeros.exit, %bb.a
  %.031.lcssa = phi ptr [ %1, %bb.a ], [ %.132, %CodeRepeatedZeros.exit ]
  %i.cj = ptrtoint ptr %.031.lcssa to i64
...
.lr.ph.i.preheader:                               ; preds = %bb.a
  ...
  br i1 %i.f, label %OptimizeHuffmanForRle.exit.thread47, label %.lr.ph

OptimizeHuffmanForRle.exit.thread47:              ; preds = %.lr.ph.i.preheader
...
.lr.ph:                                           ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  %.0100124.i33 = phi i32 [ %i.m, %.lr.ph.i ], [ %i.c, %.lr.ph.i.preheader ] ; 4 uses
  %i.i = zext nneg i32 %.0100124.i33 to i64       ; 4 uses
...
.lr.ph.i:                                         ; preds = %.lr.ph
  %i.m = add nsw i32 %.0100124.i33, -1            ; 2 uses
...
._crit_edge139.i:                                 ; preds = %bb.g
  ...
  %i.ad = add nsw i32 %.0100124.i33, -3
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> %broadcast.splat, ptr %i.bh, align 4, !tbaa !54
  store <4 x i32> %broadcast.splat, ptr %i.bi, align 4, !tbaa !54
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.bj = icmp eq i64 %index.next, %n.vec
  br i1 %i.bj, label %middle.block, label %vector.body, !llvm.loop !35
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  store i32 %spec.store.select6.i, ptr %i.bn, align 4, !tbaa !54
...
bb.p:                                             ; preds = %.loopexit.i
  ...
  %i.cf = load <4 x i32>, ptr %i.ce, align 4, !tbaa !54
...
bb.v:                                             ; preds = %bb.u, %bb.t, %.thread117.i, %bb.s
  ...
  br i1 %exitcond160.not.i, label %OptimizeHuffmanForRle.exit, label %bb.h, !llvm.loop !38
...
OptimizeHuffmanForRle.exit:                       ; preds = %.lr.ph.i, %bb.v
  ...
  %wide.trip.count.i14 = zext nneg i32 %i.c to i64 ; 12 uses
  %min.iters.check61 = icmp ult i32 %i.c, 8
  br i1 %min.iters.check61, label %.lr.ph.i15.preheader, label %vector.ph62

vector.ph62:                                      ; preds = %OptimizeHuffmanForRle.exit
  %n.vec63 = and i64 %wide.trip.count.i14, 2147483640 ; 3 uses
...
vector.body64:                                    ; preds = %vector.body64, %vector.ph62
  ...
  %vec.phi = phi <4 x i32> [ zeroinitializer, %vector.ph62 ], [ %i.de, %vector.body64 ]
  %vec.phi66 = phi <4 x i32> [ zeroinitializer, %vector.ph62 ], [ %i.df, %vector.body64 ]
  %i.cw = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %index65 ; 2 uses
  %i.cx = getelementptr inbounds nuw i8, ptr %i.cw, i64 16
  %wide.load = load <4 x i32>, ptr %i.cw, align 4, !tbaa !54
  %wide.load67 = load <4 x i32>, ptr %i.cx, align 4, !tbaa !54
  %i.cy = freeze <4 x i32> %wide.load
  %i.cz = freeze <4 x i32> %wide.load67
  ...
  %i.df = add <4 x i32> %vec.phi66, %i.dd         ; 2 uses
  %index.next68 = add nuw i64 %index65, 8         ; 2 uses
  %i.dg = icmp eq i64 %index.next68, %n.vec63
  br i1 %i.dg, label %middle.block69, label %vector.body64, !llvm.loop !39
...
middle.block69:                                   ; preds = %vector.body64
  ...
  %cmp.n70 = icmp eq i64 %n.vec63, %wide.trip.count.i14
  br i1 %cmp.n70, label %._crit_edge.i19, label %.lr.ph.i15.preheader

.lr.ph.i15.preheader:                             ; preds = %OptimizeHuffmanForRle.exit, %middle.block69
  %indvars.iv.i16.ph = phi i64 [ 0, %OptimizeHuffmanForRle.exit ], [ %n.vec63, %middle.block69 ]
  %.0101112.i.ph = phi i32 [ 0, %OptimizeHuffmanForRle.exit ], [ %i.dh, %middle.block69 ]
  br label %.lr.ph.i15
...
.lr.ph.i15:                                       ; preds = %.lr.ph.i15.preheader, %.lr.ph.i15
  ...
  %.0101112.i = phi i32 [ %spec.select.i, %.lr.ph.i15 ], [ %.0101112.i.ph, %.lr.ph.i15.preheader ]
  %i.di = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv.i16
  %i.dj = load i32, ptr %i.di, align 4, !tbaa !54
  ...
  br i1 %exitcond.not.i18, label %._crit_edge.i19, label %.lr.ph.i15, !llvm.loop !40

._crit_edge.i19:                                  ; preds = %.lr.ph.i15, %middle.block69
  %spec.select.i.lcssa = phi i32 [ %i.dh, %middle.block69 ], [ %spec.select.i, %.lr.ph.i15 ] ; 5 uses
  %i.dl = icmp eq i32 %spec.select.i.lcssa, 0
  br i1 %i.dl, label %GenerateOptimalTree.exit, label %bb.w

bb.w:                                             ; preds = %._crit_edge.i19
...
.lr.ph117.us.us.i.preheader:                      ; preds = %bb.w
  %i.dp = add nsw i64 %wide.trip.count.i14, -1    ; 2 uses
  %min.iters.check108 = icmp ult i32 %i.c, 9
  %n.vec110 = and i64 %i.dp, -8                   ; 3 uses
  %i.dq = or disjoint i64 %n.vec110, 1
  %cmp.n122 = icmp eq i64 %i.dp, %n.vec110
...
bb.x:                                             ; preds = %bb.z, %.lr.ph117.us.us.i
  ...
  %i.ds = load i32, ptr %i.dr, align 4, !tbaa !54 ; 2 uses
...
bb.z:                                             ; preds = %bb.y, %bb.x
  ...
  %exitcond207.not.i = icmp eq i64 %indvars.iv.next204.i, %wide.trip.count.i14
  br i1 %exitcond207.not.i, label %._crit_edge118.us.us.i, label %bb.x, !llvm.loop !41
...
.lr.ph133.us.us.i.preheader:                      ; preds = %._crit_edge118.us.us.i
  br i1 %min.iters.check108, label %.lr.ph133.us.us.i.preheader125, label %vector.ph109

vector.ph109:                                     ; preds = %.lr.ph133.us.us.i.preheader
  %broadcast.splatinsert111 = insertelement <4 x i32> poison, i32 %i.ee, i64 0
...
vector.body113:                                   ; preds = %vector.body113, %vector.ph109
  ...
  %vec.phi115 = phi <4 x i32> [ %broadcast.splat112, %vector.ph109 ], [ %i.ek, %vector.body113 ]
  %vec.phi116 = phi <4 x i32> [ %broadcast.splat112, %vector.ph109 ], [ %i.el, %vector.body113 ]
  %i.ef = getelementptr inbounds nuw i8, ptr %i.cv, i64 %index114 ; 2 uses
  %i.eg = getelementptr inbounds nuw i8, ptr %i.ef, i64 1
  %i.eh = getelementptr inbounds nuw i8, ptr %i.ef, i64 5
  %wide.load117 = load <4 x i8>, ptr %i.eg, align 1, !tbaa !14
  %wide.load118 = load <4 x i8>, ptr %i.eh, align 1, !tbaa !14
  %i.ei = zext <4 x i8> %wide.load117 to <4 x i32>
  %i.ej = zext <4 x i8> %wide.load118 to <4 x i32>
  %i.ek = tail call <4 x i32> @llvm.umax.v4i32(<4 x i32> %vec.phi115, <4 x i32> %i.ei) ; 2 uses
  %i.el = tail call <4 x i32> @llvm.umax.v4i32(<4 x i32> %vec.phi116, <4 x i32> %i.ej) ; 2 uses
  %index.next119 = add nuw i64 %index114, 8       ; 2 uses
  %i.em = icmp eq i64 %index.next119, %n.vec110
  br i1 %i.em, label %middle.block120, label %vector.body113, !llvm.loop !42

middle.block120:                                  ; preds = %vector.body113
  %rdx.minmax121 = tail call <4 x i32> @llvm.umax.v4i32(<4 x i32> %i.ek, <4 x i32> %i.el)
  %i.en = tail call i32 @llvm.vector.reduce.umax.v4i32(<4 x i32> %rdx.minmax121) ; 2 uses
  br i1 %cmp.n122, label %._crit_edge134.us.us.i, label %.lr.ph133.us.us.i.preheader125

.lr.ph133.us.us.i.preheader125:                   ; preds = %.lr.ph133.us.us.i.preheader, %middle.block120
  %indvars.iv208.i.ph = phi i64 [ 1, %.lr.ph133.us.us.i.preheader ], [ %i.dq, %middle.block120 ]
  %.0131.us.us.i.ph = phi i32 [ %i.ee, %.lr.ph133.us.us.i.preheader ], [ %i.en, %middle.block120 ]
  br label %.lr.ph133.us.us.i

.lr.ph133.us.us.i:                                ; preds = %.lr.ph133.us.us.i.preheader125, %.lr.ph133.us.us.i
  %indvars.iv208.i = phi i64 [ %indvars.iv.next209.i, %.lr.ph133.us.us.i ], [ %indvars.iv208.i.ph, %.lr.ph133.us.us.i.preheader125 ] ; 2 uses
  %.0131.us.us.i = phi i32 [ %spec.select110.us.us.i, %.lr.ph133.us.us.i ], [ %.0131.us.us.i.ph, %.lr.ph133.us.us.i.preheader125 ]
  ...
  %exitcond212.not.i = icmp eq i64 %indvars.iv.next209.i, %wide.trip.count.i14
  br i1 %exitcond212.not.i, label %._crit_edge134.us.us.i, label %.lr.ph133.us.us.i, !llvm.loop !43

._crit_edge134.us.us.i:                           ; preds = %.lr.ph133.us.us.i, %middle.block120, %._crit_edge118.us.us.i
  %.0.lcssa.us.us.i = phi i32 [ %i.ee, %._crit_edge118.us.us.i ], [ %i.en, %middle.block120 ], [ %spec.select110.us.us.i, %.lr.ph133.us.us.i ]
...
.split.split.i.preheader:                         ; preds = %.split.i
  %i.et = add nsw i64 %wide.trip.count.i14, -1    ; 2 uses
  %min.iters.check73 = icmp ult i32 %i.c, 9
  %n.vec75 = and i64 %i.et, -8                    ; 3 uses
  %i.eu = or disjoint i64 %n.vec75, 1
  %cmp.n86 = icmp eq i64 %i.et, %n.vec75
...
.split.split.us.preheader.i:                      ; preds = %.split.i
  ...
  %i.ex = add nsw i64 %wide.trip.count.i14, -1    ; 2 uses
  %min.iters.check90 = icmp ult i32 %i.c, 9
  %n.vec92 = and i64 %i.ex, -8                    ; 3 uses
  %i.ey = or disjoint i64 %n.vec92, 1
  %cmp.n104 = icmp eq i64 %i.ex, %n.vec92
...
.lr.ph117.us137.i:                                ; preds = %bb.ab, %.split.split.us.i
  ...
  %i.fa = load i32, ptr %i.ez, align 4, !tbaa !54 ; 2 uses
...
bb.ab:                                            ; preds = %bb.aa, %.lr.ph117.us137.i
  ...
  %exitcond179.not.i = icmp eq i64 %indvars.iv.next176.i, %wide.trip.count.i14
  br i1 %exitcond179.not.i, label %.preheader.us.i, label %.lr.ph117.us137.i, !llvm.loop !41
...
bb.ac:                                            ; preds = %._crit_edge122.us.i, %.preheader.us.i
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.fj, ptr noundef nonnull align 4 dereferenceable(16) %i.fl, i64 16, i1 false), !tbaa.struct !56
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.fm, ptr noundef nonnull align 4 dereferenceable(16) %i.fo, i64 16, i1 false), !tbaa.struct !56
...
bb.ad:                                            ; preds = %.lr.ph121.us.i
  ...
  br i1 %exitcond186.not.i, label %._crit_edge122.us.loopexit.i, label %.lr.ph121.us.i, !llvm.loop !44
...
._crit_edge122.us.i:                              ; preds = %._crit_edge122.us.loopexit.i, %bb.ac
  ...
  br i1 %i.fs, label %bb.ac, label %._crit_edge129.us.i, !llvm.loop !45
...
.lr.ph133.us144.i.preheader:                      ; preds = %._crit_edge129.us.i
  br i1 %min.iters.check90, label %.lr.ph133.us144.i.preheader128, label %vector.ph91

vector.ph91:                                      ; preds = %.lr.ph133.us144.i.preheader
  %broadcast.splatinsert93 = insertelement <4 x i32> poison, i32 %i.gh, i64 0
...
vector.body95:                                    ; preds = %vector.body95, %vector.ph91
  %index96 = phi i64 [ 0, %vector.ph91 ], [ %index.next101, %vector.body95 ] ; 2 uses
  %vec.phi97 = phi <4 x i32> [ %broadcast.splat94, %vector.ph91 ], [ %i.gn, %vector.body95 ]
  %vec.phi98 = phi <4 x i32> [ %broadcast.splat94, %vector.ph91 ], [ %i.go, %vector.body95 ]
  %i.gi = getelementptr inbounds nuw i8, ptr %i.cv, i64 %index96 ; 2 uses
  %i.gj = getelementptr inbounds nuw i8, ptr %i.gi, i64 1
  %i.gk = getelementptr inbounds nuw i8, ptr %i.gi, i64 5
  %wide.load99 = load <4 x i8>, ptr %i.gj, align 1, !tbaa !14
  %wide.load100 = load <4 x i8>, ptr %i.gk, align 1, !tbaa !14
  %i.gl = zext <4 x i8> %wide.load99 to <4 x i32>
  %i.gm = zext <4 x i8> %wide.load100 to <4 x i32>
  %i.gn = tail call <4 x i32> @llvm.umax.v4i32(<4 x i32> %vec.phi97, <4 x i32> %i.gl) ; 2 uses
  %i.go = tail call <4 x i32> @llvm.umax.v4i32(<4 x i32> %vec.phi98, <4 x i32> %i.gm) ; 2 uses
  %index.next101 = add nuw i64 %index96, 8        ; 2 uses
  %i.gp = icmp eq i64 %index.next101, %n.vec92
  br i1 %i.gp, label %middle.block102, label %vector.body95, !llvm.loop !46

middle.block102:                                  ; preds = %vector.body95
  %rdx.minmax103 = tail call <4 x i32> @llvm.umax.v4i32(<4 x i32> %i.gn, <4 x i32> %i.go)
  %i.gq = tail call i32 @llvm.vector.reduce.umax.v4i32(<4 x i32> %rdx.minmax103) ; 2 uses
  br i1 %cmp.n104, label %._crit_edge134.us148.i, label %.lr.ph133.us144.i.preheader128

.lr.ph133.us144.i.preheader128:                   ; preds = %.lr.ph133.us144.i.preheader, %middle.block102
  %indvars.iv198.i.ph = phi i64 [ 1, %.lr.ph133.us144.i.preheader ], [ %i.ey, %middle.block102 ]
  %.0131.us145.i.ph = phi i32 [ %i.gh, %.lr.ph133.us144.i.preheader ], [ %i.gq, %middle.block102 ]
  br label %.lr.ph133.us144.i

.lr.ph133.us144.i:                                ; preds = %.lr.ph133.us144.i.preheader128, %.lr.ph133.us144.i
  %indvars.iv198.i = phi i64 [ %indvars.iv.next199.i, %.lr.ph133.us144.i ], [ %indvars.iv198.i.ph, %.lr.ph133.us144.i.preheader128 ] ; 2 uses
  %.0131.us145.i = phi i32 [ %spec.select110.us147.i, %.lr.ph133.us144.i ], [ %.0131.us145.i.ph, %.lr.ph133.us144.i.preheader128 ]
  ...
  %exitcond202.not.i = icmp eq i64 %indvars.iv.next199.i, %wide.trip.count.i14
  br i1 %exitcond202.not.i, label %._crit_edge134.us148.i, label %.lr.ph133.us144.i, !llvm.loop !47

._crit_edge134.us148.i:                           ; preds = %.lr.ph133.us144.i, %middle.block102, %._crit_edge129.us.i
  %.0.lcssa.us150.i = phi i32 [ %i.gh, %._crit_edge129.us.i ], [ %i.gq, %middle.block102 ], [ %spec.select110.us147.i, %.lr.ph133.us144.i ]
...
.lr.ph117.i:                                      ; preds = %bb.af, %.split.split.i
  ...
  %.096114.i = phi i32 [ %.197.i20, %bb.af ], [ 0, %.split.split.i ] ; 3 uses
  %i.gv = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv165.i
  %i.gw = load i32, ptr %i.gv, align 4, !tbaa !54 ; 2 uses
...
bb.af:                                            ; preds = %bb.ae, %.lr.ph117.i
  %.197.i20 = phi i32 [ %i.hd, %bb.ae ], [ %.096114.i, %.lr.ph117.i ]
  %indvars.iv.next166.i = add nuw nsw i64 %indvars.iv165.i, 1 ; 2 uses
  %exitcond169.not.i = icmp eq i64 %indvars.iv.next166.i, %wide.trip.count.i14
  br i1 %exitcond169.not.i, label %.preheader.i, label %.lr.ph117.i, !llvm.loop !41
...
.lr.ph133.i.preheader:                            ; preds = %.preheader.i
  br i1 %min.iters.check73, label %.lr.ph133.i.preheader132, label %vector.ph74

vector.ph74:                                      ; preds = %.lr.ph133.i.preheader
  %broadcast.splatinsert76 = insertelement <4 x i32> poison, i32 %i.hf, i64 0
...
vector.body78:                                    ; preds = %vector.body78, %vector.ph74
  %index79 = phi i64 [ 0, %vector.ph74 ], [ %index.next84, %vector.body78 ] ; 2 uses
  %vec.phi80 = phi <4 x i32> [ %broadcast.splat77, %vector.ph74 ], [ %i.hl, %vector.body78 ]
  %vec.phi81 = phi <4 x i32> [ %broadcast.splat77, %vector.ph74 ], [ %i.hm, %vector.body78 ]
  %i.hg = getelementptr inbounds nuw i8, ptr %i.cv, i64 %index79 ; 2 uses
  %i.hh = getelementptr inbounds nuw i8, ptr %i.hg, i64 1
  %i.hi = getelementptr inbounds nuw i8, ptr %i.hg, i64 5
  %wide.load82 = load <4 x i8>, ptr %i.hh, align 1, !tbaa !14
  %wide.load83 = load <4 x i8>, ptr %i.hi, align 1, !tbaa !14
  %i.hj = zext <4 x i8> %wide.load82 to <4 x i32>
  %i.hk = zext <4 x i8> %wide.load83 to <4 x i32>
  %i.hl = tail call <4 x i32> @llvm.umax.v4i32(<4 x i32> %vec.phi80, <4 x i32> %i.hj) ; 2 uses
  %i.hm = tail call <4 x i32> @llvm.umax.v4i32(<4 x i32> %vec.phi81, <4 x i32> %i.hk) ; 2 uses
  %index.next84 = add nuw i64 %index79, 8         ; 2 uses
  %i.hn = icmp eq i64 %index.next84, %n.vec75
  br i1 %i.hn, label %middle.block85, label %vector.body78, !llvm.loop !48
...
middle.block85:                                   ; preds = %vector.body78
  ...
  br i1 %cmp.n86, label %._crit_edge134.i, label %.lr.ph133.i.preheader132

.lr.ph133.i.preheader132:                         ; preds = %.lr.ph133.i.preheader, %middle.block85
  %indvars.iv170.i.ph = phi i64 [ 1, %.lr.ph133.i.preheader ], [ %i.eu, %middle.block85 ]
  %.0131.i.ph = phi i32 [ %i.hf, %.lr.ph133.i.preheader ], [ %i.ho, %middle.block85 ]
  br label %.lr.ph133.i

.lr.ph133.i:                                      ; preds = %.lr.ph133.i.preheader132, %.lr.ph133.i
  %indvars.iv170.i = phi i64 [ %indvars.iv.next171.i, %.lr.ph133.i ], [ %indvars.iv170.i.ph, %.lr.ph133.i.preheader132 ] ; 2 uses
  %.0131.i = phi i32 [ %spec.select110.i, %.lr.ph133.i ], [ %.0131.i.ph, %.lr.ph133.i.preheader132 ]
  ...
  %exitcond174.not.i = icmp eq i64 %indvars.iv.next171.i, %wide.trip.count.i14
  br i1 %exitcond174.not.i, label %._crit_edge134.i, label %.lr.ph133.i, !llvm.loop !49

._crit_edge134.i:                                 ; preds = %.lr.ph133.i, %middle.block85, %.preheader.i
  %.0.lcssa.i = phi i32 [ %i.hf, %.preheader.i ], [ %i.ho, %middle.block85 ], [ %spec.select110.i, %.lr.ph133.i ]
  %.not.i21 = icmp sgt i32 %.0.lcssa.i, %1
  %i.hs = shl i32 %.0103.i, 1
  br i1 %.not.i21, label %.split.split.i, label %GenerateOptimalTree.exit

GenerateOptimalTree.exit:                         ; preds = %._crit_edge134.i, %._crit_edge134.us148.i, %._crit_edge134.us.us.i, %OptimizeHuffmanForRle.exit.thread47, %OptimizeHuffmanForRle.exit.thread, %._crit_edge.i19
  %i.ht = phi ptr [ %i.h, %OptimizeHuffmanForRle.exit.thread ], [ %i.cu, %._crit_edge134.us.us.i ], [ %i.cu, %._crit_edge.i19 ], [ %i.cu, %._crit_edge134.us148.i ], [ %i.g, %OptimizeHuffmanForRle.exit.thread47 ], [ %i.cu, %._crit_edge134.i ] ; 2 uses
  ...
  br i1 %i.hv, label %.lr.ph.i23, label %._crit_edge.i22

.lr.ph.i23:                                       ; preds = %GenerateOptimalTree.exit
  %i.hw = load ptr, ptr %i.ht, align 8, !tbaa !13 ; 5 uses
  %wide.trip.count.i24 = zext nneg i32 %i.hu to i64 ; 2 uses
  %xtraiter143 = and i64 %wide.trip.count.i24, 3  ; 3 uses
  %i.hx = icmp ult i32 %i.hu, 4
  br i1 %i.hx, label %.epil.preheader, label %.lr.ph.i23.new

.lr.ph.i23.new:                                   ; preds = %.lr.ph.i23
  %unroll_iter = and i64 %wide.trip.count.i24, 2147483644
  br label %bb.ag

bb.ag:                                            ; preds = %bb.ag, %.lr.ph.i23.new
  %indvars.iv.i25 = phi i64 [ 0, %.lr.ph.i23.new ], [ %indvars.iv.next.i26.3, %bb.ag ] ; 5 uses
  %niter = phi i64 [ 0, %.lr.ph.i23.new ], [ %niter.next.3, %bb.ag ]
  %i.hy = getelementptr inbounds nuw i8, ptr %i.hw, i64 %indvars.iv.i25
  ...
  %i.ic = load i32, ptr %i.ib, align 4, !tbaa !54
  %i.id = add nsw i32 %i.ic, 1
  store i32 %i.id, ptr %i.ib, align 4, !tbaa !54
  %i.ie = getelementptr inbounds nuw i8, ptr %i.hw, i64 %indvars.iv.i25
  ...
  %i.ij = load i32, ptr %i.ii, align 4, !tbaa !54
  %i.ik = add nsw i32 %i.ij, 1
  store i32 %i.ik, ptr %i.ii, align 4, !tbaa !54
  %i.il = getelementptr inbounds nuw i8, ptr %i.hw, i64 %indvars.iv.i25
  ...
  %i.iq = load i32, ptr %i.ip, align 4, !tbaa !54
  %i.ir = add nsw i32 %i.iq, 1
  store i32 %i.ir, ptr %i.ip, align 4, !tbaa !54
  %i.is = getelementptr inbounds nuw i8, ptr %i.hw, i64 %indvars.iv.i25
  ...
  %indvars.iv.next.i26.3 = add nuw nsw i64 %indvars.iv.i25, 4 ; 2 uses
  %niter.next.3 = add i64 %niter, 4               ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %._crit_edge.loopexit.i.unr-lcssa, label %bb.ag, !llvm.loop !50

._crit_edge.loopexit.i.unr-lcssa:                 ; preds = %bb.ag
  %lcmp.mod144.not = icmp eq i64 %xtraiter143, 0
  br i1 %lcmp.mod144.not, label %._crit_edge.loopexit.i, label %.epil.preheader

.epil.preheader:                                  ; preds = %._crit_edge.loopexit.i.unr-lcssa, %.lr.ph.i23
  %indvars.iv.i25.epil.init = phi i64 [ 0, %.lr.ph.i23 ], [ %indvars.iv.next.i26.3, %._crit_edge.loopexit.i.unr-lcssa ]
  %lcmp.mod145 = icmp ne i64 %xtraiter143, 0
  tail call void @llvm.assume(i1 %lcmp.mod145)
  br label %bb.ah

bb.ah:                                            ; preds = %bb.ah, %.epil.preheader
  %indvars.iv.i25.epil = phi i64 [ %indvars.iv.i25.epil.init, %.epil.preheader ], [ %indvars.iv.next.i26.epil, %bb.ah ] ; 2 uses
  %epil.iter = phi i64 [ 0, %.epil.preheader ], [ %epil.iter.next, %bb.ah ]
  %i.iz = getelementptr inbounds nuw i8, ptr %i.hw, i64 %indvars.iv.i25.epil
  ...
  %i.jd = load i32, ptr %i.jc, align 4, !tbaa !54
  %i.je = add nsw i32 %i.jd, 1
  store i32 %i.je, ptr %i.jc, align 4, !tbaa !54
  %indvars.iv.next.i26.epil = add nuw nsw i64 %indvars.iv.i25.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter143
  br i1 %epil.iter.cmp.not, label %._crit_edge.loopexit.i, label %bb.ah, !llvm.loop !51
...
._crit_edge.loopexit.i:                           ; preds = %bb.ah, %._crit_edge.loopexit.i.unr-lcssa
  ...
  %.pre.i = load i32, ptr %.phi.trans.insert39.i, align 4, !tbaa !54
  %.phi.trans.insert41.i = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %.pre42.i = load i32, ptr %.phi.trans.insert41.i, align 8, !tbaa !54
  %.phi.trans.insert44.i = getelementptr inbounds nuw i8, ptr %i.b, i64 12
  %.pre45.i = load i32, ptr %.phi.trans.insert44.i, align 4, !tbaa !54
  %.phi.trans.insert47.i = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  %.pre48.i = load i32, ptr %.phi.trans.insert47.i, align 16, !tbaa !54
  ...
  %.pre54.i = load i32, ptr %.phi.trans.insert53.i, align 8, !tbaa !54
  %.phi.trans.insert56.i = getelementptr inbounds nuw i8, ptr %i.b, i64 28
  %.pre57.i = load i32, ptr %.phi.trans.insert56.i, align 4, !tbaa !54
  %.phi.trans.insert59.i = getelementptr inbounds nuw i8, ptr %i.b, i64 32
  %.pre60.i = load i32, ptr %.phi.trans.insert59.i, align 16, !tbaa !54
  %.phi.trans.insert62.i = getelementptr inbounds nuw i8, ptr %i.b, i64 36
  %.pre63.i = load i32, ptr %.phi.trans.insert62.i, align 4, !tbaa !54
  %.phi.trans.insert65.i = getelementptr inbounds nuw i8, ptr %i.b, i64 40
  %.pre66.i = load i32, ptr %.phi.trans.insert65.i, align 8, !tbaa !54
  %.phi.trans.insert68.i = getelementptr inbounds nuw i8, ptr %i.b, i64 44
  %.pre69.i = load i32, ptr %.phi.trans.insert68.i, align 4, !tbaa !54
  %.phi.trans.insert71.i = getelementptr inbounds nuw i8, ptr %i.b, i64 48
  %.pre72.i = load i32, ptr %.phi.trans.insert71.i, align 16, !tbaa !54
  %.phi.trans.insert74.i = getelementptr inbounds nuw i8, ptr %i.b, i64 52
  %.pre75.i = load i32, ptr %.phi.trans.insert74.i, align 4, !tbaa !54
  %.phi.trans.insert77.i = getelementptr inbounds nuw i8, ptr %i.b, i64 56
  %.pre78.i = load i32, ptr %.phi.trans.insert77.i, align 8, !tbaa !54
  %i.jf = shl i32 %.pre.i, 1
  br label %._crit_edge.i22

._crit_edge.i22:                                  ; preds = %._crit_edge.loopexit.i, %GenerateOptimalTree.exit
  ...
  store i32 0, ptr %i.a, align 16, !tbaa !54
  %i.ju = getelementptr inbounds nuw i8, ptr %i.a, i64 4
  store i32 0, ptr %i.ju, align 4, !tbaa !54
  %i.jv = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store i32 %i.jt, ptr %i.jv, align 8, !tbaa !54
...
bb.ai:                                            ; preds = %ReverseBits.exit.i, %.lr.ph27.i
  ...
  %i.ls = add i32 %i.lr, 1
  store i32 %i.ls, ptr %i.lq, align 4, !tbaa !54
...
.lr.ph.i.i.preheader.new:                         ; preds = %.lr.ph.i.i.preheader
  %unroll_iter151 = and i32 %i.lv, 2147483646
  br label %.lr.ph.i.i
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.i.i.preheader.new
  ...
  %niter152 = phi i32 [ 0, %.lr.ph.i.i.preheader.new ], [ %niter152.next.1, %.lr.ph.i.i ]
  ...
  %niter152.next.1 = add i32 %niter152, 2         ; 2 uses
  %niter152.ncmp.1.not = icmp eq i32 %niter152.next.1, %unroll_iter151
  br i1 %niter152.ncmp.1.not, label %ReverseBits.exit.i.loopexit.unr-lcssa, label %.lr.ph.i.i, !llvm.loop !52

ReverseBits.exit.i.loopexit.unr-lcssa:            ; preds = %.lr.ph.i.i
  %i.mq = and i32 %i.lt, 4
  %lcmp.mod148.not.not = icmp eq i32 %i.mq, 0
  br i1 %lcmp.mod148.not.not, label %.lr.ph.i.i.epil.preheader, label %ReverseBits.exit.i
...
.lr.ph.i.i.epil.preheader:                        ; preds = %ReverseBits.exit.i.loopexit.unr-lcssa, %.lr.ph.i.i.preheader
  ...
  %lcmp.mod150 = trunc i32 %i.lv to i1
...
ReverseBits.exit.i:                               ; preds = %.lr.ph.i.i.epil.preheader, %ReverseBits.exit.i.loopexit.unr-lcssa, %bb.ai
  ...
  br i1 %exitcond38.not.i, label %ConvertBitDepthsToSymbols.exit, label %bb.ai, !llvm.loop !53

ConvertBitDepthsToSymbols.exit:                   ; preds = %ReverseBits.exit.i, %._crit_edge.i22
...
!43 = distinct !{!43, !15, !17, !16}
!44 = distinct !{!44, !15}
!45 = distinct !{!45, !15}
!46 = distinct !{!46, !15, !16, !17}
!47 = distinct !{!47, !15, !17, !16}
...
!56 = !{i64 0, i64 4, !54, i64 4, i64 4, !54, i64 8, i64 4, !54, i64 12, i64 4, !54}
!57 = !{!11, !10, i64 16}
!58 = !{!"short", !4, i64 0}
!59 = !{!58, !58, i64 0}
end_hunk_0
