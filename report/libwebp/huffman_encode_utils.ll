...
bb.b:                                             ; preds = %.lr.ph53, %CodeRepeatedZeros.exit
  %.02952 = phi i32 [ 0, %.lr.ph53 ], [ %.0.lcssa, %CodeRepeatedZeros.exit ] ; 4 uses
  %.03051 = phi i32 [ 8, %.lr.ph53 ], [ %.1, %CodeRepeatedZeros.exit ] ; 4 uses
  %.03150 = phi ptr [ %1, %.lr.ph53 ], [ %.132, %CodeRepeatedZeros.exit ] ; 10 uses
...
.critedge:                                        ; preds = %bb.c, %bb.b, %.critedge.split.loop.exit79
  %.0.lcssa = phi i32 [ %i.p, %.critedge.split.loop.exit79 ], [ %smax, %bb.b ], [ %smax, %bb.c ] ; 4 uses
  %i.q = sub i32 %.0.lcssa, %.02952               ; 13 uses
...
.lr.ph.i.preheader.a:                             ; preds = %.lr.ph.i.preheader
  ...
  br i1 %i.s, label %.lr.ph47.preheader131, label %vector.ph

.lr.ph47.preheader131:                            ; preds = %vector.body, %.lr.ph.i.preheader.a
  %.02331.i46.ph = phi i32 [ %i.q, %.lr.ph.i.preheader.a ], [ %23, %vector.body ]
  %.02232.i45.ph = phi ptr [ %.03150, %.lr.ph.i.preheader.a ], [ %25, %vector.body ]
  br label %.lr.ph47

vector.ph:                                        ; preds = %.lr.ph.i.preheader.a
  %narrow130 = add nuw nsw i32 %16, 1
  %17 = zext nneg i32 %narrow130 to i64           ; 2 uses
  ...
  %25 = getelementptr i8, ptr %.03150, i64 %24
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %26 = shl i64 %index, 1                         ; 2 uses
  %next.gep = getelementptr i8, ptr %.03150, i64 %26
  %27 = getelementptr i8, ptr %.03150, i64 %26
  %next.gep92 = getelementptr i8, ptr %27, i64 16
  ...
  store <16 x i8> <i8 18, i8 127, i8 18, i8 127, i8 18, i8 127, i8 18, i8 127, i8 18, i8 127, i8 18, i8 127, i8 18, i8 127, i8 18, i8 127>, ptr %next.gep92, align 1, !tbaa !14
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %28 = icmp eq i64 %index.next, %n.vec
  br i1 %28, label %.lr.ph47.preheader131, label %vector.body, !llvm.loop !24

.lr.ph35.preheader.i:                             ; preds = %.lr.ph.i, %.lr.ph.i.preheader
  %.02232.i.lcssa = phi ptr [ %.03150, %.lr.ph.i.preheader ], [ %i.ah, %.lr.ph.i ]
  ...
  %39 = getelementptr i8, ptr %.03150, i64 %38
  %scevgep.i = getelementptr i8, ptr %39, i64 %i.v
  br label %CodeRepeatedZeros.exit

.lr.ph47:                                         ; preds = %.lr.ph47.preheader131, %.lr.ph.i
  %.02331.i46 = phi i32 [ %i.ai, %.lr.ph.i ], [ %.02331.i46.ph, %.lr.ph47.preheader131 ] ; 6 uses
  %.02232.i45 = phi ptr [ %i.ah, %.lr.ph.i ], [ %.02232.i45.ph, %.lr.ph47.preheader131 ] ; 8 uses
  %i.w = icmp samesign ult i32 %.02331.i46, 11
  br i1 %i.w, label %bb.d, label %bb.e

bb.d:                                             ; preds = %.lr.ph47
  store i8 17, ptr %.02232.i45, align 1, !tbaa !33
...
bb.e:                                             ; preds = %.lr.ph47
  ...
  store i8 18, ptr %.02232.i45, align 1, !tbaa !33
...
.lr.ph.i:                                         ; preds = %bb.e
  ...
  %i.ai = add nsw i32 %.02331.i46, -138
  %i.aj = icmp slt i32 %.02331.i46, 141
  br i1 %i.aj, label %.lr.ph35.preheader.i, label %.lr.ph47, !llvm.loop !25
...
bb.h:                                             ; preds = %bb.g
  store i8 %i.h, ptr %.03150, align 1, !tbaa !33
...
vector.body113:                                   ; preds = %vector.body113, %vector.ph111
  ...
  br i1 %i.bg, label %.lr.ph.preheader120, label %vector.body113, !llvm.loop !26
...
.lr.ph:                                           ; preds = %.lr.ph.preheader120, %.lr.ph.i35
  ...
  store i8 16, ptr %.12734.i43, align 1, !tbaa !33
...
vector.body64:                                    ; preds = %vector.body64, %vector.ph62
  ...
  %wide.load67 = load <4 x i32>, ptr %i.cx, align 4, !tbaa !56
  ...
  br i1 %i.dg, label %middle.block69, label %vector.body64, !llvm.loop !41
...
.lr.ph.i15:                                       ; preds = %.lr.ph.i15.preheader, %.lr.ph.i15
  ...
  br i1 %exitcond.not.i18, label %._crit_edge.i19, label %.lr.ph.i15, !llvm.loop !42
...
vector.body113:                                   ; preds = %vector.body113, %vector.ph109
  ...
  br i1 %i.em, label %middle.block120, label %vector.body113, !llvm.loop !44
...
vector.body95:                                    ; preds = %vector.body95, %vector.ph91
  ...
  br i1 %i.gp, label %middle.block102, label %vector.body95, !llvm.loop !48
...
vector.body78:                                    ; preds = %vector.body78, %vector.ph74
  ...
  br i1 %i.hn, label %middle.block85, label %vector.body78, !llvm.loop !50
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.i.i.preheader.new
  ...
  br i1 %niter152.ncmp.1.not, label %ReverseBits.exit.i.loopexit.unr-lcssa, label %.lr.ph.i.i, !llvm.loop !54
