...
.critedge:                                        ; preds = %bb.c, %bb.b, %.critedge.split.loop.exit80
  ...
  %i.q = sub nsw i32 %.0.lcssa, %.02955           ; 5 uses
...
.lr.ph50:                                         ; preds = %.lr.ph.preheader.i, %.lr.ph.i
  %.02331.i49 = phi i32 [ %i.ai, %.lr.ph.i ], [ %i.q, %.lr.ph.preheader.i ] ; 6 uses
...
bb.f:                                             ; preds = %bb.e
  %i.ac = trunc nuw i32 %.02331.i49 to i8
  %i.ad = add i8 %i.ac, -11
