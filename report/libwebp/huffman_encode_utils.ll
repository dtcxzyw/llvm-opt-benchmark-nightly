...
bb.a:
  ...
  br i1 %i.b, label %.lr.ph56, label %._crit_edge
...
bb.b:                                             ; preds = %.lr.ph56, %CodeRepeatedZeros.exit
  %.02955 = phi i32 [ 0, %.lr.ph56 ], [ %.0.lcssa, %CodeRepeatedZeros.exit ] ; 3 uses
  %.03054 = phi i32 [ 8, %.lr.ph56 ], [ %.1, %CodeRepeatedZeros.exit ] ; 4 uses
  %.03153 = phi ptr [ %1, %.lr.ph56 ], [ %.132, %CodeRepeatedZeros.exit ] ; 6 uses
  %i.e = load ptr, ptr %i.c, align 8, !tbaa !13   ; 2 uses
  %i.f = zext nneg i32 %.02955 to i64             ; 2 uses
  %i.g = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.f
  %i.h = load i8, ptr %i.g, align 1, !tbaa !14    ; 7 uses
  %i.i = zext i8 %i.h to i32                      ; 6 uses
  %i.j = add nuw nsw i32 %.02955, 1
...
.lr.ph95:                                         ; preds = %bb.b, %bb.c
  ...
  br i1 %i.o, label %bb.c, label %.critedge.split.loop.exit80, !llvm.loop !23

.critedge.split.loop.exit80:                      ; preds = %.lr.ph95
  %i.p = trunc nuw nsw i64 %indvars.iv.next93 to i32
  br label %.critedge

.critedge:                                        ; preds = %bb.c, %bb.b, %.critedge.split.loop.exit80
  %.0.lcssa = phi i32 [ %i.p, %.critedge.split.loop.exit80 ], [ %smax, %bb.b ], [ %smax, %bb.c ] ; 3 uses
  %i.q = sub nsw i32 %.0.lcssa, %.02955           ; 6 uses
...
.lr.ph.preheader.i:                               ; preds = %.critedge
  ...
  br i1 %i.s, label %.lr.ph35.preheader.i, label %.lr.ph50

.lr.ph35.preheader.i:                             ; preds = %.lr.ph.i, %.lr.ph.preheader.i
  %.02232.i.lcssa = phi ptr [ %.03153, %.lr.ph.preheader.i ], [ %i.ah, %.lr.ph.i ] ; 2 uses
...
.lr.ph50:                                         ; preds = %.lr.ph.preheader.i, %.lr.ph.i
  %.02331.i49 = phi i32 [ %i.ai, %.lr.ph.i ], [ %i.q, %.lr.ph.preheader.i ] ; 5 uses
  %.02232.i48 = phi ptr [ %i.ah, %.lr.ph.i ], [ %.03153, %.lr.ph.preheader.i ] ; 8 uses
  %i.w = icmp samesign ult i32 %.02331.i49, 11
  br i1 %i.w, label %bb.d, label %bb.e

bb.d:                                             ; preds = %.lr.ph50
  store i8 17, ptr %.02232.i48, align 1, !tbaa !31
  %i.x = trunc nuw nsw i32 %.02331.i49 to i8
  %i.y = add nsw i8 %i.x, -3
  %i.z = getelementptr inbounds nuw i8, ptr %.02232.i48, i64 1
  store i8 %i.y, ptr %i.z, align 1, !tbaa !32
  %i.aa = getelementptr inbounds nuw i8, ptr %.02232.i48, i64 2
  br label %CodeRepeatedZeros.exit

bb.e:                                             ; preds = %.lr.ph50
  %i.ab = icmp samesign ult i32 %.02331.i49, 139
  store i8 18, ptr %.02232.i48, align 1, !tbaa !31
  br i1 %i.ab, label %bb.f, label %.lr.ph.i

bb.f:                                             ; preds = %bb.e
  %i.ac = trunc nuw i32 %4 to i8
  %i.ad = add i8 %i.ac, -10
  %i.ae = getelementptr inbounds nuw i8, ptr %.02232.i48, i64 1
  store i8 %i.ad, ptr %i.ae, align 1, !tbaa !32
  %i.af = getelementptr inbounds nuw i8, ptr %.02232.i48, i64 2
  br label %CodeRepeatedZeros.exit

.lr.ph.i:                                         ; preds = %bb.e
  %i.ag = getelementptr inbounds nuw i8, ptr %.02232.i48, i64 1
  store i8 127, ptr %i.ag, align 1, !tbaa !32
  %i.ah = getelementptr i8, ptr %.02232.i48, i64 2 ; 2 uses
  %i.ai = add nsw i32 %.02331.i49, -138           ; 2 uses
  %i.aj = icmp slt i32 %.02331.i49, 141
  br i1 %i.aj, label %.lr.ph35.preheader.i, label %.lr.ph50

bb.g:                                             ; preds = %.critedge
  %.not.i = icmp eq i32 %.03054, %i.i
  br i1 %.not.i, label %bb.i, label %bb.h

bb.h:                                             ; preds = %bb.g
  store i8 %i.h, ptr %.03153, align 1, !tbaa !31
  %i.ak = getelementptr inbounds nuw i8, ptr %.03153, i64 1
  store i8 0, ptr %i.ak, align 1, !tbaa !32
  %i.al = getelementptr inbounds nuw i8, ptr %.03153, i64 2
  %i.am = add nsw i32 %i.q, -1
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.g
  %.026.i = phi ptr [ %i.al, %bb.h ], [ %.03153, %bb.g ] ; 6 uses
  %.025.i = phi i32 [ %i.am, %bb.h ], [ %i.q, %bb.g ] ; 8 uses
  %i.an = icmp sgt i32 %.025.i, 0
  br i1 %i.an, label %.lr.ph.preheader.i35, label %CodeRepeatedZeros.exit

.lr.ph.preheader.i35:                             ; preds = %bb.i
  %5 = add nsw i32 %.025.i, -1
  %6 = urem i32 %5, 6
  %i.ao = icmp samesign ult i32 %.025.i, 3
  br i1 %i.ao, label %iter.check, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %.lr.ph.preheader.i35
...
.lr.ph.preheader120:                              ; preds = %vector.body113, %.lr.ph.preheader
  %.12734.i46.ph = phi ptr [ %.026.i, %.lr.ph.preheader ], [ %i.ba, %vector.body113 ]
  %.135.i45.ph = phi i32 [ %.025.i, %.lr.ph.preheader ], [ %i.bd, %vector.body113 ]
  br label %.lr.ph
...
iter.check:                                       ; preds = %.lr.ph.i37, %.lr.ph.preheader.i35
  %.135.i.lcssa = phi i32 [ %.025.i, %.lr.ph.preheader.i35 ], [ %i.cg, %.lr.ph.i37 ] ; 2 uses
  %.12734.i.lcssa = phi ptr [ %.026.i, %.lr.ph.preheader.i35 ], [ %i.cf, %.lr.ph.i37 ] ; 6 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader120, %.lr.ph.i37
  %.12734.i46 = phi ptr [ %i.cf, %.lr.ph.i37 ], [ %.12734.i46.ph, %.lr.ph.preheader120 ] ; 5 uses
  %.135.i45 = phi i32 [ %i.cg, %.lr.ph.i37 ], [ %.135.i45.ph, %.lr.ph.preheader120 ] ; 3 uses
  %i.bz = icmp samesign ult i32 %.135.i45, 7
  store i8 16, ptr %.12734.i46, align 1, !tbaa !31
  br i1 %i.bz, label %bb.j, label %.lr.ph.i37

bb.j:                                             ; preds = %.lr.ph
  %i.ca = trunc nuw nsw i32 %6 to i8
  %i.cb = add nsw i8 %i.ca, -2
  %i.cc = getelementptr inbounds nuw i8, ptr %.12734.i46, i64 1
  store i8 %i.cb, ptr %i.cc, align 1, !tbaa !32
  %i.cd = getelementptr inbounds nuw i8, ptr %.12734.i46, i64 2
  br label %CodeRepeatedZeros.exit

.lr.ph.i37:                                       ; preds = %.lr.ph
  %i.ce = getelementptr inbounds nuw i8, ptr %.12734.i46, i64 1
  store i8 3, ptr %i.ce, align 1, !tbaa !32
  %i.cf = getelementptr inbounds nuw i8, ptr %.12734.i46, i64 2 ; 2 uses
  %i.cg = add nsw i32 %.135.i45, -6               ; 2 uses
  %i.ch = icmp samesign ult i32 %.135.i45, 9
...
CodeRepeatedZeros.exit:                           ; preds = %vec.epilog.scalar.ph, %middle.block, %vec.epilog.middle.block, %bb.j, %bb.i, %bb.f, %bb.d, %.lr.ph35.preheader.i
  ...
  %.1 = phi i32 [ %i.i, %bb.j ], [ %.03054, %.lr.ph35.preheader.i ], [ %.03054, %bb.d ], [ %.03054, %bb.f ], [ %i.i, %bb.i ], [ %i.i, %vec.epilog.middle.block ], [ %i.i, %middle.block ], [ %i.i, %vec.epilog.scalar.ph ]
