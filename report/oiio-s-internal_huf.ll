...
.epil.preheader:                                  ; preds = %countFrequencies.exit.preheader.unr-lcssa, %15
  ...
  %lcmp.mod546 = icmp ne i64 %xtraiter, 0         ; [#uses=1 type=i1]
...
begin_hunk_1
  ...
  %.not547 = icmp eq i64 %indvars.iv.next37.i.i, 1 ; [#uses=1 type=i1]
...
begin_hunk_2
  ...
  %.fr500 = freeze i32 %358                       ; [#uses=1 type=i32]
  %359 = lshr i32 %.fr500, 3                      ; [#uses=1 type=i32]
...
begin_hunk_3
  ...
  %.fr499 = freeze i32 %415                       ; [#uses=1 type=i32]
  %416 = lshr i32 %.fr499, 3                      ; [#uses=1 type=i32]
...
begin_hunk_4
  ...
  %.fr501 = freeze i32 %442                       ; [#uses=1 type=i32]
  %443 = lshr i32 %.fr501, 3                      ; [#uses=1 type=i32]
...
begin_hunk_5
  ...
  %.fr = freeze i64 %510                          ; [#uses=1 type=i64]
  %511 = lshr i64 %.fr, 3                         ; [#uses=1 type=i64]
...
begin_hunk_6
  ...
  %531 = add nsw i32 %.1186.lcssa.i, %479         ; [#uses=1 type=i32]
  %.fr505 = freeze i32 %531                       ; [#uses=4 type=i32]
  %532 = icmp slt i32 %.fr505, 8                  ; [#uses=1 type=i1]
...
.lr.ph332.preheader.i:                            ; preds = %.critedge.i61
  ...
  %533 = zext nneg i32 %.fr505 to i64             ; [#uses=4 type=i64]
...
begin_hunk_7
  ...
  %561 = add nsw i32 %.fr505, 8                   ; [#uses=2 type=i32]
  %562 = icmp slt i32 %.fr505, 0                  ; [#uses=1 type=i1]
...
begin_hunk_8
  ...
  %.fr507 = freeze i32 %567                       ; [#uses=1 type=i32]
  %568 = lshr i32 %.fr507, 3                      ; [#uses=1 type=i32]
...
begin_hunk_9
  ...
  %.fr508 = freeze i64 %648                       ; [#uses=1 type=i64]
  %649 = lshr i64 %.fr508, 3                      ; [#uses=1 type=i64]
...
begin_hunk_10
  ...
  %.fr509 = freeze i64 %674                       ; [#uses=1 type=i64]
  %675 = lshr i64 %.fr509, 3                      ; [#uses=1 type=i64]
...
begin_hunk_11
  ...
  %.fr511 = freeze i32 %707                       ; [#uses=1 type=i32]
  %708 = lshr i32 %.fr511, 3                      ; [#uses=1 type=i32]
