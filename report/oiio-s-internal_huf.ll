...
begin_hunk_1
  ...
  %.fr500 = freeze i32 %358
  %359 = lshr i32 %.fr500, 3
...
begin_hunk_2
  ...
  %.fr499 = freeze i32 %415
  %416 = lshr i32 %.fr499, 3
...
begin_hunk_3
  ...
  %.fr501 = freeze i32 %442
  %443 = lshr i32 %.fr501, 3
...
begin_hunk_5
  ...
  %531 = add nsw i32 %.1186.lcssa.i, %479
  %.fr505 = freeze i32 %531                       ; 4 uses
  %532 = icmp slt i32 %.fr505, 8
...
.lr.ph332.preheader.i:                            ; preds = %.critedge.i61
  ...
  %533 = zext nneg i32 %.fr505 to i64             ; 4 uses
...
begin_hunk_6
  ...
  %561 = add nsw i32 %.fr505, 8                   ; 2 uses
  %562 = icmp slt i32 %.fr505, 0
...
begin_hunk_7
  ...
  %.fr507 = freeze i32 %567
  %568 = lshr i32 %.fr507, 3
...
begin_hunk_8
  ...
  %.fr508 = freeze i64 %648
  %649 = lshr i64 %.fr508, 3
  %650 = add i64 %2, %8
...
begin_hunk_9
  ...
  %.fr509 = freeze i64 %674
  %675 = lshr i64 %.fr509, 3
  %676 = add i64 %2, %8
...
begin_hunk_10
  ...
  %.fr511 = freeze i32 %707
  %708 = lshr i32 %.fr511, 3
