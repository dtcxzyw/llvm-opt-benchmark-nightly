...
bb.bo:                                            ; preds = %bb.bn
  ...
  %i.so = getelementptr inbounds nuw i8, ptr %3, i64 8 ; 7 uses
...
.rtvec:                                           ; preds = %bb.an
  ...
  %6 = load <4 x float>, ptr %i.abw, align 8
  %7 = load <4 x float>, ptr %i.abx, align 8
  %i.acd = insertelement <4 x float> poison, float %i.aca, i64 2
  %i.ace = insertelement <4 x float> %i.acd, float %i.lg, i64 3
  %i.acf = shufflevector <4 x float> %6, <4 x float> %i.ace, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.acg = insertelement <4 x float> <float poison, float poison, float poison, float 1.000000e+00>, float %i.acc, i64 2
  %i.ach = shufflevector <4 x float> %7, <4 x float> %i.acg, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
...
.rtvec659:                                        ; preds = %bb.aq
  ...
  %8 = load <4 x float>, ptr %i.adc, align 8
  ...
  %i.adp = shufflevector <4 x float> %8, <4 x float> %i.ado, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
...
.rtvec670:                                        ; preds = %bb.at
  ...
  %9 = load <4 x float>, ptr %i.aek, align 8
  %i.aes = insertelement <4 x float> poison, float %i.aeq, i64 2
  %i.aet = insertelement <4 x float> %i.aes, float %i.mg, i64 3
  %i.aeu = shufflevector <4 x float> %9, <4 x float> %i.aet, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
...
.rtvec681:                                        ; preds = %bb.bp
  ...
  store i32 5, ptr %0, align 8, !tbaa !76
  %10 = load <2 x double>, ptr %i.so, align 8
  %11 = shufflevector <2 x double> %10, <2 x double> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %i.aft = getelementptr inbounds nuw i8, ptr %0, i64 8
  %12 = load double, ptr %i.so, align 8, !tbaa !79 ; 3 uses
  %i.afu = load <4 x float>, ptr %i.afs, align 8, !tbaa !79
  %13 = insertelement <4 x double> %11, double %12, i64 1
  %i.afv = insertelement <4 x double> %13, double %12, i64 2
  %14 = insertelement <4 x double> %i.afv, double %12, i64 3
  %i.afw = fptrunc <4 x double> %14 to <4 x float>
