...
.lr.ph:                                           ; preds = %bb.a, %bb.e
  ...
  %.sroa.035.044 = phi ptr [ %.sroa.035.1, %bb.e ], [ undef, %bb.a ]
  %.sroa.024.043 = phi ptr [ %.sroa.024.1, %bb.e ], [ undef, %bb.a ]
...
bb.c:                                             ; preds = %bb.b, %.lr.ph
  %.sroa.035.1 = phi ptr [ %i.m, %bb.b ], [ %.sroa.035.044, %.lr.ph ] ; 2 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c
  %.sroa.024.1 = phi ptr [ %i.s, %bb.d ], [ %.sroa.024.043, %bb.c ] ; 2 uses
...
.lr.ph:                                           ; preds = %bb.a, %bb.e
  ...
  %.sroa.053.062 = phi ptr [ %.sroa.053.1, %bb.e ], [ undef, %bb.a ]
  %.sroa.042.061 = phi ptr [ %.sroa.042.1, %bb.e ], [ undef, %bb.a ]
...
bb.c:                                             ; preds = %bb.b, %.lr.ph
  %.sroa.053.1 = phi ptr [ %i.m, %bb.b ], [ %.sroa.053.062, %.lr.ph ] ; 2 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c
  %.sroa.042.1 = phi ptr [ %i.s, %bb.d ], [ %.sroa.042.061, %bb.c ] ; 2 uses
