...
.lr.ph.i.i.i.preheader.i:                         ; preds = %_ZN4Luau11SmallVectorINS_7CodeGen4IrOpELj6EE7reserveEj.exit.i
  ...
  %1 = sub nsw i64 %i.es, %i.ew
  %i.ez = add nsw i64 %1, 4611686018427387903
  %2 = and i64 %i.ez, 4611686018427387903         ; 2 uses
  %i.fa = add nuw nsw i64 %2, 1                   ; 2 uses
...
.lr.ph.i.i.i.preheader:                           ; preds = %_ZN4Luau11SmallVectorINS_7CodeGen4IrOpELj6EE7reserveEj.exit
  ...
  %i.bn = add nsw i64 %2, 4611686018427387903
  %3 = and i64 %i.bn, 4611686018427387903         ; 2 uses
  %i.bo = add nuw nsw i64 %3, 1                   ; 2 uses
  %min.iters.check33 = icmp samesign ult i64 %3, 11
