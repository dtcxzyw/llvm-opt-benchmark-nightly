...
thread-pre-split:                                 ; preds = %bb.f, %.lr.ph.i, %._crit_edge.i
  %.sroa.11.1.ph.a = phi i64 [ %.sroa.11.0179, %.lr.ph.i ], [ %i.ed, %._crit_edge.i ], [ %.sroa.11.0179, %bb.f ]
  ...
  br i1 %i.j, label %bb.ah, label %.lr.ph188
...
.lr.ph188:                                        ; preds = %.noexc, %thread-pre-split
  ...
  %.sroa.11.0179 = phi i64 [ %.sroa.11.1.ph.a, %thread-pre-split ], [ 0, %.noexc ] ; 6 uses
...
_ZN4Luau8VecDequeIPKNS_4TypeESaIS3_EE9pop_frontEv.exit: ; preds = %.lr.ph188, %bb.c
  %i.t = icmp eq i64 %.sroa.11.0179, 0            ; 2 uses
...
bb.f:                                             ; preds = %bb.h, %bb.e
  ...
  %.01832.i.i = phi i64 [ 0, %bb.e ], [ %i.ae, %bb.h ]
  %.01933.i.i = and i64 %.pn.i.i, %i.v            ; 2 uses
  %i.aa = getelementptr inbounds nuw [8 x i8], ptr %.sroa.090.0186, i64 %.01933.i.i
...
bb.h:                                             ; preds = %bb.g
  %i.ae = add i64 %.01832.i.i, 1                  ; 3 uses
  %i.af = add i64 %i.ae, %.01933.i.i
...
bb.p:                                             ; preds = %bb.r, %bb.o
  ...
  %.01832.i.i49 = phi i64 [ 0, %bb.o ], [ %i.bk, %bb.r ]
  %.01933.i.i50 = and i64 %.pn.i.i48, %i.ba       ; 2 uses
  %i.bg = getelementptr inbounds nuw [8 x i8], ptr %i.bf, i64 %.01933.i.i50
...
bb.r:                                             ; preds = %bb.q
  %i.bk = add i64 %.01832.i.i49, 1                ; 3 uses
  %i.bl = add i64 %i.bk, %.01933.i.i50
...
_ZNK4Luau12DenseHashSetIPKvNS_16DenseHashPointerESt8equal_toIS2_EE8containsERKS2_.exit: ; preds = %bb.u, %bb.j, %_ZN4Luau3getINS_16IntersectionTypeEEEPKT_PKNS_4TypeE.exit, %.loopexit
  ...
  %.not.i.i58 = icmp ult i64 %.sroa.11.0179, %i.cg
...
_ZNK4Luau12DenseHashSetIPKvNS_16DenseHashPointerESt8equal_toIS2_EE8containsERKS2_.exit.thread151: ; preds = %bb.d
  ...
  %.not.i.i58155 = icmp ult i64 %.sroa.11.0179, %i.ci
...
bb.y:                                             ; preds = %bb.aa, %bb.x
  ...
  %.01832.i.i.i = phi i64 [ 0, %bb.x ], [ %i.cs, %bb.aa ]
  %.01933.i.i.i = and i64 %.pn.i.i.i, %i.cj       ; 2 uses
  %i.co = getelementptr inbounds nuw [8 x i8], ptr %.sroa.090.0186, i64 %.01933.i.i.i
...
bb.aa:                                            ; preds = %bb.z
  %i.cs = add i64 %.01832.i.i.i, 1                ; 3 uses
  %i.ct = add i64 %i.cs, %.01933.i.i.i
...
bb.ad:                                            ; preds = %bb.ac
  ...
  %.02136.i22.i = and i64 %i.df, %i.cy            ; 3 uses
  %i.dg = getelementptr inbounds nuw [8 x i8], ptr %.sroa.0.0.i, i64 %.02136.i22.i
...
._crit_edge.i69:                                  ; preds = %bb.ae, %bb.ad
  %.02136.i.lcssa21.i = phi i64 [ %.02136.i22.i, %bb.ad ], [ %.02136.i.i68, %bb.ae ]
  %i.dj = getelementptr inbounds nuw [8 x i8], ptr %.sroa.0.0.i, i64 %.02136.i.lcssa21.i ; 2 uses
...
.lr.ph.i67:                                       ; preds = %bb.ad, %bb.ae
  ...
  %.02136.i24.i = phi i64 [ %.02136.i.i68, %bb.ae ], [ %.02136.i22.i, %bb.ad ] ; 2 uses
  %.02035.i23.i = phi i64 [ %i.dm, %bb.ae ], [ 0, %bb.ad ]
...
bb.ae:                                            ; preds = %.lr.ph.i67
  %i.dm = add i64 %.02035.i23.i, 1                ; 3 uses
  %i.dn = add i64 %i.dm, %.02136.i24.i
  %.not.i12.i = icmp ule i64 %i.dm, %i.cy
  call void @llvm.assume(i1 %.not.i12.i)
  %.02136.i.i68 = and i64 %i.dn, %i.cy            ; 3 uses
  %i.do = getelementptr inbounds nuw [8 x i8], ptr %.sroa.0.0.i, i64 %.02136.i.i68
...
_ZN4Luau6detail14DenseHashTableIPKNS_4TypeES4_S4_NS0_16ItemInterfaceSetIS4_EENS_16DenseHashPointerESt8equal_toIS4_EE13insert_unsafeERKS4_.exit.loopexit.i70: ; preds = %.lr.ph.i67
  %i.dr = getelementptr inbounds nuw [8 x i8], ptr %.sroa.0.0.i, i64 %.02136.i24.i
  br label %_ZN4Luau6detail14DenseHashTableIPKNS_4TypeES4_S4_NS0_16ItemInterfaceSetIS4_EENS_16DenseHashPointerESt8equal_toIS4_EE13insert_unsafeERKS4_.exit.i
...
_ZN4Luau6detail14DenseHashTableIPKNS_4TypeES4_S4_NS0_16ItemInterfaceSetIS4_EENS_16DenseHashPointerESt8equal_toIS4_EE14rehash_if_fullERKS4_.exit.i: ; preds = %bb.y, %_ZNK4Luau12DenseHashSetIPKvNS_16DenseHashPointerESt8equal_toIS2_EE8containsERKS2_.exit.thread151, %._crit_edge28.i, %bb.ab, %_ZNK4Luau12DenseHashSetIPKvNS_16DenseHashPointerESt8equal_toIS2_EE8containsERKS2_.exit
  ...
  %.02136.i6.i = and i64 %i.du, %i.dy             ; 3 uses
  %i.dz = getelementptr inbounds nuw [8 x i8], ptr %.sroa.090.4, i64 %.02136.i6.i
...
._crit_edge.i:                                    ; preds = %bb.ag, %_ZN4Luau6detail14DenseHashTableIPKNS_4TypeES4_S4_NS0_16ItemInterfaceSetIS4_EENS_16DenseHashPointerESt8equal_toIS4_EE14rehash_if_fullERKS4_.exit.i
  %.02136.i.lcssa5.i = phi i64 [ %.02136.i6.i, %_ZN4Luau6detail14DenseHashTableIPKNS_4TypeES4_S4_NS0_16ItemInterfaceSetIS4_EENS_16DenseHashPointerESt8equal_toIS4_EE14rehash_if_fullERKS4_.exit.i ], [ %.02136.i.i, %bb.ag ]
  %i.ec = getelementptr inbounds nuw [8 x i8], ptr %.sroa.090.4, i64 %.02136.i.lcssa5.i
  store ptr %i.o, ptr %i.ec, align 8, !tbaa !88
  %i.ed = add i64 %.sroa.11.0179, 1
...
.lr.ph.i:                                         ; preds = %_ZN4Luau6detail14DenseHashTableIPKNS_4TypeES4_S4_NS0_16ItemInterfaceSetIS4_EENS_16DenseHashPointerESt8equal_toIS4_EE14rehash_if_fullERKS4_.exit.i, %bb.ag
  ...
  %.02136.i8.i = phi i64 [ %.02136.i.i, %bb.ag ], [ %.02136.i6.i, %_ZN4Luau6detail14DenseHashTableIPKNS_4TypeES4_S4_NS0_16ItemInterfaceSetIS4_EENS_16DenseHashPointerESt8equal_toIS4_EE14rehash_if_fullERKS4_.exit.i ]
  %.02035.i7.i = phi i64 [ %i.eg, %bb.ag ], [ 0, %_ZN4Luau6detail14DenseHashTableIPKNS_4TypeES4_S4_NS0_16ItemInterfaceSetIS4_EENS_16DenseHashPointerESt8equal_toIS4_EE14rehash_if_fullERKS4_.exit.i ]
  %i.ef = icmp eq ptr %i.ee, %i.o
  br i1 %i.ef, label %thread-pre-split, label %bb.ag

bb.ag:                                            ; preds = %.lr.ph.i
  %i.eg = add i64 %.02035.i7.i, 1                 ; 3 uses
  %i.eh = add i64 %i.eg, %.02136.i8.i
  %.not.i3.i = icmp ule i64 %i.eg, %i.du
  call void @llvm.assume(i1 %.not.i3.i)
  %.02136.i.i = and i64 %i.eh, %i.du              ; 3 uses
  %i.ei = getelementptr inbounds nuw [8 x i8], ptr %.sroa.090.4, i64 %.02136.i.i
...
_ZNK4Luau12DenseHashSetIPKNS_4TypeENS_16DenseHashPointerESt8equal_toIS3_EE8containsERKS3_.exit: ; preds = %bb.j, %.lr.ph194, %bb.r, %bb.q, %bb.p, %._crit_edge, %bb.n, %_ZN4Luau3getINS_24TypeFunctionInstanceTypeEEEPKT_PKNS_4TypeE.exit, %bb.k
  ...
  br i1 %.not.i.i61, label %_ZN4Luau12DenseHashSetIPKNS_4TypeENS_16DenseHashPointerESt8equal_toIS3_EED2Ev.exit, label %bb.ah

bb.ah:                                            ; preds = %thread-pre-split, %_ZNK4Luau12DenseHashSetIPKNS_4TypeENS_16DenseHashPointerESt8equal_toIS3_EE8containsERKS3_.exit
...
_ZN4Luau12DenseHashSetIPKNS_4TypeENS_16DenseHashPointerESt8equal_toIS3_EED2Ev.exit: ; preds = %.noexc, %_ZNK4Luau12DenseHashSetIPKNS_4TypeENS_16DenseHashPointerESt8equal_toIS3_EE8containsERKS3_.exit, %bb.ah
  %.6235 = phi i32 [ %.6241, %bb.ah ], [ %.6, %_ZNK4Luau12DenseHashSetIPKNS_4TypeENS_16DenseHashPointerESt8equal_toIS3_EE8containsERKS3_.exit ], [ 5, %.noexc ]
...
bb.ai:                                            ; preds = %bb.i, %bb.v
  %.pn43.pn = phi { ptr, i32 } [ %i.ce, %bb.v ], [ %i.ah, %bb.i ] ; 2 uses
  %.not.i.i62 = icmp eq ptr %.sroa.090.0186, null
  br i1 %.not.i.i62, label %_ZN4Luau12DenseHashSetIPKNS_4TypeENS_16DenseHashPointerESt8equal_toIS3_EED2Ev.exit63, label %bb.aj

bb.aj:                                            ; preds = %bb.ai
  call void @_ZdlPv(ptr noundef nonnull %.sroa.090.0186) #26
  br label %_ZN4Luau12DenseHashSetIPKNS_4TypeENS_16DenseHashPointerESt8equal_toIS3_EED2Ev.exit63

_ZN4Luau12DenseHashSetIPKNS_4TypeENS_16DenseHashPointerESt8equal_toIS3_EED2Ev.exit63: ; preds = %bb.aj, %bb.ai, %.thread146
  %.pn43.pn.pn = phi { ptr, i32 } [ %.pn43.pn, %bb.aj ], [ %i.ag, %.thread146 ], [ %.pn43.pn, %bb.ai ]
