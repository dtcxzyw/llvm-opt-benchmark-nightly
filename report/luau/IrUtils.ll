...
begin_hunk_0_@_ZN4Luau7CodeGen29propagateTagsFromPredecessorsERKNS0_10IrFunctionERKNS0_7IrBlockESt8functionIFhmEES7_IFvmhEE:bb.a
  ...
  %i.i = sub i64 %i.g, %i.h
  %i.j = sdiv exact i64 %i.i, 36                  ; 2 uses
  ...
  %i.o = load ptr, ptr %i.l, align 8, !tbaa !54
  %i.p = ptrtoint ptr %i.n to i64
  %i.q = ptrtoint ptr %i.o to i64
  %i.r = sub i64 %i.p, %i.q
  %i.s = ashr exact i64 %i.r, 2
  %.not = icmp ugt i64 %i.s, %i.k
  br i1 %.not, label %bb.b, label %.loopexit80

bb.b:                                             ; preds = %bb.a
  %i.t = trunc i64 %i.j to i32
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 536
  %i.v = tail call { ptr, ptr } @_ZN4Luau7CodeGen12predecessorsERKNS0_7CfgInfoEj(ptr noundef nonnull align 8 dereferenceable(344) %i.u, i32 noundef %i.t) ; 2 uses
  %i.w = extractvalue { ptr, ptr } %i.v, 0        ; 4 uses
  %i.x = extractvalue { ptr, ptr } %i.v, 1        ; 4 uses
  %i.y = icmp eq ptr %i.w, %i.x
  br i1 %i.y, label %.loopexit80, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.z = getelementptr inbounds nuw i8, ptr %0, i64 904 ; 2 uses
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 912
  %i.ab = load ptr, ptr %i.aa, align 8, !tbaa !92
  %i.ac = load ptr, ptr %i.z, align 8, !tbaa !93  ; 3 uses
  %i.ad = ptrtoint ptr %i.ab to i64
  %i.ae = ptrtoint ptr %i.ac to i64
  %i.af = sub i64 %i.ad, %i.ae
  %i.ag = sdiv exact i64 %i.af, 24                ; 2 uses
  %i.ah = load i8, ptr @_ZN5FFlag34LuauCodegenSkipDeadPredecessorTagsE, align 8, !tbaa !62, !range !94, !noundef !95
  %i.ai = trunc nuw i8 %i.ah to i1
  br i1 %i.ai, label %.split.us, label %.split

.split.us:                                        ; preds = %bb.c
  %i.aj = load ptr, ptr %0, align 8, !tbaa !28
  br label %bb.d

bb.d:                                             ; preds = %bb.g, %.split.us
  %.05188.us = phi ptr [ %i.w, %.split.us ], [ %i.aw, %bb.g ] ; 2 uses
  %.07487.us = phi i64 [ -1, %.split.us ], [ %.175.ph.us, %bb.g ] ; 2 uses
  %i.ak = load i32, ptr %.05188.us, align 4, !tbaa !56
  %i.al = zext i32 %i.ak to i64                   ; 3 uses
  %i.am = getelementptr inbounds nuw [36 x i8], ptr %i.aj, i64 %i.al
  %i.an = load i8, ptr %i.am, align 4, !tbaa !33
  %i.ao = icmp eq i8 %i.an, 5
  br i1 %i.ao, label %bb.g, label %bb.e

bb.e:                                             ; preds = %bb.d
  %.not58.us = icmp ugt i64 %i.ag, %i.al
  br i1 %.not58.us, label %bb.f, label %.loopexit80

bb.f:                                             ; preds = %bb.e
  %i.ap = getelementptr inbounds nuw [24 x i8], ptr %i.ac, i64 %i.al ; 2 uses
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 8
  %i.ar = load ptr, ptr %i.aq, align 8, !tbaa !97
  %i.as = load ptr, ptr %i.ap, align 8, !tbaa !98
  %i.at = ptrtoint ptr %i.ar to i64
  %i.au = ptrtoint ptr %i.as to i64
  %i.av = sub i64 %i.at, %i.au
  %.sroa.speculated.us = tail call i64 @llvm.umin.i64(i64 %i.av, i64 %.07487.us)
  br label %bb.g

bb.g:                                             ; preds = %bb.f, %bb.d
  %.175.ph.us = phi i64 [ %.sroa.speculated.us, %bb.f ], [ %.07487.us, %bb.d ] ; 2 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %.05188.us, i64 4 ; 2 uses
  %.not57.us = icmp eq ptr %i.aw, %i.x
  br i1 %.not57.us, label %.lr.ph100, label %bb.d

.split:                                           ; preds = %bb.c, %bb.h
  %.05188 = phi ptr [ %i.bg, %bb.h ], [ %i.w, %bb.c ] ; 2 uses
  %.07487 = phi i64 [ %.sroa.speculated, %bb.h ], [ -1, %bb.c ]
  %i.ax = load i32, ptr %.05188, align 4, !tbaa !56
  %i.ay = zext i32 %i.ax to i64                   ; 2 uses
  %.not58 = icmp ugt i64 %i.ag, %i.ay
  br i1 %.not58, label %bb.h, label %.loopexit80

bb.h:                                             ; preds = %.split
  %i.az = getelementptr inbounds nuw [24 x i8], ptr %i.ac, i64 %i.ay ; 2 uses
  %i.ba = getelementptr inbounds nuw i8, ptr %i.az, i64 8
  %i.bb = load ptr, ptr %i.ba, align 8, !tbaa !97
  %i.bc = load ptr, ptr %i.az, align 8, !tbaa !98
...
.lr.ph100:                                        ; preds = %bb.h, %bb.g
  ...
  %i.bi = load ptr, ptr %i.bh, align 8, !tbaa !101
...
_ZNKSt6bitsetILm256EE4testEm.exit.us102:          ; preds = %.lr.ph.split.us108
  ...
  %i.cc = load i64, ptr %i.cb, align 8, !tbaa !103
...
bb.j:                                             ; preds = %_ZNKSt6bitsetILm256EE4testEm.exit.us102
  %i.cg = load i8, ptr %i.bk, align 8, !tbaa !107, !range !94, !noundef !95
  %i.ch = trunc nuw i8 %i.cg to i1
  br i1 %i.ch, label %bb.k, label %bb.o

bb.k:                                             ; preds = %bb.j
  %i.ci = load i8, ptr %i.bl, align 1, !tbaa !108
...
bb.l:                                             ; preds = %bb.k, %_ZNKSt6bitsetILm256EE4testEm.exit.us102
  ...
  store i64 %.089.us101, ptr %i.e, align 8, !tbaa !103
  %i.ck = load ptr, ptr %i.bm, align 8, !tbaa !110
...
_ZNKSt8functionIFhmEEclEm.exit.us106:             ; preds = %bb.l
  %i.cl = load ptr, ptr %i.bn, align 8, !tbaa !112
  %i.cm = call noundef zeroext i8 %i.cl(ptr noundef nonnull align 8 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(8) %i.e), !inline_history !87 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e)
  %.not61.us = icmp eq i8 %i.cm, -1
  br i1 %.not61.us, label %bb.o, label %bb.m

bb.m:                                             ; preds = %_ZNKSt8functionIFhmEEclEm.exit.us106
  %i.cn = load ptr, ptr %i.bz, align 8, !tbaa !98
...
bb.n:                                             ; preds = %bb.m
  ...
  store i64 %.089.us101, ptr %i.a, align 8, !tbaa !103
  store i8 -1, ptr %i.b, align 1, !tbaa !40
  %i.cq = load ptr, ptr %i.bo, align 8, !tbaa !110
...
_ZNKSt8functionIFvmhEEclEmh.exit65.us:            ; preds = %bb.n
  %i.cr = load ptr, ptr %i.bp, align 8, !tbaa !114
  call void %i.cr(ptr noundef nonnull align 8 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(8) %i.a, ptr noundef nonnull align 1 dereferenceable(1) %i.b), !inline_history !88
...
_ZNKSt6bitsetILm256EE4testEm.exit.us.us:          ; preds = %.lr.ph.split.us.us
  %i.ct = lshr i64 %.089.us.us, 6
  %i.cu = getelementptr inbounds nuw [8 x i8], ptr %i.bj, i64 %i.ct
  %i.cv = load i64, ptr %i.cu, align 8, !tbaa !103
  %i.cw = and i64 %.089.us.us, 63
  %i.cx = shl nuw i64 1, %i.cw
  %i.cy = and i64 %i.cv, %i.cx
  %.not79.us.us = icmp eq i64 %i.cy, 0
  br i1 %.not79.us.us, label %bb.p, label %bb.r

bb.p:                                             ; preds = %_ZNKSt6bitsetILm256EE4testEm.exit.us.us
  %i.cz = load i8, ptr %i.bk, align 8, !tbaa !107, !range !94, !noundef !95
  %i.da = trunc nuw i8 %i.cz to i1
  br i1 %i.da, label %bb.q, label %bb.s

bb.q:                                             ; preds = %bb.p
  %i.db = load i8, ptr %i.bl, align 1, !tbaa !108
  %i.dc = zext i8 %i.db to i64
  %.not60.us.us = icmp samesign ult i64 %.089.us.us, %i.dc
  br i1 %.not60.us.us, label %bb.s, label %bb.r

bb.r:                                             ; preds = %bb.q, %_ZNKSt6bitsetILm256EE4testEm.exit.us.us
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e)
  store i64 %.089.us.us, ptr %i.e, align 8, !tbaa !103
  %i.dd = load ptr, ptr %i.bm, align 8, !tbaa !110
  %.not.i.i.us.us = icmp eq ptr %i.dd, null
...
_ZNKSt8functionIFhmEEclEm.exit.us.us:             ; preds = %bb.r
  %i.de = load ptr, ptr %i.bn, align 8, !tbaa !112
  %i.df = call noundef zeroext i8 %i.de(ptr noundef nonnull align 8 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(8) %i.e), !inline_history !87 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e)
  %i.dg = load ptr, ptr %i.bz, align 8, !tbaa !98
  %i.dh = getelementptr inbounds nuw i8, ptr %i.dg, i64 %.089.us.us
  %i.di = load i8, ptr %i.dh, align 1, !tbaa !40
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d)
  store i64 %.089.us.us, ptr %i.c, align 8, !tbaa !103
  store i8 %i.di, ptr %i.d, align 1, !tbaa !40
  %i.dj = load ptr, ptr %i.bo, align 8, !tbaa !110
  %.not.i.i63.us.us = icmp eq ptr %i.dj, null
...
_ZNKSt8functionIFvmhEEclEmh.exit.us.us:           ; preds = %_ZNKSt8functionIFhmEEclEm.exit.us.us
  %i.dk = load ptr, ptr %i.bp, align 8, !tbaa !114
  call void %i.dk(ptr noundef nonnull align 8 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(8) %i.c, ptr noundef nonnull align 1 dereferenceable(1) %i.d), !inline_history !88
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = select i1 %or.cond, i16 265, i16 9
  br label %bb.c

switch.lookup:                                    ; preds = %bb.a
  %i.e = zext nneg i8 %spec.select to i64
  %switch.gep = getelementptr inbounds nuw [2 x i8], ptr @switch.table._ZN4Luau7CodeGen22tryGetLuauTagForBcTypeEhb, i64 %i.e
  %switch.load = load i16, ptr %switch.gep, align 2
  br label %bb.c

bb.c:                                             ; preds = %switch.lookup, %bb.b
  %.sroa.13.0 = phi i16 [ %switch.load, %switch.lookup ], [ %i.d, %bb.b ]
  ret i16 %.sroa.13.0
}
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = load ptr, ptr %1, align 8, !tbaa !38     ; 4 uses
...
bb.f:                                             ; preds = %bb.e
  %i.k = load i32, ptr %i.f, align 4, !tbaa !40
  store i32 %i.k, ptr %i.g, align 4, !tbaa !40
  br label %_ZSt4copyIPKN4Luau7CodeGen4IrOpEPS2_ET0_T_S7_S6_.exit

_ZSt4copyIPKN4Luau7CodeGen4IrOpEPS2_ET0_T_S7_S6_.exit: ; preds = %bb.d, %bb.e, %bb.f
  %i.l = load i32, ptr %i.d, align 8, !tbaa !39   ; 2 uses
  %i.m = load i32, ptr %i.b, align 8, !tbaa !39
...
.lr.ph:                                           ; preds = %_ZSt4copyIPKN4Luau7CodeGen4IrOpEPS2_ET0_T_S7_S6_.exit, %.lr.ph
  ...
  store i32 %i.p, ptr %i.d, align 8, !tbaa !39
  %i.q = load i32, ptr %i.b, align 8, !tbaa !39
  %i.r = icmp ugt i32 %i.p, %i.q
  br i1 %i.r, label %.lr.ph, label %.loopexit, !llvm.loop !115

bb.g:                                             ; preds = %bb.b
  %i.s = icmp ugt i32 %i.e, 1
  br i1 %i.s, label %bb.h, label %bb.i, !prof !46
...
bb.j:                                             ; preds = %bb.i
  %i.v = load i32, ptr %i.f, align 4, !tbaa !40
  store i32 %i.v, ptr %i.g, align 4, !tbaa !40
  br label %_ZSt4copyIPKN4Luau7CodeGen4IrOpEPS2_ET0_T_S7_S6_.exit15

_ZSt4copyIPKN4Luau7CodeGen4IrOpEPS2_ET0_T_S7_S6_.exit15: ; preds = %bb.h, %bb.i, %bb.j
  %i.w = load i32, ptr %i.b, align 8, !tbaa !39   ; 4 uses
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 12 ; 2 uses
  %i.y = load i32, ptr %i.x, align 4, !tbaa !42   ; 3 uses
...
_ZSt4copyIPKN4Luau7CodeGen4IrOpEPS2_ET0_T_S7_S6_.exit15._ZN4Luau11SmallVectorINS_7CodeGen4IrOpELj6EE7reserveEj.exit_crit_edge: ; preds = %_ZSt4copyIPKN4Luau7CodeGen4IrOpEPS2_ET0_T_S7_S6_.exit15
  %.pre17 = load ptr, ptr %0, align 8, !tbaa !38
...
bb.k:                                             ; preds = %_ZSt4copyIPKN4Luau7CodeGen4IrOpEPS2_ET0_T_S7_S6_.exit15
  ...
  %i.ah = load ptr, ptr %0, align 8, !tbaa !38    ; 7 uses
  %i.ai = load i32, ptr %i.d, align 8, !tbaa !39  ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %next.gep27, align 4, !tbaa !40
  %wide.load28 = load <4 x i32>, ptr %i.av, align 4, !tbaa !40
  %i.aw = getelementptr i8, ptr %next.gep, i64 16
  store <4 x i32> %wide.load, ptr %next.gep, align 4, !tbaa !40
  store <4 x i32> %wide.load28, ptr %i.aw, align 4, !tbaa !40
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %.lr.ph.i.i.i.i.i.i.preheader49, %.lr.ph.i.i.i.i.i.i
  ...
  %i.ay = load i32, ptr %.sroa.08.012.i.i.i.i.i.i, align 4, !tbaa !40
  store i32 %i.ay, ptr %.013.i.i.i.i.i.i, align 4, !tbaa !40
