...
._crit_edge:                                      ; preds = %.lr.ph, %bb.a
  %.sroa.10.0.lcssa.a = phi float [ %i.e, %bb.a ], [ %.sroa.10.1, %.lr.ph ]
  %1 = phi <2 x float> [ %i.c, %bb.a ], [ %i.j, %.lr.ph ] ; 2 uses
  %2 = extractelement <2 x float> %1, i64 0
  %3 = extractelement <2 x float> %1, i64 1
  tail call void @_Z14lua_pushvectorP9lua_Statefff(ptr noundef %0, float noundef %2, float noundef %3, float noundef %.sroa.10.0.lcssa.a)
  ret i32 1
