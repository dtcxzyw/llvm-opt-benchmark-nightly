Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/luau/original/lveclib?download=true
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %bb.a
  %.sroa.10.0.lcssa.a = phi float [ %2, %bb.a ], [ %3, %._crit_edge.loopexit ]
  %.sroa.0.0.lcssa = phi float [ %1, %bb.a ], [ %4, %._crit_edge.loopexit ]
  %.sroa.10.0.lcssa = phi float [ %i.e, %bb.a ], [ %.sroa.10.1, %._crit_edge.loopexit ]
  tail call void @_Z14lua_pushvectorP9lua_Statefff(ptr noundef %0, float noundef %.sroa.0.0.lcssa, float noundef %.sroa.10.0.lcssa.a, float noundef %.sroa.10.0.lcssa)
  ret i32 1
