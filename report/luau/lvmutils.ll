...
begin_hunk_0_@_Z11luaV_concatP9lua_Stateii:bb.a
  ...
  %i.al = load ptr, ptr %i.k, align 8, !tbaa !52
  %i.am = load ptr, ptr %i.j, align 8, !tbaa !51  ; 2 uses
...
bb.e:                                             ; preds = %.thread.i
  ...
  %.pre.i.i = load ptr, ptr %i.j, align 8, !tbaa !51
...
bb.g:                                             ; preds = %bb.c, %_Z13luaV_tostringP9lua_StateP10lua_TValue.exit
  ...
  %i.bc = load i32, ptr %i.bb, align 4, !tbaa !54 ; 2 uses
  %i.bd = icmp eq i32 %i.bc, 0
  br i1 %i.bd, label %bb.h, label %bb.j

bb.h:                                             ; preds = %bb.g
  %i.be = load i32, ptr %i.q, align 4, !tbaa !10
...
bb.i:                                             ; preds = %bb.h
  ...
  store i32 6, ptr %i.q, align 4, !tbaa !10
...
_Z13luaV_tostringP9lua_StateP10lua_TValue.exit86: ; preds = %.lr.ph
  ...
  store i32 6, ptr %i.bq, align 4, !tbaa !10
...
.critedge2:                                       ; preds = %.lr.ph, %_Z13luaV_tostringP9lua_StateP10lua_TValue.exit86
  ...
  %i.bz = load i32, ptr %i.by, align 4, !tbaa !54
...
bb.s:                                             ; preds = %bb.r, %bb.q
  ...
  store i32 6, ptr %i.cx, align 4, !tbaa !10
...
bb.b:                                             ; preds = %bb.a
  %i.o = load float, ptr %2, align 4, !tbaa !56
  %i.p = load float, ptr %3, align 4, !tbaa !56
  %i.q = fadd float %i.o, %i.p
  store float %i.q, ptr %1, align 4, !tbaa !56
  %i.r = getelementptr inbounds nuw i8, ptr %2, i64 4
  %i.s = load float, ptr %i.r, align 4, !tbaa !56
  ...
  store float %i.v, ptr %i.w, align 4, !tbaa !56
  ...
  store float %i.ab, ptr %i.ac, align 4, !tbaa !56
  %i.ad = getelementptr inbounds nuw i8, ptr %1, i64 12
  store i32 5, ptr %i.ad, align 4, !tbaa !10
  br label %bb.t
...
bb.j:                                             ; preds = %bb.i
  %i.am = load double, ptr %i.c, align 8, !tbaa !13
...
bb.k:                                             ; preds = %_Z13luaV_tonumberPK10lua_TValuePS_.exit59, %_Z13luaV_tonumberPK10lua_TValuePS_.exit, %bb.d, %bb.g
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #8
  %i.an = load i32, ptr %i.e, align 4, !tbaa !10
...
bb.m:                                             ; preds = %bb.l
  %i.ar = load double, ptr %i.b, align 8, !tbaa !13
...
bb.n:                                             ; preds = %bb.m, %bb.k
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #8
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #8
  %i.as = load i32, ptr %i.h, align 4, !tbaa !10
...
._crit_edge:                                      ; preds = %bb.o, %bb.n
  ...
  store i32 3, ptr %i.az, align 4, !tbaa !10
  br label %bb.t
...
.thread.i:                                        ; preds = %bb.q, %bb.p
  ...
  %i.bk = load ptr, ptr %i.bi, align 8, !tbaa !51
  ...
  %i.bm = load ptr, ptr %i.bi, align 8, !tbaa !51
  ...
  %i.bq = load ptr, ptr %i.bi, align 8, !tbaa !51 ; 2 uses
...
bb.r:                                             ; preds = %.thread.i
  call void @_Z14luaD_growstackP9lua_Statei(ptr noundef nonnull %0, i32 noundef 3)
  %.pre.i.i = load ptr, ptr %i.bi, align 8, !tbaa !51
  br label %_ZL10call_binTMP9lua_StatePK10lua_TValueS3_PS1_3TMS.exit
...
.thread91:                                        ; preds = %bb.f
  %i.ai = load double, ptr %i.d, align 8, !tbaa !13
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #8
  br label %.thread
...
.thread:                                          ; preds = %..thread_crit_edge, %.thread91
  ...
  %i.al = load float, ptr %2, align 4, !tbaa !56
  %i.am = fmul float %i.al, %i.ak
  store float %i.am, ptr %1, align 4, !tbaa !56
  ...
  store i32 5, ptr %i.av, align 4, !tbaa !10
  br label %bb.v
...
.thread97:                                        ; preds = %bb.k
  %i.ba = load double, ptr %i.c, align 8, !tbaa !13
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #8
  br label %.thread94
...
.thread94:                                        ; preds = %..thread94_crit_edge, %.thread97
  ...
  %i.bd = load float, ptr %3, align 4, !tbaa !56
  %i.be = fmul float %i.bd, %i.bc
  store float %i.be, ptr %1, align 4, !tbaa !56
  ...
  store float %i.bh, ptr %i.bi, align 4, !tbaa !56
  ...
  store float %i.bl, ptr %i.bm, align 4, !tbaa !56
  %i.bn = getelementptr inbounds nuw i8, ptr %1, i64 12
  store i32 5, ptr %i.bn, align 4, !tbaa !10
  br label %bb.v

bb.m:                                             ; preds = %bb.l, %bb.g, %bb.h
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #8
  %i.bo = load i32, ptr %i.e, align 4, !tbaa !10
...
bb.o:                                             ; preds = %bb.n
  %i.bs = load double, ptr %i.b, align 8, !tbaa !13
...
bb.p:                                             ; preds = %bb.o, %bb.m
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #8
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #8
  %i.bt = load i32, ptr %i.h, align 4, !tbaa !10
...
._crit_edge:                                      ; preds = %bb.q, %bb.p
  ...
  store i32 3, ptr %i.ca, align 4, !tbaa !10
  br label %bb.v
...
.thread.i:                                        ; preds = %bb.s, %bb.r
  ...
  %i.cl = load ptr, ptr %i.cj, align 8, !tbaa !51
  ...
  %i.cn = load ptr, ptr %i.cj, align 8, !tbaa !51
  ...
  %i.cr = load ptr, ptr %i.cj, align 8, !tbaa !51 ; 2 uses
...
bb.t:                                             ; preds = %.thread.i
  call void @_Z14luaD_growstackP9lua_Statei(ptr noundef nonnull %0, i32 noundef 3)
  %.pre.i.i = load ptr, ptr %i.cj, align 8, !tbaa !51
  br label %_ZL10call_binTMP9lua_StatePK10lua_TValueS3_PS1_3TMS.exit
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.q = load float, ptr %3, align 4, !tbaa !56
  ...
  store float %i.u, ptr %1, align 4, !tbaa !56
  %i.v = getelementptr inbounds nuw i8, ptr %2, i64 4
  %i.w = load float, ptr %i.v, align 4, !tbaa !56
  ...
  store float %i.an, ptr %i.ao, align 4, !tbaa !56
  %i.ap = getelementptr inbounds nuw i8, ptr %1, i64 12
  store i32 5, ptr %i.ap, align 4, !tbaa !10
  br label %bb.v
...
.thread97:                                        ; preds = %bb.f
  %i.au = load double, ptr %i.d, align 8, !tbaa !13
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #8
  br label %.thread
...
.thread:                                          ; preds = %..thread_crit_edge, %.thread97
  ...
  %i.ax = load float, ptr %2, align 4, !tbaa !56
  ...
  store float %i.bc, ptr %1, align 4, !tbaa !56
  %i.bd = getelementptr inbounds nuw i8, ptr %2, i64 4
  %i.be = load float, ptr %i.bd, align 4, !tbaa !56
  ...
  store float %i.bi, ptr %i.bj, align 4, !tbaa !56
  ...
  store i32 5, ptr %i.br, align 4, !tbaa !10
  br label %bb.v
...
.thread103:                                       ; preds = %bb.k
  %i.bw = load double, ptr %i.c, align 8, !tbaa !13
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #8
  br label %.thread100
...
.thread100:                                       ; preds = %..thread100_crit_edge, %.thread103
  ...
  %i.ca = load float, ptr %3, align 4, !tbaa !56
  ...
  store float %i.ce, ptr %1, align 4, !tbaa !56
  %i.cf = getelementptr inbounds nuw i8, ptr %3, i64 4
  %i.cg = load float, ptr %i.cf, align 4, !tbaa !56
  ...
  store float %i.ck, ptr %i.cl, align 4, !tbaa !56
  ...
  store float %i.cr, ptr %i.cs, align 4, !tbaa !56
  %i.ct = getelementptr inbounds nuw i8, ptr %1, i64 12
  store i32 5, ptr %i.ct, align 4, !tbaa !10
  br label %bb.v

bb.m:                                             ; preds = %bb.l, %bb.g, %bb.h
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #8
  %i.cu = load i32, ptr %i.e, align 4, !tbaa !10
...
bb.o:                                             ; preds = %bb.n
  %i.cy = load double, ptr %i.b, align 8, !tbaa !13
...
bb.p:                                             ; preds = %bb.o, %bb.m
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #8
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #8
  %i.cz = load i32, ptr %i.h, align 4, !tbaa !10
...
._crit_edge:                                      ; preds = %bb.q, %bb.p
  ...
  store i32 3, ptr %i.dh, align 4, !tbaa !10
  br label %bb.v
...
.thread.i:                                        ; preds = %bb.s, %bb.r
  ...
  %i.dp = load ptr, ptr %i.do, align 8, !tbaa !50
  ...
  %i.ds = load ptr, ptr %i.dq, align 8, !tbaa !51
  ...
  %i.du = load ptr, ptr %i.dq, align 8, !tbaa !51
  ...
  %i.dy = load ptr, ptr %i.dq, align 8, !tbaa !51 ; 2 uses
...
bb.t:                                             ; preds = %.thread.i
  call void @_Z14luaD_growstackP9lua_Statei(ptr noundef nonnull %0, i32 noundef 3)
  %.pre.i.i = load ptr, ptr %i.dq, align 8, !tbaa !51
  br label %_ZL10call_binTMP9lua_StatePK10lua_TValueS3_PS1_3TMS.exit
...
bb.i:                                             ; preds = %bb.h
  %i.w = load double, ptr %i.c, align 8, !tbaa !13
...
bb.j:                                             ; preds = %_Z13luaV_tonumberPK10lua_TValuePS_.exit45, %_Z13luaV_tonumberPK10lua_TValuePS_.exit, %bb.c, %bb.f, %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #8
  %i.x = load i32, ptr %i.e, align 4, !tbaa !10
...
bb.l:                                             ; preds = %bb.k
  %i.ab = load double, ptr %i.b, align 8, !tbaa !13
...
bb.m:                                             ; preds = %bb.l, %bb.j
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #8
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #8
  %i.ac = load i32, ptr %i.h, align 4, !tbaa !10
...
._crit_edge:                                      ; preds = %bb.n, %bb.m
  ...
  store i32 3, ptr %i.am, align 4, !tbaa !10
  br label %bb.s
...
.thread.i:                                        ; preds = %bb.p, %bb.o
  ...
  %i.ax = load ptr, ptr %i.av, align 8, !tbaa !51
  ...
  %i.az = load ptr, ptr %i.av, align 8, !tbaa !51
  ...
  %i.bd = load ptr, ptr %i.av, align 8, !tbaa !51 ; 2 uses
...
bb.q:                                             ; preds = %.thread.i
  call void @_Z14luaD_growstackP9lua_Statei(ptr noundef nonnull %0, i32 noundef 3)
  %.pre.i.i = load ptr, ptr %i.av, align 8, !tbaa !51
  br label %_ZL10call_binTMP9lua_StatePK10lua_TValueS3_PS1_3TMS.exit
...
._crit_edge:                                      ; preds = %bb.n, %bb.m
  ...
  store i32 3, ptr %i.aj, align 4, !tbaa !10
  br label %bb.s
...
.thread.i:                                        ; preds = %bb.p, %bb.o
  ...
  %i.au = load ptr, ptr %i.as, align 8, !tbaa !51
  ...
  %i.aw = load ptr, ptr %i.as, align 8, !tbaa !51
  ...
  %i.ba = load ptr, ptr %i.as, align 8, !tbaa !51 ; 2 uses
...
bb.q:                                             ; preds = %.thread.i
  call void @_Z14luaD_growstackP9lua_Statei(ptr noundef nonnull %0, i32 noundef 3)
  %.pre.i.i = load ptr, ptr %i.as, align 8, !tbaa !51
  br label %_ZL10call_binTMP9lua_StatePK10lua_TValueS3_PS1_3TMS.exit
...
bb.b:                                             ; preds = %bb.a
  %i.o = load float, ptr %2, align 4, !tbaa !56
  %i.p = fneg float %i.o
  store float %i.p, ptr %1, align 4, !tbaa !56
  ...
  store float %i.s, ptr %i.t, align 4, !tbaa !56
  %i.u = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.v = load float, ptr %i.u, align 4, !tbaa !56
  %i.w = fneg float %i.v
  %i.x = getelementptr inbounds nuw i8, ptr %1, i64 8
  store float %i.w, ptr %i.x, align 4, !tbaa !56
  %i.y = getelementptr inbounds nuw i8, ptr %1, i64 12
  store i32 5, ptr %i.y, align 4, !tbaa !10
  br label %bb.u
...
bb.j:                                             ; preds = %bb.i
  %i.ah = load double, ptr %i.c, align 8, !tbaa !13
...
bb.m:                                             ; preds = %bb.l
  %i.am = load double, ptr %i.b, align 8, !tbaa !13
...
bb.n:                                             ; preds = %bb.m, %bb.k
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #8
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #8
  %i.an = load i32, ptr %i.h, align 4, !tbaa !10
...
bb.p:                                             ; preds = %bb.o, %bb.n
  ...
  store i32 3, ptr %i.at, align 4, !tbaa !10
  br label %bb.u
...
.thread.i:                                        ; preds = %bb.r, %bb.q
  ...
  %i.be = load ptr, ptr %i.bc, align 8, !tbaa !51
  ...
  %i.bg = load ptr, ptr %i.bc, align 8, !tbaa !51
  ...
  %i.bk = load ptr, ptr %i.bc, align 8, !tbaa !51 ; 2 uses
...
bb.s:                                             ; preds = %.thread.i
  call void @_Z14luaD_growstackP9lua_Statei(ptr noundef nonnull %0, i32 noundef 3)
  %.pre.i.i = load ptr, ptr %i.bc, align 8, !tbaa !51
  br label %_ZL10call_binTMP9lua_StatePK10lua_TValueS3_PS1_3TMS.exit
