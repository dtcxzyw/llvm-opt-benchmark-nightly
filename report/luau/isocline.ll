...
bb.cj:                                            ; preds = %bb.cj, %.lr.ph.i.i.i.i.i
  ...
  %i.pk = load ptr, ptr %i.pi, align 8, !tbaa !167
  %i.pl = load ptr, ptr %i.pj, align 8, !tbaa !168
  ...
  %.val.i.i.i.i.i = load ptr, ptr %i.po, align 8, !tbaa !82
  call void %.val.i.i.i.i.i(ptr noundef %i.pn) #28, !inline_history !380
  %i.pp = add nuw nsw i64 %.017.i.i.i.i.i, 1      ; 2 uses
  %i.pq = load i64, ptr %i.os, align 8, !tbaa !166 ; 2 uses
  %i.pr = icmp slt i64 %i.pp, %i.pq
  br i1 %i.pr, label %bb.cj, label %history_remove_last.exit.i.i.i, !llvm.loop !19
...
history_remove_last.exit.i.i.i:                   ; preds = %bb.cj
  ...
  store i64 %i.pt, ptr %i.os, align 8, !tbaa !166
...
sbuf_string.exit.i.i.i.i:                         ; preds = %bb.cm, %bb.cl
  ...
  %i.qe = load i64, ptr %i.ae, align 8, !tbaa !222 ; 2 uses
  %.val.i.i.i163.i.i = load ptr, ptr %i.px, align 8, !tbaa !70
  %i.qf = call ptr %.val.i.i.i163.i.i(i64 noundef 24) #28, !inline_history !381 ; 9 uses
...
bb.cn:                                            ; preds = %sbuf_string.exit.i.i.i.i
  ...
  %.val.i.i.i.i.i.i = load ptr, ptr %i.px, align 8, !tbaa !70
  %i.qk = call ptr %.val.i.i.i.i.i.i(i64 noundef %i.qj) #28, !inline_history !382 ; 3 uses
  %i.ql = icmp eq ptr %i.qk, null
  br i1 %i.ql, label %bb.co, label %bb.cp

bb.co:                                            ; preds = %bb.cn
  %i.qm = getelementptr inbounds nuw i8, ptr %i.qf, i64 8
  store ptr null, ptr %i.qm, align 8, !tbaa !234
  %i.qn = getelementptr inbounds nuw i8, ptr %i.qf, i64 16
  store i64 %i.qe, ptr %i.qn, align 8, !tbaa !235
  %i.qo = getelementptr i8, ptr %i.px, i64 16
  %.val14.i.i.i.i.i = load ptr, ptr %i.qo, align 8, !tbaa !82
  call void %.val14.i.i.i.i.i(ptr noundef nonnull %i.qf) #28, !inline_history !383
...
bb.cp:                                            ; preds = %bb.cn
  ...
  store ptr %i.qk, ptr %i.qp, align 8, !tbaa !234
  %i.qq = getelementptr inbounds nuw i8, ptr %i.qf, i64 16
  store i64 %i.qe, ptr %i.qq, align 8, !tbaa !235
  %i.qr = load ptr, ptr %i.al, align 8, !tbaa !236
  store ptr %i.qr, ptr %i.qf, align 8, !tbaa !237
  store ptr %i.qf, ptr %i.al, align 8, !tbaa !236
  br label %editor_undo_capture.exit.i.i

editor_undo_capture.exit.i.i:                     ; preds = %bb.cp, %bb.co, %sbuf_string.exit.i.i.i.i, %bb.ck
  store i8 1, ptr %i.ca, align 1, !tbaa !232
  %i.qs = load ptr, ptr @rpenv, align 8, !tbaa !129 ; 2 uses
...
bb.cq:                                            ; preds = %editor_undo_capture.exit.i.i
  ...
  store ptr %i.qu, ptr @rpenv, align 8, !tbaa !129
...
ic_get_env.exit.i.i.i:                            ; preds = %bb.cq
  ...
  %.pre.i.i.i.i = load ptr, ptr @rpenv, align 8, !tbaa !129 ; 2 uses
...
ic_get_env.exit.thread6.i.i.i:                    ; preds = %ic_get_env.exit.i.i.i, %editor_undo_capture.exit.i.i
  ...
  %i.qz = load i8, ptr %i.qy, align 8, !tbaa !174, !range !136, !noundef !137
  store i8 1, ptr %i.qy, align 8, !tbaa !174
...
ic_enable_hint.exit.i.i:                          ; preds = %ic_get_env.exit.thread6.i.i.i, %ic_get_env.exit.i.i.i, %bb.cq
  ...
  %i.rb = load ptr, ptr %i.aj, align 8, !tbaa !226
  store ptr @.str.312, ptr %i.aj, align 8, !tbaa !226
...
bb.cr:                                            ; preds = %.lr.ph.i34.i
  %i.rg = load ptr, ptr %i.l, align 8, !tbaa !216
  %.val162.i.i = load ptr, ptr %i.rg, align 8, !tbaa !70
  %i.rh = call ptr %.val162.i.i(i64 noundef 40) #28, !inline_history !384 ; 8 uses
...
bb.cs:                                            ; preds = %bb.cr
  ...
  store i64 %.0351484.i.i, ptr %i.rj, align 8, !tbaa !401
  %i.rk = getelementptr inbounds nuw i8, ptr %i.rh, i64 16
  store i64 %.0343485.i.i, ptr %i.rk, align 8, !tbaa !402
  %i.rl = getelementptr inbounds nuw i8, ptr %i.rh, i64 24
  store i64 %.0340486.i.i, ptr %i.rl, align 8, !tbaa !403
  %i.rm = getelementptr inbounds nuw i8, ptr %i.rh, i64 32
  store i8 1, ptr %i.rm, align 8, !tbaa !404
  store ptr %.0362483.i.i, ptr %i.rh, align 8, !tbaa !405
...
hsearch_push.exit.i.i:                            ; preds = %bb.cs, %bb.cr
  ...
  %i.rp = load i8, ptr %i.ro, align 1, !tbaa !48
  store i8 0, ptr %i.ro, align 1, !tbaa !48
  %i.rq = load ptr, ptr %i.bv, align 8, !tbaa !161 ; 2 uses
  %i.rr = load i64, ptr %i.rq, align 8, !tbaa !166 ; 4 uses
...
history_get.exit.lr.ph.i.i.i:                     ; preds = %hsearch_push.exit.i.i
  ...
  %i.ru = load ptr, ptr %i.rt, align 8, !tbaa !168
...
history_get.exit.i.i.i:                           ; preds = %bb.ct, %history_get.exit.lr.ph.i.i.i
  ...
  %i.rz = load ptr, ptr %i.ry, align 8, !tbaa !87 ; 2 uses
...
bb.ct:                                            ; preds = %history_get.exit.i.i.i
  ...
  br i1 %exitcond.not.i.i.i, label %.loopexit434.i.i, label %history_get.exit.i.i.i, !llvm.loop !385
...
bb.cu:                                            ; preds = %.loopexit434.i.i
  %i.sf = load ptr, ptr %i.aa, align 8, !tbaa !143
  %i.sg = getelementptr i8, ptr %i.sf, i64 33
  %.val155.i.i = load i8, ptr %i.sg, align 1, !tbaa !159, !range !136, !noundef !137
  %i.sh = trunc nuw i8 %.val155.i.i to i1
  br i1 %i.sh, label %bb.cw, label %bb.cv

bb.cv:                                            ; preds = %bb.cu
  %i.si = load ptr, ptr @stderr, align 8, !tbaa !93
  %fputc.i166.i.i = call i32 @fputc(i32 7, ptr %i.si) ; 0 uses
  %i.sj = load ptr, ptr @stderr, align 8, !tbaa !93
...
bb.cw:                                            ; preds = %bb.cv, %bb.cu, %.loopexit434.i.i, %.thread46.i.i.i
  ...
  store i8 %i.rp, ptr %i.ro, align 1, !tbaa !48
...
.thread.i.i:                                      ; preds = %bb.cw, %.lr.ph.i34.i, %ic_strlen.exit.i.i
  ...
  %i.sm = load ptr, ptr %6, align 8, !tbaa !217   ; 5 uses
...
sbuf_len.exit.i.i.i.i:                            ; preds = %.thread.i.i
  %.pre.i.i169.i.i = load i64, ptr inttoptr (i64 16 to ptr), align 16, !tbaa !79 ; 2 uses
...
sbuf_len.exit.i.thread.i.i.i:                     ; preds = %.thread.i.i
  ...
  %i.sp = load i64, ptr %i.so, align 8, !tbaa !79 ; 4 uses
...
bb.cy:                                            ; preds = %bb.cx
  %i.su = load ptr, ptr %i.sm, align 8, !tbaa !81 ; 2 uses
  ...
  %.pre.i.i.i.i.i = load i64, ptr %i.sq, align 8, !tbaa !79
...
sbuf_clear.exit.thread.i.i.i:                     ; preds = %bb.cy, %bb.cx
  ...
  store i64 %.pre-phi.i.i.i.i, ptr %i.sq, align 8, !tbaa !79
  %i.sw = load ptr, ptr %i.sm, align 8, !tbaa !81
  %i.sx = getelementptr inbounds i8, ptr %i.sw, i64 %.pre-phi.i.i.i.i
  store i8 0, ptr %i.sx, align 1, !tbaa !48
  %.pre.i.i.i205 = load i64, ptr %i.sq, align 8, !tbaa !79
...
bb.cz:                                            ; preds = %ic_enable_hint.exit.i.i
  %i.tb = load ptr, ptr %6, align 8, !tbaa !217   ; 5 uses
...
.sbuf_len.exit_crit_edge.i.i.i:                   ; preds = %bb.cz
  %.pre.i173.i.i = load i64, ptr inttoptr (i64 16 to ptr), align 16, !tbaa !79 ; 2 uses
...
bb.da:                                            ; preds = %bb.cz
  ...
  %i.tf = load i64, ptr %i.te, align 8, !tbaa !79 ; 2 uses
  br label %sbuf_len.exit.i.i.i
...
bb.dc:                                            ; preds = %bb.db
  %i.tk = load ptr, ptr %i.tb, align 8, !tbaa !81 ; 2 uses
  ...
  %.pre.i.i172.i.i = load i64, ptr %i.th, align 8, !tbaa !79
...
ic_memmove.exit.i.i.i.i:                          ; preds = %bb.dc, %bb.db
  ...
  store i64 %.pre-phi.i.i.i, ptr %i.th, align 8, !tbaa !79
  %i.tm = load ptr, ptr %i.tb, align 8, !tbaa !81
  %i.tn = getelementptr inbounds i8, ptr %i.tm, i64 %.pre-phi.i.i.i
  store i8 0, ptr %i.tn, align 1, !tbaa !48
  br label %sbuf_clear.exit.i.i
...
sbuf_clear.exit.i.i:                              ; preds = %ic_memmove.exit.i.i.i.i, %sbuf_len.exit.i.i.i, %sbuf_replace.exit.i.i
  ...
  store i64 %.sink.i.i, ptr %i.ae, align 8, !tbaa !222
...
bb.dd:                                            ; preds = %bb.fd, %.outer.i.i
  %i.tt = load ptr, ptr %i.bv, align 8, !tbaa !161 ; 2 uses
  br i1 %i.to, label %.thread391.i.i, label %bb.de

bb.de:                                            ; preds = %bb.dd
  %i.tu = load i64, ptr %i.tt, align 8, !tbaa !166 ; 2 uses
...
bb.dg:                                            ; preds = %bb.df
  ...
  %i.ue = load i64, ptr %i.ud, align 8, !tbaa !79
...
sbuf_append_n.exit.i.i:                           ; preds = %bb.dg, %bb.df
  ...
  %i.ug = load ptr, ptr %i.r, align 8, !tbaa !218 ; 3 uses
...
bb.dh:                                            ; preds = %sbuf_append_n.exit.i.i
  ...
  %i.uj = load i64, ptr %i.ui, align 8, !tbaa !79
...
begin_hunk_1_@edit_line:bb.a
  %.pre.i.i226.i.i = load i64, ptr inttoptr (i64 16 to ptr), align 16, !tbaa !79 ; 2 uses
...
sbuf_len.exit.i.thread.i214.i.i:                  ; preds = %editor_undo_forget.exit.i.i
  ...
  %i.yi = load i64, ptr %i.yh, align 8, !tbaa !79 ; 4 uses
...
bb.ei:                                            ; preds = %bb.eh
  %i.yn = load ptr, ptr %i.yf, align 8, !tbaa !81 ; 2 uses
  ...
  %.pre.i.i.i220.i.i = load i64, ptr %i.yj, align 8, !tbaa !79
...
sbuf_clear.exit.thread.i222.i.i:                  ; preds = %bb.ei, %bb.eh
  ...
  store i64 %.pre-phi.i.i223.i.i, ptr %i.yj, align 8, !tbaa !79
  %i.yp = load ptr, ptr %i.yf, align 8, !tbaa !81
  %i.yq = getelementptr inbounds i8, ptr %i.yp, i64 %.pre-phi.i.i223.i.i
  store i8 0, ptr %i.yq, align 1, !tbaa !48
  %.pre.i224.i.i = load i64, ptr %i.yj, align 8, !tbaa !79
...
sbuf_replace.exit228.i.i:                         ; preds = %bb.ej, %sbuf_len.exit.i3.i216.i.i
  ...
  %i.yu = load ptr, ptr %6, align 8, !tbaa !217   ; 2 uses
...
bb.ek:                                            ; preds = %sbuf_replace.exit228.i.i
  ...
  %i.yx = load i64, ptr %i.yw, align 8, !tbaa !79
...
sbuf_len.exit.i.i203:                             ; preds = %bb.ek, %sbuf_replace.exit228.i.i
  ...
  store i64 %.0.i229.i.i, ptr %i.ae, align 8, !tbaa !222
  store i8 0, ptr %i.ah, align 8, !tbaa !225
  store i64 %.4355.ph.i.i.ph, ptr %i.ak, align 8, !tbaa !238
...
hsearch_pop.exit.i.i:                             ; preds = %bb.el
  %i.yy = load ptr, ptr %0, align 8, !tbaa !108
  %i.yz = load ptr, ptr %.4366.ph.i.i, align 8, !tbaa !405 ; 2 uses
  %i.za = getelementptr inbounds nuw i8, ptr %.4366.ph.i.i, i64 8
  %i.zb = load i64, ptr %i.za, align 8, !tbaa !401 ; 2 uses
  %i.zc = getelementptr inbounds nuw i8, ptr %.4366.ph.i.i, i64 16
  %i.zd = load i64, ptr %i.zc, align 8, !tbaa !402 ; 2 uses
  %i.ze = getelementptr inbounds nuw i8, ptr %.4366.ph.i.i, i64 24
  %i.zf = load i64, ptr %i.ze, align 8, !tbaa !403 ; 2 uses
  %i.zg = getelementptr inbounds nuw i8, ptr %.4366.ph.i.i, i64 32
  %i.zh = load i8, ptr %i.zg, align 8, !tbaa !404, !range !136, !noundef !137
  %i.zi = getelementptr i8, ptr %i.yy, i64 16
  %.val.i231.i.i = load ptr, ptr %i.zi, align 8, !tbaa !82
  call void %.val.i231.i.i(ptr noundef nonnull %.4366.ph.i.i) #28, !inline_history !390
...
bb.em:                                            ; preds = %hsearch_pop.exit.i.i
  ...
  %i.zm = load ptr, ptr %6, align 8, !tbaa !217   ; 3 uses
  %i.zn = load i64, ptr %i.ae, align 8, !tbaa !222 ; 8 uses
  %.val.i.i232.i.i = load ptr, ptr %i.zm, align 8, !tbaa !81 ; 4 uses
...
.lr.ph1132:                                       ; preds = %.preheader.i.i.i.i.i.i.preheader, %.preheader.i.i.i.i.i.i
  ...
  %i.zt = load i8, ptr %i.zs, align 1, !tbaa !48
...
bb.eo:                                            ; preds = %bb.en
  ...
  %i.zy = load i64, ptr %i.zx, align 8, !tbaa !79 ; 5 uses
...
bb.eq:                                            ; preds = %bb.ep
  ...
  %.pre.i.i.i236.i.i = load i64, ptr %i.zx, align 8, !tbaa !79
  %.pre.i.i237.i.i = load ptr, ptr %i.zm, align 8, !tbaa !81
...
ic_memmove.exit.i.i.i.i.i:                        ; preds = %bb.eq, %bb.ep
  ...
  store i64 %i.aai, ptr %i.zx, align 8, !tbaa !79
  %i.aaj = getelementptr inbounds i8, ptr %i.aag, i64 %i.aai
  store i8 0, ptr %i.aaj, align 1, !tbaa !48
...
sbuf_delete_char_before.exit.i.i.i:               ; preds = %ic_memmove.exit.i.i.i.i.i, %bb.eo, %bb.en, %sbuf_prev_ofs.exit.i.i.i.i, %bb.em
  ...
  store i64 %.0.i.i233.i.i, ptr %i.ae, align 8, !tbaa !222
...
bb.er:                                            ; preds = %sbuf_clear.exit211.i.i, %sbuf_clear.exit211.i.i, %sbuf_clear.exit211.i.i
  %i.aak = load ptr, ptr %0, align 8, !tbaa !108
  %.val161.i.i = load ptr, ptr %i.aak, align 8, !tbaa !70
  %i.aal = call ptr %.val161.i.i(i64 noundef 40) #28, !inline_history !384 ; 8 uses
...
bb.es:                                            ; preds = %bb.er
  ...
  store i64 %.4355.ph.i.i.ph, ptr %i.aan, align 8, !tbaa !401
  %i.aao = getelementptr inbounds nuw i8, ptr %i.aal, i64 16
  store i64 %.4347.ph.i.i.ph, ptr %i.aao, align 8, !tbaa !402
  %i.aap = getelementptr inbounds nuw i8, ptr %i.aal, i64 24
  store i64 %.5.ph.ph.i.i, ptr %i.aap, align 8, !tbaa !403
  %i.aaq = getelementptr inbounds nuw i8, ptr %i.aal, i64 32
  store i8 0, ptr %i.aaq, align 8, !tbaa !404
  store ptr %.4366.ph.i.i, ptr %i.aal, align 8, !tbaa !405
...
hsearch_push.exit239.i.i:                         ; preds = %bb.es, %bb.er
  ...
  %i.aar = load ptr, ptr %i.bv, align 8, !tbaa !161 ; 2 uses
  %i.aas = load ptr, ptr %6, align 8, !tbaa !217  ; 2 uses
  %i.aat = getelementptr inbounds nuw i8, ptr %i.aas, i64 16
  %i.aau = load i64, ptr %i.aat, align 8, !tbaa !79
  %i.aav = icmp slt i64 %i.aau, 0
  br i1 %i.aav, label %sbuf_string.exit242.i.i, label %bb.et

bb.et:                                            ; preds = %hsearch_push.exit239.i.i
  %i.aaw = load ptr, ptr %i.aas, align 8, !tbaa !81 ; 2 uses
...
sbuf_string.exit242.i.i:                          ; preds = %bb.et, %hsearch_push.exit239.i.i
  ...
  %i.aay = load i64, ptr %i.aar, align 8, !tbaa !166 ; 4 uses
...
history_get.exit.lr.ph.i243.i.i:                  ; preds = %sbuf_string.exit242.i.i
  ...
  %i.abb = load ptr, ptr %i.aba, align 8, !tbaa !168
...
history_get.exit.i244.i.i:                        ; preds = %bb.eu, %history_get.exit.lr.ph.i243.i.i
  ...
  %i.abf = load ptr, ptr %i.abe, align 8, !tbaa !87 ; 2 uses
...
bb.eu:                                            ; preds = %history_get.exit.i244.i.i
  ...
  br i1 %exitcond.not.i251.i.i, label %.loopexit432.i.i, label %history_get.exit.i244.i.i, !llvm.loop !385
...
bb.ev:                                            ; preds = %.loopexit432.i.i
  %i.abl = load ptr, ptr %0, align 8, !tbaa !108
  %i.abm = load ptr, ptr %.11.i.i, align 8, !tbaa !405
  %i.abn = getelementptr i8, ptr %i.abl, i64 16
  %.val.i253.i.i = load ptr, ptr %i.abn, align 8, !tbaa !82
  call void %.val.i253.i.i(ptr noundef nonnull %.11.i.i) #28, !inline_history !390
...
bb.ex:                                            ; preds = %sbuf_clear.exit211.i.i, %sbuf_clear.exit211.i.i, %sbuf_clear.exit211.i.i
  %i.abu = load ptr, ptr %0, align 8, !tbaa !108
  %.val160.i.i = load ptr, ptr %i.abu, align 8, !tbaa !70
  %i.abv = call ptr %.val160.i.i(i64 noundef 40) #28, !inline_history !384 ; 8 uses
...
bb.ey:                                            ; preds = %bb.ex
  ...
  store i64 %.4355.ph.i.i.ph, ptr %i.abx, align 8, !tbaa !401
  %i.aby = getelementptr inbounds nuw i8, ptr %i.abv, i64 16
  store i64 %.4347.ph.i.i.ph, ptr %i.aby, align 8, !tbaa !402
  %i.abz = getelementptr inbounds nuw i8, ptr %i.abv, i64 24
  store i64 %.5.ph.ph.i.i, ptr %i.abz, align 8, !tbaa !403
  %i.aca = getelementptr inbounds nuw i8, ptr %i.abv, i64 32
  store i8 0, ptr %i.aca, align 8, !tbaa !404
  store ptr %.4366.ph.i.i, ptr %i.abv, align 8, !tbaa !405
...
hsearch_push.exit258.i.i:                         ; preds = %bb.ey, %bb.ex
  ...
  %i.acb = load ptr, ptr %i.bv, align 8, !tbaa !161 ; 2 uses
  %i.acc = load ptr, ptr %6, align 8, !tbaa !217  ; 2 uses
  %i.acd = getelementptr inbounds nuw i8, ptr %i.acc, i64 16
  %i.ace = load i64, ptr %i.acd, align 8, !tbaa !79
  %i.acf = icmp slt i64 %i.ace, 0
  br i1 %i.acf, label %sbuf_string.exit261.i.i, label %bb.ez

bb.ez:                                            ; preds = %hsearch_push.exit258.i.i
  %i.acg = load ptr, ptr %i.acc, align 8, !tbaa !81 ; 2 uses
...
history_get.exit38.lr.ph.i.i.i:                   ; preds = %sbuf_string.exit261.i.i
  %i.aci = load i64, ptr %i.acb, align 8, !tbaa !166 ; 2 uses
  %i.acj = getelementptr inbounds nuw i8, ptr %i.acb, i64 16
  %i.ack = load ptr, ptr %i.acj, align 8, !tbaa !168
...
history_get.exit38.i.i.i:                         ; preds = %bb.fa, %history_get.exit38.lr.ph.i.i.i
  ...
  %i.aco = load ptr, ptr %i.acn, align 8, !tbaa !87 ; 2 uses
...
bb.fa:                                            ; preds = %history_get.exit38.i.i.i
  ...
  br i1 %i.acq, label %history_get.exit38.i.i.i, label %.loopexit433.i.i, !llvm.loop !391
...
bb.fb:                                            ; preds = %.loopexit433.i.i
  %i.acu = load ptr, ptr %0, align 8, !tbaa !108
  %i.acv = load ptr, ptr %.13.i.i, align 8, !tbaa !405
  %i.acw = getelementptr i8, ptr %i.acu, i64 16
  %.val.i268.i.i = load ptr, ptr %i.acw, align 8, !tbaa !82
  call void %.val.i268.i.i(ptr noundef nonnull %.13.i.i) #28, !inline_history !390
...
bb.ff:                                            ; preds = %bb.fe
  %i.adf = load ptr, ptr %0, align 8, !tbaa !108
  %.val159.i.i = load ptr, ptr %i.adf, align 8, !tbaa !70
  %i.adg = call ptr %.val159.i.i(i64 noundef 40) #28, !inline_history !384 ; 8 uses
...
bb.fg:                                            ; preds = %bb.ff
  ...
  store i64 %.4355.ph.i.i.ph, ptr %i.adi, align 8, !tbaa !401
  %i.adj = getelementptr inbounds nuw i8, ptr %i.adg, i64 16
  store i64 %.4347.ph.i.i.ph, ptr %i.adj, align 8, !tbaa !402
  %i.adk = getelementptr inbounds nuw i8, ptr %i.adg, i64 24
  store i64 %.5.ph.ph.i.i, ptr %i.adk, align 8, !tbaa !403
  %i.adl = getelementptr inbounds nuw i8, ptr %i.adg, i64 32
  store i8 1, ptr %i.adl, align 8, !tbaa !404
  store ptr %.4366.ph.i.i, ptr %i.adg, align 8, !tbaa !405
...
bb.fi:                                            ; preds = %bb.fh
  %i.adn = load ptr, ptr %0, align 8, !tbaa !108
  %.val158.i.i = load ptr, ptr %i.adn, align 8, !tbaa !70
  %i.ado = call ptr %.val158.i.i(i64 noundef 40) #28, !inline_history !384 ; 8 uses
...
bb.fj:                                            ; preds = %bb.fi
  ...
  store i64 %.4355.ph.i.i.ph, ptr %i.adq, align 8, !tbaa !401
  %i.adr = getelementptr inbounds nuw i8, ptr %i.ado, i64 16
  store i64 %.4347.ph.i.i.ph, ptr %i.adr, align 8, !tbaa !402
  %i.ads = getelementptr inbounds nuw i8, ptr %i.ado, i64 24
  store i64 %.5.ph.ph.i.i, ptr %i.ads, align 8, !tbaa !403
  %i.adt = getelementptr inbounds nuw i8, ptr %i.ado, i64 32
  store i8 1, ptr %i.adt, align 8, !tbaa !404
  store ptr %.4366.ph.i.i, ptr %i.ado, align 8, !tbaa !405
...
bb.fk:                                            ; preds = %bb.fh
  %i.adu = load ptr, ptr %i.aa, align 8, !tbaa !143
  %i.adv = getelementptr i8, ptr %i.adu, i64 33
  %.val152.i.i = load i8, ptr %i.adv, align 1, !tbaa !159, !range !136, !noundef !137
  %i.adw = trunc nuw i8 %.val152.i.i to i1
  br i1 %i.adw, label %.outer.outer.i.i.backedge, label %bb.fl

bb.fl:                                            ; preds = %bb.fk
  %i.adx = load ptr, ptr @stderr, align 8, !tbaa !93
  %fputc.i276.i.i = call i32 @fputc(i32 7, ptr %i.adx) ; 0 uses
  %i.ady = load ptr, ptr @stderr, align 8, !tbaa !93
...
bb.fm:                                            ; preds = %hsearch_push.exit275.i.i, %hsearch_push.exit273.i.i
  ...
  %i.aea = load ptr, ptr %i.bv, align 8, !tbaa !161 ; 2 uses
  %i.aeb = load ptr, ptr %6, align 8, !tbaa !217  ; 3 uses
  %i.aec = getelementptr inbounds nuw i8, ptr %i.aeb, i64 16
  %i.aed = load i64, ptr %i.aec, align 8, !tbaa !79 ; 2 uses
  %i.aee = icmp slt i64 %i.aed, 0
  br i1 %i.aee, label %sbuf_string.exit280.i.i, label %bb.fn

bb.fn:                                            ; preds = %bb.fm
  %i.aef = load ptr, ptr %i.aeb, align 8, !tbaa !81 ; 2 uses
...
sbuf_string.exit280.i.i:                          ; preds = %bb.fn, %bb.fm
  ...
  %i.aeh = load i64, ptr %i.aea, align 8, !tbaa !166 ; 4 uses
...
history_get.exit.lr.ph.i281.i.i:                  ; preds = %sbuf_string.exit280.i.i
  ...
  %i.aek = load ptr, ptr %i.aej, align 8, !tbaa !168
...
history_get.exit.i282.i.i:                        ; preds = %bb.fo, %history_get.exit.lr.ph.i281.i.i
  ...
  %i.aep = load ptr, ptr %i.aeo, align 8, !tbaa !87 ; 2 uses
...
bb.fo:                                            ; preds = %history_get.exit.i282.i.i
  ...
  br i1 %exitcond.not.i289.i.i, label %.loopexit.i.i, label %history_get.exit.i282.i.i, !llvm.loop !385
...
editor_restore.exit:                              ; preds = %sbuf_replace.exit.i, %bb.dz, %sbuf_len.exit.i.i203
  store i8 0, ptr %i.ca, align 1, !tbaa !232
...
.lr.ph.i.i.i:                                     ; preds = %editor_restore.exit
  %i.afc = load ptr, ptr %0, align 8, !tbaa !108
...
bb.fq:                                            ; preds = %bb.fq, %.lr.ph.i.i.i
  ...
  %i.afe = load ptr, ptr %.06.i.i.i, align 8, !tbaa !405 ; 2 uses
  %.val.i295.i.i = load ptr, ptr %i.afd, align 8, !tbaa !82
  call void %.val.i295.i.i(ptr noundef nonnull %.06.i.i.i) #28, !inline_history !392
  %.not.i296.i.i = icmp eq ptr %i.afe, null
  br i1 %.not.i296.i.i, label %hsearch_done.exit.i.i, label %bb.fq, !llvm.loop !393

hsearch_done.exit.i.i:                            ; preds = %bb.fq, %editor_restore.exit
  store ptr %i.rb, ptr %i.aj, align 8, !tbaa !226
  %i.aff = load ptr, ptr @rpenv, align 8, !tbaa !129 ; 2 uses
...
bb.fr:                                            ; preds = %hsearch_done.exit.i.i
  ...
  store ptr %i.afh, ptr @rpenv, align 8, !tbaa !129
...
ic_get_env.exit.i300.i.i:                         ; preds = %bb.fr
  ...
  %.pre.i.i301.i.i = load ptr, ptr @rpenv, align 8, !tbaa !129 ; 2 uses
...
ic_get_env.exit.thread6.i297.i.i:                 ; preds = %ic_get_env.exit.i300.i.i, %hsearch_done.exit.i.i
  ...
  store i8 %i.ra, ptr %i.afl, align 8, !tbaa !174
...
edit_history_search_with_current_word.exit:       ; preds = %bb.cf, %bb.cg, %ic_enable_hint.exit302.i.i
  %i.afm = load ptr, ptr %0, align 8, !tbaa !108
  %i.afn = getelementptr i8, ptr %i.afm, i64 16
  %.val.i204 = load ptr, ptr %i.afn, align 8, !tbaa !82
  call void %.val.i204(ptr noundef %.1.i) #28, !inline_history !394
...
bb.fu:                                            ; preds = %bb.bh
  %i.afo = load i64, ptr %i.af, align 8, !tbaa !223
  %i.afp = load ptr, ptr %i.aa, align 8, !tbaa !143
  %i.afq = getelementptr i8, ptr %i.afp, i64 16
  %.val.i208 = load i64, ptr %i.afq, align 8, !tbaa !204
  %i.afr = add nsw i64 %.val.i208, -1
  store i64 %i.afr, ptr %i.af, align 8, !tbaa !223
  call fastcc void @edit_clear(ptr noundef nonnull %0, ptr noundef nonnull %6)
  store i64 %i.afo, ptr %i.af, align 8, !tbaa !223
  call fastcc void @edit_refresh(ptr noundef nonnull %0, ptr noundef nonnull %6)
  br label %edit_multiline_eol.exit.backedge
...
bb.fy:                                            ; preds = %bb.bh, %bb.bh
  %i.afs = load ptr, ptr %6, align 8, !tbaa !217
  %i.aft = load i64, ptr %i.ae, align 8, !tbaa !222 ; 6 uses
  %.val.i209 = load ptr, ptr %i.afs, align 8, !tbaa !81 ; 3 uses
...
.lr.ph1125:                                       ; preds = %.preheader.i.i.i.i.preheader, %.preheader.i.i.i.i
  ...
  %i.afz = load i8, ptr %i.afy, align 1, !tbaa !48
...
bb.fz:                                            ; preds = %sbuf_prev.exit.i
  ...
  %.val.i.i212 = load ptr, ptr %i.aj, align 8, !tbaa !226
  %i.agd = load ptr, ptr %i.bh, align 8, !tbaa !148
  %i.age = call fastcc i64 @bbcode_column_width(ptr noundef %i.agd, ptr noundef %.val.i.i212)
  %i.agf = load ptr, ptr %i.bh, align 8, !tbaa !148
  %i.agg = load ptr, ptr %.in.i, align 8, !tbaa !147
  %i.agh = call fastcc i64 @bbcode_column_width(ptr noundef %i.agf, ptr noundef %i.agg)
  %i.agi = load ptr, ptr %i.bh, align 8, !tbaa !148
  %i.agj = load ptr, ptr %i.cd, align 8, !tbaa !157
  %i.agk = call fastcc i64 @bbcode_column_width(ptr noundef %i.agi, ptr noundef %i.agj) ; 2 uses
  %i.agl = add nsw i64 %i.agh, %i.age             ; 2 uses
  %i.agm = load i8, ptr %i.ce, align 2, !tbaa !173, !range !136, !noundef !137
  %i.agn = trunc nuw i8 %i.agm to i1
  %i.ago = call i64 @llvm.smax.i64(i64 %i.agl, i64 %i.agk)
  %i.agp = select i1 %i.agn, i64 %i.agk, i64 %i.ago
  %i.agq = load ptr, ptr %6, align 8, !tbaa !217  ; 2 uses
  %i.agr = load i64, ptr %i.ad, align 8, !tbaa !221
  %i.ags = load i64, ptr %i.ae, align 8, !tbaa !222
  %.val6.i.i213 = load ptr, ptr %i.agq, align 8, !tbaa !81
  %i.agt = getelementptr i8, ptr %i.agq, i64 16
  %.val7.i.i214 = load i64, ptr %i.agt, align 8, !tbaa !79
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e)
  store i64 %i.ags, ptr %i.e, align 8, !tbaa !88
  ...
  store i64 %.pre-phi.i211, ptr %i.ae, align 8, !tbaa !222
  call fastcc void @edit_refresh(ptr noundef nonnull %0, ptr noundef nonnull %6)
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #28
  br label %edit_multiline_eol.exit.backedge

bb.ga:                                            ; preds = %bb.bh, %bb.bh
  %i.agv = load i64, ptr %i.ae, align 8, !tbaa !222
  %i.agw = load ptr, ptr %6, align 8, !tbaa !217  ; 2 uses
...
bb.gb:                                            ; preds = %bb.ga
  ...
  %i.agz = load i64, ptr %i.agy, align 8, !tbaa !79
