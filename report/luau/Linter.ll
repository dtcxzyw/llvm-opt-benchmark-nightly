...
begin_hunk_0_@_ZN4Luau16LintFormatString16checkStringMatchEPKcmPi:bb.a
  %memchr177 = tail call ptr @memchr(ptr noundef nonnull dereferenceable(1) @.str.141, i32 %i.bc, i64 12)
  %.not37.i = icmp eq ptr %memchr177, null
  br i1 %.not37.i, label %.thread172, label %bb.ab

bb.aa:                                            ; preds = %bb.y
  %memchr176 = tail call ptr @memchr(ptr noundef nonnull dereferenceable(1) @.str.140, i32 %i.ay, i64 14)
  %.not.i = icmp eq ptr %memchr176, null
  br i1 %.not.i, label %.thread172, label %bb.ab
...
bb.ac:                                            ; preds = %bb.ab
  ...
  br i1 %i.bj, label %.thread172, label %bb.af
...
bb.ae:                                            ; preds = %bb.ad
  ...
  br i1 %i.bo, label %.thread172, label %bb.af
...
bb.ag:                                            ; preds = %.lr.ph220
  %i.br = add nsw i32 %.0157218, 1                ; 4 uses
  %.not.i132 = icmp eq ptr %.sroa.11.0216, %.sroa.19.0217
  br i1 %.not.i132, label %bb.ai, label %bb.ah

bb.ah:                                            ; preds = %bb.ag
  store i32 %i.br, ptr %.sroa.11.0216, align 4, !tbaa !9
  %i.bs = getelementptr inbounds nuw i8, ptr %.sroa.11.0216, i64 4
  br label %_ZNSt6vectorIiSaIiEE9push_backERKi.exit

bb.ai:                                            ; preds = %bb.ag
  %i.bt = ptrtoint ptr %.sroa.19.0217 to i64
  %i.bu = ptrtoint ptr %.sroa.0144.0215 to i64
...
bb.ak:                                            ; preds = %.noexc134
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 4 %i.cd, ptr align 4 %.sroa.0144.0215, i64 %i.bv, i1 false)
...
_ZNSt6vectorIiSaIiEE11_S_relocateEPiS2_S2_RS0_.exit16.i.i: ; preds = %bb.ak, %.noexc134
  ...
  %.not.i17.i.i = icmp eq ptr %.sroa.0144.0215, null
...
bb.am:                                            ; preds = %.lr.ph220
  %i.ci = icmp eq ptr %.sroa.0144.0215, %.sroa.11.0216
  br i1 %i.ci, label %.thread172, label %bb.an

bb.an:                                            ; preds = %bb.am
  %i.cj = getelementptr inbounds i8, ptr %.sroa.11.0216, i64 -4
  br label %_ZNSt6vectorIiSaIiEE9push_backERKi.exit

_ZNSt6vectorIiSaIiEE9push_backERKi.exit:          ; preds = %bb.af, %bb.f, %.preheader, %bb.v, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i, %bb.ah, %.lr.ph220, %bb.i, %bb.m, %bb.n, %bb.o, %bb.an
  %.sroa.0144.1 = phi ptr [ %.sroa.0144.0215, %.lr.ph220 ], [ %.sroa.0144.0215, %bb.ah ], [ %.sroa.0144.0215, %bb.n ], [ %.sroa.0144.0215, %bb.i ], [ %.sroa.0144.0215, %bb.m ], [ %.sroa.0144.0215, %bb.o ], [ %.sroa.0144.0215, %bb.v ], [ %.sroa.0144.0215, %bb.an ], [ %i.cd, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i ], [ %.sroa.0144.0215, %.preheader ], [ %.sroa.0144.0215, %bb.f ], [ %.sroa.0144.0215, %bb.af ] ; 4 uses
  %.sroa.11.1 = phi ptr [ %.sroa.11.0216, %.lr.ph220 ], [ %i.bs, %bb.ah ], [ %.sroa.11.0216, %bb.n ], [ %.sroa.11.0216, %bb.i ], [ %.sroa.11.0216, %bb.m ], [ %.sroa.11.0216, %bb.o ], [ %.sroa.11.0216, %bb.v ], [ %i.cj, %bb.an ], [ %i.cg, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i ], [ %.sroa.11.0216, %.preheader ], [ %.sroa.11.0216, %bb.f ], [ %.sroa.11.0216, %bb.af ] ; 2 uses
  %.sroa.19.1 = phi ptr [ %.sroa.19.0217, %.lr.ph220 ], [ %.sroa.19.0217, %bb.ah ], [ %.sroa.19.0217, %bb.n ], [ %.sroa.19.0217, %bb.i ], [ %.sroa.19.0217, %bb.m ], [ %.sroa.19.0217, %bb.o ], [ %.sroa.19.0217, %bb.v ], [ %.sroa.19.0217, %bb.an ], [ %i.ch, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i ], [ %.sroa.19.0217, %.preheader ], [ %.sroa.19.0217, %bb.f ], [ %.sroa.19.0217, %bb.af ] ; 3 uses
  %.1158 = phi i32 [ %.0157218, %.lr.ph220 ], [ %i.br, %bb.ah ], [ %.0157218, %bb.n ], [ %.0157218, %bb.i ], [ %.0157218, %bb.m ], [ %.0157218, %bb.o ], [ %.0157218, %bb.v ], [ %.0157218, %bb.an ], [ %i.br, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i ], [ %.0157218, %.preheader ], [ %.0157218, %bb.f ], [ %.0157218, %bb.af ] ; 2 uses
  %.2104 = phi i64 [ %.0102219, %.lr.ph220 ], [ %.0102219, %bb.ah ], [ %i.c, %bb.n ], [ %i.r, %bb.i ], [ %i.c, %bb.m ], [ %i.c, %bb.o ], [ %.2.lcssa, %bb.v ], [ %.0102219, %bb.an ], [ %.0102219, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i ], [ %i.c, %.preheader ], [ %i.c, %bb.f ], [ %.2.lcssa, %bb.af ]
  %i.ck = add i64 %.2104, 1                       ; 2 uses
  %.not127 = icmp ult i64 %i.ck, %2
  br i1 %.not127, label %.lr.ph220, label %.thread174, !llvm.loop !550

.thread174:                                       ; preds = %_ZNSt6vectorIiSaIiEE9push_backERKi.exit
  %i.cl = icmp eq ptr %.sroa.0144.1, %.sroa.11.1
  br i1 %i.cl, label %.thread174.thread, label %.thread172

.thread174.thread:                                ; preds = %bb.a, %.thread174
  %.0157.lcssa267 = phi i32 [ %.1158, %.thread174 ], [ 0, %bb.a ]
  %.sroa.19.0.lcssa266 = phi ptr [ %.sroa.19.1, %.thread174 ], [ null, %bb.a ] ; 2 uses
  %.sroa.0144.0.lcssa265 = phi ptr [ %.sroa.0144.1, %.thread174 ], [ null, %bb.a ] ; 2 uses
  %.not128 = icmp eq ptr %3, null
  br i1 %.not128, label %.thread172, label %bb.ao

bb.ao:                                            ; preds = %.thread174.thread
  store i32 %.0157.lcssa267, ptr %3, align 4, !tbaa !9
  br label %.thread172

.thread172:                                       ; preds = %.critedge, %bb.e, %bb.b, %bb.d, %bb.i, %bb.m, %bb.l, %bb.n, %bb.o, %bb.am, %bb.w, %bb.ae, %bb.ac, %bb.z, %bb.x, %bb.aa, %.lr.ph213, %.thread174.thread, %bb.ao, %.thread174
  %.sroa.0144.0207 = phi ptr [ %.sroa.0144.1, %.thread174 ], [ %.sroa.0144.0215, %bb.w ], [ %.sroa.0144.0.lcssa265, %bb.ao ], [ %.sroa.0144.0.lcssa265, %.thread174.thread ], [ %.sroa.0144.0215, %.lr.ph213 ], [ %.sroa.0144.0215, %bb.aa ], [ %.sroa.0144.0215, %bb.x ], [ %.sroa.0144.0215, %bb.z ], [ %.sroa.0144.0215, %bb.ac ], [ %.sroa.0144.0215, %bb.ae ], [ %.sroa.0144.0215, %bb.am ], [ %.sroa.0144.0215, %bb.o ], [ %.sroa.0144.0215, %bb.n ], [ %.sroa.0144.0215, %bb.l ], [ %.sroa.0144.0215, %bb.m ], [ %.sroa.0144.0215, %bb.i ], [ %.sroa.0144.0215, %bb.d ], [ %.sroa.0144.0215, %bb.b ], [ %.sroa.0144.0215, %bb.e ], [ %.sroa.0144.0215, %.critedge ] ; 3 uses
  %.sroa.19.0195 = phi ptr [ %.sroa.19.1, %.thread174 ], [ %.sroa.19.0217, %bb.w ], [ %.sroa.19.0.lcssa266, %bb.ao ], [ %.sroa.19.0.lcssa266, %.thread174.thread ], [ %.sroa.19.0217, %.lr.ph213 ], [ %.sroa.19.0217, %bb.aa ], [ %.sroa.19.0217, %bb.x ], [ %.sroa.19.0217, %bb.z ], [ %.sroa.19.0217, %bb.ac ], [ %.sroa.19.0217, %bb.ae ], [ %.sroa.19.0217, %bb.am ], [ %.sroa.19.0217, %bb.o ], [ %.sroa.19.0217, %bb.n ], [ %.sroa.19.0217, %bb.l ], [ %.sroa.19.0217, %bb.m ], [ %.sroa.19.0217, %bb.i ], [ %.sroa.19.0217, %bb.d ], [ %.sroa.19.0217, %bb.b ], [ %.sroa.19.0217, %bb.e ], [ %.sroa.19.0217, %.critedge ]
  %.9 = phi ptr [ @.str.152, %.thread174 ], [ @.str.142, %bb.w ], [ null, %bb.ao ], [ null, %.thread174.thread ], [ @.str.145, %.lr.ph213 ], [ @.str.154, %bb.ae ], [ @.str.154, %bb.ac ], [ @.str.148, %bb.z ], [ @.str.153, %bb.x ], [ @.str.149, %bb.aa ], [ @.str.147, %bb.l ], [ @.str.148, %bb.n ], [ @.str.149, %bb.o ], [ @.str.151, %bb.am ], [ @.str.144, %bb.e ], [ @.str.142, %bb.b ], [ @.str.143, %bb.d ], [ @.str.146, %bb.i ], [ @.str.150, %.critedge ], [ @.str.147, %bb.m ]
  %.not.i.i.i135 = icmp eq ptr %.sroa.0144.0207, null
  br i1 %.not.i.i.i135, label %_ZNSt6vectorIiSaIiEED2Ev.exit136, label %bb.ap

bb.ap:                                            ; preds = %.thread172
  %i.cm = ptrtoint ptr %.sroa.19.0195 to i64
  %i.cn = ptrtoint ptr %.sroa.0144.0207 to i64
  %i.co = sub i64 %i.cm, %i.cn
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.0144.0207, i64 noundef %i.co) #29
  br label %_ZNSt6vectorIiSaIiEED2Ev.exit136

_ZNSt6vectorIiSaIiEED2Ev.exit136:                 ; preds = %.thread172, %bb.ap
  ret ptr %.9
}
...
.lr.ph:                                           ; preds = %.lr.ph.preheader215, %.lr.ph
  ...
  %i.au = load i32, ptr %.055131, align 8, !tbaa !556
...
bb.d:                                             ; preds = %.lr.ph139, %bb.aj
  %.0137 = phi ptr [ %i.c, %.lr.ph139 ], [ %i.fs, %bb.aj ] ; 2 uses
