...
bb.ag:                                            ; preds = %.lr.ph219
  %i.br = add nsw i32 %.0156217, 1                ; 4 uses
  %.not.i132 = icmp eq ptr %.sroa.11.0215, %.sroa.19.0216
  br i1 %.not.i132, label %bb.ai, label %bb.ah

bb.ah:                                            ; preds = %bb.ag
  store i32 %i.br, ptr %.sroa.11.0215, align 4, !tbaa !9
  %i.bs = getelementptr inbounds nuw i8, ptr %.sroa.11.0215, i64 4
  br label %_ZNSt6vectorIiSaIiEE9push_backERKi.exit

bb.ai:                                            ; preds = %bb.ag
  %i.bt = ptrtoint ptr %.sroa.19.0216 to i64
  %i.bu = ptrtoint ptr %.sroa.0144.0214 to i64
...
bb.ak:                                            ; preds = %.noexc134
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 4 %i.cd, ptr align 4 %.sroa.0144.0214, i64 %i.bv, i1 false)
...
_ZNSt6vectorIiSaIiEE11_S_relocateEPiS2_S2_RS0_.exit16.i.i: ; preds = %bb.ak, %.noexc134
  ...
  %.not.i17.i.i = icmp eq ptr %.sroa.0144.0214, null
...
bb.al:                                            ; preds = %_ZNSt6vectorIiSaIiEE11_S_relocateEPiS2_S2_RS0_.exit16.i.i
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.0144.0214, i64 noundef %i.bv) #29
...
bb.am:                                            ; preds = %.lr.ph219
  %i.ci = icmp eq ptr %.sroa.0144.0214, %.sroa.11.0215
  br i1 %i.ci, label %.thread171, label %bb.an

bb.an:                                            ; preds = %bb.am
  %i.cj = getelementptr inbounds i8, ptr %.sroa.11.0215, i64 -4
  br label %_ZNSt6vectorIiSaIiEE9push_backERKi.exit
...
_ZNSt6vectorIiSaIiEE9push_backERKi.exit:          ; preds = %bb.af, %bb.f, %.preheader, %bb.v, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i, %bb.ah, %.lr.ph219, %bb.i, %bb.m, %bb.n, %bb.o, %bb.an
  %.sroa.0144.1 = phi ptr [ %.sroa.0144.0214, %.lr.ph219 ], [ %.sroa.0144.0214, %bb.ah ], [ %.sroa.0144.0214, %bb.n ], [ %.sroa.0144.0214, %bb.i ], [ %.sroa.0144.0214, %bb.m ], [ %.sroa.0144.0214, %bb.o ], [ %.sroa.0144.0214, %bb.v ], [ %.sroa.0144.0214, %bb.an ], [ %i.cd, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i ], [ %.sroa.0144.0214, %.preheader ], [ %.sroa.0144.0214, %bb.f ], [ %.sroa.0144.0214, %bb.af ] ; 4 uses
  %.sroa.11.1 = phi ptr [ %.sroa.11.0215, %.lr.ph219 ], [ %i.bs, %bb.ah ], [ %.sroa.11.0215, %bb.n ], [ %.sroa.11.0215, %bb.i ], [ %.sroa.11.0215, %bb.m ], [ %.sroa.11.0215, %bb.o ], [ %.sroa.11.0215, %bb.v ], [ %i.cj, %bb.an ], [ %i.cg, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i ], [ %.sroa.11.0215, %.preheader ], [ %.sroa.11.0215, %bb.f ], [ %.sroa.11.0215, %bb.af ] ; 2 uses
  %.sroa.19.1 = phi ptr [ %.sroa.19.0216, %.lr.ph219 ], [ %.sroa.19.0216, %bb.ah ], [ %.sroa.19.0216, %bb.n ], [ %.sroa.19.0216, %bb.i ], [ %.sroa.19.0216, %bb.m ], [ %.sroa.19.0216, %bb.o ], [ %.sroa.19.0216, %bb.v ], [ %.sroa.19.0216, %bb.an ], [ %i.ch, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i ], [ %.sroa.19.0216, %.preheader ], [ %.sroa.19.0216, %bb.f ], [ %.sroa.19.0216, %bb.af ] ; 3 uses
  %.1157 = phi i32 [ %.0156217, %.lr.ph219 ], [ %i.br, %bb.ah ], [ %.0156217, %bb.n ], [ %.0156217, %bb.i ], [ %.0156217, %bb.m ], [ %.0156217, %bb.o ], [ %.0156217, %bb.v ], [ %.0156217, %bb.an ], [ %i.br, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i ], [ %.0156217, %.preheader ], [ %.0156217, %bb.f ], [ %.0156217, %bb.af ] ; 2 uses
  %.2104 = phi i64 [ %.0102218, %.lr.ph219 ], [ %.0102218, %bb.ah ], [ %i.c, %bb.n ], [ %i.r, %bb.i ], [ %i.c, %bb.m ], [ %i.c, %bb.o ], [ %.2.lcssa, %bb.v ], [ %.0102218, %bb.an ], [ %.0102218, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i ], [ %i.c, %.preheader ], [ %i.c, %bb.f ], [ %.2.lcssa, %bb.af ]
...
.thread173.thread:                                ; preds = %bb.a, %.thread173
  %.0156.lcssa266 = phi i32 [ %.1157, %.thread173 ], [ 0, %bb.a ]
  %.sroa.19.0.lcssa265 = phi ptr [ %.sroa.19.1, %.thread173 ], [ null, %bb.a ] ; 2 uses
...
bb.ao:                                            ; preds = %.thread173.thread
  store i32 %.0156.lcssa266, ptr %3, align 4, !tbaa !9
  br label %.thread171
...
.thread171:                                       ; preds = %.critedge, %bb.e, %bb.b, %bb.d, %bb.i, %bb.m, %bb.l, %bb.n, %bb.o, %bb.am, %bb.w, %bb.ae, %bb.ac, %bb.z, %bb.x, %bb.aa, %.lr.ph212, %.thread173.thread, %bb.ao, %.thread173
  %.sroa.0144.0206 = phi ptr [ %.sroa.0144.1, %.thread173 ], [ %.sroa.0144.0214, %bb.w ], [ %.sroa.0144.0.lcssa264, %bb.ao ], [ %.sroa.0144.0.lcssa264, %.thread173.thread ], [ %.sroa.0144.0214, %.lr.ph212 ], [ %.sroa.0144.0214, %bb.aa ], [ %.sroa.0144.0214, %bb.x ], [ %.sroa.0144.0214, %bb.z ], [ %.sroa.0144.0214, %bb.ac ], [ %.sroa.0144.0214, %bb.ae ], [ %.sroa.0144.0214, %bb.am ], [ %.sroa.0144.0214, %bb.o ], [ %.sroa.0144.0214, %bb.n ], [ %.sroa.0144.0214, %bb.l ], [ %.sroa.0144.0214, %bb.m ], [ %.sroa.0144.0214, %bb.i ], [ %.sroa.0144.0214, %bb.d ], [ %.sroa.0144.0214, %bb.b ], [ %.sroa.0144.0214, %bb.e ], [ %.sroa.0144.0214, %.critedge ] ; 3 uses
  %.sroa.19.0194 = phi ptr [ %.sroa.19.1, %.thread173 ], [ %.sroa.19.0216, %bb.w ], [ %.sroa.19.0.lcssa265, %bb.ao ], [ %.sroa.19.0.lcssa265, %.thread173.thread ], [ %.sroa.19.0216, %.lr.ph212 ], [ %.sroa.19.0216, %bb.aa ], [ %.sroa.19.0216, %bb.x ], [ %.sroa.19.0216, %bb.z ], [ %.sroa.19.0216, %bb.ac ], [ %.sroa.19.0216, %bb.ae ], [ %.sroa.19.0216, %bb.am ], [ %.sroa.19.0216, %bb.o ], [ %.sroa.19.0216, %bb.n ], [ %.sroa.19.0216, %bb.l ], [ %.sroa.19.0216, %bb.m ], [ %.sroa.19.0216, %bb.i ], [ %.sroa.19.0216, %bb.d ], [ %.sroa.19.0216, %bb.b ], [ %.sroa.19.0216, %bb.e ], [ %.sroa.19.0216, %.critedge ]
  ...
  %.not.i.i.i135 = icmp eq ptr %.sroa.0144.0206, null
  br i1 %.not.i.i.i135, label %_ZNSt6vectorIiSaIiEED2Ev.exit136, label %bb.ap

bb.ap:                                            ; preds = %.thread171
  %i.cm = ptrtoint ptr %.sroa.19.0194 to i64
  %i.cn = ptrtoint ptr %.sroa.0144.0206 to i64
  %i.co = sub i64 %i.cm, %i.cn
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.0144.0206, i64 noundef %i.co) #29
