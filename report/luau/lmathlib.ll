...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %3 = extractelement <2 x float> %i.ae, i64 0
  ...
  %i.ds = shufflevector <2 x float> %5, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
