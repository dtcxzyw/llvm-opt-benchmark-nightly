...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %1 = fptrunc double %.0 to float                ; 2 uses
  %i.s = fptrunc double %.017 to float            ; 2 uses
  %2 = fptrunc double %.016 to float              ; 2 uses
  %i.t = call float @llvm.floor.f32(float %1)     ; 2 uses
  %i.u = call float @llvm.floor.f32(float %i.s)   ; 2 uses
  %i.v = call float @llvm.floor.f32(float %2)     ; 2 uses
  %i.w = fptosi float %i.t to i32
  %i.x = and i32 %i.w, 255
  %i.y = fptosi float %i.u to i32
  %i.z = fptosi float %i.v to i32
  %3 = fsub float %1, %i.t                        ; 7 uses
  %i.aa = fsub float %i.s, %i.u                   ; 7 uses
  %4 = fmul float %3, %3
  %5 = fmul float %3, %4
  %6 = call float @llvm.fmuladd.f32(float %3, float 6.000000e+00, float -1.500000e+01)
  %7 = call float @llvm.fmuladd.f32(float %3, float %6, float 1.000000e+01)
  %8 = fmul float %5, %7
  ...
  %10 = fadd float %i.aa, -1.000000e+00
  %i.bp = and i8 %i.bo, 15
  ...
  %13 = getelementptr inbounds nuw [12 x i8], ptr @_ZL11kPerlinGrad, i64 %12 ; 2 uses
  %14 = getelementptr inbounds nuw i8, ptr %13, i64 8
  %15 = load float, ptr %14, align 4, !tbaa !34
  %16 = getelementptr inbounds nuw i8, ptr %i.bg, i64 1
  ...
  %18 = getelementptr inbounds nuw i8, ptr %i.cf, i64 8
  %19 = load float, ptr %18, align 4, !tbaa !34
  %20 = getelementptr inbounds nuw i8, ptr %i.bn, i64 1
  %21 = load i8, ptr %20, align 1, !tbaa !33
  %22 = and i8 %21, 15
  %23 = zext nneg i8 %22 to i64
  %24 = getelementptr inbounds nuw [12 x i8], ptr @_ZL11kPerlinGrad, i64 %23 ; 2 uses
  %i.cg = getelementptr inbounds nuw i8, ptr %24, i64 8
  %i.ch = load float, ptr %i.cg, align 4, !tbaa !34
  %25 = getelementptr inbounds nuw i8, ptr %i.bu, i64 1
  %26 = load i8, ptr %25, align 1, !tbaa !33
  %27 = and i8 %26, 15
  %28 = zext nneg i8 %27 to i64
  %29 = getelementptr inbounds nuw [12 x i8], ptr @_ZL11kPerlinGrad, i64 %28 ; 2 uses
  %i.ci = getelementptr inbounds nuw i8, ptr %29, i64 8
  %30 = load float, ptr %i.ci, align 4, !tbaa !34
  %31 = fsub float %2, %i.v                       ; 6 uses
  %32 = fmul float %31, %31
  %33 = fmul float %31, %32
  %34 = call float @llvm.fmuladd.f32(float %31, float 6.000000e+00, float -1.500000e+01)
  %35 = call float @llvm.fmuladd.f32(float %31, float %34, float 1.000000e+01)
  %36 = fmul float %33, %35
  %37 = load <2 x float>, ptr %i.bd, align 4, !tbaa !34 ; 2 uses
  %38 = load <2 x float>, ptr %i.bk, align 4, !tbaa !34 ; 2 uses
  %39 = load <2 x float>, ptr %i.br, align 4, !tbaa !34 ; 2 uses
  %40 = load <2 x float>, ptr %i.by, align 4, !tbaa !34 ; 2 uses
  %41 = insertelement <2 x float> poison, float %31, i64 0
  %42 = shufflevector <2 x float> %41, <2 x float> poison, <2 x i32> zeroinitializer
  %43 = fadd <2 x float> %42, <float -1.000000e+00, float -0.000000e+00> ; 4 uses
  %44 = load <2 x float>, ptr %13, align 4, !tbaa !34 ; 2 uses
  %i.cj = insertelement <2 x float> poison, float %i.aa, i64 0
  %45 = shufflevector <2 x float> %i.cj, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %46 = shufflevector <2 x float> %44, <2 x float> %37, <2 x i32> <i32 1, i32 3>
  %47 = fmul <2 x float> %45, %46
  %48 = shufflevector <2 x float> %44, <2 x float> %37, <2 x i32> <i32 0, i32 2>
  ...
  %52 = insertelement <2 x float> poison, float %15, i64 0
  %53 = insertelement <2 x float> %52, float %i.bf, i64 1
  %54 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %53, <2 x float> %43, <2 x float> %51) ; 2 uses
  %55 = load <2 x float>, ptr %i.cf, align 4, !tbaa !34 ; 2 uses
  %i.ck = shufflevector <2 x float> %55, <2 x float> %38, <2 x i32> <i32 1, i32 3>
  %i.cl = fmul <2 x float> %45, %i.ck
  %i.cm = shufflevector <2 x float> %55, <2 x float> %38, <2 x i32> <i32 0, i32 2>
  %56 = insertelement <2 x float> poison, float %9, i64 0
  %57 = shufflevector <2 x float> %56, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %58 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cm, <2 x float> %57, <2 x float> %i.cl)
  %i.cn = insertelement <2 x float> poison, float %19, i64 0
  %i.co = insertelement <2 x float> %i.cn, float %i.bm, i64 1
  %i.cp = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.co, <2 x float> %43, <2 x float> %58)
  %59 = fsub <2 x float> %i.cp, %54
  %60 = insertelement <2 x float> poison, float %8, i64 0
  %61 = shufflevector <2 x float> %60, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %62 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %61, <2 x float> %59, <2 x float> %54) ; 2 uses
  %63 = load <2 x float>, ptr %24, align 4, !tbaa !34 ; 2 uses
  %64 = insertelement <2 x float> poison, float %10, i64 0
  %65 = shufflevector <2 x float> %64, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.cq = shufflevector <2 x float> %63, <2 x float> %39, <2 x i32> <i32 1, i32 3>
  %i.cr = fmul <2 x float> %65, %i.cq
  %i.cs = shufflevector <2 x float> %63, <2 x float> %39, <2 x i32> <i32 0, i32 2>
  %66 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cs, <2 x float> %50, <2 x float> %i.cr)
  %67 = insertelement <2 x float> poison, float %i.ch, i64 0
  %68 = insertelement <2 x float> %67, float %i.bt, i64 1
  %i.ct = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %68, <2 x float> %43, <2 x float> %66) ; 2 uses
  %69 = load <2 x float>, ptr %29, align 4, !tbaa !34 ; 2 uses
  %70 = shufflevector <2 x float> %69, <2 x float> %40, <2 x i32> <i32 1, i32 3>
  %71 = fmul <2 x float> %65, %70
  %72 = shufflevector <2 x float> %69, <2 x float> %40, <2 x i32> <i32 0, i32 2>
  %73 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %72, <2 x float> %57, <2 x float> %71)
  %i.cu = insertelement <2 x float> poison, float %30, i64 0
  %i.cv = insertelement <2 x float> %i.cu, float %i.ca, i64 1
  %i.cw = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cv, <2 x float> %43, <2 x float> %73)
  %i.cx = fsub <2 x float> %i.cw, %i.ct
  %i.cy = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %61, <2 x float> %i.cx, <2 x float> %i.ct)
  %i.cz = fsub <2 x float> %i.cy, %62
  %74 = insertelement <2 x float> poison, float %i.af, i64 0
  %75 = shufflevector <2 x float> %74, <2 x float> poison, <2 x i32> zeroinitializer
  %76 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %75, <2 x float> %i.cz, <2 x float> %62) ; 2 uses
  %77 = extractelement <2 x float> %76, i64 0
  %78 = extractelement <2 x float> %76, i64 1     ; 2 uses
  %79 = fsub float %77, %78
  %i.da = call noundef float @llvm.fmuladd.f32(float %36, float %79, float %78)
