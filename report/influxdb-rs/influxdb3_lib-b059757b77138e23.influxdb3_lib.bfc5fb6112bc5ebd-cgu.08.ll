...
begin_hunk_0_@_RNvXs2_NtNtCsbYyEjVLvvus_5tonic5codec6decodeINtB5_9StreamingNtNtCsekDO8Mha3LU_12arrow_flight3gen6ActionENtNtCsi0Uwx9p0WRp_12futures_core6stream6Stream9poll_nextCsgsNUVCRJO2f_13influxdb3_lib:bb.a
  %i.u = call { i64, i64 } %i.t(ptr noundef nonnull %i.q), !noalias !12700, !inline_history !12690 ; 2 uses
  %i.v = extractvalue { i64, i64 } %i.u, 0
  %i.w = extractvalue { i64, i64 } %i.u, 1
  call void @_RNvMs0_NtNtCsbYyEjVLvvus_5tonic5codec6decodeNtB5_14StreamingInner12decode_chunk(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %i.d, ptr noalias noundef nonnull align 8 dereferenceable(232) %1, i64 noundef %i.v, i64 noundef %i.w), !noalias !12701
  %i.x = load i64, ptr %i.d, align 8, !range !19, !noalias !12700, !noundef !17
  %i.y = trunc nuw i64 %i.x to i1
  %i.z = load ptr, ptr %i.k, align 8, !noalias !12700, !align !23, !noundef !17 ; 3 uses
  br i1 %i.y, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !12700
  br label %.loopexit

bb.d:                                             ; preds = %bb.b
  %i.aa = load i64, ptr %i.l, align 8, !noalias !12700
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !12700
...
bb.e:                                             ; preds = %bb.d
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !12700
  store ptr %i.z, ptr %i.c, align 8, !noalias !12700
  store i64 %i.aa, ptr %i.m, align 8, !noalias !12700
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !12700
  %i.ab = load ptr, ptr %i.i, align 8, !alias.scope !12699, !noalias !12701, !nonnull !17, !noundef !17
  %i.ac = load ptr, ptr %i.j, align 8, !alias.scope !12699, !noalias !12701, !nonnull !17, !align !23, !noundef !17
  %i.ad = getelementptr inbounds nuw i8, ptr %i.ac, i64 24
  %i.ae = load ptr, ptr %i.ad, align 8, !invariant.load !17, !noalias !12701, !nonnull !17
  call void %i.ae(ptr noalias noundef nonnull sret([56 x i8]) align 8 captures(address) dereferenceable(56) %i.b, ptr noundef nonnull %i.ab, ptr noalias noundef nonnull align 8 dereferenceable(16) %i.c), !noalias !12701, !inline_history !12690
  %i.af = load i64, ptr %i.b, align 8, !range !44, !noalias !12700, !noundef !17 ; 4 uses
  %i.ag = icmp eq i64 %i.af, -2
  %i.ah = load ptr, ptr %.sroa.421.0..sroa_idx.i, align 8, !noalias !12700 ; 3 uses
  br i1 %i.ag, label %bb.f, label %bb.g

bb.f:                                             ; preds = %bb.e
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !12700
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !12700
  br label %.loopexit

bb.g:                                             ; preds = %bb.e
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %.sroa.4.i, ptr noundef nonnull align 8 dereferenceable(40) %.sroa.522.0..sroa_idx.i, i64 40, i1 false), !noalias !12700
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !12700
...
bb.h:                                             ; preds = %bb.g
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !12700
  store i64 %i.af, ptr %i.a, align 8, !noalias !12700
  store ptr %i.ah, ptr %.sroa.311.0..sroa_idx.i, align 8, !noalias !12700
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %.sroa.4.0..sroa_idx.i, ptr noundef nonnull align 8 dereferenceable(40) %.sroa.4.i, i64 40, i1 false), !noalias !12700
  %i.ai = load i8, ptr %i.f, align 8, !range !24, !alias.scope !12702, !noalias !12701, !noundef !17
...
bb.i:                                             ; preds = %bb.h
  %i.aj = load ptr, ptr %i.n, align 8, !alias.scope !12703, !noalias !12701, !align !23, !noundef !17
...
bb.j:                                             ; preds = %bb.i
  invoke void @_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtCsbYyEjVLvvus_5tonic6status6StatusECsgsNUVCRJO2f_13influxdb3_lib(ptr noalias noundef nonnull readonly align 8 dereferenceable(8) %i.n)
          to label %_RNvMs1_NtNtCsbYyEjVLvvus_5tonic5codec6decodeINtB5_9StreamingNtNtCsekDO8Mha3LU_12arrow_flight3gen6ActionE12decode_chunkCsgsNUVCRJO2f_13influxdb3_lib.exit unwind label %bb.k, !noalias !12701

bb.k:                                             ; preds = %bb.j
  %i.al = landingpad { ptr, i32 }
          cleanup
  store i8 0, ptr %i.f, align 8, !alias.scope !12699, !noalias !12701
  invoke fastcc void @_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtCsekDO8Mha3LU_12arrow_flight3gen6ActionECsgsNUVCRJO2f_13influxdb3_lib(ptr noalias noundef align 8 dereferenceable(56) %i.a) #44
          to label %common.resume unwind label %bb.l, !noalias !12701

bb.l:                                             ; preds = %bb.k
  %i.am = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCs4NRVxsYgnAr_4core9panicking16panic_in_cleanup() #45, !noalias !12701
  unreachable
...
_RNvMs1_NtNtCsbYyEjVLvvus_5tonic5codec6decodeINtB5_9StreamingNtNtCsekDO8Mha3LU_12arrow_flight3gen6ActionE12decode_chunkCsgsNUVCRJO2f_13influxdb3_lib.exit: ; preds = %bb.h, %bb.i, %bb.j
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !12700
...
bb.o:                                             ; preds = %_RNvMs1_NtNtCsbYyEjVLvvus_5tonic5codec6decodeINtB5_9StreamingNtNtCsekDO8Mha3LU_12arrow_flight3gen6ActionE12decode_chunkCsgsNUVCRJO2f_13influxdb3_lib.exit.thread68
  ...
  %i.an = load i8, ptr %i.e, align 8, !range !24, !noundef !17
...
bb.r:                                             ; preds = %bb.o
  ...
  %.sroa.331.0.copyload = load ptr, ptr %.sroa.331.0..sroa_idx, align 8, !nonnull !17, !noundef !17
...
bb.u:                                             ; preds = %bb.s
  %.pre = load i8, ptr %i.f, align 8, !range !24
  %i.aq = icmp eq i8 %.pre, 2
  br i1 %i.aq, label %._crit_edge, label %bb.b

bb.v:                                             ; preds = %bb.t
  %i.ar = load i8, ptr %i.f, align 8, !range !24, !alias.scope !12704, !noundef !17
  %switch.i = icmp samesign ult i8 %i.ar, 2
  br i1 %switch.i, label %.thread, label %bb.w

bb.w:                                             ; preds = %bb.v
  %i.as = load ptr, ptr %i.n, align 8, !alias.scope !12705, !align !23, !noundef !17
...
bb.a:
  ...
  %i.f = load i8, ptr %i.e, align 8, !range !24, !noundef !17
...
._crit_edge:                                      ; preds = %bb.u, %.thread, %bb.a
  ...
  %i.p = load ptr, ptr %i.o, align 8, !align !23, !noundef !17 ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph, %bb.u
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !12727
  %i.q = load ptr, ptr %i.h, align 8, !alias.scope !12726, !noalias !12725, !nonnull !17, !noundef !17
  %i.r = load ptr, ptr %i.i, align 8, !alias.scope !12726, !noalias !12725, !nonnull !17, !align !23, !noundef !17
  %i.s = getelementptr inbounds nuw i8, ptr %i.r, i64 32
  %i.t = load ptr, ptr %i.s, align 8, !invariant.load !17, !noalias !12727, !nonnull !17
  %i.u = call { i64, i64 } %i.t(ptr noundef nonnull %i.q), !noalias !12727, !inline_history !12709 ; 2 uses
  %i.v = extractvalue { i64, i64 } %i.u, 0
  %i.w = extractvalue { i64, i64 } %i.u, 1
  call void @_RNvMs0_NtNtCsbYyEjVLvvus_5tonic5codec6decodeNtB5_14StreamingInner12decode_chunk(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %i.c, ptr noalias noundef nonnull align 8 dereferenceable(232) %1, i64 noundef %i.v, i64 noundef %i.w), !noalias !12725
  %i.x = load i64, ptr %i.c, align 8, !range !19, !noalias !12727, !noundef !17
  %i.y = trunc nuw i64 %i.x to i1
  %i.z = load ptr, ptr %i.j, align 8, !noalias !12727, !align !23, !noundef !17 ; 3 uses
  br i1 %i.y, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !12727
  br label %bb.n

bb.d:                                             ; preds = %bb.b
  %i.aa = load i64, ptr %i.k, align 8, !noalias !12727
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !12727
  %.not.i = icmp eq ptr %i.z, null
...
bb.e:                                             ; preds = %bb.d
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !12727
  store ptr %i.z, ptr %i.b, align 8, !noalias !12727
  store i64 %i.aa, ptr %i.l, align 8, !noalias !12727
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !12727
  %i.ab = load ptr, ptr %i.h, align 8, !alias.scope !12726, !noalias !12725, !nonnull !17, !noundef !17
  %i.ac = load ptr, ptr %i.i, align 8, !alias.scope !12726, !noalias !12725, !nonnull !17, !align !23, !noundef !17
  %i.ad = getelementptr inbounds nuw i8, ptr %i.ac, i64 24
  %i.ae = load ptr, ptr %i.ad, align 8, !invariant.load !17, !noalias !12725, !nonnull !17
  call void %i.ae(ptr noalias noundef nonnull sret([40 x i8]) align 8 captures(address) dereferenceable(40) %i.a, ptr noundef nonnull %i.ab, ptr noalias noundef nonnull align 8 dereferenceable(16) %i.b), !noalias !12725, !inline_history !12709
  %i.af = load i64, ptr %i.a, align 8, !range !19, !noalias !12727, !noundef !17
  %i.ag = trunc nuw i64 %i.af to i1
  %i.ah = load ptr, ptr %i.m, align 8, !noalias !12727 ; 4 uses
  br i1 %i.ag, label %bb.f, label %bb.g
...
bb.f:                                             ; preds = %bb.e
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !12727
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !12727
  br label %bb.n

bb.g:                                             ; preds = %bb.e
  %.sroa.420.sroa.0.0.copyload.i = load ptr, ptr %.sroa.420.0..sroa_idx.i, align 8, !noalias !12727 ; 2 uses
  %.sroa.420.sroa.4.0.copyload.i = load i64, ptr %.sroa.420.sroa.4.0..sroa.420.0..sroa_idx.sroa_idx.i, align 8, !noalias !12727 ; 2 uses
  %.sroa.420.sroa.5.0.copyload.i = load ptr, ptr %.sroa.420.sroa.5.0..sroa.420.0..sroa_idx.sroa_idx.i, align 8, !noalias !12727 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !12727
...
bb.h:                                             ; preds = %bb.g
  %i.ai = load i8, ptr %i.e, align 8, !range !24, !alias.scope !12728, !noalias !12725, !noundef !17
  %switch.i.i = icmp samesign ult i8 %i.ai, 2
...
bb.i:                                             ; preds = %bb.h
  %i.aj = load ptr, ptr %i.n, align 8, !alias.scope !12729, !noalias !12725, !align !23, !noundef !17
  %i.ak = icmp eq ptr %i.aj, null
...
bb.j:                                             ; preds = %bb.i
  invoke void @_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtCsbYyEjVLvvus_5tonic6status6StatusECsgsNUVCRJO2f_13influxdb3_lib(ptr noalias noundef nonnull readonly align 8 dereferenceable(8) %i.n)
          to label %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtNtCsbYyEjVLvvus_5tonic5codec6decode5StateECsgsNUVCRJO2f_13influxdb3_lib.exit.i unwind label %bb.k, !noalias !12725

bb.k:                                             ; preds = %bb.j
  %i.al = landingpad { ptr, i32 }
          cleanup
  store i8 0, ptr %i.e, align 8, !alias.scope !12726, !noalias !12725
  %i.am = getelementptr inbounds nuw i8, ptr %i.ah, i64 32
  %i.an = load ptr, ptr %i.am, align 8, !noalias !12730, !nonnull !17, !noundef !17
  invoke void %i.an(ptr noundef %.sroa.420.sroa.5.0.copyload.i, ptr noundef %.sroa.420.sroa.0.0.copyload.i, i64 noundef %.sroa.420.sroa.4.0.copyload.i)
          to label %common.resume unwind label %bb.l, !noalias !12725, !inline_history !12720
...
_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtNtCsbYyEjVLvvus_5tonic5codec6decode5StateECsgsNUVCRJO2f_13influxdb3_lib.exit.i: ; preds = %bb.j, %bb.i, %bb.h
  store i8 0, ptr %i.e, align 8, !alias.scope !12726, !noalias !12725
  store ptr %i.ah, ptr %.sroa.8, align 8, !alias.scope !12725, !noalias !12726
...
bb.l:                                             ; preds = %bb.k
  %i.ao = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCs4NRVxsYgnAr_4core9panicking16panic_in_cleanup() #45, !noalias !12725
  unreachable
...
_RNvMs1_NtNtCsbYyEjVLvvus_5tonic5codec6decodeINtB5_9StreamingNtNtCsekDO8Mha3LU_12arrow_flight3gen6TicketE12decode_chunkCsgsNUVCRJO2f_13influxdb3_lib.exit: ; preds = %bb.g, %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtNtCsbYyEjVLvvus_5tonic5codec6decode5StateECsgsNUVCRJO2f_13influxdb3_lib.exit.i
  ...
  store ptr %.sroa.420.sroa.5.0.copyload.sink.i, ptr %.sink.i.sroa.phi, align 8, !alias.scope !12725, !noalias !12726
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !12727
...
bb.p:                                             ; preds = %_RNvMs1_NtNtCsbYyEjVLvvus_5tonic5codec6decodeINtB5_9StreamingNtNtCsekDO8Mha3LU_12arrow_flight3gen6TicketE12decode_chunkCsgsNUVCRJO2f_13influxdb3_lib.exit.thread, %_RNvMs1_NtNtCsbYyEjVLvvus_5tonic5codec6decodeINtB5_9StreamingNtNtCsekDO8Mha3LU_12arrow_flight3gen6TicketE12decode_chunkCsgsNUVCRJO2f_13influxdb3_lib.exit
  ...
  %i.ap = load i8, ptr %i.d, align 8, !range !24, !noundef !17
...
bb.r:                                             ; preds = %bb.p
  ...
  %.sroa.322.0.copyload = load ptr, ptr %.sroa.322.0..sroa_idx, align 8, !nonnull !17, !noundef !17
  store i64 1, ptr %0, align 8
...
bb.u:                                             ; preds = %bb.s
  %.pre = load i8, ptr %i.e, align 8, !range !24
  %i.as = icmp eq i8 %.pre, 2
  br i1 %i.as, label %._crit_edge, label %bb.b

bb.v:                                             ; preds = %bb.t
  %i.at = load i8, ptr %i.e, align 8, !range !24, !alias.scope !12731, !noundef !17
  %switch.i = icmp samesign ult i8 %i.at, 2
  br i1 %switch.i, label %.thread, label %bb.w

bb.w:                                             ; preds = %bb.v
  %i.au = load ptr, ptr %i.n, align 8, !alias.scope !12732, !align !23, !noundef !17
...
bb.b:                                             ; preds = %.lr.ph, %bb.u
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !12754
  %i.q = load ptr, ptr %i.h, align 8, !alias.scope !12753, !noalias !12752, !nonnull !17, !noundef !17
  %i.r = load ptr, ptr %i.i, align 8, !alias.scope !12753, !noalias !12752, !nonnull !17, !align !23, !noundef !17
  %i.s = getelementptr inbounds nuw i8, ptr %i.r, i64 32
  %i.t = load ptr, ptr %i.s, align 8, !invariant.load !17, !noalias !12754, !nonnull !17
  %i.u = call { i64, i64 } %i.t(ptr noundef nonnull %i.q), !noalias !12754, !inline_history !12736 ; 2 uses
  %i.v = extractvalue { i64, i64 } %i.u, 0
  %i.w = extractvalue { i64, i64 } %i.u, 1
  call void @_RNvMs0_NtNtCsbYyEjVLvvus_5tonic5codec6decodeNtB5_14StreamingInner12decode_chunk(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %i.c, ptr noalias noundef nonnull align 8 dereferenceable(232) %1, i64 noundef %i.v, i64 noundef %i.w), !noalias !12752
  %i.x = load i64, ptr %i.c, align 8, !range !19, !noalias !12754, !noundef !17
  %i.y = trunc nuw i64 %i.x to i1
  %i.z = load ptr, ptr %i.j, align 8, !noalias !12754, !align !23, !noundef !17 ; 3 uses
  br i1 %i.y, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !12754
  br label %bb.n

bb.d:                                             ; preds = %bb.b
  %i.aa = load i64, ptr %i.k, align 8, !noalias !12754
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !12754
  %.not.i = icmp eq ptr %i.z, null
...
bb.e:                                             ; preds = %bb.d
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !12754
  store ptr %i.z, ptr %i.b, align 8, !noalias !12754
  store i64 %i.aa, ptr %i.l, align 8, !noalias !12754
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !12754
  %i.ab = load ptr, ptr %i.h, align 8, !alias.scope !12753, !noalias !12752, !nonnull !17, !noundef !17
  %i.ac = load ptr, ptr %i.i, align 8, !alias.scope !12753, !noalias !12752, !nonnull !17, !align !23, !noundef !17
  %i.ad = getelementptr inbounds nuw i8, ptr %i.ac, i64 24
  %i.ae = load ptr, ptr %i.ad, align 8, !invariant.load !17, !noalias !12752, !nonnull !17
  call void %i.ae(ptr noalias noundef nonnull sret([40 x i8]) align 8 captures(address) dereferenceable(40) %i.a, ptr noundef nonnull %i.ab, ptr noalias noundef nonnull align 8 dereferenceable(16) %i.b), !noalias !12752, !inline_history !12736
  %i.af = load i64, ptr %i.a, align 8, !range !19, !noalias !12754, !noundef !17
  %i.ag = trunc nuw i64 %i.af to i1
  %i.ah = load ptr, ptr %i.m, align 8, !noalias !12754 ; 4 uses
  br i1 %i.ag, label %bb.f, label %bb.g
...
bb.f:                                             ; preds = %bb.e
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !12754
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !12754
  br label %bb.n

bb.g:                                             ; preds = %bb.e
  %.sroa.420.sroa.0.0.copyload.i = load ptr, ptr %.sroa.420.0..sroa_idx.i, align 8, !noalias !12754 ; 2 uses
  %.sroa.420.sroa.4.0.copyload.i = load i64, ptr %.sroa.420.sroa.4.0..sroa.420.0..sroa_idx.sroa_idx.i, align 8, !noalias !12754 ; 2 uses
  %.sroa.420.sroa.5.0.copyload.i = load ptr, ptr %.sroa.420.sroa.5.0..sroa.420.0..sroa_idx.sroa_idx.i, align 8, !noalias !12754 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !12754
  %.not23.i = icmp eq ptr %i.ah, null
...
bb.h:                                             ; preds = %bb.g
  %i.ai = load i8, ptr %i.e, align 8, !range !24, !alias.scope !12755, !noalias !12752, !noundef !17
  %switch.i.i = icmp samesign ult i8 %i.ai, 2
  br i1 %switch.i.i, label %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtNtCsbYyEjVLvvus_5tonic5codec6decode5StateECsgsNUVCRJO2f_13influxdb3_lib.exit.i, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.aj = load ptr, ptr %i.n, align 8, !alias.scope !12756, !noalias !12752, !align !23, !noundef !17
  %i.ak = icmp eq ptr %i.aj, null
  br i1 %i.ak, label %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtNtCsbYyEjVLvvus_5tonic5codec6decode5StateECsgsNUVCRJO2f_13influxdb3_lib.exit.i, label %bb.j

bb.j:                                             ; preds = %bb.i
  invoke void @_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtCsbYyEjVLvvus_5tonic6status6StatusECsgsNUVCRJO2f_13influxdb3_lib(ptr noalias noundef nonnull readonly align 8 dereferenceable(8) %i.n)
          to label %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtNtCsbYyEjVLvvus_5tonic5codec6decode5StateECsgsNUVCRJO2f_13influxdb3_lib.exit.i unwind label %bb.k, !noalias !12752

bb.k:                                             ; preds = %bb.j
  %i.al = landingpad { ptr, i32 }
          cleanup
  store i8 0, ptr %i.e, align 8, !alias.scope !12753, !noalias !12752
  %i.am = getelementptr inbounds nuw i8, ptr %i.ah, i64 32
  %i.an = load ptr, ptr %i.am, align 8, !noalias !12757, !nonnull !17, !noundef !17
  invoke void %i.an(ptr noundef %.sroa.420.sroa.5.0.copyload.i, ptr noundef %.sroa.420.sroa.0.0.copyload.i, i64 noundef %.sroa.420.sroa.4.0.copyload.i)
          to label %common.resume unwind label %bb.l, !noalias !12752, !inline_history !12747

_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtNtCsbYyEjVLvvus_5tonic5codec6decode5StateECsgsNUVCRJO2f_13influxdb3_lib.exit.i: ; preds = %bb.j, %bb.i, %bb.h
  store i8 0, ptr %i.e, align 8, !alias.scope !12753, !noalias !12752
  store ptr %i.ah, ptr %.sroa.8, align 8, !alias.scope !12752, !noalias !12753
...
bb.l:                                             ; preds = %bb.k
  %i.ao = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCs4NRVxsYgnAr_4core9panicking16panic_in_cleanup() #45, !noalias !12752
  unreachable
...
_RNvMs1_NtNtCsbYyEjVLvvus_5tonic5codec6decodeINtB5_9StreamingNtNtCsekDO8Mha3LU_12arrow_flight3gen8CriteriaE12decode_chunkCsgsNUVCRJO2f_13influxdb3_lib.exit: ; preds = %bb.g, %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtNtCsbYyEjVLvvus_5tonic5codec6decode5StateECsgsNUVCRJO2f_13influxdb3_lib.exit.i
  ...
  %.sink.i.sroa.phi = phi ptr [ %.sroa.8, %bb.g ], [ %.sroa.17, %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtNtCsbYyEjVLvvus_5tonic5codec6decode5StateECsgsNUVCRJO2f_13influxdb3_lib.exit.i ]
  %.sroa.420.sroa.5.0.copyload.sink.i = phi ptr [ null, %bb.g ], [ %.sroa.420.sroa.5.0.copyload.i, %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueNtNtNtCsbYyEjVLvvus_5tonic5codec6decode5StateECsgsNUVCRJO2f_13influxdb3_lib.exit.i ]
  store ptr %.sroa.420.sroa.5.0.copyload.sink.i, ptr %.sink.i.sroa.phi, align 8, !alias.scope !12752, !noalias !12753
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !12754
  %.sroa.8.0..sroa.8.0..sroa.8.0..sroa.8.8..sroa.034.0.copyload.pr = load ptr, ptr %.sroa.8, align 8 ; 2 uses
  %.sroa.17.0..sroa.17.0..sroa.17.0..sroa.17.16.copyload = load ptr, ptr %.sroa.17, align 8
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.8)
...
bb.v:                                             ; preds = %bb.t
  %i.at = load i8, ptr %i.e, align 8, !range !24, !alias.scope !12758, !noundef !17
  %switch.i = icmp samesign ult i8 %i.at, 2
  br i1 %switch.i, label %.thread, label %bb.w

bb.w:                                             ; preds = %bb.v
  %i.au = load ptr, ptr %i.n, align 8, !alias.scope !12759, !align !23, !noundef !17
  %i.av = icmp eq ptr %i.au, null
  br i1 %i.av, label %.thread, label %bb.x
...
_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtNtNtCshxQpDNzqVNo_7dashmap6mapref8multiple8RefMultiNtNtB4_3any6TypeIdINtNtCscdodAO9FK5_5alloc5boxed3BoxDNtB1v_3AnyNtNtB4_6marker4SendNtB2w_4SyncEL_EEECsgsNUVCRJO2f_13influxdb3_lib.exit: ; preds = %bb.k, %bb.l, %bb.e
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !12792)
  call void @llvm.experimental.noalias.scope.decl(metadata !12793)
  %i.g = load ptr, ptr %.sroa.5.0..sroa_idx, align 8, !alias.scope !12794, !noundef !17 ; 2 uses
...
bb.c:                                             ; preds = %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtNtNtCshxQpDNzqVNo_7dashmap6mapref8multiple8RefMultiNtNtB4_3any6TypeIdINtNtCscdodAO9FK5_5alloc5boxed3BoxDNtB1v_3AnyNtNtB4_6marker4SendNtB2w_4SyncEL_EEECsgsNUVCRJO2f_13influxdb3_lib.exit
  %i.i = atomicrmw sub ptr %i.g, i64 1 release, align 8, !noalias !12795
...
bb.f:                                             ; preds = %bb.b
  %i.l = load ptr, ptr %i.b, align 8, !noundef !17
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.m = load ptr, ptr %i.e, align 8, !noundef !17
  %i.n = load ptr, ptr %i.f, align 8, !noundef !17
...
bb.h:                                             ; preds = %bb.f
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !12797)
  %i.p = load ptr, ptr %.sroa.5.0..sroa_idx, align 8, !alias.scope !12798, !noundef !17 ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  %i.r = atomicrmw sub ptr %i.p, i64 1 release, align 8, !noalias !12799
...
bb.k:                                             ; preds = %bb.g
  ...
  %i.v = load ptr, ptr %i.a, align 8, !alias.scope !12803, !nonnull !17, !noundef !17
  %i.w = atomicrmw sub ptr %i.v, i64 1 release, align 8, !noalias !12803
...
bb.l:                                             ; preds = %bb.k
  ...
  invoke void @_RNvMsn_NtCscdodAO9FK5_5alloc4syncINtB5_3ArcINtNtCs6gU0GsN6MoR_8lock_api6rwlock15RwLockReadGuardNtNtCshxQpDNzqVNo_7dashmap4lock9RawRwLockINtNtNtCsc96bKABWO34_9hashbrown3raw5inner8RawTableTNtNtCs4NRVxsYgnAr_4core3any6TypeIdINtNtB1z_4util11SharedValueINtNtB7_5boxed3BoxDNtB31_3AnyNtNtB33_6marker4SendNtB4t_4SyncEL_EEEEEE9drop_slowCs43kcu4yvms7_24influxdb3_query_executor(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.a)
          to label %_RINvNtCs4NRVxsYgnAr_4core3ptr9drop_glueINtNtNtCshxQpDNzqVNo_7dashmap6mapref8multiple8RefMultiNtNtB4_3any6TypeIdINtNtCscdodAO9FK5_5alloc5boxed3BoxDNtB1v_3AnyNtNtB4_6marker4SendNtB2w_4SyncEL_EEECsgsNUVCRJO2f_13influxdb3_lib.exit unwind label %bb.o
