begin_hunk_0
  ...
  %.fr = freeze <4 x double> %14                  ; [#uses=1 type=<4 x double>]
  %15 = fcmp une <4 x double> %.fr, <double 1.000000e+00, double 0.000000e+00, double 1.000000e+00, double 0.000000e+00> ; [#uses=1 type=<4 x i1>]
  ...
  %.fr22 = freeze double %20                      ; [#uses=1 type=double]
  %21 = fdiv double 1.000000e+00, %.fr22          ; [#uses=3 type=double]
...
begin_hunk_1
  ...
  %op.rdx = or i1 %28, %25                        ; [#uses=1 type=i1]
