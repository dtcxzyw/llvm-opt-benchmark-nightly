Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/slurm/original/launch_state?download=true
inline.NumInlined: 3
inline.NumDeleted: 1
...
.critedge:                                        ; preds = %bb.d, %._crit_edge
  %i.n = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull @job_state_mutex) #7 ; 2 uses
  %.not18 = icmp eq i32 %i.n, 0
  br i1 %.not18, label %bb.f, label %bb.e

bb.e:                                             ; preds = %.critedge
  %i.o = tail call ptr @__errno_location() #8
