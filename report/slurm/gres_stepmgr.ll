Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/slurm/original/gres_stepmgr?download=true
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %..164 = select i1 %.not80, i1 true, i1 %.164
  br label %bb.o
...
bb.af:                                            ; preds = %bb.b, %bb.a, %.loopexit
  %.037 = phi i64 [ %.3, %.loopexit ], [ -2, %bb.a ], [ 0, %bb.b ]
...
bb.c:                                             ; preds = %bb.b
  ...
  %.not52265 = icmp eq ptr %i.y, null
  br i1 %.not52265, label %._crit_edge268, label %.lr.ph267
...
bb.g:                                             ; preds = %bb.e, %bb.f
  ...
  %.not270 = icmp eq i32 %i.az, 0
  br i1 %.not270, label %.preheader80, label %.lr.ph

.preheader80:                                     ; preds = %.lr.ph, %bb.g
...
.preheader.lr.ph.split:                           ; preds = %.preheader80
...
bb.h:                                             ; preds = %.split.us.us.us
  ...
  %.pre284 = load ptr, ptr %i.a, align 8
  %.phi.trans.insert285 = getelementptr inbounds [4 x i8], ptr %.pre284, i64 %i.ck
  %.pre286 = load i32, ptr %.phi.trans.insert285, align 4
  br label %bb.i
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.bn = sub nsw i32 %.144.ph212.us.us, %i.bm
  br label %bb.l

bb.k:                                             ; preds = %bb.i
  %spec.select.us.us = call i32 @llvm.smax.i32(i32 %i.bi, i32 %.0.ph214.us.us)
  br label %bb.l

bb.l:                                             ; preds = %bb.k, %bb.j
  %.245.us.us = phi i32 [ %i.bn, %bb.j ], [ %.144.ph212.us.us, %bb.k ] ; 2 uses
  %.1.us.us = phi i32 [ %.0.ph214.us.us, %bb.j ], [ %spec.select.us.us, %bb.k ]
  %i.bo = icmp slt i32 %.245.us.us, 1
  br i1 %i.bo, label %bb.m, label %.lr.ph87.us.us.backedge

bb.m:                                             ; preds = %bb.l
  %i.bp = load ptr, ptr %i.b, align 8
  %i.bq = call i32 @bit_set_count(ptr noundef %i.bp) #7
  %.not59.us.us = icmp slt i32 %i.bq, %3
  br i1 %.not59.us.us, label %.lr.ph87.us.us.backedge, label %._crit_edge.sink.split

.lr.ph87.us.us.backedge:                          ; preds = %bb.m, %bb.l
  br label %.lr.ph87.us.us, !llvm.loop !62

bb.n:                                             ; preds = %.backedge, %.lr.ph87.us.us
  %.07086.us.us.us = phi i32 [ %.070.ph211.us.us, %.lr.ph87.us.us ], [ %i.ce, %.backedge ] ; 2 uses
  %.07485.us.us.us = phi i32 [ %.074.ph210.us.us, %.lr.ph87.us.us ], [ %.175.us.us221.us, %.backedge ]
  %.pn.pn273 = load ptr, ptr %i.c, align 8
  %.in272 = getelementptr inbounds nuw i8, ptr %.pn.pn273, i64 92
  %i.br = load i32, ptr %.in272, align 4
  %i.bs = icmp eq i32 %.07086.us.us.us, -1
  br i1 %i.bs, label %.critedge.i.us.us220.us, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.bt = add nsw i32 %.07485.us.us.us, 1
  %i.bu = srem i32 %i.bt, %i.v                    ; 3 uses
  %i.bv = icmp eq i32 %i.bu, 0
  br i1 %i.bv, label %_gres_next_node_inx.exit.thread.us259, label %bb.p
...
.critedge.i.us.us220.us:                          ; preds = %bb.n
...
bb.r:                                             ; preds = %bb.q
  %i.cd = add nsw i32 %.07086.us.us.us, 1
  %i.ce = srem i32 %i.cd, %i.br                   ; 4 uses
  %i.cf = zext nneg i32 %.175.us.us221.us to i64  ; 3 uses
  %i.cg = call i32 @slurm_bit_test(ptr noundef %2, i64 noundef %i.cf) #7
  %.not56.us.us223.us = icmp eq i32 %i.cg, 0
  br i1 %.not56.us.us223.us, label %.backedge, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.ch = load ptr, ptr %i.b, align 8
  %i.ci = call i32 @slurm_bit_test(ptr noundef %i.ch, i64 noundef %i.cf) #7
  %.not57.us.us224.us = icmp eq i32 %i.ci, 0
  br i1 %.not57.us.us224.us, label %.split.us.us.us, label %.backedge
...
bb.t:                                             ; preds = %.backedge319, %.lr.ph87
  %.07086 = phi i32 [ %.070.ph211, %.lr.ph87 ], [ %i.di, %.backedge319 ] ; 2 uses
  %.07485 = phi i32 [ %.074.ph210, %.lr.ph87 ], [ %.175, %.backedge319 ]
  %.pn.pn = load ptr, ptr %i.c, align 8
  %.in271 = getelementptr inbounds nuw i8, ptr %.pn.pn, i64 92
  %i.ct = load i32, ptr %.in271, align 4
  %i.cu = icmp eq i32 %.07086, -1
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %i.ed = sub nsw i32 %.144.ph212, %i.ec
  br label %bb.ad

bb.ac:                                            ; preds = %bb.aa
  %spec.select = call i32 @llvm.smax.i32(i32 %i.dy, i32 %.0.ph214)
  br label %bb.ad

bb.ad:                                            ; preds = %bb.ac, %bb.ab
  %.245 = phi i32 [ %i.ed, %bb.ab ], [ %.144.ph212, %bb.ac ] ; 2 uses
  %.1 = phi i32 [ %.0.ph214, %bb.ab ], [ %spec.select, %bb.ac ]
  %i.ee = icmp slt i32 %.245, 1
  br i1 %i.ee, label %bb.ae, label %.lr.ph87.backedge

bb.ae:                                            ; preds = %bb.ad
  %i.ef = load ptr, ptr %i.b, align 8
  %i.eg = call i32 @bit_set_count(ptr noundef %i.ef) #7
  %.not59 = icmp slt i32 %i.eg, %3
  br i1 %.not59, label %.lr.ph87.backedge, label %._crit_edge.sink.split

.lr.ph87.backedge:                                ; preds = %bb.ae, %bb.ad
...
bb.ah:                                            ; preds = %bb.d, %bb.ag
  ...
  br i1 %.not52, label %._crit_edge268, label %bb.d

._crit_edge268:                                   ; preds = %bb.ah, %bb.c
  call void @list_iterator_destroy(ptr noundef %i.x) #7
  br label %bb.ai

bb.ai:                                            ; preds = %bb.b, %bb.a, %._crit_edge268
