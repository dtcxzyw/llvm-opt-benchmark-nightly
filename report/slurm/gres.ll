...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not41, label %bb.aa, label %bb.c
...
bb.f:                                             ; preds = %.lr.ph60, %.backedge
  %i.z = phi ptr [ %i.n, %.lr.ph60 ], [ %i.cy, %.backedge ] ; 10 uses
...
bb.q:                                             ; preds = %bb.o, %bb.n
  ...
  br i1 %.not1822.i, label %_init_gres_device.exit.thread52, label %.lr.ph.i
...
.lr.ph.i:                                         ; preds = %bb.q
  ...
  %.not19.i57 = icmp eq i16 %i.cf, 0
  br i1 %.not19.i57, label %_init_gres_device.exit.thread52, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %.lr.ph.i
  %exitcond.not.i67 = icmp eq i64 %wide.trip.count.i, 2
  br i1 %exitcond.not.i67, label %._crit_edge.thread.i, label %.lr.ph69, !llvm.loop !29

.lr.ph69:                                         ; preds = %.lr.ph.preheader
  br label %bb.r, !llvm.loop !29

.lr.ph:                                           ; preds = %bb.r
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.next.i68, 1 ; 2 uses
...
._crit_edge.i:                                    ; preds = %bb.r
  ...
  br i1 %i.co, label %._crit_edge.thread.i, label %_init_gres_device.exit.thread52
...
_init_gres_device.exit.thread52:                  ; preds = %._crit_edge.thread.i, %._crit_edge.i, %.lr.ph.i, %bb.q
...
bb.s:                                             ; preds = %_init_gres_device.exit.thread52
  store i32 %storemerge.i.sink, ptr %i.u, align 4
  br label %.thread

.thread:                                          ; preds = %_init_gres_device.exit.thread52, %bb.s
...
.backedge:                                        ; preds = %bb.u, %bb.y, %_init_gres_device.exit.thread
  ...
  %.not44 = icmp eq ptr %i.cy, null
  br i1 %.not44, label %._crit_edge, label %bb.f, !llvm.loop !31
...
._crit_edge:                                      ; preds = %.backedge, %.preheader
  ...
  br i1 %.not45, label %bb.aa, label %bb.z
...
bb.bj:                                            ; preds = %bb.al
  %i.hf = call i32 @xstrncasecmp(ptr noundef nonnull %.088, ptr noundef nonnull @.str.348, i64 noundef 4) #26
...
bb.bl:                                            ; preds = %bb.bk, %bb.bi, %gres_use_local_device_index.exit, %_get_shared_gres_per_task.exit, %bb.o, %bb.s, %bb.z, %bb.y, %bb.ak, %bb.ai, %bb.ah, %bb.ab, %bb.ac, %bb.ad, %bb.u, %bb.q
  %.087 = phi ptr [ %i.hg, %bb.bk ], [ %i.cf, %_get_shared_gres_per_task.exit ], [ %i.cf, %bb.bi ], [ %i.cf, %gres_use_local_device_index.exit ], [ %i.bz, %bb.ak ], [ %i.bx, %bb.ai ], [ %i.br, %bb.ah ], [ %i.bm, %bb.ab ], [ %i.bm, %bb.ad ], [ %i.bm, %bb.ac ], [ %i.bd, %bb.z ], [ %i.az, %bb.y ], [ %i.av, %bb.u ], [ %i.as, %bb.s ], [ %i.ap, %bb.q ], [ %i.am, %bb.o ] ; 4 uses
  %.not108 = icmp eq ptr %.087, null
  br i1 %.not108, label %bb.bt, label %bb.bm

bb.bm:                                            ; preds = %bb.bl
  %i.hh = call i32 @bit_set_count(ptr noundef nonnull %.087) #26
...
.sink.split:                                      ; preds = %gres_use_local_device_index.exit115, %gres_use_local_device_index.exit115.thread, %bb.bs
  ...
  call void @bit_set(ptr noundef nonnull %.087, i64 noundef %.sink) #26
  br label %bb.bt

bb.bt:                                            ; preds = %.sink.split, %bb.bm, %bb.bl
  store ptr %.087, ptr %3, align 8
  br label %bb.bu

bb.bu:                                            ; preds = %bb.bj, %bb.aj, %bb.h, %bb.a, %bb.bt, %bb.c
  %.0 = phi i32 [ 0, %bb.a ], [ -1, %bb.aj ], [ 0, %bb.bt ], [ 0, %bb.h ], [ 0, %bb.c ], [ -1, %bb.bj ]
