...
.preheader.i.preheader:                           ; preds = %.lr.ph.i
  ...
  br i1 %exitcond45.not.i96, label %_get_segment_start.exit, label %.lr.ph102

.preheader.i:                                     ; preds = %.lr.ph102
  %exitcond45.not.i = icmp eq i64 %indvars.iv.next42.i, %wide.trip.count44.i
  br i1 %exitcond45.not.i, label %_get_segment_start.exit, label %.lr.ph102, !llvm.loop !16

.lr.ph102:                                        ; preds = %.preheader.i.preheader, %.preheader.i
  %indvars.iv.next42.i101 = phi i64 [ %indvars.iv.next42.i, %.preheader.i ], [ %indvars.iv.i, %.preheader.i.preheader ]
  %indvars.iv.next42.i = add nuw nsw i64 %indvars.iv.next42.i101, 1 ; 4 uses
...
_get_segment_start.exit:                          ; preds = %bb.g, %.preheader.i, %.preheader.i.preheader, %bb.d, %bb.e, %bb.f, %.loopexit.loopexit.split.loop.exit46.i
  %.124.i = phi i16 [ 0, %bb.d ], [ 0, %bb.e ], [ 0, %bb.f ], [ 0, %.preheader.i.preheader ], [ %i.al, %.loopexit.loopexit.split.loop.exit46.i ], [ 0, %.preheader.i ], [ 0, %bb.g ]
...
bb.h:                                             ; preds = %.lr.ph72, %.loopexit
  %.04270 = phi i32 [ 0, %.lr.ph72 ], [ %i.cb, %.loopexit ] ; 2 uses
  %i.aq = load i32, ptr %i.f, align 8
  %i.ar = icmp sgt i32 %i.aq, 0
  br i1 %i.ar, label %.lr.ph68.preheader, label %.loopexit
...
.lr.ph68:                                         ; preds = %.lr.ph68.preheader, %.critedge
  %.066 = phi i32 [ %i.bx, %.critedge ], [ 0, %.lr.ph68.preheader ] ; 2 uses
  %.03965 = phi ptr [ %i.by, %.critedge ], [ %i.as, %.lr.ph68.preheader ] ; 5 uses
  %i.at = load i32, ptr %i.b, align 4             ; 2 uses
  %i.au = getelementptr inbounds nuw i8, ptr %.03965, i64 72
...
.preheader.i51:                                   ; preds = %.lr.ph68
  %i.ay = getelementptr inbounds nuw i8, ptr %.03965, i64 80
...
.lr.ph.i52:                                       ; preds = %.preheader.i51
  %i.ba = getelementptr inbounds nuw i8, ptr %.03965, i64 8
...
.critedge:                                        ; preds = %bb.j, %.preheader.i51, %.lr.ph68, %_get_ring_pos.exit
  ...
  %i.by = getelementptr inbounds nuw i8, ptr %.03965, i64 104
  %i.bz = load i32, ptr %i.f, align 8
  %i.ca = icmp slt i32 %i.bx, %i.bz
  br i1 %i.ca, label %.lr.ph68, label %.loopexit, !llvm.loop !20

.loopexit:                                        ; preds = %.critedge, %bb.h, %bb.k
  %i.cb = add i32 %.04270, 1
