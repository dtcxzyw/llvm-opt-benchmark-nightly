...
bb.a:
  ...
  %.not199.a = icmp eq ptr %1, null
  br i1 %.not199.a, label %bb.p, label %bb.b
...
.thread:                                          ; preds = %bb.b, %bb.d, %bb.c
  %.0185208 = phi ptr [ %i.g, %bb.c ], [ %i.g, %bb.d ], [ null, %bb.b ]
  %i.n = tail call i32 (ptr, ...) @slurm_error(ptr noundef nonnull @.str.2, ptr noundef %.0185208) #8 ; 0 uses
  br label %.critedge
...
.loopexit:                                        ; preds = %bb.f, %bb.e
  %.not204 = icmp eq i64 %i.h, 0
  br i1 %.not204, label %bb.h, label %bb.g
...
bb.i:                                             ; preds = %ring_record_get_ring_inx.exit
  ...
  %.not202.a = icmp eq i32 %i.ap, 0
  br i1 %.not202.a, label %bb.j, label %._crit_edge245.a

._crit_edge245.a:                                 ; preds = %bb.i
  %.pre = load ptr, ptr %i.t, align 8             ; 2 uses
  %.phi.trans.insert = getelementptr inbounds nuw [104 x i8], ptr %.pre, i64 %i.af
  %.phi.trans.insert246 = getelementptr inbounds nuw i8, ptr %.phi.trans.insert, i64 80
  %.pre247 = load i16, ptr %.phi.trans.insert246, align 8
  br label %bb.k
...
bb.k:                                             ; preds = %._crit_edge245.a, %ring_record_get_ring_inx.exit
  %i.ar = phi i16 [ %.pre247, %._crit_edge245.a ], [ %i.ai, %ring_record_get_ring_inx.exit ]
  %i.as = phi ptr [ %.pre, %._crit_edge245.a ], [ %i.ae, %ring_record_get_ring_inx.exit ]
...
bb.m:                                             ; preds = %bb.l
  ...
  %.not203 = icmp eq i32 %i.bd, 0
  br i1 %.not203, label %bb.o, label %._crit_edge248

._crit_edge248:                                   ; preds = %bb.m
  %.pre249.a = load ptr, ptr %i.t, align 8
  %.phi.trans.insert250 = getelementptr inbounds nuw [104 x i8], ptr %.pre249.a, i64 %i.af
  %.phi.trans.insert251 = getelementptr inbounds nuw i8, ptr %.phi.trans.insert250, i64 80
  %.pre252 = load i16, ptr %.phi.trans.insert251, align 8
  %.pre254 = zext i16 %.pre252 to i32
  br label %bb.n

bb.n:                                             ; preds = %._crit_edge248, %bb.k
  %.pre-phi = phi i32 [ %.pre254, %._crit_edge248 ], [ %i.au, %bb.k ]
...
bb.p:                                             ; preds = %bb.o, %bb.a
  ...
  br i1 %i.bn, label %.lr.ph231, label %.critedge234
...
._crit_edge232:                                   ; preds = %bb.aw
  br i1 %.2177, label %bb.ax, label %.critedge234

bb.q:                                             ; preds = %.lr.ph231, %bb.aw
  %indvars.iv243 = phi i64 [ 0, %.lr.ph231 ], [ %indvars.iv.next244, %bb.aw ] ; 4 uses
  %.0175229 = phi i1 [ false, %.lr.ph231 ], [ %.2177, %bb.aw ] ; 3 uses
  %.0179228 = phi i16 [ undef, %.lr.ph231 ], [ %.4, %bb.aw ] ; 6 uses
  %i.br = load ptr, ptr %i.bo, align 8
  %i.bs = getelementptr inbounds nuw [104 x i8], ptr %i.br, i64 %indvars.iv243 ; 13 uses
  ...
  %i.bz = icmp eq i64 %.2174, %indvars.iv243      ; 3 uses
...
._crit_edge:                                      ; preds = %bb.z, %bb.u
  %.1180.lcssa = phi i16 [ %.0179228, %bb.u ], [ %.2181, %bb.z ]
...
bb.v:                                             ; preds = %.lr.ph, %bb.z
  ...
  %.1180213 = phi i16 [ %.0179228, %.lr.ph ], [ %.2181, %bb.z ] ; 2 uses
  %.0183212 = phi i1 [ false, %.lr.ph ], [ %.1184, %bb.z ]
...
bb.x:                                             ; preds = %bb.v
  br i1 %.0183212, label %bb.y, label %bb.z
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.cw = zext i16 %.1180213 to i32
  store i32 %i.cw, ptr %i.ct, align 4
  br label %bb.z

bb.z:                                             ; preds = %bb.x, %bb.y, %bb.w
  %.1184 = phi i1 [ true, %bb.w ], [ true, %bb.y ], [ false, %bb.x ]
  %.2181 = phi i16 [ %i.cr, %bb.w ], [ %i.cv, %bb.y ], [ %.1180213, %bb.x ] ; 2 uses
...
bb.ad:                                            ; preds = %bb.ac, %bb.ab
  ...
  %.not237 = icmp eq i16 %i.dt, 0
  br i1 %.not237, label %._crit_edge226, label %.lr.ph225

.lr.ph225:                                        ; preds = %bb.ad
  %i.du = getelementptr inbounds nuw i8, ptr %i.bs, i64 8
  br label %bb.ae

._crit_edge226:                                   ; preds = %bb.ai, %bb.ad
...
bb.ae:                                            ; preds = %.lr.ph225, %bb.ai
  %i.dy = phi i16 [ %i.dt, %.lr.ph225 ], [ %i.el, %bb.ai ]
  %indvars.iv241 = phi i64 [ 0, %.lr.ph225 ], [ %indvars.iv.next242, %bb.ai ] ; 2 uses
  %.0170222 = phi i1 [ false, %.lr.ph225 ], [ %.1171, %bb.ai ] ; 2 uses
  %i.dz = getelementptr inbounds nuw [4 x i8], ptr %i.du, i64 %indvars.iv241 ; 2 uses
...
bb.af:                                            ; preds = %bb.ae
  br i1 %.0170222, label %bb.ag, label %bb.ah
...
bb.ah:                                            ; preds = %bb.af, %bb.ag
  ...
  %.pre253 = load i16, ptr %i.ds, align 8
  br label %bb.ai

bb.ai:                                            ; preds = %bb.ae, %bb.ah
  %i.el = phi i16 [ %.pre253, %bb.ah ], [ %i.dy, %bb.ae ] ; 2 uses
  %.1171 = phi i1 [ %.0170222, %bb.ah ], [ true, %bb.ae ]
  %indvars.iv.next242 = add nuw nsw i64 %indvars.iv241, 1 ; 2 uses
  %i.em = zext i16 %i.el to i64
  %i.en = icmp samesign ult i64 %indvars.iv.next242, %i.em
  br i1 %i.en, label %bb.ae, label %._crit_edge226, !llvm.loop !12
...
bb.an:                                            ; preds = %.lr.ph220, %bb.au
  %indvars.iv239 = phi i64 [ 0, %.lr.ph220 ], [ %indvars.iv.next240, %bb.au ] ; 3 uses
  %.0158217 = phi i16 [ 16, %.lr.ph220 ], [ %.3275, %bb.au ] ; 2 uses
  %.0160216 = phi i8 [ 0, %.lr.ph220 ], [ %.2162274, %bb.au ] ; 3 uses
  %.0163215 = phi i1 [ false, %.lr.ph220 ], [ %.2165273, %bb.au ] ; 5 uses
  %i.ey = getelementptr inbounds nuw [4 x i8], ptr %i.ew, i64 %indvars.iv239 ; 4 uses
  %i.ez = load i32, ptr %i.ey, align 4            ; 3 uses
  %i.fa = trunc i32 %i.ez to i16                  ; 2 uses
  br i1 %.0163215, label %bb.ao, label %bb.ap

bb.ao:                                            ; preds = %bb.an
  %i.fb = zext i16 %.0158217 to i32               ; 2 uses
  store i32 %i.fb, ptr %i.ey, align 4
  br label %bb.ap

bb.ap:                                            ; preds = %bb.ao, %bb.an
  %i.fc = phi i32 [ %i.fb, %bb.ao ], [ %i.ez, %bb.an ]
  %.1159 = phi i16 [ %i.fa, %bb.ao ], [ %.0158217, %bb.an ] ; 3 uses
  %i.fd = and i32 %i.ez, 65535
  %i.fe = load i32, ptr %i.bi, align 8            ; 2 uses
  %i.ff = icmp eq i32 %i.fd, %i.fe
  %i.fg = icmp eq i64 %indvars.iv239, %i.bq       ; 3 uses
  br i1 %i.ff, label %bb.aq, label %bb.ar

bb.aq:                                            ; preds = %bb.ap
  %spec.select = and i1 %i.fg, %.0163215
  %i.fh = or i1 %.0163215, %i.fg
  %spec.select210 = select i1 %i.fh, i8 %.0160216, i8 1
  br label %bb.as

bb.ar:                                            ; preds = %bb.ap
  br i1 %i.fg, label %.thread269, label %bb.as

.thread269:                                       ; preds = %bb.ar
  %i.fi = trunc nuw i8 %.0160216 to i1            ; 2 uses
  %not. = xor i1 %i.fi, true
  %.0163. = or i1 %.0163215, %not.
  %.1159. = select i1 %i.fi, i16 %.1159, i16 %i.fa
  br label %.sink.split

bb.as:                                            ; preds = %bb.aq, %bb.ar
  %.2165 = phi i1 [ %spec.select, %bb.aq ], [ %.0163215, %bb.ar ] ; 2 uses
  %.2162 = phi i8 [ %spec.select210, %bb.aq ], [ %.0160216, %bb.ar ]
  %i.fj = trunc nuw i8 %.2162 to i1
...
.sink.split:                                      ; preds = %bb.at, %.thread269
  %.sink = phi i32 [ %i.fe, %.thread269 ], [ %i.fl, %bb.at ] ; 2 uses
  %.3275.ph = phi i16 [ %.1159., %.thread269 ], [ %.1159, %bb.at ]
  %.2162274.ph = phi i8 [ 0, %.thread269 ], [ 1, %bb.at ]
  %.2165273.ph = phi i1 [ %.0163., %.thread269 ], [ %.2165, %bb.at ]
  store i32 %.sink, ptr %i.ey, align 4
  br label %bb.au

bb.au:                                            ; preds = %.sink.split, %bb.as
  %.3275 = phi i16 [ %.1159, %bb.as ], [ %.3275.ph, %.sink.split ]
  %.2162274 = phi i8 [ 0, %bb.as ], [ %.2162274.ph, %.sink.split ]
  %.2165273 = phi i1 [ %.2165, %bb.as ], [ %.2165273.ph, %.sink.split ]
  ...
  %i.fw = icmp samesign ult i64 %indvars.iv.next240, %i.fv
  br i1 %i.fw, label %bb.an, label %._crit_edge221, !llvm.loop !13

bb.av:                                            ; preds = %._crit_edge226, %._crit_edge221, %bb.aj, %._crit_edge
  %.3182 = phi i16 [ %.0179228, %._crit_edge226 ], [ %.0179228, %._crit_edge221 ], [ %.0179228, %bb.aj ], [ %.1180.lcssa, %._crit_edge ]
  %.1176 = phi i1 [ %.0175229, %._crit_edge226 ], [ true, %._crit_edge221 ], [ %.0175229, %bb.aj ], [ true, %._crit_edge ]
  %i.fx = trunc nuw nsw i64 %indvars.iv243 to i32
...
bb.aw:                                            ; preds = %bb.q, %bb.av
  ...
  %.2177 = phi i1 [ %.1176, %bb.av ], [ %.0175229, %bb.q ] ; 2 uses
  %indvars.iv.next244 = add nuw nsw i64 %indvars.iv243, 1 ; 2 uses
  %i.fy = load i32, ptr %i.bl, align 8
  %i.fz = sext i32 %i.fy to i64
  %i.ga = icmp slt i64 %indvars.iv.next244, %i.fz
  br i1 %i.ga, label %bb.q, label %._crit_edge232, !llvm.loop !14

bb.ax:                                            ; preds = %._crit_edge232
...
.critedge234:                                     ; preds = %bb.p, %bb.ax, %._crit_edge232
...
bb.ay:                                            ; preds = %.critedge, %.critedge234
  %.1 = phi i32 [ 0, %.critedge234 ], [ -1, %.critedge ]
