inline.NumInlined: 6
inline.NumDeleted: 2
begin_hunk_0_@topology_p_build_config:bb.a
...
._crit_edge:                                      ; preds = %_get_segment_start.exit, %bb.c
  ...
  %.not4869 = icmp eq ptr %i.m, null
  br i1 %.not4869, label %._crit_edge73, label %.lr.ph72
...
.lr.ph.i:                                         ; preds = %bb.f, %bb.g
  ...
  br i1 %.not29.i, label %.preheader.i.preheader, label %bb.g

.preheader.i.preheader:                           ; preds = %.lr.ph.i
  %i.ah = icmp samesign ult i64 %indvars.iv.next42.i100, %i.w
  br i1 %i.ah, label %.lr.ph102, label %_get_segment_start.exit

.preheader.i:                                     ; preds = %.lr.ph102
  %indvars.iv.next42.i = add nuw nsw i64 %indvars.iv.next42.i101, 1 ; 2 uses
  %i.ai = icmp samesign ult i64 %indvars.iv.next42.i, %i.w
  br i1 %i.ai, label %.lr.ph102, label %_get_segment_start.exit, !llvm.loop !16
...
.lr.ph102:                                        ; preds = %.preheader.i.preheader, %.preheader.i
  ...
  br i1 %.not30.i, label %.preheader.i, label %.loopexit.loopexit.split.loop.exit46.i, !llvm.loop !16
...
.loopexit.loopexit.split.loop.exit46.i:           ; preds = %.lr.ph102
  %i.an = trunc nuw i64 %indvars.iv.next42.i101 to i16
  br label %_get_segment_start.exit

_get_segment_start.exit:                          ; preds = %bb.g, %.preheader.i, %.preheader.i.preheader, %bb.d, %bb.e, %bb.f, %.loopexit.loopexit.split.loop.exit46.i
  %.124.i = phi i16 [ 0, %bb.d ], [ 0, %bb.e ], [ 0, %bb.f ], [ 0, %.preheader.i.preheader ], [ %i.an, %.loopexit.loopexit.split.loop.exit46.i ], [ 0, %.preheader.i ], [ 0, %bb.g ]
  %i.ao = getelementptr inbounds nuw [2 x i8], ptr %i.i, i64 %indvars.iv
  store i16 %.124.i, ptr %i.ao, align 2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.ap = load i32, ptr %i.f, align 8
  %i.aq = sext i32 %i.ap to i64
  %i.ar = icmp slt i64 %indvars.iv.next, %i.aq
  br i1 %i.ar, label %bb.d, label %._crit_edge, !llvm.loop !18
...
bb.h:                                             ; preds = %.lr.ph72, %.loopexit
  %.04370 = phi i32 [ 0, %.lr.ph72 ], [ %i.cd, %.loopexit ] ; 2 uses
  %i.as = load i32, ptr %i.f, align 8
  %i.at = icmp sgt i32 %i.as, 0
  br i1 %i.at, label %.lr.ph68.preheader, label %.loopexit

.lr.ph68.preheader:                               ; preds = %bb.h
  %i.au = load ptr, ptr %i.n, align 8
  br label %.lr.ph68

.lr.ph68:                                         ; preds = %.lr.ph68.preheader, %.critedge
  %.066 = phi i32 [ %i.bz, %.critedge ], [ 0, %.lr.ph68.preheader ] ; 2 uses
  %.03965 = phi ptr [ %i.ca, %.critedge ], [ %i.au, %.lr.ph68.preheader ] ; 5 uses
  %i.av = load i32, ptr %i.b, align 4             ; 2 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %.03965, i64 72
  %i.ax = load ptr, ptr %i.aw, align 8
  %i.ay = sext i32 %i.av to i64
  %i.az = call i32 @slurm_bit_test(ptr noundef %i.ax, i64 noundef %i.ay) #8
  %.not.i50 = icmp eq i32 %i.az, 0
  br i1 %.not.i50, label %.critedge, label %.preheader.i51

.preheader.i51:                                   ; preds = %.lr.ph68
  %i.ba = getelementptr inbounds nuw i8, ptr %.03965, i64 80
  %i.bb = load i16, ptr %i.ba, align 8            ; 4 uses
  %.not15.i = icmp eq i16 %i.bb, 0
  br i1 %.not15.i, label %.critedge, label %.lr.ph.i52

.lr.ph.i52:                                       ; preds = %.preheader.i51
  %i.bc = getelementptr inbounds nuw i8, ptr %.03965, i64 8
  %wide.trip.count.i = zext i16 %i.bb to i64
  br label %bb.i

bb.i:                                             ; preds = %bb.j, %.lr.ph.i52
  %indvars.iv.i53 = phi i64 [ 0, %.lr.ph.i52 ], [ %indvars.iv.next.i54, %bb.j ] ; 3 uses
  %i.bd = getelementptr inbounds nuw [4 x i8], ptr %i.bc, i64 %indvars.iv.i53
  %i.be = load i32, ptr %i.bd, align 4
  %i.bf = icmp eq i32 %i.be, %i.av
  br i1 %i.bf, label %_get_ring_pos.exit, label %bb.j
...
_get_ring_pos.exit:                               ; preds = %bb.i
  %i.bg = trunc i64 %indvars.iv.i53 to i16        ; 2 uses
  %.not49 = icmp eq i16 %i.bg, -1
  br i1 %.not49, label %.critedge, label %bb.k

bb.k:                                             ; preds = %_get_ring_pos.exit
  %i.bh = zext nneg i32 %.066 to i64
  %i.bi = getelementptr inbounds nuw [2 x i8], ptr %i.i, i64 %i.bh
  %i.bj = load i16, ptr %i.bi, align 2
  %i.bk = add i16 %i.bb, %i.bg
  %i.bl = sub i16 %i.bk, %i.bj
  %i.bm = urem i16 %i.bl, %i.bb
  %i.bn = getelementptr inbounds nuw i8, ptr %.03965, i64 96
  %i.bo = load i16, ptr %i.bn, align 8
  %i.bp = zext i16 %i.bo to i32
  %i.bq = shl nuw i32 %i.bp, 16
  %i.br = load ptr, ptr %1, align 8
  %i.bs = zext i32 %.04370 to i64                 ; 2 uses
  %i.bt = getelementptr inbounds nuw [4 x i8], ptr %i.br, i64 %i.bs
  store i32 %i.bq, ptr %i.bt, align 4
  %i.bu = zext i16 %i.bm to i32
  %i.bv = load ptr, ptr %1, align 8
  %i.bw = getelementptr inbounds nuw [4 x i8], ptr %i.bv, i64 %i.bs ; 2 uses
  %i.bx = load i32, ptr %i.bw, align 4
  %i.by = add i32 %i.bx, %i.bu
  store i32 %i.by, ptr %i.bw, align 4
  br label %.loopexit

.critedge:                                        ; preds = %bb.j, %.preheader.i51, %.lr.ph68, %_get_ring_pos.exit
  %i.bz = add nuw nsw i32 %.066, 1                ; 2 uses
  %i.ca = getelementptr inbounds nuw i8, ptr %.03965, i64 104
  %i.cb = load i32, ptr %i.f, align 8
  %i.cc = icmp slt i32 %i.bz, %i.cb
  br i1 %i.cc, label %.lr.ph68, label %.loopexit, !llvm.loop !20

.loopexit:                                        ; preds = %.critedge, %bb.h, %bb.k
  %i.cd = add i32 %.04370, 1
  %i.ce = load i32, ptr %i.b, align 4
  %i.cf = add nsw i32 %i.ce, 1
  store i32 %i.cf, ptr %i.b, align 4
  %i.cg = call ptr @next_node_bitmap(ptr noundef nonnull %0, ptr noundef nonnull %i.b) #8
  %.not48 = icmp eq ptr %i.cg, null
  br i1 %.not48, label %._crit_edge73, label %bb.h, !llvm.loop !21

bb.l:                                             ; preds = %bb.b, %bb.a, %._crit_edge73
