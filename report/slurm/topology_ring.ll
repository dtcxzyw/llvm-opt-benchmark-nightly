...
.preheader.i.preheader:                           ; preds = %.lr.ph.i
  ...
  br i1 %4, label %.lr.ph102, label %_get_segment_start.exit
...
.preheader.i:                                     ; preds = %.lr.ph102
  ...
  br i1 %5, label %.lr.ph102, label %_get_segment_start.exit, !llvm.loop !16
...
.lr.ph102:                                        ; preds = %.preheader.i.preheader, %.preheader.i
  ...
  %i.ah = getelementptr inbounds nuw [4 x i8], ptr %i.s, i64 %indvars.iv.next42.i101
...
.loopexit.loopexit.split.loop.exit46.i:           ; preds = %.lr.ph102
  %i.al = trunc nuw i64 %indvars.iv.next42.i101 to i16
