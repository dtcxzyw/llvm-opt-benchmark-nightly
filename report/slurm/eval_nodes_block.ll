...
begin_hunk_0_@eval_nodes_block:bb.a
  store ptr %i.nb, ptr %i.d, align 8
  br label %bb.cq
...
.lr.ph1205:                                       ; preds = %.lr.ph1205.preheader, %bb.cy
  ...
  br i1 %.not800, label %bb.cr, label %bb.cu
...
.lr.ph1209:                                       ; preds = %bb.cz, %.lr.ph1209
  ...
  br i1 %i.ph, label %.lr.ph1209, label %.loopexit1119.thread, !llvm.loop !12
...
bb.di:                                            ; preds = %bb.de, %bb.da, %bb.dh, %._crit_edge1403, %bb.df
  ...
  br i1 %i.sl, label %.lr.ph1226, label %._crit_edge1227, !llvm.loop !19
