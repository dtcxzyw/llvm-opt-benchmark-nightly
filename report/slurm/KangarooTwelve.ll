...
bb.a:
  ...
  br i1 %.not, label %bb.b, label %.thread112
...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %.not95, label %bb.d, label %.thread112
...
bb.e:                                             ; preds = %bb.d
  ...
  %.not96 = icmp eq i32 %i.w, 0
  br i1 %.not96, label %.thread.thread, label %.critedge
...
bb.f:                                             ; preds = %bb.b
  %.not90 = icmp eq i32 %i.j, 0
  br i1 %.not90, label %.thread, label %bb.g
...
bb.g:                                             ; preds = %bb.f
  ...
  %.not91 = icmp eq i32 %i.ae, 0
  br i1 %.not91, label %bb.h, label %.thread112
...
bb.i:                                             ; preds = %bb.h
  ...
  %.not92 = icmp eq i32 %i.an, 0
  br i1 %.not92, label %bb.j, label %.critedge104

bb.j:                                             ; preds = %bb.i
  %i.ao = call i32 @KeccakWidth1600_12rounds_SpongeSqueeze(ptr noundef nonnull %0, ptr noundef nonnull %i.b, i64 noundef 32) #4
  %.not93 = icmp eq i32 %i.ao, 0
  br i1 %.not93, label %bb.k, label %.critedge104
...
bb.k:                                             ; preds = %bb.j
  ...
  br i1 %.not94, label %.thread, label %.thread112

.critedge104:                                     ; preds = %bb.i, %bb.j
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #4
  br label %.thread112

.thread:                                          ; preds = %bb.d, %bb.k, %bb.h, %bb.f
  %.276 = phi ptr [ %i.ag, %bb.k ], [ %1, %bb.f ], [ %i.ag, %bb.h ], [ %i.q, %bb.d ]
  %.271 = phi i64 [ %i.ah, %bb.k ], [ %2, %bb.f ], [ %i.ah, %bb.h ], [ %i.r, %bb.d ] ; 2 uses
  %.not97121 = icmp eq i64 %.271, 0
  br i1 %.not97121, label %.thread112, label %.lr.ph

.lr.ph:                                           ; preds = %.thread.thread, %.thread
  %.271136 = phi i64 [ %i.r, %.thread.thread ], [ %.271, %.thread ]
  %.276135 = phi ptr [ %i.q, %.thread.thread ], [ %.276, %.thread ]
  %i.ar = getelementptr inbounds nuw i8, ptr %0, i64 448
  %i.as = getelementptr inbounds nuw i8, ptr %0, i64 216
  br label %bb.l

bb.l:                                             ; preds = %.lr.ph, %bb.s
  %.372123 = phi i64 [ %.271136, %.lr.ph ], [ %i.ay, %bb.s ] ; 3 uses
  %.377122 = phi ptr [ %.276135, %.lr.ph ], [ %i.ax, %bb.s ] ; 2 uses
  %i.at = call i64 @llvm.umin.i64(i64 %.372123, i64 8192) ; 4 uses
  ...
  %.not98 = icmp eq i32 %i.av, 0
  br i1 %.not98, label %bb.m, label %.thread112

bb.m:                                             ; preds = %bb.l
  %i.aw = call i32 @KeccakWidth1600_12rounds_SpongeAbsorb(ptr noundef nonnull %0, ptr noundef %.377122, i64 noundef %i.at) #4
  %.not99 = icmp eq i32 %i.aw, 0
  br i1 %.not99, label %bb.n, label %.thread112

bb.n:                                             ; preds = %bb.m
  %i.ax = getelementptr inbounds nuw i8, ptr %.377122, i64 %i.at
  %i.ay = sub i64 %.372123, %i.at                 ; 2 uses
  %i.az = icmp ugt i64 %.372123, 8191
...
bb.o:                                             ; preds = %bb.n
  ...
  br i1 %.not100, label %bb.p, label %.critedge107
...
bb.p:                                             ; preds = %bb.o
  ...
  br i1 %.not101, label %bb.q, label %.critedge107
...
bb.q:                                             ; preds = %bb.p
  ...
  br i1 %.not102, label %bb.s, label %.thread112

bb.r:                                             ; preds = %bb.n
  store i32 %i.au, ptr %i.ar, align 8
  br label %bb.s

.critedge107:                                     ; preds = %bb.o, %bb.p
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #4
  br label %.thread112

bb.s:                                             ; preds = %bb.r, %bb.q
  %.not97 = icmp eq i64 %i.ay, 0
  br i1 %.not97, label %.thread112, label %bb.l

.thread112:                                       ; preds = %bb.s, %bb.q, %bb.l, %bb.m, %.thread, %.critedge107, %.critedge104, %bb.g, %bb.k, %bb.c, %.critedge, %bb.a
  %.11 = phi i32 [ 1, %bb.c ], [ 1, %.critedge104 ], [ 1, %bb.a ], [ 1, %.critedge107 ], [ 1, %.critedge ], [ 1, %bb.k ], [ 1, %bb.g ], [ 0, %.thread ], [ 1, %bb.l ], [ 1, %bb.q ], [ 0, %bb.s ], [ 1, %bb.m ]
  ret i32 %.11
}
...
bb.a:
  ...
  br i1 %.not, label %bb.b, label %.critedge48

bb.b:                                             ; preds = %bb.a
  %.not36 = icmp eq i64 %3, 0
  br i1 %.not36, label %.split, label %bb.c
...
bb.d:                                             ; preds = %right_encode.exit, %.split
  ...
  br i1 %.not38, label %bb.e, label %.critedge48
...
bb.j:                                             ; preds = %._crit_edge, %bb.f
  ...
  %.not23.i49 = icmp eq i64 %i.ai, 0
  br i1 %.not23.i49, label %right_encode.exit62, label %.lr.ph.i50

.lr.ph22.preheader.i53:                           ; preds = %.lr.ph.i50
  %i.aj = add nuw nsw i32 %.01718.i52, 2          ; 2 uses
  %wide.trip.count.i54 = zext nneg i32 %i.aj to i64
  br label %.lr.ph22.i55

.lr.ph.i50:                                       ; preds = %bb.j, %.lr.ph.i50
  %.019.i51 = phi i64 [ %i.al, %.lr.ph.i50 ], [ %i.ai, %bb.j ]
  %.01718.i52 = phi i32 [ %i.ak, %.lr.ph.i50 ], [ 0, %bb.j ] ; 3 uses
  %i.ak = add nuw nsw i32 %.01718.i52, 1          ; 4 uses
  %i.al = lshr i64 %.019.i51, 8                   ; 2 uses
  %i.am = icmp ne i64 %i.al, 0
  %i.an = icmp samesign ult i32 %.01718.i52, 7
  %i.ao = select i1 %i.am, i1 %i.an, i1 false
  br i1 %i.ao, label %.lr.ph.i50, label %.lr.ph22.preheader.i53, !llvm.loop !8

.lr.ph22.i55:                                     ; preds = %.lr.ph22.i55, %.lr.ph22.preheader.i53
  %indvars.iv.i56 = phi i64 [ 1, %.lr.ph22.preheader.i53 ], [ %indvars.iv.next.i57, %.lr.ph22.i55 ] ; 3 uses
  %i.ap = trunc i64 %indvars.iv.i56 to i32
  %i.aq = sub i32 %i.ak, %i.ap
  %i.ar = shl nsw i32 %i.aq, 3
  %i.as = zext nneg i32 %i.ar to i64
  %i.at = lshr i64 %i.ai, %i.as
  %i.au = trunc i64 %i.at to i8
  %i.av = getelementptr i8, ptr %i.a, i64 %indvars.iv.i56
...
right_encode.exit62:                              ; preds = %bb.j, %right_encode.exit62.loopexit
  %.017.lcssa29.i59 = phi i8 [ %i.ay, %right_encode.exit62.loopexit ], [ 0, %bb.j ]
  %.pre-phi26.i60 = phi i32 [ %i.aj, %right_encode.exit62.loopexit ], [ 1, %bb.j ] ; 3 uses
  %.pre-phi.i61 = phi i64 [ %i.ax, %right_encode.exit62.loopexit ], [ 0, %bb.j ]
  %i.az = getelementptr inbounds nuw i8, ptr %i.a, i64 %.pre-phi.i61
  store i8 %.017.lcssa29.i59, ptr %i.az, align 1
  %i.ba = zext nneg i32 %.pre-phi26.i60 to i64
  %i.bb = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.ba
  store i8 -1, ptr %i.bb, align 1
  %i.bc = add nuw nsw i32 %.pre-phi26.i60, 2
  %4 = zext nneg i32 %.pre-phi26.i60 to i64
  ...
  br i1 %.not43, label %bb.k, label %.critedge48

.critedge:                                        ; preds = %bb.g, %bb.h
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #4
  br label %.critedge48

bb.k:                                             ; preds = %bb.e, %right_encode.exit62
  %.131 = phi i8 [ 6, %right_encode.exit62 ], [ 7, %bb.e ]
  %i.bh = getelementptr inbounds nuw i8, ptr %0, i64 216 ; 2 uses
  %i.bi = call i32 @KeccakWidth1600_12rounds_SpongeAbsorbLastFewBits(ptr noundef nonnull %i.bh, i8 noundef zeroext %.131) #4
  %.not44 = icmp eq i32 %i.bi, 0
  br i1 %.not44, label %bb.l, label %.critedge48
...
.critedge48:                                      ; preds = %.critedge, %bb.i, %bb.k, %bb.d, %bb.c, %bb.a, %right_encode.exit62, %bb.n, %bb.m
  %.3 = phi i32 [ 1, %right_encode.exit62 ], [ 1, %bb.a ], [ 1, %bb.c ], [ 1, %bb.k ], [ %i.bl, %bb.m ], [ 0, %bb.n ], [ 1, %bb.d ], [ 1, %bb.i ], [ 1, %.critedge ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #4
  ret i32 %.3
}
