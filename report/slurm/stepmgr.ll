...
begin_hunk_0_@_set_max_num_tasks:bb.a
  %.04459 = phi i32 [ %i.co, %scalar.ph ], [ %.04459.ph, %scalar.ph.preheader ]
  %i.ck = getelementptr inbounds nuw [2 x i8], ptr %i.bz, i64 %indvars.iv71
  %i.cl = load i16, ptr %i.ck, align 2
  %i.cm = zext i16 %i.cl to i32
  %i.cn = sdiv i32 %i.cm, %3
  %i.co = add i32 %i.cn, %.04459                  ; 2 uses
  %indvars.iv.next72 = add nuw nsw i64 %indvars.iv71, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next72, %wide.trip.count
  br i1 %exitcond.not, label %._crit_edge63, label %scalar.ph, !llvm.loop !45
}
