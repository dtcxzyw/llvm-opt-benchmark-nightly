...
begin_hunk_0_@torus3d_record_update_torus_config:bb.a
...
.preheader178.us.i.i:                             ; preds = %.thread167.split.us.split.preheader.i.i, %.thread167.split.us.split.i.loopexit.i
  ...
  br label %.preheader177.us207.i.i

.preheader177.us207.i.i:                          ; preds = %.thread170.us.i.i, %.preheader178.us.i.i
  %indvars.iv250.i.i = phi i64 [ %indvars.iv.next251.i.i, %.thread170.us.i.i ], [ %indvars.iv97.i, %.preheader178.us.i.i ] ; 2 uses
  br label %bb.k

bb.k:                                             ; preds = %bb.m, %.preheader177.us207.i.i
  %indvars.iv244.i.i = phi i64 [ %indvars.iv.next245.i.i, %bb.m ], [ %indvars.iv.i, %.preheader177.us207.i.i ] ; 2 uses
  ...
  br i1 %i.dn, label %.split.us.i.i.loopexit, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.do = call i32 @slurm_bit_test(ptr noundef %i.ae, i64 noundef %i.dk) #10
  %.not148.us.i.i = icmp eq i32 %i.do, 0
  br i1 %.not148.us.i.i, label %bb.m, label %.split.us.i.i.loopexit
...
bb.m:                                             ; preds = %bb.l
  ...
  br i1 %exitcond249.not.i.i, label %.thread170.us.i.i, label %bb.k, !llvm.loop !40

.thread170.us.i.i:                                ; preds = %bb.m
  %indvars.iv.next251.i.i = add nuw nsw i64 %indvars.iv250.i.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next251.i.i, %i.cu
  br i1 %exitcond.not.i, label %.thread167.split.us.split.i.loopexit.i, label %.preheader177.us207.i.i, !llvm.loop !39
...
.split.us.i.i.loopexit:                           ; preds = %bb.k, %bb.l
...
bb.q:                                             ; preds = %bb.q, %.preheader.i.i
  ...
  %lftr.wideiv44.a = trunc i64 %indvars.iv.next269.i.i to i16
  %exitcond45 = icmp eq i16 %lftr.wideiv44.a, %indvars124.i
