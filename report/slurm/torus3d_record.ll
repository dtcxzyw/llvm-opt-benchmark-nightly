...
.thread.i:                                        ; preds = %._crit_edge.i65, %.lr.ph119.i, %bb.ac, %bb.al, %bb.ae, %bb.aa, %bb.w, %.preheader.i63, %._crit_edge139.i, %_build_placement_anchors.exit, %bb.bi, %bb.be, %bb.bc, %_validate_regions_config.exit
  %.079 = phi ptr [ %.1, %bb.bc ], [ %.1, %bb.be ], [ %.1, %bb.bi ], [ %.2, %bb.aa ], [ %.1, %_build_placement_anchors.exit ], [ %.1, %_validate_regions_config.exit ], [ %.1, %._crit_edge139.i ], [ %.1, %.preheader.i63 ], [ %.2, %bb.w ], [ %.2, %bb.ae ], [ %.3, %bb.al ], [ %.2, %bb.ac ], [ %.1, %.lr.ph119.i ], [ %.1, %._crit_edge.i65 ] ; 3 uses
  %.not48 = phi i1 [ false, %bb.bc ], [ false, %bb.be ], [ false, %bb.bi ], [ false, %bb.aa ], [ false, %_build_placement_anchors.exit ], [ true, %_validate_regions_config.exit ], [ true, %._crit_edge139.i ], [ true, %.preheader.i63 ], [ false, %bb.w ], [ false, %bb.ae ], [ false, %bb.al ], [ false, %bb.ac ], [ true, %.lr.ph119.i ], [ true, %._crit_edge.i65 ]
  %.not119.i = icmp eq ptr %.079, null
  br i1 %.not119.i, label %_validate_config.exit, label %bb.cl
