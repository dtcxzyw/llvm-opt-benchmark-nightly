...
bb.t:                                             ; preds = %bb.r
  ...
  br i1 %i.by, label %.lr.ph93.i, label %_validate_regions_config.exit

.lr.ph93.i:                                       ; preds = %bb.t
  %i.bz = getelementptr inbounds nuw i8, ptr %i.ab, i64 48
  br label %bb.u
...
bb.u:                                             ; preds = %._crit_edge.i76, %.lr.ph93.i
  ...
  %i.cb = getelementptr inbounds nuw [24 x i8], ptr %i.ca, i64 %indvars.iv.i70 ; 8 uses
  %i.cc = getelementptr inbounds nuw i8, ptr %i.cb, i64 6 ; 2 uses
  ...
  %i.ci = mul nuw nsw i64 %i.ch, %i.ce
  %i.cj = getelementptr inbounds nuw i8, ptr %i.cb, i64 10
  %i.ck = load i16, ptr %i.cj, align 2            ; 2 uses
  %i.cl = zext i16 %i.ck to i64
  %i.cm = mul nuw nsw i64 %i.ci, %i.cl            ; 3 uses
  %i.cn = zext i16 %i.cd to i32                   ; 2 uses
  %i.co = zext i16 %i.cg to i32                   ; 2 uses
  %i.cp = mul nuw i32 %i.co, %i.cn
  %i.cq = getelementptr inbounds nuw i8, ptr %i.cb, i64 16
  %i.cr = load ptr, ptr %i.cq, align 8            ; 3 uses
  %.not.i71 = icmp eq ptr %i.cr, null
  br i1 %.not.i71, label %bb.w, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.cs = load i8, ptr %i.cr, align 1
  %.not74.i = icmp eq i8 %i.cs, 0
  br i1 %.not74.i, label %bb.w, label %bb.x

bb.w:                                             ; preds = %bb.v, %bb.u
  %i.ct = call i32 (ptr, ...) @error(ptr noundef nonnull @.str.12) #10 ; 0 uses
  br label %.thread.i

bb.x:                                             ; preds = %bb.v
  %i.cu = load i16, ptr %i.cb, align 8
  %i.cv = zext i16 %i.cu to i32
  %i.cw = add nuw nsw i32 %i.cv, %i.cn
  %i.cx = load i16, ptr %i.ab, align 8
  %i.cy = zext i16 %i.cx to i32
  %i.cz = icmp samesign ugt i32 %i.cw, %i.cy
  br i1 %i.cz, label %bb.aa, label %bb.y

bb.y:                                             ; preds = %bb.x
  %i.da = getelementptr inbounds nuw i8, ptr %i.cb, i64 2 ; 2 uses
  %i.db = load i16, ptr %i.da, align 2
  %i.dc = zext i16 %i.db to i32
  %i.dd = add nuw nsw i32 %i.dc, %i.co
  %i.de = load i16, ptr %i.ao, align 2
  %i.df = zext i16 %i.de to i32
  %i.dg = icmp samesign ugt i32 %i.dd, %i.df
  br i1 %i.dg, label %bb.aa, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.dh = getelementptr inbounds nuw i8, ptr %i.cb, i64 4 ; 2 uses
  %i.di = load i16, ptr %i.dh, align 4
  %i.dj = zext i16 %i.di to i32
  %i.dk = zext i16 %i.ck to i32
  %i.dl = add nuw nsw i32 %i.dj, %i.dk
  %i.dm = load i16, ptr %i.aq, align 4
  %i.dn = zext i16 %i.dm to i32
  %i.do = icmp samesign ugt i32 %i.dl, %i.dn
  br i1 %i.do, label %bb.aa, label %bb.ab

bb.aa:                                            ; preds = %bb.z, %bb.y, %bb.x
  %i.dp = call i32 (ptr, ...) @error(ptr noundef nonnull @.str.13) #10 ; 0 uses
  br label %.thread.i

bb.ab:                                            ; preds = %bb.z
  %i.dq = call ptr @hostlist_create(ptr noundef nonnull %i.cr) #10 ; 6 uses
  %.not75.i = icmp eq ptr %i.dq, null
  br i1 %.not75.i, label %bb.ac, label %bb.ad

bb.ac:                                            ; preds = %bb.ab
  %i.dr = call i32 (ptr, ...) @error(ptr noundef nonnull @.str.14) #10 ; 0 uses
  br label %.thread.i

bb.ad:                                            ; preds = %bb.ab
  %i.ds = call i32 @hostlist_count(ptr noundef nonnull %i.dq) #10
  %i.dt = sext i32 %i.ds to i64
  %.not76.i = icmp eq i64 %i.cm, %i.dt
  br i1 %.not76.i, label %.preheader.i72, label %bb.ae

.preheader.i72:                                   ; preds = %bb.ad
  %.not94.i = icmp eq i64 %i.cm, 0
  br i1 %.not94.i, label %._crit_edge.i76, label %.lr.ph.i73

.lr.ph.i73:                                       ; preds = %.preheader.i72
  %i.du = zext i32 %i.cp to i64
  br label %bb.af

bb.ae:                                            ; preds = %bb.ad
  %i.dv = call i32 (ptr, ...) @error(ptr noundef nonnull @.str.15) #10 ; 0 uses
  call void @hostlist_destroy(ptr noundef nonnull %i.dq) #10
  br label %.thread.i

bb.af:                                            ; preds = %bb.am, %.lr.ph.i73
  %.3 = phi ptr [ %.2, %.lr.ph.i73 ], [ %.4, %bb.am ] ; 4 uses
  %.090.i = phi i64 [ 0, %.lr.ph.i73 ], [ %i.fj, %bb.am ] ; 4 uses
  %i.dw = load i16, ptr %i.cc, align 2
  %i.dx = load i16, ptr %i.cf, align 8
  %i.dy = call ptr @hostlist_shift(ptr noundef nonnull %i.dq) #10 ; 4 uses
  %i.dz = call ptr @find_node_record(ptr noundef %i.dy) #10 ; 2 uses
  %.not77.i = icmp eq ptr %i.dz, null
...
bb.ah:                                            ; preds = %bb.ag
  %i.ea = call ptr @hostlist_create(ptr noundef null) #10
  br label %bb.ai

bb.ai:                                            ; preds = %bb.ah, %bb.ag
  %.6 = phi ptr [ %i.ea, %bb.ah ], [ %.3, %bb.ag ] ; 2 uses
  %i.eb = call i32 @hostlist_push_host(ptr noundef %.6, ptr noundef %i.dy) #10 ; 0 uses
  br label %bb.am

bb.aj:                                            ; preds = %bb.af
  %i.ec = udiv i64 %.090.i, %i.du
  %i.ed = trunc i64 %i.ec to i16
  %i.ee = zext i16 %i.dw to i64                   ; 2 uses
  %i.ef = udiv i64 %.090.i, %i.ee
  %i.eg = zext i16 %i.dx to i64
  %i.eh = urem i64 %i.ef, %i.eg
  %i.ei = trunc nuw i64 %i.eh to i16
  %i.ej = urem i64 %.090.i, %i.ee
  %i.ek = trunc nuw i64 %i.ej to i16
  %i.el = load i16, ptr %i.cb, align 8
  %i.em = add i16 %i.el, %i.ek
  %i.en = load i16, ptr %i.da, align 2
  %i.eo = add i16 %i.en, %i.ei
  %i.ep = load i16, ptr %i.dh, align 4
  %i.eq = add i16 %i.ep, %i.ed
  %i.er = zext i16 %i.em to i64
  %i.es = zext i16 %i.eo to i64
  %i.et = load i16, ptr %i.bd, align 8
  %i.eu = zext i16 %i.et to i64
  %i.ev = zext i16 %i.eq to i64
  %i.ew = load i16, ptr %i.bf, align 2
  %i.ex = zext i16 %i.ew to i64
  %i.ey = mul nuw nsw i64 %i.ex, %i.ev
  %reass.add.i.i = add nuw nsw i64 %i.ey, %i.es
  %reass.mul.i.i = mul nuw nsw i64 %reass.add.i.i, %i.eu
  %i.ez = add nuw nsw i64 %reass.mul.i.i, %i.er
  %i.fa = load ptr, ptr %i.bn, align 8
  %i.fb = and i64 %i.ez, 4294967295
  %i.fc = getelementptr inbounds nuw [4 x i8], ptr %i.fa, i64 %i.fb ; 2 uses
  %i.fd = load i32, ptr %i.fc, align 4
  %.not79.i74 = icmp eq i32 %i.fd, -2
  br i1 %.not79.i74, label %bb.ak, label %bb.al

bb.ak:                                            ; preds = %bb.aj
  %i.fe = getelementptr inbounds nuw i8, ptr %i.dz, i64 216
  %i.ff = load i32, ptr %i.fe, align 8            ; 2 uses
  store i32 %i.ff, ptr %i.fc, align 4
  %i.fg = load ptr, ptr %i.br, align 8
  %i.fh = zext i32 %i.ff to i64
  call void @bit_set(ptr noundef %i.fg, i64 noundef %i.fh) #10
  br label %bb.am

bb.al:                                            ; preds = %bb.aj
  %i.fi = call i32 (ptr, ...) @error(ptr noundef nonnull @.str.16) #10 ; 0 uses
...
bb.am:                                            ; preds = %bb.ak, %bb.ai
  ...
  call void @free(ptr noundef %i.dy) #10
  %i.fj = add nuw nsw i64 %.090.i, 1              ; 2 uses
  %exitcond.not.i75 = icmp eq i64 %i.fj, %i.cm
...
._crit_edge.i76:                                  ; preds = %bb.am, %.preheader.i72
  ...
  %i.fk = load i32, ptr %i.bs, align 8
  %i.fl = sext i32 %i.fk to i64
  %i.fm = icmp slt i64 %indvars.iv.next.i77, %i.fl
  br i1 %i.fm, label %bb.u, label %_validate_regions_config.exit, !llvm.loop !12

bb.an:                                            ; preds = %bb.r
  %i.fn = load ptr, ptr %i.ai, align 8            ; 3 uses
  %.not111.i = icmp eq ptr %i.fn, null
...
.lr.ph.i:                                         ; preds = %.preheader.i
  %i.au = trunc nuw i64 %indvars.iv97.i to i16    ; 2 uses
  br label %bb.d
...
._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %.preheader.i
  ...
  %i.bb = phi i16 [ %i.fr, %._crit_edge.loopexit.i ], [ 0, %.preheader.i ]
...
bb.d:                                             ; preds = %bb.r, %.lr.ph.i
  ...
  %i.be = phi i16 [ %i.at, %.lr.ph.i ], [ %i.fr, %bb.r ]
...
bb.h:                                             ; preds = %.loopexit
  tail call void @slurm_bit_free(ptr noundef nonnull %0) #10
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %.loopexit
  store ptr null, ptr %0, align 8
  tail call void @slurm_xfree(ptr noundef nonnull %i.b) #10
...
declare i32 @hostlist_count(ptr noundef) local_unnamed_addr #5
