...
bb.a:
  ...
  br i1 %i.a, label %.preheader, label %bb.b, !dbg !5527
...
.lr.ph72.preheader:                               ; preds = %.preheader
  %umax95 = tail call i64 @llvm.umax.i64(i64 %1, i64 1), !dbg !5540 ; 2 uses
...
.loopexit:                                        ; preds = %._crit_edge69, %bb.p, %.preheader
  ret void, !dbg !5546
...
._crit_edge69:                                    ; preds = %bb.h, %bb.c
  ...
  %exitcond94.not = icmp eq i64 %indvars.iv.next, 6, !dbg !5544
  br i1 %exitcond94.not, label %.loopexit, label %bb.c, !dbg !5544
...
bb.h:                                             ; preds = %._crit_edge
  ...
  %exitcond92.not = icmp eq i64 %i.h, %2, !dbg !5548
  br i1 %exitcond92.not, label %._crit_edge69, label %.lr.ph68, !dbg !5557
...
.lr.ph72:                                         ; preds = %.lr.ph72.preheader, %bb.p
  %.sroa.029.071 = phi i64 [ %i.r, %bb.p ], [ 1, %.lr.ph72.preheader ] ; 4 uses
  %i.r = add nuw nsw i64 %.sroa.029.071, 1, !dbg !5590 ; 2 uses
  %exitcond96.not = icmp eq i64 %.sroa.029.071, %umax95, !dbg !5540
  br i1 %exitcond96.not, label %bb.l, label %bb.k, !dbg !5540
...
bb.m:                                             ; preds = %bb.k, %bb.o
  ...
  br i1 %i.v, label %bb.o, label %bb.n, !dbg !5605

bb.n:                                             ; preds = %bb.o, %bb.m
  %.sroa.08.1 = phi i64 [ 0, %bb.o ], [ %.sroa.08.0, %bb.m ], !dbg !5598 ; 3 uses
  %i.w = icmp ult i64 %.sroa.08.1, %1, !dbg !5606
  br i1 %i.w, label %bb.p, label %bb.q, !dbg !5606
...
bb.o:                                             ; preds = %bb.m
  ...
  br i1 %i.y, label %bb.n, label %bb.m, !dbg !5609

bb.p:                                             ; preds = %bb.n
  %i.z = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %.sroa.08.1, !dbg !5606
  store i64 %i.t, ptr %i.z, align 4, !dbg !5606
  %exitcond97.not = icmp eq i64 %i.r, %2, !dbg !5528
  br i1 %exitcond97.not, label %.loopexit, label %.lr.ph72, !dbg !5531
