...
vector.ph269:                                     ; preds = %.lr.ph174.preheader
  %n.vec270 = and i64 %i.cl, 9223372036854775800  ; 3 uses
  %i.cm = shl i64 %n.vec270, 2
  %i.cn = getelementptr i8, ptr %i.cf, i64 %i.cm
...
vector.body273:                                   ; preds = %vector.body273, %vector.ph269
  ...
  %vec.phi275 = phi <4 x i1> [ splat (i1 true), %vector.ph269 ], [ %i.cs, %vector.body273 ]
  %vec.phi276 = phi <4 x i1> [ splat (i1 true), %vector.ph269 ], [ %i.ct, %vector.body273 ]
  %i.co = shl i64 %index274, 2
  %next.gep277 = getelementptr i8, ptr %i.cf, i64 %i.co ; 2 uses
  %i.cp = getelementptr i8, ptr %next.gep277, i64 16, !dbg !7369
  %wide.load278 = load <4 x i32>, ptr %next.gep277, align 4, !dbg !7369, !alias.scope !7370, !noalias !7373
  %wide.load279 = load <4 x i32>, ptr %i.cp, align 4, !dbg !7369, !alias.scope !7370, !noalias !7373
  %i.cq = icmp ult <4 x i32> %wide.load278, %broadcast.splat272, !dbg !7375
  %i.cr = icmp ult <4 x i32> %wide.load279, %broadcast.splat272, !dbg !7375
  %i.cs = and <4 x i1> %vec.phi275, %i.cq, !dbg !7377 ; 2 uses
  %i.ct = and <4 x i1> %vec.phi276, %i.cr, !dbg !7377 ; 2 uses
  %index.next280 = add nuw i64 %index274, 8       ; 2 uses
  %i.cu = icmp eq i64 %index.next280, %n.vec270, !dbg !7368
  br i1 %i.cu, label %middle.block281, label %vector.body273, !dbg !7368, !llvm.loop !7378

middle.block281:                                  ; preds = %vector.body273
  %bin.rdx282 = and <4 x i1> %i.ct, %i.cs, !dbg !7368
  %i.cv = bitcast <4 x i1> %bin.rdx282 to i4, !dbg !7368
  %i.cw = icmp eq i4 %i.cv, -1, !dbg !7368        ; 2 uses
  %cmp.n283 = icmp eq i64 %i.cl, %n.vec270, !dbg !7368
...
.lr.ph174.preheader287:                           ; preds = %.lr.ph174.preheader, %middle.block281
  %.sroa.0.0.i172.ph = phi i1 [ true, %.lr.ph174.preheader ], [ %i.cw, %middle.block281 ]
  %.sroa.02.0.i171.ph = phi ptr [ %i.cf, %.lr.ph174.preheader ], [ %i.cn, %middle.block281 ]
  br label %.lr.ph174, !dbg !7368

.lr.ph174:                                        ; preds = %.lr.ph174.preheader287, %.lr.ph174
  %.sroa.0.0.i172 = phi i1 [ %i.da, %.lr.ph174 ], [ %.sroa.0.0.i172.ph, %.lr.ph174.preheader287 ]
  %.sroa.02.0.i171 = phi ptr [ %i.cx, %.lr.ph174 ], [ %.sroa.02.0.i171.ph, %.lr.ph174.preheader287 ] ; 2 uses
  %i.cx = getelementptr inbounds nuw i8, ptr %.sroa.02.0.i171, i64 4, !dbg !7381 ; 2 uses
  %i.cy = load i32, ptr %.sroa.02.0.i171, align 4, !dbg !7369, !alias.scope !7370, !noalias !7373, !noundef !13
  %i.cz = icmp ult i32 %i.cy, %i.ch, !dbg !7375
  %i.da = and i1 %.sroa.0.0.i172, %i.cz, !dbg !7377 ; 2 uses
  %i.db = icmp eq ptr %i.cx, %i.ci, !dbg !7356
  br i1 %i.db, label %._crit_edge175, label %.lr.ph174, !dbg !7368, !llvm.loop !7384

._crit_edge175:                                   ; preds = %.lr.ph174, %middle.block281
  %.lcssa = phi i1 [ %i.cw, %middle.block281 ], [ %i.da, %.lr.ph174 ], !dbg !7377
...
.lr.ph180:                                        ; preds = %bb.r, %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63.thread
  ...
  %i.dc = call { i64, i64 } @_RNvMs2_NtNtNtNtCsfISxE4fmY1Y_14polars_parquet7parquet8encoding9bitpacked6decodeINtB5_14ChunkedDecodermE9next_intoBd_(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.n, ptr noalias noundef nonnull align 4 dereferenceable(128) %i.a), !dbg !7427, !noalias !7429
  %i.dd = extractvalue { i64, i64 } %i.dc, 0, !dbg !7427
  %i.de = trunc nuw i64 %i.dd to i1, !dbg !7430
  br i1 %i.de, label %bb.y, label %bb.x, !dbg !7430
...
bb.y:                                             ; preds = %.lr.ph180
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !dbg !7434, !noalias !7417
  %i.df = load i64, ptr %i.w, align 8, !dbg !7439, !alias.scope !7442, !noundef !13
  %i.dg = trunc i64 %i.df to i32, !dbg !7445
  %i.dh = load <32 x i32>, ptr %i.m, align 4, !dbg !7447, !alias.scope !7448, !noalias !7451
  %i.di = insertelement <32 x i32> poison, i32 %i.dg, i64 0, !dbg !7453
  %i.dj = shufflevector <32 x i32> %i.di, <32 x i32> poison, <32 x i32> zeroinitializer, !dbg !7453
  %i.dk = icmp uge <32 x i32> %i.dh, %i.dj, !dbg !7454
  %i.dl = bitcast <32 x i1> %i.dk to i32, !dbg !7454
  %i.dm = icmp eq i32 %i.dl, 0, !dbg !7454
  br i1 %i.dm, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63.thread, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63, !dbg !7455, !prof !3295
...
.loopexit:                                        ; preds = %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63.thread, %bb.r, %bb.x
  ...
  %i.dn = load i64, ptr %i.j, align 8, !dbg !7461, !range !431, !noundef !13
  %i.do = trunc nuw i64 %i.dn to i1, !dbg !7464
  br i1 %i.do, label %bb.z, label %bb.ad, !dbg !7464
...
bb.z:                                             ; preds = %.loopexit
  ...
  %i.dp = load i64, ptr %i.ax, align 8, !dbg !7466, !noundef !13 ; 4 uses
  %i.dq = icmp ult i64 %i.dp, 33
  br i1 %i.dq, label %bb.ab, label %bb.aa, !dbg !7467, !prof !576

bb.aa:                                            ; preds = %bb.z
  call void @_RNvNtNtCscgRAwXFJnXP_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %i.dp, i64 noundef 32, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @17) #37, !dbg !7480
  unreachable

bb.ab:                                            ; preds = %bb.z
  %i.dr = load i64, ptr %i.w, align 8, !dbg !7481, !alias.scope !7483, !noundef !13
  %i.ds = trunc i64 %i.dr to i32, !dbg !7486      ; 2 uses
  %.idx = shl nuw nsw i64 %i.dp, 2, !dbg !7488    ; 2 uses
  %i.dt = getelementptr inbounds nuw i8, ptr %i.i, i64 %.idx, !dbg !7488 ; 2 uses
  %i.du = icmp eq i64 %i.dp, 0, !dbg !7493
  br i1 %i.du, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit60.thread, label %.lr.ph184.preheader, !dbg !7496

.lr.ph184.preheader:                              ; preds = %bb.ab
  %i.dv = add nsw i64 %.idx, -4, !dbg !7496       ; 2 uses
  %i.dw = lshr exact i64 %i.dv, 2, !dbg !7496
  %i.dx = add nuw nsw i64 %i.dw, 1, !dbg !7496    ; 2 uses
  %min.iters.check = icmp ult i64 %i.dv, 28, !dbg !7496
  br i1 %min.iters.check, label %.lr.ph184.preheader286, label %vector.ph, !dbg !7496

vector.ph:                                        ; preds = %.lr.ph184.preheader
  %n.vec = and i64 %i.dx, 9223372036854775800     ; 5 uses
  %i.dy = shl i64 %n.vec, 2
  %i.dz = getelementptr i8, ptr %i.i, i64 %i.dy
  %broadcast.splatinsert = insertelement <4 x i32> poison, i32 %i.ds, i64 0
  ...
  %i.ea = icmp ult <4 x i32> %wide.load, %broadcast.splat, !dbg !7503 ; 2 uses
  %i.eb = icmp ult <4 x i32> %wide.load266, %broadcast.splat, !dbg !7503 ; 2 uses
  %i.ec = icmp eq i64 %n.vec, 8, !dbg !7496
  br i1 %i.ec, label %middle.block, label %vector.body.1, !dbg !7496
...
vector.body.1:                                    ; preds = %vector.ph
  ...
  %i.ed = icmp ult <4 x i32> %wide.load.1, %broadcast.splat, !dbg !7503
  %i.ee = icmp ult <4 x i32> %wide.load266.1, %broadcast.splat, !dbg !7503
  %i.ef = and <4 x i1> %i.ea, %i.ed, !dbg !7504   ; 2 uses
  %i.eg = and <4 x i1> %i.eb, %i.ee, !dbg !7504   ; 2 uses
  %i.eh = icmp eq i64 %n.vec, 16, !dbg !7496
  br i1 %i.eh, label %middle.block, label %vector.body.2, !dbg !7496
...
vector.body.2:                                    ; preds = %vector.body.1
  ...
  %i.ei = icmp ult <4 x i32> %wide.load.2, %broadcast.splat, !dbg !7503
  %i.ej = icmp ult <4 x i32> %wide.load266.2, %broadcast.splat, !dbg !7503
  %i.ek = and <4 x i1> %i.ef, %i.ei, !dbg !7504   ; 2 uses
  %i.el = and <4 x i1> %i.eg, %i.ej, !dbg !7504   ; 2 uses
  %i.em = icmp eq i64 %n.vec, 24, !dbg !7496
  br i1 %i.em, label %middle.block, label %vector.body.3, !dbg !7496
...
vector.body.3:                                    ; preds = %vector.body.2
  ...
  %i.en = icmp ult <4 x i32> %wide.load.3, %broadcast.splat, !dbg !7503
  %i.eo = icmp ult <4 x i32> %wide.load266.3, %broadcast.splat, !dbg !7503
  %i.ep = and <4 x i1> %i.ek, %i.en, !dbg !7504
  %i.eq = and <4 x i1> %i.el, %i.eo, !dbg !7504
  br label %middle.block, !dbg !7496

middle.block:                                     ; preds = %vector.body.3, %vector.body.2, %vector.body.1, %vector.ph
  %.lcssa305 = phi <4 x i1> [ %i.ea, %vector.ph ], [ %i.ef, %vector.body.1 ], [ %i.ek, %vector.body.2 ], [ %i.ep, %vector.body.3 ], !dbg !7504
  %.lcssa304 = phi <4 x i1> [ %i.eb, %vector.ph ], [ %i.eg, %vector.body.1 ], [ %i.el, %vector.body.2 ], [ %i.eq, %vector.body.3 ], !dbg !7504
  %bin.rdx = and <4 x i1> %.lcssa304, %.lcssa305, !dbg !7496
  %i.er = bitcast <4 x i1> %bin.rdx to i4, !dbg !7496
  %i.es = icmp eq i4 %i.er, -1, !dbg !7496        ; 2 uses
  %cmp.n = icmp eq i64 %i.dx, %n.vec, !dbg !7496
...
.lr.ph184.preheader286:                           ; preds = %.lr.ph184.preheader, %middle.block
  %.sroa.0.0.i59182.ph = phi i1 [ true, %.lr.ph184.preheader ], [ %i.es, %middle.block ]
  %.sroa.02.0.i58181.ph = phi ptr [ %i.i, %.lr.ph184.preheader ], [ %i.dz, %middle.block ]
  br label %.lr.ph184, !dbg !7496
end_hunk_0
...
vector.ph267:                                     ; preds = %.lr.ph173.preheader
  %n.vec268 = and i64 %i.ch, 9223372036854775800  ; 3 uses
  %i.ci = shl i64 %n.vec268, 2
...
vector.body271:                                   ; preds = %vector.body271, %vector.ph267
  ...
  %vec.phi273 = phi <4 x i1> [ splat (i1 true), %vector.ph267 ], [ %i.co, %vector.body271 ]
  %vec.phi274 = phi <4 x i1> [ splat (i1 true), %vector.ph267 ], [ %i.cp, %vector.body271 ]
  %i.ck = shl i64 %index272, 2
  %next.gep275 = getelementptr i8, ptr %i.cb, i64 %i.ck ; 2 uses
  %i.cl = getelementptr i8, ptr %next.gep275, i64 16, !dbg !7701
  %wide.load276 = load <4 x i32>, ptr %next.gep275, align 4, !dbg !7701, !alias.scope !7702, !noalias !7705
  %wide.load277 = load <4 x i32>, ptr %i.cl, align 4, !dbg !7701, !alias.scope !7702, !noalias !7705
  %i.cm = icmp ult <4 x i32> %wide.load276, %broadcast.splat270, !dbg !7707
  %i.cn = icmp ult <4 x i32> %wide.load277, %broadcast.splat270, !dbg !7707
  %i.co = and <4 x i1> %vec.phi273, %i.cm, !dbg !7708 ; 2 uses
  %i.cp = and <4 x i1> %vec.phi274, %i.cn, !dbg !7708 ; 2 uses
  %index.next278 = add nuw i64 %index272, 8       ; 2 uses
  %i.cq = icmp eq i64 %index.next278, %n.vec268, !dbg !7700
  br i1 %i.cq, label %middle.block279, label %vector.body271, !dbg !7700, !llvm.loop !7709

middle.block279:                                  ; preds = %vector.body271
  %bin.rdx280 = and <4 x i1> %i.cp, %i.co, !dbg !7700
  %i.cr = bitcast <4 x i1> %bin.rdx280 to i4, !dbg !7700
  %i.cs = icmp eq i4 %i.cr, -1, !dbg !7700        ; 2 uses
  %cmp.n281 = icmp eq i64 %i.ch, %n.vec268, !dbg !7700
...
.lr.ph173.preheader285:                           ; preds = %.lr.ph173.preheader, %middle.block279
  %.sroa.0.0.i171.ph = phi i1 [ true, %.lr.ph173.preheader ], [ %i.cs, %middle.block279 ]
  %.sroa.02.0.i170.ph = phi ptr [ %i.cb, %.lr.ph173.preheader ], [ %i.cj, %middle.block279 ]
  br label %.lr.ph173, !dbg !7700

.lr.ph173:                                        ; preds = %.lr.ph173.preheader285, %.lr.ph173
  %.sroa.0.0.i171 = phi i1 [ %i.cw, %.lr.ph173 ], [ %.sroa.0.0.i171.ph, %.lr.ph173.preheader285 ]
  %.sroa.02.0.i170 = phi ptr [ %i.ct, %.lr.ph173 ], [ %.sroa.02.0.i170.ph, %.lr.ph173.preheader285 ] ; 2 uses
  %i.ct = getelementptr inbounds nuw i8, ptr %.sroa.02.0.i170, i64 4, !dbg !7710 ; 2 uses
  %i.cu = load i32, ptr %.sroa.02.0.i170, align 4, !dbg !7701, !alias.scope !7702, !noalias !7705, !noundef !13
  %i.cv = icmp ult i32 %i.cu, %i.cd, !dbg !7707
  %i.cw = and i1 %.sroa.0.0.i171, %i.cv, !dbg !7708 ; 2 uses
  %i.cx = icmp eq ptr %i.ct, %i.ce, !dbg !7697
  br i1 %i.cx, label %._crit_edge174, label %.lr.ph173, !dbg !7700, !llvm.loop !7712

._crit_edge174:                                   ; preds = %.lr.ph173, %middle.block279
  %.lcssa = phi i1 [ %i.cs, %middle.block279 ], [ %i.cw, %.lr.ph173 ], !dbg !7708
...
.lr.ph179:                                        ; preds = %bb.t, %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63.thread
  ...
  %i.cy = call { i64, i64 } @_RNvMs2_NtNtNtNtCsfISxE4fmY1Y_14polars_parquet7parquet8encoding9bitpacked6decodeINtB5_14ChunkedDecodermE9next_intoBd_(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.n, ptr noalias noundef nonnull align 4 dereferenceable(128) %i.a), !dbg !7747, !noalias !7748
  %i.cz = extractvalue { i64, i64 } %i.cy, 0, !dbg !7747
  %i.da = trunc nuw i64 %i.cz to i1, !dbg !7749
  br i1 %i.da, label %bb.aa, label %bb.z, !dbg !7749
...
bb.aa:                                            ; preds = %.lr.ph179
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !dbg !7751, !noalias !7740
  %i.db = load i8, ptr %i.v, align 1, !dbg !7755, !alias.scope !7758, !noundef !13
  %i.dc = load <32 x i32>, ptr %i.m, align 4, !dbg !7761, !alias.scope !7763, !noalias !7766
  %i.dd = zext i8 %i.db to i16, !dbg !7768
  %i.de = insertelement <32 x i16> poison, i16 %i.dd, i64 0, !dbg !7768
  %i.df = shufflevector <32 x i16> %i.de, <32 x i16> poison, <32 x i32> zeroinitializer, !dbg !7768
  %i.dg = zext nneg <32 x i16> %i.df to <32 x i32>, !dbg !7768
  %i.dh = icmp uge <32 x i32> %i.dc, %i.dg, !dbg !7769
  %i.di = bitcast <32 x i1> %i.dh to i32, !dbg !7769
  %i.dj = icmp eq i32 %i.di, 0, !dbg !7769
  br i1 %i.dj, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63.thread, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63, !dbg !7770, !prof !3295
...
.loopexit:                                        ; preds = %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63.thread, %bb.t, %bb.z
  ...
  %i.dk = load i64, ptr %i.j, align 8, !dbg !7776, !range !431, !noundef !13
  %i.dl = trunc nuw i64 %i.dk to i1, !dbg !7779
  br i1 %i.dl, label %bb.ab, label %bb.af, !dbg !7779
...
bb.ab:                                            ; preds = %.loopexit
  ...
  %i.dm = load i64, ptr %i.aw, align 8, !dbg !7781, !noundef !13 ; 4 uses
  %i.dn = icmp ult i64 %i.dm, 33
  br i1 %i.dn, label %bb.ad, label %bb.ac, !dbg !7782, !prof !576

bb.ac:                                            ; preds = %bb.ab
  call void @_RNvNtNtCscgRAwXFJnXP_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %i.dm, i64 noundef 32, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @17) #37, !dbg !7794
  unreachable

bb.ad:                                            ; preds = %bb.ab
  %i.do = load i8, ptr %i.v, align 1, !dbg !7795, !alias.scope !7797, !noundef !13
  %i.dp = zext i8 %i.do to i32, !dbg !7800        ; 2 uses
  %.idx = shl nuw nsw i64 %i.dm, 2, !dbg !7802    ; 2 uses
  %i.dq = getelementptr inbounds nuw i8, ptr %i.i, i64 %.idx, !dbg !7802 ; 2 uses
  %i.dr = icmp eq i64 %i.dm, 0, !dbg !7807
  br i1 %i.dr, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit60.thread, label %.lr.ph183.preheader, !dbg !7810

.lr.ph183.preheader:                              ; preds = %bb.ad
  %i.ds = add nsw i64 %.idx, -4, !dbg !7810       ; 2 uses
  %i.dt = lshr exact i64 %i.ds, 2, !dbg !7810
  %i.du = add nuw nsw i64 %i.dt, 1, !dbg !7810    ; 2 uses
  %min.iters.check = icmp ult i64 %i.ds, 28, !dbg !7810
  br i1 %min.iters.check, label %.lr.ph183.preheader284, label %vector.ph, !dbg !7810

vector.ph:                                        ; preds = %.lr.ph183.preheader
  %n.vec = and i64 %i.du, 9223372036854775800     ; 5 uses
  %i.dv = shl i64 %n.vec, 2
  %i.dw = getelementptr i8, ptr %i.i, i64 %i.dv
  %broadcast.splatinsert = insertelement <4 x i32> poison, i32 %i.dp, i64 0
  %broadcast.splat = shufflevector <4 x i32> %broadcast.splatinsert, <4 x i32> poison, <4 x i32> zeroinitializer ; 8 uses
  ...
  %i.dx = icmp ult <4 x i32> %wide.load, %broadcast.splat, !dbg !7817 ; 2 uses
  %i.dy = icmp ult <4 x i32> %wide.load264, %broadcast.splat, !dbg !7817 ; 2 uses
  %i.dz = icmp eq i64 %n.vec, 8, !dbg !7810
  br i1 %i.dz, label %middle.block, label %vector.body.1, !dbg !7810
...
vector.body.1:                                    ; preds = %vector.ph
  ...
  %i.ea = icmp ult <4 x i32> %wide.load.1, %broadcast.splat, !dbg !7817
  %i.eb = icmp ult <4 x i32> %wide.load264.1, %broadcast.splat, !dbg !7817
  %i.ec = and <4 x i1> %i.dx, %i.ea, !dbg !7818   ; 2 uses
  %i.ed = and <4 x i1> %i.dy, %i.eb, !dbg !7818   ; 2 uses
  %i.ee = icmp eq i64 %n.vec, 16, !dbg !7810
  br i1 %i.ee, label %middle.block, label %vector.body.2, !dbg !7810
...
vector.body.2:                                    ; preds = %vector.body.1
  ...
  %i.ef = icmp ult <4 x i32> %wide.load.2, %broadcast.splat, !dbg !7817
  %i.eg = icmp ult <4 x i32> %wide.load264.2, %broadcast.splat, !dbg !7817
  %i.eh = and <4 x i1> %i.ec, %i.ef, !dbg !7818   ; 2 uses
  %i.ei = and <4 x i1> %i.ed, %i.eg, !dbg !7818   ; 2 uses
  %i.ej = icmp eq i64 %n.vec, 24, !dbg !7810
  br i1 %i.ej, label %middle.block, label %vector.body.3, !dbg !7810
...
vector.body.3:                                    ; preds = %vector.body.2
  ...
  %i.ek = icmp ult <4 x i32> %wide.load.3, %broadcast.splat, !dbg !7817
  %i.el = icmp ult <4 x i32> %wide.load264.3, %broadcast.splat, !dbg !7817
  %i.em = and <4 x i1> %i.eh, %i.ek, !dbg !7818
  %i.en = and <4 x i1> %i.ei, %i.el, !dbg !7818
  br label %middle.block, !dbg !7810

middle.block:                                     ; preds = %vector.body.3, %vector.body.2, %vector.body.1, %vector.ph
  %.lcssa303 = phi <4 x i1> [ %i.dx, %vector.ph ], [ %i.ec, %vector.body.1 ], [ %i.eh, %vector.body.2 ], [ %i.em, %vector.body.3 ], !dbg !7818
  %.lcssa302 = phi <4 x i1> [ %i.dy, %vector.ph ], [ %i.ed, %vector.body.1 ], [ %i.ei, %vector.body.2 ], [ %i.en, %vector.body.3 ], !dbg !7818
  %bin.rdx = and <4 x i1> %.lcssa302, %.lcssa303, !dbg !7810
  %i.eo = bitcast <4 x i1> %bin.rdx to i4, !dbg !7810
  %i.ep = icmp eq i4 %i.eo, -1, !dbg !7810        ; 2 uses
  %cmp.n = icmp eq i64 %i.du, %n.vec, !dbg !7810
...
.lr.ph183.preheader284:                           ; preds = %.lr.ph183.preheader, %middle.block
  %.sroa.0.0.i59181.ph = phi i1 [ true, %.lr.ph183.preheader ], [ %i.ep, %middle.block ]
  %.sroa.02.0.i58180.ph = phi ptr [ %i.i, %.lr.ph183.preheader ], [ %i.dw, %middle.block ]
end_hunk_1
...
vector.body273:                                   ; preds = %vector.body273, %vector.ph269
  ...
  %i.co = shl i64 %index274, 2
  %next.gep277 = getelementptr i8, ptr %i.cf, i64 %i.co ; 2 uses
  %i.cp = getelementptr i8, ptr %next.gep277, i64 16, !dbg !8037
  %wide.load278 = load <4 x i32>, ptr %next.gep277, align 4, !dbg !8037, !alias.scope !8038, !noalias !8041
  %wide.load279 = load <4 x i32>, ptr %i.cp, align 4, !dbg !8037, !alias.scope !8038, !noalias !8041
  %i.cq = icmp ult <4 x i32> %wide.load278, %broadcast.splat272, !dbg !8043
  %i.cr = icmp ult <4 x i32> %wide.load279, %broadcast.splat272, !dbg !8043
  %i.cs = and <4 x i1> %vec.phi275, %i.cq, !dbg !8044 ; 2 uses
  %i.ct = and <4 x i1> %vec.phi276, %i.cr, !dbg !8044 ; 2 uses
  %index.next280 = add nuw i64 %index274, 8       ; 2 uses
  %i.cu = icmp eq i64 %index.next280, %n.vec270, !dbg !8036
  br i1 %i.cu, label %middle.block281, label %vector.body273, !dbg !8036, !llvm.loop !8045

middle.block281:                                  ; preds = %vector.body273
  %bin.rdx282 = and <4 x i1> %i.ct, %i.cs, !dbg !8036
  %i.cv = bitcast <4 x i1> %bin.rdx282 to i4, !dbg !8036
  %i.cw = icmp eq i4 %i.cv, -1, !dbg !8036        ; 2 uses
  %cmp.n283 = icmp eq i64 %i.cl, %n.vec270, !dbg !8036
...
.lr.ph174:                                        ; preds = %.lr.ph174.preheader287, %.lr.ph174
  %.sroa.0.0.i172 = phi i1 [ %i.da, %.lr.ph174 ], [ %.sroa.0.0.i172.ph, %.lr.ph174.preheader287 ]
  %.sroa.02.0.i171 = phi ptr [ %i.cx, %.lr.ph174 ], [ %.sroa.02.0.i171.ph, %.lr.ph174.preheader287 ] ; 2 uses
  %i.cx = getelementptr inbounds nuw i8, ptr %.sroa.02.0.i171, i64 4, !dbg !8046 ; 2 uses
  %i.cy = load i32, ptr %.sroa.02.0.i171, align 4, !dbg !8037, !alias.scope !8038, !noalias !8041, !noundef !13
  %i.cz = icmp ult i32 %i.cy, %i.ch, !dbg !8043
  %i.da = and i1 %.sroa.0.0.i172, %i.cz, !dbg !8044 ; 2 uses
  %i.db = icmp eq ptr %i.cx, %i.ci, !dbg !8033
  br i1 %i.db, label %._crit_edge175, label %.lr.ph174, !dbg !8036, !llvm.loop !8048

._crit_edge175:                                   ; preds = %.lr.ph174, %middle.block281
  %.lcssa = phi i1 [ %i.cw, %middle.block281 ], [ %i.da, %.lr.ph174 ], !dbg !8044
...
.lr.ph180:                                        ; preds = %bb.r, %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63.thread
  ...
  %i.dc = call { i64, i64 } @_RNvMs2_NtNtNtNtCsfISxE4fmY1Y_14polars_parquet7parquet8encoding9bitpacked6decodeINtB5_14ChunkedDecodermE9next_intoBd_(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.n, ptr noalias noundef nonnull align 4 dereferenceable(128) %i.a), !dbg !8083, !noalias !8084
  %i.dd = extractvalue { i64, i64 } %i.dc, 0, !dbg !8083
  %i.de = trunc nuw i64 %i.dd to i1, !dbg !8085
  br i1 %i.de, label %bb.y, label %bb.x, !dbg !8085
...
bb.y:                                             ; preds = %.lr.ph180
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !dbg !8087, !noalias !8076
  %i.df = load i64, ptr %i.w, align 8, !dbg !8091, !alias.scope !8094, !noundef !13
  %i.dg = trunc i64 %i.df to i32, !dbg !8097
  %i.dh = load <32 x i32>, ptr %i.m, align 4, !dbg !8099, !alias.scope !8100, !noalias !8103
  %i.di = insertelement <32 x i32> poison, i32 %i.dg, i64 0, !dbg !8105
  %i.dj = shufflevector <32 x i32> %i.di, <32 x i32> poison, <32 x i32> zeroinitializer, !dbg !8105
  %i.dk = icmp uge <32 x i32> %i.dh, %i.dj, !dbg !8106
  %i.dl = bitcast <32 x i1> %i.dk to i32, !dbg !8106
  %i.dm = icmp eq i32 %i.dl, 0, !dbg !8106
  br i1 %i.dm, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63.thread, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63, !dbg !8107, !prof !3295
...
.loopexit:                                        ; preds = %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63.thread, %bb.r, %bb.x
  ...
  %i.dn = load i64, ptr %i.j, align 8, !dbg !8113, !range !431, !noundef !13
  %i.do = trunc nuw i64 %i.dn to i1, !dbg !8116
  br i1 %i.do, label %bb.z, label %bb.ad, !dbg !8116
...
bb.z:                                             ; preds = %.loopexit
  ...
  %i.dp = load i64, ptr %i.ax, align 8, !dbg !8118, !noundef !13 ; 4 uses
  %i.dq = icmp ult i64 %i.dp, 33
  br i1 %i.dq, label %bb.ab, label %bb.aa, !dbg !8119, !prof !576

bb.aa:                                            ; preds = %bb.z
  call void @_RNvNtNtCscgRAwXFJnXP_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %i.dp, i64 noundef 32, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @17) #37, !dbg !8131
  unreachable

bb.ab:                                            ; preds = %bb.z
  %i.dr = load i64, ptr %i.w, align 8, !dbg !8132, !alias.scope !8134, !noundef !13
  %i.ds = trunc i64 %i.dr to i32, !dbg !8137      ; 2 uses
  %.idx = shl nuw nsw i64 %i.dp, 2, !dbg !8139    ; 2 uses
  %i.dt = getelementptr inbounds nuw i8, ptr %i.i, i64 %.idx, !dbg !8139 ; 2 uses
  %i.du = icmp eq i64 %i.dp, 0, !dbg !8144
  br i1 %i.du, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit60.thread, label %.lr.ph184.preheader, !dbg !8147

.lr.ph184.preheader:                              ; preds = %bb.ab
  %i.dv = add nsw i64 %.idx, -4, !dbg !8147       ; 2 uses
  %i.dw = lshr exact i64 %i.dv, 2, !dbg !8147
  %i.dx = add nuw nsw i64 %i.dw, 1, !dbg !8147    ; 2 uses
  %min.iters.check = icmp ult i64 %i.dv, 28, !dbg !8147
...
vector.ph:                                        ; preds = %.lr.ph184.preheader
  ...
  %i.ea = icmp ult <4 x i32> %wide.load, %broadcast.splat, !dbg !8154 ; 2 uses
  %i.eb = icmp ult <4 x i32> %wide.load266, %broadcast.splat, !dbg !8154 ; 2 uses
  %i.ec = icmp eq i64 %n.vec, 8, !dbg !8147
  br i1 %i.ec, label %middle.block, label %vector.body.1, !dbg !8147
...
vector.body.1:                                    ; preds = %vector.ph
  ...
  %i.ed = icmp ult <4 x i32> %wide.load.1, %broadcast.splat, !dbg !8154
  %i.ee = icmp ult <4 x i32> %wide.load266.1, %broadcast.splat, !dbg !8154
  %i.ef = and <4 x i1> %i.ea, %i.ed, !dbg !8155   ; 2 uses
  %i.eg = and <4 x i1> %i.eb, %i.ee, !dbg !8155   ; 2 uses
  %i.eh = icmp eq i64 %n.vec, 16, !dbg !8147
  br i1 %i.eh, label %middle.block, label %vector.body.2, !dbg !8147
...
vector.body.2:                                    ; preds = %vector.body.1
  ...
  %i.ei = icmp ult <4 x i32> %wide.load.2, %broadcast.splat, !dbg !8154
  %i.ej = icmp ult <4 x i32> %wide.load266.2, %broadcast.splat, !dbg !8154
  %i.ek = and <4 x i1> %i.ef, %i.ei, !dbg !8155   ; 2 uses
  %i.el = and <4 x i1> %i.eg, %i.ej, !dbg !8155   ; 2 uses
  %i.em = icmp eq i64 %n.vec, 24, !dbg !8147
  br i1 %i.em, label %middle.block, label %vector.body.3, !dbg !8147
...
vector.body.3:                                    ; preds = %vector.body.2
  ...
  %i.en = icmp ult <4 x i32> %wide.load.3, %broadcast.splat, !dbg !8154
  %i.eo = icmp ult <4 x i32> %wide.load266.3, %broadcast.splat, !dbg !8154
  %i.ep = and <4 x i1> %i.ek, %i.en, !dbg !8155
  %i.eq = and <4 x i1> %i.el, %i.eo, !dbg !8155
  br label %middle.block, !dbg !8147

middle.block:                                     ; preds = %vector.body.3, %vector.body.2, %vector.body.1, %vector.ph
  %.lcssa305 = phi <4 x i1> [ %i.ea, %vector.ph ], [ %i.ef, %vector.body.1 ], [ %i.ek, %vector.body.2 ], [ %i.ep, %vector.body.3 ], !dbg !8155
  %.lcssa304 = phi <4 x i1> [ %i.eb, %vector.ph ], [ %i.eg, %vector.body.1 ], [ %i.el, %vector.body.2 ], [ %i.eq, %vector.body.3 ], !dbg !8155
  %bin.rdx = and <4 x i1> %.lcssa304, %.lcssa305, !dbg !8147
  %i.er = bitcast <4 x i1> %bin.rdx to i4, !dbg !8147
  %i.es = icmp eq i4 %i.er, -1, !dbg !8147        ; 2 uses
  %cmp.n = icmp eq i64 %i.dx, %n.vec, !dbg !8147
  br i1 %cmp.n, label %._crit_edge185, label %.lr.ph184.preheader286, !dbg !8147

.lr.ph184.preheader286:                           ; preds = %.lr.ph184.preheader, %middle.block
  %.sroa.0.0.i59182.ph = phi i1 [ true, %.lr.ph184.preheader ], [ %i.es, %middle.block ]
  %.sroa.02.0.i58181.ph = phi ptr [ %i.i, %.lr.ph184.preheader ], [ %i.dz, %middle.block ]
  br label %.lr.ph184, !dbg !8147
end_hunk_2
...
vector.body271:                                   ; preds = %vector.body271, %vector.ph267
  ...
  %i.ck = shl i64 %index272, 2
  %next.gep275 = getelementptr i8, ptr %i.cb, i64 %i.ck ; 2 uses
  %i.cl = getelementptr i8, ptr %next.gep275, i64 16, !dbg !8352
  %wide.load276 = load <4 x i32>, ptr %next.gep275, align 4, !dbg !8352, !alias.scope !8353, !noalias !8356
  %wide.load277 = load <4 x i32>, ptr %i.cl, align 4, !dbg !8352, !alias.scope !8353, !noalias !8356
  %i.cm = icmp ult <4 x i32> %wide.load276, %broadcast.splat270, !dbg !8358
  %i.cn = icmp ult <4 x i32> %wide.load277, %broadcast.splat270, !dbg !8358
  %i.co = and <4 x i1> %vec.phi273, %i.cm, !dbg !8359 ; 2 uses
  %i.cp = and <4 x i1> %vec.phi274, %i.cn, !dbg !8359 ; 2 uses
  %index.next278 = add nuw i64 %index272, 8       ; 2 uses
  %i.cq = icmp eq i64 %index.next278, %n.vec268, !dbg !8351
  br i1 %i.cq, label %middle.block279, label %vector.body271, !dbg !8351, !llvm.loop !8360

middle.block279:                                  ; preds = %vector.body271
  %bin.rdx280 = and <4 x i1> %i.cp, %i.co, !dbg !8351
  %i.cr = bitcast <4 x i1> %bin.rdx280 to i4, !dbg !8351
  %i.cs = icmp eq i4 %i.cr, -1, !dbg !8351        ; 2 uses
  %cmp.n281 = icmp eq i64 %i.ch, %n.vec268, !dbg !8351
...
.lr.ph173:                                        ; preds = %.lr.ph173.preheader285, %.lr.ph173
  %.sroa.0.0.i171 = phi i1 [ %i.cw, %.lr.ph173 ], [ %.sroa.0.0.i171.ph, %.lr.ph173.preheader285 ]
  %.sroa.02.0.i170 = phi ptr [ %i.ct, %.lr.ph173 ], [ %.sroa.02.0.i170.ph, %.lr.ph173.preheader285 ] ; 2 uses
  %i.ct = getelementptr inbounds nuw i8, ptr %.sroa.02.0.i170, i64 4, !dbg !8361 ; 2 uses
  %i.cu = load i32, ptr %.sroa.02.0.i170, align 4, !dbg !8352, !alias.scope !8353, !noalias !8356, !noundef !13
  %i.cv = icmp ult i32 %i.cu, %i.cd, !dbg !8358
  %i.cw = and i1 %.sroa.0.0.i171, %i.cv, !dbg !8359 ; 2 uses
  %i.cx = icmp eq ptr %i.ct, %i.ce, !dbg !8348
  br i1 %i.cx, label %._crit_edge174, label %.lr.ph173, !dbg !8351, !llvm.loop !8363

._crit_edge174:                                   ; preds = %.lr.ph173, %middle.block279
  %.lcssa = phi i1 [ %i.cs, %middle.block279 ], [ %i.cw, %.lr.ph173 ], !dbg !8359
...
.lr.ph179:                                        ; preds = %bb.t, %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63.thread
  ...
  %i.cy = call { i64, i64 } @_RNvMs2_NtNtNtNtCsfISxE4fmY1Y_14polars_parquet7parquet8encoding9bitpacked6decodeINtB5_14ChunkedDecodermE9next_intoBd_(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.n, ptr noalias noundef nonnull align 4 dereferenceable(128) %i.a), !dbg !8398, !noalias !8399
  %i.cz = extractvalue { i64, i64 } %i.cy, 0, !dbg !8398
  %i.da = trunc nuw i64 %i.cz to i1, !dbg !8400
  br i1 %i.da, label %bb.aa, label %bb.z, !dbg !8400
...
bb.aa:                                            ; preds = %.lr.ph179
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !dbg !8402, !noalias !8391
  %i.db = load i16, ptr %i.v, align 2, !dbg !8406, !alias.scope !8409, !noundef !13
  %i.dc = zext i16 %i.db to i32, !dbg !8412
  %i.dd = load <32 x i32>, ptr %i.m, align 4, !dbg !8414, !alias.scope !8415, !noalias !8418
  %i.de = insertelement <32 x i32> poison, i32 %i.dc, i64 0, !dbg !8420
  %i.df = shufflevector <32 x i32> %i.de, <32 x i32> poison, <32 x i32> zeroinitializer, !dbg !8420
  %i.dg = icmp uge <32 x i32> %i.dd, %i.df, !dbg !8421
  %i.dh = bitcast <32 x i1> %i.dg to i32, !dbg !8421
  %i.di = icmp eq i32 %i.dh, 0, !dbg !8421
  br i1 %i.di, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63.thread, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63, !dbg !8422, !prof !3295
...
.loopexit:                                        ; preds = %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63.thread, %bb.t, %bb.z
  ...
  %i.dj = load i64, ptr %i.j, align 8, !dbg !8428, !range !431, !noundef !13
  %i.dk = trunc nuw i64 %i.dj to i1, !dbg !8431
  br i1 %i.dk, label %bb.ab, label %bb.af, !dbg !8431
...
bb.ab:                                            ; preds = %.loopexit
  ...
  %i.dl = load i64, ptr %i.aw, align 8, !dbg !8433, !noundef !13 ; 4 uses
  %i.dm = icmp ult i64 %i.dl, 33
  br i1 %i.dm, label %bb.ad, label %bb.ac, !dbg !8434, !prof !576

bb.ac:                                            ; preds = %bb.ab
  call void @_RNvNtNtCscgRAwXFJnXP_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %i.dl, i64 noundef 32, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @17) #37, !dbg !8446
  unreachable

bb.ad:                                            ; preds = %bb.ab
  %i.dn = load i16, ptr %i.v, align 2, !dbg !8447, !alias.scope !8449, !noundef !13
  %i.do = zext i16 %i.dn to i32, !dbg !8452       ; 2 uses
  %.idx = shl nuw nsw i64 %i.dl, 2, !dbg !8454    ; 2 uses
  %i.dp = getelementptr inbounds nuw i8, ptr %i.i, i64 %.idx, !dbg !8454 ; 2 uses
  %i.dq = icmp eq i64 %i.dl, 0, !dbg !8459
  br i1 %i.dq, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit60.thread, label %.lr.ph183.preheader, !dbg !8462

.lr.ph183.preheader:                              ; preds = %bb.ad
  %i.dr = add nsw i64 %.idx, -4, !dbg !8462       ; 2 uses
  %i.ds = lshr exact i64 %i.dr, 2, !dbg !8462
  %i.dt = add nuw nsw i64 %i.ds, 1, !dbg !8462    ; 2 uses
  %min.iters.check = icmp ult i64 %i.dr, 28, !dbg !8462
  br i1 %min.iters.check, label %.lr.ph183.preheader284, label %vector.ph, !dbg !8462

vector.ph:                                        ; preds = %.lr.ph183.preheader
  %n.vec = and i64 %i.dt, 9223372036854775800     ; 5 uses
  %i.du = shl i64 %n.vec, 2
  %i.dv = getelementptr i8, ptr %i.i, i64 %i.du
  %broadcast.splatinsert = insertelement <4 x i32> poison, i32 %i.do, i64 0
  %broadcast.splat = shufflevector <4 x i32> %broadcast.splatinsert, <4 x i32> poison, <4 x i32> zeroinitializer ; 8 uses
  ...
  %i.dw = icmp ult <4 x i32> %wide.load, %broadcast.splat, !dbg !8469 ; 2 uses
  %i.dx = icmp ult <4 x i32> %wide.load264, %broadcast.splat, !dbg !8469 ; 2 uses
  %i.dy = icmp eq i64 %n.vec, 8, !dbg !8462
  br i1 %i.dy, label %middle.block, label %vector.body.1, !dbg !8462
...
vector.body.1:                                    ; preds = %vector.ph
  ...
  %i.dz = icmp ult <4 x i32> %wide.load.1, %broadcast.splat, !dbg !8469
  %i.ea = icmp ult <4 x i32> %wide.load264.1, %broadcast.splat, !dbg !8469
  %i.eb = and <4 x i1> %i.dw, %i.dz, !dbg !8470   ; 2 uses
  %i.ec = and <4 x i1> %i.dx, %i.ea, !dbg !8470   ; 2 uses
  %i.ed = icmp eq i64 %n.vec, 16, !dbg !8462
  br i1 %i.ed, label %middle.block, label %vector.body.2, !dbg !8462
...
vector.body.2:                                    ; preds = %vector.body.1
  ...
  %i.ee = icmp ult <4 x i32> %wide.load.2, %broadcast.splat, !dbg !8469
  %i.ef = icmp ult <4 x i32> %wide.load264.2, %broadcast.splat, !dbg !8469
  %i.eg = and <4 x i1> %i.eb, %i.ee, !dbg !8470   ; 2 uses
  %i.eh = and <4 x i1> %i.ec, %i.ef, !dbg !8470   ; 2 uses
  %i.ei = icmp eq i64 %n.vec, 24, !dbg !8462
  br i1 %i.ei, label %middle.block, label %vector.body.3, !dbg !8462
...
vector.body.3:                                    ; preds = %vector.body.2
  ...
  %i.ej = icmp ult <4 x i32> %wide.load.3, %broadcast.splat, !dbg !8469
  %i.ek = icmp ult <4 x i32> %wide.load264.3, %broadcast.splat, !dbg !8469
  %i.el = and <4 x i1> %i.eg, %i.ej, !dbg !8470
  %i.em = and <4 x i1> %i.eh, %i.ek, !dbg !8470
  br label %middle.block, !dbg !8462

middle.block:                                     ; preds = %vector.body.3, %vector.body.2, %vector.body.1, %vector.ph
  %.lcssa303 = phi <4 x i1> [ %i.dw, %vector.ph ], [ %i.eb, %vector.body.1 ], [ %i.eg, %vector.body.2 ], [ %i.el, %vector.body.3 ], !dbg !8470
  %.lcssa302 = phi <4 x i1> [ %i.dx, %vector.ph ], [ %i.ec, %vector.body.1 ], [ %i.eh, %vector.body.2 ], [ %i.em, %vector.body.3 ], !dbg !8470
  %bin.rdx = and <4 x i1> %.lcssa302, %.lcssa303, !dbg !8462
  %i.en = bitcast <4 x i1> %bin.rdx to i4, !dbg !8462
  %i.eo = icmp eq i4 %i.en, -1, !dbg !8462        ; 2 uses
  %cmp.n = icmp eq i64 %i.dt, %n.vec, !dbg !8462
  br i1 %cmp.n, label %._crit_edge184, label %.lr.ph183.preheader284, !dbg !8462

.lr.ph183.preheader284:                           ; preds = %.lr.ph183.preheader, %middle.block
  %.sroa.0.0.i59181.ph = phi i1 [ true, %.lr.ph183.preheader ], [ %i.eo, %middle.block ]
  %.sroa.02.0.i58180.ph = phi ptr [ %i.i, %.lr.ph183.preheader ], [ %i.dv, %middle.block ]
  br label %.lr.ph183, !dbg !8462
end_hunk_3
...
vector.body273:                                   ; preds = %vector.body273, %vector.ph269
  ...
  %i.co = shl i64 %index274, 2
  %next.gep277 = getelementptr i8, ptr %i.cf, i64 %i.co ; 2 uses
  %i.cp = getelementptr i8, ptr %next.gep277, i64 16, !dbg !8689
  %wide.load278 = load <4 x i32>, ptr %next.gep277, align 4, !dbg !8689, !alias.scope !8690, !noalias !8693
  %wide.load279 = load <4 x i32>, ptr %i.cp, align 4, !dbg !8689, !alias.scope !8690, !noalias !8693
  %i.cq = icmp ult <4 x i32> %wide.load278, %broadcast.splat272, !dbg !8695
  %i.cr = icmp ult <4 x i32> %wide.load279, %broadcast.splat272, !dbg !8695
  %i.cs = and <4 x i1> %vec.phi275, %i.cq, !dbg !8696 ; 2 uses
  %i.ct = and <4 x i1> %vec.phi276, %i.cr, !dbg !8696 ; 2 uses
  %index.next280 = add nuw i64 %index274, 8       ; 2 uses
  %i.cu = icmp eq i64 %index.next280, %n.vec270, !dbg !8688
  br i1 %i.cu, label %middle.block281, label %vector.body273, !dbg !8688, !llvm.loop !8697

middle.block281:                                  ; preds = %vector.body273
  %bin.rdx282 = and <4 x i1> %i.ct, %i.cs, !dbg !8688
  %i.cv = bitcast <4 x i1> %bin.rdx282 to i4, !dbg !8688
  %i.cw = icmp eq i4 %i.cv, -1, !dbg !8688        ; 2 uses
  %cmp.n283 = icmp eq i64 %i.cl, %n.vec270, !dbg !8688
...
.lr.ph174:                                        ; preds = %.lr.ph174.preheader287, %.lr.ph174
  %.sroa.0.0.i172 = phi i1 [ %i.da, %.lr.ph174 ], [ %.sroa.0.0.i172.ph, %.lr.ph174.preheader287 ]
  %.sroa.02.0.i171 = phi ptr [ %i.cx, %.lr.ph174 ], [ %.sroa.02.0.i171.ph, %.lr.ph174.preheader287 ] ; 2 uses
  %i.cx = getelementptr inbounds nuw i8, ptr %.sroa.02.0.i171, i64 4, !dbg !8698 ; 2 uses
  %i.cy = load i32, ptr %.sroa.02.0.i171, align 4, !dbg !8689, !alias.scope !8690, !noalias !8693, !noundef !13
  %i.cz = icmp ult i32 %i.cy, %i.ch, !dbg !8695
  %i.da = and i1 %.sroa.0.0.i172, %i.cz, !dbg !8696 ; 2 uses
  %i.db = icmp eq ptr %i.cx, %i.ci, !dbg !8685
  br i1 %i.db, label %._crit_edge175, label %.lr.ph174, !dbg !8688, !llvm.loop !8700

._crit_edge175:                                   ; preds = %.lr.ph174, %middle.block281
  %.lcssa = phi i1 [ %i.cw, %middle.block281 ], [ %i.da, %.lr.ph174 ], !dbg !8696
...
.lr.ph180:                                        ; preds = %bb.r, %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63.thread
  ...
  %i.dc = call { i64, i64 } @_RNvMs2_NtNtNtNtCsfISxE4fmY1Y_14polars_parquet7parquet8encoding9bitpacked6decodeINtB5_14ChunkedDecodermE9next_intoBd_(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.n, ptr noalias noundef nonnull align 4 dereferenceable(128) %i.a), !dbg !8735, !noalias !8736
  %i.dd = extractvalue { i64, i64 } %i.dc, 0, !dbg !8735
  %i.de = trunc nuw i64 %i.dd to i1, !dbg !8737
  br i1 %i.de, label %bb.y, label %bb.x, !dbg !8737
...
bb.y:                                             ; preds = %.lr.ph180
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !dbg !8739, !noalias !8728
  %i.df = load i64, ptr %i.w, align 8, !dbg !8743, !alias.scope !8746, !noundef !13
  %i.dg = trunc i64 %i.df to i32, !dbg !8749
  %i.dh = load <32 x i32>, ptr %i.m, align 4, !dbg !8751, !alias.scope !8752, !noalias !8755
  %i.di = insertelement <32 x i32> poison, i32 %i.dg, i64 0, !dbg !8757
  %i.dj = shufflevector <32 x i32> %i.di, <32 x i32> poison, <32 x i32> zeroinitializer, !dbg !8757
  %i.dk = icmp uge <32 x i32> %i.dh, %i.dj, !dbg !8758
  %i.dl = bitcast <32 x i1> %i.dk to i32, !dbg !8758
  %i.dm = icmp eq i32 %i.dl, 0, !dbg !8758
  br i1 %i.dm, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63.thread, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63, !dbg !8759, !prof !3295
...
.loopexit:                                        ; preds = %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63.thread, %bb.r, %bb.x
  ...
  %i.dn = load i64, ptr %i.j, align 8, !dbg !8765, !range !431, !noundef !13
  %i.do = trunc nuw i64 %i.dn to i1, !dbg !8768
  br i1 %i.do, label %bb.z, label %bb.ad, !dbg !8768
...
bb.z:                                             ; preds = %.loopexit
  ...
  %i.dp = load i64, ptr %i.ax, align 8, !dbg !8770, !noundef !13 ; 4 uses
  %i.dq = icmp ult i64 %i.dp, 33
  br i1 %i.dq, label %bb.ab, label %bb.aa, !dbg !8771, !prof !576

bb.aa:                                            ; preds = %bb.z
  call void @_RNvNtNtCscgRAwXFJnXP_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %i.dp, i64 noundef 32, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @17) #37, !dbg !8783
  unreachable

bb.ab:                                            ; preds = %bb.z
  %i.dr = load i64, ptr %i.w, align 8, !dbg !8784, !alias.scope !8786, !noundef !13
  %i.ds = trunc i64 %i.dr to i32, !dbg !8789      ; 2 uses
  %.idx = shl nuw nsw i64 %i.dp, 2, !dbg !8791    ; 2 uses
  %i.dt = getelementptr inbounds nuw i8, ptr %i.i, i64 %.idx, !dbg !8791 ; 2 uses
  %i.du = icmp eq i64 %i.dp, 0, !dbg !8796
  br i1 %i.du, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit60.thread, label %.lr.ph184.preheader, !dbg !8799

.lr.ph184.preheader:                              ; preds = %bb.ab
  %i.dv = add nsw i64 %.idx, -4, !dbg !8799       ; 2 uses
  %i.dw = lshr exact i64 %i.dv, 2, !dbg !8799
  %i.dx = add nuw nsw i64 %i.dw, 1, !dbg !8799    ; 2 uses
  %min.iters.check = icmp ult i64 %i.dv, 28, !dbg !8799
...
vector.ph:                                        ; preds = %.lr.ph184.preheader
  ...
  %i.ea = icmp ult <4 x i32> %wide.load, %broadcast.splat, !dbg !8806 ; 2 uses
  %i.eb = icmp ult <4 x i32> %wide.load266, %broadcast.splat, !dbg !8806 ; 2 uses
  %i.ec = icmp eq i64 %n.vec, 8, !dbg !8799
  br i1 %i.ec, label %middle.block, label %vector.body.1, !dbg !8799
...
vector.body.1:                                    ; preds = %vector.ph
  ...
  %i.ed = icmp ult <4 x i32> %wide.load.1, %broadcast.splat, !dbg !8806
  %i.ee = icmp ult <4 x i32> %wide.load266.1, %broadcast.splat, !dbg !8806
  %i.ef = and <4 x i1> %i.ea, %i.ed, !dbg !8807   ; 2 uses
  %i.eg = and <4 x i1> %i.eb, %i.ee, !dbg !8807   ; 2 uses
  %i.eh = icmp eq i64 %n.vec, 16, !dbg !8799
  br i1 %i.eh, label %middle.block, label %vector.body.2, !dbg !8799
...
vector.body.2:                                    ; preds = %vector.body.1
  ...
  %i.ei = icmp ult <4 x i32> %wide.load.2, %broadcast.splat, !dbg !8806
  %i.ej = icmp ult <4 x i32> %wide.load266.2, %broadcast.splat, !dbg !8806
  %i.ek = and <4 x i1> %i.ef, %i.ei, !dbg !8807   ; 2 uses
  %i.el = and <4 x i1> %i.eg, %i.ej, !dbg !8807   ; 2 uses
  %i.em = icmp eq i64 %n.vec, 24, !dbg !8799
  br i1 %i.em, label %middle.block, label %vector.body.3, !dbg !8799
...
vector.body.3:                                    ; preds = %vector.body.2
  ...
  %i.en = icmp ult <4 x i32> %wide.load.3, %broadcast.splat, !dbg !8806
  %i.eo = icmp ult <4 x i32> %wide.load266.3, %broadcast.splat, !dbg !8806
  %i.ep = and <4 x i1> %i.ek, %i.en, !dbg !8807
  %i.eq = and <4 x i1> %i.el, %i.eo, !dbg !8807
  br label %middle.block, !dbg !8799

middle.block:                                     ; preds = %vector.body.3, %vector.body.2, %vector.body.1, %vector.ph
  %.lcssa305 = phi <4 x i1> [ %i.ea, %vector.ph ], [ %i.ef, %vector.body.1 ], [ %i.ek, %vector.body.2 ], [ %i.ep, %vector.body.3 ], !dbg !8807
  %.lcssa304 = phi <4 x i1> [ %i.eb, %vector.ph ], [ %i.eg, %vector.body.1 ], [ %i.el, %vector.body.2 ], [ %i.eq, %vector.body.3 ], !dbg !8807
  %bin.rdx = and <4 x i1> %.lcssa304, %.lcssa305, !dbg !8799
  %i.er = bitcast <4 x i1> %bin.rdx to i4, !dbg !8799
  %i.es = icmp eq i4 %i.er, -1, !dbg !8799        ; 2 uses
  %cmp.n = icmp eq i64 %i.dx, %n.vec, !dbg !8799
  br i1 %cmp.n, label %._crit_edge185, label %.lr.ph184.preheader286, !dbg !8799

.lr.ph184.preheader286:                           ; preds = %.lr.ph184.preheader, %middle.block
  %.sroa.0.0.i59182.ph = phi i1 [ true, %.lr.ph184.preheader ], [ %i.es, %middle.block ]
  %.sroa.02.0.i58181.ph = phi ptr [ %i.i, %.lr.ph184.preheader ], [ %i.dz, %middle.block ]
  br label %.lr.ph184, !dbg !8799
end_hunk_4
begin_hunk_5_@_RINvNtNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded8required6decodeNtNtNtCs8774dFTUdNv_12polars_arrow5types13aligned_bytes16Bytes4Alignment4mEBc_:bb.a
  br i1 %.not.i, label %bb.e, label %._crit_edge, !dbg !8890
...
vector.ph267:                                     ; preds = %.lr.ph173.preheader
  %n.vec268 = and i64 %i.cg, 9223372036854775800  ; 3 uses
  %i.ch = shl i64 %n.vec268, 2
...
vector.body271:                                   ; preds = %vector.body271, %vector.ph267
  %index272 = phi i64 [ 0, %vector.ph267 ], [ %index.next278, %vector.body271 ] ; 2 uses
  %vec.phi273 = phi <4 x i1> [ splat (i1 true), %vector.ph267 ], [ %i.cn, %vector.body271 ]
  %vec.phi274 = phi <4 x i1> [ splat (i1 true), %vector.ph267 ], [ %i.co, %vector.body271 ]
  %i.cj = shl i64 %index272, 2
  %next.gep275 = getelementptr i8, ptr %i.cb, i64 %i.cj ; 2 uses
  %i.ck = getelementptr i8, ptr %next.gep275, i64 16, !dbg !9003
  %wide.load276 = load <4 x i32>, ptr %next.gep275, align 4, !dbg !9003, !alias.scope !9004, !noalias !9007
  %wide.load277 = load <4 x i32>, ptr %i.ck, align 4, !dbg !9003, !alias.scope !9004, !noalias !9007
  %i.cl = icmp ult <4 x i32> %wide.load276, %broadcast.splat270, !dbg !9009
  %i.cm = icmp ult <4 x i32> %wide.load277, %broadcast.splat270, !dbg !9009
  %i.cn = and <4 x i1> %vec.phi273, %i.cl, !dbg !9010 ; 2 uses
  %i.co = and <4 x i1> %vec.phi274, %i.cm, !dbg !9010 ; 2 uses
  %index.next278 = add nuw i64 %index272, 8       ; 2 uses
  %i.cp = icmp eq i64 %index.next278, %n.vec268, !dbg !9002
  br i1 %i.cp, label %middle.block279, label %vector.body271, !dbg !9002, !llvm.loop !9011

middle.block279:                                  ; preds = %vector.body271
  %bin.rdx280 = and <4 x i1> %i.co, %i.cn, !dbg !9002
  %i.cq = bitcast <4 x i1> %bin.rdx280 to i4, !dbg !9002
  %i.cr = icmp eq i4 %i.cq, -1, !dbg !9002        ; 2 uses
  %cmp.n281 = icmp eq i64 %i.cg, %n.vec268, !dbg !9002
  br i1 %cmp.n281, label %._crit_edge174, label %.lr.ph173.preheader285, !dbg !9002

.lr.ph173.preheader285:                           ; preds = %.lr.ph173.preheader, %middle.block279
  %.sroa.0.0.i171.ph = phi i1 [ true, %.lr.ph173.preheader ], [ %i.cr, %middle.block279 ]
  %.sroa.02.0.i170.ph = phi ptr [ %i.cb, %.lr.ph173.preheader ], [ %i.ci, %middle.block279 ]
  br label %.lr.ph173, !dbg !9002

.lr.ph173:                                        ; preds = %.lr.ph173.preheader285, %.lr.ph173
  %.sroa.0.0.i171 = phi i1 [ %i.cv, %.lr.ph173 ], [ %.sroa.0.0.i171.ph, %.lr.ph173.preheader285 ]
  %.sroa.02.0.i170 = phi ptr [ %i.cs, %.lr.ph173 ], [ %.sroa.02.0.i170.ph, %.lr.ph173.preheader285 ] ; 2 uses
  %i.cs = getelementptr inbounds nuw i8, ptr %.sroa.02.0.i170, i64 4, !dbg !9012 ; 2 uses
  %i.ct = load i32, ptr %.sroa.02.0.i170, align 4, !dbg !9003, !alias.scope !9004, !noalias !9007, !noundef !13
  %i.cu = icmp ult i32 %i.ct, %i.cc, !dbg !9009
  %i.cv = and i1 %.sroa.0.0.i171, %i.cu, !dbg !9010 ; 2 uses
  %i.cw = icmp eq ptr %i.cs, %i.cd, !dbg !8999
  br i1 %i.cw, label %._crit_edge174, label %.lr.ph173, !dbg !9002, !llvm.loop !9014

._crit_edge174:                                   ; preds = %.lr.ph173, %middle.block279
  %.lcssa = phi i1 [ %i.cr, %middle.block279 ], [ %i.cv, %.lr.ph173 ], !dbg !9010
...
.lr.ph179:                                        ; preds = %bb.t, %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63.thread
  ...
  %i.cx = call { i64, i64 } @_RNvMs2_NtNtNtNtCsfISxE4fmY1Y_14polars_parquet7parquet8encoding9bitpacked6decodeINtB5_14ChunkedDecodermE9next_intoBd_(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.n, ptr noalias noundef nonnull align 4 dereferenceable(128) %i.a), !dbg !9049, !noalias !9050
  %i.cy = extractvalue { i64, i64 } %i.cx, 0, !dbg !9049
  %i.cz = trunc nuw i64 %i.cy to i1, !dbg !9051
  br i1 %i.cz, label %bb.aa, label %bb.z, !dbg !9051
...
bb.aa:                                            ; preds = %.lr.ph179
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !dbg !9053, !noalias !9042
  %i.da = load i32, ptr %i.v, align 4, !dbg !9057, !alias.scope !9060, !noundef !13
  %i.db = load <32 x i32>, ptr %i.m, align 4, !dbg !9063, !alias.scope !9065, !noalias !9068
  %i.dc = insertelement <32 x i32> poison, i32 %i.da, i64 0, !dbg !9070
  %i.dd = shufflevector <32 x i32> %i.dc, <32 x i32> poison, <32 x i32> zeroinitializer, !dbg !9070
  %i.de = icmp uge <32 x i32> %i.db, %i.dd, !dbg !9071
  %i.df = bitcast <32 x i1> %i.de to i32, !dbg !9071
  %i.dg = icmp eq i32 %i.df, 0, !dbg !9071
  br i1 %i.dg, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63.thread, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63, !dbg !9072, !prof !3295
...
.loopexit:                                        ; preds = %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit63.thread, %bb.t, %bb.z
  ...
  %i.dh = load i64, ptr %i.j, align 8, !dbg !9078, !range !431, !noundef !13
  %i.di = trunc nuw i64 %i.dh to i1, !dbg !9081
  br i1 %i.di, label %bb.ab, label %bb.af, !dbg !9081
...
bb.ab:                                            ; preds = %.loopexit
  ...
  %i.dj = load i64, ptr %i.aw, align 8, !dbg !9083, !noundef !13 ; 4 uses
  %i.dk = icmp ult i64 %i.dj, 33
  br i1 %i.dk, label %bb.ad, label %bb.ac, !dbg !9084, !prof !576

bb.ac:                                            ; preds = %bb.ab
  call void @_RNvNtNtCscgRAwXFJnXP_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %i.dj, i64 noundef 32, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @17) #37, !dbg !9096
  unreachable

bb.ad:                                            ; preds = %bb.ab
  %i.dl = load i32, ptr %i.v, align 4, !dbg !9097, !alias.scope !9099, !noundef !13 ; 2 uses
  %.idx = shl nuw nsw i64 %i.dj, 2, !dbg !9102    ; 2 uses
  %i.dm = getelementptr inbounds nuw i8, ptr %i.i, i64 %.idx, !dbg !9102 ; 2 uses
  %i.dn = icmp eq i64 %i.dj, 0, !dbg !9108
  br i1 %i.dn, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit60.thread, label %.lr.ph183.preheader, !dbg !9111

.lr.ph183.preheader:                              ; preds = %bb.ad
  %i.do = add nsw i64 %.idx, -4, !dbg !9111       ; 2 uses
  %i.dp = lshr exact i64 %i.do, 2, !dbg !9111
  %i.dq = add nuw nsw i64 %i.dp, 1, !dbg !9111    ; 2 uses
  %min.iters.check = icmp ult i64 %i.do, 28, !dbg !9111
  br i1 %min.iters.check, label %.lr.ph183.preheader284, label %vector.ph, !dbg !9111

vector.ph:                                        ; preds = %.lr.ph183.preheader
  %n.vec = and i64 %i.dq, 9223372036854775800     ; 5 uses
  %i.dr = shl i64 %n.vec, 2
  %i.ds = getelementptr i8, ptr %i.i, i64 %i.dr
  ...
  %i.dt = icmp ult <4 x i32> %wide.load, %broadcast.splat, !dbg !9118 ; 2 uses
  %i.du = icmp ult <4 x i32> %wide.load264, %broadcast.splat, !dbg !9118 ; 2 uses
  %i.dv = icmp eq i64 %n.vec, 8, !dbg !9111
  br i1 %i.dv, label %middle.block, label %vector.body.1, !dbg !9111
...
vector.body.1:                                    ; preds = %vector.ph
  ...
  %i.dw = icmp ult <4 x i32> %wide.load.1, %broadcast.splat, !dbg !9118
  %i.dx = icmp ult <4 x i32> %wide.load264.1, %broadcast.splat, !dbg !9118
  %i.dy = and <4 x i1> %i.dt, %i.dw, !dbg !9119   ; 2 uses
  %i.dz = and <4 x i1> %i.du, %i.dx, !dbg !9119   ; 2 uses
  %i.ea = icmp eq i64 %n.vec, 16, !dbg !9111
  br i1 %i.ea, label %middle.block, label %vector.body.2, !dbg !9111
...
vector.body.2:                                    ; preds = %vector.body.1
  ...
  %i.eb = icmp ult <4 x i32> %wide.load.2, %broadcast.splat, !dbg !9118
  %i.ec = icmp ult <4 x i32> %wide.load264.2, %broadcast.splat, !dbg !9118
  %i.ed = and <4 x i1> %i.dy, %i.eb, !dbg !9119   ; 2 uses
  %i.ee = and <4 x i1> %i.dz, %i.ec, !dbg !9119   ; 2 uses
  %i.ef = icmp eq i64 %n.vec, 24, !dbg !9111
  br i1 %i.ef, label %middle.block, label %vector.body.3, !dbg !9111
...
vector.body.3:                                    ; preds = %vector.body.2
  ...
  %i.eg = icmp ult <4 x i32> %wide.load.3, %broadcast.splat, !dbg !9118
  %i.eh = icmp ult <4 x i32> %wide.load264.3, %broadcast.splat, !dbg !9118
  %i.ei = and <4 x i1> %i.ed, %i.eg, !dbg !9119
  %i.ej = and <4 x i1> %i.ee, %i.eh, !dbg !9119
  br label %middle.block, !dbg !9111

middle.block:                                     ; preds = %vector.body.3, %vector.body.2, %vector.body.1, %vector.ph
  %.lcssa303 = phi <4 x i1> [ %i.dt, %vector.ph ], [ %i.dy, %vector.body.1 ], [ %i.ed, %vector.body.2 ], [ %i.ei, %vector.body.3 ], !dbg !9119
  %.lcssa302 = phi <4 x i1> [ %i.du, %vector.ph ], [ %i.dz, %vector.body.1 ], [ %i.ee, %vector.body.2 ], [ %i.ej, %vector.body.3 ], !dbg !9119
  %bin.rdx = and <4 x i1> %.lcssa302, %.lcssa303, !dbg !9111
  %i.ek = bitcast <4 x i1> %bin.rdx to i4, !dbg !9111
  %i.el = icmp eq i4 %i.ek, -1, !dbg !9111        ; 2 uses
  %cmp.n = icmp eq i64 %i.dq, %n.vec, !dbg !9111
  br i1 %cmp.n, label %._crit_edge184, label %.lr.ph183.preheader284, !dbg !9111

.lr.ph183.preheader284:                           ; preds = %.lr.ph183.preheader, %middle.block
  %.sroa.0.0.i59181.ph = phi i1 [ true, %.lr.ph183.preheader ], [ %i.el, %middle.block ]
  %.sroa.02.0.i58180.ph = phi ptr [ %i.i, %.lr.ph183.preheader ], [ %i.ds, %middle.block ]
  br label %.lr.ph183, !dbg !9111
...
vector.body273:                                   ; preds = %vector.body273, %vector.ph269
  ...
  %i.co = shl i64 %index274, 2
  %next.gep277 = getelementptr i8, ptr %i.cf, i64 %i.co ; 2 uses
  %i.cp = getelementptr i8, ptr %next.gep277, i64 16, !dbg !9341
  %wide.load278 = load <4 x i32>, ptr %next.gep277, align 4, !dbg !9341, !alias.scope !9342, !noalias !9345
  %wide.load279 = load <4 x i32>, ptr %i.cp, align 4, !dbg !9341, !alias.scope !9342, !noalias !9345
  %i.cq = icmp ult <4 x i32> %wide.load278, %broadcast.splat272, !dbg !9347
  %i.cr = icmp ult <4 x i32> %wide.load279, %broadcast.splat272, !dbg !9347
  %i.cs = and <4 x i1> %vec.phi275, %i.cq, !dbg !9348 ; 2 uses
  %i.ct = and <4 x i1> %vec.phi276, %i.cr, !dbg !9348 ; 2 uses
  %index.next280 = add nuw i64 %index274, 8       ; 2 uses
  %i.cu = icmp eq i64 %index.next280, %n.vec270, !dbg !9340
  br i1 %i.cu, label %middle.block281, label %vector.body273, !dbg !9340, !llvm.loop !9349

middle.block281:                                  ; preds = %vector.body273
  %bin.rdx282 = and <4 x i1> %i.ct, %i.cs, !dbg !9340
  %i.cv = bitcast <4 x i1> %bin.rdx282 to i4, !dbg !9340
  %i.cw = icmp eq i4 %i.cv, -1, !dbg !9340        ; 2 uses
  %cmp.n283 = icmp eq i64 %i.cl, %n.vec270, !dbg !9340
...
.lr.ph174:                                        ; preds = %.lr.ph174.preheader287, %.lr.ph174
  %.sroa.0.0.i172 = phi i1 [ %i.da, %.lr.ph174 ], [ %.sroa.0.0.i172.ph, %.lr.ph174.preheader287 ]
  %.sroa.02.0.i171 = phi ptr [ %i.cx, %.lr.ph174 ], [ %.sroa.02.0.i171.ph, %.lr.ph174.preheader287 ] ; 2 uses
  %i.cx = getelementptr inbounds nuw i8, ptr %.sroa.02.0.i171, i64 4, !dbg !9350 ; 2 uses
  %i.cy = load i32, ptr %.sroa.02.0.i171, align 4, !dbg !9341, !alias.scope !9342, !noalias !9345, !noundef !13
  %i.cz = icmp ult i32 %i.cy, %i.ch, !dbg !9347
  %i.da = and i1 %.sroa.0.0.i172, %i.cz, !dbg !9348 ; 2 uses
  %i.db = icmp eq ptr %i.cx, %i.ci, !dbg !9337
  br i1 %i.db, label %._crit_edge175, label %.lr.ph174, !dbg !9340, !llvm.loop !9352

._crit_edge175:                                   ; preds = %.lr.ph174, %middle.block281
  %.lcssa = phi i1 [ %i.cw, %middle.block281 ], [ %i.da, %.lr.ph174 ], !dbg !9348
...
.lr.ph180:                                        ; preds = %bb.s, %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit59.thread
  ...
  %i.dc = call { i64, i64 } @_RNvMs2_NtNtNtNtCsfISxE4fmY1Y_14polars_parquet7parquet8encoding9bitpacked6decodeINtB5_14ChunkedDecodermE9next_intoBd_(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.n, ptr noalias noundef nonnull align 4 dereferenceable(128) %i.a), !dbg !9387, !noalias !9388
  %i.dd = extractvalue { i64, i64 } %i.dc, 0, !dbg !9387
  %i.de = trunc nuw i64 %i.dd to i1, !dbg !9389
  br i1 %i.de, label %bb.z, label %bb.y, !dbg !9389
...
bb.z:                                             ; preds = %.lr.ph180
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !dbg !9391, !noalias !9380
  %i.df = load i64, ptr %i.w, align 8, !dbg !9395, !alias.scope !9398, !noundef !13
  %i.dg = trunc i64 %i.df to i32, !dbg !9401
  %i.dh = load <32 x i32>, ptr %i.m, align 4, !dbg !9403, !alias.scope !9404, !noalias !9407
  %i.di = insertelement <32 x i32> poison, i32 %i.dg, i64 0, !dbg !9409
  %i.dj = shufflevector <32 x i32> %i.di, <32 x i32> poison, <32 x i32> zeroinitializer, !dbg !9409
  %i.dk = icmp uge <32 x i32> %i.dh, %i.dj, !dbg !9410
  %i.dl = bitcast <32 x i1> %i.dk to i32, !dbg !9410
  %i.dm = icmp eq i32 %i.dl, 0, !dbg !9410
  br i1 %i.dm, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit59.thread, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit59, !dbg !9411, !prof !3295
...
.loopexit:                                        ; preds = %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit59.thread, %bb.s, %bb.y
  ...
  %i.dn = load i64, ptr %i.j, align 8, !dbg !9417, !range !431, !noundef !13
  %i.do = trunc nuw i64 %i.dn to i1, !dbg !9420
  br i1 %i.do, label %bb.aa, label %bb.ae, !dbg !9420
...
bb.aa:                                            ; preds = %.loopexit
  ...
  %i.dp = load i64, ptr %i.ax, align 8, !dbg !9422, !noundef !13 ; 4 uses
  %i.dq = icmp ult i64 %i.dp, 33
  br i1 %i.dq, label %bb.ac, label %bb.ab, !dbg !9423, !prof !576

bb.ab:                                            ; preds = %bb.aa
  call void @_RNvNtNtCscgRAwXFJnXP_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %i.dp, i64 noundef 32, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @17) #37, !dbg !9435
  unreachable

bb.ac:                                            ; preds = %bb.aa
  %i.dr = load i64, ptr %i.w, align 8, !dbg !9436, !alias.scope !9438, !noundef !13
  %i.ds = trunc i64 %i.dr to i32, !dbg !9441      ; 2 uses
  %.idx = shl nuw nsw i64 %i.dp, 2, !dbg !9443    ; 2 uses
  %i.dt = getelementptr inbounds nuw i8, ptr %i.i, i64 %.idx, !dbg !9443 ; 2 uses
  %i.du = icmp eq i64 %i.dp, 0, !dbg !9448
  br i1 %i.du, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit56.thread, label %.lr.ph184.preheader, !dbg !9451

.lr.ph184.preheader:                              ; preds = %bb.ac
  %i.dv = add nsw i64 %.idx, -4, !dbg !9451       ; 2 uses
  %i.dw = lshr exact i64 %i.dv, 2, !dbg !9451
  %i.dx = add nuw nsw i64 %i.dw, 1, !dbg !9451    ; 2 uses
  %min.iters.check = icmp ult i64 %i.dv, 28, !dbg !9451
...
vector.ph:                                        ; preds = %.lr.ph184.preheader
  ...
  %i.ea = icmp ult <4 x i32> %wide.load, %broadcast.splat, !dbg !9458 ; 2 uses
  %i.eb = icmp ult <4 x i32> %wide.load266, %broadcast.splat, !dbg !9458 ; 2 uses
  %i.ec = icmp eq i64 %n.vec, 8, !dbg !9451
  br i1 %i.ec, label %middle.block, label %vector.body.1, !dbg !9451
...
vector.body.1:                                    ; preds = %vector.ph
  ...
  %i.ed = icmp ult <4 x i32> %wide.load.1, %broadcast.splat, !dbg !9458
  %i.ee = icmp ult <4 x i32> %wide.load266.1, %broadcast.splat, !dbg !9458
  %i.ef = and <4 x i1> %i.ea, %i.ed, !dbg !9459   ; 2 uses
  %i.eg = and <4 x i1> %i.eb, %i.ee, !dbg !9459   ; 2 uses
  %i.eh = icmp eq i64 %n.vec, 16, !dbg !9451
  br i1 %i.eh, label %middle.block, label %vector.body.2, !dbg !9451
...
vector.body.2:                                    ; preds = %vector.body.1
  ...
  %i.ei = icmp ult <4 x i32> %wide.load.2, %broadcast.splat, !dbg !9458
  %i.ej = icmp ult <4 x i32> %wide.load266.2, %broadcast.splat, !dbg !9458
  %i.ek = and <4 x i1> %i.ef, %i.ei, !dbg !9459   ; 2 uses
  %i.el = and <4 x i1> %i.eg, %i.ej, !dbg !9459   ; 2 uses
  %i.em = icmp eq i64 %n.vec, 24, !dbg !9451
  br i1 %i.em, label %middle.block, label %vector.body.3, !dbg !9451
...
vector.body.3:                                    ; preds = %vector.body.2
  ...
  %i.en = icmp ult <4 x i32> %wide.load.3, %broadcast.splat, !dbg !9458
  %i.eo = icmp ult <4 x i32> %wide.load266.3, %broadcast.splat, !dbg !9458
  %i.ep = and <4 x i1> %i.ek, %i.en, !dbg !9459
  %i.eq = and <4 x i1> %i.el, %i.eo, !dbg !9459
  br label %middle.block, !dbg !9451

middle.block:                                     ; preds = %vector.body.3, %vector.body.2, %vector.body.1, %vector.ph
  %.lcssa305 = phi <4 x i1> [ %i.ea, %vector.ph ], [ %i.ef, %vector.body.1 ], [ %i.ek, %vector.body.2 ], [ %i.ep, %vector.body.3 ], !dbg !9459
  %.lcssa304 = phi <4 x i1> [ %i.eb, %vector.ph ], [ %i.eg, %vector.body.1 ], [ %i.el, %vector.body.2 ], [ %i.eq, %vector.body.3 ], !dbg !9459
  %bin.rdx = and <4 x i1> %.lcssa304, %.lcssa305, !dbg !9451
  %i.er = bitcast <4 x i1> %bin.rdx to i4, !dbg !9451
  %i.es = icmp eq i4 %i.er, -1, !dbg !9451        ; 2 uses
  %cmp.n = icmp eq i64 %i.dx, %n.vec, !dbg !9451
  br i1 %cmp.n, label %._crit_edge185, label %.lr.ph184.preheader286, !dbg !9451

.lr.ph184.preheader286:                           ; preds = %.lr.ph184.preheader, %middle.block
  %.sroa.0.0.i55182.ph = phi i1 [ true, %.lr.ph184.preheader ], [ %i.es, %middle.block ]
  %.sroa.02.0.i54181.ph = phi ptr [ %i.i, %.lr.ph184.preheader ], [ %i.dz, %middle.block ]
  br label %.lr.ph184, !dbg !9451
end_hunk_6
...
vector.ph264:                                     ; preds = %.lr.ph169.preheader
  %n.vec265 = and i64 %i.cm, 9223372036854775800  ; 3 uses
  %i.cn = shl i64 %n.vec265, 2
  %i.co = getelementptr i8, ptr %i.cg, i64 %i.cn
...
vector.body268:                                   ; preds = %vector.body268, %vector.ph264
  ...
  %vec.phi270 = phi <4 x i1> [ splat (i1 true), %vector.ph264 ], [ %i.ct, %vector.body268 ]
  %vec.phi271 = phi <4 x i1> [ splat (i1 true), %vector.ph264 ], [ %i.cu, %vector.body268 ]
  %i.cp = shl i64 %index269, 2
  %next.gep272 = getelementptr i8, ptr %i.cg, i64 %i.cp ; 2 uses
  %i.cq = getelementptr i8, ptr %next.gep272, i64 16, !dbg !9678
  %wide.load273 = load <4 x i32>, ptr %next.gep272, align 4, !dbg !9678, !alias.scope !9679, !noalias !9682
  %wide.load274 = load <4 x i32>, ptr %i.cq, align 4, !dbg !9678, !alias.scope !9679, !noalias !9682
  %i.cr = icmp ult <4 x i32> %wide.load273, %broadcast.splat267, !dbg !9684
  %i.cs = icmp ult <4 x i32> %wide.load274, %broadcast.splat267, !dbg !9684
  %i.ct = and <4 x i1> %vec.phi270, %i.cr, !dbg !9685 ; 2 uses
  %i.cu = and <4 x i1> %vec.phi271, %i.cs, !dbg !9685 ; 2 uses
  %index.next275 = add nuw i64 %index269, 8       ; 2 uses
  %i.cv = icmp eq i64 %index.next275, %n.vec265, !dbg !9677
  br i1 %i.cv, label %middle.block276, label %vector.body268, !dbg !9677, !llvm.loop !9686

middle.block276:                                  ; preds = %vector.body268
  %bin.rdx277 = and <4 x i1> %i.cu, %i.ct, !dbg !9677
  %i.cw = bitcast <4 x i1> %bin.rdx277 to i4, !dbg !9677
  %i.cx = icmp eq i4 %i.cw, -1, !dbg !9677        ; 2 uses
  %cmp.n278 = icmp eq i64 %i.cm, %n.vec265, !dbg !9677
...
.lr.ph169.preheader282:                           ; preds = %.lr.ph169.preheader, %middle.block276
  %.sroa.0.0.i167.ph = phi i1 [ true, %.lr.ph169.preheader ], [ %i.cx, %middle.block276 ]
  %.sroa.02.0.i166.ph = phi ptr [ %i.cg, %.lr.ph169.preheader ], [ %i.co, %middle.block276 ]
  br label %.lr.ph169, !dbg !9677

.lr.ph169:                                        ; preds = %.lr.ph169.preheader282, %.lr.ph169
  %.sroa.0.0.i167 = phi i1 [ %i.db, %.lr.ph169 ], [ %.sroa.0.0.i167.ph, %.lr.ph169.preheader282 ]
  %.sroa.02.0.i166 = phi ptr [ %i.cy, %.lr.ph169 ], [ %.sroa.02.0.i166.ph, %.lr.ph169.preheader282 ] ; 2 uses
  %i.cy = getelementptr inbounds nuw i8, ptr %.sroa.02.0.i166, i64 4, !dbg !9687 ; 2 uses
  %i.cz = load i32, ptr %.sroa.02.0.i166, align 4, !dbg !9678, !alias.scope !9679, !noalias !9682, !noundef !13
  %i.da = icmp ult i32 %i.cz, %i.ci, !dbg !9684
  %i.db = and i1 %.sroa.0.0.i167, %i.da, !dbg !9685 ; 2 uses
  %i.dc = icmp eq ptr %i.cy, %i.cj, !dbg !9674
  br i1 %i.dc, label %._crit_edge170, label %.lr.ph169, !dbg !9677, !llvm.loop !9689

._crit_edge170:                                   ; preds = %.lr.ph169, %middle.block276
  %.lcssa = phi i1 [ %i.cx, %middle.block276 ], [ %i.db, %.lr.ph169 ], !dbg !9685
...
.lr.ph175:                                        ; preds = %bb.s, %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit56.thread
  ...
  %i.dd = call { i64, i64 } @_RNvMs2_NtNtNtNtCsfISxE4fmY1Y_14polars_parquet7parquet8encoding9bitpacked6decodeINtB5_14ChunkedDecodermE9next_intoBd_(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.n, ptr noalias noundef nonnull align 4 dereferenceable(128) %i.a), !dbg !9724, !noalias !9725
  %i.de = extractvalue { i64, i64 } %i.dd, 0, !dbg !9724
  %i.df = trunc nuw i64 %i.de to i1, !dbg !9726
  br i1 %i.df, label %bb.z, label %bb.y, !dbg !9726
...
bb.z:                                             ; preds = %.lr.ph175
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !dbg !9728, !noalias !9717
  %i.dg = load i64, ptr %i.x, align 8, !dbg !9732, !alias.scope !9735, !noundef !13
  %i.dh = trunc i64 %i.dg to i32, !dbg !9738
  %i.di = load <32 x i32>, ptr %i.m, align 4, !dbg !9740, !alias.scope !9741, !noalias !9744
  %i.dj = insertelement <32 x i32> poison, i32 %i.dh, i64 0, !dbg !9746
  %i.dk = shufflevector <32 x i32> %i.dj, <32 x i32> poison, <32 x i32> zeroinitializer, !dbg !9746
  %i.dl = icmp uge <32 x i32> %i.di, %i.dk, !dbg !9747
  %i.dm = bitcast <32 x i1> %i.dl to i32, !dbg !9747
  %i.dn = icmp eq i32 %i.dm, 0, !dbg !9747
  br i1 %i.dn, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit56.thread, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit56, !dbg !9748, !prof !3295
...
.loopexit:                                        ; preds = %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit56.thread, %bb.s, %bb.y
  ...
  %i.do = load i64, ptr %i.j, align 8, !dbg !9754, !range !431, !noundef !13
  %i.dp = trunc nuw i64 %i.do to i1, !dbg !9757
  br i1 %i.dp, label %bb.aa, label %bb.ae, !dbg !9757
...
bb.aa:                                            ; preds = %.loopexit
  ...
  %i.dq = load i64, ptr %i.ay, align 8, !dbg !9759, !noundef !13 ; 4 uses
  %i.dr = icmp ult i64 %i.dq, 33
  br i1 %i.dr, label %bb.ac, label %bb.ab, !dbg !9760, !prof !576

bb.ab:                                            ; preds = %bb.aa
  call void @_RNvNtNtCscgRAwXFJnXP_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %i.dq, i64 noundef 32, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @17) #37, !dbg !9772
  unreachable

bb.ac:                                            ; preds = %bb.aa
  %i.ds = load i64, ptr %i.x, align 8, !dbg !9773, !alias.scope !9775, !noundef !13
  %i.dt = trunc i64 %i.ds to i32, !dbg !9778      ; 2 uses
  %.idx = shl nuw nsw i64 %i.dq, 2, !dbg !9780    ; 2 uses
  %i.du = getelementptr inbounds nuw i8, ptr %i.i, i64 %.idx, !dbg !9780 ; 2 uses
  %i.dv = icmp eq i64 %i.dq, 0, !dbg !9785
  br i1 %i.dv, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit53.thread, label %.lr.ph179.preheader, !dbg !9788

.lr.ph179.preheader:                              ; preds = %bb.ac
  %i.dw = add nsw i64 %.idx, -4, !dbg !9788       ; 2 uses
  %i.dx = lshr exact i64 %i.dw, 2, !dbg !9788
  %i.dy = add nuw nsw i64 %i.dx, 1, !dbg !9788    ; 2 uses
  %min.iters.check = icmp ult i64 %i.dw, 28, !dbg !9788
  br i1 %min.iters.check, label %.lr.ph179.preheader281, label %vector.ph, !dbg !9788

vector.ph:                                        ; preds = %.lr.ph179.preheader
  %n.vec = and i64 %i.dy, 9223372036854775800     ; 5 uses
  %i.dz = shl i64 %n.vec, 2
  %i.ea = getelementptr i8, ptr %i.i, i64 %i.dz
  %broadcast.splatinsert = insertelement <4 x i32> poison, i32 %i.dt, i64 0
  %broadcast.splat = shufflevector <4 x i32> %broadcast.splatinsert, <4 x i32> poison, <4 x i32> zeroinitializer ; 8 uses
  ...
  %i.eb = icmp ult <4 x i32> %wide.load, %broadcast.splat, !dbg !9795 ; 2 uses
  %i.ec = icmp ult <4 x i32> %wide.load261, %broadcast.splat, !dbg !9795 ; 2 uses
  %i.ed = icmp eq i64 %n.vec, 8, !dbg !9788
  br i1 %i.ed, label %middle.block, label %vector.body.1, !dbg !9788
...
vector.body.1:                                    ; preds = %vector.ph
  ...
  %i.ee = icmp ult <4 x i32> %wide.load.1, %broadcast.splat, !dbg !9795
  %i.ef = icmp ult <4 x i32> %wide.load261.1, %broadcast.splat, !dbg !9795
  %i.eg = and <4 x i1> %i.eb, %i.ee, !dbg !9796   ; 2 uses
  %i.eh = and <4 x i1> %i.ec, %i.ef, !dbg !9796   ; 2 uses
  %i.ei = icmp eq i64 %n.vec, 16, !dbg !9788
  br i1 %i.ei, label %middle.block, label %vector.body.2, !dbg !9788
...
vector.body.2:                                    ; preds = %vector.body.1
  ...
  %i.ej = icmp ult <4 x i32> %wide.load.2, %broadcast.splat, !dbg !9795
  %i.ek = icmp ult <4 x i32> %wide.load261.2, %broadcast.splat, !dbg !9795
  %i.el = and <4 x i1> %i.eg, %i.ej, !dbg !9796   ; 2 uses
  %i.em = and <4 x i1> %i.eh, %i.ek, !dbg !9796   ; 2 uses
  %i.en = icmp eq i64 %n.vec, 24, !dbg !9788
  br i1 %i.en, label %middle.block, label %vector.body.3, !dbg !9788
...
vector.body.3:                                    ; preds = %vector.body.2
  ...
  %i.eo = icmp ult <4 x i32> %wide.load.3, %broadcast.splat, !dbg !9795
  %i.ep = icmp ult <4 x i32> %wide.load261.3, %broadcast.splat, !dbg !9795
  %i.eq = and <4 x i1> %i.el, %i.eo, !dbg !9796
  %i.er = and <4 x i1> %i.em, %i.ep, !dbg !9796
  br label %middle.block, !dbg !9788

middle.block:                                     ; preds = %vector.body.3, %vector.body.2, %vector.body.1, %vector.ph
  %.lcssa300 = phi <4 x i1> [ %i.eb, %vector.ph ], [ %i.eg, %vector.body.1 ], [ %i.el, %vector.body.2 ], [ %i.eq, %vector.body.3 ], !dbg !9796
  %.lcssa299 = phi <4 x i1> [ %i.ec, %vector.ph ], [ %i.eh, %vector.body.1 ], [ %i.em, %vector.body.2 ], [ %i.er, %vector.body.3 ], !dbg !9796
  %bin.rdx = and <4 x i1> %.lcssa299, %.lcssa300, !dbg !9788
  %i.es = bitcast <4 x i1> %bin.rdx to i4, !dbg !9788
  %i.et = icmp eq i4 %i.es, -1, !dbg !9788        ; 2 uses
  %cmp.n = icmp eq i64 %i.dy, %n.vec, !dbg !9788
...
.lr.ph179.preheader281:                           ; preds = %.lr.ph179.preheader, %middle.block
  %.sroa.0.0.i52177.ph = phi i1 [ true, %.lr.ph179.preheader ], [ %i.et, %middle.block ]
  %.sroa.02.0.i51176.ph = phi ptr [ %i.i, %.lr.ph179.preheader ], [ %i.ea, %middle.block ]
  br label %.lr.ph179, !dbg !9788
end_hunk_7
...
vector.body268:                                   ; preds = %vector.body268, %vector.ph264
  ...
  %i.cp = shl i64 %index269, 2
  %next.gep272 = getelementptr i8, ptr %i.cg, i64 %i.cp ; 2 uses
  %i.cq = getelementptr i8, ptr %next.gep272, i64 16, !dbg !10015
  %wide.load273 = load <4 x i32>, ptr %next.gep272, align 4, !dbg !10015, !alias.scope !10016, !noalias !10019
  %wide.load274 = load <4 x i32>, ptr %i.cq, align 4, !dbg !10015, !alias.scope !10016, !noalias !10019
  %i.cr = icmp ult <4 x i32> %wide.load273, %broadcast.splat267, !dbg !10021
  %i.cs = icmp ult <4 x i32> %wide.load274, %broadcast.splat267, !dbg !10021
  %i.ct = and <4 x i1> %vec.phi270, %i.cr, !dbg !10022 ; 2 uses
  %i.cu = and <4 x i1> %vec.phi271, %i.cs, !dbg !10022 ; 2 uses
  %index.next275 = add nuw i64 %index269, 8       ; 2 uses
  %i.cv = icmp eq i64 %index.next275, %n.vec265, !dbg !10014
  br i1 %i.cv, label %middle.block276, label %vector.body268, !dbg !10014, !llvm.loop !10023

middle.block276:                                  ; preds = %vector.body268
  %bin.rdx277 = and <4 x i1> %i.cu, %i.ct, !dbg !10014
  %i.cw = bitcast <4 x i1> %bin.rdx277 to i4, !dbg !10014
  %i.cx = icmp eq i4 %i.cw, -1, !dbg !10014       ; 2 uses
  %cmp.n278 = icmp eq i64 %i.cm, %n.vec265, !dbg !10014
...
.lr.ph169:                                        ; preds = %.lr.ph169.preheader282, %.lr.ph169
  %.sroa.0.0.i167 = phi i1 [ %i.db, %.lr.ph169 ], [ %.sroa.0.0.i167.ph, %.lr.ph169.preheader282 ]
  %.sroa.02.0.i166 = phi ptr [ %i.cy, %.lr.ph169 ], [ %.sroa.02.0.i166.ph, %.lr.ph169.preheader282 ] ; 2 uses
  %i.cy = getelementptr inbounds nuw i8, ptr %.sroa.02.0.i166, i64 4, !dbg !10024 ; 2 uses
  %i.cz = load i32, ptr %.sroa.02.0.i166, align 4, !dbg !10015, !alias.scope !10016, !noalias !10019, !noundef !13
  %i.da = icmp ult i32 %i.cz, %i.ci, !dbg !10021
  %i.db = and i1 %.sroa.0.0.i167, %i.da, !dbg !10022 ; 2 uses
  %i.dc = icmp eq ptr %i.cy, %i.cj, !dbg !10011
  br i1 %i.dc, label %._crit_edge170, label %.lr.ph169, !dbg !10014, !llvm.loop !10026

._crit_edge170:                                   ; preds = %.lr.ph169, %middle.block276
  %.lcssa = phi i1 [ %i.cx, %middle.block276 ], [ %i.db, %.lr.ph169 ], !dbg !10022
...
.lr.ph175:                                        ; preds = %bb.s, %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit56.thread
  ...
  %i.dd = call { i64, i64 } @_RNvMs2_NtNtNtNtCsfISxE4fmY1Y_14polars_parquet7parquet8encoding9bitpacked6decodeINtB5_14ChunkedDecodermE9next_intoBd_(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.n, ptr noalias noundef nonnull align 4 dereferenceable(128) %i.a), !dbg !10061, !noalias !10062
  %i.de = extractvalue { i64, i64 } %i.dd, 0, !dbg !10061
  %i.df = trunc nuw i64 %i.de to i1, !dbg !10063
  br i1 %i.df, label %bb.z, label %bb.y, !dbg !10063
...
bb.z:                                             ; preds = %.lr.ph175
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !dbg !10065, !noalias !10054
  %i.dg = load i64, ptr %i.x, align 8, !dbg !10069, !alias.scope !10072, !noundef !13
  %i.dh = trunc i64 %i.dg to i32, !dbg !10075
  %i.di = load <32 x i32>, ptr %i.m, align 4, !dbg !10077, !alias.scope !10078, !noalias !10081
  %i.dj = insertelement <32 x i32> poison, i32 %i.dh, i64 0, !dbg !10083
  %i.dk = shufflevector <32 x i32> %i.dj, <32 x i32> poison, <32 x i32> zeroinitializer, !dbg !10083
  %i.dl = icmp uge <32 x i32> %i.di, %i.dk, !dbg !10084
  %i.dm = bitcast <32 x i1> %i.dl to i32, !dbg !10084
  %i.dn = icmp eq i32 %i.dm, 0, !dbg !10084
  br i1 %i.dn, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit56.thread, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit56, !dbg !10085, !prof !3295
...
.loopexit:                                        ; preds = %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit56.thread, %bb.s, %bb.y
  ...
  %i.do = load i64, ptr %i.j, align 8, !dbg !10091, !range !431, !noundef !13
  %i.dp = trunc nuw i64 %i.do to i1, !dbg !10094
  br i1 %i.dp, label %bb.aa, label %bb.ae, !dbg !10094
...
bb.aa:                                            ; preds = %.loopexit
  ...
  %i.dq = load i64, ptr %i.ay, align 8, !dbg !10096, !noundef !13 ; 4 uses
  %i.dr = icmp ult i64 %i.dq, 33
  br i1 %i.dr, label %bb.ac, label %bb.ab, !dbg !10097, !prof !576

bb.ab:                                            ; preds = %bb.aa
  call void @_RNvNtNtCscgRAwXFJnXP_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %i.dq, i64 noundef 32, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @17) #37, !dbg !10109
  unreachable

bb.ac:                                            ; preds = %bb.aa
  %i.ds = load i64, ptr %i.x, align 8, !dbg !10110, !alias.scope !10112, !noundef !13
  %i.dt = trunc i64 %i.ds to i32, !dbg !10115     ; 2 uses
  %.idx = shl nuw nsw i64 %i.dq, 2, !dbg !10117   ; 2 uses
  %i.du = getelementptr inbounds nuw i8, ptr %i.i, i64 %.idx, !dbg !10117 ; 2 uses
  %i.dv = icmp eq i64 %i.dq, 0, !dbg !10122
  br i1 %i.dv, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit53.thread, label %.lr.ph179.preheader, !dbg !10125

.lr.ph179.preheader:                              ; preds = %bb.ac
  %i.dw = add nsw i64 %.idx, -4, !dbg !10125      ; 2 uses
  %i.dx = lshr exact i64 %i.dw, 2, !dbg !10125
  %i.dy = add nuw nsw i64 %i.dx, 1, !dbg !10125   ; 2 uses
  %min.iters.check = icmp ult i64 %i.dw, 28, !dbg !10125
...
vector.ph:                                        ; preds = %.lr.ph179.preheader
  ...
  %i.eb = icmp ult <4 x i32> %wide.load, %broadcast.splat, !dbg !10132 ; 2 uses
  %i.ec = icmp ult <4 x i32> %wide.load261, %broadcast.splat, !dbg !10132 ; 2 uses
  %i.ed = icmp eq i64 %n.vec, 8, !dbg !10125
  br i1 %i.ed, label %middle.block, label %vector.body.1, !dbg !10125
...
vector.body.1:                                    ; preds = %vector.ph
  ...
  %i.ee = icmp ult <4 x i32> %wide.load.1, %broadcast.splat, !dbg !10132
  %i.ef = icmp ult <4 x i32> %wide.load261.1, %broadcast.splat, !dbg !10132
  %i.eg = and <4 x i1> %i.eb, %i.ee, !dbg !10133  ; 2 uses
  %i.eh = and <4 x i1> %i.ec, %i.ef, !dbg !10133  ; 2 uses
  %i.ei = icmp eq i64 %n.vec, 16, !dbg !10125
  br i1 %i.ei, label %middle.block, label %vector.body.2, !dbg !10125
...
vector.body.2:                                    ; preds = %vector.body.1
  ...
  %i.ej = icmp ult <4 x i32> %wide.load.2, %broadcast.splat, !dbg !10132
  %i.ek = icmp ult <4 x i32> %wide.load261.2, %broadcast.splat, !dbg !10132
  %i.el = and <4 x i1> %i.eg, %i.ej, !dbg !10133  ; 2 uses
  %i.em = and <4 x i1> %i.eh, %i.ek, !dbg !10133  ; 2 uses
  %i.en = icmp eq i64 %n.vec, 24, !dbg !10125
  br i1 %i.en, label %middle.block, label %vector.body.3, !dbg !10125
...
vector.body.3:                                    ; preds = %vector.body.2
  ...
  %i.eo = icmp ult <4 x i32> %wide.load.3, %broadcast.splat, !dbg !10132
  %i.ep = icmp ult <4 x i32> %wide.load261.3, %broadcast.splat, !dbg !10132
  %i.eq = and <4 x i1> %i.el, %i.eo, !dbg !10133
  %i.er = and <4 x i1> %i.em, %i.ep, !dbg !10133
  br label %middle.block, !dbg !10125

middle.block:                                     ; preds = %vector.body.3, %vector.body.2, %vector.body.1, %vector.ph
  %.lcssa300 = phi <4 x i1> [ %i.eb, %vector.ph ], [ %i.eg, %vector.body.1 ], [ %i.el, %vector.body.2 ], [ %i.eq, %vector.body.3 ], !dbg !10133
  %.lcssa299 = phi <4 x i1> [ %i.ec, %vector.ph ], [ %i.eh, %vector.body.1 ], [ %i.em, %vector.body.2 ], [ %i.er, %vector.body.3 ], !dbg !10133
  %bin.rdx = and <4 x i1> %.lcssa299, %.lcssa300, !dbg !10125
  %i.es = bitcast <4 x i1> %bin.rdx to i4, !dbg !10125
  %i.et = icmp eq i4 %i.es, -1, !dbg !10125       ; 2 uses
  %cmp.n = icmp eq i64 %i.dy, %n.vec, !dbg !10125
  br i1 %cmp.n, label %._crit_edge180, label %.lr.ph179.preheader281, !dbg !10125

.lr.ph179.preheader281:                           ; preds = %.lr.ph179.preheader, %middle.block
  %.sroa.0.0.i52177.ph = phi i1 [ true, %.lr.ph179.preheader ], [ %i.et, %middle.block ]
  %.sroa.02.0.i51176.ph = phi ptr [ %i.i, %.lr.ph179.preheader ], [ %i.ea, %middle.block ]
  br label %.lr.ph179, !dbg !10125
end_hunk_8
...
vector.body268:                                   ; preds = %vector.body268, %vector.ph264
  ...
  %i.cp = shl i64 %index269, 2
  %next.gep272 = getelementptr i8, ptr %i.cg, i64 %i.cp ; 2 uses
  %i.cq = getelementptr i8, ptr %next.gep272, i64 16, !dbg !10352
  %wide.load273 = load <4 x i32>, ptr %next.gep272, align 4, !dbg !10352, !alias.scope !10353, !noalias !10356
  %wide.load274 = load <4 x i32>, ptr %i.cq, align 4, !dbg !10352, !alias.scope !10353, !noalias !10356
  %i.cr = icmp ult <4 x i32> %wide.load273, %broadcast.splat267, !dbg !10358
  %i.cs = icmp ult <4 x i32> %wide.load274, %broadcast.splat267, !dbg !10358
  %i.ct = and <4 x i1> %vec.phi270, %i.cr, !dbg !10359 ; 2 uses
  %i.cu = and <4 x i1> %vec.phi271, %i.cs, !dbg !10359 ; 2 uses
  %index.next275 = add nuw i64 %index269, 8       ; 2 uses
  %i.cv = icmp eq i64 %index.next275, %n.vec265, !dbg !10351
  br i1 %i.cv, label %middle.block276, label %vector.body268, !dbg !10351, !llvm.loop !10360

middle.block276:                                  ; preds = %vector.body268
  %bin.rdx277 = and <4 x i1> %i.cu, %i.ct, !dbg !10351
  %i.cw = bitcast <4 x i1> %bin.rdx277 to i4, !dbg !10351
  %i.cx = icmp eq i4 %i.cw, -1, !dbg !10351       ; 2 uses
  %cmp.n278 = icmp eq i64 %i.cm, %n.vec265, !dbg !10351
...
.lr.ph169:                                        ; preds = %.lr.ph169.preheader282, %.lr.ph169
  %.sroa.0.0.i167 = phi i1 [ %i.db, %.lr.ph169 ], [ %.sroa.0.0.i167.ph, %.lr.ph169.preheader282 ]
  %.sroa.02.0.i166 = phi ptr [ %i.cy, %.lr.ph169 ], [ %.sroa.02.0.i166.ph, %.lr.ph169.preheader282 ] ; 2 uses
  %i.cy = getelementptr inbounds nuw i8, ptr %.sroa.02.0.i166, i64 4, !dbg !10361 ; 2 uses
  %i.cz = load i32, ptr %.sroa.02.0.i166, align 4, !dbg !10352, !alias.scope !10353, !noalias !10356, !noundef !13
  %i.da = icmp ult i32 %i.cz, %i.ci, !dbg !10358
  %i.db = and i1 %.sroa.0.0.i167, %i.da, !dbg !10359 ; 2 uses
  %i.dc = icmp eq ptr %i.cy, %i.cj, !dbg !10348
  br i1 %i.dc, label %._crit_edge170, label %.lr.ph169, !dbg !10351, !llvm.loop !10363

._crit_edge170:                                   ; preds = %.lr.ph169, %middle.block276
  %.lcssa = phi i1 [ %i.cx, %middle.block276 ], [ %i.db, %.lr.ph169 ], !dbg !10359
...
.lr.ph175:                                        ; preds = %bb.s, %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit56.thread
  ...
  %i.dd = call { i64, i64 } @_RNvMs2_NtNtNtNtCsfISxE4fmY1Y_14polars_parquet7parquet8encoding9bitpacked6decodeINtB5_14ChunkedDecodermE9next_intoBd_(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.n, ptr noalias noundef nonnull align 4 dereferenceable(128) %i.a), !dbg !10398, !noalias !10399
  %i.de = extractvalue { i64, i64 } %i.dd, 0, !dbg !10398
  %i.df = trunc nuw i64 %i.de to i1, !dbg !10400
  br i1 %i.df, label %bb.z, label %bb.y, !dbg !10400
...
bb.z:                                             ; preds = %.lr.ph175
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !dbg !10402, !noalias !10391
  %i.dg = load i64, ptr %i.x, align 8, !dbg !10406, !alias.scope !10409, !noundef !13
  %i.dh = trunc i64 %i.dg to i32, !dbg !10412
  %i.di = load <32 x i32>, ptr %i.m, align 4, !dbg !10414, !alias.scope !10415, !noalias !10418
  %i.dj = insertelement <32 x i32> poison, i32 %i.dh, i64 0, !dbg !10420
  %i.dk = shufflevector <32 x i32> %i.dj, <32 x i32> poison, <32 x i32> zeroinitializer, !dbg !10420
  %i.dl = icmp uge <32 x i32> %i.di, %i.dk, !dbg !10421
  %i.dm = bitcast <32 x i1> %i.dl to i32, !dbg !10421
  %i.dn = icmp eq i32 %i.dm, 0, !dbg !10421
  br i1 %i.dn, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit56.thread, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit56, !dbg !10422, !prof !3295
...
.loopexit:                                        ; preds = %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit56.thread, %bb.s, %bb.y
  ...
  %i.do = load i64, ptr %i.j, align 8, !dbg !10428, !range !431, !noundef !13
  %i.dp = trunc nuw i64 %i.do to i1, !dbg !10431
  br i1 %i.dp, label %bb.aa, label %bb.ae, !dbg !10431
...
bb.aa:                                            ; preds = %.loopexit
  ...
  %i.dq = load i64, ptr %i.ay, align 8, !dbg !10433, !noundef !13 ; 4 uses
  %i.dr = icmp ult i64 %i.dq, 33
  br i1 %i.dr, label %bb.ac, label %bb.ab, !dbg !10434, !prof !576

bb.ab:                                            ; preds = %bb.aa
  call void @_RNvNtNtCscgRAwXFJnXP_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %i.dq, i64 noundef 32, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @17) #37, !dbg !10446
  unreachable

bb.ac:                                            ; preds = %bb.aa
  %i.ds = load i64, ptr %i.x, align 8, !dbg !10447, !alias.scope !10449, !noundef !13
  %i.dt = trunc i64 %i.ds to i32, !dbg !10452     ; 2 uses
  %.idx = shl nuw nsw i64 %i.dq, 2, !dbg !10454   ; 2 uses
  %i.du = getelementptr inbounds nuw i8, ptr %i.i, i64 %.idx, !dbg !10454 ; 2 uses
  %i.dv = icmp eq i64 %i.dq, 0, !dbg !10459
  br i1 %i.dv, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit53.thread, label %.lr.ph179.preheader, !dbg !10462

.lr.ph179.preheader:                              ; preds = %bb.ac
  %i.dw = add nsw i64 %.idx, -4, !dbg !10462      ; 2 uses
  %i.dx = lshr exact i64 %i.dw, 2, !dbg !10462
  %i.dy = add nuw nsw i64 %i.dx, 1, !dbg !10462   ; 2 uses
  %min.iters.check = icmp ult i64 %i.dw, 28, !dbg !10462
...
vector.ph:                                        ; preds = %.lr.ph179.preheader
  ...
  %i.eb = icmp ult <4 x i32> %wide.load, %broadcast.splat, !dbg !10469 ; 2 uses
  %i.ec = icmp ult <4 x i32> %wide.load261, %broadcast.splat, !dbg !10469 ; 2 uses
  %i.ed = icmp eq i64 %n.vec, 8, !dbg !10462
  br i1 %i.ed, label %middle.block, label %vector.body.1, !dbg !10462
...
vector.body.1:                                    ; preds = %vector.ph
  ...
  %i.ee = icmp ult <4 x i32> %wide.load.1, %broadcast.splat, !dbg !10469
  %i.ef = icmp ult <4 x i32> %wide.load261.1, %broadcast.splat, !dbg !10469
  %i.eg = and <4 x i1> %i.eb, %i.ee, !dbg !10470  ; 2 uses
  %i.eh = and <4 x i1> %i.ec, %i.ef, !dbg !10470  ; 2 uses
  %i.ei = icmp eq i64 %n.vec, 16, !dbg !10462
  br i1 %i.ei, label %middle.block, label %vector.body.2, !dbg !10462
...
vector.body.2:                                    ; preds = %vector.body.1
  ...
  %i.ej = icmp ult <4 x i32> %wide.load.2, %broadcast.splat, !dbg !10469
  %i.ek = icmp ult <4 x i32> %wide.load261.2, %broadcast.splat, !dbg !10469
  %i.el = and <4 x i1> %i.eg, %i.ej, !dbg !10470  ; 2 uses
  %i.em = and <4 x i1> %i.eh, %i.ek, !dbg !10470  ; 2 uses
  %i.en = icmp eq i64 %n.vec, 24, !dbg !10462
  br i1 %i.en, label %middle.block, label %vector.body.3, !dbg !10462
...
vector.body.3:                                    ; preds = %vector.body.2
  ...
  %i.eo = icmp ult <4 x i32> %wide.load.3, %broadcast.splat, !dbg !10469
  %i.ep = icmp ult <4 x i32> %wide.load261.3, %broadcast.splat, !dbg !10469
  %i.eq = and <4 x i1> %i.el, %i.eo, !dbg !10470
  %i.er = and <4 x i1> %i.em, %i.ep, !dbg !10470
  br label %middle.block, !dbg !10462

middle.block:                                     ; preds = %vector.body.3, %vector.body.2, %vector.body.1, %vector.ph
  %.lcssa300 = phi <4 x i1> [ %i.eb, %vector.ph ], [ %i.eg, %vector.body.1 ], [ %i.el, %vector.body.2 ], [ %i.eq, %vector.body.3 ], !dbg !10470
  %.lcssa299 = phi <4 x i1> [ %i.ec, %vector.ph ], [ %i.eh, %vector.body.1 ], [ %i.em, %vector.body.2 ], [ %i.er, %vector.body.3 ], !dbg !10470
  %bin.rdx = and <4 x i1> %.lcssa299, %.lcssa300, !dbg !10462
  %i.es = bitcast <4 x i1> %bin.rdx to i4, !dbg !10462
  %i.et = icmp eq i4 %i.es, -1, !dbg !10462       ; 2 uses
  %cmp.n = icmp eq i64 %i.dy, %n.vec, !dbg !10462
  br i1 %cmp.n, label %._crit_edge180, label %.lr.ph179.preheader281, !dbg !10462

.lr.ph179.preheader281:                           ; preds = %.lr.ph179.preheader, %middle.block
  %.sroa.0.0.i52177.ph = phi i1 [ true, %.lr.ph179.preheader ], [ %i.et, %middle.block ]
  %.sroa.02.0.i51176.ph = phi ptr [ %i.i, %.lr.ph179.preheader ], [ %i.ea, %middle.block ]
  br label %.lr.ph179, !dbg !10462
end_hunk_9
...
vector.body268:                                   ; preds = %vector.body268, %vector.ph264
  ...
  %i.cp = shl i64 %index269, 2
  %next.gep272 = getelementptr i8, ptr %i.cg, i64 %i.cp ; 2 uses
  %i.cq = getelementptr i8, ptr %next.gep272, i64 16, !dbg !10689
  %wide.load273 = load <4 x i32>, ptr %next.gep272, align 4, !dbg !10689, !alias.scope !10690, !noalias !10693
  %wide.load274 = load <4 x i32>, ptr %i.cq, align 4, !dbg !10689, !alias.scope !10690, !noalias !10693
  %i.cr = icmp ult <4 x i32> %wide.load273, %broadcast.splat267, !dbg !10695
  %i.cs = icmp ult <4 x i32> %wide.load274, %broadcast.splat267, !dbg !10695
  %i.ct = and <4 x i1> %vec.phi270, %i.cr, !dbg !10696 ; 2 uses
  %i.cu = and <4 x i1> %vec.phi271, %i.cs, !dbg !10696 ; 2 uses
  %index.next275 = add nuw i64 %index269, 8       ; 2 uses
  %i.cv = icmp eq i64 %index.next275, %n.vec265, !dbg !10688
  br i1 %i.cv, label %middle.block276, label %vector.body268, !dbg !10688, !llvm.loop !10697

middle.block276:                                  ; preds = %vector.body268
  %bin.rdx277 = and <4 x i1> %i.cu, %i.ct, !dbg !10688
  %i.cw = bitcast <4 x i1> %bin.rdx277 to i4, !dbg !10688
  %i.cx = icmp eq i4 %i.cw, -1, !dbg !10688       ; 2 uses
  %cmp.n278 = icmp eq i64 %i.cm, %n.vec265, !dbg !10688
...
.lr.ph169:                                        ; preds = %.lr.ph169.preheader282, %.lr.ph169
  %.sroa.0.0.i167 = phi i1 [ %i.db, %.lr.ph169 ], [ %.sroa.0.0.i167.ph, %.lr.ph169.preheader282 ]
  %.sroa.02.0.i166 = phi ptr [ %i.cy, %.lr.ph169 ], [ %.sroa.02.0.i166.ph, %.lr.ph169.preheader282 ] ; 2 uses
  %i.cy = getelementptr inbounds nuw i8, ptr %.sroa.02.0.i166, i64 4, !dbg !10698 ; 2 uses
  %i.cz = load i32, ptr %.sroa.02.0.i166, align 4, !dbg !10689, !alias.scope !10690, !noalias !10693, !noundef !13
  %i.da = icmp ult i32 %i.cz, %i.ci, !dbg !10695
  %i.db = and i1 %.sroa.0.0.i167, %i.da, !dbg !10696 ; 2 uses
  %i.dc = icmp eq ptr %i.cy, %i.cj, !dbg !10685
  br i1 %i.dc, label %._crit_edge170, label %.lr.ph169, !dbg !10688, !llvm.loop !10700

._crit_edge170:                                   ; preds = %.lr.ph169, %middle.block276
  %.lcssa = phi i1 [ %i.cx, %middle.block276 ], [ %i.db, %.lr.ph169 ], !dbg !10696
...
.lr.ph175:                                        ; preds = %bb.s, %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit56.thread
  ...
  %i.dd = call { i64, i64 } @_RNvMs2_NtNtNtNtCsfISxE4fmY1Y_14polars_parquet7parquet8encoding9bitpacked6decodeINtB5_14ChunkedDecodermE9next_intoBd_(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.n, ptr noalias noundef nonnull align 4 dereferenceable(128) %i.a), !dbg !10735, !noalias !10736
  %i.de = extractvalue { i64, i64 } %i.dd, 0, !dbg !10735
  %i.df = trunc nuw i64 %i.de to i1, !dbg !10737
  br i1 %i.df, label %bb.z, label %bb.y, !dbg !10737
...
bb.z:                                             ; preds = %.lr.ph175
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !dbg !10739, !noalias !10728
  %i.dg = load i64, ptr %i.x, align 8, !dbg !10743, !alias.scope !10746, !noundef !13
  %i.dh = trunc i64 %i.dg to i32, !dbg !10749
  %i.di = load <32 x i32>, ptr %i.m, align 4, !dbg !10751, !alias.scope !10752, !noalias !10755
  %i.dj = insertelement <32 x i32> poison, i32 %i.dh, i64 0, !dbg !10757
  %i.dk = shufflevector <32 x i32> %i.dj, <32 x i32> poison, <32 x i32> zeroinitializer, !dbg !10757
  %i.dl = icmp uge <32 x i32> %i.di, %i.dk, !dbg !10758
  %i.dm = bitcast <32 x i1> %i.dl to i32, !dbg !10758
  %i.dn = icmp eq i32 %i.dm, 0, !dbg !10758
  br i1 %i.dn, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit56.thread, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit56, !dbg !10759, !prof !3295
...
.loopexit:                                        ; preds = %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit56.thread, %bb.s, %bb.y
  ...
  %i.do = load i64, ptr %i.j, align 8, !dbg !10765, !range !431, !noundef !13
  %i.dp = trunc nuw i64 %i.do to i1, !dbg !10768
  br i1 %i.dp, label %bb.aa, label %bb.ae, !dbg !10768
...
bb.aa:                                            ; preds = %.loopexit
  ...
  %i.dq = load i64, ptr %i.ay, align 8, !dbg !10770, !noundef !13 ; 4 uses
  %i.dr = icmp ult i64 %i.dq, 33
  br i1 %i.dr, label %bb.ac, label %bb.ab, !dbg !10771, !prof !576

bb.ab:                                            ; preds = %bb.aa
  call void @_RNvNtNtCscgRAwXFJnXP_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %i.dq, i64 noundef 32, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @17) #37, !dbg !10783
  unreachable

bb.ac:                                            ; preds = %bb.aa
  %i.ds = load i64, ptr %i.x, align 8, !dbg !10784, !alias.scope !10786, !noundef !13
  %i.dt = trunc i64 %i.ds to i32, !dbg !10789     ; 2 uses
  %.idx = shl nuw nsw i64 %i.dq, 2, !dbg !10791   ; 2 uses
  %i.du = getelementptr inbounds nuw i8, ptr %i.i, i64 %.idx, !dbg !10791 ; 2 uses
  %i.dv = icmp eq i64 %i.dq, 0, !dbg !10796
  br i1 %i.dv, label %_RNvNtNtNtNtCsfISxE4fmY1Y_14polars_parquet5arrow4read11deserialize18dictionary_encoded19verify_dict_indices.exit53.thread, label %.lr.ph179.preheader, !dbg !10799

.lr.ph179.preheader:                              ; preds = %bb.ac
  %i.dw = add nsw i64 %.idx, -4, !dbg !10799      ; 2 uses
  %i.dx = lshr exact i64 %i.dw, 2, !dbg !10799
  %i.dy = add nuw nsw i64 %i.dx, 1, !dbg !10799   ; 2 uses
  %min.iters.check = icmp ult i64 %i.dw, 28, !dbg !10799
...
vector.ph:                                        ; preds = %.lr.ph179.preheader
  ...
  %i.eb = icmp ult <4 x i32> %wide.load, %broadcast.splat, !dbg !10806 ; 2 uses
  %i.ec = icmp ult <4 x i32> %wide.load261, %broadcast.splat, !dbg !10806 ; 2 uses
  %i.ed = icmp eq i64 %n.vec, 8, !dbg !10799
  br i1 %i.ed, label %middle.block, label %vector.body.1, !dbg !10799
...
vector.body.1:                                    ; preds = %vector.ph
  ...
  %i.ee = icmp ult <4 x i32> %wide.load.1, %broadcast.splat, !dbg !10806
  %i.ef = icmp ult <4 x i32> %wide.load261.1, %broadcast.splat, !dbg !10806
  %i.eg = and <4 x i1> %i.eb, %i.ee, !dbg !10807  ; 2 uses
  %i.eh = and <4 x i1> %i.ec, %i.ef, !dbg !10807  ; 2 uses
  %i.ei = icmp eq i64 %n.vec, 16, !dbg !10799
  br i1 %i.ei, label %middle.block, label %vector.body.2, !dbg !10799
...
vector.body.2:                                    ; preds = %vector.body.1
  ...
  %i.ej = icmp ult <4 x i32> %wide.load.2, %broadcast.splat, !dbg !10806
  %i.ek = icmp ult <4 x i32> %wide.load261.2, %broadcast.splat, !dbg !10806
  %i.el = and <4 x i1> %i.eg, %i.ej, !dbg !10807  ; 2 uses
  %i.em = and <4 x i1> %i.eh, %i.ek, !dbg !10807  ; 2 uses
  %i.en = icmp eq i64 %n.vec, 24, !dbg !10799
  br i1 %i.en, label %middle.block, label %vector.body.3, !dbg !10799
...
vector.body.3:                                    ; preds = %vector.body.2
  ...
  %i.eo = icmp ult <4 x i32> %wide.load.3, %broadcast.splat, !dbg !10806
  %i.ep = icmp ult <4 x i32> %wide.load261.3, %broadcast.splat, !dbg !10806
  %i.eq = and <4 x i1> %i.el, %i.eo, !dbg !10807
  %i.er = and <4 x i1> %i.em, %i.ep, !dbg !10807
  br label %middle.block, !dbg !10799

middle.block:                                     ; preds = %vector.body.3, %vector.body.2, %vector.body.1, %vector.ph
  %.lcssa300 = phi <4 x i1> [ %i.eb, %vector.ph ], [ %i.eg, %vector.body.1 ], [ %i.el, %vector.body.2 ], [ %i.eq, %vector.body.3 ], !dbg !10807
  %.lcssa299 = phi <4 x i1> [ %i.ec, %vector.ph ], [ %i.eh, %vector.body.1 ], [ %i.em, %vector.body.2 ], [ %i.er, %vector.body.3 ], !dbg !10807
  %bin.rdx = and <4 x i1> %.lcssa299, %.lcssa300, !dbg !10799
  %i.es = bitcast <4 x i1> %bin.rdx to i4, !dbg !10799
  %i.et = icmp eq i4 %i.es, -1, !dbg !10799       ; 2 uses
  %cmp.n = icmp eq i64 %i.dy, %n.vec, !dbg !10799
  br i1 %cmp.n, label %._crit_edge180, label %.lr.ph179.preheader281, !dbg !10799

.lr.ph179.preheader281:                           ; preds = %.lr.ph179.preheader, %middle.block
  %.sroa.0.0.i52177.ph = phi i1 [ true, %.lr.ph179.preheader ], [ %i.et, %middle.block ]
  %.sroa.02.0.i51176.ph = phi ptr [ %i.i, %.lr.ph179.preheader ], [ %i.ea, %middle.block ]
  br label %.lr.ph179, !dbg !10799
end_hunk_10
