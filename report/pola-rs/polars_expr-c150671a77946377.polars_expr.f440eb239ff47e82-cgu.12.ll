...
.lr.ph54.i.us.preheader:                          ; preds = %.lr.ph54.i.preheader
  ...
  %i.hs = ptrtoaddr ptr %.sroa.9.1.lcssa.i56 to i64, !dbg !53012
  %i.ht = add i64 %i.hr, %i.d, !dbg !53012
  %i.hu = xor i64 %i.hs, -1, !dbg !53012
  %i.hv = add i64 %i.ht, %i.hu, !dbg !53012       ; 2 uses
...
.lr.ph38.i58.us.preheader:                        ; preds = %.lr.ph38.i58.preheader
  ...
  %i.eh = ptrtoaddr ptr %.sroa.9.1.lcssa.i49 to i64, !dbg !54217
  %i.ei = add i64 %i.eg, %i.d, !dbg !54217
  %i.ej = xor i64 %i.eh, -1, !dbg !54217
  %i.ek = add i64 %i.ei, %i.ej, !dbg !54217       ; 2 uses
...
.lr.ph38.i58:                                     ; preds = %.lr.ph38.i58.preheader, %.lr.ph38.i58
  ...
  %unswitched.select = select i1 %i.ff, ptr %2, ptr %i.fg, !dbg !54246
  %i.fh = getelementptr inbounds nuw [8 x i8], ptr %unswitched.select, i64 %.sroa.27.235.i60, !dbg !54219
