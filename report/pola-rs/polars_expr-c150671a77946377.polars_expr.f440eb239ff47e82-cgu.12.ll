...
.lr.ph54.i.us.preheader:                          ; preds = %.lr.ph54.i.preheader
  ...
  %i.hs = ptrtoaddr ptr %.sroa.9.1.lcssa.i56 to i64, !dbg !56896
  %i.ht = add i64 %i.hr, %i.d, !dbg !56896
  %i.hu = xor i64 %i.hs, -1, !dbg !56896
  %i.hv = add i64 %i.ht, %i.hu, !dbg !56896       ; 2 uses
...
.lr.ph38.i58.us.preheader:                        ; preds = %.lr.ph38.i58.preheader
  ...
  %i.eh = ptrtoaddr ptr %.sroa.9.1.lcssa.i49 to i64, !dbg !58098
  %i.ei = add i64 %i.eg, %i.d, !dbg !58098
  %i.ej = xor i64 %i.eh, -1, !dbg !58098
  %i.ek = add i64 %i.ei, %i.ej, !dbg !58098       ; 2 uses
