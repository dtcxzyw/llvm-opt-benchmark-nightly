...
bb.a:
  %i.a = alloca [16 x i8], align 8                ; 4 uses
  %3 = load ptr, ptr %1, align 8, !dbg !160285, !nonnull !14, !noundef !14
  %i.b = getelementptr inbounds nuw i8, ptr %1, i64 8, !dbg !160286
  %.sroa.02.0.copyload = load ptr, ptr %i.b, align 8, !dbg !160286 ; 2 uses
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 16, !dbg !160286
  %.sroa.5.0.copyload = load i64, ptr %.sroa.5.0..sroa_idx, align 8, !dbg !160286 ; 2 uses
  %.sroa.65.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 24, !dbg !160286
  %.sroa.65.0.copyload = load i64, ptr %.sroa.65.0..sroa_idx, align 8, !dbg !160286 ; 3 uses
...
_RINvXNtNtCse67t6KqNqGQ_5rayon4iter5unzipNtB3_5UnzipINtB3_7UnzipOpTmINtNtCs2mZqlW55729_12polars_utils7idx_vec7UnitVecmEEE7consumeINtNtNtB5_7collect8consumer13CollectResultmEIB23_B13_EECskY9G75ZWc4U_11polars_expr.exit: ; preds = %bb.c
  ...
  store ptr %3, ptr %0, align 8, !dbg !160338
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 8, !dbg !160338
  store ptr %.sroa.02.0.copyload, ptr %4, align 8, !dbg !160338
...
!160285 = !DILocation(line: 375, column: 29, scope: !160284)
!160286 = !DILocation(line: 375, column: 51, scope: !160284)
