...
bb.r:                                             ; preds = %bb.q
  ...
  %2 = extractelement <2 x double> %i.fx, i64 0, !dbg !498
  %3 = fmul double %.sroa.016.0.i, %2, !dbg !498
  %i.fy = shufflevector <2 x double> %i.fx, <2 x double> poison, <2 x i32> zeroinitializer, !dbg !504 ; 2 uses
  %i.fz = fmul <2 x double> %i.fq, %i.fy, !dbg !504 ; 5 uses
  %i.ga = fmul <2 x double> %i.fr, %i.fy, !dbg !505
  %i.gb = fmul <2 x double> %i.fz, %i.fz, !dbg !506
  %i.gc = fsub <2 x double> %i.ga, %i.gb, !dbg !507
  %i.gd = call nsz <2 x double> @llvm.maximumnum.v2f64(<2 x double> %i.gc, <2 x double> zeroinitializer), !dbg !508
  %i.ge = shufflevector <2 x double> %i.fx, <2 x double> poison, <2 x i32> <i32 1, i32 1>, !dbg !510
  %i.gf = fmul <2 x double> %i.ge, %i.gd, !dbg !510 ; 3 uses
...
!498 = !DILocation(line: 381, column: 32, scope: !499, inlinedAt: !180)
!499 = distinct !DILexicalBlock(scope: !500, file: !72, line: 380, column: 9)
!500 = distinct !DILexicalBlock(scope: !501, file: !72, line: 379, column: 9)
!501 = distinct !DILexicalBlock(scope: !502, file: !72, line: 378, column: 9)
!502 = distinct !DILexicalBlock(scope: !503, file: !72, line: 377, column: 9)
!503 = distinct !DILexicalBlock(scope: !496, file: !72, line: 376, column: 9)
!504 = !DILocation(line: 378, column: 22, scope: !502, inlinedAt: !180)
!505 = !DILocation(line: 380, column: 31, scope: !500, inlinedAt: !180)
!506 = !DILocation(line: 380, column: 53, scope: !500, inlinedAt: !180)
!507 = !DILocation(line: 380, column: 30, scope: !500, inlinedAt: !180)
!508 = !DILocation(line: 1011, column: 9, scope: !239, inlinedAt: !509)
!509 = distinct !DILocation(line: 380, column: 70, scope: !500, inlinedAt: !180)
!510 = !DILocation(line: 380, column: 21, scope: !500, inlinedAt: !180)
!511 = !DILocation(line: 381, column: 54, scope: !499, inlinedAt: !180)
!512 = !DILocation(line: 381, column: 31, scope: !499, inlinedAt: !180)
!513 = !DILocation(line: 381, column: 22, scope: !499, inlinedAt: !180)
...
!522 = distinct !DILexicalBlock(scope: !499, file: !72, line: 381, column: 9)
