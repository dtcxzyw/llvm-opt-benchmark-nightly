...
bb.ke:                                            ; preds = %bb.kd
  ...
  %.sroa.15.24.copyload.a = load ptr, ptr %.sroa.14.24..sroa.6.0..sroa_idx.i.sroa_idx, align 8, !dbg !173141, !noalias !172391
  %.sroa.14.24.copyload = load ptr, ptr %.sroa.15.24..sroa.6.0..sroa_idx.i.sroa_idx, align 8, !dbg !173141, !noalias !172391
...
bb.kv:                                            ; preds = %bb.ke, %bb.kt, %bb.ku
  ...
  %.sroa.15.0.ph = phi ptr [ %i.xw, %bb.kt ], [ %.sroa.14.24.copyload, %bb.ke ], [ %i.xw, %bb.ku ]
  %.sroa.14.0.ph = phi ptr [ null, %bb.kt ], [ %.sroa.15.24.copyload.a, %bb.ke ], [ null, %bb.ku ]
