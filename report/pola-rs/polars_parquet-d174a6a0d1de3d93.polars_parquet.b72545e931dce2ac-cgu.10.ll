...
.lr.ph.preheader:                                 ; preds = %bb.a
  %exitcond.not762 = icmp eq i64 %2, 0, !dbg !18400
  br i1 %exitcond.not762, label %.lr.ph._crit_edge, label %.lr.ph766, !dbg !18400
...
.lr.ph:                                           ; preds = %bb.bg
  ...
  br i1 %exitcond.not, label %.lr.ph._crit_edge, label %.lr.ph766, !dbg !18400
...
.lr.ph365:                                        ; preds = %.lr.ph365.preheader, %bb.ay
  ...
  br i1 %.first_iter, label %bb.ax, label %.invoke700, !dbg !18434
...
bb.f:                                             ; preds = %._crit_edge366
  ...
  br i1 %i.u, label %bb.g, label %.invoke700, !dbg !18462
...
.invoke700:                                       ; preds = %bb.f, %.invoke700.loopexit778.split.loop.exit854, %.lr.ph365, %.lr.ph374
  ...
  invoke void @_RNvNtCscgRAwXFJnXP_4core9panicking18panic_bounds_check(i64 noundef %i.v, i64 noundef %i.w, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.x) #20
          to label %.cont701 unwind label %.loopexit.split-lp, !dbg !18463
...
.split388:                                        ; preds = %.split388.preheader, %.loopexit237
  ...
  %i.bz = icmp ult i64 %.sroa.085.0400, %.sroa.012.0354765, !dbg !18556
...
._crit_edge393.thread:                            ; preds = %.split388
  ...
  br i1 %i.cf, label %.thread594, label %bb.t, !dbg !18578

bb.r:                                             ; preds = %.lr.ph392
  %i.cg = add nuw nsw i64 %.sroa.089.0390, 1, !dbg !18579
  %.sroa.0100.0 = add i64 %.sroa.0100.0391, 1, !dbg !18572
  %exitcond525.not = icmp eq i64 %.sroa.0100.0391, %.sroa.012.0354765, !dbg !18556
...
bb.s:                                             ; preds = %._crit_edge393
  ...
  br i1 %i.ch, label %.thread594, label %bb.u, !dbg !18581
...
.thread594:                                       ; preds = %._crit_edge393.thread, %bb.s
  ...
  %i.ci = getelementptr inbounds nuw [4 x i8], ptr @_RNvNtNtCsk4ZPsEfLtLH_6brotli3enc9constants14kZeroRepsDepth, i64 %.sroa.089.0.lcssa593597, !dbg !18581
  %i.cj = load i32, ptr %i.ci, align 4, !dbg !18581, !noundef !14
  %i.ck = trunc i32 %i.cj to i8, !dbg !18581
  %i.cl = getelementptr inbounds nuw [8 x i8], ptr @_RNvNtNtCsk4ZPsEfLtLH_6brotli3enc9constants13kZeroRepsBits, i64 %.sroa.089.0.lcssa593597, !dbg !18583
...
.loopexit237:                                     ; preds = %.lr.ph398.split, %.preheader, %bb.ab, %.thread594
  ...
  %.sroa.084.1 = phi i8 [ %.sroa.084.0401, %.thread594 ], [ %i.by, %bb.ab ], [ %i.by, %.preheader ], [ %i.by, %.lr.ph398.split ], !dbg !18586
  %.not = icmp ugt i64 %.pre-phi589, %.sroa.012.0354765, !dbg !18587
...
bb.w:                                             ; preds = %bb.t, %bb.x
  %.sroa.089.1 = phi i64 [ %i.da, %bb.x ], [ %.sroa.089.0.lcssa592, %bb.t ], !dbg !18590 ; 4 uses
...
bb.x:                                             ; preds = %bb.v
  ...
  %i.da = add i64 %.sroa.089.0.lcssa592, -1, !dbg !18596
