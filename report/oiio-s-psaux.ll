...
40:                                               ; preds = %skip_spaces.exit.i
  %41 = load i8, ptr %storemerge.lcssa.i.i, align 1, !tbaa !38 ; [#uses=2 type=i8]
  %42 = add i8 %41, -48                           ; [#uses=1 type=i8]
...
27:                                               ; preds = %22, %24, %15
  ...
  %.095 = phi i64 [ 0, %15 ], [ %26, %24 ], [ %19, %22 ] ; [#uses=5 type=i64]
...
.lr.ph:                                           ; preds = %.preheader127
  %35 = icmp eq i64 %.095, 0                      ; [#uses=1 type=i1]
...
begin_hunk_4
  ...
  %91 = icmp ne i64 %.095, 0                      ; [#uses=1 type=i1]
...
begin_hunk_5
  ...
  %.196219 = phi i64 [ %99, %107 ], [ %.095, %.preheader126 ] ; [#uses=2 type=i64]
...
begin_hunk_6
  ...
  %.297228 = phi i64 [ %112, %110 ], [ %.095, %.preheader ] ; [#uses=2 type=i64]
...
._crit_edge:                                      ; preds = %110, %107, %.preheader
  %.297.lcssa = phi i64 [ %.095, %.preheader ], [ %99, %107 ], [ %112, %110 ] ; [#uses=2 type=i64]
...
9:                                                ; preds = %7
  %10 = add nsw i32 %.01126, 1                    ; [#uses=1 type=i32]
  br label %skip_string.exit

11:                                               ; preds = %7
  %12 = add nsw i32 %.01126, -1                   ; [#uses=2 type=i32]
...
28:                                               ; preds = %skip_spaces.exit.i
  %29 = load i8, ptr %storemerge.lcssa.i.i, align 1, !tbaa !38 ; [#uses=2 type=i8]
  %30 = add i8 %29, -48                           ; [#uses=1 type=i8]
