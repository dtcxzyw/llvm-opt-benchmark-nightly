...
40:                                               ; preds = %skip_spaces.exit.i
  %41 = load i8, ptr %storemerge.lcssa.i.i, align 1, !tbaa !38
  %.fr27.i = freeze i8 %41                        ; 2 uses
  %42 = add i8 %.fr27.i, -48
...
begin_hunk_5
  ...
  %.196219 = phi i64 [ %99, %107 ], [ %.095.fr, %.preheader126 ] ; 2 uses
...
begin_hunk_6
  ...
  %.297228 = phi i64 [ %112, %110 ], [ %.095.fr, %.preheader ] ; 2 uses
...
._crit_edge:                                      ; preds = %110, %107, %.preheader
  %.297.lcssa = phi i64 [ %.095.fr, %.preheader ], [ %99, %107 ], [ %112, %110 ] ; 2 uses
...
28:                                               ; preds = %skip_spaces.exit.i
  %29 = load i8, ptr %storemerge.lcssa.i.i, align 1, !tbaa !38
  %.fr27.i = freeze i8 %29                        ; 2 uses
  %30 = add i8 %.fr27.i, -48
