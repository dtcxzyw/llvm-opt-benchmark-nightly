begin_hunk_0
  ...
  %.not194.us.i.us.i.i191 = icmp eq i64 %.sroa.036.sroa.4.0.copyload.i.i.i, 0 ; [#uses=1 type=i1]
  br label %333
...
350:                                              ; preds = %370
  %351 = add nuw nsw i64 %.sroa.04.0.i.us.i.i.i185, 1 ; [#uses=2 type=i64]
...
.lr.ph187:                                        ; preds = %.preheader196.us.i.i.i.preheader, %.preheader196.us.i.i.i
  %.sroa.2.0.i.us.i.i.i186 = phi i64 [ %356, %.preheader196.us.i.i.i ], [ %.sroa.036.sroa.4.0.copyload.i.i.i, %.preheader196.us.i.i.i.preheader ] ; [#uses=1 type=i64]
  %356 = add i64 %.sroa.2.0.i.us.i.i.i186, -1     ; [#uses=6 type=i64]
...
.lr.ph:                                           ; preds = %348, %350
  %.sroa.04.0.i.us.i.i.i185 = phi i64 [ %351, %350 ], [ %.sroa.0.0.i.i.us.i.i.i, %348 ] ; [#uses=4 type=i64]
  %368 = add i64 %.sroa.04.0.i.us.i.i.i185, %340  ; [#uses=2 type=i64]
  %369 = icmp ult i64 %368, %.sroa.036.sroa.13.0.copyload.i.i.i ; [#uses=1 type=i1]
  br i1 %369, label %370, label %.split250.us.i.i.i

370:                                              ; preds = %.lr.ph
  %371 = getelementptr inbounds nuw i8, ptr %.sroa.036.sroa.14.0.copyload.i.i.i, i64 %.sroa.04.0.i.us.i.i.i185 ; [#uses=1 type=ptr]
...
375:                                              ; preds = %370
  ...
  %377 = add i64 %376, %.sroa.04.0.i.us.i.i.i185  ; [#uses=1 type=i64]
  br label %.sink.split.i88.us.i.i.i
...
.preheader195.us.i.i.i:                           ; preds = %406
  %392 = add nuw nsw i64 %.sroa.04.0.i98.us.i.i.i189, 1 ; [#uses=2 type=i64]
...
.lr.ph193:                                        ; preds = %.preheader.us.i.us.i.i.preheader, %.preheader.us.i.us.i.i
  %.sroa.2.0.i99.us.i.us.i.i192 = phi i64 [ %394, %.preheader.us.i.us.i.i ], [ %.sroa.036.sroa.4.0.copyload.i.i.i, %.preheader.us.i.us.i.i.preheader ] ; [#uses=1 type=i64]
  %394 = add i64 %.sroa.2.0.i99.us.i.us.i.i192, -1 ; [#uses=4 type=i64]
...
.lr.ph190:                                        ; preds = %.preheader195.us.i.i.i.preheader, %.preheader195.us.i.i.i
  %.sroa.04.0.i98.us.i.i.i189 = phi i64 [ %392, %.preheader195.us.i.i.i ], [ %.sroa.036.sroa.4.0.copyload.i.i.i, %.preheader195.us.i.i.i.preheader ] ; [#uses=4 type=i64]
  %404 = add i64 %.sroa.04.0.i98.us.i.i.i189, %384 ; [#uses=2 type=i64]
  %405 = icmp ult i64 %404, %.sroa.036.sroa.13.0.copyload.i.i.i ; [#uses=1 type=i1]
  br i1 %405, label %406, label %.split260.us.i.i.i

406:                                              ; preds = %.lr.ph190
  %407 = getelementptr inbounds nuw i8, ptr %.sroa.036.sroa.14.0.copyload.i.i.i, i64 %.sroa.04.0.i98.us.i.i.i189 ; [#uses=1 type=ptr]
...
411:                                              ; preds = %406
  ...
  %413 = add i64 %412, %.sroa.04.0.i98.us.i.i.i189 ; [#uses=1 type=i64]
  br label %416
...
.split245.us.invoke.i.i.i:                        ; preds = %.preheader.us.i.preheader.split.i.i, %358, %.lr.ph187, %.lr.ph193, %.split250.us.i.i.i, %.split260.us.i.i.i
  %507 = phi i64 [ %umax.i101.i.i.i, %.split260.us.i.i.i ], [ %395, %.lr.ph193 ], [ %umax.i.i.i.i, %.split250.us.i.i.i ], [ %359, %358 ], [ %356, %.lr.ph187 ], [ %331, %.preheader.us.i.preheader.split.i.i ] ; [#uses=1 type=i64]
  ...
  %509 = phi ptr [ @6, %.split260.us.i.i.i ], [ @5, %.lr.ph193 ], [ @6, %.split250.us.i.i.i ], [ @5, %358 ], [ @4, %.lr.ph187 ], [ @4, %.preheader.us.i.preheader.split.i.i ] ; [#uses=1 type=ptr]
