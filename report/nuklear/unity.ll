...
begin_hunk_3_@stbtt_GetGlyphSDF:bb.a
  ...
  br i1 %or.cond519, label %bb.bq, label %bb.c
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %i.au = call ptr %.val491(ptr %.val490, ptr noundef null, i64 noundef range(i64 -51539607552, 51539607529) %i.ar) #50, !inline_history !469 ; 2 uses
  ...
  %i.az = call ptr %.val489(ptr %.val, ptr noundef null, i64 noundef range(i64 -51539607552, 51539607529) %i.aw) #50, !inline_history !469 ; 4 uses
...
bb.p:                                             ; preds = %bb.l, %bb.n, %bb.o, %bb.m
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.preheader525, label %bb.l, !llvm.loop !540
...
.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge533
  ...
  %i.dq = mul nuw nsw i32 %i.dp, %i.am
  %i.dr = sub i32 %i.dq, %i.af
  br label %bb.q

bb.q:                                             ; preds = %.preheader, %bb.bp
  %indvars.iv542 = phi i64 [ %i.bg, %.preheader ], [ %indvars.iv.next543, %bb.bp ] ; 2 uses
...
begin_hunk_4_@stbtt__cff_get_index:bb.a
  store i32 %i.n, ptr %i.a, align 8, !tbaa !526
