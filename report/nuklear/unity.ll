...
bb.h:                                             ; preds = %bb.g, %bb.f
  %i.bh = phi float [ %i.w, %bb.f ], [ %.pre.i, %bb.g ] ; 5 uses
  %.sroa.20.0.i = phi <2 x float> [ %i.ah, %bb.f ], [ %.sroa.20.8.vec.insert.i, %bb.g ] ; 8 uses
  %.sroa.0125.0.i = phi <2 x float> [ %i.aa, %bb.f ], [ %.sroa.0125.0.vec.insert139.i, %bb.g ] ; 8 uses
  ...
  %.sroa.0125.0.vec.extract141.i = extractelement <2 x float> %.sroa.0125.0.i, i64 0 ; 6 uses
  %6 = tail call float @llvm.fmuladd.f32(float %i.bs, float %i.br, float %.sroa.0125.0.vec.extract141.i) ; 5 uses
  %i.bt = getelementptr inbounds nuw i8, ptr %0, i64 2352
  %i.bu = load float, ptr %i.bt, align 8, !tbaa !1131 ; 3 uses
  %i.bv = insertelement <2 x float> poison, float %i.bh, i64 0
  %.sroa.9115.8.vec.insert.i = insertelement <2 x float> %i.bv, float %i.bu, i64 1 ; 2 uses
  %.sroa.0125.4.vec.extract.i = extractelement <2 x float> %.sroa.0125.0.i, i64 1 ; 6 uses
  %.sroa.20.12.vec.extract.i = extractelement <2 x float> %.sroa.20.0.i, i64 1 ; 3 uses
  %7 = tail call float @llvm.fmuladd.f32(float %.sroa.20.12.vec.extract.i, float 5.000000e-01, float %.sroa.0125.4.vec.extract.i) ; 2 uses
  %8 = fneg float %i.bu
  %9 = tail call float @llvm.fmuladd.f32(float %8, float 5.000000e-01, float %7) ; 3 uses
  %10 = fneg float %i.bh                          ; 2 uses
  %11 = tail call float @llvm.fmuladd.f32(float %10, float 5.000000e-01, float %6) ; 3 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ca = fcmp ole float %11, %i.bz
  %i.cb = fadd float %i.bh, %11
...
nk_input_has_mouse_click_in_rect.exit.i.i.i:      ; preds = %bb.i
  ...
  %i.ci = fcmp ole float %9, %i.ch
  %i.cj = fadd float %i.bu, %9
...
bb.j:                                             ; preds = %nk_input_has_mouse_click_in_rect.exit.i.i.i
  ...
  %i.cn = tail call float @llvm.fmuladd.f32(float %i.bh, float 5.000000e-01, float %11)
...
.thread87.i.i:                                    ; preds = %bb.k, %bb.j, %nk_input_has_mouse_click_in_rect.exit.i.i.i, %bb.i
  %.sroa.0.0.i = phi float [ %6, %bb.j ], [ %i.dg, %bb.k ], [ %6, %nk_input_has_mouse_click_in_rect.exit.i.i.i ], [ %6, %bb.i ] ; 3 uses
...
nk_slider_behavior.exit.i:                        ; preds = %nk_input_is_mouse_prev_hovering_rect.exit85.thread.sink.split.i.i, %bb.n, %.thread97.i.i, %bb.h
  ...
  %.sroa.0.1.i = phi float [ %6, %bb.h ], [ %.sroa.0.0.i, %nk_input_is_mouse_prev_hovering_rect.exit85.thread.sink.split.i.i ], [ %.sroa.0.0.i, %bb.n ], [ %.sroa.0.0.i, %.thread97.i.i ]
  ...
  %12 = tail call float @llvm.fmuladd.f32(float %10, float 5.000000e-01, float %.sroa.0.1.i) ; 2 uses
  %13 = insertelement <2 x float> poison, float %12, i64 0
  %.sroa.0108.0.vec.insert113.i = insertelement <2 x float> %13, float %9, i64 1 ; 2 uses
...
bb.t:                                             ; preds = %bb.s, %bb.r, %bb.q
  ...
  %i.fa = tail call float @llvm.fmuladd.f32(float %i.ez, float 5.000000e-01, float %7)
  ...
  %i.fb = tail call float @llvm.fmuladd.f32(float %i.bh, float 5.000000e-01, float %12)
