...
.loopexit:                                        ; preds = %.loopexit.loopexit, %.preheader, %bb.a
  %.0 = phi i32 [ 0, %bb.a ], [ 0, %.preheader ], [ %i.bg, %.loopexit.loopexit ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #50
  ret i32 %.0
}
...
.thread.1:                                        ; preds = %.lr.ph63.1
  ...
  store i32 1, ptr %i.gb, align 4, !tbaa !344
  br label %bb.an
...
bb.am:                                            ; preds = %.lr.ph63.1
  ...
  store i32 %i.gf, ptr %i.gg, align 4, !tbaa !344
...
bb.ao:                                            ; preds = %bb.an, %bb.am
  ...
  br i1 %niter113.ncmp.1, label %._crit_edge64.loopexit.unr-lcssa, label %.lr.ph63, !llvm.loop !360
...
.lr.ph63.epil.preheader:                          ; preds = %._crit_edge64.loopexit.unr-lcssa, %._crit_edge59
  ...
  %.04560.epil.init = phi i32 [ 1, %._crit_edge59 ], [ %i.gh, %._crit_edge64.loopexit.unr-lcssa ]
  ...
  %i.gk = load i32, ptr %i.gj, align 4, !tbaa !358
...
bb.ap:                                            ; preds = %.lr.ph63.epil.preheader
  ...
  store i32 %i.gq, ptr %i.gr, align 4, !tbaa !344
...
._crit_edge64:                                    ; preds = %._crit_edge64.loopexit.unr-lcssa, %bb.aq, %bb.ap, %._crit_edge59.thread
  %.045.lcssa = phi i32 [ 1, %._crit_edge59.thread ], [ %i.gh, %._crit_edge64.loopexit.unr-lcssa ], [ %.04560.epil.init, %bb.aq ], [ 0, %bb.ap ]
  ret i32 %.045.lcssa
}
...
bb.a:
  ...
  %i.d = load i32, ptr %i.c, align 4, !tbaa !349  ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.h = load i32, ptr %i.g, align 4, !tbaa !348
  %i.i = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.j = load i32, ptr %i.i, align 4, !tbaa !348
...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 4, !tbaa !344
...
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !361  ; 6 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.d = load i32, ptr %i.c, align 8, !tbaa !364  ; 4 uses
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader
  ...
  %.2132.prol = add i32 %i.cw, %i.cc              ; 2 uses
  %i.cx = add nsw i16 %i.bo, -1
  br label %.lr.ph.prol.loopexit

.lr.ph.prol.loopexit:                             ; preds = %.lr.ph.prol, %.lr.ph.preheader
  %.2132.lcssa.unr = phi i32 [ poison, %.lr.ph.preheader ], [ %.2132.prol, %.lr.ph.prol ]
  %.0122.in186.unr = phi i16 [ %i.ci, %.lr.ph.preheader ], [ %.0122.prol, %.lr.ph.prol ]
  %.0123185.unr = phi i16 [ %i.bo, %.lr.ph.preheader ], [ %i.cx, %.lr.ph.prol ]
  %.1131184.unr = phi i32 [ %i.cc, %.lr.ph.preheader ], [ %.2132.prol, %.lr.ph.prol ]
  %i.cy = icmp eq i16 %i.cj, 1
  br i1 %i.cy, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  %.0122.in186 = phi i16 [ %.0122.1, %.lr.ph ], [ %.0122.in186.unr, %.lr.ph.prol.loopexit ] ; 2 uses
  %.0123185 = phi i16 [ %i.dz, %.lr.ph ], [ %.0123185.unr, %.lr.ph.prol.loopexit ]
  %.1131184 = phi i32 [ %.2132.1, %.lr.ph ], [ %.1131184.unr, %.lr.ph.prol.loopexit ] ; 2 uses
  %.0122 = lshr i16 %.0122.in186, 1
  %i.cz = zext i32 %.1131184 to i64
  %i.da = getelementptr inbounds nuw i8, ptr %i.b, i64 %i.cz
  %i.db = and i16 %.0122, 32766                   ; 2 uses
  ...
  %.2132 = add i32 %i.dl, %.1131184               ; 2 uses
  %.0122.1 = lshr i16 %.0122.in186, 2             ; 2 uses
  %i.dm = zext i32 %.2132 to i64
  %i.dn = getelementptr inbounds nuw i8, ptr %i.b, i64 %i.dm
  %i.do = and i16 %.0122.1, 16382                 ; 2 uses
  ...
  %.2132.1 = add i32 %i.dy, %.2132                ; 2 uses
  %i.dz = add i16 %.0123185, -2                   ; 2 uses
  %.not142.1 = icmp eq i16 %i.dz, 0
  br i1 %.not142.1, label %._crit_edge, label %.lr.ph, !llvm.loop !365

._crit_edge:                                      ; preds = %.lr.ph.prol.loopexit, %.lr.ph, %bb.h
  %.1131.lcssa = phi i32 [ %i.cc, %bb.h ], [ %.2132.lcssa.unr, %.lr.ph.prol.loopexit ], [ %.2132.1, %.lr.ph ]
  %reass.sub = sub i32 %.1131.lcssa, %i.d
...
bb.l:                                             ; preds = %._crit_edge, %bb.k, %bb.j
  %.2.shrunk = phi i32 [ %i.gf, %bb.k ], [ %i.fr, %bb.j ], [ 0, %._crit_edge ]
...
bb.o:                                             ; preds = %.lr.ph190, %bb.r
  %.0124188 = phi i32 [ %i.gk, %.lr.ph190 ], [ %.2126, %bb.r ] ; 2 uses
  %.0127187 = phi i32 [ 0, %.lr.ph190 ], [ %.2129, %bb.r ] ; 3 uses
  %i.gn = sub nsw i32 %.0124188, %.0127187
  %i.go = lshr i32 %i.gn, 1
  %i.gp = add nuw nsw i32 %i.go, %.0127187        ; 3 uses
...
bb.r:                                             ; preds = %bb.q, %bb.o
  %.2129 = phi i32 [ %.0127187, %bb.o ], [ %i.ha, %bb.q ] ; 2 uses
  %.2126 = phi i32 [ %i.gp, %bb.o ], [ %.0124188, %bb.q ] ; 2 uses
  %i.hg = icmp slt i32 %.2129, %.2126
  br i1 %i.hg, label %bb.o, label %.loopexit, !llvm.loop !366

.loopexit:                                        ; preds = %bb.r, %bb.n, %.thread, %bb.m, %bb.l, %bb.g, %bb.a, %bb.f, %bb.e, %bb.d, %bb.c, %bb.b
  %.8 = phi i32 [ 0, %bb.m ], [ 0, %bb.b ], [ 0, %bb.d ], [ 0, %bb.a ], [ 0, %bb.g ], [ %i.x, %bb.c ], [ %i.av, %bb.f ], [ 0, %bb.e ], [ %.2, %bb.l ], [ %.5, %.thread ], [ 0, %bb.n ], [ 0, %bb.r ]
  ret i32 %.8
}
...
bb.a:
  ...
  %i.c = load i32, ptr %i.b, align 4, !tbaa !367
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = load i32, ptr %i.f, align 4, !tbaa !368
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.i = load i32, ptr %i.h, align 4, !tbaa !369  ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.m = load i32, ptr %i.l, align 8, !tbaa !370
  %i.n = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.o = load i32, ptr %i.n, align 8, !tbaa !371
...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 4, !tbaa !367
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.i = load i32, ptr %i.h, align 4, !tbaa !368
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.k = load i32, ptr %i.j, align 4, !tbaa !369  ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.q = load ptr, ptr %i.p, align 8, !tbaa !361  ; 2 uses
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.s = load i32, ptr %i.r, align 8, !tbaa !371
...
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !361  ; 5 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 36
  %i.d = load i32, ptr %i.c, align 4, !tbaa !394
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ab = load i32, ptr %i.aa, align 8, !tbaa !395
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.ak = load i32, ptr %i.aj, align 8, !tbaa !395
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ay = load i32, ptr %i.ax, align 8, !tbaa !395
...
bb.a:
  ...
  %i.d = load i32, ptr %i.c, align 4, !tbaa !396  ; 2 uses
  %i.e = sext i32 %i.d to i64
...
bb.e:                                             ; preds = %.lr.ph, %bb.e
  ...
  store i32 %i.ag, ptr %i.ah, align 4, !tbaa !397
  ...
  store i32 %i.an, ptr %i.ao, align 4, !tbaa !399
  ...
  store i32 %i.av, ptr %i.aw, align 4, !tbaa !400
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.loopexit, label %bb.e, !llvm.loop !401
...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 8, !tbaa !402  ; 2 uses
  %.not = icmp eq i32 %i.b, 0
...
bb.ah:                                            ; preds = %bb.am, %.lr.ph.i15
  %.0223.i = phi i32 [ %i.jg, %.lr.ph.i15 ], [ %.1.i, %bb.am ] ; 2 uses
  %.0232.i = phi i32 [ 0, %.lr.ph.i15 ], [ %.124.i, %bb.am ] ; 2 uses
  %i.ji = add nsw i32 %.0232.i, %.0223.i
...
bb.am:                                            ; preds = %bb.ak, %bb.ai
  %.124.i = phi i32 [ %.0232.i, %bb.ai ], [ %i.js, %bb.ak ] ; 2 uses
  %.1.i = phi i32 [ %i.jq, %bb.ai ], [ %.0223.i, %bb.ak ] ; 2 uses
  %.not28.i = icmp sgt i32 %.124.i, %.1.i
  br i1 %.not28.i, label %stbtt__GetGlyphGPOSInfoAdvance.exit, label %bb.ah, !llvm.loop !408
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load i32, ptr %i.c, align 8, !tbaa !402
...
bb.a:
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !361  ; 5 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.p = load i32, ptr %i.o, align 8, !tbaa !395
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ac = load i32, ptr %i.ab, align 8, !tbaa !395
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.al = load i32, ptr %i.ak, align 8, !tbaa !395
  %i.am = sext i32 %i.al to i64
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.az = load i32, ptr %i.ay, align 8, !tbaa !395
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.q = load i32, ptr %i.p, align 4, !tbaa !394
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.ab = load ptr, ptr %i.aa, align 8, !tbaa !361
  %i.ac = getelementptr inbounds nuw i8, ptr %0, i64 36
  %i.ad = load i32, ptr %i.ac, align 4, !tbaa !394
...
bb.a:
  ...
  %i.d = load i32, ptr %i.c, align 8, !tbaa !409  ; 2 uses
...
bb.f:                                             ; preds = %bb.e, %bb.d, %bb.c, %bb.b
  ...
  br i1 %exitcond.not.i, label %stbtt__find_table.exit.thread, label %bb.b, !llvm.loop !410
...
.thread:                                          ; preds = %bb.h, %bb.i, %bb.j
  ...
  %.0110 = phi ptr [ %i.am, %bb.j ], [ %i.c, %bb.i ], [ %i.c, %bb.h ] ; 7 uses
  %.0109 = phi ptr [ %i.an, %bb.j ], [ %i.e, %bb.i ], [ %i.e, %bb.h ] ; 7 uses
  %.0108 = phi ptr [ %i.ao, %bb.j ], [ %i.f, %bb.i ], [ %i.f, %bb.h ] ; 4 uses
  %.0107 = phi ptr [ %i.aq, %bb.j ], [ %i.g, %bb.i ], [ %i.g, %bb.h ] ; 3 uses
  %.0106 = phi ptr [ %i.ar, %bb.j ], [ %i.h, %bb.i ], [ %i.h, %bb.h ] ; 3 uses
  %.0105 = phi ptr [ %i.ap, %bb.j ], [ %i.d, %bb.i ], [ %i.d, %bb.h ] ; 13 uses
  %i.au = getelementptr inbounds nuw i8, ptr %i.j, i64 280 ; 2 uses
  %i.av = load i32, ptr %i.au, align 8, !tbaa !1146
...
bb.k:                                             ; preds = %.thread
  %i.az = load i32, ptr %i.y, align 4, !tbaa !895
...
bb.l:                                             ; preds = %bb.k, %.thread
  ...
  %i.bb = load i32, ptr %i.ba, align 4, !tbaa !848
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  %i.bj = load ptr, ptr %i.m, align 8, !tbaa !756 ; 9 uses
  %i.bk = getelementptr inbounds nuw i8, ptr %0, i64 9884
  %i.bl = load i32, ptr %i.bk, align 4, !tbaa !1057 ; 2 uses
  ...
  %i.cd = load i8, ptr %.0, align 1, !tbaa !11
...
nk_strlen.exit.i:                                 ; preds = %.lr.ph.i.preheader.i, %bb.m, %bb.m
  ...
  %i.cj = tail call float %i.ch(ptr %i.ci, float noundef %i.bq, ptr noundef nonnull %.0, i32 noundef %.0286.i) #50, !inline_history !1149
  %i.ck = fadd float %i.bq, %i.bx
  %i.cl = load float, ptr %i.bv, align 8, !tbaa !1148 ; 3 uses
  %i.cm = fadd float %i.ck, %i.cl                 ; 3 uses
  %.sroa.0.0.vec.insert381.i = insertelement <2 x float> poison, float %i.cm, i64 0
  %i.cn = load float, ptr %i.bs, align 8, !tbaa !1147 ; 2 uses
  %i.co = fadd float %.sroa.0394.4.vec.extract402.i, %i.cn
  %i.cp = getelementptr inbounds nuw i8, ptr %0, i64 3516
  %i.cq = load float, ptr %i.cp, align 4, !tbaa !1150 ; 2 uses
  ...
  %i.dd = load i32, ptr %.0105, align 4, !tbaa !10
...
bb.n:                                             ; preds = %nk_strlen.exit.i
  ...
  %i.dh = load i32, ptr %.0109, align 4, !tbaa !10
  %i.di = load ptr, ptr %i.bj, align 8
  %i.dj = call float %i.df(ptr %i.di, float noundef %i.dg, ptr noundef nonnull %.0110, i32 noundef %i.dh) #50, !inline_history !1149
  %i.dk = getelementptr inbounds nuw i8, ptr %0, i64 4460
  %i.dl = load float, ptr %i.dk, align 4, !tbaa !1151
  %i.dm = fadd float %i.dj, %i.dl
  br label %bb.af

bb.o:                                             ; preds = %nk_strlen.exit.i
  %i.dn = load i32, ptr %2, align 8, !tbaa !1152
...
bb.s:                                             ; preds = %.preheader, %bb.s
  ...
  br i1 %.not.i.i, label %bb.t, label %bb.s, !llvm.loop !1154
...
.lr.ph19.i.i.i:                                   ; preds = %.lr.ph19.i.i.i, %.lr.ph19.preheader.i.i.i.new
  ...
  br i1 %niter.ncmp.1, label %nk_itoa.exit.loopexit.i.unr-lcssa, label %.lr.ph19.i.i.i, !llvm.loop !1155
...
bb.ae:                                            ; preds = %.sink.split.i, %bb.o
  ...
  %i.fy = call float %i.fv(ptr %i.fx, float noundef %i.fw, ptr noundef nonnull %i.b, i32 noundef %.0..0..0..i) #50, !inline_history !1149
  br label %bb.af

bb.af:                                            ; preds = %bb.ae, %bb.n
  %.0285.i = phi float [ %i.dm, %bb.n ], [ %i.fy, %bb.ae ]
  %.0283.i = phi ptr [ %.0110, %bb.n ], [ %i.b, %bb.ae ] ; 2 uses
  %.0.i = phi ptr [ %.0109, %bb.n ], [ %i.a, %bb.ae ] ; 4 uses
  %i.fz = load float, ptr %i.bv, align 8, !tbaa !1148 ; 2 uses
  %i.ga = extractelement <2 x float> %i.cx, i64 0
  %i.gb = fadd float %i.cm, %i.ga                 ; 5 uses
  %i.gc = fsub float %i.db, %i.gb                 ; 2 uses
  %i.gd = load float, ptr %i.bs, align 8, !tbaa !1147 ; 2 uses
  ...
  %i.gp = load i32, ptr %.0105, align 4, !tbaa !10
  ...
  %.pr53.i.i = load i32, ptr %.0105, align 4, !tbaa !10 ; 2 uses
...
..thread49_crit_edge.i.i:                         ; preds = %bb.ag
  ...
  %.pre.i.i = load float, ptr %.phi.trans.insert.i.i, align 4, !tbaa !714
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %i.gv = load float, ptr %i.gu, align 4, !tbaa !714 ; 7 uses
...
nk_input_has_mouse_click_in_rect.exit.i.i.i.i:    ; preds = %bb.ai
  ...
  %i.gz = load float, ptr %i.gy, align 4, !tbaa !715 ; 2 uses
...
nk_input_has_mouse_click_down_in_rect.exit.i.i.i: ; preds = %nk_input_has_mouse_click_in_rect.exit.i.i.i.i
  ...
  %i.he = load i8, ptr %i.hd, align 4, !tbaa !711, !range !79, !noundef !80
...
nk_input_is_mouse_click_down_in_rect.exit.i.i:    ; preds = %nk_input_has_mouse_click_down_in_rect.exit.i.i.i
  ...
  %i.hg = load i32, ptr %i.hf, align 4, !tbaa !702
...
bb.aj:                                            ; preds = %nk_input_is_mouse_click_down_in_rect.exit.i.i
  store i32 2, ptr %.0105, align 4, !tbaa !10
  br label %.thread49.i.i
...
bb.e:                                             ; preds = %bb.d
  %i.u = load ptr, ptr %0, align 8, !tbaa !530
  %i.v = add nsw i32 %i.t, 1                      ; 2 uses
  store i32 %i.v, ptr %i.a, align 8, !tbaa !528
...
bb.f:                                             ; preds = %.lr.ph.i
  %i.ai = load ptr, ptr %0, align 8, !tbaa !530
  %i.aj = add nsw i32 %i.ag, 1                    ; 2 uses
  store i32 %i.aj, ptr %i.a, align 8, !tbaa !528
...
bb.g:                                             ; preds = %stbtt__buf_get8.exit.i18
  %i.ar = load ptr, ptr %0, align 8, !tbaa !530
  %i.as = add nsw i32 %i.ap, 1                    ; 2 uses
  store i32 %i.as, ptr %i.a, align 8, !tbaa !528
...
stbtt__buf_get8.exit.i18.1:                       ; preds = %bb.g, %stbtt__buf_get8.exit.i18
  ...
  br i1 %niter.ncmp.1, label %stbtt__buf_get.exit21.loopexit.unr-lcssa, label %.lr.ph.i, !llvm.loop !531
...
bb.h:                                             ; preds = %.lr.ph.i.epil.preheader
  %i.ba = load ptr, ptr %0, align 8, !tbaa !530
  %i.bb = add nsw i32 %.epil.init, 1              ; 2 uses
  store i32 %i.bb, ptr %i.a, align 8, !tbaa !528
...
stbtt__buf_get.exit21:                            ; preds = %stbtt__buf_get.exit21.loopexit, %stbtt__buf_get8.exit
  ...
  store i32 %..i.i22, ptr %i.a, align 8, !tbaa !528
  br label %bb.i
...
bb.j:                                             ; preds = %bb.i
  %i.bq = load ptr, ptr %0, align 8, !tbaa !530
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.i
  %.04076 = phi i32 [ %.242, %bb.i ], [ 0, %.lr.ph.preheader ] ; 2 uses
  %.04375 = phi i32 [ %.245, %bb.i ], [ %i.aj, %.lr.ph.preheader ] ; 2 uses
  %i.ak = add nsw i32 %.04076, %.04375
...
bb.i:                                             ; preds = %bb.f, %bb.h
  %.245 = phi i32 [ %.04375, %bb.h ], [ %i.av, %bb.f ] ; 2 uses
  %.242 = phi i32 [ %i.bd, %bb.h ], [ %.04076, %bb.f ] ; 2 uses
  %.not = icmp sgt i32 %.242, %.245
  br i1 %.not, label %.thread, label %.lr.ph, !llvm.loop !1240
...
bb.c:                                             ; preds = %bb.b
  ...
  store float %6, ptr %i.ai, align 4, !tbaa !430
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 4
  store float %7, ptr %i.aj, align 4, !tbaa !425
...
.critedge:                                        ; preds = %bb.d, %bb.m, %bb.n, %bb.o, %bb.l, %bb.p, %bb.e, %bb.b
  ...
  br i1 %exitcond.not, label %.critedge91, label %bb.b, !llvm.loop !1242
...
.lr.ph:                                           ; preds = %bb.a, %bb.s
  %.064100 = phi ptr [ %i.cj, %bb.s ], [ %2, %bb.a ] ; 7 uses
  %.07099 = phi i32 [ %i.ck, %bb.s ], [ %3, %bb.a ] ; 4 uses
  %.07498 = phi i32 [ %.276, %bb.s ], [ 0, %bb.a ] ; 12 uses
  %i.a = load i8, ptr %.064100, align 1, !tbaa !11 ; 3 uses
  %i.b = zext i8 %i.a to i32                      ; 2 uses
  %i.c = shl nuw nsw i32 %i.b, 8
  %i.d = getelementptr inbounds nuw i8, ptr %.064100, i64 1
...
bb.c:                                             ; preds = %bb.b
  %i.i = add nsw i32 %.07498, 1
  %i.j = sext i32 %.07498 to i64
...
bb.i:                                             ; preds = %bb.h
  %i.ad = getelementptr inbounds nuw i8, ptr %.064100, i64 2 ; 2 uses
  %i.ae = add nsw i32 %.07498, 3                  ; 2 uses
  %.not85 = icmp slt i32 %i.ae, %1
  br i1 %.not85, label %bb.j, label %.critedge

bb.j:                                             ; preds = %bb.i
  %i.af = getelementptr inbounds nuw i8, ptr %.064100, i64 3
...
bb.s:                                             ; preds = %bb.n, %bb.g, %bb.r, %bb.c
  %.276 = phi i32 [ %i.i, %bb.c ], [ %i.v, %bb.g ], [ %i.bn, %bb.n ], [ %i.cc, %bb.r ] ; 2 uses
  %.272 = phi i32 [ %.07099, %bb.c ], [ %.07099, %bb.g ], [ %i.bo, %bb.n ], [ %.07099, %bb.r ]
  %.266 = phi ptr [ %.064100, %bb.c ], [ %.064100, %bb.g ], [ %i.ad, %bb.n ], [ %.064100, %bb.r ]
  %i.cj = getelementptr inbounds nuw i8, ptr %.266, i64 2
  %i.ck = add nsw i32 %.272, -2                   ; 2 uses
  %.not = icmp eq i32 %i.ck, 0
  br i1 %.not, label %.critedge, label %.lr.ph, !llvm.loop !1243

.critedge:                                        ; preds = %bb.s, %bb.r, %bb.p, %bb.o, %bb.g, %bb.f, %bb.e, %bb.c, %bb.b, %bb.q, %bb.m, %bb.l, %bb.k, %bb.j, %bb.i, %bb.a
  %.4 = phi i32 [ 0, %bb.a ], [ -1, %bb.r ], [ -1, %bb.p ], [ -1, %bb.o ], [ -1, %bb.m ], [ -1, %bb.g ], [ -1, %bb.f ], [ -1, %bb.q ], [ -1, %bb.e ], [ -1, %bb.c ], [ -1, %bb.b ], [ -1, %bb.l ], [ -1, %bb.k ], [ -1, %bb.j ], [ -1, %bb.i ], [ %.276, %bb.s ]
  ret i32 %.4
}
end_hunk_6
