...
bb.d:                                             ; preds = %bb.c, %bb.d
  ...
  %5 = insertelement <4 x float> poison, float %i.x, i64 0
  %6 = insertelement <4 x float> %5, float %i.w, i64 1
  %7 = insertelement <4 x float> %6, float %i.s, i64 2
  %8 = insertelement <4 x float> %7, float %i.v, i64 3
  %9 = insertelement <4 x float> poison, float %i.r, i64 0
  %10 = insertelement <4 x float> %9, float %i.t, i64 1
  %11 = shufflevector <4 x float> %10, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 0>
  %12 = fmul <4 x float> %8, %11                  ; 4 uses
  %13 = shufflevector <4 x float> %12, <4 x float> poison, <2 x i32> <i32 3, i32 3>
  %14 = fmul <2 x float> %1, %13
  %15 = shufflevector <4 x float> %12, <4 x float> poison, <2 x i32> <i32 2, i32 2>
  %16 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %15, <2 x float> %.sroa.0.0.copyload.i, <2 x float> %14)
  %17 = shufflevector <4 x float> %12, <4 x float> poison, <2 x i32> <i32 1, i32 1>
  %18 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %17, <2 x float> %2, <2 x float> %16)
  %i.y = shufflevector <4 x float> %12, <4 x float> poison, <2 x i32> zeroinitializer
  %i.z = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.y, <2 x float> %3, <2 x float> %18)
...
bb.d:                                             ; preds = %bb.d, %bb.c
  ...
  %8 = insertelement <4 x float> poison, float %i.z, i64 0
  %9 = insertelement <4 x float> %8, float %i.y, i64 1
  %10 = insertelement <4 x float> %9, float %i.u, i64 2
  %11 = insertelement <4 x float> %10, float %i.x, i64 3
  %12 = insertelement <4 x float> poison, float %i.t, i64 0
  %13 = insertelement <4 x float> %12, float %i.v, i64 1
  %14 = shufflevector <4 x float> %13, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 0>
  %15 = fmul <4 x float> %11, %14                 ; 4 uses
  %16 = shufflevector <4 x float> %15, <4 x float> poison, <2 x i32> <i32 3, i32 3>
  %17 = fmul <2 x float> %2, %16
  %18 = shufflevector <4 x float> %15, <4 x float> poison, <2 x i32> <i32 2, i32 2>
  %19 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %18, <2 x float> %.sroa.0.0.copyload.i.i, <2 x float> %17)
  %20 = shufflevector <4 x float> %15, <4 x float> poison, <2 x i32> <i32 1, i32 1>
  %21 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %20, <2 x float> %3, <2 x float> %19)
  %i.aa = shufflevector <4 x float> %15, <4 x float> poison, <2 x i32> zeroinitializer
  %i.ab = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aa, <2 x float> %4, <2 x float> %21)
  tail call void @nk_draw_list_path_line_to(ptr noundef nonnull %0, <2 x float> %i.ab)
...
bb.p:                                             ; preds = %bb.p, %bb.o
  ...
  %i.dj = fmul float %i.dh, %i.di                 ; 5 uses
  ...
  %5 = insertelement <4 x float> poison, float %i.dp, i64 0
  %6 = insertelement <4 x float> %5, float %i.do, i64 1
  %7 = insertelement <4 x float> %6, float %i.dk, i64 2
  %8 = insertelement <4 x float> %7, float %i.dn, i64 3
  %9 = insertelement <4 x float> poison, float %i.dj, i64 0
  %10 = insertelement <4 x float> %9, float %i.dl, i64 1
  %11 = shufflevector <4 x float> %10, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 0>
  %12 = fmul <4 x float> %8, %11                  ; 4 uses
  %13 = shufflevector <4 x float> %12, <4 x float> poison, <2 x i32> <i32 3, i32 3>
  %14 = fmul <2 x float> %13, %i.cg
  %15 = shufflevector <4 x float> %12, <4 x float> poison, <2 x i32> <i32 2, i32 2>
  %16 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %15, <2 x float> %.sroa.0.0.copyload.i.i.i, <2 x float> %14)
  %17 = shufflevector <4 x float> %12, <4 x float> poison, <2 x i32> <i32 1, i32 1>
  %18 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %17, <2 x float> %i.ci, <2 x float> %16)
  %i.dq = shufflevector <4 x float> %12, <4 x float> poison, <2 x i32> zeroinitializer
  %i.dr = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dq, <2 x float> %i.ck, <2 x float> %18)
...
bb.cb:                                            ; preds = %bb.ca, %bb.bz
  ...
  %13 = sitofp i32 %i.ub to float                 ; 2 uses
  ...
  %i.uo = fsub nnan float %13, %.1306.i.i.i
...
._crit_edge.i.i.i:                                ; preds = %.prol.loopexit, %.lr.ph467.i.i.i.new, %bb.cb
  ...
  %i.wa = fadd float %12, 1.000000e+00            ; 2 uses
  %i.wb = fsub nnan float %i.wa, %12
