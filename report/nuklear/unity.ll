...
bb.c:                                             ; preds = %bb.g, %.lr.ph.i.i
  ...
  %i.q = shl nuw nsw i32 %indvars.iv.tr.i.i, 4
  %i.r = add i32 %i.p, %i.q
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.y = load i32, ptr %i.q, align 8, !tbaa !489
  %i.z = load i32, ptr %i.r, align 8, !tbaa !489
  %i.aa = load i32, ptr %i.s, align 8, !tbaa !489
  %i.ab = load i32, ptr %i.t, align 8, !tbaa !489
  ...
  %i.ag = load i32, ptr %i.u, align 8, !tbaa !489
  %i.ah = load i32, ptr %i.v, align 8, !tbaa !489
  %i.ai = load i32, ptr %i.w, align 8, !tbaa !489
  %i.aj = load i32, ptr %i.x, align 8, !tbaa !489
  ...
  br i1 %i.aq, label %middle.block, label %vector.body, !llvm.loop !519
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.new
  ...
  br i1 %niter.ncmp.3, label %._crit_edge.loopexit.unr-lcssa, label %bb.b, !llvm.loop !520
...
bb.c:                                             ; preds = %bb.c, %.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge, label %bb.c, !llvm.loop !521
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit.unr-lcssa, %bb.c, %.preheader54
  ...
  br i1 %exitcond66.not, label %.lr.ph59.preheader, label %.preheader54, !llvm.loop !522
...
.lr.ph59:                                         ; preds = %.lr.ph59.preheader75, %.lr.ph59
  ...
  %i.bc = load i32, ptr %i.bb, align 8, !tbaa !489
  %i.bd = add nsw i32 %i.bc, %.058                ; 2 uses
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1 ; 2 uses
  %exitcond71.not = icmp eq i64 %indvars.iv.next68, %wide.trip.count70
  br i1 %exitcond71.not, label %._crit_edge60.loopexit, label %.lr.ph59, !llvm.loop !523
...
._crit_edge60:                                    ; preds = %bb.a, %._crit_edge60.loopexit
  ...
  %i.bg = load ptr, ptr %0, align 8, !tbaa !471   ; 2 uses
  %.val = load ptr, ptr %i.bg, align 8
  %i.bh = getelementptr i8, ptr %i.bg, i64 8
  %.val51 = load ptr, ptr %i.bh, align 8, !tbaa !49
  %i.bi = tail call ptr %.val51(ptr %.val, ptr noundef null, i64 noundef range(i64 -51539607552, 51539607529) %.0.lcssa) #50, !inline_history !468 ; 5 uses
  %i.bj = icmp eq ptr %i.bi, null
  br i1 %i.bj, label %bb.e, label %bb.d

bb.d:                                             ; preds = %._crit_edge60
  %i.bk = load ptr, ptr %0, align 8, !tbaa !471
  ...
  %i.bp = load ptr, ptr %i.bo, align 8, !tbaa !476
  ...
  %i.bs = load ptr, ptr %0, align 8, !tbaa !471   ; 2 uses
...
bb.h:                                             ; preds = %bb.m, %.lr.ph.i134.i
  ...
  %indvars.iv.tr.i137.i = trunc nuw nsw i64 %indvars.iv.i136.i to i32
  %i.ai = shl nuw nsw i32 %indvars.iv.tr.i137.i, 4
...
bb.n:                                             ; preds = %bb.s, %.lr.ph.i145.i
  ...
  %indvars.iv.tr.i148.i = trunc nuw nsw i64 %indvars.iv.i147.i to i32
  %i.bf = shl nuw nsw i32 %indvars.iv.tr.i148.i, 4
...
bb.t:                                             ; preds = %bb.y, %.lr.ph.i156.i
  ...
  %indvars.iv.tr.i159.i = trunc nuw nsw i64 %indvars.iv.i158.i to i32
  %i.cd = shl nuw nsw i32 %indvars.iv.tr.i159.i, 4
...
bb.z:                                             ; preds = %bb.ae, %.lr.ph.i167.i
  ...
  %indvars.iv.tr.i170.i = trunc nuw nsw i64 %indvars.iv.i169.i to i32
  %i.da = shl nuw nsw i32 %indvars.iv.tr.i170.i, 4
...
bb.af:                                            ; preds = %bb.ak, %.lr.ph.i178.i
  ...
  %indvars.iv.tr.i181.i = trunc nuw nsw i64 %indvars.iv.i180.i to i32
  %i.dx = shl nuw nsw i32 %indvars.iv.tr.i181.i, 4
...
bb.al:                                            ; preds = %bb.aq, %.lr.ph.i189.i
  ...
  %indvars.iv.tr.i192.i = trunc nuw nsw i64 %indvars.iv.i191.i to i32
  %i.eu = shl nuw nsw i32 %indvars.iv.tr.i192.i, 4
...
bb.ar:                                            ; preds = %bb.aw, %.lr.ph.i200.i
  ...
  %indvars.iv.tr.i203.i = trunc nuw nsw i64 %indvars.iv.i202.i to i32
  %i.fr = shl nuw nsw i32 %indvars.iv.tr.i203.i, 4
...
bb.ba:                                            ; preds = %bb.be, %.lr.ph.i211.i
  ...
  %indvars.iv.tr.i214.i = trunc nuw nsw i64 %indvars.iv.i213.i to i32
  %i.go = shl nuw nsw i32 %indvars.iv.tr.i214.i, 4
...
bb.bf:                                            ; preds = %stbtt__find_table.exit218.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %i.g, i64 16, i1 false), !tbaa.struct !524
  %i.hk = getelementptr inbounds nuw i8, ptr %3, i64 8 ; 17 uses
  %i.hl = load i32, ptr %i.hk, align 8, !tbaa !525 ; 2 uses
  %i.hm = add nsw i32 %i.hl, 2
  %i.hn = getelementptr inbounds nuw i8, ptr %3, i64 12 ; 2 uses
  %i.ho = load i32, ptr %i.hn, align 4, !tbaa !526 ; 48 uses
...
bb.bg:                                            ; preds = %bb.bf
  %i.hr = load ptr, ptr %3, align 8, !tbaa !527
...
stbtt__buf_get8.exit.i:                           ; preds = %bb.bg, %bb.bf
  ...
  store i32 %i.hw, ptr %i.hk, align 8, !tbaa !525
...
bb.bh:                                            ; preds = %stbtt__buf_get8.exit.i
  %i.hx = load ptr, ptr %3, align 8, !tbaa !527
  %i.hy = add nsw i32 %i.hw, 1                    ; 2 uses
  store i32 %i.hy, ptr %i.hk, align 8, !tbaa !525
...
bb.bi:                                            ; preds = %stbtt__buf_get8.exit.i.i.i
  %i.if = load ptr, ptr %3, align 8, !tbaa !527
  %i.ig = add nsw i32 %i.ie, 1                    ; 2 uses
  store i32 %i.ig, ptr %i.hk, align 8, !tbaa !525
...
bb.bk:                                            ; preds = %bb.bj
  %i.in = load ptr, ptr %3, align 8, !tbaa !527
...
stbtt__buf_get8.exit.i18.i.i.1:                   ; preds = %bb.bm, %stbtt__buf_get8.exit.i18.i.i
  ...
  br i1 %niter.ncmp.1, label %stbtt__buf_get.exit21.loopexit.i.i.unr-lcssa, label %.lr.ph.i.i.i, !llvm.loop !528
...
stbtt__buf_get8.exit.i18.i312.i.1:                ; preds = %bb.cq, %stbtt__buf_get8.exit.i18.i312.i
  ...
  br i1 %niter230.ncmp.1, label %stbtt__buf_get.exit21.loopexit.i315.i.unr-lcssa, label %.lr.ph.i.i308.i, !llvm.loop !528
...
stbtt__buf_get.exit21.i316.i:                     ; preds = %stbtt__buf_get.exit21.loopexit.i315.i, %stbtt__buf_get8.exit.i304.i
  ...
  store i32 %..i.i22.i318.i, ptr %i.hk, align 8, !tbaa !525
...
stbtt__buf_range.exit.i:                          ; preds = %bb.ct
  ...
  store i32 %..i.i, ptr %i.hk, align 8, !tbaa !525
  ...
  %i.uy = load i32, ptr %i.hn, align 4, !tbaa !526 ; 3 uses
...
bb.cu:                                            ; preds = %stbtt__buf_range.exit.i, %bb.cs
  ...
  store i32 %..i329.i, ptr %i.hk, align 8, !tbaa !525
...
bb.cw:                                            ; preds = %bb.da, %.lr.ph.i333.i
  ...
  %indvars.iv.tr.i336.i = trunc nuw nsw i64 %indvars.iv.i335.i to i32
  %i.vs = shl nuw nsw i32 %indvars.iv.tr.i336.i, 4
...
bb.dc:                                            ; preds = %bb.de, %.lr.ph.i
  ...
  %indvars.iv.tr.i = trunc nuw nsw i64 %indvars.iv.i to i32
  %i.xf = shl nuw nsw i32 %indvars.iv.tr.i, 3
...
bb.de:                                            ; preds = %.sink.split.i, %bb.dd, %bb.dc
  ...
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %._crit_edge.i, label %bb.dc, !llvm.loop !529
...
bb.a:
  ...
  store i32 %4, ptr %i.a, align 4, !tbaa !491
  %i.b = getelementptr inbounds nuw i8, ptr %7, i64 8
  store ptr null, ptr %i.b, align 8, !tbaa !490
  %i.c = getelementptr inbounds nuw i8, ptr %7, i64 16
  store i32 %5, ptr %i.c, align 8, !tbaa !489
  %i.d = getelementptr inbounds nuw i8, ptr %7, i64 24
  store ptr %6, ptr %i.d, align 8, !tbaa !508
  store float %3, ptr %7, align 8, !tbaa !484
...
begin_hunk_3_@stbtt_GetGlyphSDF:bb.a
  br i1 %or.cond7, label %bb.be, label %bb.bg
...
.thread:                                          ; preds = %.lr.ph530, %bb.an, %bb.bj, %bb.bl, %bb.bk, %bb.aq, %bb.ao, %bb.ap
  ...
  br i1 %exitcond541.not, label %._crit_edge, label %.lr.ph530, !llvm.loop !541
...
._crit_edge.thread:                               ; preds = %bb.t, %._crit_edge, %bb.bm
  ...
  br i1 %i.va, label %bb.bo, label %bb.bn

bb.bn:                                            ; preds = %._crit_edge.thread
  %i.vb = fcmp ogt float %i.uz, 2.550000e+02
  %spec.store.select = select i1 %i.vb, float 2.550000e+02, float %i.uz
  %i.vc = fptoui float %spec.store.select to i8
  br label %bb.bo

bb.bo:                                            ; preds = %._crit_edge.thread, %bb.bn
  %.0438 = phi i8 [ %i.vc, %bb.bn ], [ 0, %._crit_edge.thread ]
  %i.vd = add i32 %i.dr, %i.ds
  %i.ve = sext i32 %i.vd to i64
  %i.vf = getelementptr inbounds i8, ptr %i.au, i64 %i.ve
  store i8 %.0438, ptr %i.vf, align 1, !tbaa !11
  %indvars.iv.next543 = add nsw i64 %indvars.iv542, 1 ; 2 uses
  %i.vg = icmp slt i64 %indvars.iv.next543, %i.bh
  br i1 %i.vg, label %bb.q, label %._crit_edge533, !llvm.loop !542

._crit_edge533:                                   ; preds = %bb.bo
  %i.vh = add nsw i32 %.0440534, 1                ; 2 uses
  %i.vi = icmp slt i32 %i.vh, %i.al
  br i1 %i.vi, label %.preheader, label %._crit_edge535.split, !llvm.loop !543
...
bb.bp:                                            ; preds = %stbtt_GetGlyphBitmapBoxSubpixel.exit.thread, %stbtt_GetGlyphBitmapBoxSubpixel.exit, %bb.a, %._crit_edge535.split
...
bb.m:                                             ; preds = %bb.k, %bb.j, %bb.i, %bb.h
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %stbtt__find_table.exit.thread, label %bb.h, !llvm.loop !544
...
bb.e:                                             ; preds = %stbtt_GetGlyphBitmapBox.exit.i
  ...
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %stbtt_BakeFontBitmap_internal.exit, label %stbtt_GetGlyphHMetrics.exit.i, !llvm.loop !549
...
bb.e:                                             ; preds = %bb.j, %.lr.ph.i.i.i
  ...
  %i.j = shl nuw nsw i32 %indvars.iv.tr.i.i.i, 4
...
bb.k:                                             ; preds = %bb.o, %.lr.ph.i52.i.i
  ...
  %indvars.iv.tr.i55.i.i = trunc nuw nsw i64 %indvars.iv.i54.i.i to i32
  %i.ag = shl nuw nsw i32 %indvars.iv.tr.i55.i.i, 4
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !550  ; 2 uses
...
bb.d:                                             ; preds = %._crit_edge, %bb.c
  ...
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !558  ; 3 uses
...
._crit_edge:                                      ; preds = %bb.f, %bb.d, %nk_range_count.exit
  ...
  %i.aa = load ptr, ptr %i.z, align 8, !tbaa !562 ; 2 uses
  %.not39 = icmp eq ptr %i.aa, %i.f
  br i1 %.not39, label %.loopexit, label %bb.d, !llvm.loop !563
