...
bb.d:                                             ; preds = %bb.c
  ...
  %i.d = load i32, ptr %i.c, align 4, !tbaa !905
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.f = load i32, ptr %i.e, align 4, !tbaa !906
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !812
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !757
  %i.j = getelementptr inbounds nuw i8, ptr %i.i, i64 56
  %i.k = load float, ptr %i.j, align 8, !tbaa !851
...
bb.f:                                             ; preds = %bb.d, %bb.e
  ...
  %i.m = load float, ptr %i.l, align 4, !tbaa !714 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.r = load float, ptr %i.q, align 8, !tbaa !715 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.r = load float, ptr %i.b, align 4, !tbaa !714 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.v = load float, ptr %i.c, align 8, !tbaa !715 ; 2 uses
...
bb.h:                                             ; preds = %nk_input_is_mouse_hovering_rect.exit.thread.a
  ...
  %i.ah = load float, ptr %i.c, align 8, !tbaa !715 ; 2 uses
...
nk_input_is_mouse_hovering_rect.exit32.thread:    ; preds = %bb.i, %bb.j, %nk_input_is_mouse_hovering_rect.exit.thread.a, %bb.h, %bb.c
  ...
  br i1 %.not21, label %.loopexit, label %bb.c, !llvm.loop !908
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.u = load float, ptr %i.c, align 8, !tbaa !715 ; 2 uses
...
nk_input_is_mouse_hovering_rect.exit32.thread.i:  ; preds = %bb.k, %bb.j, %bb.i, %bb.h, %bb.c
  ...
  br i1 %.not21.i, label %nk_window_is_any_hovered.exit, label %bb.c, !llvm.loop !908
...
nk_window_is_any_hovered.exit:                    ; preds = %bb.g, %bb.i, %bb.k, %nk_input_is_mouse_hovering_rect.exit32.thread.i, %bb.a, %bb.b
  ...
  %i.ar = load i32, ptr %i.aq, align 8, !tbaa !810
  %i.as = and i32 %i.ar, 2
...
nk_strlen.exit:                                   ; preds = %.lr.ph.i.preheader18, %.lr.ph.i.preheader, %bb.b
  ...
  %.01222.i = load ptr, ptr %i.e, align 8, !tbaa !294 ; 2 uses
  %.not23.i = icmp eq ptr %.01222.i, null
  br i1 %.not23.i, label %nk_find_window.exit.thread, label %.lr.ph25.i

.lr.ph25.i:                                       ; preds = %nk_strlen.exit, %nk_stricmpn.exit.i
  %.01224.i = phi ptr [ %.012.i, %nk_stricmpn.exit.i ], [ %.01222.i, %nk_strlen.exit ] ; 6 uses
  %i.f = getelementptr inbounds nuw i8, ptr %.01224.i, i64 4
  %i.g = load i32, ptr %i.f, align 4, !tbaa !827
  %i.h = icmp eq i32 %i.g, %i.d
  br i1 %i.h, label %bb.c, label %nk_stricmpn.exit.i

bb.c:                                             ; preds = %.lr.ph25.i
  %i.i = getelementptr inbounds nuw i8, ptr %.01224.i, i64 8 ; 2 uses
...
.lr.ph.i.preheader.i:                             ; preds = %bb.c
  %scevgep.i = getelementptr i8, ptr %.01224.i, i64 9
...
.lr.ph:                                           ; preds = %nk_strlen.exit.preheader.i
  %i.m = getelementptr inbounds nuw i8, ptr %.01224.i, i64 9
  br label %bb.d
...
nk_stricmpn.exit.i:                               ; preds = %bb.g, %.lr.ph25.i
  %i.z = getelementptr inbounds nuw i8, ptr %.01224.i, i64 528
  %.012.i = load ptr, ptr %i.z, align 8, !tbaa !294 ; 2 uses
  %.not.i = icmp eq ptr %.012.i, null
  br i1 %.not.i, label %nk_find_window.exit.thread, label %.lr.ph25.i, !llvm.loop !828
...
nk_find_window.exit:                              ; preds = %nk_strlen.exit.preheader.i, %nk_strlen.exit.i, %.nk_find_window.exit_crit_edge
  %i.aa = getelementptr inbounds nuw i8, ptr %.01224.i, i64 72
