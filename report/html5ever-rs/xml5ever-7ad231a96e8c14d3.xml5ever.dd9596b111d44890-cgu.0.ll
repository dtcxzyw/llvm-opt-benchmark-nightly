...
bb.k:                                             ; preds = %bb.j
  ...
  %i.am = load i32, ptr %i.al, align 4, !noalias !98, !noundef !4
  %i.an = getelementptr inbounds nuw i8, ptr %i.c, i64 8
  store i32 %i.am, ptr %i.an, align 8, !noalias !98
  %i.ao = getelementptr i8, ptr %i.c, i64 1       ; 3 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %i.ao) ]
  store ptr %i.ao, ptr %1, align 8, !noalias !98
  store i32 0, ptr %i.al, align 4, !noalias !98
...
_RNvMss_NtCsldpiDtalS19_7tendril7tendrilINtB5_7TendrilNtNtB7_3fmt4UTF8E15make_buf_sharedCsj1ugBVjDER0_8xml5ever.exit.i: ; preds = %bb.k, %bb.j
  ...
  %i.ar = load i64, ptr %i.aq, align 8, !noalias !98, !noundef !4 ; 2 uses
  %i.as = icmp eq i64 %i.ar, -1
  br i1 %i.as, label %bb.l, label %_RNvXNtCsldpiDtalS19_7tendril7tendrilNtB2_9NonAtomicNtB2_9Atomicity9increment.exit.i, !prof !11
...
bb.l:                                             ; preds = %_RNvMss_NtCsldpiDtalS19_7tendril7tendrilINtB5_7TendrilNtNtB7_3fmt4UTF8E15make_buf_sharedCsj1ugBVjDER0_8xml5ever.exit.i
  %i.at = load ptr, ptr @_RNvCsldpiDtalS19_7tendril5OFLOW, align 8, !noalias !98, !nonnull !4, !noundef !4
  %i.au = load i64, ptr getelementptr inbounds nuw (i8, ptr @_RNvCsldpiDtalS19_7tendril5OFLOW, i64 8), align 8, !noalias !98, !noundef !4
  tail call void @_RNvNtCskKLDkoKarTP_4core6option13expect_failed(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.at, i64 noundef %i.au, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @13) #21, !noalias !98
  unreachable
...
_RNvXNtCsldpiDtalS19_7tendril7tendrilNtB2_9NonAtomicNtB2_9Atomicity9increment.exit.i: ; preds = %_RNvMss_NtCsldpiDtalS19_7tendril7tendrilINtB5_7TendrilNtNtB7_3fmt4UTF8E15make_buf_sharedCsj1ugBVjDER0_8xml5ever.exit.i
  ...
  store i64 %i.av, ptr %i.aq, align 8, !noalias !98
  %i.aw = load ptr, ptr %1, align 8, !noalias !101, !nonnull !4, !noundef !4 ; 2 uses
  ...
  %i.bc = load i32, ptr %i.bb, align 4, !noalias !98, !noundef !4
  %i.bd = add i32 %i.bc, %2
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.bn = load i32, ptr %i.bm, align 4, !noalias !104, !noundef !4
...
_RNvMss_NtCsldpiDtalS19_7tendril7tendrilINtB5_7TendrilNtNtB7_3fmt4UTF8E13as_byte_sliceCsj1ugBVjDER0_8xml5ever.exit.i: ; preds = %.thread, %bb.p, %bb.o
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %.sroa.4.i.i, ptr nonnull readonly align 1 %i.bu, i64 range(i64 0, 9) %i.bt, i1 false), !noalias !111
