...
.lr.ph111:                                        ; preds = %.lr.ph111.preheader, %bb.o
  %.186110 = phi i32 [ %5, %bb.o ], [ %i.v, %.lr.ph111.preheader ] ; 2 uses
  %4 = zext nneg i32 %.186110 to i64
...
bb.o:                                             ; preds = %.lr.ph111
  ...
  %5 = add nsw i32 %.186110, %i.ad                ; 2 uses
...
.loopexit:                                        ; preds = %bb.b, %bb.c, %.preheader, %.split.us, %bb.a
  %.0 = phi i32 [ %0, %bb.a ], [ %i.ai, %.split.us ], [ 14, %bb.c ], [ 14, %.preheader ], [ 14, %bb.b ]
  ret i32 %.0
}
