...
begin_hunk_0_@mca_common_ompio_file_read:bb.a
  store i32 5, ptr %i.em, align 8, !tbaa !71
  br label %opal_convertor_cleanup.exit.i

opal_convertor_cleanup.exit.i:                    ; preds = %bb.af, %.split.loop.exit145.i
  %i.es = getelementptr inbounds nuw i8, ptr %5, i64 40
  store ptr null, ptr %i.es, align 8, !tbaa !74
  %i.et = getelementptr inbounds nuw i8, ptr %5, i64 104
  store i32 0, ptr %i.et, align 8, !tbaa !75
...
bb.ag:                                            ; preds = %opal_convertor_cleanup.exit.i
  call void @mca_common_ompio_release_buf(ptr noundef nonnull %0, ptr noundef %.095128.i) #7
  br label %bb.ah

bb.ah:                                            ; preds = %bb.ag, %opal_convertor_cleanup.exit.i
  call void @free(ptr noundef %i.bz) #7
  %.not118.i = icmp eq ptr %4, null
  br i1 %.not118.i, label %mca_common_ompio_file_read_pipelined.exit, label %bb.ai

bb.ai:                                            ; preds = %bb.ah
  %i.eu = getelementptr inbounds nuw i8, ptr %4, i64 16
  store i64 %.099.lcssa.i, ptr %i.eu, align 8, !tbaa !35
  br label %mca_common_ompio_file_read_pipelined.exit

mca_common_ompio_file_read_pipelined.exit:        ; preds = %bb.l, %bb.n, %bb.q, %bb.ah, %bb.ai
  %.0.i = phi i32 [ -2, %bb.l ], [ -2, %bb.n ], [ -2, %bb.q ], [ %.4.i, %bb.ai ], [ %.4.i, %bb.ah ]
...
bb.aj:                                            ; preds = %bb.f
  ...
  %i.ex = call i32 @mca_common_ompio_decode_datatype(ptr noundef nonnull %0, ptr noundef %3, i32 noundef range(i32 1, 0) %2, ptr noundef %1, ptr noundef nonnull %i.d, ptr noundef %i.ew, ptr noundef nonnull %i.c, ptr noundef nonnull %i.b) #7 ; 0 uses
  %i.ey = getelementptr inbounds nuw i8, ptr %0, i64 448
  %i.ez = load ptr, ptr %i.ey, align 8, !tbaa !95
  %i.fa = call i32 %i.ez(ptr noundef nonnull @.str.2, i32 noundef 18) #7, !inline_history !93
  %i.fb = sext i32 %i.fa to i64                   ; 2 uses
  %i.fc = load i64, ptr %i.d, align 8, !tbaa !38
  %i.fd = uitofp i64 %i.fc to double
  %i.fe = uitofp i64 %i.fb to double
  %i.ff = fdiv double %i.fd, %i.fe
  %i.fg = call double @llvm.ceil.f64(double %i.ff)
  %i.fh = fptosi double %i.fg to i32              ; 3 uses
  %i.fi = getelementptr inbounds nuw i8, ptr %0, i64 232
  %i.fj = load i32, ptr %i.fi, align 8, !tbaa !68
  store i32 %i.fj, ptr %i.g, align 4, !tbaa !36
  %i.fk = getelementptr inbounds nuw i8, ptr %0, i64 352
  %i.fl = icmp sgt i32 %i.fh, 0
  br i1 %i.fl, label %.lr.ph.i33, label %._crit_edge.i

.lr.ph.i33:                                       ; preds = %bb.aj
  %i.fm = getelementptr inbounds nuw i8, ptr %0, i64 288 ; 3 uses
  %i.fn = getelementptr inbounds nuw i8, ptr %0, i64 296 ; 3 uses
  br label %bb.ak

bb.ak:                                            ; preds = %bb.am, %.lr.ph.i33
  %.02935.i = phi i64 [ 0, %.lr.ph.i33 ], [ %i.fz, %bb.am ] ; 3 uses
  %.03034.i = phi i32 [ 0, %.lr.ph.i33 ], [ %i.gb, %bb.am ] ; 2 uses
  %i.fo = load i64, ptr %i.d, align 8, !tbaa !38
  %i.fp = load i32, ptr %i.b, align 4, !tbaa !36
  %i.fq = load ptr, ptr %i.c, align 8, !tbaa !76
  %i.fr = call i32 @mca_common_ompio_build_io_array(ptr noundef nonnull %0, i32 noundef %.03034.i, i32 noundef %i.fh, i64 noundef %i.fb, i64 noundef %i.fo, i32 noundef %i.fp, ptr noundef %i.fq, ptr noundef nonnull %i.f, ptr noundef nonnull %i.g, ptr noundef nonnull %i.a, ptr noundef nonnull %i.e, ptr noundef nonnull %i.fm, ptr noundef nonnull %i.fn) #7 ; 0 uses
  %i.fs = load i32, ptr %i.fn, align 8, !tbaa !69
  %i.ft = icmp eq i32 %i.fs, 0
  br i1 %i.ft, label %._crit_edge.loopexit.i, label %bb.al

bb.al:                                            ; preds = %bb.ak
  %i.fu = load ptr, ptr %i.fk, align 8, !tbaa !41
  %i.fv = getelementptr inbounds nuw i8, ptr %i.fu, i64 16
  %i.fw = load ptr, ptr %i.fv, align 8, !tbaa !96
  %i.fx = call i64 %i.fw(ptr noundef nonnull %0) #7, !inline_history !93 ; 3 uses
  %i.fy = icmp sgt i64 %i.fx, -1
  br i1 %i.fy, label %bb.am, label %._crit_edge.loopexit.i

bb.am:                                            ; preds = %bb.al
  %i.fz = add i64 %i.fx, %.02935.i                ; 2 uses
  store i32 0, ptr %i.fn, align 8, !tbaa !69
  %i.ga = load ptr, ptr %i.fm, align 8, !tbaa !70
  call void @free(ptr noundef %i.ga) #7
  store ptr null, ptr %i.fm, align 8, !tbaa !70
  %i.gb = add nuw nsw i32 %.03034.i, 1            ; 2 uses
  %exitcond.not.i34 = icmp eq i32 %i.gb, %i.fh
  br i1 %exitcond.not.i34, label %._crit_edge.loopexit.i, label %bb.ak, !llvm.loop !94

._crit_edge.loopexit.i:                           ; preds = %bb.am, %bb.al, %bb.ak
  %.029.lcssa.ph.i = phi i64 [ %.02935.i, %bb.al ], [ %i.fz, %bb.am ], [ %.02935.i, %bb.ak ]
  %.1.ph.i = phi i64 [ %i.fx, %bb.al ], [ 0, %bb.am ], [ 0, %bb.ak ]
  %i.gc = trunc i64 %.1.ph.i to i32
  br label %._crit_edge.i

._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %bb.aj
  %.029.lcssa.i = phi i64 [ 0, %bb.aj ], [ %.029.lcssa.ph.i, %._crit_edge.loopexit.i ]
  %.1.i = phi i32 [ 0, %bb.aj ], [ %i.gc, %._crit_edge.loopexit.i ]
  %i.gd = load ptr, ptr %i.c, align 8, !tbaa !76
  call void @free(ptr noundef %i.gd) #7
  %.not.i32 = icmp eq ptr %4, null
  br i1 %.not.i32, label %mca_common_ompio_file_read_default.exit, label %bb.an

bb.an:                                            ; preds = %._crit_edge.i
  %i.ge = getelementptr inbounds nuw i8, ptr %4, i64 16
  store i64 %.029.lcssa.i, ptr %i.ge, align 8, !tbaa !35
  br label %mca_common_ompio_file_read_default.exit

mca_common_ompio_file_read_default.exit:          ; preds = %._crit_edge.i, %bb.an
...
bb.ao:                                            ; preds = %bb.d, %bb.e, %bb.a, %mca_common_ompio_file_read_default.exit, %mca_common_ompio_file_read_pipelined.exit
