Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/openmpi/original/fcoll_vulcan_file_write_all?download=true
inline.NumInlined: 9
inline.NumDeleted: 5
...
begin_hunk_0_@shuffle_init:bb.a
  ...
  %i.lg = load ptr, ptr %i.ci, align 8, !tbaa !71 ; 2 uses
  %i.lh = load i32, ptr %i.ce, align 8, !tbaa !211
  %i.li = sext i32 %i.lh to i64                   ; 2 uses
  %i.lj = getelementptr inbounds [8 x i8], ptr %i.lg, i64 %i.li
  %i.lk = load ptr, ptr %i.lj, align 8, !tbaa !23
  ...
  store i64 %i.lf, ptr %i.lo, align 8, !tbaa !16
  %i.lp = add nsw i32 %i.lm, 1
  store i32 %i.lp, ptr %i.ll, align 4, !tbaa !9
  %i.lq = load i32, ptr %i.ce, align 8, !tbaa !211
  ...
  %i.lu = load ptr, ptr %i.cj, align 8, !tbaa !69 ; 2 uses
...
bb.ag:                                            ; preds = %bb.af
  ...
  %i.mh = tail call ptr @realloc(ptr noundef %i.mc, i64 noundef %i.mg) #15
  %i.mi = load ptr, ptr %i.cg, align 8, !tbaa !70
  %i.mj = load i32, ptr %i.ce, align 8, !tbaa !211
  %i.mk = sext i32 %i.mj to i64                   ; 3 uses
  %i.ml = getelementptr inbounds [8 x i8], ptr %i.mi, i64 %i.mk
  store ptr %i.mh, ptr %i.ml, align 8, !tbaa !21
  %i.mm = load ptr, ptr %i.ci, align 8, !tbaa !71
  %i.mn = getelementptr inbounds [8 x i8], ptr %i.mm, i64 %i.mk
  %i.mo = load ptr, ptr %i.mn, align 8, !tbaa !23
  %i.mp = load ptr, ptr %i.cj, align 8, !tbaa !69
  ...
  %i.mu = tail call ptr @realloc(ptr noundef %i.mo, i64 noundef %i.mt) #15
  %i.mv = load ptr, ptr %i.ci, align 8, !tbaa !71 ; 2 uses
  %i.mw = load i32, ptr %i.ce, align 8, !tbaa !211
  %i.mx = sext i32 %i.mw to i64                   ; 3 uses
  %i.my = getelementptr inbounds [8 x i8], ptr %i.mv, i64 %i.mx
  store ptr %i.mu, ptr %i.my, align 8, !tbaa !23
  %.pre714 = load ptr, ptr %i.cg, align 8, !tbaa !70
  %.pre716 = load ptr, ptr %3, align 8, !tbaa !68 ; 2 uses
  ...
  %.pre720.pre.pre.a = load ptr, ptr %i.ch, align 8, !tbaa !65
  %.pre721.pre.pre = load ptr, ptr %i.cc, align 8, !tbaa !66
  br label %bb.ah
...
bb.ah:                                            ; preds = %bb.ag, %bb.af
  ...
  store i64 0, ptr %i.no, align 8, !tbaa !16
  %.pre722.pre = load i32, ptr %i.cd, align 8, !tbaa !210
...
._crit_edge723:                                   ; preds = %._crit_edge759, %bb.ah
  ...
  %i.np = load ptr, ptr %i.ck, align 8, !tbaa !55
  ...
  %i.nz = load i64, ptr %i.ny, align 8, !tbaa !58
  %i.oa = trunc i64 %i.nz to i32                  ; 2 uses
  %i.ob = select i1 %i.ns, i32 %i.oa, i32 0
  %i.oc = load i32, ptr %i.by, align 8, !tbaa !209
  %i.od = sub i32 %i.oc, %i.oa                    ; 2 uses
  store i32 %i.od, ptr %i.by, align 8, !tbaa !209
  %i.oe = add nsw i32 %.pre722, 1
  store i32 %i.oe, ptr %i.cd, align 8, !tbaa !210
  br label %bb.ai
...
bb.ai:                                            ; preds = %._crit_edge723, %bb.w
  ...
  br i1 %.not551, label %.loopexit583, label %bb.n, !llvm.loop !194
...
.lr.ph610:                                        ; preds = %.preheader580
  %i.on = load ptr, ptr %i.oj, align 8, !tbaa !70
  %i.oo = getelementptr inbounds nuw [8 x i8], ptr %i.on, i64 %indvars.iv664
  %i.op = load ptr, ptr %i.oo, align 8, !tbaa !21 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.oz, label %middle.block, label %vector.body, !llvm.loop !195
...
bb.ak:                                            ; preds = %bb.aj
  tail call void (i32, ptr, ...) @opal_output(i32 noundef 1, ptr noundef nonnull @.str.2) #12
  br label %.loopexit

bb.al:                                            ; preds = %bb.aj
  %i.pk = shl nuw nsw i64 %i.pg, 2                ; 2 uses
  %i.pl = tail call noalias ptr @malloc(i64 noundef %i.pk) #13 ; 11 uses
  %i.pm = icmp eq ptr %i.pl, null
  br i1 %i.pm, label %bb.am, label %.preheader578.lr.ph

.preheader578.lr.ph:                              ; preds = %bb.al
  %i.pn = load ptr, ptr %3, align 8, !tbaa !68
...
.lr.ph619:                                        ; preds = %.preheader578
  %i.pt = load ptr, ptr %i.po, align 8, !tbaa !70
  %i.pu = getelementptr inbounds nuw [8 x i8], ptr %i.pt, i64 %indvars.iv674
  %i.pv = load ptr, ptr %i.pu, align 8, !tbaa !21
...
bb.ao:                                            ; preds = %bb.an
  ...
  store i64 %i.qa, ptr %i.qd, align 8, !tbaa !214
  %i.qe = getelementptr inbounds nuw i8, ptr %i.qc, i64 16
  store i32 %i.pw, ptr %i.qe, align 8, !tbaa !215
  %i.qf = load ptr, ptr %i.pp, align 8, !tbaa !71
  ...
  %i.qj = load i64, ptr %i.qi, align 8, !tbaa !16
  store i64 %i.qj, ptr %i.qc, align 8, !tbaa !216
...
bb.ap:                                            ; preds = %bb.an, %bb.ao
  ...
  br i1 %exitcond673.not, label %._crit_edge620, label %bb.an, !llvm.loop !198
...
._crit_edge620:                                   ; preds = %bb.ap, %.preheader578
  ...
  br i1 %exitcond678.not, label %._crit_edge624, label %.preheader578, !llvm.loop !199

._crit_edge624:                                   ; preds = %._crit_edge620
  %i.ql = add nsw i32 %.1513.lcssa, -1            ; 2 uses
  %i.qm = tail call noalias ptr @malloc(i64 noundef %i.pk) #13 ; 21 uses
...
vector.body24:                                    ; preds = %vector.body24, %vector.ph22
  ...
  br i1 %i.qt, label %middle.block27, label %vector.body24, !llvm.loop !200
...
.loopexit.i:                                      ; preds = %bb.ax
  ...
  br i1 %i.qx, label %.preheader130.i, label %.preheader.i, !llvm.loop !202
...
bb.at:                                            ; preds = %bb.as
  ...
  %i.rh = load i64, ptr %i.rg, align 8, !tbaa !216
  ...
  %i.rn = load i64, ptr %i.rm, align 8, !tbaa !216
...
bb.aw:                                            ; preds = %bb.av
  ...
  %i.ru = load i64, ptr %i.rt, align 8, !tbaa !216
  ...
  %i.sa = load i64, ptr %i.rz, align 8, !tbaa !216
...
bb.ba:                                            ; preds = %bb.az
  ...
  %i.st = load i64, ptr %i.ss, align 8, !tbaa !216
  ...
  %i.sz = load i64, ptr %i.sy, align 8, !tbaa !216
...
bb.bd:                                            ; preds = %bb.bc
  ...
  %i.tg = load i64, ptr %i.tf, align 8, !tbaa !216
  ...
  %i.tm = load i64, ptr %i.tl, align 8, !tbaa !216
...
bb.bg:                                            ; preds = %bb.be
  ...
  br i1 %i.tw, label %.lr.ph138.i, label %._crit_edge139.i.loopexit, !llvm.loop !203
...
._crit_edge139.i:                                 ; preds = %._crit_edge139.i.loopexit, %bb.ar
  ...
  tail call void @free(ptr noundef nonnull %i.qm) #12
...
local_heap_sort.exit:                             ; preds = %bb.aq, %._crit_edge139.i
  ...
  %i.ub = tail call noalias ptr @malloc(i64 noundef %i.ua) #13 ; 12 uses
  %i.uc = getelementptr inbounds [8 x i8], ptr %i.ub, i64 %i.tz
  store i64 0, ptr %i.uc, align 8, !tbaa !16
...
.lr.ph626.preheader:                              ; preds = %local_heap_sort.exit
  ...
  %i.ue = icmp slt i32 %.1513.lcssa, 3
  br i1 %i.ue, label %.lr.ph626.epil.preheader, label %.lr.ph626.preheader.new
...
.lr.ph626:                                        ; preds = %.lr.ph626, %.lr.ph626.preheader.new
  ...
  %i.uf = getelementptr [4 x i8], ptr %i.pl, i64 %indvars.iv680 ; 2 uses
  %i.ug = getelementptr i8, ptr %i.uf, i64 -4
  %i.uh = load i32, ptr %i.ug, align 4, !tbaa !9
  %i.ui = sext i32 %i.uh to i64                   ; 2 uses
  %i.uj = getelementptr inbounds [8 x i8], ptr %i.ub, i64 %i.ui
  %i.uk = load i64, ptr %i.uj, align 8, !tbaa !16
  %i.ul = getelementptr inbounds [24 x i8], ptr %i.pi, i64 %i.ui
  %i.um = getelementptr inbounds nuw i8, ptr %i.ul, i64 8
  %i.un = load i64, ptr %i.um, align 8, !tbaa !214
  %i.uo = add nsw i64 %i.un, %i.uk
  %i.up = load i32, ptr %i.uf, align 4, !tbaa !9  ; 2 uses
  %i.uq = sext i32 %i.up to i64
  %i.ur = getelementptr inbounds [8 x i8], ptr %i.ub, i64 %i.uq
  store i64 %i.uo, ptr %i.ur, align 8, !tbaa !16
  %i.us = getelementptr [4 x i8], ptr %i.pl, i64 %indvars.iv680
  %i.ut = getelementptr i8, ptr %i.us, i64 4
  %i.uu = sext i32 %i.up to i64                   ; 2 uses
  %i.uv = getelementptr inbounds [8 x i8], ptr %i.ub, i64 %i.uu
  %i.uw = load i64, ptr %i.uv, align 8, !tbaa !16
  %i.ux = getelementptr inbounds [24 x i8], ptr %i.pi, i64 %i.uu
  %i.uy = getelementptr inbounds nuw i8, ptr %i.ux, i64 8
  %i.uz = load i64, ptr %i.uy, align 8, !tbaa !214
  %i.va = add nsw i64 %i.uz, %i.uw
  %i.vb = load i32, ptr %i.ut, align 4, !tbaa !9
  %i.vc = sext i32 %i.vb to i64
  %i.vd = getelementptr inbounds [8 x i8], ptr %i.ub, i64 %i.vc
  store i64 %i.va, ptr %i.vd, align 8, !tbaa !16
  %indvars.iv.next681.1 = add nuw nsw i64 %indvars.iv680, 2 ; 2 uses
  %niter.next.1 = add nuw i64 %niter, 2           ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge627.loopexit.unr-lcssa, label %.lr.ph626, !llvm.loop !204
...
.lr.ph626.epil.preheader:                         ; preds = %._crit_edge627.loopexit.unr-lcssa, %.lr.ph626.preheader
  ...
  %i.ve = getelementptr [4 x i8], ptr %i.pl, i64 %indvars.iv680.epil.init ; 2 uses
  %i.vf = getelementptr i8, ptr %i.ve, i64 -4
  %i.vg = load i32, ptr %i.vf, align 4, !tbaa !9
  %i.vh = sext i32 %i.vg to i64                   ; 2 uses
  %i.vi = getelementptr inbounds [8 x i8], ptr %i.ub, i64 %i.vh
  %i.vj = load i64, ptr %i.vi, align 8, !tbaa !16
  %i.vk = getelementptr inbounds [24 x i8], ptr %i.pi, i64 %i.vh
  %i.vl = getelementptr inbounds nuw i8, ptr %i.vk, i64 8
  %i.vm = load i64, ptr %i.vl, align 8, !tbaa !214
  %i.vn = add nsw i64 %i.vm, %i.vj
  %i.vo = load i32, ptr %i.ve, align 4, !tbaa !9
  %i.vp = sext i32 %i.vo to i64
  %i.vq = getelementptr inbounds [8 x i8], ptr %i.ub, i64 %i.vp
  store i64 %i.vn, ptr %i.vq, align 8, !tbaa !16
  br label %._crit_edge627

._crit_edge627:                                   ; preds = %.lr.ph626.epil.preheader, %._crit_edge627.loopexit.unr-lcssa, %local_heap_sort.exit
  %i.vr = load i32, ptr %i.of, align 8, !tbaa !54
  %i.vs = sext i32 %i.vr to i64
  %i.vt = shl nsw i64 %i.vs, 2
  %i.vu = tail call noalias ptr @calloc(i64 noundef 1, i64 noundef %i.vt) #14 ; 3 uses
  %i.vv = icmp eq ptr %i.vu, null
  br i1 %i.vv, label %bb.bh, label %.lr.ph629
...
bb.bi:                                            ; preds = %.lr.ph629, %bb.bl
  ...
  %i.vx = getelementptr inbounds nuw [4 x i8], ptr %i.pl, i64 %indvars.iv685
  %i.vy = load i32, ptr %i.vx, align 4, !tbaa !9
  %i.vz = sext i32 %i.vy to i64                   ; 2 uses
  %i.wa = getelementptr inbounds [24 x i8], ptr %i.pi, i64 %i.vz
  %i.wb = getelementptr inbounds nuw i8, ptr %i.wa, i64 16
  %i.wc = load i32, ptr %i.wb, align 8, !tbaa !215 ; 3 uses
  %i.wd = getelementptr inbounds [8 x i8], ptr %i.ub, i64 %i.vz
  %i.we = load i64, ptr %i.wd, align 8, !tbaa !16
  %i.wf = load ptr, ptr %i.vw, align 8, !tbaa !71
  %i.wg = sext i32 %i.wc to i64                   ; 3 uses
  %i.wh = getelementptr inbounds [8 x i8], ptr %i.wf, i64 %i.wg
  %i.wi = load ptr, ptr %i.wh, align 8, !tbaa !23
  %i.wj = getelementptr inbounds [4 x i8], ptr %i.vu, i64 %i.wg ; 2 uses
  %i.wk = load i32, ptr %i.wj, align 4, !tbaa !9  ; 4 uses
  %i.wl = sext i32 %i.wk to i64
  %i.wm = getelementptr inbounds [8 x i8], ptr %i.wi, i64 %i.wl
  store i64 %i.we, ptr %i.wm, align 8, !tbaa !16
  %i.wn = load ptr, ptr %3, align 8, !tbaa !68
  %i.wo = getelementptr inbounds [4 x i8], ptr %i.wn, i64 %i.wg
  %i.wp = load i32, ptr %i.wo, align 4, !tbaa !9  ; 2 uses
  %i.wq = icmp slt i32 %i.wk, %i.wp
  br i1 %i.wq, label %bb.bj, label %bb.bk

bb.bj:                                            ; preds = %bb.bi
  %i.wr = add nsw i32 %i.wk, 1
  store i32 %i.wr, ptr %i.wj, align 4, !tbaa !9
  br label %bb.bl

bb.bk:                                            ; preds = %bb.bi
  %i.ws = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.8, i32 noundef %i.wc, i32 noundef %i.wk, i32 noundef %i.wc, i32 noundef %i.wp) ; 0 uses
  br label %bb.bl
...
._crit_edge630:                                   ; preds = %bb.bl
  %.pre736.a = load i32, ptr %i.of, align 8, !tbaa !54
  tail call void @free(ptr noundef nonnull %i.vu) #12
  %i.wt = icmp sgt i32 %.pre736.a, 0
  br i1 %i.wt, label %.lr.ph633, label %.loopexit575

.lr.ph633:                                        ; preds = %._crit_edge630
  %i.wu = getelementptr inbounds nuw i8, ptr %3, i64 40
  %i.wv = getelementptr inbounds nuw i8, ptr %3, i64 48
  %i.ww = getelementptr inbounds nuw i8, ptr %3, i64 112 ; 3 uses
  %i.wx = getelementptr inbounds nuw i8, ptr %3, i64 96
  %i.wy = getelementptr inbounds nuw i8, ptr %3, i64 160
  %i.wz = add nsw i32 %0, 123
  %i.xa = getelementptr inbounds nuw i8, ptr %3, i64 80
  br label %bb.bm

bb.bm:                                            ; preds = %.lr.ph633, %bb.bp
  %indvars.iv691 = phi i64 [ 0, %.lr.ph633 ], [ %indvars.iv.next692, %bb.bp ] ; 9 uses
  %i.xb = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %indvars.iv691 ; 2 uses
  store ptr @ompi_request_null, ptr %i.xb, align 8, !tbaa !14
  %i.xc = load ptr, ptr %3, align 8, !tbaa !68
  %i.xd = getelementptr inbounds nuw [4 x i8], ptr %i.xc, i64 %indvars.iv691
  %i.xe = load i32, ptr %i.xd, align 4, !tbaa !9  ; 2 uses
  %i.xf = icmp sgt i32 %i.xe, 0
  br i1 %i.xf, label %bb.bn, label %bb.bp

bb.bn:                                            ; preds = %bb.bm
  %i.xg = load ptr, ptr %i.wu, align 8, !tbaa !70
  %i.xh = getelementptr inbounds nuw [8 x i8], ptr %i.xg, i64 %indvars.iv691
  %i.xi = load ptr, ptr %i.xh, align 8, !tbaa !21
  %i.xj = load ptr, ptr %i.wv, align 8, !tbaa !71
  %i.xk = getelementptr inbounds nuw [8 x i8], ptr %i.xj, i64 %indvars.iv691
  %i.xl = load ptr, ptr %i.xk, align 8, !tbaa !23
  %i.xm = load ptr, ptr %i.ww, align 8, !tbaa !73
  %i.xn = getelementptr inbounds nuw [8 x i8], ptr %i.xm, i64 %indvars.iv691
  %i.xo = tail call i32 @ompi_datatype_create_hindexed(i32 noundef %i.xe, ptr noundef %i.xi, ptr noundef %i.xl, ptr noundef nonnull @ompi_mpi_byte, ptr noundef %i.xn) #12 ; 0 uses
  %i.xp = load ptr, ptr %i.ww, align 8, !tbaa !73
  %i.xq = getelementptr inbounds nuw [8 x i8], ptr %i.xp, i64 %indvars.iv691
  %.val563 = load ptr, ptr %i.xq, align 8, !tbaa !74
  %i.xr = tail call i32 @opal_datatype_commit(ptr noundef %.val563) #12 ; 0 uses
  %i.xs = load ptr, ptr %i.ww, align 8, !tbaa !73
  %i.xt = getelementptr inbounds nuw [8 x i8], ptr %i.xs, i64 %indvars.iv691
  %i.xu = load ptr, ptr %i.xt, align 8, !tbaa !74 ; 2 uses
  %i.xv = getelementptr i8, ptr %i.xu, i64 24
  %.val564 = load i64, ptr %i.xv, align 8, !tbaa !221
  %.not559 = icmp eq i64 %.val564, 0
  br i1 %.not559, label %bb.bp, label %bb.bo

bb.bo:                                            ; preds = %bb.bn
  %i.xw = load ptr, ptr getelementptr inbounds nuw (i8, ptr @mca_pml, i64 64), align 8, !tbaa !223
  %i.xx = load ptr, ptr %i.wx, align 8, !tbaa !72
  %i.xy = load ptr, ptr %i.wy, align 8, !tbaa !55
  %i.xz = getelementptr inbounds nuw [4 x i8], ptr %i.xy, i64 %indvars.iv691
  %i.ya = load i32, ptr %i.xz, align 4, !tbaa !9
  %i.yb = load ptr, ptr %i.xa, align 8, !tbaa !224
  %i.yc = tail call i32 %i.xw(ptr noundef %i.xx, i64 noundef 1, ptr noundef nonnull %i.xu, i32 noundef %i.ya, i32 noundef %i.wz, ptr noundef %i.yb, ptr noundef nonnull %i.xb) #12
  %.not560 = icmp eq i32 %i.yc, 0
...
bb.bp:                                            ; preds = %bb.bm, %bb.bo, %bb.bn
  ...
  %i.yd = load i32, ptr %i.of, align 8, !tbaa !54
  %i.ye = sext i32 %i.yd to i64
  %i.yf = icmp slt i64 %indvars.iv.next692, %i.ye
  br i1 %i.yf, label %bb.bm, label %.loopexit575, !llvm.loop !206
...
bb.bq:                                            ; preds = %.loopexit575
  %i.yg = sext i32 %.6 to i64                     ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #12
  store ptr @ompi_mpi_datatype_null, ptr %i.a, align 8, !tbaa !74
  %i.yh = tail call noalias dereferenceable_or_null(40) ptr @calloc(i64 noundef 10, i64 noundef 4) #14 ; 6 uses
  %i.yi = tail call noalias dereferenceable_or_null(80) ptr @calloc(i64 noundef 10, i64 noundef 8) #14 ; 4 uses
  %i.yj = icmp eq ptr %i.yh, null
  %i.yk = icmp eq ptr %i.yi, null
  %or.cond = or i1 %i.yj, %i.yk
  br i1 %or.cond, label %bb.bt, label %bb.br

bb.br:                                            ; preds = %bb.bq
  %i.yl = getelementptr inbounds nuw i8, ptr %3, i64 184 ; 2 uses
  %i.ym = getelementptr inbounds nuw i8, ptr %3, i64 168 ; 5 uses
  %i.yn = getelementptr inbounds nuw i8, ptr %3, i64 140 ; 8 uses
  %i.yo = load ptr, ptr %i.yl, align 8, !tbaa !63 ; 3 uses
  %i.yp = load i32, ptr %i.ym, align 8, !tbaa !225 ; 3 uses
  %i.yq = sext i32 %i.yp to i64
  %i.yr = getelementptr inbounds [16 x i8], ptr %i.yo, i64 %i.yq
  %i.ys = load ptr, ptr %i.yr, align 8, !tbaa !57
  %i.yt = ptrtoint ptr %i.ys to i64
  %i.yu = load i32, ptr %i.yn, align 4, !tbaa !226 ; 3 uses
  %i.yv = sext i32 %i.yu to i64
  %i.yw = add nsw i64 %i.yv, %i.yt                ; 2 uses
  %i.yx = sext i32 %i.yp to i64
  %i.yy = getelementptr inbounds [16 x i8], ptr %i.yo, i64 %i.yx
  %i.yz = getelementptr inbounds nuw i8, ptr %i.yy, i64 8
  %i.za = load i64, ptr %i.yz, align 8, !tbaa !58 ; 2 uses
  %i.zb = sext i32 %i.yu to i64                   ; 2 uses
  %i.zc = sub i64 %i.za, %i.zb                    ; 2 uses
  %.not558.peel = icmp ugt i64 %i.zc, %i.yg
  br i1 %.not558.peel, label %.thread804, label %bb.bs

.thread804:                                       ; preds = %bb.br
  store i32 %.6, ptr %i.yh, align 4, !tbaa !9
  %i.zd = add i32 %i.yu, %.6
  store i32 %i.zd, ptr %i.yn, align 4, !tbaa !226
  br label %.thread812

bb.bs:                                            ; preds = %bb.br
  %i.ze = trunc i64 %i.zc to i32
  store i32 %i.ze, ptr %i.yh, align 4, !tbaa !9
  %.neg.peel = sub i64 %i.yg, %i.za
  %i.zf = add i64 %.neg.peel, %i.zb               ; 2 uses
  %i.zg = add nsw i32 %i.yp, 1
  store i32 %i.zg, ptr %i.ym, align 8, !tbaa !225
  store i32 0, ptr %i.yn, align 4, !tbaa !226
  %.not555.peel = icmp eq i64 %i.zf, 0
...
.peel.next:                                       ; preds = %bb.bs, %bb.bw
  %i.zh = phi ptr [ %i.zr, %bb.bw ], [ %i.yo, %bb.bs ]
  %indvars.iv694 = phi i64 [ %indvars.iv.next695, %bb.bw ], [ 0, %bb.bs ] ; 2 uses
  %.0481638 = phi i32 [ %.1482, %bb.bw ], [ 10, %bb.bs ] ; 2 uses
  %.0484636 = phi i64 [ %i.aao, %bb.bw ], [ %i.zf, %bb.bs ] ; 3 uses
  %.0491635 = phi ptr [ %.1492, %bb.bw ], [ %i.yi, %bb.bs ] ; 2 uses
  %.0497634 = phi ptr [ %.1498, %bb.bw ], [ %i.yh, %bb.bs ] ; 2 uses
  %indvars.iv.next695 = add nuw nsw i64 %indvars.iv694, 1 ; 4 uses
  %i.zi = trunc nuw nsw i64 %indvars.iv.next695 to i32
  %.urem = urem i32 %i.zi, 10
  %i.zj = icmp eq i32 %.urem, 0
  br i1 %i.zj, label %bb.bu, label %bb.bv

bb.bu:                                            ; preds = %.peel.next
  %i.zk = add nsw i32 %.0481638, 10               ; 2 uses
  %i.zl = sext i32 %i.zk to i64                   ; 2 uses
  %i.zm = shl nsw i64 %i.zl, 2
  %i.zn = tail call ptr @realloc(ptr noundef nonnull %.0497634, i64 noundef %i.zm) #15
  %i.zo = shl nsw i64 %i.zl, 3
  %i.zp = tail call ptr @realloc(ptr noundef nonnull %.0491635, i64 noundef %i.zo) #15
  %.pre737.a = load ptr, ptr %i.yl, align 8, !tbaa !63
  %.pre738 = load i32, ptr %i.yn, align 4, !tbaa !226
  %i.zq = sext i32 %.pre738 to i64
  br label %bb.bv

bb.bv:                                            ; preds = %.peel.next, %bb.bu
  %i.zr = phi ptr [ %.pre737.a, %bb.bu ], [ %i.zh, %.peel.next ] ; 3 uses
  %i.zs = phi i64 [ %i.zq, %bb.bu ], [ 0, %.peel.next ] ; 2 uses
  %.1498 = phi ptr [ %i.zn, %bb.bu ], [ %.0497634, %.peel.next ] ; 3 uses
  %.1492 = phi ptr [ %i.zp, %bb.bu ], [ %.0491635, %.peel.next ] ; 3 uses
  %.1482 = phi i32 [ %i.zk, %bb.bu ], [ %.0481638, %.peel.next ]
  %i.zt = load i32, ptr %i.ym, align 8, !tbaa !225
  %i.zu = sext i32 %i.zt to i64
  %i.zv = getelementptr inbounds [16 x i8], ptr %i.zr, i64 %i.zu ; 2 uses
  %i.zw = load ptr, ptr %i.zv, align 8, !tbaa !57
  %i.zx = ptrtoint ptr %i.zw to i64
  %i.zy = sub i64 %i.zx, %i.yw
  %i.zz = add i64 %i.zy, %i.zs
  %i.aaa = getelementptr inbounds nuw [8 x i8], ptr %.1492, i64 %indvars.iv.next695
  store i64 %i.zz, ptr %i.aaa, align 8, !tbaa !16
  %.phi.trans.insert740 = getelementptr inbounds nuw i8, ptr %i.zv, i64 8
  %.pre741 = load i64, ptr %.phi.trans.insert740, align 8, !tbaa !58
  %i.aab = sub i64 %.pre741, %i.zs                ; 2 uses
  %.not558 = icmp ult i64 %.0484636, %i.aab
  %i.aac = getelementptr inbounds nuw [4 x i8], ptr %.1498, i64 %indvars.iv.next695 ; 2 uses
  br i1 %.not558, label %.thread808, label %bb.bw

.thread808:                                       ; preds = %bb.bv
  %i.aad = trunc i64 %.0484636 to i32             ; 2 uses
  store i32 %i.aad, ptr %i.aac, align 4, !tbaa !9
  %i.aae = load i32, ptr %i.yn, align 4, !tbaa !226
  %i.aaf = add i32 %i.aae, %i.aad
  store i32 %i.aaf, ptr %i.yn, align 4, !tbaa !226
  br label %.loopexit821

bb.bw:                                            ; preds = %bb.bv
  %i.aag = trunc i64 %i.aab to i32
  store i32 %i.aag, ptr %i.aac, align 4, !tbaa !9
  %i.aah = load i32, ptr %i.ym, align 8, !tbaa !225 ; 2 uses
  %i.aai = sext i32 %i.aah to i64
  %i.aaj = getelementptr inbounds [16 x i8], ptr %i.zr, i64 %i.aai
  %i.aak = getelementptr inbounds nuw i8, ptr %i.aaj, i64 8
  %i.aal = load i64, ptr %i.aak, align 8, !tbaa !58
  %i.aam = load i32, ptr %i.yn, align 4, !tbaa !226
  %i.aan = sext i32 %i.aam to i64
  %.neg = sub i64 %.0484636, %i.aal
  %i.aao = add i64 %.neg, %i.aan                  ; 2 uses
  %i.aap = add nsw i32 %i.aah, 1
  store i32 %i.aap, ptr %i.ym, align 8, !tbaa !225
  store i32 0, ptr %i.yn, align 4, !tbaa !226
end_hunk_1
