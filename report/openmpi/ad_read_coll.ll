...
bb.b:                                             ; preds = %.lr.ph492, %._crit_edge481
  ...
  %.0276489 = phi i32 [ 0, %.lr.ph492 ], [ %.1277.lcssa, %._crit_edge481 ] ; 2 uses
  %.0279488 = phi i64 [ %i.aw, %.lr.ph492 ], [ %.1280.lcssa, %._crit_edge481 ] ; 2 uses
  %.0296487 = phi i64 [ %i.ay, %.lr.ph492 ], [ %.1297.lcssa, %._crit_edge481 ] ; 2 uses
  %.0315486 = phi i32 [ 0, %.lr.ph492 ], [ %.1316.lcssa, %._crit_edge481 ] ; 2 uses
...
.lr.ph480:                                        ; preds = %.lr.ph480.preheader, %.loopexit
  %.1277478 = phi i32 [ %.23, %.loopexit ], [ %.0276489, %.lr.ph480.preheader ] ; 7 uses
  %.1280477 = phi i64 [ %.16295, %.loopexit ], [ %.0279488, %.lr.ph480.preheader ] ; 7 uses
  %.1297476 = phi i64 [ %.16312, %.loopexit ], [ %.0296487, %.lr.ph480.preheader ] ; 7 uses
  %.0313475 = phi i64 [ %i.iq, %.loopexit ], [ %i.bc, %.lr.ph480.preheader ] ; 2 uses
  %.0314474 = phi i64 [ %i.ip, %.loopexit ], [ %i.be, %.lr.ph480.preheader ] ; 2 uses
  %.1316473 = phi i32 [ %.23338, %.loopexit ], [ %.0315486, %.lr.ph480.preheader ] ; 7 uses
  store i64 %.0313475, ptr %i.b, align 8, !tbaa !37
  %i.bf = call i32 @ADIOI_Calc_aggregator(ptr noundef %0, i64 noundef %.0314474, i64 noundef %12, ptr noundef nonnull %i.b, i64 noundef %13, ptr noundef %14, ptr noundef %15) #6
...
.lr.ph441:                                        ; preds = %.lr.ph441.preheader, %bb.f
  %.2278439 = phi i32 [ %.4, %bb.f ], [ %.1277478, %.lr.ph441.preheader ] ; 3 uses
  %.2281438 = phi i64 [ %.3282, %bb.f ], [ %.1280477, %.lr.ph441.preheader ] ; 2 uses
  %.2298437 = phi i64 [ %.3299, %bb.f ], [ %.1297476, %.lr.ph441.preheader ]
  %.2317436 = phi i32 [ %.4319, %bb.f ], [ %.1316473, %.lr.ph441.preheader ] ; 2 uses
  %.0341435 = phi i64 [ %i.cu, %bb.f ], [ %i.ca, %.lr.ph441.preheader ] ; 2 uses
  %i.cb = call i64 @llvm.smin.i64(i64 %.0341435, i64 %.2281438) ; 3 uses
  %i.cc = add nsw i64 %i.cb, %.2298437
  %i.cd = sub nsw i64 %.2281438, %i.cb            ; 2 uses
  %.not378 = icmp eq i64 %i.cd, 0
  br i1 %.not378, label %bb.e, label %bb.f

bb.e:                                             ; preds = %.lr.ph441
  %i.ce = sext i32 %.2278439 to i64
  %i.cf = load i64, ptr %i.az, align 8, !tbaa !74
  %i.cg = add nsw i64 %i.cf, -1
  %i.ch = icmp sle i64 %i.cg, %i.ce               ; 2 uses
  %i.ci = add nsw i32 %.2278439, 1
  %i.cj = zext i1 %i.ch to i32
  %.3318 = add nsw i32 %.2317436, %i.cj           ; 2 uses
  %.3 = select i1 %i.ch, i32 0, i32 %i.ci         ; 2 uses
...
bb.f:                                             ; preds = %bb.e, %.lr.ph441
  %.4319 = phi i32 [ %.2317436, %.lr.ph441 ], [ %.3318, %bb.e ] ; 3 uses
  %.3299 = phi i64 [ %i.cc, %.lr.ph441 ], [ %i.cq, %bb.e ] ; 3 uses
  %.3282 = phi i64 [ %i.cd, %.lr.ph441 ], [ %i.ct, %bb.e ] ; 3 uses
  %.4 = phi i32 [ %.2278439, %.lr.ph441 ], [ %.3, %bb.e ] ; 3 uses
  %i.cu = sub nsw i64 %.0341435, %i.cb            ; 2 uses
...
.preheader380:                                    ; preds = %bb.i, %._crit_edge442
  %.1342.lcssa = phi i64 [ %i.bw, %._crit_edge442 ], [ %i.ea, %bb.i ] ; 2 uses
  %.5320.lcssa = phi i32 [ %.4319, %._crit_edge442 ], [ %.7322, %bb.i ] ; 2 uses
  %.4300.lcssa = phi i64 [ %.3299, %._crit_edge442 ], [ %.5301, %bb.i ] ; 2 uses
  %.4283.lcssa = phi i64 [ %.3282, %._crit_edge442 ], [ %.5284, %bb.i ] ; 2 uses
  %.5.lcssa = phi i32 [ %.4, %._crit_edge442 ], [ %.7, %bb.i ] ; 2 uses
...
bb.g:                                             ; preds = %.lr.ph455, %bb.i
  ...
  %.5453 = phi i32 [ %.4, %.lr.ph455 ], [ %.7, %bb.i ] ; 3 uses
  %.4283452 = phi i64 [ %.3282, %.lr.ph455 ], [ %.5284, %bb.i ] ; 2 uses
  %.4300451 = phi i64 [ %.3299, %.lr.ph455 ], [ %.5301, %bb.i ] ; 2 uses
  %.5320450 = phi i32 [ %.4319, %.lr.ph455 ], [ %.7322, %bb.i ] ; 2 uses
  %.0339449 = phi i64 [ %., %.lr.ph455 ], [ %i.dz, %bb.i ] ; 2 uses
  %.1342448 = phi i64 [ %i.bw, %.lr.ph455 ], [ %i.ea, %bb.i ]
  %i.cz = call i64 @llvm.smin.i64(i64 %.0339449, i64 %.4283452) ; 6 uses
  %i.da = getelementptr inbounds i8, ptr %1, i64 %.4300451
...
bb.i:                                             ; preds = %bb.h, %bb.g
  %.7322 = phi i32 [ %.5320450, %bb.g ], [ %.6321, %bb.h ] ; 2 uses
  %.5301 = phi i64 [ %i.dh, %bb.g ], [ %i.dv, %bb.h ] ; 2 uses
  %.5284 = phi i64 [ %i.di, %bb.g ], [ %i.dy, %bb.h ] ; 2 uses
  %.7 = phi i32 [ %.5453, %bb.g ], [ %.6, %bb.h ] ; 2 uses
  %i.dz = sub nsw i64 %.0339449, %i.cz            ; 2 uses
  %i.ea = sub nsw i64 %.1342448, %i.cz            ; 2 uses
  %.not374 = icmp eq i64 %i.dz, 0
  br i1 %.not374, label %.preheader380, label %bb.g, !llvm.loop !85

.lr.ph467:                                        ; preds = %.preheader380, %bb.k
  %.8466 = phi i32 [ %.10, %bb.k ], [ %.5.lcssa, %.preheader380 ] ; 3 uses
  %.6285465 = phi i64 [ %.7286, %bb.k ], [ %.4283.lcssa, %.preheader380 ] ; 2 uses
  %.6302464 = phi i64 [ %.7303, %bb.k ], [ %.4300.lcssa, %.preheader380 ]
  %.8323463 = phi i32 [ %.10325, %bb.k ], [ %.5320.lcssa, %.preheader380 ] ; 2 uses
  %.2343462 = phi i64 [ %i.eu, %bb.k ], [ %.1342.lcssa, %.preheader380 ] ; 2 uses
  %i.eb = call i64 @llvm.smin.i64(i64 %.2343462, i64 %.6285465) ; 3 uses
  %i.ec = add nsw i64 %i.eb, %.6302464
  %i.ed = sub nsw i64 %.6285465, %i.eb            ; 2 uses
  %.not376 = icmp eq i64 %i.ed, 0
  br i1 %.not376, label %bb.j, label %bb.k

bb.j:                                             ; preds = %.lr.ph467
  %i.ee = sext i32 %.8466 to i64
  %i.ef = load i64, ptr %i.az, align 8, !tbaa !74
  %i.eg = add nsw i64 %i.ef, -1
  %i.eh = icmp sle i64 %i.eg, %i.ee               ; 2 uses
  %i.ei = add nsw i32 %.8466, 1
  %i.ej = zext i1 %i.eh to i32
  %.9324 = add nsw i32 %.8323463, %i.ej           ; 2 uses
  %.9 = select i1 %i.eh, i32 0, i32 %i.ei         ; 2 uses
  %i.ek = load ptr, ptr %i.as, align 8, !tbaa !72
  %i.el = sext i32 %.9 to i64                     ; 2 uses
  %i.em = getelementptr inbounds [8 x i8], ptr %i.ek, i64 %i.el
  %i.en = load i64, ptr %i.em, align 8, !tbaa !37
  %i.eo = sext i32 %.9324 to i64
...
bb.k:                                             ; preds = %bb.j, %.lr.ph467
  %.10325 = phi i32 [ %.8323463, %.lr.ph467 ], [ %.9324, %bb.j ] ; 2 uses
  %.7303 = phi i64 [ %i.ec, %.lr.ph467 ], [ %i.eq, %bb.j ] ; 2 uses
  %.7286 = phi i64 [ %i.ed, %.lr.ph467 ], [ %i.et, %bb.j ] ; 2 uses
  %.10 = phi i32 [ %.8466, %.lr.ph467 ], [ %.9, %bb.j ] ; 2 uses
  %i.eu = sub nsw i64 %.2343462, %i.eb            ; 2 uses
...
.preheader381:                                    ; preds = %bb.o, %bb.l
  %.3344.lcssa = phi i64 [ %i.bp, %bb.l ], [ %i.gc, %bb.o ] ; 2 uses
  %.11326.lcssa = phi i32 [ %.1316473, %bb.l ], [ %.13328, %bb.o ] ; 2 uses
  %.8304.lcssa = phi i64 [ %.1297476, %bb.l ], [ %.9305, %bb.o ] ; 2 uses
  %.8287.lcssa = phi i64 [ %.1280477, %bb.l ], [ %.9288, %bb.o ] ; 2 uses
  %.11.lcssa = phi i32 [ %.1277478, %bb.l ], [ %.13, %bb.o ] ; 2 uses
...
bb.m:                                             ; preds = %.lr.ph417, %bb.o
  ...
  %.11415 = phi i32 [ %.1277478, %.lr.ph417 ], [ %.13, %bb.o ] ; 3 uses
  %.8287414 = phi i64 [ %.1280477, %.lr.ph417 ], [ %.9288, %bb.o ] ; 2 uses
  %.8304413 = phi i64 [ %.1297476, %.lr.ph417 ], [ %.9305, %bb.o ] ; 2 uses
  %.11326412 = phi i32 [ %.1316473, %.lr.ph417 ], [ %.13328, %bb.o ] ; 2 uses
  %.1340411 = phi i64 [ %.379, %.lr.ph417 ], [ %i.gb, %bb.o ] ; 2 uses
  %.3344410 = phi i64 [ %i.bp, %.lr.ph417 ], [ %i.gc, %bb.o ]
  %i.fb = call i64 @llvm.smin.i64(i64 %.1340411, i64 %.8287414) ; 6 uses
  %i.fc = getelementptr inbounds i8, ptr %1, i64 %.8304413
...
bb.o:                                             ; preds = %bb.n, %bb.m
  %.13328 = phi i32 [ %.11326412, %bb.m ], [ %.12327, %bb.n ] ; 2 uses
  %.9305 = phi i64 [ %i.fj, %bb.m ], [ %i.fx, %bb.n ] ; 2 uses
  %.9288 = phi i64 [ %i.fk, %bb.m ], [ %i.ga, %bb.n ] ; 2 uses
  %.13 = phi i32 [ %.11415, %bb.m ], [ %.12, %bb.n ] ; 2 uses
  %i.gb = sub nsw i64 %.1340411, %i.fb            ; 2 uses
  %i.gc = sub nsw i64 %.3344410, %i.fb            ; 2 uses
  %.not369 = icmp eq i64 %i.gb, 0
  br i1 %.not369, label %.preheader381, label %bb.m, !llvm.loop !87

.lr.ph429:                                        ; preds = %.preheader381, %bb.q
  %.14428 = phi i32 [ %.16, %bb.q ], [ %.11.lcssa, %.preheader381 ] ; 3 uses
  %.10289427 = phi i64 [ %.11290, %bb.q ], [ %.8287.lcssa, %.preheader381 ] ; 2 uses
  %.10306426 = phi i64 [ %.11307, %bb.q ], [ %.8304.lcssa, %.preheader381 ]
  %.14329425 = phi i32 [ %.16331, %bb.q ], [ %.11326.lcssa, %.preheader381 ] ; 2 uses
  %.4345424 = phi i64 [ %i.gw, %bb.q ], [ %.3344.lcssa, %.preheader381 ] ; 2 uses
  %i.gd = call i64 @llvm.smin.i64(i64 %.4345424, i64 %.10289427) ; 3 uses
  %i.ge = add nsw i64 %i.gd, %.10306426
  %i.gf = sub nsw i64 %.10289427, %i.gd           ; 2 uses
  %.not371 = icmp eq i64 %i.gf, 0
  br i1 %.not371, label %bb.p, label %bb.q

bb.p:                                             ; preds = %.lr.ph429
  %i.gg = sext i32 %.14428 to i64
  %i.gh = load i64, ptr %i.az, align 8, !tbaa !74
  %i.gi = add nsw i64 %i.gh, -1
  %i.gj = icmp sle i64 %i.gi, %i.gg               ; 2 uses
  %i.gk = add nsw i32 %.14428, 1
  %i.gl = zext i1 %i.gj to i32
  %.15330 = add nsw i32 %.14329425, %i.gl         ; 2 uses
  %.15 = select i1 %i.gj, i32 0, i32 %i.gk        ; 2 uses
  %i.gm = load ptr, ptr %i.as, align 8, !tbaa !72
  %i.gn = sext i32 %.15 to i64                    ; 2 uses
  %i.go = getelementptr inbounds [8 x i8], ptr %i.gm, i64 %i.gn
  %i.gp = load i64, ptr %i.go, align 8, !tbaa !37
  %i.gq = sext i32 %.15330 to i64
...
bb.q:                                             ; preds = %bb.p, %.lr.ph429
  %.16331 = phi i32 [ %.14329425, %.lr.ph429 ], [ %.15330, %bb.p ] ; 2 uses
  %.11307 = phi i64 [ %i.ge, %.lr.ph429 ], [ %i.gs, %bb.p ] ; 2 uses
  %.11290 = phi i64 [ %i.gf, %.lr.ph429 ], [ %i.gv, %bb.p ] ; 2 uses
  %.16 = phi i32 [ %.14428, %.lr.ph429 ], [ %.15, %bb.p ] ; 2 uses
  %i.gw = sub nsw i64 %.4345424, %i.gd            ; 2 uses
...
.lr.ph404:                                        ; preds = %bb.r, %bb.t
  %.17402 = phi i32 [ %.19, %bb.t ], [ %.1277478, %bb.r ] ; 3 uses
  %.12291401 = phi i64 [ %.13292, %bb.t ], [ %.1280477, %bb.r ] ; 2 uses
  %.12308400 = phi i64 [ %.13309, %bb.t ], [ %.1297476, %bb.r ]
  %.17332399 = phi i32 [ %.19334, %bb.t ], [ %.1316473, %bb.r ] ; 2 uses
  %.5346398 = phi i64 [ %i.hs, %bb.t ], [ %i.bp, %bb.r ] ; 2 uses
  %i.gz = call i64 @llvm.smin.i64(i64 %.5346398, i64 %.12291401) ; 3 uses
  %i.ha = add nsw i64 %i.gz, %.12308400
  %i.hb = sub nsw i64 %.12291401, %i.gz           ; 2 uses
  %.not368 = icmp eq i64 %i.hb, 0
  br i1 %.not368, label %bb.s, label %bb.t

bb.s:                                             ; preds = %.lr.ph404
  %i.hc = sext i32 %.17402 to i64
  %i.hd = load i64, ptr %i.az, align 8, !tbaa !74
  %i.he = add nsw i64 %i.hd, -1
  %i.hf = icmp sle i64 %i.he, %i.hc               ; 2 uses
  %i.hg = add nsw i32 %.17402, 1
  %i.hh = zext i1 %i.hf to i32
  %.18333 = add nsw i32 %.17332399, %i.hh         ; 2 uses
  %.18 = select i1 %i.hf, i32 0, i32 %i.hg        ; 2 uses
  %i.hi = load ptr, ptr %i.as, align 8, !tbaa !72
  %i.hj = sext i32 %.18 to i64                    ; 2 uses
  %i.hk = getelementptr inbounds [8 x i8], ptr %i.hi, i64 %i.hj
  %i.hl = load i64, ptr %i.hk, align 8, !tbaa !37
  %i.hm = sext i32 %.18333 to i64
...
bb.t:                                             ; preds = %bb.s, %.lr.ph404
  %.19334 = phi i32 [ %.17332399, %.lr.ph404 ], [ %.18333, %bb.s ] ; 2 uses
  %.13309 = phi i64 [ %i.ha, %.lr.ph404 ], [ %i.ho, %bb.s ] ; 2 uses
  %.13292 = phi i64 [ %i.hb, %.lr.ph404 ], [ %i.hr, %bb.s ] ; 2 uses
  %.19 = phi i32 [ %.17402, %.lr.ph404 ], [ %.18, %bb.s ] ; 2 uses
  %i.hs = sub nsw i64 %.5346398, %i.gz            ; 2 uses
...
.lr.ph393:                                        ; preds = %bb.u, %bb.w
  %.20391 = phi i32 [ %.22, %bb.w ], [ %.1277478, %bb.u ] ; 3 uses
  %.14293390 = phi i64 [ %.15294, %bb.w ], [ %.1280477, %bb.u ] ; 2 uses
  %.14310389 = phi i64 [ %.15311, %bb.w ], [ %.1297476, %bb.u ]
  %.20335388 = phi i32 [ %.22337, %bb.w ], [ %.1316473, %bb.u ] ; 2 uses
  %.6347387 = phi i64 [ %i.in, %bb.w ], [ %i.ht, %bb.u ] ; 2 uses
  %i.hu = call i64 @llvm.smin.i64(i64 %.6347387, i64 %.14293390) ; 3 uses
  %i.hv = add nsw i64 %i.hu, %.14310389
  %i.hw = sub nsw i64 %.14293390, %i.hu           ; 2 uses
  %.not366 = icmp eq i64 %i.hw, 0
  br i1 %.not366, label %bb.v, label %bb.w

bb.v:                                             ; preds = %.lr.ph393
  %i.hx = sext i32 %.20391 to i64
  %i.hy = load i64, ptr %i.az, align 8, !tbaa !74
  %i.hz = add nsw i64 %i.hy, -1
  %i.ia = icmp sle i64 %i.hz, %i.hx               ; 2 uses
  %i.ib = add nsw i32 %.20391, 1
  %i.ic = zext i1 %i.ia to i32
  %.21336 = add nsw i32 %.20335388, %i.ic         ; 2 uses
  %.21 = select i1 %i.ia, i32 0, i32 %i.ib        ; 2 uses
  %i.id = load ptr, ptr %i.as, align 8, !tbaa !72
  %i.ie = sext i32 %.21 to i64                    ; 2 uses
  %i.if = getelementptr inbounds [8 x i8], ptr %i.id, i64 %i.ie
  %i.ig = load i64, ptr %i.if, align 8, !tbaa !37
  %i.ih = sext i32 %.21336 to i64
  %i.ii = mul nsw i64 %16, %i.ih
  %i.ij = add nsw i64 %i.ii, %i.ig
end_hunk_0
begin_hunk_1_@ADIOI_R_Exchange_data:bb.a
  %.2143184 = phi i32 [ 0, %.lr.ph186 ], [ %.3144, %bb.h ] ; 3 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.di = add nsw i32 %.2143184, 1
  br label %bb.h

bb.h:                                             ; preds = %bb.f, %bb.g
  %.3144 = phi i32 [ %i.di, %bb.g ], [ %.2143184, %bb.f ]
...
bb.i:                                             ; preds = %.lr.ph192, %bb.o
  ...
  %.4145189 = phi i32 [ 0, %.lr.ph192 ], [ %.5, %bb.o ] ; 3 uses
  %.0152188 = phi i32 [ 0, %.lr.ph192 ], [ %.2154, %bb.o ] ; 2 uses
  %.0155187 = phi i32 [ 0, %.lr.ph192 ], [ %.2157, %bb.o ] ; 2 uses
...
bb.l:                                             ; preds = %._crit_edge216, %bb.k
  ...
  %.1156 = phi i32 [ %i.dw, %bb.k ], [ %.0155187, %._crit_edge216 ] ; 2 uses
  %.1153 = phi i32 [ %i.ed, %bb.k ], [ %.0152188, %._crit_edge216 ] ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.fa = sext i32 %.1153 to i64
  %i.fb = load ptr, ptr %i.ez, align 8, !tbaa !56
  %i.fc = sext i32 %.1156 to i64
  %i.fd = getelementptr inbounds [8 x i8], ptr %i.fb, i64 %i.fc
  store i64 %i.fa, ptr %i.fd, align 8, !tbaa !37
  br label %bb.n

bb.n:                                             ; preds = %bb.m, %bb.l
  %i.fe = add nsw i32 %.4145189, 1
  br label %bb.o

bb.o:                                             ; preds = %bb.i, %bb.n
  %.2157 = phi i32 [ %.1156, %bb.n ], [ %.0155187, %bb.i ]
  %.2154 = phi i32 [ %.1153, %bb.n ], [ %.0152188, %bb.i ]
  %.5 = phi i32 [ %i.fe, %bb.n ], [ %.4145189, %bb.i ]
...
._crit_edge193.thread232:                         ; preds = %.preheader
  %.not163234 = icmp eq i32 %.0150.lcssa, 0
  br i1 %.not163234, label %bb.r, label %.thread235

.thread235:                                       ; preds = %._crit_edge193.thread232
  %i.ff = tail call i32 @PMPI_Waitall(i32 noundef %.0150.lcssa, ptr noundef %i.ap, ptr noundef null) #6 ; 0 uses
  br label %bb.q

._crit_edge193.thread:                            ; preds = %.preheader170
  %.not163228 = icmp eq i32 %.0150.lcssa, 0
  br i1 %.not163228, label %bb.r, label %.thread

.thread:                                          ; preds = %._crit_edge193.thread
  %i.fg = tail call i32 @PMPI_Waitall(i32 noundef %.0150.lcssa, ptr noundef %i.ap, ptr noundef null) #6 ; 0 uses
  br label %.critedge

bb.p:                                             ; preds = %._crit_edge193
  %i.fh = call i32 @PMPI_Waitall(i32 noundef %.0150.lcssa, ptr noundef %i.ap, ptr noundef null) #6 ; 0 uses
  br i1 %.not, label %bb.q, label %.critedge

bb.q:                                             ; preds = %.thread235, %bb.p
  %.0147226229237 = phi ptr [ %i.bk, %.thread235 ], [ %.0147, %bb.p ] ; 2 uses
  call void @ADIOI_Fill_user_buffer(ptr noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %.0147226229237, ptr noundef %3, ptr noundef %4, ptr noundef %6, ptr poison, ptr poison, ptr noundef %10, i32 noundef %11, i32 noundef %14, i64 noundef %15, i64 noundef %16, ptr noundef %17, ptr noundef %18, i64 noundef %21)
  br label %bb.r

bb.r:                                             ; preds = %._crit_edge193.thread232, %._crit_edge193.thread, %bb.q, %._crit_edge193
  %.0147226230 = phi ptr [ null, %._crit_edge193.thread ], [ %.0147226229237, %bb.q ], [ %.0147, %._crit_edge193 ], [ %i.bk, %._crit_edge193.thread232 ] ; 2 uses
  %i.fi = zext nneg i32 %.0150.lcssa to i64
  %i.fj = getelementptr inbounds nuw [8 x i8], ptr %i.ap, i64 %i.fi
  %i.fk = call i32 @PMPI_Waitall(i32 noundef %.0148.lcssa, ptr noundef %i.fj, ptr noundef null) #6 ; 0 uses
  call void @ADIOI_Free_fn(ptr noundef %i.ap, i32 noundef 891, ptr noundef nonnull @.str) #6
  br i1 %.not, label %bb.s, label %bb.t

bb.s:                                             ; preds = %bb.r
  %i.fl = load ptr, ptr %.0147226230, align 8, !tbaa !84
  call void @ADIOI_Free_fn(ptr noundef %i.fl, i32 noundef 894, ptr noundef nonnull @.str) #6
  call void @ADIOI_Free_fn(ptr noundef nonnull %.0147226230, i32 noundef 895, ptr noundef nonnull @.str) #6
  br label %bb.t

.critedge:                                        ; preds = %.thread, %bb.p
  %i.fm = zext nneg i32 %.0150.lcssa to i64
  %i.fn = getelementptr inbounds nuw [8 x i8], ptr %i.ap, i64 %i.fm
  %i.fo = call i32 @PMPI_Waitall(i32 noundef %.0148.lcssa, ptr noundef nonnull %i.fn, ptr noundef null) #6 ; 0 uses
  call void @ADIOI_Free_fn(ptr noundef %i.ap, i32 noundef 891, ptr noundef nonnull @.str) #6
  br label %bb.t
