...
bb.a:
  %i.a = load i8, ptr @ompi_mpi_param_check, align 1, !tbaa !25, !range !26, !noundef !27
  %i.b = trunc nuw i8 %i.a to i1
  br i1 %i.b, label %bb.b, label %bb.j

bb.b:                                             ; preds = %bb.a
  %i.c = load volatile i32, ptr @ompi_instance_count, align 4, !tbaa !28
...
bb.e:                                             ; preds = %bb.d
  %i.g = load ptr, ptr getelementptr inbounds nuw (i8, ptr @ompi_mpi_comm_world, i64 312), align 8, !tbaa !57
  %i.h = load i32, ptr getelementptr inbounds nuw (i8, ptr @ompi_mpi_comm_world, i64 320), align 8, !tbaa !58
...
bb.g:                                             ; preds = %bb.f
  %i.l = load ptr, ptr getelementptr inbounds nuw (i8, ptr @ompi_mpi_comm_world, i64 312), align 8, !tbaa !57
  %i.m = load i32, ptr getelementptr inbounds nuw (i8, ptr @ompi_mpi_comm_world, i64 320), align 8, !tbaa !58
...
bb.i:                                             ; preds = %bb.h
  %i.p = load ptr, ptr getelementptr inbounds nuw (i8, ptr @ompi_mpi_comm_world, i64 312), align 8, !tbaa !57
  %i.q = load i32, ptr getelementptr inbounds nuw (i8, ptr @ompi_mpi_comm_world, i64 320), align 8, !tbaa !58
...
.lr.ph:                                           ; preds = %bb.j, %bb.p
  ...
  %i.t = load i32, ptr %.086, align 4, !tbaa !28  ; 4 uses
...
vector.body139:                                   ; preds = %pred.store.continue164, %vector.ph137
  ...
  %wide.load149.a = load <4 x i32>, ptr %next.gep141.a, align 4, !tbaa !28
...
pred.store.if:                                    ; preds = %vector.body139
  store i32 1, ptr %next.gep141.a, align 4, !tbaa !28
...
pred.store.if151:                                 ; preds = %pred.store.continue
  store i32 1, ptr %next.gep142.a, align 4, !tbaa !28
...
pred.store.if153:                                 ; preds = %pred.store.continue152
  store i32 1, ptr %next.gep143.a, align 4, !tbaa !28
...
pred.store.if155:                                 ; preds = %pred.store.continue154
  store i32 1, ptr %next.gep144.a, align 4, !tbaa !28
...
pred.store.if157:                                 ; preds = %pred.store.continue156
  store i32 1, ptr %next.gep145.a, align 4, !tbaa !28
...
pred.store.if159:                                 ; preds = %pred.store.continue158
  store i32 1, ptr %next.gep146.a, align 4, !tbaa !28
...
pred.store.if161:                                 ; preds = %pred.store.continue160
  store i32 1, ptr %next.gep147.a, align 4, !tbaa !28
...
.preheader34.i:                                   ; preds = %.preheader34.loopexit.i, %bb.v
  ...
  %i.bz = icmp samesign ugt i32 %i.bn, 2
...
.lr.ph.i:                                         ; preds = %bb.v, %.lr.ph.i
  ...
  store i32 2, ptr %i.cc, align 4, !tbaa !28
  %i.cd = and i32 %.03035.i, 2
  %i.ce = icmp eq i32 %i.cd, 0
  br i1 %i.ce, label %.lr.ph.i, label %.preheader34.loopexit.i, !llvm.loop !11
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> splat (i32 1), ptr %i.de, align 4, !tbaa !28
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.df = icmp eq i64 %index.next, %n.vec
  br i1 %i.df, label %middle.block, label %vector.body, !llvm.loop !14
...
.lr.ph65.us.i:                                    ; preds = %._crit_edge.us.i, %.lr.ph65.us.preheader.i
  ...
  %.pre.i = load i32, ptr %i.cx, align 4, !tbaa !28 ; 2 uses
...
.lr.ph65.us.i.new:                                ; preds = %.lr.ph65.us.i, %.lr.ph65.us.i.new
  ...
  %i.do = load i32, ptr %.146.us.i, align 4, !tbaa !28 ; 2 uses
  ...
  %i.dr = load i32, ptr %.146.us.i.1, align 4, !tbaa !28 ; 2 uses
  ...
  %i.du = load i32, ptr %.146.us.i.2, align 4, !tbaa !28 ; 2 uses
  ...
  %i.dx = load i32, ptr %.146.us.i.3, align 4, !tbaa !28 ; 2 uses
...
bb.y:                                             ; preds = %bb.y, %.epil.preheader
  ...
  %i.eb = load i32, ptr %.146.us.i.epil, align 4, !tbaa !28 ; 2 uses
...
._crit_edge.us.i:                                 ; preds = %bb.y, %._crit_edge.us.i.unr-lcssa
  ...
  %i.ee = load i32, ptr %spec.select.us.i.lcssa, align 4, !tbaa !28
  %i.ef = mul nsw i32 %i.ee, %i.dm
  store i32 %i.ef, ptr %spec.select.us.i.lcssa, align 4, !tbaa !28
  %indvars.iv.next.i58 = add nsw i64 %indvars.iv.i57, -1
  %i.eg = icmp sgt i64 %indvars.iv.i57, 0
  br i1 %i.eg, label %.lr.ph65.us.i, label %.preheader.i55, !llvm.loop !17

.lr.ph68.split.i:                                 ; preds = %.lr.ph68.i
  %.promoted.i = load i32, ptr %i.cx, align 4, !tbaa !28 ; 2 uses
...
vector.body126:                                   ; preds = %vector.body126, %vector.ph124
  ...
  %wide.load = load <4 x i32>, ptr %i.en, align 4, !tbaa !28
  %wide.load129 = load <4 x i32>, ptr %i.eo, align 4, !tbaa !28
  ...
  br i1 %i.er, label %middle.block132, label %vector.body126, !llvm.loop !18
...
.preheader.thread.i:                              ; preds = %scalar.ph122, %middle.block132
  ...
  store i32 %.lcssa, ptr %i.cx, align 4, !tbaa !28
...
scalar.ph122:                                     ; preds = %scalar.ph122.preheader, %scalar.ph122
  ...
  br i1 %.not92.i, label %.preheader.thread.i, label %scalar.ph122, !llvm.loop !20

.loopexit.i:                                      ; preds = %.lr.ph71.i.prol.loopexit, %bb.ac, %.lr.ph74.i
  %exitcond83.not.i = icmp eq i32 %.25272.i, %i.ew
  br i1 %exitcond83.not.i, label %.lr.ph92.preheader, label %.lr.ph74.i, !llvm.loop !21
...
.lr.ph71.preheader.i:                             ; preds = %.lr.ph74.i
  %.pre84.i = load i32, ptr %.273.i, align 4, !tbaa !28 ; 4 uses
...
.lr.ph71.i.prol:                                  ; preds = %.lr.ph71.preheader.i
  %i.fd = load i32, ptr %i.fc, align 4, !tbaa !28 ; 3 uses
  %i.fe = icmp sgt i32 %i.fd, %.pre84.i
  br i1 %i.fe, label %bb.z, label %.lr.ph71.i.prol.loopexit.unr-lcssa

bb.z:                                             ; preds = %.lr.ph71.i.prol
  store i32 %.pre84.i, ptr %i.fc, align 4, !tbaa !28
  store i32 %i.fd, ptr %.273.i, align 4, !tbaa !28
...
.lr.ph71.i:                                       ; preds = %.lr.ph71.i.prol.loopexit, %bb.ac
  ...
  %i.fk = load i32, ptr %.24770.i, align 4, !tbaa !28 ; 3 uses
  %i.fl = icmp sgt i32 %i.fk, %i.fj
  br i1 %i.fl, label %bb.aa, label %.lr.ph71.i.1

bb.aa:                                            ; preds = %.lr.ph71.i
  store i32 %i.fj, ptr %.24770.i, align 4, !tbaa !28
  store i32 %i.fk, ptr %.273.i, align 4, !tbaa !28
...
.lr.ph71.i.1:                                     ; preds = %bb.aa, %.lr.ph71.i
  ...
  %i.fo = load i32, ptr %i.fn, align 4, !tbaa !28 ; 3 uses
  %i.fp = icmp sgt i32 %i.fo, %i.fm
  br i1 %i.fp, label %bb.ab, label %bb.ac

bb.ab:                                            ; preds = %.lr.ph71.i.1
  store i32 %i.fm, ptr %i.fn, align 4, !tbaa !28
  store i32 %i.fo, ptr %.273.i, align 4, !tbaa !28
  br label %bb.ac
...
bb.ac:                                            ; preds = %bb.ab, %.lr.ph71.i.1
  ...
  br i1 %exitcond81.not.i.1, label %.loopexit.i, label %.lr.ph71.i, !llvm.loop !22
...
.lr.ph92:                                         ; preds = %bb.af, %.lr.ph92.preheader.new
  ...
  %i.fu = load i32, ptr %.14688, align 4, !tbaa !28
  %i.fv = icmp eq i32 %i.fu, 0
  br i1 %i.fv, label %bb.ad, label %.lr.ph92.1

bb.ad:                                            ; preds = %.lr.ph92
  %i.fw = getelementptr inbounds nuw i8, ptr %.190, i64 4
  %i.fx = load i32, ptr %.190, align 4, !tbaa !28
  store i32 %i.fx, ptr %.14688, align 4, !tbaa !28
  br label %.lr.ph92.1
...
bb.ae:                                            ; preds = %.lr.ph92.1
  ...
  %i.gc = load i32, ptr %.2, align 4, !tbaa !28
  store i32 %i.gc, ptr %i.fy, align 4, !tbaa !28
  br label %bb.af
...
bb.af:                                            ; preds = %bb.ae, %.lr.ph92.1
  ...
  br i1 %niter188.ncmp.1, label %._crit_edge93.unr-lcssa, label %.lr.ph92, !llvm.loop !23
...
.lr.ph92.epil.preheader:                          ; preds = %._crit_edge93.unr-lcssa, %.lr.ph92.preheader
  ...
  %i.ge = load i32, ptr %.14688.epil.init, align 4, !tbaa !28
  %i.gf = icmp eq i32 %i.ge, 0
  br i1 %i.gf, label %bb.ag, label %._crit_edge93

bb.ag:                                            ; preds = %.lr.ph92.epil.preheader
  %i.gg = load i32, ptr %.190.epil.init, align 4, !tbaa !28
  store i32 %i.gg, ptr %.14688.epil.init, align 4, !tbaa !28
...
!7 = !{!6, !5, i64 0}
!8 = distinct !{!8, !59}
!9 = distinct !{!9, !59, !60, !61}
!10 = distinct !{!10, !59, !61, !60}
!11 = distinct !{!11, !59}
!12 = distinct !{!12, !59}
!13 = distinct !{!13, !59}
!14 = distinct !{!14, !59, !60, !61}
!15 = distinct !{!15, !59}
!16 = distinct !{!16, !62}
!17 = distinct !{!17, !59}
!18 = distinct !{!18, !59, !60, !61}
!19 = distinct !{!19, !59, !61, !60}
!20 = distinct !{!20, !59, !61, !60}
!21 = distinct !{!21, !59}
!22 = distinct !{!22, !59}
!23 = distinct !{!23, !59}
!24 = !{!"_Bool", !4, i64 0}
...
!31 = !{!"p1 _ZTS12opal_class_t", !30, i64 0}
!32 = !{!"opal_object_t", !31, i64 0, !5, i64 8}
!33 = !{!"p1 _ZTS19opal_hash_element_t", !30, i64 0}
!34 = !{!"long", !4, i64 0}
!35 = !{!"p1 _ZTS24opal_hash_type_methods_t", !30, i64 0}
!36 = !{!"opal_hash_table_t", !32, i64 0, !33, i64 16, !34, i64 24, !34, i64 32, !34, i64 40, !5, i64 48, !5, i64 52, !5, i64 56, !5, i64 60, !35, i64 64}
!37 = !{!"p1 _ZTS11opal_info_t", !30, i64 0}
!38 = !{!"opal_infosubscriber_t", !32, i64 0, !36, i64 16, !37, i64 88}
!39 = !{!"opal_mutex_t", !32, i64 0, !4, i64 16, !5, i64 56}
!40 = !{!"p1 omnipotent char", !30, i64 0}
!41 = !{!"ompi_comm_extended_cid_t", !34, i64 0, !4, i64 8}
!42 = !{!"ompi_comm_extended_cid_block_t", !41, i64 0, !34, i64 16, !4, i64 24, !4, i64 25}
!43 = !{!"p1 int", !30, i64 0}
!44 = !{!"p1 _ZTS12ompi_group_t", !30, i64 0}
!45 = !{!"p1 _ZTS19ompi_communicator_t", !30, i64 0}
!46 = !{!"p1 _ZTS17opal_hash_table_t", !30, i64 0}
!47 = !{!"p1 _ZTS22mca_topo_base_module_t", !30, i64 0}
!48 = !{!"any p2 pointer", !30, i64 0}
!49 = !{!"p2 _ZTS20ompi_peruse_handle_t", !48, i64 0}
!50 = !{!"p1 _ZTS17ompi_errhandler_t", !30, i64 0}
!51 = !{!"p1 _ZTS14mca_pml_comm_t", !30, i64 0}
!52 = !{!"p1 _ZTS14mca_mtl_comm_t", !30, i64 0}
!53 = !{!"p1 _ZTS25mca_coll_base_comm_coll_t", !30, i64 0}
!54 = !{!"p1 _ZTS15ompi_instance_t", !30, i64 0}
!55 = !{!"p1 _ZTS13opal_object_t", !30, i64 0}
!56 = !{!"ompi_communicator_t", !38, i64 0, !39, i64 96, !40, i64 160, !41, i64 168, !42, i64 184, !5, i64 216, !5, i64 220, !5, i64 224, !5, i64 228, !5, i64 232, !43, i64 240, !5, i64 248, !5, i64 252, !5, i64 256, !44, i64 264, !44, i64 272, !45, i64 280, !46, i64 288, !47, i64 296, !49, i64 304, !50, i64 312, !5, i64 320, !51, i64 328, !52, i64 336, !53, i64 344, !54, i64 352, !55, i64 360, !5, i64 368, !5, i64 372, !24, i64 376, !24, i64 377, !24, i64 378}
end_hunk_1
