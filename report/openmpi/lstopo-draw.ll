...
bb.s:                                             ; preds = %bb.r, %._crit_edge142.thread.i
  ...
  %7 = add i32 %i.ef, 1                           ; 3 uses
  %8 = udiv i32 %i.ek, %7                         ; 2 uses
  %9 = mul i32 %8, %i.co
  %10 = mul i32 %7, %i.cp
  %11 = mul i32 %i.cp, %i.ef
  %12 = uitofp i32 %9 to float
  %13 = uitofp i32 %i.ej to float
  %i.el = uitofp i32 %10 to float
  %i.em = uitofp i32 %11 to float
  %i.en = insertelement <2 x float> poison, float %13, i64 0
  %i.eo = insertelement <2 x float> %i.en, float %12, i64 1
  %i.ep = insertelement <2 x float> poison, float %i.em, i64 0
  %i.eq = insertelement <2 x float> %i.ep, float %i.el, i64 1
...
find_children_rectangle.exit:                     ; preds = %bb.p, %._crit_edge142.i, %bb.s, %bb.t
  %.3104.i = phi i32 [ %8, %bb.s ], [ %.2103.ph.i, %._crit_edge142.i ], [ %i.fd, %bb.t ], [ %.1102.i, %bb.p ]
