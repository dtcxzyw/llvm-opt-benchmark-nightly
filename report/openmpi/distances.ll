...
.preheader54.i:                                   ; preds = %bb.k
  ...
  br i1 %7, label %.epil.preheader, label %.preheader54.i.new
...
.epil.preheader:                                  ; preds = %.unr-lcssa, %.preheader54.i
  ...
  %i.bn = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv.i.epil.init
...
.lr.ph61.split.us.split.us.i.preheader:           ; preds = %bb.q
  ...
  %8 = icmp eq i64 %6, 0
  br i1 %8, label %.lr.ph61.split.us.split.us.i.epil.preheader, label %.lr.ph61.split.us.split.us.i.preheader.new
...
.lr.ph61.split.us.split.us.i.epil.preheader:      ; preds = %hwloc_internal_distances_restrict.exit.unr-lcssa, %.lr.ph61.split.us.split.us.i.preheader
  ...
  %i.by = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv92.i.epil.init
...
bb.r:                                             ; preds = %.lr.ph61.split.us.split.us.i.epil.preheader
  %i.ca = zext i32 %.260.us.us.i.epil.init to i64
...
begin_hunk_1_@hwloc_backend_distances_add_commit:bb.a
  store ptr %1, ptr %i.ac, align 8, !tbaa !52
  br label %bb.n

bb.m:                                             ; preds = %.thread
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 704
  store ptr %1, ptr %i.ad, align 8, !tbaa !47
  br label %bb.n

bb.n:                                             ; preds = %bb.m, %bb.l
  %i.ae = getelementptr inbounds nuw i8, ptr %1, i64 72
  store ptr %i.ab, ptr %i.ae, align 8, !tbaa !68
  %i.af = getelementptr inbounds nuw i8, ptr %1, i64 80
  store ptr null, ptr %i.af, align 8, !tbaa !52
  store ptr %1, ptr %i.aa, align 8, !tbaa !67
  %i.ag = load i32, ptr %i.d, align 8, !tbaa !66
  %i.ah = and i32 %i.ag, -3
  store i32 %i.ah, ptr %i.d, align 8, !tbaa !66
  br label %bb.p

bb.o:                                             ; preds = %bb.d, %bb.a, %bb.b
  %i.ai = tail call ptr @__errno_location() #32
  store i32 22, ptr %i.ai, align 4, !tbaa !16
  %i.aj = load ptr, ptr %1, align 8, !tbaa !53
  tail call void @free(ptr noundef %i.aj) #28
...
bb.a:
  ...
  %fwrite = tail call i64 @fwrite(ptr nonnull %i.l, i64 8, i64 1, ptr %i.k) #34 ; 0 uses
  %.not = icmp eq i32 %i.b, 0
  br i1 %.not, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %bb.a
  %wide.trip.count47 = zext i32 %i.b to i64       ; 2 uses
...
.lr.ph.split.us:                                  ; preds = %.lr.ph.split.us.preheader, %.lr.ph.split.us
  ...
  %i.m = load ptr, ptr @stderr, align 8, !tbaa !91
  %i.n = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !79
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 16
  %i.q = load i32, ptr %i.p, align 8, !tbaa !88
  %i.r = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.m, ptr noundef nonnull @.str.12, i32 noundef %i.q) #35 ; 0 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count47
  br i1 %exitcond.not, label %.lr.ph38, label %.lr.ph.split.us, !llvm.loop !111

.lr.ph.split:                                     ; preds = %.lr.ph, %.lr.ph.split
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %.lr.ph.split ], [ 0, %.lr.ph ] ; 2 uses
  %i.s = load ptr, ptr @stderr, align 8, !tbaa !91
  %i.t = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv44
  ...
  %i.y = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.s, ptr noundef nonnull @.str.12, i32 noundef %i.x) #35 ; 0 uses
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1 ; 2 uses
  %exitcond48.not = icmp eq i64 %indvars.iv.next45, %wide.trip.count47
  br i1 %exitcond48.not, label %.lr.ph38, label %.lr.ph.split, !llvm.loop !111

._crit_edge:                                      ; preds = %bb.a
  %i.z = load ptr, ptr @stderr, align 8, !tbaa !91
  %fputc = tail call i32 @fputc(i32 10, ptr %i.z) ; 0 uses
  br label %._crit_edge39

.lr.ph38:                                         ; preds = %.lr.ph.split.us, %.lr.ph.split
  %i.aa = load ptr, ptr @stderr, align 8, !tbaa !91
  %fputc70 = tail call i32 @fputc(i32 10, ptr %i.aa) ; 0 uses
  %wide.trip.count68 = zext i32 %i.b to i64       ; 4 uses
  switch i32 %i.h, label %.lr.ph38.split [
    i32 13, label %.lr.ph38.split.us.preheader
    i32 3, label %.lr.ph38.split.us.preheader
  ]

.lr.ph38.split.us.preheader:                      ; preds = %.lr.ph38, %.lr.ph38
  br label %.lr.ph38.split.us

.lr.ph38.split.us:                                ; preds = %.lr.ph38.split.us.preheader, %bb.c
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %bb.c ], [ 0, %.lr.ph38.split.us.preheader ] ; 3 uses
  %i.ab = load ptr, ptr @stderr, align 8, !tbaa !91
  %i.ac = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv55
  %i.ad = load ptr, ptr %i.ac, align 8, !tbaa !79
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 16
  %i.af = load i32, ptr %i.ae, align 8, !tbaa !88
  %i.ag = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.ab, ptr noundef nonnull @.str.14, i32 noundef %i.af) #35 ; 0 uses
  %i.ah = trunc nuw i64 %indvars.iv55 to i32
  %i.ai = mul i32 %i.b, %i.ah
  br label %bb.b

bb.b:                                             ; preds = %bb.b, %.lr.ph38.split.us
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %bb.b ], [ 0, %.lr.ph38.split.us ] ; 2 uses
  %i.aj = load ptr, ptr @stderr, align 8, !tbaa !91
  %i.ak = trunc nuw i64 %indvars.iv49 to i32
  %i.al = add i32 %i.ai, %i.ak
  %i.am = zext i32 %i.al to i64
  %i.an = getelementptr inbounds nuw [8 x i8], ptr %i.f, i64 %i.am
  %i.ao = load i64, ptr %i.an, align 8, !tbaa !82
  %i.ap = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.aj, ptr noundef nonnull @.str.15, i64 noundef %i.ao) #35 ; 0 uses
  %indvars.iv.next50 = add nuw nsw i64 %indvars.iv49, 1 ; 2 uses
  %exitcond54.not = icmp eq i64 %indvars.iv.next50, %wide.trip.count68
  br i1 %exitcond54.not, label %bb.c, label %bb.b, !llvm.loop !112

bb.c:                                             ; preds = %bb.b
  %i.aq = load ptr, ptr @stderr, align 8, !tbaa !91
  %fputc33.us = tail call i32 @fputc(i32 10, ptr %i.aq) ; 0 uses
  %indvars.iv.next56 = add nuw nsw i64 %indvars.iv55, 1 ; 2 uses
  %exitcond59.not = icmp eq i64 %indvars.iv.next56, %wide.trip.count68
  br i1 %exitcond59.not, label %._crit_edge39, label %.lr.ph38.split.us, !llvm.loop !113

.lr.ph38.split:                                   ; preds = %.lr.ph38, %bb.e
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %bb.e ], [ 0, %.lr.ph38 ] ; 3 uses
  %i.ar = load ptr, ptr @stderr, align 8, !tbaa !91
  %i.as = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv65
  %i.at = load ptr, ptr %i.as, align 8, !tbaa !79
  %i.au = getelementptr inbounds nuw i8, ptr %i.at, i64 240
  %i.av = load i64, ptr %i.au, align 8, !tbaa !89
  %i.aw = trunc i64 %i.av to i32
  %i.ax = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.ar, ptr noundef nonnull @.str.14, i32 noundef %i.aw) #35 ; 0 uses
  %i.ay = trunc nuw i64 %indvars.iv65 to i32
  %i.az = mul i32 %i.b, %i.ay
  br label %bb.d

bb.d:                                             ; preds = %.lr.ph38.split, %bb.d
  %indvars.iv60 = phi i64 [ 0, %.lr.ph38.split ], [ %indvars.iv.next61, %bb.d ] ; 2 uses
  %i.ba = load ptr, ptr @stderr, align 8, !tbaa !91
  %i.bb = trunc nuw i64 %indvars.iv60 to i32
  %i.bc = add i32 %i.az, %i.bb
  %i.bd = zext i32 %i.bc to i64
  %i.be = getelementptr inbounds nuw [8 x i8], ptr %i.f, i64 %i.bd
  %i.bf = load i64, ptr %i.be, align 8, !tbaa !82
  %i.bg = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.ba, ptr noundef nonnull @.str.15, i64 noundef %i.bf) #35 ; 0 uses
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1 ; 2 uses
  %exitcond64.not = icmp eq i64 %indvars.iv.next61, %wide.trip.count68
  br i1 %exitcond64.not, label %bb.e, label %bb.d, !llvm.loop !112

bb.e:                                             ; preds = %bb.d
  %i.bh = load ptr, ptr @stderr, align 8, !tbaa !91
  %fputc33 = tail call i32 @fputc(i32 10, ptr %i.bh) ; 0 uses
  %indvars.iv.next66 = add nuw nsw i64 %indvars.iv65, 1 ; 2 uses
  %exitcond69.not = icmp eq i64 %indvars.iv.next66, %wide.trip.count68
  br i1 %exitcond69.not, label %._crit_edge39, label %.lr.ph38.split, !llvm.loop !113

._crit_edge39:                                    ; preds = %bb.c, %bb.e, %._crit_edge
  ret void
}
...
.preheader111.i:                                  ; preds = %.epilog-lcssa, %hwloc__check_grouping_matrix.exit
  ...
  br i1 %9, label %.epil.preheader, label %.preheader111.i.new
...
bb.p:                                             ; preds = %.epil.preheader
  %i.bv = trunc nuw i64 %indvars.iv.i143.epil.init to i32
  %i.bw = add i32 %i.bk, %i.bv
  %i.bx = zext i32 %i.bw to i64
  %i.by = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %i.bx
  %i.bz = load i64, ptr %i.by, align 8, !tbaa !82
  %spec.select.i.epil = tail call i64 @llvm.umin.i64(i64 %i.bz, i64 %.192112.i.epil.init)
  br label %.epilog-lcssa
...
.preheader159:                                    ; preds = %.lr.ph203
  ...
  br i1 %10, label %.epil.preheader386, label %.preheader159.new
...
.epil.preheader386:                               ; preds = %.loopexit.loopexit.unr-lcssa, %.preheader159
  ...
  %i.hd = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %indvars.iv256.epil.init
...
bb.am:                                            ; preds = %.epil.preheader386
  %i.hf = trunc nuw i64 %indvars.iv256.epil.init to i32
