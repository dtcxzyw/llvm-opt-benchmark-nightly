...
bb.c:                                             ; preds = %bb.a
  ...
  %4 = load <4 x float>, ptr %i.j, align 4, !tbaa !34
  %5 = fpext <4 x float> %4 to <4 x double>       ; 4 uses
  %i.k = getelementptr inbounds nuw i8, ptr %2, i64 36
  %6 = load <4 x float>, ptr %i.k, align 4, !tbaa !34
  %7 = fpext <4 x float> %6 to <4 x double>       ; 4 uses
  %i.l = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.m = load float, ptr %i.l, align 8, !tbaa !138
  %i.n = fpext float %i.m to double
  %i.o = getelementptr inbounds nuw i8, ptr %2, i64 12
  %8 = load <2 x float>, ptr %i.o, align 4, !tbaa !34
  %9 = fpext <2 x float> %8 to <2 x double>       ; 2 uses
  %10 = extractelement <4 x double> %5, i64 0
  %11 = extractelement <4 x double> %5, i64 1
  %12 = extractelement <4 x double> %5, i64 2
  %13 = extractelement <4 x double> %5, i64 3
  %14 = extractelement <4 x double> %7, i64 0
  %15 = extractelement <4 x double> %7, i64 1
  %16 = extractelement <4 x double> %7, i64 2
  %17 = extractelement <4 x double> %7, i64 3
  %18 = extractelement <2 x double> %9, i64 0
  %19 = extractelement <2 x double> %9, i64 1
  %i.p = tail call i32 (ptr, ptr, ...) @pmix_asprintf(ptr noundef %0, ptr noundef nonnull @.str.115, ptr noundef nonnull %i.c, i64 noundef %i.f, i64 noundef %i.h, ptr noundef %i.i, ptr noundef nonnull %i.c, double noundef %10, double noundef %11, double noundef %12, double noundef %13, ptr noundef nonnull %i.c, double noundef %14, double noundef %15, double noundef %16, double noundef %17, ptr noundef nonnull %i.c, double noundef %i.n, double noundef %18, double noundef %19) #8 ; 0 uses
  br label %bb.d
...
!138 = !{!135, !35, i64 8}
!139 = !{!140, !32, i64 32}
!140 = !{!"pmix_data_buffer", !9, i64 0, !9, i64 8, !9, i64 16, !32, i64 24, !32, i64 32}
end_hunk_0
