...
.lr.ph.i:                                         ; preds = %bb.d, %.lr.ph.i
  %i.g = phi ptr [ %i.i, %.lr.ph.i ], [ %i.f, %bb.d ]
  %.07.i = phi ptr [ %i.h, %.lr.ph.i ], [ %i.e, %bb.d ]
  tail call void %i.g(ptr noundef nonnull @era_mutex) #20, !inline_history !53
  %i.h = getelementptr inbounds nuw i8, ptr %.07.i, i64 8 ; 2 uses
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !52   ; 2 uses
  %.not.i = icmp eq ptr %i.i, null
  br i1 %.not.i, label %opal_obj_run_constructors.exit, label %.lr.ph.i, !llvm.loop !54

opal_obj_run_constructors.exit:                   ; preds = %.lr.ph.i, %bb.d
  %i.j = load i32, ptr @opal_class_init_epoch, align 4, !tbaa !45
  %i.k = load i32, ptr getelementptr inbounds nuw (i8, ptr @opal_mutex_t_class, i64 32), align 8, !tbaa !46
  %.not1 = icmp eq i32 %i.j, %i.k
