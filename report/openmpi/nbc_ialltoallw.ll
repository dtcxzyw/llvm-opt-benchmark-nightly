...
bb.d:                                             ; preds = %.thread, %bb.c
  ...
  br i1 %i.j, label %.lr.ph.preheader, label %._crit_edge.thread.a
...
._crit_edge:                                      ; preds = %opal_datatype_span.exit
  ...
  br i1 %i.k, label %._crit_edge.thread.a, label %nbc_get_noop_request.exit, !prof !69
...
bb.h:                                             ; preds = %nbc_get_noop_request.exit, %bb.c
  ...
  %i.aj = load i64, ptr getelementptr inbounds nuw (i8, ptr @NBC_Schedule_class, i64 56), align 8, !tbaa !53
  %i.ak = tail call noalias ptr @malloc(i64 noundef %i.aj) #7 ; 26 uses
  %i.al = load i32, ptr @opal_class_init_epoch, align 4, !tbaa !50
  %i.am = load i32, ptr getelementptr inbounds nuw (i8, ptr @NBC_Schedule_class, i64 32), align 8, !tbaa !54
...
bb.k:                                             ; preds = %bb.j
  store ptr @NBC_Schedule_class, ptr %i.ak, align 8, !tbaa !55
  %i.an = getelementptr inbounds nuw i8, ptr %i.ak, i64 8 ; 13 uses
  store volatile i32 1, ptr %i.an, align 8, !tbaa !56
  %i.ao = load ptr, ptr getelementptr inbounds nuw (i8, ptr @NBC_Schedule_class, i64 40), align 8, !tbaa !57 ; 2 uses
...
.lr.ph.i.i:                                       ; preds = %bb.k, %.lr.ph.i.i
  ...
  tail call void %i.aq(ptr noundef nonnull %i.ak) #6, !inline_history !0
  %i.ar = getelementptr inbounds nuw i8, ptr %.07.i.i, i64 8 ; 2 uses
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !58 ; 2 uses
...
opal_datatype_span.exit.i:                        ; preds = %bb.p, %bb.o
  ...
  %i.cq = tail call i32 @NBC_Sched_copy(ptr noundef %i.cd, i8 noundef signext 0, i64 noundef %i.ci, ptr noundef nonnull %i.ch, ptr noundef %i.cp, i8 noundef signext 1, i64 noundef %i.ci, ptr noundef nonnull %i.ch, ptr noundef nonnull %i.ak, i1 noundef zeroext true) #6 ; 2 uses
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.cw = tail call i32 @NBC_Sched_send(ptr noundef %i.by, i8 noundef signext 0, i64 noundef %i.ct, ptr noundef %i.cv, i32 noundef %i.br, ptr noundef nonnull %i.ak, i1 noundef zeroext false) #6 ; 2 uses
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.db = tail call i32 @NBC_Sched_recv(ptr noundef %i.cd, i8 noundef signext 0, i64 noundef %i.cy, ptr noundef %i.da, i32 noundef %i.bt, ptr noundef nonnull %i.ak, i1 noundef zeroext true) #6 ; 2 uses
...
bb.v:                                             ; preds = %bb.u
  ...
  %i.dg = tail call i32 @NBC_Sched_send(ptr noundef %i.dd, i8 noundef signext 1, i64 noundef %i.de, ptr noundef %i.df, i32 noundef %i.bt, ptr noundef nonnull %i.ak, i1 noundef zeroext false) #6 ; 2 uses
...
bb.w:                                             ; preds = %.thread.i
  ...
  %i.dl = tail call i32 @NBC_Sched_recv(ptr noundef %i.by, i8 noundef signext 0, i64 noundef %i.di, ptr noundef %i.dk, i32 noundef %i.br, ptr noundef nonnull %i.ak, i1 noundef zeroext true) #6 ; 2 uses
...
opal_datatype_span.exit154.i:                     ; preds = %bb.z, %bb.y
  ...
  %i.ek = tail call i32 @NBC_Sched_copy(ptr noundef %i.dw, i8 noundef signext 0, i64 noundef %i.eb, ptr noundef nonnull %i.dy, ptr noundef %i.ej, i8 noundef signext 1, i64 noundef %i.eb, ptr noundef nonnull %i.dy, ptr noundef nonnull %i.ak, i1 noundef zeroext true) #6 ; 2 uses
...
bb.aa:                                            ; preds = %opal_datatype_span.exit154.i
  ...
  %i.eo = tail call i32 @NBC_Sched_send(ptr noundef %i.ej, i8 noundef signext 1, i64 noundef %i.em, ptr noundef %i.en, i32 noundef %i.dr, ptr noundef nonnull %i.ak, i1 noundef zeroext false) #6 ; 2 uses
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %i.es = tail call i32 @NBC_Sched_recv(ptr noundef %i.dw, i8 noundef signext 0, i64 noundef %i.eq, ptr noundef %i.er, i32 noundef %i.dr, ptr noundef nonnull %i.ak, i1 noundef zeroext true) #6 ; 2 uses
...
opal_datatype_span.exit.i144:                     ; preds = %bb.ad
  ...
  br i1 %i.fr, label %bb.ae, label %opal_datatype_span.exit.thread.i, !prof !81
...
bb.ae:                                            ; preds = %opal_datatype_span.exit.i144
  ...
  %i.fx = tail call i32 @NBC_Sched_send(ptr noundef %i.fv, i8 noundef signext 0, i64 noundef %i.ez, ptr noundef nonnull %i.ew, i32 noundef %i.fw, ptr noundef nonnull %i.ak, i1 noundef zeroext false) #6 ; 2 uses
...
opal_datatype_span.exit57.i:                      ; preds = %opal_datatype_span.exit.thread.i
  ...
  br i1 %i.gu, label %bb.af, label %opal_datatype_span.exit57.thread.i, !prof !81
...
bb.af:                                            ; preds = %opal_datatype_span.exit57.i
  ...
  %i.ha = tail call i32 @NBC_Sched_recv(ptr noundef %i.gy, i8 noundef signext 0, i64 noundef %i.gc, ptr noundef nonnull %i.fz, i32 noundef %i.gz, ptr noundef nonnull %i.ak, i1 noundef zeroext false) #6 ; 2 uses
...
.loopexit:                                        ; preds = %opal_datatype_span.exit.i, %bb.r, %bb.t, %bb.v, %bb.w, %bb.af, %bb.ae, %bb.ab, %bb.aa, %opal_datatype_span.exit154.i
  ...
  %i.hb = load i8, ptr @opal_uses_threads, align 1, !tbaa !59, !range !60, !noundef !61
  %i.hc = trunc nuw i8 %i.hb to i1
  br i1 %i.hc, label %bb.ag, label %bb.ah, !prof !62
...
bb.ai:                                            ; preds = %opal_thread_add_fetch_32.exit
  %i.hj = load ptr, ptr %i.ak, align 8, !tbaa !55
...
.lr.ph.i148:                                      ; preds = %bb.ai, %.lr.ph.i148
  ...
  tail call void %i.hn(ptr noundef nonnull %i.ak) #6, !inline_history !2
  %i.ho = getelementptr inbounds nuw i8, ptr %.07.i, i64 8 ; 2 uses
  %i.hp = load ptr, ptr %i.ho, align 8, !tbaa !58 ; 2 uses
...
a2aw_sched_inplace.exit:                          ; preds = %opal_datatype_span.exit57.thread.i, %._crit_edge.i, %bb.ab, %bb.ac
  %i.hq = tail call i32 @NBC_Sched_commit(ptr noundef nonnull %i.ak) #6 ; 2 uses
  %.not130 = icmp eq i32 %i.hq, 0
  br i1 %.not130, label %bb.ap, label %bb.ak, !prof !12

bb.ak:                                            ; preds = %a2aw_sched_inplace.exit
  %i.hr = load i8, ptr @opal_uses_threads, align 1, !tbaa !59, !range !60, !noundef !61
  %i.hs = trunc nuw i8 %i.hr to i1
  br i1 %i.hs, label %bb.al, label %bb.am, !prof !62
...
bb.an:                                            ; preds = %opal_thread_add_fetch_32.exit152
  %i.hz = load ptr, ptr %i.ak, align 8, !tbaa !55
...
.lr.ph.i154:                                      ; preds = %bb.an, %.lr.ph.i154
  ...
  tail call void %i.id(ptr noundef nonnull %i.ak) #6, !inline_history !2
  %i.ie = getelementptr inbounds nuw i8, ptr %.07.i155, i64 8 ; 2 uses
  %i.if = load ptr, ptr %i.ie, align 8, !tbaa !58 ; 2 uses
...
bb.ap:                                            ; preds = %a2aw_sched_inplace.exit
  %i.ig = tail call i32 @NBC_Schedule_request(ptr noundef nonnull %i.ak, ptr noundef %8, ptr noundef %10, i1 noundef zeroext %11, ptr noundef %9, ptr noundef %.1) #6 ; 2 uses
  %.not131 = icmp eq i32 %i.ig, 0
  br i1 %.not131, label %nbc_get_noop_request.exit.thread, label %bb.aq, !prof !12

bb.aq:                                            ; preds = %bb.ap
  %i.ih = load i8, ptr @opal_uses_threads, align 1, !tbaa !59, !range !60, !noundef !61
  %i.ii = trunc nuw i8 %i.ih to i1
  br i1 %i.ii, label %bb.ar, label %bb.as, !prof !62
...
.lr.ph.i162:                                      ; preds = %bb.at, %.lr.ph.i162
  ...
  tail call void %i.it(ptr noundef nonnull %i.ak) #6, !inline_history !2
  %i.iu = getelementptr inbounds nuw i8, ptr %.07.i163, i64 8 ; 2 uses
  %i.iv = load ptr, ptr %i.iu, align 8, !tbaa !58 ; 2 uses
...
ompi_comm_remote_size.exit:                       ; preds = %bb.a, %bb.b
  ...
  %i.i = load i64, ptr getelementptr inbounds nuw (i8, ptr @NBC_Schedule_class, i64 56), align 8, !tbaa !53
  %i.j = tail call noalias ptr @malloc(i64 noundef %i.i) #7 ; 17 uses
  %i.k = load i32, ptr @opal_class_init_epoch, align 4, !tbaa !50
  %i.l = load i32, ptr getelementptr inbounds nuw (i8, ptr @NBC_Schedule_class, i64 32), align 8, !tbaa !54
...
bb.e:                                             ; preds = %bb.d
  store ptr @NBC_Schedule_class, ptr %i.j, align 8, !tbaa !55
  %i.m = getelementptr inbounds nuw i8, ptr %i.j, i64 8 ; 17 uses
  store volatile i32 1, ptr %i.m, align 8, !tbaa !56
  %i.n = load ptr, ptr getelementptr inbounds nuw (i8, ptr @NBC_Schedule_class, i64 40), align 8, !tbaa !57 ; 2 uses
...
.lr.ph.i.i:                                       ; preds = %bb.e, %.lr.ph.i.i
  ...
  tail call void %i.p(ptr noundef nonnull %i.j) #6, !inline_history !0
...
bb.f:                                             ; preds = %.lr.ph
  ...
  %i.ac = tail call i32 @NBC_Sched_send(ptr noundef %i.x, i8 noundef signext 0, i64 noundef %i.y, ptr noundef %i.aa, i32 noundef %i.ab, ptr noundef nonnull %i.j, i1 noundef zeroext false) #6 ; 4 uses
  %.not68 = icmp eq i32 %i.ac, 0
  br i1 %.not68, label %bb.k, label %bb.g, !prof !12

bb.g:                                             ; preds = %bb.f
  %i.ad = load i8, ptr @opal_uses_threads, align 1, !tbaa !59, !range !60, !noundef !61
  %i.ae = trunc nuw i8 %i.ad to i1
  br i1 %i.ae, label %bb.h, label %bb.i, !prof !62
...
bb.j:                                             ; preds = %opal_thread_add_fetch_32.exit
  %i.al = load ptr, ptr %i.j, align 8, !tbaa !55
...
.lr.ph.i:                                         ; preds = %bb.j, %.lr.ph.i
  ...
  tail call void %i.ap(ptr noundef nonnull %i.j) #6, !inline_history !2
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.bc = tail call i32 @NBC_Sched_recv(ptr noundef %i.ax, i8 noundef signext 0, i64 noundef %i.ay, ptr noundef %i.ba, i32 noundef %i.bb, ptr noundef nonnull %i.j, i1 noundef zeroext false) #6 ; 4 uses
  %.not70 = icmp eq i32 %i.bc, 0
  br i1 %.not70, label %bb.q, label %bb.m, !prof !12

bb.m:                                             ; preds = %bb.l
  %i.bd = load i8, ptr @opal_uses_threads, align 1, !tbaa !59, !range !60, !noundef !61
  %i.be = trunc nuw i8 %i.bd to i1
  br i1 %i.be, label %bb.n, label %bb.o, !prof !62
...
bb.p:                                             ; preds = %opal_thread_add_fetch_32.exit77
  %i.bl = load ptr, ptr %i.j, align 8, !tbaa !55
...
.lr.ph.i79:                                       ; preds = %bb.p, %.lr.ph.i79
  ...
  tail call void %i.bp(ptr noundef nonnull %i.j) #6, !inline_history !2
  %i.bq = getelementptr inbounds nuw i8, ptr %.07.i80, i64 8 ; 2 uses
  %i.br = load ptr, ptr %i.bq, align 8, !tbaa !58 ; 2 uses
...
bb.r:                                             ; preds = %._crit_edge
  %i.bt = load i8, ptr @opal_uses_threads, align 1, !tbaa !59, !range !60, !noundef !61
  %i.bu = trunc nuw i8 %i.bt to i1
  br i1 %i.bu, label %bb.s, label %bb.t, !prof !62
...
.lr.ph.i86:                                       ; preds = %bb.u, %.lr.ph.i86
  ...
  tail call void %i.cf(ptr noundef nonnull %i.j) #6, !inline_history !2
  %i.cg = getelementptr inbounds nuw i8, ptr %.07.i87, i64 8 ; 2 uses
  %i.ch = load ptr, ptr %i.cg, align 8, !tbaa !58 ; 2 uses
...
bb.w:                                             ; preds = %bb.v
  %i.cj = load i8, ptr @opal_uses_threads, align 1, !tbaa !59, !range !60, !noundef !61
  %i.ck = trunc nuw i8 %i.cj to i1
  br i1 %i.ck, label %bb.x, label %bb.y, !prof !62
...
bb.z:                                             ; preds = %opal_thread_add_fetch_32.exit91
  %i.cr = load ptr, ptr %i.j, align 8, !tbaa !55
...
.lr.ph.i93:                                       ; preds = %bb.z, %.lr.ph.i93
  ...
  tail call void %i.cv(ptr noundef nonnull %i.j) #6, !inline_history !2
...
define internal fastcc void @ompi_coll_base_nbc_reserve_tags(ptr nofree noundef captures(address) %0) unnamed_addr #2 {
  ...
  %3 = load i8, ptr @opal_uses_threads, align 1, !tbaa !59, !range !60, !noundef !61
  %4 = trunc nuw i8 %3 to i1
  br i1 %4, label %.split, label %opal_thread_compare_exchange_strong_32.exit.us, !prof !62
...
opal_thread_compare_exchange_strong_32.exit.us:   ; preds = %1, %opal_thread_compare_exchange_strong_32.exit.us
  ...
  %6 = load volatile i32, ptr %2, align 8, !tbaa !50
  %7 = icmp eq i32 %6, %5
...
.split:                                           ; preds = %1, %.split.backedge
  ...
  br i1 %15, label %16, label %19, !prof !62
...
.opal_thread_compare_exchange_strong_32.exit_crit_edge: ; preds = %16
  %.pre.pre = load i8, ptr @opal_uses_threads, align 1, !tbaa !59, !range !60
...
!52 = !{!"opal_class_t", !27, i64 0, !18, i64 8, !13, i64 16, !13, i64 24, !9, i64 32, !9, i64 36, !35, i64 40, !35, i64 48, !21, i64 56}
!53 = !{!52, !21, i64 56}
!54 = !{!52, !9, i64 32}
!55 = !{!19, !18, i64 0}
!56 = !{!19, !9, i64 8}
