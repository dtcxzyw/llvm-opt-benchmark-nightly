...
bb.r:                                             ; preds = %bb.q
  %i.bh = load ptr, ptr %i.aw, align 8, !tbaa !19
  %i.bi = lshr exact i32 %i.ba, 1
  %i.bj = zext nneg i32 %i.bi to i64
  %i.bk = getelementptr inbounds nuw [8 x i8], ptr %i.bh, i64 %i.bj
  store i64 %i.bf, ptr %i.bk, align 8, !tbaa !21
  br label %bb.s

bb.s:                                             ; preds = %bb.r, %bb.q
  %.134 = phi i64 [ %i.bf, %bb.q ], [ 0, %bb.r ]
  %i.bl = load ptr, ptr %i.a, align 8, !tbaa !26  ; 2 uses
...
bb.w:                                             ; preds = %bb.v
  store ptr %i.bt, ptr %i.aw, align 8, !tbaa !19
  store i32 1, ptr %i.an, align 4, !tbaa !18
...
hwloc_bitmap_reset_by_ulongs.exit.i49:            ; preds = %bb.v
  %.pr.i50 = load i32, ptr %0, align 8, !tbaa !17 ; 2 uses
...
.lr.ph.i.i47:                                     ; preds = %hwloc_bitmap_reset_by_ulongs.exit.i49, %hwloc_bitmap_reset_by_ulongs.exit.thread.i46
  ...
  %i.bv = load ptr, ptr %i.aw, align 8, !tbaa !19
  %i.bw = zext i32 %i.bu to i64
  %i.bx = shl nuw nsw i64 %i.bw, 3
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.bv, i8 0, i64 %i.bx, i1 false), !tbaa !21
  br label %hwloc_bitmap_zero.exit

hwloc_bitmap_zero.exit:                           ; preds = %hwloc_bitmap_reset_by_ulongs.exit.i49, %.lr.ph.i.i47
  store i32 0, ptr %i.av, align 8, !tbaa !22
  br label %hwloc_bitmap_reset_by_ulongs.exit.thread
...
hwloc_bitmap_reset_by_ulongs.exit:                ; preds = %bb.b
  %.pr = load i32, ptr %0, align 8, !tbaa !17     ; 2 uses
...
.lr.ph.i:                                         ; preds = %hwloc_bitmap_reset_by_ulongs.exit.thread, %hwloc_bitmap_reset_by_ulongs.exit
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.i, i8 -1, i64 %i.k, i1 false), !tbaa !21
...
.lr.ph.i:                                         ; preds = %hwloc_bitmap_reset_by_ulongs.exit.thread, %hwloc_bitmap_reset_by_ulongs.exit
  ...
  %i.j = zext i32 %i.g to i64
  %i.k = shl nuw nsw i64 %i.j, 3
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.i, i8 0, i64 %i.k, i1 false), !tbaa !21
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.b = load i32, ptr %2, align 8, !tbaa !17     ; 4 uses
...
.preheader.i:                                     ; preds = %bb.d
  %i.f = load ptr, ptr %i.c, align 8, !tbaa !19   ; 2 uses
...
bb.e:                                             ; preds = %.preheader.split.us.i
  ...
  br i1 %exitcond.not.i, label %.split.us.i, label %.preheader.split.us.i, !llvm.loop !0

bb.f:                                             ; preds = %bb.d
  %i.s = load i32, ptr %i.a, align 8, !tbaa !22
...
bb.g:                                             ; preds = %.preheader.split.i
  ...
  br i1 %exitcond42.not.i, label %.split.us.i, label %.preheader.split.i, !llvm.loop !0

.split.us.i:                                      ; preds = %bb.e, %bb.g
  %i.x = load i32, ptr %i.a, align 8, !tbaa !22
...
.preheader.i65:                                   ; preds = %hwloc_bitmap_next.exit.thread81
  %i.af = load ptr, ptr %i.c, align 8, !tbaa !19  ; 2 uses
...
bb.h:                                             ; preds = %.preheader.split.us.i66
  ...
  br i1 %exitcond.not.i72, label %.split.us.i73, label %.preheader.split.us.i66, !llvm.loop !1

bb.i:                                             ; preds = %hwloc_bitmap_next.exit.thread81
  %i.as = load i32, ptr %i.a, align 8, !tbaa !22
...
bb.j:                                             ; preds = %.preheader.split.i76
  ...
  br i1 %exitcond43.not.i, label %.split.us.i73, label %.preheader.split.i76, !llvm.loop !1

.split.us.i73:                                    ; preds = %bb.h, %bb.j
  %i.ay = load i32, ptr %i.a, align 8, !tbaa !22
...
bb.a:
  ...
  %i.c = load i32, ptr %0, align 8, !tbaa !17     ; 4 uses
...
bb.b:                                             ; preds = %.preheader.split.us
  ...
  br i1 %exitcond.not, label %.split.us, label %.preheader.split.us, !llvm.loop !0
...
bb.d:                                             ; preds = %.preheader.split
  ...
  br i1 %exitcond42.not, label %.split.us, label %.preheader.split, !llvm.loop !0
...
bb.b:                                             ; preds = %.preheader.split.us
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.split.us, label %.preheader.split.us, !llvm.loop !1
...
bb.d:                                             ; preds = %.preheader.split
  ...
  br i1 %exitcond43.not, label %.split.us, label %.preheader.split, !llvm.loop !1
...
hwloc_bitmap_reset_by_ulongs.exit.i:              ; preds = %bb.b
  %.pr.i = load i32, ptr %0, align 8, !tbaa !17   ; 2 uses
...
.lr.ph.i.i:                                       ; preds = %hwloc_bitmap_reset_by_ulongs.exit.i, %hwloc_bitmap_reset_by_ulongs.exit.thread.i
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.j, i8 0, i64 %i.l, i1 false), !tbaa !21
  br label %hwloc_bitmap_zero.exit
