...
bb.a:
  ...
  %.val = load ptr, ptr %i.a, align 8, !tbaa !36
  %i.b = getelementptr i8, ptr %.val, i64 16
  %.val.val = load i32, ptr %i.b, align 8, !tbaa !39 ; 10 uses
  %i.c = getelementptr i8, ptr %6, i64 220
...
ompi_coll_base_sendrecv.exit.us:                  ; preds = %.lr.ph, %bb.d
  ...
  %i.x = sub nsw i32 %.val58, %.060.us            ; 2 uses
  %8 = add i32 %i.q, %i.x
  %9 = srem i32 %8, %.val.val
  %10 = add nsw i32 %i.x, %.val.val
  %11 = srem i32 %10, %.val.val
...
ompi_coll_base_sendrecv.exit:                     ; preds = %.lr.ph, %bb.e
  ...
  %i.ah = sub nsw i32 %.val58, %.060              ; 2 uses
  %12 = add i32 %i.q, %i.ah
  %13 = srem i32 %12, %.val.val
  %14 = add nsw i32 %i.ah, %.val.val
  %15 = srem i32 %14, %.val.val
  %i.ai = sext i32 %13 to i64
  %i.aj = mul i64 %i.u, %i.ai
  %i.ak = getelementptr inbounds i8, ptr %3, i64 %i.aj
  %i.al = sext i32 %15 to i64
