...
bb.j:                                             ; preds = %.critedge
  ...
  %i.ak = zext nneg i32 %.029.lcssa to i64
...
.lr.ph40:                                         ; preds = %bb.j, %.lr.ph40
  ...
  %.02839 = phi i64 [ %i.at, %.lr.ph40 ], [ %i.ap, %bb.j ] ; 2 uses
  %i.as = add nuw nsw i32 %i.ar, 1                ; 2 uses
  %i.at = lshr exact i64 %.02839, 1
  %i.au = and i64 %.02839, 2
