...
bb.b:                                             ; preds = %.lr.ph
  ...
  %i.y = getelementptr inbounds nuw i8, ptr %2, i64 %.04355 ; 4 uses
...
.loopexit96:                                      ; preds = %bb.c
  ...
  %i.bn = add i64 %.043.lcssa, 4                  ; 2 uses
...
.outer.outer:                                     ; preds = %.outer.outer.backedge, %bb.a
  ...
  %.058.ph.ph = phi i32 [ 0, %bb.a ], [ %.058.ph.ph.be, %.outer.outer.backedge ] ; 9 uses
  %.not83.ph = phi i1 [ true, %bb.a ], [ %.not83.ph.be, %.outer.outer.backedge ]
  %.056.ph.ph = phi i32 [ 0, %bb.a ], [ %.056.ph.ph.be, %.outer.outer.backedge ]
  %i.a = zext i32 %.058.ph.ph to i64              ; 2 uses
...
.outer:                                           ; preds = %.outer.backedge, %.outer.outer
  ...
  %.056.ph = phi i32 [ %.056.ph.ph, %.outer.outer ], [ 1, %.outer.backedge ] ; 2 uses
  br label %bb.b
...
bb.j:                                             ; preds = %bb.f
  %.pre = add i32 %.058.ph.ph, 1                  ; 3 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.af = zext i32 %.058.ph.ph to i64
...
bb.q:                                             ; preds = %bb.p
  %i.am = zext i32 %.058.ph.ph to i64             ; 2 uses
...
.lr.ph:                                           ; preds = %.preheader, %bb.u
  %.055120 = phi i32 [ %i.bd, %bb.u ], [ %i.aw, %.preheader ] ; 2 uses
end_hunk_0
