...
bb.a:
  tail call void @x86_64_check_and_enable_capability() #5
  %i.a = icmp ult ptr @_sbss, @_ebss
  br i1 %i.a, label %.lr.ph.preheader, label %._crit_edge

.lr.ph.preheader:                                 ; preds = %bb.a
  %i.b = and i64 sub (i64 add (i64 ptrtoaddr (ptr @_ebss to i64), i64 -1), i64 ptrtoaddr (ptr @_sbss to i64)), -8
  %i.c = add i64 %i.b, 8
...
._crit_edge:                                      ; preds = %.lr.ph.preheader, %bb.a
  ...
  tail call void asm sideeffect "wrfsbase $0", "r,~{memory},~{dirflag},~{fpsr},~{flags}"(i64 %i.e) #6, !srcloc !8
  tail call void @intel64_lowsetup() #5
...
x86_64_mb2_config.exit:                           ; preds = %bb.c, %._crit_edge
  ...
  %i.u = tail call i32 @acpi_init(i64 noundef %i.t) #5 ; 0 uses
  tail call void @__revoke_low_memory() #5
  tail call void @x86_64_cpu_init() #5
  tail call void @x86_64_boardinitialize() #5
  tail call void @x86_64_earlyserialinit() #5
  tail call void @x86_64_timer_calibrate_freq() #5
  tail call void @x86_64_cpu_priv_set(i8 noundef zeroext 0) #5
  tail call void @nx_start() #5
  br label %bb.e
