...
bb.b:                                             ; preds = %bb.a
  ...
  %1 = tail call range(i64 0, -1) i64 @llvm.umulh.i64(i64 %i.e, i64 %i.i) ; 2 uses
  %i.l = sub i64 %i.e, %1
  %i.m = lshr i64 %i.l, 1
  %i.n = add i64 %i.m, %1
...
bb.d:                                             ; preds = %oneshot_current.exit.i
  ...
  %2 = tail call range(i64 0, -1) i64 @llvm.umulh.i64(i64 %i.au, i64 %i.ay) ; 2 uses
  %i.bb = sub i64 %i.au, %2
...
bb.b:                                             ; preds = %bb.a
  ...
  %1 = tail call range(i64 0, -1) i64 @llvm.umulh.i64(i64 %i.d, i64 %i.h) ; 2 uses
  %i.k = sub i64 %i.d, %1
  %i.l = lshr i64 %i.k, 1
  %i.m = add i64 %i.l, %1
...
bb.b:                                             ; preds = %bb.a
  ...
  %1 = tail call range(i64 0, -1) i64 @llvm.umulh.i64(i64 %i.g, i64 %i.k) ; 2 uses
  %i.n = sub i64 %i.g, %1
  %i.o = lshr i64 %i.n, 1
  %i.p = add i64 %i.o, %1
...
oneshot_delta_cnt2tick.exit:                      ; preds = %bb.b
  ...
  %2 = tail call range(i64 0, -1) i64 @llvm.umulh.i64(i64 %i.al, i64 %i.ap) ; 2 uses
  %i.as = sub i64 %i.al, %2
...
; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i64 @llvm.umulh.i64(i64, i64) #6
