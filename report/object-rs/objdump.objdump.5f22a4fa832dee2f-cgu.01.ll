...
bb.an:                                            ; preds = %bb.x, %bb.y
  ...
  %.sroa.05.0.copyload.i = load i16, ptr %i.gw, align 1, !noalias !173
  %2 = shl nuw nsw i8 %i.gv, 3
  %3 = zext nneg i8 %2 to i16
  %4 = shl nuw i16 192, %3
  %i.gx = and i16 %4, %.sroa.05.0.copyload.i
...
bb.ao:                                            ; preds = %bb.z, %bb.aa
  ...
  %.sroa.02.0.copyload.i12 = load i16, ptr %i.ht, align 1, !noalias !173
  %5 = shl nuw nsw i8 %i.hs, 3
  %6 = zext nneg i8 %5 to i16
  %7 = shl nuw i16 192, %6
  %i.hu = and i16 %7, %.sroa.02.0.copyload.i12
