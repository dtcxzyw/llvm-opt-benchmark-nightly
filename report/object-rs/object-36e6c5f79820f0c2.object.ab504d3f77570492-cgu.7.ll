...
begin_hunk_0_@_RNvXs8_NtCsexYYUdYSQU6_5alloc5sliceINtNtB7_3vec3VecNtNtNtCseHTIzroA4w0_6object4read10symbol_map14ObjectMapEntryEINtNtNtNtCskKLDkoKarTP_4core5slice4sort6stable8BufGuardBN_E19as_uninit_slice_mutBT_:bb.a
  %i.f = load i64, ptr %0, align 8, !range !70, !noundef !4
  %i.g = sub i64 %i.f, %i.d
...
bb.a:
  ...
  %i.b = load i8, ptr %i.a, align 8, !range !83, !alias.scope !134, !noalias !137, !noundef !4
  %i.c = trunc nuw i8 %i.b to i1
  br i1 %i.c, label %bb.g, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.d = load ptr, ptr %1, align 8, !alias.scope !134, !noalias !137, !nonnull !4, !noundef !4 ; 7 uses
  %i.e = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 3 uses
  %i.f = load i64, ptr %i.e, align 8, !alias.scope !134, !noalias !137, !noundef !4 ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  store ptr %i.i, ptr %1, align 8, !alias.scope !134, !noalias !137, !captures !64
  store i64 %i.h, ptr %i.e, align 8, !alias.scope !134, !noalias !137
  %i.j = load <4 x i32>, ptr %i.d, align 1, !alias.scope !139, !noalias !142
  %.fr = freeze <4 x i32> %i.j
  %i.k = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  %.sroa.05.0.copyload.i.i = load i32, ptr %i.k, align 1, !alias.scope !139, !noalias !142
  %.sroa.05.0.copyload.i.i.fr = freeze i32 %.sroa.05.0.copyload.i.i
  %i.l = getelementptr inbounds nuw i8, ptr %i.d, i64 20
  %.sroa.06.0.copyload.i.i = load i32, ptr %i.l, align 1, !alias.scope !139, !noalias !142
  %.sroa.06.0.copyload.i.i.fr = freeze i32 %.sroa.06.0.copyload.i.i
  %i.m = getelementptr inbounds nuw i8, ptr %i.d, i64 24
  %.sroa.07.0.copyload.i.i = load i32, ptr %i.m, align 1, !alias.scope !139, !noalias !142
...
_RNvMs8_NtCseHTIzroA4w0_6object2peNtB5_24ImageDelayloadDescriptor7is_null.exit.i: ; preds = %bb.c
  ...
  %.sroa.08.0.copyload.i.i = load i32, ptr %i.u, align 1, !alias.scope !139, !noalias !142
...
bb.d:                                             ; preds = %_RNvMs8_NtCseHTIzroA4w0_6object2peNtB5_24ImageDelayloadDescriptor7is_null.exit.i
  store i8 1, ptr %i.a, align 8, !alias.scope !134, !noalias !137
  br label %bb.g

bb.e:                                             ; preds = %bb.b
  store ptr inttoptr (i64 1 to ptr), ptr %1, align 8, !alias.scope !134, !noalias !137
  store i64 0, ptr %i.e, align 8, !alias.scope !134, !noalias !137
  store i8 1, ptr %i.a, align 8, !alias.scope !134, !noalias !137
...
bb.b:                                             ; preds = %bb.c, %.lr.ph.i
  ...
  %.sroa.6.0.copyload.i = load ptr, ptr %.sroa.6.0..sroa_idx.i, align 8, !noalias !146 ; 3 uses
  %.sroa.7.0.copyload.i = load i64, ptr %.sroa.7.0..sroa_idx.i, align 8, !noalias !146 ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  call void @_RNvXs2_NtNtNtCseHTIzroA4w0_6object4read5macho12exports_trieNtB5_12NodeIteratorNtNtNtNtCskKLDkoKarTP_4core4iter6traits8iterator8Iterator4next(ptr noalias nofree noundef nonnull sret([56 x i8]) align 8 captures(none) dereferenceable(56) %i.a, ptr noalias nofree noundef nonnull align 8 dereferenceable(72) %1), !noalias !143
  %i.d = load i64, ptr %i.a, align 8, !range !21, !noalias !146, !noundef !4 ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = load i64, ptr %i.d, align 8, !alias.scope !151, !noalias !148, !noundef !4 ; 2 uses
  %i.f = icmp eq i64 %i.e, 0
  br i1 %i.f, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  store ptr inttoptr (i64 1 to ptr), ptr %1, align 8, !alias.scope !151, !noalias !148
  br label %bb.r

bb.d:                                             ; preds = %bb.b
  %i.g = load ptr, ptr %1, align 8, !alias.scope !151, !noalias !148, !nonnull !4, !noundef !4 ; 2 uses
  %i.h = add nsw i64 %i.e, -1
  %i.i = getelementptr inbounds nuw i8, ptr %i.g, i64 1
  store ptr %i.i, ptr %1, align 8, !alias.scope !151, !noalias !148, !captures !64
  store i64 %i.h, ptr %i.d, align 8, !alias.scope !151, !noalias !148
  %i.j = load i8, ptr %i.g, align 1, !noalias !153, !noundef !4 ; 3 uses
  %i.k = getelementptr inbounds nuw i8, ptr %1, i64 48 ; 2 uses
  %i.l = load i8, ptr %i.k, align 8, !alias.scope !151, !noalias !148, !noundef !4 ; 2 uses
  %i.m = and i8 %i.l, 7
...
bb.e:                                             ; preds = %bb.d
  %i.v = tail call { i64, i64 } @_RNvMs_NtNtCseHTIzroA4w0_6object4read4utilNtB4_5Bytes12read_uleb128(ptr noalias nofree noundef nonnull align 8 dereferenceable(56) %1), !noalias !148 ; 2 uses
...
bb.f:                                             ; preds = %bb.g, %bb.d
  ...
  %i.z = load i64, ptr %i.y, align 8, !alias.scope !151, !noalias !148, !noundef !4
  %i.aa = getelementptr inbounds nuw i8, ptr %1, i64 49
  %i.ab = load i8, ptr %i.aa, align 1, !alias.scope !151, !noalias !148, !noundef !4
  %i.ac = and i8 %i.ab, 63
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.ah = load i8, ptr %i.k, align 8, !alias.scope !151, !noalias !148, !noundef !4
  %i.ai = sub i8 7, %i.ah
  %i.aj = and i8 %i.ai, 63
...
bb.h:                                             ; preds = %bb.f
  %i.an = tail call { i64, i64 } @_RNvMs_NtNtCseHTIzroA4w0_6object4read4utilNtB4_5Bytes12read_sleb128(ptr noalias nofree noundef nonnull align 8 dereferenceable(56) %1), !noalias !148 ; 2 uses
...
bb.j:                                             ; preds = %bb.h
  ...
  %i.au = load i32, ptr %i.at, align 8, !alias.scope !151, !noalias !148, !noundef !4
  %i.av = trunc i64 %i.as to i32
  %i.aw = add i32 %i.au, %i.av
  store i32 %i.aw, ptr %i.at, align 8, !alias.scope !151, !noalias !148
  br label %bb.i

bb.k:                                             ; preds = %bb.i
  %i.ax = tail call { i64, i64 } @_RNvMs_NtNtCseHTIzroA4w0_6object4read4utilNtB4_5Bytes12read_sleb128(ptr noalias nofree noundef nonnull align 8 dereferenceable(56) %1), !noalias !148 ; 2 uses
...
bb.l:                                             ; preds = %bb.m, %bb.i
  ...
  %i.bb = load i8, ptr %i.ba, align 2, !range !83, !alias.scope !151, !noalias !148, !noundef !4
...
bb.m:                                             ; preds = %bb.k
  ...
  %i.bh = load i32, ptr %i.bg, align 4, !alias.scope !151, !noalias !148, !noundef !4
  %i.bi = trunc i64 %i.bf to i32
  %i.bj = add i32 %i.bh, %i.bi
  store i32 %i.bj, ptr %i.bg, align 4, !alias.scope !151, !noalias !148
  br label %bb.l

bb.n:                                             ; preds = %bb.l
  %i.bk = tail call { i64, i64 } @_RNvMs_NtNtCseHTIzroA4w0_6object4read4utilNtB4_5Bytes12read_sleb128(ptr noalias nofree noundef nonnull align 8 dereferenceable(56) %1), !noalias !148 ; 2 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.bp = load i64, ptr %i.bo, align 8, !alias.scope !151, !noalias !148, !noundef !4
  %i.bq = add i64 %i.bp, %i.bn                    ; 2 uses
  store i64 %i.bq, ptr %i.bo, align 8, !alias.scope !151, !noalias !148
  br label %_RNvMsk_NtNtNtCseHTIzroA4w0_6object4read3elf10relocationNtB5_12CrelIterator5parse.exit
...
_RNvMsk_NtNtNtCseHTIzroA4w0_6object4read3elf10relocationNtB5_12CrelIterator5parse.exit: ; preds = %._RNvMsk_NtNtNtCseHTIzroA4w0_6object4read3elf10relocationNtB5_12CrelIterator5parse.exit_crit_edge, %bb.o
  ...
  %i.br = load i64, ptr %i.a, align 8, !alias.scope !151, !noalias !148, !noundef !4
  %i.bs = add i64 %i.br, -1
  store i64 %i.bs, ptr %i.a, align 8, !alias.scope !151, !noalias !148
...
!4 = !{}
!5 = !{!6}
!6 = distinct !{!6, !7, !"_RINvMNtCskKLDkoKarTP_4core6optionINtB3_6OptionRNtNtCseHTIzroA4w0_6object2pe18ImageDataDirectoryE6filterNCNvMNtNtNtBN_4read2pe14data_directoryNtB1I_15DataDirectories3get0EBN_: argument 0"}
!7 = distinct !{!7, !"_RINvMNtCskKLDkoKarTP_4core6optionINtB3_6OptionRNtNtCseHTIzroA4w0_6object2pe18ImageDataDirectoryE6filterNCNvMNtNtNtBN_4read2pe14data_directoryNtB1I_15DataDirectories3get0EBN_"}
!8 = !{!9, !11}
!9 = distinct !{!9, !10, !"_RNCNvNtCs906JEEYSgkH_6memchr6memchr6memchr0CseHTIzroA4w0_6object: argument 0"}
!10 = distinct !{!10, !"_RNCNvNtCs906JEEYSgkH_6memchr6memchr6memchr0CseHTIzroA4w0_6object"}
!11 = distinct !{!11, !12, !"_RNvMs_NtNtCseHTIzroA4w0_6object4read4utilNtB4_5Bytes11read_string: argument 0"}
!12 = distinct !{!12, !"_RNvMs_NtNtCseHTIzroA4w0_6object4read4utilNtB4_5Bytes11read_string"}
!13 = distinct !{null, null}
!14 = !{!11}
!15 = !{!16, !18}
!16 = distinct !{!16, !17, !"_RNCNvNtCs906JEEYSgkH_6memchr6memchr6memchr0CseHTIzroA4w0_6object: argument 0"}
!17 = distinct !{!17, !"_RNCNvNtCs906JEEYSgkH_6memchr6memchr6memchr0CseHTIzroA4w0_6object"}
!18 = distinct !{!18, !19, !"_RNvMs_NtNtCseHTIzroA4w0_6object4read4utilNtB4_5Bytes11read_string: argument 0"}
!19 = distinct !{!19, !"_RNvMs_NtNtCseHTIzroA4w0_6object4read4utilNtB4_5Bytes11read_string"}
!20 = !{!18}
!21 = !{i64 -3, i64 3}
!22 = !{!23}
!23 = distinct !{!23, !24, !"_RNvMs_NtNtCseHTIzroA4w0_6object4read4utilNtB4_5Bytes10read_bytes: argument 0"}
!24 = distinct !{!24, !"_RNvMs_NtNtCseHTIzroA4w0_6object4read4utilNtB4_5Bytes10read_bytes"}
!25 = !{!26}
!26 = distinct !{!26, !27, !"_RNvMs3_NtNtNtCseHTIzroA4w0_6object4read5macho12exports_trieNtB5_10ExportData5parse: argument 0"}
!27 = distinct !{!27, !"_RNvMs3_NtNtNtCseHTIzroA4w0_6object4read5macho12exports_trieNtB5_10ExportData5parse"}
!28 = !{!26, !29}
!29 = distinct !{!29, !27, !"_RNvMs3_NtNtNtCseHTIzroA4w0_6object4read5macho12exports_trieNtB5_10ExportData5parse: argument 1"}
!30 = !{!29}
!31 = !{!32}
!32 = distinct !{!32, !33, !"_RNvMs_NtNtCseHTIzroA4w0_6object4read4utilNtB4_5Bytes11read_string: argument 0"}
!33 = distinct !{!33, !"_RNvMs_NtNtCseHTIzroA4w0_6object4read4utilNtB4_5Bytes11read_string"}
!34 = !{!35, !32, !26, !29}
!35 = distinct !{!35, !36, !"_RNCNvNtCs906JEEYSgkH_6memchr6memchr6memchr0CseHTIzroA4w0_6object: argument 0"}
!36 = distinct !{!36, !"_RNCNvNtCs906JEEYSgkH_6memchr6memchr6memchr0CseHTIzroA4w0_6object"}
!37 = !{!35, !32, !26}
