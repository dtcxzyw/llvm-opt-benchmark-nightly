...
vector.body919:                                   ; preds = %vector.body919, %vector.ph885
  ...
  %9 = shufflevector <8 x float> %i.yf, <8 x float> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7> ; 2 uses
  %10 = shufflevector <8 x float> %i.yg, <8 x float> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7> ; 2 uses
  %i.yh = tail call <16 x float> @llvm.fmuladd.v16f32(<16 x float> %10, <16 x float> %i.xw, <16 x float> zeroinitializer)
  %i.yi = tail call <16 x float> @llvm.fmuladd.v16f32(<16 x float> %9, <16 x float> %i.xv, <16 x float> %i.yh)
  %i.yj = tail call <16 x float> @llvm.fmuladd.v16f32(<16 x float> %10, <16 x float> %i.xy, <16 x float> zeroinitializer)
  %i.yk = tail call <16 x float> @llvm.fmuladd.v16f32(<16 x float> %9, <16 x float> %i.xx, <16 x float> %i.yj)
