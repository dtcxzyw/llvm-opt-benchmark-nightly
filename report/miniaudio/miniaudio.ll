...
.critedge334:                                     ; preds = %.split324.i, %.split324.us.us.i, %._crit_edge335.split.i, %._crit_edge335.split.us.us.i, %.split345.i, %.split345.us.us.i, %._crit_edge.split.us85.i, %._crit_edge.split.us.us.us.i, %ma_zero_memory_default.exit.i.i.i, %.lr.ph.i, %ma_zero_memory_default.exit.i.i, %bb.bj, %.loopexit.i, %.preheader303.i, %.preheader308.i, %._crit_edge.thread.i, %._crit_edge.i, %bb.f, %bb.e, %.preheader64.i, %bb.d, %bb.c, %bb.b, %ma_channel_map_apply_shuffle_table.exit, %.loopexit, %.critedge
  ret void
}
