...
.lr.ph220:                                        ; preds = %bb.b
  ...
  %broadcast.splatinsert577 = insertelement <2 x i32> poison, i32 %4, i64 0
...
.lr.ph157:                                        ; preds = %bb.v, %.lr.ph157
  ...
  %i.pi = tail call <4 x i32> @llvm.x86.sse2.pslli.d(<4 x i32> %i.ph, i32 range(i32 -232, 288) %4) ; 2 uses
  %i.pj = sub <4 x i32> %i.pg, %i.pd
  %i.pk = tail call <4 x i32> @llvm.x86.sse2.pslli.d(<4 x i32> %i.pj, i32 range(i32 -232, 288) %4) ; 2 uses
