...
_ZN17double_conversionL12FillDigits32EjNS_6VectorIcEEPi.exit: ; preds = %._crit_edge.i, %._crit_edge35.loopexit.i
  ...
  store i8 %14, ptr %18, align 1, !tbaa !11
  %19 = insertelement <4 x i32> poison, i32 %i.by, i64 0
  %20 = insertelement <4 x i32> %19, i32 %i.bx, i64 1
  ...
  %i.cn = urem <4 x i16> %i.cm, splat (i16 10)
  %25 = trunc nuw nsw <4 x i16> %i.cn to <4 x i8> ; 4 uses
  %i.co = extractelement <4 x i8> %25, i64 0
  ...
  %i.cu = extractelement <4 x i8> %25, i64 2
  ...
  %i.dp = extractelement <4 x i8> %24, i64 1
  ...
  %27 = extractelement <4 x i8> %24, i64 3
  %i.dz = or disjoint i8 %27, 48
  ...
  %i.ee = extractelement <4 x i8> %25, i64 1
  ...
  %i.ek = extractelement <4 x i8> %25, i64 3
