...
_ZN17double_conversionL12FillDigits32EjNS_6VectorIcEEPi.exit: ; preds = %._crit_edge.i, %._crit_edge35.loopexit.i
  ...
  %7 = trunc nuw nsw i64 %i.bw to i32             ; 7 uses
  %8 = trunc nuw nsw i64 %6 to i32                ; 7 uses
  %9 = udiv i32 %8, 100
  %10 = udiv i32 %8, 10
  %i.bx = insertelement <4 x i32> poison, i32 %8, i64 0
  ...
  %i.ct = udiv i32 %7, 10000
  %11 = udiv i32 %7, 1000
  %i.cu = udiv i32 %8, 10000
  %12 = udiv i32 %8, 1000
  %.lhs.trunc38.i = trunc nuw nsw i32 %i.ct to i16
  ...
  %i.cv = insertelement <4 x i16> poison, i16 %.lhs.trunc30.i.a, i64 0
  %i.cw = insertelement <4 x i16> %i.cv, i16 %.lhs.trunc36.i, i64 1
  %i.cx = insertelement <4 x i16> %i.cw, i16 %.lhs.trunc32.i, i64 2
  %i.cy = insertelement <4 x i16> %i.cx, i16 %.lhs.trunc38.i, i64 3
