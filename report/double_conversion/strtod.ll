...
@_ZN17double_conversionL19exact_powers_of_tenE = internal unnamed_addr constant [23 x double] [double 1.000000e+00, double 1.000000e+01, double 1.000000e+02, double 1.000000e+03, double 1.000000e+04, double 1.000000e+05, double 1.000000e+06, double 1.000000e+07, double 1.000000e+08, double 1.000000e+09, double 1.000000e+10, double 1.000000e+11, double 1.000000e+12, double 1.000000e+13, double 1.000000e+14, double 1.000000e+15, double 1.000000e+16, double 1.000000e+17, double 1.000000e+18, double 1.000000e+19, double 1.000000e+20, double 1.000000e+21, double 1.000000e+22], align 16
@switch.table._ZN17double_conversionL12ComputeGuessENS_6VectorIKcEEiPd = private unnamed_addr constant [7 x i8] c"\04\07\0A\0E\11\14\18", align 4
@switch.table._ZN17double_conversionL12ComputeGuessENS_6VectorIKcEEiPd.1 = private unnamed_addr constant [7 x i32] [i32 -1610612736, i32 -939524096, i32 -100663296, i32 -1673527296, i32 -1018167296, i32 -198967296, i32 -1734967296], align 8

; Function Attrs: mustprogress uwtable
define noundef double @_ZN17double_conversion13StrtodTrimmedENS_6VectorIKcEEi(ptr %0, i32 %1, i32 noundef %2) local_unnamed_addr #0 {
bb.a:
  ...
  %i.c = load double, ptr %i.a, align 8, !tbaa !11 ; 6 uses
  br i1 %i.b, label %_ZNK17double_conversion6Double10NextDoubleEv.exit, label %bb.b
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.p = tail call fastcc noundef i32 @_ZN17double_conversionL22CompareBufferWithDiyFpENS_6VectorIKcEEiNS_5DiyFpE(ptr %0, i32 %1, i32 noundef %2, i64 %i.j, i32 %i.o) ; 2 uses
  %i.q = icmp slt i32 %i.p, 0
  br i1 %i.q, label %_ZNK17double_conversion6Double10NextDoubleEv.exit, label %bb.c
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %i.r, label %_ZNK17double_conversion6Double10NextDoubleEv.exit, label %bb.e
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.t, label %_ZNK17double_conversion6Double10NextDoubleEv.exit, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.u = add i64 %i.d, -1
  %i.v = bitcast i64 %i.u to double
  br label %_ZNK17double_conversion6Double10NextDoubleEv.exit
...
bb.i:                                             ; preds = %bb.c
  ...
  br i1 %3, label %bb.j, label %_ZNK17double_conversion6Double10NextDoubleEv.exit
...
bb.k:                                             ; preds = %bb.j
  ...
  br i1 %i.z, label %_ZNK17double_conversion6Double10NextDoubleEv.exit, label %bb.l
...
_ZNK17double_conversion6Double10NextDoubleEv.exit: ; preds = %bb.a, %bb.m, %bb.l, %bb.k, %bb.i, %bb.h, %bb.g, %bb.f, %bb.d, %bb.b
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.preheader.i.i
  ...
  br i1 %i.r, label %.lr.ph.i.i, label %._crit_edge.loopexit.i.i, !llvm.loop !14
...
.lr.ph.i35.i:                                     ; preds = %.lr.ph.i35.i, %.lr.ph.preheader.i34.i
  ...
  br i1 %i.ah, label %.lr.ph.i35.i, label %._crit_edge.loopexit.i39.i, !llvm.loop !14
...
.lr.ph.i44.i:                                     ; preds = %.lr.ph.i44.i, %.lr.ph.preheader.i43.i
  ...
  br i1 %i.bb, label %.lr.ph.i44.i, label %._crit_edge.loopexit.i48.i, !llvm.loop !14
...
_ZN17double_conversionL10ReadUint64ENS_6VectorIKcEEPi.exit49.i: ; preds = %._crit_edge.loopexit.i48.i, %bb.k
  ...
  %i.bf = load double, ptr %i.be, align 8, !tbaa !11
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i, %.lr.ph.preheader.i.i.i
  ...
  br i1 %i.bv, label %.lr.ph.i.i.i, label %._crit_edge.loopexit.i.i.i, !llvm.loop !14

end_hunk_0
begin_hunk_1_@_ZN17double_conversionL12ComputeGuessENS_6VectorIKcEEiPd:bb.a
  %i.go = phi double [ %i.gn, %._crit_edge26.i.i.i ], [ +inf, %._crit_edge.i.i.i ], [ 0.000000e+00, %bb.s ] ; 2 uses
  store double %i.go, ptr %3, align 8, !tbaa !11
...
.sink.split:                                      ; preds = %_ZN17double_conversion5DiyFp9NormalizeEv.exit.i, %_ZN17double_conversionL10ReadUint64ENS_6VectorIKcEEPi.exit49.i, %_ZN17double_conversionL10ReadUint64ENS_6VectorIKcEEPi.exit40.i, %_ZN17double_conversionL10ReadUint64ENS_6VectorIKcEEPi.exit.i, %bb.c, %bb.b, %bb.a
  ...
  store double %.sink, ptr %3, align 8, !tbaa !11
  br label %bb.t
...
bb.a:
  ...
  store i16 0, ptr %5, align 4, !tbaa !26
  %i.a = getelementptr inbounds nuw i8, ptr %5, i64 2
  store i16 0, ptr %i.a, align 2, !tbaa !27
...
bb.b:                                             ; preds = %.lr.ph.i.i
  ...
  br i1 %exitcond.not.i.i, label %_ZN17double_conversionL16TrimLeadingZerosENS_6VectorIKcEE.exit.i, label %.lr.ph.i.i, !llvm.loop !0
...
bb.d:                                             ; preds = %bb.e
  ...
  br i1 %i.l, label %bb.e, label %_ZN17double_conversion17TrimTrailingZerosENS_6VectorIKcEE.exit.thread.i, !llvm.loop !1
...
bb.e:                                             ; preds = %.lr.ph, %bb.d
  ...
  br i1 %.not.i26.i, label %bb.d, label %_ZN17double_conversion17TrimTrailingZerosENS_6VectorIKcEE.exit.i, !llvm.loop !1
...
.preheader.i.preheader:                           ; preds = %_ZN17double_conversion17TrimTrailingZerosENS_6VectorIKcEE.exit.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(779) %i.b, ptr noundef nonnull align 1 dereferenceable(779) %.sroa.09.1.i.i, i64 779, i1 false), !tbaa !12
  %i.u = getelementptr inbounds nuw i8, ptr %i.b, i64 779
  store i8 49, ptr %i.u, align 1, !tbaa !12
...
_ZN17double_conversionL10TrimAndCutENS_6VectorIKcEEiPciPS2_Pi.exit: ; preds = %_ZN17double_conversion17TrimTrailingZerosENS_6VectorIKcEE.exit.thread.i, %_ZN17double_conversion17TrimTrailingZerosENS_6VectorIKcEE.exit.i, %.preheader.i.preheader
  ...
  %i.y = load double, ptr %i.a, align 8, !tbaa !11 ; 6 uses
...
bb.m:                                             ; preds = %bb.g
  ...
  br i1 %3, label %bb.n, label %_ZN17double_conversion13StrtodTrimmedENS_6VectorIKcEEi.exit
...
bb.o:                                             ; preds = %bb.n
  ...
  br i1 %i.av, label %_ZN17double_conversion13StrtodTrimmedENS_6VectorIKcEEi.exit, label %bb.p
...
_ZN17double_conversion13StrtodTrimmedENS_6VectorIKcEEi.exit: ; preds = %_ZN17double_conversionL10TrimAndCutENS_6VectorIKcEEiPciPS2_Pi.exit, %bb.f, %bb.h, %bb.j, %bb.k, %bb.l, %bb.m, %bb.o, %bb.p, %bb.q
  %.1.i = phi double [ %i.ax, %bb.p ], [ %i.y, %bb.m ], [ %i.y, %bb.f ], [ +inf, %bb.h ], [ 0.000000e+00, %bb.j ], [ %i.at, %bb.l ], [ %i.ar, %bb.k ], [ 0.000000e+00, %bb.o ], [ %i.az, %bb.q ], [ %i.y, %_ZN17double_conversionL10TrimAndCutENS_6VectorIKcEEiPciPS2_Pi.exit ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #5
...
bb.d:                                             ; preds = %bb.e
  ...
  br i1 %i.k, label %bb.e, label %_ZN17double_conversion17TrimTrailingZerosENS_6VectorIKcEE.exit.thread.i, !llvm.loop !1
...
.preheader.i.preheader:                           ; preds = %_ZN17double_conversion17TrimTrailingZerosENS_6VectorIKcEE.exit.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(779) %i.a, ptr noundef nonnull align 1 dereferenceable(779) %.sroa.09.1.i.i, i64 779, i1 false), !tbaa !12
  %i.t = getelementptr inbounds nuw i8, ptr %i.a, i64 779
  store i8 49, ptr %i.t, align 1, !tbaa !12
...
!18 = distinct !{!18, !13}
!19 = !{!"long", !6, i64 0}
!20 = !{!"_ZTSN17double_conversion5DiyFpE", !19, i64 0, !7, i64 8}
!21 = !{!20, !19, i64 0}
!22 = !{!20, !7, i64 8}
!23 = !{!7, !7, i64 0}
!24 = !{!"short", !6, i64 0}
!25 = !{!"_ZTSN17double_conversion6BignumE", !24, i64 0, !24, i64 2, !6, i64 4}
!26 = !{!25, !24, i64 0}
!27 = !{!25, !24, i64 2}
end_hunk_1
