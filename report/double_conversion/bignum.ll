...
bb.c:                                             ; preds = %bb.d, %.lr.ph.i
  ...
  br i1 %i.cm, label %4, label %_ZN17double_conversion6Bignum5ClampEv.exit

4:                                                ; preds = %bb.c
  %5 = add nsw i16 %i.ci, -1
  store i16 %5, ptr %0, align 4, !tbaa !17
  ...
  %11 = icmp eq i32 %10, 0
  br i1 %11, label %bb.d, label %_ZN17double_conversion6Bignum5ClampEv.exit
...
_ZN17double_conversion6Bignum5ClampEv.exit:       ; preds = %bb.c, %4, %.critedge.i, %.critedge.thread3.i
  ret void
