...
bb.hw:                                            ; preds = %bb.hv
  ...
  %i.aiy = shl i64 %.22894.i538, %i.aiw
  %i.aiz = zext i64 %i.aiy to i128                ; 3 uses
...
bb.hx:                                            ; preds = %bb.hw
  ...
  %15 = zext i64 %i.ajj to i128
  %16 = mul nuw i128 %15, %i.aiz
  %17 = lshr i128 %16, 64
  %18 = trunc nuw i128 %17 to i64
  %i.ajk = add i64 %18, %i.aje                    ; 2 uses
...
bb.afc:                                           ; preds = %bb.afb
  ...
  %i.fhy = shl i64 %.22894.i669, %i.fhw
  %i.fhz = zext i64 %i.fhy to i128                ; 3 uses
...
bb.afd:                                           ; preds = %bb.afc
  ...
  %19 = zext i64 %i.fij to i128
  %20 = mul nuw i128 %19, %i.fhz
  %21 = lshr i128 %20, 64
  %22 = trunc nuw i128 %21 to i64
  %i.fik = add i64 %22, %i.fie                    ; 2 uses
...
bb.aql:                                           ; preds = %bb.aqk
  ...
  %i.hwj = shl i64 %.22894.i, %i.hwh
  %i.hwk = zext i64 %i.hwj to i128                ; 3 uses
...
bb.aqm:                                           ; preds = %bb.aql
  ...
  %23 = zext i64 %i.hwu to i128
  %24 = mul nuw i128 %23, %i.hwk
  %25 = lshr i128 %24, 64
  %26 = trunc nuw i128 %25 to i64
  %i.hwv = add i64 %26, %i.hwp                    ; 2 uses
...
bb.bmw:                                           ; preds = %bb.bmv
  ...
  %i.mta = shl i64 %.22894.i407, %i.msy
  %i.mtb = zext i64 %i.mta to i128                ; 3 uses
...
bb.bmx:                                           ; preds = %bb.bmw
  ...
  %27 = zext i64 %i.mtl to i128
  %28 = mul nuw i128 %27, %i.mtb
  %29 = lshr i128 %28, 64
  %30 = trunc nuw i128 %29 to i64
  %i.mtm = add i64 %30, %i.mtg                    ; 2 uses
...
bb.gt:                                            ; preds = %bb.gs
  ...
  %8 = zext i64 %i.acf to i128
  %9 = mul nuw i128 %8, %i.abv
  %10 = lshr i128 %9, 64
  %11 = trunc nuw i128 %10 to i64
  %i.acg = add i64 %11, %i.aca                    ; 2 uses
...
bb.gu:                                            ; preds = %bb.gt
  ...
  %i.abi = shl i64 %.22894.i, %i.abg
  %i.abj = zext i64 %i.abi to i128                ; 3 uses
...
bb.gv:                                            ; preds = %bb.gu
  ...
  %7 = zext i64 %i.abt to i128
  %8 = mul nuw i128 %7, %i.abj
  %9 = lshr i128 %8, 64
  %10 = trunc nuw i128 %9 to i64
  %i.abu = add i64 %10, %i.abo                    ; 2 uses
...
bb.hl:                                            ; preds = %bb.hk
  ...
  %i.aep = shl i64 %.22894.i1009, %i.aen
  %i.aeq = zext i64 %i.aep to i128                ; 3 uses
...
bb.hm:                                            ; preds = %bb.hl
  ...
  %10 = zext i64 %i.afa to i128
  %11 = mul nuw i128 %10, %i.aeq
  %12 = lshr i128 %11, 64
  %13 = trunc nuw i128 %12 to i64
  %i.afb = add i64 %13, %i.aev                    ; 2 uses
...
bb.ve:                                            ; preds = %bb.vd
  ...
  %i.dco = shl i64 %.22894.i878, %i.dcm
  %i.dcp = zext i64 %i.dco to i128                ; 3 uses
...
bb.vf:                                            ; preds = %bb.ve
  ...
  %14 = zext i64 %i.dcz to i128
  %15 = mul nuw i128 %14, %i.dcp
  %16 = lshr i128 %15, 64
  %17 = trunc nuw i128 %16 to i64
  %i.dda = add i64 %17, %i.dcu                    ; 2 uses
...
bb.aqp:                                           ; preds = %bb.aqo
  ...
  %i.htq = shl i64 %.22894.i, %i.hto
  %i.htr = zext i64 %i.htq to i128                ; 3 uses
...
bb.aqq:                                           ; preds = %bb.aqp
  ...
  %18 = zext i64 %i.hub to i128
  %19 = mul nuw i128 %18, %i.htr
  %20 = lshr i128 %19, 64
  %21 = trunc nuw i128 %20 to i64
  %i.huc = add i64 %21, %i.htw                    ; 2 uses
...
bb.ac:                                            ; preds = %bb.ab
  ...
  %i.in = shl i64 %i.p, %i.im
  %3 = zext i64 %i.in to i128                     ; 2 uses
  %i.io = zext i64 %i.ik to i128
  %4 = mul nuw i128 %i.io, %3
  %5 = lshr i128 %4, 64
  %i.ip = zext i64 %i.ii to i128
  %i.iq = mul nuw i128 %i.ip, %3
  %i.ir = add nuw i128 %5, %i.iq                  ; 2 uses
...
._crit_edge:                                      ; preds = %bb.ab, %bb.ac, %bb.ad, %bb.ae
  ...
  %i.kg = shl i64 %i.jq, %i.kf
  %6 = zext i64 %i.kg to i128                     ; 2 uses
  %i.kh = zext i64 %i.ke to i128                  ; 3 uses
  %7 = mul nuw i128 %i.kh, %6
  %8 = lshr i128 %7, 64
  %i.ki = zext i64 %i.kb to i128                  ; 3 uses
  %i.kj = mul nuw i128 %i.ki, %6
  %i.kk = add nuw i128 %8, %i.kj                  ; 2 uses
  ...
  %i.kr = shl i64 %i.jn, %i.kf
  %i.ks = zext i64 %i.kr to i128                  ; 2 uses
  %9 = mul nuw i128 %i.kh, %i.ks
  %10 = lshr i128 %9, 64
  %i.kt = mul nuw i128 %i.ki, %i.ks
  %i.ku = add nuw i128 %10, %i.kt                 ; 2 uses
  ...
  %i.lb = shl i64 %i.jr, %i.kf
  %i.lc = zext i64 %i.lb to i128                  ; 2 uses
  %11 = mul nuw i128 %i.kh, %i.lc
  %12 = lshr i128 %11, 64
  %i.ld = mul nuw i128 %i.ki, %i.lc
  %i.le = add nuw i128 %12, %i.ld                 ; 2 uses
...
bb.ac:                                            ; preds = %bb.ab
  ...
  %i.iu = shl i64 %i.q, %i.it
  %4 = zext i64 %i.iu to i128                     ; 2 uses
  %i.iv = zext i64 %i.iq to i128
  %5 = mul nuw i128 %i.iv, %4
  %6 = lshr i128 %5, 64
  %i.iw = zext i64 %i.io to i128
  %i.ix = mul nuw i128 %i.iw, %4
  %i.iy = add nuw i128 %6, %i.ix                  ; 2 uses
...
bb.ag:                                            ; preds = %bb.af
  ...
  %7 = zext i64 %i.ju to i128
  %8 = zext i64 %.sroa.5.0.copyload.i to i128
  %9 = mul nuw i128 %7, %8
  %10 = lshr i128 %9, 64
  %11 = trunc nuw i128 %10 to i64
  %i.jv = zext nneg i32 %.sroa.7.0.copyload.i to i64
  %i.jw = lshr i64 %11, %i.jv                     ; 2 uses
...
bb.bd:                                            ; preds = %bb.bc
  ...
  %i.xe = shl i64 %i.q, %i.xd
  %12 = zext i64 %i.xe to i128                    ; 2 uses
  %i.xf = zext i64 %i.xb to i128
  %13 = mul nuw i128 %i.xf, %12
  %14 = lshr i128 %13, 64
  %i.xg = zext i64 %i.wz to i128
  %i.xh = mul nuw i128 %i.xg, %12
  %i.xi = add nuw i128 %14, %i.xh                 ; 2 uses
...
._crit_edge:                                      ; preds = %bb.bc, %bb.bd, %bb.be, %bb.bf
  ...
  %i.yx = shl i64 %i.yh, %i.yw
  %15 = zext i64 %i.yx to i128                    ; 2 uses
  %i.yy = zext i64 %i.yv to i128                  ; 3 uses
  %16 = mul nuw i128 %i.yy, %15
  %17 = lshr i128 %16, 64
  %i.yz = zext i64 %i.ys to i128                  ; 3 uses
  %i.za = mul nuw i128 %i.yz, %15
  %i.zb = add nuw i128 %17, %i.za                 ; 2 uses
  ...
  %i.zi = shl i64 %i.ye, %i.yw
  %i.zj = zext i64 %i.zi to i128                  ; 2 uses
  %18 = mul nuw i128 %i.yy, %i.zj
  %19 = lshr i128 %18, 64
  %i.zk = mul nuw i128 %i.yz, %i.zj
  %i.zl = add nuw i128 %19, %i.zk                 ; 2 uses
  ...
  %i.zs = shl i64 %i.yi, %i.yw
  %i.zt = zext i64 %i.zs to i128                  ; 2 uses
  %20 = mul nuw i128 %i.yy, %i.zt
  %21 = lshr i128 %20, 64
  %i.zu = mul nuw i128 %i.yz, %i.zt
  %i.zv = add nuw i128 %21, %i.zu                 ; 2 uses
