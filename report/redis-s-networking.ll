...
41:                                               ; preds = %28, %34, %24, %35
  %42 = load i64, ptr %5, align 8, !tbaa !98      ; [#uses=1 type=i64]
  %.fr102 = freeze i64 %42                        ; [#uses=3 type=i64]
  %43 = and i64 %.fr102, 2                        ; [#uses=1 type=i64]
  %.not.i = icmp ne i64 %43, 0                    ; [#uses=4 type=i1]
  %44 = and i64 %.fr102, 5                        ; [#uses=1 type=i64]
  ...
  %.pre.fr = freeze i64 %.pre                     ; [#uses=1 type=i64]
  %.not66 = icmp eq i64 %.pre.fr, -1              ; [#uses=3 type=i1]
...
getClientType.exit.thread:                        ; preds = %41
  %45 = and i64 %.fr102, 18014398509481984        ; [#uses=1 type=i64]
...
define dso_local void @addReplyBulkSds(ptr noundef %0, ptr noundef %1) local_unnamed_addr #0 {
  %3 = alloca [128 x i8], align 16                ; [#uses=7 type=ptr]
...
47:                                               ; preds = %2, %27, %43, %clientHasPendingReplies.exit.i, %18, %34, %37, %40, %24
  ...
  %.val.i = load i8, ptr %48, align 1, !tbaa !17  ; [#uses=2 type=i8]
...
50:                                               ; preds = %47
  %51 = lshr i8 %.val.i, 3                        ; [#uses=1 type=i8]
  %52 = zext nneg i8 %51 to i64                   ; [#uses=1 type=i64]
...
sdslen.exit:                                      ; preds = %50, %53, %57, %61, %65
  %.0.i9 = phi i64 [ %67, %65 ], [ %52, %50 ], [ %56, %53 ], [ %60, %57 ], [ %64, %61 ] ; [#uses=1 type=i64]
  %.0.i9.fr = freeze i64 %.0.i9                   ; [#uses=4 type=i64]
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #30
  %68 = icmp ult i64 %.0.i9.fr, 32                ; [#uses=1 type=i1]
  %69 = icmp samesign ult i64 %.0.i9.fr, 10       ; [#uses=1 type=i1]
  %. = select i1 %69, i64 4, i64 5                ; [#uses=1 type=i64]
  br i1 %68, label %70, label %76

70:                                               ; preds = %sdslen.exit, %.thread
  %71 = phi i64 [ 4, %.thread ], [ %., %sdslen.exit ] ; [#uses=1 type=i64]
  %.0.i91821 = phi i64 [ 0, %.thread ], [ %.0.i9.fr, %sdslen.exit ] ; [#uses=1 type=i64]
...
76:                                               ; preds = %sdslen.exit
  ...
  %78 = call i32 @ll2string(ptr noundef nonnull %77, i64 noundef 127, i64 noundef %.0.i9.fr) #30 ; [#uses=2 type=i32]
...
authRequired.exit:                                ; preds = %1
  ...
  %.fr = freeze i32 %9                            ; [#uses=1 type=i32]
  %.not5.i.not = icmp eq i32 %.fr, 0              ; [#uses=1 type=i1]
...
define internal fastcc void @releaseBufReferences(ptr noundef captures(address_is_null) %0, ptr noundef captures(address) %1, i64 noundef %2) unnamed_addr #0 {
  ...
  %.not2334 = icmp eq i64 %2, 0                   ; [#uses=2 type=i1]
...
.lr.ph:                                           ; preds = %5
  ...
  %.fr24 = freeze i8 %7                           ; [#uses=1 type=i8]
  %.not39 = icmp eq i8 %.fr24, 0                  ; [#uses=1 type=i1]
...
define internal fastcc ptr @processSentDataInEncodedBuffer(ptr noundef captures(address_is_null) %0, ptr noundef captures(address, ret: address, provenance) %1, ptr noundef readnone captures(address) %2, ptr noundef captures(none) %3, ptr noundef nonnull captures(none) %4) unnamed_addr #0 {
  ...
  br i1 %.not, label %.thread109, label %7
...
.lr.ph:                                           ; preds = %7
  ...
  %.fr77 = freeze i8 %9                           ; [#uses=1 type=i8]
  %.not130 = icmp eq i8 %.fr77, 0                 ; [#uses=1 type=i1]
...
.critedge:                                        ; preds = %.lr.ph.split.us, %73, %.lr.ph.split, %127, %.thread109, %7
  %.046.lcssa = phi ptr [ %1, %7 ], [ %1, %.thread109 ], [ %.04667, %.lr.ph.split ], [ %130, %127 ], [ %.04667.us, %.lr.ph.split.us ], [ %76, %73 ] ; [#uses=2 type=ptr]
