...
.lr.ph.i64:                                       ; preds = %.lr.ph.i64.prol.loopexit, %.lr.ph.i64
  ...
  store i32 %i.fg, ptr %i.fh, align 4, !tbaa !24
  %i.fi = add nuw nsw i64 %.010.i65, 2            ; 2 uses
  %.not.i66.1 = icmp eq i64 %i.fi, %i.ee
  br i1 %.not.i66.1, label %_ZN4gdcm15RescaleFunctionIhiEEvPT_PKT0_ddm.exit, label %.lr.ph.i64, !llvm.loop !260
...
vector.body121:                                   ; preds = %vector.body121, %vector.ph115
  ...
  %wide.load123 = load <4 x i32>, ptr %i.fk, align 4, !tbaa !24
  ...
  store <4 x float> %i.fn, ptr %i.fo, align 4, !tbaa !20
  %index.next124 = add nuw i64 %index122, 4       ; 2 uses
  %i.fp = icmp eq i64 %index.next124, %n.vec116
  br i1 %i.fp, label %middle.block125, label %vector.body121, !llvm.loop !261
...
.lr.ph.i68:                                       ; preds = %.lr.ph.i68.preheader240, %.lr.ph.i68
  ...
  %i.fr = load i32, ptr %i.fq, align 4, !tbaa !24
  ...
  store float %i.fu, ptr %i.fv, align 4, !tbaa !20
  %i.fw = add nuw nsw i64 %.010.i69, 1            ; 2 uses
  %.not.i70 = icmp eq i64 %i.fw, %i.fj
  br i1 %.not.i70, label %_ZN4gdcm15RescaleFunctionIhiEEvPT_PKT0_ddm.exit, label %.lr.ph.i68, !llvm.loop !262
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i32>, ptr %i.fy, align 4, !tbaa !24
  %wide.load112 = load <2 x i32>, ptr %i.fz, align 4, !tbaa !24
  ...
  store <2 x double> %i.gc, ptr %i.ge, align 8, !tbaa !25
  store <2 x double> %i.gd, ptr %i.gf, align 8, !tbaa !25
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.gg = icmp eq i64 %index.next, %n.vec
  br i1 %i.gg, label %middle.block, label %vector.body, !llvm.loop !263
...
.lr.ph.i72:                                       ; preds = %.lr.ph.i72.preheader242, %.lr.ph.i72
  ...
  store double %i.gk, ptr %i.gl, align 8, !tbaa !25
  %i.gm = add nuw nsw i64 %.010.i73, 1            ; 2 uses
  %.not.i74 = icmp eq i64 %i.gm, %i.fx
  br i1 %.not.i74, label %_ZN4gdcm15RescaleFunctionIhiEEvPT_PKT0_ddm.exit, label %.lr.ph.i72, !llvm.loop !264
...
bb.a:
  ...
  store double %.sink9, ptr %i.b, align 8, !tbaa !269
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 40
  store double %.sink, ptr %i.c, align 8, !tbaa !270
  ret void
}
...
bb.e:                                             ; preds = %bb.a
  ...
  %13 = load <2 x double>, ptr %0, align 8, !tbaa !25 ; 3 uses
  %i.f = load <2 x double>, ptr %i.e, align 8, !tbaa !25 ; 3 uses
...
bb.w:                                             ; preds = %bb.v
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(10) %1, ptr noundef nonnull align 2 dereferenceable(10) %2, i64 10, i1 false), !tbaa.struct !273
...
bb.y:                                             ; preds = %bb.x
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(10) %1, ptr noundef nonnull align 2 dereferenceable(10) %3, i64 10, i1 false), !tbaa.struct !273
...
bb.aa:                                            ; preds = %bb.z
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(10) %1, ptr noundef nonnull align 2 dereferenceable(10) %4, i64 10, i1 false), !tbaa.struct !273
...
bb.ah:                                            ; preds = %.preheader, %bb.ah
  ...
  br i1 %.not77.i, label %bb.ai, label %bb.ah, !llvm.loop !271
...
bb.am:                                            ; preds = %bb.al, %bb.ak, %bb.aj, %bb.ai
  ...
  %i.ar = load i16, ptr %i.aq, align 2, !tbaa !274
...
bb.an:                                            ; preds = %bb.am
  ...
  store i16 %.0.i.i, ptr %i.at, align 4, !tbaa !275
