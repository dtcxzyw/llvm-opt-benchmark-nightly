...
begin_hunk_0_@_ZN3tev11ImageButton4drawEP10NVGcontext:bb.a
  store ptr %i.du, ptr %i.cx, align 8, !tbaa !115
...
bb.ac:                                            ; preds = %bb.ab, %_ZNSt3__114__split_bufferImRNS_9allocatorImEEE5clearB8ne180100Ev.exit.i.i.i, %bb.x
  ...
  store ptr %.0.i, ptr %i.cw, align 8, !tbaa !287
  ...
  %i.ej = load i8, ptr %.0.i94, align 1, !tbaa !49
...
_ZN3tev15codePointLengthEc.exit:                  ; preds = %bb.ac, %bb.ad, %bb.ae
  ...
  br i1 %i.ew, label %bb.w, label %._crit_edge, !llvm.loop !277
...
._crit_edge:                                      ; preds = %_ZN3tev15codePointLengthEc.exit
  %.pre = load ptr, ptr %3, align 8, !tbaa !286   ; 4 uses
  %i.ex = load i32, ptr %i.bn, align 16, !tbaa !104
...
bb.af:                                            ; preds = %.noexc98, %.lr.ph.i.i
  ...
  %.val13.val.i.i = load i64, ptr %i.fh, align 8, !tbaa !107
...
.noexc98:                                         ; preds = %bb.af
  ...
  br i1 %.not.i.i96, label %.loopexit, label %bb.af, !llvm.loop !278

.loopexit:                                        ; preds = %.noexc98
  %.pre211 = load ptr, ptr %i.fb, align 8, !tbaa !287 ; 2 uses
  %.pre212.pre = load ptr, ptr %3, align 8, !tbaa !286 ; 6 uses
...
.thread:                                          ; preds = %bb.ag
  ...
  %i.fy = load i64, ptr %i.fx, align 8, !tbaa !107
  store i64 %i.fy, ptr %i.bv, align 8, !tbaa !282
  %i.fz = load i64, ptr %i.bn, align 16, !tbaa !49
  store i64 %i.fz, ptr %i.bo, align 16, !tbaa !49
  br label %bb.ak
...
.loopexit.thread:                                 ; preds = %._crit_edge, %.loopexit
  ...
  %i.gc = load i64, ptr %i.bn, align 16, !tbaa !49
  store i64 %i.gc, ptr %i.bo, align 16, !tbaa !49
...
bb.ak:                                            ; preds = %.thread, %.loopexit.thread
  ...
  store ptr %.pre212239242, ptr %i.fb, align 8, !tbaa !287
...
bb.al:                                            ; preds = %bb.aj, %bb.ai, %.loopexit200, %.loopexit.split-lp
  ...
  %i.gi = load ptr, ptr %3, align 8, !tbaa !286   ; 4 uses
...
bb.am:                                            ; preds = %bb.al
  ...
  store ptr %i.gi, ptr %i.gj, align 8, !tbaa !287
  %i.gk = getelementptr inbounds nuw i8, ptr %3, i64 16
  %i.gl = load ptr, ptr %i.gk, align 8, !tbaa !115
...
bb.an:                                            ; preds = %bb.n, %_ZNSt3__16vectorImNS_9allocatorImEEED2B8ne180100Ev.exit, %bb.q
  ...
  %i.gq = load <4 x i32>, ptr %i.gp, align 8, !tbaa !104
  ...
  %i.gz = load i32, ptr %i.gy, align 8, !tbaa !105 ; 2 uses
  ...
  %i.hf = load i8, ptr %i.he, align 8, !tbaa !86, !range !108, !noundef !109
  ...
  %i.hh = load i8, ptr %i.p, align 16, !tbaa !89, !range !108, !noundef !109
  %i.hi = trunc nuw i8 %i.hh to i1
  br i1 %i.hi, label %bb.aq, label %bb.ao

bb.ao:                                            ; preds = %bb.an
  %i.hj = load i8, ptr %i.f, align 1, !tbaa !87, !range !108, !noundef !109
  %i.hk = trunc nuw i8 %i.hj to i1
  br i1 %i.hk, label %bb.aq, label %bb.ap

bb.ap:                                            ; preds = %bb.ao
  %i.hl = getelementptr inbounds nuw i8, ptr %0, i64 107
  %i.hm = load i8, ptr %i.hl, align 1, !tbaa !281, !range !108, !noundef !109
...
bb.at:                                            ; preds = %bb.as
  ...
  %i.hq = load i64, ptr %i.hp, align 8, !tbaa !282 ; 8 uses
  %i.hr = getelementptr inbounds nuw i8, ptr %0, i64 152
  %i.hs = load i8, ptr %i.hr, align 8, !noalias !289 ; 2 uses
  %i.ht = trunc i8 %i.hs to i1                    ; 2 uses
  %i.hu = getelementptr inbounds nuw i8, ptr %0, i64 160
  %i.hv = load i64, ptr %i.hu, align 16, !noalias !289
  %i.hw = lshr i8 %i.hs, 1
...
_ZNKSt3__117basic_string_viewIcNS_11char_traitsIcEEE6substrB8ne180100Emm.exit.i: ; preds = %bb.at
  ...
  %i.ib = load ptr, ptr %i.ia, align 8, !noalias !289
  ...
  %i.ig = load i64, ptr %i.bb, align 8, !tbaa !107, !noalias !289 ; 2 uses
  %i.ih = call i64 @llvm.usub.sat.i64(i64 %i.ig, i64 %i.hq) ; 4 uses
  %i.ii = getelementptr inbounds nuw i8, ptr %0, i64 384
  %i.ij = load i64, ptr %i.ii, align 16, !tbaa !107, !noalias !289
...
bb.bs:                                            ; preds = %bb.br, %bb.bn
  %i.jj = load i8, ptr %i.p, align 16, !tbaa !89, !range !108, !noundef !109
...
bb.bu:                                            ; preds = %bb.bs
  %i.jm = load i8, ptr %i.f, align 1, !tbaa !87, !range !108, !noundef !109
  %i.jn = trunc nuw i8 %i.jm to i1
  br i1 %i.jn, label %bb.bw, label %bb.bv

bb.bv:                                            ; preds = %bb.bu
  %i.jo = getelementptr inbounds nuw i8, ptr %0, i64 107
  %i.jp = load i8, ptr %i.jo, align 1, !tbaa !281, !range !108, !noundef !109
...
bb.bx:                                            ; preds = %bb.bw, %bb.bv
  ...
  %i.jr = load i32, ptr %i.gy, align 8, !tbaa !105
...
bb.cb:                                            ; preds = %bb.ca
  %i.ju = load i32, ptr %i.gp, align 8, !tbaa !104
...
bb.cd:                                            ; preds = %bb.cc
  %i.km = load ptr, ptr %i.jz, align 8, !tbaa !49
...
bb.b:                                             ; preds = %bb.a
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #31, !noalias !294
  store i64 %2, ptr %3, align 16, !tbaa !49, !noalias !294
  %i.q = getelementptr inbounds nuw i8, ptr %3, i64 16
  store i64 %i.p, ptr %i.q, align 16, !tbaa !49, !noalias !294
...
bb.c:                                             ; preds = %bb.b
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #31, !noalias !294
...
bb.d:                                             ; preds = %bb.c
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt16invalid_argument, i64 16), ptr %i.j, align 8, !tbaa !48
