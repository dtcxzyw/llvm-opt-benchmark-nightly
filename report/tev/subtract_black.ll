...
define noundef range(i32 -100013, 1) i32 @_ZN6LibRaw14subtract_blackEv(ptr noundef nonnull align 8 dereferenceable(768512) %0) local_unnamed_addr #0 align 2 {
bb.a:
  tail call void @_ZN6LibRaw9adjust_blEv(ptr noundef nonnull align 8 dereferenceable(768512) %0)
  %i.a = tail call noundef i32 @_ZN6LibRaw23subtract_black_internalEv(ptr noundef nonnull align 8 dereferenceable(768512) %0)
  ret i32 %i.a
}

declare void @_ZN6LibRaw9adjust_blEv(ptr noundef nonnull align 8 dereferenceable(768512)) local_unnamed_addr #1

; Function Attrs: mustprogress uwtable
define noundef range(i32 -100013, 1) i32 @_ZN6LibRaw23subtract_black_internalEv(ptr noundef nonnull align 8 dereferenceable(768512) %0) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 3 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 5592
  %i.c = load i32, ptr %i.b, align 8, !tbaa !74
  %i.d = and i32 %i.c, 268435440
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.i = invoke noundef i32 %i.h(ptr noundef nonnull align 8 dereferenceable(768512) %0)
...
bb.d:                                             ; preds = %bb.c
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 136672 ; 6 uses
  %i.k = load i32, ptr %i.j, align 8, !tbaa !77   ; 3 uses
  %.not74 = icmp eq i32 %i.k, 0
  %i.l = getelementptr inbounds nuw i8, ptr %0, i64 136676
  %i.m = load i32, ptr %i.l, align 4, !tbaa !77   ; 2 uses
  %.not75 = icmp eq i32 %i.m, 0
  %or.cond = select i1 %.not74, i1 %.not75, i1 false
  br i1 %or.cond, label %bb.e, label %._crit_edge127

bb.e:                                             ; preds = %bb.d
  %i.n = getelementptr inbounds nuw i8, ptr %0, i64 136680
  %i.o = load i32, ptr %i.n, align 8, !tbaa !77
  %.not76 = icmp eq i32 %i.o, 0
  br i1 %.not76, label %bb.f, label %._crit_edge127

bb.f:                                             ; preds = %bb.e
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 136684
  %i.q = load i32, ptr %i.p, align 4, !tbaa !77
  %.not77 = icmp eq i32 %i.q, 0
  br i1 %.not77, label %bb.g, label %._crit_edge127

bb.g:                                             ; preds = %bb.f
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 136688
  %i.s = load i32, ptr %i.r, align 8, !tbaa !77
  %.not78 = icmp eq i32 %i.s, 0
  br i1 %.not78, label %bb.m, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 136692
  %i.u = load i32, ptr %i.t, align 4, !tbaa !77
  %.not79 = icmp eq i32 %i.u, 0
  br i1 %.not79, label %bb.m, label %._crit_edge127

._crit_edge127:                                   ; preds = %bb.d, %bb.h, %bb.f, %bb.e
  %.sroa.5.0.copyload = phi i32 [ %i.m, %bb.d ], [ 0, %bb.h ], [ 0, %bb.f ], [ 0, %bb.e ] ; 2 uses
  %.sroa.7.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 136680
  %.sroa.7.0.copyload = load i32, ptr %.sroa.7.0..sroa_idx, align 8, !tbaa !77 ; 2 uses
  %.sroa.9.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 136684
  %.sroa.9.0.copyload = load i32, ptr %.sroa.9.0..sroa_idx, align 4, !tbaa !77 ; 2 uses
  %i.v = getelementptr inbounds nuw i8, ptr %0, i64 28
  %i.w = load i16, ptr %i.v, align 4, !tbaa !78
  %i.x = zext i16 %i.w to i32
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 30 ; 5 uses
  %i.z = load i16, ptr %i.y, align 2, !tbaa !79
  %i.aa = zext i16 %i.z to i32
  %i.ab = mul nuw i32 %i.aa, %i.x                 ; 4 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %0, i64 136688
  %i.ad = load i32, ptr %i.ac, align 8, !tbaa !77 ; 5 uses
...
bb.i:                                             ; preds = %bb.b
  ...
  %i.ag = tail call i32 @llvm.eh.typeid.for.p0(ptr nonnull @_ZTI17LibRaw_exceptions) #5
  %i.ah = icmp eq i32 %i.af, %i.ag
  br i1 %i.ah, label %bb.j, label %bb.x

bb.j:                                             ; preds = %bb.i
  %i.ai = extractvalue { ptr, i32 } %i.ae, 0
  %i.aj = tail call ptr @__cxa_begin_catch(ptr %i.ai) #5
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %i.fo, %vector.body ]
  %vec.phi135 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %i.fp, %vector.body ]
  ...
  %i.fm = zext <4 x i16> %wide.load to <4 x i32>
  %i.fn = zext <4 x i16> %wide.load136 to <4 x i32>
  %i.fo = tail call <4 x i32> @llvm.umax.v4i32(<4 x i32> %vec.phi, <4 x i32> %i.fm) ; 2 uses
  %i.fp = tail call <4 x i32> @llvm.umax.v4i32(<4 x i32> %vec.phi135, <4 x i32> %i.fn) ; 2 uses
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.fq = icmp eq i64 %index.next, %n.vec
  br i1 %i.fq, label %middle.block, label %vector.body, !llvm.loop !10

middle.block:                                     ; preds = %vector.body
  %rdx.minmax = tail call <4 x i32> @llvm.umax.v4i32(<4 x i32> %i.fo, <4 x i32> %i.fp)
  %i.fr = tail call i32 @llvm.vector.reduce.umax.v4i32(<4 x i32> %rdx.minmax) ; 2 uses
...
.lr.ph.preheader137:                              ; preds = %.lr.ph.preheader, %middle.block
  ...
  %.0100.ph = phi i32 [ 0, %.lr.ph.preheader ], [ %i.fr, %middle.block ]
  br label %.lr.ph
...
.lr.ph:                                           ; preds = %.lr.ph.preheader137, %.lr.ph
  ...
  %i.fs = getelementptr inbounds nuw [2 x i8], ptr %i.fb, i64 %indvars.iv118
  %i.ft = load i16, ptr %i.fs, align 2, !tbaa !83
  %i.fu = zext i16 %i.ft to i32
  %spec.select83 = tail call i32 @llvm.umax.i32(i32 %.0100, i32 %i.fu) ; 2 uses
...
._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %bb.m
  %.0.lcssa = phi i32 [ 0, %bb.m ], [ %i.fr, %middle.block ], [ %spec.select83, %.lr.ph ]
  %i.fv = getelementptr inbounds nuw i8, ptr %0, i64 153092
  store i32 %.0.lcssa, ptr %i.fv, align 4, !tbaa !85
  br label %bb.w
...
bb.x:                                             ; preds = %bb.o, %bb.i
  %.merged = phi { ptr, i32 } [ %i.fw, %bb.o ], [ %i.ae, %bb.i ]
