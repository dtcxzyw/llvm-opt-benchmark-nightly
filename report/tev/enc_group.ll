...
bb.f:                                             ; preds = %.lr.ph, %bb.f
  ...
  %i.ed = fcmp olt <4 x float> %i.ec, splat (float 1.125000e+00) ; 2 uses
  %.not76 = icmp ne <4 x i32> %i.dy, zeroinitializer
  ...
  %11 = select <4 x i1> %i.ed, <4 x i1> %.not76, <4 x i1> zeroinitializer
  %12 = select <4 x i1> %11, <4 x i32> %i.ee, <4 x i32> zeroinitializer
  %13 = bitcast <4 x float> %i.eh to <4 x i32>
  %14 = select <4 x i1> %i.ed, <4 x i32> zeroinitializer, <4 x i32> %13
  %15 = or <4 x i32> %14, %12
...
.lr.ph.i.us:                                      ; preds = %_ZN3jxl6N_SSE215QuantizeBlockACERKNS_9QuantizerEbmfNS_14AcStrategyTypeEmmPfPKfPKiPi.exit.i.us, %.lr.ph.i.us
  ...
  %10 = bitcast <4 x float> %i.ll to <4 x i32>
  %11 = and <4 x i32> %10, splat (i32 -2147483648)
  %i.lm = call <4 x float> @llvm.fabs.v4f32(<4 x float> %i.ll)
  %i.ln = fcmp olt <4 x float> %i.lm, splat (float 1.125000e+00) ; 2 uses
  %.not76.i.us = icmp ne <4 x i32> %i.lk, zeroinitializer
  %12 = or disjoint <4 x i32> %11, splat (i32 1064177896)
  ...
  %13 = select <4 x i1> %i.ln, <4 x i1> %.not76.i.us, <4 x i1> zeroinitializer
  %14 = select <4 x i1> %13, <4 x i32> %12, <4 x i32> zeroinitializer
  %15 = bitcast <4 x float> %i.lq to <4 x i32>
  %16 = select <4 x i1> %i.ln, <4 x i32> zeroinitializer, <4 x i32> %15
  %17 = or <4 x i32> %16, %14
