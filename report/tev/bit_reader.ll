Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/tev/original/bit_reader?download=true
...
BrotliPullByte.exit:                              ; preds = %bb.b
  ...
  store i64 %i.j, ptr %0, align 8, !tbaa !14
...
bb.a:
  %i.a = load i64, ptr %0, align 8, !tbaa !14     ; 3 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 7 uses
  %i.c = load i64, ptr %i.b, align 8, !tbaa !13   ; 7 uses
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 5 uses
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !15   ; 9 uses
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 32 ; 2 uses
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !16   ; 5 uses
...
BrotliPullByte.exit.i8:                           ; preds = %.lr.ph
  %i.m = load i8, ptr %i.e, align 1, !tbaa !17
  %i.n = zext i8 %i.m to i64
  %i.o = shl nuw nsw i64 %i.n, %i.c
  %i.p = or i64 %i.o, %i.a                        ; 3 uses
  store i64 %i.p, ptr %0, align 8, !tbaa !14
  ...
  store ptr %i.r, ptr %i.d, align 8, !tbaa !15
...
BrotliPullByte.exit.i8.1:                         ; preds = %.lr.ph.1
  ...
  store i64 %i.x, ptr %0, align 8, !tbaa !14
...
._crit_edge:                                      ; preds = %BrotliPullByte.exit.i8, %BrotliPullByte.exit.i8.1, %bb.a
  ...
  store i64 %i.ad, ptr %0, align 8, !tbaa !14
...
.lr.ph33:                                         ; preds = %BrotliPullByte.exit.i
  ...
  br i1 %i.ah, label %BrotliSafeReadBits.exit11.thread, label %BrotliPullByte.exit.i, !llvm.loop !18
...
BrotliPullByte.exit.i:                            ; preds = %.lr.ph33.preheader, %.lr.ph33
  ...
  %i.al = load i8, ptr %i.aj, align 1, !tbaa !17
  %i.am = zext i8 %i.al to i64
  %i.an = shl i64 %i.am, %i.ai
  %i.ao = or i64 %i.an, %i.ak                     ; 3 uses
  store i64 %i.ao, ptr %0, align 8, !tbaa !14
  ...
  br i1 %i.ar, label %.lr.ph33, label %._crit_edge34, !llvm.loop !18
...
._crit_edge34:                                    ; preds = %BrotliPullByte.exit.i, %._crit_edge
  ...
  store i64 %5, ptr %i.b, align 8, !tbaa !13
  %6 = lshr i64 %3, %i.ae
  store i64 %6, ptr %0, align 8, !tbaa !14
  %7 = shl i64 %4, 16
  %8 = or disjoint i64 %7, %i.ab
  store i64 %8, ptr %2, align 8, !tbaa !20
...
BrotliSafeReadBits.exit11.thread:                 ; preds = %.lr.ph, %.lr.ph.1, %.lr.ph33, %.lr.ph33.preheader
  ...
  store ptr %i.as, ptr %i.f, align 8, !tbaa !16
  %i.at = add i64 %i.j, -28
...
bb.c:                                             ; preds = %BrotliSafeReadBits.exit11.thread
  ...
  store ptr %i.e, ptr %i.ax, align 8, !tbaa !21
  br label %BrotliBitReaderSetInput.exit
...
attributes #2 = { nofree noinline norecurse nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none, target_mem: none) uwtable "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!12 = !{!"", !9, i64 0, !9, i64 8, !11, i64 16, !11, i64 24, !11, i64 32}
!13 = !{!12, !9, i64 8}
!14 = !{!12, !9, i64 0}
!15 = !{!12, !11, i64 16}
!16 = !{!12, !11, i64 32}
