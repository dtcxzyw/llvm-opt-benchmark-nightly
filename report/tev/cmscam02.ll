...
InverseCorrelates.exit:                           ; preds = %bb.b, %bb.c
  ...
  %3 = extractelement <2 x i1> %i.cr, i64 1
  ...
  %4 = extractelement <2 x i1> %i.cr, i64 0
  ...
  %5 = select i1 %3, double %i.ch, double %i.cg
  %6 = select i1 %i.cj, double %i.ch, double %i.cg
  %7 = select i1 %4, double %i.ch, double %i.cg
  %8 = fmul double %i.da, %5                      ; 2 uses
  %9 = fmul double %i.cy, %6                      ; 2 uses
  %10 = fmul double %7, %i.dg                     ; 2 uses
  %11 = fmul double %8, f0x3FFD9ADE4046FFDE
  %12 = insertelement <2 x double> poison, double %8, i64 0
  %13 = shufflevector <2 x double> %12, <2 x double> poison, <2 x i32> zeroinitializer
  %i.dx = fmul <2 x double> %13, <double f0xBFE16E5EA75C2336, double f0x3F756044DD566727>
  %14 = tail call double @llvm.fmuladd.f64(double %9, double f0xBFE6DBC443794205, double %11)
  %15 = insertelement <2 x double> poison, double %9, i64 0
  %16 = shufflevector <2 x double> %15, <2 x double> poison, <2 x i32> zeroinitializer
  %i.dy = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %16, <2 x double> <double f0x3FF8F249DF5F3018, double f0x3F8611789ABDD357>, <2 x double> %i.dx)
  %17 = tail call double @llvm.fmuladd.f64(double %10, double f0xBFC166C5EFA969C8, double %14)
  %18 = insertelement <2 x double> poison, double %10, i64 0
  %i.dz = shufflevector <2 x double> %18, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.eg = fdiv double %17, %i.dw                  ; 2 uses
