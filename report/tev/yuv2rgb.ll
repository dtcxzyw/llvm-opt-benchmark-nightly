...
.lr.ph.split.us420:                               ; preds = %.lr.ph.split.us420.preheader, %.lr.ph.split.us420
  ...
  %.0.us = select i1 %.0248, float %i.qc, float %i.qj ; 2 uses
  %i.qk = getelementptr [2 x i8], ptr %i.lc, i64 %indvars.iv453
  %21 = insertelement <2 x float> poison, float %i.qh, i64 0 ; 2 uses
  %22 = insertelement <2 x float> %21, float %i.qi, i64 1
  %23 = fmul nnan <2 x float> %22, <float 1.142900e+00, float 1.168900e+00>
  %i.ql = insertelement <2 x float> %21, float %i.pw, i64 1
  %24 = select <2 x i1> %19, <2 x float> %i.ql, <2 x float> %23 ; 3 uses
  %25 = extractelement <2 x float> %24, i64 1     ; 2 uses
  %26 = call float @llvm.fmuladd.f32(float %20, float %.0.us, float %25)
  ...
  %29 = call float @llvm.fmuladd.f32(float %i.lj, float %.0.us, float %25)
...
_Z10clip_f_u16fi.exit:                            ; preds = %.preheader, %bb.bt
  ...
  %.0 = select i1 %.0125, float %i.jv, float %i.kc ; 2 uses
  %i.kd = insertelement <2 x float> poison, float %i.ka, i64 0 ; 2 uses
  %21 = insertelement <2 x float> %i.kd, float %i.kb, i64 1
  %22 = fmul nnan <2 x float> %21, <float 1.142900e+00, float 1.168900e+00>
  %i.ke = insertelement <2 x float> %i.kd, float %i.jo, i64 1
  %23 = select <2 x i1> %19, <2 x float> %i.ke, <2 x float> %22 ; 3 uses
  %24 = extractelement <2 x float> %23, i64 1     ; 2 uses
  %25 = call float @llvm.fmuladd.f32(float %.pre256.pre, float %.0, float %24)
  ...
  %27 = call float @llvm.fmuladd.f32(float %.pre258.pre, float %.0, float %24)
