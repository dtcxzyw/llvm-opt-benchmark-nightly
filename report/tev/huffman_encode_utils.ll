...
bb.d:                                             ; preds = %.lr.ph46
  store i8 17, ptr %.02232.i44, align 1, !tbaa !31
...
bb.e:                                             ; preds = %.lr.ph46
  ...
  store i8 18, ptr %.02232.i44, align 1, !tbaa !31
...
bb.h:                                             ; preds = %bb.g
  store i8 %i.h, ptr %.03049, align 1, !tbaa !31
...
.lr.ph:                                           ; preds = %.lr.ph.preheader119, %.lr.ph.i34
  ...
  store i8 16, ptr %.12734.i42, align 1, !tbaa !31
...
vector.body62:                                    ; preds = %vector.body62, %vector.ph60
  ...
  %wide.load65 = load <4 x i32>, ptr %i.cx, align 4, !tbaa !54
  ...
  br i1 %i.dg, label %middle.block67, label %vector.body62, !llvm.loop !39
...
.lr.ph.i13:                                       ; preds = %.lr.ph.i13.preheader, %.lr.ph.i13
  ...
  br i1 %exitcond.not.i16, label %._crit_edge.i17, label %.lr.ph.i13, !llvm.loop !40
...
vector.body111:                                   ; preds = %vector.body111, %vector.ph107
  ...
  br i1 %i.em, label %middle.block118, label %vector.body111, !llvm.loop !42
...
vector.body93:                                    ; preds = %vector.body93, %vector.ph89
  ...
  br i1 %i.gp, label %middle.block100, label %vector.body93, !llvm.loop !46
...
vector.body76:                                    ; preds = %vector.body76, %vector.ph72
  ...
  br i1 %i.hn, label %middle.block83, label %vector.body76, !llvm.loop !48
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.i.i.preheader.new
  ...
  br i1 %niter150.ncmp.1.not, label %ReverseBits.exit.i.loopexit.unr-lcssa, label %.lr.ph.i.i, !llvm.loop !52
