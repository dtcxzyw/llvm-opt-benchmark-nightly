Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/tev/original/tcd?download=true
...
.lr.ph.i.split.us:                                ; preds = %.lr.ph.i, %bb.f
  ...
  %i.o = load i32, ptr %i.n, align 8, !tbaa !95   ; 2 uses
  %i.p = lshr i32 %i.o, 3
  %i.q = and i32 %i.o, 7
  ...
  %i.ac = load i32, ptr %i.ab, align 8, !tbaa !117
  %i.ad = sub i32 %i.aa, %i.ac                    ; 2 uses
  %i.ae = getelementptr inbounds i8, ptr %i.y, i64 -4
  %i.af = load i32, ptr %i.ae, align 4, !tbaa !86 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %exitcond.not.i.us, label %opj_tcd_get_decoded_tile_size.exit, label %.lr.ph.i.split.us, !llvm.loop !0
...
.lr.ph.i.split:                                   ; preds = %.lr.ph.i, %bb.k
  ...
  %i.ba = load i32, ptr %i.az, align 8, !tbaa !80
  ...
  %i.bf = load i32, ptr %i.be, align 8, !tbaa !84
  %i.bg = load i32, ptr %i.bd, align 8, !tbaa !82
  %i.bh = sub nsw i32 %i.bf, %i.bg                ; 2 uses
  %i.bi = getelementptr inbounds i8, ptr %i.bc, i64 -180
  %i.bj = load i32, ptr %i.bi, align 4, !tbaa !86 ; 2 uses
  %i.bk = getelementptr inbounds i8, ptr %i.bc, i64 -188
  %i.bl = load i32, ptr %i.bk, align 4, !tbaa !86 ; 2 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  br i1 %exitcond.not.i, label %opj_tcd_get_decoded_tile_size.exit, label %.lr.ph.i.split, !llvm.loop !0
...
bb.l:                                             ; preds = %.lr.ph210, %.loopexit
  ...
  %.0123208 = phi ptr [ %i.cd, %.lr.ph210 ], [ %i.np, %.loopexit ] ; 4 uses
  %.0124207 = phi ptr [ %i.by, %.lr.ph210 ], [ %i.no, %.loopexit ] ; 5 uses
  %.0134206 = phi i32 [ 0, %.lr.ph210 ], [ %i.nq, %.loopexit ]
  %i.cf = getelementptr inbounds nuw i8, ptr %.0124207, i64 24
  %i.cg = load i32, ptr %i.cf, align 8, !tbaa !95 ; 2 uses
  ...
  %i.cp = load i32, ptr %i.ce, align 8, !tbaa !115
  %.not = icmp eq i32 %i.cp, 0
  br i1 %.not, label %bb.n, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.cq = getelementptr inbounds nuw i8, ptr %i.co, i64 8
  %i.cr = load <2 x i32>, ptr %i.cq, align 8, !tbaa !86
  %i.cs = load <2 x i32>, ptr %i.co, align 8, !tbaa !86
  %i.ct = sub nsw <2 x i32> %i.cr, %i.cs          ; 2 uses
  %i.cu = getelementptr inbounds nuw i8, ptr %.0123208, i64 24
  %i.cv = load i32, ptr %i.cu, align 8, !tbaa !80
  %i.cw = add i32 %i.cv, -1
  %i.cx = zext i32 %i.cw to i64
  %i.cy = getelementptr inbounds nuw [192 x i8], ptr %i.ck, i64 %i.cx ; 2 uses
  %i.cz = getelementptr inbounds nuw i8, ptr %i.cy, i64 8
  %i.da = load i32, ptr %i.cz, align 8, !tbaa !84
  %i.db = load i32, ptr %i.cy, align 8, !tbaa !82
...
bb.n:                                             ; preds = %bb.l
  ...
  %i.dh = load <2 x i32>, ptr %i.df, align 8, !tbaa !86
  %i.di = load <2 x i32>, ptr %i.dg, align 8, !tbaa !86
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  %i.dm = getelementptr inbounds nuw i8, ptr %.0123208, i64 %.sink
...
.lr.ph:                                           ; preds = %.preheader153
  %i.dp = zext i32 %i.dl to i64                   ; 6 uses
  %i.dq = shl nuw nsw i64 %i.dp, 2                ; 5 uses
  %i.dr = add i32 %i.dl, %.0121
  %i.ds = zext i32 %i.dr to i64                   ; 5 uses
  %xtraiter = and i32 %i.do, 3                    ; 3 uses
  %i.dt = icmp ult i32 %i.do, 4
  br i1 %i.dt, label %.epil.preheader, label %.lr.ph.new

.lr.ph.new:                                       ; preds = %.lr.ph
  %unroll_iter = and i32 %i.do, -4
  br label %bb.r

bb.p:                                             ; preds = %bb.o
  %i.du = getelementptr inbounds nuw i8, ptr %.0124207, i64 32
  %i.dv = load i32, ptr %i.du, align 8, !tbaa !127
  %.not138 = icmp eq i32 %i.dv, 0
  %i.dw = extractelement <2 x i32> %i.dk, i64 1   ; 3 uses
  %.not219 = icmp eq i32 %i.dw, 0                 ; 2 uses
...
.preheader143.us.preheader:                       ; preds = %.preheader143.lr.ph
  ...
  %i.eb = zext i32 %i.dl to i64                   ; 2 uses
  %min.iters.check314 = icmp ult i32 %i.dl, 8
  %n.vec316 = and i64 %i.eb, 4294967288           ; 5 uses
  %i.ec = shl nuw nsw i64 %n.vec316, 2
  %i.ed = trunc nuw i64 %n.vec316 to i32
  %cmp.n325 = icmp eq i64 %n.vec316, %i.eb
  br label %.preheader143.us

.preheader143.us:                                 ; preds = %.preheader143.us.preheader, %._crit_edge.us192
  %.0109190.us = phi ptr [ %i.gb, %._crit_edge.us192 ], [ %.0118, %.preheader143.us.preheader ] ; 6 uses
  %.0113189.us = phi ptr [ %.lcssa292, %._crit_edge.us192 ], [ %.0102209, %.preheader143.us.preheader ] ; 6 uses
  %.0129188.us = phi i32 [ %i.gc, %._crit_edge.us192 ], [ 0, %.preheader143.us.preheader ]
  br i1 %min.iters.check314, label %scalar.ph313.preheader, label %vector.memcheck305

vector.memcheck305:                               ; preds = %.preheader143.us
  %scevgep306 = getelementptr i8, ptr %.0113189.us, i64 1
  %scevgep307 = getelementptr i8, ptr %scevgep306, i64 %i.dz
  %scevgep308 = getelementptr i8, ptr %.0109190.us, i64 4
  %scevgep309 = getelementptr i8, ptr %scevgep308, i64 %i.ea
  %bound0310 = icmp ult ptr %.0113189.us, %scevgep309
  %bound1311 = icmp ult ptr %.0109190.us, %scevgep307
...
vector.ph315:                                     ; preds = %vector.memcheck305
  %i.ee = getelementptr i8, ptr %.0109190.us, i64 %i.ec ; 2 uses
  %i.ef = getelementptr i8, ptr %.0113189.us, i64 %n.vec316 ; 2 uses
...
vector.body317:                                   ; preds = %vector.body317, %vector.ph315
  ...
  %i.eg = shl i64 %index318, 2
  %next.gep319 = getelementptr i8, ptr %.0109190.us, i64 %i.eg ; 2 uses
  %next.gep320 = getelementptr i8, ptr %.0113189.us, i64 %index318 ; 2 uses
  %i.eh = getelementptr i8, ptr %next.gep319, i64 16
  %wide.load321 = load <4 x i32>, ptr %next.gep319, align 4, !tbaa !86, !alias.scope !312
  %wide.load322 = load <4 x i32>, ptr %i.eh, align 4, !tbaa !86, !alias.scope !312
  %i.ei = trunc <4 x i32> %wide.load321 to <4 x i8>
  %i.ej = trunc <4 x i32> %wide.load322 to <4 x i8>
  %i.ek = getelementptr i8, ptr %next.gep320, i64 4
  store <4 x i8> %i.ei, ptr %next.gep320, align 1, !tbaa !35, !alias.scope !313, !noalias !312
  store <4 x i8> %i.ej, ptr %i.ek, align 1, !tbaa !35, !alias.scope !313, !noalias !312
  %index.next323 = add nuw i64 %index318, 8       ; 2 uses
  %i.el = icmp eq i64 %index.next323, %n.vec316
  br i1 %i.el, label %middle.block324, label %vector.body317, !llvm.loop !284
...
scalar.ph313.preheader:                           ; preds = %vector.memcheck305, %.preheader143.us, %middle.block324
  %.1110184.us.ph = phi ptr [ %.0109190.us, %vector.memcheck305 ], [ %.0109190.us, %.preheader143.us ], [ %i.ee, %middle.block324 ] ; 2 uses
  %.1114183.us.ph = phi ptr [ %.0113189.us, %vector.memcheck305 ], [ %.0113189.us, %.preheader143.us ], [ %i.ef, %middle.block324 ] ; 2 uses
  %.0125182.us.ph = phi i32 [ 0, %vector.memcheck305 ], [ 0, %.preheader143.us ], [ %i.ed, %middle.block324 ] ; 4 uses
  %i.em = sub i32 %i.dl, %.0125182.us.ph
  %xtraiter401 = and i32 %i.em, 7                 ; 2 uses
...
scalar.ph313.prol:                                ; preds = %scalar.ph313.preheader, %scalar.ph313.prol
  %.1110184.us.prol = phi ptr [ %i.en, %scalar.ph313.prol ], [ %.1110184.us.ph, %scalar.ph313.preheader ] ; 2 uses
  %.1114183.us.prol = phi ptr [ %i.eq, %scalar.ph313.prol ], [ %.1114183.us.ph, %scalar.ph313.preheader ] ; 2 uses
  %.0125182.us.prol = phi i32 [ %i.er, %scalar.ph313.prol ], [ %.0125182.us.ph, %scalar.ph313.preheader ]
  %prol.iter403 = phi i32 [ %prol.iter403.next, %scalar.ph313.prol ], [ 0, %scalar.ph313.preheader ]
  %i.en = getelementptr inbounds nuw i8, ptr %.1110184.us.prol, i64 4 ; 3 uses
  %i.eo = load i32, ptr %.1110184.us.prol, align 4, !tbaa !86
  %i.ep = trunc i32 %i.eo to i8
  %i.eq = getelementptr inbounds nuw i8, ptr %.1114183.us.prol, i64 1 ; 3 uses
  store i8 %i.ep, ptr %.1114183.us.prol, align 1, !tbaa !35
  %i.er = add nuw i32 %.0125182.us.prol, 1        ; 2 uses
  %prol.iter403.next = add i32 %prol.iter403, 1   ; 2 uses
  %prol.iter403.cmp.not = icmp eq i32 %prol.iter403.next, %xtraiter401
  br i1 %prol.iter403.cmp.not, label %scalar.ph313.prol.loopexit, label %scalar.ph313.prol, !llvm.loop !285

scalar.ph313.prol.loopexit:                       ; preds = %scalar.ph313.prol, %scalar.ph313.preheader
  %.lcssa386.unr = phi ptr [ poison, %scalar.ph313.preheader ], [ %i.en, %scalar.ph313.prol ]
  %.lcssa385.unr = phi ptr [ poison, %scalar.ph313.preheader ], [ %i.eq, %scalar.ph313.prol ]
  %.1110184.us.unr = phi ptr [ %.1110184.us.ph, %scalar.ph313.preheader ], [ %i.en, %scalar.ph313.prol ]
  %.1114183.us.unr = phi ptr [ %.1114183.us.ph, %scalar.ph313.preheader ], [ %i.eq, %scalar.ph313.prol ]
  %.0125182.us.unr = phi i32 [ %.0125182.us.ph, %scalar.ph313.preheader ], [ %i.er, %scalar.ph313.prol ]
  %i.es = sub i32 %.0125182.us.ph, %i.dl
  %i.et = icmp ugt i32 %i.es, -8
  br i1 %i.et, label %._crit_edge.us192, label %scalar.ph313

scalar.ph313:                                     ; preds = %scalar.ph313.prol.loopexit, %scalar.ph313
  %.1110184.us = phi ptr [ %i.fw, %scalar.ph313 ], [ %.1110184.us.unr, %scalar.ph313.prol.loopexit ] ; 9 uses
  %.1114183.us = phi ptr [ %i.fz, %scalar.ph313 ], [ %.1114183.us.unr, %scalar.ph313.prol.loopexit ] ; 9 uses
  %.0125182.us = phi i32 [ %i.ga, %scalar.ph313 ], [ %.0125182.us.unr, %scalar.ph313.prol.loopexit ]
  %i.eu = getelementptr inbounds nuw i8, ptr %.1110184.us, i64 4
  %i.ev = load i32, ptr %.1110184.us, align 4, !tbaa !86
  %i.ew = trunc i32 %i.ev to i8
  %i.ex = getelementptr inbounds nuw i8, ptr %.1114183.us, i64 1
  store i8 %i.ew, ptr %.1114183.us, align 1, !tbaa !35
  %i.ey = getelementptr inbounds nuw i8, ptr %.1110184.us, i64 8
  %i.ez = load i32, ptr %i.eu, align 4, !tbaa !86
  %i.fa = trunc i32 %i.ez to i8
  %i.fb = getelementptr inbounds nuw i8, ptr %.1114183.us, i64 2
  store i8 %i.fa, ptr %i.ex, align 1, !tbaa !35
  %i.fc = getelementptr inbounds nuw i8, ptr %.1110184.us, i64 12
  %i.fd = load i32, ptr %i.ey, align 4, !tbaa !86
  %i.fe = trunc i32 %i.fd to i8
  %i.ff = getelementptr inbounds nuw i8, ptr %.1114183.us, i64 3
  store i8 %i.fe, ptr %i.fb, align 1, !tbaa !35
  %i.fg = getelementptr inbounds nuw i8, ptr %.1110184.us, i64 16
  %i.fh = load i32, ptr %i.fc, align 4, !tbaa !86
  %i.fi = trunc i32 %i.fh to i8
  %i.fj = getelementptr inbounds nuw i8, ptr %.1114183.us, i64 4
  store i8 %i.fi, ptr %i.ff, align 1, !tbaa !35
  %i.fk = getelementptr inbounds nuw i8, ptr %.1110184.us, i64 20
  %i.fl = load i32, ptr %i.fg, align 4, !tbaa !86
  %i.fm = trunc i32 %i.fl to i8
  %i.fn = getelementptr inbounds nuw i8, ptr %.1114183.us, i64 5
  store i8 %i.fm, ptr %i.fj, align 1, !tbaa !35
  %i.fo = getelementptr inbounds nuw i8, ptr %.1110184.us, i64 24
  %i.fp = load i32, ptr %i.fk, align 4, !tbaa !86
  %i.fq = trunc i32 %i.fp to i8
  %i.fr = getelementptr inbounds nuw i8, ptr %.1114183.us, i64 6
  store i8 %i.fq, ptr %i.fn, align 1, !tbaa !35
  %i.fs = getelementptr inbounds nuw i8, ptr %.1110184.us, i64 28
  %i.ft = load i32, ptr %i.fo, align 4, !tbaa !86
  %i.fu = trunc i32 %i.ft to i8
  %i.fv = getelementptr inbounds nuw i8, ptr %.1114183.us, i64 7
  store i8 %i.fu, ptr %i.fr, align 1, !tbaa !35
  %i.fw = getelementptr inbounds nuw i8, ptr %.1110184.us, i64 32 ; 2 uses
  %i.fx = load i32, ptr %i.fs, align 4, !tbaa !86
  %i.fy = trunc i32 %i.fx to i8
  %i.fz = getelementptr inbounds nuw i8, ptr %.1114183.us, i64 8 ; 2 uses
  store i8 %i.fy, ptr %i.fv, align 1, !tbaa !35
  %i.ga = add nuw i32 %.0125182.us, 8             ; 2 uses
  %exitcond246.not.7 = icmp eq i32 %i.ga, %i.dl
  br i1 %exitcond246.not.7, label %._crit_edge.us192, label %scalar.ph313, !llvm.loop !286

._crit_edge.us192:                                ; preds = %scalar.ph313.prol.loopexit, %scalar.ph313, %middle.block324
  %.lcssa293 = phi ptr [ %i.ee, %middle.block324 ], [ %.lcssa386.unr, %scalar.ph313.prol.loopexit ], [ %i.fw, %scalar.ph313 ]
  %.lcssa292 = phi ptr [ %i.ef, %middle.block324 ], [ %.lcssa385.unr, %scalar.ph313.prol.loopexit ], [ %i.fz, %scalar.ph313 ] ; 2 uses
  %i.gb = getelementptr inbounds nuw [4 x i8], ptr %.lcssa293, i64 %i.dx
  %i.gc = add nuw i32 %.0129188.us, 1             ; 2 uses
  %exitcond247.not = icmp eq i32 %i.gc, %i.dw
  br i1 %exitcond247.not, label %.loopexit, label %.preheader143.us, !llvm.loop !287
...
.preheader.us.preheader:                          ; preds = %.preheader.lr.ph
  ...
  %i.gh = zext i32 %i.dl to i64                   ; 2 uses
  %min.iters.check = icmp ult i32 %i.dl, 8
  %n.vec = and i64 %i.gh, 4294967288              ; 5 uses
  %i.gi = shl nuw nsw i64 %n.vec, 2
  %i.gj = trunc nuw i64 %n.vec to i32
  %cmp.n = icmp eq i64 %n.vec, %i.gh
  br label %.preheader.us

.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us204
  %.2111202.us = phi ptr [ %i.ih, %._crit_edge.us204 ], [ %.0118, %.preheader.us.preheader ] ; 6 uses
  %.2115201.us = phi ptr [ %.lcssa294, %._crit_edge.us204 ], [ %.0102209, %.preheader.us.preheader ] ; 6 uses
  %.1130200.us = phi i32 [ %i.ii, %._crit_edge.us204 ], [ 0, %.preheader.us.preheader ]
end_hunk_0
...
.epil.preheader:                                  ; preds = %.loopexit.loopexit380.unr-lcssa, %.lr.ph
  %.0158.epil.init = phi ptr [ %.0118, %.lr.ph ], [ %i.nl, %.loopexit.loopexit380.unr-lcssa ]
  %.0100157.epil.init = phi ptr [ %.0102209, %.lr.ph ], [ %i.nk, %.loopexit.loopexit380.unr-lcssa ]
  %lcmp.mod395 = icmp ne i32 %xtraiter, 0
  tail call void @llvm.assume(i1 %lcmp.mod395)
  br label %bb.s

bb.s:                                             ; preds = %bb.s, %.epil.preheader
  %.0158.epil = phi ptr [ %.0158.epil.init, %.epil.preheader ], [ %i.nn, %bb.s ] ; 2 uses
  %.0100157.epil = phi ptr [ %.0100157.epil.init, %.epil.preheader ], [ %i.nm, %bb.s ] ; 2 uses
  %epil.iter = phi i32 [ 0, %.epil.preheader ], [ %epil.iter.next, %bb.s ]
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 4 %.0100157.epil, ptr align 4 %.0158.epil, i64 %i.dq, i1 false)
  %i.nm = getelementptr inbounds nuw [4 x i8], ptr %.0100157.epil, i64 %i.dp ; 2 uses
  %i.nn = getelementptr inbounds nuw [4 x i8], ptr %.0158.epil, i64 %i.ds
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %.loopexit, label %bb.s, !llvm.loop !310
...
.loopexit:                                        ; preds = %.loopexit.loopexit380.unr-lcssa, %bb.s, %._crit_edge.us, %._crit_edge.us180, %._crit_edge.us192, %._crit_edge.us204, %.preheader144.lr.ph, %.preheader145.lr.ph, %.preheader.lr.ph, %.preheader143.lr.ph, %.preheader153, %.preheader151, %.preheader149, %.preheader147, %.preheader146, %bb.o
  ...
  %i.nr = load ptr, ptr %i.a, align 8, !tbaa !20
  %i.ns = getelementptr inbounds nuw i8, ptr %i.nr, i64 16
  %i.nt = load i32, ptr %i.ns, align 8, !tbaa !28
  %i.nu = icmp ult i32 %i.nq, %i.nt
  br i1 %i.nu, label %bb.l, label %opj_tcd_get_decoded_tile_size.exit.thread, !llvm.loop !311
...
define dso_local i64 @opj_tcd_get_encoder_input_buffer_size(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #6 {
bb.a:
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.m = load i32, ptr %i.l, align 8, !tbaa !95   ; 2 uses
  %i.n = lshr i32 %i.m, 3
  %i.o = and i32 %i.m, 7
...
define dso_local range(i32 0, 2) i32 @opj_tcd_copy_tile_data(ptr nofree noundef readonly captures(none) %0, ptr nofree noundef readonly captures(none) %1, i64 noundef %2) local_unnamed_addr #7 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 32
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %.lr.ph.preheader.i
  ...
  %i.t = load i32, ptr %i.s, align 8, !tbaa !77
  %i.u = load i32, ptr %.01825.i, align 8, !tbaa !74
  %i.v = sub nsw i32 %i.t, %i.u
  %i.w = sext i32 %i.v to i64
...
vector.body171:                                   ; preds = %vector.body171, %vector.ph169
  ...
  %wide.load175 = load <4 x i8>, ptr %next.gep174, align 1, !tbaa !35, !alias.scope !340
  %wide.load176 = load <4 x i8>, ptr %i.br, align 1, !tbaa !35, !alias.scope !340
  ...
  store <4 x i32> %i.bs, ptr %next.gep173, align 4, !tbaa !86, !alias.scope !341, !noalias !340
  store <4 x i32> %i.bt, ptr %i.bu, align 4, !tbaa !86, !alias.scope !341, !noalias !340
  %index.next177 = add nuw i64 %index172, 8       ; 2 uses
  %i.bv = icmp eq i64 %index.next177, %n.vec170
  br i1 %i.bv, label %middle.block178, label %vector.body171, !llvm.loop !323
...
.lr.ph102.prol:                                   ; preds = %.lr.ph102.preheader235, %.lr.ph102.prol
  ...
  %i.bx = load i8, ptr %.062100.prol, align 1, !tbaa !35
  %i.by = sext i8 %i.bx to i32
  %i.bz = getelementptr inbounds nuw i8, ptr %.060101.prol, i64 4 ; 2 uses
  store i32 %i.by, ptr %.060101.prol, align 4, !tbaa !86
  ...
  br i1 %prol.iter250.cmp.not, label %.lr.ph102.prol.loopexit, label %.lr.ph102.prol, !llvm.loop !324
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i8>, ptr %next.gep157, align 1, !tbaa !35, !alias.scope !342
  %wide.load158 = load <4 x i8>, ptr %i.cj, align 1, !tbaa !35, !alias.scope !342
  %i.ck = zext <4 x i8> %wide.load to <4 x i32>
  %i.cl = zext <4 x i8> %wide.load158 to <4 x i32>
  %i.cm = getelementptr i8, ptr %next.gep, i64 16
  store <4 x i32> %i.ck, ptr %next.gep, align 4, !tbaa !86, !alias.scope !343, !noalias !342
  store <4 x i32> %i.cl, ptr %i.cm, align 4, !tbaa !86, !alias.scope !343, !noalias !342
...
.lr.ph107.prol:                                   ; preds = %.lr.ph107.preheader234, %.lr.ph107.prol
  ...
  %i.cp = load i8, ptr %.163105.prol, align 1, !tbaa !35
  %i.cq = zext i8 %i.cp to i32
  %i.cr = getelementptr inbounds nuw i8, ptr %.161106.prol, i64 4 ; 2 uses
  store i32 %i.cq, ptr %.161106.prol, align 4, !tbaa !86
...
bb.c:                                             ; preds = %.lr.ph113
  ...
  %i.fm = load i32, ptr %i.fl, align 8, !tbaa !127
...
vector.body203:                                   ; preds = %vector.body203, %vector.ph201
  ...
  %wide.load207 = load <4 x i16>, ptr %next.gep205, align 2, !tbaa !344
  %wide.load208 = load <4 x i16>, ptr %i.ft, align 2, !tbaa !344
  ...
  store <4 x i32> %i.fu, ptr %next.gep206, align 4, !tbaa !86
  store <4 x i32> %i.fv, ptr %i.fw, align 4, !tbaa !86
  %index.next209 = add nuw i64 %index204, 8       ; 2 uses
  %i.fx = icmp eq i64 %index.next209, %n.vec202
  br i1 %i.fx, label %middle.block210, label %vector.body203, !llvm.loop !332
...
.lr.ph92.preheader239:                            ; preds = %.lr.ph92.preheader, %middle.block210
  %.05791.ph = phi ptr [ %.073109, %.lr.ph92.preheader ], [ %i.fo, %middle.block210 ]
  %.05890.ph = phi ptr [ %i.fk, %.lr.ph92.preheader ], [ %i.fq, %middle.block210 ]
  %.27089.ph = phi i64 [ 0, %.lr.ph92.preheader ], [ %n.vec202, %middle.block210 ]
  br label %.lr.ph92
...
vector.ph185:                                     ; preds = %.lr.ph97.preheader
  ...
  %i.fz = getelementptr i8, ptr %.073109, i64 %i.fy ; 2 uses
...
vector.body187:                                   ; preds = %vector.body187, %vector.ph185
  ...
  %next.gep189 = getelementptr i8, ptr %.073109, i64 %i.gc ; 2 uses
  %i.gd = shl i64 %index188, 2
  %next.gep190 = getelementptr i8, ptr %i.fk, i64 %i.gd ; 2 uses
  %i.ge = getelementptr i8, ptr %next.gep189, i64 8
  %wide.load191 = load <4 x i16>, ptr %next.gep189, align 2, !tbaa !344
  %wide.load192 = load <4 x i16>, ptr %i.ge, align 2, !tbaa !344
  ...
  store <4 x i32> %i.gf, ptr %next.gep190, align 4, !tbaa !86
  store <4 x i32> %i.gg, ptr %i.gh, align 4, !tbaa !86
  %index.next193 = add nuw i64 %index188, 8       ; 2 uses
  %i.gi = icmp eq i64 %index.next193, %n.vec186
  br i1 %i.gi, label %middle.block194, label %vector.body187, !llvm.loop !333
...
.lr.ph97.preheader237:                            ; preds = %.lr.ph97.preheader, %middle.block194
  %.196.ph = phi ptr [ %.073109, %.lr.ph97.preheader ], [ %i.fz, %middle.block194 ]
...
.lr.ph92:                                         ; preds = %.lr.ph92.preheader239, %.lr.ph92
  ...
  %.27089 = phi i64 [ %i.gn, %.lr.ph92 ], [ %.27089.ph, %.lr.ph92.preheader239 ]
  %i.gj = getelementptr inbounds nuw i8, ptr %.05791, i64 2 ; 2 uses
  %i.gk = load i16, ptr %.05791, align 2, !tbaa !344
  %i.gl = sext i16 %i.gk to i32
  %i.gm = getelementptr inbounds nuw i8, ptr %.05890, i64 4
  store i32 %i.gl, ptr %.05890, align 4, !tbaa !86
  %i.gn = add nuw i64 %.27089, 1                  ; 2 uses
  %exitcond129.not = icmp eq i64 %i.gn, %i.bf
  br i1 %exitcond129.not, label %.loopexit, label %.lr.ph92, !llvm.loop !334
...
.lr.ph97:                                         ; preds = %.lr.ph97.preheader237, %.lr.ph97
  ...
  %i.gp = load i16, ptr %.196, align 2, !tbaa !344
  %i.gq = zext i16 %i.gp to i32
  %i.gr = getelementptr inbounds nuw i8, ptr %.15995, i64 4
  store i32 %i.gq, ptr %.15995, align 4, !tbaa !86
...
vector.ph219:                                     ; preds = %.lr.ph.preheader
  ...
  %i.gz = getelementptr i8, ptr %.073109, i64 %i.gx ; 2 uses
...
vector.body221:                                   ; preds = %vector.body221, %vector.ph219
  ...
  %next.gep224 = getelementptr i8, ptr %.073109, i64 %i.ha ; 2 uses
  %i.hb = getelementptr i8, ptr %next.gep224, i64 16
  %wide.load225 = load <4 x i32>, ptr %next.gep224, align 4, !tbaa !86
  %wide.load226 = load <4 x i32>, ptr %i.hb, align 4, !tbaa !86
  %i.hc = getelementptr i8, ptr %next.gep223, i64 16
  store <4 x i32> %wide.load225, ptr %next.gep223, align 4, !tbaa !86
  store <4 x i32> %wide.load226, ptr %i.hc, align 4, !tbaa !86
  %index.next227 = add nuw i64 %index222, 8       ; 2 uses
  %i.hd = icmp eq i64 %index.next227, %n.vec220
  br i1 %i.hd, label %middle.block228, label %vector.body221, !llvm.loop !336
...
.lr.ph.preheader241:                              ; preds = %.lr.ph.preheader, %middle.block228
  ...
  %.05687.ph = phi ptr [ %.073109, %.lr.ph.preheader ], [ %i.gz, %middle.block228 ] ; 2 uses
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader241, %.lr.ph.prol
  ...
  %i.hf = load i32, ptr %.05687.prol, align 4, !tbaa !86
  %i.hg = getelementptr inbounds nuw i8, ptr %.088.prol, i64 4 ; 2 uses
  store i32 %i.hf, ptr %.088.prol, align 4, !tbaa !86
  %i.hh = add nuw i64 %.486.prol, 1               ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol, !llvm.loop !337
...
.loopexit:                                        ; preds = %.lr.ph.prol.loopexit, %.lr.ph, %.lr.ph92, %.lr.ph97, %.lr.ph102.prol.loopexit, %.lr.ph102, %.lr.ph107.prol.loopexit, %.lr.ph107, %middle.block228, %middle.block210, %middle.block194, %middle.block178, %middle.block, %bb.d, %.preheader82, %.preheader80, %.preheader78, %.preheader, %.lr.ph113
  %.174 = phi ptr [ %.073109, %.lr.ph113 ], [ %i.fe, %.lr.ph107 ], [ %i.go, %.lr.ph97 ], [ %i.gj, %.lr.ph92 ], [ %i.dx, %.lr.ph102 ], [ %.073109, %.preheader ], [ %.073109, %.preheader78 ], [ %.073109, %.preheader80 ], [ %.073109, %.preheader82 ], [ %.073109, %bb.d ], [ %i.ch, %middle.block ], [ %i.bp, %middle.block178 ], [ %i.fz, %middle.block194 ], [ %i.fo, %middle.block210 ], [ %i.gz, %middle.block228 ], [ %.lcssa246.unr, %.lr.ph107.prol.loopexit ], [ %.lcssa245.unr, %.lr.ph102.prol.loopexit ], [ %.lcssa.unr, %.lr.ph.prol.loopexit ], [ %i.if, %.lr.ph ]
  %i.ij = getelementptr inbounds nuw i8, ptr %.067111, i64 64
  %i.ik = getelementptr inbounds nuw i8, ptr %.066112, i64 112
  %i.il = add nuw i32 %.071110, 1                 ; 2 uses
  %i.im = load i32, ptr %i.c, align 8, !tbaa !28
  %i.in = icmp ult i32 %i.il, %i.im
  br i1 %i.in, label %.lr.ph113, label %.loopexit85, !llvm.loop !339

.loopexit85:                                      ; preds = %.loopexit, %opj_tcd_get_encoder_input_buffer_size.exit, %opj_tcd_get_encoder_input_buffer_size.exit.thread
  %.072 = phi i32 [ 0, %opj_tcd_get_encoder_input_buffer_size.exit.thread ], [ %spec.select146, %opj_tcd_get_encoder_input_buffer_size.exit ], [ 1, %.loopexit ]
  ret i32 %.072
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local range(i32 0, 2) i32 @opj_tcd_is_band_empty(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #8 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.b = load i32, ptr %i.a, align 8, !tbaa !92
  %i.c = load i32, ptr %0, align 8, !tbaa !90
  %i.d = icmp eq i32 %i.b, %i.c
  br i1 %i.d, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 12
  %i.f = load i32, ptr %i.e, align 4, !tbaa !93
...
define dso_local range(i32 0, 2) i32 @opj_tcd_is_subband_area_of_interest(ptr nofree noundef readonly captures(none) %0, i32 noundef %1, i32 noundef %2, i32 noundef %3, i32 noundef %4, i32 noundef %5, i32 noundef %6, i32 noundef %7) local_unnamed_addr #9 {
bb.a:
  ...
  %i.t = load i32, ptr %i.n, align 8, !tbaa !74
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 72
  %i.v = load i32, ptr %i.u, align 8, !tbaa !139
  %i.w = load i32, ptr %i.s, align 8, !tbaa !73
  ...
  %i.ah = load i32, ptr %i.ag, align 4, !tbaa !140
  ...
  %i.au = load i32, ptr %i.at, align 8, !tbaa !141
