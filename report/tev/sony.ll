...
bb.b:                                             ; preds = %bb.a
  %4 = load i16, ptr %i.b, align 8, !tbaa !86
  %.off = add i16 %4, -1
...
.thread:                                          ; preds = %bb.a, %bb.c
  ...
  br i1 %.not127.a, label %bb.k, label %5

5:                                                ; preds = %.thread
  %6 = load i16, ptr %i.b, align 8, !tbaa !86
...
bb.k:                                             ; preds = %bb.h, %_ZL9my_roundff.exit154, %5, %.thread
