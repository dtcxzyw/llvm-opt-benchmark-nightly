...
.lr.ph275:                                        ; preds = %.preheader
  %10 = trunc i64 %indvars.iv348 to i32
  %11 = add i32 %10, 35                           ; 2 uses
  %i.id = add nuw i32 %11, %invariant.op303
  %i.ie = sext i32 %i.id to i64
  %i.if = getelementptr inbounds [164 x i8], ptr %6, i64 %i.ie
  %i.ig = add nuw i32 %11, %invariant.op305
  %i.ih = sext i32 %i.ig to i64
  %i.ii = getelementptr inbounds [164 x i8], ptr %6, i64 %i.ih
  %12 = trunc i64 %indvars.iv348 to i32
  %13 = add i32 %12, 3                            ; 2 uses
  %i.ij = add nuw i32 %13, %invariant.op307
  %i.ik = sext i32 %i.ij to i64
  %i.il = getelementptr inbounds [164 x i8], ptr %6, i64 %i.ik
  %i.im = add nuw i32 %13, %invariant.op309
