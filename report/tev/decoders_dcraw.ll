...
.preheader79.preheader:                           ; preds = %bb.e, %bb.f
  ...
  %2 = shufflevector <8 x float> %i.gf, <8 x float> poison, <2 x i32> <i32 7, i32 poison>
  %3 = shufflevector <2 x float> %2, <2 x float> %i.he, <4 x i32> <i32 0, i32 3, i32 3, i32 3>
  %i.hv = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %3, <4 x float> %i.fr, <4 x float> %i.hu)
...
.preheader77:                                     ; preds = %.preheader79.preheader, %.preheader77
  ...
  %4 = shufflevector <8 x float> %i.ie, <8 x float> poison, <2 x i32> <i32 7, i32 poison>
  %5 = shufflevector <2 x float> %4, <2 x float> %i.iy, <4 x i32> <i32 0, i32 3, i32 3, i32 3>
  %i.jp = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %5, <4 x float> %i.fr, <4 x float> %i.jo)
