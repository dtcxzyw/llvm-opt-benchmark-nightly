...
begin_hunk_0_@jpeg_read_scanlines:bb.a
  store i32 %i.o, ptr %i.r, align 4, !tbaa !52
  %i.s = load ptr, ptr %0, align 8, !tbaa !49
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %i.x = load i32, ptr %i.w, align 4, !tbaa !57   ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  store i32 126, ptr %i.z, align 8, !tbaa !51
...
bb.i:                                             ; preds = %bb.h
  ...
  store i64 %i.ag, ptr %i.ah, align 8, !tbaa !45
  %i.ai = load ptr, ptr %i.ad, align 8, !tbaa !42
...
bb.k:                                             ; preds = %bb.j
  %i.ao = load ptr, ptr %0, align 8, !tbaa !49    ; 2 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %i.ao, i64 40
  store i32 16, ptr %i.ap, align 8, !tbaa !51
  ...
  store i32 %i.ar, ptr %i.as, align 4, !tbaa !52
  %i.at = load ptr, ptr %0, align 8, !tbaa !49
  %i.au = load ptr, ptr %i.at, align 8, !tbaa !53
  tail call void %i.au(ptr noundef nonnull %0) #5
  %.pre = load ptr, ptr %i.aj, align 8, !tbaa !59
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %i.aw = load i32, ptr %i.a, align 4, !tbaa !67  ; 2 uses
...
bb.a:
  ...
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !59   ; 9 uses
  ...
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !54   ; 5 uses
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 632 ; 3 uses
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !74   ; 6 uses
...
bb.b:                                             ; preds = %bb.a
  %i.o = load ptr, ptr %0, align 8, !tbaa !49     ; 2 uses
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 40
  store i32 16, ptr %i.p, align 8, !tbaa !51
  %i.q = getelementptr inbounds nuw i8, ptr %i.o, i64 44
  store i32 %i.n, ptr %i.q, align 4, !tbaa !52
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.v = load i32, ptr %i.u, align 4, !tbaa !66
  %.not173 = icmp eq i32 %i.v, 0
  br i1 %.not173, label %bb.e, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.w = load ptr, ptr %0, align 8, !tbaa !49     ; 2 uses
  %i.x = getelementptr inbounds nuw i8, ptr %i.w, i64 40
  store i32 48, ptr %i.x, align 8, !tbaa !51
  %i.y = load ptr, ptr %i.w, align 8, !tbaa !53
...
bb.g:                                             ; preds = %bb.f
  %i.ad = load ptr, ptr %0, align 8, !tbaa !49    ; 2 uses
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 40
  store i32 48, ptr %i.ae, align 8, !tbaa !51
  %i.af = load ptr, ptr %i.ad, align 8, !tbaa !53
...
bb.i:                                             ; preds = %bb.h
  %i.ai = load ptr, ptr %0, align 8, !tbaa !49    ; 2 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 40
  store i32 21, ptr %i.aj, align 8, !tbaa !51
  %i.ak = getelementptr inbounds nuw i8, ptr %i.ai, i64 44
  store i32 %i.ah, ptr %i.ak, align 4, !tbaa !52
...
bb.j:                                             ; preds = %bb.i, %bb.h
  ...
  %i.at = load i32, ptr %i.as, align 4, !tbaa !57 ; 5 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.ba = load ptr, ptr %i.aw, align 8, !tbaa !36
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ba, i64 36
  store i32 1, ptr %i.bb, align 4, !tbaa !82
  br label %bb.bs
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.be = load i32, ptr %i.bd, align 8, !tbaa !70 ; 4 uses
  %i.bf = getelementptr inbounds nuw i8, ptr %0, i64 412
  %i.bg = load i32, ptr %i.bf, align 4, !tbaa !73 ; 5 uses
  ...
  %i.bm = load ptr, ptr %i.k, align 8, !tbaa !74  ; 3 uses
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bm, i64 64
  %i.bo = load i32, ptr %i.bn, align 8, !tbaa !119 ; 2 uses
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.br = load i32, ptr %i.bq, align 8, !tbaa !120 ; 2 uses
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.ca = load ptr, ptr %i.bz, align 8, !tbaa !87 ; 2 uses
  %.not33.i = icmp eq ptr %i.ca, null
  br i1 %.not33.i, label %bb.u, label %bb.t

bb.t:                                             ; preds = %bb.s
  store ptr @noop_convert, ptr %i.bz, align 8, !tbaa !87
  br label %bb.u
...
bb.y:                                             ; preds = %bb.x, %bb.w, %bb.v, %bb.u
  ...
  %i.ch = load i32, ptr %i.cg, align 4, !tbaa !72
...
bb.z:                                             ; preds = %._crit_edge.i
  %i.cm = load ptr, ptr %i.bv, align 8, !tbaa !85
  %i.cn = getelementptr inbounds nuw i8, ptr %i.cm, i64 8
  store ptr %.026.i, ptr %i.cn, align 8, !tbaa !87
  br label %bb.aa
...
bb.ab:                                            ; preds = %bb.aa
  ...
  store ptr %.025.i, ptr %i.cq, align 8, !tbaa !90
...
bb.ae:                                            ; preds = %.critedge, %bb.ad
  ...
  %i.cx = load i32, ptr %i.cw, align 4, !tbaa !121 ; 2 uses
...
bb.ag:                                            ; preds = %bb.af, %bb.ae
  ...
  %i.dc = load i32, ptr %i.db, align 8, !tbaa !69 ; 2 uses
...
.lr.ph49.i:                                       ; preds = %bb.ag
  ...
  %i.df = load ptr, ptr %i.de, align 8, !tbaa !76
  %i.dg = load ptr, ptr %i.e, align 8, !tbaa !59  ; 2 uses
  %i.dh = getelementptr inbounds nuw i8, ptr %i.dg, i64 120
  %i.di = load ptr, ptr %i.dh, align 8, !tbaa !124
  %i.dj = getelementptr inbounds nuw i8, ptr %i.dg, i64 128
  %i.dk = load ptr, ptr %i.dj, align 8, !tbaa !124
...
bb.ah:                                            ; preds = %._crit_edge.i193, %.lr.ph49.i
  ...
  %i.do = load i32, ptr %i.dn, align 4, !tbaa !125
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  store ptr %i.go, ptr %i.gp, align 8, !tbaa !84
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i195 = icmp eq i64 %indvars.iv.next.i, %i.ed
  br i1 %exitcond.not.i195, label %._crit_edge.i193, label %scalar.ph, !llvm.loop !112
...
bb.ai:                                            ; preds = %set_wraparound_pointers.exit
  ...
  store i32 %i.bg, ptr %i.gw, align 8, !tbaa !131
  %i.gx = sub i32 %i.at, %i.cv
  %i.gy = getelementptr inbounds nuw i8, ptr %i.l, i64 236
  store i32 %i.gx, ptr %i.gy, align 4, !tbaa !132
  br label %bb.an
...
bb.ap:                                            ; preds = %bb.ao, %.thread
  ...
  %i.if = load i32, ptr %i.ie, align 8, !tbaa !133
  %i.ig = add i32 %i.if, %i.id
  store i32 %i.ig, ptr %i.ie, align 8, !tbaa !133
  br i1 %.not178, label %bb.bc, label %bb.aq

bb.aq:                                            ; preds = %bb.ap
  %i.ih = getelementptr inbounds nuw i8, ptr %i.f, i64 148 ; 2 uses
  %i.ii = load i32, ptr %i.ih, align 4, !tbaa !121
  %i.ij = add i32 %i.ii, %i.id
  store i32 %i.ij, ptr %i.ih, align 4, !tbaa !121
  %i.ik = load ptr, ptr %i.i, align 8, !tbaa !54  ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #5
  store i8 0, ptr %i.a, align 1
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #5
  store ptr %i.a, ptr %i.b, align 8, !tbaa !84
...
bb.ar:                                            ; preds = %bb.aq
  ...
  %i.io = load i32, ptr %i.in, align 4, !tbaa !72
...
bb.as:                                            ; preds = %bb.ar
  ...
  %i.iq = load ptr, ptr %i.ip, align 8, !tbaa !87 ; 2 uses
  %.not33.i213 = icmp eq ptr %i.iq, null
  br i1 %.not33.i213, label %bb.au, label %bb.at

bb.at:                                            ; preds = %bb.as
  store ptr @noop_convert, ptr %i.ip, align 8, !tbaa !87
  br label %bb.au
...
bb.aw:                                            ; preds = %bb.av
  ...
  %i.iv = load ptr, ptr %i.iu, align 8, !tbaa !90 ; 2 uses
  %.not36.i202 = icmp eq ptr %i.iv, null
  br i1 %.not36.i202, label %bb.ay, label %bb.ax

bb.ax:                                            ; preds = %bb.aw
  store ptr @noop_quantize, ptr %i.iu, align 8, !tbaa !90
  br label %bb.ay
...
bb.ay:                                            ; preds = %bb.ax, %bb.aw, %bb.av, %bb.au
  ...
  %i.ix = load i32, ptr %i.iw, align 4, !tbaa !72
...
.lr.ph.i207:                                      ; preds = %bb.ay, %.lr.ph.i207
  ...
  br i1 %exitcond.not.i209, label %._crit_edge.i210, label %.lr.ph.i207, !llvm.loop !0
...
bb.az:                                            ; preds = %._crit_edge.i210
  %i.jc = load ptr, ptr %i.il, align 8, !tbaa !85
  %i.jd = getelementptr inbounds nuw i8, ptr %i.jc, i64 8
  store ptr %.026.i199, ptr %i.jd, align 8, !tbaa !87
  br label %bb.ba
...
bb.bb:                                            ; preds = %bb.ba
  ...
  store ptr %.025.i203, ptr %i.jg, align 8, !tbaa !90
...
.lr.ph:                                           ; preds = %.preheader, %bb.bg
  ...
  %i.js = load ptr, ptr %i.hw, align 8, !tbaa !138 ; 2 uses
  %i.jt = getelementptr inbounds nuw i8, ptr %i.js, i64 32
  %i.ju = load i32, ptr %i.jt, align 8, !tbaa !140
  %.not188 = icmp eq i32 %i.ju, 0
  br i1 %.not188, label %bb.bf, label %bb.bg

bb.bf:                                            ; preds = %.lr.ph
  %i.jv = load i32, ptr %i.hx, align 8, !tbaa !141
  %i.jw = load ptr, ptr %i.i, align 8, !tbaa !54
  %i.jx = getelementptr inbounds nuw i8, ptr %i.jw, i64 116
  store i32 %i.jv, ptr %i.jx, align 4, !tbaa !142
  br label %bb.bg
...
bb.bg:                                            ; preds = %bb.bf, %.lr.ph
  ...
  %i.kc = load i32, ptr %i.hv, align 8, !tbaa !137 ; 2 uses
  %i.kd = icmp ult i32 %i.kb, %i.kc
  br i1 %i.kd, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !114

._crit_edge.loopexit:                             ; preds = %bb.bg
  %.pre236 = load i32, ptr %i.hu, align 8, !tbaa !136
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader
  ...
  br i1 %i.kh, label %.preheader, label %._crit_edge229, !llvm.loop !115

._crit_edge229:                                   ; preds = %._crit_edge, %.preheader.lr.ph, %.preheader225
  %i.ki = load i32, ptr %i.hx, align 8, !tbaa !141
  %i.kj = add i32 %i.ki, 1                        ; 3 uses
  store i32 %i.kj, ptr %i.hx, align 8, !tbaa !141
  %i.kk = load i32, ptr %i.hy, align 8, !tbaa !133
  %i.kl = add i32 %i.kk, 1
  store i32 %i.kl, ptr %i.hy, align 8, !tbaa !133
end_hunk_0
