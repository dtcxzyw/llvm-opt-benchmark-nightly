...
begin_hunk_0_@opj_j2k_write_poc_in_memory:bb.a
  ...
  %i.n = load i32, ptr %i.m, align 4, !tbaa !95   ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.aa = load i32, ptr %.0523, align 4, !tbaa !92
  ...
  %i.aj = load i32, ptr %i.ai, align 4, !tbaa !123
  ...
  %i.ap = load i32, ptr %i.ao, align 4, !tbaa !240
  ...
  %i.ar = load i32, ptr %i.af, align 4, !tbaa !122
  %i.as = load i32, ptr %i.y, align 8, !tbaa !86
  %i.at = tail call noundef i32 @llvm.smin.i32(i32 %i.ar, i32 %i.as)
  store i32 %i.at, ptr %i.af, align 4, !tbaa !122
  %i.au = load i32, ptr %i.ai, align 4, !tbaa !123
  %i.av = load i32, ptr %i.z, align 4, !tbaa !106
  %i.aw = tail call noundef i32 @llvm.smin.i32(i32 %i.au, i32 %i.av)
  store i32 %i.aw, ptr %i.ai, align 4, !tbaa !123
  %i.ax = load i32, ptr %i.al, align 4, !tbaa !93
  %i.ay = tail call noundef i32 @llvm.smin.i32(i32 %i.ax, i32 %i.l)
  store i32 %i.ay, ptr %i.al, align 4, !tbaa !93
...
._crit_edge:                                      ; preds = %bb.b, %bb.a
  %i.bb = add i32 %i.s, 4
  store i32 %i.bb, ptr %2, align 4, !tbaa !70
  ret void
}
...
bb.h:                                             ; preds = %bb.f, %bb.e
  ...
  %i.v = load i32, ptr %i.u, align 8, !tbaa !13   ; 2 uses
...
bb.j:                                             ; preds = %bb.h
  ...
  %i.aa = load i32, ptr %i.z, align 8, !tbaa !171
...
bb.l:                                             ; preds = %bb.j
  %i.ae = load i32, ptr %3, align 4, !tbaa !70
  %i.af = add i32 %i.ae, 2
  store i32 %i.af, ptr %3, align 4, !tbaa !70
  %i.ag = load i32, ptr %i.p, align 4, !tbaa !13
  %.not61 = icmp eq i32 %i.ag, 0
  br i1 %.not61, label %bb.t, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.ah = load i32, ptr %i.u, align 8, !tbaa !13
...
bb.o:                                             ; preds = %bb.m
  ...
  %i.ap = load i32, ptr %i.ao, align 4, !tbaa !503
...
bb.p:                                             ; preds = %._crit_edge13.i, %.lr.ph21.i
  ...
  %.05417.i = phi i16 [ 3, %.lr.ph21.i ], [ %i.bx, %._crit_edge13.i ] ; 3 uses
  %.05716.i = phi i8 [ 0, %.lr.ph21.i ], [ %.158.i, %._crit_edge13.i ] ; 3 uses
  %.06315.i = phi ptr [ %i.an, %.lr.ph21.i ], [ %i.bv, %._crit_edge13.i ] ; 5 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #21
  %i.av = load ptr, ptr %i.aq, align 8, !tbaa !504
  %i.aw = getelementptr inbounds nuw [4 x i8], ptr %i.av, i64 %indvars.iv33.i
  %i.ax = load i32, ptr %i.aw, align 4, !tbaa !70 ; 5 uses
  %i.ay = trunc i32 %i.ax to i8
  %i.az = and i8 %i.ay, 127
  store i8 %i.az, ptr %i.a, align 1, !tbaa !13
...
.lr.ph.i:                                         ; preds = %bb.p
  ...
  %i.bb = or i8 %i.ba, -128
  store i8 %i.bb, ptr %i.ar, align 1, !tbaa !13
...
.lr.ph.i.1:                                       ; preds = %.lr.ph.i
  ...
  %i.bd = or i8 %i.bc, -128
  store i8 %i.bd, ptr %i.as, align 1, !tbaa !13
...
.lr.ph.i.2:                                       ; preds = %.lr.ph.i.1
  ...
  %i.bf = or i8 %i.be, -128
  store i8 %i.bf, ptr %i.at, align 1, !tbaa !13
...
.lr.ph.i.3:                                       ; preds = %.lr.ph.i.2
  ...
  store i8 %i.bh, ptr %i.au, align 1, !tbaa !13
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.bk = getelementptr inbounds nuw i8, ptr %.06315.i, i64 2
  %i.bl = getelementptr inbounds nuw i8, ptr %.06315.i, i64 4
  %i.bm = add nuw i8 %.05716.i, 1                 ; 2 uses
  %i.bn = zext i8 %i.bm to i32
  tail call void @opj_write_bytes_LE(ptr noundef nonnull %i.bl, i32 noundef %i.bn, i32 noundef 1) #21
  %i.bo = getelementptr inbounds nuw i8, ptr %.06315.i, i64 5
  br label %.lr.ph12.preheader.i

.lr.ph12.preheader.i:                             ; preds = %bb.r, %._crit_edge.i
  %.164.i = phi ptr [ %i.bo, %bb.r ], [ %.06315.i, %._crit_edge.i ]
  %.158.i = phi i8 [ %i.bm, %bb.r ], [ %.05716.i, %._crit_edge.i ]
  %.155.i = phi i16 [ 3, %bb.r ], [ %.05417.i, %._crit_edge.i ]
  %.153.i = phi ptr [ %i.bk, %bb.r ], [ %.05218.i, %._crit_edge.i ] ; 2 uses
  %i.bp = zext nneg i8 %.050.lcssa.i to i64
  br label %.lr.ph12.i

.lr.ph12.i:                                       ; preds = %.lr.ph12.i, %.lr.ph12.preheader.i
  %indvars.iv30.i = phi i64 [ %i.bp, %.lr.ph12.preheader.i ], [ %indvars.iv.next31.i, %.lr.ph12.i ] ; 2 uses
  %.2659.i = phi ptr [ %.164.i, %.lr.ph12.preheader.i ], [ %i.bv, %.lr.ph12.i ] ; 2 uses
  %i.bq = add nuw nsw i64 %indvars.iv30.i, 4294967295
  %i.br = and i64 %i.bq, 4294967295
  %i.bs = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.br
  %i.bt = load i8, ptr %i.bs, align 1, !tbaa !13
  %i.bu = zext i8 %i.bt to i32
  tail call void @opj_write_bytes_LE(ptr noundef nonnull %.2659.i, i32 noundef %i.bu, i32 noundef 1) #21
  %i.bv = getelementptr inbounds nuw i8, ptr %.2659.i, i64 1 ; 3 uses
  %indvars.iv.next31.i = add nsw i64 %indvars.iv30.i, -1 ; 2 uses
  %i.bw = and i64 %indvars.iv.next31.i, 255
  %.not67.i = icmp eq i64 %i.bw, 0
  br i1 %.not67.i, label %._crit_edge13.i, label %.lr.ph12.i, !llvm.loop !497

._crit_edge13.i:                                  ; preds = %.lr.ph12.i
  %i.bx = add i16 %.155.i, %6                     ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #21
  %indvars.iv.next34.i = add nuw nsw i64 %indvars.iv33.i, 1 ; 2 uses
  %i.by = load i32, ptr %i.ao, align 4, !tbaa !503
  %i.bz = zext i32 %i.by to i64
  %i.ca = icmp samesign ult i64 %indvars.iv.next34.i, %i.bz
  br i1 %i.ca, label %bb.p, label %._crit_edge22.loopexit.i, !llvm.loop !498

._crit_edge22.loopexit.i:                         ; preds = %._crit_edge13.i
  %i.cb = zext i16 %i.bx to i32
  br label %.critedge

bb.s:                                             ; preds = %bb.q
  %i.cc = tail call i32 (ptr, i32, ptr, ...) @opj_event_msg(ptr noundef %5, i32 noundef 1, ptr noundef nonnull @.str.306) #21 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #21
...
.critedge:                                        ; preds = %._crit_edge22.loopexit.i, %bb.o
  %.063.lcssa.i = phi ptr [ %i.an, %bb.o ], [ %i.bv, %._crit_edge22.loopexit.i ]
  %.054.lcssa.i = phi i32 [ 3, %bb.o ], [ %i.cb, %._crit_edge22.loopexit.i ]
  %.052.lcssa.i = phi ptr [ %i.al, %bb.o ], [ %.153.i, %._crit_edge22.loopexit.i ]
  %i.cd = ptrtoint ptr %.063.lcssa.i to i64
  %i.ce = ptrtoint ptr %i.aj to i64
  ...
  %i.ch = and i64 %i.cf, 4294967295               ; 2 uses
  %i.ci = getelementptr inbounds nuw i8, ptr %2, i64 %i.ch
  %i.cj = load i32, ptr %3, align 4, !tbaa !70
  %i.ck = zext i32 %i.cj to i64
  tail call void @llvm.memmove.p0.p0.i64(ptr align 1 %i.ci, ptr align 1 %2, i64 %i.ck, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %2, ptr nonnull align 1 %i.aj, i64 %i.ch, i1 false)
  tail call void @opj_free(ptr noundef nonnull %i.aj) #21
  %i.cl = load i32, ptr %3, align 4, !tbaa !70
  %i.cm = add i32 %i.cl, %i.cg
  store i32 %i.cm, ptr %3, align 4, !tbaa !70
  br label %bb.t
...
.preheader:                                       ; preds = %opj_j2k_convert_progression_order.exit
  ...
  %i.n = load i8, ptr %i.m, align 8, !tbaa !13
  ...
  %i.t = load i8, ptr %.06.i, align 1, !tbaa !13  ; 2 uses
...
bb.h:                                             ; preds = %bb.z, %bb.t, %bb.n, %bb.g
  ...
  store i32 %.02326.lcssa.wide, ptr %i.aa, align 4, !tbaa !13
  br label %.loopexit
