...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bi = xor <4 x i32> %i.az, splat (i32 -1)
  %i.bj = xor <4 x i32> %i.bh, splat (i32 -1)
  %i.bk = and <4 x i32> %vec.phi, %i.bi           ; 2 uses
  %i.bl = and <4 x i32> %vec.phi37, %i.bj         ; 2 uses
