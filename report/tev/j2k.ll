...
.lr.ph12.i:                                       ; preds = %.lr.ph12.i, %.lr.ph12.preheader.i
  ...
  %.2659.i = phi ptr [ %.164.i, %.lr.ph12.preheader.i ], [ %i.bu, %.lr.ph12.i ] ; 2 uses
  %i.bq = getelementptr i8, ptr %i.a, i64 %indvars.iv30.i
  %i.br = getelementptr i8, ptr %i.bq, i64 -1
  %i.bs = load i8, ptr %i.br, align 1, !tbaa !13
  %i.bt = zext i8 %i.bs to i32
  tail call void @opj_write_bytes_LE(ptr noundef nonnull %.2659.i, i32 noundef %i.bt, i32 noundef 1) #21
  %i.bu = getelementptr inbounds nuw i8, ptr %.2659.i, i64 1 ; 3 uses
  %indvars.iv.next31.i = add nsw i64 %indvars.iv30.i, -1 ; 2 uses
  %i.bv = and i64 %indvars.iv.next31.i, 255
  %.not67.i = icmp eq i64 %i.bv, 0
...
._crit_edge13.i:                                  ; preds = %.lr.ph12.i
  ...
  %i.bz = icmp samesign ult i64 %indvars.iv.next34.i, %i.by
  br i1 %i.bz, label %bb.p, label %._crit_edge22.loopexit.i, !llvm.loop !498
...
bb.s:                                             ; preds = %bb.q
  %i.cb = tail call i32 (ptr, i32, ptr, ...) @opj_event_msg(ptr noundef %5, i32 noundef 1, ptr noundef nonnull @.str.306) #21 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #21
...
.critedge:                                        ; preds = %._crit_edge22.loopexit.i, %bb.o
  %.063.lcssa.i = phi ptr [ %i.an, %bb.o ], [ %i.bu, %._crit_edge22.loopexit.i ]
  %.054.lcssa.i = phi i32 [ 3, %bb.o ], [ %i.ca, %._crit_edge22.loopexit.i ]
  %.052.lcssa.i = phi ptr [ %i.al, %bb.o ], [ %.153.i, %._crit_edge22.loopexit.i ]
  %i.cc = ptrtoint ptr %.063.lcssa.i to i64
  %i.cd = ptrtoint ptr %i.aj to i64
  ...
  %i.cg = and i64 %i.ce, 4294967295               ; 2 uses
  %i.ch = getelementptr inbounds nuw i8, ptr %2, i64 %i.cg
  %i.ci = load i32, ptr %3, align 4, !tbaa !70
  %i.cj = zext i32 %i.ci to i64
  tail call void @llvm.memmove.p0.p0.i64(ptr align 1 %i.ch, ptr align 1 %2, i64 %i.cj, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %2, ptr nonnull align 1 %i.aj, i64 %i.cg, i1 false)
  tail call void @opj_free(ptr noundef nonnull %i.aj) #21
  %i.ck = load i32, ptr %3, align 4, !tbaa !70
  %i.cl = add i32 %i.ck, %i.cf
  store i32 %i.cl, ptr %3, align 4, !tbaa !70
  br label %bb.t
