...
bb.f:                                             ; preds = %.lr.ph132.split.us
  ...
  %i.by = load ptr, ptr %i.a, align 8, !tbaa !28  ; 2 uses
  %i.bz = getelementptr inbounds nuw i8, ptr %i.by, i64 32
  %i.ca = load ptr, ptr %i.bz, align 8, !tbaa !222
  %i.cb = getelementptr inbounds nuw i8, ptr %i.ca, i64 16
  %i.cc = load i32, ptr %i.cb, align 8, !tbaa !55
  %i.cd = zext i32 %i.cc to i64
  %i.ce = icmp samesign ult i64 %indvars.iv.next178, %i.cd
  br i1 %i.ce, label %.lr.ph132.split.us, label %._crit_edge, !llvm.loop !373

.lr.ph132.split:                                  ; preds = %.lr.ph132
  %wide.trip.count175 = zext i32 %i.br to i64     ; 2 uses
  %.pre = load ptr, ptr %i.av, align 8, !tbaa !193
  %.pre185 = load ptr, ptr %.pre, align 8, !tbaa !196
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %.pre185, i64 24
  %.pre186 = load ptr, ptr %.phi.trans.insert, align 8, !tbaa !224 ; 5 uses
  %.pre187 = load ptr, ptr %i.aw, align 8, !tbaa !222
  %.phi.trans.insert188 = getelementptr inbounds nuw i8, ptr %.pre187, i64 24
  %.pre189 = load ptr, ptr %.phi.trans.insert188, align 8, !tbaa !62 ; 5 uses
...
.loopexit:                                        ; preds = %opj_j2k_pre_write_tile.exit, %opj_j2k_pre_write_tile.exit.thread
  %.not83 = icmp eq ptr %.069137, null
  br i1 %.not83, label %.critedge, label %bb.g

bb.g:                                             ; preds = %.loopexit
  tail call void @opj_free(ptr noundef nonnull %.069137) #21
  br label %.critedge
...
bb.h:                                             ; preds = %bb.h, %.lr.ph132.split.new
  ...
  %i.cj = load ptr, ptr %i.ci, align 8, !tbaa !219
  %i.ck = getelementptr inbounds nuw i8, ptr %i.cg, i64 48
  store ptr %i.cj, ptr %i.ck, align 8, !tbaa !227
  %i.cl = getelementptr inbounds nuw i8, ptr %i.cg, i64 56
  store i32 0, ptr %i.cl, align 8, !tbaa !400
  ...
  store ptr %i.cp, ptr %i.cq, align 8, !tbaa !227
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cm, i64 56
  store i32 0, ptr %i.cr, align 8, !tbaa !400
  ...
  store ptr %i.cv, ptr %i.cw, align 8, !tbaa !227
  %i.cx = getelementptr inbounds nuw i8, ptr %i.cs, i64 56
  store i32 0, ptr %i.cx, align 8, !tbaa !400
  ...
  %i.db = load ptr, ptr %i.da, align 8, !tbaa !219
  %i.dc = getelementptr inbounds nuw i8, ptr %i.cy, i64 48
  store ptr %i.db, ptr %i.dc, align 8, !tbaa !227
  %i.dd = getelementptr inbounds nuw i8, ptr %i.cy, i64 56
  store i32 0, ptr %i.dd, align 8, !tbaa !400
  ...
  br i1 %niter368.ncmp.3, label %._crit_edge.thread.unr-lcssa, label %bb.h, !llvm.loop !373
...
bb.i:                                             ; preds = %bb.i, %.epil.preheader362
  ...
  store ptr %i.dh, ptr %i.di, align 8, !tbaa !227
  %i.dj = getelementptr inbounds nuw i8, ptr %i.de, i64 56
  store i32 0, ptr %i.dj, align 8, !tbaa !400
  ...
  br i1 %epil.iter364.cmp.not, label %._crit_edge.thread, label %bb.i, !llvm.loop !374
...
._crit_edge:                                      ; preds = %bb.f, %.preheader
  ...
  br i1 %.268202, label %bb.k, label %bb.s

bb.k:                                             ; preds = %._crit_edge
  %i.dn = icmp ugt i64 %i.dm, %.073136
  br i1 %i.dn, label %bb.l, label %bb.o

bb.l:                                             ; preds = %bb.k
  %i.do = tail call ptr @opj_realloc(ptr noundef %.069137, i64 noundef %i.dm) #21 ; 2 uses
  %.not85.not = icmp eq ptr %i.do, null
  br i1 %.not85.not, label %bb.m, label %.thread99

bb.m:                                             ; preds = %bb.l
  %.not86 = icmp eq ptr %.069137, null
...
bb.o:                                             ; preds = %bb.k
  %i.dq = icmp eq ptr %.069137, null
  br i1 %i.dq, label %.critedge, label %.thread99

.thread99:                                        ; preds = %bb.l, %bb.o
  %.271103 = phi ptr [ %.069137, %bb.o ], [ %i.do, %bb.l ] ; 4 uses
  %.275102 = phi i64 [ %.073136, %bb.o ], [ %i.dm, %bb.l ]
  %i.dr = load ptr, ptr %i.a, align 8, !tbaa !28  ; 3 uses
  %i.ds = getelementptr inbounds nuw i8, ptr %i.dr, i64 32 ; 2 uses
  %i.dt = load ptr, ptr %i.ds, align 8, !tbaa !222 ; 2 uses
  %i.du = getelementptr inbounds nuw i8, ptr %i.dt, i64 16
  %i.dv = load i32, ptr %i.du, align 8, !tbaa !55
...
opj_get_tile_dimensions.exit.i:                   ; preds = %.loopexit.i, %opj_get_tile_dimensions.exit.lr.ph.i
  ...
  %.081170.i = phi ptr [ %.271103, %opj_get_tile_dimensions.exit.lr.ph.i ], [ %.182.i, %.loopexit.i ] ; 16 uses
  %i.dy = load ptr, ptr %i.dw, align 8, !tbaa !193
  %i.dz = load ptr, ptr %i.dy, align 8, !tbaa !196
  %i.ea = getelementptr inbounds nuw i8, ptr %i.dz, i64 24
  %i.eb = load ptr, ptr %i.ea, align 8, !tbaa !224
  ...
  %i.eh = load i32, ptr %i.eg, align 8, !tbaa !66 ; 2 uses
  ...
  %i.en = load i32, ptr %i.em, align 8, !tbaa !401 ; 19 uses
  %i.eo = load i32, ptr %i.ec, align 8, !tbaa !402 ; 20 uses
  %i.ep = sub i32 %i.en, %i.eo                    ; 6 uses
  %i.eq = getelementptr inbounds nuw i8, ptr %i.ec, i64 12
  %i.er = load i32, ptr %i.eq, align 4, !tbaa !403 ; 4 uses
  %i.es = getelementptr inbounds nuw i8, ptr %i.ec, i64 4
  %i.et = load i32, ptr %i.es, align 4, !tbaa !404 ; 5 uses
  %i.eu = sub i32 %i.er, %i.et                    ; 5 uses
  %i.ev = load i32, ptr %i.dx, align 8, !tbaa !124 ; 2 uses
  %i.ew = load i32, ptr %i.ef, align 8, !tbaa !67
  ...
  %i.fe = load i32, ptr %i.fd, align 4, !tbaa !125
  %i.ff = getelementptr inbounds nuw i8, ptr %i.ef, i64 4
  %i.fg = load i32, ptr %i.ff, align 4, !tbaa !68
  ...
  %i.fo = load i32, ptr %i.fn, align 8, !tbaa !74
  ...
  %i.ga = load ptr, ptr %i.fz, align 8, !tbaa !219
...
.preheader108.us.i:                               ; preds = %.preheader108.us.i.preheader, %._crit_edge.us.i
  %.0124.us.i = phi ptr [ %.lcssa235, %._crit_edge.us.i ], [ %.081170.i, %.preheader108.us.i.preheader ] ; 4 uses
  %.8123.us.i = phi ptr [ %i.hz, %._crit_edge.us.i ], [ %i.gc, %.preheader108.us.i.preheader ] ; 4 uses
  %.479122.us.i = phi i32 [ %i.ia, %._crit_edge.us.i ], [ 0, %.preheader108.us.i.preheader ]
...
vector.body324:                                   ; preds = %vector.body324, %vector.ph322
  ...
  %wide.load328 = load <4 x i32>, ptr %next.gep327, align 4, !tbaa !70
  %wide.load329 = load <4 x i32>, ptr %i.gp, align 4, !tbaa !70
  %i.gq = getelementptr i8, ptr %next.gep326, i64 16
  store <4 x i32> %wide.load328, ptr %next.gep326, align 4, !tbaa !70
  store <4 x i32> %wide.load329, ptr %i.gq, align 4, !tbaa !70
  %index.next330 = add nuw i64 %index325, 8       ; 2 uses
  %i.gr = icmp eq i64 %index.next330, %n.vec323
  br i1 %i.gr, label %middle.block331, label %vector.body324, !llvm.loop !375
...
scalar.ph320.preheader:                           ; preds = %.preheader108.us.i, %middle.block331
  ...
  %.474118.us.i.ph = phi i32 [ 0, %.preheader108.us.i ], [ %i.gj, %middle.block331 ] ; 4 uses
  %i.gs = add i32 %i.eo, %.474118.us.i.ph
...
scalar.ph320.prol:                                ; preds = %scalar.ph320.preheader, %scalar.ph320.prol
  ...
  %.474118.us.i.prol = phi i32 [ %i.gx, %scalar.ph320.prol ], [ %.474118.us.i.ph, %scalar.ph320.preheader ]
  ...
  %i.gv = load i32, ptr %.9119.us.i.prol, align 4, !tbaa !70
  %i.gw = getelementptr inbounds nuw i8, ptr %.1120.us.i.prol, i64 4 ; 3 uses
  store i32 %i.gv, ptr %.1120.us.i.prol, align 4, !tbaa !70
  %i.gx = add nuw i32 %.474118.us.i.prol, 1       ; 2 uses
  %prol.iter.next = add i32 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter369
  br i1 %prol.iter.cmp.not, label %scalar.ph320.prol.loopexit, label %scalar.ph320.prol, !llvm.loop !376
...
scalar.ph320.prol.loopexit:                       ; preds = %scalar.ph320.prol, %scalar.ph320.preheader
  ...
  %.474118.us.i.unr = phi i32 [ %.474118.us.i.ph, %scalar.ph320.preheader ], [ %i.gx, %scalar.ph320.prol ]
  %i.gy = add i32 %i.gk, %.474118.us.i.ph
...
._crit_edge.us.i:                                 ; preds = %scalar.ph320.prol.loopexit, %scalar.ph320, %middle.block331
  ...
  %i.ia = add nuw i32 %.479122.us.i, 1            ; 2 uses
  %exitcond201.not.i = icmp eq i32 %i.ia, %i.eu
  br i1 %exitcond201.not.i, label %.loopexit.i, label %.preheader108.us.i, !llvm.loop !378
...
.preheader105.us.i:                               ; preds = %.preheader105.us.i.preheader, %._crit_edge.us156.i
  %.060154.us.i = phi ptr [ %.lcssa242, %._crit_edge.us156.i ], [ %.081170.i, %.preheader105.us.i.preheader ] ; 6 uses
  %.065153.us.i = phi ptr [ %i.kn, %._crit_edge.us156.i ], [ %i.gc, %.preheader105.us.i.preheader ] ; 6 uses
  %.075152.us.i = phi i32 [ %i.ko, %._crit_edge.us156.i ], [ 0, %.preheader105.us.i.preheader ]
...
vector.ph271:                                     ; preds = %vector.memcheck261
  ...
  %i.iq = getelementptr i8, ptr %.065153.us.i, i64 %i.im ; 2 uses
...
vector.body273:                                   ; preds = %vector.body273, %vector.ph271
  ...
  %next.gep276 = getelementptr i8, ptr %.065153.us.i, i64 %i.ir ; 2 uses
  %i.is = getelementptr i8, ptr %next.gep276, i64 16
  %wide.load277 = load <4 x i32>, ptr %next.gep276, align 4, !tbaa !70, !alias.scope !405
  %wide.load278 = load <4 x i32>, ptr %i.is, align 4, !tbaa !70, !alias.scope !405
