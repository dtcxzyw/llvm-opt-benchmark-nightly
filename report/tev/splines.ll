...
bb.d:                                             ; preds = %_ZN3jxl6N_SSE412_GLOBAL__N_111DrawSegmentIN3hwy6N_SSE44SimdIfLm1ELi0EEEEEvT_RKNS_13SplineSegmentEbmmmPrPf.exit.i, %.lr.ph48.i
  ...
  %10 = shufflevector <4 x float> %i.es, <4 x float> %i.ey, <2 x i32> <i32 0, i32 4>
  %11 = fcmp ole <4 x float> %i.ey, zeroinitializer
  %i.ez = tail call <2 x float> @llvm.fabs.v2f32(<2 x float> %10) ; 4 uses
  ...
  %i.fq = select <4 x i1> %11, <4 x i32> <i32 -2147483648, i32 poison, i32 poison, i32 poison>, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
