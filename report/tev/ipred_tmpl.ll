...
.lr.ph.us.preheader:                              ; preds = %.lr.ph115
  ...
  %scevgep160 = getelementptr i8, ptr %.192, i64 2
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %.loopexit.us
  ...
  %scevgep160.a = getelementptr i8, ptr %scevgep160, i64 %i.bp
...
vector.memcheck:                                  ; preds = %vector.scevcheck150
  ...
  %umax.sroa.sel = getelementptr i8, ptr %.192, i64 %i.cl
  %bound0 = icmp ult ptr %invariant.gep.us, %scevgep158
  %bound1 = icmp ult ptr %scevgep156, %scevgep155
  %found.conflict = and i1 %bound0, %bound1
  %bound0163 = icmp ult ptr %invariant.gep.us, %scevgep160.a
  %bound1164 = icmp ult ptr %umax.sroa.sel, %scevgep155
