...
.preheader.us.us:                                 ; preds = %.preheader.us.us.preheader, %._crit_edge.us.us
  ...
  %i.q = load i8, ptr %i.o, align 1, !tbaa !8     ; 2 uses
...
bb.b:                                             ; preds = %.preheader.us.us
  ...
  store i8 %i.x, ptr %i.p, align 1, !tbaa !8
  ...
  store i8 %i.ad, ptr %i.y, align 1, !tbaa !8
  ...
  store i8 %i.aj, ptr %i.ae, align 1, !tbaa !8
  br label %bb.c
...
bb.e:                                             ; preds = %bb.d
  ...
  store i8 %i.at, ptr %i.ao, align 1, !tbaa !8
  ...
  store i8 %i.az, ptr %i.au, align 1, !tbaa !8
  ...
  store i8 %i.bf, ptr %i.ba, align 1, !tbaa !8
  br label %bb.f
...
bb.h:                                             ; preds = %bb.g
  ...
  store i8 %i.bp, ptr %i.bk, align 1, !tbaa !8
  ...
  store i8 %i.cb, ptr %i.bw, align 1, !tbaa !8
...
._crit_edge.us.us:                                ; preds = %bb.g, %bb.h, %bb.f, %bb.c
  ...
  br i1 %i.ce, label %.preheader.us.us, label %._crit_edge116, !llvm.loop !18
...
bb.i:                                             ; preds = %.preheader.us, %bb.i
  ...
  %i.ch = load <16 x i8>, ptr %i.cg, align 1, !tbaa !8 ; 2 uses
  ...
  store <16 x i8> %i.cy, ptr %i.cg, align 1, !tbaa !8
...
bb.k:                                             ; preds = %bb.j
  ...
  store i8 %i.dv, ptr %i.dq, align 1, !tbaa !8
  br label %bb.l
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  br i1 %i.dx, label %bb.j, label %._crit_edge.us, !llvm.loop !20
...
._crit_edge.us:                                   ; preds = %bb.l, %..loopexit_crit_edge.us
  ...
  br i1 %i.ea, label %.preheader.us, label %._crit_edge116, !llvm.loop !18
...
.preheader102.us:                                 ; preds = %.preheader102.us.preheader, %._crit_edge.us121
  ...
  %i.eo = load i8, ptr %i.em, align 1, !tbaa !8   ; 2 uses
  %.not101.us120 = icmp eq i8 %i.eo, -1
...
bb.m:                                             ; preds = %.preheader102.us
  ...
  store i8 %i.fb, ptr %i.ew, align 1, !tbaa !8
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.fj = load i8, ptr %i.fi, align 1, !tbaa !8   ; 2 uses
  %.not101.us120.1 = icmp eq i8 %i.fj, -1
...
bb.p:                                             ; preds = %bb.o
  ...
  store i8 %i.fr, ptr %i.fm, align 1, !tbaa !8
  ...
  store i8 %i.fx, ptr %i.fs, align 1, !tbaa !8
  ...
  store i8 %i.gd, ptr %i.fy, align 1, !tbaa !8
  br label %bb.q
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.gf = load i8, ptr %i.ge, align 1, !tbaa !8   ; 2 uses
  %.not101.us120.2 = icmp eq i8 %i.gf, -1
...
bb.s:                                             ; preds = %bb.r
  ...
  store i8 %i.gn, ptr %i.gi, align 1, !tbaa !8
  ...
  store i8 %i.gt, ptr %i.go, align 1, !tbaa !8
  ...
  store i8 %i.gz, ptr %i.gu, align 1, !tbaa !8
...
._crit_edge.us121:                                ; preds = %bb.r, %bb.s, %bb.q, %bb.n
  ...
  br i1 %i.hc, label %.preheader102.us, label %._crit_edge116, !llvm.loop !18
...
bb.t:                                             ; preds = %.preheader102, %bb.t
  ...
  %i.hf = load <16 x i8>, ptr %i.he, align 1, !tbaa !8 ; 2 uses
  ...
  store <16 x i8> %i.hw, ptr %i.he, align 1, !tbaa !8
...
bb.u:                                             ; preds = %.lr.ph111, %bb.w
  ...
  %i.ib = load i8, ptr %i.ia, align 1, !tbaa !8   ; 2 uses
...
bb.v:                                             ; preds = %bb.u
  ...
  store i8 %i.iv, ptr %i.iq, align 1, !tbaa !8
  br label %bb.w
...
bb.w:                                             ; preds = %bb.v, %bb.u
  ...
  br i1 %i.ix, label %bb.u, label %._crit_edge, !llvm.loop !20
...
._crit_edge:                                      ; preds = %bb.w, %..loopexit103_crit_edge
  ...
  br i1 %i.ja, label %.preheader102, label %._crit_edge116, !llvm.loop !18
