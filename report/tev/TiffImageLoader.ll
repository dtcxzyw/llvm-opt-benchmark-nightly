...
.from.659:                                        ; preds = %bb.z
  ...
  %.sroa.11.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.j, i64 72 ; 5 uses
...
bb.ba:                                            ; preds = %_ZN4tlog5debugIJmRKN7nanogui6MatrixIfLm3EEEEEEvN3fmt3v127fstringIJDpT_EE1tEDpOS9_.exit
  ...
  %31 = load float, ptr %.sroa.10.0..sroa_idx.i, align 4, !tbaa !79, !noalias !1236
  %32 = load float, ptr %.sroa.11.0..sroa_idx.i, align 8, !tbaa !79, !noalias !1236 ; 2 uses
  ...
  %i.yk = shufflevector <2 x float> %33, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.yn = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ym, <2 x float> %35, <2 x float> %i.yl) ; 2 uses
  %i.yo = extractelement <2 x float> %i.yn, i64 1
  store float %i.yo, ptr %.sroa.12437.0..sroa_idx, align 8, !tbaa !80
  %36 = insertelement <2 x float> %i.vy, float %32, i64 1
  %37 = shufflevector <2 x float> %36, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 1>
  %i.yp = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.yf, <4 x float> %37, <4 x float> %i.yb)
