...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.ct = fcmp olt <4 x float> %i.cs, splat (float 1.125000e+00) ; 2 uses
  %.not.i = icmp ne <4 x i32> %i.ca, zeroinitializer
  ...
  %17 = select <4 x i1> %i.ct, <4 x i1> %.not.i, <4 x i1> zeroinitializer
  %18 = select <4 x i1> %17, <4 x i32> %i.cu, <4 x i32> zeroinitializer
  %19 = bitcast <4 x float> %i.cx to <4 x i32>
  %20 = select <4 x i1> %i.ct, <4 x i32> zeroinitializer, <4 x i32> %19
  %21 = or <4 x i32> %20, %18
  %22 = bitcast <4 x i32> %21 to <4 x float>
  %i.cy = fmul <4 x float> %i.bn, %22
  ...
  %i.dd = fcmp olt <4 x float> %i.dc, splat (float 1.125000e+00) ; 2 uses
  %.not76.i = icmp ne <4 x i32> %i.ch, zeroinitializer
  ...
  %23 = select <4 x i1> %i.dd, <4 x i1> %.not76.i, <4 x i1> zeroinitializer
  %24 = select <4 x i1> %23, <4 x i32> %i.de, <4 x i32> zeroinitializer
  %25 = bitcast <4 x float> %i.dh to <4 x i32>
  %26 = select <4 x i1> %i.dd, <4 x i32> zeroinitializer, <4 x i32> %25
  %27 = or <4 x i32> %24, %26
  %28 = bitcast <4 x i32> %27 to <4 x float>
  %i.di = fmul <4 x float> %i.bq, %28             ; 3 uses
  ...
  %i.dn = fcmp olt <4 x float> %i.dm, splat (float 1.125000e+00) ; 2 uses
  %.not77.i = icmp ne <4 x i32> %i.co, zeroinitializer
  ...
  %29 = select <4 x i1> %i.dn, <4 x i1> %.not77.i, <4 x i1> zeroinitializer
  %30 = select <4 x i1> %29, <4 x i32> %i.do, <4 x i32> zeroinitializer
  %31 = bitcast <4 x float> %i.dr to <4 x i32>
  %32 = select <4 x i1> %i.dn, <4 x i32> zeroinitializer, <4 x i32> %31
  %33 = or <4 x i32> %30, %32
  %34 = bitcast <4 x i32> %33 to <4 x float>
  %i.ds = fmul <4 x float> %i.bt, %34
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.ce = fcmp olt <4 x float> %i.cd, splat (float 1.125000e+00) ; 2 uses
  %.not.i = icmp ne <4 x i32> %i.bv, zeroinitializer
  ...
  %17 = select <4 x i1> %i.ce, <4 x i1> %.not.i, <4 x i1> zeroinitializer
  %18 = select <4 x i1> %17, <4 x i32> %i.cf, <4 x i32> zeroinitializer
  %19 = bitcast <4 x float> %i.ci to <4 x i32>
  %20 = select <4 x i1> %i.ce, <4 x i32> zeroinitializer, <4 x i32> %19
  %21 = or <4 x i32> %20, %18
  %22 = bitcast <4 x i32> %21 to <4 x float>
  %i.cj = fmul <4 x float> %i.bn, %22
  ...
  %i.co = fcmp olt <4 x float> %i.cn, splat (float 1.125000e+00) ; 2 uses
  %.not70.i = icmp ne <4 x i32> %i.bx, zeroinitializer
  ...
  %23 = select <4 x i1> %i.co, <4 x i1> %.not70.i, <4 x i1> zeroinitializer
  %24 = select <4 x i1> %23, <4 x i32> %i.cp, <4 x i32> zeroinitializer
  %25 = bitcast <4 x float> %i.cs to <4 x i32>
  %26 = select <4 x i1> %i.co, <4 x i32> zeroinitializer, <4 x i32> %25
  %27 = or <4 x i32> %24, %26
  %28 = bitcast <4 x i32> %27 to <4 x float>
  %i.ct = fmul <4 x float> %i.bq, %28             ; 3 uses
  ...
  %i.cy = fcmp olt <4 x float> %i.cx, splat (float 1.125000e+00) ; 2 uses
  %.not71.i = icmp ne <4 x i32> %i.bz, zeroinitializer
  ...
  %29 = select <4 x i1> %i.cy, <4 x i1> %.not71.i, <4 x i1> zeroinitializer
  %30 = select <4 x i1> %29, <4 x i32> %i.cz, <4 x i32> zeroinitializer
  %31 = bitcast <4 x float> %i.dc to <4 x i32>
  %32 = select <4 x i1> %i.cy, <4 x i32> zeroinitializer, <4 x i32> %31
  %33 = or <4 x i32> %30, %32
  %34 = bitcast <4 x i32> %33 to <4 x float>
  %i.dd = fmul <4 x float> %i.bt, %34
