...
bb.b:                                             ; preds = %bb.a
  ...
  %97 = load <2 x float>, ptr %i.b, align 4, !tbaa !256 ; 2 uses
  ...
  %i.h = shufflevector <2 x float> %97, <2 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  ...
  %98 = shufflevector <2 x float> %97, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1> ; 2 uses
  %i.l = fadd <4 x float> %i.k, %98
  %i.m = fsub <4 x float> %i.k, %98
...
bb.h:                                             ; preds = %bb.a
  ...
  %99 = load <2 x float>, ptr %i.uz, align 4, !tbaa !256 ; 2 uses
  %i.va = shufflevector <2 x float> %99, <2 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  ...
  %100 = shufflevector <2 x float> %99, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1> ; 2 uses
  %i.ve = fadd <4 x float> %i.vd, %100            ; 2 uses
  %i.vf = fsub <4 x float> %i.vd, %100            ; 2 uses
