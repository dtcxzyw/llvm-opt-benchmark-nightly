...
bb.e:                                             ; preds = %bb.a
  ...
  %15 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %12, <2 x double> <double -2.990000e-01, double 7.010000e-01>, <2 x double> %14)
  ...
  %i.p = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.o, <2 x double> <double 8.860000e-01, double -1.140000e-01>, <2 x double> %15)
  %i.q = fdiv <2 x double> %i.p, <double 1.772000e+00, double 1.402000e+00>
  %i.r = icmp slt i32 %8, 0
  ...
  %i.u = insertelement <2 x double> poison, double %10, i64 0
