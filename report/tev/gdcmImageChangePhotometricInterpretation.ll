...
bb.g:                                             ; preds = %bb.f
  ...
  %i.t = load i16, ptr %i.s, align 2, !tbaa !54
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.v = load i16, ptr %i.u, align 2, !tbaa !55
...
bb.j:                                             ; preds = %.lr.ph63, %_ZNK4gdcm11PixelFormat13GetBitsStoredEv.exit
  ...
  %i.ab = load <2 x i16>, ptr %i.aa, align 2, !tbaa !19
  store <2 x i16> %i.ab, ptr %i.a, align 4, !tbaa !19
  %i.ac = getelementptr inbounds nuw i8, ptr %i.aa, i64 4 ; 2 uses
  %i.ad = load i16, ptr %i.ac, align 2, !tbaa !19
  store i16 %i.ad, ptr %i.x, align 4, !tbaa !19
  %i.ae = load i16, ptr %i.y, align 2, !tbaa !84  ; 2 uses
  %i.af = load i16, ptr %i.u, align 2, !tbaa !55
...
_ZNK4gdcm11PixelFormat13GetBitsStoredEv.exit:     ; preds = %bb.j
  ...
  %i.ai = load <2 x i16>, ptr %i.b, align 4, !tbaa !19
  store <2 x i16> %i.ai, ptr %i.aa, align 2, !tbaa !19
  %i.aj = load i16, ptr %i.z, align 4, !tbaa !19
  store i16 %i.aj, ptr %i.ac, align 2, !tbaa !19
...
bb.o:                                             ; preds = %.lr.ph, %_ZNK4gdcm11PixelFormat13GetBitsStoredEv.exit58
  ...
  store i8 %i.at, ptr %i.c, align 1, !tbaa !45
  %i.au = getelementptr inbounds nuw i8, ptr %i.as, i64 1 ; 2 uses
  %i.av = load i8, ptr %i.au, align 1, !tbaa !45
  store i8 %i.av, ptr %i.am, align 1, !tbaa !45
  %i.aw = getelementptr inbounds nuw i8, ptr %i.as, i64 2 ; 2 uses
  %i.ax = load i8, ptr %i.aw, align 1, !tbaa !45
  store i8 %i.ax, ptr %i.an, align 1, !tbaa !45
  %i.ay = load i16, ptr %i.ao, align 2, !tbaa !84 ; 2 uses
  %i.az = load i16, ptr %i.u, align 2, !tbaa !55
...
_ZNK4gdcm11PixelFormat13GetBitsStoredEv.exit58:   ; preds = %bb.o
  ...
  %i.bc = load i8, ptr %i.d, align 1, !tbaa !45
  store i8 %i.bc, ptr %i.as, align 1, !tbaa !45
  %i.bd = load i8, ptr %i.ap, align 1, !tbaa !45
  store i8 %i.bd, ptr %i.au, align 1, !tbaa !45
  %i.be = load i8, ptr %i.aq, align 1, !tbaa !45
  store i8 %i.be, ptr %i.aw, align 1, !tbaa !45
...
bb.s:                                             ; preds = %bb.h, %._crit_edge, %._crit_edge64
  ...
  %i.bk = load ptr, ptr %i.bg, align 8, !tbaa !13
...
bb.e:                                             ; preds = %bb.a
  ...
  %i.g = load i16, ptr %i.f, align 2, !tbaa !19
  %i.h = uitofp i16 %i.g to double
  %i.i = load i16, ptr %1, align 2, !tbaa !19
  %i.j = zext nneg i16 %2 to i32
  %i.k = add nsw i32 %i.j, -1
  %i.l = shl nuw nsw i32 1, %i.k
  %i.m = fmul nnan double %i.h, 5.870000e-01      ; 2 uses
  %i.n = fneg double %i.m
  %3 = insertelement <2 x i16> poison, i16 %i.e, i64 0
  %4 = insertelement <2 x i16> %3, i16 %i.i, i64 1
  %5 = uitofp <2 x i16> %4 to <2 x double>        ; 4 uses
  ...
  %i.r = shufflevector <2 x double> %5, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.v = tail call double @llvm.fmuladd.f64(double %7, double 2.990000e-01, double %i.m)
  %8 = extractelement <2 x double> %5, i64 0
  %i.w = tail call double @llvm.fmuladd.f64(double %8, double 1.140000e-01, double %i.v)
  ...
  store <2 x i16> %i.ak, ptr %0, align 2, !tbaa !19
  ...
  store i16 %i.am, ptr %i.an, align 2, !tbaa !19
  ret void
}
...
bb.e:                                             ; preds = %bb.a
  ...
  %i.g = load i8, ptr %i.f, align 1, !tbaa !45
  ...
  %3 = insertelement <2 x i8> poison, i8 %i.e, i64 0
  %4 = insertelement <2 x i8> %3, i8 %i.i, i64 1
  %5 = uitofp <2 x i8> %4 to <2 x double>         ; 4 uses
  %6 = extractelement <2 x double> %5, i64 1
  %i.p = tail call double @llvm.fmuladd.f64(double %6, double 2.990000e-01, double %i.m)
  %7 = extractelement <2 x double> %5, i64 0
  %i.q = tail call double @llvm.fmuladd.f64(double %7, double 1.140000e-01, double %i.p)
  ...
  %i.t = insertelement <2 x double> poison, double %i.n, i64 0
  %i.u = shufflevector <2 x double> %i.t, <2 x double> poison, <2 x i32> zeroinitializer
  %i.v = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %8, <2 x double> <double -2.990000e-01, double 7.010000e-01>, <2 x double> %i.u)
  %i.w = shufflevector <2 x double> %5, <2 x double> poison, <2 x i32> zeroinitializer
  %i.x = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.w, <2 x double> <double 8.860000e-01, double -1.140000e-01>, <2 x double> %i.v)
  %i.y = fdiv <2 x double> %i.x, <double 1.772000e+00, double 1.402000e+00>
  %i.z = icmp slt i32 %i.s, 0
  %spec.select3.i = tail call i32 @llvm.umin.i32(i32 %i.s, i32 255)
  %spec.select.i = trunc nuw i32 %spec.select3.i to i8
  %i.aa = select i1 %i.z, i8 0, i8 %spec.select.i
  store i8 %i.aa, ptr %0, align 1, !tbaa !45
  ...
  %i.af = fadd <2 x double> %i.ae, splat (double 5.000000e-01)
  %i.ag = fptosi <2 x double> %i.af to <2 x i32>  ; 2 uses
  %i.ah = icmp slt <2 x i32> %i.ag, zeroinitializer
  %i.ai = tail call <2 x i32> @llvm.umin.v2i32(<2 x i32> %i.ag, <2 x i32> splat (i32 255))
  %i.aj = trunc nuw <2 x i32> %i.ai to <2 x i8>
  %i.ak = select <2 x i1> %i.ah, <2 x i8> zeroinitializer, <2 x i8> %i.aj ; 2 uses
  %i.al = extractelement <2 x i8> %i.ak, i64 0
  store i8 %i.al, ptr %i.ab, align 1, !tbaa !45
  %i.am = getelementptr inbounds nuw i8, ptr %0, i64 2
  %i.an = extractelement <2 x i8> %i.ak, i64 1
  store i8 %i.an, ptr %i.am, align 1, !tbaa !45
  ret void
}
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !52   ; 5 uses
...
.lr.ph.preheader.i:                               ; preds = %bb.b
  ...
  tail call void @llvm.memset.p0.i64(ptr align 1 %i.d, i8 0, i64 %1, i1 false), !tbaa !45
...
_ZNSt3__16vectorIcNS_9allocatorIcEEE18__construct_at_endEm.exit: ; preds = %bb.b, %.lr.ph.preheader.i
  ...
  store ptr %.sroa.6.0.lcssa.i, ptr %i.c, align 8, !tbaa !52
...
bb.f:                                             ; preds = %bb.e, %_ZNKSt3__16vectorIcNS_9allocatorIcEEE11__recommendB8ne180100Em.exit
  ...
  tail call void @llvm.memset.p0.i64(ptr align 1 %i.u, i8 0, i64 %1, i1 false), !tbaa !45
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.ah, align 1, !tbaa !45, !noalias !97
  %wide.load34 = load <16 x i8>, ptr %i.ai, align 1, !tbaa !45, !noalias !97
  %i.aj = getelementptr inbounds i8, ptr %next.gep, i64 -16
  %i.ak = getelementptr inbounds i8, ptr %next.gep, i64 -32
  store <16 x i8> %wide.load, ptr %i.aj, align 1, !tbaa !45, !noalias !97
end_hunk_0
