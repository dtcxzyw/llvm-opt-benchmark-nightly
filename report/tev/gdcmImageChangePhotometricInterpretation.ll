...
bb.e:                                             ; preds = %bb.a
  ...
  %i.n = fneg double %i.m
  %3 = uitofp i16 %i.i to double                  ; 2 uses
  ...
  %i.v = tail call double @llvm.fmuladd.f64(double %3, double 2.990000e-01, double %i.m)
  %i.w = tail call double @llvm.fmuladd.f64(double %4, double 1.140000e-01, double %i.v)
...
bb.e:                                             ; preds = %bb.a
  ...
  %3 = uitofp i8 %i.i to double                   ; 2 uses
  %4 = uitofp i8 %i.e to double                   ; 2 uses
  %i.p = tail call double @llvm.fmuladd.f64(double %3, double 2.990000e-01, double %i.m)
  %i.q = tail call double @llvm.fmuladd.f64(double %4, double 1.140000e-01, double %i.p)
  ...
  %i.v = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> <double -2.990000e-01, double 7.010000e-01>, <2 x double> %i.u)
  %7 = insertelement <2 x double> poison, double %4, i64 0
  %i.w = shufflevector <2 x double> %7, <2 x double> poison, <2 x i32> zeroinitializer
