...
bb.e:                                             ; preds = %bb.a
  ...
  %i.p = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %14, <2 x double> <double -2.990000e-01, double 7.010000e-01>, <2 x double> %i.o)
  %i.q = shufflevector <2 x double> %7, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.w = insertelement <2 x double> poison, double %4, i64 0
