...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <16 x i8> %wide.load34, ptr %i.ak, align 1, !tbaa !45, !noalias !97
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph.i.i.i.i.i.i.i.preheader, label %vec.epilog.ph, !prof !98
