...
._crit_edge122.i:                                 ; preds = %._crit_edge122.loopexit.loopexit.i, %bb.o, %bb.m
  ...
  %notmask.i = shl nsw i32 -1, %.1.lcssa.i
  %4 = xor i32 %notmask.i, -1
  %i.by = and i32 %.079.i, %4
...
._crit_edge:                                      ; preds = %bb.f, %bb.d, %bb.b
  ...
  %notmask = shl nsw i32 -1, %.0111.lcssa
  %3 = xor i32 %notmask, -1
  %i.ap = and i32 %3, %i.o
...
._crit_edge188:                                   ; preds = %bb.o, %bb.m, %bb.k
  ...
  %notmask201 = shl nsw i32 -1, %.1112.lcssa
  %4 = xor i32 %notmask201, -1
  %i.cr = and i32 %4, %i.bn
...
._crit_edge197:                                   ; preds = %bb.x, %bb.v, %bb.t
  ...
  %notmask202 = shl nsw i32 -1, %.2.lcssa
  %5 = xor i32 %notmask202, -1
  %i.et = and i32 %5, %i.dp
...
._crit_edge:                                      ; preds = %bb.e, %bb.c, %bb.a
  ...
  %notmask = shl nsw i32 -1, %.037.lcssa
  %3 = xor i32 %notmask, -1
  %i.ah = and i32 %1, %3
