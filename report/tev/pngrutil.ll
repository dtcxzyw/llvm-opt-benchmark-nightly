...
bb.d:                                             ; preds = %bb.c
  ...
  %3 = or disjoint i32 %i.i, %i.p
  %i.q = or disjoint i32 %3, %i.m
...
bb.g:                                             ; preds = %bb.f
  ...
  %4 = or disjoint i32 %i.ap, %i.aw
  %i.ax = or disjoint i32 %4, %i.at
...
bb.k:                                             ; preds = %bb.j
  ...
  %3 = or disjoint i32 %i.x, %i.ae
  %i.af = or disjoint i32 %3, %i.ab
...
bb.n:                                             ; preds = %bb.m
  ...
  %4 = or disjoint i32 %i.be, %i.bl
  %i.bm = or disjoint i32 %4, %i.bi
