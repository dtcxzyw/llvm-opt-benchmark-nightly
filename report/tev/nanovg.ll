...
bb.cl:                                            ; preds = %bb.ck, %bb.cj
  ...
  %12 = sitofp i32 %.pre-phi475.i.i.i to float    ; 3 uses
  %13 = sitofp i32 %i.vq to float                 ; 2 uses
  ...
  %i.wd = fsub nnan float %13, %.1306.i.i.i
...
._crit_edge.i.i.i:                                ; preds = %.prol.loopexit, %.lr.ph467.i.i.i.new, %bb.cl
  ...
  %i.xp = fadd float %12, 1.000000e+00            ; 2 uses
  %i.xq = fsub nnan float %i.xp, %12
