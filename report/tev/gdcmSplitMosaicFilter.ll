...
bb.y:                                             ; preds = %bb.x
  ...
  %13 = fmul nnan double %i.bw, 5.000000e-01
  %14 = fmul nnan double %i.bx, 5.000000e-01
  %15 = fmul nnan double %i.by, 5.000000e-01
  %16 = load double, ptr %12, align 8, !tbaa !31
  %17 = load <2 x double>, ptr %4, align 8, !tbaa !31
  %18 = fneg <2 x double> %17                     ; 2 uses
  %19 = fneg double %16
  %20 = extractelement <2 x double> %18, i64 0
  %21 = fmul double %13, %20                      ; 2 uses
  %22 = extractelement <2 x double> %18, i64 1
  %23 = fmul double %14, %22                      ; 2 uses
  %24 = fmul double %15, %19                      ; 2 uses
  %i.bz = load <2 x double>, ptr %9, align 16, !tbaa !31
  %25 = insertelement <2 x double> poison, double %21, i64 0
  %26 = shufflevector <2 x double> %25, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ca = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %26, <2 x double> %i.bz, <2 x double> %i.bt)
  %i.cb = load <2 x double>, ptr %i.k, align 8, !tbaa !31
  %27 = insertelement <2 x double> poison, double %23, i64 0
  %28 = shufflevector <2 x double> %27, <2 x double> poison, <2 x i32> zeroinitializer
  %i.cc = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %28, <2 x double> %i.cb, <2 x double> %i.ca)
  %i.cd = load <2 x double>, ptr %i.a, align 16, !tbaa !31
  %29 = insertelement <2 x double> poison, double %24, i64 0
  %i.ce = shufflevector <2 x double> %29, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.ci = call double @llvm.fmuladd.f64(double %21, double %i.ch, double %i.bq)
