...
begin_hunk_0_@Eval1InputFloat:bb.a
  %i.ca = load i32, ptr %i.bz, align 4, !tbaa !21 ; 2 uses
  %i.cb = mul i32 %i.ca, %i.bu                    ; 6 uses
  %i.cc = mul i32 %i.ca, %i.bw                    ; 6 uses
  %i.cd = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.ce = load i32, ptr %i.cd, align 8, !tbaa !17 ; 3 uses
  %.not = icmp eq i32 %i.ce, 0
  br i1 %.not, label %.loopexit, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %bb.c
  %wide.trip.count = zext i32 %i.ce to i64        ; 6 uses
  %min.iters.check = icmp ult i32 %i.ce, 16
  br i1 %min.iters.check, label %.lr.ph.preheader76, label %vector.scevcheck

vector.scevcheck:                                 ; preds = %.lr.ph.preheader
  %i.cf = add nsw i64 %wide.trip.count, -1        ; 2 uses
  %i.cg = trunc i64 %i.cf to i32                  ; 2 uses
  %i.ch = xor i32 %i.cb, -1
  %i.ci = icmp ult i32 %i.ch, %i.cg
  %i.cj = xor i32 %i.cc, -1
  %i.ck = icmp ult i32 %i.cj, %i.cg
  %i.cl = icmp ugt i64 %i.cf, 4294967295
  %i.cm = or i1 %i.ck, %i.cl
  %i.cn = or i1 %i.ci, %i.cm
  br i1 %i.cn, label %.lr.ph.preheader76, label %vector.memcheck

vector.memcheck:                                  ; preds = %vector.scevcheck
  %i.co = sub i64 %i.a, %i.d                      ; 2 uses
  %i.cp = zext i32 %i.cc to i64
  %i.cq = shl nuw nsw i64 %i.cp, 2
  %i.cr = sub i64 %i.cq, %i.co
  %diff.check = icmp ugt i64 %i.cr, -32
  %i.cs = zext i32 %i.cb to i64
  %i.ct = shl nuw nsw i64 %i.cs, 2
  %i.cu = sub i64 %i.ct, %i.co
  %diff.check56 = icmp ugt i64 %i.cu, -32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.cv = trunc nuw i64 %index to i32             ; 2 uses
  %i.cw = add i32 %i.cb, %i.cv
  %i.cx = zext i32 %i.cw to i64
  %i.cy = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.cx ; 2 uses
  %i.cz = getelementptr inbounds nuw i8, ptr %i.cy, i64 16
  %wide.load = load <4 x float>, ptr %i.cy, align 4, !tbaa !25 ; 2 uses
  %wide.load57 = load <4 x float>, ptr %i.cz, align 4, !tbaa !25 ; 2 uses
  %i.da = add i32 %i.cc, %i.cv
  %i.db = zext i32 %i.da to i64
  %i.dc = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.db ; 2 uses
  %i.dd = getelementptr inbounds nuw i8, ptr %i.dc, i64 16
  %wide.load58 = load <4 x float>, ptr %i.dc, align 4, !tbaa !25
  %wide.load59 = load <4 x float>, ptr %i.dd, align 4, !tbaa !25
  %i.de = fsub <4 x float> %wide.load58, %wide.load
  %i.df = fsub <4 x float> %wide.load59, %wide.load57
  %i.dg = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.de, <4 x float> %broadcast.splat, <4 x float> %wide.load)
  %i.dh = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.df, <4 x float> %broadcast.splat, <4 x float> %wide.load57)
  %i.di = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %index ; 2 uses
  %i.dj = getelementptr inbounds nuw i8, ptr %i.di, i64 16
  store <4 x float> %i.dg, ptr %i.di, align 4, !tbaa !25
  store <4 x float> %i.dh, ptr %i.dj, align 4, !tbaa !25
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.dk = icmp eq i64 %index.next, %n.vec
  br i1 %i.dk, label %middle.block, label %vector.body, !llvm.loop !45

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count
  br i1 %cmp.n, label %.loopexit, label %.lr.ph.preheader76

.lr.ph.preheader76:                               ; preds = %vector.memcheck, %vector.scevcheck, %.lr.ph.preheader, %middle.block
  %indvars.iv.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %vector.scevcheck ], [ 0, %.lr.ph.preheader ], [ %n.vec, %middle.block ] ; 5 uses
  %xtraiter = and i64 %wide.trip.count, 1
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol

.lr.ph.prol:                                      ; preds = %.lr.ph.preheader76
  %i.dl = trunc nuw i64 %indvars.iv.ph to i32     ; 2 uses
  %i.dm = add i32 %i.cb, %i.dl
  %i.dn = zext i32 %i.dm to i64
  %i.do = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.dn
  %i.dp = load float, ptr %i.do, align 4, !tbaa !25 ; 2 uses
  %i.dq = add i32 %i.cc, %i.dl
  %i.dr = zext i32 %i.dq to i64
  %i.ds = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.dr
  %i.dt = load float, ptr %i.ds, align 4, !tbaa !25
  %i.du = fsub float %i.dt, %i.dp
  %i.dv = tail call float @llvm.fmuladd.f32(float %i.du, float %i.by, float %i.dp)
  %i.dw = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv.ph
  store float %i.dv, ptr %i.dw, align 4, !tbaa !25
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  %i.ea = add i32 %i.cb, %i.dz
  %i.eb = zext i32 %i.ea to i64
  %i.ec = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.eb
  %i.ed = load float, ptr %i.ec, align 4, !tbaa !25 ; 2 uses
  %i.ee = add i32 %i.cc, %i.dz
  %i.ef = zext i32 %i.ee to i64
  %i.eg = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.ef
  %i.eh = load float, ptr %i.eg, align 4, !tbaa !25
  %i.ei = fsub float %i.eh, %i.ed
  %i.ej = tail call float @llvm.fmuladd.f32(float %i.ei, float %i.by, float %i.ed)
  %i.ek = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv
  store float %i.ej, ptr %i.ek, align 4, !tbaa !25
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.el = trunc nuw i64 %indvars.iv.next to i32   ; 2 uses
  %i.em = add i32 %i.cb, %i.el
  %i.en = zext i32 %i.em to i64
  %i.eo = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.en
  %i.ep = load float, ptr %i.eo, align 4, !tbaa !25 ; 2 uses
  %i.eq = add i32 %i.cc, %i.el
  %i.er = zext i32 %i.eq to i64
  %i.es = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.er
  %i.et = load float, ptr %i.es, align 4, !tbaa !25
  %i.eu = fsub float %i.et, %i.ep
  %i.ev = tail call float @llvm.fmuladd.f32(float %i.eu, float %i.by, float %i.ep)
  %i.ew = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv.next
  store float %i.ev, ptr %i.ew, align 4, !tbaa !25
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, %wide.trip.count
  br i1 %exitcond.not.1, label %.loopexit, label %.lr.ph, !llvm.loop !46

.loopexit:                                        ; preds = %.lr.ph.prol.loopexit, %.lr.ph, %.lr.ph42.prol.loopexit, %.lr.ph42, %middle.block, %middle.block72, %bb.c, %._crit_edge
  ret void
}

; Function Attrs: nofree norecurse nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none, target_mem: none) uwtable
define internal void @Eval1Input(ptr nofree noundef readonly captures(none) %0, ptr nofree noundef writeonly captures(none) %1, ptr nofree noundef readonly captures(none) %2) #4 {
bb.a:
...
._crit_edge:                                      ; preds = %bb.a, %bb.b
  %i.i = phi i32 [ 0, %bb.b ], [ %.pre, %bb.a ]
  %i.j = getelementptr inbounds nuw i8, ptr %2, i64 140
  %i.k = load i32, ptr %i.j, align 4, !tbaa !21
  %i.l = mul i32 %i.k, %i.i                       ; 9 uses
  %i.m = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.n = load i32, ptr %i.m, align 8, !tbaa !17   ; 4 uses
  %.not41 = icmp eq i32 %i.n, 0
  br i1 %.not41, label %.loopexit, label %iter.check

iter.check:                                       ; preds = %._crit_edge
  %wide.trip.count47 = zext i32 %i.n to i64       ; 9 uses
  %min.iters.check59 = icmp ult i32 %i.n, 4
  br i1 %min.iters.check59, label %.lr.ph40.preheader, label %vector.scevcheck55

vector.scevcheck55:                               ; preds = %iter.check
  %i.o = add nsw i64 %wide.trip.count47, -1       ; 2 uses
  %i.p = trunc i64 %i.o to i32
  %i.q = xor i32 %i.l, -1
  %i.r = icmp ult i32 %i.q, %i.p
  %i.s = icmp ugt i64 %i.o, 4294967295
  %i.t = or i1 %i.r, %i.s
  br i1 %i.t, label %.lr.ph40.preheader, label %vector.memcheck56

vector.memcheck56:                                ; preds = %vector.scevcheck55
  %i.u = zext i32 %i.l to i64
  %i.v = shl nuw nsw i64 %i.u, 1
  %i.w = add i64 %i.v, %i.d
  %i.x = sub i64 %i.w, %i.a
  %diff.check57 = icmp ugt i64 %i.x, -32
  br i1 %diff.check57, label %.lr.ph40.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %vector.memcheck56
  %min.iters.check60 = icmp ult i32 %i.n, 16
  br i1 %min.iters.check60, label %vec.epilog.ph, label %vector.ph61

vector.ph61:                                      ; preds = %vector.main.loop.iter.check
  %i.y = and i64 %wide.trip.count47, 12
...
vector.body63:                                    ; preds = %vector.ph61, %vector.body63
  ...
  %i.ac = getelementptr inbounds nuw [2 x i8], ptr %i.c, i64 %i.ab ; 2 uses
  %i.ad = getelementptr inbounds nuw i8, ptr %i.ac, i64 16
  %wide.load65 = load <8 x i16>, ptr %i.ac, align 2, !tbaa !27
  %wide.load66 = load <8 x i16>, ptr %i.ad, align 2, !tbaa !27
  %i.ae = getelementptr inbounds nuw [2 x i8], ptr %1, i64 %index64 ; 2 uses
  %i.af = getelementptr inbounds nuw i8, ptr %i.ae, i64 16
  store <8 x i16> %wide.load65, ptr %i.ae, align 2, !tbaa !27
  store <8 x i16> %wide.load66, ptr %i.af, align 2, !tbaa !27
  %index.next67 = add nuw i64 %index64, 16        ; 2 uses
  %i.ag = icmp eq i64 %index.next67, %n.vec62
  br i1 %i.ag, label %middle.block68, label %vector.body63, !llvm.loop !47

middle.block68:                                   ; preds = %vector.body63
  %cmp.n69 = icmp eq i64 %n.vec62, %wide.trip.count47
...
vec.epilog.iter.check:                            ; preds = %middle.block68
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph40.preheader, label %vec.epilog.ph, !prof !53

vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec62, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec70 = and i64 %wide.trip.count47, 4294967292 ; 3 uses
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index71 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next73, %vec.epilog.vector.body ] ; 3 uses
  %i.ah = trunc nuw i64 %index71 to i32
  %i.ai = add i32 %i.l, %i.ah
  %i.aj = zext i32 %i.ai to i64
  %i.ak = getelementptr inbounds nuw [2 x i8], ptr %i.c, i64 %i.aj
  %wide.load72 = load <4 x i16>, ptr %i.ak, align 2, !tbaa !27
  %i.al = getelementptr inbounds nuw [2 x i8], ptr %1, i64 %index71
  store <4 x i16> %wide.load72, ptr %i.al, align 2, !tbaa !27
  %index.next73 = add nuw i64 %index71, 4         ; 2 uses
  %i.am = icmp eq i64 %index.next73, %n.vec70
  br i1 %i.am, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !48
...
.lr.ph40.preheader:                               ; preds = %iter.check, %vector.scevcheck55, %vector.memcheck56, %vec.epilog.iter.check, %vec.epilog.middle.block
  ...
  br i1 %lcmp.mod79.not, label %.lr.ph40.prol.loopexit, label %.lr.ph40.prol

.lr.ph40.prol:                                    ; preds = %.lr.ph40.preheader, %.lr.ph40.prol
  %indvars.iv44.prol = phi i64 [ %indvars.iv.next45.prol, %.lr.ph40.prol ], [ %indvars.iv44.ph, %.lr.ph40.preheader ] ; 3 uses
  %prol.iter = phi i64 [ %prol.iter.next, %.lr.ph40.prol ], [ 0, %.lr.ph40.preheader ]
  %i.an = trunc nuw i64 %indvars.iv44.prol to i32
  %i.ao = add i32 %i.l, %i.an
  %i.ap = zext i32 %i.ao to i64
  %i.aq = getelementptr inbounds nuw [2 x i8], ptr %i.c, i64 %i.ap
  %i.ar = load i16, ptr %i.aq, align 2, !tbaa !27
  %i.as = getelementptr inbounds nuw [2 x i8], ptr %1, i64 %indvars.iv44.prol
  store i16 %i.ar, ptr %i.as, align 2, !tbaa !27
  %indvars.iv.next45.prol = add nuw nsw i64 %indvars.iv44.prol, 1 ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter78
  br i1 %prol.iter.cmp.not, label %.lr.ph40.prol.loopexit, label %.lr.ph40.prol, !llvm.loop !49

.lr.ph40.prol.loopexit:                           ; preds = %.lr.ph40.prol, %.lr.ph40.preheader
  %indvars.iv44.unr = phi i64 [ %indvars.iv44.ph, %.lr.ph40.preheader ], [ %indvars.iv.next45.prol, %.lr.ph40.prol ]
  %i.at = sub nsw i64 %indvars.iv44.ph, %wide.trip.count47
  %i.au = icmp ugt i64 %i.at, -4
  br i1 %i.au, label %.loopexit, label %.lr.ph40

.lr.ph40:                                         ; preds = %.lr.ph40.prol.loopexit, %.lr.ph40
  %indvars.iv44 = phi i64 [ %indvars.iv.next45.3, %.lr.ph40 ], [ %indvars.iv44.unr, %.lr.ph40.prol.loopexit ] ; 6 uses
  %i.av = trunc nuw i64 %indvars.iv44 to i32
  %i.aw = add i32 %i.l, %i.av
  %i.ax = zext i32 %i.aw to i64
  %i.ay = getelementptr inbounds nuw [2 x i8], ptr %i.c, i64 %i.ax
  %i.az = load i16, ptr %i.ay, align 2, !tbaa !27
  %i.ba = getelementptr inbounds nuw [2 x i8], ptr %1, i64 %indvars.iv44
  store i16 %i.az, ptr %i.ba, align 2, !tbaa !27
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1 ; 2 uses
  %i.bb = trunc nuw i64 %indvars.iv.next45 to i32
  %i.bc = add i32 %i.l, %i.bb
  %i.bd = zext i32 %i.bc to i64
  %i.be = getelementptr inbounds nuw [2 x i8], ptr %i.c, i64 %i.bd
  %i.bf = load i16, ptr %i.be, align 2, !tbaa !27
  %i.bg = getelementptr inbounds nuw [2 x i8], ptr %1, i64 %indvars.iv.next45
  store i16 %i.bf, ptr %i.bg, align 2, !tbaa !27
  %indvars.iv.next45.1 = add nuw nsw i64 %indvars.iv44, 2 ; 2 uses
  %i.bh = trunc nuw i64 %indvars.iv.next45.1 to i32
  %i.bi = add i32 %i.l, %i.bh
  %i.bj = zext i32 %i.bi to i64
  %i.bk = getelementptr inbounds nuw [2 x i8], ptr %i.c, i64 %i.bj
  %i.bl = load i16, ptr %i.bk, align 2, !tbaa !27
  %i.bm = getelementptr inbounds nuw [2 x i8], ptr %1, i64 %indvars.iv.next45.1
  store i16 %i.bl, ptr %i.bm, align 2, !tbaa !27
  %indvars.iv.next45.2 = add nuw nsw i64 %indvars.iv44, 3 ; 2 uses
  %i.bn = trunc nuw i64 %indvars.iv.next45.2 to i32
  %i.bo = add i32 %i.l, %i.bn
  %i.bp = zext i32 %i.bo to i64
  %i.bq = getelementptr inbounds nuw [2 x i8], ptr %i.c, i64 %i.bp
  %i.br = load i16, ptr %i.bq, align 2, !tbaa !27
  %i.bs = getelementptr inbounds nuw [2 x i8], ptr %1, i64 %indvars.iv.next45.2
  store i16 %i.br, ptr %i.bs, align 2, !tbaa !27
  %indvars.iv.next45.3 = add nuw nsw i64 %indvars.iv44, 4 ; 2 uses
  %exitcond48.not.3 = icmp eq i64 %indvars.iv.next45.3, %wide.trip.count47
  br i1 %exitcond48.not.3, label %.loopexit, label %.lr.ph40, !llvm.loop !50

bb.c:                                             ; preds = %bb.b
  %i.bt = mul i32 %.pre, %i.f                     ; 2 uses
  %i.bu = add nsw i32 %i.bt, 32767
  %i.bv = sdiv i32 %i.bu, 65535
  %i.bw = add nsw i32 %i.bv, %i.bt                ; 2 uses
  %i.bx = ashr i32 %i.bw, 16                      ; 2 uses
  %i.by = and i32 %i.bw, 65535                    ; 4 uses
  %i.bz = add nsw i32 %i.bx, 1
  %i.ca = getelementptr inbounds nuw i8, ptr %2, i64 140
  %i.cb = load i32, ptr %i.ca, align 4, !tbaa !21 ; 2 uses
  %i.cc = mul i32 %i.cb, %i.bx                    ; 6 uses
  %i.cd = mul i32 %i.cb, %i.bz                    ; 6 uses
  %i.ce = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.cf = load i32, ptr %i.ce, align 8, !tbaa !17 ; 3 uses
  %.not = icmp eq i32 %i.cf, 0
  br i1 %.not, label %.loopexit, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %bb.c
  %wide.trip.count = zext i32 %i.cf to i64        ; 6 uses
  %min.iters.check = icmp ult i32 %i.cf, 24
  br i1 %min.iters.check, label %.lr.ph.preheader76, label %vector.scevcheck
...
vector.scevcheck:                                 ; preds = %.lr.ph.preheader
  ...
  %i.ck = xor i32 %i.cd, -1
  %i.cl = icmp ult i32 %i.ck, %i.ch
  %i.cm = icmp ugt i64 %i.cg, 4294967295
  %i.cn = or i1 %i.cl, %i.cm
  %i.co = or i1 %i.cj, %i.cn
  br i1 %i.co, label %.lr.ph.preheader76, label %vector.memcheck

vector.memcheck:                                  ; preds = %vector.scevcheck
  %i.cp = sub i64 %i.a, %i.d                      ; 2 uses
  %i.cq = zext i32 %i.cd to i64
  %i.cr = shl nuw nsw i64 %i.cq, 1
  %i.cs = sub i64 %i.cr, %i.cp
  %diff.check = icmp ugt i64 %i.cs, -16
  %i.ct = zext i32 %i.cc to i64
  %i.cu = shl nuw nsw i64 %i.ct, 1
  %i.cv = sub i64 %i.cu, %i.cp
  %diff.check53 = icmp ugt i64 %i.cv, -16
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 3 uses
  %i.cw = trunc nuw i64 %index to i32             ; 2 uses
  %i.cx = add i32 %i.cc, %i.cw
  %i.cy = zext i32 %i.cx to i64
  %i.cz = getelementptr inbounds nuw [2 x i8], ptr %i.c, i64 %i.cy
  %wide.load = load <8 x i16>, ptr %i.cz, align 2, !tbaa !27 ; 2 uses
  %i.da = zext <8 x i16> %wide.load to <8 x i32>
  %i.db = add i32 %i.cd, %i.cw
  %i.dc = zext i32 %i.db to i64
  %i.dd = getelementptr inbounds nuw [2 x i8], ptr %i.c, i64 %i.dc
  %wide.load54 = load <8 x i16>, ptr %i.dd, align 2, !tbaa !27
  %i.de = zext <8 x i16> %wide.load54 to <8 x i32>
  %i.df = sub nsw <8 x i32> %i.de, %i.da
  %i.dg = mul <8 x i32> %i.df, %broadcast.splat
  %i.dh = add <8 x i32> %i.dg, splat (i32 32768)
  %i.di = lshr <8 x i32> %i.dh, splat (i32 16)
  %i.dj = trunc nuw <8 x i32> %i.di to <8 x i16>
  %i.dk = add <8 x i16> %wide.load, %i.dj
  %i.dl = getelementptr inbounds nuw [2 x i8], ptr %1, i64 %index
  store <8 x i16> %i.dk, ptr %i.dl, align 2, !tbaa !27
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.dm = icmp eq i64 %index.next, %n.vec
  br i1 %i.dm, label %middle.block, label %vector.body, !llvm.loop !51
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader76
  %i.dn = trunc nuw i64 %indvars.iv.ph to i32     ; 2 uses
  %i.do = add i32 %i.cc, %i.dn
  %i.dp = zext i32 %i.do to i64
  %i.dq = getelementptr inbounds nuw [2 x i8], ptr %i.c, i64 %i.dp
  %i.dr = load i16, ptr %i.dq, align 2, !tbaa !27 ; 2 uses
  %i.ds = zext i16 %i.dr to i32
  %i.dt = add i32 %i.cd, %i.dn
  %i.du = zext i32 %i.dt to i64
  %i.dv = getelementptr inbounds nuw [2 x i8], ptr %i.c, i64 %i.du
  %i.dw = load i16, ptr %i.dv, align 2, !tbaa !27
  %i.dx = zext i16 %i.dw to i32
  %i.dy = sub nsw i32 %i.dx, %i.ds
  %i.dz = mul i32 %i.dy, %i.by
  %i.ea = add i32 %i.dz, 32768
  %i.eb = lshr i32 %i.ea, 16
  %i.ec = trunc nuw i32 %i.eb to i16
  %i.ed = add i16 %i.dr, %i.ec
  %i.ee = getelementptr inbounds nuw [2 x i8], ptr %1, i64 %indvars.iv.ph
  store i16 %i.ed, ptr %i.ee, align 2, !tbaa !27
  %indvars.iv.next.prol = or disjoint i64 %indvars.iv.ph, 1
  br label %.lr.ph.prol.loopexit

.lr.ph.prol.loopexit:                             ; preds = %.lr.ph.prol, %.lr.ph.preheader76
  %indvars.iv.unr = phi i64 [ %indvars.iv.ph, %.lr.ph.preheader76 ], [ %indvars.iv.next.prol, %.lr.ph.prol ]
  %i.ef = add nsw i64 %wide.trip.count, -1
  %i.eg = icmp eq i64 %indvars.iv.ph, %i.ef
  br i1 %i.eg, label %.loopexit, label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.lr.ph ], [ %indvars.iv.unr, %.lr.ph.prol.loopexit ] ; 4 uses
  %i.eh = trunc nuw i64 %indvars.iv to i32        ; 2 uses
  %i.ei = add i32 %i.cc, %i.eh
  %i.ej = zext i32 %i.ei to i64
  %i.ek = getelementptr inbounds nuw [2 x i8], ptr %i.c, i64 %i.ej
  %i.el = load i16, ptr %i.ek, align 2, !tbaa !27 ; 2 uses
  %i.em = zext i16 %i.el to i32
  %i.en = add i32 %i.cd, %i.eh
  %i.eo = zext i32 %i.en to i64
  %i.ep = getelementptr inbounds nuw [2 x i8], ptr %i.c, i64 %i.eo
  %i.eq = load i16, ptr %i.ep, align 2, !tbaa !27
  %i.er = zext i16 %i.eq to i32
  %i.es = sub nsw i32 %i.er, %i.em
  %i.et = mul i32 %i.es, %i.by
  %i.eu = add i32 %i.et, 32768
  %i.ev = lshr i32 %i.eu, 16
  %i.ew = trunc nuw i32 %i.ev to i16
  %i.ex = add i16 %i.el, %i.ew
  %i.ey = getelementptr inbounds nuw [2 x i8], ptr %1, i64 %indvars.iv
end_hunk_0
begin_hunk_1_@BilinearInterp16:bb.a
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
end_hunk_1
begin_hunk_2_@Eval15InputsFloat:bb.a
