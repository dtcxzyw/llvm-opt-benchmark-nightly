...
$_ZTSNSt3__120__shared_ptr_emplaceI17color_profile_rawNS_9allocatorIS1_EEEE = comdat any

@_ZN5Error2OkE = external local_unnamed_addr global %class.Error, align 8
@.str.5 = private unnamed_addr constant [53 x i8] c"colr boxes with undefined box size are not supported\00", align 1
@.str.6 = private unnamed_addr constant [45 x i8] c"Color profile exceeds maximum supported size\00", align 1
@.str.7 = private unnamed_addr constant [14 x i8] c"colour_type: \00", align 1
@.str.8 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@.str.9 = private unnamed_addr constant [18 x i8] c"colour_type: ---\0A\00", align 1
@.str.10 = private unnamed_addr constant [18 x i8] c"no color profile\0A\00", align 1
@.str.11 = private unnamed_addr constant [15 x i8] c"profile size: \00", align 1
@.str.12 = private unnamed_addr constant [19 x i8] c"colour_primaries: \00", align 1
@.str.13 = private unnamed_addr constant [27 x i8] c"transfer_characteristics: \00", align 1
@.str.14 = private unnamed_addr constant [22 x i8] c"matrix_coefficients: \00", align 1
@.str.15 = private unnamed_addr constant [18 x i8] c"full_range_flag: \00", align 1
@_ZTV17color_profile_raw = hidden constant { [7 x ptr] } { [7 x ptr] [ptr null, ptr @_ZTI17color_profile_raw, ptr @_ZN17color_profile_rawD2Ev, ptr @_ZN17color_profile_rawD0Ev, ptr @_ZNK17color_profile_raw8get_typeEv, ptr @_ZNK17color_profile_raw4dumpER6Indent, ptr @_ZNK17color_profile_raw5writeER12StreamWriter] }, align 8
@_ZTI17color_profile_raw = hidden constant { ptr, ptr, ptr } { ptr getelementptr inbounds (ptr, ptr @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2), ptr @_ZTS17color_profile_raw, ptr @_ZTI13color_profile }, align 8
...
bb.a:
  ...
  store i8 1, ptr %0, align 4, !tbaa !13
  store float %5, ptr %i.e, align 4, !tbaa !94
  store float %6, ptr %i.f, align 4, !tbaa !95
  store float %1, ptr %i.a, align 4, !tbaa !96
  store float %2, ptr %i.b, align 4, !tbaa !97
  store float %3, ptr %i.c, align 4, !tbaa !98
  store float %4, ptr %i.d, align 4, !tbaa !99
  store float %7, ptr %i.g, align 4, !tbaa !100
  store float %8, ptr %i.h, align 4, !tbaa !101
  ret void
}
...
bb.b:                                             ; preds = %bb.a
  ...
  store i8 1, ptr %0, align 4, !tbaa !13
  store <4 x float> <float 3.000000e-01, float 6.000000e-01, float 1.500000e-01, float 6.000000e-02>, ptr %i.a, align 4, !tbaa !14
  store <4 x float> <float 6.400000e-01, float 3.300000e-01, float 3.127000e-01, float 3.290000e-01>, ptr %i.b, align 4, !tbaa !14
  br label %bb.m

bb.c:                                             ; preds = %bb.a
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 20
  store i8 1, ptr %0, align 4, !tbaa !13
  store <4 x float> <float 2.100000e-01, float f0x3F35C28F, float 1.400000e-01, float 8.000000e-02>, ptr %i.a, align 4, !tbaa !14
  store <4 x float> <float 6.700000e-01, float 3.300000e-01, float 3.100000e-01, float 3.160000e-01>, ptr %i.c, align 4, !tbaa !14
  br label %bb.m

bb.d:                                             ; preds = %bb.a
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 20
  store i8 1, ptr %0, align 4, !tbaa !13
  store <4 x float> <float 2.900000e-01, float 6.000000e-01, float 1.500000e-01, float 6.000000e-02>, ptr %i.a, align 4, !tbaa !14
  store <4 x float> <float 6.400000e-01, float 3.300000e-01, float 3.127000e-01, float 3.290000e-01>, ptr %i.d, align 4, !tbaa !14
  br label %bb.m

bb.e:                                             ; preds = %bb.a, %bb.a
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 20
  store i8 1, ptr %0, align 4, !tbaa !13
  store <4 x float> <float 3.100000e-01, float 5.950000e-01, float 1.550000e-01, float 7.000000e-02>, ptr %i.a, align 4, !tbaa !14
  store <4 x float> <float 6.300000e-01, float 3.400000e-01, float 3.127000e-01, float 3.290000e-01>, ptr %i.e, align 4, !tbaa !14
  br label %bb.m

bb.f:                                             ; preds = %bb.a
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 20
  store i8 1, ptr %0, align 4, !tbaa !13
  store <4 x float> <float 2.430000e-01, float f0x3F3126E9, float 1.450000e-01, float 4.900000e-02>, ptr %i.a, align 4, !tbaa !14
  store <4 x float> <float 6.810000e-01, float 3.190000e-01, float 3.100000e-01, float 3.160000e-01>, ptr %i.f, align 4, !tbaa !14
  br label %bb.m

bb.g:                                             ; preds = %bb.a
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 20
  store i8 1, ptr %0, align 4, !tbaa !13
  store <4 x float> <float 1.700000e-01, float f0x3F4C0831, float 1.310000e-01, float 4.600000e-02>, ptr %i.a, align 4, !tbaa !14
  store <4 x float> <float 7.080000e-01, float 2.920000e-01, float 3.127000e-01, float 3.290000e-01>, ptr %i.g, align 4, !tbaa !14
  br label %bb.m

bb.h:                                             ; preds = %bb.a
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 20
  store i8 1, ptr %0, align 4, !tbaa !13
  store <4 x float> <float 0.000000e+00, float 1.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %i.a, align 4, !tbaa !14
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 3.333330e-01, float 3.333300e-01>, ptr %i.h, align 4, !tbaa !14
  br label %bb.m

bb.i:                                             ; preds = %bb.a
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 20
  store i8 1, ptr %0, align 4, !tbaa !13
  store <4 x float> <float 2.650000e-01, float f0x3F30A3D7, float 1.500000e-01, float 6.000000e-02>, ptr %i.a, align 4, !tbaa !14
  store <4 x float> <float 6.800000e-01, float 3.200000e-01, float 3.140000e-01, float 3.510000e-01>, ptr %i.i, align 4, !tbaa !14
  br label %bb.m
...
bb.j:                                             ; preds = %bb.a
  ...
  store i8 1, ptr %0, align 4, !tbaa !13
  store <4 x float> <float 2.650000e-01, float f0x3F30A3D7, float 1.500000e-01, float 6.000000e-02>, ptr %i.a, align 4, !tbaa !14
  store <4 x float> <float 6.800000e-01, float 3.200000e-01, float 3.127000e-01, float 3.290000e-01>, ptr %i.j, align 4, !tbaa !14
  br label %bb.m

bb.k:                                             ; preds = %bb.a
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 20
  store i8 1, ptr %0, align 4, !tbaa !13
  store <4 x float> <float 2.950000e-01, float 6.050000e-01, float 1.550000e-01, float 7.700000e-02>, ptr %i.a, align 4, !tbaa !14
  store <4 x float> <float 6.300000e-01, float 3.400000e-01, float 3.127000e-01, float 3.290000e-01>, ptr %i.k, align 4, !tbaa !14
  br label %bb.m
...
switch.lookup:                                    ; preds = %bb.b
  ...
  %switch.load70 = load float, ptr %switch.gep69, align 4
  ...
  %switch.load72 = load float, ptr %switch.gep71, align 4
  %2 = insertelement <2 x float> poison, float %switch.load64, i64 0
  %3 = insertelement <2 x float> %2, float %switch.load68, i64 1
  %i.k = insertelement <2 x float> poison, float %switch.load66, i64 0 ; 2 uses
  %i.l = insertelement <2 x float> %i.k, float %switch.load, i64 1
  %i.m = insertelement <2 x float> poison, float %switch.load60, i64 0
  %i.n = insertelement <2 x float> %i.m, float %switch.load64, i64 1
  %i.o = insertelement <2 x float> poison, float %switch.load, i64 0
  %i.p = insertelement <2 x float> %i.o, float %switch.load62, i64 1
  %i.q = insertelement <2 x float> poison, float %switch.load68, i64 0 ; 2 uses
  %i.r = insertelement <2 x float> %i.q, float %switch.load60, i64 1
  %i.s = insertelement <2 x float> %i.k, float %switch.load60, i64 1
  %i.t = insertelement <2 x float> %i.q, float %switch.load, i64 1
  %4 = fadd <2 x float> %i.s, %i.t
...
_Z20get_colour_primariest.exit:                   ; preds = %bb.b, %switch.lookup
  ...
  %.sroa.84.0 = phi float [ %switch.load70, %switch.lookup ], [ 0.000000e+00, %bb.b ] ; 2 uses
  %.sroa.96.0 = phi float [ %switch.load72, %switch.lookup ], [ 0.000000e+00, %bb.b ] ; 3 uses
  %5 = phi <2 x float> [ %3, %switch.lookup ], [ zeroinitializer, %bb.b ] ; 2 uses
  %i.u = phi <2 x float> [ %i.l, %switch.lookup ], [ zeroinitializer, %bb.b ] ; 2 uses
  %i.v = phi <2 x float> [ %i.n, %switch.lookup ], [ zeroinitializer, %bb.b ] ; 4 uses
  %i.w = phi <2 x float> [ %i.p, %switch.lookup ], [ zeroinitializer, %bb.b ] ; 3 uses
  %i.x = phi <2 x float> [ %i.r, %switch.lookup ], [ zeroinitializer, %bb.b ]
  %i.y = phi <2 x float> [ %4, %switch.lookup ], [ zeroinitializer, %bb.b ]
  %i.z = fadd <2 x float> %i.w, %i.v
  %i.aa = fsub <2 x float> splat (float 1.000000e+00), %i.y ; 3 uses
  %i.ab = fsub <2 x float> splat (float 1.000000e+00), %i.z ; 2 uses
  %i.ac = fneg <2 x float> %i.ab                  ; 2 uses
  %i.ad = extractelement <2 x float> %i.ac, i64 1
  %i.ae = fmul float %.sroa.72.0, %i.ad
  %i.af = extractelement <2 x float> %i.aa, i64 0
  %i.ag = tail call float @llvm.fmuladd.f32(float %.sroa.48.0, float %i.af, float %i.ae)
  %i.ah = fmul float %.sroa.1325.0, %i.ag
  %i.ai = fneg <2 x float> %i.aa
  %i.aj = fmul <2 x float> %i.v, %i.ai
  %i.ak = shufflevector <2 x float> %5, <2 x float> %i.v, <2 x i32> <i32 1, i32 2>
  %i.al = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ak, <2 x float> %i.ab, <2 x float> %i.aj) ; 3 uses
  %i.am = extractelement <2 x float> %i.al, i64 1
  %i.an = tail call float @llvm.fmuladd.f32(float %.sroa.60.0, float %i.am, float %i.ah)
  %i.ao = extractelement <2 x float> %i.al, i64 0
  %i.ap = tail call float @llvm.fmuladd.f32(float %.sroa.37.0, float %i.ao, float %i.an)
  %i.aq = fmul float %.sroa.96.0, %i.ap           ; 2 uses
  %i.ar = fcmp oeq float %i.aq, 0.000000e+00
  br i1 %i.ar, label %bb.j, label %bb.c

bb.c:                                             ; preds = %_Z20get_colour_primariest.exit
  %i.as = fadd float %.sroa.84.0, %.sroa.96.0
  %i.at = fsub float 1.000000e+00, %i.as
  %i.au = fmul <2 x float> %i.u, %i.ac
  %i.av = fneg <2 x float> %i.x
  %i.aw = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.w, <2 x float> %i.aa, <2 x float> %i.au)
  %i.ax = insertelement <2 x float> poison, float %.sroa.96.0, i64 0
  %i.ay = shufflevector <2 x float> %i.ax, <2 x float> poison, <2 x i32> zeroinitializer
  %i.az = fmul <2 x float> %i.ay, %i.aw
  %i.ba = insertelement <2 x float> poison, float %.sroa.84.0, i64 0
  %i.bb = shufflevector <2 x float> %i.ba, <2 x float> poison, <2 x i32> zeroinitializer
  %i.bc = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bb, <2 x float> %i.al, <2 x float> %i.az)
  %i.bd = fmul nnan <2 x float> %i.w, %i.av
  %i.be = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.u, <2 x float> %i.v, <2 x float> %i.bd)
  %i.bf = insertelement <2 x float> poison, float %i.at, i64 0
...
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 4
  store i8 1, ptr %0, align 4, !tbaa !103
  store <4 x float> <float 1.402000e+00, float -3.441360e-01, float -7.141360e-01, float 1.772000e+00>, ptr %i.a, align 4, !tbaa !14
  ret void
}
...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  store i8 1, ptr %0, align 4, !tbaa !15
  store <4 x float> %i.o, ptr %i.p, align 4, !tbaa !14
  ret void
}
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = fneg float %.sroa.0.0.vec.extract16
  %i.f = fsub float 1.000000e+00, %.sroa.0.4.vec.extract
  %i.g = fsub float %i.d, %.sroa.0.4.vec.extract  ; 2 uses
  %i.h = insertelement <2 x float> %i.a, float %i.g, i64 0
  %i.i = fneg <2 x float> %i.h                    ; 2 uses
  %i.j = shufflevector <2 x float> %i.i, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %i.k = insertelement <2 x float> %i.j, float %i.e, i64 0
  ...
  %i.r = fdiv <2 x float> %i.i, %i.q
  %i.s = fmul <2 x float> %i.r, splat (float 5.000000e-01)
  %i.t = shufflevector <2 x float> %i.a, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %i.u = insertelement <4 x float> %i.t, float %i.g, i64 0
  %i.v = shufflevector <2 x float> %i.o, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  %i.x = phi <4 x float> [ %i.w, %bb.b ], [ <float 5.870000e-01, float 1.140000e-01, float -1.687350e-01, float -3.312640e-01>, %bb.a ]
  %i.y = phi <2 x float> [ %i.s, %bb.b ], [ <float -4.186880e-01, float -8.131200e-02>, %bb.a ]
  %i.z = getelementptr inbounds nuw i8, ptr %0, i64 4
  store i8 1, ptr %0, align 4, !tbaa !15
  store float %.sink38, ptr %i.z, align 4
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 8
  store <4 x float> %i.x, ptr %i.aa, align 4
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 24
  store <2 x float> splat (float 5.000000e-01), ptr %i.ab, align 4
  %i.ac = getelementptr inbounds nuw i8, ptr %0, i64 32
  store <2 x float> %i.y, ptr %i.ac, align 4
  ret void
}
...
bb.a:
  ...
  store <4 x float> <float 2.990000e-01, float 5.870000e-01, float 1.140000e-01, float -1.687350e-01>, ptr %i.a, align 4, !tbaa !14
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 20
  store <4 x float> <float -3.312640e-01, float 5.000000e-01, float 5.000000e-01, float -4.186880e-01>, ptr %i.b, align 4, !tbaa !14
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 36
  store float -8.131200e-02, ptr %i.c, align 4, !tbaa !14
  ret void
}
