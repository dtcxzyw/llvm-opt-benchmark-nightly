...
switch.lookup:                                    ; preds = %bb.b
  ...
  %switch.load = load float, ptr %switch.gep, align 4 ; 3 uses
  ...
  %switch.load60 = load float, ptr %switch.gep59, align 4 ; 2 uses
  ...
  %i.m = insertelement <2 x float> poison, float %switch.load66, i64 0
  ...
  %i.s = insertelement <2 x float> poison, float %switch.load68, i64 0
...
_Z20get_colour_primariest.exit:                   ; preds = %bb.b, %switch.lookup
  ...
  %.sroa.60.0 = phi float [ %switch.load66, %switch.lookup ], [ 0.000000e+00, %bb.b ] ; 2 uses
  %.sroa.72.0 = phi float [ %switch.load68, %switch.lookup ], [ 0.000000e+00, %bb.b ] ; 2 uses
  ...
  %i.v = phi <2 x float> [ %i.n, %switch.lookup ], [ zeroinitializer, %bb.b ] ; 2 uses
  %i.w = phi <2 x float> [ %i.p, %switch.lookup ], [ zeroinitializer, %bb.b ] ; 4 uses
  %i.x = phi <2 x float> [ %i.r, %switch.lookup ], [ zeroinitializer, %bb.b ] ; 3 uses
  %i.y = phi <2 x float> [ %i.t, %switch.lookup ], [ zeroinitializer, %bb.b ]
  %2 = fadd float %.sroa.60.0, %.sroa.72.0
  %i.z = fadd <2 x float> %i.x, %i.w              ; 2 uses
  %3 = shufflevector <2 x float> %i.z, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %4 = insertelement <2 x float> %3, float %2, i64 0
  %i.aa = fsub <2 x float> splat (float 1.000000e+00), %4 ; 3 uses
  ...
  %i.ak = shufflevector <2 x float> %i.u, <2 x float> %i.w, <2 x i32> <i32 1, i32 2>
...
bb.c:                                             ; preds = %_Z20get_colour_primariest.exit
  ...
  %i.au = fmul <2 x float> %i.v, %i.ac
  %i.av = fneg <2 x float> %i.y
  %i.aw = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.x, <2 x float> %i.aa, <2 x float> %i.au)
  ...
  %i.bd = fmul nnan <2 x float> %i.x, %i.av
  %i.be = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.v, <2 x float> %i.w, <2 x float> %i.bd)
