...
bb.c:                                             ; preds = %_Z20get_colour_primariest.exit
  %2 = fadd float %.sroa.84.0, %.sroa.96.0
  %i.aw = fsub float 1.000000e+00, %2
  ...
  %3 = insertelement <2 x float> poison, float %.sroa.96.0, i64 0
  %i.ba = shufflevector <2 x float> %3, <2 x float> poison, <2 x i32> zeroinitializer
  %i.bb = fmul <2 x float> %i.ba, %i.az
  %4 = insertelement <2 x float> poison, float %.sroa.84.0, i64 0
  %5 = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> zeroinitializer
  %i.bc = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %5, <2 x float> %i.ap, <2 x float> %i.bb)
