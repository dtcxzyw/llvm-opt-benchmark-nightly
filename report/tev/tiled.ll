...
.lr.ph.preheader.i110:                            ; preds = %bb.cf
  ...
  %i.kh = getelementptr i8, ptr %i.kg, i64 %i.ka  ; 4 uses
  %min.iters.check = icmp ult i8 %i.kb, 64
  br i1 %min.iters.check, label %.lr.ph.i112.preheader, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph.preheader.i110
  %n.vec = and i64 %wide.trip.count.i111, 24      ; 4 uses
  %broadcast.splatinsert = insertelement <8 x i32> poison, i32 %i.kf, i64 0
...
vector.body.1:                                    ; preds = %vector.ph
  ...
  store <8 x i8> %i.kq, ptr %i.kr, align 1, !tbaa !37
  %i.ks = icmp eq i64 %n.vec, 16
...
vector.body.2:                                    ; preds = %vector.body.1
  ...
  store <8 x i8> %i.kw, ptr %i.kx, align 1, !tbaa !37
...
.lr.ph.i112:                                      ; preds = %.lr.ph.i112.preheader, %.lr.ph.i112
  ...
  store i8 %i.ld, ptr %i.le, align 1, !tbaa !37
...
_Z8writevecIjEvPhRmT_i.exit:                      ; preds = %.lr.ph.i112, %middle.block, %bb.cf
  ...
  %i.lf = add i64 %i.ka, %.pre-phi
  br label %bb.cg

bb.cg:                                            ; preds = %_Z8writevecIjEvPhRmT_i.exit, %_Z8writevecImEvPhRmT_i.exit
  %.1 = phi i64 [ %i.ka, %_Z8writevecImEvPhRmT_i.exit ], [ %i.lf, %_Z8writevecIjEvPhRmT_i.exit ]
  %i.lg = getelementptr inbounds nuw i8, ptr %.sroa.0123.0144, i64 16 ; 2 uses
  %.not135 = icmp eq ptr %i.lg, %i.bd
...
_ZNSt3__16vectorIhNS_9allocatorIhEEED2B8ne180100Ev.exit: ; preds = %bb.cg, %_ZNSt3__16vectorIhNS_9allocatorIhEEE6resizeEm.exit
  %i.lh = load ptr, ptr %5, align 8, !tbaa !120   ; 2 uses
  %i.li = ptrtoint ptr %i.lh to i64
  %i.lj = getelementptr inbounds nuw i8, ptr %1, i64 88
  %i.lk = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.ll = load <2 x ptr>, ptr %i.ay, align 8, !tbaa !95
  %i.lm = load ptr, ptr %i.ay, align 8, !tbaa !119
  %i.ln = ptrtoint ptr %i.lm to i64
  %i.lo = sub i64 %i.ln, %i.li
  store i64 %i.lo, ptr %i.lj, align 8, !tbaa !123
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %5, i8 0, i64 24, i1 false)
  store ptr %i.lh, ptr %0, align 8, !tbaa !120
  store <2 x ptr> %i.ll, ptr %i.lk, align 8, !tbaa !95
  %i.lp = getelementptr inbounds nuw i8, ptr %0, i64 32
  store i32 0, ptr %i.lp, align 8, !tbaa !125
  br label %.critedge62
...
bb.ci:                                            ; preds = %bb.ax, %bb.cd, %bb.r
  ...
  %i.lw = load ptr, ptr %5, align 8, !tbaa !120   ; 4 uses
  %.not.i.i118 = icmp eq ptr %i.lw, null
  br i1 %.not.i.i118, label %_ZNSt3__16vectorIhNS_9allocatorIhEEED2B8ne180100Ev.exit119, label %bb.cj

bb.cj:                                            ; preds = %bb.ci
  store ptr %i.lw, ptr %i.ay, align 8, !tbaa !119
  %i.lx = getelementptr inbounds nuw i8, ptr %5, i64 16
  %i.ly = load ptr, ptr %i.lx, align 8, !tbaa !95
...
bb.ck:                                            ; preds = %_ZN5ErrorD2Ev.exit66, %_ZNSt3__16vectorIhNS_9allocatorIhEEED2B8ne180100Ev.exit117
  %i.mc = load i32, ptr %i.a, align 8, !tbaa !40  ; 2 uses
  %i.md = icmp eq i32 %i.mc, -1
  br i1 %i.md, label %_ZN6ResultImED2Ev.exit, label %bb.cl

bb.cl:                                            ; preds = %bb.ck
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #25
  %i.me = zext i32 %i.mc to i64
  %i.mf = getelementptr inbounds nuw [8 x i8], ptr @__const._ZNSt3__116__variant_detail12__visitation6__base11__visit_altB8ne180100IZNS0_6__dtorINS0_8__traitsIJm5ErrorEEELNS0_6_TraitE1EE9__destroyB8ne180100EvEUlRT_E_JRS9_EEEDcOSA_DpOT0_.__fmatrix, i64 %i.me
  %i.mg = load ptr, ptr %i.mf, align 8, !tbaa !112
  invoke void %i.mg(ptr noundef nonnull align 1 dereferenceable(1) %2, ptr noundef nonnull align 8 dereferenceable(40) %3)
...
bb.cm:                                            ; preds = %bb.cl
  ...
  call void @__clang_call_terminate(ptr %i.mi) #29
  unreachable
