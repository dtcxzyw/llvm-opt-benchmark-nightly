...
.preheader125:                                    ; preds = %.preheader125.lr.ph, %.loopexit124
  ...
  %indvars209 = trunc i64 %indvars.iv196 to i32   ; 5 uses
...
.preheader123:                                    ; preds = %bb.o, %.preheader125
  ...
  %.neg121.peel178 = add nsw i32 %indvars209, -1  ; 2 uses
  br label %bb.p
...
bb.u:                                             ; preds = %bb.t, %.lr.ph.split.preheader
  ...
  %i.if = sub i32 %indvars209, %i.ie              ; 2 uses
...
bb.y:                                             ; preds = %bb.x, %.lr.ph.split.peel.next
  ...
  %i.ji = sub i32 %indvars209, %i.jh              ; 2 uses
...
bb.ac:                                            ; preds = %bb.ab, %.lr.ph.split.peel.next164
  ...
  %2 = sub i32 %.neg121.peel178, %i.kj            ; 2 uses
...
bb.ag:                                            ; preds = %bb.af, %.lr.ph.split.peel.next171
  ...
  %3 = sub i32 %.neg121.peel178, %i.ll            ; 2 uses
...
bb.an:                                            ; preds = %bb.am, %.lr.ph.split
  ...
  %i.ny = add nsw i32 %i.nx, %indvars209
  %4 = sub i32 %i.ny, %i.nv                       ; 2 uses
