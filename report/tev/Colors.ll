...
bb.e:                                             ; preds = %bb.d
  ...
  %i.bb = fdiv float 1.000000e+00, %i.ay
  %i.bc = fneg <2 x float> %i.r                   ; 2 uses
  %i.bd = insertelement <2 x float> poison, float %i.al, i64 0
  %i.be = insertelement <2 x float> poison, float %i.bb, i64 0 ; 2 uses
  ...
  %i.bx = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bu, <2 x float> %i.bw, <2 x float> %i.bs)
  ...
  %i.cb = fneg <4 x float> %i.bl
  %2 = shufflevector <4 x float> %i.cb, <4 x float> poison, <2 x i32> <i32 3, i32 1> ; 2 uses
  %3 = insertelement <2 x float> %2, float %i.ar, i64 0
  %4 = fmul <2 x float> %3, %i.bf
  %5 = shufflevector <2 x float> %i.be, <2 x float> poison, <3 x i32> zeroinitializer
  %6 = shufflevector <2 x float> %i.bx, <2 x float> %2, <3 x i32> <i32 0, i32 2, i32 1>
  %7 = fmul <3 x float> %5, %6
  br label %_ZN7nanogui7inverseERKNS_6MatrixIfLm3EEE.exit

_ZN7nanogui7inverseERKNS_6MatrixIfLm3EEE.exit:    ; preds = %bb.d, %bb.e
  %8 = phi <3 x float> [ %7, %bb.e ], [ zeroinitializer, %bb.d ] ; 4 uses
  %9 = phi <2 x float> [ %4, %bb.e ], [ zeroinitializer, %bb.d ] ; 2 uses
  %10 = phi <2 x float> [ %i.bp, %bb.e ], [ zeroinitializer, %bb.d ] ; 2 uses
  %i.cc = phi <2 x float> [ %i.ca, %bb.e ], [ zeroinitializer, %bb.d ] ; 2 uses
  %11 = extractelement <3 x float> %8, i64 2      ; 2 uses
  %12 = extractelement <3 x float> %8, i64 1      ; 2 uses
  %13 = extractelement <3 x float> %8, i64 0      ; 2 uses
  %i.cd = extractelement <2 x float> %i.g, i64 0
  %i.ce = tail call float @llvm.fmuladd.f32(float %11, float %i.cd, float 0.000000e+00)
  %i.cf = extractelement <2 x float> %i.g, i64 1
  %i.cg = tail call float @llvm.fmuladd.f32(float %12, float %i.cf, float %i.ce)
  %i.ch = shufflevector <2 x float> %i.g, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ci = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %10, <2 x float> %i.ch, <2 x float> zeroinitializer)
  %i.cj = shufflevector <2 x float> %i.g, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.ck = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cc, <2 x float> %i.cj, <2 x float> %i.ci)
  ...
  %i.cn = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %9, <2 x float> %i.cm, <2 x float> %i.ck)
  %i.co = tail call float @llvm.fmuladd.f32(float %13, float %i.j, float %i.cg)
  br label %bb.h
...
bb.h:                                             ; preds = %bb.f, %bb.g, %_ZN7nanogui7inverseERKNS_6MatrixIfLm3EEE.exit
  %.sroa.14141.0 = phi float [ 0.000000e+00, %bb.f ], [ 0.000000e+00, %bb.g ], [ %11, %_ZN7nanogui7inverseERKNS_6MatrixIfLm3EEE.exit ]
  %.sroa.32.0 = phi float [ 0.000000e+00, %bb.f ], [ 0.000000e+00, %bb.g ], [ %12, %_ZN7nanogui7inverseERKNS_6MatrixIfLm3EEE.exit ]
  %.sroa.50.0 = phi float [ 1.000000e+00, %bb.f ], [ 1.000000e+00, %bb.g ], [ %13, %_ZN7nanogui7inverseERKNS_6MatrixIfLm3EEE.exit ]
  ...
  %14 = phi <3 x float> [ <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00>, %bb.f ], [ <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00>, %bb.g ], [ %8, %_ZN7nanogui7inverseERKNS_6MatrixIfLm3EEE.exit ] ; 3 uses
  %i.cv = phi <2 x float> [ zeroinitializer, %bb.f ], [ zeroinitializer, %bb.g ], [ %9, %_ZN7nanogui7inverseERKNS_6MatrixIfLm3EEE.exit ] ; 2 uses
  %i.cw = phi <2 x float> [ <float 0.000000e+00, float 1.000000e+00>, %bb.f ], [ <float 0.000000e+00, float 1.000000e+00>, %bb.g ], [ %i.cc, %_ZN7nanogui7inverseERKNS_6MatrixIfLm3EEE.exit ] ; 2 uses
  %i.cx = phi <2 x float> [ <float 1.000000e+00, float 0.000000e+00>, %bb.f ], [ <float 1.000000e+00, float 0.000000e+00>, %bb.g ], [ %10, %_ZN7nanogui7inverseERKNS_6MatrixIfLm3EEE.exit ] ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ef = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %15, <2 x float> %i.ee, <2 x float> zeroinitializer)
  ...
  %i.el = shufflevector <3 x float> %14, <3 x float> poison, <2 x i32> zeroinitializer
