...
.lr.ph242.split.us:                               ; preds = %.lr.ph242.split.us, %.lr.ph242.split.us.preheader.new
  ...
  %.not216.us = icmp eq ptr %.0184240.us, null    ; 8 uses
  %7 = getelementptr inbounds nuw i8, ptr %.0184240.us, i64 1
  %.2186.us = select i1 %.not216.us, ptr null, ptr %7
  %8 = getelementptr inbounds nuw i8, ptr %.2186.us, i64 1
  %.2186.us.1 = select i1 %.not216.us, ptr null, ptr %8
  %9 = getelementptr inbounds nuw i8, ptr %.2186.us.1, i64 1
  %.2186.us.2 = select i1 %.not216.us, ptr null, ptr %9
  %10 = getelementptr inbounds nuw i8, ptr %.2186.us.2, i64 1
  %.2186.us.3 = select i1 %.not216.us, ptr null, ptr %10
  %11 = getelementptr inbounds nuw i8, ptr %.2186.us.3, i64 1
  %.2186.us.4 = select i1 %.not216.us, ptr null, ptr %11
  %12 = getelementptr inbounds nuw i8, ptr %.2186.us.4, i64 1
  %.2186.us.5 = select i1 %.not216.us, ptr null, ptr %12
  %13 = getelementptr inbounds nuw i8, ptr %.2186.us.5, i64 1
  %.2186.us.6 = select i1 %.not216.us, ptr null, ptr %13
  %i.et = getelementptr inbounds nuw i8, ptr %.2186.us.6, i64 1
