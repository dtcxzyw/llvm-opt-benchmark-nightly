...
.lr.ph437:                                        ; preds = %._crit_edge402.split
  ...
  %i.jm = getelementptr inbounds nuw i8, ptr %15, i64 20 ; 2 uses
  %i.jn = getelementptr inbounds nuw i8, ptr %15, i64 24 ; 2 uses
  %i.jo = getelementptr inbounds nuw i8, ptr %15, i64 28 ; 2 uses
...
_Z17set_chroma_pixelsPhS_hhhRK25RGB_to_YCbCr_coefficientsb.exit: ; preds = %.lr.ph434, %_Z17set_chroma_pixelsPhS_hhhRK25RGB_to_YCbCr_coefficientsb.exit
  ...
  %17 = insertelement <3 x i8> poison, i8 %i.ms, i64 0
  %18 = insertelement <3 x i8> %17, i8 %i.mr, i64 1
  %19 = insertelement <3 x i8> %18, i8 %i.mt, i64 2
  %20 = uitofp <3 x i8> %19 to <3 x float>        ; 3 uses
  %21 = load float, ptr %i.jo, align 4, !tbaa !170
  %22 = load float, ptr %i.jn, align 4, !tbaa !170
  %23 = load float, ptr %i.jm, align 4, !tbaa !170
  %24 = load <4 x float>, ptr %i.jl, align 4
  %25 = shufflevector <4 x float> %24, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %26 = load <2 x float>, ptr %i.jp, align 4, !tbaa !170 ; 2 uses
  %27 = shufflevector <2 x float> %26, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %i.mu = insertelement <2 x float> %27, float %23, i64 0
  %28 = shufflevector <3 x float> %20, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %29 = fmul <2 x float> %i.mu, %28
  %30 = shufflevector <3 x float> %20, <3 x float> poison, <2 x i32> zeroinitializer
  %i.mv = insertelement <2 x float> %25, float %21, i64 1
  %31 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %30, <2 x float> %i.mv, <2 x float> %29)
  %32 = shufflevector <3 x float> %20, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %33 = insertelement <2 x float> %26, float %22, i64 0
  %i.mw = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %32, <2 x float> %33, <2 x float> %31)
...
.lr.ph411:                                        ; preds = %bb.ca
  ...
  %i.yd = getelementptr inbounds nuw i8, ptr %15, i64 20 ; 2 uses
  %i.ye = getelementptr inbounds nuw i8, ptr %15, i64 24 ; 2 uses
  %i.yf = getelementptr inbounds nuw i8, ptr %15, i64 28 ; 2 uses
...
_Z17set_chroma_pixelsPhS_hhhRK25RGB_to_YCbCr_coefficientsb.exit356: ; preds = %.lr.ph407, %_Z17set_chroma_pixelsPhS_hhhRK25RGB_to_YCbCr_coefficientsb.exit356
  ...
  %34 = insertelement <3 x i8> poison, i8 %i.aal, i64 0
  %35 = insertelement <3 x i8> %34, i8 %i.aak, i64 1
  %36 = insertelement <3 x i8> %35, i8 %i.aam, i64 2
  %37 = uitofp <3 x i8> %36 to <3 x float>        ; 3 uses
  %38 = load float, ptr %i.yf, align 4, !tbaa !170
  %39 = load float, ptr %i.ye, align 4, !tbaa !170
  %40 = load float, ptr %i.yd, align 4, !tbaa !170
  %41 = load <4 x float>, ptr %i.yc, align 4
  %42 = shufflevector <4 x float> %41, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %43 = load <2 x float>, ptr %i.yg, align 4, !tbaa !170 ; 2 uses
  %44 = shufflevector <2 x float> %43, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %i.aan = insertelement <2 x float> %44, float %40, i64 0
  %45 = shufflevector <3 x float> %37, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %46 = fmul <2 x float> %i.aan, %45
  %47 = shufflevector <3 x float> %37, <3 x float> poison, <2 x i32> zeroinitializer
  %i.aao = insertelement <2 x float> %42, float %38, i64 1
  %48 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %47, <2 x float> %i.aao, <2 x float> %46)
  %49 = shufflevector <3 x float> %37, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %50 = insertelement <2 x float> %43, float %39, i64 0
  %i.aap = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %49, <2 x float> %50, <2 x float> %48)
