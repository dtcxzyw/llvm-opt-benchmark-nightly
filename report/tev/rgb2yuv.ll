...
_Z17set_chroma_pixelsPhS_hhhRK25RGB_to_YCbCr_coefficientsb.exit: ; preds = %.lr.ph434, %_Z17set_chroma_pixelsPhS_hhhRK25RGB_to_YCbCr_coefficientsb.exit
  ...
  %.0271431 = phi ptr [ %i.mh, %.lr.ph434 ], [ %i.mn, %_Z17set_chroma_pixelsPhS_hhhRK25RGB_to_YCbCr_coefficientsb.exit ] ; 3 uses
  ...
  %i.mq = load i8, ptr %.0271431, align 1, !tbaa !133
  %i.mr = uitofp i8 %i.mq to float
  %17 = load <2 x i8>, ptr %i.mm, align 1, !tbaa !133
  %18 = uitofp <2 x i8> %17 to <2 x float>        ; 2 uses
  ...
  %i.mx = shufflevector <2 x float> %18, <2 x float> poison, <2 x i32> zeroinitializer
  %i.my = fmul <2 x float> %i.mw, %i.mx
  %i.mz = insertelement <2 x float> poison, float %i.mr, i64 0
  ...
  %i.ne = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %19, <2 x float> %i.nd, <2 x float> %i.nc)
...
_Z17set_chroma_pixelsPhS_hhhRK25RGB_to_YCbCr_coefficientsb.exit356: ; preds = %.lr.ph407, %_Z17set_chroma_pixelsPhS_hhhRK25RGB_to_YCbCr_coefficientsb.exit356
  ...
  %.0243405 = phi ptr [ %i.aah, %.lr.ph407 ], [ %i.aan, %_Z17set_chroma_pixelsPhS_hhhRK25RGB_to_YCbCr_coefficientsb.exit356 ] ; 3 uses
  %i.aam = getelementptr inbounds nuw i8, ptr %.0243405, i64 1
  ...
  %i.aar = load i8, ptr %.0243405, align 1, !tbaa !133
  %i.aas = uitofp i8 %i.aar to float
  %20 = load <2 x i8>, ptr %i.aam, align 1, !tbaa !133
  %21 = uitofp <2 x i8> %20 to <2 x float>        ; 2 uses
  ...
  %i.aay = shufflevector <2 x float> %21, <2 x float> poison, <2 x i32> zeroinitializer
  %i.aaz = fmul <2 x float> %i.aax, %i.aay
  %i.aba = insertelement <2 x float> poison, float %i.aas, i64 0
  ...
  %i.abf = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %22, <2 x float> %i.abe, <2 x float> %i.abd)
