...
bb.i:                                             ; preds = %bb.c
  ...
  %7 = load float, ptr %i.u, align 4, !tbaa !76, !noalias !712
  %8 = load float, ptr %5, align 8, !tbaa !76, !noalias !712 ; 2 uses
  %9 = load float, ptr %6, align 4, !tbaa !76, !noalias !712 ; 2 uses
  %10 = insertelement <2 x float> poison, float %7, i64 0
  %i.bj = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.bt = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bp, <2 x float> %12, <2 x float> %i.bk)
  %i.bu = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> zeroinitializer, <2 x float> %i.bt) ; 3 uses
  ...
  %15 = shufflevector <3 x float> %i.bc, <3 x float> %i.by, <4 x i32> <i32 1, i32 poison, i32 4, i32 poison>
  %16 = insertelement <4 x float> %15, float %8, i64 1
  %i.cj = shufflevector <4 x float> %16, <4 x float> %i.bs, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
