...
begin_hunk_0_@_ZN3jxl6N_AVX24MaskERKNS_5PlaneIfEES4_RKNS_17ButteraugliParamsEPNS_8BlurTempEPS2_SA_:bb.a
  %i.it = icmp ugt i64 %i.is, -4
  br i1 %i.it, label %._crit_edge.split.us.us, label %vec.epilog.scalar.ph268

vec.epilog.scalar.ph268:                          ; preds = %vec.epilog.scalar.ph268.prol.loopexit, %vec.epilog.scalar.ph268
  %.0123.us.us = phi i64 [ %i.jj, %vec.epilog.scalar.ph268 ], [ %.0123.us.us.unr, %vec.epilog.scalar.ph268.prol.loopexit ] ; 6 uses
  %i.iu = getelementptr inbounds nuw [4 x i8], ptr %i.hz, i64 %.0123.us.us
  %i.iv = load float, ptr %i.iu, align 4, !tbaa !58
  %i.iw = getelementptr inbounds nuw [4 x i8], ptr %i.ib, i64 %.0123.us.us
  store float %i.iv, ptr %i.iw, align 4, !tbaa !58
  %i.ix = add nuw nsw i64 %.0123.us.us, 1         ; 2 uses
  %i.iy = getelementptr inbounds nuw [4 x i8], ptr %i.hz, i64 %i.ix
  %i.iz = load float, ptr %i.iy, align 4, !tbaa !58
  %i.ja = getelementptr inbounds nuw [4 x i8], ptr %i.ib, i64 %i.ix
  store float %i.iz, ptr %i.ja, align 4, !tbaa !58
  %i.jb = add nuw nsw i64 %.0123.us.us, 2         ; 2 uses
  %i.jc = getelementptr inbounds nuw [4 x i8], ptr %i.hz, i64 %i.jb
  %i.jd = load float, ptr %i.jc, align 4, !tbaa !58
  %i.je = getelementptr inbounds nuw [4 x i8], ptr %i.ib, i64 %i.jb
  store float %i.jd, ptr %i.je, align 4, !tbaa !58
  %i.jf = add nuw nsw i64 %.0123.us.us, 3         ; 2 uses
  %i.jg = getelementptr inbounds nuw [4 x i8], ptr %i.hz, i64 %i.jf
  %i.jh = load float, ptr %i.jg, align 4, !tbaa !58
  %i.ji = getelementptr inbounds nuw [4 x i8], ptr %i.ib, i64 %i.jf
  store float %i.jh, ptr %i.ji, align 4, !tbaa !58
  %i.jj = add nuw nsw i64 %.0123.us.us, 4         ; 2 uses
  %exitcond132.not.3 = icmp eq i64 %i.jj, %i.b
  br i1 %exitcond132.not.3, label %._crit_edge.split.us.us, label %vec.epilog.scalar.ph268, !llvm.loop !654

._crit_edge.split.us.us:                          ; preds = %vec.epilog.scalar.ph268.prol.loopexit, %vec.epilog.scalar.ph268, %vec.epilog.middle.block277, %middle.block264
  %i.jk = add nuw nsw i64 %.058124.us, 1          ; 2 uses
  %exitcond133.not = icmp eq i64 %i.jk, %i.e
  br i1 %exitcond133.not, label %.loopexit, label %iter.check267, !llvm.loop !655

.preheader.lr.ph.split.split:                     ; preds = %.preheader.lr.ph.split
  %i.jl = load ptr, ptr %i.hi, align 8, !tbaa !68 ; 6 uses
  %i.jm = load i64, ptr %i.hj, align 8, !tbaa !69 ; 4 uses
  %i.jn = add nsw i64 %i.e, -1                    ; 3 uses
  %i.jo = mul i64 %i.hn, %i.jn
  %i.jp = shl nuw nsw i64 %i.b, 2                 ; 5 uses
  %i.jq = getelementptr i8, ptr %i.hm, i64 %i.jo
  %scevgep173 = getelementptr i8, ptr %i.jq, i64 %i.jp ; 4 uses
  %i.jr = mul i64 %i.jm, %i.jn
  %i.js = getelementptr i8, ptr %i.jl, i64 %i.jr
  %scevgep174 = getelementptr i8, ptr %i.js, i64 %i.jp ; 4 uses
  %i.jt = mul i64 %i.hd, %i.jn
  %i.ju = getelementptr i8, ptr %i.hb, i64 %i.jt
  %scevgep175 = getelementptr i8, ptr %i.ju, i64 %i.jp ; 2 uses
  %i.jv = insertelement <4 x i64> poison, i64 %i.hn, i64 0
  %i.jw = insertelement <4 x i64> %i.jv, i64 %i.hd, i64 1
  %i.jx = shufflevector <4 x i64> %i.jw, <4 x i64> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %i.jy = insertelement <4 x i64> <i64 poison, i64 poison, i64 0, i64 poison>, i64 %i.jm, i64 0
  %i.jz = insertelement <4 x i64> %i.jy, i64 %i.hd, i64 1
  %i.ka = shufflevector <4 x i64> %i.jz, <4 x i64> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 0>
  %min.iters.check217 = icmp ult i32 %i.a, 4
  %bound0180 = icmp ult ptr %i.hm, %scevgep174
  %bound1181 = icmp ult ptr %i.jl, %scevgep173
  %found.conflict182 = and i1 %bound0180, %bound1181
  %bound0185 = icmp ult ptr %i.hm, %scevgep175
  %bound1186 = icmp ult ptr %i.hb, %scevgep173
  %found.conflict187 = and i1 %bound0185, %bound1186
  %bound0200 = icmp ult ptr %i.jl, %scevgep175
  %bound1201 = icmp ult ptr %i.hb, %scevgep174
  %found.conflict202 = and i1 %bound0200, %bound1201
  %i.kb = or <4 x i64> %i.jx, %i.ka
  %i.kc = icmp slt <4 x i64> %i.kb, zeroinitializer
  %stride.check209 = icmp slt i64 %i.jm, 0
  %i.kd = bitcast <4 x i1> %i.kc to i4
  %i.ke = icmp ne i4 %i.kd, 0
  %op.rdx = or i1 %i.ke, %found.conflict182
  %invariant.op = or i1 %found.conflict187, %op.rdx
  %min.iters.check218 = icmp ult i32 %i.a, 16
  %i.kf = and i64 %i.b, 12
  %n.vec220 = and i64 %i.b, 4294967280            ; 4 uses
  %cmp.n233 = icmp eq i64 %n.vec220, %i.b
  %min.epilog.iters.check = icmp eq i64 %i.kf, 0
  %n.vec234 = and i64 %i.b, 4294967292            ; 3 uses
  %cmp.n241 = icmp eq i64 %n.vec234, %i.b
  %xtraiter290 = and i64 %i.b, 1
  %lcmp.mod291.not = icmp eq i64 %xtraiter290, 0
  %i.kg = add nsw i64 %i.b, -1
  br label %iter.check

iter.check:                                       ; preds = %.preheader.lr.ph.split.split, %._crit_edge.split
  %.058124 = phi i64 [ 0, %.preheader.lr.ph.split.split ], [ %i.mj, %._crit_edge.split ] ; 6 uses
  %i.kh = mul i64 %i.hd, %.058124
  %i.ki = getelementptr inbounds nuw i8, ptr %i.hb, i64 %i.kh ; 6 uses
  call void @llvm.assume(i1 true) [ "align"(ptr %i.ki, i64 64) ]
  %i.kj = mul i64 %i.hn, %.058124
  %i.kk = getelementptr inbounds nuw i8, ptr %i.hm, i64 %i.kj ; 6 uses
  call void @llvm.assume(i1 true) [ "align"(ptr %i.kk, i64 64) ]
  %i.kl = load ptr, ptr %i.he, align 8            ; 2 uses
  %i.km = load i64, ptr %i.hf, align 8
  %i.kn = mul i64 %i.km, %.058124                 ; 2 uses
  %i.ko = getelementptr inbounds nuw i8, ptr %i.kl, i64 %i.kn ; 8 uses
  %i.kp = load ptr, ptr %i.hg, align 8            ; 2 uses
  %i.kq = load i64, ptr %i.hh, align 8
  %i.kr = mul i64 %i.kq, %.058124                 ; 2 uses
  %i.ks = getelementptr inbounds nuw i8, ptr %i.kp, i64 %i.kr ; 8 uses
  call void @llvm.assume(i1 true) [ "align"(ptr %i.ko, i64 64) ]
  call void @llvm.assume(i1 true) [ "align"(ptr %i.ks, i64 64) ]
  %i.kt = mul i64 %i.jm, %.058124
  %i.ku = getelementptr inbounds nuw i8, ptr %i.jl, i64 %i.kt ; 6 uses
  call void @llvm.assume(i1 true) [ "align"(ptr %i.ku, i64 64) ]
  br i1 %min.iters.check217, label %vec.epilog.scalar.ph.preheader, label %vector.memcheck172

vector.memcheck172:                               ; preds = %iter.check
  %scevgep176 = getelementptr i8, ptr %i.kl, i64 %i.jp
  %scevgep177 = getelementptr i8, ptr %scevgep176, i64 %i.kn ; 2 uses
  %scevgep178 = getelementptr i8, ptr %i.kp, i64 %i.jp
  %scevgep179 = getelementptr i8, ptr %scevgep178, i64 %i.kr ; 2 uses
  %bound0190 = icmp ult ptr %i.hm, %scevgep177
  %bound1191 = icmp ult ptr %i.ko, %scevgep173
  %found.conflict192 = and i1 %bound0190, %bound1191
  %bound0195 = icmp ult ptr %i.hm, %scevgep179
  %bound1196 = icmp ult ptr %i.ks, %scevgep173
  %found.conflict197 = and i1 %bound0195, %bound1196
  %bound0206 = icmp ult ptr %i.jl, %scevgep177
  %bound1207 = icmp ult ptr %i.ko, %scevgep174
  %found.conflict208 = and i1 %bound0206, %bound1207
  %bound0211 = icmp ult ptr %i.jl, %scevgep179
  %bound1212 = icmp ult ptr %i.ks, %scevgep174
  %found.conflict213 = and i1 %bound0211, %bound1212
  %op.rdx281 = or i1 %found.conflict197, %found.conflict202
  %op.rdx282 = or i1 %found.conflict208, %found.conflict213
  %op.rdx283.reass = or i1 %found.conflict192, %invariant.op
  %op.rdx284 = or i1 %op.rdx281, %op.rdx282
  %op.rdx285 = or i1 %op.rdx283.reass, %op.rdx284
  %op.rdx286 = or i1 %op.rdx285, %stride.check209
  br i1 %op.rdx286, label %vec.epilog.scalar.ph.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %vector.memcheck172
  br i1 %min.iters.check218, label %vec.epilog.ph, label %vector.body221

vector.body221:                                   ; preds = %vector.main.loop.iter.check, %vector.body221
  %index222 = phi i64 [ %index.next231, %vector.body221 ], [ 0, %vector.main.loop.iter.check ] ; 6 uses
  %i.kv = getelementptr inbounds nuw [4 x i8], ptr %i.ki, i64 %index222 ; 2 uses
  %i.kw = getelementptr inbounds nuw i8, ptr %i.kv, i64 32
  %wide.load223 = load <8 x float>, ptr %i.kv, align 64, !tbaa !58, !alias.scope !681
  %wide.load224 = load <8 x float>, ptr %i.kw, align 32, !tbaa !58, !alias.scope !681
  %i.kx = getelementptr inbounds nuw [4 x i8], ptr %i.kk, i64 %index222 ; 2 uses
  %i.ky = getelementptr inbounds nuw i8, ptr %i.kx, i64 32
  store <8 x float> %wide.load223, ptr %i.kx, align 64, !tbaa !58, !alias.scope !682, !noalias !683
  store <8 x float> %wide.load224, ptr %i.ky, align 32, !tbaa !58, !alias.scope !682, !noalias !683
  %i.kz = getelementptr inbounds nuw [4 x i8], ptr %i.ko, i64 %index222 ; 2 uses
  %i.la = getelementptr inbounds nuw i8, ptr %i.kz, i64 32
  %wide.load225 = load <8 x float>, ptr %i.kz, align 64, !tbaa !58, !alias.scope !684
  %wide.load226 = load <8 x float>, ptr %i.la, align 32, !tbaa !58, !alias.scope !684
  %i.lb = getelementptr inbounds nuw [4 x i8], ptr %i.ks, i64 %index222 ; 2 uses
  %i.lc = getelementptr inbounds nuw i8, ptr %i.lb, i64 32
  %wide.load227 = load <8 x float>, ptr %i.lb, align 64, !tbaa !58, !alias.scope !685
  %wide.load228 = load <8 x float>, ptr %i.lc, align 32, !tbaa !58, !alias.scope !685
  %i.ld = fsub <8 x float> %wide.load225, %wide.load227 ; 2 uses
  %i.le = fsub <8 x float> %wide.load226, %wide.load228 ; 2 uses
  %i.lf = fmul <8 x float> %i.ld, splat (float 1.000000e+01)
  %i.lg = fmul <8 x float> %i.le, splat (float 1.000000e+01)
  %i.lh = getelementptr inbounds nuw [4 x i8], ptr %i.ku, i64 %index222 ; 3 uses
  %i.li = getelementptr inbounds nuw i8, ptr %i.lh, i64 32 ; 2 uses
  %wide.load229 = load <8 x float>, ptr %i.lh, align 64, !tbaa !58, !alias.scope !686, !noalias !687
  %wide.load230 = load <8 x float>, ptr %i.li, align 32, !tbaa !58, !alias.scope !686, !noalias !687
  %i.lj = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.lf, <8 x float> %i.ld, <8 x float> %wide.load229)
  %i.lk = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.lg, <8 x float> %i.le, <8 x float> %wide.load230)
  store <8 x float> %i.lj, ptr %i.lh, align 64, !tbaa !58, !alias.scope !686, !noalias !687
  store <8 x float> %i.lk, ptr %i.li, align 32, !tbaa !58, !alias.scope !686, !noalias !687
  %index.next231 = add nuw i64 %index222, 16      ; 2 uses
  %i.ll = icmp eq i64 %index.next231, %n.vec220
  br i1 %i.ll, label %middle.block232, label %vector.body221, !llvm.loop !662

middle.block232:                                  ; preds = %vector.body221
  br i1 %cmp.n233, label %._crit_edge.split, label %vec.epilog.iter.check

vec.epilog.iter.check:                            ; preds = %middle.block232
  br i1 %min.epilog.iters.check, label %vec.epilog.scalar.ph.preheader, label %vec.epilog.ph, !prof !688

vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec220, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index235 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next240, %vec.epilog.vector.body ] ; 6 uses
  %i.lm = getelementptr inbounds nuw [4 x i8], ptr %i.ki, i64 %index235
  %wide.load236 = load <4 x float>, ptr %i.lm, align 16, !tbaa !58, !alias.scope !681
  %i.ln = getelementptr inbounds nuw [4 x i8], ptr %i.kk, i64 %index235
  store <4 x float> %wide.load236, ptr %i.ln, align 16, !tbaa !58, !alias.scope !682, !noalias !683
  %i.lo = getelementptr inbounds nuw [4 x i8], ptr %i.ko, i64 %index235
  %wide.load237 = load <4 x float>, ptr %i.lo, align 16, !tbaa !58, !alias.scope !684
  %i.lp = getelementptr inbounds nuw [4 x i8], ptr %i.ks, i64 %index235
  %wide.load238 = load <4 x float>, ptr %i.lp, align 16, !tbaa !58, !alias.scope !685
  %i.lq = fsub <4 x float> %wide.load237, %wide.load238 ; 2 uses
  %i.lr = fmul <4 x float> %i.lq, splat (float 1.000000e+01)
  %i.ls = getelementptr inbounds nuw [4 x i8], ptr %i.ku, i64 %index235 ; 2 uses
  %wide.load239 = load <4 x float>, ptr %i.ls, align 16, !tbaa !58, !alias.scope !686, !noalias !687
  %i.lt = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.lr, <4 x float> %i.lq, <4 x float> %wide.load239)
  store <4 x float> %i.lt, ptr %i.ls, align 16, !tbaa !58, !alias.scope !686, !noalias !687
  %index.next240 = add nuw i64 %index235, 4       ; 2 uses
  %i.lu = icmp eq i64 %index.next240, %n.vec234
  br i1 %i.lu, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !663
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader
  %i.lv = getelementptr inbounds nuw [4 x i8], ptr %i.ki, i64 %.0123.ph
  %i.lw = load float, ptr %i.lv, align 16, !tbaa !58
  %i.lx = getelementptr inbounds nuw [4 x i8], ptr %i.kk, i64 %.0123.ph
  store float %i.lw, ptr %i.lx, align 16, !tbaa !58
  %i.ly = getelementptr inbounds nuw [4 x i8], ptr %i.ko, i64 %.0123.ph
  %i.lz = load float, ptr %i.ly, align 16, !tbaa !58
  %i.ma = getelementptr inbounds nuw [4 x i8], ptr %i.ks, i64 %.0123.ph
  %i.mb = load float, ptr %i.ma, align 16, !tbaa !58
  %i.mc = fsub float %i.lz, %i.mb                 ; 2 uses
  %i.md = fmul float %i.mc, 1.000000e+01
  %i.me = getelementptr inbounds nuw [4 x i8], ptr %i.ku, i64 %.0123.ph ; 2 uses
  %i.mf = load float, ptr %i.me, align 16, !tbaa !58
  %i.mg = call float @llvm.fmuladd.f32(float %i.md, float %i.mc, float %i.mf)
  store float %i.mg, ptr %i.me, align 16, !tbaa !58
  %i.mh = or disjoint i64 %.0123.ph, 1
  br label %vec.epilog.scalar.ph.prol.loopexit

vec.epilog.scalar.ph.prol.loopexit:               ; preds = %vec.epilog.scalar.ph.prol, %vec.epilog.scalar.ph.preheader
  %.0123.unr = phi i64 [ %.0123.ph, %vec.epilog.scalar.ph.preheader ], [ %i.mh, %vec.epilog.scalar.ph.prol ]
  %i.mi = icmp eq i64 %.0123.ph, %i.kg
  br i1 %i.mi, label %._crit_edge.split, label %vec.epilog.scalar.ph

._crit_edge.split:                                ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %vec.epilog.middle.block, %middle.block232
  %i.mj = add nuw nsw i64 %.058124, 1             ; 2 uses
  %exitcond131.not = icmp eq i64 %i.mj, %i.e
  br i1 %exitcond131.not, label %.loopexit, label %iter.check, !llvm.loop !655

vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  %.0123 = phi i64 [ %i.nj, %vec.epilog.scalar.ph ], [ %.0123.unr, %vec.epilog.scalar.ph.prol.loopexit ] ; 7 uses
  %i.mk = getelementptr inbounds nuw [4 x i8], ptr %i.ki, i64 %.0123
  %i.ml = load float, ptr %i.mk, align 4, !tbaa !58
  %i.mm = getelementptr inbounds nuw [4 x i8], ptr %i.kk, i64 %.0123
  store float %i.ml, ptr %i.mm, align 4, !tbaa !58
  %i.mn = getelementptr inbounds nuw [4 x i8], ptr %i.ko, i64 %.0123
  %i.mo = load float, ptr %i.mn, align 4, !tbaa !58
  %i.mp = getelementptr inbounds nuw [4 x i8], ptr %i.ks, i64 %.0123
  %i.mq = load float, ptr %i.mp, align 4, !tbaa !58
  %i.mr = fsub float %i.mo, %i.mq                 ; 2 uses
  %i.ms = fmul float %i.mr, 1.000000e+01
  %i.mt = getelementptr inbounds nuw [4 x i8], ptr %i.ku, i64 %.0123 ; 2 uses
  %i.mu = load float, ptr %i.mt, align 4, !tbaa !58
  %i.mv = call float @llvm.fmuladd.f32(float %i.ms, float %i.mr, float %i.mu)
  store float %i.mv, ptr %i.mt, align 4, !tbaa !58
  %i.mw = add nuw nsw i64 %.0123, 1               ; 5 uses
  %i.mx = getelementptr inbounds nuw [4 x i8], ptr %i.ki, i64 %i.mw
  %i.my = load float, ptr %i.mx, align 4, !tbaa !58
  %i.mz = getelementptr inbounds nuw [4 x i8], ptr %i.kk, i64 %i.mw
  store float %i.my, ptr %i.mz, align 4, !tbaa !58
  %i.na = getelementptr inbounds nuw [4 x i8], ptr %i.ko, i64 %i.mw
  %i.nb = load float, ptr %i.na, align 4, !tbaa !58
  %i.nc = getelementptr inbounds nuw [4 x i8], ptr %i.ks, i64 %i.mw
  %i.nd = load float, ptr %i.nc, align 4, !tbaa !58
  %i.ne = fsub float %i.nb, %i.nd                 ; 2 uses
  %i.nf = fmul float %i.ne, 1.000000e+01
  %i.ng = getelementptr inbounds nuw [4 x i8], ptr %i.ku, i64 %i.mw ; 2 uses
  %i.nh = load float, ptr %i.ng, align 4, !tbaa !58
  %i.ni = call float @llvm.fmuladd.f32(float %i.nf, float %i.ne, float %i.nh)
  store float %i.ni, ptr %i.ng, align 4, !tbaa !58
  %i.nj = add nuw nsw i64 %.0123, 2               ; 2 uses
  %exitcond.not.1 = icmp eq i64 %i.nj, %i.b
  br i1 %exitcond.not.1, label %._crit_edge.split, label %vec.epilog.scalar.ph, !llvm.loop !664

.loopexit:                                        ; preds = %._crit_edge.split, %._crit_edge.split.us.us, %.preheader122, %.preheader.lr.ph, %_ZN3jxl6N_AVX214DiffPrecomputeERKNS_5PlaneIfEEffPS2_.exit77, %bb.l
  %.sroa.0.0 = phi i32 [ %i.gy, %bb.l ], [ %i.gw, %_ZN3jxl6N_AVX214DiffPrecomputeERKNS_5PlaneIfEEffPS2_.exit77 ], [ 0, %.preheader.lr.ph ], [ 0, %._crit_edge.split.us.us ], [ 0, %.preheader122 ], [ 0, %._crit_edge.split ] ; 2 uses
  call void @_ZN3jxl13AlignedMemoryD1Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %i.ci) #45
  call void @llvm.lifetime.end.p0(ptr nonnull %20) #46
  %.pr = load i32, ptr %i.bz, align 8, !tbaa !77
  %i.nk = icmp eq i32 %.pr, 0
  br i1 %i.nk, label %bb.m, label %.thread

bb.m:                                             ; preds = %.loopexit
  call void @_ZN3jxl13AlignedMemoryD1Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %i.cj) #45
  br label %.thread

.thread:                                          ; preds = %_ZN3jxl5PlaneIfE6CreateEP22JxlMemoryManagerStructmmm.exit67, %bb.m, %.loopexit
  %.sroa.0.1104 = phi i32 [ %.sroa.0.0, %bb.m ], [ %.sroa.0.0, %.loopexit ], [ %i.cg, %_ZN3jxl5PlaneIfE6CreateEP22JxlMemoryManagerStructmmm.exit67 ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %19) #46
  call void @_ZN3jxl13AlignedMemoryD1Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %i.bs) #45
  call void @llvm.lifetime.end.p0(ptr nonnull %18) #46
  %.pr105 = load i32, ptr %i.bj, align 8, !tbaa !77
  %i.nl = icmp eq i32 %.pr105, 0
  br i1 %i.nl, label %bb.n, label %.thread106

bb.n:                                             ; preds = %.thread
  call void @_ZN3jxl13AlignedMemoryD1Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %i.bt) #45
  br label %.thread106

.thread106:                                       ; preds = %_ZN3jxl5PlaneIfE6CreateEP22JxlMemoryManagerStructmmm.exit65, %bb.n, %.thread
  %.sroa.0.2108 = phi i32 [ %.sroa.0.1104, %bb.n ], [ %.sroa.0.1104, %.thread ], [ %i.bq, %_ZN3jxl5PlaneIfE6CreateEP22JxlMemoryManagerStructmmm.exit65 ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %17) #46
  call void @_ZN3jxl13AlignedMemoryD1Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %i.bc) #45
  call void @llvm.lifetime.end.p0(ptr nonnull %16) #46
  %.pr109 = load i32, ptr %i.at, align 8, !tbaa !77
  %i.nm = icmp eq i32 %.pr109, 0
  br i1 %i.nm, label %bb.o, label %.thread110

bb.o:                                             ; preds = %.thread106
  call void @_ZN3jxl13AlignedMemoryD1Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %i.bd) #45
  br label %.thread110

.thread110:                                       ; preds = %_ZN3jxl5PlaneIfE6CreateEP22JxlMemoryManagerStructmmm.exit63, %bb.o, %.thread106
  %.sroa.0.3112 = phi i32 [ %.sroa.0.2108, %bb.o ], [ %.sroa.0.2108, %.thread106 ], [ %i.ba, %_ZN3jxl5PlaneIfE6CreateEP22JxlMemoryManagerStructmmm.exit63 ] ; 2 uses
  ...
  %.pr113 = load i32, ptr %i.ad, align 8, !tbaa !77
  %i.nn = icmp eq i32 %.pr113, 0
  br i1 %i.nn, label %bb.p, label %.thread114

bb.p:                                             ; preds = %.thread110
  call void @_ZN3jxl13AlignedMemoryD1Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %i.an) #45
  br label %.thread114

.thread114:                                       ; preds = %_ZN3jxl5PlaneIfE6CreateEP22JxlMemoryManagerStructmmm.exit61, %bb.p, %.thread110
  %.sroa.0.4116 = phi i32 [ %.sroa.0.3112, %bb.p ], [ %.sroa.0.3112, %.thread110 ], [ %i.ak, %_ZN3jxl5PlaneIfE6CreateEP22JxlMemoryManagerStructmmm.exit61 ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %13) #46
  %.pr117 = load i32, ptr %i.j, align 8, !tbaa !77
  %i.no = icmp eq i32 %.pr117, 0
  br i1 %i.no, label %bb.q, label %_ZN3jxl8StatusOrINS_5PlaneIfEEED2Ev.exit81

bb.q:                                             ; preds = %.thread114
  call void @_ZN3jxl13AlignedMemoryD1Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %i.t) #45
  br label %_ZN3jxl8StatusOrINS_5PlaneIfEEED2Ev.exit81

_ZN3jxl8StatusOrINS_5PlaneIfEEED2Ev.exit81:       ; preds = %_ZN3jxl5PlaneIfE6CreateEP22JxlMemoryManagerStructmmm.exit, %.thread114, %bb.q
  %.sroa.0.5120 = phi i32 [ %.sroa.0.4116, %bb.q ], [ %.sroa.0.4116, %.thread114 ], [ %i.q, %_ZN3jxl5PlaneIfE6CreateEP22JxlMemoryManagerStructmmm.exit ]
  call void @llvm.lifetime.end.p0(ptr nonnull %11) #46
  ret i32 %.sroa.0.5120
}

; Function Attrs: mustprogress nounwind uwtable
define hidden i32 @_ZN3jxl6N_AVX215MaskPsychoImageERKNS_11PsychoImageES3_mmRKNS_17ButteraugliParamsEPNS_8BlurTempEPNS_5PlaneIfEESB_(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(560) %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(560) %1, i64 noundef %2, i64 noundef %3, ptr nofree nonnull readnone align 4 captures(none) %4, ptr noundef %5, ptr noalias noundef %6, ptr noalias nofree noundef readonly captures(address_is_null) %7) #16 {
bb.a:
  %8 = alloca %"class.jxl::Plane", align 8        ; 8 uses
  %9 = alloca %"class.jxl::Plane", align 8        ; 8 uses
  %10 = alloca %"class.jxl::StatusOr", align 8    ; 10 uses
  %11 = alloca %"class.jxl::Plane", align 8       ; 8 uses
  %12 = alloca %"class.jxl::StatusOr", align 8    ; 10 uses
  %13 = alloca %"class.jxl::Plane", align 8       ; 8 uses
  ...
  %i.e = trunc nuw i64 %3 to i32                  ; 2 uses
  %i.f = or i64 %2, %3
  %or.cond = icmp ult i64 %i.f, 4294967296
  br i1 %or.cond, label %bb.b, label %_ZN3jxl8StatusOrINS_5PlaneIfEEED2Ev.exit32

bb.b:                                             ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %9) #46, !noalias !713
  call void @_ZN3jxl6detail9PlaneBaseC2Ejjm(ptr noundef nonnull align 8 dereferenceable(56) %9, i32 noundef %i.d, i32 noundef %i.e, i64 noundef 4) #45, !noalias !713
  %i.g = call i32 @_ZN3jxl6detail9PlaneBase8AllocateEP22JxlMemoryManagerStructm(ptr noundef nonnull align 8 dereferenceable(56) %9, ptr noundef %i.c, i64 noundef 0) #45, !noalias !713 ; 2 uses
  %i.h = icmp eq i32 %i.g, 0
  %i.i = getelementptr inbounds nuw i8, ptr %10, i64 56 ; 3 uses
  br i1 %i.h, label %.critedge.i, label %bb.c

bb.c:                                             ; preds = %bb.b
  store i32 %i.g, ptr %i.i, align 8, !tbaa !77, !alias.scope !713
  br label %_ZN3jxl5PlaneIfE6CreateEP22JxlMemoryManagerStructmmm.exit

.critedge.i:                                      ; preds = %bb.b
  store i32 0, ptr %i.i, align 8, !tbaa !77, !alias.scope !713
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(60) %10, ptr noundef nonnull align 8 dereferenceable(56) %9, i64 24, i1 false)
  %i.j = getelementptr inbounds nuw i8, ptr %10, i64 24
  %i.k = getelementptr inbounds nuw i8, ptr %9, i64 24
  call void @_ZN3jxl13AlignedMemoryC1EOS0_(ptr noundef nonnull align 8 dereferenceable(24) %i.j, ptr noundef nonnull align 8 dereferenceable(24) %i.k) #45
  %i.l = getelementptr inbounds nuw i8, ptr %10, i64 48
  %i.m = getelementptr inbounds nuw i8, ptr %9, i64 48
  %i.n = load i64, ptr %i.m, align 8, !tbaa !78, !noalias !713
  store i64 %i.n, ptr %i.l, align 8, !tbaa !78, !alias.scope !713
  br label %_ZN3jxl5PlaneIfE6CreateEP22JxlMemoryManagerStructmmm.exit
...
_ZN3jxl5PlaneIfE6CreateEP22JxlMemoryManagerStructmmm.exit: ; preds = %bb.c, %.critedge.i
  ...
  call void @_ZN3jxl13AlignedMemoryD1Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %i.o) #45
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #46, !noalias !713
  %.pre = load i32, ptr %i.i, align 8, !tbaa !77  ; 2 uses
  %i.p = getelementptr inbounds nuw i8, ptr %10, i64 56
  %i.q = icmp eq i32 %.pre, 0
  br i1 %i.q, label %bb.d, label %_ZN3jxl8StatusOrINS_5PlaneIfEEED2Ev.exit32
...
bb.d:                                             ; preds = %_ZN3jxl5PlaneIfE6CreateEP22JxlMemoryManagerStructmmm.exit
  ...
  %i.r = getelementptr inbounds nuw i8, ptr %11, i64 24 ; 2 uses
  %i.s = getelementptr inbounds nuw i8, ptr %10, i64 24 ; 2 uses
  call void @_ZN3jxl13AlignedMemoryC1EOS0_(ptr noundef nonnull align 8 dereferenceable(24) %i.r, ptr noundef nonnull align 8 dereferenceable(24) %i.s) #45
  %i.t = getelementptr inbounds nuw i8, ptr %11, i64 48
  %i.u = getelementptr inbounds nuw i8, ptr %10, i64 48
  %i.v = load i64, ptr %i.u, align 8, !tbaa !78, !noalias !714
  store i64 %i.v, ptr %i.t, align 8, !tbaa !78, !alias.scope !714
  call void @llvm.lifetime.start.p0(ptr nonnull %12) #46
  call void @llvm.experimental.noalias.scope.decl(metadata !715)
end_hunk_0
begin_hunk_1_@_ZN3jxl6N_SSE215SeparateMFAndHFERKNS_17ButteraugliParamsEPNS_6Image3IfEEPNS_5PlaneIfEEPNS_8BlurTempE:bb.a
...
end_hunk_1
begin_hunk_2_@_ZN3jxl6N_SSE216SeparateHFAndUHFERKNS_17ButteraugliParamsEPNS_5PlaneIfEES6_PNS_8BlurTempE:bb.a
...
end_hunk_2
begin_hunk_3_@_ZN3jxl6N_SSE225ButteraugliDiffmapInPlaceERNS_6Image3IfEES3_RKNS_17ButteraugliParamsERNS_5PlaneIfEE:bb.a
