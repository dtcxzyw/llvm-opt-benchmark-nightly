...
bb.p:                                             ; preds = %._crit_edge78, %bb.l
  ...
  %i.bl = mul i32 %i.bk, %i.e                     ; 3 uses
  %i.bm = sext i32 %i.bl to i64                   ; 7 uses
