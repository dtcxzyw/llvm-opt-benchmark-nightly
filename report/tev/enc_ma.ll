...
iter.check1336:                                   ; preds = %bb.am
  ...
  %i.wt = mul nsw i64 %.2787, 12
  %i.wu = add nsw i64 %i.wt, -12
  %.neg = mul i64 %.2790, -12
...
iter.check1307:                                   ; preds = %bb.ap
  ...
  %i.xs = mul nsw i64 %.2787, 12
  %i.xt = add nsw i64 %i.xs, -12
...
iter.check1278:                                   ; preds = %.loopexit
  ...
  %i.yr = mul nsw i64 %.2787, 12
  %i.ys = add nsw i64 %i.yr, -12
...
iter.check1249:                                   ; preds = %bb.au
  ...
  %i.zq = mul nsw i64 %.2787, 12
  %i.zr = add nsw i64 %i.zq, -12
