...
._crit_edge938:                                   ; preds = %._crit_edge, %_ZNSt3__16vectorIiNS_9allocatorIiEEEC2Em.exit
  ...
  %18 = load ptr, ptr %i.k, align 8, !tbaa !59
  %19 = ptrtoint ptr %spec.select.i.i.i to i64
  %i.ew = ptrtoint ptr %18 to i64
  %i.ex = sub i64 %19, %i.ew                      ; 2 uses
...
._crit_edge938:                                   ; preds = %._crit_edge, %_ZNSt3__16vectorIiNS_9allocatorIiEEEC2Em.exit
  ...
  %18 = load ptr, ptr %i.k, align 8, !tbaa !59
  %19 = ptrtoint ptr %spec.select.i.i.i to i64
  %i.fh = ptrtoint ptr %18 to i64
  %i.fi = sub i64 %19, %i.fh                      ; 2 uses
...
bb.s:                                             ; preds = %bb.r
  ...
  %spec.select.i.i.i = select i1 %.not.not.i.i.i, ptr %i.cn, ptr %i.cs ; 2 uses
  %i.ct = ptrtoint ptr %spec.select.i.i.i to i64
  %i.cu = sub i64 %i.ct, %i.cp
  %i.cv = getelementptr inbounds i8, ptr %i.cl, i64 %i.cu ; 3 uses
