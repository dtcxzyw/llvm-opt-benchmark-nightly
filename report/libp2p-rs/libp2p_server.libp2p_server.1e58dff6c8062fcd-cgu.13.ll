...
bb.b:                                             ; preds = %bb.a
  %.sroa.0.0.copyload.i.i = load i128, ptr %i.c, align 1, !alias.scope !4314, !noalias !4315 ; 16 uses
  %.sroa.0.0.extract.trunc.i.i.i = trunc i128 %.sroa.0.0.copyload.i.i to i64
  %.sroa.4.0.extract.shift.i.i.i = lshr i128 %.sroa.0.0.copyload.i.i, 8
  %.sroa.4.0.extract.trunc.i.i.i = trunc i128 %.sroa.4.0.extract.shift.i.i.i to i64
  %.sroa.5.0.extract.shift.i.i.i = lshr i128 %.sroa.0.0.copyload.i.i, 16
  %.sroa.5.0.extract.trunc.i.i.i = trunc i128 %.sroa.5.0.extract.shift.i.i.i to i64
  %.sroa.6.0.extract.shift.i.i.i = lshr i128 %.sroa.0.0.copyload.i.i, 24
  %.sroa.0.0.extract.trunc.i.i.i.a = trunc i128 %.sroa.6.0.extract.shift.i.i.i to i64
  %.sroa.7.0.extract.shift.i.i.i = lshr i128 %.sroa.0.0.copyload.i.i, 32
  %.sroa.7.0.extract.trunc.i.i.i = trunc i128 %.sroa.7.0.extract.shift.i.i.i to i64
  %.sroa.8.0.extract.shift.i.i.i = lshr i128 %.sroa.0.0.copyload.i.i, 40
  %.sroa.8.0.extract.trunc.i.i.i = trunc i128 %.sroa.8.0.extract.shift.i.i.i to i64
  %.sroa.9.0.extract.shift.i.i.i = lshr i128 %.sroa.0.0.copyload.i.i, 48
  %.sroa.9.0.extract.trunc.i.i.i = trunc i128 %.sroa.9.0.extract.shift.i.i.i to i64
  %.sroa.10.0.extract.shift.i.i.i = lshr i128 %.sroa.0.0.copyload.i.i, 56
  %.sroa.10.0.extract.trunc.i.i.i = trunc i128 %.sroa.10.0.extract.shift.i.i.i to i64
  ...
  %i.d = and i64 %.sroa.0.0.extract.trunc.i.i.i, 255
  %i.e = xor i64 %i.d, -8517097267634966620
  %i.f = mul i64 %i.e, 1099511628211
  %i.g = and i64 %.sroa.4.0.extract.trunc.i.i.i, 255
  %i.h = xor i64 %i.f, %i.g
  %i.i = mul i64 %i.h, 1099511628211
  %i.j = and i64 %.sroa.5.0.extract.trunc.i.i.i, 255
  %i.k = xor i64 %i.i, %i.j
  %i.l = mul i64 %i.k, 1099511628211
  %i.m = and i64 %.sroa.0.0.extract.trunc.i.i.i.a, 255
  %i.n = xor i64 %i.l, %i.m
  %i.o = mul i64 %i.n, 1099511628211
  %i.p = and i64 %.sroa.7.0.extract.trunc.i.i.i, 255
  %i.q = xor i64 %i.o, %i.p
  %i.r = mul i64 %i.q, 1099511628211
  %i.s = and i64 %.sroa.8.0.extract.trunc.i.i.i, 255
  %i.t = xor i64 %i.r, %i.s
  %i.u = mul i64 %i.t, 1099511628211
  %i.v = and i64 %.sroa.9.0.extract.trunc.i.i.i, 255
  %i.w = xor i64 %i.u, %i.v
  %i.x = mul i64 %i.w, 1099511628211
  %2 = and i64 %.sroa.10.0.extract.trunc.i.i.i, 255
  %i.y = xor i64 %i.x, %2
