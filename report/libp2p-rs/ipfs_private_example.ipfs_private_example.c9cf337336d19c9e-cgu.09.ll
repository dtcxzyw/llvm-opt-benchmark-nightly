...
vec.epilog.vector.body219:                        ; preds = %vec.epilog.vector.body219, %vec.epilog.ph217
  ...
  %i.tk = getelementptr inbounds nuw i8, ptr %i.av, i64 %index220
  %wide.load221 = load <4 x i8>, ptr %i.tk, align 1, !noalias !4334
  %i.tl = getelementptr inbounds nuw i8, ptr %i.aw, i64 %index220
  %i.tm = getelementptr inbounds nuw i8, ptr %i.s, i64 %index220
  %wide.load222 = load <4 x i8>, ptr %i.tm, align 4, !alias.scope !4335, !noalias !4336
  %i.tn = xor <4 x i8> %wide.load222, %wide.load221
  store <4 x i8> %i.tn, ptr %i.tl, align 1, !noalias !4334
  %index.next223 = add nuw i64 %index220, 4       ; 2 uses
  %i.to = icmp eq i64 %index.next223, %n.vec218
  br i1 %i.to, label %vec.epilog.middle.block224, label %vec.epilog.vector.body219, !llvm.loop !4274
...
vec.epilog.scalar.ph214.prol:                     ; preds = %vec.epilog.scalar.ph214.preheader, %vec.epilog.scalar.ph214.prol
  %.sroa.01.0.i1.i.i.prol = phi i64 [ %i.ts, %vec.epilog.scalar.ph214.prol ], [ %.sroa.01.0.i1.i.i.ph, %vec.epilog.scalar.ph214.preheader ] ; 4 uses
  %prol.iter267 = phi i64 [ %prol.iter267.next, %vec.epilog.scalar.ph214.prol ], [ 0, %vec.epilog.scalar.ph214.preheader ]
  %i.tp = getelementptr inbounds nuw i8, ptr %i.av, i64 %.sroa.01.0.i1.i.i.prol
  %i.tq = load i8, ptr %i.tp, align 1, !noalias !4334, !noundef !7
  %i.tr = getelementptr inbounds nuw i8, ptr %i.aw, i64 %.sroa.01.0.i1.i.i.prol
  %i.ts = add nuw nsw i64 %.sroa.01.0.i1.i.i.prol, 1 ; 2 uses
  %i.tt = getelementptr inbounds nuw i8, ptr %i.s, i64 %.sroa.01.0.i1.i.i.prol
  %i.tu = load i8, ptr %i.tt, align 1, !alias.scope !4335, !noalias !4336, !noundef !7
  %i.tv = xor i8 %i.tu, %i.tq
  store i8 %i.tv, ptr %i.tr, align 1, !noalias !4334
...
vec.epilog.scalar.ph214.prol.loopexit:            ; preds = %vec.epilog.scalar.ph214.prol, %vec.epilog.scalar.ph214.preheader
  %.sroa.01.0.i1.i.i.unr = phi i64 [ %.sroa.01.0.i1.i.i.ph, %vec.epilog.scalar.ph214.preheader ], [ %i.ts, %vec.epilog.scalar.ph214.prol ]
  %i.tw = sub nsw i64 %.sroa.01.0.i1.i.i.ph, %i.au
  %i.tx = icmp ugt i64 %i.tw, -4
  br i1 %i.tx, label %.loopexit, label %vec.epilog.scalar.ph214

vec.epilog.scalar.ph214:                          ; preds = %vec.epilog.scalar.ph214.prol.loopexit, %vec.epilog.scalar.ph214
  %.sroa.01.0.i1.i.i = phi i64 [ %i.uw, %vec.epilog.scalar.ph214 ], [ %.sroa.01.0.i1.i.i.unr, %vec.epilog.scalar.ph214.prol.loopexit ] ; 7 uses
  %i.ty = getelementptr inbounds nuw i8, ptr %i.av, i64 %.sroa.01.0.i1.i.i
  %i.tz = load i8, ptr %i.ty, align 1, !noalias !4334, !noundef !7
  %i.ua = getelementptr inbounds nuw i8, ptr %i.aw, i64 %.sroa.01.0.i1.i.i
  %i.ub = add nuw nsw i64 %.sroa.01.0.i1.i.i, 1   ; 3 uses
  %i.uc = getelementptr inbounds nuw i8, ptr %i.s, i64 %.sroa.01.0.i1.i.i
  %i.ud = load i8, ptr %i.uc, align 1, !alias.scope !4335, !noalias !4336, !noundef !7
  %i.ue = xor i8 %i.ud, %i.tz
  store i8 %i.ue, ptr %i.ua, align 1, !noalias !4334
  %i.uf = getelementptr inbounds nuw i8, ptr %i.av, i64 %i.ub
  %i.ug = load i8, ptr %i.uf, align 1, !noalias !4334, !noundef !7
  %i.uh = getelementptr inbounds nuw i8, ptr %i.aw, i64 %i.ub
  %i.ui = add nuw nsw i64 %.sroa.01.0.i1.i.i, 2   ; 3 uses
  %i.uj = getelementptr inbounds nuw i8, ptr %i.s, i64 %i.ub
  %i.uk = load i8, ptr %i.uj, align 1, !alias.scope !4335, !noalias !4336, !noundef !7
  %i.ul = xor i8 %i.uk, %i.ug
  store i8 %i.ul, ptr %i.uh, align 1, !noalias !4334
  %i.um = getelementptr inbounds nuw i8, ptr %i.av, i64 %i.ui
  %i.un = load i8, ptr %i.um, align 1, !noalias !4334, !noundef !7
  %i.uo = getelementptr inbounds nuw i8, ptr %i.aw, i64 %i.ui
  %i.up = add nuw nsw i64 %.sroa.01.0.i1.i.i, 3   ; 3 uses
  %i.uq = getelementptr inbounds nuw i8, ptr %i.s, i64 %i.ui
  %i.ur = load i8, ptr %i.uq, align 1, !alias.scope !4335, !noalias !4336, !noundef !7
  %i.us = xor i8 %i.ur, %i.un
  store i8 %i.us, ptr %i.uo, align 1, !noalias !4334
  %i.ut = getelementptr inbounds nuw i8, ptr %i.av, i64 %i.up
  %i.uu = load i8, ptr %i.ut, align 1, !noalias !4334, !noundef !7
  %i.uv = getelementptr inbounds nuw i8, ptr %i.aw, i64 %i.up
  %i.uw = add nuw nsw i64 %.sroa.01.0.i1.i.i, 4   ; 2 uses
  %i.ux = getelementptr inbounds nuw i8, ptr %i.s, i64 %i.up
  %i.uy = load i8, ptr %i.ux, align 1, !alias.scope !4335, !noalias !4336, !noundef !7
  %i.uz = xor i8 %i.uy, %i.uu
  store i8 %i.uz, ptr %i.uv, align 1, !noalias !4334
  %exitcond.not.i8.i.3 = icmp eq i64 %i.uw, %i.au
...
.loopexit:                                        ; preds = %vec.epilog.scalar.ph214.prol.loopexit, %vec.epilog.scalar.ph214, %vec.epilog.middle.block224, %middle.block210
  %i.va = trunc nuw nsw i64 %i.au to i8
  store i8 %i.va, ptr %i.s, align 4, !alias.scope !4337, !noalias !4338
