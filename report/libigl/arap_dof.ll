...
begin_hunk_0_@_ZN5Eigen8internal29general_matrix_matrix_productIldLi0ELb0EdLi0ELb0ELi0ELi1EE3runElllPKdlS4_lPdlldRNS0_15level3_blockingIddEEPNS0_16GemmParallelInfoIlEE:bb.a
...
.loopexit.us:                                     ; preds = %bb.r
  ...
  br i1 %i.cg, label %bb.r, label %..loopexit177_crit_edge.split.us198, !llvm.loop !719

..loopexit177_crit_edge.split.us198:              ; preds = %.loopexit.us
  %i.ch = icmp slt i64 %i.bz, %0
  br i1 %i.ch, label %.lr.ph183.us, label %._crit_edge, !llvm.loop !720
...
bb.a:
  ...
  tail call void asm sideeffect "#EIGEN PRODUCT PACK LHS", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !721
  %i.b = sdiv i64 %4, 4
...
.preheader64.us.new:                              ; preds = %.preheader64.us, %.preheader64.us.new
  ...
  %i.l = load ptr, ptr %2, align 8, !tbaa !76
  %i.m = load i64, ptr %i.j, align 8, !tbaa !78
  ...
  %i.q = load <2 x double>, ptr %i.p, align 1, !tbaa !54
  %i.r = getelementptr i8, ptr %i.o, i64 16
  %i.s = getelementptr [8 x i8], ptr %i.r, i64 %i.n
  %i.t = load <2 x double>, ptr %i.s, align 1, !tbaa !54
  %i.u = getelementptr inbounds [8 x i8], ptr %1, i64 %.15765.us ; 2 uses
  store <2 x double> %i.q, ptr %i.u, align 16, !tbaa !54
  %i.v = getelementptr i8, ptr %i.u, i64 16
  store <2 x double> %i.t, ptr %i.v, align 16, !tbaa !54
  %i.w = or disjoint i64 %.05466.us, 1
  %i.x = load ptr, ptr %2, align 8, !tbaa !76
  %i.y = load i64, ptr %i.j, align 8, !tbaa !78
...
.epil.preheader:                                  ; preds = %._crit_edge.us.unr-lcssa, %.preheader64.us
  ...
  %i.al = load ptr, ptr %2, align 8, !tbaa !76
  %i.am = load i64, ptr %i.j, align 8, !tbaa !78
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.unr-lcssa, %.epil.preheader
  ...
  br i1 %i.ay, label %.preheader64.us, label %.preheader63, !llvm.loop !723
...
.preheader62.us.new:                              ; preds = %.preheader62.us, %.preheader62.us.new
  ...
  %i.bi = load ptr, ptr %2, align 8, !tbaa !76
  ...
  %i.bn = load <2 x double>, ptr %i.bm, align 1, !tbaa !54
  %i.bo = getelementptr inbounds [8 x i8], ptr %1, i64 %.372.us
  store <2 x double> %i.bn, ptr %i.bo, align 16, !tbaa !54
  %i.bp = or disjoint i64 %.05373.us, 1
  %i.bq = load ptr, ptr %2, align 8, !tbaa !76
  ...
  %i.bv = load <2 x double>, ptr %i.bu, align 1, !tbaa !54
  %i.bw = getelementptr [8 x i8], ptr %1, i64 %.372.us
  %i.bx = getelementptr i8, ptr %i.bw, i64 16
  store <2 x double> %i.bv, ptr %i.bx, align 16, !tbaa !54
  ...
  br i1 %niter130.ncmp.1, label %._crit_edge.us78.unr-lcssa, label %.preheader62.us.new, !llvm.loop !724
...
.epil.preheader124:                               ; preds = %._crit_edge.us78.unr-lcssa, %.preheader62.us
  ...
  %i.ca = load ptr, ptr %2, align 8, !tbaa !76
  ...
  %i.cf = load <2 x double>, ptr %i.ce, align 1, !tbaa !54
  %i.cg = getelementptr inbounds [8 x i8], ptr %1, i64 %.372.us.epil.init
  store <2 x double> %i.cf, ptr %i.cg, align 16, !tbaa !54
...
._crit_edge.us78:                                 ; preds = %._crit_edge.us78.unr-lcssa, %.epil.preheader124
  ...
  br i1 %i.cj, label %.preheader62.us, label %.preheader61, !llvm.loop !725
...
.preheader.lr.ph.split:                           ; preds = %.preheader61
  ...
  %i.cn = load ptr, ptr %2, align 8, !tbaa !76    ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.da, align 8, !tbaa !46
  %wide.load114 = load <2 x double>, ptr %i.db, align 8, !tbaa !46
  %i.dc = getelementptr [8 x i8], ptr %i.cz, i64 %index ; 2 uses
  %i.dd = getelementptr inbounds nuw i8, ptr %i.dc, i64 16
  store <2 x double> %wide.load, ptr %i.dc, align 8, !tbaa !46
  store <2 x double> %wide.load114, ptr %i.dd, align 8, !tbaa !46
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.de = icmp eq i64 %index.next, %n.vec
  br i1 %i.de, label %middle.block, label %vector.body, !llvm.loop !726
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  store double %i.dh, ptr %i.dj, align 8, !tbaa !46
...
._crit_edge:                                      ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  ...
  br i1 %exitcond98.not, label %._crit_edge86.split, label %.preheader, !llvm.loop !728
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  store double %i.dq, ptr %i.dr, align 8, !tbaa !46
  ...
  store double %i.dv, ptr %i.dx, align 8, !tbaa !46
  ...
  store double %i.eb, ptr %i.ed, align 8, !tbaa !46
  ...
  store double %i.eh, ptr %i.ek, align 8, !tbaa !46
  %i.el = add nuw nsw i64 %.083, 4                ; 2 uses
  %exitcond97.not.3 = icmp eq i64 %i.el, %3
  br i1 %exitcond97.not.3, label %._crit_edge, label %scalar.ph, !llvm.loop !729
...
bb.a:
end_hunk_0
begin_hunk_1_@_ZN5Eigen8internal13gemm_pack_rhsIdlNS0_22const_blas_data_mapperIdlLi0EEELi4ELi0ELb0ELb0EEclEPdRKS3_llll:bb.a
...
.loopexit706:                                     ; preds = %._crit_edge777.split.split.us.us.us, %._crit_edge777.split.split.us799, %._crit_edge777.split.us.us.us, %.preheader705
  ...
  br i1 %i.af, label %bb.b, label %._crit_edge809, !llvm.loop !750
...
.preheader699.lr.ph.split:                        ; preds = %.preheader700
  ...
  %i.ak = load ptr, ptr %1, align 8, !tbaa !751   ; 2 uses
  %i.al = load i64, ptr %i.ai, align 8, !tbaa !753 ; 8 uses
...
.lr.ph817.us.us.new:                              ; preds = %.lr.ph817.us.us, %.lr.ph817.us.us.new
  ...
  %i.az = load <4 x double>, ptr %.0229814.us.us, align 8, !tbaa !46
  ...
  %i.bi = load <4 x double>, ptr %i.be, align 8, !tbaa !46
  ...
  %niter.next.1 = add nuw nsw i64 %niter, 2       ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge818.us.us.unr-lcssa, label %.lr.ph817.us.us.new, !llvm.loop !754
...
.epil.preheader:                                  ; preds = %._crit_edge818.us.us.unr-lcssa, %.lr.ph817.us.us
  ...
  %i.br = load <4 x double>, ptr %.0229814.us.us.epil.init, align 8, !tbaa !46
...
._crit_edge818.us.us:                             ; preds = %._crit_edge818.us.us.unr-lcssa, %.epil.preheader
  ...
  store double %i.ca, ptr %i.bx, align 8, !tbaa !46
  ...
  store double %i.ce, ptr %i.cb, align 8, !tbaa !46
  ...
  store double %i.ci, ptr %i.cf, align 8, !tbaa !46
  ...
  store double %i.cm, ptr %i.cj, align 8, !tbaa !46
  %i.cn = add nsw i64 %.0230825.us.us, 1          ; 2 uses
  %exitcond891.not = icmp eq i64 %i.cn, %4
  br i1 %exitcond891.not, label %._crit_edge827.split.us.us, label %.lr.ph817.us.us, !llvm.loop !755

._crit_edge827.split.us.us:                       ; preds = %._crit_edge818.us.us
  %i.co = add nuw nsw i64 %.0231828.us, 4         ; 2 uses
  %i.cp = icmp slt i64 %i.co, %i.d
  br i1 %i.cp, label %.preheader699.us, label %.preheader698, !llvm.loop !756
...
.lr.ph759.us.us.us:                               ; preds = %._crit_edge770.us.us.us, %.preheader703.us.us
  ...
  %i.cu = load ptr, ptr %1, align 8, !tbaa !751
  %i.cv = load i64, ptr %i.z, align 8, !tbaa !753
...
bb.c:                                             ; preds = %bb.c, %.lr.ph759.us.us.us
  ...
  tail call void asm sideeffect "#begin gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !757
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !758
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !759
  %i.da = load <2 x double>, ptr %.0235755.us.us.us, align 16, !tbaa !54
  %i.db = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 16
  %i.dc = load <2 x double>, ptr %i.db, align 16, !tbaa !54
  %i.dd = load double, ptr %.0234756.us.us.us, align 8, !tbaa !46
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !760
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !761
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !762
  %i.dk = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 32
  %i.dl = load <2 x double>, ptr %i.dk, align 16, !tbaa !54
  %i.dm = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 48
  %i.dn = load <2 x double>, ptr %i.dm, align 16, !tbaa !54
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !763
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !764
  ...
  %i.dx = load <2 x double>, ptr %i.dw, align 16, !tbaa !54
  %i.dy = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 80
  %i.dz = load <2 x double>, ptr %i.dy, align 16, !tbaa !54
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !766
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !767
  ...
  %i.ej = load <2 x double>, ptr %i.ei, align 16, !tbaa !54
  %i.ek = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 112
  %i.el = load <2 x double>, ptr %i.ek, align 16, !tbaa !54
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !769
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !770
  ...
  %i.ev = load <2 x double>, ptr %i.eu, align 16, !tbaa !54
  %i.ew = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 144
  %i.ex = load <2 x double>, ptr %i.ew, align 16, !tbaa !54
  %i.ey = getelementptr inbounds nuw i8, ptr %.0234756.us.us.us, i64 32
  %i.ez = load double, ptr %i.ey, align 8, !tbaa !46
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !772
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !773
  ...
  %i.fh = load <2 x double>, ptr %i.fg, align 16, !tbaa !54
  %i.fi = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 176
  %i.fj = load <2 x double>, ptr %i.fi, align 16, !tbaa !54
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !775
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !776
  ...
  %i.ft = load <2 x double>, ptr %i.fs, align 16, !tbaa !54
  %i.fu = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 208
  %i.fv = load <2 x double>, ptr %i.fu, align 16, !tbaa !54
  %i.fw = getelementptr inbounds nuw i8, ptr %.0234756.us.us.us, i64 48
  %i.fx = load double, ptr %i.fw, align 8, !tbaa !46
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !778
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !779
  ...
  %i.gf = load <2 x double>, ptr %i.ge, align 16, !tbaa !54
  %i.gg = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 240
  %i.gh = load <2 x double>, ptr %i.gg, align 16, !tbaa !54
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !781
  ...
  tail call void asm sideeffect "#end gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !782
  %i.gs = add nuw nsw i64 %.0233757.us.us.us, 8   ; 2 uses
  %i.gt = icmp slt i64 %i.gs, %i.s
  br i1 %i.gt, label %bb.c, label %..preheader701_crit_edge.us.us.us, !llvm.loop !783
...
.lr.ph769.us.us.us:                               ; preds = %..preheader701_crit_edge.us.us.us, %.lr.ph769.us.us.us
  ...
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !784
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !785
  %i.gu = load <2 x double>, ptr %.1236766.us.us.us, align 16, !tbaa !54
  %i.gv = getelementptr inbounds nuw i8, ptr %.1236766.us.us.us, i64 16
  %i.gw = load <2 x double>, ptr %i.gv, align 16, !tbaa !54
  %i.gx = load double, ptr %.1767.us.us.us, align 8, !tbaa !46
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !786
  ...
  br i1 %i.hh, label %.lr.ph769.us.us.us, label %._crit_edge770.us.us.us, !llvm.loop !787
...
end_hunk_1
begin_hunk_2_@_ZN5Eigen8internal11gebp_kernelIddlNS0_16blas_data_mapperIdlLi0ELi0ELi1EEELi4ELi4ELb0ELb0EEclERKS3_PKdS8_llldllll:bb.a
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !805
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !806
  %i.sz = getelementptr inbounds nuw i8, ptr %.0243715, i64 224
  %i.ta = load <2 x double>, ptr %i.sz, align 16, !tbaa !54 ; 4 uses
  %i.tb = getelementptr inbounds nuw i8, ptr %.0243715, i64 240
  %i.tc = load <2 x double>, ptr %i.tb, align 16, !tbaa !54 ; 4 uses
  %i.td = getelementptr inbounds nuw i8, ptr %.0241716, i64 224
  %i.te = load <4 x i32>, ptr %i.td, align 16, !tbaa !54 ; 2 uses
  %i.tf = getelementptr inbounds nuw i8, ptr %.0241716, i64 240
  %i.tg = load <4 x i32>, ptr %i.tf, align 16, !tbaa !54 ; 2 uses
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !807
  ...
  tail call void asm sideeffect "#end gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !808
  %i.uh = add nuw nsw i64 %.0240717, 8            ; 2 uses
  %i.ui = icmp slt i64 %i.uh, %i.s
  br i1 %i.ui, label %.lr.ph, label %.preheader702, !llvm.loop !809
...
._crit_edge:                                      ; preds = %.lr.ph738, %.preheader702
  ...
  %i.uj = load <2 x double>, ptr %i.jy, align 1, !tbaa !54
  %i.uk = getelementptr inbounds nuw i8, ptr %i.jy, i64 16 ; 2 uses
  %i.ul = load <2 x double>, ptr %i.uk, align 1, !tbaa !54
  %i.um = load <2 x double>, ptr %i.ka, align 1, !tbaa !54
  %i.un = getelementptr inbounds nuw i8, ptr %i.ka, i64 16 ; 2 uses
  %i.uo = load <2 x double>, ptr %i.un, align 1, !tbaa !54
  ...
  store <2 x double> %i.uq, ptr %i.jy, align 1, !tbaa !54
  store <2 x double> %i.us, ptr %i.uk, align 1, !tbaa !54
  store <2 x double> %i.uu, ptr %i.ka, align 1, !tbaa !54
  store <2 x double> %i.uw, ptr %i.un, align 1, !tbaa !54
  %i.ux = load <2 x double>, ptr %i.kc, align 1, !tbaa !54
  %i.uy = getelementptr inbounds nuw i8, ptr %i.kc, i64 16 ; 2 uses
  %i.uz = load <2 x double>, ptr %i.uy, align 1, !tbaa !54
  %i.va = load <2 x double>, ptr %i.ke, align 1, !tbaa !54
  %i.vb = getelementptr inbounds nuw i8, ptr %i.ke, i64 16 ; 2 uses
  %i.vc = load <2 x double>, ptr %i.vb, align 1, !tbaa !54
  ...
  store <2 x double> %i.ve, ptr %i.kc, align 1, !tbaa !54
  store <2 x double> %i.vg, ptr %i.uy, align 1, !tbaa !54
  store <2 x double> %i.vi, ptr %i.ke, align 1, !tbaa !54
  store <2 x double> %i.vk, ptr %i.vb, align 1, !tbaa !54
  %i.vl = add nuw nsw i64 %.0245747, 4            ; 2 uses
  %i.vm = icmp slt i64 %i.vl, %.sroa.speculated
  br i1 %i.vm, label %bb.e, label %._crit_edge749, !llvm.loop !810
...
.lr.ph738:                                        ; preds = %.preheader702, %.lr.ph738
  ...
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !811
  %i.vn = load <2 x double>, ptr %.1244735, align 16, !tbaa !54 ; 4 uses
  %i.vo = getelementptr inbounds nuw i8, ptr %.1244735, i64 16
  %i.vp = load <2 x double>, ptr %i.vo, align 16, !tbaa !54 ; 4 uses
  %i.vq = load <4 x i32>, ptr %.1242736, align 16, !tbaa !54 ; 2 uses
  %i.vr = getelementptr inbounds nuw i8, ptr %.1242736, i64 16
  %i.vs = load <4 x i32>, ptr %i.vr, align 16, !tbaa !54 ; 2 uses
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !812
  ...
  br i1 %i.wu, label %.lr.ph738, label %._crit_edge, !llvm.loop !813
...
.preheader.lr.ph.split:                           ; preds = %.preheader698
  ...
  %i.xf = load ptr, ptr %1, align 8, !tbaa !751   ; 4 uses
  %i.xg = load i64, ptr %i.xd, align 8, !tbaa !753 ; 4 uses
...
bb.f:                                             ; preds = %bb.f, %.preheader.prol
  ...
  %i.xj = load double, ptr %gep847.prol, align 8, !tbaa !46
  %i.xk = call double @llvm.fmuladd.f64(double %7, double 0.000000e+00, double %i.xj)
  store double %i.xk, ptr %gep847.prol, align 8, !tbaa !46
  %i.xl = add nsw i64 %.0226843.prol, 1           ; 2 uses
  %exitcond892.not.prol = icmp eq i64 %i.xl, %4
  br i1 %exitcond892.not.prol, label %._crit_edge845.split.prol, label %bb.f, !llvm.loop !814
...
.lr.ph836.us.us.new:                              ; preds = %.lr.ph836.us.us, %.lr.ph836.us.us.new
  ...
  %i.xt = load double, ptr %i.xs, align 8, !tbaa !46
  %i.xu = getelementptr inbounds nuw [8 x i8], ptr %gep842.us, i64 %.0834.us.us
  %i.xv = load double, ptr %i.xu, align 8, !tbaa !46
  ...
  %i.ya = load double, ptr %i.xz, align 8, !tbaa !46
  %i.yb = getelementptr inbounds nuw [8 x i8], ptr %gep842.us, i64 %i.xy
  %i.yc = load double, ptr %i.yb, align 8, !tbaa !46
  ...
  %i.yh = load double, ptr %i.yg, align 8, !tbaa !46
  %i.yi = getelementptr inbounds nuw [8 x i8], ptr %gep842.us, i64 %i.yf
  %i.yj = load double, ptr %i.yi, align 8, !tbaa !46
  ...
  %i.yo = load double, ptr %i.yn, align 8, !tbaa !46
  %i.yp = getelementptr inbounds nuw [8 x i8], ptr %gep842.us, i64 %i.ym
  %i.yq = load double, ptr %i.yp, align 8, !tbaa !46
  ...
  br i1 %niter1028.ncmp.3, label %._crit_edge837.us.us.unr-lcssa, label %.lr.ph836.us.us.new, !llvm.loop !815
...
bb.g:                                             ; preds = %bb.g, %.epil.preheader1022
  ...
  %i.yv = load double, ptr %i.yu, align 8, !tbaa !46
  %i.yw = getelementptr inbounds nuw [8 x i8], ptr %gep842.us, i64 %.0834.us.us.epil
  %i.yx = load double, ptr %i.yw, align 8, !tbaa !46
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge837.us.us, label %bb.g, !llvm.loop !816
...
._crit_edge837.us.us:                             ; preds = %bb.g, %._crit_edge837.us.us.unr-lcssa
  ...
  %i.zb = load double, ptr %gep847.us.us, align 8, !tbaa !46
  %i.zc = call double @llvm.fmuladd.f64(double %7, double %.lcssa, double %i.zb)
  store double %i.zc, ptr %gep847.us.us, align 8, !tbaa !46
  %i.zd = add nsw i64 %.0226843.us.us, 1          ; 2 uses
  %exitcond895.not = icmp eq i64 %i.zd, %4
  br i1 %exitcond895.not, label %._crit_edge845.split.us.us, label %.lr.ph836.us.us, !llvm.loop !814
...
._crit_edge845.split.us.us:                       ; preds = %._crit_edge837.us.us
  ...
  br i1 %exitcond892.not.a, label %.loopexit, label %.preheader.us, !llvm.loop !817

._crit_edge827.split:                             ; preds = %bb.h
  %i.zf = add nuw nsw i64 %.0231828, 4            ; 2 uses
  %i.zg = icmp slt i64 %i.zf, %i.d
  br i1 %i.zg, label %.preheader699, label %.preheader698, !llvm.loop !756
...
bb.j:                                             ; preds = %.preheader, %bb.j
  ...
  %i.aaf = load double, ptr %gep847, align 8, !tbaa !46
  %i.aag = call double @llvm.fmuladd.f64(double %7, double 0.000000e+00, double %i.aaf)
  store double %i.aag, ptr %gep847, align 8, !tbaa !46
  %i.aah = add nsw i64 %.0226843, 1               ; 2 uses
  %exitcond892.not = icmp eq i64 %i.aah, %4
  br i1 %exitcond892.not, label %._crit_edge845.split, label %bb.j, !llvm.loop !814
...
bb.b:                                             ; preds = %.lr.ph455, %._crit_edge449
  ...
  %i.l = load ptr, ptr %1, align 8, !tbaa !751
  %i.m = load i64, ptr %i.c, align 8, !tbaa !753  ; 4 uses
...
.lr.ph:                                           ; preds = %bb.b, %.lr.ph
  ...
  tail call void asm sideeffect "#begin gebp micro kernel 1/half/quarterX4", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !818
  %i.am = getelementptr inbounds nuw i8, ptr %.0122429, i64 384
  tail call void @llvm.prefetch.p0(ptr nonnull %i.am, i32 0, i32 3, i32 1)
  tail call void asm sideeffect "#begin step of gebp micro kernel 1X4", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !819
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !820
  %i.an = load <2 x double>, ptr %.0124428, align 16, !tbaa !54 ; 4 uses
  %i.ao = load <4 x i32>, ptr %.0122429, align 16, !tbaa !54 ; 2 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %.0122429, i64 16
  %i.aq = load <4 x i32>, ptr %i.ap, align 16, !tbaa !54 ; 2 uses
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 1X4", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !821
  tail call void asm sideeffect "#begin step of gebp micro kernel 1X4", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !819
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !820
  %i.bh = getelementptr inbounds nuw i8, ptr %.0124428, i64 16
  %i.bi = load <2 x double>, ptr %i.bh, align 16, !tbaa !54 ; 4 uses
  %i.bj = getelementptr inbounds nuw i8, ptr %.0122429, i64 32
  %i.bk = load <4 x i32>, ptr %i.bj, align 16, !tbaa !54 ; 2 uses
  %i.bl = getelementptr inbounds nuw i8, ptr %.0122429, i64 48
  %i.bm = load <4 x i32>, ptr %i.bl, align 16, !tbaa !54 ; 2 uses
  ...
  %i.ce = load <2 x double>, ptr %i.cd, align 16, !tbaa !54 ; 4 uses
  %i.cf = getelementptr inbounds nuw i8, ptr %.0122429, i64 64
  %i.cg = load <4 x i32>, ptr %i.cf, align 16, !tbaa !54 ; 2 uses
  %i.ch = getelementptr inbounds nuw i8, ptr %.0122429, i64 80
  %i.ci = load <4 x i32>, ptr %i.ch, align 16, !tbaa !54 ; 2 uses
  ...
  %i.da = load <2 x double>, ptr %i.cz, align 16, !tbaa !54 ; 4 uses
  %i.db = getelementptr inbounds nuw i8, ptr %.0122429, i64 96
  %i.dc = load <4 x i32>, ptr %i.db, align 16, !tbaa !54 ; 2 uses
  %i.dd = getelementptr inbounds nuw i8, ptr %.0122429, i64 112
  %i.de = load <4 x i32>, ptr %i.dd, align 16, !tbaa !54 ; 2 uses
...
end_hunk_2
begin_hunk_3_@_ZN5Eigen8internal29general_matrix_matrix_productIlfLi0ELb0EfLi0ELb0ELi0ELi1EE3runElllPKflS4_lPfllfRNS0_15level3_blockingIffEEPNS0_16GemmParallelInfoIlEE:bb.a
  %.sroa.speculated126.us = call i64 @llvm.smin.i64(i64 %0, i64 %i.bz)
  %i.ca = sub nsw i64 %.sroa.speculated126.us, %.078193.us
  %i.cb = getelementptr [4 x i8], ptr %3, i64 %.078193.us
  br label %bb.q
...
bb.q:                                             ; preds = %.lr.ph181.us, %.loopexit.us
  ...
  %i.cf = getelementptr [4 x i8], ptr %i.cb, i64 %i.ce
  store ptr %i.cf, ptr %16, align 8
  store i64 %4, ptr %i.an, align 8
...
.loopexit.us:                                     ; preds = %bb.q
  call void @llvm.lifetime.end.p0(ptr nonnull %16) #25
  %i.cg = icmp slt i64 %i.cc, %2
  br i1 %i.cg, label %bb.q, label %..loopexit175_crit_edge.split.us196, !llvm.loop !1508

..loopexit175_crit_edge.split.us196:              ; preds = %.loopexit.us
  %i.ch = icmp slt i64 %i.bz, %0
  br i1 %i.ch, label %.lr.ph181.us, label %._crit_edge, !llvm.loop !1509
...
._crit_edge:                                      ; preds = %..loopexit175_crit_edge.split.us196, %..loopexit175_crit_edge.split.us.us.us, %.lr.ph, %_ZN5Eigen8internal14aligned_mallocEm.exit113
  br i1 %i.ai, label %bb.r, label %_ZN5Eigen8internal28aligned_stack_memory_handlerIfED2Ev.exit

bb.r:                                             ; preds = %._crit_edge
  call void @free(ptr noundef %i.ag) #25
  br label %_ZN5Eigen8internal28aligned_stack_memory_handlerIfED2Ev.exit

_ZN5Eigen8internal28aligned_stack_memory_handlerIfED2Ev.exit: ; preds = %._crit_edge, %bb.r
  br i1 %i.u, label %bb.s, label %_ZN5Eigen8internal28aligned_stack_memory_handlerIfED2Ev.exit114

bb.s:                                             ; preds = %_ZN5Eigen8internal28aligned_stack_memory_handlerIfED2Ev.exit
  call void @free(ptr noundef %i.s) #25
  br label %_ZN5Eigen8internal28aligned_stack_memory_handlerIfED2Ev.exit114

_ZN5Eigen8internal28aligned_stack_memory_handlerIfED2Ev.exit114: ; preds = %_ZN5Eigen8internal28aligned_stack_memory_handlerIfED2Ev.exit, %bb.s
  call void @llvm.lifetime.end.p0(ptr nonnull %15) #25
  call void @llvm.lifetime.end.p0(ptr nonnull %14) #25
  call void @llvm.lifetime.end.p0(ptr nonnull %13) #25
  ret void
...
bb.t:                                             ; preds = %bb.g
  %i.cj = landingpad { ptr, i32 }
          cleanup
  br label %_ZN5Eigen8internal28aligned_stack_memory_handlerIfED2Ev.exit118
...
bb.w:                                             ; preds = %.split.us.split.us.split.us.split.us.split.us, %bb.v, %.split.us186
  ...
  br i1 %i.ai, label %bb.x, label %_ZN5Eigen8internal28aligned_stack_memory_handlerIfED2Ev.exit118

bb.x:                                             ; preds = %bb.w
  call void @free(ptr noundef %i.ag) #25
  br label %_ZN5Eigen8internal28aligned_stack_memory_handlerIfED2Ev.exit118

_ZN5Eigen8internal28aligned_stack_memory_handlerIfED2Ev.exit118: ; preds = %bb.x, %bb.w, %bb.u, %bb.t
  %.pn.pn.pn.pn = phi { ptr, i32 } [ %i.cj, %bb.t ], [ %i.ck, %bb.u ], [ %.pn.pn, %bb.w ], [ %.pn.pn, %bb.x ]
  br i1 %i.u, label %bb.y, label %_ZN5Eigen8internal28aligned_stack_memory_handlerIfED2Ev.exit119

bb.y:                                             ; preds = %_ZN5Eigen8internal28aligned_stack_memory_handlerIfED2Ev.exit118
  call void @free(ptr noundef %i.s) #25
  br label %_ZN5Eigen8internal28aligned_stack_memory_handlerIfED2Ev.exit119

_ZN5Eigen8internal28aligned_stack_memory_handlerIfED2Ev.exit119: ; preds = %_ZN5Eigen8internal28aligned_stack_memory_handlerIfED2Ev.exit118, %bb.y
  call void @llvm.lifetime.end.p0(ptr nonnull %15) #25
  call void @llvm.lifetime.end.p0(ptr nonnull %14) #25
  call void @llvm.lifetime.end.p0(ptr nonnull %13) #25
...
.preheader64.us.new:                              ; preds = %.preheader64.us, %.preheader64.us.new
  ...
  %i.m = load i64, ptr %i.j, align 8, !tbaa !387
  %i.n = mul nsw i64 %i.m, %.05466.us             ; 2 uses
  %i.o = getelementptr [4 x i8], ptr %i.l, i64 %.05568.us ; 2 uses
  %i.p = getelementptr [4 x i8], ptr %i.o, i64 %i.n
  %i.q = load <4 x float>, ptr %i.p, align 1, !tbaa !54
  %i.r = getelementptr i8, ptr %i.o, i64 16
  %i.s = getelementptr [4 x i8], ptr %i.r, i64 %i.n
  %i.t = load <4 x float>, ptr %i.s, align 1, !tbaa !54
  %i.u = getelementptr inbounds [4 x i8], ptr %1, i64 %.15765.us ; 2 uses
  store <4 x float> %i.q, ptr %i.u, align 16, !tbaa !54
  %i.v = getelementptr i8, ptr %i.u, i64 16
  store <4 x float> %i.t, ptr %i.v, align 16, !tbaa !54
  %i.w = or disjoint i64 %.05466.us, 1
  %i.x = load ptr, ptr %2, align 8, !tbaa !385
  %i.y = load i64, ptr %i.j, align 8, !tbaa !387
  %i.z = mul nsw i64 %i.y, %i.w                   ; 2 uses
  %i.aa = getelementptr [4 x i8], ptr %i.x, i64 %.05568.us ; 2 uses
  %i.ab = getelementptr [4 x i8], ptr %i.aa, i64 %i.z
  %i.ac = load <4 x float>, ptr %i.ab, align 1, !tbaa !54
  %i.ad = getelementptr i8, ptr %i.aa, i64 16
  %i.ae = getelementptr [4 x i8], ptr %i.ad, i64 %i.z
  %i.af = load <4 x float>, ptr %i.ae, align 1, !tbaa !54
  %i.ag = getelementptr [4 x i8], ptr %1, i64 %.15765.us ; 2 uses
  %i.ah = getelementptr i8, ptr %i.ag, i64 32
  store <4 x float> %i.ac, ptr %i.ah, align 16, !tbaa !54
  %i.ai = getelementptr i8, ptr %i.ag, i64 48
  store <4 x float> %i.af, ptr %i.ai, align 16, !tbaa !54
  %i.aj = add nsw i64 %.15765.us, 16              ; 3 uses
  %i.ak = add nuw nsw i64 %.05466.us, 2           ; 2 uses
  %niter.next.1 = add nuw nsw i64 %niter, 2       ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.us.unr-lcssa, label %.preheader64.us.new, !llvm.loop !1510
...
.epil.preheader:                                  ; preds = %._crit_edge.us.unr-lcssa, %.preheader64.us
  ...
  %.15765.us.epil.init = phi i64 [ %.05667.us, %.preheader64.us ], [ %i.aj, %._crit_edge.us.unr-lcssa ] ; 2 uses
  tail call void @llvm.assume(i1 %lcmp.mod123)
  %i.al = load ptr, ptr %2, align 8, !tbaa !385
  %i.am = load i64, ptr %i.j, align 8, !tbaa !387
  %i.an = mul nsw i64 %i.am, %.05466.us.epil.init ; 2 uses
  %i.ao = getelementptr [4 x i8], ptr %i.al, i64 %.05568.us ; 2 uses
  %i.ap = getelementptr [4 x i8], ptr %i.ao, i64 %i.an
  %i.aq = load <4 x float>, ptr %i.ap, align 1, !tbaa !54
  %i.ar = getelementptr i8, ptr %i.ao, i64 16
  %i.as = getelementptr [4 x i8], ptr %i.ar, i64 %i.an
  %i.at = load <4 x float>, ptr %i.as, align 1, !tbaa !54
  %i.au = getelementptr inbounds [4 x i8], ptr %1, i64 %.15765.us.epil.init ; 2 uses
  store <4 x float> %i.aq, ptr %i.au, align 16, !tbaa !54
  %i.av = getelementptr i8, ptr %i.au, i64 16
  store <4 x float> %i.at, ptr %i.av, align 16, !tbaa !54
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.unr-lcssa, %.epil.preheader
  ...
  %i.ay = icmp slt i64 %i.ax, %i.c
  br i1 %i.ay, label %.preheader64.us, label %.preheader63, !llvm.loop !1511
...
.preheader62.us.new:                              ; preds = %.preheader62.us, %.preheader62.us.new
  ...
  %.372.us = phi i64 [ %i.by, %.preheader62.us.new ], [ %.25874.us, %.preheader62.us ] ; 3 uses
  %niter130 = phi i64 [ %niter130.next.1, %.preheader62.us.new ], [ 0, %.preheader62.us ]
  %i.bi = load ptr, ptr %2, align 8, !tbaa !385
  %i.bj = load i64, ptr %i.bb, align 8, !tbaa !387
  %i.bk = mul nsw i64 %i.bj, %.05373.us
  %i.bl = getelementptr [4 x i8], ptr %i.bi, i64 %.175.us
  %i.bm = getelementptr [4 x i8], ptr %i.bl, i64 %i.bk
  %i.bn = load <4 x float>, ptr %i.bm, align 1, !tbaa !54
  %i.bo = getelementptr inbounds [4 x i8], ptr %1, i64 %.372.us
  store <4 x float> %i.bn, ptr %i.bo, align 16, !tbaa !54
  %i.bp = or disjoint i64 %.05373.us, 1
  %i.bq = load ptr, ptr %2, align 8, !tbaa !385
  %i.br = load i64, ptr %i.bb, align 8, !tbaa !387
  %i.bs = mul nsw i64 %i.br, %i.bp
  %i.bt = getelementptr [4 x i8], ptr %i.bq, i64 %.175.us
  %i.bu = getelementptr [4 x i8], ptr %i.bt, i64 %i.bs
  %i.bv = load <4 x float>, ptr %i.bu, align 1, !tbaa !54
  %i.bw = getelementptr [4 x i8], ptr %1, i64 %.372.us
  %i.bx = getelementptr i8, ptr %i.bw, i64 16
  store <4 x float> %i.bv, ptr %i.bx, align 16, !tbaa !54
...
.epil.preheader124:                               ; preds = %._crit_edge.us78.unr-lcssa, %.preheader62.us
  ...
  %.372.us.epil.init = phi i64 [ %.25874.us, %.preheader62.us ], [ %i.by, %._crit_edge.us78.unr-lcssa ] ; 2 uses
  tail call void @llvm.assume(i1 %lcmp.mod128)
  %i.ca = load ptr, ptr %2, align 8, !tbaa !385
  %i.cb = load i64, ptr %i.bb, align 8, !tbaa !387
  %i.cc = mul nsw i64 %i.cb, %.05373.us.epil.init
  %i.cd = getelementptr [4 x i8], ptr %i.ca, i64 %.175.us
  %i.ce = getelementptr [4 x i8], ptr %i.cd, i64 %i.cc
  %i.cf = load <4 x float>, ptr %i.ce, align 1, !tbaa !54
  %i.cg = getelementptr inbounds [4 x i8], ptr %1, i64 %.372.us.epil.init
  store <4 x float> %i.cf, ptr %i.cg, align 16, !tbaa !54
...
._crit_edge.us78:                                 ; preds = %._crit_edge.us78.unr-lcssa, %.epil.preheader124
  ...
  %i.cj = icmp slt i64 %i.ci, %i.g
  br i1 %i.cj, label %.preheader62.us, label %.preheader61, !llvm.loop !1513
...
.preheader.lr.ph.split:                           ; preds = %.preheader61
  %i.cm = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.cn = load ptr, ptr %2, align 8, !tbaa !385   ; 2 uses
  %i.co = ptrtoaddr ptr %i.cn to i64
  %i.cp = load i64, ptr %i.cm, align 8, !tbaa !387 ; 6 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.db = getelementptr i8, ptr %i.da, i64 16
  %wide.load = load <4 x float>, ptr %i.da, align 4, !tbaa !364
  %wide.load114 = load <4 x float>, ptr %i.db, align 4, !tbaa !364
  %i.dc = getelementptr [4 x i8], ptr %i.cz, i64 %index ; 2 uses
  %i.dd = getelementptr inbounds nuw i8, ptr %i.dc, i64 16
  store <4 x float> %wide.load, ptr %i.dc, align 4, !tbaa !364
  store <4 x float> %wide.load114, ptr %i.dd, align 4, !tbaa !364
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.de = icmp eq i64 %index.next, %n.vec
  br i1 %i.de, label %middle.block, label %vector.body, !llvm.loop !1514
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  %i.dh = load float, ptr %i.dg, align 4, !tbaa !364
  %i.di = add nsw i64 %.582.prol, 1               ; 3 uses
  %i.dj = getelementptr inbounds [4 x i8], ptr %1, i64 %.582.prol
  store float %i.dh, ptr %i.dj, align 4, !tbaa !364
  %i.dk = add nuw nsw i64 %.083.prol, 1           ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter131
...
bb.a:
end_hunk_3
begin_hunk_4_@_ZN5Eigen8internal13gemm_pack_rhsIflNS0_22const_blas_data_mapperIflLi0EEELi4ELi0ELb0ELb0EEclEPfRKS3_llll:bb.a
  %i.if = getelementptr inbounds nuw [4 x i8], ptr %i.gx, i64 %.0108
  %i.ig = getelementptr inbounds nuw i8, ptr %i.if, i64 12
  %i.ih = load float, ptr %i.ig, align 4, !tbaa !364
  %i.ii = getelementptr [4 x i8], ptr %1, i64 %.4107
  %i.ij = getelementptr i8, ptr %i.ii, i64 12
  store float %i.ih, ptr %i.ij, align 4, !tbaa !364
  %i.ik = add nsw i64 %.4107, 4                   ; 2 uses
  %i.il = add nuw nsw i64 %.0108, 4               ; 2 uses
  %exitcond119.not.3 = icmp eq i64 %i.il, %3
  br i1 %exitcond119.not.3, label %._crit_edge, label %scalar.ph172, !llvm.loop !1537
}
...
bb.a:
  %12 = alloca %"struct.Eigen::internal::lhs_process_one_packet.1854", align 1 ; 3 uses
  %i.a = icmp eq i64 %8, -1
  %spec.select = select i1 %i.a, i64 %5, i64 %8   ; 11 uses
  %i.b = icmp eq i64 %9, -1
...
.loopexit689:                                     ; preds = %._crit_edge760.split.split.us.us.us, %._crit_edge760.split.split.us782, %._crit_edge760.split.us.us.us, %.preheader688
  ...
  br i1 %i.ag, label %bb.c, label %._crit_edge792, !llvm.loop !1538
...
.preheader682.lr.ph.split:                        ; preds = %.preheader683
  ...
  %i.aq = load ptr, ptr %1, align 8, !tbaa !1539  ; 2 uses
  %i.ar = load i64, ptr %i.ao, align 8, !tbaa !1541 ; 6 uses
...
bb.b:                                             ; preds = %bb.b, %.lr.ph801.us.us
  ...
  %i.av = load <4 x float>, ptr %.0235798.us.us, align 1, !tbaa !54
  %i.aw = getelementptr inbounds nuw i8, ptr %.0235798.us.us, i64 16
  %i.ax = load <4 x float>, ptr %i.aw, align 1, !tbaa !54
  %i.ay = load float, ptr %.0237797.us.us, align 4, !tbaa !364
  ...
  %i.bc = load float, ptr %i.bb, align 4, !tbaa !364
  ...
  %i.bk = load <4 x float>, ptr %i.bj, align 1, !tbaa !54
  %i.bl = getelementptr inbounds nuw i8, ptr %.0235798.us.us, i64 48
  %i.bm = load <4 x float>, ptr %i.bl, align 1, !tbaa !54
  %i.bn = getelementptr inbounds nuw i8, ptr %.0237797.us.us, i64 8
  %i.bo = load float, ptr %i.bn, align 4, !tbaa !364
  ...
  %i.bs = load float, ptr %i.br, align 4, !tbaa !364
  ...
  br i1 %i.cc, label %bb.b, label %._crit_edge802.us.us, !llvm.loop !1542
...
.lr.ph815.us.us:                                  ; preds = %._crit_edge802.us.us, %.lr.ph815.us.us
  ...
  %i.cd = load <4 x float>, ptr %.1236812.us.us, align 1, !tbaa !54
  %i.ce = load float, ptr %.1238811.us.us, align 4, !tbaa !364
  ...
  br i1 %i.cm, label %.lr.ph815.us.us, label %._crit_edge816.us.us, !llvm.loop !1543
...
._crit_edge816.us.us:                             ; preds = %.lr.ph815.us.us, %._crit_edge802.us.us
  ...
  %i.co = load float, ptr %i.cn, align 4, !tbaa !364
  %i.cp = getelementptr inbounds i8, ptr %gep824.us.us, i64 %.idx7.i ; 2 uses
  %i.cq = load float, ptr %i.cp, align 4, !tbaa !364
  %i.cr = getelementptr inbounds [4 x i8], ptr %gep824.us.us, i64 %i.ar ; 2 uses
  %i.cs = load float, ptr %i.cr, align 4, !tbaa !364
  %i.ct = load float, ptr %gep824.us.us, align 4, !tbaa !364
  ...
  store float %i.da, ptr %gep824.us.us, align 4, !tbaa !364
  %.4.vec.extract.us.us = extractelement <4 x float> %i.cz, i64 1
  store float %.4.vec.extract.us.us, ptr %i.cr, align 4, !tbaa !364
  %.8.vec.extract.us.us = extractelement <4 x float> %i.cz, i64 2
  store float %.8.vec.extract.us.us, ptr %i.cp, align 4, !tbaa !364
  %.12.vec.extract.us.us = extractelement <4 x float> %i.cz, i64 3
  store float %.12.vec.extract.us.us, ptr %i.cn, align 4, !tbaa !364
  %i.db = add nsw i64 %.0239820.us.us, 1          ; 2 uses
  %exitcond893.not = icmp eq i64 %i.db, %4
  br i1 %exitcond893.not, label %._crit_edge822.split.us.us, label %.lr.ph801.us.us, !llvm.loop !1544
...
._crit_edge822.split.us.us:                       ; preds = %._crit_edge816.us.us
  ...
  br i1 %i.dh, label %.preheader682.us, label %.preheader681, !llvm.loop !1545
...
.lr.ph742.us.us.us:                               ; preds = %._crit_edge753.us.us.us, %.preheader686.us.us
  ...
  %i.dm = load ptr, ptr %1, align 8, !tbaa !1539
  %i.dn = load i64, ptr %i.aa, align 8, !tbaa !1541
...
bb.d:                                             ; preds = %bb.d, %.lr.ph742.us.us.us
  ...
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !758
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !759
  %i.ds = load <4 x float>, ptr %.0245738.us.us.us, align 16, !tbaa !54
  %i.dt = getelementptr inbounds nuw i8, ptr %.0245738.us.us.us, i64 16
  %i.du = load <4 x float>, ptr %i.dt, align 16, !tbaa !54
  %i.dv = load float, ptr %.0243739.us.us.us, align 4, !tbaa !364
  ...
  %i.ed = load <4 x float>, ptr %i.ec, align 16, !tbaa !54
  %i.ee = getelementptr inbounds nuw i8, ptr %.0245738.us.us.us, i64 48
  %i.ef = load <4 x float>, ptr %i.ee, align 16, !tbaa !54
  ...
  %i.ep = load <4 x float>, ptr %i.eo, align 16, !tbaa !54
  %i.eq = getelementptr inbounds nuw i8, ptr %.0245738.us.us.us, i64 80
  %i.er = load <4 x float>, ptr %i.eq, align 16, !tbaa !54
  %i.es = getelementptr inbounds nuw i8, ptr %.0243739.us.us.us, i64 8
  %i.et = load float, ptr %i.es, align 4, !tbaa !364
  ...
  %i.fb = load <4 x float>, ptr %i.fa, align 16, !tbaa !54
  %i.fc = getelementptr inbounds nuw i8, ptr %.0245738.us.us.us, i64 112
  %i.fd = load <4 x float>, ptr %i.fc, align 16, !tbaa !54
  %i.fe = getelementptr inbounds nuw i8, ptr %.0243739.us.us.us, i64 12
  %i.ff = load float, ptr %i.fe, align 4, !tbaa !364
  ...
  %i.fn = load <4 x float>, ptr %i.fm, align 16, !tbaa !54
  %i.fo = getelementptr inbounds nuw i8, ptr %.0245738.us.us.us, i64 144
  %i.fp = load <4 x float>, ptr %i.fo, align 16, !tbaa !54
  %i.fq = getelementptr inbounds nuw i8, ptr %.0243739.us.us.us, i64 16
  %i.fr = load float, ptr %i.fq, align 4, !tbaa !364
  ...
  %i.fz = load <4 x float>, ptr %i.fy, align 16, !tbaa !54
  %i.ga = getelementptr inbounds nuw i8, ptr %.0245738.us.us.us, i64 176
  %i.gb = load <4 x float>, ptr %i.ga, align 16, !tbaa !54
  %i.gc = getelementptr inbounds nuw i8, ptr %.0243739.us.us.us, i64 20
  %i.gd = load float, ptr %i.gc, align 4, !tbaa !364
  ...
  %i.gl = load <4 x float>, ptr %i.gk, align 16, !tbaa !54
  %i.gm = getelementptr inbounds nuw i8, ptr %.0245738.us.us.us, i64 208
  %i.gn = load <4 x float>, ptr %i.gm, align 16, !tbaa !54
  %i.go = getelementptr inbounds nuw i8, ptr %.0243739.us.us.us, i64 24
  %i.gp = load float, ptr %i.go, align 4, !tbaa !364
  ...
  %i.gx = load <4 x float>, ptr %i.gw, align 16, !tbaa !54
  %i.gy = getelementptr inbounds nuw i8, ptr %.0245738.us.us.us, i64 240
  %i.gz = load <4 x float>, ptr %i.gy, align 16, !tbaa !54
  %i.ha = getelementptr inbounds nuw i8, ptr %.0243739.us.us.us, i64 28
  %i.hb = load float, ptr %i.ha, align 4, !tbaa !364
  ...
  br i1 %i.hl, label %bb.d, label %..preheader684_crit_edge.us.us.us, !llvm.loop !1546
...
.lr.ph752.us.us.us:                               ; preds = %..preheader684_crit_edge.us.us.us, %.lr.ph752.us.us.us
  ...
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !784
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !785
  %i.hm = load <4 x float>, ptr %.1246749.us.us.us, align 16, !tbaa !54
  %i.hn = getelementptr inbounds nuw i8, ptr %.1246749.us.us.us, i64 16
  %i.ho = load <4 x float>, ptr %i.hn, align 16, !tbaa !54
  %i.hp = load float, ptr %.1244750.us.us.us, align 4, !tbaa !364
...
end_hunk_4
begin_hunk_5_@_ZN5Eigen8internal11gebp_kernelIfflNS0_16blas_data_mapperIflLi0ELi0ELi1EEELi8ELi4ELb0ELb0EEclERKS3_PKfS8_lllfllll:bb.a
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !804
  %i.rb = getelementptr inbounds nuw i8, ptr %.0253698, i64 192
  %i.rc = load <4 x float>, ptr %i.rb, align 16, !tbaa !54 ; 4 uses
  %i.rd = getelementptr inbounds nuw i8, ptr %.0253698, i64 208
  %i.re = load <4 x float>, ptr %i.rd, align 16, !tbaa !54 ; 4 uses
  %i.rf = getelementptr inbounds nuw i8, ptr %.0251699, i64 96
  %i.rg = load <4 x float>, ptr %i.rf, align 16, !tbaa !54 ; 4 uses
  ...
  %i.sc = load <4 x float>, ptr %i.sb, align 16, !tbaa !54 ; 4 uses
  %i.sd = getelementptr inbounds nuw i8, ptr %.0253698, i64 240
  %i.se = load <4 x float>, ptr %i.sd, align 16, !tbaa !54 ; 4 uses
  %i.sf = getelementptr inbounds nuw i8, ptr %.0251699, i64 112
  %i.sg = load <4 x float>, ptr %i.sf, align 16, !tbaa !54 ; 4 uses
  ...
  br i1 %i.te, label %.lr.ph, label %.preheader685, !llvm.loop !1551
...
._crit_edge:                                      ; preds = %.lr.ph721, %.preheader685
  ...
  %i.tf = load <4 x float>, ptr %i.kq, align 1, !tbaa !54
  %i.tg = getelementptr inbounds nuw i8, ptr %i.kq, i64 16 ; 2 uses
  %i.th = load <4 x float>, ptr %i.tg, align 1, !tbaa !54
  %i.ti = load <4 x float>, ptr %i.ks, align 1, !tbaa !54
  %i.tj = getelementptr inbounds nuw i8, ptr %i.ks, i64 16 ; 2 uses
  %i.tk = load <4 x float>, ptr %i.tj, align 1, !tbaa !54
  ...
  store <4 x float> %i.tm, ptr %i.kq, align 1, !tbaa !54
  store <4 x float> %i.to, ptr %i.tg, align 1, !tbaa !54
  store <4 x float> %i.tq, ptr %i.ks, align 1, !tbaa !54
  store <4 x float> %i.ts, ptr %i.tj, align 1, !tbaa !54
  %i.tt = load <4 x float>, ptr %i.ku, align 1, !tbaa !54
  %i.tu = getelementptr inbounds nuw i8, ptr %i.ku, i64 16 ; 2 uses
  %i.tv = load <4 x float>, ptr %i.tu, align 1, !tbaa !54
  %i.tw = load <4 x float>, ptr %i.kw, align 1, !tbaa !54
  %i.tx = getelementptr inbounds nuw i8, ptr %i.kw, i64 16 ; 2 uses
  %i.ty = load <4 x float>, ptr %i.tx, align 1, !tbaa !54
  ...
  store <4 x float> %i.ua, ptr %i.ku, align 1, !tbaa !54
  store <4 x float> %i.uc, ptr %i.tu, align 1, !tbaa !54
  store <4 x float> %i.ue, ptr %i.kw, align 1, !tbaa !54
  store <4 x float> %i.ug, ptr %i.tx, align 1, !tbaa !54
  %i.uh = add nuw nsw i64 %.0255730, 8            ; 2 uses
  %i.ui = icmp slt i64 %i.uh, %.sroa.speculated
  br i1 %i.ui, label %bb.f, label %._crit_edge732, !llvm.loop !1552
...
.lr.ph721:                                        ; preds = %.preheader685, %.lr.ph721
  ...
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !811
  %i.uj = load <4 x float>, ptr %.1254718, align 16, !tbaa !54 ; 4 uses
  %i.uk = getelementptr inbounds nuw i8, ptr %.1254718, i64 16
  %i.ul = load <4 x float>, ptr %i.uk, align 16, !tbaa !54 ; 4 uses
  %i.um = load <4 x float>, ptr %.1252719, align 16, !tbaa !54 ; 4 uses
  ...
  br i1 %i.vk, label %.lr.ph721, label %._crit_edge, !llvm.loop !1553
...
.preheader.lr.ph.split:                           ; preds = %.preheader681
  ...
  %i.vs = load ptr, ptr %1, align 8, !tbaa !1539  ; 4 uses
  %i.vt = load i64, ptr %i.vq, align 8, !tbaa !1541 ; 4 uses
...
bb.g:                                             ; preds = %bb.g, %.preheader.prol
  ...
  %i.vw = load float, ptr %gep844.prol, align 4, !tbaa !364
  %i.vx = call float @llvm.fmuladd.f32(float %7, float 0.000000e+00, float %i.vw)
  store float %i.vx, ptr %gep844.prol, align 4, !tbaa !364
  %i.vy = add nsw i64 %.0232840.prol, 1           ; 2 uses
  %exitcond894.not.prol = icmp eq i64 %i.vy, %4
  br i1 %exitcond894.not.prol, label %._crit_edge842.split.prol, label %bb.g, !llvm.loop !1554
...
.lr.ph833.us.us.new:                              ; preds = %.lr.ph833.us.us, %.lr.ph833.us.us.new
  ...
  %i.wi = load float, ptr %i.wh, align 4, !tbaa !364
  ...
  %i.wn = load float, ptr %i.wm, align 4, !tbaa !364
  %i.wo = getelementptr inbounds nuw [4 x i8], ptr %gep839.us, i64 %i.wl
  %i.wp = load float, ptr %i.wo, align 4, !tbaa !364
  ...
  %i.wu = load float, ptr %i.wt, align 4, !tbaa !364
  %i.wv = getelementptr inbounds nuw [4 x i8], ptr %gep839.us, i64 %i.ws
  %i.ww = load float, ptr %i.wv, align 4, !tbaa !364
  ...
  %i.xb = load float, ptr %i.xa, align 4, !tbaa !364
  %i.xc = getelementptr inbounds nuw [4 x i8], ptr %gep839.us, i64 %i.wz
  %i.xd = load float, ptr %i.xc, align 4, !tbaa !364
  %i.xe = fmul float %i.xb, %i.xd
  %i.xf = fadd float %i.wy, %i.xe                 ; 3 uses
  %i.xg = add nuw nsw i64 %.0831.us.us, 4         ; 2 uses
  %niter.next.3 = add nuw nsw i64 %niter, 4       ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %._crit_edge834.us.us.unr-lcssa, label %.lr.ph833.us.us.new, !llvm.loop !1555
...
bb.h:                                             ; preds = %bb.h, %.epil.preheader
  ...
  %i.xi = load float, ptr %i.xh, align 4, !tbaa !364
  %i.xj = getelementptr inbounds nuw [4 x i8], ptr %gep839.us, i64 %.0831.us.us.epil
  %i.xk = load float, ptr %i.xj, align 4, !tbaa !364
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge834.us.us, label %bb.h, !llvm.loop !1556
...
._crit_edge834.us.us:                             ; preds = %bb.h, %._crit_edge834.us.us.unr-lcssa
  ...
  %i.xo = load float, ptr %gep844.us.us, align 4, !tbaa !364
  %i.xp = call float @llvm.fmuladd.f32(float %7, float %.lcssa, float %i.xo)
  store float %i.xp, ptr %gep844.us.us, align 4, !tbaa !364
  %i.xq = add nsw i64 %.0232840.us.us, 1          ; 2 uses
  %exitcond897.not = icmp eq i64 %i.xq, %4
  br i1 %exitcond897.not, label %._crit_edge842.split.us.us, label %.lr.ph833.us.us, !llvm.loop !1554
...
._crit_edge842.split.us.us:                       ; preds = %._crit_edge834.us.us
  ...
  br i1 %exitcond894.not.a, label %.loopexit, label %.preheader.us, !llvm.loop !1557

._crit_edge822.split:                             ; preds = %._crit_edge816
  %i.xs = add nuw nsw i64 %.0240825, 4            ; 2 uses
  %i.xt = icmp slt i64 %i.xs, %i.d
  br i1 %i.xt, label %.preheader682, label %.preheader681, !llvm.loop !1545
...
.lr.ph815:                                        ; preds = %bb.i
  %i.xv = load <4 x float>, ptr %gep827, align 1, !tbaa !54
  %i.xw = load float, ptr %gep819, align 4, !tbaa !364
...
.lr.ph815.1:                                      ; preds = %.lr.ph815
  ...
  %i.yc = load <4 x float>, ptr %i.vn, align 1, !tbaa !54
  %i.yd = load float, ptr %i.yb, align 4, !tbaa !364
...
.lr.ph815.2:                                      ; preds = %.lr.ph815.1
  ...
  %i.yj = load <4 x float>, ptr %i.vo, align 1, !tbaa !54
  %i.yk = load float, ptr %i.yi, align 4, !tbaa !364
...
._crit_edge816:                                   ; preds = %.lr.ph815, %.lr.ph815.1, %.lr.ph815.2, %bb.i
  ...
  %i.yq = load float, ptr %i.yp, align 4, !tbaa !364
  %i.yr = getelementptr inbounds i8, ptr %gep824, i64 %.idx7.i ; 2 uses
  %i.ys = load float, ptr %i.yr, align 4, !tbaa !364
  %i.yt = getelementptr inbounds [4 x i8], ptr %gep824, i64 %i.ar ; 2 uses
  %i.yu = load float, ptr %i.yt, align 4, !tbaa !364
  %i.yv = load float, ptr %gep824, align 4, !tbaa !364
  ...
  store float %i.zc, ptr %gep824, align 4, !tbaa !364
  %.4.vec.extract = extractelement <4 x float> %i.zb, i64 1
  store float %.4.vec.extract, ptr %i.yt, align 4, !tbaa !364
  %.8.vec.extract = extractelement <4 x float> %i.zb, i64 2
  store float %.8.vec.extract, ptr %i.yr, align 4, !tbaa !364
  %.12.vec.extract = extractelement <4 x float> %i.zb, i64 3
  store float %.12.vec.extract, ptr %i.yp, align 4, !tbaa !364
  %i.zd = add nsw i64 %.0239820, 1                ; 2 uses
  %exitcond892.not = icmp eq i64 %i.zd, %4
  br i1 %exitcond892.not, label %._crit_edge822.split, label %bb.i, !llvm.loop !1544
...
bb.k:                                             ; preds = %.preheader, %bb.k
  ...
  %i.zn = load float, ptr %gep844, align 4, !tbaa !364
  %i.zo = call float @llvm.fmuladd.f32(float %7, float 0.000000e+00, float %i.zn)
  store float %i.zo, ptr %gep844, align 4, !tbaa !364
  %i.zp = add nsw i64 %.0232840, 1                ; 2 uses
  %exitcond894.not = icmp eq i64 %i.zp, %4
  br i1 %exitcond894.not, label %._crit_edge842.split, label %bb.k, !llvm.loop !1554
...
bb.b:                                             ; preds = %.lr.ph354, %._crit_edge348
  ...
  %i.m = load ptr, ptr %1, align 8, !tbaa !1539
  %i.n = load i64, ptr %i.c, align 8, !tbaa !1541 ; 4 uses
...
.lr.ph:                                           ; preds = %bb.b, %.lr.ph
  ...
  tail call void asm sideeffect "#begin step of gebp micro kernel 1X4", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !819
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #25, !srcloc !820
  %i.ao = load <4 x float>, ptr %.0124327, align 16, !tbaa !54 ; 4 uses
  %i.ap = load <4 x float>, ptr %.0122328, align 16, !tbaa !54 ; 4 uses
  ...
  %i.bd = load <4 x float>, ptr %i.bc, align 16, !tbaa !54 ; 4 uses
  %i.be = getelementptr inbounds nuw i8, ptr %.0122328, i64 16
  %i.bf = load <4 x float>, ptr %i.be, align 16, !tbaa !54 ; 4 uses
  ...
  %i.bt = load <4 x float>, ptr %i.bs, align 16, !tbaa !54 ; 4 uses
  %i.bu = getelementptr inbounds nuw i8, ptr %.0122328, i64 32
  %i.bv = load <4 x float>, ptr %i.bu, align 16, !tbaa !54 ; 4 uses
  ...
  %i.cj = load <4 x float>, ptr %i.ci, align 16, !tbaa !54 ; 4 uses
  %i.ck = getelementptr inbounds nuw i8, ptr %.0122328, i64 48
  %i.cl = load <4 x float>, ptr %i.ck, align 16, !tbaa !54 ; 4 uses
  ...
  %i.da = load <4 x float>, ptr %i.cz, align 16, !tbaa !54 ; 4 uses
  %i.db = getelementptr inbounds nuw i8, ptr %.0122328, i64 64
  %i.dc = load <4 x float>, ptr %i.db, align 16, !tbaa !54 ; 4 uses
