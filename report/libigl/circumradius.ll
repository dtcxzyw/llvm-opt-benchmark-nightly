...
.lr.ph.i.i.i.i.i.i.i.i.i.prol:                    ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i.preheader117
  ...
  %i.as = load double, ptr %i.aq, align 8, !tbaa !38
  %i.at = load double, ptr %i.ar, align 8, !tbaa !38
  ...
  store double %i.bb, ptr %i.ap, align 8, !tbaa !38
...
.lr.ph.i.i.i.i.i.i.i.i.i:                         ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i.prol.loopexit, %.lr.ph.i.i.i.i.i.i.i.i.i
  ...
  %i.bh = load double, ptr %i.bf, align 8, !tbaa !38
  %i.bi = load double, ptr %i.bg, align 8, !tbaa !38
  ...
  store double %i.bq, ptr %i.be, align 8, !tbaa !38
  ...
  %i.bv = load double, ptr %i.bt, align 8, !tbaa !38
  %i.bw = load double, ptr %i.bu, align 8, !tbaa !38
  %i.bx = fmul double %i.bv, %i.bw
  %i.by = getelementptr inbounds [8 x i8], ptr %i.f, i64 %i.br
  %i.bz = load double, ptr %i.by, align 8, !tbaa !38
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  %i.da = load ptr, ptr %4, align 8, !tbaa !74
...
bb.i:                                             ; preds = %bb.h, %bb.e
  ...
  %i.db = load ptr, ptr %3, align 8, !tbaa !85
...
bb.b:                                             ; preds = %.lr.ph, %.loopexit
  ...
  %i.as = load i64, ptr %i.a, align 8, !tbaa !32  ; 11 uses
...
.invoke:                                          ; preds = %_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit.i.i, %bb.d, %bb.c
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.bb, align 8, !tbaa !31
...
.sink.split.i:                                    ; preds = %_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit.i.i
  store ptr %i.az, ptr %13, align 8, !tbaa !33
...
bb.e:                                             ; preds = %.invoke
  %i.bc = landingpad { ptr, i32 }
          cleanup
  %i.bd = load ptr, ptr %13, align 8, !tbaa !33
...
_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEE6resizeEll.exit.i.i.thread: ; preds = %bb.b, %.sink.split.i
  ...
  store i64 %i.at, ptr %i.k, align 8, !tbaa !34
  store i64 %i.at, ptr %i.l, align 8, !tbaa !29
  call void @llvm.lifetime.start.p0(ptr nonnull %14) #20
  %i.bf = load ptr, ptr %1, align 8, !tbaa !35, !noalias !563
  %i.bg = getelementptr inbounds nuw [4 x i8], ptr %i.bf, i64 %indvars.iv
  %i.bh = load i64, ptr %i.e, align 8, !tbaa !88, !noalias !564 ; 16 uses
...
.invoke295:                                       ; preds = %_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit.i.i123, %bb.i, %bb.g
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.bs, align 8, !tbaa !31
...
.sink.split.i121:                                 ; preds = %_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit.i.i123, %bb.h
  ...
  store ptr %.sink.i122, ptr %14, align 8, !tbaa !89
  br label %bb.j
...
bb.j:                                             ; preds = %.sink.split.i121, %_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELin1ELi1ELin1ELin1EEEE6resizeEll.exit.i.i.i.i.i.i.i
  ...
  store i64 %i.as, ptr %i.m, align 8, !tbaa !90
  store i64 %i.bh, ptr %i.n, align 8, !tbaa !88
...
vector.body438:                                   ; preds = %vector.memcheck431, %vector.body438
  ...
  %wide.load440 = load <2 x double>, ptr %i.cl, align 8, !tbaa !38
  %wide.load441 = load <2 x double>, ptr %i.cm, align 8, !tbaa !38
  %i.cn = getelementptr i8, ptr %i.ck, i64 16
  store <2 x double> %wide.load440, ptr %i.ck, align 8, !tbaa !38
  store <2 x double> %wide.load441, ptr %i.cn, align 8, !tbaa !38
  %index.next442 = add nuw i64 %index439, 4       ; 2 uses
  %i.co = icmp eq i64 %index.next442, %n.vec437
  br i1 %i.co, label %middle.block443, label %vector.body438, !llvm.loop !495
...
scalar.ph434.prol:                                ; preds = %scalar.ph434.preheader, %scalar.ph434.prol
  ...
  store double %i.cr, ptr %i.cp, align 8, !tbaa !38
  %i.cs = add nuw nsw i64 %.09.i.i.i.i.i.i.i.prol, 1 ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %scalar.ph434.prol.loopexit, label %scalar.ph434.prol, !llvm.loop !496
...
._crit_edge.i.i.i.i.i.i.i:                        ; preds = %scalar.ph434.prol.loopexit, %scalar.ph434, %middle.block443
  ...
  br i1 %exitcond12.not.i.i.i.i.i.i.i, label %.loopexit226.loopexit, label %.preheader.i.i.i.i.i.i.i, !llvm.loop !497
...
scalar.ph434:                                     ; preds = %scalar.ph434.prol.loopexit, %scalar.ph434
  ...
  %i.cy = load double, ptr %i.cx, align 8, !tbaa !38
  store double %i.cy, ptr %i.cw, align 8, !tbaa !38
...
bb.b:                                             ; preds = %.lr.ph, %.loopexit
  ...
  %i.ay = load ptr, ptr %1, align 8, !tbaa !98, !noalias !634
  %i.az = getelementptr inbounds nuw [4 x i8], ptr %i.ay, i64 %indvars.iv ; 3 uses
  %i.ba = load i64, ptr %i.d, align 8, !tbaa !88, !noalias !635 ; 8 uses
  ...
  %i.bb = load ptr, ptr %0, align 8, !tbaa !89, !noalias !636 ; 4 uses
...
.split.i.i.i.i.i.i.i.i:                           ; preds = %bb.c
  %i.be = load i64, ptr %i.a, align 8, !tbaa !97  ; 2 uses
  %i.bf = load i32, ptr %i.az, align 4, !tbaa !36
...
vector.body260:                                   ; preds = %vector.body260, %vector.ph258
  ...
  %wide.load262 = load <2 x double>, ptr %i.bo, align 8, !tbaa !38
  %wide.load263 = load <2 x double>, ptr %i.bp, align 8, !tbaa !38
  %i.bq = getelementptr i8, ptr %i.bn, i64 16
  store <2 x double> %wide.load262, ptr %i.bn, align 8, !tbaa !38
  store <2 x double> %wide.load263, ptr %i.bq, align 8, !tbaa !38
  %index.next264 = add nuw i64 %index261, 4       ; 2 uses
  %i.br = icmp eq i64 %index.next264, %n.vec259
  br i1 %i.br, label %middle.block265, label %vector.body260, !llvm.loop !595
...
scalar.ph256.prol:                                ; preds = %scalar.ph256.preheader, %scalar.ph256.prol
  ...
  %i.bu = load double, ptr %i.bt, align 8, !tbaa !38
  store double %i.bu, ptr %i.bs, align 8, !tbaa !38
...
vector.body246:                                   ; preds = %vector.body246, %vector.ph244
  ...
  %i.cm = getelementptr i8, ptr %i.cl, i64 16
  %wide.load248 = load <2 x double>, ptr %i.cl, align 8, !tbaa !38
  %wide.load249 = load <2 x double>, ptr %i.cm, align 8, !tbaa !38
  %i.cn = getelementptr i8, ptr %i.ck, i64 16
  store <2 x double> %wide.load248, ptr %i.ck, align 8, !tbaa !38
  store <2 x double> %wide.load249, ptr %i.cn, align 8, !tbaa !38
  %index.next250 = add nuw i64 %index247, 4       ; 2 uses
  %i.co = icmp eq i64 %index.next250, %n.vec245
  br i1 %i.co, label %middle.block251, label %vector.body246, !llvm.loop !597
...
scalar.ph242:                                     ; preds = %scalar.ph242.prol.loopexit, %scalar.ph242
  ...
  %i.cx = load double, ptr %i.cw, align 8, !tbaa !38
  store double %i.cx, ptr %i.cv, align 8, !tbaa !38
  ...
  %i.db = load double, ptr %i.da, align 8, !tbaa !38
  ...
  %i.dj = load double, ptr %i.di, align 8, !tbaa !38
  store double %i.dj, ptr %i.dh, align 8, !tbaa !38
...
bb.b:                                             ; preds = %.lr.ph, %.loopexit
  ...
  %i.au = load ptr, ptr %1, align 8, !tbaa !98, !noalias !768
  %i.av = getelementptr inbounds nuw [4 x i8], ptr %i.au, i64 %indvars.iv ; 3 uses
  %i.aw = load i64, ptr %i.d, align 8, !tbaa !29, !noalias !769 ; 2 uses
  ...
  %i.ax = load ptr, ptr %0, align 8, !tbaa !33, !noalias !770 ; 6 uses
  %i.ay = load i64, ptr %i.i, align 8, !tbaa !34, !noalias !770 ; 4 uses
...
.lr.ph.i.i.i.i.i.i.i.i:                           ; preds = %bb.c
  %i.ba = load i32, ptr %i.av, align 4, !tbaa !36
...
vector.body252:                                   ; preds = %vector.body252, %vector.ph250
  ...
  %wide.load = load <2 x double>, ptr %i.ci, align 8, !tbaa !38, !alias.scope !771, !noalias !772
  %i.cj = getelementptr [8 x i8], ptr %i.bi, i64 %index253
  %wide.load254 = load <2 x double>, ptr %i.cj, align 8, !tbaa !38, !alias.scope !773, !noalias !772
  %i.ck = getelementptr [8 x i8], ptr %i.bn, i64 %index253
  %wide.load255 = load <2 x double>, ptr %i.ck, align 8, !tbaa !38, !alias.scope !774, !noalias !772
  ...
  store <6 x double> %interleaved.vec, ptr %i.ch, align 8, !tbaa !38, !alias.scope !772
  %index.next256 = add nuw i64 %index253, 2       ; 2 uses
  %i.cn = icmp eq i64 %index.next256, %n.vec251
  br i1 %i.cn, label %middle.block257, label %vector.body252, !llvm.loop !738
...
scalar.ph248.prol:                                ; preds = %scalar.ph248.preheader
  ...
  %i.cr = load double, ptr %i.cq, align 8, !tbaa !38
  store double %i.cr, ptr %i.co, align 8, !tbaa !38
  %i.cs = getelementptr i8, ptr %i.bd, i64 %.idx.i.i.i.i.i.i.i.i.i.i.i.i.prol
  %i.ct = getelementptr [8 x i8], ptr %i.bi, i64 %i.cp
  %i.cu = load double, ptr %i.ct, align 8, !tbaa !38
  store double %i.cu, ptr %i.cs, align 8, !tbaa !38
...
scalar.ph248:                                     ; preds = %scalar.ph248.prol.loopexit, %scalar.ph248
  ...
  %i.dd = load double, ptr %i.dc, align 8, !tbaa !38
  store double %i.dd, ptr %i.da, align 8, !tbaa !38
  ...
  store double %i.dg, ptr %i.de, align 8, !tbaa !38
  ...
  %i.do = load double, ptr %i.dn, align 8, !tbaa !38
  store double %i.do, ptr %i.dl, align 8, !tbaa !38
  ...
  store double %i.dr, ptr %i.dp, align 8, !tbaa !38
  %i.ds = getelementptr i8, ptr %i.bj, i64 %.idx.i.i.i.i.i.i.i.i.i.i.i.i.1
  %i.dt = getelementptr [8 x i8], ptr %i.bn, i64 %i.dm
  %i.du = load double, ptr %i.dt, align 8, !tbaa !38
  store double %i.du, ptr %i.ds, align 8, !tbaa !38
...
bb.d:                                             ; preds = %thread-pre-split.i.i.i.i.i.i.i
  %i.dw = landingpad { ptr, i32 }
          cleanup
  %i.dx = load ptr, ptr %8, align 8, !tbaa !148, !alias.scope !770
...
begin_hunk_3_@_ZN5Eigen8internal26call_dense_assignment_loopINS_5BlockINS2_INS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEELin1ELin1ELb0EEELin1ELin1ELb0EEENS_7ProductINS_13CwiseBinaryOpINS0_17scalar_product_opIddEEKNS_14CwiseNullaryOpINS0_18scalar_constant_opIdEEKS4_EEKNS2_IKNS3_IdLin1ELin1ELi0ELin1ELin1EEELin1ELi1ELb0EEEEENS_3MapINS3_IdLi1ELin1ELi1ELi1ELi1EEELi0ENS_6StrideILi0ELi0EEEEELi1EEENS0_13sub_assign_opIddEEEEvRT_RKT0_RKT1_:bb.a
  ...
  store ptr %4, ptr %5, align 8, !tbaa !1463
  %i.by = getelementptr inbounds nuw i8, ptr %5, i64 8
  store ptr %3, ptr %i.by, align 8, !tbaa !1464
  %i.bz = getelementptr inbounds nuw i8, ptr %5, i64 16
  store ptr %2, ptr %i.bz, align 8, !tbaa !285
  %i.ca = getelementptr inbounds nuw i8, ptr %5, i64 24
  store ptr %0, ptr %i.ca, align 8, !tbaa !1465
...
bb.c:                                             ; preds = %.loopexit
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #20
  %i.cb = load ptr, ptr %3, align 8, !tbaa !74
...
bb.d:                                             ; preds = %.loopexit
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #20
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #20
  %i.cd = load ptr, ptr %3, align 8, !tbaa !74
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !1494, !nonnull !59, !align !60 ; 6 uses
...
.preheader.lr.ph.i:                               ; preds = %bb.b
  ...
  %i.j = load i64, ptr %i.i, align 8, !tbaa !44   ; 9 uses
...
.preheader.lr.ph.split.i:                         ; preds = %.preheader.lr.ph.i
  ...
  %i.m = load ptr, ptr %i.l, align 8, !nonnull !59, !align !60 ; 2 uses
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 16
  %i.o = load ptr, ptr %0, align 8, !nonnull !59, !align !60 ; 2 uses
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 16
  %i.q = load ptr, ptr %i.o, align 8, !tbaa !281  ; 4 uses
  %i.r = load i64, ptr %i.p, align 8, !tbaa !44   ; 3 uses
  %i.s = load ptr, ptr %i.m, align 8, !tbaa !74, !noalias !1495 ; 6 uses
  %i.t = load ptr, ptr %i.n, align 8, !tbaa !272, !noalias !1496 ; 3 uses
...
vector.ph:                                        ; preds = %.preheader.i
  %i.ae = load double, ptr %i.ad, align 8, !tbaa !38, !alias.scope !1497
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.ag, align 8, !tbaa !38, !alias.scope !1498
  %wide.load69 = load <2 x double>, ptr %i.ah, align 8, !tbaa !38, !alias.scope !1498
  ...
  %wide.load70 = load <2 x double>, ptr %i.af, align 8, !tbaa !38, !alias.scope !1499, !noalias !1500
  %wide.load71 = load <2 x double>, ptr %i.ak, align 8, !tbaa !38, !alias.scope !1499, !noalias !1500
  %i.al = fsub <2 x double> %wide.load70, %i.ai
  %i.am = fsub <2 x double> %wide.load71, %i.aj
  store <2 x double> %i.al, ptr %i.af, align 8, !tbaa !38, !alias.scope !1499, !noalias !1500
  store <2 x double> %i.am, ptr %i.ak, align 8, !tbaa !38, !alias.scope !1499, !noalias !1500
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.an = icmp eq i64 %index.next, %n.vec
  br i1 %i.an, label %middle.block, label %vector.body, !llvm.loop !1474
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader
  ...
  %i.aq = load double, ptr %i.ap, align 8, !tbaa !38
  %i.ar = load double, ptr %i.ad, align 8, !tbaa !38
  %i.as = fmul double %i.aq, %i.ar
  %i.at = load double, ptr %i.ao, align 8, !tbaa !38
  %i.au = fsub double %i.at, %i.as
  store double %i.au, ptr %i.ao, align 8, !tbaa !38
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.bb = load double, ptr %i.ad, align 8, !tbaa !38
  %i.bc = fmul double %i.ba, %i.bb
  %i.bd = load double, ptr %i.ay, align 8, !tbaa !38
  %i.be = fsub double %i.bd, %i.bc
  store double %i.be, ptr %i.ay, align 8, !tbaa !38
  ...
  %i.bj = load double, ptr %i.ad, align 8, !tbaa !38
  %i.bk = fmul double %i.bi, %i.bj
  %i.bl = load double, ptr %i.bg, align 8, !tbaa !38
  %i.bm = fsub double %i.bl, %i.bk
  store double %i.bm, ptr %i.bg, align 8, !tbaa !38
  %i.bn = add nuw nsw i64 %.09.i, 2               ; 2 uses
  %exitcond.not.i.1 = icmp eq i64 %i.bn, %i.j
  br i1 %exitcond.not.i.1, label %._crit_edge.i, label %scalar.ph, !llvm.loop !1476

_ZN5Eigen8internal13first_alignedILi16EdlEET1_PKT0_S2_.exit: ; preds = %bb.a
  %i.bo = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %i.bp = load i64, ptr %i.bo, align 8, !tbaa !44 ; 7 uses
  %i.bq = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  %i.br = load i64, ptr %i.bq, align 8, !tbaa !44 ; 2 uses
  %i.bs = getelementptr inbounds nuw i8, ptr %i.b, i64 48
  %i.bt = load ptr, ptr %i.bs, align 8, !tbaa !265, !nonnull !59, !align !60
...
.preheader43.loopexit:                            ; preds = %bb.c
  %i.ci = load ptr, ptr %i.cb, align 8, !tbaa !1501, !nonnull !59, !align !60 ; 2 uses
  %i.cj = getelementptr inbounds nuw i8, ptr %i.ci, i64 16
  %i.ck = load ptr, ptr %i.cj, align 8, !tbaa !272, !noalias !1502
  %i.cl = getelementptr inbounds nuw [8 x i8], ptr %i.ck, i64 %.03451
  %i.cm = load ptr, ptr %i.ci, align 8, !tbaa !74, !noalias !1503
  %i.cn = load ptr, ptr %0, align 8, !tbaa !1504, !nonnull !59, !align !60 ; 2 uses
  %i.co = load ptr, ptr %i.cn, align 8, !tbaa !281
  ...
  %i.ct = load double, ptr %i.cm, align 8, !tbaa !38
  %i.cu = load double, ptr %i.cl, align 8, !tbaa !38
  %i.cv = fmul double %i.ct, %i.cu
  %i.cw = load double, ptr %i.cs, align 8, !tbaa !38
  %i.cx = fsub double %i.cw, %i.cv
  store double %i.cx, ptr %i.cs, align 8, !tbaa !38
...
.lr.ph49:                                         ; preds = %.preheader
  %i.da = load ptr, ptr %0, align 8, !tbaa !1504, !nonnull !59, !align !60 ; 2 uses
  %i.db = load ptr, ptr %i.da, align 8, !tbaa !281 ; 3 uses
  ...
  %i.dg = load ptr, ptr %i.cb, align 8, !tbaa !1501, !nonnull !59, !align !60 ; 2 uses
  %i.dh = load ptr, ptr %i.dg, align 8, !tbaa !74, !noalias !1505 ; 4 uses
  %i.di = getelementptr inbounds nuw i8, ptr %i.dg, i64 16
  %i.dj = load ptr, ptr %i.di, align 8, !tbaa !272, !noalias !1506 ; 2 uses
...
vector.ph88:                                      ; preds = %vector.memcheck72
  ...
  %i.dw = load double, ptr %i.dk, align 8, !tbaa !38, !alias.scope !1507
...
vector.body90:                                    ; preds = %vector.body90, %vector.ph88
  ...
  %wide.load92 = load <2 x double>, ptr %i.dz, align 8, !tbaa !38, !alias.scope !1508
  %wide.load93 = load <2 x double>, ptr %i.ea, align 8, !tbaa !38, !alias.scope !1508
  ...
  %wide.load96 = load <2 x double>, ptr %i.dy, align 8, !tbaa !38, !alias.scope !1509, !noalias !1510
  %wide.load97 = load <2 x double>, ptr %i.ed, align 8, !tbaa !38, !alias.scope !1509, !noalias !1510
  %i.ee = fsub <2 x double> %wide.load96, %i.eb
  %i.ef = fsub <2 x double> %wide.load97, %i.ec
  store <2 x double> %i.ee, ptr %i.dy, align 8, !tbaa !38, !alias.scope !1509, !noalias !1510
  store <2 x double> %i.ef, ptr %i.ed, align 8, !tbaa !38, !alias.scope !1509, !noalias !1510
  %index.next98 = add nuw i64 %index91, 4         ; 2 uses
  %i.eg = icmp eq i64 %index.next98, %n.vec89
  br i1 %i.eg, label %middle.block99, label %vector.body90, !llvm.loop !1489
...
.lr.ph47:                                         ; preds = %.preheader43, %.lr.ph47
  ...
  %i.eh = load ptr, ptr %0, align 8, !tbaa !1504, !nonnull !59, !align !60 ; 2 uses
  %i.ei = load ptr, ptr %i.eh, align 8, !tbaa !281
  %i.ej = getelementptr inbounds nuw i8, ptr %i.eh, i64 16
  %i.ek = load i64, ptr %i.ej, align 8, !tbaa !44
  ...
  %i.eo = load ptr, ptr %i.cb, align 8, !tbaa !1501, !nonnull !59, !align !60 ; 2 uses
  %i.ep = getelementptr inbounds nuw i8, ptr %i.eo, i64 48
  %i.eq = getelementptr inbounds nuw i8, ptr %i.eo, i64 56
  %i.er = load ptr, ptr %i.ep, align 8, !tbaa !1511
  %i.es = getelementptr inbounds [8 x i8], ptr %i.er, i64 %.03246
  %i.et = load <2 x double>, ptr %i.es, align 1, !tbaa !71
  %i.eu = load ptr, ptr %i.eq, align 8, !tbaa !274
  ...
  %i.fa = load <2 x double>, ptr %i.en, align 16, !tbaa !71
  %i.fb = fsub <2 x double> %i.fa, %i.ez
  store <2 x double> %i.fb, ptr %i.en, align 16, !tbaa !71
  %i.fc = add nsw i64 %.03246, 2                  ; 2 uses
  %i.fd = icmp slt i64 %i.fc, %i.cg
  br i1 %i.fd, label %.lr.ph47, label %.preheader, !llvm.loop !1490
...
scalar.ph86:                                      ; preds = %scalar.ph86.preheader, %scalar.ph86
  ...
  %i.fj = load double, ptr %i.fi, align 8, !tbaa !38
  %i.fk = load double, ptr %i.dk, align 8, !tbaa !38
  %i.fl = fmul double %i.fj, %i.fk
  %i.fm = load double, ptr %i.fh, align 8, !tbaa !38
  %i.fn = fsub double %i.fm, %i.fl
  store double %i.fn, ptr %i.fh, align 8, !tbaa !38
  %i.fo = add nsw i64 %.048, 1                    ; 2 uses
  %i.fp = icmp slt i64 %i.fo, %i.bp
  br i1 %i.fp, label %scalar.ph86, label %._crit_edge, !llvm.loop !1492
...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !tbaa !44   ; 4 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.d, align 8, !tbaa !31
...
_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit: ; preds = %bb.a
  %i.e = load ptr, ptr %1, align 8, !tbaa !262    ; 2 uses
...
begin_hunk_4_@_ZNK5Eigen10MatrixBaseINS_5BlockINS1_INS_6MatrixIdLi4ELi4ELi0ELi4ELi4EEELi4ELi1ELb1EEELin1ELi1ELb0EEEE15makeHouseholderINS_11VectorBlockIS5_Lin1EEEEEvRT_RdSC_:bb.a
  %i.fz = load double, ptr %i.fy, align 8, !tbaa !38
  %i.ga = fdiv double %i.fz, %i.db
  store double %i.ga, ptr %i.fx, align 8, !tbaa !38
  ...
  %i.ge = load double, ptr %i.gd, align 8, !tbaa !38
  %i.gf = fdiv double %i.ge, %i.db
  store double %i.gf, ptr %i.gc, align 8, !tbaa !38
...
.lr.ph.i.i.i.i.i.i.i.i.i.i:                       ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i.i, %.lr.ph.i.preheader.i.i.i.i.i.i.i.i.i
  ...
  %i.go = load <2 x double>, ptr %i.gn, align 1, !tbaa !71
  %i.gp = fdiv <2 x double> %i.go, %i.ey
  store <2 x double> %i.gp, ptr %i.gm, align 16, !tbaa !71
  %i.gq = add nsw i64 %.021.i.i.i.i.i.i.i.i.i.i, 2 ; 2 uses
  %i.gr = icmp slt i64 %i.gq, %i.dn
  br i1 %i.gr, label %.lr.ph.i.i.i.i.i.i.i.i.i.i, label %._crit_edge.i.i.i.i.i.i.i.i.i.i, !llvm.loop !1754
...
_ZN5Eigen5BlockINS0_INS0_INS_6MatrixIdLi4ELi4ELi0ELi4ELi4EEELi4ELi1ELb1EEELin1ELi1ELb0EEELin1ELi1ELb0EEaSINS_13CwiseBinaryOpINS_8internal18scalar_quotient_opIddEEKNS0_IKS4_Lin1ELi1ELb0EEEKNS_14CwiseNullaryOpINS8_18scalar_constant_opIdEEKNS1_IdLin1ELi1ELi0ELi4ELi1EEEEEEEEERS5_RKNS_9DenseBaseIT_EE.exit: ; preds = %.lr.ph.i17.i.i.i.i.i.i.i.i.i.i.prol.loopexit, %.lr.ph.i17.i.i.i.i.i.i.i.i.i.i, %middle.block52, %._crit_edge.i.i.i.i.i.i.i.i.i.i
  %i.gs = load double, ptr %3, align 8, !tbaa !38 ; 2 uses
  %i.gt = fsub double %i.gs, %i.br
  %i.gu = fdiv double %i.gt, %i.gs
  store double %i.gu, ptr %2, align 8, !tbaa !38
...
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !1777, !nonnull !59, !align !60 ; 5 uses
...
.preheader.lr.ph.i:                               ; preds = %bb.b
  %i.i = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %i.j = load i64, ptr %i.i, align 8, !tbaa !44   ; 8 uses
  %i.k = icmp sgt i64 %i.j, 0
  %i.l = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.m = load ptr, ptr %i.l, align 8, !nonnull !59, !align !335 ; 7 uses
...
.preheader.lr.ph.split.i:                         ; preds = %.preheader.lr.ph.i
  ...
  %i.o = load ptr, ptr %0, align 8, !nonnull !59, !align !60
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !331  ; 4 uses
  %i.q = load ptr, ptr %i.n, align 16, !tbaa !1778, !noalias !1779 ; 3 uses
  %i.r = shl i64 %i.g, 5
...
vector.ph:                                        ; preds = %.preheader.i
  %i.y = load double, ptr %i.x, align 8, !tbaa !38, !alias.scope !1780
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.aa, align 16, !tbaa !38, !alias.scope !1781
  %wide.load70 = load <2 x double>, ptr %i.ab, align 16, !tbaa !38, !alias.scope !1781
  ...
  %wide.load71 = load <2 x double>, ptr %i.z, align 8, !tbaa !38, !alias.scope !1782, !noalias !1783
  %wide.load72 = load <2 x double>, ptr %i.ae, align 8, !tbaa !38, !alias.scope !1782, !noalias !1783
  %i.af = fsub <2 x double> %wide.load71, %i.ac
  %i.ag = fsub <2 x double> %wide.load72, %i.ad
  store <2 x double> %i.af, ptr %i.z, align 8, !tbaa !38, !alias.scope !1782, !noalias !1783
  store <2 x double> %i.ag, ptr %i.ae, align 8, !tbaa !38, !alias.scope !1782, !noalias !1783
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ah = icmp eq i64 %index.next, %n.vec
  br i1 %i.ah, label %middle.block, label %vector.body, !llvm.loop !1761
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader
  ...
  %i.ak = load double, ptr %i.aj, align 16, !tbaa !38
  %i.al = load double, ptr %i.x, align 8, !tbaa !38
  %i.am = fmul double %i.ak, %i.al
  %i.an = load double, ptr %i.ai, align 8, !tbaa !38
  %i.ao = fsub double %i.an, %i.am
  store double %i.ao, ptr %i.ai, align 8, !tbaa !38
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.av = load double, ptr %i.x, align 8, !tbaa !38
  %i.aw = fmul double %i.au, %i.av
  %i.ax = load double, ptr %i.as, align 8, !tbaa !38
  %i.ay = fsub double %i.ax, %i.aw
  store double %i.ay, ptr %i.as, align 8, !tbaa !38
  ...
  %i.bd = load double, ptr %i.x, align 8, !tbaa !38
  %i.be = fmul double %i.bc, %i.bd
  %i.bf = load double, ptr %i.ba, align 8, !tbaa !38
  %i.bg = fsub double %i.bf, %i.be
  store double %i.bg, ptr %i.ba, align 8, !tbaa !38
  %i.bh = add nuw nsw i64 %.09.i, 2               ; 2 uses
  %exitcond.not.i.1 = icmp eq i64 %i.bh, %i.j
  br i1 %exitcond.not.i.1, label %._crit_edge.i, label %scalar.ph, !llvm.loop !1763

_ZN5Eigen8internal13first_alignedILi16EdlEET1_PKT0_S2_.exit: ; preds = %bb.a
  %i.bi = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %i.bj = load i64, ptr %i.bi, align 8, !tbaa !44 ; 7 uses
  %i.bk = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  %i.bl = load i64, ptr %i.bk, align 8, !tbaa !44 ; 2 uses
...
.preheader45.loopexit:                            ; preds = %bb.c
  %i.by = load ptr, ptr %i.bq, align 8, !tbaa !1784, !nonnull !59, !align !335 ; 2 uses
  %i.bz = getelementptr inbounds nuw i8, ptr %i.by, i64 48
  %i.ca = load ptr, ptr %i.bz, align 16, !tbaa !1778, !noalias !1785
  %i.cb = getelementptr inbounds nuw [8 x i8], ptr %i.ca, i64 %.03453
  %i.cc = load ptr, ptr %0, align 8, !tbaa !1786, !nonnull !59, !align !60
  %i.cd = load ptr, ptr %i.cc, align 8, !tbaa !331
  %.idx.i.i.i = shl i64 %.03453, 5
  %i.ce = getelementptr i8, ptr %i.cd, i64 %.idx.i.i.i ; 2 uses
  %i.cf = load double, ptr %i.by, align 16, !tbaa !38
  %i.cg = load double, ptr %i.cb, align 8, !tbaa !38
  %i.ch = fmul double %i.cf, %i.cg
  %i.ci = load double, ptr %i.ce, align 8, !tbaa !38
  %i.cj = fsub double %i.ci, %i.ch
  store double %i.cj, ptr %i.ce, align 8, !tbaa !38
...
.lr.ph51:                                         ; preds = %.preheader
  %i.cm = load ptr, ptr %0, align 8, !tbaa !1786, !nonnull !59, !align !60
  %i.cn = load ptr, ptr %i.cm, align 8, !tbaa !331 ; 3 uses
  %.idx.i.i.i38 = shl i64 %.03453, 5              ; 2 uses
  %i.co = getelementptr i8, ptr %i.cn, i64 %.idx.i.i.i38 ; 2 uses
  %i.cp = load ptr, ptr %i.bq, align 8, !tbaa !1784, !nonnull !59, !align !335 ; 5 uses
  %i.cq = getelementptr inbounds nuw i8, ptr %i.cp, i64 48
  %i.cr = load ptr, ptr %i.cq, align 16, !tbaa !1778, !noalias !1787 ; 2 uses
...
vector.ph88:                                      ; preds = %vector.memcheck73
  ...
  %i.de = load double, ptr %i.cs, align 8, !tbaa !38, !alias.scope !1788
...
vector.body90:                                    ; preds = %vector.body90, %vector.ph88
  ...
  %wide.load92 = load <2 x double>, ptr %i.dh, align 8, !tbaa !38, !alias.scope !1789
  %wide.load93 = load <2 x double>, ptr %i.di, align 8, !tbaa !38, !alias.scope !1789
  ...
  %wide.load96 = load <2 x double>, ptr %i.dg, align 8, !tbaa !38, !alias.scope !1790, !noalias !1791
  %wide.load97 = load <2 x double>, ptr %i.dl, align 8, !tbaa !38, !alias.scope !1790, !noalias !1791
  %i.dm = fsub <2 x double> %wide.load96, %i.dj
  %i.dn = fsub <2 x double> %wide.load97, %i.dk
  store <2 x double> %i.dm, ptr %i.dg, align 8, !tbaa !38, !alias.scope !1790, !noalias !1791
  store <2 x double> %i.dn, ptr %i.dl, align 8, !tbaa !38, !alias.scope !1790, !noalias !1791
  %index.next98 = add nuw i64 %index91, 4         ; 2 uses
  %i.do = icmp eq i64 %index.next98, %n.vec89
  br i1 %i.do, label %middle.block99, label %vector.body90, !llvm.loop !1772
...
bb.d:                                             ; preds = %.lr.ph49, %bb.d
  ...
  %i.dp = load ptr, ptr %0, align 8, !tbaa !1786, !nonnull !59, !align !60
  %i.dq = load ptr, ptr %i.dp, align 8, !tbaa !331
  %i.dr = getelementptr i8, ptr %i.dq, i64 %.idx.i.i.i37
  %i.ds = getelementptr [8 x i8], ptr %i.dr, i64 %.03248 ; 2 uses
  %i.dt = load ptr, ptr %i.bq, align 8, !tbaa !1784, !nonnull !59, !align !335 ; 2 uses
  %i.du = getelementptr inbounds nuw i8, ptr %i.dt, i64 80
  %i.dv = getelementptr inbounds nuw i8, ptr %i.dt, i64 88
  %i.dw = load ptr, ptr %i.du, align 16, !tbaa !336
  %i.dx = getelementptr inbounds [8 x i8], ptr %i.dw, i64 %.03248
  %i.dy = load <2 x double>, ptr %i.dx, align 1, !tbaa !71
  %i.dz = load ptr, ptr %i.dv, align 8, !tbaa !324
  %i.ea = getelementptr [8 x i8], ptr %i.dz, i64 %.03453
  %i.eb = load double, ptr %i.ea, align 8, !tbaa !38
  ...
  %i.ef = load <2 x double>, ptr %i.ds, align 16, !tbaa !71
  %i.eg = fsub <2 x double> %i.ef, %i.ee
  store <2 x double> %i.eg, ptr %i.ds, align 16, !tbaa !71
  %i.eh = add nsw i64 %.03248, 2                  ; 2 uses
  %i.ei = icmp slt i64 %i.eh, %i.bw
  br i1 %i.ei, label %bb.d, label %.preheader, !llvm.loop !1773
...
scalar.ph86:                                      ; preds = %scalar.ph86.preheader, %scalar.ph86
  ...
  %i.eo = load double, ptr %i.cs, align 8, !tbaa !38
  %i.ep = fmul double %i.en, %i.eo
  %i.eq = load double, ptr %i.el, align 8, !tbaa !38
  %i.er = fsub double %i.eq, %i.ep
  store double %i.er, ptr %i.el, align 8, !tbaa !38
  %i.es = add nsw i64 %.050, 1                    ; 2 uses
  %i.et = icmp slt i64 %i.es, %i.bj
  br i1 %i.et, label %scalar.ph86, label %._crit_edge, !llvm.loop !1775
...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !tbaa !313  ; 14 uses
...
bb.c:                                             ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #20
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %6, ptr noundef nonnull align 16 dereferenceable(32) %1, i64 32, i1 false), !tbaa.struct !1805
...
._crit_edge.i.i.i.i.i.i.epil:                     ; preds = %._crit_edge.i.i.i.i.i.i.epil, %._crit_edge.i.i.i.i.i.i.epil.preheader
  ...
  %.pre64.epil = load double, ptr %i.og, align 8, !tbaa !38
  %i.oh = fmul double %i.f, %.pre64.epil
  store double %i.oh, ptr %i.og, align 8, !tbaa !38
  ...
  br i1 %epil.iter172.cmp.not, label %_ZN5Eigen9DenseBaseINS_5BlockINS_6MatrixIdLi4ELi1ELi0ELi4ELi1EEELin1ELin1ELb0EEEEmLERKd.exit, label %._crit_edge.i.i.i.i.i.i.epil, !llvm.loop !1845
...
.preheader.i.i.i.i.i.i.i.epil:                    ; preds = %.preheader.i.i.i.i.i.i.i.epil, %.preheader.i.i.i.i.i.i.i.epil.preheader
  ...
  %i.ok = load double, ptr %i.oj, align 8, !tbaa !38
  %i.ol = fmul double %i.f, %i.ok
  store double %i.ol, ptr %i.oj, align 8, !tbaa !38
  %i.om = add nuw nsw i64 %.0810.i.i.i.i.i.i.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter166
  br i1 %epil.iter.cmp.not, label %_ZN5Eigen9DenseBaseINS_5BlockINS_6MatrixIdLi4ELi1ELi0ELi4ELi1EEELin1ELin1ELb0EEEEmLERKd.exit, label %.preheader.i.i.i.i.i.i.i.epil, !llvm.loop !1846
...
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !1887, !nonnull !59, !align !60 ; 5 uses
...
.preheader.lr.ph.split.i:                         ; preds = %.preheader.lr.ph.i
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 48
  %i.o = load ptr, ptr %0, align 8, !nonnull !59, !align !60
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !347  ; 4 uses
  %i.q = load ptr, ptr %i.n, align 16, !tbaa !272, !noalias !1888 ; 3 uses
  %i.r = shl i64 %i.g, 5
  %i.s = shl i64 %i.j, 3                          ; 2 uses
  %i.t = getelementptr i8, ptr %i.p, i64 %i.r
  %i.u = getelementptr i8, ptr %i.t, i64 %i.s
...
vector.ph:                                        ; preds = %.preheader.i
  %i.y = load double, ptr %i.x, align 8, !tbaa !38, !alias.scope !1889
  %broadcast.splatinsert = insertelement <2 x double> poison, double %i.y, i64 0
  %broadcast.splat = shufflevector <2 x double> %broadcast.splatinsert, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.aa = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %index ; 2 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %i.aa, i64 16
  %wide.load = load <2 x double>, ptr %i.aa, align 16, !tbaa !38, !alias.scope !1890
  %wide.load70 = load <2 x double>, ptr %i.ab, align 16, !tbaa !38, !alias.scope !1890
  %i.ac = fmul <2 x double> %wide.load, %broadcast.splat
  %i.ad = fmul <2 x double> %wide.load70, %broadcast.splat
  %i.ae = getelementptr i8, ptr %i.z, i64 16      ; 2 uses
  %wide.load71 = load <2 x double>, ptr %i.z, align 8, !tbaa !38, !alias.scope !1891, !noalias !1892
  %wide.load72 = load <2 x double>, ptr %i.ae, align 8, !tbaa !38, !alias.scope !1891, !noalias !1892
  %i.af = fsub <2 x double> %wide.load71, %i.ac
  %i.ag = fsub <2 x double> %wide.load72, %i.ad
  store <2 x double> %i.af, ptr %i.z, align 8, !tbaa !38, !alias.scope !1891, !noalias !1892
  store <2 x double> %i.ag, ptr %i.ae, align 8, !tbaa !38, !alias.scope !1891, !noalias !1892
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ah = icmp eq i64 %index.next, %n.vec
  br i1 %i.ah, label %middle.block, label %vector.body, !llvm.loop !1871
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.bh = add nuw nsw i64 %.09.i, 2               ; 2 uses
  %exitcond.not.i.1 = icmp eq i64 %i.bh, %i.j
  br i1 %exitcond.not.i.1, label %._crit_edge.i, label %scalar.ph, !llvm.loop !1873
...
.preheader45.loopexit:                            ; preds = %bb.c
  %i.by = load ptr, ptr %i.bq, align 8, !tbaa !1893, !nonnull !59, !align !335 ; 2 uses
  %i.bz = getelementptr inbounds nuw i8, ptr %i.by, i64 48
  %i.ca = load ptr, ptr %i.bz, align 16, !tbaa !272, !noalias !1894
  %i.cb = getelementptr inbounds nuw [8 x i8], ptr %i.ca, i64 %.03453
  %i.cc = load ptr, ptr %0, align 8, !tbaa !1895, !nonnull !59, !align !60
  %i.cd = load ptr, ptr %i.cc, align 8, !tbaa !347
  %.idx.i.i.i = shl i64 %.03453, 5
  %i.ce = getelementptr i8, ptr %i.cd, i64 %.idx.i.i.i ; 2 uses
  %i.cf = load double, ptr %i.by, align 16, !tbaa !38
  %i.cg = load double, ptr %i.cb, align 8, !tbaa !38
...
.lr.ph51:                                         ; preds = %.preheader
  %i.cm = load ptr, ptr %0, align 8, !tbaa !1895, !nonnull !59, !align !60
  %i.cn = load ptr, ptr %i.cm, align 8, !tbaa !347 ; 3 uses
  %.idx.i.i.i38 = shl i64 %.03453, 5              ; 2 uses
  %i.co = getelementptr i8, ptr %i.cn, i64 %.idx.i.i.i38 ; 2 uses
  %i.cp = load ptr, ptr %i.bq, align 8, !tbaa !1893, !nonnull !59, !align !335 ; 5 uses
  %i.cq = getelementptr inbounds nuw i8, ptr %i.cp, i64 48
  %i.cr = load ptr, ptr %i.cq, align 16, !tbaa !272, !noalias !1896 ; 2 uses
  %i.cs = getelementptr inbounds nuw [8 x i8], ptr %i.cr, i64 %.03453 ; 3 uses
  %i.ct = add i64 %.03552, %i.bv
  %i.cu = sub i64 %i.bj, %i.ct                    ; 3 uses
  %min.iters.check87 = icmp ult i64 %i.cu, 6
...
vector.ph88:                                      ; preds = %vector.memcheck73
  %n.vec89 = and i64 %i.cu, -4                    ; 3 uses
  %i.dd = add i64 %i.bw, %n.vec89
  %i.de = load double, ptr %i.cs, align 8, !tbaa !38, !alias.scope !1897
  %broadcast.splatinsert94 = insertelement <2 x double> poison, double %i.de, i64 0
  %broadcast.splat95 = shufflevector <2 x double> %broadcast.splatinsert94, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  br label %vector.body90
...
vector.body90:                                    ; preds = %vector.body90, %vector.ph88
  ...
  %i.dh = getelementptr inbounds [8 x i8], ptr %i.cp, i64 %i.df ; 2 uses
  %i.di = getelementptr inbounds nuw i8, ptr %i.dh, i64 16
  %wide.load92 = load <2 x double>, ptr %i.dh, align 8, !tbaa !38, !alias.scope !1898
  %wide.load93 = load <2 x double>, ptr %i.di, align 8, !tbaa !38, !alias.scope !1898
  %i.dj = fmul <2 x double> %wide.load92, %broadcast.splat95
  %i.dk = fmul <2 x double> %wide.load93, %broadcast.splat95
  %i.dl = getelementptr i8, ptr %i.dg, i64 16     ; 2 uses
  %wide.load96 = load <2 x double>, ptr %i.dg, align 8, !tbaa !38, !alias.scope !1899, !noalias !1900
  %wide.load97 = load <2 x double>, ptr %i.dl, align 8, !tbaa !38, !alias.scope !1899, !noalias !1900
  %i.dm = fsub <2 x double> %wide.load96, %i.dj
  %i.dn = fsub <2 x double> %wide.load97, %i.dk
  store <2 x double> %i.dm, ptr %i.dg, align 8, !tbaa !38, !alias.scope !1899, !noalias !1900
  store <2 x double> %i.dn, ptr %i.dl, align 8, !tbaa !38, !alias.scope !1899, !noalias !1900
  %index.next98 = add nuw i64 %index91, 4         ; 2 uses
  %i.do = icmp eq i64 %index.next98, %n.vec89
  br i1 %i.do, label %middle.block99, label %vector.body90, !llvm.loop !1882
...
bb.d:                                             ; preds = %.lr.ph49, %bb.d
  %.03248 = phi i64 [ %.03552, %.lr.ph49 ], [ %i.eh, %bb.d ] ; 3 uses
  %i.dp = load ptr, ptr %0, align 8, !tbaa !1895, !nonnull !59, !align !60
  %i.dq = load ptr, ptr %i.dp, align 8, !tbaa !347
  %i.dr = getelementptr i8, ptr %i.dq, i64 %.idx.i.i.i37
  %i.ds = getelementptr [8 x i8], ptr %i.dr, i64 %.03248 ; 2 uses
  %i.dt = load ptr, ptr %i.bq, align 8, !tbaa !1893, !nonnull !59, !align !335 ; 2 uses
  %i.du = getelementptr inbounds nuw i8, ptr %i.dt, i64 80
  %i.dv = getelementptr inbounds nuw i8, ptr %i.dt, i64 88
  %i.dw = load ptr, ptr %i.du, align 16, !tbaa !336
  %i.dx = getelementptr inbounds [8 x i8], ptr %i.dw, i64 %.03248
  %i.dy = load <2 x double>, ptr %i.dx, align 1, !tbaa !71
  %i.dz = load ptr, ptr %i.dv, align 8, !tbaa !274
  %i.ea = getelementptr [8 x i8], ptr %i.dz, i64 %.03453
  %i.eb = load double, ptr %i.ea, align 8, !tbaa !38
  %i.ec = insertelement <2 x double> poison, double %i.eb, i64 0
  %i.ed = shufflevector <2 x double> %i.ec, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.eh = add nsw i64 %.03248, 2                  ; 2 uses
  %i.ei = icmp slt i64 %i.eh, %i.bw
  br i1 %i.ei, label %bb.d, label %.preheader, !llvm.loop !1883
...
scalar.ph86:                                      ; preds = %scalar.ph86.preheader, %scalar.ph86
  ...
  %i.es = add nsw i64 %.050, 1                    ; 2 uses
  %i.et = icmp slt i64 %i.es, %i.bj
  br i1 %i.et, label %scalar.ph86, label %._crit_edge, !llvm.loop !1885
...
_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit: ; preds = %bb.a
  %i.e = load ptr, ptr %1, align 8, !tbaa !343    ; 2 uses
  %.not = icmp eq ptr %i.e, null
  br i1 %.not, label %bb.c, label %_ZN5Eigen8internal14aligned_mallocEm.exit
...
bb.f:                                             ; preds = %bb.e
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.l, align 8, !tbaa !31
...
bb.h:                                             ; preds = %bb.g
  %i.az = load ptr, ptr %0, align 8, !tbaa !33, !noalias !1998 ; 3 uses
  %i.ba = icmp eq i64 %i.h, 1
  br i1 %i.ba, label %bb.i, label %bb.j

bb.i:                                             ; preds = %bb.h
  %i.bb = load double, ptr %3, align 8, !tbaa !38
  %i.bc = load ptr, ptr %i.f, align 8, !tbaa !85, !noalias !1999 ; 3 uses
  %i.bd = load ptr, ptr %i.b, align 8, !tbaa !85  ; 3 uses
  %i.be = load double, ptr %i.bd, align 8, !tbaa !38
  %i.bf = fmul double %i.ay, %i.be
  %i.bg = load double, ptr %i.bc, align 8, !tbaa !38
  %i.bh = fmul double %i.bf, %i.bg
  %i.bi = getelementptr [8 x i8], ptr %i.bd, i64 %i.d
  %i.bj = load double, ptr %i.bi, align 8, !tbaa !38
  %i.bk = fmul double %i.ay, %i.bj
  %i.bl = getelementptr i8, ptr %i.bc, i64 8
  %i.bm = load double, ptr %i.bl, align 8, !tbaa !38
  ...
  %i.bw = load double, ptr %i.az, align 8, !tbaa !38
  %i.bx = tail call double @llvm.fmuladd.f64(double %i.bb, double %i.bv, double %i.bw)
  store double %i.bx, ptr %i.az, align 8, !tbaa !38
...
bb.j:                                             ; preds = %bb.h
  ...
  %i.bz = load i64, ptr %i.by, align 8, !noalias !2000
  ...
  store i64 %i.bz, ptr %i.ca, align 8, !alias.scope !2001
  %i.cb = getelementptr inbounds nuw i8, ptr %6, i64 24
  store double %i.ay, ptr %i.cb, align 8, !tbaa !51, !alias.scope !2001
  %i.cc = getelementptr inbounds nuw i8, ptr %6, i64 32
  store ptr %i.b, ptr %i.cc, align 8, !tbaa !143, !alias.scope !2001
...
bb.k:                                             ; preds = %bb.g
  %i.ce = load double, ptr %3, align 8, !tbaa !38
  ...
  store i64 %i.av, ptr %i.cg, align 8, !tbaa !200
  %i.ch = getelementptr inbounds nuw i8, ptr %9, i64 24 ; 3 uses
  store i64 %i.k, ptr %i.ch, align 8, !tbaa !201
  %i.ci = getelementptr inbounds nuw i8, ptr %9, i64 32 ; 3 uses
  store i64 3, ptr %i.ci, align 8, !tbaa !202
  ...
  %i.cj = load i64, ptr %i.cg, align 8, !tbaa !200
  %i.ck = load i64, ptr %i.ci, align 8, !tbaa !202 ; 2 uses
  %i.cl = mul nsw i64 %i.ck, %i.cj
  %i.cm = getelementptr inbounds nuw i8, ptr %9, i64 40
  store i64 %i.cl, ptr %i.cm, align 8, !tbaa !2003
  %i.cn = load i64, ptr %i.ch, align 8, !tbaa !201
  %i.co = mul nsw i64 %i.cn, %i.ck
  %i.cp = getelementptr inbounds nuw i8, ptr %9, i64 48
  store i64 %i.co, ptr %i.cp, align 8, !tbaa !2004
  %i.cq = load ptr, ptr %i.a, align 8, !tbaa !363, !nonnull !59, !align !60
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cq, i64 8
  %i.cs = load i64, ptr %i.cr, align 8, !tbaa !86
  %i.ct = load ptr, ptr %2, align 8, !tbaa !365, !nonnull !59, !align !60
  %i.cu = getelementptr inbounds nuw i8, ptr %i.ct, i64 8
  %i.cv = load i64, ptr %i.cu, align 8, !tbaa !86 ; 2 uses
  %i.cw = icmp eq i64 %i.cv, -1
  %i.cx = load i64, ptr %i.g, align 8, !tbaa !86  ; 2 uses
  %..i.i = select i1 %i.cw, i64 %i.cx, i64 %i.cv
  %i.cy = load ptr, ptr %i.b, align 8, !tbaa !85
  %i.cz = load i64, ptr %i.c, align 8, !tbaa !86
  %i.da = load ptr, ptr %i.f, align 8, !tbaa !85
  %i.db = load ptr, ptr %0, align 8, !tbaa !33
  %i.dc = load i64, ptr %i.au, align 8, !tbaa !34
...
_ZN5Eigen8internal16parallelize_gemmILb1ENS0_12gemm_functorIdlNS0_29general_matrix_matrix_productIldLi0ELb0EdLi1ELb0ELi0ELi1EEENS_6MatrixIdLin1ELi3ELi0ELin1ELi3EEENS_9TransposeIKS6_EENS5_IdLin1ELin1ELi0ELin1ELin1EEENS0_19gemm_blocking_spaceILi0EddLin1ELin1ELi3ELi1ELb0EEEEElEEvRKT0_T1_SH_SH_b.exit: ; preds = %bb.k
  %i.dd = load ptr, ptr %9, align 8, !tbaa !206
...
.noexc:                                           ; preds = %bb.c
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.v, align 8, !tbaa !31
...
_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEE6resizeEll.exit.i: ; preds = %bb.c, %bb.b
  ...
  %.pr = load i64, ptr %i.p, align 8, !tbaa !29
  %.pre = load i64, ptr %i.n, align 8, !tbaa !34
  br label %bb.d
...
bb.d:                                             ; preds = %_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEE6resizeEll.exit.i, %bb.a
  ...
  %i.z = load ptr, ptr %0, align 8, !tbaa !33     ; 4 uses
  %i.aa = and i64 %i.x, 1
...
.preheader41.loopexit.i:                          ; preds = %.lr.ph52.i
  ...
  %i.aw = load double, ptr %i.ao, align 8, !tbaa !38
  %i.ax = fmul double %i.av, %i.aw
  %i.ay = getelementptr [8 x i8], ptr %i.at, i64 %i.ar
  %i.az = load double, ptr %i.ay, align 8, !tbaa !38
  %i.ba = load double, ptr %i.as, align 8, !tbaa !38
...
.lr.ph46.i:                                       ; preds = %.preheader.i
  ...
  %i.bq = load ptr, ptr %i.d, align 8, !tbaa !85, !noalias !2029 ; 8 uses
  %i.br = load ptr, ptr %i.g, align 8, !tbaa !85, !noalias !2030 ; 4 uses
  %i.bs = getelementptr [8 x i8], ptr %i.br, i64 %.03150.i ; 5 uses
  %i.bt = load i64, ptr %i.i, align 8, !tbaa !86  ; 5 uses
  %i.bu = load i64, ptr %i.l, align 8, !tbaa !86  ; 3 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.co = load double, ptr %i.bs, align 8, !tbaa !38, !alias.scope !2031
  ...
  %i.cp = load double, ptr %i.bv, align 8, !tbaa !38, !alias.scope !2032
  ...
  %i.cq = load double, ptr %i.bw, align 8, !tbaa !38, !alias.scope !2033
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.ct, align 8, !tbaa !38, !alias.scope !2034
  %wide.load65 = load <2 x double>, ptr %i.cu, align 8, !tbaa !38, !alias.scope !2034
  ...
  %wide.load68 = load <2 x double>, ptr %i.cx, align 8, !tbaa !38, !alias.scope !2035
  %wide.load69 = load <2 x double>, ptr %i.cy, align 8, !tbaa !38, !alias.scope !2035
  ...
  %wide.load72 = load <2 x double>, ptr %i.db, align 8, !tbaa !38, !alias.scope !2036
  %wide.load73 = load <2 x double>, ptr %i.dc, align 8, !tbaa !38, !alias.scope !2036
  ...
  store <2 x double> %i.dj, ptr %i.cs, align 8, !tbaa !38, !alias.scope !2037, !noalias !2038
  store <2 x double> %i.dk, ptr %i.dl, align 8, !tbaa !38, !alias.scope !2037, !noalias !2038
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.dm = icmp eq i64 %index.next, %n.vec
  br i1 %i.dm, label %middle.block, label %vector.body, !llvm.loop !2021
...
.lr.ph44.i:                                       ; preds = %.lr.ph44.i.preheader, %.lr.ph44.i
  ...
  %i.do = load <2 x double>, ptr %i.dn, align 1, !tbaa !71
  %i.dp = load double, ptr %i.bl, align 8, !tbaa !38
  ...
  %i.du = load <2 x double>, ptr %i.dt, align 1, !tbaa !71
  %i.dv = load double, ptr %i.bm, align 8, !tbaa !38
  ...
  %i.eb = load <2 x double>, ptr %i.ea, align 1, !tbaa !71
  %i.ec = load double, ptr %i.bn, align 8, !tbaa !38
...
.lr.ph.i.i.i.i.i.i.i.i.i.i:                       ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i.i, %.lr.ph.i.preheader.i.i.i.i.i.i.i.i.i
  ...
  %i.gq = add nsw i64 %.021.i.i.i.i.i.i.i.i.i.i, 2 ; 2 uses
  %i.gr = icmp slt i64 %i.gq, %i.dn
  br i1 %i.gr, label %.lr.ph.i.i.i.i.i.i.i.i.i.i, label %._crit_edge.i.i.i.i.i.i.i.i.i.i, !llvm.loop !2152
...
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !2175, !nonnull !59, !align !60 ; 5 uses
...
.preheader.lr.ph.i:                               ; preds = %bb.b
  ...
  %i.k = icmp sgt i64 %i.j, 0
  %i.l = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.m = load ptr, ptr %i.l, align 8, !nonnull !59, !align !60 ; 7 uses
...
.preheader.lr.ph.split.i:                         ; preds = %.preheader.lr.ph.i
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 48
  %i.o = load ptr, ptr %0, align 8, !nonnull !59, !align !60
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !383  ; 4 uses
  %i.q = load ptr, ptr %i.n, align 8, !tbaa !2176, !noalias !2177 ; 3 uses
  %i.r = mul i64 %i.g, 40
  %i.s = shl i64 %i.j, 3                          ; 2 uses
  %i.t = getelementptr i8, ptr %i.p, i64 %i.r
  %i.u = getelementptr i8, ptr %i.t, i64 %i.s
...
vector.ph:                                        ; preds = %.preheader.i
  %i.y = load double, ptr %i.x, align 8, !tbaa !38, !alias.scope !2178
  %broadcast.splatinsert = insertelement <2 x double> poison, double %i.y, i64 0
  %broadcast.splat = shufflevector <2 x double> %broadcast.splatinsert, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.aa = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %index ; 2 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %i.aa, i64 16
  %wide.load = load <2 x double>, ptr %i.aa, align 8, !tbaa !38, !alias.scope !2179
  %wide.load70 = load <2 x double>, ptr %i.ab, align 8, !tbaa !38, !alias.scope !2179
  %i.ac = fmul <2 x double> %wide.load, %broadcast.splat
  %i.ad = fmul <2 x double> %wide.load70, %broadcast.splat
  %i.ae = getelementptr i8, ptr %i.z, i64 16      ; 2 uses
  %wide.load71 = load <2 x double>, ptr %i.z, align 8, !tbaa !38, !alias.scope !2180, !noalias !2181
  %wide.load72 = load <2 x double>, ptr %i.ae, align 8, !tbaa !38, !alias.scope !2180, !noalias !2181
  %i.af = fsub <2 x double> %wide.load71, %i.ac
  %i.ag = fsub <2 x double> %wide.load72, %i.ad
  store <2 x double> %i.af, ptr %i.z, align 8, !tbaa !38, !alias.scope !2180, !noalias !2181
  store <2 x double> %i.ag, ptr %i.ae, align 8, !tbaa !38, !alias.scope !2180, !noalias !2181
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ah = icmp eq i64 %index.next, %n.vec
  br i1 %i.ah, label %middle.block, label %vector.body, !llvm.loop !2159
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.bh = add nuw nsw i64 %.09.i, 2               ; 2 uses
  %exitcond.not.i.1 = icmp eq i64 %i.bh, %i.j
  br i1 %exitcond.not.i.1, label %._crit_edge.i, label %scalar.ph, !llvm.loop !2161
...
.preheader45.loopexit:                            ; preds = %bb.c
  %i.by = load ptr, ptr %i.bq, align 8, !tbaa !2182, !nonnull !59, !align !60 ; 2 uses
  %i.bz = getelementptr inbounds nuw i8, ptr %i.by, i64 48
  %i.ca = load ptr, ptr %i.bz, align 8, !tbaa !2176, !noalias !2183
  %i.cb = getelementptr inbounds nuw [8 x i8], ptr %i.ca, i64 %.03453
  %i.cc = load ptr, ptr %0, align 8, !tbaa !2184, !nonnull !59, !align !60
  %i.cd = load ptr, ptr %i.cc, align 8, !tbaa !383
  %.idx.i.i.i = mul i64 %.03453, 40
  %i.ce = getelementptr i8, ptr %i.cd, i64 %.idx.i.i.i ; 2 uses
  %i.cf = load double, ptr %i.by, align 8, !tbaa !38
  %i.cg = load double, ptr %i.cb, align 8, !tbaa !38
  %i.ch = fmul double %i.cf, %i.cg
  %i.ci = load double, ptr %i.ce, align 8, !tbaa !38
  %i.cj = fsub double %i.ci, %i.ch
...
.lr.ph51:                                         ; preds = %.preheader
  %i.cm = load ptr, ptr %0, align 8, !tbaa !2184, !nonnull !59, !align !60
  %i.cn = load ptr, ptr %i.cm, align 8, !tbaa !383 ; 3 uses
  %.idx.i.i.i38 = mul i64 %.03453, 40             ; 2 uses
  %i.co = getelementptr i8, ptr %i.cn, i64 %.idx.i.i.i38 ; 2 uses
  %i.cp = load ptr, ptr %i.bq, align 8, !tbaa !2182, !nonnull !59, !align !60 ; 5 uses
  %i.cq = getelementptr inbounds nuw i8, ptr %i.cp, i64 48
  %i.cr = load ptr, ptr %i.cq, align 8, !tbaa !2176, !noalias !2185 ; 2 uses
  %i.cs = getelementptr inbounds nuw [8 x i8], ptr %i.cr, i64 %.03453 ; 3 uses
  %i.ct = add i64 %.03552, %i.bv
  %i.cu = sub i64 %i.bj, %i.ct                    ; 3 uses
  %min.iters.check87 = icmp ult i64 %i.cu, 6
...
vector.ph88:                                      ; preds = %vector.memcheck73
  %n.vec89 = and i64 %i.cu, -4                    ; 3 uses
  %i.dd = add i64 %i.bw, %n.vec89
  %i.de = load double, ptr %i.cs, align 8, !tbaa !38, !alias.scope !2186
  %broadcast.splatinsert94 = insertelement <2 x double> poison, double %i.de, i64 0
  %broadcast.splat95 = shufflevector <2 x double> %broadcast.splatinsert94, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  br label %vector.body90
...
vector.body90:                                    ; preds = %vector.body90, %vector.ph88
  ...
  %i.dh = getelementptr inbounds [8 x i8], ptr %i.cp, i64 %i.df ; 2 uses
  %i.di = getelementptr inbounds nuw i8, ptr %i.dh, i64 16
  %wide.load92 = load <2 x double>, ptr %i.dh, align 8, !tbaa !38, !alias.scope !2187
  %wide.load93 = load <2 x double>, ptr %i.di, align 8, !tbaa !38, !alias.scope !2187
  %i.dj = fmul <2 x double> %wide.load92, %broadcast.splat95
  %i.dk = fmul <2 x double> %wide.load93, %broadcast.splat95
  %i.dl = getelementptr i8, ptr %i.dg, i64 16     ; 2 uses
  %wide.load96 = load <2 x double>, ptr %i.dg, align 8, !tbaa !38, !alias.scope !2188, !noalias !2189
  %wide.load97 = load <2 x double>, ptr %i.dl, align 8, !tbaa !38, !alias.scope !2188, !noalias !2189
  %i.dm = fsub <2 x double> %wide.load96, %i.dj
  %i.dn = fsub <2 x double> %wide.load97, %i.dk
  store <2 x double> %i.dm, ptr %i.dg, align 8, !tbaa !38, !alias.scope !2188, !noalias !2189
  store <2 x double> %i.dn, ptr %i.dl, align 8, !tbaa !38, !alias.scope !2188, !noalias !2189
  %index.next98 = add nuw i64 %index91, 4         ; 2 uses
  %i.do = icmp eq i64 %index.next98, %n.vec89
  br i1 %i.do, label %middle.block99, label %vector.body90, !llvm.loop !2170
...
bb.d:                                             ; preds = %.lr.ph49, %bb.d
  %.03248 = phi i64 [ %.03552, %.lr.ph49 ], [ %i.eh, %bb.d ] ; 3 uses
  %i.dp = load ptr, ptr %0, align 8, !tbaa !2184, !nonnull !59, !align !60
  %i.dq = load ptr, ptr %i.dp, align 8, !tbaa !383
  %i.dr = getelementptr i8, ptr %i.dq, i64 %.idx.i.i.i37
  %i.ds = getelementptr [8 x i8], ptr %i.dr, i64 %.03248 ; 2 uses
  %i.dt = load ptr, ptr %i.bq, align 8, !tbaa !2182, !nonnull !59, !align !60 ; 2 uses
  %i.du = getelementptr inbounds nuw i8, ptr %i.dt, i64 80
  %i.dv = getelementptr inbounds nuw i8, ptr %i.dt, i64 88
  %i.dw = load ptr, ptr %i.du, align 8, !tbaa !387
  %i.dx = getelementptr inbounds [8 x i8], ptr %i.dw, i64 %.03248
  %i.dy = load <2 x double>, ptr %i.dx, align 1, !tbaa !71
  %i.dz = load ptr, ptr %i.dv, align 8, !tbaa !375
  %i.ea = getelementptr [8 x i8], ptr %i.dz, i64 %.03453
  %i.eb = load double, ptr %i.ea, align 8, !tbaa !38
  %i.ec = insertelement <2 x double> poison, double %i.eb, i64 0
  %i.ed = shufflevector <2 x double> %i.ec, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.eh = add nsw i64 %.03248, 2                  ; 2 uses
  %i.ei = icmp slt i64 %i.eh, %i.bw
  br i1 %i.ei, label %bb.d, label %.preheader, !llvm.loop !2171
...
scalar.ph86:                                      ; preds = %scalar.ph86.preheader, %scalar.ph86
  ...
  %i.eo = load double, ptr %i.en, align 8, !tbaa !38
  %i.ep = load double, ptr %i.cs, align 8, !tbaa !38
  %i.eq = fmul double %i.eo, %i.ep
  %i.er = load double, ptr %i.em, align 8, !tbaa !38
  %i.es = fsub double %i.er, %i.eq
  store double %i.es, ptr %i.em, align 8, !tbaa !38
  %i.et = add nsw i64 %.050, 1                    ; 2 uses
  %i.eu = icmp slt i64 %i.et, %i.bj
  br i1 %i.eu, label %scalar.ph86, label %._crit_edge, !llvm.loop !2173
...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !tbaa !366  ; 14 uses
  %i.c = icmp eq i64 %i.b, 0
  br i1 %i.c, label %bb.b, label %bb.c
...
bb.c:                                             ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #20
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %6, ptr noundef nonnull align 8 dereferenceable(40) %1, i64 40, i1 false), !tbaa.struct !2203
...
._crit_edge.i.i.i.i.i.i.epil:                     ; preds = %._crit_edge.i.i.i.i.i.i.epil, %._crit_edge.i.i.i.i.i.i.epil.preheader
  ...
  %i.or = load double, ptr %i.oq, align 8, !tbaa !38
  %i.os = fmul double %i.e, %i.or
  store double %i.os, ptr %i.oq, align 8, !tbaa !38
  ...
  br i1 %epil.iter171.cmp.not, label %_ZN5Eigen9DenseBaseINS_5BlockINS_6MatrixIdLi5ELi1ELi0ELi5ELi1EEELin1ELin1ELb0EEEEmLERKd.exit, label %._crit_edge.i.i.i.i.i.i.epil, !llvm.loop !2243
...
.preheader.i.i.i.i.i.i.i.epil:                    ; preds = %.preheader.i.i.i.i.i.i.i.epil, %.preheader.i.i.i.i.i.i.i.epil.preheader
  ...
  %i.ov = load double, ptr %i.ou, align 8, !tbaa !38
  %i.ow = fmul double %i.e, %i.ov
  store double %i.ow, ptr %i.ou, align 8, !tbaa !38
  %i.ox = add nuw nsw i64 %.0810.i.i.i.i.i.i.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter165
  br i1 %epil.iter.cmp.not, label %_ZN5Eigen9DenseBaseINS_5BlockINS_6MatrixIdLi5ELi1ELi0ELi5ELi1EEELin1ELin1ELb0EEEEmLERKd.exit, label %.preheader.i.i.i.i.i.i.i.epil, !llvm.loop !2244
...
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !2285, !nonnull !59, !align !60 ; 5 uses
...
.preheader.lr.ph.split.i:                         ; preds = %.preheader.lr.ph.i
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 48
  %i.o = load ptr, ptr %0, align 8, !nonnull !59, !align !60
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !398  ; 4 uses
  %i.q = load ptr, ptr %i.n, align 8, !tbaa !272, !noalias !2286 ; 3 uses
  %i.r = mul i64 %i.g, 40
  %i.s = shl i64 %i.j, 3                          ; 2 uses
  %i.t = getelementptr i8, ptr %i.p, i64 %i.r
  %i.u = getelementptr i8, ptr %i.t, i64 %i.s
...
vector.ph:                                        ; preds = %.preheader.i
  %i.y = load double, ptr %i.x, align 8, !tbaa !38, !alias.scope !2287
  %broadcast.splatinsert = insertelement <2 x double> poison, double %i.y, i64 0
  %broadcast.splat = shufflevector <2 x double> %broadcast.splatinsert, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.aa = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %index ; 2 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %i.aa, i64 16
  %wide.load = load <2 x double>, ptr %i.aa, align 8, !tbaa !38, !alias.scope !2288
  %wide.load70 = load <2 x double>, ptr %i.ab, align 8, !tbaa !38, !alias.scope !2288
  %i.ac = fmul <2 x double> %wide.load, %broadcast.splat
  %i.ad = fmul <2 x double> %wide.load70, %broadcast.splat
  %i.ae = getelementptr i8, ptr %i.z, i64 16      ; 2 uses
  %wide.load71 = load <2 x double>, ptr %i.z, align 8, !tbaa !38, !alias.scope !2289, !noalias !2290
  %wide.load72 = load <2 x double>, ptr %i.ae, align 8, !tbaa !38, !alias.scope !2289, !noalias !2290
  %i.af = fsub <2 x double> %wide.load71, %i.ac
  %i.ag = fsub <2 x double> %wide.load72, %i.ad
  store <2 x double> %i.af, ptr %i.z, align 8, !tbaa !38, !alias.scope !2289, !noalias !2290
  store <2 x double> %i.ag, ptr %i.ae, align 8, !tbaa !38, !alias.scope !2289, !noalias !2290
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ah = icmp eq i64 %index.next, %n.vec
  br i1 %i.ah, label %middle.block, label %vector.body, !llvm.loop !2269
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.bh = add nuw nsw i64 %.09.i, 2               ; 2 uses
  %exitcond.not.i.1 = icmp eq i64 %i.bh, %i.j
  br i1 %exitcond.not.i.1, label %._crit_edge.i, label %scalar.ph, !llvm.loop !2271
...
.preheader45.loopexit:                            ; preds = %bb.c
  %i.by = load ptr, ptr %i.bq, align 8, !tbaa !2291, !nonnull !59, !align !60 ; 2 uses
  %i.bz = getelementptr inbounds nuw i8, ptr %i.by, i64 48
  %i.ca = load ptr, ptr %i.bz, align 8, !tbaa !272, !noalias !2292
  %i.cb = getelementptr inbounds nuw [8 x i8], ptr %i.ca, i64 %.03453
  %i.cc = load ptr, ptr %0, align 8, !tbaa !2293, !nonnull !59, !align !60
  %i.cd = load ptr, ptr %i.cc, align 8, !tbaa !398
  %.idx.i.i.i = mul i64 %.03453, 40
  %i.ce = getelementptr i8, ptr %i.cd, i64 %.idx.i.i.i ; 2 uses
  %i.cf = load double, ptr %i.by, align 8, !tbaa !38
  %i.cg = load double, ptr %i.cb, align 8, !tbaa !38
...
.lr.ph51:                                         ; preds = %.preheader
  %i.cm = load ptr, ptr %0, align 8, !tbaa !2293, !nonnull !59, !align !60
  %i.cn = load ptr, ptr %i.cm, align 8, !tbaa !398 ; 3 uses
  %.idx.i.i.i38 = mul i64 %.03453, 40             ; 2 uses
  %i.co = getelementptr i8, ptr %i.cn, i64 %.idx.i.i.i38 ; 2 uses
  %i.cp = load ptr, ptr %i.bq, align 8, !tbaa !2291, !nonnull !59, !align !60 ; 5 uses
  %i.cq = getelementptr inbounds nuw i8, ptr %i.cp, i64 48
  %i.cr = load ptr, ptr %i.cq, align 8, !tbaa !272, !noalias !2294 ; 2 uses
  %i.cs = getelementptr inbounds nuw [8 x i8], ptr %i.cr, i64 %.03453 ; 3 uses
  %i.ct = add i64 %.03552, %i.bv
  %i.cu = sub i64 %i.bj, %i.ct                    ; 3 uses
  %min.iters.check87 = icmp ult i64 %i.cu, 6
...
vector.ph88:                                      ; preds = %vector.memcheck73
  %n.vec89 = and i64 %i.cu, -4                    ; 3 uses
  %i.dd = add i64 %i.bw, %n.vec89
  %i.de = load double, ptr %i.cs, align 8, !tbaa !38, !alias.scope !2295
  %broadcast.splatinsert94 = insertelement <2 x double> poison, double %i.de, i64 0
  %broadcast.splat95 = shufflevector <2 x double> %broadcast.splatinsert94, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  br label %vector.body90
...
vector.body90:                                    ; preds = %vector.body90, %vector.ph88
  ...
  %i.dh = getelementptr inbounds [8 x i8], ptr %i.cp, i64 %i.df ; 2 uses
  %i.di = getelementptr inbounds nuw i8, ptr %i.dh, i64 16
  %wide.load92 = load <2 x double>, ptr %i.dh, align 8, !tbaa !38, !alias.scope !2296
  %wide.load93 = load <2 x double>, ptr %i.di, align 8, !tbaa !38, !alias.scope !2296
  %i.dj = fmul <2 x double> %wide.load92, %broadcast.splat95
  %i.dk = fmul <2 x double> %wide.load93, %broadcast.splat95
  %i.dl = getelementptr i8, ptr %i.dg, i64 16     ; 2 uses
  %wide.load96 = load <2 x double>, ptr %i.dg, align 8, !tbaa !38, !alias.scope !2297, !noalias !2298
  %wide.load97 = load <2 x double>, ptr %i.dl, align 8, !tbaa !38, !alias.scope !2297, !noalias !2298
  %i.dm = fsub <2 x double> %wide.load96, %i.dj
  %i.dn = fsub <2 x double> %wide.load97, %i.dk
  store <2 x double> %i.dm, ptr %i.dg, align 8, !tbaa !38, !alias.scope !2297, !noalias !2298
  store <2 x double> %i.dn, ptr %i.dl, align 8, !tbaa !38, !alias.scope !2297, !noalias !2298
  %index.next98 = add nuw i64 %index91, 4         ; 2 uses
  %i.do = icmp eq i64 %index.next98, %n.vec89
  br i1 %i.do, label %middle.block99, label %vector.body90, !llvm.loop !2280
...
bb.d:                                             ; preds = %.lr.ph49, %bb.d
  %.03248 = phi i64 [ %.03552, %.lr.ph49 ], [ %i.eh, %bb.d ] ; 3 uses
  %i.dp = load ptr, ptr %0, align 8, !tbaa !2293, !nonnull !59, !align !60
  %i.dq = load ptr, ptr %i.dp, align 8, !tbaa !398
  %i.dr = getelementptr i8, ptr %i.dq, i64 %.idx.i.i.i37
  %i.ds = getelementptr [8 x i8], ptr %i.dr, i64 %.03248 ; 2 uses
  %i.dt = load ptr, ptr %i.bq, align 8, !tbaa !2291, !nonnull !59, !align !60 ; 2 uses
  %i.du = getelementptr inbounds nuw i8, ptr %i.dt, i64 80
  %i.dv = getelementptr inbounds nuw i8, ptr %i.dt, i64 88
  %i.dw = load ptr, ptr %i.du, align 8, !tbaa !387
  %i.dx = getelementptr inbounds [8 x i8], ptr %i.dw, i64 %.03248
  ...
  %i.eh = add nsw i64 %.03248, 2                  ; 2 uses
  %i.ei = icmp slt i64 %i.eh, %i.bw
  br i1 %i.ei, label %bb.d, label %.preheader, !llvm.loop !2281
...
scalar.ph86:                                      ; preds = %scalar.ph86.preheader, %scalar.ph86
  ...
  %i.et = add nsw i64 %.050, 1                    ; 2 uses
  %i.eu = icmp slt i64 %i.et, %i.bj
  br i1 %i.eu, label %scalar.ph86, label %._crit_edge, !llvm.loop !2283
...
_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit: ; preds = %bb.a
  %i.e = load ptr, ptr %1, align 8, !tbaa !394    ; 2 uses
  %.not = icmp eq ptr %i.e, null
  br i1 %.not, label %bb.c, label %_ZN5Eigen8internal14aligned_mallocEm.exit
