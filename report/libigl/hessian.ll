...
bb.o:                                             ; preds = %bb.n, %._crit_edge.i.i.i.i, %bb.l
  ...
  %i.bw = bitcast <2 x i64> %.sroa.067.2.i.i.i.i to <4 x i32>
  ...
  %foldExtExtBinop = add nsw <4 x i32> %i.by, %shift ; 2 uses
  %13 = extractelement <4 x i32> %foldExtExtBinop, i64 0 ; 2 uses
