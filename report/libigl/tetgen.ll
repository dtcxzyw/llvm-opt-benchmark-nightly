...
.preheader112:                                    ; preds = %.preheader112.preheader, %.loopexit111
  ...
  %i.ae = shl nsw i64 %i.ad, 3                    ; 3 uses
...
.lr.ph133.preheader:                              ; preds = %bb.f
  ...
  %i.ch = shl nsw i64 %i.cb, 5
  %6 = add nsw i64 %i.ch, %i.ae                   ; 2 uses
  %scevgep175.a = getelementptr i8, ptr %1, i64 %6
  %i.ci = getelementptr i8, ptr %scevgep176, i64 %6
...
vector.memcheck:                                  ; preds = %.preheader.us
  ...
  %bound1 = icmp ult ptr %scevgep175.a, %scevgep174
