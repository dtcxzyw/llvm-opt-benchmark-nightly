...
begin_hunk_0_@_ZN10tetgenmesh19removevertexbyflipsEPd:bb.a
  store i32 %i.ahx, ptr %i.aii, align 8, !tbaa !237
  store ptr %i.aeh, ptr %.ptr.1, align 16, !tbaa !232
  %i.aij = getelementptr inbounds nuw i8, ptr %i.adt, i64 72
  store i32 %i.ahz, ptr %i.aih, align 8, !tbaa !237
  store ptr %i.aeu, ptr %.ptr352.4, align 8, !tbaa !232
  %i.aik = getelementptr inbounds nuw i8, ptr %i.adt, i64 88
  store i32 %i.aif, ptr %i.aij, align 8, !tbaa !237
  store ptr %i.aeh, ptr %.ptr352.5, align 8, !tbaa !232
  store i32 %i.ahz, ptr %i.aik, align 8, !tbaa !237
  br label %bb.bx
...
bb.bx:                                            ; preds = %.preheader621.preheader, %bb.bw
  ...
  %i.ais = load ptr, ptr %i.air, align 8, !tbaa !221 ; 4 uses
...
.split654.thread:                                 ; preds = %bb.bx, %.split654
  ...
  %i.ajz = load ptr, ptr %i.ajy, align 8, !tbaa !221 ; 4 uses
...
.split654.1:                                      ; preds = %.split654.thread
  ...
  %.sroa.6410.0.1.1 = load i32, ptr %i.akn, align 4, !tbaa !60
  ...
  %i.aku = load ptr, ptr %i.akt, align 8, !tbaa !113
...
.split654.1.thread:                               ; preds = %.split654.thread, %.split654.1
  ...
  %i.alg = load ptr, ptr %i.alf, align 8, !tbaa !221 ; 5 uses
...
bb.by:                                            ; preds = %.split654.2
  ...
  %i.amp = load ptr, ptr %i.amo, align 8, !tbaa !113 ; 3 uses
...
.preheader908:                                    ; preds = %bb.bq, %.preheader908
  ...
  %i.ang = load i32, ptr %i.anf, align 4, !tbaa !60
  ...
  br i1 %i.anh, label %bb.bz, label %.preheader908, !llvm.loop !1119
...
.prol.preheader:                                  ; preds = %bb.bz, %.prol.preheader
  ...
  store ptr null, ptr %i.anq, align 8, !tbaa !232
  %i.anr = getelementptr inbounds nuw i8, ptr %i.anq, i64 8
  store i32 0, ptr %i.anr, align 8, !tbaa !237
  %i.ans = getelementptr inbounds nuw i8, ptr %i.anq, i64 16 ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.prol.loopexit, label %.prol.preheader, !llvm.loop !1120
...
.unr-lcssa:                                       ; preds = %.new, %.prol.loopexit
  store ptr %i.xo, ptr %i.anl, align 8, !tbaa !232
  %i.aom = getelementptr inbounds nuw i8, ptr %i.anl, i64 8 ; 2 uses
  store i32 %i.xp, ptr %i.aom, align 8, !tbaa !237
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  store ptr %i.apb, ptr %i.aor, align 8, !tbaa !232
  ...
  %i.apf = load i32, ptr %i.ape, align 4, !tbaa !60 ; 2 uses
  store i32 %i.apf, ptr %i.aoz, align 8, !tbaa !237
  ...
  store ptr %i.apq, ptr %i.apg, align 8, !tbaa !232
  ...
  %i.apu = load i32, ptr %i.apt, align 4, !tbaa !60 ; 3 uses
  store i32 %i.apu, ptr %i.apo, align 8, !tbaa !237
  %niter.next.1 = add nuw i64 %niter, 2           ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.loopexit.unr-lcssa, label %.lr.ph, !llvm.loop !1121
...
.lr.ph.epil.preheader:                            ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph.preheader
  ...
  store ptr %i.aqg, ptr %i.apw, align 8, !tbaa !232
  ...
  %i.aqk = load i32, ptr %i.aqj, align 4, !tbaa !60
  store i32 %i.aqk, ptr %i.aqe, align 8, !tbaa !237
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %.lr.ph.epil.preheader, %._crit_edge.loopexit.unr-lcssa, %.unr-lcssa
  ...
  %i.aqp = load i32, ptr %i.aqo, align 4, !tbaa !60
...
.lr.ph680.preheader:                              ; preds = %._crit_edge
  ...
  %.pre762 = load ptr, ptr %.phi.trans.insert761, align 8, !tbaa !232 ; 2 uses
  %.phi.trans.insert763 = getelementptr inbounds nuw i8, ptr %.phi.trans.insert761, i64 8
  %.pre764 = load i32, ptr %.phi.trans.insert763, align 8, !tbaa !237 ; 2 uses
  %7 = shl i64 %indvar, 1
...
.lr.ph680.prol:                                   ; preds = %.lr.ph680.preheader
  ...
  store ptr %i.arw, ptr %i.arm, align 8, !tbaa !232
  ...
  %i.asa = load i32, ptr %i.arz, align 4, !tbaa !60 ; 2 uses
  store i32 %i.asa, ptr %i.aru, align 8, !tbaa !237
...
.lr.ph680:                                        ; preds = %.lr.ph680.prol.loopexit, %.lr.ph680
  ...
  store ptr %i.asp, ptr %i.asf, align 8, !tbaa !232
  ...
  %i.ast = load i32, ptr %i.ass, align 4, !tbaa !60 ; 2 uses
  store i32 %i.ast, ptr %i.asn, align 8, !tbaa !237
  ...
  store ptr %i.ate, ptr %i.asu, align 8, !tbaa !232
  ...
  %i.ati = load i32, ptr %i.ath, align 4, !tbaa !60 ; 2 uses
  store i32 %i.ati, ptr %i.atc, align 8, !tbaa !237
  %exitcond748.not.1 = icmp eq i64 %indvars.iv.next743.1, %wide.trip.count747
  br i1 %exitcond748.not.1, label %._crit_edge681.loopexit, label %.lr.ph680, !llvm.loop !1122

._crit_edge681.loopexit:                          ; preds = %.lr.ph680, %.lr.ph680.prol.loopexit
  %.pre765 = load ptr, ptr %i.aqm, align 8, !tbaa !232
  %.pre766 = load i32, ptr %i.aqq, align 8, !tbaa !237
...
._crit_edge681:                                   ; preds = %._crit_edge681.loopexit, %._crit_edge
  ...
  store ptr %i.xo, ptr %2, align 16, !tbaa !232
  %i.atl = getelementptr inbounds [4 x i8], ptr @_ZN10tetgenmesh7esymtblE, i64 %i.aqr
  %i.atm = load i32, ptr %i.atl, align 4, !tbaa !60
  %i.atn = sext i32 %i.atm to i64
  %i.ato = getelementptr inbounds [4 x i8], ptr @_ZN10tetgenmesh8enexttblE, i64 %i.atn
  %i.atp = load i32, ptr %i.ato, align 4, !tbaa !60
  store i32 %i.atp, ptr %i.a, align 8, !tbaa !237
  store ptr %i.atk, ptr %.ptr.1, align 16, !tbaa !232
  ...
  %i.aua = load ptr, ptr %.ptr.2, align 16, !tbaa !232 ; 2 uses
  store ptr %i.aua, ptr %i.aqm, align 8, !tbaa !232
  %i.aub = getelementptr inbounds nuw i8, ptr %2, i64 40 ; 3 uses
  %i.auc = load i32, ptr %i.aub, align 8, !tbaa !237 ; 2 uses
  store i32 %i.auc, ptr %i.aqq, align 8, !tbaa !237
  %i.aud = load ptr, ptr %2, align 16, !tbaa !232
  store ptr %i.aud, ptr %i.anl, align 8, !tbaa !232
  %i.aue = load i32, ptr %i.a, align 8, !tbaa !237
  store i32 %i.aue, ptr %i.aom, align 8, !tbaa !237
...
.lr.ph684:                                        ; preds = %.lr.ph684.preheader, %.lr.ph684
  ...
  %i.avh = load ptr, ptr %2, align 16, !tbaa !232
  store ptr %i.avh, ptr %i.aux, align 8, !tbaa !232
  %i.avi = load i32, ptr %i.a, align 8, !tbaa !237
  %i.avj = sext i32 %i.avi to i64
  %i.avk = getelementptr inbounds [4 x i8], ptr @_ZN10tetgenmesh7esymtblE, i64 %i.avj
  %i.avl = load i32, ptr %i.avk, align 4, !tbaa !60
  store i32 %i.avl, ptr %i.auz, align 8, !tbaa !237
  ...
  br i1 %exitcond754.not, label %._crit_edge685.loopexit, label %.lr.ph684, !llvm.loop !1123

._crit_edge685.loopexit:                          ; preds = %.lr.ph684
  %.pre767 = load ptr, ptr %i.aqm, align 8, !tbaa !232
  %.pre768 = load i32, ptr %i.aqq, align 8, !tbaa !237
...
._crit_edge685:                                   ; preds = %._crit_edge681, %._crit_edge685.loopexit
  ...
  %i.awy = load ptr, ptr %2, align 16, !tbaa !232
  store ptr %i.awy, ptr %i.awa, align 8, !tbaa !232
  %i.awz = load i32, ptr %i.a, align 8, !tbaa !237
  store i32 %i.awz, ptr %i.awc, align 8, !tbaa !237
  br label %bb.ca
