...
bb.h:                                             ; preds = %_ZN10tetgenmesh17shellfacetraverseEPNS_10memorypoolE.exit130, %.lr.ph272
  ...
  %i.bl = load ptr, ptr %i.bk, align 8, !tbaa !221 ; 7 uses
  ...
  %i.bp = load ptr, ptr %i.bo, align 8, !tbaa !221 ; 8 uses
...
bb.m:                                             ; preds = %.lr.ph, %bb.l
  ...
  %i.ek = load double, ptr %i.ej, align 8, !tbaa !59
  %1 = load <3 x double>, ptr %i.bp, align 8, !tbaa !59 ; 4 uses
  %2 = load <3 x double>, ptr %i.bl, align 8, !tbaa !59 ; 4 uses
  %i.el = fsub <3 x double> %1, %2                ; 6 uses
  ...
  %i.eu = shufflevector <3 x double> %2, <3 x double> poison, <2 x i32> zeroinitializer
  %i.ev = shufflevector <2 x double> %i.em, <2 x double> %i.et, <2 x i32> <i32 0, i32 2> ; 2 uses
  %i.ew = fsub <2 x double> %i.eu, %i.ev          ; 4 uses
  %i.ex = shufflevector <3 x double> %2, <3 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.ey = shufflevector <2 x double> %i.em, <2 x double> %i.et, <2 x i32> <i32 1, i32 3> ; 2 uses
  %i.ez = fsub <2 x double> %i.ex, %i.ey          ; 4 uses
  %i.fa = shufflevector <3 x double> %2, <3 x double> poison, <2 x i32> <i32 2, i32 2>
  %i.fb = insertelement <2 x double> poison, double %i.ei, i64 0
  %i.fc = insertelement <2 x double> %i.fb, double %i.ek, i64 1 ; 2 uses
  %i.fd = fsub <2 x double> %i.fa, %i.fc          ; 4 uses
  %i.fe = shufflevector <3 x double> %1, <3 x double> poison, <2 x i32> zeroinitializer
  %i.ff = fsub <2 x double> %i.ev, %i.fe          ; 4 uses
  %i.fg = shufflevector <3 x double> %1, <3 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.fh = fsub <2 x double> %i.ey, %i.fg          ; 4 uses
  %i.fi = shufflevector <3 x double> %1, <3 x double> poison, <2 x i32> <i32 2, i32 2>
  ...
  %i.hz = load double, ptr %i.hy, align 8, !tbaa !59
  %3 = load <3 x double>, ptr %i.bp, align 8, !tbaa !59 ; 4 uses
  %4 = load <3 x double>, ptr %i.bl, align 8, !tbaa !59 ; 4 uses
  %i.ia = fsub <3 x double> %3, %4                ; 6 uses
  ...
  %i.ij = shufflevector <3 x double> %4, <3 x double> poison, <2 x i32> zeroinitializer
  %i.ik = shufflevector <2 x double> %i.ib, <2 x double> %i.ii, <2 x i32> <i32 0, i32 2> ; 2 uses
  %i.il = fsub <2 x double> %i.ij, %i.ik          ; 4 uses
  %i.im = shufflevector <3 x double> %4, <3 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.in = shufflevector <2 x double> %i.ib, <2 x double> %i.ii, <2 x i32> <i32 1, i32 3> ; 2 uses
  %i.io = fsub <2 x double> %i.im, %i.in          ; 4 uses
  %i.ip = shufflevector <3 x double> %4, <3 x double> poison, <2 x i32> <i32 2, i32 2>
  %i.iq = insertelement <2 x double> poison, double %i.hx, i64 0
  %i.ir = insertelement <2 x double> %i.iq, double %i.hz, i64 1 ; 2 uses
  %i.is = fsub <2 x double> %i.ip, %i.ir          ; 4 uses
  %i.it = shufflevector <3 x double> %3, <3 x double> poison, <2 x i32> zeroinitializer
  %i.iu = fsub <2 x double> %i.ik, %i.it          ; 4 uses
  %i.iv = shufflevector <3 x double> %3, <3 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.iw = fsub <2 x double> %i.in, %i.iv          ; 4 uses
  %i.ix = shufflevector <3 x double> %3, <3 x double> poison, <2 x i32> <i32 2, i32 2>
...
_ZN10tetgenmesh9sort_3ptsEPdS0_S0_PS0_.exit:      ; preds = %bb.dg, %bb.de, %bb.df, %bb.dd
  ...
  %i.anw = call noundef ptr @_ZN10tetgenmesh10memorypool5allocEv(ptr noundef nonnull align 8 dereferenceable(88) %i.anv) ; 24 uses
...
.preheader.preheader:                             ; preds = %_ZN10tetgenmesh9makepointEPPdNS_8verttypeE.exit
  ...
  %i.asc = getelementptr inbounds nuw i8, ptr %i.anw, i64 8
  %i.asd = getelementptr inbounds nuw i8, ptr %i.aac, i64 16 ; 3 uses
  %i.ase = load double, ptr %i.asd, align 8, !tbaa !59
  %i.asf = getelementptr inbounds nuw i8, ptr %i.anw, i64 16
  ...
  %9 = load <3 x double>, ptr %i.anw, align 8, !tbaa !59 ; 5 uses
  ...
  %i.asm = shufflevector <3 x double> %9, <3 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.asp = fsub <2 x double> %i.aso, %10          ; 6 uses
  %i.asq = insertelement <2 x double> poison, double %i.ase, i64 0
  %i.asr = insertelement <2 x double> %i.asq, double %i.asi, i64 1
  %11 = shufflevector <3 x double> %9, <3 x double> poison, <2 x i32> <i32 2, i32 2>
  %i.ass = fsub <2 x double> %i.asr, %11          ; 4 uses
...
bb.dl:                                            ; preds = %.preheader.preheader
  %12 = load double, ptr %i.anw, align 8, !tbaa !59
  %i.atl = fsub double %.pre627, %12              ; 4 uses
  ...
  %i.ato = fsub double %i.atn, %13                ; 4 uses
  ...
  %i.atr = fsub double %i.atq, %14                ; 4 uses
...
bb.by:                                            ; preds = %bb.bx
  ...
  %i.acu = load ptr, ptr %i.act, align 8, !tbaa !221 ; 5 uses
  ...
  %3 = load <3 x double>, ptr %i.acu, align 8, !tbaa !59 ; 3 uses
  ...
  %i.adj = shufflevector <3 x double> %3, <3 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.adn = fsub <2 x double> %i.adm, %4           ; 4 uses
  ...
  %i.adp = fsub <2 x double> %i.ado, %5           ; 4 uses
