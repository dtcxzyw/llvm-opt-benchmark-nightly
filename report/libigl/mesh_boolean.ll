...
bb.aj:                                            ; preds = %_ZN5Eigen6MatrixIiLi1ELin1ELi1ELi1ELin1EEC2ERKS1_.exit
  ...
  %i.ew = invoke noundef i32 %i.ev(ptr noundef nonnull align 8 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(16) %27)
          to label %bb.ak unwind label %.loopexit333, !inline_history !145
...
bb.ao:                                            ; preds = %_ZN5Eigen6MatrixIiLi1ELin1ELi1ELi1ELin1EEC2ERKS1_.exit168
  ...
  %i.fj = invoke noundef i32 %i.fi(ptr noundef nonnull align 8 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(16) %28)
          to label %bb.ap unwind label %.loopexit338, !inline_history !145
...
bb.ap:                                            ; preds = %bb.ao
  ...
  br i1 %exitcond.not, label %.lr.ph388, label %bb.ad, !llvm.loop !146
...
bb.ay:                                            ; preds = %bb.aw
  ...
  %i.gn = invoke noundef i32 %i.gm(ptr noundef nonnull align 8 dereferenceable(32) %4, ptr noundef nonnull align 4 dereferenceable(4) %i.a, ptr noundef nonnull align 4 dereferenceable(4) %i.b)
          to label %bb.az unwind label %.loopexit322, !inline_history !149 ; 2 uses
...
bb.bb:                                            ; preds = %bb.ba
  store i32 %i.gq, ptr %.sroa.13.0385, align 4, !tbaa !134
...
bb.bi:                                            ; preds = %bb.bh
  store i32 %i.hj, ptr %.sroa.13.0385, align 4, !tbaa !134
...
bb.aj:                                            ; preds = %_ZN5Eigen6MatrixIiLi1ELin1ELi1ELi1ELin1EEC2ERKS1_.exit
  %i.ev = load ptr, ptr %i.dt, align 8, !tbaa !143
  %i.ew = invoke noundef i32 %i.ev(ptr noundef nonnull align 8 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(16) %27)
          to label %bb.ak unwind label %.loopexit330, !inline_history !145
...
bb.ao:                                            ; preds = %_ZN5Eigen6MatrixIiLi1ELin1ELi1ELi1ELin1EEC2ERKS1_.exit168
  %i.fi = load ptr, ptr %i.dt, align 8, !tbaa !143
  %i.fj = invoke noundef i32 %i.fi(ptr noundef nonnull align 8 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(16) %28)
          to label %bb.ap unwind label %.loopexit335, !inline_history !145
...
bb.ap:                                            ; preds = %bb.ao
  ...
  %exitcond.not = icmp eq i64 %i.fo, %i.k
  br i1 %exitcond.not, label %.lr.ph383, label %bb.ad, !llvm.loop !399
...
bb.ay:                                            ; preds = %bb.aw
  %i.gm = load ptr, ptr %i.dx, align 8, !tbaa !147
  %i.gn = invoke noundef i32 %i.gm(ptr noundef nonnull align 8 dereferenceable(32) %4, ptr noundef nonnull align 4 dereferenceable(4) %i.a, ptr noundef nonnull align 4 dereferenceable(4) %i.b)
          to label %bb.az unwind label %.loopexit319, !inline_history !149 ; 2 uses
...
bb.bb:                                            ; preds = %bb.ba
  store i32 %i.gq, ptr %.sroa.13.0380, align 4, !tbaa !134
...
bb.bi:                                            ; preds = %bb.bh
  store i32 %i.hj, ptr %.sroa.13.0380, align 4, !tbaa !134
...
bb.ap:                                            ; preds = %bb.ao
  ...
  %i.fo = add nuw i64 %.098383, 1                 ; 2 uses
  %exitcond.not = icmp eq i64 %i.fo, %i.k
  br i1 %exitcond.not, label %.lr.ph388, label %bb.ad, !llvm.loop !496
