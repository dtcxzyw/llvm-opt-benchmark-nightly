...
bb.ag:                                            ; preds = %bb.af
  ...
  %i.afb = load float, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 700), align 4, !tbaa !15
  %i.afc = load float, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 672), align 8, !tbaa !14
  %65 = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 188), align 4, !tbaa !10 ; 3 uses
  ...
  %i.aff = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 628), align 4, !tbaa !10 ; 2 uses
  %66 = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 676), align 4, !tbaa !10 ; 2 uses
  %i.afg = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 604), align 4, !tbaa !10 ; 3 uses
  %67 = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 620), align 4, !tbaa !10 ; 3 uses
  %i.afh = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 664), align 8, !tbaa !10 ; 3 uses
  %68 = shufflevector <2 x float> %i.afh, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %69 = insertelement <2 x float> %i.afh, float %i.afc, i64 1
  %70 = fmul <2 x float> %68, %69
  %71 = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 692), align 4
  %72 = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 688), align 8
  %73 = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 696), align 8
  %74 = shufflevector <4 x float> %71, <4 x float> poison, <2 x i32> zeroinitializer
  %75 = shufflevector <2 x float> %i.afg, <2 x float> %67, <2 x i32> <i32 1, i32 3>
  %76 = fmul <2 x float> %74, %75
  %77 = shufflevector <4 x float> %72, <4 x float> poison, <2 x i32> zeroinitializer
  %78 = shufflevector <2 x float> %i.afg, <2 x float> %67, <2 x i32> <i32 0, i32 2>
  %79 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %77, <2 x float> %78, <2 x float> %76)
  %80 = shufflevector <4 x float> %73, <4 x float> poison, <2 x i32> zeroinitializer
  %81 = shufflevector <2 x float> %i.afe, <2 x float> %i.aff, <2 x i32> <i32 0, i32 2>
  %82 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %80, <2 x float> %81, <2 x float> %79) ; 2 uses
  %83 = extractelement <2 x float> %82, i64 1     ; 2 uses
  %i.afi = tail call float @llvm.fabs.f32(float %83)
  %i.afj = fcmp olt float %i.afi, f0x34000000
  %84 = extractelement <2 x float> %82, i64 0
  %i.afk = fsub float %84, %i.afb
  %i.afl = fneg float %i.afk
  %i.afm = fdiv float %i.afl, %83
  ...
  %i.afr = fmul <2 x float> %67, %i.afq
  %i.afs = fmul <2 x float> %i.aff, %i.afq
  %i.aft = fadd <2 x float> %i.afg, %i.afr
  %i.afu = fadd <2 x float> %i.afe, %i.afs
  %i.afv = shufflevector <2 x float> %66, <2 x float> %68, <2 x i32> <i32 0, i32 3>
  %i.afw = shufflevector <2 x float> %i.afh, <2 x float> %66, <2 x i32> <i32 0, i32 3>
  %i.afx = fmul <2 x float> %i.afv, %i.afw
  %i.afy = fsub <2 x float> %i.aft, %70
  %i.afz = fsub <2 x float> %i.afu, %i.afx
  %i.aga = fsub <2 x float> %i.afy, %65           ; 3 uses
  %i.agb = fsub <2 x float> %i.afz, %i.afd        ; 2 uses
...
bb.aj:                                            ; preds = %bb.ai
  ...
  %i.agx = shufflevector <2 x float> %i.afd, <2 x float> %65, <3 x i32> <i32 0, i32 2, i32 3>
  ...
  %i.ahd = fadd <2 x float> %i.afd, %.sroa.11218.0.i
