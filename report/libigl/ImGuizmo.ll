...
bb.ag:                                            ; preds = %bb.af
  ...
  %65 = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 692), align 4
  %66 = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 688), align 8
  %67 = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 696), align 8
  %68 = shufflevector <4 x float> %65, <4 x float> poison, <2 x i32> zeroinitializer
  %i.afq = shufflevector <2 x float> %i.afk, <2 x float> %i.afl, <2 x i32> <i32 1, i32 3>
  %i.afr = fmul <2 x float> %68, %i.afq
  %i.afs = shufflevector <4 x float> %66, <4 x float> poison, <2 x i32> zeroinitializer
  ...
  %69 = shufflevector <4 x float> %67, <4 x float> poison, <2 x i32> zeroinitializer
  %i.afv = shufflevector <2 x float> %i.afh, <2 x float> %i.afi, <2 x i32> <i32 0, i32 2>
  %i.afw = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %69, <2 x float> %i.afv, <2 x float> %i.afu) ; 2 uses
...
bb.ak:                                            ; preds = %bb.aj
  ...
  %i.aio = fmul <4 x float> %70, %i.aia           ; 2 uses
  store <4 x float> %i.aio, ptr %55, align 16, !tbaa !10
  %71 = shufflevector <3 x float> %i.ain, <3 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.aip = fmul <4 x float> %71, %i.aib           ; 2 uses
  store <4 x float> %i.aip, ptr %i.ahw, align 16, !tbaa !10
  %72 = shufflevector <3 x float> %i.ain, <3 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %i.aiq = fmul <4 x float> %72, %i.aic           ; 2 uses
...
bb.ap:                                            ; preds = %bb.ao, %bb.an
  %73 = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 276), align 4
  %i.ajs = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 280), align 8
  %74 = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 268), align 4, !tbaa !10 ; 4 uses
  %75 = shufflevector <2 x float> %74, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %76 = fmul <2 x float> %75, <float 1.000000e+00, float 0.000000e+00>
  %77 = shufflevector <2 x float> %74, <2 x float> poison, <2 x i32> zeroinitializer
  %78 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %77, <2 x float> zeroinitializer, <2 x float> %76)
  %79 = shufflevector <4 x float> %73, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %81 = shufflevector <4 x float> %i.ajs, <4 x float> poison, <4 x i32> zeroinitializer
  %.sroa.7.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %4, i64 16
  %82 = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 292), align 4
  %i.ajv = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 296), align 8
  %83 = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 284), align 4, !tbaa !10 ; 4 uses
  %84 = shufflevector <2 x float> %83, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %85 = fmul <2 x float> %84, <float 1.000000e+00, float 0.000000e+00>
  %86 = shufflevector <2 x float> %83, <2 x float> poison, <2 x i32> zeroinitializer
  %87 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %86, <2 x float> zeroinitializer, <2 x float> %85)
  %88 = shufflevector <4 x float> %82, <4 x float> poison, <4 x i32> zeroinitializer
  %89 = shufflevector <2 x float> %87, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %90 = shufflevector <4 x float> %i.ajv, <4 x float> poison, <4 x i32> zeroinitializer
  %.sroa.11.0..sroa_idx.i42 = getelementptr inbounds nuw i8, ptr %4, i64 32
  %91 = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 308), align 4
  %i.ajw = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 312), align 8
  %92 = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 300), align 4, !tbaa !10 ; 3 uses
  %93 = shufflevector <2 x float> %92, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %94 = shufflevector <2 x float> %92, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %95 = fmul <2 x float> %94, <float 1.000000e+00, float 0.000000e+00> ; 2 uses
  %96 = shufflevector <2 x float> %92, <2 x float> poison, <2 x i32> zeroinitializer
  %97 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %96, <2 x float> zeroinitializer, <2 x float> %95)
  ...
  %100 = shufflevector <4 x float> %i.ajw, <4 x float> poison, <4 x i32> zeroinitializer
  %.sroa.15.0..sroa_idx.i45 = getelementptr inbounds nuw i8, ptr %4, i64 48
  %101 = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 324), align 4
  %i.ajx = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 328), align 8
  %102 = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 316), align 4, !tbaa !10 ; 3 uses
  %103 = shufflevector <2 x float> %102, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %104 = shufflevector <2 x float> %102, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %105 = fmul <2 x float> %104, <float 1.000000e+00, float 0.000000e+00> ; 2 uses
  %106 = shufflevector <2 x float> %74, <2 x float> %83, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
  %107 = shufflevector <4 x float> %106, <4 x float> %93, <4 x i32> <i32 0, i32 1, i32 4, i32 poison>
  %108 = shufflevector <4 x float> %107, <4 x float> %103, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %109 = shufflevector <2 x float> %74, <2 x float> %83, <4 x i32> <i32 1, i32 3, i32 poison, i32 poison>
  %i.ajy = fmul <4 x float> %109, <float 0.000000e+00, float 0.000000e+00, float poison, float poison>
  %110 = shufflevector <2 x float> %95, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %111 = shufflevector <4 x float> %i.ajy, <4 x float> %110, <4 x i32> <i32 0, i32 1, i32 5, i32 poison>
  %112 = shufflevector <2 x float> %105, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %113 = shufflevector <4 x float> %111, <4 x float> %112, <4 x i32> <i32 0, i32 1, i32 2, i32 5>
  %114 = fadd <4 x float> %108, %113              ; 4 uses
  %115 = shufflevector <4 x float> %114, <4 x float> %80, <4 x i32> <i32 0, i32 4, i32 5, i32 5>
  %116 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %79, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00>, <4 x float> %115)
  %117 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.aju, <4 x float> %81, <4 x float> %116)
  %118 = shufflevector <4 x float> %114, <4 x float> poison, <4 x i32> <i32 1, i32 poison, i32 poison, i32 poison>
  %119 = shufflevector <4 x float> %118, <4 x float> %89, <4 x i32> <i32 0, i32 4, i32 5, i32 5>
  %120 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %88, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00>, <4 x float> %119)
  %121 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.aju, <4 x float> %90, <4 x float> %120)
  %122 = shufflevector <4 x float> %114, <4 x float> poison, <4 x i32> <i32 2, i32 poison, i32 poison, i32 poison>
  %123 = shufflevector <4 x float> %122, <4 x float> %99, <4 x i32> <i32 0, i32 4, i32 5, i32 5>
  %124 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %98, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00>, <4 x float> %123)
  %125 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.aju, <4 x float> %100, <4 x float> %124)
  %126 = shufflevector <2 x float> %102, <2 x float> poison, <2 x i32> zeroinitializer
  %127 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %126, <2 x float> zeroinitializer, <2 x float> %105)
  %i.ajz = shufflevector <4 x float> %101, <4 x float> poison, <4 x i32> zeroinitializer
  %128 = shufflevector <4 x float> %114, <4 x float> poison, <4 x i32> <i32 3, i32 poison, i32 poison, i32 poison>
  %129 = shufflevector <2 x float> %127, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %130 = shufflevector <4 x float> %128, <4 x float> %129, <4 x i32> <i32 0, i32 4, i32 5, i32 5>
  %i.aka = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ajz, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00>, <4 x float> %130)
  %131 = shufflevector <4 x float> %i.ajx, <4 x float> poison, <4 x i32> zeroinitializer
  %i.akb = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.aju, <4 x float> %131, <4 x float> %i.aka)
  store <4 x float> %117, ptr %4, align 4
  store <4 x float> %121, ptr %.sroa.7.0..sroa_idx.i, align 4
  store <4 x float> %125, ptr %.sroa.11.0..sroa_idx.i42, align 4
