...
bb.dz:                                            ; preds = %bb.ed, %bb.dx
  ...
  %i.cuw = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 396), align 4, !tbaa !16
  %i.cux = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 412), align 4, !tbaa !16
  %i.cuy = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 428), align 4, !tbaa !16
  %i.cuz = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 444), align 4, !tbaa !16
  ...
  %i.cva = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 972), align 4, !tbaa !9 ; 3 uses
  %i.cvb = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 964), align 4, !tbaa !9 ; 3 uses
  br label %bb.eb
...
bb.ea:                                            ; preds = %bb.eb
  ...
  %i.cwg = extractelement <2 x float> %i.cva, i64 0
  %i.cwh = fmul float %i.cwg, %i.cwd
  %i.cwi = extractelement <2 x float> %i.cva, i64 1
  %i.cwj = fmul float %i.cwi, %i.cwf
  %i.cwk = extractelement <2 x float> %i.cvb, i64 0
  %i.cwl = fadd float %i.cwk, %i.cwh
  %i.cwm = extractelement <2 x float> %i.cvb, i64 1
...
bb.eb:                                            ; preds = %bb.eb, %bb.dz
  ...
  %i.cxn = fmul <2 x float> %i.cux, %i.cxm
  ...
  %i.cxq = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cxp, <2 x float> %i.cuw, <2 x float> %i.cxn)
  ...
  %i.cxt = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cxs, <2 x float> %i.cuy, <2 x float> %i.cxq)
  %i.cxu = fadd <2 x float> %i.cuz, %i.cxt
  ...
  %i.cyd = fmul <2 x float> %i.cva, %i.cyc
  %i.cye = fadd <2 x float> %i.cvb, %i.cyd
...
bb.ee:                                            ; preds = %bb.dy
  ...
  %i.cyi = load float, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 196), align 4, !tbaa !9 ; 3 uses
  ...
  %i.cyr = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 188), align 4, !tbaa !9 ; 3 uses
  %i.cys = load float, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 192), align 8, !tbaa !9
  %69 = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 472), align 8, !tbaa !16 ; 2 uses
  %i.cyt = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 460), align 4, !tbaa !16
  %i.cyu = load float, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 464), align 8, !tbaa !16
  %i.cyv = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 688), align 8, !tbaa !9 ; 5 uses
  %i.cyw = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 476), align 4, !tbaa !16 ; 2 uses
  %70 = shufflevector <2 x float> %i.cyv, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %71 = insertelement <2 x float> %70, float %i.cys, i64 1
  %72 = shufflevector <2 x float> %71, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
  %73 = shufflevector <2 x float> %i.cyv, <2 x float> %i.cyw, <4 x i32> <i32 1, i32 2, i32 3, i32 poison>
  %i.cyx = insertelement <4 x float> %73, float %i.cyl, i64 3
  %i.cyy = fmul <4 x float> %72, %i.cyx
  %i.cyz = shufflevector <2 x float> %i.cyv, <2 x float> %i.cyr, <4 x i32> <i32 0, i32 2, i32 2, i32 2>
  %74 = shufflevector <2 x float> %i.cyt, <2 x float> %69, <4 x i32> <i32 poison, i32 0, i32 1, i32 2> ; 2 uses
  %i.cza = shufflevector <2 x float> %i.cyv, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %75 = shufflevector <4 x float> %i.cza, <4 x float> %74, <4 x i32> <i32 0, i32 5, i32 poison, i32 7>
  %76 = insertelement <4 x float> %75, float %i.cyu, i64 2
  %i.czb = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.cyz, <4 x float> %76, <4 x float> %i.cyy) ; 3 uses
  ...
  %i.czg = call float @llvm.fmuladd.f32(float %i.cyi, float %i.cym, float %i.czf)
  %i.czh = fadd float %i.cyn, %i.czg
  %77 = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 736), align 8, !tbaa !9 ; 3 uses
  %.sroa.092.0.copyload.i = load float, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 740), align 4, !tbaa !9 ; 3 uses
  ...
  %i.czs = insertelement <4 x float> <float poison, float poison, float 0.000000e+00, float -0.000000e+00>, float %i.cyi, i64 0
  ...
  %78 = shufflevector <2 x float> %i.czp, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %i.dao = extractelement <2 x float> %77, i64 0  ; 2 uses
  %79 = shufflevector <2 x float> %77, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %80 = shufflevector <2 x float> %69, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  ...
  %81 = shufflevector <2 x float> %i.cyw, <2 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 1, i32 poison>
  ...
  %i.dau = shufflevector <4 x float> %i.dat, <4 x float> %78, <4 x i32> <i32 0, i32 4, i32 poison, i32 poison>
  ...
  %i.dax = shufflevector <4 x float> %i.dar, <4 x float> %78, <4 x i32> <i32 0, i32 1, i32 5, i32 4>
  %82 = shufflevector <2 x float> %77, <2 x float> %i.cyr, <4 x i32> <i32 0, i32 2, i32 2, i32 2>
  %83 = insertelement <4 x float> %81, float %i.cyl, i64 3
  %84 = shufflevector <4 x float> %83, <4 x float> %79, <4 x i32> <i32 5, i32 poison, i32 2, i32 3>
  %85 = shufflevector <4 x float> %84, <4 x float> %80, <4 x i32> <i32 0, i32 5, i32 2, i32 3>
  br label %bb.eg
...
bb.eh:                                            ; preds = %bb.eg
  ...
  %i.dcl = fmul float %.sroa.092.0.copyload.i, %i.dbu
...
_ZN8ImGuizmo8matrix_t12RotationAxisERKNS_5vec_tEf.exit.i123: ; preds = %bb.eh, %bb.eg
  ...
  %.sink59.i.i125 = phi float [ %i.dcl, %bb.eh ], [ %.sroa.092.0.copyload.i, %bb.eg ]
  ...
  %i.dco = fmul float %.sroa.092.0.copyload.i, %.sroa.11.0.i
  %i.dcp = extractelement <2 x float> %i.dcn, i64 0
  %i.dcq = call float @llvm.fmuladd.f32(float %i.dao, float %i.dcp, float %i.dco)
  ...
  %i.dcv = call float @llvm.fmuladd.f32(float %i.dao, float %i.dcu, float %.sink59.i.i125)
  ...
  %86 = insertelement <2 x float> <float -0.000000e+00, float poison>, float %i.dda, i64 1
  %87 = shufflevector <2 x float> %86, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
  %88 = fadd <4 x float> %82, %87
  %i.ddc = shufflevector <4 x float> %i.dcm, <4 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.ddd = insertelement <2 x float> <float -0.000000e+00, float poison>, float %i.ddb, i64 1
  %89 = shufflevector <2 x float> %i.ddc, <2 x float> %i.cyr, <4 x i32> <i32 0, i32 3, i32 3, i32 3>
  %i.dde = shufflevector <2 x float> %i.ddd, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
  %90 = fadd <4 x float> %89, %i.dde
  %91 = fmul <4 x float> %85, %90
  %i.ddf = insertelement <4 x float> %74, float %.sroa.7.0.i, i64 0
  %i.ddg = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %88, <4 x float> %i.ddf, <4 x float> %91) ; 3 uses
  ...
  %i.ddl = fadd float %i.cyi, %i.ddk              ; 2 uses
  %i.ddm = extractelement <4 x float> %i.ddg, i64 3
  %i.ddn = call float @llvm.fmuladd.f32(float %i.ddl, float %i.cym, float %i.ddm)
  %i.ddo = fadd float %i.cyn, %i.ddn
  ...
  %i.ddt = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ddr, <2 x float> %i.cyj, <2 x float> %i.dds)
  %i.ddu = fadd <2 x float> %i.cyk, %i.ddt
