...
bb.dz:                                            ; preds = %bb.ed, %bb.dx
  ...
  %65 = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL8gContextE, i64 664), align 8
  ...
  %66 = shufflevector <4 x float> %65, <4 x float> poison, <3 x i32> zeroinitializer
  br label %bb.eb
...
bb.eb:                                            ; preds = %bb.eb, %bb.dz
  ...
  %67 = insertelement <3 x float> poison, float %i.ctx, i64 0
  %68 = insertelement <3 x float> %67, float %i.ctv, i64 1
  %69 = insertelement <3 x float> %68, float %i.ctw, i64 2
  %70 = fmul <3 x float> %66, %69                 ; 6 uses
  %71 = shufflevector <3 x float> %70, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.cty = fmul <2 x float> %i.cro, %71
  %72 = shufflevector <3 x float> %70, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %73 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %72, <2 x float> %i.crn, <2 x float> %i.cty)
  %i.ctz = shufflevector <3 x float> %70, <3 x float> poison, <2 x i32> zeroinitializer
  %i.cua = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ctz, <2 x float> %i.crp, <2 x float> %73)
  %74 = fadd <2 x float> %i.crq, %i.cua
  %75 = extractelement <3 x float> %70, i64 2
  %76 = fmul float %i.crs, %75
  %77 = extractelement <3 x float> %70, i64 1
  %78 = call float @llvm.fmuladd.f32(float %77, float %i.crr, float %76)
  %79 = extractelement <3 x float> %70, i64 0
  %i.cub = call float @llvm.fmuladd.f32(float %79, float %i.crt, float %78)
  ...
  %i.cug = fmul <2 x float> %74, %i.cuf           ; 2 uses
