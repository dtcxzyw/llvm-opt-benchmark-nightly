...
.preheader680.i:                                  ; preds = %bb.bp
  ...
  %65 = load <1 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL14directionUnaryE, i64 8), align 8
  ...
  %i.bhs = shufflevector <1 x float> %65, <1 x float> poison, <2 x i32> zeroinitializer ; 2 uses
...
bb.br:                                            ; preds = %bb.bq, %.preheader680.i
  ...
  %.1165.i = phi float [ 0.000000e+00, %.preheader680.i ], [ %i.biu, %bb.bq ] ; 2 uses
  %.1162.i = phi i32 [ %i.bgw, %.preheader680.i ], [ 0, %bb.bq ]
...
bb.bt:                                            ; preds = %bb.bs, %bb.br
  ...
  %66 = load <1 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL14directionUnaryE, i64 24), align 8
  ...
  %i.bjb = shufflevector <1 x float> %66, <1 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %sqrt.i.i.1.i83 = call noundef float @llvm.sqrt.f32(float %i.bjk)
  %i.bjl = fdiv float 1.000000e+00, %sqrt.i.i.1.i83
  ...
  %i.bjx = fcmp ult float %i.bjw, %.1165.i
...
bb.bw:                                            ; preds = %bb.bv
  ...
  %i.bkc = add nuw nsw i32 %.1159.i, 1
  br label %bb.bx

bb.bx:                                            ; preds = %bb.bw, %bb.bv
  %.1159.1.i = phi i32 [ %i.bkc, %bb.bw ], [ %.1159.i, %bb.bv ] ; 4 uses
  ...
  %67 = load <1 x float>, ptr getelementptr inbounds nuw (i8, ptr @_ZN8ImGuizmoL14directionUnaryE, i64 40), align 8
  ...
  %i.bkh = shufflevector <1 x float> %67, <1 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %sqrt.i.i.2.i84 = call noundef float @llvm.sqrt.f32(float %i.bkq)
  %i.bkr = fdiv float 1.000000e+00, %sqrt.i.i.2.i84
  ...
  %i.bld = fcmp ult float %i.blc, %.1165.1.i      ; 3 uses
  ...
  %.1162.2.i = select i1 %i.bld, i32 %.1162.1.i, i32 2 ; 4 uses
  %i.ble = fcmp ult float %i.blc, 1.000000e-01
  br i1 %i.ble, label %bb.by, label %.thread746.i

.thread746.i:                                     ; preds = %bb.bx
  %i.blf = zext nneg i32 %.1159.1.i to i64        ; 2 uses
  ...
  %i.bli = add nuw nsw i32 %.1159.1.i, 1
  br label %.thread.i

bb.by:                                            ; preds = %bb.bx
  %i.blj = icmp eq i32 %.1159.1.i, 0
  br i1 %i.blj, label %bb.bz, label %.thread.i

bb.bz:                                            ; preds = %bb.by
  store i32 %.1162.2.i, ptr %i.k, align 4, !tbaa !65
...
.thread.i:                                        ; preds = %bb.by, %.thread746.i
  %.1159.2748.i = phi i32 [ %i.bli, %.thread746.i ], [ %.1159.1.i, %bb.by ] ; 3 uses
  %.pre.i85 = load i32, ptr %i.k, align 4, !tbaa !65 ; 3 uses
...
.preheader.i:                                     ; preds = %bb.ca, %.preheader.preheader.i
  ...
  %i.blm = icmp eq i32 %i.bll, %.1162.2.i
  br i1 %i.blm, label %split.i, label %bb.ca

split.i:                                          ; preds = %.preheader.i, %._crit_edge712.i
  %i.bln = phi i32 [ %.pre.i85, %._crit_edge712.i ], [ %.1162.2.i, %.preheader.i ]
  %.0171.i = phi i64 [ 0, %._crit_edge712.i ], [ %indvars.iv.i, %.preheader.i ] ; 2 uses
  %i.blo = getelementptr inbounds nuw [4 x i8], ptr %i.k, i64 %.0171.i
  store i32 %i.bln, ptr %i.k, align 4, !tbaa !65
  store i32 %.pre.i85, ptr %i.blo, align 4, !tbaa !65
  %.sroa.0.0.copyload = load <4 x float>, ptr %42, align 16
  %i.blp = getelementptr inbounds nuw [16 x i8], ptr %42, i64 %.0171.i ; 2 uses
...
.backedge:                                        ; preds = %.backedge.backedge, %.thread.thread.i
  ...
  %sqrt.i.i.i.i.i98 = call float @llvm.sqrt.f32(float %i.boi)
  %i.boj = fdiv float 1.000000e+00, %sqrt.i.i.i.i.i98 ; 3 uses
