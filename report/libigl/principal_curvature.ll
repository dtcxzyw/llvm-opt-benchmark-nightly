...
_ZNK5Eigen9DenseBaseINS_8DiagonalIKNS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEEELi0EEEE8maxCoeffEv.exit.loopexit.unr-lcssa: ; preds = %.lr.ph.i.i.i.i
  ...
  br i1 %lcmp.mod631.not, label %_ZNK5Eigen9DenseBaseINS_8DiagonalIKNS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEEELi0EEEE8maxCoeffEv.exit, label %.lr.ph.i.i.i.i.epil.preheader
...
.lr.ph.i.i.i.i.epil.preheader:                    ; preds = %_ZNK5Eigen9DenseBaseINS_8DiagonalIKNS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEEELi0EEEE8maxCoeffEv.exit.loopexit.unr-lcssa, %.lr.ph.i.i.i.i.preheader
  ...
  %lcmp.mod633 = trunc i64 %i.kc to i1
  call void @llvm.assume(i1 %lcmp.mod633)
...
.preheader262.us.preheader:                       ; preds = %_ZNK5Eigen9DenseBaseINS_8DiagonalIKNS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEEELi0EEEE8maxCoeffEv.exit
  %xtraiter634 = and i64 %i.ka, 1
  %i.ln = icmp eq i64 %i.ka, 1
  %unroll_iter637 = and i64 %i.ka, 9223372036854775806
  %lcmp.mod635.not = icmp eq i64 %xtraiter634, 0
  %lcmp.mod636 = trunc i64 %i.ka to i1
...
bb.ad:                                            ; preds = %bb.ac, %bb.ab
  %i.mt = phi <2 x double> [ %i.ms, %bb.ac ], [ <double 0.000000e+00, double 1.000000e+00>, %bb.ab ] ; 7 uses
  ...
  %5 = insertelement <2 x double> poison, double %i.me, i64 0
  %6 = insertelement <2 x double> %5, double %i.mh, i64 1 ; 3 uses
...
_ZN5Eigen8internal36apply_rotation_in_the_plane_selectorIddLi2ELi0ELb0EE3runEPdlS3_lldd.exit.loopexit.i.i.i.us: ; preds = %bb.ad
  %i.my = insertelement <2 x double> %6, double %i.md, i64 0
  %7 = fmul <2 x double> %i.my, %i.mt
  %8 = fmul double %i.mh, %i.mw
  %9 = call double @llvm.fmuladd.f64(double %i.mu, double %i.lx, double %8) ; 2 uses
  %10 = fneg <2 x double> %i.mt
  %11 = shufflevector <2 x double> %i.mt, <2 x double> %10, <2 x i32> <i32 1, i32 2>
  %i.mz = insertelement <2 x double> %6, double %i.lx, i64 1
  %i.na = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %11, <2 x double> %i.mz, <2 x double> %7)
  %.pre293 = call noundef double @llvm.fabs.f64(double %9)
...
_ZN5Eigen10MatrixBaseINS_6MatrixIdLi2ELi2ELi0ELi2ELi2EEEE14applyOnTheLeftIdEEvllRKNS_14JacobiRotationIT_EE.exit.i.us: ; preds = %_ZN5Eigen8internal36apply_rotation_in_the_plane_selectorIddLi2ELi0ELb0EE3runEPdlS3_lldd.exit.loopexit.i.i.i.us, %bb.ad
  ...
  %.sroa.9.0.i.us = phi double [ %9, %_ZN5Eigen8internal36apply_rotation_in_the_plane_selectorIddLi2ELi0ELb0EE3runEPdlS3_lldd.exit.loopexit.i.i.i.us ], [ %i.lx, %bb.ad ]
  %12 = phi <2 x double> [ %i.na, %_ZN5Eigen8internal36apply_rotation_in_the_plane_selectorIddLi2ELi0ELb0EE3runEPdlS3_lldd.exit.loopexit.i.i.i.us ], [ %6, %bb.ad ] ; 2 uses
...
bb.ae:                                            ; preds = %_ZN5Eigen10MatrixBaseINS_6MatrixIdLi2ELi2ELi0ELi2ELi2EEEE14applyOnTheLeftIdEEvllRKNS_14JacobiRotationIT_EE.exit.i.us
  ...
  %i.nd = fdiv double %13, %i.nb                  ; 4 uses
...
.lr.ph.i.i.i103.us.new:                           ; preds = %.lr.ph.i.i.i103.us, %.lr.ph.i.i.i103.us.new
  ...
  %niter638 = phi i64 [ %niter638.next.1, %.lr.ph.i.i.i103.us.new ], [ 0, %.lr.ph.i.i.i103.us ]
  ...
  %niter638.next.1 = add nuw nsw i64 %niter638, 2 ; 2 uses
  %niter638.ncmp.1 = icmp eq i64 %niter638.next.1, %unroll_iter637
  br i1 %niter638.ncmp.1, label %_ZN5Eigen10MatrixBaseINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEE14applyOnTheLeftIdEEvllRKNS_14JacobiRotationIT_EE.exit.us.loopexit.unr-lcssa, label %.lr.ph.i.i.i103.us.new, !llvm.loop !502
...
_ZN5Eigen10MatrixBaseINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEE14applyOnTheLeftIdEEvllRKNS_14JacobiRotationIT_EE.exit.us.loopexit.unr-lcssa: ; preds = %.lr.ph.i.i.i103.us.new
  br i1 %lcmp.mod635.not, label %_ZN5Eigen10MatrixBaseINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEE14applyOnTheLeftIdEEvllRKNS_14JacobiRotationIT_EE.exit.us, label %.epil.preheader
...
.lr.ph.i.i.i107.us.preheader:                     ; preds = %vector.memcheck458, %.lr.ph.i.i.preheader.i.us, %middle.block481
  ...
  %.neg667.a = or disjoint i64 %.01519.i.i.i110.us.ph, 1
  %xtraiter639 = and i64 %i.pv, 1
  %lcmp.mod640.not = icmp eq i64 %xtraiter639, 0
  br i1 %lcmp.mod640.not, label %.lr.ph.i.i.i107.us.prol.loopexit, label %.lr.ph.i.i.i107.us.prol
