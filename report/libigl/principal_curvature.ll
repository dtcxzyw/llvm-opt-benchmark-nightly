...
bb.c:                                             ; preds = %.lr.ph438, %bb.c
  ...
  %i.dj = load double, ptr %i.di, align 8, !tbaa !60
  ...
  br i1 %exitcond.not, label %._crit_edge439, label %bb.c, !llvm.loop !898
...
._crit_edge439:                                   ; preds = %bb.c, %._crit_edge.._crit_edge439_crit_edge
  ...
  store double %i.ec, ptr %i.dz, align 8, !tbaa !60
  ...
  store double %i.eh, ptr %i.ee, align 8, !tbaa !60
  ...
  store double %i.em, ptr %i.ej, align 8, !tbaa !60
  ...
  store double %i.fg, ptr %i.fd, align 8, !tbaa !60
  ...
  store double %i.fl, ptr %i.fi, align 8, !tbaa !60
  %i.fm = add nuw nsw i64 %.0206448, 8            ; 3 uses
  %i.fn = icmp sgt i64 %i.c, %i.fm
  br i1 %i.fn, label %.preheader409, label %.preheader408, !llvm.loop !899
...
.lr.ph456:                                        ; preds = %.preheader407
  %i.fo = load ptr, ptr %3, align 8, !tbaa !892
...
bb.d:                                             ; preds = %.lr.ph456, %bb.d
  ...
  br i1 %.not237, label %._crit_edge457, label %bb.d, !llvm.loop !900
...
.lr.ph469:                                        ; preds = %._crit_edge457
  %i.hc = load ptr, ptr %3, align 8, !tbaa !892
...
bb.e:                                             ; preds = %.lr.ph469, %bb.e
  ...
  br i1 %exitcond549.not, label %._crit_edge470, label %bb.e, !llvm.loop !901
...
.lr.ph481:                                        ; preds = %.preheader405
  %i.jc = load ptr, ptr %3, align 8, !tbaa !892   ; 3 uses
...
.epil.preheader:                                  ; preds = %._crit_edge482.loopexit.unr-lcssa, %.lr.ph481
  ...
  %i.km = load <2 x double>, ptr %i.kl, align 1, !tbaa !16 ; 2 uses
...
.lr.ph490:                                        ; preds = %._crit_edge482
  %i.la = load ptr, ptr %3, align 8, !tbaa !892   ; 3 uses
...
bb.c:                                             ; preds = %.lr.ph438, %bb.c
  ...
  %i.da = load double, ptr %i.cz, align 8, !tbaa !60
  %i.db = getelementptr [8 x i8], ptr %i.cy, i64 %i.ch
  %i.dc = load double, ptr %i.db, align 8, !tbaa !60
  %i.dd = getelementptr [8 x i8], ptr %i.cy, i64 %i.cj
  %i.de = load double, ptr %i.dd, align 8, !tbaa !60
  %i.df = getelementptr [8 x i8], ptr %i.cy, i64 %i.cl
  %i.dg = load double, ptr %i.df, align 8, !tbaa !60
  %i.dh = getelementptr [8 x i8], ptr %i.cy, i64 %i.cn
  %i.di = load double, ptr %i.dh, align 8, !tbaa !60
  %i.dj = getelementptr [8 x i8], ptr %i.cy, i64 %i.cp
  %i.dk = load double, ptr %i.dj, align 8, !tbaa !60
  %i.dl = getelementptr [8 x i8], ptr %i.cy, i64 %i.cr
  %i.dm = load double, ptr %i.dl, align 8, !tbaa !60
  ...
  br i1 %exitcond.not, label %._crit_edge439, label %bb.c, !llvm.loop !1117
...
.lr.ph456:                                        ; preds = %.preheader407
  %i.ft = load ptr, ptr %3, align 8, !tbaa !889
  %i.fu = load i64, ptr %i.ab, align 8, !tbaa !891
...
bb.d:                                             ; preds = %.lr.ph456, %bb.d
  ...
  %i.gn = load <2 x double>, ptr %i.gm, align 1, !tbaa !16 ; 4 uses
  ...
  br i1 %.not237, label %._crit_edge457, label %bb.d, !llvm.loop !1119
...
.lr.ph469:                                        ; preds = %._crit_edge457
  %i.hk = load ptr, ptr %3, align 8, !tbaa !889
  %i.hl = load i64, ptr %i.ab, align 8, !tbaa !891
...
bb.e:                                             ; preds = %.lr.ph469, %bb.e
  ...
  %i.id = load double, ptr %i.ic, align 8, !tbaa !60
  %i.ie = getelementptr [8 x i8], ptr %i.hx, i64 %i.hs
  %i.if = load double, ptr %i.ie, align 8, !tbaa !60
  ...
  br i1 %exitcond549.not, label %._crit_edge470, label %bb.e, !llvm.loop !1120
...
.lr.ph481:                                        ; preds = %.preheader405
  %i.jm = load ptr, ptr %3, align 8, !tbaa !889   ; 3 uses
  %i.jn = load i64, ptr %i.gd, align 8, !tbaa !891 ; 3 uses
...
.epil.preheader:                                  ; preds = %._crit_edge482.loopexit.unr-lcssa, %.lr.ph481
  ...
  %i.lb = load <2 x double>, ptr %i.la, align 1, !tbaa !16 ; 2 uses
...
.lr.ph490:                                        ; preds = %._crit_edge482
  %i.lp = load ptr, ptr %3, align 8, !tbaa !889   ; 3 uses
  %i.lq = load i64, ptr %i.gd, align 8, !tbaa !891 ; 3 uses
