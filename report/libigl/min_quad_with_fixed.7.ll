...
bb.a:
  ...
  %i.h = icmp slt i32 %.sroa.speculated427, 1
...
bb.ag:                                            ; preds = %._crit_edge589, %bb.cc, %bb.cd
  ...
  br i1 %exitcond631.not, label %.thread497, label %.loopexit516, !llvm.loop !320

.loopexit516:                                     ; preds = %.lr.ph597, %bb.ag
