...
bb.c:                                             ; preds = %.lr.ph438, %bb.c
  ...
  %i.cz = load double, ptr %i.cy, align 8, !tbaa !152
  %i.da = getelementptr [8 x i8], ptr %i.ct, i64 %i.ch
  %i.db = load double, ptr %i.da, align 8, !tbaa !152
  %i.dc = getelementptr [8 x i8], ptr %i.ct, i64 %i.cj
  %i.dd = load double, ptr %i.dc, align 8, !tbaa !152
  %i.de = getelementptr [8 x i8], ptr %i.ct, i64 %i.cl
  %i.df = load double, ptr %i.de, align 8, !tbaa !152
  ...
  %i.dj = load double, ptr %i.di, align 8, !tbaa !152
  ...
  br i1 %exitcond.not, label %._crit_edge439, label %bb.c, !llvm.loop !1820
...
._crit_edge439:                                   ; preds = %bb.c, %._crit_edge.._crit_edge439_crit_edge
  ...
  store double %i.em, ptr %i.ej, align 8, !tbaa !152
  ...
  store double %i.ew, ptr %i.et, align 8, !tbaa !152
...
.lr.ph456:                                        ; preds = %.preheader407
  %i.fo = load ptr, ptr %3, align 8, !tbaa !809
...
.lr.ph469:                                        ; preds = %._crit_edge457
  %i.hc = load ptr, ptr %3, align 8, !tbaa !809
...
bb.e:                                             ; preds = %.lr.ph469, %bb.e
  ...
  %i.hp = load double, ptr %i.ho, align 8, !tbaa !152
  %i.hq = getelementptr [8 x i8], ptr %i.hn, i64 %i.hf
  %i.hr = load double, ptr %i.hq, align 8, !tbaa !152
...
.lr.ph481:                                        ; preds = %.preheader405
  %i.jc = load ptr, ptr %3, align 8, !tbaa !809   ; 3 uses
...
.epil.preheader:                                  ; preds = %._crit_edge482.loopexit.unr-lcssa, %.lr.ph481
  ...
  %i.km = load <2 x double>, ptr %i.kl, align 1, !tbaa !52 ; 2 uses
  ...
  %i.kp = load <2 x double>, ptr %i.ko, align 1, !tbaa !52
...
.lr.ph490:                                        ; preds = %._crit_edge482
  %i.la = load ptr, ptr %3, align 8, !tbaa !809   ; 3 uses
