...
_ZN5Eigen9DenseBaseINS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEEE11setConstantERKi.exit: ; preds = %_ZN5Eigen6MatrixIiLin1ELi1ELi0ELin1ELi1EEC2IiEERKT_.exit, %bb.a
  %.sroa.0403.0454 = phi ptr [ null, %bb.a ], [ %i.j, %_ZN5Eigen6MatrixIiLin1ELi1ELi0ELin1ELi1EEC2IiEERKT_.exit ] ; 10 uses
  %sext506 = shl i64 %i.e, 32                     ; 3 uses
  %i.m = ashr exact i64 %sext506, 32
...
_ZN5Eigen6MatrixIdLin1ELi1ELi0ELin1ELi1EEC2IiEERKT_.exit: ; preds = %_ZN5Eigen6MatrixIiLin1ELi1ELi0ELin1ELi1EEC2IiEERKT_.exit252, %bb.i
  %.sroa.0380.0471 = phi ptr [ null, %_ZN5Eigen6MatrixIiLin1ELi1ELi0ELin1ELi1EEC2IiEERKT_.exit252 ], [ %i.v, %bb.i ] ; 21 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  br i1 %.not.i.i.i.i.i, label %.loopexit521, label %bb.p
...
_ZN5Eigen6MatrixIiLin1ELi1ELi0ELin1ELi1EEC2IlEERKT_.exit.i: ; preds = %_ZN5Eigen8internal23check_size_for_overflowIiEEvm.exit.i.i.i.i.i.i, %bb.p
  ...
  br i1 %i.bu, label %.lr.ph.i, label %.loopexit521
...
begin_hunk_1_@_ZN5Eigen8SparseQRINS_12SparseMatrixIdLi0EiEENS_14COLAMDOrderingIiEEE9factorizeERKS2_:bb.a
  %i.gs = getelementptr inbounds nuw [4 x i8], ptr %i.fl, i64 %indvars.iv614
  %i.gt = load i32, ptr %i.gs, align 4, !tbaa !104 ; 3 uses
  %.0.i.i.i.us.i.i.i.us = zext i32 %i.gt to i64   ; 2 uses
  %i.gu = icmp sgt i32 %i.gt, 0
  br i1 %i.gu, label %.lr.ph.us.i.i.i.us.preheader, label %.loopexit517.us

.lr.ph.us.i.i.i.us.preheader:                     ; preds = %.split.us.split.i.i.i.us
  %xtraiter776 = and i64 %.0.i.i.i.us.i.i.i.us, 3 ; 3 uses
...
.lr.ph.us.i.i.i.us.preheader.new:                 ; preds = %.lr.ph.us.i.i.i.us.preheader
  %unroll_iter781 = and i64 %.0.i.i.i.us.i.i.i.us, 2147483644
...
.lr.ph.us.i.i.i.us:                               ; preds = %.lr.ph.us.i.i.i.us, %.lr.ph.us.i.i.i.us.preheader.new
  ...
  %niter782 = phi i64 [ 0, %.lr.ph.us.i.i.i.us.preheader.new ], [ %niter782.next.3, %.lr.ph.us.i.i.i.us ]
  ...
  br i1 %niter782.ncmp.3, label %.loopexit517.us.loopexit.unr-lcssa, label %.lr.ph.us.i.i.i.us

.loopexit517.us.loopexit.unr-lcssa:               ; preds = %.lr.ph.us.i.i.i.us
  %lcmp.mod778.not = icmp eq i64 %xtraiter776, 0
  br i1 %lcmp.mod778.not, label %.loopexit517.us, label %.lr.ph.us.i.i.i.us.epil.preheader

.lr.ph.us.i.i.i.us.epil.preheader:                ; preds = %.loopexit517.us.loopexit.unr-lcssa, %.lr.ph.us.i.i.i.us.preheader
  %.117.us.i.i.i.us.epil.init = phi double [ 0.000000e+00, %.lr.ph.us.i.i.i.us.preheader ], [ %i.ho, %.loopexit517.us.loopexit.unr-lcssa ]
  %.sroa.611.016.us.i.i.i.us.epil.init = phi i64 [ 0, %.lr.ph.us.i.i.i.us.preheader ], [ %i.hp, %.loopexit517.us.loopexit.unr-lcssa ]
...
.lr.ph.us.i.i.i.us.epil:                          ; preds = %.lr.ph.us.i.i.i.us.epil, %.lr.ph.us.i.i.i.us.epil.preheader
  ...
  %epil.iter777 = phi i64 [ %epil.iter777.next, %.lr.ph.us.i.i.i.us.epil ], [ 0, %.lr.ph.us.i.i.i.us.epil.preheader ]
  ...
  br i1 %epil.iter777.cmp.not, label %.loopexit517.us, label %.lr.ph.us.i.i.i.us.epil, !llvm.loop !317

.loopexit517.us:                                  ; preds = %.loopexit517.us.loopexit.unr-lcssa, %.lr.ph.us.i.i.i.us.epil, %.split.us.split.i.i.i.us
  %.us-phi.i.i.i.us = phi double [ 0.000000e+00, %.split.us.split.i.i.i.us ], [ %i.ho, %.loopexit517.us.loopexit.unr-lcssa ], [ %i.ht, %.lr.ph.us.i.i.i.us.epil ]
  %i.hv = tail call noundef double @sqrt(double noundef %.us-phi.i.i.i.us) #33 ; 2 uses
  %i.hw = fcmp olt double %.0451537.us, %i.hv
  %.sroa.speculated.us = select i1 %i.hw, double %i.hv, double %.0451537.us ; 2 uses
  ...
  br i1 %exitcond618.not, label %._crit_edge540, label %.split.us.split.i.i.i.us, !llvm.loop !318

bb.z:                                             ; preds = %bb.ad, %.lr.ph.new
  %indvars.iv = phi i64 [ 0, %.lr.ph.new ], [ %indvars.iv.next.1, %bb.ad ] ; 5 uses
  %niter775 = phi i64 [ 0, %.lr.ph.new ], [ %niter775.next.1, %bb.ad ]
...
bb.ad:                                            ; preds = %bb.ac, %bb.ab
  ...
  %niter775.next.1 = add i64 %niter775, 2         ; 2 uses
  %niter775.ncmp.1 = icmp eq i64 %niter775.next.1, %unroll_iter774
  br i1 %niter775.ncmp.1, label %._crit_edge.unr-lcssa, label %bb.z, !llvm.loop !319

._crit_edge540:                                   ; preds = %.loopexit518, %.loopexit517.us, %._crit_edge.thread
  %.0451.lcssa = phi double [ %.sroa.speculated.us, %.loopexit517.us ], [ 0.000000e+00, %._crit_edge.thread ], [ %.sroa.speculated, %.loopexit518 ] ; 2 uses
  %i.iv = fcmp oeq double %.0451.lcssa, 0.000000e+00
  %.1452 = select i1 %i.iv, double 1.000000e+00, double %.0451.lcssa
  %i.iw = add nsw i32 %i.f, %i.c
  %i.ix = mul nsw i32 %i.iw, 20
  %i.iy = sitofp i32 %i.ix to double
  %i.iz = fmul double %.1452, %i.iy
  %i.ja = fmul double %i.iz, f0x3CB0000000000000
  br label %bb.ae

.split.i.i.i:                                     ; preds = %.lr.ph539, %.loopexit518
  %indvars.iv609 = phi i64 [ %indvars.iv.next610, %.loopexit518 ], [ 0, %.lr.ph539 ] ; 3 uses
  %.0451537 = phi double [ %.sroa.speculated, %.loopexit518 ], [ 0.000000e+00, %.lr.ph539 ] ; 2 uses
  %i.jb = getelementptr inbounds nuw [4 x i8], ptr %i.gq, i64 %indvars.iv609
  %i.jc = load i32, ptr %i.jb, align 4, !tbaa !104
  %i.jd = getelementptr inbounds nuw [4 x i8], ptr %i.fl, i64 %indvars.iv609
  ...
  br i1 %i.ji, label %.lr.ph.i.i.i, label %.loopexit518
...
.lr.ph.i.i.i:                                     ; preds = %.split.i.i.i, %.lr.ph.i.i.i
  ...
  br i1 %i.jo, label %.lr.ph.i.i.i, label %.loopexit518

.loopexit518:                                     ; preds = %.lr.ph.i.i.i, %.split.i.i.i
  ...
  %i.jq = fcmp olt double %.0451537, %i.jp
  %.sroa.speculated = select i1 %i.jq, double %i.jp, double %.0451537 ; 2 uses
  %indvars.iv.next610 = add nuw nsw i64 %indvars.iv609, 1 ; 2 uses
  %exitcond613.not = icmp eq i64 %indvars.iv.next610, %wide.trip.count617
  br i1 %exitcond613.not, label %._crit_edge540, label %.split.i.i.i, !llvm.loop !318

bb.ae:                                            ; preds = %._crit_edge.thread, %._crit_edge540, %._crit_edge
  %.0171 = phi double [ %i.ja, %._crit_edge540 ], [ %i.af, %._crit_edge ], [ %i.af, %._crit_edge.thread ]
...
bb.af:                                            ; preds = %bb.ae
  ...
  br i1 %i.n, label %.lr.ph597, label %.thread497

.lr.ph597:                                        ; preds = %bb.af
  %.idx.i.i.i.i.i.i.i.i.i.i274 = shl nuw nsw i64 %i.g, 2
  %i.jv = icmp slt i64 %sext507, 4294967296
  %.idx.i.i.i.i.i.i.i.i.i.i.i = lshr exact i64 %sext507, 29
  ...
  %sext510 = add nsw i64 %sext506, -4294967296
  %i.kg = ashr exact i64 %sext510, 32             ; 4 uses
  %wide.trip.count630 = and i64 %i.e, 2147483647
  br label %4

bb.ag:                                            ; preds = %._crit_edge589, %bb.cc, %bb.cd
  %.2167 = phi i32 [ %.0165594, %bb.cd ], [ %i.aan, %bb.cc ], [ %i.aan, %._crit_edge589 ] ; 2 uses
  ...
  br i1 %exitcond631.not, label %.thread497, label %4, !llvm.loop !320

4:                                                ; preds = %.lr.ph597, %bb.ag
  %indvars.iv627 = phi i64 [ 0, %.lr.ph597 ], [ %indvars.iv.next628, %bb.ag ] ; 13 uses
  %.0165594 = phi i32 [ 0, %.lr.ph597 ], [ %.2167, %bb.ag ] ; 12 uses
  br i1 %i.h, label %.loopexit516, label %.lr.ph.i.i.i.i.i.i.i.i.i.i.i.i275.preheader

.lr.ph.i.i.i.i.i.i.i.i.i.i.i.i275.preheader:      ; preds = %4
  tail call void @llvm.memset.p0.i64(ptr align 4 %.sroa.0403.0454, i8 -1, i64 %.idx.i.i.i.i.i.i.i.i.i.i274, i1 false), !tbaa !104
  br label %.loopexit516

.loopexit516:                                     ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i.i.i.i275.preheader, %4
  %i.kh = load ptr, ptr %i.ai, align 8, !tbaa !145
  %i.ki = getelementptr inbounds nuw [4 x i8], ptr %i.kh, i64 %indvars.iv627 ; 2 uses
  %i.kj = load i32, ptr %i.ki, align 4, !tbaa !104
  %i.kk = getelementptr i8, ptr %i.ki, i64 4
  store i32 %i.kj, ptr %i.kk, align 4, !tbaa !104
  %i.kl = sext i32 %.0165594 to i64               ; 10 uses
  %i.km = getelementptr inbounds [4 x i8], ptr %.sroa.0403.0454, i64 %i.kl
  %i.kn = trunc nuw nsw i64 %indvars.iv627 to i32 ; 6 uses
  store i32 %i.kn, ptr %i.km, align 4, !tbaa !104
  store i32 %.0165594, ptr %.sroa.0380.0471, align 4, !tbaa !104
...
_ZN5Eigen9DenseBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEE11setConstantERKd.exit.loopexit.i: ; preds = %.loopexit516
...
_ZN5Eigen9DenseBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEE7setZeroEv.exit: ; preds = %_ZN5Eigen9DenseBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEE11setConstantERKd.exit.loopexit.i, %.loopexit516
  %i.ko = icmp sge i32 %.0165594, %i.c            ; 2 uses
  %i.kp = load ptr, ptr %i.jw, align 8, !tbaa !161
  %i.kq = load ptr, ptr %i.jx, align 8, !tbaa !162
  %i.kr = load ptr, ptr %i.jy, align 8, !tbaa !145
  %i.ks = getelementptr inbounds nuw [4 x i8], ptr %i.kr, i64 %indvars.iv627 ; 2 uses
...
bb.ai:                                            ; preds = %_ZN5Eigen9DenseBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEE7setZeroEv.exit
  %i.la = getelementptr inbounds nuw [4 x i8], ptr %i.kv, i64 %indvars.iv627
...
_ZN5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE13InnerIteratorC2ERKS3_l.exit: ; preds = %bb.ah, %bb.ai
  ...
  %.not509551 = select i1 %i.le, i1 %i.ko, i1 false
  br i1 %.not509551, label %.preheader514, label %.lr.ph556

.lr.ph556:                                        ; preds = %_ZN5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE13InnerIteratorC2ERKS3_l.exit
  %i.lf = load ptr, ptr %i.jz, align 8, !tbaa !78
  br label %bb.aj

bb.aj:                                            ; preds = %.lr.ph556, %bb.au
  %i.lg = phi i1 [ %i.le, %.lr.ph556 ], [ %i.np, %bb.au ] ; 2 uses
  %.0159555 = phi i1 [ %i.ko, %.lr.ph556 ], [ %spec.select, %bb.au ]
  %.0172554 = phi i64 [ 1, %.lr.ph556 ], [ %.2174, %bb.au ] ; 4 uses
  %.0176553 = phi i64 [ 0, %.lr.ph556 ], [ %.1177.lcssa, %bb.au ] ; 4 uses
  %.sroa.8337.0552 = phi i64 [ %i.ku, %.lr.ph556 ], [ %i.no, %bb.au ] ; 3 uses
  br i1 %i.lg, label %bb.al, label %bb.ak

bb.ak:                                            ; preds = %bb.aj
  %i.lh = getelementptr inbounds [4 x i8], ptr %i.kq, i64 %.sroa.8337.0552
...
bb.al:                                            ; preds = %bb.aj, %bb.ak
  ...
  %.0158 = phi i32 [ %.0165594, %bb.aj ], [ %i.li, %bb.ak ] ; 3 uses
  %i.lj = icmp eq i32 %.0158, %.0165594
  %spec.select = select i1 %i.lj, i1 true, i1 %.0159555 ; 2 uses
...
.preheader:                                       ; preds = %bb.al
  ...
  %i.lo = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0403.0454, i64 %i.ln ; 2 uses
  %i.lp = load i32, ptr %i.lo, align 4, !tbaa !104
  %i.lq = zext i32 %i.lp to i64
  %.not541 = icmp eq i64 %indvars.iv627, %i.lq
  br i1 %.not541, label %._crit_edge545, label %.lr.ph544
...
bb.am:                                            ; preds = %bb.al
  ...
  %i.lv = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %i.ls, i64 noundef 0, i64 noundef %i.lu, ptr noundef nonnull @.str.9, i64 noundef 46)
          to label %.thread495 unwind label %bb.an ; 0 uses
...
bb.ao:                                            ; preds = %.lr.ph544, %bb.ao
  %i.lx = phi ptr [ %i.lo, %.lr.ph544 ], [ %i.me, %bb.ao ]
  %i.ly = phi i64 [ %i.ln, %.lr.ph544 ], [ %i.md, %bb.ao ]
  %.0157543 = phi i32 [ %i.ll, %.lr.ph544 ], [ %i.mc, %bb.ao ]
  %.1177542 = phi i64 [ %.0176553, %.lr.ph544 ], [ %i.mb, %bb.ao ] ; 2 uses
  %i.lz = getelementptr inbounds [4 x i8], ptr %.sroa.0392.0, i64 %.1177542
  store i32 %.0157543, ptr %i.lz, align 4, !tbaa !104
  store i32 %i.kn, ptr %i.lx, align 4, !tbaa !104
  %i.ma = getelementptr inbounds [4 x i8], ptr %i.lr, i64 %i.ly
  %i.mb = add nsw i64 %.1177542, 1                ; 2 uses
  %i.mc = load i32, ptr %i.ma, align 4, !tbaa !104 ; 2 uses
  %i.md = sext i32 %i.mc to i64                   ; 2 uses
  %i.me = getelementptr inbounds [4 x i8], ptr %.sroa.0403.0454, i64 %i.md ; 2 uses
  %i.mf = load i32, ptr %i.me, align 4, !tbaa !104
  %i.mg = zext i32 %i.mf to i64
  %.not = icmp eq i64 %indvars.iv627, %i.mg
  br i1 %.not, label %._crit_edge545, label %bb.ao, !llvm.loop !321

._crit_edge545:                                   ; preds = %bb.ao, %.preheader
  %.1177.lcssa = phi i64 [ %.0176553, %.preheader ], [ %i.mb, %bb.ao ] ; 5 uses
  %i.mh = sub nsw i64 %.1177.lcssa, %.0176553     ; 3 uses
  %i.mi = lshr i64 %i.mh, 1                       ; 3 uses
  %i.mj = icmp sgt i64 %i.mh, 1
  br i1 %i.mj, label %.lr.ph549, label %._crit_edge550

.lr.ph549:                                        ; preds = %._crit_edge545
  %i.mk = getelementptr [4 x i8], ptr %.sroa.0392.0, i64 %.0176553 ; 3 uses
  %i.ml = getelementptr [4 x i8], ptr %.sroa.0392.0, i64 %.1177.lcssa ; 3 uses
  %i.mm = icmp eq i64 %i.mi, 1
  br i1 %i.mm, label %.epil.preheader783, label %.lr.ph549.new

.lr.ph549.new:                                    ; preds = %.lr.ph549
  %unroll_iter788 = and i64 %i.mi, 4611686018427387902
  br label %bb.ap

._crit_edge550.loopexit.unr-lcssa:                ; preds = %bb.ap
  %i.mn = and i64 %i.mh, 2
  %lcmp.mod786.not = icmp eq i64 %i.mn, 0
  br i1 %lcmp.mod786.not, label %._crit_edge550, label %.epil.preheader783

.epil.preheader783:                               ; preds = %._crit_edge550.loopexit.unr-lcssa, %.lr.ph549
  %.0156547.epil.init = phi i64 [ 0, %.lr.ph549 ], [ %i.ne, %._crit_edge550.loopexit.unr-lcssa ] ; 2 uses
  %lcmp.mod787 = trunc i64 %i.mi to i1
  tail call void @llvm.assume(i1 %lcmp.mod787)
  %i.mo = getelementptr [4 x i8], ptr %i.mk, i64 %.0156547.epil.init ; 2 uses
  %i.mp = xor i64 %.0156547.epil.init, -1
...
._crit_edge550:                                   ; preds = %.epil.preheader783, %._crit_edge550.loopexit.unr-lcssa, %._crit_edge545
  br i1 %i.lg, label %bb.ar, label %bb.aq

bb.ap:                                            ; preds = %bb.ap, %.lr.ph549.new
  %.0156547 = phi i64 [ 0, %.lr.ph549.new ], [ %i.ne, %bb.ap ] ; 5 uses
  %niter789 = phi i64 [ 0, %.lr.ph549.new ], [ %niter789.next.1, %bb.ap ]
  %i.mt = getelementptr [4 x i8], ptr %i.mk, i64 %.0156547 ; 2 uses
  %i.mu = xor i64 %.0156547, -1
  ...
  %i.my = getelementptr [4 x i8], ptr %i.mk, i64 %.0156547
  %i.mz = getelementptr i8, ptr %i.my, i64 4      ; 2 uses
  %i.na = xor i64 %.0156547, -2
  ...
  %i.ne = add nuw nsw i64 %.0156547, 2            ; 2 uses
  %niter789.next.1 = add i64 %niter789, 2         ; 2 uses
  %niter789.ncmp.1 = icmp eq i64 %niter789.next.1, %unroll_iter788
  br i1 %niter789.ncmp.1, label %._crit_edge550.loopexit.unr-lcssa, label %bb.ap, !llvm.loop !322

bb.aq:                                            ; preds = %._crit_edge550
  %i.nf = getelementptr inbounds [8 x i8], ptr %i.kp, i64 %.sroa.8337.0552
  %i.ng = load double, ptr %i.nf, align 8, !tbaa !152
  br label %bb.ar

bb.ar:                                            ; preds = %._crit_edge550, %bb.aq
  %.sink = phi double [ %i.ng, %bb.aq ], [ 0.000000e+00, %._crit_edge550 ]
  %i.nh = getelementptr inbounds [8 x i8], ptr %.sroa.0363.0, i64 %.pre-phi
  store double %.sink, ptr %i.nh, align 8, !tbaa !152
  %i.ni = icmp sgt i32 %.0158, %.0165594
  br i1 %i.ni, label %bb.as, label %bb.au

bb.as:                                            ; preds = %bb.ar
  %i.nj = getelementptr inbounds [4 x i8], ptr %.sroa.0403.0454, i64 %.pre-phi ; 2 uses
  %i.nk = load i32, ptr %i.nj, align 4, !tbaa !104
  %i.nl = zext i32 %i.nk to i64
  %.not214 = icmp eq i64 %indvars.iv627, %i.nl
  br i1 %.not214, label %bb.au, label %bb.at

bb.at:                                            ; preds = %bb.as
  %i.nm = getelementptr inbounds [4 x i8], ptr %.sroa.0380.0471, i64 %.0172554
  store i32 %.0158, ptr %i.nm, align 4, !tbaa !104
  store i32 %i.kn, ptr %i.nj, align 4, !tbaa !104
  %i.nn = add nsw i64 %.0172554, 1
  br label %bb.au

bb.au:                                            ; preds = %bb.at, %bb.as, %bb.ar
  %.2174 = phi i64 [ %.0172554, %bb.ar ], [ %i.nn, %bb.at ], [ %.0172554, %bb.as ] ; 3 uses
  %i.no = add nsw i64 %.sroa.8337.0552, 1         ; 2 uses
  %i.np = icmp sge i64 %i.no, %.sink.i            ; 2 uses
  %.not509 = select i1 %i.np, i1 %spec.select, i1 false
  br i1 %.not509, label %.thread490, label %bb.aj, !llvm.loop !323

.thread490:                                       ; preds = %bb.au
  %i.nq = add nsw i64 %.1177.lcssa, -1            ; 2 uses
  %i.nr = icmp sgt i64 %.1177.lcssa, 0            ; 4 uses
  br i1 %i.nr, label %.lr.ph569, label %._crit_edge570

.lr.ph569:                                        ; preds = %.thread490
...
._crit_edge570:                                   ; preds = %.loopexit, %.thread490
  %.4.lcssa = phi i64 [ %.2174, %.thread490 ], [ %.7, %.loopexit ] ; 9 uses
  %.not725 = icmp sge i32 %.0165594, %.sroa.speculated430 ; 2 uses
  br i1 %.not725, label %bb.bo, label %bb.bk

bb.av:                                            ; preds = %.lr.ph569, %.loopexit
  %i.oa = phi ptr [ %i.nx, %.lr.ph569 ], [ %i.ov, %.loopexit ] ; 3 uses
  %.0155568 = phi i64 [ %i.nq, %.lr.ph569 ], [ %i.ua, %.loopexit ] ; 3 uses
  %.4567 = phi i64 [ %.2174, %.lr.ph569 ], [ %.7, %.loopexit ] ; 6 uses
  %i.ob = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0392.0, i64 %.0155568
