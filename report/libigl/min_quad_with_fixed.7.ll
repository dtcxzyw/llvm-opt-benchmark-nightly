...
.epil.preheader:                                  ; preds = %.loopexit104.loopexit.unr-lcssa, %.lr.ph114
  ...
  %lcmp.mod133 = trunc i64 %i.cd to i1
...
.lr.ph118.preheader:                              ; preds = %.loopexit104
  ...
  br i1 %min.iters.check, label %.lr.ph118.preheader132, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load131 = load <2 x double>, ptr %i.dh, align 8, !tbaa !152
  %i.di = fmul <2 x double> %broadcast.splat, %wide.load
  %i.dj = fmul <2 x double> %broadcast.splat, %wide.load131
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %.loopexit, label %.lr.ph118.preheader132

.lr.ph118.preheader132:                           ; preds = %.lr.ph118.preheader, %middle.block
  %.0116.ph = phi i64 [ %.0115, %.lr.ph118.preheader ], [ %i.de, %middle.block ]
  br label %.lr.ph118

.lr.ph118:                                        ; preds = %.lr.ph118.preheader132, %.lr.ph118
  %.0116 = phi i64 [ %.0, %.lr.ph118 ], [ %.0116.ph, %.lr.ph118.preheader132 ] ; 2 uses
