...
_ZNK4CGAL20CommonKernelFunctors18Construct_vertex_3INS_16Simple_cartesianINS_11Interval_ntILb0EEEEEEclERKNS_10Triangle_3IS5_EEi.exit.i: ; preds = %bb.h, %bb.g, %bb.f
  ...
  store ptr null, ptr %i.ab, align 8, !tbaa !7119
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %.1108 = phi i64 [ %i.eh, %scalar.ph ], [ %.1108.ph, %scalar.ph.preheader ] ; 3 uses
  %i.du = xor i64 %.1108, -1
  %i.dv = add i64 %.187, %i.du                    ; 2 uses
  %i.dw = sub i64 %i.dv, %i.b
  %i.dx = getelementptr inbounds nuw [8 x i8], ptr %i.at, i64 %i.dw
  %i.dy = load i64, ptr %i.dx, align 8, !tbaa !6973
  %i.dz = shl i64 %i.dy, %i.d                     ; 2 uses
  %i.ea = getelementptr inbounds nuw [8 x i8], ptr %i.at, i64 %i.dv ; 2 uses
  store i64 %i.dz, ptr %i.ea, align 8, !tbaa !6973
  %i.eb = add i64 %.1108, %i.b
  %i.ec = sub i64 %invariant.op, %i.eb
  %i.ed = getelementptr inbounds nuw [8 x i8], ptr %i.at, i64 %i.ec
  %i.ee = load i64, ptr %i.ed, align 8, !tbaa !6973
  %i.ef = lshr i64 %i.ee, %i.ce
  %i.eg = or disjoint i64 %i.ef, %i.dz
  store i64 %i.eg, ptr %i.ea, align 8, !tbaa !6973
  %i.eh = add i64 %.1108, 1                       ; 3 uses
  %i.ei = sub nsw i64 %.187, %i.eh                ; 2 uses
  %.not96 = icmp slt i64 %i.ei, %i.cc
  br i1 %.not96, label %._crit_edge, label %scalar.ph, !llvm.loop !7323

._crit_edge:                                      ; preds = %scalar.ph, %middle.block, %bb.u
  %.1.lcssa = phi i64 [ %.0, %bb.u ], [ %i.db, %middle.block ], [ %i.eh, %scalar.ph ] ; 3 uses
  %.lcssa = phi i64 [ %i.cd, %bb.u ], [ %i.dt, %middle.block ], [ %i.ei, %scalar.ph ]
  %i.ej = add i64 %i.b, 1
  %.not97 = icmp ult i64 %.lcssa, %i.ej
  br i1 %.not97, label %bb.w, label %bb.v

bb.v:                                             ; preds = %._crit_edge
  %i.ek = xor i64 %.1.lcssa, -1
  %i.el = add i64 %.187, %i.ek                    ; 2 uses
  %i.em = sub i64 %i.el, %i.b
  %i.en = getelementptr inbounds nuw [8 x i8], ptr %i.at, i64 %i.em
  %i.eo = load i64, ptr %i.en, align 8, !tbaa !6973
  %i.ep = shl i64 %i.eo, %i.d
  %i.eq = getelementptr inbounds nuw [8 x i8], ptr %i.at, i64 %i.el
  store i64 %i.ep, ptr %i.eq, align 8, !tbaa !6973
  %i.er = add i64 %.1.lcssa, 1
  br label %bb.w

bb.w:                                             ; preds = %bb.v, %._crit_edge
  %.2 = phi i64 [ %i.er, %bb.v ], [ %.1.lcssa, %._crit_edge ]
  %i.es = sub i64 %.187, %.2
  %i.et = shl i64 %i.es, 3
  tail call void @llvm.memset.p0.i64(ptr align 8 %i.at, i8 0, i64 %i.et, i1 false)
  br label %bb.x
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr %i.s, ptr %i.t, align 8, !tbaa !7324
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr null, ptr %i.v, align 8, !tbaa !7119
...
.noexc:                                           ; preds = %bb.b
  ...
  %i.ad = getelementptr inbounds nuw i8, ptr %i.m, i64 80
  store ptr %i.ac, ptr %i.ad, align 8, !tbaa !10291
  %i.ae = getelementptr inbounds nuw i8, ptr %i.m, i64 88
