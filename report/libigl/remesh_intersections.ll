...
bb.j:                                             ; preds = %bb.i
  store i8 0, ptr %i.ar, align 8, !tbaa !863
...
bb.l:                                             ; preds = %bb.k
  ...
  store i8 0, ptr %i.bd, align 8, !tbaa !863
  br label %_ZN5boost14multiprecision8backends12cpp_int_baseILm0ELm18446744073709551615ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyELb0EE4signEb.exit
...
bb.n:                                             ; preds = %bb.m
  ...
  store i64 %i.bg, ptr %i.ab, align 8, !tbaa !856
  %i.bh = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.bi = load i8, ptr %i.bh, align 8, !tbaa !863, !range !392, !noundef !393 ; 2 uses
  %i.bj = trunc nuw i8 %i.bi to i1
  %i.bk = xor i8 %i.bi, 1
  %i.bl = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 2 uses
  store i8 %i.bk, ptr %i.bl, align 8, !tbaa !863
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.bq = load i64, ptr %i.bp, align 8, !tbaa !856
...
bb.p:                                             ; preds = %bb.o
  store i8 0, ptr %i.bl, align 8, !tbaa !863
  br label %_ZN5boost14multiprecision8backends12cpp_int_baseILm0ELm18446744073709551615ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyELb0EE4signEb.exit

bb.q:                                             ; preds = %bb.m
  %i.bs = sub i64 %i.ai, %i.aj
  store i64 %i.bs, ptr %i.ab, align 8, !tbaa !856
  %i.bt = getelementptr inbounds nuw i8, ptr %i.ah, i64 8
  %i.bu = load i64, ptr %i.bt, align 8, !tbaa !856 ; 2 uses
...
.lr.ph:                                           ; preds = %bb.q, %.lr.ph
  ...
  store i64 -1, ptr %i.bv, align 8, !tbaa !856
  %i.bw = add i64 %.069, 1                        ; 3 uses
  %i.bx = getelementptr inbounds nuw [8 x i8], ptr %i.ah, i64 %i.bw
  %i.by = load i64, ptr %i.bx, align 8, !tbaa !856 ; 2 uses
...
._crit_edge:                                      ; preds = %.lr.ph, %bb.q
  ...
  store i64 %i.bz, ptr %i.ca, align 8, !tbaa !856
...
bb.r:                                             ; preds = %._crit_edge
  ...
  %i.cd = load i64, ptr %i.a, align 16, !tbaa !854
  ...
  %.pre77 = load i8, ptr %i.c, align 1, !tbaa !391, !range !392
  %.promoted.pre = load i64, ptr %i.be, align 16, !tbaa !854
...
_ZN5boost14multiprecision8backends12cpp_int_baseILm0ELm18446744073709551615ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyELb0EE9normalizeEv.exit.thread: ; preds = %.lr.ph73
  ...
  %i.cn = load i8, ptr %i.cm, align 8, !tbaa !863, !range !392, !noundef !393
  %i.co = getelementptr inbounds nuw i8, ptr %0, i64 24
  store i8 %i.cn, ptr %i.co, align 8, !tbaa !863
  br label %_ZN5boost14multiprecision8backends12cpp_int_baseILm0ELm18446744073709551615ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyELb0EE4signEb.exit

bb.t:                                             ; preds = %.lr.ph73
  store i64 %i.cj, ptr %i.be, align 16, !tbaa !854
...
_ZN5boost14multiprecision8backends12cpp_int_baseILm0ELm18446744073709551615ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyELb0EE9normalizeEv.exit: ; preds = %bb.t, %bb.s
  ...
  %i.cr = load i8, ptr %i.cq, align 8, !tbaa !863, !range !392, !noundef !393 ; 2 uses
  %i.cs = trunc nuw i8 %i.cr to i1
  %i.ct = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 2 uses
  store i8 %i.cr, ptr %i.ct, align 8, !tbaa !863
...
bb.u:                                             ; preds = %_ZN5boost14multiprecision8backends12cpp_int_baseILm0ELm18446744073709551615ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyELb0EE9normalizeEv.exit
  %i.cu = load i64, ptr %i.ch, align 8, !tbaa !856
...
bb.v:                                             ; preds = %bb.u
  store i8 0, ptr %i.ct, align 8, !tbaa !863
  br label %_ZN5boost14multiprecision8backends12cpp_int_baseILm0ELm18446744073709551615ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyELb0EE4signEb.exit
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.b = load i64, ptr %i.a, align 16, !tbaa !854
  ...
  %i.d = load i8, ptr %i.c, align 1, !tbaa !391, !range !392, !noundef !393
...
_ZNSt15__new_allocatorIyE8allocateEmPKv.exit.i:   ; preds = %bb.b
  ...
  %i.k = load i8, ptr %i.c, align 1, !tbaa !391, !range !392, !noundef !393
  %i.l = trunc nuw i8 %i.k to i1                  ; 2 uses
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.n = load ptr, ptr %i.m, align 8              ; 2 uses
  %i.o = select i1 %i.l, ptr %0, ptr %i.n
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.q = load i64, ptr %i.p, align 16, !tbaa !854
  %i.r = shl i64 %i.q, 3
...
bb.c:                                             ; preds = %_ZNSt15__new_allocatorIyE8allocateEmPKv.exit.i
  ...
  %i.t = load i8, ptr %i.s, align 2, !tbaa !864, !range !392, !noundef !393
...
bb.e:                                             ; preds = %bb.c, %_ZNSt15__new_allocatorIyE8allocateEmPKv.exit.i
  store i8 0, ptr %i.c, align 1, !tbaa !391
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.d
  store i64 %spec.select.i, ptr %i.p, align 16, !tbaa !854
  store i64 %.sroa.speculated.i, ptr %0, align 16, !tbaa !439
  store ptr %i.j, ptr %i.m, align 8, !tbaa !439
...
bb.g:                                             ; preds = %bb.b
  ...
  store i64 %spec.select.i, ptr %i.x, align 16, !tbaa !854
  br label %_ZN5boost14multiprecision8backends12cpp_int_baseILm0ELm18446744073709551615ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyELb0EE6resizeEmm.exit
...
_ZN5boost14multiprecision8backends12cpp_int_baseILm0ELm18446744073709551615ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyELb0EE6resizeEmm.exit: ; preds = %bb.g, %bb.f, %bb.a
  %i.y = load i64, ptr %2, align 8, !tbaa !856    ; 4 uses
  %i.z = getelementptr inbounds nuw i8, ptr %0, i64 25 ; 5 uses
  %i.aa = load i8, ptr %i.z, align 1, !tbaa !391, !range !392, !noundef !393 ; 2 uses
...
.lr.ph86.peel.newph:                              ; preds = %bb.h, %bb.i
  ...
  %i.ap = load i64, ptr %i.ao, align 8, !tbaa !856 ; 2 uses
  %i.aq = add i64 %i.ap, 1
  %i.ar = getelementptr inbounds nuw [8 x i8], ptr %i.ae, i64 %.05484
  store i64 %i.aq, ptr %i.ar, align 8, !tbaa !856
...
bb.j:                                             ; preds = %.critedge
  ...
  %i.av = load i64, ptr %i.au, align 16, !tbaa !854
  ...
  %.pre66.pre = load i8, ptr %i.z, align 1, !tbaa !391, !range !392
  br label %bb.k
...
bb.k:                                             ; preds = %bb.j, %.critedge
  ...
  %.promoted.pre = load i64, ptr %.phi.trans.insert, align 16, !tbaa !854 ; 4 uses
...
_ZNSt15__new_allocatorIyE8allocateEmPKv.exit.i46: ; preds = %bb.l
  ...
  %i.bf = load i8, ptr %i.z, align 1, !tbaa !391, !range !392, !noundef !393
  %i.bg = trunc nuw i8 %i.bf to i1                ; 2 uses
  %i.bh = load ptr, ptr %i.ac, align 8            ; 2 uses
  %i.bi = select i1 %i.bg, ptr %0, ptr %i.bh
  %i.bj = load i64, ptr %.phi.trans.insert, align 16, !tbaa !854
  %i.bk = shl i64 %i.bj, 3
...
bb.m:                                             ; preds = %_ZNSt15__new_allocatorIyE8allocateEmPKv.exit.i46
  ...
  %i.bm = load i8, ptr %i.bl, align 2, !tbaa !864, !range !392, !noundef !393
...
bb.n:                                             ; preds = %bb.m
  ...
  %.pre.pre.pre = load i8, ptr %i.z, align 1, !tbaa !391, !range !392
  br label %bb.p

bb.o:                                             ; preds = %bb.m, %_ZNSt15__new_allocatorIyE8allocateEmPKv.exit.i46
  store i8 0, ptr %i.z, align 1, !tbaa !391
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %bb.n
  %.pre.pre = phi i8 [ 0, %bb.o ], [ %.pre.pre.pre, %bb.n ]
  store i64 %spec.select.i44, ptr %.phi.trans.insert, align 16, !tbaa !854
  store i64 %.sroa.speculated.i48, ptr %0, align 16, !tbaa !439
  store ptr %i.be, ptr %i.ac, align 8, !tbaa !439
...
bb.r:                                             ; preds = %_ZN5boost14multiprecision8backends12cpp_int_baseILm0ELm18446744073709551615ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyELb0EE6resizeEmm.exit49
  ...
  store i64 %.039.lcssa.off0, ptr %i.bu, align 8, !tbaa !856
  br label %._crit_edge
...
.lr.ph63:                                         ; preds = %._crit_edge, %bb.s
  ...
  %i.cd = load i64, ptr %i.cc, align 8, !tbaa !856
...
_ZN5boost14multiprecision8backends12cpp_int_baseILm0ELm18446744073709551615ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyELb0EE9normalizeEv.exit.thread: ; preds = %.lr.ph63
  ...
  %i.cf = load i8, ptr %i.ce, align 8, !tbaa !863, !range !392, !noundef !393
  %i.cg = getelementptr inbounds nuw i8, ptr %0, i64 24
  store i8 %i.cf, ptr %i.cg, align 8, !tbaa !863
  br label %_ZN5boost14multiprecision8backends12cpp_int_baseILm0ELm18446744073709551615ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyELb0EE4signEb.exit

bb.s:                                             ; preds = %.lr.ph63
  store i64 %i.cb, ptr %i.bz, align 16, !tbaa !854
...
_ZN5boost14multiprecision8backends12cpp_int_baseILm0ELm18446744073709551615ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyELb0EE9normalizeEv.exit: ; preds = %bb.s, %._crit_edge
  ...
  %i.cj = load i8, ptr %i.ci, align 8, !tbaa !863, !range !392, !noundef !393 ; 2 uses
  %i.ck = trunc nuw i8 %i.cj to i1
  %i.cl = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 2 uses
  store i8 %i.cj, ptr %i.cl, align 8, !tbaa !863
...
bb.t:                                             ; preds = %_ZN5boost14multiprecision8backends12cpp_int_baseILm0ELm18446744073709551615ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyELb0EE9normalizeEv.exit
  %i.cm = load i64, ptr %i.by, align 8, !tbaa !856
...
bb.u:                                             ; preds = %bb.t
  store i8 0, ptr %i.cl, align 8, !tbaa !863
  br label %_ZN5boost14multiprecision8backends12cpp_int_baseILm0ELm18446744073709551615ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyELb0EE4signEb.exit
...
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.b = load i64, ptr %i.a, align 16, !tbaa !854 ; 6 uses
  %i.c = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.d = load i64, ptr %i.c, align 16, !tbaa !854 ; 4 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = load i8, ptr %i.f, align 8, !tbaa !863, !range !392, !noundef !393
  %i.h = trunc nuw i8 %i.g to i1
  %i.i = getelementptr inbounds nuw i8, ptr %1, i64 25
  %i.j = load i8, ptr %i.i, align 1, !tbaa !391, !range !392, !noundef !393
  %i.k = trunc nuw i8 %i.j to i1
  %i.l = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.m = load ptr, ptr %i.l, align 8
  %i.n = select i1 %i.k, ptr %1, ptr %i.m
  %i.o = load i64, ptr %i.n, align 8, !tbaa !856  ; 3 uses
  %i.p = getelementptr inbounds nuw i8, ptr %2, i64 25
  %i.q = load i8, ptr %i.p, align 1, !tbaa !391, !range !392, !noundef !393
  %i.r = trunc nuw i8 %i.q to i1
  %i.s = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.t = load ptr, ptr %i.s, align 8
  %i.u = select i1 %i.r, ptr %2, ptr %i.t
  %i.v = load i64, ptr %i.u, align 8, !tbaa !856  ; 3 uses
  ...
  %i.z = load i8, ptr %i.y, align 1, !tbaa !391, !range !392, !noundef !393
