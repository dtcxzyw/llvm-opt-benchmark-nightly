...
vector.body:                                      ; preds = %.preheader.i.i.i.i.i.i.i.i.i.i, %vector.body
  ...
  %wide.load = load <2 x double>, ptr %i.bl, align 8, !tbaa !47, !alias.scope !234
  %wide.load170 = load <2 x double>, ptr %i.bm, align 8, !tbaa !47, !alias.scope !234
  %i.bn = getelementptr i8, ptr %i.bk, i64 16
  store <2 x double> %wide.load, ptr %i.bk, align 8, !tbaa !47, !alias.scope !235, !noalias !234
  store <2 x double> %wide.load170, ptr %i.bn, align 8, !tbaa !47, !alias.scope !235, !noalias !234
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.bo = icmp eq i64 %index.next, %n.vec
  br i1 %i.bo, label %middle.block, label %vector.body, !llvm.loop !210
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  br i1 %prol.iter.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !211
...
._crit_edge.i.i.i.i.i.i.i.i.i.i:                  ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  ...
  br i1 %exitcond12.not.i.i.i.i.i.i.i.i.i.i, label %.loopexit131, label %.preheader.i.i.i.i.i.i.i.i.i.i, !llvm.loop !212
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  br i1 %exitcond.not.i.i.i.i.i.i.i.i.i.i.3, label %._crit_edge.i.i.i.i.i.i.i.i.i.i, label %scalar.ph, !llvm.loop !213
...
.loopexit131:                                     ; preds = %._crit_edge.i.i.i.i.i.i.i.i.i.i, %bb.f
  ...
  store ptr %i.cs, ptr %16, align 8, !tbaa !27, !alias.scope !236
  %i.ct = getelementptr inbounds nuw i8, ptr %16, i64 8
  store i64 %i.al, ptr %i.ct, align 8, !tbaa !28, !alias.scope !236
  %i.cu = getelementptr inbounds nuw i8, ptr %16, i64 16
  store i64 %i.z, ptr %i.cu, align 8, !tbaa !28, !alias.scope !236
  %i.cv = getelementptr inbounds nuw i8, ptr %16, i64 24
  store ptr %14, ptr %i.cv, align 8, !tbaa !30, !alias.scope !236
  %i.cw = getelementptr inbounds nuw i8, ptr %16, i64 32
  store i64 %i.z, ptr %i.cw, align 8, !tbaa !28, !alias.scope !236
  %i.cx = getelementptr inbounds nuw i8, ptr %16, i64 40
  store i64 0, ptr %i.cx, align 8, !tbaa !28, !alias.scope !236
  %i.cy = getelementptr inbounds nuw i8, ptr %16, i64 48
  store i64 %i.an, ptr %i.cy, align 8, !tbaa !33, !alias.scope !236
  call void @llvm.lifetime.start.p0(ptr nonnull %9) #20
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #20
  store ptr %i.aq, ptr %6, align 8, !tbaa !35
  %i.cz = getelementptr inbounds nuw i8, ptr %6, i64 8
  store i64 %i.ar, ptr %i.cz, align 8, !tbaa !36
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #20
  store ptr %i.cs, ptr %7, align 8, !tbaa !39
  %i.da = getelementptr inbounds nuw i8, ptr %7, i64 16
  store i64 %i.an, ptr %i.da, align 8, !tbaa !28
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #20
  store ptr %7, ptr %8, align 8, !tbaa !41
  %i.db = getelementptr inbounds nuw i8, ptr %8, i64 8
  store ptr %6, ptr %i.db, align 8, !tbaa !231
  %i.dc = getelementptr inbounds nuw i8, ptr %8, i64 16
  store ptr %9, ptr %i.dc, align 8, !tbaa !232
  %i.dd = getelementptr inbounds nuw i8, ptr %8, i64 24
  store ptr %16, ptr %i.dd, align 8, !tbaa !45
...
bb.g:                                             ; preds = %.loopexit131
  ...
  %i.de = load ptr, ptr %14, align 8, !tbaa !23, !noalias !237
  %i.df = getelementptr inbounds [8 x i8], ptr %i.de, i64 %i.z
  %i.dg = load i64, ptr %i.x, align 8, !tbaa !20, !noalias !237 ; 14 uses
...
.preheader.i.i.i.i.i.i.i.i.i.i.i.i.i:             ; preds = %.preheader.i.i.i.i.i.i.i.i.i.i.i.i.i, %.preheader.i.i.i.i.i.i.i.i.i.i.i.i.preheader.i.new
  ...
  br i1 %niter.ncmp.7, label %.loopexit.loopexit186.unr-lcssa, label %.preheader.i.i.i.i.i.i.i.i.i.i.i.i.i, !llvm.loop !218
...
.lr.ph47.i.preheader.i.i.i.i.i.i.i.i.i.i.i:       ; preds = %.preheader43.i.i.i.i.i.i.i.i.i.i.i.i
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(1) %scevgep.i, i8 0, i64 %25, i1 false), !tbaa !52
...
._crit_edge.i.i.i.i.i.i.i.i.i.i.i.i:              ; preds = %.lr.ph49.i.i.i.i.i.i.i.i.i.i.i.i, %.preheader.i.i.i.i.i.i.i.i.i.i.i.i
  ...
  br i1 %exitcond54.not.i.i.i.i.i.i.i.i.i.i.i.i, label %.loopexit, label %bb.i, !llvm.loop !219
...
.preheader.i.i.i.i.i.i.i.i.i.i.i.i.i.epil:        ; preds = %.preheader.i.i.i.i.i.i.i.i.i.i.i.i.i.epil, %.preheader.i.i.i.i.i.i.i.i.i.i.i.i.i.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %.loopexit, label %.preheader.i.i.i.i.i.i.i.i.i.i.i.i.i.epil, !llvm.loop !220
...
bb.j:                                             ; preds = %.loopexit
  %i.fn = load i64, ptr %i.w, align 8, !tbaa !24  ; 4 uses
  %i.fo = load i64, ptr %i.x, align 8, !tbaa !20  ; 4 uses
...
.invoke159:                                       ; preds = %_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit.i.i93, %bb.n, %bb.l
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.fz, align 8, !tbaa !22
...
.sink.split.i91:                                  ; preds = %_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit.i.i93, %bb.m
  ...
  store ptr %.sink.i92, ptr %17, align 8, !tbaa !23
  br label %.noexc77
...
.noexc77:                                         ; preds = %.sink.split.i91, %_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEE6resizeEll.exit.i.i.i.i.i.i
  store i64 %i.fn, ptr %i.fp, align 8, !tbaa !20
  store i64 %i.fo, ptr %i.fq, align 8, !tbaa !24
...
bb.r:                                             ; preds = %.loopexit
  ...
  store i32 0, ptr %i.gd, align 4, !tbaa !61
  ...
  store i64 0, ptr %i.gf, align 8, !tbaa !62
...
bb.u:                                             ; preds = %bb.t
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.gq, align 8, !tbaa !22
...
.lr.ph:                                           ; preds = %bb.t
  %i.gs = load ptr, ptr %i.gl, align 8, !tbaa !63 ; 2 uses
