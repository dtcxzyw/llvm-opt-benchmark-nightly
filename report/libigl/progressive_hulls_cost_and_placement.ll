...
_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEE6resizeEll.exit.i.i: ; preds = %bb.c
  ...
  %i.m = load ptr, ptr %16, align 8, !tbaa !13    ; 3 uses
...
_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit.i.i.i.i.i: ; preds = %_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit.i.i
  store ptr %i.w, ptr %17, align 8, !tbaa !19
  store i64 %i.q, ptr %i.r, align 8, !tbaa !20
  store i64 3, ptr %i.s, align 8, !tbaa !21
...
.lr.ph:                                           ; preds = %bb.h, %_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit.i.i.i.i.i142
  ...
  store ptr %.sink.i.i.i.i141, ptr %18, align 8, !tbaa !24
  %i.ak = getelementptr inbounds nuw i8, ptr %18, i64 8 ; 2 uses
  store i64 %i.q, ptr %i.ak, align 8, !tbaa !23
  %i.al = load ptr, ptr %2, align 8, !tbaa !96
  %i.am = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.an = load i64, ptr %i.am, align 8, !tbaa !97 ; 2 uses
  %i.ao = load ptr, ptr %1, align 8, !tbaa !19, !noalias !98 ; 3 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.aq = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.ar = load i64, ptr %i.aq, align 8, !tbaa !20 ; 20 uses
  %.idx.i.i.i.i.i.i.i.i.i.i = shl nsw i64 %i.ar, 4 ; 3 uses
  %.idx = shl i64 %i.an, 3
  %i.as = load i64, ptr %i.ap, align 8, !tbaa !21, !noalias !99 ; 15 uses
  ...
  %xtraiter651 = and i64 %i.as, 3                 ; 3 uses
  %i.be = icmp ult i64 %i.as, 4
  %unroll_iter655 = and i64 %i.as, 9223372036854775804
  %lcmp.mod653.not = icmp eq i64 %xtraiter651, 0
  %lcmp.mod654 = icmp ne i64 %xtraiter651, 0
  %xtraiter657 = and i64 %i.as, 3                 ; 3 uses
  %i.bf = icmp ult i64 %i.as, 4
  %unroll_iter661 = and i64 %i.as, 9223372036854775804
  %lcmp.mod659.not = icmp eq i64 %xtraiter657, 0
  %lcmp.mod660 = icmp ne i64 %xtraiter657, 0
...
.lr.ph.i.i.i.i.i.i.i.i.i.i:                       ; preds = %.lr.ph, %._crit_edge.i150.thread
  ...
  %i.br = load i32, ptr %i.bm, align 4, !tbaa !25
  %i.bs = sext i32 %i.br to i64
  %i.bt = getelementptr inbounds [8 x i8], ptr %i.ao, i64 %i.bs ; 10 uses
  %i.bu = load double, ptr %i.bq, align 8, !tbaa !27
  %i.bv = load double, ptr %i.bt, align 8, !tbaa !27 ; 2 uses
  ...
  %i.cr = load double, ptr %i.cq, align 8, !tbaa !27
  ...
  store double %i.cv, ptr %i.dc, align 8, !tbaa !27
  %i.dd = getelementptr [8 x i8], ptr %i.dc, i64 %i.q ; 2 uses
  store double %i.cy, ptr %i.dd, align 8, !tbaa !27
  %i.de = getelementptr [8 x i8], ptr %i.dc, i64 %i.bc
  store double %i.db, ptr %i.de, align 8, !tbaa !27
  %i.df = load double, ptr %i.bt, align 8, !tbaa !27
  %i.dg = load double, ptr %i.dc, align 8, !tbaa !27
  %i.dh = fmul double %i.df, %i.dg
  %i.di = load double, ptr %i.bz, align 8, !tbaa !27
end_hunk_0
