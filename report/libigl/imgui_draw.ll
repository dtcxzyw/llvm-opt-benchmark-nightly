...
.lr.ph618:                                        ; preds = %bb.l
  ...
  %.pre663 = load ptr, ptr %i.cr, align 8, !tbaa !88
  br label %bb.n

.backedge:                                        ; preds = %.backedge.backedge, %.lr.ph612
  %indvars.iv631 = phi i64 [ 0, %.lr.ph612 ], [ %indvars.iv.next632, %.backedge.backedge ] ; 2 uses
  %.0432609 = phi i32 [ %i.cm, %.lr.ph612 ], [ %i.cw, %.backedge.backedge ] ; 3 uses
  %indvars.iv.next632 = add nuw nsw i64 %indvars.iv631, 1 ; 5 uses
  %i.cs = icmp eq i64 %indvars.iv.next632, %i.aj  ; 2 uses
  %i.ct = trunc nuw nsw i64 %indvars.iv.next632 to i32
  %i.cu = select i1 %i.cs, i32 0, i32 %i.ct       ; 2 uses
  %i.cv = add i32 %.0432609, %i.cn
  %i.cw = select i1 %i.cs, i32 %i.cm, i32 %i.cv   ; 3 uses
  %i.cx = getelementptr inbounds nuw [8 x i8], ptr %i.ai, i64 %indvars.iv631
  ...
  %foldExtExtBinop684 = fmul <2 x float> %i.dd, %i.dd
  %i.de = extractelement <2 x float> %foldExtExtBinop684, i64 1
...
bb.j:                                             ; preds = %.backedge
  ...
  %spec.store.select = select i1 %i.dj, float 1.000000e+02, float %i.di
  %i.dk = insertelement <2 x float> poison, float %spec.store.select, i64 0
...
bb.m:                                             ; preds = %.lr.ph616, %bb.m
  %i.fg = phi ptr [ %.pre, %.lr.ph616 ], [ %i.fu, %bb.m ]
  ...
  br i1 %exitcond640.not, label %.loopexit604, label %bb.m, !llvm.loop !100

bb.n:                                             ; preds = %.lr.ph618, %bb.n
  %i.fv = phi ptr [ %.pre663, %.lr.ph618 ], [ %i.gq, %bb.n ]
  %indvars.iv641 = phi i64 [ 0, %.lr.ph618 ], [ %indvars.iv.next642, %bb.n ] ; 3 uses
  %i.fw = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv641
  ...
  %i.gc = getelementptr inbounds nuw i8, ptr %i.ak, i64 %.idx674 ; 2 uses
  ...
  br i1 %exitcond646.not, label %.loopexit604, label %bb.n, !llvm.loop !101
...
bb.o:                                             ; preds = %bb.h
  ...
  %foldExtExtBinop686 = fsub <4 x float> %i.gx, %shift
  %shift696 = shufflevector <4 x float> %i.hb, <4 x float> poison, <4 x i32> <i32 poison, i32 3, i32 poison, i32 poison>
  %foldExtExtBinop697 = fsub <4 x float> %i.gx, %shift696
  %.sroa.0.0.vec.insert.i547 = shufflevector <4 x float> %foldExtExtBinop686, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %i.hg = shufflevector <4 x float> %foldExtExtBinop697, <4 x float> poison, <2 x i32> <i32 poison, i32 1>
  %.sroa.0.4.vec.insert.i548 = shufflevector <2 x float> %.sroa.0.0.vec.insert.i547, <2 x float> %i.hg, <2 x i32> <i32 0, i32 3>
  %i.hh = getelementptr inbounds nuw i8, ptr %i.ak, i64 16
  store <2 x float> %.sroa.0.4.vec.insert.i548, ptr %i.hh, align 8
  %foldExtExtBinop688 = fsub <4 x float> %i.gx, %i.hb
  %foldExtExtBinop690 = fsub <4 x float> %i.gx, %i.hb
  %.sroa.0.0.vec.insert.i551 = shufflevector <4 x float> %foldExtExtBinop688, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %i.hi = shufflevector <4 x float> %foldExtExtBinop690, <4 x float> poison, <2 x i32> <i32 poison, i32 1>
  %.sroa.0.4.vec.insert.i552 = shufflevector <2 x float> %.sroa.0.0.vec.insert.i551, <2 x float> %i.hi, <2 x i32> <i32 0, i32 3>
  %i.hj = getelementptr inbounds nuw i8, ptr %i.ak, i64 24
  store <2 x float> %.sroa.0.4.vec.insert.i552, ptr %i.hj, align 8
...
.lr.ph622:                                        ; preds = %bb.o, %.thread598
  %i.id = phi float [ %i.bl, %.thread598 ], [ %i.gs, %bb.o ] ; 2 uses
...
.lr.ph624:                                        ; preds = %bb.r
  ...
  %.pre664 = load ptr, ptr %i.il, align 8, !tbaa !88
  br label %bb.s

bb.p:                                             ; preds = %.lr.ph622, %bb.r
  %indvars.iv647 = phi i64 [ 0, %.lr.ph622 ], [ %indvars.iv.next648, %bb.r ] ; 2 uses
  %i.im = phi ptr [ %.promoted, %.lr.ph622 ], [ %i.kr, %bb.r ] ; 9 uses
  %.0423619 = phi i32 [ %i.if, %.lr.ph622 ], [ %spec.select, %bb.r ] ; 3 uses
  %indvars.iv.next648 = add nuw nsw i64 %indvars.iv647, 1 ; 4 uses
  %i.in = icmp eq i64 %indvars.iv.next648, %i.aj  ; 2 uses
  %i.io = trunc nuw nsw i64 %indvars.iv.next648 to i32
  %i.ip = select i1 %i.in, i32 0, i32 %i.io       ; 2 uses
  %i.iq = add i32 %.0423619, 4
  %spec.select = select i1 %i.in, i32 %i.if, i32 %i.iq ; 3 uses
  %i.ir = getelementptr inbounds nuw [8 x i8], ptr %i.ai, i64 %indvars.iv647
  ...
  %foldExtExtBinop692 = fmul <2 x float> %i.ix, %i.ix
  %i.iy = extractelement <2 x float> %foldExtExtBinop692, i64 1
...
bb.q:                                             ; preds = %bb.p
  ...
  %spec.store.select6 = select i1 %i.jd, float 1.000000e+02, float %i.jc
  %i.je = insertelement <2 x float> poison, float %spec.store.select6, i64 0
...
bb.r:                                             ; preds = %bb.q, %bb.p
  ...
  %i.ka = trunc i32 %.0423619 to i16              ; 3 uses
  ...
  br i1 %exitcond651.not, label %.lr.ph624, label %bb.p, !llvm.loop !102

bb.s:                                             ; preds = %.lr.ph624, %bb.s
  %i.ks = phi ptr [ %.pre664, %.lr.ph624 ], [ %i.lu, %bb.s ]
  %indvars.iv652 = phi i64 [ 0, %.lr.ph624 ], [ %indvars.iv.next653, %bb.s ] ; 2 uses
  %.idx675 = shl nuw nsw i64 %indvars.iv652, 5
  %i.kt = getelementptr inbounds nuw i8, ptr %i.ak, i64 %.idx675 ; 4 uses
  ...
  br i1 %exitcond657.not, label %.loopexit604, label %bb.s, !llvm.loop !103
...
bb.t:                                             ; preds = %.lr.ph627, %bb.v
  ...
  %i.mi = icmp eq i64 %indvars.iv.next659, %i.mf
  %i.mj = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv658 ; 3 uses
  %i.mk = select i1 %i.mi, i64 0, i64 %indvars.iv.next659
  ...
  %foldExtExtBinop694 = fmul <2 x float> %i.mq, %i.mq
  %i.mr = extractelement <2 x float> %foldExtExtBinop694, i64 1
