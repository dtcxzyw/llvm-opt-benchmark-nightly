Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/libigl/original/hessian_energy?download=true
...
.loopexit:                                        ; preds = %.lr.ph13.i59, %middle.block, %._crit_edge149, %.critedge.i56
  store i8 1, ptr %2, align 8, !tbaa !91
  %i.gd = invoke noundef nonnull align 8 dereferenceable(72) ptr @_ZN5Eigen12SparseMatrixIdLi1ElEaSERKS1_(ptr noundef nonnull align 8 dereferenceable(72) %0, ptr noundef nonnull align 8 dereferenceable(72) %2)
          to label %bb.ae unwind label %bb.ai     ; 0 uses

bb.ae:                                            ; preds = %.loopexit
  %i.ge = load ptr, ptr %i.cu, align 8, !tbaa !93
  call void @free(ptr noundef %i.ge) #19
  %i.gf = load ptr, ptr %i.da, align 8, !tbaa !98
  call void @free(ptr noundef %i.gf) #19
  %i.gg = load ptr, ptr %i.dd, align 8, !tbaa !99 ; 2 uses
  %i.gh = icmp eq ptr %i.gg, null
  br i1 %i.gh, label %bb.ag, label %bb.af

bb.af:                                            ; preds = %bb.ae
  call void @_ZdaPv(ptr noundef nonnull %i.gg) #22
  br label %bb.ag

bb.ag:                                            ; preds = %bb.af, %bb.ae
  %i.gi = getelementptr inbounds nuw i8, ptr %2, i64 48
  %i.gj = load ptr, ptr %i.gi, align 8, !tbaa !100 ; 2 uses
  %i.gk = icmp eq ptr %i.gj, null
  br i1 %i.gk, label %_ZN5Eigen12SparseMatrixIdLi1ElED2Ev.exit, label %bb.ah

bb.ah:                                            ; preds = %bb.ag
  call void @_ZdaPv(ptr noundef nonnull %i.gj) #22
  br label %_ZN5Eigen12SparseMatrixIdLi1ElED2Ev.exit

_ZN5Eigen12SparseMatrixIdLi1ElED2Ev.exit:         ; preds = %bb.ag, %bb.ah
...
.body84:                                          ; preds = %.loopexit134, %.loopexit.split-lp, %_ZN5Eigen8internal12scoped_arrayIdED2Ev.exit9.i.i86, %bb.t, %_ZN5Eigen8internal12scoped_arrayIdED2Ev.exit9.i.i72, %bb.ai
  %.pn.pn = phi { ptr, i32 } [ %i.dl, %_ZN5Eigen8internal12scoped_arrayIdED2Ev.exit9.i.i72 ], [ %i.gl, %bb.ai ], [ %i.ei, %bb.t ], [ %i.fv, %_ZN5Eigen8internal12scoped_arrayIdED2Ev.exit9.i.i86 ], [ %lpad.loopexit, %.loopexit134 ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ]
  call void @_ZN5Eigen12SparseMatrixIdLi1ElED2Ev(ptr noundef nonnull align 8 dead_on_return(72) dereferenceable(72) %2) #19
  br label %.body

.body:                                            ; preds = %bb.p, %.body84
...
bb.p:                                             ; preds = %bb.o, %._crit_edge.i.i.i.i.i, %bb.m
  ...
  %i.ci = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %i.cf) ; 2 uses
  %i.cj = icmp sgt i64 %.0.i.i.i.i.i.i.i.i.i, 0
  br i1 %i.cj, label %.lr.ph85.i.i.i.i.i.preheader, label %.preheader.i.i.i.i.i
...
vector.ph:                                        ; preds = %.lr.ph85.i.i.i.i.i.preheader
  ...
  %i.ck = shufflevector <4 x i32> %foldExtExtBinop, <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, <4 x i32> <i32 0, i32 5, i32 6, i32 7>
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %vec.phi = phi <4 x i32> [ %i.ck, %vector.ph ], [ %i.cn, %vector.body ]
  %vec.phi8 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %i.co, %vector.body ]
  %i.cl = getelementptr inbounds nuw [4 x i8], ptr %i.ag, i64 %index ; 2 uses
  %i.cm = getelementptr inbounds nuw i8, ptr %i.cl, i64 16
  %wide.load = load <4 x i32>, ptr %i.cl, align 4, !tbaa !42
  %wide.load9 = load <4 x i32>, ptr %i.cm, align 4, !tbaa !42
  %i.cn = add <4 x i32> %wide.load, %vec.phi      ; 2 uses
  %i.co = add <4 x i32> %wide.load9, %vec.phi8    ; 2 uses
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.cp = icmp eq i64 %index.next, %n.vec
  br i1 %i.cp, label %middle.block, label %vector.body, !llvm.loop !132
...
.lr.ph85.i.i.i.i.i.preheader83:                   ; preds = %.lr.ph85.i.i.i.i.i.preheader, %middle.block
  ...
  %.07582.i.i.i.i.i.ph = phi i32 [ %i.ci, %.lr.ph85.i.i.i.i.i.preheader ], [ %i.cq, %middle.block ]
  br label %.lr.ph85.i.i.i.i.i

.preheader.i.i.i.i.i:                             ; preds = %.lr.ph85.i.i.i.i.i, %middle.block, %bb.p
  %.075.lcssa.i.i.i.i.i = phi i32 [ %i.ci, %bb.p ], [ %i.cq, %middle.block ], [ %i.df, %.lr.ph85.i.i.i.i.i ] ; 3 uses
  %i.cr = icmp slt i64 %i.bg, %i.as
...
vector.body46:                                    ; preds = %vector.body46, %vector.ph44
  ...
  %wide.load50 = load <2 x i64>, ptr %i.et, align 8, !tbaa !84
  %wide.load51 = load <2 x i64>, ptr %i.eu, align 8, !tbaa !84
  %i.ev = add <2 x i64> %wide.load50, %vec.phi48  ; 2 uses
  %i.ew = add <2 x i64> %wide.load51, %vec.phi49  ; 2 uses
  %index.next52 = add nuw i64 %index47, 4         ; 2 uses
  %i.ex = icmp eq i64 %index.next52, %n.vec45
  br i1 %i.ex, label %middle.block53, label %vector.body46, !llvm.loop !138

middle.block53:                                   ; preds = %vector.body46
  %bin.rdx54 = add <2 x i64> %i.ew, %i.ev
  %i.ey = tail call i64 @llvm.vector.reduce.add.v2i64(<2 x i64> %bin.rdx54) ; 2 uses
  %cmp.n55 = icmp eq i64 %i.ep, %n.vec45
  br i1 %cmp.n55, label %_ZNK5Eigen8internal9evaluatorINS_20SparseCompressedBaseINS_12SparseMatrixIdLi1ElEEEEE16nonZerosEstimateEv.exit, label %.lr.ph.i.i.i.i.i147.preheader70

.lr.ph.i.i.i.i.i147.preheader70:                  ; preds = %.lr.ph.i.i.i.i.i147.preheader, %middle.block53
  %.01724.i.i.i.i.i.ph = phi i64 [ 1, %.lr.ph.i.i.i.i.i147.preheader ], [ %i.eq, %middle.block53 ]
  %.02223.i.i.i.i.i.ph = phi i64 [ %i.en, %.lr.ph.i.i.i.i.i147.preheader ], [ %i.ey, %middle.block53 ]
  br label %.lr.ph.i.i.i.i.i147

.lr.ph.i.i.i.i.i147:                              ; preds = %.lr.ph.i.i.i.i.i147.preheader70, %.lr.ph.i.i.i.i.i147
  %.01724.i.i.i.i.i = phi i64 [ %i.fc, %.lr.ph.i.i.i.i.i147 ], [ %.01724.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i147.preheader70 ] ; 2 uses
  %.02223.i.i.i.i.i = phi i64 [ %i.fb, %.lr.ph.i.i.i.i.i147 ], [ %.02223.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i147.preheader70 ]
  %i.ez = getelementptr [8 x i8], ptr %i.ee, i64 %.01724.i.i.i.i.i
  %i.fa = load i64, ptr %i.ez, align 8, !tbaa !84
  %i.fb = add nsw i64 %i.fa, %.02223.i.i.i.i.i    ; 2 uses
  %i.fc = add nuw nsw i64 %.01724.i.i.i.i.i, 1    ; 2 uses
  %exitcond.not.i.i.i.i.i148 = icmp eq i64 %i.fc, %i.d
  br i1 %exitcond.not.i.i.i.i.i148, label %_ZNK5Eigen8internal9evaluatorINS_20SparseCompressedBaseINS_12SparseMatrixIdLi1ElEEEEE16nonZerosEstimateEv.exit, label %.lr.ph.i.i.i.i.i147, !llvm.loop !139

_ZNK5Eigen8internal9evaluatorINS_20SparseCompressedBaseINS_12SparseMatrixIdLi1ElEEEEE16nonZerosEstimateEv.exit: ; preds = %.lr.ph.i.i.i.i.i147, %middle.block53, %bb.t, %bb.s, %bb.r
  %.0.i.i146 = phi i64 [ %i.el, %bb.r ], [ 0, %bb.s ], [ %i.en, %bb.t ], [ %i.ey, %middle.block53 ], [ %i.fb, %.lr.ph.i.i.i.i.i147 ]
  %i.fd = add nsw i64 %.0.i.i146, %.0.i.i
  %i.fe = getelementptr inbounds nuw i8, ptr %2, i64 56 ; 4 uses
  store i64 0, ptr %i.fe, align 8, !tbaa !140
  %i.ff = getelementptr inbounds nuw i8, ptr %2, i64 24 ; 4 uses
  %i.fg = load ptr, ptr %i.ff, align 8, !tbaa !107
  %i.fh = getelementptr inbounds nuw i8, ptr %2, i64 8 ; 3 uses
  %i.fi = load i64, ptr %i.fh, align 8, !tbaa !108
  %i.fj = shl i64 %i.fi, 2
  %i.fk = add i64 %i.fj, 4
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.fg, i8 0, i64 %i.fk, i1 false)
  %i.fl = getelementptr inbounds nuw i8, ptr %2, i64 32 ; 2 uses
  %i.fm = load ptr, ptr %i.fl, align 8, !tbaa !109 ; 2 uses
