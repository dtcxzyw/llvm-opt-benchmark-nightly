...
.preheader.i.i.i.i.i.i.i.i.i.i.i.i:
  ...
  %6 = load <4 x float>, ptr %i.g, align 16       ; 4 uses
  %7 = load float, ptr %i.h, align 16, !tbaa !12
  %8 = load float, ptr %i.i, align 4, !tbaa !12
  %9 = load float, ptr %i.j, align 8, !tbaa !12
  %10 = load float, ptr %i.k, align 4, !tbaa !12
  %11 = load float, ptr %i.l, align 16, !tbaa !12
  %12 = load float, ptr %i.m, align 4, !tbaa !12
  %13 = load float, ptr %i.n, align 8, !tbaa !12
  %14 = load float, ptr %i.o, align 4, !tbaa !12
  ...
  %i.aj = shufflevector <4 x float> %6, <4 x float> poison, <4 x i32> zeroinitializer
  %i.ak = fmul <4 x float> %i.q, %i.aj
  %15 = shufflevector <4 x float> %6, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.al = fmul <4 x float> %i.s, %15
  %i.am = fadd <4 x float> %i.ak, %i.al
  %16 = shufflevector <4 x float> %6, <4 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %i.an = fmul <4 x float> %i.u, %16
  %i.ao = fadd <4 x float> %i.an, %i.am
  %17 = shufflevector <4 x float> %6, <4 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
  %i.ap = fmul <4 x float> %i.w, %17
  %i.aq = fadd <4 x float> %i.ap, %i.ao           ; 10 uses
  %18 = insertelement <4 x float> poison, float %7, i64 0
  %i.ar = shufflevector <4 x float> %18, <4 x float> poison, <4 x i32> zeroinitializer
  %i.as = fmul <4 x float> %i.q, %i.ar
  %19 = insertelement <4 x float> poison, float %8, i64 0
  %i.at = shufflevector <4 x float> %19, <4 x float> poison, <4 x i32> zeroinitializer
  %i.au = fmul <4 x float> %i.s, %i.at
  %i.av = fadd <4 x float> %i.as, %i.au
  %20 = insertelement <4 x float> poison, float %9, i64 0
  %i.aw = shufflevector <4 x float> %20, <4 x float> poison, <4 x i32> zeroinitializer
  %i.ax = fmul <4 x float> %i.u, %i.aw
  %i.ay = fadd <4 x float> %i.av, %i.ax
  %21 = insertelement <4 x float> poison, float %10, i64 0
  %i.az = shufflevector <4 x float> %21, <4 x float> poison, <4 x i32> zeroinitializer
  %i.ba = fmul <4 x float> %i.w, %i.az
  %i.bb = fadd <4 x float> %i.ay, %i.ba           ; 10 uses
  %22 = insertelement <4 x float> poison, float %11, i64 0
  %i.bc = shufflevector <4 x float> %22, <4 x float> poison, <4 x i32> zeroinitializer
  %i.bd = fmul <4 x float> %i.q, %i.bc
  %23 = insertelement <4 x float> poison, float %12, i64 0
  %24 = shufflevector <4 x float> %23, <4 x float> poison, <4 x i32> zeroinitializer
  %i.be = fmul <4 x float> %i.s, %24
  %i.bf = fadd <4 x float> %i.bd, %i.be
  %25 = insertelement <4 x float> poison, float %13, i64 0
  %26 = shufflevector <4 x float> %25, <4 x float> poison, <4 x i32> zeroinitializer
  %i.bg = fmul <4 x float> %i.u, %26
  %i.bh = fadd <4 x float> %i.bf, %i.bg
  %27 = insertelement <4 x float> poison, float %14, i64 0
  %28 = shufflevector <4 x float> %27, <4 x float> poison, <4 x i32> zeroinitializer
  %i.bi = fmul <4 x float> %i.w, %28
  %i.bj = fadd <4 x float> %i.bh, %i.bi           ; 10 uses
