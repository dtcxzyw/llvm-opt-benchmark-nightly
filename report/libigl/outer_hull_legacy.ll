...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.df, align 8, !tbaa !329, !alias.scope !366
  ...
  store <2 x i64> %i.dg, ptr %i.di, align 8, !tbaa !329, !alias.scope !369, !noalias !371
  ...
  %wide.load144 = load <2 x i64>, ptr %i.dm, align 8, !tbaa !329, !alias.scope !373
  %i.dn = lshr <2 x i64> %wide.load144, %broadcast.splat
  %i.do = or disjoint <2 x i64> %i.dn, %i.dg
  store <2 x i64> %i.do, ptr %i.di, align 8, !tbaa !329, !alias.scope !369, !noalias !371
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.dp = icmp eq i64 %index.next, %n.vec
  br i1 %i.dp, label %middle.block, label %vector.body, !llvm.loop !374
...
bb.v:                                             ; preds = %._crit_edge
  ...
  %i.em = load i64, ptr %i.el, align 8, !tbaa !329
  %i.en = shl i64 %i.em, %i.d
  %i.eo = getelementptr inbounds nuw [8 x i8], ptr %i.at, i64 %i.ej
  store i64 %i.en, ptr %i.eo, align 8, !tbaa !329
