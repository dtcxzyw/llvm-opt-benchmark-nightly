...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 220 ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %4 = load float, ptr %i.x, align 4, !tbaa !59   ; 2 uses
  %5 = load float, ptr %i.u, align 8, !tbaa !59   ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ks = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.kw = fdiv <2 x float> %i.kv, %8              ; 2 uses
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.lp = fmul double %9, %i.lo
  %10 = fpext float %4 to double
  %i.lq = fdiv double %i.lp, %10
...
_ZNK5Eigen10MatrixBaseINS_6MatrixIfLi3ELi1ELi0ELi3ELi1EEEE10normalizedEv.exit: ; preds = %bb.a, %bb.b
  ...
  %6 = load i32, ptr %i.k, align 4, !tbaa !112
  %7 = load i32, ptr %i.i, align 16, !tbaa !111
  %8 = uitofp i32 %6 to float
  %9 = uitofp i32 %7 to float
  %10 = insertelement <2 x float> poison, float %9, i64 0
  %i.gr = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.gv = fdiv <2 x float> %i.gu, %12             ; 2 uses
