...
bb.ef:                                            ; preds = %bb.ee, %bb.ed, %_ZN5ImStbL37stb_textedit_prep_selection_at_cursorEPNS_17STB_TexteditStateE.exit465.thread.i
  ...
  %.val376890.i = phi i32 [ %.val376.i, %bb.ee ], [ %.val376.i, %bb.ed ], [ %.val376888.i, %_ZN5ImStbL37stb_textedit_prep_selection_at_cursorEPNS_17STB_TexteditStateE.exit465.thread.i ] ; 14 uses
  %i.ro = phi i32 [ %i.rj, %bb.ee ], [ %i.rl, %bb.ed ], [ %.ph886.i, %_ZN5ImStbL37stb_textedit_prep_selection_at_cursorEPNS_17STB_TexteditStateE.exit465.thread.i ]
  %i.rp = phi i32 [ %i.rj, %bb.ee ], [ %i.rj, %bb.ed ], [ %.ph886.i, %_ZN5ImStbL37stb_textedit_prep_selection_at_cursorEPNS_17STB_TexteditStateE.exit465.thread.i ]
  %i.rq = icmp sgt i32 %i.rn, %.val376890.i
  br i1 %i.rq, label %bb.eg, label %_ZN5ImStbL18stb_textedit_clampEP19ImGuiInputTextStatePNS_17STB_TexteditStateE.exit470.i

bb.eg:                                            ; preds = %bb.ef
  store i32 %.val376890.i, ptr %i.c, align 4, !tbaa !318
...
_ZN5ImStbL18stb_textedit_clampEP19ImGuiInputTextStatePNS_17STB_TexteditStateE.exit470.i: ; preds = %bb.eg, %bb.ef
  %i.rr = phi i32 [ %i.rn, %bb.ef ], [ %.val376890.i, %bb.eg ]
  ...
  br i1 %i.ru, label %.lr.ph621.i, label %.thread560.i

.lr.ph621.i:                                      ; preds = %_ZN5ImStbL18stb_textedit_clampEP19ImGuiInputTextStatePNS_17STB_TexteditStateE.exit470.i
  ...
  %i.rz = sext i32 %.val376890.i to i64
  ...
  %.promoted.i = load i32, ptr %i.rw, align 4, !tbaa !421
  %.promoted624.i = load i32, ptr %i.rx, align 4, !tbaa !416
  %.pre.i = load i8, ptr %i.rt, align 2, !tbaa !319
  %i.sd = icmp eq i8 %.pre.i, 0
  %i.se = select i1 %i.sd, ptr %3, ptr %i.rv
  %.pre96 = load float, ptr %i.se, align 4, !tbaa !130 ; 2 uses
  br label %bb.eh

bb.eh:                                            ; preds = %._crit_edge312, %.lr.ph621.i
  %i.sf = phi i32 [ %i.ro, %.lr.ph621.i ], [ %i.ue, %._crit_edge312 ] ; 5 uses
  %i.sg = phi i32 [ %i.rp, %.lr.ph621.i ], [ %i.ub, %._crit_edge312 ] ; 3 uses
  %i.sh = phi i32 [ %.promoted624.i, %.lr.ph621.i ], [ %i.si, %._crit_edge312 ]
  %i.si = phi i32 [ %.promoted.i, %.lr.ph621.i ], [ %.0300.lcssa.i, %._crit_edge312 ] ; 9 uses
  %.0301620.i = phi i32 [ 0, %.lr.ph621.i ], [ %i.uk, %._crit_edge312 ]
...
bb.ei:                                            ; preds = %bb.eh
  ...
  %i.ss = icmp slt i32 %i.si, %.val376890.i
...
.lr.ph.split.us.i.i484.i:                         ; preds = %bb.ei, %.lr.ph.split.us.i.i484.i
  ...
  %or.cond937.i = select i1 %cond.i, i1 %i.sv, i1 false
  br i1 %or.cond937.i, label %.lr.ph.split.us.i.i484.i, label %_ZN5ImStbL22STB_TEXTEDIT_LAYOUTROWEPNS_14StbTexteditRowEP19ImGuiInputTextStatei.exit492.i
...
_ZN5ImStbL22STB_TEXTEDIT_LAYOUTROWEPNS_14StbTexteditRowEP19ImGuiInputTextStatei.exit492.i: ; preds = %.lr.ph.split.us.i.i484.i, %bb.ei
  ...
  br i1 %i.tb, label %.lr.ph617.i, label %.thread554.i

.lr.ph617.i:                                      ; preds = %_ZN5ImStbL22STB_TEXTEDIT_LAYOUTROWEPNS_14StbTexteditRowEP19ImGuiInputTextStatei.exit492.i
...
bb.ej:                                            ; preds = %bb.el, %.lr.ph617.i
  %i.te = phi i32 [ %i.si, %.lr.ph617.i ], [ %i.ts, %bb.el ] ; 4 uses
  %indvars.iv704.i = phi i64 [ 0, %.lr.ph617.i ], [ %indvars.iv.next705.i, %bb.el ] ; 2 uses
  %.0616.i = phi float [ 0.000000e+00, %.lr.ph617.i ], [ %i.tq, %bb.el ]
  %gep.i = getelementptr [2 x i8], ptr %i.sl, i64 %indvars.iv704.i
...
bb.ek:                                            ; preds = %_ZN5ImStbL21STB_TEXTEDIT_GETWIDTHEP19ImGuiInputTextStateii.exit495.i
  %i.tq = fadd float %.0616.i, %i.to              ; 2 uses
  %i.tr = fcmp ogt float %i.tq, %.pre96
  br i1 %i.tr, label %.thread554.i, label %bb.el

bb.el:                                            ; preds = %bb.ek
  %i.ts = add nsw i32 %i.te, 1                    ; 3 uses
  store i32 %i.ts, ptr %i.c, align 4, !tbaa !318
  %indvars.iv.next705.i = add nuw nsw i64 %indvars.iv704.i, 1 ; 2 uses
  %exitcond707.not.i = icmp eq i64 %indvars.iv.next705.i, %wide.trip.count.i
  br i1 %exitcond707.not.i, label %.thread554.i, label %bb.ej, !llvm.loop !422
...
bb.em:                                            ; preds = %.thread554.i
  %i.tu = icmp sgt i32 %i.sg, %.val376890.i
  br i1 %i.tu, label %bb.en, label %bb.eo

bb.en:                                            ; preds = %bb.em
  store i32 %.val376890.i, ptr %i.qy, align 8, !tbaa !316
  br label %bb.eo

bb.eo:                                            ; preds = %bb.en, %bb.em
  %i.tv = phi i32 [ %.val376890.i, %bb.en ], [ %i.sg, %bb.em ] ; 6 uses
  %i.tw = icmp sgt i32 %i.sf, %.val376890.i
  br i1 %i.tw, label %bb.ep, label %bb.eq

bb.ep:                                            ; preds = %bb.eo
  store i32 %.val376890.i, ptr %i.ra, align 4, !tbaa !317
  br label %bb.eq

bb.eq:                                            ; preds = %bb.ep, %bb.eo
  %i.tx = phi i32 [ %.val376890.i, %bb.ep ], [ %i.sf, %bb.eo ] ; 2 uses
...
bb.es:                                            ; preds = %bb.er, %bb.eq, %.thread554.i
  ...
  %i.uc = icmp sgt i32 %i.tz, %.val376890.i
...
_ZN5ImStbL18stb_textedit_clampEP19ImGuiInputTextStatePNS_17STB_TexteditStateE.exit497.i: ; preds = %bb.et, %bb.es
  %i.ud = phi i32 [ %i.tz, %bb.es ], [ %.val376890.i, %bb.et ] ; 2 uses
  store i8 1, ptr %i.rt, align 2, !tbaa !319
  store float %.pre96, ptr %i.rv, align 8, !tbaa !320
...
.thread560.i:                                     ; preds = %._crit_edge312, %bb.eh, %_ZN5ImStbL18stb_textedit_clampEP19ImGuiInputTextStatePNS_17STB_TexteditStateE.exit470.i
