...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %or.cond3 = select i1 %i.ay, i1 true, i1 %i.az
  %i.ba = zext i1 %or.cond3 to i8                 ; 2 uses
  %.4 = or i8 %.364, %i.ba                        ; 2 uses
  %i.bb = trunc nuw i32 %.3 to i8                 ; 2 uses
  store i8 %i.bb, ptr %i.ac, align 2, !tbaa !313
  %i.bc = shl nuw nsw i8 %.4, 4
  %i.bd = trunc nuw nsw i32 %.368 to i8
  %3 = add nuw nsw i8 %i.ba, %i.bd
  %i.be = shl nuw nsw i8 %3, 2
  %i.bf = and i8 %i.be, 12
