...
bb.d:                                             ; preds = %bb.c, %bb.b
  %i.e = landingpad { ptr, i32 }
          cleanup
  %i.f = load ptr, ptr %4, align 8, !tbaa !14
...
_ZN3igl16MassMatrixHelperIN5Eigen6MatrixIdLin1ELi3ELi0ELin1ELi3EEENS2_IiLin1ELin1ELi0ELin1ELin1EEEdLi3EE7computeERKNS1_10MatrixBaseIS3_EERKNS6_IS4_EENS_14MassMatrixTypeERNS1_12SparseMatrixIdLi0EiEE.exit.i: ; preds = %bb.c
  %i.g = load ptr, ptr %4, align 8, !tbaa !14
...
bb.b:                                             ; preds = %bb.a
  %i.g = load ptr, ptr %38, align 8, !tbaa !20    ; 3 uses
  %i.h = getelementptr inbounds nuw i8, ptr %38, i64 8
  %i.i = load i64, ptr %i.h, align 8, !tbaa !22   ; 5 uses
  %i.j = sdiv i64 %i.i, 2                         ; 2 uses
  %i.k = shl nsw i64 %i.j, 1                      ; 5 uses
...
.lr.ph.i.i.i.i.i.i.i.i.i.preheader:               ; preds = %._crit_edge.i.i.i.i.i.i.i.i
  %i.n = shl nsw i64 %i.j, 1
  %i.o = sub i64 %i.i, %i.n                       ; 3 uses
...
vector.ph:                                        ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i.preheader
  ...
  %i.p = add i64 %i.k, %n.vec
  %i.q = getelementptr [8 x i8], ptr %i.g, i64 %i.k
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.r = getelementptr [8 x i8], ptr %i.q, i64 %index ; 3 uses
  %i.s = getelementptr inbounds nuw i8, ptr %i.r, i64 16 ; 2 uses
  %wide.load = load <2 x double>, ptr %i.r, align 8, !tbaa !23
  %wide.load1399 = load <2 x double>, ptr %i.s, align 8, !tbaa !23
  %i.t = call <2 x double> @llvm.fabs.v2f64(<2 x double> %wide.load)
  %i.u = call <2 x double> @llvm.fabs.v2f64(<2 x double> %wide.load1399)
  store <2 x double> %i.t, ptr %i.r, align 8, !tbaa !23
  store <2 x double> %i.u, ptr %i.s, align 8, !tbaa !23
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.v = icmp eq i64 %index.next, %n.vec
  br i1 %i.v, label %middle.block, label %vector.body, !llvm.loop !25
...
.lr.ph.i.i.i.i.i.i.i.i.i.preheader2354:           ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i.preheader, %middle.block
  %.05.i.i.i.i.i.i.i.i.i.ph = phi i64 [ %i.k, %.lr.ph.i.i.i.i.i.i.i.i.i.preheader ], [ %i.p, %middle.block ]
  br label %.lr.ph.i.i.i.i.i.i.i.i.i

.lr.ph.i.i.i.i.i.i.i.i.i:                         ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i.preheader2354, %.lr.ph.i.i.i.i.i.i.i.i.i
  %.05.i.i.i.i.i.i.i.i.i = phi i64 [ %i.z, %.lr.ph.i.i.i.i.i.i.i.i.i ], [ %.05.i.i.i.i.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.i.i.i.i.preheader2354 ] ; 2 uses
  %i.w = getelementptr inbounds [8 x i8], ptr %i.g, i64 %.05.i.i.i.i.i.i.i.i.i ; 2 uses
  %i.x = load double, ptr %i.w, align 8, !tbaa !23
  %i.y = call noundef double @llvm.fabs.f64(double %i.x)
  store double %i.y, ptr %i.w, align 8, !tbaa !23
  %i.z = add nsw i64 %.05.i.i.i.i.i.i.i.i.i, 1    ; 2 uses
  %exitcond.not.i.i.i.i.i.i.i.i.i = icmp eq i64 %i.z, %i.i
  br i1 %exitcond.not.i.i.i.i.i.i.i.i.i, label %.loopexit1258, label %.lr.ph.i.i.i.i.i.i.i.i.i, !llvm.loop !29

.lr.ph.i.i.i.i.i.i.i.i:                           ; preds = %bb.b, %.lr.ph.i.i.i.i.i.i.i.i
  %.011.i.i.i.i.i.i.i.i = phi i64 [ %i.ad, %.lr.ph.i.i.i.i.i.i.i.i ], [ 0, %bb.b ] ; 2 uses
  %i.aa = getelementptr inbounds nuw [8 x i8], ptr %i.g, i64 %.011.i.i.i.i.i.i.i.i ; 2 uses
  %i.ab = load <2 x double>, ptr %i.aa, align 16, !tbaa !30
  %i.ac = call noundef <2 x double> @llvm.fabs.v2f64(<2 x double> %i.ab)
  store <2 x double> %i.ac, ptr %i.aa, align 16, !tbaa !30
  %i.ad = add nuw nsw i64 %.011.i.i.i.i.i.i.i.i, 2 ; 2 uses
  %i.ae = icmp slt i64 %i.ad, %i.k
  br i1 %i.ae, label %.lr.ph.i.i.i.i.i.i.i.i, label %._crit_edge.i.i.i.i.i.i.i.i, !llvm.loop !31
...
bb.d:                                             ; preds = %.loopexit1258, %.loopexit1258
  %i.ag = shl nsw i32 %i.f, 2
  %i.ah = sext i32 %i.ag to i64                   ; 3 uses
  invoke void @_ZN5Eigen15PlainObjectBaseINS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEEE6resizeEll(ptr noundef nonnull align 8 dereferenceable(16) %39, i64 noundef %i.ah, i64 noundef 1)
          to label %bb.e unwind label %bb.n

bb.e:                                             ; preds = %bb.d
  invoke void @_ZN5Eigen15PlainObjectBaseINS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEEE6resizeEll(ptr noundef nonnull align 8 dereferenceable(16) %40, i64 noundef %i.ah, i64 noundef 1)
          to label %bb.f unwind label %bb.n

bb.f:                                             ; preds = %bb.e
  invoke void @_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEE6resizeEll(ptr noundef nonnull align 8 dereferenceable(16) %41, i64 noundef %i.ah, i64 noundef 1)
          to label %bb.g unwind label %bb.n

bb.g:                                             ; preds = %bb.f
  %i.ai = load ptr, ptr %1, align 8, !tbaa !32, !noalias !33
  call void @llvm.lifetime.start.p0(ptr nonnull %42) #15
  call void @llvm.experimental.noalias.scope.decl(metadata !36)
  %sext1226 = shl i64 %i.e, 32
  %i.aj = ashr exact i64 %sext1226, 32            ; 6 uses
  %i.ak = load ptr, ptr %39, align 8, !tbaa !39, !noalias !36 ; 2 uses
  %i.al = getelementptr inbounds nuw i8, ptr %39, i64 8 ; 5 uses
  %i.am = load i64, ptr %i.al, align 8, !tbaa !41, !noalias !36 ; 2 uses
  store ptr %i.ak, ptr %42, align 8, !tbaa !42, !alias.scope !36
  %i.an = getelementptr inbounds nuw i8, ptr %42, i64 8
  store i64 %i.aj, ptr %i.an, align 8, !tbaa !45, !alias.scope !36
  %i.ao = getelementptr inbounds nuw i8, ptr %42, i64 16
  store i64 1, ptr %i.ao, align 8, !tbaa !45, !alias.scope !36
  %i.ap = getelementptr inbounds nuw i8, ptr %42, i64 24
  store ptr %39, ptr %i.ap, align 8, !tbaa !46, !alias.scope !36
  %i.aq = getelementptr inbounds nuw i8, ptr %42, i64 32
  %i.ar = getelementptr inbounds nuw i8, ptr %42, i64 48
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.aq, i8 0, i64 16, i1 false)
  store i64 %i.am, ptr %i.ar, align 8, !tbaa !48, !alias.scope !36
  call void @llvm.lifetime.start.p0(ptr nonnull %37) #15
  call void @llvm.lifetime.start.p0(ptr nonnull %34) #15
  store ptr %i.ai, ptr %34, align 8, !tbaa !51
  %i.as = getelementptr inbounds nuw i8, ptr %34, i64 16
  %i.at = load i64, ptr %i.d, align 8, !tbaa !18
  store i64 %i.at, ptr %i.as, align 8, !tbaa !45
  call void @llvm.lifetime.start.p0(ptr nonnull %35) #15
  store ptr %i.ak, ptr %35, align 8, !tbaa !54
  %i.au = getelementptr inbounds nuw i8, ptr %35, i64 16
  store i64 %i.am, ptr %i.au, align 8, !tbaa !45
  call void @llvm.lifetime.start.p0(ptr nonnull %36) #15
  store ptr %35, ptr %36, align 8, !tbaa !56
  %i.av = getelementptr inbounds nuw i8, ptr %36, i64 8
  store ptr %34, ptr %i.av, align 8, !tbaa !58
  %i.aw = getelementptr inbounds nuw i8, ptr %36, i64 16
  store ptr %37, ptr %i.aw, align 8, !tbaa !60
  %i.ax = getelementptr inbounds nuw i8, ptr %36, i64 24
  store ptr %42, ptr %i.ax, align 8, !tbaa !62
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ay = load ptr, ptr %1, align 8, !tbaa !32, !noalias !64
  %i.az = load i64, ptr %i.d, align 8, !tbaa !18, !noalias !64 ; 2 uses
  %i.ba = getelementptr inbounds [4 x i8], ptr %i.ay, i64 %i.az
  call void @llvm.lifetime.start.p0(ptr nonnull %43) #15
  call void @llvm.experimental.noalias.scope.decl(metadata !67)
  %i.bb = load ptr, ptr %39, align 8, !tbaa !39, !noalias !67
  %i.bc = getelementptr inbounds [4 x i8], ptr %i.bb, i64 %i.aj ; 2 uses
  %i.bd = load i64, ptr %i.al, align 8, !tbaa !41, !noalias !67 ; 2 uses
  store ptr %i.bc, ptr %43, align 8, !tbaa !42, !alias.scope !67
  %i.be = getelementptr inbounds nuw i8, ptr %43, i64 8
  store i64 %i.aj, ptr %i.be, align 8, !tbaa !45, !alias.scope !67
  %i.bf = getelementptr inbounds nuw i8, ptr %43, i64 16
  store i64 1, ptr %i.bf, align 8, !tbaa !45, !alias.scope !67
  %i.bg = getelementptr inbounds nuw i8, ptr %43, i64 24
  store ptr %39, ptr %i.bg, align 8, !tbaa !46, !alias.scope !67
  %i.bh = getelementptr inbounds nuw i8, ptr %43, i64 32
  store i64 %i.aj, ptr %i.bh, align 8, !tbaa !45, !alias.scope !67
  %i.bi = getelementptr inbounds nuw i8, ptr %43, i64 40
  store i64 0, ptr %i.bi, align 8, !tbaa !45, !alias.scope !67
  %i.bj = getelementptr inbounds nuw i8, ptr %43, i64 48
  store i64 %i.bd, ptr %i.bj, align 8, !tbaa !48, !alias.scope !67
  call void @llvm.lifetime.start.p0(ptr nonnull %33) #15
  call void @llvm.lifetime.start.p0(ptr nonnull %30) #15
  store ptr %i.ba, ptr %30, align 8, !tbaa !51
  %i.bk = getelementptr inbounds nuw i8, ptr %30, i64 16
  store i64 %i.az, ptr %i.bk, align 8, !tbaa !45
  call void @llvm.lifetime.start.p0(ptr nonnull %31) #15
  store ptr %i.bc, ptr %31, align 8, !tbaa !54
  %i.bl = getelementptr inbounds nuw i8, ptr %31, i64 16
  store i64 %i.bd, ptr %i.bl, align 8, !tbaa !45
  call void @llvm.lifetime.start.p0(ptr nonnull %32) #15
  store ptr %31, ptr %32, align 8, !tbaa !56
  %i.bm = getelementptr inbounds nuw i8, ptr %32, i64 8
  store ptr %30, ptr %i.bm, align 8, !tbaa !58
  %i.bn = getelementptr inbounds nuw i8, ptr %32, i64 16
  store ptr %33, ptr %i.bn, align 8, !tbaa !60
  %i.bo = getelementptr inbounds nuw i8, ptr %32, i64 24
  store ptr %43, ptr %i.bo, align 8, !tbaa !62
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.bp = load ptr, ptr %1, align 8, !tbaa !32, !noalias !70
  %i.bq = load i64, ptr %i.d, align 8, !tbaa !18, !noalias !70 ; 2 uses
  %.idx1227 = shl nsw i64 %i.bq, 3
  %i.br = getelementptr inbounds i8, ptr %i.bp, i64 %.idx1227
  call void @llvm.lifetime.start.p0(ptr nonnull %44) #15
  %i.bs = shl nsw i32 %i.f, 1
  %i.bt = sext i32 %i.bs to i64                   ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !73)
  %i.bu = load ptr, ptr %39, align 8, !tbaa !39, !noalias !73
  %i.bv = getelementptr inbounds [4 x i8], ptr %i.bu, i64 %i.bt ; 2 uses
  %i.bw = load i64, ptr %i.al, align 8, !tbaa !41, !noalias !73 ; 2 uses
  store ptr %i.bv, ptr %44, align 8, !tbaa !42, !alias.scope !73
  %i.bx = getelementptr inbounds nuw i8, ptr %44, i64 8
  store i64 %i.aj, ptr %i.bx, align 8, !tbaa !45, !alias.scope !73
  %i.by = getelementptr inbounds nuw i8, ptr %44, i64 16
  store i64 1, ptr %i.by, align 8, !tbaa !45, !alias.scope !73
  %i.bz = getelementptr inbounds nuw i8, ptr %44, i64 24
  store ptr %39, ptr %i.bz, align 8, !tbaa !46, !alias.scope !73
  %i.ca = getelementptr inbounds nuw i8, ptr %44, i64 32
  store i64 %i.bt, ptr %i.ca, align 8, !tbaa !45, !alias.scope !73
  %i.cb = getelementptr inbounds nuw i8, ptr %44, i64 40
  store i64 0, ptr %i.cb, align 8, !tbaa !45, !alias.scope !73
  %i.cc = getelementptr inbounds nuw i8, ptr %44, i64 48
  store i64 %i.bw, ptr %i.cc, align 8, !tbaa !48, !alias.scope !73
  call void @llvm.lifetime.start.p0(ptr nonnull %29) #15
  call void @llvm.lifetime.start.p0(ptr nonnull %26) #15
  store ptr %i.br, ptr %26, align 8, !tbaa !51
  %i.cd = getelementptr inbounds nuw i8, ptr %26, i64 16
  store i64 %i.bq, ptr %i.cd, align 8, !tbaa !45
  call void @llvm.lifetime.start.p0(ptr nonnull %27) #15
  store ptr %i.bv, ptr %27, align 8, !tbaa !54
  %i.ce = getelementptr inbounds nuw i8, ptr %27, i64 16
  store i64 %i.bw, ptr %i.ce, align 8, !tbaa !45
  call void @llvm.lifetime.start.p0(ptr nonnull %28) #15
  store ptr %27, ptr %28, align 8, !tbaa !56
  %i.cf = getelementptr inbounds nuw i8, ptr %28, i64 8
  store ptr %26, ptr %i.cf, align 8, !tbaa !58
  %i.cg = getelementptr inbounds nuw i8, ptr %28, i64 16
  store ptr %29, ptr %i.cg, align 8, !tbaa !60
  %i.ch = getelementptr inbounds nuw i8, ptr %28, i64 24
  store ptr %44, ptr %i.ch, align 8, !tbaa !62
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.ci = load ptr, ptr %1, align 8, !tbaa !32, !noalias !76
  %i.cj = load i64, ptr %i.d, align 8, !tbaa !18, !noalias !76 ; 2 uses
  %.idx1228 = mul nsw i64 %i.cj, 12
  %i.ck = getelementptr inbounds i8, ptr %i.ci, i64 %.idx1228
  call void @llvm.lifetime.start.p0(ptr nonnull %45) #15
  %sext146 = mul i64 %i.e, 12884901888
  %i.cl = ashr exact i64 %sext146, 32             ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !79)
  %i.cm = load ptr, ptr %39, align 8, !tbaa !39, !noalias !79
  %i.cn = getelementptr inbounds [4 x i8], ptr %i.cm, i64 %i.cl ; 2 uses
  %i.co = load i64, ptr %i.al, align 8, !tbaa !41, !noalias !79 ; 2 uses
  store ptr %i.cn, ptr %45, align 8, !tbaa !42, !alias.scope !79
  %i.cp = getelementptr inbounds nuw i8, ptr %45, i64 8
  store i64 %i.aj, ptr %i.cp, align 8, !tbaa !45, !alias.scope !79
  %i.cq = getelementptr inbounds nuw i8, ptr %45, i64 16
  store i64 1, ptr %i.cq, align 8, !tbaa !45, !alias.scope !79
  %i.cr = getelementptr inbounds nuw i8, ptr %45, i64 24
  store ptr %39, ptr %i.cr, align 8, !tbaa !46, !alias.scope !79
  %i.cs = getelementptr inbounds nuw i8, ptr %45, i64 32
  store i64 %i.cl, ptr %i.cs, align 8, !tbaa !45, !alias.scope !79
  %i.ct = getelementptr inbounds nuw i8, ptr %45, i64 40
  store i64 0, ptr %i.ct, align 8, !tbaa !45, !alias.scope !79
  %i.cu = getelementptr inbounds nuw i8, ptr %45, i64 48
  store i64 %i.co, ptr %i.cu, align 8, !tbaa !48, !alias.scope !79
  call void @llvm.lifetime.start.p0(ptr nonnull %25) #15
  call void @llvm.lifetime.start.p0(ptr nonnull %22) #15
  store ptr %i.ck, ptr %22, align 8, !tbaa !51
  %i.cv = getelementptr inbounds nuw i8, ptr %22, i64 16
  store i64 %i.cj, ptr %i.cv, align 8, !tbaa !45
  call void @llvm.lifetime.start.p0(ptr nonnull %23) #15
  store ptr %i.cn, ptr %23, align 8, !tbaa !54
  %i.cw = getelementptr inbounds nuw i8, ptr %23, i64 16
  store i64 %i.co, ptr %i.cw, align 8, !tbaa !45
  call void @llvm.lifetime.start.p0(ptr nonnull %24) #15
  store ptr %23, ptr %24, align 8, !tbaa !56
  %i.cx = getelementptr inbounds nuw i8, ptr %24, i64 8
  store ptr %22, ptr %i.cx, align 8, !tbaa !58
  %i.cy = getelementptr inbounds nuw i8, ptr %24, i64 16
  store ptr %25, ptr %i.cy, align 8, !tbaa !60
  %i.cz = getelementptr inbounds nuw i8, ptr %24, i64 24
  store ptr %45, ptr %i.cz, align 8, !tbaa !62
...
bb.bm:                                            ; preds = %_ZN5Eigen9DenseBaseINS_12ArrayWrapperINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEEEdVERKd.exit
  %i.drk = load ptr, ptr %41, align 8, !tbaa !20
  call void @free(ptr noundef %i.drk) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %41) #15
  %i.drl = load ptr, ptr %40, align 8, !tbaa !39
  call void @free(ptr noundef %i.drl) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %40) #15
  %i.drm = load ptr, ptr %39, align 8, !tbaa !39
  call void @free(ptr noundef %i.drm) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %39) #15
  %i.drn = load ptr, ptr %38, align 8, !tbaa !20
  call void @free(ptr noundef %i.drn) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %38) #15
  ret void

bb.bn:                                            ; preds = %bb.bj, %bb.bi, %bb.r, %bb.q, %bb.p, %bb.o, %bb.bl, %bb.bk, %bb.u, %bb.n
  %.pn150 = phi { ptr, i32 } [ %i.fx, %bb.n ], [ %i.ga, %bb.q ], [ %i.fz, %bb.p ], [ %i.fy, %bb.o ], [ %i.drg, %bb.bj ], [ %i.gb, %bb.r ], [ %i.jo, %bb.u ], [ %i.dri, %bb.bl ], [ %i.drh, %bb.bk ], [ %i.drf, %bb.bi ]
  %i.dro = load ptr, ptr %41, align 8, !tbaa !20
  call void @free(ptr noundef %i.dro) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %41) #15
  %i.drp = load ptr, ptr %40, align 8, !tbaa !39
  call void @free(ptr noundef %i.drp) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %40) #15
  %i.drq = load ptr, ptr %39, align 8, !tbaa !39
  call void @free(ptr noundef %i.drq) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %39) #15
  br label %bb.bo

bb.bo:                                            ; preds = %bb.bn, %bb.c
  %.pn150.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn150, %bb.bn ], [ %i.af, %bb.c ]
  %i.drr = load ptr, ptr %38, align 8, !tbaa !20
  call void @free(ptr noundef %i.drr) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %38) #15
...
bb.c:                                             ; preds = %bb.b, %bb.a
  %i.c = landingpad { ptr, i32 }
          cleanup
  %i.d = load ptr, ptr %4, align 8, !tbaa !14
...
_ZN3igl16MassMatrixHelperIN5Eigen6MatrixIdLin1ELi3ELi0ELin1ELi3EEENS2_IiLin1ELi3ELi0ELin1ELi3EEEdLi3EE7computeERKNS1_10MatrixBaseIS3_EERKNS6_IS4_EENS_14MassMatrixTypeERNS1_12SparseMatrixIdLi0EiEE.exit: ; preds = %bb.b
  %i.e = load ptr, ptr %4, align 8, !tbaa !14
...
bb.a:
  ...
  %i.c = trunc i64 %i.b to i32                    ; 2 uses
  %i.d = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 37 uses
  %i.e = load i64, ptr %i.d, align 8, !tbaa !503  ; 4 uses
  %i.f = trunc i64 %i.e to i32                    ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %38) #15
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %38, i8 0, i64 16, i1 false)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.v = icmp eq i64 %index.next, %n.vec
  br i1 %i.v, label %middle.block, label %vector.body, !llvm.loop !504
...
.lr.ph.i.i.i.i.i.i.i.i.i:                         ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i.preheader2354, %.lr.ph.i.i.i.i.i.i.i.i.i
  ...
  %i.z = add nsw i64 %.05.i.i.i.i.i.i.i.i.i, 1    ; 2 uses
  %exitcond.not.i.i.i.i.i.i.i.i.i = icmp eq i64 %i.z, %i.i
  br i1 %exitcond.not.i.i.i.i.i.i.i.i.i, label %.loopexit1258, label %.lr.ph.i.i.i.i.i.i.i.i.i, !llvm.loop !505
...
bb.g:                                             ; preds = %bb.f
  %i.ai = load ptr, ptr %1, align 8, !tbaa !506, !noalias !507
  call void @llvm.lifetime.start.p0(ptr nonnull %42) #15
  call void @llvm.experimental.noalias.scope.decl(metadata !510)
  %sext1226 = shl i64 %i.e, 32
  %i.aj = ashr exact i64 %sext1226, 32            ; 6 uses
  %i.ak = load ptr, ptr %39, align 8, !tbaa !39, !noalias !510 ; 2 uses
  %i.al = getelementptr inbounds nuw i8, ptr %39, i64 8 ; 5 uses
  %i.am = load i64, ptr %i.al, align 8, !tbaa !41, !noalias !510 ; 2 uses
  store ptr %i.ak, ptr %42, align 8, !tbaa !42, !alias.scope !510
  %i.an = getelementptr inbounds nuw i8, ptr %42, i64 8
  store i64 %i.aj, ptr %i.an, align 8, !tbaa !45, !alias.scope !510
  %i.ao = getelementptr inbounds nuw i8, ptr %42, i64 16
  store i64 1, ptr %i.ao, align 8, !tbaa !45, !alias.scope !510
  %i.ap = getelementptr inbounds nuw i8, ptr %42, i64 24
  store ptr %39, ptr %i.ap, align 8, !tbaa !46, !alias.scope !510
  %i.aq = getelementptr inbounds nuw i8, ptr %42, i64 32
  %i.ar = getelementptr inbounds nuw i8, ptr %42, i64 48
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.aq, i8 0, i64 16, i1 false)
  store i64 %i.am, ptr %i.ar, align 8, !tbaa !48, !alias.scope !510
  call void @llvm.lifetime.start.p0(ptr nonnull %37) #15
  call void @llvm.lifetime.start.p0(ptr nonnull %34) #15
  store ptr %i.ai, ptr %34, align 8, !tbaa !513
  %i.as = getelementptr inbounds nuw i8, ptr %34, i64 16
  %i.at = load i64, ptr %i.d, align 8, !tbaa !503
  store i64 %i.at, ptr %i.as, align 8, !tbaa !45
  call void @llvm.lifetime.start.p0(ptr nonnull %35) #15
  store ptr %i.ak, ptr %35, align 8, !tbaa !54
  %i.au = getelementptr inbounds nuw i8, ptr %35, i64 16
  ...
  store ptr %35, ptr %36, align 8, !tbaa !56
  %i.av = getelementptr inbounds nuw i8, ptr %36, i64 8
  store ptr %34, ptr %i.av, align 8, !tbaa !515
  %i.aw = getelementptr inbounds nuw i8, ptr %36, i64 16
  store ptr %37, ptr %i.aw, align 8, !tbaa !60
  %i.ax = getelementptr inbounds nuw i8, ptr %36, i64 24
  store ptr %42, ptr %i.ax, align 8, !tbaa !62
...
bb.h:                                             ; preds = %bb.g
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %37) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %42) #15
  %i.ay = load ptr, ptr %1, align 8, !tbaa !506, !noalias !517
  %i.az = load i64, ptr %i.d, align 8, !tbaa !503, !noalias !517 ; 2 uses
  %i.ba = getelementptr inbounds [4 x i8], ptr %i.ay, i64 %i.az
  call void @llvm.lifetime.start.p0(ptr nonnull %43) #15
  call void @llvm.experimental.noalias.scope.decl(metadata !520)
  %i.bb = load ptr, ptr %39, align 8, !tbaa !39, !noalias !520
  %i.bc = getelementptr inbounds [4 x i8], ptr %i.bb, i64 %i.aj ; 2 uses
  %i.bd = load i64, ptr %i.al, align 8, !tbaa !41, !noalias !520 ; 2 uses
  store ptr %i.bc, ptr %43, align 8, !tbaa !42, !alias.scope !520
  %i.be = getelementptr inbounds nuw i8, ptr %43, i64 8
  store i64 %i.aj, ptr %i.be, align 8, !tbaa !45, !alias.scope !520
  %i.bf = getelementptr inbounds nuw i8, ptr %43, i64 16
  store i64 1, ptr %i.bf, align 8, !tbaa !45, !alias.scope !520
  %i.bg = getelementptr inbounds nuw i8, ptr %43, i64 24
  store ptr %39, ptr %i.bg, align 8, !tbaa !46, !alias.scope !520
  %i.bh = getelementptr inbounds nuw i8, ptr %43, i64 32
  store i64 %i.aj, ptr %i.bh, align 8, !tbaa !45, !alias.scope !520
  %i.bi = getelementptr inbounds nuw i8, ptr %43, i64 40
  store i64 0, ptr %i.bi, align 8, !tbaa !45, !alias.scope !520
  %i.bj = getelementptr inbounds nuw i8, ptr %43, i64 48
  store i64 %i.bd, ptr %i.bj, align 8, !tbaa !48, !alias.scope !520
  call void @llvm.lifetime.start.p0(ptr nonnull %33) #15
  call void @llvm.lifetime.start.p0(ptr nonnull %30) #15
  store ptr %i.ba, ptr %30, align 8, !tbaa !513
  %i.bk = getelementptr inbounds nuw i8, ptr %30, i64 16
  store i64 %i.az, ptr %i.bk, align 8, !tbaa !45
  call void @llvm.lifetime.start.p0(ptr nonnull %31) #15
  store ptr %i.bc, ptr %31, align 8, !tbaa !54
  ...
  store ptr %31, ptr %32, align 8, !tbaa !56
  %i.bm = getelementptr inbounds nuw i8, ptr %32, i64 8
  store ptr %30, ptr %i.bm, align 8, !tbaa !515
  %i.bn = getelementptr inbounds nuw i8, ptr %32, i64 16
  store ptr %33, ptr %i.bn, align 8, !tbaa !60
  %i.bo = getelementptr inbounds nuw i8, ptr %32, i64 24
  store ptr %43, ptr %i.bo, align 8, !tbaa !62
...
bb.i:                                             ; preds = %bb.h
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %33) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %43) #15
  %i.bp = load ptr, ptr %1, align 8, !tbaa !506, !noalias !523
  %i.bq = load i64, ptr %i.d, align 8, !tbaa !503, !noalias !523 ; 2 uses
  %.idx1227 = shl nsw i64 %i.bq, 3
  %i.br = getelementptr inbounds i8, ptr %i.bp, i64 %.idx1227
  call void @llvm.lifetime.start.p0(ptr nonnull %44) #15
  %i.bs = shl nsw i32 %i.f, 1
  ...
  %i.bu = load ptr, ptr %39, align 8, !tbaa !39, !noalias !526
  %i.bv = getelementptr inbounds [4 x i8], ptr %i.bu, i64 %i.bt ; 2 uses
  %i.bw = load i64, ptr %i.al, align 8, !tbaa !41, !noalias !526 ; 2 uses
  store ptr %i.bv, ptr %44, align 8, !tbaa !42, !alias.scope !526
  %i.bx = getelementptr inbounds nuw i8, ptr %44, i64 8
  store i64 %i.aj, ptr %i.bx, align 8, !tbaa !45, !alias.scope !526
  %i.by = getelementptr inbounds nuw i8, ptr %44, i64 16
  store i64 1, ptr %i.by, align 8, !tbaa !45, !alias.scope !526
  %i.bz = getelementptr inbounds nuw i8, ptr %44, i64 24
  store ptr %39, ptr %i.bz, align 8, !tbaa !46, !alias.scope !526
  %i.ca = getelementptr inbounds nuw i8, ptr %44, i64 32
  store i64 %i.bt, ptr %i.ca, align 8, !tbaa !45, !alias.scope !526
  %i.cb = getelementptr inbounds nuw i8, ptr %44, i64 40
  store i64 0, ptr %i.cb, align 8, !tbaa !45, !alias.scope !526
  %i.cc = getelementptr inbounds nuw i8, ptr %44, i64 48
  store i64 %i.bw, ptr %i.cc, align 8, !tbaa !48, !alias.scope !526
  call void @llvm.lifetime.start.p0(ptr nonnull %29) #15
  call void @llvm.lifetime.start.p0(ptr nonnull %26) #15
  store ptr %i.br, ptr %26, align 8, !tbaa !513
  %i.cd = getelementptr inbounds nuw i8, ptr %26, i64 16
  store i64 %i.bq, ptr %i.cd, align 8, !tbaa !45
  call void @llvm.lifetime.start.p0(ptr nonnull %27) #15
  store ptr %i.bv, ptr %27, align 8, !tbaa !54
  ...
  store ptr %27, ptr %28, align 8, !tbaa !56
  %i.cf = getelementptr inbounds nuw i8, ptr %28, i64 8
  store ptr %26, ptr %i.cf, align 8, !tbaa !515
  %i.cg = getelementptr inbounds nuw i8, ptr %28, i64 16
  store ptr %29, ptr %i.cg, align 8, !tbaa !60
  %i.ch = getelementptr inbounds nuw i8, ptr %28, i64 24
  store ptr %44, ptr %i.ch, align 8, !tbaa !62
...
bb.j:                                             ; preds = %bb.i
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %29) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %44) #15
  %i.ci = load ptr, ptr %1, align 8, !tbaa !506, !noalias !529
  %i.cj = load i64, ptr %i.d, align 8, !tbaa !503, !noalias !529 ; 2 uses
  %.idx1228 = mul nsw i64 %i.cj, 12
  %i.ck = getelementptr inbounds i8, ptr %i.ci, i64 %.idx1228
  call void @llvm.lifetime.start.p0(ptr nonnull %45) #15
  %sext146 = mul i64 %i.e, 12884901888
  ...
  %i.cm = load ptr, ptr %39, align 8, !tbaa !39, !noalias !532
  %i.cn = getelementptr inbounds [4 x i8], ptr %i.cm, i64 %i.cl ; 2 uses
  %i.co = load i64, ptr %i.al, align 8, !tbaa !41, !noalias !532 ; 2 uses
  store ptr %i.cn, ptr %45, align 8, !tbaa !42, !alias.scope !532
  %i.cp = getelementptr inbounds nuw i8, ptr %45, i64 8
  store i64 %i.aj, ptr %i.cp, align 8, !tbaa !45, !alias.scope !532
  %i.cq = getelementptr inbounds nuw i8, ptr %45, i64 16
  store i64 1, ptr %i.cq, align 8, !tbaa !45, !alias.scope !532
  %i.cr = getelementptr inbounds nuw i8, ptr %45, i64 24
  store ptr %39, ptr %i.cr, align 8, !tbaa !46, !alias.scope !532
  %i.cs = getelementptr inbounds nuw i8, ptr %45, i64 32
  store i64 %i.cl, ptr %i.cs, align 8, !tbaa !45, !alias.scope !532
  %i.ct = getelementptr inbounds nuw i8, ptr %45, i64 40
  store i64 0, ptr %i.ct, align 8, !tbaa !45, !alias.scope !532
  %i.cu = getelementptr inbounds nuw i8, ptr %45, i64 48
  store i64 %i.co, ptr %i.cu, align 8, !tbaa !48, !alias.scope !532
  call void @llvm.lifetime.start.p0(ptr nonnull %25) #15
  call void @llvm.lifetime.start.p0(ptr nonnull %22) #15
  store ptr %i.ck, ptr %22, align 8, !tbaa !513
  %i.cv = getelementptr inbounds nuw i8, ptr %22, i64 16
  store i64 %i.cj, ptr %i.cv, align 8, !tbaa !45
  call void @llvm.lifetime.start.p0(ptr nonnull %23) #15
  store ptr %i.cn, ptr %23, align 8, !tbaa !54
  ...
  store ptr %23, ptr %24, align 8, !tbaa !56
  %i.cx = getelementptr inbounds nuw i8, ptr %24, i64 8
  store ptr %22, ptr %i.cx, align 8, !tbaa !515
  %i.cy = getelementptr inbounds nuw i8, ptr %24, i64 16
  store ptr %25, ptr %i.cy, align 8, !tbaa !60
  %i.cz = getelementptr inbounds nuw i8, ptr %24, i64 24
  store ptr %45, ptr %i.cz, align 8, !tbaa !62
...
begin_hunk_2_@_ZN5Eigen8internal21dense_assignment_loopINS0_31generic_dense_assignment_kernelINS0_9evaluatorINS_5BlockINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEELin1ELin1ELb0EEEEENS3_INS_14CwiseNullaryOpINS0_18scalar_constant_opIdEENS5_IdLin1ELin1ELi0ELin1ELi1EEEEEEENS0_13div_assign_opIddEELi0EEELi4ELi0EE3runERSH_:bb.a
  %i.bk = load ptr, ptr %i.bj, align 8, !tbaa !968, !nonnull !936, !align !937
...
.preheader43.loopexit:                            ; preds = %bb.c
  %i.bz = load ptr, ptr %i.bs, align 8, !tbaa !969, !nonnull !936, !align !937
  %i.ca = load ptr, ptr %0, align 8, !tbaa !970, !nonnull !936, !align !937 ; 2 uses
  %i.cb = load ptr, ptr %i.ca, align 8, !tbaa !490
  ...
  %i.cg = load double, ptr %i.bz, align 8, !tbaa !488
  %i.ch = load double, ptr %i.cf, align 8, !tbaa !23
  %i.ci = fdiv double %i.ch, %i.cg
  store double %i.ci, ptr %i.cf, align 8, !tbaa !23
...
.lr.ph49:                                         ; preds = %.preheader
  %i.cl = load ptr, ptr %0, align 8, !tbaa !970, !nonnull !936, !align !937 ; 2 uses
  %i.cm = load ptr, ptr %i.cl, align 8, !tbaa !490 ; 3 uses
  %i.cn = getelementptr inbounds nuw i8, ptr %i.cl, i64 16
  %i.co = load i64, ptr %i.cn, align 8, !tbaa !45 ; 2 uses
  %i.cp = mul nsw i64 %i.co, %.03451
  %i.cq = getelementptr [8 x i8], ptr %i.cm, i64 %i.cp ; 2 uses
  %i.cr = load ptr, ptr %i.bs, align 8, !tbaa !969, !nonnull !936, !align !937 ; 4 uses
  %i.cs = and i64 %i.bv, -2
  %i.ct = add i64 %.03550, %i.cs
  %i.cu = sub i64 %i.bg, %i.ct                    ; 3 uses
  %min.iters.check73 = icmp ult i64 %i.cu, 2
  br i1 %min.iters.check73, label %scalar.ph72.preheader, label %vector.memcheck64

vector.memcheck64:                                ; preds = %.lr.ph49
  %i.cv = mul i64 %i.co, %i.bu                    ; 2 uses
  %i.cw = shl i64 %i.bv, 3
  %i.cx = and i64 %i.cw, -16
  %i.cy = shl i64 %.03550, 3
  %i.cz = getelementptr i8, ptr %i.cm, i64 %i.cv
  %i.da = getelementptr i8, ptr %i.cz, i64 %i.cx
  %scevgep65 = getelementptr i8, ptr %i.da, i64 %i.cy
  %scevgep66 = getelementptr i8, ptr %i.cm, i64 %i.bt
  %scevgep67 = getelementptr i8, ptr %scevgep66, i64 %i.cv
...
vector.ph74:                                      ; preds = %vector.memcheck64
  %n.vec75 = and i64 %i.cu, -2                    ; 3 uses
  %i.db = add i64 %i.bx, %n.vec75
  %i.dc = load double, ptr %i.cr, align 8, !tbaa !488, !alias.scope !971
  ...
  %i.dd = getelementptr [8 x i8], ptr %i.cq, i64 %i.bx
...
vector.body76:                                    ; preds = %vector.body76, %vector.ph74
  ...
  %i.de = getelementptr [8 x i8], ptr %i.dd, i64 %index77 ; 2 uses
  %wide.load78 = load <2 x double>, ptr %i.de, align 8, !tbaa !23, !alias.scope !974, !noalias !971
  %i.df = fdiv <2 x double> %wide.load78, %broadcast.splat80
  store <2 x double> %i.df, ptr %i.de, align 8, !tbaa !23, !alias.scope !974, !noalias !971
  %index.next81 = add nuw i64 %index77, 2         ; 2 uses
  %i.dg = icmp eq i64 %index.next81, %n.vec75
  br i1 %i.dg, label %middle.block82, label %vector.body76, !llvm.loop !976

middle.block82:                                   ; preds = %vector.body76
  %cmp.n83 = icmp eq i64 %i.cu, %n.vec75
...
scalar.ph72.preheader:                            ; preds = %vector.memcheck64, %.lr.ph49, %middle.block82
  %.048.ph = phi i64 [ %i.bx, %vector.memcheck64 ], [ %i.bx, %.lr.ph49 ], [ %i.db, %middle.block82 ]
  br label %scalar.ph72

.lr.ph47:                                         ; preds = %.preheader43, %.lr.ph47
  %.03246 = phi i64 [ %i.du, %.lr.ph47 ], [ %.03550, %.preheader43 ] ; 2 uses
  %i.dh = load ptr, ptr %0, align 8, !tbaa !970, !nonnull !936, !align !937 ; 2 uses
  %i.di = load ptr, ptr %i.dh, align 8, !tbaa !490
  %i.dj = getelementptr inbounds nuw i8, ptr %i.dh, i64 16
  %i.dk = load i64, ptr %i.dj, align 8, !tbaa !45
  %i.dl = mul nsw i64 %i.dk, %.03451
  %i.dm = getelementptr [8 x i8], ptr %i.di, i64 %i.dl
  %i.dn = getelementptr [8 x i8], ptr %i.dm, i64 %.03246 ; 2 uses
  %i.do = load ptr, ptr %i.bs, align 8, !tbaa !969, !nonnull !936, !align !937
  %i.dp = load double, ptr %i.do, align 8, !tbaa !23
  ...
  %i.ds = load <2 x double>, ptr %i.dn, align 16, !tbaa !30
  %i.dt = fdiv <2 x double> %i.ds, %i.dr
  store <2 x double> %i.dt, ptr %i.dn, align 16, !tbaa !30
  %i.du = add nsw i64 %.03246, 2                  ; 2 uses
  %i.dv = icmp slt i64 %i.du, %i.bx
  br i1 %i.dv, label %.lr.ph47, label %.preheader, !llvm.loop !977

._crit_edge:                                      ; preds = %scalar.ph72, %middle.block82, %.preheader
  %i.dw = add nsw i64 %.03550, %i.bn
  %i.dx = srem i64 %i.dw, 2
  %.sroa.speculated = tail call i64 @llvm.smin.i64(i64 %i.bg, i64 %i.dx)
  %i.dy = add nuw nsw i64 %.03451, 1              ; 2 uses
  %exitcond54.not = icmp eq i64 %i.dy, %i.bi
  br i1 %exitcond54.not, label %_ZN5Eigen8internal21dense_assignment_loopINS0_31generic_dense_assignment_kernelINS0_9evaluatorINS_5BlockINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEELin1ELin1ELb0EEEEENS3_INS_14CwiseNullaryOpINS0_18scalar_constant_opIdEENS5_IdLin1ELin1ELi0ELin1ELi1EEEEEEENS0_13div_assign_opIddEELi0EEELi0ELi0EE3runERSH_.exit, label %bb.c, !llvm.loop !978

scalar.ph72:                                      ; preds = %scalar.ph72.preheader, %scalar.ph72
  %.048 = phi i64 [ %i.ed, %scalar.ph72 ], [ %.048.ph, %scalar.ph72.preheader ] ; 2 uses
  %i.dz = getelementptr [8 x i8], ptr %i.cq, i64 %.048 ; 2 uses
  %i.ea = load double, ptr %i.cr, align 8, !tbaa !488
  %i.eb = load double, ptr %i.dz, align 8, !tbaa !23
  %i.ec = fdiv double %i.eb, %i.ea
  store double %i.ec, ptr %i.dz, align 8, !tbaa !23
  %i.ed = add nsw i64 %.048, 1                    ; 2 uses
  %i.ee = icmp slt i64 %i.ed, %i.bg
  br i1 %i.ee, label %scalar.ph72, label %._crit_edge, !llvm.loop !979
...
bb.a:
  ...
  %47 = alloca %"class.Eigen::Block.91", align 8  ; 11 uses
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.b = load i64, ptr %i.a, align 8, !tbaa !980  ; 5 uses
  %i.c = trunc i64 %i.b to i32                    ; 2 uses
  %i.d = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 37 uses
  %i.e = load i64, ptr %i.d, align 8, !tbaa !503  ; 4 uses
  %i.f = trunc i64 %i.e to i32                    ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.v = icmp eq i64 %index.next, %n.vec
  br i1 %i.v, label %middle.block, label %vector.body, !llvm.loop !982
...
.lr.ph.i.i.i.i.i.i.i.i.i:                         ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i.preheader2354, %.lr.ph.i.i.i.i.i.i.i.i.i
  ...
  %i.z = add nsw i64 %.05.i.i.i.i.i.i.i.i.i, 1    ; 2 uses
  %exitcond.not.i.i.i.i.i.i.i.i.i = icmp eq i64 %i.z, %i.i
  br i1 %exitcond.not.i.i.i.i.i.i.i.i.i, label %.loopexit1258, label %.lr.ph.i.i.i.i.i.i.i.i.i, !llvm.loop !983
...
bb.g:                                             ; preds = %bb.f
  %i.ai = load ptr, ptr %1, align 8, !tbaa !506, !noalias !984
  call void @llvm.lifetime.start.p0(ptr nonnull %42) #15
  call void @llvm.experimental.noalias.scope.decl(metadata !987)
  %sext1226 = shl i64 %i.e, 32
  %i.aj = ashr exact i64 %sext1226, 32            ; 6 uses
  %i.ak = load ptr, ptr %39, align 8, !tbaa !39, !noalias !987 ; 2 uses
  %i.al = getelementptr inbounds nuw i8, ptr %39, i64 8 ; 5 uses
  %i.am = load i64, ptr %i.al, align 8, !tbaa !41, !noalias !987 ; 2 uses
  store ptr %i.ak, ptr %42, align 8, !tbaa !42, !alias.scope !987
  %i.an = getelementptr inbounds nuw i8, ptr %42, i64 8
  store i64 %i.aj, ptr %i.an, align 8, !tbaa !45, !alias.scope !987
  %i.ao = getelementptr inbounds nuw i8, ptr %42, i64 16
  store i64 1, ptr %i.ao, align 8, !tbaa !45, !alias.scope !987
  %i.ap = getelementptr inbounds nuw i8, ptr %42, i64 24
  store ptr %39, ptr %i.ap, align 8, !tbaa !46, !alias.scope !987
  %i.aq = getelementptr inbounds nuw i8, ptr %42, i64 32
  %i.ar = getelementptr inbounds nuw i8, ptr %42, i64 48
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.aq, i8 0, i64 16, i1 false)
  store i64 %i.am, ptr %i.ar, align 8, !tbaa !48, !alias.scope !987
  call void @llvm.lifetime.start.p0(ptr nonnull %37) #15
  call void @llvm.lifetime.start.p0(ptr nonnull %34) #15
  store ptr %i.ai, ptr %34, align 8, !tbaa !513
  %i.as = getelementptr inbounds nuw i8, ptr %34, i64 16
...
bb.h:                                             ; preds = %bb.g
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %37) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %42) #15
  %i.ay = load ptr, ptr %1, align 8, !tbaa !506, !noalias !990
  %i.az = load i64, ptr %i.d, align 8, !tbaa !503, !noalias !990 ; 2 uses
  %i.ba = getelementptr inbounds [4 x i8], ptr %i.ay, i64 %i.az
  call void @llvm.lifetime.start.p0(ptr nonnull %43) #15
  call void @llvm.experimental.noalias.scope.decl(metadata !993)
  %i.bb = load ptr, ptr %39, align 8, !tbaa !39, !noalias !993
  %i.bc = getelementptr inbounds [4 x i8], ptr %i.bb, i64 %i.aj ; 2 uses
  %i.bd = load i64, ptr %i.al, align 8, !tbaa !41, !noalias !993 ; 2 uses
  store ptr %i.bc, ptr %43, align 8, !tbaa !42, !alias.scope !993
  %i.be = getelementptr inbounds nuw i8, ptr %43, i64 8
  store i64 %i.aj, ptr %i.be, align 8, !tbaa !45, !alias.scope !993
  %i.bf = getelementptr inbounds nuw i8, ptr %43, i64 16
  store i64 1, ptr %i.bf, align 8, !tbaa !45, !alias.scope !993
  %i.bg = getelementptr inbounds nuw i8, ptr %43, i64 24
  store ptr %39, ptr %i.bg, align 8, !tbaa !46, !alias.scope !993
  %i.bh = getelementptr inbounds nuw i8, ptr %43, i64 32
  store i64 %i.aj, ptr %i.bh, align 8, !tbaa !45, !alias.scope !993
  %i.bi = getelementptr inbounds nuw i8, ptr %43, i64 40
  store i64 0, ptr %i.bi, align 8, !tbaa !45, !alias.scope !993
  %i.bj = getelementptr inbounds nuw i8, ptr %43, i64 48
  store i64 %i.bd, ptr %i.bj, align 8, !tbaa !48, !alias.scope !993
  call void @llvm.lifetime.start.p0(ptr nonnull %33) #15
  call void @llvm.lifetime.start.p0(ptr nonnull %30) #15
  store ptr %i.ba, ptr %30, align 8, !tbaa !513
  %i.bk = getelementptr inbounds nuw i8, ptr %30, i64 16
...
bb.i:                                             ; preds = %bb.h
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %33) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %43) #15
  %i.bp = load ptr, ptr %1, align 8, !tbaa !506, !noalias !996
  %i.bq = load i64, ptr %i.d, align 8, !tbaa !503, !noalias !996 ; 2 uses
  %.idx1227 = shl nsw i64 %i.bq, 3
  %i.br = getelementptr inbounds i8, ptr %i.bp, i64 %.idx1227
  call void @llvm.lifetime.start.p0(ptr nonnull %44) #15
  %i.bs = shl nsw i32 %i.f, 1
  ...
  %i.bu = load ptr, ptr %39, align 8, !tbaa !39, !noalias !999
  %i.bv = getelementptr inbounds [4 x i8], ptr %i.bu, i64 %i.bt ; 2 uses
  %i.bw = load i64, ptr %i.al, align 8, !tbaa !41, !noalias !999 ; 2 uses
  store ptr %i.bv, ptr %44, align 8, !tbaa !42, !alias.scope !999
  %i.bx = getelementptr inbounds nuw i8, ptr %44, i64 8
  store i64 %i.aj, ptr %i.bx, align 8, !tbaa !45, !alias.scope !999
  %i.by = getelementptr inbounds nuw i8, ptr %44, i64 16
  store i64 1, ptr %i.by, align 8, !tbaa !45, !alias.scope !999
  %i.bz = getelementptr inbounds nuw i8, ptr %44, i64 24
  store ptr %39, ptr %i.bz, align 8, !tbaa !46, !alias.scope !999
  %i.ca = getelementptr inbounds nuw i8, ptr %44, i64 32
  store i64 %i.bt, ptr %i.ca, align 8, !tbaa !45, !alias.scope !999
  %i.cb = getelementptr inbounds nuw i8, ptr %44, i64 40
  store i64 0, ptr %i.cb, align 8, !tbaa !45, !alias.scope !999
  %i.cc = getelementptr inbounds nuw i8, ptr %44, i64 48
  store i64 %i.bw, ptr %i.cc, align 8, !tbaa !48, !alias.scope !999
  call void @llvm.lifetime.start.p0(ptr nonnull %29) #15
  call void @llvm.lifetime.start.p0(ptr nonnull %26) #15
  store ptr %i.br, ptr %26, align 8, !tbaa !513
  %i.cd = getelementptr inbounds nuw i8, ptr %26, i64 16
...
bb.j:                                             ; preds = %bb.i
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %29) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %44) #15
  %i.ci = load ptr, ptr %1, align 8, !tbaa !506, !noalias !1002
  %i.cj = load i64, ptr %i.d, align 8, !tbaa !503, !noalias !1002 ; 2 uses
  %.idx1228 = mul nsw i64 %i.cj, 12
  %i.ck = getelementptr inbounds i8, ptr %i.ci, i64 %.idx1228
  call void @llvm.lifetime.start.p0(ptr nonnull %45) #15
  %sext146 = mul i64 %i.e, 12884901888
  ...
  %i.cm = load ptr, ptr %39, align 8, !tbaa !39, !noalias !1005
  %i.cn = getelementptr inbounds [4 x i8], ptr %i.cm, i64 %i.cl ; 2 uses
  %i.co = load i64, ptr %i.al, align 8, !tbaa !41, !noalias !1005 ; 2 uses
  store ptr %i.cn, ptr %45, align 8, !tbaa !42, !alias.scope !1005
  %i.cp = getelementptr inbounds nuw i8, ptr %45, i64 8
  store i64 %i.aj, ptr %i.cp, align 8, !tbaa !45, !alias.scope !1005
  %i.cq = getelementptr inbounds nuw i8, ptr %45, i64 16
  store i64 1, ptr %i.cq, align 8, !tbaa !45, !alias.scope !1005
  %i.cr = getelementptr inbounds nuw i8, ptr %45, i64 24
  store ptr %39, ptr %i.cr, align 8, !tbaa !46, !alias.scope !1005
  %i.cs = getelementptr inbounds nuw i8, ptr %45, i64 32
  store i64 %i.cl, ptr %i.cs, align 8, !tbaa !45, !alias.scope !1005
  %i.ct = getelementptr inbounds nuw i8, ptr %45, i64 40
  store i64 0, ptr %i.ct, align 8, !tbaa !45, !alias.scope !1005
  %i.cu = getelementptr inbounds nuw i8, ptr %45, i64 48
  store i64 %i.co, ptr %i.cu, align 8, !tbaa !48, !alias.scope !1005
  call void @llvm.lifetime.start.p0(ptr nonnull %25) #15
  call void @llvm.lifetime.start.p0(ptr nonnull %22) #15
  store ptr %i.ck, ptr %22, align 8, !tbaa !513
  %i.cv = getelementptr inbounds nuw i8, ptr %22, i64 16
...
begin_hunk_3_@_ZN5Eigen8internal21dense_assignment_loopINS0_31generic_dense_assignment_kernelINS0_9evaluatorINS_5BlockINS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELin1ELin1ELb0EEEEENS3_INS4_IKNS5_IiLin1ELi4ELi0ELin1ELi4EEELin1ELi1ELb1EEEEENS0_9assign_opIiiEELi0EEELi4ELi0EE3runERSF_:bb.a
  ...
  br i1 %i.dk, label %.preheader43, label %scalar.ph83

.preheader43:                                     ; preds = %scalar.ph83.prol.loopexit, %scalar.ph83, %middle.block92, %bb.c
  %i.dl = icmp sgt i64 %i.cd, 3
  br i1 %i.dl, label %.lr.ph47, label %.preheader

scalar.ph83:                                      ; preds = %scalar.ph83.prol.loopexit, %scalar.ph83
  %.03345 = phi i64 [ %i.eb, %scalar.ph83 ], [ %.03345.unr, %scalar.ph83.prol.loopexit ] ; 6 uses
  ...
  store i32 %i.do, ptr %i.dm, align 4, !tbaa !82
  ...
  %i.dw = load i32, ptr %i.dv, align 4, !tbaa !82
  store i32 %i.dw, ptr %i.du, align 4, !tbaa !82
  ...
  %i.ea = load i32, ptr %i.dz, align 4, !tbaa !82
  store i32 %i.ea, ptr %i.dy, align 4, !tbaa !82
  %i.eb = add nuw nsw i64 %.03345, 4              ; 2 uses
  %exitcond.not.3 = icmp eq i64 %i.eb, %.03550
  br i1 %exitcond.not.3, label %.preheader43, label %scalar.ph83, !llvm.loop !1419
...
.lr.ph49:                                         ; preds = %.preheader
  %i.ed = load ptr, ptr %0, align 8, !tbaa !1415, !nonnull !936, !align !937 ; 2 uses
  %i.ee = load ptr, ptr %i.ed, align 8, !tbaa !54 ; 2 uses
  %i.ef = getelementptr inbounds nuw i8, ptr %i.ed, i64 16
  %i.eg = load i64, ptr %i.ef, align 8, !tbaa !45 ; 2 uses
  %i.eh = mul nsw i64 %i.eg, %.03451
  %i.ei = getelementptr [4 x i8], ptr %i.ee, i64 %i.eh ; 2 uses
  %i.ej = load ptr, ptr %i.ca, align 8, !tbaa !1416, !nonnull !936, !align !937 ; 2 uses
  %i.ek = load ptr, ptr %i.ej, align 8, !tbaa !51 ; 2 uses
  %i.el = getelementptr inbounds nuw i8, ptr %i.ej, i64 16
  %i.em = load i64, ptr %i.el, align 8, !tbaa !45 ; 2 uses
  %i.en = mul nsw i64 %i.em, %.03451
  %i.eo = getelementptr [4 x i8], ptr %i.ek, i64 %i.en ; 2 uses
  %i.ep = and i64 %i.cd, -4
  %i.eq = add i64 %.03550, %i.ep
  %i.er = sub i64 %i.bm, %i.eq                    ; 3 uses
  %min.iters.check70 = icmp ult i64 %i.er, 12
  br i1 %min.iters.check70, label %scalar.ph69.preheader, label %vector.memcheck68

vector.memcheck68:                                ; preds = %.lr.ph49
  %i.es = ptrtoaddr ptr %i.ek to i64
  %i.et = ptrtoaddr ptr %i.ee to i64
  %i.eu = mul i64 %i.eg, %i.cc
  %i.ev = add i64 %i.eu, %i.et
  %i.ew = mul i64 %i.em, %i.cc
  %i.ex = add i64 %i.ew, %i.es
  %i.ey = sub i64 %i.ex, %i.ev
  %diff.check = icmp ugt i64 %i.ey, -32
  br i1 %diff.check, label %scalar.ph69.preheader, label %vector.ph71

vector.ph71:                                      ; preds = %vector.memcheck68
  %n.vec72 = and i64 %i.er, -8                    ; 3 uses
  %i.ez = add i64 %i.cf, %n.vec72
...
vector.body73:                                    ; preds = %vector.body73, %vector.ph71
  ...
  %i.fa = add i64 %i.cf, %index74                 ; 2 uses
  %i.fb = getelementptr [4 x i8], ptr %i.ei, i64 %i.fa ; 2 uses
  %i.fc = getelementptr [4 x i8], ptr %i.eo, i64 %i.fa ; 2 uses
  %i.fd = getelementptr i8, ptr %i.fc, i64 16
  %wide.load75 = load <4 x i32>, ptr %i.fc, align 4, !tbaa !82
  %wide.load76 = load <4 x i32>, ptr %i.fd, align 4, !tbaa !82
  %i.fe = getelementptr i8, ptr %i.fb, i64 16
  store <4 x i32> %wide.load75, ptr %i.fb, align 4, !tbaa !82
  store <4 x i32> %wide.load76, ptr %i.fe, align 4, !tbaa !82
  %index.next77 = add nuw i64 %index74, 8         ; 2 uses
  %i.ff = icmp eq i64 %index.next77, %n.vec72
  br i1 %i.ff, label %middle.block78, label %vector.body73, !llvm.loop !1420

middle.block78:                                   ; preds = %vector.body73
  %cmp.n79 = icmp eq i64 %i.er, %n.vec72
  br i1 %cmp.n79, label %._crit_edge, label %scalar.ph69.preheader

scalar.ph69.preheader:                            ; preds = %vector.memcheck68, %.lr.ph49, %middle.block78
  %.048.ph = phi i64 [ %i.cf, %vector.memcheck68 ], [ %i.cf, %.lr.ph49 ], [ %i.ez, %middle.block78 ]
  br label %scalar.ph69

.lr.ph47:                                         ; preds = %.preheader43, %.lr.ph47
  %.03246 = phi i64 [ %i.fv, %.lr.ph47 ], [ %.03550, %.preheader43 ] ; 3 uses
  %i.fg = load ptr, ptr %0, align 8, !tbaa !1415, !nonnull !936, !align !937 ; 2 uses
  %i.fh = load ptr, ptr %i.fg, align 8, !tbaa !54
  %i.fi = getelementptr inbounds nuw i8, ptr %i.fg, i64 16
  %i.fj = load i64, ptr %i.fi, align 8, !tbaa !45
  %i.fk = mul nsw i64 %i.fj, %.03451
  %i.fl = getelementptr [4 x i8], ptr %i.fh, i64 %i.fk
  %i.fm = getelementptr [4 x i8], ptr %i.fl, i64 %.03246
  %i.fn = load ptr, ptr %i.ca, align 8, !tbaa !1416, !nonnull !936, !align !937 ; 2 uses
  %i.fo = load ptr, ptr %i.fn, align 8, !tbaa !51
  %i.fp = getelementptr inbounds [4 x i8], ptr %i.fo, i64 %.03246
  %i.fq = getelementptr inbounds nuw i8, ptr %i.fn, i64 16
  %i.fr = load i64, ptr %i.fq, align 8, !tbaa !45
  %i.fs = mul nsw i64 %i.fr, %.03451
  %i.ft = getelementptr inbounds [4 x i8], ptr %i.fp, i64 %i.fs
  %i.fu = load <2 x i64>, ptr %i.ft, align 1, !tbaa !30
  store <2 x i64> %i.fu, ptr %i.fm, align 16, !tbaa !30
  %i.fv = add nsw i64 %.03246, 4                  ; 2 uses
  %i.fw = icmp slt i64 %i.fv, %i.cf
  br i1 %i.fw, label %.lr.ph47, label %.preheader, !llvm.loop !1421

._crit_edge:                                      ; preds = %scalar.ph69, %middle.block78, %.preheader
  %i.fx = add nsw i64 %.03550, %i.bu
  %i.fy = srem i64 %i.fx, 4
  %.sroa.speculated = tail call i64 @llvm.smin.i64(i64 %i.bm, i64 %i.fy)
  %i.fz = add nuw nsw i64 %.03451, 1              ; 2 uses
  %exitcond56.not = icmp eq i64 %i.fz, %i.bo
  br i1 %exitcond56.not, label %_ZN5Eigen8internal21dense_assignment_loopINS0_31generic_dense_assignment_kernelINS0_9evaluatorINS_5BlockINS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELin1ELin1ELb0EEEEENS3_INS4_IKNS5_IiLin1ELi4ELi0ELin1ELi4EEELin1ELi1ELb1EEEEENS0_9assign_opIiiEELi0EEELi0ELi0EE3runERSF_.exit, label %bb.c, !llvm.loop !1422

scalar.ph69:                                      ; preds = %scalar.ph69.preheader, %scalar.ph69
  %.048 = phi i64 [ %i.gd, %scalar.ph69 ], [ %.048.ph, %scalar.ph69.preheader ] ; 3 uses
  %i.ga = getelementptr [4 x i8], ptr %i.ei, i64 %.048
  %i.gb = getelementptr [4 x i8], ptr %i.eo, i64 %.048
  %i.gc = load i32, ptr %i.gb, align 4, !tbaa !82
  store i32 %i.gc, ptr %i.ga, align 4, !tbaa !82
  %i.gd = add nsw i64 %.048, 1                    ; 2 uses
  %i.ge = icmp slt i64 %i.gd, %i.bm
  br i1 %i.ge, label %scalar.ph69, label %._crit_edge, !llvm.loop !1423
...
bb.a:
  ...
  %47 = alloca %"class.Eigen::Block.91", align 8  ; 11 uses
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.b = load i64, ptr %i.a, align 8, !tbaa !1424 ; 5 uses
  %i.c = trunc i64 %i.b to i32                    ; 2 uses
  %i.d = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 37 uses
  %i.e = load i64, ptr %i.d, align 8, !tbaa !503  ; 4 uses
  %i.f = trunc i64 %i.e to i32                    ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.v = icmp eq i64 %index.next, %n.vec
  br i1 %i.v, label %middle.block, label %vector.body, !llvm.loop !1426
...
.lr.ph.i.i.i.i.i.i.i.i.i:                         ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i.preheader2354, %.lr.ph.i.i.i.i.i.i.i.i.i
  ...
  %i.z = add nsw i64 %.05.i.i.i.i.i.i.i.i.i, 1    ; 2 uses
  %exitcond.not.i.i.i.i.i.i.i.i.i = icmp eq i64 %i.z, %i.i
  br i1 %exitcond.not.i.i.i.i.i.i.i.i.i, label %.loopexit1258, label %.lr.ph.i.i.i.i.i.i.i.i.i, !llvm.loop !1427
...
bb.g:                                             ; preds = %bb.f
  %i.ai = load ptr, ptr %1, align 8, !tbaa !506, !noalias !1428
  call void @llvm.lifetime.start.p0(ptr nonnull %42) #15
  call void @llvm.experimental.noalias.scope.decl(metadata !1431)
  %sext1226 = shl i64 %i.e, 32
  %i.aj = ashr exact i64 %sext1226, 32            ; 6 uses
  %i.ak = load ptr, ptr %39, align 8, !tbaa !39, !noalias !1431 ; 2 uses
  %i.al = getelementptr inbounds nuw i8, ptr %39, i64 8 ; 5 uses
  %i.am = load i64, ptr %i.al, align 8, !tbaa !41, !noalias !1431 ; 2 uses
  store ptr %i.ak, ptr %42, align 8, !tbaa !42, !alias.scope !1431
  %i.an = getelementptr inbounds nuw i8, ptr %42, i64 8
  store i64 %i.aj, ptr %i.an, align 8, !tbaa !45, !alias.scope !1431
  %i.ao = getelementptr inbounds nuw i8, ptr %42, i64 16
  store i64 1, ptr %i.ao, align 8, !tbaa !45, !alias.scope !1431
  %i.ap = getelementptr inbounds nuw i8, ptr %42, i64 24
  store ptr %39, ptr %i.ap, align 8, !tbaa !46, !alias.scope !1431
  %i.aq = getelementptr inbounds nuw i8, ptr %42, i64 32
  %i.ar = getelementptr inbounds nuw i8, ptr %42, i64 48
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.aq, i8 0, i64 16, i1 false)
  store i64 %i.am, ptr %i.ar, align 8, !tbaa !48, !alias.scope !1431
  call void @llvm.lifetime.start.p0(ptr nonnull %37) #15
  call void @llvm.lifetime.start.p0(ptr nonnull %34) #15
  store ptr %i.ai, ptr %34, align 8, !tbaa !513
  %i.as = getelementptr inbounds nuw i8, ptr %34, i64 16
...
bb.h:                                             ; preds = %bb.g
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %37) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %42) #15
  %i.ay = load ptr, ptr %1, align 8, !tbaa !506, !noalias !1434
  %i.az = load i64, ptr %i.d, align 8, !tbaa !503, !noalias !1434 ; 2 uses
  %i.ba = getelementptr inbounds [4 x i8], ptr %i.ay, i64 %i.az
  call void @llvm.lifetime.start.p0(ptr nonnull %43) #15
  call void @llvm.experimental.noalias.scope.decl(metadata !1437)
  %i.bb = load ptr, ptr %39, align 8, !tbaa !39, !noalias !1437
  %i.bc = getelementptr inbounds [4 x i8], ptr %i.bb, i64 %i.aj ; 2 uses
  %i.bd = load i64, ptr %i.al, align 8, !tbaa !41, !noalias !1437 ; 2 uses
  store ptr %i.bc, ptr %43, align 8, !tbaa !42, !alias.scope !1437
  %i.be = getelementptr inbounds nuw i8, ptr %43, i64 8
  store i64 %i.aj, ptr %i.be, align 8, !tbaa !45, !alias.scope !1437
  %i.bf = getelementptr inbounds nuw i8, ptr %43, i64 16
  store i64 1, ptr %i.bf, align 8, !tbaa !45, !alias.scope !1437
  %i.bg = getelementptr inbounds nuw i8, ptr %43, i64 24
  store ptr %39, ptr %i.bg, align 8, !tbaa !46, !alias.scope !1437
  %i.bh = getelementptr inbounds nuw i8, ptr %43, i64 32
  store i64 %i.aj, ptr %i.bh, align 8, !tbaa !45, !alias.scope !1437
  %i.bi = getelementptr inbounds nuw i8, ptr %43, i64 40
  store i64 0, ptr %i.bi, align 8, !tbaa !45, !alias.scope !1437
  %i.bj = getelementptr inbounds nuw i8, ptr %43, i64 48
  store i64 %i.bd, ptr %i.bj, align 8, !tbaa !48, !alias.scope !1437
  call void @llvm.lifetime.start.p0(ptr nonnull %33) #15
  call void @llvm.lifetime.start.p0(ptr nonnull %30) #15
  store ptr %i.ba, ptr %30, align 8, !tbaa !513
  %i.bk = getelementptr inbounds nuw i8, ptr %30, i64 16
...
bb.i:                                             ; preds = %bb.h
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %33) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %43) #15
  %i.bp = load ptr, ptr %1, align 8, !tbaa !506, !noalias !1440
  %i.bq = load i64, ptr %i.d, align 8, !tbaa !503, !noalias !1440 ; 2 uses
  %.idx1227 = shl nsw i64 %i.bq, 3
  %i.br = getelementptr inbounds i8, ptr %i.bp, i64 %.idx1227
  call void @llvm.lifetime.start.p0(ptr nonnull %44) #15
  %i.bs = shl nsw i32 %i.f, 1
  ...
  %i.bu = load ptr, ptr %39, align 8, !tbaa !39, !noalias !1443
  %i.bv = getelementptr inbounds [4 x i8], ptr %i.bu, i64 %i.bt ; 2 uses
  %i.bw = load i64, ptr %i.al, align 8, !tbaa !41, !noalias !1443 ; 2 uses
  store ptr %i.bv, ptr %44, align 8, !tbaa !42, !alias.scope !1443
  %i.bx = getelementptr inbounds nuw i8, ptr %44, i64 8
  store i64 %i.aj, ptr %i.bx, align 8, !tbaa !45, !alias.scope !1443
  %i.by = getelementptr inbounds nuw i8, ptr %44, i64 16
  store i64 1, ptr %i.by, align 8, !tbaa !45, !alias.scope !1443
  %i.bz = getelementptr inbounds nuw i8, ptr %44, i64 24
  store ptr %39, ptr %i.bz, align 8, !tbaa !46, !alias.scope !1443
  %i.ca = getelementptr inbounds nuw i8, ptr %44, i64 32
  store i64 %i.bt, ptr %i.ca, align 8, !tbaa !45, !alias.scope !1443
  %i.cb = getelementptr inbounds nuw i8, ptr %44, i64 40
  store i64 0, ptr %i.cb, align 8, !tbaa !45, !alias.scope !1443
  %i.cc = getelementptr inbounds nuw i8, ptr %44, i64 48
  store i64 %i.bw, ptr %i.cc, align 8, !tbaa !48, !alias.scope !1443
  call void @llvm.lifetime.start.p0(ptr nonnull %29) #15
  call void @llvm.lifetime.start.p0(ptr nonnull %26) #15
  store ptr %i.br, ptr %26, align 8, !tbaa !513
  %i.cd = getelementptr inbounds nuw i8, ptr %26, i64 16
...
bb.j:                                             ; preds = %bb.i
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %29) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %44) #15
  %i.ci = load ptr, ptr %1, align 8, !tbaa !506, !noalias !1446
  %i.cj = load i64, ptr %i.d, align 8, !tbaa !503, !noalias !1446 ; 2 uses
  %.idx1228 = mul nsw i64 %i.cj, 12
  %i.ck = getelementptr inbounds i8, ptr %i.ci, i64 %.idx1228
  call void @llvm.lifetime.start.p0(ptr nonnull %45) #15
  %sext146 = mul i64 %i.e, 12884901888
  ...
  %i.cm = load ptr, ptr %39, align 8, !tbaa !39, !noalias !1449
  %i.cn = getelementptr inbounds [4 x i8], ptr %i.cm, i64 %i.cl ; 2 uses
  %i.co = load i64, ptr %i.al, align 8, !tbaa !41, !noalias !1449 ; 2 uses
  store ptr %i.cn, ptr %45, align 8, !tbaa !42, !alias.scope !1449
  %i.cp = getelementptr inbounds nuw i8, ptr %45, i64 8
  store i64 %i.aj, ptr %i.cp, align 8, !tbaa !45, !alias.scope !1449
  %i.cq = getelementptr inbounds nuw i8, ptr %45, i64 16
  store i64 1, ptr %i.cq, align 8, !tbaa !45, !alias.scope !1449
  %i.cr = getelementptr inbounds nuw i8, ptr %45, i64 24
  store ptr %39, ptr %i.cr, align 8, !tbaa !46, !alias.scope !1449
  %i.cs = getelementptr inbounds nuw i8, ptr %45, i64 32
  store i64 %i.cl, ptr %i.cs, align 8, !tbaa !45, !alias.scope !1449
  %i.ct = getelementptr inbounds nuw i8, ptr %45, i64 40
  store i64 0, ptr %i.ct, align 8, !tbaa !45, !alias.scope !1449
  %i.cu = getelementptr inbounds nuw i8, ptr %45, i64 48
  store i64 %i.co, ptr %i.cu, align 8, !tbaa !48, !alias.scope !1449
  call void @llvm.lifetime.start.p0(ptr nonnull %25) #15
  call void @llvm.lifetime.start.p0(ptr nonnull %22) #15
  store ptr %i.ck, ptr %22, align 8, !tbaa !513
  %i.cv = getelementptr inbounds nuw i8, ptr %22, i64 16
