Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/libigl/original/per_vertex_normals?download=true
...
begin_hunk_0_@_ZN5Eigen8internal26call_dense_assignment_loopINS_6MatrixIfLin1ELi3ELi1ELin1ELi3EEENS_13CwiseBinaryOpINS0_18scalar_quotient_opIffEEKS3_KNS_9ReplicateINS_12CwiseUnaryOpINS0_14scalar_sqrt_opIfEEKNS_16PartialReduxExprIKNS9_INS0_14scalar_abs2_opIfEES7_EENS0_10member_sumIffEELi1EEEEELi1ELi3EEEEENS0_9assign_opIffEEEEvRT_RKT0_RKT1_:bb.a
  ...
  %i.be = fmul <4 x float> %i.bd, %i.bd
  %i.bf = getelementptr i8, ptr %i.ac, i64 8
  %i.bg = getelementptr i8, ptr %i.ad, i64 20
  %i.bh = getelementptr i8, ptr %i.af, i64 32
  %i.bi = getelementptr i8, ptr %i.ah, i64 44
  %i.bj = load float, ptr %i.bf, align 4, !tbaa !44, !alias.scope !458
  %i.bk = load float, ptr %i.bg, align 4, !tbaa !44, !alias.scope !458
  %i.bl = load float, ptr %i.bh, align 4, !tbaa !44, !alias.scope !458
  %i.bm = load float, ptr %i.bi, align 4, !tbaa !44, !alias.scope !458
  ...
  %i.bq = insertelement <4 x float> %i.bp, float %i.bm, i64 3 ; 2 uses
  %i.br = fmul <4 x float> %i.bq, %i.bq
  %i.bs = fadd <4 x float> %i.be, %i.br
  %i.bt = fadd <4 x float> %i.ar, %i.bs
  %i.bu = call <4 x float> @llvm.sqrt.v4f32(<4 x float> %i.bt)
  store <4 x float> %i.bu, ptr %i.x, align 4, !tbaa !44, !alias.scope !459, !noalias !458
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.bv = icmp eq i64 %index.next, %n.vec
  br i1 %i.bv, label %middle.block, label %vector.body, !llvm.loop !441

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %.pr.i.i.i.i.i.i.i.i.i.i.i.i, %n.vec
  br i1 %cmp.n, label %_ZN5Eigen8internal9evaluatorINS_13CwiseBinaryOpINS0_18scalar_quotient_opIffEEKNS_6MatrixIfLin1ELi3ELi1ELin1ELi3EEEKNS_9ReplicateINS_12CwiseUnaryOpINS0_14scalar_sqrt_opIfEEKNS_16PartialReduxExprIKNS9_INS0_14scalar_abs2_opIfEES7_EENS0_10member_sumIffEELi1EEEEELi1ELi3EEEEEEC2ERKSO_.exit, label %scalar.ph.preheader

scalar.ph.preheader:                              ; preds = %vector.memcheck, %vector.scevcheck, %.lr.ph.i.i.i.i.i.i.i.i.i.i.i.i.i, %middle.block
  %.05.i.i.i.i.i.i.i.i.i.i.i.i.i.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %vector.scevcheck ], [ 0, %.lr.ph.i.i.i.i.i.i.i.i.i.i.i.i.i ], [ %n.vec, %middle.block ] ; 5 uses
  %.neg = or disjoint i64 %.05.i.i.i.i.i.i.i.i.i.i.i.i.i.ph, 1
  %xtraiter = and i64 %.pr.i.i.i.i.i.i.i.i.i.i.i.i, 1
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol

scalar.ph.prol:                                   ; preds = %scalar.ph.preheader
  %i.bw = getelementptr inbounds nuw [4 x i8], ptr %.pre.i.i.i.i.i.i.i, i64 %.05.i.i.i.i.i.i.i.i.i.i.i.i.i.ph
  ...
  %i.by = load <2 x float>, ptr %i.bx, align 4, !tbaa !44 ; 2 uses
  %i.bz = fmul <2 x float> %i.by, %i.by           ; 2 uses
  %i.ca = getelementptr i8, ptr %i.bx, i64 8
  %i.cb = load float, ptr %i.ca, align 4, !tbaa !44 ; 2 uses
  ...
  store float %i.ch, ptr %i.bw, align 4, !tbaa !44
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.cm = load <2 x float>, ptr %i.cl, align 4, !tbaa !44 ; 2 uses
  %i.cn = fmul <2 x float> %i.cm, %i.cm           ; 2 uses
  %i.co = getelementptr i8, ptr %i.cl, i64 8
  %i.cp = load float, ptr %i.co, align 4, !tbaa !44 ; 2 uses
  ...
  store float %i.cv, ptr %i.ck, align 4, !tbaa !44
  ...
  %i.cz = load <2 x float>, ptr %i.cy, align 4, !tbaa !44 ; 2 uses
  %i.da = fmul <2 x float> %i.cz, %i.cz           ; 2 uses
  %i.db = getelementptr i8, ptr %i.cy, i64 8
  %i.dc = load float, ptr %i.db, align 4, !tbaa !44 ; 2 uses
  ...
  store float %i.di, ptr %i.cx, align 4, !tbaa !44
...
_ZN5Eigen8internal9evaluatorINS_13CwiseBinaryOpINS0_18scalar_quotient_opIffEEKNS_6MatrixIfLin1ELi3ELi1ELin1ELi3EEEKNS_9ReplicateINS_12CwiseUnaryOpINS0_14scalar_sqrt_opIfEEKNS_16PartialReduxExprIKNS9_INS0_14scalar_abs2_opIfEES7_EENS0_10member_sumIffEELi1EEEEELi1ELi3EEEEEEC2ERKSO_.exit: ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block, %bb.a, %bb.b
  ...
  store ptr %i.dm, ptr %i.dn, align 8, !tbaa !93
  %i.do = getelementptr inbounds nuw i8, ptr %3, i64 40
  %i.dp = load ptr, ptr %i.e, align 8, !tbaa !457, !nonnull !51, !align !74
  %i.dq = getelementptr inbounds nuw i8, ptr %i.dp, i64 8
  %i.dr = load i64, ptr %i.dq, align 8, !tbaa !36 ; 4 uses
  store i64 %i.dr, ptr %i.do, align 8, !tbaa !82
  %i.ds = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.dt = load i64, ptr %i.ds, align 8, !tbaa !36
...
thread-pre-split:                                 ; preds = %bb.c
  %.pr = load i64, ptr %i.ds, align 8, !tbaa !36
  br label %bb.d
...
bb.d:                                             ; preds = %thread-pre-split, %_ZN5Eigen8internal9evaluatorINS_13CwiseBinaryOpINS0_18scalar_quotient_opIffEEKNS_6MatrixIfLin1ELi3ELi1ELin1ELi3EEEKNS_9ReplicateINS_12CwiseUnaryOpINS0_14scalar_sqrt_opIfEEKNS_16PartialReduxExprIKNS9_INS0_14scalar_abs2_opIfEES7_EENS0_10member_sumIffEELi1EEEEELi1ELi3EEEEEEC2ERKSO_.exit
  ...
  %i.dv = load ptr, ptr %0, align 8, !tbaa !86    ; 9 uses
...
.lr.ph.i:                                         ; preds = %bb.d
  %i.dx = load ptr, ptr %i.a, align 8, !tbaa !461 ; 11 uses
  %i.dy = load ptr, ptr %i.dn, align 8, !tbaa !95 ; 4 uses
...
vector.scevcheck17:                               ; preds = %.lr.ph.i
  ...
  %op.rdx47.a = or i1 %i.eb, %i.ef
  %op.rdx48.a = or i1 %i.eh, %i.ej
  %op.rdx49.a = or i1 %op.rdx, %op.rdx47.a
  %op.rdx50 = or i1 %op.rdx48.a, %i.el
  %op.rdx51 = or i1 %op.rdx49.a, %op.rdx50
  br i1 %op.rdx51, label %scalar.ph35.preheader, label %vector.memcheck25
...
vector.ph37:                                      ; preds = %vector.memcheck25
  %n.vec38 = and i64 %i.du, 9223372036854775804   ; 3 uses
  br label %vector.body39

vector.body39:                                    ; preds = %vector.body39, %vector.ph37
  %index40 = phi i64 [ 0, %vector.ph37 ], [ %index.next43, %vector.body39 ] ; 6 uses
  %i.eo = mul i64 %index40, 12                    ; 2 uses
  %i.ep = mul i64 %index40, 12
  %i.eq = mul i64 %index40, 12
  %i.er = mul i64 %index40, 12
  ...
  %i.fa = getelementptr [4 x i8], ptr %i.dy, i64 %index40 ; 3 uses
  %wide.load = load <4 x float>, ptr %i.fa, align 4, !tbaa !44, !alias.scope !462, !noalias !463
  %i.fb = load float, ptr %i.et, align 4, !tbaa !44, !alias.scope !464
  %i.fc = load float, ptr %i.ev, align 4, !tbaa !44, !alias.scope !464
  %i.fd = load float, ptr %i.ex, align 4, !tbaa !44, !alias.scope !464
  %i.fe = load float, ptr %i.ez, align 4, !tbaa !44, !alias.scope !464
  ...
  %wide.load41 = load <4 x float>, ptr %i.fa, align 4, !tbaa !44, !alias.scope !462, !noalias !463
  %i.fn = load float, ptr %i.fj, align 4, !tbaa !44, !alias.scope !464
  %i.fo = load float, ptr %i.fk, align 4, !tbaa !44, !alias.scope !464
  %i.fp = load float, ptr %i.fl, align 4, !tbaa !44, !alias.scope !464
  %i.fq = load float, ptr %i.fm, align 4, !tbaa !44, !alias.scope !464
  ...
  %wide.load42 = load <4 x float>, ptr %i.fa, align 4, !tbaa !44, !alias.scope !462, !noalias !463
  %i.fz = load float, ptr %i.fv, align 4, !tbaa !44, !alias.scope !464
  %i.ga = load float, ptr %i.fw, align 4, !tbaa !44, !alias.scope !464
  %i.gb = load float, ptr %i.fx, align 4, !tbaa !44, !alias.scope !464
  %i.gc = load float, ptr %i.fy, align 4, !tbaa !44, !alias.scope !464
  ...
  %i.gh = fdiv <4 x float> %i.gg, %wide.load42
  %i.gi = shufflevector <4 x float> %i.fi, <4 x float> %i.fu, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %4 = shufflevector <4 x float> %wide.load, <4 x float> %wide.load41, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.gj = fdiv <8 x float> %i.gi, %4
  %i.gk = shufflevector <4 x float> %i.gh, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %interleaved.vec = shufflevector <8 x float> %i.gj, <8 x float> %i.gk, <12 x i32> <i32 0, i32 4, i32 8, i32 1, i32 5, i32 9, i32 2, i32 6, i32 10, i32 3, i32 7, i32 11>
  store <12 x float> %interleaved.vec, ptr %i.es, align 4, !tbaa !44, !alias.scope !463, !noalias !464
  %index.next43 = add nuw i64 %index40, 4         ; 2 uses
  %i.gl = icmp eq i64 %index.next43, %n.vec38
  br i1 %i.gl, label %middle.block44, label %vector.body39, !llvm.loop !447

middle.block44:                                   ; preds = %vector.body39
  %cmp.n45 = icmp eq i64 %i.du, %n.vec38
  br i1 %cmp.n45, label %_ZN5Eigen8internal21dense_assignment_loopINS0_31generic_dense_assignment_kernelINS0_9evaluatorINS_6MatrixIfLin1ELi3ELi1ELin1ELi3EEEEENS3_INS_13CwiseBinaryOpINS0_18scalar_quotient_opIffEEKS5_KNS_9ReplicateINS_12CwiseUnaryOpINS0_14scalar_sqrt_opIfEEKNS_16PartialReduxExprIKNSC_INS0_14scalar_abs2_opIfEESA_EENS0_10member_sumIffEELi1EEEEELi1ELi3EEEEEEENS0_9assign_opIffEELi0EEELi0ELi1EE3runERSV_.exit, label %scalar.ph35.preheader

scalar.ph35.preheader:                            ; preds = %vector.memcheck25, %vector.scevcheck17, %.lr.ph.i, %middle.block44
  %.05.i.ph = phi i64 [ 0, %vector.memcheck25 ], [ 0, %vector.scevcheck17 ], [ 0, %.lr.ph.i ], [ %n.vec38, %middle.block44 ]
  br label %scalar.ph35

scalar.ph35:                                      ; preds = %scalar.ph35.preheader, %scalar.ph35
  %.05.i = phi i64 [ %i.hc, %scalar.ph35 ], [ %.05.i.ph, %scalar.ph35.preheader ] ; 3 uses
  %.idx.i.i.i.i.i = mul i64 %.05.i, 12            ; 2 uses
  %i.gm = getelementptr i8, ptr %i.dv, i64 %.idx.i.i.i.i.i ; 3 uses
  %i.gn = getelementptr i8, ptr %i.dx, i64 %.idx.i.i.i.i.i ; 3 uses
  %i.go = getelementptr [4 x i8], ptr %i.dy, i64 %.05.i ; 3 uses
  %i.gp = load float, ptr %i.go, align 4, !tbaa !44
  %i.gq = load float, ptr %i.gn, align 4, !tbaa !44
  %i.gr = fdiv float %i.gq, %i.gp
  store float %i.gr, ptr %i.gm, align 4, !tbaa !44
  %i.gs = getelementptr i8, ptr %i.gm, i64 4
  %i.gt = getelementptr i8, ptr %i.gn, i64 4
  %i.gu = load float, ptr %i.go, align 4, !tbaa !44
  %i.gv = load float, ptr %i.gt, align 4, !tbaa !44
  %i.gw = fdiv float %i.gv, %i.gu
  store float %i.gw, ptr %i.gs, align 4, !tbaa !44
  %i.gx = getelementptr i8, ptr %i.gm, i64 8
  %i.gy = getelementptr i8, ptr %i.gn, i64 8
  %i.gz = load float, ptr %i.go, align 4, !tbaa !44
  %i.ha = load float, ptr %i.gy, align 4, !tbaa !44
  %i.hb = fdiv float %i.ha, %i.gz
  store float %i.hb, ptr %i.gx, align 4, !tbaa !44
  %i.hc = add nuw nsw i64 %.05.i, 1               ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.hc, %i.du
  br i1 %exitcond.not.i, label %_ZN5Eigen8internal21dense_assignment_loopINS0_31generic_dense_assignment_kernelINS0_9evaluatorINS_6MatrixIfLin1ELi3ELi1ELin1ELi3EEEEENS3_INS_13CwiseBinaryOpINS0_18scalar_quotient_opIffEEKS5_KNS_9ReplicateINS_12CwiseUnaryOpINS0_14scalar_sqrt_opIfEEKNS_16PartialReduxExprIKNSC_INS0_14scalar_abs2_opIfEESA_EENS0_10member_sumIffEELi1EEEEELi1ELi3EEEEEEENS0_9assign_opIffEELi0EEELi0ELi1EE3runERSV_.exit, label %scalar.ph35, !llvm.loop !448

_ZN5Eigen8internal21dense_assignment_loopINS0_31generic_dense_assignment_kernelINS0_9evaluatorINS_6MatrixIfLin1ELi3ELi1ELin1ELi3EEEEENS3_INS_13CwiseBinaryOpINS0_18scalar_quotient_opIffEEKS5_KNS_9ReplicateINS_12CwiseUnaryOpINS0_14scalar_sqrt_opIfEEKNS_16PartialReduxExprIKNSC_INS0_14scalar_abs2_opIfEESA_EENS0_10member_sumIffEELi1EEEEELi1ELi3EEEEEEENS0_9assign_opIffEELi0EEELi0ELi1EE3runERSV_.exit: ; preds = %scalar.ph35, %middle.block44, %bb.d
  %i.hd = load ptr, ptr %i.d, align 8, !tbaa !49
...
bb.e:                                             ; preds = %bb.c
  %i.he = landingpad { ptr, i32 }
          cleanup
  %i.hf = load ptr, ptr %i.d, align 8, !tbaa !49
  call void @free(ptr noundef %i.hf) #14
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #14
  br label %common.resume
}
...
bb.c:                                             ; preds = %bb.b
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.e, align 8, !tbaa !38
...
bb.f:                                             ; preds = %bb.e
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.l, align 8, !tbaa !38
...
bb.g:                                             ; preds = %_ZN5Eigen8internal23check_size_for_overflowIfEEvm.exit.i.i
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.p, align 8, !tbaa !38
...
_ZN5Eigen12DenseStorageIfLin1ELin1ELi1ELi0EE6resizeElll.exit: ; preds = %_ZN5Eigen8internal28check_rows_cols_for_overflowILin1EE3runIlEEvT_S4_.exit, %.sink.split.i
  store i64 %1, ptr %i.g, align 8, !tbaa !50
  ret void
}
...
bb.d:                                             ; preds = %bb.c
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.i, align 8, !tbaa !38
...
bb.e:                                             ; preds = %_ZN5Eigen8internal23check_size_for_overflowIfEEvm.exit.i
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.m, align 8, !tbaa !38
