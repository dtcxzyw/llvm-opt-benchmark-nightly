...
vector.body39:                                    ; preds = %vector.body39, %vector.ph37
  ...
  %i.fa = getelementptr [4 x i8], ptr %i.dy, i64 %index40
  %wide.load = load <4 x float>, ptr %i.fa, align 4, !tbaa !44, !alias.scope !462, !noalias !463 ; 2 uses
  ...
  %i.gh = fdiv <4 x float> %i.gg, %wide.load
  %i.gi = shufflevector <4 x float> %i.fi, <4 x float> %i.fu, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %4 = shufflevector <4 x float> %wide.load, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
