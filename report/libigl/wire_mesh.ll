...
begin_hunk_0_@_ZN5Eigen9JacobiSVDINS_6MatrixIdLi2ELi3ELi0ELi2ELi3EEELi2EE7computeERKS2_j:bb.a
  %i.hp = tail call double @llvm.fmuladd.f64(double %.sink20.i.i.i.us, double %i.hk, double %i.ho)
  store double %i.hp, ptr %i.hj, align 8, !tbaa !19
...
_ZN5Eigen10MatrixBaseINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEEE15applyOnTheRightIdEEvllRKNS_14JacobiRotationIT_EE.exit.us: ; preds = %_ZN5Eigen8internal36apply_rotation_in_the_plane_selectorIddLi3ELi0ELb0EE3runEPdlS3_lldd.exit.loopexit.i.i.us, %_ZN5Eigen10MatrixBaseINS_6MatrixIdLi2ELi2ELi0ELi2ELi2EEEE15applyOnTheRightIdEEvllRKNS_14JacobiRotationIT_EE.exit71.thread.us, %_ZN5Eigen10MatrixBaseINS_6MatrixIdLi2ELi2ELi0ELi2ELi2EEEE15applyOnTheRightIdEEvllRKNS_14JacobiRotationIT_EE.exit.us
  %i.hq = load double, ptr %i.hz, align 8, !tbaa !19
  %i.hr = tail call noundef double @llvm.fabs.f64(double %i.hq) ; 2 uses
  %i.hs = load double, ptr %i.co, align 8, !tbaa !19
...
bb.k:                                             ; preds = %_ZN5Eigen10MatrixBaseINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEEE15applyOnTheRightIdEEvllRKNS_14JacobiRotationIT_EE.exit.us, %bb.f
  ...
  br i1 %exitcond.not, label %bb.l, label %bb.e, !llvm.loop !375
...
bb.l:                                             ; preds = %bb.k
  ...
  br i1 %brmerge.not, label %.preheader, label %.preheader198.us, !llvm.loop !376
...
._crit_edge.thread:                               ; preds = %.preheader
  ...
  %i.ii = load <2 x double>, ptr %i.if, align 16, !tbaa !53
  %i.ij = fmul <2 x double> %i.ih, %i.ii
  store <2 x double> %i.ij, ptr %i.if, align 16, !tbaa !53
  %i.ik = getelementptr inbounds nuw i8, ptr %0, i64 144
  store i64 %i.br, ptr %i.ik, align 16, !tbaa !387
  br label %.loopexit
...
._crit_edge:                                      ; preds = %bb.n
  ...
  %i.io = load <2 x double>, ptr %i.il, align 16, !tbaa !53
  %i.ip = fmul <2 x double> %i.in, %i.io
  store <2 x double> %i.ip, ptr %i.il, align 16, !tbaa !53
  %i.iq = getelementptr inbounds nuw i8, ptr %0, i64 144 ; 2 uses
  store i64 %i.jh, ptr %i.iq, align 16, !tbaa !387
...
.lr.ph:                                           ; preds = %.preheader, %bb.n
  ...
  %i.iv = load double, ptr %i.iu, align 8, !tbaa !19 ; 2 uses
  %i.iw = tail call noundef double @llvm.fabs.f64(double %i.iv)
  %i.ix = getelementptr inbounds nuw [8 x i8], ptr %i.if, i64 %.055212
  store double %i.iw, ptr %i.ix, align 8, !tbaa !19
  %i.iy = load i8, ptr %i.bt, align 1, !tbaa !112, !range !111, !noundef !109
  %i.iz = trunc nuw i8 %i.iy to i1
  %i.ja = load i8, ptr %i.bu, align 8, !range !111
...
bb.m:                                             ; preds = %.lr.ph
  ...
  %i.jf = load <2 x double>, ptr %i.je, align 16, !tbaa !53
  %i.jg = fneg <2 x double> %i.jf
  store <2 x double> %i.jg, ptr %i.je, align 16, !tbaa !53
  %.pre225 = load i64, ptr %i.bq, align 8, !tbaa !70
  br label %bb.n
...
bb.n:                                             ; preds = %bb.m, %.lr.ph
  ...
  br i1 %i.jj, label %.lr.ph, label %._crit_edge, !llvm.loop !377
...
.lr.ph215:                                        ; preds = %._crit_edge, %.thread192
  ...
  %i.jo = load double, ptr %i.jn, align 8, !tbaa !19 ; 5 uses
...
.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i, %.lr.ph.i.i.i.i.preheader.new
  ...
  %i.jv = load double, ptr %i.ju, align 8, !tbaa !19 ; 3 uses
  ...
  %i.ka = load double, ptr %i.jz, align 8, !tbaa !19 ; 3 uses
  ...
  br i1 %niter.ncmp.1, label %_ZNK5Eigen9DenseBaseINS_5BlockINS_6MatrixIdLi2ELi1ELi0ELi2ELi1EEELin1ELi1ELb0EEEE8maxCoeffIlEEdPT_.exit.unr-lcssa, label %.lr.ph.i.i.i.i, !llvm.loop !378
...
.lr.ph.i.i.i.i.epil.preheader:                    ; preds = %_ZNK5Eigen9DenseBaseINS_5BlockINS_6MatrixIdLi2ELi1ELi0ELi2ELi1EEELin1ELi1ELb0EEEE8maxCoeffIlEEdPT_.exit.unr-lcssa, %.lr.ph.i.i.i.i.preheader
  ...
  %i.kf = load double, ptr %i.ke, align 8, !tbaa !19 ; 2 uses
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.km = load double, ptr %i.kk, align 8, !tbaa !19
  %i.kn = load double, ptr %i.kl, align 8, !tbaa !19
  store double %i.kn, ptr %i.kk, align 8, !tbaa !19
  store double %i.km, ptr %i.kl, align 8, !tbaa !19
  %i.ko = load i8, ptr %i.bt, align 1, !tbaa !112, !range !111, !noundef !109
  %i.kp = trunc nuw i8 %i.ko to i1
  %i.kq = load i8, ptr %i.bu, align 8, !range !111
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.kv = load <2 x double>, ptr %i.ku, align 16, !tbaa !53
  %i.kw = load <2 x double>, ptr %i.kt, align 16, !tbaa !53
  store <2 x double> %i.kw, ptr %i.ku, align 16, !tbaa !53
  store <2 x double> %i.kv, ptr %i.kt, align 16, !tbaa !53
  br label %bb.r

bb.r:                                             ; preds = %bb.q, %bb.p
  %i.kx = load i8, ptr %i.bv, align 1, !tbaa !113, !range !111, !noundef !109
  %i.ky = trunc nuw i8 %i.kx to i1
  %i.kz = load i8, ptr %i.bw, align 2, !range !111
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.le = load <2 x double>, ptr %i.ld, align 8, !tbaa !53
  %i.lf = load <2 x double>, ptr %i.lc, align 8, !tbaa !53
  store <2 x double> %i.lf, ptr %i.ld, align 8, !tbaa !53
  store <2 x double> %i.le, ptr %i.lc, align 8, !tbaa !53
  %i.lg = getelementptr i8, ptr %i.lc, i64 16     ; 2 uses
  %i.lh = getelementptr i8, ptr %i.ld, i64 16     ; 2 uses
  %i.li = load double, ptr %i.lg, align 8, !tbaa !19
  %i.lj = load double, ptr %i.lh, align 8, !tbaa !19
  store double %i.lj, ptr %i.lg, align 8, !tbaa !19
  store double %i.li, ptr %i.lh, align 8, !tbaa !19
  br label %.thread192
...
_ZNK5Eigen9DenseBaseINS_5BlockINS_6MatrixIdLi2ELi1ELi0ELi2ELi1EEELin1ELi1ELb0EEEE8maxCoeffIlEEdPT_.exit.thread: ; preds = %_ZNK5Eigen9DenseBaseINS_5BlockINS_6MatrixIdLi2ELi1ELi0ELi2ELi1EEELin1ELi1ELb0EEEE8maxCoeffIlEEdPT_.exit, %_ZNK5Eigen9DenseBaseINS_5BlockINS_6MatrixIdLi2ELi1ELi0ELi2ELi1EEELin1ELi1ELb0EEEE8maxCoeffIlEEdPT_.exit.thread188
  store i64 %.0213, ptr %i.iq, align 16, !tbaa !387
  br label %.loopexit
...
.thread192:                                       ; preds = %_ZNK5Eigen9DenseBaseINS_5BlockINS_6MatrixIdLi2ELi1ELi0ELi2ELi1EEELin1ELi1ELb0EEEE8maxCoeffIlEEdPT_.exit.thread188, %bb.o, %bb.s, %bb.r
  ...
  %i.ll = load i64, ptr %i.bq, align 8, !tbaa !70 ; 2 uses
  %i.lm = icmp slt i64 %i.lk, %i.ll
  br i1 %i.lm, label %.lr.ph215, label %.loopexit, !llvm.loop !379
...
.loopexit:                                        ; preds = %.thread192, %._crit_edge.thread, %._crit_edge, %_ZNK5Eigen9DenseBaseINS_5BlockINS_6MatrixIdLi2ELi1ELi0ELi2ELi1EEELin1ELi1ELb0EEEE8maxCoeffIlEEdPT_.exit.thread
  ...
  store i8 1, ptr %i.ln, align 4, !tbaa !384
  br label %bb.t
...
bb.a:
  ...
  %i.b = load double, ptr %2, align 16, !tbaa !19
  store double %i.b, ptr %i.a, align 16, !tbaa !19
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 200
  %i.d = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.e = load double, ptr %i.d, align 16, !tbaa !19
  store double %i.e, ptr %i.c, align 8, !tbaa !19
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 208 ; 2 uses
  %i.g = getelementptr inbounds nuw i8, ptr %2, i64 32
  %i.h = load double, ptr %i.g, align 16, !tbaa !19
  store double %i.h, ptr %i.f, align 16, !tbaa !19
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 216
  %i.j = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.k = load double, ptr %i.j, align 8, !tbaa !19
  store double %i.k, ptr %i.i, align 8, !tbaa !19
  ...
  store double %i.n, ptr %i.l, align 16, !tbaa !19
  ...
  store double %i.q, ptr %i.o, align 8, !tbaa !19
  %i.r = load <2 x double>, ptr %i.a, align 16, !tbaa !53
  store <2 x double> %i.r, ptr %0, align 16, !tbaa !53
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.t = load <2 x double>, ptr %i.f, align 16, !tbaa !53
  store <2 x double> %i.t, ptr %i.s, align 16, !tbaa !53
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 32 ; 2 uses
  %i.v = load <2 x double>, ptr %i.l, align 16, !tbaa !53
  store <2 x double> %i.v, ptr %i.u, align 16, !tbaa !53
  ...
  %i.x = load double, ptr %0, align 16, !tbaa !19
  store double %i.x, ptr %i.w, align 16, !tbaa !19
  %i.y = getelementptr inbounds nuw i8, ptr %1, i64 200
  %i.z = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.aa = load double, ptr %i.z, align 8, !tbaa !19
  store double %i.aa, ptr %i.y, align 8, !tbaa !19
  %i.ab = getelementptr inbounds nuw i8, ptr %1, i64 208
  store double 0.000000e+00, ptr %i.ab, align 16, !tbaa !19
  %i.ac = getelementptr inbounds nuw i8, ptr %1, i64 216
  %i.ad = load double, ptr %i.u, align 16, !tbaa !19
  store double %i.ad, ptr %i.ac, align 8, !tbaa !19
  %i.ae = getelementptr inbounds nuw i8, ptr %1, i64 137
  %i.af = load i8, ptr %i.ae, align 1, !tbaa !113, !range !111, !noundef !109
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr %0, ptr %3, align 8, !tbaa !116, !alias.scope !392
  %i.ai = getelementptr inbounds nuw i8, ptr %3, i64 8
  store ptr %i.ah, ptr %i.ai, align 8, !tbaa !118, !alias.scope !392
  %i.aj = getelementptr inbounds nuw i8, ptr %3, i64 16
  store i8 0, ptr %i.aj, align 8, !tbaa !120, !alias.scope !392
  %i.ak = getelementptr inbounds nuw i8, ptr %3, i64 24
  store i64 2, ptr %i.ak, align 8, !tbaa !121, !alias.scope !392
  %i.al = getelementptr inbounds nuw i8, ptr %3, i64 32
  store i64 0, ptr %i.al, align 8, !tbaa !122, !alias.scope !392
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.ap = load i8, ptr %i.ao, align 2, !tbaa !114, !range !111, !noundef !109
  %i.aq = trunc nuw i8 %i.ap to i1
  br i1 %i.aq, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  %i.ar = getelementptr inbounds nuw i8, ptr %1, i64 32 ; 2 uses
  store double 1.000000e+00, ptr %i.ar, align 16, !tbaa !19
  ...
  store double 1.000000e+00, ptr %i.at, align 16, !tbaa !19
  ...
  store double 1.000000e+00, ptr %i.av, align 16, !tbaa !19
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #23
  %i.aw = getelementptr inbounds nuw i8, ptr %0, i64 48
  store ptr %0, ptr %4, align 8, !tbaa !116, !alias.scope !393
  %i.ax = getelementptr inbounds nuw i8, ptr %4, i64 8
  store ptr %i.aw, ptr %i.ax, align 8, !tbaa !118, !alias.scope !393
  %i.ay = getelementptr inbounds nuw i8, ptr %4, i64 16
  store i8 0, ptr %i.ay, align 8, !tbaa !120, !alias.scope !393
  %i.az = getelementptr inbounds nuw i8, ptr %4, i64 24
  store i64 2, ptr %i.az, align 8, !tbaa !121, !alias.scope !393
  %i.ba = getelementptr inbounds nuw i8, ptr %4, i64 32
  store i64 0, ptr %i.ba, align 8, !tbaa !122, !alias.scope !393
...
bb.e:                                             ; preds = %bb.c, %bb.d, %bb.b
  ...
  %i.bd = load i8, ptr %i.bc, align 1, !tbaa !112, !range !111, !noundef !109
  %i.be = trunc nuw i8 %i.bd to i1
  %i.bf = getelementptr inbounds nuw i8, ptr %1, i64 136
  %i.bg = load i8, ptr %i.bf, align 8, !range !111
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.bk = load i32, ptr %i.bj, align 16, !tbaa !48
  %i.bl = sext i32 %i.bk to i64
  %i.bm = getelementptr [8 x i8], ptr %1, i64 %i.bl
  store double 1.000000e+00, ptr %i.bm, align 8, !tbaa !19
  ...
  store double 1.000000e+00, ptr %i.br, align 8, !tbaa !19
  br label %bb.g
...
bb.a:
  %3 = alloca %"class.Eigen::Block.1094", align 8 ; 10 uses
  %4 = alloca %"class.Eigen::Block.1105", align 8 ; 9 uses
  %5 = alloca %"class.Eigen::Block.1094", align 8 ; 10 uses
  %6 = alloca %"class.Eigen::Block.1105", align 8 ; 9 uses
  %7 = alloca %"class.Eigen::Block.1094", align 8 ; 10 uses
  %8 = alloca %"class.Eigen::Block.1105", align 8 ; 9 uses
  %9 = alloca %"class.Eigen::Block.1094", align 8 ; 10 uses
  %10 = alloca %"class.Eigen::Block.1105", align 8 ; 9 uses
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.b = load i64, ptr %i.a, align 8, !tbaa !121  ; 7 uses
end_hunk_0
begin_hunk_1_@_ZNK5Eigen19HouseholderSequenceINS_6MatrixIdLi3ELi2ELi0ELi3ELi2EEENS1_IdLi2ELi1ELi0ELi2ELi1EEELi1EE6evalToINS1_IdLi3ELi3ELi0ELi3ELi3EEENS1_IdLi1ELi3ELi1ELi1ELi3EEEEEvRT_RT0_:bb.a
  %i.el = sub i64 3, %i.ek                        ; 4 uses
  %i.em = load i8, ptr %i.dl, align 8, !tbaa !120, !range !111, !noundef !109
...
bb.j:                                             ; preds = %bb.i
  ...
  store ptr %i.ep, ptr %7, align 8, !tbaa !126, !alias.scope !429
  store i64 %i.el, ptr %i.dy, align 8, !tbaa !33, !alias.scope !429
  store i64 %i.el, ptr %i.dz, align 8, !tbaa !33, !alias.scope !429
  store ptr %1, ptr %i.ea, align 8, !tbaa !128, !alias.scope !429
  store i64 %i.ek, ptr %i.eb, align 8, !tbaa !33, !alias.scope !429
  store i64 %i.ek, ptr %i.ec, align 8, !tbaa !33, !alias.scope !429
  store i64 3, ptr %i.ed, align 8, !tbaa !131, !alias.scope !429
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #23
  call void @llvm.experimental.noalias.scope.decl(metadata !430)
  call void @llvm.experimental.noalias.scope.decl(metadata !431)
  %i.es = load ptr, ptr %0, align 8, !tbaa !123, !noalias !432, !nonnull !109, !align !124 ; 2 uses
  %i.et = getelementptr inbounds [8 x i8], ptr %i.es, i64 %i.eq
  %i.eu = getelementptr inbounds nuw i8, ptr %i.et, i64 %.idx.i.i.i.i.i70
  store ptr %i.eu, ptr %8, align 8, !tbaa !133, !alias.scope !432
  store i64 %i.er, ptr %i.ee, align 8, !tbaa !33, !alias.scope !432
  store ptr %i.es, ptr %i.ef, align 8, !tbaa !116, !alias.scope !432
  store i64 %i.eq, ptr %i.eg, align 8, !tbaa !33, !alias.scope !432
  store i64 %.0104, ptr %i.eh, align 8, !tbaa !33, !alias.scope !432
  store i64 3, ptr %i.ei, align 8, !tbaa !135, !alias.scope !432
  %i.ev = load ptr, ptr %i.dx, align 8, !tbaa !136, !nonnull !109, !align !124
...
bb.k:                                             ; preds = %bb.i
  ...
  store ptr %i.ep, ptr %9, align 8, !tbaa !126, !alias.scope !433
  store i64 %i.el, ptr %i.dm, align 8, !tbaa !33, !alias.scope !433
  store i64 %i.el, ptr %i.dn, align 8, !tbaa !33, !alias.scope !433
  store ptr %1, ptr %i.do, align 8, !tbaa !128, !alias.scope !433
  store i64 %i.ek, ptr %i.dp, align 8, !tbaa !33, !alias.scope !433
  store i64 %i.ek, ptr %i.dq, align 8, !tbaa !33, !alias.scope !433
  store i64 3, ptr %i.dr, align 8, !tbaa !131, !alias.scope !433
  call void @llvm.lifetime.start.p0(ptr nonnull %10) #23
  call void @llvm.experimental.noalias.scope.decl(metadata !434)
  call void @llvm.experimental.noalias.scope.decl(metadata !435)
  %i.ex = load ptr, ptr %0, align 8, !tbaa !123, !noalias !436, !nonnull !109, !align !124 ; 2 uses
  %i.ey = getelementptr inbounds [8 x i8], ptr %i.ex, i64 %i.eq
  %i.ez = getelementptr inbounds nuw i8, ptr %i.ey, i64 %.idx.i.i.i.i.i70
  store ptr %i.ez, ptr %10, align 8, !tbaa !133, !alias.scope !436
  store i64 %i.er, ptr %i.ds, align 8, !tbaa !33, !alias.scope !436
  store ptr %i.ex, ptr %i.dt, align 8, !tbaa !116, !alias.scope !436
  store i64 %i.eq, ptr %i.du, align 8, !tbaa !33, !alias.scope !436
  store i64 %.0104, ptr %i.dv, align 8, !tbaa !33, !alias.scope !436
  store i64 3, ptr %i.dw, align 8, !tbaa !135, !alias.scope !436
  %i.fa = load ptr, ptr %i.dx, align 8, !tbaa !136, !nonnull !109, !align !124
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  br i1 %i.fc, label %bb.i, label %.loopexit, !llvm.loop !420
...
bb.a:
  %4 = alloca %"class.Eigen::Block.617", align 8  ; 10 uses
  %5 = alloca %"class.Eigen::Block.1094", align 8 ; 10 uses
  %6 = alloca %"class.Eigen::VectorBlock.1614", align 8 ; 8 uses
  %7 = alloca %"class.Eigen::Block.1094", align 8 ; 14 uses
  %8 = alloca %"class.Eigen::Block.1105", align 8 ; 13 uses
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 4 uses
  %i.b = load i8, ptr %i.a, align 8, !range !111
  %.fr66 = freeze i8 %i.b
...
.lr.ph.split.us:                                  ; preds = %.lr.ph, %.lr.ph.split.us
  ...
  %i.v = load i8, ptr %i.a, align 8, !tbaa !120, !range !111, !noundef !109
  %i.w = trunc nuw i8 %i.v to i1
  %i.x = xor i64 %.063.us, -1
  %i.y = add i64 %i.u, %i.x
  %i.z = select i1 %i.w, i64 %.063.us, i64 %i.y   ; 4 uses
  %i.aa = load i64, ptr %i.h, align 8, !tbaa !122
  ...
  store ptr %i.ae, ptr %7, align 8, !tbaa !126, !alias.scope !447
  store i64 %i.ac, ptr %i.i, align 8, !tbaa !33, !alias.scope !447
  store i64 %i.ac, ptr %i.j, align 8, !tbaa !33, !alias.scope !447
  store ptr %1, ptr %i.k, align 8, !tbaa !128, !alias.scope !447
  store i64 %i.ab, ptr %i.l, align 8, !tbaa !33, !alias.scope !447
  store i64 %i.ab, ptr %i.m, align 8, !tbaa !33, !alias.scope !447
  store i64 3, ptr %i.n, align 8, !tbaa !131, !alias.scope !447
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #23
  call void @llvm.experimental.noalias.scope.decl(metadata !448)
  call void @llvm.experimental.noalias.scope.decl(metadata !449)
  %i.af = add i64 %i.ab, 1                        ; 2 uses
  %i.ag = load ptr, ptr %0, align 8, !tbaa !123, !noalias !450, !nonnull !109, !align !124 ; 2 uses
  %i.ah = sub i64 2, %i.ab
  ...
  store ptr %i.aj, ptr %8, align 8, !tbaa !133, !alias.scope !450
  store i64 %i.ah, ptr %i.o, align 8, !tbaa !33, !alias.scope !450
  store ptr %i.ag, ptr %i.p, align 8, !tbaa !116, !alias.scope !450
  store i64 %i.af, ptr %i.q, align 8, !tbaa !33, !alias.scope !450
  store i64 %i.z, ptr %i.r, align 8, !tbaa !33, !alias.scope !450
  store i64 3, ptr %i.s, align 8, !tbaa !135, !alias.scope !450
  %i.ak = load ptr, ptr %i.t, align 8, !tbaa !136, !nonnull !109, !align !124
  ...
  %i.an = load i64, ptr %i.d, align 8, !tbaa !121 ; 2 uses
  %i.ao = icmp slt i64 %i.am, %i.an
  br i1 %i.ao, label %.lr.ph.split.us, label %.loopexit, !llvm.loop !443
...
bb.b:                                             ; preds = %.lr.ph65, %bb.d
  ...
  %i.bl = load i8, ptr %i.a, align 8, !tbaa !120, !range !111, !noundef !109
...
bb.d:                                             ; preds = %.thread, %bb.c
  ...
  %i.bt = load i64, ptr %i.as, align 8, !tbaa !122
  %i.bu = add i64 %i.bt, %i.br                    ; 6 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #23
  %i.bv = load ptr, ptr %0, align 8, !tbaa !123, !nonnull !109, !align !124 ; 2 uses
  ...
  store ptr %i.by, ptr %4, align 8, !tbaa !138
  store i64 %i.bw, ptr %i.at, align 8, !tbaa !33
  store i64 %i.bs, ptr %i.au, align 8, !tbaa !33
  store ptr %i.bv, ptr %i.av, align 8, !tbaa !116
  store i64 %i.bu, ptr %i.aw, align 8, !tbaa !33
  store i64 %i.br, ptr %i.ax, align 8, !tbaa !33
  store i64 3, ptr %i.ay, align 8, !tbaa !141
  ...
  store ptr %i.cb, ptr %5, align 8, !tbaa !126
  store i64 %i.bw, ptr %i.az, align 8, !tbaa !33
  store i64 %spec.select, ptr %i.ba, align 8, !tbaa !33
  store ptr %1, ptr %i.bb, align 8, !tbaa !128
  store i64 %i.bu, ptr %i.bc, align 8, !tbaa !33
  store i64 %i.bz, ptr %i.bd, align 8, !tbaa !33
  store i64 3, ptr %i.be, align 8, !tbaa !131
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #23
  %i.cc = load ptr, ptr %i.bf, align 8, !tbaa !136, !nonnull !109, !align !124 ; 2 uses
  %i.cd = getelementptr inbounds [8 x i8], ptr %i.cc, i64 %i.br
  store ptr %i.cd, ptr %6, align 8, !tbaa !143, !alias.scope !451
  store i64 %i.bs, ptr %i.bg, align 8, !tbaa !33, !alias.scope !451
  store ptr %i.cc, ptr %i.bh, align 8, !tbaa !118, !alias.scope !451
  store i64 %i.br, ptr %i.bi, align 8, !tbaa !33, !alias.scope !451
  store i64 2, ptr %i.bj, align 8, !tbaa !453, !alias.scope !451
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #23
  %i.cf = load i64, ptr %i.d, align 8, !tbaa !121 ; 2 uses
  %i.cg = icmp slt i64 %.pre-phi, %i.cf
  br i1 %i.cg, label %bb.b, label %.loopexit, !llvm.loop !446

.lr.ph.split:                                     ; preds = %.lr.ph, %.lr.ph.split
  %i.ch = phi i64 [ %i.cz, %.lr.ph.split ], [ %i.e, %.lr.ph ]
  %.063 = phi i64 [ %i.cy, %.lr.ph.split ], [ 0, %.lr.ph ] ; 3 uses
  %i.ci = load i8, ptr %i.a, align 8, !tbaa !120, !range !111, !noundef !109
  %i.cj = trunc nuw i8 %i.ci to i1
  %i.ck = xor i64 %.063, -1
  %i.cl = add i64 %i.ch, %i.ck
  %i.cm = select i1 %i.cj, i64 %.063, i64 %i.cl   ; 4 uses
  %i.cn = load i64, ptr %i.h, align 8, !tbaa !122
  %i.co = add i64 %i.cm, %i.cn                    ; 5 uses
  %i.cp = sub i64 3, %i.co
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #23
  %i.cq = getelementptr inbounds [8 x i8], ptr %1, i64 %i.co
  store ptr %i.cq, ptr %7, align 8, !tbaa !126, !alias.scope !447
  store i64 %i.cp, ptr %i.i, align 8, !tbaa !33, !alias.scope !447
  store i64 3, ptr %i.j, align 8, !tbaa !33, !alias.scope !447
  store ptr %1, ptr %i.k, align 8, !tbaa !128, !alias.scope !447
  store i64 %i.co, ptr %i.l, align 8, !tbaa !33, !alias.scope !447
  store i64 0, ptr %i.m, align 8, !tbaa !33, !alias.scope !447
  store i64 3, ptr %i.n, align 8, !tbaa !131, !alias.scope !447
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #23
  call void @llvm.experimental.noalias.scope.decl(metadata !448)
  call void @llvm.experimental.noalias.scope.decl(metadata !449)
  %i.cr = add i64 %i.co, 1                        ; 2 uses
  %i.cs = load ptr, ptr %0, align 8, !tbaa !123, !noalias !450, !nonnull !109, !align !124 ; 2 uses
  %i.ct = sub i64 2, %i.co
  ...
  store ptr %i.cv, ptr %8, align 8, !tbaa !133, !alias.scope !450
  store i64 %i.ct, ptr %i.o, align 8, !tbaa !33, !alias.scope !450
  store ptr %i.cs, ptr %i.p, align 8, !tbaa !116, !alias.scope !450
  store i64 %i.cr, ptr %i.q, align 8, !tbaa !33, !alias.scope !450
  store i64 %i.cm, ptr %i.r, align 8, !tbaa !33, !alias.scope !450
  store i64 3, ptr %i.s, align 8, !tbaa !135, !alias.scope !450
  %i.cw = load ptr, ptr %i.t, align 8, !tbaa !136, !nonnull !109, !align !124
  ...
  %i.cz = load i64, ptr %i.d, align 8, !tbaa !121 ; 2 uses
  %i.da = icmp slt i64 %i.cy, %i.cz
  br i1 %i.da, label %.lr.ph.split, label %.loopexit, !llvm.loop !443
...
.preheader.i.i.i.i:
  %1 = alloca %"class.Eigen::VectorBlock.668", align 8 ; 12 uses
  %i.a = alloca double, align 8                   ; 8 uses
  %2 = alloca %"class.Eigen::VectorBlock.603", align 8 ; 18 uses
  %3 = alloca %"class.Eigen::Block.617", align 8  ; 14 uses
  %4 = alloca %"class.Eigen::VectorBlock.603", align 8 ; 16 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 5 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 128 ; 4 uses
  %i.d = load <2 x double>, ptr %0, align 16, !tbaa !53 ; 2 uses
  %i.e = fmul <2 x double> %i.d, %i.d             ; 2 uses
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.g = load <2 x double>, ptr %i.f, align 16
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.i = load <2 x double>, ptr %i.h, align 8, !tbaa !53 ; 2 uses
  ...
  store <2 x double> %i.s, ptr %i.c, align 16, !tbaa !19
  store <2 x double> %i.s, ptr %i.b, align 16, !tbaa !19
  ...
  store i64 2, ptr %i.aa, align 8, !tbaa !460
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 160 ; 5 uses
  store double 0.000000e+00, ptr %i.ab, align 16, !tbaa !461
  ...
  %i.au = load double, ptr %i.b, align 16, !tbaa !19 ; 2 uses
  %i.av = getelementptr inbounds nuw i8, ptr %0, i64 120
  %i.aw = load double, ptr %i.av, align 8, !tbaa !19 ; 2 uses
  ...
  %i.az = load i64, ptr %i.aa, align 8, !tbaa !460
...
bb.a:                                             ; preds = %.preheader.i.i.i.i
  store i64 0, ptr %i.aa, align 8, !tbaa !460
  br label %bb.b

bb.b:                                             ; preds = %bb.a, %.preheader.i.i.i.i
  store i64 %.sroa.5.1.i.i, ptr %i.u, align 16, !tbaa !145
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.be = load <2 x double>, ptr %i.bd, align 8, !tbaa !53
  %i.bf = load <2 x double>, ptr %0, align 16, !tbaa !53
  store <2 x double> %i.bf, ptr %i.bd, align 8, !tbaa !53
end_hunk_1
