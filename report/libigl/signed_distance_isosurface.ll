...
bb.b:                                             ; preds = %bb.a
  ...
  %i.p = load double, ptr %i.o, align 8, !tbaa !95, !noalias !1387
  %i.q = load double, ptr %i.l, align 8, !tbaa !95, !noalias !1387
  %i.r = fsub double %i.p, %i.q                   ; 2 uses
  %i.s = getelementptr inbounds nuw i8, ptr %i.o, i64 8
  %i.t = load double, ptr %i.s, align 8, !tbaa !95, !noalias !1387
  %i.u = getelementptr inbounds nuw i8, ptr %.sroa.0.0.copyload.i, i64 24
  %i.v = load double, ptr %i.u, align 8, !tbaa !95, !noalias !1387
  %i.w = fsub double %i.t, %i.v                   ; 2 uses
  %i.x = getelementptr inbounds nuw i8, ptr %i.o, i64 16
  %i.y = load double, ptr %i.x, align 8, !tbaa !95, !noalias !1387
  %i.z = getelementptr inbounds nuw i8, ptr %.sroa.0.0.copyload.i, i64 32
  %i.aa = load double, ptr %i.z, align 8, !tbaa !95, !noalias !1387
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.k = getelementptr inbounds nuw [8 x i8], ptr %i.i, i64 %i.j
  %.sroa.0.0.copyload.i = load ptr, ptr %i.k, align 8, !tbaa !171 ; 3 uses
  %3 = getelementptr inbounds nuw i8, ptr %.sroa.0.0.copyload.i, i64 16
  %.sroa.650.0..sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.0.0.copyload.i, i64 24
  %i.l = getelementptr inbounds nuw i8, ptr %.sroa.0.0.copyload.i, i64 32
  %i.m = and i32 %i.f, 3
  %i.n = xor i32 %i.m, 2
  %i.o = zext nneg i32 %i.n to i64
  %i.p = getelementptr inbounds nuw [8 x i8], ptr %i.i, i64 %i.o
  %.sroa.0.0.copyload.i19 = load ptr, ptr %i.p, align 8, !tbaa !171 ; 3 uses
  %i.q = getelementptr inbounds nuw i8, ptr %.sroa.0.0.copyload.i19, i64 16
  ...
  %i.r = add nsw i32 %i.f, 3
  %i.s = and i32 %i.r, 3
  %i.t = zext nneg i32 %i.s to i64
  %i.u = getelementptr inbounds nuw [8 x i8], ptr %i.i, i64 %i.t
  %.sroa.0.0.copyload.i21 = load ptr, ptr %i.u, align 8, !tbaa !171 ; 3 uses
  %i.v = getelementptr inbounds nuw i8, ptr %.sroa.0.0.copyload.i21, i64 16
  ...
  %.sroa.8.0.copyload = load double, ptr %.sroa.8.0..sroa_idx, align 8 ; 2 uses
  %.sroa.650.0.copyload = load double, ptr %.sroa.650.0..sroa_idx, align 8
  %.sroa.8.0.copyload.a = load double, ptr %3, align 8
  %.sroa.853.0.copyload = load double, ptr %i.l, align 8
  %i.w = load <2 x double>, ptr %i.q, align 8     ; 3 uses
  %.sroa.640.0.copyload = load double, ptr %.sroa.640.0..sroa_idx, align 8
  %i.x = load <2 x double>, ptr %i.v, align 8     ; 3 uses
  %.sroa.6.0.copyload = load double, ptr %.sroa.6.0..sroa_idx, align 8
  %i.y = shufflevector <2 x double> %i.w, <2 x double> %i.x, <2 x i32> <i32 0, i32 2>
  %4 = insertelement <2 x double> poison, double %.sroa.8.0.copyload.a, i64 0
  %i.z = shufflevector <2 x double> %4, <2 x double> poison, <2 x i32> zeroinitializer
  %i.aa = fsub <2 x double> %i.y, %i.z            ; 6 uses
  %i.ab = shufflevector <2 x double> %i.w, <2 x double> %i.x, <2 x i32> <i32 1, i32 3>
  %5 = insertelement <2 x double> poison, double %.sroa.650.0.copyload, i64 0
  %6 = shufflevector <2 x double> %5, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ac = fsub <2 x double> %i.ab, %6             ; 5 uses
  %7 = insertelement <2 x double> poison, double %.sroa.843.0.copyload, i64 0
  %i.ad = insertelement <2 x double> %7, double %.sroa.8.0.copyload, i64 1
  %i.ae = insertelement <2 x double> poison, double %.sroa.853.0.copyload, i64 0
  %8 = shufflevector <2 x double> %i.ae, <2 x double> poison, <2 x i32> zeroinitializer
  %i.af = fsub <2 x double> %i.ad, %8             ; 6 uses
  %i.ag = fmul <2 x double> %i.ac, %i.ac
  %i.ah = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.aa, <2 x double> %i.aa, <2 x double> %i.ag)
  %i.ai = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.af, <2 x double> %i.af, <2 x double> %i.ah) ; 2 uses
  %foldExtExtBinop = fsub <2 x double> %i.x, %i.w
  %i.aj = extractelement <2 x double> %foldExtExtBinop, i64 0 ; 2 uses
  %i.ak = fsub double %.sroa.6.0.copyload, %.sroa.640.0.copyload ; 2 uses
  %i.al = fsub double %.sroa.8.0.copyload, %.sroa.843.0.copyload ; 2 uses
  %i.am = fmul double %i.ak, %i.ak
  %i.an = tail call double @llvm.fmuladd.f64(double %i.aj, double %i.aj, double %i.am)
  %i.ao = tail call noundef double @llvm.fmuladd.f64(double %i.al, double %i.al, double %i.an) ; 4 uses
  %i.ap = extractelement <2 x double> %i.af, i64 0
  %i.aq = extractelement <2 x double> %i.af, i64 1
  %i.ar = fneg double %i.aq
  %i.as = extractelement <2 x double> %i.aa, i64 0
  %i.at = fmul double %i.as, %i.ar
  %i.au = extractelement <2 x double> %i.aa, i64 1
  %i.av = tail call double @llvm.fmuladd.f64(double %i.ap, double %i.au, double %i.at) ; 2 uses
  %i.aw = fmul double %i.av, %i.av
  %i.ax = shufflevector <2 x double> %i.ac, <2 x double> %i.aa, <2 x i32> <i32 1, i32 3>
  %i.ay = fneg <2 x double> %i.ax
  %i.az = shufflevector <2 x double> %i.af, <2 x double> %i.ac, <2 x i32> <i32 0, i32 2>
  %i.ba = fmul <2 x double> %i.az, %i.ay
  %i.bb = shufflevector <2 x double> %i.af, <2 x double> %i.aa, <2 x i32> <i32 1, i32 2>
  %i.bc = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ac, <2 x double> %i.bb, <2 x double> %i.ba) ; 2 uses
  %i.bd = fmul <2 x double> %i.bc, %i.bc          ; 2 uses
  %i.be = extractelement <2 x double> %i.bd, i64 0
  %i.bf = fadd double %i.be, %i.aw
  %i.bg = extractelement <2 x double> %i.bd, i64 1
  %i.bh = fadd double %i.bg, %i.bf
  %i.bi = fmul double %i.bh, 2.500000e-01
  %i.bj = fmul double %i.bi, 4.000000e+00
  %i.bk = extractelement <2 x double> %i.ai, i64 0 ; 4 uses
  %i.bl = extractelement <2 x double> %i.ai, i64 1 ; 4 uses
  %i.bm = fcmp ugt double %i.bk, %i.bl
  %i.bn = fcmp ugt double %i.bk, %i.ao
  %or.cond.i22 = or i1 %i.bm, %i.bn
  %.inv.i = fcmp ole double %i.bl, %i.ao
  %..i = select i1 %.inv.i, double %i.bl, double %i.ao
  %.0.i = select i1 %or.cond.i22, double %..i, double %i.bk
  %i.bo = fmul double %.0.i, %i.bj
  %i.bp = fmul double %i.bk, %i.bl
  %i.bq = fmul double %i.ao, %i.bp
  %i.br = fdiv double %i.bo, %i.bq                ; 2 uses
  store double %i.br, ptr %2, align 8, !tbaa !95
  %i.bs = load double, ptr %i.a, align 8, !tbaa !233 ; 2 uses
  %i.bt = fcmp oeq double %i.bs, 0.000000e+00
  %i.bu = fcmp olt double %i.br, %i.bs
  %spec.select = select i1 %i.bt, i1 true, i1 %i.bu
  br label %bb.d
...
bb.bl:                                            ; preds = %_ZNK4CGAL14Surface_mesher19Surface_mesher_baseINS_28Complex_2_in_triangulation_3INS_24Delaunay_triangulation_3INS_28Robust_circumcenter_traits_3INS_5EpickEEENS_30Triangulation_data_structure_3INS_26Surface_mesh_vertex_base_3IS6_NS_27Triangulation_vertex_base_3IS6_NS_30Triangulation_ds_vertex_base_3IvEEEEEENS_52Delaunay_triangulation_cell_base_with_circumcenter_3IS6_NS_24Surface_mesh_cell_base_3IS6_NS_34Delaunay_triangulation_cell_base_3IS6_NS_25Triangulation_cell_base_3IS6_NS_28Triangulation_ds_cell_base_3IvEEEEEEEEEENS_14Sequential_tagEEENS_7DefaultESQ_EEvEENS_18Implicit_surface_3IS6_St8functionIFdNS_7Point_3IS5_EEEEEENS0_25Implicit_surface_oracle_3IS6_SZ_NS_10INTERN_RET27Real_embeddable_traits_baseIdSt17integral_constantIbLb1EEE3SgnENS0_12_GLOBAL__N_110Return_minINS_4SignEEENS_17Creator_uniform_3IdSW_EENS0_19Null_oracle_visitorEEENS_31Surface_mesh_default_criteria_3ISR_EEE12mirror_facetERKSt4pairINS_8internal11CC_iteratorINS_17Compact_containerINSE_IS6_NSF_IS6_NSG_IS6_NSH_IS6_NSI_ISP_EEEEEEEEEESQ_SQ_SQ_EE16
  ...
  %i.xk = load double, ptr %i.xj, align 8, !tbaa !95, !noalias !1498
  ...
  %i.xp = load double, ptr %i.xo, align 8, !tbaa !95, !noalias !1499
  %i.xq = load <2 x double>, ptr %i.xi, align 8, !tbaa !95, !noalias !1498 ; 2 uses
  %i.xr = load double, ptr %i.ww, align 8, !tbaa !95, !noalias !1498 ; 2 uses
  %i.xs = load double, ptr %i.wv, align 8, !tbaa !95, !noalias !1498 ; 2 uses
  %i.xt = load double, ptr %i.wx, align 8, !tbaa !95, !noalias !1498 ; 2 uses
  %i.xu = load <2 x double>, ptr %i.xn, align 8, !tbaa !95, !noalias !1499 ; 2 uses
...
bb.bp:                                            ; preds = %.noexc22
  ...
  %.sroa.02.0.copyload.i.i.i.i.i.i = load ptr, ptr %i.zv, align 8, !tbaa !171 ; 5 uses
  ...
  store i64 0, ptr %i.sk, align 8, !tbaa !1501
...
.lr.ph.i.i.i.i.i.i.i:                             ; preds = %_ZN4CGAL28Complex_2_in_triangulation_3INS_24Delaunay_triangulation_3INS_28Robust_circumcenter_traits_3INS_5EpickEEENS_30Triangulation_data_structure_3INS_26Surface_mesh_vertex_base_3IS4_NS_27Triangulation_vertex_base_3IS4_NS_30Triangulation_ds_vertex_base_3IvEEEEEENS_52Delaunay_triangulation_cell_base_with_circumcenter_3IS4_NS_24Surface_mesh_cell_base_3IS4_NS_34Delaunay_triangulation_cell_base_3IS4_NS_25Triangulation_cell_base_3IS4_NS_28Triangulation_ds_cell_base_3IvEEEEEEEEEENS_14Sequential_tagEEENS_7DefaultESO_EEvE15incident_facetsISt20back_insert_iteratorINSt7__cxx114listISt4pairINS_8internal11CC_iteratorINS_17Compact_containerINSC_IS4_NSD_IS4_NSE_IS4_NSF_IS4_NSG_ISN_EEEEEEEEEESO_SO_SO_EELb0EEEiESaIS16_EEEEEET_NSX_INSY_INS6_IS4_NS7_IS4_NS8_ISN_EEEEEESO_SO_SO_EELb0EEES1A_.exit.i.i.i.i.i.i.i
  ...
  %48 = getelementptr inbounds nuw i8, ptr %.sroa.02.0.copyload.i.i.i.i.i.i, i64 24
  %49 = getelementptr inbounds nuw i8, ptr %.sroa.02.0.copyload.i.i.i.i.i.i, i64 32
  %50 = load double, ptr %48, align 8, !tbaa !95, !noalias !1502
  %51 = load double, ptr %i.aag, align 8, !tbaa !95, !noalias !1502
  %52 = load double, ptr %49, align 8, !tbaa !95, !noalias !1502
  ...
  %.pre.i.i.i.i.i19.i.i = load double, ptr %.phi.trans.insert35.i.i.i.i.i.i.i, align 8, !tbaa !95, !noalias !1503
  %.phi.trans.insert36.i.i.i.i.i.i.i = getelementptr inbounds nuw i8, ptr %.phi.trans.insert35.i.i.i.i.i.i.i, i64 8
  %.pre37.i.i.i.i.i.i.i = load double, ptr %.phi.trans.insert36.i.i.i.i.i.i.i, align 8, !tbaa !95, !noalias !1503
  %.phi.trans.insert38.i.i.i.i.i.i.i = getelementptr inbounds nuw i8, ptr %.phi.trans.insert35.i.i.i.i.i.i.i, i64 16
  %.pre39.i.i.i.i.i.i.i = load double, ptr %.phi.trans.insert38.i.i.i.i.i.i.i, align 8, !tbaa !95, !noalias !1503
  ...
  %i.aah = shufflevector <2 x double> %55, <2 x double> poison, <2 x i32> zeroinitializer
...
bb.bs:                                            ; preds = %bb.bs, %.lr.ph.i.i.i.i.i.i.i
  ...
  %i.aar = load double, ptr %i.aaq, align 8, !tbaa !95, !noalias !1502 ; 2 uses
  %i.aas = load <2 x double>, ptr %i.aao, align 8, !tbaa !95, !noalias !1502 ; 3 uses
  %i.aat = load double, ptr %i.aap, align 8, !tbaa !95, !noalias !1502
  ...
  br i1 %.not.i.i.i.i.i20.i.i, label %._crit_edge.i.i.i.i.i.i.i, label %bb.bs, !llvm.loop !1449
...
.noexc24:                                         ; preds = %_ZN4CGAL12Mesher_levelINS_24Delaunay_triangulation_3INS_28Robust_circumcenter_traits_3INS_5EpickEEENS_30Triangulation_data_structure_3INS_26Surface_mesh_vertex_base_3IS4_NS_27Triangulation_vertex_base_3IS4_NS_30Triangulation_ds_vertex_base_3IvEEEEEENS_52Delaunay_triangulation_cell_base_with_circumcenter_3IS4_NS_24Surface_mesh_cell_base_3IS4_NS_34Delaunay_triangulation_cell_base_3IS4_NS_25Triangulation_cell_base_3IS4_NS_28Triangulation_ds_cell_base_3IvEEEEEEEEEENS_14Sequential_tagEEENS_7DefaultESO_EENS_14Surface_mesher14Surface_mesherINSQ_28Surface_mesher_manifold_baseINS_28Complex_2_in_triangulation_3ISP_vEENS_18Implicit_surface_3IS4_St8functionIFdNS_7Point_3IS3_EEEEEENSQ_25Implicit_surface_oracle_3IS4_S11_NS_10INTERN_RET27Real_embeddable_traits_baseIdSt17integral_constantIbLb1EEE3SgnENSQ_12_GLOBAL__N_110Return_minINS_4SignEEENS_17Creator_uniform_3IdSY_EENSQ_19Null_oracle_visitorEEENS_31Surface_mesh_default_criteria_3ISP_EENSQ_33Surface_mesher_regular_edges_baseISU_S11_S1G_S1I_Lb0EEEEESt4pairINS_8internal11CC
  %i.abt = load ptr, ptr %i.hp, align 8, !tbaa !498, !noalias !1506, !nonnull !83, !align !332
...
_ZNK4CGAL15Triangulation_3INS_28Robust_circumcenter_traits_3INS_5EpickEEENS_30Triangulation_data_structure_3INS_26Surface_mesh_vertex_base_3IS3_NS_27Triangulation_vertex_base_3IS3_NS_30Triangulation_ds_vertex_base_3IvEEEEEENS_52Delaunay_triangulation_cell_base_with_circumcenter_3IS3_NS_24Surface_mesh_cell_base_3IS3_NS_34Delaunay_triangulation_cell_base_3IS3_NS_25Triangulation_cell_base_3IS3_NS_28Triangulation_ds_cell_base_3IvEEEEEEEEEENS_14Sequential_tagEEENS_7DefaultEE6locateERKNS_7Point_3IS2_EERNSO_11Locate_typeERiSV_NS_8internal11CC_iteratorINS_17Compact_containerINSB_IS3_NSC_IS3_NSD_IS3_NSE_IS3_NSF_ISM_EEEEEEEEEESN_SN_SN_EELb0EEEPb.exit.i.i.i.i.i.i.i: ; preds = %.noexc24
  store ptr %i.abu, ptr %i.so, align 8, !tbaa !345, !alias.scope !1506
  %i.abv = load i32, ptr %34, align 8, !tbaa !524, !alias.scope !1506
...
bb.bu:                                            ; preds = %_ZNK4CGAL15Triangulation_3INS_28Robust_circumcenter_traits_3INS_5EpickEEENS_30Triangulation_data_structure_3INS_26Surface_mesh_vertex_base_3IS3_NS_27Triangulation_vertex_base_3IS3_NS_30Triangulation_ds_vertex_base_3IvEEEEEENS_52Delaunay_triangulation_cell_base_with_circumcenter_3IS3_NS_24Surface_mesh_cell_base_3IS3_NS_34Delaunay_triangulation_cell_base_3IS3_NS_25Triangulation_cell_base_3IS3_NS_28Triangulation_ds_cell_base_3IvEEEEEEEEEENS_14Sequential_tagEEENS_7DefaultEE6locateERKNS_7Point_3IS2_EERNSO_11Locate_typeERiSV_NS_8internal11CC_iteratorINS_17Compact_containerINSB_IS3_NSC_IS3_NSD_IS3_NSE_IS3_NSF_ISM_EEEEEEEEEESN_SN_SN_EELb0EEEPb.exit.i.i.i.i.i.i.i
  %i.abw = load ptr, ptr %i.hp, align 8, !tbaa !498, !noalias !1506, !nonnull !83, !align !332
  call void @llvm.lifetime.start.p0(ptr nonnull %31) #38, !noalias !1506
...
bb.bv:                                            ; preds = %bb.bu
  call void @llvm.lifetime.end.p0(ptr nonnull %31) #38, !noalias !1506
