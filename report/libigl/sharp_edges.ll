...
bb.d:                                             ; preds = %.lr.ph
  ...
  %12 = fmul double %i.cw, %i.ci
  %13 = fmul <2 x double> %.sroa.0112.8.vec.insert, %.sroa.0100.8.vec.insert ; 2 uses
  %14 = shufflevector <2 x double> %i.cx, <2 x double> %13, <2 x i32> <i32 0, i32 2>
  %15 = shufflevector <2 x double> %i.cx, <2 x double> %13, <2 x i32> <i32 1, i32 3>
  %16 = fadd <2 x double> %14, %15                ; 2 uses
  %17 = extractelement <2 x double> %16, i64 0
  %18 = fadd double %12, %17
  %19 = fmul double %i.bk, %i.br
  %i.cy = extractelement <2 x double> %16, i64 1
  %i.cz = fadd double %19, %i.cy
  %i.da = call double @atan2(double noundef %18, double noundef %i.cz) #18
