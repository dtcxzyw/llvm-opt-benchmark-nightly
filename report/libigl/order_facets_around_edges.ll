...
.invoke:                                          ; preds = %_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit.i.i, %bb.s
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.hr, align 8, !tbaa !45
...
bb.t:                                             ; preds = %.invoke
  %i.hs = landingpad { ptr, i32 }
          cleanup
  %i.ht = load ptr, ptr %8, align 8, !tbaa !83
...
.lr.ph366:                                        ; preds = %bb.u
  ...
  %i.ib = load ptr, ptr %i.ax, align 8, !tbaa !22
  %i.ic = load ptr, ptr %1, align 8, !tbaa !40
  %i.id = load i64, ptr %i.a, align 8, !tbaa !16
  %i.ie = load ptr, ptr %2, align 8, !tbaa !83, !noalias !92
  %i.if = load i64, ptr %i.ar, align 8, !tbaa !85 ; 2 uses
  %.idx.i.i.i.i.i.i.i.i.i.i149 = shl nsw i64 %i.if, 4
  %i.ig = load ptr, ptr %8, align 8, !tbaa !83
  %i.ih = load i64, ptr %i.au, align 8, !tbaa !85 ; 2 uses
  %.idx = shl i64 %i.ih, 4
...
bb.v:                                             ; preds = %.lr.ph366, %bb.aa
  ...
  %i.in = load i32, ptr %i.im, align 4, !tbaa !36
  ...
  %i.iw = load i32, ptr %i.iv, align 4, !tbaa !36
...
bb.w:                                             ; preds = %bb.v
  %i.je = load i64, ptr %storemerge.i.i.i.i.i, align 8, !tbaa !46
  %i.jf = or i64 %i.je, %i.jc
  br label %bb.y

bb.x:                                             ; preds = %bb.v
  %i.jg = xor i64 %i.jc, -1
  %i.jh = load i64, ptr %storemerge.i.i.i.i.i, align 8, !tbaa !46
...
bb.y:                                             ; preds = %bb.w, %bb.x
  ...
  %i.jk = load double, ptr %i.jj, align 8, !tbaa !39 ; 3 uses
  ...
  %i.jm = load double, ptr %i.jl, align 8, !tbaa !39 ; 3 uses
  ...
  %i.jo = load double, ptr %i.jn, align 8, !tbaa !39 ; 3 uses
  ...
  store double %i.kh, ptr %i.kb, align 8, !tbaa !39
  ...
  store double %i.kk, ptr %i.kl, align 8, !tbaa !39
  %i.km = and i64 %storemerge353, %i.jc
  %.not = icmp eq i64 %i.km, 0                    ; 2 uses
  br i1 %.not, label %bb.aa, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.kn = load double, ptr %i.kb, align 8, !tbaa !39
  %i.ko = fneg double %i.kn
  store double %i.ko, ptr %i.kb, align 8, !tbaa !39
  %i.kp = load double, ptr %i.kl, align 8, !tbaa !39
  %i.kq = fneg double %i.kp
  store double %i.kq, ptr %i.kl, align 8, !tbaa !39
  br label %bb.aa

bb.aa:                                            ; preds = %bb.y, %bb.z
  %i.kr = load double, ptr %i.kb, align 8, !tbaa !39
  %i.ks = fneg double %i.kr
  store double %i.ks, ptr %i.kb, align 8, !tbaa !39
  ...
  store double %i.kx, ptr %i.kt, align 8, !tbaa !39
...
bb.ab:                                            ; preds = %._crit_edge
  %i.kz = load ptr, ptr %5, align 8, !tbaa !20
  %i.la = getelementptr inbounds nuw [24 x i8], ptr %i.kz, i64 %.0112370 ; 4 uses
  %i.lb = load ptr, ptr %6, align 8, !tbaa !28
  ...
  %i.le = load ptr, ptr %i.ld, align 8, !tbaa !35 ; 2 uses
  %i.lf = load ptr, ptr %i.la, align 8, !tbaa !22 ; 2 uses
...
_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E.exit.i.i:        ; preds = %bb.ae
  store ptr %i.ln, ptr %i.ld, align 8, !tbaa !35
...
_ZNSt6vectorIiSaIiEE6resizeEm.exit:               ; preds = %_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E.exit.i.i, %bb.ae, %bb.ad, %bb.ac
  ...
  %i.lp = load ptr, ptr %i.lo, align 8, !tbaa !31 ; 2 uses
  %i.lq = getelementptr inbounds nuw i8, ptr %i.lc, i64 24 ; 2 uses
  %i.lr = load i32, ptr %i.lq, align 8, !tbaa !47 ; 2 uses
end_hunk_0
