...
bb.b:                                             ; preds = %.lr.ph, %bb.d
  ...
  %4 = fadd double %i.ce, %3
  %.scalar.i = tail call noundef double @llvm.sqrt.f64(double %4)
  ...
  %shift115 = shufflevector <2 x double> %i.cp, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop116 = fadd <2 x double> %i.cp, %shift115
  %i.cq = extractelement <2 x double> %foldExtExtBinop116, i64 0
