...
.rtvec:                                           ; preds = %bb.a
  ...
  %4 = load float, ptr %i.j, align 4, !tbaa !13
  %i.w = load float, ptr %0, align 4, !tbaa !13
  %i.x = load float, ptr %i.m, align 4, !tbaa !13
  %i.y = load float, ptr %1, align 4, !tbaa !13
  %i.z = fmul float %4, %i.x
  %i.aa = tail call float @llvm.fmuladd.f32(float %i.q, float %i.y, float %i.z)
  %5 = load float, ptr %i.l, align 4, !tbaa !13
  %i.ab = load float, ptr %i.j, align 4, !tbaa !13
  %i.ac = tail call float @llvm.fmuladd.f32(float %5, float %i.p, float %i.aa)
  %i.ad = insertelement <4 x float> poison, float %3, i64 0
  %i.ae = insertelement <4 x float> %i.ad, float %i.w, i64 1
  ...
  %i.an = insertelement <4 x float> %i.am, float %i.n, i64 1
  %i.ao = insertelement <4 x float> %i.an, float %i.n, i64 2
  ...
  %i.ar = insertelement <4 x float> %i.aq, float %i.h, i64 1
  %i.as = insertelement <4 x float> %i.ar, float %i.o, i64 2
