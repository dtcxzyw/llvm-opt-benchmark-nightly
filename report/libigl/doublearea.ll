...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !209, !noalias !210
  %i.bs = getelementptr [4 x i8], ptr %i.br, i64 %i.b
  %wide.load271 = load <2 x i32>, ptr %i.bs, align 4, !tbaa !45, !alias.scope !211, !noalias !212
  %i.bt = getelementptr [4 x i8], ptr %i.bq, i64 %i.c
  %i.bu = getelementptr i8, ptr %i.br, i64 %.idx
  %wide.load272 = load <2 x i32>, ptr %i.bu, align 4, !tbaa !45, !alias.scope !213, !noalias !212 ; 2 uses
  ...
  store <4 x i32> %interleaved.vec, ptr %i.bq, align 4, !tbaa !45, !noalias !53
  %i.bw = getelementptr i8, ptr %i.br, i64 %.idx94
  %wide.load273 = load <2 x i32>, ptr %i.bw, align 4, !tbaa !45, !alias.scope !214, !noalias !212
  %interleaved.vec274 = shufflevector <2 x i32> %wide.load271, <2 x i32> %wide.load273, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec274, ptr %i.bt, align 4, !tbaa !45
  %wide.load275 = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !209, !noalias !212
  %interleaved.vec276 = shufflevector <2 x i32> %wide.load272, <2 x i32> %wide.load275, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec276, ptr %i.bv, align 4, !tbaa !45
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.bx = icmp eq i64 %index.next, %n.vec
  br i1 %i.bx, label %middle.block, label %vector.body, !llvm.loop !200
...
_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58: ; preds = %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58.preheader, %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58
  ...
  %i.ca = load i32, ptr %i.bz, align 4, !tbaa !45, !noalias !215
  store i32 %i.ca, ptr %i.by, align 4, !tbaa !45, !noalias !215
  ...
  %i.cf = load i32, ptr %i.ce, align 4, !tbaa !45 ; 2 uses
  %i.cg = getelementptr i8, ptr %i.by, i64 %.idx93
  store i32 %i.cf, ptr %i.cg, align 4, !tbaa !45
  %i.ch = getelementptr i8, ptr %i.by, i64 4      ; 3 uses
  store i32 %i.cf, ptr %i.ch, align 4, !tbaa !45, !noalias !216
  %i.ci = getelementptr i8, ptr %i.bz, i64 %.idx94
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !45
  %i.ck = getelementptr [4 x i8], ptr %i.ch, i64 %i.c
  store i32 %i.cj, ptr %i.ck, align 4, !tbaa !45
  %i.cl = load i32, ptr %i.bz, align 4, !tbaa !45
  ...
  br i1 %exitcond.not, label %._crit_edge, label %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58, !llvm.loop !203
...
bb.d:                                             ; preds = %._crit_edge
  %i.co = load i64, ptr %i.a, align 8, !tbaa !34
...
.preheader:                                       ; preds = %bb.d
  %i.cp = load i64, ptr %i.a, align 8, !tbaa !34  ; 7 uses
  %i.cq = icmp sgt i64 %i.cp, 0
  %.pre = load ptr, ptr %4, align 8, !tbaa !38    ; 7 uses
  br i1 %i.cq, label %.lr.ph, label %._crit_edge98

.lr.ph:                                           ; preds = %.preheader
  %i.cr = load ptr, ptr %2, align 8, !tbaa !38    ; 4 uses
...
vector.body292:                                   ; preds = %vector.body292, %vector.ph290
  ...
  %wide.vec = load <4 x double>, ptr %i.cy, align 8, !tbaa !40, !alias.scope !217 ; 2 uses
  ...
  %wide.vec295 = load <4 x double>, ptr %i.da, align 8, !tbaa !40, !alias.scope !217 ; 2 uses
  ...
  store <2 x double> %i.dc, ptr %i.db, align 8, !tbaa !40, !alias.scope !218, !noalias !217
  store <2 x double> %i.dd, ptr %i.de, align 8, !tbaa !40, !alias.scope !218, !noalias !217
  %index.next298 = add nuw i64 %index293, 4       ; 2 uses
  %i.df = icmp eq i64 %index.next298, %n.vec291
  br i1 %i.df, label %middle.block299, label %vector.body292, !llvm.loop !207
...
._crit_edge98:                                    ; preds = %scalar.ph288, %middle.block299, %.preheader
  ...
  %i.dg = load ptr, ptr %3, align 8, !tbaa !41
...
common.resume:                                    ; preds = %bb.d, %._crit_edge
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #23
  %i.dj = load ptr, ptr %3, align 8, !tbaa !41
...
bb.c:                                             ; preds = %bb.b
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.e, align 8, !tbaa !52
...
bb.d:                                             ; preds = %_ZN5Eigen8internal28check_rows_cols_for_overflowILin1EE3runIlEEvT_S4_.exit
  %i.i = load ptr, ptr %0, align 8, !tbaa !38
...
bb.f:                                             ; preds = %bb.e
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.l, align 8, !tbaa !52
...
bb.g:                                             ; preds = %_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit.i.i
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.p, align 8, !tbaa !52
...
_ZN5Eigen12DenseStorageIdLin1ELin1ELi1ELi0EE6resizeElll.exit: ; preds = %_ZN5Eigen8internal28check_rows_cols_for_overflowILin1EE3runIlEEvT_S4_.exit, %.sink.split.i
  store i64 %1, ptr %i.g, align 8, !tbaa !37
  ret void
}
...
bb.c:                                             ; preds = %bb.b
  ...
  store ptr %2, ptr %i.f, align 8, !tbaa !57
  %i.g = getelementptr inbounds nuw i8, ptr %7, i64 16
  store ptr %i.a, ptr %i.g, align 8, !tbaa !58
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.i = load ptr, ptr %6, align 8, !tbaa !41
  call void @free(ptr noundef %i.i) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #23
  %i.j = load ptr, ptr %5, align 8, !tbaa !43
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  %i.m = load ptr, ptr %6, align 8, !tbaa !41
  call void @free(ptr noundef %i.m) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #23
  %i.n = load ptr, ptr %5, align 8, !tbaa !43
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bq = getelementptr i8, ptr %.sink.i108, i64 %i.bp ; 3 uses
  %i.br = getelementptr [4 x i8], ptr %i.o, i64 %index ; 5 uses
  %wide.load = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !256, !noalias !257
  %i.bs = getelementptr [4 x i8], ptr %i.br, i64 %i.b
  %wide.load271 = load <2 x i32>, ptr %i.bs, align 4, !tbaa !45, !alias.scope !258, !noalias !259
  %i.bt = getelementptr [4 x i8], ptr %i.bq, i64 %i.c
  %i.bu = getelementptr i8, ptr %i.br, i64 %.idx
  %wide.load272 = load <2 x i32>, ptr %i.bu, align 4, !tbaa !45, !alias.scope !260, !noalias !259 ; 2 uses
  %i.bv = getelementptr i8, ptr %i.bq, i64 %.idx93
  %interleaved.vec = shufflevector <2 x i32> %wide.load, <2 x i32> %wide.load272, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec, ptr %i.bq, align 4, !tbaa !45, !noalias !53
  %i.bw = getelementptr i8, ptr %i.br, i64 %.idx94
  %wide.load273 = load <2 x i32>, ptr %i.bw, align 4, !tbaa !45, !alias.scope !261, !noalias !259
  %interleaved.vec274 = shufflevector <2 x i32> %wide.load271, <2 x i32> %wide.load273, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec274, ptr %i.bt, align 4, !tbaa !45
  %wide.load275 = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !256, !noalias !259
  %interleaved.vec276 = shufflevector <2 x i32> %wide.load272, <2 x i32> %wide.load275, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec276, ptr %i.bv, align 4, !tbaa !45
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.bx = icmp eq i64 %index.next, %n.vec
  br i1 %i.bx, label %middle.block, label %vector.body, !llvm.loop !247
...
_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58: ; preds = %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58.preheader, %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58
  ...
  %i.by = getelementptr i8, ptr %.sink.i108, i64 %.idx103 ; 4 uses
  %i.bz = getelementptr [4 x i8], ptr %i.o, i64 %.03796 ; 5 uses
  %i.ca = load i32, ptr %i.bz, align 4, !tbaa !45, !noalias !262
  store i32 %i.ca, ptr %i.by, align 4, !tbaa !45, !noalias !262
  %i.cb = getelementptr [4 x i8], ptr %i.bz, i64 %i.b
  %i.cc = load i32, ptr %i.cb, align 4, !tbaa !45
  %i.cd = getelementptr [4 x i8], ptr %i.by, i64 %i.c
  store i32 %i.cc, ptr %i.cd, align 4, !tbaa !45
  ...
  store i32 %i.cf, ptr %i.cg, align 4, !tbaa !45
  %i.ch = getelementptr i8, ptr %i.by, i64 4      ; 3 uses
  store i32 %i.cf, ptr %i.ch, align 4, !tbaa !45, !noalias !263
  %i.ci = getelementptr i8, ptr %i.bz, i64 %.idx94
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !45
  %i.ck = getelementptr [4 x i8], ptr %i.ch, i64 %i.c
  store i32 %i.cj, ptr %i.ck, align 4, !tbaa !45
  ...
  %i.cn = add nuw i64 %.03796, 1                  ; 2 uses
  %exitcond.not = icmp eq i64 %i.cn, %i.b
  br i1 %exitcond.not, label %._crit_edge, label %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58, !llvm.loop !250
...
.preheader:                                       ; preds = %bb.d
  %i.cp = load i64, ptr %i.a, align 8, !tbaa !34  ; 7 uses
  %i.cq = icmp sgt i64 %i.cp, 0
  %.pre = load ptr, ptr %4, align 8, !tbaa !63    ; 7 uses
  br i1 %i.cq, label %.lr.ph, label %._crit_edge98

.lr.ph:                                           ; preds = %.preheader
  %i.cr = load ptr, ptr %2, align 8, !tbaa !63    ; 4 uses
  %5 = add nsw i64 %i.cp, -2147483649
  %min.iters.check289 = icmp ult i64 %5, -2147483629
  br i1 %min.iters.check289, label %scalar.ph288.preheader, label %vector.memcheck282
...
vector.body292:                                   ; preds = %vector.body292, %vector.ph290
  ...
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 32
  %wide.vec = load <8 x float>, ptr %i.cy, align 4, !tbaa !65, !alias.scope !264 ; 2 uses
  %strided.vec = shufflevector <8 x float> %wide.vec, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %strided.vec294 = shufflevector <8 x float> %wide.vec, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %wide.vec295 = load <8 x float>, ptr %i.da, align 4, !tbaa !65, !alias.scope !264 ; 2 uses
  ...
  %i.de = getelementptr inbounds nuw i8, ptr %i.db, i64 16
  store <4 x float> %i.dc, ptr %i.db, align 4, !tbaa !65, !alias.scope !265, !noalias !264
  store <4 x float> %i.dd, ptr %i.de, align 4, !tbaa !65, !alias.scope !265, !noalias !264
  %index.next298 = add nuw i64 %index293, 8       ; 2 uses
  %i.df = icmp eq i64 %index.next298, %n.vec291
  br i1 %i.df, label %middle.block299, label %vector.body292, !llvm.loop !254
...
common.resume:                                    ; preds = %bb.d, %._crit_edge
  %i.dh = landingpad { ptr, i32 }
          cleanup
  %i.di = load ptr, ptr %4, align 8, !tbaa !63
  call void @free(ptr noundef %i.di) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #23
  %i.dj = load ptr, ptr %3, align 8, !tbaa !41
  call void @free(ptr noundef %i.dj) #23
...
scalar.ph288:                                     ; preds = %scalar.ph288.preheader, %scalar.ph288
  ...
  %i.do = load float, ptr %i.dn, align 4, !tbaa !65
  %i.dp = or disjoint i32 %i.dl, 1
  %i.dq = zext i32 %i.dp to i64
  %i.dr = getelementptr inbounds nuw [4 x i8], ptr %.pre, i64 %i.dq
  %i.ds = load float, ptr %i.dr, align 4, !tbaa !65
  %i.dt = getelementptr inbounds nuw [4 x i8], ptr %i.cr, i64 %indvars.iv
  %i.du = fadd float %i.do, %i.ds
  store float %i.du, ptr %i.dt, align 4, !tbaa !65
  %indvars.iv.next = add i64 %indvars.iv, 1       ; 2 uses
  %i.dv = and i64 %indvars.iv.next, 4294967295
  %i.dw = icmp samesign ugt i64 %i.cp, %i.dv
  br i1 %i.dw, label %scalar.ph288, label %._crit_edge98, !llvm.loop !255
}
...
bb.d:                                             ; preds = %_ZN5Eigen8internal28check_rows_cols_for_overflowILin1EE3runIlEEvT_S4_.exit
  %i.i = load ptr, ptr %0, align 8, !tbaa !63
  tail call void @free(ptr noundef %i.i) #23
  %i.j = icmp sgt i64 %i.f, 0
  br i1 %i.j, label %bb.e, label %.sink.split.i
...
_ZN5Eigen12DenseStorageIfLin1ELin1ELi1ELi0EE6resizeElll.exit: ; preds = %_ZN5Eigen8internal28check_rows_cols_for_overflowILin1EE3runIlEEvT_S4_.exit, %.sink.split.i
  store i64 %1, ptr %i.g, align 8, !tbaa !62
  ret void
}
...
bb.a:
  ...
  store float %1, ptr %i.a, align 4, !tbaa !65
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.f = getelementptr inbounds nuw i8, ptr %7, i64 8
  store ptr %2, ptr %i.f, align 8, !tbaa !267
  %i.g = getelementptr inbounds nuw i8, ptr %7, i64 16
  store ptr %i.a, ptr %i.g, align 8, !tbaa !268
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #23
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #23
  store ptr %7, ptr %4, align 8, !tbaa !59
...
bb.d:                                             ; preds = %bb.c
  ...
  call void @free(ptr noundef %i.i) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #23
  %i.j = load ptr, ptr %5, align 8, !tbaa !67
  call void @free(ptr noundef %i.j) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #23
  ret void
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  call void @free(ptr noundef %i.m) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #23
  %i.n = load ptr, ptr %5, align 8, !tbaa !67
  call void @free(ptr noundef %i.n) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #23
  resume { ptr, i32 } %.pn
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bq = getelementptr i8, ptr %.sink.i108, i64 %i.bp ; 3 uses
  %i.br = getelementptr [4 x i8], ptr %i.o, i64 %index ; 5 uses
  %wide.load = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !295, !noalias !296
  %i.bs = getelementptr [4 x i8], ptr %i.br, i64 %i.b
  %wide.load271 = load <2 x i32>, ptr %i.bs, align 4, !tbaa !45, !alias.scope !297, !noalias !298
  %i.bt = getelementptr [4 x i8], ptr %i.bq, i64 %i.c
  %i.bu = getelementptr i8, ptr %i.br, i64 %.idx
  %wide.load272 = load <2 x i32>, ptr %i.bu, align 4, !tbaa !45, !alias.scope !299, !noalias !298 ; 2 uses
  %i.bv = getelementptr i8, ptr %i.bq, i64 %.idx93
  %interleaved.vec = shufflevector <2 x i32> %wide.load, <2 x i32> %wide.load272, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec, ptr %i.bq, align 4, !tbaa !45, !noalias !53
  %i.bw = getelementptr i8, ptr %i.br, i64 %.idx94
  %wide.load273 = load <2 x i32>, ptr %i.bw, align 4, !tbaa !45, !alias.scope !300, !noalias !298
  %interleaved.vec274 = shufflevector <2 x i32> %wide.load271, <2 x i32> %wide.load273, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec274, ptr %i.bt, align 4, !tbaa !45
  %wide.load275 = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !295, !noalias !298
  %interleaved.vec276 = shufflevector <2 x i32> %wide.load272, <2 x i32> %wide.load275, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec276, ptr %i.bv, align 4, !tbaa !45
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.bx = icmp eq i64 %index.next, %n.vec
  br i1 %i.bx, label %middle.block, label %vector.body, !llvm.loop !286
...
_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58: ; preds = %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58.preheader, %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58
  ...
  %i.by = getelementptr i8, ptr %.sink.i108, i64 %.idx103 ; 4 uses
  %i.bz = getelementptr [4 x i8], ptr %i.o, i64 %.03796 ; 5 uses
  %i.ca = load i32, ptr %i.bz, align 4, !tbaa !45, !noalias !301
  store i32 %i.ca, ptr %i.by, align 4, !tbaa !45, !noalias !301
  %i.cb = getelementptr [4 x i8], ptr %i.bz, i64 %i.b
  %i.cc = load i32, ptr %i.cb, align 4, !tbaa !45
  %i.cd = getelementptr [4 x i8], ptr %i.by, i64 %i.c
  store i32 %i.cc, ptr %i.cd, align 4, !tbaa !45
  ...
  store i32 %i.cf, ptr %i.cg, align 4, !tbaa !45
  %i.ch = getelementptr i8, ptr %i.by, i64 4      ; 3 uses
  store i32 %i.cf, ptr %i.ch, align 4, !tbaa !45, !noalias !302
  %i.ci = getelementptr i8, ptr %i.bz, i64 %.idx94
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !45
  %i.ck = getelementptr [4 x i8], ptr %i.ch, i64 %i.c
  store i32 %i.cj, ptr %i.ck, align 4, !tbaa !45
  ...
  %i.cn = add nuw i64 %.03796, 1                  ; 2 uses
  %exitcond.not = icmp eq i64 %i.cn, %i.b
  br i1 %exitcond.not, label %._crit_edge, label %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58, !llvm.loop !289
...
vector.body292:                                   ; preds = %vector.body292, %vector.ph290
  ...
  %i.cz = getelementptr inbounds nuw [8 x i8], ptr %.pre, i64 %i.cx
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 32
  %wide.vec = load <4 x double>, ptr %i.cy, align 8, !tbaa !40, !alias.scope !303 ; 2 uses
  %strided.vec = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %strided.vec294 = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %wide.vec295 = load <4 x double>, ptr %i.da, align 8, !tbaa !40, !alias.scope !303 ; 2 uses
  %strided.vec296 = shufflevector <4 x double> %wide.vec295, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %strided.vec297 = shufflevector <4 x double> %wide.vec295, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %i.db = getelementptr inbounds nuw [8 x i8], ptr %i.cr, i64 %index293 ; 2 uses
  %i.dc = fadd <2 x double> %strided.vec, %strided.vec294
  %i.dd = fadd <2 x double> %strided.vec296, %strided.vec297
  %i.de = getelementptr inbounds nuw i8, ptr %i.db, i64 16
  store <2 x double> %i.dc, ptr %i.db, align 8, !tbaa !40, !alias.scope !304, !noalias !303
  store <2 x double> %i.dd, ptr %i.de, align 8, !tbaa !40, !alias.scope !304, !noalias !303
  %index.next298 = add nuw i64 %index293, 4       ; 2 uses
  %i.df = icmp eq i64 %index.next298, %n.vec291
  br i1 %i.df, label %middle.block299, label %vector.body292, !llvm.loop !293
...
scalar.ph288:                                     ; preds = %scalar.ph288.preheader, %scalar.ph288
  ...
  %i.dv = and i64 %indvars.iv.next, 4294967295
  %i.dw = icmp samesign ugt i64 %i.cp, %i.dv
  br i1 %i.dw, label %scalar.ph288, label %._crit_edge98, !llvm.loop !294
}
...
.noexc47:                                         ; preds = %.noexc
  tail call void @_ZN5Eigen15PlainObjectBaseINS_6MatrixIfLin1ELi1ELi0ELin1ELi1EEEE6resizeEll(ptr noundef nonnull align 8 dereferenceable(16) %2, i64 noundef %i.b, i64 noundef 1)
  %.pr.i.i.i.i.i.i.i = load i64, ptr %i.c, align 8, !tbaa !62
...
_ZN5Eigen15PlainObjectBaseINS_6MatrixIfLin1ELi1ELi0ELin1ELi1EEEEaSINS_14CwiseNullaryOpINS_8internal18scalar_constant_opIfEES2_EEEERS2_RKNS_9EigenBaseIT_EE.exit.loopexit: ; preds = %_ZN5Eigen8internal17resize_if_allowedINS_6MatrixIfLin1ELi1ELi0ELin1ELi1EEENS_14CwiseNullaryOpINS0_18scalar_constant_opIfEES3_EEffEEvRT_RKT0_RKNS0_9assign_opIT1_T2_EE.exit.i.i.i.i.i.i.i
  %i.g = load ptr, ptr %2, align 8, !tbaa !63
  %.idx.i.i.i.i.i.i.i.i.i = shl nuw nsw i64 %i.e, 2
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.g, i8 0, i64 %.idx.i.i.i.i.i.i.i.i.i, i1 false), !tbaa !65
...
.preheader.lr.ph:                                 ; preds = %_ZN5Eigen15PlainObjectBaseINS_6MatrixIfLin1ELi1ELi0ELin1ELi1EEEEaSINS_14CwiseNullaryOpINS_8internal18scalar_constant_opIfEES2_EEEERS2_RKNS_9EigenBaseIT_EE.exit
  %i.h = load ptr, ptr %1, align 8, !tbaa !76
  %i.i = load ptr, ptr %0, align 8, !tbaa !67     ; 3 uses
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.k = load i64, ptr %i.j, align 8, !tbaa !68   ; 4 uses
  %i.l = load i64, ptr %i.a, align 8, !tbaa !75   ; 2 uses
  %.idx.i = shl i64 %i.l, 3
...
.preheader:                                       ; preds = %.preheader.lr.ph, %.preheader
  ...
  %.promoted = load float, ptr %i.ab, align 4, !tbaa !65
  %i.ac = load float, ptr %i.s, align 4, !tbaa !65
  %i.ad = load float, ptr %i.w, align 4, !tbaa !65 ; 2 uses
  %i.ae = fsub float %i.ac, %i.ad
  %i.af = load float, ptr %i.aa, align 4, !tbaa !65
  %i.ag = fsub float %i.af, %i.ad
  %i.ah = getelementptr [4 x i8], ptr %i.s, i64 %i.k ; 2 uses
  %i.ai = load float, ptr %i.ah, align 4, !tbaa !65
  ...
  %i.an = load float, ptr %i.am, align 4, !tbaa !65
  ...
  store float %i.as, ptr %i.ab, align 4, !tbaa !65
  %i.at = load float, ptr %i.ah, align 4, !tbaa !65
  %i.au = load float, ptr %i.aj, align 4, !tbaa !65 ; 2 uses
  %i.av = fsub float %i.at, %i.au
  %i.aw = load float, ptr %i.am, align 4, !tbaa !65
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bq = getelementptr i8, ptr %.sink.i108, i64 %i.bp ; 3 uses
  %i.br = getelementptr [4 x i8], ptr %i.o, i64 %index ; 5 uses
  %wide.load = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !358, !noalias !359
  %i.bs = getelementptr [4 x i8], ptr %i.br, i64 %i.b
  %wide.load271 = load <2 x i32>, ptr %i.bs, align 4, !tbaa !45, !alias.scope !360, !noalias !361
  %i.bt = getelementptr [4 x i8], ptr %i.bq, i64 %i.c
  %i.bu = getelementptr i8, ptr %i.br, i64 %.idx
  %wide.load272 = load <2 x i32>, ptr %i.bu, align 4, !tbaa !45, !alias.scope !362, !noalias !361 ; 2 uses
  %i.bv = getelementptr i8, ptr %i.bq, i64 %.idx93
  %interleaved.vec = shufflevector <2 x i32> %wide.load, <2 x i32> %wide.load272, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec, ptr %i.bq, align 4, !tbaa !45, !noalias !53
  %i.bw = getelementptr i8, ptr %i.br, i64 %.idx94
  %wide.load273 = load <2 x i32>, ptr %i.bw, align 4, !tbaa !45, !alias.scope !363, !noalias !361
  %interleaved.vec274 = shufflevector <2 x i32> %wide.load271, <2 x i32> %wide.load273, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec274, ptr %i.bt, align 4, !tbaa !45
  %wide.load275 = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !358, !noalias !361
  %interleaved.vec276 = shufflevector <2 x i32> %wide.load272, <2 x i32> %wide.load275, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec276, ptr %i.bv, align 4, !tbaa !45
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.bx = icmp eq i64 %index.next, %n.vec
  br i1 %i.bx, label %middle.block, label %vector.body, !llvm.loop !349
...
_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58: ; preds = %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58.preheader, %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58
  ...
  %i.by = getelementptr i8, ptr %.sink.i108, i64 %.idx103 ; 4 uses
  %i.bz = getelementptr [4 x i8], ptr %i.o, i64 %.03796 ; 5 uses
  %i.ca = load i32, ptr %i.bz, align 4, !tbaa !45, !noalias !364
  store i32 %i.ca, ptr %i.by, align 4, !tbaa !45, !noalias !364
  %i.cb = getelementptr [4 x i8], ptr %i.bz, i64 %i.b
  %i.cc = load i32, ptr %i.cb, align 4, !tbaa !45
  %i.cd = getelementptr [4 x i8], ptr %i.by, i64 %i.c
  store i32 %i.cc, ptr %i.cd, align 4, !tbaa !45
  ...
  store i32 %i.cf, ptr %i.cg, align 4, !tbaa !45
  %i.ch = getelementptr i8, ptr %i.by, i64 4      ; 3 uses
  store i32 %i.cf, ptr %i.ch, align 4, !tbaa !45, !noalias !365
  %i.ci = getelementptr i8, ptr %i.bz, i64 %.idx94
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !45
  %i.ck = getelementptr [4 x i8], ptr %i.ch, i64 %i.c
  store i32 %i.cj, ptr %i.ck, align 4, !tbaa !45
  ...
  %i.cn = add nuw i64 %.03796, 1                  ; 2 uses
  %exitcond.not = icmp eq i64 %i.cn, %i.b
  br i1 %exitcond.not, label %._crit_edge, label %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58, !llvm.loop !352
...
vector.body292:                                   ; preds = %vector.body292, %vector.ph290
  ...
  %i.cz = getelementptr inbounds nuw [4 x i8], ptr %.pre, i64 %i.cx
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 32
  %wide.vec = load <8 x float>, ptr %i.cy, align 4, !tbaa !65, !alias.scope !366 ; 2 uses
  %strided.vec = shufflevector <8 x float> %wide.vec, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %strided.vec294 = shufflevector <8 x float> %wide.vec, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %wide.vec295 = load <8 x float>, ptr %i.da, align 4, !tbaa !65, !alias.scope !366 ; 2 uses
  %strided.vec296 = shufflevector <8 x float> %wide.vec295, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %strided.vec297 = shufflevector <8 x float> %wide.vec295, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %i.db = getelementptr inbounds nuw [4 x i8], ptr %i.cr, i64 %index293 ; 2 uses
  %i.dc = fadd <4 x float> %strided.vec, %strided.vec294
  %i.dd = fadd <4 x float> %strided.vec296, %strided.vec297
  %i.de = getelementptr inbounds nuw i8, ptr %i.db, i64 16
  store <4 x float> %i.dc, ptr %i.db, align 4, !tbaa !65, !alias.scope !367, !noalias !366
  store <4 x float> %i.dd, ptr %i.de, align 4, !tbaa !65, !alias.scope !367, !noalias !366
  %index.next298 = add nuw i64 %index293, 8       ; 2 uses
  %i.df = icmp eq i64 %index.next298, %n.vec291
  br i1 %i.df, label %middle.block299, label %vector.body292, !llvm.loop !356
...
scalar.ph288:                                     ; preds = %scalar.ph288.preheader, %scalar.ph288
  ...
  %i.dv = and i64 %indvars.iv.next, 4294967295
  %i.dw = icmp samesign ugt i64 %i.cp, %i.dv
  br i1 %i.dw, label %scalar.ph288, label %._crit_edge98, !llvm.loop !357
}
...
.noexc:
  ...
  %i.b = load i64, ptr %i.a, align 8, !tbaa !78   ; 6 uses
  tail call void @_ZN5Eigen15PlainObjectBaseINS_6MatrixIfLin1ELi1ELi0ELin1ELi1EEEE6resizeEll(ptr noundef nonnull align 8 dereferenceable(16) %2, i64 noundef %i.b, i64 noundef 1)
  %i.c = getelementptr inbounds nuw i8, ptr %2, i64 8 ; 5 uses
  %i.d = load i64, ptr %i.c, align 8, !tbaa !62
  %.not.i.i.i.i.i.i.i.i = icmp eq i64 %i.d, %i.b
...
.preheader.lr.ph:                                 ; preds = %_ZN5Eigen15PlainObjectBaseINS_6MatrixIfLin1ELi1ELi0ELin1ELi1EEEEaSINS_14CwiseNullaryOpINS_8internal18scalar_constant_opIfEES2_EEEERS2_RKNS_9EigenBaseIT_EE.exit
  %i.h = load ptr, ptr %1, align 8, !tbaa !79
  %i.i = load ptr, ptr %0, align 8, !tbaa !81     ; 3 uses
  %i.j = load ptr, ptr %2, align 8, !tbaa !63
  br label %.preheader
...
.preheader:                                       ; preds = %.preheader.lr.ph, %.preheader
  ...
  store float %i.bf, ptr %i.x, align 4, !tbaa !65
  %i.bg = load float, ptr %i.ap, align 4, !tbaa !65
  %i.bh = load float, ptr %i.aq, align 4, !tbaa !65 ; 2 uses
  %i.bi = fsub float %i.bg, %i.bh
  %i.bj = load float, ptr %i.ar, align 4, !tbaa !65
  %i.bk = fsub float %i.bj, %i.bh
  %i.bl = load float, ptr %i.o, align 4, !tbaa !65
  %i.bm = load float, ptr %i.s, align 4, !tbaa !65 ; 2 uses
  %i.bn = fsub float %i.bl, %i.bm
  %i.bo = load float, ptr %i.w, align 4, !tbaa !65
  ...
  store float %i.bt, ptr %i.x, align 4, !tbaa !65
  %i.bu = add nuw i64 %.04074, 1                  ; 2 uses
  %exitcond.not = icmp eq i64 %i.bu, %i.b
  br i1 %exitcond.not, label %._crit_edge, label %.preheader, !llvm.loop !368
...
._crit_edge:                                      ; preds = %.preheader, %_ZN5Eigen15PlainObjectBaseINS_6MatrixIfLin1ELi1ELi0ELin1ELi1EEEEaSINS_14CwiseNullaryOpINS_8internal18scalar_constant_opIfEES2_EEEERS2_RKNS_9EigenBaseIT_EE.exit
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %3, i8 0, i64 16, i1 false), !alias.scope !377
  %i.bv = load ptr, ptr %2, align 8, !tbaa !63, !noalias !377 ; 8 uses
  %i.bw = ptrtoaddr ptr %i.bv to i64
  %i.bx = load i64, ptr %i.c, align 8, !tbaa !62, !noalias !377 ; 2 uses
...
bb.a:                                             ; preds = %thread-pre-split.i.i.i.i.i.i.i
  %.pr.i.i.i.i.i.i.i49 = load i64, ptr %i.by, align 8, !tbaa !62, !alias.scope !377 ; 8 uses
  %.pre.i.i = load ptr, ptr %3, align 8, !tbaa !63, !alias.scope !377 ; 8 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bq = getelementptr i8, ptr %.sink.i108, i64 %i.bp ; 3 uses
  %i.br = getelementptr [4 x i8], ptr %i.o, i64 %index ; 5 uses
  %wide.load = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !420, !noalias !421
  %i.bs = getelementptr [4 x i8], ptr %i.br, i64 %i.b
  %wide.load271 = load <2 x i32>, ptr %i.bs, align 4, !tbaa !45, !alias.scope !422, !noalias !423
  %i.bt = getelementptr [4 x i8], ptr %i.bq, i64 %i.c
  %i.bu = getelementptr i8, ptr %i.br, i64 %.idx
  %wide.load272 = load <2 x i32>, ptr %i.bu, align 4, !tbaa !45, !alias.scope !424, !noalias !423 ; 2 uses
  %i.bv = getelementptr i8, ptr %i.bq, i64 %.idx93
  %interleaved.vec = shufflevector <2 x i32> %wide.load, <2 x i32> %wide.load272, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec, ptr %i.bq, align 4, !tbaa !45, !noalias !53
  %i.bw = getelementptr i8, ptr %i.br, i64 %.idx94
  %wide.load273 = load <2 x i32>, ptr %i.bw, align 4, !tbaa !45, !alias.scope !425, !noalias !423
  %interleaved.vec274 = shufflevector <2 x i32> %wide.load271, <2 x i32> %wide.load273, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec274, ptr %i.bt, align 4, !tbaa !45
  %wide.load275 = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !420, !noalias !423
  %interleaved.vec276 = shufflevector <2 x i32> %wide.load272, <2 x i32> %wide.load275, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec276, ptr %i.bv, align 4, !tbaa !45
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.bx = icmp eq i64 %index.next, %n.vec
  br i1 %i.bx, label %middle.block, label %vector.body, !llvm.loop !411
...
_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58: ; preds = %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58.preheader, %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58
  ...
  %i.by = getelementptr i8, ptr %.sink.i108, i64 %.idx103 ; 4 uses
  %i.bz = getelementptr [4 x i8], ptr %i.o, i64 %.03796 ; 5 uses
  %i.ca = load i32, ptr %i.bz, align 4, !tbaa !45, !noalias !426
  store i32 %i.ca, ptr %i.by, align 4, !tbaa !45, !noalias !426
  %i.cb = getelementptr [4 x i8], ptr %i.bz, i64 %i.b
  %i.cc = load i32, ptr %i.cb, align 4, !tbaa !45
  %i.cd = getelementptr [4 x i8], ptr %i.by, i64 %i.c
  store i32 %i.cc, ptr %i.cd, align 4, !tbaa !45
  ...
  store i32 %i.cf, ptr %i.cg, align 4, !tbaa !45
  %i.ch = getelementptr i8, ptr %i.by, i64 4      ; 3 uses
  store i32 %i.cf, ptr %i.ch, align 4, !tbaa !45, !noalias !427
  %i.ci = getelementptr i8, ptr %i.bz, i64 %.idx94
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !45
  %i.ck = getelementptr [4 x i8], ptr %i.ch, i64 %i.c
  store i32 %i.cj, ptr %i.ck, align 4, !tbaa !45
  ...
  %i.cn = add nuw i64 %.03796, 1                  ; 2 uses
  %exitcond.not = icmp eq i64 %i.cn, %i.b
  br i1 %exitcond.not, label %._crit_edge, label %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58, !llvm.loop !414
...
vector.body292:                                   ; preds = %vector.body292, %vector.ph290
  ...
  %i.cz = getelementptr inbounds nuw [4 x i8], ptr %.pre, i64 %i.cx
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 32
  %wide.vec = load <8 x float>, ptr %i.cy, align 4, !tbaa !65, !alias.scope !428 ; 2 uses
  %strided.vec = shufflevector <8 x float> %wide.vec, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %strided.vec294 = shufflevector <8 x float> %wide.vec, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %wide.vec295 = load <8 x float>, ptr %i.da, align 4, !tbaa !65, !alias.scope !428 ; 2 uses
  %strided.vec296 = shufflevector <8 x float> %wide.vec295, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %strided.vec297 = shufflevector <8 x float> %wide.vec295, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %i.db = getelementptr inbounds nuw [4 x i8], ptr %i.cr, i64 %index293 ; 2 uses
  %i.dc = fadd <4 x float> %strided.vec, %strided.vec294
  %i.dd = fadd <4 x float> %strided.vec296, %strided.vec297
  %i.de = getelementptr inbounds nuw i8, ptr %i.db, i64 16
  store <4 x float> %i.dc, ptr %i.db, align 4, !tbaa !65, !alias.scope !429, !noalias !428
  store <4 x float> %i.dd, ptr %i.de, align 4, !tbaa !65, !alias.scope !429, !noalias !428
  %index.next298 = add nuw i64 %index293, 8       ; 2 uses
  %i.df = icmp eq i64 %index.next298, %n.vec291
  br i1 %i.df, label %middle.block299, label %vector.body292, !llvm.loop !418
...
scalar.ph288:                                     ; preds = %scalar.ph288.preheader, %scalar.ph288
  ...
  %i.dv = and i64 %indvars.iv.next, 4294967295
  %i.dw = icmp samesign ugt i64 %i.cp, %i.dv
  br i1 %i.dw, label %scalar.ph288, label %._crit_edge98, !llvm.loop !419
}
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.e = load i64, ptr %i.d, align 8, !tbaa !440
  %i.f = trunc i64 %i.e to i32
  %i.g = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 3 uses
  %i.h = load i64, ptr %i.g, align 8, !tbaa !34   ; 9 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #23
...
.noexc47:                                         ; preds = %bb.e
  %.pr.i.i.i.i.i.i.i = load i64, ptr %i.i, align 8, !tbaa !37
...
_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEaSINS_14CwiseNullaryOpINS_8internal18scalar_constant_opIdEES2_EEEERS2_RKNS_9EigenBaseIT_EE.exit.loopexit: ; preds = %_ZN5Eigen8internal17resize_if_allowedINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEENS_14CwiseNullaryOpINS0_18scalar_constant_opIdEES3_EEddEEvRT_RKT0_RKNS0_9assign_opIT1_T2_EE.exit.i.i.i.i.i.i.i
  %i.m = load ptr, ptr %2, align 8, !tbaa !38
  %.idx.i.i.i.i.i.i.i.i.i = shl nuw nsw i64 %i.k, 3
  tail call void @llvm.memset.p0.i64(ptr align 8 %i.m, i8 0, i64 %.idx.i.i.i.i.i.i.i.i.i, i1 false), !tbaa !40
...
.preheader.lr.ph:                                 ; preds = %_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEaSINS_14CwiseNullaryOpINS_8internal18scalar_constant_opIdEES2_EEEERS2_RKNS_9EigenBaseIT_EE.exit
  ...
  %i.o = load ptr, ptr %0, align 8, !tbaa !441    ; 3 uses
  %i.p = load i64, ptr %i.d, align 8, !tbaa !440  ; 3 uses
  %i.q = load i64, ptr %i.g, align 8, !tbaa !34   ; 2 uses
  %.idx.i = shl i64 %i.q, 3
  %i.r = load ptr, ptr %2, align 8, !tbaa !38
  br label %.preheader
...
.preheader:                                       ; preds = %.preheader.lr.ph, %.preheader
  ...
  %i.ae = load i32, ptr %i.ad, align 4, !tbaa !45
  ...
  %.promoted = load double, ptr %i.ai, align 8, !tbaa !40
  %i.aj = load double, ptr %i.x, align 8, !tbaa !40
  %i.ak = load double, ptr %i.ac, align 8, !tbaa !40 ; 2 uses
  %i.al = fsub double %i.aj, %i.ak
  %i.am = load double, ptr %i.ah, align 8, !tbaa !40
  ...
  %i.ar = load double, ptr %i.aq, align 8, !tbaa !40 ; 2 uses
  %i.as = fsub double %i.ap, %i.ar
  %i.at = getelementptr i8, ptr %i.ah, i64 8      ; 2 uses
  %i.au = load double, ptr %i.at, align 8, !tbaa !40
  ...
  store double %i.az, ptr %i.ai, align 8, !tbaa !40
  %i.ba = load double, ptr %i.ao, align 8, !tbaa !40
  %i.bb = load double, ptr %i.aq, align 8, !tbaa !40 ; 2 uses
  %i.bc = fsub double %i.ba, %i.bb
  %i.bd = load double, ptr %i.at, align 8, !tbaa !40
  %i.be = fsub double %i.bd, %i.bb
  %i.bf = getelementptr i8, ptr %i.x, i64 16      ; 2 uses
  %i.bg = load double, ptr %i.bf, align 8, !tbaa !40
  %i.bh = getelementptr i8, ptr %i.ac, i64 16     ; 2 uses
  %i.bi = load double, ptr %i.bh, align 8, !tbaa !40 ; 2 uses
  ...
  store double %i.bq, ptr %i.ai, align 8, !tbaa !40
  %i.br = load double, ptr %i.bf, align 8, !tbaa !40
  %i.bs = load double, ptr %i.bh, align 8, !tbaa !40 ; 2 uses
  %i.bt = fsub double %i.br, %i.bs
  %i.bu = load double, ptr %i.bk, align 8, !tbaa !40
  %i.bv = fsub double %i.bu, %i.bs
  %i.bw = load double, ptr %i.x, align 8, !tbaa !40
  %i.bx = load double, ptr %i.ac, align 8, !tbaa !40 ; 2 uses
  %i.by = fsub double %i.bw, %i.bx
  %i.bz = load double, ptr %i.ah, align 8, !tbaa !40
  ...
  store double %i.ce, ptr %i.ai, align 8, !tbaa !40
  %i.cf = add nuw i64 %.04074, 1                  ; 2 uses
  %exitcond78.not = icmp eq i64 %i.cf, %i.h
  br i1 %exitcond78.not, label %._crit_edge, label %.preheader, !llvm.loop !430
...
._crit_edge:                                      ; preds = %.preheader, %_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEaSINS_14CwiseNullaryOpINS_8internal18scalar_constant_opIdEES2_EEEERS2_RKNS_9EigenBaseIT_EE.exit
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %4, i8 0, i64 16, i1 false), !alias.scope !442
  %i.ch = load ptr, ptr %2, align 8, !tbaa !38, !noalias !442 ; 8 uses
  %i.ci = ptrtoaddr ptr %i.ch to i64
  %i.cj = load i64, ptr %i.i, align 8, !tbaa !37, !noalias !442 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bq = getelementptr i8, ptr %.sink.i108, i64 %i.bp ; 3 uses
  %i.br = getelementptr [4 x i8], ptr %i.o, i64 %index ; 5 uses
  %wide.load = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !465, !noalias !466
  %i.bs = getelementptr [4 x i8], ptr %i.br, i64 %i.b
  %wide.load271 = load <2 x i32>, ptr %i.bs, align 4, !tbaa !45, !alias.scope !467, !noalias !468
  %i.bt = getelementptr [4 x i8], ptr %i.bq, i64 %i.c
  %i.bu = getelementptr i8, ptr %i.br, i64 %.idx
  %wide.load272 = load <2 x i32>, ptr %i.bu, align 4, !tbaa !45, !alias.scope !469, !noalias !468 ; 2 uses
  %i.bv = getelementptr i8, ptr %i.bq, i64 %.idx93
  %interleaved.vec = shufflevector <2 x i32> %wide.load, <2 x i32> %wide.load272, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec, ptr %i.bq, align 4, !tbaa !45, !noalias !53
  %i.bw = getelementptr i8, ptr %i.br, i64 %.idx94
  %wide.load273 = load <2 x i32>, ptr %i.bw, align 4, !tbaa !45, !alias.scope !470, !noalias !468
  %interleaved.vec274 = shufflevector <2 x i32> %wide.load271, <2 x i32> %wide.load273, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec274, ptr %i.bt, align 4, !tbaa !45
  %wide.load275 = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !465, !noalias !468
  %interleaved.vec276 = shufflevector <2 x i32> %wide.load272, <2 x i32> %wide.load275, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec276, ptr %i.bv, align 4, !tbaa !45
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.bx = icmp eq i64 %index.next, %n.vec
  br i1 %i.bx, label %middle.block, label %vector.body, !llvm.loop !456
...
_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58: ; preds = %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58.preheader, %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58
  ...
  %i.by = getelementptr i8, ptr %.sink.i108, i64 %.idx103 ; 4 uses
  %i.bz = getelementptr [4 x i8], ptr %i.o, i64 %.03796 ; 5 uses
  %i.ca = load i32, ptr %i.bz, align 4, !tbaa !45, !noalias !471
  store i32 %i.ca, ptr %i.by, align 4, !tbaa !45, !noalias !471
  %i.cb = getelementptr [4 x i8], ptr %i.bz, i64 %i.b
  %i.cc = load i32, ptr %i.cb, align 4, !tbaa !45
  %i.cd = getelementptr [4 x i8], ptr %i.by, i64 %i.c
  store i32 %i.cc, ptr %i.cd, align 4, !tbaa !45
  ...
  store i32 %i.cf, ptr %i.cg, align 4, !tbaa !45
  %i.ch = getelementptr i8, ptr %i.by, i64 4      ; 3 uses
  store i32 %i.cf, ptr %i.ch, align 4, !tbaa !45, !noalias !472
  %i.ci = getelementptr i8, ptr %i.bz, i64 %.idx94
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !45
  %i.ck = getelementptr [4 x i8], ptr %i.ch, i64 %i.c
  store i32 %i.cj, ptr %i.ck, align 4, !tbaa !45
  ...
  %i.cn = add nuw i64 %.03796, 1                  ; 2 uses
  %exitcond.not = icmp eq i64 %i.cn, %i.b
  br i1 %exitcond.not, label %._crit_edge, label %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58, !llvm.loop !459
...
vector.body292:                                   ; preds = %vector.body292, %vector.ph290
  ...
  %i.cz = getelementptr inbounds nuw [8 x i8], ptr %.pre, i64 %i.cx
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 32
  %wide.vec = load <4 x double>, ptr %i.cy, align 8, !tbaa !40, !alias.scope !473 ; 2 uses
  %strided.vec = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %strided.vec294 = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %wide.vec295 = load <4 x double>, ptr %i.da, align 8, !tbaa !40, !alias.scope !473 ; 2 uses
  %strided.vec296 = shufflevector <4 x double> %wide.vec295, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %strided.vec297 = shufflevector <4 x double> %wide.vec295, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %i.db = getelementptr inbounds nuw [8 x i8], ptr %i.cr, i64 %index293 ; 2 uses
  %i.dc = fadd <2 x double> %strided.vec, %strided.vec294
  %i.dd = fadd <2 x double> %strided.vec296, %strided.vec297
  %i.de = getelementptr inbounds nuw i8, ptr %i.db, i64 16
  store <2 x double> %i.dc, ptr %i.db, align 8, !tbaa !40, !alias.scope !474, !noalias !473
  store <2 x double> %i.dd, ptr %i.de, align 8, !tbaa !40, !alias.scope !474, !noalias !473
  %index.next298 = add nuw i64 %index293, 4       ; 2 uses
  %i.df = icmp eq i64 %index.next298, %n.vec291
  br i1 %i.df, label %middle.block299, label %vector.body292, !llvm.loop !463
...
scalar.ph288:                                     ; preds = %scalar.ph288.preheader, %scalar.ph288
  ...
  %i.dv = and i64 %indvars.iv.next, 4294967295
  %i.dw = icmp samesign ugt i64 %i.cp, %i.dv
  br i1 %i.dw, label %scalar.ph288, label %._crit_edge98, !llvm.loop !464
}
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load i64, ptr %i.c, align 8, !tbaa !72, !noalias !486 ; 4 uses
  ...
  %i.e = load ptr, ptr %0, align 8, !tbaa !83     ; 7 uses
  %i.f = ptrtoaddr ptr %i.e to i64
  %i.g = load ptr, ptr %2, align 8, !tbaa !83     ; 7 uses
  %i.h = ptrtoaddr ptr %i.g to i64
  %i.i = load i64, ptr %i.c, align 8, !tbaa !72   ; 4 uses
  %i.j = load ptr, ptr %1, align 8, !tbaa !83     ; 7 uses
...
thread-pre-split.i.i.i.i.i.i.i:                   ; preds = %bb.b
  tail call void @_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEE6resizeEll(ptr noundef nonnull align 8 dereferenceable(16) %3, i64 noundef %i.d, i64 noundef 1)
  %.pr.i.i.i.i.i.i.i = load i64, ptr %i.l, align 8, !tbaa !37
  br label %bb.c
...
bb.c:                                             ; preds = %thread-pre-split.i.i.i.i.i.i.i, %bb.b
  ...
  %i.o = load ptr, ptr %3, align 8, !tbaa !38     ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.aj, align 8, !tbaa !40
  %wide.load150 = load <2 x double>, ptr %i.ak, align 8, !tbaa !40 ; 2 uses
  ...
  %wide.load151 = load <2 x double>, ptr %i.an, align 8, !tbaa !40
  %wide.load152 = load <2 x double>, ptr %i.ao, align 8, !tbaa !40 ; 2 uses
  ...
  %wide.load153 = load <2 x double>, ptr %i.ar, align 8, !tbaa !40
  %i.as = fsub <2 x double> %wide.load153, %wide.load152
  %i.at = getelementptr inbounds [8 x i8], ptr %i.j, i64 %i.ah
  %wide.load154 = load <2 x double>, ptr %i.at, align 8, !tbaa !40
  %i.au = fsub <2 x double> %wide.load154, %wide.load150
  %i.av = fmul <2 x double> %i.as, %i.au
  %i.aw = fsub <2 x double> %i.aq, %i.av
  store <2 x double> %i.aw, ptr %i.ai, align 8, !tbaa !40
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.ax = icmp eq i64 %index.next, %n.vec
  br i1 %i.ax, label %middle.block, label %vector.body, !llvm.loop !477
...
.lr.ph.i.i.i.i.i.i.i.i.i:                         ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i.preheader155, %.lr.ph.i.i.i.i.i.i.i.i.i
  ...
  %i.bb = load double, ptr %i.az, align 8, !tbaa !40
  %i.bc = load double, ptr %i.ba, align 8, !tbaa !40 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i32>, ptr %i.bx, align 4, !tbaa !45, !alias.scope !532, !noalias !533
  %i.by = getelementptr i8, ptr %i.bx, i64 4
  %wide.load208 = load <2 x i32>, ptr %i.by, align 4, !tbaa !45, !alias.scope !532, !noalias !533
  %i.bz = getelementptr [4 x i8], ptr %i.bw, i64 %i.c
  %i.ca = getelementptr i8, ptr %i.bx, i64 8
  %wide.load209 = load <2 x i32>, ptr %i.ca, align 4, !tbaa !45, !alias.scope !532, !noalias !533 ; 2 uses
  ...
  store <4 x i32> %interleaved.vec, ptr %i.bw, align 4, !tbaa !45, !noalias !53
  %i.cc = getelementptr i8, ptr %i.bx, i64 12
  %wide.load210 = load <2 x i32>, ptr %i.cc, align 4, !tbaa !45, !alias.scope !532, !noalias !533
  %interleaved.vec211 = shufflevector <2 x i32> %wide.load208, <2 x i32> %wide.load210, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec211, ptr %i.bz, align 4, !tbaa !45
  %wide.load212 = load <2 x i32>, ptr %i.bx, align 4, !tbaa !45, !alias.scope !532, !noalias !533
  %interleaved.vec213 = shufflevector <2 x i32> %wide.load209, <2 x i32> %wide.load212, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec213, ptr %i.cb, align 4, !tbaa !45
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.cd = icmp eq i64 %index.next, %n.vec
  br i1 %i.cd, label %middle.block, label %vector.body, !llvm.loop !521
...
_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit66: ; preds = %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit66.preheader, %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit66
  ...
  store i32 %i.ch, ptr %i.ce, align 4, !tbaa !45, !noalias !534
  %i.ci = getelementptr i8, ptr %i.cg, i64 4
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !45
  %i.ck = getelementptr [4 x i8], ptr %i.ce, i64 %i.c
  store i32 %i.cj, ptr %i.ck, align 4, !tbaa !45
  %i.cl = getelementptr i8, ptr %i.cg, i64 8
  %i.cm = load i32, ptr %i.cl, align 4, !tbaa !45 ; 2 uses
  %i.cn = getelementptr i8, ptr %i.ce, i64 %.idx
  store i32 %i.cm, ptr %i.cn, align 4, !tbaa !45
  %i.co = getelementptr i8, ptr %i.ce, i64 4      ; 3 uses
  store i32 %i.cm, ptr %i.co, align 4, !tbaa !45, !noalias !535
  %i.cp = getelementptr i8, ptr %i.cg, i64 12
  %i.cq = load i32, ptr %i.cp, align 4, !tbaa !45
  %i.cr = getelementptr [4 x i8], ptr %i.co, i64 %i.c
  store i32 %i.cq, ptr %i.cr, align 4, !tbaa !45
  %i.cs = load i32, ptr %i.cg, align 4, !tbaa !45
  %i.ct = getelementptr i8, ptr %i.co, i64 %.idx
  store i32 %i.cs, ptr %i.ct, align 4, !tbaa !45
  %i.cu = add nuw i64 %.041108, 1                 ; 2 uses
  %exitcond.not = icmp eq i64 %i.cu, %i.b
  br i1 %exitcond.not, label %._crit_edge, label %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit66, !llvm.loop !526
...
bb.d:                                             ; preds = %._crit_edge
  %i.cv = load i64, ptr %i.a, align 8, !tbaa !104
...
.preheader:                                       ; preds = %bb.d
  %i.cw = load i64, ptr %i.a, align 8, !tbaa !104 ; 7 uses
  %i.cx = icmp sgt i64 %i.cw, 0
  %.pre = load ptr, ptr %4, align 8, !tbaa !38    ; 7 uses
  br i1 %i.cx, label %.lr.ph, label %._crit_edge110

.lr.ph:                                           ; preds = %.preheader
  %i.cy = load ptr, ptr %2, align 8, !tbaa !38    ; 4 uses
...
vector.body229:                                   ; preds = %vector.body229, %vector.ph227
  ...
  %wide.vec = load <4 x double>, ptr %i.df, align 8, !tbaa !40, !alias.scope !536 ; 2 uses
  %strided.vec = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %strided.vec231 = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %wide.vec232 = load <4 x double>, ptr %i.dh, align 8, !tbaa !40, !alias.scope !536 ; 2 uses
  ...
  store <2 x double> %i.dj, ptr %i.di, align 8, !tbaa !40, !alias.scope !537, !noalias !536
  store <2 x double> %i.dk, ptr %i.dl, align 8, !tbaa !40, !alias.scope !537, !noalias !536
  %index.next235 = add nuw i64 %index230, 4       ; 2 uses
  %i.dm = icmp eq i64 %index.next235, %n.vec228
  br i1 %i.dm, label %middle.block236, label %vector.body229, !llvm.loop !530
...
common.resume:                                    ; preds = %bb.d, %._crit_edge
  %i.do = landingpad { ptr, i32 }
          cleanup
  %i.dp = load ptr, ptr %4, align 8, !tbaa !38
  call void @free(ptr noundef %i.dp) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #23
  %i.dq = load ptr, ptr %3, align 8, !tbaa !41
...
scalar.ph225:                                     ; preds = %scalar.ph225.preheader, %scalar.ph225
  ...
  store double %i.eb, ptr %i.ea, align 8, !tbaa !40
  %indvars.iv.next = add i64 %indvars.iv, 1       ; 2 uses
  %i.ec = and i64 %indvars.iv.next, 4294967295
  %i.ed = icmp samesign ugt i64 %i.cw, %i.ec
  br i1 %i.ed, label %scalar.ph225, label %._crit_edge110, !llvm.loop !531
}
...
.noexc:                                           ; preds = %bb.a
  ...
  %i.e = load i64, ptr %i.d, align 8, !tbaa !104  ; 6 uses
...
.noexc47:                                         ; preds = %.noexc
  tail call void @_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEE6resizeEll(ptr noundef nonnull align 8 dereferenceable(16) %2, i64 noundef %i.e, i64 noundef 1)
  %.pr.i.i.i.i.i.i.i = load i64, ptr %i.f, align 8, !tbaa !37
  br label %_ZN5Eigen8internal17resize_if_allowedINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEENS_14CwiseNullaryOpINS0_18scalar_constant_opIdEES3_EEddEEvRT_RKT0_RKNS0_9assign_opIT1_T2_EE.exit.i.i.i.i.i.i.i
...
_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEaSINS_14CwiseNullaryOpINS_8internal18scalar_constant_opIdEES2_EEEERS2_RKNS_9EigenBaseIT_EE.exit.loopexit: ; preds = %_ZN5Eigen8internal17resize_if_allowedINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEENS_14CwiseNullaryOpINS0_18scalar_constant_opIdEES3_EEddEEvRT_RKT0_RKNS0_9assign_opIT1_T2_EE.exit.i.i.i.i.i.i.i
  ...
  tail call void @llvm.memset.p0.i64(ptr align 8 %i.j, i8 0, i64 %.idx.i.i.i.i.i.i.i.i.i, i1 false), !tbaa !40
  br label %_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEaSINS_14CwiseNullaryOpINS_8internal18scalar_constant_opIdEES2_EEEERS2_RKNS_9EigenBaseIT_EE.exit
...
.preheader.lr.ph:                                 ; preds = %_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEaSINS_14CwiseNullaryOpINS_8internal18scalar_constant_opIdEES2_EEEERS2_RKNS_9EigenBaseIT_EE.exit
  %i.k = load ptr, ptr %1, align 8, !tbaa !105
  %i.l = load i64, ptr %i.a, align 8, !tbaa !103
  %i.m = load ptr, ptr %0, align 8, !tbaa !107    ; 3 uses
...
.preheader:                                       ; preds = %.preheader.lr.ph, %.preheader
  ...
  %.promoted = load double, ptr %i.ac, align 8, !tbaa !40
  %i.ad = load double, ptr %i.t, align 8, !tbaa !40
  %i.ae = load double, ptr %i.x, align 8, !tbaa !40 ; 2 uses
  ...
  %i.aj = load double, ptr %i.ai, align 8, !tbaa !40
  %i.ak = getelementptr i8, ptr %i.x, i64 8       ; 2 uses
  %i.al = load double, ptr %i.ak, align 8, !tbaa !40 ; 2 uses
  ...
  store double %i.at, ptr %i.ac, align 8, !tbaa !40
  %i.au = load double, ptr %i.ai, align 8, !tbaa !40
  %i.av = load double, ptr %i.ak, align 8, !tbaa !40 ; 2 uses
  %i.aw = fsub double %i.au, %i.av
  %i.ax = load double, ptr %i.an, align 8, !tbaa !40
  %i.ay = fsub double %i.ax, %i.av
  %i.az = getelementptr i8, ptr %i.t, i64 16      ; 2 uses
  %i.ba = load double, ptr %i.az, align 8, !tbaa !40
  ...
  store double %i.bk, ptr %i.ac, align 8, !tbaa !40
  %i.bl = load double, ptr %i.az, align 8, !tbaa !40
  %i.bm = load double, ptr %i.bb, align 8, !tbaa !40 ; 2 uses
  %i.bn = fsub double %i.bl, %i.bm
  %i.bo = load double, ptr %i.be, align 8, !tbaa !40
  %i.bp = fsub double %i.bo, %i.bm
  %i.bq = load double, ptr %i.t, align 8, !tbaa !40
  %i.br = load double, ptr %i.x, align 8, !tbaa !40 ; 2 uses
  %i.bs = fsub double %i.bq, %i.br
  %i.bt = load double, ptr %i.ab, align 8, !tbaa !40
  ...
  store double %i.by, ptr %i.ac, align 8, !tbaa !40
  %i.bz = add nuw i64 %.04073, 1                  ; 2 uses
  %exitcond.not = icmp eq i64 %i.bz, %i.e
  br i1 %exitcond.not, label %._crit_edge, label %.preheader, !llvm.loop !538

._crit_edge:                                      ; preds = %.preheader, %_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEaSINS_14CwiseNullaryOpINS_8internal18scalar_constant_opIdEES2_EEEERS2_RKNS_9EigenBaseIT_EE.exit
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #23
  tail call void @llvm.experimental.noalias.scope.decl(metadata !547)
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %3, i8 0, i64 16, i1 false), !alias.scope !547
  %i.ca = load ptr, ptr %2, align 8, !tbaa !38, !noalias !547 ; 8 uses
  %i.cb = ptrtoaddr ptr %i.ca to i64
  %i.cc = load i64, ptr %i.f, align 8, !tbaa !37, !noalias !547 ; 2 uses
...
bb.c:                                             ; preds = %thread-pre-split.i.i.i.i.i.i.i
  %.pr.i.i.i.i.i.i.i49 = load i64, ptr %i.cd, align 8, !tbaa !37, !alias.scope !547 ; 8 uses
  %.pre.i.i = load ptr, ptr %3, align 8, !tbaa !38, !alias.scope !547 ; 8 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bw = getelementptr i8, ptr %.sink.i120, i64 %i.bv ; 3 uses
  %i.bx = getelementptr [4 x i8], ptr %i.o, i64 %index ; 5 uses
  %wide.load = load <2 x i32>, ptr %i.bx, align 4, !tbaa !45, !alias.scope !567, !noalias !568
  %i.by = getelementptr i8, ptr %i.bx, i64 4
  %wide.load208 = load <2 x i32>, ptr %i.by, align 4, !tbaa !45, !alias.scope !567, !noalias !568
  %i.bz = getelementptr [4 x i8], ptr %i.bw, i64 %i.c
  %i.ca = getelementptr i8, ptr %i.bx, i64 8
  %wide.load209 = load <2 x i32>, ptr %i.ca, align 4, !tbaa !45, !alias.scope !567, !noalias !568 ; 2 uses
  %i.cb = getelementptr i8, ptr %i.bw, i64 %.idx
  %interleaved.vec = shufflevector <2 x i32> %wide.load, <2 x i32> %wide.load209, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec, ptr %i.bw, align 4, !tbaa !45, !noalias !53
  %i.cc = getelementptr i8, ptr %i.bx, i64 12
  %wide.load210 = load <2 x i32>, ptr %i.cc, align 4, !tbaa !45, !alias.scope !567, !noalias !568
  %interleaved.vec211 = shufflevector <2 x i32> %wide.load208, <2 x i32> %wide.load210, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec211, ptr %i.bz, align 4, !tbaa !45
  %wide.load212 = load <2 x i32>, ptr %i.bx, align 4, !tbaa !45, !alias.scope !567, !noalias !568
  %interleaved.vec213 = shufflevector <2 x i32> %wide.load209, <2 x i32> %wide.load212, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec213, ptr %i.cb, align 4, !tbaa !45
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.cd = icmp eq i64 %index.next, %n.vec
  br i1 %i.cd, label %middle.block, label %vector.body, !llvm.loop !556
...
_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit66: ; preds = %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit66.preheader, %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit66
  ...
  %i.cg = getelementptr [4 x i8], ptr %i.o, i64 %i.cf ; 5 uses
  %i.ch = load i32, ptr %i.cg, align 4, !tbaa !45
  store i32 %i.ch, ptr %i.ce, align 4, !tbaa !45, !noalias !569
  %i.ci = getelementptr i8, ptr %i.cg, i64 4
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !45
  %i.ck = getelementptr [4 x i8], ptr %i.ce, i64 %i.c
  store i32 %i.cj, ptr %i.ck, align 4, !tbaa !45
  ...
  store i32 %i.cm, ptr %i.cn, align 4, !tbaa !45
  %i.co = getelementptr i8, ptr %i.ce, i64 4      ; 3 uses
  store i32 %i.cm, ptr %i.co, align 4, !tbaa !45, !noalias !570
  %i.cp = getelementptr i8, ptr %i.cg, i64 12
  %i.cq = load i32, ptr %i.cp, align 4, !tbaa !45
  %i.cr = getelementptr [4 x i8], ptr %i.co, i64 %i.c
  store i32 %i.cq, ptr %i.cr, align 4, !tbaa !45
  ...
  %i.cu = add nuw i64 %.041108, 1                 ; 2 uses
  %exitcond.not = icmp eq i64 %i.cu, %i.b
  br i1 %exitcond.not, label %._crit_edge, label %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit66, !llvm.loop !561
...
vector.body229:                                   ; preds = %vector.body229, %vector.ph227
  ...
  %i.dg = getelementptr inbounds nuw [8 x i8], ptr %.pre, i64 %i.de
  %i.dh = getelementptr inbounds nuw i8, ptr %i.dg, i64 32
  %wide.vec = load <4 x double>, ptr %i.df, align 8, !tbaa !40, !alias.scope !571 ; 2 uses
  %strided.vec = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %strided.vec231 = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %wide.vec232 = load <4 x double>, ptr %i.dh, align 8, !tbaa !40, !alias.scope !571 ; 2 uses
  %strided.vec233 = shufflevector <4 x double> %wide.vec232, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %strided.vec234 = shufflevector <4 x double> %wide.vec232, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %i.di = getelementptr inbounds nuw [8 x i8], ptr %i.cy, i64 %index230 ; 2 uses
  %i.dj = fadd <2 x double> %strided.vec, %strided.vec231
  %i.dk = fadd <2 x double> %strided.vec233, %strided.vec234
  %i.dl = getelementptr inbounds nuw i8, ptr %i.di, i64 16
  store <2 x double> %i.dj, ptr %i.di, align 8, !tbaa !40, !alias.scope !572, !noalias !571
  store <2 x double> %i.dk, ptr %i.dl, align 8, !tbaa !40, !alias.scope !572, !noalias !571
  %index.next235 = add nuw i64 %index230, 4       ; 2 uses
  %i.dm = icmp eq i64 %index.next235, %n.vec228
  br i1 %i.dm, label %middle.block236, label %vector.body229, !llvm.loop !565
...
scalar.ph225:                                     ; preds = %scalar.ph225.preheader, %scalar.ph225
  ...
  %i.ec = and i64 %indvars.iv.next, 4294967295
  %i.ed = icmp samesign ugt i64 %i.cw, %i.ec
  br i1 %i.ed, label %scalar.ph225, label %._crit_edge110, !llvm.loop !566
}
...
.preheader.lr.ph:                                 ; preds = %_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEaSINS_14CwiseNullaryOpINS_8internal18scalar_constant_opIdEES2_EEEERS2_RKNS_9EigenBaseIT_EE.exit
  %i.n = load ptr, ptr %1, align 8, !tbaa !41
  %i.o = load ptr, ptr %0, align 8, !tbaa !83     ; 3 uses
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.q = load i64, ptr %i.p, align 8, !tbaa !72   ; 4 uses
  %i.r = load i64, ptr %i.g, align 8, !tbaa !34   ; 2 uses
  %.idx.i = shl i64 %i.r, 3
  %i.s = load ptr, ptr %2, align 8, !tbaa !38
...
.preheader:                                       ; preds = %.preheader.lr.ph, %.preheader
  ...
  %.promoted = load double, ptr %i.ah, align 8, !tbaa !40
  %i.ai = load double, ptr %i.y, align 8, !tbaa !40
  %i.aj = load double, ptr %i.ac, align 8, !tbaa !40 ; 2 uses
  %i.ak = fsub double %i.ai, %i.aj
  %i.al = load double, ptr %i.ag, align 8, !tbaa !40
  ...
  store double %i.ay, ptr %i.ah, align 8, !tbaa !40
  %i.az = load double, ptr %i.an, align 8, !tbaa !40
  %i.ba = load double, ptr %i.ap, align 8, !tbaa !40 ; 2 uses
  %i.bb = fsub double %i.az, %i.ba
  %i.bc = load double, ptr %i.as, align 8, !tbaa !40
  ...
  %i.bh = load double, ptr %i.bg, align 8, !tbaa !40 ; 2 uses
  ...
  store double %i.bp, ptr %i.ah, align 8, !tbaa !40
  %i.bq = load double, ptr %i.be, align 8, !tbaa !40
  %i.br = load double, ptr %i.bg, align 8, !tbaa !40 ; 2 uses
  %i.bs = fsub double %i.bq, %i.br
  %i.bt = load double, ptr %i.bj, align 8, !tbaa !40
  %i.bu = fsub double %i.bt, %i.br
  %i.bv = load double, ptr %i.y, align 8, !tbaa !40
  %i.bw = load double, ptr %i.ac, align 8, !tbaa !40 ; 2 uses
  %i.bx = fsub double %i.bv, %i.bw
  %i.by = load double, ptr %i.ag, align 8, !tbaa !40
  ...
  store double %i.cd, ptr %i.ah, align 8, !tbaa !40
  %i.ce = add nuw i64 %.04074, 1                  ; 2 uses
  %exitcond78.not = icmp eq i64 %i.ce, %i.h
  br i1 %exitcond78.not, label %._crit_edge, label %.preheader, !llvm.loop !573
...
._crit_edge:                                      ; preds = %.preheader, %_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEaSINS_14CwiseNullaryOpINS_8internal18scalar_constant_opIdEES2_EEEERS2_RKNS_9EigenBaseIT_EE.exit
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %4, i8 0, i64 16, i1 false), !alias.scope !583
  %i.cg = load ptr, ptr %2, align 8, !tbaa !38, !noalias !583 ; 8 uses
  %i.ch = ptrtoaddr ptr %i.cg to i64
  %i.ci = load i64, ptr %i.i, align 8, !tbaa !37, !noalias !583 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bq = getelementptr i8, ptr %.sink.i108, i64 %i.bp ; 3 uses
  %i.br = getelementptr [4 x i8], ptr %i.o, i64 %index ; 5 uses
  %wide.load = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !606, !noalias !607
  %i.bs = getelementptr [4 x i8], ptr %i.br, i64 %i.b
  %wide.load271 = load <2 x i32>, ptr %i.bs, align 4, !tbaa !45, !alias.scope !608, !noalias !609
  %i.bt = getelementptr [4 x i8], ptr %i.bq, i64 %i.c
  %i.bu = getelementptr i8, ptr %i.br, i64 %.idx
  %wide.load272 = load <2 x i32>, ptr %i.bu, align 4, !tbaa !45, !alias.scope !610, !noalias !609 ; 2 uses
  %i.bv = getelementptr i8, ptr %i.bq, i64 %.idx93
  %interleaved.vec = shufflevector <2 x i32> %wide.load, <2 x i32> %wide.load272, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec, ptr %i.bq, align 4, !tbaa !45, !noalias !53
  %i.bw = getelementptr i8, ptr %i.br, i64 %.idx94
  %wide.load273 = load <2 x i32>, ptr %i.bw, align 4, !tbaa !45, !alias.scope !611, !noalias !609
  %interleaved.vec274 = shufflevector <2 x i32> %wide.load271, <2 x i32> %wide.load273, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec274, ptr %i.bt, align 4, !tbaa !45
  %wide.load275 = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !606, !noalias !609
  %interleaved.vec276 = shufflevector <2 x i32> %wide.load272, <2 x i32> %wide.load275, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec276, ptr %i.bv, align 4, !tbaa !45
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.bx = icmp eq i64 %index.next, %n.vec
  br i1 %i.bx, label %middle.block, label %vector.body, !llvm.loop !597
...
_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58: ; preds = %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58.preheader, %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58
  ...
  %i.by = getelementptr i8, ptr %.sink.i108, i64 %.idx103 ; 4 uses
  %i.bz = getelementptr [4 x i8], ptr %i.o, i64 %.03796 ; 5 uses
  %i.ca = load i32, ptr %i.bz, align 4, !tbaa !45, !noalias !612
  store i32 %i.ca, ptr %i.by, align 4, !tbaa !45, !noalias !612
  %i.cb = getelementptr [4 x i8], ptr %i.bz, i64 %i.b
  %i.cc = load i32, ptr %i.cb, align 4, !tbaa !45
  %i.cd = getelementptr [4 x i8], ptr %i.by, i64 %i.c
  store i32 %i.cc, ptr %i.cd, align 4, !tbaa !45
  ...
  store i32 %i.cf, ptr %i.cg, align 4, !tbaa !45
  %i.ch = getelementptr i8, ptr %i.by, i64 4      ; 3 uses
  store i32 %i.cf, ptr %i.ch, align 4, !tbaa !45, !noalias !613
  %i.ci = getelementptr i8, ptr %i.bz, i64 %.idx94
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !45
  %i.ck = getelementptr [4 x i8], ptr %i.ch, i64 %i.c
  store i32 %i.cj, ptr %i.ck, align 4, !tbaa !45
  ...
  %i.cn = add nuw i64 %.03796, 1                  ; 2 uses
  %exitcond.not = icmp eq i64 %i.cn, %i.b
  br i1 %exitcond.not, label %._crit_edge, label %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58, !llvm.loop !600
...
vector.body292:                                   ; preds = %vector.body292, %vector.ph290
  ...
  %i.cz = getelementptr inbounds nuw [8 x i8], ptr %.pre, i64 %i.cx
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 32
  %wide.vec = load <4 x double>, ptr %i.cy, align 8, !tbaa !40, !alias.scope !614 ; 2 uses
  %strided.vec = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %strided.vec294 = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %wide.vec295 = load <4 x double>, ptr %i.da, align 8, !tbaa !40, !alias.scope !614 ; 2 uses
  %strided.vec296 = shufflevector <4 x double> %wide.vec295, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %strided.vec297 = shufflevector <4 x double> %wide.vec295, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %i.db = getelementptr inbounds nuw [8 x i8], ptr %i.cr, i64 %index293 ; 2 uses
  %i.dc = fadd <2 x double> %strided.vec, %strided.vec294
  %i.dd = fadd <2 x double> %strided.vec296, %strided.vec297
  %i.de = getelementptr inbounds nuw i8, ptr %i.db, i64 16
  store <2 x double> %i.dc, ptr %i.db, align 8, !tbaa !40, !alias.scope !615, !noalias !614
  store <2 x double> %i.dd, ptr %i.de, align 8, !tbaa !40, !alias.scope !615, !noalias !614
  %index.next298 = add nuw i64 %index293, 4       ; 2 uses
  %i.df = icmp eq i64 %index.next298, %n.vec291
  br i1 %i.df, label %middle.block299, label %vector.body292, !llvm.loop !604
...
scalar.ph288:                                     ; preds = %scalar.ph288.preheader, %scalar.ph288
  ...
  %i.dv = and i64 %indvars.iv.next, 4294967295
  %i.dw = icmp samesign ugt i64 %i.cp, %i.dv
  br i1 %i.dw, label %scalar.ph288, label %._crit_edge98, !llvm.loop !605
}
...
.noexc47:                                         ; preds = %bb.e
  %.pr.i.i.i.i.i.i.i = load i64, ptr %i.i, align 8, !tbaa !109
...
_ZN5Eigen15PlainObjectBaseINS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEEEaSINS_14CwiseNullaryOpINS_8internal18scalar_constant_opIiEES2_EEEERS2_RKNS_9EigenBaseIT_EE.exit.loopexit: ; preds = %_ZN5Eigen8internal17resize_if_allowedINS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEENS_14CwiseNullaryOpINS0_18scalar_constant_opIiEES3_EEiiEEvRT_RKT0_RKNS0_9assign_opIT1_T2_EE.exit.i.i.i.i.i.i.i
  %i.m = load ptr, ptr %2, align 8, !tbaa !110
  %.idx.i.i.i.i.i.i.i.i.i = shl nuw nsw i64 %i.k, 2
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.m, i8 0, i64 %.idx.i.i.i.i.i.i.i.i.i, i1 false), !tbaa !45
...
.preheader.lr.ph:                                 ; preds = %_ZN5Eigen15PlainObjectBaseINS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEEEaSINS_14CwiseNullaryOpINS_8internal18scalar_constant_opIiEES2_EEEERS2_RKNS_9EigenBaseIT_EE.exit
  %i.n = load ptr, ptr %1, align 8, !tbaa !41
  %i.o = load ptr, ptr %0, align 8, !tbaa !83     ; 9 uses
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.q = load i64, ptr %i.p, align 8, !tbaa !72   ; 7 uses
  %i.r = load i64, ptr %i.g, align 8, !tbaa !34   ; 2 uses
  %.idx.i = shl i64 %i.r, 3
  %i.s = load ptr, ptr %2, align 8, !tbaa !110
...
.preheader:                                       ; preds = %.preheader.lr.ph, %.preheader
  ...
  %i.ay = load i32, ptr %i.y, align 4, !tbaa !45
  ...
  %i.bw = load double, ptr %i.bv, align 8, !tbaa !40 ; 2 uses
  %i.bx = fsub double %i.bu, %i.bw
  %i.by = getelementptr [8 x i8], ptr %i.bp, i64 %i.t
  %i.bz = load double, ptr %i.by, align 8, !tbaa !40
  ...
  store i32 %i.cg, ptr %i.y, align 4, !tbaa !45
  %i.ch = load i32, ptr %i.v, align 4, !tbaa !45
  ...
  %i.cm = load i32, ptr %i.w, align 4, !tbaa !45
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bq = getelementptr i8, ptr %.sink.i108, i64 %i.bp ; 3 uses
  %i.br = getelementptr [4 x i8], ptr %i.o, i64 %index ; 5 uses
  %wide.load = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !648, !noalias !649
  %i.bs = getelementptr [4 x i8], ptr %i.br, i64 %i.b
  %wide.load271 = load <2 x i32>, ptr %i.bs, align 4, !tbaa !45, !alias.scope !650, !noalias !651
  %i.bt = getelementptr [4 x i8], ptr %i.bq, i64 %i.c
  %i.bu = getelementptr i8, ptr %i.br, i64 %.idx
  %wide.load272 = load <2 x i32>, ptr %i.bu, align 4, !tbaa !45, !alias.scope !652, !noalias !651 ; 2 uses
  %i.bv = getelementptr i8, ptr %i.bq, i64 %.idx93
  %interleaved.vec = shufflevector <2 x i32> %wide.load, <2 x i32> %wide.load272, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec, ptr %i.bq, align 4, !tbaa !45, !noalias !53
  %i.bw = getelementptr i8, ptr %i.br, i64 %.idx94
  %wide.load273 = load <2 x i32>, ptr %i.bw, align 4, !tbaa !45, !alias.scope !653, !noalias !651
  %interleaved.vec274 = shufflevector <2 x i32> %wide.load271, <2 x i32> %wide.load273, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec274, ptr %i.bt, align 4, !tbaa !45
  %wide.load275 = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !648, !noalias !651
  %interleaved.vec276 = shufflevector <2 x i32> %wide.load272, <2 x i32> %wide.load275, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec276, ptr %i.bv, align 4, !tbaa !45
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.bx = icmp eq i64 %index.next, %n.vec
  br i1 %i.bx, label %middle.block, label %vector.body, !llvm.loop !639
...
_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58: ; preds = %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58.preheader, %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58
  ...
  %i.by = getelementptr i8, ptr %.sink.i108, i64 %.idx103 ; 4 uses
  %i.bz = getelementptr [4 x i8], ptr %i.o, i64 %.03796 ; 5 uses
  %i.ca = load i32, ptr %i.bz, align 4, !tbaa !45, !noalias !654
  store i32 %i.ca, ptr %i.by, align 4, !tbaa !45, !noalias !654
  %i.cb = getelementptr [4 x i8], ptr %i.bz, i64 %i.b
  %i.cc = load i32, ptr %i.cb, align 4, !tbaa !45
  %i.cd = getelementptr [4 x i8], ptr %i.by, i64 %i.c
  store i32 %i.cc, ptr %i.cd, align 4, !tbaa !45
  ...
  store i32 %i.cf, ptr %i.cg, align 4, !tbaa !45
  %i.ch = getelementptr i8, ptr %i.by, i64 4      ; 3 uses
  store i32 %i.cf, ptr %i.ch, align 4, !tbaa !45, !noalias !655
  %i.ci = getelementptr i8, ptr %i.bz, i64 %.idx94
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !45
  %i.ck = getelementptr [4 x i8], ptr %i.ch, i64 %i.c
  store i32 %i.cj, ptr %i.ck, align 4, !tbaa !45
  ...
  %i.cn = add nuw i64 %.03796, 1                  ; 2 uses
  %exitcond.not = icmp eq i64 %i.cn, %i.b
  br i1 %exitcond.not, label %._crit_edge, label %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58, !llvm.loop !642
...
.preheader:                                       ; preds = %bb.d
  %i.cp = load i64, ptr %i.a, align 8, !tbaa !34  ; 7 uses
  %i.cq = icmp sgt i64 %i.cp, 0
  %.pre = load ptr, ptr %4, align 8, !tbaa !110   ; 7 uses
  br i1 %i.cq, label %.lr.ph, label %._crit_edge98

.lr.ph:                                           ; preds = %.preheader
  %i.cr = load ptr, ptr %2, align 8, !tbaa !110   ; 4 uses
  %5 = add nsw i64 %i.cp, -2147483649
...
vector.body292:                                   ; preds = %vector.body292, %vector.ph290
  ...
  %i.cz = getelementptr inbounds nuw [4 x i8], ptr %.pre, i64 %i.cx
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 32
  %wide.vec = load <8 x i32>, ptr %i.cy, align 4, !tbaa !45, !alias.scope !656 ; 2 uses
  %strided.vec = shufflevector <8 x i32> %wide.vec, <8 x i32> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %strided.vec294 = shufflevector <8 x i32> %wide.vec, <8 x i32> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %wide.vec295 = load <8 x i32>, ptr %i.da, align 4, !tbaa !45, !alias.scope !656 ; 2 uses
  ...
  %i.de = getelementptr inbounds nuw i8, ptr %i.db, i64 16
  store <4 x i32> %i.dc, ptr %i.db, align 4, !tbaa !45, !alias.scope !657, !noalias !656
  store <4 x i32> %i.dd, ptr %i.de, align 4, !tbaa !45, !alias.scope !657, !noalias !656
  %index.next298 = add nuw i64 %index293, 8       ; 2 uses
  %i.df = icmp eq i64 %index.next298, %n.vec291
  br i1 %i.df, label %middle.block299, label %vector.body292, !llvm.loop !646
...
common.resume:                                    ; preds = %bb.d, %._crit_edge
  %i.dh = landingpad { ptr, i32 }
          cleanup
  %i.di = load ptr, ptr %4, align 8, !tbaa !110
  call void @free(ptr noundef %i.di) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #23
  %i.dj = load ptr, ptr %3, align 8, !tbaa !41
  call void @free(ptr noundef %i.dj) #23
...
scalar.ph288:                                     ; preds = %scalar.ph288.preheader, %scalar.ph288
  ...
  %i.dm = zext i32 %i.dl to i64
  %i.dn = getelementptr inbounds nuw [4 x i8], ptr %.pre, i64 %i.dm
  %i.do = load i32, ptr %i.dn, align 4, !tbaa !45
  %i.dp = or disjoint i32 %i.dl, 1
  %i.dq = zext i32 %i.dp to i64
  %i.dr = getelementptr inbounds nuw [4 x i8], ptr %.pre, i64 %i.dq
  %i.ds = load i32, ptr %i.dr, align 4, !tbaa !45
  %i.dt = getelementptr inbounds nuw [4 x i8], ptr %i.cr, i64 %indvars.iv
  %i.du = add nsw i32 %i.ds, %i.do
  store i32 %i.du, ptr %i.dt, align 4, !tbaa !45
  %indvars.iv.next = add i64 %indvars.iv, 1       ; 2 uses
  %i.dv = and i64 %indvars.iv.next, 4294967295
  %i.dw = icmp samesign ugt i64 %i.cp, %i.dv
  br i1 %i.dw, label %scalar.ph288, label %._crit_edge98, !llvm.loop !647
}
...
_ZN5Eigen12DenseStorageIiLin1ELin1ELi1ELi0EE6resizeElll.exit: ; preds = %_ZN5Eigen8internal28check_rows_cols_for_overflowILin1EE3runIlEEvT_S4_.exit, %.sink.split.i
  store i64 %1, ptr %i.g, align 8, !tbaa !109
  ret void
}
...
bb.c:                                             ; preds = %bb.b
  ...
  store ptr %5, ptr %7, align 8, !tbaa !55
  %i.f = getelementptr inbounds nuw i8, ptr %7, i64 8
  store ptr %2, ptr %i.f, align 8, !tbaa !658
  %i.g = getelementptr inbounds nuw i8, ptr %7, i64 16
  store ptr %i.a, ptr %i.g, align 8, !tbaa !58
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #23
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #23
...
.noexc47:                                         ; preds = %.noexc
  tail call void @_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEE6resizeEll(ptr noundef nonnull align 8 dereferenceable(16) %2, i64 noundef %i.b, i64 noundef 1)
  %.pr.i.i.i.i.i.i.i = load i64, ptr %i.c, align 8, !tbaa !37
  br label %_ZN5Eigen8internal17resize_if_allowedINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEENS_14CwiseNullaryOpINS0_18scalar_constant_opIdEES3_EEddEEvRT_RKT0_RKNS0_9assign_opIT1_T2_EE.exit.i.i.i.i.i.i.i
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.br = getelementptr [4 x i8], ptr %i.o, i64 %index ; 5 uses
  %wide.load = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !720, !noalias !721
  %i.bs = getelementptr [4 x i8], ptr %i.br, i64 %i.b
  %wide.load270 = load <2 x i32>, ptr %i.bs, align 4, !tbaa !45, !alias.scope !722, !noalias !723
  %i.bt = getelementptr [4 x i8], ptr %i.bq, i64 %i.c
  %i.bu = getelementptr i8, ptr %i.br, i64 %.idx
  %wide.load271 = load <2 x i32>, ptr %i.bu, align 4, !tbaa !45, !alias.scope !724, !noalias !723 ; 2 uses
  %i.bv = getelementptr i8, ptr %i.bq, i64 %.idx93
  %interleaved.vec = shufflevector <2 x i32> %wide.load, <2 x i32> %wide.load271, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec, ptr %i.bq, align 4, !tbaa !45, !noalias !53
  %i.bw = getelementptr i8, ptr %i.br, i64 %.idx94
  %wide.load272 = load <2 x i32>, ptr %i.bw, align 4, !tbaa !45, !alias.scope !725, !noalias !723
  %interleaved.vec273 = shufflevector <2 x i32> %wide.load270, <2 x i32> %wide.load272, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec273, ptr %i.bt, align 4, !tbaa !45
  %wide.load274 = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !720, !noalias !723
  %interleaved.vec275 = shufflevector <2 x i32> %wide.load271, <2 x i32> %wide.load274, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec275, ptr %i.bv, align 4, !tbaa !45
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.bx = icmp eq i64 %index.next, %n.vec
  br i1 %i.bx, label %middle.block, label %vector.body, !llvm.loop !711
...
_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58: ; preds = %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58.preheader, %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58
  ...
  %i.bz = getelementptr [4 x i8], ptr %i.o, i64 %.03796 ; 5 uses
  %i.ca = load i32, ptr %i.bz, align 4, !tbaa !45, !noalias !726
  store i32 %i.ca, ptr %i.by, align 4, !tbaa !45, !noalias !726
  %i.cb = getelementptr [4 x i8], ptr %i.bz, i64 %i.b
  %i.cc = load i32, ptr %i.cb, align 4, !tbaa !45
  %i.cd = getelementptr [4 x i8], ptr %i.by, i64 %i.c
  store i32 %i.cc, ptr %i.cd, align 4, !tbaa !45
  ...
  store i32 %i.cf, ptr %i.cg, align 4, !tbaa !45
  %i.ch = getelementptr i8, ptr %i.by, i64 4      ; 3 uses
  store i32 %i.cf, ptr %i.ch, align 4, !tbaa !45, !noalias !727
  %i.ci = getelementptr i8, ptr %i.bz, i64 %.idx94
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !45
  %i.ck = getelementptr [4 x i8], ptr %i.ch, i64 %i.c
  store i32 %i.cj, ptr %i.ck, align 4, !tbaa !45
  ...
  %i.cn = add nuw i64 %.03796, 1                  ; 2 uses
  %exitcond.not = icmp eq i64 %i.cn, %i.b
  br i1 %exitcond.not, label %._crit_edge, label %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58, !llvm.loop !714
...
_ZN5Eigen8internal28check_rows_cols_for_overflowILin1EE3runIlEEvT_S4_.exit.i: ; preds = %._crit_edge
  %i.co = load i64, ptr %i.a, align 8, !tbaa !34  ; 2 uses
...
.lr.ph:                                           ; preds = %_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEE6resizeEll.exit.preheader
  %i.cr = load ptr, ptr %2, align 8, !tbaa !83    ; 4 uses
  %5 = add nsw i64 %i.cp, -2147483649
...
vector.body291:                                   ; preds = %vector.body291, %vector.ph289
  ...
  %i.cz = getelementptr inbounds nuw [8 x i8], ptr %.pre, i64 %i.cx
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 32
  %wide.vec = load <4 x double>, ptr %i.cy, align 8, !tbaa !40, !alias.scope !728 ; 2 uses
  %strided.vec = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %strided.vec293 = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %wide.vec294 = load <4 x double>, ptr %i.da, align 8, !tbaa !40, !alias.scope !728 ; 2 uses
  ...
  %i.de = getelementptr inbounds nuw i8, ptr %i.db, i64 16
  store <2 x double> %i.dc, ptr %i.db, align 8, !tbaa !40, !alias.scope !729, !noalias !728
  store <2 x double> %i.dd, ptr %i.de, align 8, !tbaa !40, !alias.scope !729, !noalias !728
  %index.next297 = add nuw i64 %index292, 4       ; 2 uses
  %i.df = icmp eq i64 %index.next297, %n.vec290
  br i1 %i.df, label %middle.block298, label %vector.body291, !llvm.loop !718
...
_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEE6resizeEll.exit: ; preds = %_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEE6resizeEll.exit.preheader329, %_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEE6resizeEll.exit
  ...
  %i.dv = and i64 %indvars.iv.next, 4294967295
  %i.dw = icmp samesign ugt i64 %i.cp, %i.dv
  br i1 %i.dw, label %_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEE6resizeEll.exit, label %_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEE6resizeEll.exit._crit_edge, !llvm.loop !719
}
...
bb.a:
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #23
  %i.a = load <2 x double>, ptr %1, align 1, !tbaa !50 ; 2 uses
  %i.b = load <2 x double>, ptr %2, align 1, !tbaa !50 ; 2 uses
  ...
  %i.g = load double, ptr %i.e, align 8, !tbaa !40 ; 2 uses
  %i.h = load double, ptr %i.f, align 8, !tbaa !40 ; 2 uses
  %i.i = load <2 x double>, ptr %0, align 1, !tbaa !50 ; 2 uses
  %i.j = fsub <2 x double> %i.b, %i.i             ; 2 uses
  %i.k = fmul <2 x double> %i.j, %i.j             ; 2 uses
  %i.l = getelementptr i8, ptr %0, i64 16
  %i.m = load double, ptr %i.l, align 8, !tbaa !40 ; 2 uses
  ...
  store <2 x double> %i.x, ptr %4, align 16, !tbaa !40
  ...
  store double %.scalar.i.i.i.i.i.i.i.i.i.i.i.i.i.i25, ptr %i.y, align 16, !tbaa !40
...
bb.b:                                             ; preds = %bb.a
  %i.c = getelementptr inbounds nuw i8, ptr %2, i64 8 ; 2 uses
  %i.d = load i64, ptr %i.c, align 8, !tbaa !72, !noalias !741 ; 6 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bq = getelementptr i8, ptr %.sink.i108, i64 %i.bp ; 3 uses
  %i.br = getelementptr [4 x i8], ptr %i.o, i64 %index ; 5 uses
  %wide.load = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !907, !noalias !908
  %i.bs = getelementptr [4 x i8], ptr %i.br, i64 %i.b
  %wide.load271 = load <2 x i32>, ptr %i.bs, align 4, !tbaa !45, !alias.scope !909, !noalias !910
  %i.bt = getelementptr [4 x i8], ptr %i.bq, i64 %i.c
  %i.bu = getelementptr i8, ptr %i.br, i64 %.idx
  %wide.load272 = load <2 x i32>, ptr %i.bu, align 4, !tbaa !45, !alias.scope !911, !noalias !910 ; 2 uses
  %i.bv = getelementptr i8, ptr %i.bq, i64 %.idx93
  %interleaved.vec = shufflevector <2 x i32> %wide.load, <2 x i32> %wide.load272, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec, ptr %i.bq, align 4, !tbaa !45, !noalias !53
  %i.bw = getelementptr i8, ptr %i.br, i64 %.idx94
  %wide.load273 = load <2 x i32>, ptr %i.bw, align 4, !tbaa !45, !alias.scope !912, !noalias !910
  %interleaved.vec274 = shufflevector <2 x i32> %wide.load271, <2 x i32> %wide.load273, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec274, ptr %i.bt, align 4, !tbaa !45
  %wide.load275 = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !907, !noalias !910
  %interleaved.vec276 = shufflevector <2 x i32> %wide.load272, <2 x i32> %wide.load275, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec276, ptr %i.bv, align 4, !tbaa !45
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.bx = icmp eq i64 %index.next, %n.vec
  br i1 %i.bx, label %middle.block, label %vector.body, !llvm.loop !898
...
_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58: ; preds = %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58.preheader, %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58
  ...
  %i.by = getelementptr i8, ptr %.sink.i108, i64 %.idx103 ; 4 uses
  %i.bz = getelementptr [4 x i8], ptr %i.o, i64 %.03796 ; 5 uses
  %i.ca = load i32, ptr %i.bz, align 4, !tbaa !45, !noalias !913
  store i32 %i.ca, ptr %i.by, align 4, !tbaa !45, !noalias !913
  %i.cb = getelementptr [4 x i8], ptr %i.bz, i64 %i.b
  %i.cc = load i32, ptr %i.cb, align 4, !tbaa !45
  %i.cd = getelementptr [4 x i8], ptr %i.by, i64 %i.c
  store i32 %i.cc, ptr %i.cd, align 4, !tbaa !45
  ...
  store i32 %i.cf, ptr %i.cg, align 4, !tbaa !45
  %i.ch = getelementptr i8, ptr %i.by, i64 4      ; 3 uses
  store i32 %i.cf, ptr %i.ch, align 4, !tbaa !45, !noalias !914
  %i.ci = getelementptr i8, ptr %i.bz, i64 %.idx94
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !45
  %i.ck = getelementptr [4 x i8], ptr %i.ch, i64 %i.c
  store i32 %i.cj, ptr %i.ck, align 4, !tbaa !45
  ...
  %i.cn = add nuw i64 %.03796, 1                  ; 2 uses
  %exitcond.not = icmp eq i64 %i.cn, %i.b
  br i1 %exitcond.not, label %._crit_edge, label %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58, !llvm.loop !901
...
vector.body292:                                   ; preds = %vector.body292, %vector.ph290
  ...
  %i.cz = getelementptr inbounds nuw [8 x i8], ptr %.pre, i64 %i.cx
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 32
  %wide.vec = load <4 x double>, ptr %i.cy, align 8, !tbaa !40, !alias.scope !915 ; 2 uses
  %strided.vec = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %strided.vec294 = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %wide.vec295 = load <4 x double>, ptr %i.da, align 8, !tbaa !40, !alias.scope !915 ; 2 uses
  %strided.vec296 = shufflevector <4 x double> %wide.vec295, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %strided.vec297 = shufflevector <4 x double> %wide.vec295, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %i.db = getelementptr inbounds nuw [8 x i8], ptr %i.cr, i64 %index293 ; 2 uses
  %i.dc = fadd <2 x double> %strided.vec, %strided.vec294
  %i.dd = fadd <2 x double> %strided.vec296, %strided.vec297
  %i.de = getelementptr inbounds nuw i8, ptr %i.db, i64 16
  store <2 x double> %i.dc, ptr %i.db, align 8, !tbaa !40, !alias.scope !916, !noalias !915
  store <2 x double> %i.dd, ptr %i.de, align 8, !tbaa !40, !alias.scope !916, !noalias !915
  %index.next298 = add nuw i64 %index293, 4       ; 2 uses
  %i.df = icmp eq i64 %index.next298, %n.vec291
  br i1 %i.df, label %middle.block299, label %vector.body292, !llvm.loop !905
...
scalar.ph288:                                     ; preds = %scalar.ph288.preheader, %scalar.ph288
  ...
  %i.dv = and i64 %indvars.iv.next, 4294967295
  %i.dw = icmp samesign ugt i64 %i.cp, %i.dv
  br i1 %i.dw, label %scalar.ph288, label %._crit_edge98, !llvm.loop !906
}
...
.noexc:                                           ; preds = %bb.b
  ...
  %i.c = load ptr, ptr %3, align 8, !tbaa !43     ; 3 uses
  %i.d = load i64, ptr %i.b, align 8, !tbaa !44   ; 2 uses
  %.idx.i.i.i = shl i64 %i.d, 4
  %i.e = load double, ptr %i.c, align 8, !tbaa !40 ; 3 uses
  ...
  %i.i = load double, ptr %i.h, align 8, !tbaa !40 ; 4 uses
  ...
  %i.w = load ptr, ptr %4, align 8, !tbaa !41
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %i.aa = load ptr, ptr %4, align 8, !tbaa !41
  call void @free(ptr noundef %i.aa) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #23
  %i.ab = load ptr, ptr %3, align 8, !tbaa !43
...
bb.f:                                             ; preds = %bb.e
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.m, align 8, !tbaa !52
...
bb.g:                                             ; preds = %_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit.i.i
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.q, align 8, !tbaa !52
...
_ZN5Eigen12DenseStorageIdLin1ELin1ELi3ELi0EE6resizeElll.exit: ; preds = %_ZN5Eigen8internal28check_rows_cols_for_overflowILin1EE3runIlEEvT_S4_.exit, %.sink.split.i
  store i64 %1, ptr %i.g, align 8, !tbaa !44
  ret void
}
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !927, !nonnull !53, !align !119 ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %i.d = load i64, ptr %i.c, align 8, !tbaa !88   ; 7 uses
  %i.e = load ptr, ptr %i.b, align 8, !tbaa !87
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bq = getelementptr i8, ptr %.sink.i108, i64 %i.bp ; 3 uses
  %i.br = getelementptr [4 x i8], ptr %i.o, i64 %index ; 5 uses
  %wide.load = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !967, !noalias !968
  %i.bs = getelementptr [4 x i8], ptr %i.br, i64 %i.b
  %wide.load271 = load <2 x i32>, ptr %i.bs, align 4, !tbaa !45, !alias.scope !969, !noalias !970
  %i.bt = getelementptr [4 x i8], ptr %i.bq, i64 %i.c
  %i.bu = getelementptr i8, ptr %i.br, i64 %.idx
  %wide.load272 = load <2 x i32>, ptr %i.bu, align 4, !tbaa !45, !alias.scope !971, !noalias !970 ; 2 uses
  %i.bv = getelementptr i8, ptr %i.bq, i64 %.idx93
  %interleaved.vec = shufflevector <2 x i32> %wide.load, <2 x i32> %wide.load272, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec, ptr %i.bq, align 4, !tbaa !45, !noalias !53
  %i.bw = getelementptr i8, ptr %i.br, i64 %.idx94
  %wide.load273 = load <2 x i32>, ptr %i.bw, align 4, !tbaa !45, !alias.scope !972, !noalias !970
  %interleaved.vec274 = shufflevector <2 x i32> %wide.load271, <2 x i32> %wide.load273, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec274, ptr %i.bt, align 4, !tbaa !45
  %wide.load275 = load <2 x i32>, ptr %i.br, align 4, !tbaa !45, !alias.scope !967, !noalias !970
  %interleaved.vec276 = shufflevector <2 x i32> %wide.load272, <2 x i32> %wide.load275, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x i32> %interleaved.vec276, ptr %i.bv, align 4, !tbaa !45
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.bx = icmp eq i64 %index.next, %n.vec
  br i1 %i.bx, label %middle.block, label %vector.body, !llvm.loop !958
...
_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58: ; preds = %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58.preheader, %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58
  ...
  %i.by = getelementptr i8, ptr %.sink.i108, i64 %.idx103 ; 4 uses
  %i.bz = getelementptr [4 x i8], ptr %i.o, i64 %.03796 ; 5 uses
  %i.ca = load i32, ptr %i.bz, align 4, !tbaa !45, !noalias !973
  store i32 %i.ca, ptr %i.by, align 4, !tbaa !45, !noalias !973
  %i.cb = getelementptr [4 x i8], ptr %i.bz, i64 %i.b
  %i.cc = load i32, ptr %i.cb, align 4, !tbaa !45
  %i.cd = getelementptr [4 x i8], ptr %i.by, i64 %i.c
  store i32 %i.cc, ptr %i.cd, align 4, !tbaa !45
  ...
  store i32 %i.cf, ptr %i.cg, align 4, !tbaa !45
  %i.ch = getelementptr i8, ptr %i.by, i64 4      ; 3 uses
  store i32 %i.cf, ptr %i.ch, align 4, !tbaa !45, !noalias !974
  %i.ci = getelementptr i8, ptr %i.bz, i64 %.idx94
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !45
  %i.ck = getelementptr [4 x i8], ptr %i.ch, i64 %i.c
  store i32 %i.cj, ptr %i.ck, align 4, !tbaa !45
  ...
  %i.cn = add nuw i64 %.03796, 1                  ; 2 uses
  %exitcond.not = icmp eq i64 %i.cn, %i.b
  br i1 %exitcond.not, label %._crit_edge, label %_ZN5Eigen16CommaInitializerINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEEcmERKi.exit58, !llvm.loop !961
...
vector.body292:                                   ; preds = %vector.body292, %vector.ph290
  ...
  %i.cz = getelementptr inbounds nuw [8 x i8], ptr %.pre, i64 %i.cx
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 32
  %wide.vec = load <4 x double>, ptr %i.cy, align 8, !tbaa !40, !alias.scope !975 ; 2 uses
  %strided.vec = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %strided.vec294 = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %wide.vec295 = load <4 x double>, ptr %i.da, align 8, !tbaa !40, !alias.scope !975 ; 2 uses
  %strided.vec296 = shufflevector <4 x double> %wide.vec295, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %strided.vec297 = shufflevector <4 x double> %wide.vec295, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %i.db = getelementptr inbounds nuw [8 x i8], ptr %i.cr, i64 %index293 ; 2 uses
  %i.dc = fadd <2 x double> %strided.vec, %strided.vec294
  %i.dd = fadd <2 x double> %strided.vec296, %strided.vec297
  %i.de = getelementptr inbounds nuw i8, ptr %i.db, i64 16
  store <2 x double> %i.dc, ptr %i.db, align 8, !tbaa !40, !alias.scope !976, !noalias !975
  store <2 x double> %i.dd, ptr %i.de, align 8, !tbaa !40, !alias.scope !976, !noalias !975
  %index.next298 = add nuw i64 %index293, 4       ; 2 uses
  %i.df = icmp eq i64 %index.next298, %n.vec291
  br i1 %i.df, label %middle.block299, label %vector.body292, !llvm.loop !965
...
scalar.ph288:                                     ; preds = %scalar.ph288.preheader, %scalar.ph288
  ...
  %i.dv = and i64 %indvars.iv.next, 4294967295
  %i.dw = icmp samesign ugt i64 %i.cp, %i.dv
  br i1 %i.dw, label %scalar.ph288, label %._crit_edge98, !llvm.loop !966
}
...
.lr.ph:                                           ; preds = %.preheader57
  %i.k = load ptr, ptr %2, align 8, !tbaa !161, !nonnull !53, !align !119 ; 2 uses
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !163, !nonnull !53, !align !119 ; 2 uses
  ...
  %i.q = load ptr, ptr %i.p, align 8, !tbaa !164, !nonnull !53, !align !119
...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  %i.u = load double, ptr %i.t, align 8, !tbaa !40 ; 3 uses
  %i.v = getelementptr [8 x i8], ptr %i.t, i64 %i.o
  %i.w = load double, ptr %i.v, align 8, !tbaa !40 ; 3 uses
  %i.x = getelementptr i8, ptr %i.t, i64 %.idx.i.i
  %i.y = load double, ptr %i.x, align 8, !tbaa !40 ; 4 uses
  ...
  store i32 %i.al, ptr %i.am, align 4, !tbaa !45
  %i.an = add nuw nsw i64 %.03360, 1              ; 2 uses
  %exitcond.not = icmp eq i64 %i.an, %0
  br i1 %exitcond.not, label %.loopexit58, label %bb.c, !llvm.loop !977
...
.noexc:                                           ; preds = %_ZNSt12_Vector_baseISt6threadSaIS0_EE11_M_allocateEm.exit.i
  %i.ay = load ptr, ptr %6, align 8, !tbaa !126   ; 5 uses
  %i.az = load ptr, ptr %i.av, align 8, !tbaa !127 ; 2 uses
  %.not10.i.i.i.i = icmp eq ptr %i.ay, %i.az
...
.lr.ph.i.i.i.i:                                   ; preds = %.noexc, %.lr.ph.i.i.i.i
  %.012.i.i.i.i = phi ptr [ %i.bc, %.lr.ph.i.i.i.i ], [ %i.ax, %.noexc ] ; 2 uses
  %.0911.i.i.i.i = phi ptr [ %i.bb, %.lr.ph.i.i.i.i ], [ %i.ay, %.noexc ] ; 3 uses
