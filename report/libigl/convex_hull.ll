...
bb.c:                                             ; preds = %bb.a
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #28
  %.430 = extractvalue { ptr, i32 } %i.bj, 1
  %i.bk = call i32 @llvm.eh.typeid.for.p0(ptr nonnull @_ZTIN4CGAL30Uncertain_conversion_exceptionE) #28
  %i.bl = icmp eq i32 %.430, %i.bk
  br i1 %i.bl, label %bb.d, label %bb.h

bb.d:                                             ; preds = %bb.c
  %.4 = extractvalue { ptr, i32 } %i.bj, 0
  %i.bm = call ptr @__cxa_begin_catch(ptr %.4) #28 ; 0 uses
  invoke void @__cxa_end_catch()
          to label %bb.e unwind label %bb.g

bb.e:                                             ; preds = %bb.b, %bb.d
  %.121 = phi i1 [ true, %bb.d ], [ %i.bh, %bb.b ]
  ...
  br i1 %.121, label %bb.f, label %bb.i
...
_ZN4CGAL34has_smaller_signed_dist_to_planeC3INS_11Interval_ntILb0EEEEENS_8Equal_toIT_S4_E11result_typeERKS4_S8_S8_S8_S8_S8_S8_S8_S8_S8_S8_S8_S8_S8_S8_.exit: ; preds = %bb.a, %bb.b, %bb.c, %bb.d
  %.sroa.5.0.i.i.i.i.i.i = phi i64 [ 8589934591, %bb.d ], [ 4294967297, %bb.a ], [ -1, %bb.b ], [ 0, %bb.c ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %14) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %13) #28
  ...
  %i.cb = icmp slt i32 %.sroa.3.0.extract.trunc.i.i, -1
  %i.cc = icmp sgt i32 %.sroa.0.0.extract.trunc.i.i, -1
  %or.cond.i.i = or i1 %i.cc, %i.cb
  %i.cd = icmp eq i32 %.sroa.0.0.extract.trunc.i.i, %.sroa.3.0.extract.trunc.i.i
  %i.ce = zext i1 %i.cd to i16
  %i.cf = or disjoint i16 %i.ce, 256
  %.sroa.4.0.i.i = select i1 %or.cond.i.i, i16 0, i16 %i.cf
...
bb.f:                                             ; preds = %bb.a
  ...
  %i.ci = call i32 @llvm.eh.typeid.for.p0(ptr nonnull @_ZTIN4CGAL30Uncertain_conversion_exceptionE) #28
  %i.cj = icmp eq i32 %.327, %i.ci
  br i1 %i.cj, label %bb.g, label %bb.k

bb.g:                                             ; preds = %bb.f
  %.323 = extractvalue { ptr, i32 } %i.ch, 0
  %i.ck = call ptr @__cxa_begin_catch(ptr %.323) #28 ; 0 uses
  invoke void @__cxa_end_catch()
...
.lr.ph60:                                         ; preds = %.lr.ph60.preheader, %bb.o
  %.sroa.09.058 = phi ptr [ %.sroa.0.0.copyload.i.i45, %bb.o ], [ %.sroa.0.0.copyload.i.i44, %.lr.ph60.preheader ] ; 2 uses
  %.03257 = phi i64 [ %i.cg, %bb.o ], [ 3, %.lr.ph60.preheader ]
  %i.ce = getelementptr inbounds nuw i8, ptr %.sroa.09.058, i64 8
  %.sroa.0.0.copyload.i.i45 = load ptr, ptr %i.ce, align 8, !tbaa !274
  %i.cf = invoke ptr @_ZN4CGAL5Euler10split_faceINS_12Polyhedron_3INS_5EpickENS_18Polyhedron_items_3ENS_18HalfedgeDS_defaultESaIiEEEEEN5boost12graph_traitsIT_E19halfedge_descriptorESC_SC_RSA_(ptr nonnull %.sroa.09.058, ptr %.sroa.0.0.copyload.i.i, ptr noundef nonnull align 8 dereferenceable(105) %1)
          to label %bb.o unwind label %bb.p       ; 0 uses

bb.o:                                             ; preds = %.lr.ph60
  %i.cg = add nuw i64 %.03257, 1                  ; 2 uses
...
begin_hunk_5_@_ZN4CGAL26ch__ref_graham_andrew_scanIN9__gnu_cxx17__normal_iteratorIPNS_7Point_3INS_5EpickEEESt6vectorIS5_SaIS5_EEEESt20back_insert_iteratorINSt7__cxx114listIS5_S8_EEENS_22Projection_traits_xy_3IS4_EEEET0_T_SJ_RSI_RKT1_:_ZNKSt6vectorIN9__gnu_cxx17__normal_iteratorIPN4CGAL7Point_3INS2_5EpickEEES_IS5_SaIS5_EEEESaIS9_EE12_M_check_lenEmPKc.exit.i.i
  ...
  %.157.i.i.i.i.i43 = select i1 %i.bs, double %i.br, double %i.bq ; 3 uses
  %.155.i.i.i.i.i44 = select i1 %i.bs, double %i.bq, double %i.br ; 2 uses
  %i.bt = fcmp olt double %.157.i.i.i.i.i43, 1.000000e-146
  br i1 %i.bt, label %bb.i, label %bb.j

bb.i:                                             ; preds = %bb.h
  %i.bu = fcmp oeq double %.157.i.i.i.i.i43, 0.000000e+00
...
bb.j:                                             ; preds = %bb.h
  %i.bv = fcmp olt double %.155.i.i.i.i.i44, f0x5FB317E5EF3AB327
  br i1 %i.bv, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  %i.bw = fmul double %.157.i.i.i.i.i43, f0x3CD0028010000004
  %i.bx = fmul double %.155.i.i.i.i.i44, %i.bw    ; 2 uses
  %i.by = fcmp ule double %i.bl, %i.bx            ; 2 uses
  %i.bz = fneg double %i.bx
  %i.ca = fcmp uge double %i.bl, %i.bz
  %cond1.i.i.i.i.i46 = and i1 %i.by, %i.ca
  %.0.i.i.i.i.i47 = select i1 %i.by, i32 -1, i32 1
  br i1 %cond1.i.i.i.i.i46, label %bb.l, label %bb.m
...
bb.m:                                             ; preds = %bb.k, %bb.l
  %.3.i.i.i.i.i45 = phi i32 [ %.0.i.i.i.i.i47, %bb.k ], [ %i.cb, %bb.l ]
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %11) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #28
...
.preheader:                                       ; preds = %bb.m, %bb.w
  ...
  %.157.i.i.i.i.i52 = select i1 %i.cv, double %i.cu, double %i.ct ; 3 uses
  %.155.i.i.i.i.i53 = select i1 %i.cv, double %i.ct, double %i.cu ; 2 uses
  %i.cw = fcmp olt double %.157.i.i.i.i.i52, 1.000000e-146
  br i1 %i.cw, label %bb.n, label %bb.o

bb.n:                                             ; preds = %.preheader
  %i.cx = fcmp oeq double %.157.i.i.i.i.i52, 0.000000e+00
...
bb.o:                                             ; preds = %.preheader
  %i.cy = fcmp olt double %.155.i.i.i.i.i53, f0x5FB317E5EF3AB327
  br i1 %i.cy, label %bb.p, label %bb.q

bb.p:                                             ; preds = %bb.o
  %i.cz = fmul double %.157.i.i.i.i.i52, f0x3CD0028010000004
  %i.da = fmul double %.155.i.i.i.i.i53, %i.cz    ; 2 uses
  %i.db = fcmp ule double %i.co, %i.da            ; 2 uses
  %i.dc = fneg double %i.da
  %i.dd = fcmp uge double %i.co, %i.dc
  %cond1.i.i.i.i.i55 = and i1 %i.db, %i.dd
  %.0.i.i.i.i.i56 = select i1 %i.db, i32 -1, i32 1
  br i1 %cond1.i.i.i.i.i55, label %bb.q, label %bb.v
...
bb.v:                                             ; preds = %bb.p, %bb.t, %bb.u
  %.3.i.i.i.i.i54 = phi i32 [ %.0.i.i.i.i.i56, %bb.p ], [ %i.gf, %bb.u ], [ %.sroa.0.0.extract.trunc.i.i, %bb.t ]
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #28
...
begin_hunk_6_@_ZN4CGAL26ch__ref_graham_andrew_scanIN9__gnu_cxx17__normal_iteratorIPNS_7Point_3INS_5EpickEEESt6vectorIS5_SaIS5_EEEESt20back_insert_iteratorINSt7__cxx114listIS5_S8_EEENS_22Projection_traits_yz_3IS4_EEEET0_T_SJ_RSI_RKT1_:_ZNKSt6vectorIN9__gnu_cxx17__normal_iteratorIPN4CGAL7Point_3INS2_5EpickEEES_IS5_SaIS5_EEEESaIS9_EE12_M_check_lenEmPKc.exit.i.i
  ...
  %.157.i.i.i.i.i43 = select i1 %i.bx, double %i.bw, double %i.bv ; 3 uses
  %.155.i.i.i.i.i44 = select i1 %i.bx, double %i.bv, double %i.bw ; 2 uses
  %i.by = fcmp olt double %.157.i.i.i.i.i43, 1.000000e-146
  br i1 %i.by, label %bb.i, label %bb.j

bb.i:                                             ; preds = %bb.h
  %i.bz = fcmp oeq double %.157.i.i.i.i.i43, 0.000000e+00
...
bb.j:                                             ; preds = %bb.h
  %i.ca = fcmp olt double %.155.i.i.i.i.i44, f0x5FB317E5EF3AB327
  br i1 %i.ca, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  %i.cb = fmul double %.157.i.i.i.i.i43, f0x3CD0028010000004
  %i.cc = fmul double %.155.i.i.i.i.i44, %i.cb    ; 2 uses
  %i.cd = fcmp ule double %i.bq, %i.cc            ; 2 uses
  %i.ce = fneg double %i.cc
  %i.cf = fcmp uge double %i.bq, %i.ce
  %cond1.i.i.i.i.i46 = and i1 %i.cd, %i.cf
  %.0.i.i.i.i.i47 = select i1 %i.cd, i32 -1, i32 1
  br i1 %cond1.i.i.i.i.i46, label %bb.l, label %bb.m
...
bb.m:                                             ; preds = %bb.k, %bb.l
  %.3.i.i.i.i.i45 = phi i32 [ %.0.i.i.i.i.i47, %bb.k ], [ %i.cg, %bb.l ]
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %11) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #28
...
.preheader:                                       ; preds = %bb.m, %bb.w
  ...
  %.157.i.i.i.i.i52 = select i1 %i.dc, double %i.db, double %i.da ; 3 uses
  %.155.i.i.i.i.i53 = select i1 %i.dc, double %i.da, double %i.db ; 2 uses
  %i.dd = fcmp olt double %.157.i.i.i.i.i52, 1.000000e-146
  br i1 %i.dd, label %bb.n, label %bb.o

bb.n:                                             ; preds = %.preheader
  %i.de = fcmp oeq double %.157.i.i.i.i.i52, 0.000000e+00
...
bb.o:                                             ; preds = %.preheader
  %i.df = fcmp olt double %.155.i.i.i.i.i53, f0x5FB317E5EF3AB327
  br i1 %i.df, label %bb.p, label %bb.q

bb.p:                                             ; preds = %bb.o
  %i.dg = fmul double %.157.i.i.i.i.i52, f0x3CD0028010000004
  %i.dh = fmul double %.155.i.i.i.i.i53, %i.dg    ; 2 uses
  %i.di = fcmp ule double %i.cv, %i.dh            ; 2 uses
  %i.dj = fneg double %i.dh
  %i.dk = fcmp uge double %i.cv, %i.dj
  %cond1.i.i.i.i.i55 = and i1 %i.di, %i.dk
  %.0.i.i.i.i.i56 = select i1 %i.di, i32 -1, i32 1
  br i1 %cond1.i.i.i.i.i55, label %bb.q, label %bb.v
...
bb.v:                                             ; preds = %bb.p, %bb.t, %bb.u
  %.3.i.i.i.i.i54 = phi i32 [ %.0.i.i.i.i.i56, %bb.p ], [ %i.gm, %bb.u ], [ %.sroa.0.0.extract.trunc.i.i, %bb.t ]
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #28
...
begin_hunk_7_@_ZN4CGAL26ch__ref_graham_andrew_scanIN9__gnu_cxx17__normal_iteratorIPNS_7Point_3INS_5EpickEEESt6vectorIS5_SaIS5_EEEESt20back_insert_iteratorINSt7__cxx114listIS5_S8_EEENS_22Projection_traits_xz_3IS4_EEEET0_T_SJ_RSI_RKT1_:_ZNKSt6vectorIN9__gnu_cxx17__normal_iteratorIPN4CGAL7Point_3INS2_5EpickEEES_IS5_SaIS5_EEEESaIS9_EE12_M_check_lenEmPKc.exit.i.i
  ...
  %.056.i.i.i.i.i41 = select i1 %i.cg, double %i.ce, double %i.cc ; 3 uses
  %i.ch = fcmp olt double %i.cd, %i.cf
  %.054.i.i.i.i.i42 = select i1 %i.ch, double %i.cf, double %i.cd ; 3 uses
  %i.ci = fcmp ogt double %.056.i.i.i.i.i41, %.054.i.i.i.i.i42 ; 2 uses
  %.157.i.i.i.i.i43 = select i1 %i.ci, double %.054.i.i.i.i.i42, double %.056.i.i.i.i.i41 ; 3 uses
  %.155.i.i.i.i.i44 = select i1 %i.ci, double %.056.i.i.i.i.i41, double %.054.i.i.i.i.i42 ; 2 uses
  %i.cj = fcmp olt double %.157.i.i.i.i.i43, 1.000000e-146
  br i1 %i.cj, label %bb.i, label %bb.j

bb.i:                                             ; preds = %bb.h
  %i.ck = fcmp oeq double %.157.i.i.i.i.i43, 0.000000e+00
...
bb.j:                                             ; preds = %bb.h
  %i.cl = fcmp olt double %.155.i.i.i.i.i44, f0x5FB317E5EF3AB327
  br i1 %i.cl, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  %i.cm = fmul double %.157.i.i.i.i.i43, f0x3CD0028010000004
  %i.cn = fmul double %.155.i.i.i.i.i44, %i.cm    ; 2 uses
  %i.co = fcmp ule double %i.cb, %i.cn            ; 2 uses
  %i.cp = fneg double %i.cn
  %i.cq = fcmp uge double %i.cb, %i.cp
  %cond1.i.i.i.i.i46 = and i1 %i.co, %i.cq
  %.0.i.i.i.i.i47 = select i1 %i.co, i32 -1, i32 1
  br i1 %cond1.i.i.i.i.i46, label %bb.l, label %bb.m
...
bb.m:                                             ; preds = %bb.k, %bb.l
  %.3.i.i.i.i.i45 = phi i32 [ %.0.i.i.i.i.i47, %bb.k ], [ %i.cr, %bb.l ]
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %11) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #28
...
.preheader:                                       ; preds = %bb.m, %bb.w
  ...
  %.056.i.i.i.i.i50 = select i1 %i.dm, double %i.dk, double %i.di ; 3 uses
  %i.dn = fcmp olt double %i.dj, %i.dl
  %.054.i.i.i.i.i51 = select i1 %i.dn, double %i.dl, double %i.dj ; 3 uses
  %i.do = fcmp ogt double %.056.i.i.i.i.i50, %.054.i.i.i.i.i51 ; 2 uses
  %.157.i.i.i.i.i52 = select i1 %i.do, double %.054.i.i.i.i.i51, double %.056.i.i.i.i.i50 ; 3 uses
  %.155.i.i.i.i.i53 = select i1 %i.do, double %.056.i.i.i.i.i50, double %.054.i.i.i.i.i51 ; 2 uses
  %i.dp = fcmp olt double %.157.i.i.i.i.i52, 1.000000e-146
  br i1 %i.dp, label %bb.n, label %bb.o

bb.n:                                             ; preds = %.preheader
  %i.dq = fcmp oeq double %.157.i.i.i.i.i52, 0.000000e+00
...
bb.o:                                             ; preds = %.preheader
  %i.dr = fcmp olt double %.155.i.i.i.i.i53, f0x5FB317E5EF3AB327
  br i1 %i.dr, label %bb.p, label %bb.q

bb.p:                                             ; preds = %bb.o
  %i.ds = fmul double %.157.i.i.i.i.i52, f0x3CD0028010000004
  %i.dt = fmul double %.155.i.i.i.i.i53, %i.ds    ; 2 uses
  %i.du = fcmp ule double %i.dh, %i.dt            ; 2 uses
  %i.dv = fneg double %i.dt
  %i.dw = fcmp uge double %i.dh, %i.dv
  %cond1.i.i.i.i.i55 = and i1 %i.du, %i.dw
  %.0.i.i.i.i.i56 = select i1 %i.du, i32 -1, i32 1
  br i1 %cond1.i.i.i.i.i55, label %bb.q, label %bb.v
...
bb.v:                                             ; preds = %bb.p, %bb.t, %bb.u
  %.3.i.i.i.i.i54 = phi i32 [ %.0.i.i.i.i.i56, %bb.p ], [ %i.gy, %bb.u ], [ %.sroa.0.0.extract.trunc.i.i, %bb.t ]
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #28
...
bb.o:                                             ; preds = %bb.k, %bb.l, %bb.m, %bb.n
  %.sroa.5.0.i.i.i = phi i64 [ 8589934591, %bb.n ], [ 4294967297, %bb.k ], [ -1, %bb.l ], [ 0, %bb.m ] ; 2 uses
  %.sroa.0.0.extract.trunc.i = trunc i64 %.sroa.5.0.i.i.i to i32 ; 2 uses
  %.sroa.2.0.extract.shift.i = lshr i64 %.sroa.5.0.i.i.i, 32
  %.sroa.2.0.extract.trunc.i = trunc nuw i64 %.sroa.2.0.extract.shift.i to i32
  %i.kz = icmp eq i32 %.sroa.0.0.extract.trunc.i, %.sroa.2.0.extract.trunc.i
  br i1 %i.kz, label %.thread, label %bb.p

.thread:                                          ; preds = %bb.o
  %i.la = icmp eq i32 %.sroa.0.0.extract.trunc.i, 1
  br label %bb.ek
...
bb.u:                                             ; preds = %bb.t
  ...
  invoke void @_ZNK4CGAL23CartesianKernelFunctors18Construct_vector_3INS_16Simple_cartesianIN5boost14multiprecision6numberINS4_8backends16rational_adaptorINS6_15cpp_int_backendILm0ELm0ELNS4_16cpp_integer_typeE1ELNS4_18cpp_int_check_typeE0ESaIyEEEEELNS4_26expression_template_optionE1EEEEEEclENS_15Return_base_tagERKNS_7Point_3ISG_EESM_(ptr dead_on_unwind nonnull writable sret(%"class.CGAL::VectorC3.417") align 16 %4, ptr noundef nonnull align 1 dereferenceable(1) %12, ptr noundef nonnull align 16 dereferenceable(192) %13, ptr noundef nonnull align 16 dereferenceable(192) %16)
          to label %.noexc73 unwind label %bb.cv
...
.noexc73:                                         ; preds = %bb.u
  ...
  %i.lo = load i64, ptr %i.ln, align 16, !tbaa !135, !noalias !1353 ; 2 uses
  store i64 %i.lo, ptr %i.lm, align 16, !tbaa !135, !alias.scope !1353
  %i.lp = getelementptr inbounds nuw i8, ptr %15, i64 24
  %i.lq = getelementptr inbounds nuw i8, ptr %4, i64 24
  %i.lr = load i8, ptr %i.lq, align 8, !tbaa !144, !range !13, !noalias !1353, !noundef !14
  store i8 %i.lr, ptr %i.lp, align 8, !tbaa !144, !alias.scope !1353
  %i.ls = getelementptr inbounds nuw i8, ptr %15, i64 25 ; 2 uses
  %i.lt = getelementptr inbounds nuw i8, ptr %4, i64 25
  %i.lu = load i8, ptr %i.lt, align 1, !tbaa !9, !range !13, !noalias !1353, !noundef !14 ; 2 uses
  store i8 %i.lu, ptr %i.ls, align 1, !tbaa !9, !alias.scope !1353
  %i.lv = getelementptr inbounds nuw i8, ptr %15, i64 26 ; 2 uses
  %i.lw = getelementptr inbounds nuw i8, ptr %4, i64 26
  %i.lx = load i8, ptr %i.lw, align 2, !tbaa !145, !range !13, !noalias !1353, !noundef !14
  store i8 %i.lx, ptr %i.lv, align 2, !tbaa !145, !alias.scope !1353
  %i.ly = trunc nuw i8 %i.lu to i1
  br i1 %i.ly, label %bb.v, label %bb.w

bb.v:                                             ; preds = %.noexc73
  %i.lz = shl i64 %i.lo, 3
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 dereferenceable(192) %15, ptr nonnull align 16 dereferenceable(192) %4, i64 %i.lz, i1 false)
...
_ZN5boost14multiprecision8backends12cpp_int_baseILm0ELm18446744073709551615ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyELb0EEC2EOS6_.exit.i.i.i: ; preds = %bb.w, %bb.v
  %i.ma = getelementptr inbounds nuw i8, ptr %15, i64 32 ; 4 uses
  %i.mb = getelementptr inbounds nuw i8, ptr %4, i64 32 ; 2 uses
  store i64 0, ptr %i.ma, align 16, !tbaa !146, !alias.scope !1353
  %i.mc = getelementptr inbounds nuw i8, ptr %15, i64 48
  %i.md = getelementptr inbounds nuw i8, ptr %4, i64 48
  %i.me = load i64, ptr %i.md, align 16, !tbaa !135, !noalias !1353 ; 2 uses
  store i64 %i.me, ptr %i.mc, align 16, !tbaa !135, !alias.scope !1353
  %i.mf = getelementptr inbounds nuw i8, ptr %15, i64 56
  %i.mg = getelementptr inbounds nuw i8, ptr %4, i64 56
  %i.mh = load i8, ptr %i.mg, align 8, !tbaa !144, !range !13, !noalias !1353, !noundef !14
  store i8 %i.mh, ptr %i.mf, align 8, !tbaa !144, !alias.scope !1353
  %i.mi = getelementptr inbounds nuw i8, ptr %15, i64 57 ; 2 uses
  %i.mj = getelementptr inbounds nuw i8, ptr %4, i64 57
  %i.mk = load i8, ptr %i.mj, align 1, !tbaa !9, !range !13, !noalias !1353, !noundef !14 ; 2 uses
  store i8 %i.mk, ptr %i.mi, align 1, !tbaa !9, !alias.scope !1353
  %i.ml = getelementptr inbounds nuw i8, ptr %15, i64 58 ; 2 uses
  %i.mm = getelementptr inbounds nuw i8, ptr %4, i64 58
  %i.mn = load i8, ptr %i.mm, align 2, !tbaa !145, !range !13, !noalias !1353, !noundef !14
  store i8 %i.mn, ptr %i.ml, align 2, !tbaa !145, !alias.scope !1353
  %i.mo = trunc nuw i8 %i.mk to i1
...
bb.x:                                             ; preds = %_ZN5boost14multiprecision8backends12cpp_int_baseILm0ELm18446744073709551615ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyELb0EEC2EOS6_.exit.i.i.i
  %i.mp = shl i64 %i.me, 3
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 dereferenceable(27) %i.ma, ptr nonnull align 16 dereferenceable(27) %i.mb, i64 %i.mp, i1 false)
...
bb.y:                                             ; preds = %_ZN5boost14multiprecision8backends12cpp_int_baseILm0ELm18446744073709551615ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyELb0EEC2EOS6_.exit.i.i.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(27) %i.ma, ptr noundef nonnull align 16 dereferenceable(27) %i.mb, i64 16, i1 false), !tbaa.struct !202
  br label %_ZN5boost14multiprecision8backends16rational_adaptorINS1_15cpp_int_backendILm0ELm0ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyEEEEC2EOS8_.exit.i.i

_ZN5boost14multiprecision8backends16rational_adaptorINS1_15cpp_int_backendILm0ELm0ELNS0_16cpp_integer_typeE1ELNS0_18cpp_int_check_typeE0ESaIyEEEEC2EOS8_.exit.i.i: ; preds = %bb.y, %bb.x
  %i.mq = getelementptr inbounds nuw i8, ptr %15, i64 64 ; 5 uses
  %i.mr = getelementptr inbounds nuw i8, ptr %4, i64 64
  store i64 0, ptr %i.mq, align 16, !tbaa !146, !alias.scope !1353
  %i.ms = getelementptr inbounds nuw i8, ptr %15, i64 80
  %i.mt = getelementptr inbounds nuw i8, ptr %4, i64 80
  %i.mu = load i64, ptr %i.mt, align 16, !tbaa !135, !noalias !1353 ; 2 uses
  store i64 %i.mu, ptr %i.ms, align 16, !tbaa !135, !alias.scope !1353
  %i.mv = getelementptr inbounds nuw i8, ptr %15, i64 88
  %i.mw = getelementptr inbounds nuw i8, ptr %4, i64 88
  %i.mx = load i8, ptr %i.mw, align 8, !tbaa !144, !range !13, !noalias !1353, !noundef !14
  store i8 %i.mx, ptr %i.mv, align 8, !tbaa !144, !alias.scope !1353
  %i.my = getelementptr inbounds nuw i8, ptr %15, i64 89 ; 2 uses
  %i.mz = getelementptr inbounds nuw i8, ptr %4, i64 89
  %i.na = load i8, ptr %i.mz, align 1, !tbaa !9, !range !13, !noalias !1353, !noundef !14 ; 2 uses
  store i8 %i.na, ptr %i.my, align 1, !tbaa !9, !alias.scope !1353
  %i.nb = getelementptr inbounds nuw i8, ptr %15, i64 90 ; 2 uses
  %i.nc = getelementptr inbounds nuw i8, ptr %4, i64 90
  %i.nd = load i8, ptr %i.nc, align 2, !tbaa !145, !range !13, !noalias !1353, !noundef !14
  store i8 %i.nd, ptr %i.nb, align 2, !tbaa !145, !alias.scope !1353
  %i.ne = trunc nuw i8 %i.na to i1
  %i.nf = shl i64 %i.mu, 3
  %.sink.i = select i1 %i.ne, i64 %i.nf, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 dereferenceable(64) %i.mq, ptr nonnull align 16 dereferenceable(64) %i.mr, i64 %.sink.i, i1 false)
  %i.ng = getelementptr inbounds nuw i8, ptr %15, i64 96 ; 3 uses
  %i.nh = getelementptr inbounds nuw i8, ptr %4, i64 96
  store i64 0, ptr %i.ng, align 16, !tbaa !146, !alias.scope !1353
  %i.ni = getelementptr inbounds nuw i8, ptr %15, i64 112
  %i.nj = getelementptr inbounds nuw i8, ptr %4, i64 112
  %i.nk = load i64, ptr %i.nj, align 16, !tbaa !135, !noalias !1353 ; 2 uses
  store i64 %i.nk, ptr %i.ni, align 16, !tbaa !135, !alias.scope !1353
  %i.nl = getelementptr inbounds nuw i8, ptr %15, i64 120
  %i.nm = getelementptr inbounds nuw i8, ptr %4, i64 120
  %i.nn = load i8, ptr %i.nm, align 8, !tbaa !144, !range !13, !noalias !1353, !noundef !14
  store i8 %i.nn, ptr %i.nl, align 8, !tbaa !144, !alias.scope !1353
  %i.no = getelementptr inbounds nuw i8, ptr %15, i64 121 ; 2 uses
  %i.np = getelementptr inbounds nuw i8, ptr %4, i64 121
  %i.nq = load i8, ptr %i.np, align 1, !tbaa !9, !range !13, !noalias !1353, !noundef !14 ; 2 uses
  store i8 %i.nq, ptr %i.no, align 1, !tbaa !9, !alias.scope !1353
  %i.nr = getelementptr inbounds nuw i8, ptr %15, i64 122 ; 2 uses
  %i.ns = getelementptr inbounds nuw i8, ptr %4, i64 122
  %i.nt = load i8, ptr %i.ns, align 2, !tbaa !145, !range !13, !noalias !1353, !noundef !14
  store i8 %i.nt, ptr %i.nr, align 2, !tbaa !145, !alias.scope !1353
  %i.nu = trunc nuw i8 %i.nq to i1
  %i.nv = shl i64 %i.nk, 3
  %.sink8.i = select i1 %i.nu, i64 %i.nv, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 dereferenceable(27) %i.ng, ptr nonnull align 16 dereferenceable(27) %i.nh, i64 %.sink8.i, i1 false)
  %i.nw = getelementptr inbounds nuw i8, ptr %15, i64 128 ; 5 uses
  %i.nx = getelementptr inbounds nuw i8, ptr %4, i64 128
  store i64 0, ptr %i.nw, align 16, !tbaa !146, !alias.scope !1353
  %i.ny = getelementptr inbounds nuw i8, ptr %15, i64 144
  %i.nz = getelementptr inbounds nuw i8, ptr %4, i64 144
  %i.oa = load i64, ptr %i.nz, align 16, !tbaa !135, !noalias !1353 ; 2 uses
  store i64 %i.oa, ptr %i.ny, align 16, !tbaa !135, !alias.scope !1353
  %i.ob = getelementptr inbounds nuw i8, ptr %15, i64 152
  %i.oc = getelementptr inbounds nuw i8, ptr %4, i64 152
  %i.od = load i8, ptr %i.oc, align 8, !tbaa !144, !range !13, !noalias !1353, !noundef !14
  store i8 %i.od, ptr %i.ob, align 8, !tbaa !144, !alias.scope !1353
  %i.oe = getelementptr inbounds nuw i8, ptr %15, i64 153 ; 2 uses
  %i.of = getelementptr inbounds nuw i8, ptr %4, i64 153
  %i.og = load i8, ptr %i.of, align 1, !tbaa !9, !range !13, !noalias !1353, !noundef !14 ; 2 uses
  store i8 %i.og, ptr %i.oe, align 1, !tbaa !9, !alias.scope !1353
  %i.oh = getelementptr inbounds nuw i8, ptr %15, i64 154 ; 2 uses
  %i.oi = getelementptr inbounds nuw i8, ptr %4, i64 154
  %i.oj = load i8, ptr %i.oi, align 2, !tbaa !145, !range !13, !noalias !1353, !noundef !14
  store i8 %i.oj, ptr %i.oh, align 2, !tbaa !145, !alias.scope !1353
  %i.ok = trunc nuw i8 %i.og to i1
  %i.ol = shl i64 %i.oa, 3
  %.sink9.i = select i1 %i.ok, i64 %i.ol, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 dereferenceable(64) %i.nw, ptr nonnull align 16 dereferenceable(64) %i.nx, i64 %.sink9.i, i1 false)
end_hunk_8
...
bb.f:                                             ; preds = %bb.e, %bb.d, %bb.c, %.noexc110
  ...
  %i.kk = icmp slt i32 %.sroa.3.0.extract.trunc.i.i.i, -1
  %i.kl = icmp sgt i32 %.sroa.0.0.extract.trunc.i.i.i, -1
  %or.cond.i.i.i = or i1 %i.kl, %i.kk
  %i.km = icmp eq i32 %.sroa.0.0.extract.trunc.i.i.i, %.sroa.3.0.extract.trunc.i.i.i
  %i.kn = zext i1 %i.km to i16
  %i.ko = or disjoint i16 %i.kn, 256
  %.sroa.4.0.i.i.i = select i1 %or.cond.i.i.i, i16 0, i16 %i.ko ; 3 uses
  ...
  %i.kp = trunc i16 %.sroa.4.0.i.i.i to i1
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b)
  call void @llvm.x86.sse.stmxcsr(ptr nonnull %i.a)
  %i.kq = load i32, ptr %i.a, align 4
  %i.kr = and i32 %i.kq, -24577
  %i.ks = or disjoint i32 %i.kr, %i.aw
...
bb.g:                                             ; preds = %bb.f
  %i.kt = invoke noundef zeroext i1 @_ZNK4CGAL24Filtered_predicate_RT_FTINS_23CartesianKernelFunctors31Less_signed_distance_to_plane_3INS_16Simple_cartesianINS_9cpp_floatEEEEENS2_INS3_IN5boost14multiprecision6numberINS8_8backends16rational_adaptorINSA_15cpp_int_backendILm0ELm0ELNS8_16cpp_integer_typeE1ELNS8_18cpp_int_check_typeE0ESaIyEEEEELNS8_26expression_template_optionE1EEEEEEENS2_INS3_INS_11Interval_ntILb0EEEEEEENS_19Cartesian_converterINS_21Type_equality_wrapperINS_27Cartesian_base_no_ref_countIdNS_5EpickEEEST_EES5_NS_12NT_converterIdS4_EEEENSQ_ISV_SK_NSW_IdSJ_EEEENSQ_ISV_SO_NSW_IdSN_EEEELb1EE4callIJNS_7Point_3IST_EES16_S16_S16_S16_ETnPNSt9enable_ifIXntsr22Call_operator_needs_FTIDpT_EE5valueEvE4typeELPv0EEEbDpRKS18_(ptr noundef nonnull align 1 dereferenceable(9) %3, ptr noundef nonnull align 8 dereferenceable(72) %4, ptr noundef nonnull align 8 dereferenceable(24) %i.q, ptr noundef nonnull align 8 dereferenceable(24) %i.r, ptr noundef nonnull align 8 dereferenceable(24) %i.at, ptr noundef nonnull align 8 dereferenceable(24) %i.au)
          to label %.noexc unwind label %bb.h

.noexc:                                           ; preds = %bb.f, %bb.g
  %.3.i = phi i1 [ %i.kp, %bb.f ], [ %i.kt, %bb.g ]
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #28
  %spec.select.i.i.i = select i1 %.3.i, ptr %i.as, ptr %.sroa.02.011.i.i.i ; 2 uses
  %i.ku = load ptr, ptr %i.as, align 8, !tbaa !286 ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.ku, %i.aj
...
.loopexit253:                                     ; preds = %.noexc, %.preheader.i.i.i, %_ZNSt7__cxx114listIN4CGAL7Point_3INS1_5EpickEEESaIS4_EE5clearEv.exit
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #28
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #28
  %i.kv = getelementptr inbounds nuw i8, ptr %.sroa.02.2.i.i.i, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %8, ptr noundef nonnull align 8 dereferenceable(24) %i.kv, i64 24, i1 false)
  %i.kw = getelementptr inbounds nuw i8, ptr %i.ai, i64 80 ; 2 uses
  %i.kx = load i64, ptr %i.kw, align 8, !tbaa !289
  %i.ky = add i64 %i.kx, -1
  store i64 %i.ky, ptr %i.kw, align 8, !tbaa !289
...
.lr.ph:                                           ; preds = %.preheader252, %bb.l
  ...
  %i.kz = getelementptr inbounds nuw i8, ptr %.sroa.0174.0272, i64 16 ; 3 uses
  %i.la = load ptr, ptr %i.kz, align 8, !tbaa !322 ; 3 uses
  %i.lb = getelementptr inbounds nuw i8, ptr %i.la, i64 64 ; 3 uses
  %i.lc = load ptr, ptr %i.lb, align 8, !tbaa !286 ; 2 uses
  %i.ld = icmp eq ptr %i.lc, %i.lb
  br i1 %i.ld, label %bb.j, label %_ZNSt7__cxx114listIN4CGAL7Point_3INS1_5EpickEEESaIS4_EE6spliceESt20_List_const_iteratorIS4_ERS6_S8_S8_.exit

_ZNSt7__cxx114listIN4CGAL7Point_3INS1_5EpickEEESaIS4_EE6spliceESt20_List_const_iteratorIS4_ERS6_S8_S8_.exit: ; preds = %.lr.ph
  %i.le = getelementptr inbounds nuw i8, ptr %i.la, i64 80 ; 2 uses
  %i.lf = load i64, ptr %i.le, align 8, !tbaa !287
  %i.lg = load i64, ptr %i.i, align 8, !tbaa !289
  %i.lh = add i64 %i.lg, %i.lf
  store i64 %i.lh, ptr %i.i, align 8, !tbaa !289
  store i64 0, ptr %i.le, align 8, !tbaa !289
  call void @_ZNSt8__detail15_List_node_base11_M_transferEPS0_S1_(ptr noundef nonnull align 8 dereferenceable(16) %6, ptr noundef %i.lc, ptr noundef nonnull %i.lb) #28
  %.pre308 = load ptr, ptr %i.kz, align 8, !tbaa !322
  br label %bb.j
...
bb.j:                                             ; preds = %_ZNSt7__cxx114listIN4CGAL7Point_3INS1_5EpickEEESaIS4_EE6spliceESt20_List_const_iteratorIS4_ERS6_S8_S8_.exit, %.lr.ph
  %i.lk = phi ptr [ %.pre308, %_ZNSt7__cxx114listIN4CGAL7Point_3INS1_5EpickEEESaIS4_EE6spliceESt20_List_const_iteratorIS4_ERS6_S8_S8_.exit ], [ %i.la, %.lr.ph ] ; 2 uses
  %i.ll = getelementptr inbounds nuw i8, ptr %i.lk, i64 56
  %i.lm = load ptr, ptr %i.ll, align 8, !tbaa !340 ; 3 uses
  %.not247 = icmp eq ptr %i.lm, %1
  br i1 %.not247, label %bb.l, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.ln = load i64, ptr %i.v, align 8, !tbaa !581
  %i.lo = add i64 %i.ln, -1
  store i64 %i.lo, ptr %i.v, align 8, !tbaa !581
  call void @_ZNSt8__detail15_List_node_base9_M_unhookEv(ptr noundef nonnull align 8 dereferenceable(16) %i.lm) #28
  call void @_ZdlPvm(ptr noundef nonnull %i.lm, i64 noundef 24) #38
  %.pre309 = load ptr, ptr %i.kz, align 8, !tbaa !322
  br label %bb.l

bb.l:                                             ; preds = %bb.k, %bb.j
  %i.lp = phi ptr [ %.pre309, %bb.k ], [ %i.lk, %bb.j ]
  %i.lq = getelementptr inbounds nuw i8, ptr %i.lp, i64 52
  store i32 0, ptr %i.lq, align 4, !tbaa !25
...
._crit_edge:                                      ; preds = %bb.l, %.preheader252
  %i.lr = load i64, ptr %i.n, align 8, !tbaa !1404 ; 3 uses
  %i.ls = icmp ugt i64 %i.lr, 576460752303423487
  br i1 %i.ls, label %bb.m, label %bb.n
...
_ZNSt6vectorISt4pairIN4CGAL8internal11CC_iteratorINS1_17Compact_containerINS1_23Convex_hull_face_base_2INS1_20Convex_hull_traits_3INS1_5EpickENS1_12Polyhedron_3IS7_NS1_18Polyhedron_items_3ENS1_18HalfedgeDS_defaultESaIiEEESt17integral_constantIbLb1EEEENS1_28Triangulation_ds_face_base_2INS1_30Triangulation_data_structure_2INS1_25Convex_hull_vertex_base_2INS1_11GT3_for_CH3ISF_EENS1_30Triangulation_ds_vertex_base_2IvEEEENS5_ISF_NSG_IvEEEEEEEEEENS1_7DefaultEST_ST_EELb0EEEiESaISW_EE7reserveEm.exit.thread: ; preds = %bb.n
  %i.lt = load ptr, ptr %i.l, align 8, !tbaa !1402 ; 4 uses
  %i.lu = getelementptr inbounds nuw i8, ptr %i.lt, i64 40
  %.sroa.0113.0.copyload217 = load ptr, ptr %i.lu, align 8 ; 3 uses
  %.sroa.12.0..sroa_idx218 = getelementptr inbounds nuw i8, ptr %i.lt, i64 48
  %.sroa.12.0.copyload219 = load i32, ptr %.sroa.12.0..sroa_idx218, align 8 ; 2 uses
  %.sroa.14.0..sroa_idx220 = getelementptr inbounds nuw i8, ptr %i.lt, i64 52
  %.sroa.14.0.copyload221 = load i32, ptr %.sroa.14.0..sroa_idx220, align 4 ; 2 uses
  %i.lv = getelementptr inbounds nuw i8, ptr %.sroa.0113.0.copyload217, i64 52
  store i32 0, ptr %i.lv, align 4, !tbaa !25
  %i.lw = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znwm(i64 noundef 16) #40
...
_ZNSt12_Vector_baseISt4pairIN4CGAL8internal11CC_iteratorINS1_17Compact_containerINS1_23Convex_hull_face_base_2INS1_20Convex_hull_traits_3INS1_5EpickENS1_12Polyhedron_3IS7_NS1_18Polyhedron_items_3ENS1_18HalfedgeDS_defaultESaIiEEESt17integral_constantIbLb1EEEENS1_28Triangulation_ds_face_base_2INS1_30Triangulation_data_structure_2INS1_25Convex_hull_vertex_base_2INS1_11GT3_for_CH3ISF_EENS1_30Triangulation_ds_vertex_base_2IvEEEENS5_ISF_NSG_IvEEEEEEEEEENS1_7DefaultEST_ST_EELb0EEEiESaISW_EE11_M_allocateEm.exit.i: ; preds = %bb.n
  %i.lx = shl nuw nsw i64 %i.lr, 4                ; 2 uses
  %i.ly = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.lx) #40
...
_ZNSt6vectorISt4pairIN4CGAL8internal11CC_iteratorINS1_17Compact_containerINS1_23Convex_hull_face_base_2INS1_20Convex_hull_traits_3INS1_5EpickENS1_12Polyhedron_3IS7_NS1_18Polyhedron_items_3ENS1_18HalfedgeDS_defaultESaIiEEESt17integral_constantIbLb1EEEENS1_28Triangulation_ds_face_base_2INS1_30Triangulation_data_structure_2INS1_25Convex_hull_vertex_base_2INS1_11GT3_for_CH3ISF_EENS1_30Triangulation_ds_vertex_base_2IvEEEENS5_ISF_NSG_IvEEEEEEEEEENS1_7DefaultEST_ST_EELb0EEEiESaISW_EE7reserveEm.exit: ; preds = %_ZNSt12_Vector_baseISt4pairIN4CGAL8internal11CC_iteratorINS1_17Compact_containerINS1_23Convex_hull_face_base_2INS1_20Convex_hull_traits_3INS1_5EpickENS1_12Polyhedron_3IS7_NS1_18Polyhedron_items_3ENS1_18HalfedgeDS_defaultESaIiEEESt17integral_constantIbLb1EEEENS1_28Triangulation_ds_face_base_2INS1_30Triangulation_data_structure_2INS1_25Convex_hull_vertex_base_2INS1_11GT3_for_CH3ISF_EENS1_30Triangulation_ds_vertex_base_2IvEEEENS5_ISF_NSG_IvEEEEEEEEEENS1_7DefaultEST_ST_EELb0EEEiESaISW_EE11_M_allocateEm.exit.i
  %i.lz = load ptr, ptr %i.l, align 8, !tbaa !1402 ; 4 uses
  %i.ma = getelementptr inbounds nuw i8, ptr %i.lz, i64 40
  %.sroa.0113.0.copyload = load ptr, ptr %i.ma, align 8 ; 3 uses
  %.sroa.12.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.lz, i64 48
  %.sroa.12.0.copyload = load i32, ptr %.sroa.12.0..sroa_idx, align 8 ; 2 uses
  %.sroa.14.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.lz, i64 52
  %.sroa.14.0.copyload = load i32, ptr %.sroa.14.0..sroa_idx, align 4 ; 2 uses
  %i.mb = getelementptr inbounds nuw i8, ptr %.sroa.0113.0.copyload, i64 52
  store i32 0, ptr %i.mb, align 4, !tbaa !25
  %i.mc = getelementptr inbounds nuw i8, ptr %i.ly, i64 %i.lx
  store ptr %.sroa.0113.0.copyload, ptr %i.ly, align 8
  %.sroa.12.0..sroa_idx120 = getelementptr inbounds nuw i8, ptr %i.ly, i64 8
  store i32 %.sroa.12.0.copyload, ptr %.sroa.12.0..sroa_idx120, align 8
  %.sroa.14.0..sroa_idx128 = getelementptr inbounds nuw i8, ptr %i.ly, i64 12
...
.noexc61:                                         ; preds = %_ZNSt6vectorISt4pairIN4CGAL8internal11CC_iteratorINS1_17Compact_containerINS1_23Convex_hull_face_base_2INS1_20Convex_hull_traits_3INS1_5EpickENS1_12Polyhedron_3IS7_NS1_18Polyhedron_items_3ENS1_18HalfedgeDS_defaultESaIiEEESt17integral_constantIbLb1EEEENS1_28Triangulation_ds_face_base_2INS1_30Triangulation_data_structure_2INS1_25Convex_hull_vertex_base_2INS1_11GT3_for_CH3ISF_EENS1_30Triangulation_ds_vertex_base_2IvEEEENS5_ISF_NSG_IvEEEEEEEEEENS1_7DefaultEST_ST_EELb0EEEiESaISW_EE7reserveEm.exit.thread
  store ptr %.sroa.0113.0.copyload217, ptr %i.lw, align 8
  %.sroa.12.0..sroa_idx122 = getelementptr inbounds nuw i8, ptr %i.lw, i64 8
  store i32 %.sroa.12.0.copyload219, ptr %.sroa.12.0..sroa_idx122, align 8
  %.sroa.14.0..sroa_idx130 = getelementptr inbounds nuw i8, ptr %i.lw, i64 12
  store i32 %.sroa.14.0.copyload221, ptr %.sroa.14.0..sroa_idx130, align 4
  %i.md = getelementptr inbounds nuw i8, ptr %i.lw, i64 16
  br label %_ZNSt6vectorISt4pairIN4CGAL8internal11CC_iteratorINS1_17Compact_containerINS1_23Convex_hull_face_base_2INS1_20Convex_hull_traits_3INS1_5EpickENS1_12Polyhedron_3IS7_NS1_18Polyhedron_items_3ENS1_18HalfedgeDS_defaultESaIiEEESt17integral_constantIbLb1EEEENS1_28Triangulation_ds_face_base_2INS1_30Triangulation_data_structure_2INS1_25Convex_hull_vertex_base_2INS1_11GT3_for_CH3ISF_EENS1_30Triangulation_ds_vertex_base_2IvEEEENS5_ISF_NSG_IvEEEEEEEEEENS1_7DefaultEST_ST_EELb0EEEiESaISW_EE9push_backERKSW_.exit
...
_ZNSt6vectorISt4pairIN4CGAL8internal11CC_iteratorINS1_17Compact_containerINS1_23Convex_hull_face_base_2INS1_20Convex_hull_traits_3INS1_5EpickENS1_12Polyhedron_3IS7_NS1_18Polyhedron_items_3ENS1_18HalfedgeDS_defaultESaIiEEESt17integral_constantIbLb1EEEENS1_28Triangulation_ds_face_base_2INS1_30Triangulation_data_structure_2INS1_25Convex_hull_vertex_base_2INS1_11GT3_for_CH3ISF_EENS1_30Triangulation_ds_vertex_base_2IvEEEENS5_ISF_NSG_IvEEEEEEEEEENS1_7DefaultEST_ST_EELb0EEEiESaISW_EE9push_backERKSW_.exit: ; preds = %.noexc61, %_ZNSt6vectorISt4pairIN4CGAL8internal11CC_iteratorINS1_17Compact_containerINS1_23Convex_hull_face_base_2INS1_20Convex_hull_traits_3INS1_5EpickENS1_12Polyhedron_3IS7_NS1_18Polyhedron_items_3ENS1_18HalfedgeDS_defaultESaIiEEESt17integral_constantIbLb1EEEENS1_28Triangulation_ds_face_base_2INS1_30Triangulation_data_structure_2INS1_25Convex_hull_vertex_base_2INS1_11GT3_for_CH3ISF_EENS1_30Triangulation_ds_vertex_base_2IvEEEENS5_ISF_NSG_IvEEEEEEEEEENS1_7DefaultEST_ST_EELb0EEEiESaISW_EE7reserveEm.exit
  ...
  %i.me = phi ptr [ %i.lt, %.noexc61 ], [ %i.lz, %_ZNSt6vectorISt4pairIN4CGAL8internal11CC_iteratorINS1_17Compact_containerINS1_23Convex_hull_face_base_2INS1_20Convex_hull_traits_3INS1_5EpickENS1_12Polyhedron_3IS7_NS1_18Polyhedron_items_3ENS1_18HalfedgeDS_defaultESaIiEEESt17integral_constantIbLb1EEEENS1_28Triangulation_ds_face_base_2INS1_30Triangulation_data_structure_2INS1_25Convex_hull_vertex_base_2INS1_11GT3_for_CH3ISF_EENS1_30Triangulation_ds_vertex_base_2IvEEEENS5_ISF_NSG_IvEEEEEEEEEENS1_7DefaultEST_ST_EELb0EEEiESaISW_EE7reserveEm.exit ]
  %.sroa.0138.5 = phi ptr [ %i.lw, %.noexc61 ], [ %i.ly, %_ZNSt6vectorISt4pairIN4CGAL8internal11CC_iteratorINS1_17Compact_containerINS1_23Convex_hull_face_base_2INS1_20Convex_hull_traits_3INS1_5EpickENS1_12Polyhedron_3IS7_NS1_18Polyhedron_items_3ENS1_18HalfedgeDS_defaultESaIiEEESt17integral_constantIbLb1EEEENS1_28Triangulation_ds_face_base_2INS1_30Triangulation_data_structure_2INS1_25Convex_hull_vertex_base_2INS1_11GT3_for_CH3ISF_EENS1_30Triangulation_ds_vertex_base_2IvEEEENS5_ISF_NSG_IvEEEEEEEEEENS1_7DefaultEST_ST_EELb0EEEiESaISW_EE7reserveEm.exit ] ; 4 uses
  %.sroa.28.5 = phi ptr [ %i.md, %.noexc61 ], [ %i.mc, %_ZNSt6vectorISt4pairIN4CGAL8internal11CC_iteratorINS1_17Compact_containerINS1_23Convex_hull_face_base_2INS1_20Convex_hull_traits_3INS1_5EpickENS1_12Polyhedron_3IS7_NS1_18Polyhedron_items_3ENS1_18HalfedgeDS_defaultESaIiEEESt17integral_constantIbLb1EEEENS1_28Triangulation_ds_face_base_2INS1_30Triangulation_data_structure_2INS1_25Convex_hull_vertex_base_2INS1_11GT3_for_CH3ISF_EENS1_30Triangulation_ds_vertex_base_2IvEEEENS5_ISF_NSG_IvEEEEEEEEEENS1_7DefaultEST_ST_EELb0EEEiESaISW_EE7reserveEm.exit ] ; 2 uses
  %i.mf = call noundef nonnull ptr @_ZSt28_Rb_tree_rebalance_for_erasePSt18_Rb_tree_node_baseRS_(ptr noundef nonnull %i.me, ptr noundef nonnull align 8 dereferenceable(32) %i.j) #28
  call void @_ZdlPvm(ptr noundef nonnull %i.mf, i64 noundef 56) #38
  %i.mg = load i64, ptr %i.n, align 8, !tbaa !1404
  %.sroa.15.0273 = getelementptr inbounds nuw i8, ptr %.sroa.0138.5, i64 16 ; 2 uses
  %storemerge274 = add i64 %i.mg, -1              ; 2 uses
  store i64 %storemerge274, ptr %i.n, align 8, !tbaa !1404
  %i.mh = icmp eq i64 %storemerge274, 0
  br i1 %i.mh, label %._crit_edge282, label %.lr.ph281
...
.lr.ph281:                                        ; preds = %_ZNSt6vectorISt4pairIN4CGAL8internal11CC_iteratorINS1_17Compact_containerINS1_23Convex_hull_face_base_2INS1_20Convex_hull_traits_3INS1_5EpickENS1_12Polyhedron_3IS7_NS1_18Polyhedron_items_3ENS1_18HalfedgeDS_defaultESaIiEEESt17integral_constantIbLb1EEEENS1_28Triangulation_ds_face_base_2INS1_30Triangulation_data_structure_2INS1_25Convex_hull_vertex_base_2INS1_11GT3_for_CH3ISF_EENS1_30Triangulation_ds_vertex_base_2IvEEEENS5_ISF_NSG_IvEEEEEEEEEENS1_7DefaultEST_ST_EELb0EEEiESaISW_EE9push_backERKSW_.exit, %_ZNSt6vectorISt4pairIN4CGAL8internal11CC_iteratorINS1_17Compact_containerINS1_23Convex_hull_face_base_2INS1_20Convex_hull_traits_3INS1_5EpickENS1_12Polyhedron_3IS7_NS1_18Polyhedron_items_3ENS1_18HalfedgeDS_defaultESaIiEEESt17integral_constantIbLb1EEEENS1_28Triangulation_ds_face_base_2INS1_30Triangulation_data_structure_2INS1_25Convex_hull_vertex_base_2INS1_11GT3_for_CH3ISF_EENS1_30Triangulation_ds_vertex_base_2IvEEEENS5_ISF_NSG_IvEEEEEEEEEENS1_7DefaultEST_ST_EELb0EEEiESaISW_EE9push_backERKSW_.exit81
  ...
  %.sroa.0113.0279 = phi ptr [ %i.mw, %_ZNSt6vectorISt4pairIN4CGAL8internal11CC_iteratorINS1_17Compact_containerINS1_23Convex_hull_face_base_2INS1_20Convex_hull_traits_3INS1_5EpickENS1_12Polyhedron_3IS7_NS1_18Polyhedron_items_3ENS1_18HalfedgeDS_defaultESaIiEEESt17integral_constantIbLb1EEEENS1_28Triangulation_ds_face_base_2INS1_30Triangulation_data_structure_2INS1_25Convex_hull_vertex_base_2INS1_11GT3_for_CH3ISF_EENS1_30Triangulation_ds_vertex_base_2IvEEEENS5_ISF_NSG_IvEEEEEEEEEENS1_7DefaultEST_ST_EELb0EEEiESaISW_EE9push_backERKSW_.exit81 ], [ %.sroa.0113.0.copyload227, %_ZNSt6vectorISt4pairIN4CGAL8internal11CC_iteratorINS1_17Compact_containerINS1_23Convex_hull_face_base_2INS1_20Convex_hull_traits_3INS1_5EpickENS1_12Polyhedron_3IS7_NS1_18Polyhedron_items_3ENS1_18HalfedgeDS_defaultESaIiEEESt17integral_constantIbLb1EEEENS1_28Triangulation_ds_face_base_2INS1_30Triangulation_data_structure_2INS1_25Convex_hull_vertex_base_2INS1_11GT3_for_CH3ISF_EENS1_30Triangulation_ds_vertex_base_2IvEEEENS5_ISF_NSG_IvEEEEEEEEEENS1_7DefaultEST_ST_EELb0EEEiESaISW_EE9push_backERKSW_.exit ]
end_hunk_9
...
bb.h:                                             ; preds = %.lr.ph, %.thread
  ...
  %i.br = extractelement <2 x double> %i.bp, i64 1 ; 3 uses
  %i.bs = fcmp ogt double %i.bq, %i.br            ; 2 uses
  %.157.i.i43 = select i1 %i.bs, double %i.br, double %i.bq ; 3 uses
  %.155.i.i44 = select i1 %i.bs, double %i.bq, double %i.br ; 2 uses
  %i.bt = fcmp olt double %.157.i.i43, 1.000000e-146
  br i1 %i.bt, label %bb.i, label %bb.j

bb.i:                                             ; preds = %bb.h
  %i.bu = fcmp oeq double %.157.i.i43, 0.000000e+00
  br i1 %i.bu, label %.thread, label %bb.l

bb.j:                                             ; preds = %bb.h
  %i.bv = fcmp olt double %.155.i.i44, f0x5FB317E5EF3AB327
  br i1 %i.bv, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  %i.bw = fmul double %.157.i.i43, f0x3CD0028010000004
  %i.bx = fmul double %.155.i.i44, %i.bw          ; 2 uses
  %i.by = fcmp ule double %i.bl, %i.bx            ; 2 uses
  %i.bz = fneg double %i.bx
  %i.ca = fcmp uge double %i.bl, %i.bz
  %cond1.i.i46 = and i1 %i.by, %i.ca
  %.0.i.i47 = select i1 %i.by, i32 -1, i32 1
  br i1 %cond1.i.i46, label %bb.l, label %bb.m
...
bb.m:                                             ; preds = %bb.k, %bb.l
  %.3.i.i45 = phi i32 [ %.0.i.i47, %bb.k ], [ %i.cb, %bb.l ]
...
.preheader:                                       ; preds = %bb.m, %.thread141
  ...
  %i.cu = extractelement <2 x double> %i.cs, i64 1 ; 3 uses
  %i.cv = fcmp ogt double %i.ct, %i.cu            ; 2 uses
  %.157.i.i52 = select i1 %i.cv, double %i.cu, double %i.ct ; 3 uses
  %.155.i.i53 = select i1 %i.cv, double %i.ct, double %i.cu ; 2 uses
  %i.cw = fcmp olt double %.157.i.i52, 1.000000e-146
  br i1 %i.cw, label %bb.n, label %bb.o

bb.n:                                             ; preds = %.preheader
  %i.cx = fcmp oeq double %.157.i.i52, 0.000000e+00
  br i1 %i.cx, label %.thread141, label %bb.q

bb.o:                                             ; preds = %.preheader
  %i.cy = fcmp olt double %.155.i.i53, f0x5FB317E5EF3AB327
  br i1 %i.cy, label %bb.p, label %bb.q

bb.p:                                             ; preds = %bb.o
  %i.cz = fmul double %.157.i.i52, f0x3CD0028010000004
  %i.da = fmul double %.155.i.i53, %i.cz          ; 2 uses
  %i.db = fcmp ule double %i.co, %i.da            ; 2 uses
  %i.dc = fneg double %i.da
  %i.dd = fcmp uge double %i.co, %i.dc
  %cond1.i.i55 = and i1 %i.db, %i.dd
  %.0.i.i56 = select i1 %i.db, i32 -1, i32 1
  br i1 %cond1.i.i55, label %bb.q, label %bb.v
...
bb.v:                                             ; preds = %bb.p, %bb.t, %bb.u
  %.3.i.i54 = phi i32 [ %.0.i.i56, %bb.p ], [ %i.gf, %bb.u ], [ %.sroa.0.0.extract.trunc.i.i, %bb.t ]
