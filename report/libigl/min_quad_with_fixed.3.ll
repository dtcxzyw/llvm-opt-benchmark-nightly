...
.lr.ph:                                           ; preds = %_ZNK5Eigen19ColPivHouseholderQRINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEEE4rankEv.exit.thread
  %.idx.i.i.i.i30 = mul i64 %i.bg, 24             ; 4 uses
  ...
  %3 = lshr exact i64 %i.bt, 3
  %4 = lshr exact i64 %i.bt, 3
...
bb.b:                                             ; preds = %.lr.ph, %_ZN5Eigen9DenseBaseINS_5BlockINS1_INS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi3ELi1ELb1EEELin1ELi1ELb0EEEE4swapIS5_EEvRKNS0_IT_EE.exit49
  ...
  %.0163 = phi i64 [ %i.bg, %.lr.ph ], [ %i.hr, %_ZN5Eigen9DenseBaseINS_5BlockINS1_INS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi3ELi1ELb1EEELin1ELi1ELb0EEEE4swapIS5_EEvRKNS0_IT_EE.exit49 ] ; 20 uses
  %i.bw = mul i64 %.0163, 24
  %scevgep212 = getelementptr i8, ptr %0, i64 %i.bw
  %i.bx = add i64 %3, %indvar
  %.lobit = and i64 %i.bx, 1                      ; 2 uses
  ...
  %i.ch = mul i64 %.0163, 24
  %scevgep = getelementptr i8, ptr %0, i64 %i.ch
  %i.ci = sub i64 %.lcssa, %indvar                ; 2 uses
  %i.cj = add i64 %4, %indvar
  %.lobit235 = and i64 %i.cj, 1
