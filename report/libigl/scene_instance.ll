...
.lr.ph:                                           ; preds = %_ZN6embree16MotionDerivativeC2ERKNS_28MotionDerivativeCoefficientsEiRKNS_6Vec3faES6_.exit
  ...
  %i.cp = load <4 x float>, ptr %3, align 16      ; 4 uses
  ...
  %18 = fneg float %.sroa.1194.60.vec.extract
  %19 = insertelement <2 x i1> poison, i1 %i.do, i64 0
  %20 = shufflevector <2 x i1> %19, <2 x i1> poison, <2 x i32> zeroinitializer
  %21 = fneg <4 x float> %i.cp
  %22 = shufflevector <4 x float> %21, <4 x float> poison, <2 x i32> <i32 poison, i32 3>
  %23 = insertelement <2 x float> %22, float %18, i64 0
  %24 = shufflevector <4 x float> %i.cs, <4 x float> %i.cp, <2 x i32> <i32 3, i32 7>
  %i.dp = select <2 x i1> %20, <2 x float> %23, <2 x float> %24 ; 2 uses
...
.lr.ph750:                                        ; preds = %bb.g
  ...
  %i.fx = load <4 x float>, ptr %3, align 16      ; 4 uses
  ...
  %25 = fneg float %.sroa.11.60.vec.extract
  %26 = insertelement <2 x i1> poison, i1 %i.gw, i64 0
  %27 = shufflevector <2 x i1> %26, <2 x i1> poison, <2 x i32> zeroinitializer
  %28 = fneg <4 x float> %i.fx
  %29 = shufflevector <4 x float> %28, <4 x float> poison, <2 x i32> <i32 poison, i32 3>
  %30 = insertelement <2 x float> %29, float %25, i64 0
  %31 = shufflevector <4 x float> %i.ga, <4 x float> %i.fx, <2 x i32> <i32 3, i32 7>
  %i.gx = select <2 x i1> %27, <2 x float> %30, <2 x float> %31 ; 2 uses
