...
begin_hunk_0_@_ZNK6embree8Instance15nonlinearBoundsERKNS_4BBoxIfEES4_f:bb.a
  ...
  %i.cqt = fadd <4 x float> %.sroa.0179.03891.us, %i.cqq ; 2 uses
  %i.cqu = fadd <4 x float> %.sroa.0136.03893.us, %i.cqq ; 2 uses
  %i.cqv = fadd <4 x float> %.sroa.44201.03890.us, %i.cqs ; 2 uses
  %i.cqw = fadd <4 x float> %.sroa.44.03892.us, %i.cqs ; 2 uses
...
_ZNK6embree8Instance6boundsEmm.exit:              ; preds = %_ZNK6embree8Instance6boundsEmm.exit.preheader, %_ZNK6embree8Instance6boundsEmm.exit
  ...
  %.sroa.0136.03893 = phi <4 x float> [ %i.cvo, %_ZNK6embree8Instance6boundsEmm.exit ], [ %.sroa.0136.1, %_ZNK6embree8Instance6boundsEmm.exit.preheader ] ; 2 uses
  %.sroa.44.03892 = phi <4 x float> [ %i.cvq, %_ZNK6embree8Instance6boundsEmm.exit ], [ %.sroa.44.1, %_ZNK6embree8Instance6boundsEmm.exit.preheader ] ; 2 uses
  %.sroa.0179.03891 = phi <4 x float> [ %i.cvn, %_ZNK6embree8Instance6boundsEmm.exit ], [ %.sroa.0179.1, %_ZNK6embree8Instance6boundsEmm.exit.preheader ] ; 2 uses
  %.sroa.44201.03890 = phi <4 x float> [ %i.cvp, %_ZNK6embree8Instance6boundsEmm.exit ], [ %.sroa.44201.1, %_ZNK6embree8Instance6boundsEmm.exit.preheader ] ; 2 uses
  ...
  %i.csz = fmul <4 x float> %.sroa.0136.03893, %i.csy
  %i.cta = fmul <4 x float> %.sroa.44.03892, %i.csy
  ...
  %i.ctg = fmul <4 x float> %.sroa.0179.03891, %i.ctf
  %i.cth = fadd <4 x float> %i.csz, %i.ctg
  %i.cti = fmul <4 x float> %.sroa.44201.03890, %i.ctf
  ...
  %i.cvn = fadd <4 x float> %.sroa.0179.03891, %i.cvk ; 2 uses
  %i.cvo = fadd <4 x float> %.sroa.0136.03893, %i.cvk ; 2 uses
  %i.cvp = fadd <4 x float> %.sroa.44201.03890, %i.cvm ; 2 uses
  %i.cvq = fadd <4 x float> %.sroa.44.03892, %i.cvm ; 2 uses
