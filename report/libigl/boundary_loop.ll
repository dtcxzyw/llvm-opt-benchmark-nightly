...
bb.l:                                             ; preds = %bb.k
  ...
  %.not235 = icmp eq i64 %i.bz, %i.cb
  br i1 %.not235, label %._crit_edge234, label %.lr.ph

.preheader:                                       ; preds = %_ZNSt3setIiSt4lessIiESaIiEE6insertESt23_Rb_tree_const_iteratorIiEOi.exit
  %i.cc = icmp eq i64 %i.dz, 0
  br i1 %i.cc, label %._crit_edge234, label %.lr.ph233
...
.lr.ph:                                           ; preds = %bb.l, %_ZNSt3setIiSt4lessIiESaIiEE6insertESt23_Rb_tree_const_iteratorIiEOi.exit
  ...
  %.056225 = phi i64 [ %i.ea, %_ZNSt3setIiSt4lessIiESaIiEE6insertESt23_Rb_tree_const_iteratorIiEOi.exit ], [ 0, %bb.l ] ; 5 uses
  %i.cr = sdiv i64 %.056225, 64
  %i.cs = getelementptr inbounds [8 x i8], ptr %i.cn, i64 %i.cr
  %i.ct = and i64 %.056225, -9223372036854775745
...
bb.o:                                             ; preds = %.lr.ph
  %i.cz = trunc i64 %.056225 to i32               ; 5 uses
...
.noexc79:                                         ; preds = %_ZNSt8_Rb_treeIiiSt9_IdentityIiESt4lessIiESaIiEE10_M_insert_IiNS5_11_Alloc_nodeEEESt17_Rb_tree_iteratorIiEPSt18_Rb_tree_node_baseSB_OT_RT0_.exit.i.i.i
  ...
  %.pre250 = load i32, ptr %i.bs, align 8, !tbaa !64
  %.pre251 = load ptr, ptr %7, align 8, !tbaa !61
...
_ZNSt3setIiSt4lessIiESaIiEE6insertESt23_Rb_tree_const_iteratorIiEOi.exit: ; preds = %bb.s, %.noexc79, %.lr.ph
  %i.dw = phi ptr [ %i.cn, %bb.s ], [ %.pre251, %.noexc79 ], [ %i.cn, %.lr.ph ] ; 2 uses
  %i.dx = phi i32 [ %i.co, %bb.s ], [ %.pre250, %.noexc79 ], [ %i.co, %.lr.ph ] ; 2 uses
  %i.dy = phi ptr [ %i.cp, %bb.s ], [ %.pre, %.noexc79 ], [ %i.cp, %.lr.ph ] ; 2 uses
  %i.dz = phi i64 [ %i.cq, %bb.s ], [ %i.du, %.noexc79 ], [ %i.cq, %.lr.ph ] ; 2 uses
  %i.ea = add nuw i64 %.056225, 1                 ; 2 uses
...
bb.v:                                             ; preds = %.lr.ph233, %_ZNSt6vectorIiSaIiEED2Ev.exit
  %.0232 = phi i32 [ undef, %.lr.ph233 ], [ %.2.lcssa306310, %_ZNSt6vectorIiSaIiEED2Ev.exit ] ; 2 uses
...
_ZNSt6vectorIiSaIiEE9push_backERKi.exit:          ; preds = %bb.w, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i
  ...
  br i1 %i.go, label %.thread, label %.lr.ph228

.lr.ph228:                                        ; preds = %_ZNSt6vectorIiSaIiEE9push_backERKi.exit, %.loopexit
  %i.gp = phi i64 [ %i.mr, %.loopexit ], [ %i.gm, %_ZNSt6vectorIiSaIiEE9push_backERKi.exit ]
  %i.gq = phi ptr [ %i.mn, %.loopexit ], [ %i.gi, %_ZNSt6vectorIiSaIiEE9push_backERKi.exit ]
  %i.gr = phi i32 [ %i.mh, %.loopexit ], [ %i.gc, %_ZNSt6vectorIiSaIiEE9push_backERKi.exit ] ; 3 uses
  %i.gs = phi i64 [ %i.me, %.loopexit ], [ %i.fz, %_ZNSt6vectorIiSaIiEE9push_backERKi.exit ] ; 5 uses
  %i.gt = phi i64 [ %i.md, %.loopexit ], [ %i.fy, %_ZNSt6vectorIiSaIiEE9push_backERKi.exit ]
  %i.gu = phi ptr [ %i.mb, %.loopexit ], [ %i.fw, %_ZNSt6vectorIiSaIiEE9push_backERKi.exit ] ; 3 uses
  %i.gv = phi ptr [ %i.ma, %.loopexit ], [ %i.fv, %_ZNSt6vectorIiSaIiEE9push_backERKi.exit ] ; 3 uses
  %.1230333 = phi i32 [ %.3, %.loopexit ], [ %.0232, %_ZNSt6vectorIiSaIiEE9push_backERKi.exit ]
  ...
  %min.iters.check356 = icmp ugt i64 %i.gy, 8
  %ident.check.not = icmp eq i64 %i.gz, 1
  %or.cond = select i1 %min.iters.check356, i1 %ident.check.not, i1 false
  %n.vec358 = and i64 %i.hd, -8                   ; 3 uses
  %i.he = or disjoint i64 %n.vec358, 1
  %cmp.n370 = icmp eq i64 %i.hd, %n.vec358
  br label %bb.ab
...
bb.ab:                                            ; preds = %.lr.ph228, %.critedge
  %indvars.iv = phi i64 [ 0, %.lr.ph228 ], [ %indvars.iv.next, %.critedge ] ; 2 uses
  %.2226 = phi i32 [ %.1230333, %.lr.ph228 ], [ %.3, %.critedge ] ; 3 uses
...
.lr.ph.i.i.i.i87.preheader:                       ; preds = %bb.ab
  br i1 %or.cond, label %vector.ph357, label %.lr.ph.i.i.i.i87.preheader373

vector.ph357:                                     ; preds = %.lr.ph.i.i.i.i87.preheader
  %broadcast.splatinsert359 = insertelement <4 x i32> poison, i32 %i.hj, i64 0
...
vector.body361:                                   ; preds = %vector.body361, %vector.ph357
  %index362 = phi i64 [ 0, %vector.ph357 ], [ %index.next367, %vector.body361 ] ; 2 uses
  %vec.phi363 = phi <4 x i32> [ %broadcast.splat360, %vector.ph357 ], [ %i.hn, %vector.body361 ]
  %vec.phi364 = phi <4 x i32> [ %broadcast.splat360, %vector.ph357 ], [ %i.ho, %vector.body361 ]
  %i.hk = getelementptr [4 x i8], ptr %i.hi, i64 %index362 ; 2 uses
  %i.hl = getelementptr i8, ptr %i.hk, i64 4
  %i.hm = getelementptr i8, ptr %i.hk, i64 20
  %wide.load365 = load <4 x i32>, ptr %i.hl, align 4, !tbaa !19
  %wide.load366 = load <4 x i32>, ptr %i.hm, align 4, !tbaa !19
  %i.hn = call <4 x i32> @llvm.smin.v4i32(<4 x i32> %wide.load365, <4 x i32> %vec.phi363) ; 2 uses
  %i.ho = call <4 x i32> @llvm.smin.v4i32(<4 x i32> %wide.load366, <4 x i32> %vec.phi364) ; 2 uses
  %index.next367 = add nuw i64 %index362, 8       ; 2 uses
  %i.hp = icmp eq i64 %index.next367, %n.vec358
  br i1 %i.hp, label %middle.block368, label %vector.body361, !llvm.loop !72

middle.block368:                                  ; preds = %vector.body361
  %rdx.minmax369 = call <4 x i32> @llvm.smin.v4i32(<4 x i32> %i.hn, <4 x i32> %i.ho)
  %i.hq = call i32 @llvm.vector.reduce.smin.v4i32(<4 x i32> %rdx.minmax369) ; 2 uses
  br i1 %cmp.n370, label %_ZNK5Eigen9DenseBaseINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEE8minCoeffEv.exit, label %.lr.ph.i.i.i.i87.preheader373

.lr.ph.i.i.i.i87.preheader373:                    ; preds = %.lr.ph.i.i.i.i87.preheader, %middle.block368
  %.01722.i.i.i.i.ph = phi i64 [ 1, %.lr.ph.i.i.i.i87.preheader ], [ %i.he, %middle.block368 ] ; 4 uses
  %.02021.i.i.i.i.ph = phi i32 [ %i.hj, %.lr.ph.i.i.i.i87.preheader ], [ %i.hq, %middle.block368 ] ; 2 uses
...
.lr.ph.i.i.i.i87.prol:                            ; preds = %.lr.ph.i.i.i.i87.preheader373, %.lr.ph.i.i.i.i87.prol
  %.01722.i.i.i.i.prol = phi i64 [ %i.hw, %.lr.ph.i.i.i.i87.prol ], [ %.01722.i.i.i.i.ph, %.lr.ph.i.i.i.i87.preheader373 ] ; 2 uses
  %.02021.i.i.i.i.prol = phi i32 [ %i.hv, %.lr.ph.i.i.i.i87.prol ], [ %.02021.i.i.i.i.ph, %.lr.ph.i.i.i.i87.preheader373 ]
  %prol.iter = phi i64 [ %prol.iter.next, %.lr.ph.i.i.i.i87.prol ], [ 0, %.lr.ph.i.i.i.i87.preheader373 ]
...
.lr.ph.i.i.i.i87.prol.loopexit:                   ; preds = %.lr.ph.i.i.i.i87.prol, %.lr.ph.i.i.i.i87.preheader373
  %.lcssa376.unr = phi i32 [ poison, %.lr.ph.i.i.i.i87.preheader373 ], [ %i.hv, %.lr.ph.i.i.i.i87.prol ]
  %.01722.i.i.i.i.unr = phi i64 [ %.01722.i.i.i.i.ph, %.lr.ph.i.i.i.i87.preheader373 ], [ %i.hw, %.lr.ph.i.i.i.i87.prol ]
  %.02021.i.i.i.i.unr = phi i32 [ %.02021.i.i.i.i.ph, %.lr.ph.i.i.i.i87.preheader373 ], [ %i.hv, %.lr.ph.i.i.i.i87.prol ]
...
_ZNK5Eigen9DenseBaseINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEE8minCoeffEv.exit: ; preds = %.lr.ph.i.i.i.i87.prol.loopexit, %.lr.ph.i.i.i.i87, %middle.block368, %bb.ab
  %.020.lcssa.i.i.i.i = phi i32 [ %i.hj, %bb.ab ], [ %i.hq, %middle.block368 ], [ %.lcssa376.unr, %.lr.ph.i.i.i.i87.prol.loopexit ], [ %i.ir, %.lr.ph.i.i.i.i87 ]
...
bb.ad:                                            ; preds = %bb.ac
  ...
  %spec.select191 = select i1 %i.jz, i32 %i.jl, i32 %.2226
  br label %.critedge
...
.critedge:                                        ; preds = %bb.ad, %bb.ac, %_ZNK5Eigen9DenseBaseINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEE8minCoeffEv.exit
  %.3 = phi i32 [ %.2226, %_ZNK5Eigen9DenseBaseINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEE8minCoeffEv.exit ], [ %.2226, %bb.ac ], [ %spec.select191, %bb.ad ] ; 12 uses
  %.259 = phi i1 [ false, %_ZNK5Eigen9DenseBaseINS_5BlockINS_6MatrixIiLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEEE8minCoeffEv.exit ], [ false, %bb.ac ], [ %i.jz, %bb.ad ] ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.ka = icmp samesign uge i64 %indvars.iv.next, %i.hc
  %.not62 = select i1 %i.ka, i1 true, i1 %.259
...
bb.af:                                            ; preds = %bb.ae
  store i32 %.3, ptr %i.gv, align 4, !tbaa !19
...
.noexc101:                                        ; preds = %_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc.exit.i.i94
  ...
  store i32 %.3, ptr %i.kk, align 4, !tbaa !19
...
.lr.ph.i.i.i155:                                  ; preds = %bb.al, %.lr.ph.i.i.i155
  ...
  %i.lb = icmp slt i32 %i.la, %.3                 ; 2 uses
...
.lr.ph.i25.i.i:                                   ; preds = %_ZNSt8_Rb_treeIiiSt9_IdentityIiESt4lessIiESaIiEE14_M_lower_boundEPSt13_Rb_tree_nodeIiEPSt18_Rb_tree_node_baseRKi.exit.i.i, %.lr.ph.i25.i.i
  ...
  %i.le = icmp slt i32 %.3, %i.ld                 ; 2 uses
...
.loopexit:                                        ; preds = %.lr.ph.i2.i, %_ZNSt8_Rb_treeIiiSt9_IdentityIiESt4lessIiESaIiEE5clearEv.exit.i.i, %.critedge.i.i
  ...
  br i1 %i.mt, label %.thread, label %.lr.ph228, !llvm.loop !82

.thread:                                          ; preds = %._crit_edge, %.loopexit, %_ZNSt6vectorIiSaIiEE9push_backERKi.exit
  %.2.lcssa306310 = phi i32 [ %.0232, %_ZNSt6vectorIiSaIiEE9push_backERKi.exit ], [ %.3, %.loopexit ], [ %.3, %._crit_edge ]
...
._ZNSt6vectorIS_IiSaIiEESaIS1_EE9push_backERKS1_.exit_crit_edge: ; preds = %bb.au
  %.pre252 = load ptr, ptr %9, align 8, !tbaa !16
  br label %_ZNSt6vectorIS_IiSaIiEESaIS1_EE9push_backERKS1_.exit
...
_ZNSt6vectorIS_IiSaIiEESaIS1_EE9push_backERKS1_.exit: ; preds = %._ZNSt6vectorIS_IiSaIiEESaIS1_EE9push_backERKS1_.exit_crit_edge, %_ZNSt6vectorIiSaIiEEC2ERKS1_.exit.i
  %i.ns = phi ptr [ %.pre252, %._ZNSt6vectorIS_IiSaIiEESaIS1_EE9push_backERKS1_.exit_crit_edge ], [ %i.nh, %_ZNSt6vectorIiSaIiEEC2ERKS1_.exit.i ] ; 3 uses
...
_ZNSt6vectorIiSaIiEED2Ev.exit:                    ; preds = %_ZNSt6vectorIS_IiSaIiEESaIS1_EE9push_backERKS1_.exit, %bb.av
  ...
  br i1 %i.ny, label %._crit_edge234, label %bb.v, !llvm.loop !86
...
._crit_edge234:                                   ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit, %bb.l, %.preheader
...
_ZNSt3setIiSt4lessIiESaIiEED2Ev.exit:             ; preds = %._crit_edge234
