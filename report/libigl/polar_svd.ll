...
.loopexit706:                                     ; preds = %._crit_edge777.split.split.us.us.us, %._crit_edge777.split.split.us799, %._crit_edge777.split.us.us.us, %.preheader705
  ...
  br i1 %i.af, label %bb.b, label %._crit_edge809, !llvm.loop !928
...
.preheader699.lr.ph.split:                        ; preds = %.preheader700
  ...
  %i.ak = load ptr, ptr %1, align 8, !tbaa !929   ; 2 uses
  %i.al = load i64, ptr %i.ai, align 8, !tbaa !931 ; 8 uses
...
.lr.ph817.us.us.new:                              ; preds = %.lr.ph817.us.us, %.lr.ph817.us.us.new
  ...
  %i.ay = load double, ptr %i.ax, align 8, !tbaa !27
  %i.az = load <4 x double>, ptr %.0229814.us.us, align 8, !tbaa !27
  ...
  %i.bh = load double, ptr %i.bg, align 8, !tbaa !27
  %i.bi = load <4 x double>, ptr %i.be, align 8, !tbaa !27
  ...
  br i1 %niter.ncmp.1, label %._crit_edge818.us.us.unr-lcssa, label %.lr.ph817.us.us.new, !llvm.loop !932
...
.epil.preheader:                                  ; preds = %._crit_edge818.us.us.unr-lcssa, %.lr.ph817.us.us
  ...
  %i.bq = load double, ptr %i.bp, align 8, !tbaa !27
  %i.br = load <4 x double>, ptr %.0229814.us.us.epil.init, align 8, !tbaa !27
...
._crit_edge818.us.us:                             ; preds = %._crit_edge818.us.us.unr-lcssa, %.epil.preheader
  ...
  store double %i.ca, ptr %i.bx, align 8, !tbaa !27
  ...
  store double %i.ce, ptr %i.cb, align 8, !tbaa !27
  ...
  store double %i.cm, ptr %i.cj, align 8, !tbaa !27
  %i.cn = add nsw i64 %.0230825.us.us, 1          ; 2 uses
  %exitcond891.not = icmp eq i64 %i.cn, %4
  br i1 %exitcond891.not, label %._crit_edge827.split.us.us, label %.lr.ph817.us.us, !llvm.loop !933

._crit_edge827.split.us.us:                       ; preds = %._crit_edge818.us.us
  %i.co = add nuw nsw i64 %.0231828.us, 4         ; 2 uses
  %i.cp = icmp slt i64 %i.co, %i.d
  br i1 %i.cp, label %.preheader699.us, label %.preheader698, !llvm.loop !934
...
.lr.ph759.us.us.us:                               ; preds = %._crit_edge770.us.us.us, %.preheader703.us.us
  ...
  %i.cu = load ptr, ptr %1, align 8, !tbaa !929
  %i.cv = load i64, ptr %i.z, align 8, !tbaa !931
...
bb.c:                                             ; preds = %bb.c, %.lr.ph759.us.us.us
  ...
  tail call void asm sideeffect "#begin gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !935
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !936
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !937
  %i.da = load <2 x double>, ptr %.0235755.us.us.us, align 16, !tbaa !35
  %i.db = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 16
  %i.dc = load <2 x double>, ptr %i.db, align 16, !tbaa !35
  %i.dd = load double, ptr %.0234756.us.us.us, align 8, !tbaa !27
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !938
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !939
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !940
  %i.dk = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 32
  %i.dl = load <2 x double>, ptr %i.dk, align 16, !tbaa !35
  %i.dm = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 48
  %i.dn = load <2 x double>, ptr %i.dm, align 16, !tbaa !35
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !941
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !942
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !943
  %i.dw = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 64
  %i.dx = load <2 x double>, ptr %i.dw, align 16, !tbaa !35
  %i.dy = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 80
  %i.dz = load <2 x double>, ptr %i.dy, align 16, !tbaa !35
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !944
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !945
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !946
  %i.ei = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 96
  %i.ej = load <2 x double>, ptr %i.ei, align 16, !tbaa !35
  %i.ek = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 112
  %i.el = load <2 x double>, ptr %i.ek, align 16, !tbaa !35
  %i.em = getelementptr inbounds nuw i8, ptr %.0234756.us.us.us, i64 24
  %i.en = load double, ptr %i.em, align 8, !tbaa !27
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !947
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !948
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !949
  %i.eu = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 128
  %i.ev = load <2 x double>, ptr %i.eu, align 16, !tbaa !35
  %i.ew = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 144
  %i.ex = load <2 x double>, ptr %i.ew, align 16, !tbaa !35
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !950
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !951
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !952
  %i.fg = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 160
  %i.fh = load <2 x double>, ptr %i.fg, align 16, !tbaa !35
  %i.fi = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 176
  %i.fj = load <2 x double>, ptr %i.fi, align 16, !tbaa !35
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !953
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !954
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !955
  %i.fs = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 192
  %i.ft = load <2 x double>, ptr %i.fs, align 16, !tbaa !35
  %i.fu = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 208
  %i.fv = load <2 x double>, ptr %i.fu, align 16, !tbaa !35
  %i.fw = getelementptr inbounds nuw i8, ptr %.0234756.us.us.us, i64 48
  %i.fx = load double, ptr %i.fw, align 8, !tbaa !27
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !956
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !957
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !958
  %i.ge = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 224
  %i.gf = load <2 x double>, ptr %i.ge, align 16, !tbaa !35
  %i.gg = getelementptr inbounds nuw i8, ptr %.0235755.us.us.us, i64 240
  %i.gh = load <2 x double>, ptr %i.gg, align 16, !tbaa !35
  %i.gi = getelementptr inbounds nuw i8, ptr %.0234756.us.us.us, i64 56
  %i.gj = load double, ptr %i.gi, align 8, !tbaa !27
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !959
  ...
  tail call void asm sideeffect "#end gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !960
  %i.gs = add nuw nsw i64 %.0233757.us.us.us, 8   ; 2 uses
  %i.gt = icmp slt i64 %i.gs, %i.s
  br i1 %i.gt, label %bb.c, label %..preheader701_crit_edge.us.us.us, !llvm.loop !961
...
.lr.ph769.us.us.us:                               ; preds = %..preheader701_crit_edge.us.us.us, %.lr.ph769.us.us.us
  ...
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !962
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !963
  %i.gu = load <2 x double>, ptr %.1236766.us.us.us, align 16, !tbaa !35
  %i.gv = getelementptr inbounds nuw i8, ptr %.1236766.us.us.us, i64 16
  %i.gw = load <2 x double>, ptr %i.gv, align 16, !tbaa !35
  %i.gx = load double, ptr %.1767.us.us.us, align 8, !tbaa !27
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX1", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !964
  ...
  br i1 %i.hh, label %.lr.ph769.us.us.us, label %._crit_edge770.us.us.us, !llvm.loop !965
...
begin_hunk_1_@_ZN5Eigen8internal11gebp_kernelIddlNS0_16blas_data_mapperIdlLi0ELi0ELi1EEELi4ELi4ELb0ELb0EEclERKS3_PKdS8_llldllll:bb.a
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !983
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !984
  %i.sz = getelementptr inbounds nuw i8, ptr %.0243715, i64 224
  %i.ta = load <2 x double>, ptr %i.sz, align 16, !tbaa !35 ; 4 uses
  %i.tb = getelementptr inbounds nuw i8, ptr %.0243715, i64 240
  %i.tc = load <2 x double>, ptr %i.tb, align 16, !tbaa !35 ; 4 uses
  %i.td = getelementptr inbounds nuw i8, ptr %.0241716, i64 224
  %i.te = load <4 x i32>, ptr %i.td, align 16, !tbaa !35 ; 2 uses
  %i.tf = getelementptr inbounds nuw i8, ptr %.0241716, i64 240
  %i.tg = load <4 x i32>, ptr %i.tf, align 16, !tbaa !35 ; 2 uses
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !985
  ...
  tail call void asm sideeffect "#end gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !986
  %i.uh = add nuw nsw i64 %.0240717, 8            ; 2 uses
  %i.ui = icmp slt i64 %i.uh, %i.s
  br i1 %i.ui, label %.lr.ph, label %.preheader702, !llvm.loop !987
...
._crit_edge:                                      ; preds = %.lr.ph738, %.preheader702
  ...
  %i.uj = load <2 x double>, ptr %i.jy, align 1, !tbaa !35
  %i.uk = getelementptr inbounds nuw i8, ptr %i.jy, i64 16 ; 2 uses
  %i.ul = load <2 x double>, ptr %i.uk, align 1, !tbaa !35
  %i.um = load <2 x double>, ptr %i.ka, align 1, !tbaa !35
  %i.un = getelementptr inbounds nuw i8, ptr %i.ka, i64 16 ; 2 uses
  %i.uo = load <2 x double>, ptr %i.un, align 1, !tbaa !35
  ...
  store <2 x double> %i.uq, ptr %i.jy, align 1, !tbaa !35
  store <2 x double> %i.us, ptr %i.uk, align 1, !tbaa !35
  store <2 x double> %i.uu, ptr %i.ka, align 1, !tbaa !35
  store <2 x double> %i.uw, ptr %i.un, align 1, !tbaa !35
  %i.ux = load <2 x double>, ptr %i.kc, align 1, !tbaa !35
  %i.uy = getelementptr inbounds nuw i8, ptr %i.kc, i64 16 ; 2 uses
  %i.uz = load <2 x double>, ptr %i.uy, align 1, !tbaa !35
  %i.va = load <2 x double>, ptr %i.ke, align 1, !tbaa !35
  %i.vb = getelementptr inbounds nuw i8, ptr %i.ke, i64 16 ; 2 uses
  %i.vc = load <2 x double>, ptr %i.vb, align 1, !tbaa !35
  ...
  store <2 x double> %i.ve, ptr %i.kc, align 1, !tbaa !35
  store <2 x double> %i.vg, ptr %i.uy, align 1, !tbaa !35
  store <2 x double> %i.vi, ptr %i.ke, align 1, !tbaa !35
  store <2 x double> %i.vk, ptr %i.vb, align 1, !tbaa !35
  %i.vl = add nuw nsw i64 %.0245747, 4            ; 2 uses
  %i.vm = icmp slt i64 %i.vl, %.sroa.speculated
  br i1 %i.vm, label %bb.e, label %._crit_edge749, !llvm.loop !988
...
.lr.ph738:                                        ; preds = %.preheader702, %.lr.ph738
  ...
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !989
  %i.vn = load <2 x double>, ptr %.1244735, align 16, !tbaa !35 ; 4 uses
  %i.vo = getelementptr inbounds nuw i8, ptr %.1244735, i64 16
  %i.vp = load <2 x double>, ptr %i.vo, align 16, !tbaa !35 ; 4 uses
  %i.vq = load <4 x i32>, ptr %.1242736, align 16, !tbaa !35 ; 2 uses
  %i.vr = getelementptr inbounds nuw i8, ptr %.1242736, i64 16
  %i.vs = load <4 x i32>, ptr %i.vr, align 16, !tbaa !35 ; 2 uses
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !990
  ...
  br i1 %i.wu, label %.lr.ph738, label %._crit_edge, !llvm.loop !991
...
.preheader.lr.ph.split:                           ; preds = %.preheader698
  ...
  %i.xf = load ptr, ptr %1, align 8, !tbaa !929   ; 4 uses
  %i.xg = load i64, ptr %i.xd, align 8, !tbaa !931 ; 4 uses
...
bb.f:                                             ; preds = %bb.f, %.preheader.prol
  ...
  %i.xj = load double, ptr %gep847.prol, align 8, !tbaa !27
  %i.xk = call double @llvm.fmuladd.f64(double %7, double 0.000000e+00, double %i.xj)
  store double %i.xk, ptr %gep847.prol, align 8, !tbaa !27
  %i.xl = add nsw i64 %.0226843.prol, 1           ; 2 uses
  %exitcond892.not.prol = icmp eq i64 %i.xl, %4
  br i1 %exitcond892.not.prol, label %._crit_edge845.split.prol, label %bb.f, !llvm.loop !992
...
.lr.ph836.us.us.new:                              ; preds = %.lr.ph836.us.us, %.lr.ph836.us.us.new
  ...
  %i.xt = load double, ptr %i.xs, align 8, !tbaa !27
  %i.xu = getelementptr inbounds nuw [8 x i8], ptr %gep842.us, i64 %.0834.us.us
  %i.xv = load double, ptr %i.xu, align 8, !tbaa !27
  ...
  %i.ya = load double, ptr %i.xz, align 8, !tbaa !27
  %i.yb = getelementptr inbounds nuw [8 x i8], ptr %gep842.us, i64 %i.xy
  %i.yc = load double, ptr %i.yb, align 8, !tbaa !27
  ...
  %i.yh = load double, ptr %i.yg, align 8, !tbaa !27
  %i.yi = getelementptr inbounds nuw [8 x i8], ptr %gep842.us, i64 %i.yf
  %i.yj = load double, ptr %i.yi, align 8, !tbaa !27
  ...
  %i.yo = load double, ptr %i.yn, align 8, !tbaa !27
  %i.yp = getelementptr inbounds nuw [8 x i8], ptr %gep842.us, i64 %i.ym
  %i.yq = load double, ptr %i.yp, align 8, !tbaa !27
  ...
  br i1 %niter1028.ncmp.3, label %._crit_edge837.us.us.unr-lcssa, label %.lr.ph836.us.us.new, !llvm.loop !993
...
bb.g:                                             ; preds = %bb.g, %.epil.preheader1022
  ...
  %i.yv = load double, ptr %i.yu, align 8, !tbaa !27
  %i.yw = getelementptr inbounds nuw [8 x i8], ptr %gep842.us, i64 %.0834.us.us.epil
  %i.yx = load double, ptr %i.yw, align 8, !tbaa !27
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge837.us.us, label %bb.g, !llvm.loop !994
...
._crit_edge837.us.us:                             ; preds = %bb.g, %._crit_edge837.us.us.unr-lcssa
  ...
  %i.zb = load double, ptr %gep847.us.us, align 8, !tbaa !27
  %i.zc = call double @llvm.fmuladd.f64(double %7, double %.lcssa, double %i.zb)
  store double %i.zc, ptr %gep847.us.us, align 8, !tbaa !27
  %i.zd = add nsw i64 %.0226843.us.us, 1          ; 2 uses
  %exitcond895.not = icmp eq i64 %i.zd, %4
  br i1 %exitcond895.not, label %._crit_edge845.split.us.us, label %.lr.ph836.us.us, !llvm.loop !992
...
._crit_edge845.split.us.us:                       ; preds = %._crit_edge837.us.us
  ...
  br i1 %exitcond892.not.a, label %.loopexit, label %.preheader.us, !llvm.loop !995

._crit_edge827.split:                             ; preds = %bb.h
  %i.zf = add nuw nsw i64 %.0231828, 4            ; 2 uses
  %i.zg = icmp slt i64 %i.zf, %i.d
  br i1 %i.zg, label %.preheader699, label %.preheader698, !llvm.loop !934
...
bb.j:                                             ; preds = %.preheader, %bb.j
  ...
  %i.aaf = load double, ptr %gep847, align 8, !tbaa !27
  %i.aag = call double @llvm.fmuladd.f64(double %7, double 0.000000e+00, double %i.aaf)
  store double %i.aag, ptr %gep847, align 8, !tbaa !27
  %i.aah = add nsw i64 %.0226843, 1               ; 2 uses
  %exitcond892.not = icmp eq i64 %i.aah, %4
  br i1 %exitcond892.not, label %._crit_edge845.split, label %bb.j, !llvm.loop !992
...
bb.b:                                             ; preds = %.lr.ph455, %._crit_edge449
  ...
  %i.l = load ptr, ptr %1, align 8, !tbaa !929
  %i.m = load i64, ptr %i.c, align 8, !tbaa !931  ; 4 uses
...
.lr.ph:                                           ; preds = %bb.b, %.lr.ph
  ...
  tail call void asm sideeffect "#begin gebp micro kernel 1/half/quarterX4", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !996
  %i.am = getelementptr inbounds nuw i8, ptr %.0122429, i64 384
  tail call void @llvm.prefetch.p0(ptr nonnull %i.am, i32 0, i32 3, i32 1)
  tail call void asm sideeffect "#begin step of gebp micro kernel 1X4", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !997
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !998
  %i.an = load <2 x double>, ptr %.0124428, align 16, !tbaa !35 ; 4 uses
  %i.ao = load <4 x i32>, ptr %.0122429, align 16, !tbaa !35 ; 2 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %.0122429, i64 16
  %i.aq = load <4 x i32>, ptr %i.ap, align 16, !tbaa !35 ; 2 uses
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 1X4", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !999
  tail call void asm sideeffect "#begin step of gebp micro kernel 1X4", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !997
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !998
  %i.bh = getelementptr inbounds nuw i8, ptr %.0124428, i64 16
  %i.bi = load <2 x double>, ptr %i.bh, align 16, !tbaa !35 ; 4 uses
  %i.bj = getelementptr inbounds nuw i8, ptr %.0122429, i64 32
  %i.bk = load <4 x i32>, ptr %i.bj, align 16, !tbaa !35 ; 2 uses
  %i.bl = getelementptr inbounds nuw i8, ptr %.0122429, i64 48
  %i.bm = load <4 x i32>, ptr %i.bl, align 16, !tbaa !35 ; 2 uses
  ...
  %i.ce = load <2 x double>, ptr %i.cd, align 16, !tbaa !35 ; 4 uses
  %i.cf = getelementptr inbounds nuw i8, ptr %.0122429, i64 64
  %i.cg = load <4 x i32>, ptr %i.cf, align 16, !tbaa !35 ; 2 uses
  %i.ch = getelementptr inbounds nuw i8, ptr %.0122429, i64 80
  %i.ci = load <4 x i32>, ptr %i.ch, align 16, !tbaa !35 ; 2 uses
  ...
  %i.da = load <2 x double>, ptr %i.cz, align 16, !tbaa !35 ; 4 uses
  %i.db = getelementptr inbounds nuw i8, ptr %.0122429, i64 96
  %i.dc = load <4 x i32>, ptr %i.db, align 16, !tbaa !35 ; 2 uses
  %i.dd = getelementptr inbounds nuw i8, ptr %.0122429, i64 112
  %i.de = load <4 x i32>, ptr %i.dd, align 16, !tbaa !35 ; 2 uses
...
bb.ad:                                            ; preds = %bb.y, %bb.v
  ...
  br i1 %i.dd, label %.lr.ph295, label %.preheader, !llvm.loop !1059

._crit_edge298:                                   ; preds = %bb.ag, %.preheader
  %i.de = sub nsw i64 %.0126301, %i.b             ; 2 uses
  %i.df = icmp sgt i64 %i.de, 0
  %indvar.next = add i64 %indvar, 1
  br i1 %i.df, label %bb.q, label %._crit_edge304, !llvm.loop !1060
...
bb.af:                                            ; preds = %bb.ae
  ...
  %i.dj = load double, ptr %10, align 8, !tbaa !27
...
bb.ag:                                            ; preds = %bb.af
  ...
  br i1 %i.dk, label %bb.ae, label %._crit_edge298, !llvm.loop !1061
...
bb.a:
  ...
  tail call void asm sideeffect "#EIGEN PRODUCT PACK LHS", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !1062
  %i.b = sdiv i64 %4, 4
...
.preheader64.us.new:                              ; preds = %.preheader64.us, %.preheader64.us.new
  ...
  %i.l = load ptr, ptr %2, align 8, !tbaa !635
  %i.m = load i64, ptr %i.j, align 8, !tbaa !637
  ...
  %i.q = load <2 x double>, ptr %i.p, align 1, !tbaa !35
  %i.r = getelementptr i8, ptr %i.o, i64 16
  %i.s = getelementptr [8 x i8], ptr %i.r, i64 %i.n
  %i.t = load <2 x double>, ptr %i.s, align 1, !tbaa !35
  %i.u = getelementptr inbounds [8 x i8], ptr %1, i64 %.15765.us ; 2 uses
  store <2 x double> %i.q, ptr %i.u, align 16, !tbaa !35
  %i.v = getelementptr i8, ptr %i.u, i64 16
  store <2 x double> %i.t, ptr %i.v, align 16, !tbaa !35
  %i.w = or disjoint i64 %.05466.us, 1
  %i.x = load ptr, ptr %2, align 8, !tbaa !635
  %i.y = load i64, ptr %i.j, align 8, !tbaa !637
...
.epil.preheader:                                  ; preds = %._crit_edge.us.unr-lcssa, %.preheader64.us
  ...
  %i.al = load ptr, ptr %2, align 8, !tbaa !635
  %i.am = load i64, ptr %i.j, align 8, !tbaa !637
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.unr-lcssa, %.epil.preheader
  ...
  br i1 %i.ay, label %.preheader64.us, label %.preheader63, !llvm.loop !1064
...
.preheader62.us.new:                              ; preds = %.preheader62.us, %.preheader62.us.new
  ...
  br i1 %niter130.ncmp.1, label %._crit_edge.us78.unr-lcssa, label %.preheader62.us.new, !llvm.loop !1065
...
.epil.preheader124:                               ; preds = %._crit_edge.us78.unr-lcssa, %.preheader62.us
  ...
  %i.ca = load ptr, ptr %2, align 8, !tbaa !635
  %i.cb = load i64, ptr %i.bb, align 8, !tbaa !637
  ...
  %i.cf = load <2 x double>, ptr %i.ce, align 1, !tbaa !35
  %i.cg = getelementptr inbounds [8 x i8], ptr %1, i64 %.372.us.epil.init
  store <2 x double> %i.cf, ptr %i.cg, align 16, !tbaa !35
...
._crit_edge.us78:                                 ; preds = %._crit_edge.us78.unr-lcssa, %.epil.preheader124
  ...
  br i1 %i.cj, label %.preheader62.us, label %.preheader61, !llvm.loop !1066
...
.preheader.lr.ph.split:                           ; preds = %.preheader61
  ...
  %i.cn = load ptr, ptr %2, align 8, !tbaa !635   ; 2 uses
  %i.co = ptrtoaddr ptr %i.cn to i64
  %i.cp = load i64, ptr %i.cm, align 8, !tbaa !637 ; 6 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.da, align 8, !tbaa !27
  %wide.load114 = load <2 x double>, ptr %i.db, align 8, !tbaa !27
  %i.dc = getelementptr [8 x i8], ptr %i.cz, i64 %index ; 2 uses
  %i.dd = getelementptr inbounds nuw i8, ptr %i.dc, i64 16
  store <2 x double> %wide.load, ptr %i.dc, align 8, !tbaa !27
  store <2 x double> %wide.load114, ptr %i.dd, align 8, !tbaa !27
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.de = icmp eq i64 %index.next, %n.vec
  br i1 %i.de, label %middle.block, label %vector.body, !llvm.loop !1067
...
._crit_edge:                                      ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  ...
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond98.not, label %._crit_edge86.split, label %.preheader, !llvm.loop !1069
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  store double %i.dq, ptr %i.dr, align 8, !tbaa !27
  ...
  store double %i.dv, ptr %i.dx, align 8, !tbaa !27
  ...
  store double %i.eh, ptr %i.ek, align 8, !tbaa !27
  %i.el = add nuw nsw i64 %.083, 4                ; 2 uses
  %exitcond97.not.3 = icmp eq i64 %i.el, %3
  br i1 %exitcond97.not.3, label %._crit_edge, label %scalar.ph, !llvm.loop !1070
