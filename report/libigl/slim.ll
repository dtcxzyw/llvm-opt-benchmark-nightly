...
.lr.ph:                                           ; preds = %bb.l
  ...
  %34 = insertelement <2 x double> <double 9.000000e+00, double poison>, double %2, i64 1
  br label %bb.m
...
bb.s:                                             ; preds = %bb.m
  ...
  %35 = insertelement <2 x double> poison, double %i.uv, i64 0
  %36 = insertelement <2 x double> %35, double %i.vp, i64 1
  %37 = fmul <2 x double> %36, %34                ; 4 uses
  %i.wg = shufflevector <2 x double> %37, <2 x double> poison, <2 x i32> zeroinitializer
  %i.wh = fdiv <2 x double> %i.wf, %i.wg
  %38 = shufflevector <2 x double> %37, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  ...
  %i.wy = fdiv double %i.wx, %39
  %40 = extractelement <2 x double> %37, i64 1
  %i.wz = fmul double %i.wy, %40
