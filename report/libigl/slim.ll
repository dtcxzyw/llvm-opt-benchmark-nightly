...
bb.e:                                             ; preds = %bb.d
  %i.i = load ptr, ptr %i.c, align 8, !tbaa !255
  call void @free(ptr noundef %i.i) #28
  %i.j = load ptr, ptr %i.h, align 8, !tbaa !302
  call void @free(ptr noundef %i.j) #28
  %i.k = getelementptr inbounds nuw i8, ptr %3, i64 40
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !303  ; 2 uses
  %i.m = icmp eq ptr %i.l, null
  br i1 %i.m, label %bb.g, label %bb.f

bb.f:                                             ; preds = %bb.e
  call void @_ZdaPv(ptr noundef nonnull %i.l) #31
  br label %bb.g

bb.g:                                             ; preds = %bb.f, %bb.e
  %i.n = getelementptr inbounds nuw i8, ptr %3, i64 48
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !304  ; 2 uses
  %i.p = icmp eq ptr %i.o, null
  br i1 %i.p, label %_ZN5Eigen12SparseMatrixIdLi0EiED2Ev.exit, label %bb.h

bb.h:                                             ; preds = %bb.g
  call void @_ZdaPv(ptr noundef nonnull %i.o) #31
...
bb.i:                                             ; preds = %bb.d, %_ZN5Eigen12SparseMatrixIdLi0EiEC2Ev.exit
  %i.q = landingpad { ptr, i32 }
          cleanup
  call void @_ZN5Eigen12SparseMatrixIdLi0EiED2Ev(ptr noundef nonnull align 8 dead_on_return(72) dereferenceable(72) %3) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #28
  br label %common.resume
}
...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !tbaa !19   ; 25 uses
...
.invoke:                                          ; preds = %_ZN5Eigen8internal23check_size_for_overflowIiEEvm.exit.i.i.i, %bb.b
  %i.g = tail call ptr @__cxa_allocate_exception(i64 8) #28 ; 2 uses
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.g, align 8, !tbaa !256
  invoke void @__cxa_throw(ptr nonnull %i.g, ptr nonnull @_ZTISt9bad_alloc, ptr nonnull @_ZNSt9bad_allocD1Ev) #30
...
.lr.ph154:                                        ; preds = %.preheader147
  ...
  %i.k = load ptr, ptr %i.j, align 8, !tbaa !255
...
.lr.ph.i.i.i:                                     ; preds = %bb.d, %.lr.ph.i.i.i
  ...
  %i.ad = load <4 x i32>, ptr %i.ac, align 16, !tbaa !44
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %i.ay, align 4, !tbaa !31
  %wide.load216 = load <4 x i32>, ptr %i.az, align 4, !tbaa !31
  %i.ba = add <4 x i32> %wide.load, %vec.phi      ; 2 uses
  %i.bb = add <4 x i32> %wide.load216, %vec.phi215 ; 2 uses
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.bc = icmp eq i64 %index.next, %n.vec
  br i1 %i.bc, label %middle.block, label %vector.body, !llvm.loop !721
...
.lr.ph80.i.i.i:                                   ; preds = %.lr.ph80.i.i.i.preheader238, %.lr.ph80.i.i.i
  ...
  br i1 %exitcond.not.i.i.i, label %_ZNK5Eigen9DenseBaseINS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEEE3sumEv.exit, label %.lr.ph80.i.i.i, !llvm.loop !722

bb.g:                                             ; preds = %._crit_edge155.thread
  %i.bi = load i32, ptr %.sroa.0126.2144, align 4, !tbaa !31 ; 3 uses
...
vector.body221:                                   ; preds = %vector.body221, %vector.ph219
  ...
  %wide.load225 = load <4 x i32>, ptr %i.bo, align 4, !tbaa !31
  %wide.load226 = load <4 x i32>, ptr %i.bp, align 4, !tbaa !31
  ...
  br i1 %i.bs, label %middle.block228, label %vector.body221, !llvm.loop !723
...
.lr.ph85.i.i.i:                                   ; preds = %.lr.ph85.i.i.i.preheader235, %.lr.ph85.i.i.i
  ...
  br i1 %exitcond92.not.i.i.i, label %_ZNK5Eigen9DenseBaseINS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEEE3sumEv.exit, label %.lr.ph85.i.i.i, !llvm.loop !724
...
bb.o:                                             ; preds = %bb.n
  ...
  store i32 %i.cx, ptr %i.cv, align 4, !tbaa !31
  %i.cy = load i32, ptr %i.co, align 4, !tbaa !31
  %i.cz = add nsw i32 %i.cy, 1
  store i32 %i.cz, ptr %i.co, align 4, !tbaa !31
  br label %bb.q

bb.p:                                             ; preds = %.lr.ph.split.us
  %i.da = load i32, ptr %i.cp, align 4, !tbaa !31
  %i.db = add nsw i32 %i.da, 1
  store i32 %i.db, ptr %i.cp, align 4, !tbaa !31
  br label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.o, %bb.n
  %i.dc = add nsw i64 %.sroa.9.0151.us, 1         ; 2 uses
  %exitcond173.not = icmp eq i64 %i.dc, %.sink.i
  br i1 %exitcond173.not, label %._crit_edge, label %.lr.ph.split.us, !llvm.loop !725
...
._crit_edge:                                      ; preds = %bb.u, %bb.q, %_ZN5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE13InnerIteratorC2ERKS3_l.exit
  ...
  br i1 %exitcond174.not, label %._crit_edge155.thread, label %bb.i, !llvm.loop !726
...
.lr.ph.us.preheader.epil:                         ; preds = %_ZN5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE13InnerIteratorC2ERKS3_l.exit.us.epil.preheader
  ...
  call void @llvm.memset.p0.i64(ptr align 8 %scevgep20.epil, i8 0, i64 %i.bo, i1 false), !tbaa !28
...
.lr.ph.preheader.epil:                            ; preds = %_ZN5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE13InnerIteratorC2ERKS3_l.exit.epil.preheader
  ...
  call void @llvm.memset.p0.i64(ptr align 8 %scevgep.epil, i8 0, i64 %i.bx, i1 false), !tbaa !28
  br label %._crit_edge17
...
._crit_edge17:                                    ; preds = %._crit_edge17.loopexit31.unr-lcssa, %.lr.ph.preheader.epil, %_ZN5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE13InnerIteratorC2ERKS3_l.exit.epil.preheader, %._crit_edge17.loopexit.unr-lcssa, %.lr.ph.us.preheader.epil, %_ZN5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE13InnerIteratorC2ERKS3_l.exit.us.epil.preheader, %bb.e
  ...
  store i8 0, ptr %4, align 8, !tbaa !732, !alias.scope !734
  %i.by = getelementptr inbounds nuw i8, ptr %4, i64 8
  store ptr %2, ptr %i.by, align 8, !tbaa !332, !alias.scope !734
  %i.bz = getelementptr inbounds nuw i8, ptr %4, i64 16
  store ptr %0, ptr %i.bz, align 8, !tbaa !332, !alias.scope !734
...
bb.g:                                             ; preds = %._crit_edge17
  ...
  %i.cb = load ptr, ptr %i.c, align 8, !tbaa !255
  call void @free(ptr noundef %i.cb) #28
  %i.cc = load ptr, ptr %i.h, align 8, !tbaa !302
  call void @free(ptr noundef %i.cc) #28
  %i.cd = getelementptr inbounds nuw i8, ptr %2, i64 40
  %i.ce = load ptr, ptr %i.cd, align 8, !tbaa !303 ; 2 uses
  %i.cf = icmp eq ptr %i.ce, null
  br i1 %i.cf, label %bb.i, label %bb.h

bb.h:                                             ; preds = %bb.g
  call void @_ZdaPv(ptr noundef nonnull %i.ce) #31
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.g
  %i.cg = getelementptr inbounds nuw i8, ptr %2, i64 48
  %i.ch = load ptr, ptr %i.cg, align 8, !tbaa !304 ; 2 uses
  %i.ci = icmp eq ptr %i.ch, null
  br i1 %i.ci, label %_ZN5Eigen12SparseMatrixIdLi0EiED2Ev.exit, label %bb.j

bb.j:                                             ; preds = %bb.i
  call void @_ZdaPv(ptr noundef nonnull %i.ch) #31
  br label %_ZN5Eigen12SparseMatrixIdLi0EiED2Ev.exit
...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !tbaa !30   ; 32 uses
  %i.c = trunc i64 %i.b to i32                    ; 17 uses
  %i.d = sitofp i32 %i.c to double
  %i.e = tail call double @sqrt(double noundef %i.d) #28
  ...
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !302  ; 13 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.p = load i32, ptr %i.m, align 4, !tbaa !31
...
bb.f:                                             ; preds = %_ZN5Eigen8internalL21first_default_alignedINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEEElRKNS_9DenseBaseIT_EE.exit.i.i.i.i
  ...
  %i.ag = load <2 x i64>, ptr %i.af, align 1, !tbaa !44 ; 2 uses
  %i.ah = icmp sgt i64 %i.y, 7
  br i1 %i.ah, label %bb.g, label %bb.i

bb.g:                                             ; preds = %bb.f
  %i.ai = getelementptr i8, ptr %i.af, i64 16
  %i.aj = load <4 x i32>, ptr %i.ai, align 1, !tbaa !44 ; 2 uses
...
.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i, %.lr.ph.preheader.i.i.i.i
  ...
  %i.ar = load <4 x i32>, ptr %i.aq, align 1, !tbaa !44
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %i.bi, align 4, !tbaa !31
  %wide.load1170 = load <4 x i32>, ptr %i.bj, align 4, !tbaa !31
  %i.bk = add <4 x i32> %wide.load, %vec.phi      ; 2 uses
  %i.bl = add <4 x i32> %wide.load1170, %vec.phi1169 ; 2 uses
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.bm = icmp eq i64 %index.next, %n.vec
  br i1 %i.bm, label %middle.block, label %vector.body, !llvm.loop !738
...
vector.body1175:                                  ; preds = %vector.body1175, %vector.ph1173
  ...
  %wide.load1179 = load <4 x i32>, ptr %i.bv, align 4, !tbaa !31
  %wide.load1180 = load <4 x i32>, ptr %i.bw, align 4, !tbaa !31
  ...
  br i1 %i.bz, label %middle.block1182, label %vector.body1175, !llvm.loop !739
...
.lr.ph85.i.i.i.i:                                 ; preds = %.lr.ph85.i.i.i.i.preheader1355, %.lr.ph85.i.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.i, label %.preheader.i.i.i.i, label %.lr.ph85.i.i.i.i, !llvm.loop !740
...
.lr.ph89.i.i.i.i:                                 ; preds = %.lr.ph89.i.i.i.i.preheader1350, %.lr.ph89.i.i.i.i
  ...
  br i1 %i.cj, label %.lr.ph89.i.i.i.i, label %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit, !llvm.loop !741
...
bb.j:                                             ; preds = %_ZN5Eigen8internalL21first_default_alignedINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEEElRKNS_9DenseBaseIT_EE.exit.i.i.i.i
  %i.ck = load i32, ptr %i.j, align 4, !tbaa !31  ; 3 uses
...
vector.body1191:                                  ; preds = %vector.body1191, %vector.ph1189
  ...
  %wide.load1195 = load <4 x i32>, ptr %i.cq, align 4, !tbaa !31
  %wide.load1196 = load <4 x i32>, ptr %i.cr, align 4, !tbaa !31
  ...
  br i1 %i.cu, label %middle.block1198, label %vector.body1191, !llvm.loop !742
...
.lr.ph94.i.i.i.i:                                 ; preds = %.lr.ph94.i.i.i.i.preheader1346, %.lr.ph94.i.i.i.i
  ...
  br i1 %exitcond102.not.i.i.i.i, label %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit, label %.lr.ph94.i.i.i.i, !llvm.loop !743
...
_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit: ; preds = %.lr.ph89.i.i.i.i, %.lr.ph94.i.i.i.i, %middle.block1182, %middle.block1198, %.preheader.i.i.i.i, %bb.j, %bb.b, %bb.c
  ...
  %i.dd = load i64, ptr %i.dc, align 8, !tbaa !621
...
bb.k:                                             ; preds = %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit
  %i.de = load ptr, ptr %1, align 8, !tbaa !341
  tail call void @free(ptr noundef %i.de) #28
...
_ZN5Eigen8internal23check_size_for_overflowIiEEvm.exit.i.i.i.i: ; preds = %bb.k
  ...
  %i.dh = tail call noalias ptr @malloc(i64 noundef %i.dg) #29 ; 2 uses
...
bb.l:                                             ; preds = %_ZN5Eigen8internal23check_size_for_overflowIiEEvm.exit.i.i.i.i
  %i.dj = tail call ptr @__cxa_allocate_exception(i64 8) #28 ; 2 uses
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.dj, align 8, !tbaa !256
  tail call void @__cxa_throw(ptr nonnull %i.dj, ptr nonnull @_ZTISt9bad_alloc, ptr nonnull @_ZNSt9bad_allocD1Ev) #30
  unreachable
...
.sink.split.i.i.i:                                ; preds = %_ZN5Eigen8internal23check_size_for_overflowIiEEvm.exit.i.i.i.i, %bb.k
  ...
  store ptr %.sink.i.i.i, ptr %1, align 8, !tbaa !341
...
_ZN5Eigen15PermutationBaseINS_17PermutationMatrixILin1ELin1EiEEE6resizeEl.exit: ; preds = %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit, %.sink.split.i.i.i
  store i64 %i.db, ptr %i.dc, align 8, !tbaa !621
  %i.dk = sdiv i32 %.0.i, 5
...
end_hunk_1
begin_hunk_2_@_ZNK5Eigen22SimplicialCholeskyBaseINS_14SimplicialLDLTINS_12SparseMatrixIdLi0EiEELi1ENS_11AMDOrderingIiEEEEE11_solve_implINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEESA_EEvRKNS_10MatrixBaseIT_EERNSB_IT0_EE:bb.a
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.ab, align 8, !tbaa !28
  %wide.load130 = load <2 x double>, ptr %i.ac, align 8, !tbaa !28
  %i.ad = getelementptr inbounds nuw i8, ptr %i.aa, i64 16
  store <2 x double> %wide.load, ptr %i.aa, align 8, !tbaa !28
  store <2 x double> %wide.load130, ptr %i.ad, align 8, !tbaa !28
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ae = icmp eq i64 %index.next, %n.vec
  br i1 %i.ae, label %middle.block, label %vector.body, !llvm.loop !805
...
.lr.ph.i.i.i.i.i.i.i.i.prol:                      ; preds = %.lr.ph.i.i.i.i.i.i.i.i.preheader273, %.lr.ph.i.i.i.i.i.i.i.i.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.i.i.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.i.i.i.i.i.prol, !llvm.loop !806
...
.lr.ph.i.i.i.i.i.i.i.i:                           ; preds = %.lr.ph.i.i.i.i.i.i.i.i.prol.loopexit, %.lr.ph.i.i.i.i.i.i.i.i
  ...
  %i.ao = load double, ptr %i.an, align 8, !tbaa !28
  store double %i.ao, ptr %i.am, align 8, !tbaa !28
  ...
  %i.as = load double, ptr %i.ar, align 8, !tbaa !28
  ...
  store double %i.aw, ptr %i.au, align 8, !tbaa !28
  ...
  %i.ba = load double, ptr %i.az, align 8, !tbaa !28
  store double %i.ba, ptr %i.ay, align 8, !tbaa !28
  %i.bb = add nsw i64 %.05.i.i.i.i.i.i.i.i, 4     ; 2 uses
  %exitcond.not.i.i.i.i.i.i.i.i.3 = icmp eq i64 %i.bb, %i.o
  br i1 %exitcond.not.i.i.i.i.i.i.i.i.3, label %_ZN5Eigen10MatrixBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEaSERKS3_.exit, label %.lr.ph.i.i.i.i.i.i.i.i, !llvm.loop !807
...
.lr.ph.i.i.i.i.i.i.i:                             ; preds = %bb.f, %.lr.ph.i.i.i.i.i.i.i
  ...
  %i.be = load <2 x double>, ptr %i.bd, align 16, !tbaa !44
  store <2 x double> %i.be, ptr %i.bc, align 16, !tbaa !44
  %i.bf = add nuw nsw i64 %.011.i.i.i.i.i.i.i, 2  ; 2 uses
  %i.bg = icmp slt i64 %i.bf, %i.s
  br i1 %i.bg, label %.lr.ph.i.i.i.i.i.i.i, label %._crit_edge.i.i.i.i.i.i.i, !llvm.loop !323
...
_ZN5Eigen10MatrixBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEaSERKS3_.exit: ; preds = %.lr.ph.i.i.i.i.i.i.i.i.prol.loopexit, %.lr.ph.i.i.i.i.i.i.i.i, %middle.block, %._crit_edge.i.i.i.i.i.i.i, %_ZN5Eigen10MatrixBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEaSINS_7ProductINS_17PermutationMatrixILin1ELin1EiEES2_Li2EEEEERS2_RKNS_9DenseBaseIT_EE.exit
  ...
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !302 ; 13 uses
...
bb.g:                                             ; preds = %_ZN5Eigen10MatrixBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEaSERKS3_.exit
  ...
  %i.bm = load ptr, ptr %i.bl, align 8, !tbaa !255 ; 2 uses
  ...
  %i.br = load i32, ptr %i.bm, align 4, !tbaa !31
...
bb.h:                                             ; preds = %_ZN5Eigen10MatrixBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEaSERKS3_.exit
  ...
  %i.bu = load i64, ptr %i.bt, align 8, !tbaa !30 ; 11 uses
...
bb.k:                                             ; preds = %_ZN5Eigen8internalL21first_default_alignedINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEEElRKNS_9DenseBaseIT_EE.exit.i.i.i.i
  ...
  %i.ck = load <2 x i64>, ptr %i.cj, align 1, !tbaa !44 ; 2 uses
  %i.cl = icmp sgt i64 %i.cc, 7
  br i1 %i.cl, label %bb.l, label %bb.n

bb.l:                                             ; preds = %bb.k
  %i.cm = getelementptr i8, ptr %i.cj, i64 16
  %i.cn = load <4 x i32>, ptr %i.cm, align 1, !tbaa !44 ; 2 uses
...
.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i, %.lr.ph.preheader.i.i.i.i
  ...
  %i.cv = load <4 x i32>, ptr %i.cu, align 1, !tbaa !44
  ...
  %i.cz = load <4 x i32>, ptr %i.cy, align 1, !tbaa !44
  %i.da = add <4 x i32> %i.cz, %i.ct              ; 2 uses
  %.057.i.i.i.i = add nsw i64 %.05780.i.i.i.i, 8  ; 2 uses
  %i.db = icmp slt i64 %.057.i.i.i.i, %i.ch
  br i1 %i.db, label %.lr.ph.i.i.i.i, label %._crit_edge.i.i.i.i, !llvm.loop !737

bb.m:                                             ; preds = %._crit_edge.i.i.i.i
  %i.dc = getelementptr inbounds [4 x i8], ptr %i.bj, i64 %i.ch
  %i.dd = load <4 x i32>, ptr %i.dc, align 1, !tbaa !44
...
bb.n:                                             ; preds = %bb.m, %._crit_edge.i.i.i.i, %bb.k
  ...
  %i.dh = bitcast <2 x i64> %.sroa.067.2.i.i.i.i to <4 x i32> ; 2 uses
  ...
  %foldExtExtBinop = add nsw <4 x i32> %i.dj, %shift
  %5 = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %i.dh) ; 2 uses
...
vector.body135:                                   ; preds = %vector.body135, %vector.ph133
  ...
  %wide.load138 = load <4 x i32>, ptr %i.dm, align 4, !tbaa !31
  %wide.load139 = load <4 x i32>, ptr %i.dn, align 4, !tbaa !31
  ...
  br i1 %i.dq, label %middle.block141, label %vector.body135, !llvm.loop !808
...
vector.body148:                                   ; preds = %vector.body148, %vector.ph146
  ...
  %wide.load152 = load <4 x i32>, ptr %i.dz, align 4, !tbaa !31
  %wide.load153 = load <4 x i32>, ptr %i.ea, align 4, !tbaa !31
  ...
  br i1 %i.ed, label %middle.block155, label %vector.body148, !llvm.loop !809
...
.lr.ph85.i.i.i.i:                                 ; preds = %.lr.ph85.i.i.i.i.preheader267, %.lr.ph85.i.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.i, label %.preheader.i.i.i.i, label %.lr.ph85.i.i.i.i, !llvm.loop !810
...
.lr.ph89.i.i.i.i:                                 ; preds = %.lr.ph89.i.i.i.i.preheader262, %.lr.ph89.i.i.i.i
  ...
  %i.ek = load i32, ptr %i.ej, align 4, !tbaa !31
  %i.el = add nsw i32 %i.ek, %.187.i.i.i.i        ; 2 uses
  %i.em = add nsw i64 %.05588.i.i.i.i, 1          ; 2 uses
  %i.en = icmp slt i64 %i.em, %i.bu
  br i1 %i.en, label %.lr.ph89.i.i.i.i, label %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit, !llvm.loop !811
...
bb.o:                                             ; preds = %_ZN5Eigen8internalL21first_default_alignedINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEEElRKNS_9DenseBaseIT_EE.exit.i.i.i.i
  %i.eo = load i32, ptr %i.bj, align 4, !tbaa !31 ; 3 uses
...
vector.body164:                                   ; preds = %vector.body164, %vector.ph162
  ...
  %wide.load168 = load <4 x i32>, ptr %i.eu, align 4, !tbaa !31
  %wide.load169 = load <4 x i32>, ptr %i.ev, align 4, !tbaa !31
  ...
  br i1 %i.ey, label %middle.block171, label %vector.body164, !llvm.loop !812
...
.lr.ph94.i.i.i.i:                                 ; preds = %.lr.ph94.i.i.i.i.preheader258, %.lr.ph94.i.i.i.i
  ...
  %i.fb = load i32, ptr %i.fa, align 4, !tbaa !31
  ...
  br i1 %exitcond102.not.i.i.i.i, label %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit, label %.lr.ph94.i.i.i.i, !llvm.loop !813
...
_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit.thread: ; preds = %bb.h, %bb.p, %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit
  ...
  %i.fh = load i64, ptr %i.fg, align 8, !tbaa !25 ; 4 uses
...
bb.q:                                             ; preds = %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit.thread
  ...
  %i.fk = load ptr, ptr %i.fj, align 8, !tbaa !27 ; 6 uses
  %i.fl = ptrtoaddr ptr %i.fk to i64
  %i.fm = load ptr, ptr %2, align 8, !tbaa !27    ; 7 uses
  %i.fn = ptrtoaddr ptr %i.fm to i64
  %i.fo = getelementptr inbounds nuw i8, ptr %2, i64 8 ; 2 uses
  %i.fp = load i64, ptr %i.fo, align 8, !tbaa !25
...
thread-pre-split.i.i.i.i.i.i12:                   ; preds = %bb.q
  ...
  %.pr.i.i.i.i.i.i13 = load i64, ptr %i.fo, align 8, !tbaa !25
...
.lr.ph.i.i.i.i.i.i.i.i15:                         ; preds = %.lr.ph.i.i.i.i.i.i.i.i15.prol.loopexit, %.lr.ph.i.i.i.i.i.i.i.i15
  ...
  %i.gz = load double, ptr %i.gy, align 8, !tbaa !28
  %i.ha = fmul double %i.gx, %i.gz
  store double %i.ha, ptr %i.gu, align 8, !tbaa !28
  ...
  store double %i.hi, ptr %i.hc, align 8, !tbaa !28
  %i.hj = add nsw i64 %.05.i.i.i.i.i.i.i.i16, 2   ; 2 uses
  %exitcond.not.i.i.i.i.i.i.i.i17.1 = icmp eq i64 %i.hj, %i.fr
  br i1 %exitcond.not.i.i.i.i.i.i.i.i17.1, label %_ZN5Eigen10MatrixBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEaSINS_7ProductINS_15DiagonalWrapperIKNS_12CwiseUnaryOpINS_8internal17scalar_inverse_opIdEEKS2_EEEES2_Li1EEEEERS2_RKNS_9DenseBaseIT_EE.exit, label %.lr.ph.i.i.i.i.i.i.i.i15, !llvm.loop !815
...
_ZN5Eigen10MatrixBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEaSINS_7ProductINS_15DiagonalWrapperIKNS_12CwiseUnaryOpINS_8internal17scalar_inverse_opIdEEKS2_EEEES2_Li1EEEEERS2_RKNS_9DenseBaseIT_EE.exit: ; preds = %.lr.ph.i.i.i.i.i.i.i.i15.prol.loopexit, %.lr.ph.i.i.i.i.i.i.i.i15, %middle.block188, %._crit_edge.i.i.i.i.i.i.i14, %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit.thread
  %i.ht = load ptr, ptr %i.bi, align 8, !tbaa !302 ; 13 uses
...
bb.s:                                             ; preds = %_ZN5Eigen10MatrixBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEaSINS_7ProductINS_15DiagonalWrapperIKNS_12CwiseUnaryOpINS_8internal17scalar_inverse_opIdEEKS2_EEEES2_Li1EEEEERS2_RKNS_9DenseBaseIT_EE.exit
  ...
  %i.hw = load ptr, ptr %i.hv, align 8, !tbaa !255 ; 2 uses
  %i.hx = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.hy = load i64, ptr %i.hx, align 8, !tbaa !30
  %i.hz = getelementptr inbounds [4 x i8], ptr %i.hw, i64 %i.hy
  %i.ia = load i32, ptr %i.hz, align 4, !tbaa !31
  %i.ib = load i32, ptr %i.hw, align 4, !tbaa !31
...
bb.t:                                             ; preds = %_ZN5Eigen10MatrixBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEaSINS_7ProductINS_15DiagonalWrapperIKNS_12CwiseUnaryOpINS_8internal17scalar_inverse_opIdEEKS2_EEEES2_Li1EEEEERS2_RKNS_9DenseBaseIT_EE.exit
  ...
  %i.ie = load i64, ptr %i.id, align 8, !tbaa !30 ; 11 uses
...
bb.w:                                             ; preds = %_ZN5Eigen8internalL21first_default_alignedINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEEElRKNS_9DenseBaseIT_EE.exit.i.i.i.i21
  ...
  %i.iu = load <2 x i64>, ptr %i.it, align 1, !tbaa !44 ; 2 uses
  %i.iv = icmp sgt i64 %i.im, 7
  br i1 %i.iv, label %bb.x, label %bb.z

bb.x:                                             ; preds = %bb.w
  %i.iw = getelementptr i8, ptr %i.it, i64 16
  %i.ix = load <4 x i32>, ptr %i.iw, align 1, !tbaa !44 ; 2 uses
...
.lr.ph.i.i.i.i45:                                 ; preds = %.lr.ph.i.i.i.i45, %.lr.ph.preheader.i.i.i.i43
  ...
  %i.jf = load <4 x i32>, ptr %i.je, align 1, !tbaa !44
...
bb.z:                                             ; preds = %bb.y, %._crit_edge.i.i.i.i40, %bb.w
  ...
  %i.jr = bitcast <2 x i64> %.sroa.067.2.i.i.i.i25 to <4 x i32> ; 2 uses
  ...
  %foldExtExtBinop241 = add nsw <4 x i32> %i.jt, %shift240
  %6 = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %i.jr) ; 2 uses
...
vector.body195:                                   ; preds = %vector.body195, %vector.ph193
  ...
  %wide.load199 = load <4 x i32>, ptr %i.jw, align 4, !tbaa !31
  %wide.load200 = load <4 x i32>, ptr %i.jx, align 4, !tbaa !31
  ...
  br i1 %i.ka, label %middle.block202, label %vector.body195, !llvm.loop !817
...
vector.body211:                                   ; preds = %vector.body211, %vector.ph209
  ...
  %wide.load215 = load <4 x i32>, ptr %i.kj, align 4, !tbaa !31
  %wide.load216 = load <4 x i32>, ptr %i.kk, align 4, !tbaa !31
  ...
  br i1 %i.kn, label %middle.block218, label %vector.body211, !llvm.loop !818
...
.lr.ph85.i.i.i.i36:                               ; preds = %.lr.ph85.i.i.i.i36.preheader251, %.lr.ph85.i.i.i.i36
  ...
  %i.kq = load i32, ptr %i.kp, align 4, !tbaa !31
  ...
  br i1 %exitcond.not.i.i.i.i39, label %.preheader.i.i.i.i28, label %.lr.ph85.i.i.i.i36, !llvm.loop !819
...
.lr.ph89.i.i.i.i33:                               ; preds = %.lr.ph89.i.i.i.i33.preheader246, %.lr.ph89.i.i.i.i33
  ...
  %i.ku = load i32, ptr %i.kt, align 4, !tbaa !31
  %i.kv = add nsw i32 %i.ku, %.187.i.i.i.i35      ; 2 uses
  %i.kw = add nsw i64 %.05588.i.i.i.i34, 1        ; 2 uses
  %i.kx = icmp slt i64 %i.kw, %i.ie
  br i1 %i.kx, label %.lr.ph89.i.i.i.i33, label %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit54, !llvm.loop !820
...
bb.aa:                                            ; preds = %_ZN5Eigen8internalL21first_default_alignedINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEEElRKNS_9DenseBaseIT_EE.exit.i.i.i.i21
  %i.ky = load i32, ptr %i.ht, align 4, !tbaa !31 ; 3 uses
...
vector.body227:                                   ; preds = %vector.body227, %vector.ph225
  ...
  %wide.load231 = load <4 x i32>, ptr %i.le, align 4, !tbaa !31
  %wide.load232 = load <4 x i32>, ptr %i.lf, align 4, !tbaa !31
  ...
  br i1 %i.li, label %middle.block234, label %vector.body227, !llvm.loop !821
...
.lr.ph94.i.i.i.i50:                               ; preds = %.lr.ph94.i.i.i.i50.preheader243, %.lr.ph94.i.i.i.i50
  ...
  %i.ll = load i32, ptr %i.lk, align 4, !tbaa !31
  ...
  br i1 %exitcond102.not.i.i.i.i53, label %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit54, label %.lr.ph94.i.i.i.i50, !llvm.loop !822
...
bb.ab:                                            ; preds = %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit54
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #28
  store i8 0, ptr %4, align 8, !tbaa !823, !alias.scope !825
  %i.lp = getelementptr inbounds nuw i8, ptr %4, i64 8 ; 2 uses
  store i8 0, ptr %i.lp, align 8, !alias.scope !825
  %.sroa.41.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %4, i64 16
  store ptr %i.bh, ptr %.sroa.41.0..sroa_idx.i.i, align 8, !alias.scope !825
...
_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit54.thread: ; preds = %bb.t, %bb.ab, %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit54
  %i.lq = load i64, ptr %i.d, align 8, !tbaa !621
...
bb.ac:                                            ; preds = %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit54.thread
  ...
  %i.lu = load i64, ptr %i.lt, align 8, !tbaa !621 ; 2 uses
  %i.lv = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.lw = load i64, ptr %i.lv, align 8, !tbaa !25
...
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !830, !nonnull !17, !align !391 ; 5 uses
end_hunk_3
begin_hunk_4_@_ZN5Eigen8internal32sparse_solve_triangular_selectorIKNS_9TransposeIKNS_12SparseMatrixIdLi0EiEEEENS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEELi6ELi2ELi1EE3runERS7_RS9_:bb.a
...
.lr.ph42:                                         ; preds = %.lr.ph42.prol.loopexit, %.lr.ph42
  ...
  %i.cv = load double, ptr %gep, align 8, !tbaa !28
  ...
  %i.de = load double, ptr %gep.1, align 8, !tbaa !28
  ...
  br i1 %exitcond.not.1, label %._crit_edge, label %.lr.ph42, !llvm.loop !849
...
._crit_edge:                                      ; preds = %bb.d, %.lr.ph42.prol.loopexit, %.lr.ph42, %.critedge
  ...
  store double %.022.lcssa, ptr %gep49, align 8, !tbaa !28
  %.021 = add nsw i64 %.02145, -1
  %i.di = icmp sgt i64 %.02145, 0
  br i1 %i.di, label %_ZN5Eigen8internal15unary_evaluatorINS_9TransposeIKNS_12SparseMatrixIdLi0EiEEEENS0_13IteratorBasedEdE13InnerIteratorC2ERKS8_l.exit, label %.split51, !llvm.loop !850
}

; Function Attrs: inlinehint mustprogress nounwind uwtable
define linkonce_odr dso_local void @_ZN5Eigen8internal22generic_matrix_wrapperINS_12SparseMatrixIdLi0EiEELb0EED2Ev(ptr noundef nonnull align 8 dead_on_return(216) dereferenceable(216) %0) unnamed_addr #4 comdat align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 208
  %i.b = load i8, ptr %i.a, align 8, !tbaa !275, !range !301, !noundef !17
  %i.c = trunc nuw i8 %i.b to i1
  br i1 %i.c, label %bb.b, label %_ZN5Eigen3RefIKNS_12SparseMatrixIdLi0EiEELi0ENS_11OuterStrideILin1EEEED2Ev.exit
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !304  ; 2 uses
  %i.m = icmp eq ptr %i.l, null
  br i1 %i.m, label %_ZN5Eigen3RefIKNS_12SparseMatrixIdLi0EiEELi0ENS_11OuterStrideILin1EEEED2Ev.exit, label %bb.e

bb.e:                                             ; preds = %bb.d
  tail call void @_ZdaPv(ptr noundef nonnull %i.l) #31
  br label %_ZN5Eigen3RefIKNS_12SparseMatrixIdLi0EiEELi0ENS_11OuterStrideILin1EEEED2Ev.exit

_ZN5Eigen3RefIKNS_12SparseMatrixIdLi0EiEELi0ENS_11OuterStrideILin1EEEED2Ev.exit: ; preds = %bb.a, %bb.d, %bb.e
  %i.n = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !255
  tail call void @free(ptr noundef %i.o) #28
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.q = load ptr, ptr %i.p, align 8, !tbaa !302
  tail call void @free(ptr noundef %i.q) #28
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !303  ; 2 uses
  %i.t = icmp eq ptr %i.s, null
  br i1 %i.t, label %bb.g, label %bb.f

bb.f:                                             ; preds = %_ZN5Eigen3RefIKNS_12SparseMatrixIdLi0EiEELi0ENS_11OuterStrideILin1EEEED2Ev.exit
  tail call void @_ZdaPv(ptr noundef nonnull %i.s) #31
  br label %bb.g

bb.g:                                             ; preds = %bb.f, %_ZN5Eigen3RefIKNS_12SparseMatrixIdLi0EiEELi0ENS_11OuterStrideILin1EEEED2Ev.exit
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 48
  %i.v = load ptr, ptr %i.u, align 8, !tbaa !304  ; 2 uses
  %i.w = icmp eq ptr %i.v, null
  br i1 %i.w, label %_ZN5Eigen12SparseMatrixIdLi0EiED2Ev.exit, label %bb.h
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZN5Eigen8internal13SparseRefBaseINS_3RefIKNS_12SparseMatrixIdLi0EiEELi0ENS_11OuterStrideILin1EEEEEE9constructIS5_EEvRT_(ptr noundef nonnull align 8 dereferenceable(64) %0, ptr noundef nonnull align 8 dereferenceable(72) %1) local_unnamed_addr #0 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !255  ; 4 uses
  %i.c = icmp eq ptr %i.b, null
  %i.d = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.e = load i64, ptr %i.d, align 8, !tbaa !19   ; 2 uses
  %i.f = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.g = load i64, ptr %i.f, align 8, !tbaa !30   ; 24 uses
  br i1 %i.c, label %bb.b, label %bb.j

bb.b:                                             ; preds = %bb.a
  %i.h = mul nsw i64 %i.g, %i.e
  %i.i = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !302, !nonnull !17, !noundef !17 ; 12 uses
...
bb.e:                                             ; preds = %_ZN5Eigen8internalL21first_default_alignedINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEEElRKNS_9DenseBaseIT_EE.exit.i.i.i.i
  ...
  %i.z = load <2 x i64>, ptr %i.y, align 1, !tbaa !44 ; 2 uses
  %i.aa = icmp sgt i64 %i.r, 7
  br i1 %i.aa, label %bb.f, label %bb.h

bb.f:                                             ; preds = %bb.e
  %i.ab = getelementptr i8, ptr %i.y, i64 16
  %i.ac = load <4 x i32>, ptr %i.ab, align 1, !tbaa !44 ; 2 uses
...
.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i, %.lr.ph.preheader.i.i.i.i
  ...
  %i.ak = load <4 x i32>, ptr %i.aj, align 1, !tbaa !44
  ...
  %i.ao = load <4 x i32>, ptr %i.an, align 1, !tbaa !44
  %i.ap = add <4 x i32> %i.ao, %i.ai              ; 2 uses
  %.057.i.i.i.i = add nsw i64 %.05780.i.i.i.i, 8  ; 2 uses
  %i.aq = icmp slt i64 %.057.i.i.i.i, %i.w
  br i1 %i.aq, label %.lr.ph.i.i.i.i, label %._crit_edge.i.i.i.i, !llvm.loop !737

bb.g:                                             ; preds = %._crit_edge.i.i.i.i
  %i.ar = getelementptr inbounds [4 x i8], ptr %i.j, i64 %i.w
  %i.as = load <4 x i32>, ptr %i.ar, align 1, !tbaa !44
...
vector.body146:                                   ; preds = %vector.body146, %vector.ph144
  ...
  %wide.load150 = load <4 x i32>, ptr %i.bb, align 4, !tbaa !31
  %wide.load151 = load <4 x i32>, ptr %i.bc, align 4, !tbaa !31
  ...
  br i1 %i.bf, label %middle.block153, label %vector.body146, !llvm.loop !851
...
vector.body162:                                   ; preds = %vector.body162, %vector.ph160
  ...
  %wide.load166 = load <4 x i32>, ptr %i.bo, align 4, !tbaa !31
  %wide.load167 = load <4 x i32>, ptr %i.bp, align 4, !tbaa !31
  ...
  br i1 %i.bs, label %middle.block169, label %vector.body162, !llvm.loop !852
...
.lr.ph85.i.i.i.i:                                 ; preds = %.lr.ph85.i.i.i.i.preheader202, %.lr.ph85.i.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.i, label %.preheader.i.i.i.i, label %.lr.ph85.i.i.i.i, !llvm.loop !853
...
.lr.ph89.i.i.i.i:                                 ; preds = %.lr.ph89.i.i.i.i.preheader197, %.lr.ph89.i.i.i.i
  ...
  br i1 %i.cc, label %.lr.ph89.i.i.i.i, label %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit, !llvm.loop !854
...
bb.i:                                             ; preds = %_ZN5Eigen8internalL21first_default_alignedINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEEElRKNS_9DenseBaseIT_EE.exit.i.i.i.i
  %i.cd = load i32, ptr %i.j, align 4, !tbaa !31  ; 3 uses
...
vector.body178:                                   ; preds = %vector.body178, %vector.ph176
  ...
  %wide.load182 = load <4 x i32>, ptr %i.cj, align 4, !tbaa !31
  %wide.load183 = load <4 x i32>, ptr %i.ck, align 4, !tbaa !31
  ...
  br i1 %i.cn, label %middle.block185, label %vector.body178, !llvm.loop !855
...
.lr.ph94.i.i.i.i:                                 ; preds = %.lr.ph94.i.i.i.i.preheader194, %.lr.ph94.i.i.i.i
  ...
  br i1 %exitcond102.not.i.i.i.i, label %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit, label %.lr.ph94.i.i.i.i, !llvm.loop !856
...
bb.j:                                             ; preds = %bb.a
  ...
  %i.cz = load ptr, ptr %i.cy, align 8, !tbaa !302 ; 14 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.dc = load i32, ptr %i.db, align 4, !tbaa !31
  %i.dd = load i32, ptr %i.b, align 4, !tbaa !31
...
bb.o:                                             ; preds = %_ZN5Eigen8internalL21first_default_alignedINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEEElRKNS_9DenseBaseIT_EE.exit.i.i.i.i14
  ...
  %i.du = load <2 x i64>, ptr %i.dt, align 1, !tbaa !44 ; 2 uses
  %i.dv = icmp sgt i64 %i.dm, 7
  br i1 %i.dv, label %bb.p, label %bb.r

bb.p:                                             ; preds = %bb.o
  %i.dw = getelementptr i8, ptr %i.dt, i64 16
  %i.dx = load <4 x i32>, ptr %i.dw, align 1, !tbaa !44 ; 2 uses
...
.lr.ph.i.i.i.i38:                                 ; preds = %.lr.ph.i.i.i.i38, %.lr.ph.preheader.i.i.i.i36
  ...
  %i.ef = load <4 x i32>, ptr %i.ee, align 1, !tbaa !44
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %i.ew, align 4, !tbaa !31
  %wide.load109 = load <4 x i32>, ptr %i.ex, align 4, !tbaa !31
  ...
  br i1 %i.fa, label %middle.block, label %vector.body, !llvm.loop !859
...
vector.body114:                                   ; preds = %vector.body114, %vector.ph112
  ...
  %wide.load118 = load <4 x i32>, ptr %i.fj, align 4, !tbaa !31
  %wide.load119 = load <4 x i32>, ptr %i.fk, align 4, !tbaa !31
  ...
  br i1 %i.fn, label %middle.block121, label %vector.body114, !llvm.loop !860
...
.lr.ph85.i.i.i.i29:                               ; preds = %.lr.ph85.i.i.i.i29.preheader217, %.lr.ph85.i.i.i.i29
  ...
  br i1 %exitcond.not.i.i.i.i32, label %.preheader.i.i.i.i21, label %.lr.ph85.i.i.i.i29, !llvm.loop !861
...
.lr.ph89.i.i.i.i26:                               ; preds = %.lr.ph89.i.i.i.i26.preheader212, %.lr.ph89.i.i.i.i26
  ...
  %i.fu = load i32, ptr %i.ft, align 4, !tbaa !31
  %i.fv = add nsw i32 %i.fu, %.187.i.i.i.i28      ; 2 uses
  %i.fw = add nsw i64 %.05588.i.i.i.i27, 1        ; 2 uses
  %i.fx = icmp slt i64 %i.fw, %i.g
  br i1 %i.fx, label %.lr.ph89.i.i.i.i26, label %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit47, !llvm.loop !862
...
bb.s:                                             ; preds = %_ZN5Eigen8internalL21first_default_alignedINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEEElRKNS_9DenseBaseIT_EE.exit.i.i.i.i14
  %i.fy = load i32, ptr %i.cz, align 4, !tbaa !31 ; 3 uses
...
vector.body130:                                   ; preds = %vector.body130, %vector.ph128
  ...
  %wide.load134 = load <4 x i32>, ptr %i.ge, align 4, !tbaa !31
  %wide.load135 = load <4 x i32>, ptr %i.gf, align 4, !tbaa !31
  ...
  br i1 %i.gi, label %middle.block137, label %vector.body130, !llvm.loop !863
...
.lr.ph94.i.i.i.i43:                               ; preds = %.lr.ph94.i.i.i.i43.preheader208, %.lr.ph94.i.i.i.i43
  ...
  br i1 %exitcond102.not.i.i.i.i46, label %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit47, label %.lr.ph94.i.i.i.i43, !llvm.loop !864
...
_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit47: ; preds = %.lr.ph89.i.i.i.i26, %.lr.ph94.i.i.i.i43, %middle.block121, %middle.block137, %.preheader.i.i.i.i21, %bb.s, %bb.k, %bb.l
  ...
  %i.gp = load <2 x ptr>, ptr %i.go, align 8, !tbaa !394
  store i8 0, ptr %0, align 8, !tbaa !273
  %i.gq = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i64 %i.g, ptr %i.gq, align 8, !tbaa !857
  %i.gr = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i64 %i.e, ptr %i.gr, align 8, !tbaa !858
  %i.gs = getelementptr inbounds nuw i8, ptr %0, i64 24
  store i32 0, ptr %i.gs, align 8, !tbaa !31
  br label %bb.t
...
bb.t:                                             ; preds = %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit47, %_ZNK5Eigen20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEE8nonZerosEv.exit
  ...
  store i32 %.0.i25.sink, ptr %i.gu, align 4, !tbaa !31
  %i.gv = getelementptr inbounds nuw i8, ptr %0, i64 32
  store ptr %.sink94, ptr %i.gv, align 8, !tbaa !865
  %i.gw = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.gx = shufflevector <2 x ptr> %i.gt, <2 x ptr> poison, <2 x i32> <i32 1, i32 0>
  store <2 x ptr> %i.gx, ptr %i.gw, align 8, !tbaa !394
  %i.gy = getelementptr inbounds nuw i8, ptr %0, i64 56
  store ptr %.sink, ptr %i.gy, align 8, !tbaa !866
  ret void
}

; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local noundef nonnull align 8 dereferenceable(17) ptr @_ZN5Eigen22DiagonalPreconditionerIdE9factorizeINS_3RefIKNS_12SparseMatrixIdLi0EiEELi0ENS_11OuterStrideILin1EEEEEEERS1_RKT_(ptr noundef nonnull align 8 dereferenceable(17) %0, ptr noundef nonnull align 8 dereferenceable(137) %1) local_unnamed_addr #2 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 2 uses
  %i.b = load i64, ptr %i.a, align 8, !tbaa !857  ; 6 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.d = load i64, ptr %i.c, align 8, !tbaa !25
  %.not.i.i = icmp eq i64 %i.b, %i.d
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.f, label %bb.c, label %.sink.split.i.i

bb.c:                                             ; preds = %bb.b
end_hunk_4
begin_hunk_5_@_ZN5Eigen8internal43conservative_sparse_sparse_product_selectorINS_12SparseMatrixIdLi0EiEES3_S3_Li0ELi0ELi0EE3runERKS3_S6_RS3_:bb.a
  br label %bb.z

bb.z:                                             ; preds = %.body, %bb.x
  %.pn.pn = phi { ptr, i32 } [ %.pn, %.body ], [ %i.bc, %bb.x ]
  call void @_ZN5Eigen12SparseMatrixIdLi0EiED2Ev(ptr noundef nonnull align 8 dead_on_return(72) dereferenceable(72) %4) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #28
  br label %common.resume
...
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.b = load i64, ptr %i.a, align 8, !tbaa !19   ; 12 uses
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.d = load i64, ptr %i.c, align 8, !tbaa !30   ; 14 uses
...
bb.c:                                             ; preds = %bb.b
  %i.h = tail call ptr @__cxa_allocate_exception(i64 8) #28 ; 2 uses
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.h, align 8, !tbaa !256
...
bb.d:                                             ; preds = %_ZN5Eigen8internal14aligned_mallocEm.exit
  ...
  invoke void @__cxa_throw(ptr nonnull %i.k, ptr nonnull @_ZTISt9bad_alloc, ptr nonnull @_ZNSt9bad_allocD1Ev) #30
...
bb.f:                                             ; preds = %bb.e
  %i.x = tail call ptr @__cxa_allocate_exception(i64 8) #28 ; 2 uses
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.x, align 8, !tbaa !256
...
bb.g:                                             ; preds = %_ZN5Eigen8internal14aligned_mallocEm.exit143
  %i.aa = tail call ptr @__cxa_allocate_exception(i64 8) #28 ; 2 uses
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.aa, align 8, !tbaa !256
  invoke void @__cxa_throw(ptr nonnull %i.aa, ptr nonnull @_ZTISt9bad_alloc, ptr nonnull @_ZNSt9bad_allocD1Ev) #30
...
bb.h:                                             ; preds = %_ZN5Eigen8internal14aligned_mallocEm.exit143, %_ZN5Eigen8internal14aligned_mallocEm.exit143.thread
  ...
  %i.ag = load ptr, ptr %i.af, align 8, !tbaa !302 ; 13 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ao = load i32, ptr %i.aj, align 4, !tbaa !31
...
bb.j:                                             ; preds = %bb.h
  ...
  %i.as = load i64, ptr %i.ar, align 8, !tbaa !30 ; 11 uses
...
bb.m:                                             ; preds = %_ZN5Eigen8internalL21first_default_alignedINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEEElRKNS_9DenseBaseIT_EE.exit.i.i.i.i.i
  ...
  %i.bi = load <2 x i64>, ptr %i.bh, align 1, !tbaa !44 ; 2 uses
  %i.bj = icmp sgt i64 %i.ba, 7
  br i1 %i.bj, label %bb.n, label %bb.p

bb.n:                                             ; preds = %bb.m
  %i.bk = getelementptr i8, ptr %i.bh, i64 16
  %i.bl = load <4 x i32>, ptr %i.bk, align 1, !tbaa !44 ; 2 uses
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i, %.lr.ph.preheader.i.i.i.i.i
  ...
  %i.bt = load <4 x i32>, ptr %i.bs, align 1, !tbaa !44
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %i.ck, align 4, !tbaa !31
  %wide.load392 = load <4 x i32>, ptr %i.cl, align 4, !tbaa !31
  ...
  br i1 %i.co, label %middle.block, label %vector.body, !llvm.loop !946
...
vector.body397:                                   ; preds = %vector.body397, %vector.ph395
  ...
  %wide.load401 = load <4 x i32>, ptr %i.cx, align 4, !tbaa !31
  %wide.load402 = load <4 x i32>, ptr %i.cy, align 4, !tbaa !31
  ...
  br i1 %i.db, label %middle.block404, label %vector.body397, !llvm.loop !947
...
.lr.ph85.i.i.i.i.i:                               ; preds = %.lr.ph85.i.i.i.i.i.preheader515, %.lr.ph85.i.i.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.i.i, label %.preheader.i.i.i.i.i, label %.lr.ph85.i.i.i.i.i, !llvm.loop !948
...
.lr.ph89.i.i.i.i.i:                               ; preds = %.lr.ph89.i.i.i.i.i.preheader510, %.lr.ph89.i.i.i.i.i
  ...
  br i1 %i.dl, label %.lr.ph89.i.i.i.i.i, label %_ZNK5Eigen9DenseBaseINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEE3sumEv.exit.i.i, !llvm.loop !949
...
bb.q:                                             ; preds = %_ZN5Eigen8internalL21first_default_alignedINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEEElRKNS_9DenseBaseIT_EE.exit.i.i.i.i.i
  %i.dm = load i32, ptr %i.ag, align 4, !tbaa !31 ; 3 uses
...
vector.body413:                                   ; preds = %vector.body413, %vector.ph411
  ...
  %wide.load417 = load <4 x i32>, ptr %i.ds, align 4, !tbaa !31
  %wide.load418 = load <4 x i32>, ptr %i.dt, align 4, !tbaa !31
  ...
  br i1 %i.dw, label %middle.block420, label %vector.body413, !llvm.loop !950
...
.lr.ph94.i.i.i.i.i:                               ; preds = %.lr.ph94.i.i.i.i.i.preheader506, %.lr.ph94.i.i.i.i.i
  ...
  br i1 %exitcond102.not.i.i.i.i.i, label %_ZNK5Eigen9DenseBaseINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEE3sumEv.exit.i.i, label %.lr.ph94.i.i.i.i.i, !llvm.loop !951
...
_ZNK5Eigen8internal9evaluatorINS_20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEEEE16nonZerosEstimateEv.exit: ; preds = %_ZNK5Eigen9DenseBaseINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEE3sumEv.exit.i.i, %bb.j, %bb.i
  ...
  %i.ee = load ptr, ptr %i.ed, align 8, !tbaa !302 ; 13 uses
...
bb.v:                                             ; preds = %_ZN5Eigen8internalL21first_default_alignedINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEEElRKNS_9DenseBaseIT_EE.exit.i.i.i.i.i150
  ...
  %i.fc = load <2 x i64>, ptr %i.fb, align 1, !tbaa !44 ; 2 uses
  %i.fd = icmp sgt i64 %i.eu, 7
  br i1 %i.fd, label %bb.w, label %bb.y

bb.w:                                             ; preds = %bb.v
  %i.fe = getelementptr i8, ptr %i.fb, i64 16
  %i.ff = load <4 x i32>, ptr %i.fe, align 1, !tbaa !44 ; 2 uses
...
.lr.ph.i.i.i.i.i174:                              ; preds = %.lr.ph.i.i.i.i.i174, %.lr.ph.preheader.i.i.i.i.i172
  ...
  %i.fn = load <4 x i32>, ptr %i.fm, align 1, !tbaa !44
  ...
  %i.fr = load <4 x i32>, ptr %i.fq, align 1, !tbaa !44
  ...
  br i1 %i.ft, label %.lr.ph.i.i.i.i.i174, label %._crit_edge.i.i.i.i.i169, !llvm.loop !737

bb.x:                                             ; preds = %._crit_edge.i.i.i.i.i169
  %i.fu = getelementptr inbounds [4 x i8], ptr %i.ee, i64 %i.ez
  %i.fv = load <4 x i32>, ptr %i.fu, align 1, !tbaa !44
...
vector.body429:                                   ; preds = %vector.body429, %vector.ph427
  ...
  %wide.load433 = load <4 x i32>, ptr %i.ge, align 4, !tbaa !31
  %wide.load434 = load <4 x i32>, ptr %i.gf, align 4, !tbaa !31
  ...
  br i1 %i.gi, label %middle.block436, label %vector.body429, !llvm.loop !952
...
vector.body445:                                   ; preds = %vector.body445, %vector.ph443
  ...
  %wide.load449 = load <4 x i32>, ptr %i.gr, align 4, !tbaa !31
  %wide.load450 = load <4 x i32>, ptr %i.gs, align 4, !tbaa !31
  ...
  br i1 %i.gv, label %middle.block452, label %vector.body445, !llvm.loop !953
...
.lr.ph85.i.i.i.i.i165:                            ; preds = %.lr.ph85.i.i.i.i.i165.preheader500, %.lr.ph85.i.i.i.i.i165
  ...
  br i1 %exitcond.not.i.i.i.i.i168, label %.preheader.i.i.i.i.i157, label %.lr.ph85.i.i.i.i.i165, !llvm.loop !954
...
.lr.ph89.i.i.i.i.i162:                            ; preds = %.lr.ph89.i.i.i.i.i162.preheader495, %.lr.ph89.i.i.i.i.i162
  ...
  br i1 %i.hf, label %.lr.ph89.i.i.i.i.i162, label %_ZNK5Eigen9DenseBaseINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEE3sumEv.exit.i.i159, !llvm.loop !955
...
bb.z:                                             ; preds = %_ZN5Eigen8internalL21first_default_alignedINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEEElRKNS_9DenseBaseIT_EE.exit.i.i.i.i.i150
  %i.hg = load i32, ptr %i.ee, align 4, !tbaa !31 ; 3 uses
...
vector.body461:                                   ; preds = %vector.body461, %vector.ph459
  ...
  %wide.load465 = load <4 x i32>, ptr %i.hm, align 4, !tbaa !31
  %wide.load466 = load <4 x i32>, ptr %i.hn, align 4, !tbaa !31
  ...
  br i1 %i.hq, label %middle.block468, label %vector.body461, !llvm.loop !956
...
.lr.ph94.i.i.i.i.i179:                            ; preds = %.lr.ph94.i.i.i.i.i179.preheader491, %.lr.ph94.i.i.i.i.i179
  ...
  %i.ht = load i32, ptr %i.hs, align 4, !tbaa !31
  ...
  br i1 %exitcond102.not.i.i.i.i.i182, label %_ZNK5Eigen9DenseBaseINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEE3sumEv.exit.i.i159, label %.lr.ph94.i.i.i.i.i179, !llvm.loop !957
...
_ZNK5Eigen8internal9evaluatorINS_20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEEEE16nonZerosEstimateEv.exit183: ; preds = %_ZNK5Eigen9DenseBaseINS_3MapIKNS_6MatrixIiLin1ELi1ELi0ELin1ELi1EEELi0ENS_6StrideILi0ELi0EEEEEE3sumEv.exit.i.i159, %bb.s, %bb.r
  ...
  store i64 0, ptr %i.hy, align 8, !tbaa !556
  %i.hz = getelementptr inbounds nuw i8, ptr %2, i64 24 ; 6 uses
  %i.ia = load ptr, ptr %i.hz, align 8, !tbaa !255
  %i.ib = getelementptr inbounds nuw i8, ptr %2, i64 8 ; 3 uses
  %i.ic = load i64, ptr %i.ib, align 8, !tbaa !30
  %i.id = shl i64 %i.ic, 2
  %i.ie = add i64 %i.id, 4
  ...
  %i.ig = load ptr, ptr %i.if, align 8, !tbaa !302 ; 2 uses
...
bb.aa:                                            ; preds = %_ZNK5Eigen8internal9evaluatorINS_20SparseCompressedBaseINS_12SparseMatrixIdLi0EiEEEEE16nonZerosEstimateEv.exit183
  %i.ih = load i64, ptr %i.ib, align 8, !tbaa !30
  %i.ii = shl i64 %i.ih, 2
