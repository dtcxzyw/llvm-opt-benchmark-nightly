...
bb.k:                                             ; preds = %bb.j, %._crit_edge.i.i.i.i.i, %bb.h
  ...
  %i.ed = bitcast <2 x i64> %.sroa.067.2.i.i.i.i.i to <4 x i32> ; 2 uses
  ...
  %foldExtExtBinop = add nsw <4 x i32> %i.ef, %shift
  %3 = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %i.ed) ; 2 uses
