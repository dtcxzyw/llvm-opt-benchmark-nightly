...
._crit_edge:                                      ; preds = %bb.b
  ...
  %.phi.trans.insert217 = getelementptr inbounds nuw i8, ptr %1, i64 20
  %.pre218 = load float, ptr %.phi.trans.insert217, align 4
  %.phi.trans.insert219 = getelementptr inbounds nuw i8, ptr %1, i64 24
  %.pre220 = load float, ptr %.phi.trans.insert219, align 8
  %3 = load <7 x float>, ptr %.phi.trans.insert, align 16
  %4 = shufflevector <7 x float> %3, <7 x float> poison, <4 x i32> <i32 0, i32 4, i32 5, i32 6>
  br label %bb.l
...
._crit_edge227:                                   ; preds = %bb.f
  ...
  %.phi.trans.insert230 = getelementptr inbounds nuw i8, ptr %1, i64 68
  %.pre231 = load float, ptr %.phi.trans.insert230, align 4
  %.phi.trans.insert232 = getelementptr inbounds nuw i8, ptr %1, i64 72
  %.pre233 = load float, ptr %.phi.trans.insert232, align 8
  %5 = load <7 x float>, ptr %.phi.trans.insert228, align 16
  %6 = shufflevector <7 x float> %5, <7 x float> poison, <4 x i32> <i32 0, i32 4, i32 5, i32 6>
  br label %bb.h
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.bo = load <4 x float>, ptr %i.bl, align 16, !noalias !101 ; 4 uses
  ...
  %i.bt = load <4 x float>, ptr %i.bq, align 16, !noalias !106 ; 4 uses
  ...
  %7 = extractelement <4 x float> %i.bo, i64 1
  %8 = extractelement <4 x float> %i.bo, i64 2
  %9 = extractelement <4 x float> %i.bt, i64 1
  %10 = extractelement <4 x float> %i.bt, i64 2
  %11 = shufflevector <4 x float> %i.bt, <4 x float> %i.bs, <4 x i32> <i32 0, i32 4, i32 5, i32 6>
  %12 = shufflevector <4 x float> %i.bo, <4 x float> %i.bn, <4 x i32> <i32 0, i32 4, i32 5, i32 6>
  br i1 %i.ce, label %bb.h, label %bb.l

bb.h:                                             ; preds = %._crit_edge227, %bb.g
  %13 = phi float [ %.pre233, %._crit_edge227 ], [ %10, %bb.g ]
  %14 = phi float [ %.pre231, %._crit_edge227 ], [ %9, %bb.g ]
  %i.cf = phi <4 x float> [ %6, %._crit_edge227 ], [ %11, %bb.g ] ; 4 uses
  ...
  %i.cm = shufflevector <4 x float> %15, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.cq = shufflevector <4 x float> %16, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %17 = shufflevector <4 x float> %i.cf, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.cv = getelementptr inbounds nuw i8, ptr %i.cg, i64 48 ; 2 uses
  %i.cw = load <4 x float>, ptr %i.cv, align 16, !noalias !120
  %i.cx = tail call noundef <4 x float> @llvm.x86.sse.min.ps(<4 x float> %17, <4 x float> %i.cw)
  %18 = shufflevector <4 x float> %i.cf, <4 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %i.cy = getelementptr inbounds nuw i8, ptr %i.cg, i64 80 ; 2 uses
  %i.cz = load <4 x float>, ptr %i.cy, align 16, !noalias !123
  %i.da = tail call noundef <4 x float> @llvm.x86.sse.min.ps(<4 x float> %18, <4 x float> %i.cz)
  %19 = shufflevector <4 x float> %i.cf, <4 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
  %i.db = getelementptr inbounds nuw i8, ptr %i.cg, i64 112 ; 2 uses
  %i.dc = load <4 x float>, ptr %i.db, align 16, !noalias !126
  %i.dd = tail call noundef <4 x float> @llvm.x86.sse.min.ps(<4 x float> %19, <4 x float> %i.dc)
...
bb.l:                                             ; preds = %._crit_edge, %bb.g
  %20 = phi float [ %8, %bb.g ], [ %.pre220, %._crit_edge ]
  %21 = phi float [ %7, %bb.g ], [ %.pre218, %._crit_edge ]
  %i.gi = phi <4 x float> [ %12, %bb.g ], [ %4, %._crit_edge ] ; 4 uses
  ...
  %i.gp = shufflevector <4 x float> %22, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %23 = insertelement <4 x float> poison, float %20, i64 0
  %i.gt = shufflevector <4 x float> %23, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %24 = shufflevector <4 x float> %i.gi, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.gy = getelementptr inbounds nuw i8, ptr %i.gj, i64 48 ; 2 uses
  %i.gz = load <4 x float>, ptr %i.gy, align 16, !noalias !144
  %i.ha = tail call noundef <4 x float> @llvm.x86.sse.min.ps(<4 x float> %24, <4 x float> %i.gz)
  %25 = shufflevector <4 x float> %i.gi, <4 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %i.hb = getelementptr inbounds nuw i8, ptr %i.gj, i64 80 ; 2 uses
  %i.hc = load <4 x float>, ptr %i.hb, align 16, !noalias !147
  %i.hd = tail call noundef <4 x float> @llvm.x86.sse.min.ps(<4 x float> %25, <4 x float> %i.hc)
  %26 = shufflevector <4 x float> %i.gi, <4 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
...
._crit_edge:                                      ; preds = %bb.b
  ...
  %.pre107 = load float, ptr %.phi.trans.insert, align 4
  %.phi.trans.insert108 = getelementptr inbounds nuw i8, ptr %2, i64 8
  %.pre109 = load float, ptr %.phi.trans.insert108, align 8
  %9 = load <7 x float>, ptr %2, align 16
  %10 = shufflevector <7 x float> %9, <7 x float> poison, <4 x i32> <i32 0, i32 4, i32 5, i32 6>
  br label %bb.h
...
._crit_edge116:                                   ; preds = %bb.d
  %.phi.trans.insert118 = getelementptr inbounds nuw i8, ptr %4, i64 4
  %.pre119 = load float, ptr %.phi.trans.insert118, align 4
  %.phi.trans.insert120 = getelementptr inbounds nuw i8, ptr %4, i64 8
  %.pre121 = load float, ptr %.phi.trans.insert120, align 8
  %11 = load <7 x float>, ptr %4, align 16
  %12 = shufflevector <7 x float> %11, <7 x float> poison, <4 x i32> <i32 0, i32 4, i32 5, i32 6>
  br label %bb.f

bb.e:                                             ; preds = %bb.d
  %i.e = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.f = load <4 x float>, ptr %i.e, align 16, !noalias !168 ; 2 uses
  %i.g = load <4 x float>, ptr %2, align 16, !noalias !168 ; 4 uses
  %i.h = fsub <4 x float> %i.f, %i.g              ; 3 uses
  %i.i = getelementptr inbounds nuw i8, ptr %4, i64 16
  %13 = load <4 x float>, ptr %i.i, align 16, !noalias !173 ; 2 uses
  %i.j = load <4 x float>, ptr %4, align 16, !noalias !173 ; 4 uses
  %i.k = fsub <4 x float> %13, %i.j               ; 3 uses
  ...
  %14 = extractelement <4 x float> %i.g, i64 1
  %15 = extractelement <4 x float> %i.g, i64 2
  %i.v = extractelement <4 x float> %i.j, i64 1
  %i.w = extractelement <4 x float> %i.j, i64 2
  %16 = shufflevector <4 x float> %i.j, <4 x float> %13, <4 x i32> <i32 0, i32 4, i32 5, i32 6>
  %17 = shufflevector <4 x float> %i.g, <4 x float> %i.f, <4 x i32> <i32 0, i32 4, i32 5, i32 6>
  br i1 %i.u, label %bb.f, label %bb.h

bb.f:                                             ; preds = %._crit_edge116, %bb.e
  %18 = phi float [ %.pre121, %._crit_edge116 ], [ %i.w, %bb.e ]
  %i.x = phi float [ %.pre119, %._crit_edge116 ], [ %i.v, %bb.e ]
  %i.y = phi <4 x float> [ %12, %._crit_edge116 ], [ %16, %bb.e ] ; 4 uses
  %i.z = inttoptr i64 %1 to ptr                   ; 7 uses
  %i.aa = shufflevector <4 x float> %i.y, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %19 = insertelement <4 x float> poison, float %i.x, i64 0
  %i.ae = shufflevector <4 x float> %19, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.ai = shufflevector <4 x float> %20, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %21 = shufflevector <4 x float> %i.y, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.am = getelementptr inbounds nuw i8, ptr %i.z, i64 48 ; 2 uses
  %i.an = load <4 x float>, ptr %i.am, align 16, !noalias !187
  %i.ao = tail call noundef <4 x float> @llvm.x86.sse.min.ps(<4 x float> %21, <4 x float> %i.an)
  %22 = shufflevector <4 x float> %i.y, <4 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %i.ap = getelementptr inbounds nuw i8, ptr %i.z, i64 80 ; 2 uses
  %i.aq = load <4 x float>, ptr %i.ap, align 16, !noalias !190
  %i.ar = tail call noundef <4 x float> @llvm.x86.sse.min.ps(<4 x float> %22, <4 x float> %i.aq)
  %23 = shufflevector <4 x float> %i.y, <4 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
  %i.as = getelementptr inbounds nuw i8, ptr %i.z, i64 112 ; 2 uses
  %i.at = load <4 x float>, ptr %i.as, align 16, !noalias !193
  %i.au = tail call noundef <4 x float> @llvm.x86.sse.min.ps(<4 x float> %23, <4 x float> %i.at)
...
bb.h:                                             ; preds = %._crit_edge, %bb.e
  %i.cc = phi float [ %.pre109, %._crit_edge ], [ %15, %bb.e ]
  %24 = phi float [ %.pre107, %._crit_edge ], [ %14, %bb.e ]
  %i.cd = phi <4 x float> [ %10, %._crit_edge ], [ %17, %bb.e ] ; 4 uses
  ...
  %i.cj = shufflevector <4 x float> %25, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.cn = shufflevector <4 x float> %26, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %27 = shufflevector <4 x float> %i.cd, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.cr = getelementptr inbounds nuw i8, ptr %i.ce, i64 48 ; 2 uses
  %i.cs = load <4 x float>, ptr %i.cr, align 16, !noalias !209
  %i.ct = tail call noundef <4 x float> @llvm.x86.sse.min.ps(<4 x float> %27, <4 x float> %i.cs)
  %28 = shufflevector <4 x float> %i.cd, <4 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %i.cu = getelementptr inbounds nuw i8, ptr %i.ce, i64 80 ; 2 uses
  %i.cv = load <4 x float>, ptr %i.cu, align 16, !noalias !212
  %i.cw = tail call noundef <4 x float> @llvm.x86.sse.min.ps(<4 x float> %28, <4 x float> %i.cv)
  %29 = shufflevector <4 x float> %i.cd, <4 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
  %i.cx = getelementptr inbounds nuw i8, ptr %i.ce, i64 112 ; 2 uses
  %i.cy = load <4 x float>, ptr %i.cx, align 16, !noalias !215
  %i.cz = tail call noundef <4 x float> @llvm.x86.sse.min.ps(<4 x float> %29, <4 x float> %i.cy)
