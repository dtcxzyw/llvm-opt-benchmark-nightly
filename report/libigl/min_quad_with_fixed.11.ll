...
.invoke:                                          ; preds = %_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit.i.i, %bb.b
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.bh, align 8, !tbaa !71
...
.sink.split.i:                                    ; preds = %_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit.i.i, %bb.a
  ...
  store ptr %.sink.i, ptr %27, align 8, !tbaa !63
...
bb.c:                                             ; preds = %.invoke
  %i.bi = landingpad { ptr, i32 }
          cleanup
  %i.bj = load ptr, ptr %27, align 8, !tbaa !63
...
_ZN5Eigen6MatrixIdLin1ELin1ELi0ELin1ELin1EEC2IliEERKT_RKT0_.exit: ; preds = %.sink.split.i, %_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEE6resizeEll.exit.i.i
  ...
  store i64 %i.az, ptr %i.ba, align 8, !tbaa !68
  store i64 1, ptr %i.bb, align 8, !tbaa !72
  %i.bl = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.bm = load i64, ptr %i.bl, align 8, !tbaa !72
  %i.bn = mul nsw i64 %i.bm, %i.aw
  %58 = icmp sgt i64 %i.bn, 0
  %i.bo = icmp sgt i64 %i.aw, 0
  %or.cond = and i1 %58, %i.bo
  br i1 %or.cond, label %.preheader.i.i.i.i.i.i.i.i.i.i.preheader.preheader, label %_ZN5Eigen5BlockINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEELin1ELin1ELb0EEaSINS_9ReplicateIS2_Lin1ELin1EEEEERS3_RKNS_9DenseBaseIT_EE.exit

.preheader.i.i.i.i.i.i.i.i.i.i.preheader.preheader: ; preds = %_ZN5Eigen6MatrixIdLin1ELin1ELi0ELin1ELin1EEC2IliEERKT_RKT0_.exit
  %i.bp = ptrtoaddr ptr %i.bk to i64
  %59 = load ptr, ptr %1, align 8, !tbaa !63      ; 7 uses
  %min.iters.check547 = icmp ult i64 %i.aw, 8
  %60 = ptrtoaddr ptr %59 to i64
  %i.bq = sub i64 %60, %i.bp
...
vector.body550:                                   ; preds = %vector.body550, %vector.ph548
  ...
  %wide.load552 = load <2 x double>, ptr %i.bs, align 8, !tbaa !65
  %wide.load553 = load <2 x double>, ptr %i.bt, align 8, !tbaa !65
  %i.bu = getelementptr i8, ptr %i.br, i64 16
  store <2 x double> %wide.load552, ptr %i.br, align 8, !tbaa !65
  store <2 x double> %wide.load553, ptr %i.bu, align 8, !tbaa !65
  %index.next554 = add nuw i64 %index551, 4       ; 2 uses
  %i.bv = icmp eq i64 %index.next554, %n.vec549
  br i1 %i.bv, label %middle.block555, label %vector.body550, !llvm.loop !247
...
.preheader.i.i.i.i.i.i.i.i.i.i.preheader.prol:    ; preds = %.preheader.i.i.i.i.i.i.i.i.i.i.preheader.preheader619, %.preheader.i.i.i.i.i.i.i.i.i.i.preheader.prol
  ...
  %i.bx = load double, ptr %gep.i.i.i.i.i.i.i.i.i.i.prol, align 8, !tbaa !65
  store double %i.bx, ptr %i.bw, align 8, !tbaa !65
  ...
  br i1 %prol.iter634.cmp.not, label %.preheader.i.i.i.i.i.i.i.i.i.i.preheader.prol.loopexit, label %.preheader.i.i.i.i.i.i.i.i.i.i.preheader.prol, !llvm.loop !248
...
.preheader.i.i.i.i.i.i.i.i.i.i.preheader:         ; preds = %.preheader.i.i.i.i.i.i.i.i.i.i.preheader.prol.loopexit, %.preheader.i.i.i.i.i.i.i.i.i.i.preheader
  ...
  %i.cc = load double, ptr %gep.i.i.i.i.i.i.i.i.i.i, align 8, !tbaa !65
  store double %i.cc, ptr %i.cb, align 8, !tbaa !65
  ...
  %i.cf = load double, ptr %gep.i.i.i.i.i.i.i.i.i.i.1, align 8, !tbaa !65
  store double %i.cf, ptr %i.ce, align 8, !tbaa !65
  ...
  %i.ci = load double, ptr %gep.i.i.i.i.i.i.i.i.i.i.2, align 8, !tbaa !65
  store double %i.ci, ptr %i.ch, align 8, !tbaa !65
  ...
  %i.cl = load double, ptr %gep.i.i.i.i.i.i.i.i.i.i.3, align 8, !tbaa !65
  store double %i.cl, ptr %i.ck, align 8, !tbaa !65
  %i.cm = add nuw nsw i64 %.09.i.i.i.i.i.i.i.i.i.i, 4 ; 2 uses
  %exitcond.not.i.i.i.i.i.i.i.i.i.i.3 = icmp eq i64 %i.cm, %i.aw
  br i1 %exitcond.not.i.i.i.i.i.i.i.i.i.i.3, label %_ZN5Eigen5BlockINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEELin1ELin1ELb0EEaSINS_9ReplicateIS2_Lin1ELin1EEEEERS3_RKNS_9DenseBaseIT_EE.exit, label %.preheader.i.i.i.i.i.i.i.i.i.i.preheader, !llvm.loop !249

_ZN5Eigen5BlockINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEELin1ELin1ELb0EEaSINS_9ReplicateIS2_Lin1ELin1EEEEERS3_RKNS_9DenseBaseIT_EE.exit: ; preds = %.preheader.i.i.i.i.i.i.i.i.i.i.preheader.prol.loopexit, %.preheader.i.i.i.i.i.i.i.i.i.i.preheader, %middle.block555, %_ZN5Eigen6MatrixIdLin1ELin1ELi0ELin1ELin1EEC2IliEERKT_RKT0_.exit
...
.preheader.lr.ph.i.i.i.i.i.i.i.i.i.i195:          ; preds = %_ZN5Eigen5BlockINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEELin1ELin1ELb0EEaSINS_9ReplicateIS2_Lin1ELin1EEEEERS3_RKNS_9DenseBaseIT_EE.exit
  %i.co = load ptr, ptr %27, align 8, !tbaa !63, !noalias !316 ; 2 uses
  %i.cp = getelementptr inbounds [8 x i8], ptr %i.co, i64 %i.aw ; 6 uses
  %i.cq = load ptr, ptr %3, align 8, !tbaa !61    ; 7 uses
...
vector.body564:                                   ; preds = %vector.body564, %vector.ph562
  ...
  %wide.load566 = load <2 x double>, ptr %i.cx, align 8, !tbaa !65
  %wide.load567 = load <2 x double>, ptr %i.cy, align 8, !tbaa !65
  ...
  store <2 x double> %i.cz, ptr %i.cw, align 8, !tbaa !65
  store <2 x double> %i.da, ptr %i.db, align 8, !tbaa !65
  %index.next568 = add nuw i64 %index565, 4       ; 2 uses
  %i.dc = icmp eq i64 %index.next568, %n.vec563
  br i1 %i.dc, label %middle.block569, label %vector.body564, !llvm.loop !252
...
scalar.ph560.prol:                                ; preds = %scalar.ph560.preheader, %scalar.ph560.prol
  ...
  store double %i.dg, ptr %i.dd, align 8, !tbaa !65
  ...
  br i1 %prol.iter637.cmp.not, label %scalar.ph560.prol.loopexit, label %scalar.ph560.prol, !llvm.loop !253
...
scalar.ph560:                                     ; preds = %scalar.ph560.prol.loopexit, %scalar.ph560
  ...
  %i.dm = load double, ptr %i.dl, align 8, !tbaa !65
  %i.dn = fmul double %i.dm, -2.000000e+00
  store double %i.dn, ptr %i.dk, align 8, !tbaa !65
  ...
  store double %i.ds, ptr %i.dp, align 8, !tbaa !65
  ...
  store double %i.dx, ptr %i.du, align 8, !tbaa !65
...
bb.f:                                             ; preds = %bb.e
  %i.ei = load ptr, ptr %28, align 8, !tbaa !63   ; 8 uses
  %i.ej = ptrtoaddr ptr %i.ei to i64
  %i.ek = getelementptr inbounds nuw i8, ptr %28, i64 8
  %i.el = load i64, ptr %i.ek, align 8, !tbaa !68 ; 6 uses
  %i.em = getelementptr inbounds nuw i8, ptr %28, i64 16
  %i.en = load i64, ptr %i.em, align 8, !tbaa !72 ; 6 uses
...
._crit_edge456.thread512:                         ; preds = %_ZN5Eigen15PlainObjectBaseINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEEE6resizeEll.exit.i.i.i.i.i.i.i.i
  store i64 %i.el, ptr %i.eo, align 8, !tbaa !68
...
.invoke520:                                       ; preds = %_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit.i.i286, %bb.j, %bb.h
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.fa, align 8, !tbaa !71
...
._crit_edge456:                                   ; preds = %_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit.i.i286
  store ptr %i.ey, ptr %30, align 8, !tbaa !63
  store i64 %i.el, ptr %i.eo, align 8, !tbaa !68
  store i64 %i.en, ptr %i.ep, align 8, !tbaa !72
