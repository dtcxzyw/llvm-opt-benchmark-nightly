...
begin_hunk_1_@_ZN5Eigen8internal26call_dense_assignment_loopINS_5BlockINS2_INS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEELin1ELin1ELb0EEELin1ELin1ELb0EEENS_7ProductINS_13CwiseBinaryOpINS0_17scalar_product_opIddEEKNS_14CwiseNullaryOpINS0_18scalar_constant_opIdEEKS4_EEKNS2_IKNS3_IdLin1ELin1ELi0ELin1ELin1EEELin1ELi1ELb0EEEEENS_3MapINS3_IdLi1ELin1ELi1ELi1ELi1EEELi0ENS_6StrideILi0ELi0EEEEELi1EEENS0_13sub_assign_opIddEEEEvRT_RKT0_RKT1_:bb.a
  ...
  store ptr %4, ptr %5, align 8, !tbaa !1273
  %i.by = getelementptr inbounds nuw i8, ptr %5, i64 8
  store ptr %3, ptr %i.by, align 8, !tbaa !1274
  %i.bz = getelementptr inbounds nuw i8, ptr %5, i64 16
  store ptr %2, ptr %i.bz, align 8, !tbaa !1275
  %i.ca = getelementptr inbounds nuw i8, ptr %5, i64 24
  store ptr %0, ptr %i.ca, align 8, !tbaa !1276
...
bb.c:                                             ; preds = %.loopexit
  ...
  %i.cb = load ptr, ptr %3, align 8, !tbaa !19
  call void @free(ptr noundef %i.cb) #24
...
bb.d:                                             ; preds = %.loopexit
  ...
  call void @free(ptr noundef %i.cd) #24
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #24
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !1305, !nonnull !89, !align !110 ; 6 uses
...
.preheader.lr.ph.i:                               ; preds = %bb.b
  ...
  %i.j = load i64, ptr %i.i, align 8, !tbaa !34   ; 9 uses
...
.preheader.lr.ph.split.i:                         ; preds = %.preheader.lr.ph.i
  ...
  %i.m = load ptr, ptr %i.l, align 8, !nonnull !89, !align !110 ; 2 uses
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 16
  %i.o = load ptr, ptr %0, align 8, !nonnull !89, !align !110 ; 2 uses
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 16
  %i.q = load ptr, ptr %i.o, align 8, !tbaa !205  ; 4 uses
  %i.r = load i64, ptr %i.p, align 8, !tbaa !34   ; 3 uses
  %i.s = load ptr, ptr %i.m, align 8, !tbaa !19, !noalias !1306 ; 6 uses
  %i.t = load ptr, ptr %i.n, align 8, !tbaa !200, !noalias !1307 ; 3 uses
...
vector.ph:                                        ; preds = %.preheader.i
  %i.ae = load double, ptr %i.ad, align 8, !tbaa !21, !alias.scope !1308
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.ag, align 8, !tbaa !21, !alias.scope !1309
  %wide.load69 = load <2 x double>, ptr %i.ah, align 8, !tbaa !21, !alias.scope !1309
  ...
  %wide.load70 = load <2 x double>, ptr %i.af, align 8, !tbaa !21, !alias.scope !1310, !noalias !1311
  %wide.load71 = load <2 x double>, ptr %i.ak, align 8, !tbaa !21, !alias.scope !1310, !noalias !1311
  %i.al = fsub <2 x double> %wide.load70, %i.ai
  %i.am = fsub <2 x double> %wide.load71, %i.aj
  store <2 x double> %i.al, ptr %i.af, align 8, !tbaa !21, !alias.scope !1310, !noalias !1311
  store <2 x double> %i.am, ptr %i.ak, align 8, !tbaa !21, !alias.scope !1310, !noalias !1311
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.an = icmp eq i64 %index.next, %n.vec
  br i1 %i.an, label %middle.block, label %vector.body, !llvm.loop !1285
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader
  ...
  %i.ar = load double, ptr %i.ad, align 8, !tbaa !21
  %i.as = fmul double %i.aq, %i.ar
  %i.at = load double, ptr %i.ao, align 8, !tbaa !21
  %i.au = fsub double %i.at, %i.as
  store double %i.au, ptr %i.ao, align 8, !tbaa !21
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.bb = load double, ptr %i.ad, align 8, !tbaa !21
  %i.bc = fmul double %i.ba, %i.bb
  %i.bd = load double, ptr %i.ay, align 8, !tbaa !21
  %i.be = fsub double %i.bd, %i.bc
  store double %i.be, ptr %i.ay, align 8, !tbaa !21
  ...
  %i.bj = load double, ptr %i.ad, align 8, !tbaa !21
  %i.bk = fmul double %i.bi, %i.bj
  %i.bl = load double, ptr %i.bg, align 8, !tbaa !21
  %i.bm = fsub double %i.bl, %i.bk
  store double %i.bm, ptr %i.bg, align 8, !tbaa !21
...
_ZN5Eigen8internal13first_alignedILi16EdlEET1_PKT0_S2_.exit: ; preds = %bb.a
  ...
  %i.bp = load i64, ptr %i.bo, align 8, !tbaa !34 ; 7 uses
  %i.bq = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  %i.br = load i64, ptr %i.bq, align 8, !tbaa !34 ; 2 uses
  %i.bs = getelementptr inbounds nuw i8, ptr %i.b, i64 48
  %i.bt = load ptr, ptr %i.bs, align 8, !tbaa !111, !nonnull !89, !align !110
...
.preheader43.loopexit:                            ; preds = %bb.c
  %i.ci = load ptr, ptr %i.cb, align 8, !tbaa !1312, !nonnull !89, !align !110 ; 2 uses
  %i.cj = getelementptr inbounds nuw i8, ptr %i.ci, i64 16
  %i.ck = load ptr, ptr %i.cj, align 8, !tbaa !200, !noalias !1313
  %i.cl = getelementptr inbounds nuw [8 x i8], ptr %i.ck, i64 %.03451
  %i.cm = load ptr, ptr %i.ci, align 8, !tbaa !19, !noalias !1314
  %i.cn = load ptr, ptr %0, align 8, !tbaa !1315, !nonnull !89, !align !110 ; 2 uses
  %i.co = load ptr, ptr %i.cn, align 8, !tbaa !205
  %i.cp = getelementptr inbounds nuw i8, ptr %i.cn, i64 16
  %i.cq = load i64, ptr %i.cp, align 8, !tbaa !34
  %i.cr = mul nsw i64 %i.cq, %.03451
  %i.cs = getelementptr [8 x i8], ptr %i.co, i64 %i.cr ; 2 uses
  %i.ct = load double, ptr %i.cm, align 8, !tbaa !21
  %i.cu = load double, ptr %i.cl, align 8, !tbaa !21
  %i.cv = fmul double %i.ct, %i.cu
  %i.cw = load double, ptr %i.cs, align 8, !tbaa !21
  %i.cx = fsub double %i.cw, %i.cv
  store double %i.cx, ptr %i.cs, align 8, !tbaa !21
...
.lr.ph49:                                         ; preds = %.preheader
  %i.da = load ptr, ptr %0, align 8, !tbaa !1315, !nonnull !89, !align !110 ; 2 uses
  %i.db = load ptr, ptr %i.da, align 8, !tbaa !205 ; 3 uses
  ...
  %i.dg = load ptr, ptr %i.cb, align 8, !tbaa !1312, !nonnull !89, !align !110 ; 2 uses
  %i.dh = load ptr, ptr %i.dg, align 8, !tbaa !19, !noalias !1316 ; 4 uses
  %i.di = getelementptr inbounds nuw i8, ptr %i.dg, i64 16
  %i.dj = load ptr, ptr %i.di, align 8, !tbaa !200, !noalias !1317 ; 2 uses
...
vector.ph88:                                      ; preds = %vector.memcheck72
  ...
  %i.dw = load double, ptr %i.dk, align 8, !tbaa !21, !alias.scope !1318
...
vector.body90:                                    ; preds = %vector.body90, %vector.ph88
  ...
  %wide.load92 = load <2 x double>, ptr %i.dz, align 8, !tbaa !21, !alias.scope !1319
  %wide.load93 = load <2 x double>, ptr %i.ea, align 8, !tbaa !21, !alias.scope !1319
  ...
  %wide.load96 = load <2 x double>, ptr %i.dy, align 8, !tbaa !21, !alias.scope !1320, !noalias !1321
  %wide.load97 = load <2 x double>, ptr %i.ed, align 8, !tbaa !21, !alias.scope !1320, !noalias !1321
  %i.ee = fsub <2 x double> %wide.load96, %i.eb
  %i.ef = fsub <2 x double> %wide.load97, %i.ec
  store <2 x double> %i.ee, ptr %i.dy, align 8, !tbaa !21, !alias.scope !1320, !noalias !1321
  store <2 x double> %i.ef, ptr %i.ed, align 8, !tbaa !21, !alias.scope !1320, !noalias !1321
  %index.next98 = add nuw i64 %index91, 4         ; 2 uses
  %i.eg = icmp eq i64 %index.next98, %n.vec89
  br i1 %i.eg, label %middle.block99, label %vector.body90, !llvm.loop !1300
...
.lr.ph47:                                         ; preds = %.preheader43, %.lr.ph47
  ...
  %i.eh = load ptr, ptr %0, align 8, !tbaa !1315, !nonnull !89, !align !110 ; 2 uses
  %i.ei = load ptr, ptr %i.eh, align 8, !tbaa !205
  %i.ej = getelementptr inbounds nuw i8, ptr %i.eh, i64 16
  %i.ek = load i64, ptr %i.ej, align 8, !tbaa !34
  ...
  %i.eo = load ptr, ptr %i.cb, align 8, !tbaa !1312, !nonnull !89, !align !110 ; 2 uses
  %i.ep = getelementptr inbounds nuw i8, ptr %i.eo, i64 48
  %i.eq = getelementptr inbounds nuw i8, ptr %i.eo, i64 56
  %i.er = load ptr, ptr %i.ep, align 8, !tbaa !1322
  %i.es = getelementptr inbounds [8 x i8], ptr %i.er, i64 %.03246
  %i.et = load <2 x double>, ptr %i.es, align 1, !tbaa !30
  %i.eu = load ptr, ptr %i.eq, align 8, !tbaa !202
  %i.ev = getelementptr [8 x i8], ptr %i.eu, i64 %.03451
  %i.ew = load double, ptr %i.ev, align 8, !tbaa !21
  ...
  %i.fa = load <2 x double>, ptr %i.en, align 16, !tbaa !30
  %i.fb = fsub <2 x double> %i.fa, %i.ez
  store <2 x double> %i.fb, ptr %i.en, align 16, !tbaa !30
  %i.fc = add nsw i64 %.03246, 2                  ; 2 uses
  %i.fd = icmp slt i64 %i.fc, %i.cg
  br i1 %i.fd, label %.lr.ph47, label %.preheader, !llvm.loop !1301
...
scalar.ph86:                                      ; preds = %scalar.ph86.preheader, %scalar.ph86
  ...
  %i.fk = load double, ptr %i.dk, align 8, !tbaa !21
  %i.fl = fmul double %i.fj, %i.fk
  %i.fm = load double, ptr %i.fh, align 8, !tbaa !21
  %i.fn = fsub double %i.fm, %i.fl
  store double %i.fn, ptr %i.fh, align 8, !tbaa !21
  %i.fo = add nsw i64 %.048, 1                    ; 2 uses
  %i.fp = icmp slt i64 %i.fo, %i.bp
  br i1 %i.fp, label %scalar.ph86, label %._crit_edge, !llvm.loop !1303
...
bb.b:                                             ; preds = %bb.a
  %i.d = tail call ptr @__cxa_allocate_exception(i64 8) #24 ; 2 uses
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.d, align 8, !tbaa !27
  tail call void @__cxa_throw(ptr nonnull %i.d, ptr nonnull @_ZTISt9bad_alloc, ptr nonnull @_ZNSt9bad_allocD1Ev) #26
  unreachable

_ZN5Eigen8internal23check_size_for_overflowIdEEvm.exit: ; preds = %bb.a
  %i.e = load ptr, ptr %1, align 8, !tbaa !93     ; 2 uses
...
bb.e:                                             ; preds = %bb.c
  %i.j = tail call noalias ptr @malloc(i64 noundef %i.f) #25 ; 3 uses
