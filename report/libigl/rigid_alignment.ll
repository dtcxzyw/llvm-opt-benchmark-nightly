...
bb.ck:                                            ; preds = %_ZN5Eigen8internal24call_assignment_no_aliasINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEENS_5SolveINS_31CompleteOrthogonalDecompositionINS2_IdLin1ELin1ELi0ELin1ELin1EEEEES3_EENS0_9assign_opIddEEEEvRT_RKT0_RKT1_.exit.i.i.i
  ...
  %i.cre = load <2 x double>, ptr %i.crd, align 8, !tbaa !21 ; 5 uses
  %i.crf = extractelement <2 x double> %i.cre, i64 1 ; 2 uses
  %i.crg = extractelement <2 x double> %i.cre, i64 0 ; 2 uses
...
bb.co:                                            ; preds = %bb.cl
  ...
  %33 = extractelement <2 x double> %.sroa.01256.16..sroa.01256.16..sroa.01256.16., i64 0
  ...
  %34 = extractelement <2 x double> %i.csf, i64 1 ; 2 uses
  ...
  %35 = fmul double %34, %i.crk                   ; 2 uses
  %36 = fmul double %34, %33                      ; 2 uses
  %i.ctj = fmul double %35, %i.crj
  %i.ctk = insertelement <2 x double> <double 1.000000e+00, double poison>, double %i.ctj, i64 1
  %i.ctl = fadd <2 x double> %i.csh, %i.ctk       ; 3 uses
  %.sroa.0.8.vec.insert.i.i.i.i = insertelement <2 x double> %i.ctl, double %i.csk, i64 1
  %i.ctm = extractelement <2 x double> %i.ctl, i64 0 ; 2 uses
  ...
  %i.ctp = shufflevector <2 x double> %37, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.cts = fmul <2 x double> %39, %i.ctr          ; 2 uses
  ...
  %40 = fmul double %i.crg, %36
  %41 = extractelement <2 x double> %i.ctl, i64 1
  %42 = fsub double %41, %40
  %43 = fadd double %i.ctm, %42
...
bb.cp:                                            ; preds = %bb.co, %bb.cm
  ...
  %.sroa.21.0 = phi double [ 1.000000e+00, %bb.cm ], [ %43, %bb.co ] ; 3 uses
