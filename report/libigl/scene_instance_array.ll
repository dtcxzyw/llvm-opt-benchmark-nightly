...
.lr.ph:                                           ; preds = %_ZN6embree16MotionDerivativeC2ERKNS_28MotionDerivativeCoefficientsEiRKNS_6Vec3faES6_.exit
  ...
  %18 = shufflevector <4 x float> %i.cs, <4 x float> %i.cq, <2 x i32> <i32 3, i32 7> ; 2 uses
  ...
  %i.ds = select <2 x i1> %i.dr, <2 x float> %19, <2 x float> %18 ; 2 uses
...
.lr.ph750:                                        ; preds = %bb.g
  ...
  %.sroa.5.28.vec.extract = extractelement <4 x float> %i.fy, i64 3
  ...
  %20 = shufflevector <4 x float> %i.ga, <4 x float> %i.fy, <2 x i32> <i32 3, i32 7> ; 2 uses
  ...
  %i.ha = select <2 x i1> %i.gz, <2 x float> %21, <2 x float> %20 ; 2 uses
