...
bb.a:
  ...
  %8 = load double, ptr %6, align 8, !tbaa !193, !noalias !3016 ; 7 uses
  %i.p = load double, ptr %1, align 8, !tbaa !193, !noalias !3016 ; 7 uses
  %9 = load double, ptr %7, align 8, !tbaa !193, !noalias !3016 ; 7 uses
  %i.q = fsub double %i.p, %i.l                   ; 4 uses
  %10 = fsub double %8, %i.m                      ; 4 uses
  ...
  %i.z = tail call double @llvm.fmuladd.f64(double %i.i, double %i.q, double %i.y)
  %i.aa = fneg double %i.q
  %i.ab = fmul double %i.u, %i.aa
  %i.ac = tail call double @llvm.fmuladd.f64(double %i.x, double %10, double %i.ab)
...
bb.b:                                             ; preds = %bb.a
  %i.am = fmul double %i.u, %10
  %i.an = tail call double @llvm.fmuladd.f64(double %i.q, double %i.x, double %i.am)
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ej = fmul double %i.ei, %10
  %i.ek = extractelement <2 x double> %i.eg, i64 0
  %i.el = tail call double @llvm.fmuladd.f64(double %i.q, double %i.ek, double %i.ej)
...
.thread:                                          ; preds = %bb.i, %bb.h, %bb.j
  ...
  %i.fd = shufflevector <2 x double> %11, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.fg = fsub <2 x double> %i.ff, %13            ; 2 uses
  %i.fh = insertelement <2 x double> poison, double %i.f, i64 0
  %14 = insertelement <2 x double> %i.fh, double %i.bq, i64 1
  %i.fi = insertelement <2 x double> poison, double %9, i64 0
  %15 = shufflevector <2 x double> %i.fi, <2 x double> poison, <2 x i32> zeroinitializer
  %i.fj = fsub <2 x double> %14, %15              ; 2 uses
