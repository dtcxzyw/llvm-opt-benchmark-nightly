...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %.sroa.4.0.copyload = load <4 x float>, ptr %.sroa.4.0..sroa_idx, align 16 ; 2 uses
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 128 ; 4 uses
  %.sroa.5.0.copyload = load <4 x float>, ptr %.sroa.5.0..sroa_idx, align 16 ; 2 uses
  %.sroa.6.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 144 ; 4 uses
  %.sroa.6.0.copyload = load <4 x float>, ptr %.sroa.6.0..sroa_idx, align 16, !tbaa !40 ; 5 uses
  ...
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 116 ; 2 uses
  %5 = load <1 x float>, ptr %4, align 4, !noalias !62
  %6 = shufflevector <1 x float> %5, <1 x float> poison, <4 x i32> zeroinitializer
  %i.gt = fmul <4 x float> %.sroa.8236.28.vec.insert, %6
  %i.gu = fadd <4 x float> %i.gs, %i.gt
  %7 = getelementptr inbounds nuw i8, ptr %0, i64 120 ; 2 uses
  %8 = load <1 x float>, ptr %7, align 8, !noalias !62
  %9 = shufflevector <1 x float> %8, <1 x float> poison, <4 x i32> zeroinitializer
  %i.gv = fmul <4 x float> %.sroa.14239.44.vec.insert, %9
  %i.gw = fadd <4 x float> %i.gu, %i.gv
  %10 = getelementptr inbounds nuw i8, ptr %0, i64 124 ; 2 uses
  %11 = load <1 x float>, ptr %10, align 4, !noalias !62
  %12 = shufflevector <1 x float> %11, <1 x float> poison, <4 x i32> zeroinitializer
  %i.gx = fmul <4 x float> %12, <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>
  ...
  %i.hb = getelementptr inbounds nuw i8, ptr %0, i64 132 ; 2 uses
  %13 = load <1 x float>, ptr %i.hb, align 4, !noalias !62
  %14 = shufflevector <1 x float> %13, <1 x float> poison, <4 x i32> zeroinitializer
  %i.hc = fmul <4 x float> %.sroa.8236.28.vec.insert, %14
  %i.hd = fadd <4 x float> %i.ha, %i.hc
  %i.he = getelementptr inbounds nuw i8, ptr %0, i64 136 ; 2 uses
  %15 = load <1 x float>, ptr %i.he, align 8, !noalias !62
  %16 = shufflevector <1 x float> %15, <1 x float> poison, <4 x i32> zeroinitializer
  %i.hf = fmul <4 x float> %.sroa.14239.44.vec.insert, %16
  %i.hg = fadd <4 x float> %i.hd, %i.hf
  %i.hh = getelementptr inbounds nuw i8, ptr %0, i64 140 ; 2 uses
  %17 = load <1 x float>, ptr %i.hh, align 4, !noalias !62
  %18 = shufflevector <1 x float> %17, <1 x float> poison, <4 x i32> zeroinitializer
  %i.hi = fmul <4 x float> %18, <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>
  ...
  %19 = load <1 x float>, ptr %i.fz, align 16, !noalias !75
  %i.ic = shufflevector <1 x float> %19, <1 x float> poison, <4 x i32> zeroinitializer
  %i.id = fmul <4 x float> %i.ic, %i.cw
  %20 = load <1 x float>, ptr %i.gc, align 4, !noalias !75
  %i.ie = shufflevector <1 x float> %20, <1 x float> poison, <4 x i32> zeroinitializer
  %i.if = fmul <4 x float> %i.ie, %i.cy
  %i.ig = fadd <4 x float> %i.id, %i.if
  %21 = load <1 x float>, ptr %i.gh, align 8, !noalias !75
  %i.ih = shufflevector <1 x float> %21, <1 x float> poison, <4 x i32> zeroinitializer
  %i.ii = fmul <4 x float> %i.ih, %i.da
  %i.ij = fadd <4 x float> %i.ii, %i.ig
  %22 = load <1 x float>, ptr %i.gm, align 4, !noalias !75
  %i.ik = shufflevector <1 x float> %22, <1 x float> poison, <4 x i32> zeroinitializer
  %i.il = fmul <4 x float> %i.ik, %i.dc
  %i.im = fadd <4 x float> %i.il, %i.ij           ; 2 uses
  %23 = load <1 x float>, ptr %.sroa.4.0..sroa_idx, align 16, !noalias !75
  %i.in = shufflevector <1 x float> %23, <1 x float> poison, <4 x i32> zeroinitializer
  %i.io = fmul <4 x float> %i.in, %i.cw
  %24 = load <1 x float>, ptr %4, align 4, !noalias !75
  %i.ip = shufflevector <1 x float> %24, <1 x float> poison, <4 x i32> zeroinitializer
  %i.iq = fmul <4 x float> %i.ip, %i.cy
  %i.ir = fadd <4 x float> %i.io, %i.iq
  %25 = load <1 x float>, ptr %7, align 8, !noalias !75
  %i.is = shufflevector <1 x float> %25, <1 x float> poison, <4 x i32> zeroinitializer
  %i.it = fmul <4 x float> %i.is, %i.da
  %i.iu = fadd <4 x float> %i.it, %i.ir
  %26 = load <1 x float>, ptr %10, align 4, !noalias !75
  %i.iv = shufflevector <1 x float> %26, <1 x float> poison, <4 x i32> zeroinitializer
  %i.iw = fmul <4 x float> %i.iv, %i.dc
  %i.ix = fadd <4 x float> %i.iw, %i.iu           ; 2 uses
  %27 = load <1 x float>, ptr %.sroa.5.0..sroa_idx, align 16, !noalias !75
  %i.iy = shufflevector <1 x float> %27, <1 x float> poison, <4 x i32> zeroinitializer
  %i.iz = fmul <4 x float> %i.iy, %i.cw
  %28 = load <1 x float>, ptr %i.hb, align 4, !noalias !75
  %i.ja = shufflevector <1 x float> %28, <1 x float> poison, <4 x i32> zeroinitializer
  %i.jb = fmul <4 x float> %i.ja, %i.cy
  %i.jc = fadd <4 x float> %i.iz, %i.jb
  %29 = load <1 x float>, ptr %i.he, align 8, !noalias !75
  %i.jd = shufflevector <1 x float> %29, <1 x float> poison, <4 x i32> zeroinitializer
  %i.je = fmul <4 x float> %i.jd, %i.da
  %i.jf = fadd <4 x float> %i.je, %i.jc
  %30 = load <1 x float>, ptr %i.hh, align 4, !noalias !75
  %i.jg = shufflevector <1 x float> %30, <1 x float> poison, <4 x i32> zeroinitializer
  %i.jh = fmul <4 x float> %i.jg, %i.dc
  %i.ji = fadd <4 x float> %i.jh, %i.jf           ; 2 uses
  %31 = load <4 x float>, ptr %.sroa.6.0..sroa_idx, align 16, !noalias !75 ; 4 uses
  %i.jj = shufflevector <4 x float> %31, <4 x float> poison, <4 x i32> zeroinitializer
  %i.jk = fmul <4 x float> %i.jj, %i.cw
  %32 = shufflevector <4 x float> %31, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.jl = fmul <4 x float> %32, %i.cy
  %i.jm = fadd <4 x float> %i.jk, %i.jl
  %33 = shufflevector <4 x float> %31, <4 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %i.jn = fmul <4 x float> %33, %i.da
  %i.jo = fadd <4 x float> %i.jn, %i.jm
  %34 = shufflevector <4 x float> %31, <4 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
  %i.jp = fmul <4 x float> %34, %i.dc
