...
.lr.ph.i.i.i.i.i.i.i.i.i.i.i.i.prol:              ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i.i.i.i.preheader121, %.lr.ph.i.i.i.i.i.i.i.i.i.i.i.i.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.i.i.i.i.i.i.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.i.i.i.i.i.i.i.i.i.prol, !llvm.loop !311
...
bb.e:                                             ; preds = %.lr.ph30, %.loopexit
  ...
  %i.ex = load <2 x double>, ptr %i.eu, align 8, !tbaa !34 ; 2 uses
...
bb.j:                                             ; preds = %"_ZZN3igl8copyleft8quadprogERKN5Eigen6MatrixIdLin1ELin1ELi0ELin1ELin1EEERKNS2_IdLin1ELi1ELi0ELin1ELi1EEES5_S8_S5_S8_RS6_ENK3$_0clEdd.exit"
  ...
  store double 0.000000e+00, ptr %i.ew, align 8, !tbaa !34
  ...
  store double %.0.i.sink, ptr %i.eu, align 8, !tbaa !34
...
.lr.ph26.lver.orig:                               ; preds = %.lr.ph26.lver.check, %.lr.ph26.lver.orig
  ...
  store double %i.gg, ptr %i.ga, align 8, !tbaa !34
...
vector.body107:                                   ; preds = %vector.body107, %vector.ph101
  ...
  %wide.load109 = load <2 x double>, ptr %i.gm, align 8, !tbaa !34, !alias.scope !326, !noalias !327 ; 2 uses
  %i.gn = getelementptr [8 x i8], ptr %i.gl, i64 %i.gi ; 2 uses
  %wide.load110 = load <2 x double>, ptr %i.gn, align 8, !tbaa !34, !alias.scope !327 ; 2 uses
  ...
  store <2 x double> %i.gp, ptr %i.gm, align 8, !tbaa !34, !alias.scope !326, !noalias !327
  ...
  store <2 x double> %i.gs, ptr %i.gn, align 8, !tbaa !34, !alias.scope !327
  %index.next111 = add nuw i64 %index108, 2       ; 2 uses
  %i.gt = icmp eq i64 %index.next111, %n.vec102
  br i1 %i.gt, label %middle.block112, label %vector.body107, !llvm.loop !322
...
.lr.ph26:                                         ; preds = %.lr.ph26.ph, %.lr.ph26
  ...
  store double %i.hc, ptr %i.gw, align 8, !tbaa !34
...
scalar.ph99:                                      ; preds = %scalar.ph99.preheader, %scalar.ph99
  ...
  store double %i.hm, ptr %i.hg, align 8, !tbaa !34
...
bb.a:
  ...
  %i.b = load ptr, ptr %1, align 8, !tbaa !56, !nonnull !57, !align !58
...
.thread.i:                                        ; preds = %bb.a
  ...
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !339, !nonnull !57, !align !58
...
bb.c:                                             ; preds = %bb.b
  %.pr.i.i.i.i.i = load i64, ptr %i.e, align 8, !tbaa !16 ; 4 uses
  %i.h = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !339, !nonnull !57, !align !58 ; 2 uses
...
_ZN5Eigen9DenseBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEE11setConstantERKd.exit.loopexit.i.i.i.i.i.i.i: ; preds = %bb.c
  %i.k = load ptr, ptr %5, align 8, !tbaa !30
  %.idx.i.i.i.i.i.i.i.i.i.i.i.i.i.i.i.i.i = shl nuw nsw i64 %.pr.i.i.i.i.i, 3
  call void @llvm.memset.p0.i64(ptr align 8 %i.k, i8 0, i64 %.idx.i.i.i.i.i.i.i.i.i.i.i.i.i.i.i.i.i, i1 false), !tbaa !34
  br label %_ZN5Eigen9DenseBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEE7setZeroEv.exit.i.i.i.i.i.i
...
_ZN5Eigen9DenseBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEE7setZeroEv.exit.i.i.i.i.i.i: ; preds = %_ZN5Eigen9DenseBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEE11setConstantERKd.exit.loopexit.i.i.i.i.i.i.i, %bb.c, %.thread.i
  ...
  store double 1.000000e+00, ptr %i.a, align 8, !tbaa !34
...
bb.d:                                             ; preds = %_ZN5Eigen9DenseBaseINS_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEE7setZeroEv.exit.i.i.i.i.i.i
  %i.r = load ptr, ptr %i.n, align 8, !tbaa !22, !noalias !340 ; 11 uses
  %i.s = load ptr, ptr %i.m, align 8, !tbaa !30, !noalias !341 ; 11 uses
  %i.t = getelementptr inbounds nuw i8, ptr %i.m, i64 8
  %i.u = load i64, ptr %i.t, align 8, !tbaa !16, !noalias !341 ; 10 uses
...
bb.f:                                             ; preds = %bb.e
  %i.aa = load <2 x double>, ptr %i.r, align 1, !tbaa !39
  %i.ab = load <2 x double>, ptr %i.s, align 1, !tbaa !39
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.af = load <2 x double>, ptr %i.ae, align 1, !tbaa !39
  %i.ag = getelementptr inbounds nuw i8, ptr %i.s, i64 16
  %i.ah = load <2 x double>, ptr %i.ag, align 1, !tbaa !39
...
.lr.ph.i.i.i.i.i.i.i.i.i.i.i.i.i:                 ; preds = %bb.g, %.lr.ph.i.i.i.i.i.i.i.i.i.i.i.i.i
  ...
  %i.an = load <2 x double>, ptr %i.am, align 1, !tbaa !39
  %i.ao = getelementptr inbounds nuw [8 x i8], ptr %i.s, i64 %.05480.i.i.i.i.i.i.i.i.i.i.i.i.i
  %i.ap = load <2 x double>, ptr %i.ao, align 1, !tbaa !39
  ...
  %i.au = load <2 x double>, ptr %i.at, align 1, !tbaa !39
  %i.av = getelementptr inbounds nuw [8 x i8], ptr %i.s, i64 %i.as
  %i.aw = load <2 x double>, ptr %i.av, align 1, !tbaa !39
