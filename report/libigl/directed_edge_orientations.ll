...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !tbaa !216  ; 7 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %.pre = load i64, ptr %i.a, align 8, !tbaa !216
...
.lr.ph:                                           ; preds = %_ZNSt6vectorIN5Eigen10QuaternionIdLi0EEENS0_17aligned_allocatorIS2_EEE6resizeEm.exit
  ...
  %i.y = getelementptr inbounds nuw i8, ptr %5, i64 368
  %i.z = getelementptr inbounds nuw i8, ptr %5, i64 369
...
bb.f:                                             ; preds = %.lr.ph, %_ZN5Eigen14QuaternionBaseINS_10QuaternionIdLi0EEEE17setFromTwoVectorsINS_6MatrixIdLi1ELi3ELi1ELi1ELi3EEENS_13CwiseBinaryOpINS_8internal20scalar_difference_opIddEEKNS_5BlockIKNS5_IdLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEESF_EEEERS2_RKNS_10MatrixBaseIT_EERKNSI_IT0_EE.exit
  ...
  %i.ac = phi i64 [ %i.n, %.lr.ph ], [ %i.cd, %_ZN5Eigen14QuaternionBaseINS_10QuaternionIdLi0EEEE17setFromTwoVectorsINS_6MatrixIdLi1ELi3ELi1ELi1ELi3EEENS_13CwiseBinaryOpINS_8internal20scalar_difference_opIddEEKNS_5BlockIKNS5_IdLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEESF_EEEERS2_RKNS_10MatrixBaseIT_EERKNSI_IT0_EE.exit ]
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #20
  %i.ad = load ptr, ptr %1, align 8, !tbaa !217
  %i.ae = getelementptr [4 x i8], ptr %i.ad, i64 %indvars.iv ; 2 uses
  %i.af = getelementptr [4 x i8], ptr %i.ae, i64 %i.ac
  %i.ag = load i32, ptr %i.af, align 4, !tbaa !16
  %i.ah = sext i32 %i.ag to i64                   ; 2 uses
  %i.ai = load ptr, ptr %0, align 8, !tbaa !19, !noalias !218 ; 2 uses
  %i.aj = getelementptr inbounds [8 x i8], ptr %i.ai, i64 %i.ah
  %i.ak = load i64, ptr %i.p, align 8, !tbaa !20, !noalias !218 ; 2 uses
  %i.al = load i32, ptr %i.ae, align 4, !tbaa !16
  ...
  %i.au = fmul <2 x double> %i.ar, <double 1.000000e+00, double 0.000000e+00> ; 2 uses
  ...
  %i.aw = fmul double %i.at, 0.000000e+00
  %i.ax = fadd double %i.aw, %i.av                ; 4 uses
  %i.ay = fcmp olt double %i.ax, f0xBFEFFFFFFFFFDCD1
...
bb.g:                                             ; preds = %bb.f
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(11) %i.u, i8 0, i64 11, i1 false)
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.w, i8 -1, i64 16, i1 false)
  store i64 0, ptr %i.x, align 8, !tbaa !42
  store i8 0, ptr %i.y, align 16, !tbaa !61
  store i8 0, ptr %i.z, align 1, !tbaa !220
  %i.ba = call noundef nonnull align 16 dereferenceable(560) ptr @_ZN5Eigen9JacobiSVDINS_6MatrixIdLi2ELi3ELi0ELi2ELi3EEELi2EE7computeERKS2_j(ptr noundef nonnull align 16 dereferenceable(560) %5, ptr noundef nonnull align 16 dereferenceable(48) %4, i32 noundef 16) ; 0 uses
  %i.bb = load <2 x double>, ptr %i.aa, align 16, !tbaa !23
  %i.bc = load double, ptr %i.ab, align 16, !tbaa !25
  %i.bd = fadd nnan double %.sroa.speculated.i, 1.000000e+00
  %i.be = fmul nnan double %i.bd, 5.000000e-01    ; 2 uses
  %i.bf = call double @sqrt(double noundef %i.be) #20
  %i.bg = fsub double 1.000000e+00, %i.be
  %i.bh = call double @sqrt(double noundef %i.bg) #20 ; 2 uses
  %.sroa.6.16.vec.insert.i.i.i.i.i.i.i.i.i.i = insertelement <2 x double> poison, double %i.bh, i64 0
  %i.bi = shufflevector <2 x double> %.sroa.6.16.vec.insert.i.i.i.i.i.i.i.i.i.i, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bj = fmul <2 x double> %i.bb, %i.bi
  %i.bk = fmul double %i.bc, %i.bh
...
bb.h:                                             ; preds = %bb.f
  %i.bl = fneg double %i.at
  %i.bm = shufflevector <2 x double> %i.ar, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %i.bn = insertelement <2 x double> %i.bm, double %i.at, i64 0
  %i.bo = fmul <2 x double> %i.ar, <double 0.000000e+00, double -0.000000e+00> ; 2 uses
  %i.bp = shufflevector <2 x double> %i.bo, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.bq = insertelement <2 x double> %i.bp, double %i.bl, i64 1
  %i.br = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bn, <2 x double> zeroinitializer, <2 x double> %i.bq)
  %shift37 = shufflevector <2 x double> %i.ar, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop38 = fsub <2 x double> %shift37, %i.bo
  %i.bs = extractelement <2 x double> %foldExtExtBinop38, i64 0
  %i.bt = fadd double %i.ax, 1.000000e+00
  %i.bu = fmul double %i.bt, 2.000000e+00
  %i.bv = call double @sqrt(double noundef %i.bu) #20 ; 2 uses
  %i.bw = fdiv double 1.000000e+00, %i.bv         ; 2 uses
  %.sroa.6.16.vec.insert.i.i.i.i.i.i.i.i.i20.i = insertelement <2 x double> poison, double %i.bw, i64 0
  %i.bx = shufflevector <2 x double> %.sroa.6.16.vec.insert.i.i.i.i.i.i.i.i.i20.i, <2 x double> poison, <2 x i32> zeroinitializer
  %i.by = fmul <2 x double> %i.br, %i.bx
  %i.bz = fmul double %i.bs, %i.bw
  %i.ca = fmul double %i.bv, 5.000000e-01
  br label %_ZN5Eigen14QuaternionBaseINS_10QuaternionIdLi0EEEE17setFromTwoVectorsINS_6MatrixIdLi1ELi3ELi1ELi1ELi3EEENS_13CwiseBinaryOpINS_8internal20scalar_difference_opIddEEKNS_5BlockIKNS5_IdLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEESF_EEEERS2_RKNS_10MatrixBaseIT_EERKNSI_IT0_EE.exit
...
_ZN5Eigen14QuaternionBaseINS_10QuaternionIdLi0EEEE17setFromTwoVectorsINS_6MatrixIdLi1ELi3ELi1ELi1ELi3EEENS_13CwiseBinaryOpINS_8internal20scalar_difference_opIddEEKNS_5BlockIKNS5_IdLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEESF_EEEERS2_RKNS_10MatrixBaseIT_EERKNSI_IT0_EE.exit: ; preds = %bb.g, %bb.h
  %.sink73.i = phi double [ %i.bf, %bb.g ], [ %i.ca, %bb.h ]
  %.sink72.i = phi <2 x double> [ %i.bj, %bb.g ], [ %i.by, %bb.h ]
  %.sink.i = phi double [ %i.bk, %bb.g ], [ %i.bz, %bb.h ]
  %i.cb = getelementptr inbounds nuw i8, ptr %i.ap, i64 24
  store double %.sink73.i, ptr %i.cb, align 8, !tbaa !25
  store <2 x double> %.sink72.i, ptr %i.ap, align 8, !tbaa !23
  %i.cc = getelementptr i8, ptr %i.ap, i64 16
  store double %.sink.i, ptr %i.cc, align 8, !tbaa !25
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #20
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.cd = load i64, ptr %i.a, align 8, !tbaa !216 ; 2 uses
  %i.ce = icmp sgt i64 %i.cd, %indvars.iv.next
  br i1 %i.ce, label %bb.f, label %._crit_edge, !llvm.loop !213
}
...
bb.f:                                             ; preds = %_ZNKSt6vectorIN5Eigen10QuaternionIdLi0EEENS0_17aligned_allocatorIS2_EEE12_M_check_lenEmPKc.exit
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.w, align 8, !tbaa !64
...
.lr.ph.i.i.i:                                     ; preds = %bb.g, %.lr.ph.i.i.i
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %.012.i.i.i, ptr noundef nonnull align 16 dereferenceable(32) %.0911.i.i.i, i64 32, i1 false), !tbaa.struct !226, !alias.scope !227
  ...
  br i1 %.not.i.i.i, label %_ZNSt6vectorIN5Eigen10QuaternionIdLi0EEENS0_17aligned_allocatorIS2_EEE11_S_relocateEPS2_S6_S6_RS4_.exit, label %.lr.ph.i.i.i, !llvm.loop !224
...
_ZNSt12_Vector_baseIN5Eigen10QuaternionIdLi0EEENS0_17aligned_allocatorIS2_EEE13_M_deallocateEPS2_m.exit32: ; preds = %_ZNSt6vectorIN5Eigen10QuaternionIdLi0EEENS0_17aligned_allocatorIS2_EEE11_S_relocateEPS2_S6_S6_RS4_.exit, %bb.h
  ...
  store ptr %i.ab, ptr %i.h, align 8, !tbaa !225
  br label %bb.i
