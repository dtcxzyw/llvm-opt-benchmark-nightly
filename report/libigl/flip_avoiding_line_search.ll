...
bb.a:
  ...
  %i.bg = load double, ptr %i.ak, align 8, !tbaa !18 ; 7 uses
  ...
  %i.bt = load double, ptr %i.au, align 8, !tbaa !18 ; 19 uses
  %i.bu = load double, ptr %i.at, align 8, !tbaa !18 ; 17 uses
...
bb.k:                                             ; preds = %bb.a
  ...
  store ptr %i.ss, ptr %i.sv, align 8, !tbaa !34
...
bb.l:                                             ; preds = %bb.k
  %i.tc = load double, ptr %i.sr, align 8, !tbaa !18 ; 2 uses
...
bb.n:                                             ; preds = %bb.k
  %i.te = load double, ptr %i.sr, align 8, !tbaa !18 ; 4 uses
  %i.tf = load double, ptr %i.su, align 8, !tbaa !18 ; 4 uses
...
_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEEvT_S7_.exit: ; preds = %.noexc
  %i.tm = load double, ptr %i.sr, align 8, !tbaa !18 ; 2 uses
...
bb.p:                                             ; preds = %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEEvT_S7_.exit
  %i.tp = load double, ptr %i.su, align 8, !tbaa !18 ; 2 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.ts = load double, ptr %i.tr, align 8, !tbaa !18 ; 2 uses
