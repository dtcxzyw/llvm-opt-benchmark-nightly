...
bb.a:
  ...
  %i.co = load double, ptr %i.aa, align 8, !tbaa !13 ; 9 uses
  ...
  %i.cw = load double, ptr %i.x, align 8, !tbaa !13 ; 5 uses
  ...
  %5 = fmul <2 x double> %i.gg, %i.gu             ; 2 uses
  %i.ic = fmul <2 x double> %i.hc, %i.ft          ; 2 uses
  %6 = insertelement <2 x double> %i.fr, double %i.cq, i64 1
  %7 = insertelement <2 x double> %i.gy, double %i.dn, i64 1
  %i.id = fmul <2 x double> %6, %7                ; 2 uses
  ...
  %i.or = tail call double @llvm.fmuladd.f64(double %i.ds, double %i.bt, double %i.oq)
  ...
  %i.pc = shufflevector <2 x double> %5, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  ...
  %i.pi = shufflevector <2 x double> %i.ic, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  ...
  %i.qg = insertelement <2 x double> poison, double %i.ds, i64 0
  ...
  %i.qm = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %5, <2 x double> %i.ql, <2 x double> %i.qk)
  %i.qn = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hd, <2 x double> %i.pq, <2 x double> %i.qm)
  %i.qo = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ic, <2 x double> %i.ql, <2 x double> %i.qn)
  ...
  %8 = shufflevector <2 x double> %i.id, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  ...
  %i.qw = shufflevector <2 x double> %i.id, <2 x double> poison, <2 x i32> zeroinitializer
