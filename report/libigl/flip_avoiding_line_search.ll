...
bb.a:
  ...
  %5 = fmul double %i.bg, %i.cv                   ; 2 uses
  %6 = fmul double %i.da, %i.bd                   ; 2 uses
  %i.do = fmul double %i.cq, %i.bx                ; 2 uses
  %7 = fneg double %i.cg
  %i.dp = fmul double %i.cs, %i.cw                ; 3 uses
  %i.dq = fmul double %i.cq, %i.da                ; 3 uses
  %8 = fneg double %i.dq                          ; 2 uses
  %i.dr = fneg double %i.dp                       ; 2 uses
  ...
  %9 = shufflevector <2 x double> %i.dx, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.fn = insertelement <2 x double> %9, double %i.az, i64 1
  ...
  %i.fv = extractelement <2 x double> %i.dx, i64 0 ; 3 uses
  %10 = fmul double %i.bg, %i.fv                  ; 2 uses
  %11 = fmul double %i.ba, %i.bc                  ; 2 uses
  %i.fw = insertelement <2 x double> poison, double %11, i64 0
  %12 = insertelement <2 x double> %i.fw, double %10, i64 1
  ...
  %i.lb = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %12, <2 x double> %i.fx, <2 x double> %i.la) ; 3 uses
  ...
  %i.lt = tail call double @llvm.fmuladd.f64(double %5, double %i.bu, double %i.ls)
  %i.lu = tail call double @llvm.fmuladd.f64(double %i.it, double %i.bt, double %i.lt)
  %i.lv = tail call double @llvm.fmuladd.f64(double %6, double %i.bu, double %i.lu)
  ...
  %i.ly = tail call double @llvm.fmuladd.f64(double %11, double %i.dc, double %i.lx)
  ...
  %i.mh = tail call double @llvm.fmuladd.f64(double %i.do, double %i.bu, double %i.mg)
  ...
  %i.mp = insertelement <2 x double> %i.mo, double %13, i64 1
  ...
  %i.mv = tail call double @llvm.fmuladd.f64(double %7, double %i.cv, double %i.mu)
  ...
  %i.ne = tail call double @llvm.fmuladd.f64(double %i.dp, double %i.bm, double %i.nd)
  %i.nf = tail call double @llvm.fmuladd.f64(double %i.db, double %i.co, double %i.ne)
  %i.ng = tail call double @llvm.fmuladd.f64(double %8, double %i.bm, double %i.nf)
  ...
  %i.ns = tail call double @llvm.fmuladd.f64(double %i.iq, double %i.bt, double %i.nr)
  ...
  %i.nw = tail call double @llvm.fmuladd.f64(double %i.dr, double %i.bu, double %i.nv)
  %i.nx = tail call double @llvm.fmuladd.f64(double %i.di, double %i.de, double %i.nw)
  %i.ny = tail call double @llvm.fmuladd.f64(double %i.dq, double %i.bu, double %i.nx)
  ...
  %i.of = tail call double @llvm.fmuladd.f64(double %10, double %i.dg, double %i.oe)
  %i.og = tail call double @llvm.fmuladd.f64(double %5, double %i.dc, double %i.of)
  ...
  %i.oj = tail call double @llvm.fmuladd.f64(double %6, double %i.dc, double %i.oi)
  ...
  %i.op = insertelement <2 x double> poison, double %13, i64 0
  ...
  %i.ou = insertelement <2 x double> %i.ot, double %i.dp, i64 0
  ...
  %i.pa = insertelement <2 x double> %i.oz, double %8, i64 0
  ...
  %i.pl = insertelement <2 x double> %i.pk, double %i.dr, i64 0
  ...
  %i.pp = insertelement <2 x double> poison, double %i.iq, i64 0
  %i.pq = insertelement <2 x double> %i.pp, double %i.do, i64 1
  ...
  %i.pt = insertelement <2 x double> %i.ps, double %i.dq, i64 0
