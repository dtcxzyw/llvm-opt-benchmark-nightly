...
bb.a:
  ...
  %5 = insertelement <4 x i32> %4, i32 %3, i64 1
  %6 = insertelement <4 x i32> %5, i32 %2, i64 2
  %7 = insertelement <4 x i32> %6, i32 %1, i64 3
  %8 = and <4 x i32> %7, <i32 255, i32 255, i32 255, i32 -1>
  %i.a = uitofp <4 x i32> %8 to <4 x float>
...
_ZN8ImVectorI13ImGuiColorModE9push_backERKS0_.exit: ; preds = %._ZN8ImVectorI13ImGuiColorModE7reserveEi.exit_crit_edge.i, %bb.g
  ...
  %6 = insertelement <4 x i32> %5, i32 %2, i64 2
  %7 = insertelement <4 x i32> %6, i32 %i.ao, i64 3
  %8 = and <4 x i32> %7, <i32 255, i32 255, i32 -1, i32 255>
  %9 = uitofp <4 x i32> %8 to <4 x float>         ; 2 uses
  %10 = shufflevector <4 x float> %9, <4 x float> poison, <2 x i32> <i32 1, i32 0>
  %11 = fmul nnan <2 x float> %10, splat (float f0x3B808081)
  %12 = shufflevector <4 x float> %9, <4 x float> poison, <2 x i32> <i32 3, i32 2>
  %i.ap = fmul nnan <2 x float> %12, splat (float f0x3B808081)
  store <2 x float> %11, ptr %i.d, align 8
...
.lr.ph.i573:                                      ; preds = %.preheader.i
  ...
  %28 = insertelement <2 x float> %i.akj, float f0xFF7FFFFF, i64 0
  %29 = insertelement <2 x float> %i.akj, float f0xFF7FFFFF, i64 1
...
bb.hu:                                            ; preds = %.thread117.i, %.lr.ph.i573
  ...
  %i.aui = icmp samesign ugt i64 %indvars.iv97.i, 1 ; 4 uses
...
.thread82.thread.i:                               ; preds = %bb.ii, %.thread83.i, %bb.ih, %.thread79.i, %bb.ig
  %30 = phi <2 x float> [ splat (float f0xFF7FFFFF), %bb.ii ], [ splat (float f0xFF7FFFFF), %bb.ig ], [ splat (float f0xFF7FFFFF), %.thread83.i ], [ %28, %bb.ih ], [ %29, %.thread79.i ] ; 2 uses
  ...
  %31 = load <2 x float>, ptr %i.akv, align 8     ; 2 uses
  %32 = insertelement <2 x i1> poison, i1 %i.aui, i64 0
  %33 = shufflevector <2 x i1> %32, <2 x i1> poison, <2 x i32> zeroinitializer
  %i.axs = insertelement <2 x float> %31, float %i.axp, i64 1
  %i.axt = insertelement <2 x float> %31, float %i.axp, i64 0
  %i.axu = select <2 x i1> %33, <2 x float> %i.axs, <2 x float> %i.axt ; 3 uses
  %34 = fcmp olt <2 x float> %i.axu, %30
  %35 = fcmp ogt <2 x float> %i.axu, %i.axh
  %36 = select <2 x i1> %35, <2 x float> %i.axh, <2 x float> %i.axu
  %i.axv = select <2 x i1> %34, <2 x float> %30, <2 x float> %36 ; 3 uses
...
_ZN6ImRect3AddERK6ImVec2.exit.us:                 ; preds = %.preheader.us.thread, %bb.b, %.preheader.us
  ...
  %10 = insertelement <2 x i64> poison, i64 %i.an, i64 0
  %11 = shufflevector <2 x i64> %10, <2 x i64> poison, <4 x i32> zeroinitializer
  %12 = lshr <4 x i64> %11, <i64 32, i64 0, i64 32, i64 0>
  %13 = trunc <4 x i64> %12 to <4 x i32>
  %14 = bitcast <4 x i32> %13 to <4 x float>      ; 3 uses
  %i.ao = fcmp olt <4 x float> %i.s, %14
  %i.ap = fcmp ogt <4 x float> %i.s, %14
  %i.aq = shufflevector <4 x i1> %i.ao, <4 x i1> %i.ap, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.ar = select <4 x i1> %i.aq, <4 x float> %14, <4 x float> %i.s ; 3 uses
...
_ZN6ImRect3AddERK6ImVec2.exit.us.1:               ; preds = %bb.c, %_ZN6ImRect3AddERK6ImVec2.exit.us
  ...
  %15 = insertelement <2 x i64> poison, i64 %i.ba, i64 0
  %16 = shufflevector <2 x i64> %15, <2 x i64> poison, <4 x i32> zeroinitializer
  %17 = lshr <4 x i64> %16, <i64 32, i64 0, i64 32, i64 0>
  %18 = trunc <4 x i64> %17 to <4 x i32>
  %19 = bitcast <4 x i32> %18 to <4 x float>      ; 3 uses
  %i.bb = fcmp olt <4 x float> %i.ar, %19
  %i.bc = fcmp ogt <4 x float> %i.ar, %19
  %i.bd = shufflevector <4 x i1> %i.bb, <4 x i1> %i.bc, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.be = select <4 x i1> %i.bd, <4 x float> %19, <4 x float> %i.ar ; 3 uses
...
_ZN6ImRect3AddERK6ImVec2.exit.us.2:               ; preds = %bb.d, %_ZN6ImRect3AddERK6ImVec2.exit.us.1
  ...
  %20 = insertelement <2 x i64> poison, i64 %i.bn, i64 0
  %21 = shufflevector <2 x i64> %20, <2 x i64> poison, <4 x i32> zeroinitializer
  %22 = lshr <4 x i64> %21, <i64 32, i64 0, i64 32, i64 0>
  %23 = trunc <4 x i64> %22 to <4 x i32>
  %24 = bitcast <4 x i32> %23 to <4 x float>      ; 3 uses
  %i.bo = fcmp olt <4 x float> %i.be, %24
  %i.bp = fcmp ogt <4 x float> %i.be, %24
  %i.bq = shufflevector <4 x i1> %i.bo, <4 x i1> %i.bp, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.br = select <4 x i1> %i.bq, <4 x float> %24, <4 x float> %i.be ; 2 uses
...
_ZN6ImRect3AddERK6ImVec2.exit.us78:               ; preds = %bb.e, %.preheader.us70.preheader
  ...
  %25 = load i64, ptr %i.cm, align 4
  %26 = insertelement <2 x i64> poison, i64 %25, i64 0
  %27 = shufflevector <2 x i64> %26, <2 x i64> poison, <4 x i32> zeroinitializer
  %28 = lshr <4 x i64> %27, <i64 32, i64 0, i64 32, i64 0>
  %29 = trunc <4 x i64> %28 to <4 x i32>
  %30 = bitcast <4 x i32> %29 to <4 x float>      ; 3 uses
  %i.cn = fcmp olt <4 x float> %i.cf, %30
  %i.co = fcmp ogt <4 x float> %i.cf, %30
  %i.cp = shufflevector <4 x i1> %i.cn, <4 x i1> %i.co, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.cq = select <4 x i1> %i.cp, <4 x float> %30, <4 x float> %i.cf ; 3 uses
...
_ZN6ImRect3AddERK6ImVec2.exit.us78.1:             ; preds = %bb.f, %_ZN6ImRect3AddERK6ImVec2.exit.us78
  ...
  %31 = load i64, ptr %i.cy, align 4
  %32 = insertelement <2 x i64> poison, i64 %31, i64 0
  %33 = shufflevector <2 x i64> %32, <2 x i64> poison, <4 x i32> zeroinitializer
  %34 = lshr <4 x i64> %33, <i64 32, i64 0, i64 32, i64 0>
  %35 = trunc <4 x i64> %34 to <4 x i32>
  %36 = bitcast <4 x i32> %35 to <4 x float>      ; 3 uses
  %i.cz = fcmp olt <4 x float> %i.cq, %36
  %i.da = fcmp ogt <4 x float> %i.cq, %36
  %i.db = shufflevector <4 x i1> %i.cz, <4 x i1> %i.da, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.dc = select <4 x i1> %i.db, <4 x float> %36, <4 x float> %i.cq ; 3 uses
...
_ZN6ImRect3AddERK6ImVec2.exit.us78.2:             ; preds = %bb.g, %_ZN6ImRect3AddERK6ImVec2.exit.us78.1
  ...
  %37 = load i64, ptr %i.dk, align 4
  %38 = insertelement <2 x i64> poison, i64 %37, i64 0
  %39 = shufflevector <2 x i64> %38, <2 x i64> poison, <4 x i32> zeroinitializer
  %40 = lshr <4 x i64> %39, <i64 32, i64 0, i64 32, i64 0>
  %41 = trunc <4 x i64> %40 to <4 x i32>
  %42 = bitcast <4 x i32> %41 to <4 x float>      ; 3 uses
  %i.dl = fcmp olt <4 x float> %i.dc, %42
  %i.dm = fcmp ogt <4 x float> %i.dc, %42
  %i.dn = shufflevector <4 x i1> %i.dl, <4 x i1> %i.dm, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.do = select <4 x i1> %i.dn, <4 x float> %42, <4 x float> %i.dc ; 2 uses
...
_ZN6ImRect3AddERK6ImVec2.exit.2:                  ; preds = %_ZN6ImRect3AddERK6ImVec2.exit.2, %.lr.ph.split.split.preheader
  ...
  %43 = add nuw i32 %.02755, 1
  %.pre103 = zext i32 %43 to i64
  %44 = getelementptr inbounds nuw [20 x i8], ptr %i.bz, i64 %.pre103
  %i.dv = add i32 %.02755, 2
  %.pre105.a = zext i32 %i.dv to i64
  %i.dw = getelementptr inbounds nuw [20 x i8], ptr %i.bz, i64 %.pre105.a
  %45 = load i64, ptr %i.du, align 4
  %46 = insertelement <2 x i64> poison, i64 %45, i64 0
  %47 = shufflevector <2 x i64> %46, <2 x i64> poison, <4 x i32> zeroinitializer
  %48 = lshr <4 x i64> %47, <i64 0, i64 32, i64 0, i64 32>
  %49 = trunc <4 x i64> %48 to <4 x i32>
  %50 = bitcast <4 x i32> %49 to <4 x float>      ; 3 uses
  %i.dx = fcmp ogt <4 x float> %i.dt, %50
  %i.dy = fcmp olt <4 x float> %i.dt, %50
  %i.dz = shufflevector <4 x i1> %i.dx, <4 x i1> %i.dy, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.ea = select <4 x i1> %i.dz, <4 x float> %50, <4 x float> %i.dt ; 3 uses
  %51 = load i64, ptr %44, align 4
  %52 = insertelement <2 x i64> poison, i64 %51, i64 0
  %53 = shufflevector <2 x i64> %52, <2 x i64> poison, <4 x i32> zeroinitializer
  %54 = lshr <4 x i64> %53, <i64 0, i64 32, i64 0, i64 32>
  %55 = trunc <4 x i64> %54 to <4 x i32>
  %56 = bitcast <4 x i32> %55 to <4 x float>      ; 3 uses
  %i.eb = fcmp ogt <4 x float> %i.ea, %56
  %i.ec = fcmp olt <4 x float> %i.ea, %56
  %i.ed = shufflevector <4 x i1> %i.eb, <4 x i1> %i.ec, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.ee = select <4 x i1> %i.ed, <4 x float> %56, <4 x float> %i.ea ; 3 uses
  %57 = load i64, ptr %i.dw, align 4
  %58 = insertelement <2 x i64> poison, i64 %57, i64 0
  %59 = shufflevector <2 x i64> %58, <2 x i64> poison, <4 x i32> zeroinitializer
  %60 = lshr <4 x i64> %59, <i64 0, i64 32, i64 0, i64 32>
  %61 = trunc <4 x i64> %60 to <4 x i32>
  %62 = bitcast <4 x i32> %61 to <4 x float>      ; 3 uses
  %i.ef = fcmp ogt <4 x float> %i.ee, %62
  %i.eg = fcmp olt <4 x float> %i.ee, %62
  %i.eh = shufflevector <4 x i1> %i.ef, <4 x i1> %i.eg, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.ei = select <4 x i1> %i.eh, <4 x float> %62, <4 x float> %i.ee ; 2 uses
