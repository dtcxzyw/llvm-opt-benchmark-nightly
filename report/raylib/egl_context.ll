Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/raylib/original/egl_context?download=true
...
bb.am:                                            ; preds = %bb.al
  %i.dp = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133616), align 8
...
bb.an:                                            ; preds = %bb.al
  ...
  %i.dt = load i32, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133536), align 8
...
sub_0.lr.ph:                                      ; preds = %bb.aq
  ...
  %.pre151 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133520), align 8
  br label %sub_0
...
bb.ar:                                            ; preds = %.tail
  ...
  store ptr %i.el, ptr %i.ea, align 8
  %.not134 = icmp eq ptr %i.el, null
  %.pre150 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133520), align 8
...
.critedge:                                        ; preds = %._crit_edge, %bb.an
  ...
  store ptr @makeContextCurrentEGL, ptr %i.er, align 8
  %i.es = getelementptr inbounds nuw i8, ptr %0, i64 608
  store ptr @swapBuffersEGL, ptr %i.es, align 8
  %i.et = getelementptr inbounds nuw i8, ptr %0, i64 616
  store ptr @swapIntervalEGL, ptr %i.et, align 8
  %i.eu = getelementptr inbounds nuw i8, ptr %0, i64 624
  store ptr @extensionSupportedEGL, ptr %i.eu, align 8
  %i.ev = getelementptr inbounds nuw i8, ptr %0, i64 632
  store ptr @getProcAddressEGL, ptr %i.ev, align 8
  %i.ew = getelementptr inbounds nuw i8, ptr %0, i64 640
  store ptr @destroyContextEGL, ptr %i.ew, align 8
  br label %bb.au
...
bb.au:                                            ; preds = %bb.at, %bb.e, %.critedge, %getEGLErrorString.exit142, %getEGLErrorString.exit140, %getEGLErrorString.exit138, %getEGLErrorString.exit, %bb.b
  %.1110 = phi i32 [ 0, %getEGLErrorString.exit140 ], [ 0, %getEGLErrorString.exit142 ], [ 1, %.critedge ], [ 0, %bb.at ], [ 0, %getEGLErrorString.exit ], [ 0, %getEGLErrorString.exit138 ], [ 0, %bb.b ], [ 0, %bb.e ]
...
bb.e:                                             ; preds = %bb.c
  %i.u = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133600), align 8
  %i.v = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133504), align 8
  %i.w = call i32 %i.u(ptr noundef %i.v, ptr noundef null, i32 noundef 0, ptr noundef nonnull %i.l) #4 ; 0 uses
  %i.x = load i32, ptr %i.l, align 4              ; 2 uses
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.aa = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133600), align 8
  %i.ab = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133504), align 8
...
bb.h:                                             ; preds = %.lr.ph, %bb.s
  ...
  %i.ar = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133504), align 8
  %i.as = call i32 %i.aq(ptr noundef %i.ar, ptr noundef %i.an, i32 noundef 12351, ptr noundef nonnull %i.k) #4, !inline_history !5 ; 0 uses
  %i.at = load i32, ptr %i.k, align 4
  call void @llvm.lifetime.end.p0(ptr nonnull %i.k) #4
  %.not63 = icmp eq i32 %i.at, 12430
  br i1 %.not63, label %bb.i, label %bb.s

bb.i:                                             ; preds = %bb.h
  call void @llvm.lifetime.start.p0(ptr nonnull %i.j) #4
  %i.au = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133592), align 8
  %i.av = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133504), align 8
  %i.aw = call i32 %i.au(ptr noundef %i.av, ptr noundef %i.an, i32 noundef 12339, ptr noundef nonnull %i.j) #4, !inline_history !5 ; 0 uses
  %i.ax = load i32, ptr %i.j, align 4
  call void @llvm.lifetime.end.p0(ptr nonnull %i.j) #4
  %i.ay = and i32 %i.ax, 4
  %.not64 = icmp eq i32 %i.ay, 0
  br i1 %.not64, label %bb.s, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.az = load i32, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 40), align 8
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.bb = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133592), align 8
  %i.bc = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133504), align 8
  %i.bd = call i32 %i.bb(ptr noundef %i.bc, ptr noundef %i.an, i32 noundef 12334, ptr noundef nonnull %i.i) #4, !inline_history !5 ; 0 uses
  %i.be = load i32, ptr %i.i, align 4             ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.i) #4
  %i.bf = sext i32 %i.be to i64
  store i64 %i.bf, ptr %i.aj, align 8
  %.not65.not = icmp eq i32 %i.be, 0
  br i1 %.not65.not, label %.critedge, label %bb.l
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.bh = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 137696), align 8
...
bb.q:                                             ; preds = %bb.p, %bb.j
  ...
  %i.bp = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133592), align 8
  %i.bq = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133504), align 8
  %i.br = call i32 %i.bp(ptr noundef %i.bq, ptr noundef %i.an, i32 noundef 12352, ptr noundef nonnull %i.h) #4, !inline_history !5 ; 0 uses
  %i.bs = load i32, ptr %i.h, align 4
  call void @llvm.lifetime.end.p0(ptr nonnull %i.h) #4
  %i.bt = and i32 %i.bs, %.053
  %.not68 = icmp eq i32 %i.bt, 0
  br i1 %.not68, label %bb.s, label %bb.r

bb.r:                                             ; preds = %bb.q
  call void @llvm.lifetime.start.p0(ptr nonnull %i.g) #4
  %i.bu = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133592), align 8
  %i.bv = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133504), align 8
  %i.bw = call i32 %i.bu(ptr noundef %i.bv, ptr noundef %i.an, i32 noundef 12324, ptr noundef nonnull %i.g) #4, !inline_history !5 ; 0 uses
  %i.bx = load i32, ptr %i.g, align 4
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g) #4
  store i32 %i.bx, ptr %i.ap, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f) #4
  %i.by = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133592), align 8
  %i.bz = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133504), align 8
  %i.ca = call i32 %i.by(ptr noundef %i.bz, ptr noundef %i.an, i32 noundef 12323, ptr noundef nonnull %i.f) #4, !inline_history !5 ; 0 uses
  ...
  %i.cd = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133592), align 8
  %i.ce = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133504), align 8
  %i.cf = call i32 %i.cd(ptr noundef %i.ce, ptr noundef %i.an, i32 noundef 12322, ptr noundef nonnull %i.e) #4, !inline_history !5 ; 0 uses
  ...
  %i.ci = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133592), align 8
  %i.cj = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133504), align 8
  %i.ck = call i32 %i.ci(ptr noundef %i.cj, ptr noundef %i.an, i32 noundef 12321, ptr noundef nonnull %i.d) #4, !inline_history !5 ; 0 uses
  %i.cl = load i32, ptr %i.d, align 4
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #4
  %i.cm = getelementptr inbounds nuw i8, ptr %i.ap, i64 12
  store i32 %i.cl, ptr %i.cm, align 4
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #4
  %i.cn = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133592), align 8
  %i.co = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133504), align 8
  %i.cp = call i32 %i.cn(ptr noundef %i.co, ptr noundef %i.an, i32 noundef 12325, ptr noundef nonnull %i.c) #4, !inline_history !5 ; 0 uses
  ...
  %i.cs = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133592), align 8
  %i.ct = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133504), align 8
  %i.cu = call i32 %i.cs(ptr noundef %i.ct, ptr noundef %i.an, i32 noundef 12326, ptr noundef nonnull %i.b) #4, !inline_history !5 ; 0 uses
  %i.cv = load i32, ptr %i.b, align 4
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #4
  %i.cw = getelementptr inbounds nuw i8, ptr %i.ap, i64 20
  store i32 %i.cv, ptr %i.cw, align 4
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #4
  %i.cx = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133592), align 8
  %i.cy = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133504), align 8
  %i.cz = call i32 %i.cx(ptr noundef %i.cy, ptr noundef %i.an, i32 noundef 12337, ptr noundef nonnull %i.a) #4, !inline_history !5 ; 0 uses
  %i.da = load i32, ptr %i.a, align 4
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #4
  %i.db = getelementptr inbounds nuw i8, ptr %i.ap, i64 48
  store i32 %i.da, ptr %i.db, align 8
  %i.dc = load i32, ptr %i.al, align 8
  %i.dd = getelementptr inbounds nuw i8, ptr %i.ap, i64 56
...
._crit_edge.thread:                               ; preds = %bb.g
  %i.dl = call ptr @_glfwChooseFBConfig(ptr noundef nonnull %1, ptr noundef %i.ag, i32 noundef 0) #4 ; 2 uses
  %.not80 = icmp eq ptr %i.dl, null
  br i1 %.not80, label %.thread, label %bb.t

bb.t:                                             ; preds = %._crit_edge.thread, %._crit_edge
  %i.dm = phi ptr [ %i.dl, %._crit_edge.thread ], [ %i.dk, %._crit_edge ]
...
bb.v:                                             ; preds = %bb.u
  %i.dr = load i32, ptr %0, align 8
  %i.ds = icmp eq i32 %i.dr, 196610
  br i1 %i.ds, label %bb.w, label %bb.z
...
.thread:                                          ; preds = %._crit_edge.thread, %bb.u
  call void (i32, ptr, ...) @_glfwInputError(i32 noundef 65545, ptr noundef nonnull @.str.71) #4
  br label %bb.aa

bb.aa:                                            ; preds = %.thread, %bb.x, %bb.y, %bb.z, %bb.t
  %i.dw = phi i32 [ 0, %.thread ], [ 0, %bb.x ], [ 0, %bb.y ], [ 0, %bb.z ], [ 1, %bb.t ]
  call void @_glfw_free(ptr noundef %i.z) #4
  call void @_glfw_free(ptr noundef %i.ag) #4
  br label %bb.ab

bb.ab:                                            ; preds = %bb.aa, %bb.f, %bb.d
  %.057 = phi i32 [ 0, %bb.d ], [ %i.dw, %bb.aa ], [ 0, %bb.f ]
...
bb.a:
  ...
  %i.a = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133680), align 8 ; 2 uses
  %i.b = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133504), align 8 ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  %i.h = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133616), align 8
...
bb.e:                                             ; preds = %bb.d
  %i.m = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133616), align 8
...
bb.c:                                             ; preds = %bb.a
  %i.b = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133688), align 8
  %i.c = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133504), align 8
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 664
  %i.e = load ptr, ptr %i.d, align 8
  %i.f = tail call i32 %i.b(ptr noundef %i.c, ptr noundef %i.e) #4 ; 0 uses
  br label %bb.d
...
bb.a:
  %i.a = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133696), align 8
  %i.b = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133504), align 8
...
bb.c:                                             ; preds = %bb.b, %bb.a
  %i.e = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133712), align 8
...
bb.a:
  %i.a = load i32, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 40), align 8
...
bb.f:                                             ; preds = %bb.e
  %i.h = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133656), align 8
  %i.i = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133504), align 8
  %i.j = tail call i32 %i.h(ptr noundef %i.i, ptr noundef nonnull %i.g) #4 ; 0 uses
