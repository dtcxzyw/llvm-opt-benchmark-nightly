...
bb.a:
  %.sroa.11.12.vec.extract = extractelement <2 x float> %1, i64 1 ; 5 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %.sroa.11.8.vec.extract = extractelement <2 x float> %1, i64 0 ; 3 uses
  ...
  %i.i = select i1 %i.g, float 1.000000e+00, float %i.h ; 3 uses
  ...
  %4 = fmul float %.sroa.11.8.vec.extract, %i.i
  %.sroa.11.8.vec.insert = insertelement <2 x float> poison, float %4, i64 0
  %5 = fmul float %.sroa.11.12.vec.extract, %i.i  ; 2 uses
  %.sroa.11.12.vec.insert = insertelement <2 x float> %.sroa.11.8.vec.insert, float %5, i64 1
  br label %bb.c
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %.sroa.11.0 = phi <2 x float> [ %.sroa.11.12.vec.insert, %bb.b ], [ %1, %bb.a ]
...
GetCameraUp.exit:                                 ; preds = %bb.a, %bb.b
  ...
  %.sroa.617.0.i.i = phi float [ %i.j, %bb.b ], [ %.sroa.24.0.copyload.i, %bb.a ] ; 2 uses
  ...
  %i.l = fsub <2 x float> %.sroa.070.0.copyload, %.sroa.068.0.copyload ; 6 uses
  %i.m = extractelement <2 x float> %i.l, i64 1   ; 9 uses
  %i.n = extractelement <2 x float> %i.l, i64 0   ; 7 uses
  %i.o = fsub float %.sroa.271.0.copyload, %.sroa.269.0.copyload ; 6 uses
  br i1 %2, label %bb.c, label %bb.d
...
bb.c:                                             ; preds = %GetCameraUp.exit
  ...
  %i.u = insertelement <2 x float> poison, float %.sroa.617.0.i.i, i64 0 ; 2 uses
  ...
  %i.ah = shufflevector <2 x float> %i.l, <2 x float> poison, <2 x i32> zeroinitializer ; 3 uses
  ...
  %5 = fneg <2 x float> %.sroa.013.0.i.i
  %6 = shufflevector <2 x float> %.sroa.013.0.i.i, <2 x float> %5, <2 x i32> <i32 0, i32 2> ; 2 uses
  %7 = shufflevector <2 x float> %i.l, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.al = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %6, <2 x float> %7, <2 x float> %i.ak) ; 2 uses
  ...
  %8 = fmul float %i.m, %i.s
  %9 = fmul float %.sroa.020.4.vec.extract.i, %i.m
  %10 = insertelement <2 x float> poison, float %9, i64 0
  %11 = insertelement <2 x float> %10, float %8, i64 1
  %12 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %6, <2 x float> %i.ah, <2 x float> %11)
  %13 = insertelement <2 x float> %i.u, float %i.t, i64 1
  %14 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %13, <2 x float> %i.ab, <2 x float> %12) ; 2 uses
  %15 = extractelement <2 x float> %14, i64 0
  %16 = tail call float @atan2f(float noundef %i.aq, float noundef %15) #56
  %17 = fadd float %16, -1.000000e-03             ; 2 uses
  %18 = fcmp ogt float %1, %17
  %.0 = select i1 %18, float %17, float %1        ; 2 uses
  %19 = extractelement <2 x float> %i.ap, i64 1
  %i.ar = extractelement <2 x float> %14, i64 1
  %i.as = tail call float @atan2f(float noundef %19, float noundef %i.ar) #56
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.az = fdiv float 1.000000e+00, %sqrt.i.i.i    ; 3 uses
  %20 = fmul float %i.n, %i.az
  %.sroa.013.0.vec.insert.i.i.i = insertelement <2 x float> poison, float %20, i64 0
  %21 = fmul float %i.m, %i.az
  %.sroa.013.4.vec.insert.i.i.i = insertelement <2 x float> %.sroa.013.0.vec.insert.i.i.i, float %21, i64 1
  %i.ba = fmul float %.pre-phi, %i.az
  br label %GetCameraForward.exit.i

GetCameraForward.exit.i:                          ; preds = %bb.e, %bb.d
  %.sroa.013.0.i.i.i = phi <2 x float> [ %.sroa.013.4.vec.insert.i.i.i, %bb.e ], [ %i.l, %bb.d ] ; 2 uses
...
bb.a:
  ...
  %2 = fmul double %i.bd, %i.aq
  %i.be = fptrunc double %i.ba to float           ; 3 uses
  %3 = insertelement <2 x float> poison, float %i.f, i64 0
  %i.bf = insertelement <2 x float> %3, float %i.be, i64 1
  %4 = fmul <2 x float> %i.bf, <float 5.000000e-01, float 2.000000e+00> ; 2 uses
  %5 = insertelement <2 x double> poison, double %2, i64 0
  %6 = insertelement <2 x double> %5, double %i.bd, i64 1 ; 3 uses
  %7 = fadd <2 x double> %6, %6
  %8 = fptrunc <2 x double> %7 to <2 x float>     ; 3 uses
  %i.bg = insertelement <2 x float> %8, float %i.at, i64 0
  %i.bh = fdiv <2 x float> %4, %i.bg              ; 3 uses
  ...
  %9 = fptrunc double %i.bk to float
  %i.bl = fptrunc double %i.bj to float           ; 2 uses
  %i.bm = fadd float %i.be, %i.bl
  %i.bn = fneg float %i.bm
  %i.bo = fmul float %i.be, %i.bl
  %i.bp = fptrunc <2 x double> %6 to <2 x float>  ; 2 uses
  %i.bq = fsub <2 x float> %i.bp, %i.bp
  %i.br = fdiv <2 x float> %i.bq, %8              ; 3 uses
  %i.bs = shufflevector <2 x float> %4, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  ...
  %10 = insertelement <4 x float> %i.bt, float %i.bn, i64 2
  %11 = shufflevector <2 x float> %8, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %i.bu = insertelement <4 x float> %11, float 1.000000e+00, i64 1
  %12 = insertelement <4 x float> %i.bu, float %9, i64 2
  ...
  %i.by = shufflevector <4 x float> %10, <4 x float> %i.bx, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %i.bz = fdiv <4 x float> %i.by, %13             ; 4 uses
