...
bb.a:
  ...
  %i.dv = tail call float @llvm.fmuladd.f32(float %i.dt, float %i.du, float %i.ds) ; 2 uses
  ...
  %4 = extractelement <2 x float> %i.bo, i64 0    ; 2 uses
  %5 = fmul float %i.fl, %4
  %6 = fmul float %i.fo, %4
  %i.fp = extractelement <2 x float> %i.bo, i64 1
  %i.fq = fmul float %i.fo, %i.fp
  %i.fr = fmul float %i.fo, %i.dd
  %i.fs = insertelement <2 x float> poison, float %i.fo, i64 0
  %7 = extractelement <2 x float> %i.fk, i64 0    ; 5 uses
  %8 = extractelement <2 x float> %i.bn, i64 1
  %9 = tail call float @llvm.fmuladd.f32(float %7, float %8, float %5) ; 2 uses
  %10 = fneg float %7
  %11 = shufflevector <2 x float> %i.ct, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %12 = shufflevector <2 x float> %i.ct, <2 x float> %i.dp, <2 x i32> <i32 0, i32 2>
  %i.ft = insertelement <2 x float> poison, float %9, i64 0
  %i.fu = shufflevector <2 x float> %i.ft, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %13 = fneg float %i.cw                          ; 2 uses
  %14 = tail call float @llvm.fmuladd.f32(float %i.bu, float %i.ac, float %i.as)
  %i.fv = tail call float @llvm.fmuladd.f32(float %i.bv, float %i.ca, float %14)
  %15 = tail call float @llvm.fmuladd.f32(float %i.bw, float %i.cb, float %i.fv) ; 3 uses
  ...
  %18 = fmul <2 x float> %17, %i.dp
  %19 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ck, <2 x float> %i.dy, <2 x float> %18) ; 6 uses
  %i.fw = tail call float @llvm.fmuladd.f32(float %i.fl, float %i.ed, float %i.fq) ; 3 uses
  %20 = fneg float %i.fw                          ; 2 uses
  %21 = extractelement <2 x float> %19, i64 0     ; 2 uses
  %22 = fmul float %21, %20
  %23 = tail call float @llvm.fmuladd.f32(float %7, float %i.ed, float %6) ; 3 uses
  %i.fx = insertelement <2 x float> poison, float %23, i64 0 ; 2 uses
  %i.fy = insertelement <2 x float> %i.fx, float %20, i64 1
  %24 = fmul <2 x float> %i.dy, %i.fy
  %25 = fneg float %23                            ; 2 uses
  %26 = insertelement <2 x float> poison, float %25, i64 0
  %27 = insertelement <2 x float> %26, float %i.fw, i64 1
  %28 = fmul <2 x float> %17, %27
  %29 = insertelement <2 x float> %i.eh, float %13, i64 1
  %i.fz = shufflevector <2 x float> %i.ck, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.ga = shufflevector <2 x float> %i.ck, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %30 = insertelement <2 x float> %i.ga, float %i.el, i64 0
  %i.gb = insertelement <2 x float> poison, float %13, i64 0
  %i.gc = insertelement <2 x float> %i.gb, float %15, i64 1
  %31 = shufflevector <2 x float> %19, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %32 = tail call float @llvm.fmuladd.f32(float %i.bx, float %i.cc, float %i.av)
  %33 = tail call float @llvm.fmuladd.f32(float %i.by, float %i.cd, float %32)
  %34 = tail call float @llvm.fmuladd.f32(float %i.bz, float %i.ce, float %33) ; 6 uses
  %i.gd = fneg float %i.fo                        ; 2 uses
  %i.ge = tail call float @llvm.fmuladd.f32(float %i.bu, float %i.et, float %i.ew)
  %i.gf = tail call float @llvm.fmuladd.f32(float %i.bv, float %i.eu, float %i.ge)
  %i.gg = tail call float @llvm.fmuladd.f32(float %i.bw, float %i.ev, float %i.gf) ; 4 uses
  %i.gh = insertelement <2 x float> poison, float %i.gg, i64 0 ; 2 uses
  %i.gi = shufflevector <2 x float> %i.gh, <2 x float> poison, <2 x i32> zeroinitializer
  %i.gj = fmul <2 x float> %i.gi, %i.bo
  %35 = tail call float @llvm.fmuladd.f32(float %i.gg, float %i.ed, float %i.fr) ; 2 uses
  ...
  %38 = insertelement <2 x float> %i.fs, float %i.gd, i64 1
  %39 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.fk, <2 x float> %i.ec, <2 x float> %i.gj) ; 7 uses
  %40 = extractelement <2 x float> %39, i64 1
  %41 = extractelement <2 x float> %39, i64 0
  %i.gk = fneg float %21
  %i.gl = tail call float @llvm.fmuladd.f32(float %i.dt, float %34, float %i.dw) ; 4 uses
  %42 = fneg float %i.gl                          ; 2 uses
  %i.gm = extractelement <2 x float> %19, i64 1   ; 2 uses
  %i.gn = tail call float @llvm.fmuladd.f32(float %i.dq, float %34, float %i.ea) ; 4 uses
  %43 = fneg float %i.gn                          ; 2 uses
  %44 = fneg float %34
  %45 = insertelement <2 x float> poison, float %44, i64 0
  %46 = insertelement <2 x float> %45, float %34, i64 1
  %i.go = insertelement <2 x float> poison, float %i.gl, i64 0
  %i.gp = insertelement <2 x float> %i.go, float %43, i64 1
  %i.gq = fmul <2 x float> %i.ec, %i.gp
  %47 = fmul float %i.gg, %42
  %48 = fmul float %i.gg, %i.gn
  %49 = shufflevector <2 x float> %39, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %50 = insertelement <2 x float> poison, float %34, i64 0
  %i.gr = insertelement <2 x float> %50, float %i.eq, i64 1
  %51 = tail call float @llvm.fmuladd.f32(float %15, float %34, float %i.er) ; 4 uses
  %52 = tail call float @llvm.fmuladd.f32(float %i.dv, float %35, float %22)
  %53 = tail call float @llvm.fmuladd.f32(float %i.gl, float %40, float %52)
  %54 = tail call float @llvm.fmuladd.f32(float %i.gm, float %23, float %53)
  %55 = tail call float @llvm.fmuladd.f32(float %43, float %41, float %54)
  %56 = tail call float @llvm.fmuladd.f32(float %51, float %9, float %55)
  %57 = fdiv float 1.000000e+00, %56
  %58 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ee, <2 x float> %37, <2 x float> %24)
  %i.gs = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %46, <2 x float> %39, <2 x float> %58)
  %i.gt = insertelement <2 x float> poison, float %57, i64 0
  %59 = shufflevector <2 x float> %i.gt, <2 x float> poison, <2 x i32> zeroinitializer ; 8 uses
  %60 = fmul <2 x float> %i.gs, %59
  %61 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.eg, <2 x float> %37, <2 x float> %28)
  %i.gu = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %29, <2 x float> %39, <2 x float> %61)
  %i.gv = fmul <2 x float> %i.gu, %59
  %i.gw = insertelement <2 x float> poison, float %51, i64 0
  %i.gx = shufflevector <2 x float> %i.gw, <2 x float> poison, <2 x i32> zeroinitializer
  %i.gy = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bp, <2 x float> %i.gx, <2 x float> %i.gq)
  %i.gz = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ek, <2 x float> %19, <2 x float> %i.gy)
  %i.ha = fmul <2 x float> %i.gz, %59
  %i.hb = tail call float @llvm.fmuladd.f32(float %7, float %51, float %47)
  %i.hc = tail call float @llvm.fmuladd.f32(float %i.fm, float %51, float %48)
  %i.hd = insertelement <2 x float> poison, float %i.hb, i64 0
  %i.he = insertelement <2 x float> %i.hd, float %i.hc, i64 1
  %i.hf = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %38, <2 x float> %19, <2 x float> %i.he)
  %i.hg = fmul <2 x float> %i.hf, %59
  %i.hh = insertelement <2 x float> %49, float %25, i64 0
  %i.hi = fmul <2 x float> %11, %i.hh
  %i.hj = insertelement <2 x float> %39, float %i.fw, i64 0 ; 2 uses
  %i.hk = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %12, <2 x float> %i.hj, <2 x float> %i.hi)
  %i.hl = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.gr, <2 x float> %i.fu, <2 x float> %i.hk)
  %i.hm = fmul <2 x float> %i.hl, %59
  %i.hn = fneg <2 x float> %39
  %i.ho = shufflevector <2 x float> %i.fx, <2 x float> %i.hn, <2 x i32> <i32 0, i32 2>
  %i.hp = fmul <2 x float> %i.fz, %i.ho
  %i.hq = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %30, <2 x float> %i.hj, <2 x float> %i.hp)
  %i.hr = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.gc, <2 x float> %i.fu, <2 x float> %i.hq)
  %i.hs = fmul <2 x float> %i.hr, %59
  %i.ht = insertelement <2 x float> %31, float %42, i64 0
  %i.hu = fmul <2 x float> %i.em, %i.ht
  %i.hv = insertelement <2 x float> %19, float %i.gn, i64 0
  ...
  %i.hy = fmul <2 x float> %i.hx, %59
  %i.hz = fmul float %i.fl, %i.gl
  %i.ia = fmul float %i.fl, %i.gk
  %i.ib = tail call float @llvm.fmuladd.f32(float %10, float %i.gn, float %i.hz)
  %i.ic = tail call float @llvm.fmuladd.f32(float %7, float %i.gm, float %i.ia)
  %62 = insertelement <2 x float> %i.gh, float %i.gd, i64 1
  %63 = insertelement <2 x float> poison, float %i.ic, i64 0
  %i.id = insertelement <2 x float> %63, float %i.ib, i64 1
  %64 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %62, <2 x float> %i.ep, <2 x float> %i.id)
  %65 = shufflevector <2 x float> %64, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.ie = fmul <2 x float> %65, %59
  %i.if = fmul <2 x float> %i.bq, %i.gv
  %i.ig = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %60, <2 x float> %i.br, <2 x float> %i.if)
...
bb.a:
  ...
  %.sroa.03.0.copyload.i = load <2 x float>, ptr %i.a, align 4 ; 6 uses
  ...
  %.sroa.07.0.vec.extract.i.i = extractelement <2 x float> %.sroa.03.0.copyload.i, i64 0 ; 5 uses
  %.sroa.07.4.vec.extract.i.i = extractelement <2 x float> %.sroa.03.0.copyload.i, i64 1 ; 5 uses
...
GetCameraUp.exit:                                 ; preds = %bb.a, %bb.b
  ...
  %.sroa.06.4.vec.extract.i = extractelement <2 x float> %.sroa.070.0.copyload, i64 0
  %.sroa.03.4.vec.extract.i = extractelement <2 x float> %.sroa.068.0.copyload, i64 0
  %.sroa.08.4.vec.insert.i = fsub <2 x float> %.sroa.070.0.copyload, %.sroa.068.0.copyload ; 11 uses
  %i.l = extractelement <2 x float> %.sroa.08.4.vec.insert.i, i64 1 ; 5 uses
  %i.m = extractelement <2 x float> %.sroa.08.4.vec.insert.i, i64 0 ; 6 uses
  %i.n = fsub float %.sroa.271.0.copyload, %.sroa.269.0.copyload ; 7 uses
  br i1 %2, label %bb.c, label %bb.d
...
GetCameraRight.exit:                              ; preds = %GetCameraUp.exit.i, %bb.g
  %.sroa.013.0.i.i112 = phi <2 x float> [ %.sroa.013.4.vec.insert.i.i116, %bb.g ], [ %.sroa.018.4.vec.insert.i.i, %GetCameraUp.exit.i ] ; 5 uses
  %.sroa.617.0.i.i113 = phi float [ %i.cm, %bb.g ], [ %i.ce, %GetCameraUp.exit.i ] ; 3 uses
  %.sroa.044.0.vec.extract.i = extractelement <2 x float> %.sroa.013.0.i.i112, i64 0 ; 2 uses
  %foldExtExtBinop = fmul <2 x float> %.sroa.013.0.i.i112, %.sroa.013.0.i.i112
  ...
  %i.cr = select i1 %i.cp, float 1.000000e+00, float %i.cq
  %6 = shufflevector <2 x float> %.sroa.013.0.i.i112, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %7 = insertelement <2 x float> %6, float %.sroa.617.0.i.i113, i64 0
  %8 = insertelement <2 x float> poison, float %i.cr, i64 0
  %9 = shufflevector <2 x float> %8, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %10 = fmul <2 x float> %7, %9                   ; 4 uses
  %11 = fmul <2 x float> %.sroa.013.0.i.i112, %9  ; 3 uses
  %i.cs = fmul float %.2, 5.000000e-01            ; 4 uses
  %12 = tail call float @sinf(float noundef %i.cs) #56
  %i.ct = tail call float @cosf(float noundef %i.cs) #56
  %13 = shufflevector <2 x float> %.sroa.08.4.vec.insert.i, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %14 = insertelement <2 x float> %13, float %i.n, i64 1 ; 3 uses
  %15 = fneg <2 x float> %14
  %16 = fneg <2 x float> %.sroa.08.4.vec.insert.i
  %17 = insertelement <2 x float> %13, float %i.n, i64 0 ; 2 uses
  %18 = fneg <2 x float> %17
  %i.cu = fmul float %i.ct, 2.000000e+00          ; 2 uses
  ...
  %21 = fmul <2 x float> %20, %10                 ; 5 uses
  %22 = shufflevector <2 x float> %10, <2 x float> %11, <2 x i32> <i32 1, i32 3>
  %23 = fmul <2 x float> %20, %22                 ; 5 uses
  %24 = shufflevector <2 x float> %11, <2 x float> %10, <2 x i32> <i32 1, i32 2>
  %25 = fmul <2 x float> %20, %24
  %26 = fmul <2 x float> %23, %18
  %27 = fmul <2 x float> %21, %15
  %28 = shufflevector <2 x float> %23, <2 x float> %21, <2 x i32> <i32 1, i32 2>
  %29 = fmul <2 x float> %28, %16
  %30 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %21, <2 x float> %.sroa.08.4.vec.insert.i, <2 x float> %26) ; 3 uses
  %31 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %25, <2 x float> %17, <2 x float> %27) ; 2 uses
  %32 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %23, <2 x float> %14, <2 x float> %29)
  %33 = extractelement <2 x float> %30, i64 0
  %i.cv = fneg float %33
  %34 = extractelement <2 x float> %21, i64 0
  %i.cw = fmul float %34, %i.cv
  %35 = extractelement <2 x float> %30, i64 1
  %36 = extractelement <2 x float> %23, i64 1
  %i.cx = tail call float @llvm.fmuladd.f32(float %36, float %35, float %i.cw)
  %37 = fneg <2 x float> %32
  %38 = fmul <2 x float> %23, %37
  %39 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %21, <2 x float> %31, <2 x float> %38)
  %40 = extractelement <2 x float> %31, i64 0
  %i.cy = fmul float %i.cu, %40
  %41 = insertelement <2 x float> poison, float %i.cu, i64 0
  %42 = shufflevector <2 x float> %41, <2 x float> poison, <2 x i32> zeroinitializer
  %43 = fmul <2 x float> %42, %30
  %44 = fmul float %i.cx, 2.000000e+00
  %45 = fmul <2 x float> %39, splat (float 2.000000e+00)
  %i.cz = fadd float %i.m, %i.cy
  %46 = fadd <2 x float> %14, %43
  %i.da = fadd float %i.cz, %44                   ; 2 uses
  %47 = fadd <2 x float> %46, %45                 ; 3 uses
...
bb.h:                                             ; preds = %GetCameraRight.exit
  ...
  %i.db = fsub float %.sroa.06.4.vec.extract.i, %i.da
  %.sroa.08.0.vec.insert.i122 = insertelement <2 x float> poison, float %i.db, i64 0
  %48 = shufflevector <2 x float> %.sroa.070.0.copyload, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %.sroa.08.4.vec.insert.i125 = insertelement <2 x float> %48, float %.sroa.223.0.copyload, i64 1
  %49 = fsub <2 x float> %.sroa.08.4.vec.insert.i125, %47 ; 2 uses
  %50 = shufflevector <2 x float> %.sroa.08.0.vec.insert.i122, <2 x float> %49, <2 x i32> <i32 0, i32 2>
  store <2 x float> %50, ptr %0, align 4
  %51 = extractelement <2 x float> %49, i64 1
  store float %51, ptr %.sroa.269.0..sroa_idx, align 4
  br label %bb.j

bb.i:                                             ; preds = %GetCameraRight.exit
  %.sroa.213.0.copyload = load float, ptr %.sroa.269.0..sroa_idx, align 4
  %i.dc = fadd float %.sroa.03.4.vec.extract.i, %i.da
  %.sroa.08.0.vec.insert.i130 = insertelement <2 x float> poison, float %i.dc, i64 0
  %shift = shufflevector <2 x float> %.sroa.068.0.copyload, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop151 = fadd <2 x float> %shift, %47
  %.sroa.08.4.vec.insert.i133 = shufflevector <2 x float> %.sroa.08.0.vec.insert.i130, <2 x float> %foldExtExtBinop151, <2 x i32> <i32 0, i32 2>
  %52 = extractelement <2 x float> %47, i64 1
  %i.dd = fadd float %52, %.sroa.213.0.copyload
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.de = tail call float @sinf(float noundef %i.cs) #56
  %53 = tail call float @cosf(float noundef %i.cs) #56
  %i.df = fmul float %53, 2.000000e+00            ; 2 uses
  %54 = insertelement <2 x float> poison, float %i.de, i64 0
  %55 = shufflevector <2 x float> %54, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %56 = fmul <2 x float> %10, %55                 ; 3 uses
  %57 = fmul <2 x float> %11, %55                 ; 2 uses
  %i.dg = fneg float %.sroa.07.4.vec.extract.i.i
  %58 = shufflevector <2 x float> %.sroa.03.0.copyload.i, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %59 = insertelement <2 x float> %58, float %.sroa.24.0.copyload, i64 0
  %60 = fneg <2 x float> %59
  %61 = fmul <2 x float> %57, %60
  %62 = extractelement <2 x float> %56, i64 0     ; 3 uses
  %i.dh = fmul float %62, %i.dg
  %63 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %56, <2 x float> %.sroa.03.0.copyload.i, <2 x float> %61) ; 3 uses
  %64 = extractelement <2 x float> %57, i64 1     ; 3 uses
  %65 = tail call float @llvm.fmuladd.f32(float %64, float %.sroa.24.0.copyload, float %i.dh) ; 3 uses
  %66 = extractelement <2 x float> %63, i64 0     ; 2 uses
  %i.di = fneg float %66
  %i.dj = fmul float %62, %i.di
  %67 = extractelement <2 x float> %63, i64 1     ; 2 uses
  %i.dk = tail call float @llvm.fmuladd.f32(float %64, float %67, float %i.dj)
  %i.dl = fneg float %65
  %68 = fneg float %67
  %69 = fmul float %64, %i.dl
  %70 = extractelement <2 x float> %56, i64 1     ; 2 uses
  %i.dm = fmul float %70, %68
  %i.dn = tail call float @llvm.fmuladd.f32(float %70, float %66, float %69)
  %71 = tail call float @llvm.fmuladd.f32(float %62, float %65, float %i.dm)
  %i.do = fmul float %i.df, %65
  %72 = insertelement <2 x float> poison, float %i.df, i64 0
  %73 = shufflevector <2 x float> %72, <2 x float> poison, <2 x i32> zeroinitializer
  %74 = fmul <2 x float> %73, %63
  %i.dp = fmul float %i.dk, 2.000000e+00
  %75 = insertelement <2 x float> poison, float %71, i64 0
  %76 = insertelement <2 x float> %75, float %i.dn, i64 1
  %77 = fmul <2 x float> %76, splat (float 2.000000e+00)
  %i.dq = fadd float %.sroa.07.0.vec.extract.i.i, %i.do
  %78 = insertelement <2 x float> %58, float %.sroa.24.0.copyload, i64 1
  %79 = fadd <2 x float> %78, %74
  %i.dr = fadd float %i.dq, %i.dp
  %.sroa.071.4.vec.insert82.i141 = insertelement <2 x float> poison, float %i.dr, i64 0
  %80 = fadd <2 x float> %79, %77                 ; 2 uses
  %81 = shufflevector <2 x float> %.sroa.071.4.vec.insert82.i141, <2 x float> %80, <2 x i32> <i32 0, i32 2>
  store <2 x float> %81, ptr %i.a, align 4
  %82 = extractelement <2 x float> %80, i64 1
  store float %82, ptr %.sroa.24.0..sroa_idx.i, align 4
  br label %bb.l
