...
bb.a:
  ...
  %3 = insertelement <4 x float> poison, float %.sroa.946.0.copyload, i64 0
  %4 = shufflevector <4 x float> %3, <4 x float> poison, <4 x i32> zeroinitializer
  %5 = insertelement <4 x float> poison, float %.sroa.1047.0.copyload, i64 0
  %6 = shufflevector <4 x float> %5, <4 x float> poison, <4 x i32> zeroinitializer
  %.sroa.1350.0.copyload = load float, ptr %.sroa.1350.0..sroa_idx, align 4
  %.sroa.1451.0.copyload = load float, ptr %.sroa.1451.0..sroa_idx, align 4
  %7 = insertelement <4 x float> poison, float %.sroa.1350.0.copyload, i64 0
  %8 = shufflevector <4 x float> %7, <4 x float> poison, <4 x i32> zeroinitializer
  %i.i = insertelement <4 x float> poison, float %.sroa.1451.0.copyload, i64 0
  %i.j = shufflevector <4 x float> %i.i, <4 x float> poison, <4 x i32> zeroinitializer
  %.sroa.1350.0.copyload.a = load float, ptr %.sroa.1754.0..sroa_idx, align 4
  %.sroa.1451.0.copyload.a = load float, ptr %.sroa.1855.0..sroa_idx, align 4
  %i.k = load <2 x float>, ptr %i.a, align 4      ; 4 uses
  %9 = shufflevector <2 x float> %i.k, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %10 = fmul <2 x float> %9, %i.b                 ; 2 uses
  %11 = shufflevector <2 x float> %i.k, <2 x float> poison, <2 x i32> zeroinitializer
  %12 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %11, <2 x float> %i.c, <2 x float> %10)
  %13 = load <2 x float>, ptr %.sroa.744.0..sroa_idx, align 4 ; 4 uses
  %14 = load <2 x float>, ptr %.sroa.1148.0..sroa_idx, align 4 ; 4 uses
  %i.l = shufflevector <2 x float> %14, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %15 = load <2 x float>, ptr %.sroa.1552.0..sroa_idx, align 4 ; 4 uses
  %16 = shufflevector <2 x float> %15, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %17 = shufflevector <2 x float> %i.k, <2 x float> %13, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison> ; 2 uses
  %18 = shufflevector <2 x float> %14, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %19 = shufflevector <4 x float> %17, <4 x float> %18, <4 x i32> <i32 0, i32 1, i32 4, i32 poison>
  %i.m = shufflevector <2 x float> %15, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %20 = shufflevector <4 x float> %19, <4 x float> %i.m, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %21 = shufflevector <2 x float> %i.k, <2 x float> %13, <4 x i32> <i32 1, i32 3, i32 poison, i32 poison>
  %22 = shufflevector <4 x float> %21, <4 x float> %18, <4 x i32> <i32 0, i32 1, i32 5, i32 poison>
  %23 = shufflevector <4 x float> %22, <4 x float> %i.m, <4 x i32> <i32 0, i32 1, i32 2, i32 5>
  %24 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %20, <4 x float> zeroinitializer, <4 x float> %23) ; 4 uses
  %25 = shufflevector <2 x float> %12, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.n = shufflevector <2 x float> %13, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.o = fmul <2 x float> %i.n, %i.b              ; 2 uses
  %26 = shufflevector <2 x float> %13, <2 x float> poison, <2 x i32> zeroinitializer
  %27 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %26, <2 x float> %i.c, <2 x float> %i.o)
  ...
  %30 = fmul <2 x float> %29, %i.b                ; 2 uses
  %31 = shufflevector <2 x float> %30, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %32 = shufflevector <2 x float> %14, <2 x float> poison, <2 x i32> zeroinitializer
  %33 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %32, <2 x float> %i.c, <2 x float> %30)
  %34 = shufflevector <2 x float> %33, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %35 = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %36 = fmul <2 x float> %35, %i.b                ; 2 uses
  %37 = shufflevector <2 x float> %36, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %38 = shufflevector <4 x float> %17, <4 x float> %i.l, <4 x i32> <i32 0, i32 1, i32 4, i32 poison>
  %39 = shufflevector <4 x float> %38, <4 x float> %16, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %40 = shufflevector <2 x float> %10, <2 x float> %i.o, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
  %41 = shufflevector <4 x float> %40, <4 x float> %31, <4 x i32> <i32 0, i32 1, i32 4, i32 poison>
  %42 = shufflevector <4 x float> %41, <4 x float> %37, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %43 = fadd <4 x float> %39, %42                 ; 4 uses
  %i.p = shufflevector <4 x float> %43, <4 x float> %24, <4 x i32> <i32 0, i32 4, i32 poison, i32 poison>
  %i.q = shufflevector <4 x float> %i.p, <4 x float> %25, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  ...
  %i.t = shufflevector <4 x float> %43, <4 x float> %24, <4 x i32> <i32 1, i32 5, i32 poison, i32 poison>
  %i.u = shufflevector <4 x float> %i.t, <4 x float> %28, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %i.v = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.d, <4 x float> %4, <4 x float> %i.u)
  %i.w = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %6, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>, <4 x float> %i.v)
  store <4 x float> %i.w, ptr %.sroa.744.0..sroa_idx, align 4
  %i.x = shufflevector <4 x float> %43, <4 x float> %24, <4 x i32> <i32 2, i32 6, i32 poison, i32 poison>
  %i.y = shufflevector <4 x float> %i.x, <4 x float> %34, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %i.z = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.d, <4 x float> %8, <4 x float> %i.y)
  %i.aa = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.j, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>, <4 x float> %i.z)
  store <4 x float> %i.aa, ptr %.sroa.1148.0..sroa_idx, align 4
  %44 = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> zeroinitializer
  %45 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %44, <2 x float> %i.c, <2 x float> %36)
  %i.ab = insertelement <4 x float> poison, float %.sroa.1350.0.copyload.a, i64 0
  %i.ac = shufflevector <4 x float> %i.ab, <4 x float> poison, <4 x i32> zeroinitializer
  %i.ad = shufflevector <4 x float> %43, <4 x float> %24, <4 x i32> <i32 3, i32 7, i32 poison, i32 poison>
  %i.ae = shufflevector <2 x float> %45, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  ...
  %i.ah = insertelement <4 x float> poison, float %.sroa.1451.0.copyload.a, i64 0
...
bb.a:
  ...
  %9 = tail call float @llvm.fmuladd.f32(float %i.a, float -2.000000e+00, float %i.b)
  %10 = tail call float @llvm.fmuladd.f32(float %i.b, float 2.000000e+00, float %i.d)
  %11 = fadd float %8, %9                         ; 2 uses
  %12 = fadd float %10, 1.000000e+00              ; 2 uses
  %i.g = insertelement <2 x float> poison, float %11, i64 0
  %13 = shufflevector <2 x float> %i.g, <2 x float> poison, <2 x i32> zeroinitializer
  %14 = fmul <2 x float> %2, %13
  %15 = insertelement <2 x float> poison, float %12, i64 0
  %i.h = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> zeroinitializer
  %i.i = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.h, <2 x float> %0, <2 x float> %14)
  ...
  %i.p = fmul float %3, %11
  %i.q = tail call float @llvm.fmuladd.f32(float %12, float %1, float %i.p)
...
bb.a:
  ...
  %8 = extractelement <2 x float> %foldExtExtBinop, i64 1 ; 2 uses
  %foldExtExtBinop70 = fsub <2 x float> %4, %2    ; 2 uses
  %9 = extractelement <2 x float> %foldExtExtBinop70, i64 0 ; 2 uses
  %10 = fsub float %5, %3                         ; 3 uses
  ...
  %11 = fmul float %8, %8
  %i.l = tail call float @llvm.fmuladd.f32(float %9, float %9, float %11)
  %i.m = tail call float @llvm.fmuladd.f32(float %10, float %10, float %i.l)
  %12 = shufflevector <2 x float> %foldExtExtBinop, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.n = fmul <2 x float> %12, %i.k
  %13 = shufflevector <2 x float> %foldExtExtBinop70, <2 x float> poison, <2 x i32> zeroinitializer
  %i.o = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %13, <2 x float> %i.h, <2 x float> %i.n)
  %14 = insertelement <2 x float> poison, float %10, i64 0
  %i.p = shufflevector <2 x float> %14, <2 x float> poison, <2 x i32> zeroinitializer
