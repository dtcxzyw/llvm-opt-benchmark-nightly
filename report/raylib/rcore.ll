...
.lr.ph115:                                        ; preds = %bb.c
  ...
  %4 = trunc i32 %smax to i1
  %lcmp.mod170 = trunc i32 %smax to i1
  %5 = and i32 %smax138, 2147483632
  %unroll_iter177 = zext nneg i32 %5 to i64
  %6 = trunc i32 %smax138 to i1
...
.lr.ph109.preheader.unr-lcssa:                    ; preds = %.lr.ph107
  br i1 %4, label %.lr.ph107.epil.preheader, label %.lr.ph109.preheader.new
...
.lr.ph112.preheader.unr-lcssa:                    ; preds = %.lr.ph109
  br i1 %6, label %.lr.ph109.epil.preheader, label %.lr.ph112.preheader
...
.lr.ph98.preheader.new:                           ; preds = %.lr.ph98.preheader
  %6 = and i32 %4, 2147483646
  %unroll_iter207 = zext nneg i32 %6 to i64
  br label %.lr.ph98
...
._crit_edge99.loopexit.unr-lcssa:                 ; preds = %.lr.ph98
  %7 = trunc i32 %4 to i1
  br i1 %7, label %.lr.ph98.epil.preheader, label %._crit_edge99.loopexit
...
.lr.ph63.i.preheader:                             ; preds = %.preheader.i
  ...
  %8 = trunc i32 %i.dp to i1
  br i1 %8, label %.lr.ph63.i.prol, label %.lr.ph63.i.prol.loopexit
...
.lr.ph.preheader.i.unr-lcssa:                     ; preds = %bb.b
  %5 = trunc i32 %3 to i1
  br i1 %5, label %.epil.preheader, label %.lr.ph.preheader.i
...
sdefl_gen_codes.exit.unr-lcssa:                   ; preds = %.preheader.i52
  %6 = trunc i32 %3 to i1
  br i1 %6, label %.preheader.i52.epil.preheader, label %sdefl_gen_codes.exit
