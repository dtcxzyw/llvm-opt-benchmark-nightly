...
sinfl_decode.exit234:                             ; preds = %bb.ax, %bb.ay
  ...
  %i.rb = ptrtoint ptr %.3156 to i64              ; 13 uses
...
bb.az:                                            ; preds = %sinfl_decode.exit234
  ...
  %i.rh = ashr exact i64 %sext, 32                ; 5 uses
...
bb.bb:                                            ; preds = %bb.ba
  ...
  %i.ru = tail call i64 @llvm.umax.i64(i64 %5, i64 %i.rt)
...
bb.bd:                                            ; preds = %bb.bc
  ...
  %i.sz = tail call i64 @llvm.umax.i64(i64 %6, i64 %i.sy)
...
iter.check:                                       ; preds = %bb.bc
  ...
  %7 = add i64 %i.rh, %i.rb
  %i.tr = add i64 %i.rb, 3
  %umax = tail call i64 @llvm.umax.i64(i64 %7, i64 %i.tr)
  %i.ts = add i64 %umax, -2
...
iter.check534:                                    ; preds = %bb.az
  ...
  %8 = add i64 %i.rh, %i.rb
  %i.uo = add i64 %i.rb, 3
  %umax515 = tail call i64 @llvm.umax.i64(i64 %8, i64 %i.uo)
