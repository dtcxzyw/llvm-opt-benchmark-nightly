...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %3 = zext i8 %i.z to i32
  %4 = mul nuw nsw i32 %3, %i.x
  ...
  %6 = mul nuw nsw i32 %5, %i.x
  %.lhs.trunc31 = trunc nuw i32 %6 to i16
  ...
  %8 = mul nuw nsw i32 %7, %i.x
  %.lhs.trunc33 = trunc nuw i32 %8 to i16
...
vector.body:                                      ; preds = %vector.body, %.lr.ph.preheader.i.i
  ...
  %i.aen = insertelement <4 x i8> %i.aem, i8 %i.aej, i64 3
  %i.aeo = zext <4 x i8> %i.aen to <4 x i32>      ; 4 uses
  ...
  %3 = zext <4 x i8> %i.aex to <4 x i32>
  %4 = mul nuw nsw <4 x i32> %3, %i.aeo
  %5 = trunc nuw <4 x i32> %4 to <4 x i16>
  ...
  %6 = zext <4 x i8> %i.afn to <4 x i32>
  %7 = mul nuw nsw <4 x i32> %6, %i.aeo
  %8 = trunc nuw <4 x i32> %7 to <4 x i16>
  %i.afo = udiv <4 x i16> %8, splat (i16 255)
  ...
  %9 = zext <4 x i8> %i.agd to <4 x i32>
  %10 = mul nuw nsw <4 x i32> %9, %i.aeo
  %11 = trunc nuw <4 x i32> %10 to <4 x i16>
  %i.age = udiv <4 x i16> %11, splat (i16 255)
