...
.lr.ph:                                           ; preds = %bb.i, %.lr.ph
  ...
  %i.ab = add nuw nsw i64 %.044, 1                ; 3 uses
...
begin_hunk_1_@ma_channel_map_apply_f32:bb.a
  %i.ss = getelementptr inbounds nuw i8, ptr %i.sm, i64 8
  %i.st = load float, ptr %i.ss, align 8
  %i.su = tail call float @llvm.fmuladd.f32(float %i.qb, float %i.st, float %i.sr)
  %i.sv = getelementptr inbounds nuw i8, ptr %i.sm, i64 12
  %i.sw = load float, ptr %i.sv, align 4
  %i.sx = tail call float @llvm.fmuladd.f32(float %i.qd, float %i.sw, float %i.su)
  %i.sy = fadd float %i.sx, 0.000000e+00
  %i.sz = getelementptr inbounds nuw i8, ptr %i.sm, i64 20
  %i.ta = load float, ptr %i.sz, align 4
  %i.tb = tail call float @llvm.fmuladd.f32(float %i.qf, float %i.ta, float %i.sy)
  %i.tc = tail call float @llvm.fmuladd.f32(float %i.sl, float %i.tb, float %i.sk) ; 2 uses
...
ma_channel_map_get_channel.exit353.us399.us:      ; preds = %ma_channel_map_get_channel.exit350.us.us, %ma_channel_map_get_channel.exit353.us399.us
  ...
  %.0394.us400.us = phi float [ %i.ub, %ma_channel_map_get_channel.exit353.us399.us ], [ 0.000000e+00, %ma_channel_map_get_channel.exit350.us.us ]
  %i.td = getelementptr inbounds nuw i8, ptr %4, i64 %indvars.iv
  %i.te = load i8, ptr %i.td, align 1
  %i.tf = trunc nuw i64 %indvars.iv to i32
  %i.tg = add i32 %i.mx, %i.tf
  %i.th = zext i32 %i.tg to i64
  %i.ti = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.th
  %i.tj = load float, ptr %i.ti, align 4
  %i.tk = zext i8 %i.te to i64
  %i.tl = getelementptr inbounds nuw [24 x i8], ptr @g_maChannelPlaneRatios, i64 %i.tk ; 5 uses
  %i.tm = load float, ptr %i.tl, align 8
  %i.tn = getelementptr inbounds nuw i8, ptr %i.tl, i64 4
  %i.to = load float, ptr %i.tn, align 4
  %i.tp = fmul float %i.pz, %i.to
  %i.tq = tail call float @llvm.fmuladd.f32(float %i.px, float %i.tm, float %i.tp)
  %i.tr = getelementptr inbounds nuw i8, ptr %i.tl, i64 8
  %i.ts = load float, ptr %i.tr, align 8
  %i.tt = tail call float @llvm.fmuladd.f32(float %i.qb, float %i.ts, float %i.tq)
  %i.tu = getelementptr inbounds nuw i8, ptr %i.tl, i64 12
  %i.tv = load float, ptr %i.tu, align 4
  %i.tw = tail call float @llvm.fmuladd.f32(float %i.qd, float %i.tv, float %i.tt)
  %i.tx = fadd float %i.tw, 0.000000e+00
  %i.ty = getelementptr inbounds nuw i8, ptr %i.tl, i64 20
  %i.tz = load float, ptr %i.ty, align 4
  %i.ua = tail call float @llvm.fmuladd.f32(float %i.qf, float %i.tz, float %i.tx)
  %i.ub = tail call float @llvm.fmuladd.f32(float %i.tj, float %i.ua, float %.0394.us400.us) ; 2 uses
...
.lr.ph.split.us.us.us:                            ; preds = %ma_channel_map_get_channel.exit353.us.us.us.peel322, %ma_channel_map_get_channel.exit353.us.us.us
  ...
  %.0394.us.us.us = phi float [ %i.vf, %ma_channel_map_get_channel.exit353.us.us.us ], [ %i.tc, %ma_channel_map_get_channel.exit353.us.us.us.peel322 ]
...
bb.u:                                             ; preds = %.lr.ph.split.us.us.us
  %i.uc = icmp samesign ult i64 %indvars.iv530, 6
  br i1 %i.uc, label %switch.lookup, label %.thread.i67.i.us.us.us
...
bb.v:                                             ; preds = %.lr.ph.split.us.us.us
  %i.ud = icmp samesign ult i64 %indvars.iv530, 7
  br i1 %i.ud, label %switch.lookup161, label %.thread.i67.i.us.us.us
...
bb.w:                                             ; preds = %.lr.ph.split.us.us.us
  %i.ue = icmp samesign ult i64 %indvars.iv530, 8
  br i1 %i.ue, label %switch.lookup165, label %bb.x

bb.x:                                             ; preds = %bb.w
  %i.uf = icmp samesign ult i64 %indvars.iv530, 32
  %or.cond.i73.i.us.us.us = and i1 %i.mm, %i.uf
  %i.ug = add nuw nsw i64 %indvars.iv530, 12
  %spec.select689 = select i1 %or.cond.i73.i.us.us.us, i64 %i.ug, i64 0
  br label %ma_channel_map_get_channel.exit353.us.us.us

switch.lookup:                                    ; preds = %bb.u
  %switch.tableidx = add nuw nsw i64 %indvars.iv530, 4294967295
  %i.uh = and i64 %switch.tableidx, 4294967295
  %switch.gep = getelementptr inbounds nuw i8, ptr @switch.table.ma_channel_map_apply_f32, i64 %i.uh
...
switch.lookup161:                                 ; preds = %bb.v
  ...
  %i.ui = and i64 %switch.tableidx160, 4294967295
  %switch.gep162 = getelementptr inbounds nuw i8, ptr @switch.table.ma_channel_map_apply_f32.47, i64 %i.ui
...
ma_channel_map_get_channel.exit353.us.us.us:      ; preds = %switch.lookup165, %switch.lookup161, %switch.lookup, %bb.x, %.thread.i67.i.us.us.us, %switch.lookup.i68.i.us.us.us, %.lr.ph.split.us.us.us
  ...
  %i.uj = trunc nuw i64 %indvars.iv530 to i32
  %i.uk = add i32 %i.mx, %i.uj
  %i.ul = zext i32 %i.uk to i64
  %i.um = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.ul
  %i.un = load float, ptr %i.um, align 4
  %i.uo = and i64 %.0.i352.us.us.us, 255
  %i.up = getelementptr inbounds nuw [24 x i8], ptr @g_maChannelPlaneRatios, i64 %i.uo ; 5 uses
...
._crit_edge.us.us:                                ; preds = %ma_channel_map_get_channel.exit353.us.us.us.peel546, %ma_channel_map_get_channel.exit353.us399.us, %ma_channel_map_get_channel.exit353.us.us.us.peel322, %ma_channel_map_get_channel.exit353.us.us.us.peel, %ma_channel_map_get_channel.exit353.us.us.us.peel287, %ma_channel_map_get_channel.exit353.us.us.us, %.lr.ph.split.us.us.us.preheader
  %.us-phi.us.us = phi float [ %i.vf, %ma_channel_map_get_channel.exit353.us.us.us ], [ %i.ra, %ma_channel_map_get_channel.exit353.us.us.us.peel546 ], [ %i.qs, %.lr.ph.split.us.us.us.preheader ], [ %i.tc, %ma_channel_map_get_channel.exit353.us.us.us.peel322 ], [ %i.rs, %ma_channel_map_get_channel.exit353.us.us.us.peel ], [ %i.sk, %ma_channel_map_get_channel.exit353.us.us.us.peel287 ], [ %i.ub, %ma_channel_map_get_channel.exit353.us399.us ]
...
ma_channel_map_get_channel.exit347.us:            ; preds = %.lr.ph, %ma_channel_map_get_channel.exit347.us
  ...
  %i.wf = trunc nuw nsw i64 %indvars.iv571 to i32
...
.lr.ph455:                                        ; preds = %.preheader361
  ...
  %i.yw = add i64 %6, -536870913
  %i.yx = icmp ult i64 %i.yw, -536870912
  %or.cond170 = or i1 %min.iters.check96, %i.yx
  br i1 %or.cond170, label %scalar.ph95.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph455
  %i.yy = shl nuw nsw i64 %6, 5
  %scevgep = getelementptr i8, ptr %0, i64 %i.yy
  %i.yz = shl nuw nsw i64 %6, 3
  %scevgep94 = getelementptr i8, ptr %3, i64 %i.yz
...
vector.ph97:                                      ; preds = %vector.memcheck
  ...
  %i.ze = shufflevector <2 x float> %i.yr, <2 x float> %i.ys, <8 x i32> <i32 1, i32 1, i32 1, i32 1, i32 3, i32 3, i32 3, i32 3>
  %i.zf = shufflevector <2 x float> %i.yr, <2 x float> %i.ys, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 2, i32 2, i32 2, i32 2>
  %i.zg = shufflevector <2 x float> %i.yt, <2 x float> %i.yu, <8 x i32> <i32 1, i32 1, i32 1, i32 1, i32 3, i32 3, i32 3, i32 3>
  %i.zh = shufflevector <2 x float> %i.yt, <2 x float> %i.yu, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 2, i32 2, i32 2, i32 2>
  %i.zi = shufflevector <8 x float> %i.za, <8 x float> %i.zc, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.zj = shufflevector <8 x float> %i.zb, <8 x float> %i.zd, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.zk = shufflevector <8 x float> %i.ze, <8 x float> %i.zg, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.zl = shufflevector <8 x float> %i.zf, <8 x float> %i.zh, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  br label %vector.body131

vector.body131:                                   ; preds = %vector.body131, %vector.ph97
  %index132 = phi i32 [ 0, %vector.ph97 ], [ %index.next134, %vector.body131 ] ; 3 uses
  %i.zm = shl i32 %index132, 1
  %i.zn = zext i32 %i.zm to i64
  %i.zo = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.zn
  %wide.vec = load <8 x float>, ptr %i.zo, align 4, !alias.scope !692 ; 2 uses
  ...
  %i.zy = shufflevector <4 x float> %strided.vec133, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.zz = shufflevector <4 x float> %strided.vec, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.aaa = shufflevector <8 x float> %i.zs, <8 x float> %i.zu, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.aab = shufflevector <8 x float> %i.zt, <8 x float> %i.zv, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.aac = tail call <16 x float> @llvm.fmuladd.v16f32(<16 x float> %i.aab, <16 x float> %i.zj, <16 x float> zeroinitializer)
  %i.aad = tail call <16 x float> @llvm.fmuladd.v16f32(<16 x float> %i.aaa, <16 x float> %i.zi, <16 x float> %i.aac)
  ...
  %i.aaf = shufflevector <8 x float> %i.zx, <8 x float> %i.zz, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.aag = tail call <16 x float> @llvm.fmuladd.v16f32(<16 x float> %i.aaf, <16 x float> %i.zl, <16 x float> zeroinitializer)
  %i.aah = tail call <16 x float> @llvm.fmuladd.v16f32(<16 x float> %i.aae, <16 x float> %i.zk, <16 x float> %i.aag)
  %interleaved.vec = shufflevector <16 x float> %i.aad, <16 x float> %i.aah, <32 x i32> <i32 0, i32 4, i32 8, i32 12, i32 16, i32 20, i32 24, i32 28, i32 1, i32 5, i32 9, i32 13, i32 17, i32 21, i32 25, i32 29, i32 2, i32 6, i32 10, i32 14, i32 18, i32 22, i32 26, i32 30, i32 3, i32 7, i32 11, i32 15, i32 19, i32 23, i32 27, i32 31>
  store <32 x float> %interleaved.vec, ptr %i.zr, align 4, !alias.scope !693, !noalias !692
  %index.next134 = add nuw i32 %index132, 4       ; 2 uses
  %i.aai = icmp eq i32 %index.next134, %n.vec98
  br i1 %i.aai, label %middle.block135, label %vector.body131, !llvm.loop !682
...
scalar.ph95.preheader:                            ; preds = %vector.memcheck, %.lr.ph455, %middle.block135
  ...
  %i.aaj = shufflevector <2 x float> %i.yn, <2 x float> %i.yo, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
  %i.aak = shufflevector <2 x float> %i.yp, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %i.aal = shufflevector <4 x float> %i.aaj, <4 x float> %i.aak, <4 x i32> <i32 0, i32 1, i32 4, i32 poison>
  %i.aam = shufflevector <2 x float> %i.yq, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %i.aan = shufflevector <4 x float> %i.aal, <4 x float> %i.aam, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %i.aao = shufflevector <2 x float> %i.yn, <2 x float> %i.yo, <4 x i32> <i32 1, i32 3, i32 poison, i32 poison>
  %i.aap = shufflevector <4 x float> %i.aao, <4 x float> %i.aak, <4 x i32> <i32 0, i32 1, i32 5, i32 poison>
  %i.aaq = shufflevector <4 x float> %i.aap, <4 x float> %i.aam, <4 x i32> <i32 0, i32 1, i32 2, i32 5>
  %i.aar = shufflevector <2 x float> %i.yr, <2 x float> %i.ys, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
  %i.aas = shufflevector <2 x float> %i.yt, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %i.aat = shufflevector <4 x float> %i.aar, <4 x float> %i.aas, <4 x i32> <i32 0, i32 1, i32 4, i32 poison>
  %i.aau = shufflevector <2 x float> %i.yu, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %i.aav = shufflevector <4 x float> %i.aat, <4 x float> %i.aau, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %i.aaw = shufflevector <2 x float> %i.yr, <2 x float> %i.ys, <4 x i32> <i32 1, i32 3, i32 poison, i32 poison>
  %i.aax = shufflevector <4 x float> %i.aaw, <4 x float> %i.aas, <4 x i32> <i32 0, i32 1, i32 5, i32 poison>
  %i.aay = shufflevector <4 x float> %i.aax, <4 x float> %i.aau, <4 x i32> <i32 0, i32 1, i32 2, i32 5>
  br label %scalar.ph95

scalar.ph95:                                      ; preds = %scalar.ph95.preheader, %scalar.ph95
  %.0314454 = phi i32 [ %i.abp, %scalar.ph95 ], [ %.0314454.ph, %scalar.ph95.preheader ] ; 3 uses
  %i.aaz = shl i32 %.0314454, 1
  %i.aba = zext i32 %i.aaz to i64
  %i.abb = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.aba
  %i.abc = shl i32 %.0314454, 3                   ; 2 uses
  %i.abd = zext i32 %i.abc to i64
  %i.abe = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.abd
  %i.abf = load <2 x float>, ptr %i.abb, align 4  ; 2 uses
  %i.abg = shufflevector <2 x float> %i.abf, <2 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %i.abh = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.abg, <4 x float> %i.aan, <4 x float> zeroinitializer)
  %i.abi = shufflevector <2 x float> %i.abf, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1> ; 2 uses
  %i.abj = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.abi, <4 x float> %i.aaq, <4 x float> %i.abh)
  store <4 x float> %i.abj, ptr %i.abe, align 4
  %i.abk = or disjoint i32 %i.abc, 4
  %i.abl = zext i32 %i.abk to i64
  %i.abm = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.abl
  %i.abn = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.abg, <4 x float> %i.aav, <4 x float> zeroinitializer)
  %i.abo = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.abi, <4 x float> %i.aay, <4 x float> %i.abn)
  store <4 x float> %i.abo, ptr %i.abm, align 4
  %i.abp = add i32 %.0314454, 1                   ; 3 uses
  %i.abq = zext i32 %i.abp to i64
  %i.abr = icmp ugt i64 %6, %i.abq
  br i1 %i.abr, label %scalar.ph95, label %.loopexit362, !llvm.loop !683

.preheader363:                                    ; preds = %.preheader363.lr.ph, %._crit_edge443
  %.1315452 = phi i32 [ 0, %.preheader363.lr.ph ], [ %i.adk, %._crit_edge443 ] ; 3 uses
  br i1 %.not476, label %._crit_edge443, label %.lr.ph442

.lr.ph442:                                        ; preds = %.preheader363
  %i.abs = mul i32 %.1315452, %5
  br label %bb.ac

bb.ac:                                            ; preds = %.lr.ph442, %bb.ac
  %indvars.iv586 = phi i64 [ 0, %.lr.ph442 ], [ %indvars.iv.next587, %bb.ac ] ; 10 uses
  %i.abt = phi <4 x float> [ zeroinitializer, %.lr.ph442 ], [ %i.aco, %bb.ac ]
  %i.abu = phi <4 x float> [ zeroinitializer, %.lr.ph442 ], [ %i.adb, %bb.ac ]
  %i.abv = trunc nuw nsw i64 %indvars.iv586 to i32
  %i.abw = add i32 %i.abs, %i.abv
  %i.abx = zext i32 %i.abw to i64
  %i.aby = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.abx
  %i.abz = load float, ptr %i.aby, align 4
  %i.aca = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %indvars.iv586
  %i.acb = load float, ptr %i.aca, align 4
  %i.acc = getelementptr inbounds nuw [4 x i8], ptr %i.xz, i64 %indvars.iv586
  %i.acd = load float, ptr %i.acc, align 4
  %i.ace = getelementptr inbounds nuw [4 x i8], ptr %i.ya, i64 %indvars.iv586
  %i.acf = load float, ptr %i.ace, align 4
  %i.acg = getelementptr inbounds nuw [4 x i8], ptr %i.yb, i64 %indvars.iv586
  %i.ach = load float, ptr %i.acg, align 4
  %i.aci = insertelement <4 x float> poison, float %i.abz, i64 0
  %i.acj = shufflevector <4 x float> %i.aci, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %i.ack = insertelement <4 x float> poison, float %i.acb, i64 0
  %i.acl = insertelement <4 x float> %i.ack, float %i.acd, i64 1
  %i.acm = insertelement <4 x float> %i.acl, float %i.acf, i64 2
  %i.acn = insertelement <4 x float> %i.acm, float %i.ach, i64 3
  %i.aco = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.acj, <4 x float> %i.acn, <4 x float> %i.abt) ; 2 uses
  %i.acp = getelementptr inbounds nuw [4 x i8], ptr %i.yc, i64 %indvars.iv586
  %i.acq = load float, ptr %i.acp, align 4
  %i.acr = getelementptr inbounds nuw [4 x i8], ptr %i.yd, i64 %indvars.iv586
  %i.acs = load float, ptr %i.acr, align 4
  %i.act = getelementptr inbounds nuw [4 x i8], ptr %i.ye, i64 %indvars.iv586
  %i.acu = load float, ptr %i.act, align 4
  %i.acv = getelementptr inbounds nuw [4 x i8], ptr %i.yf, i64 %indvars.iv586
  ...
  %i.adb = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.acj, <4 x float> %i.ada, <4 x float> %i.abu) ; 2 uses
...
._crit_edge443:                                   ; preds = %bb.ac, %.preheader363
  %i.adc = phi <4 x float> [ zeroinitializer, %.preheader363 ], [ %i.aco, %bb.ac ]
  %i.add = phi <4 x float> [ zeroinitializer, %.preheader363 ], [ %i.adb, %bb.ac ]
  %i.ade = shl i32 %.1315452, 3                   ; 2 uses
  %i.adf = zext i32 %i.ade to i64
  %i.adg = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.adf
  store <4 x float> %i.adc, ptr %i.adg, align 4
  %i.adh = or disjoint i32 %i.ade, 4
  %i.adi = zext i32 %i.adh to i64
  %i.adj = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.adi
  store <4 x float> %i.add, ptr %i.adj, align 4
  %i.adk = add i32 %.1315452, 1                   ; 3 uses
  %i.adl = zext i32 %i.adk to i64
  %i.adm = icmp ugt i64 %6, %i.adl
  br i1 %i.adm, label %.preheader363, label %.loopexit362

.preheader366:                                    ; preds = %.preheader366.lr.ph, %._crit_edge425
  %.2431 = phi i32 [ 0, %.preheader366.lr.ph ], [ %i.aff, %._crit_edge425 ] ; 3 uses
  br i1 %.not474, label %._crit_edge425, label %.lr.ph424

.lr.ph424:                                        ; preds = %.preheader366
  %i.adn = mul i32 %.2431, %5
  br label %bb.ad

bb.ad:                                            ; preds = %.lr.ph424, %bb.ad
  %indvars.iv581 = phi i64 [ 0, %.lr.ph424 ], [ %indvars.iv.next582, %bb.ad ] ; 8 uses
  %i.ado = phi <2 x float> [ zeroinitializer, %.lr.ph424 ], [ %i.aes, %bb.ad ]
  %i.adp = phi <2 x float> [ zeroinitializer, %.lr.ph424 ], [ %i.ael, %bb.ad ]
  %i.adq = phi <2 x float> [ zeroinitializer, %.lr.ph424 ], [ %i.aee, %bb.ad ]
  %i.adr = trunc nuw nsw i64 %indvars.iv581 to i32
  %i.ads = add i32 %i.adn, %i.adr
  %i.adt = zext i32 %i.ads to i64
  %i.adu = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.adt
  %i.adv = load float, ptr %i.adu, align 4
  %i.adw = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %indvars.iv581
  %i.adx = load float, ptr %i.adw, align 4
  %i.ady = getelementptr inbounds nuw [4 x i8], ptr %i.xt, i64 %indvars.iv581
  %i.adz = load float, ptr %i.ady, align 4
  %i.aea = insertelement <2 x float> poison, float %i.adv, i64 0
  %i.aeb = shufflevector <2 x float> %i.aea, <2 x float> poison, <2 x i32> zeroinitializer ; 3 uses
  %i.aec = insertelement <2 x float> poison, float %i.adx, i64 0
  %i.aed = insertelement <2 x float> %i.aec, float %i.adz, i64 1
  %i.aee = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aeb, <2 x float> %i.aed, <2 x float> %i.adq) ; 2 uses
  %i.aef = getelementptr inbounds nuw [4 x i8], ptr %i.xu, i64 %indvars.iv581
  %i.aeg = load float, ptr %i.aef, align 4
  %i.aeh = getelementptr inbounds nuw [4 x i8], ptr %i.xv, i64 %indvars.iv581
  %i.aei = load float, ptr %i.aeh, align 4
  %i.aej = insertelement <2 x float> poison, float %i.aeg, i64 0
  %i.aek = insertelement <2 x float> %i.aej, float %i.aei, i64 1
  %i.ael = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aeb, <2 x float> %i.aek, <2 x float> %i.adp) ; 2 uses
  %i.aem = getelementptr inbounds nuw [4 x i8], ptr %i.xw, i64 %indvars.iv581
  %i.aen = load float, ptr %i.aem, align 4
  %i.aeo = getelementptr inbounds nuw [4 x i8], ptr %i.xx, i64 %indvars.iv581
  %i.aep = load float, ptr %i.aeo, align 4
  %i.aeq = insertelement <2 x float> poison, float %i.aen, i64 0
  %i.aer = insertelement <2 x float> %i.aeq, float %i.aep, i64 1
  %i.aes = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aeb, <2 x float> %i.aer, <2 x float> %i.ado) ; 2 uses
...
._crit_edge425:                                   ; preds = %bb.ad, %.preheader366
  %i.aet = phi <2 x float> [ zeroinitializer, %.preheader366 ], [ %i.aes, %bb.ad ]
  %i.aeu = phi <2 x float> [ zeroinitializer, %.preheader366 ], [ %i.ael, %bb.ad ]
  %i.aev = phi <2 x float> [ zeroinitializer, %.preheader366 ], [ %i.aee, %bb.ad ]
  %i.aew = mul i32 %.2431, 6                      ; 3 uses
  %i.aex = zext i32 %i.aew to i64
  %i.aey = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.aex
  store <2 x float> %i.aev, ptr %i.aey, align 4
  %i.aez = add i32 %i.aew, 2
  %i.afa = zext i32 %i.aez to i64
  %i.afb = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.afa
  store <2 x float> %i.aeu, ptr %i.afb, align 4
  %i.afc = add i32 %i.aew, 4
  %i.afd = zext i32 %i.afc to i64
  %i.afe = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.afd
  store <2 x float> %i.aet, ptr %i.afe, align 4
  %i.aff = add i32 %.2431, 1                      ; 3 uses
  %i.afg = zext i32 %i.aff to i64
  %i.afh = icmp ugt i64 %6, %i.afg
  br i1 %i.afh, label %.preheader366, label %.loopexit362
...
.loopexit362:                                     ; preds = %._crit_edge425, %._crit_edge443, %scalar.ph95, %middle.block135, %.preheader367, %.preheader364, %.preheader361, %._crit_edge416
  %.3 = phi i32 [ 0, %._crit_edge416 ], [ %i.abp, %scalar.ph95 ], [ %i.adk, %._crit_edge443 ], [ 0, %.preheader361 ], [ 0, %.preheader364 ], [ 0, %.preheader367 ], [ %n.vec98, %middle.block135 ], [ %i.aff, %._crit_edge425 ] ; 2 uses
  %i.afi = zext i32 %.3 to i64
  %i.afj = icmp ugt i64 %6, %i.afi
  br i1 %i.afj, label %.preheader360.lr.ph, label %.loopexit
...
.preheader360.lr.ph:                              ; preds = %.loopexit362
  ...
  %i.afk = add nsw i64 %wide.trip.count579, -1    ; 2 uses
  %xtraiter333 = and i64 %wide.trip.count569, 3   ; 3 uses
  %i.afl = add nsw i32 %5, -1
  %i.afm = icmp ult i32 %i.afl, 3
  ...
  %i.afn = trunc nsw i64 %i.afk to i32
  %i.afo = icmp ugt i64 %i.afk, 4294967295
...
.preheader360.us:                                 ; preds = %.preheader360.lr.ph, %._crit_edge463.us
  %.4464.us = phi i32 [ %i.aim, %._crit_edge463.us ], [ %.3, %.preheader360.lr.ph ] ; 3 uses
  %i.afp = mul i32 %.4464.us, %5                  ; 5 uses
  %i.afq = mul i32 %.4464.us, %2                  ; 8 uses
...
vector.scevcheck138:                              ; preds = %.preheader.us466.preheader
  %i.afr = xor i32 %i.afq, -1
  %i.afs = icmp ult i32 %i.afr, %i.afn
  %i.aft = or i1 %i.afs, %i.afo
  br i1 %i.aft, label %.preheader.us466.preheader171, label %vector.body143
...
vector.body143:                                   ; preds = %vector.scevcheck138, %vector.body143
  ...
  %i.afu = trunc nuw nsw i64 %index144 to i32
  %i.afv = add i32 %i.afq, %i.afu
  %i.afw = zext i32 %i.afv to i64
  %i.afx = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.afw ; 2 uses
  %i.afy = getelementptr inbounds nuw i8, ptr %i.afx, i64 16
  store <4 x float> zeroinitializer, ptr %i.afx, align 4
  store <4 x float> zeroinitializer, ptr %i.afy, align 4
  %index.next145 = add nuw i64 %index144, 8       ; 2 uses
  %i.afz = icmp eq i64 %index.next145, %n.vec142
  br i1 %i.afz, label %middle.block146, label %vector.body143, !llvm.loop !684
...
.preheader.us466.prol:                            ; preds = %.preheader.us466.preheader171, %.preheader.us466.prol
  ...
  %i.aga = trunc nuw nsw i64 %indvars.iv601.prol to i32
  %i.agb = add i32 %i.afq, %i.aga
...
.preheader.us466.prol.loopexit:                   ; preds = %.preheader.us466.prol, %.preheader.us466.preheader171
  ...
  %i.age = sub nsw i64 %indvars.iv601.ph, %wide.trip.count579
  %i.agf = icmp ugt i64 %i.age, -4
  br i1 %i.agf, label %._crit_edge463.us, label %.preheader.us466.preheader171.new

.preheader.us466.preheader171.new:                ; preds = %.preheader.us466.prol.loopexit
  %invariant.op374 = add i32 1, %i.afq
  %invariant.op376 = add i32 2, %i.afq
  %invariant.op378 = add i32 3, %i.afq
...
.preheader.us466:                                 ; preds = %.preheader.us466, %.preheader.us466.preheader171.new
  ...
  %i.agg = trunc nuw nsw i64 %indvars.iv601 to i32
  %i.agh = add i32 %i.afq, %i.agg
  ...
  %.reass375 = add i32 %i.agk, %invariant.op374
  %i.agl = zext i32 %.reass375 to i64
  ...
  %.reass377 = add i32 %i.agn, %invariant.op376
  %i.ago = zext i32 %.reass377 to i64
  ...
  %.reass379 = add i32 %i.agq, %invariant.op378
  %i.agr = zext i32 %.reass379 to i64
...
.preheader.us.us:                                 ; preds = %.preheader360.us, %._crit_edge460.us.us
  ...
  %i.agt = getelementptr inbounds nuw [128 x i8], ptr %i.b, i64 %indvars.iv596 ; 5 uses
  br i1 %i.afm, label %.epil.preheader332, label %.preheader.us.us.new
...
.preheader.us.us.new:                             ; preds = %.preheader.us.us, %.preheader.us.us.new
  ...
  %.0312458.us.us = phi float [ %i.ahz, %.preheader.us.us.new ], [ 0.000000e+00, %.preheader.us.us ]
  %niter339 = phi i64 [ %niter339.next.3, %.preheader.us.us.new ], [ 0, %.preheader.us.us ]
  %i.agu = trunc nuw nsw i64 %indvars.iv591 to i32
  %i.agv = add i32 %i.afp, %i.agu
  %i.agw = zext i32 %i.agv to i64
  %i.agx = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.agw
  %i.agy = load float, ptr %i.agx, align 4
  %i.agz = getelementptr inbounds nuw [4 x i8], ptr %i.agt, i64 %indvars.iv591
  %i.aha = load float, ptr %i.agz, align 16
  %i.ahb = tail call float @llvm.fmuladd.f32(float %i.agy, float %i.aha, float %.0312458.us.us)
  %indvars.iv.next592 = or disjoint i64 %indvars.iv591, 1 ; 2 uses
  %i.ahc = trunc nuw nsw i64 %indvars.iv.next592 to i32
  %i.ahd = add i32 %i.afp, %i.ahc
  %i.ahe = zext i32 %i.ahd to i64
  %i.ahf = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.ahe
  %i.ahg = load float, ptr %i.ahf, align 4
  %i.ahh = getelementptr inbounds nuw [4 x i8], ptr %i.agt, i64 %indvars.iv.next592
  %i.ahi = load float, ptr %i.ahh, align 4
  %i.ahj = tail call float @llvm.fmuladd.f32(float %i.ahg, float %i.ahi, float %i.ahb)
  %indvars.iv.next592.1 = or disjoint i64 %indvars.iv591, 2 ; 2 uses
  %i.ahk = trunc nuw nsw i64 %indvars.iv.next592.1 to i32
  %i.ahl = add i32 %i.afp, %i.ahk
  %i.ahm = zext i32 %i.ahl to i64
  %i.ahn = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.ahm
  %i.aho = load float, ptr %i.ahn, align 4
  %i.ahp = getelementptr inbounds nuw [4 x i8], ptr %i.agt, i64 %indvars.iv.next592.1
  %i.ahq = load float, ptr %i.ahp, align 8
  %i.ahr = tail call float @llvm.fmuladd.f32(float %i.aho, float %i.ahq, float %i.ahj)
  %indvars.iv.next592.2 = or disjoint i64 %indvars.iv591, 3 ; 2 uses
  %i.ahs = trunc nuw nsw i64 %indvars.iv.next592.2 to i32
  %i.aht = add i32 %i.afp, %i.ahs
  %i.ahu = zext i32 %i.aht to i64
  %i.ahv = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.ahu
  %i.ahw = load float, ptr %i.ahv, align 4
  %i.ahx = getelementptr inbounds nuw [4 x i8], ptr %i.agt, i64 %indvars.iv.next592.2
  %i.ahy = load float, ptr %i.ahx, align 4
  %i.ahz = tail call float @llvm.fmuladd.f32(float %i.ahw, float %i.ahy, float %i.ahr) ; 3 uses
...
.epil.preheader332:                               ; preds = %._crit_edge460.us.us.unr-lcssa, %.preheader.us.us
  ...
  %.0312458.us.us.epil.init = phi float [ 0.000000e+00, %.preheader.us.us ], [ %i.ahz, %._crit_edge460.us.us.unr-lcssa ]
...
bb.ae:                                            ; preds = %bb.ae, %.epil.preheader332
  ...
  %.0312458.us.us.epil = phi float [ %i.aih, %bb.ae ], [ %.0312458.us.us.epil.init, %.epil.preheader332 ]
  %epil.iter334 = phi i64 [ %epil.iter334.next, %bb.ae ], [ 0, %.epil.preheader332 ]
  %i.aia = trunc nuw nsw i64 %indvars.iv591.epil to i32
  %i.aib = add i32 %i.afp, %i.aia
  %i.aic = zext i32 %i.aib to i64
  %i.aid = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.aic
  %i.aie = load float, ptr %i.aid, align 4
  %i.aif = getelementptr inbounds nuw [4 x i8], ptr %i.agt, i64 %indvars.iv591.epil
  %i.aig = load float, ptr %i.aif, align 4
  %i.aih = tail call float @llvm.fmuladd.f32(float %i.aie, float %i.aig, float %.0312458.us.us.epil) ; 2 uses
...
._crit_edge460.us.us:                             ; preds = %bb.ae, %._crit_edge460.us.us.unr-lcssa
  %.lcssa = phi float [ %i.ahz, %._crit_edge460.us.us.unr-lcssa ], [ %i.aih, %bb.ae ]
  %i.aii = trunc nuw nsw i64 %indvars.iv596 to i32
  %i.aij = add i32 %i.afq, %i.aii
  %i.aik = zext i32 %i.aij to i64
  %i.ail = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.aik
  store float %.lcssa, ptr %i.ail, align 4
...
._crit_edge463.us:                                ; preds = %._crit_edge460.us.us, %.preheader.us466.prol.loopexit, %.preheader.us466, %middle.block146
  %i.aim = add i32 %.4464.us, 1                   ; 2 uses
  %i.ain = zext i32 %i.aim to i64
  %i.aio = icmp ugt i64 %6, %i.ain
  br i1 %i.aio, label %.preheader360.us, label %.loopexit

.preheader360:                                    ; preds = %.loopexit362.thread, %.preheader360
  %.4464 = phi i32 [ %i.aip, %.preheader360 ], [ 0, %.loopexit362.thread ]
  %i.aip = add i32 %.4464, 1                      ; 2 uses
  %i.aiq = zext i32 %i.aip to i64
  %i.air = icmp ugt i64 %6, %i.aiq
  br i1 %i.air, label %.preheader360, label %.loopexit

.preheader370:                                    ; preds = %.preheader370.lr.ph, %.preheader370
  %.5406 = phi i32 [ %i.ais, %.preheader370 ], [ 0, %.preheader370.lr.ph ]
  %i.ais = add i32 %.5406, 1                      ; 2 uses
  %i.ait = zext i32 %i.ais to i64
  %i.aiu = icmp ugt i64 %6, %i.ait
  br i1 %i.aiu, label %.preheader370, label %.loopexit
...
bb.af:                                            ; preds = %bb.q
  ...
  %i.aix = mul i64 %6, %i.aiw                     ; 2 uses
  %.not.i13.i = icmp eq i64 %i.aix, 0
  br i1 %.not.i13.i, label %ma_copy_pcm_frames.exit, label %.lr.ph.i354

.lr.ph.i354:                                      ; preds = %bb.af, %ma_zero_memory_default.exit.i.i
  %.0.i15.i = phi ptr [ %i.aiz, %ma_zero_memory_default.exit.i.i ], [ %0, %bb.af ] ; 3 uses
  %.08.i14.i = phi i64 [ %i.aiy, %ma_zero_memory_default.exit.i.i ], [ %i.aix, %bb.af ] ; 2 uses
...
ma_zero_memory_default.exit.i.i:                  ; preds = %bb.ag, %.lr.ph.i354
  %i.aiy = sub nuw i64 %.08.i14.i, %spec.store.select.i.i355 ; 2 uses
  %i.aiz = getelementptr inbounds nuw i8, ptr %.0.i15.i, i64 %spec.store.select.i.i355
  %.not.i.i357 = icmp eq i64 %i.aiy, 0
...
.peel.next139.i.split.us:                         ; preds = %ma_channel_map_get_channel.exit45.us.us.us.us85.peel.i
  store i8 0, ptr %i.bz, align 1
  br label %bb.o

bb.o:                                             ; preds = %bb.s, %.peel.next139.i.split.us
  %.03651.us.us.us.us76.i.us = phi i32 [ 2, %.peel.next139.i.split.us ], [ %i.ck, %bb.s ] ; 7 uses
  %i.ce = icmp ult i32 %.03651.us.us.us.us76.i.us, 8
  br i1 %i.ce, label %switch.lookup, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.cf = icmp ult i32 %.03651.us.us.us.us76.i.us, 32
  br i1 %i.cf, label %bb.q, label %ma_channel_map_get_channel.exit45.us.us.us.us85.i.us

bb.q:                                             ; preds = %bb.p
  %i.cg = trunc nuw nsw i32 %.03651.us.us.us.us76.i.us to i8
  %i.ch = add nuw nsw i8 %i.cg, 12
  br label %ma_channel_map_get_channel.exit45.us.us.us.us85.i.us

switch.lookup:                                    ; preds = %bb.o
  %switch.tableidx = add nsw i32 %.03651.us.us.us.us76.i.us, -1
...
ma_channel_map_get_channel.exit45.us.us.us.us85.i.us: ; preds = %switch.lookup, %bb.q, %bb.p
  %.0.i44.us.us.us.us86.i.us = phi i8 [ 0, %bb.p ], [ %switch.masked, %switch.lookup ], [ %i.ch, %bb.q ] ; 2 uses
  %i.ci = icmp eq i8 %.0.i.us.us.us.i, %.0.i44.us.us.us.us86.i.us
  br i1 %i.ci, label %.split.us.us.us.split.us88.loopexit.i, label %bb.r

bb.r:                                             ; preds = %ma_channel_map_get_channel.exit45.us.us.us.us85.i.us
  switch i8 %.0.i44.us.us.us.us86.i.us, label %bb.s [
    i8 2, label %.sink.split.i.us
    i8 11, label %.sink.split.i.us
  ]

.sink.split.i.us:                                 ; preds = %bb.r, %bb.r
  %i.cj = trunc i32 %.03651.us.us.us.us76.i.us to i8
  store i8 %i.cj, ptr %i.bz, align 1
  br label %bb.s

bb.s:                                             ; preds = %.sink.split.i.us, %bb.r
  %i.ck = add nuw i32 %.03651.us.us.us.us76.i.us, 1 ; 2 uses
  %exitcond136.not.i.us = icmp eq i32 %i.ck, %i.bp
  br i1 %exitcond136.not.i.us, label %..loopexit_crit_edge.split.us.us.us.split.us87.i, label %bb.o, !llvm.loop !714

.peel.next139.i.split.us429:                      ; preds = %ma_channel_map_get_channel.exit45.us.us.us.us85.peel.i
  store i8 1, ptr %i.bz, align 1
  br label %bb.t

bb.t:                                             ; preds = %bb.x, %.peel.next139.i.split.us429
  %.03651.us.us.us.us76.i.us430 = phi i32 [ 2, %.peel.next139.i.split.us429 ], [ %i.cr, %bb.x ] ; 7 uses
  %i.cl = icmp ult i32 %.03651.us.us.us.us76.i.us430, 8
  br i1 %i.cl, label %switch.lookup679, label %bb.u

bb.u:                                             ; preds = %bb.t
  %i.cm = icmp ult i32 %.03651.us.us.us.us76.i.us430, 32
  br i1 %i.cm, label %bb.v, label %ma_channel_map_get_channel.exit45.us.us.us.us85.i.us431

bb.v:                                             ; preds = %bb.u
  %i.cn = trunc nuw nsw i32 %.03651.us.us.us.us76.i.us430 to i8
  %i.co = add nuw nsw i8 %i.cn, 12
  br label %ma_channel_map_get_channel.exit45.us.us.us.us85.i.us431

switch.lookup679:                                 ; preds = %bb.t
  %switch.tableidx678 = add nsw i32 %.03651.us.us.us.us76.i.us430, -1
...
ma_channel_map_get_channel.exit45.us.us.us.us85.i.us431: ; preds = %switch.lookup679, %bb.v, %bb.u
  %.0.i44.us.us.us.us86.i.us432 = phi i8 [ 0, %bb.u ], [ %switch.masked683, %switch.lookup679 ], [ %i.co, %bb.v ] ; 2 uses
  %i.cp = icmp eq i8 %.0.i.us.us.us.i, %.0.i44.us.us.us.us86.i.us432
  br i1 %i.cp, label %.split.us.us.us.split.us88.loopexit.i, label %bb.w

bb.w:                                             ; preds = %ma_channel_map_get_channel.exit45.us.us.us.us85.i.us431
  switch i8 %.0.i44.us.us.us.us86.i.us432, label %bb.x [
    i8 3, label %.sink.split.i.us433
    i8 12, label %.sink.split.i.us433
  ]

.sink.split.i.us433:                              ; preds = %bb.w, %bb.w
  %i.cq = trunc i32 %.03651.us.us.us.us76.i.us430 to i8
  store i8 %i.cq, ptr %i.bz, align 1
  br label %bb.x

bb.x:                                             ; preds = %.sink.split.i.us433, %bb.w
  %i.cr = add nuw i32 %.03651.us.us.us.us76.i.us430, 1 ; 2 uses
  %exitcond136.not.i.us434 = icmp eq i32 %i.cr, %i.bp
  br i1 %exitcond136.not.i.us434, label %..loopexit_crit_edge.split.us.us.us.split.us87.i, label %bb.t, !llvm.loop !714

.peel.next139.i.split:                            ; preds = %ma_channel_map_get_channel.exit45.us.us.us.us85.peel.i, %bb.aa
  %.03651.us.us.us.us76.i = phi i32 [ %i.cx, %bb.aa ], [ 2, %ma_channel_map_get_channel.exit45.us.us.us.us85.peel.i ] ; 6 uses
  %i.cs = icmp ult i32 %.03651.us.us.us.us76.i, 8
  br i1 %i.cs, label %switch.lookup685, label %bb.y

bb.y:                                             ; preds = %.peel.next139.i.split
  %i.ct = icmp ult i32 %.03651.us.us.us.us76.i, 32
  br i1 %i.ct, label %bb.z, label %ma_channel_map_get_channel.exit45.us.us.us.us85.i

bb.z:                                             ; preds = %bb.y
  %i.cu = trunc nuw nsw i32 %.03651.us.us.us.us76.i to i8
  %i.cv = add nuw nsw i8 %i.cu, 12
  br label %ma_channel_map_get_channel.exit45.us.us.us.us85.i

switch.lookup685:                                 ; preds = %.peel.next139.i.split
  %switch.tableidx684 = add nsw i32 %.03651.us.us.us.us76.i, -1
...
ma_channel_map_get_channel.exit45.us.us.us.us85.i: ; preds = %switch.lookup685, %bb.z, %bb.y
  %.0.i44.us.us.us.us86.i = phi i8 [ 0, %bb.y ], [ %switch.masked689, %switch.lookup685 ], [ %i.cv, %bb.z ]
  %i.cw = icmp eq i8 %.0.i.us.us.us.i, %.0.i44.us.us.us.us86.i
  br i1 %i.cw, label %.split.us.us.us.split.us88.loopexit.i, label %bb.aa

bb.aa:                                            ; preds = %ma_channel_map_get_channel.exit45.us.us.us.us85.i
  %i.cx = add nuw i32 %.03651.us.us.us.us76.i, 1  ; 2 uses
  %exitcond136.not.i = icmp eq i32 %i.cx, %i.bp
  br i1 %exitcond136.not.i, label %..loopexit_crit_edge.split.us.us.us.split.us87.i, label %.peel.next139.i.split, !llvm.loop !714

.split.us.us.us.split.us88.loopexit.i:            ; preds = %ma_channel_map_get_channel.exit45.us.us.us.us85.i.us431, %ma_channel_map_get_channel.exit45.us.us.us.us85.i.us, %ma_channel_map_get_channel.exit45.us.us.us.us85.i
  %.us-phi = phi i32 [ %.03651.us.us.us.us76.i.us, %ma_channel_map_get_channel.exit45.us.us.us.us85.i.us ], [ %.03651.us.us.us.us76.i, %ma_channel_map_get_channel.exit45.us.us.us.us85.i ], [ %.03651.us.us.us.us76.i.us430, %ma_channel_map_get_channel.exit45.us.us.us.us85.i.us431 ]
  %i.cy = trunc i32 %.us-phi to i8
  br label %.split.us.us.us.split.us88.i

.split.us.us.us.split.us88.fold.split.i:          ; preds = %ma_channel_map_get_channel.exit45.us.us.us.us85.peel.i
  br label %.split.us.us.us.split.us88.i

.split.us.us.us.split.us88.i:                     ; preds = %ma_channel_map_get_channel.exit45.us.us.us.us85.peel.i, %.split.us.us.us.split.us88.fold.split.i, %.split.us.us.us.split.us88.loopexit.i
  %.03651.us.us.us.us76.lcssa.i = phi i8 [ %i.cy, %.split.us.us.us.split.us88.loopexit.i ], [ 0, %ma_channel_map_get_channel.exit45.us.us.us.us85.peel.i ], [ 1, %.split.us.us.us.split.us88.fold.split.i ]
  store i8 %.03651.us.us.us.us76.lcssa.i, ptr %i.bz, align 1
  br label %..loopexit_crit_edge.split.us.us.us.split.us87.i

..loopexit_crit_edge.split.us.us.us.split.us87.i: ; preds = %bb.x, %bb.s, %bb.aa, %.split.us.us.us.split.us88.i
...
bb.an:                                            ; preds = %.sink.split183.i, %bb.am, %bb.al, %bb.ak
  %i.dq = add nuw nsw i32 %.03651.us.us.us.us.i, 1 ; 2 uses
...
.preheader.split.us.split.i:                      ; preds = %..loopexit_crit_edge.split.us68.i, %.preheader.split.us.split.preheader.i
  %indvars.iv112.i = phi i64 [ 0, %.preheader.split.us.split.preheader.i ], [ %indvars.iv.next113.i, %..loopexit_crit_edge.split.us68.i ] ; 4 uses
...
ma_channel_map_get_channel.exit.us.i:             ; preds = %bb.ap, %bb.ao
  ...
  switch i8 %.0.i.fr.us.i, label %ma_channel_map_get_channel.exit45.us64.i [
...
ma_channel_map_get_channel.exit45.us57.us.i:      ; preds = %ma_channel_map_get_channel.exit45.us57.us.i.preheader, %bb.as
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %bb.as ], [ 0, %ma_channel_map_get_channel.exit45.us57.us.i.preheader ] ; 4 uses
  %i.dx = getelementptr inbounds nuw i8, ptr %i.bo, i64 %indvars.iv.i
  %i.dy = load i8, ptr %i.dx, align 1             ; 2 uses
  %i.dz = icmp eq i8 %.0.i.fr.us.i, %i.dy
  br i1 %i.dz, label %.split.us72.i, label %bb.aq

bb.aq:                                            ; preds = %ma_channel_map_get_channel.exit45.us57.us.i
  switch i8 %i.dy, label %bb.as [
    i8 3, label %bb.ar
    i8 12, label %bb.ar
  ]

bb.ar:                                            ; preds = %bb.aq, %bb.aq
  %i.ea = trunc i64 %indvars.iv.i to i8
...
bb.as:                                            ; preds = %bb.ar, %bb.aq
  ...
  br i1 %exitcond.not.i, label %..loopexit_crit_edge.split.us68.i, label %ma_channel_map_get_channel.exit45.us57.us.i

ma_channel_map_get_channel.exit45.us52.us.i:      ; preds = %ma_channel_map_get_channel.exit45.us52.us.i.preheader, %bb.av
  %indvars.iv102.i = phi i64 [ %indvars.iv.next103.i, %bb.av ], [ 0, %ma_channel_map_get_channel.exit45.us52.us.i.preheader ] ; 4 uses
  ...
  br i1 %i.ed, label %.split.us72.i, label %bb.at

bb.at:                                            ; preds = %ma_channel_map_get_channel.exit45.us52.us.i
  switch i8 %i.ec, label %bb.av [
    i8 2, label %bb.au
    i8 11, label %bb.au
  ]
...
bb.av:                                            ; preds = %bb.au, %bb.at
  ...
  br i1 %exitcond106.not.i, label %..loopexit_crit_edge.split.us68.i, label %ma_channel_map_get_channel.exit45.us52.us.i

ma_channel_map_get_channel.exit45.us64.i:         ; preds = %ma_channel_map_get_channel.exit.us.i, %bb.aw
  %indvars.iv107.i = phi i64 [ %indvars.iv.next108.i, %bb.aw ], [ 0, %ma_channel_map_get_channel.exit.us.i ] ; 3 uses
  %i.ef = getelementptr inbounds nuw i8, ptr %i.bo, i64 %indvars.iv107.i
  %i.eg = load i8, ptr %i.ef, align 1
  %i.eh = icmp eq i8 %.0.i.fr.us.i, %i.eg
  br i1 %i.eh, label %.split.us72.i, label %bb.aw

bb.aw:                                            ; preds = %ma_channel_map_get_channel.exit45.us64.i
  ...
  br i1 %exitcond111.not.i, label %..loopexit_crit_edge.split.us68.i, label %ma_channel_map_get_channel.exit45.us64.i

.split.us72.i:                                    ; preds = %ma_channel_map_get_channel.exit45.us57.us.i, %ma_channel_map_get_channel.exit45.us52.us.i, %ma_channel_map_get_channel.exit45.us64.i
  %.us-phi55.us.in.i = phi i64 [ %indvars.iv102.i, %ma_channel_map_get_channel.exit45.us52.us.i ], [ %indvars.iv107.i, %ma_channel_map_get_channel.exit45.us64.i ], [ %indvars.iv.i, %ma_channel_map_get_channel.exit45.us57.us.i ]
  %i.ei = trunc i64 %.us-phi55.us.in.i to i8
  store i8 %i.ei, ptr %i.ds, align 1
  br label %..loopexit_crit_edge.split.us68.i

..loopexit_crit_edge.split.us68.i:                ; preds = %bb.as, %bb.av, %bb.aw, %.split.us72.i
...
ma_channel_map_build_shuffle_table.exitthread-pre-split: ; preds = %..loopexit_crit_edge.split.us68.i, %..loopexit_crit_edge.split.us.us.us.split.us.i, %..loopexit_crit_edge.split.us.us.us.split.us87.i, %bb.l
...
.lr.ph:                                           ; preds = %bb.i, %.lr.ph
  ...
  %i.af = add nuw nsw i64 %.042, 1                ; 3 uses
...
bb.y:                                             ; preds = %bb.x, %.lr.ph.i.i.us.i
  ...
  %i.ib = add nuw nsw i64 %.014.i.i.us.i, 1       ; 2 uses
...
bb.ac:                                            ; preds = %bb.ab, %.lr.ph.i10.i.us.i
  ...
  %i.iy = add nuw nsw i64 %.014.i11.i.us.i, 1     ; 2 uses
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.i.i.preheader.new
  ...
  %i.lt = add nuw nsw i64 %.06.i.i, 4             ; 2 uses
...
.lr.ph.i.i.epil:                                  ; preds = %.lr.ph.i.i.epil, %.lr.ph.i.i.epil.preheader
  ...
  %i.ma = add nuw nsw i64 %.06.i.i.epil, 1
...
.lr.ph.i.i67:                                     ; preds = %.lr.ph.i.i67, %.lr.ph.i.i67.preheader.new
  ...
  %i.ok = add nuw nsw i64 %.06.i.i68, 4           ; 2 uses
...
.lr.ph.i.i67.epil:                                ; preds = %.lr.ph.i.i67.epil, %.lr.ph.i.i67.epil.preheader
  ...
  %i.or = add nuw nsw i64 %.06.i.i68.epil, 1
...
.lr.ph.i.i35:                                     ; preds = %.lr.ph.i.i35.preheader250, %.lr.ph.i.i35
  ...
  %i.hw = add nuw nsw i64 %.012.i.i, 1            ; 2 uses
...
.lr.ph.i.i.us.i:                                  ; preds = %.lr.ph.i.i.us.i.preheader254, %.lr.ph.i.i.us.i
  ...
  %i.kx = add nuw nsw i64 %.012.i.i.us.i, 1       ; 2 uses
...
.lr.ph.i.i53:                                     ; preds = %.lr.ph.i.i53, %.lr.ph.i.i53.preheader.new
  ...
  %i.oa = add nuw nsw i64 %.012.i.i54, 4          ; 2 uses
...
.lr.ph.i.i53.epil:                                ; preds = %.lr.ph.i.i53.epil, %.lr.ph.i.i53.epil.preheader
  ...
  %i.oj = add nuw nsw i64 %.012.i.i54.epil, 1
...
.lr.ph.i.i73:                                     ; preds = %.lr.ph.i.i73, %.lr.ph.i.i73.preheader.new
  ...
  %i.rb = add nuw nsw i64 %.012.i.i74, 4          ; 2 uses
  %niter.next.3 = add i64 %niter, 4               ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
...
.lr.ph.i.i73.epil:                                ; preds = %.lr.ph.i.i73.epil, %.lr.ph.i.i73.epil.preheader
  ...
  %i.rk = add nuw nsw i64 %.012.i.i74.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
...
.lr.ph.i.i.us.i:                                  ; preds = %.lr.ph.i.i.us.i.preheader252, %.lr.ph.i.i.us.i
  ...
  %i.ju = add nuw nsw i64 %.012.i.i.us.i, 1       ; 2 uses
...
.lr.ph.i9.i.us.i:                                 ; preds = %.lr.ph.i9.i.us.i.preheader255, %.lr.ph.i9.i.us.i
  ...
  %i.kv = add nuw nsw i64 %.012.i10.i.us.i, 1     ; 2 uses
...
.lr.ph.i.i53:                                     ; preds = %.lr.ph.i.i53, %.lr.ph.i.i53.preheader.new
  ...
  %i.ny = add nuw nsw i64 %.012.i.i54, 4          ; 2 uses
...
.lr.ph.i.i53.epil:                                ; preds = %.lr.ph.i.i53.epil, %.lr.ph.i.i53.epil.preheader
  ...
  %i.oh = add nuw nsw i64 %.012.i.i54.epil, 1
...
.lr.ph.i.i73:                                     ; preds = %.lr.ph.i.i73, %.lr.ph.i.i73.preheader.new
  ...
  %i.qz = add nuw nsw i64 %.012.i.i74, 4          ; 2 uses
  %niter.next.3 = add i64 %niter, 4               ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %.loopexit.i77.loopexit.unr-lcssa, label %.lr.ph.i.i73
...
.lr.ph.i.i73.epil:                                ; preds = %.lr.ph.i.i73.epil, %.lr.ph.i.i73.epil.preheader
  ...
  %i.ri = add nuw nsw i64 %.012.i.i74.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader40, %.lr.ph.i
  ...
  %i.ag = add nuw nsw i64 %.08.i, 1               ; 2 uses
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader145, %.lr.ph.i.i
  ...
  %i.cp = add nuw nsw i64 %.08.i.i, 1             ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph, %memcompare.exit.thread
  ...
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %memcompare.exit.thread ] ; 2 uses
  %3 = phi i32 [ %i.fm, %.lr.ph ], [ %i.gh, %memcompare.exit.thread ]
  %4 = getelementptr inbounds nuw [12 x i8], ptr @modlist, i64 %indvars.iv ; 4 uses
  %i.ft = load i8, ptr %4, align 4
...
memcompare.exit.thread:                           ; preds = %bb.c, %bb.d, %bb.b, %bb.e, %memcompare.exit
  ...
  %i.gf = getelementptr inbounds nuw [12 x i8], ptr @modlist, i64 %indvars.iv.next
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader130, %.lr.ph.i.i
  ...
  %i.fu = add nuw nsw i64 %.08.i.i, 1             ; 2 uses
