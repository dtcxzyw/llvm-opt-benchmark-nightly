...
bb.af:                                            ; preds = %bb.ae
  %i.hv = getelementptr inbounds nuw i8, ptr %.1308, i64 416 ; 2 uses
...
bb.ag:                                            ; preds = %bb.ad
  %i.ib = add i64 %.0291.in.lcssa, 15             ; 3 uses
...
bb.aj:                                            ; preds = %bb.ai, %bb.af, %bb.ae, %._crit_edge
  %.2293 = phi i64 [ %.0291.in.lcssa, %._crit_edge ], [ %.0291.in.lcssa, %bb.af ], [ %.0291.in.lcssa, %bb.ae ], [ %i.im, %bb.ai ]
  %i.in = add i64 %.2293, 15                      ; 3 uses
...
stbir__edge_wrap.exit.i:                          ; preds = %call.2.i.i, %call.1.i.i, %.lr.ph253.i, %.lr.ph253.i
  ...
  %i.nf = add i32 %.2188250.i, 1                  ; 2 uses
...
bb.ax:                                            ; preds = %stbir__edge_wrap.exit232.i, %.lr.ph259.i
  ...
  %.3189256.i = phi i32 [ %i.lr, %.lr.ph259.i ], [ %i.np, %stbir__edge_wrap.exit232.i ] ; 14 uses
  %9 = icmp sgt i32 %.3189256.i, -1
  %10 = icmp slt i32 %.3189256.i, %i.lr           ; 2 uses
...
call.0.i228.i:                                    ; preds = %11
  ...
  %spec.select.i.i229.i = tail call i32 @llvm.smin.i32(i32 %.3189256.i, i32 %i.mn)
...
stbir__edge_wrap.exit232.i:                       ; preds = %call.2.i221.i, %bb.az, %12, %bb.ay, %call.0.i228.i, %bb.ax
  %.0.i220.i = phi i32 [ %.3189256.i, %bb.ax ], [ %.0.i.i230.i, %call.0.i228.i ], [ %.3189256.i, %12 ], [ %.010.i.i224.i, %call.2.i221.i ], [ %spec.select234.i, %bb.ay ], [ %.0.i10.i227.i, %bb.az ] ; 2 uses
...
.preheader291.i:                                  ; preds = %bb.bs, %.preheader291.i
  %.0259.i = phi ptr [ %i.pl, %.preheader291.i ], [ %i.pa, %bb.bs ] ; 2 uses
  %.0257.i = phi ptr [ %i.pk, %.preheader291.i ], [ %i.pa, %bb.bs ] ; 3 uses
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(ptr %.0257.i) #52, !srcloc !516
  %i.pj = load i32, ptr %.0259.i, align 4
  store i32 %i.pj, ptr %.0257.i, align 4
  %i.pk = getelementptr inbounds nuw i8, ptr %.0257.i, i64 4 ; 2 uses
  %i.pl = getelementptr inbounds [4 x i8], ptr %.0259.i, i64 %i.ph
  %i.pm = icmp ult ptr %i.pk, %i.pg
  br i1 %i.pm, label %.preheader291.i, label %.loopexit.i, !llvm.loop !517

.preheader293.i:                                  ; preds = %bb.bs, %.preheader293.i
  %.1260.i = phi ptr [ %i.pp, %.preheader293.i ], [ %i.pa, %bb.bs ] ; 2 uses
  %.1258.i = phi ptr [ %i.po, %.preheader293.i ], [ %i.pa, %bb.bs ] ; 3 uses
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(ptr %.1258.i) #52, !srcloc !518
  %i.pn = load i64, ptr %.1260.i, align 8
  store i64 %i.pn, ptr %.1258.i, align 8
  %i.po = getelementptr inbounds nuw i8, ptr %.1258.i, i64 8 ; 2 uses
  %i.pp = getelementptr inbounds [4 x i8], ptr %.1260.i, i64 %i.ph
  %i.pq = icmp ult ptr %i.po, %i.pg
  br i1 %i.pq, label %.preheader293.i, label %.loopexit.i, !llvm.loop !519
...
.lr.ph.preheader.i:                               ; preds = %bb.ag
  %i.hz = sub nsw i32 %i.hl, %.0139181            ; 2 uses
...
scalar.ph555.prol.loopexit:                       ; preds = %scalar.ph555.prol, %scalar.ph555.preheader
  %.0185323.unr = phi ptr [ %.0185323.ph, %scalar.ph555.preheader ], [ %i.cq, %scalar.ph555.prol ]
  %.0186322.unr = phi ptr [ %.0186322.ph, %scalar.ph555.preheader ], [ %i.cr, %scalar.ph555.prol ]
  %.1207321.unr = phi i32 [ %.1207321.ph, %scalar.ph555.preheader ], [ %i.cs, %scalar.ph555.prol ]
...
scalar.ph555:                                     ; preds = %scalar.ph555.prol.loopexit, %scalar.ph555
  %.0185323 = phi ptr [ %i.di, %scalar.ph555 ], [ %.0185323.unr, %scalar.ph555.prol.loopexit ] ; 5 uses
  %.0186322 = phi ptr [ %i.dj, %scalar.ph555 ], [ %.0186322.unr, %scalar.ph555.prol.loopexit ] ; 5 uses
  %.1207321 = phi i32 [ %i.dk, %scalar.ph555 ], [ %.1207321.unr, %scalar.ph555.prol.loopexit ]
  %i.cu = load i32, ptr %.0186322, align 4
  %i.cv = add nsw i32 %i.cu, %i.f
  store i32 %i.cv, ptr %.0185323, align 4
  %i.cw = getelementptr inbounds nuw i8, ptr %.0186322, i64 4
  %i.cx = load i32, ptr %i.cw, align 4
  %i.cy = add nsw i32 %i.cx, %i.f
  %i.cz = getelementptr inbounds nuw i8, ptr %.0185323, i64 4
  store i32 %i.cy, ptr %i.cz, align 4
  %i.da = getelementptr inbounds nuw i8, ptr %.0185323, i64 8
  %i.db = getelementptr inbounds nuw i8, ptr %.0186322, i64 8
  %i.dc = load i32, ptr %i.db, align 4
  %i.dd = add nsw i32 %i.dc, %i.f
  store i32 %i.dd, ptr %i.da, align 4
  %i.de = getelementptr inbounds nuw i8, ptr %.0186322, i64 12
  %i.df = load i32, ptr %i.de, align 4
  %i.dg = add nsw i32 %i.df, %i.f
  %i.dh = getelementptr inbounds nuw i8, ptr %.0185323, i64 12
  store i32 %i.dg, ptr %i.dh, align 4
  %i.di = getelementptr inbounds nuw i8, ptr %.0185323, i64 16
  %i.dj = getelementptr inbounds nuw i8, ptr %.0186322, i64 16
  %i.dk = add nsw i32 %.1207321, 2                ; 2 uses
  %exitcond372.not.1 = icmp eq i32 %i.dk, %3
  br i1 %exitcond372.not.1, label %.loopexit624, label %scalar.ph555, !llvm.loop !593
...
bb.f:                                             ; preds = %bb.f, %bb.e
  ...
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(ptr %.025.i) #52, !srcloc !594
  ...
  br i1 %i.dy, label %bb.f, label %bb.g, !llvm.loop !595
...
bb.h:                                             ; preds = %.preheader630, %bb.h
  ...
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(ptr %.2.i) #52, !srcloc !596
...
bb.i:                                             ; preds = %.lr.ph354, %.loopexit
  %.1191353 = phi ptr [ %4, %.lr.ph354 ], [ %i.ny, %.loopexit ] ; 19 uses
  %.1193350 = phi ptr [ %5, %.lr.ph354 ], [ %i.nz, %.loopexit ] ; 50 uses
  %.0194349 = phi i32 [ -1, %.lr.ph354 ], [ %.2196, %.loopexit ] ; 4 uses
  %.0197348 = phi i32 [ -2147483647, %.lr.ph354 ], [ %.3200, %.loopexit ] ; 4 uses
  %.0201347 = phi i32 [ 2147483647, %.lr.ph354 ], [ %.3204, %.loopexit ] ; 4 uses
  %.2208346 = phi i32 [ 0, %.lr.ph354 ], [ %i.oa, %.loopexit ]
  br i1 %i.ee, label %bb.j, label %bb.n

bb.j:                                             ; preds = %bb.i
  %i.ej = getelementptr inbounds nuw i8, ptr %.1191353, i64 4 ; 2 uses
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %i.em = load i32, ptr %.1191353, align 4        ; 2 uses
...
vector.body575:                                   ; preds = %vector.body575, %vector.ph573
  ...
  %i.es = getelementptr inbounds nuw [4 x i8], ptr %.1193350, i64 %i.er ; 2 uses
  %i.et = getelementptr inbounds nuw i8, ptr %i.es, i64 16
  %wide.load577 = load <4 x float>, ptr %i.es, align 4
  %wide.load578 = load <4 x float>, ptr %i.et, align 4
  %i.eu = getelementptr inbounds nuw [4 x i8], ptr %.1193350, i64 %index576 ; 2 uses
  ...
  br i1 %i.ew, label %middle.block580, label %vector.body575, !llvm.loop !597
...
.preheader:                                       ; preds = %.preheader.preheader625, %.preheader
  ...
  %i.ey = getelementptr inbounds nuw [4 x i8], ptr %.1193350, i64 %i.ex
  ...
  br i1 %exitcond384.not, label %stbir__insert_coeff.exit274, label %.preheader, !llvm.loop !598
...
.lr.ph.preheader.i:                               ; preds = %bb.x
  ...
  %invariant.gep.i = getelementptr [4 x i8], ptr %.1193350, i64 %i.fu ; 6 uses
...
vector.body616:                                   ; preds = %vector.body616, %vector.ph614
  ...
  %i.gd = getelementptr inbounds nuw [4 x i8], ptr %.1193350, i64 %i.gc ; 2 uses
  ...
  br i1 %i.gj, label %middle.block621, label %vector.body616, !llvm.loop !599
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader, %.lr.ph.i.prol
  ...
  %i.gl = getelementptr inbounds nuw [4 x i8], ptr %.1193350, i64 %indvars.iv.i.prol
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.gt = getelementptr inbounds nuw [4 x i8], ptr %.1193350, i64 %indvars.iv.i
  ...
  %i.gv = getelementptr inbounds nuw [4 x i8], ptr %.1193350, i64 %indvars.iv.next.i
  ...
  %i.gx = getelementptr inbounds nuw [4 x i8], ptr %.1193350, i64 %indvars.iv.next.i.1
  ...
  %i.gz = getelementptr inbounds nuw [4 x i8], ptr %.1193350, i64 %indvars.iv.next.i.2
...
bb.y:                                             ; preds = %bb.w
  ...
  %i.hd = getelementptr inbounds nuw [4 x i8], ptr %.1193350, i64 %i.hc ; 2 uses
...
bb.aa:                                            ; preds = %bb.z
  ...
  %.064.i = add nsw i32 %i.hh, 1                  ; 2 uses
  %i.hi = icmp slt i32 %.064.i, %i.hg
  br i1 %i.hi, label %.lr.ph67.preheader.i, label %._crit_edge68.i

.lr.ph67.preheader.i:                             ; preds = %bb.aa
  %i.hj = sext i32 %.064.i to i64
  %i.hk = shl nsw i64 %i.hj, 2
  %scevgep73.i = getelementptr i8, ptr %.1193350, i64 %i.hk
  %i.hl = add i32 %9, -2
...
._crit_edge68.i:                                  ; preds = %.lr.ph67.preheader.i, %bb.aa
  ...
  %i.hr = getelementptr inbounds [4 x i8], ptr %.1193350, i64 %i.hq
...
bb.ab:                                            ; preds = %.loopexit291
  ...
  %i.hv = getelementptr inbounds nuw [4 x i8], ptr %.1193350, i64 %i.hu ; 2 uses
...
.tail276:                                         ; preds = %.lr.ph328, %stbir__insert_coeff.exit255
  ...
  %.1325 = phi i32 [ -1, %.lr.ph328 ], [ %i.kg, %stbir__insert_coeff.exit255 ] ; 3 uses
  %i.hx = icmp sgt i32 %.1325, %i.ei
  %i.hy = sub nsw i32 0, %.1325
...
bb.ac:                                            ; preds = %.tail276
  ...
  store i32 %i.hz, ptr %.1191353, align 4
  store float %i.ib, ptr %.1193350, align 4
...
.lr.ph.preheader.i243:                            ; preds = %bb.af
  ...
  %invariant.gep.i244 = getelementptr [4 x i8], ptr %.1193350, i64 %i.ij ; 6 uses
...
vector.body602:                                   ; preds = %vector.body602, %vector.ph600
  ...
  %i.is = getelementptr inbounds nuw [4 x i8], ptr %.1193350, i64 %i.ir ; 2 uses
  ...
  br i1 %i.iy, label %middle.block607, label %vector.body602, !llvm.loop !602
...
.lr.ph.i245.prol:                                 ; preds = %.lr.ph.i245.preheader, %.lr.ph.i245.prol
  ...
  %i.ja = getelementptr inbounds nuw [4 x i8], ptr %.1193350, i64 %indvars.iv.i246.prol
  %i.jb = load float, ptr %i.ja, align 4
  ...
  br i1 %prol.iter642.cmp.not.a, label %.lr.ph.i245.prol.loopexit, label %.lr.ph.i245.prol, !llvm.loop !603
...
.lr.ph.i245:                                      ; preds = %.lr.ph.i245.prol.loopexit, %.lr.ph.i245
  ...
  %i.ji = getelementptr inbounds nuw [4 x i8], ptr %.1193350, i64 %indvars.iv.i246
  ...
  %i.jk = getelementptr inbounds nuw [4 x i8], ptr %.1193350, i64 %indvars.iv.next.i248
  ...
  %i.jm = getelementptr inbounds nuw [4 x i8], ptr %.1193350, i64 %indvars.iv.next.i248.1
  ...
  %i.jo = getelementptr inbounds nuw [4 x i8], ptr %.1193350, i64 %indvars.iv.next.i248.2
...
bb.ag:                                            ; preds = %bb.ae
  ...
  %i.js = getelementptr inbounds nuw [4 x i8], ptr %.1193350, i64 %i.jr ; 2 uses
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %.064.i251 = add nsw i32 %i.jw, 1               ; 2 uses
  %i.jx = icmp slt i32 %.064.i251, %i.jv
  br i1 %i.jx, label %.lr.ph67.preheader.i253, label %._crit_edge68.i252

.lr.ph67.preheader.i253:                          ; preds = %bb.ai
  %i.jy = sext i32 %.064.i251 to i64
  %i.jz = shl nsw i64 %i.jy, 2
  %scevgep73.i254 = getelementptr i8, ptr %.1193350, i64 %i.jz
