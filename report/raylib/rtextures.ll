...
bb.ba:                                            ; preds = %bb.ay, %bb.ax
  ...
  %i.gi = load ptr, ptr %i.gh, align 8            ; 8 uses
...
bb.be:                                            ; preds = %bb.bc
  ...
  %i.gt = tail call noalias noundef ptr @malloc(i64 noundef range(i64 -8589934588, 8589934589) %i.gs) #53 ; 5 uses
...
vector.memcheck50:                                ; preds = %.lr.ph240.i.i.i.preheader
  %bound057 = icmp ult ptr %i.ir, %scevgep56
  %bound158 = icmp ult ptr %i.io, %scevgep53
...
stbi__malloc_mad3.exit.i:                         ; preds = %stbi__mul2sizes_valid.exit12.i.i.i, %stbi__mul2sizes_valid.exit.thread15.i.i.i
  ...
  %i.aeu = tail call noalias noundef ptr @malloc(i64 noundef range(i64 -8589934588, 8589934589) %i.aet) #53 ; 30 uses
...
.lr.ph92.preheader.i:                             ; preds = %.lr.ph95.i
  ...
  %scevgep20 = getelementptr i8, ptr %i.aeu, i64 %wide.trip.count107.i
...
iter.check:                                       ; preds = %._crit_edge93.i, %.lr.ph92.preheader.i
  ...
  %i.bdq = getelementptr inbounds nuw i8, ptr %i.aeu, i64 %i.bdp ; 6 uses
  %i.bdr = xor i32 %i.bdo, -1
  %i.bds = add i32 %i.bcf, %i.bdr
  %i.bdt = mul i32 %i.bds, %factor.op.mul.i
  %i.bdu = zext i32 %i.bdt to i64
  %i.bdv = getelementptr inbounds nuw i8, ptr %i.aeu, i64 %i.bdu ; 6 uses
...
vector.memcheck:                                  ; preds = %iter.check
  ...
  %scevgep21 = getelementptr i8, ptr %scevgep20, i64 %i.bea
  %i.beb = trunc i64 %indvars.iv109.i to i32
  %i.bec = mul i32 %factor.op.mul.i, %i.beb
  %i.bed = zext i32 %i.bec to i64
  %scevgep = getelementptr i8, ptr %scevgep19.a, i64 %i.bed
  %bound0 = icmp ult ptr %i.bdq, %scevgep21
  %bound1 = icmp ult ptr %i.bdv, %scevgep
...
bb.b:                                             ; preds = %bb.a
  ...
  br label %stbi__get8.exit.i
end_hunk_2
begin_hunk_3_@stbi__parse_png_file:bb.a
  br label %.thread400
...
.preheader.i:                                     ; preds = %._crit_edge.i, %.preheader.lr.ph.split.i
  ...
  %i.vf = trunc i64 %indvars.iv109.i to i32
  %i.vg = mul i32 %i.ui, %i.vf
  %i.vh = add i32 %i.vg, %i.ug
  %.reass.i = mul i32 %factor.op.mul.i, %i.vh
  %i.vi = mul nuw nsw i64 %indvars.iv109.i, %i.vd ; 3 uses
  %i.vj = zext i32 %.reass.i to i64
  %i.vk = getelementptr inbounds nuw i8, ptr %i.tr, i64 %i.vj ; 3 uses
...
.preheader.i.new:                                 ; preds = %.preheader.i, %.preheader.i.new
  ...
  %i.vl = mul nsw i64 %indvars.iv.i352, %i.vb
  %i.vm = add nsw i64 %i.vl, %i.vc
  %i.vn = mul nsw i64 %i.vm, %i.ts
  %i.vo = getelementptr inbounds i8, ptr %i.vk, i64 %i.vn
  %i.vp = add nuw nsw i64 %indvars.iv.i352, %i.vi
  %i.vq = mul nsw i64 %i.vp, %i.ts
  %i.vr = getelementptr inbounds i8, ptr %.pre115.i, i64 %i.vq
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.vo, ptr align 1 %i.vr, i64 %i.ts, i1 false)
  %indvars.iv.next.i353 = or disjoint i64 %indvars.iv.i352, 1 ; 2 uses
  %i.vs = mul nsw i64 %indvars.iv.next.i353, %i.vb
  %i.vt = add nsw i64 %i.vs, %i.vc
  %i.vu = mul nsw i64 %i.vt, %i.ts
  %i.vv = getelementptr inbounds i8, ptr %i.vk, i64 %i.vu
  %i.vw = add nuw nsw i64 %indvars.iv.next.i353, %i.vi
  %i.vx = mul nsw i64 %i.vw, %i.ts
  %i.vy = getelementptr inbounds i8, ptr %.pre115.i, i64 %i.vx
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.vv, ptr align 1 %i.vy, i64 %i.ts, i1 false)
...
.epil.preheader:                                  ; preds = %._crit_edge.i.unr-lcssa, %.preheader.i
  ...
  %i.vz = mul nsw i64 %indvars.iv.i352.epil.init, %i.vb
  %i.wa = add nsw i64 %i.vz, %i.vc
  %i.wb = mul nsw i64 %i.wa, %i.ts
  %i.wc = getelementptr inbounds i8, ptr %i.vk, i64 %i.wb
  %i.wd = add nuw nsw i64 %indvars.iv.i352.epil.init, %i.vi
  %i.we = mul nsw i64 %i.wd, %i.ts
  %i.wf = getelementptr inbounds i8, ptr %.pre115.i, i64 %i.we
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.wc, ptr align 1 %i.wf, i64 %i.ts, i1 false)
  br label %._crit_edge.i

._crit_edge.i:                                    ; preds = %._crit_edge.i.unr-lcssa, %.epil.preheader
  %indvars.iv.next110.i = add nuw nsw i64 %indvars.iv109.i, 1 ; 2 uses
  %i.wg = icmp samesign ult i64 %indvars.iv.next110.i, %i.ve
  br i1 %i.wg, label %.preheader.i, label %._crit_edge103.split.i

._crit_edge103.split.i:                           ; preds = %._crit_edge.i, %.preheader99.i
  call void @free(ptr noundef %.pre115.i) #52
  %i.wh = zext i32 %i.uw to i64
  %i.wi = getelementptr inbounds nuw i8, ptr %.076106.i, i64 %i.wh
  %i.wj = sub i32 %.085104.i, %i.uw
  br label %bb.fn

bb.fn:                                            ; preds = %._crit_edge103.split.i, %bb.fl
  %.388.i = phi i32 [ %.085104.i, %bb.fl ], [ %i.wj, %._crit_edge103.split.i ]
  %.379.i = phi ptr [ %.076106.i, %bb.fl ], [ %i.wi, %._crit_edge103.split.i ]
...
stbi__create_png_image.exit:                      ; preds = %bb.fh
  %i.wk = call fastcc i32 @stbi__create_png_image_raw(ptr noundef nonnull %0, ptr noundef readonly %i.sz, i32 noundef %i.sp, i32 noundef %spec.select1503, i32 noundef %i.tf, i32 noundef %i.th, i32 noundef %i.ta, i32 noundef range(i32 0, 256) %.0210)
  %.not269 = icmp eq i32 %i.wk, 0
...
bb.fp:                                            ; preds = %bb.fo
  %i.wl = load i32, ptr %i.gm, align 8
  %i.wm = icmp eq i32 %i.wl, 16
  %i.wn = load i32, ptr %i.sy, align 4            ; 2 uses
  %.val = load ptr, ptr %0, align 8               ; 2 uses
  %.val300 = load ptr, ptr %i.g, align 8          ; 2 uses
  %.val.val = load i32, ptr %.val, align 8        ; 2 uses
  %i.wo = getelementptr i8, ptr %.val, i64 4
  %.val.val301 = load i32, ptr %i.wo, align 4     ; 2 uses
  br i1 %i.wm, label %bb.fq, label %bb.fr

bb.fq:                                            ; preds = %bb.fp
  call fastcc void @stbi__compute_transparency16(i32 %.val.val, i32 %.val.val301, ptr %.val300, ptr noundef %i.c, i32 noundef %i.wn)
  br label %bb.fs

bb.fr:                                            ; preds = %bb.fp
  call fastcc void @stbi__compute_transparency(i32 %.val.val, i32 %.val.val301, ptr %.val300, ptr noundef %i.b, i32 noundef %i.wn)
  br label %bb.fs

bb.fs:                                            ; preds = %bb.fr, %bb.fq, %bb.fo
  %i.wp = load i32, ptr @stbi__de_iphone_flag_global, align 4
  %i.wq = icmp ne i32 %i.wp, 0
  %or.cond12 = select i1 %i.rw, i1 %i.wq, i1 false
  br i1 %or.cond12, label %bb.ft, label %bb.fv

bb.ft:                                            ; preds = %bb.fs
  %i.wr = load i32, ptr %i.sy, align 4
  %i.ws = icmp sgt i32 %i.wr, 2
  br i1 %i.ws, label %bb.fu, label %bb.fv
...
bb.fw:                                            ; preds = %bb.fv
  %i.wt = zext nneg i8 %.0239 to i32              ; 2 uses
  store i32 %i.wt, ptr %i.gl, align 8
  %i.wu = icmp samesign ugt i32 %2, 2
  %spec.select = select i1 %i.wu, i32 %2, i32 %i.wt ; 4 uses
  store i32 %spec.select, ptr %i.sy, align 4
  %i.wv = load ptr, ptr %0, align 8               ; 2 uses
  %i.ww = load i32, ptr %i.wv, align 8
  %i.wx = getelementptr inbounds nuw i8, ptr %i.wv, i64 4
  %i.wy = load i32, ptr %i.wx, align 4
  %i.wz = mul i32 %i.wy, %i.ww                    ; 9 uses
  %i.xa = load ptr, ptr %i.g, align 8             ; 9 uses
  %or.cond.not.i.i.i.i355 = icmp sgt i32 %i.wz, -1
...
stbi__mul2sizes_valid.exit.i.i.i357:              ; preds = %bb.fw
  %i.xb = udiv i32 2147483647, %spec.select
  %.not10.i.i.i = icmp samesign ugt i32 %i.wz, %i.xb
...
stbi__malloc_mad2.exit.i:                         ; preds = %stbi__mul2sizes_valid.exit.i.i.i357
  %i.xc = mul nuw nsw i32 %i.wz, %spec.select
  %i.xd = zext nneg i32 %i.xc to i64
  %i.xe = call noalias noundef ptr @malloc(i64 noundef range(i64 -8589934588, 8589934589) %i.xd) #53 ; 6 uses
  %i.xf = icmp eq ptr %i.xe, null
  br i1 %i.xf, label %stbi__expand_png_palette.exit.thread, label %bb.fx
...
bb.fx:                                            ; preds = %stbi__malloc_mad2.exit.i
  %i.xg = icmp eq i32 %spec.select, 3
  %.not56.i = icmp eq i32 %i.wz, 0                ; 2 uses
  br i1 %i.xg, label %.preheader.i361, label %.preheader49.i
...
.lr.ph.preheader.i:                               ; preds = %.preheader49.i
  %wide.trip.count.i = zext nneg i32 %i.wz to i64 ; 2 uses
  %xtraiter2145 = and i64 %wide.trip.count.i, 3   ; 3 uses
  %i.xh = icmp ult i32 %i.wz, 4
  br i1 %i.xh, label %.lr.ph.i.epil.preheader, label %.lr.ph.preheader.i.new
...
.lr.ph55.preheader.i:                             ; preds = %.preheader.i361
  %wide.trip.count62.i = zext nneg i32 %i.wz to i64 ; 2 uses
  %xtraiter2150 = and i64 %wide.trip.count62.i, 1
  %i.xi = icmp eq i32 %i.wz, 1
  br i1 %i.xi, label %.lr.ph55.i.epil.preheader, label %.lr.ph55.preheader.i.new
...
.lr.ph55.i:                                       ; preds = %.lr.ph55.i, %.lr.ph55.preheader.i.new
  ...
  %.04553.i = phi ptr [ %i.xe, %.lr.ph55.preheader.i.new ], [ %i.yj, %.lr.ph55.i ] ; 7 uses
  %niter2155 = phi i64 [ 0, %.lr.ph55.preheader.i.new ], [ %niter2155.next.1, %.lr.ph55.i ]
  %i.xj = getelementptr inbounds nuw i8, ptr %i.xa, i64 %indvars.iv59.i
  %i.xk = load i8, ptr %i.xj, align 1
end_hunk_3
begin_hunk_4_@stbi__de_iphone:bb.a
...
bb.m:                                             ; preds = %.lr.ph400, %.loopexit
  ...
  %i.cw = trunc i64 %indvars.iv457 to i32         ; 2 uses
  ...
  %i.dd = zext nneg i32 %i.dc to i64              ; 7 uses
