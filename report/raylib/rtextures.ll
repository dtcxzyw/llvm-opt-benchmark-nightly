...
begin_hunk_9_@stbi__create_png_image_raw:bb.a
  %.4396 = phi i8 [ %i.rl, %.lr.ph397.1 ], [ 0, %.lr.ph397.preheader ]
  %.2241395 = phi ptr [ %i.rk, %.lr.ph397.1 ], [ %i.dh, %.lr.ph397.preheader ] ; 3 uses
  %.4246394 = phi ptr [ %.5247, %.lr.ph397.1 ], [ %i.cy, %.lr.ph397.preheader ] ; 3 uses
  %.2267393 = phi i32 [ %i.rm, %.lr.ph397.1 ], [ 0, %.lr.ph397.preheader ] ; 2 uses
  %niter789 = phi i32 [ %niter789.next.1, %.lr.ph397.1 ], [ 0, %.lr.ph397.preheader ]
  %i.rd = and i32 %.2267393, 6
  %i.re = icmp eq i32 %i.rd, 0
  br i1 %i.re, label %bb.x, label %.lr.ph397.1

bb.x:                                             ; preds = %.lr.ph397
  %i.rf = getelementptr inbounds nuw i8, ptr %.4246394, i64 1
  %i.rg = load i8, ptr %.4246394, align 1
  br label %.lr.ph397.1

.lr.ph397.1:                                      ; preds = %bb.x, %.lr.ph397
  %.5247 = phi ptr [ %i.rf, %bb.x ], [ %.4246394, %.lr.ph397 ] ; 2 uses
  %.5 = phi i8 [ %i.rg, %bb.x ], [ %.4396, %.lr.ph397 ] ; 3 uses
  %isneg = icmp slt i8 %.5, 0
  %i.rh = select i1 %isneg, i8 %i.qg, i8 0
  %i.ri = getelementptr inbounds nuw i8, ptr %.2241395, i64 1
  store i8 %i.rh, ptr %.2241395, align 1
  %.mask = and i8 %.5, 64
  %isneg.1.not = icmp eq i8 %.mask, 0
  %i.rj = select i1 %isneg.1.not, i8 0, i8 %i.qg
  %i.rk = getelementptr inbounds nuw i8, ptr %.2241395, i64 2 ; 2 uses
  store i8 %i.rj, ptr %i.ri, align 1
  %i.rl = shl i8 %.5, 2                           ; 2 uses
  %i.rm = add nuw i32 %.2267393, 2                ; 2 uses
...
.lr.ph397.epil.preheader:                         ; preds = %.loopexit335.loopexit.unr-lcssa, %.lr.ph397.preheader
  %.4396.epil.init = phi i8 [ 0, %.lr.ph397.preheader ], [ %i.rl, %.loopexit335.loopexit.unr-lcssa ]
  %.2241395.epil.init = phi ptr [ %i.dh, %.lr.ph397.preheader ], [ %i.rk, %.loopexit335.loopexit.unr-lcssa ]
  %.4246394.epil.init = phi ptr [ %i.cy, %.lr.ph397.preheader ], [ %.5247, %.loopexit335.loopexit.unr-lcssa ]
  %.2267393.epil.init = phi i32 [ 0, %.lr.ph397.preheader ], [ %i.rm, %.loopexit335.loopexit.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod787)
  %i.rn = and i32 %.2267393.epil.init, 7
  %i.ro = icmp eq i32 %i.rn, 0
  br i1 %i.ro, label %bb.y, label %.loopexit335.loopexit.epilog-lcssa

bb.y:                                             ; preds = %.lr.ph397.epil.preheader
  %i.rp = load i8, ptr %.4246394.epil.init, align 1
  br label %.loopexit335.loopexit.epilog-lcssa

.loopexit335.loopexit.epilog-lcssa:               ; preds = %bb.y, %.lr.ph397.epil.preheader
  %.5.epil = phi i8 [ %i.rp, %bb.y ], [ %.4396.epil.init, %.lr.ph397.epil.preheader ]
  %isneg.epil = icmp slt i8 %.5.epil, 0
  %i.rq = select i1 %isneg.epil, i8 %i.qg, i8 0
  store i8 %i.rq, ptr %.2241395.epil.init, align 1
...
.lr.ph392.epil.preheader:                         ; preds = %.loopexit335.loopexit735.unr-lcssa, %.lr.ph392.preheader
  %.0239390.epil.init = phi ptr [ %i.dh, %.lr.ph392.preheader ], [ %i.qo, %.loopexit335.loopexit735.unr-lcssa ]
  %.0242389.epil.init = phi ptr [ %i.cy, %.lr.ph392.preheader ], [ %i.qh, %.loopexit335.loopexit735.unr-lcssa ]
  %.0265388.epil.init = phi i32 [ 0, %.lr.ph392.preheader ], [ %i.qp, %.loopexit335.loopexit735.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod781)
  %i.rr = and i32 %.0265388.epil.init, 1
  %i.rs = icmp eq i32 %i.rr, 0
  br i1 %i.rs, label %bb.z, label %.loopexit335.loopexit735.epilog-lcssa

bb.z:                                             ; preds = %.lr.ph392.epil.preheader
  %i.rt = load i8, ptr %.0242389.epil.init, align 1
  %i.ru = lshr i8 %i.rt, 4
  %i.rv = mul i8 %i.ru, %i.qg
  br label %.loopexit335.loopexit735.epilog-lcssa

.loopexit335.loopexit735.epilog-lcssa:            ; preds = %bb.z, %.lr.ph392.epil.preheader
  %.1237.epil = phi i8 [ %i.rv, %bb.z ], [ 0, %.lr.ph392.epil.preheader ]
...
.lr.ph387.epil.preheader:                         ; preds = %.loopexit335.loopexit736.unr-lcssa, %.lr.ph387.preheader
  %.2238386.epil.init = phi i8 [ 0, %.lr.ph387.preheader ], [ %i.rb, %.loopexit335.loopexit736.unr-lcssa ]
  %.1240385.epil.init = phi ptr [ %i.dh, %.lr.ph387.preheader ], [ %i.ra, %.loopexit335.loopexit736.unr-lcssa ]
  %.2244384.epil.init = phi ptr [ %i.cy, %.lr.ph387.preheader ], [ %.3245, %.loopexit335.loopexit736.unr-lcssa ]
  %.1266383.epil.init = phi i32 [ 0, %.lr.ph387.preheader ], [ %i.rc, %.loopexit335.loopexit736.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod775)
  %i.rw = and i32 %.1266383.epil.init, 3
  %i.rx = icmp eq i32 %i.rw, 0
  br i1 %i.rx, label %bb.aa, label %.loopexit335.loopexit736.epilog-lcssa

bb.aa:                                            ; preds = %.lr.ph387.epil.preheader
  %i.ry = load i8, ptr %.2244384.epil.init, align 1
  br label %.loopexit335.loopexit736.epilog-lcssa

.loopexit335.loopexit736.epilog-lcssa:            ; preds = %bb.aa, %.lr.ph387.epil.preheader
  %.3.epil = phi i8 [ %i.ry, %bb.aa ], [ %.2238386.epil.init, %.lr.ph387.epil.preheader ]
  %i.rz = lshr i8 %.3.epil, 6
  %i.sa = mul i8 %i.rz, %i.qg
  store i8 %i.sa, ptr %.1240385.epil.init, align 1
  br label %.loopexit335
...
.loopexit335:                                     ; preds = %.loopexit335.loopexit736.epilog-lcssa, %.loopexit335.loopexit736.unr-lcssa, %.loopexit335.loopexit735.epilog-lcssa, %.loopexit335.loopexit735.unr-lcssa, %.loopexit335.loopexit.epilog-lcssa, %.loopexit335.loopexit.unr-lcssa, %.preheader338, %.preheader336, %.preheader
  br i1 %i.ax, label %.loopexit, label %bb.ab

bb.ab:                                            ; preds = %.loopexit335
  br i1 %i.ay, label %.preheader.i, label %.preheader26.i

.preheader26.i:                                   ; preds = %bb.ab
  br i1 %i.az, label %.lr.ph.i.preheader, label %.loopexit

.lr.ph.i.preheader:                               ; preds = %.preheader26.i
  br i1 %lcmp.mod791.not.not, label %.lr.ph.i.prol, label %.lr.ph.i.prol.loopexit

.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader
  %i.sb = getelementptr inbounds nuw i8, ptr %i.dh, i64 %i.cr ; 4 uses
  %i.sc = getelementptr inbounds nuw i8, ptr %i.sb, i64 3
  store i8 -1, ptr %i.sc, align 1
  %i.sd = getelementptr inbounds nuw i8, ptr %i.dh, i64 %i.cs ; 3 uses
  %i.se = getelementptr inbounds nuw i8, ptr %i.sd, i64 2
  %i.sf = load i8, ptr %i.se, align 1
  %i.sg = getelementptr inbounds nuw i8, ptr %i.sb, i64 2
  store i8 %i.sf, ptr %i.sg, align 1
  %i.sh = getelementptr inbounds nuw i8, ptr %i.sd, i64 1
  %i.si = load i8, ptr %i.sh, align 1
  %i.sj = getelementptr inbounds nuw i8, ptr %i.sb, i64 1
  store i8 %i.si, ptr %i.sj, align 1
  %i.sk = load i8, ptr %i.sd, align 1
  store i8 %i.sk, ptr %i.sb, align 1
  br label %.lr.ph.i.prol.loopexit

.lr.ph.i.prol.loopexit:                           ; preds = %.lr.ph.i.prol, %.lr.ph.i.preheader
  %indvars.iv.i.unr = phi i64 [ %i.ba, %.lr.ph.i.preheader ], [ %indvars.iv.next.i.prol, %.lr.ph.i.prol ]
  br i1 %i.ct, label %.loopexit, label %.lr.ph.i

.preheader.i:                                     ; preds = %bb.ab
  br i1 %i.az, label %.lr.ph32.i.preheader, label %.loopexit
...
.lr.ph32.i.prol:                                  ; preds = %.lr.ph32.i.preheader, %.lr.ph32.i.prol
  %indvars.iv35.i.prol = phi i64 [ %indvars.iv.next36.i.prol, %.lr.ph32.i.prol ], [ %i.ba, %.lr.ph32.i.preheader ] ; 3 uses
  %prol.iter795 = phi i64 [ %prol.iter795.next, %.lr.ph32.i.prol ], [ 0, %.lr.ph32.i.preheader ]
  %i.sl = shl nuw nsw i64 %indvars.iv35.i.prol, 1
  %i.sm = getelementptr inbounds nuw i8, ptr %i.dh, i64 %i.sl ; 2 uses
  %i.sn = getelementptr inbounds nuw i8, ptr %i.sm, i64 1
  store i8 -1, ptr %i.sn, align 1
  %i.so = getelementptr inbounds nuw i8, ptr %i.dh, i64 %indvars.iv35.i.prol
  %i.sp = load i8, ptr %i.so, align 1
  store i8 %i.sp, ptr %i.sm, align 1
...
.lr.ph32.i.prol.loopexit:                         ; preds = %.lr.ph32.i.prol, %.lr.ph32.i.preheader
  %indvars.iv35.i.unr = phi i64 [ %i.ba, %.lr.ph32.i.preheader ], [ %indvars.iv.next36.i.prol, %.lr.ph32.i.prol ]
  br i1 %i.cu, label %.loopexit, label %.lr.ph32.i
...
.lr.ph32.i:                                       ; preds = %.lr.ph32.i.prol.loopexit, %.lr.ph32.i
  ...
  %i.sq = shl nuw nsw i64 %indvars.iv35.i, 1
  %i.sr = getelementptr inbounds nuw i8, ptr %i.dh, i64 %i.sq ; 2 uses
  %i.ss = getelementptr inbounds nuw i8, ptr %i.sr, i64 1
  store i8 -1, ptr %i.ss, align 1
  %i.st = getelementptr inbounds nuw i8, ptr %i.dh, i64 %indvars.iv35.i
  %i.su = load i8, ptr %i.st, align 1
  store i8 %i.su, ptr %i.sr, align 1
  %indvars.iv.next36.i = add nsw i64 %indvars.iv35.i, -1 ; 2 uses
  %i.sv = shl nuw nsw i64 %indvars.iv.next36.i, 1
  %i.sw = getelementptr inbounds nuw i8, ptr %i.dh, i64 %i.sv ; 2 uses
  %i.sx = getelementptr inbounds nuw i8, ptr %i.sw, i64 1
  store i8 -1, ptr %i.sx, align 1
  %i.sy = getelementptr inbounds nuw i8, ptr %i.dh, i64 %indvars.iv.next36.i
  %i.sz = load i8, ptr %i.sy, align 1
  store i8 %i.sz, ptr %i.sw, align 1
  %indvars.iv.next36.i.1 = add nsw i64 %indvars.iv35.i, -2 ; 2 uses
  %i.ta = shl nuw nsw i64 %indvars.iv.next36.i.1, 1
  %i.tb = getelementptr inbounds nuw i8, ptr %i.dh, i64 %i.ta ; 2 uses
  %i.tc = getelementptr inbounds nuw i8, ptr %i.tb, i64 1
  store i8 -1, ptr %i.tc, align 1
  %i.td = getelementptr inbounds nuw i8, ptr %i.dh, i64 %indvars.iv.next36.i.1
  %i.te = load i8, ptr %i.td, align 1
  store i8 %i.te, ptr %i.tb, align 1
  %indvars.iv.next36.i.2 = add nsw i64 %indvars.iv35.i, -3 ; 3 uses
  %i.tf = shl nuw nsw i64 %indvars.iv.next36.i.2, 1
  %i.tg = getelementptr inbounds nuw i8, ptr %i.dh, i64 %i.tf ; 2 uses
  %i.th = getelementptr inbounds nuw i8, ptr %i.tg, i64 1
  store i8 -1, ptr %i.th, align 1
  %i.ti = getelementptr inbounds nuw i8, ptr %i.dh, i64 %indvars.iv.next36.i.2
  %i.tj = load i8, ptr %i.ti, align 1
  store i8 %i.tj, ptr %i.tg, align 1
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.tk = shl nuw nsw i64 %indvars.iv.i, 2
  %i.tl = getelementptr inbounds nuw i8, ptr %i.dh, i64 %i.tk ; 4 uses
  %i.tm = getelementptr inbounds nuw i8, ptr %i.tl, i64 3
  store i8 -1, ptr %i.tm, align 1
  %i.tn = mul nuw nsw i64 %indvars.iv.i, 3
  %i.to = getelementptr inbounds nuw i8, ptr %i.dh, i64 %i.tn ; 3 uses
  %i.tp = getelementptr inbounds nuw i8, ptr %i.to, i64 2
  %i.tq = load i8, ptr %i.tp, align 1
  %i.tr = getelementptr inbounds nuw i8, ptr %i.tl, i64 2
  store i8 %i.tq, ptr %i.tr, align 1
  %i.ts = getelementptr inbounds nuw i8, ptr %i.to, i64 1
  %i.tt = load i8, ptr %i.ts, align 1
  %i.tu = getelementptr inbounds nuw i8, ptr %i.tl, i64 1
  store i8 %i.tt, ptr %i.tu, align 1
  %i.tv = load i8, ptr %i.to, align 1
  store i8 %i.tv, ptr %i.tl, align 1
  %indvars.iv.next.i = add nsw i64 %indvars.iv.i, -1 ; 3 uses
  %i.tw = shl nuw nsw i64 %indvars.iv.next.i, 2
  %i.tx = getelementptr inbounds nuw i8, ptr %i.dh, i64 %i.tw ; 4 uses
  %i.ty = getelementptr inbounds nuw i8, ptr %i.tx, i64 3
  store i8 -1, ptr %i.ty, align 1
  %i.tz = mul nuw nsw i64 %indvars.iv.next.i, 3
  %i.ua = getelementptr inbounds nuw i8, ptr %i.dh, i64 %i.tz ; 3 uses
  %i.ub = getelementptr inbounds nuw i8, ptr %i.ua, i64 2
  %i.uc = load i8, ptr %i.ub, align 1
  %i.ud = getelementptr inbounds nuw i8, ptr %i.tx, i64 2
  store i8 %i.uc, ptr %i.ud, align 1
  %i.ue = getelementptr inbounds nuw i8, ptr %i.ua, i64 1
  %i.uf = load i8, ptr %i.ue, align 1
  %i.ug = getelementptr inbounds nuw i8, ptr %i.tx, i64 1
  store i8 %i.uf, ptr %i.ug, align 1
  %i.uh = load i8, ptr %i.ua, align 1
  store i8 %i.uh, ptr %i.tx, align 1
  %indvars.iv.next.i.1 = add nsw i64 %indvars.iv.i, -2
  %.not.i304.1 = icmp eq i64 %indvars.iv.next.i, 0
  br i1 %.not.i304.1, label %.loopexit, label %.lr.ph.i

bb.ac:                                            ; preds = %.loopexit348
  br i1 %i.aw, label %bb.ad, label %bb.ag

bb.ad:                                            ; preds = %bb.ac
  br i1 %i.ax, label %bb.ae, label %bb.af

bb.ae:                                            ; preds = %bb.ad
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.dh, ptr nonnull align 1 %i.cy, i64 %i.bb, i1 false)
  br label %.loopexit

bb.af:                                            ; preds = %bb.ad
  br i1 %i.ay, label %.preheader.i312, label %.preheader26.i306

.preheader26.i306:                                ; preds = %bb.af
  br i1 %i.az, label %.lr.ph.i308.preheader, label %.loopexit
...
.lr.ph.i308.prol:                                 ; preds = %.lr.ph.i308.preheader
  %i.ui = getelementptr inbounds nuw i8, ptr %i.dh, i64 %i.ci ; 4 uses
  %i.uj = getelementptr inbounds nuw i8, ptr %i.ui, i64 3
  store i8 -1, ptr %i.uj, align 1
  %i.uk = getelementptr inbounds nuw i8, ptr %i.cy, i64 %i.cj ; 3 uses
  %i.ul = getelementptr inbounds nuw i8, ptr %i.uk, i64 2
  %i.um = load i8, ptr %i.ul, align 1
  %i.un = getelementptr inbounds nuw i8, ptr %i.ui, i64 2
  store i8 %i.um, ptr %i.un, align 1
  %i.uo = getelementptr inbounds nuw i8, ptr %i.uk, i64 1
  %i.up = load i8, ptr %i.uo, align 1
  %i.uq = getelementptr inbounds nuw i8, ptr %i.ui, i64 1
  store i8 %i.up, ptr %i.uq, align 1
  %i.ur = load i8, ptr %i.uk, align 1
  store i8 %i.ur, ptr %i.ui, align 1
  br label %.lr.ph.i308.prol.loopexit

.lr.ph.i308.prol.loopexit:                        ; preds = %.lr.ph.i308.prol, %.lr.ph.i308.preheader
  %indvars.iv.i309.unr = phi i64 [ %i.ba, %.lr.ph.i308.preheader ], [ %indvars.iv.next.i310.prol, %.lr.ph.i308.prol ]
  br i1 %i.ck, label %.loopexit, label %.lr.ph.i308

.preheader.i312:                                  ; preds = %bb.af
  br i1 %i.az, label %.lr.ph32.i314.preheader, label %.loopexit
...
vector.body:                                      ; preds = %.lr.ph32.i314.preheader, %vector.body
  ...
  %i.us = sub i64 %i.ba, %index                   ; 2 uses
  %i.ut = shl nuw nsw i64 %i.us, 1
  %i.uu = getelementptr inbounds nuw i8, ptr %i.dh, i64 %i.ut
  %i.uv = getelementptr inbounds nuw i8, ptr %i.cy, i64 %i.us
  %i.uw = getelementptr inbounds i8, ptr %i.uv, i64 -7
  %wide.load = load <8 x i8>, ptr %i.uw, align 1
  %i.ux = getelementptr inbounds i8, ptr %i.uu, i64 -14
  ...
  store <16 x i8> %interleaved.vec, ptr %i.ux, align 1
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.uy = icmp eq i64 %index.next, %n.vec
  br i1 %i.uy, label %middle.block, label %vector.body, !llvm.loop !228
...
.lr.ph32.i314.preheader737:                       ; preds = %.lr.ph32.i314.preheader, %middle.block
  %indvars.iv35.i315.ph = phi i64 [ %i.ba, %.lr.ph32.i314.preheader ], [ %i.cm, %middle.block ]
...
.lr.ph32.i314:                                    ; preds = %.lr.ph32.i314.preheader737, %.lr.ph32.i314
  ...
  %i.uz = shl nuw nsw i64 %indvars.iv35.i315, 1
  %i.va = getelementptr inbounds nuw i8, ptr %i.dh, i64 %i.uz ; 2 uses
  %i.vb = getelementptr inbounds nuw i8, ptr %i.va, i64 1
  store i8 -1, ptr %i.vb, align 1
  %i.vc = getelementptr inbounds nuw i8, ptr %i.cy, i64 %indvars.iv35.i315
  %i.vd = load i8, ptr %i.vc, align 1
  store i8 %i.vd, ptr %i.va, align 1
...
.lr.ph.i308:                                      ; preds = %.lr.ph.i308.prol.loopexit, %.lr.ph.i308
  ...
  %i.ve = shl nuw nsw i64 %indvars.iv.i309, 2
  %i.vf = getelementptr inbounds nuw i8, ptr %i.dh, i64 %i.ve ; 4 uses
  %i.vg = getelementptr inbounds nuw i8, ptr %i.vf, i64 3
  store i8 -1, ptr %i.vg, align 1
  %i.vh = mul nuw nsw i64 %indvars.iv.i309, 3
  %i.vi = getelementptr inbounds nuw i8, ptr %i.cy, i64 %i.vh ; 3 uses
  %i.vj = getelementptr inbounds nuw i8, ptr %i.vi, i64 2
  %i.vk = load i8, ptr %i.vj, align 1
  %i.vl = getelementptr inbounds nuw i8, ptr %i.vf, i64 2
  store i8 %i.vk, ptr %i.vl, align 1
  %i.vm = getelementptr inbounds nuw i8, ptr %i.vi, i64 1
  %i.vn = load i8, ptr %i.vm, align 1
  %i.vo = getelementptr inbounds nuw i8, ptr %i.vf, i64 1
  store i8 %i.vn, ptr %i.vo, align 1
  %i.vp = load i8, ptr %i.vi, align 1
  store i8 %i.vp, ptr %i.vf, align 1
  %indvars.iv.next.i310 = add nsw i64 %indvars.iv.i309, -1 ; 3 uses
  %i.vq = shl nuw nsw i64 %indvars.iv.next.i310, 2
  %i.vr = getelementptr inbounds nuw i8, ptr %i.dh, i64 %i.vq ; 4 uses
  %i.vs = getelementptr inbounds nuw i8, ptr %i.vr, i64 3
  store i8 -1, ptr %i.vs, align 1
  %i.vt = mul nuw nsw i64 %indvars.iv.next.i310, 3
  %i.vu = getelementptr inbounds nuw i8, ptr %i.cy, i64 %i.vt ; 3 uses
  %i.vv = getelementptr inbounds nuw i8, ptr %i.vu, i64 2
  %i.vw = load i8, ptr %i.vv, align 1
  %i.vx = getelementptr inbounds nuw i8, ptr %i.vr, i64 2
  store i8 %i.vw, ptr %i.vx, align 1
  %i.vy = getelementptr inbounds nuw i8, ptr %i.vu, i64 1
  %i.vz = load i8, ptr %i.vy, align 1
  %i.wa = getelementptr inbounds nuw i8, ptr %i.vr, i64 1
  store i8 %i.vz, ptr %i.wa, align 1
  %i.wb = load i8, ptr %i.vu, align 1
  store i8 %i.wb, ptr %i.vr, align 1
...
bb.ah:                                            ; preds = %bb.ag
  br i1 %i.ax, label %.preheader342, label %bb.ai

.preheader342:                                    ; preds = %bb.ah
  br i1 %.not404, label %.loopexit, label %.lr.ph382.preheader

.lr.ph382.preheader:                              ; preds = %.preheader342
  br i1 %i.cg, label %.lr.ph382.epil.preheader, label %.lr.ph382

.lr.ph382:                                        ; preds = %.lr.ph382.preheader, %.lr.ph382
  %.0381 = phi ptr [ %i.xk, %.lr.ph382 ], [ %i.dh, %.lr.ph382.preheader ] ; 5 uses
  %.0249380 = phi ptr [ %i.xl, %.lr.ph382 ], [ %i.cy, %.lr.ph382.preheader ] ; 9 uses
  %niter768 = phi i32 [ %niter768.next.3, %.lr.ph382 ], [ 0, %.lr.ph382.preheader ]
  %i.wc = load i8, ptr %.0249380, align 1
  %i.wd = zext i8 %i.wc to i16
  %i.we = shl nuw i16 %i.wd, 8
  %i.wf = getelementptr inbounds nuw i8, ptr %.0249380, i64 1
  %i.wg = load i8, ptr %i.wf, align 1
  %i.wh = zext i8 %i.wg to i16
  %i.wi = or disjoint i16 %i.we, %i.wh
  store i16 %i.wi, ptr %.0381, align 2
  %i.wj = getelementptr inbounds nuw i8, ptr %.0381, i64 2
  %i.wk = getelementptr inbounds nuw i8, ptr %.0249380, i64 2
  %i.wl = load i8, ptr %i.wk, align 1
  %i.wm = zext i8 %i.wl to i16
  %i.wn = shl nuw i16 %i.wm, 8
  %i.wo = getelementptr inbounds nuw i8, ptr %.0249380, i64 3
  %i.wp = load i8, ptr %i.wo, align 1
  %i.wq = zext i8 %i.wp to i16
  %i.wr = or disjoint i16 %i.wn, %i.wq
  store i16 %i.wr, ptr %i.wj, align 2
  %i.ws = getelementptr inbounds nuw i8, ptr %.0381, i64 4
  %i.wt = getelementptr inbounds nuw i8, ptr %.0249380, i64 4
  %i.wu = load i8, ptr %i.wt, align 1
  %i.wv = zext i8 %i.wu to i16
  %i.ww = shl nuw i16 %i.wv, 8
  %i.wx = getelementptr inbounds nuw i8, ptr %.0249380, i64 5
  %i.wy = load i8, ptr %i.wx, align 1
  %i.wz = zext i8 %i.wy to i16
  %i.xa = or disjoint i16 %i.ww, %i.wz
  store i16 %i.xa, ptr %i.ws, align 2
  %i.xb = getelementptr inbounds nuw i8, ptr %.0381, i64 6
  %i.xc = getelementptr inbounds nuw i8, ptr %.0249380, i64 6
  %i.xd = load i8, ptr %i.xc, align 1
  %i.xe = zext i8 %i.xd to i16
  %i.xf = shl nuw i16 %i.xe, 8
  %i.xg = getelementptr inbounds nuw i8, ptr %.0249380, i64 7
  %i.xh = load i8, ptr %i.xg, align 1
  %i.xi = zext i8 %i.xh to i16
  %i.xj = or disjoint i16 %i.xf, %i.xi
  store i16 %i.xj, ptr %i.xb, align 2
  %i.xk = getelementptr inbounds nuw i8, ptr %.0381, i64 8 ; 2 uses
  %i.xl = getelementptr inbounds nuw i8, ptr %.0249380, i64 8 ; 2 uses
...
bb.ai:                                            ; preds = %bb.ah
  br i1 %i.ay, label %.preheader344, label %.preheader346
...
.lr.ph378.preheader:                              ; preds = %.preheader344
  br i1 %i.cf, label %.lr.ph378.epil.preheader, label %.lr.ph378

.lr.ph378:                                        ; preds = %.lr.ph378.preheader, %.lr.ph378
  %.1377 = phi ptr [ %i.ye, %.lr.ph378 ], [ %i.dh, %.lr.ph378.preheader ] ; 5 uses
  %.1250376 = phi ptr [ %i.yf, %.lr.ph378 ], [ %i.cy, %.lr.ph378.preheader ] ; 5 uses
  %niter = phi i32 [ %niter.next.1, %.lr.ph378 ], [ 0, %.lr.ph378.preheader ]
  %i.xm = load i8, ptr %.1250376, align 1
  %i.xn = zext i8 %i.xm to i16
  %i.xo = shl nuw i16 %i.xn, 8
  %i.xp = getelementptr inbounds nuw i8, ptr %.1250376, i64 1
  %i.xq = load i8, ptr %i.xp, align 1
  %i.xr = zext i8 %i.xq to i16
  %i.xs = or disjoint i16 %i.xo, %i.xr
  store i16 %i.xs, ptr %.1377, align 2
  %i.xt = getelementptr inbounds nuw i8, ptr %.1377, i64 2
  store i16 -1, ptr %i.xt, align 2
  %i.xu = getelementptr inbounds nuw i8, ptr %.1377, i64 4
  %i.xv = getelementptr inbounds nuw i8, ptr %.1250376, i64 2
  %i.xw = load i8, ptr %i.xv, align 1
  %i.xx = zext i8 %i.xw to i16
  %i.xy = shl nuw i16 %i.xx, 8
  %i.xz = getelementptr inbounds nuw i8, ptr %.1250376, i64 3
  %i.ya = load i8, ptr %i.xz, align 1
  %i.yb = zext i8 %i.ya to i16
  %i.yc = or disjoint i16 %i.xy, %i.yb
  store i16 %i.yc, ptr %i.xu, align 2
  %i.yd = getelementptr inbounds nuw i8, ptr %.1377, i64 6
  store i16 -1, ptr %i.yd, align 2
  %i.ye = getelementptr inbounds nuw i8, ptr %.1377, i64 8 ; 2 uses
  %i.yf = getelementptr inbounds nuw i8, ptr %.1250376, i64 4 ; 2 uses
  %niter.next.1 = add nuw i32 %niter, 2           ; 2 uses
  %niter.ncmp.1 = icmp eq i32 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.loopexit.loopexit741.unr-lcssa, label %.lr.ph378

.lr.ph374:                                        ; preds = %.preheader346, %.lr.ph374
  %.2373 = phi ptr [ %i.zh, %.lr.ph374 ], [ %i.dh, %.preheader346 ] ; 5 uses
  %.2251372 = phi ptr [ %i.zi, %.lr.ph374 ], [ %i.cy, %.preheader346 ] ; 7 uses
  %.5270371 = phi i32 [ %i.zg, %.lr.ph374 ], [ 0, %.preheader346 ]
  %i.yg = load i8, ptr %.2251372, align 1
  %i.yh = zext i8 %i.yg to i16
  %i.yi = shl nuw i16 %i.yh, 8
  %i.yj = getelementptr inbounds nuw i8, ptr %.2251372, i64 1
  %i.yk = load i8, ptr %i.yj, align 1
  %i.yl = zext i8 %i.yk to i16
  %i.ym = or disjoint i16 %i.yi, %i.yl
  store i16 %i.ym, ptr %.2373, align 2
  %i.yn = getelementptr inbounds nuw i8, ptr %.2251372, i64 2
  %i.yo = load i8, ptr %i.yn, align 1
  %i.yp = zext i8 %i.yo to i16
  %i.yq = shl nuw i16 %i.yp, 8
  %i.yr = getelementptr inbounds nuw i8, ptr %.2251372, i64 3
  %i.ys = load i8, ptr %i.yr, align 1
  %i.yt = zext i8 %i.ys to i16
  %i.yu = or disjoint i16 %i.yq, %i.yt
  %i.yv = getelementptr inbounds nuw i8, ptr %.2373, i64 2
  store i16 %i.yu, ptr %i.yv, align 2
  %i.yw = getelementptr inbounds nuw i8, ptr %.2251372, i64 4
  %i.yx = load i8, ptr %i.yw, align 1
  %i.yy = zext i8 %i.yx to i16
  %i.yz = shl nuw i16 %i.yy, 8
  %i.za = getelementptr inbounds nuw i8, ptr %.2251372, i64 5
  %i.zb = load i8, ptr %i.za, align 1
  %i.zc = zext i8 %i.zb to i16
  %i.zd = or disjoint i16 %i.yz, %i.zc
  %i.ze = getelementptr inbounds nuw i8, ptr %.2373, i64 4
  store i16 %i.zd, ptr %i.ze, align 2
  %i.zf = getelementptr inbounds nuw i8, ptr %.2373, i64 6
  store i16 -1, ptr %i.zf, align 2
  %i.zg = add nuw i32 %.5270371, 1                ; 2 uses
  %i.zh = getelementptr inbounds nuw i8, ptr %.2373, i64 8
  %i.zi = getelementptr inbounds nuw i8, ptr %.2251372, i64 6
  %exitcond451.not = icmp eq i32 %i.zg, %4
...
.lr.ph382.epil.preheader:                         ; preds = %.loopexit.loopexit740.unr-lcssa, %.lr.ph382.preheader
  %.0381.epil.init = phi ptr [ %i.dh, %.lr.ph382.preheader ], [ %i.xk, %.loopexit.loopexit740.unr-lcssa ]
  %.0249380.epil.init = phi ptr [ %i.cy, %.lr.ph382.preheader ], [ %i.xl, %.loopexit.loopexit740.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod766)
  br label %.lr.ph382.epil

.lr.ph382.epil:                                   ; preds = %.lr.ph382.epil, %.lr.ph382.epil.preheader
  %.0381.epil = phi ptr [ %i.zq, %.lr.ph382.epil ], [ %.0381.epil.init, %.lr.ph382.epil.preheader ] ; 2 uses
  %.0249380.epil = phi ptr [ %i.zr, %.lr.ph382.epil ], [ %.0249380.epil.init, %.lr.ph382.epil.preheader ] ; 3 uses
  %epil.iter = phi i32 [ %epil.iter.next, %.lr.ph382.epil ], [ 0, %.lr.ph382.epil.preheader ]
  %i.zj = load i8, ptr %.0249380.epil, align 1
  %i.zk = zext i8 %i.zj to i16
  %i.zl = shl nuw i16 %i.zk, 8
  %i.zm = getelementptr inbounds nuw i8, ptr %.0249380.epil, i64 1
  %i.zn = load i8, ptr %i.zm, align 1
  %i.zo = zext i8 %i.zn to i16
  %i.zp = or disjoint i16 %i.zl, %i.zo
  store i16 %i.zp, ptr %.0381.epil, align 2
  %i.zq = getelementptr inbounds nuw i8, ptr %.0381.epil, i64 2
  %i.zr = getelementptr inbounds nuw i8, ptr %.0249380.epil, i64 2
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
...
.lr.ph378.epil.preheader:                         ; preds = %.loopexit.loopexit741.unr-lcssa, %.lr.ph378.preheader
  %.1377.epil.init = phi ptr [ %i.dh, %.lr.ph378.preheader ], [ %i.ye, %.loopexit.loopexit741.unr-lcssa ] ; 2 uses
  %.1250376.epil.init = phi ptr [ %i.cy, %.lr.ph378.preheader ], [ %i.yf, %.loopexit.loopexit741.unr-lcssa ] ; 2 uses
  tail call void @llvm.assume(i1 %lcmp.mod763)
  %i.zs = load i8, ptr %.1250376.epil.init, align 1
