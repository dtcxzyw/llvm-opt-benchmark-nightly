...
bb.a:
  %.sroa.35.0.extract.shift.a = lshr i32 %0, 8
  %.sroa.46.0.extract.shift = lshr i32 %0, 16
  %.sroa.5.0.extract.shift = lshr i32 %0, 24
  %.sroa.2.0.extract.shift.a = lshr i32 %1, 8
  ...
  %2 = udiv i16 %.lhs.trunc, 255
  %.zext = zext nneg i16 %2 to i32
  %3 = and i32 %.sroa.35.0.extract.shift.a, 255
  %4 = and i32 %.sroa.2.0.extract.shift.a, 255
  %5 = mul nuw nsw i32 %4, %3
  %.lhs.trunc10.a = trunc nuw i32 %5 to i16
  %6 = udiv i16 %.lhs.trunc10.a, 255
  %.zext11 = zext nneg i16 %6 to i32
  %7 = and i32 %.sroa.46.0.extract.shift, 255
  %8 = and i32 %.sroa.3.0.extract.shift, 255
  %9 = mul nuw nsw i32 %8, %7
  %.lhs.trunc12 = trunc nuw i32 %9 to i16
  %10 = udiv i16 %.lhs.trunc12, 255
  %.zext13.a = zext nneg i16 %10 to i32
  %11 = mul nuw nsw i32 %.sroa.4.0.extract.shift, %.sroa.5.0.extract.shift
  %.lhs.trunc14 = trunc nuw i32 %11 to i16
  %12 = udiv i16 %.lhs.trunc14, 255
  %.zext15 = zext nneg i16 %12 to i32
  %.sroa.7.0.insert.ext = shl nuw i32 %.zext15, 24
  %.sroa.59.0.insert.ext = shl nuw nsw i32 %.zext13.a, 16
  ...
  %.sroa.38.0.insert.ext = shl nuw nsw i32 %.zext11, 8
