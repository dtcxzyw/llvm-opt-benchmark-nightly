...
begin_hunk_2_@stbir__alloc_internal_mem_and_build_samplers:bb.a
  %i.yl = getelementptr inbounds nuw i8, ptr %.1308, i64 240 ; 2 uses
  br label %bb.ce

bb.ce:                                            ; preds = %bb.cg, %bb.cd
  %.3.i357 = phi ptr [ %i.yk, %bb.cd ], [ %i.yz, %bb.cg ] ; 4 uses
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(ptr %.3.i357) #52, !srcloc !81
  %i.ym = icmp ugt ptr %.3.i357, %i.yl
  br i1 %i.ym, label %bb.cf, label %bb.cg

bb.cf:                                            ; preds = %bb.ce
  %i.yn = icmp eq ptr %.3.i357, %i.xu
  br i1 %i.yn, label %stbir_simd_memcpy.exit360, label %bb.cg

bb.cg:                                            ; preds = %bb.cf, %bb.ce
  %.4.i358 = phi ptr [ %.3.i357, %bb.ce ], [ %i.yl, %bb.cf ] ; 6 uses
  %i.yo = getelementptr inbounds i8, ptr %.4.i358, i64 %i.xw ; 4 uses
  %i.yp = load <4 x float>, ptr %i.yo, align 1
  ...
  %i.yu = getelementptr inbounds nuw i8, ptr %i.yo, i64 48
  %i.yv = load <4 x float>, ptr %i.yu, align 1
  store <4 x float> %i.yp, ptr %.4.i358, align 1
  %i.yw = getelementptr inbounds nuw i8, ptr %.4.i358, i64 16
  store <4 x float> %i.yr, ptr %i.yw, align 1
  %i.yx = getelementptr inbounds nuw i8, ptr %.4.i358, i64 32
  store <4 x float> %i.yt, ptr %i.yx, align 1
  %i.yy = getelementptr inbounds nuw i8, ptr %.4.i358, i64 48
  store <4 x float> %i.yv, ptr %i.yy, align 1
  %i.yz = getelementptr inbounds nuw i8, ptr %.4.i358, i64 64
  br label %bb.ce, !llvm.loop !82

bb.ch:                                            ; preds = %stbir_simd_memcpy.exit
  tail call fastcc void @stbir__calculate_filters(ptr noundef %1, ptr noundef %.3, ptr noundef %8)
  %i.za = getelementptr inbounds nuw i8, ptr %.1308, i64 304
  %i.zb = ptrtoint ptr %1 to i64
  %i.zc = ptrtoint ptr %i.wn to i64               ; 2 uses
  %i.zd = sub i64 %i.zb, %i.zc                    ; 2 uses
  %i.ze = getelementptr inbounds i8, ptr %i.wn, i64 %i.zd ; 4 uses
  %i.zf = load <4 x float>, ptr %i.ze, align 1
  ...
  store <4 x float> %i.zf, ptr %i.wn, align 8
  %i.zm = getelementptr inbounds nuw i8, ptr %i.ex, i64 168
  store <4 x float> %i.zh, ptr %i.zm, align 8
  %i.zn = getelementptr inbounds nuw i8, ptr %i.ex, i64 184
  store <4 x float> %i.zj, ptr %i.zn, align 8
  %i.zo = getelementptr inbounds nuw i8, ptr %i.ex, i64 200
  store <4 x float> %i.zl, ptr %i.zo, align 8
  %i.zp = and i64 %i.zc, -64
  %i.zq = add i64 %i.zp, 64
  %i.zr = inttoptr i64 %i.zq to ptr
  %i.zs = getelementptr inbounds nuw i8, ptr %.1308, i64 240 ; 2 uses
  br label %bb.ci

bb.ci:                                            ; preds = %bb.ck, %bb.ch
  %.3.i361 = phi ptr [ %i.zr, %bb.ch ], [ %i.aag, %bb.ck ] ; 4 uses
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(ptr %.3.i361) #52, !srcloc !81
  %i.zt = icmp ugt ptr %.3.i361, %i.zs
  br i1 %i.zt, label %bb.cj, label %bb.ck

bb.cj:                                            ; preds = %bb.ci
  %i.zu = icmp eq ptr %.3.i361, %i.za
  br i1 %i.zu, label %stbir_simd_memcpy.exit360, label %bb.ck

bb.ck:                                            ; preds = %bb.cj, %bb.ci
  %.4.i362 = phi ptr [ %.3.i361, %bb.ci ], [ %i.zs, %bb.cj ] ; 6 uses
  %i.zv = getelementptr inbounds i8, ptr %.4.i362, i64 %i.zd ; 4 uses
  %i.zw = load <4 x float>, ptr %i.zv, align 1
  %i.zx = getelementptr inbounds nuw i8, ptr %i.zv, i64 16
  %i.zy = load <4 x float>, ptr %i.zx, align 1
  %i.zz = getelementptr inbounds nuw i8, ptr %i.zv, i64 32
  %i.aaa = load <4 x float>, ptr %i.zz, align 1
  %i.aab = getelementptr inbounds nuw i8, ptr %i.zv, i64 48
  %i.aac = load <4 x float>, ptr %i.aab, align 1
  store <4 x float> %i.zw, ptr %.4.i362, align 1
  %i.aad = getelementptr inbounds nuw i8, ptr %.4.i362, i64 16
  store <4 x float> %i.zy, ptr %i.aad, align 1
  %i.aae = getelementptr inbounds nuw i8, ptr %.4.i362, i64 32
  store <4 x float> %i.aaa, ptr %i.aae, align 1
  %i.aaf = getelementptr inbounds nuw i8, ptr %.4.i362, i64 48
  store <4 x float> %i.aac, ptr %i.aaf, align 1
  %i.aag = getelementptr inbounds nuw i8, ptr %.4.i362, i64 64
  br label %bb.ci, !llvm.loop !82

stbir_simd_memcpy.exit360:                        ; preds = %bb.cf, %bb.cj
  %i.aah = getelementptr inbounds nuw i8, ptr %i.ex, i64 416
  %i.aai = load ptr, ptr %i.aah, align 8          ; 4 uses
  %i.aaj = getelementptr inbounds nuw i8, ptr %i.ex, i64 468
  %i.aak = load i32, ptr %i.aaj, align 4          ; 8 uses
  %i.aal = getelementptr inbounds nuw i8, ptr %.1308, i64 280 ; 2 uses
  %i.aam = load ptr, ptr %i.wn, align 8
  %i.aan = icmp sgt i32 %i.aak, 0
  br i1 %i.aan, label %.lr.ph76.i, label %.loopexit

.lr.ph76.i:                                       ; preds = %stbir_simd_memcpy.exit360
  %i.aao = load i32, ptr %i.aal, align 8
  %i.aap = getelementptr inbounds nuw i8, ptr %i.ex, i64 184
  %i.aaq = load i32, ptr %i.aap, align 8
  %i.aar = getelementptr inbounds nuw i8, ptr %i.ex, i64 252
  %i.aas = load i32, ptr %i.aar, align 4          ; 3 uses
  %i.aat = getelementptr inbounds nuw i8, ptr %i.ex, i64 188
  %i.aau = load i32, ptr %i.aat, align 4          ; 3 uses
  %.not78.i = icmp eq i32 %i.aao, 0
  %i.aav = mul nsw i32 %i.aas, 3
  %i.aaw = sub nsw i32 0, %i.aas                  ; 4 uses
  %i.aax = add nsw i32 %i.aas, %i.aaq             ; 4 uses
  %wide.trip.count86.i = zext nneg i32 %i.aak to i64 ; 3 uses
...
.lr.ph76.split.us.i.preheader:                    ; preds = %.lr.ph76.i
  ...
  %i.aay = icmp eq i32 %i.aak, 1
  br i1 %i.aay, label %.lr.ph76.split.us.i.epil.preheader, label %.lr.ph76.split.us.i.preheader.new
...
.lr.ph76.split.us.i:                              ; preds = %.lr.ph76.split.us.i, %.lr.ph76.split.us.i.preheader.new
  ...
  %.05674.us.i = phi i32 [ %i.aau, %.lr.ph76.split.us.i.preheader.new ], [ %i.abq, %.lr.ph76.split.us.i ] ; 2 uses
  %.05773.us.i = phi i32 [ 0, %.lr.ph76.split.us.i.preheader.new ], [ %i.abo, %.lr.ph76.split.us.i ] ; 2 uses
  %niter206 = phi i64 [ 0, %.lr.ph76.split.us.i.preheader.new ], [ %niter206.next.1, %.lr.ph76.split.us.i ]
  %i.aaz = getelementptr inbounds nuw [120 x i8], ptr %i.aai, i64 %indvars.iv83.i ; 4 uses
  %i.aba = getelementptr inbounds nuw i8, ptr %i.aaz, i64 20
  store i32 %.05773.us.i, ptr %i.aba, align 4
  %i.abb = trunc i64 %indvars.iv83.i to i32
  %i.abc = sub i32 %i.aak, %i.abb
  %i.abd = sdiv i32 %.05674.us.i, %i.abc          ; 2 uses
  %i.abe = add nsw i32 %i.abd, %.05773.us.i       ; 3 uses
  %i.abf = getelementptr inbounds nuw i8, ptr %i.aaz, i64 24
  store i32 %i.abe, ptr %i.abf, align 8
  %i.abg = sub nsw i32 %.05674.us.i, %i.abd       ; 2 uses
  %i.abh = getelementptr inbounds nuw i8, ptr %i.aaz, i64 28
  store i32 %i.aaw, ptr %i.abh, align 4
  %i.abi = getelementptr inbounds nuw i8, ptr %i.aaz, i64 32
  store i32 %i.aax, ptr %i.abi, align 8
  %indvars.iv.next84.i = or disjoint i64 %indvars.iv83.i, 1 ; 2 uses
  %i.abj = getelementptr inbounds nuw [120 x i8], ptr %i.aai, i64 %indvars.iv.next84.i ; 4 uses
  %i.abk = getelementptr inbounds nuw i8, ptr %i.abj, i64 20
  store i32 %i.abe, ptr %i.abk, align 4
  %i.abl = trunc i64 %indvars.iv.next84.i to i32
  %i.abm = sub i32 %i.aak, %i.abl
  %i.abn = sdiv i32 %i.abg, %i.abm                ; 2 uses
  %i.abo = add nsw i32 %i.abn, %i.abe             ; 3 uses
  %i.abp = getelementptr inbounds nuw i8, ptr %i.abj, i64 24
  store i32 %i.abo, ptr %i.abp, align 8
  %i.abq = sub nsw i32 %i.abg, %i.abn             ; 2 uses
  %i.abr = getelementptr inbounds nuw i8, ptr %i.abj, i64 28
  store i32 %i.aaw, ptr %i.abr, align 4
  %i.abs = getelementptr inbounds nuw i8, ptr %i.abj, i64 32
  store i32 %i.aax, ptr %i.abs, align 8
...
.lr.ph76.split.i:                                 ; preds = %.lr.ph76.i, %bb.cn
  %indvars.iv.i365 = phi i64 [ %indvars.iv.next.i370, %bb.cn ], [ 0, %.lr.ph76.i ] ; 4 uses
  %.05674.i = phi i32 [ %i.aco, %bb.cn ], [ %i.aau, %.lr.ph76.i ] ; 2 uses
  %.05773.i = phi i32 [ %i.aby, %bb.cn ], [ 0, %.lr.ph76.i ] ; 4 uses
  %i.abt = getelementptr inbounds nuw [120 x i8], ptr %i.aai, i64 %indvars.iv.i365 ; 5 uses
  %i.abu = getelementptr inbounds nuw i8, ptr %i.abt, i64 20 ; 2 uses
  store i32 %.05773.i, ptr %i.abu, align 4
  %i.abv = trunc i64 %indvars.iv.i365 to i32
  %i.abw = sub i32 %i.aak, %i.abv
  %i.abx = sdiv i32 %.05674.i, %i.abw             ; 3 uses
  %i.aby = add nsw i32 %i.abx, %.05773.i          ; 2 uses
  %i.abz = getelementptr inbounds nuw i8, ptr %i.abt, i64 24
  store i32 %i.aby, ptr %i.abz, align 8
  %.not79.i = icmp eq i64 %indvars.iv.i365, 0
  br i1 %.not79.i, label %bb.cn, label %bb.cl

bb.cl:                                            ; preds = %.lr.ph76.split.i
  %i.aca = sext i32 %.05773.i to i64
  %i.acb = getelementptr inbounds [8 x i8], ptr %i.aam, i64 %i.aca ; 2 uses
  %spec.select.i366 = tail call i32 @llvm.smin.i32(i32 %i.abx, i32 %i.aav) ; 2 uses
  %i.acc = load i32, ptr %i.acb, align 4          ; 2 uses
  %.not65.i = icmp slt i32 %spec.select.i366, 1
  br i1 %.not65.i, label %._crit_edge.i369, label %.lr.ph.i367

.lr.ph.i367:                                      ; preds = %bb.cl, %bb.cm
  %i.acd = phi i32 [ %i.acj, %bb.cm ], [ %i.acc, %bb.cl ] ; 2 uses
  %.069.i = phi ptr [ %i.ace, %bb.cm ], [ %i.acb, %bb.cl ]
  %.05268.i = phi i32 [ %spec.select64.i, %bb.cm ], [ 0, %bb.cl ] ; 2 uses
  %.05367.i = phi i32 [ %i.aci, %bb.cm ], [ 1, %bb.cl ] ; 3 uses
  %i.ace = getelementptr inbounds nuw i8, ptr %.069.i, i64 8 ; 2 uses
  %i.acf = load i32, ptr %i.ace, align 4          ; 3 uses
  %i.acg = icmp sgt i32 %i.acf, %i.acc
  br i1 %i.acg, label %._crit_edge.i369, label %bb.cm

bb.cm:                                            ; preds = %.lr.ph.i367
  %i.ach = icmp slt i32 %i.acf, %i.acd
  %spec.select64.i = select i1 %i.ach, i32 %.05367.i, i32 %.05268.i ; 2 uses
  %i.aci = add nuw nsw i32 %.05367.i, 1
  %.not.not.i368 = icmp slt i32 %.05367.i, %spec.select.i366
  %i.acj = tail call i32 @llvm.smin.i32(i32 %i.acf, i32 %i.acd)
  br i1 %.not.not.i368, label %.lr.ph.i367, label %._crit_edge.i369

._crit_edge.i369:                                 ; preds = %bb.cm, %.lr.ph.i367, %bb.cl
  %.052.lcssa.i = phi i32 [ 0, %bb.cl ], [ %spec.select64.i, %bb.cm ], [ %.05268.i, %.lr.ph.i367 ] ; 2 uses
  %i.ack = getelementptr i8, ptr %i.abt, i64 -96  ; 2 uses
  %i.acl = load i32, ptr %i.ack, align 8
  %i.acm = add nsw i32 %i.acl, %.052.lcssa.i
  store i32 %i.acm, ptr %i.ack, align 8
  %i.acn = add nsw i32 %.052.lcssa.i, %.05773.i
  store i32 %i.acn, ptr %i.abu, align 4
  br label %bb.cn

bb.cn:                                            ; preds = %._crit_edge.i369, %.lr.ph76.split.i
  %i.aco = sub nsw i32 %.05674.i, %i.abx
  %i.acp = getelementptr inbounds nuw i8, ptr %i.abt, i64 28
  store i32 %i.aaw, ptr %i.acp, align 4
  %i.acq = getelementptr inbounds nuw i8, ptr %i.abt, i64 32
  store i32 %i.aax, ptr %i.acq, align 8
...
.lr.ph76.split.us.i.epil.preheader:               ; preds = %.loopexit.loopexit.unr-lcssa, %.lr.ph76.split.us.i.preheader
  ...
  %.05674.us.i.epil.init = phi i32 [ %i.aau, %.lr.ph76.split.us.i.preheader ], [ %i.abq, %.loopexit.loopexit.unr-lcssa ]
  %.05773.us.i.epil.init = phi i32 [ 0, %.lr.ph76.split.us.i.preheader ], [ %i.abo, %.loopexit.loopexit.unr-lcssa ] ; 2 uses
  %lcmp.mod204 = trunc i32 %i.aak to i1
  tail call void @llvm.assume(i1 %lcmp.mod204)
  %i.acr = getelementptr inbounds nuw [120 x i8], ptr %i.aai, i64 %indvars.iv83.i.epil.init ; 4 uses
  %i.acs = getelementptr inbounds nuw i8, ptr %i.acr, i64 20
  store i32 %.05773.us.i.epil.init, ptr %i.acs, align 4
  %i.act = trunc i64 %indvars.iv83.i.epil.init to i32
  %i.acu = sub i32 %i.aak, %i.act
  %i.acv = sdiv i32 %.05674.us.i.epil.init, %i.acu
  %i.acw = add nsw i32 %i.acv, %.05773.us.i.epil.init
  %i.acx = getelementptr inbounds nuw i8, ptr %i.acr, i64 24
  store i32 %i.acw, ptr %i.acx, align 8
  %i.acy = getelementptr inbounds nuw i8, ptr %i.acr, i64 28
  store i32 %i.aaw, ptr %i.acy, align 4
  %i.acz = getelementptr inbounds nuw i8, ptr %i.acr, i64 32
  store i32 %i.aax, ptr %i.acz, align 8
  br label %.loopexit

.loopexit:                                        ; preds = %bb.cn, %.lr.ph76.split.us.i.epil.preheader, %.loopexit.loopexit.unr-lcssa, %stbir_simd_memcpy.exit360
  %i.ada = getelementptr inbounds nuw i8, ptr %i.ex, i64 276
  %i.adb = load i32, ptr %i.ada, align 4          ; 2 uses
  %i.adc = getelementptr inbounds nuw i8, ptr %i.ex, i64 332
  %i.add = load i32, ptr %i.aal, align 8
  %.not334 = icmp eq i32 %i.add, 0
  %i.ade = tail call i32 @llvm.smin.i32(i32 %i.adb, i32 %.0.lcssa.i)
  %spec.store.select = select i1 %.not334, i32 %i.ade, i32 %i.adb
  store i32 %spec.store.select, ptr %i.adc, align 4
  br label %.thread15

.thread13:                                        ; preds = %bb.at
  %i.adf = add i64 %.3294.in, 15                  ; 2 uses
  %i.adg = tail call noalias ptr @malloc(i64 noundef %i.adf) #53 ; 2 uses
  %i.adh = icmp eq ptr %i.adg, null
  br i1 %i.adh, label %.thread15, label %bb.q
