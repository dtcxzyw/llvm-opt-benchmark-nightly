...
bb.al:                                            ; preds = %bb.ak
  ...
  %i.kz = load <2 x float>, ptr %i.cg, align 8    ; 8 uses
  %i.la = load float, ptr %i.ck, align 4          ; 4 uses
  %i.lb = load float, ptr %i.cl, align 4          ; 5 uses
  ...
  %i.ml = insertelement <2 x float> %i.kx, float %i.lb, i64 0
  ...
  %i.mr = insertelement <2 x float> %i.kz, float %i.lc, i64 0
  ...
  %i.ns = insertelement <2 x float> %i.kz, float %i.nr, i64 0
  ...
  %17 = insertelement <2 x float> poison, float %i.lb, i64 0
  %i.ow = insertelement <2 x float> %17, float %i.op, i64 1
...
QuaternionSlerp.exit:                             ; preds = %bb.g, %bb.i, %bb.k, %bb.l
  ...
  %i.ev = load float, ptr %i.ak, align 4          ; 2 uses
  ...
  %i.ji = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.ev, i64 0
  %i.jj = insertelement <2 x float> %i.fy, float %i.ga, i64 0
  %i.jk = shufflevector <4 x float> %i.ff, <4 x float> poison, <3 x i32> <i32 3, i32 poison, i32 poison> ; 2 uses
  %i.jl = shufflevector <3 x float> %i.jk, <3 x float> <float poison, float 0.000000e+00, float 0.000000e+00>, <3 x i32> <i32 0, i32 4, i32 5> ; 3 uses
  ...
  %i.jv = shufflevector <3 x float> %i.jk, <3 x float> %i.hz, <3 x i32> <i32 0, i32 3, i32 4>
  ...
  %3 = insertelement <3 x float> poison, float %i.ev, i64 0
  %i.kb = shufflevector <3 x float> %3, <3 x float> poison, <3 x i32> zeroinitializer
...
bb.g:                                             ; preds = %bb.f
  ...
  %.sroa.17193.0.copyload = load float, ptr %.sroa.17193.0..sroa_idx, align 4 ; 5 uses
  ...
  %i.cy = insertelement <2 x float> %i.cx, float %.sroa.17193.0.copyload, i64 1
  %i.cz = fmul <2 x float> %i.cy, %i.cw
  %i.da = shufflevector <4 x float> %i.bq, <4 x float> poison, <2 x i32> <i32 0, i32 2>
  %i.db = insertelement <2 x float> poison, float %.sroa.16192.0.copyload, i64 0 ; 2 uses
  %i.dc = insertelement <2 x float> %i.db, float %.sroa.18194.0.copyload, i64 1
  ...
  %i.ei = insertelement <2 x float> %i.db, float %i.eh, i64 1
  ...
  %1 = insertelement <2 x float> poison, float %i.dz, i64 0
  %i.fo = insertelement <2 x float> %1, float %.sroa.17193.0.copyload, i64 1
...
QuaternionSlerp.exit288:                          ; preds = %QuaternionSlerp.exit229, %bb.s, %bb.u, %bb.v
  ...
  %i.ku = load float, ptr %i.he, align 4          ; 2 uses
  ...
  %i.pg = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.ku, i64 0
  %i.ph = insertelement <2 x float> %i.lw, float %i.ly, i64 0
  %i.pi = shufflevector <4 x float> %i.ld, <4 x float> poison, <3 x i32> <i32 3, i32 poison, i32 poison> ; 2 uses
  %i.pj = shufflevector <3 x float> %i.pi, <3 x float> <float poison, float 0.000000e+00, float 0.000000e+00>, <3 x i32> <i32 0, i32 4, i32 5> ; 3 uses
  ...
  %i.pt = shufflevector <3 x float> %i.pi, <3 x float> %i.nx, <3 x i32> <i32 0, i32 3, i32 4>
  ...
  %6 = insertelement <3 x float> poison, float %i.ku, i64 0
  %i.pz = shufflevector <3 x float> %6, <3 x float> poison, <3 x i32> zeroinitializer
