...
begin_hunk_0_@cgltf_parse_json_root:bb.a
...
bb.hk:                                            ; preds = %bb.hj
  ...
  %i.axy = call ptr %i.axv(ptr noundef %i.axw, i64 noundef %i.axx) #54, !inline_history !229 ; 3 uses
...
bb.ht:                                            ; preds = %bb.hs
  ...
  %i.azb = call ptr %i.ayy(ptr noundef %i.ayz, i64 noundef %i.aza) #54, !inline_history !230 ; 3 uses
...
bb.sd:                                            ; preds = %bb.sc
  ...
  %i.dns = call ptr %i.dnp(ptr noundef %i.dnq, i64 noundef %i.dnr) #54, !inline_history !243 ; 3 uses
...
bb.up:                                            ; preds = %bb.uo
  ...
  %i.ebm = call ptr %i.ebj(ptr noundef %i.ebk, i64 noundef %i.ebl) #54, !inline_history !250 ; 3 uses
...
bb.vw:                                            ; preds = %bb.vv
  ...
  %i.eib = call ptr %i.ehy(ptr noundef %i.ehz, i64 noundef %i.eia) #54, !inline_history !251 ; 3 uses
...
end_hunk_3
begin_hunk_4_@cgltf_parse_json_nodes:bb.a
...
bb.av:                                            ; preds = %bb.au
  ...
  %i.qv = call ptr %i.qs(ptr noundef %i.qt, i64 noundef %i.qu) #54, !inline_history !265 ; 3 uses
...
end_hunk_4
begin_hunk_5_@cgltf_parse_json_lights:bb.a
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %i.jh = add i64 %i.je, 1
  %i.ji = call ptr %i.jf(ptr noundef %i.jg, i64 noundef %i.jh) #54, !inline_history !279 ; 3 uses
...
end_hunk_5
begin_hunk_6_@cgltf_parse_json_meshopt_compression:bb.a
...
end_hunk_6
begin_hunk_7_@cgltf_parse_json_anisotropy:bb.a
...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge, label %.lr.ph.epil, !llvm.loop !282
