...
.lr.ph836:                                        ; preds = %bb.j
  ...
  %8 = sub nsw i64 %.0537.idx, %i.ao              ; 2 uses
  ...
  %xtraiter1647.a = and i32 %4, 7                 ; 3 uses
  %i.cm = icmp ult i32 %4, 8
  %unroll_iter = and i32 %4, -8
  %lcmp.mod1648.not.a = icmp eq i32 %xtraiter1647.a, 0
  %lcmp.mod1649 = icmp ne i32 %xtraiter1647.a, 0
  br label %bb.k
...
bb.k:                                             ; preds = %.lr.ph836, %.loopexit734
  ...
  %i.cn = load ptr, ptr %i.u, align 8             ; 10 uses
  %i.co = ptrtoaddr ptr %i.cn to i64              ; 4 uses
  %i.cp = trunc i64 %indvars.iv974 to i32
  %i.cq = mul i32 %i.e, %i.cp
  %i.cr = zext i32 %i.cq to i64                   ; 12 uses
  %i.cs = getelementptr inbounds nuw i8, ptr %i.cn, i64 %i.cr ; 5 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %.0537 = getelementptr inbounds nuw i8, ptr %i.cs, i64 %.0537.idx ; 3 uses
  %i.cw = getelementptr inbounds i8, ptr %.0537, i64 %i.ap ; 4 uses
...
bb.ad:                                            ; preds = %._crit_edge991, %bb.ac, %bb.y
  %.sink1041 = phi i64 [ %i.at, %._crit_edge991 ], [ 1, %bb.ac ], [ %i.av, %bb.y ] ; 11 uses
  ...
  %i.eh = getelementptr inbounds i8, ptr %i.cw, i64 %.sink1041 ; 21 uses
...
.lr.ph820.preheader:                              ; preds = %vector.memcheck1232, %iter.check1251, %vec.epilog.iter.check1253, %vec.epilog.middle.block1262
  ...
  %xtraiter1650.a = and i64 %wide.trip.count947, 1
  %lcmp.mod1651.not.a = icmp eq i64 %xtraiter1650.a, 0
  br i1 %lcmp.mod1651.not.a, label %.lr.ph820.prol.loopexit, label %.lr.ph820.prol
...
.preheader719.lr.ph:                              ; preds = %.preheader743
  ...
  %scevgep1453 = getelementptr i8, ptr %i.cn, i64 %9
  %i.sr = add nsw i64 %.sink1041, %i.cr           ; 2 uses
  %scevgep1458 = getelementptr i8, ptr %scevgep1453, i64 %i.sr
  %scevgep1459 = getelementptr i8, ptr %i.cn, i64 %i.bx
  %i.ss = add nsw i64 %.sink1041, %wide.trip.count921
  %10 = add nsw i64 %i.ss, %i.cr                  ; 2 uses
  %scevgep1455 = getelementptr i8, ptr %scevgep1459, i64 %10
  %i.st = getelementptr i8, ptr %i.cn, i64 %i.bz
  %scevgep1456 = getelementptr i8, ptr %i.st, i64 %i.sr
  %scevgep1457 = getelementptr i8, ptr %i.cn, i64 %i.cb
  %scevgep1458.a = getelementptr i8, ptr %scevgep1457, i64 %10
  ...
  %bound01470 = icmp ult ptr %.1538, %scevgep1455
  %bound11471 = icmp ult ptr %scevgep1458, %scevgep1448
  %found.conflict1472 = and i1 %bound01470, %bound11471
  %conflict.rdx1475 = or i1 %found.conflict1472, %conflict.rdx1469
  %bound01476 = icmp ult ptr %.1538, %scevgep1458.a
...
.preheader718.lr.ph:                              ; preds = %.preheader741
  ...
  %11 = getelementptr i8, ptr %.1580, i64 %i.ta
  %scevgep1393 = getelementptr i8, ptr %11, i64 %wide.trip.count926
  %scevgep1394 = getelementptr i8, ptr %i.cn, i64 %8
  %i.tb = getelementptr i8, ptr %scevgep1394, i64 %.sink1041
  %scevgep1391 = getelementptr i8, ptr %i.tb, i64 %i.cr
  ...
  %scevgep1393.a = getelementptr i8, ptr %i.td, i64 %i.cr
  %scevgep1394.a = getelementptr i8, ptr %.1538, i64 %i.bo
  ...
  %bound01397 = icmp ult ptr %.1538, %scevgep1393
  ...
  %bound01402 = icmp ult ptr %.1538, %scevgep1393.a
  %bound11403 = icmp ult ptr %scevgep1391, %scevgep1390
  ...
  %bound11409 = icmp ult ptr %scevgep1394.a, %scevgep1390
...
.preheader717.lr.ph:                              ; preds = %.preheader739
  ...
  %12 = getelementptr i8, ptr %.1580, i64 %i.tl
  %scevgep1345 = getelementptr i8, ptr %12, i64 %wide.trip.count931
  %scevgep1346 = getelementptr i8, ptr %i.cn, i64 %8
  %i.tm = getelementptr i8, ptr %scevgep1346, i64 %.sink1041
  %scevgep1345.a = getelementptr i8, ptr %i.tm, i64 %i.cr
  %scevgep1346.a = getelementptr i8, ptr %i.cn, i64 %i.bj
  %i.tn = getelementptr i8, ptr %scevgep1346.a, i64 %.sink1041
  ...
  %bound11354 = icmp ult ptr %scevgep1345.a, %scevgep1344
