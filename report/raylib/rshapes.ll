...
.peel.next92:
  ...
  %i.az = shufflevector <4 x float> %10, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %15 = shufflevector <4 x float> %i.ar, <4 x float> %i.av, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.ba = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %14, <8 x float> %i.az, <8 x float> %15)
  %i.bb = shufflevector <4 x float> %12, <4 x float> %i.ay, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %16 = shufflevector <4 x float> %10, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.bc = shufflevector <4 x float> %i.ar, <4 x float> %i.av, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.bd = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.bb, <8 x float> %16, <8 x float> %i.bc)
  %interleaved.vec = shufflevector <8 x float> %i.ba, <8 x float> %i.bd, <16 x i32> <i32 0, i32 4, i32 8, i32 12, i32 1, i32 5, i32 9, i32 13, i32 2, i32 6, i32 10, i32 14, i32 3, i32 7, i32 11, i32 15>
  ...
  %i.bg = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bf, <4 x float> <float 2.500000e-01, float f0x3E955556, float f0x3EAAAAAB, float 3.750000e-01>, <4 x float> %broadcast.splat114) ; 5 uses
  ...
  %i.bk = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bj, <4 x float> <float 2.500000e-01, float f0x3E955556, float f0x3EAAAAAB, float 3.750000e-01>, <4 x float> %broadcast.splat122) ; 5 uses
  ...
  %17 = fmul <4 x float> %i.bm, %i.bm
  %18 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bn, <4 x float> %i.bn, <4 x float> %17)
  %19 = tail call <4 x float> @llvm.sqrt.v4f32(<4 x float> %18)
  %20 = fdiv <4 x float> %broadcast.splat124, %19 ; 2 uses
  %21 = fneg <4 x float> %i.bn
  %22 = fneg <4 x float> %i.bm
  %23 = getelementptr inbounds nuw i8, ptr %6, i64 96
  %24 = shufflevector <4 x float> %i.bm, <4 x float> %21, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.bo = shufflevector <4 x float> %20, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %25 = shufflevector <4 x float> %i.bg, <4 x float> %i.bk, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.bp = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %24, <8 x float> %i.bo, <8 x float> %25)
  %i.bq = shufflevector <4 x float> %22, <4 x float> %i.bn, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %26 = shufflevector <4 x float> %20, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.br = shufflevector <4 x float> %i.bg, <4 x float> %i.bk, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.bs = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.bq, <8 x float> %26, <8 x float> %i.br)
  %interleaved.vec.1 = shufflevector <8 x float> %i.bp, <8 x float> %i.bs, <16 x i32> <i32 0, i32 4, i32 8, i32 12, i32 1, i32 5, i32 9, i32 13, i32 2, i32 6, i32 10, i32 14, i32 3, i32 7, i32 11, i32 15>
  store <16 x float> %interleaved.vec.1, ptr %23, align 16
  ...
  %i.bv = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bu, <4 x float> <float f0x3ED55556, float f0x3EEAAAAB, float 5.000000e-01, float f0x3F0AAAAB>, <4 x float> %broadcast.splat114) ; 5 uses
  ...
  %i.bz = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.by, <4 x float> <float f0x3ED55556, float f0x3EEAAAAB, float 5.000000e-01, float f0x3F0AAAAB>, <4 x float> %broadcast.splat122) ; 5 uses
  ...
  %27 = fmul <4 x float> %i.cb, %i.cb
  %28 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.cc, <4 x float> %i.cc, <4 x float> %27)
  %29 = tail call <4 x float> @llvm.sqrt.v4f32(<4 x float> %28)
  %30 = fdiv <4 x float> %broadcast.splat124, %29 ; 2 uses
  ...
  %i.cd = shufflevector <4 x float> %30, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %35 = shufflevector <4 x float> %i.bv, <4 x float> %i.bz, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.ce = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %34, <8 x float> %i.cd, <8 x float> %35)
  %i.cf = shufflevector <4 x float> %32, <4 x float> %i.cc, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %36 = shufflevector <4 x float> %30, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.cg = shufflevector <4 x float> %i.bv, <4 x float> %i.bz, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.ch = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.cf, <8 x float> %36, <8 x float> %i.cg)
  %interleaved.vec.2 = shufflevector <8 x float> %i.ce, <8 x float> %i.ch, <16 x i32> <i32 0, i32 4, i32 8, i32 12, i32 1, i32 5, i32 9, i32 13, i32 2, i32 6, i32 10, i32 14, i32 3, i32 7, i32 11, i32 15>
  ...
  %i.ck = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.cj, <4 x float> <float f0x3F155556, float 6.250000e-01, float f0x3F2AAAAB, float f0x3F355556>, <4 x float> %broadcast.splat114) ; 5 uses
  ...
  %i.co = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.cn, <4 x float> <float f0x3F155556, float 6.250000e-01, float f0x3F2AAAAB, float f0x3F355556>, <4 x float> %broadcast.splat122) ; 5 uses
  ...
  %37 = fmul <4 x float> %i.cq, %i.cq
  %38 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.cr, <4 x float> %i.cr, <4 x float> %37)
  %39 = tail call <4 x float> @llvm.sqrt.v4f32(<4 x float> %38)
  %40 = fdiv <4 x float> %broadcast.splat124, %39 ; 2 uses
  %41 = fneg <4 x float> %i.cr
  %42 = fneg <4 x float> %i.cq
  %43 = getelementptr inbounds nuw i8, ptr %6, i64 224
  %44 = shufflevector <4 x float> %i.cq, <4 x float> %41, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.cs = shufflevector <4 x float> %40, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %45 = shufflevector <4 x float> %i.ck, <4 x float> %i.co, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.ct = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %44, <8 x float> %i.cs, <8 x float> %45)
  %i.cu = shufflevector <4 x float> %42, <4 x float> %i.cr, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %46 = shufflevector <4 x float> %40, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.cv = shufflevector <4 x float> %i.ck, <4 x float> %i.co, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.cw = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.cu, <8 x float> %46, <8 x float> %i.cv)
  %interleaved.vec.3 = shufflevector <8 x float> %i.ct, <8 x float> %i.cw, <16 x i32> <i32 0, i32 4, i32 8, i32 12, i32 1, i32 5, i32 9, i32 13, i32 2, i32 6, i32 10, i32 14, i32 3, i32 7, i32 11, i32 15>
  store <16 x float> %interleaved.vec.3, ptr %43, align 16
  ...
  %i.cz = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.cy, <4 x float> <float 7.500000e-01, float f0x3F4AAAAB, float f0x3F555556, float 8.750000e-01>, <4 x float> %broadcast.splat114) ; 5 uses
  ...
  %i.dd = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.dc, <4 x float> <float 7.500000e-01, float f0x3F4AAAAB, float f0x3F555556, float 8.750000e-01>, <4 x float> %broadcast.splat122) ; 5 uses
  ...
  %47 = fmul <4 x float> %i.df, %i.df
  %48 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.dg, <4 x float> %i.dg, <4 x float> %47)
  %49 = tail call <4 x float> @llvm.sqrt.v4f32(<4 x float> %48)
  %50 = fdiv <4 x float> %broadcast.splat124, %49 ; 2 uses
  %51 = fneg <4 x float> %i.dg
  %52 = fneg <4 x float> %i.df
  %53 = getelementptr inbounds nuw i8, ptr %6, i64 288
  %54 = shufflevector <4 x float> %i.df, <4 x float> %51, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.dh = shufflevector <4 x float> %50, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %55 = shufflevector <4 x float> %i.cz, <4 x float> %i.dd, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.di = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %54, <8 x float> %i.dh, <8 x float> %55)
  %i.dj = shufflevector <4 x float> %52, <4 x float> %i.dg, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %56 = shufflevector <4 x float> %50, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.dk = shufflevector <4 x float> %i.cz, <4 x float> %i.dd, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.dl = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.dj, <8 x float> %56, <8 x float> %i.dk)
  %interleaved.vec.4 = shufflevector <8 x float> %i.di, <8 x float> %i.dl, <16 x i32> <i32 0, i32 4, i32 8, i32 12, i32 1, i32 5, i32 9, i32 13, i32 2, i32 6, i32 10, i32 14, i32 3, i32 7, i32 11, i32 15>
  store <16 x float> %interleaved.vec.4, ptr %53, align 16
