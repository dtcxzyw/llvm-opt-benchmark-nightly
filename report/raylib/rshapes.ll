...
bb.a:
  ...
  %i.b = fmul <2 x float> %9, %i.a
  %10 = shufflevector <2 x float> %foldExtExtBinop60, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %11 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %10, <2 x float> %6, <2 x float> %i.b) ; 2 uses
  ...
  %i.c = insertelement <2 x float> %11, float %15, i64 1
  %16 = shufflevector <2 x float> %11, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.d = fdiv <2 x float> %i.c, %16               ; 2 uses
