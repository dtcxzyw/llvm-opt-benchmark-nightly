...
bb.e:                                             ; preds = %.peel.next, %bb.e
  ...
  %i.bj = trunc nuw nsw i64 %indvars.iv to i32
  %i.bk = uitofp nneg i32 %i.bj to float
  %i.bl = fdiv float %i.bk, 2.400000e+01          ; 4 uses
  %i.bm = fneg float %i.bl
  %5 = insertelement <4 x float> poison, float %i.bm, i64 0
  %6 = insertelement <4 x float> %5, float %i.bl, i64 1 ; 4 uses
  %7 = shufflevector <4 x float> %6, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
  %8 = fmul <4 x float> %7, <float 1.000000e+00, float 3.000000e+00, float -3.000000e+00, float 1.000000e+00>
  %9 = shufflevector <4 x float> %6, <4 x float> <float poison, float poison, float poison, float 1.000000e+00>, <4 x i32> <i32 1, i32 1, i32 1, i32 7>
  %10 = fmul nnan <4 x float> %9, <float 2.000000e+00, float -5.000000e+00, float 4.000000e+00, float 1.000000e+00>
  %11 = shufflevector <4 x float> %6, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1> ; 2 uses
  %12 = fmul <4 x float> %11, %8                  ; 2 uses
  %13 = fneg <4 x float> %12
  %14 = shufflevector <4 x float> %6, <4 x float> %13, <4 x i32> <i32 1, i32 1, i32 1, i32 7>
  %15 = fmul <4 x float> %14, %10
  %16 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %12, <4 x float> %11, <4 x float> %15) ; 3 uses
  %17 = extractelement <4 x float> %16, i64 0
  %18 = fsub float %17, %i.bl
  %19 = insertelement <2 x float> <float 2.000000e+00, float poison>, float %i.bl, i64 1
  %20 = shufflevector <4 x float> %16, <4 x float> poison, <2 x i32> <i32 1, i32 2>
  %21 = fadd <2 x float> %19, %20                 ; 2 uses
  %.idx = shl nuw nsw i64 %indvars.iv, 4
  %22 = getelementptr inbounds nuw i8, ptr %4, i64 %.idx
  %23 = shufflevector <2 x float> %21, <2 x float> poison, <2 x i32> zeroinitializer
  %i.bn = fmul <2 x float> %i.o, %23
  %i.bo = insertelement <2 x float> poison, float %18, i64 0
  ...
  %25 = shufflevector <4 x float> %16, <4 x float> poison, <2 x i32> <i32 3, i32 3>
  %i.bs = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.q, <2 x float> %25, <2 x float> %i.br)
  ...
  store <4 x float> %i.ci, ptr %22, align 16
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, 25
...
bb.a:                                             ; preds = %.peel.next, %bb.a
  ...
  %7 = fmul float %i.ah, 3.000000e+00
  %8 = fmul float %i.ae, %7
  %9 = fmul nnan float %i.af, 3.000000e+00
  %10 = tail call float @powf(float noundef %i.ae, float noundef 2.000000e+00) #14
  %11 = fmul float %9, %10
  %12 = tail call float @powf(float noundef %i.ae, float noundef 3.000000e+00) #14
  %.idx = shl nuw nsw i64 %indvars.iv, 4
  %13 = getelementptr inbounds nuw i8, ptr %6, i64 %.idx
  %i.ai = insertelement <2 x float> poison, float %8, i64 0
  %14 = shufflevector <2 x float> %i.ai, <2 x float> poison, <2 x i32> zeroinitializer
  %i.aj = fmul <2 x float> %1, %14
  ...
  %i.an = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ao = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.an, <2 x float> %2, <2 x float> %i.am)
  %i.ap = insertelement <2 x float> poison, float %12, i64 0
  ...
  store <4 x float> %i.bd, ptr %13, align 16
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, 25
...
bb.a:
  %i.a = fneg float %4
  %5 = insertelement <4 x float> poison, float %i.a, i64 0
  %6 = insertelement <4 x float> %5, float %4, i64 1 ; 4 uses
  %7 = shufflevector <4 x float> %6, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
  %8 = fmul <4 x float> %7, <float 1.000000e+00, float 3.000000e+00, float -3.000000e+00, float 1.000000e+00>
  %9 = shufflevector <4 x float> %6, <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, <4 x i32> <i32 1, i32 1, i32 1, i32 5>
  %10 = fmul <4 x float> %9, <float 2.000000e+00, float -5.000000e+00, float 4.000000e+00, float 1.000000e+00>
  %11 = shufflevector <4 x float> %6, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1> ; 2 uses
  %12 = fmul <4 x float> %11, %8                  ; 2 uses
  %13 = fneg <4 x float> %12
  %14 = shufflevector <4 x float> %6, <4 x float> %13, <4 x i32> <i32 1, i32 1, i32 1, i32 7>
  ...
  %17 = extractelement <4 x float> %16, i64 0
  %18 = fsub float %17, %4
  %19 = shufflevector <4 x float> %16, <4 x float> poison, <2 x i32> <i32 1, i32 2>
  %i.b = insertelement <2 x float> <float 2.000000e+00, float poison>, float %4, i64 1
  %i.c = fadd <2 x float> %19, %i.b               ; 2 uses
  %20 = shufflevector <2 x float> %i.c, <2 x float> poison, <2 x i32> zeroinitializer
  %i.d = fmul <2 x float> %1, %20
  %i.e = insertelement <2 x float> poison, float %18, i64 0
  %i.f = shufflevector <2 x float> %i.e, <2 x float> poison, <2 x i32> zeroinitializer
  %i.g = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %0, <2 x float> %i.f, <2 x float> %i.d)
  %21 = shufflevector <2 x float> %i.c, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.h = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %2, <2 x float> %21, <2 x float> %i.g)
  %22 = shufflevector <4 x float> %16, <4 x float> poison, <2 x i32> <i32 3, i32 3>
  %i.i = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %3, <2 x float> %22, <2 x float> %i.h)
...
bb.a:
  ...
  %5 = fmul float %i.c, 3.000000e+00
  %6 = fmul float %4, %5
  %7 = fmul float %i.a, 3.000000e+00
  %8 = tail call float @powf(float noundef %4, float noundef 2.000000e+00) #14
  %9 = fmul float %7, %8
  %10 = tail call float @powf(float noundef %4, float noundef 3.000000e+00) #14
  %i.d = insertelement <2 x float> poison, float %6, i64 0
  %11 = shufflevector <2 x float> %i.d, <2 x float> poison, <2 x i32> zeroinitializer
  %i.e = fmul <2 x float> %1, %11
  ...
  %i.i = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> zeroinitializer
  %i.j = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.i, <2 x float> %2, <2 x float> %i.h)
  %i.k = insertelement <2 x float> poison, float %10, i64 0
...
bb.a:
  ...
  %4 = shufflevector <2 x float> %0, <2 x float> %1, <2 x i32> <i32 0, i32 2>
  %5 = shufflevector <2 x float> %3, <2 x float> poison, <2 x i32> zeroinitializer
  %i.a = fsub <2 x float> %4, %5                  ; 3 uses
  %6 = shufflevector <2 x float> %0, <2 x float> %1, <2 x i32> <i32 1, i32 3>
  %7 = shufflevector <2 x float> %3, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.b = fsub <2 x float> %6, %7                  ; 2 uses
  %8 = shufflevector <2 x float> %foldExtExtBinop, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %9 = shufflevector <2 x float> %2, <2 x float> %1, <2 x i32> <i32 0, i32 3>
  %10 = fsub <2 x float> %3, %9                   ; 2 uses
  %11 = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer
  %12 = fmul <2 x float> %11, %i.b
  %13 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %8, <2 x float> %i.a, <2 x float> %12) ; 2 uses
  %shift = shufflevector <2 x float> %i.a, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop60 = fmul <2 x float> %shift, %i.b
  %14 = extractelement <2 x float> %foldExtExtBinop60, i64 0
  %15 = extractelement <2 x float> %i.a, i64 0
  %16 = extractelement <2 x float> %10, i64 1
  %17 = tail call float @llvm.fmuladd.f32(float %16, float %15, float %14)
  %i.c = insertelement <2 x float> %13, float %17, i64 1
  %18 = shufflevector <2 x float> %13, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.d = fdiv <2 x float> %i.c, %18               ; 2 uses
  %i.e = extractelement <2 x float> %i.d, i64 0   ; 2 uses
  %i.f = fsub float 1.000000e+00, %i.e
  %i.g = fcmp ogt float %i.e, 0.000000e+00
  %i.h = extractelement <2 x float> %i.d, i64 1   ; 2 uses
