...
bb.a:
  ...
  %foldExtExtBinop60.a = fmul <2 x float> %8, %foldExtExtBinop
  %10 = extractelement <2 x float> %foldExtExtBinop60.a, i64 1
  ...
  %i.b = insertelement <2 x float> poison, float %13, i64 0
  %19 = shufflevector <2 x float> %i.b, <2 x float> poison, <2 x i32> zeroinitializer
  %i.c = fdiv <2 x float> %18, %19                ; 2 uses
  %i.d = extractelement <2 x float> %i.c, i64 1   ; 2 uses
  %i.e = fsub float 1.000000e+00, %i.d
  %i.f = fcmp ogt float %i.d, 0.000000e+00
  %i.g = extractelement <2 x float> %i.c, i64 0   ; 2 uses
