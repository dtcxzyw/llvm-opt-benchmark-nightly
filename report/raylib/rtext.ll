...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.kk = shl nuw i64 %index381, 1
  %i.kl = getelementptr inbounds nuw i8, ptr %i.jx, i64 %i.kk
  %i.km = getelementptr inbounds nuw i8, ptr %.pre332, i64 %index381
  %wide.load382 = load <4 x i8>, ptr %i.km, align 1, !alias.scope !52
  ...
  store <8 x i8> %interleaved.vec383, ptr %i.kl, align 1, !alias.scope !55, !noalias !52
  %index.next384 = add nuw i64 %index381, 4       ; 2 uses
  %i.kn = icmp eq i64 %index.next384, %n.vec380
...
vec.epilog.scalar.ph.preheader:                   ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv323.ph = phi i64 [ 0, %iter.check ], [ 0, %vector.memcheck ], [ %n.vec371, %vec.epilog.iter.check ], [ %n.vec380, %vec.epilog.middle.block ] ; 3 uses
