...
bb.nh:                                            ; preds = %bb.ng
  ...
  %i.bwg = load i16, ptr %i.bwf, align 2          ; 4 uses
  %i.bwh = getelementptr inbounds nuw i8, ptr %i.bwa, i64 6
  %i.bwi = load i16, ptr %i.bwh, align 2          ; 5 uses
  %i.bwj = getelementptr inbounds nuw i8, ptr %i.bwa, i64 2
  %i.bwk = load i16, ptr %i.bwe, align 2          ; 7 uses
  %i.bwl = load i16, ptr %i.bwd, align 2          ; 3 uses
  %i.bwm = sext i16 %i.bwk to i32
  %i.bwn = load i16, ptr %i.bwj, align 2          ; 7 uses
  %i.bwo = load i16, ptr %i.bwa, align 2          ; 3 uses
...
bb.ni:                                            ; preds = %bb.nh
  ...
  %10 = sitofp i16 %i.bwg to float                ; 2 uses
  %11 = sitofp i16 %i.bwi to float                ; 2 uses
  %12 = shufflevector <2 x i16> %i.bxa, <2 x i16> %i.bxb, <2 x i32> <i32 0, i32 2>
  %i.bxc = sitofp <2 x i16> %12 to <2 x float>    ; 4 uses
  %13 = shufflevector <2 x i16> %i.bxa, <2 x i16> %i.bxb, <2 x i32> <i32 1, i32 3>
  %14 = sitofp <2 x i16> %13 to <2 x float>       ; 4 uses
  %15 = icmp ne i16 %i.bwl, %i.bwg
  %16 = icmp ne i16 %i.bwk, %i.bwi
  %narrow.i.not.i.i.us.us.i = or i1 %15, %16
  br i1 %narrow.i.not.i.i.us.us.i, label %bb.nj, label %bb.nk

bb.nj:                                            ; preds = %bb.ni
  %17 = icmp ne i16 %i.bwg, %i.bwo
  %18 = icmp ne i16 %i.bwi, %i.bwn
  %narrow.i182.not.i.i.us.us.i = or i1 %17, %18
...
bb.nn:                                            ; preds = %bb.nm
  ...
  %i.bxq = fsub float %.0150.i.i.us.us.i, %19
  ...
  %20 = extractelement <2 x float> %i.bxc, i64 1
  %i.bxw = call float @llvm.fmuladd.f32(float %i.bxt, float %i.bxv, float %20)
...
.thread21.i.i.i.us.us.i:                          ; preds = %bb.nt, %bb.ns, %bb.np
  ...
  %i.bzh = call <2 x float> @llvm.copysign.v2f32(<2 x float> zeroinitializer, <2 x float> %14)
  %i.bzi = call float @llvm.copysign.f32(float 0.000000e+00, float %11)
  %i.bzj = fadd float %i.bzi, %10
  %i.bzk = fadd <2 x float> %i.bzh, %i.bxc        ; 2 uses
