...
bb.b:                                             ; preds = %bb.a
  ...
  %i.i = call i32 %i.f(ptr noundef %i.g, i64 noundef %i.h, ptr noundef nonnull %1, i32 noundef 1) #17, !inline_history !21 ; 0 uses
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.l = call i32 %i.j(ptr noundef %i.k, i64 noundef 0) #17, !inline_history !22 ; 0 uses
  ...
  %i.v = call i32 %i.p(ptr noundef %i.q, i64 noundef 0, i64 noundef %i.s, i32 noundef 0, i32 noundef 0, i32 noundef 0, i32 noundef 0, i32 noundef %i.t, i32 noundef %i.u) #17, !inline_history !23 ; 0 uses
  ...
  %i.y = call i32 %i.w(ptr noundef %i.x) #17, !inline_history !23 ; 0 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ai = call i32 %i.af(ptr noundef %i.ad, i64 noundef %i.ae, i64 noundef %i.ah) #17, !inline_history !24 ; 0 uses
  br label %updateCursorImage.exit

bb.f:                                             ; preds = %bb.d
  %i.aj = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 138008), align 8
  %i.ak = call i32 %i.aj(ptr noundef %i.ad, i64 noundef %i.ae) #17, !inline_history !24 ; 0 uses
  br label %updateCursorImage.exit
...
bb.g:                                             ; preds = %bb.c
  ...
  %i.ap = call i32 %i.al(ptr noundef %i.am, i64 noundef %i.an, i64 noundef %i.ao) #17, !inline_history !24 ; 0 uses
  br label %updateCursorImage.exit
...
.lr.ph59.preheader.unr-lcssa:                     ; preds = %.lr.ph
  ...
  br i1 %lcmp.mod.not, label %.lr.ph.epil.preheader, label %.lr.ph59.preheader
...
bb.a:
  ...
  %i.e = load i64, ptr %i.d, align 8
  %i.f = call i32 %i.b(ptr noundef %i.c, i64 noundef %i.e, ptr noundef nonnull %3) #17, !inline_history !16 ; 0 uses
...
bb.x:                                             ; preds = %bb.w, %bb.r, %bb.q, %bb.p, %bb.o, %bb.n
  ...
  call void %i.dn(ptr noundef %i.do, ptr noundef nonnull %6) #17, !inline_history !33
  br label %processEvent.exit
...
bb.z:                                             ; preds = %thread-pre-split.i
  ...
  %i.dt = call i32 %i.dp(ptr noundef %i.dq, i64 noundef %i.dr, i32 noundef %i.ds, ptr noundef nonnull %i.e) #17, !inline_history !33
...
bb.ak:                                            ; preds = %bb.aj
  ...
  %i.fi = call i32 %i.fe(ptr noundef %i.fh, ptr noundef nonnull %6, ptr noundef nonnull %i.g, i32 noundef 99, ptr noundef null, ptr noundef nonnull %i.f) #17, !inline_history !33 ; 3 uses
...
bb.al:                                            ; preds = %bb.ak
  ...
  %i.fs = call i32 %i.fo(ptr noundef %i.fr, ptr noundef nonnull %6, ptr noundef %i.fn, i32 noundef %i.fi, ptr noundef null, ptr noundef nonnull %i.f) #17, !inline_history !33
...
bb.fb:                                            ; preds = %._crit_edge
  ...
  %i.tu = call i32 %i.tr(ptr noundef nonnull %.lcssa18, i64 noundef %i.tt, ptr noundef nonnull %0) #17, !inline_history !25 ; 0 uses
...
bb.fd:                                            ; preds = %._crit_edge22, %bb.fc
  ...
  %i.uk = call i32 %i.uh(ptr noundef %i.ui, i64 noundef 0, i64 noundef %i.uj, i32 noundef 0, i32 noundef 0, i32 noundef 0, i32 noundef 0, i32 noundef %i.ub, i32 noundef %.pre-phi) #17, !inline_history !23 ; 0 uses
  ...
  %i.un = call i32 %i.ul(ptr noundef %i.um) #17, !inline_history !23 ; 0 uses
  br label %bb.fe
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.p = tail call i32 %i.o(ptr noundef nonnull %i.a) #17, !inline_history !36
...
.preheader.1.i:                                   ; preds = %.lr.ph.i
  ...
  %.not10.i = trunc i16 %1 to i1
  %i.r = load i16, ptr %i.l, align 2
  %.not10.1.i = trunc i16 %i.r to i1
  %or.cond.i = select i1 %.not10.i, i1 true, i1 %.not10.1.i
...
.critedge.loopexit.i:                             ; preds = %.preheader.1.i
  ...
  %i.u = call i32 %i.s(ptr noundef %i.t) #17, !inline_history !36
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.q = tail call i32 %i.p(ptr noundef nonnull %i.b) #17, !inline_history !36
...
.preheader.1.i:                                   ; preds = %.lr.ph.i
  ...
  %.not10.i = trunc i16 %2 to i1
  %i.s = load i16, ptr %i.m, align 2
  %.not10.1.i = trunc i16 %i.s to i1
  %or.cond.i = select i1 %.not10.i, i1 true, i1 %.not10.1.i
  br i1 %or.cond.i, label %waitForAnyEvent.exit, label %.critedge.loopexit.i
...
.critedge.loopexit.i:                             ; preds = %.preheader.1.i
  ...
  %i.v = call i32 %i.t(ptr noundef %i.u) #17, !inline_history !36
...
bb.a:
  ...
  %i.n = call i32 %i.l(ptr noundef %i.m, ptr noundef nonnull %i.j, ptr noundef nonnull %i.k) #17, !inline_history !37 ; 0 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.t = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_glfw, i64 133888), align 8
  %i.u = call i32 %i.s(ptr noundef %i.t, i64 noundef %i.p, ptr noundef nonnull %i.c, ptr noundef nonnull %i.d, ptr noundef nonnull %i.e, ptr noundef nonnull %i.f, ptr noundef nonnull %i.g, ptr noundef nonnull %i.h, ptr noundef nonnull %i.i) #17, !inline_history !38 ; 0 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ah = call i32 %i.ae(ptr noundef %i.af, i64 noundef %i.ag, ptr noundef nonnull %3, i32 noundef 1) #17, !inline_history !32 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #17
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #17
  br label %.thread
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.ar = call i32 %i.ao(ptr noundef %i.ap, i64 noundef %i.aq, ptr noundef nonnull %2, i32 noundef 1) #17, !inline_history !21 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #17
