...
bb.g:                                             ; preds = %.lr.ph, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit126
  %i.ae = phi ptr [ %i.r, %.lr.ph ], [ %i.gx, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit126 ] ; 2 uses
  %i.af = phi ptr [ %i.l, %.lr.ph ], [ %.pre174, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit126 ] ; 3 uses
  %i.ag = phi ptr [ %i.l, %.lr.ph ], [ %i.gy, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit126 ] ; 3 uses
  %i.ah = phi ptr [ %i.l, %.lr.ph ], [ %i.gz, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit126 ] ; 3 uses
  %i.ai = phi ptr [ %i.l, %.lr.ph ], [ %i.ha, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit126 ] ; 3 uses
  %i.aj = phi ptr [ %i.r, %.lr.ph ], [ %i.hb, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit126 ] ; 10 uses
  %i.ak = phi ptr [ %i.l, %.lr.ph ], [ %i.hc, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit126 ] ; 5 uses
  %.0171 = phi double [ %i.aa, %.lr.ph ], [ %i.au, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit126 ] ; 3 uses
  %.sroa.0137.0170 = phi ptr [ %i.m, %.lr.ph ], [ %i.hd, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit126 ] ; 13 uses
...
bb.r:                                             ; preds = %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit66
  ...
  %.pre173.a = load ptr, ptr %i.ad, align 8, !tbaa !33 ; 3 uses
...
bb.t:                                             ; preds = %bb.s
  ...
  store ptr %i.dd, ptr %i.b, align 8, !tbaa !19
  br label %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit81

bb.u:                                             ; preds = %bb.s
  %i.de = ptrtoint ptr %i.cv to i64
  %i.df = ptrtoint ptr %i.cu to i64               ; 2 uses
  %i.dg = sub i64 %i.de, %i.df                    ; 5 uses
  %i.dh = icmp eq i64 %i.dg, 9223372036854775800
  br i1 %i.dh, label %.invoke, label %_ZNKSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i71

_ZNKSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i71: ; preds = %bb.u
  %i.di = sdiv exact i64 %i.dg, 24                ; 3 uses
  %.sroa.speculated.i.i.i.i72 = tail call i64 @llvm.umax.i64(i64 %i.di, i64 1)
  %i.dj = add nsw i64 %.sroa.speculated.i.i.i.i72, %i.di ; 2 uses
  %i.dk = icmp ult i64 %i.dj, %i.di
  %i.dl = tail call i64 @llvm.umin.i64(i64 %i.dj, i64 384307168202282325)
  %i.dm = select i1 %i.dk, i64 384307168202282325, i64 %i.dl ; 3 uses
  %.not.i.i.i.i73 = icmp ne i64 %i.dm, 0
  tail call void @llvm.assume(i1 %.not.i.i.i.i73)
  %i.dn = mul nuw nsw i64 %i.dm, 24
  %i.do = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.dn) #11
...
.noexc80:                                         ; preds = %_ZNKSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i71
  ...
  br i1 %i.dq, label %bb.v, label %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i.i76

bb.v:                                             ; preds = %.noexc80
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.do, ptr align 8 %i.cu, i64 %i.dg, i1 false)
...
_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i.i76: ; preds = %bb.v, %.noexc80
  %i.dr = getelementptr inbounds nuw i8, ptr %i.dp, i64 24 ; 2 uses
...
bb.w:                                             ; preds = %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i.i76
  %i.ds = load ptr, ptr %i.ad, align 8, !tbaa !33
  %i.dt = ptrtoint ptr %i.ds to i64
  %i.du = sub i64 %i.dt, %i.df
  tail call void @_ZdlPvm(ptr noundef nonnull %i.cu, i64 noundef %i.du) #12
...
_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i78: ; preds = %bb.w, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i.i76
  store ptr %i.do, ptr %i.a, align 8, !tbaa !20
  store ptr %i.dr, ptr %i.b, align 8, !tbaa !19
  %i.dv = getelementptr inbounds nuw [24 x i8], ptr %i.do, i64 %i.dm ; 2 uses
  store ptr %i.dv, ptr %i.ad, align 8, !tbaa !33
  br label %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit81
...
_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit81:  ; preds = %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i78, %bb.t, %bb.r
  %i.dw = phi ptr [ %i.do, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i78 ], [ %i.cr, %bb.t ], [ %i.cr, %bb.r ]
  %i.dx = phi ptr [ %i.do, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i78 ], [ %i.cs, %bb.t ], [ %i.cs, %bb.r ]
  %i.dy = phi ptr [ %i.dv, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i78 ], [ %.pre173.a, %bb.t ], [ %.pre173.a, %bb.r ] ; 2 uses
  %i.dz = phi ptr [ %i.dr, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i78 ], [ %i.dd, %bb.t ], [ %i.cv, %bb.r ] ; 6 uses
  %i.ea = phi ptr [ %i.do, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i78 ], [ %i.ct, %bb.t ], [ %i.ct, %bb.r ] ; 8 uses
  %i.eb = getelementptr inbounds nuw i8, ptr %.sroa.0137.0170, i64 8
  %i.ec = load double, ptr %i.eb, align 8, !tbaa !21
  %i.ed = fsub double %i.ec, %1
  %i.ee = getelementptr inbounds nuw i8, ptr %.sroa.0137.0170, i64 16
...
bb.x:                                             ; preds = %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit81
  ...
  %i.ej = getelementptr inbounds nuw i8, ptr %i.dz, i64 24 ; 3 uses
  store ptr %i.ej, ptr %i.b, align 8, !tbaa !19
...
bb.y:                                             ; preds = %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit81
  ...
  %i.el = ptrtoint ptr %i.ea to i64               ; 2 uses
  %i.em = sub i64 %i.ek, %i.el                    ; 5 uses
  %i.en = icmp eq i64 %i.em, 9223372036854775800
  br i1 %i.en, label %.invoke, label %_ZNKSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i86

_ZNKSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i86: ; preds = %bb.y
  %i.eo = sdiv exact i64 %i.em, 24                ; 3 uses
  %.sroa.speculated.i.i.i.i87 = tail call i64 @llvm.umax.i64(i64 %i.eo, i64 1)
  %i.ep = add nsw i64 %.sroa.speculated.i.i.i.i87, %i.eo ; 2 uses
  %i.eq = icmp ult i64 %i.ep, %i.eo
  %i.er = tail call i64 @llvm.umin.i64(i64 %i.ep, i64 384307168202282325)
  %i.es = select i1 %i.eq, i64 384307168202282325, i64 %i.er ; 3 uses
  %.not.i.i.i.i88 = icmp ne i64 %i.es, 0
  tail call void @llvm.assume(i1 %.not.i.i.i.i88)
  %i.et = mul nuw nsw i64 %i.es, 24
  %i.eu = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.et) #11
...
.noexc95:                                         ; preds = %_ZNKSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i86
  ...
  br i1 %i.ew, label %bb.z, label %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i.i91

bb.z:                                             ; preds = %.noexc95
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.eu, ptr align 8 %i.ea, i64 %i.em, i1 false)
...
_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i.i91: ; preds = %bb.z, %.noexc95
  %i.ex = getelementptr inbounds nuw i8, ptr %i.ev, i64 24 ; 3 uses
  %.not.i17.i.i.i92 = icmp eq ptr %i.ea, null
...
bb.aa:                                            ; preds = %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i.i91
  %i.ey = load ptr, ptr %i.ad, align 8, !tbaa !33
  %i.ez = ptrtoint ptr %i.ey to i64
  %i.fa = sub i64 %i.ez, %i.el
  tail call void @_ZdlPvm(ptr noundef nonnull %i.ea, i64 noundef %i.fa) #12
...
_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i93: ; preds = %bb.aa, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i.i91
  store ptr %i.eu, ptr %i.a, align 8, !tbaa !20
  store ptr %i.ex, ptr %i.b, align 8, !tbaa !19
  %i.fb = getelementptr inbounds nuw [24 x i8], ptr %i.eu, i64 %i.es
  store ptr %i.fb, ptr %i.ad, align 8, !tbaa !33
  br label %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit96
...
_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit96:  ; preds = %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i93, %bb.x, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit66
  %i.fc = phi ptr [ %i.ex, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i93 ], [ %i.ej, %bb.x ], [ %i.cq, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit66 ]
  %i.fd = phi ptr [ %i.eu, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i93 ], [ %i.dw, %bb.x ], [ %i.cr, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit66 ] ; 2 uses
  %i.fe = phi ptr [ %i.eu, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i93 ], [ %i.dx, %bb.x ], [ %i.cs, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit66 ] ; 10 uses
  %i.ff = phi ptr [ %i.eu, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i93 ], [ %i.ea, %bb.x ], [ %i.ct, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit66 ]
  %i.fg = phi ptr [ %i.eu, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i93 ], [ %i.ea, %bb.x ], [ %i.cu, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit66 ]
  %i.fh = phi ptr [ %i.ex, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i93 ], [ %i.ej, %bb.x ], [ %i.cv, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit66 ] ; 7 uses
  %i.fi = phi ptr [ %i.eu, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i93 ], [ %i.ea, %bb.x ], [ %i.cw, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit66 ]
...
bb.ac:                                            ; preds = %bb.ab
  ...
  store ptr %i.fn, ptr %i.b, align 8, !tbaa !19
  br label %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit111

bb.ad:                                            ; preds = %bb.ab
  %i.fo = ptrtoint ptr %i.fh to i64
  %i.fp = ptrtoint ptr %i.fe to i64               ; 2 uses
  %i.fq = sub i64 %i.fo, %i.fp                    ; 5 uses
  %i.fr = icmp eq i64 %i.fq, 9223372036854775800
  br i1 %i.fr, label %.invoke, label %_ZNKSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i101

_ZNKSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i101: ; preds = %bb.ad
  %i.fs = sdiv exact i64 %i.fq, 24                ; 3 uses
  %.sroa.speculated.i.i.i.i102 = tail call i64 @llvm.umax.i64(i64 %i.fs, i64 1)
  %i.ft = add nsw i64 %.sroa.speculated.i.i.i.i102, %i.fs ; 2 uses
  %i.fu = icmp ult i64 %i.ft, %i.fs
  %i.fv = tail call i64 @llvm.umin.i64(i64 %i.ft, i64 384307168202282325)
  %i.fw = select i1 %i.fu, i64 384307168202282325, i64 %i.fv ; 3 uses
  %.not.i.i.i.i103 = icmp ne i64 %i.fw, 0
  tail call void @llvm.assume(i1 %.not.i.i.i.i103)
  %i.fx = mul nuw nsw i64 %i.fw, 24
  %i.fy = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.fx) #11
...
.noexc110:                                        ; preds = %_ZNKSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i101
  ...
  br i1 %i.ga, label %bb.ae, label %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i.i106

bb.ae:                                            ; preds = %.noexc110
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.fy, ptr align 8 %i.fe, i64 %i.fq, i1 false)
...
_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i.i106: ; preds = %bb.ae, %.noexc110
  %i.gb = getelementptr inbounds nuw i8, ptr %i.fz, i64 24 ; 3 uses
  %.not.i17.i.i.i107 = icmp eq ptr %i.fe, null
...
bb.af:                                            ; preds = %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i.i106
  %i.gc = load ptr, ptr %i.ad, align 8, !tbaa !33
  %i.gd = ptrtoint ptr %i.gc to i64
  %i.ge = sub i64 %i.gd, %i.fp
  tail call void @_ZdlPvm(ptr noundef nonnull %i.fe, i64 noundef %i.ge) #12
...
_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i108: ; preds = %bb.af, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i.i106
  store ptr %i.fy, ptr %i.a, align 8, !tbaa !20
  store ptr %i.gb, ptr %i.b, align 8, !tbaa !19
  %i.gf = getelementptr inbounds nuw [24 x i8], ptr %i.fy, i64 %i.fw
  store ptr %i.gf, ptr %i.ad, align 8, !tbaa !33
  br label %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit111
...
_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit111: ; preds = %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i108, %bb.ac, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit96
  %i.gg = phi ptr [ %i.gb, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i108 ], [ %i.fn, %bb.ac ], [ %i.fc, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit96 ] ; 11 uses
  %i.gh = phi ptr [ %i.fy, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i108 ], [ %i.fd, %bb.ac ], [ %i.fd, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit96 ] ; 13 uses
  %i.gi = phi ptr [ %i.fy, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i108 ], [ %i.fe, %bb.ac ], [ %i.fe, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit96 ]
  %i.gj = phi ptr [ %i.fy, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i108 ], [ %i.fe, %bb.ac ], [ %i.ff, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit96 ]
  %i.gk = phi ptr [ %i.fy, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i108 ], [ %i.fe, %bb.ac ], [ %i.fg, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit96 ]
  %i.gl = phi ptr [ %i.gb, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i108 ], [ %i.fn, %bb.ac ], [ %i.fh, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit96 ]
  %i.gm = phi ptr [ %i.fy, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i108 ], [ %i.fe, %bb.ac ], [ %i.fi, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit96 ]
  %i.gn = icmp ne ptr %.sroa.0137.0170, %i.s
  %brmerge = or i1 %i.gn, %i.av
...
bb.ag:                                            ; preds = %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit111
  %i.go = icmp eq ptr %i.gh, %i.gg
  br i1 %i.go, label %bb.ah, label %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit126

bb.ah:                                            ; preds = %bb.ag
  %i.gp = load ptr, ptr %i.ad, align 8, !tbaa !33
  %.not.i.i113 = icmp eq ptr %i.gg, %i.gp
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %i.gq = getelementptr inbounds nuw i8, ptr %i.gg, i64 24 ; 3 uses
  store ptr %i.gq, ptr %i.b, align 8, !tbaa !19
...
_ZNKSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i116: ; preds = %bb.ah
  %i.gr = ptrtoint ptr %i.gg to i64
  %i.gs = invoke noalias noundef nonnull dereferenceable(24) ptr @_Znwm(i64 noundef 24) #11
...
_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i.i121: ; preds = %_ZNKSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i116
  ...
  %i.gt = getelementptr inbounds nuw i8, ptr %i.gs, i64 24 ; 4 uses
  %.not.i17.i.i.i122 = icmp eq ptr %i.gg, null
...
bb.aj:                                            ; preds = %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i.i121
  %i.gu = load ptr, ptr %i.ad, align 8, !tbaa !33
  %i.gv = ptrtoint ptr %i.gu to i64
  %i.gw = sub i64 %i.gv, %i.gr
  tail call void @_ZdlPvm(ptr noundef nonnull %i.gh, i64 noundef %i.gw) #12
...
_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i123: ; preds = %bb.aj, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i.i121
  store ptr %i.gs, ptr %i.a, align 8, !tbaa !20
  store ptr %i.gt, ptr %i.b, align 8, !tbaa !19
  store ptr %i.gt, ptr %i.ad, align 8, !tbaa !33
  br label %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit126
...
_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit126: ; preds = %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i123, %bb.ai, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit111, %bb.ag
  %i.gx = phi ptr [ %i.gt, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i123 ], [ %i.gq, %bb.ai ], [ %i.gg, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit111 ], [ %i.gg, %bb.ag ] ; 2 uses
  %.pre174 = phi ptr [ %i.gs, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i123 ], [ %i.gh, %bb.ai ], [ %i.gh, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit111 ], [ %i.gh, %bb.ag ] ; 2 uses
  %i.gy = phi ptr [ %i.gs, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i123 ], [ %i.gh, %bb.ai ], [ %i.gi, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit111 ], [ %i.gh, %bb.ag ]
  %i.gz = phi ptr [ %i.gs, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i123 ], [ %i.gh, %bb.ai ], [ %i.gj, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit111 ], [ %i.gh, %bb.ag ]
  %i.ha = phi ptr [ %i.gs, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i123 ], [ %i.gh, %bb.ai ], [ %i.gk, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit111 ], [ %i.gh, %bb.ag ]
  %i.hb = phi ptr [ %i.gt, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i123 ], [ %i.gq, %bb.ai ], [ %i.gl, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit111 ], [ %i.gg, %bb.ag ]
  %i.hc = phi ptr [ %i.gs, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i123 ], [ %i.gh, %bb.ai ], [ %i.gm, %_ZN5Ipopt16PiecewisePenalty8AddEntryEddd.exit111 ], [ %i.gh, %bb.ag ]
  %i.hd = getelementptr inbounds nuw i8, ptr %.sroa.0137.0170, i64 24 ; 2 uses
  %.not168 = icmp ugt ptr %i.hd, %i.s
...
_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EED2Ev.exit128: ; preds = %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EED2Ev.exit128.loopexit, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE5clearEv.exit
  ...
  %i.he = phi ptr [ %i.gx, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EED2Ev.exit128.loopexit ], [ %i.r, %_ZNSt6vectorIN5Ipopt17PiecewisePenEntryESaIS1_EE5clearEv.exit ]
  %i.hf = ptrtoint ptr %i.he to i64
  %i.hg = sub i64 %i.hf, %.pre-phi179
  %i.hh = sdiv exact i64 %i.hg, 24
  %i.hi = trunc i64 %i.hh to i32
  store i32 %i.hi, ptr %0, align 8, !tbaa !8
  tail call void @_ZdlPvm(ptr noundef nonnull %i.m, i64 noundef %i.g) #12
  ret void
}
