...
begin_hunk_0_@_ZN5Ipopt24LimMemQuasiNewtonUpdater16ShiftDenseVectorERNS_8SmartPtrINS_11DenseVectorEEEd:bb.a
  ...
  tail call void %i.bz(ptr noundef nonnull align 8 dereferenceable(248) %i.bs) #20, !inline_history !335
  br label %bb.m
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  %i.cm = load double, ptr %i.cl, align 8, !tbaa !284
  %i.cn = getelementptr inbounds nuw [8 x i8], ptr %i.ax, i64 %indvars.iv.next.2
  store double %i.cm, ptr %i.cn, align 8, !tbaa !284
  %exitcond.not.3 = icmp eq i64 %indvars.iv.next.3, %wide.trip.count
  br i1 %exitcond.not.3, label %._crit_edge, label %.lr.ph, !llvm.loop !463

bb.m:                                             ; preds = %._crit_edge, %bb.i, %bb.j
  store ptr %i.h, ptr %1, align 8, !tbaa !65
  %i.co = load i32, ptr %i.j, align 8, !tbaa !8
  %i.cp = add nsw i32 %i.co, -1                   ; 2 uses
  store i32 %i.cp, ptr %i.j, align 8, !tbaa !8
  %i.cq = icmp eq i32 %i.cp, 0
  br i1 %i.cq, label %bb.n, label %_ZN5Ipopt8SmartPtrINS_11DenseVectorEED2Ev.exit

bb.n:                                             ; preds = %bb.m
  %i.cr = load ptr, ptr %i.h, align 8, !tbaa !10
  %i.cs = getelementptr inbounds nuw i8, ptr %i.cr, i64 8
  %i.ct = load ptr, ptr %i.cs, align 8
  tail call void %i.ct(ptr noundef nonnull align 8 dereferenceable(248) %i.h) #20, !inline_history !289
...
bb.o:                                             ; preds = %bb.k, %bb.l
  ...
  %i.cu = load i32, ptr %i.j, align 8, !tbaa !8
  %i.cv = add nsw i32 %i.cu, -1                   ; 2 uses
  store i32 %i.cv, ptr %i.j, align 8, !tbaa !8
  %i.cw = icmp eq i32 %i.cv, 0
  br i1 %i.cw, label %bb.p, label %common.resume

bb.p:                                             ; preds = %bb.o
  %i.cx = load ptr, ptr %i.h, align 8, !tbaa !10
  %i.cy = getelementptr inbounds nuw i8, ptr %i.cx, i64 8
  %i.cz = load ptr, ptr %i.cy, align 8
  tail call void %i.cz(ptr noundef nonnull align 8 dereferenceable(248) %i.h) #20, !inline_history !289
...
bb.a:
  ...
  %i.b = load ptr, ptr %1, align 8, !tbaa !67     ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %i.b, i64 56
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !95
  %i.e = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  %i.f = load i32, ptr %i.e, align 8, !tbaa !307  ; 8 uses
  %i.g = getelementptr inbounds nuw i8, ptr %i.b, i64 72
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !291, !noalias !464
  %i.i = tail call noalias noundef nonnull dereferenceable(104) ptr @_Znwm(i64 noundef 104) #23, !noalias !464 ; 11 uses
  invoke void @_ZN5Ipopt14DenseGenMatrixC1EPKNS_19DenseGenMatrixSpaceE(ptr noundef nonnull align 8 dereferenceable(104) %i.i, ptr noundef nonnull align 8 dereferenceable(20) %i.h)
          to label %_ZNK5Ipopt14DenseGenMatrix21MakeNewDenseGenMatrixEv.exit unwind label %bb.b, !noalias !464
...
bb.b:                                             ; preds = %bb.a
  %i.j = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPvm(ptr noundef nonnull %i.i, i64 noundef 104) #21, !noalias !464
  br label %common.resume
...
_ZNK5Ipopt14DenseGenMatrix21MakeNewDenseGenMatrixEv.exit: ; preds = %bb.a
  ...
  %i.l = load i32, ptr %i.k, align 8, !tbaa !8, !noalias !464
  %i.m = add nsw i32 %i.l, 1
  store i32 %i.m, ptr %i.k, align 8, !tbaa !8, !noalias !464
  %i.n = load ptr, ptr %1, align 8, !tbaa !67     ; 3 uses
  %i.o = getelementptr inbounds nuw i8, ptr %i.n, i64 88
  store i8 1, ptr %i.o, align 8, !tbaa !383
...
bb.c:                                             ; preds = %_ZNK5Ipopt14DenseGenMatrix21MakeNewDenseGenMatrixEv.exit
  ...
  %i.q = load ptr, ptr %i.p, align 8, !tbaa !384  ; 2 uses
  %i.r = ptrtoaddr ptr %i.q to i64
  %i.s = getelementptr inbounds nuw i8, ptr %i.i, i64 88
  store i8 1, ptr %i.s, align 8, !tbaa !383
...
_ZN5Ipopt14DenseGenMatrix6ValuesEv.exit52:        ; preds = %bb.c
  ...
  %i.u = load ptr, ptr %i.t, align 8, !tbaa !384  ; 4 uses
...
vector.body:                                      ; preds = %.preheader95, %vector.body
  ...
  %wide.load = load <2 x double>, ptr %i.ag, align 8, !tbaa !284
  %wide.load153 = load <2 x double>, ptr %i.ah, align 8, !tbaa !284
  %i.ai = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep140, i64 %index ; 2 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 16
  store <2 x double> %wide.load, ptr %i.ai, align 8, !tbaa !284
  store <2 x double> %wide.load153, ptr %i.aj, align 8, !tbaa !284
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ak = icmp eq i64 %index.next, %n.vec
  br i1 %i.ak, label %middle.block, label %vector.body, !llvm.loop !467
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  %i.al = load double, ptr %gep.prol, align 8, !tbaa !284
  %gep141.prol = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep140, i64 %indvars.iv.prol
  store double %i.al, ptr %gep141.prol, align 8, !tbaa !284
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !468
...
._crit_edge:                                      ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  ...
  br i1 %exitcond120.not, label %.lr.ph, label %.preheader95, !llvm.loop !469
...
.lr.ph105:                                        ; preds = %.preheader
  ...
  call void @llvm.memset.p0.i64(ptr align 8 %scevgep, i8 0, i64 %i.bf, i1 false), !tbaa !284
...
bb.f:                                             ; preds = %.lr.ph, %_ZN5Ipopt8SmartPtrIKNS_6VectorEED2Ev.exit66
  ...
  %i.bg = load ptr, ptr %i.ao, align 8, !tbaa !149, !noalias !471
  %i.bh = getelementptr inbounds nuw [8 x i8], ptr %i.bg, i64 %i.ap
  %i.bi = load ptr, ptr %i.bh, align 8, !tbaa !157, !noalias !471 ; 2 uses
...
_ZNK5Ipopt17MultiVectorMatrix8ConstVecEi.exit.i:  ; preds = %bb.f
  %i.bj = load ptr, ptr %i.aq, align 8, !tbaa !158, !noalias !471
  %i.bk = getelementptr inbounds nuw [8 x i8], ptr %i.bj, i64 %i.ap
  %i.bl = load ptr, ptr %i.bk, align 8, !tbaa !45, !noalias !471 ; 2 uses
...
_ZNK5Ipopt17MultiVectorMatrix8ConstVecEi.exit.thread.i: ; preds = %_ZNK5Ipopt17MultiVectorMatrix8ConstVecEi.exit.i, %bb.f
  ...
  %i.bn = load i32, ptr %i.bm, align 8, !tbaa !8, !noalias !471
  %i.bo = add nsw i32 %i.bn, 1
  store i32 %i.bo, ptr %i.bm, align 8, !tbaa !8, !noalias !471
...
_ZNK5Ipopt17MultiVectorMatrix9GetVectorEi.exit:   ; preds = %_ZNK5Ipopt17MultiVectorMatrix8ConstVecEi.exit.thread.i, %_ZNK5Ipopt17MultiVectorMatrix8ConstVecEi.exit.i
  ...
  %i.bp = load ptr, ptr %i.ar, align 8, !tbaa !149, !noalias !474
  %i.bq = getelementptr inbounds nuw [8 x i8], ptr %i.bp, i64 %indvars.iv121
  %i.br = load ptr, ptr %i.bq, align 8, !tbaa !157, !noalias !474 ; 2 uses
...
_ZNK5Ipopt17MultiVectorMatrix8ConstVecEi.exit.i57: ; preds = %_ZNK5Ipopt17MultiVectorMatrix9GetVectorEi.exit
  %i.bs = load ptr, ptr %i.as, align 8, !tbaa !158, !noalias !474
  %i.bt = getelementptr inbounds nuw [8 x i8], ptr %i.bs, i64 %indvars.iv121
  %i.bu = load ptr, ptr %i.bt, align 8, !tbaa !45, !noalias !474 ; 2 uses
...
_ZNK5Ipopt17MultiVectorMatrix8ConstVecEi.exit.thread.i54: ; preds = %_ZNK5Ipopt17MultiVectorMatrix8ConstVecEi.exit.i57, %_ZNK5Ipopt17MultiVectorMatrix9GetVectorEi.exit
  ...
  %i.bw = load i32, ptr %i.bv, align 8, !tbaa !8, !noalias !474
  %i.bx = add nsw i32 %i.bw, 1
  store i32 %i.bx, ptr %i.bv, align 8, !tbaa !8, !noalias !474
...
bb.g:                                             ; preds = %_ZNK5Ipopt17MultiVectorMatrix9GetVectorEi.exit59
  ...
  %i.ca = load i32, ptr %i.bz, align 8, !tbaa !276
  %i.cb = getelementptr inbounds nuw i8, ptr %.0.i4.i, i64 48 ; 2 uses
  %i.cc = load i32, ptr %i.cb, align 8, !tbaa !116
...
bb.h:                                             ; preds = %bb.g
  %i.cd = load ptr, ptr %.0.i4.i, align 8, !tbaa !10
  ...
  %i.cg = invoke noundef double %i.cf(ptr noundef nonnull align 8 dereferenceable(205) %.0.i4.i)
          to label %.noexc unwind label %bb.n, !inline_history !332 ; 2 uses

.noexc:                                           ; preds = %bb.h
  %i.ch = getelementptr inbounds nuw i8, ptr %.0.i4.i, i64 96
  store double %i.cg, ptr %i.ch, align 8, !tbaa !277
  %i.ci = load i32, ptr %i.cb, align 8, !tbaa !116
  store i32 %i.ci, ptr %i.bz, align 8, !tbaa !276
  br label %_ZNK5Ipopt6Vector3DotERKS0_.exit
...
bb.j:                                             ; preds = %.noexc61
  %i.cl = load ptr, ptr %.0.i4.i, align 8, !tbaa !10
...
.noexc62:                                         ; preds = %bb.j
  store double %i.co, ptr %i.a, align 8, !tbaa !284
...
_ZNK5Ipopt6Vector3DotERKS0_.exit.thread:          ; preds = %.noexc61, %.noexc62
  %i.cp = load double, ptr %i.a, align 8, !tbaa !284
...
bb.t:                                             ; preds = %_ZNK5Ipopt6Vector3DotERKS0_.exit, %_ZNK5Ipopt6Vector3DotERKS0_.exit.thread
  ...
  %i.dm = load i32, ptr %i.dl, align 8, !tbaa !8
...
bb.u:                                             ; preds = %bb.t
  %i.dp = load ptr, ptr %.0.i4.i55, align 8, !tbaa !10
...
_ZNK5Ipopt6Vector3DotERKS0_.exit.thread:          ; preds = %.noexc55, %.noexc56
  %i.cu = load double, ptr %i.a, align 8, !tbaa !284
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #20
  br label %bb.m

_ZNK5Ipopt6Vector3DotERKS0_.exit:                 ; preds = %._crit_edge.i.i, %.noexc
  %i.cv = phi double [ %.pre.i.i, %._crit_edge.i.i ], [ %i.cl, %.noexc ] ; 2 uses
  %i.cw = fmul double %i.cv, %i.cv
  br label %bb.m

bb.m:                                             ; preds = %_ZNK5Ipopt6Vector3DotERKS0_.exit, %_ZNK5Ipopt6Vector3DotERKS0_.exit.thread
  %.sink = phi double [ %i.cw, %_ZNK5Ipopt6Vector3DotERKS0_.exit ], [ %i.cu, %_ZNK5Ipopt6Vector3DotERKS0_.exit.thread ]
  %i.cx = mul nuw nsw i64 %indvars.iv108, %i.aw
  %gep129 = getelementptr [8 x i8], ptr %invariant.gep128.sink, i64 %i.cx
  store double %.sink, ptr %gep129, align 8, !tbaa !284
  %i.cy = getelementptr inbounds nuw i8, ptr %.0.i4.i50, i64 8 ; 2 uses
  %i.cz = load i32, ptr %i.cy, align 8, !tbaa !8
  %i.da = add nsw i32 %i.cz, -1                   ; 2 uses
  store i32 %i.da, ptr %i.cy, align 8, !tbaa !8
  %i.db = icmp eq i32 %i.da, 0
  br i1 %i.db, label %bb.n, label %_ZN5Ipopt8SmartPtrIKNS_6VectorEED2Ev.exit

bb.n:                                             ; preds = %bb.m
  %i.dc = load ptr, ptr %.0.i4.i50, align 8, !tbaa !10
  %i.dd = getelementptr inbounds nuw i8, ptr %i.dc, i64 8
  %i.de = load ptr, ptr %i.dd, align 8
  call void %i.de(ptr noundef nonnull align 8 dereferenceable(205) %.0.i4.i50) #20, !inline_history !115
  br label %_ZN5Ipopt8SmartPtrIKNS_6VectorEED2Ev.exit

_ZN5Ipopt8SmartPtrIKNS_6VectorEED2Ev.exit:        ; preds = %bb.n, %bb.m
  %i.df = getelementptr inbounds nuw i8, ptr %.0.i4.i, i64 8 ; 2 uses
  %i.dg = load i32, ptr %i.df, align 8, !tbaa !8
  %i.dh = add nsw i32 %i.dg, -1                   ; 2 uses
  store i32 %i.dh, ptr %i.df, align 8, !tbaa !8
  %i.di = icmp eq i32 %i.dh, 0
  br i1 %i.di, label %bb.o, label %_ZN5Ipopt8SmartPtrIKNS_6VectorEED2Ev.exit60

bb.o:                                             ; preds = %_ZN5Ipopt8SmartPtrIKNS_6VectorEED2Ev.exit
  %i.dj = load ptr, ptr %.0.i4.i, align 8, !tbaa !10
  %i.dk = getelementptr inbounds nuw i8, ptr %i.dj, i64 8
  %i.dl = load ptr, ptr %i.dk, align 8
  call void %i.dl(ptr noundef nonnull align 8 dereferenceable(205) %.0.i4.i) #20, !inline_history !115
  br label %_ZN5Ipopt8SmartPtrIKNS_6VectorEED2Ev.exit60
