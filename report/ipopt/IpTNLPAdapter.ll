...
bb.hp:                                            ; preds = %._crit_edge2160, %bb.hk
  ...
  br i1 %i.wa, label %bb.hv, label %bb.hq
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %gep.a = getelementptr [4 x i8], ptr %invariant.gep.a, i64 %index ; 2 uses
  %i.xc = getelementptr inbounds nuw i8, ptr %gep.a, i64 16
  %wide.load = load <4 x i32>, ptr %gep.a, align 4, !tbaa !100
  %wide.load3156 = load <4 x i32>, ptr %i.xc, align 4, !tbaa !100
  %gep3432 = getelementptr [4 x i8], ptr %invariant.gep3431, i64 %index ; 2 uses
  %i.xd = getelementptr inbounds nuw i8, ptr %gep3432, i64 16
  store <4 x i32> %wide.load, ptr %gep3432, align 4, !tbaa !100
  store <4 x i32> %wide.load3156, ptr %i.xd, align 4, !tbaa !100
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.xe = icmp eq i64 %index.next, %n.vec
  br i1 %i.xe, label %middle.block, label %vector.body, !llvm.loop !227
...
.lr.ph2170.prol:                                  ; preds = %.lr.ph2170.preheader3250, %.lr.ph2170.prol
  ...
  %i.xh = getelementptr inbounds [4 x i8], ptr %i.nm, i64 %indvars.iv2375.prol
  %i.xi = load i32, ptr %i.xh, align 4, !tbaa !100
  %indvars.iv.next2380.prol = add nsw i64 %indvars.iv2379.prol, 1 ; 3 uses
  %i.xj = getelementptr inbounds [4 x i8], ptr %i.nm, i64 %indvars.iv2379.prol
  store i32 %i.xi, ptr %i.xj, align 4, !tbaa !100
...
.lr.ph2170.prol.loopexit:                         ; preds = %.lr.ph2170.prol, %.lr.ph2170.preheader3250
  ...
  %i.xk = sub i32 %i.xf, %.1655.lcssa
  %i.xl = icmp ugt i32 %i.xk, -4
  br i1 %i.xl, label %.loopexit2083.loopexit, label %.lr.ph2170
...
.lr.ph2170:                                       ; preds = %.lr.ph2170.prol.loopexit, %.lr.ph2170
  ...
  %i.xm = getelementptr inbounds [4 x i8], ptr %i.nm, i64 %indvars.iv2375
  %i.xn = load i32, ptr %i.xm, align 4, !tbaa !100
  %i.xo = getelementptr inbounds [4 x i8], ptr %i.nm, i64 %indvars.iv2379
  store i32 %i.xn, ptr %i.xo, align 4, !tbaa !100
  %i.xp = getelementptr [4 x i8], ptr %i.nm, i64 %indvars.iv2375
  %i.xq = getelementptr i8, ptr %i.xp, i64 4
  %i.xr = load i32, ptr %i.xq, align 4, !tbaa !100
  %i.xs = getelementptr [4 x i8], ptr %i.nm, i64 %indvars.iv2379
  %i.xt = getelementptr i8, ptr %i.xs, i64 4
  store i32 %i.xr, ptr %i.xt, align 4, !tbaa !100
  %i.xu = getelementptr [4 x i8], ptr %i.nm, i64 %indvars.iv2375
  %i.xv = getelementptr i8, ptr %i.xu, i64 8
  %i.xw = load i32, ptr %i.xv, align 4, !tbaa !100
  %i.xx = getelementptr [4 x i8], ptr %i.nm, i64 %indvars.iv2379
  %i.xy = getelementptr i8, ptr %i.xx, i64 8
  store i32 %i.xw, ptr %i.xy, align 4, !tbaa !100
  %i.xz = getelementptr [4 x i8], ptr %i.nm, i64 %indvars.iv2375
  %i.ya = getelementptr i8, ptr %i.xz, i64 12
  %i.yb = load i32, ptr %i.ya, align 4, !tbaa !100
  %indvars.iv.next2380.3 = add nsw i64 %indvars.iv2379, 4 ; 2 uses
  %i.yc = getelementptr [4 x i8], ptr %i.nm, i64 %indvars.iv2379
  %i.yd = getelementptr i8, ptr %i.yc, i64 12
  store i32 %i.yb, ptr %i.yd, align 4, !tbaa !100
...
.loopexit2083.loopexit:                           ; preds = %.lr.ph2170.prol.loopexit, %.lr.ph2170, %middle.block
  %indvars.iv.next2380.lcssa = phi i64 [ %i.xa, %middle.block ], [ %indvars.iv.next2380.lcssa3251.unr, %.lr.ph2170.prol.loopexit ], [ %indvars.iv.next2380.3, %.lr.ph2170 ]
  %i.ye = trunc nsw i64 %indvars.iv.next2380.lcssa to i32
  br label %.loopexit2083

.loopexit2083:                                    ; preds = %bb.hs, %.loopexit2083.loopexit, %bb.hq, %.preheader2082
  %.3630 = phi i32 [ %i.ye, %.loopexit2083.loopexit ], [ %.06272162, %.preheader2082 ], [ %i.wc, %bb.hq ], [ %.16281916, %bb.hs ]
  call void @llvm.lifetime.start.p0(ptr nonnull %i.g) #22
  store double 0.000000e+00, ptr %i.g, align 8, !tbaa !123
  %i.yf = load i32, ptr %i.hj, align 4, !tbaa !110
  %i.yg = load ptr, ptr %i.hw, align 8, !tbaa !80
  invoke void @_ZN5Ipopt10IpBlasCopyEiPKdiPdi(i32 noundef %i.yf, ptr noundef nonnull %i.g, i32 noundef 0, ptr noundef %i.yg, i32 noundef 1)
...
bb.hv:                                            ; preds = %bb.ht, %bb.hp
  %i.yi = phi ptr [ %i.vz, %bb.hp ], [ %.pre2604, %bb.ht ] ; 2 uses
  %.3657 = phi i32 [ %.1655.lcssa, %bb.hp ], [ %.3630, %bb.ht ]
  %.not8.i.i = icmp eq ptr %i.yi, %61
  br i1 %.not8.i.i, label %_ZNSt7__cxx1110_List_baseIiSaIiEED2Ev.exit, label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %bb.hv, %.lr.ph.i.i
  %.09.i.i = phi ptr [ %i.yj, %.lr.ph.i.i ], [ %i.yi, %bb.hv ] ; 2 uses
...
_ZNSt7__cxx1110_List_baseIiSaIiEED2Ev.exit:       ; preds = %.lr.ph.i.i, %bb.hv
  call void @llvm.lifetime.end.p0(ptr nonnull %61) #22
  br label %bb.hx

bb.hw:                                            ; preds = %bb.hn, %bb.ho, %bb.hu, %bb.he
  %.pn956.pn = phi { ptr, i32 } [ %i.us, %bb.he ], [ %i.yh, %bb.hu ], [ %i.vx, %bb.hn ], [ %i.vy, %bb.ho ]
...
.lr.ph.i.i1056:                                   ; preds = %bb.hw, %.lr.ph.i.i1056
  %.09.i.i1057 = phi ptr [ %i.yl, %.lr.ph.i.i1056 ], [ %i.yk, %bb.hw ] ; 2 uses
...
_ZNSt7__cxx1110_List_baseIiSaIiEED2Ev.exit1059:   ; preds = %.lr.ph.i.i1056, %bb.hw
  call void @llvm.lifetime.end.p0(ptr nonnull %61) #22
  br label %_ZN5Ipopt8SmartPtrINS_16DenseVectorSpaceEED2Ev.exit1531

bb.hx:                                            ; preds = %bb.gz, %bb.ha, %_ZNSt7__cxx1110_List_baseIiSaIiEED2Ev.exit
  ...
  %i.ym = invoke noalias noundef nonnull dereferenceable(160) ptr @_Znwm(i64 noundef 160) #25
          to label %bb.hy unwind label %bb.iu     ; 26 uses
...
bb.hy:                                            ; preds = %bb.hx
  ...
  br i1 %.not.i.i.i, label %bb.ib, label %bb.hz
...
bb.hz:                                            ; preds = %bb.hy
  ...
  br i1 %i.zj, label %bb.ia, label %bb.ib
...
bb.ib:                                            ; preds = %bb.ia, %bb.hz, %bb.hy
  ...
  %i.zn = invoke noalias noundef nonnull dereferenceable(160) ptr @_Znwm(i64 noundef 160) #25
          to label %bb.ic unwind label %bb.iv     ; 26 uses
...
bb.ic:                                            ; preds = %bb.ib
  ...
  br i1 %.not.i.i.i1064, label %bb.if, label %bb.id
...
bb.id:                                            ; preds = %bb.ic
  ...
  br i1 %i.aak, label %bb.ie, label %bb.if
...
bb.if:                                            ; preds = %bb.ie, %bb.id, %bb.ic
  ...
  %i.aao = invoke noalias noundef nonnull dereferenceable(160) ptr @_Znwm(i64 noundef 160) #25
          to label %bb.ig unwind label %bb.iw     ; 26 uses
