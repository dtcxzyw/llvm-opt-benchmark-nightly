...
bb.o:                                             ; preds = %bb.n
  %i.cr = load ptr, ptr %.0.i3.i, align 8, !tbaa !20
  %i.cs = getelementptr inbounds nuw i8, ptr %i.cr, i64 8
  %i.ct = load ptr, ptr %i.cs, align 8
  tail call void %i.ct(ptr noundef nonnull align 8 dereferenceable(205) %.0.i3.i) #17, !inline_history !3
...
_ZN5Ipopt8SmartPtrIKNS_6VectorEED2Ev.exit38:      ; preds = %bb.n, %bb.o
  ...
  %i.cv = load i8, ptr %i.cu, align 1, !tbaa !84, !range !83, !noundef !76
  %i.cw = trunc nuw i8 %i.cv to i1
  %i.cx = load ptr, ptr %i.bv, align 8, !tbaa !25
  %i.cy = getelementptr inbounds nuw [4 x i8], ptr %i.cx, i64 %.02876
  %i.cz = load i32, ptr %i.cy, align 4, !tbaa !29
...
bb.p:                                             ; preds = %_ZN5Ipopt8SmartPtrIKNS_6VectorEED2Ev.exit38
  ...
  %i.dd = load ptr, ptr %i.ae, align 8, !tbaa !69, !noalias !135
  %i.de = getelementptr inbounds nuw [8 x i8], ptr %i.dd, i64 %indvars.iv.next
  %i.df = load ptr, ptr %i.de, align 8, !tbaa !72, !noalias !135 ; 2 uses
...
_ZNK5Ipopt14CompoundVector9ConstCompEi.exit.i43:  ; preds = %bb.p
  %i.dg = load ptr, ptr %i.bu, align 8, !tbaa !73, !noalias !135
  %i.dh = getelementptr inbounds nuw [8 x i8], ptr %i.dg, i64 %indvars.iv.next
  %i.di = load ptr, ptr %i.dh, align 8, !tbaa !75, !noalias !135, !nonnull !76, !noundef !76
...
_ZNK5Ipopt14CompoundVector9ConstCompEi.exit.thread.i40: ; preds = %_ZNK5Ipopt14CompoundVector9ConstCompEi.exit.i43, %bb.p
  ...
  %i.dk = load i32, ptr %i.dj, align 8, !tbaa !14, !noalias !135 ; 2 uses
  ...
  %i.dt = load double, ptr %i.ds, align 8, !tbaa !32
  %i.du = getelementptr inbounds nuw [8 x i8], ptr %i.u, i64 %.02876 ; 2 uses
  %i.dv = load double, ptr %i.du, align 8, !tbaa !32
  %i.dw = tail call double @llvm.fmuladd.f64(double %i.da, double %i.dt, double %i.dv)
  store double %i.dw, ptr %i.du, align 8, !tbaa !32
  store i32 %i.dk, ptr %i.dj, align 8, !tbaa !14
...
bb.q:                                             ; preds = %_ZNK5Ipopt14CompoundVector9ConstCompEi.exit.thread.i40
  %i.dy = load ptr, ptr %.0.i3.i41, align 8, !tbaa !20
  %i.dz = getelementptr inbounds nuw i8, ptr %i.dy, i64 8
  %i.ea = load ptr, ptr %i.dz, align 8
  tail call void %i.ea(ptr noundef nonnull align 8 dereferenceable(205) %.0.i3.i41) #17, !inline_history !3
...
_ZN5Ipopt8SmartPtrIKNS_6VectorEED2Ev.exit47:      ; preds = %bb.r, %_ZNK5Ipopt14CompoundVector9ConstCompEi.exit.thread.i40, %bb.q
  ...
  %i.eh = load i32, ptr %i.eg, align 8, !tbaa !14
  %i.ei = add nsw i32 %i.eh, -1                   ; 2 uses
  store i32 %i.ei, ptr %i.eg, align 8, !tbaa !14
...
bb.s:                                             ; preds = %_ZN5Ipopt8SmartPtrIKNS_6VectorEED2Ev.exit47
  %i.ek = load ptr, ptr %i.ck, align 8, !tbaa !20
  %i.el = getelementptr inbounds nuw i8, ptr %i.ek, i64 8
  %i.em = load ptr, ptr %i.el, align 8
  tail call void %i.em(ptr noundef nonnull align 8 dereferenceable(248) %i.ck) #17, !inline_history !130
...
_ZN5Ipopt8SmartPtrIKNS_11DenseVectorEED2Ev.exit52: ; preds = %_ZN5Ipopt8SmartPtrIKNS_6VectorEED2Ev.exit47, %bb.s
  ...
  %i.eo = load ptr, ptr %i.br, align 8, !tbaa !24
  %i.ep = load ptr, ptr %i.bq, align 8, !tbaa !25 ; 2 uses
  %i.eq = ptrtoint ptr %i.eo to i64
  %i.er = ptrtoint ptr %i.ep to i64
  %i.es = sub i64 %i.eq, %i.er
  %i.et = ashr exact i64 %i.es, 2
  %i.eu = icmp ult i64 %i.en, %i.et
  br i1 %i.eu, label %bb.i, label %._crit_edge, !llvm.loop !131
...
._crit_edge:                                      ; preds = %_ZN5Ipopt8SmartPtrIKNS_6VectorEED2Ev.exit
  ...
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !85   ; 2 uses
...
.lr.ph80.preheader:                               ; preds = %._crit_edge
  ...
  tail call void @llvm.memset.p0.i64(ptr nonnull align 8 %i.n, i8 0, i64 %i.s, i1 false), !tbaa !32
  br label %.preheader74
...
bb.b:                                             ; preds = %.lr.ph, %_ZN5Ipopt8SmartPtrIKNS_6VectorEED2Ev.exit
  ...
  %i.u = load ptr, ptr %i.i, align 8, !tbaa !69, !noalias !146
  %i.v = getelementptr inbounds nuw [8 x i8], ptr %i.u, i64 %indvars.iv
  %i.w = load ptr, ptr %i.v, align 8, !tbaa !72, !noalias !146 ; 2 uses
...
_ZNK5Ipopt14CompoundVector9ConstCompEi.exit.i:    ; preds = %bb.b
  %i.x = load ptr, ptr %i.j, align 8, !tbaa !73, !noalias !146
  %i.y = getelementptr inbounds nuw [8 x i8], ptr %i.x, i64 %indvars.iv
  %i.z = load ptr, ptr %i.y, align 8, !tbaa !75, !noalias !146, !nonnull !76, !noundef !76
...
_ZNK5Ipopt14CompoundVector9ConstCompEi.exit.thread.i: ; preds = %_ZNK5Ipopt14CompoundVector9ConstCompEi.exit.i, %bb.b
  ...
  %i.ab = load i32, ptr %i.aa, align 8, !tbaa !14, !noalias !146
...
bb.c:                                             ; preds = %_ZNK5Ipopt14CompoundVector9ConstCompEi.exit.thread.i
  %i.ai = load ptr, ptr %.0.i3.i, align 8, !tbaa !20
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 8
  %i.ak = load ptr, ptr %i.aj, align 8
  tail call void %i.ak(ptr noundef nonnull align 8 dereferenceable(205) %.0.i3.i) #17, !inline_history !3
...
_ZN5Ipopt8SmartPtrIKNS_6VectorEED2Ev.exit:        ; preds = %_ZNK5Ipopt14CompoundVector9ConstCompEi.exit.thread.i, %bb.c
  ...
  br i1 %i.ap, label %bb.b, label %._crit_edge, !llvm.loop !139
...
.preheader74:                                     ; preds = %.thread, %.lr.ph80.preheader, %._crit_edge
  ...
  %i.av = load ptr, ptr %i.as, align 8, !tbaa !25 ; 5 uses
...
bb.d:                                             ; preds = %bb.d, %.lr.ph82.new
  ...
  %i.co = load double, ptr %i.cn, align 8, !tbaa !32
  ...
  store double %i.cs, ptr %i.cq, align 8, !tbaa !32
  %i.ct = add nuw i64 %.04181, 2                  ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.preheader.loopexit.unr-lcssa, label %bb.d, !llvm.loop !140
...
bb.e:                                             ; preds = %.lr.ph85, %_ZN5Ipopt8SmartPtrINS_6VectorEED2Ev.exit65
  ...
  tail call void @_ZN5Ipopt12TaggedObject13ObjectChangedEv(ptr noundef nonnull align 8 dereferenceable(265) %2), !noalias !147
  %i.cu = load ptr, ptr %i.bt, align 8, !tbaa !69, !noalias !147
  %i.cv = getelementptr inbounds nuw [8 x i8], ptr %i.cu, i64 %indvars.iv93
  %i.cw = load ptr, ptr %i.cv, align 8, !tbaa !72, !noalias !147 ; 6 uses
  %.not.i.i.i54 = icmp eq ptr %i.cw, null
  br i1 %.not.i.i.i54, label %._crit_edge96, label %bb.f

._crit_edge96:                                    ; preds = %bb.e
  %.pre97 = load i32, ptr inttoptr (i64 8 to ptr), align 8, !tbaa !14
  %i.cx = add nsw i32 %.pre97, -1
  br label %bb.g

bb.f:                                             ; preds = %bb.e
  %i.cy = getelementptr inbounds nuw i8, ptr %i.cw, i64 8 ; 2 uses
  %i.cz = load i32, ptr %i.cy, align 8, !tbaa !14, !noalias !147 ; 2 uses
  %i.da = add nsw i32 %i.cz, 1
  store i32 %i.da, ptr %i.cy, align 8, !tbaa !14, !noalias !147
  br label %bb.g
...
bb.g:                                             ; preds = %._crit_edge96, %bb.f
  ...
  %i.df = load i32, ptr %i.de, align 4, !tbaa !78 ; 2 uses
  %i.dg = getelementptr inbounds nuw i8, ptr %i.cw, i64 8
  store i32 %i.db, ptr %i.dg, align 8, !tbaa !14
  %i.dh = icmp eq i32 %i.db, 0
  br i1 %i.dh, label %bb.h, label %_ZN5Ipopt8SmartPtrINS_6VectorEED2Ev.exit

bb.h:                                             ; preds = %bb.g
  %i.di = load ptr, ptr %i.cw, align 8, !tbaa !20
  %i.dj = getelementptr inbounds nuw i8, ptr %i.di, i64 8
  %i.dk = load ptr, ptr %i.dj, align 8
  tail call void %i.dk(ptr noundef nonnull align 8 dereferenceable(205) %i.cw) #17, !inline_history !4
  br label %_ZN5Ipopt8SmartPtrINS_6VectorEED2Ev.exit

_ZN5Ipopt8SmartPtrINS_6VectorEED2Ev.exit:         ; preds = %bb.g, %bb.h
  tail call void @_ZN5Ipopt12TaggedObject13ObjectChangedEv(ptr noundef nonnull align 8 dereferenceable(265) %2), !noalias !148
  %i.dl = load ptr, ptr %i.bt, align 8, !tbaa !69, !noalias !148
  %i.dm = getelementptr inbounds nuw [8 x i8], ptr %i.dl, i64 %indvars.iv93
  %i.dn = load ptr, ptr %i.dm, align 8, !tbaa !72, !noalias !148 ; 10 uses
...
bb.i:                                             ; preds = %_ZN5Ipopt8SmartPtrINS_6VectorEED2Ev.exit
  ...
  %i.dp = load i32, ptr %i.do, align 8, !tbaa !14, !noalias !148
  %i.dq = add nsw i32 %i.dp, 1
  store i32 %i.dq, ptr %i.do, align 8, !tbaa !14, !noalias !148
...
_ZN5Ipopt14CompoundVector15GetCompNonConstEi.exit57: ; preds = %_ZN5Ipopt8SmartPtrINS_6VectorEED2Ev.exit, %bb.i
  ...
  %i.dt = load i8, ptr %i.ds, align 8, !tbaa !82, !range !83, !noundef !76
  %i.du = trunc nuw i8 %i.dt to i1
  %i.dv = getelementptr inbounds nuw i8, ptr %i.dr, i64 233 ; 2 uses
  %i.dw = load i8, ptr %i.dv, align 1, !range !83
...
.noexc58:                                         ; preds = %.noexc
  store i8 1, ptr %i.ds, align 8, !tbaa !82
  store i8 0, ptr %i.dv, align 1, !tbaa !84
  %i.dy = getelementptr inbounds nuw i8, ptr %i.dr, i64 216 ; 2 uses
  %i.dz = load ptr, ptr %i.dy, align 8, !tbaa !85 ; 2 uses
...
bb.k:                                             ; preds = %.noexc58
  ...
  %i.ee = load i32, ptr %i.ed, align 4, !tbaa !78 ; 2 uses
...
_ZNK5Ipopt16DenseVectorSpace23AllocateInternalStorageEv.exit.i.i: ; preds = %bb.l, %bb.k
  ...
  store ptr %.0.i.i.i, ptr %i.dy, align 8, !tbaa !85
...
bb.m:                                             ; preds = %bb.j, %.noexc, %bb.l
  ...
  %i.el = load i32, ptr %i.ek, align 8, !tbaa !14
  %i.em = add nsw i32 %i.el, -1                   ; 2 uses
  store i32 %i.em, ptr %i.ek, align 8, !tbaa !14
  %i.en = icmp eq i32 %i.em, 0
  br i1 %i.en, label %bb.n, label %_ZN5Ipopt8SmartPtrINS_6VectorEED2Ev.exit63

bb.n:                                             ; preds = %bb.m
  %i.eo = load ptr, ptr %i.dn, align 8, !tbaa !20
  %i.ep = getelementptr inbounds nuw i8, ptr %i.eo, i64 8
  %i.eq = load ptr, ptr %i.ep, align 8
  tail call void %i.eq(ptr noundef nonnull align 8 dereferenceable(205) %i.dn) #17, !inline_history !4
...
_ZN5Ipopt11DenseVector6ValuesEv.exit:             ; preds = %.noexc58, %_ZNK5Ipopt16DenseVectorSpace23AllocateInternalStorageEv.exit.i.i
  ...
  %i.et = load i32, ptr %i.es, align 8, !tbaa !14
  %i.eu = add nsw i32 %i.et, -1                   ; 2 uses
  store i32 %i.eu, ptr %i.es, align 8, !tbaa !14
...
bb.o:                                             ; preds = %_ZN5Ipopt11DenseVector6ValuesEv.exit
  %i.ew = load ptr, ptr %i.dn, align 8, !tbaa !20
