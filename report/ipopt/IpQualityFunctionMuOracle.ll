...
_ZNK5Ipopt6Vector4AsumEv.exit106:                 ; preds = %._crit_edge.i103, %bb.o
  ...
  %22 = load <4 x i32>, ptr %i.np, align 8
  %23 = shufflevector <4 x i32> %22, <4 x i32> poison, <2 x i32> <i32 0, i32 poison>
...
_ZNK5Ipopt6Vector4Nrm2Ev.exit125:                 ; preds = %._crit_edge.i122, %bb.t
  ...
  %24 = load <4 x i32>, ptr %i.qz, align 8
  %25 = shufflevector <4 x i32> %24, <4 x i32> poison, <2 x i32> <i32 0, i32 poison>
