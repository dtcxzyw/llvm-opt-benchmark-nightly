...
bb.a:
  ...
  br i1 %i.g, label %.lr.ph.a, label %._crit_edge
...
bb.b:                                             ; preds = %.lr.ph.a, %.loopexit
  %indvars.iv103 = phi i64 [ 0, %.lr.ph.a ], [ %indvars.iv.next104, %.loopexit ] ; 3 uses
  %i.l = getelementptr inbounds nuw [8 x i8], ptr %i.j, i64 %indvars.iv103
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !39   ; 9 uses
  %i.n = getelementptr inbounds nuw [8 x i8], ptr %i.k, i64 %indvars.iv103
...
.preheader58.lr.ph:                               ; preds = %bb.c
  ...
  br i1 %i.af, label %.preheader58.lr.ph.split.us, label %.loopexit
...
.preheader58.lr.ph.split.us:                      ; preds = %.preheader58.lr.ph
  ...
  br i1 %i.ao, label %.preheader58.lr.ph.split.us.split.us, label %.loopexit

.preheader58.lr.ph.split.us.split.us:             ; preds = %.preheader58.lr.ph.split.us
  ...
  br i1 %i.aw, label %.preheader58.lr.ph.split.us.split.us.split.us, label %.loopexit

.preheader58.lr.ph.split.us.split.us.split.us:    ; preds = %.preheader58.lr.ph.split.us.split.us
  ...
  %ident.check116 = icmp ne i32 %i.ax, 1
  %i.bc = or i1 %ident.check, %ident.check116
  %n.vec = and i64 %i.bb, 2147483644              ; 5 uses
  %i.bd = trunc nuw nsw i64 %n.vec to i32
  %cmp.n = icmp eq i64 %n.vec, %i.bb
  br label %.preheader58.us.us.us

.preheader58.us.us.us:                            ; preds = %.preheader58.lr.ph.split.us.split.us.split.us, %._crit_edge.split.us.split.us.us.us.us
  %indvars.iv89 = phi i32 [ 0, %.preheader58.lr.ph.split.us.split.us.split.us ], [ %indvars.iv.next90, %._crit_edge.split.us.split.us.us.us.us ] ; 2 uses
  %indvars.iv = phi i32 [ 0, %.preheader58.lr.ph.split.us.split.us.split.us ], [ %indvars.iv.next, %._crit_edge.split.us.split.us.us.us.us ] ; 2 uses
  %.05169.us.us.us = phi i32 [ 0, %.preheader58.lr.ph.split.us.split.us.split.us ], [ %i.cq, %._crit_edge.split.us.split.us.us.us.us ]
  br label %.preheader.us.us.us.us.us

.preheader.us.us.us.us.us:                        ; preds = %.preheader58.us.us.us, %._crit_edge64.split.us.us.us.us.us.us
  %indvars.iv91 = phi i32 [ %indvars.iv89, %.preheader58.us.us.us ], [ %indvars.iv.next92, %._crit_edge64.split.us.us.us.us.us.us ] ; 2 uses
  %indvars.iv83 = phi i32 [ %indvars.iv, %.preheader58.us.us.us ], [ %indvars.iv.next84, %._crit_edge64.split.us.us.us.us.us.us ] ; 2 uses
  %.05265.us.us.us.us.us = phi i32 [ 0, %.preheader58.us.us.us ], [ %i.cp, %._crit_edge64.split.us.us.us.us.us.us ]
  br label %.lr.ph.us.us.us.us.us.us

.lr.ph.us.us.us.us.us.us:                         ; preds = %.preheader.us.us.us.us.us, %._crit_edge.us.us.us.us.us.us
  %indvars.iv93 = phi i32 [ %indvars.iv91, %.preheader.us.us.us.us.us ], [ %indvars.iv.next94, %._crit_edge.us.us.us.us.us.us ] ; 3 uses
  %indvars.iv85 = phi i32 [ %indvars.iv83, %.preheader.us.us.us.us.us ], [ %indvars.iv.next86, %._crit_edge.us.us.us.us.us.us ] ; 3 uses
  %.05362.us.us.us.us.us.us = phi i32 [ 0, %.preheader.us.us.us.us.us ], [ %i.co, %._crit_edge.us.us.us.us.us.us ]
  %i.be = sext i32 %indvars.iv85 to i64           ; 4 uses
  %i.bf = sext i32 %indvars.iv93 to i64           ; 4 uses
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.scevcheck

vector.scevcheck:                                 ; preds = %.lr.ph.us.us.us.us.us.us
  %i.bg = sext i32 %indvars.iv93 to i64
  %i.bh = add nsw i64 %i.v, %i.bg
  %i.bi = shl nsw i64 %i.bh, 3
  %i.bj = add i64 %i.bi, %i.b
  %i.bk = sext i32 %indvars.iv85 to i64
...
vector.ph:                                        ; preds = %vector.scevcheck
  ...
  %invariant.gep120 = getelementptr [8 x i8], ptr %i.w, i64 %i.bf
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load117 = load <2 x double>, ptr %i.br, align 8, !tbaa !74
  %gep121 = getelementptr [8 x i8], ptr %invariant.gep120, i64 %index ; 2 uses
  %i.bs = getelementptr inbounds nuw i8, ptr %gep121, i64 16
  store <2 x double> %wide.load, ptr %gep121, align 8, !tbaa !74
  store <2 x double> %wide.load117, ptr %i.bs, align 8, !tbaa !74
...
scalar.ph.preheader:                              ; preds = %vector.scevcheck, %.lr.ph.us.us.us.us.us.us, %middle.block
  %indvars.iv95.ph = phi i64 [ %i.bf, %vector.scevcheck ], [ %i.bf, %.lr.ph.us.us.us.us.us.us ], [ %i.bp, %middle.block ] ; 2 uses
  %indvars.iv87.ph = phi i64 [ %i.be, %vector.scevcheck ], [ %i.be, %.lr.ph.us.us.us.us.us.us ], [ %i.bq, %middle.block ] ; 2 uses
  %.05460.us.us.us.us.us.us.ph = phi i32 [ 0, %vector.scevcheck ], [ 0, %.lr.ph.us.us.us.us.us.us ], [ %i.bd, %middle.block ] ; 4 uses
  %i.bu = sub i32 %i.av, %.05460.us.us.us.us.us.us.ph
  %xtraiter = and i32 %i.bu, 3                    ; 2 uses
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol

scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  %indvars.iv95.prol = phi i64 [ %indvars.iv.next96.prol, %scalar.ph.prol ], [ %indvars.iv95.ph, %scalar.ph.preheader ] ; 2 uses
  %indvars.iv87.prol = phi i64 [ %indvars.iv.next88.prol, %scalar.ph.prol ], [ %indvars.iv87.ph, %scalar.ph.preheader ] ; 2 uses
  %.05460.us.us.us.us.us.us.prol = phi i32 [ %i.by, %scalar.ph.prol ], [ %.05460.us.us.us.us.us.us.ph, %scalar.ph.preheader ]
  %prol.iter = phi i32 [ %prol.iter.next, %scalar.ph.prol ], [ 0, %scalar.ph.preheader ]
  %i.bv = getelementptr inbounds [8 x i8], ptr %i.s, i64 %indvars.iv87.prol
  %i.bw = load double, ptr %i.bv, align 8, !tbaa !74
  %i.bx = getelementptr inbounds [8 x i8], ptr %i.w, i64 %indvars.iv95.prol
  store double %i.bw, ptr %i.bx, align 8, !tbaa !74
  %indvars.iv.next88.prol = add nsw i64 %indvars.iv87.prol, %i.az ; 2 uses
  %indvars.iv.next96.prol = add nsw i64 %indvars.iv95.prol, %i.ba ; 2 uses
  %i.by = add nuw nsw i32 %.05460.us.us.us.us.us.us.prol, 1 ; 2 uses
  %prol.iter.next = add i32 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !79

scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  %indvars.iv95.unr = phi i64 [ %indvars.iv95.ph, %scalar.ph.preheader ], [ %indvars.iv.next96.prol, %scalar.ph.prol ]
  %indvars.iv87.unr = phi i64 [ %indvars.iv87.ph, %scalar.ph.preheader ], [ %indvars.iv.next88.prol, %scalar.ph.prol ]
  %.05460.us.us.us.us.us.us.unr = phi i32 [ %.05460.us.us.us.us.us.us.ph, %scalar.ph.preheader ], [ %i.by, %scalar.ph.prol ]
  %i.bz = sub i32 %.05460.us.us.us.us.us.us.ph, %i.av
  %i.ca = icmp ugt i32 %i.bz, -4
  br i1 %i.ca, label %._crit_edge.us.us.us.us.us.us, label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  %indvars.iv95 = phi i64 [ %indvars.iv.next96.3, %scalar.ph ], [ %indvars.iv95.unr, %scalar.ph.prol.loopexit ] ; 2 uses
  %indvars.iv87 = phi i64 [ %indvars.iv.next88.3, %scalar.ph ], [ %indvars.iv87.unr, %scalar.ph.prol.loopexit ] ; 2 uses
  %.05460.us.us.us.us.us.us = phi i32 [ %i.cn, %scalar.ph ], [ %.05460.us.us.us.us.us.us.unr, %scalar.ph.prol.loopexit ]
...
.loopexit:                                        ; preds = %._crit_edge.split.us.split.us.us.us.us, %bb.c, %.preheader58.lr.ph.split.us, %.preheader58.lr.ph.split.us.split.us, %.preheader58.lr.ph, %bb.b
