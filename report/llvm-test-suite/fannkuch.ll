...
begin_hunk_0_@main:bb.a
  ...
  %.087.i = phi i64 [ 11, %bb.a ], [ %.087.i.be, %.loopexit.i.backedge ] ; 4 uses
  %min.iters.check = phi i1 [ false, %bb.a ], [ %min.iters.check.be, %.loopexit.i.backedge ]
  %.087.i.a = phi i32 [ 11, %bb.a ], [ %.087.i.be.a, %.loopexit.i.backedge ]
...
.lr.ph.preheader.i:                               ; preds = %bb.b
  %i.bh = add nsw i64 %.087.i, -1                 ; 2 uses
  br i1 %min.iters.check, label %.lr.ph.i.preheader, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph.preheader.i
  %n.vec = and i64 %i.bh, -8                      ; 3 uses
  %i.bi = sub nsw i64 %.087.i, %n.vec
...
begin_hunk_2_@main:bb.a
  ...
  %offset.idx = sub i64 %.087.i, %index
...
.lr.ph.i.preheader:                               ; preds = %.lr.ph.preheader.i, %middle.block
  %indvars.iv.i.ph = phi i64 [ %.087.i, %.lr.ph.preheader.i ], [ %i.bi, %middle.block ]
  br label %.lr.ph.i
...
.loopexit.i.backedge:                             ; preds = %bb.n, %bb.m, %bb.l, %bb.k, %bb.j, %bb.i, %bb.h, %bb.g, %bb.f, %bb.e
  ...
  %.087.i.be = phi i64 [ 1, %bb.e ], [ 2, %bb.f ], [ 3, %bb.g ], [ 4, %bb.h ], [ 5, %bb.i ], [ 6, %bb.j ], [ 7, %bb.k ], [ 8, %bb.l ], [ 9, %bb.m ], [ 10, %bb.n ]
