...
bb.a:
  ...
  %i.e = select i1 %i.c, ptr %1, ptr %2           ; 14 uses
...
bb.n:                                             ; preds = %_ZN20btAlignedObjectArrayIP20btPersistentManifoldED2Ev.exit
  ...
  %i.cy = getelementptr inbounds nuw i8, ptr %i.e, i64 56 ; 2 uses
  ...
  %i.dd = fneg <3 x float> %i.dc                  ; 5 uses
  %i.de = shufflevector <3 x float> %i.dd, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  ...
  %16 = load <3 x float>, ptr %i.cy, align 4, !tbaa !71, !noalias !117 ; 5 uses
  %17 = load float, ptr %i.cy, align 4, !tbaa !71, !noalias !117
  %i.dk = shufflevector <3 x float> %16, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.dl = fmul <2 x float> %i.da, %i.dk
  %i.dm = shufflevector <3 x float> %16, <3 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.do = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.db, <2 x float> %18, <2 x float> %i.dn)
  ...
  %19 = shufflevector <3 x float> %i.dd, <3 x float> %16, <2 x i32> <i32 1, i32 4>
  %i.ds = fmul <2 x float> %i.dr, %19
  ...
  %20 = insertelement <2 x float> %i.dg, float %17, i64 1
  %i.dv = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.du, <2 x float> %20, <2 x float> %i.ds)
  ...
  %21 = shufflevector <3 x float> %i.dd, <3 x float> %16, <2 x i32> <i32 2, i32 5>
  %i.dy = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dx, <2 x float> %21, <2 x float> %i.dv) ; 2 uses
...
bb.a:
  ...
  %11 = extractelement <4 x float> %i.f, i64 0
  %i.y = getelementptr inbounds nuw i8, ptr %i.w, i64 32
  %12 = extractelement <4 x float> %i.f, i64 2
  ...
  %i.af = extractelement <4 x float> %i.h, i64 0
  %i.ag = extractelement <4 x float> %i.h, i64 2
  %13 = extractelement <4 x float> %i.j, i64 0
  %14 = extractelement <4 x float> %i.j, i64 2
  %i.ah = getelementptr inbounds nuw i8, ptr %i.w, i64 48
  %i.ai = load float, ptr %i.ah, align 4, !tbaa !71, !noalias !137 ; 3 uses
  %15 = getelementptr inbounds nuw i8, ptr %i.w, i64 52
  %i.aj = load float, ptr %15, align 4, !tbaa !71, !noalias !137 ; 3 uses
  %16 = fmul float %.sroa.5.0.copyload, %i.aj
  %17 = tail call float @llvm.fmuladd.f32(float %11, float %i.ai, float %16)
  %18 = getelementptr inbounds nuw i8, ptr %i.w, i64 56
  %19 = load float, ptr %18, align 4, !tbaa !71, !noalias !137 ; 3 uses
  %20 = tail call noundef float @llvm.fmuladd.f32(float %12, float %19, float %17)
  %21 = extractelement <4 x float> %i.l, i64 0
  %22 = fadd float %21, %20
  %23 = fmul float %.sroa.10.16.copyload, %i.aj
  %24 = tail call float @llvm.fmuladd.f32(float %i.af, float %i.ai, float %23)
  %25 = tail call noundef float @llvm.fmuladd.f32(float %i.ag, float %19, float %24)
  %26 = fadd float %.sroa.20.48.copyload, %25
  %i.ak = fmul float %.sroa.15.32.copyload, %i.aj
  %i.al = tail call float @llvm.fmuladd.f32(float %13, float %i.ai, float %i.ak)
  %i.am = tail call noundef float @llvm.fmuladd.f32(float %14, float %19, float %i.al)
  ...
  store <2 x float> %.sroa.0.4.vec.insert.i.i, ptr %i.cq, align 16, !alias.scope !137
