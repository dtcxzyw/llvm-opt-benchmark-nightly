...
bb.a:
  ...
  %i.d = select i1 %i.c, ptr %2, ptr %1           ; 20 uses
...
bb.n:                                             ; preds = %_ZN20btAlignedObjectArrayIP20btPersistentManifoldED2Ev.exit
  ...
  %16 = getelementptr inbounds nuw i8, ptr %i.d, i64 60
  %17 = getelementptr inbounds nuw i8, ptr %i.d, i64 64
  ...
  %18 = load float, ptr %16, align 4, !tbaa !71, !noalias !116
  %19 = load float, ptr %i.co, align 8, !tbaa !71, !noalias !116
  %20 = load float, ptr %17, align 8, !tbaa !71, !noalias !116
  %21 = fneg float %18                            ; 2 uses
  %22 = fneg float %19                            ; 2 uses
  %23 = fneg float %20
  %24 = insertelement <2 x float> poison, float %21, i64 0
  %25 = shufflevector <2 x float> %24, <2 x float> poison, <2 x i32> zeroinitializer
  %i.dd = fmul <2 x float> %i.db, %25
  %26 = insertelement <2 x float> poison, float %22, i64 0
  %i.de = shufflevector <2 x float> %26, <2 x float> poison, <2 x i32> zeroinitializer
  %i.df = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.da, <2 x float> %i.de, <2 x float> %i.dd)
  %27 = insertelement <2 x float> poison, float %23, i64 0 ; 2 uses
  %28 = shufflevector <2 x float> %27, <2 x float> poison, <2 x i32> zeroinitializer
  %i.dg = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dc, <2 x float> %28, <2 x float> %i.df)
  ...
  %29 = shufflevector <2 x float> %i.dk, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  ...
  %30 = insertelement <2 x float> %i.dk, float %21, i64 0
  %i.dt = fmul <2 x float> %i.ds, %30
  ...
  %31 = insertelement <2 x float> %29, float %22, i64 0
  %i.dw = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dv, <2 x float> %31, <2 x float> %i.dt)
  ...
  %i.dz = insertelement <2 x float> %27, float %i.dh, i64 1
