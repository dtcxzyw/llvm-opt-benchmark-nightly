...
begin_hunk_0_@toggle_move:bb.a
  %i.ch = load i32, ptr %i.cg, align 4, !tbaa !4
  %.not37 = icmp eq i32 %i.ch, %.sroa.033.0.extract.trunc
...
.lr.ph64.preheader:                               ; preds = %bb.g
  %5 = zext nneg i32 %.477 to i64                 ; 3 uses
...
.lr.ph64.prol:                                    ; preds = %.lr.ph64.preheader, %.lr.ph64.prol
  %indvars.iv73.prol = phi i64 [ %indvars.iv.next74.prol, %.lr.ph64.prol ], [ %5, %.lr.ph64.preheader ] ; 2 uses
  %prol.iter = phi i64 [ %prol.iter.next, %.lr.ph64.prol ], [ 0, %.lr.ph64.preheader ]
  %6 = getelementptr inbounds nuw [12 x i8], ptr %0, i64 %indvars.iv73.prol ; 2 uses
  %7 = getelementptr i8, ptr %6, i64 -12
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %6, ptr noundef nonnull align 4 dereferenceable(12) %7, i64 12, i1 false), !tbaa.struct !15
...
.lr.ph64.prol.loopexit:                           ; preds = %.lr.ph64.prol, %.lr.ph64.preheader
  %indvars.iv73.unr = phi i64 [ %5, %.lr.ph64.preheader ], [ %indvars.iv.next74.prol, %.lr.ph64.prol ]
  %8 = icmp ult i32 %.477, 4
  br i1 %8, label %._crit_edge, label %.lr.ph64
...
.lr.ph64:                                         ; preds = %.lr.ph64.prol.loopexit, %.lr.ph64
  ...
  %9 = getelementptr inbounds nuw [12 x i8], ptr %0, i64 %indvars.iv73 ; 2 uses
  %10 = getelementptr i8, ptr %9, i64 -12
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %9, ptr noundef nonnull align 4 dereferenceable(12) %10, i64 12, i1 false), !tbaa.struct !15
  %11 = getelementptr [12 x i8], ptr %0, i64 %indvars.iv73 ; 2 uses
  %12 = getelementptr i8, ptr %11, i64 -12
  %13 = getelementptr i8, ptr %11, i64 -24
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %12, ptr noundef nonnull align 4 dereferenceable(12) %13, i64 12, i1 false), !tbaa.struct !15
  %14 = getelementptr [12 x i8], ptr %0, i64 %indvars.iv73 ; 2 uses
  %15 = getelementptr i8, ptr %14, i64 -24
  %i.t = getelementptr i8, ptr %14, i64 -36
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %15, ptr noundef nonnull align 4 dereferenceable(12) %i.t, i64 12, i1 false), !tbaa.struct !15
  %16 = getelementptr [12 x i8], ptr %0, i64 %indvars.iv73 ; 2 uses
  %17 = getelementptr i8, ptr %16, i64 -36
  %i.u = getelementptr i8, ptr %16, i64 -48
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %17, ptr noundef nonnull align 4 dereferenceable(12) %i.u, i64 12, i1 false), !tbaa.struct !15
  %indvars.iv.next74.3 = add nsw i64 %indvars.iv73, -4
  %18 = icmp sgt i64 %indvars.iv73, 4
  br i1 %18, label %.lr.ph64, label %._crit_edge, !llvm.loop !18
...
bb.e:                                             ; preds = %bb.d, %bb.c
  %.1 = phi i32 [ %i.fc, %bb.d ], [ %i.dy, %bb.c ] ; 2 uses
  %i.fd = add nsw i32 %.sroa.272.0.extract.trunc, -1 ; 2 uses
  %.not78 = icmp eq i32 %i.fd, 0
  br i1 %.not78, label %bb.g, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.fe = sext i32 %i.fd to i64                   ; 2 uses
  %i.ff = getelementptr [4 x i8], ptr %i.l, i64 %i.fe ; 3 uses
  ...
  %i.fk = and i32 %i.fj, %i.fh                    ; 2 uses
  %i.fl = load i32, ptr %i.ff, align 4, !tbaa !4  ; 2 uses
  %i.fm = shl i32 %i.fl, 1
  %i.fn = or i32 %i.fm, %i.fl
  %i.fo = xor i32 %i.fn, -1
  %i.fp = shl i32 %i.fk, 1
  %i.fq = and i32 %i.fp, %i.fo
  %i.fr = and i32 %i.fq, %i.fk                    ; 2 uses
  %i.fs = and i32 %i.fr, 65534
  %i.ft = zext nneg i32 %i.fs to i64
  %i.fu = getelementptr inbounds nuw [4 x i8], ptr @move_table16, i64 %i.ft
  %i.fv = load i32, ptr %i.fu, align 8, !tbaa !4  ; 2 uses
  %.not.i.i92 = icmp ult i32 %i.fv, 268435456
  %i.fw = lshr i32 %i.fr, 16
  %i.fx = zext nneg i32 %i.fw to i64
  %i.fy = getelementptr inbounds nuw [4 x i8], ptr @move_table16, i64 %i.fx
  %i.fz = load i32, ptr %i.fy, align 4, !tbaa !4
  %i.ga = add i32 %i.fz, %i.fv
  %..i.i93 = select i1 %.not.i.i92, i32 65535, i32 65534
  %i.gb = and i32 %i.ga, %..i.i93
  %i.gc = getelementptr inbounds [12 x i8], ptr %i.bd, i64 %i.fe
  %i.gd = load i32, ptr %i.gc, align 4, !tbaa !8
  %.neg79 = add i32 %i.gd, %.1
  %i.ge = sub i32 %.neg79, %i.gb
  br label %bb.g

bb.g:                                             ; preds = %bb.f, %bb.e
  %.2 = phi i32 [ %i.ge, %bb.f ], [ %.1, %bb.e ]  ; 2 uses
  %i.gf = getelementptr inbounds [4 x i8], ptr @g_board_size, i64 %i.k
  %i.gg = load i32, ptr %i.gf, align 4, !tbaa !4
  %.not80 = icmp eq i32 %i.q, %i.gg
  br i1 %.not80, label %bb.i, label %bb.h

bb.h:                                             ; preds = %bb.g
  %sext99 = add i64 %0, 8589934592
  %i.gh = ashr i64 %sext99, 32                    ; 2 uses
  %i.gi = getelementptr [4 x i8], ptr %i.l, i64 %i.gh ; 3 uses
  ...
  %i.gn = and i32 %i.gm, %i.gk                    ; 2 uses
  %i.go = load i32, ptr %i.gi, align 4, !tbaa !4  ; 2 uses
  %i.gp = shl i32 %i.go, 1
  %i.gq = or i32 %i.gp, %i.go
  %i.gr = xor i32 %i.gq, -1
  %i.gs = shl i32 %i.gn, 1
  %i.gt = and i32 %i.gs, %i.gr
  %i.gu = and i32 %i.gt, %i.gn                    ; 2 uses
  %i.gv = and i32 %i.gu, 65534
  %i.gw = zext nneg i32 %i.gv to i64
  %i.gx = getelementptr inbounds nuw [4 x i8], ptr @move_table16, i64 %i.gw
  %i.gy = load i32, ptr %i.gx, align 8, !tbaa !4  ; 2 uses
  %.not.i.i94 = icmp ult i32 %i.gy, 268435456
  %i.gz = lshr i32 %i.gu, 16
  %i.ha = zext nneg i32 %i.gz to i64
  %i.hb = getelementptr inbounds nuw [4 x i8], ptr @move_table16, i64 %i.ha
  %i.hc = load i32, ptr %i.hb, align 4, !tbaa !4
  %i.hd = add i32 %i.hc, %i.gy
  %..i.i95 = select i1 %.not.i.i94, i32 65535, i32 65534
  %i.he = and i32 %i.hd, %..i.i95
  %i.hf = getelementptr inbounds [12 x i8], ptr %i.bd, i64 %i.gh
  %i.hg = load i32, ptr %i.hf, align 4, !tbaa !8
  %.neg81 = add i32 %i.hg, %.2
  %i.hh = sub i32 %.neg81, %i.he
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.g
  %.3 = phi i32 [ %i.hh, %bb.h ], [ %.2, %bb.g ]
  %i.hi = load i32, ptr %i.g, align 4, !tbaa !4
  %i.hj = xor i32 %i.hi, %i.c
  store i32 %i.hj, ptr %i.g, align 4, !tbaa !4
  %i.hk = load i32, ptr %i.n, align 4, !tbaa !4
  %i.hl = xor i32 %i.hk, %i.j
  store i32 %i.hl, ptr %i.n, align 4, !tbaa !4
  %i.hm = load i32, ptr %i.s, align 4, !tbaa !4
  %i.hn = xor i32 %i.hm, %i.j
  store i32 %i.hn, ptr %i.s, align 4, !tbaa !4
  %i.ho = shl nsw i32 %.3, 7
  %i.hp = sext i32 %1 to i64
  %i.hq = getelementptr inbounds [4096 x i8], ptr @g_first_move, i64 %i.hp
  %i.hr = getelementptr inbounds [128 x i8], ptr %i.hq, i64 %i.f
  %i.hs = getelementptr inbounds [4 x i8], ptr %i.hr, i64 %i.m
  %i.ht = load i32, ptr %i.hs, align 4, !tbaa !4
  %i.hu = add nsw i32 %i.ht, %i.ho
  ret i32 %i.hu
}

declare void @_fatal_error_aux(ptr noundef, i32 noundef, i32 noundef, ptr noundef, ...) local_unnamed_addr #4
