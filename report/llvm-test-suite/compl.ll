...
compl_special_cases.exit:                         ; preds = %bb.y
  %i.cg = load i32, ptr @cube, align 8, !tbaa !11 ; 3 uses
  ...
  %i.co = tail call ptr (ptr, i32, ...) @set_clear(ptr noundef %i.cn, i32 noundef %i.cg) #8 ; 5 uses
  %i.cp = load i32, ptr @cube, align 8, !tbaa !11 ; 3 uses
  ...
  %i.cx = tail call ptr (ptr, i32, ...) @set_clear(ptr noundef %i.cw, i32 noundef %i.cp) #8 ; 5 uses
...
bb.j:                                             ; preds = %._crit_edge
  %i.cc = load i32, ptr @cube, align 8, !tbaa !11 ; 3 uses
  ...
  %i.ck = tail call ptr (ptr, i32, ...) @set_clear(ptr noundef %i.cj, i32 noundef %i.cc) #8, !inline_history !32 ; 4 uses
...
simp_comp_special_cases.exit:                     ; preds = %bb.q
  %i.ev = load i32, ptr @cube, align 8, !tbaa !11 ; 3 uses
  ...
  %i.fd = tail call ptr (ptr, i32, ...) @set_clear(ptr noundef %i.fc, i32 noundef %i.ev) #8 ; 6 uses
  %i.fe = load i32, ptr @cube, align 8, !tbaa !11 ; 3 uses
  ...
  %i.fm = tail call ptr (ptr, i32, ...) @set_clear(ptr noundef %i.fl, i32 noundef %i.fe) #8 ; 6 uses
...
bb.j:                                             ; preds = %._crit_edge
  %i.bs = load i32, ptr @cube, align 8, !tbaa !11 ; 3 uses
  ...
  %i.ca = tail call ptr (ptr, i32, ...) @set_clear(ptr noundef %i.bz, i32 noundef %i.bs) #8, !inline_history !50 ; 4 uses
...
simplify_special_cases.exit:                      ; preds = %bb.q
  %i.ed = load i32, ptr @cube, align 8, !tbaa !11 ; 3 uses
  ...
  %i.el = tail call ptr (ptr, i32, ...) @set_clear(ptr noundef %i.ek, i32 noundef %i.ed) #8 ; 5 uses
  %i.em = load i32, ptr @cube, align 8, !tbaa !11 ; 3 uses
  ...
  %i.eu = tail call ptr (ptr, i32, ...) @set_clear(ptr noundef %i.et, i32 noundef %i.em) #8 ; 5 uses
