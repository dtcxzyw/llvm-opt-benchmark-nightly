...
begin_hunk_0_@_ZN8NArchive4NCab10CCheckSum26UpdateEPKvj:bb.a
  ...
  %.02740 = phi ptr [ %1, %.lr.ph ], [ %i.j, %.loopexit ] ; 6 uses
...
begin_hunk_2_@_ZN8NArchive4NCab10CCheckSum26UpdateEPKvj:bb.a
  ...
  %i.al = getelementptr i8, ptr %.02740, i64 %i.ak ; 2 uses
...
begin_hunk_3_@_ZN8NArchive4NCab10CCheckSum26UpdateEPKvj:bb.a
  ...
  br i1 %cmp.n, label %._crit_edge, label %.lr.ph52.preheader89
...
begin_hunk_4_@_ZN8NArchive4NCab10CCheckSum26UpdateEPKvj:bb.a
  ...
  %i.au = getelementptr inbounds nuw i8, ptr %.12850, i64 4 ; 2 uses
  %i.av = xor i32 %i.at, %.349                    ; 2 uses
  %.not34 = icmp eq i32 %i.as, 0
  br i1 %.not34, label %._crit_edge, label %.lr.ph52, !llvm.loop !31

._crit_edge:                                      ; preds = %.lr.ph52, %middle.block, %.critedge
  %.3.lcssa = phi i32 [ %.02939, %.critedge ], [ %i.ar, %middle.block ], [ %i.av, %.lr.ph52 ]
  %.128.lcssa = phi ptr [ %.02740, %.critedge ], [ %i.al, %middle.block ], [ %i.au, %.lr.ph52 ] ; 3 uses
