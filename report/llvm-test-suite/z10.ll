...
.thread:                                          ; preds = %bb.j, %bb.k
  %.ph = phi i32 [ 128, %bb.k ], [ 134, %bb.j ]   ; 2 uses
  %trunc165 = trunc nuw i32 %.ph to i8
  br label %bb.aa
...
bb.aa:                                            ; preds = %bb.l, %.thread
  %trunc166 = phi i8 [ %trunc165, %.thread ], [ 127, %bb.l ]
  %5 = phi i32 [ %.ph, %.thread ], [ 127, %bb.l ] ; 2 uses
...
begin_hunk_2_@CrossExpand:bb.a
  ...
  %i.cx = call ptr @CrossMake(ptr noundef nonnull %i.af, ptr noundef %i.cw, i32 noundef %5) ; 5 uses
  %6 = zext nneg i32 %5 to i64
  %i.cy = getelementptr inbounds nuw i8, ptr @zz_lengths, i64 %6
