...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.bx, label %middle.block, label %vector.body, !llvm.loop !603
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.cc, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !605
...
.loopexit30:                                      ; preds = %.lr.ph.i.i.i.i.i, %middle.block, %vec.epilog.middle.block, %.noexc17
  ...
  %i.cj = load ptr, ptr %i.ci, align 8, !tbaa !563 ; 2 uses
  %i.ck = load ptr, ptr %i.ch, align 8, !tbaa !488 ; 2 uses
...
bb.l:                                             ; preds = %.loopexit30
  ...
  br i1 %i.co, label %.noexc.i.i25, label %_ZNSt15__new_allocatorINSt7__cxx1112regex_traitsIcE10_RegexMaskEE8allocateEmPKv.exit.i.i.i.i, !prof !109
...
.noexc27:                                         ; preds = %_ZNSt15__new_allocatorINSt7__cxx1112regex_traitsIcE10_RegexMaskEE8allocateEmPKv.exit.i.i.i.i, %.loopexit30
  ...
  store ptr %i.cq, ptr %i.cg, align 8, !tbaa !488
  %i.cr = getelementptr inbounds nuw i8, ptr %0, i64 80 ; 2 uses
  store ptr %i.cq, ptr %i.cr, align 8, !tbaa !563
  %i.cs = getelementptr inbounds nuw i8, ptr %i.cq, i64 %i.cn
  %i.ct = getelementptr inbounds nuw i8, ptr %0, i64 88
  store ptr %i.cs, ptr %i.ct, align 8, !tbaa !485
  %i.cu = load ptr, ptr %i.ch, align 8, !tbaa !484 ; 6 uses
  %i.cv = load ptr, ptr %i.ci, align 8, !tbaa !484 ; 3 uses
...
vector.body66:                                    ; preds = %vector.body66, %vector.ph63
  ...
  br i1 %i.dj, label %middle.block73, label %vector.body66, !llvm.loop !607
...
.loopexit:                                        ; preds = %.lr.ph.i.i.i.i.i20, %middle.block73, %.noexc27
  ...
  store ptr %.0.lcssa.i.i.i.i.i24, ptr %i.cr, align 8, !tbaa !563
...
.body:                                            ; preds = %bb.m, %bb.i, %bb.h, %_ZNSt6vectorISt4pairIccESaIS1_EED2Ev.exit
  ...
  %i.dx = load ptr, ptr %0, align 8, !tbaa !490   ; 3 uses
  %.not.i.i.i29 = icmp eq ptr %i.dx, null
  br i1 %.not.i.i.i29, label %_ZNSt6vectorIcSaIcEED2Ev.exit, label %bb.q

bb.q:                                             ; preds = %.body
  %i.dy = load ptr, ptr %i.l, align 8, !tbaa !481
  %i.dz = ptrtoint ptr %i.dy to i64
  %i.ea = ptrtoint ptr %i.dx to i64
  %i.eb = sub i64 %i.dz, %i.ea
  tail call void @_ZdlPvm(ptr noundef nonnull %i.dx, i64 noundef %i.eb) #34
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.bx = icmp eq i64 %index.next, %n.vec
  br i1 %i.bx, label %middle.block, label %vector.body, !llvm.loop !651
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %index.next56 = add nuw i64 %index52, 4         ; 2 uses
  %i.cc = icmp eq i64 %index.next56, %n.vec51
  br i1 %i.cc, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !652
...
vector.body66:                                    ; preds = %vector.body66, %vector.ph63
  ...
  %index.next72 = add nuw i64 %index67, 8         ; 2 uses
  %i.dj = icmp eq i64 %index.next72, %n.vec65
  br i1 %i.dj, label %middle.block73, label %vector.body66, !llvm.loop !654
...
end_hunk_3
begin_hunk_4_@_ZNSt8__detail9_ExecutorIN9__gnu_cxx17__normal_iteratorIPKcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEESaINS5_9sub_matchISB_EEENS5_12regex_traitsIcEELb1EE12_M_lookaheadEl:bb.a
...
bb.a:
  ...
  br i1 %i.h, label %bb.b, label %_ZNKSt6vectorISt10unique_ptrIN9benchmark8internal9BenchmarkESt14default_deleteIS3_EESaIS6_EE12_M_check_lenEmPKc.exit
...
_ZNKSt6vectorISt10unique_ptrIN9benchmark8internal9BenchmarkESt14default_deleteIS3_EESaIS6_EE12_M_check_lenEmPKc.exit: ; preds = %bb.a
  ...
  %i.q = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.p) #36 ; 10 uses
  %i.r = getelementptr inbounds nuw i8, ptr %i.q, i64 %i.o
  %i.s = load i64, ptr %2, align 8, !tbaa !14
...
_ZNSt6vectorISt10unique_ptrIN9benchmark8internal9BenchmarkESt14default_deleteIS3_EESaIS6_EE11_S_relocateEPS6_S9_S9_RS7_.exit: ; preds = %.lr.ph.i.i.i, %middle.block, %_ZNKSt6vectorISt10unique_ptrIN9benchmark8internal9BenchmarkESt14default_deleteIS3_EESaIS6_EE12_M_check_lenEmPKc.exit
  %.0.lcssa.i.i.i = phi ptr [ %i.q, %_ZNKSt6vectorISt10unique_ptrIN9benchmark8internal9BenchmarkESt14default_deleteIS3_EESaIS6_EE12_M_check_lenEmPKc.exit ], [ %i.ab, %middle.block ], [ %i.ak, %.lr.ph.i.i.i ] ; 2 uses
...
vector.body50:                                    ; preds = %vector.body50, %vector.ph47
  ...
  %wide.load55 = load <2 x i64>, ptr %i.ay, align 8, !tbaa !14, !alias.scope !913, !noalias !908
  ...
  store <2 x i64> %wide.load55, ptr %i.az, align 8, !tbaa !14, !alias.scope !916, !noalias !913
  ...
  store <2 x ptr> splat (ptr null), ptr %i.ba, align 8, !tbaa !14, !alias.scope !913, !noalias !908
  %index.next56 = add nuw i64 %index51, 4         ; 2 uses
  %i.bb = icmp eq i64 %index.next56, %n.vec49
  br i1 %i.bb, label %middle.block57, label %vector.body50, !llvm.loop !918
...
.lr.ph.i.i.i17:                                   ; preds = %.lr.ph.i.i.i17.preheader61, %.lr.ph.i.i.i17
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !908)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !911)
  %i.bc = load i64, ptr %.0911.i.i.i19, align 8, !tbaa !14, !alias.scope !911, !noalias !908
  store i64 %i.bc, ptr %.012.i.i.i18, align 8, !tbaa !14, !alias.scope !908, !noalias !911
...
_ZNSt6vectorISt10unique_ptrIN9benchmark8internal9BenchmarkESt14default_deleteIS3_EESaIS6_EE11_S_relocateEPS6_S9_S9_RS7_.exit22: ; preds = %.lr.ph.i.i.i17, %middle.block57, %_ZNSt6vectorISt10unique_ptrIN9benchmark8internal9BenchmarkESt14default_deleteIS3_EESaIS6_EE11_S_relocateEPS6_S9_S9_RS7_.exit
  %.0.lcssa.i.i.i21 = phi ptr [ %i.al, %_ZNSt6vectorISt10unique_ptrIN9benchmark8internal9BenchmarkESt14default_deleteIS3_EESaIS6_EE11_S_relocateEPS6_S9_S9_RS7_.exit ], [ %i.av, %middle.block57 ], [ %i.be, %.lr.ph.i.i.i17 ]
...
bb.c:                                             ; preds = %_ZNSt6vectorISt10unique_ptrIN9benchmark8internal9BenchmarkESt14default_deleteIS3_EESaIS6_EE11_S_relocateEPS6_S9_S9_RS7_.exit22
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %i.d, i64 noundef %i.bi) #34
...
_ZNSt12_Vector_baseISt10unique_ptrIN9benchmark8internal9BenchmarkESt14default_deleteIS3_EESaIS6_EE13_M_deallocateEPS6_m.exit: ; preds = %_ZNSt6vectorISt10unique_ptrIN9benchmark8internal9BenchmarkESt14default_deleteIS3_EESaIS6_EE11_S_relocateEPS6_S9_S9_RS7_.exit22, %bb.c
  ...
  store ptr %.0.lcssa.i.i.i21, ptr %i.b, align 8, !tbaa !13
...
end_hunk_4
begin_hunk_5_@_ZNSt6vectorIN9benchmark8internal17BenchmarkInstanceESaIS2_EE17_M_realloc_insertIJS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_:bb.a
...
_ZNSt6vectorIlSaIlEE9push_backERKl.exit:          ; preds = %_ZNSt6vectorIlSaIlEE17_M_realloc_insertIJRKlEEEvN9__gnu_cxx17__normal_iteratorIPlS1_EEDpOT_.exit.i, %bb.j, %bb.h
  ...
  br i1 %or.cond, label %_ZNSt6vectorIlSaIlEE9push_backERKl.exit._crit_edge.loopexit, label %bb.h, !llvm.loop !953

end_hunk_5
begin_hunk_6_@_ZNSt6vectorIN9benchmark8internal10StatisticsESaIS2_EE17_M_realloc_insertIJRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERPFdRKS_IdSaIdEEERNS0_13StatisticUnitEEEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_:bb.a
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.y = shl i64 %index, 2
  %next.gep = getelementptr i8, ptr %i.o, i64 %i.y ; 3 uses
  %i.z = getelementptr i8, ptr %next.gep, i64 16  ; 2 uses
  %wide.load = load <4 x i32>, ptr %next.gep, align 4, !tbaa !4
  %wide.load19 = load <4 x i32>, ptr %i.z, align 4, !tbaa !4
  %i.aa = sub nsw <4 x i32> zeroinitializer, %wide.load
  %i.ab = sub nsw <4 x i32> zeroinitializer, %wide.load19
  store <4 x i32> %i.aa, ptr %next.gep, align 4, !tbaa !4
  store <4 x i32> %i.ab, ptr %i.z, align 4, !tbaa !4
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ac = icmp eq i64 %index.next, %n.vec
  br i1 %i.ac, label %middle.block, label %vector.body, !llvm.loop !979
...
.lr.ph.i.preheader45:                             ; preds = %.lr.ph.i.preheader, %middle.block
  %.sroa.01.05.i.ph = phi ptr [ %i.o, %.lr.ph.i.preheader ], [ %i.x, %middle.block ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader45, %.lr.ph.i
  %.sroa.01.05.i = phi ptr [ %i.af, %.lr.ph.i ], [ %.sroa.01.05.i.ph, %.lr.ph.i.preheader45 ] ; 3 uses
  %i.ad = load i32, ptr %.sroa.01.05.i, align 4, !tbaa !4
  %i.ae = sub nsw i32 0, %i.ad
  store i32 %i.ae, ptr %.sroa.01.05.i, align 4, !tbaa !4
  %i.af = getelementptr inbounds nuw i8, ptr %.sroa.01.05.i, i64 4 ; 2 uses
  %.not.i17 = icmp eq ptr %i.af, %i.r
...
vector.memcheck:                                  ; preds = %.lr.ph.i.i.preheader
  ...
  %i.aq = add i64 %umax, -4                       ; 2 uses
  %i.ar = icmp ne i64 %i.aq, %i.p
  %umin = zext i1 %i.ar to i64                    ; 2 uses
  %i.as = add i64 %i.p, %umin
  ...
  %scevgep20 = getelementptr i8, ptr %i.r, i64 %i.ay
...
vector.ph25:                                      ; preds = %vector.memcheck
  %n.vec27 = and i64 %i.an, 9223372036854775800   ; 4 uses
  %i.az = mul i64 %n.vec27, -4
  %i.ba = getelementptr i8, ptr %.sroa.0.08.i.i, i64 %i.az
  %i.bb = shl i64 %n.vec27, 2
...
vector.body28:                                    ; preds = %vector.body28, %vector.ph25
  ...
  %i.bd = mul i64 %index29, -4
  %next.gep30 = getelementptr i8, ptr %.sroa.0.08.i.i, i64 %i.bd ; 2 uses
  %i.be = shl i64 %index29, 2
  %next.gep31 = getelementptr i8, ptr %i.o, i64 %i.be ; 3 uses
  %i.bf = getelementptr i8, ptr %next.gep31, i64 16 ; 2 uses
  %wide.load32.a = load <4 x i32>, ptr %next.gep31, align 4, !tbaa !4, !alias.scope !981, !noalias !984
  %wide.load33.a = load <4 x i32>, ptr %i.bf, align 4, !tbaa !4, !alias.scope !981, !noalias !984
  %i.bg = getelementptr i8, ptr %next.gep30, i64 -12 ; 2 uses
  %i.bh = getelementptr i8, ptr %next.gep30, i64 -28 ; 2 uses
  %wide.load34 = load <4 x i32>, ptr %i.bg, align 4, !tbaa !4, !alias.scope !984
  %wide.load35 = load <4 x i32>, ptr %i.bh, align 4, !tbaa !4, !alias.scope !984
  %reverse = shufflevector <4 x i32> %wide.load34, <4 x i32> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %reverse36.a = shufflevector <4 x i32> %wide.load35, <4 x i32> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  store <4 x i32> %reverse, ptr %next.gep31, align 4, !tbaa !4, !alias.scope !981, !noalias !984
  store <4 x i32> %reverse36.a, ptr %i.bf, align 4, !tbaa !4, !alias.scope !981, !noalias !984
  %reverse37 = shufflevector <4 x i32> %wide.load32.a, <4 x i32> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %reverse38 = shufflevector <4 x i32> %wide.load33.a, <4 x i32> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  store <4 x i32> %reverse37, ptr %i.bg, align 4, !tbaa !4, !alias.scope !984
  store <4 x i32> %reverse38, ptr %i.bh, align 4, !tbaa !4, !alias.scope !984
  %index.next39 = add nuw i64 %index29, 8         ; 2 uses
  %i.bi = icmp eq i64 %index.next39, %n.vec27
  br i1 %i.bi, label %middle.block40, label %vector.body28, !llvm.loop !986

middle.block40:                                   ; preds = %vector.body28
  %cmp.n41 = icmp eq i64 %i.an, %n.vec27
...
.lr.ph.i.i.preheader44:                           ; preds = %vector.memcheck, %.lr.ph.i.i.preheader, %middle.block40
  %.sroa.0.010.i.i.ph = phi ptr [ %.sroa.0.08.i.i, %vector.memcheck ], [ %.sroa.0.08.i.i, %.lr.ph.i.i.preheader ], [ %i.ba, %middle.block40 ]
  %.sroa.05.09.i.i.ph = phi ptr [ %i.o, %vector.memcheck ], [ %i.o, %.lr.ph.i.i.preheader ], [ %i.bc, %middle.block40 ]
  br label %.lr.ph.i.i
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader44, %.lr.ph.i.i
  ...
  %.sroa.05.09.i.i = phi ptr [ %i.bl, %.lr.ph.i.i ], [ %.sroa.05.09.i.i.ph, %.lr.ph.i.i.preheader44 ] ; 3 uses
  %i.bj = load i32, ptr %.sroa.05.09.i.i, align 4, !tbaa !4
  %i.bk = load i32, ptr %.sroa.0.010.i.i, align 4, !tbaa !4
  store i32 %i.bk, ptr %.sroa.05.09.i.i, align 4, !tbaa !4
  store i32 %i.bj, ptr %.sroa.0.010.i.i, align 4, !tbaa !4
  %i.bl = getelementptr inbounds nuw i8, ptr %.sroa.05.09.i.i, i64 4 ; 2 uses
  %.sroa.0.0.i.i = getelementptr inbounds i8, ptr %.sroa.0.010.i.i, i64 -4 ; 2 uses
  %i.bm = icmp ult ptr %i.bl, %.sroa.0.0.i.i
  br i1 %i.bm, label %.lr.ph.i.i, label %_ZSt7reverseIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEEvT_S7_.exit, !llvm.loop !987
...
bb.n:                                             ; preds = %_ZNSt6vectorIiSaIiEE11_S_relocateEPiS2_S2_RS0_.exit16.i.i
  tail call void @_ZdlPvm(ptr noundef nonnull %i.n, i64 noundef %i.t) #34
