...
bb.a:
  ...
  %i.b = load double, ptr @four, align 8, !tbaa !8 ; 2 uses
  %i.c = fmul double %i.b, 1.562500e+08
  %i.d = fdiv double %i.a, %i.c                   ; 2 uses
  %i.e = load double, ptr @A6, align 8, !tbaa !8  ; 2 uses
  %i.f = load double, ptr @A5, align 8, !tbaa !8  ; 2 uses
  %i.g = load double, ptr @A4, align 8, !tbaa !8  ; 2 uses
  %i.h = load double, ptr @A3, align 8, !tbaa !8  ; 2 uses
  %i.i = load double, ptr @A2, align 8, !tbaa !8  ; 2 uses
  %i.j = load double, ptr @A1, align 8, !tbaa !8  ; 2 uses
  %i.k = load double, ptr @one, align 8, !tbaa !8 ; 4 uses
  %i.l = load double, ptr @B6, align 8, !tbaa !8  ; 2 uses
  %i.m = load double, ptr @B5, align 8, !tbaa !8  ; 2 uses
  %i.n = load double, ptr @B4, align 8, !tbaa !8  ; 2 uses
...
bb.b:                                             ; preds = %bb.a, %bb.b
  %.044 = phi double [ 0.000000e+00, %bb.a ], [ %i.af, %bb.b ]
  ...
  %i.ae = tail call double @llvm.fmuladd.f64(double %i.t, double %i.ad, double %i.k)
  %i.af = tail call double @llvm.fmuladd.f64(double %i.z, double %i.ae, double %.044) ; 2 uses
  %i.ag = add nuw nsw i64 %.04043, 1              ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.aj = tail call double @llvm.fmuladd.f64(double %i.e, double %i.ai, double %i.f)
  %i.ak = tail call double @llvm.fmuladd.f64(double %i.aj, double %i.ai, double %i.g)
  %i.al = tail call double @llvm.fmuladd.f64(double %i.ak, double %i.ai, double %i.h)
  %i.am = tail call double @llvm.fmuladd.f64(double %i.al, double %i.ai, double %i.i)
  %i.an = tail call double @llvm.fmuladd.f64(double %i.am, double %i.ai, double %i.j)
  %i.ao = tail call double @llvm.fmuladd.f64(double %i.an, double %i.ai, double %i.k)
  %i.ap = fmul double %i.ah, %i.ao
  %i.aq = tail call double @llvm.fmuladd.f64(double %i.l, double %i.ai, double %i.m)
  %i.ar = tail call double @llvm.fmuladd.f64(double %i.ai, double %i.aq, double %i.n)
  %i.as = tail call double @llvm.fmuladd.f64(double %i.ai, double %i.ar, double %i.o)
  %i.at = tail call double @llvm.fmuladd.f64(double %i.ai, double %i.as, double %i.p)
  %i.au = tail call double @llvm.fmuladd.f64(double %i.ai, double %i.at, double %i.q)
  %i.av = tail call double @llvm.fmuladd.f64(double %i.ai, double %i.au, double %i.k)
  %i.aw = fmul double %i.ap, %i.av
  %i.ax = load double, ptr @two, align 8, !tbaa !8 ; 2 uses
  %i.ay = tail call double @llvm.fmuladd.f64(double %i.ax, double %i.af, double %i.aw)
  %i.az = fmul double %i.d, %i.ay
  %i.ba = fdiv double %i.az, %i.ax                ; 2 uses
  store double %i.ba, ptr @sa, align 8, !tbaa !8
  store double 2.500000e-01, ptr @sb, align 8, !tbaa !8
  %i.bb = fadd double %i.ba, -2.500000e-01        ; 2 uses
  store double %i.bb, ptr @sc, align 8, !tbaa !8
  %i.bc = fmul double %i.bb, 1.000000e-30
  %i.bd = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %i.bc, double noundef 0.000000e+00, double noundef 0.000000e+00) ; 0 uses
  ret i32 0
}
