...
.lr.ph.split.us.preheader:                        ; preds = %.lr.ph
  ...
  %i.x = getelementptr [8 x i8], ptr %i.b, i64 %i.w
  %i.y = getelementptr i8, ptr %i.x, i64 -8
  %i.z = zext nneg i32 %i.c to i64
  %i.aa = load ptr, ptr %i.y, align 8, !tbaa !8
  br label %bb.c

bb.c:                                             ; preds = %.lr.ph.split.us.preheader, %AddEdges.exit.us
  %indvars.iv66 = phi i64 [ %i.z, %.lr.ph.split.us.preheader ], [ %indvars.iv.next67, %AddEdges.exit.us ] ; 4 uses
  %i.ab = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %indvars.iv66
...
.preheader.us.i.us.preheader:                     ; preds = %bb.c
  %i.ac = trunc i64 %indvars.iv66 to i32
...
bb.d:                                             ; preds = %bb.f, %.preheader.us.i.us
  %.135.us.i.us = phi i32 [ 0, %.preheader.us.i.us ], [ %i.bb, %bb.f ] ; 5 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.av = getelementptr inbounds nuw [24 x i8], ptr %i.aa, i64 %i.au
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %exitcond.not.i.us = icmp eq i32 %i.bb, %i.u
...
AddEdges.exit.us:                                 ; preds = %._crit_edge37.us.i.us, %bb.c
  ...
  %i.be = icmp sgt i64 %indvars.iv66, 0
  br i1 %i.be, label %bb.c, label %._crit_edge, !llvm.loop !21
