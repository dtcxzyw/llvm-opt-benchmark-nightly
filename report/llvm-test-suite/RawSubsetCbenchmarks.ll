...
.preheader199.lr.ph:                              ; preds = %_ZN9benchmark5State13StateIteratorC2EPS0_.exit
  ...
  %1 = add nsw i64 %wide.trip.count, -1           ; 44 uses
  %2 = shl nuw nsw i64 %wide.trip.count, 3        ; 46 uses
  %i.cr = add nuw nsw i64 %2, 8                   ; 2 uses
  %i.cs = add nsw i64 %2, -8                      ; 15 uses
  %min.iters.check1031 = icmp ult i64 %1, 2
  %n.vec1034 = and i64 %1, -2                     ; 2 uses
  %i.ct = or i64 %1, 1
  %cmp.n1055 = icmp eq i64 %1, %n.vec1034
  %min.iters.check923 = icmp ult i64 %1, 2
  %n.vec926 = and i64 %1, -2                      ; 2 uses
  %i.cu = or i64 %1, 1
  %cmp.n947 = icmp eq i64 %1, %n.vec926
  %min.iters.check815 = icmp ult i64 %1, 2
  %n.vec818 = and i64 %1, -2                      ; 2 uses
  %i.cv = or i64 %1, 1
  %cmp.n839 = icmp eq i64 %1, %n.vec818
  %min.iters.check707 = icmp ult i64 %1, 2
  %n.vec710 = and i64 %1, -2                      ; 2 uses
  %i.cw = or i64 %1, 1
  %cmp.n731 = icmp eq i64 %1, %n.vec710
  %min.iters.check599 = icmp ult i64 %1, 2
  %n.vec602 = and i64 %1, -2                      ; 2 uses
  %i.cx = or i64 %1, 1
  %cmp.n623 = icmp eq i64 %1, %n.vec602
  %min.iters.check487 = icmp ult i64 %1, 2
  %n.vec490 = and i64 %1, -2                      ; 2 uses
  %i.cy = or i64 %1, 1
  %cmp.n515 = icmp eq i64 %1, %n.vec490
  %min.iters.check381 = icmp ult i64 %1, 2
  %n.vec384 = and i64 %1, -2                      ; 2 uses
  %i.cz = or i64 %1, 1
  %cmp.n393 = icmp eq i64 %1, %n.vec384
  %i.da = and i64 %i.z, 1
  %lcmp.mod.not.not = icmp eq i64 %i.da, 0
  %min.iters.check348 = icmp ult i64 %1, 2
  %n.vec351 = and i64 %1, -2                      ; 2 uses
  %i.db = or i64 %1, 1
  %cmp.n360 = icmp eq i64 %1, %n.vec351
  %i.dc = and i64 %i.z, 1
  %lcmp.mod1066.not.not = icmp eq i64 %i.dc, 0
  %min.iters.check315 = icmp ult i64 %1, 2
  %n.vec318 = and i64 %1, -2                      ; 2 uses
  %i.dd = or i64 %1, 1
  %cmp.n327 = icmp eq i64 %1, %n.vec318
  %i.de = and i64 %i.z, 1
  %lcmp.mod1068.not.not = icmp eq i64 %i.de, 0
  %min.iters.check282 = icmp ult i64 %1, 2
  %n.vec285 = and i64 %1, -2                      ; 2 uses
  %i.df = or i64 %1, 1
  %cmp.n294 = icmp eq i64 %1, %n.vec285
  %i.dg = and i64 %i.z, 1
...
vector.memcheck949:                               ; preds = %.preheader196.us.preheader
  ...
  %scevgep951 = getelementptr i8, ptr %i.dq, i64 %2 ; 9 uses
  %scevgep952 = getelementptr i8, ptr %i.ds, i64 8 ; 9 uses
  %scevgep953 = getelementptr i8, ptr %i.ds, i64 %2 ; 9 uses
  %scevgep954 = getelementptr i8, ptr %i.dj, i64 %i.cs ; 2 uses
  %scevgep955 = getelementptr i8, ptr %i.dk, i64 %i.cs ; 2 uses
  %scevgep956 = getelementptr i8, ptr %i.dl, i64 %2 ; 2 uses
  %scevgep957 = getelementptr i8, ptr %i.dm, i64 %2 ; 2 uses
  %scevgep958 = getelementptr i8, ptr %i.dn, i64 %2 ; 2 uses
  %scevgep959 = getelementptr i8, ptr %i.do, i64 %2 ; 2 uses
  %scevgep960 = getelementptr i8, ptr %i.dp, i64 %i.cs ; 2 uses
  %scevgep961 = getelementptr i8, ptr %i.dr, i64 8 ; 2 uses
  %scevgep962 = getelementptr i8, ptr %i.dr, i64 %2 ; 2 uses
...
vector.memcheck841:                               ; preds = %._crit_edge.us
  ...
  %scevgep843 = getelementptr i8, ptr %i.gu, i64 %2 ; 2 uses
  %scevgep844 = getelementptr i8, ptr %i.gv, i64 8 ; 2 uses
  %scevgep845 = getelementptr i8, ptr %i.gv, i64 %2 ; 2 uses
  %scevgep846 = getelementptr i8, ptr %i.gq, i64 %i.cs
  %scevgep847 = getelementptr i8, ptr %i.gr, i64 %i.cs
  %scevgep848 = getelementptr i8, ptr %i.dj, i64 %2
  %scevgep849 = getelementptr i8, ptr %i.dk, i64 %2
  %scevgep850 = getelementptr i8, ptr %i.gs, i64 %2
  %scevgep851 = getelementptr i8, ptr %i.dp, i64 %2
  %scevgep852 = getelementptr i8, ptr %i.gt, i64 %i.cs
  %scevgep853 = getelementptr i8, ptr %i.dn, i64 8
  %scevgep854 = getelementptr i8, ptr %i.dn, i64 %2
...
vector.memcheck733:                               ; preds = %._crit_edge.us.1
  ...
  %scevgep735 = getelementptr i8, ptr %i.ld, i64 %2 ; 2 uses
  %scevgep736 = getelementptr i8, ptr %i.le, i64 8 ; 2 uses
  %scevgep737 = getelementptr i8, ptr %i.le, i64 %2 ; 2 uses
  %scevgep738 = getelementptr i8, ptr %i.kz, i64 %i.cs
  %scevgep739 = getelementptr i8, ptr %i.la, i64 %i.cs
  %scevgep740 = getelementptr i8, ptr %i.gq, i64 %2
  %scevgep741 = getelementptr i8, ptr %i.gr, i64 %2
  %scevgep742 = getelementptr i8, ptr %i.lb, i64 %2
  %scevgep743 = getelementptr i8, ptr %i.gt, i64 %2
  %scevgep744 = getelementptr i8, ptr %i.lc, i64 %i.cs
  %scevgep745 = getelementptr i8, ptr %i.gs, i64 8
  %scevgep746 = getelementptr i8, ptr %i.gs, i64 %2
...
vector.memcheck625:                               ; preds = %._crit_edge.us.2
  ...
  %scevgep627 = getelementptr i8, ptr %i.pm, i64 %2 ; 2 uses
  %scevgep628 = getelementptr i8, ptr %i.pn, i64 8 ; 2 uses
  %scevgep629 = getelementptr i8, ptr %i.pn, i64 %2 ; 2 uses
  %scevgep630 = getelementptr i8, ptr %i.pi, i64 %i.cs
  %scevgep631 = getelementptr i8, ptr %i.pj, i64 %i.cs
  %scevgep632 = getelementptr i8, ptr %i.kz, i64 %2
  %scevgep633 = getelementptr i8, ptr %i.la, i64 %2
  %scevgep634 = getelementptr i8, ptr %i.pk, i64 %2
  %scevgep635 = getelementptr i8, ptr %i.lc, i64 %2
  %scevgep636 = getelementptr i8, ptr %i.pl, i64 %i.cs
  %scevgep637 = getelementptr i8, ptr %i.lb, i64 8
  %scevgep638 = getelementptr i8, ptr %i.lb, i64 %2
...
vector.memcheck517:                               ; preds = %._crit_edge.us.3
  ...
  %scevgep519 = getelementptr i8, ptr %i.tv, i64 %2 ; 2 uses
  %scevgep520 = getelementptr i8, ptr %i.tw, i64 8 ; 2 uses
  %scevgep521 = getelementptr i8, ptr %i.tw, i64 %2 ; 2 uses
  %scevgep522 = getelementptr i8, ptr %i.tr, i64 %i.cs
  %scevgep523 = getelementptr i8, ptr %i.ts, i64 %i.cs
  %scevgep524 = getelementptr i8, ptr %i.pi, i64 %2
  %scevgep525 = getelementptr i8, ptr %i.pj, i64 %2
  %scevgep526 = getelementptr i8, ptr %i.tt, i64 %2
  %scevgep527 = getelementptr i8, ptr %i.pl, i64 %2
  %scevgep528 = getelementptr i8, ptr %i.tu, i64 %i.cs
  %scevgep529 = getelementptr i8, ptr %i.pk, i64 8
  %scevgep530 = getelementptr i8, ptr %i.pk, i64 %2
...
vector.memcheck395:                               ; preds = %.preheader195.us
  ...
  %scevgep396 = getelementptr i8, ptr %i.yn, i64 %2 ; 10 uses
  %scevgep397 = getelementptr i8, ptr %i.yt, i64 8 ; 10 uses
  %scevgep398 = getelementptr i8, ptr %i.yt, i64 %2 ; 10 uses
  %scevgep399 = getelementptr i8, ptr %i.ye, i64 %2 ; 2 uses
  %scevgep400 = getelementptr i8, ptr %i.yc, i64 %i.cr ; 2 uses
  %scevgep401 = getelementptr nuw i8, ptr %i.yb, i64 8 ; 2 uses
  %scevgep402 = getelementptr i8, ptr %i.yb, i64 %2 ; 2 uses
  %scevgep403 = getelementptr nuw i8, ptr %i.yh, i64 8 ; 2 uses
  %scevgep404 = getelementptr i8, ptr %i.yh, i64 %2 ; 2 uses
  %scevgep405 = getelementptr nuw i8, ptr %i.yj, i64 8 ; 2 uses
  %scevgep406 = getelementptr i8, ptr %i.yj, i64 %2 ; 2 uses
  %scevgep407 = getelementptr nuw i8, ptr %i.yl, i64 8 ; 2 uses
  %scevgep408 = getelementptr i8, ptr %i.yl, i64 %2 ; 2 uses
  %scevgep409 = getelementptr i8, ptr %i.ya, i64 %i.cr ; 2 uses
  %scevgep410 = getelementptr i8, ptr %i.yp, i64 8 ; 2 uses
  %scevgep411 = getelementptr i8, ptr %i.yp, i64 %2 ; 2 uses
  %scevgep412 = getelementptr i8, ptr %i.yr, i64 8 ; 2 uses
  %scevgep413 = getelementptr i8, ptr %i.yr, i64 %2 ; 2 uses
