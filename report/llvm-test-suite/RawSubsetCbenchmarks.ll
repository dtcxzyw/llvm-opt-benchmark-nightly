...
bb.a:
  ...
  %1 = load double, ptr %i.t, align 8, !tbaa !11
  ...
  %2 = load double, ptr %i.v, align 8, !tbaa !11
  ...
  %3 = load double, ptr %i.ad, align 8, !tbaa !11
...
.preheader155.lr.ph.split:                        ; preds = %.preheader155.lr.ph
  ...
  %4 = insertelement <2 x double> poison, double %1, i64 0 ; 2 uses
  %5 = insertelement <2 x double> poison, double %2, i64 0
  %6 = insertelement <2 x double> poison, double %3, i64 0 ; 2 uses
...
._crit_edge:                                      ; preds = %bb.b, %._crit_edge
  ...
  %i.cj = insertelement <2 x double> %4, double %i.cg, i64 1
  ...
  %i.ea = insertelement <2 x double> %6, double %i.dx, i64 1
...
bb.b:                                             ; preds = %.preheader155, %bb.b
  ...
  %i.gb = insertelement <2 x double> %4, double %i.fy, i64 1
  ...
  %i.gw = insertelement <2 x double> %5, double %i.gu, i64 1
  ...
  %i.ht = insertelement <2 x double> %6, double %i.hq, i64 1
