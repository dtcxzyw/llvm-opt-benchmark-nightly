...
._crit_edge:                                      ; preds = %bb.b, %._crit_edge
  ...
  %i.bx = load double, ptr %i.bf, align 8, !tbaa !11
  %i.by = load double, ptr %i.bn, align 8, !tbaa !11
  %10 = getelementptr inbounds nuw i8, ptr %i.au, i64 24
  %11 = load double, ptr %10, align 8, !tbaa !11
  %i.bz = load double, ptr %i.bw, align 8, !tbaa !11 ; 2 uses
  %i.ca = tail call double @llvm.fmuladd.f64(double %i.q, double %i.bx, double %i.bz)
  %i.cb = tail call double @llvm.fmuladd.f64(double %2, double %i.by, double %i.ca)
  %12 = insertelement <2 x double> %7, double %i.bz, i64 1
  %13 = insertelement <2 x double> <double poison, double -2.000000e+00>, double %i.bu, i64 0
  %14 = insertelement <2 x double> poison, double %i.cb, i64 0
  ...
  %19 = load double, ptr %i.bf, align 8, !tbaa !11
  %i.ck = load double, ptr %i.bn, align 8, !tbaa !11
  %i.cl = load double, ptr %i.bv, align 8, !tbaa !11
  %20 = getelementptr inbounds nuw i8, ptr %i.at, i64 24
  ...
  %i.cq = fadd double %28, %i.cp
  %29 = extractelement <2 x double> %27, i64 0
  %i.cr = tail call double @llvm.fmuladd.f64(double %i.o, double %i.cq, double %29)
  ...
  %30 = load double, ptr %i.bf, align 8, !tbaa !11
  %i.cw = load double, ptr %i.bn, align 8, !tbaa !11
  %i.cx = load double, ptr %i.bv, align 8, !tbaa !11
  %31 = getelementptr inbounds nuw i8, ptr %i.as, i64 24
  %32 = load double, ptr %31, align 8, !tbaa !11
  %i.cy = load double, ptr %i.cv, align 8, !tbaa !11 ; 2 uses
  %33 = tail call double @llvm.fmuladd.f64(double %i.y, double %30, double %i.cy)
  %i.cz = tail call double @llvm.fmuladd.f64(double %6, double %i.cw, double %33)
  %34 = insertelement <2 x double> %9, double %i.cy, i64 1
  %35 = insertelement <2 x double> <double poison, double -2.000000e+00>, double %i.cx, i64 0
  %36 = insertelement <2 x double> poison, double %i.cz, i64 0
  ...
  %i.dc = fadd double %39, %i.db
  %40 = extractelement <2 x double> %38, i64 0
  %i.dd = tail call double @llvm.fmuladd.f64(double %i.o, double %i.dc, double %40)
...
bb.b:                                             ; preds = %.preheader155, %bb.b
  ...
  %41 = getelementptr inbounds nuw i8, ptr %i.dk, i64 16
  %42 = load double, ptr %41, align 8, !tbaa !11
  %i.ep = load double, ptr %i.em, align 8, !tbaa !11 ; 2 uses
  %i.eq = tail call double @llvm.fmuladd.f64(double %i.q, double %i.en, double %i.ep)
  %i.er = tail call double @llvm.fmuladd.f64(double %2, double %i.eo, double %i.eq)
  %43 = insertelement <2 x double> %7, double %i.ep, i64 1
  %44 = insertelement <2 x double> <double poison, double -2.000000e+00>, double %i.ek, i64 0
  %45 = insertelement <2 x double> poison, double %i.er, i64 0
  ...
  %i.et = fadd double %48, %i.es
  %49 = extractelement <2 x double> %47, i64 0
  %i.eu = tail call double @llvm.fmuladd.f64(double %i.o, double %i.et, double %49)
  ...
  %50 = load double, ptr %i.dv, align 8, !tbaa !11
  %i.ez = load double, ptr %i.ed, align 8, !tbaa !11
  %i.fa = load double, ptr %i.el, align 8, !tbaa !11
  %51 = getelementptr inbounds nuw i8, ptr %i.dj, i64 16
  %52 = load double, ptr %51, align 8, !tbaa !11
  %i.fb = load double, ptr %i.ey, align 8, !tbaa !11 ; 2 uses
  %53 = tail call double @llvm.fmuladd.f64(double %i.u, double %50, double %i.fb)
  %i.fc = tail call double @llvm.fmuladd.f64(double %4, double %i.ez, double %53)
  %54 = insertelement <2 x double> %8, double %i.fb, i64 1
  %55 = insertelement <2 x double> <double poison, double -2.000000e+00>, double %i.fa, i64 0
  %56 = insertelement <2 x double> poison, double %i.fc, i64 0
  ...
  %i.fe = fadd double %59, %i.fd
  %60 = extractelement <2 x double> %58, i64 0
  %i.ff = tail call double @llvm.fmuladd.f64(double %i.o, double %i.fe, double %60)
  ...
  %61 = load double, ptr %i.dv, align 8, !tbaa !11
  %i.fk = load double, ptr %i.ed, align 8, !tbaa !11
  %i.fl = load double, ptr %i.el, align 8, !tbaa !11
  %62 = getelementptr inbounds nuw i8, ptr %i.di, i64 16
  %63 = load double, ptr %62, align 8, !tbaa !11
  %i.fm = load double, ptr %i.fj, align 8, !tbaa !11 ; 2 uses
  %64 = tail call double @llvm.fmuladd.f64(double %i.y, double %61, double %i.fm)
  %i.fn = tail call double @llvm.fmuladd.f64(double %6, double %i.fk, double %64)
  %65 = insertelement <2 x double> %9, double %i.fm, i64 1
  %66 = insertelement <2 x double> <double poison, double -2.000000e+00>, double %i.fl, i64 0
  %67 = insertelement <2 x double> poison, double %i.fn, i64 0
...
.lr.ph.us.preheader.preheader:                    ; preds = %.preheader119.lr.ph
  ...
  %scevgep = getelementptr i8, ptr %2, i64 %i.ah  ; 2 uses
  %scevgep153 = getelementptr i8, ptr %i.q, i64 %i.ah ; 3 uses
  %scevgep154 = getelementptr i8, ptr %1, i64 %i.ah ; 4 uses
  %scevgep155 = getelementptr i8, ptr %i.i, i64 %i.ah ; 3 uses
  %scevgep156 = getelementptr i8, ptr %i.d, i64 %i.ah ; 3 uses
  ...
  %i.ao = insertelement <8 x ptr> %5, ptr %1, i64 5
  %i.ap = insertelement <8 x ptr> %i.ao, ptr %i.d, i64 7
  %6 = shufflevector <8 x ptr> %i.ap, <8 x ptr> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 1, i32 1, i32 5, i32 0, i32 7>
  ...
  %i.ax = insertelement <4 x ptr> %8, ptr %i.d, i64 2
  %9 = shufflevector <4 x ptr> %i.ax, <4 x ptr> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 1>
  ...
  %i.bc = insertelement <4 x ptr> %10, ptr %i.i, i64 1
  %i.bd = insertelement <4 x ptr> %i.bc, ptr %1, i64 2
  ...
  %i.bj = insertelement <8 x ptr> %11, ptr %i.d, i64 3
  %i.bk = insertelement <8 x ptr> %i.bj, ptr %i.m, i64 4
  %i.bl = insertelement <8 x ptr> %i.bk, ptr %i.q, i64 5
  %12 = insertelement <8 x ptr> %i.bl, ptr %i.i, i64 6
  %13 = shufflevector <8 x ptr> %12, <8 x ptr> poison, <8 x i32> <i32 0, i32 1, i32 0, i32 3, i32 4, i32 5, i32 6, i32 5>
  %14 = icmp ult <8 x ptr> %13, %i.an
  %i.bm = icmp ult <8 x ptr> %6, %i.aw
  %i.bn = and <8 x i1> %14, %i.bm                 ; 2 uses
  %i.bo = icmp ult <4 x ptr> %9, %i.bb
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %bb.c
  ...
  %i.bw = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv
  store double 0.000000e+00, ptr %i.bw, align 8, !tbaa !11
  %i.bx = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv
  ...
  %i.cc = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv
...
vector.body:                                      ; preds = %.preheader118.us.preheader, %vector.body
  ...
  %i.co = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %index ; 2 uses
  ...
  %i.cr = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %index ; 3 uses
  %wide.load202 = load <2 x double>, ptr %i.cr, align 8, !tbaa !11, !alias.scope !115, !noalias !116
  %i.cs = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %index
...
.preheader118.us:                                 ; preds = %.preheader118.us.preheader206, %.preheader118.us
  ...
  %i.di = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv141 ; 2 uses
  ...
  %i.dn = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv141 ; 3 uses
  %i.do = load double, ptr %i.dn, align 8, !tbaa !11
  %i.dp = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv141
