...
._crit_edge:                                      ; preds = %bb.b, %._crit_edge
  %i.ay = phi ptr [ %i.bv, %._crit_edge ], [ %.pre172, %bb.b ] ; 4 uses
  %i.az = phi ptr [ %i.bn, %._crit_edge ], [ %.pre170, %bb.b ] ; 4 uses
  %i.ba = phi ptr [ %i.bf, %._crit_edge ], [ %.pre168, %bb.b ] ; 4 uses
  ...
  %i.cd = load double, ptr %i.cc, align 8, !tbaa !11 ; 2 uses
  %i.ce = load double, ptr %i.bl, align 8, !tbaa !11
  %1 = tail call double @llvm.fmuladd.f64(double %i.q, double %i.ce, double %i.cd)
  %2 = load double, ptr %i.bt, align 8, !tbaa !11
  %i.cf = tail call double @llvm.fmuladd.f64(double %i.s, double %2, double %1)
  %i.cg = tail call double @llvm.fmuladd.f64(double %i.u, double %i.ca, double %i.cf)
  %3 = getelementptr inbounds nuw i8, ptr %i.ba, i64 24
  %4 = load double, ptr %3, align 8, !tbaa !11
  %5 = tail call double @llvm.fmuladd.f64(double %i.cd, double -2.000000e+00, double %4)
  %i.ch = getelementptr inbounds nuw i8, ptr %i.ba, i64 8
  %i.ci = load double, ptr %i.ch, align 8, !tbaa !11
  %i.cj = fadd double %5, %i.ci
  %i.ck = tail call double @llvm.fmuladd.f64(double %i.o, double %i.cj, double %i.cg)
  ...
  %i.cp = load double, ptr %i.co, align 8, !tbaa !11 ; 2 uses
  %i.cq = load double, ptr %i.bl, align 8, !tbaa !11
  %6 = tail call double @llvm.fmuladd.f64(double %i.w, double %i.cq, double %i.cp)
  %7 = load double, ptr %i.bt, align 8, !tbaa !11
  %i.cr = tail call double @llvm.fmuladd.f64(double %i.y, double %7, double %6)
  %8 = load double, ptr %i.cb, align 8, !tbaa !11
  %9 = tail call double @llvm.fmuladd.f64(double %i.aa, double %8, double %i.cr)
  %10 = getelementptr inbounds nuw i8, ptr %i.az, i64 24
  %11 = load double, ptr %10, align 8, !tbaa !11
  %12 = tail call double @llvm.fmuladd.f64(double %i.cp, double -2.000000e+00, double %11)
  %i.cs = getelementptr inbounds nuw i8, ptr %i.az, i64 8
  %i.ct = load double, ptr %i.cs, align 8, !tbaa !11
  %i.cu = fadd double %12, %i.ct
  %i.cv = tail call double @llvm.fmuladd.f64(double %i.o, double %i.cu, double %9)
  ...
  %i.db = load double, ptr %i.bl, align 8, !tbaa !11
  %13 = tail call double @llvm.fmuladd.f64(double %i.ac, double %i.db, double %i.da)
  %14 = load double, ptr %i.bt, align 8, !tbaa !11
  %i.dc = tail call double @llvm.fmuladd.f64(double %i.ae, double %14, double %13)
  %15 = load double, ptr %i.cb, align 8, !tbaa !11
  %16 = tail call double @llvm.fmuladd.f64(double %i.ag, double %15, double %i.dc)
  %17 = getelementptr inbounds nuw i8, ptr %i.ay, i64 24
  %18 = load double, ptr %17, align 8, !tbaa !11
  %19 = tail call double @llvm.fmuladd.f64(double %i.da, double -2.000000e+00, double %18)
  %i.dd = getelementptr inbounds nuw i8, ptr %i.ay, i64 8
  %i.de = load double, ptr %i.dd, align 8, !tbaa !11
  %i.df = fadd double %19, %i.de
  %i.dg = tail call double @llvm.fmuladd.f64(double %i.o, double %i.df, double %16)
...
bb.b:                                             ; preds = %.preheader155, %bb.b
  %i.dl = phi ptr [ %.pre172, %.preheader155 ], [ %i.ei, %bb.b ] ; 4 uses
  %i.dm = phi ptr [ %.pre170, %.preheader155 ], [ %i.ea, %bb.b ] ; 4 uses
  %i.dn = phi ptr [ %.pre168, %.preheader155 ], [ %i.ds, %bb.b ] ; 4 uses
  ...
  %i.eq = load double, ptr %i.ep, align 8, !tbaa !11 ; 2 uses
  %i.er = load double, ptr %i.dy, align 8, !tbaa !11
  %20 = tail call double @llvm.fmuladd.f64(double %i.q, double %i.er, double %i.eq)
  %21 = load double, ptr %i.eg, align 8, !tbaa !11
  %i.es = tail call double @llvm.fmuladd.f64(double %i.s, double %21, double %20)
  %i.et = tail call double @llvm.fmuladd.f64(double %i.u, double %i.en, double %i.es)
  %22 = getelementptr inbounds nuw i8, ptr %i.dn, i64 16
  %23 = load double, ptr %22, align 8, !tbaa !11
  %24 = tail call double @llvm.fmuladd.f64(double %i.eq, double -2.000000e+00, double %23)
  %i.eu = load double, ptr %i.dn, align 8, !tbaa !11
  %i.ev = fadd double %24, %i.eu
  %i.ew = tail call double @llvm.fmuladd.f64(double %i.o, double %i.ev, double %i.et)
  ...
  %i.fb = load double, ptr %i.fa, align 8, !tbaa !11 ; 2 uses
  %i.fc = load double, ptr %i.dy, align 8, !tbaa !11
  %25 = tail call double @llvm.fmuladd.f64(double %i.w, double %i.fc, double %i.fb)
  %26 = load double, ptr %i.eg, align 8, !tbaa !11
  %i.fd = tail call double @llvm.fmuladd.f64(double %i.y, double %26, double %25)
  %27 = load double, ptr %i.eo, align 8, !tbaa !11
  %28 = tail call double @llvm.fmuladd.f64(double %i.aa, double %27, double %i.fd)
  %29 = getelementptr inbounds nuw i8, ptr %i.dm, i64 16
  %30 = load double, ptr %29, align 8, !tbaa !11
  %31 = tail call double @llvm.fmuladd.f64(double %i.fb, double -2.000000e+00, double %30)
  %i.fe = load double, ptr %i.dm, align 8, !tbaa !11
  %i.ff = fadd double %31, %i.fe
  %i.fg = tail call double @llvm.fmuladd.f64(double %i.o, double %i.ff, double %28)
  ...
  %i.fl = load double, ptr %i.fk, align 8, !tbaa !11 ; 2 uses
  %i.fm = load double, ptr %i.dy, align 8, !tbaa !11
  %32 = tail call double @llvm.fmuladd.f64(double %i.ac, double %i.fm, double %i.fl)
  %33 = load double, ptr %i.eg, align 8, !tbaa !11
  %i.fn = tail call double @llvm.fmuladd.f64(double %i.ae, double %33, double %32)
  %34 = load double, ptr %i.eo, align 8, !tbaa !11
  %35 = tail call double @llvm.fmuladd.f64(double %i.ag, double %34, double %i.fn)
  %36 = getelementptr inbounds nuw i8, ptr %i.dl, i64 16
  %37 = load double, ptr %36, align 8, !tbaa !11
  %38 = tail call double @llvm.fmuladd.f64(double %i.fl, double -2.000000e+00, double %37)
