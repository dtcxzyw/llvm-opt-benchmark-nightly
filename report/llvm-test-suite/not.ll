...
.noexc:                                           ; preds = %bb.b
  call void @_ZSt19__throw_logic_errorPKc(ptr noundef nonnull @.str.4) #11
  unreachable

bb.c:                                             ; preds = %bb.b
  %i.j = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %i.g) #10 ; 4 uses
...
begin_hunk_3
  ...
  %.pre = load ptr, ptr %2, align 8, !tbaa !15    ; 3 uses
  br i1 %i.u, label %bb.g, label %.critedge

bb.g:                                             ; preds = %bb.f
  %bcmp.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(7) %.pre, ptr noundef nonnull dereferenceable(7) @.str, i64 7)
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %.critedge
  ...
  %i.z = add i64 %i.y, 1
  call void @_ZdlPvm(ptr noundef %.pre, i64 noundef %i.z) #12
  br label %.critedge37
...
bb.h:                                             ; preds = %.critedge37
  ...
  %i.ac = call i32 @setenv(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, i32 noundef 0) #10 ; 0 uses
  %i.ad = call i32 @setenv(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.2, i32 noundef 0) #10 ; 0 uses
