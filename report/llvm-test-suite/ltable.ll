...
begin_hunk_0_@resize:bb.a
  ...
  %i.bz = call fastcc ptr @newkey(ptr noundef %0, ptr noundef nonnull %1, ptr noundef nonnull %4)
...
._crit_edge74:                                    ; preds = %bb.h, %luaH_setnum.exit
  ...
  br i1 %exitcond.not, label %bb.n, label %bb.h, !llvm.loop !31
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.cu = call ptr @luaH_get(ptr noundef nonnull %1, ptr noundef nonnull %i.ct) ; 2 uses
  store i8 0, ptr %i.cm, align 2, !tbaa !32
...
bb.w:                                             ; preds = %.sink.split, %bb.v, %bb.u
  %i.cz = call fastcc ptr @newkey(ptr noundef %0, ptr noundef nonnull %1, ptr noundef nonnull %i.ct)
...
bb.x:                                             ; preds = %luaH_set.exit, %bb.s
  ...
  br i1 %i.de, label %bb.s, label %._crit_edge, !llvm.loop !33
...
begin_hunk_5_@luaH_new:bb.a
  ...
  store i8 -1, ptr %i.c, align 2, !tbaa !32
...
begin_hunk_8_@setnodevector:bb.a
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge.loopexit, label %.lr.ph.epil, !llvm.loop !37
...
begin_hunk_9_@setnodevector:bb.a
  ...
  store ptr %i.as, ptr %i.at, align 8, !tbaa !38
  ret void
}
...
begin_hunk_10_@luaH_getstr:bb.a
  ...
  br i1 %.not, label %bb.e, label %bb.b, !llvm.loop !39
...
begin_hunk_11_@luaH_get:bb.a
  ...
  br i1 %.not.i, label %luaH_getstr.exit, label %bb.c, !llvm.loop !39
...
begin_hunk_12_@luaH_get:bb.a
  ...
  br i1 %.not20, label %luaH_getstr.exit, label %mainposition.exit, !llvm.loop !40
...
bb.a:
  ...
  store i8 0, ptr %i.b, align 2, !tbaa !32
...
begin_hunk_15_@newkey:bb.a
  ...
  br i1 %i.bu, label %getfreepos.exit, label %bb.i, !llvm.loop !41
...
begin_hunk_16_@newkey:bb.a
  ...
  br i1 %i.ds, label %middle.block, label %vector.body, !llvm.loop !42
...
begin_hunk_17_@newkey:bb.a
  ...
  br i1 %.not.not.i, label %scalar.ph, label %._crit_edge.loopexit.i, !llvm.loop !45
...
begin_hunk_18_@newkey:bb.a
  ...
  br i1 %exitcond.not.i, label %numusearray.exit, label %bb.k, !llvm.loop !46
...
begin_hunk_19_@newkey:bb.a
  ...
  br i1 %i.ff, label %numusehash.exit, label %bb.n, !llvm.loop !47
...
begin_hunk_20_@newkey:bb.a
  ...
  br i1 %i.gg, label %.lr.ph.i, label %computesizes.exit, !llvm.loop !48
...
begin_hunk_21_@newkey:bb.a
  ...
  tail call fastcc void @resize(ptr noundef %0, ptr noundef %1, i32 noundef %.2.i, i32 noundef %i.gj)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #8
  %i.gk = tail call ptr @luaH_get(ptr noundef %1, ptr noundef %2) ; 2 uses
  store i8 0, ptr %i.h, align 2, !tbaa !32
...
begin_hunk_22_@newkey:bb.a
  ...
  br i1 %.not51, label %bb.ac, label %.preheader, !llvm.loop !49

bb.ac:                                            ; preds = %.preheader
  %i.ip = getelementptr inbounds nuw i8, ptr %.043, i64 32
  store ptr %i.bq, ptr %i.ip, align 8, !tbaa !10
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %i.bq, ptr noundef nonnull align 8 dereferenceable(40) %.0.i, i64 40, i1 false), !tbaa.struct !50
...
begin_hunk_23_@luaH_setstr:bb.a
  ...
  br i1 %.not.i, label %luaH_getstr.exit.thread, label %bb.b, !llvm.loop !39
...
begin_hunk_24_@luaH_getn:bb.a
  ...
  br i1 %i.t, label %.lr.ph, label %unbound_search.exit, !llvm.loop !51
...
bb.j:                                             ; preds = %luaH_getnum.exit.i
  ...
  br i1 %i.bd, label %.preheader46.i, label %bb.e, !llvm.loop !52
...
begin_hunk_26_@luaH_getn:bb.a
  ...
  %i.ce = add i32 %.1.i, 1
  br i1 %.not25.i, label %unbound_search.exit, label %.preheader46.i, !llvm.loop !53
...
begin_hunk_27_@luaH_getn:bb.a
  ...
  br i1 %i.dj, label %.lr.ph.i, label %unbound_search.exit, !llvm.loop !54
...
!40 = distinct !{!40, !21}
!41 = distinct !{!41, !21}
!42 = distinct !{!42, !21, !43, !44}
!43 = !{!"llvm.loop.isvectorized", i32 1}
!44 = !{!"llvm.loop.unroll.runtime.disable"}
!45 = distinct !{!45, !21, !44, !43}
!46 = distinct !{!46, !21}
!47 = distinct !{!47, !21}
!48 = distinct !{!48, !21}
!49 = distinct !{!49, !21}
!50 = !{i64 0, i64 8, !10, i64 8, i64 4, !4, i64 16, i64 24, !10}
!51 = distinct !{!51, !21}
!52 = distinct !{!52, !21}
!53 = distinct !{!53, !21}
!54 = distinct !{!54, !21}
