...
bb.i:                                             ; preds = %._crit_edge.i46, %.lr.ph134.i39
  %indvar106 = phi i64 [ %indvar.next107, %._crit_edge.i46 ], [ 0, %.lr.ph134.i39 ] ; 3 uses
...
.lr.ph.i49.preheader:                             ; preds = %.critedge.i42
  %xtraiter108 = and i64 %indvar106, 1
  %lcmp.mod109.not = icmp eq i64 %xtraiter108, 0
  br i1 %lcmp.mod109.not, label %.lr.ph.i49.prol.loopexit, label %.lr.ph.i49.prol
...
check_FP.exit.thread:                             ; preds = %.critedge.i58.3, %.critedge.i58.2, %.critedge.i58.1, %.critedge.i58, %bb.k
  ...
  %.lcssa102 = phi i32 [ %i.dd, %bb.k ], [ %i.dn, %.critedge.i58 ], [ %i.dr, %.critedge.i58.1 ], [ %i.dv, %.critedge.i58.2 ], [ %i.dz, %.critedge.i58.3 ]
  ...
  %i.dj = sitofp i32 %.lcssa102 to double
