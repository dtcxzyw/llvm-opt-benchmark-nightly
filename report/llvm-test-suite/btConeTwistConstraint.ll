...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !36, !nonnull !32, !align !37 ; 25 uses
  ...
  %15 = getelementptr inbounds nuw i8, ptr %0, i64 400 ; 2 uses
  %i.k = getelementptr inbounds nuw i8, ptr %i.g, i64 16
  %i.l = load float, ptr %i.k, align 8, !tbaa !27
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 404 ; 2 uses
  %i.n = getelementptr inbounds nuw i8, ptr %i.g, i64 56 ; 2 uses
  %i.o = load float, ptr %i.n, align 8, !tbaa !27
  %i.p = getelementptr inbounds nuw i8, ptr %i.g, i64 24 ; 2 uses
  %16 = load float, ptr %i.p, align 8, !tbaa !27
  %i.q = getelementptr inbounds nuw i8, ptr %i.g, i64 28
  %i.r = load float, ptr %i.q, align 4, !tbaa !27
  %i.s = getelementptr inbounds nuw i8, ptr %i.g, i64 32
  %17 = load float, ptr %i.s, align 8, !tbaa !27
  %i.t = getelementptr inbounds nuw i8, ptr %i.g, i64 60
  %i.u = load float, ptr %i.t, align 4, !tbaa !27 ; 2 uses
  %i.v = getelementptr inbounds nuw i8, ptr %i.g, i64 40 ; 2 uses
  %i.w = getelementptr inbounds nuw i8, ptr %i.g, i64 48
  %18 = load float, ptr %i.w, align 8, !tbaa !27
  %19 = load <2 x float>, ptr %i.h, align 8, !tbaa !27 ; 2 uses
  %i.x = load float, ptr %15, align 8, !tbaa !27  ; 2 uses
  %i.y = load float, ptr %i.j, align 4, !tbaa !27 ; 2 uses
  %i.z = load float, ptr %i.m, align 4, !tbaa !27 ; 2 uses
  %20 = load <2 x float>, ptr %i.v, align 8, !tbaa !27 ; 2 uses
  %21 = shufflevector <2 x float> %20, <2 x float> %19, <2 x i32> <i32 1, i32 3>
  %22 = insertelement <2 x float> poison, float %i.x, i64 0
  %23 = shufflevector <2 x float> %22, <2 x float> poison, <2 x i32> zeroinitializer
  %24 = fmul <2 x float> %21, %23
  %25 = shufflevector <2 x float> %20, <2 x float> %19, <2 x i32> <i32 0, i32 2>
  ...
  %26 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %25, <2 x float> %i.ab, <2 x float> %24)
  %27 = insertelement <2 x float> poison, float %18, i64 0
  %28 = insertelement <2 x float> %27, float %i.l, i64 1
  ...
  %i.ae = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %28, <2 x float> %i.ad, <2 x float> %26)
  %29 = fmul float %i.x, %i.r
  %30 = tail call float @llvm.fmuladd.f32(float %16, float %i.y, float %29)
  %31 = tail call noundef float @llvm.fmuladd.f32(float %17, float %i.z, float %30)
  %32 = fadd float %i.u, %31                      ; 2 uses
  %33 = getelementptr inbounds nuw i8, ptr %i.g, i64 64
  %34 = load float, ptr %33, align 8, !tbaa !27
  %35 = insertelement <2 x float> poison, float %34, i64 0
  %36 = insertelement <2 x float> %35, float %i.o, i64 1 ; 2 uses
  %i.af = fadd <2 x float> %36, %i.ae             ; 3 uses
  ...
  %i.bu = fadd <3 x float> %i.bs, %i.bt           ; 4 uses
...
bb.c:                                             ; preds = %bb.b
  %i.by = fsub float %32, %i.u                    ; 3 uses
  %i.bz = fsub <2 x float> %i.af, %36             ; 4 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %37 = shufflevector <2 x float> %i.bz, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %38 = insertelement <2 x float> %37, float %i.by, i64 0
  %39 = fneg <2 x float> %38
  %40 = fmul <2 x float> %i.db, %39
  %i.dc = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cw, <2 x float> %i.bz, <2 x float> %40)
  %i.dd = extractelement <2 x float> %i.cw, i64 0
  %i.de = fmul float %i.dd, %i.cq
  %i.df = extractelement <2 x float> %i.db, i64 1
  %i.dg = tail call float @llvm.fmuladd.f32(float %i.df, float %i.by, float %i.de)
...
_ZNK12btSolverBody31getVelocityInLocalPointObsoleteERK9btVector3RS0_.exit83: ; preds = %_ZNK12btSolverBody31getVelocityInLocalPointObsoleteERK9btVector3RS0_.exit, %bb.e
  ...
  %41 = extractelement <2 x float> %i.af, i64 1
  %42 = fsub float %41, %i.ez
  %43 = extractelement <3 x float> %i.bu, i64 1
  %i.fa = fsub float %32, %43
  %44 = extractelement <3 x float> %i.bu, i64 2
  %45 = extractelement <2 x float> %i.af, i64 0
  %46 = fsub float %45, %44
  ...
  %i.gd = shufflevector <2 x float> %i.bz, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.ge = shufflevector <4 x float> %i.gc, <4 x float> %i.gd, <4 x i32> <i32 0, i32 4, i32 5, i32 poison> ; 2 uses
  %47 = shufflevector <4 x float> %i.ge, <4 x float> poison, <4 x i32> <i32 2, i32 0, i32 1, i32 poison>
  br label %bb.f
...
bb.f:                                             ; preds = %_ZNK12btSolverBody31getVelocityInLocalPointObsoleteERK9btVector3RS0_.exit83, %bb.f
  ...
  %i.gi = fdiv float 1.000000e+00, %i.gh
  %i.gj = getelementptr inbounds nuw i8, ptr %i.gf, i64 8 ; 2 uses
  %i.gk = load float, ptr %i.gj, align 4, !tbaa !27 ; 5 uses
  ...
  %i.gu = fmul float %i.fa, %i.gp
  %i.gv = tail call float @llvm.fmuladd.f32(float %42, float %i.gr, float %i.gu)
  %i.gw = tail call noundef float @llvm.fmuladd.f32(float %46, float %i.gk, float %i.gv)
  ...
  %i.he = insertelement <4 x float> %i.hd, float %i.gi, i64 3 ; 2 uses
  %i.hf = fneg <4 x float> %i.he                  ; 2 uses
  %i.hg = fneg float %i.gp
  %i.hh = insertelement <4 x float> %i.ge, float %i.gt, i64 3
  %i.hi = fmul <4 x float> %i.hh, %i.hf
  %i.hj = insertelement <4 x float> %47, float %i.gy, i64 3
  %i.hk = shufflevector <2 x float> %i.go, <2 x float> poison, <4 x i32> <i32 1, i32 poison, i32 0, i32 poison>
  %48 = shufflevector <4 x float> %i.hk, <4 x float> %i.he, <4 x i32> <i32 0, i32 6, i32 2, i32 7>
  %i.hl = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.hj, <4 x float> %48, <4 x float> %i.hi) ; 9 uses
...
bb.g:                                             ; preds = %.loopexit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.lk, ptr noundef nonnull align 8 dereferenceable(16) %i.p, i64 16, i1 false), !tbaa.struct !24
  %i.ll = getelementptr inbounds nuw i8, ptr %6, i64 32
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.ll, ptr noundef nonnull align 8 dereferenceable(16) %i.v, i64 16, i1 false), !tbaa.struct !24
  %i.lm = getelementptr inbounds nuw i8, ptr %6, i64 48 ; 2 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.lm, ptr noundef nonnull align 8 dereferenceable(16) %i.n, i64 16, i1 false), !tbaa.struct !24
...
_ZNK12btSolverBody18getAngularVelocityER9btVector3.exit134: ; preds = %bb.j, %bb.k
  ...
  %i.nz = load float, ptr %15, align 8, !tbaa !27, !noalias !126
  %i.oa = fneg float %i.nz                        ; 3 uses
  %i.ob = load float, ptr %i.m, align 4, !tbaa !27, !noalias !126
