...
bb.b:                                             ; preds = %bb.a
  ...
  %11 = load <4 x float>, ptr %i.by, align 4
  ...
  %13 = load <4 x float>, ptr %i.bp, align 4
  ...
  %14 = load <4 x float>, ptr %i.ax, align 4
  ...
  %i.ha = insertelement <4 x float> %14, float %i.gn, i64 1
  ...
  %i.hx = shufflevector <4 x float> %13, <4 x float> %i.hw, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
...
_ZNK21btConeTwistConstraint33adjustSwingAxisToUseEllipseNormalER9btVector3.exit: ; preds = %._crit_edge, %bb.k
  ...
  %i.zq = insertelement <2 x float> %18, float %i.yq, i64 1
  %i.zr = fmul <2 x float> %i.yz, %i.zq
  %i.zs = insertelement <2 x float> %16, float %i.yo, i64 1
...
bb.l:                                             ; preds = %bb.g, %_Z15shortestArcQuatRK9btVector3S1_.exit
  ...
  %19 = load <4 x float>, ptr %i.aae, align 4
  ...
  %20 = load <4 x float>, ptr %i.nt, align 4
  %21 = load <4 x float>, ptr %i.abc, align 4
  %22 = load <4 x float>, ptr %i.abd, align 4
  ...
  %23 = load <4 x float>, ptr %i.abh, align 4
  ...
  %25 = load <4 x float>, ptr %i.aan, align 4
  ...
  %27 = load <4 x float>, ptr %i.aap, align 4
  ...
  %i.abt = insertelement <2 x float> %26, float %i.abl, i64 1 ; 3 uses
  ...
  %i.aby = shufflevector <4 x float> %19, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %i.acq = insertelement <2 x float> %28, float %i.abn, i64 1 ; 2 uses
  ...
  %i.adk = shufflevector <4 x float> %21, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %i.adq = shufflevector <4 x float> %20, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %i.adu = insertelement <2 x float> %24, float %i.abk, i64 1
  %i.adv = shufflevector <4 x float> %22, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.adw = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.adu, <2 x float> %i.adv, <2 x float> %i.adr) ; 6 uses
...
._crit_edge540:                                   ; preds = %_ZN21btConeTwistConstraint21computeTwistLimitInfoERK12btQuaternionRfR9btVector3.exit
  ...
  %29 = load <4 x float>, ptr %i.ama, align 4
  %30 = load <4 x float>, ptr %i.amb, align 4
  %i.amf = insertelement <4 x float> poison, float %i.ame, i64 0
  %i.amg = insertelement <4 x float> %i.amf, float %i.alx, i64 1
  %i.amh = shufflevector <4 x float> %i.amg, <4 x float> %30, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  ...
  %i.amm = shufflevector <4 x float> %i.aml, <4 x float> %29, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
...
bb.a:
  ...
  %6 = load <4 x float>, ptr %i.bk, align 4
...
bb.c:                                             ; preds = %bb.b
  ...
  %2 = load <4 x float>, ptr %i.ae, align 8
  ...
  %i.cf = shufflevector <4 x float> %2, <4 x float> poison, <2 x i32> zeroinitializer
...
bb.b:                                             ; preds = %bb.a
  ...
  %15 = load <4 x float>, ptr %i.bd, align 4
  %i.be = getelementptr inbounds nuw i8, ptr %0, i64 464 ; 2 uses
  %16 = load <4 x float>, ptr %i.be, align 8
  ...
  %17 = load <4 x float>, ptr %i.bh, align 4
  ...
  %i.bv = shufflevector <4 x float> %16, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %i.ca = shufflevector <4 x float> %15, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %i.ce = insertelement <2 x float> poison, float %i.bq, i64 0
  %i.cf = insertelement <2 x float> %i.ce, float %i.bg, i64 1
  %i.cg = shufflevector <4 x float> %17, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.ch = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cf, <2 x float> %i.cg, <2 x float> %i.cb)
...
begin_hunk_3_@_ZN21btConeTwistConstraint14setMotorTargetERK12btQuaternion:bb.a
  ...
  %9 = load <4 x float>, ptr %i.fh, align 4
  %10 = load <4 x float>, ptr %i.fi, align 4      ; 2 uses
  %11 = load <4 x float>, ptr %i.fj, align 4
  %i.hd = insertelement <4 x float> <float poison, float poison, float poison, float 0.000000e+00>, float %i.fn, i64 2
  %i.he = shufflevector <4 x float> %10, <4 x float> %i.hd, <4 x i32> <i32 0, i32 1, i32 6, i32 7> ; 2 uses
  ...
  %i.hi = shufflevector <4 x float> %9, <4 x float> %i.hh, <4 x i32> <i32 0, i32 1, i32 6, i32 7> ; 3 uses
  ...
  %i.hm = shufflevector <4 x float> %11, <4 x float> %i.hl, <4 x i32> <i32 0, i32 1, i32 6, i32 7> ; 3 uses
  ...
  %i.hr = shufflevector <4 x float> %10, <4 x float> %i.hq, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
