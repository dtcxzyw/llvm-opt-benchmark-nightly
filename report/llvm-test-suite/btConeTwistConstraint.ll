...
bb.j:                                             ; preds = %._crit_edge
  ...
  %i.tt = call float @llvm.fmuladd.f32(float %.0.i, float %.0.i, float %i.ts)
...
bb.aa:                                            ; preds = %bb.x, %bb.z, %bb.y, %bb.r, %bb.t, %bb.s, %bb.u, %bb.v, %bb.o, %bb.p
  ...
  %i.aec = call float @llvm.fmuladd.f32(float %i.adu, float %i.adu, float %i.aeb)
...
bb.c:                                             ; preds = %._crit_edge, %bb.b
  ...
  %i.s = fneg float %i.b
  %i.t = tail call float @llvm.fmuladd.f32(float %i.b, float %i.b, float %.pre-phi)
