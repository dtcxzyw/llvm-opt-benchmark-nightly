...
bb.a:
  ...
  %i.ce = load <2 x float>, ptr %3, align 4, !tbaa !27 ; 2 uses
  %i.cf = load float, ptr %i.bh, align 8, !tbaa !27 ; 2 uses
  %i.cg = load float, ptr %i.bg, align 4, !tbaa !27 ; 2 uses
  %i.ch = load float, ptr %i.bk, align 4, !tbaa !27 ; 2 uses
  %6 = load <2 x float>, ptr %i.bl, align 4, !tbaa !27 ; 2 uses
  %7 = insertelement <2 x float> poison, float %i.cf, i64 0
  %8 = shufflevector <2 x float> %7, <2 x float> poison, <2 x i32> zeroinitializer
  %9 = shufflevector <2 x float> %i.ce, <2 x float> %6, <2 x i32> <i32 1, i32 3>
  %10 = fmul <2 x float> %8, %9
  %i.ci = shufflevector <2 x float> %i.ce, <2 x float> %6, <2 x i32> <i32 0, i32 2>
  ...
  %i.cl = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ci, <2 x float> %i.ck, <2 x float> %10)
  ...
  %i.cr = fmul float %i.cf, %i.br
  %i.cs = tail call float @llvm.fmuladd.f32(float %i.bp, float %i.cg, float %i.cr)
  %i.ct = tail call noundef float @llvm.fmuladd.f32(float %i.bt, float %i.ch, float %i.cs) ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.y = getelementptr inbounds nuw i8, ptr %i.g, i64 40 ; 2 uses
  %i.z = getelementptr inbounds nuw i8, ptr %i.g, i64 48
  %i.aa = load float, ptr %i.z, align 8, !tbaa !27
  %i.ab = load <2 x float>, ptr %i.h, align 8, !tbaa !27 ; 2 uses
  %i.ac = load float, ptr %i.k, align 8, !tbaa !27 ; 2 uses
  %i.ad = load float, ptr %i.j, align 4, !tbaa !27 ; 2 uses
  %i.ae = load float, ptr %i.n, align 4, !tbaa !27 ; 2 uses
  %15 = load <2 x float>, ptr %i.y, align 8, !tbaa !27 ; 2 uses
  %16 = shufflevector <2 x float> %15, <2 x float> %i.ab, <2 x i32> <i32 1, i32 3>
  %17 = insertelement <2 x float> poison, float %i.ac, i64 0
  %18 = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> zeroinitializer
  %19 = fmul <2 x float> %16, %18
  %i.af = shufflevector <2 x float> %15, <2 x float> %i.ab, <2 x i32> <i32 0, i32 2>
  ...
  %i.ai = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.af, <2 x float> %i.ah, <2 x float> %19)
  %i.aj = insertelement <2 x float> poison, float %i.aa, i64 0
  %i.ak = insertelement <2 x float> %i.aj, float %i.m, i64 1
  %i.al = insertelement <2 x float> poison, float %i.ae, i64 0
  ...
  %i.ao = fmul float %i.ac, %i.t
  %i.ap = tail call float @llvm.fmuladd.f32(float %i.r, float %i.ad, float %i.ao)
  %i.aq = tail call noundef float @llvm.fmuladd.f32(float %i.v, float %i.ae, float %i.ap)
...
bb.g:                                             ; preds = %.loopexit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.mo, ptr noundef nonnull align 8 dereferenceable(16) %i.y, i64 16, i1 false), !tbaa.struct !24
...
bb.ag:                                            ; preds = %bb.af
  ...
  %i.bea = load float, ptr %i.bdy, align 8, !tbaa !27 ; 3 uses
...
bb.ai:                                            ; preds = %bb.ah, %bb.ag
  ...
  %i.bet = load ptr, ptr %i.f, align 8, !tbaa !36, !nonnull !32, !align !37 ; 7 uses
  %i.beu = getelementptr inbounds nuw i8, ptr %i.bet, i64 280
  %i.bev = getelementptr inbounds nuw i8, ptr %i.bet, i64 288
  %i.bew = load float, ptr %i.bev, align 8, !tbaa !27
  %i.bex = getelementptr inbounds nuw i8, ptr %i.bet, i64 296
  ...
  %i.bfx = load <2 x float>, ptr %i.beu, align 8, !tbaa !27 ; 2 uses
  %20 = load <2 x float>, ptr %i.bex, align 8, !tbaa !27 ; 2 uses
  %21 = insertelement <2 x float> poison, float %i.bea, i64 0
  %22 = shufflevector <2 x float> %21, <2 x float> poison, <2 x i32> zeroinitializer
  %23 = shufflevector <2 x float> %i.bfx, <2 x float> %20, <2 x i32> <i32 1, i32 3>
  %24 = fmul <2 x float> %22, %23
  %i.bfy = shufflevector <2 x float> %i.bfx, <2 x float> %20, <2 x i32> <i32 0, i32 2>
  ...
  %i.bgb = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bfy, <2 x float> %i.bga, <2 x float> %24)
  ...
  %i.bgr = load ptr, ptr %i.ax, align 8, !tbaa !38, !nonnull !32, !align !37 ; 7 uses
  %i.bgs = getelementptr inbounds nuw i8, ptr %i.bgr, i64 280
  %i.bgt = getelementptr inbounds nuw i8, ptr %i.bgr, i64 288
  %i.bgu = load float, ptr %i.bgt, align 8, !tbaa !27
  %i.bgv = getelementptr inbounds nuw i8, ptr %i.bgr, i64 296
  ...
  %i.bhs = load <2 x float>, ptr %i.bgs, align 8, !tbaa !27 ; 2 uses
  %i.bht = load float, ptr %i.bdy, align 8, !tbaa !27 ; 2 uses
  %i.bhu = load float, ptr %i.bdx, align 4, !tbaa !27 ; 2 uses
  %i.bhv = load float, ptr %i.bdz, align 4, !tbaa !27 ; 2 uses
  %i.bhw = load <2 x float>, ptr %i.bgv, align 8, !tbaa !27 ; 2 uses
  %25 = insertelement <2 x float> poison, float %i.bht, i64 0
  %26 = shufflevector <2 x float> %25, <2 x float> poison, <2 x i32> zeroinitializer
  %27 = shufflevector <2 x float> %i.bhs, <2 x float> %i.bhw, <2 x i32> <i32 1, i32 3>
  %28 = fmul <2 x float> %26, %27
  %29 = shufflevector <2 x float> %i.bhs, <2 x float> %i.bhw, <2 x i32> <i32 0, i32 2>
  %i.bhx = insertelement <2 x float> poison, float %i.bhu, i64 0
  %30 = shufflevector <2 x float> %i.bhx, <2 x float> poison, <2 x i32> zeroinitializer
  %i.bhy = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %29, <2 x float> %30, <2 x float> %28)
