...
bb.a:
  ...
  %i.ak = shufflevector <2 x float> %i.x, <2 x float> %i.ad, <2 x i32> <i32 0, i32 3>
  %8 = fneg <2 x float> %i.ak
  %i.al = shufflevector <2 x float> %i.ad, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 3 uses
  %9 = shufflevector <2 x float> %i.ad, <2 x float> %i.x, <2 x i32> <i32 0, i32 3>
  ...
  %i.at = fsub <2 x float> %i.as, %i.u            ; 6 uses
  ...
  %i.ck = fsub <2 x float> %i.cj, %i.u            ; 4 uses
  ...
  %i.cu = shufflevector <2 x float> %i.ck, <2 x float> %i.at, <2 x i32> <i32 1, i32 2> ; 2 uses
  %i.cv = fmul <2 x float> %i.cu, %8
  %i.cw = shufflevector <2 x float> %i.at, <2 x float> %i.ck, <2 x i32> <i32 1, i32 3> ; 2 uses
  %i.cx = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %10, <2 x float> %i.cw, <2 x float> %i.cv) ; 2 uses
  %i.cy = fneg <2 x float> %i.cw
  %i.cz = fmul <2 x float> %9, %i.cy
  %i.da = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cu, <2 x float> %i.am, <2 x float> %i.cz) ; 2 uses
