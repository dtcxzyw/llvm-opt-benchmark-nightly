...
bb.a:
  ...
  %i.q = load <2 x float>, ptr %i.d, align 4, !tbaa !20 ; 8 uses
  ...
  %6 = load <2 x float>, ptr %i.k, align 4, !tbaa !20 ; 4 uses
  %7 = fsub <2 x float> %6, %i.q                  ; 2 uses
  ...
  %i.af = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.x, <2 x float> %8, <2 x float> %i.ae) ; 4 uses
...
bb.c:                                             ; preds = %bb.a
  ...
  %9 = fsub float %i.y, %i.ak
  %10 = extractelement <2 x float> %6, i64 1      ; 2 uses
  %i.al = fsub float %10, %i.f
  %11 = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> zeroinitializer
  %12 = shufflevector <2 x float> %i.g, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %13 = fsub <2 x float> %11, %12
  %i.am = fmul <2 x float> %i.v, %13
  %i.an = insertelement <2 x float> poison, float %9, i64 0
...
bb.f:                                             ; preds = %bb.e
  ...
  %14 = extractelement <2 x float> %i.q, i64 0
  %i.bp = fadd float %14, %i.bl
  %15 = extractelement <2 x float> %i.q, i64 1
  %i.bq = fadd float %15, %i.bn
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.bu = fsub float %i.y, %i.bt
  %i.bv = fsub float %10, %i.j
  %16 = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> zeroinitializer
  %17 = shufflevector <2 x float> %i.h, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %18 = fsub <2 x float> %16, %17
  %i.bw = fmul <2 x float> %i.v, %18
...
bb.j:                                             ; preds = %bb.i
  ...
  %19 = extractelement <2 x float> %i.q, i64 0
  %i.cx = fadd float %19, %i.ct
  %20 = extractelement <2 x float> %i.q, i64 1
  %i.cy = fadd float %20, %i.cv
...
bb.a:
  ...
  %8 = shufflevector <2 x float> %foldExtExtBinop, <2 x float> poison, <3 x i32> <i32 0, i32 poison, i32 poison>
  %9 = extractelement <2 x float> %foldExtExtBinop, i64 0
  %10 = load float, ptr %i.i, align 4, !tbaa !20  ; 2 uses
  %11 = load <2 x float>, ptr %4, align 4, !tbaa !20 ; 2 uses
  %i.p = shufflevector <2 x float> %11, <2 x float> %i.n, <2 x i32> <i32 0, i32 3>
  %i.q = fsub <2 x float> %i.p, %i.o              ; 7 uses
  %i.r = shufflevector <2 x float> %i.q, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 3 uses
  %12 = extractelement <2 x float> %i.o, i64 1    ; 2 uses
  ...
  %15 = load float, ptr %i.l, align 4, !tbaa !20  ; 2 uses
  %16 = load <2 x float>, ptr %5, align 4, !tbaa !20 ; 2 uses
  %17 = fsub <2 x float> %16, %i.o                ; 7 uses
  %i.s = load float, ptr %i.m, align 4, !tbaa !20 ; 2 uses
  ...
  %18 = extractelement <2 x float> %i.ag, i64 0
  %19 = shufflevector <2 x float> %i.af, <2 x float> %i.ag, <2 x i32> <i32 3, i32 1>
  %20 = fsub <2 x float> %19, %14                 ; 7 uses
  ...
  %21 = fsub float %i.ai, %12                     ; 2 uses
  %i.aj = insertelement <2 x float> poison, float %15, i64 0 ; 2 uses
  %i.ak = insertelement <2 x float> %i.aj, float %i.s, i64 1
  %i.al = fsub <2 x float> %i.ak, %14             ; 4 uses
  %i.am = shufflevector <2 x float> %i.al, <2 x float> poison, <2 x i32> zeroinitializer
  %i.an = fsub float %18, %12                     ; 5 uses
  %i.ao = shufflevector <2 x float> %i.q, <2 x float> %20, <3 x i32> <i32 0, i32 poison, i32 2>
  %i.ap = insertelement <3 x float> %i.ao, float %i.an, i64 1
  %i.aq = fneg <3 x float> %i.ap
  %i.ar = shufflevector <2 x float> %i.q, <2 x float> %20, <3 x i32> <i32 1, i32 3, i32 poison>
  %i.as = shufflevector <3 x float> %i.ar, <3 x float> %8, <3 x i32> <i32 0, i32 1, i32 3>
  %i.at = fmul <3 x float> %i.as, %i.aq
  %i.au = shufflevector <2 x float> %i.q, <2 x float> %20, <3 x i32> <i32 poison, i32 1, i32 3>
  ...
  %i.ax = shufflevector <2 x float> %20, <2 x float> %i.q, <3 x i32> <i32 poison, i32 0, i32 2>
  ...
  %i.bo = shufflevector <2 x float> %i.al, <2 x float> %20, <2 x i32> <i32 1, i32 2> ; 2 uses
  %i.bp = fmul <2 x float> %i.bo, %i.aa
  %i.bq = insertelement <2 x float> %i.ab, float %i.an, i64 1
  %i.br = shufflevector <2 x float> %20, <2 x float> %i.al, <2 x i32> <i32 1, i32 3> ; 2 uses
  ...
  %i.cc = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %20, <2 x float> %i.bk, <2 x float> %i.cb) ; 3 uses
  ...
  %i.cj = shufflevector <2 x float> %16, <2 x float> poison, <3 x i32> <i32 0, i32 1, i32 poison>
  %i.ck = insertelement <3 x float> %i.cj, float %i.s, i64 2
  %i.cl = shufflevector <2 x float> %i.n, <2 x float> %i.af, <3 x i32> <i32 0, i32 2, i32 3>
  %i.cm = fsub <3 x float> %i.ck, %i.cl           ; 2 uses
  %i.cn = shufflevector <2 x float> %11, <2 x float> %i.ag, <3 x i32> <i32 2, i32 3, i32 0>
  ...
  %i.db = insertelement <2 x float> %i.aj, float %10, i64 1
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.eh = fsub float %.sroa.8232.0.copyload, %15  ; 2 uses
