...
bb.a:
  ...
  %8 = load <4 x float>, ptr %2, align 4          ; 2 uses
  ...
  %i.w = load float, ptr %i.k, align 4, !tbaa !20 ; 3 uses
...
bb.a:
  ...
  %7 = load float, ptr %2, align 4, !tbaa !20     ; 2 uses
  %8 = load <2 x float>, ptr %6, align 4, !tbaa !20 ; 3 uses
