...
bb.j:                                             ; preds = %bb.h, %bb.f, %_ZN11btTransform11getIdentityEv.exit
  ...
  %6 = load <3 x float>, ptr %3, align 4          ; 7 uses
  %.sroa.39.48.copyload = load float, ptr %3, align 4 ; 3 uses
  ...
  %i.bo = fneg <3 x float> %i.bn                  ; 6 uses
  %7 = shufflevector <3 x float> %i.bo, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %8 = fmul <2 x float> %i.bl, %7
  %9 = shufflevector <3 x float> %i.bo, <3 x float> poison, <2 x i32> zeroinitializer
  %10 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bk, <2 x float> %9, <2 x float> %8)
  %11 = shufflevector <3 x float> %i.bo, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %12 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bm, <2 x float> %11, <2 x float> %10)
  %i.bp = shufflevector <3 x float> %6, <3 x float> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.bq = fmul <2 x float> %i.bp, %i.bl
  %i.br = shufflevector <3 x float> %6, <3 x float> poison, <2 x i32> zeroinitializer
  %i.bs = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bk, <2 x float> %i.br, <2 x float> %i.bq)
  %i.bt = shufflevector <3 x float> %6, <3 x float> poison, <2 x i32> <i32 2, i32 2> ; 2 uses
  %i.bu = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bm, <2 x float> %i.bt, <2 x float> %i.bs)
  %13 = fadd <2 x float> %i.bu, %12
  %14 = shufflevector <3 x float> %6, <3 x float> %i.bo, <2 x i32> <i32 1, i32 4>
  %15 = insertelement <2 x float> poison, float %i.bh, i64 0
  %i.bv = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> zeroinitializer
  %16 = fmul <2 x float> %14, %i.bv
  %i.bw = insertelement <2 x float> poison, float %i.bg, i64 0
  %i.bx = shufflevector <2 x float> %i.bw, <2 x float> poison, <2 x i32> zeroinitializer
  %17 = shufflevector <3 x float> %i.bo, <3 x float> poison, <2 x i32> <i32 poison, i32 0>
  %18 = insertelement <2 x float> %17, float %.sroa.39.48.copyload, i64 0
  %19 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bx, <2 x float> %18, <2 x float> %16)
  %i.by = insertelement <2 x float> poison, float %i.bi, i64 0
  %i.bz = shufflevector <2 x float> %i.by, <2 x float> poison, <2 x i32> zeroinitializer
  %20 = shufflevector <3 x float> %6, <3 x float> %i.bo, <2 x i32> <i32 2, i32 5>
  %i.ca = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bz, <2 x float> %20, <2 x float> %19) ; 2 uses
  %shift = shufflevector <2 x float> %i.ca, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop = fadd <2 x float> %i.ca, %shift
  ...
  store <2 x float> %13, ptr %i.dl, align 8
  ...
  %21 = load float, ptr %i.dp, align 8, !tbaa !10, !noalias !25 ; 2 uses
  %22 = load float, ptr %i.dq, align 8, !tbaa !10, !noalias !25 ; 2 uses
  %23 = load float, ptr %i.dr, align 8, !tbaa !10, !noalias !25 ; 2 uses
  ...
  %i.dv = load <3 x float>, ptr %24, align 8, !tbaa !10, !noalias !26
  ...
  %i.ed = fmul <2 x float> %i.bp, %i.dt
  %25 = insertelement <2 x float> poison, float %.sroa.39.48.copyload, i64 0
  %26 = shufflevector <2 x float> %25, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ee = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ds, <2 x float> %26, <2 x float> %i.ed)
  %27 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.du, <2 x float> %i.bt, <2 x float> %i.ee)
  %28 = fadd <2 x float> %27, %i.ec
  %29 = shufflevector <3 x float> %6, <3 x float> %i.dw, <2 x i32> <i32 1, i32 4>
  %i.ef = insertelement <2 x float> poison, float %22, i64 0
  %i.eg = shufflevector <2 x float> %i.ef, <2 x float> poison, <2 x i32> zeroinitializer
  %i.eh = fmul <2 x float> %29, %i.eg
  %i.ei = insertelement <2 x float> poison, float %21, i64 0
  %i.ej = shufflevector <2 x float> %i.ei, <2 x float> poison, <2 x i32> zeroinitializer
  %30 = shufflevector <3 x float> %i.dw, <3 x float> poison, <2 x i32> <i32 poison, i32 0>
  %31 = insertelement <2 x float> %30, float %.sroa.39.48.copyload, i64 0
  %i.ek = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ej, <2 x float> %31, <2 x float> %i.eh)
  %i.el = insertelement <2 x float> poison, float %23, i64 0
  %i.em = shufflevector <2 x float> %i.el, <2 x float> poison, <2 x i32> zeroinitializer
  %32 = shufflevector <3 x float> %6, <3 x float> %i.dw, <2 x i32> <i32 2, i32 5>
  %i.en = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.em, <2 x float> %32, <2 x float> %i.ek) ; 2 uses
  ...
  %i.fg = insertelement <4 x float> <float poison, float 0.000000e+00, float poison, float poison>, float %22, i64 0
  %i.fh = shufflevector <4 x float> %i.fg, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %i.fi = fmul <4 x float> %i.fh, %i.cg
  %i.fj = insertelement <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, float %21, i64 0
  ...
  %i.fm = insertelement <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, float %23, i64 0
  ...
  store <2 x float> %28, ptr %i.fp, align 8
