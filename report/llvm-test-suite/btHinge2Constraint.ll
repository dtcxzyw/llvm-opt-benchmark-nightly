...
bb.j:                                             ; preds = %bb.h, %bb.f, %_ZN11btTransform11getIdentityEv.exit
  ...
  %i.ei = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cl, <2 x float> %6, <2 x float> %i.cj) ; 2 uses
  ...
  %i.fb = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.el, <2 x float> %i.ef, <2 x float> %i.fa)
  ...
  %11 = shufflevector <2 x float> %i.ew, <2 x float> %i.ee, <2 x i32> <i32 3, i32 1>
  %i.fk = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.fj, <2 x float> %11, <2 x float> %i.fh) ; 2 uses
