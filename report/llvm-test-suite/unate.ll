...
begin_hunk_0_@exact_minimum_cover:bb.a
  %i.cq = load i32, ptr %i.cp, align 4, !tbaa !13
  %i.cr = load i32, ptr %i.ci, align 8, !tbaa !23 ; 2 uses
...
.lr.ph123:                                        ; preds = %.lr.ph123.preheader, %.loopexit
  %.1121 = phi ptr [ %i.hl, %.loopexit ], [ %i.fx, %.lr.ph123.preheader ] ; 7 uses
...
vector.memcheck:                                  ; preds = %.lr.ph123
  %.not149 = icmp eq i32 %i.gk, 0
  %i.gn = select i1 %.not149, i64 0, i64 4        ; 2 uses
  %scevgep = getelementptr i8, ptr %.1121, i64 %i.gn
  %scevgep140 = getelementptr i8, ptr %.1121, i64 4
  %i.go = shl nuw nsw i64 %i.gl, 2                ; 2 uses
  %scevgep141 = getelementptr i8, ptr %scevgep140, i64 %i.go
  %scevgep142 = getelementptr i8, ptr %i.fv, i64 %i.gn
  %scevgep144 = getelementptr i8, ptr %scevgep143, i64 %i.go
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.gp = sub nsw i64 %i.gl, %n.vec
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.gq = sub i64 %i.gl, %index                   ; 2 uses
  %i.gr = getelementptr inbounds nuw [4 x i8], ptr %i.fv, i64 %i.gq ; 2 uses
  ...
  %wide.load146.a = load <4 x i32>, ptr %i.gt, align 4, !tbaa !4, !alias.scope !42
  %i.gu = getelementptr inbounds nuw [4 x i8], ptr %.1121, i64 %i.gq ; 2 uses
  %i.gv = getelementptr inbounds i8, ptr %i.gu, i64 -12 ; 2 uses
  %i.gw = getelementptr inbounds i8, ptr %i.gu, i64 -28 ; 2 uses
  %wide.load147.a = load <4 x i32>, ptr %i.gv, align 4, !tbaa !4, !alias.scope !45, !noalias !42
  %wide.load148 = load <4 x i32>, ptr %i.gw, align 4, !tbaa !4, !alias.scope !45, !noalias !42
  %i.gx = xor <4 x i32> %wide.load147.a, splat (i32 -1)
  %i.gy = xor <4 x i32> %wide.load148, splat (i32 -1)
  %i.gz = and <4 x i32> %wide.load, %i.gx
  %i.ha = and <4 x i32> %wide.load146.a, %i.gy
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph123, %middle.block
  %indvars.iv.ph = phi i64 [ %i.gl, %vector.memcheck ], [ %i.gl, %.lr.ph123 ], [ %i.gp, %middle.block ]
  br label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %scalar.ph ], [ %indvars.iv.ph, %scalar.ph.preheader ] ; 4 uses
  %i.hc = getelementptr inbounds nuw [4 x i8], ptr %i.fv, i64 %indvars.iv
  %i.hd = load i32, ptr %i.hc, align 4, !tbaa !4
  %i.he = getelementptr inbounds nuw [4 x i8], ptr %.1121, i64 %indvars.iv ; 2 uses
...
.loopexit:                                        ; preds = %scalar.ph, %middle.block
  %i.hj = load i32, ptr %i.fj, align 8, !tbaa !23
  %i.hk = sext i32 %i.hj to i64
  %i.hl = getelementptr inbounds [4 x i8], ptr %.1121, i64 %i.hk ; 2 uses
  %i.hm = icmp ult ptr %i.hl, %i.gd
...
.lr.ph104.split.us:                               ; preds = %.lr.ph104, %._crit_edge.split.us118
  %i.r = phi i32 [ %i.z, %._crit_edge.split.us118 ], [ %i.h, %.lr.ph104 ]
  %i.s = phi i32 [ %i.aa, %._crit_edge.split.us118 ], [ %.pre130, %.lr.ph104 ] ; 2 uses
  %.0101.us = phi ptr [ %i.ac, %._crit_edge.split.us118 ], [ %i.e, %.lr.ph104 ] ; 3 uses
...
._crit_edge.split.us118:                          ; preds = %._crit_edge.split.us118.loopexit, %.lr.ph104.split.us
  %i.z = phi i32 [ %i.r, %.lr.ph104.split.us ], [ %.pre129, %._crit_edge.split.us118.loopexit ] ; 2 uses
  %i.aa = phi i32 [ %i.s, %.lr.ph104.split.us ], [ %i.bc, %._crit_edge.split.us118.loopexit ]
  ...
  %i.ac = getelementptr inbounds [4 x i8], ptr %.0101.us, i64 %i.ab ; 2 uses
  %i.ad = icmp ult ptr %i.ac, %i.k
  br i1 %i.ad, label %.lr.ph104.split.us, label %._crit_edge105
...
.lr.ph.us:                                        ; preds = %.lr.ph104.split.us, %.thread80.us114
  ...
  %.06586.us111 = phi ptr [ %i.be, %.thread80.us114 ], [ %i.t, %.lr.ph104.split.us ] ; 3 uses
  %i.ae = tail call i32 (ptr, ptr, ptr, ...) @set_andp(ptr noundef %.16287.us110, ptr noundef %.0101.us, ptr noundef %.06586.us111) #10
  %.not127 = icmp eq i32 %i.ae, 0
  br i1 %.not127, label %.thread80.us114, label %bb.b

bb.b:                                             ; preds = %.lr.ph.us
  %i.af = tail call i32 (ptr, ...) @set_ord(ptr noundef %.16287.us110) #10 ; 3 uses
  %i.ag = icmp sgt i32 %i.af, %.190.us
