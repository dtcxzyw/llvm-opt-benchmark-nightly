...
._crit_edge:                                      ; preds = %.lr.ph15, %middle.block30, %.preheader
  ret ptr %i.d
}
...
bb.a:
  ...
  %i.c = load i32, ptr @nrow, align 4, !tbaa !18  ; 2 uses
...
.lr.ph.i:                                         ; preds = %bb.b
  %i.l = load i32, ptr @nrow, align 4, !tbaa !18  ; 2 uses
...
vector.body129:                                   ; preds = %vector.body129, %vector.ph125
  ...
  store <4 x i32> %broadcast.splat128, ptr %i.n, align 4, !tbaa !18
  store <4 x i32> %broadcast.splat128, ptr %i.o, align 4, !tbaa !18
  %index.next131 = add nuw i64 %index130, 8       ; 2 uses
  %i.p = icmp eq i64 %index.next131, %n.vec126
  br i1 %i.p, label %middle.block132, label %vector.body129, !llvm.loop !50
...
vector.body117:                                   ; preds = %vector.body117, %vector.ph115
  ...
  store <4 x i32> %broadcast.splat, ptr %i.u, align 4, !tbaa !18
  store <4 x i32> %broadcast.splat, ptr %i.v, align 4, !tbaa !18
  %index.next119 = add nuw i64 %index118, 8       ; 2 uses
  %i.w = icmp eq i64 %index.next119, %n.vec116
  br i1 %i.w, label %middle.block120, label %vector.body117, !llvm.loop !51
...
scalar.ph123:                                     ; preds = %scalar.ph123.preheader, %scalar.ph123
  ...
  store i32 %i.l, ptr %i.x, align 4, !tbaa !18
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %.not.i = icmp eq i64 %indvars.iv.next.i, %i.m
  br i1 %.not.i, label %.lr.ph15.preheader.i, label %scalar.ph123, !llvm.loop !52
...
.lr.ph15.i:                                       ; preds = %.lr.ph15.i.preheader, %.lr.ph15.i
  ...
  store i32 %.13566, ptr %i.y, align 4, !tbaa !18
  %indvars.iv.next18.i = add nuw nsw i64 %indvars.iv17.i, 1 ; 2 uses
  %.not10.i = icmp eq i64 %indvars.iv.next18.i, %i.q
  br i1 %.not10.i, label %.lr.ph.i42.preheader, label %.lr.ph15.i, !llvm.loop !53
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %i.ad, align 4, !tbaa !18
  %wide.load105 = load <4 x i32>, ptr %i.ae, align 4, !tbaa !18
  ...
  %wide.load107 = load <4 x i32>, ptr %i.ag, align 4, !tbaa !18
  %wide.load108 = load <4 x i32>, ptr %i.ah, align 4, !tbaa !18
  ...
  br i1 %i.ak, label %middle.block, label %vector.body, !llvm.loop !54
...
.lr.ph.i42:                                       ; preds = %.lr.ph.i42.preheader136, %.lr.ph.i42
  ...
  br i1 %.not.i45, label %melt_data.exit.preheader, label %.lr.ph.i42, !llvm.loop !55
...
melt_data.exit:                                   ; preds = %.lr.ph99
  ...
  br i1 %i.aq, label %equal_data.exit.thread, label %.lr.ph99, !llvm.loop !1
...
.lr.ph99:                                         ; preds = %melt_data.exit.preheader, %melt_data.exit
  ...
  br i1 %i.av, label %melt_data.exit, label %equal_data.exit, !llvm.loop !1
...
.lr.ph.preheader.i48:                             ; preds = %equal_data.exit
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 4 %scevgep.i, ptr readonly align 4 %scevgep7.i, i64 %i.bf, i1 false), !tbaa !18
  store ptr %i.az, ptr %i.ax, align 8, !tbaa !27
  %i.bg = getelementptr inbounds nuw i8, ptr %i.ax, i64 8
  store ptr null, ptr %i.bg, align 8, !tbaa !26
  %i.bh = load ptr, ptr %i.ay, align 8, !tbaa !26 ; 4 uses
  %i.bi = load i32, ptr %1, align 4, !tbaa !18    ; 2 uses
...
.preheader.split:                                 ; preds = %.lr.ph.preheader.i48, %equal_data.exit.i
  ...
  %.0.i = load ptr, ptr %.0.in.i, align 8, !tbaa !33 ; 3 uses
...
bb.c:                                             ; preds = %bb.d
  ...
  br i1 %i.bm, label %get_value.exit, label %bb.d, !llvm.loop !1
...
bb.f:                                             ; preds = %bb.e
  %i.bx = load i32, ptr @ncol, align 4, !tbaa !18 ; 3 uses
  %i.by = add nsw i32 %i.bx, -1                   ; 3 uses
  %i.bz = load i32, ptr @nrow, align 4, !tbaa !18
...
bb.g:                                             ; preds = %equal_data.exit.i52
  ...
  %.0.i53 = load ptr, ptr %i.cd, align 8, !tbaa !37 ; 2 uses
  %cond.i = icmp eq ptr %.0.i53, null
  br i1 %cond.i, label %in_wanted.exit.thread, label %bb.h, !llvm.loop !7

bb.h:                                             ; preds = %bb.g, %.lr.ph.i49
  %.013.i = phi ptr [ %.011.i, %.lr.ph.i49 ], [ %.0.i53, %bb.g ] ; 2 uses
  %i.ce = load ptr, ptr %.013.i, align 8, !tbaa !27
  br i1 %i.cc, label %in_wanted.exit, label %.lr.ph103

bb.i:                                             ; preds = %.lr.ph103
  %i.cf = icmp eq i64 %indvars.iv.next.i.i51, 0
  br i1 %i.cf, label %in_wanted.exit, label %.lr.ph103, !llvm.loop !1
...
.lr.ph103:                                        ; preds = %bb.h, %bb.i
  ...
  br i1 %i.ck, label %bb.i, label %equal_data.exit.i52, !llvm.loop !1
...
in_wanted.exit.thread:                            ; preds = %bb.g, %bb.f, %bb.e, %in_wanted.exit, %equal_data.exit.thread
  ...
  %i.cq = load i32, ptr @ncol, align 4, !tbaa !18 ; 2 uses
  %.not38 = icmp eq i32 %i.cp, %i.cq
  br i1 %.not38, label %._crit_edge.loopexit, label %bb.b, !llvm.loop !56

._crit_edge.loopexit:                             ; preds = %in_wanted.exit.thread
  %.pre = load i32, ptr @nrow, align 4, !tbaa !18
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader60
  ...
  br i1 %.not, label %._crit_edge73, label %.preheader60, !llvm.loop !57
...
._crit_edge73:                                    ; preds = %._crit_edge
  %.pre78 = load ptr, ptr %i.b, align 8, !tbaa !26 ; 2 uses
...
bb.j:                                             ; preds = %._crit_edge73
  %i.cu = load i32, ptr %1, align 4, !tbaa !18
  %i.cv = sub nsw i32 1, %i.cu
  store i32 %i.cv, ptr %1, align 4, !tbaa !18
  br label %bb.k
...
bb.a:
  ...
  store ptr null, ptr @game_tree, align 8, !tbaa !33
  %i.d = load i32, ptr @ncol, align 4, !tbaa !18  ; 3 uses
...
.lr.ph.i.preheader.preheader:                     ; preds = %bb.a
  ...
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.g, i8 0, i64 %i.i, i1 false), !tbaa !18
  %.pre = load i32, ptr %i.g, align 4, !tbaa !18
  %i.j = add nsw i32 %.pre, -1
  store i32 %i.j, ptr %i.g, align 4, !tbaa !18
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %bb.b
  ...
  %i.m = load i32, ptr @nrow, align 4, !tbaa !18
...
bb.b:                                             ; preds = %.lr.ph.i
  ...
  %i.o = load i32, ptr @ncol, align 4, !tbaa !18
  %i.p = zext i32 %i.o to i64
  %.not.not.i = icmp eq i64 %indvars.iv.next, %i.p
  br i1 %.not.not.i, label %.loopexit38, label %.lr.ph.i, !llvm.loop !0

bb.c:                                             ; preds = %.lr.ph.i
  %i.q = add nsw i32 %i.l, 1
  store i32 %i.q, ptr %i.k, align 4, !tbaa !18
  %i.r = load i32, ptr @ncol, align 4, !tbaa !18  ; 5 uses
  %.not9.i = icmp eq i32 %i.r, 0                  ; 2 uses
  br i1 %.not9.i, label %.loopexit, label %.lr.ph.preheader.i

.lr.ph.preheader.i:                               ; preds = %bb.c
  %i.s = load i32, ptr @nrow, align 4, !tbaa !18
...
bb.d:                                             ; preds = %.lr.ph.i20
  ...
  br i1 %.not.i, label %.loopexit, label %.lr.ph.i20, !llvm.loop !2
...
.loopexit:                                        ; preds = %bb.d, %bb.c
  ...
  %i.z = load ptr, ptr @game_tree, align 8, !tbaa !33
  %i.aa = icmp eq ptr %i.z, null
  br i1 %i.aa, label %bb.e, label %bb.f

bb.e:                                             ; preds = %.loopexit
  store ptr %i.x, ptr @game_tree, align 8, !tbaa !33
  br label %bb.f
...
.lr.ph.preheader.i21:                             ; preds = %bb.f
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 4 %scevgep.i, ptr readonly align 4 %scevgep7.i, i64 %i.ak, i1 false), !tbaa !18
...
copy_data.exit:                                   ; preds = %bb.f, %.lr.ph.preheader.i21
  ...
  %i.an = load ptr, ptr %i.y, align 8, !tbaa !30  ; 3 uses
  %i.ao = getelementptr inbounds nuw i8, ptr %i.an, i64 16
  store ptr %i.am, ptr %i.ao, align 8, !tbaa !31
  %i.ap = load i32, ptr %i.b, align 4, !tbaa !18
  ...
  %i.ar = load ptr, ptr %i.y, align 8, !tbaa !30  ; 3 uses
  %i.as = load i32, ptr %i.a, align 4, !tbaa !18
...
copy_data.exit.valid_data.exit_crit_edge:         ; preds = %copy_data.exit
  %.pre52 = load i32, ptr @ncol, align 4, !tbaa !18
  %i.au = icmp eq i32 %.pre52, 0
  br i1 %i.au, label %.loopexit38, label %.lr.ph.i.preheader, !llvm.loop !59

bb.g:                                             ; preds = %copy_data.exit
  tail call void @free(ptr noundef %.01744.ph) #17
  %i.av = load i32, ptr @nrow, align 4, !tbaa !18 ; 2 uses
  %i.aw = load i32, ptr @ncol, align 4, !tbaa !18 ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> %broadcast.splat, ptr %i.bb, align 4, !tbaa !18
  store <4 x i32> %broadcast.splat, ptr %i.bc, align 4, !tbaa !18
  %index.next = add nuw i64 %index, 8             ; 2 uses
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  store i32 %i.av, ptr %i.be, align 4, !tbaa !18
  %indvars.iv.next.i24 = add nuw nsw i64 %indvars.iv.i23, 1 ; 2 uses
  %.not.i25 = icmp eq i64 %indvars.iv.next.i24, %i.ba
  br i1 %.not.i25, label %valid_data.exit, label %scalar.ph, !llvm.loop !61
...
valid_data.exit:                                  ; preds = %scalar.ph, %.lr.ph.i20, %middle.block
  ...
  br label %.lr.ph.i.preheader.outer, !llvm.loop !59
...
bb.a:
  ...
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 8 ; 2 uses
  store ptr null, ptr %i.b, align 8, !tbaa !26
  %i.c = load i32, ptr @nrow, align 4, !tbaa !18  ; 5 uses
  %.not43 = icmp eq i32 %i.c, 0
  br i1 %.not43, label %._crit_edge46, label %.preheader.lr.ph

.preheader.lr.ph:                                 ; preds = %bb.a
  %i.d = load i32, ptr @ncol, align 4, !tbaa !18  ; 6 uses
...
vector.body106:                                   ; preds = %vector.body106, %vector.ph102
  ...
  store <4 x i32> %broadcast.splat105, ptr %i.r, align 4, !tbaa !18
  store <4 x i32> %broadcast.splat105, ptr %i.s, align 4, !tbaa !18
  %index.next108 = add nuw i64 %index107, 8       ; 2 uses
  %i.t = icmp eq i64 %index.next108, %n.vec103
  br i1 %i.t, label %middle.block109, label %vector.body106, !llvm.loop !62
...
vector.body94:                                    ; preds = %vector.body94, %vector.ph92
  ...
  store <4 x i32> %broadcast.splat, ptr %i.x, align 4, !tbaa !18
  store <4 x i32> %broadcast.splat, ptr %i.y, align 4, !tbaa !18
  %index.next96 = add nuw i64 %index95, 8         ; 2 uses
  %i.z = icmp eq i64 %index.next96, %n.vec93
  br i1 %i.z, label %middle.block97, label %vector.body94, !llvm.loop !63
...
scalar.ph100:                                     ; preds = %scalar.ph100.preheader, %scalar.ph100
  ...
  store i32 %i.c, ptr %i.aa, align 4, !tbaa !18
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %.not.i = icmp eq i64 %indvars.iv.next.i, %i.q
  br i1 %.not.i, label %.lr.ph15.preheader.i, label %scalar.ph100, !llvm.loop !64

.lr.ph15.i:                                       ; preds = %.lr.ph15.i.preheader, %.lr.ph15.i
  %indvars.iv17.i = phi i64 [ %indvars.iv.next18.i, %.lr.ph15.i ], [ %indvars.iv17.i.ph, %.lr.ph15.i.preheader ] ; 2 uses
  %i.ab = getelementptr inbounds nuw [4 x i8], ptr %i.p, i64 %indvars.iv17.i
  store i32 %.02344, ptr %i.ab, align 4, !tbaa !18
  %indvars.iv.next18.i = add nuw nsw i64 %indvars.iv17.i, 1 ; 2 uses
  %.not10.i = icmp eq i64 %indvars.iv.next18.i, %i.g
  br i1 %.not10.i, label %.lr.ph.i28.preheader, label %.lr.ph15.i, !llvm.loop !65
...
vector.body:                                      ; preds = %.lr.ph.i28.preheader, %vector.body
  ...
  %wide.load82 = load <4 x i32>, ptr %i.ag, align 4, !tbaa !18
  ...
  %wide.load84 = load <4 x i32>, ptr %i.ai, align 4, !tbaa !18
  %wide.load85 = load <4 x i32>, ptr %i.aj, align 4, !tbaa !18
  ...
  br i1 %i.am, label %middle.block, label %vector.body, !llvm.loop !66
...
.lr.ph.i28:                                       ; preds = %.lr.ph.i28.preheader112, %.lr.ph.i28
  ...
  br i1 %.not.i31, label %melt_data.exit.loopexit.preheader.preheader, label %.lr.ph.i28, !llvm.loop !67
...
melt_data.exit.loopexit:                          ; preds = %melt_data.exit.loopexit.preheader
  ...
  br i1 %i.ar, label %.thread, label %melt_data.exit.loopexit.preheader, !llvm.loop !1
...
melt_data.exit.loopexit.preheader:                ; preds = %melt_data.exit.loopexit.preheader.preheader, %melt_data.exit.loopexit
  ...
  br i1 %i.aw, label %melt_data.exit.loopexit, label %equal_data.exit, !llvm.loop !1
...
bb.c:                                             ; preds = %equal_data.exit
  ...
  store ptr %i.ay, ptr %i.az, align 8, !tbaa !26
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 4 %scevgep.i, ptr readonly align 4 %scevgep7.i, i64 %i.m, i1 false), !tbaa !18
  ...
  %i.bc = load ptr, ptr %i.az, align 8, !tbaa !26 ; 2 uses
  %i.bd = add nuw nsw i32 %.02140, 1              ; 2 uses
  tail call void @free(ptr noundef nonnull %i.p) #17
  %.not26 = icmp eq i32 %i.bd, %i.d
  br i1 %.not26, label %._crit_edge, label %bb.b, !llvm.loop !68
...
._crit_edge:                                      ; preds = %bb.c, %.thread
  ...
  br i1 %.not, label %._crit_edge46.loopexit47, label %.preheader, !llvm.loop !69
