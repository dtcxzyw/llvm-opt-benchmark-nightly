begin_hunk_0_@_ZThn8_N7NCrypto12CAesCbcCoder6SetKeyEPKhj:bb.a
  ...
  tail call void %i.f(ptr noundef nonnull %i.k, ptr noundef %1, i32 noundef %2), !inline_history !20
...
begin_hunk_1_@_ZN7NCrypto14CAesCbcEncoderC2Ev:bb.a
  ...
  %i.j = load ptr, ptr @g_AesCbc_Encode, align 8, !tbaa !21
...
begin_hunk_2_@_ZN7NCrypto14CAesCbcDecoderC2Ev:bb.a
  ...
  %i.j = load ptr, ptr @g_AesCbc_Decode, align 8, !tbaa !21
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 24
  store ptr %i.j, ptr %i.k, align 8, !tbaa !18
  %i.l = getelementptr inbounds nuw i8, ptr %0, i64 32
end_hunk_2
...
bb.a:
  %i.a = load i8, ptr %1, align 4, !tbaa !22      ; 2 uses
  %i.b = load i8, ptr @IID_IUnknown, align 4, !tbaa !22
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_IUnknown, i64 1), align 1, !tbaa !22
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.g = load i8, ptr %i.f, align 2, !tbaa !22
  %i.h = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_IUnknown, i64 2), align 2, !tbaa !22
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.k = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_IUnknown, i64 3), align 1, !tbaa !22
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.m = load i8, ptr %i.l, align 4, !tbaa !22
  %i.n = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_IUnknown, i64 4), align 4, !tbaa !22
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.q = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_IUnknown, i64 5), align 1, !tbaa !22
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.t = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_IUnknown, i64 6), align 2, !tbaa !22
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.w = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_IUnknown, i64 7), align 1, !tbaa !22
  %.not.7.i = icmp eq i8 %i.v, %i.w
  br i1 %.not.7.i, label %bb.i, label %_ZeqRK4GUIDS1_.exit.thread

bb.i:                                             ; preds = %bb.h
  %i.x = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.y = load i8, ptr %i.x, align 4, !tbaa !22
  %i.z = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_IUnknown, i64 8), align 4, !tbaa !22
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.ac = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_IUnknown, i64 9), align 1, !tbaa !22
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.ae = load i8, ptr %i.ad, align 2, !tbaa !22
  %i.af = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_IUnknown, i64 10), align 2, !tbaa !22
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.ai = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_IUnknown, i64 11), align 1, !tbaa !22
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.ak = load i8, ptr %i.aj, align 4, !tbaa !22
  %i.al = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_IUnknown, i64 12), align 4, !tbaa !22
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.ao = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_IUnknown, i64 13), align 1, !tbaa !22
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.aq = load i8, ptr %i.ap, align 2, !tbaa !22
  %i.ar = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_IUnknown, i64 14), align 2, !tbaa !22
...
_ZeqRK4GUIDS1_.exit:                              ; preds = %bb.o
  ...
  %i.au = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_IUnknown, i64 15), align 1, !tbaa !22
...
_ZeqRK4GUIDS1_.exit.thread:                       ; preds = %bb.m, %bb.h, %bb.l, %bb.g, %bb.n, %bb.f, %bb.j, %bb.e, %bb.o, %bb.d, %bb.k, %bb.c, %bb.b, %bb.i, %bb.a, %_ZeqRK4GUIDS1_.exit
  %i.av = load i8, ptr @IID_ICryptoProperties, align 4, !tbaa !22
...
bb.p:                                             ; preds = %_ZeqRK4GUIDS1_.exit.thread
  ...
  %i.ay = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_ICryptoProperties, i64 1), align 1, !tbaa !22
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.ba = load i8, ptr %i.az, align 2, !tbaa !22
  %i.bb = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_ICryptoProperties, i64 2), align 2, !tbaa !22
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.be = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_ICryptoProperties, i64 3), align 1, !tbaa !22
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.bg = load i8, ptr %i.bf, align 4, !tbaa !22
  %i.bh = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_ICryptoProperties, i64 4), align 4, !tbaa !22
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.bk = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_ICryptoProperties, i64 5), align 1, !tbaa !22
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.bm = load i8, ptr %i.bl, align 2, !tbaa !22
  %i.bn = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_ICryptoProperties, i64 6), align 2, !tbaa !22
...
bb.v:                                             ; preds = %bb.u
  ...
  %i.bq = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_ICryptoProperties, i64 7), align 1, !tbaa !22
...
bb.w:                                             ; preds = %bb.v
  ...
  %i.bs = load i8, ptr %i.br, align 4, !tbaa !22
  %i.bt = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_ICryptoProperties, i64 8), align 4, !tbaa !22
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.bv = load i8, ptr %i.bu, align 1, !tbaa !22
  %i.bw = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_ICryptoProperties, i64 9), align 1, !tbaa !22
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.bz = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_ICryptoProperties, i64 10), align 2, !tbaa !22
...
bb.z:                                             ; preds = %bb.y
  ...
  %i.cc = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_ICryptoProperties, i64 11), align 1, !tbaa !22
...
bb.aa:                                            ; preds = %bb.z
  ...
  %i.ce = load i8, ptr %i.cd, align 4, !tbaa !22
  %i.cf = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_ICryptoProperties, i64 12), align 4, !tbaa !22
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %i.ci = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_ICryptoProperties, i64 13), align 1, !tbaa !22
...
bb.ac:                                            ; preds = %bb.ab
  ...
  %i.ck = load i8, ptr %i.cj, align 2, !tbaa !22
  %i.cl = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_ICryptoProperties, i64 14), align 2, !tbaa !22
...
_ZeqRK4GUIDS1_.exit23:                            ; preds = %bb.ac
  ...
  %i.co = load i8, ptr getelementptr inbounds nuw (i8, ptr @IID_ICryptoProperties, i64 15), align 1, !tbaa !22
...
_ZeqRK4GUIDS1_.exit23.thread.sink.split:          ; preds = %_ZeqRK4GUIDS1_.exit23, %_ZeqRK4GUIDS1_.exit
  ...
  store ptr %i.cp, ptr %2, align 8, !tbaa !21
...
begin_hunk_4_@_ZThn8_N7NCrypto12CAesCbcCoder7ReleaseEv:bb.a
  ...
  tail call void %i.g(ptr noundef nonnull align 8 dereferenceable(328) %i.d) #10, !inline_history !23
...
!18 = !{!13, !17, i64 24}
!19 = !{!13, !17, i64 32}
!20 = !{ptr @_ZN7NCrypto12CAesCbcCoder6SetKeyEPKhj}
!21 = !{!17, !17, i64 0}
!22 = !{!6, !6, i64 0}
!23 = !{ptr @_ZN7NCrypto12CAesCbcCoder7ReleaseEv}
end_hunk_5
