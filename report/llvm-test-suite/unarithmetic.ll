...
.lr.ph.preheader.i:                               ; preds = %bb.s
  ...
  br i1 %min.iters.check, label %.lr.ph.i.a, label %vector.ph93
...
middle.block98:                                   ; preds = %vector.body94
  ...
  br i1 %cmp.n, label %start_decoding.exit.backedge, label %.lr.ph.i.a

start_decoding.exit.backedge:                     ; preds = %.lr.ph.i.a, %.lr.ph.i.1, %.lr.ph.i.2, %.lr.ph.i.3, %.lr.ph.i.4, %.lr.ph.i.5, %.lr.ph.i.6, %middle.block98, %bb.s
  br label %start_decoding.exit

.lr.ph.i.a:                                       ; preds = %middle.block98, %.lr.ph.preheader.i
...
.lr.ph.i.3:                                       ; preds = %.lr.ph.i.2
  ...
  br i1 %.not108, label %start_decoding.exit.backedge, label %.lr.ph.i.4
