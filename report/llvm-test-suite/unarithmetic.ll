...
start_decoding.exit.backedge:                     ; preds = %.lr.ph.i.4, %middle.block98, %bb.s
  br label %start_decoding.exit

.lr.ph.i.a:                                       ; preds = %.lr.ph.preheader.i, %middle.block98
...
.lr.ph.i.4:                                       ; preds = %.lr.ph.i.a, %.lr.ph.i.4
  ...
  br i1 %i.fp, label %.lr.ph.i.4, label %start_decoding.exit.backedge, !llvm.loop !24
