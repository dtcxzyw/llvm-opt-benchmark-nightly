...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ds = sitofp <2 x i16> %i.dr to <2 x double>  ; 2 uses
  ...
  %i.eb = sitofp <2 x i16> %i.ea to <2 x double>  ; 2 uses
  ...
  %i.ek = sitofp <2 x i16> %i.ej to <2 x double>  ; 3 uses
  ...
  %i.et = sitofp <2 x i16> %i.es to <2 x double>  ; 3 uses
  ...
  %i.fc = sitofp <2 x i16> %i.fb to <2 x double>  ; 3 uses
  ...
  %i.fl = sitofp <2 x i16> %i.fk to <2 x double>  ; 3 uses
  ...
  %i.fu = sitofp <2 x i16> %i.ft to <2 x double>  ; 3 uses
  ...
  %i.gd = sitofp <2 x i16> %i.gc to <2 x double>  ; 3 uses
  ...
  %1 = shufflevector <2 x double> %i.gd, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %2 = shufflevector <2 x double> %i.fu, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %3 = shufflevector <2 x double> %i.fl, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %4 = shufflevector <2 x double> %i.fc, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %5 = shufflevector <2 x double> %i.et, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %6 = shufflevector <2 x double> %i.ek, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %7 = shufflevector <2 x double> %i.eb, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %8 = shufflevector <2 x double> %i.ds, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  ...
  %9 = shufflevector <2 x double> %i.go, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %10 = shufflevector <2 x double> %i.gj, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %i.ih = shufflevector <2 x double> %i.hs, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %i.ii = shufflevector <2 x double> %i.hn, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %i.ij = shufflevector <2 x double> %i.hi, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %i.ik = shufflevector <2 x double> %i.hd, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %i.il = shufflevector <2 x double> %i.gy, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %i.im = shufflevector <2 x double> %i.gt, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %i.in = shufflevector <2 x double> %i.go, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %i.io = shufflevector <2 x double> %i.gj, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %11 = shufflevector <4 x double> %1, <4 x double> %i.ht, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %12 = shufflevector <4 x double> %2, <4 x double> %i.hu, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %13 = shufflevector <4 x double> %3, <4 x double> %i.hv, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %14 = shufflevector <4 x double> %4, <4 x double> %i.hw, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %15 = shufflevector <4 x double> %5, <4 x double> %i.hx, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %16 = shufflevector <4 x double> %6, <4 x double> %i.hy, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %17 = shufflevector <4 x double> %7, <4 x double> %i.hz, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %18 = shufflevector <4 x double> %8, <4 x double> %i.ia, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.ip = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %i.da, <8 x double> %18, <8 x double> zeroinitializer)
  %i.iq = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %i.cz, <8 x double> %17, <8 x double> %i.ip)
  %i.ir = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %i.cy, <8 x double> %16, <8 x double> %i.iq)
  %i.is = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %i.cx, <8 x double> %15, <8 x double> %i.ir)
  %i.it = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %i.cw, <8 x double> %14, <8 x double> %i.is)
  %i.iu = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %i.cv, <8 x double> %13, <8 x double> %i.it)
  %i.iv = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %i.cu, <8 x double> %12, <8 x double> %i.iu)
  %i.iw = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %i.ct, <8 x double> %11, <8 x double> %i.iv)
  %i.ix = shufflevector <4 x double> %i.ib, <4 x double> %i.ih, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.iy = shufflevector <4 x double> %i.ic, <4 x double> %i.ii, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.iz = shufflevector <4 x double> %i.id, <4 x double> %i.ij, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.ja = shufflevector <4 x double> %i.ie, <4 x double> %i.ik, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.jb = shufflevector <4 x double> %i.if, <4 x double> %i.il, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.jc = shufflevector <4 x double> %i.ig, <4 x double> %i.im, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %19 = shufflevector <4 x double> %9, <4 x double> %i.in, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %20 = shufflevector <4 x double> %10, <4 x double> %i.io, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.jd = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %i.di, <8 x double> %20, <8 x double> zeroinitializer)
  %i.je = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %i.dh, <8 x double> %19, <8 x double> %i.jd)
