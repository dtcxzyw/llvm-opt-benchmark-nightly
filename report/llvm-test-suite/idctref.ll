...
vector.ph:
  ...
  %1 = shufflevector <2 x double> %i.bm, <2 x double> %i.be, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.bn = shufflevector <2 x double> %i.bl, <2 x double> %i.bd, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.bo = shufflevector <2 x double> %i.bk, <2 x double> %i.bc, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.bp = shufflevector <2 x double> %i.bj, <2 x double> %i.bb, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.bq = shufflevector <2 x double> %i.bi, <2 x double> %i.ba, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.br = shufflevector <2 x double> %i.bh, <2 x double> %i.az, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.bs = shufflevector <2 x double> %i.bg, <2 x double> %i.ay, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.bt = shufflevector <2 x double> %i.bf, <2 x double> %i.ax, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.bu = shufflevector <2 x double> %i.aw, <2 x double> %i.ao, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %2 = shufflevector <4 x double> %1, <4 x double> %i.bu, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.bv = shufflevector <2 x double> %i.av, <2 x double> %i.an, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %3 = shufflevector <4 x double> %i.bn, <4 x double> %i.bv, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.bw = shufflevector <2 x double> %i.au, <2 x double> %i.am, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %4 = shufflevector <4 x double> %i.bo, <4 x double> %i.bw, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.bx = shufflevector <2 x double> %i.at, <2 x double> %i.al, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %5 = shufflevector <4 x double> %i.bp, <4 x double> %i.bx, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.by = shufflevector <2 x double> %i.as, <2 x double> %i.ak, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %6 = shufflevector <4 x double> %i.bq, <4 x double> %i.by, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.bz = shufflevector <2 x double> %i.ar, <2 x double> %i.aj, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %7 = shufflevector <4 x double> %i.br, <4 x double> %i.bz, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.ca = shufflevector <2 x double> %i.aq, <2 x double> %i.ai, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %8 = shufflevector <4 x double> %i.bs, <4 x double> %i.ca, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.cb = shufflevector <2 x double> %i.ap, <2 x double> %i.ah, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %9 = shufflevector <4 x double> %i.bt, <4 x double> %i.cb, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.cc = shufflevector <2 x double> %i.ag, <2 x double> %i.y, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.cd = shufflevector <2 x double> %i.af, <2 x double> %i.x, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.ce = shufflevector <2 x double> %i.ae, <2 x double> %i.w, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.cf = shufflevector <2 x double> %i.ad, <2 x double> %i.v, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.cg = shufflevector <2 x double> %i.ac, <2 x double> %i.u, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.ch = shufflevector <2 x double> %i.ab, <2 x double> %i.t, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.ci = shufflevector <2 x double> %i.aa, <2 x double> %i.s, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.cj = shufflevector <2 x double> %i.z, <2 x double> %i.r, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.ck = shufflevector <2 x double> %i.q, <2 x double> %i.i, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.cl = shufflevector <4 x double> %i.cc, <4 x double> %i.ck, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %10 = shufflevector <2 x double> %i.p, <2 x double> %i.h, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.cm = shufflevector <4 x double> %i.cd, <4 x double> %10, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %11 = shufflevector <2 x double> %i.o, <2 x double> %i.g, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.cn = shufflevector <4 x double> %i.ce, <4 x double> %11, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %12 = shufflevector <2 x double> %i.n, <2 x double> %i.f, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.co = shufflevector <4 x double> %i.cf, <4 x double> %12, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %13 = shufflevector <2 x double> %i.m, <2 x double> %i.e, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.cp = shufflevector <4 x double> %i.cg, <4 x double> %13, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %14 = shufflevector <2 x double> %i.l, <2 x double> %i.d, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.cq = shufflevector <4 x double> %i.ch, <4 x double> %14, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %15 = shufflevector <2 x double> %i.k, <2 x double> %i.c, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.cr = shufflevector <4 x double> %i.ci, <4 x double> %15, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %broadcast.splatinsert192 = insertelement <2 x double> poison, double %i.b, i64 0
  %16 = shufflevector <2 x double> %i.j, <2 x double> %broadcast.splatinsert192, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.cs = shufflevector <4 x double> %i.cj, <4 x double> %16, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.dc = sitofp <2 x i16> %i.db to <2 x double>
  %17 = shufflevector <2 x double> %i.dc, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %18 = shufflevector <4 x double> %17, <4 x double> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  ...
  %19 = shufflevector <2 x double> %i.dl, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %20 = shufflevector <4 x double> %19, <4 x double> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  ...
  %i.du = sitofp <2 x i16> %i.dt to <2 x double>  ; 2 uses
  %21 = shufflevector <2 x double> %i.du, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %22 = shufflevector <4 x double> %21, <4 x double> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  ...
  %i.ed = sitofp <2 x i16> %i.ec to <2 x double>  ; 2 uses
  %23 = shufflevector <2 x double> %i.ed, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %24 = shufflevector <4 x double> %23, <4 x double> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  ...
  %i.em = sitofp <2 x i16> %i.el to <2 x double>  ; 2 uses
  %25 = shufflevector <2 x double> %i.em, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %26 = shufflevector <4 x double> %25, <4 x double> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  ...
  %i.ev = sitofp <2 x i16> %i.eu to <2 x double>  ; 2 uses
  %27 = shufflevector <2 x double> %i.ev, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %28 = shufflevector <4 x double> %27, <4 x double> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  ...
  %i.fe = sitofp <2 x i16> %i.fd to <2 x double>  ; 2 uses
  %29 = shufflevector <2 x double> %i.fe, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %30 = shufflevector <4 x double> %29, <4 x double> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.ff = getelementptr inbounds nuw [2 x i8], ptr %0, i64 %i.ct
  %i.fg = getelementptr inbounds nuw i8, ptr %i.ff, i64 14 ; 2 uses
  %31 = getelementptr inbounds nuw [2 x i8], ptr %0, i64 %i.cu
  %32 = getelementptr inbounds nuw i8, ptr %31, i64 30 ; 2 uses
  %i.fh = load i16, ptr %i.fg, align 2, !tbaa !13
  %i.fi = load i16, ptr %32, align 2, !tbaa !13
  ...
  %33 = shufflevector <2 x double> %i.fl, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %34 = shufflevector <4 x double> %33, <4 x double> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %35 = getelementptr inbounds nuw [8 x i8], ptr %i.a, i64 %i.ct
  %36 = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %2, <8 x double> %18, <8 x double> zeroinitializer)
  %37 = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %3, <8 x double> %20, <8 x double> %36)
  %38 = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %4, <8 x double> %22, <8 x double> %37)
  %39 = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %5, <8 x double> %24, <8 x double> %38)
  %40 = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %6, <8 x double> %26, <8 x double> %39)
  %41 = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %7, <8 x double> %28, <8 x double> %40)
  %42 = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %8, <8 x double> %30, <8 x double> %41)
  %i.fm = load i16, ptr %i.cv, align 2, !tbaa !13
  %i.fn = load i16, ptr %i.cx, align 2, !tbaa !13
  %i.fo = insertelement <2 x i16> poison, i16 %i.fm, i64 0
  %i.fp = insertelement <2 x i16> %i.fo, i16 %i.fn, i64 1
  %i.fq = sitofp <2 x i16> %i.fp to <2 x double>
  %43 = shufflevector <2 x double> %i.fq, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %44 = shufflevector <4 x double> %43, <4 x double> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.fr = load i16, ptr %i.de, align 2, !tbaa !13
  %i.fs = load i16, ptr %i.dg, align 2, !tbaa !13
  %i.ft = insertelement <2 x i16> poison, i16 %i.fr, i64 0
  %i.fu = insertelement <2 x i16> %i.ft, i16 %i.fs, i64 1
  %i.fv = sitofp <2 x i16> %i.fu to <2 x double>
  %45 = shufflevector <2 x double> %i.fv, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %46 = shufflevector <4 x double> %45, <4 x double> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.fw = load i16, ptr %i.dn, align 2, !tbaa !13
  %i.fx = load i16, ptr %i.dp, align 2, !tbaa !13
  ...
  %47 = shufflevector <2 x double> %i.du, <2 x double> %i.ga, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.gb = shufflevector <2 x double> %i.ga, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %48 = shufflevector <4 x double> %47, <4 x double> %i.gb, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %49 = load i16, ptr %i.dw, align 2, !tbaa !13
  %50 = load i16, ptr %i.dy, align 2, !tbaa !13
  %51 = insertelement <2 x i16> poison, i16 %49, i64 0
  %52 = insertelement <2 x i16> %51, i16 %50, i64 1
  %53 = sitofp <2 x i16> %52 to <2 x double>      ; 2 uses
  %54 = shufflevector <2 x double> %i.ed, <2 x double> %53, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.gc = shufflevector <2 x double> %53, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %55 = shufflevector <4 x double> %54, <4 x double> %i.gc, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %56 = load i16, ptr %i.ef, align 2, !tbaa !13
  %57 = load i16, ptr %i.eh, align 2, !tbaa !13
  %58 = insertelement <2 x i16> poison, i16 %56, i64 0
  %59 = insertelement <2 x i16> %58, i16 %57, i64 1
  %60 = sitofp <2 x i16> %59 to <2 x double>      ; 2 uses
  %i.gd = shufflevector <2 x double> %i.em, <2 x double> %60, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.ge = shufflevector <2 x double> %60, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %61 = shufflevector <4 x double> %i.gd, <4 x double> %i.ge, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %62 = load i16, ptr %i.eo, align 2, !tbaa !13
  %63 = load i16, ptr %i.eq, align 2, !tbaa !13
  %64 = insertelement <2 x i16> poison, i16 %62, i64 0
  %65 = insertelement <2 x i16> %64, i16 %63, i64 1
  %66 = sitofp <2 x i16> %65 to <2 x double>      ; 2 uses
  %67 = shufflevector <2 x double> %i.ev, <2 x double> %66, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.gf = shufflevector <2 x double> %66, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %i.gg = shufflevector <4 x double> %67, <4 x double> %i.gf, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %68 = load i16, ptr %i.ex, align 2, !tbaa !13
  %69 = load i16, ptr %i.ez, align 2, !tbaa !13
  %70 = insertelement <2 x i16> poison, i16 %68, i64 0
  %71 = insertelement <2 x i16> %70, i16 %69, i64 1
  %72 = sitofp <2 x i16> %71 to <2 x double>      ; 2 uses
  %73 = shufflevector <2 x double> %i.fe, <2 x double> %72, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %74 = shufflevector <2 x double> %72, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %75 = shufflevector <4 x double> %73, <4 x double> %74, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %76 = load i16, ptr %i.fg, align 2, !tbaa !13
  %77 = load i16, ptr %32, align 2, !tbaa !13
  %78 = insertelement <2 x i16> poison, i16 %76, i64 0
  %79 = insertelement <2 x i16> %78, i16 %77, i64 1
  %80 = sitofp <2 x i16> %79 to <2 x double>      ; 2 uses
  %81 = shufflevector <2 x double> %80, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %82 = shufflevector <2 x double> %i.fl, <2 x double> %80, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.gh = shufflevector <4 x double> %82, <4 x double> %81, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %83 = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %i.cl, <8 x double> %44, <8 x double> zeroinitializer)
  %i.gi = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %i.cm, <8 x double> %46, <8 x double> %83)
  %i.gj = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %i.cn, <8 x double> %48, <8 x double> %i.gi)
  %i.gk = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %i.co, <8 x double> %55, <8 x double> %i.gj)
  %i.gl = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %i.cp, <8 x double> %61, <8 x double> %i.gk)
  %i.gm = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %i.cq, <8 x double> %i.gg, <8 x double> %i.gl)
  %i.gn = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %i.cr, <8 x double> %75, <8 x double> %i.gm)
  %i.go = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %9, <8 x double> %34, <8 x double> %42)
  %i.gp = tail call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %i.cs, <8 x double> %i.gh, <8 x double> %i.gn)
  %interleaved.vec = shufflevector <8 x double> %i.go, <8 x double> %i.gp, <16 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14, i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15>
  store <16 x double> %interleaved.vec, ptr %35, align 16, !tbaa !9
