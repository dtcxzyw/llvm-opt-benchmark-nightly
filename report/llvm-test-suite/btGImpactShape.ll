...
bb.b:                                             ; preds = %bb.a
  ...
  %i.l = getelementptr inbounds [64 x i8], ptr %i.k, i64 %i.g ; 10 uses
  ...
  %i.ab = getelementptr inbounds nuw i8, ptr %i.l, i64 48 ; 2 uses
  ...
  %i.bb = load float, ptr %i.u, align 4, !tbaa !24, !noalias !100
  %6 = load <3 x float>, ptr %i.ab, align 4, !tbaa !24, !noalias !99 ; 5 uses
  %i.bc = load float, ptr %i.ab, align 4, !tbaa !24, !noalias !99
  ...
  %i.bj = fmul <2 x float> %i.bi, %7
  %i.bk = shufflevector <2 x float> %i.af, <2 x float> %i.av, <2 x i32> <i32 0, i32 2>
  %i.bl = shufflevector <3 x float> %6, <3 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.bo = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bn, <2 x float> %8, <2 x float> %i.bm)
  ...
  %i.cp = fmul float %i.co, %9
  %i.cq = extractelement <2 x float> %i.cn, i64 0
  %i.cr = tail call float @llvm.fmuladd.f32(float %i.cq, float %i.bc, float %i.cp)
  %10 = extractelement <3 x float> %6, i64 2
  %i.cs = tail call noundef float @llvm.fmuladd.f32(float %i.aa, float %10, float %i.cr)
  ...
  %i.dd = insertelement <4 x float> %i.ci, float %i.bb, i64 2
