...
begin_hunk_0_@_ZNK22btGImpactMeshShapePart15lockChildShapesEv:bb.a
  ...
  tail call void %i.u(ptr noundef nonnull align 8 dereferenceable(24) %i.h, ptr noundef nonnull %i.i, ptr noundef nonnull align 4 dereferenceable(4) %i.j, ptr noundef nonnull align 4 dereferenceable(4) %i.k, ptr noundef nonnull align 4 dereferenceable(4) %i.l, ptr noundef nonnull %i.m, ptr noundef nonnull align 4 dereferenceable(4) %i.n, ptr noundef nonnull align 4 dereferenceable(4) %i.o, ptr noundef nonnull align 4 dereferenceable(4) %i.p, i32 noundef %i.r), !inline_history !100
...
begin_hunk_1_@_ZNK22btGImpactMeshShapePart17unlockChildShapesEv:bb.a
  ...
  tail call void %i.n(ptr noundef nonnull align 8 dereferenceable(24) %i.i, i32 noundef %i.k), !inline_history !101
...
bb.h:                                             ; preds = %._crit_edge, %bb.g
  ...
  store i32 0, ptr %i.s, align 8, !tbaa !103
...
begin_hunk_3_@_ZN18btGImpactMeshShape13calcLocalAABBEv:bb.a
  ...
  %i.u = load i8, ptr %i.t, align 4, !tbaa !79, !range !76, !noundef !104
...
begin_hunk_4_@_ZN18btGImpactMeshShape13calcLocalAABBEv:bb.a
  ...
  tail call void %i.y(ptr noundef nonnull align 8 dereferenceable(176) %i.s), !inline_history !105
...
begin_hunk_6_@_ZNK22btGImpactMeshShapePart23TrimeshPrimitiveManager19get_bullet_triangleEiR17btTriangleShapeEx:bb.a
  ...
  %i.eu = load float, ptr %i.et, align 8, !tbaa !109
