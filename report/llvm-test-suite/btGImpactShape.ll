...
bb.a:
  ...
  %.sroa.14.24.vec.extract.a = extractelement <2 x float> %foldExtExtBinop11, i64 1
  %.sroa.14.24.vec.extract = load float, ptr %.sroa.14.16..sroa_idx8, align 4, !tbaa !30 ; 2 uses
  %.sroa.7.8.vec.extract = load float, ptr %.sroa.7.0..sroa_idx5, align 4, !tbaa !30
  %i.d = fadd float %.sroa.7.8.vec.extract, %.sroa.14.24.vec.extract
  %i.e = fmul float %i.c, 5.000000e-01            ; 3 uses
  %i.f = fmul float %.sroa.14.24.vec.extract.a, 5.000000e-01 ; 3 uses
  ...
  %i.j = fsub float %.sroa.14.24.vec.extract, %i.g ; 2 uses
