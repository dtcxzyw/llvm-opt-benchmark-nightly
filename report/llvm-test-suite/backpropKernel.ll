...
.lr.ph168:                                        ; preds = %bb.a
  ...
  %wide.trip.count209 = zext i32 %i.f to i64
  %xtraiter = and i64 %wide.trip.count, 1
  %i.g = icmp eq i32 %0, 0
  %unroll_iter = and i64 %wide.trip.count, 4294967294
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  %lcmp.mod229 = trunc i32 %i.f to i1
  %xtraiter231 = and i64 %i.b, 1
  %i.h = icmp eq i32 %1, 0
  %unroll_iter235 = and i64 %i.b, 4294967294
  %lcmp.mod232.not = icmp eq i64 %xtraiter231, 0
  %lcmp.mod234 = trunc i32 %i.a to i1
  br label %bb.b

._crit_edge169:                                   ; preds = %._crit_edge165, %bb.a
  %.0.lcssa = phi float [ 0.000000e+00, %bb.a ], [ %.1.lcssa219, %._crit_edge165 ]
  ret float %.0.lcssa

bb.b:                                             ; preds = %.lr.ph168, %._crit_edge165
  %.099166 = phi i32 [ 0, %.lr.ph168 ], [ %i.dc, %._crit_edge165 ]
...
.preheader120:                                    ; preds = %bb.b, %._crit_edge
  %indvars.iv176 = phi i64 [ %indvars.iv.next177, %._crit_edge ], [ 1, %bb.b ] ; 3 uses
  br i1 %.not117122, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader120
  %invariant.gep = getelementptr inbounds nuw [4 x i8], ptr %9, i64 %indvars.iv176 ; 3 uses
...
._crit_edge:                                      ; preds = %.epil.preheader, %._crit_edge.loopexit.unr-lcssa, %.preheader120
  ...
  %i.ai = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %indvars.iv176
  store float %i.ah, ptr %i.ai, align 4, !tbaa !8
  %indvars.iv.next177 = add nuw nsw i64 %indvars.iv176, 1 ; 2 uses
  %exitcond180.not = icmp eq i64 %indvars.iv.next177, %i.b
  br i1 %exitcond180.not, label %._crit_edge127, label %.preheader120, !llvm.loop !12
...
.preheader119:                                    ; preds = %._crit_edge127, %._crit_edge132
  %indvars.iv186 = phi i64 [ %indvars.iv.next187, %._crit_edge132 ], [ 1, %._crit_edge127 ] ; 3 uses
  br i1 %.not116128, label %._crit_edge132, label %.lr.ph131

.lr.ph131:                                        ; preds = %.preheader119
  %invariant.gep134 = getelementptr inbounds nuw [4 x i8], ptr %10, i64 %indvars.iv186 ; 3 uses
  br i1 %i.h, label %.epil.preheader230, label %.lr.ph131.new

.lr.ph131.new:                                    ; preds = %.lr.ph131, %.lr.ph131.new
  %indvars.iv181 = phi i64 [ %indvars.iv.next182.1, %.lr.ph131.new ], [ 0, %.lr.ph131 ] ; 4 uses
  %.1107129 = phi double [ %i.aw, %.lr.ph131.new ], [ 0.000000e+00, %.lr.ph131 ]
  %niter236 = phi i64 [ %niter236.next.1, %.lr.ph131.new ], [ 0, %.lr.ph131 ]
  %i.aj = mul nuw nsw i64 %indvars.iv181, %i.d
  %gep135 = getelementptr inbounds nuw [4 x i8], ptr %invariant.gep134, i64 %i.aj
  %i.ak = load float, ptr %gep135, align 4, !tbaa !8
  %i.al = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %indvars.iv181
  ...
  %indvars.iv.next182.1 = add nuw nsw i64 %indvars.iv181, 2 ; 2 uses
  %niter236.next.1 = add i64 %niter236, 2         ; 2 uses
  %niter236.ncmp.1 = icmp eq i64 %niter236.next.1, %unroll_iter235
  br i1 %niter236.ncmp.1, label %._crit_edge132.loopexit.unr-lcssa, label %.lr.ph131.new, !llvm.loop !13

._crit_edge132.loopexit.unr-lcssa:                ; preds = %.lr.ph131.new
  br i1 %lcmp.mod232.not, label %._crit_edge132, label %.epil.preheader230

.epil.preheader230:                               ; preds = %._crit_edge132.loopexit.unr-lcssa, %.lr.ph131
  %indvars.iv181.epil.init = phi i64 [ 0, %.lr.ph131 ], [ %indvars.iv.next182.1, %._crit_edge132.loopexit.unr-lcssa ] ; 2 uses
  ...
  %i.ax = mul nuw nsw i64 %indvars.iv181.epil.init, %i.d
  ...
  %i.az = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %indvars.iv181.epil.init
...
._crit_edge132:                                   ; preds = %.epil.preheader230, %._crit_edge132.loopexit.unr-lcssa, %.preheader119
  %.1107.lcssa = phi double [ 0.000000e+00, %.preheader119 ], [ %i.aw, %._crit_edge132.loopexit.unr-lcssa ], [ %i.bd, %.epil.preheader230 ]
  ...
  %i.bj = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %indvars.iv186
  store float %i.bi, ptr %i.bj, align 4, !tbaa !8
  %indvars.iv.next187 = add nuw nsw i64 %indvars.iv186, 1 ; 2 uses
  %exitcond190.not = icmp eq i64 %indvars.iv.next187, %i.d
  br i1 %exitcond190.not, label %.lr.ph141, label %.preheader119, !llvm.loop !14

.lr.ph141:                                        ; preds = %._crit_edge132, %.lr.ph141
  %indvars.iv191 = phi i64 [ %indvars.iv.next192, %.lr.ph141 ], [ 1, %._crit_edge132 ] ; 4 uses
  %.1140 = phi float [ %i.bx, %.lr.ph141 ], [ 0.000000e+00, %._crit_edge132 ]
  %i.bk = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %indvars.iv191
  %i.bl = load float, ptr %i.bk, align 4, !tbaa !8 ; 2 uses
  %i.bm = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %indvars.iv191
  ...
  %i.bv = getelementptr inbounds nuw [4 x i8], ptr %7, i64 %indvars.iv191
  ...
  %exitcond195.not = icmp eq i64 %indvars.iv.next192, %i.d
  br i1 %exitcond195.not, label %.preheader118.lr.ph, label %.lr.ph141, !llvm.loop !15

._crit_edge142.thread:                            ; preds = %._crit_edge127
  store float 1.000000e+00, ptr %4, align 4, !tbaa !8
  br label %._crit_edge154

.preheader118.lr.ph:                              ; preds = %.lr.ph141
  store float 1.000000e+00, ptr %4, align 4, !tbaa !8
  br i1 %brmerge, label %._crit_edge154, label %.preheader118

.preheader118:                                    ; preds = %.preheader118.lr.ph, %._crit_edge147
  %indvars.iv201 = phi i64 [ %indvars.iv.next202, %._crit_edge147 ], [ 1, %.preheader118.lr.ph ] ; 4 uses
  %i.by = getelementptr inbounds nuw [4 x i8], ptr %7, i64 %indvars.iv201
  %i.bz = load float, ptr %i.by, align 4, !tbaa !8
  %i.ca = fpext float %i.bz to double
  %i.cb = fmul double %i.ca, 3.000000e-01
  %invariant.gep148 = getelementptr inbounds nuw [4 x i8], ptr %12, i64 %indvars.iv201
  %invariant.gep150 = getelementptr inbounds nuw [4 x i8], ptr %10, i64 %indvars.iv201
  br label %bb.c

bb.c:                                             ; preds = %.preheader118, %bb.c
  %indvars.iv196 = phi i64 [ 0, %.preheader118 ], [ %indvars.iv.next197, %bb.c ] ; 3 uses
  %i.cc = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %indvars.iv196
  %i.cd = load float, ptr %i.cc, align 4, !tbaa !8
  %i.ce = fpext float %i.cd to double
  %i.cf = mul nuw nsw i64 %indvars.iv196, %i.d    ; 2 uses
  ...
  %exitcond200.not = icmp eq i64 %indvars.iv.next197, %i.b
  br i1 %exitcond200.not, label %._crit_edge147, label %bb.c, !llvm.loop !16

._crit_edge147:                                   ; preds = %bb.c
  %indvars.iv.next202 = add nuw nsw i64 %indvars.iv201, 1 ; 2 uses
  %exitcond205.not = icmp eq i64 %indvars.iv.next202, %i.d
  br i1 %exitcond205.not, label %._crit_edge154, label %.preheader118, !llvm.loop !17

._crit_edge154:                                   ; preds = %._crit_edge147, %._crit_edge142.thread, %.preheader118.lr.ph
  %.1.lcssa219 = phi float [ 0.000000e+00, %._crit_edge142.thread ], [ %i.bx, %.preheader118.lr.ph ], [ %i.bx, %._crit_edge147 ]
  store float 1.000000e+00, ptr %3, align 4, !tbaa !8
  br i1 %brmerge171, label %._crit_edge165, label %.preheader

.preheader:                                       ; preds = %._crit_edge154, %._crit_edge158
  %indvars.iv211 = phi i64 [ %indvars.iv.next212, %._crit_edge158 ], [ 1, %._crit_edge154 ] ; 4 uses
  %i.cn = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %indvars.iv211
  %i.co = load float, ptr %i.cn, align 4, !tbaa !8
  %i.cp = fpext float %i.co to double
  %i.cq = fmul double %i.cp, 3.000000e-01
  %invariant.gep159 = getelementptr inbounds nuw [4 x i8], ptr %11, i64 %indvars.iv211
  %invariant.gep161 = getelementptr inbounds nuw [4 x i8], ptr %9, i64 %indvars.iv211
  br label %bb.d

bb.d:                                             ; preds = %.preheader, %bb.d
  %indvars.iv206 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next207, %bb.d ] ; 3 uses
  %i.cr = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %indvars.iv206
  %i.cs = load float, ptr %i.cr, align 4, !tbaa !8
  %i.ct = fpext float %i.cs to double
  %i.cu = mul nuw nsw i64 %indvars.iv206, %i.b    ; 2 uses
  ...
  br i1 %exitcond210.not, label %._crit_edge158, label %bb.d, !llvm.loop !18

._crit_edge158:                                   ; preds = %bb.d
  %indvars.iv.next212 = add nuw nsw i64 %indvars.iv211, 1 ; 2 uses
  %exitcond215.not.a = icmp eq i64 %indvars.iv.next212, %i.b
  br i1 %exitcond215.not.a, label %._crit_edge165, label %.preheader, !llvm.loop !19

._crit_edge165:                                   ; preds = %._crit_edge158, %._crit_edge154
  %i.dc = add nuw nsw i32 %.099166, 1             ; 2 uses
  %exitcond216.not = icmp eq i32 %i.dc, %13
  br i1 %exitcond216.not, label %._crit_edge169, label %bb.b, !llvm.loop !20
}
