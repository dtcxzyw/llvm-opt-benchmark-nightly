begin_hunk_0_@term_PrintPrefix:bb.a
  ...
  tail call void @term_PrintPrefix(ptr noundef %.0.val.i)
...
begin_hunk_1_@term_PrintPrefix:bb.a
  ...
  br i1 %.not, label %term_TermListPrintPrefix.exit, label %.lr.ph, !llvm.loop !56
...
bb.b:                                             ; preds = %.lr.ph
  %i.c = tail call i32 @putc(i32 noundef 40, ptr noundef %0) ; 0 uses
  %.val.i = load ptr, ptr %i.b, align 8
  tail call void @term_TermListFPrintPrefix(ptr noundef %0, ptr noundef %.val.i)
  %i.d = tail call i32 @putc(i32 noundef 41, ptr noundef %0) ; 0 uses
...
bb.b:                                             ; preds = %.lr.ph
  %i.c = tail call i32 @putc(i32 noundef 40, ptr noundef %0) ; 0 uses
  %.val.i = load ptr, ptr %i.b, align 8
  tail call void @term_TermListFPrintOtterPrefix(ptr noundef %0, ptr noundef %.val.i)
  %i.d = tail call i32 @putc(i32 noundef 41, ptr noundef %0) ; 0 uses
...
bb.h:                                             ; preds = %.lr.ph
  ...
  br i1 %.not27, label %._crit_edge, label %.lr.ph, !llvm.loop !63
...
begin_hunk_12_@term_NumberOfSymbolOccurrences:bb.a
  ...
  br i1 %.not13, label %._crit_edge, label %.lr.ph, !llvm.loop !67
...
bb.g:                                             ; preds = %.lr.ph
  ...
  br i1 %.not27, label %.critedge.thread23, label %.lr.ph, !llvm.loop !68
...
bb.g:                                             ; preds = %.lr.ph
  ...
  br i1 %.not20, label %.critedge.thread17, label %.lr.ph, !llvm.loop !70
...
bb.h:                                             ; preds = %.lr.ph
  ...
  br i1 %.not36, label %._crit_edge, label %.lr.ph, !llvm.loop !72

.critedge:                                        ; preds = %.lr.ph
  %.not34 = icmp eq i32 %stack_POINTER.promoted41, %i.a
  br i1 %.not34, label %._crit_edge, label %.lr.ph50, !llvm.loop !73
...
begin_hunk_17_@term_MakePseudoLinear:bb.a
  ...
  br i1 %.not, label %.loopexit, label %bb.b, !llvm.loop !76
...
begin_hunk_18_@term_ListOfAtoms:bb.a
  ...
  br i1 %.not15, label %.loopexit, label %.lr.ph, !llvm.loop !77
...
bb.h:                                             ; preds = %bb.g
  ...
  br i1 %.not36, label %term_IsTerm.exit.thread, label %.preheader60, !llvm.loop !80
...
bb.j:                                             ; preds = %bb.i
  ...
  br i1 %.not33, label %term_IsTerm.exit.thread, label %.preheader, !llvm.loop !81
