...
begin_hunk_0_@_ZN11ALACEncoder12EncodeStereoEP9BitBufferPvjjj:bb.a
  ...
  %.not282 = icmp eq i32 %5, %i.s                 ; 3 uses
...
bb.q:                                             ; preds = %bb.r
  %i.cb = select i1 %.not282, i32 0, i32 32       ; 2 uses
...
begin_hunk_3_@_ZN11ALACEncoder16EncodeStereoFastEP9BitBufferPvjjj:bb.a
  ...
  %.not138 = icmp eq i32 %5, %i.q                 ; 3 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.dp = select i1 %.not138, i32 0, i32 32       ; 2 uses
...
begin_hunk_6_@_ZN11ALACEncoder10EncodeMonoEP9BitBufferPvjjj:bb.a
  ...
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 8284
  %i.q = load i32, ptr %i.p, align 4, !tbaa !27
  %.not199 = icmp eq i32 %5, %i.q                 ; 5 uses
...
begin_hunk_7_@_ZN11ALACEncoder10EncodeMonoEP9BitBufferPvjjj:bb.a
  ...
  %i.gl = icmp ult i32 %i.gk, %spec.select202
  %spec.select.1 = select i1 %i.gl, i32 8, i32 4  ; 4 uses
  %spec.select202.1 = call i32 @llvm.umin.i32(i32 %i.gk, i32 %spec.select202)
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #14
  %i.gm = select i1 %.not199, i32 0, i32 32       ; 2 uses
  %i.gn = mul i32 %i.l, %5
  %9 = add i32 %i.gn, 32
  %i.go = select i1 %i.k, i32 %9, i32 32
  %i.gp = add i32 %i.go, %i.gm
  %.3 = add i32 %i.gp, %spec.select202.1
  %i.gq = load i16, ptr %i.c, align 8, !tbaa !10
  %i.gr = sext i16 %i.gq to i32
  %i.gs = mul i32 %5, %i.gr
  %10 = or disjoint i32 %i.gm, 16
  %i.gt = add i32 %10, %i.gs                      ; 3 uses
...
.lr.ph238:                                        ; preds = %bb.h, %bb.i
  ...
  %11 = or disjoint i32 %spec.select.1, 128
  call void @BitBufferWrite(ptr noundef nonnull %1, i32 noundef %11, i32 noundef 8)
