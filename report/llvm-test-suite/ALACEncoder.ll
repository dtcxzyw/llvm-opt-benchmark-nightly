...
define dso_local noundef range(i32 24, 49) i32 @_ZN11ALACEncoder18GetMagicCookieSizeEj(ptr noundef nonnull readnone align 8 captures(none) dereferenceable(8300) %0, i32 noundef %1) local_unnamed_addr #9 align 2 {
bb.a:
...
define dso_local void @_ZN11ALACEncoder14GetMagicCookieEPvPj(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(8300) %0, ptr noundef writeonly captures(none) %1, ptr noundef captures(none) %2) local_unnamed_addr #5 align 2 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define dso_local noundef range(i32 -108, 1) i32 @_ZN11ALACEncoder17InitializeEncoderE22AudioFormatDescription(ptr noundef nonnull align 8 dereferenceable(8300) initializes((12, 28), (32, 80), (8288, 8300)) %0, ptr noundef readonly byval(%struct.AudioFormatDescription) align 8 captures(none) %1) unnamed_addr #5 align 2 {
bb.a:
...
.preheader.lr.ph:                                 ; preds = %.preheader24
  ...
  %i.ay = getelementptr inbounds nuw i8, ptr %0, i64 4176
  br label %.preheader

.preheader:                                       ; preds = %.preheader.lr.ph, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader.lr.ph ], [ %indvars.iv.next, %.preheader ] ; 3 uses
  %i.az = getelementptr inbounds nuw [512 x i8], ptr %i.ax, i64 %indvars.iv ; 16 uses
  %i.ba = getelementptr inbounds nuw [512 x i8], ptr %i.ay, i64 %indvars.iv ; 16 uses
  tail call void @init_coefs(ptr noundef nonnull %i.az, i32 noundef 9, i32 noundef 16)
  tail call void @init_coefs(ptr noundef nonnull %i.ba, i32 noundef 9, i32 noundef 16)
  %i.bb = getelementptr inbounds nuw i8, ptr %i.az, i64 32
  tail call void @init_coefs(ptr noundef nonnull %i.bb, i32 noundef 9, i32 noundef 16)
  %i.bc = getelementptr inbounds nuw i8, ptr %i.ba, i64 32
  tail call void @init_coefs(ptr noundef nonnull %i.bc, i32 noundef 9, i32 noundef 16)
  %i.bd = getelementptr inbounds nuw i8, ptr %i.az, i64 64
  tail call void @init_coefs(ptr noundef nonnull %i.bd, i32 noundef 9, i32 noundef 16)
  %i.be = getelementptr inbounds nuw i8, ptr %i.ba, i64 64
  tail call void @init_coefs(ptr noundef nonnull %i.be, i32 noundef 9, i32 noundef 16)
  %i.bf = getelementptr inbounds nuw i8, ptr %i.az, i64 96
  ...
  %i.bi = getelementptr inbounds nuw i8, ptr %i.ba, i64 128
  ...
  %i.bs = getelementptr inbounds nuw i8, ptr %i.ba, i64 288
  ...
  %i.cc = getelementptr inbounds nuw i8, ptr %i.ba, i64 448
  ...
  %i.ce = getelementptr inbounds nuw i8, ptr %i.ba, i64 480
  tail call void @init_coefs(ptr noundef nonnull %i.ce, i32 noundef 9, i32 noundef 16)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.cf = load i32, ptr %i.f, align 4, !tbaa !73
  %i.cg = sext i32 %i.cf to i64
  %i.ch = icmp slt i64 %indvars.iv.next, %i.cg
  br i1 %i.ch, label %.preheader, label %.loopexit, !llvm.loop !83
...
define dso_local void @_ZN11ALACEncoder15GetSourceFormatEPK22AudioFormatDescriptionPS0_(ptr noundef nonnull writeonly align 8 captures(none) dereferenceable(8300) initializes((8, 10)) %0, ptr noundef readonly captures(none) %1, ptr readnone captures(none) %2) unnamed_addr #12 align 2 {
bb.a:
