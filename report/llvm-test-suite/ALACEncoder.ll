...
begin_hunk_1_@_ZN11ALACEncoder6EncodeE22AudioFormatDescriptionS0_PhS1_Pi:bb.a
  ...
  %7 = shl nsw i32 %i.s, 1
  %8 = load i32, ptr %i.g, align 4, !tbaa !60     ; 5 uses
  %i.t = add i32 %8, -1
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.ag = call noundef i32 @_ZN11ALACEncoder10EncodeMonoEP9BitBufferPvjjj(ptr noundef nonnull align 8 dereferenceable(8300) %0, ptr noundef nonnull %6, ptr noundef %.060, i32 noundef %8, i32 noundef %.056, i32 noundef %i.d)
...
bb.k:                                             ; preds = %bb.i
  ...
  %i.ak = call noundef i32 @_ZN11ALACEncoder12EncodeStereoEP9BitBufferPvjjj(ptr noundef nonnull align 8 dereferenceable(8300) %0, ptr noundef nonnull %6, ptr noundef %.060, i32 noundef %8, i32 noundef %.056, i32 noundef %i.d)
  %i.al = add i32 %.056, 2
  %i.am = add i8 %.053, 1
  br label %bb.n
end_hunk_4
...
bb.l:                                             ; preds = %bb.i
  ...
  %i.ao = call noundef i32 @_ZN11ALACEncoder10EncodeMonoEP9BitBufferPvjjj(ptr noundef nonnull align 8 dereferenceable(8300) %0, ptr noundef nonnull %6, ptr noundef %.060, i32 noundef %8, i32 noundef %.056, i32 noundef %i.d)
