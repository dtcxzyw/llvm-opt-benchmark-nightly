...
begin_hunk_0_@eamForce:bb.a
  ...
  %i.hi = getelementptr inbounds nuw [8 x i8], ptr %i.hh, i64 %indvars.iv309 ; 2 uses
  ...
  %i.hp = getelementptr inbounds nuw [8 x i8], ptr %i.ho, i64 %indvars.iv309 ; 2 uses
...
._crit_edge.us.us:                                ; preds = %bb.g
  ...
  %exitcond312.not = icmp eq i32 %i.hw, %.fr295
...
._crit_edge:                                      ; preds = %..loopexit230_crit_edge.us, %bb.c
  ...
  %i.ib = icmp slt i64 %indvars.iv.next318, %i.ia
...
._crit_edge270:                                   ; preds = %._crit_edge265, %._crit_edge360, %.preheader
  ...
  br i1 %i.ii, label %.lr.ph293, label %._crit_edge294
...
.lr.ph264:                                        ; preds = %bb.h
  ...
  %i.ja = add i32 %i.il, %indvars.iv320
  br label %bb.i
...
._crit_edge265:                                   ; preds = %bb.i, %bb.h
  ...
  %exitcond330.not.a = icmp eq i64 %indvars.iv.next327, %wide.trip.count329
  br i1 %exitcond330.not.a, label %._crit_edge270, label %bb.h

bb.i:                                             ; preds = %.lr.ph264, %bb.i
  %indvars.iv322 = phi i64 [ %i.in, %.lr.ph264 ], [ %indvars.iv.next323, %bb.i ] ; 4 uses
  %.9262 = phi double [ %.8268, %.lr.ph264 ], [ %i.kj, %bb.i ]
  %i.jb = getelementptr inbounds nuw [8 x i8], ptr %i.ip, i64 %indvars.iv322
  ...
  %i.ki = getelementptr inbounds nuw [8 x i8], ptr %i.iw, i64 %indvars.iv322
  store double %i.kh, ptr %i.ki, align 8, !tbaa !18
  %i.kj = fadd double %.9262, %i.kd               ; 2 uses
  %i.kk = getelementptr inbounds nuw [8 x i8], ptr %i.iz, i64 %indvars.iv322 ; 2 uses
  ...
  %exitcond325.not = icmp eq i32 %i.ja, %lftr.wideiv
...
bb.j:                                             ; preds = %.lr.ph293, %._crit_edge288
  %indvars.iv354.a = phi i64 [ 0, %.lr.ph293 ], [ %indvars.iv.next355.a, %._crit_edge288 ] ; 5 uses
  %indvars.iv343 = phi i32 [ 0, %.lr.ph293 ], [ %indvars.iv.next344, %._crit_edge288 ] ; 2 uses
  %i.ko = phi ptr [ %i.if, %.lr.ph293 ], [ %i.pz, %._crit_edge288 ] ; 2 uses
  %i.kp = zext i32 %indvars.iv343 to i64
  %i.kq = getelementptr inbounds nuw i8, ptr %i.ko, i64 120
  %i.kr = load ptr, ptr %i.kq, align 8, !tbaa !64
  %i.ks = getelementptr inbounds nuw [4 x i8], ptr %i.kr, i64 %indvars.iv354.a
  %i.kt = load i32, ptr %i.ks, align 4, !tbaa !4
  %.fr = freeze i32 %i.kt                         ; 2 uses
  %i.ku = trunc nuw nsw i64 %indvars.iv354.a to i32
...
.lr.ph279.us:                                     ; preds = %.lr.ph279.us.preheader, %._crit_edge280.us
  ...
  %.0189282.us = phi i32 [ 0, %.lr.ph279.us.preheader ], [ %i.py, %._crit_edge280.us ] ; 2 uses
  br label %bb.k

bb.k:                                             ; preds = %.loopexit.us, %.lr.ph279.us
  %indvars.iv339 = phi i64 [ %indvars.iv.next340, %.loopexit.us ], [ %i.ll, %.lr.ph279.us ] ; 4 uses
  %.0187277.us = phi i32 [ %i.px, %.loopexit.us ], [ 0, %.lr.ph279.us ] ; 2 uses
  %.not.us = icmp samesign ugt i32 %.0187277.us, %.0189282.us
  %or.cond208.us = select i1 %i.lj, i1 true, i1 %.not.us
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.lp = getelementptr inbounds nuw [24 x i8], ptr %i.lo, i64 %indvars.iv345 ; 3 uses
  %i.lq = getelementptr inbounds [24 x i8], ptr %i.lo, i64 %indvars.iv339 ; 3 uses
  ...
  br i1 %i.mh, label %.loopexit.us.loopexit, label %.loopexit.us
...
.loopexit.us.loopexit:                            ; preds = %bb.l
  ...
  %.0.i215.us = select i1 %i.mo, double %i.mn, double %i.mi
  %i.mp = fsub double %.0.i215.us, %i.mn
  ...
  %.040.i216.us = call i32 @llvm.smin.i32(i32 %i.mv, i32 %i.mu)
  %.1.i217.us = select i1 %i.mw, double %i.my, double %i.ms ; 2 uses
  %i.mz = call double @llvm.floor.f64(double %.1.i217.us)
  %i.na = fsub double %.1.i217.us, %i.mz
  %i.nb = sext i32 %.040.i216.us to i64
  ...
  %i.nr = getelementptr inbounds nuw [8 x i8], ptr %i.nq, i64 %indvars.iv345 ; 6 uses
  %i.ns = getelementptr inbounds [8 x i8], ptr %i.nq, i64 %indvars.iv339 ; 6 uses
  %i.nt = getelementptr inbounds nuw i8, ptr %i.lm, i64 40
  %i.nu = load ptr, ptr %i.nt, align 8, !tbaa !60 ; 2 uses
  %i.nv = getelementptr inbounds nuw [24 x i8], ptr %i.nu, i64 %indvars.iv345 ; 4 uses
  %i.nw = getelementptr inbounds [24 x i8], ptr %i.nu, i64 %indvars.iv339 ; 4 uses
...
.loopexit.us:                                     ; preds = %bb.l, %.loopexit.us.loopexit, %bb.k
  %i.px = add nuw nsw i32 %.0187277.us, 1         ; 2 uses
...
._crit_edge288:                                   ; preds = %..loopexit229_crit_edge.split.us, %bb.j
  ...
  %i.qd = icmp slt i64 %indvars.iv.next355.a, %i.qc
  %indvars.iv.next344 = add i32 %indvars.iv343, 64
  br i1 %i.qd, label %bb.j, label %._crit_edge294
}
