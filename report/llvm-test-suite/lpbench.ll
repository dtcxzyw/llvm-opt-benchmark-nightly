...
.lr.ph.a:                                         ; preds = %.lr.ph.preheader, %.lr.ph.a
  ...
  %gep.a = getelementptr [8 x i8], ptr %invariant.gep, i64 %indvars.iv.a ; 2 uses
  %i.m = load double, ptr %gep.a, align 8, !tbaa !19
  %i.n = fmul double %1, %i.m
  store double %i.n, ptr %gep.a, align 8, !tbaa !19
  %indvars.iv.next.a = add nsw i64 %indvars.iv.a, %i.j ; 2 uses
  %5 = icmp slt i64 %indvars.iv.next.a, %i.l
  br i1 %5, label %.lr.ph.a, label %.loopexit, !llvm.loop !35
...
.lr.ph23:                                         ; preds = %.lr.ph23.preheader50, %.lr.ph23
  ...
  %exitcond.not.a = icmp eq i64 %indvars.iv.next27, %wide.trip.count
  br i1 %exitcond.not.a, label %.loopexit, label %.lr.ph23, !llvm.loop !36

.loopexit:                                        ; preds = %.lr.ph.a, %.lr.ph23, %middle.block47, %bb.c, %bb.a
  ret void
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.k, align 8, !tbaa !19, !alias.scope !47
  %wide.load71 = load <2 x double>, ptr %i.l, align 8, !tbaa !19, !alias.scope !47
  %i.m = getelementptr [8 x i8], ptr %invariant.gep63, i64 %index ; 3 uses
  %i.n = getelementptr i8, ptr %i.m, i64 16       ; 2 uses
  %wide.load72 = load <2 x double>, ptr %i.m, align 8, !tbaa !19, !alias.scope !48, !noalias !47
  %wide.load73 = load <2 x double>, ptr %i.n, align 8, !tbaa !19, !alias.scope !48, !noalias !47
  ...
  store <2 x double> %i.o, ptr %i.m, align 8, !tbaa !19, !alias.scope !48, !noalias !47
  store <2 x double> %i.p, ptr %i.n, align 8, !tbaa !19, !alias.scope !48, !noalias !47
...
vector.body89:                                    ; preds = %vector.body89, %vector.ph85
  ...
  %wide.load91 = load <2 x double>, ptr %gep107, align 8, !tbaa !19, !alias.scope !49
  %wide.load92 = load <2 x double>, ptr %i.ax, align 8, !tbaa !19, !alias.scope !49
  %gep109 = getelementptr [8 x i8], ptr %invariant.gep108, i64 %index90 ; 3 uses
  %i.ay = getelementptr i8, ptr %gep109, i64 16   ; 2 uses
  %wide.load93 = load <2 x double>, ptr %gep109, align 8, !tbaa !19, !alias.scope !50, !noalias !49
  %wide.load94 = load <2 x double>, ptr %i.ay, align 8, !tbaa !19, !alias.scope !50, !noalias !49
  ...
  store <2 x double> %i.az, ptr %gep109, align 8, !tbaa !19, !alias.scope !50, !noalias !49
  store <2 x double> %i.ba, ptr %i.ay, align 8, !tbaa !19, !alias.scope !50, !noalias !49
  %index.next95 = add nuw i64 %index90, 4         ; 2 uses
  %i.bb = icmp eq i64 %index.next95, %n.vec86
  br i1 %i.bb, label %middle.block96, label %vector.body89, !llvm.loop !44
...
vector.body85:                                    ; preds = %vector.body85, %vector.ph81
  ...
  br i1 %i.ah, label %middle.block90, label %vector.body85, !llvm.loop !51
...
.lr.ph23.i:                                       ; preds = %.lr.ph23.i.preheader, %.lr.ph23.i
  ...
  br i1 %exitcond.not.i, label %.lr.ph.preheader, label %.lr.ph23.i, !llvm.loop !52
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.ar, align 8, !tbaa !19, !alias.scope !58
  %wide.load76 = load <2 x double>, ptr %i.as, align 8, !tbaa !19, !alias.scope !58
  %i.at = getelementptr [8 x i8], ptr %invariant.gep63.i, i64 %index ; 3 uses
  %i.au = getelementptr i8, ptr %i.at, i64 16     ; 2 uses
  %wide.load77 = load <2 x double>, ptr %i.at, align 8, !tbaa !19, !alias.scope !59, !noalias !58
  %wide.load78 = load <2 x double>, ptr %i.au, align 8, !tbaa !19, !alias.scope !59, !noalias !58
  ...
  store <2 x double> %i.av, ptr %i.at, align 8, !tbaa !19, !alias.scope !59, !noalias !58
  store <2 x double> %i.aw, ptr %i.au, align 8, !tbaa !19, !alias.scope !59, !noalias !58
  %index.next = add nuw i64 %index, 4             ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.m, align 8, !tbaa !19, !alias.scope !70
  %wide.load57 = load <2 x double>, ptr %i.n, align 8, !tbaa !19, !alias.scope !70
  %i.o = getelementptr [8 x i8], ptr %invariant.gep63.i, i64 %index ; 3 uses
  %i.p = getelementptr i8, ptr %i.o, i64 16       ; 2 uses
  %wide.load58 = load <2 x double>, ptr %i.o, align 8, !tbaa !19, !alias.scope !71, !noalias !70
  %wide.load59 = load <2 x double>, ptr %i.p, align 8, !tbaa !19, !alias.scope !71, !noalias !70
  ...
  store <2 x double> %i.q, ptr %i.o, align 8, !tbaa !19, !alias.scope !71, !noalias !70
  store <2 x double> %i.r, ptr %i.p, align 8, !tbaa !19, !alias.scope !71, !noalias !70
  %index.next = add nuw i64 %index, 4             ; 2 uses
...
vector.body72:                                    ; preds = %vector.body72, %vector.ph68
  ...
  %i.as = getelementptr i8, ptr %i.ar, i64 16
  %wide.load74 = load <2 x double>, ptr %i.ar, align 8, !tbaa !19, !alias.scope !72
  %wide.load75 = load <2 x double>, ptr %i.as, align 8, !tbaa !19, !alias.scope !72
  %i.at = getelementptr [8 x i8], ptr %2, i64 %index73 ; 3 uses
  %i.au = getelementptr i8, ptr %i.at, i64 16     ; 2 uses
  %wide.load76 = load <2 x double>, ptr %i.at, align 8, !tbaa !19, !alias.scope !73, !noalias !72
  %wide.load77 = load <2 x double>, ptr %i.au, align 8, !tbaa !19, !alias.scope !73, !noalias !72
  ...
  store <2 x double> %i.av, ptr %i.at, align 8, !tbaa !19, !alias.scope !73, !noalias !72
  store <2 x double> %i.aw, ptr %i.au, align 8, !tbaa !19, !alias.scope !73, !noalias !72
  %index.next78 = add nuw i64 %index73, 4         ; 2 uses
  %i.ax = icmp eq i64 %index.next78, %n.vec69
  br i1 %i.ax, label %middle.block79, label %vector.body72, !llvm.loop !68
...
.lr.ph.i42:                                       ; preds = %.lr.ph.i42.prol.loopexit, %.lr.ph.i42
  ...
  br i1 %exitcond.not.i47.1, label %daxpy.exit48, label %.lr.ph.i42, !llvm.loop !69
...
vector.body75:                                    ; preds = %vector.body75, %vector.ph71
  ...
  br i1 %i.bu, label %middle.block80, label %vector.body75, !llvm.loop !76
...
.lr.ph23.i.i:                                     ; preds = %.lr.ph23.i.i.preheader, %.lr.ph23.i.i
  ...
  br i1 %exitcond.not.i.i, label %.lr.ph.i.preheader, label %.lr.ph23.i.i, !llvm.loop !77
...
vector.body61:                                    ; preds = %vector.body61, %vector.ph60
  ...
  %wide.load63 = load <2 x double>, ptr %i.ce, align 8, !tbaa !19, !alias.scope !90
  %wide.load64 = load <2 x double>, ptr %i.cf, align 8, !tbaa !19, !alias.scope !90
  %i.cg = getelementptr [8 x i8], ptr %invariant.gep63.i.i, i64 %index62 ; 3 uses
  %i.ch = getelementptr i8, ptr %i.cg, i64 16     ; 2 uses
  %wide.load65 = load <2 x double>, ptr %i.cg, align 8, !tbaa !19, !alias.scope !91, !noalias !90
  %wide.load66 = load <2 x double>, ptr %i.ch, align 8, !tbaa !19, !alias.scope !91, !noalias !90
  ...
  store <2 x double> %i.ci, ptr %i.cg, align 8, !tbaa !19, !alias.scope !91, !noalias !90
  store <2 x double> %i.cj, ptr %i.ch, align 8, !tbaa !19, !alias.scope !91, !noalias !90
  %index.next67 = add nuw i64 %index62, 4         ; 2 uses
  %i.ck = icmp eq i64 %index.next67, %n.vec
  br i1 %i.ck, label %middle.block68, label %vector.body61, !llvm.loop !81
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  br i1 %exitcond.not.i57.i.1, label %daxpy.exit.i, label %.lr.ph.i.i, !llvm.loop !82
...
vector.body89:                                    ; preds = %vector.body89, %vector.ph85
  ...
  br i1 %i.dp, label %middle.block96, label %vector.body89, !llvm.loop !83
...
.lr.ph.i.i38:                                     ; preds = %.lr.ph.i.i38.preheader, %.lr.ph.i.i38
  ...
  br i1 %exitcond.not.i.i43, label %daxpy.exit.i34, label %.lr.ph.i.i38, !llvm.loop !84
...
vector.body105:                                   ; preds = %vector.body105, %vector.ph101
  ...
  br i1 %i.ek, label %middle.block112, label %vector.body105, !llvm.loop !85
...
.lr.ph.i42.i:                                     ; preds = %.lr.ph.i42.i.preheader115, %.lr.ph.i42.i
  ...
  br i1 %exitcond.not.i47.i, label %daxpy.exit48.i, label %.lr.ph.i42.i, !llvm.loop !86
...
!76 = distinct !{!76, !23, !24, !25}
!77 = distinct !{!77, !23, !25, !24}
...
!84 = distinct !{!84, !23, !25, !24}
!85 = distinct !{!85, !23, !24, !25}
!86 = distinct !{!86, !23, !25, !24}
!87 = distinct !{!87, !23}
!88 = !{!"p1 omnipotent char", !20, i64 0}
!89 = !{!88, !88, i64 0}
!90 = !{!79}
!91 = !{!80}
!92 = !{!"p1 _ZTS8_IO_FILE", !20, i64 0}
!93 = !{!92, !92, i64 0}
end_hunk_0
