...
begin_hunk_0_@matgen:bb.a
  ...
  store double %i.aw, ptr %i.au, align 8, !tbaa !19
  %indvars.iv.next41.3 = add nuw nsw i64 %indvars.iv40, 4 ; 2 uses
  %exitcond43.not.3 = icmp eq i64 %indvars.iv.next41.3, 2000
  br i1 %exitcond43.not.3, label %middle.block, label %scalar.ph, !llvm.loop !30
...
middle.block:                                     ; preds = %vector.body, %scalar.ph
  ...
  br i1 %exitcond47.not, label %bb.d, label %.preheader, !llvm.loop !2
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  %i.l = load double, ptr %gep, align 8, !tbaa !19
  ...
  %i.p = load double, ptr %gep.1, align 8, !tbaa !19
  ...
  br i1 %niter.ncmp.1, label %.loopexit.loopexit63.unr-lcssa, label %.lr.ph, !llvm.loop !33
...
.lr.ph49:                                         ; preds = %.lr.ph49, %.lr.ph49.preheader.new
  ...
  %i.y = load double, ptr %gep61, align 8, !tbaa !19
  ...
  %i.ac = load double, ptr %gep61.1, align 8, !tbaa !19
  ...
  br i1 %niter71.ncmp.1, label %.loopexit.loopexit.unr-lcssa, label %.lr.ph49, !llvm.loop !3
...
.lr.ph49.epil.preheader:                          ; preds = %.loopexit.loopexit.unr-lcssa, %.lr.ph49.preheader
  ...
  %i.ag = load double, ptr %gep61.epil, align 8, !tbaa !19
...
.lr.ph.epil.preheader:                            ; preds = %.loopexit.loopexit63.unr-lcssa, %.lr.ph.preheader
  ...
  %i.ak = load double, ptr %gep.epil, align 8, !tbaa !19
...
vector.body42:                                    ; preds = %vector.body42, %vector.ph38
  ...
  %wide.load44 = load <2 x double>, ptr %i.c, align 8, !tbaa !19
  %wide.load45 = load <2 x double>, ptr %i.d, align 8, !tbaa !19
  %i.e = fmul <2 x double> %broadcast.splat41, %wide.load44
  %i.f = fmul <2 x double> %broadcast.splat41, %wide.load45
  store <2 x double> %i.e, ptr %i.c, align 8, !tbaa !19
  store <2 x double> %i.f, ptr %i.d, align 8, !tbaa !19
  %index.next46 = add nuw i64 %index43, 4         ; 2 uses
  %i.g = icmp eq i64 %index.next46, %n.vec39
  br i1 %i.g, label %middle.block47, label %vector.body42, !llvm.loop !34
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  %9 = load double, ptr %gep, align 8, !tbaa !19
  %10 = fmul double %1, %9
  store double %10, ptr %gep, align 8, !tbaa !19
  %indvars.iv.next = add nsw i64 %indvars.iv, %i.j ; 2 uses
  %gep.1 = getelementptr [8 x i8], ptr %invariant.gep, i64 %indvars.iv.next ; 2 uses
  %11 = load double, ptr %gep.1, align 8, !tbaa !19
  %12 = fmul double %1, %11
  store double %12, ptr %gep.1, align 8, !tbaa !19
  ...
  %13 = load double, ptr %gep.2, align 8, !tbaa !19
  %14 = fmul double %1, %13
  store double %14, ptr %gep.2, align 8, !tbaa !19
  ...
  %15 = load double, ptr %gep.3, align 8, !tbaa !19
  %16 = fmul double %1, %15
  store double %16, ptr %gep.3, align 8, !tbaa !19
  %indvars.iv.next.3 = add nsw i64 %indvars.iv.next.2, %i.j ; 2 uses
  %niter.next.3 = add i64 %niter, 4               ; 2 uses
  %niter.ncmp.3.not = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3.not, label %.loopexit.loopexit51.unr-lcssa, label %.lr.ph, !llvm.loop !35
...
.lr.ph.a:                                         ; preds = %.lr.ph23.preheader50, %.lr.ph.a
  ...
  %i.m = load double, ptr %gep.a, align 8, !tbaa !19
  %i.n = fmul double %1, %i.m
  store double %i.n, ptr %gep.a, align 8, !tbaa !19
  %indvars.iv.next.a = add nuw nsw i64 %indvars.iv.a, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next.a, %wide.trip.count
  br i1 %exitcond.not, label %.loopexit, label %.lr.ph.a, !llvm.loop !36
...
.lr.ph23:                                         ; preds = %.lr.ph23, %.lr.ph.epil.preheader
  ...
  %i.o = load double, ptr %gep33, align 8, !tbaa !19
  %i.p = fmul double %1, %i.o
  store double %i.p, ptr %gep33, align 8, !tbaa !19
  ...
  br i1 %exitcond.not.a, label %.loopexit, label %.lr.ph23, !llvm.loop !37
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.k, align 8, !tbaa !19, !alias.scope !49
  %wide.load71 = load <2 x double>, ptr %i.l, align 8, !tbaa !19, !alias.scope !49
  %i.m = getelementptr [8 x i8], ptr %invariant.gep63, i64 %index ; 3 uses
  %i.n = getelementptr i8, ptr %i.m, i64 16       ; 2 uses
  %wide.load72 = load <2 x double>, ptr %i.m, align 8, !tbaa !19, !alias.scope !50, !noalias !49
  %wide.load73 = load <2 x double>, ptr %i.n, align 8, !tbaa !19, !alias.scope !50, !noalias !49
  ...
  store <2 x double> %i.o, ptr %i.m, align 8, !tbaa !19, !alias.scope !50, !noalias !49
  store <2 x double> %i.p, ptr %i.n, align 8, !tbaa !19, !alias.scope !50, !noalias !49
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.q = icmp eq i64 %index.next, %n.vec
  br i1 %i.q, label %middle.block, label %vector.body, !llvm.loop !42
...
vector.body89:                                    ; preds = %vector.body89, %vector.ph85
  ...
  %wide.load91 = load <2 x double>, ptr %gep107, align 8, !tbaa !19, !alias.scope !51
  %wide.load92 = load <2 x double>, ptr %i.ax, align 8, !tbaa !19, !alias.scope !51
  %gep109 = getelementptr [8 x i8], ptr %invariant.gep108, i64 %index90 ; 3 uses
  %i.ay = getelementptr i8, ptr %gep109, i64 16   ; 2 uses
  %wide.load93 = load <2 x double>, ptr %gep109, align 8, !tbaa !19, !alias.scope !52, !noalias !51
  %wide.load94 = load <2 x double>, ptr %i.ay, align 8, !tbaa !19, !alias.scope !52, !noalias !51
  ...
  store <2 x double> %i.az, ptr %gep109, align 8, !tbaa !19, !alias.scope !52, !noalias !51
  store <2 x double> %i.ba, ptr %i.ay, align 8, !tbaa !19, !alias.scope !52, !noalias !51
...
bb.b:                                             ; preds = %bb.a, %.loopexit
  ...
  %i.e = load double, ptr %i.d, align 8, !tbaa !19 ; 3 uses
...
.lr.ph49.i:                                       ; preds = %.lr.ph49.i, %.new
  ...
  %i.h = load double, ptr %gep61.i, align 8, !tbaa !19
  ...
  %i.l = load double, ptr %gep61.i.1, align 8, !tbaa !19
  %i.m = tail call double @llvm.fabs.f64(double %i.l) ; 2 uses
  ...
  br i1 %niter.ncmp.1, label %idamax.exit.unr-lcssa, label %.lr.ph49.i, !llvm.loop !3
...
.lr.ph49.i.epil.preheader:                        ; preds = %idamax.exit.unr-lcssa, %bb.b
  ...
  %i.p = load double, ptr %gep61.i.epil, align 8, !tbaa !19
...
.thread:                                          ; preds = %bb.c
  store double %i.e, ptr %i.x, align 8, !tbaa !19
  store double %i.y, ptr %i.d, align 8, !tbaa !19
  br label %bb.d
...
vector.body85:                                    ; preds = %vector.body85, %vector.ph81
  ...
  %wide.load87 = load <2 x double>, ptr %i.ad, align 8, !tbaa !19
  %wide.load88 = load <2 x double>, ptr %i.ae, align 8, !tbaa !19
  %i.af = fmul <2 x double> %broadcast.splat84, %wide.load87
  %i.ag = fmul <2 x double> %broadcast.splat84, %wide.load88
  store <2 x double> %i.af, ptr %i.ad, align 8, !tbaa !19
  store <2 x double> %i.ag, ptr %i.ae, align 8, !tbaa !19
  %index.next89 = add nuw i64 %index86, 4         ; 2 uses
  %i.ah = icmp eq i64 %index.next89, %n.vec82
  br i1 %i.ah, label %middle.block90, label %vector.body85, !llvm.loop !53
...
.lr.ph23.i:                                       ; preds = %.lr.ph23.i.preheader, %.lr.ph23.i
  ...
  %i.ai = load double, ptr %gep33.i, align 8, !tbaa !19
  %i.aj = fmul double %i.ab, %i.ai
  store double %i.aj, ptr %gep33.i, align 8, !tbaa !19
  %indvars.iv.next27.i = add nuw nsw i64 %indvars.iv26.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next27.i, %i.ac
  br i1 %exitcond.not.i, label %.lr.ph.preheader, label %.lr.ph23.i, !llvm.loop !54
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.ar, align 8, !tbaa !19, !alias.scope !60
  %wide.load76 = load <2 x double>, ptr %i.as, align 8, !tbaa !19, !alias.scope !60
  %i.at = getelementptr [8 x i8], ptr %invariant.gep63.i, i64 %index ; 3 uses
  %i.au = getelementptr i8, ptr %i.at, i64 16     ; 2 uses
  %wide.load77 = load <2 x double>, ptr %i.at, align 8, !tbaa !19, !alias.scope !61, !noalias !60
  %wide.load78 = load <2 x double>, ptr %i.au, align 8, !tbaa !19, !alias.scope !61, !noalias !60
  ...
  store <2 x double> %i.av, ptr %i.at, align 8, !tbaa !19, !alias.scope !61, !noalias !60
  store <2 x double> %i.aw, ptr %i.au, align 8, !tbaa !19, !alias.scope !61, !noalias !60
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ax = icmp eq i64 %index.next, %n.vec
  br i1 %i.ax, label %middle.block, label %vector.body, !llvm.loop !58
...
.loopexit:                                        ; preds = %daxpy.exit, %idamax.exit
  ...
  br i1 %exitcond72.not, label %bb.h, label %bb.b, !llvm.loop !5

bb.h:                                             ; preds = %.loopexit
  %i.bj = getelementptr inbounds nuw i8, ptr %1, i64 7996
  store i32 1999, ptr %i.bj, align 4, !tbaa !15
  ret void
}
...
bb.b:                                             ; preds = %bb.a, %daxpy.exit
  ...
  %i.e = load double, ptr %i.d, align 8, !tbaa !19 ; 6 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  store double %i.h, ptr %i.d, align 8, !tbaa !19
  store double %i.e, ptr %i.g, align 8, !tbaa !19
  br label %bb.d
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.m, align 8, !tbaa !19, !alias.scope !72
  %wide.load57 = load <2 x double>, ptr %i.n, align 8, !tbaa !19, !alias.scope !72
  %i.o = getelementptr [8 x i8], ptr %invariant.gep63.i, i64 %index ; 3 uses
  %i.p = getelementptr i8, ptr %i.o, i64 16       ; 2 uses
  %wide.load58 = load <2 x double>, ptr %i.o, align 8, !tbaa !19, !alias.scope !73, !noalias !72
  %wide.load59 = load <2 x double>, ptr %i.p, align 8, !tbaa !19, !alias.scope !73, !noalias !72
  ...
  store <2 x double> %i.q, ptr %i.o, align 8, !tbaa !19, !alias.scope !73, !noalias !72
  store <2 x double> %i.r, ptr %i.p, align 8, !tbaa !19, !alias.scope !73, !noalias !72
  %index.next = add nuw i64 %index, 4             ; 2 uses
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader
  ...
  %i.u = load double, ptr %gep.i.prol, align 8, !tbaa !19
  %gep64.i.prol = getelementptr [8 x i8], ptr %invariant.gep63.i, i64 %indvars.iv.i.ph ; 2 uses
  %i.v = load double, ptr %gep64.i.prol, align 8, !tbaa !19
  %i.w = tail call double @llvm.fmuladd.f64(double %i.e, double %i.u, double %i.v)
  store double %i.w, ptr %gep64.i.prol, align 8, !tbaa !19
  %indvars.iv.next.i.prol = or disjoint i64 %indvars.iv.i.ph, 1
  br label %.lr.ph.i.prol.loopexit
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.y = load double, ptr %gep.i, align 8, !tbaa !19
  %gep64.i = getelementptr [8 x i8], ptr %invariant.gep63.i, i64 %indvars.iv.i ; 2 uses
  %i.z = load double, ptr %gep64.i, align 8, !tbaa !19
  %i.aa = tail call double @llvm.fmuladd.f64(double %i.e, double %i.y, double %i.z)
  store double %i.aa, ptr %gep64.i, align 8, !tbaa !19
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %gep.i.1 = getelementptr [8 x i8], ptr %invariant.gep.i, i64 %indvars.iv.next.i
  %i.ab = load double, ptr %gep.i.1, align 8, !tbaa !19
  %gep64.i.1 = getelementptr [8 x i8], ptr %invariant.gep63.i, i64 %indvars.iv.next.i ; 2 uses
  %i.ac = load double, ptr %gep64.i.1, align 8, !tbaa !19
  %i.ad = tail call double @llvm.fmuladd.f64(double %i.e, double %i.ab, double %i.ac)
  store double %i.ad, ptr %gep64.i.1, align 8, !tbaa !19
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2 ; 2 uses
...
.preheader:                                       ; preds = %daxpy.exit, %daxpy.exit48
  ...
  %i.ai = load ptr, ptr %i.ah, align 8, !tbaa !22 ; 7 uses
  ...
  store double %i.an, ptr %i.al, align 8, !tbaa !19
...
vector.body72:                                    ; preds = %vector.body72, %vector.ph68
  ...
  %i.as = getelementptr i8, ptr %i.ar, i64 16
  %wide.load74 = load <2 x double>, ptr %i.ar, align 8, !tbaa !19, !alias.scope !74
  %wide.load75 = load <2 x double>, ptr %i.as, align 8, !tbaa !19, !alias.scope !74
  %i.at = getelementptr [8 x i8], ptr %2, i64 %index73 ; 3 uses
  %i.au = getelementptr i8, ptr %i.at, i64 16     ; 2 uses
  %wide.load76 = load <2 x double>, ptr %i.at, align 8, !tbaa !19, !alias.scope !75, !noalias !74
  %wide.load77 = load <2 x double>, ptr %i.au, align 8, !tbaa !19, !alias.scope !75, !noalias !74
  ...
  store <2 x double> %i.av, ptr %i.at, align 8, !tbaa !19, !alias.scope !75, !noalias !74
  store <2 x double> %i.aw, ptr %i.au, align 8, !tbaa !19, !alias.scope !75, !noalias !74
  %index.next78 = add nuw i64 %index73, 4         ; 2 uses
  %i.ax = icmp eq i64 %index.next78, %n.vec69
  br i1 %i.ax, label %middle.block79, label %vector.body72, !llvm.loop !70
...
.lr.ph.i42.prol:                                  ; preds = %.lr.ph.i42.preheader82
  ...
  %i.az = load double, ptr %gep.i44.prol, align 8, !tbaa !19
  %gep64.i45.prol = getelementptr [8 x i8], ptr %2, i64 %indvars.iv.i43.ph ; 2 uses
  %i.ba = load double, ptr %gep64.i45.prol, align 8, !tbaa !19
  %i.bb = tail call double @llvm.fmuladd.f64(double %i.ao, double %i.az, double %i.ba)
  store double %i.bb, ptr %gep64.i45.prol, align 8, !tbaa !19
...
.lr.ph.i42:                                       ; preds = %.lr.ph.i42.prol.loopexit, %.lr.ph.i42
  ...
  %i.bd = load double, ptr %gep.i44, align 8, !tbaa !19
  %gep64.i45 = getelementptr [8 x i8], ptr %2, i64 %indvars.iv.i43 ; 2 uses
  %i.be = load double, ptr %gep64.i45, align 8, !tbaa !19
  %i.bf = tail call double @llvm.fmuladd.f64(double %i.ao, double %i.bd, double %i.be)
  store double %i.bf, ptr %gep64.i45, align 8, !tbaa !19
...
daxpy.exit48:                                     ; preds = %.lr.ph.i42.prol.loopexit, %.lr.ph.i42, %middle.block79, %.preheader
  ...
  br i1 %exitcond55.not, label %bb.f, label %.preheader, !llvm.loop !7
...
bb.c:                                             ; preds = %bb.b
  ...
  %seed.promoted25.i = load i64, ptr @seed, align 8, !tbaa !17
...
.preheader22.i:                                   ; preds = %bb.e
  ...
  store i64 %i.l, ptr @seed, align 8, !tbaa !17
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16000) %i.i, i8 0, i64 16000, i1 false), !tbaa !19
...
bb.d:                                             ; preds = %bb.d, %.preheader23.i
  ...
  store double %i.u, ptr %i.x, align 8, !tbaa !19
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 2000
  br i1 %exitcond.not.i, label %bb.e, label %bb.d, !llvm.loop !0

bb.e:                                             ; preds = %bb.d
  %indvars.iv.next34.i = add nuw nsw i64 %indvars.iv33.i, 1 ; 2 uses
  %exitcond36.not.i = icmp eq i64 %indvars.iv.next34.i, 2000
  br i1 %exitcond36.not.i, label %.preheader22.i, label %.preheader23.i, !llvm.loop !1
...
vector.body:                                      ; preds = %vector.body, %.preheader.i
  ...
  %wide.load = load <2 x double>, ptr %i.aa, align 8, !tbaa !19
  %wide.load56 = load <2 x double>, ptr %i.ab, align 8, !tbaa !19
  %i.ac = getelementptr inbounds nuw [8 x i8], ptr %i.i, i64 %index ; 3 uses
  %i.ad = getelementptr inbounds nuw i8, ptr %i.ac, i64 16 ; 2 uses
  %wide.load57 = load <2 x double>, ptr %i.ac, align 8, !tbaa !19
  %wide.load58 = load <2 x double>, ptr %i.ad, align 8, !tbaa !19
  %i.ae = fadd <2 x double> %wide.load, %wide.load57
  %i.af = fadd <2 x double> %wide.load56, %wide.load58
  store <2 x double> %i.ae, ptr %i.ac, align 8, !tbaa !19
  store <2 x double> %i.af, ptr %i.ad, align 8, !tbaa !19
  %index.next = or disjoint i64 %index, 4         ; 2 uses
  %i.ag = getelementptr inbounds nuw [8 x i8], ptr %i.z, i64 %index.next ; 2 uses
  %i.ah = getelementptr inbounds nuw i8, ptr %i.ag, i64 16
  %wide.load.1 = load <2 x double>, ptr %i.ag, align 8, !tbaa !19
  %wide.load56.1 = load <2 x double>, ptr %i.ah, align 8, !tbaa !19
  ...
  %wide.load57.1 = load <2 x double>, ptr %i.ai, align 8, !tbaa !19
  %wide.load58.1 = load <2 x double>, ptr %i.aj, align 8, !tbaa !19
  %i.ak = fadd <2 x double> %wide.load.1, %wide.load57.1
  %i.al = fadd <2 x double> %wide.load56.1, %wide.load58.1
  store <2 x double> %i.ak, ptr %i.ai, align 8, !tbaa !19
  store <2 x double> %i.al, ptr %i.aj, align 8, !tbaa !19
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %exitcond47.not.i, label %matgen.exit, label %.preheader.i, !llvm.loop !2
...
matgen.exit:                                      ; preds = %middle.block, %.loopexit.i
  ...
  %i.ap = load ptr, ptr %i.ao, align 8, !tbaa !22 ; 4 uses
  %i.aq = getelementptr inbounds nuw [8 x i8], ptr %i.ap, i64 %indvars.iv69.i ; 5 uses
  %i.ar = load double, ptr %i.aq, align 8, !tbaa !19 ; 3 uses
...
.lr.ph49.i.i:                                     ; preds = %.lr.ph49.i.i, %matgen.exit.new
  ...
  %i.au = load double, ptr %gep61.i.i, align 8, !tbaa !19
  ...
  %i.ay = load double, ptr %gep61.i.i.1, align 8, !tbaa !19
  ...
  %niter.next.1 = add nuw i64 %niter, 2           ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %idamax.exit.i.unr-lcssa, label %.lr.ph49.i.i, !llvm.loop !3
...
.lr.ph49.i.i.epil.preheader:                      ; preds = %idamax.exit.i.unr-lcssa, %matgen.exit
  ...
  %i.bc = load double, ptr %gep61.i.i.epil, align 8, !tbaa !19
...
.thread.i:                                        ; preds = %bb.f
  store double %i.ar, ptr %i.bk, align 8, !tbaa !19
  store double %i.bl, ptr %i.aq, align 8, !tbaa !19
  br label %bb.g
...
vector.body75:                                    ; preds = %vector.body75, %vector.ph71
  ...
  %wide.load77 = load <2 x double>, ptr %i.bq, align 8, !tbaa !19
  %wide.load78 = load <2 x double>, ptr %i.br, align 8, !tbaa !19
  %i.bs = fmul <2 x double> %broadcast.splat74, %wide.load77
  %i.bt = fmul <2 x double> %broadcast.splat74, %wide.load78
  store <2 x double> %i.bs, ptr %i.bq, align 8, !tbaa !19
  store <2 x double> %i.bt, ptr %i.br, align 8, !tbaa !19
  %index.next79 = add nuw i64 %index76, 4         ; 2 uses
  %i.bu = icmp eq i64 %index.next79, %n.vec72
  br i1 %i.bu, label %middle.block80, label %vector.body75, !llvm.loop !78
...
.lr.ph23.i.i:                                     ; preds = %.lr.ph23.i.i.preheader, %.lr.ph23.i.i
  ...
  %i.bv = load double, ptr %gep33.i.i, align 8, !tbaa !19
  %i.bw = fmul double %i.bo, %i.bv
  store double %i.bw, ptr %gep33.i.i, align 8, !tbaa !19
...
vector.body61:                                    ; preds = %vector.body61, %vector.ph60
  ...
  %wide.load63 = load <2 x double>, ptr %i.ce, align 8, !tbaa !19, !alias.scope !92
  %wide.load64 = load <2 x double>, ptr %i.cf, align 8, !tbaa !19, !alias.scope !92
  %i.cg = getelementptr [8 x i8], ptr %invariant.gep63.i.i, i64 %index62 ; 3 uses
  %i.ch = getelementptr i8, ptr %i.cg, i64 16     ; 2 uses
  %wide.load65 = load <2 x double>, ptr %i.cg, align 8, !tbaa !19, !alias.scope !93, !noalias !92
  %wide.load66 = load <2 x double>, ptr %i.ch, align 8, !tbaa !19, !alias.scope !93, !noalias !92
  ...
  store <2 x double> %i.ci, ptr %i.cg, align 8, !tbaa !19, !alias.scope !93, !noalias !92
  store <2 x double> %i.cj, ptr %i.ch, align 8, !tbaa !19, !alias.scope !93, !noalias !92
  %index.next67 = add nuw i64 %index62, 4         ; 2 uses
  %i.ck = icmp eq i64 %index.next67, %n.vec
  br i1 %i.ck, label %middle.block68, label %vector.body61, !llvm.loop !83
...
bb.k:                                             ; preds = %daxpy.exit.i34, %dgefa.exit
  ...
  %i.cy = load i32, ptr %i.cx, align 4, !tbaa !15 ; 2 uses
  %i.cz = sext i32 %i.cy to i64
  %i.da = getelementptr inbounds [8 x i8], ptr %i.i, i64 %i.cz ; 2 uses
  %i.db = load double, ptr %i.da, align 8, !tbaa !19 ; 4 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  store double %i.de, ptr %i.da, align 8, !tbaa !19
  store double %i.db, ptr %i.dd, align 8, !tbaa !19
  br label %bb.m
...
vector.body89:                                    ; preds = %vector.body89, %vector.ph85
  ...
  %wide.load91 = load <2 x double>, ptr %i.dj, align 8, !tbaa !19
  %wide.load92 = load <2 x double>, ptr %i.dk, align 8, !tbaa !19
  %i.dl = getelementptr [8 x i8], ptr %invariant.gep63.i.i37, i64 %index90 ; 3 uses
  %i.dm = getelementptr i8, ptr %i.dl, i64 16     ; 2 uses
  %wide.load93 = load <2 x double>, ptr %i.dl, align 8, !tbaa !19
  %wide.load94 = load <2 x double>, ptr %i.dm, align 8, !tbaa !19
  ...
  store <2 x double> %i.dn, ptr %i.dl, align 8, !tbaa !19
  store <2 x double> %i.do, ptr %i.dm, align 8, !tbaa !19
  %index.next95 = add nuw i64 %index90, 4         ; 2 uses
  %i.dp = icmp eq i64 %index.next95, %n.vec86
  br i1 %i.dp, label %middle.block96, label %vector.body89, !llvm.loop !85
...
.preheader.i36:                                   ; preds = %daxpy.exit.i34, %daxpy.exit48.i
  ...
  %i.dv = load ptr, ptr %i.du, align 8, !tbaa !22 ; 3 uses
  ...
  store double %i.ea, ptr %i.dy, align 8, !tbaa !19
...
vector.body105:                                   ; preds = %vector.body105, %vector.ph101
  ...
  %wide.load107 = load <2 x double>, ptr %i.ee, align 8, !tbaa !19
  %wide.load108 = load <2 x double>, ptr %i.ef, align 8, !tbaa !19
  %i.eg = getelementptr [8 x i8], ptr %i.i, i64 %index106 ; 3 uses
  %i.eh = getelementptr i8, ptr %i.eg, i64 16     ; 2 uses
  %wide.load109 = load <2 x double>, ptr %i.eg, align 8, !tbaa !19
  %wide.load110 = load <2 x double>, ptr %i.eh, align 8, !tbaa !19
  ...
  store <2 x double> %i.ei, ptr %i.eg, align 8, !tbaa !19
  store <2 x double> %i.ej, ptr %i.eh, align 8, !tbaa !19
  %index.next111 = add nuw i64 %index106, 4       ; 2 uses
  %i.ek = icmp eq i64 %index.next111, %n.vec102
  br i1 %i.ek, label %middle.block112, label %vector.body105, !llvm.loop !87
...
!79 = distinct !{!79, !23, !25, !24}
!80 = distinct !{!80, !"LVerDomain"}
!81 = distinct !{!81, !80}
!82 = distinct !{!82, !80}
!83 = distinct !{!83, !23, !24, !25}
!84 = distinct !{!84, !23, !24}
!85 = distinct !{!85, !23, !24, !25}
!86 = distinct !{!86, !23, !25, !24}
!87 = distinct !{!87, !23, !24, !25}
!88 = distinct !{!88, !23, !25, !24}
!89 = distinct !{!89, !23}
!90 = !{!"p1 omnipotent char", !20, i64 0}
!91 = !{!90, !90, i64 0}
!92 = !{!81}
!93 = !{!82}
!94 = !{!"p1 _ZTS8_IO_FILE", !20, i64 0}
!95 = !{!94, !94, i64 0}
end_hunk_0
