...
bb.d:                                             ; preds = %.thread, %bb.c
  ...
  %i.ac = sub nuw nsw i64 1999, %indvars.iv69     ; 4 uses
...
vector.ph81:                                      ; preds = %bb.d
  %n.vec83 = and i64 %i.ac, 2044                  ; 3 uses
  %broadcast.splatinsert84 = insertelement <2 x double> poison, double %i.ab, i64 0
...
vector.body86:                                    ; preds = %vector.body86, %vector.ph81
  ...
  %i.ad = getelementptr [8 x i8], ptr %invariant.gep32.i, i64 %index87 ; 3 uses
  %i.ae = getelementptr i8, ptr %i.ad, i64 16     ; 2 uses
  %wide.load88 = load <2 x double>, ptr %i.ad, align 8, !tbaa !10
  %wide.load89 = load <2 x double>, ptr %i.ae, align 8, !tbaa !10
  %i.af = fmul <2 x double> %broadcast.splat85, %wide.load88
  %i.ag = fmul <2 x double> %broadcast.splat85, %wide.load89
  ...
  %i.ah = icmp eq i64 %index.next90, %n.vec83
  br i1 %i.ah, label %middle.block91, label %vector.body86, !llvm.loop !47
...
.lr.ph.preheader:                                 ; preds = %.lr.ph23.i, %middle.block91
  ...
  %n.vec = and i64 %i.a, -4                       ; 3 uses
  %cmp.n = icmp eq i64 %i.a, %n.vec
  %i.ak = and i64 %indvars.iv69, 1
  %lcmp.mod97.not.not = icmp eq i64 %i.ak, 0
  br label %.lr.ph
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %daxpy.exit
  ...
  %i.al = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %indvars.iv66
  %i.am = load ptr, ptr %i.al, align 8, !tbaa !12 ; 4 uses
  %i.an = getelementptr inbounds [8 x i8], ptr %i.am, i64 %i.w ; 2 uses
  %i.ao = load double, ptr %i.an, align 8, !tbaa !10 ; 6 uses
  br i1 %.not, label %bb.f, label %bb.e

bb.e:                                             ; preds = %.lr.ph
  %i.ap = getelementptr inbounds nuw [8 x i8], ptr %i.am, i64 %indvars.iv69 ; 2 uses
  %i.aq = load double, ptr %i.ap, align 8, !tbaa !10
  store double %i.aq, ptr %i.an, align 8, !tbaa !10
  store double %i.ao, ptr %i.ap, align 8, !tbaa !10
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %.lr.ph
  %i.ar = fcmp une double %i.ao, 0.000000e+00
  br i1 %i.ar, label %bb.g, label %daxpy.exit

bb.g:                                             ; preds = %bb.f
  %invariant.gep63.i = getelementptr [8 x i8], ptr %i.am, i64 %indvars.iv.next70 ; 5 uses
  br i1 %min.iters.check, label %.lr.ph.i.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %bb.g
  %scevgep = getelementptr i8, ptr %i.am, i64 16000
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.as = getelementptr [8 x i8], ptr %invariant.gep32.i, i64 %index ; 2 uses
  %i.at = getelementptr i8, ptr %i.as, i64 16
  %wide.load = load <2 x double>, ptr %i.as, align 8, !tbaa !10, !alias.scope !49
  %wide.load76 = load <2 x double>, ptr %i.at, align 8, !tbaa !10, !alias.scope !49
  %i.au = getelementptr [8 x i8], ptr %invariant.gep63.i, i64 %index ; 3 uses
  %i.av = getelementptr i8, ptr %i.au, i64 16     ; 2 uses
  %wide.load77 = load <2 x double>, ptr %i.au, align 8, !tbaa !10, !alias.scope !52, !noalias !49
  %wide.load78 = load <2 x double>, ptr %i.av, align 8, !tbaa !10, !alias.scope !52, !noalias !49
  %i.aw = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat, <2 x double> %wide.load, <2 x double> %wide.load77)
  %i.ax = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat, <2 x double> %wide.load76, <2 x double> %wide.load78)
  store <2 x double> %i.aw, ptr %i.au, align 8, !tbaa !10, !alias.scope !52, !noalias !49
  store <2 x double> %i.ax, ptr %i.av, align 8, !tbaa !10, !alias.scope !52, !noalias !49
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ay = icmp eq i64 %index.next, %n.vec
  br i1 %i.ay, label %middle.block, label %vector.body, !llvm.loop !54
...
.lr.ph.i.preheader:                               ; preds = %vector.memcheck, %bb.g, %middle.block
  ...
  %i.az = add i64 %indvars.iv69, %indvars.iv.i.ph
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader
  ...
  %i.ba = load double, ptr %gep.i.prol, align 8, !tbaa !10
  %gep64.i.prol = getelementptr [8 x i8], ptr %invariant.gep63.i, i64 %indvars.iv.i.ph ; 2 uses
  %i.bb = load double, ptr %gep64.i.prol, align 8, !tbaa !10
  %i.bc = tail call double @llvm.fmuladd.f64(double %i.ao, double %i.ba, double %i.bb)
  store double %i.bc, ptr %gep64.i.prol, align 8, !tbaa !10
...
.lr.ph.i.prol.loopexit:                           ; preds = %.lr.ph.i.prol, %.lr.ph.i.preheader
  ...
  %i.bd = icmp eq i64 %i.az, 1998
  br i1 %i.bd, label %daxpy.exit, label %.lr.ph.i
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.be = load double, ptr %gep.i, align 8, !tbaa !10
  %gep64.i = getelementptr [8 x i8], ptr %invariant.gep63.i, i64 %indvars.iv.i ; 2 uses
  %i.bf = load double, ptr %gep64.i, align 8, !tbaa !10
  %i.bg = tail call double @llvm.fmuladd.f64(double %i.ao, double %i.be, double %i.bf)
  store double %i.bg, ptr %gep64.i, align 8, !tbaa !10
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %gep.i.1 = getelementptr [8 x i8], ptr %invariant.gep32.i, i64 %indvars.iv.next.i
  %i.bh = load double, ptr %gep.i.1, align 8, !tbaa !10
  %gep64.i.1 = getelementptr [8 x i8], ptr %invariant.gep63.i, i64 %indvars.iv.next.i ; 2 uses
  %i.bi = load double, ptr %gep64.i.1, align 8, !tbaa !10
  %i.bj = tail call double @llvm.fmuladd.f64(double %i.ao, double %i.bh, double %i.bi)
  store double %i.bj, ptr %gep64.i.1, align 8, !tbaa !10
...
bb.h:                                             ; preds = %.loopexit
  %i.bk = getelementptr inbounds nuw i8, ptr %1, i64 7996
  store i32 1999, ptr %i.bk, align 4, !tbaa !4
  ret void
}
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.n = sub nuw nsw i64 1999, %indvars.iv        ; 3 uses
...
.lr.ph.i.preheader:                               ; preds = %vector.memcheck, %bb.e, %middle.block
  ...
  %i.v = add nuw i64 %indvars.iv, %indvars.iv.i.ph
...
.preheader:                                       ; preds = %daxpy.exit, %daxpy.exit48
  ...
  %3 = sub nsw i64 1999, %indvars.iv52            ; 3 uses
  %i.ah = shl i64 %indvars.iv52, 3
  %i.ai = sub i64 15992, %i.ah                    ; 2 uses
  %scevgep62 = getelementptr i8, ptr %2, i64 %i.ai
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1 ; 2 uses
  %i.aj = sub nuw nsw i64 1999, %indvars.iv52     ; 4 uses
  ...
  %i.ao = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %i.aj ; 2 uses
  %i.ap = load double, ptr %i.ao, align 8, !tbaa !10
  %i.aq = fdiv double %i.ap, %i.an                ; 3 uses
  store double %i.aq, ptr %i.ao, align 8, !tbaa !10
  %i.ar = fneg double %i.aq                       ; 4 uses
  %i.as = icmp ne i64 %indvars.iv52, 1999
  %i.at = fcmp une double %i.aq, 0.000000e+00
  %or.cond.i38 = and i1 %i.as, %i.at
  br i1 %or.cond.i38, label %.lr.ph.i42.preheader, label %daxpy.exit48

.lr.ph.i42.preheader:                             ; preds = %.preheader
  %min.iters.check68 = icmp ult i64 %3, 4
  br i1 %min.iters.check68, label %.lr.ph.i42.preheader84, label %vector.memcheck61

vector.memcheck61:                                ; preds = %.lr.ph.i42.preheader
  %scevgep63 = getelementptr i8, ptr %i.al, i64 %i.ai
  %bound064 = icmp ult ptr %2, %scevgep63
  %bound165 = icmp ult ptr %i.al, %scevgep62
...
vector.ph69:                                      ; preds = %vector.memcheck61
  %n.vec71 = and i64 %3, -4                       ; 3 uses
  %broadcast.splatinsert72 = insertelement <2 x double> poison, double %i.ar, i64 0
...
vector.body74:                                    ; preds = %vector.body74, %vector.ph69
  ...
  %i.au = getelementptr [8 x i8], ptr %i.al, i64 %index75 ; 2 uses
  %i.av = getelementptr i8, ptr %i.au, i64 16
  %wide.load76 = load <2 x double>, ptr %i.au, align 8, !tbaa !10, !alias.scope !66
  %wide.load77 = load <2 x double>, ptr %i.av, align 8, !tbaa !10, !alias.scope !66
  %i.aw = getelementptr [8 x i8], ptr %2, i64 %index75 ; 3 uses
  %i.ax = getelementptr i8, ptr %i.aw, i64 16     ; 2 uses
  %wide.load78 = load <2 x double>, ptr %i.aw, align 8, !tbaa !10, !alias.scope !69, !noalias !66
  %wide.load79 = load <2 x double>, ptr %i.ax, align 8, !tbaa !10, !alias.scope !69, !noalias !66
  %i.ay = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat73, <2 x double> %wide.load76, <2 x double> %wide.load78)
  %i.az = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat73, <2 x double> %wide.load77, <2 x double> %wide.load79)
  store <2 x double> %i.ay, ptr %i.aw, align 8, !tbaa !10, !alias.scope !69, !noalias !66
  store <2 x double> %i.az, ptr %i.ax, align 8, !tbaa !10, !alias.scope !69, !noalias !66
  %index.next80 = add nuw i64 %index75, 4         ; 2 uses
  %i.ba = icmp eq i64 %index.next80, %n.vec71
  br i1 %i.ba, label %middle.block81, label %vector.body74, !llvm.loop !71

middle.block81:                                   ; preds = %vector.body74
  %cmp.n82 = icmp eq i64 %3, %n.vec71
...
.lr.ph.i42.preheader84:                           ; preds = %vector.memcheck61, %.lr.ph.i42.preheader, %middle.block81
  ...
  %i.bb = add i64 %indvars.iv52, %indvars.iv.i43.ph
  %i.bc = and i64 %indvars.iv52, 1
  %lcmp.mod86.not.not = icmp eq i64 %i.bc, 0
  br i1 %lcmp.mod86.not.not, label %.lr.ph.i42.prol, label %.lr.ph.i42.prol.loopexit

.lr.ph.i42.prol:                                  ; preds = %.lr.ph.i42.preheader84
  %gep.i44.prol = getelementptr [8 x i8], ptr %i.al, i64 %indvars.iv.i43.ph
  %i.bd = load double, ptr %gep.i44.prol, align 8, !tbaa !10
  %gep64.i45.prol = getelementptr [8 x i8], ptr %2, i64 %indvars.iv.i43.ph ; 2 uses
  %i.be = load double, ptr %gep64.i45.prol, align 8, !tbaa !10
  %i.bf = tail call double @llvm.fmuladd.f64(double %i.ar, double %i.bd, double %i.be)
  store double %i.bf, ptr %gep64.i45.prol, align 8, !tbaa !10
...
.lr.ph.i42.prol.loopexit:                         ; preds = %.lr.ph.i42.prol, %.lr.ph.i42.preheader84
  ...
  %i.bg = icmp eq i64 %i.bb, 1998
  br i1 %i.bg, label %daxpy.exit48, label %.lr.ph.i42
...
.lr.ph.i42:                                       ; preds = %.lr.ph.i42.prol.loopexit, %.lr.ph.i42
  ...
  %gep.i44 = getelementptr [8 x i8], ptr %i.al, i64 %indvars.iv.i43
  %i.bh = load double, ptr %gep.i44, align 8, !tbaa !10
  %gep64.i45 = getelementptr [8 x i8], ptr %2, i64 %indvars.iv.i43 ; 2 uses
  %i.bi = load double, ptr %gep64.i45, align 8, !tbaa !10
  %i.bj = tail call double @llvm.fmuladd.f64(double %i.ar, double %i.bh, double %i.bi)
  store double %i.bj, ptr %gep64.i45, align 8, !tbaa !10
  %indvars.iv.next.i46 = add nuw nsw i64 %indvars.iv.i43, 1 ; 2 uses
  %gep.i44.1 = getelementptr [8 x i8], ptr %i.al, i64 %indvars.iv.next.i46
  %i.bk = load double, ptr %gep.i44.1, align 8, !tbaa !10
  %gep64.i45.1 = getelementptr [8 x i8], ptr %2, i64 %indvars.iv.next.i46 ; 2 uses
  %i.bl = load double, ptr %gep64.i45.1, align 8, !tbaa !10
  %i.bm = tail call double @llvm.fmuladd.f64(double %i.ar, double %i.bk, double %i.bl)
  store double %i.bm, ptr %gep64.i45.1, align 8, !tbaa !10
  %indvars.iv.next.i46.1 = add nuw nsw i64 %indvars.iv.i43, 2 ; 2 uses
  %exitcond.not.i47.1 = icmp eq i64 %indvars.iv.next.i46.1, %i.aj
...
bb.g:                                             ; preds = %.thread.i, %bb.f
  ...
  %i.bp = sub nuw nsw i64 1999, %indvars.iv69.i   ; 4 uses
  %invariant.gep32.i.i = getelementptr [8 x i8], ptr %i.ap, i64 %indvars.iv.next70.i ; 7 uses
  %min.iters.check69 = icmp samesign ugt i64 %indvars.iv69.i, 1995
...
.lr.ph.i.preheader:                               ; preds = %.lr.ph23.i.i, %middle.block80
  %scevgep58 = getelementptr i8, ptr %i.ap, i64 16000
  %min.iters.check = icmp ult i64 %i.an, 4
  %n.vec = and i64 %i.an, -4                      ; 3 uses
  %cmp.n = icmp eq i64 %i.an, %n.vec
  %i.bx = and i64 %indvars.iv69.i, 1
  %lcmp.mod121.not.not = icmp eq i64 %i.bx, 0
  br label %.lr.ph.i
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %daxpy.exit.i
  ...
  %i.by = getelementptr inbounds nuw [8 x i8], ptr %i.f, i64 %indvars.iv66.i
  %i.bz = load ptr, ptr %i.by, align 8, !tbaa !12 ; 4 uses
  %i.ca = getelementptr inbounds [8 x i8], ptr %i.bz, i64 %i.bj ; 2 uses
  %i.cb = load double, ptr %i.ca, align 8, !tbaa !10 ; 6 uses
  br i1 %.not.i, label %bb.i, label %bb.h

bb.h:                                             ; preds = %.lr.ph.i
  %i.cc = getelementptr inbounds nuw [8 x i8], ptr %i.bz, i64 %indvars.iv69.i ; 2 uses
  %i.cd = load double, ptr %i.cc, align 8, !tbaa !10
  store double %i.cd, ptr %i.ca, align 8, !tbaa !10
  store double %i.cb, ptr %i.cc, align 8, !tbaa !10
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %.lr.ph.i
  %i.ce = fcmp une double %i.cb, 0.000000e+00
  br i1 %i.ce, label %bb.j, label %daxpy.exit.i

bb.j:                                             ; preds = %bb.i
  %invariant.gep63.i.i = getelementptr [8 x i8], ptr %i.bz, i64 %indvars.iv.next70.i ; 5 uses
  br i1 %min.iters.check, label %.lr.ph.i.i.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %bb.j
  %scevgep = getelementptr i8, ptr %i.bz, i64 16000
...
vector.body60:                                    ; preds = %vector.body60, %vector.ph59
  ...
  %i.cf = getelementptr [8 x i8], ptr %invariant.gep32.i.i, i64 %index61 ; 2 uses
  %i.cg = getelementptr i8, ptr %i.cf, i64 16
  %wide.load62 = load <2 x double>, ptr %i.cf, align 8, !tbaa !10, !alias.scope !80
  %wide.load63 = load <2 x double>, ptr %i.cg, align 8, !tbaa !10, !alias.scope !80
  %i.ch = getelementptr [8 x i8], ptr %invariant.gep63.i.i, i64 %index61 ; 3 uses
  %i.ci = getelementptr i8, ptr %i.ch, i64 16     ; 2 uses
  %wide.load64 = load <2 x double>, ptr %i.ch, align 8, !tbaa !10, !alias.scope !83, !noalias !80
  %wide.load65 = load <2 x double>, ptr %i.ci, align 8, !tbaa !10, !alias.scope !83, !noalias !80
  %i.cj = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat, <2 x double> %wide.load62, <2 x double> %wide.load64)
  %i.ck = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat, <2 x double> %wide.load63, <2 x double> %wide.load65)
  store <2 x double> %i.cj, ptr %i.ch, align 8, !tbaa !10, !alias.scope !83, !noalias !80
  store <2 x double> %i.ck, ptr %i.ci, align 8, !tbaa !10, !alias.scope !83, !noalias !80
  %index.next66 = add nuw i64 %index61, 4         ; 2 uses
  %i.cl = icmp eq i64 %index.next66, %n.vec
  br i1 %i.cl, label %middle.block67, label %vector.body60, !llvm.loop !85
...
.lr.ph.i.i.preheader:                             ; preds = %vector.memcheck, %bb.j, %middle.block67
  ...
  %i.cm = add i64 %indvars.iv69.i, %indvars.iv.i.i.ph
...
.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.i.i.preheader
  ...
  %i.cn = load double, ptr %gep.i.i.prol, align 8, !tbaa !10
  %gep64.i.i.prol = getelementptr [8 x i8], ptr %invariant.gep63.i.i, i64 %indvars.iv.i.i.ph ; 2 uses
  %i.co = load double, ptr %gep64.i.i.prol, align 8, !tbaa !10
  %i.cp = tail call double @llvm.fmuladd.f64(double %i.cb, double %i.cn, double %i.co)
  store double %i.cp, ptr %gep64.i.i.prol, align 8, !tbaa !10
...
.lr.ph.i.i.prol.loopexit:                         ; preds = %.lr.ph.i.i.prol, %.lr.ph.i.i.preheader
  ...
  %i.cq = icmp eq i64 %i.cm, 1998
  br i1 %i.cq, label %daxpy.exit.i, label %.lr.ph.i.i
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  %i.cr = load double, ptr %gep.i.i, align 8, !tbaa !10
  %gep64.i.i = getelementptr [8 x i8], ptr %invariant.gep63.i.i, i64 %indvars.iv.i.i ; 2 uses
  %i.cs = load double, ptr %gep64.i.i, align 8, !tbaa !10
  %i.ct = tail call double @llvm.fmuladd.f64(double %i.cb, double %i.cr, double %i.cs)
  store double %i.ct, ptr %gep64.i.i, align 8, !tbaa !10
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1 ; 2 uses
  %gep.i.i.1 = getelementptr [8 x i8], ptr %invariant.gep32.i.i, i64 %indvars.iv.next.i.i
  %i.cu = load double, ptr %gep.i.i.1, align 8, !tbaa !10
  %gep64.i.i.1 = getelementptr [8 x i8], ptr %invariant.gep63.i.i, i64 %indvars.iv.next.i.i ; 2 uses
  %i.cv = load double, ptr %gep64.i.i.1, align 8, !tbaa !10
  %i.cw = tail call double @llvm.fmuladd.f64(double %i.cb, double %i.cu, double %i.cv)
  store double %i.cw, ptr %gep64.i.i.1, align 8, !tbaa !10
...
dgefa.exit:                                       ; preds = %.loopexit.i
  %i.cx = getelementptr inbounds nuw i8, ptr %i.j, i64 7996
  store i32 1999, ptr %i.cx, align 4, !tbaa !4
  br label %bb.k

bb.k:                                             ; preds = %daxpy.exit.i34, %dgefa.exit
  %indvars.iv.i31 = phi i64 [ 0, %dgefa.exit ], [ %indvars.iv.next.i33, %daxpy.exit.i34 ] ; 7 uses
  %i.cy = getelementptr inbounds nuw [4 x i8], ptr %i.j, i64 %indvars.iv.i31
  %i.cz = load i32, ptr %i.cy, align 4, !tbaa !4  ; 2 uses
  %i.da = sext i32 %i.cz to i64
  %i.db = getelementptr inbounds [8 x i8], ptr %i.i, i64 %i.da ; 2 uses
  %i.dc = load double, ptr %i.db, align 8, !tbaa !10 ; 4 uses
  %i.dd = zext i32 %i.cz to i64
  %.not.i32 = icmp eq i64 %indvars.iv.i31, %i.dd
  br i1 %.not.i32, label %bb.m, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.de = getelementptr inbounds nuw [8 x i8], ptr %i.i, i64 %indvars.iv.i31 ; 2 uses
  %i.df = load double, ptr %i.de, align 8, !tbaa !10
  store double %i.df, ptr %i.db, align 8, !tbaa !10
  store double %i.dc, ptr %i.de, align 8, !tbaa !10
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %bb.k
  %indvars.iv.next.i33 = add nuw nsw i64 %indvars.iv.i31, 1 ; 4 uses
  %i.dg = fcmp une double %i.dc, 0.000000e+00
  br i1 %i.dg, label %bb.n, label %daxpy.exit.i34

bb.n:                                             ; preds = %bb.m
  %i.dh = getelementptr inbounds nuw [8 x i8], ptr %i.f, i64 %indvars.iv.i31
  %i.di = load ptr, ptr %i.dh, align 8, !tbaa !12
  %i.dj = sub nuw nsw i64 1999, %indvars.iv.i31   ; 3 uses
  %invariant.gep.i.i = getelementptr [8 x i8], ptr %i.di, i64 %indvars.iv.next.i33 ; 2 uses
...
vector.ph85:                                      ; preds = %bb.n
  %n.vec87 = and i64 %i.dj, 2044                  ; 3 uses
  %broadcast.splatinsert88 = insertelement <2 x double> poison, double %i.dc, i64 0
  %broadcast.splat89 = shufflevector <2 x double> %broadcast.splatinsert88, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  br label %vector.body90

vector.body90:                                    ; preds = %vector.body90, %vector.ph85
  %index91 = phi i64 [ 0, %vector.ph85 ], [ %index.next96, %vector.body90 ] ; 3 uses
  %i.dk = getelementptr [8 x i8], ptr %invariant.gep.i.i, i64 %index91 ; 2 uses
  ...
  %i.dm = getelementptr [8 x i8], ptr %invariant.gep63.i.i37, i64 %index91 ; 3 uses
  %i.dn = getelementptr i8, ptr %i.dm, i64 16     ; 2 uses
  %wide.load94 = load <2 x double>, ptr %i.dm, align 8, !tbaa !10
  %wide.load95 = load <2 x double>, ptr %i.dn, align 8, !tbaa !10
  %i.do = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat89, <2 x double> %wide.load92, <2 x double> %wide.load94)
  %i.dp = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat89, <2 x double> %wide.load93, <2 x double> %wide.load95)
  store <2 x double> %i.do, ptr %i.dm, align 8, !tbaa !10
  store <2 x double> %i.dp, ptr %i.dn, align 8, !tbaa !10
  %index.next96 = add nuw i64 %index91, 4         ; 2 uses
  %i.dq = icmp eq i64 %index.next96, %n.vec87
  br i1 %i.dq, label %middle.block97, label %vector.body90, !llvm.loop !87

middle.block97:                                   ; preds = %vector.body90
  %cmp.n98 = icmp eq i64 %i.dj, %n.vec87
...
.lr.ph.i.i38:                                     ; preds = %.lr.ph.i.i38.preheader, %.lr.ph.i.i38
  ...
  %i.dr = load double, ptr %gep.i.i40, align 8, !tbaa !10
  %gep64.i.i41 = getelementptr [8 x i8], ptr %invariant.gep63.i.i37, i64 %indvars.iv.i.i39 ; 2 uses
  %i.ds = load double, ptr %gep64.i.i41, align 8, !tbaa !10
  %i.dt = tail call double @llvm.fmuladd.f64(double %i.dc, double %i.dr, double %i.ds)
  store double %i.dt, ptr %gep64.i.i41, align 8, !tbaa !10
  %indvars.iv.next.i.i42 = add nuw nsw i64 %indvars.iv.i.i39, 1 ; 2 uses
  %exitcond.not.i.i43 = icmp eq i64 %indvars.iv.next.i.i42, %i.dj
...
.preheader.i36:                                   ; preds = %daxpy.exit.i34, %daxpy.exit48.i
  ...
  %3 = sub nsw i64 1999, %indvars.iv52.i          ; 3 uses
  %indvars.iv.next53.i = add nuw nsw i64 %indvars.iv52.i, 1 ; 2 uses
  %i.du = sub nuw nsw i64 1999, %indvars.iv52.i   ; 4 uses
  %i.dv = getelementptr inbounds nuw [8 x i8], ptr %i.f, i64 %i.du
  %i.dw = load ptr, ptr %i.dv, align 8, !tbaa !12 ; 3 uses
  %i.dx = getelementptr inbounds nuw [8 x i8], ptr %i.dw, i64 %i.du
  %i.dy = load double, ptr %i.dx, align 8, !tbaa !10
  %i.dz = getelementptr inbounds nuw [8 x i8], ptr %i.i, i64 %i.du ; 2 uses
  %i.ea = load double, ptr %i.dz, align 8, !tbaa !10
  %i.eb = fdiv double %i.ea, %i.dy                ; 3 uses
  store double %i.eb, ptr %i.dz, align 8, !tbaa !10
  %i.ec = fneg double %i.eb                       ; 2 uses
  %i.ed = icmp ne i64 %indvars.iv52.i, 1999
  %i.ee = fcmp une double %i.eb, 0.000000e+00
  %or.cond.i38.i = and i1 %i.ed, %i.ee
  br i1 %or.cond.i38.i, label %.lr.ph.i42.i.preheader, label %daxpy.exit48.i

.lr.ph.i42.i.preheader:                           ; preds = %.preheader.i36
  %min.iters.check101 = icmp ult i64 %3, 4
  br i1 %min.iters.check101, label %.lr.ph.i42.i.preheader117, label %vector.ph102

vector.ph102:                                     ; preds = %.lr.ph.i42.i.preheader
  %n.vec104 = and i64 %3, -4                      ; 3 uses
  %broadcast.splatinsert105 = insertelement <2 x double> poison, double %i.ec, i64 0
...
vector.body107:                                   ; preds = %vector.body107, %vector.ph102
  ...
  %i.ef = getelementptr [8 x i8], ptr %i.dw, i64 %index108 ; 2 uses
  %i.eg = getelementptr i8, ptr %i.ef, i64 16
  %wide.load109 = load <2 x double>, ptr %i.ef, align 8, !tbaa !10
  %wide.load110 = load <2 x double>, ptr %i.eg, align 8, !tbaa !10
  %i.eh = getelementptr [8 x i8], ptr %i.i, i64 %index108 ; 3 uses
  %i.ei = getelementptr i8, ptr %i.eh, i64 16     ; 2 uses
  %wide.load111 = load <2 x double>, ptr %i.eh, align 8, !tbaa !10
  %wide.load112 = load <2 x double>, ptr %i.ei, align 8, !tbaa !10
  %i.ej = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat106, <2 x double> %wide.load109, <2 x double> %wide.load111)
  %i.ek = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat106, <2 x double> %wide.load110, <2 x double> %wide.load112)
  store <2 x double> %i.ej, ptr %i.eh, align 8, !tbaa !10
  store <2 x double> %i.ek, ptr %i.ei, align 8, !tbaa !10
  %index.next113 = add nuw i64 %index108, 4       ; 2 uses
  %i.el = icmp eq i64 %index.next113, %n.vec104
  br i1 %i.el, label %middle.block114, label %vector.body107, !llvm.loop !89

middle.block114:                                  ; preds = %vector.body107
  %cmp.n115 = icmp eq i64 %3, %n.vec104
...
.lr.ph.i42.i:                                     ; preds = %.lr.ph.i42.i.preheader117, %.lr.ph.i42.i
  ...
  %gep.i44.i = getelementptr [8 x i8], ptr %i.dw, i64 %indvars.iv.i43.i
  %i.em = load double, ptr %gep.i44.i, align 8, !tbaa !10
  %gep64.i45.i = getelementptr [8 x i8], ptr %i.i, i64 %indvars.iv.i43.i ; 2 uses
  %i.en = load double, ptr %gep64.i45.i, align 8, !tbaa !10
  %i.eo = tail call double @llvm.fmuladd.f64(double %i.ec, double %i.em, double %i.en)
  store double %i.eo, ptr %gep64.i45.i, align 8, !tbaa !10
  %indvars.iv.next.i46.i = add nuw nsw i64 %indvars.iv.i43.i, 1 ; 2 uses
  %exitcond.not.i47.i = icmp eq i64 %indvars.iv.next.i46.i, %i.du
...
bb.o:                                             ; preds = %dgesl.exit, %bb.o
  ...
  %i.ep = getelementptr inbounds nuw [8 x i8], ptr %i.f, i64 %indvars.iv48
  %i.eq = load ptr, ptr %i.ep, align 8, !tbaa !12
  tail call void @free(ptr noundef %i.eq) #14
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.er = load ptr, ptr @stdout, align 8, !tbaa !92
  %i.es = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.er, ptr noundef nonnull %.026, double noundef 0.000000e+00) #14 ; 0 uses
...
!47 = distinct !{!47, !16, !24, !25}
!48 = distinct !{!48, !16, !25, !24}
!49 = !{!50}
!50 = distinct !{!50, !51}
!51 = distinct !{!51, !"LVerDomain"}
!52 = !{!53}
!53 = distinct !{!53, !51}
!54 = distinct !{!54, !16, !24, !25}
!55 = distinct !{!55, !16, !24}
!56 = distinct !{!56, !16}
!57 = distinct !{!57, !16}
!58 = !{!59}
!59 = distinct !{!59, !60}
...
!61 = !{!62}
!62 = distinct !{!62, !60}
!63 = distinct !{!63, !16, !24, !25}
!64 = distinct !{!64, !16, !24}
!65 = distinct !{!65, !16}
!66 = !{!67}
!67 = distinct !{!67, !68}
...
!69 = !{!70}
!70 = distinct !{!70, !68}
!71 = distinct !{!71, !16, !24, !25}
!72 = distinct !{!72, !16, !24}
!73 = distinct !{!73, !16}
!74 = !{!75, !75, i64 0}
!75 = !{!"p1 omnipotent char", !14, i64 0}
!76 = distinct !{!76, !16}
!77 = distinct !{!77, !16, !24, !25}
!78 = distinct !{!78, !16, !24, !25}
!79 = distinct !{!79, !16, !25, !24}
!80 = !{!81}
!81 = distinct !{!81, !82}
!82 = distinct !{!82, !"LVerDomain"}
!83 = !{!84}
!84 = distinct !{!84, !82}
!85 = distinct !{!85, !16, !24, !25}
!86 = distinct !{!86, !16, !24}
!87 = distinct !{!87, !16, !24, !25}
!88 = distinct !{!88, !16, !25, !24}
!89 = distinct !{!89, !16, !24, !25}
!90 = distinct !{!90, !16, !25, !24}
!91 = distinct !{!91, !16}
!92 = !{!93, !93, i64 0}
!93 = !{!"p1 _ZTS8_IO_FILE", !14, i64 0}
end_hunk_0
