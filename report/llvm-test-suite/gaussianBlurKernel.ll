...
.preheader68.preheader:                           ; preds = %.preheader69
  ...
  %wide.trip.count100 = zext nneg i32 %i.bp to i64
...
.preheader67:                                     ; preds = %.preheader68, %.preheader67
  ...
  %i.ec = add nuw nsw i64 %indvars.iv93, 1        ; 2 uses
  %i.ed = getelementptr [4 x i8], ptr %i.de, i64 %indvars.iv93
  ...
  %i.ey = getelementptr inbounds nuw [4 x i8], ptr %i.de, i64 %indvars.iv93
  ...
  %i.fe = getelementptr [4 x i8], ptr %i.dh, i64 %indvars.iv93
  ...
  %i.fz = getelementptr inbounds nuw [4 x i8], ptr %i.dh, i64 %indvars.iv93
  ...
  %i.gf = getelementptr [4 x i8], ptr %i.dk, i64 %indvars.iv93
  ...
  %i.ha = getelementptr inbounds nuw [4 x i8], ptr %i.dk, i64 %indvars.iv93
  ...
  %i.hg = getelementptr [4 x i8], ptr %i.dn, i64 %indvars.iv93
  ...
  %i.ib = getelementptr inbounds nuw [4 x i8], ptr %i.dn, i64 %indvars.iv93
  ...
  %i.ih = getelementptr [4 x i8], ptr %i.dp, i64 %indvars.iv93
  ...
  %i.jc = getelementptr inbounds nuw [4 x i8], ptr %i.dp, i64 %indvars.iv93
  ...
  %i.ji = getelementptr [4 x i8], ptr %i.ds, i64 %indvars.iv93
  ...
  %i.kd = getelementptr inbounds nuw [4 x i8], ptr %i.ds, i64 %indvars.iv93
  ...
  %i.kj = getelementptr [4 x i8], ptr %i.dv, i64 %indvars.iv93
  ...
  %i.le = getelementptr inbounds nuw [4 x i8], ptr %i.dv, i64 %indvars.iv93
  ...
  %i.lk = getelementptr [4 x i8], ptr %i.dy, i64 %indvars.iv93
  ...
  %i.mf = getelementptr inbounds nuw [4 x i8], ptr %i.dy, i64 %indvars.iv93
  ...
  %i.ml = getelementptr [4 x i8], ptr %i.eb, i64 %indvars.iv93
  ...
  %i.ng = getelementptr inbounds nuw [4 x i8], ptr %i.eb, i64 %indvars.iv93
  ...
  %i.no = getelementptr inbounds nuw [4 x i8], ptr %i.db, i64 %indvars.iv93
  store i32 %i.nn, ptr %i.no, align 4, !tbaa !4
  %exitcond96.not = icmp eq i64 %i.ec, %wide.trip.count
  br i1 %exitcond96.not, label %._crit_edge, label %.preheader67, !llvm.loop !12
