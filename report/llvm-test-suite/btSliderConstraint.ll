...
_ZN18btSliderConstraint13testAngLimitsEv.exit:    ; preds = %_ZN18btSliderConstraint13testLinLimitsEv.exit, %bb.m, %.sink.split.i
  ...
  %5 = load float, ptr %i.ye, align 8, !tbaa !8
  %6 = load float, ptr %i.yf, align 8, !tbaa !8
  ...
  %i.zg = insertelement <4 x float> %7, float %i.zd, i64 1
  ...
  %8 = insertelement <4 x float> poison, float %5, i64 0
  %i.zm = insertelement <4 x float> %8, float %i.za, i64 1
...
begin_hunk_1_@_ZN18btSliderConstraint19calculateTransformsERK11btTransformS2_:bb.a
  ...
  %3 = load float, ptr %i.gv, align 4, !tbaa !8   ; 3 uses
  %.sroa.0.0.vec.insert.i = insertelement <2 x float> poison, float %3, i64 0 ; 2 uses
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %i.ih = tail call float @llvm.fmuladd.f32(float %3, float %.sink461, float %i.ig)
  ...
  %6 = insertelement <2 x float> %.sroa.0.0.vec.insert.i, float %5, i64 1
  %i.jb = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ja, <2 x float> %6, <2 x float> %i.iz)
  ...
  %i.jl = tail call float @llvm.fmuladd.f32(float %.sink461, float %8, float %i.jk)
...
_ZN18btSliderConstraint13testAngLimitsEv.exit:    ; preds = %_ZN18btSliderConstraint13testLinLimitsEv.exit, %bb.k, %.sink.split.i
  ...
  %8 = load float, ptr %i.bx, align 8, !tbaa !8   ; 6 uses
  %.sroa.0.0.vec.insert.i321 = insertelement <2 x float> poison, float %8, i64 0
  ...
  %9 = load float, ptr %i.cc, align 4, !tbaa !8   ; 6 uses
  %.sroa.0.0.vec.insert.i326 = insertelement <2 x float> poison, float %9, i64 0
  ...
  store float %8, ptr %i.ci, align 4, !tbaa !8
  ...
  store float %9, ptr %i.cm, align 4, !tbaa !8
  ...
  %i.fa = tail call float @llvm.fmuladd.f32(float %i.es, float %8, float %i.ez)
  ...
  %i.fe = tail call float @llvm.fmuladd.f32(float %i.es, float %9, float %i.fd)
  ...
  %10 = insertelement <2 x float> poison, float %i.cb, i64 0
  %i.fp = insertelement <2 x float> %10, float %8, i64 1
  ...
  %11 = insertelement <2 x float> poison, float %i.cg, i64 0
  %i.gc = insertelement <2 x float> %11, float %9, i64 1
  ...
  %i.hq = tail call float @llvm.fmuladd.f32(float %8, float %i.gy, float %i.hp)
  ...
  %i.hv = tail call float @llvm.fmuladd.f32(float %9, float %i.gy, float %i.hu)
