...
bb.a:
  ...
  br i1 %i.b, label %.preheader20.preheader, label %._crit_edge25.split
...
.preheader20:                                     ; preds = %.preheader20.preheader, %._crit_edge23
  %indvars.iv32.a = phi i64 [ %i.j, %.preheader20.preheader ], [ %indvars.iv.next33, %._crit_edge23 ] ; 3 uses
  %i.l = getelementptr inbounds [4096 x i8], ptr @a, i64 %indvars.iv32.a
...
bb.b:                                             ; preds = %bb.b, %.preheader
  ...
  %i.r = load float, ptr %gep, align 4, !tbaa !8
  %i.s = tail call float @llvm.fmuladd.f32(float %i.q, float %i.r, float %i.o) ; 2 uses
  %indvars.iv.next = add nsw i64 %indvars.iv, 1   ; 2 uses
  %i.t = icmp slt i64 %indvars.iv.next, %i.g
  br i1 %i.t, label %bb.b, label %._crit_edge.a, !llvm.loop !13

._crit_edge.a:                                    ; preds = %bb.b
  store float %i.s, ptr %i.n, align 4, !tbaa !8
  %indvars.iv.next30 = add nsw i64 %indvars.iv29, 1 ; 2 uses
  %i.u = icmp slt i64 %indvars.iv.next30, %i.i
  br i1 %i.u, label %.preheader, label %._crit_edge23, !llvm.loop !14

._crit_edge23:                                    ; preds = %._crit_edge.a
  %indvars.iv.next33 = add nsw i64 %indvars.iv32.a, 1 ; 2 uses
  %i.v = icmp slt i64 %indvars.iv.next33, %i.k
  br i1 %i.v, label %.preheader20, label %._crit_edge25.split, !llvm.loop !15

._crit_edge25.split:                              ; preds = %._crit_edge23, %bb.a
  ret void
}
...
bb.a:
  ...
  %i.b = icmp sgt i32 %i.a, 0
  br i1 %i.b, label %.preheader11.lr.ph, label %._crit_edge17.split

.preheader11.lr.ph:                               ; preds = %bb.a
  %i.c = load i32, ptr @BLOCK, align 4            ; 2 uses
  %i.d = icmp sgt i32 %i.c, 0
  br i1 %i.d, label %.preheader11.preheader, label %._crit_edge17.split

.preheader11.preheader:                           ; preds = %.preheader11.lr.ph
  %i.e = zext nneg i32 %i.c to i64                ; 3 uses
  br label %.preheader11

.preheader11:                                     ; preds = %.preheader11.preheader, %._crit_edge14
  %indvars.iv23 = phi i64 [ 0, %.preheader11.preheader ], [ %indvars.iv.next24, %._crit_edge14 ] ; 2 uses
...
.preheader20.i:                                   ; preds = %._crit_edge23.i, %.preheader20.preheader.i
  %indvars.iv32.i = phi i64 [ %indvars.iv23, %.preheader20.preheader.i ], [ %indvars.iv.next33.i, %._crit_edge23.i ] ; 3 uses
  %i.f = getelementptr inbounds nuw [4096 x i8], ptr @a, i64 %indvars.iv32.i
  %i.g = getelementptr inbounds nuw [4096 x i8], ptr @c, i64 %indvars.iv32.i
...
bb.b:                                             ; preds = %bb.b, %.preheader.i
  ...
  %i.l = load float, ptr %gep.i, align 4, !tbaa !8
  %i.m = tail call float @llvm.fmuladd.f32(float %i.k, float %i.l, float %i.i) ; 2 uses
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %i.n = icmp samesign ult i64 %indvars.iv.next.i, %indvars.iv.next
  br i1 %i.n, label %bb.b, label %._crit_edge.i, !llvm.loop !13

._crit_edge.i:                                    ; preds = %bb.b
  store float %i.m, ptr %i.h, align 4, !tbaa !8
  %indvars.iv.next30.i = add nuw nsw i64 %indvars.iv29.i, 1 ; 2 uses
  %i.o = icmp samesign ult i64 %indvars.iv.next30.i, %indvars.iv.next21
  br i1 %i.o, label %.preheader.i, label %._crit_edge23.i, !llvm.loop !14

._crit_edge23.i:                                  ; preds = %._crit_edge.i
  %indvars.iv.next33.i = add nuw nsw i64 %indvars.iv32.i, 1 ; 2 uses
  %i.p = icmp samesign ult i64 %indvars.iv.next33.i, %indvars.iv.next24
  br i1 %i.p, label %.preheader20.i, label %mm_inner.exit.loopexit, !llvm.loop !15

mm_inner.exit.loopexit:                           ; preds = %._crit_edge23.i
  %i.q = trunc nuw i64 %indvars.iv.next to i32
  %i.r = icmp sgt i32 %i.a, %i.q
  br i1 %i.r, label %.preheader20.preheader.i, label %._crit_edge.a, !llvm.loop !16

._crit_edge.a:                                    ; preds = %mm_inner.exit.loopexit
  %i.s = trunc nuw i64 %indvars.iv.next21 to i32
  %i.t = icmp sgt i32 %i.a, %i.s
  br i1 %i.t, label %.preheader, label %._crit_edge14, !llvm.loop !17

._crit_edge14:                                    ; preds = %._crit_edge.a
  %i.u = trunc nuw i64 %indvars.iv.next24 to i32
  %i.v = icmp sgt i32 %i.a, %i.u
  br i1 %i.v, label %.preheader11, label %._crit_edge17.split, !llvm.loop !18

._crit_edge17.split:                              ; preds = %._crit_edge14, %.preheader11.lr.ph, %bb.a
  ret void
}
