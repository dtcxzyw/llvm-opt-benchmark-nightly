...
begin_hunk_0_@_ZN33btConvexConcaveCollisionAlgorithm21calculateTimeOfImpactEP17btCollisionObjectS1_RK16btDispatcherInfoP16btManifoldResult:bb.a
bb.b:                                             ; preds = %bb.a
  ...
  %14 = load float, ptr %i.ae, align 4, !tbaa !57, !noalias !95 ; 7 uses
  %15 = load float, ptr %i.af, align 4, !tbaa !57, !noalias !95 ; 7 uses
  %16 = load float, ptr %i.ag, align 4, !tbaa !57, !noalias !95 ; 7 uses
  %i.ah = getelementptr inbounds nuw i8, ptr %i.ad, i64 56
  %i.ai = load float, ptr %i.ah, align 4, !tbaa !57, !noalias !100
  %i.aj = fneg float %i.ai
  %i.ak = getelementptr inbounds nuw i8, ptr %i.ad, i64 60
  %i.al = load float, ptr %i.ak, align 4, !tbaa !57, !noalias !100
  ...
  %i.aq = load float, ptr %i.ab, align 4, !tbaa !57, !noalias !101 ; 3 uses
  %i.ar = getelementptr inbounds nuw i8, ptr %i.d, i64 24
  %i.as = load float, ptr %i.ar, align 4, !tbaa !57, !noalias !101 ; 3 uses
  %i.at = getelementptr inbounds nuw i8, ptr %i.d, i64 40
  %i.au = load float, ptr %i.at, align 4, !tbaa !57, !noalias !101 ; 3 uses
  %i.av = getelementptr inbounds nuw i8, ptr %i.d, i64 12
  %i.aw = load float, ptr %i.av, align 4, !tbaa !57, !noalias !101 ; 3 uses
  %i.ax = getelementptr inbounds nuw i8, ptr %i.d, i64 28
  %i.ay = load float, ptr %i.ax, align 4, !tbaa !57, !noalias !101 ; 3 uses
  %i.az = getelementptr inbounds nuw i8, ptr %i.d, i64 44
  %i.ba = load float, ptr %i.az, align 4, !tbaa !57, !noalias !101 ; 3 uses
  %i.bb = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  %i.bc = load float, ptr %i.bb, align 4, !tbaa !57, !noalias !101 ; 3 uses
  %i.bd = getelementptr inbounds nuw i8, ptr %i.d, i64 32
  %i.be = load float, ptr %i.bd, align 4, !tbaa !57, !noalias !101 ; 3 uses
  %i.bf = getelementptr inbounds nuw i8, ptr %i.d, i64 48
  %i.bg = load float, ptr %i.bf, align 4, !tbaa !57, !noalias !101 ; 3 uses
  ...
  %i.bh = load float, ptr %i.ac, align 4, !tbaa !57, !noalias !106 ; 3 uses
  %i.bi = getelementptr inbounds nuw i8, ptr %i.d, i64 88
  %i.bj = load float, ptr %i.bi, align 4, !tbaa !57, !noalias !106 ; 3 uses
  %i.bk = getelementptr inbounds nuw i8, ptr %i.d, i64 104
  %i.bl = load float, ptr %i.bk, align 4, !tbaa !57, !noalias !106 ; 3 uses
  ...
  %i.bt = load float, ptr %i.bs, align 4, !tbaa !57, !noalias !106 ; 3 uses
  %i.bu = getelementptr inbounds nuw i8, ptr %i.d, i64 96
  %i.bv = load float, ptr %i.bu, align 4, !tbaa !57, !noalias !106 ; 3 uses
  %i.bw = getelementptr inbounds nuw i8, ptr %i.d, i64 112
  %i.bx = load float, ptr %i.bw, align 4, !tbaa !57, !noalias !106 ; 3 uses
  ...
  %32 = load <2 x float>, ptr %8, align 4, !tbaa !57, !noalias !95 ; 2 uses
  %33 = load float, ptr %11, align 4, !tbaa !57, !noalias !95 ; 6 uses
  %34 = load <2 x float>, ptr %9, align 4, !tbaa !57, !noalias !95 ; 2 uses
  %35 = load float, ptr %12, align 4, !tbaa !57, !noalias !95 ; 6 uses
  %36 = load <2 x float>, ptr %10, align 4, !tbaa !57, !noalias !95 ; 2 uses
  %37 = load float, ptr %13, align 4, !tbaa !57, !noalias !95 ; 6 uses
...
begin_hunk_1_@_ZN33btConvexConcaveCollisionAlgorithm21calculateTimeOfImpactEP17btCollisionObjectS1_RK16btDispatcherInfoP16btManifoldResult:bb.a
  ...
  %i.cv = load <2 x float>, ptr %i.h, align 4, !tbaa !57, !noalias !111 ; 3 uses
...
end_hunk_1
begin_hunk_2_@_ZN33btConvexConcaveCollisionAlgorithm21calculateTimeOfImpactEP17btCollisionObjectS1_RK16btDispatcherInfoP16btManifoldResult:bb.a
...
end_hunk_2
begin_hunk_3_@_ZN33btConvexConcaveCollisionAlgorithm21calculateTimeOfImpactEP17btCollisionObjectS1_RK16btDispatcherInfoP16btManifoldResult:bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #13
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVZN33btConvexConcaveCollisionAlgorithm21calculateTimeOfImpactEP17btCollisionObjectS1_RK16btDispatcherInfoP16btManifoldResultE31LocalTriangleSphereCastCallback, i64 16), ptr %7, align 8, !tbaa !8
  ...
  store float 0.000000e+00, ptr %.sroa.765.0..sroa_idx, align 4, !tbaa !67
  ...
  store float 0.000000e+00, ptr %.sroa.1269.16..sroa_idx, align 4, !tbaa !67
  ...
  store float 0.000000e+00, ptr %.sroa.1773.32..sroa_idx, align 4, !tbaa !67
  %i.gf = getelementptr inbounds nuw i8, ptr %7, i64 56
end_hunk_3
begin_hunk_4_@_ZN33btConvexConcaveCollisionAlgorithm21calculateTimeOfImpactEP17btCollisionObjectS1_RK16btDispatcherInfoP16btManifoldResult:bb.a
  %.sroa.22.48..sroa_idx79 = getelementptr inbounds nuw i8, ptr %7, i64 64
  store <2 x float> %i.dy, ptr %.sroa.22.48..sroa_idx79, align 8, !tbaa !67
  ...
  store float 0.000000e+00, ptr %.sroa.7.0..sroa_idx, align 4, !tbaa !67
  ...
  store float 0.000000e+00, ptr %.sroa.12.16..sroa_idx, align 4, !tbaa !67
  ...
  store float 0.000000e+00, ptr %.sroa.17.32..sroa_idx, align 4, !tbaa !67
