...
bb.b:                                             ; preds = %bb.a
  ...
  %8 = load float, ptr %i.bw, align 4, !tbaa !57, !noalias !103 ; 3 uses
  %i.bx = load float, ptr %i.ae, align 4, !tbaa !57, !noalias !108 ; 6 uses
  %9 = load <3 x float>, ptr %i.ae, align 4, !tbaa !57, !noalias !108 ; 3 uses
  %10 = shufflevector <3 x float> %9, <3 x float> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 2> ; 3 uses
  %11 = load float, ptr %i.af, align 4, !tbaa !57, !noalias !108 ; 6 uses
  %12 = load <3 x float>, ptr %i.af, align 4, !tbaa !57, !noalias !108 ; 3 uses
  %13 = shufflevector <3 x float> %12, <3 x float> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 2> ; 3 uses
  %14 = load float, ptr %i.ag, align 4, !tbaa !57, !noalias !108 ; 6 uses
  %15 = load <3 x float>, ptr %i.ag, align 4, !tbaa !57, !noalias !108 ; 3 uses
