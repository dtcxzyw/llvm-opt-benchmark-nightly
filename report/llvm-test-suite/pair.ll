...
begin_hunk_0_@set_pair1:bb.a
  ...
  %invariant.op = add i32 %i.jm, %i.jo            ; 5 uses
  %.reass = sub i32 %invariant.op, %i.do          ; 3 uses
...
vector.ph343:                                     ; preds = %vector.memcheck337
  ...
  %invariant.gep372 = getelementptr [8 x i8], ptr %i.gq, i64 %i.jp
  br label %vector.body346

vector.body346:                                   ; preds = %vector.body346, %vector.ph343
  %index347 = phi i64 [ 0, %vector.ph343 ], [ %index.next351, %vector.body346 ] ; 3 uses
  %i.kg = trunc i64 %index347 to i32
  %gep373 = getelementptr [8 x i8], ptr %invariant.gep372, i64 %index347 ; 3 uses
  ...
  %i.ki = add i32 %invariant.op, %i.kg
