...
bb.b:                                             ; preds = %bb.a
  ...
  %9 = load <4 x float>, ptr %i.bh, align 8       ; 3 uses
  %i.bi = extractelement <4 x float> %9, i64 2    ; 2 uses
...
bb.c:                                             ; preds = %bb.h
  ...
  %11 = extractelement <2 x float> %13, i64 0
  br i1 %exitcond, label %.thread, label %bb.d

bb.d:                                             ; preds = %.lr.ph, %bb.c
  %i.bn = phi i32 [ 1, %.lr.ph ], [ %i.bm, %bb.c ] ; 2 uses
  %.sroa.082.0145165 = phi float [ %10, %.lr.ph ], [ %11, %bb.c ]
...
bb.g:                                             ; preds = %bb.f
  ...
  %12 = load <4 x float>, ptr %i.bh, align 8
...
bb.h:                                             ; preds = %bb.f
  ...
  %13 = load <2 x float>, ptr %i.bh, align 8      ; 2 uses
...
._crit_edge.loopexit:                             ; preds = %bb.h
  ...
  %15 = insertelement <4 x float> %14, float %.sroa.14.0.copyload102, i64 2
  %16 = insertelement <4 x float> %15, float %.sroa.17.0.copyload111, i64 3
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %bb.b
  %.sroa.082.0.lcssa = phi float [ %i.bi, %bb.b ], [ %.sroa.14.0.copyload102, %._crit_edge.loopexit ]
  %.sroa.11.0.lcssa = phi float [ 0.000000e+00, %bb.b ], [ %i.bs, %._crit_edge.loopexit ]
  %17 = phi <4 x float> [ %9, %bb.b ], [ %16, %._crit_edge.loopexit ] ; 3 uses
  %18 = extractelement <4 x float> %17, i64 1
  %19 = fmul float %i.ah, %18
  %20 = extractelement <4 x float> %17, i64 0
  %i.cz = call float @llvm.fmuladd.f32(float %20, float %i.ag, float %19)
  %i.da = call noundef float @llvm.fmuladd.f32(float %.sroa.082.0.lcssa, float %i.ai, float %i.cz)
