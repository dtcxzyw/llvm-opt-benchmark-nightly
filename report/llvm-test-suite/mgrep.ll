...
.lr.ph.i.epil.preheader:                          ; preds = %countline.exit.loopexit.unr-lcssa, %.lr.ph.preheader.i
  ...
  %lcmp.mod61 = trunc i64 %i.h to i1
...
bb.l:                                             ; preds = %bb.j
  ...
  %i.av = icmp samesign ugt i32 %i.ak, 1023
  ...
  %i.ay = zext nneg i32 %i.al to i64
  %i.az = call ptr @strncpy(ptr noundef nonnull dereferenceable(1) %i.ax, ptr noundef nonnull dereferenceable(1) %i.aj, i64 noundef %i.ay) #16 ; 0 uses
