...
define dso_local void @sort_moves(ptr noundef captures(none) %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #0 {
bb.a:
...
.preheader53.thread:                              ; preds = %bb.a
  %.not70116 = icmp eq i32 %1, %2
  br i1 %.not70116, label %._crit_edge, label %.lr.ph72.split
...
.lr.ph68.us.preheader:                            ; preds = %.lr.ph72
  ...
  %i.j = add nsw i64 %wide.trip.count97, -1       ; 2 uses
  %xtraiter = and i64 %i.j, 3                     ; 3 uses
  %i.k = add nsw i32 %.149, -2
...
.lr.ph68.us.new:                                  ; preds = %.lr.ph68.us, %.lr.ph68.us.new
  ...
  %.04366.us = phi i32 [ %spec.select.us.3, %.lr.ph68.us.new ], [ %i.m, %.lr.ph68.us ] ; 2 uses
  %niter = phi i64 [ %niter.next.3, %.lr.ph68.us.new ], [ 0, %.lr.ph68.us ]
  %i.n = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %indvars.iv94
  %i.o = load i32, ptr %i.n, align 4, !tbaa !4    ; 2 uses
  %i.p = icmp sgt i32 %i.o, %.04366.us
  %spec.select.us = tail call i32 @llvm.smax.i32(i32 %i.o, i32 %.04366.us) ; 2 uses
  %i.q = trunc nuw nsw i64 %indvars.iv94 to i32
  %spec.select52.us = select i1 %i.p, i32 %i.q, i32 %.04167.us
  %indvars.iv.next95 = add nuw nsw i64 %indvars.iv94, 1 ; 2 uses
  %i.r = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %indvars.iv.next95
  %i.s = load i32, ptr %i.r, align 4, !tbaa !4    ; 2 uses
  %i.t = icmp sgt i32 %i.s, %spec.select.us
  %spec.select.us.1 = tail call i32 @llvm.smax.i32(i32 %i.s, i32 %spec.select.us) ; 2 uses
  %i.u = trunc nuw nsw i64 %indvars.iv.next95 to i32
  %spec.select52.us.1 = select i1 %i.t, i32 %i.u, i32 %spec.select52.us
  %indvars.iv.next95.1 = add nuw nsw i64 %indvars.iv94, 2 ; 2 uses
  %i.v = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %indvars.iv.next95.1
  %i.w = load i32, ptr %i.v, align 4, !tbaa !4    ; 2 uses
  %i.x = icmp sgt i32 %i.w, %spec.select.us.1
  %spec.select.us.2 = tail call i32 @llvm.smax.i32(i32 %i.w, i32 %spec.select.us.1) ; 2 uses
  %i.y = trunc nuw nsw i64 %indvars.iv.next95.1 to i32
  %spec.select52.us.2 = select i1 %i.x, i32 %i.y, i32 %spec.select52.us.1
  %indvars.iv.next95.2 = add nuw nsw i64 %indvars.iv94, 3 ; 2 uses
  %i.z = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %indvars.iv.next95.2
  %i.aa = load i32, ptr %i.z, align 4, !tbaa !4   ; 2 uses
  %i.ab = icmp sgt i32 %i.aa, %spec.select.us.2
  %spec.select.us.3 = tail call i32 @llvm.smax.i32(i32 %i.aa, i32 %spec.select.us.2) ; 2 uses
  %i.ac = trunc nuw nsw i64 %indvars.iv.next95.2 to i32
  %spec.select52.us.3 = select i1 %i.ab, i32 %i.ac, i32 %spec.select52.us.2 ; 3 uses
...
.epil.preheader:                                  ; preds = %..preheader_crit_edge.us.unr-lcssa, %.lr.ph68.us
  ...
  %.04366.us.epil.init = phi i32 [ %i.m, %.lr.ph68.us ], [ %spec.select.us.3, %..preheader_crit_edge.us.unr-lcssa ]
...
bb.b:                                             ; preds = %bb.b, %.epil.preheader
  ...
  %i.ad = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %indvars.iv94.epil
  %i.ae = load i32, ptr %i.ad, align 4, !tbaa !4  ; 2 uses
  %i.af = icmp sgt i32 %i.ae, %.04366.us.epil
  %spec.select.us.epil = tail call i32 @llvm.smax.i32(i32 %i.ae, i32 %.04366.us.epil)
  %i.ag = trunc nuw nsw i64 %indvars.iv94.epil to i32
  %spec.select52.us.epil = select i1 %i.af, i32 %i.ag, i32 %.04167.us.epil ; 2 uses
...
bb.c:                                             ; preds = %.lr.ph, %bb.e
  ...
  %i.as = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %indvars.iv
  %i.at = load i32, ptr %i.as, align 4, !tbaa !4
  %i.au = icmp eq i32 %i.h, %i.at
  br i1 %i.au, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  %i.av = trunc nuw nsw i64 %indvars.iv to i32
  %i.aw = getelementptr inbounds nuw [3072 x i8], ptr %3, i64 %indvars.iv
  %i.ax = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %indvars.iv ; 2 uses
...
.loopexit:                                        ; preds = %.preheader54, %bb.d
  ...
  %i.bc = icmp eq i32 %.04557, %.04861
  br i1 %i.bc, label %.loopexit.thread, label %bb.h

.loopexit.thread:                                 ; preds = %bb.e, %.loopexit
  %i.bd = icmp eq i32 %.04861, 128
...
bb.g:                                             ; preds = %bb.f, %.loopexit.thread
  ...
  %i.bk = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %i.be
  store i32 1, ptr %i.bk, align 4, !tbaa !4
  %i.bl = add nsw i32 %.04861, 1
  br label %bb.h

bb.h:                                             ; preds = %.loopexit, %bb.g
  %.149 = phi i32 [ %i.bl, %bb.g ], [ %.04861, %.loopexit ] ; 4 uses
