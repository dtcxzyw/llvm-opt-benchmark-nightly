...
.preheader85.us.preheader:                        ; preds = %.preheader85.lr.ph
  ...
  %i.m = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %i.l
  %i.n = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.l
  %i.o = sub i64 %i.b, %i.a
...
.lr.ph.us.preheader112:                           ; preds = %.lr.ph.us.preheader, %middle.block
  ...
  br i1 %lcmp.mod.not.a, label %.lr.ph.us.prol.loopexit, label %.lr.ph.us.prol
...
bb.b:                                             ; preds = %bb.e, %.peel.next.a
  %indvars.iv99 = phi i64 [ 1, %.peel.next.a ], [ %indvars.iv.next100, %bb.e ] ; 5 uses
...
bb.d:                                             ; preds = %bb.b
  %i.ak = load i32, ptr %i.bg, align 4, !tbaa !4
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %exitcond103.not = icmp eq i64 %indvars.iv.next100, %i.c
  br i1 %exitcond103.not, label %._crit_edge.us, label %bb.b, !llvm.loop !14
...
.loopexit:                                        ; preds = %.lr.ph.us.prol.loopexit, %.lr.ph.us, %middle.block
  ...
  %i.bb = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %i.ba ; 3 uses
  ...
  br i1 %exitcond103.peel.not, label %._crit_edge.us, label %.peel.next.a

.peel.next.a:                                     ; preds = %.loopexit
  %i.bg = getelementptr inbounds nuw [4 x i8], ptr %i.bb, i64 %i.l
  br label %bb.b

._crit_edge.us:                                   ; preds = %bb.e, %.loopexit
