...
.preheader171:                                    ; preds = %.loopexit, %bb.d
  %.sroa.15.0 = phi i32 [ 0, %bb.d ], [ %.sroa.12.2, %.loopexit ]
  %.sroa.18.0 = phi i32 [ 0, %bb.d ], [ %.sroa.15.2, %.loopexit ]
...
.preheader172:                                    ; preds = %.lr.ph178
  ...
  %..2 = call i32 @llvm.smax.i32(i32 %.sroa.12.1, i32 %i.av)
  %i.aw = call i32 @llvm.smax.i32(i32 %.sroa.15.1, i32 %i.au)
  br label %.loopexit

.loopexit:                                        ; preds = %.preheader172, %.lr.ph178
  %.sroa.12.2 = phi i32 [ %..2, %.preheader172 ], [ %.sroa.12.1, %.lr.ph178 ] ; 2 uses
  %.sroa.15.2 = phi i32 [ %i.aw, %.preheader172 ], [ %.sroa.15.1, %.lr.ph178 ] ; 2 uses
