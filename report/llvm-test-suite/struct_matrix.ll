...
bb.b:                                             ; preds = %.lr.ph, %hypre_StructMatrixExtractPointerByIndex.exit.thread
  %indvars.iv194 = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next195, %hypre_StructMatrixExtractPointerByIndex.exit.thread ] ; 3 uses
...
hypre_StructMatrixExtractPointerByIndex.exit:     ; preds = %bb.b
  ...
  %i.u = getelementptr inbounds nuw [8 x i8], ptr %i.t, i64 %indvars.iv194
...
bb.c:                                             ; preds = %hypre_StructMatrixExtractPointerByIndex.exit
  ...
  %i.ac = getelementptr inbounds nuw [24 x i8], ptr %i.ab, i64 %indvars.iv194 ; 5 uses
...
.preheader160.lr.ph:                              ; preds = %bb.c
  ...
  %factor.op.mul175.neg = mul i32 %i.af, %.neg
...
.preheader159.us.us.us.us.us.preheader:           ; preds = %.preheader160.lr.ph
  ...
  br label %.preheader159.us.us.us.us.us

.preheader159.us.us.us.us.us:                     ; preds = %.preheader159.us.us.us.us.us.preheader, %._crit_edge165.split.us.us.us.us.us.us
  %.0132168.us.us.us.us.us = phi i32 [ %i.bj, %._crit_edge165.split.us.us.us.us.us.us ], [ 0, %.preheader159.us.us.us.us.us.preheader ]
  %.1144167.us.us.us.us.us = phi i32 [ %i.bk, %._crit_edge165.split.us.us.us.us.us.us ], [ 0, %.preheader159.us.us.us.us.us.preheader ]
  br label %.preheader.us.us.us.us.us.us

.preheader.us.us.us.us.us.us:                     ; preds = %._crit_edge.us.us.us.us.us.us, %.preheader159.us.us.us.us.us
  %.1133164.us.us.us.us.us.us = phi i32 [ %.0132168.us.us.us.us.us, %.preheader159.us.us.us.us.us ], [ %i.bh, %._crit_edge.us.us.us.us.us.us ]
  %.1142163.us.us.us.us.us.us = phi i32 [ 0, %.preheader159.us.us.us.us.us ], [ %i.bi, %._crit_edge.us.us.us.us.us.us ]
  %i.ba = sext i32 %.1133164.us.us.us.us.us.us to i64 ; 3 uses
...
scalar.ph.preheader:                              ; preds = %.preheader.us.us.us.us.us.us, %middle.block
  %indvars.iv.ph = phi i64 [ %i.ba, %.preheader.us.us.us.us.us.us ], [ %i.bb, %middle.block ]
  %.1137161.us.us.us.us.us.us.ph = phi i32 [ 0, %.preheader.us.us.us.us.us.us ], [ %i.az, %middle.block ]
  br label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %scalar.ph ], [ %indvars.iv.ph, %scalar.ph.preheader ] ; 2 uses
  %.1137161.us.us.us.us.us.us = phi i32 [ %i.bf, %scalar.ph ], [ %.1137161.us.us.us.us.us.us.ph, %scalar.ph.preheader ]
  %i.be = getelementptr inbounds [8 x i8], ptr %i.aa, i64 %indvars.iv
  store double 1.000000e+00, ptr %i.be, align 8, !tbaa !53
  %indvars.iv.next = add nsw i64 %indvars.iv, 1   ; 2 uses
  %i.bf = add nuw nsw i32 %.1137161.us.us.us.us.us.us, 1 ; 2 uses
  %exitcond.not = icmp eq i32 %i.bf, %i.ae
  br i1 %exitcond.not, label %._crit_edge.us.us.us.us.us.us, label %scalar.ph, !llvm.loop !58
...
._crit_edge.us.us.us.us.us.us:                    ; preds = %scalar.ph, %middle.block
  ...
  %i.bi = add nuw nsw i32 %.1142163.us.us.us.us.us.us, 1 ; 2 uses
  %exitcond192.not = icmp eq i32 %i.bi, %i.af
  br i1 %exitcond192.not, label %._crit_edge165.split.us.us.us.us.us.us, label %.preheader.us.us.us.us.us.us, !llvm.loop !59

._crit_edge165.split.us.us.us.us.us.us:           ; preds = %._crit_edge.us.us.us.us.us.us
  %i.bj = add nsw i32 %i.ax, %i.bh
  %i.bk = add nuw nsw i32 %.1144167.us.us.us.us.us, 1 ; 2 uses
  %exitcond193.not = icmp eq i32 %i.bk, %i.ag
  br i1 %exitcond193.not, label %hypre_StructMatrixExtractPointerByIndex.exit.thread, label %.preheader159.us.us.us.us.us, !llvm.loop !60

hypre_StructMatrixExtractPointerByIndex.exit.thread: ; preds = %._crit_edge165.split.us.us.us.us.us.us, %.preheader160.lr.ph, %bb.c, %bb.b, %hypre_StructMatrixExtractPointerByIndex.exit
  %indvars.iv.next195 = add nuw nsw i64 %indvars.iv194, 1 ; 2 uses
  %i.bl = load i32, ptr %i.i, align 8, !tbaa !29
  %i.bm = sext i32 %i.bl to i64
  %i.bn = icmp slt i64 %indvars.iv.next195, %i.bm
...
bb.c:                                             ; preds = %._crit_edge.thread, %._crit_edge
  ...
  br i1 %i.ay, label %.lr.ph599, label %._crit_edge600
...
.lr.ph599:                                        ; preds = %bb.c
  ...
  br i1 %i.bi, label %._crit_edge600, label %.lr.ph599.split.preheader

.lr.ph599.split.preheader:                        ; preds = %.lr.ph599
  %i.bj = sext i32 %2 to i64                      ; 8 uses
  %wide.trip.count = zext nneg i32 %2 to i64
  %wide.trip.count647 = zext nneg i32 %2 to i64
  %scevgep697 = getelementptr i8, ptr %4, i64 8
  %ident.check690.not = icmp eq i32 %2, 1
  %ident.check.not = icmp eq i32 %2, 1
  br label %.lr.ph599.split

.lr.ph599.splitthread-pre-split:                  ; preds = %.loopexit494
  %.pr = load ptr, ptr %i.i, align 8, !tbaa !45
  br label %.lr.ph599.split

.lr.ph599.split:                                  ; preds = %.lr.ph599.splitthread-pre-split, %.lr.ph599.split.preheader
  %i.bk = phi ptr [ %.pr, %.lr.ph599.splitthread-pre-split ], [ %i.bh, %.lr.ph599.split.preheader ] ; 2 uses
  %indvars.iv649 = phi i64 [ %indvars.iv.next650, %.lr.ph599.splitthread-pre-split ], [ 0, %.lr.ph599.split.preheader ] ; 5 uses
  %i.bl = getelementptr inbounds nuw [24 x i8], ptr %i.bk, i64 %indvars.iv649 ; 7 uses
  %i.bm = load ptr, ptr %i.an, align 8, !tbaa !45
  %i.bn = getelementptr inbounds nuw [24 x i8], ptr %i.bm, i64 %indvars.iv649 ; 6 uses
  %.not469 = icmp eq ptr %i.bk, null
  br i1 %.not469, label %.loopexit494, label %bb.d

bb.d:                                             ; preds = %.lr.ph599.split
  ...
  br i1 %i.az, label %.lr.ph587, label %.loopexit494
...
.lr.ph587:                                        ; preds = %bb.d
  ...
  br i1 %.not470, label %.lr.ph587.split.us, label %.lr.ph587.split

.lr.ph587.split.us:                               ; preds = %.lr.ph587, %.loopexit492.us
  %indvars.iv644 = phi i64 [ %indvars.iv.next645, %.loopexit492.us ], [ 0, %.lr.ph587 ] ; 2 uses
  %.sroa.0212.0585.us = phi i32 [ %i.dy, %.loopexit492.us ], [ %i.bt, %.lr.ph587 ] ; 2 uses
  %i.by = load ptr, ptr %i.ba, align 8, !tbaa !19 ; 2 uses
  %i.bz = ptrtoaddr ptr %i.by to i64
  %i.ca = load ptr, ptr %i.bb, align 8, !tbaa !20
  %i.cb = getelementptr inbounds nuw [8 x i8], ptr %i.ca, i64 %indvars.iv649
  %i.cc = load ptr, ptr %i.cb, align 8, !tbaa !21
  %i.cd = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %indvars.iv644
...
bb.f:                                             ; preds = %bb.e, %.lr.ph587.split.us
  %i.cz = phi i32 [ %i.cy, %bb.e ], [ 0, %.lr.ph587.split.us ]
  ...
  %i.dj = sub i32 %.sroa.0212.0585.us, %i.di
...
.loopexit492.us:                                  ; preds = %._crit_edge547.split.us.us.us.us.us.us.us, %.preheader489.lr.ph.us, %bb.h
  %i.dy = add nsw i32 %.sroa.0212.0585.us, 1
  ...
  br i1 %exitcond648.not, label %.loopexit494, label %.lr.ph587.split.us, !llvm.loop !69
...
.preheader489.lr.ph.us:                           ; preds = %bb.h
  ...
  %factor.op.mul568.us = mul i32 %i.ed, %i.dv
  %i.ee = select i1 %i.dc, i32 %i.de, i32 0       ; 3 uses
  %factor.op.mul567.us = mul i32 %i.dv, %i.ee
  %i.ef = mul i32 %2, %i.du
...
.preheader487.us.us.us.us.us.us.preheader:        ; preds = %.preheader489.lr.ph.us
  ...
  %or.cond.a = and i1 %min.iters.check, %ident.check.not
  %n.vec = and i64 %i.eu, 2147483644              ; 5 uses
  %i.ev = trunc nuw nsw i64 %n.vec to i32
  %cmp.n = icmp eq i64 %n.vec, %i.eu
  br label %.preheader487.us.us.us.us.us.us

.preheader487.us.us.us.us.us.us:                  ; preds = %.preheader487.us.us.us.us.us.us.preheader, %._crit_edge547.split.us.us.us.us.us.us.us
  %.3395557.us.us.us.us.us.us = phi i32 [ %i.gl, %._crit_edge547.split.us.us.us.us.us.us.us ], [ %i.dh, %.preheader487.us.us.us.us.us.us.preheader ]
  %.3403556.us.us.us.us.us.us = phi i32 [ %i.gm, %._crit_edge547.split.us.us.us.us.us.us.us ], [ %i.et, %.preheader487.us.us.us.us.us.us.preheader ]
  %.3420555.us.us.us.us.us.us = phi i32 [ %i.gn, %._crit_edge547.split.us.us.us.us.us.us.us ], [ 0, %.preheader487.us.us.us.us.us.us.preheader ]
  br label %.preheader.us.us.us.us.us.us.us

.preheader.us.us.us.us.us.us.us:                  ; preds = %._crit_edge541.us.us.us.us.us.us.us, %.preheader487.us.us.us.us.us.us
  %.4396546.us.us.us.us.us.us.us = phi i32 [ %.3395557.us.us.us.us.us.us, %.preheader487.us.us.us.us.us.us ], [ %i.gi, %._crit_edge541.us.us.us.us.us.us.us ]
  %.4404545.us.us.us.us.us.us.us = phi i32 [ %.3403556.us.us.us.us.us.us, %.preheader487.us.us.us.us.us.us ], [ %i.gj, %._crit_edge541.us.us.us.us.us.us.us ]
  %.3416544.us.us.us.us.us.us.us = phi i32 [ 0, %.preheader487.us.us.us.us.us.us ], [ %i.gk, %._crit_edge541.us.us.us.us.us.us.us ]
  %i.ew = sext i32 %.4396546.us.us.us.us.us.us.us to i64 ; 5 uses
  %i.ex = sext i32 %.4404545.us.us.us.us.us.us.us to i64 ; 5 uses
  br i1 %or.cond.a, label %vector.memcheck, label %scalar.ph.preheader

vector.memcheck:                                  ; preds = %.preheader.us.us.us.us.us.us.us
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %invariant.gep734 = getelementptr [8 x i8], ptr %4, i64 %i.ex
  %invariant.gep736 = getelementptr [8 x i8], ptr %i.cj, i64 %i.ew
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 3 uses
  %gep735 = getelementptr [8 x i8], ptr %invariant.gep734, i64 %index ; 2 uses
  %i.fg = getelementptr inbounds nuw i8, ptr %gep735, i64 16
  %wide.load = load <2 x double>, ptr %gep735, align 8, !tbaa !53
  %wide.load686 = load <2 x double>, ptr %i.fg, align 8, !tbaa !53
  %gep737 = getelementptr [8 x i8], ptr %invariant.gep736, i64 %index ; 2 uses
  %i.fh = getelementptr inbounds nuw i8, ptr %gep737, i64 16
  store <2 x double> %wide.load, ptr %gep737, align 8, !tbaa !53
  store <2 x double> %wide.load686, ptr %i.fh, align 8, !tbaa !53
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.fi = icmp eq i64 %index.next, %n.vec
  br i1 %i.fi, label %middle.block, label %vector.body, !llvm.loop !70

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %._crit_edge541.us.us.us.us.us.us.us, label %scalar.ph.preheader

scalar.ph.preheader:                              ; preds = %vector.memcheck, %.preheader.us.us.us.us.us.us.us, %middle.block
  %indvars.iv636.ph = phi i64 [ %i.ex, %vector.memcheck ], [ %i.ex, %.preheader.us.us.us.us.us.us.us ], [ %i.fe, %middle.block ] ; 2 uses
  %indvars.iv634.ph = phi i64 [ %i.ew, %vector.memcheck ], [ %i.ew, %.preheader.us.us.us.us.us.us.us ], [ %i.ff, %middle.block ] ; 2 uses
  %.3412537.us.us.us.us.us.us.us.ph = phi i32 [ 0, %vector.memcheck ], [ 0, %.preheader.us.us.us.us.us.us.us ], [ %i.ev, %middle.block ] ; 4 uses
  %i.fj = sub i32 %i.du, %.3412537.us.us.us.us.us.us.us.ph
  %xtraiter726 = and i32 %i.fj, 3                 ; 2 uses
  %lcmp.mod727.not = icmp eq i32 %xtraiter726, 0
  br i1 %lcmp.mod727.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol

scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  %indvars.iv636.prol = phi i64 [ %indvars.iv.next637.prol, %scalar.ph.prol ], [ %indvars.iv636.ph, %scalar.ph.preheader ] ; 2 uses
  %indvars.iv634.prol = phi i64 [ %indvars.iv.next635.prol, %scalar.ph.prol ], [ %indvars.iv634.ph, %scalar.ph.preheader ] ; 2 uses
  %.3412537.us.us.us.us.us.us.us.prol = phi i32 [ %i.fn, %scalar.ph.prol ], [ %.3412537.us.us.us.us.us.us.us.ph, %scalar.ph.preheader ]
  %prol.iter = phi i32 [ %prol.iter.next, %scalar.ph.prol ], [ 0, %scalar.ph.preheader ]
  %i.fk = getelementptr inbounds [8 x i8], ptr %4, i64 %indvars.iv636.prol
  %i.fl = load double, ptr %i.fk, align 8, !tbaa !53
  %i.fm = getelementptr inbounds [8 x i8], ptr %i.cj, i64 %indvars.iv634.prol
  store double %i.fl, ptr %i.fm, align 8, !tbaa !53
  %indvars.iv.next635.prol = add nsw i64 %indvars.iv634.prol, 1 ; 3 uses
  %indvars.iv.next637.prol = add nsw i64 %indvars.iv636.prol, %i.bj ; 3 uses
  %i.fn = add nuw nsw i32 %.3412537.us.us.us.us.us.us.us.prol, 1 ; 2 uses
  %prol.iter.next = add i32 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter726
  br i1 %prol.iter.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !71

scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  %indvars.iv.next635.lcssa723.unr = phi i64 [ poison, %scalar.ph.preheader ], [ %indvars.iv.next635.prol, %scalar.ph.prol ]
  %indvars.iv.next637.lcssa722.unr = phi i64 [ poison, %scalar.ph.preheader ], [ %indvars.iv.next637.prol, %scalar.ph.prol ]
  %indvars.iv636.unr = phi i64 [ %indvars.iv636.ph, %scalar.ph.preheader ], [ %indvars.iv.next637.prol, %scalar.ph.prol ]
  %indvars.iv634.unr = phi i64 [ %indvars.iv634.ph, %scalar.ph.preheader ], [ %indvars.iv.next635.prol, %scalar.ph.prol ]
  %.3412537.us.us.us.us.us.us.us.unr = phi i32 [ %.3412537.us.us.us.us.us.us.us.ph, %scalar.ph.preheader ], [ %i.fn, %scalar.ph.prol ]
  %i.fo = sub i32 %.3412537.us.us.us.us.us.us.us.ph, %i.du
  %i.fp = icmp ugt i32 %i.fo, -4
  br i1 %i.fp, label %._crit_edge541.us.us.us.us.us.us.us, label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  %indvars.iv636 = phi i64 [ %indvars.iv.next637.3, %scalar.ph ], [ %indvars.iv636.unr, %scalar.ph.prol.loopexit ] ; 2 uses
  %indvars.iv634 = phi i64 [ %indvars.iv.next635.3, %scalar.ph ], [ %indvars.iv634.unr, %scalar.ph.prol.loopexit ] ; 5 uses
  %.3412537.us.us.us.us.us.us.us = phi i32 [ %i.gf, %scalar.ph ], [ %.3412537.us.us.us.us.us.us.us.unr, %scalar.ph.prol.loopexit ]
  %i.fq = getelementptr inbounds [8 x i8], ptr %4, i64 %indvars.iv636
  %i.fr = load double, ptr %i.fq, align 8, !tbaa !53
  %i.fs = getelementptr inbounds [8 x i8], ptr %i.cj, i64 %indvars.iv634
  store double %i.fr, ptr %i.fs, align 8, !tbaa !53
  %indvars.iv.next637 = add nsw i64 %indvars.iv636, %i.bj ; 2 uses
  %i.ft = getelementptr inbounds [8 x i8], ptr %4, i64 %indvars.iv.next637
  %i.fu = load double, ptr %i.ft, align 8, !tbaa !53
  %i.fv = getelementptr [8 x i8], ptr %i.cj, i64 %indvars.iv634
  %i.fw = getelementptr i8, ptr %i.fv, i64 8
  store double %i.fu, ptr %i.fw, align 8, !tbaa !53
  %indvars.iv.next637.1 = add nsw i64 %indvars.iv.next637, %i.bj ; 2 uses
  %i.fx = getelementptr inbounds [8 x i8], ptr %4, i64 %indvars.iv.next637.1
  %i.fy = load double, ptr %i.fx, align 8, !tbaa !53
  %i.fz = getelementptr [8 x i8], ptr %i.cj, i64 %indvars.iv634
  %i.ga = getelementptr i8, ptr %i.fz, i64 16
  store double %i.fy, ptr %i.ga, align 8, !tbaa !53
  %indvars.iv.next637.2 = add nsw i64 %indvars.iv.next637.1, %i.bj ; 2 uses
  %i.gb = getelementptr inbounds [8 x i8], ptr %4, i64 %indvars.iv.next637.2
  %i.gc = load double, ptr %i.gb, align 8, !tbaa !53
  %i.gd = getelementptr [8 x i8], ptr %i.cj, i64 %indvars.iv634
  %i.ge = getelementptr i8, ptr %i.gd, i64 24
  store double %i.gc, ptr %i.ge, align 8, !tbaa !53
  %indvars.iv.next635.3 = add nsw i64 %indvars.iv634, 4 ; 2 uses
  %indvars.iv.next637.3 = add nsw i64 %indvars.iv.next637.2, %i.bj ; 2 uses
  %i.gf = add nuw nsw i32 %.3412537.us.us.us.us.us.us.us, 4 ; 2 uses
  %exitcond641.not.3 = icmp eq i32 %i.gf, %i.du
  br i1 %exitcond641.not.3, label %._crit_edge541.us.us.us.us.us.us.us, label %scalar.ph, !llvm.loop !72

._crit_edge541.us.us.us.us.us.us.us:              ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  %indvars.iv.next635.lcssa = phi i64 [ %i.ff, %middle.block ], [ %indvars.iv.next635.lcssa723.unr, %scalar.ph.prol.loopexit ], [ %indvars.iv.next635.3, %scalar.ph ]
  %indvars.iv.next637.lcssa = phi i64 [ %i.fe, %middle.block ], [ %indvars.iv.next637.lcssa722.unr, %scalar.ph.prol.loopexit ], [ %indvars.iv.next637.3, %scalar.ph ]
  %i.gg = trunc nsw i64 %indvars.iv.next637.lcssa to i32
  %i.gh = trunc nsw i64 %indvars.iv.next635.lcssa to i32
  %i.gi = add nsw i32 %i.em, %i.gh                ; 2 uses
  %i.gj = add nsw i32 %i.en, %i.gg                ; 2 uses
  %i.gk = add nuw nsw i32 %.3416544.us.us.us.us.us.us.us, 1 ; 2 uses
  %exitcond642.not = icmp eq i32 %i.gk, %i.dv
  br i1 %exitcond642.not, label %._crit_edge547.split.us.us.us.us.us.us.us, label %.preheader.us.us.us.us.us.us.us, !llvm.loop !73

._crit_edge547.split.us.us.us.us.us.us.us:        ; preds = %._crit_edge541.us.us.us.us.us.us.us
  %i.gl = add nsw i32 %i.eo, %i.gi
  %i.gm = add nsw i32 %i.ep, %i.gj
  %i.gn = add nuw nsw i32 %.3420555.us.us.us.us.us.us, 1 ; 2 uses
  %exitcond643.not = icmp eq i32 %i.gn, %i.dw
  br i1 %exitcond643.not, label %.loopexit492.us, label %.preheader487.us.us.us.us.us.us, !llvm.loop !74

.lr.ph587.split:                                  ; preds = %.lr.ph587, %.loopexit493
  %indvars.iv629 = phi i64 [ %indvars.iv.next630, %.loopexit493 ], [ 0, %.lr.ph587 ] ; 2 uses
  %.sroa.0212.0585 = phi i32 [ %i.lc, %.loopexit493 ], [ %i.bt, %.lr.ph587 ] ; 2 uses
  %i.go = load ptr, ptr %i.ba, align 8, !tbaa !19 ; 3 uses
  %i.gp = load ptr, ptr %i.bb, align 8, !tbaa !20
  %i.gq = getelementptr inbounds nuw [8 x i8], ptr %i.gp, i64 %indvars.iv649
  %i.gr = load ptr, ptr %i.gq, align 8, !tbaa !21
  %i.gs = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %indvars.iv629
...
bb.j:                                             ; preds = %.lr.ph587.split, %bb.i
  %i.ho = phi i32 [ %i.hn, %bb.i ], [ 0, %.lr.ph587.split ]
  ...
  %i.hy = sub i32 %.sroa.0212.0585, %i.hx
...
.preheader490.lr.ph:                              ; preds = %bb.l
  ...
  %factor.op.mul524 = mul i32 %i.ik, %i.is
  %i.it = mul i32 %2, %i.ij
...
.preheader488.us.us.us.us.us.preheader:           ; preds = %.preheader490.lr.ph
  ...
  %scevgep693 = getelementptr i8, ptr %i.go, i64 8
  %i.jj = add nsw i32 %i.ij, -1
  %i.jk = zext i32 %i.jj to i64
  %i.jl = shl nuw nsw i64 %i.jk, 3                ; 2 uses
  %i.jm = getelementptr i8, ptr %scevgep693, i64 %i.ji
  %scevgep694 = getelementptr i8, ptr %i.jm, i64 %i.jl
  %scevgep698 = getelementptr i8, ptr %scevgep697, i64 %i.jl
  %i.jn = zext nneg i32 %i.ij to i64              ; 2 uses
  %min.iters.check701 = icmp ugt i32 %i.ij, 3
  %or.cond717 = and i1 %min.iters.check701, %ident.check690.not
  %n.vec704 = and i64 %i.jn, 2147483644           ; 5 uses
  %i.jo = trunc nuw nsw i64 %n.vec704 to i32
  %cmp.n713 = icmp eq i64 %n.vec704, %i.jn
  br label %.preheader488.us.us.us.us.us

.preheader488.us.us.us.us.us:                     ; preds = %.preheader488.us.us.us.us.us.preheader, %._crit_edge505.split.us.us.us.us.us.us
  %.0392514.us.us.us.us.us = phi i32 [ %i.kz, %._crit_edge505.split.us.us.us.us.us.us ], [ %i.hw, %.preheader488.us.us.us.us.us.preheader ]
  %.0400513.us.us.us.us.us = phi i32 [ %i.la, %._crit_edge505.split.us.us.us.us.us.us ], [ %i.jh, %.preheader488.us.us.us.us.us.preheader ]
  %.1418512.us.us.us.us.us = phi i32 [ %i.lb, %._crit_edge505.split.us.us.us.us.us.us ], [ 0, %.preheader488.us.us.us.us.us.preheader ]
  br label %.preheader486.us.us.us.us.us.us

.preheader486.us.us.us.us.us.us:                  ; preds = %._crit_edge500.us.us.us.us.us.us, %.preheader488.us.us.us.us.us
  %.1393504.us.us.us.us.us.us = phi i32 [ %.0392514.us.us.us.us.us, %.preheader488.us.us.us.us.us ], [ %i.kw, %._crit_edge500.us.us.us.us.us.us ]
  %.1401503.us.us.us.us.us.us = phi i32 [ %.0400513.us.us.us.us.us, %.preheader488.us.us.us.us.us ], [ %i.kx, %._crit_edge500.us.us.us.us.us.us ]
  %.1414502.us.us.us.us.us.us = phi i32 [ 0, %.preheader488.us.us.us.us.us ], [ %i.ky, %._crit_edge500.us.us.us.us.us.us ]
  %i.jp = sext i32 %.1393504.us.us.us.us.us.us to i64 ; 5 uses
  %i.jq = sext i32 %.1401503.us.us.us.us.us.us to i64 ; 5 uses
  br i1 %or.cond717, label %vector.memcheck691, label %scalar.ph700.preheader

vector.memcheck691:                               ; preds = %.preheader486.us.us.us.us.us.us
  %i.jr = shl nsw i64 %i.jp, 3                    ; 2 uses
  %scevgep692 = getelementptr i8, ptr %scevgep, i64 %i.jr
  %scevgep695 = getelementptr i8, ptr %scevgep694, i64 %i.jr
  %i.js = shl nsw i64 %i.jq, 3                    ; 2 uses
  %scevgep696 = getelementptr i8, ptr %4, i64 %i.js
  %scevgep699 = getelementptr i8, ptr %scevgep698, i64 %i.js
  %bound0 = icmp ult ptr %scevgep692, %scevgep699
  %bound1 = icmp ult ptr %scevgep696, %scevgep695
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %scalar.ph700.preheader, label %vector.ph702

vector.ph702:                                     ; preds = %vector.memcheck691
  %i.jt = add nsw i64 %n.vec704, %i.jq            ; 2 uses
  %i.ju = add nsw i64 %n.vec704, %i.jp            ; 2 uses
  %invariant.gep = getelementptr [8 x i8], ptr %4, i64 %i.jq
  %invariant.gep732 = getelementptr [8 x i8], ptr %i.gy, i64 %i.jp
  br label %vector.body705

vector.body705:                                   ; preds = %vector.body705, %vector.ph702
  %index706 = phi i64 [ 0, %vector.ph702 ], [ %index.next711, %vector.body705 ] ; 3 uses
  %gep = getelementptr [8 x i8], ptr %invariant.gep, i64 %index706 ; 2 uses
  %i.jv = getelementptr inbounds nuw i8, ptr %gep, i64 16
  %wide.load707 = load <2 x double>, ptr %gep, align 8, !tbaa !53, !alias.scope !75
  %wide.load708 = load <2 x double>, ptr %i.jv, align 8, !tbaa !53, !alias.scope !75
  %gep733 = getelementptr [8 x i8], ptr %invariant.gep732, i64 %index706 ; 3 uses
  %i.jw = getelementptr inbounds nuw i8, ptr %gep733, i64 16 ; 2 uses
  %wide.load709 = load <2 x double>, ptr %gep733, align 8, !tbaa !53, !alias.scope !78, !noalias !75
  %wide.load710 = load <2 x double>, ptr %i.jw, align 8, !tbaa !53, !alias.scope !78, !noalias !75
  %i.jx = fadd <2 x double> %wide.load707, %wide.load709
  %i.jy = fadd <2 x double> %wide.load708, %wide.load710
  store <2 x double> %i.jx, ptr %gep733, align 8, !tbaa !53, !alias.scope !78, !noalias !75
  store <2 x double> %i.jy, ptr %i.jw, align 8, !tbaa !53, !alias.scope !78, !noalias !75
  %index.next711 = add nuw i64 %index706, 4       ; 2 uses
  %i.jz = icmp eq i64 %index.next711, %n.vec704
  br i1 %i.jz, label %middle.block712, label %vector.body705, !llvm.loop !80

middle.block712:                                  ; preds = %vector.body705
  br i1 %cmp.n713, label %._crit_edge500.us.us.us.us.us.us, label %scalar.ph700.preheader

scalar.ph700.preheader:                           ; preds = %vector.memcheck691, %.preheader486.us.us.us.us.us.us, %middle.block712
  %indvars.iv622.ph = phi i64 [ %i.jq, %vector.memcheck691 ], [ %i.jq, %.preheader486.us.us.us.us.us.us ], [ %i.jt, %middle.block712 ] ; 3 uses
  %indvars.iv620.ph = phi i64 [ %i.jp, %vector.memcheck691 ], [ %i.jp, %.preheader486.us.us.us.us.us.us ], [ %i.ju, %middle.block712 ] ; 3 uses
  %.1410496.us.us.us.us.us.us.ph = phi i32 [ 0, %vector.memcheck691 ], [ 0, %.preheader486.us.us.us.us.us.us ], [ %i.jo, %middle.block712 ] ; 4 uses
  %i.ka = sub i32 %i.ij, %.1410496.us.us.us.us.us.us.ph
  %.neg = add i32 %.1410496.us.us.us.us.us.us.ph, 1
  %xtraiter = and i32 %i.ka, 1
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %scalar.ph700.prol.loopexit, label %scalar.ph700.prol

scalar.ph700.prol:                                ; preds = %scalar.ph700.preheader
  %i.kb = getelementptr inbounds [8 x i8], ptr %4, i64 %indvars.iv622.ph
  %i.kc = load double, ptr %i.kb, align 8, !tbaa !53
  %i.kd = getelementptr inbounds [8 x i8], ptr %i.gy, i64 %indvars.iv620.ph ; 2 uses
  %i.ke = load double, ptr %i.kd, align 8, !tbaa !53
  %i.kf = fadd double %i.kc, %i.ke
  store double %i.kf, ptr %i.kd, align 8, !tbaa !53
  %indvars.iv.next621.prol = add nsw i64 %indvars.iv620.ph, 1 ; 2 uses
  %indvars.iv.next623.prol = add nsw i64 %indvars.iv622.ph, %i.bj ; 2 uses
  %i.kg = add nuw nsw i32 %.1410496.us.us.us.us.us.us.ph, 1
  br label %scalar.ph700.prol.loopexit

scalar.ph700.prol.loopexit:                       ; preds = %scalar.ph700.prol, %scalar.ph700.preheader
  %indvars.iv.next621.lcssa720.unr = phi i64 [ poison, %scalar.ph700.preheader ], [ %indvars.iv.next621.prol, %scalar.ph700.prol ]
  %indvars.iv.next623.lcssa719.unr = phi i64 [ poison, %scalar.ph700.preheader ], [ %indvars.iv.next623.prol, %scalar.ph700.prol ]
  %indvars.iv622.unr = phi i64 [ %indvars.iv622.ph, %scalar.ph700.preheader ], [ %indvars.iv.next623.prol, %scalar.ph700.prol ]
  %indvars.iv620.unr = phi i64 [ %indvars.iv620.ph, %scalar.ph700.preheader ], [ %indvars.iv.next621.prol, %scalar.ph700.prol ]
  %.1410496.us.us.us.us.us.us.unr = phi i32 [ %.1410496.us.us.us.us.us.us.ph, %scalar.ph700.preheader ], [ %i.kg, %scalar.ph700.prol ]
  %i.kh = icmp eq i32 %i.ij, %.neg
  br i1 %i.kh, label %._crit_edge500.us.us.us.us.us.us, label %scalar.ph700

scalar.ph700:                                     ; preds = %scalar.ph700.prol.loopexit, %scalar.ph700
  %indvars.iv622 = phi i64 [ %indvars.iv.next623.1, %scalar.ph700 ], [ %indvars.iv622.unr, %scalar.ph700.prol.loopexit ] ; 2 uses
  %indvars.iv620 = phi i64 [ %indvars.iv.next621.1, %scalar.ph700 ], [ %indvars.iv620.unr, %scalar.ph700.prol.loopexit ] ; 3 uses
  %.1410496.us.us.us.us.us.us = phi i32 [ %i.kt, %scalar.ph700 ], [ %.1410496.us.us.us.us.us.us.unr, %scalar.ph700.prol.loopexit ]
  %i.ki = getelementptr inbounds [8 x i8], ptr %4, i64 %indvars.iv622
  %i.kj = load double, ptr %i.ki, align 8, !tbaa !53
  %i.kk = getelementptr inbounds [8 x i8], ptr %i.gy, i64 %indvars.iv620 ; 2 uses
  %i.kl = load double, ptr %i.kk, align 8, !tbaa !53
  %i.km = fadd double %i.kj, %i.kl
  store double %i.km, ptr %i.kk, align 8, !tbaa !53
  %indvars.iv.next623 = add nsw i64 %indvars.iv622, %i.bj ; 2 uses
  %i.kn = getelementptr inbounds [8 x i8], ptr %4, i64 %indvars.iv.next623
  %i.ko = load double, ptr %i.kn, align 8, !tbaa !53
  %i.kp = getelementptr [8 x i8], ptr %i.gy, i64 %indvars.iv620
  ...
  %indvars.iv.next621.1 = add nsw i64 %indvars.iv620, 2 ; 2 uses
  %indvars.iv.next623.1 = add nsw i64 %indvars.iv.next623, %i.bj ; 2 uses
  %i.kt = add nuw nsw i32 %.1410496.us.us.us.us.us.us, 2 ; 2 uses
  %exitcond.not.1 = icmp eq i32 %i.kt, %i.ij
  br i1 %exitcond.not.1, label %._crit_edge500.us.us.us.us.us.us, label %scalar.ph700, !llvm.loop !81

._crit_edge500.us.us.us.us.us.us:                 ; preds = %scalar.ph700.prol.loopexit, %scalar.ph700, %middle.block712
  %indvars.iv.next621.lcssa = phi i64 [ %i.ju, %middle.block712 ], [ %indvars.iv.next621.lcssa720.unr, %scalar.ph700.prol.loopexit ], [ %indvars.iv.next621.1, %scalar.ph700 ]
  %indvars.iv.next623.lcssa = phi i64 [ %i.jt, %middle.block712 ], [ %indvars.iv.next623.lcssa719.unr, %scalar.ph700.prol.loopexit ], [ %indvars.iv.next623.1, %scalar.ph700 ]
  %i.ku = trunc nsw i64 %indvars.iv.next623.lcssa to i32
  %i.kv = trunc nsw i64 %indvars.iv.next621.lcssa to i32
  %i.kw = add nsw i32 %i.ja, %i.kv                ; 2 uses
  %i.kx = add nsw i32 %i.jb, %i.ku                ; 2 uses
  %i.ky = add nuw nsw i32 %.1414502.us.us.us.us.us.us, 1 ; 2 uses
  %exitcond627.not = icmp eq i32 %i.ky, %i.ik
  br i1 %exitcond627.not, label %._crit_edge505.split.us.us.us.us.us.us, label %.preheader486.us.us.us.us.us.us, !llvm.loop !82

._crit_edge505.split.us.us.us.us.us.us:           ; preds = %._crit_edge500.us.us.us.us.us.us
  %i.kz = add nsw i32 %i.jc, %i.kw
  %i.la = add nsw i32 %i.jd, %i.kx
  %i.lb = add nuw nsw i32 %.1418512.us.us.us.us.us, 1 ; 2 uses
  %exitcond628.not = icmp eq i32 %i.lb, %i.il
  br i1 %exitcond628.not, label %.loopexit493, label %.preheader488.us.us.us.us.us, !llvm.loop !83

.loopexit493:                                     ; preds = %._crit_edge505.split.us.us.us.us.us.us, %.preheader490.lr.ph, %bb.l
  %i.lc = add nsw i32 %.sroa.0212.0585, 1
  %indvars.iv.next630 = add nuw nsw i64 %indvars.iv629, 1 ; 2 uses
  %exitcond632.not = icmp eq i64 %indvars.iv.next630, %wide.trip.count
  br i1 %exitcond632.not, label %.loopexit494, label %.lr.ph587.split, !llvm.loop !69

.loopexit494:                                     ; preds = %.loopexit493, %.loopexit492.us, %bb.d, %.lr.ph599.split
  %indvars.iv.next650 = add nuw nsw i64 %indvars.iv649, 1 ; 2 uses
  %i.ld = load i32, ptr %i.aw, align 8, !tbaa !29
  %i.le = sext i32 %i.ld to i64
  %i.lf = icmp slt i64 %indvars.iv.next650, %i.le
  br i1 %i.lf, label %.lr.ph599.splitthread-pre-split, label %._crit_edge600, !llvm.loop !84

._crit_edge600:                                   ; preds = %.loopexit494, %.lr.ph599, %bb.c
  %i.lg = call i32 @hypre_BoxDestroy(ptr noundef nonnull %i.ao) #11 ; 0 uses
  br label %bb.m

bb.m:                                             ; preds = %._crit_edge600, %._crit_edge
