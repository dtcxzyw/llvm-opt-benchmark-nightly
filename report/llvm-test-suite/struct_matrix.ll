...
.preheader171:                                    ; preds = %.loopexit, %bb.d
  ...
  %.sroa.12.0 = phi i32 [ 0, %bb.d ], [ %.sroa.15.2.a, %.loopexit ]
  %.sroa.15.0 = phi i32 [ 0, %bb.d ], [ %.sroa.18.2.a, %.loopexit ]
...
.preheader172:                                    ; preds = %.lr.ph178
  ...
  %16 = call i32 @llvm.smax.i32(i32 %.sroa.15.1.a, i32 %14)
  %i.at = getelementptr inbounds nuw i8, ptr %i.as, i64 8
  %i.au = load i32, ptr %i.at, align 4, !tbaa !4  ; 2 uses
  %i.av = sub nsw i32 0, %i.au
  %..2 = call i32 @llvm.smax.i32(i32 %.sroa.18.1.a, i32 %i.av)
...
.loopexit:                                        ; preds = %.preheader172, %.lr.ph178
  ...
  %.sroa.15.2.a = phi i32 [ %16, %.preheader172 ], [ %.sroa.15.1.a, %.lr.ph178 ] ; 2 uses
  %.sroa.18.2.a = phi i32 [ %..2, %.preheader172 ], [ %.sroa.18.1.a, %.lr.ph178 ] ; 2 uses
