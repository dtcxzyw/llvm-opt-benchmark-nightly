...
bb.ao:                                            ; preds = %bb.am, %bb.an
  ...
  %i.sk = fsub double 1.000000e+00, %i.sj         ; 3 uses
  ...
  %i.so = insertelement <2 x double> %i.sn, double %i.sk, i64 1
...
bb.as:                                            ; preds = %bb.ao
  ...
  %16 = insertelement <2 x double> poison, double %i.sk, i64 0
  %17 = shufflevector <2 x double> %16, <2 x double> poison, <2 x i32> zeroinitializer
  %i.tt = fmul <2 x double> %17, %i.ts
