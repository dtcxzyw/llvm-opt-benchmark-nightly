...
bb.a:
  %i.a = load i32, ptr %0, align 8, !tbaa !28     ; 10 uses
...
.lr.ph167:                                        ; preds = %.preheader
  ...
  %i.l = zext nneg i32 %i.b to i64                ; 6 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.af = load float, ptr %i.ae, align 4, !tbaa !33
  store float %i.af, ptr %i.ab, align 4, !tbaa !33
  store float %i.ac, ptr %i.ae, align 4, !tbaa !33
...
vector.memcheck:                                  ; preds = %.lr.ph156.preheader
  %scevgep209 = getelementptr i8, ptr %i.x, i64 %4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %i.al, align 4, !tbaa !33, !alias.scope !34
  %wide.load211 = load <4 x float>, ptr %i.am, align 4, !tbaa !33, !alias.scope !34
  ...
  %wide.load212 = load <4 x float>, ptr %i.an, align 4, !tbaa !33, !alias.scope !35, !noalias !34
  %wide.load213 = load <4 x float>, ptr %i.ao, align 4, !tbaa !33, !alias.scope !35, !noalias !34
  ...
  store <4 x float> %i.ap, ptr %i.an, align 4, !tbaa !33, !alias.scope !35, !noalias !34
  store <4 x float> %i.aq, ptr %i.ao, align 4, !tbaa !33, !alias.scope !35, !noalias !34
...
.lr.ph156.prol:                                   ; preds = %.lr.ph156.preheader239
  ...
  %i.at = load float, ptr %.0118.prol, align 4, !tbaa !33
  ...
  store float %i.aw, ptr %i.au, align 4, !tbaa !33
...
.lr.ph156:                                        ; preds = %.lr.ph156.prol.loopexit, %.lr.ph156
  ...
  br i1 %exitcond184.not.1, label %._crit_edge157, label %.lr.ph156, !llvm.loop !12
...
._crit_edge157:                                   ; preds = %.lr.ph156.prol.loopexit, %.lr.ph156, %middle.block
  ...
  br i1 %exitcond189.not, label %.preheader, label %bb.b, !llvm.loop !13

.lr.ph164.preheader:                              ; preds = %.lr.ph167, %._crit_edge165
  %indvar.a = phi i64 [ %indvar.next.a, %._crit_edge165 ], [ 0, %.lr.ph167 ] ; 3 uses
  %i.bi = phi ptr [ %i.da, %._crit_edge165 ], [ %i.q, %.lr.ph167 ] ; 5 uses
  %i.bj = phi ptr [ %i.cx, %._crit_edge165 ], [ %i.n, %.lr.ph167 ] ; 6 uses
  %indvars.iv195207 = phi i64 [ %indvars.iv.next196, %._crit_edge165 ], [ %i.l, %.lr.ph167 ] ; 7 uses
...
vector.body224:                                   ; preds = %vector.body224, %vector.ph222
  ...
  %wide.load227 = load <4 x float>, ptr %next.gep226, align 4, !tbaa !33, !alias.scope !39
  %wide.load228 = load <4 x float>, ptr %i.bq, align 4, !tbaa !33, !alias.scope !39
  %i.br = load float, ptr %i.bi, align 4, !tbaa !33, !alias.scope !40
  ...
  %wide.load229 = load <4 x float>, ptr %i.bs, align 4, !tbaa !33, !alias.scope !41, !noalias !39
  %wide.load230 = load <4 x float>, ptr %i.bt, align 4, !tbaa !33, !alias.scope !41, !noalias !39
  ...
  store <4 x float> %i.bw, ptr %i.bs, align 4, !tbaa !33, !alias.scope !41, !noalias !39
  store <4 x float> %i.bx, ptr %i.bt, align 4, !tbaa !33, !alias.scope !41, !noalias !39
  %index.next233 = add nuw i64 %index225, 8       ; 2 uses
  %i.by = icmp eq i64 %index.next233, %n.vec223
  br i1 %i.by, label %middle.block234, label %vector.body224, !llvm.loop !18
...
.lr.ph164.prol:                                   ; preds = %.lr.ph164.preheader238
  %i.bz = load float, ptr %.0116161.ph, align 4, !tbaa !33
  %i.ca = load float, ptr %i.bi, align 4, !tbaa !33
  %i.cb = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %indvars.iv190.ph ; 2 uses
  %i.cc = load float, ptr %i.cb, align 4, !tbaa !33
  %i.cd = fneg float %i.bz
  %i.ce = tail call float @llvm.fmuladd.f32(float %i.cd, float %i.ca, float %i.cc)
  store float %i.ce, ptr %i.cb, align 4, !tbaa !33
...
.lr.ph164:                                        ; preds = %.lr.ph164.prol.loopexit, %.lr.ph164
  ...
  %i.ch = load float, ptr %.0116161, align 4, !tbaa !33
  %i.ci = load float, ptr %i.bi, align 4, !tbaa !33
  ...
  store float %i.cu, ptr %i.cr, align 4, !tbaa !33
  ...
  br i1 %exitcond194.not.1, label %._crit_edge165, label %.lr.ph164, !llvm.loop !19
...
._crit_edge165:                                   ; preds = %.lr.ph164.prol.loopexit, %.lr.ph164, %middle.block234
  ...
  %i.cz = load float, ptr %i.cy, align 4, !tbaa !33
  %i.da = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %indvars.iv.next196 ; 3 uses
  %i.db = load float, ptr %i.da, align 4, !tbaa !33
  %i.dc = fdiv float %i.db, %i.cz
  store float %i.dc, ptr %i.da, align 4, !tbaa !33
  %.not203 = icmp eq i64 %indvars.iv.next196, 0
  %indvar.next.a = add i64 %indvar.a, 1
  br i1 %.not203, label %.loopexit, label %.lr.ph164.preheader, !llvm.loop !20
...
bb.d:                                             ; preds = %.lr.ph138, %._crit_edge
  ...
  %i.de = load ptr, ptr %i.dd, align 8, !tbaa !31 ; 3 uses
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  %i.dh = load float, ptr %.1117134, align 4, !tbaa !33
  %i.di = load float, ptr %.0114135, align 4, !tbaa !33
  ...
  %i.dm = load float, ptr %i.dk, align 4, !tbaa !33
  %i.dn = load float, ptr %i.dl, align 4, !tbaa !33
  ...
  %i.dr = load float, ptr %i.dp, align 4, !tbaa !33
  %i.ds = load float, ptr %i.dq, align 4, !tbaa !33
  ...
  %i.dw = load float, ptr %i.du, align 4, !tbaa !33
  %i.dx = load float, ptr %i.dv, align 4, !tbaa !33
  ...
  br i1 %niter.ncmp.3, label %._crit_edge.loopexit.unr-lcssa, label %.lr.ph, !llvm.loop !21
...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  %i.eb = load float, ptr %.1117134.epil, align 4, !tbaa !33
  %i.ec = load float, ptr %.0114135.epil, align 4, !tbaa !33
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph.epil, %bb.d
  ...
  %i.eh = load float, ptr %i.eg, align 4, !tbaa !33
  %i.ei = fsub float %i.eh, %.0120.lcssa
  %i.ej = load float, ptr %i.df, align 4, !tbaa !33
  %i.ek = fdiv float %i.ei, %i.ej
  store float %i.ek, ptr %i.eg, align 4, !tbaa !33
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond172.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond172.not, label %._crit_edge139, label %bb.d, !llvm.loop !23
