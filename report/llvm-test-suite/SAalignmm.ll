...
._crit_edge32.loopexit.i:                         ; preds = %._crit_edge.i
  %i.ti = add i32 %.016349.i, %.015551.i
  %i.tj = add i32 %i.ti, %i.ro
  br label %._crit_edge32.i

._crit_edge32.i:                                  ; preds = %._crit_edge32.loopexit.i, %bb.ap
  %.1156.lcssa.i = phi i32 [ %.015551.i, %bb.ap ], [ %i.tj, %._crit_edge32.loopexit.i ] ; 2 uses
