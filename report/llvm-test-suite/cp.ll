...
define dso_local void @_ZN9ConstPool4readEP9ClassfilePt(ptr noundef nonnull align 8 captures(none) dereferenceable(16) initializes((0, 2), (8, 16)) %0, ptr noundef captures(none) %1, ptr noundef readnone captures(none) %2) local_unnamed_addr #0 align 2 {
bb.a:
  ...
  %i.g = shl i16 %i.d, 8
  %i.h = and i16 %i.f, 255
  %i.i = or disjoint i16 %i.h, %i.g               ; 2 uses
  ...
  %3 = load i16, ptr %0, align 8, !tbaa !22
  %i.n = zext i16 %3 to i32                       ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph, %bb.ad
  ...
  %.093126 = phi i32 [ %i.o, %.lr.ph ], [ %.295, %bb.ad ] ; 2 uses
  %.096125 = phi i32 [ 1, %.lr.ph ], [ %.298, %bb.ad ] ; 5 uses
  %i.s = load ptr, ptr %i.m, align 8, !tbaa !23
  %i.t = add nsw i32 %.096125, 1                  ; 20 uses
  %i.u = sext i32 %.096125 to i64
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.ac = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.aa, ptr noundef nonnull @.str, i32 noundef %i.ab, i32 noundef %.096125) #6 ; 0 uses
