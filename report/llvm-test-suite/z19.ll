begin_hunk_0_@AttachGalley:bb.a
  ...
  %4 = sub nuw nsw i32 1, %i.ai                   ; 5 uses
...
begin_hunk_2_@InterposeWideOrHigh:bb.a
  ...
  %i.al = getelementptr inbounds nuw [4 x i8], ptr %i.ak, i64 %i.ah ; 2 uses
  ...
  %i.aq = getelementptr inbounds nuw [4 x i8], ptr %i.ap, i64 %i.ah ; 2 uses
...
begin_hunk_3_@InterposeWideOrHigh:bb.a
  ...
  %3 = load i32, ptr %i.al, align 4, !tbaa !8
  %4 = load i32, ptr %i.aq, align 4, !tbaa !8
  %i.az = add nsw i32 %4, %3
