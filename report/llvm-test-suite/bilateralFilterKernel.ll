...
bb.b:                                             ; preds = %bb.b, %.preheader.us.us.us
  ...
  %5 = insertelement <2 x double> poison, double %i.x, i64 0
  %6 = insertelement <2 x double> %5, double %i.ah, i64 1
  %7 = fdiv <2 x double> %6, <double f0x408C463ABECCB2BB, double f0x409921FB54442D18> ; 2 uses
  %shift = shufflevector <2 x double> %7, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop = fmul <2 x double> %7, %shift
  %8 = extractelement <2 x double> %foldExtExtBinop, i64 0 ; 2 uses
  %i.ai = load i32, ptr %i.s, align 4, !tbaa !4
  %i.aj = sitofp i32 %i.ai to double
  %i.ak = fmul double %8, %i.aj
  %i.al = fadd double %.17177.us.us.us, %i.ak     ; 3 uses
  %i.am = fadd double %.178.us.us.us, %8          ; 3 uses
