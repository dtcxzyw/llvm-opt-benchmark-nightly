...
_ZN11CStringBaseIwED2Ev.exit.i:                   ; preds = %bb.dn, %bb.dm
  ...
  switch i32 %.496.i, label %.thread164.i [
    i32 0, label %bb.do
    i32 4, label %bb.do
  ]
end_hunk_1
...
._crit_edge.i:                                    ; preds = %bb.do, %.preheader.i
  ...
  br i1 %i.nz, label %bb.ds, label %bb.du
...
.thread164.i:                                     ; preds = %_ZN11CStringBaseIwED2Ev.exit.i, %bb.ds, %bb.cy
  %.6.ph.i = phi i32 [ %i.mx, %bb.cy ], [ 0, %bb.ds ], [ %.4.i, %_ZN11CStringBaseIwED2Ev.exit.i ]
...
bb.dw:                                            ; preds = %bb.du, %._crit_edge431
...
bb.fv:                                            ; preds = %_ZN13CObjectVectorI11CStringBaseIwEED2Ev.exit.i, %.thread164.i
  %.4 = phi i64 [ %.1318, %_ZN13CObjectVectorI11CStringBaseIwEED2Ev.exit.i ], [ 0, %.thread164.i ]
  %.10.i = phi i32 [ %.9.i, %_ZN13CObjectVectorI11CStringBaseIwEED2Ev.exit.i ], [ %.6.ph.i, %.thread164.i ] ; 2 uses
