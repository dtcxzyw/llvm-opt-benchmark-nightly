...
.lr.ph.i.preheader:                               ; preds = %sf_new.exit
  ...
  %or.cond = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond, label %.lr.ph.i.preheader56, label %vector.ph
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %intcpy.exit, label %.lr.ph.i.preheader56
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader56, %.lr.ph.i.prol
  %indvars.iv.i.prol = phi i64 [ %indvars.iv.next.i.prol, %.lr.ph.i.prol ], [ %indvars.iv.i.ph, %.lr.ph.i.preheader56 ]
  %.058.i.prol = phi ptr [ %i.be, %.lr.ph.i.prol ], [ %.058.i.ph, %.lr.ph.i.preheader56 ] ; 2 uses
  %.067.i.prol = phi ptr [ %i.bc, %.lr.ph.i.prol ], [ %.067.i.ph, %.lr.ph.i.preheader56 ] ; 2 uses
  %prol.iter = phi i64 [ %prol.iter.next, %.lr.ph.i.prol ], [ 0, %.lr.ph.i.preheader56 ]
...
.lr.ph.i.prol.loopexit:                           ; preds = %.lr.ph.i.prol, %.lr.ph.i.preheader56
  %indvars.iv.i.unr = phi i64 [ %indvars.iv.i.ph, %.lr.ph.i.preheader56 ], [ %indvars.iv.next.i.prol, %.lr.ph.i.prol ]
  %.058.i.unr = phi ptr [ %.058.i.ph, %.lr.ph.i.preheader56 ], [ %i.be, %.lr.ph.i.prol ]
  %.067.i.unr = phi ptr [ %.067.i.ph, %.lr.ph.i.preheader56 ], [ %i.bc, %.lr.ph.i.prol ]
...
.lr.ph.i22.preheader:                             ; preds = %intcpy.exit
  ...
  br i1 %min.iters.check39, label %.lr.ph.i22.preheader55, label %vector.memcheck36
...
vector.memcheck36:                                ; preds = %.lr.ph.i22.preheader
  ...
  br i1 %diff.check37, label %.lr.ph.i22.preheader55, label %vector.ph40

vector.ph40:                                      ; preds = %vector.memcheck36
  %n.vec41 = and i64 %2, 2147483640               ; 4 uses
  %i.cn = shl nuw nsw i64 %n.vec41, 2             ; 2 uses
...
vector.body42:                                    ; preds = %vector.body42, %vector.ph40
  %index43 = phi i64 [ 0, %vector.ph40 ], [ %index.next48, %vector.body42 ] ; 2 uses
  %i.cq = shl i64 %index43, 2                     ; 2 uses
  %next.gep44 = getelementptr i8, ptr %i.ci, i64 %i.cq ; 2 uses
  %next.gep45 = getelementptr i8, ptr %i.ch, i64 %i.cq ; 2 uses
  %i.cr = getelementptr i8, ptr %next.gep45, i64 16
  %wide.load46 = load <4 x i32>, ptr %next.gep45, align 4, !tbaa !4
  %wide.load47 = load <4 x i32>, ptr %i.cr, align 4, !tbaa !4
  %i.cs = getelementptr i8, ptr %next.gep44, i64 16
  store <4 x i32> %wide.load46, ptr %next.gep44, align 4, !tbaa !4
  store <4 x i32> %wide.load47, ptr %i.cs, align 4, !tbaa !4
  %index.next48 = add nuw i64 %index43, 8         ; 2 uses
  %i.ct = icmp eq i64 %index.next48, %n.vec41
  br i1 %i.ct, label %middle.block49, label %vector.body42, !llvm.loop !53

middle.block49:                                   ; preds = %vector.body42
  %cmp.n50 = icmp eq i64 %n.vec41, %2
  br i1 %cmp.n50, label %intcpy.exit28, label %.lr.ph.i22.preheader55

.lr.ph.i22.preheader55:                           ; preds = %vector.memcheck36, %.lr.ph.i22.preheader, %middle.block49
  %indvars.iv.i23.ph = phi i64 [ 0, %vector.memcheck36 ], [ 0, %.lr.ph.i22.preheader ], [ %n.vec41, %middle.block49 ] ; 3 uses
  %.058.i24.ph = phi ptr [ %i.ci, %vector.memcheck36 ], [ %i.ci, %.lr.ph.i22.preheader ], [ %i.co, %middle.block49 ] ; 2 uses
  %.067.i25.ph = phi ptr [ %i.ch, %vector.memcheck36 ], [ %i.ch, %.lr.ph.i22.preheader ], [ %i.cp, %middle.block49 ] ; 2 uses
  %xtraiter57 = and i64 %2, 7
  %3 = and i32 %i.n, 7
  %lcmp.mod58.not = icmp eq i32 %3, 0
  br i1 %lcmp.mod58.not, label %.lr.ph.i22.prol.loopexit, label %.lr.ph.i22.prol

.lr.ph.i22.prol:                                  ; preds = %.lr.ph.i22.preheader55, %.lr.ph.i22.prol
  %indvars.iv.i23.prol = phi i64 [ %indvars.iv.next.i26.prol, %.lr.ph.i22.prol ], [ %indvars.iv.i23.ph, %.lr.ph.i22.preheader55 ]
  %.058.i24.prol = phi ptr [ %i.cw, %.lr.ph.i22.prol ], [ %.058.i24.ph, %.lr.ph.i22.preheader55 ] ; 2 uses
  %.067.i25.prol = phi ptr [ %i.cu, %.lr.ph.i22.prol ], [ %.067.i25.ph, %.lr.ph.i22.preheader55 ] ; 2 uses
  %prol.iter59 = phi i64 [ %prol.iter59.next, %.lr.ph.i22.prol ], [ 0, %.lr.ph.i22.preheader55 ]
  ...
  br i1 %prol.iter59.cmp.not, label %.lr.ph.i22.prol.loopexit, label %.lr.ph.i22.prol, !llvm.loop !54

.lr.ph.i22.prol.loopexit:                         ; preds = %.lr.ph.i22.prol, %.lr.ph.i22.preheader55
  %indvars.iv.i23.unr = phi i64 [ %indvars.iv.i23.ph, %.lr.ph.i22.preheader55 ], [ %indvars.iv.next.i26.prol, %.lr.ph.i22.prol ]
  %.058.i24.unr = phi ptr [ %.058.i24.ph, %.lr.ph.i22.preheader55 ], [ %i.cw, %.lr.ph.i22.prol ]
  %.067.i25.unr = phi ptr [ %.067.i25.ph, %.lr.ph.i22.preheader55 ], [ %i.cu, %.lr.ph.i22.prol ]
...
intcpy.exit28:                                    ; preds = %.lr.ph.i22.prol.loopexit, %.lr.ph.i22, %middle.block49, %intcpy.exit
  ret ptr %.0.i
}
