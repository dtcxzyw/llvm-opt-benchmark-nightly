...
vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  ...
  %ind.escape23 = add nsw i64 %i.aj, -1
...
.loopexit:                                        ; preds = %.preheader.i, %vec.epilog.middle.block, %middle.block
  %indvars.iv44.i.lcssa = phi i64 [ %ind.escape23, %vec.epilog.middle.block ], [ %ind.escape, %middle.block ], [ %indvars.iv44.i, %.preheader.i ] ; 3 uses
...
vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n61 = icmp eq i64 %i.w, %n.vec56
  %ind.escape62 = add nsw i64 %i.ae, -1
  br i1 %cmp.n61, label %.loopexit65, label %.preheader.preheader
...
.loopexit65:                                      ; preds = %.preheader, %vec.epilog.middle.block, %middle.block
  %indvars.iv44.lcssa = phi i64 [ %ind.escape62, %vec.epilog.middle.block ], [ %ind.escape, %middle.block ], [ %indvars.iv44, %.preheader ] ; 3 uses
