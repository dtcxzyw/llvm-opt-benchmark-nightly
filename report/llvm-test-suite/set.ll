...
.lr.ph.preheader:                                 ; preds = %sf_new.exit
  ...
  %i.an = sext i32 %.pre51 to i64                 ; 9 uses
...
._crit_edge:                                      ; preds = %.lr.ph.epil, %._crit_edge.unr-lcssa
  ...
  br i1 %i.bb, label %.preheader.lr.ph, label %._crit_edge47
...
.preheader.us:                                    ; preds = %.preheader.lr.ph, %._crit_edge44.us
  %.146.us = phi i32 [ %i.ca, %._crit_edge44.us ], [ 0, %.preheader.lr.ph ] ; 3 uses
  %.13845.us = phi ptr [ %i.bz, %._crit_edge44.us ], [ %i.az, %.preheader.lr.ph ] ; 2 uses
  %i.bg = and i32 %.146.us, 31
  %i.bh = shl nuw i32 1, %i.bg
  %i.bi = lshr i32 %.146.us, 5
  %i.bj = zext nneg i32 %i.bi to i64
  %invariant.gep.us = getelementptr [4 x i8], ptr %i.v, i64 %i.bj
  br label %bb.d

bb.d:                                             ; preds = %.preheader.us, %bb.f
  %.03542.us = phi i32 [ 0, %.preheader.us ], [ %i.by, %bb.f ] ; 4 uses
  %i.bk = lshr i32 %.03542.us, 5
  %i.bl = zext nneg i32 %i.bk to i64
  %i.bm = getelementptr inbounds nuw [4 x i8], ptr %.13845.us, i64 %i.bl
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bm, i64 4
  %i.bo = load i32, ptr %i.bn, align 4, !tbaa !4
  %i.bp = and i32 %.03542.us, 31
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.bt = mul nsw i32 %i.bs, %.03542.us
  %i.bu = sext i32 %i.bt to i64
  %gep.us = getelementptr [4 x i8], ptr %invariant.gep.us, i64 %i.bu
  %i.bv = getelementptr inbounds nuw i8, ptr %gep.us, i64 4 ; 2 uses
...
._crit_edge44.us:                                 ; preds = %bb.f
  %i.bz = getelementptr inbounds [4 x i8], ptr %.13845.us, i64 %i.bf
  %i.ca = add nuw nsw i32 %.146.us, 1             ; 2 uses
  %exitcond50.not = icmp eq i32 %i.ca, %i.ba
...
._crit_edge47:                                    ; preds = %._crit_edge44.us, %._crit_edge.thread, %._crit_edge
  %i.cb = phi ptr [ %i.bd, %._crit_edge.thread ], [ %i.az, %._crit_edge ], [ %i.az, %._crit_edge44.us ] ; 2 uses
  %i.cc = phi ptr [ %i.bc, %._crit_edge.thread ], [ %i.ay, %._crit_edge ], [ %i.ay, %._crit_edge44.us ]
