begin_hunk_0
  ...
  %i.ax = shl nuw nsw i64 %i.aw, 2                ; 5 uses
  %i.ay = add nuw nsw i64 %i.ax, 4                ; 4 uses
  br i1 %i.am, label %.lr.ph57.split.us, label %.lr.ph57.split

.lr.ph57.split.us:                                ; preds = %.lr.ph57
  br i1 %i.ai, label %.lr.ph57.split.us.split.us, label %.lr.ph57.split.us.split

.lr.ph57.split.us.split.us:                       ; preds = %.lr.ph57.split.us, %._crit_edge55.us.us
  %i.az = phi i32 [ %i.ba, %._crit_edge55.us.us ], [ 0, %.lr.ph57.split.us ] ; 2 uses
  %.04656.us.us = phi ptr [ %i.ck, %._crit_edge55.us.us ], [ %i.ab, %.lr.ph57.split.us ] ; 3 uses
...
begin_hunk_1
  ...
  %3 = add nsw i64 %i.be, %i.au
  %4 = sub nsw i64 %3, %i.ax
  %scevgep77 = getelementptr i8, ptr %i.w, i64 %4
...
.lr.ph57.split.us.split:                          ; preds = %.lr.ph57.split.us, %._crit_edge55.us
  %i.cm = phi i32 [ %i.cn, %._crit_edge55.us ], [ 0, %.lr.ph57.split.us ] ; 2 uses
  %.04656.us = phi ptr [ %i.dl, %._crit_edge55.us ], [ %i.ab, %.lr.ph57.split.us ] ; 2 uses
...
begin_hunk_3
  ...
  %5 = add nsw i64 %i.cr, %i.au
  %6 = sub nsw i64 %5, %i.ax
  %scevgep74 = getelementptr i8, ptr %i.w, i64 %6
...
.lr.ph57.split:                                   ; preds = %.lr.ph57
  br i1 %i.ai, label %.lr.ph57.split.split.us, label %.lr.ph57.split.split

.lr.ph57.split.split.us:                          ; preds = %.lr.ph57.split, %._crit_edge.us65
  %i.dn = phi i32 [ %i.do, %._crit_edge.us65 ], [ 0, %.lr.ph57.split ] ; 2 uses
  %.04656.us59 = phi ptr [ %i.ef, %._crit_edge.us65 ], [ %i.ab, %.lr.ph57.split ] ; 2 uses
...
begin_hunk_5
  ...
  %7 = add nsw i64 %i.ds, %i.au
  %8 = sub nsw i64 %7, %i.ax
  %scevgep71 = getelementptr i8, ptr %i.w, i64 %8
...
.lr.ph57.split.split:                             ; preds = %.lr.ph57.split, %.lr.ph57.split.split
  %i.eh = phi i32 [ %i.ei, %.lr.ph57.split.split ], [ 0, %.lr.ph57.split ] ; 2 uses
  %.04656 = phi ptr [ %i.en, %.lr.ph57.split.split ], [ %i.ab, %.lr.ph57.split ]
...
begin_hunk_7
  ...
  %9 = add nsw i64 %i.em, %i.au
  %10 = sub nsw i64 %9, %i.ax
  %scevgep = getelementptr i8, ptr %i.w, i64 %10
...
begin_hunk_9
  ...
  %2 = add nsw i64 %i.bw, %i.bh
  %3 = sub nsw i64 %2, %i.bk
  %scevgep = getelementptr i8, ptr %i.av, i64 %3
