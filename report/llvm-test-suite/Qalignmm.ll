...
.lr.ph630:                                        ; preds = %bb.y
  ...
  %i.ahp = add nuw nsw i64 %15, 4                 ; 2 uses
  %16 = zext i32 %13 to i64
  %i.ahq = add nuw nsw i64 %16, 1                 ; 2 uses
  %min.iters.check1214 = icmp ult i32 %13, 7
...
vector.memcheck1207:                              ; preds = %.lr.ph.preheader.i531
  %scevgep1208 = getelementptr i8, ptr %.0466625, i64 %i.ahp
  %scevgep1209 = getelementptr i8, ptr %i.aia, i64 %i.ahp
