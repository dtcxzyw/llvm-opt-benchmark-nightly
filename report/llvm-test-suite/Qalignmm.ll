...
vector.memcheck:                                  ; preds = %.lr.ph571
  ...
  %13 = shufflevector <4 x i1> %i.ii, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %14 = shufflevector <4 x i1> %i.iv, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %15 = or <8 x i1> %13, %14
  %16 = shufflevector <4 x i1> %i.ji, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %17 = or <8 x i1> %15, %16
  %i.jw = shufflevector <4 x i1> %i.jv, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %18 = or <8 x i1> %17, %i.jw
  %i.jx = or <8 x i1> %18, %i.ht
...
vector.memcheck914:                               ; preds = %.lr.ph575
  ...
  %19 = shufflevector <4 x i1> %i.pr, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %20 = shufflevector <4 x i1> %i.qe, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %21 = or <8 x i1> %19, %20
  %22 = shufflevector <4 x i1> %i.qr, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %23 = or <8 x i1> %21, %22
  %i.rf = shufflevector <4 x i1> %i.re, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %24 = or <8 x i1> %23, %i.rf
  %i.rg = or <8 x i1> %24, %i.pc
...
vector.memcheck:                                  ; preds = %.lr.ph567
  ...
  %i.ju = icmp ult <4 x ptr> %i.js, %i.jt
  %i.jv = and <4 x i1> %i.jo, %i.ju
  %15 = shufflevector <4 x i1> %i.ii, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %16 = shufflevector <4 x i1> %i.iv, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %17 = or <8 x i1> %15, %16
  %18 = shufflevector <4 x i1> %i.ji, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %19 = or <8 x i1> %17, %18
  %i.jw = shufflevector <4 x i1> %i.jv, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %20 = or <8 x i1> %19, %i.jw
  %i.jx = or <8 x i1> %20, %i.ht
  %i.jy = shufflevector <8 x i1> %i.jx, <8 x i1> %i.ht, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 15>
  %i.jz = bitcast <8 x i1> %i.jy to i8
  %i.ka = icmp ne i8 %i.jz, 0
...
vector.memcheck897:                               ; preds = %.lr.ph571
  ...
  %i.rd = icmp ult <4 x ptr> %i.rb, %i.rc
  %i.re = and <4 x i1> %i.qx, %i.rd
  %21 = shufflevector <4 x i1> %i.pr, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %22 = shufflevector <4 x i1> %i.qe, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %23 = or <8 x i1> %21, %22
  %24 = shufflevector <4 x i1> %i.qr, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %25 = or <8 x i1> %23, %24
  %i.rf = shufflevector <4 x i1> %i.re, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %26 = or <8 x i1> %25, %i.rf
  %i.rg = or <8 x i1> %26, %i.pc
  %i.rh = shufflevector <8 x i1> %i.rg, <8 x i1> %i.pc, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 15>
  %i.ri = bitcast <8 x i1> %i.rh to i8
  %i.rj = icmp ne i8 %i.ri, 0
