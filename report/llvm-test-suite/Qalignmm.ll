...
bb.l:                                             ; preds = %._crit_edge.us, %._crit_edge.us.thread
  ...
  %i.y = getelementptr inbounds nuw i8, ptr %i.r, i64 %indvars.iv246
  store i8 %.sink, ptr %i.y, align 1, !tbaa !18
  %indvars.iv.next247 = add nuw nsw i64 %indvars.iv246, 1 ; 2 uses
  %exitcond250.not = icmp eq i64 %indvars.iv.next247, %wide.trip.count249
  br i1 %exitcond250.not, label %.preheader210, label %.preheader211.us, !llvm.loop !21
...
.preheader210:                                    ; preds = %bb.l, %.preheader211.preheader, %.preheader211.us216.preheader
  ...
  br i1 %i.aa, label %.preheader209.lr.ph, label %._crit_edge228.split

.preheader210.thread:                             ; preds = %bb.i
  %i.ab = icmp sgt i32 %4, 0
  br i1 %i.ab, label %.preheader209.lr.ph, label %._crit_edge228.split
...
.preheader209.us:                                 ; preds = %.preheader209.us.preheader, %bb.o
  %indvars.iv262 = phi i64 [ 0, %.preheader209.us.preheader ], [ %indvars.iv.next263, %bb.o ] ; 3 uses
  br label %bb.m

bb.m:                                             ; preds = %.preheader209.us, %bb.n
  %indvars.iv257 = phi i64 [ 0, %.preheader209.us ], [ %indvars.iv.next258, %bb.n ] ; 3 uses
  %i.ae = getelementptr inbounds nuw [8 x i8], ptr %6, i64 %indvars.iv257
  %i.af = load ptr, ptr %i.ae, align 8, !tbaa !16
  %i.ag = getelementptr inbounds nuw i8, ptr %i.af, i64 %indvars.iv262
...
bb.n:                                             ; preds = %bb.m
  ...
  br i1 %exitcond261.not, label %._crit_edge.us222.thread, label %bb.m, !llvm.loop !22

._crit_edge.us222:                                ; preds = %bb.m
  %i.aj = trunc nuw nsw i64 %indvars.iv257 to i32
...
bb.o:                                             ; preds = %._crit_edge.us222, %._crit_edge.us222.thread
  %.sink285 = phi i8 [ 0, %._crit_edge.us222.thread ], [ 1, %._crit_edge.us222 ]
  %i.ak = getelementptr inbounds nuw i8, ptr %i.ad, i64 %indvars.iv262
  store i8 %.sink285, ptr %i.ak, align 1, !tbaa !18
  %indvars.iv.next263 = add nuw nsw i64 %indvars.iv262, 1 ; 2 uses
  %exitcond266.not = icmp eq i64 %indvars.iv.next263, %wide.trip.count265
  br i1 %exitcond266.not, label %.preheader208, label %.preheader209.us, !llvm.loop !23
...
.preheader208:                                    ; preds = %bb.o, %.preheader209.preheader, %.preheader209.us224.preheader
  br i1 %i.p, label %.preheader207.lr.ph, label %._crit_edge228.split
...
.preheader207.lr.ph:                              ; preds = %.preheader208
  ...
  %wide.trip.count273 = zext nneg i32 %3 to i64   ; 2 uses
  %xtraiter = and i64 %wide.trip.count273, 7      ; 3 uses
  %i.ap = icmp ult i32 %3, 8
  br i1 %i.ap, label %.preheader207.epil.preheader, label %.preheader207.lr.ph.new

.preheader207.lr.ph.new:                          ; preds = %.preheader207.lr.ph
  %unroll_iter = and i64 %wide.trip.count273, 2147483640
  br label %.preheader207

.preheader207:                                    ; preds = %.preheader207, %.preheader207.lr.ph.new
  %indvars.iv270 = phi i64 [ 0, %.preheader207.lr.ph.new ], [ %indvars.iv.next271.7, %.preheader207 ] ; 9 uses
  %niter = phi i64 [ 0, %.preheader207.lr.ph.new ], [ %niter.next.7, %.preheader207 ]
  %i.aq = getelementptr inbounds nuw [8 x i8], ptr %i.am, i64 %indvars.iv270
  %i.ar = load ptr, ptr %i.aq, align 8, !tbaa !12
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.ar, i8 0, i64 %i.ao, i1 false), !tbaa !14
  %i.as = getelementptr inbounds nuw [8 x i8], ptr %i.am, i64 %indvars.iv270
  ...
  %i.av = getelementptr inbounds nuw [8 x i8], ptr %i.am, i64 %indvars.iv270
  ...
  %i.ay = getelementptr inbounds nuw [8 x i8], ptr %i.am, i64 %indvars.iv270
  ...
  %i.bb = getelementptr inbounds nuw [8 x i8], ptr %i.am, i64 %indvars.iv270
  ...
  %i.be = getelementptr inbounds nuw [8 x i8], ptr %i.am, i64 %indvars.iv270
  ...
  %i.bh = getelementptr inbounds nuw [8 x i8], ptr %i.am, i64 %indvars.iv270
  ...
  %i.bk = getelementptr inbounds nuw [8 x i8], ptr %i.am, i64 %indvars.iv270
  ...
  br i1 %niter.ncmp.7, label %._crit_edge228.split.loopexit.unr-lcssa, label %.preheader207, !llvm.loop !24

._crit_edge228.split.loopexit.unr-lcssa:          ; preds = %.preheader207
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %._crit_edge228.split, label %.preheader207.epil.preheader

.preheader207.epil.preheader:                     ; preds = %._crit_edge228.split.loopexit.unr-lcssa, %.preheader207.lr.ph
  %indvars.iv270.epil.init = phi i64 [ 0, %.preheader207.lr.ph ], [ %indvars.iv.next271.7, %._crit_edge228.split.loopexit.unr-lcssa ]
  %lcmp.mod319 = icmp ne i64 %xtraiter, 0
  tail call void @llvm.assume(i1 %lcmp.mod319)
  br label %.preheader207.epil

.preheader207.epil:                               ; preds = %.preheader207.epil, %.preheader207.epil.preheader
  %indvars.iv270.epil = phi i64 [ %indvars.iv270.epil.init, %.preheader207.epil.preheader ], [ %indvars.iv.next271.epil, %.preheader207.epil ] ; 2 uses
  %epil.iter = phi i64 [ 0, %.preheader207.epil.preheader ], [ %epil.iter.next, %.preheader207.epil ]
  %i.bn = getelementptr inbounds nuw [8 x i8], ptr %i.am, i64 %indvars.iv270.epil
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge228.split, label %.preheader207.epil, !llvm.loop !25

._crit_edge228.split:                             ; preds = %._crit_edge228.split.loopexit.unr-lcssa, %.preheader207.epil, %.preheader210, %.preheader210.thread, %.preheader208
  %i.bp = load double, ptr @fastathreshold, align 8, !tbaa !27
  %i.bq = icmp sgt i32 %1, 0
  br i1 %i.bq, label %.preheader206.lr.ph, label %._crit_edge238.split

.preheader206.lr.ph:                              ; preds = %._crit_edge228.split
  %i.br = icmp sgt i32 %2, 0
  %i.bs = load ptr, ptr @impmtx, align 8
  br i1 %i.br, label %.preheader206.preheader, label %._crit_edge238.split

.preheader206.preheader:                          ; preds = %.preheader206.lr.ph
  %wide.trip.count283 = zext nneg i32 %1 to i64
  %wide.trip.count278 = zext nneg i32 %2 to i64
  br label %.preheader206

.preheader206:                                    ; preds = %.preheader206.preheader, %._crit_edge236
  %indvars.iv280 = phi i64 [ 0, %.preheader206.preheader ], [ %indvars.iv.next281, %._crit_edge236 ] ; 4 uses
  %i.bt = getelementptr inbounds nuw [8 x i8], ptr %7, i64 %indvars.iv280
  %i.bu = load double, ptr %i.bt, align 8, !tbaa !27
  %i.bv = getelementptr inbounds nuw [8 x i8], ptr %9, i64 %indvars.iv280
  %i.bw = load ptr, ptr %i.bv, align 8, !tbaa !29
  %i.bx = getelementptr inbounds nuw [8 x i8], ptr %5, i64 %indvars.iv280
  br label %bb.p

bb.p:                                             ; preds = %.preheader206, %._crit_edge233
  %indvars.iv275 = phi i64 [ 0, %.preheader206 ], [ %indvars.iv.next276, %._crit_edge233 ] ; 4 uses
  %i.by = getelementptr inbounds nuw [8 x i8], ptr %8, i64 %indvars.iv275
  ...
  %i.cd = getelementptr inbounds nuw [8 x i8], ptr %i.bw, i64 %indvars.iv275
  %.0229 = load ptr, ptr %i.cd, align 8, !tbaa !31 ; 2 uses
  %.not180230 = icmp eq ptr %.0229, null
  br i1 %.not180230, label %._crit_edge233, label %.lr.ph.us

bb.q:                                             ; preds = %.lr.ph.us, %.critedge
  %.0231 = phi ptr [ %.0229, %.lr.ph.us ], [ %.0, %.critedge ] ; 6 uses
  %i.ce = getelementptr inbounds nuw i8, ptr %.0231, i64 24
  %.pre.pre = load i32, ptr %i.ce, align 8, !tbaa !33 ; 3 uses
  br label %bb.r

bb.r:                                             ; preds = %bb.s, %bb.q
  %.0158 = phi i32 [ -1, %bb.q ], [ %spec.select, %bb.s ] ; 2 uses
  %.0142 = phi ptr [ %11, %bb.q ], [ %i.cg, %bb.s ] ; 3 uses
  %i.cf = load i8, ptr %.0142, align 1, !tbaa !18 ; 2 uses
  %.not181 = icmp eq i8 %i.cf, 0
  br i1 %.not181, label %bb.t, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.cg = getelementptr inbounds nuw i8, ptr %.0142, i64 1 ; 2 uses
  %.not182 = icmp ne i8 %i.cf, 45
  %i.ch = zext i1 %.not182 to i32
  %spec.select = add nsw i32 %.0158, %i.ch        ; 2 uses
  %i.ci = icmp eq i32 %spec.select, %.pre.pre
  br i1 %i.ci, label %bb.t, label %bb.r, !llvm.loop !35

bb.t:                                             ; preds = %bb.s, %bb.r
  %.2160 = phi i32 [ %.pre.pre, %bb.s ], [ %.0158, %bb.r ]
  %.1143 = phi ptr [ %i.cg, %bb.s ], [ %.0142, %bb.r ] ; 2 uses
  %i.cj = ptrtoint ptr %.1143 to i64
  %i.ck = add i64 %i.cj, %13                      ; 2 uses
  %i.cl = trunc i64 %i.ck to i32                  ; 2 uses
  %i.cm = getelementptr inbounds nuw i8, ptr %.0231, i64 28
  %i.cn = load i32, ptr %i.cm, align 4, !tbaa !36 ; 2 uses
  %i.co = icmp eq i32 %.pre.pre, %i.cn
  br i1 %i.co, label %bb.w, label %.preheader205

.preheader205:                                    ; preds = %bb.t, %bb.u
  %.3161 = phi i32 [ %spec.select199, %bb.u ], [ %.2160, %bb.t ]
  %.2 = phi ptr [ %i.cq, %bb.u ], [ %.1143, %bb.t ] ; 3 uses
  %i.cp = load i8, ptr %.2, align 1, !tbaa !18    ; 2 uses
  %.not183 = icmp eq i8 %i.cp, 0
  br i1 %.not183, label %bb.v, label %bb.u

bb.u:                                             ; preds = %.preheader205
  %i.cq = getelementptr inbounds nuw i8, ptr %.2, i64 1 ; 2 uses
  %.not184 = icmp ne i8 %i.cp, 45
  %i.cr = zext i1 %.not184 to i32
  %spec.select199 = add nsw i32 %.3161, %i.cr     ; 2 uses
  %i.cs = icmp eq i32 %spec.select199, %i.cn
  br i1 %i.cs, label %bb.v, label %.preheader205, !llvm.loop !37

bb.v:                                             ; preds = %bb.u, %.preheader205
  %.3 = phi ptr [ %i.cq, %bb.u ], [ %.2, %.preheader205 ]
...
bb.w:                                             ; preds = %bb.v, %bb.t
  %.0153 = phi i32 [ %i.cv, %bb.v ], [ %i.cl, %bb.t ]
  %i.cw = getelementptr inbounds nuw i8, ptr %.0231, i64 32
  %.pre286.pre = load i32, ptr %i.cw, align 8, !tbaa !38 ; 3 uses
  br label %bb.x

bb.x:                                             ; preds = %bb.y, %bb.w
  %.5163 = phi i32 [ -1, %bb.w ], [ %spec.select200, %bb.y ] ; 2 uses
  %.4 = phi ptr [ %15, %bb.w ], [ %i.cy, %bb.y ]  ; 3 uses
  %i.cx = load i8, ptr %.4, align 1, !tbaa !18    ; 2 uses
  %.not185 = icmp eq i8 %i.cx, 0
  br i1 %.not185, label %bb.z, label %bb.y

bb.y:                                             ; preds = %bb.x
  %i.cy = getelementptr inbounds nuw i8, ptr %.4, i64 1 ; 2 uses
  %.not186 = icmp ne i8 %i.cx, 45
  %i.cz = zext i1 %.not186 to i32
  %spec.select200 = add nsw i32 %.5163, %i.cz     ; 2 uses
  %i.da = icmp eq i32 %spec.select200, %.pre286.pre
  br i1 %i.da, label %bb.z, label %bb.x, !llvm.loop !39

bb.z:                                             ; preds = %bb.y, %bb.x
  %.7165 = phi i32 [ %.pre286.pre, %bb.y ], [ %.5163, %bb.x ]
  %.5 = phi ptr [ %i.cy, %bb.y ], [ %.4, %bb.x ]  ; 2 uses
  %i.db = ptrtoint ptr %.5 to i64
  %i.dc = add i64 %i.db, %17                      ; 2 uses
  %i.dd = trunc i64 %i.dc to i32                  ; 2 uses
  %i.de = getelementptr inbounds nuw i8, ptr %.0231, i64 36
  %i.df = load i32, ptr %i.de, align 4, !tbaa !40 ; 2 uses
  %i.dg = icmp eq i32 %.pre286.pre, %i.df
  br i1 %i.dg, label %bb.ac, label %.preheader

.preheader:                                       ; preds = %bb.z, %bb.aa
  %.8 = phi i32 [ %spec.select201, %bb.aa ], [ %.7165, %bb.z ]
  %.6 = phi ptr [ %i.di, %bb.aa ], [ %.5, %bb.z ] ; 3 uses
  %i.dh = load i8, ptr %.6, align 1, !tbaa !18    ; 2 uses
  %.not187 = icmp eq i8 %i.dh, 0
  br i1 %.not187, label %bb.ab, label %bb.aa

bb.aa:                                            ; preds = %.preheader
  %i.di = getelementptr inbounds nuw i8, ptr %.6, i64 1 ; 2 uses
  %.not188 = icmp ne i8 %i.dh, 45
  %i.dj = zext i1 %.not188 to i32
  %spec.select201 = add nsw i32 %.8, %i.dj        ; 2 uses
  %i.dk = icmp eq i32 %spec.select201, %i.df
  br i1 %i.dk, label %bb.ab, label %.preheader, !llvm.loop !41

bb.ab:                                            ; preds = %bb.aa, %.preheader
  %.7 = phi ptr [ %i.di, %bb.aa ], [ %.6, %.preheader ]
...
bb.ac:                                            ; preds = %bb.ab, %bb.z
  %.0152 = phi i32 [ %i.dn, %bb.ab ], [ %i.dd, %bb.z ]
  %sext = shl i64 %i.ck, 32
  %i.do = ashr exact i64 %sext, 32
  %i.dp = getelementptr inbounds i8, ptr %11, i64 %i.do
  %sext189 = shl i64 %i.dc, 32
  %i.dq = ashr exact i64 %sext189, 32
  %i.dr = getelementptr inbounds i8, ptr %15, i64 %i.dq
  %i.ds = getelementptr inbounds nuw i8, ptr %.0231, i64 64
  br label %bb.ad

bb.ad:                                            ; preds = %bb.am, %bb.ac
  %.0156 = phi i32 [ %i.dd, %bb.ac ], [ %.1157, %bb.am ] ; 6 uses
  %.0154 = phi i32 [ %i.cl, %bb.ac ], [ %.1155, %bb.am ] ; 5 uses
  %.0140 = phi ptr [ %i.dp, %bb.ac ], [ %.1141, %bb.am ] ; 5 uses
  %.0139 = phi ptr [ %i.dr, %bb.ac ], [ %.1, %bb.am ] ; 6 uses
  %i.dt = load i8, ptr %.0140, align 1, !tbaa !18 ; 2 uses
  %.not190 = icmp eq i8 %i.dt, 0
  br i1 %.not190, label %.critedge, label %bb.ae

bb.ae:                                            ; preds = %bb.ad
  %i.du = load i8, ptr %.0139, align 1, !tbaa !18 ; 2 uses
  %.not191 = icmp eq i8 %i.du, 0
  br i1 %.not191, label %.critedge, label %bb.af

bb.af:                                            ; preds = %bb.ae
  %.not192 = icmp eq i8 %i.dt, 45                 ; 2 uses
  %.not193 = icmp eq i8 %i.du, 45                 ; 3 uses
  %or.cond202 = or i1 %.not192, %.not193
  br i1 %or.cond202, label %bb.ah, label %bb.ag

bb.ag:                                            ; preds = %bb.af
  %i.dv = load float, ptr %i.ds, align 8, !tbaa !42
  %i.dw = sext i32 %.0154 to i64
  %i.dx = getelementptr inbounds [8 x i8], ptr %i.bs, i64 %i.dw
  %i.dy = load ptr, ptr %i.dx, align 8, !tbaa !12
  %i.dz = sext i32 %.0156 to i64
  ...
  %i.ed = add nsw i32 %.0154, 1
  %i.ee = add nsw i32 %.0156, 1
  %i.ef = getelementptr inbounds nuw i8, ptr %.0140, i64 1
  %i.eg = getelementptr inbounds nuw i8, ptr %.0139, i64 1
  br label %bb.am
...
bb.aj:                                            ; preds = %bb.ai
  %i.eh = add nsw i32 %.0156, 1
  %i.ei = getelementptr inbounds nuw i8, ptr %.0139, i64 1
  br label %bb.am

bb.ak:                                            ; preds = %bb.ah
  %i.ej = add nsw i32 %.0154, 1                   ; 2 uses
  %i.ek = getelementptr inbounds nuw i8, ptr %.0140, i64 1 ; 2 uses
  br i1 %.not193, label %bb.al, label %bb.am

bb.al:                                            ; preds = %bb.ak
  %i.el = add nsw i32 %.0156, 1
  %i.em = getelementptr inbounds nuw i8, ptr %.0139, i64 1
  br label %bb.am

bb.am:                                            ; preds = %bb.ak, %bb.al, %bb.aj, %bb.ai, %bb.ag
  %.1157 = phi i32 [ %i.ee, %bb.ag ], [ %i.eh, %bb.aj ], [ %.0156, %bb.ai ], [ %i.el, %bb.al ], [ %.0156, %bb.ak ] ; 2 uses
  %.1155 = phi i32 [ %i.ed, %bb.ag ], [ %.0154, %bb.aj ], [ %.0154, %bb.ai ], [ %i.ej, %bb.al ], [ %i.ej, %bb.ak ] ; 2 uses
  %.1141 = phi ptr [ %i.ef, %bb.ag ], [ %.0140, %bb.aj ], [ %.0140, %bb.ai ], [ %i.ek, %bb.al ], [ %i.ek, %bb.ak ]
  %.1 = phi ptr [ %i.eg, %bb.ag ], [ %i.ei, %bb.aj ], [ %.0139, %bb.ai ], [ %i.em, %bb.al ], [ %.0139, %bb.ak ]
  %i.en = icmp sgt i32 %.1155, %.0153
  %i.eo = icmp sgt i32 %.1157, %.0152
  %or.cond203 = select i1 %i.en, i1 true, i1 %i.eo
  br i1 %or.cond203, label %.critedge, label %bb.ad, !llvm.loop !43

.critedge:                                        ; preds = %bb.am, %bb.ae, %bb.ad
  %i.ep = getelementptr inbounds nuw i8, ptr %.0231, i64 8
  %.0 = load ptr, ptr %i.ep, align 8, !tbaa !31   ; 2 uses
...
.lr.ph.us:                                        ; preds = %bb.p
  ...
  %14 = getelementptr inbounds nuw [8 x i8], ptr %6, i64 %indvars.iv275
