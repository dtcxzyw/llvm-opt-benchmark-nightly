...
vector.ph1075:                                    ; preds = %vector.memcheck1067
  %n.vec1077 = and i64 %i.n, 4294967288           ; 5 uses
  %i.xu = shl nuw nsw i64 %n.vec1077, 2
  %i.xv = getelementptr i8, ptr %i.xo, i64 %i.xu
  %.cast = trunc nuw i64 %n.vec1077 to i32
  %i.xw = sub i32 %i.o, %.cast
  %13 = shl nuw nsw i64 %n.vec1077, 2
  %i.xx = getelementptr i8, ptr %i.vi, i64 %13
  br label %vector.body1078

vector.body1078:                                  ; preds = %vector.body1078, %vector.ph1075
  %index1079 = phi i64 [ 0, %vector.ph1075 ], [ %index.next1086, %vector.body1078 ] ; 3 uses
  %offset.idx = shl i64 %index1079, 2
  %next.gep = getelementptr i8, ptr %i.xo, i64 %offset.idx ; 2 uses
  %offset.idx1080 = shl i64 %index1079, 2
  %next.gep1081 = getelementptr i8, ptr %i.vi, i64 %offset.idx1080 ; 3 uses
...
begin_hunk_1_@Q__align:bb.a
  ...
  %n.vec1223 = and i64 %i.ahp, 8589934584         ; 5 uses
  %i.ahq = shl nuw nsw i64 %n.vec1223, 2
  %.cast1224 = trunc i64 %n.vec1223 to i32
  %i.ahr = sub i32 %i.o, %.cast1224
  %14 = shl nuw nsw i64 %n.vec1223, 2
...
vector.ph1221:                                    ; preds = %vector.memcheck1213
  ...
  %i.aia = getelementptr i8, ptr %.0466625, i64 %14
  br label %vector.body1225

vector.body1225:                                  ; preds = %vector.body1225, %vector.ph1221
  %index1226 = phi i64 [ 0, %vector.ph1221 ], [ %index.next1235, %vector.body1225 ] ; 3 uses
  %offset.idx1227 = shl i64 %index1226, 2
  %next.gep1228 = getelementptr i8, ptr %i.ahy, i64 %offset.idx1227 ; 2 uses
  %offset.idx1229 = shl i64 %index1226, 2
  %next.gep1230 = getelementptr i8, ptr %.0466625, i64 %offset.idx1229 ; 3 uses
...
vector.ph1322:                                    ; preds = %vector.main.loop.iter.check
  ...
  %n.vec1324 = and i64 %i.asz, 4294967264         ; 6 uses
  %.cast1325 = trunc nuw i64 %n.vec1324 to i32
  %i.atb = sub i32 %i.asy, %.cast1325
  %i.atc = sub nsw i64 0, %n.vec1324
  %i.atd = getelementptr i8, ptr %.012639.i, i64 %i.atc ; 2 uses
  %15 = sub nsw i64 0, %n.vec1324
  %i.ate = getelementptr i8, ptr %.013238.i, i64 %15 ; 2 uses
  br label %vector.body1326

vector.body1326:                                  ; preds = %vector.body1326, %vector.ph1322
  %index1327 = phi i64 [ 0, %vector.ph1322 ], [ %index.next1332, %vector.body1326 ] ; 3 uses
  %offset.idx1328 = sub i64 0, %index1327
  %next.gep1329 = getelementptr i8, ptr %.012639.i, i64 %offset.idx1328 ; 2 uses
  %offset.idx1330 = sub i64 0, %index1327
  %next.gep1331 = getelementptr i8, ptr %.013238.i, i64 %offset.idx1330 ; 2 uses
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec1339 = and i64 %i.asz, 4294967292         ; 5 uses
  %.cast1340 = trunc nuw i64 %n.vec1339 to i32
  %i.atk = sub i32 %i.asy, %.cast1340
  %i.atl = sub nsw i64 0, %n.vec1339
  %i.atm = getelementptr i8, ptr %.012639.i, i64 %i.atl ; 2 uses
  %16 = sub nsw i64 0, %n.vec1339
  %i.atn = getelementptr i8, ptr %.013238.i, i64 %16 ; 2 uses
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index1341 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next1344, %vec.epilog.vector.body ] ; 3 uses
  %i.ato = sub i64 0, %index1341
  %next.gep1342 = getelementptr i8, ptr %.012639.i, i64 %i.ato
  %17 = sub i64 0, %index1341
  %next.gep1343 = getelementptr i8, ptr %.013238.i, i64 %17
...
vector.ph1298:                                    ; preds = %.lr.ph29.preheader.i
  %n.vec1300 = and i64 %i.auu, 2147483640         ; 5 uses
  %.cast1301 = trunc nuw nsw i64 %n.vec1300 to i32
  %i.auw = sub nsw i32 %i.aut, %.cast1301
  %i.aux = sub nsw i64 0, %n.vec1300
  %i.auy = getelementptr i8, ptr %.1127.lcssa.i, i64 %i.aux ; 2 uses
  %18 = sub nsw i64 0, %n.vec1300
  %i.auz = getelementptr i8, ptr %.1133.lcssa.i, i64 %18 ; 2 uses
...
vector.body1302:                                  ; preds = %vector.body1302, %vector.ph1298
  %index1303 = phi i64 [ 0, %vector.ph1298 ], [ %index.next1309, %vector.body1302 ] ; 3 uses
  ...
  %offset.idx1305 = sub i64 0, %index1303
  %next.gep1306 = getelementptr i8, ptr %.1127.lcssa.i, i64 %offset.idx1305 ; 2 uses
  %offset.idx1307 = sub i64 0, %index1303
  %next.gep1308 = getelementptr i8, ptr %.1133.lcssa.i, i64 %offset.idx1307 ; 2 uses
