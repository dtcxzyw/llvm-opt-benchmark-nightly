...
bb.cv:                                            ; preds = %bb.cu
  %i.mz = invoke noalias noundef nonnull dereferenceable(3480) ptr @_Znwm(i64 noundef 3480) #23
          to label %bb.cw unwind label %bb.ct     ; 10 uses
...
.noexc523:                                        ; preds = %bb.cw
  store <2 x ptr> <ptr getelementptr inbounds nuw inrange(-16, 96) (i8, ptr @_ZTVN9NCompress8NDeflate8NDecoder9CCOMCoderE, i64 16), ptr getelementptr inbounds nuw inrange(-16, 48) (i8, ptr @_ZTVN9NCompress8NDeflate8NDecoder9CCOMCoderE, i64 128)>, ptr %i.mz, align 8, !tbaa !25
  %i.na = getelementptr inbounds nuw i8, ptr %i.mz, i64 16
  store <2 x ptr> <ptr getelementptr inbounds nuw inrange(-16, 56) (i8, ptr @_ZTVN9NCompress8NDeflate8NDecoder9CCOMCoderE, i64 192), ptr getelementptr inbounds nuw inrange(-16, 48) (i8, ptr @_ZTVN9NCompress8NDeflate8NDecoder9CCOMCoderE, i64 264)>, ptr %i.na, align 8, !tbaa !25
...
bb.di:                                            ; preds = %bb.dh
  %i.ob = invoke noalias noundef nonnull dereferenceable(2024) ptr @_Znwm(i64 noundef 2024) #23
          to label %bb.dj unwind label %bb.ct     ; 17 uses
...
bb.dj:                                            ; preds = %bb.di
  ...
  store <2 x ptr> <ptr getelementptr inbounds nuw inrange(-16, 72) (i8, ptr @_ZTVN9NCompress8NQuantum8CDecoderE, i64 16), ptr getelementptr inbounds nuw inrange(-16, 56) (i8, ptr @_ZTVN9NCompress8NQuantum8CDecoderE, i64 104)>, ptr %i.ob, align 8, !tbaa !25
