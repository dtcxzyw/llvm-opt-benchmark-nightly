...
.preheader141.lr.ph:                              ; preds = %_ZN9benchmark5State13StateIteratorC2EPS0_.exit
  ...
  %min.iters.check971 = icmp ult i64 %1, 2
  %n.vec974 = and i64 %1, -2                      ; 2 uses
  %i.ct = or i64 %1, 1
  %cmp.n995 = icmp eq i64 %1, %n.vec974
  %min.iters.check863 = icmp ult i64 %1, 2
  %n.vec866 = and i64 %1, -2                      ; 2 uses
  %i.cu = or i64 %1, 1
  %cmp.n887 = icmp eq i64 %1, %n.vec866
  %min.iters.check755 = icmp ult i64 %1, 2
  %n.vec758 = and i64 %1, -2                      ; 2 uses
  %i.cv = or i64 %1, 1
  %cmp.n779 = icmp eq i64 %1, %n.vec758
  %min.iters.check647 = icmp ult i64 %1, 2
  %n.vec650 = and i64 %1, -2                      ; 2 uses
  %i.cw = or i64 %1, 1
  %cmp.n671 = icmp eq i64 %1, %n.vec650
  %min.iters.check539 = icmp ult i64 %1, 2
  %n.vec542 = and i64 %1, -2                      ; 2 uses
  %i.cx = or i64 %1, 1
  %cmp.n563 = icmp eq i64 %1, %n.vec542
  %min.iters.check427 = icmp ult i64 %1, 2
  %n.vec430 = and i64 %1, -2                      ; 2 uses
  %i.cy = or i64 %1, 1
  %cmp.n455 = icmp eq i64 %1, %n.vec430
  %min.iters.check321 = icmp ult i64 %1, 2
  %n.vec324 = and i64 %1, -2                      ; 2 uses
  %i.cz = or i64 %1, 1
  %cmp.n333 = icmp eq i64 %1, %n.vec324
  %i.da = and i64 %i.z, 1
  %lcmp.mod.not.not = icmp eq i64 %i.da, 0
  %min.iters.check288 = icmp ult i64 %1, 2
  %n.vec291 = and i64 %1, -2                      ; 2 uses
  %i.db = or i64 %1, 1
  %cmp.n300 = icmp eq i64 %1, %n.vec291
  %i.dc = and i64 %i.z, 1
  %lcmp.mod1006.not.not = icmp eq i64 %i.dc, 0
  %min.iters.check255 = icmp ult i64 %1, 2
  %n.vec258 = and i64 %1, -2                      ; 2 uses
  %i.dd = or i64 %1, 1
  %cmp.n267 = icmp eq i64 %1, %n.vec258
  %i.de = and i64 %i.z, 1
  %lcmp.mod1008.not.not = icmp eq i64 %i.de, 0
  %min.iters.check222 = icmp ult i64 %1, 2
  %n.vec225 = and i64 %1, -2                      ; 2 uses
  %i.df = or i64 %1, 1
  %cmp.n234 = icmp eq i64 %1, %n.vec225
  %i.dg = and i64 %i.z, 1
...
vector.memcheck889:                               ; preds = %.preheader138.us.preheader
  ...
  %scevgep891 = getelementptr i8, ptr %i.dq, i64 %2 ; 9 uses
  %scevgep892 = getelementptr i8, ptr %i.ds, i64 8 ; 9 uses
  %scevgep893 = getelementptr i8, ptr %i.ds, i64 %2 ; 9 uses
  %scevgep894 = getelementptr i8, ptr %i.dj, i64 %i.cs ; 2 uses
  %scevgep895 = getelementptr i8, ptr %i.dk, i64 %i.cs ; 2 uses
  %scevgep896 = getelementptr i8, ptr %i.dl, i64 %2 ; 2 uses
  %scevgep897 = getelementptr i8, ptr %i.dm, i64 %2 ; 2 uses
  %scevgep898 = getelementptr i8, ptr %i.dn, i64 %2 ; 2 uses
  %scevgep899 = getelementptr i8, ptr %i.do, i64 %2 ; 2 uses
  %scevgep900 = getelementptr i8, ptr %i.dp, i64 %i.cs ; 2 uses
  %scevgep901 = getelementptr i8, ptr %i.dr, i64 8 ; 2 uses
  %scevgep902 = getelementptr i8, ptr %i.dr, i64 %2 ; 2 uses
...
vector.memcheck781:                               ; preds = %"._Z6forallIZL18BM_HYDRO_2D_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge.us"
  ...
  %scevgep783 = getelementptr i8, ptr %i.gu, i64 %2 ; 2 uses
  %scevgep784 = getelementptr i8, ptr %i.gv, i64 8 ; 2 uses
  %scevgep785 = getelementptr i8, ptr %i.gv, i64 %2 ; 2 uses
  %scevgep786 = getelementptr i8, ptr %i.gq, i64 %i.cs
  %scevgep787 = getelementptr i8, ptr %i.gr, i64 %i.cs
  %scevgep788 = getelementptr i8, ptr %i.dj, i64 %2
  %scevgep789 = getelementptr i8, ptr %i.dk, i64 %2
  %scevgep790 = getelementptr i8, ptr %i.gs, i64 %2
  %scevgep791 = getelementptr i8, ptr %i.dp, i64 %2
  %scevgep792 = getelementptr i8, ptr %i.gt, i64 %i.cs
  %scevgep793 = getelementptr i8, ptr %i.dn, i64 8
  %scevgep794 = getelementptr i8, ptr %i.dn, i64 %2
...
vector.memcheck673:                               ; preds = %"._Z6forallIZL18BM_HYDRO_2D_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge.us.1"
  ...
  %scevgep675 = getelementptr i8, ptr %i.ld, i64 %2 ; 2 uses
  %scevgep676 = getelementptr i8, ptr %i.le, i64 8 ; 2 uses
  %scevgep677 = getelementptr i8, ptr %i.le, i64 %2 ; 2 uses
  %scevgep678 = getelementptr i8, ptr %i.kz, i64 %i.cs
  %scevgep679 = getelementptr i8, ptr %i.la, i64 %i.cs
  %scevgep680 = getelementptr i8, ptr %i.gq, i64 %2
  %scevgep681 = getelementptr i8, ptr %i.gr, i64 %2
  %scevgep682 = getelementptr i8, ptr %i.lb, i64 %2
  %scevgep683 = getelementptr i8, ptr %i.gt, i64 %2
  %scevgep684 = getelementptr i8, ptr %i.lc, i64 %i.cs
  %scevgep685 = getelementptr i8, ptr %i.gs, i64 8
  %scevgep686 = getelementptr i8, ptr %i.gs, i64 %2
...
vector.memcheck565:                               ; preds = %"._Z6forallIZL18BM_HYDRO_2D_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge.us.2"
  ...
  %scevgep567 = getelementptr i8, ptr %i.pm, i64 %2 ; 2 uses
  %scevgep568 = getelementptr i8, ptr %i.pn, i64 8 ; 2 uses
  %scevgep569 = getelementptr i8, ptr %i.pn, i64 %2 ; 2 uses
  %scevgep570 = getelementptr i8, ptr %i.pi, i64 %i.cs
  %scevgep571 = getelementptr i8, ptr %i.pj, i64 %i.cs
  %scevgep572 = getelementptr i8, ptr %i.kz, i64 %2
  %scevgep573 = getelementptr i8, ptr %i.la, i64 %2
  %scevgep574 = getelementptr i8, ptr %i.pk, i64 %2
  %scevgep575 = getelementptr i8, ptr %i.lc, i64 %2
  %scevgep576 = getelementptr i8, ptr %i.pl, i64 %i.cs
  %scevgep577 = getelementptr i8, ptr %i.lb, i64 8
  %scevgep578 = getelementptr i8, ptr %i.lb, i64 %2
...
vector.memcheck457:                               ; preds = %"._Z6forallIZL18BM_HYDRO_2D_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge.us.3"
  ...
  %scevgep459 = getelementptr i8, ptr %i.tv, i64 %2 ; 2 uses
  %scevgep460 = getelementptr i8, ptr %i.tw, i64 8 ; 2 uses
  %scevgep461 = getelementptr i8, ptr %i.tw, i64 %2 ; 2 uses
  %scevgep462 = getelementptr i8, ptr %i.tr, i64 %i.cs
  %scevgep463 = getelementptr i8, ptr %i.ts, i64 %i.cs
  %scevgep464 = getelementptr i8, ptr %i.pi, i64 %2
  %scevgep465 = getelementptr i8, ptr %i.pj, i64 %2
  %scevgep466 = getelementptr i8, ptr %i.tt, i64 %2
  %scevgep467 = getelementptr i8, ptr %i.pl, i64 %2
  %scevgep468 = getelementptr i8, ptr %i.tu, i64 %i.cs
  %scevgep469 = getelementptr i8, ptr %i.pk, i64 8
  %scevgep470 = getelementptr i8, ptr %i.pk, i64 %2
...
vector.memcheck335:                               ; preds = %.preheader137.us
  ...
  %scevgep336 = getelementptr i8, ptr %i.yn, i64 %2 ; 10 uses
  %scevgep337 = getelementptr i8, ptr %i.yu, i64 8 ; 10 uses
  %scevgep338 = getelementptr i8, ptr %i.yu, i64 %2 ; 10 uses
  %scevgep339 = getelementptr i8, ptr %i.ye, i64 %2 ; 2 uses
  %scevgep340 = getelementptr i8, ptr %i.yc, i64 %i.cr ; 2 uses
  %scevgep341 = getelementptr nuw i8, ptr %i.yb, i64 8 ; 2 uses
  %scevgep342 = getelementptr i8, ptr %i.yb, i64 %2 ; 2 uses
  %scevgep343 = getelementptr nuw i8, ptr %i.yh, i64 8 ; 2 uses
  %scevgep344 = getelementptr i8, ptr %i.yh, i64 %2 ; 2 uses
  %scevgep345 = getelementptr nuw i8, ptr %i.yj, i64 8 ; 2 uses
  %scevgep346 = getelementptr i8, ptr %i.yj, i64 %2 ; 2 uses
  %scevgep347 = getelementptr nuw i8, ptr %i.yl, i64 8 ; 2 uses
  %scevgep348 = getelementptr i8, ptr %i.yl, i64 %2 ; 2 uses
  %scevgep349 = getelementptr i8, ptr %i.ya, i64 %i.cr ; 2 uses
  %scevgep350 = getelementptr i8, ptr %i.yq, i64 8 ; 2 uses
  %scevgep351 = getelementptr i8, ptr %i.yq, i64 %2 ; 2 uses
  %scevgep352 = getelementptr i8, ptr %i.ys, i64 8 ; 2 uses
  %scevgep353 = getelementptr i8, ptr %i.ys, i64 %2 ; 2 uses
