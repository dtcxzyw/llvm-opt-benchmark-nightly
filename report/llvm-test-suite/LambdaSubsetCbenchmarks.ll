...
bb.a:
  ...
  %1 = getelementptr inbounds nuw i8, ptr %i.a, i64 400
  %2 = load double, ptr %1, align 8, !tbaa !11    ; 2 uses
  ...
  %3 = getelementptr inbounds nuw i8, ptr %i.a, i64 424
  %4 = load double, ptr %3, align 8, !tbaa !11    ; 2 uses
  ...
  %5 = getelementptr inbounds nuw i8, ptr %i.a, i64 448
  %6 = load double, ptr %5, align 8, !tbaa !11    ; 2 uses
...
.preheader.lr.ph.split:                           ; preds = %.preheader.lr.ph
  ...
  %7 = insertelement <2 x double> poison, double %i.s, i64 0 ; 2 uses
  %8 = insertelement <2 x double> poison, double %i.w, i64 0 ; 2 uses
  %9 = insertelement <2 x double> poison, double %i.aa, i64 0 ; 2 uses
  br label %.preheader
...
bb.b:                                             ; preds = %.preheader, %bb.b
  ...
  %i.by = load double, ptr %i.bg, align 8, !tbaa !11
  %i.bz = load double, ptr %i.bo, align 8, !tbaa !11
  %10 = getelementptr i8, ptr %i.av, i64 16
  %11 = load double, ptr %10, align 8, !tbaa !11
  %i.ca = load double, ptr %i.bx, align 8, !tbaa !11 ; 2 uses
  %i.cb = tail call double @llvm.fmuladd.f64(double %i.q, double %i.by, double %i.ca)
  %i.cc = tail call double @llvm.fmuladd.f64(double %2, double %i.bz, double %i.cb)
  %12 = insertelement <2 x double> %7, double %i.ca, i64 1
  %13 = insertelement <2 x double> <double poison, double -2.000000e+00>, double %i.bv, i64 0
  %14 = insertelement <2 x double> poison, double %i.cc, i64 0
  %15 = insertelement <2 x double> %14, double %11, i64 1
  %16 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %12, <2 x double> %13, <2 x double> %15) ; 2 uses
  %i.cd = load double, ptr %i.av, align 8, !tbaa !11
  %17 = extractelement <2 x double> %16, i64 1
  %i.ce = fadd double %17, %i.cd
  %18 = extractelement <2 x double> %16, i64 0
  %i.cf = tail call double @llvm.fmuladd.f64(double %i.o, double %i.ce, double %18)
  ...
  %19 = load double, ptr %i.bg, align 8, !tbaa !11
  %i.ck = load double, ptr %i.bo, align 8, !tbaa !11
  %i.cl = load double, ptr %i.bw, align 8, !tbaa !11
  %20 = getelementptr i8, ptr %i.au, i64 16
  %21 = load double, ptr %20, align 8, !tbaa !11
  %i.cm = load double, ptr %i.cj, align 8, !tbaa !11 ; 2 uses
  %22 = tail call double @llvm.fmuladd.f64(double %i.u, double %19, double %i.cm)
  %i.cn = tail call double @llvm.fmuladd.f64(double %4, double %i.ck, double %22)
  %23 = insertelement <2 x double> %8, double %i.cm, i64 1
  %24 = insertelement <2 x double> <double poison, double -2.000000e+00>, double %i.cl, i64 0
  %25 = insertelement <2 x double> poison, double %i.cn, i64 0
  %26 = insertelement <2 x double> %25, double %21, i64 1
  %27 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %23, <2 x double> %24, <2 x double> %26) ; 2 uses
  %i.co = load double, ptr %i.au, align 8, !tbaa !11
  %28 = extractelement <2 x double> %27, i64 1
  %i.cp = fadd double %28, %i.co
  %29 = extractelement <2 x double> %27, i64 0
  %i.cq = tail call double @llvm.fmuladd.f64(double %i.o, double %i.cp, double %29)
  ...
  %30 = load double, ptr %i.bg, align 8, !tbaa !11
  %i.cv = load double, ptr %i.bo, align 8, !tbaa !11
  %i.cw = load double, ptr %i.bw, align 8, !tbaa !11
  %31 = getelementptr i8, ptr %i.at, i64 16
  %32 = load double, ptr %31, align 8, !tbaa !11
  %i.cx = load double, ptr %i.cu, align 8, !tbaa !11 ; 2 uses
  %33 = tail call double @llvm.fmuladd.f64(double %i.y, double %30, double %i.cx)
  %i.cy = tail call double @llvm.fmuladd.f64(double %6, double %i.cv, double %33)
  %34 = insertelement <2 x double> %9, double %i.cx, i64 1
  %35 = insertelement <2 x double> <double poison, double -2.000000e+00>, double %i.cw, i64 0
  %36 = insertelement <2 x double> poison, double %i.cy, i64 0
  %37 = insertelement <2 x double> %36, double %32, i64 1
  %38 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %34, <2 x double> %35, <2 x double> %37) ; 2 uses
  %i.cz = load double, ptr %i.at, align 8, !tbaa !11
  %39 = extractelement <2 x double> %38, i64 1
  %i.da = fadd double %39, %i.cz
  %40 = extractelement <2 x double> %38, i64 0
  %i.db = tail call double @llvm.fmuladd.f64(double %i.o, double %i.da, double %40)
...
"._Z6forallIZL13BM_ADI_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge": ; preds = %bb.b, %"._Z6forallIZL13BM_ADI_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge"
  ...
  %i.ek = load double, ptr %i.ds, align 8, !tbaa !11
  %i.el = load double, ptr %i.ea, align 8, !tbaa !11
  %41 = getelementptr i8, ptr %i.dh, i64 24
  %42 = load double, ptr %41, align 8, !tbaa !11
  %i.em = load double, ptr %i.ej, align 8, !tbaa !11 ; 2 uses
  %i.en = tail call double @llvm.fmuladd.f64(double %i.q, double %i.ek, double %i.em)
  %i.eo = tail call double @llvm.fmuladd.f64(double %2, double %i.el, double %i.en)
  %43 = insertelement <2 x double> %7, double %i.em, i64 1
  %44 = insertelement <2 x double> <double poison, double -2.000000e+00>, double %i.eh, i64 0
  %45 = insertelement <2 x double> poison, double %i.eo, i64 0
  %46 = insertelement <2 x double> %45, double %42, i64 1
  %47 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %43, <2 x double> %44, <2 x double> %46) ; 2 uses
  %i.ep = getelementptr i8, ptr %i.dh, i64 8
  %i.eq = load double, ptr %i.ep, align 8, !tbaa !11
  %48 = extractelement <2 x double> %47, i64 1
  %i.er = fadd double %48, %i.eq
  %49 = extractelement <2 x double> %47, i64 0
  %i.es = tail call double @llvm.fmuladd.f64(double %i.o, double %i.er, double %49)
  ...
  %50 = load double, ptr %i.ds, align 8, !tbaa !11
  %i.ex = load double, ptr %i.ea, align 8, !tbaa !11
  %i.ey = load double, ptr %i.ei, align 8, !tbaa !11
  %51 = getelementptr i8, ptr %i.dg, i64 24
  %52 = load double, ptr %51, align 8, !tbaa !11
  %i.ez = load double, ptr %i.ew, align 8, !tbaa !11 ; 2 uses
  %53 = tail call double @llvm.fmuladd.f64(double %i.u, double %50, double %i.ez)
  %i.fa = tail call double @llvm.fmuladd.f64(double %4, double %i.ex, double %53)
  %54 = insertelement <2 x double> %8, double %i.ez, i64 1
  %55 = insertelement <2 x double> <double poison, double -2.000000e+00>, double %i.ey, i64 0
  %56 = insertelement <2 x double> poison, double %i.fa, i64 0
  %57 = insertelement <2 x double> %56, double %52, i64 1
  %58 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %54, <2 x double> %55, <2 x double> %57) ; 2 uses
  %i.fb = getelementptr i8, ptr %i.dg, i64 8
  %i.fc = load double, ptr %i.fb, align 8, !tbaa !11
  %59 = extractelement <2 x double> %58, i64 1
  %i.fd = fadd double %59, %i.fc
  %60 = extractelement <2 x double> %58, i64 0
  %i.fe = tail call double @llvm.fmuladd.f64(double %i.o, double %i.fd, double %60)
  ...
  %61 = load double, ptr %i.ds, align 8, !tbaa !11
  %i.fj = load double, ptr %i.ea, align 8, !tbaa !11
  %i.fk = load double, ptr %i.ei, align 8, !tbaa !11
  %62 = getelementptr i8, ptr %i.df, i64 24
  %63 = load double, ptr %62, align 8, !tbaa !11
  %i.fl = load double, ptr %i.fi, align 8, !tbaa !11 ; 2 uses
  %64 = tail call double @llvm.fmuladd.f64(double %i.y, double %61, double %i.fl)
  %i.fm = tail call double @llvm.fmuladd.f64(double %6, double %i.fj, double %64)
  %65 = insertelement <2 x double> %9, double %i.fl, i64 1
  %66 = insertelement <2 x double> <double poison, double -2.000000e+00>, double %i.fk, i64 0
  %67 = insertelement <2 x double> poison, double %i.fm, i64 0
  %68 = insertelement <2 x double> %67, double %63, i64 1
  %69 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %65, <2 x double> %66, <2 x double> %68) ; 2 uses
  %i.fn = getelementptr i8, ptr %i.df, i64 8
  %i.fo = load double, ptr %i.fn, align 8, !tbaa !11
  %70 = extractelement <2 x double> %69, i64 1
  %i.fp = fadd double %70, %i.fo
  %71 = extractelement <2 x double> %69, i64 0
  %i.fq = tail call double @llvm.fmuladd.f64(double %i.o, double %i.fp, double %71)
...
bb.a:
  %i.a = tail call noundef nonnull align 8 dereferenceable(1616) ptr @_Z11getLoopDatav() ; 12 uses
  tail call void @_Z8loopInitj(i32 noundef 25)
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  %i.c = getelementptr inbounds nuw i8, ptr %i.a, i64 24
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !8    ; 7 uses
  %i.e = load <2 x ptr>, ptr %i.b, align 8, !tbaa !8 ; 3 uses
  %1 = extractelement <2 x ptr> %i.e, i64 1       ; 7 uses
  %2 = extractelement <2 x ptr> %i.e, i64 0       ; 5 uses
...
.lr.ph127.split.us.preheader:                     ; preds = %.lr.ph127
  ...
  %scevgep = getelementptr i8, ptr %2, i64 %i.ai  ; 2 uses
  %scevgep157 = getelementptr i8, ptr %i.q, i64 %i.ai ; 3 uses
  %scevgep158 = getelementptr i8, ptr %1, i64 %i.ai ; 4 uses
  %scevgep159 = getelementptr i8, ptr %i.i, i64 %i.ai ; 3 uses
  %scevgep160 = getelementptr i8, ptr %i.d, i64 %i.ai ; 3 uses
  ...
  %3 = insertelement <8 x ptr> poison, ptr %i.q, i64 0
  %4 = insertelement <8 x ptr> %3, ptr %2, i64 1
  %5 = insertelement <8 x ptr> %4, ptr %i.i, i64 2
  %i.ap = insertelement <8 x ptr> %5, ptr %1, i64 5
  %i.aq = insertelement <8 x ptr> %i.ap, ptr %i.d, i64 7
  %6 = shufflevector <8 x ptr> %i.aq, <8 x ptr> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 1, i32 1, i32 5, i32 0, i32 7>
  ...
  %7 = insertelement <4 x ptr> poison, ptr %i.q, i64 0
  %8 = insertelement <4 x ptr> %7, ptr %1, i64 1
  %i.ay = insertelement <4 x ptr> %8, ptr %i.d, i64 2
  %9 = shufflevector <4 x ptr> %i.ay, <4 x ptr> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 1>
  ...
  %10 = insertelement <4 x ptr> poison, ptr %i.m, i64 0
  %i.bd = insertelement <4 x ptr> %10, ptr %i.i, i64 1
  %i.be = insertelement <4 x ptr> %i.bd, ptr %1, i64 2
  ...
  %11 = shufflevector <2 x ptr> %i.e, <2 x ptr> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %min.iters.check = icmp samesign ult i64 %wide.trip.count, 2
  %i.bk = insertelement <8 x ptr> %11, ptr %i.d, i64 3
  %i.bl = insertelement <8 x ptr> %i.bk, ptr %i.m, i64 4
  %i.bm = insertelement <8 x ptr> %i.bl, ptr %i.q, i64 5
  %12 = insertelement <8 x ptr> %i.bm, ptr %i.i, i64 6
  %13 = shufflevector <8 x ptr> %12, <8 x ptr> poison, <8 x i32> <i32 0, i32 1, i32 0, i32 3, i32 4, i32 5, i32 6, i32 5>
  %14 = icmp ult <8 x ptr> %13, %i.ao
  %i.bn = icmp ult <8 x ptr> %6, %i.ax
  %i.bo = and <8 x i1> %14, %i.bn                 ; 2 uses
  %i.bp = icmp ult <4 x ptr> %9, %i.bc
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %"_ZZL16BM_PIC_1D_LAMBDARN9benchmark5StateEENK3$_0clEi.exit.us"
  ...
  %i.by = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv
  ...
  %i.cd = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv
...
vector.body:                                      ; preds = %"_Z6forallIZL16BM_PIC_1D_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit.us.preheader", %vector.body
  ...
  %i.cp = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %index ; 2 uses
  ...
  %i.cs = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %index ; 3 uses
  %wide.load206 = load <2 x double>, ptr %i.cs, align 8, !tbaa !11, !alias.scope !113, !noalias !114
  %i.ct = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %index
...
"_Z6forallIZL16BM_PIC_1D_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit.us": ; preds = %"_Z6forallIZL16BM_PIC_1D_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit.us.preheader211", %"_Z6forallIZL16BM_PIC_1D_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit.us"
  ...
  %i.dj = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv143 ; 2 uses
  ...
  %i.do = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv143 ; 3 uses
  %i.dp = load double, ptr %i.do, align 8, !tbaa !11
  %i.dq = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv143
