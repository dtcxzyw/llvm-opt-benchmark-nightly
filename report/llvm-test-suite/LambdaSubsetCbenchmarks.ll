...
bb.b:                                             ; preds = %.preheader, %bb.b
  %i.az = phi ptr [ %.pre115, %.preheader ], [ %i.bw, %bb.b ] ; 4 uses
  %i.ba = phi ptr [ %.pre113, %.preheader ], [ %i.bo, %bb.b ] ; 4 uses
  %i.bb = phi ptr [ %.pre111, %.preheader ], [ %i.bg, %bb.b ] ; 4 uses
  ...
  %i.ce = load double, ptr %i.cd, align 8, !tbaa !11 ; 2 uses
  %i.cf = load double, ptr %i.bm, align 8, !tbaa !11
  %1 = tail call double @llvm.fmuladd.f64(double %i.q, double %i.cf, double %i.ce)
  %2 = load double, ptr %i.bu, align 8, !tbaa !11
  %i.cg = tail call double @llvm.fmuladd.f64(double %i.s, double %2, double %1)
  %i.ch = tail call double @llvm.fmuladd.f64(double %i.u, double %i.cb, double %i.cg)
  %3 = getelementptr i8, ptr %i.bb, i64 16
  %4 = load double, ptr %3, align 8, !tbaa !11
  %5 = tail call double @llvm.fmuladd.f64(double %i.ce, double -2.000000e+00, double %4)
  %i.ci = load double, ptr %i.bb, align 8, !tbaa !11
  %i.cj = fadd double %5, %i.ci
  %i.ck = tail call double @llvm.fmuladd.f64(double %i.o, double %i.cj, double %i.ch)
  ...
  %i.ct = fadd double %12, %i.cs
  %i.cu = tail call double @llvm.fmuladd.f64(double %i.o, double %i.ct, double %9)
  ...
  %i.da = load double, ptr %i.bm, align 8, !tbaa !11
  %13 = tail call double @llvm.fmuladd.f64(double %i.ac, double %i.da, double %i.cz)
  %14 = load double, ptr %i.bu, align 8, !tbaa !11
  %i.db = tail call double @llvm.fmuladd.f64(double %i.ae, double %14, double %13)
  %15 = load double, ptr %i.cc, align 8, !tbaa !11
  %16 = tail call double @llvm.fmuladd.f64(double %i.ag, double %15, double %i.db)
  %17 = getelementptr i8, ptr %i.az, i64 16
  %18 = load double, ptr %17, align 8, !tbaa !11
  %19 = tail call double @llvm.fmuladd.f64(double %i.cz, double -2.000000e+00, double %18)
  %i.dc = load double, ptr %i.az, align 8, !tbaa !11
  %i.dd = fadd double %19, %i.dc
  %i.de = tail call double @llvm.fmuladd.f64(double %i.o, double %i.dd, double %16)
...
"._Z6forallIZL13BM_ADI_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge": ; preds = %bb.b, %"._Z6forallIZL13BM_ADI_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge"
  %i.di = phi ptr [ %i.ef, %"._Z6forallIZL13BM_ADI_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge" ], [ %.pre115, %bb.b ] ; 4 uses
  %i.dj = phi ptr [ %i.dx, %"._Z6forallIZL13BM_ADI_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge" ], [ %.pre120, %bb.b ] ; 4 uses
  %i.dk = phi ptr [ %i.dp, %"._Z6forallIZL13BM_ADI_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge" ], [ %.pre119, %bb.b ] ; 4 uses
  ...
  %20 = tail call double @llvm.fmuladd.f64(double %i.q, double %i.eo, double %i.en)
  %21 = load double, ptr %i.ed, align 8, !tbaa !11
  %i.ep = tail call double @llvm.fmuladd.f64(double %i.s, double %21, double %20)
  %i.eq = tail call double @llvm.fmuladd.f64(double %i.u, double %i.ek, double %i.ep)
  %22 = getelementptr i8, ptr %i.dk, i64 24
  %23 = load double, ptr %22, align 8, !tbaa !11
  %24 = tail call double @llvm.fmuladd.f64(double %i.en, double -2.000000e+00, double %23)
  %i.er = getelementptr i8, ptr %i.dk, i64 8
  %i.es = load double, ptr %i.er, align 8, !tbaa !11
  %i.et = fadd double %24, %i.es
  %i.eu = tail call double @llvm.fmuladd.f64(double %i.o, double %i.et, double %i.eq)
  ...
  %25 = tail call double @llvm.fmuladd.f64(double %i.w, double %i.fa, double %i.ez)
  %26 = load double, ptr %i.ed, align 8, !tbaa !11
  %i.fb = tail call double @llvm.fmuladd.f64(double %i.y, double %26, double %25)
  %27 = load double, ptr %i.el, align 8, !tbaa !11
  %28 = tail call double @llvm.fmuladd.f64(double %i.aa, double %27, double %i.fb)
  %29 = getelementptr i8, ptr %i.dj, i64 24
  %30 = load double, ptr %29, align 8, !tbaa !11
  %31 = tail call double @llvm.fmuladd.f64(double %i.ez, double -2.000000e+00, double %30)
  %i.fc = getelementptr i8, ptr %i.dj, i64 8
  %i.fd = load double, ptr %i.fc, align 8, !tbaa !11
  %i.fe = fadd double %31, %i.fd
  %i.ff = tail call double @llvm.fmuladd.f64(double %i.o, double %i.fe, double %28)
  ...
  %32 = tail call double @llvm.fmuladd.f64(double %i.ac, double %i.fl, double %i.fk)
  %33 = load double, ptr %i.ed, align 8, !tbaa !11
  %i.fm = tail call double @llvm.fmuladd.f64(double %i.ae, double %33, double %32)
  %34 = load double, ptr %i.el, align 8, !tbaa !11
  %35 = tail call double @llvm.fmuladd.f64(double %i.ag, double %34, double %i.fm)
  %36 = getelementptr i8, ptr %i.di, i64 24
