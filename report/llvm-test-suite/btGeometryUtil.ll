...
begin_hunk_0_@_ZN14btGeometryUtil29getVerticesFromPlaneEquationsERK20btAlignedObjectArrayI9btVector3ERS2_:bb.a
  ...
  %2 = insertelement <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, float %i.ca, i64 0
  %3 = shufflevector <4 x float> %2, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %i.cf = insertelement <4 x float> <float poison, float poison, float poison, float 1.000000e+00>, float %i.ao, i64 2
  ...
  %4 = fmul <4 x float> %3, %i.ch
  %5 = insertelement <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, float %i.cb, i64 0
  %6 = shufflevector <4 x float> %5, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %i.ci = insertelement <4 x float> <float poison, float poison, float poison, float 1.000000e+00>, float %i.ax, i64 2
