...
define dso_local noundef i32 @_ZN8NArchive3N7z8CEncoder16CreateMixerCoderEPKy(ptr noundef nonnull align 8 dereferenceable(433) initializes((0, 8)) %0, ptr noundef %1) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %2 = alloca %class.CMyComPtr.9, align 8         ; 10 uses
  %3 = alloca %class.CMyComPtr, align 8           ; 10 uses
  %4 = alloca %class.CMyComPtr.11, align 8        ; 9 uses
  %5 = alloca %class.CMyComPtr.12, align 8        ; 8 uses
  %i.a = tail call noalias noundef nonnull dereferenceable(224) ptr @_Znwm(i64 noundef 224) #15 ; 24 uses
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  %i.c = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store i32 0, ptr %i.c, align 4, !tbaa !8
  store ptr getelementptr inbounds nuw inrange(-16, 72) (i8, ptr @_ZTVN11NCoderMixer14CCoderMixer2MTE, i64 16), ptr %i.a, align 8, !tbaa !10
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN11NCoderMixer14CCoderMixer2MTE, i64 104), ptr %i.b, align 8, !tbaa !10
  %i.d = getelementptr inbounds nuw i8, ptr %i.a, i64 24
  %i.e = getelementptr inbounds nuw i8, ptr %i.a, i64 32
  %i.f = getelementptr inbounds nuw i8, ptr %i.a, i64 48
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.e, i8 0, i64 16, i1 false)
  store i64 8, ptr %i.f, align 8, !tbaa !12
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTV13CRecordVectorIN11NCoderMixer17CCoderStreamsInfoEE, i64 16), ptr %i.d, align 8, !tbaa !10
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTV13CRecordVectorIN11NCoderMixer9CBindPairEE, i64 16), ptr %i.g, align 8, !tbaa !10
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTV13CRecordVectorIjE, i64 16), ptr %i.j, align 8, !tbaa !10
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTV13CRecordVectorIjE, i64 16), ptr %i.m, align 8, !tbaa !10
  %i.p = getelementptr inbounds nuw i8, ptr %i.a, i64 152
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTV13CObjectVectorI13CStreamBinderE, i64 16), ptr %i.p, align 8, !tbaa !10
  %i.s = getelementptr inbounds nuw i8, ptr %i.a, i64 192
  %i.t = getelementptr inbounds nuw i8, ptr %i.a, i64 200
  %i.u = getelementptr inbounds nuw i8, ptr %i.a, i64 216
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTV13CObjectVectorIN11NCoderMixer7CCoder2EE, i64 16), ptr %i.s, align 8, !tbaa !10
  store ptr %i.a, ptr %0, align 8, !tbaa !16
  %i.v = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.w = load ptr, ptr getelementptr inbounds nuw inrange(-24, 64) (i8, ptr @_ZTVN11NCoderMixer14CCoderMixer2MTE, i64 24), align 8
  %i.x = tail call noundef i32 %i.w(ptr noundef nonnull align 8 dereferenceable(8) %i.a), !inline_history !35 ; 0 uses
  %i.y = load ptr, ptr %i.v, align 8, !tbaa !36   ; 3 uses
  %.not6.i = icmp eq ptr %i.y, null
  br i1 %.not6.i, label %_ZN9CMyComPtrI15ICompressCoder2EaSEPS0_.exit, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.z = load ptr, ptr %i.y, align 8, !tbaa !10
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 16
  %i.ab = load ptr, ptr %i.aa, align 8
  %i.ac = tail call noundef i32 %i.ab(ptr noundef nonnull align 8 dereferenceable(8) %i.y), !inline_history !35 ; 0 uses
  br label %_ZN9CMyComPtrI15ICompressCoder2EaSEPS0_.exit

_ZN9CMyComPtrI15ICompressCoder2EaSEPS0_.exit:     ; preds = %bb.a, %bb.b
  store ptr %i.a, ptr %i.v, align 8, !tbaa !36
  %i.ad = load ptr, ptr %0, align 8, !tbaa !16    ; 2 uses
  ...
  %i.ai = tail call noundef i32 %i.ah(ptr noundef nonnull align 8 dereferenceable(224) %i.ad, ptr noundef nonnull align 8 dereferenceable(128) %i.ae) ; 2 uses
  %.not.not = icmp eq i32 %i.ai, 0
  br i1 %.not.not, label %.preheader, label %.loopexit

.preheader:                                       ; preds = %_ZN9CMyComPtrI15ICompressCoder2EaSEPS0_.exit
  %i.aj = getelementptr inbounds nuw i8, ptr %0, i64 60 ; 2 uses
  %i.ak = load i32, ptr %i.aj, align 4, !tbaa !37
  %i.al = icmp sgt i32 %i.ak, 0
  br i1 %i.al, label %_ZN8NArchive3N7z10CCoderInfoD2Ev.exit.lr.ph, label %.loopexit

_ZN8NArchive3N7z10CCoderInfoD2Ev.exit.lr.ph:      ; preds = %.preheader
...
bb.c:                                             ; preds = %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit
  %indvars.iv.next188 = add nuw nsw i64 %indvars.iv187, 1 ; 2 uses
  %i.at = load i32, ptr %i.aj, align 4, !tbaa !37
  %i.au = sext i32 %i.at to i64
  %i.av = icmp slt i64 %indvars.iv.next188, %i.au
  br i1 %i.av, label %_ZN8NArchive3N7z10CCoderInfoD2Ev.exit, label %.loopexit, !llvm.loop !38

_ZN8NArchive3N7z10CCoderInfoD2Ev.exit:            ; preds = %_ZN8NArchive3N7z10CCoderInfoD2Ev.exit.lr.ph, %bb.c
  %indvars.iv187 = phi i64 [ 0, %_ZN8NArchive3N7z10CCoderInfoD2Ev.exit.lr.ph ], [ %indvars.iv.next188, %bb.c ] ; 2 uses
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 16) (i8, ptr @_ZTV7CBufferIhE, i64 16), ptr %i.ba, align 8, !tbaa !10
  ...
  call void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %i.an)
  %i.bc = load ptr, ptr %i.ao, align 8, !tbaa !40
  %i.bd = load i32, ptr %i.ap, align 4, !tbaa !37 ; 2 uses
  %i.be = sext i32 %i.bd to i64
  %i.bf = getelementptr inbounds [8 x i8], ptr %i.bc, i64 %i.be
  store ptr %i.az, ptr %i.bf, align 8, !tbaa !41
  %i.bg = add nsw i32 %i.bd, 1                    ; 2 uses
  store i32 %i.bg, ptr %i.ap, align 4, !tbaa !37
  %i.bh = load ptr, ptr %i.ao, align 8, !tbaa !40
...
bb.d:                                             ; preds = %_ZN8NArchive3N7z10CCoderInfoD2Ev.exit
  %.not76 = icmp eq i32 %i.bn, 0
  br i1 %.not76, label %bb.f, label %_ZN9CMyComPtrI8IUnknownED2Ev.exit

bb.e:                                             ; preds = %_ZN8NArchive3N7z10CCoderInfoD2Ev.exit
  %i.bo = landingpad { ptr, i32 }
          cleanup
  br label %_ZN9CMyComPtrI8IUnknownED2Ev.exit113

bb.f:                                             ; preds = %bb.d
  %i.bp = load ptr, ptr %2, align 8, !tbaa !50    ; 2 uses
  %i.bq = icmp eq ptr %i.bp, null
  br i1 %i.bq, label %bb.g, label %.thread132

bb.g:                                             ; preds = %bb.f
  %i.br = load ptr, ptr %3, align 8, !tbaa !36    ; 2 uses
  %i.bs = icmp eq ptr %i.br, null
  br i1 %i.bs, label %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit.thread, label %.thread132

_ZN9CMyComPtrI14ICompressCoderED2Ev.exit.thread:  ; preds = %bb.g
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #16
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #16
  br label %.loopexit

.thread132:                                       ; preds = %bb.g, %bb.f
  %i.bt = phi ptr [ %i.bp, %bb.f ], [ %i.br, %bb.g ] ; 11 uses
  %i.bu = load ptr, ptr %i.bt, align 8, !tbaa !10
  %i.bv = getelementptr inbounds nuw i8, ptr %i.bu, i64 8
  %i.bw = load ptr, ptr %i.bv, align 8
  %i.bx = invoke noundef i32 %i.bw(ptr noundef nonnull align 8 dereferenceable(8) %i.bt)
          to label %_ZN9CMyComPtrI8IUnknownEC2EPS0_.exit unwind label %bb.i, !inline_history !53 ; 0 uses

_ZN9CMyComPtrI8IUnknownEC2EPS0_.exit:             ; preds = %.thread132
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #16
  store ptr null, ptr %4, align 8, !tbaa !54
  %i.by = load ptr, ptr %i.bt, align 8, !tbaa !10
  %i.bz = load ptr, ptr %i.by, align 8
  %i.ca = invoke noundef i32 %i.bz(ptr noundef nonnull align 8 dereferenceable(8) %i.bt, ptr noundef nonnull align 4 dereferenceable(16) @IID_ICompressSetCoderMt, ptr noundef nonnull %4)
          to label %_ZNK9CMyComPtrI8IUnknownE14QueryInterfaceI19ICompressSetCoderMtEEiRK4GUIDPPT_.exit unwind label %bb.j, !inline_history !57 ; 0 uses

_ZNK9CMyComPtrI8IUnknownE14QueryInterfaceI19ICompressSetCoderMtEEiRK4GUIDPPT_.exit: ; preds = %_ZN9CMyComPtrI8IUnknownEC2EPS0_.exit
  %i.cb = load ptr, ptr %4, align 8, !tbaa !54    ; 3 uses
  %.not78 = icmp eq ptr %i.cb, null
  br i1 %.not78, label %_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit.thread, label %bb.h

_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit.thread: ; preds = %_ZNK9CMyComPtrI8IUnknownE14QueryInterfaceI19ICompressSetCoderMtEEiRK4GUIDPPT_.exit
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #16
  br label %bb.o

bb.h:                                             ; preds = %_ZNK9CMyComPtrI8IUnknownE14QueryInterfaceI19ICompressSetCoderMtEEiRK4GUIDPPT_.exit
  %i.cc = load i32, ptr %i.aq, align 8, !tbaa !58
  %i.cd = load ptr, ptr %i.cb, align 8, !tbaa !10
  %i.ce = getelementptr inbounds nuw i8, ptr %i.cd, i64 40
  %i.cf = load ptr, ptr %i.ce, align 8
  %i.cg = invoke noundef i32 %i.cf(ptr noundef nonnull align 8 dereferenceable(8) %i.cb, i32 noundef %i.cc)
...
bb.j:                                             ; preds = %_ZN9CMyComPtrI8IUnknownEC2EPS0_.exit
...
bb.l:                                             ; preds = %bb.h
  %.not80 = icmp eq i32 %i.cg, 0
  %.pr = load ptr, ptr %4, align 8, !tbaa !54     ; 3 uses
  %.not.i99 = icmp eq ptr %.pr, null
  br i1 %.not.i99, label %_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.ck = load ptr, ptr %.pr, align 8, !tbaa !10
  %i.cl = getelementptr inbounds nuw i8, ptr %i.ck, i64 16
  %i.cm = load ptr, ptr %i.cl, align 8
  %i.cn = invoke noundef i32 %i.cm(ptr noundef nonnull align 8 dereferenceable(8) %.pr)
          to label %_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit unwind label %bb.n ; 0 uses

bb.n:                                             ; preds = %bb.m
  %i.co = landingpad { ptr, i32 }
          catch ptr null
  %i.cp = extractvalue { ptr, i32 } %i.co, 0
  call void @__clang_call_terminate(ptr %i.cp) #17
  unreachable

_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit:    ; preds = %bb.l, %bb.m
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #16
  br i1 %.not80, label %bb.o, label %bb.ai

bb.o:                                             ; preds = %_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit.thread, %_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit
  %i.cq = invoke noundef i32 @_Z19SetMethodPropertiesRK7CMethodPKyP8IUnknown(ptr noundef nonnull align 8 dereferenceable(40) %i.ay, ptr noundef %1, ptr noundef nonnull %i.bt)
          to label %bb.p unwind label %bb.t       ; 2 uses

bb.p:                                             ; preds = %bb.o
  %.not81 = icmp eq i32 %i.cq, 0
  br i1 %.not81, label %bb.u, label %bb.ai

bb.q:                                             ; preds = %bb.k, %bb.j
  %.pn = phi { ptr, i32 } [ %i.cj, %bb.k ], [ %i.ci, %bb.j ]
  %i.cr = load ptr, ptr %4, align 8, !tbaa !54    ; 3 uses
  %.not.i100 = icmp eq ptr %i.cr, null
  br i1 %.not.i100, label %_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit101, label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.cs = load ptr, ptr %i.cr, align 8, !tbaa !10
  %i.ct = getelementptr inbounds nuw i8, ptr %i.cs, i64 16
  %i.cu = load ptr, ptr %i.ct, align 8
  %i.cv = invoke noundef i32 %i.cu(ptr noundef nonnull align 8 dereferenceable(8) %i.cr)
          to label %_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit101 unwind label %bb.s ; 0 uses

bb.s:                                             ; preds = %bb.r
  %i.cw = landingpad { ptr, i32 }
          catch ptr null
  %i.cx = extractvalue { ptr, i32 } %i.cw, 0
  call void @__clang_call_terminate(ptr %i.cx) #17
  unreachable

_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit101: ; preds = %bb.q, %bb.r
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #16
  br label %bb.aq
...
bb.u:                                             ; preds = %bb.p
  ...
  %i.cz = load ptr, ptr %i.bt, align 8, !tbaa !10
  %i.da = load ptr, ptr %i.cz, align 8
  %i.db = invoke noundef i32 %i.da(ptr noundef nonnull align 8 dereferenceable(8) %i.bt, ptr noundef nonnull align 4 dereferenceable(16) @IID_ICryptoSetPassword, ptr noundef nonnull %5)
          to label %_ZNK9CMyComPtrI8IUnknownE14QueryInterfaceI18ICryptoSetPasswordEEiRK4GUIDPPT_.exit unwind label %bb.x, !inline_history !62 ; 0 uses

_ZNK9CMyComPtrI8IUnknownE14QueryInterfaceI18ICryptoSetPasswordEEiRK4GUIDPPT_.exit: ; preds = %bb.u
  %i.dc = load ptr, ptr %5, align 8, !tbaa !59    ; 3 uses
  %.not82 = icmp eq ptr %i.dc, null
  br i1 %.not82, label %bb.ac, label %bb.v

bb.v:                                             ; preds = %_ZNK9CMyComPtrI8IUnknownE14QueryInterfaceI18ICryptoSetPasswordEEiRK4GUIDPPT_.exit
  %i.dd = load i32, ptr %i.as, align 8, !tbaa !63 ; 5 uses
  %i.de = shl nsw i32 %i.dd, 1                    ; 2 uses
  %i.df = icmp eq i32 %i.dd, 0
  br i1 %i.df, label %._crit_edge, label %bb.w

bb.w:                                             ; preds = %bb.v
  %i.dg = zext i32 %i.de to i64
  %i.dh = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %i.dg) #15
          to label %_ZN7CBufferIhE11SetCapacityEm.exit unwind label %.thread143 ; 12 uses

_ZN7CBufferIhE11SetCapacityEm.exit:               ; preds = %bb.w
  %i.di = icmp sgt i32 %i.dd, 0
  br i1 %i.di, label %.lr.ph, label %._crit_edge

.lr.ph:                                           ; preds = %_ZN7CBufferIhE11SetCapacityEm.exit
  %i.dj = load ptr, ptr %i.ar, align 8, !tbaa !64 ; 8 uses
  %wide.trip.count = zext nneg i32 %i.dd to i64   ; 7 uses
  %min.iters.check = icmp ult i32 %i.dd, 8
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph
  %i.dk = shl nuw nsw i64 %wide.trip.count, 1
  %scevgep = getelementptr i8, ptr %i.dh, i64 %i.dk
  %i.dl = shl nuw nsw i64 %wide.trip.count, 2
  %scevgep225 = getelementptr i8, ptr %i.dj, i64 %i.dl
  %bound0 = icmp ult ptr %i.dh, %scevgep225
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.dm = getelementptr inbounds nuw [4 x i8], ptr %i.dj, i64 %index ; 2 uses
  %i.dn = getelementptr inbounds nuw i8, ptr %i.dm, i64 16
  %wide.load = load <4 x i32>, ptr %i.dm, align 4, !tbaa !65, !alias.scope !67
  %wide.load226 = load <4 x i32>, ptr %i.dn, align 4, !tbaa !65, !alias.scope !67
  %i.do = shl nuw nsw i64 %index, 1
  %i.dp = getelementptr inbounds nuw i8, ptr %i.dh, i64 %i.do ; 2 uses
  %i.dq = trunc <4 x i32> %wide.load to <4 x i16>
  %i.dr = trunc <4 x i32> %wide.load226 to <4 x i16>
  %i.ds = getelementptr inbounds nuw i8, ptr %i.dp, i64 8
  store <4 x i16> %i.dq, ptr %i.dp, align 1, !alias.scope !70, !noalias !67
  store <4 x i16> %i.dr, ptr %i.ds, align 1, !alias.scope !70, !noalias !67
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.dt = icmp eq i64 %index.next, %n.vec
  br i1 %i.dt, label %middle.block, label %vector.body, !llvm.loop !72
