...
bb.a:
  ...
  br i1 %i.c, label %.preheader.lr.ph, label %._crit_edge222
...
.preheader.lr.ph:                                 ; preds = %bb.a
  ...
  br i1 %i.d, label %.preheader.us.preheader, label %._crit_edge222
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  %indvars.iv = phi i64 [ 0, %.preheader.us.preheader ], [ %indvars.iv.next, %._crit_edge.us ] ; 4 uses
...
bb.b:                                             ; preds = %.preheader.us, %bb.m
  %.048220.us = phi i32 [ 0, %.preheader.us ], [ %i.p, %bb.m ] ; 8 uses
  %i.o = load i32, ptr %i.g, align 4, !tbaa !4
  %i.p = add nuw nsw i32 %.048220.us, 1           ; 2 uses
  %i.q = shl nuw i32 2, %.048220.us
  %i.r = and i32 %i.o, %i.q
  %.not.us = icmp eq i32 %i.r, 0
  br i1 %.not.us, label %bb.h, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.s = add nuw nsw i32 %.048220.us, %i.m        ; 3 uses
  ...
  br i1 %.not.i.us, label %bb.d, label %check_hashkey_bit_set.exit.us
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %i.ac, label %.lr.ph.i.i.us, label %print_bitboard.exit.i.us

.lr.ph.i.i.us:                                    ; preds = %bb.d, %.lr.ph.i.i.us
  %indvars.iv.i.i.us = phi i64 [ %indvars.iv.next.i.i.us, %.lr.ph.i.i.us ], [ 0, %bb.d ] ; 3 uses
  %i.ad = getelementptr inbounds nuw [4 x i8], ptr @g_board, i64 %indvars.iv.i.i.us
  ...
  %.not.i.i.us = icmp sgt i64 %indvars.iv.i.i.us, %i.ah
  br i1 %.not.i.i.us, label %print_bitboard.exit.i.us, label %.lr.ph.i.i.us, !llvm.loop !8

print_bitboard.exit.i.us:                         ; preds = %.lr.ph.i.i.us, %bb.d
  %.sroa.0.0.copyload.i.us = load i32, ptr %11, align 8
  %.sroa.4.0.copyload.i.us = load i32, ptr %.sroa.4.0..sroa_idx.i, align 4
  %.sroa.5.0.copyload.i.us = load i32, ptr %.sroa.5.0..sroa_idx.i, align 8
  %.sroa.6.0.copyload.i.us = load i32, ptr %.sroa.6.0..sroa_idx.i, align 4
  %.sroa.7.0.copyload.i.us = load i32, ptr %.sroa.7.0..sroa_idx.i, align 8
  %i.ai = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.19, i32 noundef %.sroa.0.0.copyload.i.us, i32 noundef %.sroa.4.0.copyload.i.us, i32 noundef %.sroa.5.0.copyload.i.us, i32 noundef %.sroa.6.0.copyload.i.us, i32 noundef %.sroa.7.0.copyload.i.us) ; 0 uses
...
check_hashkey_bit_set.exit.us:                    ; preds = %bb.c, %print_bitboard.exit.i.us
  call void @llvm.lifetime.end.p0(ptr nonnull %11)
  %i.aj = xor i32 %.048220.us, -1
  ...
  %.not.i51.us = icmp eq i32 %i.as, 0
  br i1 %.not.i51.us, label %bb.e, label %check_hashkey_bit_set.exit66.us

bb.e:                                             ; preds = %check_hashkey_bit_set.exit.us
  ...
  br i1 %i.av, label %.lr.ph.i.i62.us, label %print_bitboard.exit.i52.us

.lr.ph.i.i62.us:                                  ; preds = %bb.e, %.lr.ph.i.i62.us
  %indvars.iv.i.i63.us = phi i64 [ %indvars.iv.next.i.i64.us, %.lr.ph.i.i62.us ], [ 0, %bb.e ] ; 3 uses
  %i.aw = getelementptr inbounds nuw [4 x i8], ptr @g_board, i64 %indvars.iv.i.i63.us
  ...
  %indvars.iv.next.i.i64.us = add nuw nsw i64 %indvars.iv.i.i63.us, 1
  %i.az = load i32, ptr @g_board_size, align 4, !tbaa !4
  %i.ba = sext i32 %i.az to i64
  %.not.i.i65.us = icmp sgt i64 %indvars.iv.i.i63.us, %i.ba
  br i1 %.not.i.i65.us, label %print_bitboard.exit.i52.us, label %.lr.ph.i.i62.us, !llvm.loop !8

print_bitboard.exit.i52.us:                       ; preds = %.lr.ph.i.i62.us, %bb.e
  %.sroa.0.0.copyload.i53.us = load i32, ptr %10, align 8
  %.sroa.4.0.copyload.i55.us = load i32, ptr %.sroa.4.0..sroa_idx.i54, align 4
  %.sroa.5.0.copyload.i57.us = load i32, ptr %.sroa.5.0..sroa_idx.i56, align 8
  %.sroa.6.0.copyload.i59.us = load i32, ptr %.sroa.6.0..sroa_idx.i58, align 4
  %.sroa.7.0.copyload.i61.us = load i32, ptr %.sroa.7.0..sroa_idx.i60, align 8
  %i.bb = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.19, i32 noundef %.sroa.0.0.copyload.i53.us, i32 noundef %.sroa.4.0.copyload.i55.us, i32 noundef %.sroa.5.0.copyload.i57.us, i32 noundef %.sroa.6.0.copyload.i59.us, i32 noundef %.sroa.7.0.copyload.i61.us) ; 0 uses
  tail call void (ptr, i32, i32, ptr, ...) @_fatal_error_aux(ptr noundef nonnull @.str.1, i32 noundef 23, i32 noundef 1, ptr noundef nonnull @.str.28) #9
  br label %check_hashkey_bit_set.exit66.us

check_hashkey_bit_set.exit66.us:                  ; preds = %check_hashkey_bit_set.exit.us, %print_bitboard.exit.i52.us
  call void @llvm.lifetime.end.p0(ptr nonnull %10)
  %i.bc = add nsw i32 %.048220.us, %i.l           ; 3 uses
  ...
  %.not.i67.us = icmp eq i32 %i.bj, 0
  br i1 %.not.i67.us, label %bb.f, label %check_hashkey_bit_set.exit82.us

bb.f:                                             ; preds = %check_hashkey_bit_set.exit66.us
  ...
  br i1 %i.bm, label %.lr.ph.i.i78.us, label %print_bitboard.exit.i68.us

.lr.ph.i.i78.us:                                  ; preds = %bb.f, %.lr.ph.i.i78.us
  %indvars.iv.i.i79.us = phi i64 [ %indvars.iv.next.i.i80.us, %.lr.ph.i.i78.us ], [ 0, %bb.f ] ; 3 uses
  %i.bn = getelementptr inbounds nuw [4 x i8], ptr @g_board, i64 %indvars.iv.i.i79.us
  ...
  %indvars.iv.next.i.i80.us = add nuw nsw i64 %indvars.iv.i.i79.us, 1
  %i.bq = load i32, ptr @g_board_size, align 4, !tbaa !4
  %i.br = sext i32 %i.bq to i64
  %.not.i.i81.us = icmp sgt i64 %indvars.iv.i.i79.us, %i.br
  br i1 %.not.i.i81.us, label %print_bitboard.exit.i68.us, label %.lr.ph.i.i78.us, !llvm.loop !8

print_bitboard.exit.i68.us:                       ; preds = %.lr.ph.i.i78.us, %bb.f
  %.sroa.0.0.copyload.i69.us = load i32, ptr %9, align 8
  %.sroa.4.0.copyload.i71.us = load i32, ptr %.sroa.4.0..sroa_idx.i70, align 4
  %.sroa.5.0.copyload.i73.us = load i32, ptr %.sroa.5.0..sroa_idx.i72, align 8
  %.sroa.6.0.copyload.i75.us = load i32, ptr %.sroa.6.0..sroa_idx.i74, align 4
  %.sroa.7.0.copyload.i77.us = load i32, ptr %.sroa.7.0..sroa_idx.i76, align 8
  %i.bs = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.19, i32 noundef %.sroa.0.0.copyload.i69.us, i32 noundef %.sroa.4.0.copyload.i71.us, i32 noundef %.sroa.5.0.copyload.i73.us, i32 noundef %.sroa.6.0.copyload.i75.us, i32 noundef %.sroa.7.0.copyload.i77.us) ; 0 uses
  tail call void (ptr, i32, i32, ptr, ...) @_fatal_error_aux(ptr noundef nonnull @.str.1, i32 noundef 23, i32 noundef 1, ptr noundef nonnull @.str.28) #9
  br label %check_hashkey_bit_set.exit82.us

check_hashkey_bit_set.exit82.us:                  ; preds = %check_hashkey_bit_set.exit66.us, %print_bitboard.exit.i68.us
  ...
  %.not.i83.us = icmp eq i32 %i.ca, 0
  br i1 %.not.i83.us, label %bb.g, label %check_hashkey_bit_set.exit98.us

bb.g:                                             ; preds = %check_hashkey_bit_set.exit82.us
  ...
  br i1 %i.cd, label %.lr.ph.i.i94.us, label %print_bitboard.exit.i84.us

.lr.ph.i.i94.us:                                  ; preds = %bb.g, %.lr.ph.i.i94.us
  %indvars.iv.i.i95.us = phi i64 [ %indvars.iv.next.i.i96.us, %.lr.ph.i.i94.us ], [ 0, %bb.g ] ; 3 uses
  %i.ce = getelementptr inbounds nuw [4 x i8], ptr @g_board, i64 %indvars.iv.i.i95.us
  ...
  %indvars.iv.next.i.i96.us = add nuw nsw i64 %indvars.iv.i.i95.us, 1
  %i.ch = load i32, ptr @g_board_size, align 4, !tbaa !4
  %i.ci = sext i32 %i.ch to i64
  %.not.i.i97.us = icmp sgt i64 %indvars.iv.i.i95.us, %i.ci
  br i1 %.not.i.i97.us, label %print_bitboard.exit.i84.us, label %.lr.ph.i.i94.us, !llvm.loop !8

print_bitboard.exit.i84.us:                       ; preds = %.lr.ph.i.i94.us, %bb.g
  %.sroa.0.0.copyload.i85.us = load i32, ptr %8, align 8
  %.sroa.4.0.copyload.i87.us = load i32, ptr %.sroa.4.0..sroa_idx.i86, align 4
  %.sroa.5.0.copyload.i89.us = load i32, ptr %.sroa.5.0..sroa_idx.i88, align 8
  %.sroa.6.0.copyload.i91.us = load i32, ptr %.sroa.6.0..sroa_idx.i90, align 4
  %.sroa.7.0.copyload.i93.us = load i32, ptr %.sroa.7.0..sroa_idx.i92, align 8
  %i.cj = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.19, i32 noundef %.sroa.0.0.copyload.i85.us, i32 noundef %.sroa.4.0.copyload.i87.us, i32 noundef %.sroa.5.0.copyload.i89.us, i32 noundef %.sroa.6.0.copyload.i91.us, i32 noundef %.sroa.7.0.copyload.i93.us) ; 0 uses
  tail call void (ptr, i32, i32, ptr, ...) @_fatal_error_aux(ptr noundef nonnull @.str.1, i32 noundef 23, i32 noundef 1, ptr noundef nonnull @.str.28) #9
  br label %check_hashkey_bit_set.exit98.us

check_hashkey_bit_set.exit98.us:                  ; preds = %check_hashkey_bit_set.exit82.us, %print_bitboard.exit.i84.us
  call void @llvm.lifetime.end.p0(ptr nonnull %8)
  br label %bb.m

bb.h:                                             ; preds = %bb.b
  %i.ck = add nuw nsw i32 %.048220.us, %i.n       ; 3 uses
  ...
  %.not.i99.us = icmp eq i32 %i.cr, 0
  br i1 %.not.i99.us, label %check_hashkey_bit_not_set.exit.us, label %bb.i
...
bb.i:                                             ; preds = %bb.h
  ...
  br i1 %i.cu, label %.lr.ph.i.i110.us, label %print_bitboard.exit.i100.us

.lr.ph.i.i110.us:                                 ; preds = %bb.i, %.lr.ph.i.i110.us
  %indvars.iv.i.i111.us = phi i64 [ %indvars.iv.next.i.i112.us, %.lr.ph.i.i110.us ], [ 0, %bb.i ] ; 3 uses
  %i.cv = getelementptr inbounds nuw [4 x i8], ptr @g_board, i64 %indvars.iv.i.i111.us
  ...
  %indvars.iv.next.i.i112.us = add nuw nsw i64 %indvars.iv.i.i111.us, 1
  %i.cy = load i32, ptr @g_board_size, align 4, !tbaa !4
  %i.cz = sext i32 %i.cy to i64
  %.not.i.i113.us = icmp sgt i64 %indvars.iv.i.i111.us, %i.cz
  br i1 %.not.i.i113.us, label %print_bitboard.exit.i100.us, label %.lr.ph.i.i110.us, !llvm.loop !8

print_bitboard.exit.i100.us:                      ; preds = %.lr.ph.i.i110.us, %bb.i
  %.sroa.0.0.copyload.i101.us = load i32, ptr %7, align 8
  %.sroa.4.0.copyload.i103.us = load i32, ptr %.sroa.4.0..sroa_idx.i102, align 4
  %.sroa.5.0.copyload.i105.us = load i32, ptr %.sroa.5.0..sroa_idx.i104, align 8
  %.sroa.6.0.copyload.i107.us = load i32, ptr %.sroa.6.0..sroa_idx.i106, align 4
  %.sroa.7.0.copyload.i109.us = load i32, ptr %.sroa.7.0..sroa_idx.i108, align 8
  %i.da = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.19, i32 noundef %.sroa.0.0.copyload.i101.us, i32 noundef %.sroa.4.0.copyload.i103.us, i32 noundef %.sroa.5.0.copyload.i105.us, i32 noundef %.sroa.6.0.copyload.i107.us, i32 noundef %.sroa.7.0.copyload.i109.us) ; 0 uses
...
check_hashkey_bit_not_set.exit.us:                ; preds = %bb.h, %print_bitboard.exit.i100.us
  call void @llvm.lifetime.end.p0(ptr nonnull %7)
  %i.db = xor i32 %.048220.us, -1
  ...
  %.not.i114.us = icmp eq i32 %i.dk, 0
  br i1 %.not.i114.us, label %check_hashkey_bit_not_set.exit129.us, label %bb.j

bb.j:                                             ; preds = %check_hashkey_bit_not_set.exit.us
  ...
  br i1 %i.dn, label %.lr.ph.i.i125.us, label %print_bitboard.exit.i115.us

.lr.ph.i.i125.us:                                 ; preds = %bb.j, %.lr.ph.i.i125.us
  %indvars.iv.i.i126.us = phi i64 [ %indvars.iv.next.i.i127.us, %.lr.ph.i.i125.us ], [ 0, %bb.j ] ; 3 uses
  %i.do = getelementptr inbounds nuw [4 x i8], ptr @g_board, i64 %indvars.iv.i.i126.us
  ...
  %indvars.iv.next.i.i127.us = add nuw nsw i64 %indvars.iv.i.i126.us, 1
  %i.dr = load i32, ptr @g_board_size, align 4, !tbaa !4
  %i.ds = sext i32 %i.dr to i64
  %.not.i.i128.us = icmp sgt i64 %indvars.iv.i.i126.us, %i.ds
  br i1 %.not.i.i128.us, label %print_bitboard.exit.i115.us, label %.lr.ph.i.i125.us, !llvm.loop !8

print_bitboard.exit.i115.us:                      ; preds = %.lr.ph.i.i125.us, %bb.j
  %.sroa.0.0.copyload.i116.us = load i32, ptr %6, align 8
  %.sroa.4.0.copyload.i118.us = load i32, ptr %.sroa.4.0..sroa_idx.i117, align 4
  %.sroa.5.0.copyload.i120.us = load i32, ptr %.sroa.5.0..sroa_idx.i119, align 8
  %.sroa.6.0.copyload.i122.us = load i32, ptr %.sroa.6.0..sroa_idx.i121, align 4
  %.sroa.7.0.copyload.i124.us = load i32, ptr %.sroa.7.0..sroa_idx.i123, align 8
  %i.dt = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.19, i32 noundef %.sroa.0.0.copyload.i116.us, i32 noundef %.sroa.4.0.copyload.i118.us, i32 noundef %.sroa.5.0.copyload.i120.us, i32 noundef %.sroa.6.0.copyload.i122.us, i32 noundef %.sroa.7.0.copyload.i124.us) ; 0 uses
  tail call void (ptr, i32, i32, ptr, ...) @_fatal_error_aux(ptr noundef nonnull @.str.1, i32 noundef 38, i32 noundef 1, ptr noundef nonnull @.str.28) #9
  br label %check_hashkey_bit_not_set.exit129.us

check_hashkey_bit_not_set.exit129.us:             ; preds = %check_hashkey_bit_not_set.exit.us, %print_bitboard.exit.i115.us
  call void @llvm.lifetime.end.p0(ptr nonnull %6)
  %i.du = add nsw i32 %.048220.us, %i.l           ; 3 uses
  ...
  %.not.i130.us = icmp eq i32 %i.eb, 0
  br i1 %.not.i130.us, label %check_hashkey_bit_not_set.exit145.us, label %bb.k

bb.k:                                             ; preds = %check_hashkey_bit_not_set.exit129.us
  ...
  br i1 %i.ee, label %.lr.ph.i.i141.us, label %print_bitboard.exit.i131.us

.lr.ph.i.i141.us:                                 ; preds = %bb.k, %.lr.ph.i.i141.us
  %indvars.iv.i.i142.us = phi i64 [ %indvars.iv.next.i.i143.us, %.lr.ph.i.i141.us ], [ 0, %bb.k ] ; 3 uses
  %i.ef = getelementptr inbounds nuw [4 x i8], ptr @g_board, i64 %indvars.iv.i.i142.us
  ...
  %indvars.iv.next.i.i143.us = add nuw nsw i64 %indvars.iv.i.i142.us, 1
  %i.ei = load i32, ptr @g_board_size, align 4, !tbaa !4
  %i.ej = sext i32 %i.ei to i64
  %.not.i.i144.us = icmp sgt i64 %indvars.iv.i.i142.us, %i.ej
  br i1 %.not.i.i144.us, label %print_bitboard.exit.i131.us, label %.lr.ph.i.i141.us, !llvm.loop !8

print_bitboard.exit.i131.us:                      ; preds = %.lr.ph.i.i141.us, %bb.k
  %.sroa.0.0.copyload.i132.us = load i32, ptr %5, align 8
  %.sroa.4.0.copyload.i134.us = load i32, ptr %.sroa.4.0..sroa_idx.i133, align 4
  %.sroa.5.0.copyload.i136.us = load i32, ptr %.sroa.5.0..sroa_idx.i135, align 8
  %.sroa.6.0.copyload.i138.us = load i32, ptr %.sroa.6.0..sroa_idx.i137, align 4
  %.sroa.7.0.copyload.i140.us = load i32, ptr %.sroa.7.0..sroa_idx.i139, align 8
  %i.ek = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.19, i32 noundef %.sroa.0.0.copyload.i132.us, i32 noundef %.sroa.4.0.copyload.i134.us, i32 noundef %.sroa.5.0.copyload.i136.us, i32 noundef %.sroa.6.0.copyload.i138.us, i32 noundef %.sroa.7.0.copyload.i140.us) ; 0 uses
  tail call void (ptr, i32, i32, ptr, ...) @_fatal_error_aux(ptr noundef nonnull @.str.1, i32 noundef 38, i32 noundef 1, ptr noundef nonnull @.str.28) #9
  br label %check_hashkey_bit_not_set.exit145.us

check_hashkey_bit_not_set.exit145.us:             ; preds = %check_hashkey_bit_not_set.exit129.us, %print_bitboard.exit.i131.us
  ...
  %.not.i146.us = icmp eq i32 %i.es, 0
  br i1 %.not.i146.us, label %check_hashkey_bit_not_set.exit161.us, label %bb.l

bb.l:                                             ; preds = %check_hashkey_bit_not_set.exit145.us
  ...
  br i1 %i.ev, label %.lr.ph.i.i157.us, label %print_bitboard.exit.i147.us

.lr.ph.i.i157.us:                                 ; preds = %bb.l, %.lr.ph.i.i157.us
  %indvars.iv.i.i158.us = phi i64 [ %indvars.iv.next.i.i159.us, %.lr.ph.i.i157.us ], [ 0, %bb.l ] ; 3 uses
  %i.ew = getelementptr inbounds nuw [4 x i8], ptr @g_board, i64 %indvars.iv.i.i158.us
  ...
  %.not.i.i160.us = icmp sgt i64 %indvars.iv.i.i158.us, %i.fa
  br i1 %.not.i.i160.us, label %print_bitboard.exit.i147.us, label %.lr.ph.i.i157.us, !llvm.loop !8

print_bitboard.exit.i147.us:                      ; preds = %.lr.ph.i.i157.us, %bb.l
  %.sroa.0.0.copyload.i148.us = load i32, ptr %4, align 8
  %.sroa.4.0.copyload.i150.us = load i32, ptr %.sroa.4.0..sroa_idx.i149, align 4
  %.sroa.5.0.copyload.i152.us = load i32, ptr %.sroa.5.0..sroa_idx.i151, align 8
  %.sroa.6.0.copyload.i154.us = load i32, ptr %.sroa.6.0..sroa_idx.i153, align 4
  %.sroa.7.0.copyload.i156.us = load i32, ptr %.sroa.7.0..sroa_idx.i155, align 8
  %i.fb = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.19, i32 noundef %.sroa.0.0.copyload.i148.us, i32 noundef %.sroa.4.0.copyload.i150.us, i32 noundef %.sroa.5.0.copyload.i152.us, i32 noundef %.sroa.6.0.copyload.i154.us, i32 noundef %.sroa.7.0.copyload.i156.us) ; 0 uses
  tail call void (ptr, i32, i32, ptr, ...) @_fatal_error_aux(ptr noundef nonnull @.str.1, i32 noundef 38, i32 noundef 1, ptr noundef nonnull @.str.28) #9
  br label %check_hashkey_bit_not_set.exit161.us

check_hashkey_bit_not_set.exit161.us:             ; preds = %check_hashkey_bit_not_set.exit145.us, %print_bitboard.exit.i147.us
  call void @llvm.lifetime.end.p0(ptr nonnull %4)
  br label %bb.m

bb.m:                                             ; preds = %check_hashkey_bit_set.exit98.us, %check_hashkey_bit_not_set.exit161.us
  %exitcond.not = icmp eq i32 %i.p, %i.b
  br i1 %exitcond.not, label %._crit_edge.us, label %bb.b, !llvm.loop !10

._crit_edge.us:                                   ; preds = %bb.m
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond225.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond225.not, label %._crit_edge222.loopexit, label %.preheader.us, !llvm.loop !11

._crit_edge222.loopexit:                          ; preds = %._crit_edge.us
  %.pre = load i32, ptr @g_board_size, align 4, !tbaa !4
  %.pre226.a = load i32, ptr getelementptr inbounds nuw (i8, ptr @g_board_size, i64 4), align 4, !tbaa !4
  br label %._crit_edge222

._crit_edge222:                                   ; preds = %._crit_edge222.loopexit, %.preheader.lr.ph, %bb.a
  %i.fc = phi i32 [ %.pre226.a, %._crit_edge222.loopexit ], [ %i.b, %.preheader.lr.ph ], [ %i.b, %bb.a ] ; 5 uses
  %i.fd = phi i32 [ %.pre, %._crit_edge222.loopexit ], [ %i.a, %.preheader.lr.ph ], [ %i.a, %bb.a ] ; 3 uses
...
.preheader.us.preheader.i:                        ; preds = %._crit_edge222
  ...
  %lcmp.mod245 = trunc i32 %i.fc to i1
...
._crit_edge23.i:                                  ; preds = %._crit_edge.us.i, %._crit_edge222
  %.0.lcssa.i = phi i32 [ %i.ff, %._crit_edge222 ], [ %.2.us.i.lcssa, %._crit_edge.us.i ]
...
bb.s:                                             ; preds = %._crit_edge23.i
  ...
  %.pre227.a = load i32, ptr @g_board_size, align 4, !tbaa !4
  %.pre228.a = load i32, ptr getelementptr inbounds nuw (i8, ptr @g_board_size, i64 4), align 4, !tbaa !4
  br label %check_hashkey_code.exit

check_hashkey_code.exit:                          ; preds = %._crit_edge23.i, %bb.s
  %i.gz = phi i32 [ %i.fc, %._crit_edge23.i ], [ %.pre228.a, %bb.s ] ; 5 uses
  %i.ha = phi i32 [ %i.fd, %._crit_edge23.i ], [ %.pre227.a, %bb.s ] ; 3 uses
...
.preheader.us.preheader.i167:                     ; preds = %check_hashkey_code.exit
  ...
  %xtraiter247 = and i64 %i.hf, 1
  %i.hg = icmp eq i32 %i.gz, 1
  %unroll_iter251 = and i64 %i.hf, 2147483646
  %lcmp.mod248.not = icmp eq i64 %xtraiter247, 0
  %lcmp.mod250 = trunc i32 %i.gz to i1
...
.preheader.us.i169:                               ; preds = %._crit_edge.us.i178, %.preheader.us.preheader.i167
  ...
  br i1 %i.hg, label %.epil.preheader246, label %.preheader.us.i169.new
...
.preheader.us.i169.new:                           ; preds = %.preheader.us.i169, %bb.w
  ...
  %niter252 = phi i64 [ %niter252.next.1, %bb.w ], [ 0, %.preheader.us.i169 ]
