...
begin_hunk_0_@FlushGalley:bb.a
  ...
  %. = select i1 %.not780, i64 16, i64 24
  %.pn794 = select i1 %.not780, i64 24, i64 16
...
bb.aw:                                            ; preds = %bb.aq, %bb.av, %bb.ap
  ...
  %i.em = load ptr, ptr %i.el, align 8, !tbaa !8  ; 5 uses
...
.preheader991.lr.ph:                              ; preds = %bb.ay
  %i.ev = getelementptr inbounds nuw i8, ptr %i.em, i64 %.
  %i.ew = getelementptr inbounds nuw i8, ptr %i.em, i64 %.pn794
  %3 = getelementptr inbounds nuw i8, ptr %i.em, i64 24 ; 2 uses
...
bb.dd:                                            ; preds = %bb.dc
  %i.pm = load ptr, ptr %i.ev, align 8, !tbaa !8
  %i.pn = load ptr, ptr %i.ew, align 8, !tbaa !8
...
bb.df:                                            ; preds = %bb.de, %bb.dd
  %i.pr = load ptr, ptr %3, align 8, !tbaa !8     ; 2 uses
  br label %bb.dg
...
bb.di:                                            ; preds = %bb.dh
  ...
  %.pre1419 = load ptr, ptr %3, align 8, !tbaa !8
  br label %bb.dj
