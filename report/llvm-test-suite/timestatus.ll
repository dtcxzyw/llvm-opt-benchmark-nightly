...
begin_hunk_0_@timestatus:bb.a
  ...
  %4 = fpext float %i.q to double
  %5 = fadd double %4, 5.000000e-01
  %6 = fpext float %i.r to double
  %7 = fadd double %6, 5.000000e-01
  br label %ts_calc_times.exit23

ts_calc_times.exit23:                             ; preds = %bb.d, %bb.g
  %.sink20.i33 = phi double [ %7, %bb.g ], [ 5.000000e-01, %bb.d ] ; 2 uses
  %.sroa.8.0.a = phi double [ %5, %bb.g ], [ 5.000000e-01, %bb.d ] ; 2 uses
  %.sroa.5.0.a = phi double [ %.sink.i22, %bb.g ], [ 0.000000e+00, %bb.d ]
  %.sroa.5.0 = phi double [ %i.ad, %bb.g ], [ 5.000000e-01, %bb.d ] ; 2 uses
...
begin_hunk_1_@timestatus:bb.a
  ...
  %i.ax = fptosi double %.sroa.5.0 to i64         ; 2 uses
  %i.ay = sdiv i64 %i.ax, 3600
  %i.az = trunc i64 %i.ay to i32
  %i.ba = fdiv double %.sroa.5.0, 6.000000e+01
...
begin_hunk_2_@timestatus:bb.a
  ...
  %i.br = fptosi double %.sroa.8.0.a to i64       ; 2 uses
  %i.bs = sdiv i64 %i.br, 3600
  %i.bt = trunc i64 %i.bs to i32
  %i.bu = fdiv double %.sroa.8.0.a, 6.000000e+01
  ...
  %i.ca = fptosi double %.sink20.i33 to i64       ; 2 uses
  %i.cb = sdiv i64 %i.ca, 3600
  %i.cc = trunc i64 %i.cb to i32
  %i.cd = fdiv double %.sink20.i33, 6.000000e+01
  ...
  %i.cj = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.al, ptr noundef nonnull @.str.1, i64 noundef %1, i64 noundef %.pre-phi, i32 noundef %.0, i32 noundef %i.aq, i32 noundef %i.au, i32 noundef %i.aw, i32 noundef %i.az, i32 noundef %i.bd, i32 noundef %i.bf, i32 noundef %i.bk, i32 noundef %i.bo, i32 noundef %i.bq, i32 noundef %i.bt, i32 noundef %i.bx, i32 noundef %i.bz, double noundef %.sroa.5.0.a, i32 noundef %i.cc, i32 noundef %i.cg, i32 noundef %i.ci) #10 ; 0 uses
