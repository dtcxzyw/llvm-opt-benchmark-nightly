...
bb.a:
  ...
  %4 = load <3 x float>, ptr %1, align 4, !tbaa !22 ; 5 uses
  %i.f = load float, ptr %1, align 4, !tbaa !22
  ...
  %i.j = shufflevector <3 x float> %4, <3 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.m = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.l, <2 x float> %6, <2 x float> %i.k)
  ...
  %i.v = tail call noundef float @llvm.fmuladd.f32(float %i.u, float %8, float %i.s)
