...
begin_hunk_1
  ...
  %i.gt = tail call ptr @xmalloc(i64 noundef %i.gs) #11 ; 5 uses
  ...
  %i.gy = tail call ptr @xmalloc(i64 noundef %i.gs) #11 ; 4 uses
...
bb.bc:                                            ; preds = %.lr.ph516
  %11 = trunc nsw i64 %indvars.iv563 to i32
  %12 = sub nsw i32 %i.lo, %2
  %13 = sub nsw i32 %4, %i.lq
  %.not398 = icmp slt i32 %12, %13
  %.418 = select i1 %.not398, i32 %i.lq, i32 %i.lo ; 3 uses
  %.0349 = add nsw i32 %.418, %11                 ; 2 uses
  tail call void @free(ptr noundef nonnull %i.cz) #11
  tail call void @free(ptr noundef nonnull %i.gt) #11
