...
bb.a:
  ...
  %i.j = sitofp <2 x i64> %i.h to <2 x float>     ; 5 uses
  ...
  %i.r = extractelement <2 x float> %i.j, i64 1
  %i.s = tail call float @llvm.fmuladd.f32(float %i.r, float %i.b, float %i.q)
  %i.t = fpext float %i.s to double
  %5 = insertelement <2 x float> %i.j, float %i.l, i64 0
  %6 = fneg <2 x float> %5
  %7 = shufflevector <2 x float> %i.n, <2 x float> poison, <2 x i32> zeroinitializer
  %8 = fmul nnan <2 x float> %7, %6
  %9 = shufflevector <2 x float> %i.n, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %10 = shufflevector <2 x float> %i.j, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %11 = insertelement <2 x float> %10, float %i.o, i64 0
  %12 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %9, <2 x float> %11, <2 x float> %8)
  ...
  %i.aa = shufflevector <2 x double> %13, <2 x double> poison, <2 x i32> zeroinitializer
