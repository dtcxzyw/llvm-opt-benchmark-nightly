...
.thread.i:                                        ; preds = %bb.q, %bb.p, %bb.o
  %i.cc = phi ptr [ null, %bb.p ], [ %i.bx, %bb.q ], [ null, %bb.o ]
  ...
  br i1 %.not6.i.i.i, label %_ZN8NArchive3N7z17CFolderOutStream28OpenFileEv.exit, label %bb.r
...
_ZN8NArchive3N7z17CFolderOutStream28OpenFileEv.exit: ; preds = %.thread.i, %bb.r
...
.backedge:                                        ; preds = %_ZN8NArchive3N7z17CFolderOutStream28OpenFileEv.exit, %.thread58, %bb.l
  %.029.be = phi i32 [ %i.z, %bb.l ], [ %i.z, %.thread58 ], [ %.02970, %_ZN8NArchive3N7z17CFolderOutStream28OpenFileEv.exit ] ; 2 uses
  %.026.be = phi ptr [ %i.y, %bb.l ], [ %i.y, %.thread58 ], [ %.02671, %_ZN8NArchive3N7z17CFolderOutStream28OpenFileEv.exit ]
  %.not45 = icmp eq i32 %.029.be, 0
  br i1 %.not45, label %.loopexit, label %bb.d, !llvm.loop !63

.loopexit.sink.split:                             ; preds = %_ZN8NArchive3N7z17CFolderOutStream221CloseFileAndSetResultEv.exit, %_ZN8NArchive3N7z17CFolderOutStream221CloseFileAndSetResultEv.exit.thread, %bb.e, %bb.f
...
.loopexit:                                        ; preds = %bb.n, %bb.m, %.backedge, %.loopexit.sink.split, %bb.c
  %.7 = phi i32 [ 0, %bb.c ], [ %.7.ph, %.loopexit.sink.split ], [ -2147467259, %bb.n ], [ 0, %.backedge ], [ 1, %bb.m ]
  ret i32 %.7
}
...
bb.a:
  ...
  %i.p = load i8, ptr %i.o, align 8, !tbaa !96, !range !48, !noundef !49
...
bb.b:                                             ; preds = %bb.a
  ...
  store i32 %i.t, ptr %i.u, align 4, !tbaa !98
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #17
  br label %bb.d
...
bb.c:                                             ; preds = %bb.a
  ...
  store i32 -2147467259, ptr %i.y, align 4, !tbaa !98
  call void @__cxa_end_catch()
  %.pre = load i32, ptr %i.y, align 4, !tbaa !98
  br label %bb.d
...
._crit_edge:                                      ; preds = %bb.d
  ...
  %.pre3 = load ptr, ptr %.phi.trans.insert2, align 8, !tbaa !99
  br label %bb.f
...
bb.e:                                             ; preds = %bb.d
  ...
  store i32 %i.al, ptr %i.ab, align 4, !tbaa !98
  br label %bb.f
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.as = call noundef i32 %i.ar(ptr noundef nonnull align 8 dereferenceable(8) %i.ao), !inline_history !100 ; 0 uses
...
bb.h:                                             ; preds = %_ZN9CMyComPtrI20ISequentialOutStreamE7ReleaseEv.exit.i
  ...
  %i.ba = call noundef i32 %i.az(ptr noundef nonnull align 8 dereferenceable(8) %i.aw), !inline_history !101 ; 0 uses
...
bb.a:
  ...
  %26 = alloca %"struct.NArchive::N7z::CCompressionMethodMode", align 8 ; 30 uses
  %27 = alloca %"class.NArchive::N7z::CEncoder", align 8 ; 8 uses
  ...
  %36 = alloca %class.CRecordVector.22, align 8   ; 12 uses
  %i.d = alloca i8, align 1                       ; 8 uses
  %37 = alloca %"struct.NArchive::N7z::CRefItem", align 8 ; 2 uses
  %38 = alloca %class.CRecordVector.1, align 8    ; 12 uses
  %39 = alloca %class.CStringBase, align 8        ; 9 uses
  %40 = alloca %"struct.NArchive::N7z::CFolder", align 8 ; 26 uses
  %41 = alloca %"struct.NArchive::N7z::CFileItem", align 8 ; 13 uses
  %42 = alloca %"struct.NArchive::N7z::CFileItem2", align 8 ; 7 uses
  ...
  %i.f = load i64, ptr %i.e, align 8, !tbaa !104  ; 3 uses
  %.not = icmp eq ptr %1, null                    ; 2 uses
  br i1 %.not, label %.thread, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.g = getelementptr inbounds nuw i8, ptr %1, i64 488
  %i.h = load i64, ptr %i.g, align 8, !tbaa !108  ; 2 uses
...
.thread:                                          ; preds = %bb.a, %bb.c, %bb.b
  ...
  store i64 4, ptr %i.n, align 8, !tbaa !117
  ...
  store i64 12, ptr %i.p, align 8, !tbaa !117
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.al, label %bb.e, label %.preheader965, !llvm.loop !118
...
bb.i:                                             ; preds = %.lr.ph1446, %bb.k
  ...
  %i.be = load i32, ptr %i.bd, align 8, !tbaa !119 ; 2 uses
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  br i1 %i.bk, label %bb.i, label %.preheader964, !llvm.loop !121
...
bb.m:                                             ; preds = %.lr.ph1451, %bb.q
  ...
  %i.ca = load i8, ptr %i.bz, align 8, !tbaa !122, !range !48, !noundef !49
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.ck = load i8, ptr %i.cj, align 4, !tbaa !123, !range !48, !noundef !49
...
.noexc703:                                        ; preds = %bb.cy
  ...
  store ptr %i.sr, ptr %i.sq, align 8, !tbaa !102
  store i32 0, ptr %i.sr, align 4, !tbaa !12
  store i32 4, ptr %i.ss, align 4, !tbaa !173
  %i.st = getelementptr inbounds nuw i8, ptr %22, i64 288 ; 2 uses
  store i32 1, ptr %i.sp, align 8, !tbaa !172
  %i.su = load ptr, ptr %i.st, align 8, !tbaa !95 ; 3 uses
...
bb.cz:                                            ; preds = %.noexc703
  ...
  %i.sy = invoke noundef i32 %i.sx(ptr noundef nonnull align 8 dereferenceable(8) %i.su)
          to label %bb.da unwind label %bb.dg, !inline_history !174 ; 0 uses

bb.da:                                            ; preds = %.noexc703, %bb.cz
  store ptr %i.so, ptr %i.st, align 8, !tbaa !95
  %i.sz = load ptr, ptr %7, align 8, !tbaa !157   ; 3 uses
  %i.ta = getelementptr inbounds nuw i8, ptr %i.sz, i64 68
  %i.tb = load i8, ptr %i.ta, align 4, !tbaa !167, !range !48, !noundef !49
...
bb.dc:                                            ; preds = %bb.db
  ...
  %i.tg = load ptr, ptr %i.sq, align 8, !tbaa !102 ; 3 uses
  ...
  %i.tk = load i32, ptr %i.ss, align 4, !tbaa !173 ; 2 uses
...
bb.df:                                            ; preds = %bb.df, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i
  ...
  br i1 %.not.i.i, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i, label %bb.df, !llvm.loop !175
...
bb.dk:                                            ; preds = %bb.dj
  ...
  %i.uh = load ptr, ptr %25, align 8, !tbaa !176  ; 2 uses
...
bb.dn:                                            ; preds = %bb.dm
  %i.uk = load ptr, ptr %25, align 8, !tbaa !176
...
bb.dq:                                            ; preds = %bb.dp, %bb.dl
  ...
  %i.uo = load ptr, ptr %25, align 8, !tbaa !176
...
bb.dx:                                            ; preds = %bb.dv
  ...
  store i64 0, ptr %i.uv, align 8, !tbaa !178
  ...
  %i.uz = getelementptr inbounds nuw i8, ptr %26, i64 32 ; 7 uses
  ...
  %i.ve = getelementptr inbounds nuw i8, ptr %26, i64 72 ; 7 uses
  ...
  %i.zz = getelementptr inbounds nuw i8, ptr %41, i64 16 ; 3 uses
...
bb.dy:                                            ; preds = %bb.dx, %bb.ms
  ...
  %.91540 = phi i32 [ 0, %bb.dx ], [ %.31, %bb.ms ] ; 2 uses
  %.05601539 = phi i32 [ 0, %bb.dx ], [ %.15611028, %bb.ms ] ; 3 uses
  ...
  store i64 8, ptr %i.uy, align 8, !tbaa !117
  ...
  store i64 16, ptr %i.vb, align 8, !tbaa !117
  ...
  store i32 1, ptr %i.vc, align 8, !tbaa !185
  store i8 0, ptr %i.vd, align 4, !tbaa !167
...
bb.ea:                                            ; preds = %bb.dy
  store ptr %i.aaj, ptr %i.ve, align 8, !tbaa !102
  store i32 0, ptr %i.aaj, align 4, !tbaa !12
  store i32 4, ptr %i.vf, align 4, !tbaa !173
  %i.aal = trunc i64 %indvars.iv1820 to i1
  %i.aam = load ptr, ptr %7, align 8, !tbaa !157  ; 2 uses
  br i1 %i.aal, label %bb.eb, label %bb.gf

bb.eb:                                            ; preds = %bb.ea
  %i.aan = load i8, ptr %i.vg, align 1, !tbaa !186, !range !48, !noundef !49
...
bb.ec:                                            ; preds = %.noexc711
  ...
  store i64 8, ptr %i.vr, align 8, !tbaa !117
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTV13CObjectVectorI5CPropE, i64 16), ptr %i.vp, align 8, !tbaa !33
  store i64 50528539, ptr %12, align 8, !tbaa !187
  store i32 4, ptr %i.vs, align 8, !tbaa !190
  store i32 1, ptr %i.vt, align 4, !tbaa !192
...
.noexc.i:                                         ; preds = %bb.ec
  store i64 50528539, ptr %i.aaq, align 8, !tbaa !187
  ...
  store i64 8, ptr %i.aat, align 8, !tbaa !117
...
bb.ee:                                            ; preds = %bb.ed
  ...
  store i64 196865, ptr %12, align 8, !tbaa !187
  store i32 1, ptr %i.vs, align 8, !tbaa !190
  store i32 1, ptr %i.vt, align 4, !tbaa !192
  call void @llvm.lifetime.start.p0(ptr nonnull %13) #17
  store i16 0, ptr %i.vu, align 8, !tbaa !193
  store i16 0, ptr %i.vv, align 2, !tbaa !196
  store i32 12, ptr %13, align 8, !tbaa !197
...
.noexc59.i:                                       ; preds = %bb.ef
  %i.abb = load i32, ptr %13, align 8, !tbaa !197
  store i32 %i.abb, ptr %i.aba, align 8, !tbaa !197
...
bb.ej:                                            ; preds = %bb.eh
  ...
  store i16 0, ptr %i.vy, align 8, !tbaa !193
  store i16 0, ptr %i.vz, align 2, !tbaa !196
  store i32 9, ptr %14, align 8, !tbaa !197
...
.noexc64.i:                                       ; preds = %bb.ek
  %i.abo = load i32, ptr %14, align 8, !tbaa !197
  store i32 %i.abo, ptr %i.abn, align 8, !tbaa !197
...
bb.eo:                                            ; preds = %bb.em
  ...
  store i16 0, ptr %i.wa, align 8, !tbaa !193
  store i16 0, ptr %i.wb, align 2, !tbaa !196
...
.noexc71.i:                                       ; preds = %bb.ep
  %i.acb = load i32, ptr %15, align 8, !tbaa !197
  store i32 %i.acb, ptr %i.aca, align 8, !tbaa !197
...
.noexc115.i:                                      ; preds = %bb.fx
  store i64 50528515, ptr %i.age, align 8, !tbaa !187
  ...
  store i64 8, ptr %i.agh, align 8, !tbaa !117
...
bb.ga:                                            ; preds = %bb.fz
  ...
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %i.vh)
          to label %_ZN7CMethodD2Ev.exit123.i unwind label %bb.gb, !inline_history !200

bb.gb:                                            ; preds = %bb.ga
  %i.agt = landingpad { ptr, i32 }
          catch ptr null
  %i.agu = extractvalue { ptr, i32 } %i.agt, 0
  call void @__clang_call_terminate(ptr %i.agu) #20, !inline_history !200
  unreachable

_ZN7CMethodD2Ev.exit123.i:                        ; preds = %bb.ga
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %i.vh) #17, !inline_history !200
...
bb.gg:                                            ; preds = %_ZN8NArchive3N7zL13MakeExeMethodERKNS0_22CCompressionMethodModeEbRS1_.exit
  %i.agz = load i8, ptr %i.vd, align 4, !tbaa !167, !range !48, !noundef !49
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i714:     ; preds = %bb.gk, %bb.gi
  ...
  %i.ahq = load ptr, ptr %i.wh, align 8, !tbaa !102
  br label %bb.gl
...
bb.gl:                                            ; preds = %bb.gl, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i714
  ...
  br i1 %.not.i.i717, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i718, label %bb.gl, !llvm.loop !175
...
.lr.ph1506:                                       ; preds = %.lr.ph1506.preheader, %._crit_edge1503
  %indvars.iv1789 = phi i64 [ %i.ahy, %.lr.ph1506.preheader ], [ %indvars.iv.next1790, %._crit_edge1503 ] ; 4 uses
  ...
  %i.aic = load i32, ptr %i.aib, align 4, !tbaa !140
...
bb.gp:                                            ; preds = %.lr.ph1506
  %i.aif = load i32, ptr %i.aia, align 4, !tbaa !142
  %i.aig = getelementptr inbounds nuw i8, ptr %i.aia, i64 8 ; 2 uses
  %i.aih = load i32, ptr %i.aig, align 4, !tbaa !201
...
vector.body3271:                                  ; preds = %vector.body3271, %vector.ph3268
  ...
  %wide.load3275 = load <2 x i64>, ptr %i.ajg, align 8, !tbaa !131
  %wide.load3276 = load <2 x i64>, ptr %i.ajh, align 8, !tbaa !131
  ...
  br i1 %i.ajk, label %middle.block3278, label %vector.body3271, !llvm.loop !202
...
scalar.ph3266.prol:                               ; preds = %scalar.ph3266.preheader, %scalar.ph3266.prol
  ...
  %i.ajq = load i64, ptr %i.ajp, align 8, !tbaa !131
  ...
  br i1 %prol.iter3541.cmp.not, label %scalar.ph3266.prol.loopexit, label %scalar.ph3266.prol, !llvm.loop !203
...
scalar.ph3266:                                    ; preds = %scalar.ph3266, %scalar.ph3266.preheader.new
  ...
  %i.ajy = load i64, ptr %i.ajx, align 8, !tbaa !131
  ...
  %i.akd = load i64, ptr %i.akc, align 8, !tbaa !131
  ...
  %i.aki = load i64, ptr %i.akh, align 8, !tbaa !131
  ...
  %i.akn = load i64, ptr %i.akm, align 8, !tbaa !131
  ...
  br i1 %exitcond.not.i729.3, label %.loopexit946, label %scalar.ph3266, !llvm.loop !204
...
.loopexit946:                                     ; preds = %scalar.ph3266.prol.loopexit, %scalar.ph3266, %middle.block3278, %bb.gq
  ...
  %i.akq = load i64, ptr %i.xc, align 8, !tbaa !205
  ...
  %i.aku = load i64, ptr %i.akt, align 8, !tbaa !131
...
bb.gr:                                            ; preds = %.loopexit946
  ...
  br i1 %.not612, label %bb.gu, label %.critedge677.thread.loopexit
...
bb.gu:                                            ; preds = %bb.gr
  %i.akz = load i64, ptr %i.uv, align 8, !tbaa !178
  %i.ala = add i64 %i.akz, %.09.lcssa.i723
  store i64 %i.ala, ptr %i.uv, align 8, !tbaa !178
...
.lr.ph1497:                                       ; preds = %bb.gu, %bb.gz
  ...
  %i.alt = load i64, ptr %i.als, align 8, !tbaa !131
...
bb.gz:                                            ; preds = %.lr.ph1497
  ...
  store i64 %i.alt, ptr %i.alx, align 8, !tbaa !131
  ...
  br i1 %i.amb, label %.lr.ph1497, label %._crit_edge1498, !llvm.loop !206
...
bb.hb:                                            ; preds = %bb.gp
  ...
  store i32 0, ptr %i.wn, align 8, !tbaa !207
  ...
  store ptr null, ptr %i.wp, align 8, !tbaa !208
...
bb.hf:                                            ; preds = %bb.he
  ...
  store i64 1, ptr %i.wr, align 8, !tbaa !117
...
._crit_edge1490:                                  ; preds = %._crit_edge1490.loopexit, %bb.hf
  ...
  %i.amq = load ptr, ptr %i.wy, align 8, !tbaa !99 ; 7 uses
...
bb.hg:                                            ; preds = %._crit_edge1490
  ...
  %i.amz = invoke noundef i32 %i.amy(ptr noundef nonnull align 8 dereferenceable(8) %i.amr)
          to label %.noexc737 unwind label %bb.ho, !inline_history !218 ; 0 uses
...
bb.hh:                                            ; preds = %.noexc737
  ...
  %i.ane = invoke noundef i32 %i.and(ptr noundef nonnull align 8 dereferenceable(8) %i.ana)
          to label %_ZN9CMyComPtrI20ISequentialOutStreamEaSEPS0_.exit.i unwind label %bb.ho, !inline_history !218 ; 0 uses
...
.lr.ph1489:                                       ; preds = %bb.hf, %bb.hn
  ...
  %i.ano = load i8, ptr %i.ann, align 8, !tbaa !122, !range !48, !noundef !49
...
begin_hunk_3_@_ZN8NArchive3N7z6UpdateEP9IInStreamPKNS0_18CArchiveDatabaseExERK13CObjectVectorINS0_11CUpdateItemEERNS0_11COutArchiveERNS0_16CArchiveDatabaseEP20ISequentialOutStreamP22IArchiveUpdateCallbackRKNS0_14CUpdateOptionsEP22ICryptoGetTextPassword:bb.a
  store i64 %i.are, ptr %i.xz, align 8, !tbaa !225
  ...
  br i1 %exitcond1785.not.3, label %._crit_edge1493, label %scalar.ph3289, !llvm.loop !233
...
bb.hz:                                            ; preds = %bb.ia, %.lr.ph.i.us.i
  ...
  %i.arn = load i32, ptr %i.arm, align 4, !tbaa !234
...
bb.ia:                                            ; preds = %bb.hz
  ...
  br i1 %exitcond.not.i.us.i, label %_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit.thread.i, label %bb.hz, !llvm.loop !235
...
_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit.loopexit.us.i: ; preds = %bb.hz
  ...
  br i1 %i.arp, label %.lr.ph.i.us.i, label %_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit._crit_edge.i, !llvm.loop !236
...
_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit.thread.i: ; preds = %bb.ia, %.lr.ph.i748
  ...
  %i.art = load i64, ptr %i.ars, align 8, !tbaa !131
...
_ZNK8NArchive3N7z7CFolder13GetUnpackSizeEv.exit:  ; preds = %_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit.thread.i, %._crit_edge1493
  ...
  %i.arv = load i64, ptr %i.ye, align 8, !tbaa !237
  %i.arw = add i64 %i.arv, %.1.i
  store i64 %i.arw, ptr %i.ye, align 8, !tbaa !237
...
bb.id:                                            ; preds = %_ZN13CObjectVectorIN8NArchive3N7z7CFolderEE3AddERKS2_.exit754, %_ZN11CVirtThread10WaitFinishEv.exit, %bb.hv
  ...
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(133) %32)
          to label %_ZN8NArchive3N7z7CFolderD2Ev.exit unwind label %bb.ie, !inline_history !238

bb.ie:                                            ; preds = %bb.id
  %i.asf = landingpad { ptr, i32 }
          catch ptr null
  %i.asg = extractvalue { ptr, i32 } %i.asf, 0
  call void @__clang_call_terminate(ptr %i.asg) #20, !inline_history !238
  unreachable

_ZN8NArchive3N7z7CFolderD2Ev.exit:                ; preds = %bb.id
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(133) %32) #17, !inline_history !238
...
bb.if:                                            ; preds = %_ZN8NArchive3N7z17CFolderOutStream24InitEPKNS0_18CArchiveDatabaseExEjPK13CRecordVectorIbEP20ISequentialOutStream.exit, %_ZN8NArchive3N7z7CFolderD2Ev.exit
  ...
  %i.ash = load ptr, ptr %30, align 8, !tbaa !215 ; 3 uses
...
bb.ik:                                            ; preds = %bb.hc, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit
  ...
  %i.asv = load ptr, ptr %i.wp, align 8, !tbaa !208 ; 5 uses
...
bb.il:                                            ; preds = %bb.ik
  ...
  %i.asx = load i8, ptr %i.asw, align 8, !tbaa !239, !range !48, !noundef !49
...
_ZN13CStreamBinderD2Ev.exit:                      ; preds = %bb.in
  ...
  br i1 %.15400, label %bb.iw, label %.critedge677.thread.loopexit
...
bb.iq:                                            ; preds = %bb.ip, %bb.hi
  ...
  %i.atf = load ptr, ptr %30, align 8, !tbaa !215 ; 3 uses
...
bb.iw:                                            ; preds = %bb.ha, %_ZN13CStreamBinderD2Ev.exit
  ...
  %i.att = load i32, ptr %i.aig, align 4, !tbaa !201
...
bb.iy:                                            ; preds = %.lr.ph1502
  store ptr %i.aug, ptr %i.yl, align 8, !tbaa !102
...
bb.iz:                                            ; preds = %bb.iy
  %i.auh = load i8, ptr %i.yn, align 8, !tbaa !122, !range !48, !noundef !49
...
bb.jb:                                            ; preds = %bb.ja
  ...
  %i.auu = load i8, ptr %i.aut, align 4, !tbaa !123, !range !48, !noundef !49
...
bb.jf:                                            ; preds = %bb.jb
  ...
  %i.ava = load i8, ptr %i.auz, align 1, !tbaa !241, !range !48, !noundef !49
...
bb.jh:                                            ; preds = %bb.jg
  store ptr %i.avc, ptr %i.yp, align 8, !tbaa !102
...
bb.ji:                                            ; preds = %bb.jh
  ...
  %i.ave = load i32, ptr %i.ys, align 4, !tbaa !58
  store i32 %i.ave, ptr %i.yt, align 4, !tbaa !58
  %i.avf = load i8, ptr %i.yo, align 2, !tbaa !242, !range !48, !noundef !49
  store i8 %i.avf, ptr %i.yr, align 2, !tbaa !242
  %i.avg = load i8, ptr %i.yn, align 8, !tbaa !122, !range !48, !noundef !49
  store i8 %i.avg, ptr %i.yq, align 8, !tbaa !122
...
bb.jl:                                            ; preds = %bb.jl, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i
  ...
  br i1 %.not.i.i.i, label %bb.jm, label %bb.jl, !llvm.loop !175
...
bb.jp:                                            ; preds = %bb.jj, %bb.jh
  %i.awd = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.awe = load ptr, ptr %i.yp, align 8, !tbaa !102 ; 2 uses
...
.critedge682:                                     ; preds = %bb.jr, %bb.jb, %bb.ja, %bb.iz
  ...
  %i.awg = load ptr, ptr %i.yl, align 8, !tbaa !102 ; 2 uses
...
bb.jt:                                            ; preds = %bb.je, %_ZN8NArchive3N7z9CFileItemD2Ev.exit768, %bb.jd
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %34) #17
  %i.awk = load ptr, ptr %i.yl, align 8, !tbaa !102 ; 2 uses
...
.critedge677:                                     ; preds = %.critedge677.loopexit, %.preheader955
  ...
  br i1 %i.awr, label %.critedge677.thread, label %bb.jv
...
bb.jv:                                            ; preds = %.critedge677
  ...
  store i64 24, ptr %i.yx, align 8, !tbaa !117
...
begin_hunk_4_@_ZN8NArchive3N7z6UpdateEP9IInStreamPKNS0_18CArchiveDatabaseExERK13CObjectVectorINS0_11CUpdateItemEERNS0_11COutArchiveERNS0_16CArchiveDatabaseEP20ISequentialOutStreamP22IArchiveUpdateCallbackRKNS0_14CUpdateOptionsEP22ICryptoGetTextPassword:bb.a
  ...
  %wide.load3257 = load <2 x i64>, ptr %gep3781, align 8, !tbaa !131, !alias.scope !262
  %wide.load3258 = load <2 x i64>, ptr %i.bcz, align 8, !tbaa !131, !alias.scope !262
...
middle.block3260:                                 ; preds = %vector.body3253
  ...
  store i64 %i.bdd, ptr %i.xz, align 8, !tbaa !225, !alias.scope !266, !noalias !262
...
scalar.ph3248.prol:                               ; preds = %scalar.ph3248.preheader, %scalar.ph3248.prol
  ...
  %i.bdh = load i64, ptr %i.bdg, align 8, !tbaa !131
  %i.bdi = add i64 %i.bdh, %i.bdf                 ; 3 uses
  store i64 %i.bdi, ptr %i.xz, align 8, !tbaa !225
...
bb.lq:                                            ; preds = %bb.lr, %.lr.ph.i.us.i827
  ...
  %i.beo = load i32, ptr %i.ben, align 4, !tbaa !234
...
bb.lr:                                            ; preds = %bb.lq
  ...
  br i1 %exitcond.not.i.us.i831, label %_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit.thread.i824, label %bb.lq, !llvm.loop !235
...
_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit.loopexit.us.i832: ; preds = %bb.lq
  ...
  br i1 %i.beq, label %.lr.ph.i.us.i827, label %_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit._crit_edge.i820, !llvm.loop !236
...
_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit.thread.i824: ; preds = %bb.lr, %.lr.ph.i821
  ...
  %i.beu = load i64, ptr %i.bet, align 8, !tbaa !131
...
_ZNK8NArchive3N7z7CFolder13GetUnpackSizeEv.exit835: ; preds = %_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit.thread.i824, %._crit_edge1532
  ...
  %i.bew = load i64, ptr %i.ye, align 8, !tbaa !237
  %i.bex = add i64 %i.bew, %.1.i826
  store i64 %i.bex, ptr %i.ye, align 8, !tbaa !237
...
bb.lu:                                            ; preds = %_ZN13CObjectVectorIN8NArchive3N7z7CFolderEE3AddERKS2_.exit840, %bb.mg
  ...
  %.251536 = phi i32 [ %.23., %_ZN13CObjectVectorIN8NArchive3N7z7CFolderEE3AddERKS2_.exit840 ], [ %.26, %bb.mg ] ; 2 uses
  %.04171534 = phi i32 [ 0, %_ZN13CObjectVectorIN8NArchive3N7z7CFolderEE3AddERKS2_.exit840 ], [ %.2419, %bb.mg ] ; 3 uses
...
bb.lv:                                            ; preds = %bb.lu
  store ptr %i.bfq, ptr %i.zz, align 8, !tbaa !102
  ...
  %i.bfs = load i8, ptr %i.bfr, align 1, !tbaa !241, !range !48, !noundef !49
...
bb.ly:                                            ; preds = %bb.md, %bb.ma, %bb.lw
  ...
  %i.bfw = load ptr, ptr %i.zz, align 8, !tbaa !102 ; 2 uses
...
bb.ma:                                            ; preds = %bb.lv
  %i.bfy = load i32, ptr %i.bfp, align 8, !tbaa !119
...
bb.mb:                                            ; preds = %bb.ma, %bb.lw
  ...
  br i1 %or.cond, label %bb.me, label %bb.mc
...
bb.md:                                            ; preds = %bb.mc
  ...
  store i8 %spec.select2167, ptr %i.aac, align 2, !tbaa !242
  store i8 %spec.select2167, ptr %i.aaa, align 8, !tbaa !122
...
bb.me:                                            ; preds = %bb.md, %bb.mc, %bb.mb
  %.2419 = phi i32 [ %.04171534, %bb.mb ], [ %.04171534, %bb.mc ], [ %spec.select2168, %bb.md ] ; 2 uses
  %.23408 = phi i32 [ 1, %bb.mb ], [ 57, %bb.mc ], [ 0, %bb.md ] ; 2 uses
  %.26 = phi i32 [ -2147467259, %bb.mb ], [ %.251536, %bb.mc ], [ %.251536, %bb.md ] ; 3 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %42) #17
  %i.bgo = load ptr, ptr %i.zz, align 8, !tbaa !102 ; 2 uses
  %i.bgp = icmp eq ptr %i.bgo, null
  br i1 %i.bgp, label %_ZN8NArchive3N7z9CFileItemD2Ev.exit844, label %bb.mf

bb.mf:                                            ; preds = %bb.me
  call void @_ZdaPv(ptr noundef nonnull %i.bgo) #19
  br label %_ZN8NArchive3N7z9CFileItemD2Ev.exit844

_ZN8NArchive3N7z9CFileItemD2Ev.exit844:           ; preds = %bb.me, %bb.mf
  call void @llvm.lifetime.end.p0(ptr nonnull %41) #17
  switch i32 %.23408, label %.loopexit [
    i32 0, label %bb.mg
    i32 57, label %bb.mg
  ]

bb.mg:                                            ; preds = %_ZN8NArchive3N7z9CFileItemD2Ev.exit844, %_ZN8NArchive3N7z9CFileItemD2Ev.exit844
...
bb.mi:                                            ; preds = %bb.mh
  ...
  store i32 %.2419, ptr %i.bgt, align 4, !tbaa !4
...
.loopexit:                                        ; preds = %_ZN8NArchive3N7z9CFileItemD2Ev.exit844, %bb.mi, %bb.lk
  %.7548 = phi i32 [ %.5546, %bb.lk ], [ %i.bgw, %bb.mi ], [ %.5546, %_ZN8NArchive3N7z9CFileItemD2Ev.exit844 ]
  %.26411 = phi i32 [ 1, %bb.lk ], [ 0, %bb.mi ], [ %.23408, %_ZN8NArchive3N7z9CFileItemD2Ev.exit844 ] ; 2 uses
  %.28 = phi i32 [ %i.bcp, %bb.lk ], [ %.26, %bb.mi ], [ %.26, %_ZN8NArchive3N7z9CFileItemD2Ev.exit844 ] ; 2 uses
  ...
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(133) %40)
          to label %bb.mk unwind label %bb.mj, !inline_history !238

bb.mj:                                            ; preds = %.loopexit
  %i.bgx = landingpad { ptr, i32 }
          catch ptr null
  %i.bgy = extractvalue { ptr, i32 } %i.bgx, 0
  call void @__clang_call_terminate(ptr %i.bgy) #20, !inline_history !238
  unreachable

bb.mk:                                            ; preds = %.loopexit
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(133) %40) #17, !inline_history !238
...
_ZN11CStringBaseIwED2Ev.exit850:                  ; preds = %bb.mk
  ...
  %cond6 = icmp eq i32 %.26411, 0
  br i1 %cond6, label %bb.km, label %bb.mp, !llvm.loop !273
...
bb.mp:                                            ; preds = %bb.km, %_ZN11CStringBaseIwED2Ev.exit850
  %.27412 = phi i32 [ %.26411, %_ZN11CStringBaseIwED2Ev.exit850 ], [ 0, %bb.km ]
  %.29 = phi i32 [ %.28, %_ZN11CStringBaseIwED2Ev.exit850 ], [ %.23, %bb.km ]
...
.critedge677.thread.loopexit:                     ; preds = %bb.gr, %_ZN13CStreamBinderD2Ev.exit
  %.31.ph = phi i32 [ %i.akw, %bb.gr ], [ %.18, %_ZN13CStreamBinderD2Ev.exit ]
  %46 = trunc nsw i64 %indvars.iv1789 to i32
  br label %.critedge677.thread

.critedge677.thread:                              ; preds = %.critedge677.thread.loopexit, %bb.mp, %.critedge677
  %.15611028 = phi i32 [ %.1561.lcssa, %.critedge677 ], [ %.1561.lcssa, %bb.mp ], [ %46, %.critedge677.thread.loopexit ] ; 2 uses
  %.29414 = phi i32 [ 25, %.critedge677 ], [ %.27412, %bb.mp ], [ 1, %.critedge677.thread.loopexit ]
  %.31 = phi i32 [ %.10.lcssa, %.critedge677 ], [ %.29, %bb.mp ], [ %.31.ph, %.critedge677.thread.loopexit ] ; 2 uses
  ...
  %i.bhm = load ptr, ptr %i.ve, align 8, !tbaa !102 ; 2 uses
  %i.bhn = icmp eq ptr %i.bhm, null
  br i1 %i.bhn, label %_ZN11CStringBaseIwED2Ev.exit.i, label %bb.mq

bb.mq:                                            ; preds = %.critedge677.thread
  call void @_ZdaPv(ptr noundef nonnull %i.bhm) #19
  br label %_ZN11CStringBaseIwED2Ev.exit.i

_ZN11CStringBaseIwED2Ev.exit.i:                   ; preds = %bb.mq, %.critedge677.thread
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %i.uz) #17
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTV13CObjectVectorIN8NArchive3N7z11CMethodFullEE, i64 16), ptr %26, align 8, !tbaa !33
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(88) %26)
          to label %_ZN8NArchive3N7z22CCompressionMethodModeD2Ev.exit unwind label %bb.mr, !inline_history !274

bb.mr:                                            ; preds = %_ZN11CStringBaseIwED2Ev.exit.i
  %47 = landingpad { ptr, i32 }
          catch ptr null
  %i.bho = extractvalue { ptr, i32 } %47, 0
...
_ZN8NArchive3N7z22CCompressionMethodModeD2Ev.exit: ; preds = %_ZN11CStringBaseIwED2Ev.exit.i
  ...
  switch i32 %.29414, label %.loopexit962 [
    i32 0, label %bb.ms
    i32 25, label %bb.ms
  ]

bb.ms:                                            ; preds = %_ZN8NArchive3N7z22CCompressionMethodModeD2Ev.exit, %_ZN8NArchive3N7z22CCompressionMethodModeD2Ev.exit
...
bb.mv:                                            ; preds = %bb.ms
  ...
  %.not649 = icmp eq i32 %.15611028, %i.bhp
...
bb.mx:                                            ; preds = %bb.mv
  ...
  store i64 4, ptr %i.bhs, align 8, !tbaa !117
...
bb.my:                                            ; preds = %.lr.ph1543, %bb.nf
  ...
  %i.bic = load i8, ptr %i.bib, align 4, !tbaa !123, !range !48, !noundef !49
  %i.bid = trunc nuw i8 %i.bic to i1
  br i1 %i.bid, label %bb.mz, label %bb.nc

bb.mz:                                            ; preds = %bb.my
  %i.bie = getelementptr inbounds nuw i8, ptr %i.bia, i64 63
  %i.bif = load i8, ptr %i.bie, align 1, !tbaa !159, !range !48, !noundef !49
...
bb.nc:                                            ; preds = %bb.my
  %i.bip = load i32, ptr %i.bia, align 8, !tbaa !119 ; 2 uses
...
bb.nd:                                            ; preds = %bb.nc
  ...
  %i.biv = load i8, ptr %i.biu, align 8, !tbaa !122, !range !48, !noundef !49
...
bb.nh:                                            ; preds = %bb.ng
  store ptr %i.bjv, ptr %i.bjl, align 8, !tbaa !102
  ...
  %i.bjx = load i8, ptr %i.bjw, align 1, !tbaa !241, !range !48, !noundef !49
...
bb.nk:                                            ; preds = %bb.nn, %bb.nm, %bb.ni
  ...
  %i.bkb = load ptr, ptr %i.bjl, align 8, !tbaa !102 ; 2 uses
...
bb.nm:                                            ; preds = %bb.nh
  %i.bkd = load i32, ptr %i.bju, align 8, !tbaa !119
...
bb.no:                                            ; preds = %bb.nn
  call void @llvm.lifetime.end.p0(ptr nonnull %45) #17
  %i.bke = load ptr, ptr %i.bjl, align 8, !tbaa !102 ; 2 uses
