...
bb.h:                                             ; preds = %bb.g
  ...
  %26 = ashr i32 %i.bm, 31
  %27 = or i32 %26, %25
  %i.db = trunc nsw i32 %27 to i16
  %28 = sub i16 %.0436543, %i.db
  br label %bb.n

bb.i:                                             ; preds = %.lr.ph549
  %i.dc = icmp slt i32 %10, 0
  br i1 %i.dc, label %bb.j, label %bb.n

bb.j:                                             ; preds = %bb.i
  %29 = icmp sgt i32 %i.bv, 0
  %30 = zext i1 %29 to i32
  %31 = ashr i32 %i.bv, 31
  %32 = or i32 %31, %30                           ; 2 uses
  %i.dd = trunc nsw i32 %32 to i16
  %i.de = add i16 %.0430546, %i.dd                ; 4 uses
  %i.df = mul i32 %i.bv, %32
  %i.dg = sub i32 0, %i.df
...
bb.k:                                             ; preds = %bb.j
  %33 = icmp sgt i32 %i.bs, 0
  %34 = zext i1 %33 to i32
  %35 = ashr i32 %i.bs, 31
  %36 = or i32 %35, %34                           ; 2 uses
  %i.dk = trunc nsw i32 %36 to i16
  %i.dl = add i16 %.0432545, %i.dk                ; 3 uses
  %i.dm = mul i32 %i.bs, %36
  %i.dn = sub i32 0, %i.dm
...
bb.l:                                             ; preds = %bb.k
  %37 = icmp sgt i32 %i.bp, 0
  %38 = zext i1 %37 to i32
  %39 = ashr i32 %i.bp, 31
  %40 = or i32 %39, %38                           ; 2 uses
  %i.ds = trunc nsw i32 %40 to i16
  %i.dt = add i16 %.0434544, %i.ds                ; 2 uses
  %i.du = mul i32 %i.bp, %40
  %i.dv = sub i32 0, %i.du
...
bb.m:                                             ; preds = %bb.l
  %41 = icmp sgt i32 %i.bm, 0
  %42 = zext i1 %41 to i32
  %43 = ashr i32 %i.bm, 31
  %44 = or i32 %43, %42
  %i.dz = trunc nsw i32 %44 to i16
  %i.ea = add i16 %.0436543, %i.dz
  br label %bb.n

bb.n:                                             ; preds = %bb.h, %bb.m, %bb.i, %bb.l, %bb.k, %bb.j, %bb.g, %bb.f, %bb.e
  %.1437 = phi i16 [ %.0436543, %bb.e ], [ %.0436543, %bb.f ], [ %.0436543, %bb.g ], [ %28, %bb.h ], [ %.0436543, %bb.j ], [ %.0436543, %bb.k ], [ %.0436543, %bb.l ], [ %i.ea, %bb.m ], [ %.0436543, %bb.i ] ; 2 uses
...
.lr.ph534:                                        ; preds = %.lr.ph534.preheader, %bb.ag
  %store_forwarded637 = phi i32 [ %load_initial636, %.lr.ph534.preheader ], [ %i.gg, %bb.ag ]
...
begin_hunk_9_@unpc_block:bb.a
  ...
  %i.eu = load i32, ptr %i.et, align 4, !tbaa !4  ; 9 uses
  %i.ev = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv571 ; 8 uses
  %i.ew = getelementptr inbounds i8, ptr %i.ev, i64 -8
  %i.ex = sub nsw i32 %i.eu, %store_forwarded637  ; 5 uses
  %i.ey = getelementptr inbounds i8, ptr %i.ev, i64 -12
  %i.ez = load i32, ptr %i.ew, align 4, !tbaa !4
  %i.fa = sub nsw i32 %i.eu, %i.ez                ; 7 uses
  %i.fb = getelementptr inbounds i8, ptr %i.ev, i64 -16
  %i.fc = load i32, ptr %i.ey, align 4, !tbaa !4
  %i.fd = sub nsw i32 %i.eu, %i.fc                ; 7 uses
  %i.fe = getelementptr inbounds i8, ptr %i.ev, i64 -20
  %i.ff = load i32, ptr %i.fb, align 4, !tbaa !4
  %i.fg = sub nsw i32 %i.eu, %i.ff                ; 7 uses
  %i.fh = getelementptr inbounds i8, ptr %i.ev, i64 -24
  %i.fi = load i32, ptr %i.fe, align 4, !tbaa !4
  %i.fj = sub nsw i32 %i.eu, %i.fi                ; 7 uses
  %i.fk = getelementptr inbounds i8, ptr %i.ev, i64 -28
  %i.fl = load i32, ptr %i.fh, align 4, !tbaa !4
  %i.fm = sub nsw i32 %i.eu, %i.fl                ; 7 uses
  %i.fn = getelementptr inbounds i8, ptr %i.ev, i64 -32
  %i.fo = load i32, ptr %i.fk, align 4, !tbaa !4
  %i.fp = sub nsw i32 %i.eu, %i.fo                ; 7 uses
  %i.fq = load i32, ptr %i.fn, align 4, !tbaa !4
  %i.fr = sub nsw i32 %i.eu, %i.fq                ; 7 uses
...
begin_hunk_10_@unpc_block:bb.a
  ...
  %reass.add495 = add i32 %reass.add, %.neg483.a
  ...
  %i.gh = icmp sgt i32 %49, 0
  br i1 %i.gh, label %bb.p, label %bb.x

bb.p:                                             ; preds = %.lr.ph534
  %50 = icmp sgt i32 %i.fr, 0
  %51 = zext i1 %50 to i32
  %52 = ashr i32 %i.fr, 31
  %53 = or i32 %52, %51                           ; 2 uses
  %i.gi = trunc nsw i32 %53 to i16
  %i.gj = sub i16 %.0416528, %i.gi                ; 8 uses
  %i.gk = mul nsw i32 %53, %i.fr
...
bb.q:                                             ; preds = %bb.p
  %54 = icmp sgt i32 %i.fp, 0
  %55 = zext i1 %54 to i32
  %56 = ashr i32 %i.fp, 31
  %57 = or i32 %56, %55                           ; 2 uses
  %i.go = trunc nsw i32 %57 to i16
  %i.gp = sub i16 %.0418527, %i.go                ; 7 uses
  %i.gq = mul nsw i32 %57, %i.fp
...
bb.r:                                             ; preds = %bb.q
  %58 = icmp sgt i32 %i.fm, 0
  %59 = zext i1 %58 to i32
  %60 = ashr i32 %i.fm, 31
  %61 = or i32 %60, %59                           ; 2 uses
  %i.gv = trunc nsw i32 %61 to i16
  %i.gw = sub i16 %.0420526, %i.gv                ; 6 uses
  %i.gx = mul nsw i32 %61, %i.fm
...
bb.s:                                             ; preds = %bb.r
  %62 = icmp sgt i32 %i.fj, 0
  %63 = zext i1 %62 to i32
  %64 = ashr i32 %i.fj, 31
  %65 = or i32 %64, %63                           ; 2 uses
  %i.hb = trunc nsw i32 %65 to i16
  %i.hc = sub i16 %.0422525, %i.hb                ; 5 uses
  %i.hd = mul nsw i32 %65, %i.fj
...
bb.t:                                             ; preds = %bb.s
  %66 = icmp sgt i32 %i.fg, 0
  %67 = zext i1 %66 to i32
  %68 = ashr i32 %i.fg, 31
  %69 = or i32 %68, %67                           ; 2 uses
  %i.hi = trunc nsw i32 %69 to i16
  %i.hj = sub i16 %.0414529, %i.hi                ; 4 uses
  %i.hk = mul nsw i32 %69, %i.fg
...
bb.u:                                             ; preds = %bb.t
  %70 = icmp sgt i32 %i.fd, 0
  %71 = zext i1 %70 to i32
  %72 = ashr i32 %i.fd, 31
  %73 = or i32 %72, %71                           ; 2 uses
  %i.ho = trunc nsw i32 %73 to i16
  %i.hp = sub i16 %.0412530, %i.ho                ; 3 uses
  %i.hq = mul nsw i32 %73, %i.fd
...
bb.v:                                             ; preds = %bb.u
  %74 = icmp sgt i32 %i.fa, 0
  %75 = zext i1 %74 to i32
  %76 = ashr i32 %i.fa, 31
  %77 = or i32 %76, %75                           ; 2 uses
  %i.hu = trunc nsw i32 %77 to i16
  %i.hv = sub i16 %.0410531, %i.hu                ; 2 uses
  %i.hw = mul nsw i32 %77, %i.fa
...
bb.w:                                             ; preds = %bb.v
  %78 = icmp sgt i32 %i.ex, 0
  %79 = zext i1 %78 to i32
  %80 = ashr i32 %i.ex, 31
  %81 = or i32 %80, %79
  %i.ia = trunc nsw i32 %81 to i16
  %82 = sub i16 %.0532, %i.ia
  br label %bb.ag

bb.x:                                             ; preds = %.lr.ph534
  %i.ib = icmp slt i32 %48, 0
  br i1 %i.ib, label %bb.y, label %bb.ag

bb.y:                                             ; preds = %bb.x
  %83 = icmp sgt i32 %i.fr, 0
  %84 = zext i1 %83 to i32
  %85 = ashr i32 %i.fr, 31
  %86 = or i32 %85, %84                           ; 2 uses
  %i.ic = trunc nsw i32 %86 to i16
  %i.id = add i16 %.0416528, %i.ic                ; 8 uses
  %i.ie = mul i32 %i.fr, %86
  %i.if = sub i32 0, %i.ie
...
bb.z:                                             ; preds = %bb.y
  %87 = icmp sgt i32 %i.fp, 0
  %88 = zext i1 %87 to i32
  %89 = ashr i32 %i.fp, 31
  %90 = or i32 %89, %88                           ; 2 uses
  %i.ij = trunc nsw i32 %90 to i16
  %i.ik = add i16 %.0418527, %i.ij                ; 7 uses
  %i.il = mul i32 %i.fp, %90
  %i.im = sub i32 0, %i.il
...
bb.aa:                                            ; preds = %bb.z
  %91 = icmp sgt i32 %i.fm, 0
  %92 = zext i1 %91 to i32
  %93 = ashr i32 %i.fm, 31
  %94 = or i32 %93, %92                           ; 2 uses
  %i.ir = trunc nsw i32 %94 to i16
  %i.is = add i16 %.0420526, %i.ir                ; 6 uses
  %i.it = mul i32 %i.fm, %94
  %i.iu = sub i32 0, %i.it
...
bb.ab:                                            ; preds = %bb.aa
  %95 = icmp sgt i32 %i.fj, 0
  %96 = zext i1 %95 to i32
  %97 = ashr i32 %i.fj, 31
  %98 = or i32 %97, %96                           ; 2 uses
  %i.iy = trunc nsw i32 %98 to i16
  %i.iz = add i16 %.0422525, %i.iy                ; 5 uses
  %i.ja = mul i32 %i.fj, %98
  %i.jb = sub i32 0, %i.ja
...
bb.ac:                                            ; preds = %bb.ab
  %99 = icmp sgt i32 %i.fg, 0
  %100 = zext i1 %99 to i32
  %101 = ashr i32 %i.fg, 31
  %102 = or i32 %101, %100                        ; 2 uses
  %i.jg = trunc nsw i32 %102 to i16
  %i.jh = add i16 %.0414529, %i.jg                ; 4 uses
  %i.ji = mul i32 %i.fg, %102
  %i.jj = sub i32 0, %i.ji
...
bb.ad:                                            ; preds = %bb.ac
  %103 = icmp sgt i32 %i.fd, 0
  %104 = zext i1 %103 to i32
  %105 = ashr i32 %i.fd, 31
  %106 = or i32 %105, %104                        ; 2 uses
  %i.jn = trunc nsw i32 %106 to i16
  %i.jo = add i16 %.0412530, %i.jn                ; 3 uses
  %i.jp = mul i32 %i.fd, %106
  %i.jq = sub i32 0, %i.jp
...
bb.ae:                                            ; preds = %bb.ad
  %107 = icmp sgt i32 %i.fa, 0
  %108 = zext i1 %107 to i32
  %109 = ashr i32 %i.fa, 31
  %110 = or i32 %109, %108                        ; 2 uses
  %i.ju = trunc nsw i32 %110 to i16
  %i.jv = add i16 %.0410531, %i.ju                ; 2 uses
  %i.jw = mul i32 %i.fa, %110
  %i.jx = sub i32 0, %i.jw
...
bb.af:                                            ; preds = %bb.ae
  %111 = icmp sgt i32 %i.ex, 0
  %112 = zext i1 %111 to i32
  %113 = ashr i32 %i.ex, 31
  %114 = or i32 %113, %112
  %i.kb = trunc nsw i32 %114 to i16
...
begin_hunk_24_@unpc_block:bb.a
  ...
  %.1 = phi i16 [ %.0532, %bb.p ], [ %.0532, %bb.q ], [ %.0532, %bb.r ], [ %.0532, %bb.s ], [ %.0532, %bb.t ], [ %.0532, %bb.u ], [ %.0532, %bb.v ], [ %82, %bb.w ], [ %.0532, %bb.y ], [ %.0532, %bb.z ], [ %.0532, %bb.aa ], [ %.0532, %bb.ab ], [ %.0532, %bb.ac ], [ %.0532, %bb.ad ], [ %.0532, %bb.ae ], [ %i.kc, %bb.af ], [ %.0532, %bb.x ] ; 2 uses
...
begin_hunk_25_@unpc_block:bb.a
  ...
  %i.kh = load i32, ptr %i.kg, align 4, !tbaa !4  ; 5 uses
...
begin_hunk_26_@unpc_block:bb.a
  ...
  %115 = icmp sgt i32 %i.li, 0
  %116 = zext i1 %115 to i32
  %117 = ashr i32 %i.li, 31                       ; 2 uses
  %118 = or i32 %117, %116
...
begin_hunk_28_@unpc_block:bb.a
  ...
  %i.lu = sub nsw i32 %i.kh, %i.lt                ; 3 uses
  %119 = icmp sgt i32 %i.lu, 0
  %120 = zext i1 %119 to i32
  %121 = ashr i32 %i.lu, 31
...
begin_hunk_30_@unpc_block:bb.a
  ...
  %i.mj = sub nsw i32 %i.kh, %i.mi                ; 3 uses
  %124 = icmp sgt i32 %i.mj, 0
  %125 = zext i1 %124 to i32
  %126 = ashr i32 %i.mj, 31
