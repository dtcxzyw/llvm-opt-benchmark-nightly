...
.lr.ph551:                                        ; preds = %.lr.ph551.preheader, %bb.n
  ...
  %i.bz = add i32 %.neg506, %.neg508
  %i.ca = add i32 %.neg504, %i.bz
...
.lr.ph536:                                        ; preds = %.lr.ph536.preheader, %bb.ag
  ...
  %i.gi = add i32 %.neg493, %.neg495
  %i.gj = add i32 %.neg491, %i.gi
  %i.gk = add i32 %.neg489, %i.gj
  %i.gl = add i32 %.neg487, %i.gk
  %i.gm = add i32 %.neg485, %i.gl
  %i.gn = add i32 %.neg483, %i.gm
