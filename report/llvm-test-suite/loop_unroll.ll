...
.preheader17.us.preheader:                        ; preds = %.preheader17.lr.ph
  ...
  %i.m = icmp slt i32 %i.j, %1
  %3 = add nsw i32 %1, -3
  %4 = sub i32 %3, %i.h                           ; 2 uses
  %5 = zext i32 %4 to i64
  %i.n = add nuw nsw i64 %5, 1                    ; 2 uses
  ...
  %n.vec73 = and i64 %8, 9223372036854775800      ; 3 uses
  %9 = shl nuw i64 %n.vec73, 1
  %cmp.n85 = icmp eq i64 %8, %n.vec73
...
scalar.ph69.preheader:                            ; preds = %.preheader17.us, %middle.block83
  %indvars.iv.ph = phi i64 [ 0, %.preheader17.us ], [ %9, %middle.block83 ]
