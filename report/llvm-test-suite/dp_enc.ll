...
.lr.ph559:                                        ; preds = %.lr.ph559.preheader, %bb.n
  ...
  %i.ed = add i32 %.neg509, %.neg511
  %i.ee = add i32 %.neg507, %i.ed
...
.lr.ph544:                                        ; preds = %.lr.ph544.preheader, %bb.ag
  ...
  %i.io = add i32 %.neg493, %.neg495
  %i.ip = add i32 %.neg491, %i.io
  %i.iq = add i32 %.neg489, %i.ip
  %i.ir = add i32 %.neg487, %i.iq
  %i.is = add i32 %.neg485, %i.ir
  %i.it = add i32 %.neg483, %i.is
