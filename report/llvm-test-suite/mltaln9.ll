...
.preheader49.preheader:                           ; preds = %.preheader50
  %wide.trip.count80 = zext i32 %i.ax to i64
...
bb.b:                                             ; preds = %bb.i, %.lr.ph75.us.us
  ...
  %.05872.us.us = phi i32 [ 0, %.lr.ph75.us.us ], [ %i.bg, %bb.i ] ; 7 uses
...
bb.f:                                             ; preds = %.lr.ph.us.us, %bb.f
  ...
  %.264.us.us = phi double [ %i.ah, %.lr.ph.us.us ], [ %i.an, %bb.f ]
  %i.an = fadd double %.264.us.us, %i.bl          ; 2 uses
  %indvars.iv.next104 = add nsw i64 %indvars.iv103, 1 ; 2 uses
  %i.ao = getelementptr inbounds i8, ptr %i.p, i64 %indvars.iv.next104
  %i.ap = load i8, ptr %i.ao, align 1, !tbaa !8
  %i.aq = icmp eq i8 %i.ap, 45
  br i1 %i.aq, label %bb.f, label %._crit_edge.us.us.loopexit, !llvm.loop !46

._crit_edge.us.us.loopexit:                       ; preds = %bb.f
  %i.ar = trunc nsw i64 %indvars.iv103 to i32
  br label %._crit_edge.us.us

._crit_edge.us.us:                                ; preds = %._crit_edge.us.us.loopexit, %bb.e
  %.260.lcssa.us.us = phi i32 [ %.05872.us.us, %bb.e ], [ %i.ar, %._crit_edge.us.us.loopexit ] ; 2 uses
  %.2.lcssa.us.us = phi double [ %i.ah, %bb.e ], [ %i.an, %._crit_edge.us.us.loopexit ] ; 2 uses
  %i.as = icmp sgt i32 %.260.lcssa.us.us, %i.a
  br i1 %i.as, label %._crit_edge76.us.us, label %bb.i
...
bb.h:                                             ; preds = %.lr.ph68.us.us, %bb.h
  ...
  %.166.us.us = phi double [ %i.au, %.lr.ph68.us.us ], [ %i.ba, %bb.h ]
  %i.ba = fadd double %.166.us.us, %i.bo          ; 2 uses
  %indvars.iv.next107 = add nsw i64 %indvars.iv106, 1 ; 2 uses
  %i.bb = getelementptr inbounds i8, ptr %i.i, i64 %indvars.iv.next107
  %i.bc = load i8, ptr %i.bb, align 1, !tbaa !8
  %i.bd = icmp eq i8 %i.bc, 45
  br i1 %i.bd, label %bb.h, label %._crit_edge69.us.us.loopexit, !llvm.loop !47

._crit_edge69.us.us.loopexit:                     ; preds = %bb.h
  %i.be = trunc nsw i64 %indvars.iv106 to i32
  br label %._crit_edge69.us.us

._crit_edge69.us.us:                              ; preds = %._crit_edge69.us.us.loopexit, %bb.g
  %.159.lcssa.us.us = phi i32 [ %.05872.us.us, %bb.g ], [ %i.be, %._crit_edge69.us.us.loopexit ] ; 2 uses
  %.1.lcssa.us.us = phi double [ %i.au, %bb.g ], [ %i.ba, %._crit_edge69.us.us.loopexit ] ; 2 uses
  %i.bf = icmp sgt i32 %.159.lcssa.us.us, %i.a
  br i1 %i.bf, label %._crit_edge76.us.us, label %bb.i
...
bb.i:                                             ; preds = %._crit_edge69.us.us, %._crit_edge.us.us, %bb.d, %bb.b
  ...
  %i.bg = add nsw i32 %.361.us.us, 1              ; 2 uses
  %i.bh = icmp slt i32 %i.bg, %6
  br i1 %i.bh, label %bb.b, label %._crit_edge76.us.us, !llvm.loop !48
...
._crit_edge76.us.us:                              ; preds = %bb.i, %._crit_edge69.us.us, %._crit_edge.us.us
  ...
  %i.bi = tail call double @llvm.fmuladd.f64(double %.4.us.us, double %i.n, double %i.j) ; 3 uses
  store double %i.bi, ptr %7, align 8, !tbaa !24
  %indvars.iv.next110 = add nuw nsw i64 %indvars.iv109, 1 ; 2 uses
  %exitcond113.not = icmp eq i64 %indvars.iv.next110, %wide.trip.count112
  br i1 %exitcond113.not, label %._crit_edge84.split.us.us, label %.lr.ph75.us.us, !llvm.loop !49
...
.preheader.new:                                   ; preds = %.preheader, %.preheader.new
  ...
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge84.split.unr-lcssa, label %.preheader.new, !llvm.loop !49
...
.lr.ph78.preheader:                               ; preds = %.preheader
  %i.f = add nsw i32 %1, -1
  %wide.trip.count111 = zext i32 %i.f to i64
...
.lr.ph99:                                         ; preds = %.loopexit73
  ...
  %wide.trip.count141 = zext i32 %i.be to i64     ; 2 uses
...
.lr.ph95.us:                                      ; preds = %.lr.ph99, %.loopexit.us
  ...
  %.05898.us = phi double [ %i.df, %.loopexit.us ], [ 0.000000e+00, %.lr.ph99 ]
...
.lr.ph83.us.us:                                   ; preds = %._crit_edge.us.us, %.lr.ph95.us
  ...
  %.15993.us.us = phi double [ %i.df, %._crit_edge.us.us ], [ %.05898.us, %.lr.ph95.us ]
...
bb.e:                                             ; preds = %bb.i, %.lr.ph83.us.us
  ...
  %.06680.us.us = phi i32 [ 0, %.lr.ph83.us.us ], [ %i.cx, %bb.i ] ; 3 uses
...
bb.i:                                             ; preds = %bb.e, %bb.h, %bb.g, %bb.f
  ...
  %i.cx = add nsw i32 %.3.us.us, 1                ; 2 uses
  %i.cy = icmp slt i32 %i.cx, %i.c
  br i1 %i.cy, label %bb.e, label %._crit_edge.us.us, !llvm.loop !60
...
._crit_edge.us.us:                                ; preds = %bb.i, %bb.h, %bb.g
  ...
  %i.cz = sitofp i64 %.257.us.us to double
  %i.da = sitofp i32 %.265.us.us to double
  %i.db = fdiv double %i.cz, %i.da
  %i.dc = load ptr, ptr %i.bo, align 8, !tbaa !52
  %i.dd = getelementptr inbounds nuw [8 x i8], ptr %i.dc, i64 %indvars.iv133
  %i.de = load double, ptr %i.dd, align 8, !tbaa !24
  %i.df = tail call double @llvm.fmuladd.f64(double %i.db, double %i.de, double %.15993.us.us) ; 3 uses
  %indvars.iv.next134 = add nuw nsw i64 %indvars.iv133, 1 ; 2 uses
  %exitcond137.not = icmp eq i64 %indvars.iv.next134, %wide.trip.count136
  br i1 %exitcond137.not, label %.loopexit.us, label %.lr.ph83.us.us, !llvm.loop !61
...
bb.j:                                             ; preds = %.lr.ph95, %bb.j
  ...
  br i1 %exitcond119.not, label %.loopexit, label %bb.j, !llvm.loop !61
...
._crit_edge:                                      ; preds = %.loopexit, %.loopexit.us, %.preheader, %.loopexit73
  ...
  %.058.lcssa = phi double [ 0.000000e+00, %.loopexit73 ], [ %i.df, %.loopexit.us ], [ 0.000000e+00, %.preheader ], [ +qnan, %.loopexit ] ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph150.us, %bb.g
  ...
  %.0121147.us = phi i32 [ 0, %.lr.ph150.us ], [ %i.cb, %bb.g ] ; 7 uses
...
.lr.ph.us:                                        ; preds = %bb.d, %.lr.ph.us
  ...
  %.2139.us = phi double [ %i.av, %.lr.ph.us ], [ %i.ai, %bb.d ]
  %i.ao = getelementptr inbounds i8, ptr %i.s, i64 %indvars.iv215
  %i.ap = load i8, ptr %i.ao, align 1, !tbaa !8
  %i.aq = sext i8 %i.ap to i64
  %i.ar = getelementptr inbounds [512 x i8], ptr @amino_dis, i64 %i.aq
  %i.as = getelementptr inbounds nuw i8, ptr %i.ar, i64 180
  %i.at = load i32, ptr %i.as, align 4, !tbaa !4
  %i.au = sitofp i32 %i.at to double
  %i.av = fadd double %.2139.us, %i.au            ; 2 uses
  %indvars.iv.next216 = add nsw i64 %indvars.iv215, 1 ; 2 uses
  %i.aw = getelementptr inbounds i8, ptr %i.t, i64 %indvars.iv.next216
  %i.ax = load i8, ptr %i.aw, align 1, !tbaa !8
  %i.ay = icmp eq i8 %i.ax, 45
  br i1 %i.ay, label %.lr.ph.us, label %._crit_edge.us.loopexit, !llvm.loop !62

._crit_edge.us.loopexit:                          ; preds = %.lr.ph.us
  %i.az = trunc nsw i64 %indvars.iv215 to i32
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %bb.d
  %.2123.lcssa.us = phi i32 [ %.0121147.us, %bb.d ], [ %i.az, %._crit_edge.us.loopexit ] ; 2 uses
  %.2.lcssa.us = phi double [ %i.ai, %bb.d ], [ %i.av, %._crit_edge.us.loopexit ] ; 2 uses
  %i.ba = icmp sgt i32 %.2123.lcssa.us, %i.g
  br i1 %i.ba, label %._crit_edge151.us, label %bb.g
...
.lr.ph143.us:                                     ; preds = %bb.f, %.lr.ph143.us
  ...
  %.1141.us = phi double [ %i.bv, %.lr.ph143.us ], [ %i.bj, %bb.f ]
  %i.bp = getelementptr inbounds i8, ptr %i.t, i64 %indvars.iv218
  %i.bq = load i8, ptr %i.bp, align 1, !tbaa !8
  %i.br = sext i8 %i.bq to i64
  %i.bs = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @amino_dis, i64 23040), i64 %i.br
  %i.bt = load i32, ptr %i.bs, align 4, !tbaa !4
  %i.bu = sitofp i32 %i.bt to double
  %i.bv = fadd double %.1141.us, %i.bu            ; 2 uses
  %indvars.iv.next219 = add nsw i64 %indvars.iv218, 1 ; 2 uses
  %i.bw = getelementptr inbounds i8, ptr %i.s, i64 %indvars.iv.next219
  %i.bx = load i8, ptr %i.bw, align 1, !tbaa !8
  %i.by = icmp eq i8 %i.bx, 45
  br i1 %i.by, label %.lr.ph143.us, label %._crit_edge144.us.loopexit, !llvm.loop !63

._crit_edge144.us.loopexit:                       ; preds = %.lr.ph143.us
  %i.bz = trunc nsw i64 %indvars.iv218 to i32
  br label %._crit_edge144.us

._crit_edge144.us:                                ; preds = %._crit_edge144.us.loopexit, %bb.f
  %.1122.lcssa.us = phi i32 [ %.0121147.us, %bb.f ], [ %i.bz, %._crit_edge144.us.loopexit ] ; 2 uses
  %.1.lcssa.us = phi double [ %i.bj, %bb.f ], [ %i.bv, %._crit_edge144.us.loopexit ] ; 2 uses
  %i.ca = icmp sgt i32 %.1122.lcssa.us, %i.g
  br i1 %i.ca, label %._crit_edge151.us, label %bb.g
...
bb.g:                                             ; preds = %._crit_edge144.us, %bb.e, %._crit_edge.us, %bb.c
  ...
  %i.cb = add nsw i32 %.3124.us, 1                ; 2 uses
  %i.cc = icmp slt i32 %i.cb, %i.c
  br i1 %i.cc, label %bb.b, label %._crit_edge151.us, !llvm.loop !64
...
._crit_edge151.us:                                ; preds = %bb.g, %._crit_edge144.us, %._crit_edge.us
  ...
  %i.cd = tail call double @llvm.fmuladd.f64(double %.4.us, double %i.q, double %.0113158.us)
  br label %bb.h

bb.h:                                             ; preds = %._crit_edge151.us, %.lr.ph160.split.us
  %.1114.us = phi double [ %.0113158.us, %.lr.ph160.split.us ], [ %i.cd, %._crit_edge151.us ] ; 2 uses
...
.lr.ph:                                           ; preds = %.preheader
  ...
  %wide.trip.count254 = zext i32 %i.ck to i64     ; 2 uses
...
bb.j:                                             ; preds = %bb.o, %.lr.ph173.us.us
  ...
  %.4125170.us.us = phi i32 [ 0, %.lr.ph173.us.us ], [ %i.fi, %bb.o ] ; 7 uses
...
.lr.ph.us190.us:                                  ; preds = %bb.l, %.lr.ph.us190.us
  ...
  %.7162.us.us = phi double [ %i.ec, %.lr.ph.us190.us ], [ %i.dp, %bb.l ]
  %i.dv = getelementptr inbounds i8, ptr %i.cy, i64 %indvars.iv238
  %i.dw = load i8, ptr %i.dv, align 1, !tbaa !8
  %i.dx = sext i8 %i.dw to i64
  %i.dy = getelementptr inbounds [512 x i8], ptr @amino_dis, i64 %i.dx
  %i.dz = getelementptr inbounds nuw i8, ptr %i.dy, i64 180
  %i.ea = load i32, ptr %i.dz, align 4, !tbaa !4
  %i.eb = sitofp i32 %i.ea to double
  %i.ec = fadd double %.7162.us.us, %i.eb         ; 2 uses
  %indvars.iv.next239 = add nsw i64 %indvars.iv238, 1 ; 2 uses
  %i.ed = getelementptr inbounds i8, ptr %i.da, i64 %indvars.iv.next239
  %i.ee = load i8, ptr %i.ed, align 1, !tbaa !8
  %i.ef = icmp eq i8 %i.ee, 45
  br i1 %i.ef, label %.lr.ph.us190.us, label %._crit_edge.us191.us.loopexit, !llvm.loop !67

._crit_edge.us191.us.loopexit:                    ; preds = %.lr.ph.us190.us
  %i.eg = trunc nsw i64 %indvars.iv238 to i32
  br label %._crit_edge.us191.us

._crit_edge.us191.us:                             ; preds = %._crit_edge.us191.us.loopexit, %bb.l
  %.6127.lcssa.us.us = phi i32 [ %.4125170.us.us, %bb.l ], [ %i.eg, %._crit_edge.us191.us.loopexit ] ; 2 uses
  %.7.lcssa.us.us = phi double [ %i.dp, %bb.l ], [ %i.ec, %._crit_edge.us191.us.loopexit ] ; 2 uses
  %i.eh = icmp sgt i32 %.6127.lcssa.us.us, %i.cl
  br i1 %i.eh, label %._crit_edge174.us.us, label %bb.o
...
.lr.ph166.us.us:                                  ; preds = %bb.n, %.lr.ph166.us.us
  ...
  %.6164.us.us = phi double [ %i.fc, %.lr.ph166.us.us ], [ %i.eq, %bb.n ]
  %i.ew = getelementptr inbounds i8, ptr %i.da, i64 %indvars.iv241
  %i.ex = load i8, ptr %i.ew, align 1, !tbaa !8
  %i.ey = sext i8 %i.ex to i64
  %i.ez = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @amino_dis, i64 23040), i64 %i.ey
  %i.fa = load i32, ptr %i.ez, align 4, !tbaa !4
  %i.fb = sitofp i32 %i.fa to double
  %i.fc = fadd double %.6164.us.us, %i.fb         ; 2 uses
  %indvars.iv.next242 = add nsw i64 %indvars.iv241, 1 ; 2 uses
  %i.fd = getelementptr inbounds i8, ptr %i.cy, i64 %indvars.iv.next242
  %i.fe = load i8, ptr %i.fd, align 1, !tbaa !8
  %i.ff = icmp eq i8 %i.fe, 45
  br i1 %i.ff, label %.lr.ph166.us.us, label %._crit_edge167.us.us.loopexit, !llvm.loop !68

._crit_edge167.us.us.loopexit:                    ; preds = %.lr.ph166.us.us
  %i.fg = trunc nsw i64 %indvars.iv241 to i32
  br label %._crit_edge167.us.us

._crit_edge167.us.us:                             ; preds = %._crit_edge167.us.us.loopexit, %bb.n
  %.5126.lcssa.us.us = phi i32 [ %.4125170.us.us, %bb.n ], [ %i.fg, %._crit_edge167.us.us.loopexit ] ; 2 uses
  %.6.lcssa.us.us = phi double [ %i.eq, %bb.n ], [ %i.fc, %._crit_edge167.us.us.loopexit ] ; 2 uses
  %i.fh = icmp sgt i32 %.5126.lcssa.us.us, %i.cl
  br i1 %i.fh, label %._crit_edge174.us.us, label %bb.o
...
bb.o:                                             ; preds = %._crit_edge167.us.us, %bb.m, %._crit_edge.us191.us, %bb.k
  ...
  %i.fi = add nsw i32 %.7128.us.us, 1             ; 2 uses
  %i.fj = icmp slt i32 %i.fi, %i.c
  br i1 %i.fj, label %bb.j, label %._crit_edge174.us.us, !llvm.loop !69
...
._crit_edge174.us.us:                             ; preds = %bb.o, %._crit_edge167.us.us, %._crit_edge.us191.us
  ...
  %i.fk = tail call double @llvm.fmuladd.f64(double %.9.us.us, double %i.cx, double %.3116181.us187.us)
  br label %bb.p

bb.p:                                             ; preds = %._crit_edge174.us.us, %.lr.ph183.split.us198
  %.4117.us189.us = phi double [ %.3116181.us187.us, %.lr.ph183.split.us198 ], [ %i.fk, %._crit_edge174.us.us ] ; 2 uses
...
.lr.ph.split.us.preheader:                        ; preds = %.lr.ph
  %wide.trip.count130 = zext i32 %i.d to i64
...
.lr.ph76.us:                                      ; preds = %.loopexit.us, %.lr.ph.split.us.preheader
  ...
  %.05287.us = phi double [ 0.000000e+00, %.lr.ph.split.us.preheader ], [ %i.bd, %.loopexit.us ]
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph76.us
  ...
  %.15373.us.us = phi double [ %i.bd, %._crit_edge.us.us ], [ %.05287.us, %.lr.ph76.us ]
...
bb.b:                                             ; preds = %bb.f, %.lr.ph.us.us
  ...
  %.05463.us.us = phi i32 [ 0, %.lr.ph.us.us ], [ %i.ba, %bb.f ] ; 3 uses
...
bb.f:                                             ; preds = %bb.b, %bb.e, %bb.d, %bb.c
  ...
  br i1 %i.bb, label %bb.b, label %._crit_edge.us.us, !llvm.loop !74
...
._crit_edge.us.us:                                ; preds = %bb.f, %bb.e, %bb.d
  ...
  %i.bd = tail call double @llvm.fmuladd.f64(double %i.bc, double %spec.store.select.us.us, double %.15373.us.us) ; 3 uses
  %indvars.iv.next123 = add nuw nsw i64 %indvars.iv122, 1 ; 2 uses
  %exitcond126.not = icmp eq i64 %indvars.iv.next123, %wide.trip.count125
  br i1 %exitcond126.not, label %.loopexit.us, label %.lr.ph.us.us, !llvm.loop !75

.lr.ph.split:                                     ; preds = %.lr.ph
  br i1 %i.g, label %._crit_edge, label %.lr.ph.split.split.preheader

.lr.ph.split.split.preheader:                     ; preds = %.lr.ph.split
  %wide.trip.count112 = zext i32 %i.d to i64
  %wide.trip.count = zext nneg i32 %1 to i64      ; 3 uses
...
.lr.ph76.new:                                     ; preds = %.prol.loopexit, %.lr.ph76.new
  ...
  br i1 %exitcond.not.3, label %.loopexit, label %.lr.ph76.new, !llvm.loop !75
...
._crit_edge:                                      ; preds = %.loopexit, %.loopexit.us, %.lr.ph.split, %bb.a
  ...
  %.052.lcssa = phi double [ 0.000000e+00, %bb.a ], [ %i.bd, %.loopexit.us ], [ 0.000000e+00, %.lr.ph.split ], [ %.lcssa144, %.loopexit ]
...
.lr.ph252:                                        ; preds = %._crit_edge226
  ...
  %wide.trip.count276 = zext i32 %i.ch to i64
  br label %bb.h
...
.lr.ph271:                                        ; preds = %._crit_edge239
  ...
  %wide.trip.count293 = zext i32 %i.bl to i64
  br label %bb.j
...
.lr.ph388.preheader:                              ; preds = %._crit_edge339
  %wide.trip.count422 = zext i32 %i.ci to i64
  br label %.lr.ph388
...
.lr.ph352.preheader:                              ; preds = %._crit_edge303
  %wide.trip.count376 = zext i32 %i.az to i64
  br label %.lr.ph352
...
.lr.ph240:                                        ; preds = %._crit_edge212
  ...
  %wide.trip.count260 = zext i32 %i.at to i64
  br label %bb.f
...
.lr.ph229:                                        ; preds = %._crit_edge201
  ...
  %i.be = getelementptr inbounds nuw i8, ptr %i.a, i64 4 ; 3 uses
  %wide.trip.count249 = zext i32 %i.at to i64
  br label %bb.f
...
.lr.ph281.preheader:                              ; preds = %._crit_edge238
  %wide.trip.count306 = zext i32 %i.kb to i64
  br label %.lr.ph281
...
.lr.ph262.preheader:                              ; preds = %._crit_edge218
  %wide.trip.count287 = zext i32 %i.ay to i64
  br label %.lr.ph262
...
.lr.ph262.preheader:                              ; preds = %._crit_edge218
  %wide.trip.count287 = zext i32 %i.bh to i64
  br label %.lr.ph262
...
.lr.ph224:                                        ; preds = %._crit_edge187
  %wide.trip.count278 = zext i32 %i.as to i64
...
.lr.ph126.preheader:                              ; preds = %.preheader
  ...
  %wide.trip.count166 = zext i32 %i.cd to i64
...
.preheader50.preheader:                           ; preds = %.preheader51
  %i.g = add nsw i32 %0, -1
  %wide.trip.count78 = zext i32 %i.g to i64
  br label %.preheader50
...
.lr.ph210:                                        ; preds = %.preheader176
  ...
  %wide.trip.count269 = zext i32 %i.ct to i64
...
.lr.ph215.preheader:                              ; preds = %.loopexit175
  %wide.trip.count281 = zext i32 %i.ct to i64
  %wide.trip.count276 = zext nneg i32 %0 to i64
...
.preheader169.preheader:                          ; preds = %.preheader170
  ...
  %wide.trip.count297 = zext i32 %i.et to i64
...
.lr.ph45.preheader:                               ; preds = %.preheader
  %i.g = add nsw i32 %1, -1
  %wide.trip.count67 = zext i32 %i.g to i64
...
.lr.ph.split.us.preheader:                        ; preds = %.lr.ph
  %wide.trip.count106 = zext i32 %i.c to i64
...
.preheader58.us.us:                               ; preds = %.preheader58.us.us.preheader, %bb.j
  ...
  %.04865.us.us = phi i32 [ 0, %.preheader58.us.us.preheader ], [ %.149.us.us, %bb.j ] ; 3 uses
...
.preheader:                                       ; preds = %vec.epilog.scalar.ph, %middle.block, %vec.epilog.middle.block, %bb.a
  %.018.lcssa = phi ptr [ %i.g, %bb.a ], [ %i.ac, %vec.epilog.middle.block ], [ %i.t, %middle.block ], [ %i.bf, %vec.epilog.scalar.ph ] ; 8 uses
  %.018.lcssa44 = ptrtoaddr ptr %.018.lcssa to i64 ; 3 uses
  %.not2124 = icmp ult ptr %.018.lcssa, %1
  br i1 %.not2124, label %._crit_edge, label %iter.check64

iter.check64:                                     ; preds = %.preheader
  %i.ai = add i64 %.018.lcssa44, -1
  %i.aj = add i64 %i.b, -1
  %umin46 = tail call i64 @llvm.umin.i64(i64 %i.ai, i64 %i.aj)
  %i.ak = sub i64 %.018.lcssa44, %umin46          ; 7 uses
  %min.iters.check47 = icmp ult i64 %i.ak, 8
  br i1 %min.iters.check47, label %.lr.ph27.preheader, label %vector.memcheck43

vector.memcheck43:                                ; preds = %iter.check64
  %i.al = add i64 %i.i, %i.a
  %i.am = sub i64 %.018.lcssa44, %i.al
  %diff.check45 = icmp ugt i64 %i.am, -32
  br i1 %diff.check45, label %.lr.ph27.preheader, label %vector.main.loop.iter.check48

vector.main.loop.iter.check48:                    ; preds = %vector.memcheck43
  %min.iters.check49 = icmp ult i64 %i.ak, 32
  br i1 %min.iters.check49, label %vec.epilog.ph68, label %vector.ph50

vector.ph50:                                      ; preds = %vector.main.loop.iter.check48
  %n.mod.vf51 = and i64 %i.ak, 24
  %n.vec52 = and i64 %i.ak, -32                   ; 4 uses
  %i.an = sub i64 0, %n.vec52                     ; 2 uses
...
vector.body53:                                    ; preds = %vector.body53, %vector.ph50
  ...
  %i.aq = sub i64 0, %index54                     ; 2 uses
  %next.gep55 = getelementptr i8, ptr %i.j, i64 %i.aq ; 2 uses
  %next.gep56 = getelementptr i8, ptr %.018.lcssa, i64 %i.aq ; 2 uses
  %i.ar = getelementptr i8, ptr %next.gep55, i64 -15
  %i.as = getelementptr i8, ptr %next.gep55, i64 -31
  %wide.load57 = load <16 x i8>, ptr %i.ar, align 1, !tbaa !8
  %wide.load58 = load <16 x i8>, ptr %i.as, align 1, !tbaa !8
  %i.at = getelementptr i8, ptr %next.gep56, i64 -15
  %i.au = getelementptr i8, ptr %next.gep56, i64 -31
  store <16 x i8> %wide.load57, ptr %i.at, align 1, !tbaa !8
  store <16 x i8> %wide.load58, ptr %i.au, align 1, !tbaa !8
  %index.next59 = add nuw i64 %index54, 32        ; 2 uses
  %i.av = icmp eq i64 %index.next59, %n.vec52
  br i1 %i.av, label %middle.block60, label %vector.body53, !llvm.loop !384

middle.block60:                                   ; preds = %vector.body53
  %cmp.n61 = icmp eq i64 %i.ak, %n.vec52
  br i1 %cmp.n61, label %._crit_edge, label %vec.epilog.iter.check66

vec.epilog.iter.check66:                          ; preds = %middle.block60
  %min.epilog.iters.check67 = icmp eq i64 %n.mod.vf51, 0
  br i1 %min.epilog.iters.check67, label %.lr.ph27.preheader, label %vec.epilog.ph68, !prof !382

vec.epilog.ph68:                                  ; preds = %vector.main.loop.iter.check48, %vec.epilog.iter.check66
  %vec.epilog.resume.val62 = phi i64 [ %n.vec52, %vec.epilog.iter.check66 ], [ 0, %vector.main.loop.iter.check48 ]
  %n.vec70 = and i64 %i.ak, -8                    ; 3 uses
  %i.aw = sub i64 0, %n.vec70                     ; 2 uses
  %i.ax = getelementptr i8, ptr %i.j, i64 %i.aw
  %i.ay = getelementptr i8, ptr %.018.lcssa, i64 %i.aw
  br label %vec.epilog.vector.body71

vec.epilog.vector.body71:                         ; preds = %vec.epilog.vector.body71, %vec.epilog.ph68
  %index72 = phi i64 [ %vec.epilog.resume.val62, %vec.epilog.ph68 ], [ %index.next76, %vec.epilog.vector.body71 ] ; 2 uses
  %i.az = sub i64 0, %index72                     ; 2 uses
  %next.gep73 = getelementptr i8, ptr %i.j, i64 %i.az
  %next.gep74 = getelementptr i8, ptr %.018.lcssa, i64 %i.az
  %i.ba = getelementptr i8, ptr %next.gep73, i64 -7
  %wide.load75 = load <8 x i8>, ptr %i.ba, align 1, !tbaa !8
  %i.bb = getelementptr i8, ptr %next.gep74, i64 -7
  store <8 x i8> %wide.load75, ptr %i.bb, align 1, !tbaa !8
  %index.next76 = add nuw i64 %index72, 8         ; 2 uses
  %i.bc = icmp eq i64 %index.next76, %n.vec70
  br i1 %i.bc, label %vec.epilog.middle.block77, label %vec.epilog.vector.body71, !llvm.loop !385

vec.epilog.middle.block77:                        ; preds = %vec.epilog.vector.body71
  %cmp.n78 = icmp eq i64 %i.ak, %n.vec70
  br i1 %cmp.n78, label %._crit_edge, label %.lr.ph27.preheader

.lr.ph27.preheader:                               ; preds = %vector.memcheck43, %iter.check64, %vec.epilog.iter.check66, %vec.epilog.middle.block77
  %.026.ph = phi ptr [ %i.j, %iter.check64 ], [ %i.j, %vector.memcheck43 ], [ %i.ao, %vec.epilog.iter.check66 ], [ %i.ax, %vec.epilog.middle.block77 ]
  %.125.ph = phi ptr [ %.018.lcssa, %iter.check64 ], [ %.018.lcssa, %vector.memcheck43 ], [ %i.ap, %vec.epilog.iter.check66 ], [ %i.ay, %vec.epilog.middle.block77 ]
  br label %.lr.ph27
...
._crit_edge:                                      ; preds = %.lr.ph27, %middle.block60, %vec.epilog.middle.block77, %.preheader
  ret void
}
...
.lr.ph.split.us.preheader:                        ; preds = %.lr.ph
  %wide.trip.count94 = zext i32 %i.d to i64
  %wide.trip.count = zext nneg i32 %0 to i64
  br label %.lr.ph73.us
...
.lr.ph73.us:                                      ; preds = %.loopexit.us, %.lr.ph.split.us.preheader
  ...
  %.05175.us = phi double [ 0.000000e+00, %.lr.ph.split.us.preheader ], [ %i.bd, %.loopexit.us ]
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph73.us
  ...
  %.15270.us.us = phi double [ %i.bd, %._crit_edge.us.us ], [ %.05175.us, %.lr.ph73.us ]
...
bb.b:                                             ; preds = %bb.i, %.lr.ph.us.us
  ...
  %.05361.us.us = phi i32 [ 0, %.lr.ph.us.us ], [ %i.az, %bb.i ] ; 3 uses
...
.lr.ph.split.us.preheader:                        ; preds = %.lr.ph
  %wide.trip.count104 = zext i32 %i.c to i64
...
.lr.ph.split.us.preheader:                        ; preds = %.lr.ph
  %wide.trip.count97 = zext i32 %i.c to i64
...
.lr.ph.split.us.preheader:                        ; preds = %.lr.ph
  %wide.trip.count94 = zext i32 %i.c to i64
...
.lr.ph.split.us.preheader:                        ; preds = %.lr.ph
  %wide.trip.count108 = zext i32 %i.d to i64
  %wide.trip.count = zext nneg i32 %0 to i64
  br label %.lr.ph84.us
...
.lr.ph140.us.prol:                                ; preds = %.lr.ph140.us.preheader, %.lr.ph140.us.prol
  ...
  %.0101139.us.prol = phi double [ %i.ck, %.lr.ph140.us.prol ], [ 0.000000e+00, %.lr.ph140.us.preheader ]
  ...
  %i.ck = fadd double %.0101139.us.prol, %i.cj    ; 3 uses
...
.lr.ph140.us.prol.loopexit:                       ; preds = %.lr.ph140.us.prol, %.lr.ph140.us.preheader
  ...
  %.0101139.us.unr = phi double [ 0.000000e+00, %.lr.ph140.us.preheader ], [ %i.ck, %.lr.ph140.us.prol ]
...
.lr.ph140.us:                                     ; preds = %.lr.ph140.us.prol.loopexit, %.lr.ph140.us
  ...
  %.0101139.us = phi double [ %i.dq, %.lr.ph140.us ], [ %.0101139.us.unr, %.lr.ph140.us.prol.loopexit ]
  %i.cm = getelementptr inbounds [8 x i8], ptr %i.j, i64 %indvars.iv200
  %i.cn = load double, ptr %i.cm, align 8, !tbaa !24
  %i.co = fadd double %.0101139.us, %i.cn
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %bb.j
  ...
  %i.dw = getelementptr inbounds nuw i8, ptr %.1100143.us, i64 56
  store double %i.dv, ptr %i.dw, align 8, !tbaa !438
  %i.dx = fptrunc double %i.dv to float
  %i.dy = getelementptr inbounds nuw i8, ptr %.1100143.us, i64 64
  store float %i.dx, ptr %i.dy, align 8, !tbaa !439
  br label %bb.k

bb.k:                                             ; preds = %._crit_edge.us, %.lr.ph144.us
  %i.dz = getelementptr inbounds nuw i8, ptr %.1100143.us, i64 8
...
.lr.ph179.preheader:                              ; preds = %.preheader
  ...
  %wide.trip.count225 = zext i32 %i.en to i64
...
.lr.ph.split.us.preheader:                        ; preds = %bb.c
  %i.j = add nsw i32 %0, -1
  %wide.trip.count291 = zext i32 %i.j to i64
...
.lr.ph17.preheader:                               ; preds = %bb.a
  %i.b = add nsw i32 %0, -1
  %wide.trip.count24 = zext i32 %i.b to i64
  %wide.trip.count = zext nneg i32 %0 to i64      ; 3 uses
