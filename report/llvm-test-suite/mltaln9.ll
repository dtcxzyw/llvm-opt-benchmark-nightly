...
vector.ph56:                                      ; preds = %vector.main.loop.iter.check54
  ...
  %n.vec58 = and i64 %i.aj, -32                   ; 5 uses
  %i.am = sub i64 0, %n.vec58
  %i.an = getelementptr i8, ptr %i.j, i64 %i.am
  %2 = sub i64 0, %n.vec58
  %i.ao = getelementptr i8, ptr %.018.lcssa, i64 %2
  br label %vector.body59

vector.body59:                                    ; preds = %vector.body59, %vector.ph56
  %index60 = phi i64 [ 0, %vector.ph56 ], [ %index.next71, %vector.body59 ] ; 3 uses
  %offset.idx61 = sub i64 0, %index60
  %next.gep62.a = getelementptr i8, ptr %i.j, i64 %offset.idx61 ; 2 uses
  %offset.idx63 = sub i64 0, %index60
  %next.gep64 = getelementptr i8, ptr %.018.lcssa, i64 %offset.idx63 ; 2 uses
...
vec.epilog.ph80:                                  ; preds = %vector.main.loop.iter.check54, %vec.epilog.iter.check78
  ...
  %n.vec82 = and i64 %i.aj, -16                   ; 4 uses
  %i.au = sub i64 0, %n.vec82
  %i.av = getelementptr i8, ptr %i.j, i64 %i.au
  %3 = sub i64 0, %n.vec82
  %i.aw = getelementptr i8, ptr %.018.lcssa, i64 %3
  br label %vec.epilog.vector.body83

vec.epilog.vector.body83:                         ; preds = %vec.epilog.vector.body83, %vec.epilog.ph80
  %index84 = phi i64 [ %vec.epilog.resume.val74, %vec.epilog.ph80 ], [ %index.next90, %vec.epilog.vector.body83 ] ; 3 uses
  %i.ax = sub i64 0, %index84
  %next.gep85 = getelementptr i8, ptr %i.j, i64 %i.ax
  %4 = sub i64 0, %index84
  %next.gep86 = getelementptr i8, ptr %.018.lcssa, i64 %4
...
vector.ph:                                        ; preds = %.lr.ph.preheader
  %n.vec = and i64 %i.c, 4294967288               ; 5 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep9 = getelementptr i8, ptr %0, i64 %offset.idx8 ; 2 uses
...
vector.ph318:                                     ; preds = %.lr.ph217.us.us.preheader
  %n.vec320 = and i64 %i.br, 4294967288           ; 5 uses
  %i.bs = shl nuw nsw i64 %n.vec320, 2
  %i.bt = getelementptr i8, ptr %i.bq, i64 %i.bs
  %.cast321 = trunc nuw i64 %n.vec320 to i32
  %i.bu = sub i32 %i.bl, %.cast321
  %.cast322 = trunc nuw i64 %n.vec320 to i32
  %i.bv = add i32 %i.bi, %.cast322
...
vector.ph:                                        ; preds = %.lr.ph230.us.us.preheader
  %n.vec = and i64 %i.cx, 4294967288              ; 5 uses
  %i.cy = shl nuw nsw i64 %n.vec, 2
  %i.cz = getelementptr i8, ptr %i.cw, i64 %i.cy
  %.cast = trunc nuw i64 %n.vec to i32
  %i.da = sub i32 %i.cr, %.cast
  %.cast313 = trunc nuw i64 %n.vec to i32
  %i.db = add i32 %i.co, %.cast313
