...
bb.b:                                             ; preds = %bb.b, %.lr.ph.us.us
  ...
  %3 = select i1 %i.s, i32 %i.y, i32 0            ; 2 uses
  %i.z = xor i32 %.06473.us.us, 1                 ; 2 uses
  %4 = select i1 %i.s, i32 0, i32 %i.y
  %.v.us.us = select i1 %i.w, i32 %4, i32 %3
  %5 = mul nuw nsw i32 %.v.us.us, %i.z
  %6 = mul nuw nsw i32 %3, %.06473.us.us
  %7 = select i1 %i.s, i32 0, i32 %.06572.us.us   ; 2 uses
  %8 = mul nuw nsw i32 %7, %i.z
  %9 = select i1 %i.w, i32 %8, i32 %6
  %i.aa = add nuw nsw i32 %9, %5
  %10 = uitofp nneg i32 %i.aa to double
  %11 = mul nuw nsw i32 %7, %.06473.us.us
  %12 = uitofp nneg i32 %11 to double
  %13 = select i1 %i.w, double %12, double 0.000000e+00
  %14 = fadd double %13, %10
  %15 = select i1 %i.s, i32 %.06572.us.us, i32 0
  %16 = mul nuw nsw i32 %15, %.06473.us.us
  %17 = uitofp nneg i32 %16 to double
  %18 = select i1 %i.w, double 0.000000e+00, double %17
  %19 = fadd double %18, %14
  %20 = fptosi double %19 to i32
  %21 = sext i32 %20 to i64
  %i.ab = mul nsw i64 %21, %i.h
  ...
  %22 = zext i1 %mulbool.us.us to i32
  %i.ap = add nsw i32 %.26374.us.us, %22          ; 4 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.us.us
  ...
  %3 = select i1 %i.t, i32 %i.z, i32 0
  %i.aa = xor i32 %.08089.us.us, 1                ; 3 uses
  %4 = select i1 %i.t, i32 0, i32 %.08188.us.us
  %5 = select i1 %i.t, i32 %i.z, i32 %.08188.us.us
  %6 = select i1 %i.t, i32 0, i32 %i.z
  %.v.us.us = select i1 %i.x, i32 %6, i32 %5
  %7 = mul nuw nsw i32 %.v.us.us, %i.aa
  %8 = mul nuw nsw i32 %3, %.08089.us.us
  %9 = select i1 %i.t, i32 %.08188.us.us, i32 0   ; 2 uses
  %10 = mul nuw nsw i32 %9, %i.aa
  %i.ab = add nuw nsw i32 %i.aa, %.08089.us.us
  %11 = mul nuw nsw i32 %4, %i.ab
  %i.ac = add nuw nsw i32 %i.z, %9
  %12 = mul nuw nsw i32 %i.ac, %.08089.us.us
  %i.ad = add nuw nsw i32 %11, %8
  %i.ae = add nuw nsw i32 %i.ad, %10
  %13 = select i1 %i.x, i32 %i.ae, i32 %12
  %i.af = add nuw nsw i32 %13, %7
  ...
  %mulbool.us.us = xor i1 %mulbool.demorgan.us.us, true
  %14 = zext i1 %mulbool.us.us to i32
  %i.au = add nsw i32 %.27990.us.us, %14          ; 4 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.us.us
  ...
  %3 = select i1 %i.t, i32 0, i32 %.06570.us.us
  %4 = mul nuw nsw i32 %3, %i.aa
  %5 = select i1 %i.t, i32 %i.z, i32 %.06570.us.us
  %6 = select i1 %i.t, i32 0, i32 %i.z
  %.v.us.us = select i1 %i.x, i32 %6, i32 %5
  %7 = mul nuw nsw i32 %.v.us.us, %i.aa
  %8 = mul nuw nsw i32 %i.z, %.06471.us.us
  %9 = select i1 %i.x, i32 %4, i32 %8
  %i.ab = add nuw nsw i32 %9, %7
  ...
  %mulbool.demorgan.us.us = or i1 %i.t, %i.x
  %mulbool.us.us = xor i1 %mulbool.demorgan.us.us, true
  %10 = zext i1 %mulbool.us.us to i32
  %i.aq = add nsw i32 %.26372.us.us, %10          ; 4 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
bb.b:                                             ; preds = %bb.b, %.preheader.us.us
  ...
  %2 = select i1 %i.o, i32 0, i32 %.06065.us.us
  %3 = mul nuw nsw i32 %2, %i.v
  %4 = select i1 %i.o, i32 %i.u, i32 %.06065.us.us
  %5 = select i1 %i.o, i32 0, i32 %i.u
  %.v.us.us = select i1 %i.s, i32 %5, i32 %4
  %6 = mul nuw nsw i32 %.v.us.us, %i.v
  %7 = mul nuw nsw i32 %i.u, %.05966.us.us
  %8 = select i1 %i.s, i32 %3, i32 %7
  %i.w = add nuw nsw i32 %8, %6
  ...
  %mulbool.us.us = xor i1 %mulbool.demorgan.us.us, true
  %9 = zext i1 %mulbool.us.us to i32
  %i.ak = add nsw i32 %.25867.us.us, %9           ; 4 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
bb.b:                                             ; preds = %.preheader.us, %bb.b
  ...
  %3 = select i1 %i.n, i32 %i.t, i32 0
  %i.u = xor i32 %.05764.us, 1                    ; 2 uses
  %4 = select i1 %i.n, i32 0, i32 %.05863.us
  %5 = mul nuw nsw i32 %4, %i.u
  %6 = select i1 %i.n, i32 %i.t, i32 %.05863.us
  %7 = select i1 %i.n, i32 0, i32 %i.t            ; 2 uses
  %.v.us = select i1 %i.r, i32 %7, i32 %6
  %8 = mul nuw nsw i32 %.v.us, %i.u
  %9 = mul nuw nsw i32 %7, %.05764.us
  %10 = select i1 %i.r, i32 0, i32 %9
  %i.v = add nuw nsw i32 %8, %10
  %11 = uitofp nneg i32 %i.v to double
  %12 = mul nuw nsw i32 %3, %.05764.us
  %i.w = uitofp nneg i32 %12 to double
  %13 = select i1 %i.r, double 0.000000e+00, double %i.w
  %i.x = tail call double @llvm.fmuladd.f64(double %13, double 2.000000e+00, double %11)
  %14 = uitofp nneg i32 %5 to double
  %15 = select i1 %i.r, double %14, double 0.000000e+00
  %i.y = tail call double @llvm.fmuladd.f64(double %15, double 2.000000e+00, double %i.x)
...
bb.b:                                             ; preds = %bb.b, %.preheader.us.us
  ...
  %2 = select i1 %i.o, i32 0, i32 %.05964.us.us
  %3 = mul nuw nsw i32 %2, %i.v
  %4 = select i1 %i.o, i32 %i.u, i32 %.05964.us.us
  %5 = select i1 %i.o, i32 0, i32 %i.u
  %.v.us.us = select i1 %i.s, i32 %5, i32 %4
  %6 = mul nuw nsw i32 %.v.us.us, %i.v
  %7 = mul nuw nsw i32 %i.u, %.05865.us.us
  %8 = select i1 %i.s, i32 %3, i32 %7
  %i.w = add nuw nsw i32 %8, %6
  %i.x = uitofp nneg i32 %i.w to float
  %i.y = fpext nnan ninf float %i.x to double
...
.prol.preheader:                                  ; preds = %.lr.ph36
  ...
  %6 = select i1 %not..prol, i1 true, i1 %i.n
  br i1 %6, label %.prol.loopexit, label %bb.b
...
.epil.preheader:                                  ; preds = %._crit_edge.unr-lcssa, %.lr.ph38
  ...
  %.not29.epil = or i1 %.02335.epil.init, %i.w
