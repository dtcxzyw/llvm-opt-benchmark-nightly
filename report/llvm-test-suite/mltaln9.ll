...
bb.b:                                             ; preds = %bb.b, %.lr.ph.us.us
  ...
  %3 = uitofp nneg i32 %i.ai to float
  %4 = fpext nnan ninf float %3 to double
  %i.aj = fmul nnan double %4, 5.000000e-01
...
bb.b:                                             ; preds = %bb.b, %.preheader.us.us
  ...
  %2 = uitofp nneg i32 %i.ad to float
  %3 = fpext nnan ninf float %2 to double
  %i.ae = fmul nnan double %3, 5.000000e-01
