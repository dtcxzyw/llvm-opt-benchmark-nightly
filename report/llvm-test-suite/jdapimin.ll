begin_hunk_0_@jpeg_consume_input:bb.a
  ...
  tail call void %i.ad(ptr noundef nonnull %0, i32 noundef -1) #3
...
bb.j:                                             ; preds = %bb.f
  ...
  %i.ag = load i32, ptr %i.af, align 8, !tbaa !58 ; 3 uses
  ...
  %i.ak = load i32, ptr %i.aj, align 8, !tbaa !58 ; 3 uses
...
begin_hunk_1_@jpeg_consume_input:bb.a
  ...
  tail call void %i.ax(ptr noundef nonnull %0, i32 noundef 1) #3
  br label %default_decompress_parms.exit
...
begin_hunk_3_@jpeg_consume_input:bb.a
  ...
  store i32 %.sink81.i, ptr %i.bj, align 4, !tbaa !60
  %i.bk = getelementptr inbounds nuw i8, ptr %0, i64 56
  store i32 %.sink79.i, ptr %i.bk, align 8, !tbaa !61
  %i.bl = getelementptr inbounds nuw i8, ptr %0, i64 60
  store i32 1, ptr %i.bl, align 4, !tbaa !62
  %i.bm = getelementptr inbounds nuw i8, ptr %0, i64 64
  store i32 1, ptr %i.bm, align 8, !tbaa !63
  %i.bn = getelementptr inbounds nuw i8, ptr %0, i64 72
  store double 1.000000e+00, ptr %i.bn, align 8, !tbaa !64
  ...
  store ptr null, ptr %i.br, align 8, !tbaa !65
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.h = load i32, ptr %i.g, align 4, !tbaa !70
...
begin_hunk_9_@jpeg_finish_decompress:bb.a
  ...
  br i1 %i.ab, label %.loopexit, label %bb.j, !llvm.loop !74
...
!57 = !{!9, !11, i64 296}
!58 = !{!59, !5, i64 0}
!59 = !{!"", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !5, i64 32, !5, i64 36, !5, i64 40, !5, i64 44, !5, i64 48, !5, i64 52, !5, i64 56, !5, i64 60, !5, i64 64, !5, i64 68, !5, i64 72, !11, i64 80, !11, i64 88}
!60 = !{!9, !5, i64 52}
!61 = !{!9, !5, i64 56}
!62 = !{!9, !5, i64 60}
!63 = !{!9, !5, i64 64}
...
!71 = !{!9, !21, i64 528}
!72 = !{!73, !11, i64 8}
!73 = !{!"jpeg_decomp_master", !11, i64 0, !11, i64 8, !5, i64 16}
!74 = distinct !{!74, !75}
