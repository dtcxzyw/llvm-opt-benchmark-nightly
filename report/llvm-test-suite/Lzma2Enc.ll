begin_hunk_0_@Lzma2Enc_Encode:bb.a
  ...
  %i.ab = tail call ptr %i.aa(ptr noundef nonnull %i.z, i64 noundef 65552) #6 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  store i64 0, ptr %i.ai, align 8, !tbaa !41
  %i.aj = load i8, ptr %i.a, align 1, !tbaa !42
  %i.ak = getelementptr inbounds nuw i8, ptr %0, i64 112
  store i8 %i.aj, ptr %i.ak, align 8, !tbaa !43
  %i.al = getelementptr inbounds nuw i8, ptr %0, i64 116
  store i32 1, ptr %i.al, align 4, !tbaa !44
  %i.am = getelementptr inbounds nuw i8, ptr %0, i64 120
  store i32 1, ptr %i.am, align 8, !tbaa !45
...
begin_hunk_2_@Lzma2Enc_Encode:bb.a
  ...
  %i.bb = load i64, ptr %i.ai, align 8, !tbaa !41
  %i.bc = load ptr, ptr %3, align 8, !tbaa !46
  %i.bd = call i32 %i.bc(ptr noundef nonnull %3, i64 noundef %i.bb, i64 noundef %i.ba) #6
...
begin_hunk_3_@Lzma2Enc_Encode:bb.a
  ...
  %i.bj = load ptr, ptr %1, align 8, !tbaa !46
  %i.bk = call i64 %i.bj(ptr noundef nonnull %1, ptr noundef nonnull %i.d, i64 noundef 1) #6
...
begin_hunk_5_@MtCallbackImp_Code:bb.a
  ...
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !50   ; 5 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.p = load i8, ptr %i.a, align 1, !tbaa !42
  %i.q = getelementptr inbounds nuw i8, ptr %i.h, i64 16
  store i8 %i.p, ptr %i.q, align 8, !tbaa !43
...
.preheader:                                       ; preds = %bb.d
  %i.z = load i64, ptr %i.o, align 8, !tbaa !41
...
bb.g:                                             ; preds = %bb.f
  %i.ak = load i64, ptr %i.o, align 8, !tbaa !41
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.am = load i64, ptr %i.o, align 8, !tbaa !41
...
begin_hunk_13_@Lzma2EncInt_EncodeSubblock:bb.a
  ...
  %i.ax = load i64, ptr %i.v, align 8, !tbaa !41
  %i.ay = add i64 %i.ax, %i.au
  store i64 %i.ay, ptr %i.v, align 8, !tbaa !41
  store i64 %i.aw, ptr %2, align 8, !tbaa !38
  %.not107.us = icmp eq i32 %i.av, 0
  br i1 %.not107.us, label %._crit_edge, label %.lr.ph.split.us, !llvm.loop !60
...
bb.g:                                             ; preds = %bb.f
  %i.bh = load i64, ptr %i.v, align 8, !tbaa !41
  %i.bi = icmp eq i64 %i.bh, 0
  %i.bj = select i1 %i.bi, i8 1, i8 2
  store i8 %i.bj, ptr %1, align 1, !tbaa !42
  %i.bk = add nsw i32 %i.bd, -1                   ; 2 uses
  %i.bl = lshr i32 %i.bk, 8
  %i.bm = trunc nuw i32 %i.bl to i8
  store i8 %i.bm, ptr %i.az, align 1, !tbaa !42
  %i.bn = trunc i32 %i.bk to i8
  store i8 %i.bn, ptr %i.ba, align 1, !tbaa !42
...
bb.h:                                             ; preds = %bb.g
  ...
  br i1 %.not107, label %._crit_edge, label %bb.f, !llvm.loop !60
...
bb.j:                                             ; preds = %bb.i
  %i.cl = load i32, ptr %i.k, align 4, !tbaa !44
  %.not102 = icmp eq i32 %i.cl, 0
  br i1 %.not102, label %bb.l, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.cm = load i32, ptr %i.d, align 8, !tbaa !45
...
begin_hunk_18_@Lzma2EncInt_EncodeSubblock:bb.a
  ...
  store i8 %i.cs, ptr %1, align 1, !tbaa !42
