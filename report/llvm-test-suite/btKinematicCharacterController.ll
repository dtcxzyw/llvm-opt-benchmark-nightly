...
bb.d:                                             ; preds = %bb.b
  ...
  %5 = load float, ptr %3, align 4, !tbaa !9      ; 2 uses
  %6 = load float, ptr %i.l, align 8, !tbaa !9    ; 2 uses
  %i.s = load float, ptr %4, align 8, !tbaa !9    ; 2 uses
  ...
  %i.z = insertelement <2 x float> %10, float %i.q, i64 1
  %i.aa = insertelement <2 x float> poison, float %i.s, i64 0
  %11 = shufflevector <2 x float> %i.aa, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ab = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.z, <2 x float> %11, <2 x float> %i.y)
  ...
  %i.ah = tail call float @llvm.fmuladd.f32(float %i.ad, float %6, float %i.ag)
  %i.ai = getelementptr inbounds nuw i8, ptr %i.a, i64 48
  %i.aj = load float, ptr %i.ai, align 4, !tbaa !9
  %i.ak = tail call noundef float @llvm.fmuladd.f32(float %i.aj, float %i.s, float %i.ah)
