...
.preheader66:                                     ; preds = %.preheader66.preheader, %._crit_edge.a
  %indvars.iv101 = phi i64 [ 0, %.preheader66.preheader ], [ %indvars.iv.next102, %._crit_edge.a ] ; 2 uses
...
._crit_edge.unr-lcssa:                            ; preds = %.preheader66.new
  br i1 %lcmp.mod.not, label %._crit_edge.a, label %.epil.preheader
...
._crit_edge.a:                                    ; preds = %._crit_edge.unr-lcssa, %.epil.preheader
...
.preheader:                                       ; preds = %.preheader.lr.ph, %.preheader
  ...
  br i1 %i.en, label %.preheader, label %._crit_edge81, !llvm.loop !34
