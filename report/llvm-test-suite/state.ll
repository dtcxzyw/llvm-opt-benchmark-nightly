...
bb.d:                                             ; preds = %.lr.ph, %bb.bh
  ...
  %i.ca = load double, ptr %i.bz, align 8, !tbaa !70 ; 13 uses
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %i.kf = insertelement <2 x double> poison, double %i.ca, i64 0 ; 3 uses
  ...
  %3 = insertelement <2 x double> %i.kf, double %i.db, i64 1
  %4 = insertelement <2 x double> poison, double %i.er, i64 0
  %5 = insertelement <2 x double> %4, double %i.fg, i64 1 ; 2 uses
  ...
  %i.oj = fmul double %7, %.sroa.speculated35.i1203
  ...
  %8 = extractelement <2 x double> %foldExtExtBinop1345, i64 0
  %9 = fmul double %8, %i.er                      ; 2 uses
  %i.px = insertelement <2 x double> poison, double %i.fg, i64 0 ; 4 uses
  ...
  %i.qm = insertelement <2 x double> poison, double %9, i64 0
  %i.qn = insertelement <2 x double> %i.qm, double %i.cx, i64 1
  %i.qo = insertelement <2 x double> %i.qb, double %.sroa.speculated35.i1203, i64 0
  %10 = fmul <2 x double> %i.qn, %i.qo            ; 2 uses
  %i.qp = insertelement <2 x double> %i.pz, double %i.ql, i64 0 ; 2 uses
  %11 = fsub <2 x double> %10, %i.qp
  %12 = fadd <2 x double> %10, %i.qp
  %13 = shufflevector <2 x double> %11, <2 x double> %12, <2 x i32> <i32 0, i32 3>
  %i.qq = fdiv <2 x double> %13, %i.qd            ; 3 uses
  %14 = insertelement <2 x double> %i.px, double %i.er, i64 1
  %15 = fdiv <2 x double> %14, %5                 ; 2 uses
  %16 = fcmp olt <2 x double> %15, splat (double 1.000000e+00)
  %17 = select <2 x i1> %16, <2 x double> %15, <2 x double> splat (double 1.000000e+00) ; 5 uses
  %18 = fmul <2 x double> %6, %17                 ; 2 uses
  %19 = shufflevector <2 x double> %i.ny, <2 x double> %i.iv, <2 x i32> <i32 1, i32 3>
  %20 = shufflevector <2 x double> %i.iv, <2 x double> %i.ny, <2 x i32> <i32 1, i32 3>
  %21 = fdiv <2 x double> %19, %20                ; 2 uses
  %22 = fcmp olt <2 x double> %21, splat (double 5.000000e-01)
  %23 = select <2 x i1> %22, <2 x double> %21, <2 x double> splat (double 5.000000e-01) ; 2 uses
  %foldExtExtBinop1347 = fmul <2 x double> %i.ny, %23
  %24 = fmul double %i.cz, %i.db
  %25 = shufflevector <2 x double> %18, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %26 = fsub <2 x double> %25, %18
  %27 = insertelement <2 x double> %26, double %24, i64 1
  %28 = insertelement <2 x double> poison, double %i.cz, i64 0
  %29 = insertelement <2 x double> %17, double %i.er, i64 0
  %i.qr = insertelement <2 x double> %i.ix, double %i.pd, i64 1
  %i.qs = shufflevector <2 x double> %i.px, <2 x double> %17, <2 x i32> <i32 0, i32 2>
  %i.qt = fmul <2 x double> %i.qr, %i.qs          ; 3 uses
  %30 = fmul double %i.cx, %i.cx
  %31 = fmul double %30, 4.900000e+00
  %32 = fmul double %i.db, %i.er
  %33 = extractelement <2 x double> %i.pz, i64 0
  %34 = fadd double %32, %33
  %35 = fmul double %i.db, %i.db
  %36 = insertelement <2 x double> poison, double %35, i64 0
  %37 = insertelement <2 x double> %36, double %34, i64 1
  %38 = insertelement <2 x double> %i.qd, double %i.cx, i64 0
  %39 = fdiv <2 x double> %37, %38                ; 2 uses
  %40 = extractelement <2 x double> %39, i64 0
  %41 = fadd double %31, %40
  %42 = extractelement <2 x double> %17, i64 0
  %43 = fmul double %9, %42
  %shift1352.a = shufflevector <2 x double> %i.iv, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop1353.a = fmul <2 x double> %shift1352.a, %23
  %shift1355 = shufflevector <2 x double> %foldExtExtBinop1347, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop1356 = fadd <2 x double> %foldExtExtBinop1353.a, %shift1355 ; 3 uses
  %i.qu = insertelement <2 x double> %foldExtExtBinop1356, double %i.cx, i64 1
  %i.qv = fdiv <2 x double> %27, %i.qu            ; 2 uses
  %i.qw = extractelement <2 x double> %i.qv, i64 1
  %i.qx = fmul double %i.qw, %i.fg
  %i.qy = insertelement <2 x double> %28, double %i.qx, i64 1
  %i.qz = fmul <2 x double> %i.qy, %29            ; 2 uses
  %i.ra = fadd <2 x double> %i.qz, %i.qt
  %i.rb = fsub <2 x double> %i.qz, %i.qt
  ...
  %i.rf = fmul double %41, %i.fg
  %i.rg = extractelement <2 x double> %17, i64 1
  %i.rh = fmul double %i.rf, %i.rg
  %i.ri = fsub double %i.rh, %43
  ...
  %i.sp = insertelement <2 x double> %i.qq, double %i.og, i64 0
  %i.sq = fsub <2 x double> %i.sp, %i.so          ; 5 uses
  %i.sr = shufflevector <2 x double> %i.qq, <2 x double> %i.re, <2 x i32> <i32 0, i32 3>
  %i.ss = fmul <2 x double> %i.au, %i.sr
  %i.st = shufflevector <2 x double> %i.qq, <2 x double> %i.rz, <2 x i32> <i32 0, i32 2>
  ...
  %i.sx = shufflevector <2 x double> %i.pw, <2 x double> %39, <2 x i32> <i32 1, i32 3>
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.abk = extractelement <2 x double> %i.qt, i64 0
