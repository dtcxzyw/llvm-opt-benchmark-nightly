begin_hunk_0_@decode_mcu:bb.a
  ...
  %i.r = tail call i32 %i.q(ptr noundef nonnull %0) #4
...
begin_hunk_1_@decode_mcu:bb.a
  ...
  br i1 %i.z, label %bb.d, label %process_restart.exit, !llvm.loop !107
...
process_restart.exit:                             ; preds = %bb.d, %.preheader.i
  ...
  store i32 0, ptr %i.ab, align 4, !tbaa !108
  br label %bb.e
...
begin_hunk_2_@decode_mcu:bb.a
  ...
  %i.ak = load i32, ptr %i.aj, align 4, !tbaa !109 ; 2 uses
  ...
  %i.an = load i64, ptr %i.am, align 8, !tbaa !110 ; 2 uses
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %i.as, i64 16, i1 false), !tbaa.struct !111
  %i.at = getelementptr inbounds nuw i8, ptr %0, i64 464 ; 2 uses
  %i.au = load i32, ptr %i.at, align 8, !tbaa !112
...
begin_hunk_4_@decode_mcu:bb.a
  ...
  %i.ce = tail call i32 %i.cd(ptr noundef %i.bw) #4
...
begin_hunk_5_@decode_mcu:bb.a
  ...
  %i.cu = tail call i32 %i.ct(ptr noundef %i.co) #4
...
begin_hunk_6_@decode_mcu:bb.a
  ...
  tail call void %i.dh(ptr noundef nonnull %i.bw, i32 noundef -1) #4
...
begin_hunk_7_@decode_mcu:bb.a
  ...
  %i.eq = tail call i32 %i.ep(ptr noundef %i.ei) #4
...
begin_hunk_8_@decode_mcu:bb.a
  ...
  %i.fg = tail call i32 %i.ff(ptr noundef %i.fa) #4
...
begin_hunk_9_@decode_mcu:bb.a
  ...
  tail call void %i.ft(ptr noundef nonnull %i.ei, i32 noundef -1) #4
...
begin_hunk_10_@decode_mcu:bb.a
  ...
  %i.gm = load i32, ptr %i.gl, align 8, !tbaa !115
...
begin_hunk_11_@decode_mcu:bb.a
  ...
  store i16 %i.gq, ptr %i.bd, align 2, !tbaa !116
  %i.gr = getelementptr inbounds nuw i8, ptr %i.bi, i64 36
  %i.gs = load i32, ptr %i.gr, align 4, !tbaa !117
...
begin_hunk_12_@decode_mcu:bb.a
  ...
  %i.hh = tail call i32 %i.hg(ptr noundef %i.gz) #4
...
begin_hunk_13_@decode_mcu:bb.a
  ...
  %i.hx = tail call i32 %i.hw(ptr noundef %i.hr) #4
...
begin_hunk_14_@decode_mcu:bb.a
  ...
  tail call void %i.ik(ptr noundef nonnull %i.gz, i32 noundef -1) #4
...
begin_hunk_15_@decode_mcu:bb.a
  ...
  %i.jt = tail call i32 %i.js(ptr noundef %i.jl) #4
...
begin_hunk_16_@decode_mcu:bb.a
  ...
  %i.kj = tail call i32 %i.ki(ptr noundef %i.kd) #4
...
begin_hunk_17_@decode_mcu:bb.a
  ...
  tail call void %i.kw(ptr noundef nonnull %i.jl, i32 noundef -1) #4
...
begin_hunk_18_@decode_mcu:bb.a
  ...
  store i16 %i.lp, ptr %i.lu, align 2, !tbaa !116
  br label %bb.cb
...
begin_hunk_19_@decode_mcu:bb.a
  ...
  br i1 %i.lx, label %bb.ap, label %.loopexit, !llvm.loop !118
...
begin_hunk_20_@decode_mcu:bb.a
  ...
  %i.ml = tail call i32 %i.mk(ptr noundef %i.md) #4
...
begin_hunk_21_@decode_mcu:bb.a
  ...
  %i.nb = tail call i32 %i.na(ptr noundef %i.mv) #4
...
begin_hunk_22_@decode_mcu:bb.a
  ...
  tail call void %i.no(ptr noundef nonnull %i.md, i32 noundef -1) #4
...
begin_hunk_23_@decode_mcu:bb.a
  ...
  %i.ow = tail call i32 %i.ov(ptr noundef %i.oo) #4
...
begin_hunk_24_@decode_mcu:bb.a
  ...
  %i.pm = tail call i32 %i.pl(ptr noundef %i.pg) #4
...
begin_hunk_25_@decode_mcu:bb.a
  ...
  tail call void %i.pz(ptr noundef nonnull %i.oo, i32 noundef -1) #4
...
begin_hunk_26_@decode_mcu:bb.a
  ...
  br i1 %i.qg, label %bb.cd, label %.loopexit, !llvm.loop !119
...
.loopexit:                                        ; preds = %bb.bz, %bb.cb, %bb.dl, %bb.dm
  ...
  %i.qh = load i32, ptr %i.at, align 8, !tbaa !112
  %i.qi = sext i32 %i.qh to i64
  %i.qj = icmp slt i64 %indvars.iv.next, %i.qi
  br i1 %i.qj, label %bb.f, label %._crit_edge.loopexit, !llvm.loop !120
...
begin_hunk_27_@decode_mcu:bb.a
  ...
  store i32 %i.qk, ptr %i.aj, align 4, !tbaa !109
  store i64 %.0171.lcssa, ptr %i.am, align 8, !tbaa !110
  store i32 %.0184.lcssa, ptr %i.ao, align 8, !tbaa !102
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.as, ptr noundef nonnull align 4 dereferenceable(16) %3, i64 16, i1 false), !tbaa.struct !111
