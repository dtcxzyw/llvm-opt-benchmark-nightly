...
.lr.ph.us.preheader:                              ; preds = %bb.b
  %.0223959 = ptrtoint ptr %.02239 to i64         ; 6 uses
...
bb.a:
  ...
  %i.l = ptrtoint ptr %i.k to i64                 ; 9 uses
...
.lr.ph41.split.us.preheader:                      ; preds = %.lr.ph41
  ...
  %i.an = add i64 %1, %i.am
  %i.ao = add i64 %i.am, %i.l
  %i.ap = add i64 %i.ao, 4
  %umax76 = tail call i64 @llvm.umax.i64(i64 %i.an, i64 %i.ap)
  %2 = xor i64 %i.l, -1
  %i.aq = add i64 %umax76, %2
  %3 = sub i64 %i.aq, %i.am                       ; 2 uses
  %i.ar = lshr i64 %3, 2
...
.lr.ph.us45.preheader:                            ; preds = %.lr.ph44
  %4 = add i64 %.idx, %i.l
  %i.dg = shl nsw i64 %i.o, 2                     ; 3 uses
  %i.dh = add i64 %4, %i.dg
  %i.di = add i64 %i.dg, %i.l
  %i.dj = add i64 %i.di, 4
  %umax83 = tail call i64 @llvm.umax.i64(i64 %i.dh, i64 %i.dj)
  %5 = xor i64 %i.l, -1
  %i.dk = add i64 %umax83, %5
  %6 = sub i64 %i.dk, %i.dg                       ; 2 uses
  %i.dl = lshr i64 %6, 2
  %i.dm = add nuw nsw i64 %i.dl, 1                ; 2 uses
  %min.iters.check85 = icmp ult i64 %6, 28
