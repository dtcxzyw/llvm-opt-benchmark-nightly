...
bb.b:                                             ; preds = %.lr.ph, %._crit_edge
  ...
  %.02239 = phi ptr [ %i.h, %.lr.ph ], [ %i.m, %._crit_edge ] ; 8 uses
  %.0223959 = ptrtoaddr ptr %.02239 to i64        ; 6 uses
...
.lr.ph.us.preheader:                              ; preds = %bb.b
  ...
  %i.u = add i64 %.idx, %.0223959
  %i.v = add i64 %.0223959, 4
  %i.w = tail call i64 @llvm.umax.i64(i64 %i.u, i64 %i.v)
  %i.x = xor i64 %.0223959, -1
  ...
  %i.ac = getelementptr i8, ptr %.02239, i64 %i.ab
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %..loopexit_crit_edge.us
  ...
  %i.ad = load i32, ptr @tokensetsize, align 4, !tbaa !4
  %i.ae = getelementptr inbounds nuw i8, ptr %.02337.us, i64 8
  %i.af = load i16, ptr %i.ae, align 8, !tbaa !85
  %i.ag = sext i16 %i.af to i32
  %i.ah = mul i32 %i.ad, %i.ag
  %i.ai = sext i32 %i.ah to i64                   ; 2 uses
  %i.aj = getelementptr [4 x i8], ptr %i.j, i64 %i.ai ; 5 uses
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph.us
  %i.ak = shl nsw i64 %i.ai, 2
  %scevgep63 = getelementptr i8, ptr %scevgep62, i64 %i.ak
  %bound0 = icmp ult ptr %.02239, %scevgep63
  %bound1 = icmp ult ptr %i.aj, %scevgep60
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %scalar.ph.preheader, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %i.al = getelementptr i8, ptr %i.aj, i64 %i.ab
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.am = shl i64 %index, 2                       ; 2 uses
  %next.gep = getelementptr i8, ptr %.02239, i64 %i.am ; 3 uses
  %next.gep64 = getelementptr i8, ptr %i.aj, i64 %i.am ; 2 uses
  %i.an = getelementptr i8, ptr %next.gep64, i64 16
  %wide.load = load <4 x i32>, ptr %next.gep64, align 4, !tbaa !4, !alias.scope !95
  %wide.load65 = load <4 x i32>, ptr %i.an, align 4, !tbaa !4, !alias.scope !95
  %i.ao = getelementptr i8, ptr %next.gep, i64 16 ; 2 uses
  %wide.load66 = load <4 x i32>, ptr %next.gep, align 4, !tbaa !4, !alias.scope !98, !noalias !95
  %wide.load67 = load <4 x i32>, ptr %i.ao, align 4, !tbaa !4, !alias.scope !98, !noalias !95
  %i.ap = or <4 x i32> %wide.load66, %wide.load
  %i.aq = or <4 x i32> %wide.load67, %wide.load65
  store <4 x i32> %i.ap, ptr %next.gep, align 4, !tbaa !4, !alias.scope !98, !noalias !95
  store <4 x i32> %i.aq, ptr %i.ao, align 4, !tbaa !4, !alias.scope !98, !noalias !95
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ar = icmp eq i64 %index.next, %n.vec
  br i1 %i.ar, label %middle.block, label %vector.body, !llvm.loop !100
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph.us, %middle.block
  %.02534.us.ph = phi ptr [ %.02239, %vector.memcheck ], [ %.02239, %.lr.ph.us ], [ %i.ac, %middle.block ]
  %.02633.us.ph = phi ptr [ %i.aj, %vector.memcheck ], [ %i.aj, %.lr.ph.us ], [ %i.al, %middle.block ]
  br label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %.02534.us = phi ptr [ %i.au, %scalar.ph ], [ %.02534.us.ph, %scalar.ph.preheader ] ; 3 uses
  %.02633.us = phi ptr [ %i.as, %scalar.ph ], [ %.02633.us.ph, %scalar.ph.preheader ] ; 2 uses
  %i.as = getelementptr inbounds nuw i8, ptr %.02633.us, i64 4
  %i.at = load i32, ptr %.02633.us, align 4, !tbaa !4
  %i.au = getelementptr inbounds nuw i8, ptr %.02534.us, i64 4 ; 2 uses
  %i.av = load i32, ptr %.02534.us, align 4, !tbaa !4
  %i.aw = or i32 %i.av, %i.at
  store i32 %i.aw, ptr %.02534.us, align 4, !tbaa !4
  %i.ax = icmp ult ptr %i.au, %i.m
  br i1 %i.ax, label %scalar.ph, label %..loopexit_crit_edge.us, !llvm.loop !101
...
.lr.ph48:                                         ; preds = %.lr.ph48.preheader, %._crit_edge46
  ...
  %i.ay = load ptr, ptr @lookback, align 8, !tbaa !48
  %i.az = getelementptr inbounds nuw [8 x i8], ptr %i.ay, i64 %indvars.iv52
  %i.ba = load ptr, ptr %i.az, align 8, !tbaa !81 ; 2 uses
  %.not3142 = icmp eq ptr %i.ba, null
  br i1 %.not3142, label %._crit_edge46, label %.lr.ph45

.lr.ph45:                                         ; preds = %.lr.ph48, %.lr.ph45
  %.12443 = phi ptr [ %i.bb, %.lr.ph45 ], [ %i.ba, %.lr.ph48 ] ; 2 uses
  %i.bb = load ptr, ptr %.12443, align 8, !tbaa !83 ; 2 uses
  tail call void @free(ptr noundef nonnull %.12443) #9
  %.not31 = icmp eq ptr %i.bb, null
...
._crit_edge49:                                    ; preds = %._crit_edge46, %bb.a
  %i.bc = load ptr, ptr @lookback, align 8, !tbaa !48 ; 2 uses
...
bb.d:                                             ; preds = %bb.c, %._crit_edge49
  %i.bd = load ptr, ptr @F, align 8, !tbaa !46    ; 2 uses
  %.not30 = icmp eq ptr %i.bd, null
  br i1 %.not30, label %bb.f, label %bb.e

bb.e:                                             ; preds = %bb.d
  tail call void @free(ptr noundef nonnull %i.bd) #9
  br label %bb.f
...
bb.a:
  ...
  %1 = ptrtoaddr ptr %i.k to i64                  ; 9 uses
  %i.l = load i32, ptr @tokensetsize, align 4, !tbaa !4
  %.fr46 = freeze i32 %i.l                        ; 4 uses
  %i.m = mul i32 %.fr46, %0
  %i.n = sext i32 %i.m to i64                     ; 7 uses
  %i.o = getelementptr [4 x i8], ptr %i.k, i64 %i.n ; 10 uses
  %i.p = sext i32 %.fr46 to i64
  %.idx = shl nsw i64 %i.p, 2                     ; 4 uses
  %i.q = getelementptr inbounds i8, ptr %i.o, i64 %.idx ; 2 uses
  %i.r = load ptr, ptr @R, align 8, !tbaa !74
  %i.s = getelementptr inbounds [8 x i8], ptr %i.r, i64 %i.i
  %i.t = load ptr, ptr %i.s, align 8, !tbaa !19   ; 3 uses
  %.not = icmp eq ptr %i.t, null
  br i1 %.not, label %.loopexit38, label %.preheader37

.preheader37:                                     ; preds = %bb.a
  %i.u = load i16, ptr %i.t, align 2, !tbaa !22   ; 2 uses
  %i.v = icmp sgt i16 %i.u, -1
  br i1 %i.v, label %.lr.ph41, label %.loopexit38

.lr.ph41:                                         ; preds = %.preheader37
  %i.w = zext nneg i16 %i.u to i32                ; 2 uses
  %i.x = getelementptr inbounds nuw i8, ptr %i.t, i64 2 ; 2 uses
  %i.y = icmp sgt i32 %.fr46, 0
  br i1 %i.y, label %.lr.ph41.split.us.preheader, label %.lr.ph41.split

.lr.ph41.split.us.preheader:                      ; preds = %.lr.ph41
  %i.z = add i64 %.idx, %1
  %i.aa = shl nsw i64 %i.n, 2                     ; 4 uses
  %i.ab = add i64 %i.z, %i.aa
  %i.ac = add i64 %i.aa, %1
  %i.ad = add i64 %i.ac, 4
  %umax = tail call i64 @llvm.umax.i64(i64 %i.ab, i64 %i.ad)
  %i.ae = xor i64 %1, -1
  %i.af = add i64 %umax, %i.ae
  %i.ag = sub i64 %i.af, %i.aa
  %i.ah = and i64 %i.ag, -4                       ; 2 uses
  %i.ai = getelementptr i8, ptr %i.k, i64 %i.ah
  %i.aj = getelementptr i8, ptr %i.ai, i64 %i.aa
  %scevgep = getelementptr i8, ptr %i.aj, i64 4
  %i.ak = getelementptr i8, ptr %i.k, i64 %i.ah
  %scevgep74 = getelementptr i8, ptr %i.ak, i64 4
  %i.al = shl nsw i64 %i.n, 2                     ; 2 uses
  %i.am = add i64 %.idx, %1
  %i.an = add i64 %i.am, %i.al
  %i.ao = add i64 %i.al, %1
  %i.ap = add i64 %i.ao, 4
  %i.aq = tail call i64 @llvm.umax.i64(i64 %i.an, i64 %i.ap)
  %i.ar = shl nsw i64 %i.n, 2
  %i.as = add i64 %i.ar, %1
  %i.at = xor i64 %i.as, -1
  %i.au = add i64 %i.aq, %i.at                    ; 2 uses
  ...
  %i.ay = getelementptr i8, ptr %i.o, i64 %i.ax
...
.lr.ph41.split.us:                                ; preds = %.lr.ph41.split.us.preheader, %..loopexit36_crit_edge.us
  ...
  %i.ba = phi i32 [ %i.ce, %..loopexit36_crit_edge.us ], [ %i.w, %.lr.ph41.split.us.preheader ] ; 3 uses
  %i.bb = phi ptr [ %i.cc, %..loopexit36_crit_edge.us ], [ %i.x, %.lr.ph41.split.us.preheader ] ; 2 uses
...
vector.memcheck:                                  ; preds = %.lr.ph.us
  ...
  %bound0 = icmp ult ptr %i.o, %scevgep75
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %i.o, i64 %i.bq ; 3 uses
  %next.gep76 = getelementptr i8, ptr %i.bn, i64 %i.bq ; 2 uses
  %i.br = getelementptr i8, ptr %next.gep76, i64 16
  %wide.load = load <4 x i32>, ptr %next.gep76, align 4, !tbaa !4, !alias.scope !111
  %wide.load77 = load <4 x i32>, ptr %i.br, align 4, !tbaa !4, !alias.scope !111
  %i.bs = getelementptr i8, ptr %next.gep, i64 16 ; 2 uses
  %wide.load78 = load <4 x i32>, ptr %next.gep, align 4, !tbaa !4, !alias.scope !114, !noalias !111
  ...
  store <4 x i32> %i.bt, ptr %next.gep, align 4, !tbaa !4, !alias.scope !114, !noalias !111
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph.us, %middle.block
  %.040.us.ph = phi ptr [ %i.o, %vector.memcheck ], [ %i.o, %.lr.ph.us ], [ %i.ay, %middle.block ]
  %.02939.us.ph = phi ptr [ %i.bn, %vector.memcheck ], [ %i.bn, %.lr.ph.us ], [ %i.bp, %middle.block ]
  br label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %.040.us = phi ptr [ %i.by, %scalar.ph ], [ %.040.us.ph, %scalar.ph.preheader ] ; 3 uses
  %.02939.us = phi ptr [ %i.bw, %scalar.ph ], [ %.02939.us.ph, %scalar.ph.preheader ] ; 2 uses
  %i.bw = getelementptr inbounds nuw i8, ptr %.02939.us, i64 4
  %i.bx = load i32, ptr %.02939.us, align 4, !tbaa !4
  %i.by = getelementptr inbounds nuw i8, ptr %.040.us, i64 4 ; 2 uses
  %i.bz = load i32, ptr %.040.us, align 4, !tbaa !4
  %i.ca = or i32 %i.bz, %i.bx
  store i32 %i.ca, ptr %.040.us, align 4, !tbaa !4
  %i.cb = icmp ult ptr %i.by, %i.q
...
.lr.ph41.split:                                   ; preds = %.lr.ph41, %.loopexit36
  ...
  %i.ch = phi i32 [ %i.ct, %.loopexit36 ], [ %i.w, %.lr.ph41 ] ; 2 uses
  %i.ci = phi ptr [ %i.cr, %.loopexit36 ], [ %i.x, %.lr.ph41 ] ; 2 uses
...
.lr.ph.us45.preheader:                            ; preds = %.lr.ph44
  %i.dk = shl nsw i64 %i.n, 2                     ; 2 uses
  %i.dl = add i64 %.idx, %1
  %i.dm = add i64 %i.dl, %i.dk
  %i.dn = add i64 %i.dk, %1
  %i.do = add i64 %i.dn, 4
  %i.dp = tail call i64 @llvm.umax.i64(i64 %i.dm, i64 %i.do)
  %i.dq = shl nsw i64 %i.n, 2
  %i.dr = add i64 %i.dq, %1
  %i.ds = xor i64 %i.dr, -1
  %i.dt = add i64 %i.dp, %i.ds                    ; 2 uses
  %i.du = lshr i64 %i.dt, 2
  %i.dv = add nuw nsw i64 %i.du, 1                ; 2 uses
  %min.iters.check83 = icmp ult i64 %i.dt, 28
  %n.vec86 = and i64 %i.dv, 9223372036854775800   ; 3 uses
  %i.dw = shl i64 %n.vec86, 2                     ; 2 uses
  %i.dx = getelementptr i8, ptr %i.o, i64 %i.dw
  %cmp.n95 = icmp eq i64 %i.dv, %n.vec86
  br label %.lr.ph.us45
...
.lr.ph.us45:                                      ; preds = %.lr.ph.us45.preheader, %..loopexit_crit_edge.us
  ...
  %i.dy = phi i32 [ %i.er, %..loopexit_crit_edge.us ], [ %i.de, %.lr.ph.us45.preheader ]
  %i.dz = load i32, ptr @tokensetsize, align 4, !tbaa !4
  %i.ea = mul i32 %i.dz, %i.dy
  %i.eb = sext i32 %i.ea to i64                   ; 2 uses
  %i.ec = getelementptr inbounds [4 x i8], ptr %i.k, i64 %i.eb ; 4 uses
  br i1 %min.iters.check83, label %scalar.ph82.preheader, label %vector.memcheck81

vector.memcheck81:                                ; preds = %.lr.ph.us45
  %i.ed = sub nsw i64 %i.eb, %i.n
...
vector.ph84:                                      ; preds = %vector.memcheck81
  %i.eg = getelementptr i8, ptr %i.ec, i64 %i.dw
  br label %vector.body87

vector.body87:                                    ; preds = %vector.body87, %vector.ph84
  %index88 = phi i64 [ 0, %vector.ph84 ], [ %index.next93, %vector.body87 ] ; 2 uses
  %i.eh = shl i64 %index88, 2                     ; 2 uses
  %next.gep89 = getelementptr i8, ptr %i.o, i64 %i.eh ; 2 uses
  %next.gep90 = getelementptr i8, ptr %i.ec, i64 %i.eh ; 2 uses
  %i.ei = getelementptr i8, ptr %next.gep89, i64 16
  %wide.load91 = load <4 x i32>, ptr %next.gep89, align 4, !tbaa !4
  %wide.load92 = load <4 x i32>, ptr %i.ei, align 4, !tbaa !4
  %i.ej = getelementptr i8, ptr %next.gep90, i64 16
  store <4 x i32> %wide.load91, ptr %next.gep90, align 4, !tbaa !4
  store <4 x i32> %wide.load92, ptr %i.ej, align 4, !tbaa !4
  %index.next93 = add nuw i64 %index88, 8         ; 2 uses
  %i.ek = icmp eq i64 %index.next93, %n.vec86
  br i1 %i.ek, label %middle.block94, label %vector.body87, !llvm.loop !119

middle.block94:                                   ; preds = %vector.body87
  br i1 %cmp.n95, label %..loopexit_crit_edge.us, label %scalar.ph82.preheader

scalar.ph82.preheader:                            ; preds = %vector.memcheck81, %.lr.ph.us45, %middle.block94
  %.143.us.ph = phi ptr [ %i.o, %vector.memcheck81 ], [ %i.o, %.lr.ph.us45 ], [ %i.dx, %middle.block94 ]
  %.13042.us.ph = phi ptr [ %i.ec, %vector.memcheck81 ], [ %i.ec, %.lr.ph.us45 ], [ %i.eg, %middle.block94 ]
  br label %scalar.ph82

scalar.ph82:                                      ; preds = %scalar.ph82.preheader, %scalar.ph82
  %.143.us = phi ptr [ %i.el, %scalar.ph82 ], [ %.143.us.ph, %scalar.ph82.preheader ] ; 2 uses
  %.13042.us = phi ptr [ %i.en, %scalar.ph82 ], [ %.13042.us.ph, %scalar.ph82.preheader ] ; 2 uses
  %i.el = getelementptr inbounds nuw i8, ptr %.143.us, i64 4 ; 2 uses
  %i.em = load i32, ptr %.143.us, align 4, !tbaa !4
  %i.en = getelementptr inbounds nuw i8, ptr %.13042.us, i64 4
  store i32 %i.em, ptr %.13042.us, align 4, !tbaa !4
  %i.eo = icmp ult ptr %i.el, %i.q
  br i1 %i.eo, label %scalar.ph82, label %..loopexit_crit_edge.us, !llvm.loop !120

..loopexit_crit_edge.us:                          ; preds = %scalar.ph82, %middle.block94
  %indvars.iv.next53 = add nsw i64 %indvars.iv52, -1 ; 2 uses
  %i.ep = getelementptr inbounds [2 x i8], ptr %i.b, i64 %indvars.iv52
  %i.eq = load i16, ptr %i.ep, align 2, !tbaa !22 ; 2 uses
  %i.er = sext i16 %i.eq to i32                   ; 2 uses
  %i.es = sext i16 %i.eq to i64
  %i.et = getelementptr inbounds [2 x i8], ptr %i.h, i64 %i.es
  store i16 %i.cz, ptr %i.et, align 2, !tbaa !22
  %i.eu = icmp eq i32 %0, %i.er
  br i1 %i.eu, label %.loopexit35.loopexit, label %.lr.ph.us45

.loopexit:                                        ; preds = %.lr.ph44, %.loopexit
  %indvars.iv = phi i64 [ %indvars.iv.next, %.loopexit ], [ %i.dj, %.lr.ph44 ] ; 2 uses
  %indvars.iv.next = add nsw i64 %indvars.iv, -1  ; 2 uses
  %i.ev = getelementptr inbounds [2 x i8], ptr %i.b, i64 %indvars.iv
  %i.ew = load i16, ptr %i.ev, align 2, !tbaa !22 ; 2 uses
  %i.ex = sext i16 %i.ew to i32
  %i.ey = sext i16 %i.ew to i64
  %i.ez = getelementptr inbounds [2 x i8], ptr %i.h, i64 %i.ey
  store i16 %i.cz, ptr %i.ez, align 2, !tbaa !22
  %i.fa = icmp eq i32 %0, %i.ex
  br i1 %i.fa, label %.loopexit35.loopexit47, label %.loopexit

.loopexit35.loopexit:                             ; preds = %..loopexit_crit_edge.us
  %i.fb = trunc nsw i64 %indvars.iv.next53 to i32
  br label %.loopexit35

.loopexit35.loopexit47:                           ; preds = %.loopexit
  %i.fc = trunc nsw i64 %indvars.iv.next to i32
  br label %.loopexit35

.loopexit35:                                      ; preds = %.loopexit35.loopexit47, %.loopexit35.loopexit, %.preheader
  %.lcssa = phi i32 [ %i.da, %.preheader ], [ %i.fb, %.loopexit35.loopexit ], [ %i.fc, %.loopexit35.loopexit47 ]
