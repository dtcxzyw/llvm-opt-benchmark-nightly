...
bb.d:                                             ; preds = %make_orthogonal.exit, %.critedge
  ...
  %2 = extractelement <2 x double> %i.bl, i64 1
  %3 = tail call double @llvm.fmuladd.f64(double %i.br, double %i.bs, double 0.000000e+00)
  %i.bt = insertelement <2 x double> %i.bq, double f0x3FC91A556151761C, i64 0
  %i.bu = insertelement <2 x double> <double 0.000000e+00, double poison>, double %3, i64 1
  ...
  %i.cb = tail call double @llvm.fmuladd.f64(double %2, double f0xBFEF60EAB9A5D3A3, double %i.ca) ; 2 uses
