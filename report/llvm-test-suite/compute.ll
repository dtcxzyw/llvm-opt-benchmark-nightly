...
bb.d:                                             ; preds = %make_orthogonal.exit, %.critedge
  ...
  %2 = extractelement <2 x double> %i.bd, i64 0   ; 2 uses
  %3 = tail call double @llvm.fmuladd.f64(double %2, double %2, double 0.000000e+00)
  %foldExtExtBinop87 = fmul <2 x double> %i.bd, %i.bd
  %4 = shufflevector <2 x double> %foldExtExtBinop87, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %5 = insertelement <2 x double> %4, double %3, i64 1
  %i.be = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bd, <2 x double> %i.bd, <2 x double> %5)
  %i.bf = tail call <2 x double> @llvm.sqrt.v2f64(<2 x double> %i.be) ; 3 uses
  %6 = shufflevector <2 x double> %i.bf, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.bg = fdiv <2 x double> %i.bd, %6             ; 4 uses
  %i.bh = fneg <2 x double> %i.bc
  %i.bi = fmul <2 x double> %i.bc, %i.bh
  %i.bj = fmul <2 x double> %i.bi, %i.bd
  %7 = shufflevector <2 x double> %i.bf, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bk = fdiv <2 x double> %i.bj, %7             ; 2 uses
  ...
  %i.bu = extractelement <2 x double> %i.bf, i64 1
