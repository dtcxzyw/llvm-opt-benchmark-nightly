...
bb.c:                                             ; preds = %bb.b, %.thread433
  %i.g = phi i1 [ false, %.thread433 ], [ %i.f, %bb.b ] ; 3 uses
  %i.h = phi i32 [ 1, %.thread433 ], [ %spec.select446, %bb.b ] ; 2 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  %1 = shl nuw nsw i32 %i.h, 4
  %2 = uitofp nneg i32 %1 to double
  %i.ai = fdiv double %i.ah, %2
...
bb.v:                                             ; preds = %._crit_edge397, %bb.i, %bb.l, %bb.p, %bb.t, %bb.u, %bb.r, %bb.n, %bb.j
  ...
  %3 = icmp sgt i32 %i.aq, 24000                  ; 3 uses
  %i.ar = select i1 %3, i32 2, i32 1
...
begin_hunk_3_@lame_init_params:bb.a
  ...
  %i.bi = uitofp nneg i32 %5 to float
