...
.preheader.preheader.i:                           ; preds = %bb.h
  ...
  br i1 %.not14.3.i, label %.preheader.4.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.4.i:                                   ; preds = %.preheader.preheader.i
  %i.z = load i8, ptr %i.u, align 4, !tbaa !58
  %.not14.4.i = icmp eq i8 %i.z, 0
  br i1 %.not14.4.i, label %.preheader.5.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.5.i:                                   ; preds = %.preheader.4.i
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 69
  %i.ab = load i8, ptr %i.aa, align 1, !tbaa !58
  %.not14.5.i = icmp eq i8 %i.ab, 0
  br i1 %.not14.5.i, label %.preheader.6.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.6.i:                                   ; preds = %.preheader.5.i
  %i.ac = getelementptr inbounds nuw i8, ptr %0, i64 70
  %i.ad = load i8, ptr %i.ac, align 2, !tbaa !58
  %.not14.6.i = icmp eq i8 %i.ad, 0
  br i1 %.not14.6.i, label %.preheader.7.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.7.i:                                   ; preds = %.preheader.6.i
  %i.ae = getelementptr inbounds nuw i8, ptr %0, i64 71
  %i.af = load i8, ptr %i.ae, align 1, !tbaa !58
  %.not14.7.i = icmp eq i8 %i.af, 0
  br i1 %.not14.7.i, label %.preheader.8.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.8.i:                                   ; preds = %.preheader.7.i
  %i.ag = getelementptr inbounds nuw i8, ptr %0, i64 72
  %i.ah = load i8, ptr %i.ag, align 8, !tbaa !58
  %.not14.8.i = icmp eq i8 %i.ah, 0
  br i1 %.not14.8.i, label %.preheader.9.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.9.i:                                   ; preds = %.preheader.8.i
  %i.ai = getelementptr inbounds nuw i8, ptr %0, i64 73
  %i.aj = load i8, ptr %i.ai, align 1, !tbaa !58
  %.not14.9.i = icmp eq i8 %i.aj, 0
  br i1 %.not14.9.i, label %.preheader.10.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.10.i:                                  ; preds = %.preheader.9.i
  %i.ak = getelementptr inbounds nuw i8, ptr %0, i64 74
  %i.al = load i8, ptr %i.ak, align 2, !tbaa !58
  %.not14.10.i = icmp eq i8 %i.al, 0
  br i1 %.not14.10.i, label %.preheader.11.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.11.i:                                  ; preds = %.preheader.10.i
  %i.am = getelementptr inbounds nuw i8, ptr %0, i64 75
  %i.an = load i8, ptr %i.am, align 1, !tbaa !58
  %.not14.11.i = icmp eq i8 %i.an, 0
  br i1 %.not14.11.i, label %.preheader.12.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.12.i:                                  ; preds = %.preheader.11.i
  %i.ao = getelementptr inbounds nuw i8, ptr %0, i64 76
  %i.ap = load i8, ptr %i.ao, align 4, !tbaa !58
  %.not14.12.i = icmp eq i8 %i.ap, 0
  br i1 %.not14.12.i, label %.preheader.13.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.13.i:                                  ; preds = %.preheader.12.i
  %i.aq = getelementptr inbounds nuw i8, ptr %0, i64 77
  %i.ar = load i8, ptr %i.aq, align 1, !tbaa !58
  %.not14.13.i = icmp eq i8 %i.ar, 0
  br i1 %.not14.13.i, label %.preheader.14.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.14.i:                                  ; preds = %.preheader.13.i
  %i.as = getelementptr inbounds nuw i8, ptr %0, i64 78
  %i.at = load i8, ptr %i.as, align 2, !tbaa !58
  %.not14.14.i = icmp eq i8 %i.at, 0
  br i1 %.not14.14.i, label %.preheader.15.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.15.i:                                  ; preds = %.preheader.14.i
  %i.au = getelementptr inbounds nuw i8, ptr %0, i64 79
  %i.av = load i8, ptr %i.au, align 1, !tbaa !58
  %.not14.15.i = icmp eq i8 %i.av, 0
  br i1 %.not14.15.i, label %.preheader.16.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.16.i:                                  ; preds = %.preheader.15.i
  %i.aw = getelementptr inbounds nuw i8, ptr %0, i64 80
  %i.ax = load i8, ptr %i.aw, align 8, !tbaa !58
  %.not14.16.i = icmp eq i8 %i.ax, 0
  br i1 %.not14.16.i, label %.preheader.17.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.17.i:                                  ; preds = %.preheader.16.i
  %i.ay = getelementptr inbounds nuw i8, ptr %0, i64 81
  %i.az = load i8, ptr %i.ay, align 1, !tbaa !58
  %.not14.17.i = icmp eq i8 %i.az, 0
  br i1 %.not14.17.i, label %.preheader.18.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.18.i:                                  ; preds = %.preheader.17.i
  %i.ba = getelementptr inbounds nuw i8, ptr %0, i64 82
  %i.bb = load i8, ptr %i.ba, align 2, !tbaa !58
  %.not14.18.i = icmp eq i8 %i.bb, 0
  br i1 %.not14.18.i, label %.preheader.19.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.19.i:                                  ; preds = %.preheader.18.i
  %i.bc = getelementptr inbounds nuw i8, ptr %0, i64 83
  %i.bd = load i8, ptr %i.bc, align 1, !tbaa !58
  %.not14.19.i = icmp eq i8 %i.bd, 0
  br i1 %.not14.19.i, label %.preheader.20.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.20.i:                                  ; preds = %.preheader.19.i
  %i.be = getelementptr inbounds nuw i8, ptr %0, i64 84
  %i.bf = load i8, ptr %i.be, align 4, !tbaa !58
  %.not14.20.i = icmp eq i8 %i.bf, 0
  br i1 %.not14.20.i, label %.preheader.21.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.21.i:                                  ; preds = %.preheader.20.i
  %i.bg = getelementptr inbounds nuw i8, ptr %0, i64 85
  %i.bh = load i8, ptr %i.bg, align 1, !tbaa !58
  %.not14.21.i = icmp eq i8 %i.bh, 0
  br i1 %.not14.21.i, label %.preheader.22.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.22.i:                                  ; preds = %.preheader.21.i
  %i.bi = getelementptr inbounds nuw i8, ptr %0, i64 86
  %i.bj = load i8, ptr %i.bi, align 2, !tbaa !58
  %.not14.22.i = icmp eq i8 %i.bj, 0
  br i1 %.not14.22.i, label %.preheader.23.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

.preheader.23.i:                                  ; preds = %.preheader.22.i
  %i.bk = getelementptr inbounds nuw i8, ptr %0, i64 87
  %i.bl = load i8, ptr %i.bk, align 1, !tbaa !58
  %.not14.23.i = icmp eq i8 %i.bl, 0
  br i1 %.not14.23.i, label %bb.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread

bb.i:                                             ; preds = %.preheader.23.i
  %i.bm = getelementptr inbounds nuw i8, ptr %0, i64 62
  %i.bn = load i8, ptr %i.bm, align 2, !tbaa !58
  %.not.i = icmp eq i8 %i.bn, 0
  br i1 %.not.i, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread88

_ZN8NArchive3N7zL14TestSignature2EPKh.exit:       ; preds = %bb.i
  %i.bo = getelementptr inbounds nuw i8, ptr %0, i64 63
  %i.bp = load i8, ptr %i.bo, align 1, !tbaa !58
  %.not = icmp eq i8 %i.bp, 0
  br i1 %.not, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread, label %_ZN8NArchive3N7zL14TestSignature2EPKh.exit.thread88

end_hunk_0
begin_hunk_1_@_ZN8NArchive3N7z10CInArchive21ReadArchivePropertiesERNS0_14CInArchiveInfoE:bb.a
...
; Function Attrs: mustprogress uwtable
define dso_local void @_ZN8NArchive3N7z10CInArchive17GetNextFolderItemERNS0_7CFolderE(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(96) %0, ptr noundef nonnull align 8 dereferenceable(133) %1) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
_ZN8NArchive3N7z10CCoderInfoD2Ev.exit:            ; preds = %_ZN8NArchive3N7z10CCoderInfoD2Ev.exit.lr.ph, %bb.u
  ...
  %i.aa = load i64, ptr %i.z, align 8, !tbaa !54  ; 2 uses
  %.not.i.i = icmp ult i64 %i.y, %i.aa
  br i1 %.not.i.i, label %_ZN8NArchive3N7z10CInArchive8ReadByteEv.exit, label %bb.c

bb.c:                                             ; preds = %_ZN8NArchive3N7z10CCoderInfoD2Ev.exit
  tail call fastcc void @_ZN8NArchive3N7zL14ThrowExceptionEv()
  unreachable

_ZN8NArchive3N7z10CInArchive8ReadByteEv.exit:     ; preds = %_ZN8NArchive3N7z10CCoderInfoD2Ev.exit
  %i.ab = load ptr, ptr %i.w, align 8, !tbaa !52  ; 6 uses
  %i.ac = add nuw i64 %i.y, 1                     ; 4 uses
  store i64 %i.ac, ptr %i.x, align 8, !tbaa !55
  %i.ad = getelementptr inbounds nuw i8, ptr %i.ab, i64 %i.y
  %i.ae = load i8, ptr %i.ad, align 1, !tbaa !58  ; 2 uses
  %i.af = zext i8 %i.ae to i32                    ; 3 uses
  %i.ag = and i32 %i.af, 15                       ; 6 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #17
  %i.ah = zext nneg i32 %i.ag to i64              ; 5 uses
  %i.ai = sub i64 %i.aa, %i.ac
  %i.aj = icmp ult i64 %i.ai, %i.ah
  br i1 %i.aj, label %bb.d, label %.preheader.i.i

.preheader.i.i:                                   ; preds = %_ZN8NArchive3N7z10CInArchive8ReadByteEv.exit
  %.not.i.i76 = icmp eq i32 %i.ag, 0
  br i1 %.not.i.i76, label %._crit_edge, label %.lr.ph.i.i.preheader

.lr.ph.i.i.preheader:                             ; preds = %.preheader.i.i
  %xtraiter = and i64 %i.ah, 3                    ; 3 uses
  %i.ak = icmp samesign ult i32 %i.ag, 4
  br i1 %i.ak, label %.lr.ph.i.i.epil.preheader, label %.lr.ph.i.i.preheader.new

.lr.ph.i.i.preheader.new:                         ; preds = %.lr.ph.i.i.preheader
  %unroll_iter = and i64 %i.ah, 12
  br label %.lr.ph.i.i

bb.d:                                             ; preds = %_ZN8NArchive3N7z10CInArchive8ReadByteEv.exit
  tail call fastcc void @_ZN8NArchive3N7zL14ThrowExceptionEv()
  unreachable

.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.i.i.preheader.new
  %i.al = phi i64 [ %i.ac, %.lr.ph.i.i.preheader.new ], [ %i.ba, %.lr.ph.i.i ] ; 5 uses
  %.06.i.i = phi i64 [ 0, %.lr.ph.i.i.preheader.new ], [ %i.bf, %.lr.ph.i.i ] ; 5 uses
  %niter = phi i64 [ 0, %.lr.ph.i.i.preheader.new ], [ %niter.next.3, %.lr.ph.i.i ]
  %i.am = add i64 %i.al, 1                        ; 2 uses
  store i64 %i.am, ptr %i.x, align 8, !tbaa !55
  %i.an = getelementptr inbounds nuw i8, ptr %i.ab, i64 %i.al
  %i.ao = load i8, ptr %i.an, align 1, !tbaa !58
  %i.ap = getelementptr inbounds nuw i8, ptr %i.a, i64 %.06.i.i
  store i8 %i.ao, ptr %i.ap, align 1, !tbaa !58
  %i.aq = add i64 %i.al, 2                        ; 2 uses
  store i64 %i.aq, ptr %i.x, align 8, !tbaa !55
  %i.ar = getelementptr inbounds nuw i8, ptr %i.ab, i64 %i.am
  %i.as = load i8, ptr %i.ar, align 1, !tbaa !58
  %i.at = getelementptr inbounds nuw i8, ptr %i.a, i64 %.06.i.i
  %i.au = getelementptr inbounds nuw i8, ptr %i.at, i64 1
  store i8 %i.as, ptr %i.au, align 1, !tbaa !58
  %i.av = add i64 %i.al, 3                        ; 2 uses
  store i64 %i.av, ptr %i.x, align 8, !tbaa !55
  %i.aw = getelementptr inbounds nuw i8, ptr %i.ab, i64 %i.aq
  %i.ax = load i8, ptr %i.aw, align 1, !tbaa !58
  %i.ay = getelementptr inbounds nuw i8, ptr %i.a, i64 %.06.i.i
  %i.az = getelementptr inbounds nuw i8, ptr %i.ay, i64 2
  store i8 %i.ax, ptr %i.az, align 1, !tbaa !58
  %i.ba = add i64 %i.al, 4                        ; 3 uses
  store i64 %i.ba, ptr %i.x, align 8, !tbaa !55
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ab, i64 %i.av
  %i.bc = load i8, ptr %i.bb, align 1, !tbaa !58
  %i.bd = getelementptr inbounds nuw i8, ptr %i.a, i64 %.06.i.i
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 3
  store i8 %i.bc, ptr %i.be, align 1, !tbaa !58
  %i.bf = add nuw nsw i64 %.06.i.i, 4             ; 2 uses
  %niter.next.3 = add i64 %niter, 4               ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit.unr-lcssa, label %.lr.ph.i.i, !llvm.loop !59

_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit.unr-lcssa: ; preds = %.lr.ph.i.i
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit, label %.lr.ph.i.i.epil.preheader

.lr.ph.i.i.epil.preheader:                        ; preds = %_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit.unr-lcssa, %.lr.ph.i.i.preheader
  %.epil.init = phi i64 [ %i.ac, %.lr.ph.i.i.preheader ], [ %i.ba, %_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit.unr-lcssa ]
  %.06.i.i.epil.init = phi i64 [ 0, %.lr.ph.i.i.preheader ], [ %i.bf, %_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit.unr-lcssa ]
  %lcmp.mod174 = icmp ne i64 %xtraiter, 0
  tail call void @llvm.assume(i1 %lcmp.mod174)
  br label %.lr.ph.i.i.epil

.lr.ph.i.i.epil:                                  ; preds = %.lr.ph.i.i.epil, %.lr.ph.i.i.epil.preheader
  %i.bg = phi i64 [ %i.bh, %.lr.ph.i.i.epil ], [ %.epil.init, %.lr.ph.i.i.epil.preheader ] ; 2 uses
  %.06.i.i.epil = phi i64 [ %i.bl, %.lr.ph.i.i.epil ], [ %.06.i.i.epil.init, %.lr.ph.i.i.epil.preheader ] ; 2 uses
  %epil.iter = phi i64 [ %epil.iter.next, %.lr.ph.i.i.epil ], [ 0, %.lr.ph.i.i.epil.preheader ]
  %i.bh = add i64 %i.bg, 1                        ; 2 uses
  store i64 %i.bh, ptr %i.x, align 8, !tbaa !55
  %i.bi = getelementptr inbounds nuw i8, ptr %i.ab, i64 %i.bg
  %i.bj = load i8, ptr %i.bi, align 1, !tbaa !58
  %i.bk = getelementptr inbounds nuw i8, ptr %i.a, i64 %.06.i.i.epil
  store i8 %i.bj, ptr %i.bk, align 1, !tbaa !58
  %i.bl = add nuw nsw i64 %.06.i.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit, label %.lr.ph.i.i.epil, !llvm.loop !92

_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit:  ; preds = %.lr.ph.i.i.epil, %_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit.unr-lcssa
  %i.bm = icmp samesign ugt i32 %i.ag, 8
  br i1 %i.bm, label %bb.e, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit
  %i.bn = zext nneg i32 %i.ag to i64
  %i.bo = getelementptr i8, ptr %i.a, i64 %i.bn   ; 5 uses
  %xtraiter175 = and i64 %i.ah, 3                 ; 3 uses
  %i.bp = icmp samesign ult i32 %i.ag, 4
  br i1 %i.bp, label %.lr.ph.epil.preheader, label %.lr.ph.preheader.new

.lr.ph.preheader.new:                             ; preds = %.lr.ph.preheader
  %unroll_iter180 = and i64 %i.ah, 12
  br label %.lr.ph

bb.e:                                             ; preds = %_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit
  tail call fastcc void @_ZN8NArchive3N7zL14ThrowExceptionEv()
  unreachable

._crit_edge.loopexit.unr-lcssa:                   ; preds = %.lr.ph
  %lcmp.mod177.not = icmp eq i64 %xtraiter175, 0
  br i1 %lcmp.mod177.not, label %._crit_edge, label %.lr.ph.epil.preheader

.lr.ph.epil.preheader:                            ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph.preheader
  %indvars.iv.epil.init = phi i64 [ 0, %.lr.ph.preheader ], [ %indvars.iv.next.3, %._crit_edge.loopexit.unr-lcssa ]
  %.067119.epil.init = phi i64 [ 0, %.lr.ph.preheader ], [ %i.cz, %._crit_edge.loopexit.unr-lcssa ]
...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  %.067119.epil = phi i64 [ %.067119.epil.init, %.lr.ph.epil.preheader ], [ %i.bw, %.lr.ph.epil ]
  %epil.iter176 = phi i64 [ 0, %.lr.ph.epil.preheader ], [ %epil.iter176.next, %.lr.ph.epil ]
  %i.bq = xor i64 %indvars.iv.epil, -1
  %i.br = getelementptr i8, ptr %i.bo, i64 %i.bq
  %i.bs = load i8, ptr %i.br, align 1, !tbaa !58
  %i.bt = zext i8 %i.bs to i64
  %i.bu = shl nuw nsw i64 %indvars.iv.epil, 3
  %i.bv = shl i64 %i.bt, %i.bu
  %i.bw = or i64 %i.bv, %.067119.epil             ; 2 uses
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter176.next = add i64 %epil.iter176, 1   ; 2 uses
  %epil.iter176.cmp.not = icmp eq i64 %epil.iter176.next, %xtraiter175
  br i1 %epil.iter176.cmp.not, label %._crit_edge, label %.lr.ph.epil, !llvm.loop !93

._crit_edge:                                      ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph.epil, %.preheader.i.i
  %.067.lcssa = phi i64 [ 0, %.preheader.i.i ], [ %i.cz, %._crit_edge.loopexit.unr-lcssa ], [ %i.bw, %.lr.ph.epil ]
  store i64 %.067.lcssa, ptr %i.v, align 8, !tbaa !91
  %i.bx = and i32 %i.af, 16
  %.not72 = icmp eq i32 %i.bx, 0
  br i1 %.not72, label %bb.i, label %bb.f

.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  %indvars.iv = phi i64 [ 0, %.lr.ph.preheader.new ], [ %indvars.iv.next.3, %.lr.ph ] ; 9 uses
  %.067119 = phi i64 [ 0, %.lr.ph.preheader.new ], [ %i.cz, %.lr.ph ]
  %niter181 = phi i64 [ 0, %.lr.ph.preheader.new ], [ %niter181.next.3, %.lr.ph ]
  %i.by = xor i64 %indvars.iv, -1
  %i.bz = getelementptr i8, ptr %i.bo, i64 %i.by
  %i.ca = load i8, ptr %i.bz, align 1, !tbaa !58
  %i.cb = zext i8 %i.ca to i64
  %i.cc = shl nuw nsw i64 %indvars.iv, 3
  %i.cd = shl i64 %i.cb, %i.cc
  %i.ce = or i64 %i.cd, %.067119
  %i.cf = xor i64 %indvars.iv, -2
  %i.cg = getelementptr i8, ptr %i.bo, i64 %i.cf
  %i.ch = load i8, ptr %i.cg, align 1, !tbaa !58
  %i.ci = zext i8 %i.ch to i64
  %indvars.iv.next = shl i64 %indvars.iv, 3
  %i.cj = or disjoint i64 %indvars.iv.next, 8
  %i.ck = shl i64 %i.ci, %i.cj
  %i.cl = or i64 %i.ck, %i.ce
  %i.cm = xor i64 %indvars.iv, -3
  %i.cn = getelementptr i8, ptr %i.bo, i64 %i.cm
  %i.co = load i8, ptr %i.cn, align 1, !tbaa !58
  %i.cp = zext i8 %i.co to i64
  %indvars.iv.next.1 = shl i64 %indvars.iv, 3
  %i.cq = or disjoint i64 %indvars.iv.next.1, 16
  %i.cr = shl i64 %i.cp, %i.cq
  %i.cs = or i64 %i.cr, %i.cl
  %i.ct = xor i64 %indvars.iv, -4
  %i.cu = getelementptr i8, ptr %i.bo, i64 %i.ct
  %i.cv = load i8, ptr %i.cu, align 1, !tbaa !58
  %i.cw = zext i8 %i.cv to i64
  %indvars.iv.next.2 = shl i64 %indvars.iv, 3
  %i.cx = or disjoint i64 %indvars.iv.next.2, 24
  ...
  br i1 %niter181.ncmp.3, label %._crit_edge.loopexit.unr-lcssa, label %.lr.ph, !llvm.loop !94

bb.f:                                             ; preds = %._crit_edge
  %i.da = tail call noundef i64 @_ZN8NArchive3N7z8CInByte210ReadNumberEv(ptr noundef nonnull align 8 dereferenceable(24) %i.w) ; 2 uses
  %i.db = icmp ugt i64 %i.da, 2147483647
  br i1 %i.db, label %bb.g, label %_ZN8NArchive3N7z10CInArchive7ReadNumEv.exit78

bb.g:                                             ; preds = %bb.f
  tail call fastcc void @_ZN8NArchive3N7zL14ThrowExceptionEv()
  unreachable

_ZN8NArchive3N7z10CInArchive7ReadNumEv.exit78:    ; preds = %bb.f
  %i.dc = trunc nuw nsw i64 %i.da to i32
  %i.dd = getelementptr inbounds nuw i8, ptr %i.v, i64 32
  store i32 %i.dc, ptr %i.dd, align 8, !tbaa !29
  %i.de = load ptr, ptr %i.b, align 8, !tbaa !45
  %i.df = tail call noundef i64 @_ZN8NArchive3N7z8CInByte210ReadNumberEv(ptr noundef nonnull align 8 dereferenceable(24) %i.de) ; 2 uses
  %i.dg = icmp ugt i64 %i.df, 2147483647
  br i1 %i.dg, label %bb.h, label %_ZN8NArchive3N7z10CInArchive7ReadNumEv.exit79

bb.h:                                             ; preds = %_ZN8NArchive3N7z10CInArchive7ReadNumEv.exit78
  tail call fastcc void @_ZN8NArchive3N7zL14ThrowExceptionEv()
  unreachable

_ZN8NArchive3N7z10CInArchive7ReadNumEv.exit79:    ; preds = %_ZN8NArchive3N7z10CInArchive7ReadNumEv.exit78
  %i.dh = trunc nuw nsw i64 %i.df to i32
  br label %bb.j

bb.i:                                             ; preds = %._crit_edge
  %i.di = getelementptr inbounds nuw i8, ptr %i.v, i64 32
  store i32 1, ptr %i.di, align 8, !tbaa !29
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %_ZN8NArchive3N7z10CInArchive7ReadNumEv.exit79
  %.sink = phi i32 [ 1, %bb.i ], [ %i.dh, %_ZN8NArchive3N7z10CInArchive7ReadNumEv.exit79 ]
  %i.dj = getelementptr inbounds nuw i8, ptr %i.v, i64 36
  store i32 %.sink, ptr %i.dj, align 4, !tbaa !34
  %i.dk = and i32 %i.af, 32
  %.not73 = icmp eq i32 %i.dk, 0
  br i1 %.not73, label %_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit86, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.dl = load ptr, ptr %i.b, align 8, !tbaa !45
  %i.dm = tail call noundef i64 @_ZN8NArchive3N7z8CInByte210ReadNumberEv(ptr noundef nonnull align 8 dereferenceable(24) %i.dl) ; 12 uses
  %i.dn = icmp ugt i64 %i.dm, 2147483647
  br i1 %i.dn, label %bb.l, label %_ZN8NArchive3N7z10CInArchive7ReadNumEv.exit80

bb.l:                                             ; preds = %bb.k
  tail call fastcc void @_ZN8NArchive3N7zL14ThrowExceptionEv()
  unreachable

_ZN8NArchive3N7z10CInArchive7ReadNumEv.exit80:    ; preds = %bb.k
  %i.do = getelementptr inbounds nuw i8, ptr %i.v, i64 16 ; 2 uses
  %i.dp = load i64, ptr %i.do, align 8, !tbaa !57 ; 3 uses
  %i.dq = icmp eq i64 %i.dm, %i.dp
  br i1 %i.dq, label %_ZN8NArchive3N7z10CInArchive7ReadNumEv.exit80._ZN7CBufferIhE11SetCapacityEm.exit_crit_edge, label %bb.m

_ZN8NArchive3N7z10CInArchive7ReadNumEv.exit80._ZN7CBufferIhE11SetCapacityEm.exit_crit_edge: ; preds = %_ZN8NArchive3N7z10CInArchive7ReadNumEv.exit80
...
bb.m:                                             ; preds = %_ZN8NArchive3N7z10CInArchive7ReadNumEv.exit80
  %.not.i = icmp eq i64 %i.dm, 0
  br i1 %.not.i, label %bb.p, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.dr = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %i.dm) #18 ; 3 uses
  %.not10.i = icmp eq i64 %i.dp, 0
  br i1 %.not10.i, label %bb.p, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.ds = getelementptr inbounds nuw i8, ptr %i.v, i64 24
  %i.dt = load ptr, ptr %i.ds, align 8, !tbaa !56
  %i.du = tail call noundef i64 @llvm.umin.i64(i64 %i.dp, i64 %i.dm)
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %i.dr, ptr align 1 %i.dt, i64 %i.du, i1 false)
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %bb.n, %bb.m
  %.0.i = phi ptr [ %i.dr, %bb.o ], [ %i.dr, %bb.n ], [ null, %bb.m ] ; 2 uses
  %i.dv = getelementptr inbounds nuw i8, ptr %i.v, i64 24 ; 2 uses
  %i.dw = load ptr, ptr %i.dv, align 8, !tbaa !56 ; 2 uses
  %i.dx = icmp eq ptr %i.dw, null
  br i1 %i.dx, label %bb.r, label %bb.q

bb.q:                                             ; preds = %bb.p
  tail call void @_ZdaPv(ptr noundef nonnull %i.dw) #19
  br label %bb.r

bb.r:                                             ; preds = %bb.q, %bb.p
  store ptr %.0.i, ptr %i.dv, align 8, !tbaa !56
  store i64 %i.dm, ptr %i.do, align 8, !tbaa !57
  br label %_ZN7CBufferIhE11SetCapacityEm.exit

_ZN7CBufferIhE11SetCapacityEm.exit:               ; preds = %_ZN8NArchive3N7z10CInArchive7ReadNumEv.exit80._ZN7CBufferIhE11SetCapacityEm.exit_crit_edge, %bb.r
  %i.dy = phi ptr [ %.pre, %_ZN8NArchive3N7z10CInArchive7ReadNumEv.exit80._ZN7CBufferIhE11SetCapacityEm.exit_crit_edge ], [ %.0.i, %bb.r ] ; 3 uses
  %i.dz = load ptr, ptr %i.b, align 8, !tbaa !45  ; 5 uses
  %i.ea = getelementptr inbounds nuw i8, ptr %i.dz, i64 8
  %i.eb = load i64, ptr %i.ea, align 8, !tbaa !54
  %i.ec = getelementptr inbounds nuw i8, ptr %i.dz, i64 16 ; 7 uses
  %i.ed = load i64, ptr %i.ec, align 8, !tbaa !55
  %i.ee = sub i64 %i.eb, %i.ed
  %i.ef = icmp ugt i64 %i.dm, %i.ee
  br i1 %i.ef, label %bb.s, label %.preheader.i.i81

.preheader.i.i81:                                 ; preds = %_ZN7CBufferIhE11SetCapacityEm.exit
  %.not.i.i82 = icmp eq i64 %i.dm, 0
  br i1 %.not.i.i82, label %_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit86, label %.lr.ph.i.i83.preheader

.lr.ph.i.i83.preheader:                           ; preds = %.preheader.i.i81
  %xtraiter182 = and i64 %i.dm, 1
  %i.eg = icmp eq i64 %i.dm, 1
  br i1 %i.eg, label %.lr.ph.i.i83.epil.preheader, label %.lr.ph.i.i83.preheader.new

.lr.ph.i.i83.preheader.new:                       ; preds = %.lr.ph.i.i83.preheader
  %unroll_iter186 = and i64 %i.dm, 2147483646
...
.lr.ph.i.i83:                                     ; preds = %.lr.ph.i.i83, %.lr.ph.i.i83.preheader.new
  %.06.i.i84 = phi i64 [ 0, %.lr.ph.i.i83.preheader.new ], [ %i.eu, %.lr.ph.i.i83 ] ; 3 uses
  %niter187 = phi i64 [ 0, %.lr.ph.i.i83.preheader.new ], [ %niter187.next.1, %.lr.ph.i.i83 ]
  %i.eh = load ptr, ptr %i.dz, align 8, !tbaa !52
  %i.ei = load i64, ptr %i.ec, align 8, !tbaa !55 ; 2 uses
  %i.ej = add i64 %i.ei, 1
  store i64 %i.ej, ptr %i.ec, align 8, !tbaa !55
  %i.ek = getelementptr inbounds nuw i8, ptr %i.eh, i64 %i.ei
  %i.el = load i8, ptr %i.ek, align 1, !tbaa !58
  %i.em = getelementptr inbounds nuw i8, ptr %i.dy, i64 %.06.i.i84
  store i8 %i.el, ptr %i.em, align 1, !tbaa !58
  %i.en = load ptr, ptr %i.dz, align 8, !tbaa !52
  %i.eo = load i64, ptr %i.ec, align 8, !tbaa !55 ; 2 uses
  %i.ep = add i64 %i.eo, 1
  store i64 %i.ep, ptr %i.ec, align 8, !tbaa !55
  %i.eq = getelementptr inbounds nuw i8, ptr %i.en, i64 %i.eo
  %i.er = load i8, ptr %i.eq, align 1, !tbaa !58
  %i.es = getelementptr inbounds nuw i8, ptr %i.dy, i64 %.06.i.i84
  %i.et = getelementptr inbounds nuw i8, ptr %i.es, i64 1
  store i8 %i.er, ptr %i.et, align 1, !tbaa !58
  %i.eu = add nuw i64 %.06.i.i84, 2               ; 2 uses
  %niter187.next.1 = add i64 %niter187, 2         ; 2 uses
  %niter187.ncmp.1 = icmp eq i64 %niter187.next.1, %unroll_iter186
  br i1 %niter187.ncmp.1, label %_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit86.loopexit.unr-lcssa, label %.lr.ph.i.i83, !llvm.loop !59

_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit86.loopexit.unr-lcssa: ; preds = %.lr.ph.i.i83
  %lcmp.mod184.not = icmp eq i64 %xtraiter182, 0
  br i1 %lcmp.mod184.not, label %_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit86, label %.lr.ph.i.i83.epil.preheader

.lr.ph.i.i83.epil.preheader:                      ; preds = %_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit86.loopexit.unr-lcssa, %.lr.ph.i.i83.preheader
  %.06.i.i84.epil.init = phi i64 [ 0, %.lr.ph.i.i83.preheader ], [ %i.eu, %_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit86.loopexit.unr-lcssa ]
  %lcmp.mod185 = trunc i64 %i.dm to i1
  tail call void @llvm.assume(i1 %lcmp.mod185)
  %i.ev = load ptr, ptr %i.dz, align 8, !tbaa !52
  %i.ew = load i64, ptr %i.ec, align 8, !tbaa !55 ; 2 uses
  %i.ex = add i64 %i.ew, 1
  store i64 %i.ex, ptr %i.ec, align 8, !tbaa !55
  %i.ey = getelementptr inbounds nuw i8, ptr %i.ev, i64 %i.ew
  %i.ez = load i8, ptr %i.ey, align 1, !tbaa !58
  %i.fa = getelementptr inbounds nuw i8, ptr %i.dy, i64 %.06.i.i84.epil.init
  store i8 %i.ez, ptr %i.fa, align 1, !tbaa !58
  br label %_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit86

_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit86: ; preds = %.lr.ph.i.i83.epil.preheader, %_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit86.loopexit.unr-lcssa, %.preheader.i.i81, %bb.j
  %.not74 = icmp sgt i8 %i.ae, -1
  br i1 %.not74, label %bb.u, label %bb.t

bb.t:                                             ; preds = %_ZN8NArchive3N7z10CInArchive9ReadBytesEPhm.exit86
  tail call fastcc void @_ZN8NArchive3N7zL14ThrowExceptionEv()
end_hunk_1
...
_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit._crit_edge.i: ; preds = %_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit.preheader.i, %_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit.loopexit.us.i
  ...
  invoke void @__cxa_throw(ptr nonnull %i.cr, ptr nonnull @_ZTIi, ptr null) #21
          to label %.noexc unwind label %.loopexit.split-lp340
...
_ZNK8NArchive3N7z7CFolder13GetUnpackSizeEv.exit:  ; preds = %_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit.thread.i, %bb.n
  ...
  invoke void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %5)
          to label %bb.q unwind label %.loopexit339
...
bb.q:                                             ; preds = %_ZNK8NArchive3N7z7CFolder13GetUnpackSizeEv.exit
  ...
  invoke void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %6)
          to label %bb.r unwind label %.loopexit339
...
bb.r:                                             ; preds = %bb.q
  ...
  invoke void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %7)
          to label %bb.s unwind label %.loopexit339
...
bb.s:                                             ; preds = %bb.r
  ...
  br i1 %i.do, label %bb.m, label %_ZN8NArchive3N7z10CInArchive6ReadIDEv.exit207, !llvm.loop !167

.loopexit339:                                     ; preds = %_ZNK8NArchive3N7z7CFolder13GetUnpackSizeEv.exit, %bb.q, %bb.r
  %lpad.loopexit341 = landingpad { ptr, i32 }
          cleanup
  br label %bb.cs

.loopexit.split-lp340:                            ; preds = %_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit._crit_edge.i
  %lpad.loopexit.split-lp342 = landingpad { ptr, i32 }
          cleanup
  br label %bb.cs

_ZN8NArchive3N7z10CInArchive6ReadIDEv.exit207:    ; preds = %bb.s, %.preheader337, %bb.j
  %.3 = phi i64 [ %i.bm, %bb.j ], [ %.2139, %.preheader337 ], [ %.2139, %bb.s ]
...
bb.v:                                             ; preds = %bb.t
  ...
  %i.dr = invoke noundef i64 @_ZN8NArchive3N7z8CInByte210ReadNumberEv(ptr noundef nonnull align 8 dereferenceable(24) %i.dq)
          to label %.noexc214 unwind label %bb.ae ; 3 uses
...
bb.w:                                             ; preds = %.noexc214
  invoke fastcc void @_ZN8NArchive3N7zL14ThrowExceptionEv()
          to label %.noexc215 unwind label %bb.ae
...
bb.x:                                             ; preds = %.noexc214
  ...
  invoke void @_ZN17CBaseRecordVector7ReserveEi(ptr noundef nonnull align 8 dereferenceable(32) %i.dp, i32 noundef %i.dt)
          to label %.preheader336 unwind label %bb.ae

.preheader336:                                    ; preds = %bb.x
  %.not371 = icmp eq i64 %i.dr, 0                 ; 6 uses
  br i1 %.not371, label %._crit_edge, label %.lr.ph349
...
bb.y:                                             ; preds = %.lr.ph349, %_ZN8NArchive3N7z9CFileItemD2Ev.exit
  %.0171348 = phi i32 [ 0, %.lr.ph349 ], [ %i.em, %_ZN8NArchive3N7z9CFileItemD2Ev.exit ]
...
bb.ad:                                            ; preds = %bb.aa
  ...
  br label %_ZN8NArchive3N7z9CFileItemD2Ev.exit219
...
_ZN8NArchive3N7z9CFileItemD2Ev.exit:              ; preds = %bb.ac
  ...
  %i.em = add nuw i32 %.0171348, 1                ; 2 uses
...
_ZN8NArchive3N7z9CFileItemD2Ev.exit219:           ; preds = %bb.ad, %bb.ag
  %eh.lpad-body = phi { ptr, i32 } [ %i.ep, %bb.ag ], [ %i.eg, %bb.ad ]
  call void @_ZdaPv(ptr noundef nonnull %i.dw) #19
  br label %bb.cs

._crit_edge:                                      ; preds = %_ZN8NArchive3N7z9CFileItemD2Ev.exit, %.preheader336
...
_ZN13CRecordVectorIyE3AddEy.exit223:              ; preds = %bb.ai
...
bb.ak:                                            ; preds = %_ZN13CRecordVectorIyE3AddEy.exit223, %bb.ah
  %i.fi = getelementptr inbounds nuw i8, ptr %7, i64 12
  %i.fj = load i32, ptr %i.fi, align 4
  %i.fk = icmp eq i32 %i.fj, 0
  %or.cond = select i1 %.not371, i1 true, i1 %i.fk
  br i1 %or.cond, label %bb.am, label %bb.al

bb.al:                                            ; preds = %bb.ak
  invoke void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %i.er)
          to label %_ZN13CRecordVectorIyE3AddEy.exit225 unwind label %bb.aj

_ZN13CRecordVectorIyE3AddEy.exit225:              ; preds = %bb.al
...
bb.am:                                            ; preds = %_ZN13CRecordVectorIyE3AddEy.exit225, %bb.ak
...
.noexc228:                                        ; preds = %.noexc227
  br i1 %.not371, label %_ZN8NArchive3N7zL21BoolVector_Fill_FalseER13CRecordVectorIbEi.exit, label %.lr.ph.i226

.lr.ph.i226:                                      ; preds = %.noexc228
  %i.fs = getelementptr inbounds nuw i8, ptr %8, i64 16
  %i.ft = getelementptr inbounds nuw i8, ptr %8, i64 12 ; 2 uses
  br label %bb.an

bb.an:                                            ; preds = %.noexc229, %.lr.ph.i226
  %.06.i = phi i32 [ 0, %.lr.ph.i226 ], [ %i.fz, %.noexc229 ]
  invoke void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %8)
          to label %.noexc229 unwind label %.loopexit332

.noexc229:                                        ; preds = %bb.an
...
_ZN8NArchive3N7zL21BoolVector_Fill_FalseER13CRecordVectorIbEi.exit: ; preds = %.noexc229, %.noexc228
  ...
  %umax389 = call i32 @llvm.umax.i32(i32 %i.dt, i32 1)
  br label %bb.ao

bb.ao:                                            ; preds = %.backedge, %_ZN8NArchive3N7zL21BoolVector_Fill_FalseER13CRecordVectorIbEi.exit
  %.0166 = phi i32 [ 0, %_ZN8NArchive3N7zL21BoolVector_Fill_FalseER13CRecordVectorIbEi.exit ], [ %.3169301, %.backedge ] ; 26 uses
  ...
  %i.gx = invoke noundef i64 @_ZN8NArchive3N7z8CInByte210ReadNumberEv(ptr noundef nonnull align 8 dereferenceable(24) %i.gw)
          to label %_ZN8NArchive3N7z10CInArchive6ReadIDEv.exit231 unwind label %bb.ap ; 4 uses

_ZN8NArchive3N7z10CInArchive6ReadIDEv.exit231:    ; preds = %bb.ao
  %.not310 = icmp eq i64 %i.gx, 0
  br i1 %.not310, label %.preheader311, label %bb.aq

.loopexit332:                                     ; preds = %bb.an
  %lpad.loopexit334 = landingpad { ptr, i32 }
          cleanup
  br label %bb.cq

.loopexit.split-lp333:                            ; preds = %bb.am, %.noexc227
...
end_hunk_2
begin_hunk_3_@_ZN13CObjectVectorIN8NArchive3N7z7CFolderEE6DeleteEii:_ZNK17CBaseRecordVector22TestIndexAndCorrectNumEiRi.exit
...
bb.a:
  ...
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %0)
          to label %_ZN13CObjectVectorI7CBufferIhEED2Ev.exit unwind label %bb.b, !inline_history !190

bb.b:                                             ; preds = %bb.a
  %i.a = landingpad { ptr, i32 }
          catch ptr null
  %i.b = extractvalue { ptr, i32 } %i.a, 0
  tail call void @__clang_call_terminate(ptr %i.b) #20, !inline_history !190
  unreachable

_ZN13CObjectVectorI7CBufferIhEED2Ev.exit:         ; preds = %bb.a
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %0) #17, !inline_history !190
...
!179 = !{!157, !6, i64 480}
!180 = !{!157, !6, i64 481}
!181 = distinct !{!181, !19, !70, !71}
!182 = distinct !{!182, !73}
!183 = distinct !{!183, !19, !70}
!184 = !{!172, !17, i64 32}
!185 = !{!172, !17, i64 33}
!186 = !{!172, !5, i64 12}
!187 = !{!172, !31, i64 0}
!188 = !{!172, !17, i64 34}
!189 = distinct !{!189, !19}
!190 = !{ptr @_ZN13CObjectVectorI7CBufferIhEED2Ev}
!191 = distinct !{!191, !19}
!192 = distinct !{!192, !19}
!193 = distinct !{!193, !19}
!194 = distinct !{!194, !19}
