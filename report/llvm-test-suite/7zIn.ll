...
begin_hunk_0_@_ZN8NArchive3N7z18CArchiveDatabaseEx25FillFolderStartPackStreamEv:bb.a
  ...
  br i1 %i.w, label %bb.b, label %._crit_edge, !llvm.loop !190
}
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  br i1 %i.t, label %bb.b, label %._crit_edge, !llvm.loop !191
}
...
bb.b:                                             ; preds = %.lr.ph34, %bb.g
  ...
  %i.s = load i8, ptr %i.r, align 8, !tbaa !183, !range !23, !noundef !24
...
bb.e:                                             ; preds = %.lr.ph
  ...
  br i1 %.not, label %.lr.ph, label %.preheader._crit_edge, !llvm.loop !192
...
bb.g:                                             ; preds = %.loopexit, %bb.f, %bb.c
  ...
  br i1 %i.be, label %bb.b, label %._crit_edge35, !llvm.loop !193
}
...
bb.a:
  ...
  store i64 %i.k, ptr %i.m, align 8, !tbaa !194
  ...
  store i8 %i.q, ptr %i.r, align 1, !tbaa !195
