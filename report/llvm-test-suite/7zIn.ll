...
.invoke:                                          ; preds = %bb.as, %bb.bz, %bb.ca, %bb.cb
  %.pn = phi i64 [ 320, %bb.cb ], [ 256, %bb.ca ], [ 192, %bb.bz ], [ 384, %bb.as ]
  %14 = getelementptr inbounds nuw i8, ptr %1, i64 %.pn
  invoke void @_ZN8NArchive3N7z10CInArchive19ReadUInt64DefVectorERK13CObjectVectorI7CBufferIhEERNS0_16CUInt64DefVectorEi(ptr noundef nonnull align 8 dereferenceable(96) %0, ptr noundef nonnull align 8 dereferenceable(32) %4, ptr noundef nonnull align 8 dereferenceable(64) %14, i32 noundef %i.dt)
