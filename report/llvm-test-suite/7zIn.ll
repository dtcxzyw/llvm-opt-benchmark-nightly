...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.c
  %.02729 = phi i64 [ %i.o, %bb.c ], [ 0, %.lr.ph.preheader ] ; 3 uses
...
_ZN8NArchive3N7z10CInArchive10ReadNumberEv.exit:  ; preds = %bb.aq
  ...
  %i.hd = load i64, ptr %i.hc, align 8, !tbaa !55 ; 5 uses
...
.lr.ph350:                                        ; preds = %.preheader326
  ...
  %14 = call i64 @llvm.usub.sat.i64(i64 %i.hi, i64 %i.hd)
  br label %bb.cd
...
bb.cd:                                            ; preds = %.lr.ph350, %bb.cc
  %i.on = phi i64 [ %i.hd, %.lr.ph350 ], [ %i.op, %bb.cc ] ; 2 uses
  %.0140349 = phi i64 [ 0, %.lr.ph350 ], [ %i.om, %bb.cc ] ; 2 uses
  %exitcond385.not = icmp eq i64 %.0140349, %14
  br i1 %exitcond385.not, label %.invoke433.a, label %bb.ce
