...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %3 = load double, ptr %i.al, align 8, !tbaa !23, !alias.scope !122
  ...
  %4 = add nsw i64 %n.vec, %i.am
  %i.ar = fmul double %3, 2.000000e+00
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph69, %middle.block
  %indvars.iv71.ph = phi i64 [ %i.am, %vector.memcheck ], [ %i.am, %.lr.ph69 ], [ %4, %middle.block ] ; 7 uses
