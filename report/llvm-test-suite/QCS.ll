...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %3 = load double, ptr %i.ak, align 8, !tbaa !22, !alias.scope !122
  %broadcast.splatinsert87 = insertelement <2 x double> poison, double %3, i64 0
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.cd = getelementptr inbounds [16 x i8], ptr %i.p, i64 %i.cc
  %i.ce = sext i32 %i.bu to i64                   ; 2 uses
  %i.cf = getelementptr inbounds [16 x i8], ptr %i.p, i64 %i.ce
  %i.cg = load <2 x double>, ptr %i.cd, align 8, !tbaa !60, !noalias !131
  %i.ch = load <2 x double>, ptr %i.cf, align 8, !tbaa !60, !noalias !131
  %i.ci = fsub <2 x double> %i.cg, %i.ch          ; 2 uses
  %i.cj = getelementptr inbounds [16 x i8], ptr %i.r, i64 %i.cc
  %i.ck = getelementptr inbounds [16 x i8], ptr %i.r, i64 %i.ce
  %i.cl = load <2 x double>, ptr %i.cj, align 8, !tbaa !60, !noalias !134
  %i.cm = load <2 x double>, ptr %i.ck, align 8, !tbaa !60, !noalias !134
  %i.cn = fsub <2 x double> %i.cl, %i.cm          ; 2 uses
  %i.co = sext i32 %i.ca to i64
  %i.cp = getelementptr inbounds [8 x i8], ptr %i.x, i64 %i.co
  %i.cq = load double, ptr %i.cp, align 8, !tbaa !60 ; 2 uses
  %foldExtExtBinop = fmul <2 x double> %i.ci, %i.cn
  %i.cr = extractelement <2 x double> %foldExtExtBinop, i64 1
  %i.cs = extractelement <2 x double> %i.ci, i64 0
  %i.ct = extractelement <2 x double> %i.cn, i64 0
  %i.cu = tail call noundef double @llvm.fmuladd.f64(double %i.ct, double %i.cs, double %i.cr)
  %i.cv = fcmp ogt double %i.cq, 0.000000e+00
  %i.cw = tail call double @llvm.fabs.f64(double %i.cu)
  %i.cx = fdiv double %i.cw, %i.cq
  %i.cy = select i1 %i.cv, double %i.cx, double 0.000000e+00 ; 2 uses
  %i.cz = sext i32 %i.cb to i64
  %i.da = getelementptr inbounds [8 x i8], ptr %i.ab, i64 %i.cz ; 2 uses
  %i.db = load double, ptr %i.da, align 8, !tbaa !60 ; 2 uses
  %i.dc = fcmp olt double %i.db, %i.cy
  %.sroa.speculated = select i1 %i.dc, double %i.cy, double %i.db
  store double %.sroa.speculated, ptr %i.da, align 8, !tbaa !60
  %indvars.iv.next = add nsw i64 %indvars.iv, 1   ; 2 uses
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.dd = sub nsw i64 %indvars.iv71, %i.am
  %i.de = load double, ptr %i.ak, align 8, !tbaa !22
  %i.df = getelementptr inbounds [8 x i8], ptr %i.t, i64 %indvars.iv71
  %i.dg = load double, ptr %i.df, align 8, !tbaa !60
  %i.dh = load double, ptr %i.al, align 8, !tbaa !23
  %i.di = fmul double %i.dh, 2.000000e+00
  %i.dj = getelementptr inbounds [8 x i8], ptr %i.ab, i64 %i.dd
  %i.dk = load double, ptr %i.dj, align 8, !tbaa !60
  %i.dl = fmul double %i.di, %i.dk
  %i.dm = tail call double @llvm.fmuladd.f64(double %i.de, double %i.dg, double %i.dl)
  %i.dn = getelementptr inbounds [8 x i8], ptr %i.v, i64 %indvars.iv71
  store double %i.dm, ptr %i.dn, align 8, !tbaa !60
  %indvars.iv.next72 = add nsw i64 %indvars.iv71, 1 ; 3 uses
  %i.do = sub nsw i64 %indvars.iv.next72, %i.am
  %i.dp = load double, ptr %i.ak, align 8, !tbaa !22
  %i.dq = getelementptr inbounds [8 x i8], ptr %i.t, i64 %indvars.iv.next72
  %i.dr = load double, ptr %i.dq, align 8, !tbaa !60
  %i.ds = load double, ptr %i.al, align 8, !tbaa !23
  %i.dt = fmul double %i.ds, 2.000000e+00
  %i.du = getelementptr inbounds [8 x i8], ptr %i.ab, i64 %i.do
  %i.dv = load double, ptr %i.du, align 8, !tbaa !60
  %i.dw = fmul double %i.dt, %i.dv
  %i.dx = tail call double @llvm.fmuladd.f64(double %i.dp, double %i.dr, double %i.dw)
  %i.dy = getelementptr inbounds [8 x i8], ptr %i.v, i64 %indvars.iv.next72
  store double %i.dx, ptr %i.dy, align 8, !tbaa !60
