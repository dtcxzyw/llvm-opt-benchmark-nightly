...
bb.b:                                             ; preds = %bb.a
  ...
  %4 = load i8, ptr %3, align 1, !tbaa !8         ; 3 uses
  ...
  %i.ca = load i8, ptr %i.ax, align 1, !tbaa !8   ; 3 uses
  %7 = load i8, ptr %i.aw, align 1, !tbaa !8      ; 3 uses
  %8 = lshr i8 %i.ca, 6
  %9 = or disjoint i8 %i.ba, %6
  %i.cb = shl i8 %7, 2
  %i.cc = and i8 %i.cb, 4
  %10 = or disjoint i8 %8, %i.cc
  %i.cd = lshr i8 %4, 2
  %11 = lshr i8 %4, 5
  %12 = lshr i8 %i.ca, 3
  %i.ce = lshr i8 %7, 1
  %i.cf = lshr i8 %7, 4
  %13 = insertelement <8 x i8> poison, i8 %i.cf, i64 0
  %i.cg = insertelement <8 x i8> %13, i8 %i.ce, i64 1
  %i.ch = insertelement <8 x i8> %i.cg, i8 %10, i64 2
  %i.ci = insertelement <8 x i8> %i.ch, i8 %12, i64 3
  %14 = insertelement <8 x i8> %i.ci, i8 %i.ca, i64 4
  %15 = insertelement <8 x i8> %14, i8 %11, i64 5
  %16 = insertelement <8 x i8> %15, i8 %i.cd, i64 6
  %i.cj = insertelement <8 x i8> %16, i8 %9, i64 7
  ...
  %i.db = load i8, ptr %i.cu, align 1, !tbaa !8   ; 3 uses
  %i.dc = load i8, ptr %i.by, align 1, !tbaa !8   ; 3 uses
  %i.dd = shl i8 %i.dc, 2
  %i.de = and i8 %i.dd, 4
  %i.df = lshr i8 %i.db, 6
  ...
  %21 = insertelement <8 x i8> %i.dj, i8 %20, i64 2
  %22 = insertelement <8 x i8> %21, i8 %19, i64 3
  %23 = insertelement <8 x i8> %22, i8 %i.dg, i64 4
  %24 = insertelement <8 x i8> %23, i8 %18, i64 5
  %25 = insertelement <8 x i8> %24, i8 %i.db, i64 6
  %i.dk = insertelement <8 x i8> %25, i8 %17, i64 7
  ...
  %i.ev = getelementptr inbounds nuw i8, ptr %1, i64 21
  %i.ew = shl i8 %i.er, 1
  %i.ex = and i8 %i.ew, 62
  ...
  %i.fg = load i8, ptr %i.ez, align 1, !tbaa !8   ; 3 uses
  %i.fh = load i8, ptr %i.ev, align 1, !tbaa !8   ; 4 uses
  %i.fi = lshr i8 %i.fh, 7
  ...
  %30 = insertelement <8 x i8> %i.fr, i8 %29, i64 2
  %31 = insertelement <8 x i8> %30, i8 %28, i64 3
  %32 = insertelement <8 x i8> %31, i8 %i.fo, i64 4
  %33 = insertelement <8 x i8> %32, i8 %27, i64 5
  %34 = insertelement <8 x i8> %33, i8 %i.fg, i64 6
  %i.fs = insertelement <8 x i8> %34, i8 %26, i64 7
  ...
  %i.ho = getelementptr inbounds nuw i8, ptr %1, i64 28
  %i.hp = shl i8 %i.he, 1
  %i.hq = and i8 %i.hp, 62
  ...
  %i.hz = load i8, ptr %i.hs, align 1, !tbaa !8   ; 3 uses
  %i.ia = load i8, ptr %i.ho, align 1, !tbaa !8   ; 4 uses
  %i.ib = lshr i8 %i.ia, 7
  ...
  %39 = insertelement <8 x i8> %i.ik, i8 %38, i64 2
  %40 = insertelement <8 x i8> %39, i8 %37, i64 3
  %41 = insertelement <8 x i8> %40, i8 %i.ih, i64 4
  %42 = insertelement <8 x i8> %41, i8 %36, i64 5
  %43 = insertelement <8 x i8> %42, i8 %i.hz, i64 6
  %i.il = insertelement <8 x i8> %43, i8 %35, i64 7
