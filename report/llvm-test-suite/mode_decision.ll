...
begin_hunk_1_@submacroblock_mode_decision:bb.a
  ...
  %11 = getelementptr inbounds nuw i8, ptr %i.f, i64 4
...
begin_hunk_2_@submacroblock_mode_decision:bb.a
  ...
  %12 = extractelement <2 x i32> %i.aj, i64 0
  %13 = extractelement <2 x i32> %i.aj, i64 1
  br label %bb.d
...
bb.u:                                             ; preds = %bb.t
  store i32 %12, ptr %i.f, align 8, !tbaa !4
