...
begin_hunk_0_@initLinkCells:bb.a
  ...
  %i.j = load <2 x double>, ptr %i.d, align 8, !tbaa !8 ; 2 uses
  ...
  %i.n = fptosi <2 x double> %i.m to <2 x i32>    ; 3 uses
  %i.o = extractelement <2 x i32> %i.n, i64 0     ; 3 uses
  store i32 %i.o, ptr %i.a, align 8, !tbaa !4
  %i.p = sitofp <2 x i32> %i.n to <2 x double>
  %i.q = fdiv <2 x double> %i.j, %i.p             ; 3 uses
  %i.r = extractelement <2 x i32> %i.n, i64 1     ; 3 uses
  store i32 %i.r, ptr %i.i, align 4, !tbaa !4
  store <2 x double> %i.q, ptr %i.e, align 8, !tbaa !8
  %i.s = getelementptr inbounds nuw i8, ptr %i.a, i64 104
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 112
  %i.u = getelementptr inbounds nuw i8, ptr %i.a, i64 40
  %i.v = load <2 x double>, ptr %i.t, align 8, !tbaa !8
  store <2 x double> %i.v, ptr %i.u, align 8, !tbaa !8
  %i.w = load <2 x double>, ptr %i.g, align 8, !tbaa !8
  store <2 x double> %i.w, ptr %i.h, align 8, !tbaa !8
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 160
  %i.y = load double, ptr %i.x, align 8, !tbaa !8 ; 2 uses
  %i.z = fdiv double %i.y, %1
  %i.aa = fptosi double %i.z to i32               ; 4 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store i32 %i.aa, ptr %i.ab, align 8, !tbaa !4
  %i.ac = sitofp i32 %i.aa to double
  %i.ad = getelementptr inbounds nuw i8, ptr %i.a, i64 88
  %i.ae = insertelement <2 x double> <double poison, double 1.000000e+00>, double %i.y, i64 0
  %i.af = shufflevector <2 x double> %i.q, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %i.ag = insertelement <2 x double> %i.af, double %i.ac, i64 0
  %i.ah = fdiv <2 x double> %i.ae, %i.ag          ; 2 uses
  store <2 x double> %i.ah, ptr %i.ad, align 8, !tbaa !8
  %i.ai = shufflevector <2 x double> %i.q, <2 x double> %i.ah, <2 x i32> <i32 1, i32 2>
  %i.aj = fdiv <2 x double> splat (double 1.000000e+00), %i.ai
  store <2 x double> %i.aj, ptr %i.s, align 8, !tbaa !8
  %i.ak = mul i32 %i.r, %i.aa                     ; 2 uses
  %i.al = mul i32 %i.ak, %i.o                     ; 2 uses
  %i.am = getelementptr inbounds nuw i8, ptr %i.a, i64 12
  store i32 %i.al, ptr %i.am, align 4, !tbaa !10
  %i.an = add nsw i32 %i.o, 2
  %i.ao = add i32 %i.r, 2
  ...
  store i32 %i.as, ptr %i.at, align 8, !tbaa !14
  %i.au = add nsw i32 %i.as, %i.al                ; 4 uses
  ...
  %i.ay = tail call noalias noundef ptr @malloc(i64 noundef range(i64 -8589934592, 8589934589) %i.ax) #13 ; 2 uses
  %i.az = getelementptr inbounds nuw i8, ptr %i.a, i64 120
  store ptr %i.ay, ptr %i.az, align 8, !tbaa !16
...
.lr.ph.preheader:                                 ; preds = %bb.a
  ...
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.ay, i8 0, i64 %i.bc, i1 false), !tbaa !4
  br label %._crit_edge
...
bb.q:                                             ; preds = %bb.p
  %i.bl = load i32, ptr %i.a, align 4, !tbaa !10
  %i.bm = shl nsw i32 %.026, 1                    ; 2 uses
  %i.bn = load i32, ptr %i.bc, align 4, !tbaa !4  ; 2 uses
  %i.bo = mul nsw i32 %i.bn, %i.bm
  %i.bp = load i32, ptr %0, align 4, !tbaa !4
  %i.bq = add nsw i32 %i.bp, 2
  %reass.add71.i = add i32 %i.bi, %i.bm
  %reass.add72.i = add i32 %reass.add71.i, %i.bn
  %reass.mul73.i = mul i32 %i.bq, %reass.add72.i
  %i.br = add i32 %i.be, %i.bl
  %i.bs = add i32 %i.br, %i.bo
  %i.bt = add i32 %i.bs, %reass.mul73.i
  br label %getBoxFromTuple.exit

bb.r:                                             ; preds = %bb.p
  %i.bu = icmp eq i32 %.026, -1
  br i1 %i.bu, label %bb.s, label %bb.t

bb.s:                                             ; preds = %bb.r
  %i.bv = load i32, ptr %i.a, align 4, !tbaa !10
  %i.bw = shl nsw i32 %i.bj, 1                    ; 2 uses
  %i.bx = load i32, ptr %i.bc, align 4, !tbaa !4
  %i.by = mul nsw i32 %i.bx, %i.bw
  %i.bz = load i32, ptr %0, align 4, !tbaa !4
  %i.ca = add nsw i32 %i.bz, 2
  %reass.add69.i = add i32 %i.bh, %i.bw
  %reass.mul70.i = mul i32 %i.ca, %reass.add69.i
  %i.cb = add i32 %i.be, %i.bv
  %i.cc = add i32 %i.cb, %i.by
  %i.cd = add i32 %i.cc, %reass.mul70.i
  br label %getBoxFromTuple.exit

bb.t:                                             ; preds = %bb.r
  %i.ce = load i32, ptr %i.bc, align 4, !tbaa !4  ; 5 uses
  %i.cf = icmp eq i32 %.01428, %i.ce
  br i1 %i.cf, label %bb.u, label %bb.v

bb.u:                                             ; preds = %bb.t
  %i.cg = load i32, ptr %i.a, align 4, !tbaa !10
  %i.ch = mul i32 %i.bg, %i.bj
  %i.ci = load i32, ptr %0, align 4, !tbaa !4
  %i.cj = add nsw i32 %i.ci, 2
  %reass.add67.i = add i32 %i.bj, %.026
  %reass.mul68.i = mul i32 %i.cj, %reass.add67.i
  %i.ck = add i32 %i.be, %i.ch
  %i.cl = add i32 %i.ck, %i.cg
  %i.cm = add i32 %i.cl, %reass.mul68.i
  br label %getBoxFromTuple.exit
...
bb.w:                                             ; preds = %bb.v
  %i.cn = load i32, ptr %i.a, align 4, !tbaa !10
  %i.co = shl nsw i32 %i.bj, 1
  %i.cp = mul nsw i32 %i.co, %i.ce
  %i.cq = load i32, ptr %0, align 4, !tbaa !4
  %i.cr = add nsw i32 %i.cq, 2
  %i.cs = mul nsw i32 %i.cr, %.026
  %i.ct = add i32 %i.be, %i.cp
  %i.cu = add i32 %i.ct, %i.cn
  %i.cv = add i32 %i.cu, %i.cs
  br label %getBoxFromTuple.exit

bb.x:                                             ; preds = %bb.v
  %i.cw = load i32, ptr %0, align 4, !tbaa !4     ; 2 uses
  %i.cx = icmp eq i32 %.01530, %i.cw
  br i1 %i.cx, label %bb.y, label %bb.z

bb.y:                                             ; preds = %bb.x
  %i.cy = load i32, ptr %i.a, align 4, !tbaa !10
  %reass.add65.i = add i32 %i.bj, %.026
  %reass.mul66.i = mul i32 %i.ce, %reass.add65.i
  %i.cz = add i32 %reass.mul66.i, %.01428
...
bb.aa:                                            ; preds = %bb.z
  %i.db = load i32, ptr %i.a, align 4, !tbaa !10
  %i.dc = mul nsw i32 %i.ce, %.026
  %i.dd = add i32 %i.dc, %.01428
  %i.de = add i32 %i.dd, %i.db
  br label %getBoxFromTuple.exit

bb.ab:                                            ; preds = %bb.z
  %i.df = mul i32 %i.ce, %.026
  %reass.add.i = add i32 %i.df, %.01428
  %reass.mul.i = mul i32 %i.cw, %reass.add.i
  %i.dg = add i32 %reass.mul.i, %.01530
  br label %getBoxFromTuple.exit
