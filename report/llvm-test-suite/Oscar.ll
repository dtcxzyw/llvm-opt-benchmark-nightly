...
begin_hunk_0_@Oscar:bb.a
  ...
  store <2 x float> %i.ek, ptr getelementptr inbounds nuw (i8, ptr @e, i64 280), align 8, !tbaa !18
  %i.el = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 328), align 8, !tbaa !18 ; 2 uses
  %i.em = fadd <2 x float> %i.el, %i.ei
  %i.en = fmul <2 x float> %i.di, %i.em
  store <2 x float> %i.en, ptr getelementptr inbounds nuw (i8, ptr @e, i64 312), align 8, !tbaa !18
  %i.eo = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 360), align 8, !tbaa !18 ; 2 uses
  %i.ep = fadd <2 x float> %i.eo, %i.el
  %i.eq = fmul <2 x float> %i.di, %i.ep
  store <2 x float> %i.eq, ptr getelementptr inbounds nuw (i8, ptr @e, i64 344), align 8, !tbaa !18
  %i.er = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 392), align 8, !tbaa !18 ; 2 uses
  %i.es = fadd <2 x float> %i.er, %i.eo
  %i.et = fmul <2 x float> %i.di, %i.es
  store <2 x float> %i.et, ptr getelementptr inbounds nuw (i8, ptr @e, i64 376), align 8, !tbaa !18
  %i.eu = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 424), align 8, !tbaa !18 ; 2 uses
  %i.ev = fadd <2 x float> %i.eu, %i.er
  %i.ew = fmul <2 x float> %i.di, %i.ev
  store <2 x float> %i.ew, ptr getelementptr inbounds nuw (i8, ptr @e, i64 408), align 8, !tbaa !18
  %i.ex = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 456), align 8, !tbaa !18 ; 2 uses
  %i.ey = fadd <2 x float> %i.ex, %i.eu
  %i.ez = fmul <2 x float> %i.di, %i.ey
  store <2 x float> %i.ez, ptr getelementptr inbounds nuw (i8, ptr @e, i64 440), align 8, !tbaa !18
  %i.fa = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 488), align 8, !tbaa !18 ; 2 uses
  %i.fb = fadd <2 x float> %i.fa, %i.ex
  %i.fc = fmul <2 x float> %i.di, %i.fb
  store <2 x float> %i.fc, ptr getelementptr inbounds nuw (i8, ptr @e, i64 472), align 8, !tbaa !18
  %i.fd = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 520), align 8, !tbaa !18 ; 2 uses
  %i.fe = fadd <2 x float> %i.fd, %i.fa
  %i.ff = fmul <2 x float> %i.di, %i.fe
  store <2 x float> %i.ff, ptr getelementptr inbounds nuw (i8, ptr @e, i64 504), align 8, !tbaa !18
  %i.fg = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 552), align 8, !tbaa !18 ; 2 uses
  %i.fh = fadd <2 x float> %i.fg, %i.fd
  %i.fi = fmul <2 x float> %i.di, %i.fh
  store <2 x float> %i.fi, ptr getelementptr inbounds nuw (i8, ptr @e, i64 536), align 8, !tbaa !18
  %i.fj = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 584), align 8, !tbaa !18 ; 2 uses
  %i.fk = fadd <2 x float> %i.fj, %i.fg
  %i.fl = fmul <2 x float> %i.di, %i.fk
  store <2 x float> %i.fl, ptr getelementptr inbounds nuw (i8, ptr @e, i64 568), align 8, !tbaa !18
  %i.fm = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 616), align 8, !tbaa !18 ; 2 uses
  %i.fn = fadd <2 x float> %i.fm, %i.fj
  %i.fo = fmul <2 x float> %i.di, %i.fn
  store <2 x float> %i.fo, ptr getelementptr inbounds nuw (i8, ptr @e, i64 600), align 8, !tbaa !18
  %i.fp = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 648), align 8, !tbaa !18 ; 2 uses
  %i.fq = fadd <2 x float> %i.fp, %i.fm
  %i.fr = fmul <2 x float> %i.di, %i.fq
  store <2 x float> %i.fr, ptr getelementptr inbounds nuw (i8, ptr @e, i64 632), align 8, !tbaa !18
  %i.fs = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 680), align 8, !tbaa !18 ; 2 uses
  %i.ft = fadd <2 x float> %i.fs, %i.fp
  %i.fu = fmul <2 x float> %i.di, %i.ft
  store <2 x float> %i.fu, ptr getelementptr inbounds nuw (i8, ptr @e, i64 664), align 8, !tbaa !18
  %i.fv = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 712), align 8, !tbaa !18 ; 2 uses
  %i.fw = fadd <2 x float> %i.fv, %i.fs
  %i.fx = fmul <2 x float> %i.di, %i.fw
  store <2 x float> %i.fx, ptr getelementptr inbounds nuw (i8, ptr @e, i64 696), align 8, !tbaa !18
  %i.fy = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 744), align 8, !tbaa !18 ; 2 uses
  %i.fz = fadd <2 x float> %i.fy, %i.fv
  %i.ga = fmul <2 x float> %i.di, %i.fz
  store <2 x float> %i.ga, ptr getelementptr inbounds nuw (i8, ptr @e, i64 728), align 8, !tbaa !18
  %i.gb = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 776), align 8, !tbaa !18 ; 2 uses
  %i.gc = fadd <2 x float> %i.gb, %i.fy
  %i.gd = fmul <2 x float> %i.di, %i.gc
  store <2 x float> %i.gd, ptr getelementptr inbounds nuw (i8, ptr @e, i64 760), align 8, !tbaa !18
  %i.ge = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 808), align 8, !tbaa !18 ; 2 uses
  %i.gf = fadd <2 x float> %i.ge, %i.gb
  %i.gg = fmul <2 x float> %i.di, %i.gf
  store <2 x float> %i.gg, ptr getelementptr inbounds nuw (i8, ptr @e, i64 792), align 8, !tbaa !18
  %i.gh = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 840), align 8, !tbaa !18 ; 2 uses
  %i.gi = fadd <2 x float> %i.gh, %i.ge
  %i.gj = fmul <2 x float> %i.di, %i.gi
  store <2 x float> %i.gj, ptr getelementptr inbounds nuw (i8, ptr @e, i64 824), align 8, !tbaa !18
  %i.gk = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 872), align 8, !tbaa !18 ; 2 uses
  %i.gl = fadd <2 x float> %i.gk, %i.gh
  %i.gm = fmul <2 x float> %i.di, %i.gl
  store <2 x float> %i.gm, ptr getelementptr inbounds nuw (i8, ptr @e, i64 856), align 8, !tbaa !18
  %i.gn = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 904), align 8, !tbaa !18 ; 2 uses
  %i.go = fadd <2 x float> %i.gn, %i.gk
  %i.gp = fmul <2 x float> %i.di, %i.go
  store <2 x float> %i.gp, ptr getelementptr inbounds nuw (i8, ptr @e, i64 888), align 8, !tbaa !18
  %i.gq = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 936), align 8, !tbaa !18 ; 2 uses
  %i.gr = fadd <2 x float> %i.gq, %i.gn
  %i.gs = fmul <2 x float> %i.di, %i.gr
  store <2 x float> %i.gs, ptr getelementptr inbounds nuw (i8, ptr @e, i64 920), align 8, !tbaa !18
  %i.gt = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 968), align 8, !tbaa !18 ; 2 uses
  %i.gu = fadd <2 x float> %i.gt, %i.gq
  %i.gv = fmul <2 x float> %i.di, %i.gu
  store <2 x float> %i.gv, ptr getelementptr inbounds nuw (i8, ptr @e, i64 952), align 8, !tbaa !18
  %i.gw = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 1000), align 8, !tbaa !18 ; 2 uses
  %i.gx = fadd <2 x float> %i.gw, %i.gt
  %i.gy = fmul <2 x float> %i.di, %i.gx
  store <2 x float> %i.gy, ptr getelementptr inbounds nuw (i8, ptr @e, i64 984), align 8, !tbaa !18
  %i.gz = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @e, i64 1032), align 8, !tbaa !18
  %i.ha = fadd <2 x float> %i.gz, %i.gw
  %i.hb = fmul <2 x float> %i.di, %i.ha
  store <2 x float> %i.hb, ptr getelementptr inbounds nuw (i8, ptr @e, i64 1016), align 8, !tbaa !18
...
bb.d:                                             ; preds = %bb.d, %bb.c
  ...
  %i.hj = load <2 x float>, ptr %i.hf, align 8, !tbaa !18 ; 2 uses
  %i.hk = load <2 x float>, ptr %i.hg, align 8, !tbaa !18
  %i.hl = fadd <2 x float> %i.hj, %i.hk
  %i.hm = fmul <2 x float> %i.he, %i.hl
  store <2 x float> %i.hm, ptr %i.hi, align 8, !tbaa !18
  ...
  %i.hq = load <2 x float>, ptr %i.hn, align 8, !tbaa !18 ; 2 uses
  %i.hr = fadd <2 x float> %i.hq, %i.hj
  %i.hs = fmul <2 x float> %i.he, %i.hr
  store <2 x float> %i.hs, ptr %i.hp, align 8, !tbaa !18
  ...
  %i.hw = load <2 x float>, ptr %i.ht, align 8, !tbaa !18 ; 2 uses
  %i.hx = fadd <2 x float> %i.hw, %i.hq
  %i.hy = fmul <2 x float> %i.he, %i.hx
  store <2 x float> %i.hy, ptr %i.hv, align 8, !tbaa !18
  ...
  %i.ic = load <2 x float>, ptr %i.hz, align 8, !tbaa !18
  %i.id = fadd <2 x float> %i.ic, %i.hw
  %i.ie = fmul <2 x float> %i.he, %i.id
  store <2 x float> %i.ie, ptr %i.ib, align 8, !tbaa !18
...
.preheader16:                                     ; preds = %bb.e
  ...
  store i64 %i.if, ptr @seed, align 8, !tbaa !12
  %i.ig = extractelement <2 x float> %i.iu, i64 0
  store float %i.ig, ptr @zr, align 4, !tbaa !18
  %i.ih = extractelement <2 x float> %i.iu, i64 1
  store float %i.ih, ptr @zi, align 4, !tbaa !18
  br label %.preheader
...
bb.e:                                             ; preds = %Exptab.exit, %bb.e
  ...
  store <2 x float> %i.iv, ptr %i.ik, align 8, !tbaa !18
...
bb.g:                                             ; preds = %.loopexit, %bb.f
  ...
  %1 = load float, ptr %i.jf, align 4, !tbaa !16  ; 2 uses
  %2 = load float, ptr %0, align 8, !tbaa !15     ; 2 uses
...
vector.ph49:                                      ; preds = %vector.memcheck
  ...
  %broadcast.splatinsert50 = insertelement <4 x float> poison, float %1, i64 0
...
vector.body52:                                    ; preds = %vector.body52, %vector.ph49
  ...
  %wide.vec54 = load <8 x float>, ptr %i.kb, align 8, !tbaa !18 ; 3 uses
  ...
  %wide.vec57 = load <8 x float>, ptr %i.kc, align 8, !tbaa !18 ; 3 uses
  ...
  store <8 x float> %interleaved.vec60, ptr %i.kd, align 8, !tbaa !18
  ...
  store <8 x float> %interleaved.vec61, ptr %i.kj, align 8, !tbaa !18
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.kp = load <2 x float>, ptr %i.ko, align 8, !tbaa !18 ; 2 uses
  %i.kq = load <2 x float>, ptr %gep.i7, align 8, !tbaa !18 ; 2 uses
  %i.kr = fadd <2 x float> %i.kp, %i.kq
  store <2 x float> %i.kr, ptr %gep113.i, align 8, !tbaa !18
  ...
  store <2 x float> %i.kw, ptr %gep115.i, align 8, !tbaa !18
...
.loopexit:                                        ; preds = %scalar.ph, %middle.block63
  ...
  br i1 %.not.i9, label %.preheader95.i.preheader, label %bb.g, !llvm.loop !1
...
.preheader95.i.preheader:                         ; preds = %.loopexit
  ...
  br i1 %.not93.i, label %vector.body, label %bb.f, !llvm.loop !2
...
Printcomplex.exit:                                ; preds = %Fft.exit
  ...
  %i.li = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 8), align 8, !tbaa !15
  %i.lj = fpext float %i.li to double
  %i.lk = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 12), align 4, !tbaa !16
  ...
  %i.ln = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 144), align 16, !tbaa !15
  %i.lo = fpext float %i.ln to double
  %i.lp = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 148), align 4, !tbaa !16
  ...
  %i.ls = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 280), align 8, !tbaa !15
  %i.lt = fpext float %i.ls to double
  %i.lu = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 284), align 4, !tbaa !16
  ...
  %i.lx = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 416), align 16, !tbaa !15
  %i.ly = fpext float %i.lx to double
  %i.lz = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 420), align 4, !tbaa !16
  ...
  %i.mc = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 552), align 8, !tbaa !15
  %i.md = fpext float %i.mc to double
  %i.me = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 556), align 4, !tbaa !16
  ...
  %i.mh = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 688), align 16, !tbaa !15
  %i.mi = fpext float %i.mh to double
  %i.mj = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 692), align 4, !tbaa !16
  ...
  %i.mm = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 824), align 8, !tbaa !15
  %i.mn = fpext float %i.mm to double
  %i.mo = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 828), align 4, !tbaa !16
  ...
  %i.mr = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 960), align 16, !tbaa !15
  %i.ms = fpext float %i.mr to double
  %i.mt = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 964), align 4, !tbaa !16
  ...
  %i.mw = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 1096), align 8, !tbaa !15
  %i.mx = fpext float %i.mw to double
  %i.my = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 1100), align 4, !tbaa !16
  ...
  %i.nb = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 1232), align 16, !tbaa !15
  %i.nc = fpext float %i.nb to double
  %i.nd = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 1236), align 4, !tbaa !16
  ...
  %i.ng = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 1368), align 8, !tbaa !15
  %i.nh = fpext float %i.ng to double
  %i.ni = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 1372), align 4, !tbaa !16
  ...
  %i.nl = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 1504), align 16, !tbaa !15
  %i.nm = fpext float %i.nl to double
  %i.nn = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 1508), align 4, !tbaa !16
  ...
  %i.nq = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 1640), align 8, !tbaa !15
  %i.nr = fpext float %i.nq to double
  %i.ns = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 1644), align 4, !tbaa !16
  ...
  %i.nv = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 1776), align 16, !tbaa !15
  %i.nw = fpext float %i.nv to double
  %i.nx = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 1780), align 4, !tbaa !16
  ...
  %i.oa = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 1912), align 8, !tbaa !15
  %i.ob = fpext float %i.oa to double
  %i.oc = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 1916), align 4, !tbaa !16
  ...
  %i.of = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 2048), align 16, !tbaa !15
  %i.og = fpext float %i.of to double
  %i.oh = load float, ptr getelementptr inbounds nuw (i8, ptr @z, i64 2052), align 4, !tbaa !16
