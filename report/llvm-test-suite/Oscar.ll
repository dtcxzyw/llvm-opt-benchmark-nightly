...
vector.body219:                                   ; preds = %vector.body219, %vector.ph216
  ...
  %strided.vec222 = shufflevector <8 x float> %wide.vec221, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %strided.vec223 = shufflevector <8 x float> %wide.vec221, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %wide.vec224 = load <8 x float>, ptr %i.bc, align 4, !tbaa !16 ; 2 uses
  %strided.vec225 = shufflevector <8 x float> %wide.vec224, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %i.bt = shufflevector <8 x float> %wide.vec224, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %5 = fadd <4 x float> %strided.vec223, %i.bt
  %interleaved.vec = shufflevector <4 x float> %i.br, <4 x float> %5, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  ...
  %6 = fsub <4 x float> %strided.vec222, %strided.vec225
  ...
  %strided.vec231 = shufflevector <8 x float> %wide.vec230, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %i.bw = shufflevector <8 x float> %wide.vec230, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %7 = fsub <4 x float> %strided.vec229, %i.bw    ; 2 uses
  %i.bx = fneg <4 x float> %7
  %i.by = fmul <4 x float> %broadcast.splat, %i.bx
  %i.bz = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %broadcast.splat234, <4 x float> %6, <4 x float> %i.by)
  ...
  %8 = fsub <4 x float> %strided.vec228, %strided.vec231
  %i.cc = fmul <4 x float> %broadcast.splat, %8
  %i.cd = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %broadcast.splat236, <4 x float> %7, <4 x float> %i.cc)
...
vector.body56:                                    ; preds = %vector.body56, %vector.ph53
  ...
  %strided.vec59 = shufflevector <8 x float> %wide.vec58, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %strided.vec60 = shufflevector <8 x float> %wide.vec58, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  ...
  %strided.vec63 = shufflevector <8 x float> %wide.vec61, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  ...
  %1 = fsub <4 x float> %strided.vec59, %strided.vec62 ; 2 uses
  %2 = fsub <4 x float> %strided.vec60, %strided.vec63 ; 2 uses
  %i.kk = fneg <4 x float> %2
  %i.kl = fmul <4 x float> %broadcast.splat55, %i.kk
  %i.km = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %broadcast.splat, <4 x float> %1, <4 x float> %i.kl)
  %i.kn = getelementptr [8 x i8], ptr %invariant.gep114.i, i64 %i.kh
  %i.ko = fmul <4 x float> %1, %broadcast.splat55
  %i.kp = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %broadcast.splat, <4 x float> %2, <4 x float> %i.ko)
