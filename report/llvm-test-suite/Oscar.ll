...
bb.g:                                             ; preds = %.loopexit, %bb.f
  ...
  %indvars.iv99.i = phi i64 [ %indvars.iv.next100.i, %.loopexit ], [ %i.iy, %bb.f ] ; 6 uses
  %.085.i = phi i64 [ %indvars.iv99.i, %.loopexit ], [ 0, %bb.f ] ; 4 uses
  %.083.i = phi i64 [ %indvars.iv.next.i8.lcssa, %.loopexit ], [ 1, %bb.f ]
  ...
  %i.jj = ashr exact i64 %sext112.i, 32           ; 7 uses
  ...
  %smax45 = tail call i64 @llvm.smax.i64(i64 %indvars.iv99.i, i64 %i.jj)
...
begin_hunk_1_@Oscar:bb.a
  ...
  %smax = tail call i64 @llvm.smax.i64(i64 %indvars.iv99.i, i64 %i.jj) ; 2 uses
  %i.js = add i64 %.085.i, %smax
  ...
  %i.ju = shl nuw nsw i64 %smax, 3                ; 2 uses
...
vector.ph46:                                      ; preds = %vector.memcheck
  ...
  %i.jv = add i64 %i.jj, %n.vec                   ; 2 uses
...
begin_hunk_3_@Oscar:bb.a
  ...
  %indvars.iv.next.i8 = add nsw i64 %indvars.iv.i6, 1 ; 2 uses
  %.not.not.i = icmp slt i64 %indvars.iv.i6, %indvars.iv99.i
  br i1 %.not.not.i, label %scalar.ph, label %.loopexit, !llvm.loop !45

.loopexit:                                        ; preds = %scalar.ph, %middle.block61
  %indvars.iv.next.i8.lcssa = phi i64 [ %i.jv, %middle.block61 ], [ %indvars.iv.next.i8, %scalar.ph ]
