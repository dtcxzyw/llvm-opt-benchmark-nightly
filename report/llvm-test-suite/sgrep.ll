...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %store_forwarded = phi i32 [ %i.fm, %.lr.ph ], [ %load_initial, %.lr.ph.preheader ] ; 3 uses
  ...
  %i.fi = and i32 %i.fh, %store_forwarded         ; 3 uses
  ...
  %i.fm = and i32 %i.fl, %store_forwarded         ; 4 uses
