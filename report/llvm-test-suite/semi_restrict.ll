...
bb.w:                                             ; preds = %bb.u, %bb.v
  ...
  %i.jg = load i32, ptr %i.l, align 4, !tbaa !4   ; 2 uses
...
bb.y:                                             ; preds = %bb.w, %bb.x
  %i.jl = phi i32 [ %i.ji, %bb.x ], [ 0, %bb.w ]
  %i.jm = phi i32 [ %i.jk, %bb.x ], [ 0, %bb.w ]
  %i.jn = load i32, ptr %i.b, align 4, !tbaa !4   ; 5 uses
  %i.jo = load i32, ptr %i.au, align 4, !tbaa !4  ; 3 uses
...
.preheader381.us.us.preheader:                    ; preds = %.preheader382.lr.ph
  ...
  %min.iters.check = icmp ugt i32 %i.jn, 5
...
.preheader381.us.us:                              ; preds = %.preheader381.us.us.preheader, %._crit_edge395.split.us.us.us
  %.0321409.us.us = phi i32 [ %i.jb, %.preheader381.us.us.preheader ], [ %i.mb, %._crit_edge395.split.us.us.us ] ; 3 uses
  %.0324408.us.us = phi i32 [ %i.ig, %.preheader381.us.us.preheader ], [ %i.ma, %._crit_edge395.split.us.us.us ] ; 2 uses
  %.0330407.us.us = phi i32 [ %i.hh, %.preheader381.us.us.preheader ], [ %i.lz, %._crit_edge395.split.us.us.us ] ; 3 uses
  %.1345406.us.us = phi i32 [ 0, %.preheader381.us.us.preheader ], [ %i.ly, %._crit_edge395.split.us.us.us ]
  br label %.preheader.us.us.us

.preheader.us.us.us:                              ; preds = %._crit_edge.us.us.us, %.preheader381.us.us
  %.1322394.us.us.us = phi i32 [ %i.lx, %._crit_edge.us.us.us ], [ %.0321409.us.us, %.preheader381.us.us ] ; 2 uses
  %.1325393.us.us.us = phi i32 [ %i.lw, %._crit_edge.us.us.us ], [ %.0324408.us.us, %.preheader381.us.us ] ; 3 uses
  %.1331392.us.us.us = phi i32 [ %i.lv, %._crit_edge.us.us.us ], [ %.0330407.us.us, %.preheader381.us.us ] ; 2 uses
  %.1343391.us.us.us = phi i32 [ %i.lu, %._crit_edge.us.us.us ], [ 0, %.preheader381.us.us ] ; 3 uses
  %i.ke = sext i32 %.1331392.us.us.us to i64      ; 4 uses
  %i.kf = sext i32 %.1325393.us.us.us to i64      ; 4 uses
  %i.kg = sext i32 %.1322394.us.us.us to i64      ; 4 uses
  br i1 %or.cond491, label %vector.memcheck, label %scalar.ph.preheader

vector.memcheck:                                  ; preds = %.preheader.us.us.us
  %4 = mul i32 %i.jc, %.1343391.us.us.us
  %5 = add i32 %.0330407.us.us, %4
  %6 = sext i32 %5 to i64
  %i.kh = shl nsw i64 %6, 3                       ; 2 uses
  %i.ki = add i64 %i.kh, %.0333481
  %7 = mul i32 %i.jr, %.1343391.us.us.us
  %8 = add i32 %.0321409.us.us, %7
  %9 = sext i32 %8 to i64
  %i.kj = shl nsw i64 %9, 3                       ; 5 uses
  %10 = add i64 %i.gg, %i.kj
  %i.kk = add i64 %i.gf, %i.kh
  %11 = add i64 %i.gd, %i.kj
  %12 = sext i32 %.1325393.us.us.us to i64
  %13 = shl nsw i64 %12, 3                        ; 3 uses
  %i.kl = add i64 %i.gc, %13
  %14 = add i64 %i.gb, %i.kj
  %15 = add i64 %i.ga, %13
  %16 = add i64 %i.fx, %i.kj
  %i.km = add i64 %i.fw, %13
  %i.kn = add i64 %i.fs, %i.kj
  %i.ko = sub i64 %i.km, %i.kn
  %diff.check477 = icmp ugt i64 %i.ko, -16
  %17 = sub i64 %15, %16
  %diff.check490 = icmp ugt i64 %17, -16
  %conflict.rdx = or i1 %diff.check477, %diff.check490
  %i.kp = sub i64 %i.kl, %14
  %diff.check479 = icmp ugt i64 %i.kp, -16
  %conflict.rdx480 = or i1 %conflict.rdx, %diff.check479
  %18 = sub i64 %i.kk, %11
  %diff.check493 = icmp ugt i64 %18, -16
  %conflict.rdx494 = or i1 %conflict.rdx480, %diff.check493
  %i.kq = sub i64 %i.ki, %10
  %diff.check482 = icmp ugt i64 %i.kq, -16
  %conflict.rdx483 = or i1 %conflict.rdx494, %diff.check482
  br i1 %conflict.rdx483, label %scalar.ph.preheader, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %i.kr = add nsw i64 %n.vec, %i.kg
  %i.ks = add nsw i64 %n.vec, %i.kf
  %i.kt = add nsw i64 %n.vec, %i.ke
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %indvars.iv.next442 = add nsw i64 %indvars.iv441, %i.kb
...
._crit_edge.us.us.us:                             ; preds = %scalar.ph, %middle.block
  %i.lu = add nuw nsw i32 %.1343391.us.us.us, 1   ; 2 uses
  %i.lv = add i32 %.1331392.us.us.us, %i.jc
  %i.lw = add i32 %.1325393.us.us.us, %i.jl
  %i.lx = add i32 %.1322394.us.us.us, %i.jr
  %exitcond450.not = icmp eq i32 %i.lu, %i.jo
...
._crit_edge395.split.us.us.us:                    ; preds = %._crit_edge.us.us.us
  %i.ly = add nuw nsw i32 %.1345406.us.us, 1      ; 2 uses
  %i.lz = add i32 %.0330407.us.us, %i.jf
  %i.ma = add i32 %.0324408.us.us, %i.jx
  %i.mb = add i32 %.0321409.us.us, %i.ju
  %exitcond451.not = icmp eq i32 %i.ly, %i.jp
