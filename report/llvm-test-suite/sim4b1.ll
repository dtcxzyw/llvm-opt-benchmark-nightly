...
combine_msps.exit.thread:                         ; preds = %trim_small_repeated_msps.exit
  ...
  br i1 %i.jf, label %._crit_edge, label %bb.ax

.preheader:                                       ; preds = %combine_msps.exit
  %.not272.a = icmp eq i32 %i.jc, 0
  br i1 %.not272.a, label %._crit_edge, label %.lr.ph
...
._crit_edge:                                      ; preds = %.epil.preheader, %._crit_edge.loopexit.unr-lcssa, %combine_msps.exit.thread, %.preheader
  %.not272353 = phi i1 [ true, %.preheader ], [ true, %combine_msps.exit.thread ], [ false, %._crit_edge.loopexit.unr-lcssa ], [ false, %.epil.preheader ]
  %.0163.lcssa = phi i32 [ 0, %.preheader ], [ 0, %combine_msps.exit.thread ], [ %.1164.1, %._crit_edge.loopexit.unr-lcssa ], [ %.1164.epil, %.epil.preheader ] ; 3 uses
  %.0158.lcssa = phi i32 [ %2, %.preheader ], [ %2, %combine_msps.exit.thread ], [ %spec.select.1, %._crit_edge.loopexit.unr-lcssa ], [ %spec.select.epil, %.epil.preheader ] ; 2 uses
  ...
  br i1 %.not272353, label %._crit_edge250, label %.lr.ph249

.lr.ph249:                                        ; preds = %._crit_edge, %.lr.ph249
  %indvars.iv295 = phi i64 [ %indvars.iv.next296, %.lr.ph249 ], [ 0, %._crit_edge ] ; 2 uses
...
._crit_edge250:                                   ; preds = %.lr.ph249, %._crit_edge
  %.lcssa229 = phi i32 [ 0, %._crit_edge ], [ %i.kx, %.lr.ph249 ]
...
bb.aw:                                            ; preds = %bb.av, %._crit_edge262.thread
