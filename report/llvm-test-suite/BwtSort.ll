...
.lr.ph232:                                        ; preds = %._crit_edge229.us, %.lr.ph232._crit_edge
  %.9231 = phi i32 [ %i.ke, %.lr.ph232._crit_edge ], [ 0, %._crit_edge229.us ] ; 3 uses
...
bb.q:                                             ; preds = %.lr.ph232
  %3 = add nuw i32 %.9231, 1
  %i.jw = zext i32 %3 to i64
