...
.lr.ph366.preheader:                              ; preds = %bb.b
  %.tr309356.lcssa771 = phi i32 [ %.tr309356, %bb.b ]
  %.tr309356.lcssa745 = phi i32 [ %.tr309356, %bb.b ]
  %.tr309356.lcssa720 = phi i32 [ %.tr309356, %bb.b ]
...
.lr.ph366.preheader.new:                          ; preds = %.lr.ph366.preheader
  ...
  %i.p = zext i32 %.tr309356.lcssa720 to i64
...
begin_hunk_2_@SortGroup:bb.a
  ...
  %i.bu = add i32 %.tr309356.lcssa745, 1
...
scalar.ph.preheader658:                           ; preds = %scalar.ph.prol.loopexit
  ...
  %i.ei = zext i32 %.tr309356.lcssa771 to i64
