...
.lr.ph.i52:                                       ; preds = %bb.o
  ...
  %min.iters.check90 = icmp ult i32 %i.dt, 32
  br i1 %min.iters.check90, label %scalar.ph89.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph.i52
  %i.eg = sub i64 %i.dw, %i.dz
  %diff.check = icmp ugt i64 %i.eg, -16
  %i.eh = add nsw i64 %i.ef, %i.ee
  %4 = shl nsw i64 %i.eh, 3
  %5 = add nsw i64 %4, -1
  %diff.check60 = icmp ult i64 %5, 15
  ...
  %i.em = sub i64 %i.dw, %i.el
  %diff.check61 = icmp ugt i64 %i.em, -16
  %conflict.rdx62 = or i1 %conflict.rdx, %diff.check61
  %i.en = add nsw i64 %i.ed, %i.ee
  %6 = shl nsw i64 %i.en, 3
  %diff.check63 = icmp ugt i64 %6, -16
