...
_ZNK12gjkepa2_impl13MinkowskiDiff8Support0ERK9btVector3.exit.i: ; preds = %bb.c, %bb.b
  ...
  %i.w = tail call { <2 x float>, <2 x float> } %i.v(ptr noundef nonnull align 8 dereferenceable(24) %i.o, ptr noundef nonnull align 4 dereferenceable(16) %2), !inline_history !77 ; 2 uses
...
begin_hunk_3_@_ZNK12gjkepa2_impl3GJK10getsupportERK9btVector3RNS0_3sSVE:bb.a
  ...
  %i.bw = call { <2 x float>, <2 x float> } %i.ak(ptr noundef nonnull align 8 dereferenceable(24) %i.ad, ptr noundef nonnull align 4 dereferenceable(16) %3), !inline_history !78 ; 2 uses
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !79   ; 19 uses
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  %i.au = add i32 %i.at, 1
  store i32 %i.au, ptr %i.as, align 8, !tbaa !80
  br label %.critedge
