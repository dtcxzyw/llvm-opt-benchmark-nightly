...
bb.a:
  ...
  %i.c = load float, ptr %3, align 4, !tbaa !24   ; 4 uses
  %6 = getelementptr inbounds nuw i8, ptr %0, i64 4 ; 3 uses
  %7 = getelementptr inbounds nuw i8, ptr %3, i64 4 ; 6 uses
  %8 = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 3 uses
  %9 = getelementptr inbounds nuw i8, ptr %3, i64 8 ; 6 uses
  %10 = getelementptr inbounds nuw i8, ptr %1, i64 4 ; 3 uses
  %i.d = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 3 uses
  %11 = getelementptr inbounds nuw i8, ptr %2, i64 4 ; 3 uses
  %i.e = getelementptr inbounds nuw i8, ptr %2, i64 8 ; 3 uses
  %12 = load float, ptr %i.e, align 4, !tbaa !24  ; 2 uses
  %i.f = load float, ptr %0, align 4, !tbaa !24   ; 3 uses
  %i.g = fsub float %i.f, %i.c                    ; 5 uses
  %13 = load float, ptr %6, align 4, !tbaa !24    ; 3 uses
  %i.h = load float, ptr %8, align 4, !tbaa !24   ; 3 uses
  %14 = load float, ptr %9, align 4, !tbaa !24    ; 4 uses
  %i.i = load float, ptr %7, align 4, !tbaa !24   ; 4 uses
  %i.j = fsub float %i.h, %14                     ; 5 uses
  %i.k = load float, ptr %1, align 4, !tbaa !24   ; 3 uses
  %i.l = fsub float %i.k, %i.c                    ; 5 uses
  %i.m = load float, ptr %10, align 4, !tbaa !24  ; 3 uses
  %i.n = fsub float %i.m, %i.i                    ; 5 uses
  %15 = load float, ptr %i.d, align 4, !tbaa !24  ; 3 uses
  %16 = fsub float %13, %i.i                      ; 5 uses
  %i.o = fsub float %15, %14                      ; 5 uses
  %17 = load float, ptr %11, align 4, !tbaa !24   ; 2 uses
  %18 = load float, ptr %2, align 4, !tbaa !24    ; 2 uses
  %19 = fsub float %18, %i.c                      ; 6 uses
  %i.p = fsub float %17, %i.i                     ; 6 uses
  %i.q = fmul float %16, %i.o
  %i.r = fmul float %i.j, %i.l
  %20 = fmul float %i.r, %i.p
  %21 = tail call float @llvm.fmuladd.f32(float %i.q, float %19, float %20)
  %i.s = fneg float %i.o
  %i.t = fmul float %i.g, %i.s                    ; 2 uses
  %22 = tail call float @llvm.fmuladd.f32(float %i.t, float %i.p, float %21)
  %i.u = fneg float %i.l
  %i.v = fmul float %i.g, %i.n
  %23 = fneg float %i.n
  %24 = fmul float %i.j, %23                      ; 2 uses
  %25 = fmul float %16, %i.u                      ; 2 uses
  %26 = fsub float %i.m, %17                      ; 2 uses
  %i.w = fsub float %i.k, %18                     ; 2 uses
  %27 = fsub float %15, %12                       ; 2 uses
  %28 = insertelement <4 x float> poison, float %12, i64 0
  %29 = insertelement <4 x float> %28, float %13, i64 1
  %30 = insertelement <4 x float> %29, float %i.h, i64 2
  %31 = insertelement <4 x float> %30, float %i.f, i64 3
  %32 = insertelement <4 x float> poison, float %14, i64 0
  %33 = insertelement <4 x float> %32, float %i.m, i64 1
  %34 = insertelement <4 x float> %33, float %15, i64 2
  %35 = insertelement <4 x float> %34, float %i.k, i64 3
  %36 = fsub <4 x float> %31, %35                 ; 6 uses
  %37 = extractelement <4 x float> %36, i64 2
  %38 = fneg float %37
  %39 = extractelement <4 x float> %36, i64 1
  %40 = fneg float %39
  %41 = extractelement <4 x float> %36, i64 3
  %42 = fneg float %41
  %43 = fmul float %26, %42
  %44 = fmul float %i.w, %38
  %45 = fmul float %27, %40
  %46 = insertelement <4 x float> poison, float %25, i64 0
  %47 = insertelement <4 x float> %46, float %i.w, i64 1
  %48 = insertelement <4 x float> %47, float %26, i64 2
  %49 = insertelement <4 x float> %48, float %27, i64 3
  %50 = insertelement <4 x float> poison, float %22, i64 0
  %51 = insertelement <4 x float> %50, float %43, i64 1
  %52 = insertelement <4 x float> %51, float %45, i64 2
  %53 = insertelement <4 x float> %52, float %44, i64 3
  %54 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %49, <4 x float> %36, <4 x float> %53) ; 4 uses
  %i.x = extractelement <4 x float> %54, i64 3
  %i.y = fmul float %13, %i.x
  %i.z = insertelement <2 x float> poison, float %i.f, i64 0
  %i.aa = insertelement <2 x float> %i.z, float %i.v, i64 1
  %55 = shufflevector <4 x float> %54, <4 x float> %36, <2 x i32> <i32 2, i32 4>
  %56 = insertelement <4 x float> poison, float %i.y, i64 0
  %57 = shufflevector <4 x float> %56, <4 x float> %54, <2 x i32> <i32 0, i32 4>
  %i.ab = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aa, <2 x float> %55, <2 x float> %57)
  %58 = insertelement <2 x float> poison, float %i.h, i64 0
  %i.ac = insertelement <2 x float> %58, float %24, i64 1
  %i.ad = shufflevector <4 x float> %54, <4 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.ae = insertelement <2 x float> %i.ad, float %19, i64 1
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.an = tail call float @llvm.fmuladd.f32(float %16, float %i.o, float %24)
  %i.ao = tail call float @llvm.fmuladd.f32(float %i.j, float %i.l, float %i.t)
  %i.ap = tail call float @llvm.fmuladd.f32(float %i.g, float %i.n, float %25)
  %i.aq = fmul float %i.i, %i.ao
  %i.ar = tail call float @llvm.fmuladd.f32(float %i.c, float %i.an, float %i.aq)
  %i.as = tail call noundef float @llvm.fmuladd.f32(float %14, float %i.ap, float %i.ar)
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %59 = extractelement <4 x float> %36, i64 0     ; 4 uses
  %i.bg = call float @llvm.fmuladd.f32(float %i.n, float %59, float %i.bf)
  %i.bh = fneg float %59
  %i.bi = fmul float %i.l, %i.bh
  %i.bj = call float @llvm.fmuladd.f32(float %i.o, float %19, float %i.bi)
  %i.bk = fneg float %19
  %i.bl = fmul float %i.n, %i.bk
  %i.bm = call float @llvm.fmuladd.f32(float %i.l, float %i.p, float %i.bl)
  %i.bn = load float, ptr %3, align 4, !tbaa !24
  %i.bo = load float, ptr %7, align 4, !tbaa !24
...
bb.g:                                             ; preds = %bb.f, %bb.e, %bb.d
  ...
  %i.ck = fneg float %16
  %i.cl = fmul float %59, %i.ck
  %i.cm = call float @llvm.fmuladd.f32(float %i.p, float %i.j, float %i.cl)
  %i.cn = fneg float %i.j
  %i.co = fmul float %19, %i.cn
  %i.cp = call float @llvm.fmuladd.f32(float %59, float %i.g, float %i.co)
  %i.cq = fneg float %i.g
  %i.cr = fmul float %i.p, %i.cq
  %i.cs = call float @llvm.fmuladd.f32(float %19, float %16, float %i.cr)
  %i.ct = load float, ptr %3, align 4, !tbaa !24
  %i.cu = load float, ptr %7, align 4, !tbaa !24
  %i.cv = fmul float %i.cu, %i.cp
  %i.cw = call float @llvm.fmuladd.f32(float %i.ct, float %i.cm, float %i.cv)
  %i.cx = load float, ptr %9, align 4, !tbaa !24
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.ds = load float, ptr %11, align 4, !tbaa !24 ; 2 uses
  %i.dt = load float, ptr %i.d, align 4, !tbaa !24 ; 2 uses
  %i.du = fmul float %i.ds, %i.dt
  %i.dv = load float, ptr %3, align 4, !tbaa !24  ; 2 uses
  %i.dw = load float, ptr %i.e, align 4, !tbaa !24 ; 2 uses
  %i.dx = load float, ptr %1, align 4, !tbaa !24  ; 2 uses
  %i.dy = fmul float %i.dw, %i.dx
  %i.dz = load float, ptr %7, align 4, !tbaa !24  ; 2 uses
  ...
  %i.er = load float, ptr %6, align 4, !tbaa !24  ; 2 uses
  %i.es = load float, ptr %i.e, align 4, !tbaa !24 ; 2 uses
  %i.et = fmul float %i.er, %i.es
  %i.eu = load float, ptr %3, align 4, !tbaa !24  ; 2 uses
  %i.ev = load float, ptr %8, align 4, !tbaa !24  ; 2 uses
  %i.ew = load float, ptr %2, align 4, !tbaa !24  ; 2 uses
  %i.ex = fmul float %i.ev, %i.ew
  %i.ey = load float, ptr %7, align 4, !tbaa !24  ; 2 uses
  ...
  %i.fr = load float, ptr %10, align 4, !tbaa !24 ; 2 uses
  %i.fs = load float, ptr %8, align 4, !tbaa !24  ; 2 uses
  %i.ft = fmul float %i.fr, %i.fs
  %i.fu = load float, ptr %3, align 4, !tbaa !24  ; 2 uses
  %i.fv = load float, ptr %i.d, align 4, !tbaa !24 ; 2 uses
  %i.fw = load float, ptr %0, align 4, !tbaa !24  ; 2 uses
  %i.fx = fmul float %i.fv, %i.fw
  %i.fy = load float, ptr %7, align 4, !tbaa !24  ; 2 uses
