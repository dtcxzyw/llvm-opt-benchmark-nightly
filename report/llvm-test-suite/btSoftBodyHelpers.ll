...
.lr.ph.preheader:                                 ; preds = %bb.a
  ...
  %14 = insertelement <2 x float> %13, float %i.t, i64 1
  %i.u = insertelement <2 x float> poison, float %10, i64 0
  %i.v = insertelement <2 x float> %i.u, float %i.r, i64 1 ; 2 uses
  %i.w = fsub <2 x float> %14, %i.v
  %i.x = add nsw i32 %5, -1
...
.lr.ph.preheader:                                 ; preds = %bb.a
  ...
  %15 = insertelement <2 x float> %14, float %i.t, i64 1
  %i.u = insertelement <2 x float> poison, float %11, i64 0
  %i.v = insertelement <2 x float> %i.u, float %i.r, i64 1 ; 2 uses
  %i.w = fsub <2 x float> %15, %i.v
  %i.x = add nsw i32 %5, -1
  %i.y = uitofp nneg i32 %i.x to float
  %i.z = zext nneg i32 %5 to i64                  ; 2 uses
