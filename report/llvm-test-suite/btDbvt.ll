...
.lr.ph.i.i:                                       ; preds = %_ZN20btAlignedObjectArrayIPK10btDbvtNodeE8allocateEi.exit.i
  ...
  br i1 %or.cond75, label %scalar.ph.preheader, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load73 = load <2 x ptr>, ptr %i.t, align 8, !tbaa !34
  %i.u = getelementptr inbounds nuw i8, ptr %i.r, i64 16
  store <2 x ptr> %wide.load, ptr %i.r, align 8, !tbaa !34
  store <2 x ptr> %wide.load73, ptr %i.u, align 8, !tbaa !34
...
_ZNK20btAlignedObjectArrayIPK10btDbvtNodeE4copyEiiPS2_.exit.thread.i: ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  ...
  %.old69 = trunc nuw i8 %.old to i1
  br i1 %.old69, label %bb.c, label %_ZN20btAlignedObjectArrayIPK10btDbvtNodeE10deallocateEv.exit.i
...
bb.o:                                             ; preds = %_ZNK20btAlignedObjectArrayIPK10btDbvtNodeE16findLinearSearchERKS2_.exit
  ...
  invoke void %i.cf(ptr noundef nonnull align 8 dereferenceable(8) %1, ptr noundef nonnull %i.be, i32 noundef %i.cg, i32 noundef %.0)
