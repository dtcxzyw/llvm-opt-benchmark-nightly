...
bb.d:                                             ; preds = %.preheader, %bb.d
  ...
  %5 = getelementptr inbounds nuw i8, ptr %i.o, i64 16
  %6 = getelementptr inbounds nuw i8, ptr %i.o, i64 8
  %7 = load float, ptr %6, align 4, !tbaa !42
  %8 = getelementptr inbounds nuw i8, ptr %i.o, i64 24
  %9 = load float, ptr %8, align 4, !tbaa !42
  %10 = load <2 x float>, ptr %i.o, align 4, !tbaa !42
  %11 = load <2 x float>, ptr %5, align 4, !tbaa !42
  %12 = fadd <2 x float> %10, %11
  %13 = fsub <2 x float> %i.i, %12
  %14 = tail call <2 x float> @llvm.fabs.v2f32(<2 x float> %13) ; 2 uses
  %15 = insertelement <2 x float> poison, float %i.t, i64 0
  %16 = insertelement <2 x float> %15, float %7, i64 1
  %17 = insertelement <2 x float> poison, float %i.v, i64 0
  %18 = insertelement <2 x float> %17, float %9, i64 1
  %i.ab = fadd <2 x float> %16, %18
  %i.ac = fsub <2 x float> %4, %i.ab
  %19 = shufflevector <2 x float> %i.aa, <2 x float> %14, <2 x i32> <i32 0, i32 2>
  %20 = shufflevector <2 x float> %i.aa, <2 x float> %14, <2 x i32> <i32 1, i32 3>
  %foldExtExtBinop57 = fadd <2 x float> %19, %20
  %21 = tail call <2 x float> @llvm.fabs.v2f32(<2 x float> %i.ac)
  %22 = fadd <2 x float> %foldExtExtBinop57, %21  ; 2 uses
  %23 = extractelement <2 x float> %22, i64 0
  %24 = extractelement <2 x float> %22, i64 1
  %i.ad = fcmp uge float %23, %24
