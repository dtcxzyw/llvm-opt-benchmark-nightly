begin_hunk_0_@_ZN8NArchive3N7z8CHandler7ExtractEPKjjiP23IArchiveExtractCallback:bb.a
  ...
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %5)
          to label %.thread339 unwind label %bb.ch, !inline_history !83

bb.ch:                                            ; preds = %bb.cg
  %i.ko = landingpad { ptr, i32 }
          catch ptr null
  %i.kp = extractvalue { ptr, i32 } %i.ko, 0
  call void @__clang_call_terminate(ptr %i.kp) #18, !inline_history !83
  unreachable

.thread339:                                       ; preds = %bb.cg
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %5) #14, !inline_history !83
...
bb.cm:                                            ; preds = %_ZN9CMyComPtrI23IArchiveExtractCallbackED2Ev.exit
  ...
  store ptr %i.le, ptr %i.lf, align 16, !tbaa !84
...
begin_hunk_2_@_ZN13CObjectVectorIN8NArchive3N7z18CExtractFolderInfoEE3AddERKS2_:bb.a
  ...
  %i.p = load i8, ptr %i.o, align 1, !tbaa !22, !range !86, !noundef !87
...
begin_hunk_3_@_ZN13CObjectVectorIN8NArchive3N7z18CExtractFolderInfoEE3AddERKS2_:bb.a
  ...
  br i1 %exitcond.not.i.i.i.i, label %.loopexit, label %bb.b, !llvm.loop !88
...
begin_hunk_4_@_ZN8NArchive3N7z8CDecoderD2Ev:bb.a
  ...
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %i.a)
          to label %_ZN13CObjectVectorI9CMyComPtrI8IUnknownEED2Ev.exit unwind label %bb.b, !inline_history !89

bb.b:                                             ; preds = %bb.a
  %i.b = landingpad { ptr, i32 }
          catch ptr null
  %i.c = extractvalue { ptr, i32 } %i.b, 0
  tail call void @__clang_call_terminate(ptr %i.c) #18, !inline_history !89
  unreachable

_ZN13CObjectVectorI9CMyComPtrI8IUnknownEED2Ev.exit: ; preds = %bb.a
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %i.a) #14, !inline_history !89
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void @__clang_call_terminate(ptr %i.b) #18, !inline_history !89
  unreachable

_ZN13CObjectVectorI9CMyComPtrI8IUnknownEED2Ev.exit: ; preds = %bb.a
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %0) #14, !inline_history !89
...
bb.b:                                             ; preds = %bb.a
  %i.o = load ptr, ptr %i.m, align 8, !tbaa !93   ; 3 uses
...
bb.e:                                             ; preds = %bb.a, %_ZN9CMyComPtrI8IUnknownED2Ev.exit
  ...
  br i1 %i.v, label %bb.a, label %._crit_edge, !llvm.loop !96
}
...
bb.a:
  ...
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %0)
          to label %_ZN13CObjectVectorIN8NArchive3N7z18CExtractFolderInfoEED2Ev.exit unwind label %bb.b, !inline_history !83

bb.b:                                             ; preds = %bb.a
  %i.a = landingpad { ptr, i32 }
          catch ptr null
  %i.b = extractvalue { ptr, i32 } %i.a, 0
  tail call void @__clang_call_terminate(ptr %i.b) #18, !inline_history !83
  unreachable

_ZN13CObjectVectorIN8NArchive3N7z18CExtractFolderInfoEED2Ev.exit: ; preds = %bb.a
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %0) #14, !inline_history !83
  tail call void @_ZdlPvm(ptr noundef nonnull %0, i64 noundef 32) #17
  ret void
}
end_hunk_8
...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  br i1 %i.p, label %bb.a, label %._crit_edge, !llvm.loop !97
}
...
!81 = !{!71, !78, i64 48}
!82 = distinct !{!82, !28}
!83 = !{ptr @_ZN13CObjectVectorIN8NArchive3N7z18CExtractFolderInfoEED2Ev}
!84 = !{!85, !85, i64 0}
!85 = !{!"p1 omnipotent char", !12, i64 0}
!86 = !{i8 0, i8 2}
!87 = !{}
!88 = distinct !{!88, !28}
!89 = !{ptr @_ZN13CObjectVectorI9CMyComPtrI8IUnknownEED2Ev}
!90 = !{!91, !92, i64 0}
!91 = !{!"_ZTS9CMyComPtrI15ICompressCoder2E", !92, i64 0}
!92 = !{!"p1 _ZTS15ICompressCoder2", !12, i64 0}
!93 = !{!94, !95, i64 0}
!94 = !{!"_ZTS9CMyComPtrI8IUnknownE", !95, i64 0}
!95 = !{!"p1 _ZTS8IUnknown", !12, i64 0}
!96 = distinct !{!96, !28}
!97 = distinct !{!97, !28}
end_hunk_10
