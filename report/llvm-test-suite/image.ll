begin_hunk_0
  ...
  %i.ss = shl nsw i64 %wide.trip.count100.i, 1    ; 2 uses
...
begin_hunk_1
  ...
  %scevgep469 = getelementptr i8, ptr %i.ta, i64 %i.ss
  %scevgep470 = getelementptr i8, ptr %i.tc, i64 %i.sr
  %scevgep471 = getelementptr i8, ptr %i.tc, i64 %i.ss
...
.ph:                                              ; preds = %.lver.check
  %scevgep473 = getelementptr i8, ptr %i.ta, i64 %i.sr
  %load_initial = load i16, ptr %scevgep473, align 2 ; 5 uses
  %scevgep474 = getelementptr i8, ptr %i.tc, i64 %i.sr
