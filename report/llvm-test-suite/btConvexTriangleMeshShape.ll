...
.preheader:
  ...
  %i.w = fsub <2 x float> %i.u, %i.v              ; 9 uses
  %i.x = shufflevector <2 x float> %i.w, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %4 = fsub float %i.c, %i.e                      ; 3 uses
  %i.y = load <2 x float>, ptr %i.f, align 4, !tbaa !26
  %i.z = fsub <2 x float> %i.y, %i.v              ; 10 uses
  %i.aa = fsub float %i.h, %i.e                   ; 4 uses
  %5 = load <2 x float>, ptr %i.i, align 4, !tbaa !26
  %6 = fsub <2 x float> %5, %i.v                  ; 7 uses
  %i.ab = fsub float %i.k, %i.e                   ; 4 uses
  %i.ac = extractelement <2 x float> %6, i64 1    ; 4 uses
  %i.ad = fneg float %i.ac
  %i.ae = extractelement <2 x float> %i.z, i64 1  ; 3 uses
  %i.af = extractelement <2 x float> %i.z, i64 0  ; 6 uses
  %i.ag = extractelement <2 x float> %6, i64 0    ; 10 uses
  %i.ah = extractelement <2 x float> %i.w, i64 1  ; 4 uses
  %i.ai = extractelement <2 x float> %i.w, i64 0  ; 7 uses
  %i.aj = fneg float %i.ab
  %i.ak = fneg float %i.ag
  %i.al = shufflevector <2 x float> %i.z, <2 x float> poison, <4 x i32> <i32 poison, i32 0, i32 1, i32 0> ; 2 uses
  ...
  %i.ar = shufflevector <2 x float> %i.z, <2 x float> %6, <4 x i32> <i32 1, i32 2, i32 3, i32 poison>
  %i.as = shufflevector <4 x float> %i.ar, <4 x float> %i.x, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %i.at = shufflevector <2 x float> %i.z, <2 x float> %i.w, <4 x i32> <i32 poison, i32 poison, i32 0, i32 2>
  ...
  %i.bc = tail call noundef float @llvm.fmuladd.f32(float %4, float %i.bb, float %i.ba)
  %i.bd = tail call noundef float @llvm.fabs.f32(float %i.bc)
  %i.be = fmul float %i.bd, f0xBE2AAAAB           ; 3 uses
  %7 = extractelement <4 x float> %i.aw, i64 3
  %8 = tail call float @llvm.fmuladd.f32(float %i.ag, float %i.ag, float %7)
  %foldExtExtBinop = fmul <2 x float> %i.w, %i.z
  %9 = extractelement <2 x float> %foldExtExtBinop, i64 0
  %i.bf = tail call float @llvm.fmuladd.f32(float %i.ai, float %i.af, float %9)
  %i.bg = tail call float @llvm.fmuladd.f32(float %i.ai, float %i.ag, float %i.bf)
  %i.bh = tail call float @llvm.fmuladd.f32(float %i.ai, float %i.ag, float %i.bg)
  %i.bi = tail call float @llvm.fmuladd.f32(float %i.af, float %i.ag, float %i.bh)
  %10 = tail call float @llvm.fmuladd.f32(float %i.af, float %i.ag, float %i.bi)
  %i.bj = fmul float %10, 5.000000e-02
  %i.bk = tail call float @llvm.fmuladd.f32(float %8, float 1.000000e-01, float %i.bj)
  %11 = fmul float %i.be, %i.bk                   ; 2 uses
  %i.bl = fmul float %i.ae, %i.af
  %12 = fmul float %i.ai, %i.ae
  %i.bm = tail call float @llvm.fmuladd.f32(float %i.ah, float %i.af, float %12)
  %i.bn = tail call float @llvm.fmuladd.f32(float %i.ah, float %i.ag, float %i.bm)
  %i.bo = tail call float @llvm.fmuladd.f32(float %i.ai, float %i.ac, float %i.bn)
  %i.bp = tail call float @llvm.fmuladd.f32(float %i.ae, float %i.ag, float %i.bo)
  %i.bq = tail call float @llvm.fmuladd.f32(float %i.af, float %i.ac, float %i.bp)
  ...
  %i.ca = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bz, <2 x float> %6, <2 x float> %i.bx)
  %i.cb = fmul <2 x float> %i.w, %i.bt
  %i.cc = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bw, <2 x float> %i.z, <2 x float> %i.cb)
  %i.cd = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bw, <2 x float> %6, <2 x float> %i.cc)
  %i.ce = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.w, <2 x float> %i.bz, <2 x float> %i.cd)
  %i.cf = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bt, <2 x float> %6, <2 x float> %i.ce)
  %i.cg = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.z, <2 x float> %i.bz, <2 x float> %i.cf)
  ...
  %i.cm = fneg float %11
  %13 = shufflevector <2 x float> %i.z, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %14 = insertelement <2 x float> %13, float %i.aa, i64 1 ; 6 uses
  %15 = fmul <2 x float> %14, %14
  %16 = shufflevector <2 x float> %i.w, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.cn = insertelement <2 x float> %16, float %4, i64 1 ; 6 uses
  %i.co = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cn, <2 x float> %i.cn, <2 x float> %15)
  %17 = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.cp = insertelement <2 x float> %17, float %i.ab, i64 1 ; 6 uses
  %18 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cp, <2 x float> %i.cp, <2 x float> %i.co)
  %i.cq = fmul <2 x float> %i.cn, %14
  %i.cr = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cn, <2 x float> %14, <2 x float> %i.cq)
  %i.cs = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cn, <2 x float> %i.cp, <2 x float> %i.cr)
  %i.ct = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cn, <2 x float> %i.cp, <2 x float> %i.cs)
  %i.cu = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> %i.cp, <2 x float> %i.ct)
  %i.cv = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> %i.cp, <2 x float> %i.cu)
  %i.cw = fmul <2 x float> %i.cv, splat (float 5.000000e-02)
  %i.cx = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %18, <2 x float> splat (float 1.000000e-01), <2 x float> %i.cw)
  %i.cy = fmul <2 x float> %i.ck, %i.cx           ; 3 uses
  %19 = fneg <2 x float> %i.cy                    ; 2 uses
  %i.cz = extractelement <2 x float> %19, i64 0
  %i.da = fsub float %i.cz, %11
  %20 = shufflevector <2 x float> %19, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %21 = fsub <2 x float> %20, %i.cy
  %i.db = extractelement <2 x float> %i.cl, i64 0
  %22 = fadd float %i.db, %i.o
  store float %22, ptr %i.n, align 8, !tbaa !26
  %23 = extractelement <2 x float> %i.cy, i64 1
  %24 = fsub float %i.cm, %23
  %i.dc = tail call float @llvm.fmuladd.f32(float %i.ah, float %i.ai, float %i.bl)
  %25 = tail call float @llvm.fmuladd.f32(float %i.ac, float %i.ag, float %i.dc)
  %26 = tail call float @llvm.fmuladd.f32(float %25, float 1.000000e-01, float %i.br)
  %i.dd = fmul float %i.be, %26                   ; 2 uses
  %i.de = insertelement <2 x float> %21, float %i.dd, i64 1
  ...
  %27 = insertelement <2 x float> %i.dg, float %24, i64 1
  %i.dh = fadd <2 x float> %27, %i.q
