...
bb.c:                                             ; preds = %bb.a
  ...
  %4 = load float, ptr %i.e, align 4, !tbaa !27   ; 2 uses
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 20
  %5 = load float, ptr %i.f, align 4, !tbaa !27   ; 4 uses
  %6 = fsub float %4, %5
  %i.g = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.h = getelementptr inbounds nuw i8, ptr %1, i64 24
  %7 = load float, ptr %i.h, align 4, !tbaa !27   ; 2 uses
  %8 = fsub float %7, %5                          ; 2 uses
  %i.i = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.j = getelementptr inbounds nuw i8, ptr %1, i64 40
  %9 = load float, ptr %i.j, align 4, !tbaa !27   ; 2 uses
  %10 = fsub float %9, %5                         ; 2 uses
  %11 = fneg float %10
  %12 = fadd float %4, %7
  %13 = fadd float %12, %9
  %14 = fadd float %5, %13
  %15 = getelementptr inbounds nuw i8, ptr %0, i64 28 ; 2 uses
  %16 = load <2 x float>, ptr %1, align 4, !tbaa !27 ; 3 uses
  %17 = load <2 x float>, ptr %i.d, align 4, !tbaa !27 ; 7 uses
  %foldExtExtBinop = fsub <2 x float> %16, %17
  %18 = extractelement <2 x float> %foldExtExtBinop, i64 0
  %foldExtExtBinop48 = fsub <2 x float> %16, %17
  %i.k = extractelement <2 x float> %foldExtExtBinop48, i64 1
  %19 = load <2 x float>, ptr %i.g, align 4, !tbaa !27 ; 3 uses
  %foldExtExtBinop50 = fsub <2 x float> %19, %17
  %i.l = extractelement <2 x float> %foldExtExtBinop50, i64 0 ; 2 uses
  %foldExtExtBinop52 = fsub <2 x float> %19, %17
  %20 = extractelement <2 x float> %foldExtExtBinop52, i64 1 ; 2 uses
  %21 = load <2 x float>, ptr %i.i, align 4, !tbaa !27 ; 3 uses
  %foldExtExtBinop54 = fsub <2 x float> %21, %17
  %22 = extractelement <2 x float> %foldExtExtBinop54, i64 0 ; 2 uses
  %foldExtExtBinop56 = fsub <2 x float> %21, %17
  %i.m = extractelement <2 x float> %foldExtExtBinop56, i64 1 ; 2 uses
  %i.n = fneg float %i.m
  %i.o = fmul float %8, %i.n
  %i.p = tail call float @llvm.fmuladd.f32(float %20, float %10, float %i.o)
  %i.q = fmul float %i.l, %11
  %i.r = tail call float @llvm.fmuladd.f32(float %8, float %22, float %i.q)
  %i.s = fmul float %i.k, %i.r
  %i.t = tail call float @llvm.fmuladd.f32(float %18, float %i.p, float %i.s)
  %i.u = fneg float %22
  %i.v = fmul float %20, %i.u
  %i.w = tail call float @llvm.fmuladd.f32(float %i.l, float %i.m, float %i.v)
  %i.x = tail call noundef float @llvm.fmuladd.f32(float %6, float %i.w, float %i.t)
  %i.y = tail call noundef float @llvm.fabs.f32(float %i.x) ; 2 uses
  %i.z = fmul float %i.y, 2.500000e-01            ; 2 uses
  %23 = fadd <2 x float> %16, %19
  %24 = fadd <2 x float> %23, %21
  %25 = fadd <2 x float> %17, %24
  %26 = insertelement <2 x float> poison, float %i.z, i64 0
  %27 = shufflevector <2 x float> %26, <2 x float> poison, <2 x i32> zeroinitializer
  %28 = fmul <2 x float> %25, %27
  %29 = fmul float %14, %i.z
  %30 = load <2 x float>, ptr %15, align 4, !tbaa !27
  %31 = fadd <2 x float> %30, %28
  store <2 x float> %31, ptr %15, align 4, !tbaa !27
  %32 = getelementptr inbounds nuw i8, ptr %0, i64 36 ; 2 uses
