...
bb.d:                                             ; preds = %bb.c
  %i.do = fmul float %i.dl, f0x38800000           ; 2 uses
  %i.dp = fmul float %i.dn, f0x38800000
  %7 = fmul float %i.do, %i.do                    ; 2 uses
  %8 = fsub float %i.dp, %7
  %9 = fdiv float %8, %7                          ; 8 uses
  ...
  %i.ey = fptrunc double %i.ex to float           ; 2 uses
  %10 = fmul float %i.ey, %i.ey
  %11 = fdiv float %i.eu, %10
  %i.ez = fsub float %11, %9
  %i.fa = fadd float %9, 1.000000e+00
  %i.fb = fmul float %9, %i.fa                    ; 6 uses
