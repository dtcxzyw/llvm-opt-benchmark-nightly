...
.preheader622:                                    ; preds = %.preheader624, %bb.c
  ...
  %.0611630 = phi float [ 0.000000e+00, %.preheader624 ], [ %18, %bb.c ]
  %.0612629 = phi float [ 0.000000e+00, %.preheader624 ], [ %20, %bb.c ]
...
bb.b:                                             ; preds = %bb.b, %.preheader622
  ...
  %.1627 = phi float [ %.0611630, %.preheader622 ], [ %18, %bb.b ]
  %.1613626 = phi float [ %.0612629, %.preheader622 ], [ %20, %bb.b ]
  %7 = getelementptr inbounds nuw [4 x i8], ptr %i.cq, i64 %indvars.iv
  %8 = load float, ptr %7, align 4, !tbaa !8      ; 3 uses
  %9 = fadd float %.1627, %8
  %10 = fmul float %8, %8
  %11 = fadd float %.1613626, %10
  ...
  %18 = fadd float %15, %i.cz                     ; 3 uses
  %19 = fmul float %i.cz, %i.cz
  %20 = fadd float %17, %19                       ; 3 uses
...
bb.d:                                             ; preds = %bb.c
  %i.da = fmul float %18, f0x38800000
  %i.db = fmul float %20, f0x38800000
