...
.lr.ph:                                           ; preds = %bb.d, %add_segments.exit47
  %.04255 = phi ptr [ %0, %add_segments.exit47 ], [ %i.c, %bb.d ] ; 4 uses
...
tailrecurse.outer.split.us.us.i:                  ; preds = %.split72.us.us.i, %.lr.ph
  ...
  %.tr.ph79.us.i = phi ptr [ %i.ai, %.split72.us.us.i ], [ %i.m, %.lr.ph ] ; 4 uses
...
add_segments.exit:                                ; preds = %tailrecurse.outer.split.us.us.i
  %0 = load ptr, ptr %i.t, align 8, !tbaa !21     ; 4 uses
...
begin_hunk_4_@construct_ch:bb.a
  ...
  store ptr %0, ptr %i.bn, align 8, !tbaa !21
...
.loopexit:                                        ; preds = %add_segments.exit47, %bb.d, %bb.c
  ...
  %.1 = phi ptr [ %i.c, %bb.c ], [ %i.c, %bb.d ], [ %0, %add_segments.exit47 ] ; 5 uses
