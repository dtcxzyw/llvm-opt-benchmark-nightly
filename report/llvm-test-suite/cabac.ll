...
bb.e:                                             ; preds = %.thread, %bb.d
  %.058.a = phi i32 [ 0, %.thread ], [ 1, %bb.d ] ; 3 uses
...
begin_hunk_2_@write_significance_map:bb.a
  ...
  %6 = zext nneg i32 %.058.a to i64
  %wide.trip.count76 = zext nneg i32 %.057 to i64
  br label %bb.i

bb.f:                                             ; preds = %.lr.ph, %bb.h
  %indvars.iv = phi i64 [ %5, %.lr.ph ], [ %indvars.iv.next, %bb.h ] ; 4 uses
...
bb.i:                                             ; preds = %.lr.ph69, %bb.k
  %indvars.iv73 = phi i64 [ %6, %.lr.ph69 ], [ %indvars.iv.next74, %bb.k ] ; 4 uses
