...
bb.h:                                             ; preds = %bb.h, %.preheader.i51
  ...
  %i.eo = bitcast double %i.el to i64             ; 8 uses
  %2 = lshr i64 %i.eo, 56
  %.sroa.0.6.extract.shift.i.i = lshr i64 %i.eo, 48
  %.sroa.0.5.extract.shift.i.i = lshr i64 %i.eo, 40
  %.sroa.0.4.extract.shift.i.i = lshr i64 %i.eo, 32
  %i.ep = lshr i64 %i.eo, 24
  %i.eq = lshr i64 %i.eo, 16
  %i.er = lshr i64 %i.eo, 8
  %3 = trunc nuw i64 %2 to i8
  %.sroa.0.6.extract.trunc.i.i = trunc i64 %.sroa.0.6.extract.shift.i.i to i8
  %.sroa.0.5.extract.trunc.i.i.a = trunc i64 %.sroa.0.5.extract.shift.i.i to i8
  %.sroa.0.4.extract.trunc.i.i = trunc i64 %.sroa.0.4.extract.shift.i.i to i8
  %i.es = trunc i64 %i.ep to i8
  %4 = trunc i64 %i.eq to i8
  %5 = insertelement <2 x i64> poison, i64 %i.eo, i64 0
  %6 = insertelement <2 x i64> %5, i64 %i.er, i64 1
  ...
  %i.et = insertelement <8 x i8> %8, i8 %4, i64 2
  %9 = insertelement <8 x i8> %i.et, i8 %i.es, i64 3
  %10 = insertelement <8 x i8> %9, i8 %.sroa.0.4.extract.trunc.i.i, i64 4
  %i.eu = insertelement <8 x i8> %10, i8 %.sroa.0.5.extract.trunc.i.i.a, i64 5
  %i.ev = insertelement <8 x i8> %i.eu, i8 %.sroa.0.6.extract.trunc.i.i, i64 6
  %i.ew = insertelement <8 x i8> %i.ev, i8 %3, i64 7
