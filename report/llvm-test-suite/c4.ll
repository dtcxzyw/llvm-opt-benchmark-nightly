...
bb.f:                                             ; preds = %bb.e
  %i.n = tail call i32 (i32, i32, i32, ...) @wins(i32 noundef 2, i32 noundef %i.l, i32 noundef %0) #6
...
bb.i:                                             ; preds = %bb.h
  %i.v = tail call i32 (i32, i32, i32, ...) @wins(i32 noundef 3, i32 noundef %i.t, i32 noundef %0) #6
...
bb.l:                                             ; preds = %bb.k
  %i.ad = tail call i32 (i32, i32, i32, ...) @wins(i32 noundef 4, i32 noundef %i.ab, i32 noundef %0) #6
...
bb.o:                                             ; preds = %bb.n
  %i.al = tail call i32 (i32, i32, i32, ...) @wins(i32 noundef 5, i32 noundef %i.aj, i32 noundef %0) #6
...
bb.r:                                             ; preds = %bb.q
  %i.at = tail call i32 (i32, i32, i32, ...) @wins(i32 noundef 6, i32 noundef %i.ar, i32 noundef %0) #6
...
bb.u:                                             ; preds = %bb.t
  %i.bb = tail call i32 (i32, i32, i32, ...) @wins(i32 noundef 7, i32 noundef %i.az, i32 noundef %0) #6
