...
bb.a:
  ...
  %.197.sroa.gep227 = getelementptr inbounds nuw i8, ptr %i.a, i64 4
...
bb.e:                                             ; preds = %bb.at, %bb.as, %bb.an, %bb.am, %bb.ah, %bb.ag, %bb.ab, %bb.aa, %bb.v, %bb.u, %bb.p, %bb.o, %bb.d, %bb.c
  ...
  %.lcssa174 = phi i64 [ 1, %bb.d ], [ 1, %bb.c ], [ 2, %bb.o ], [ 2, %bb.p ], [ 3, %bb.u ], [ 3, %bb.v ], [ 4, %bb.aa ], [ 4, %bb.ab ], [ 5, %bb.ag ], [ 5, %bb.ah ], [ 6, %bb.am ], [ 6, %bb.an ], [ 7, %bb.as ], [ 7, %bb.at ]
  %.lcssa174.a = phi i32 [ 1, %bb.d ], [ 1, %bb.c ], [ 2, %bb.o ], [ 2, %bb.p ], [ 3, %bb.u ], [ 3, %bb.v ], [ 4, %bb.aa ], [ 4, %bb.ab ], [ 5, %bb.ag ], [ 5, %bb.ah ], [ 6, %bb.am ], [ 6, %bb.an ], [ 7, %bb.as ], [ 7, %bb.at ] ; 2 uses
...
.lr.ph:                                           ; preds = %bb.g, %bb.j
  %indvars.iv = phi i64 [ %indvars.iv.next, %bb.j ], [ %.lcssa174, %bb.g ]
...
bb.n:                                             ; preds = %bb.l, %bb.m, %bb.b
  %.197.sroa.phi = phi ptr [ %i.a, %bb.l ], [ %.197.sroa.gep227, %bb.m ], [ %i.a, %bb.b ]
  %.197 = phi i32 [ 0, %bb.l ], [ 1, %bb.m ], [ 0, %bb.b ] ; 3 uses
...
bb.s:                                             ; preds = %bb.r, %bb.q
  ...
  store i32 2, ptr %.197.sroa.phi, align 4, !tbaa !4
  br label %bb.t
