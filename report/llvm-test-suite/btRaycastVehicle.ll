...
bb.a:
  ...
  %i.y = load float, ptr %i.j, align 8, !tbaa !49 ; 5 uses
  %i.z = load float, ptr %i.h, align 4, !tbaa !49 ; 5 uses
  %3 = insertelement <2 x float> poison, float %i.n, i64 0
  %i.aa = insertelement <2 x float> %3, float %i.s, i64 1
  %i.ab = insertelement <2 x float> poison, float %i.o, i64 0
  %i.ac = insertelement <2 x float> %i.ab, float %i.t, i64 1 ; 3 uses
  ...
  %i.ax = fmul float %i.ap, %i.av                 ; 2 uses
  ...
  %i.bp = fdiv <2 x float> %i.aa, %i.bo           ; 3 uses
  ...
  %i.bz = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ac, <2 x float> %i.ac, <2 x float> %i.by)
  ...
  %i.cq = fmul <2 x float> %i.ac, %i.cl           ; 4 uses
  ...
  %4 = insertelement <2 x float> %i.ad, float %i.ax, i64 1 ; 2 uses
  %5 = shufflevector <2 x float> %i.ex, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  ...
  %i.fs = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.fq, <2 x float> %i.fr, <2 x float> %6)
  ...
  %i.fw = shufflevector <2 x float> %i.ex, <2 x float> poison, <2 x i32> zeroinitializer
  %7 = fmul <2 x float> %4, %i.fw
  %8 = shufflevector <2 x float> %i.fa, <2 x float> poison, <2 x i32> zeroinitializer
  %i.fx = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.fq, <2 x float> %8, <2 x float> %7)
