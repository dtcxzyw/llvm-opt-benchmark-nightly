...
bb.a:
  ...
  %3 = shufflevector <2 x float> %i.cn, <2 x float> poison, <3 x i32> <i32 poison, i32 poison, i32 1>
  %4 = insertelement <3 x float> %3, float %i.co, i64 0
  %5 = insertelement <3 x float> %4, float %i.cp, i64 1
  %6 = shufflevector <2 x float> %i.cq, <2 x float> poison, <3 x i32> <i32 poison, i32 poison, i32 1>
  %7 = insertelement <3 x float> %6, float %i.cx, i64 0
  %8 = insertelement <3 x float> %7, float %i.cv, i64 1
  %9 = fadd <3 x float> %5, %8                    ; 6 uses
  ...
  %10 = extractelement <3 x float> %9, i64 1
  %i.dp = fmul float %i.ci, %10
  ...
  %11 = extractelement <3 x float> %9, i64 0
  %i.du = tail call float @llvm.fmuladd.f32(float %11, float %i.dc, float %i.dr)
  %12 = extractelement <3 x float> %9, i64 2
  %i.dv = tail call noundef float @llvm.fmuladd.f32(float %12, float %i.dh, float %i.ds) ; 2 uses
  ...
  %13 = shufflevector <3 x float> %9, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.eb = fmul <2 x float> %i.dy, %13
  ...
  %i.em = shufflevector <3 x float> %9, <3 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.eq = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> %i.ep, <2 x float> %i.ei) ; 3 uses
