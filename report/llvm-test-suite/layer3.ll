...
begin_hunk_0_@dct36:bb.a
  ...
  %i.kz = load double, ptr %i.r, align 8, !tbaa !8
  %5 = load double, ptr %i.f, align 8, !tbaa !8
  %i.la = load double, ptr %0, align 8, !tbaa !8
  %6 = load double, ptr %i.am, align 8, !tbaa !8
  %i.lb = load double, ptr %i.ap, align 8, !tbaa !8
  %7 = tail call double @llvm.fmuladd.f64(double %i.lb, double %i.bt, double %i.hr)
  %8 = tail call double @llvm.fmuladd.f64(double %i.kz, double %i.bo, double %7)
  %i.lc = insertelement <2 x double> poison, double %5, i64 0
  %i.ld = insertelement <2 x double> %i.lc, double %6, i64 1
  ...
  %i.lh = insertelement <2 x double> poison, double %8, i64 0
