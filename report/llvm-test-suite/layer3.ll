...
bb.br:                                            ; preds = %bb.bq, %III_antialias.exit
  ...
  %.070.i = phi i64 [ 2, %bb.bq ], [ 0, %III_antialias.exit ] ; 2 uses
  %.070.i.a = phi i32 [ 2, %bb.bq ], [ 0, %III_antialias.exit ] ; 3 uses
...
.preheader86.i:                                   ; preds = %bb.br
  br i1 %i.any, label %.lr.ph100.i, label %.preheader.i160.preheader

.lr.ph100.i:                                      ; preds = %.preheader86.i, %.lr.ph100.i
  %indvars.iv123.i = phi i64 [ %indvars.iv.next124.i, %.lr.ph100.i ], [ %.070.i, %.preheader86.i ] ; 2 uses
  %.199.i = phi ptr [ %i.aoh, %.lr.ph100.i ], [ %.069.i, %.preheader86.i ] ; 3 uses
  %.17697.i = phi ptr [ %i.aoi, %.lr.ph100.i ], [ %.075.i, %.preheader86.i ] ; 3 uses
  %.18196.i = phi ptr [ %i.aoj, %.lr.ph100.i ], [ %.080.i, %.preheader86.i ] ; 3 uses
...
bb.bs:                                            ; preds = %bb.bs, %.lr.ph.i163
  %indvars.iv.i164 = phi i64 [ %.070.i, %.lr.ph.i163 ], [ %indvars.iv.next.i165, %bb.bs ] ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %.not47 = icmp eq i32 %i.l, 0                   ; 2 uses
  %spec.select = select i1 %.not47, i64 1, i64 2
  %spec.select.a = select i1 %.not47, i64 12, i64 20
  br label %bb.c

bb.c:                                             ; preds = %bb.b, %bb.a
  %.038 = phi i64 [ 0, %bb.a ], [ %spec.select, %bb.b ]
  %.038.a = phi i64 [ 4, %bb.a ], [ %spec.select.a, %bb.b ]
  %i.m = getelementptr inbounds nuw [24 x i8], ptr @III_get_scale_factors_2.stab, i64 %.038
  %i.n = lshr i32 %.039, 12
  %i.o = and i32 %i.n, 7
...
.loopexit.3:                                      ; preds = %.lr.ph56.preheader.3, %.preheader.3, %._crit_edge.3
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %.3.3, i8 0, i64 %.038.a, i1 false), !tbaa !4
  ret i32 %.137.3
}
