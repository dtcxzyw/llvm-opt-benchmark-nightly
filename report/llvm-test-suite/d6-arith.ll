...
bb.a:
  ...
  %i.c = load ptr, ptr @stkptr, align 8, !tbaa !8 ; 16 uses
...
begin_hunk_4_@_Z8pushunopP9Classfile:bb.a
  ...
  store i32 %i.b, ptr %i.bi, align 8, !tbaa !14
...
begin_hunk_5_@_Z8pushunopP9Classfile:bb.a
  ...
  %i.bm = getelementptr inbounds nuw i8, ptr %i.c, i64 8 ; 2 uses
  store ptr %i.bm, ptr @stkptr, align 8, !tbaa !8
  store ptr %i.bf, ptr %i.c, align 8, !tbaa !12
  br label %bb.o

bb.o:                                             ; preds = %bb.n, %bb.a
  %1 = phi ptr [ %i.bm, %bb.n ], [ %i.c, %bb.a ]
...
bb.af:                                            ; preds = %bb.a, %bb.a, %bb.a, %bb.o, %bb.h, %bb.g, %bb.f, %bb.e, %bb.d, %bb.c, %bb.b
  %2 = phi ptr [ %i.c, %bb.b ], [ %1, %bb.o ], [ %i.c, %bb.c ], [ %i.c, %bb.d ], [ %i.c, %bb.e ], [ %i.c, %bb.f ], [ %i.c, %bb.g ], [ %i.c, %bb.h ], [ %i.c, %bb.a ], [ %i.c, %bb.a ], [ %i.c, %bb.a ]
...
begin_hunk_7_@_Z8pushunopP9Classfile:bb.a
  ...
  %i.en = getelementptr inbounds i8, ptr %2, i64 -8
