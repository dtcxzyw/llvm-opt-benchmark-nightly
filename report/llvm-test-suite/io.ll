...
begin_hunk_0_@readData_pointer:bb.a

; Function Attrs: nounwind uwtable
define dso_local void @readData(ptr nofree noundef captures(none) %0, ptr nofree noundef writeonly captures(none) %1, ptr nofree noundef writeonly captures(none) %2, ptr nofree noundef readonly captures(none) %3) local_unnamed_addr #14 {
bb.a:
  tail call void @rewind(ptr noundef %0)
  br label %.critedge.i

.critedge.i:                                      ; preds = %.critedge.i.backedge, %bb.a
  %.0.i = phi i32 [ 10, %bb.a ], [ %i.a, %.critedge.i.backedge ]
  %i.a = tail call i32 @getc(ptr noundef %0)      ; 3 uses
  switch i32 %i.a, label %.critedge.i.backedge [
    i32 -1, label %bb.b
    i32 62, label %bb.b
    i32 61, label %bb.b
  ]
...
define dso_local i32 @countATGC(ptr nofree noundef readonly captures(none) %0, ptr nofree noundef writeonly captures(none) %1) local_unnamed_addr #8 {
bb.a:
...
define dso_local double @countATGCbk(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #13 {
bb.a:
...
; Function Attrs: nofree nosync nounwind memory(read, inaccessiblemem: none, target_mem: none) uwtable
define dso_local i32 @countalpha(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #13 {
bb.a:
  %i.a = load i8, ptr %0, align 1, !tbaa !19      ; 2 uses
...
; Function Attrs: nounwind uwtable
define dso_local void @getnumlen_nogap(ptr nofree noundef captures(none) %0, ptr nofree noundef captures(none) %1) local_unnamed_addr #14 {
bb.a:
...
; Function Attrs: nounwind uwtable
define dso_local void @getnumlen(ptr nofree noundef captures(none) %0) local_unnamed_addr #14 {
bb.a:
  %i.a = tail call ptr @AllocateCharVec(i32 noundef 5000000) #32 ; 2 uses
  %i.b = tail call i32 @getc(ptr noundef %0)      ; 2 uses
  %.not11.i = icmp eq i32 %i.b, -1
...
define dso_local void @WriteGapFill(ptr nofree noundef captures(none) %0, i32 noundef %1, ptr noundef %2, ptr nofree noundef readnone captures(none) %3, ptr nofree noundef readonly captures(none) %4) local_unnamed_addr #0 {
bb.a:
  store i32 0, ptr @nlenmax, align 4, !tbaa !4
