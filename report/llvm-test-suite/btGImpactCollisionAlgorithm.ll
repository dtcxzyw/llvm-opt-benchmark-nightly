...
bb.c:                                             ; preds = %.lr.ph, %bb.k
  ...
  %i.eo = getelementptr inbounds i8, ptr %i.ek, i64 %i.en ; 5 uses
  %i.ep = load float, ptr %i.dp, align 8, !tbaa !56 ; 2 uses
  br i1 %i.ej, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  %11 = load float, ptr %i.dq, align 4, !tbaa !56
  %12 = load <2 x double>, ptr %i.eo, align 8, !tbaa !165
  %13 = insertelement <2 x float> poison, float %i.ep, i64 0
...
bb.e:                                             ; preds = %bb.c
  ...
  %18 = getelementptr inbounds nuw i8, ptr %i.eo, i64 4
  %19 = load float, ptr %i.dq, align 4, !tbaa !56
  %20 = fmul float %i.ep, %i.ew                   ; 2 uses
  store float %20, ptr %9, align 8, !tbaa !56
  %i.ex = load float, ptr %18, align 4, !tbaa !56
  %i.ey = fmul float %i.ex, %19                   ; 2 uses
  ...
  %22 = insertelement <2 x float> %21, float %i.ey, i64 1
  br label %_ZNK22btGImpactMeshShapePart9getVertexEiR9btVector3.exit

_ZNK22btGImpactMeshShapePart9getVertexEiR9btVector3.exit: ; preds = %bb.d, %bb.e
  %i.fd = phi float [ %i.ev, %bb.d ], [ %i.fc, %bb.e ] ; 2 uses
  %23 = phi <2 x float> [ %17, %bb.d ], [ %22, %bb.e ] ; 4 uses
  ...
  %i.fm = shufflevector <2 x float> %23, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.fp = insertelement <2 x float> poison, float %i.fd, i64 0
  ...
  %i.fw = fmul float %24, %i.fv
  %i.fx = call float @llvm.fmuladd.f32(float %i.fu, float %25, float %i.fw)
  %i.fy = load float, ptr %i.dx, align 8, !tbaa !56
  %i.fz = call noundef float @llvm.fmuladd.f32(float %i.fy, float %i.fd, float %i.fx)
