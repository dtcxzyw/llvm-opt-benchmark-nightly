...
.lr.ph101:                                        ; preds = %bb.a
  ...
  %10 = getelementptr inbounds nuw i8, ptr %7, i64 4 ; 2 uses
  ...
  %i.bh = insertelement <2 x float> %i.bg, float %.sroa.3287.48.copyload, i64 1 ; 2 uses
  ...
  %i.bm = shufflevector <2 x float> %i.i, <2 x float> %i.e, <2 x i32> <i32 0, i32 2> ; 2 uses
  %i.bn = shufflevector <2 x float> %i.i, <2 x float> %i.e, <2 x i32> <i32 1, i32 3> ; 2 uses
  %i.bo = shufflevector <2 x float> %i.t, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.bp = insertelement <2 x float> %i.bo, float %.sroa.3250.48.copyload, i64 1 ; 2 uses
  ...
  %i.bu = shufflevector <2 x float> %i.s, <2 x float> %i.o, <2 x i32> <i32 0, i32 2> ; 2 uses
  %i.bv = shufflevector <2 x float> %i.s, <2 x float> %i.o, <2 x i32> <i32 1, i32 3> ; 2 uses
  ...
  %i.by = insertelement <2 x float> %i.g, float %.sroa.2983.32.copyload, i64 0 ; 2 uses
  ...
  %i.ce = insertelement <2 x float> %i.q, float %.sroa.29.32.copyload, i64 0 ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph101, %.loopexit
  ...
  %i.df = load float, ptr %10, align 4, !tbaa !56 ; 2 uses
  %i.dg = load float, ptr %11, align 8, !tbaa !56 ; 2 uses
  ...
  store <2 x float> %.sroa.3.12.vec.insert.i.i, ptr %11, align 8, !tbaa !81
  %12 = load <4 x float>, ptr %i.ae, align 8
  %i.dv = load <4 x float>, ptr %i.af, align 4
  %13 = load <4 x float>, ptr %i.ag, align 8
  %i.dw = load <4 x float>, ptr %i.ah, align 8
  %i.dx = load <4 x float>, ptr %i.ai, align 4
  %i.dy = load <4 x float>, ptr %i.aj, align 8
  %i.dz = load float, ptr %8, align 8, !tbaa !56  ; 2 uses
  %i.ea = load float, ptr %i.ak, align 4, !tbaa !56 ; 2 uses
  %i.eb = load float, ptr %i.al, align 8, !tbaa !56 ; 2 uses
  ...
  %i.el = fadd <2 x float> %i.cc, %i.ek           ; 3 uses
  ...
  store <2 x float> %.sroa.3.12.vec.insert.i.i22, ptr %i.al, align 8, !tbaa !81
  %14 = load <4 x float>, ptr %i.am, align 8
  %15 = load <4 x float>, ptr %i.an, align 4
  %16 = load <4 x float>, ptr %i.ao, align 8
  %i.eq = load <4 x float>, ptr %i.ap, align 8
  %i.er = load <4 x float>, ptr %i.aq, align 4
  %i.es = load <4 x float>, ptr %i.ar, align 8
  %i.et = load float, ptr %7, align 8, !tbaa !56  ; 2 uses
  %i.eu = shufflevector <4 x float> %i.dv, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.ev = fmul <2 x float> %i.bl, %i.eu
  %i.ew = fmul <2 x float> %i.bn, %i.eu
  %i.ex = shufflevector <4 x float> %12, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.ey = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bk, <2 x float> %i.ex, <2 x float> %i.ev)
  %i.ez = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bm, <2 x float> %i.ex, <2 x float> %i.ew)
  %i.fa = shufflevector <4 x float> %13, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.fb = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ci, <2 x float> %i.fa, <2 x float> %i.ey)
  %i.fc = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.by, <2 x float> %i.fa, <2 x float> %i.ez)
  %i.fd = fadd <2 x float> %i.j, %i.fb            ; 3 uses
  %i.fe = fadd <2 x float> %i.bh, %i.fc           ; 2 uses
  %17 = shufflevector <2 x float> %i.fd, <2 x float> %i.fe, <2 x i32> <i32 3, i32 0>
  %18 = shufflevector <2 x float> <float poison, float 0.000000e+00>, <2 x float> %i.fd, <2 x i32> <i32 3, i32 1>
  store <2 x float> %17, ptr %i.ae, align 8
  store <2 x float> %18, ptr %i.ag, align 8, !tbaa !81
  %i.ff = shufflevector <4 x float> %i.dx, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.fg = fmul <2 x float> %i.bn, %i.ff
  %i.fh = fmul <2 x float> %i.bl, %i.ff
  %i.fi = shufflevector <4 x float> %i.dw, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.fj = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bm, <2 x float> %i.fi, <2 x float> %i.fg)
  %i.fk = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bk, <2 x float> %i.fi, <2 x float> %i.fh)
  %i.fl = shufflevector <4 x float> %i.dy, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.fm = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.by, <2 x float> %i.fl, <2 x float> %i.fj)
  %i.fn = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ci, <2 x float> %i.fl, <2 x float> %i.fk)
  %i.fo = fadd <2 x float> %i.bh, %i.fm           ; 3 uses
  %i.fp = fadd <2 x float> %i.j, %i.fn            ; 2 uses
  ...
  store <2 x float> %i.fq, ptr %i.ah, align 8
  store <2 x float> %i.fr, ptr %i.aj, align 8, !tbaa !81
  %i.fs = load <2 x float>, ptr %10, align 4, !tbaa !56 ; 5 uses
  %19 = fsub <2 x float> %i.fd, %i.fs             ; 2 uses
  %20 = shufflevector <2 x float> %i.fs, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %21 = insertelement <2 x float> %20, float %i.et, i64 1 ; 2 uses
  %22 = fsub <2 x float> %i.fe, %21               ; 2 uses
  %i.ft = fsub <2 x float> %i.fo, %21             ; 2 uses
  %i.fu = fsub <2 x float> %i.fp, %i.fs           ; 2 uses
  %i.fv = fneg <2 x float> %i.fu
  %23 = fmul <2 x float> %22, %i.fv
  %24 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %19, <2 x float> %i.ft, <2 x float> %23) ; 3 uses
  %25 = extractelement <2 x float> %i.fs, i64 1
  %26 = shufflevector <4 x float> %15, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %27 = fmul <2 x float> %i.bt, %26
  %i.fw = fmul <2 x float> %i.bv, %26
  %28 = shufflevector <4 x float> %14, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %29 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bs, <2 x float> %28, <2 x float> %27)
  %30 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bu, <2 x float> %28, <2 x float> %i.fw)
  %i.fx = shufflevector <4 x float> %16, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.fy = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cj, <2 x float> %i.fx, <2 x float> %29)
  %i.fz = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ce, <2 x float> %i.fx, <2 x float> %30)
  %31 = fadd <2 x float> %i.t, %i.fy              ; 3 uses
  %i.ga = fadd <2 x float> %i.bp, %i.fz           ; 2 uses
  %32 = shufflevector <2 x float> %31, <2 x float> %i.ga, <2 x i32> <i32 3, i32 0>
  %33 = shufflevector <2 x float> <float poison, float 0.000000e+00>, <2 x float> %31, <2 x i32> <i32 3, i32 1>
  store <2 x float> %32, ptr %i.am, align 8
  store <2 x float> %33, ptr %i.ao, align 8, !tbaa !81
  %34 = shufflevector <4 x float> %i.er, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %35 = fmul <2 x float> %i.bv, %34
  %36 = fmul <2 x float> %i.bt, %34
  %37 = shufflevector <4 x float> %i.eq, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %38 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bu, <2 x float> %37, <2 x float> %35)
  %39 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bs, <2 x float> %37, <2 x float> %36)
  %40 = shufflevector <4 x float> %i.es, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %41 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ce, <2 x float> %40, <2 x float> %38)
  %42 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cj, <2 x float> %40, <2 x float> %39)
  %43 = fadd <2 x float> %i.bp, %41               ; 3 uses
  %44 = fadd <2 x float> %i.t, %42                ; 2 uses
  %i.gb = shufflevector <2 x float> %43, <2 x float> %44, <2 x i32> <i32 1, i32 2>
  %45 = insertelement <2 x float> %43, float 0.000000e+00, i64 1
  store <2 x float> %i.gb, ptr %i.ap, align 8
  store <2 x float> %45, ptr %i.ar, align 8, !tbaa !81
  %46 = load <2 x float>, ptr %i.ak, align 4, !tbaa !56 ; 5 uses
  %47 = fsub <2 x float> %31, %46                 ; 2 uses
  %48 = shufflevector <2 x float> %46, <2 x float> %i.el, <2 x i32> <i32 1, i32 2> ; 2 uses
  %49 = fsub <2 x float> %i.ga, %48               ; 2 uses
  %50 = fsub <2 x float> %43, %48                 ; 2 uses
  %i.gc = fsub <2 x float> %44, %46               ; 2 uses
  %51 = fneg <2 x float> %i.gc
  %i.gd = fmul <2 x float> %49, %51
  %i.ge = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %47, <2 x float> %50, <2 x float> %i.gd) ; 3 uses
  %i.gf = shufflevector <2 x float> %i.ft, <2 x float> %50, <2 x i32> <i32 1, i32 3>
  %i.gg = fneg <2 x float> %i.gf
  %i.gh = shufflevector <2 x float> %19, <2 x float> %47, <2 x i32> <i32 0, i32 2>
  %i.gi = fmul <2 x float> %i.gh, %i.gg
  %52 = shufflevector <2 x float> %22, <2 x float> %49, <2 x i32> <i32 1, i32 3>
  %i.gj = shufflevector <2 x float> %i.fu, <2 x float> %i.gc, <2 x i32> <i32 0, i32 2>
  %i.gk = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %52, <2 x float> %i.gj, <2 x float> %i.gi) ; 4 uses
  %i.gl = shufflevector <2 x float> %24, <2 x float> %i.ge, <2 x i32> <i32 1, i32 3> ; 2 uses
  %i.gm = fmul <2 x float> %i.gl, %i.gl
  %i.gn = shufflevector <2 x float> %24, <2 x float> %i.ge, <2 x i32> <i32 0, i32 2> ; 2 uses
  ...
  %i.gt = fmul <2 x float> %24, %i.gs             ; 3 uses
  ...
  %foldExtExtBinop112 = fmul <2 x float> %i.fs, %shift
  ...
  %i.gy = call noundef float @llvm.fmuladd.f32(float %25, float %i.gu, float %i.gx)
  ...
  %foldExtExtBinop117 = fmul <2 x float> %46, %shift116
  %53 = extractelement <2 x float> %foldExtExtBinop117, i64 0
  %i.hc = extractelement <2 x float> %i.ha, i64 0
  %i.hd = extractelement <2 x float> %i.el, i64 0
  %i.he = call float @llvm.fmuladd.f32(float %i.hd, float %i.hc, float %53)
  %i.hf = extractelement <2 x float> %46, i64 1
