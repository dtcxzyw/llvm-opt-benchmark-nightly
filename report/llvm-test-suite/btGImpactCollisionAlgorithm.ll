...
bb.b:                                             ; preds = %bb.a
  ...
  %11 = load float, ptr %9, align 4, !tbaa !50    ; 2 uses
  %12 = load float, ptr %i.o, align 4, !tbaa !50  ; 2 uses
  %i.ag = load float, ptr %10, align 4, !tbaa !50 ; 2 uses
  %13 = insertelement <2 x float> poison, float %11, i64 0
  %14 = shufflevector <2 x float> %13, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ah = fmul <2 x float> %i.q, %14
  %15 = insertelement <2 x float> poison, float %12, i64 0
  %i.ai = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> zeroinitializer
  %i.aj = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.p, <2 x float> %i.ai, <2 x float> %i.ah)
  %16 = insertelement <2 x float> poison, float %i.ag, i64 0
  %17 = shufflevector <2 x float> %16, <2 x float> poison, <2 x i32> zeroinitializer
  %18 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.r, <2 x float> %17, <2 x float> %i.aj)
  %i.ak = fmul float %i.i, %11
  %i.al = tail call float @llvm.fmuladd.f32(float %i.h, float %12, float %i.ak)
  %i.am = tail call noundef float @llvm.fmuladd.f32(float %i.j, float %i.ag, float %i.al)
  %i.an = fadd <2 x float> %18, %i.z
...
bb.a:
  ...
  %i.o = load <2 x float>, ptr %i.h, align 4      ; 2 uses
  %i.p = load <2 x float>, ptr %i.i, align 4      ; 2 uses
  %i.q = load float, ptr %i.m, align 4, !tbaa !50 ; 3 uses
  %i.r = load float, ptr %i.l, align 4, !tbaa !50 ; 3 uses
  %i.s = load float, ptr %i.n, align 4, !tbaa !50 ; 3 uses
  %11 = shufflevector <2 x float> %i.o, <2 x float> %i.p, <2 x i32> <i32 1, i32 3>
  %12 = insertelement <2 x float> poison, float %i.q, i64 0
  %13 = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> zeroinitializer
  %14 = fmul <2 x float> %11, %13
  %15 = shufflevector <2 x float> %i.o, <2 x float> %i.p, <2 x i32> <i32 0, i32 2>
  %i.t = insertelement <2 x float> poison, float %i.r, i64 0
  %16 = shufflevector <2 x float> %i.t, <2 x float> poison, <2 x i32> zeroinitializer
  %i.u = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %15, <2 x float> %16, <2 x float> %14)
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.aj = fneg <3 x float> %i.ai                  ; 4 uses
  %i.ak = shufflevector <3 x float> %i.aj, <3 x float> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  ...
  %11 = load float, ptr %10, align 4, !tbaa !50, !noalias !201 ; 2 uses
  %12 = insertelement <2 x float> poison, float %11, i64 0
  %13 = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> zeroinitializer
  %14 = load <2 x float>, ptr %i.ae, align 4, !tbaa !50, !noalias !201 ; 4 uses
  %i.aq = shufflevector <2 x float> %14, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.ar = fmul <2 x float> %i.ag, %i.aq
  %i.as = shufflevector <2 x float> %14, <2 x float> poison, <2 x i32> zeroinitializer
  %i.at = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.af, <2 x float> %i.as, <2 x float> %i.ar)
  %i.au = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ah, <2 x float> %13, <2 x float> %i.at)
  ...
  %15 = shufflevector <2 x float> %i.ak, <2 x float> %14, <2 x i32> <i32 0, i32 3>
  %i.ay = fmul <2 x float> %i.ax, %15
  ...
  %16 = shufflevector <2 x float> %i.am, <2 x float> %14, <2 x i32> <i32 0, i32 2>
  %i.bb = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ba, <2 x float> %16, <2 x float> %i.ay)
  ...
  %17 = shufflevector <3 x float> %i.aj, <3 x float> poison, <2 x i32> <i32 2, i32 poison>
  %18 = insertelement <2 x float> %17, float %11, i64 1
  %i.be = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bd, <2 x float> %18, <2 x float> %i.bb) ; 2 uses
...
bb.a:
  ...
  %i.j = load <2 x float>, ptr %i.a, align 8, !tbaa !50 ; 2 uses
  %i.k = load float, ptr %i.b, align 4, !tbaa !50 ; 2 uses
  %i.l = load float, ptr %1, align 4, !tbaa !50   ; 2 uses
  %i.m = load float, ptr %i.c, align 4, !tbaa !50 ; 2 uses
  %2 = load <2 x float>, ptr %i.g, align 8, !tbaa !50 ; 2 uses
