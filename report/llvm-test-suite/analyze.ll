...
begin_hunk_1_@ana_AutoConfiguration:bb.a
  ...
  %i.ew = add i32 %.val3.i.i.i, -1
  %i.ex = add i32 %i.ew, %.val4.i.i.i
  %i.ey = add i32 %i.ex, %.val.i.i.i
