...
begin_hunk_2_@_ZN24btSolve2LinearConstraint31resolveUnilateralPairConstraintEP11btRigidBodyS1_RK11btMatrix3x3S4_RK9btVector3fS7_S7_S7_S7_fS7_S7_S7_fS7_S7_S7_fS7_RfS8_:bb.a
  ...
  %i.hu = load <2 x float>, ptr %10, align 4, !tbaa !8 ; 3 uses
...
begin_hunk_3_@_ZN24btSolve2LinearConstraint31resolveUnilateralPairConstraintEP11btRigidBodyS1_RK11btMatrix3x3S4_RK9btVector3fS7_S7_S7_S7_fS7_S7_S7_fS7_S7_S7_fS7_RfS8_:bb.a
  ...
  %23 = load <2 x float>, ptr %i.x, align 4, !tbaa !8 ; 2 uses
  %24 = load <2 x float>, ptr %i.ag, align 4, !tbaa !8 ; 2 uses
  %i.ic = shufflevector <2 x float> %23, <2 x float> %24, <2 x i32> <i32 0, i32 2>
  %25 = fmul <2 x float> %i.cs, %i.ic
  %26 = shufflevector <2 x float> %i.hp, <2 x float> %i.hr, <2 x i32> <i32 0, i32 2> ; 2 uses
  %i.id = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %26, <2 x float> %i.cz, <2 x float> %25)
  %27 = shufflevector <2 x float> %23, <2 x float> %24, <2 x i32> <i32 1, i32 3> ; 2 uses
  %28 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %27, <2 x float> %i.dg, <2 x float> %i.id) ; 3 uses
  %29 = shufflevector <2 x float> %i.b, <2 x float> %28, <6 x i32> <i32 poison, i32 poison, i32 0, i32 2, i32 3, i32 poison>
  %30 = insertelement <6 x float> %29, float %i.c, i64 5
  %31 = shufflevector <2 x float> %i.ib, <2 x float> poison, <6 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison>
  %32 = shufflevector <6 x float> %31, <6 x float> %30, <6 x i32> <i32 0, i32 1, i32 8, i32 9, i32 10, i32 11>
  %33 = shufflevector <2 x float> %i.ec, <2 x float> poison, <6 x i32> <i32 poison, i32 poison, i32 0, i32 poison, i32 poison, i32 poison>
  %34 = shufflevector <2 x float> %i.hs, <2 x float> %i.hu, <6 x i32> <i32 0, i32 2, i32 poison, i32 1, i32 poison, i32 poison>
  %35 = shufflevector <6 x float> %34, <6 x float> %33, <6 x i32> <i32 0, i32 1, i32 8, i32 3, i32 poison, i32 poison>
  %36 = shufflevector <2 x float> %i.hu, <2 x float> poison, <6 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 1, i32 poison>
  %37 = shufflevector <6 x float> %35, <6 x float> %36, <6 x i32> <i32 0, i32 1, i32 2, i32 3, i32 10, i32 poison>
  %38 = insertelement <6 x float> %37, float %.sroa.5105.0.copyload, i64 5
  %39 = fmul <6 x float> %32, %38                 ; 5 uses
  %40 = shufflevector <6 x float> %39, <6 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 2, i32 3, i32 4, i32 5, i32 5>
  %i.ie = extractelement <6 x float> %39, i64 3
  %i.if = extractelement <2 x float> %28, i64 0
  %i.ig = fmul float %i.if, %i.ie
  %i.ih = extractelement <6 x float> %39, i64 0
  ...
  %i.in = extractelement <6 x float> %39, i64 4
  %i.io = extractelement <2 x float> %28, i64 1
  %i.ip = fmul float %i.io, %i.in
  %i.iq = extractelement <6 x float> %39, i64 1
...
begin_hunk_4_@_ZN24btSolve2LinearConstraint31resolveUnilateralPairConstraintEP11btRigidBodyS1_RK11btMatrix3x3S4_RK9btVector3fS7_S7_S7_S7_fS7_S7_S7_fS7_S7_S7_fS7_RfS8_:bb.a
  ...
  %41 = shufflevector <2 x float> %i.hp, <2 x float> %i.hr, <2 x i32> <i32 1, i32 3>
  %i.iy = fmul <2 x float> %41, %i.eq
  %i.iz = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %26, <2 x float> %i.ex, <2 x float> %i.iy)
  %i.ja = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %27, <2 x float> %i.fe, <2 x float> %i.iz) ; 3 uses
...
begin_hunk_5_@_ZN24btSolve2LinearConstraint31resolveUnilateralPairConstraintEP11btRigidBodyS1_RK11btMatrix3x3S4_RK9btVector3fS7_S7_S7_S7_fS7_S7_S7_fS7_S7_S7_fS7_RfS8_:bb.a
  ...
  %i.ka = fmul <8 x float> %i.jz, %40             ; 8 uses
...
begin_hunk_8_@_ZN24btSolve2LinearConstraint30resolveBilateralPairConstraintEP11btRigidBodyS1_RK11btMatrix3x3S4_RK9btVector3fS7_S7_S7_S7_fS7_S7_S7_fS7_S7_S7_fS7_RfS8_:bb.a
  ...
  %i.hq = load <2 x float>, ptr %10, align 4, !tbaa !8 ; 3 uses
...
begin_hunk_9_@_ZN24btSolve2LinearConstraint30resolveBilateralPairConstraintEP11btRigidBodyS1_RK11btMatrix3x3S4_RK9btVector3fS7_S7_S7_S7_fS7_S7_S7_fS7_S7_S7_fS7_RfS8_:bb.a
  ...
  %23 = load <2 x float>, ptr %i.x, align 4, !tbaa !8 ; 2 uses
  %24 = load <2 x float>, ptr %i.ag, align 4, !tbaa !8 ; 2 uses
  %i.hy = shufflevector <2 x float> %23, <2 x float> %24, <2 x i32> <i32 0, i32 2>
  %25 = fmul <2 x float> %i.co, %i.hy
  %26 = shufflevector <2 x float> %i.hl, <2 x float> %i.hn, <2 x i32> <i32 0, i32 2> ; 2 uses
  %i.hz = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %26, <2 x float> %i.cv, <2 x float> %25)
  %27 = shufflevector <2 x float> %23, <2 x float> %24, <2 x i32> <i32 1, i32 3> ; 2 uses
  %28 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %27, <2 x float> %i.dc, <2 x float> %i.hz) ; 3 uses
  %29 = shufflevector <2 x float> %i.b, <2 x float> %28, <6 x i32> <i32 poison, i32 poison, i32 0, i32 2, i32 3, i32 poison>
  %30 = insertelement <6 x float> %29, float %i.c, i64 5
  %31 = shufflevector <2 x float> %i.hx, <2 x float> poison, <6 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison>
  %32 = shufflevector <6 x float> %31, <6 x float> %30, <6 x i32> <i32 0, i32 1, i32 8, i32 9, i32 10, i32 11>
  %33 = shufflevector <2 x float> %i.dy, <2 x float> poison, <6 x i32> <i32 poison, i32 poison, i32 0, i32 poison, i32 poison, i32 poison>
  %34 = shufflevector <2 x float> %i.ho, <2 x float> %i.hq, <6 x i32> <i32 0, i32 2, i32 poison, i32 1, i32 poison, i32 poison>
  %35 = shufflevector <6 x float> %34, <6 x float> %33, <6 x i32> <i32 0, i32 1, i32 8, i32 3, i32 poison, i32 poison>
  %36 = shufflevector <2 x float> %i.hq, <2 x float> poison, <6 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 1, i32 poison>
  %37 = shufflevector <6 x float> %35, <6 x float> %36, <6 x i32> <i32 0, i32 1, i32 2, i32 3, i32 10, i32 poison>
  %38 = insertelement <6 x float> %37, float %.sroa.5117.0.copyload, i64 5
  %39 = fmul <6 x float> %32, %38                 ; 5 uses
  %40 = shufflevector <6 x float> %39, <6 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 2, i32 3, i32 4, i32 5, i32 5>
  %i.ia = extractelement <6 x float> %39, i64 3
  %i.ib = extractelement <2 x float> %28, i64 0
  %i.ic = fmul float %i.ib, %i.ia
  %i.id = extractelement <6 x float> %39, i64 0
  ...
  %i.ij = extractelement <6 x float> %39, i64 4
  %i.ik = extractelement <2 x float> %28, i64 1
  %i.il = fmul float %i.ik, %i.ij
  %i.im = extractelement <6 x float> %39, i64 1
...
begin_hunk_10_@_ZN24btSolve2LinearConstraint30resolveBilateralPairConstraintEP11btRigidBodyS1_RK11btMatrix3x3S4_RK9btVector3fS7_S7_S7_S7_fS7_S7_S7_fS7_S7_S7_fS7_RfS8_:bb.a
  ...
  %41 = shufflevector <2 x float> %i.hl, <2 x float> %i.hn, <2 x i32> <i32 1, i32 3>
  %i.iu = fmul <2 x float> %41, %i.em
  %i.iv = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %26, <2 x float> %i.et, <2 x float> %i.iu)
  %i.iw = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %27, <2 x float> %i.fa, <2 x float> %i.iv) ; 3 uses
...
begin_hunk_11_@_ZN24btSolve2LinearConstraint30resolveBilateralPairConstraintEP11btRigidBodyS1_RK11btMatrix3x3S4_RK9btVector3fS7_S7_S7_S7_fS7_S7_S7_fS7_S7_S7_fS7_RfS8_:bb.a
  ...
  %i.jw = fmul <8 x float> %i.jv, %40             ; 8 uses
