...
begin_hunk_0_@_ZN24btSolve2LinearConstraint31resolveUnilateralPairConstraintEP11btRigidBodyS1_RK11btMatrix3x3S4_RK9btVector3fS7_S7_S7_S7_fS7_S7_S7_fS7_S7_S7_fS7_RfS8_:bb.a
  ...
  %i.dt = insertelement <4 x float> <float poison, float poison, float poison, float 1.000000e+00>, float %i.ap, i64 0
  %23 = insertelement <4 x float> %i.dt, float %i.as, i64 1
  %24 = insertelement <4 x float> %23, float %i.h, i64 2
  %i.du = insertelement <4 x float> poison, float %.sroa.7.0.copyload, i64 2
  %i.dv = insertelement <4 x float> %i.du, float %11, i64 3
  %25 = shufflevector <2 x float> %i.ds, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %26 = shufflevector <4 x float> %25, <4 x float> %i.dv, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
...
begin_hunk_1_@_ZN24btSolve2LinearConstraint30resolveBilateralPairConstraintEP11btRigidBodyS1_RK11btMatrix3x3S4_RK9btVector3fS7_S7_S7_S7_fS7_S7_S7_fS7_S7_S7_fS7_RfS8_:bb.a
  ...
  %i.dp = insertelement <4 x float> <float poison, float poison, float poison, float 1.000000e+00>, float %i.ap, i64 0
  %23 = insertelement <4 x float> %i.dp, float %i.as, i64 1
  %24 = insertelement <4 x float> %23, float %i.h, i64 2
  %i.dq = insertelement <4 x float> poison, float %.sroa.7.0.copyload, i64 2
  %i.dr = insertelement <4 x float> %i.dq, float %11, i64 3
  %25 = shufflevector <2 x float> %i.do, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %26 = shufflevector <4 x float> %25, <4 x float> %i.dr, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
