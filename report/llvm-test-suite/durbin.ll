...
vector.body101:                                   ; preds = %vector.body101, %vector.ph96
  ...
  %2 = fmul <2 x double> %broadcast.splat100, %wide.load105
  %3 = fmul <2 x double> %broadcast.splat100, %wide.load106
  %reverse107 = shufflevector <2 x double> %2, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %reverse108 = shufflevector <2 x double> %3, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.fu = fadd <2 x double> %wide.load103, %reverse107
  %i.fv = fadd <2 x double> %wide.load104, %reverse108
