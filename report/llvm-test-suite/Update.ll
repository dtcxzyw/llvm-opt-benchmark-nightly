...
bb.iu:                                            ; preds = %bb.it
  %i.agp = invoke noalias noundef nonnull dereferenceable(1112) ptr @_Znwm(i64 noundef 1112) #21
          to label %bb.iv unwind label %bb.jf     ; 16 uses

bb.iv:                                            ; preds = %bb.iu
  %31 = getelementptr inbounds nuw i8, ptr %i.agp, i64 8
  %i.agq = getelementptr inbounds nuw i8, ptr %i.agp, i64 16
  store i32 0, ptr %i.agq, align 4, !tbaa !47
  store ptr getelementptr inbounds nuw inrange(-16, 64) (i8, ptr @_ZTV13CInFileStream, i64 16), ptr %i.agp, align 8, !tbaa !48
  store ptr getelementptr inbounds nuw inrange(-16, 48) (i8, ptr @_ZTV13CInFileStream, i64 96), ptr %31, align 8, !tbaa !48
