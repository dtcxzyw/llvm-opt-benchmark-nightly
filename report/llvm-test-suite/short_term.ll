...
bb.a:
  %i.a = load i16, ptr %0, align 2, !tbaa !12     ; 8 uses
  %i.b = icmp slt i16 %i.a, 0
  br i1 %i.b, label %bb.b, label %bb.h

bb.b:                                             ; preds = %bb.a
  %narrow29 = tail call i16 @llvm.ssub.sat.i16(i16 0, i16 %i.a) ; 6 uses
  %i.c = icmp samesign ult i16 %narrow29, 11059
...
bb.d:                                             ; preds = %bb.b
  %i.d = icmp samesign ult i16 %narrow29, 20070
...
bb.f:                                             ; preds = %bb.d
  %i.e = icmp samesign ugt i16 %narrow29, 26623
...
begin_hunk_3_@LARp_to_rp:bb.a
  ...
  %i.n = load i16, ptr %i.m, align 2, !tbaa !12   ; 8 uses
...
bb.u:                                             ; preds = %bb.n
  %narrow29.1 = tail call i16 @llvm.ssub.sat.i16(i16 0, i16 %i.n) ; 6 uses
  %i.v = icmp samesign ult i16 %narrow29.1, 11059
  br i1 %i.v, label %bb.z, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.w = icmp samesign ult i16 %narrow29.1, 20070
  br i1 %i.w, label %bb.y, label %bb.w

bb.w:                                             ; preds = %bb.v
  %i.x = icmp samesign ugt i16 %narrow29.1, 26623
...
begin_hunk_5_@LARp_to_rp:bb.a
  ...
  %i.aa = load i16, ptr %i.z, align 2, !tbaa !12  ; 8 uses
...
bb.ah:                                            ; preds = %bb.aa
  %narrow29.2 = tail call i16 @llvm.ssub.sat.i16(i16 0, i16 %i.aa) ; 6 uses
  %i.ai = icmp samesign ult i16 %narrow29.2, 11059
  br i1 %i.ai, label %bb.am, label %bb.ai

bb.ai:                                            ; preds = %bb.ah
  %i.aj = icmp samesign ult i16 %narrow29.2, 20070
  br i1 %i.aj, label %bb.al, label %bb.aj

bb.aj:                                            ; preds = %bb.ai
  %i.ak = icmp samesign ugt i16 %narrow29.2, 26623
...
begin_hunk_7_@LARp_to_rp:bb.a
  ...
  %i.an = load i16, ptr %i.am, align 2, !tbaa !12 ; 8 uses
...
bb.au:                                            ; preds = %bb.an
  %narrow29.3 = tail call i16 @llvm.ssub.sat.i16(i16 0, i16 %i.an) ; 6 uses
  %i.av = icmp samesign ult i16 %narrow29.3, 11059
  br i1 %i.av, label %bb.az, label %bb.av

bb.av:                                            ; preds = %bb.au
  %i.aw = icmp samesign ult i16 %narrow29.3, 20070
  br i1 %i.aw, label %bb.ay, label %bb.aw

bb.aw:                                            ; preds = %bb.av
  %i.ax = icmp samesign ugt i16 %narrow29.3, 26623
...
begin_hunk_9_@LARp_to_rp:bb.a
  ...
  %i.ba = load i16, ptr %i.az, align 2, !tbaa !12 ; 8 uses
...
bb.bh:                                            ; preds = %bb.ba
  %narrow29.4 = tail call i16 @llvm.ssub.sat.i16(i16 0, i16 %i.ba) ; 6 uses
  %i.bi = icmp samesign ult i16 %narrow29.4, 11059
  br i1 %i.bi, label %bb.bm, label %bb.bi

bb.bi:                                            ; preds = %bb.bh
  %i.bj = icmp samesign ult i16 %narrow29.4, 20070
  br i1 %i.bj, label %bb.bl, label %bb.bj

bb.bj:                                            ; preds = %bb.bi
  %i.bk = icmp samesign ugt i16 %narrow29.4, 26623
...
begin_hunk_11_@LARp_to_rp:bb.a
  ...
  %i.bn = load i16, ptr %i.bm, align 2, !tbaa !12 ; 8 uses
...
bb.bu:                                            ; preds = %bb.bn
  %narrow29.5 = tail call i16 @llvm.ssub.sat.i16(i16 0, i16 %i.bn) ; 6 uses
  %i.bv = icmp samesign ult i16 %narrow29.5, 11059
  br i1 %i.bv, label %bb.bz, label %bb.bv

bb.bv:                                            ; preds = %bb.bu
  %i.bw = icmp samesign ult i16 %narrow29.5, 20070
  br i1 %i.bw, label %bb.by, label %bb.bw

bb.bw:                                            ; preds = %bb.bv
  %i.bx = icmp samesign ugt i16 %narrow29.5, 26623
...
begin_hunk_13_@LARp_to_rp:bb.a
  ...
  %i.ca = load i16, ptr %i.bz, align 2, !tbaa !12 ; 8 uses
...
bb.ch:                                            ; preds = %bb.ca
  %narrow29.6 = tail call i16 @llvm.ssub.sat.i16(i16 0, i16 %i.ca) ; 6 uses
  %i.ci = icmp samesign ult i16 %narrow29.6, 11059
  br i1 %i.ci, label %bb.cm, label %bb.ci

bb.ci:                                            ; preds = %bb.ch
  %i.cj = icmp samesign ult i16 %narrow29.6, 20070
  br i1 %i.cj, label %bb.cl, label %bb.cj

bb.cj:                                            ; preds = %bb.ci
  %i.ck = icmp samesign ugt i16 %narrow29.6, 26623
...
begin_hunk_15_@LARp_to_rp:bb.a
  ...
  %i.cn = load i16, ptr %i.cm, align 2, !tbaa !12 ; 8 uses
...
bb.cu:                                            ; preds = %bb.cn
  %narrow29.7 = tail call i16 @llvm.ssub.sat.i16(i16 0, i16 %i.cn) ; 6 uses
  %i.cv = icmp samesign ult i16 %narrow29.7, 11059
  br i1 %i.cv, label %bb.cz, label %bb.cv

bb.cv:                                            ; preds = %bb.cu
  %i.cw = icmp samesign ult i16 %narrow29.7, 20070
  br i1 %i.cw, label %bb.cy, label %bb.cw

bb.cw:                                            ; preds = %bb.cv
  %i.cx = icmp samesign ugt i16 %narrow29.7, 26623
