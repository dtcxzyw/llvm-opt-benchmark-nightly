...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %offset.idx = add i32 %.013, %index
  %i.f = zext i32 %offset.idx to i64
  ...
  %i.i = icmp eq i32 %index.next, %n.vec
  br i1 %i.i, label %middle.block, label %vector.body, !llvm.loop !15
