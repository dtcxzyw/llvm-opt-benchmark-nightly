...
vector.body:                                      ; preds = %.lr.ph.preheader
  ...
  %i.f = add nuw nsw i32 %.013, %n.vec
  %i.g = zext nneg i32 %.013 to i64
  ...
  %i.j = icmp eq i32 %i.d, %n.vec
  br i1 %i.j, label %._crit_edge, label %.lr.ph.preheader16

.lr.ph.preheader16:                               ; preds = %.lr.ph.preheader, %vector.body
  %.015.ph = phi i32 [ %.013, %.lr.ph.preheader ], [ %i.f, %vector.body ] ; 4 uses
...
._crit_edge:                                      ; preds = %bb.e, %bb.c
  ...
  store i8 %i.au, ptr %i.aq, align 1, !tbaa !21
  ...
  store i8 %i.ba, ptr %i.ay, align 1, !tbaa !21
  %i.bc = trunc i32 %i.as to i8
  %i.bd = getelementptr inbounds nuw i8, ptr %1, i64 8
  store i8 %i.bc, ptr %i.bb, align 1, !tbaa !21
  ...
  store i8 %i.bu, ptr %i.bq, align 1, !tbaa !21
  ...
  store i8 %i.cc, ptr %i.cb, align 1, !tbaa !21
  ...
  store i8 %i.cp, ptr %i.co, align 1, !tbaa !21
