...
.preheader6:
  ...
  %2 = shl nuw nsw i32 %i.b, 1                    ; 4 uses
...
._crit_edge33:                                    ; preds = %.preheader6, %._crit_edge33.loopexit
  %.pre-phi.a = phi i32 [ %.pre63, %._crit_edge33.loopexit ], [ %i.c, %.preheader6 ]
  %i.bp = phi i32 [ %.pre, %._crit_edge33.loopexit ], [ %i.a, %.preheader6 ]
  %3 = sdiv i32 %i.c, %.pre-phi.a
  %4 = shl nuw nsw i32 %i.b, 1                    ; 8 uses
  %5 = mul nuw nsw i32 %i.bp, %4                  ; 7 uses
  %i.bq = mul nsw i32 %5, %3                      ; 4 uses
  %.not13.1 = icmp eq i32 %5, 0
  br i1 %.not13.1, label %.preheader5.1, label %.lr.ph19.1

.lr.ph19.1:                                       ; preds = %._crit_edge33
  %i.br = add nsw i32 %4, -2
  %i.bs = zext nneg i32 %4 to i64
  %i.bt = zext nneg i32 %5 to i64
