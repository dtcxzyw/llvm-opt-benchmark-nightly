...
.preheader25.lr.ph.split.split:                   ; preds = %.preheader25.lr.ph
  ...
  %i.cr = mul i32 %i.e, %i.cp
  %i.cs = mul i32 %i.c, %i.co
  %i.ct = mul i32 %i.cp, %3
  %i.cu = mul i32 %i.c, %i.cq                     ; 2 uses
  %4 = mul i32 %i.co, %i.cm
  %5 = mul i32 %i.e, %i.cn
  %i.cv = add i32 %i.a, %i.cu
  %6 = add i32 %i.a, %i.cr
  %7 = add i32 %i.a, %5                           ; 2 uses
  %i.cw = insertelement <4 x i32> poison, i32 %i.cs, i64 0
  %i.cx = insertelement <4 x i32> %i.cw, i32 %7, i64 1
  %i.cy = insertelement <4 x i32> %i.cx, i32 %6, i64 2
  %i.cz = insertelement <4 x i32> %i.cy, i32 %i.cv, i64 3
  %i.da = insertelement <4 x i32> poison, i32 %7, i64 0
  %i.db = insertelement <4 x i32> %i.da, i32 %4, i64 1
  %i.dc = insertelement <4 x i32> %i.db, i32 %i.cu, i64 2
  %i.dd = insertelement <4 x i32> %i.dc, i32 %i.ct, i64 3
  %i.de = add <4 x i32> %i.cz, %i.dd
  ...
  %i.eo = insertelement <8 x i32> %i.en, i32 %2, i64 3
