...
.preheader27.lr.ph.split.split:                   ; preds = %.preheader27.lr.ph
  ...
  %3 = load i32, ptr %i.am, align 8, !tbaa !4     ; 5 uses
  %4 = load i32, ptr %i.as, align 8, !tbaa !4     ; 5 uses
  %5 = load i32, ptr %i.ar, align 4, !tbaa !4     ; 8 uses
  %i.ct = load i32, ptr %i.ax, align 8, !tbaa !4  ; 8 uses
  %i.cu = load i32, ptr %i.aw, align 4, !tbaa !4  ; 5 uses
  %6 = load i32, ptr %i.bh, align 8, !tbaa !4     ; 5 uses
  %7 = load i32, ptr %i.bg, align 4, !tbaa !4     ; 5 uses
  %8 = load i32, ptr %i.bq, align 8, !tbaa !4     ; 5 uses
  %9 = load i32, ptr %i.bp, align 4, !tbaa !4     ; 5 uses
  %10 = mul i32 %i.e, %8
  %11 = add i32 %i.a, %10
  %12 = mul i32 %i.c, %9
  %13 = add i32 %11, %12
  %14 = mul i32 %i.e, %3
  %15 = add i32 %i.a, %14
  %i.cv = mul i32 %i.c, %i.cs
  %16 = add i32 %15, %i.cv                        ; 2 uses
  %17 = add i32 %16, 1
  %i.cw = mul i32 %i.e, %4
  %18 = add i32 %i.a, %i.cw                       ; 2 uses
  %i.cx = mul i32 %5, %i.cr
  %19 = add i32 %18, %i.cx
  %i.cy = mul i32 %i.c, %5
  %i.cz = add i32 %18, %i.cy
  %20 = mul i32 %i.c, %i.cu                       ; 2 uses
  %i.da = add i32 %i.a, %20
  %21 = mul i32 %i.ct, %2
  %i.db = add i32 %i.da, %21
  %22 = mul i32 %i.e, %i.ct
  %i.dc = add i32 %i.a, %22
  %i.dd = add i32 %i.dc, %20
  %23 = mul i32 %i.e, %6
  %i.de = add i32 %i.a, %23
  %24 = mul i32 %i.c, %7
  %i.df = add i32 %i.de, %24
...
.preheader27:                                     ; preds = %.preheader27.lr.ph.split.split, %._crit_edge38.split
  ...
  %i.fm = mul i32 %8, %indvar
  %i.fn = add i32 %i.dn, %i.fm
  %i.fo = mul i32 %3, %indvar                     ; 2 uses
  %i.fp = add i32 %i.ee, %i.fo
  %i.fq = add i32 %i.ef, %i.fo
  %i.fr = mul i32 %4, %indvar                     ; 2 uses
  %i.fs = add i32 %i.ej, %i.fr
  %i.ft = add i32 %i.em, %i.fr
  %i.fu = mul i32 %i.ct, %indvar                  ; 2 uses
  %i.fv = add i32 %i.eq, %i.fu
  %i.fw = add i32 %i.eu, %i.fu
  %i.fx = mul i32 %6, %indvar
  %i.fy = add i32 %i.ey, %i.fx
  %i.fz = mul i32 %i.cb, %indvar
  %i.ga = add i32 %i.fc, %i.fz
  %i.gb = mul i32 %8, %indvar
  %25 = add i32 %13, %i.gb
  %i.gc = mul i32 %3, %indvar                     ; 2 uses
  %26 = add i32 %17, %i.gc
  %27 = add i32 %16, %i.gc
  %28 = mul i32 %4, %indvar                       ; 2 uses
  %29 = add i32 %19, %28
  %30 = add i32 %i.cz, %28
  %i.gd = mul i32 %i.ct, %indvar                  ; 2 uses
  %31 = add i32 %i.db, %i.gd
  %32 = add i32 %i.dd, %i.gd
  %33 = mul i32 %6, %indvar
  %34 = add i32 %i.df, %33
  %i.ge = mul i32 %i.cb, %indvar
  %i.gf = add i32 %i.dj, %i.ge
  %i.gg = add i32 %.02240, 1                      ; 3 uses
  %i.gh = mul nsw i32 %3, %.02240                 ; 3 uses
  %invariant.op = add i32 %i.gh, 1                ; 2 uses
  %i.gi = mul nsw i32 %4, %.02240                 ; 2 uses
  %i.gj = mul nsw i32 %i.ct, %i.gg                ; 2 uses
  %i.gk = mul nsw i32 %i.ct, %.02240              ; 2 uses
  %i.gl = mul nsw i32 %6, %.02240
  %i.gm = mul nsw i32 %8, %.02240
...
.preheader:                                       ; preds = %.preheader27, %._crit_edge
  ...
  %i.gs = mul i32 %i.cs, %indvar55                ; 2 uses
  ...
  %i.gz = mul i32 %5, %indvar55                   ; 2 uses
  ...
  %i.hg = mul i32 %i.cu, %indvar55                ; 2 uses
  ...
  %i.hv = mul nsw i32 %i.cs, %.02137              ; 2 uses
  %i.hw = add nsw i32 %.02137, 1                  ; 3 uses
  %i.hx = mul nsw i32 %5, %i.hw                   ; 2 uses
  %i.hy = mul nsw i32 %5, %.02137                 ; 2 uses
  %i.hz = mul nsw i32 %i.cu, %.02137              ; 2 uses
  %i.ia = mul nsw i32 %7, %.02137
  %invariant.op30 = add i32 %i.ia, %i.gl          ; 2 uses
  %i.ib = mul nsw i32 %9, %.02137
...
vector.scevcheck:                                 ; preds = %.preheader
  ...
  %i.if = mul i32 %7, %indvar55
  %i.ig = mul i32 %i.cu, %indvar55                ; 2 uses
  %i.ih = mul i32 %5, %indvar55                   ; 2 uses
  %i.ii = mul i32 %i.cs, %indvar55                ; 2 uses
  %i.ij = mul i32 %9, %indvar55
  %35 = add i32 %34, %i.if
  %36 = add i32 %32, %i.ig
  %37 = add i32 %31, %i.ig
  %38 = add i32 %30, %i.ih
  ...
  %44 = insertelement <8 x i32> %43, i32 %41, i64 1
  %45 = insertelement <8 x i32> %44, i32 %40, i64 2
  %46 = insertelement <8 x i32> %45, i32 %39, i64 3
  %47 = insertelement <8 x i32> %46, i32 %38, i64 4
  %48 = insertelement <8 x i32> %47, i32 %37, i64 5
  %49 = insertelement <8 x i32> %48, i32 %36, i64 6
  %50 = insertelement <8 x i32> %49, i32 %35, i64 7 ; 2 uses
  %51 = add <8 x i32> %50, %i.fk
  %i.ik = icmp slt <8 x i32> %51, %50
...
.preheader25:                                     ; preds = %.preheader25.lr.ph.split.split, %._crit_edge34.split
  ...
  %2 = add i32 %i.dn, %i.gi
  %i.gj = mul i32 %i.cs, %indvar                  ; 2 uses
  %3 = add i32 %i.dp, %i.gj
  %4 = add i32 %i.dq, %i.gj
  %5 = mul i32 %i.cu, %indvar
  %6 = add i32 %i.dt, %5
...
vector.scevcheck:                                 ; preds = %.preheader
  ...
  %i.iu = mul i32 %i.ct, %indvar51                ; 2 uses
  %i.iv = mul i32 %i.cr, %indvar51
  %7 = add i32 %i.gp, %i.ir
  %8 = add i32 %i.go, %i.ir
  %i.iw = add i32 %i.gm, %i.is
  %i.ix = add i32 %i.gl, %i.is
  %i.iy = add i32 %6, %i.it
  %i.iz = add i32 %4, %i.iu
  %9 = add i32 %3, %i.iu
  %10 = add i32 %2, %i.iv
  %11 = insertelement <8 x i32> poison, i32 %10, i64 0
  %12 = insertelement <8 x i32> %11, i32 %9, i64 1
  %13 = insertelement <8 x i32> %12, i32 %i.iz, i64 2
  %14 = insertelement <8 x i32> %13, i32 %i.iy, i64 3
  %i.ja = insertelement <8 x i32> %14, i32 %i.ix, i64 4
  %i.jb = insertelement <8 x i32> %i.ja, i32 %i.iw, i64 5
  %i.jc = insertelement <8 x i32> %i.jb, i32 %8, i64 6
  %i.jd = insertelement <8 x i32> %i.jc, i32 %7, i64 7 ; 2 uses
...
.preheader25.lr.ph.split.split:                   ; preds = %.preheader25.lr.ph
  ...
  %i.bj = add i32 %i.c, 1
  %2 = mul i32 %i.ae, %i.bj                       ; 2 uses
  %i.bk = mul i32 %i.c, %i.ae                     ; 2 uses
  %i.bl = add i32 %i.bi, %2
  %i.bm = add i32 %i.bi, %i.bk
  %3 = insertelement <2 x i32> poison, i32 %i.bm, i64 0
  %4 = insertelement <2 x i32> %3, i32 %i.bl, i64 1
  %5 = add <2 x i32> %4, splat (i32 -1)
  %6 = add i32 %i.a, %i.bh                        ; 2 uses
  %7 = add i32 %6, %i.bk
  %8 = add i32 %6, %2
  ...
  %10 = insertelement <4 x i32> %9, i32 %7, i64 2
  %11 = insertelement <4 x i32> %10, i32 %8, i64 3 ; 2 uses
  ...
  %invariant.op100 = add <4 x i32> %11, %i.ct
...
.preheader25.lr.ph.split.split:                   ; preds = %.preheader25.lr.ph
  ...
  %i.ct = insertelement <4 x i32> poison, i32 %i.bn, i64 0
  %4 = insertelement <4 x i32> %i.ct, i32 %i.bo, i64 1
  %5 = insertelement <4 x i32> %4, i32 %3, i64 2
  %i.cu = insertelement <4 x i32> %5, i32 %i.bp, i64 3 ; 2 uses
...
.preheader25.lr.ph.split.split:                   ; preds = %.preheader25.lr.ph
  ...
  %3 = load i32, ptr %i.ak, align 8, !tbaa !4     ; 5 uses
  %4 = load i32, ptr %i.aq, align 8, !tbaa !4     ; 5 uses
  %5 = load i32, ptr %i.ap, align 4, !tbaa !4     ; 8 uses
  %i.cm = load i32, ptr %i.av, align 8, !tbaa !4  ; 8 uses
  %i.cn = load i32, ptr %i.au, align 4, !tbaa !4  ; 5 uses
  %6 = load i32, ptr %i.bf, align 8, !tbaa !4     ; 5 uses
  %7 = load i32, ptr %i.be, align 4, !tbaa !4     ; 5 uses
  %8 = load i32, ptr %i.bo, align 8, !tbaa !4     ; 5 uses
  %9 = load i32, ptr %i.bn, align 4, !tbaa !4     ; 5 uses
  %10 = mul i32 %i.e, %6
  %11 = add i32 %i.a, %10
  %12 = mul i32 %i.c, %7
  %13 = add i32 %11, %12
  %14 = mul i32 %i.e, %3
  %15 = add i32 %i.a, %14
  %i.co = mul i32 %i.c, %i.cl
  %16 = add i32 %15, %i.co                        ; 2 uses
  %17 = add i32 %16, 1
  %i.cp = mul i32 %i.e, %4
  %18 = add i32 %i.a, %i.cp                       ; 2 uses
  %i.cq = mul i32 %5, %i.ck
  %19 = add i32 %18, %i.cq
  %i.cr = mul i32 %i.c, %5
  %i.cs = add i32 %18, %i.cr
  %20 = mul i32 %i.c, %i.cn                       ; 2 uses
  %i.ct = add i32 %i.a, %20
  %21 = mul i32 %i.cm, %2
  %i.cu = add i32 %i.ct, %21
  %22 = mul i32 %i.e, %i.cm
  %i.cv = add i32 %i.a, %22
  %i.cw = add i32 %i.cv, %20
  %23 = mul i32 %i.e, %8
  %i.cx = add i32 %i.a, %23
  %24 = mul i32 %i.c, %9
  %i.cy = add i32 %i.cx, %24
...
.preheader25:                                     ; preds = %.preheader25.lr.ph.split.split, %._crit_edge36.split
  ...
  %i.ev = mul i32 %6, %indvar
  %i.ew = add i32 %i.dg, %i.ev
  %i.ex = mul i32 %3, %indvar                     ; 2 uses
  %i.ey = add i32 %i.dq, %i.ex
  %i.ez = add i32 %i.dr, %i.ex
  %i.fa = mul i32 %4, %indvar                     ; 2 uses
  %i.fb = add i32 %i.dv, %i.fa
  %i.fc = add i32 %i.dy, %i.fa
  %i.fd = mul i32 %i.cm, %indvar                  ; 2 uses
  %i.fe = add i32 %i.ec, %i.fd
  %i.ff = add i32 %i.eg, %i.fd
  %i.fg = mul i32 %8, %indvar
  %i.fh = add i32 %i.ek, %i.fg
  %i.fi = mul i32 %i.bz, %indvar
  %i.fj = add i32 %i.eo, %i.fi
  %i.fk = mul i32 %6, %indvar
  %25 = add i32 %13, %i.fk
  %i.fl = mul i32 %3, %indvar                     ; 2 uses
  %26 = add i32 %17, %i.fl
  %27 = add i32 %16, %i.fl
  %28 = mul i32 %4, %indvar                       ; 2 uses
  %29 = add i32 %19, %28
  %30 = add i32 %i.cs, %28
  %i.fm = mul i32 %i.cm, %indvar                  ; 2 uses
  %31 = add i32 %i.cu, %i.fm
  %32 = add i32 %i.cw, %i.fm
  %33 = mul i32 %8, %indvar
  %34 = add i32 %i.cy, %33
  %i.fn = mul i32 %i.bz, %indvar
  %i.fo = add i32 %i.dc, %i.fn
  %i.fp = add i32 %.02238, 1                      ; 3 uses
  %i.fq = mul nsw i32 %3, %.02238
  %i.fr = mul nsw i32 %4, %.02238                 ; 2 uses
  %i.fs = mul nsw i32 %i.cm, %i.fp                ; 2 uses
  %i.ft = mul nsw i32 %i.cm, %.02238              ; 2 uses
  %i.fu = mul nsw i32 %6, %.02238
  %i.fv = mul nsw i32 %8, %.02238
...
.preheader:                                       ; preds = %.preheader25, %._crit_edge
  ...
  %i.gb = mul i32 %i.cl, %indvar53                ; 2 uses
  ...
  %i.gi = mul i32 %5, %indvar53                   ; 2 uses
  ...
  %i.gp = mul i32 %i.cn, %indvar53                ; 2 uses
  ...
  %i.he = mul nsw i32 %i.cl, %.02135
  %invariant.op = add i32 %i.he, %i.fq            ; 2 uses
  %i.hf = add nsw i32 %.02135, 1                  ; 3 uses
  %i.hg = mul nsw i32 %5, %i.hf                   ; 2 uses
  %i.hh = mul nsw i32 %5, %.02135                 ; 2 uses
  %i.hi = mul nsw i32 %i.cn, %.02135              ; 2 uses
  %i.hj = mul nsw i32 %7, %.02135
  %invariant.op28 = add i32 %i.hj, %i.fu          ; 2 uses
  %i.hk = mul nsw i32 %9, %.02135
...
vector.scevcheck:                                 ; preds = %.preheader
  ...
  %i.ho = mul i32 %9, %indvar53
  %i.hp = mul i32 %i.cn, %indvar53                ; 2 uses
  %i.hq = mul i32 %5, %indvar53                   ; 2 uses
  %i.hr = mul i32 %i.cl, %indvar53                ; 2 uses
  %i.hs = mul i32 %7, %indvar53
  %35 = add i32 %34, %i.ho
  %36 = add i32 %32, %i.hp
  %37 = add i32 %31, %i.hp
  %38 = add i32 %30, %i.hq
  ...
  %49 = insertelement <8 x i32> %48, i32 %36, i64 6
  %50 = insertelement <8 x i32> %49, i32 %35, i64 7 ; 2 uses
  %51 = add <8 x i32> %50, %i.et
  %i.ht = icmp slt <8 x i32> %51, %50
