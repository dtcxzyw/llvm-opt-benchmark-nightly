...
.preheader25.lr.ph.split.split.i.i.i:             ; preds = %.preheader25.lr.ph.i.i.i
  ...
  %i.av = add i32 %i.o, %i.c
  %1 = add i32 %i.o, %i.c
  %2 = add i32 %i.o, -1                           ; 2 uses
  %3 = zext i32 %2 to i64
  %4 = add nuw nsw i64 %3, 1                      ; 2 uses
  %min.iters.check = icmp ult i32 %2, 3
  %n.vec = and i64 %4, 8589934588                 ; 3 uses
...
.preheader25.lr.ph.split.split:                   ; preds = %.preheader25.lr.ph
  ...
  %2 = insertelement <8 x i32> poison, i32 %i.co, i64 0
  %3 = shufflevector <8 x i32> %2, <8 x i32> poison, <8 x i32> zeroinitializer
  %4 = shufflevector <8 x i32> %i.dy, <8 x i32> %i.ds, <8 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 4, i32 4, i32 8, i32 8>
  %5 = shufflevector <8 x i32> %i.dz, <8 x i32> %4, <8 x i32> <i32 0, i32 1, i32 1, i32 3, i32 12, i32 13, i32 14, i32 15>
  %6 = add i32 %i.g, -1                           ; 2 uses
  %7 = zext i32 %6 to i64
  %8 = add nuw nsw i64 %7, 1                      ; 2 uses
  %min.iters.check = icmp ult i32 %6, 3
  %invariant.op132 = add <8 x i32> %i.eb, %3
  %n.vec = and i64 %8, 8589934590                 ; 3 uses
...
vector.scevcheck:                                 ; preds = %.preheader
  ...
  %i.im = mul <8 x i32> %5, %i.il                 ; 2 uses
...
.preheader25.lr.ph.split.split:                   ; preds = %.preheader25.lr.ph
  ...
  %2 = shufflevector <8 x i32> %i.dc, <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 1, i32 3, i32 5, i32 5, i32 7, i32 7>
  %3 = shufflevector <8 x i32> %i.dg, <8 x i32> %i.dc, <8 x i32> <i32 0, i32 1, i32 1, i32 3, i32 12, i32 12, i32 14, i32 14>
  %4 = insertelement <8 x i32> poison, i32 %i.cb, i64 0
  %5 = shufflevector <8 x i32> %4, <8 x i32> poison, <8 x i32> zeroinitializer
  %6 = add i32 %i.g, -1                           ; 2 uses
  %7 = zext i32 %6 to i64
  %8 = add nuw nsw i64 %7, 1                      ; 2 uses
  %min.iters.check = icmp ult i32 %6, 3
  %invariant.op121 = add <8 x i32> %i.dl, %5
  %n.vec = and i64 %8, 8589934590                 ; 3 uses
...
.preheader25:                                     ; preds = %.preheader25.lr.ph.split.split, %._crit_edge32
  ...
  %i.fk = mul <8 x i32> %2, %i.fj                 ; 2 uses
...
vector.scevcheck:                                 ; preds = %.preheader
  ...
  %i.hf = mul <8 x i32> %3, %i.he                 ; 2 uses
...
.preheader25.lr.ph.split.split:                   ; preds = %.preheader25.lr.ph
  ...
  %2 = insertelement <4 x i32> poison, i32 %i.bc, i64 0
  %3 = shufflevector <4 x i32> %2, <4 x i32> poison, <4 x i32> zeroinitializer
  %4 = add i32 %i.g, -1                           ; 2 uses
  %5 = zext i32 %4 to i64
  %6 = add nuw nsw i64 %5, 1                      ; 2 uses
  %min.iters.check = icmp ult i32 %4, 7
  %invariant.op96 = add <4 x i32> %i.bv, %3
  %n.vec = and i64 %6, 8589934590                 ; 3 uses
...
.preheader25.lr.ph.split.split:                   ; preds = %.preheader25.lr.ph
  ...
  %2 = insertelement <4 x i32> poison, i32 %i.bo, i64 0
  %3 = shufflevector <2 x i32> %i.bs, <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %4 = shufflevector <4 x i32> %2, <4 x i32> %3, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %i.cu = insertelement <4 x i32> %4, i32 %i.bt, i64 3 ; 2 uses
  %5 = insertelement <4 x i32> poison, i32 %i.bc, i64 0
  %6 = shufflevector <4 x i32> %5, <4 x i32> poison, <4 x i32> zeroinitializer
  %7 = add i32 %i.g, -1                           ; 2 uses
  %8 = zext i32 %7 to i64
  %9 = add nuw nsw i64 %8, 1                      ; 2 uses
  %min.iters.check = icmp ult i32 %7, 7
  %invariant.op96 = add <4 x i32> %i.cu, %6
  %n.vec = and i64 %9, 8589934590                 ; 3 uses
...
.preheader25.lr.ph.split.split:                   ; preds = %.preheader25.lr.ph
  ...
  %2 = insertelement <4 x i32> poison, i32 %i.do, i64 0
  %3 = insertelement <4 x i32> %2, i32 %i.dq, i64 1
  %4 = insertelement <4 x i32> %3, i32 %i.dp, i64 2
  %i.fm = insertelement <4 x i32> %4, i32 %i.dr, i64 3
  %i.fn = insertelement <4 x i32> poison, i32 %i.ds, i64 0
  %i.fo = insertelement <4 x i32> %i.fn, i32 %i.dt, i64 1
  %i.fp = insertelement <4 x i32> %i.fo, i32 %i.du, i64 2
  %i.fq = insertelement <4 x i32> %i.fp, i32 %i.dv, i64 3
  %5 = insertelement <8 x i32> poison, i32 %i.cj, i64 0
