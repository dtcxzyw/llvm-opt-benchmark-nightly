...
bb.m:                                             ; preds = %.lr.ph, %_ZN19FieldEngineBaseDataILi3E6VectorILi3Ed4FullE10ViewEngineILi3E13IndexFunctionIN10GenericURMI10MeshTraitsILi3Ed21UniformRectilinearTag12CartesianTagLi3EEE16PositionsFunctorEEEED2Ev.exit
  ...
  %i.ij = load i32, ptr %i.ih, align 4, !tbaa !4, !noalias !4076
  %4 = getelementptr inbounds nuw i8, ptr %i.if, i64 148
  %5 = load i32, ptr %4, align 4, !tbaa !4, !noalias !4076
  ...
  %9 = load <2 x double>, ptr %i.if, align 8, !tbaa !247, !noalias !4076 ; 2 uses
  %10 = load <2 x double>, ptr %i.ir, align 8, !tbaa !247, !noalias !4076
  %11 = load <2 x double>, ptr %6, align 8, !tbaa !247, !noalias !4076
  ...
  %12 = load <4 x i32>, ptr %i.is, align 8, !tbaa !4, !noalias !4076
  %13 = load i32, ptr %i.is, align 8, !tbaa !4, !noalias !4076
  %14 = load <2 x i32>, ptr %7, align 8, !tbaa !4, !noalias !4076
  %15 = load <2 x i32>, ptr %i.ii, align 4, !tbaa !4, !noalias !4076 ; 3 uses
