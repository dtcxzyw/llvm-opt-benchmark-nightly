...
.preheader25.lr.ph.split.split:                   ; preds = %.preheader25.lr.ph
  ...
  %i.cp = add i32 %i.c, -1
  %2 = load <2 x i32>, ptr %i.al, align 4, !tbaa !4 ; 2 uses
  %i.cq = load i32, ptr %i.am, align 8, !tbaa !4  ; 3 uses
  %i.cr = load i32, ptr %i.al, align 4, !tbaa !4  ; 3 uses
  %3 = load <2 x i32>, ptr %i.au, align 4, !tbaa !4 ; 2 uses
  %i.cs = load i32, ptr %i.av, align 8, !tbaa !4  ; 3 uses
  %i.ct = load i32, ptr %i.au, align 4, !tbaa !4  ; 5 uses
  %4 = load <2 x i32>, ptr %i.bf, align 4, !tbaa !4
  %i.cu = load i32, ptr %i.bg, align 8, !tbaa !4  ; 3 uses
  %i.cv = load i32, ptr %i.bf, align 4, !tbaa !4  ; 3 uses
  %5 = load <2 x i32>, ptr %i.bo, align 4, !tbaa !4 ; 2 uses
  %i.cw = load i32, ptr %i.bp, align 8, !tbaa !4  ; 3 uses
  %i.cx = load i32, ptr %i.bo, align 4, !tbaa !4  ; 5 uses
  %6 = load <2 x i32>, ptr %i.bx, align 4, !tbaa !4 ; 2 uses
  %7 = load i32, ptr %i.by, align 8, !tbaa !4     ; 3 uses
  %8 = load i32, ptr %i.bx, align 4, !tbaa !4     ; 5 uses
  %9 = insertelement <8 x i32> poison, i32 %i.e, i64 0
  %10 = shufflevector <8 x i32> %9, <8 x i32> poison, <8 x i32> zeroinitializer
  %11 = shufflevector <2 x i32> %2, <2 x i32> %3, <8 x i32> <i32 1, i32 3, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %12 = shufflevector <2 x i32> %5, <2 x i32> %6, <8 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 1, i32 1, i32 3, i32 3>
  %13 = shufflevector <8 x i32> %11, <8 x i32> %12, <8 x i32> <i32 0, i32 1, i32 2, i32 poison, i32 12, i32 13, i32 14, i32 15>
  %14 = shufflevector <2 x i32> %4, <2 x i32> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison> ; 2 uses
  %15 = shufflevector <8 x i32> %13, <8 x i32> %14, <8 x i32> <i32 0, i32 1, i32 2, i32 9, i32 4, i32 5, i32 6, i32 7> ; 2 uses
  %16 = mul <8 x i32> %10, %15
  %17 = insertelement <8 x i32> poison, i32 %i.a, i64 0
  %18 = shufflevector <8 x i32> %17, <8 x i32> poison, <8 x i32> zeroinitializer
  %19 = add <8 x i32> %18, %16
  %20 = insertelement <8 x i32> poison, i32 %i.c, i64 0
  %21 = insertelement <8 x i32> %20, i32 %i.cp, i64 1
  %22 = shufflevector <2 x i32> %6, <2 x i32> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison> ; 2 uses
  %23 = shufflevector <8 x i32> %21, <8 x i32> %22, <8 x i32> <i32 0, i32 1, i32 8, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison> ; 2 uses
  %24 = shufflevector <8 x i32> %23, <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 0, i32 0, i32 1, i32 0, i32 2, i32 2>
  %25 = shufflevector <2 x i32> %2, <2 x i32> %3, <8 x i32> <i32 0, i32 2, i32 2, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %26 = shufflevector <2 x i32> %5, <2 x i32> poison, <8 x i32> <i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %27 = shufflevector <8 x i32> %26, <8 x i32> %23, <8 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 0, i32 9, i32 8>
  %28 = shufflevector <8 x i32> %25, <8 x i32> %27, <8 x i32> <i32 0, i32 1, i32 2, i32 poison, i32 12, i32 13, i32 14, i32 15> ; 2 uses
  %29 = shufflevector <8 x i32> %28, <8 x i32> %14, <8 x i32> <i32 0, i32 1, i32 2, i32 8, i32 4, i32 5, i32 6, i32 7> ; 2 uses
  %30 = mul <8 x i32> %24, %29
  %31 = add <8 x i32> %19, %30                    ; 2 uses
  ...
  %32 = insertelement <8 x i32> poison, i32 %i.co, i64 0
  %33 = shufflevector <8 x i32> %32, <8 x i32> poison, <8 x i32> zeroinitializer
  %34 = shufflevector <8 x i32> %28, <8 x i32> %22, <8 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 4, i32 4, i32 8, i32 8>
  %35 = shufflevector <8 x i32> %29, <8 x i32> %34, <8 x i32> <i32 0, i32 1, i32 1, i32 3, i32 12, i32 13, i32 14, i32 15>
  %min.iters.check = icmp ult i32 %i.el, 3
  %invariant.op136 = add <8 x i32> %31, %33
...
.preheader25:                                     ; preds = %.preheader25.lr.ph.split.split, %._crit_edge34.split
  %indvar = phi i32 [ 0, %.preheader25.lr.ph.split.split ], [ %indvar.next, %._crit_edge34.split ] ; 9 uses
  ...
  %i.eu = mul i32 %i.cu, %indvar
  %i.ev = add i32 %i.du, %i.eu
  %i.ew = mul i32 %i.cw, %indvar                  ; 2 uses
  %i.ex = add i32 %i.dy, %i.ew
  %i.ey = add i32 %i.ea, %i.ew
  %i.ez = mul i32 %7, %indvar                     ; 2 uses
  %i.fa = add i32 %i.ee, %i.ez
  %i.fb = add i32 %i.eg, %i.ez
  %i.fc = mul i32 %i.cj, %indvar
  %i.fd = add i32 %i.ek, %i.fc
  %36 = insertelement <8 x i32> poison, i32 %indvar, i64 0
  %37 = shufflevector <8 x i32> %36, <8 x i32> poison, <8 x i32> zeroinitializer
  %38 = mul <8 x i32> %15, %37                    ; 2 uses
  %39 = add <8 x i32> %31, %38
  %i.fe = mul i32 %i.cj, %indvar
  %i.ff = add i32 %i.db, %i.fe
  %i.fg = mul nsw i32 %i.cq, %.02236
  %i.fh = mul nsw i32 %i.cs, %.02236              ; 2 uses
  %i.fi = mul nsw i32 %i.cu, %.02236
  %i.fj = mul nsw i32 %i.cw, %.02236              ; 2 uses
  %i.fk = mul nsw i32 %7, %.02236                 ; 2 uses
  %i.fl = mul nsw i32 %i.cj, %.02236
  %invariant.op134.reass = add <8 x i32> %38, %invariant.op136
  br label %.preheader
...
.preheader:                                       ; preds = %.preheader25, %._crit_edge
  %indvar51 = phi i32 [ 0, %.preheader25 ], [ %indvar.next52, %._crit_edge ] ; 9 uses
  ...
  %i.gb = mul i32 %i.cx, %indvar51                ; 2 uses
  ...
  %i.gi = mul i32 %8, %indvar51                   ; 2 uses
  ...
  %invariant.op = add i32 %i.gt, %i.fg            ; 2 uses
  %i.gu = mul nsw i32 %i.ct, %.02133              ; 2 uses
  %i.gv = add nsw i32 %.02133, -1                 ; 3 uses
  %i.gw = mul nsw i32 %i.ct, %i.gv                ; 2 uses
  %i.gx = mul nsw i32 %i.cv, %.02133
  %invariant.op28 = add i32 %i.gx, %i.fi          ; 2 uses
  %i.gy = mul nsw i32 %i.cx, %.02133              ; 2 uses
  %i.gz = mul nsw i32 %i.cx, %i.gv                ; 2 uses
  %i.ha = mul nsw i32 %8, %.02133                 ; 2 uses
  %i.hb = mul nsw i32 %8, %i.gv                   ; 2 uses
  %i.hc = mul nsw i32 %i.ch, %.02133
  %invariant.op30 = add i32 %i.hc, %i.fl          ; 2 uses
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.scevcheck

vector.scevcheck:                                 ; preds = %.preheader
  %i.hd = mul i32 %i.ch, %indvar51
  %i.he = add i32 %i.ff, %i.hd                    ; 2 uses
  %i.hf = insertelement <8 x i32> poison, i32 %indvar51, i64 0
  %40 = shufflevector <8 x i32> %i.hf, <8 x i32> poison, <8 x i32> zeroinitializer
  %41 = mul <8 x i32> %35, %40                    ; 2 uses
  %42 = add <8 x i32> %39, %41
  %i.hg = add <8 x i32> %41, %invariant.op134.reass
  %i.hh = icmp slt <8 x i32> %i.hg, %42
  %i.hi = add i32 %i.he, %i.co
  %i.hj = icmp slt i32 %i.hi, %i.he
