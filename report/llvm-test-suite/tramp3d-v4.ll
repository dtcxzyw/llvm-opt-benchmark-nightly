...
.preheader25.lr.ph.split.split:                   ; preds = %.preheader25.lr.ph
  ...
  %4 = load i32, ptr %i.aw, align 8, !tbaa !4     ; 4 uses
  %5 = load i32, ptr %i.av, align 4, !tbaa !4     ; 7 uses
  %6 = load <2 x i32>, ptr %i.ba, align 4, !tbaa !4 ; 2 uses
  %i.bw = load i32, ptr %i.bb, align 8, !tbaa !4  ; 7 uses
  %7 = load i32, ptr %i.ba, align 4, !tbaa !4     ; 4 uses
  %8 = load <2 x i32>, ptr %i.bj, align 4, !tbaa !4 ; 2 uses
  %9 = load i32, ptr %i.bk, align 8, !tbaa !4     ; 4 uses
  %10 = load i32, ptr %i.bj, align 4, !tbaa !4    ; 4 uses
  %i.bx = mul i32 %i.e, %9
  %i.by = add i32 %i.a, %i.bx
  %i.bz = mul i32 %i.c, %10
  %i.ca = add i32 %i.by, %i.bz
  %i.cb = mul i32 %i.e, %i.br
  %i.cc = add i32 %i.a, %i.cb
  %i.cd = mul i32 %i.c, %i.bq
  %i.ce = add i32 %i.cc, %i.cd                    ; 2 uses
  %i.cf = add i32 %i.ce, 1
  %i.cg = mul i32 %i.e, %i.bt
  %11 = add i32 %i.a, %i.cg
  %i.ch = mul i32 %i.c, %i.bu
  %12 = add i32 %11, %i.ch
  %i.ci = mul i32 %i.e, %4
  %i.cj = add i32 %i.a, %i.ci                     ; 2 uses
  %13 = mul i32 %i.c, %5
  %i.ck = add i32 %i.cj, %13
  %14 = mul i32 %5, %2
  %15 = add i32 %i.cj, %14
  %16 = mul i32 %i.e, %i.bw
  %17 = add i32 %i.a, %16
  %18 = mul i32 %i.c, %7                          ; 2 uses
  %19 = add i32 %17, %18
  %20 = add i32 %i.a, %18
  %21 = mul i32 %i.bw, %3
  %22 = add i32 %20, %21
  ...
  %23 = insertelement <8 x i32> poison, i32 %i.ca, i64 0
  %24 = insertelement <8 x i32> %23, i32 %i.ce, i64 1
  %i.du = insertelement <8 x i32> %24, i32 %i.cf, i64 2
  %i.dv = insertelement <8 x i32> %i.du, i32 %12, i64 3
  %i.dw = insertelement <8 x i32> %i.dv, i32 %i.ck, i64 4
  %i.dx = insertelement <8 x i32> %i.dw, i32 %15, i64 5
  %25 = insertelement <8 x i32> %i.dx, i32 %19, i64 6
  %i.dy = insertelement <8 x i32> %25, i32 %22, i64 7 ; 2 uses
  %26 = shufflevector <2 x i32> %i.bv, <2 x i32> %6, <8 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 1, i32 1, i32 3, i32 3>
  %27 = insertelement <8 x i32> %26, i32 %i.br, i64 1
  %28 = shufflevector <2 x i32> %8, <2 x i32> poison, <8 x i32> <i32 poison, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %29 = shufflevector <8 x i32> %27, <8 x i32> %28, <8 x i32> <i32 9, i32 1, i32 poison, i32 poison, i32 4, i32 5, i32 6, i32 7>
  %30 = shufflevector <2 x i32> %i.bs, <2 x i32> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison> ; 2 uses
  %i.dz = shufflevector <8 x i32> %29, <8 x i32> %30, <8 x i32> <i32 0, i32 1, i32 1, i32 9, i32 4, i32 5, i32 6, i32 7>
  %i.ea = shufflevector <2 x i32> %i.bv, <2 x i32> %6, <8 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 0, i32 2, i32 2>
  ...
  %i.ee = shufflevector <2 x i32> %8, <2 x i32> poison, <8 x i32> <i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %i.eg = shufflevector <8 x i32> %i.ef, <8 x i32> %30, <8 x i32> <i32 0, i32 1, i32 1, i32 8, i32 4, i32 5, i32 6, i32 7>
  %invariant.op130 = add <8 x i32> %i.dy, %i.ed
...
.preheader25:                                     ; preds = %.preheader25.lr.ph.split.split, %._crit_edge34.split
  ...
  %i.ep = mul i32 %4, %indvar                     ; 2 uses
  %i.eq = add i32 %i.dg, %i.ep
  %i.er = add i32 %i.di, %i.ep
  %i.es = mul i32 %i.bw, %indvar                  ; 2 uses
  ...
  %i.ey = add <8 x i32> %i.dy, %i.ex
  %i.ez = add i32 %.02236, 1                      ; 3 uses
  %i.fa = mul nsw i32 %i.br, %.02236
  %i.fb = mul nsw i32 %i.bt, %.02236
  %i.fc = mul nsw i32 %4, %.02236                 ; 2 uses
  %i.fd = mul nsw i32 %i.bw, %.02236              ; 2 uses
  %i.fe = mul nsw i32 %i.bw, %i.ez                ; 2 uses
  %i.ff = mul nsw i32 %9, %.02236
...
.preheader:                                       ; preds = %.preheader25, %._crit_edge
  ...
  %i.fv = mul i32 %5, %indvar51                   ; 2 uses
  ...
  %i.gc = mul i32 %7, %indvar51                   ; 2 uses
  ...
  %i.gl = mul nsw i32 %5, %.02133                 ; 2 uses
  %i.gm = add i32 %.02133, 1                      ; 3 uses
  %i.gn = mul nsw i32 %5, %i.gm                   ; 2 uses
  %i.go = mul nsw i32 %7, %.02133                 ; 2 uses
  %i.gp = mul nsw i32 %10, %.02133
