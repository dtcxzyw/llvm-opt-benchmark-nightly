...
.preheader125:                                    ; preds = %.preheader125.preheader, %._crit_edge150
  %.1101151 = phi i32 [ %i.bj, %._crit_edge150 ], [ 0, %.preheader125.preheader ]
  br label %bb.l
...
._crit_edge150:                                   ; preds = %bb.l
  %i.bj = add nuw nsw i32 %.1101151, 1            ; 2 uses
...
bb.m:                                             ; preds = %.lr.ph174, %._crit_edge170.split
  %.093173 = phi float [ 0.000000e+00, %.lr.ph174 ], [ %i.ct, %._crit_edge170.split ] ; 2 uses
  %.094172 = phi i32 [ 0, %.lr.ph174 ], [ %.195.lcssa208, %._crit_edge170.split ] ; 3 uses
  %.2102171 = phi i32 [ 0, %.lr.ph174 ], [ %i.cu, %._crit_edge170.split ] ; 3 uses
...
._crit_edge164:                                   ; preds = %.lr.ph163.epil.preheader, %.lr.ph157.epil, %._crit_edge164.unr-lcssa
  ...
  br i1 %i.ch, label %._crit_edge170.split, label %.preheader.preheader
...
.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge168
  %indvars.iv197 = phi i64 [ %i.ci, %.preheader.preheader ], [ %indvars.iv.next198, %._crit_edge168 ] ; 3 uses
  br label %bb.p
...
bb.q:                                             ; preds = %bb.q, %bb.p
  %.0 = phi ptr [ %i.cq, %bb.p ], [ %i.cr, %bb.q ] ; 2 uses
  %i.cr = load ptr, ptr %.0, align 8, !tbaa !18   ; 2 uses
  %.not = icmp eq ptr %i.cr, null
  br i1 %.not, label %bb.r, label %bb.q, !llvm.loop !25

bb.r:                                             ; preds = %bb.q
  store ptr %i.cl, ptr %.0, align 8, !tbaa !18
...
._crit_edge168:                                   ; preds = %bb.r
  ...
  br i1 %i.cs, label %.preheader, label %._crit_edge170.split, !llvm.loop !27

._crit_edge170.split:                             ; preds = %._crit_edge168, %._crit_edge164, %._crit_edge164.thread
  %i.ct = phi float [ %7, %._crit_edge164.thread ], [ %i.cg, %._crit_edge164 ], [ %i.cg, %._crit_edge168 ]
  %.195.lcssa208 = phi i32 [ %.094172, %._crit_edge164.thread ], [ %.2.lcssa.lcssa, %._crit_edge164 ], [ %.2.lcssa.lcssa, %._crit_edge168 ] ; 2 uses
...
._crit_edge175:                                   ; preds = %._crit_edge170.split, %.preheader124
  %.094.lcssa = phi i32 [ 0, %.preheader124 ], [ %.195.lcssa208, %._crit_edge170.split ]
