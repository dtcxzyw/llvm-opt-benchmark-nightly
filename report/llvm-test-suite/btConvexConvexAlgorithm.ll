...
_ZNK10btQuadWordneERKS_.exit.thread.i:            ; preds = %._ZNK10btQuadWordneERKS_.exit.thread.i_crit_edge, %bb.c
  ...
  %i.aj = insertelement <2 x float> %i.ai, float %i.ad, i64 1 ; 2 uses
  %i.ak = fmul <2 x float> %i.aj, %i.aj
  %i.al = insertelement <2 x float> poison, float %i.ah, i64 0
  %i.am = insertelement <2 x float> %i.al, float %i.ag, i64 1 ; 2 uses
  %i.an = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.am, <2 x float> %i.am, <2 x float> %i.ak)
  %i.ao = insertelement <2 x float> poison, float %i.ab, i64 0
  %i.ap = insertelement <2 x float> %i.ao, float %i.ae, i64 1 ; 2 uses
  ...
  %i.as = insertelement <2 x float> %i.ar, float %i.af, i64 1 ; 2 uses
...
_ZNK10btQuadWordneERKS_.exit.thread.i23:          ; preds = %_ZN15btTransformUtil27calculateVelocityQuaternionERK9btVector3S2_RK12btQuaternionS5_fRS0_S6_.exit._ZNK10btQuadWordneERKS_.exit.thread.i23_crit_edge, %bb.f
  ...
  %i.du = insertelement <2 x float> poison, float %i.dm, i64 0
  %i.dv = insertelement <2 x float> %i.du, float %i.dp, i64 1 ; 2 uses
  %i.dw = fmul <2 x float> %i.dv, %i.dv
  %i.dx = insertelement <2 x float> poison, float %i.dt, i64 0
  %i.dy = insertelement <2 x float> %i.dx, float %i.ds, i64 1 ; 2 uses
  %i.dz = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dy, <2 x float> %i.dy, <2 x float> %i.dw)
  %i.ea = insertelement <2 x float> poison, float %i.dn, i64 0
  %i.eb = insertelement <2 x float> %i.ea, float %i.dq, i64 1 ; 2 uses
  %i.ec = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.eb, <2 x float> %i.eb, <2 x float> %i.dz)
  %i.ed = insertelement <2 x float> poison, float %i.do, i64 0
  %i.ee = insertelement <2 x float> %i.ed, float %i.dr, i64 1 ; 2 uses
