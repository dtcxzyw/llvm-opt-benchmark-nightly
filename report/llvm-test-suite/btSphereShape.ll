...
begin_hunk_0_@_ZNK13btSphereShape21calculateLocalInertiaEfR9btVector3:bb.a
  ...
  %3 = insertelement <4 x float> <float poison, float 0.000000e+00, float poison, float poison>, float %i.k, i64 0
  %i.l = shufflevector <4 x float> %3, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
