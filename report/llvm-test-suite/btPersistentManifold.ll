...
bb.d:                                             ; preds = %bb.c
  %i.j = tail call noundef zeroext i1 %i.i(ptr noundef nonnull %i.h), !inline_history !25 ; 0 uses
...
begin_hunk_1_@_ZN20btPersistentManifold16addManifoldPointERK15btManifoldPoint:bb.a
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(172) %i.n, ptr noundef nonnull align 8 dereferenceable(172) %1, i64 172, i1 false), !tbaa.struct !26
...
begin_hunk_2_@_ZN20btPersistentManifold20refreshContactPointsERK11btTransformS2_:bb.a
  ...
  store <2 x float> %.sroa.3.12.vec.insert.i, ptr %.sroa.412.0..sroa_idx, align 8, !tbaa !27
...
begin_hunk_3_@_ZN20btPersistentManifold20refreshContactPointsERK11btTransformS2_:bb.a
  ...
  store <2 x float> %.sroa.3.12.vec.insert.i35, ptr %.sroa.410.0..sroa_idx, align 8, !tbaa !27
...
bb.f:                                             ; preds = %bb.e
  %i.dp = tail call noundef zeroext i1 %i.do(ptr noundef nonnull %i.dn), !inline_history !30 ; 0 uses
...
bb.g:                                             ; preds = %_ZN20btPersistentManifold14clearUserCacheER15btManifoldPoint.exit.i
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(172) %i.dh, ptr noundef nonnull align 8 dereferenceable(172) %i.du, i64 172, i1 false), !tbaa.struct !26
...
bb.k:                                             ; preds = %bb.j
  %i.fj = tail call noundef zeroext i1 %i.fi(ptr noundef nonnull %i.fh), !inline_history !30 ; 0 uses
...
bb.l:                                             ; preds = %_ZN20btPersistentManifold14clearUserCacheER15btManifoldPoint.exit.i60
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(172) %i.dh, ptr noundef nonnull align 8 dereferenceable(172) %i.fo, i64 172, i1 false), !tbaa.struct !26
...
bb.m:                                             ; preds = %bb.h
  %i.fu = load ptr, ptr @gContactProcessedCallback, align 8, !tbaa !28 ; 2 uses
  %.not = icmp eq ptr %i.fu, null
  br i1 %.not, label %bb.o, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.fv = load ptr, ptr %i.x, align 8, !tbaa !31
  %i.fw = load ptr, ptr %i.y, align 8, !tbaa !32
...
!23 = !{!21, !5, i64 728}
!24 = !{!21, !13, i64 732}
!25 = !{ptr @_ZN20btPersistentManifold14clearUserCacheER15btManifoldPoint}
!26 = !{i64 0, i64 16, !27, i64 16, i64 16, !27, i64 32, i64 16, !27, i64 48, i64 16, !27, i64 64, i64 16, !27, i64 80, i64 4, !18, i64 84, i64 4, !18, i64 88, i64 4, !18, i64 92, i64 4, !4, i64 96, i64 4, !4, i64 100, i64 4, !4, i64 104, i64 4, !4, i64 112, i64 8, !28, i64 120, i64 4, !18, i64 124, i64 1, !29, i64 128, i64 4, !18, i64 132, i64 4, !18, i64 136, i64 4, !4, i64 140, i64 16, !27, i64 156, i64 16, !27}
!27 = !{!6, !6, i64 0}
!28 = !{!14, !14, i64 0}
!29 = !{!15, !15, i64 0}
!30 = distinct !{null, ptr @_ZN20btPersistentManifold14clearUserCacheER15btManifoldPoint}
!31 = !{!21, !14, i64 712}
!32 = !{!21, !14, i64 720}
end_hunk_9
