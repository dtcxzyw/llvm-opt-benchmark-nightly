...
bb.j:                                             ; preds = %bb.i, %bb.h
  ...
  %8 = getelementptr inbounds nuw i8, ptr %4, i64 284
  ...
  %9 = getelementptr inbounds nuw i8, ptr %4, i64 300
  ...
  %i.da = load float, ptr %i.au, align 4, !tbaa !11 ; 3 uses
  %i.db = load float, ptr %2, align 4, !tbaa !11  ; 2 uses
  %i.dc = load float, ptr %i.ay, align 4, !tbaa !11 ; 2 uses
  %i.dd = load <2 x float>, ptr %i.cb, align 4, !tbaa !11
  %10 = load float, ptr %8, align 4, !tbaa !11
  %11 = load <2 x float>, ptr %i.ce, align 4, !tbaa !11
  %12 = load float, ptr %9, align 4, !tbaa !11
  %13 = fmul float %i.da, %12
  %14 = fmul float %i.da, %10
  %i.de = shufflevector <2 x float> %i.dd, <2 x float> %11, <2 x i32> <i32 0, i32 2>
  ...
  %i.dh = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.de, <2 x float> %i.dg, <2 x float> %16)
  ...
  %17 = getelementptr inbounds nuw i8, ptr %6, i64 284
  ...
  %18 = getelementptr inbounds nuw i8, ptr %6, i64 300
  ...
  %i.fb = load <2 x float>, ptr %i.eb, align 4, !tbaa !11
  %19 = load float, ptr %17, align 4, !tbaa !11
  %i.fc = load float, ptr %i.au, align 4, !tbaa !11 ; 3 uses
  %i.fd = load float, ptr %2, align 4, !tbaa !11  ; 2 uses
  %i.fe = load float, ptr %i.ay, align 4, !tbaa !11 ; 2 uses
  %i.ff = load <2 x float>, ptr %i.ee, align 4, !tbaa !11
  %20 = load float, ptr %18, align 4, !tbaa !11
  %21 = fmul float %i.fc, %20
  %22 = fmul float %19, %i.fc
  %23 = shufflevector <2 x float> %i.fb, <2 x float> %i.ff, <2 x i32> <i32 0, i32 2>
  %24 = insertelement <2 x float> poison, float %i.fd, i64 0
  %25 = shufflevector <2 x float> %24, <2 x float> poison, <2 x i32> zeroinitializer
  %i.fg = insertelement <2 x float> poison, float %22, i64 0
  %26 = insertelement <2 x float> %i.fg, float %21, i64 1
  %i.fh = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %23, <2 x float> %25, <2 x float> %26)
...
bb.a:
  ...
  %3 = load <3 x float>, ptr %2, align 4, !tbaa !11 ; 5 uses
  %i.ai = load float, ptr %2, align 4, !tbaa !11
