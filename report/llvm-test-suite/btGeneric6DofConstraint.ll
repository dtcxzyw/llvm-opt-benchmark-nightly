...
bb.b:                                             ; preds = %bb.a
  ...
  %12 = getelementptr inbounds nuw i8, ptr %8, i64 16 ; 2 uses
  %i.j = getelementptr inbounds nuw i8, ptr %8, i64 8
  %.in = select i1 %.not, ptr %i.j, ptr %12
  %i.k = load ptr, ptr %.in, align 8, !tbaa !111  ; 3 uses
  br i1 %.not, label %bb.d, label %bb.c
