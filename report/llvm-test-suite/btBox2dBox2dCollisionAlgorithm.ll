...
begin_hunk_0_@_Z17b2CollidePolygonsP16btManifoldResultPK12btBox2dShapeRK11btTransformS3_S6_:bb.a
  ...
  %.0.i87.sroa.gep = getelementptr inbounds nuw i8, ptr %6, i64 20 ; 2 uses
  %.0.i.sroa.gep = getelementptr inbounds nuw i8, ptr %5, i64 20 ; 4 uses
...
begin_hunk_1_@_Z17b2CollidePolygonsP16btManifoldResultPK12btBox2dShapeRK11btTransformS3_S6_:bb.a
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %.0.i.sroa.gep, i8 0, i64 16, i1 false)
...
begin_hunk_3_@_Z17b2CollidePolygonsP16btManifoldResultPK12btBox2dShapeRK11btTransformS3_S6_:bb.a
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %.0.i87.sroa.gep, i8 0, i64 16, i1 false)
...
begin_hunk_4_@_Z17b2CollidePolygonsP16btManifoldResultPK12btBox2dShapeRK11btTransformS3_S6_:bb.a
  ...
  store <2 x float> %.sroa.3.12.vec.insert.i.i.i, ptr %i.ct, align 8, !tbaa !41
  br label %bb.e

bb.e:                                             ; preds = %bb.d, %bb.c
  %.0.i.sroa.phi = phi ptr [ %.0.i.sroa.gep, %bb.d ], [ %5, %bb.c ] ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  store <2 x float> %.sroa.0.4.vec.insert.i.i42.i, ptr %.0.i.sroa.phi, align 4
  %.sroa.18.20..sroa_idx = getelementptr inbounds nuw i8, ptr %.0.i.sroa.phi, i64 8
...
bb.i:                                             ; preds = %_ZL17ClipSegmentToLineP10ClipVertexS0_RK9btVector3f.exit
  %i.gy = load float, ptr %i.ct, align 8, !tbaa !40 ; 3 uses
...
begin_hunk_6_@_Z17b2CollidePolygonsP16btManifoldResultPK12btBox2dShapeRK11btTransformS3_S6_:bb.a
  ...
  %i.hg = load <2 x float>, ptr %.0.i.sroa.gep, align 4, !tbaa !40 ; 3 uses
...
bb.k:                                             ; preds = %bb.j, %bb.i
  %.0.i87.sroa.phi = phi ptr [ %.0.i87.sroa.gep, %bb.j ], [ %6, %bb.i ]
  %.0.i87 = phi i32 [ 1, %bb.j ], [ 0, %bb.i ]    ; 2 uses
  %i.hp = fcmp ugt float %i.hn, 0.000000e+00
  br i1 %i.hp, label %bb.m, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.hq = add nuw nsw i32 %.0.i87, 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %.0.i87.sroa.phi, ptr noundef nonnull readonly align 4 dereferenceable(20) %.0.i.sroa.gep, i64 20, i1 false), !tbaa.struct !42
  br label %bb.m
