...
begin_hunk_0_@nsis_inflate:bb.a
  ...
  %.lcssa102312961298 = phi i32 [ %.lcssa10231297, %bb.cp ], [ %.promoted, %bb.bq ] ; 10 uses
...
bb.bx:                                            ; preds = %._crit_edge1279
  ...
  %.0694.neg = select i1 %i.qr, i32 7, i32 %i.qs  ; 2 uses
  %.0694 = select i1 %i.qr, i32 11, i32 3
  %i.qt = add nuw nsw i32 %.0694.neg, %i.qg       ; 3 uses
...
begin_hunk_2_@nsis_inflate:bb.a
  ...
  %i.st = zext nneg i32 %.0694.neg to i64         ; 2 uses
  ...
  %i.sy = add nuw nsw i32 %i.sx, %.0694           ; 7 uses
...
bb.cm:                                            ; preds = %bb.cf
  br i1 %i.td, label %bb.cn, label %1
...
1:                                                ; preds = %bb.cm, %bb.cn
  %2 = phi i32 [ %i.uq, %bb.cn ], [ 0, %bb.cm ]   ; 6 uses
  %min.iters.check = icmp samesign ult i32 %i.sy, 12
  br i1 %min.iters.check, label %scalar.ph.preheader, label %bb.co

bb.co:                                            ; preds = %1
  %3 = select i1 %i.qr, i32 -11, i32 -3
  %i.ur = sub nuw nsw i32 %3, %i.sx
  %i.us = icmp ult i32 %i.ur, %.lcssa102312961298
  br i1 %i.us, label %scalar.ph.preheader, label %vector.ph
...
scalar.ph.preheader:                              ; preds = %bb.co, %1, %middle.block
  %.1697.ph = phi i32 [ %.lcssa102312961298, %bb.co ], [ %.lcssa102312961298, %1 ], [ %i.ut, %middle.block ] ; 2 uses
  %.1695.ph = phi i32 [ %i.sy, %bb.co ], [ %i.sy, %1 ], [ %i.uu, %middle.block ] ; 4 uses
...
begin_hunk_5_@nsis_inflate:bb.a
  ...
  store i32 %2, ptr %i.vd, align 4, !tbaa !21
