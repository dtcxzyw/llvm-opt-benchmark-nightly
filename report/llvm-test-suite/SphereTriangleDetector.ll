...
bb.c:                                             ; preds = %bb.b
  ...
  %12 = load float, ptr %i.s, align 4, !tbaa !19
  %13 = load float, ptr %i.i, align 8, !tbaa !19
  %14 = load float, ptr %i.x, align 8, !tbaa !19
  ...
  %i.ea = fmul <2 x float> %i.dz, %16
  %17 = insertelement <2 x float> poison, float %13, i64 0
  %i.eb = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.ef = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %19, <2 x float> %i.ee, <2 x float> %i.ed) ; 3 uses
...
bb.a:
  ...
  %6 = load float, ptr %4, align 4, !tbaa !19     ; 2 uses
  %i.ag = load float, ptr %3, align 4, !tbaa !19  ; 2 uses
