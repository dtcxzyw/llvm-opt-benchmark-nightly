...
bb.c:                                             ; preds = %bb.b
  ...
  %12 = load <4 x float>, ptr %i.u, align 8
  %13 = load <4 x float>, ptr %i.ae, align 4
  %14 = load <4 x float>, ptr %i.aj, align 8
  ...
  %15 = load <4 x float>, ptr %i.p, align 8
  ...
  %16 = extractelement <2 x float> %i.ej, i64 0
  %i.fd = extractelement <4 x float> %15, i64 0
  %i.fe = fadd float %16, %i.fd
