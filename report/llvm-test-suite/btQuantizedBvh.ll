...
bb.b:                                             ; preds = %bb.a
  ...
  %.sroa.13.0.copyload.i = load float, ptr %2, align 4
  %i.f = getelementptr inbounds nuw i8, ptr %2, i64 4
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 40
  %4 = getelementptr inbounds nuw i8, ptr %i.a, i64 4
  ...
  %5 = load <3 x float>, ptr %i.g, align 8, !tbaa !40 ; 2 uses
  %6 = shufflevector <3 x float> %5, <3 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 0> ; 3 uses
  %7 = load <3 x float>, ptr %i.h, align 8, !tbaa !40 ; 2 uses
  %8 = shufflevector <3 x float> %7, <3 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 0> ; 2 uses
  %9 = load <3 x float>, ptr %i.i, align 8, !tbaa !40 ; 2 uses
  %10 = shufflevector <3 x float> %9, <3 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 0>
  %i.j = load <2 x float>, ptr %i.f, align 4      ; 2 uses
  %11 = shufflevector <3 x float> %5, <3 x float> poison, <2 x i32> <i32 1, i32 2> ; 3 uses
  %i.k = fcmp olt <2 x float> %i.j, %11
  %i.l = select <2 x i1> %i.k, <2 x float> %11, <2 x float> %i.j ; 2 uses
  %12 = shufflevector <3 x float> %7, <3 x float> poison, <2 x i32> <i32 1, i32 2> ; 2 uses
  %i.m = fcmp olt <2 x float> %12, %i.l
  %i.n = select <2 x i1> %i.m, <2 x float> %12, <2 x float> %i.l
  %i.o = fsub <2 x float> %i.n, %11
  %13 = shufflevector <3 x float> %9, <3 x float> poison, <2 x i32> <i32 1, i32 2>
  %i.p = fmul <2 x float> %i.o, %13
  %i.q = fptoui <2 x float> %i.p to <2 x i16>
  %i.r = and <2 x i16> %i.q, splat (i16 -2)       ; 3 uses
  %14 = load <2 x float>, ptr %3, align 4
  %15 = insertelement <4 x float> poison, float %.sroa.13.0.copyload.i14, i64 2
  %16 = insertelement <4 x float> %15, float %.sroa.13.0.copyload.i, i64 3
  %17 = shufflevector <2 x float> %14, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %18 = shufflevector <4 x float> %17, <4 x float> %16, <4 x i32> <i32 0, i32 1, i32 6, i32 7> ; 2 uses
  %19 = fcmp olt <4 x float> %18, %6
  %20 = select <4 x i1> %19, <4 x float> %6, <4 x float> %18 ; 2 uses
  %21 = fcmp olt <4 x float> %8, %20
  %22 = select <4 x i1> %21, <4 x float> %8, <4 x float> %20
  %23 = fsub <4 x float> %22, %6
  %24 = fmul <4 x float> %23, %10
  %25 = fadd <4 x float> %24, <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float -0.000000e+00>
  %26 = fptoui <4 x float> %25 to <4 x i16>       ; 2 uses
  %27 = or <4 x i16> %26, <i16 1, i16 1, i16 1, i16 poison> ; 3 uses
  %28 = and <4 x i16> %26, <i16 poison, i16 poison, i16 poison, i16 -2>
  %29 = shufflevector <4 x i16> %27, <4 x i16> %28, <4 x i32> <i32 0, i32 1, i32 2, i32 7> ; 3 uses
  %30 = shufflevector <2 x i16> %i.r, <2 x i16> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %31 = shufflevector <4 x i16> %29, <4 x i16> %30, <2 x i32> <i32 3, i32 4>
  store <2 x i16> %31, ptr %i.a, align 4, !tbaa !50
  %32 = extractelement <2 x i16> %i.r, i64 1
  store i16 %32, ptr %4, align 4, !tbaa !50
  %33 = shufflevector <4 x i16> %27, <4 x i16> poison, <2 x i32> <i32 0, i32 1>
  store <2 x i16> %33, ptr %i.b, align 4, !tbaa !50
  %i.s = getelementptr inbounds nuw i8, ptr %i.b, i64 4
  %34 = extractelement <4 x i16> %27, i64 2
  store i16 %34, ptr %i.s, align 4, !tbaa !50
...
bb.d:                                             ; preds = %bb.h, %.lr.ph.i
  ...
  %.03235.i = phi ptr [ %i.z, %.lr.ph.i ], [ %.133.i, %bb.h ] ; 5 uses
  %i.aa = add nuw nsw i32 %.03136.i, 1            ; 2 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %.03235.i, i64 8
  %35 = load <2 x i16>, ptr %i.ab, align 2, !tbaa !50
  %36 = icmp ule <2 x i16> %i.r, %35              ; 2 uses
  %37 = load <4 x i16>, ptr %.03235.i, align 2, !tbaa !50 ; 2 uses
  %38 = icmp uge <4 x i16> %29, %37
  %39 = icmp ule <4 x i16> %29, %37
  ...
  %.not16.not25.i.i = and i1 %42, %43
  %44 = extractelement <2 x i1> %36, i64 0
  %.not13.not.i.i = and i1 %.not16.not25.i.i, %44 ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph, %bb.f
  ...
  %.03235 = phi ptr [ %i.e, %.lr.ph ], [ %.133, %bb.f ] ; 6 uses
  %i.i = add nuw nsw i32 %.03136, 1               ; 2 uses
  %i.j = load i16, ptr %2, align 2, !tbaa !50
  %i.k = load i16, ptr %i.f, align 2, !tbaa !50
  %6 = getelementptr inbounds nuw i8, ptr %.03235, i64 10
  %i.l = load i16, ptr %6, align 2, !tbaa !50
  %7 = icmp ule i16 %i.k, %i.l
  %8 = load i16, ptr %i.g, align 2, !tbaa !50
  %i.m = load i16, ptr %i.h, align 2, !tbaa !50
  %i.n = getelementptr inbounds nuw i8, ptr %.03235, i64 8
  %i.o = load i16, ptr %i.n, align 2, !tbaa !50
  %i.p = icmp ule i16 %i.m, %i.o
  %9 = load <2 x i16>, ptr %3, align 2, !tbaa !50
  %10 = load <4 x i16>, ptr %.03235, align 2, !tbaa !50 ; 2 uses
  %11 = shufflevector <2 x i16> %9, <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %12 = shufflevector <4 x i16> %11, <4 x i16> %10, <4 x i32> <i32 0, i32 poison, i32 1, i32 7>
  %13 = insertelement <4 x i16> %12, i16 %8, i64 1
  %14 = shufflevector <4 x i16> %10, <4 x i16> poison, <4 x i32> <i32 0, i32 2, i32 1, i32 poison>
  %15 = insertelement <4 x i16> %14, i16 %i.j, i64 3
  %16 = icmp ult <4 x i16> %13, %15
  %17 = bitcast <4 x i1> %16 to i4
  %18 = icmp eq i4 %17, 0
  %.not16.not25.i = and i1 %18, %7
  %.not13.not.i = and i1 %.not16.not25.i, %i.p    ; 2 uses
...
bb.d:                                             ; preds = %bb.h, %.lr.ph.i
  ...
  %.03235.i = phi ptr [ %i.am, %.lr.ph.i ], [ %.133.i, %bb.h ] ; 6 uses
  %i.an = add nuw nsw i32 %.03136.i, 1            ; 2 uses
  %i.ao = load i16, ptr %2, align 2, !tbaa !50
  %i.ap = load i16, ptr %i.e, align 2, !tbaa !50
  %4 = getelementptr inbounds nuw i8, ptr %.03235.i, i64 10
  %i.aq = load i16, ptr %4, align 2, !tbaa !50
  %5 = icmp ule i16 %i.ap, %i.aq
  %6 = load i16, ptr %i.f, align 2, !tbaa !50
  %i.ar = load i16, ptr %i.g, align 2, !tbaa !50
  %i.as = getelementptr inbounds nuw i8, ptr %.03235.i, i64 8
  %i.at = load i16, ptr %i.as, align 2, !tbaa !50
  %i.au = icmp ule i16 %i.ar, %i.at
  %7 = load <2 x i16>, ptr %3, align 2, !tbaa !50
  %8 = load <4 x i16>, ptr %.03235.i, align 2, !tbaa !50 ; 2 uses
  %9 = shufflevector <2 x i16> %7, <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %10 = shufflevector <4 x i16> %9, <4 x i16> %8, <4 x i32> <i32 0, i32 poison, i32 1, i32 7>
  %11 = insertelement <4 x i16> %10, i16 %6, i64 1
  %12 = shufflevector <4 x i16> %8, <4 x i16> poison, <4 x i32> <i32 0, i32 2, i32 1, i32 poison>
  %13 = insertelement <4 x i16> %12, i16 %i.ao, i64 3
  %14 = icmp ult <4 x i16> %11, %13
  %15 = bitcast <4 x i1> %14 to i4
  %16 = icmp eq i4 %15, 0
  %.not16.not25.i.i = and i1 %16, %5
  %.not13.not.i.i = and i1 %.not16.not25.i.i, %i.au ; 2 uses
