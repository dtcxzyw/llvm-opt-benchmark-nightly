...
_ZNK14btQuantizedBvh10getAabbMinEi.exit:          ; preds = %.lr.ph, %_ZNK14btQuantizedBvh10getAabbMinEi.exit
  ...
  %.sroa.0.0.copyload.i17 = load <2 x float>, ptr %i.av, align 4 ; 2 uses
  ...
  %4 = shufflevector <2 x float> %.sroa.0.0.copyload.i, <2 x float> %.sroa.3.0.copyload.i, <2 x i32> <i32 1, i32 2>
  %5 = shufflevector <2 x float> %.sroa.0.0.copyload.i17, <2 x float> %.sroa.3.0.copyload.i19, <2 x i32> <i32 1, i32 2>
...
_ZNK14btQuantizedBvh10getAabbMinEi.exit45:        ; preds = %.lr.ph152.split, %_ZNK14btQuantizedBvh10getAabbMinEi.exit45
  ...
  %.sroa.0.0.copyload.i36 = load <2 x float>, ptr %i.ds, align 4
  ...
  %7 = shufflevector <2 x float> %.sroa.0.0.copyload.i26, <2 x float> %.sroa.3.0.copyload.i28, <4 x i32> <i32 poison, i32 0, i32 1, i32 2>
  %i.du = insertelement <4 x float> %7, float 1.000000e+00, i64 0
  %8 = shufflevector <2 x float> %.sroa.0.0.copyload.i36, <2 x float> %.sroa.3.0.copyload.i38, <4 x i32> <i32 poison, i32 0, i32 1, i32 2>
  %i.dv = insertelement <4 x float> %8, float -0.000000e+00, i64 0
...
_ZNK14btQuantizedBvh10getAabbMinEi.exit.prol:     ; preds = %_ZNK14btQuantizedBvh10getAabbMinEi.exit.preheader
  ...
  %8 = extractelement <2 x float> %.sroa.3.0.copyload.i.prol, i64 0
  %9 = extractelement <2 x float> %.sroa.3.0.copyload.i42.prol, i64 0
  %i.r = fadd float %8, %9
...
_ZNK14btQuantizedBvh10getAabbMinEi.exit:          ; preds = %_ZNK14btQuantizedBvh10getAabbMinEi.exit.prol.loopexit, %_ZNK14btQuantizedBvh10getAabbMinEi.exit
  ...
  %10 = extractelement <2 x float> %.sroa.3.0.copyload.i, i64 0
  %11 = extractelement <2 x float> %.sroa.3.0.copyload.i42, i64 0
  %i.bl = fadd float %10, %11
  ...
  %12 = extractelement <2 x float> %.sroa.3.0.copyload.i.1, i64 0
  %13 = extractelement <2 x float> %.sroa.3.0.copyload.i42.1, i64 0
  %i.bu = fadd float %12, %13
