...
begin_hunk_1_@_ZN14btQuantizedBvh17calcSplittingAxisEii:bb.a
  ...
  %i.cg = load <4 x float>, ptr %i.bu, align 4
...
_ZNK14btQuantizedBvh10getAabbMinEi.exit45.us.preheader: ; preds = %.lr.ph152
  ...
  %i.ck = shufflevector <4 x float> %i.cj, <4 x float> %i.cg, <4 x i32> <i32 0, i32 1, i32 4, i32 5> ; 2 uses
  %i.cl = insertelement <4 x float> <float -0.000000e+00, float poison, float poison, float poison>, float %i.bw, i64 1
  %i.cm = shufflevector <4 x float> %i.cl, <4 x float> %i.ch, <4 x i32> <i32 0, i32 1, i32 4, i32 5> ; 2 uses
...
begin_hunk_3_@_ZN14btQuantizedBvh17calcSplittingAxisEii:bb.a
  ...
  %i.df = fdiv <4 x float> %i.de, %i.ck
  %i.dg = fadd <4 x float> %i.df, %i.cm
  %i.dh = load <2 x i16>, ptr %i.cz, align 2, !tbaa !50
  %i.di = insertelement <4 x float> <float -0.000000e+00, float poison, float poison, float poison>, float %i.cy, i64 1
  ...
  %i.dm = fdiv <4 x float> %i.dl, %i.ck
  %i.dn = fadd <4 x float> %i.dm, %i.cm
