...
begin_hunk_0_@_ZNK14btQuantizedBvh26reportAabbOverlappingNodexEP21btNodeOverlapCallbackRK9btVector3S4_:bb.a
  ...
  %20 = load <2 x float>, ptr %i.h, align 8, !tbaa !40 ; 4 uses
  ...
  %i.i = fcmp olt <2 x float> %36, %17
  %i.j = select <2 x i1> %i.i, <2 x float> %17, <2 x float> %36 ; 2 uses
  %i.k = fcmp olt <2 x float> %20, %i.j
  %i.l = select <2 x i1> %i.k, <2 x float> %20, <2 x float> %i.j
  %i.m = fsub <2 x float> %i.l, %17
  %i.n = fmul <2 x float> %24, %i.m
  %i.o = fadd <2 x float> %i.n, splat (float 1.000000e+00)
  %i.p = fptoui <2 x float> %i.o to <2 x i16>
  %i.q = or <2 x i16> %i.p, splat (i16 1)         ; 3 uses
  store <2 x i16> %i.q, ptr %i.b, align 4, !tbaa !50
  %i.r = getelementptr inbounds nuw i8, ptr %i.b, i64 4
  store i16 %35, ptr %i.r, align 4, !tbaa !50
...
.lr.ph.i:                                         ; preds = %bb.c
  ...
  %39 = extractelement <2 x i16> %i.q, i64 0
  %40 = extractelement <2 x i16> %i.q, i64 1
  br label %bb.d

bb.d:                                             ; preds = %bb.h, %.lr.ph.i
  %.037.i = phi i32 [ 0, %.lr.ph.i ], [ %.1.i, %bb.h ] ; 2 uses
  %.03136.i = phi i32 [ 0, %.lr.ph.i ], [ %i.z, %bb.h ]
  %.03235.i = phi ptr [ %i.y, %.lr.ph.i ], [ %.133.i, %bb.h ] ; 9 uses
  %i.z = add nuw nsw i32 %.03136.i, 1             ; 2 uses
  %i.aa = getelementptr inbounds nuw i8, ptr %.03235.i, i64 6
  %i.ab = load i16, ptr %i.aa, align 2, !tbaa !50
  %41 = icmp ule i16 %37, %i.ab
  %i.ac = load i16, ptr %.03235.i, align 2, !tbaa !50
  %42 = icmp uge i16 %39, %i.ac
  ...
  %i.ad = getelementptr inbounds nuw i8, ptr %.03235.i, i64 8
  %49 = load i16, ptr %i.ad, align 2, !tbaa !50
