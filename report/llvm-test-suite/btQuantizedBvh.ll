...
_Z8btSetMinIfEvRT_RKS0_.exit.i:
  ...
  %8 = extractelement <2 x float> %i.f, i64 0
  %9 = extractelement <2 x float> %i.g, i64 0
  ...
  %10 = fcmp olt float %i.d, %i.b
  %.sroa.13.0 = select i1 %10, float %i.b, float %i.d
  %11 = fcmp olt <2 x float> %i.g, %i.f
  %12 = select <2 x i1> %11, <2 x float> %i.f, <2 x float> %i.g
  %13 = load <2 x float>, ptr %5, align 4, !tbaa !40
  %14 = shufflevector <2 x float> %12, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.al = insertelement <4 x float> %14, float %.sroa.13.0, i64 2
  %15 = insertelement <4 x float> poison, float %i.af, i64 2
  %i.am = insertelement <4 x float> %15, float %i.ab, i64 3
  %16 = shufflevector <2 x float> %13, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %17 = shufflevector <4 x float> %16, <4 x float> %i.am, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %18 = load <3 x float>, ptr %i.ag, align 8, !tbaa !40 ; 2 uses
  %19 = shufflevector <3 x float> %18, <3 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 0> ; 3 uses
  %20 = load <3 x float>, ptr %i.ai, align 8, !tbaa !40 ; 2 uses
  %21 = shufflevector <3 x float> %20, <3 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 0> ; 2 uses
  %22 = load <3 x float>, ptr %i.aj, align 8, !tbaa !40 ; 2 uses
  %23 = shufflevector <3 x float> %22, <3 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 0>
  %24 = fcmp olt float %i.b, %i.d
  %25 = fcmp olt <2 x float> %i.f, %i.g           ; 2 uses
  %26 = extractelement <2 x i1> %25, i64 0
  %.sroa.083.0 = select i1 %26, float %8, float %9
  %27 = insertelement <4 x float> %i.al, float %.sroa.083.0, i64 3
  %28 = fadd <4 x float> %27, %17                 ; 2 uses
  %i.an = fcmp olt <4 x float> %28, %19
  %i.ao = select <4 x i1> %i.an, <4 x float> %19, <4 x float> %28 ; 2 uses
  %i.ap = fcmp olt <4 x float> %21, %i.ao
  %i.aq = select <4 x i1> %i.ap, <4 x float> %21, <4 x float> %i.ao
  %i.ar = fsub <4 x float> %i.aq, %19
  %i.as = fmul <4 x float> %i.ar, %23
  ...
  %29 = shufflevector <2 x i1> %25, <2 x i1> poison, <2 x i32> <i32 1, i32 poison>
  %30 = insertelement <2 x i1> %29, i1 %24, i64 1
  %i.av = shufflevector <2 x float> %i.f, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.aw = insertelement <2 x float> %i.av, float %i.b, i64 1
  %31 = shufflevector <2 x float> %i.g, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %32 = insertelement <2 x float> %31, float %i.d, i64 1
  %i.ax = select <2 x i1> %30, <2 x float> %i.aw, <2 x float> %32
  %i.ay = load <2 x float>, ptr %i.ac, align 4, !tbaa !40
  %i.az = fadd <2 x float> %i.ax, %i.ay           ; 2 uses
  %i.ba = shufflevector <3 x float> %18, <3 x float> poison, <2 x i32> <i32 1, i32 2> ; 3 uses
  %i.bb = fcmp olt <2 x float> %i.az, %i.ba
  %i.bc = select <2 x i1> %i.bb, <2 x float> %i.ba, <2 x float> %i.az ; 2 uses
  %i.bd = shufflevector <3 x float> %20, <3 x float> poison, <2 x i32> <i32 1, i32 2> ; 2 uses
  %i.be = fcmp olt <2 x float> %i.bd, %i.bc
  %i.bf = select <2 x i1> %i.be, <2 x float> %i.bd, <2 x float> %i.bc
  %i.bg = fsub <2 x float> %i.bf, %i.ba
  %i.bh = shufflevector <3 x float> %22, <3 x float> poison, <2 x i32> <i32 1, i32 2>
