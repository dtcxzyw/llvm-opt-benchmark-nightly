...
bb.e:                                             ; preds = %bb.d
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 248 ; 5 uses
...
_ZN20btAlignedObjectArrayI16btBvhSubtreeInfoE20initializeFromBufferEPvii.exit: ; preds = %.thread224, %.thread, %bb.f, %bb.g
  %.pn = phi i64 [ %i.bl, %.thread ], [ %i.ck, %bb.f ], [ %i.ck, %bb.g ], [ %i.bn, %.thread224 ]
  %i.cl = phi i32 [ %i.t, %.thread ], [ %.pre209.pre, %bb.f ], [ %.pre209.pre, %bb.g ], [ %i.t, %.thread224 ] ; 2 uses
  %.0135223 = getelementptr inbounds nuw i8, ptr %i.ad, i64 %.pn ; 2 uses
