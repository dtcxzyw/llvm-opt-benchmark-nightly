...
_Z8btSetMinIfEvRT_RKS0_.exit.i:
  ...
  %9 = load <2 x float>, ptr %5, align 4, !tbaa !40
  ...
  %i.aw = shufflevector <4 x float> %10, <4 x float> %i.av, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
...
bb.c:                                             ; preds = %bb.b
  ...
  %11 = load float, ptr %i.aj, align 8, !tbaa !40
  %12 = insertelement <2 x float> poison, float %11, i64 0
  %i.ep = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> zeroinitializer
  %i.eq = fdiv <2 x float> %i.eo, %i.ep
  %13 = load float, ptr %i.ag, align 8, !tbaa !40
  %14 = insertelement <2 x float> poison, float %13, i64 0
  %i.er = shufflevector <2 x float> %14, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.eu = insertelement <2 x float> %16, float %i.et, i64 1
