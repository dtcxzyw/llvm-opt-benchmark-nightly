...
bb.a:
  %i.a = tail call noalias dereferenceable_or_null(240) ptr @calloc(i64 noundef 240, i64 noundef 1) #6 ; 2 uses
  %i.b = icmp eq ptr %i.a, null
  br i1 %i.b, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  tail call void @no_mem_exit(ptr noundef nonnull @.str) #7
  br label %bb.c
...
bb.a:
  %i.a = tail call noalias dereferenceable_or_null(2132) ptr @calloc(i64 noundef 2132, i64 noundef 1) #6 ; 2 uses
  %i.b = icmp eq ptr %i.a, null
  br i1 %i.b, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  tail call void @no_mem_exit(ptr noundef nonnull @.str.1) #7
  br label %bb.c
...
define dso_local void @FreePPS(ptr noundef captures(none) %0) local_unnamed_addr #3 {
bb.a:
...
define dso_local void @FreeSPS(ptr noundef captures(none) %0) local_unnamed_addr #5 {
bb.a:
...
!7 = !{!"Simple C/C++ TBAA"}
!8 = !{!9, !10, i64 176}
!9 = !{!"", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !6, i64 24, !5, i64 56, !5, i64 60, !5, i64 64, !6, i64 68, !6, i64 100, !6, i64 132, !5, i64 164, !5, i64 168, !5, i64 172, !10, i64 176, !5, i64 184, !5, i64 188, !5, i64 192, !5, i64 196, !5, i64 200, !5, i64 204, !5, i64 208, !5, i64 212, !5, i64 216, !5, i64 220, !5, i64 224, !5, i64 228, !5, i64 232}
