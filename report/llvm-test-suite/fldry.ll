...
begin_hunk_1_@Proc0:bb.a
  ...
  br i1 %exitcond.not, label %bb.b, label %.lr.ph.i, !llvm.loop !18

bb.b:                                             ; preds = %.lr.ph.i
  store i8 65, ptr @Char1Glob, align 1, !tbaa !20
  store i32 1, ptr @BoolGlob, align 4, !tbaa !4
  store i8 66, ptr @Char2Glob, align 1, !tbaa !20
...
bb.a:
  %i.a = load i8, ptr @Char1Glob, align 1, !tbaa !20
