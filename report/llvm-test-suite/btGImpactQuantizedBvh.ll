...
bb.b:                                             ; preds = %.lr.ph, %bb.q
  ...
  %4 = load float, ptr %i.e, align 8, !tbaa !16
  %i.u = getelementptr inbounds nuw i8, ptr %i.s, i64 2
  %5 = load float, ptr %i.d, align 8, !tbaa !16
  ...
  %i.ao = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ap = fdiv <2 x float> %i.an, %i.ao
  %7 = insertelement <2 x float> poison, float %5, i64 0
  %i.aq = shufflevector <2 x float> %7, <2 x float> poison, <2 x i32> zeroinitializer
...
bb.b:                                             ; preds = %bb.a
  ...
  %4 = load float, ptr %i.bq, align 4, !tbaa !16
...
bb.c:                                             ; preds = %bb.b
  ...
  %6 = load float, ptr %i.cx, align 4, !tbaa !16
