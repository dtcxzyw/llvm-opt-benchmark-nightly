...
polybench_alloc_data.exit:                        ; preds = %bb.a
  ...
  %i.m = load ptr, ptr %i.c, align 8, !tbaa !11   ; 8 uses
...
polybench_alloc_data.exit26:                      ; preds = %polybench_alloc_data.exit
  ...
  %i.t = load ptr, ptr %i.b, align 8, !tbaa !11   ; 12 uses
...
polybench_alloc_data.exit28:                      ; preds = %polybench_alloc_data.exit26
  ...
  %i.aa = load ptr, ptr %i.a, align 8, !tbaa !11  ; 12 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <2 x double> %i.at, ptr %i.au, align 8, !tbaa !9
...
vector.body101:                                   ; preds = %vector.body101, %vector.ph98
  ...
  store <2 x double> %i.bt, ptr %i.bu, align 8, !tbaa !9
  %i.bv = getelementptr inbounds nuw [8 x i8], ptr %i.bn, i64 %index102
  store <2 x double> %i.bt, ptr %i.bv, align 8, !tbaa !9
  ...
  br i1 %i.bw, label %middle.block106, label %vector.body101, !llvm.loop !17
...
scalar.ph97:                                      ; preds = %.preheader.i, %scalar.ph97
  ...
  br i1 %exitcond56.not.i, label %middle.block106, label %scalar.ph97, !llvm.loop !18
...
.preheader36.i:                                   ; preds = %.preheader36.i.preheader, %bb.f
  %indvars.iv57.i31 = phi i64 [ %indvars.iv.next58.i36, %bb.f ], [ 0, %.preheader36.i.preheader ] ; 5 uses
  ...
  %i.cj = mul nuw nsw i64 %indvars.iv55.i, 8000   ; 2 uses
  %scevgep108 = getelementptr i8, ptr %i.t, i64 %i.cj
  %scevgep109 = getelementptr i8, ptr %i.aa, i64 %i.cj
...
vector.body135:                                   ; preds = %vector.body135, %vector.ph133
  ...
  %wide.load137 = load <2 x double>, ptr %i.cl, align 8, !tbaa !9
  %wide.load138 = load <2 x double>, ptr %i.cm, align 8, !tbaa !9
  %i.cn = fmul <2 x double> %wide.load137, splat (double 1.200000e+00)
  %i.co = fmul <2 x double> %wide.load138, splat (double 1.200000e+00)
  store <2 x double> %i.cn, ptr %i.cl, align 8, !tbaa !9
  store <2 x double> %i.co, ptr %i.cm, align 8, !tbaa !9
  %index.next139 = add nuw i64 %index136, 4       ; 2 uses
  %i.cp = icmp eq i64 %index.next139, %n.vec134
  br i1 %i.cp, label %middle.block140, label %vector.body135, !llvm.loop !20
...
scalar.ph131:                                     ; preds = %scalar.ph131.preheader, %scalar.ph131
  ...
  br i1 %exitcond.not.i34, label %.preheader35.i, label %scalar.ph131, !llvm.loop !21
...
vector.ph122:                                     ; preds = %.preheader.i35
  %i.dk = load double, ptr %i.di, align 8, !tbaa !9, !alias.scope !51
  ...
  %i.dl = load double, ptr %i.dj, align 8, !tbaa !9, !alias.scope !52
...
vector.body123:                                   ; preds = %vector.body123, %vector.ph122
  ...
  %i.dp = load double, ptr %i.dn, align 8, !tbaa !9, !alias.scope !53
  %i.dq = load double, ptr %i.do, align 8, !tbaa !9, !alias.scope !53
  ...
  %i.dw = load double, ptr %i.du, align 8, !tbaa !9, !alias.scope !54
  %i.dx = load double, ptr %i.dv, align 8, !tbaa !9, !alias.scope !54
  ...
  %wide.load = load <2 x double>, ptr %i.ed, align 8, !tbaa !9, !alias.scope !55, !noalias !56
  %i.ee = fadd <2 x double> %wide.load, %i.ec
  store <2 x double> %i.ee, ptr %i.ed, align 8, !tbaa !9, !alias.scope !55, !noalias !56
  %index.next129 = add nuw i64 %index124, 2       ; 2 uses
  %i.ef = icmp eq i64 %index.next129, %n.vec
  br i1 %i.ef, label %middle.block130, label %vector.body123, !llvm.loop !28
...
scalar.ph121:                                     ; preds = %scalar.ph121.preheader, %scalar.ph121
  ...
  %i.eg = load double, ptr %gep.i, align 8, !tbaa !9
  %i.eh = fmul double %i.eg, 1.500000e+00
  %i.ei = load double, ptr %i.di, align 8, !tbaa !9
  %gep39.i = getelementptr inbounds nuw [8000 x i8], ptr %invariant.gep38.i, i64 %indvars.iv46.i
  %i.ej = load double, ptr %gep39.i, align 8, !tbaa !9
  %i.ek = fmul double %i.ej, 1.500000e+00
  %i.el = load double, ptr %i.dj, align 8, !tbaa !9
  ...
  store double %i.eq, ptr %i.eo, align 8, !tbaa !9
  ...
  br i1 %exitcond50.not.i, label %.loopexit189, label %scalar.ph121, !llvm.loop !29
...
.loopexit189:                                     ; preds = %scalar.ph121, %middle.block130
  ...
  br i1 %exitcond54.not.i, label %bb.f, label %.preheader.i35, !llvm.loop !30
...
bb.f:                                             ; preds = %.loopexit189
  ...
  br i1 %exitcond62.not.i, label %.preheader36.i37.preheader, label %.preheader36.i, !llvm.loop !31
...
.preheader36.i37:                                 ; preds = %.preheader36.i37.preheader, %bb.g
  %indvars.iv57.i38 = phi i64 [ %indvars.iv.next58.i55, %bb.g ], [ 0, %.preheader36.i37.preheader ] ; 5 uses
  %indvars.iv55.i39 = phi i64 [ %indvars.iv.next56.i56, %bb.g ], [ 1, %.preheader36.i37.preheader ] ; 10 uses
  ...
  %i.ev = mul nuw nsw i64 %indvars.iv55.i39, 8000 ; 2 uses
  %scevgep145 = getelementptr i8, ptr %i.t, i64 %i.ev
  %scevgep146 = getelementptr i8, ptr %i.aa, i64 %i.ev
...
vector.body181:                                   ; preds = %vector.body181, %vector.ph179
  ...
  %wide.load183 = load <2 x double>, ptr %i.ex, align 8, !tbaa !9
  %wide.load184 = load <2 x double>, ptr %i.ey, align 8, !tbaa !9
  %i.ez = fmul <2 x double> %wide.load183, splat (double 1.200000e+00)
  %i.fa = fmul <2 x double> %wide.load184, splat (double 1.200000e+00)
  store <2 x double> %i.ez, ptr %i.ex, align 8, !tbaa !9
  store <2 x double> %i.fa, ptr %i.ey, align 8, !tbaa !9
  %index.next185 = add nuw i64 %index182, 4       ; 2 uses
  %i.fb = icmp eq i64 %index.next185, %n.vec180
  br i1 %i.fb, label %middle.block186, label %vector.body181, !llvm.loop !32
...
scalar.ph177:                                     ; preds = %scalar.ph177.preheader, %scalar.ph177
  ...
  store double %i.ft, ptr %i.fr, align 8, !tbaa !9
  ...
  br i1 %exitcond.not.i42, label %.preheader35.i43, label %scalar.ph177, !llvm.loop !33
...
vector.ph164:                                     ; preds = %.preheader.i44
  %i.fw = load double, ptr %i.fu, align 8, !tbaa !9, !alias.scope !57
  ...
  %i.fx = load double, ptr %i.fv, align 8, !tbaa !9, !alias.scope !58
...
vector.body166:                                   ; preds = %vector.body166, %vector.ph164
  ...
  %i.gb = load double, ptr %i.fz, align 8, !tbaa !9, !alias.scope !59
  %i.gc = load double, ptr %i.ga, align 8, !tbaa !9, !alias.scope !59
  ...
  %i.gj = load double, ptr %i.gh, align 8, !tbaa !9, !alias.scope !60
  %i.gk = load double, ptr %i.gi, align 8, !tbaa !9, !alias.scope !60
  ...
  %wide.load172 = load <2 x double>, ptr %i.gq, align 8, !tbaa !9, !alias.scope !61, !noalias !62
  %i.gr = fadd <2 x double> %wide.load172, %i.gp
  store <2 x double> %i.gr, ptr %i.gq, align 8, !tbaa !9, !alias.scope !61, !noalias !62
  %index.next173 = add nuw i64 %index167, 2       ; 2 uses
  %i.gs = icmp eq i64 %index.next173, %n.vec165
  br i1 %i.gs, label %middle.block174, label %vector.body166, !llvm.loop !40
...
scalar.ph162:                                     ; preds = %scalar.ph162.preheader, %scalar.ph162
  ...
  store double %i.he, ptr %i.hc, align 8, !tbaa !9
  ...
  br i1 %exitcond50.not.i52, label %.loopexit, label %scalar.ph162, !llvm.loop !41
...
.loopexit:                                        ; preds = %scalar.ph162, %middle.block174
  ...
  br i1 %exitcond54.not.i54, label %bb.g, label %.preheader.i44, !llvm.loop !42
...
bb.g:                                             ; preds = %.loopexit
  ...
  br i1 %exitcond62.not.i57, label %.preheader.i58, label %.preheader36.i37, !llvm.loop !43
...
bb.h:                                             ; preds = %.critedge.i.2, %.preheader.i58
  ...
  %i.hi = load double, ptr %i.hh, align 8, !tbaa !9 ; 2 uses
  %i.hj = getelementptr inbounds nuw [8 x i8], ptr %i.hg, i64 %indvars.iv.i59
  %i.hk = load double, ptr %i.hj, align 8, !tbaa !9 ; 2 uses
...
check_FP.exit.thread:                             ; preds = %.critedge.i.1, %.critedge.i, %bb.h
  ...
  %i.hq = load ptr, ptr @stderr, align 8, !tbaa !13
...
.critedge.i.1:                                    ; preds = %.critedge.i
  ...
  %i.ic = load double, ptr %i.ib, align 8, !tbaa !9 ; 2 uses
