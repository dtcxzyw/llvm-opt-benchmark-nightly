...
vector.ph125:                                     ; preds = %.preheader.i35
  %i.dr = load double, ptr %i.dq, align 8, !tbaa !8, !alias.scope !25
  ...
  %i.ds = load double, ptr %i.dp, align 8, !tbaa !8, !alias.scope !28
...
begin_hunk_1_@main:bb.a
  ...
  %i.ei = fmul <2 x double> %i.eh, %broadcast.splat129.a
  %i.ej = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ea, <2 x double> %broadcast.splat131, <2 x double> %i.ei)
...
vector.ph171:                                     ; preds = %.preheader.i44
  %i.gf = load double, ptr %i.ge, align 8, !tbaa !8, !alias.scope !43
  ...
  %i.gg = load double, ptr %i.gd, align 8, !tbaa !8, !alias.scope !46
...
begin_hunk_3_@main:bb.a
  ...
  %i.gp = fmul <2 x double> %i.go, %broadcast.splat177
...
begin_hunk_4_@main:bb.a
  ...
  %i.gx = fmul <2 x double> %i.gw, %broadcast.splat179.a
