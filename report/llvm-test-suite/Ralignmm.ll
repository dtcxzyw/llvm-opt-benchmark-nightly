...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.o = trunc i64 %i.n to i32                    ; 29 uses
...
.lr.ph633:                                        ; preds = %bb.w
  ...
  %16 = insertelement <4 x double> poison, double %i.ue, i64 0
  %17 = shufflevector <4 x double> %16, <4 x double> poison, <4 x i32> zeroinitializer ; 2 uses
  %i.ux = add i64 %i.n, 4294967295
  %18 = and i64 %i.ux, 4294967295                 ; 2 uses
  %19 = add nuw nsw i64 %18, 1                    ; 2 uses
  %min.iters.check872 = icmp samesign ult i64 %18, 7
  %n.vec875 = and i64 %19, 8589934584             ; 4 uses
  %i.uy = shl nuw nsw i64 %n.vec875, 2            ; 2 uses
  %i.uz = trunc i64 %n.vec875 to i32
  %i.va = sub i32 %i.o, %i.uz
  %cmp.n886 = icmp eq i64 %19, %n.vec875
  br label %bb.x
...
bb.ag:                                            ; preds = %.peel.next, %bb.ar
  ...
  %i.abr = fmul <4 x double> %i.abq, %17
