Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/llvm-test-suite/original/zcontrol?download=true
inline.NumInlined: 4
begin_hunk_0
...
define dso_local range(i32 -17, 2) i32 @zexec(ptr nofree noundef readonly captures(address) %0) #0 {
bb.a:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define dso_local range(i32 -20, 2) i32 @zif(ptr nofree noundef readonly captures(none) %0) #0 {
bb.a:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define dso_local range(i32 -20, 2) i32 @zifelse(ptr nofree noundef readonly captures(none) %0) #0 {
bb.a:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define dso_local range(i32 -20, 2) i32 @zrepeat(ptr nofree noundef readonly captures(none) %0) #0 {
bb.a:
  %i.a = getelementptr inbounds i8, ptr %0, i64 -16 ; 2 uses
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define dso_local noundef i32 @repeat_continue(ptr nofree readnone captures(none) %0) #0 {
bb.a:
  %1 = alloca %struct.ref_s, align 8              ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %1)
...
bb.b:                                             ; preds = %bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.j, ptr noundef nonnull align 8 dereferenceable(16) %1, i64 16, i1 false), !tbaa.struct !11
  br label %bb.d
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define dso_local range(i32 -17, 2) i32 @zloop(ptr nofree noundef readonly captures(address) %0) #0 {
bb.a:
  %i.a = load ptr, ptr @osp_nargs, align 16, !tbaa !8
  %i.b = icmp ult ptr %0, %i.a
  br i1 %i.b, label %bb.d, label %bb.b
...
define dso_local range(i32 -8, 2) i32 @zexit(ptr nofree readnone captures(none) %0) #4 {
bb.a:
  %i.a = load ptr, ptr @esp, align 8, !tbaa !8    ; 2 uses
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define dso_local range(i32 -17, 2) i32 @zstopped(ptr nofree noundef readonly captures(address) %0) #0 {
bb.a:
  %i.a = load ptr, ptr @osp_nargs, align 16, !tbaa !8
  %i.b = icmp ult ptr %0, %i.a
  br i1 %i.b, label %bb.d, label %bb.b
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define dso_local range(i32 -20, 2) i32 @zexecstack(ptr nofree noundef captures(none) %0) #0 {
bb.a:
  %i.a = load ptr, ptr @esp, align 8, !tbaa !8    ; 4 uses
