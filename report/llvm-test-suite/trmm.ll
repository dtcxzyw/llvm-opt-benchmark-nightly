...
begin_hunk_0_@main:bb.a
  ...
  %broadcast.splatinsert31 = insertelement <2 x i64> poison, i64 %indvars.iv38.i, i64 0
...
vector.body33:                                    ; preds = %vector.body33, %vector.ph30
  ...
  %vec.ind35 = phi <2 x i64> [ <i64 0, i64 1>, %vector.ph30 ], [ %vec.ind.next37, %vector.body33 ] ; 2 uses
  %i.p = add nuw nsw <2 x i64> %vec.ind35, %broadcast.splat32
  %i.q = trunc nuw nsw <2 x i64> %i.p to <2 x i32>
  %i.r = urem <2 x i32> %i.q, splat (i32 1000)
  %i.s = uitofp nneg <2 x i32> %i.r to <2 x double>
  %i.t = fdiv <2 x double> %i.s, splat (double 1.000000e+03)
  %i.u = getelementptr inbounds nuw [8 x i8], ptr %i.o, i64 %index34
...
bb.d:                                             ; preds = %bb.d, %.preheader.i21
  ...
  %5 = trunc i64 %3 to i8
  %6 = trunc i64 %4 to i8
  %7 = insertelement <2 x i64> poison, i64 %i.ci, i64 0
  %8 = insertelement <2 x i64> %7, i64 %i.cj, i64 1
  %9 = trunc <2 x i64> %8 to <2 x i8>
  %10 = shufflevector <2 x i8> %9, <2 x i8> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.cl = insertelement <8 x i8> %10, i8 %6, i64 2
  %11 = insertelement <8 x i8> %i.cl, i8 %5, i64 3
  %12 = insertelement <8 x i8> %11, i8 %.sroa.0.4.extract.trunc.i.i, i64 4
  %13 = insertelement <8 x i8> %12, i8 %.sroa.0.5.extract.trunc.i.i, i64 5
  %14 = insertelement <8 x i8> %13, i8 %.sroa.0.6.extract.trunc.i.i, i64 6
  %i.cm = insertelement <8 x i8> %14, i8 %i.ck, i64 7
  ...
  store <16 x i8> %i.cp, ptr %i.ch, align 1, !tbaa !25
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.cr = call i32 @fputs(ptr noundef nonnull %i.cc, ptr noundef %i.cq) #12 ; 0 uses
