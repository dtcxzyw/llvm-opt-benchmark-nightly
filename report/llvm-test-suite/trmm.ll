...
bb.d:                                             ; preds = %bb.d, %.preheader.i21
  ...
  %i.ci = load i64, ptr %i.cf, align 8, !tbaa !8  ; 4 uses
  %i.cj = lshr i64 %i.ci, 56
  %i.ck = trunc nuw i64 %i.cj to i8
  %2 = insertelement <2 x i64> poison, i64 %i.ci, i64 0
  ...
  %6 = insertelement <4 x i64> poison, i64 %i.ci, i64 0
  ...
  %i.cl = insertelement <8 x i8> poison, i8 %.sroa.0.0.extract.trunc.i.i, i64 0
  %10 = shufflevector <4 x i8> %9, <4 x i8> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %11 = shufflevector <8 x i8> %i.cl, <8 x i8> %10, <8 x i32> <i32 0, i32 8, i32 9, i32 10, i32 11, i32 poison, i32 poison, i32 poison>
  ...
  %i.cm = insertelement <8 x i8> %13, i8 %i.ck, i64 7
