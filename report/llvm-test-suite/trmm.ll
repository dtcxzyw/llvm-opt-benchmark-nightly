...
begin_hunk_0_@main:bb.a
  ...
  %2 = add nuw nsw i64 %indvars.iv38.i, 1200
...
vector.body:                                      ; preds = %vector.body, %._crit_edge.i
  ...
  %i.af = sub nuw nsw <2 x i64> %broadcast.splat, %vec.ind
  %i.ag = trunc nuw nsw <2 x i64> %i.af to <2 x i32>
  %i.ah = urem <2 x i32> %i.ag, splat (i32 1200)
  ...
  %i.an = urem <2 x i32> %i.am, splat (i32 1200)
