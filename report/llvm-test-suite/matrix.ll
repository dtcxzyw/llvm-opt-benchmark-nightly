...
.preheader.us.preheader:                          ; preds = %bb.a
  ...
  br i1 %i.e, label %.preheader.us.epil.preheader, label %.preheader.us.preheader.new
...
.preheader.us:                                    ; preds = %.preheader.us, %.preheader.us.preheader.new
  %indvars.iv = phi i64 [ 0, %.preheader.us.preheader.new ], [ %indvars.iv.next.7, %.preheader.us ] ; 9 uses
  %niter = phi i64 [ 0, %.preheader.us.preheader.new ], [ %niter.next.7, %.preheader.us ]
