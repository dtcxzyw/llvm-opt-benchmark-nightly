...
begin_hunk_0_@_Z8mkmatrixii:bb.a
}
...
define dso_local void @_Z10zeromatrixiiPPi(i32 noundef %0, i32 noundef %1, ptr nofree noundef readonly captures(none) %2) local_unnamed_addr #2 {
bb.a:
...
.preheader.preheader:                             ; preds = %bb.a
  ...
  %i.d = shl nuw nsw i64 %i.c, 2                  ; 9 uses
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader.new
  %indvars.iv = phi i64 [ 0, %.preheader.preheader.new ], [ %indvars.iv.next.7, %.preheader ] ; 9 uses
  ...
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.ab, i8 0, i64 %i.d, i1 false), !tbaa !4
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8 ; 2 uses
  %niter.next.7 = add i64 %niter, 8               ; 2 uses
  %niter.ncmp.7 = icmp eq i64 %niter.next.7, %unroll_iter
  br i1 %niter.ncmp.7, label %._crit_edge11.split.loopexit.unr-lcssa, label %.preheader, !llvm.loop !17

._crit_edge11.split.loopexit.unr-lcssa:           ; preds = %.preheader
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %._crit_edge11.split, label %.preheader.epil.preheader

.preheader.epil.preheader:                        ; preds = %._crit_edge11.split.loopexit.unr-lcssa, %.preheader.preheader
  %indvars.iv.epil.init = phi i64 [ 0, %.preheader.preheader ], [ %indvars.iv.next.7, %._crit_edge11.split.loopexit.unr-lcssa ]
...
.preheader.epil:                                  ; preds = %.preheader.epil, %.preheader.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge11.split, label %.preheader.epil, !llvm.loop !18

._crit_edge11.split:                              ; preds = %._crit_edge11.split.loopexit.unr-lcssa, %.preheader.epil, %bb.a
  ret void
}
...
define dso_local noundef ptr @_Z5mmultiiPPiS0_S0_(i32 noundef %0, i32 noundef %1, ptr nofree noundef readonly captures(none) %2, ptr nofree noundef readonly captures(none) %3, ptr nofree noundef readonly returned captures(ret: address, provenance) %4) local_unnamed_addr #5 {
bb.a:
  %i.a = icmp sgt i32 %0, 0
  %i.b = icmp sgt i32 %1, 0
  %or.cond = and i1 %i.a, %i.b
  br i1 %or.cond, label %.preheader24.preheader, label %._crit_edge.split

.preheader24.preheader:                           ; preds = %bb.a
  %wide.trip.count39 = zext nneg i32 %0 to i64
  %wide.trip.count34 = zext nneg i32 %1 to i64    ; 3 uses
  %xtraiter = and i64 %wide.trip.count34, 3       ; 3 uses
  %i.c = icmp ult i32 %1, 4
  %unroll_iter = and i64 %wide.trip.count34, 2147483644
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  %lcmp.mod43 = icmp ne i64 %xtraiter, 0
  br label %.preheader24

.preheader24:                                     ; preds = %.preheader24.preheader, %._crit_edge28.split.us
  %indvars.iv36 = phi i64 [ 0, %.preheader24.preheader ], [ %indvars.iv.next37, %._crit_edge28.split.us ] ; 3 uses
  %i.d = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv36
  %i.e = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %indvars.iv36
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !8
  %i.g = load ptr, ptr %i.d, align 8, !tbaa !8    ; 5 uses
  br label %.preheader.us

.preheader.us:                                    ; preds = %._crit_edge.us, %.preheader24
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %._crit_edge.us ], [ 0, %.preheader24 ] ; 7 uses
...
.preheader.us.new:                                ; preds = %.preheader.us, %.preheader.us.new
  ...
  %.026.us = phi i32 [ %i.am, %.preheader.us.new ], [ 0, %.preheader.us ]
  ...
  %i.l = getelementptr inbounds nuw [4 x i8], ptr %i.k, i64 %indvars.iv31
  %i.m = load i32, ptr %i.l, align 4, !tbaa !4
  %i.n = mul nsw i32 %i.m, %i.i
  %i.o = add nsw i32 %i.n, %.026.us
  ...
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !8
  %i.t = getelementptr inbounds nuw [4 x i8], ptr %i.s, i64 %indvars.iv31
  ...
  %i.ab = getelementptr inbounds nuw [4 x i8], ptr %i.aa, i64 %indvars.iv31
  ...
  %i.aj = getelementptr inbounds nuw [4 x i8], ptr %i.ai, i64 %indvars.iv31
  ...
  br i1 %niter.ncmp.3, label %._crit_edge.us.unr-lcssa, label %.preheader.us.new, !llvm.loop !21
...
.epil.preheader:                                  ; preds = %._crit_edge.us.unr-lcssa, %.preheader.us
  ...
  %.026.us.epil.init = phi i32 [ 0, %.preheader.us ], [ %i.am, %._crit_edge.us.unr-lcssa ]
...
bb.b:                                             ; preds = %bb.b, %.epil.preheader
  ...
  %.026.us.epil = phi i32 [ %.026.us.epil.init, %.epil.preheader ], [ %i.au, %bb.b ]
  ...
  %i.ar = getelementptr inbounds nuw [4 x i8], ptr %i.aq, i64 %indvars.iv31
  %i.as = load i32, ptr %i.ar, align 4, !tbaa !4
  %i.at = mul nsw i32 %i.as, %i.ao
  %i.au = add nsw i32 %i.at, %.026.us.epil        ; 2 uses
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %._crit_edge.us, label %bb.b, !llvm.loop !22

._crit_edge.us:                                   ; preds = %bb.b, %._crit_edge.us.unr-lcssa
  %.lcssa = phi i32 [ %i.am, %._crit_edge.us.unr-lcssa ], [ %i.au, %bb.b ]
  %i.av = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %indvars.iv31
  store i32 %.lcssa, ptr %i.av, align 4, !tbaa !4
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1 ; 2 uses
  %exitcond35.not = icmp eq i64 %indvars.iv.next32, %wide.trip.count34
  br i1 %exitcond35.not, label %._crit_edge28.split.us, label %.preheader.us, !llvm.loop !23

._crit_edge28.split.us:                           ; preds = %._crit_edge.us
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1 ; 2 uses
  %exitcond40.not = icmp eq i64 %indvars.iv.next37, %wide.trip.count39
  br i1 %exitcond40.not, label %._crit_edge.split, label %.preheader24, !llvm.loop !24

._crit_edge.split:                                ; preds = %._crit_edge28.split.us, %bb.a
  ret ptr %4
}

; Function Attrs: mustprogress norecurse uwtable
define dso_local noundef i32 @main(i32 noundef %0, ptr nofree noundef readonly captures(none) %1) local_unnamed_addr #6 {
bb.a:
  %i.a = icmp eq i32 %0, 2
...
_Z8mkmatrixii.exit36.preheader:                   ; preds = %.lr.ph.us.i26
  ...
  br i1 %i.bx, label %.preheader24.i.preheader.preheader, label %_Z8mkmatrixii.exit36._crit_edge

.preheader24.i.preheader.preheader:               ; preds = %_Z8mkmatrixii.exit36.preheader
