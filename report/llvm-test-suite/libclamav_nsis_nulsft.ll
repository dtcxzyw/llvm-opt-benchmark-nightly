...
bb.k:                                             ; preds = %select.unfold.a, %bb.j
...
bb.ak:                                            ; preds = %bb.aj
  ...
  br i1 %.not33, label %select.unfold.a, label %.thread.thread
...
begin_hunk_2
  ...
  br i1 %.not31, label %bb.ap, label %select.unfold.a

bb.ap:                                            ; preds = %bb.ao
  %i.en = call i32 @unlink(ptr noundef nonnull %i.ae) #9 ; 0 uses
  br label %select.unfold.a

select.unfold.a:                                  ; preds = %bb.ak, %cli_nsis_unpack.exit, %bb.ap, %bb.ao
  %.1 = phi i32 [ %.0, %bb.ap ], [ %.0, %bb.ao ], [ %i.dx, %cli_nsis_unpack.exit ], [ 0, %bb.ak ]
...
.thread.thread.loopexit62:                        ; preds = %select.unfold.a
  br label %.thread.thread

.thread.thread:                                   ; preds = %bb.ak, %select.unfold.a, %.thread.thread.loopexit62, %.thread.thread41
  %5 = phi i32 [ %.1.fr, %.thread.thread.loopexit62 ], [ 1, %.thread.thread41 ], [ 0, %select.unfold.a ], [ 0, %bb.ak ]
  %i.eo = getelementptr inbounds nuw i8, ptr %4, i64 40258 ; 2 uses
  %i.ep = load i8, ptr %i.eo, align 2, !tbaa !50
...
bb.at:                                            ; preds = %bb.as, %bb.ar, %bb.aq
  store i8 0, ptr %i.eo, align 2, !tbaa !50
...
bb.au:                                            ; preds = %nsis_shutdown.exit.i
  ...
  %i.ew = load ptr, ptr %i.ev, align 8, !tbaa !51 ; 2 uses
...
bb.ay:                                            ; preds = %bb.e, %bb.ax, %bb.g, %bb.d
  %.019 = phi i32 [ -100, %bb.d ], [ -118, %bb.g ], [ %5, %bb.ax ], [ -118, %bb.e ]
...
bb.ag:                                            ; preds = %bb.ae
  ...
  store i32 %i.by, ptr %i.bz, align 8, !tbaa !55
  %i.ca = getelementptr inbounds nuw i8, ptr %0, i64 48
  store ptr %i.bc, ptr %i.ca, align 8, !tbaa !56
  %i.cb = getelementptr inbounds nuw i8, ptr %0, i64 64 ; 5 uses
  store ptr %i.b, ptr %i.cb, align 8, !tbaa !57
  %i.cc = getelementptr inbounds nuw i8, ptr %0, i64 56 ; 2 uses
  store i32 8192, ptr %i.cc, align 8, !tbaa !58
...
bb.ai:                                            ; preds = %bb.ah
  %i.cf = load ptr, ptr %i.cb, align 8, !tbaa !57
...
bb.am:                                            ; preds = %bb.al
  ...
  %i.cs = load i64, ptr %i.cr, align 8, !tbaa !54 ; 3 uses
...
.loopexit:                                        ; preds = %bb.ah, %.thread
  ...
  %i.db = load ptr, ptr %i.cb, align 8, !tbaa !57
  ...
  %i.dh = load ptr, ptr %i.cb, align 8, !tbaa !57
...
.sink.split.i:                                    ; preds = %bb.ax, %bb.aw, %bb.av
  ...
  store i8 %.sink.i, ptr %i.ea, align 2, !tbaa !50
  br label %bb.ay
...
begin_hunk_16
  ...
  store ptr %i.eg, ptr %i.dm, align 8, !tbaa !51
...
bb.bc:                                            ; preds = %bb.ba
  %i.er = load ptr, ptr %i.dm, align 8, !tbaa !51
  %i.es = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.et = getelementptr inbounds nuw i8, ptr %0, i64 48
  store ptr %i.er, ptr %i.et, align 8, !tbaa !56
  store i32 %i.en, ptr %i.es, align 8, !tbaa !55
  br label %bb.bd
...
bb.bf:                                            ; preds = %bb.bd
  ...
  store ptr %i.b, ptr %i.ey, align 8, !tbaa !57
  %i.ez = getelementptr inbounds nuw i8, ptr %0, i64 56 ; 3 uses
  store i32 4, ptr %i.ez, align 8, !tbaa !58
...
bb.bg:                                            ; preds = %bb.bf
  %i.fd = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.bi:                                            ; preds = %bb.bh
  %i.fj = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.bk:                                            ; preds = %bb.bj
  %i.fp = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.bm:                                            ; preds = %bb.bl
  %i.fv = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.bo:                                            ; preds = %bb.bn
  %i.gb = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.bq:                                            ; preds = %bb.bp
  %i.gh = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.bs:                                            ; preds = %bb.br
  %i.gn = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.bu:                                            ; preds = %bb.bt
  %i.gt = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.bw:                                            ; preds = %bb.bv
  %i.gz = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.by:                                            ; preds = %bb.bx
  %i.hf = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.ca:                                            ; preds = %bb.bz
  %i.hl = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.cc:                                            ; preds = %bb.cb
  %i.hr = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.ce:                                            ; preds = %bb.cd
  %i.hx = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.cg:                                            ; preds = %bb.cf
  %i.id = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.ci:                                            ; preds = %bb.ch
  %i.ij = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.ck:                                            ; preds = %bb.cj
  %i.ip = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.cm:                                            ; preds = %bb.cl
  %i.iv = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.co:                                            ; preds = %bb.cn
  %i.jb = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.cq:                                            ; preds = %bb.cp
  %i.jh = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.cs:                                            ; preds = %bb.cr
  %i.jn = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.cu:                                            ; preds = %bb.ct
  %i.jt = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.cw:                                            ; preds = %.critedge197
  ...
  %i.kb = load i64, ptr %i.ka, align 8, !tbaa !54 ; 3 uses
...
bb.cy:                                            ; preds = %bb.cw, %.critedge197
  ...
  store i32 %i.kg, ptr %i.ez, align 8, !tbaa !58
...
bb.cz:                                            ; preds = %.lr.ph
  %i.ki = load ptr, ptr %i.ey, align 8, !tbaa !57
...
begin_hunk_42
  ...
  store i32 %i.ku, ptr %i.ez, align 8, !tbaa !58
  br label %bb.dd
...
.loopexit219:                                     ; preds = %.lr.ph, %.critedge.thread
  ...
  %i.kz = load ptr, ptr %i.ey, align 8, !tbaa !57
  ...
  %i.lf = load ptr, ptr %i.ey, align 8, !tbaa !57
...
bb.df:                                            ; preds = %.loopexit219
  store i8 1, ptr %i.c, align 1, !tbaa !52
  br label %.critedge.thread213
...
bb.d:                                             ; preds = %bb.a
  ...
  store i32 8, ptr %i.f, align 8, !tbaa !60
  ...
  store i32 0, ptr %i.h, align 4, !tbaa !62
...
bb.b:                                             ; preds = %bb.a
  ...
  store i32 %i.d, ptr %i.f, align 8, !tbaa !66
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 48 ; 2 uses
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !56
  store ptr %i.h, ptr %i.e, align 8, !tbaa !67
  ...
  store i32 %i.j, ptr %i.k, align 8, !tbaa !68
  ...
  %i.p = load i32, ptr %i.f, align 8, !tbaa !66
  store i32 %i.p, ptr %i.c, align 8, !tbaa !55
  %i.q = load ptr, ptr %i.e, align 8, !tbaa !67
  store ptr %i.q, ptr %i.g, align 8, !tbaa !56
  %i.r = load i32, ptr %i.k, align 8, !tbaa !68
  store i32 %i.r, ptr %i.i, align 8, !tbaa !58
  %i.s = load ptr, ptr %i.n, align 8, !tbaa !69
  store ptr %i.s, ptr %i.l, align 8, !tbaa !57
  br label %bb.e
...
bb.c:                                             ; preds = %bb.a
  ...
  store i32 %i.u, ptr %i.w, align 8, !tbaa !70
  ...
  %i.ab = load i32, ptr %i.aa, align 8, !tbaa !58
  %i.ac = getelementptr inbounds nuw i8, ptr %0, i64 200 ; 2 uses
  store i32 %i.ab, ptr %i.ac, align 8, !tbaa !72
  ...
  %i.ah = load i32, ptr %i.w, align 8, !tbaa !70
  store i32 %i.ah, ptr %i.t, align 8, !tbaa !55
  %i.ai = load ptr, ptr %i.z, align 8, !tbaa !71
  store ptr %i.ai, ptr %i.x, align 8, !tbaa !56
  %i.aj = load i32, ptr %i.ac, align 8, !tbaa !72
  store i32 %i.aj, ptr %i.aa, align 8, !tbaa !58
  %i.ak = load ptr, ptr %i.af, align 8, !tbaa !73
  store ptr %i.ak, ptr %i.ad, align 8, !tbaa !57
  br label %bb.e
...
bb.d:                                             ; preds = %bb.a
  ...
  store ptr %i.av, ptr %i.aw, align 8, !tbaa !77
  ...
  %i.ay = load i32, ptr %i.ao, align 8, !tbaa !74
  store i32 %i.ay, ptr %i.al, align 8, !tbaa !55
  %i.az = load ptr, ptr %i.an, align 8, !tbaa !75
  store ptr %i.az, ptr %i.ap, align 8, !tbaa !56
  %i.ba = load i32, ptr %i.at, align 8, !tbaa !76
  store i32 %i.ba, ptr %i.ar, align 8, !tbaa !58
  %i.bb = load ptr, ptr %i.aw, align 8, !tbaa !77
  store ptr %i.bb, ptr %i.au, align 8, !tbaa !57
  br label %bb.e
...
bb.a:
  ...
  %i.b = load i8, ptr %i.a, align 2, !tbaa !50
...
bb.e:                                             ; preds = %bb.d, %bb.c, %bb.b
  store i8 0, ptr %i.a, align 2, !tbaa !50
  br label %bb.f
