...
bb.ab:                                            ; preds = %nsis_detcomp.exit71.i.i, %bb.z
  ...
  %i.cp = add i32 %.1.i.i, %.0.i.i
  %i.cq = add i32 %i.cp, 4                        ; 3 uses
...
bb.o:                                             ; preds = %bb.m
  ...
  %i.ae = load i32, ptr %i.ad, align 8, !tbaa !37 ; 4 uses
...
bb.u:                                             ; preds = %bb.s
  %i.ap = sub i32 %i.ae, %i.aj
  %2 = add i32 %i.ap, -4
  store i32 %2, ptr %i.ad, align 8, !tbaa !37
