...
begin_hunk_6_@_ZN16btCollisionWorld17objectQuerySingleEPK13btConvexShapeRK11btTransformS5_P17btCollisionObjectPK16btCollisionShapeS5_RNS_20ConvexResultCallbackEf:bb.a
  ...
  %i.hn = getelementptr inbounds nuw i8, ptr %19, i64 16
  store float %i.hg, ptr %i.hn, align 8
  %.sroa.9142.16..sroa_idx = getelementptr inbounds nuw i8, ptr %19, i64 20
  store float %i.hm, ptr %.sroa.9142.16..sroa_idx, align 4
  %.sroa.10143.16..sroa_idx = getelementptr inbounds nuw i8, ptr %19, i64 24
  store float %i.ha, ptr %.sroa.10143.16..sroa_idx, align 8
