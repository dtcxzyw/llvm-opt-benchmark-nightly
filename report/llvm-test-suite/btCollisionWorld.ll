...
bb.w:                                             ; preds = %bb.q
  ...
  %26 = shufflevector <2 x float> %i.bn, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 poison>
  %27 = insertelement <4 x float> %26, float 1.000000e+00, i64 3
  ...
  %28 = shufflevector <2 x float> %i.bm, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 poison>
  ...
  %30 = shufflevector <2 x float> %i.bo, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 poison>
  ...
  %i.jj = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ji, <4 x float> %29, <4 x float> %i.jg)
  ...
  %i.jm = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.jl, <4 x float> %31, <4 x float> %i.jj)
  ...
  %32 = shufflevector <2 x float> %i.bm, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 poison>
  %33 = insertelement <4 x float> %32, float -0.000000e+00, i64 3
  %i.ju = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.jt, <4 x float> %33, <4 x float> %i.jr)
  ...
  %34 = shufflevector <2 x float> %i.bo, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 poison>
  %35 = insertelement <4 x float> %34, float -0.000000e+00, i64 3
  %i.jx = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.jw, <4 x float> %35, <4 x float> %i.ju)
...
bb.b:                                             ; preds = %bb.a
  ...
  %2 = shufflevector <4 x float> %i.ac, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 3>
