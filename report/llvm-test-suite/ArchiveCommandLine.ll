...
.preheader.us.i.i.a:                              ; preds = %.noexc
  ...
  %.pre816 = load ptr, ptr %i.nc, align 8, !tbaa !16
  br label %bb.cd
...
.critedge.us.i.i:                                 ; preds = %bb.cd
  ...
  br i1 %i.ni, label %.noexc285, label %bb.cd, !llvm.loop !90
...
.preheader.us.i.i292.a:                           ; preds = %.noexc285
  ...
  %.pre817 = load ptr, ptr %i.nc, align 8, !tbaa !16
  br label %bb.ce
...
.critedge.us.i.i295:                              ; preds = %bb.ce
  ...
  br i1 %i.nn, label %_ZL15AddNameToCensorRN9NWildcard7CCensorERK11CStringBaseIwEbN13NRecursedType5EEnumE.exit, label %bb.ce, !llvm.loop !90
