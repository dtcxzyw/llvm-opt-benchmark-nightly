...
vector.body1072:                                  ; preds = %vector.body1072, %vector.ph1070
  ...
  %wide.load1074 = load <4 x i32>, ptr %i.ky, align 4, !tbaa !45
  %wide.load1075 = load <4 x i32>, ptr %i.kz, align 4, !tbaa !45
  %i.la = getelementptr inbounds nuw [4 x i8], ptr %i.ks, i64 %index1073 ; 2 uses
  %i.lb = getelementptr inbounds nuw i8, ptr %i.la, i64 16
  store <4 x i32> %wide.load1074, ptr %i.la, align 4, !tbaa !45
  store <4 x i32> %wide.load1075, ptr %i.lb, align 4, !tbaa !45
  %index.next1076 = add nuw i64 %index1073, 8     ; 2 uses
  %i.lc = icmp eq i64 %index.next1076, %n.vec1071
  br i1 %i.lc, label %middle.block1077, label %vector.body1072, !llvm.loop !87
...
scalar.ph1068.prol:                               ; preds = %scalar.ph1068.preheader, %scalar.ph1068.prol
  ...
  store i32 %i.le, ptr %i.lf, align 4, !tbaa !45
  ...
  br i1 %prol.iter1581.cmp.not, label %scalar.ph1068.prol.loopexit, label %scalar.ph1068.prol, !llvm.loop !88
...
scalar.ph1068:                                    ; preds = %scalar.ph1068.prol.loopexit, %scalar.ph1068
  ...
  store i32 %i.lk, ptr %i.ll, align 4, !tbaa !45
  ...
  %i.ln = load i32, ptr %i.lm, align 4, !tbaa !45
  %i.lo = getelementptr inbounds nuw [4 x i8], ptr %i.ks, i64 %indvars.iv.next.i.i246
  store i32 %i.ln, ptr %i.lo, align 4, !tbaa !45
  ...
  %i.lq = load i32, ptr %i.lp, align 4, !tbaa !45
  %i.lr = getelementptr inbounds nuw [4 x i8], ptr %i.ks, i64 %indvars.iv.next.i.i246.1
  store i32 %i.lq, ptr %i.lr, align 4, !tbaa !45
  ...
  %i.lt = load i32, ptr %i.ls, align 4, !tbaa !45
  %i.lu = getelementptr inbounds nuw [4 x i8], ptr %i.ks, i64 %indvars.iv.next.i.i246.2
  store i32 %i.lt, ptr %i.lu, align 4, !tbaa !45
  ...
  br i1 %exitcond.not.i.i247.3, label %._crit_edge.thread.i.i241, label %scalar.ph1068, !llvm.loop !89
...
._crit_edge.thread.i.i241:                        ; preds = %scalar.ph1068.prol.loopexit, %scalar.ph1068, %middle.block1077, %._crit_edge.i.i240
  ...
  %.pre.i242 = load i32, ptr %i.kg, align 8, !tbaa !42
  br label %bb.bo
...
bb.bo:                                            ; preds = %._crit_edge.thread.i.i241, %._crit_edge.i.i240, %bb.bn
  ...
  store ptr %i.ks, ptr %i.ke, align 8, !tbaa !16
  %i.lw = sext i32 %i.lv to i64
  %i.lx = getelementptr inbounds [4 x i8], ptr %i.ks, i64 %i.lw
  store i32 0, ptr %i.lx, align 4, !tbaa !45
  store i32 %i.kk, ptr %i.kl, align 4, !tbaa !46
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i233:     ; preds = %bb.bo, %bb.bm
  ...
  %i.lz = load ptr, ptr %i.kd, align 8, !tbaa !16
  br label %bb.bp
...
bb.bp:                                            ; preds = %bb.bp, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i233
  ...
  %i.mb = load i32, ptr %.0.i.i235, align 4, !tbaa !45 ; 2 uses
  %i.mc = getelementptr inbounds nuw i8, ptr %.04.i.i234, i64 4
  store i32 %i.mb, ptr %.04.i.i234, align 4, !tbaa !45
  %.not.i.i236 = icmp eq i32 %i.mb, 0
  br i1 %.not.i.i236, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i237, label %bb.bp, !llvm.loop !0

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i237:         ; preds = %bb.bp
  %i.md = load i32, ptr %i.ki, align 8, !tbaa !42
  store i32 %i.md, ptr %i.kg, align 8, !tbaa !42
...
bb.bq:                                            ; preds = %_ZN11CStringBaseIwEaSERKS0_.exit248
  ...
  %i.mf = load i32, ptr %i.me, align 4, !tbaa !43
...
_ZNK9NWildcard7CCensor14AllAreRelativeEv.exit:    ; preds = %bb.bq
  ...
  %i.mi = load ptr, ptr %i.mh, align 8, !tbaa !40
  %i.mj = load ptr, ptr %i.mi, align 8, !tbaa !41
  %i.mk = getelementptr inbounds nuw i8, ptr %i.mj, i64 8
  %i.ml = load i32, ptr %i.mk, align 8, !tbaa !42
...
bb.bt:                                            ; preds = %_ZNK9NWildcard7CCensor14AllAreRelativeEv.exit
  ...
  store i64 8, ptr %i.mq, align 8, !tbaa !53
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTV13CObjectVectorIN9NWildcard5CPairEE, i64 16), ptr %9, align 8, !tbaa !55
...
bb.bu:                                            ; preds = %bb.bt
  %i.ms = load i8, ptr %i.mr, align 8, !tbaa !35, !range !36, !noundef !37
...
bb.bz:                                            ; preds = %bb.by
  %i.my = load i8, ptr %i.mx, align 8, !tbaa !35, !range !36, !noundef !37
...
.noexc:                                           ; preds = %bb.cc
  ...
  %i.ne = load i32, ptr %i.nd, align 8, !tbaa !42 ; 2 uses
...
bb.cd:                                            ; preds = %.preheader.us.i.i.a
  %21 = load ptr, ptr %i.nc, align 8, !tbaa !16
  %i.ng = getelementptr inbounds nuw [4 x i8], ptr %21, i64 %indvars.iv35.i.i
  %i.nh = load i32, ptr %i.ng, align 4, !tbaa !45
...
.critedge.us.i.i:                                 ; preds = %bb.cd, %.preheader.us.i.i.a
  ...
  br i1 %i.ni, label %.noexc285, label %.preheader.us.i.i.a, !llvm.loop !90

.noexc285:                                        ; preds = %.critedge.us.i.i, %.noexc
  %i.nj = load i32, ptr %i.nd, align 8, !tbaa !42 ; 2 uses
...
bb.ce:                                            ; preds = %.preheader.us.i.i292.a
  %24 = load ptr, ptr %i.nc, align 8, !tbaa !16
...
.critedge.us.i.i295:                              ; preds = %bb.ce, %.preheader.us.i.i292.a
  ...
  br i1 %i.nn, label %_ZL15AddNameToCensorRN9NWildcard7CCensorERK11CStringBaseIwEbN13NRecursedType5EEnumE.exit, label %.preheader.us.i.i292.a, !llvm.loop !90
...
bb.cg:                                            ; preds = %_ZL15AddNameToCensorRN9NWildcard7CCensorERK11CStringBaseIwEbN13NRecursedType5EEnumE.exit
  ...
  %i.nq = load i8, ptr %i.np, align 1, !tbaa !38, !range !36, !noundef !37
...
bb.ci:                                            ; preds = %bb.ch
  ...
  %i.nu = load ptr, ptr %i.nt, align 8, !tbaa !40
  %i.nv = load ptr, ptr %i.nu, align 8, !tbaa !41 ; 2 uses
  ...
  %i.nz = load i32, ptr %i.ny, align 8, !tbaa !42 ; 2 uses
...
.noexc322:                                        ; preds = %bb.cj
  ...
  %i.oi = load i32, ptr %i.nx, align 4, !tbaa !46
  %i.oj = icmp sgt i32 %i.oi, 0
  %.pre4.i306 = load i32, ptr %i.nw, align 8, !tbaa !42 ; 5 uses
  br i1 %i.oj, label %.preheader.i.i312, label %bb.ck

.preheader.i.i312:                                ; preds = %.noexc322
  %i.ok = icmp sgt i32 %.pre4.i306, 0
  %.pre.i.i313 = load ptr, ptr %10, align 8, !tbaa !16 ; 9 uses
...
vector.body1468:                                  ; preds = %vector.body1468, %vector.ph1466
  ...
  %wide.load1470 = load <4 x i32>, ptr %i.om, align 4, !tbaa !45
  %wide.load1471 = load <4 x i32>, ptr %i.on, align 4, !tbaa !45
  %i.oo = getelementptr inbounds nuw [4 x i8], ptr %i.og, i64 %index1469 ; 2 uses
  %i.op = getelementptr inbounds nuw i8, ptr %i.oo, i64 16
  store <4 x i32> %wide.load1470, ptr %i.oo, align 4, !tbaa !45
  store <4 x i32> %wide.load1471, ptr %i.op, align 4, !tbaa !45
  %index.next1472 = add nuw i64 %index1469, 8     ; 2 uses
  %i.oq = icmp eq i64 %index.next1472, %n.vec1467
  br i1 %i.oq, label %middle.block1473, label %vector.body1468, !llvm.loop !91
...
scalar.ph1464.prol:                               ; preds = %scalar.ph1464.preheader, %scalar.ph1464.prol
  ...
  %i.os = load i32, ptr %i.or, align 4, !tbaa !45
  %i.ot = getelementptr inbounds nuw [4 x i8], ptr %i.og, i64 %indvars.iv.i.i319.prol
  store i32 %i.os, ptr %i.ot, align 4, !tbaa !45
  ...
  br i1 %prol.iter1635.cmp.not, label %scalar.ph1464.prol.loopexit, label %scalar.ph1464.prol, !llvm.loop !92
...
scalar.ph1464:                                    ; preds = %scalar.ph1464.prol.loopexit, %scalar.ph1464
  ...
  %i.oy = load i32, ptr %i.ox, align 4, !tbaa !45
  %i.oz = getelementptr inbounds nuw [4 x i8], ptr %i.og, i64 %indvars.iv.i.i319
  store i32 %i.oy, ptr %i.oz, align 4, !tbaa !45
  ...
  %i.pb = load i32, ptr %i.pa, align 4, !tbaa !45
  %i.pc = getelementptr inbounds nuw [4 x i8], ptr %i.og, i64 %indvars.iv.next.i.i320
  store i32 %i.pb, ptr %i.pc, align 4, !tbaa !45
  ...
  %i.pe = load i32, ptr %i.pd, align 4, !tbaa !45
  %i.pf = getelementptr inbounds nuw [4 x i8], ptr %i.og, i64 %indvars.iv.next.i.i320.1
  store i32 %i.pe, ptr %i.pf, align 4, !tbaa !45
  ...
  store i32 %i.ph, ptr %i.pi, align 4, !tbaa !45
  ...
  br i1 %exitcond.not.i.i321.3, label %._crit_edge.thread.i.i315, label %scalar.ph1464, !llvm.loop !93
...
._crit_edge.thread.i.i315:                        ; preds = %scalar.ph1464.prol.loopexit, %scalar.ph1464, %middle.block1473, %._crit_edge.i.i314
  ...
  %.pre.i316 = load i32, ptr %i.nw, align 8, !tbaa !42
  br label %bb.ck
...
bb.ck:                                            ; preds = %._crit_edge.thread.i.i315, %._crit_edge.i.i314, %.noexc322
  ...
  store ptr %i.og, ptr %10, align 8, !tbaa !16
  %i.pk = sext i32 %i.pj to i64
  %i.pl = getelementptr inbounds [4 x i8], ptr %i.og, i64 %i.pk
  store i32 0, ptr %i.pl, align 4, !tbaa !45
  store i32 %i.oa, ptr %i.nx, align 4, !tbaa !46
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i307:     ; preds = %bb.ck, %bb.ci
  ...
  %i.pn = load ptr, ptr %i.nv, align 8, !tbaa !16
  br label %bb.cl
...
bb.cl:                                            ; preds = %bb.cl, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i307
  ...
  %i.pp = load i32, ptr %.0.i.i309, align 4, !tbaa !45 ; 2 uses
  %i.pq = getelementptr inbounds nuw i8, ptr %.04.i.i308, i64 4
  store i32 %i.pp, ptr %.04.i.i308, align 4, !tbaa !45
  %.not.i.i310 = icmp eq i32 %i.pp, 0
  br i1 %.not.i.i310, label %bb.cm, label %bb.cl, !llvm.loop !0

bb.cm:                                            ; preds = %bb.cl
  %i.pr = load i32, ptr %i.ny, align 8, !tbaa !42
  store i32 %i.pr, ptr %i.nw, align 8, !tbaa !42
...
bb.co:                                            ; preds = %bb.cn
  %i.pw = load ptr, ptr %10, align 8, !tbaa !16   ; 2 uses
