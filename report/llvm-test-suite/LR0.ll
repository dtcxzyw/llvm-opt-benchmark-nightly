...
begin_hunk_0_@generate_states:bb.a
  ...
  %wide.load189 = load <8 x i16>, ptr %next.gep188, align 2, !tbaa !21
  %wide.load190 = load <8 x i16>, ptr %i.ba, align 2, !tbaa !21
  %i.bb = getelementptr i8, ptr %next.gep187, i64 16
  store <8 x i16> %wide.load189, ptr %next.gep187, align 2, !tbaa !21
  store <8 x i16> %wide.load190, ptr %i.bb, align 2, !tbaa !21
  %index.next191 = add nuw i64 %index186, 16      ; 2 uses
  %i.bc = icmp eq i64 %index.next191, %n.vec184
  br i1 %i.bc, label %middle.block192, label %vector.body185, !llvm.loop !53
...
vec.epilog.iter.check199:                         ; preds = %middle.block192
  ...
  br i1 %min.epilog.iters.check200, label %.lr.ph32.i.preheader, label %vec.epilog.ph201, !prof !40
...
vec.epilog.vector.body203:                        ; preds = %vec.epilog.vector.body203, %vec.epilog.ph201
  ...
  %wide.load207 = load <4 x i16>, ptr %next.gep206, align 2, !tbaa !21
  store <4 x i16> %wide.load207, ptr %next.gep205, align 2, !tbaa !21
  %index.next208 = add nuw i64 %index204, 4       ; 2 uses
  %i.bh = icmp eq i64 %index.next208, %n.vec202
  br i1 %i.bh, label %vec.epilog.middle.block209, label %vec.epilog.vector.body203, !llvm.loop !54
...
append_states.exit.thread:                        ; preds = %._crit_edge.i1
  store i32 0, ptr @nshifts, align 4, !tbaa !16
...
.lr.ph25.i:                                       ; preds = %._crit_edge.i1
  ...
  %.pre28.i = load ptr, ptr @ritem, align 8, !tbaa !19
  br label %bb.f
...
bb.f:                                             ; preds = %bb.j, %.lr.ph25.i
  ...
  %i.cb = load i16, ptr %.01623.i, align 2, !tbaa !21 ; 2 uses
  %i.cc = sext i16 %i.cb to i64
  %i.cd = getelementptr inbounds [2 x i8], ptr %i.bz, i64 %i.cc
  %i.ce = load i16, ptr %i.cd, align 2, !tbaa !21 ; 3 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.ci = load ptr, ptr %i.ch, align 8, !tbaa !19 ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  store i16 %i.ce, ptr %i.cl, align 2, !tbaa !21
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  store i16 %i.co, ptr %.0.i, align 2, !tbaa !21
  store ptr %i.cp, ptr %i.ch, align 8, !tbaa !19
  %.pre.i = load ptr, ptr @ritem, align 8, !tbaa !19
  %.pre29.i = load ptr, ptr @itemsetend, align 8, !tbaa !19
  br label %bb.j
...
bb.j:                                             ; preds = %bb.i, %bb.f
  ...
  br i1 %i.cs, label %bb.f, label %new_itemsets.exit, !llvm.loop !3

new_itemsets.exit:                                ; preds = %bb.j
  store i32 %.pr, ptr @nshifts, align 4, !tbaa !16
...
bb.k:                                             ; preds = %.critedge.i, %.lr.ph.i6
  ...
  %i.cw = load i16, ptr %i.cv, align 2, !tbaa !21 ; 2 uses
...
bb.l:                                             ; preds = %bb.m, %bb.k
  ...
  %i.db = load i16, ptr %i.da, align 2, !tbaa !21 ; 2 uses
  %i.dc = icmp sgt i16 %i.db, %i.cw
  br i1 %i.dc, label %bb.m, label %.critedge.i

bb.m:                                             ; preds = %bb.l
  store i16 %i.db, ptr %i.cz, align 2, !tbaa !21
  %i.dd = add nsw i32 %.018.i, -1
  %i.de = icmp sgt i32 %.018.i, 1
  br i1 %i.de, label %bb.l, label %.critedge.i, !llvm.loop !4
...
.critedge.i:                                      ; preds = %bb.m, %bb.l
  ...
  store i16 %i.cw, ptr %i.dg, align 2, !tbaa !21
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %.preheader.i, label %bb.k, !llvm.loop !5

.lr.ph21.i:                                       ; preds = %.preheader.i, %get_state.exit
  %indvars.iv23.i = phi i64 [ %indvars.iv.next24.i, %get_state.exit ], [ 0, %.preheader.i ] ; 3 uses
  %i.dh = load ptr, ptr @shift_symbol, align 8, !tbaa !19
  %i.di = getelementptr inbounds nuw [2 x i8], ptr %i.dh, i64 %indvars.iv23.i
  %i.dj = load i16, ptr %i.di, align 2, !tbaa !21 ; 3 uses
  %i.dk = load ptr, ptr @kernel_base, align 8, !tbaa !25
  %i.dl = sext i16 %i.dj to i64                   ; 6 uses
  %i.dm = getelementptr inbounds [8 x i8], ptr %i.dk, i64 %i.dl
  %i.dn = load ptr, ptr %i.dm, align 8, !tbaa !19 ; 8 uses
  %i.do = load ptr, ptr @kernel_end, align 8, !tbaa !25
  %i.dp = getelementptr inbounds [8 x i8], ptr %i.do, i64 %i.dl
  %i.dq = load ptr, ptr %i.dp, align 8, !tbaa !19 ; 6 uses
  %i.dr = ptrtoint ptr %i.dq to i64               ; 2 uses
  %i.ds = ptrtoint ptr %i.dn to i64               ; 2 uses
...
vector.body167:                                   ; preds = %vector.body167, %vector.ph165
  ...
  %wide.load171 = load <4 x i16>, ptr %next.gep170, align 2, !tbaa !21
  %wide.load172 = load <4 x i16>, ptr %i.ee, align 2, !tbaa !21
  ...
  br i1 %i.ej, label %middle.block174, label %vector.body167, !llvm.loop !56
...
.lr.ph.i15:                                       ; preds = %.lr.ph.i15.preheader213, %.lr.ph.i15
  ...
  %i.em = load i16, ptr %.03250.i, align 2, !tbaa !21
  %i.en = sext i16 %i.em to i32
  %i.eo = add nsw i32 %.03449.i, %i.en            ; 2 uses
  %i.ep = icmp ult ptr %i.el, %i.dq
  br i1 %i.ep, label %.lr.ph.i15, label %._crit_edge.i11, !llvm.loop !57
...
.preheader.i13.us:                                ; preds = %._crit_edge.i11, %.thread.i.us
  ...
  %i.ey = load i16, ptr %i.ex, align 4, !tbaa !32
...
.thread.i.us:                                     ; preds = %._crit_edge55.i.us, %.preheader.i13.us
  ...
  br i1 %.not40.i.us, label %.split.us, label %.preheader.i13.us, !llvm.loop !7
...
.preheader.i13:                                   ; preds = %._crit_edge.i11.thread, %.thread.i
  ...
  %i.fl = load i16, ptr %i.fk, align 4, !tbaa !32
...
.thread.i:                                        ; preds = %.preheader.i13
  ...
  %i.fp = load ptr, ptr %i.fo, align 8, !tbaa !42 ; 2 uses
  %.not40.i = icmp eq ptr %i.fp, null
  br i1 %.not40.i, label %.split.us, label %.preheader.i13, !llvm.loop !7
...
.split.us:                                        ; preds = %.thread.i, %.thread.i.us
  ...
  %i.fr = load i32, ptr @nstates, align 4, !tbaa !16
  %i.fs = icmp sgt i32 %i.fr, 32766
  br i1 %i.fs, label %bb.n, label %bb.o

bb.n:                                             ; preds = %.split.us
  tail call void @toomany(ptr noundef nonnull @.str) #8
  %.pre = load ptr, ptr @kernel_base, align 8, !tbaa !25
  %.phi.trans.insert = getelementptr inbounds [8 x i8], ptr %.pre, i64 %i.dl
  %.pre32 = load ptr, ptr %.phi.trans.insert, align 8, !tbaa !19 ; 2 uses
  %.pre33 = load ptr, ptr @kernel_end, align 8, !tbaa !25
  %.phi.trans.insert34 = getelementptr inbounds [8 x i8], ptr %.pre33, i64 %i.dl
  %.pre35 = load ptr, ptr %.phi.trans.insert34, align 8, !tbaa !19 ; 2 uses
...
bb.o:                                             ; preds = %bb.n, %.split.us
  ...
  %i.fv = ptrtoaddr ptr %i.fu to i64              ; 2 uses
  ...
  store i16 %i.dj, ptr %i.gb, align 2, !tbaa !43
  %i.gc = load i32, ptr @nstates, align 4, !tbaa !16 ; 2 uses
  %i.gd = trunc i32 %i.gc to i16
  %i.ge = getelementptr inbounds nuw i8, ptr %i.fz, i64 16
  store i16 %i.gd, ptr %i.ge, align 8, !tbaa !33
  %i.gf = trunc i64 %.pre-phi42 to i16
  %i.gg = getelementptr inbounds nuw i8, ptr %i.fz, i64 20
  store i16 %i.gf, ptr %i.gg, align 4, !tbaa !32
...
vector.body137:                                   ; preds = %vector.body137, %vector.ph135
  ...
  %wide.load141 = load <8 x i16>, ptr %next.gep140, align 2, !tbaa !21
  %wide.load142 = load <8 x i16>, ptr %i.gv, align 2, !tbaa !21
  %i.gw = getelementptr i8, ptr %next.gep139, i64 16
  store <8 x i16> %wide.load141, ptr %next.gep139, align 2, !tbaa !21
  store <8 x i16> %wide.load142, ptr %i.gw, align 2, !tbaa !21
  %index.next143 = add nuw i64 %index138, 16      ; 2 uses
  %i.gx = icmp eq i64 %index.next143, %n.vec136
  br i1 %i.gx, label %middle.block144, label %vector.body137, !llvm.loop !58
...
vec.epilog.iter.check150:                         ; preds = %middle.block144
  ...
  br i1 %min.epilog.iters.check151, label %.lr.ph.i.i.preheader, label %vec.epilog.ph152, !prof !40
...
vec.epilog.vector.body154:                        ; preds = %vec.epilog.vector.body154, %vec.epilog.ph152
  ...
  %wide.load158 = load <4 x i16>, ptr %next.gep157, align 2, !tbaa !21
  store <4 x i16> %wide.load158, ptr %next.gep156, align 2, !tbaa !21
  %index.next159 = add nuw i64 %index155, 4       ; 2 uses
  %i.hc = icmp eq i64 %index.next159, %n.vec153
  br i1 %i.hc, label %vec.epilog.middle.block160, label %vec.epilog.vector.body154, !llvm.loop !59
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  ...
  %i.he = load i16, ptr %.01718.i.i, align 2, !tbaa !21
  %i.hf = getelementptr inbounds nuw i8, ptr %.019.i.i, i64 2
  store i16 %i.he, ptr %.019.i.i, align 2, !tbaa !21
  %i.hg = icmp ult ptr %i.hd, %i.ft
  br i1 %i.hg, label %.lr.ph.i.i, label %new_state.exit.i, !llvm.loop !60

new_state.exit.i:                                 ; preds = %.lr.ph.i.i, %middle.block144, %vec.epilog.middle.block160, %bb.o
  %i.hh = load ptr, ptr @last_state, align 8, !tbaa !30
  store ptr %i.fz, ptr %i.hh, align 8, !tbaa !44
  store ptr %i.fz, ptr @last_state, align 8, !tbaa !30
  %i.hi = add nsw i32 %i.gc, 1
  store i32 %i.hi, ptr @nstates, align 4, !tbaa !16
  store ptr %i.fz, ptr %i.fq, align 8, !tbaa !42
...
bb.p:                                             ; preds = %._crit_edge.i11.thread, %._crit_edge.i11
  ...
  %i.hj = load i32, ptr @nstates, align 4, !tbaa !16
  %i.hk = icmp sgt i32 %i.hj, 32766
  br i1 %i.hk, label %bb.q, label %bb.r

bb.q:                                             ; preds = %bb.p
  tail call void @toomany(ptr noundef nonnull @.str) #8
  %.pre.i14 = load ptr, ptr @kernel_base, align 8, !tbaa !25
  %.phi.trans.insert.i = getelementptr inbounds [8 x i8], ptr %.pre.i14, i64 %i.dl
  %.pre59.i = load ptr, ptr %.phi.trans.insert.i, align 8, !tbaa !19 ; 2 uses
  %.pre60.i = load ptr, ptr @kernel_end, align 8, !tbaa !25
  %.phi.trans.insert61.i = getelementptr inbounds [8 x i8], ptr %.pre60.i, i64 %i.dl
  %.pre62.i = load ptr, ptr %.phi.trans.insert61.i, align 8, !tbaa !19 ; 2 uses
...
bb.r:                                             ; preds = %bb.q, %bb.p
  ...
  store i16 %i.dj, ptr %i.ht, align 2, !tbaa !43
  %i.hu = load i32, ptr @nstates, align 4, !tbaa !16 ; 2 uses
  %i.hv = trunc i32 %i.hu to i16
  %i.hw = getelementptr inbounds nuw i8, ptr %i.hr, i64 16
  store i16 %i.hv, ptr %i.hw, align 8, !tbaa !33
  %i.hx = trunc i64 %.pre-phi69.i to i16
  %i.hy = getelementptr inbounds nuw i8, ptr %i.hr, i64 20
  store i16 %i.hx, ptr %i.hy, align 4, !tbaa !32
...
vector.body102:                                   ; preds = %vector.body102, %vector.ph100
  ...
  %wide.load106.a = load <8 x i16>, ptr %next.gep105, align 2, !tbaa !21
  %wide.load107 = load <8 x i16>, ptr %i.in, align 2, !tbaa !21
  %i.io = getelementptr i8, ptr %next.gep104.a, i64 16
  store <8 x i16> %wide.load106.a, ptr %next.gep104.a, align 2, !tbaa !21
  store <8 x i16> %wide.load107, ptr %i.io, align 2, !tbaa !21
  %index.next108 = add nuw i64 %index103, 16      ; 2 uses
  %i.ip = icmp eq i64 %index.next108, %n.vec101
  br i1 %i.ip, label %middle.block109, label %vector.body102, !llvm.loop !61
...
vec.epilog.iter.check115:                         ; preds = %middle.block109
  ...
  br i1 %min.epilog.iters.check116, label %.lr.ph.i43.i.preheader, label %vec.epilog.ph117, !prof !40
...
vec.epilog.vector.body119:                        ; preds = %vec.epilog.vector.body119, %vec.epilog.ph117
  ...
  %wide.load123 = load <4 x i16>, ptr %next.gep122, align 2, !tbaa !21
  store <4 x i16> %wide.load123, ptr %next.gep121.a, align 2, !tbaa !21
  %index.next124 = add nuw i64 %index120, 4       ; 2 uses
  %i.iu = icmp eq i64 %index.next124, %n.vec118
  br i1 %i.iu, label %vec.epilog.middle.block125, label %vec.epilog.vector.body119, !llvm.loop !62
...
.lr.ph.i43.i:                                     ; preds = %.lr.ph.i43.i.preheader, %.lr.ph.i43.i
  ...
  %i.iw = load i16, ptr %.01718.i45.i, align 2, !tbaa !21
  %i.ix = getelementptr inbounds nuw i8, ptr %.019.i44.i, i64 2
  store i16 %i.iw, ptr %.019.i44.i, align 2, !tbaa !21
  %i.iy = icmp ult ptr %i.iv, %i.hl
  br i1 %i.iy, label %.lr.ph.i43.i, label %new_state.exit46.i, !llvm.loop !63

new_state.exit46.i:                               ; preds = %.lr.ph.i43.i, %middle.block109, %vec.epilog.middle.block125, %bb.r
  %i.iz = load ptr, ptr @last_state, align 8, !tbaa !30
  store ptr %i.hr, ptr %i.iz, align 8, !tbaa !44
  store ptr %i.hr, ptr @last_state, align 8, !tbaa !30
  %i.ja = add nsw i32 %i.hu, 1
  store i32 %i.ja, ptr @nstates, align 4, !tbaa !16
  %i.jb = load ptr, ptr @state_table, align 8, !tbaa !28
  %i.jc = getelementptr inbounds [8 x i8], ptr %i.jb, i64 %.034.lcssa.i69
  store ptr %i.hr, ptr %i.jc, align 8, !tbaa !30
  br label %get_state.exit
...
get_state.exit:                                   ; preds = %.preheader.i13, %._crit_edge55.i.us, %new_state.exit.i, %new_state.exit46.i
  ...
  %i.je = load i16, ptr %i.jd, align 8, !tbaa !33
  %i.jf = load ptr, ptr @shiftset, align 8, !tbaa !19
  %i.jg = getelementptr inbounds nuw [2 x i8], ptr %i.jf, i64 %indvars.iv23.i
  store i16 %i.je, ptr %i.jg, align 2, !tbaa !21
  %indvars.iv.next24.i = add nuw nsw i64 %indvars.iv23.i, 1 ; 2 uses
  %i.jh = load i32, ptr @nshifts, align 4, !tbaa !16 ; 3 uses
  %i.ji = sext i32 %i.jh to i64
  %i.jj = icmp slt i64 %indvars.iv.next24.i, %i.ji
  br i1 %i.jj, label %.lr.ph21.i, label %append_states.exit, !llvm.loop !8
...
bb.s:                                             ; preds = %append_states.exit
  ...
  %i.jp = load ptr, ptr @this_state, align 8, !tbaa !30
  %i.jq = getelementptr inbounds nuw i8, ptr %i.jp, i64 16
  %i.jr = load i16, ptr %i.jq, align 8, !tbaa !33
  %i.js = getelementptr inbounds nuw i8, ptr %i.jn, i64 8
  store i16 %i.jr, ptr %i.js, align 8, !tbaa !47
  %i.jt = load i32, ptr @nshifts, align 4, !tbaa !16 ; 3 uses
  %i.ju = trunc i32 %i.jt to i16
  %i.jv = getelementptr inbounds nuw i8, ptr %i.jn, i64 10
  store i16 %i.ju, ptr %i.jv, align 2, !tbaa !48
  %i.jw = load ptr, ptr @shiftset, align 8, !tbaa !19 ; 8 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x i16>, ptr %next.gep82, align 2, !tbaa !21
  %wide.load83 = load <8 x i16>, ptr %i.kp, align 2, !tbaa !21
  %i.kq = getelementptr i8, ptr %next.gep, i64 16
  store <8 x i16> %wide.load, ptr %next.gep, align 2, !tbaa !21
  store <8 x i16> %wide.load83, ptr %i.kq, align 2, !tbaa !21
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.kr = icmp eq i64 %index.next, %n.vec
  br i1 %i.kr, label %middle.block, label %vector.body, !llvm.loop !64
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph.i10.preheader, label %vec.epilog.ph, !prof !40
...
._crit_edge:                                      ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %middle.block, %vec.epilog.middle.block, %bb.i
  %i.di = load i32, ptr @nstates, align 4, !tbaa !16
  ...
  store i16 %i.dj, ptr %i.dm, align 2, !tbaa !21
  %i.dn = load i16, ptr %i.f, align 2, !tbaa !48
...
bb.j:                                             ; preds = %.lr.ph103, %bb.j
  ...
  store i16 %i.dr, ptr %i.ds, align 2, !tbaa !21
  %i.dt = load i16, ptr %i.f, align 2, !tbaa !48
...
._crit_edge104:                                   ; preds = %bb.j, %._crit_edge
  store ptr %i.by, ptr @first_shift, align 8, !tbaa !49
  %i.dw = load ptr, ptr @last_shift, align 8, !tbaa !49
  %i.dx = icmp eq ptr %i.dw, %i.a
  br i1 %i.dx, label %bb.k, label %bb.l

bb.k:                                             ; preds = %._crit_edge104
  store ptr %i.by, ptr @last_shift, align 8, !tbaa !49
  br label %bb.l
...
bb.l:                                             ; preds = %._crit_edge104, %bb.k
  ...
  %i.dz = load i32, ptr @nstates, align 4, !tbaa !16
  %i.ea = trunc i32 %i.dz to i16
  %i.eb = getelementptr inbounds nuw i8, ptr %i.dy, i64 16
  store i16 %i.ea, ptr %i.eb, align 8, !tbaa !33
  %i.ec = load i32, ptr @start_symbol, align 4, !tbaa !16
  %i.ed = trunc i32 %i.ec to i16
  %i.ee = getelementptr inbounds nuw i8, ptr %i.dy, i64 18
  store i16 %i.ed, ptr %i.ee, align 2, !tbaa !43
  %i.ef = load ptr, ptr @last_state, align 8, !tbaa !30
  store ptr %i.dy, ptr %i.ef, align 8, !tbaa !44
  store ptr %i.dy, ptr @last_state, align 8, !tbaa !30
  %i.eg = tail call ptr (i32, ...) @mallocate(i32 noundef 16) #8 ; 5 uses
  %i.eh = load i32, ptr @nstates, align 4, !tbaa !16 ; 2 uses
  %i.ei = add nsw i32 %i.eh, 1                    ; 2 uses
  store i32 %i.ei, ptr @nstates, align 4, !tbaa !16
  %i.ej = trunc i32 %i.eh to i16
  %i.ek = getelementptr inbounds nuw i8, ptr %i.eg, i64 8
  store i16 %i.ej, ptr %i.ek, align 8, !tbaa !47
  %i.el = getelementptr inbounds nuw i8, ptr %i.eg, i64 10
  store i16 1, ptr %i.el, align 2, !tbaa !48
  %i.em = trunc i32 %i.ei to i16
  %i.en = getelementptr inbounds nuw i8, ptr %i.eg, i64 12
  store i16 %i.em, ptr %i.en, align 4, !tbaa !21
  %i.eo = load ptr, ptr @last_shift, align 8, !tbaa !49
  store ptr %i.eg, ptr %i.eo, align 8, !tbaa !50
  store ptr %i.eg, ptr @last_shift, align 8, !tbaa !49
  br label %bb.o

bb.m:                                             ; preds = %bb.b
  %i.ep = tail call ptr (i32, ...) @mallocate(i32 noundef 16) #8 ; 4 uses
  %i.eq = load ptr, ptr @first_shift, align 8, !tbaa !49
  store ptr %i.eq, ptr %i.ep, align 8, !tbaa !50
  %i.er = getelementptr inbounds nuw i8, ptr %i.ep, i64 10
  store i16 1, ptr %i.er, align 2, !tbaa !48
  %i.es = load i32, ptr @nstates, align 4, !tbaa !16
  %i.et = trunc i32 %i.es to i16
  %i.eu = getelementptr inbounds nuw i8, ptr %i.ep, i64 12
  store i16 %i.et, ptr %i.eu, align 4, !tbaa !21
  store ptr %i.ep, ptr @first_shift, align 8, !tbaa !49
  %i.ev = tail call ptr (i32, ...) @mallocate(i32 noundef 22) #8 ; 4 uses
  %i.ew = load i32, ptr @nstates, align 4, !tbaa !16
  %i.ex = trunc i32 %i.ew to i16
  %i.ey = getelementptr inbounds nuw i8, ptr %i.ev, i64 16
  store i16 %i.ex, ptr %i.ey, align 8, !tbaa !33
  %i.ez = load i32, ptr @start_symbol, align 4, !tbaa !16
  %i.fa = trunc i32 %i.ez to i16
  %i.fb = getelementptr inbounds nuw i8, ptr %i.ev, i64 18
  store i16 %i.fa, ptr %i.fb, align 2, !tbaa !43
  %i.fc = load ptr, ptr @last_state, align 8, !tbaa !30
  store ptr %i.ev, ptr %i.fc, align 8, !tbaa !44
  store ptr %i.ev, ptr @last_state, align 8, !tbaa !30
  %i.fd = tail call ptr (i32, ...) @mallocate(i32 noundef 16) #8 ; 5 uses
  %i.fe = load i32, ptr @nstates, align 4, !tbaa !16 ; 2 uses
  %i.ff = add nsw i32 %i.fe, 1                    ; 2 uses
  store i32 %i.ff, ptr @nstates, align 4, !tbaa !16
  %i.fg = trunc i32 %i.fe to i16
  %i.fh = getelementptr inbounds nuw i8, ptr %i.fd, i64 8
  store i16 %i.fg, ptr %i.fh, align 8, !tbaa !47
  %i.fi = getelementptr inbounds nuw i8, ptr %i.fd, i64 10
  store i16 1, ptr %i.fi, align 2, !tbaa !48
  %i.fj = trunc i32 %i.ff to i16
  %i.fk = getelementptr inbounds nuw i8, ptr %i.fd, i64 12
  store i16 %i.fj, ptr %i.fk, align 4, !tbaa !21
  %i.fl = load ptr, ptr @last_shift, align 8, !tbaa !49
  store ptr %i.fd, ptr %i.fl, align 8, !tbaa !50
  store ptr %i.fd, ptr @last_shift, align 8, !tbaa !49
  br label %bb.o
...
bb.n:                                             ; preds = %bb.a
  ...
  %i.fo = load i32, ptr @nstates, align 4, !tbaa !16
  %i.fp = trunc i32 %i.fo to i16
  %i.fq = getelementptr inbounds nuw i8, ptr %i.fm, i64 12
  store i16 %i.fp, ptr %i.fq, align 4, !tbaa !21
  store ptr %i.fm, ptr @first_shift, align 8, !tbaa !49
  store ptr %i.fm, ptr @last_shift, align 8, !tbaa !49
  %i.fr = tail call ptr (i32, ...) @mallocate(i32 noundef 22) #8 ; 4 uses
  %i.fs = load i32, ptr @nstates, align 4, !tbaa !16
  %i.ft = trunc i32 %i.fs to i16
  %i.fu = getelementptr inbounds nuw i8, ptr %i.fr, i64 16
  store i16 %i.ft, ptr %i.fu, align 8, !tbaa !33
  %i.fv = load i32, ptr @start_symbol, align 4, !tbaa !16
  %i.fw = trunc i32 %i.fv to i16
  %i.fx = getelementptr inbounds nuw i8, ptr %i.fr, i64 18
  store i16 %i.fw, ptr %i.fx, align 2, !tbaa !43
  %i.fy = load ptr, ptr @last_state, align 8, !tbaa !30
  store ptr %i.fr, ptr %i.fy, align 8, !tbaa !44
  store ptr %i.fr, ptr @last_state, align 8, !tbaa !30
  %i.fz = tail call ptr (i32, ...) @mallocate(i32 noundef 16) #8 ; 5 uses
  %i.ga = load i32, ptr @nstates, align 4, !tbaa !16 ; 2 uses
  %i.gb = add nsw i32 %i.ga, 1                    ; 2 uses
  store i32 %i.gb, ptr @nstates, align 4, !tbaa !16
  %i.gc = trunc i32 %i.ga to i16
  %i.gd = getelementptr inbounds nuw i8, ptr %i.fz, i64 8
  store i16 %i.gc, ptr %i.gd, align 8, !tbaa !47
  %i.ge = getelementptr inbounds nuw i8, ptr %i.fz, i64 10
  store i16 1, ptr %i.ge, align 2, !tbaa !48
  %i.gf = trunc i32 %i.gb to i16
  %i.gg = getelementptr inbounds nuw i8, ptr %i.fz, i64 12
  store i16 %i.gf, ptr %i.gg, align 4, !tbaa !21
  %i.gh = load ptr, ptr @last_shift, align 8, !tbaa !49
  store ptr %i.fz, ptr %i.gh, align 8, !tbaa !50
  store ptr %i.fz, ptr @last_shift, align 8, !tbaa !49
  br label %bb.o

bb.o:                                             ; preds = %bb.h, %bb.m, %._crit_edge114, %bb.l, %bb.n
  %i.gi = tail call ptr (i32, ...) @mallocate(i32 noundef 22) #8 ; 3 uses
  %i.gj = load i32, ptr @nstates, align 4, !tbaa !16
  %i.gk = trunc i32 %i.gj to i16
  %i.gl = getelementptr inbounds nuw i8, ptr %i.gi, i64 16
  store i16 %i.gk, ptr %i.gl, align 8, !tbaa !33
  %i.gm = load ptr, ptr @last_state, align 8, !tbaa !30
  store ptr %i.gi, ptr %i.gm, align 8, !tbaa !44
  store ptr %i.gi, ptr @last_state, align 8, !tbaa !30
  %i.gn = tail call ptr (i32, ...) @mallocate(i32 noundef 16) #8 ; 5 uses
  %i.go = load i32, ptr @nstates, align 4, !tbaa !16 ; 2 uses
  %i.gp = add nsw i32 %i.go, 1                    ; 3 uses
  store i32 %i.gp, ptr @nstates, align 4, !tbaa !16
  %i.gq = trunc i32 %i.go to i16
  %i.gr = getelementptr inbounds nuw i8, ptr %i.gn, i64 8
  store i16 %i.gq, ptr %i.gr, align 8, !tbaa !47
  %i.gs = getelementptr inbounds nuw i8, ptr %i.gn, i64 10
  store i16 1, ptr %i.gs, align 2, !tbaa !48
  %i.gt = trunc i32 %i.gp to i16
  %i.gu = getelementptr inbounds nuw i8, ptr %i.gn, i64 12
  store i16 %i.gt, ptr %i.gu, align 4, !tbaa !21
  %i.gv = load ptr, ptr @last_shift, align 8, !tbaa !49
  store ptr %i.gn, ptr %i.gv, align 8, !tbaa !50
  store ptr %i.gn, ptr @last_shift, align 8, !tbaa !49
  store i32 %i.gp, ptr @final_state, align 4, !tbaa !16
  %i.gw = tail call ptr (i32, ...) @mallocate(i32 noundef 22) #8 ; 3 uses
  %i.gx = load i32, ptr @nstates, align 4, !tbaa !16 ; 2 uses
  %i.gy = add nsw i32 %i.gx, 1
  store i32 %i.gy, ptr @nstates, align 4, !tbaa !16
  %i.gz = trunc i32 %i.gx to i16
  %i.ha = getelementptr inbounds nuw i8, ptr %i.gw, i64 16
  store i16 %i.gz, ptr %i.ha, align 8, !tbaa !33
  %i.hb = load ptr, ptr @last_state, align 8, !tbaa !30
  store ptr %i.gw, ptr %i.hb, align 8, !tbaa !44
  store ptr %i.gw, ptr @last_state, align 8, !tbaa !30
  ret void
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i16>, ptr %next.gep, align 2, !tbaa !21
  %wide.load88 = load <4 x i16>, ptr %i.u, align 2, !tbaa !21
...
.lr.ph:                                           ; preds = %.lr.ph.preheader152, %.lr.ph
  ...
  %i.ac = load i16, ptr %.03250, align 2, !tbaa !21
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %bb.a
  ...
  %i.ai = load ptr, ptr @state_table, align 8, !tbaa !28
...
.thread:                                          ; preds = %bb.b, %._crit_edge55
  ...
  br i1 %.not40, label %bb.d, label %bb.b, !llvm.loop !7

bb.d:                                             ; preds = %.thread
  %i.bd = getelementptr inbounds nuw i8, ptr %.02857, i64 8
  %i.be = load i32, ptr @nstates, align 4, !tbaa !16
...
bb.f:                                             ; preds = %bb.e, %bb.d
  %i.bg = load ptr, ptr @kernel_base, align 8, !tbaa !25
  %i.bh = getelementptr inbounds [8 x i8], ptr %i.bg, i64 %i.b
  %i.bi = load ptr, ptr %i.bh, align 8, !tbaa !19 ; 8 uses
  %i.bj = load ptr, ptr @kernel_end, align 8, !tbaa !25
  %i.bk = getelementptr inbounds [8 x i8], ptr %i.bj, i64 %i.b
  %i.bl = load ptr, ptr %i.bk, align 8, !tbaa !19 ; 3 uses
  %i.bm = ptrtoint ptr %i.bl to i64               ; 2 uses
  %i.bn = ptrtoint ptr %i.bi to i64               ; 3 uses
  ...
  store i16 %i.al, ptr %i.bv, align 2, !tbaa !43
  %i.bw = load i32, ptr @nstates, align 4, !tbaa !16 ; 2 uses
  %i.bx = trunc i32 %i.bw to i16
  %i.by = getelementptr inbounds nuw i8, ptr %i.bt, i64 16
  store i16 %i.bx, ptr %i.by, align 8, !tbaa !33
  %i.bz = trunc i64 %i.bp to i16
  %i.ca = getelementptr inbounds nuw i8, ptr %i.bt, i64 20
  store i16 %i.bz, ptr %i.ca, align 4, !tbaa !32
...
vector.body94:                                    ; preds = %vector.body94, %vector.ph92
  ...
  %wide.load98 = load <8 x i16>, ptr %next.gep97, align 2, !tbaa !21
  %wide.load99 = load <8 x i16>, ptr %i.co, align 2, !tbaa !21
  %i.cp = getelementptr i8, ptr %next.gep96, i64 16
  store <8 x i16> %wide.load98, ptr %next.gep96, align 2, !tbaa !21
  store <8 x i16> %wide.load99, ptr %i.cp, align 2, !tbaa !21
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load109 = load <4 x i16>, ptr %next.gep108, align 2, !tbaa !21
  store <4 x i16> %wide.load109, ptr %next.gep107, align 2, !tbaa !21
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  %i.cx = load i16, ptr %.01718.i, align 2, !tbaa !21
  %i.cy = getelementptr inbounds nuw i8, ptr %.019.i, i64 2
  store i16 %i.cx, ptr %.019.i, align 2, !tbaa !21
...
new_state.exit:                                   ; preds = %.lr.ph.i, %middle.block101, %vec.epilog.middle.block, %bb.f
  %i.da = load ptr, ptr @last_state, align 8, !tbaa !30
  store ptr %i.bt, ptr %i.da, align 8, !tbaa !44
  store ptr %i.bt, ptr @last_state, align 8, !tbaa !30
  %i.db = add nsw i32 %i.bw, 1
  store i32 %i.db, ptr @nstates, align 4, !tbaa !16
  store ptr %i.bt, ptr %i.bd, align 8, !tbaa !42
  br label %.loopexit

bb.g:                                             ; preds = %._crit_edge
  %i.dc = load i32, ptr @nstates, align 4, !tbaa !16
...
bb.h:                                             ; preds = %bb.g
  ...
  %.pre59 = load ptr, ptr %.phi.trans.insert, align 8, !tbaa !19 ; 2 uses
  %.pre60 = load ptr, ptr @kernel_end, align 8, !tbaa !25
  %.phi.trans.insert61 = getelementptr inbounds [8 x i8], ptr %.pre60, i64 %i.b
  %.pre62 = load ptr, ptr %.phi.trans.insert61, align 8, !tbaa !19 ; 2 uses
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  store i16 %i.dm, ptr %i.dn, align 2, !tbaa !43
  %i.do = load i32, ptr @nstates, align 4, !tbaa !16 ; 2 uses
  %i.dp = trunc i32 %i.do to i16
  %i.dq = getelementptr inbounds nuw i8, ptr %i.dk, i64 16
  store i16 %i.dp, ptr %i.dq, align 8, !tbaa !33
  %i.dr = trunc i64 %.pre-phi69 to i16
  %i.ds = getelementptr inbounds nuw i8, ptr %i.dk, i64 20
  store i16 %i.dr, ptr %i.ds, align 4, !tbaa !32
...
vector.body123:                                   ; preds = %vector.body123, %vector.ph121
  ...
  %wide.load127.a = load <8 x i16>, ptr %next.gep126, align 2, !tbaa !21
  %wide.load128 = load <8 x i16>, ptr %i.eh, align 2, !tbaa !21
  %i.ei = getelementptr i8, ptr %next.gep125.a, i64 16
  store <8 x i16> %wide.load127.a, ptr %next.gep125.a, align 2, !tbaa !21
  store <8 x i16> %wide.load128, ptr %i.ei, align 2, !tbaa !21
...
vec.epilog.iter.check137:                         ; preds = %middle.block130
  ...
  br i1 %min.epilog.iters.check138, label %.lr.ph.i43.preheader, label %vec.epilog.ph139, !prof !40
...
vec.epilog.vector.body141:                        ; preds = %vec.epilog.vector.body141, %vec.epilog.ph139
  ...
  %wide.load145 = load <4 x i16>, ptr %next.gep144, align 2, !tbaa !21
  store <4 x i16> %wide.load145, ptr %next.gep143.a, align 2, !tbaa !21
...
.lr.ph.i43:                                       ; preds = %.lr.ph.i43.preheader, %.lr.ph.i43
  ...
  %i.eq = load i16, ptr %.01718.i45, align 2, !tbaa !21
  %i.er = getelementptr inbounds nuw i8, ptr %.019.i44, i64 2
  store i16 %i.eq, ptr %.019.i44, align 2, !tbaa !21
...
new_state.exit46:                                 ; preds = %.lr.ph.i43, %middle.block130, %vec.epilog.middle.block147, %bb.i
  %i.et = load ptr, ptr @last_state, align 8, !tbaa !30
  store ptr %i.dk, ptr %i.et, align 8, !tbaa !44
  store ptr %i.dk, ptr @last_state, align 8, !tbaa !30
  %i.eu = add nsw i32 %i.do, 1
  store i32 %i.eu, ptr @nstates, align 4, !tbaa !16
  %i.ev = load ptr, ptr @state_table, align 8, !tbaa !28
  %i.ew = getelementptr inbounds [8 x i8], ptr %i.ev, i64 %.034.lcssa
  store ptr %i.dk, ptr %i.ew, align 8, !tbaa !30
  br label %.loopexit
...
.loopexit:                                        ; preds = %bb.c, %._crit_edge55, %new_state.exit, %new_state.exit46
  ...
  %i.ey = load i16, ptr %i.ex, align 8, !tbaa !33
  %i.ez = sext i16 %i.ey to i32
  ret i32 %i.ez
}
...
bb.a:
  %i.a = load i32, ptr @nstates, align 4, !tbaa !16
...
bb.c:                                             ; preds = %bb.b, %bb.a
  %i.c = load ptr, ptr @kernel_base, align 8, !tbaa !25
  %i.d = sext i32 %0 to i64                       ; 2 uses
  %i.e = getelementptr inbounds [8 x i8], ptr %i.c, i64 %i.d
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !19   ; 8 uses
  %i.g = load ptr, ptr @kernel_end, align 8, !tbaa !25
  ...
  store i16 %i.s, ptr %i.t, align 2, !tbaa !43
  %i.u = load i32, ptr @nstates, align 4, !tbaa !16 ; 2 uses
  %i.v = trunc i32 %i.u to i16
  %i.w = getelementptr inbounds nuw i8, ptr %i.q, i64 16
  store i16 %i.v, ptr %i.w, align 8, !tbaa !33
  %i.x = trunc i64 %i.m to i16
  %i.y = getelementptr inbounds nuw i8, ptr %i.q, i64 20
  store i16 %i.x, ptr %i.y, align 4, !tbaa !32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x i16>, ptr %next.gep22, align 2, !tbaa !21
  %wide.load23 = load <8 x i16>, ptr %i.am, align 2, !tbaa !21
  %i.an = getelementptr i8, ptr %next.gep, i64 16
  store <8 x i16> %wide.load, ptr %next.gep, align 2, !tbaa !21
  store <8 x i16> %wide.load23, ptr %i.an, align 2, !tbaa !21
  %index.next = add nuw i64 %index, 16            ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load29 = load <4 x i16>, ptr %next.gep28, align 2, !tbaa !21
  store <4 x i16> %wide.load29, ptr %next.gep27, align 2, !tbaa !21
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.av = load i16, ptr %.01718, align 2, !tbaa !21
  %i.aw = getelementptr inbounds nuw i8, ptr %.019, i64 2
  store i16 %i.av, ptr %.019, align 2, !tbaa !21
...
._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %vec.epilog.middle.block, %bb.c
  %i.ay = load ptr, ptr @last_state, align 8, !tbaa !30
  store ptr %i.q, ptr %i.ay, align 8, !tbaa !44
  store ptr %i.q, ptr @last_state, align 8, !tbaa !30
  %i.az = add nsw i32 %i.u, 1
  store i32 %i.az, ptr @nstates, align 4, !tbaa !16
  ret ptr %i.q
}
...
bb.a:
  ...
  %i.b = load i32, ptr @nstates, align 4, !tbaa !16
  %i.c = trunc i32 %i.b to i16
  %i.d = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store i16 %i.c, ptr %i.d, align 8, !tbaa !33
  %i.e = load i32, ptr @start_symbol, align 4, !tbaa !16
  %i.f = trunc i32 %i.e to i16
  %i.g = getelementptr inbounds nuw i8, ptr %i.a, i64 18
  store i16 %i.f, ptr %i.g, align 2, !tbaa !43
  %i.h = load ptr, ptr @last_state, align 8, !tbaa !30
  store ptr %i.a, ptr %i.h, align 8, !tbaa !44
  store ptr %i.a, ptr @last_state, align 8, !tbaa !30
  %i.i = tail call ptr (i32, ...) @mallocate(i32 noundef 16) #8 ; 5 uses
  %i.j = load i32, ptr @nstates, align 4, !tbaa !16 ; 2 uses
  %i.k = add nsw i32 %i.j, 1                      ; 2 uses
  store i32 %i.k, ptr @nstates, align 4, !tbaa !16
  %i.l = trunc i32 %i.j to i16
  %i.m = getelementptr inbounds nuw i8, ptr %i.i, i64 8
  store i16 %i.l, ptr %i.m, align 8, !tbaa !47
  %i.n = getelementptr inbounds nuw i8, ptr %i.i, i64 10
  store i16 1, ptr %i.n, align 2, !tbaa !48
  %i.o = trunc i32 %i.k to i16
  %i.p = getelementptr inbounds nuw i8, ptr %i.i, i64 12
  store i16 %i.o, ptr %i.p, align 4, !tbaa !21
  %i.q = load ptr, ptr @last_shift, align 8, !tbaa !49
  store ptr %i.i, ptr %i.q, align 8, !tbaa !50
  store ptr %i.i, ptr @last_shift, align 8, !tbaa !49
  ret void
}
...
!24 = !{!"p2 short", !23, i64 0}
!25 = !{!24, !24, i64 0}
!26 = !{!"llvm.loop.unroll.disable"}
!27 = !{!"p2 _ZTS4core", !23, i64 0}
!28 = !{!27, !27, i64 0}
!29 = !{!"p1 _ZTS4core", !17, i64 0}
!30 = !{!29, !29, i64 0}
!31 = !{!"core", !29, i64 0, !29, i64 8, !20, i64 16, !20, i64 18, !20, i64 20, !14, i64 22}
!32 = !{!31, !20, i64 20}
!33 = !{!31, !20, i64 16}
!34 = !{!"p1 _ZTS10reductions", !17, i64 0}
!35 = !{!"reductions", !34, i64 0, !20, i64 8, !20, i64 10, !14, i64 12}
!36 = !{!35, !20, i64 8}
!37 = !{!35, !20, i64 10}
