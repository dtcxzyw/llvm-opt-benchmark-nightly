...
.lr.ph:                                           ; preds = %bb.a, %append_states.exit.thread71
  %i.c = phi ptr [ %i.la, %append_states.exit.thread71 ], [ %i.b, %bb.a ] ; 2 uses
...
bb.e:                                             ; preds = %._crit_edge.i
  ...
  br i1 %i.al, label %iter.check206, label %._crit_edge33.i

iter.check206:                                    ; preds = %bb.e
  %0 = ptrtoint ptr %i.ah to i64                  ; 3 uses
  %i.am = getelementptr inbounds nuw i8, ptr %i.z, i64 12 ; 6 uses
  %i.an = xor i64 %0, -1
  %i.ao = add i64 %.idx.i, %0
  %i.ap = add i64 %0, 2
  %umax186 = tail call i64 @llvm.umax.i64(i64 %i.ao, i64 %i.ap)
  %i.aq = add i64 %umax186, %i.an                 ; 3 uses
  %i.ar = lshr i64 %i.aq, 1
  %i.as = add nuw i64 %i.ar, 1                    ; 5 uses
  %min.iters.check188 = icmp ult i64 %i.aq, 6
  br i1 %min.iters.check188, label %.lr.ph32.i.preheader, label %vector.memcheck184

vector.memcheck184:                               ; preds = %iter.check206
  %i.at = sub i64 %i.aa, %i.ai
  %i.au = add i64 %i.at, 11
  %diff.check185 = icmp ult i64 %i.au, 31
  br i1 %diff.check185, label %.lr.ph32.i.preheader, label %vector.main.loop.iter.check189

vector.main.loop.iter.check189:                   ; preds = %vector.memcheck184
  %min.iters.check190 = icmp ult i64 %i.aq, 30
  br i1 %min.iters.check190, label %vec.epilog.ph210, label %vector.ph191

vector.ph191:                                     ; preds = %vector.main.loop.iter.check189
  %n.mod.vf192 = and i64 %i.as, 12
  %n.vec193 = and i64 %i.as, -16                  ; 4 uses
  %i.av = shl i64 %n.vec193, 1                    ; 2 uses
...
vector.body194:                                   ; preds = %vector.body194, %vector.ph191
  %index195 = phi i64 [ 0, %vector.ph191 ], [ %index.next200, %vector.body194 ] ; 2 uses
  %i.ay = shl i64 %index195, 1                    ; 2 uses
  %next.gep196 = getelementptr i8, ptr %i.ah, i64 %i.ay ; 2 uses
  %next.gep197 = getelementptr i8, ptr %i.am, i64 %i.ay ; 2 uses
  %i.az = getelementptr i8, ptr %next.gep196, i64 16
  %wide.load198 = load <8 x i16>, ptr %next.gep196, align 2, !tbaa !11
  %wide.load199 = load <8 x i16>, ptr %i.az, align 2, !tbaa !11
  %i.ba = getelementptr i8, ptr %next.gep197, i64 16
  store <8 x i16> %wide.load198, ptr %next.gep197, align 2, !tbaa !11
  store <8 x i16> %wide.load199, ptr %i.ba, align 2, !tbaa !11
  %index.next200 = add nuw i64 %index195, 16      ; 2 uses
  %i.bb = icmp eq i64 %index.next200, %n.vec193
  br i1 %i.bb, label %middle.block201, label %vector.body194, !llvm.loop !34

middle.block201:                                  ; preds = %vector.body194
  %cmp.n202 = icmp eq i64 %i.as, %n.vec193
  br i1 %cmp.n202, label %._crit_edge33.i, label %vec.epilog.iter.check208

vec.epilog.iter.check208:                         ; preds = %middle.block201
  %min.epilog.iters.check209 = icmp eq i64 %n.mod.vf192, 0
  br i1 %min.epilog.iters.check209, label %.lr.ph32.i.preheader, label %vec.epilog.ph210, !prof !37

vec.epilog.ph210:                                 ; preds = %vector.main.loop.iter.check189, %vec.epilog.iter.check208
  %vec.epilog.resume.val203 = phi i64 [ %n.vec193, %vec.epilog.iter.check208 ], [ 0, %vector.main.loop.iter.check189 ]
  %n.vec212 = and i64 %i.as, -4                   ; 3 uses
  %i.bc = shl i64 %n.vec212, 1                    ; 2 uses
...
vec.epilog.vector.body213:                        ; preds = %vec.epilog.vector.body213, %vec.epilog.ph210
  %index214 = phi i64 [ %vec.epilog.resume.val203, %vec.epilog.ph210 ], [ %index.next218, %vec.epilog.vector.body213 ] ; 2 uses
  %i.bf = shl i64 %index214, 1                    ; 2 uses
  %next.gep215 = getelementptr i8, ptr %i.ah, i64 %i.bf
  %next.gep216 = getelementptr i8, ptr %i.am, i64 %i.bf
  %wide.load217 = load <4 x i16>, ptr %next.gep215, align 2, !tbaa !11
  store <4 x i16> %wide.load217, ptr %next.gep216, align 2, !tbaa !11
  %index.next218 = add nuw i64 %index214, 4       ; 2 uses
  %i.bg = icmp eq i64 %index.next218, %n.vec212
  br i1 %i.bg, label %vec.epilog.middle.block219, label %vec.epilog.vector.body213, !llvm.loop !38

vec.epilog.middle.block219:                       ; preds = %vec.epilog.vector.body213
  %cmp.n220 = icmp eq i64 %i.as, %n.vec212
  br i1 %cmp.n220, label %._crit_edge33.i, label %.lr.ph32.i.preheader

.lr.ph32.i.preheader:                             ; preds = %vector.memcheck184, %iter.check206, %vec.epilog.iter.check208, %vec.epilog.middle.block219
  %.02130.i.ph = phi ptr [ %i.ah, %iter.check206 ], [ %i.ah, %vector.memcheck184 ], [ %i.aw, %vec.epilog.iter.check208 ], [ %i.bd, %vec.epilog.middle.block219 ]
  %.02329.i.ph = phi ptr [ %i.am, %iter.check206 ], [ %i.am, %vector.memcheck184 ], [ %i.ax, %vec.epilog.iter.check208 ], [ %i.be, %vec.epilog.middle.block219 ]
  br label %.lr.ph32.i
...
._crit_edge33.i:                                  ; preds = %.lr.ph32.i, %middle.block201, %vec.epilog.middle.block219, %bb.e
...
.lr.ph.i16.preheader:                             ; preds = %.lr.ph21.i
  %i.dw = add i64 %i.dr, 2
  %umax170 = tail call i64 @llvm.umax.i64(i64 %i.dq, i64 %i.dw)
  %i.dx = xor i64 %i.dr, -1
  %i.dy = add i64 %umax170, %i.dx                 ; 2 uses
  %i.dz = lshr i64 %i.dy, 1
  %i.ea = add nuw i64 %i.dz, 1                    ; 2 uses
  %min.iters.check171 = icmp ult i64 %i.dy, 14
  br i1 %min.iters.check171, label %.lr.ph.i16.preheader223, label %vector.ph172

vector.ph172:                                     ; preds = %.lr.ph.i16.preheader
  %n.vec174 = and i64 %i.ea, -8                   ; 3 uses
  %i.eb = shl i64 %n.vec174, 1
  %i.ec = getelementptr i8, ptr %i.dm, i64 %i.eb
...
vector.body175:                                   ; preds = %vector.body175, %vector.ph172
  ...
  %vec.phi = phi <4 x i32> [ zeroinitializer, %vector.ph172 ], [ %i.eh, %vector.body175 ]
  %vec.phi177 = phi <4 x i32> [ zeroinitializer, %vector.ph172 ], [ %i.ei, %vector.body175 ]
  %i.ed = shl i64 %index176, 1
  %next.gep178 = getelementptr i8, ptr %i.dm, i64 %i.ed ; 2 uses
  %i.ee = getelementptr i8, ptr %next.gep178, i64 8
  %wide.load179 = load <4 x i16>, ptr %next.gep178, align 2, !tbaa !11
  %wide.load180 = load <4 x i16>, ptr %i.ee, align 2, !tbaa !11
  %i.ef = sext <4 x i16> %wide.load179 to <4 x i32>
  %i.eg = sext <4 x i16> %wide.load180 to <4 x i32>
  %i.eh = add <4 x i32> %vec.phi, %i.ef           ; 2 uses
  %i.ei = add <4 x i32> %vec.phi177, %i.eg        ; 2 uses
  %index.next181 = add nuw i64 %index176, 8       ; 2 uses
  %i.ej = icmp eq i64 %index.next181, %n.vec174
  br i1 %i.ej, label %middle.block182, label %vector.body175, !llvm.loop !44
...
middle.block182:                                  ; preds = %vector.body175
  ...
  %cmp.n183 = icmp eq i64 %i.ea, %n.vec174
  br i1 %cmp.n183, label %._crit_edge.i11, label %.lr.ph.i16.preheader223

.lr.ph.i16.preheader223:                          ; preds = %.lr.ph.i16.preheader, %middle.block182
  %.050.i.ph = phi i32 [ 0, %.lr.ph.i16.preheader ], [ %i.ek, %middle.block182 ]
  %.03249.i.ph = phi ptr [ %i.dm, %.lr.ph.i16.preheader ], [ %i.ec, %middle.block182 ]
  br label %.lr.ph.i16

.lr.ph.i16:                                       ; preds = %.lr.ph.i16.preheader223, %.lr.ph.i16
  %.050.i = phi i32 [ %i.eo, %.lr.ph.i16 ], [ %.050.i.ph, %.lr.ph.i16.preheader223 ]
  %.03249.i = phi ptr [ %i.el, %.lr.ph.i16 ], [ %.03249.i.ph, %.lr.ph.i16.preheader223 ] ; 2 uses
  %i.el = getelementptr inbounds nuw i8, ptr %.03249.i, i64 2 ; 2 uses
  %i.em = load i16, ptr %.03249.i, align 2, !tbaa !11
  %i.en = sext i16 %i.em to i32
  %i.eo = add nsw i32 %.050.i, %i.en              ; 2 uses
  %i.ep = icmp ult ptr %i.el, %i.dp
  br i1 %i.ep, label %.lr.ph.i16, label %._crit_edge.i11, !llvm.loop !45

._crit_edge.i11:                                  ; preds = %.lr.ph.i16, %middle.block182
  %.lcssa = phi i32 [ %i.ek, %middle.block182 ], [ %i.eo, %.lr.ph.i16 ]
...
._crit_edge.i11.thread:                           ; preds = %.lr.ph21.i
  ...
  %.not.i1369 = icmp eq ptr %i.ew, null
  br i1 %.not.i1369, label %bb.p, label %.preheader.i14

.preheader.i14.us:                                ; preds = %._crit_edge.i11, %.thread.i.us
  %.02957.i.us = phi ptr [ %i.fj, %.thread.i.us ], [ %i.eu, %._crit_edge.i11 ] ; 5 uses
  %i.ex = getelementptr inbounds nuw i8, ptr %.02957.i.us, i64 20
  %i.ey = load i16, ptr %i.ex, align 4, !tbaa !26
  %i.ez = sext i16 %i.ey to i32
  %i.fa = icmp eq i32 %i.ez, %i.du
  br i1 %i.fa, label %.lr.ph54.preheader.i.us, label %.thread.i.us

.lr.ph54.preheader.i.us:                          ; preds = %.preheader.i14.us
  %i.fb = getelementptr inbounds nuw i8, ptr %.02957.i.us, i64 22
  br label %.lr.ph54.i.us

.lr.ph54.i.us:                                    ; preds = %.lr.ph54.i.us, %.lr.ph54.preheader.i.us
  %.13352.i.us = phi ptr [ %i.fc, %.lr.ph54.i.us ], [ %i.dm, %.lr.ph54.preheader.i.us ] ; 2 uses
  %.03451.i.us = phi ptr [ %i.fe, %.lr.ph54.i.us ], [ %i.fb, %.lr.ph54.preheader.i.us ] ; 2 uses
  %i.fc = getelementptr inbounds nuw i8, ptr %.13352.i.us, i64 2 ; 2 uses
  %i.fd = load i16, ptr %.13352.i.us, align 2, !tbaa !11
  %i.fe = getelementptr inbounds nuw i8, ptr %.03451.i.us, i64 2
  %i.ff = load i16, ptr %.03451.i.us, align 2, !tbaa !11
  %.not41.i.us = icmp eq i16 %i.fd, %i.ff         ; 2 uses
  %i.fg = icmp ult ptr %i.fc, %i.dp
...
.thread.i.us:                                     ; preds = %._crit_edge55.i.us, %.preheader.i14.us
  %i.fi = getelementptr inbounds nuw i8, ptr %.02957.i.us, i64 8
...
.preheader.i14:                                   ; preds = %._crit_edge.i11.thread, %.thread.i
  %.02957.i = phi ptr [ %i.fp, %.thread.i ], [ %i.ew, %._crit_edge.i11.thread ] ; 4 uses
  %i.fk = getelementptr inbounds nuw i8, ptr %.02957.i, i64 20
  %i.fl = load i16, ptr %i.fk, align 4, !tbaa !26
  %i.fm = sext i16 %i.fl to i32
  %i.fn = icmp eq i32 %i.fm, %i.du
  br i1 %i.fn, label %get_state.exit, label %.thread.i

.thread.i:                                        ; preds = %.preheader.i14
  %i.fo = getelementptr inbounds nuw i8, ptr %.02957.i, i64 8
...
.split.us:                                        ; preds = %.thread.i, %.thread.i.us
  ...
  %i.fq = getelementptr inbounds nuw i8, ptr %.us-phi24, i64 8
...
bb.o:                                             ; preds = %bb.n, %.split.us
  ...
  %i.ft = phi ptr [ %.pre36, %bb.n ], [ %i.dp, %.split.us ] ; 3 uses
  %i.fu = phi ptr [ %.pre33, %bb.n ], [ %i.dm, %.split.us ] ; 9 uses
  %i.fv = ptrtoaddr ptr %i.fu to i64
  %i.fw = trunc i64 %.pre-phi41 to i32
  %i.fx = and i32 %i.fw, -2
  ...
  store i16 %i.di, ptr %i.gb, align 2, !tbaa !49
  ...
  %i.gf = trunc i64 %.pre-phi43 to i16
  %i.gg = getelementptr inbounds nuw i8, ptr %i.fz, i64 20
  store i16 %i.gf, ptr %i.gg, align 4, !tbaa !26
  %i.gh = icmp ult ptr %i.fu, %i.ft
  br i1 %i.gh, label %iter.check153, label %new_state.exit.i

iter.check153:                                    ; preds = %bb.o
  %1 = ptrtoint ptr %i.fu to i64                  ; 2 uses
  %2 = ptrtoint ptr %i.ft to i64
  %i.gi = getelementptr inbounds nuw i8, ptr %i.fz, i64 22 ; 6 uses
  %i.gj = add i64 %1, 2
  %umax135 = tail call i64 @llvm.umax.i64(i64 %2, i64 %i.gj)
  %i.gk = xor i64 %1, -1
  %i.gl = add i64 %umax135, %i.gk                 ; 3 uses
  %i.gm = lshr i64 %i.gl, 1
  %i.gn = add nuw i64 %i.gm, 1                    ; 5 uses
  %min.iters.check136 = icmp ult i64 %i.gl, 6
...
vector.memcheck133:                               ; preds = %iter.check153
  ...
  %diff.check134 = icmp ult i64 %i.gp, 31
...
vector.main.loop.iter.check137:                   ; preds = %vector.memcheck133
  %min.iters.check138 = icmp ult i64 %i.gl, 30
  br i1 %min.iters.check138, label %vec.epilog.ph157, label %vector.ph139

vector.ph139:                                     ; preds = %vector.main.loop.iter.check137
  %n.mod.vf140 = and i64 %i.gn, 12
  %n.vec141 = and i64 %i.gn, -16                  ; 4 uses
  %i.gq = shl i64 %n.vec141, 1                    ; 2 uses
  %i.gr = getelementptr i8, ptr %i.fu, i64 %i.gq
  %i.gs = getelementptr i8, ptr %i.gi, i64 %i.gq
...
vector.body142:                                   ; preds = %vector.body142, %vector.ph139
  ...
  %i.gt = shl i64 %index143, 1                    ; 2 uses
  %next.gep144 = getelementptr i8, ptr %i.fu, i64 %i.gt ; 2 uses
  %next.gep145 = getelementptr i8, ptr %i.gi, i64 %i.gt ; 2 uses
  %i.gu = getelementptr i8, ptr %next.gep144, i64 16
  %wide.load146 = load <8 x i16>, ptr %next.gep144, align 2, !tbaa !11
  %wide.load147 = load <8 x i16>, ptr %i.gu, align 2, !tbaa !11
  %i.gv = getelementptr i8, ptr %next.gep145, i64 16
  store <8 x i16> %wide.load146, ptr %next.gep145, align 2, !tbaa !11
  store <8 x i16> %wide.load147, ptr %i.gv, align 2, !tbaa !11
  %index.next148 = add nuw i64 %index143, 16      ; 2 uses
  %i.gw = icmp eq i64 %index.next148, %n.vec141
  br i1 %i.gw, label %middle.block149, label %vector.body142, !llvm.loop !50

middle.block149:                                  ; preds = %vector.body142
  %cmp.n150 = icmp eq i64 %i.gn, %n.vec141
...
vec.epilog.ph157:                                 ; preds = %vector.main.loop.iter.check137, %vec.epilog.iter.check155
  ...
  %n.vec159 = and i64 %i.gn, -4                   ; 3 uses
  %i.gx = shl i64 %n.vec159, 1                    ; 2 uses
  %i.gy = getelementptr i8, ptr %i.fu, i64 %i.gx
  %i.gz = getelementptr i8, ptr %i.gi, i64 %i.gx
...
vec.epilog.vector.body160:                        ; preds = %vec.epilog.vector.body160, %vec.epilog.ph157
  ...
  %i.ha = shl i64 %index161, 1                    ; 2 uses
  %next.gep162 = getelementptr i8, ptr %i.fu, i64 %i.ha
  %next.gep163 = getelementptr i8, ptr %i.gi, i64 %i.ha
  ...
  %i.hb = icmp eq i64 %index.next165, %n.vec159
  br i1 %i.hb, label %vec.epilog.middle.block166, label %vec.epilog.vector.body160, !llvm.loop !51

vec.epilog.middle.block166:                       ; preds = %vec.epilog.vector.body160
  %cmp.n167 = icmp eq i64 %i.gn, %n.vec159
...
.lr.ph.i.i.preheader:                             ; preds = %vector.memcheck133, %iter.check153, %vec.epilog.iter.check155, %vec.epilog.middle.block166
  %.019.i.i.ph = phi ptr [ %i.fu, %iter.check153 ], [ %i.fu, %vector.memcheck133 ], [ %i.gr, %vec.epilog.iter.check155 ], [ %i.gy, %vec.epilog.middle.block166 ]
  %.01718.i.i.ph = phi ptr [ %i.gi, %iter.check153 ], [ %i.gi, %vector.memcheck133 ], [ %i.gs, %vec.epilog.iter.check155 ], [ %i.gz, %vec.epilog.middle.block166 ]
  br label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  %.019.i.i = phi ptr [ %i.hc, %.lr.ph.i.i ], [ %.019.i.i.ph, %.lr.ph.i.i.preheader ] ; 2 uses
  %.01718.i.i = phi ptr [ %i.he, %.lr.ph.i.i ], [ %.01718.i.i.ph, %.lr.ph.i.i.preheader ] ; 2 uses
  %i.hc = getelementptr inbounds nuw i8, ptr %.019.i.i, i64 2 ; 2 uses
  %i.hd = load i16, ptr %.019.i.i, align 2, !tbaa !11
  %i.he = getelementptr inbounds nuw i8, ptr %.01718.i.i, i64 2
  store i16 %i.hd, ptr %.01718.i.i, align 2, !tbaa !11
  %i.hf = icmp ult ptr %i.hc, %i.ft
  br i1 %i.hf, label %.lr.ph.i.i, label %new_state.exit.i, !llvm.loop !52

new_state.exit.i:                                 ; preds = %.lr.ph.i.i, %middle.block149, %vec.epilog.middle.block166, %bb.o
  %i.hg = load ptr, ptr @last_state, align 8, !tbaa !24
  store ptr %i.fz, ptr %i.hg, align 8, !tbaa !53
  store ptr %i.fz, ptr @last_state, align 8, !tbaa !24
  %i.hh = add nsw i32 %i.gc, 1
  store i32 %i.hh, ptr @nstates, align 4, !tbaa !4
  store ptr %i.fz, ptr %i.fq, align 8, !tbaa !47
  br label %get_state.exit

bb.p:                                             ; preds = %._crit_edge.i11.thread, %._crit_edge.i11
  %.0.lcssa.i1270 = phi i64 [ 0, %._crit_edge.i11.thread ], [ %i.er, %._crit_edge.i11 ]
  %i.hi = load i32, ptr @nstates, align 4, !tbaa !4
  %i.hj = icmp sgt i32 %i.hi, 32766
...
bb.r:                                             ; preds = %bb.q, %bb.p
  ...
  %i.hk = phi ptr [ %.pre62.i, %bb.q ], [ %i.dp, %bb.p ] ; 3 uses
  %i.hl = phi ptr [ %.pre59.i, %bb.q ], [ %i.dm, %bb.p ] ; 9 uses
  %i.hm = ptrtoaddr ptr %i.hl to i64
  %i.hn = trunc i64 %.pre-phi67.i to i32
  %i.ho = and i32 %i.hn, -2
  %i.hp = add i32 %i.ho, 22
  %i.hq = tail call ptr (i32, ...) @mallocate(i32 noundef %i.hp) #8 ; 9 uses
  %i.hr = ptrtoaddr ptr %i.hq to i64
  %i.hs = getelementptr inbounds nuw i8, ptr %i.hq, i64 18
  store i16 %i.di, ptr %i.hs, align 2, !tbaa !49
  %i.ht = load i32, ptr @nstates, align 4, !tbaa !4 ; 2 uses
  %i.hu = trunc i32 %i.ht to i16
  %i.hv = getelementptr inbounds nuw i8, ptr %i.hq, i64 16
  store i16 %i.hu, ptr %i.hv, align 8, !tbaa !29
  %i.hw = trunc i64 %.pre-phi69.i to i16
  %i.hx = getelementptr inbounds nuw i8, ptr %i.hq, i64 20
  store i16 %i.hw, ptr %i.hx, align 4, !tbaa !26
  %i.hy = icmp ult ptr %i.hl, %i.hk
  br i1 %i.hy, label %iter.check116, label %new_state.exit46.i

iter.check116:                                    ; preds = %bb.r
  %3 = ptrtoint ptr %i.hl to i64                  ; 2 uses
  %4 = ptrtoint ptr %i.hk to i64
  %i.hz = getelementptr inbounds nuw i8, ptr %i.hq, i64 22 ; 6 uses
  %i.ia = add i64 %3, 2
  %umax98 = tail call i64 @llvm.umax.i64(i64 %4, i64 %i.ia)
  %i.ib = xor i64 %3, -1
  %i.ic = add i64 %umax98, %i.ib                  ; 3 uses
  %i.id = lshr i64 %i.ic, 1
  %i.ie = add nuw i64 %i.id, 1                    ; 5 uses
  %min.iters.check99 = icmp ult i64 %i.ic, 6
  br i1 %min.iters.check99, label %.lr.ph.i43.i.preheader, label %vector.memcheck96

vector.memcheck96:                                ; preds = %iter.check116
  %i.if = sub i64 %i.hr, %i.hm
  %i.ig = add i64 %i.if, 21
  %diff.check97 = icmp ult i64 %i.ig, 31
...
vector.main.loop.iter.check100:                   ; preds = %vector.memcheck96
  %min.iters.check101 = icmp ult i64 %i.ic, 30
  br i1 %min.iters.check101, label %vec.epilog.ph120, label %vector.ph102

vector.ph102:                                     ; preds = %vector.main.loop.iter.check100
  %n.mod.vf103 = and i64 %i.ie, 12
  %n.vec104 = and i64 %i.ie, -16                  ; 4 uses
  %i.ih = shl i64 %n.vec104, 1                    ; 2 uses
  %i.ii = getelementptr i8, ptr %i.hl, i64 %i.ih
  %i.ij = getelementptr i8, ptr %i.hz, i64 %i.ih
...
vector.body105:                                   ; preds = %vector.body105, %vector.ph102
  ...
  %i.ik = shl i64 %index106, 1                    ; 2 uses
  %next.gep107 = getelementptr i8, ptr %i.hl, i64 %i.ik ; 2 uses
  %next.gep108 = getelementptr i8, ptr %i.hz, i64 %i.ik ; 2 uses
  %i.il = getelementptr i8, ptr %next.gep107, i64 16
  %wide.load109 = load <8 x i16>, ptr %next.gep107, align 2, !tbaa !11
  %wide.load110 = load <8 x i16>, ptr %i.il, align 2, !tbaa !11
  %i.im = getelementptr i8, ptr %next.gep108, i64 16
  store <8 x i16> %wide.load109, ptr %next.gep108, align 2, !tbaa !11
  store <8 x i16> %wide.load110, ptr %i.im, align 2, !tbaa !11
  %index.next111 = add nuw i64 %index106, 16      ; 2 uses
  %i.in = icmp eq i64 %index.next111, %n.vec104
  br i1 %i.in, label %middle.block112, label %vector.body105, !llvm.loop !54

middle.block112:                                  ; preds = %vector.body105
  %cmp.n113 = icmp eq i64 %i.ie, %n.vec104
...
vec.epilog.ph120:                                 ; preds = %vector.main.loop.iter.check100, %vec.epilog.iter.check118
  ...
  %n.vec122 = and i64 %i.ie, -4                   ; 3 uses
  %i.io = shl i64 %n.vec122, 1                    ; 2 uses
  %i.ip = getelementptr i8, ptr %i.hl, i64 %i.io
  %i.iq = getelementptr i8, ptr %i.hz, i64 %i.io
...
vec.epilog.vector.body123:                        ; preds = %vec.epilog.vector.body123, %vec.epilog.ph120
  ...
  %i.ir = shl i64 %index124, 1                    ; 2 uses
  %next.gep125 = getelementptr i8, ptr %i.hl, i64 %i.ir
  %next.gep126 = getelementptr i8, ptr %i.hz, i64 %i.ir
  ...
  %i.is = icmp eq i64 %index.next128, %n.vec122
  br i1 %i.is, label %vec.epilog.middle.block129, label %vec.epilog.vector.body123, !llvm.loop !55

vec.epilog.middle.block129:                       ; preds = %vec.epilog.vector.body123
  %cmp.n130 = icmp eq i64 %i.ie, %n.vec122
...
.lr.ph.i43.i.preheader:                           ; preds = %vector.memcheck96, %iter.check116, %vec.epilog.iter.check118, %vec.epilog.middle.block129
  %.019.i44.i.ph = phi ptr [ %i.hl, %iter.check116 ], [ %i.hl, %vector.memcheck96 ], [ %i.ii, %vec.epilog.iter.check118 ], [ %i.ip, %vec.epilog.middle.block129 ]
  %.01718.i45.i.ph = phi ptr [ %i.hz, %iter.check116 ], [ %i.hz, %vector.memcheck96 ], [ %i.ij, %vec.epilog.iter.check118 ], [ %i.iq, %vec.epilog.middle.block129 ]
  br label %.lr.ph.i43.i

.lr.ph.i43.i:                                     ; preds = %.lr.ph.i43.i.preheader, %.lr.ph.i43.i
  %.019.i44.i = phi ptr [ %i.it, %.lr.ph.i43.i ], [ %.019.i44.i.ph, %.lr.ph.i43.i.preheader ] ; 2 uses
  %.01718.i45.i = phi ptr [ %i.iv, %.lr.ph.i43.i ], [ %.01718.i45.i.ph, %.lr.ph.i43.i.preheader ] ; 2 uses
  %i.it = getelementptr inbounds nuw i8, ptr %.019.i44.i, i64 2 ; 2 uses
  %i.iu = load i16, ptr %.019.i44.i, align 2, !tbaa !11
  %i.iv = getelementptr inbounds nuw i8, ptr %.01718.i45.i, i64 2
  store i16 %i.iu, ptr %.01718.i45.i, align 2, !tbaa !11
  %i.iw = icmp ult ptr %i.it, %i.hk
  br i1 %i.iw, label %.lr.ph.i43.i, label %new_state.exit46.i, !llvm.loop !56

new_state.exit46.i:                               ; preds = %.lr.ph.i43.i, %middle.block112, %vec.epilog.middle.block129, %bb.r
  %i.ix = load ptr, ptr @last_state, align 8, !tbaa !24
  store ptr %i.hq, ptr %i.ix, align 8, !tbaa !53
  store ptr %i.hq, ptr @last_state, align 8, !tbaa !24
  %i.iy = add nsw i32 %i.ht, 1
  store i32 %i.iy, ptr @nstates, align 4, !tbaa !4
  %i.iz = load ptr, ptr @state_table, align 8, !tbaa !22
  %i.ja = getelementptr inbounds [8 x i8], ptr %i.iz, i64 %.0.lcssa.i1270
  store ptr %i.hq, ptr %i.ja, align 8, !tbaa !24
  br label %get_state.exit

get_state.exit:                                   ; preds = %.preheader.i14, %._crit_edge55.i.us, %new_state.exit.i, %new_state.exit46.i
  %.231.i = phi ptr [ %i.hq, %new_state.exit46.i ], [ %i.fz, %new_state.exit.i ], [ %.02957.i.us, %._crit_edge55.i.us ], [ %.02957.i, %.preheader.i14 ]
  %i.jb = getelementptr inbounds nuw i8, ptr %.231.i, i64 16
  %i.jc = load i16, ptr %i.jb, align 8, !tbaa !29
  %i.jd = load ptr, ptr @shiftset, align 8, !tbaa !8
  %i.je = getelementptr inbounds nuw [2 x i8], ptr %i.jd, i64 %indvars.iv23.i
  store i16 %i.jc, ptr %i.je, align 2, !tbaa !11
  %indvars.iv.next24.i = add nuw nsw i64 %indvars.iv23.i, 1 ; 2 uses
  %i.jf = load i32, ptr @nshifts, align 4, !tbaa !4 ; 3 uses
  %i.jg = sext i32 %i.jf to i64
  %i.jh = icmp slt i64 %indvars.iv.next24.i, %i.jg
  br i1 %i.jh, label %.lr.ph21.i, label %append_states.exit, !llvm.loop !57

append_states.exit:                               ; preds = %get_state.exit
  %i.ji = icmp sgt i32 %i.jf, 0
  br i1 %i.ji, label %bb.s, label %append_states.exit.thread71

bb.s:                                             ; preds = %append_states.exit
  %i.jj = shl nuw i32 %i.jf, 1
  %i.jk = add i32 %i.jj, 14
  %i.jl = tail call ptr (i32, ...) @mallocate(i32 noundef %i.jk) #8 ; 6 uses
  %i.jm = ptrtoaddr ptr %i.jl to i64
  %i.jn = load ptr, ptr @this_state, align 8, !tbaa !24
  %i.jo = getelementptr inbounds nuw i8, ptr %i.jn, i64 16
  %i.jp = load i16, ptr %i.jo, align 8, !tbaa !29
  %i.jq = getelementptr inbounds nuw i8, ptr %i.jl, i64 8
  store i16 %i.jp, ptr %i.jq, align 8, !tbaa !58
  %i.jr = load i32, ptr @nshifts, align 4, !tbaa !4 ; 3 uses
  %i.js = trunc i32 %i.jr to i16
  %i.jt = getelementptr inbounds nuw i8, ptr %i.jl, i64 10
  store i16 %i.js, ptr %i.jt, align 2, !tbaa !61
  %i.ju = load ptr, ptr @shiftset, align 8, !tbaa !8 ; 9 uses
  %i.jv = ptrtoaddr ptr %i.ju to i64
  %i.jw = sext i32 %i.jr to i64
  %.idx.i7 = shl nsw i64 %i.jw, 1                 ; 2 uses
  %i.jx = getelementptr inbounds i8, ptr %i.ju, i64 %.idx.i7
  %i.jy = icmp sgt i32 %i.jr, 0
  br i1 %i.jy, label %iter.check, label %save_shifts.exit

iter.check:                                       ; preds = %bb.s
  %5 = ptrtoint ptr %i.ju to i64                  ; 3 uses
  %i.jz = getelementptr inbounds nuw i8, ptr %i.jl, i64 12 ; 6 uses
  %i.ka = add i64 %.idx.i7, %5
  %i.kb = add i64 %5, 2
  %umax = tail call i64 @llvm.umax.i64(i64 %i.ka, i64 %i.kb)
  %i.kc = xor i64 %5, -1
  %i.kd = add i64 %umax, %i.kc                    ; 3 uses
  %i.ke = lshr i64 %i.kd, 1
  %i.kf = add nuw i64 %i.ke, 1                    ; 5 uses
  %min.iters.check = icmp ult i64 %i.kd, 6
  br i1 %min.iters.check, label %.lr.ph.i10.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %iter.check
  %i.kg = sub i64 %i.jm, %i.jv
  %i.kh = add i64 %i.kg, 11
  %diff.check = icmp ult i64 %i.kh, 31
  br i1 %diff.check, label %.lr.ph.i10.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %vector.memcheck
  %min.iters.check82 = icmp ult i64 %i.kd, 30
  br i1 %min.iters.check82, label %vec.epilog.ph, label %vector.ph

vector.ph:                                        ; preds = %vector.main.loop.iter.check
  %n.mod.vf = and i64 %i.kf, 12
  %n.vec = and i64 %i.kf, -16                     ; 4 uses
  %i.ki = shl i64 %n.vec, 1                       ; 2 uses
  %i.kj = getelementptr i8, ptr %i.ju, i64 %i.ki
  %i.kk = getelementptr i8, ptr %i.jz, i64 %i.ki
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.kl = shl i64 %index, 1                       ; 2 uses
  %next.gep = getelementptr i8, ptr %i.ju, i64 %i.kl ; 2 uses
  %next.gep83 = getelementptr i8, ptr %i.jz, i64 %i.kl ; 2 uses
  %i.km = getelementptr i8, ptr %next.gep, i64 16
  %wide.load = load <8 x i16>, ptr %next.gep, align 2, !tbaa !11
  %wide.load84 = load <8 x i16>, ptr %i.km, align 2, !tbaa !11
  %i.kn = getelementptr i8, ptr %next.gep83, i64 16
  store <8 x i16> %wide.load, ptr %next.gep83, align 2, !tbaa !11
  store <8 x i16> %wide.load84, ptr %i.kn, align 2, !tbaa !11
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.ko = icmp eq i64 %index.next, %n.vec
  br i1 %i.ko, label %middle.block, label %vector.body, !llvm.loop !62
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec87 = and i64 %i.kf, -4                    ; 3 uses
  %i.kp = shl i64 %n.vec87, 1                     ; 2 uses
  %i.kq = getelementptr i8, ptr %i.ju, i64 %i.kp
  %i.kr = getelementptr i8, ptr %i.jz, i64 %i.kp
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index88 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next92, %vec.epilog.vector.body ] ; 2 uses
  %i.ks = shl i64 %index88, 1                     ; 2 uses
  %next.gep89 = getelementptr i8, ptr %i.ju, i64 %i.ks
  %next.gep90 = getelementptr i8, ptr %i.jz, i64 %i.ks
  ...
  %i.kt = icmp eq i64 %index.next92, %n.vec87
  br i1 %i.kt, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !63

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n93 = icmp eq i64 %i.kf, %n.vec87
...
.lr.ph.i10.preheader:                             ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.014.i.ph = phi ptr [ %i.ju, %iter.check ], [ %i.ju, %vector.memcheck ], [ %i.kj, %vec.epilog.iter.check ], [ %i.kq, %vec.epilog.middle.block ]
  %.01113.i.ph = phi ptr [ %i.jz, %iter.check ], [ %i.jz, %vector.memcheck ], [ %i.kk, %vec.epilog.iter.check ], [ %i.kr, %vec.epilog.middle.block ]
  br label %.lr.ph.i10

.lr.ph.i10:                                       ; preds = %.lr.ph.i10.preheader, %.lr.ph.i10
  %.014.i = phi ptr [ %i.ku, %.lr.ph.i10 ], [ %.014.i.ph, %.lr.ph.i10.preheader ] ; 2 uses
  %.01113.i = phi ptr [ %i.kw, %.lr.ph.i10 ], [ %.01113.i.ph, %.lr.ph.i10.preheader ] ; 2 uses
  %i.ku = getelementptr inbounds nuw i8, ptr %.014.i, i64 2 ; 2 uses
  %i.kv = load i16, ptr %.014.i, align 2, !tbaa !11
  %i.kw = getelementptr inbounds nuw i8, ptr %.01113.i, i64 2
  store i16 %i.kv, ptr %.01113.i, align 2, !tbaa !11
  %i.kx = icmp ult ptr %i.ku, %i.jx
  br i1 %i.kx, label %.lr.ph.i10, label %save_shifts.exit, !llvm.loop !64

save_shifts.exit:                                 ; preds = %.lr.ph.i10, %middle.block, %vec.epilog.middle.block, %bb.s
  %i.ky = load ptr, ptr @last_shift, align 8, !tbaa !65 ; 2 uses
  %.not.i9 = icmp eq ptr %i.ky, null
  %first_shift..i = select i1 %.not.i9, ptr @first_shift, ptr %i.ky
  store ptr %i.jl, ptr %first_shift..i, align 8, !tbaa !65
  store ptr %i.jl, ptr @last_shift, align 8, !tbaa !65
  br label %append_states.exit.thread71

append_states.exit.thread71:                      ; preds = %.preheader.i, %append_states.exit.thread, %save_shifts.exit, %append_states.exit
  %i.kz = load ptr, ptr @this_state, align 8, !tbaa !24
  %i.la = load ptr, ptr %i.kz, align 8, !tbaa !53 ; 3 uses
  store ptr %i.la, ptr @this_state, align 8, !tbaa !24
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !8  ; 9 uses
...
iter.check:                                       ; preds = %bb.f
  %2 = ptrtoint ptr %i.bj to i64                  ; 2 uses
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  %i.dg = phi ptr [ %.pre59, %bb.h ], [ %i.d, %bb.g ] ; 9 uses
...
iter.check139:                                    ; preds = %bb.i
  %3 = ptrtoint ptr %i.dg to i64                  ; 2 uses
  %4 = ptrtoint ptr %i.df to i64
  %i.dv = getelementptr inbounds nuw i8, ptr %i.dl, i64 22 ; 6 uses
  %i.dw = add i64 %3, 2
  %umax119 = tail call i64 @llvm.umax.i64(i64 %4, i64 %i.dw)
  %i.dx = xor i64 %3, -1
