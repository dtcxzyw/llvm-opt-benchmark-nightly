...
polybench_alloc_data.exit:                        ; preds = %bb.a
  ...
  %i.l = load ptr, ptr %i.c, align 8, !tbaa !11   ; 7 uses
...
polybench_alloc_data.exit14:                      ; preds = %polybench_alloc_data.exit
  ...
  %i.r = load ptr, ptr %i.b, align 8, !tbaa !11   ; 6 uses
...
polybench_alloc_data.exit16:                      ; preds = %polybench_alloc_data.exit14
  ...
  %i.x = load ptr, ptr %i.a, align 8, !tbaa !11   ; 6 uses
...
vector.body:                                      ; preds = %vector.body, %.preheader.i
  ...
  store <2 x double> %i.ah, ptr %i.ai, align 8, !tbaa !9
...
.lver.check:                                      ; preds = %bb.h, %.preheader154.i
  ...
  store double 1.000000e+00, ptr %i.at, align 8, !tbaa !9
  %i.au = getelementptr inbounds nuw [8000 x i8], ptr %i.r, i64 %indvars.iv166.i ; 8 uses
  store double 0.000000e+00, ptr %i.au, align 8, !tbaa !9
  %i.av = load double, ptr %i.at, align 8, !tbaa !9
  %i.aw = getelementptr inbounds nuw [8000 x i8], ptr %i.x, i64 %indvars.iv166.i ; 8 uses
  store double %i.av, ptr %i.aw, align 8, !tbaa !9
...
.ph.lver.orig:                                    ; preds = %.lver.check, %.ph.lver.orig
  ...
  %i.bh = load <2 x double>, ptr %gep.i.lver.orig, align 8, !tbaa !9
  ...
  br i1 %exitcond.not.i21.lver.orig, label %.loopexit, label %.ph.lver.orig, !llvm.loop !16
...
bb.f:                                             ; preds = %bb.f, %.ph
  ...
  %i.ca = load <2 x double>, ptr %gep.i, align 8, !tbaa !9
  ...
  br i1 %exitcond.not.i21, label %.loopexit, label %bb.f, !llvm.loop !16
...
bb.g:                                             ; preds = %bb.g, %.loopexit
  ...
  store double %i.cu, ptr %i.cv, align 8, !tbaa !9
  ...
  store double %i.df, ptr %i.dg, align 8, !tbaa !9
...
bb.h:                                             ; preds = %bb.g
  ...
  br i1 %exitcond169.not.i, label %.lver.check42, label %.lver.check, !llvm.loop !18
...
.lver.check42:                                    ; preds = %bb.h, %bb.k
  ...
  store double 0.000000e+00, ptr %i.dm, align 8, !tbaa !9
  %i.dn = load double, ptr %i.dl, align 8, !tbaa !9
...
.ph43.lver.orig:                                  ; preds = %.lver.check42, %.ph43.lver.orig
  ...
  br i1 %exitcond173.not.i.lver.orig, label %.loopexit44, label %.ph43.lver.orig, !llvm.loop !19
...
bb.i:                                             ; preds = %bb.i, %.ph43
  ...
  store double %i.es, ptr %i.et, align 8, !tbaa !9
...
bb.j:                                             ; preds = %bb.j, %.loopexit44
  ...
  store double %i.fq, ptr %i.fm, align 8, !tbaa !9
...
kernel_adi.exit:                                  ; preds = %bb.l
  ...
  store i8 0, ptr %i.ga, align 1, !tbaa !28
...
bb.m:                                             ; preds = %bb.m, %.preheader.i23
  ...
  %i.gf = load i64, ptr %i.gc, align 8, !tbaa !9  ; 4 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  br i1 %exitcond23.not.i, label %print_array.exit, label %.preheader.i23, !llvm.loop !24
