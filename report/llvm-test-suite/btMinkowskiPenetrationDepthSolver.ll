...
bb.c:                                             ; preds = %.preheader335, %bb.c
  ...
  %20 = getelementptr inbounds nuw [16 x i8], ptr @_ZL22sPenetrationDirections, i64 %indvars.iv ; 3 uses
  %.sroa.5282.0..sroa_idx = getelementptr inbounds nuw i8, ptr %20, i64 4
  %.sroa.7.0..sroa_idx = getelementptr inbounds nuw i8, ptr %20, i64 8
  %i.ah = getelementptr inbounds nuw [16 x i8], ptr %13, i64 %indvars.iv ; 2 uses
  %.sroa.5282.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %i.ah, i64 8
  %.sroa.5282.0.copyload = load float, ptr %.sroa.5282.0..sroa_idx, align 4 ; 3 uses
  %.sroa.5282.0.copyload.a = load float, ptr %20, align 16 ; 3 uses
  %.sroa.7.0.copyload = load float, ptr %.sroa.7.0..sroa_idx, align 8 ; 3 uses
  %21 = fneg float %.sroa.5282.0.copyload         ; 2 uses
  %22 = fneg float %.sroa.5282.0.copyload.a       ; 2 uses
  %i.ai = fneg float %.sroa.7.0.copyload          ; 2 uses
  %23 = insertelement <2 x float> poison, float %21, i64 0
  %24 = shufflevector <2 x float> %23, <2 x float> poison, <2 x i32> zeroinitializer
  %i.aj = fmul <2 x float> %i.n, %24
  %25 = insertelement <2 x float> poison, float %22, i64 0
  %i.ak = shufflevector <2 x float> %25, <2 x float> poison, <2 x i32> zeroinitializer
  %i.al = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.m, <2 x float> %i.ak, <2 x float> %i.aj)
  %26 = insertelement <2 x float> poison, float %i.ai, i64 0
  %27 = shufflevector <2 x float> %26, <2 x float> poison, <2 x i32> zeroinitializer
  %28 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.o, <2 x float> %27, <2 x float> %i.al)
  %i.am = fmul float %i.s, %21
  %i.an = tail call float @llvm.fmuladd.f32(float %i.q, float %22, float %i.am)
  %i.ao = tail call noundef float @llvm.fmuladd.f32(float %i.u, float %i.ai, float %i.an)
  %.sroa.3.12.vec.insert.i142 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.ao, i64 0
  store <2 x float> %28, ptr %i.ah, align 16
  store <2 x float> %.sroa.3.12.vec.insert.i142, ptr %.sroa.5282.0..sroa_idx.a, align 8, !tbaa !9
  %29 = insertelement <2 x float> poison, float %.sroa.5282.0.copyload, i64 0
  %30 = shufflevector <2 x float> %29, <2 x float> poison, <2 x i32> zeroinitializer
  %31 = fmul <2 x float> %30, %i.z
  ...
  %32 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.y, <2 x float> %i.aq, <2 x float> %31)
  %33 = insertelement <2 x float> poison, float %.sroa.7.0.copyload, i64 0
  %34 = shufflevector <2 x float> %33, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ar = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aa, <2 x float> %34, <2 x float> %32)
  %i.as = fmul float %.sroa.5282.0.copyload, %i.ae
  %i.at = tail call float @llvm.fmuladd.f32(float %i.ac, float %.sroa.5282.0.copyload.a, float %i.as)
  %i.au = tail call noundef float @llvm.fmuladd.f32(float %i.ag, float %.sroa.7.0.copyload, float %i.at)
