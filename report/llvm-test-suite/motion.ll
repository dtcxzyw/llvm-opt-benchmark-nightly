...
bb.j:                                             ; preds = %bb.i, %decode_motion_vector.exit
  ...
  br i1 %or.cond3, label %bb.k, label %._crit_edge
...
bb.l:                                             ; preds = %._crit_edge
  ...
  br i1 %.not33.i31, label %decode_motion_vector.exit33.a, label %bb.m

bb.m:                                             ; preds = %bb.l
  %.neg34.i32 = shl i32 -32, %3
  %i.ap = add i32 %i.ao, %.neg34.i32
  br label %decode_motion_vector.exit33.a

bb.n:                                             ; preds = %._crit_edge
  %i.aq = icmp slt i32 %i.ab, 0
  br i1 %i.aq, label %bb.o, label %decode_motion_vector.exit33.a
...
bb.o:                                             ; preds = %bb.n
  ...
  br i1 %i.aw, label %bb.p, label %decode_motion_vector.exit33.a
...
decode_motion_vector.exit33.a:                    ; preds = %bb.l, %bb.m, %bb.n, %bb.o, %bb.p
