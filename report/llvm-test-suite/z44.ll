...
bb.ct:                                            ; preds = %bb.cs
  %i.lz = getelementptr inbounds nuw i8, ptr %.1280, i64 32
...
FindTarget.exit:                                  ; preds = %bb.cu, %bb.cu, %bb.cu, %bb.cu, %bb.cv
  ...
  %i.mh = getelementptr inbounds nuw i8, ptr %.1280, i64 %.sink
...
.critedge425:                                     ; preds = %bb.r, %bb.o, %bb.l, %.loopexit475, %bb.e, %bb.k, %._crit_edge574, %.loopexit465, %bb.cf, %bb.dc, %bb.c, %._crit_edge561, %.loopexit470, %bb.cq, %.critedge433, %._crit_edge
  %.0 = phi i32 [ 0, %bb.cf ], [ 0, %._crit_edge ], [ 0, %bb.k ], [ 0, %.loopexit470 ], [ 1, %bb.cq ], [ 0, %.critedge433 ], [ 0, %._crit_edge561 ], [ 0, %.loopexit465 ], [ 0, %bb.c ], [ 1, %bb.dc ], [ 0, %._crit_edge574 ], [ 0, %bb.e ], [ 0, %.loopexit475 ], [ 0, %bb.l ], [ 0, %bb.o ], [ 0, %bb.r ]
  ret i32 %.0
}
...
bb.l:                                             ; preds = %bb.j, %bb.k
  ...
  %.0176.in216 = getelementptr inbounds nuw i8, ptr %1, i64 8
  %.0176217 = load ptr, ptr %.0176.in216, align 8, !tbaa !8 ; 2 uses
  %.not202218 = icmp eq ptr %.0176217, %1
  br i1 %.not202218, label %._crit_edge, label %.preheader

.preheader:                                       ; preds = %bb.l, %bb.bt
  %.0176219 = phi ptr [ %.0176, %bb.bt ], [ %.0176217, %bb.l ] ; 2 uses
  br label %bb.m

bb.m:                                             ; preds = %.preheader, %bb.m
  %.0176.pn = phi ptr [ %.0, %bb.m ], [ %.0176219, %.preheader ]
  %.0.in = getelementptr inbounds nuw i8, ptr %.0176.pn, i64 16
  %.0 = load ptr, ptr %.0.in, align 8, !tbaa !8   ; 14 uses
...
bb.q:                                             ; preds = %bb.o, %bb.p
  ...
  %i.cx = getelementptr inbounds nuw i8, ptr %.0, i64 34
