...
begin_hunk_0_@_ZNK12btBox2dShape49batchedUnitVectorGetSupportingVertexWithoutMarginEPK9btVector3PS0_i:bb.a
  ...
  %i.i = load <4 x float>, ptr %i.d, align 8
  ...
  %4 = load <4 x float>, ptr %i.a, align 8
  %broadcast.splat = shufflevector <4 x float> %4, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %5 = fneg <4 x float> %broadcast.splat
  %6 = fneg <4 x float> %broadcast.splat26
  %i.k = fneg <4 x float> %broadcast.splat28.a
...
begin_hunk_1_@_ZNK12btBox2dShape49batchedUnitVectorGetSupportingVertexWithoutMarginEPK9btVector3PS0_i:bb.a
  ...
  %i.ac = select <4 x i1> %i.ab, <4 x float> %broadcast.splat, <4 x float> %5
...
begin_hunk_2_@_ZNK12btBox2dShape49batchedUnitVectorGetSupportingVertexWithoutMarginEPK9btVector3PS0_i:bb.a
  ...
  %i.aq = select <4 x i1> %i.ap, <4 x float> %broadcast.splat26, <4 x float> %6
...
begin_hunk_3_@_ZNK12btBox2dShape49batchedUnitVectorGetSupportingVertexWithoutMarginEPK9btVector3PS0_i:bb.a
  ...
  %i.be = select <4 x i1> %i.bd, <4 x float> %broadcast.splat28.a, <4 x float> %i.k
