...
bb.a:
  ...
  %i.m = fadd float %i.e, %i.l                    ; 3 uses
  %i.n = load float, ptr %1, align 4, !tbaa !10, !noalias !12
  %i.o = tail call noundef float @llvm.fabs.f32(float %i.n)
  %i.p = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.q = load float, ptr %i.p, align 4, !tbaa !10, !noalias !12
  ...
  %i.ao = fmul float %i.j, %i.r
  %i.ap = tail call float @llvm.fmuladd.f32(float %i.o, float %i.g, float %i.ao)
  %i.aq = tail call noundef float @llvm.fmuladd.f32(float %i.u, float %i.m, float %i.ap) ; 2 uses
  %i.ar = fmul float %i.j, %i.aa
  %i.as = tail call float @llvm.fmuladd.f32(float %i.x, float %i.g, float %i.ar)
  %i.at = tail call noundef float @llvm.fmuladd.f32(float %i.ad, float %i.m, float %i.as) ; 2 uses
  %i.au = fmul float %i.j, %i.aj
  %i.av = tail call float @llvm.fmuladd.f32(float %i.ag, float %i.g, float %i.au)
  %i.aw = tail call noundef float @llvm.fmuladd.f32(float %i.am, float %i.m, float %i.av) ; 2 uses
  %i.ax = fsub float %.sroa.022.0.copyload.i, %i.aq
  %i.ay = fsub float %.sroa.524.0.copyload.i, %i.at
  %i.az = fsub float %.sroa.7.0.copyload.i, %i.aw
  %.sroa.0.0.vec.insert.i7.i = insertelement <2 x float> poison, float %i.ax, i64 0
  %.sroa.0.4.vec.insert.i8.i = insertelement <2 x float> %.sroa.0.0.vec.insert.i7.i, float %i.ay, i64 1
  %.sroa.3.12.vec.insert.i9.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.az, i64 0
  store <2 x float> %.sroa.0.4.vec.insert.i8.i, ptr %2, align 4
  ...
  %i.ba = fadd float %i.aq, %.sroa.022.0.copyload.i
  %i.bb = fadd float %i.at, %.sroa.524.0.copyload.i
  %i.bc = fadd float %.sroa.7.0.copyload.i, %i.aw
  %.sroa.0.0.vec.insert.i12.i = insertelement <2 x float> poison, float %i.ba, i64 0
  %.sroa.0.4.vec.insert.i13.i = insertelement <2 x float> %.sroa.0.0.vec.insert.i12.i, float %i.bb, i64 1
  %.sroa.3.12.vec.insert.i14.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.bc, i64 0
  store <2 x float> %.sroa.0.4.vec.insert.i13.i, ptr %3, align 4
...
bb.a:
  ...
  %i.s = insertelement <2 x float> %i.r, float %i.e, i64 1
  %i.t = fadd <2 x float> %i.n, %i.s
  %i.u = fmul <2 x float> %i.t, splat (float 2.000000e+00) ; 5 uses
  %i.v = fdiv float %1, 1.200000e+01
  ...
  %i.y = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.u, <2 x float> %i.u, <2 x float> %i.x)
  %foldExtExtBinop = fmul <2 x float> %i.u, %i.u
  %i.z = extractelement <2 x float> %foldExtExtBinop, i64 0
  %i.aa = extractelement <2 x float> %i.u, i64 1  ; 2 uses
  %i.ab = tail call float @llvm.fmuladd.f32(float %i.aa, float %i.aa, float %i.z)
  %i.ac = insertelement <4 x float> <float poison, float 0.000000e+00, float poison, float poison>, float %i.v, i64 0
  %i.ad = shufflevector <4 x float> %i.ac, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %i.ae = insertelement <4 x float> <float poison, float poison, float poison, float 1.000000e+00>, float %i.ab, i64 2
  %i.af = shufflevector <2 x float> %i.y, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.ag = shufflevector <4 x float> %i.af, <4 x float> %i.ae, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.ah = fmul <4 x float> %i.ad, %i.ag
  store <4 x float> %i.ah, ptr %2, align 4, !tbaa !10
  ret void
}
...
bb.a:
  ...
  %i.c = load float, ptr %i.a, align 8, !tbaa !10 ; 2 uses
  %i.d = fneg float %i.c
  %i.e = fcmp oge float %i.b, 0.000000e+00
  %i.f = select i1 %i.e, float %i.c, float %i.d
  %i.g = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 44
  %i.i = load <2 x float>, ptr %i.g, align 4, !tbaa !10
  %i.j = load <2 x float>, ptr %i.h, align 4, !tbaa !10 ; 2 uses
  %i.k = fneg <2 x float> %i.j
  %i.l = fcmp oge <2 x float> %i.i, zeroinitializer
  %i.m = select <2 x i1> %i.l, <2 x float> %i.j, <2 x float> %i.k ; 2 uses
  %.sroa.0.0.vec.insert = insertelement <2 x float> poison, float %i.f, i64 0
  %i.n = shufflevector <2 x float> %.sroa.0.0.vec.insert, <2 x float> %i.m, <2 x i32> <i32 0, i32 2>
  %i.o = shufflevector <2 x float> <float poison, float 0.000000e+00>, <2 x float> %i.m, <2 x i32> <i32 3, i32 1>
...
bb.a:
  ...
  %i.h = fneg float %i.g
  %i.i = fmul float %.sroa.7.0.copyload, %i.h
  %i.j = tail call float @llvm.fmuladd.f32(float %.sroa.7.0.copyload, float %i.f, float %i.i)
  %i.k = load <2 x float>, ptr %i.a, align 8      ; 2 uses
  %i.l = and i32 %i.b, 1                          ; 2 uses
  %i.m = and i32 %1, 1                            ; 2 uses
  %i.n = xor i32 %i.l, 1
  %i.o = xor i32 %i.m, 1
  %i.p = uitofp nneg i32 %i.n to float
  %i.q = uitofp nneg i32 %i.o to float
  %i.r = insertelement <2 x i32> poison, i32 %i.m, i64 0
  %i.s = insertelement <2 x i32> %i.r, i32 %i.l, i64 1
  %i.t = uitofp nneg <2 x i32> %i.s to <2 x float>
  %i.u = fneg <2 x float> %i.t
  %i.v = fmul <2 x float> %i.k, %i.u
  %i.w = insertelement <2 x float> poison, float %i.q, i64 0
  %i.x = insertelement <2 x float> %i.w, float %i.p, i64 1
  %i.y = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.k, <2 x float> %i.x, <2 x float> %i.v)
  store <2 x float> %i.y, ptr %2, align 4
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %2, i64 8
  store float %i.j, ptr %.sroa.5.0..sroa_idx, align 4
