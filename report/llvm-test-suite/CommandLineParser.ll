...
begin_hunk_0_@_ZN18NCommandLineParser7CParser11ParseStringERK11CStringBaseIwEPKNS_11CSwitchFormE:bb.a
  ...
  br i1 %i.jz, label %_ZN11CStringBaseIwED2Ev.exit175, label %bb.bk

bb.bk:                                            ; preds = %.body171
  call void @_ZdaPv(ptr noundef nonnull %i.jy) #18
  br label %_ZN11CStringBaseIwED2Ev.exit175

_ZN11CStringBaseIwED2Ev.exit175:                  ; preds = %.body171, %bb.bk
...
_ZN11CStringBaseIwED2Ev.exit156:                  ; preds = %bb.bl, %bb.aj, %bb.ai, %bb.y, %bb.w
  %.7 = phi i32 [ %.498.lcssa, %bb.bl ], [ %i.cq, %bb.w ], [ %.397, %bb.aj ], [ %spec.select138, %bb.y ], [ %.397, %bb.ai ] ; 2 uses
  %i.ka = icmp slt i32 %.7, %i.b
  br i1 %i.ka, label %bb.c, label %.critedge140, !llvm.loop !66

_ZN11CStringBaseIwED2Ev.exit148:                  ; preds = %.body184.thread, %.body184, %_ZN11CStringBaseIwED2Ev.exit175, %_ZN11CStringBaseIwED2Ev.exit160
...
.preheader23.i.i:                                 ; preds = %bb.f
  ...
  br i1 %i.x, label %.preheader.lr.ph.i.i, label %_ZNK11CStringBaseIwE4FindERKS0_.exit.thread
...
.preheader.us.preheader.i.i:                      ; preds = %.preheader.lr.ph.i.i
  %i.aa = zext nneg i32 %.pre to i64              ; 2 uses
...
bb.g:                                             ; preds = %bb.i, %.preheader.us.i.i
  ...
  %i.ab = add nuw nsw i64 %indvars.iv.i.i, %indvars.iv35.i.i ; 2 uses
  %i.ac = icmp samesign ult i64 %i.ab, %i.aa
  br i1 %i.ac, label %bb.h, label %.critedge.us.i.i

bb.h:                                             ; preds = %bb.g
  %i.ad = getelementptr inbounds nuw [4 x i8], ptr %i.z, i64 %i.ab
...
.critedge.us.i.i:                                 ; preds = %bb.h, %bb.g
  ...
  %i.ah = icmp eq i64 %indvars.iv.next36.i.i, %i.aa
...
_ZNK11CStringBaseIwE4FindERKS0_.exit.thread41:    ; preds = %bb.f, %_ZNK11CStringBaseIwE4FindERKS0_.exit
  ...
  %i.aj = sub nsw i32 %.pre, %i.h
  invoke void @_ZNK11CStringBaseIwE3MidEii(ptr dead_on_unwind nonnull writable sret(%class.CStringBase) align 8 %4, ptr noundef nonnull align 8 dereferenceable(16) %2, i32 noundef %i.h, i32 noundef %i.aj)
          to label %bb.j unwind label %bb.p

bb.j:                                             ; preds = %_ZNK11CStringBaseIwE4FindERKS0_.exit.thread41
  store i32 0, ptr %i.b, align 8, !tbaa !27
  %i.ak = load ptr, ptr %3, align 8, !tbaa !30    ; 3 uses
  store i32 0, ptr %i.ak, align 4, !tbaa !31
  %i.al = load i32, ptr %i.d, align 8, !tbaa !27  ; 2 uses
  %i.am = add nsw i32 %i.al, 1                    ; 3 uses
  %i.an = load i32, ptr %i.e, align 4, !tbaa !33  ; 2 uses
  %i.ao = icmp eq i32 %i.am, %i.an
  br i1 %i.ao, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i27, label %bb.k
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.at = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %i.as) #15
          to label %.noexc unwind label %bb.q     ; 3 uses

.noexc:                                           ; preds = %bb.k
  %i.au = icmp sgt i32 %i.an, 0
  br i1 %i.au, label %._crit_edge.thread.i.i, label %bb.l

._crit_edge.thread.i.i:                           ; preds = %.noexc
  call void @_ZdaPv(ptr noundef nonnull %i.ak) #18
  %.pre.i = load i32, ptr %i.b, align 8, !tbaa !27
  %i.av = sext i32 %.pre.i to i64
  br label %bb.l

bb.l:                                             ; preds = %._crit_edge.thread.i.i, %.noexc
  %i.aw = phi i64 [ %i.av, %._crit_edge.thread.i.i ], [ 0, %.noexc ]
  store ptr %i.at, ptr %3, align 8, !tbaa !30
  %i.ax = getelementptr inbounds [4 x i8], ptr %i.at, i64 %i.aw
  store i32 0, ptr %i.ax, align 4, !tbaa !31
  store i32 %i.am, ptr %i.e, align 4, !tbaa !33
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i27

_ZN11CStringBaseIwE11SetCapacityEi.exit.i27:      ; preds = %bb.l, %bb.j
  %i.ay = phi ptr [ %i.ak, %bb.j ], [ %i.at, %bb.l ]
  %i.az = load ptr, ptr %4, align 8, !tbaa !30    ; 3 uses
  br label %bb.m

bb.m:                                             ; preds = %bb.m, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i27
  %.04.i.i28 = phi ptr [ %i.az, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i27 ], [ %i.ba, %bb.m ] ; 2 uses
  %.0.i.i29 = phi ptr [ %i.ay, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i27 ], [ %i.bc, %bb.m ] ; 2 uses
  %i.ba = getelementptr inbounds nuw i8, ptr %.04.i.i28, i64 4
  %i.bb = load i32, ptr %.04.i.i28, align 4, !tbaa !31 ; 2 uses
  %i.bc = getelementptr inbounds nuw i8, ptr %.0.i.i29, i64 4
  store i32 %i.bb, ptr %.0.i.i29, align 4, !tbaa !31
  %.not.i.i30 = icmp eq i32 %i.bb, 0
  br i1 %.not.i.i30, label %_ZN11CStringBaseIwEaSERKS0_.exit, label %bb.m, !llvm.loop !34

_ZN11CStringBaseIwEaSERKS0_.exit:                 ; preds = %bb.m
  %5 = load i32, ptr %i.d, align 8, !tbaa !27
  store i32 %5, ptr %i.b, align 8, !tbaa !27
  %i.bd = icmp eq ptr %i.az, null
  br i1 %i.bd, label %_ZN11CStringBaseIwED2Ev.exit, label %bb.n

bb.n:                                             ; preds = %_ZN11CStringBaseIwEaSERKS0_.exit
  call void @_ZdaPv(ptr noundef nonnull %i.az) #18
...
bb.q:                                             ; preds = %bb.k
  %i.bg = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.bh = load ptr, ptr %4, align 8, !tbaa !30    ; 2 uses
  %i.bi = icmp eq ptr %i.bh, null
  br i1 %i.bi, label %_ZN11CStringBaseIwED2Ev.exit31, label %bb.r

bb.r:                                             ; preds = %bb.q
  call void @_ZdaPv(ptr noundef nonnull %i.bh) #18
  br label %_ZN11CStringBaseIwED2Ev.exit31

_ZN11CStringBaseIwED2Ev.exit31:                   ; preds = %bb.r, %bb.q, %bb.p
  %.pn = phi { ptr, i32 } [ %i.bf, %bb.p ], [ %i.bg, %bb.q ], [ %i.bg, %bb.r ]
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #16
  br label %bb.w

bb.s:                                             ; preds = %_ZN11CStringBaseIwEC2EPKw.exit
  %i.bj = load ptr, ptr %2, align 8, !tbaa !30
  %i.bk = invoke noundef i32 @_Z15MyStringComparePKwS0_(ptr noundef %i.bj, ptr noundef %.sroa.0.0)
          to label %bb.t unwind label %bb.o

bb.t:                                             ; preds = %bb.s
  %i.bl = icmp eq i32 %i.bk, 0
  br i1 %i.bl, label %bb.u, label %_ZNK11CStringBaseIwE4FindERKS0_.exit.thread

bb.u:                                             ; preds = %bb.t
  store i32 0, ptr %i.b, align 8, !tbaa !27
  %i.bm = load ptr, ptr %3, align 8, !tbaa !30
...
_ZNK11CStringBaseIwE4FindERKS0_.exit.thread:      ; preds = %.critedge.us.i.i, %.preheader.lr.ph.i.i, %.preheader23.i.i, %_ZNK11CStringBaseIwE4FindERKS0_.exit, %bb.t, %bb.u, %_ZN11CStringBaseIwED2Ev.exit
  ...
  br i1 %i.bn, label %_ZN11CStringBaseIwED2Ev.exit33, label %bb.v
...
bb.w:                                             ; preds = %_ZN11CStringBaseIwED2Ev.exit31, %bb.o
  %.pn.pn = phi { ptr, i32 } [ %.pn, %_ZN11CStringBaseIwED2Ev.exit31 ], [ %i.be, %bb.o ]
  %i.bo = icmp eq ptr %.sroa.0.0, null
  br i1 %i.bo, label %_ZN11CStringBaseIwED2Ev.exit34, label %bb.x
...
._crit_edge:                                      ; preds = %_ZN11CStringBaseIwED2Ev.exit33, %bb.b, %bb.a
  %i.bp = phi i32 [ -1, %bb.a ], [ -1, %bb.b ], [ %.124, %_ZN11CStringBaseIwED2Ev.exit33 ]
  ret i32 %i.bp
}
