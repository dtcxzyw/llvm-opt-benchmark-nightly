...
bb.c:                                             ; preds = %.lr.ph, %bb.b
  ...
  %.02350 = phi i32 [ undef, %.lr.ph ], [ %.124, %bb.b ] ; 4 uses
...
.preheader23.i.i:                                 ; preds = %bb.f
  ...
  %or.cond.i.i = and i1 %i.y, %i.x
  br i1 %or.cond.i.i, label %.preheader.us.preheader.i.i, label %_ZNK11CStringBaseIwE4FindERKS0_.exit.thread

.preheader.us.preheader.i.i:                      ; preds = %.preheader23.i.i
...
_ZNK11CStringBaseIwE3MidEi.exit:                  ; preds = %_ZNK11CStringBaseIwE4FindERKS0_.exit.thread41
  ...
  br i1 %i.ao, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i27, label %bb.j
...
.noexc:                                           ; preds = %bb.j
  ...
  br i1 %i.au, label %._crit_edge.thread.i.i, label %bb.k
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i27:      ; preds = %bb.k, %_ZNK11CStringBaseIwE3MidEi.exit
  %i.ay = phi ptr [ %i.ak, %_ZNK11CStringBaseIwE3MidEi.exit ], [ %i.at, %bb.k ]
  %i.az = load ptr, ptr %4, align 8, !tbaa !30    ; 3 uses
  br label %bb.l

bb.l:                                             ; preds = %bb.l, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i27
  %.04.i.i28 = phi ptr [ %i.az, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i27 ], [ %i.ba, %bb.l ] ; 2 uses
  %.0.i.i29 = phi ptr [ %i.ay, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i27 ], [ %i.bc, %bb.l ] ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  %i.bd = load i32, ptr %i.d, align 8, !tbaa !27
  store i32 %i.bd, ptr %i.b, align 8, !tbaa !27
  %i.be = icmp eq ptr %i.az, null
