...
bb.j:                                             ; preds = %bb.f, %bb.i, %bb.h, %bb.d
  ...
  %.sroa.892.0.in = getelementptr inbounds nuw i8, ptr %.sroa.892.0.in.a, i64 4
  ...
  %.sroa.886.0.in = getelementptr inbounds nuw i8, ptr %.sroa.886.0.in.a, i64 4
...
bb.f:                                             ; preds = %bb.d, %bb.c
  %i.u = icmp eq i32 %2, 0                        ; 10 uses
  %. = select i1 %i.u, ptr %i.g, ptr %i.f
...
bb.p:                                             ; preds = %bb.g
  ...
  br i1 %i.u, label %bb.q, label %._crit_edge459

._crit_edge459:                                   ; preds = %bb.p
  %.in296.phi.trans.insert = getelementptr inbounds nuw i8, ptr %.0269, i64 72
  %.pre460 = load i32, ptr %.in296.phi.trans.insert, align 8, !tbaa !17
  br label %bb.s
...
bb.s:                                             ; preds = %._crit_edge459, %bb.q
  %i.aq = phi i32 [ %i.am, %bb.q ], [ %.pre460, %._crit_edge459 ]
...
bb.aq:                                            ; preds = %bb.ap
  %..i303 = select i1 %i.u, i64 24, i64 16
  %.in.i = getelementptr inbounds nuw i8, ptr %0, i64 %..i303
  %i.fh = load ptr, ptr %.in.i, align 8, !tbaa !17
