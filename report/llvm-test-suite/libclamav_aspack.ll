...
bb.i:                                             ; preds = %bb.h
  ...
  %i.br = getelementptr inbounds nuw i8, ptr %0, i64 %i.bq ; 14 uses
...
.outer.split.i.preheader.i:                       ; preds = %.outer.backedge.i.i, %bb.l
  %.074.ph.i21.i = phi i32 [ 0, %bb.l ], [ %.074.ph.be.i.i, %.outer.backedge.i.i ] ; 13 uses
...
.outer.backedge.i.i:                              ; preds = %.preheader.i.i.prol.loopexit, %.preheader.i.i, %middle.block.a, %bb.n
  %8 = phi i32 [ %i.ca, %bb.n ], [ %i.gh, %middle.block.a ], [ %i.gh, %.preheader.i.i ], [ %i.gh, %.preheader.i.i.prol.loopexit ]
  %.074.ph.be.i.i = phi i32 [ %i.ch, %bb.n ], [ %i.gv, %middle.block.a ], [ %.lcssa317.unr, %.preheader.i.i.prol.loopexit ], [ %i.ir, %.preheader.i.i ] ; 2 uses
...
bb.v:                                             ; preds = %readstream.exit.i.i, %._crit_edge.i
  ...
  %.179.i.i = phi i32 [ %i.dv, %readstream.exit.i.i ], [ %i.co, %._crit_edge.i ] ; 9 uses
...
bb.ag:                                            ; preds = %.sink.split.i.i, %bb.ad
  %i.gh = phi i32 [ %i.ca, %bb.ad ], [ %.sink.i.i, %.sink.split.i.i ] ; 3 uses
  %.077.i.i = phi i32 [ %i.ge, %bb.ad ], [ %.sink.i.i, %.sink.split.i.i ] ; 5 uses
  %.neg.i.i = xor i32 %.077.i.i, -1               ; 5 uses
...
.preheader.i.i.preheader.a:                       ; preds = %bb.ag
  %min.iters.check = icmp ult i32 %.179.i.i, 32
...
begin_hunk_6_@unaspack212:bb.a
  ...
  br i1 %diff.check, label %.preheader.i.i.preheader305, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i32 %.179.i.i, -32                 ; 3 uses
...
begin_hunk_7_@unaspack212:bb.a
  ...
  br i1 %i.he, label %middle.block.a, label %vector.body, !llvm.loop !27

middle.block.a:                                   ; preds = %vector.body
  %cmp.n.a = icmp eq i32 %.179.i.i, %n.vec
  br i1 %cmp.n.a, label %.outer.backedge.i.i, label %.preheader.i.i.preheader305

.preheader.i.i.preheader305:                      ; preds = %vector.memcheck, %vector.scevcheck, %.preheader.i.i.preheader.a, %middle.block.a
  %.175129.i.i.ph = phi i32 [ %.074.ph.i21.i, %vector.memcheck ], [ %.074.ph.i21.i, %vector.scevcheck ], [ %.074.ph.i21.i, %.preheader.i.i.preheader.a ], [ %i.gv, %middle.block.a ] ; 2 uses
  %.280128.i.i.ph = phi i32 [ %.179.i.i, %vector.memcheck ], [ %.179.i.i, %vector.scevcheck ], [ %.179.i.i, %.preheader.i.i.preheader.a ], [ %i.gw, %middle.block.a ] ; 4 uses
...
begin_hunk_8_@unaspack212:bb.a
  ...
  br i1 %prol.iter.cmp.not, label %.preheader.i.i.prol.loopexit, label %.preheader.i.i.prol, !llvm.loop !30
...
begin_hunk_9_@unaspack212:bb.a
  ...
  br i1 %.not94.i.i.3, label %.outer.backedge.i.i, label %.preheader.i.i, !llvm.loop !32
...
begin_hunk_10_@unaspack212:bb.a
  ...
  br i1 %i.jk, label %.lr.ph, label %.loopexit, !llvm.loop !33

.loopexit:                                        ; preds = %bb.ak, %bb.ah
  %.4 = phi i32 [ %.1208, %bb.ah ], [ %i.jj, %bb.ak ]
  br i1 %.not157, label %.critedge172, label %bb.f, !llvm.loop !34
...
begin_hunk_13_@unaspack212:bb.a
  ...
  br i1 %niter.ncmp.3, label %._crit_edge.loopexit.unr-lcssa, label %.lr.ph215, !llvm.loop !38
...
begin_hunk_14_@unaspack212:bb.a
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge, label %.lr.ph215.epil, !llvm.loop !39
...
begin_hunk_15_@build_decrypt_dictionaries:bb.a
  ...
  br i1 %exitcond.not, label %.split.us, label %.preheader115.split.us, !llvm.loop !40
...
begin_hunk_16_@build_decrypt_dictionaries:bb.a
  ...
  br i1 %or.cond, label %.loopexit110.loopexit, label %.lr.ph130, !llvm.loop !41
...
.loopexit110:                                     ; preds = %.loopexit110.loopexit134, %.loopexit110.loopexit, %bb.s
  ...
  br i1 %i.fm, label %bb.g, label %.loopexit110.thread, !llvm.loop !42
...
begin_hunk_19_@build_decrypt_array:bb.a
  ...
  br i1 %exitcond137.not, label %bb.i, label %bb.c, !llvm.loop !44
...
begin_hunk_20_@build_decrypt_array:bb.a
  ...
  br i1 %i.bj, label %.lr.ph122, label %.critedge, !llvm.loop !45
...
!32 = distinct !{!32, !20, !28}
!33 = distinct !{!33, !20}
!34 = distinct !{!34, !20}
!35 = !{!36, !5, i64 0}
!36 = !{!"cli_exe_section", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !5, i64 32}
!37 = !{!36, !5, i64 12}
!38 = distinct !{!38, !20}
!39 = distinct !{!39, !31}
!40 = distinct !{!40, !20}
