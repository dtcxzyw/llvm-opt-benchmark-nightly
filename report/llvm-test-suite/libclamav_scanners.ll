...
bb.x:                                             ; preds = %bb.w
  %i.ax = getelementptr inbounds nuw i8, ptr %1, i64 44 ; 7 uses
  %i.ay = load i32, ptr %i.ax, align 4, !tbaa !35 ; 4 uses
  %i.az = add i32 %i.ay, 1
  store i32 %i.az, ptr %i.ax, align 4, !tbaa !35
  switch i32 %i.ae, label %.thread262 [
    i32 510, label %bb.y
    i32 508, label %bb.z
    i32 507, label %bb.ab
end_hunk_0
...
.thread262:                                       ; preds = %bb.x
  store i32 %i.ay, ptr %i.ax, align 4, !tbaa !35
  br label %bb.cx
