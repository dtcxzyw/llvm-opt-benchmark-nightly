...
.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge1107
  ...
  %i.bal = add nsw i64 %indvars.iv1153, %i.bae    ; 10 uses
...
bb.gb:                                            ; preds = %bb.gb, %.lr.ph1106.split.us.split.us
  ...
  %13 = sext i32 %i.baz to i64
  %14 = getelementptr [8 x i8], ptr %i.bat, i64 %i.bau
  %i.bba = getelementptr [8 x i8], ptr %14, i64 %13
  %i.bbb = load ptr, ptr %i.bba, align 8, !tbaa !53
  %i.bbc = load i32, ptr %i.bak, align 8, !tbaa !96
  %i.bbd = ashr i32 %i.bbc, 2
  %15 = sext i32 %i.bbd to i64
  %16 = getelementptr [4 x i8], ptr %i.bbb, i64 %i.bal
  %i.bbe = getelementptr [4 x i8], ptr %16, i64 %15
...
.lr.ph1106.split.new:                             ; preds = %.lr.ph1106.split, %.lr.ph1106.split.new
  ...
  %17 = sext i32 %i.bcb to i64
  %18 = getelementptr [4 x i8], ptr %i.bbz, i64 %i.bal
  %i.bcc = getelementptr [4 x i8], ptr %18, i64 %17
  ...
  %19 = sext i32 %i.bcm to i64
  %20 = getelementptr [4 x i8], ptr %i.bck, i64 %i.bal
  %i.bcn = getelementptr [4 x i8], ptr %20, i64 %19
...
.epil.preheader:                                  ; preds = %._crit_edge1107.loopexit1269.unr-lcssa, %.lr.ph1106.split
  ...
  %21 = sext i32 %i.bcz to i64
  %22 = getelementptr [4 x i8], ptr %i.bcx, i64 %i.bal
  %i.bda = getelementptr [4 x i8], ptr %22, i64 %21
