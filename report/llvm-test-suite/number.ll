...
free_num.exit.i124:                               ; preds = %bb.t, %bb.s, %._crit_edge.i121
  ...
  br i1 %i.im, label %iter.check382, label %bb.u

bb.u:                                             ; preds = %free_num.exit.i124
  store i32 1, ptr %i.iy, align 4, !tbaa !12
  br label %iter.check382

iter.check382:                                    ; preds = %bb.u, %free_num.exit.i124
  %i.jd = zext i32 %.018.lcssa.i122 to i64        ; 5 uses
  %min.iters.check362 = icmp ult i32 %.018.lcssa.i122, 8
  br i1 %min.iters.check362, label %vec.epilog.scalar.ph383.preheader, label %vector.memcheck354

vector.memcheck354:                               ; preds = %iter.check382
  %scevgep355 = getelementptr i8, ptr %i.iy, i64 17
  %i.je = add i32 %.018.lcssa.i122, -1
  %i.jf = zext i32 %i.je to i64                   ; 2 uses
  %scevgep356 = getelementptr i8, ptr %scevgep355, i64 %i.jf
  %scevgep357 = getelementptr i8, ptr %.020.lcssa.i123, i64 -1
  %i.jg = sub nsw i64 0, %i.jf
  %scevgep358 = getelementptr i8, ptr %scevgep357, i64 %i.jg
  %bound0359 = icmp ult ptr %i.jc, %.020.lcssa.i123
  %bound1360 = icmp ult ptr %scevgep358, %scevgep356
  %found.conflict361 = and i1 %bound0359, %bound1360
  br i1 %found.conflict361, label %vec.epilog.scalar.ph383.preheader, label %vector.main.loop.iter.check363

vector.main.loop.iter.check363:                   ; preds = %vector.memcheck354
  %min.iters.check364 = icmp ult i32 %.018.lcssa.i122, 32
  br i1 %min.iters.check364, label %vec.epilog.ph386, label %vector.ph365

vector.ph365:                                     ; preds = %vector.main.loop.iter.check363
  %n.mod.vf366 = and i64 %i.jd, 24
  %n.vec367 = and i64 %i.jd, 4294967264           ; 6 uses
  %i.jh = trunc nuw i64 %n.vec367 to i32
  %i.ji = sub i32 %.018.lcssa.i122, %i.jh
  %i.jj = getelementptr i8, ptr %i.jc, i64 %n.vec367
  %i.jk = sub nsw i64 0, %n.vec367
  %i.jl = getelementptr i8, ptr %.020.lcssa.i123, i64 %i.jk
  br label %vector.body368

vector.body368:                                   ; preds = %vector.body368, %vector.ph365
  %index369 = phi i64 [ 0, %vector.ph365 ], [ %index.next376, %vector.body368 ] ; 3 uses
  %next.gep370 = getelementptr i8, ptr %i.jc, i64 %index369 ; 2 uses
  %i.jm = sub i64 0, %index369
  %next.gep371 = getelementptr i8, ptr %.020.lcssa.i123, i64 %i.jm ; 2 uses
  %i.jn = getelementptr inbounds i8, ptr %next.gep371, i64 -16
  %i.jo = getelementptr inbounds i8, ptr %next.gep371, i64 -32
  %wide.load372 = load <16 x i8>, ptr %i.jn, align 1, !tbaa !15, !alias.scope !99
  %wide.load373 = load <16 x i8>, ptr %i.jo, align 1, !tbaa !15, !alias.scope !99
  %reverse374 = shufflevector <16 x i8> %wide.load372, <16 x i8> poison, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  %reverse375 = shufflevector <16 x i8> %wide.load373, <16 x i8> poison, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  %i.jp = getelementptr i8, ptr %next.gep370, i64 16
  store <16 x i8> %reverse374, ptr %next.gep370, align 1, !tbaa !15, !alias.scope !102, !noalias !99
  store <16 x i8> %reverse375, ptr %i.jp, align 1, !tbaa !15, !alias.scope !102, !noalias !99
  %index.next376 = add nuw i64 %index369, 32      ; 2 uses
  %i.jq = icmp eq i64 %index.next376, %n.vec367
  br i1 %i.jq, label %middle.block377, label %vector.body368, !llvm.loop !104

middle.block377:                                  ; preds = %vector.body368
  %cmp.n378 = icmp eq i64 %n.vec367, %i.jd
  br i1 %cmp.n378, label %int2num.exit129, label %vec.epilog.iter.check384

vec.epilog.iter.check384:                         ; preds = %middle.block377
  %min.epilog.iters.check385 = icmp eq i64 %n.mod.vf366, 0
  br i1 %min.epilog.iters.check385, label %vec.epilog.scalar.ph383.preheader, label %vec.epilog.ph386, !prof !26

vec.epilog.ph386:                                 ; preds = %vector.main.loop.iter.check363, %vec.epilog.iter.check384
  %vec.epilog.resume.val379 = phi i64 [ %n.vec367, %vec.epilog.iter.check384 ], [ 0, %vector.main.loop.iter.check363 ]
  %n.vec388 = and i64 %i.jd, 4294967288           ; 5 uses
  %i.jr = trunc nuw i64 %n.vec388 to i32
  %i.js = sub i32 %.018.lcssa.i122, %i.jr
  %i.jt = getelementptr i8, ptr %i.jc, i64 %n.vec388
  %i.ju = sub nsw i64 0, %n.vec388
  %i.jv = getelementptr i8, ptr %.020.lcssa.i123, i64 %i.ju
  br label %vec.epilog.vector.body389

vec.epilog.vector.body389:                        ; preds = %vec.epilog.vector.body389, %vec.epilog.ph386
  %index390 = phi i64 [ %vec.epilog.resume.val379, %vec.epilog.ph386 ], [ %index.next395, %vec.epilog.vector.body389 ] ; 3 uses
  %next.gep391 = getelementptr i8, ptr %i.jc, i64 %index390
  %i.jw = sub i64 0, %index390
  %next.gep392 = getelementptr i8, ptr %.020.lcssa.i123, i64 %i.jw
  %i.jx = getelementptr inbounds i8, ptr %next.gep392, i64 -8
  %wide.load393 = load <8 x i8>, ptr %i.jx, align 1, !tbaa !15, !alias.scope !99
  %reverse394 = shufflevector <8 x i8> %wide.load393, <8 x i8> poison, <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  store <8 x i8> %reverse394, ptr %next.gep391, align 1, !tbaa !15, !alias.scope !102, !noalias !99
  %index.next395 = add nuw i64 %index390, 8       ; 2 uses
  %i.jy = icmp eq i64 %index.next395, %n.vec388
  br i1 %i.jy, label %vec.epilog.middle.block396, label %vec.epilog.vector.body389, !llvm.loop !105

vec.epilog.middle.block396:                       ; preds = %vec.epilog.vector.body389
  %cmp.n397 = icmp eq i64 %n.vec388, %i.jd
  br i1 %cmp.n397, label %int2num.exit129, label %vec.epilog.scalar.ph383.preheader

vec.epilog.scalar.ph383.preheader:                ; preds = %vector.memcheck354, %iter.check382, %vec.epilog.iter.check384, %vec.epilog.middle.block396
  %.135.i126.ph = phi i32 [ %.018.lcssa.i122, %iter.check382 ], [ %.018.lcssa.i122, %vector.memcheck354 ], [ %i.ji, %vec.epilog.iter.check384 ], [ %i.js, %vec.epilog.middle.block396 ]
  %.01934.i127.ph = phi ptr [ %i.jc, %iter.check382 ], [ %i.jc, %vector.memcheck354 ], [ %i.jj, %vec.epilog.iter.check384 ], [ %i.jt, %vec.epilog.middle.block396 ]
  %.12133.i128.ph = phi ptr [ %.020.lcssa.i123, %iter.check382 ], [ %.020.lcssa.i123, %vector.memcheck354 ], [ %i.jl, %vec.epilog.iter.check384 ], [ %i.jv, %vec.epilog.middle.block396 ]
  br label %vec.epilog.scalar.ph383

vec.epilog.scalar.ph383:                          ; preds = %vec.epilog.scalar.ph383.preheader, %vec.epilog.scalar.ph383
  %.135.i126 = phi i32 [ %i.jz, %vec.epilog.scalar.ph383 ], [ %.135.i126.ph, %vec.epilog.scalar.ph383.preheader ] ; 2 uses
  %.01934.i127 = phi ptr [ %i.kc, %vec.epilog.scalar.ph383 ], [ %.01934.i127.ph, %vec.epilog.scalar.ph383.preheader ] ; 2 uses
  %.12133.i128 = phi ptr [ %i.ka, %vec.epilog.scalar.ph383 ], [ %.12133.i128.ph, %vec.epilog.scalar.ph383.preheader ]
  ...
  br i1 %i.kd, label %vec.epilog.scalar.ph383, label %int2num.exit129, !llvm.loop !106

int2num.exit129:                                  ; preds = %vec.epilog.scalar.ph383, %vec.epilog.middle.block396, %middle.block377
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #20
