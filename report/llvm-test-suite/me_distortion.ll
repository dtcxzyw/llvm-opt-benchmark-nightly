...
begin_hunk_0_@computeBiPredSSE2:bb.a
  ...
  %n.vec = and i64 %i.ag, 2147483644              ; 6 uses
...
vector.ph:                                        ; preds = %.preheader109.us
  %i.av = getelementptr i8, ptr %.lcssa122128.us, i64 %8 ; 2 uses
  %i.aw = getelementptr i8, ptr %.lcssa116119129.us, i64 %9 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %offset.idx = shl i64 %index, 3                 ; 4 uses
  %next.gep = getelementptr i8, ptr %.lcssa122128.us, i64 %offset.idx ; 4 uses
  %10 = getelementptr i8, ptr %.lcssa122128.us, i64 %offset.idx ; 4 uses
  %next.gep299 = getelementptr i8, ptr %10, i64 8
  %11 = getelementptr i8, ptr %.lcssa122128.us, i64 %offset.idx ; 4 uses
  %next.gep300 = getelementptr i8, ptr %11, i64 16
  %12 = getelementptr i8, ptr %.lcssa122128.us, i64 %offset.idx ; 4 uses
  %next.gep301 = getelementptr i8, ptr %12, i64 24
  %offset.idx302 = shl i64 %index, 3              ; 4 uses
  %next.gep303 = getelementptr i8, ptr %.lcssa116119129.us, i64 %offset.idx302 ; 4 uses
  %13 = getelementptr i8, ptr %.lcssa116119129.us, i64 %offset.idx302 ; 4 uses
  %next.gep304.a = getelementptr i8, ptr %13, i64 8
  %i.az = getelementptr i8, ptr %.lcssa116119129.us, i64 %offset.idx302 ; 4 uses
  %next.gep305.a = getelementptr i8, ptr %i.az, i64 16
  %i.ba = getelementptr i8, ptr %.lcssa116119129.us, i64 %offset.idx302 ; 4 uses
  %next.gep306.a = getelementptr i8, ptr %i.ba, i64 24
  %offset.idx307 = shl i64 %index, 3              ; 4 uses
  %next.gep308.a = getelementptr i8, ptr %.lcssa117126127.us, i64 %offset.idx307 ; 4 uses
  %i.bb = getelementptr i8, ptr %.lcssa117126127.us, i64 %offset.idx307 ; 4 uses
  %next.gep309.a = getelementptr i8, ptr %i.bb, i64 8
  %i.bc = getelementptr i8, ptr %.lcssa117126127.us, i64 %offset.idx307 ; 4 uses
  %next.gep310 = getelementptr i8, ptr %i.bc, i64 16
  %i.bd = getelementptr i8, ptr %.lcssa117126127.us, i64 %offset.idx307 ; 4 uses
  %next.gep311 = getelementptr i8, ptr %i.bd, i64 24
  %i.be = getelementptr inbounds nuw i8, ptr %next.gep, i64 2
  %i.bf = getelementptr i8, ptr %10, i64 10
  %i.bg = getelementptr i8, ptr %11, i64 18
  %i.bh = getelementptr i8, ptr %12, i64 26
  %i.bi = load i16, ptr %next.gep, align 2, !tbaa !40
  %i.bj = load i16, ptr %next.gep299, align 2, !tbaa !40
  %i.bk = load i16, ptr %next.gep300, align 2, !tbaa !40
  %i.bl = load i16, ptr %next.gep301, align 2, !tbaa !40
  ...
  %i.bs = getelementptr inbounds nuw i8, ptr %next.gep303, i64 2
  %i.bt = getelementptr i8, ptr %13, i64 10
  %i.bu = getelementptr i8, ptr %i.az, i64 18
  %i.bv = getelementptr i8, ptr %i.ba, i64 26
  %i.bw = load i16, ptr %next.gep303, align 2, !tbaa !40
  %i.bx = load i16, ptr %next.gep304.a, align 2, !tbaa !40
  %i.by = load i16, ptr %next.gep305.a, align 2, !tbaa !40
  %i.bz = load i16, ptr %next.gep306.a, align 2, !tbaa !40
...
begin_hunk_2_@computeBiPredSSE2:bb.a
  ...
  %i.cm = getelementptr inbounds nuw i8, ptr %next.gep308.a, i64 2
  %i.cn = getelementptr i8, ptr %i.bb, i64 10
  %i.co = getelementptr i8, ptr %i.bc, i64 18
  %i.cp = getelementptr i8, ptr %i.bd, i64 26
  %i.cq = load i16, ptr %next.gep308.a, align 2, !tbaa !40
  %i.cr = load i16, ptr %next.gep309.a, align 2, !tbaa !40
  %i.cs = load i16, ptr %next.gep310, align 2, !tbaa !40
...
begin_hunk_3_@computeBiPredSSE2:bb.a
  ...
  %i.dc = getelementptr inbounds nuw i8, ptr %next.gep, i64 4
  %i.dd = getelementptr i8, ptr %10, i64 12
  %i.de = getelementptr i8, ptr %11, i64 20
  %i.df = getelementptr i8, ptr %12, i64 28
...
begin_hunk_4_@computeBiPredSSE2:bb.a
  ...
  %i.dq = getelementptr inbounds nuw i8, ptr %next.gep303, i64 4
  %i.dr = getelementptr i8, ptr %13, i64 12
  %i.ds = getelementptr i8, ptr %i.az, i64 20
  %i.dt = getelementptr i8, ptr %i.ba, i64 28
...
begin_hunk_5_@computeBiPredSSE2:bb.a
  ...
  %i.ek = getelementptr inbounds nuw i8, ptr %next.gep308.a, i64 4
  %i.el = getelementptr i8, ptr %i.bb, i64 12
  %i.em = getelementptr i8, ptr %i.bc, i64 20
  %i.en = getelementptr i8, ptr %i.bd, i64 28
...
begin_hunk_6_@computeBiPredSSE2:bb.a
  ...
  %i.fa = getelementptr inbounds nuw i8, ptr %next.gep, i64 6
  %i.fb = getelementptr i8, ptr %10, i64 14
  %i.fc = getelementptr i8, ptr %11, i64 22
  %i.fd = getelementptr i8, ptr %12, i64 30
...
begin_hunk_7_@computeBiPredSSE2:bb.a
  ...
  %i.fo = getelementptr inbounds nuw i8, ptr %next.gep303, i64 6
  %i.fp = getelementptr i8, ptr %13, i64 14
  %i.fq = getelementptr i8, ptr %i.az, i64 22
  %i.fr = getelementptr i8, ptr %i.ba, i64 30
...
begin_hunk_8_@computeBiPredSSE2:bb.a
  ...
  %i.gi = getelementptr inbounds nuw i8, ptr %next.gep308.a, i64 6
  %i.gj = getelementptr i8, ptr %i.bb, i64 14
  %i.gk = getelementptr i8, ptr %i.bc, i64 22
  %i.gl = getelementptr i8, ptr %i.bd, i64 30
...
begin_hunk_9_@computeBiPredSSE2:bb.a
  ...
  %n.vec361 = and i64 %i.nf, 2147483644           ; 6 uses
  %i.ng = trunc nuw nsw i64 %n.vec361 to i32
  %14 = shl nuw nsw i64 %n.vec361, 2
  %15 = shl nuw nsw i64 %n.vec361, 2
  %i.nh = shl nuw nsw i64 %n.vec361, 2
...
vector.ph359:                                     ; preds = %.preheader.us.us.1
  %i.ni = getelementptr i8, ptr %.lcssa141148154.us.us.1, i64 %14
  %i.nj = getelementptr i8, ptr %.lcssa142145155.us.us.1, i64 %15
...
vector.body375:                                   ; preds = %vector.body375, %vector.ph359
  %index376 = phi i64 [ 0, %vector.ph359 ], [ %index.next393, %vector.body375 ] ; 4 uses
  %vec.phi377 = phi <4 x i32> [ %i.nl, %vector.ph359 ], [ %i.on, %vector.body375 ]
  %offset.idx378 = shl i64 %index376, 2
  %next.gep379 = getelementptr i8, ptr %.lcssa141148154.us.us.1, i64 %offset.idx378
  %offset.idx380 = shl i64 %index376, 2
  %next.gep381 = getelementptr i8, ptr %.lcssa142145155.us.us.1, i64 %offset.idx380
  %offset.idx382 = shl i64 %index376, 2
  %next.gep383 = getelementptr i8, ptr %.lcssa143152153.us.us.1, i64 %offset.idx382
...
begin_hunk_11_@computeBiPredSSE2:bb.a
  ...
  %n.vec319 = and i64 %i.qu, 2147483644           ; 6 uses
  %i.qv = trunc nuw nsw i64 %n.vec319 to i32
  %16 = shl nuw nsw i64 %n.vec319, 2
  %17 = shl nuw nsw i64 %n.vec319, 2
  %i.qw = shl nuw nsw i64 %n.vec319, 2
...
vector.ph317:                                     ; preds = %.preheader.us.us
  %i.qx = getelementptr i8, ptr %.lcssa141148154.us.us, i64 %16
  %i.qy = getelementptr i8, ptr %.lcssa142145155.us.us, i64 %17
...
vector.body333:                                   ; preds = %vector.body333, %vector.ph317
  %index334 = phi i64 [ 0, %vector.ph317 ], [ %index.next349, %vector.body333 ] ; 4 uses
  %vec.phi335 = phi <4 x i32> [ %i.ra, %vector.ph317 ], [ %i.sc, %vector.body333 ]
  %offset.idx336 = shl i64 %index334, 2
  %next.gep337 = getelementptr i8, ptr %.lcssa141148154.us.us, i64 %offset.idx336
  %offset.idx338 = shl i64 %index334, 2
  %next.gep339 = getelementptr i8, ptr %.lcssa142145155.us.us, i64 %offset.idx338
  %offset.idx340 = shl i64 %index334, 2
  %next.gep341 = getelementptr i8, ptr %.lcssa143152153.us.us, i64 %offset.idx340
