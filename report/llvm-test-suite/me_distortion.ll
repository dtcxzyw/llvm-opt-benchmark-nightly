...
vector.body368:                                   ; preds = %vector.body368, %vector.ph353
  ...
  %8 = freeze <8 x i16> %wide.vec374              ; 2 uses
  %9 = bitcast <8 x i16> %8 to <4 x i32>
  %10 = bitcast <8 x i16> %8 to <4 x i32>
  %11 = and <4 x i32> %10, splat (i32 65535)
  %12 = lshr <4 x i32> %9, splat (i32 16)
  %i.nn = mul nsw <4 x i32> %11, %broadcast.splat357
  %wide.vec377 = load <8 x i16>, ptr %next.gep372, align 2, !tbaa !40
  %13 = freeze <8 x i16> %wide.vec377             ; 2 uses
  %14 = bitcast <8 x i16> %13 to <4 x i32>
  %15 = bitcast <8 x i16> %13 to <4 x i32>
  %16 = and <4 x i32> %15, splat (i32 65535)
  %17 = lshr <4 x i32> %14, splat (i32 16)
  %i.no = mul nsw <4 x i32> %16, %broadcast.splat359
  ...
  %18 = freeze <8 x i16> %wide.vec380             ; 2 uses
  %19 = bitcast <8 x i16> %18 to <4 x i32>
  %20 = bitcast <8 x i16> %18 to <4 x i32>
  %21 = and <4 x i32> %20, splat (i32 65535)
  %22 = lshr <4 x i32> %19, splat (i32 16)
  %23 = sub nsw <4 x i32> %21, %i.nu              ; 2 uses
  %24 = mul nsw <4 x i32> %23, %23
  %25 = add <4 x i32> %24, %vec.phi370
  %26 = mul nsw <4 x i32> %12, %broadcast.splat357
  %i.nv = mul nsw <4 x i32> %17, %broadcast.splat359
  %i.nw = add <4 x i32> %26, %broadcast.splat361
  ...
  %i.oc = sub nsw <4 x i32> %22, %i.ob            ; 2 uses
  %i.od = mul nsw <4 x i32> %i.oc, %i.oc
  %i.oe = add <4 x i32> %25, %i.od                ; 2 uses
...
vector.body330:                                   ; preds = %vector.body330, %vector.ph315
  ...
  %27 = freeze <8 x i16> %wide.vec                ; 2 uses
  ...
  %i.qt = mul nsw <4 x i32> %30, %broadcast.splat319
  %wide.vec337 = load <8 x i16>, ptr %next.gep334, align 2, !tbaa !40
  %32 = freeze <8 x i16> %wide.vec337             ; 2 uses
  %33 = bitcast <8 x i16> %32 to <4 x i32>
  %34 = bitcast <8 x i16> %32 to <4 x i32>
  %35 = and <4 x i32> %34, splat (i32 65535)
  %36 = lshr <4 x i32> %33, splat (i32 16)
  %i.qu = mul nsw <4 x i32> %35, %broadcast.splat321
  ...
  %37 = freeze <8 x i16> %wide.vec340             ; 2 uses
  ...
  %42 = sub nsw <4 x i32> %40, %i.ra              ; 2 uses
  %43 = mul nsw <4 x i32> %42, %42
  %44 = add <4 x i32> %43, %vec.phi332
  %45 = mul nsw <4 x i32> %31, %broadcast.splat319
  %i.rb = mul nsw <4 x i32> %36, %broadcast.splat321
  %i.rc = add <4 x i32> %45, %broadcast.splat323
  ...
  %i.ri = sub nsw <4 x i32> %41, %i.rh            ; 2 uses
  %i.rj = mul nsw <4 x i32> %i.ri, %i.ri
  %i.rk = add <4 x i32> %44, %i.rj                ; 2 uses
