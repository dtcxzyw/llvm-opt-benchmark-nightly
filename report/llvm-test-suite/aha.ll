begin_hunk_0_@check:bb.a
  ...
  %i.v = tail call i32 %i.u(i32 noundef %i.g, i32 noundef %i.l, i32 noundef %i.q) #9, !inline_history !22
...
begin_hunk_2_@check:bb.a
  ...
  %i.gp = tail call i32 %i.go(i32 noundef %i.ga, i32 noundef %i.gf, i32 noundef %i.gk) #9, !inline_history !22
...
begin_hunk_3_@check:bb.a
  ...
  br i1 %i.gx, label %.lr.ph, label %._crit_edge, !llvm.loop !25
