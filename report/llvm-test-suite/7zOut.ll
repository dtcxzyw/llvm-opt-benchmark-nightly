...
bb.h:                                             ; preds = %bb.g
  %i.ah = icmp ult i64 %i.aa, 72057594037927936   ; 2 uses
  %spec.select = select i1 %i.ah, i64 7, i64 8
  %spec.select.a = select i1 %i.ah, i32 7, i32 8
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.g, %bb.f, %bb.e, %bb.d, %bb.c, %bb.b
  %.049.lcssa54 = phi i64 [ 1, %bb.b ], [ 6, %bb.g ], [ 2, %bb.c ], [ %spec.select, %bb.h ], [ 3, %bb.d ], [ 5, %bb.f ], [ 4, %bb.e ] ; 2 uses
  %.049.lcssa54.a = phi i32 [ 1, %bb.b ], [ 6, %bb.g ], [ 2, %bb.c ], [ %spec.select.a, %bb.h ], [ 3, %bb.d ], [ 5, %bb.f ], [ 4, %bb.e ]
...
begin_hunk_1_@_ZN8NArchive3N7z11COutArchive11WriteFolderERKNS0_7CFolderE:bb.a
  ...
  %i.ar = or disjoint i32 %.049.lcssa54.a, %i.aq
  %i.as = or disjoint i32 %i.ar, %i.ap            ; 2 uses
...
_ZN8NArchive3N7z11COutArchive9WriteByteEh.exit:   ; preds = %bb.k, %_ZN10COutBuffer9WriteByteEh.exit.i, %_ZN8NArchive3N7z15CWriteBufferLoc9WriteByteEh.exit.i
  call void @_ZN8NArchive3N7z11COutArchive10WriteBytesEPKvm(ptr noundef nonnull align 8 dereferenceable(128) %0, ptr noundef nonnull %i.a, i64 noundef %.049.lcssa54)
  br i1 %i.ao, label %bb.s, label %bb.r

bb.q:                                             ; preds = %bb.i, %bb.q
  %indvars.iv = phi i64 [ %.049.lcssa54, %bb.i ], [ %indvars.iv.next, %bb.q ] ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %or.cond = select i1 %i.av, i1 true, i1 %i.ax   ; 2 uses
  %spec.select80 = zext i1 %or.cond to i8
  br label %.thread
...
.thread:                                          ; preds = %bb.g, %_ZNK8NArchive3N7z16CArchiveDatabase7IsEmptyEv.exit.thread, %bb.h
  ...
  %.062 = phi i8 [ %spec.select80, %bb.h ], [ 0, %_ZNK8NArchive3N7z16CArchiveDatabase7IsEmptyEv.exit.thread ], [ 0, %bb.g ]
  %.062.a = phi i1 [ %or.cond, %bb.h ], [ false, %_ZNK8NArchive3N7z16CArchiveDatabase7IsEmptyEv.exit.thread ], [ false, %bb.g ]
...
begin_hunk_4_@_ZN8NArchive3N7z11COutArchive13WriteDatabaseERKNS0_16CArchiveDatabaseEPKNS0_22CCompressionMethodModeERKNS0_14CHeaderOptionsE:bb.a
  ...
  store i8 %.062, ptr %i.bc, align 8, !tbaa !31
