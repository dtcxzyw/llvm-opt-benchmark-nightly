...
bb.bg:                                            ; preds = %bb.bf, %bb.bb, %bb.ba
  ...
  %.not.i108 = icmp ult ptr %i.jz, %i.n
  br i1 %.not.i108, label %.loopexit, label %bb.ba, !llvm.loop !32
...
bb.bi:                                            ; preds = %trace_cells.exit.thread, %.thread117, %.thread, %.loopexit, %bb.d, %bb.c, %bb.bh
  %.269 = phi i32 [ %i.i, %bb.c ], [ -25, %bb.d ], [ %.168.ph, %.thread117 ], [ %.3.i.ph, %trace_cells.exit.thread ], [ %i.kh, %bb.bh ], [ -13, %.loopexit ], [ %.067.ph, %.thread ]
...
bb.a:
  ...
  br i1 %i.e, label %.preheader.lr.ph, label %._crit_edge42.split
...
.preheader.lr.ph:                                 ; preds = %bb.a
  ...
  br i1 %i.f, label %.preheader.preheader, label %._crit_edge42.split
...
.preheader.preheader:                             ; preds = %.preheader.lr.ph
  ...
  %lcmp.mod50 = trunc i32 %2 to i1
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge
  %.02141 = phi i32 [ %.2.lcssa, %._crit_edge ], [ undef, %.preheader.preheader ] ; 2 uses
  %.02440 = phi ptr [ %i.ai, %._crit_edge ], [ %i.m, %.preheader.preheader ] ; 2 uses
  %.02639 = phi ptr [ %.228.lcssa, %._crit_edge ], [ %i.i, %.preheader.preheader ] ; 2 uses
  %.02938 = phi i32 [ %i.aj, %._crit_edge ], [ 0, %.preheader.preheader ]
  br i1 %i.n, label %.epil.preheader, label %.preheader.new

.preheader.new:                                   ; preds = %.preheader, %bb.i
  %.134 = phi i32 [ %.2.1, %bb.i ], [ %.02141, %.preheader ]
  %.02233 = phi i32 [ %i.aa, %bb.i ], [ 0, %.preheader ] ; 2 uses
  %.12532 = phi ptr [ %i.ab, %bb.i ], [ %.02440, %.preheader ] ; 3 uses
  %.12731 = phi ptr [ %.228.1, %bb.i ], [ %.02639, %.preheader ] ; 2 uses
  %niter = phi i32 [ %niter.next.1, %bb.i ], [ 0, %.preheader ]
  %i.o = icmp eq i32 %.02233, 0
  br i1 %i.o, label %bb.b, label %bb.c

bb.b:                                             ; preds = %.preheader.new
  %i.p = getelementptr inbounds nuw i8, ptr %.12731, i64 1 ; 2 uses
  %i.q = load i8, ptr %i.p, align 1, !tbaa !16
  %i.r = zext i8 %i.q to i32
  br label %bb.c

bb.c:                                             ; preds = %bb.b, %.preheader.new
  %.228 = phi ptr [ %i.p, %bb.b ], [ %.12731, %.preheader.new ] ; 2 uses
  %.123 = phi i32 [ 128, %bb.b ], [ %.02233, %.preheader.new ] ; 2 uses
  %.2 = phi i32 [ %i.r, %bb.b ], [ %.134, %.preheader.new ] ; 2 uses
  %i.s = and i32 %.2, %.123
  %.not = icmp eq i32 %i.s, 0
  br i1 %.not, label %bb.e, label %bb.d

bb.d:                                             ; preds = %bb.c
  store i8 1, ptr %.12532, align 1, !tbaa !16
  br label %bb.e

bb.e:                                             ; preds = %bb.c, %bb.d
  %i.t = lshr i32 %.123, 1                        ; 2 uses
  %i.u = getelementptr inbounds nuw i8, ptr %.12532, i64 1
  %i.v = icmp eq i32 %i.t, 0
  br i1 %i.v, label %bb.f, label %bb.g

bb.f:                                             ; preds = %bb.e
  %i.w = getelementptr inbounds nuw i8, ptr %.228, i64 1 ; 2 uses
  %i.x = load i8, ptr %i.w, align 1, !tbaa !16
  %i.y = zext i8 %i.x to i32
  br label %bb.g

bb.g:                                             ; preds = %bb.f, %bb.e
  %.228.1 = phi ptr [ %i.w, %bb.f ], [ %.228, %bb.e ] ; 3 uses
  %.123.1 = phi i32 [ 128, %bb.f ], [ %i.t, %bb.e ] ; 2 uses
  %.2.1 = phi i32 [ %i.y, %bb.f ], [ %.2, %bb.e ] ; 4 uses
  %i.z = and i32 %.2.1, %.123.1
...
bb.i:                                             ; preds = %bb.h, %bb.g
  %i.aa = lshr i32 %.123.1, 1                     ; 2 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %.12532, i64 2 ; 3 uses
  %niter.next.1 = add i32 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i32 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.unr-lcssa, label %.preheader.new, !llvm.loop !17

._crit_edge.unr-lcssa:                            ; preds = %bb.i
  br i1 %lcmp.mod.not, label %._crit_edge, label %.epil.preheader

.epil.preheader:                                  ; preds = %._crit_edge.unr-lcssa, %.preheader
  %.134.epil.init = phi i32 [ %.02141, %.preheader ], [ %.2.1, %._crit_edge.unr-lcssa ]
  %.02233.epil.init = phi i32 [ 0, %.preheader ], [ %i.aa, %._crit_edge.unr-lcssa ] ; 2 uses
  %.12532.epil.init = phi ptr [ %.02440, %.preheader ], [ %i.ab, %._crit_edge.unr-lcssa ] ; 2 uses
  %.12731.epil.init = phi ptr [ %.02639, %.preheader ], [ %.228.1, %._crit_edge.unr-lcssa ] ; 2 uses
  tail call void @llvm.assume(i1 %lcmp.mod50)
  %i.ac = icmp eq i32 %.02233.epil.init, 0
  br i1 %i.ac, label %bb.j, label %bb.k

bb.j:                                             ; preds = %.epil.preheader
  %i.ad = getelementptr inbounds nuw i8, ptr %.12731.epil.init, i64 1 ; 2 uses
  %i.ae = load i8, ptr %i.ad, align 1, !tbaa !16
  %i.af = zext i8 %i.ae to i32
  br label %bb.k

bb.k:                                             ; preds = %bb.j, %.epil.preheader
  %.228.epil = phi ptr [ %i.ad, %bb.j ], [ %.12731.epil.init, %.epil.preheader ]
  %.123.epil = phi i32 [ 128, %bb.j ], [ %.02233.epil.init, %.epil.preheader ]
  %.2.epil = phi i32 [ %i.af, %bb.j ], [ %.134.epil.init, %.epil.preheader ] ; 2 uses
  %i.ag = and i32 %.2.epil, %.123.epil
  %.not.epil = icmp eq i32 %i.ag, 0
  br i1 %.not.epil, label %._crit_edge.epilog-lcssa, label %bb.l

bb.l:                                             ; preds = %bb.k
  store i8 1, ptr %.12532.epil.init, align 1, !tbaa !16
  br label %._crit_edge.epilog-lcssa

._crit_edge.epilog-lcssa:                         ; preds = %bb.l, %bb.k
  %i.ah = getelementptr inbounds nuw i8, ptr %.12532.epil.init, i64 1
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.unr-lcssa, %._crit_edge.epilog-lcssa
  %.lcssa = phi ptr [ %i.ab, %._crit_edge.unr-lcssa ], [ %i.ah, %._crit_edge.epilog-lcssa ]
  %.228.lcssa = phi ptr [ %.228.1, %._crit_edge.unr-lcssa ], [ %.228.epil, %._crit_edge.epilog-lcssa ]
  %.2.lcssa = phi i32 [ %.2.1, %._crit_edge.unr-lcssa ], [ %.2.epil, %._crit_edge.epilog-lcssa ]
  %i.ai = getelementptr inbounds i8, ptr %.lcssa, i64 %i.h
  %i.aj = add nuw nsw i32 %.02938, 1              ; 2 uses
  %exitcond43.not = icmp eq i32 %i.aj, %3
  br i1 %exitcond43.not, label %._crit_edge42.split, label %.preheader, !llvm.loop !19

._crit_edge42.split:                              ; preds = %._crit_edge, %.preheader.lr.ph, %bb.a
  ret void
}
