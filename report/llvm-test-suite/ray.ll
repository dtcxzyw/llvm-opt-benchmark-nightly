...
begin_hunk_0_@main:bb.a
  ...
  %8 = alloca %struct.Ray, align 16               ; 9 uses
  %i.b = icmp eq i32 %0, 2
...
begin_hunk_1_@main:bb.a
  ...
  %.sroa.442.0..sroa_idx = getelementptr inbounds nuw i8, ptr %8, i64 32
  %.sroa.543.0..sroa_idx = getelementptr inbounds nuw i8, ptr %8, i64 40 ; 2 uses
...
begin_hunk_2_@main:bb.a
  ...
  %i.ay = fdiv double 1.000000e+00, %sqrt.i38     ; 3 uses
  %9 = fmul double %i.z, %i.ay
  %10 = fmul double %i.au, %i.ay
  %11 = fmul double %i.ay, 5.120000e+02
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #15
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %8, i8 0, i64 16, i1 false)
  store double -4.000000e+00, ptr %.sroa.5.0..sroa_idx, align 16, !tbaa !11
  store double %9, ptr %i.n, align 8, !tbaa !11
  store double %10, ptr %.sroa.442.0..sroa_idx, align 16, !tbaa !11
  store double %11, ptr %.sroa.543.0..sroa_idx, align 8, !tbaa !11
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.bo = load double, ptr %.sroa.5.0..sroa_idx, align 16, !tbaa !8, !noalias !85
  ...
  %i.bt = load <2 x double>, ptr %i.n, align 8, !tbaa !11, !noalias !82
