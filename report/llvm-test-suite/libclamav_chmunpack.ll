...
bb.cd:                                            ; preds = %bb.cb
  %i.lh = sub nuw i64 %.02029.i.i, %i.kz          ; 2 uses
...
begin_hunk_1_@read_chunk_entries:bb.a
  ...
  %i.o = or disjoint i64 %i.k, %i.n               ; 4 uses
...
begin_hunk_2_@read_chunk_entries:bb.a
  ...
  %5 = icmp ugt i64 %.012.i8791, 1
  br label %bb.m

bb.m:                                             ; preds = %bb.i, %bb.l
  %.012.i8790 = phi i1 [ true, %bb.i ], [ %5, %bb.l ]
...
begin_hunk_3_@read_chunk_entries:bb.a
  ...
  br i1 %.012.i8790, label %bb.q, label %bb.t
