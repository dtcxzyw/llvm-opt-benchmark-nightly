...
bb.k:                                             ; preds = %bb.c, %bb.g, %bb.j, %bb.i, %bb.e, %switch.lookup
  ...
  %i.v = load ptr, ptr @miptr, align 8, !tbaa !12 ; 3 uses
...
begin_hunk_1_@_Z10storelocalP9Classfile:bb.a
  ...
  %i.af = getelementptr inbounds nuw i8, ptr %i.v, i64 112
...
bb.m:                                             ; preds = %bb.k
  ...
  store ptr %i.aj, ptr %i.z, align 8, !tbaa !8
  ...
  %i.al = load ptr, ptr @miptr, align 8, !tbaa !12 ; 4 uses
...
bb.q:                                             ; preds = %bb.m, %bb.p, %bb.o, %bb.l
  %1 = phi ptr [ %i.v, %bb.l ], [ %i.al, %bb.o ], [ %i.al, %bb.p ], [ %i.al, %bb.m ]
  %.040 = phi ptr [ %i.ad, %bb.l ], [ %i.aj, %bb.o ], [ %i.aj, %bb.p ], [ %i.aj, %bb.m ]
  %.2 = phi i32 [ %i.ai, %bb.l ], [ %.1, %bb.o ], [ 4, %bb.p ], [ %.1, %bb.m ] ; 4 uses
  %i.aq = tail call noalias noundef nonnull dereferenceable(64) ptr @_Znwm(i64 noundef 64) #10 ; 6 uses
...
bb.w:                                             ; preds = %bb.t, %bb.s
  %i.bx = load ptr, ptr %i.bf, align 8, !tbaa !44 ; 4 uses
  %i.by = getelementptr inbounds nuw i8, ptr %i.bx, i64 8
  %i.bz = load i32, ptr %i.by, align 8, !tbaa !41
  %2 = icmp eq i32 %i.bz, 4
  %i.ca = icmp eq i32 %.2, 10
  %or.cond52 = select i1 %2, i1 %i.ca, i1 false
  br i1 %or.cond52, label %bb.x, label %bb.z

bb.x:                                             ; preds = %bb.w
  %i.cb = icmp eq ptr %i.bx, getelementptr inbounds nuw (i8, ptr @std_exps, i64 48)
  %i.cc = icmp eq ptr %i.bx, getelementptr inbounds nuw (i8, ptr @std_exps, i64 72)
  %or.cond = select i1 %i.cb, i1 true, i1 %i.cc
  br i1 %or.cond, label %bb.y, label %bb.z

bb.y:                                             ; preds = %bb.x
  %i.cd = getelementptr inbounds nuw i8, ptr %i.bx, i64 312
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.cw = getelementptr inbounds nuw i8, ptr %.sink75, i64 16
  %i.cx = getelementptr inbounds nuw i8, ptr %i.cp, i64 16
  %i.cy = load i32, ptr %i.cx, align 8, !tbaa !33
  %. = tail call i32 @llvm.umin.i32(i32 %i.b, i32 %i.cy)
