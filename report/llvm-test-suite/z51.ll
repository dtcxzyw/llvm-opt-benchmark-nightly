...
._crit_edge12:                                    ; preds = %.preheader.us.preheader, %.preheader.lr.ph, %bb.a
...
._crit_edge41:                                    ; preds = %.preheader.us.preheader, %.preheader.lr.ph, %bb.g
  ret void
}
...
..loopexit_crit_edge:                             ; preds = %.preheader.us.new, %.prol.loopexit
  %.lcssa = phi i32 [ %.lcssa.unr, %.prol.loopexit ], [ %i.bp, %.preheader.us.new ]
  %.not44.not = icmp sgt i64 %indvars.iv57, %i.ay
  br i1 %.not44.not, label %.preheader.us, label %.loopexit48, !llvm.loop !23

.preheader.us:                                    ; preds = %.preheader.us.preheader, %..loopexit_crit_edge
  %indvars.iv57.in = phi i64 [ %i.ax, %.preheader.us.preheader ], [ %indvars.iv57, %..loopexit_crit_edge ]
  %.03753.us = phi i32 [ 0, %.preheader.us.preheader ], [ %.lcssa, %..loopexit_crit_edge ] ; 3 uses
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.unr-lcssa, %.preheader.us
  ...
  br i1 %i.bc, label %..loopexit_crit_edge, label %.preheader.us.new
...
.preheader.us.new:                                ; preds = %.prol.loopexit, %.preheader.us.new
  ...
  br i1 %exitcond.not.1, label %..loopexit_crit_edge, label %.preheader.us.new, !llvm.loop !24
