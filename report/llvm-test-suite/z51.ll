...
bb.a:
  ...
  br i1 %i.m, label %.preheader.lr.ph, label %._crit_edge12.split

.preheader.lr.ph:                                 ; preds = %bb.a
  %i.n = load i32, ptr @hsize, align 4, !tbaa !4  ; 2 uses
  %i.o = icmp sgt i32 %i.n, 0
  br i1 %i.o, label %.preheader.preheader, label %._crit_edge12.split
...
bb.g:                                             ; preds = %bb.e, %bb.f
  ...
  br i1 %i.as, label %.preheader.lr.ph, label %._crit_edge41.split

.preheader.lr.ph:                                 ; preds = %bb.g
  %i.at = load i32, ptr @hsize, align 4, !tbaa !4 ; 2 uses
  %i.au = icmp sgt i32 %i.at, 0
  br i1 %i.au, label %.preheader.preheader, label %._crit_edge41.split
...
.preheader.lr.ph:                                 ; preds = %.preheader47
  ...
  %i.av = load ptr, ptr @page, align 8
  br i1 %i.au, label %.preheader.preheader, label %.loopexit48
...
.prol.loopexit.unr-lcssa:                         ; preds = %.preheader
  %i.be = icmp eq i32 %.03753, %i.f
  %spec.store.select.prol = select i1 %i.be, i32 0, i32 %.03753 ; 2 uses
  %i.bf = add nsw i32 %spec.store.select.prol, 1  ; 2 uses
  %i.bg = sext i32 %spec.store.select.prol to i64
...
.preheader.new:                                   ; preds = %.prol.loopexit, %.preheader.new
  ...
  %.149 = phi i32 [ %i.bp, %.preheader.new ], [ %.149.unr, %.prol.loopexit ] ; 2 uses
  %i.bj = icmp eq i32 %.149, %i.f
  %spec.store.select = select i1 %i.bj, i32 0, i32 %.149 ; 2 uses
  %i.bk = add nsw i32 %spec.store.select, 1       ; 2 uses
  %i.bl = sext i32 %spec.store.select to i64
  ...
  %spec.store.select.1 = select i1 %i.bo, i32 0, i32 %i.bk ; 2 uses
  %i.bp = add nsw i32 %spec.store.select.1, 1     ; 2 uses
  %i.bq = sext i32 %spec.store.select.1 to i64
