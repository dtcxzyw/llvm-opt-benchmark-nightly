...
bb.a:
  ...
  %3 = load i32, ptr @vsize, align 4, !tbaa !4    ; 2 uses
  %i.l = icmp sgt i32 %3, 0
  br i1 %i.l, label %.preheader.lr.ph, label %._crit_edge12.split

.preheader.lr.ph:                                 ; preds = %bb.a
  %4 = load i32, ptr @hsize, align 4, !tbaa !4    ; 2 uses
  %5 = icmp sgt i32 %4, 0
  br i1 %5, label %.preheader.preheader.a, label %._crit_edge12.split

.preheader.preheader.a:                           ; preds = %.preheader.lr.ph
  %6 = zext nneg i32 %4 to i64
  %7 = zext nneg i32 %3 to i64
  %i.m = mul nuw nsw i64 %6, %7
  tail call void @llvm.memset.p0.i64(ptr align 1 %i.k, i8 32, i64 %i.m, i1 false), !tbaa !14
  br label %._crit_edge12.split

._crit_edge12.split:                              ; preds = %.preheader.preheader.a, %.preheader.lr.ph, %bb.a
...
bb.e:                                             ; preds = %bb.d, %._crit_edge36
  ...
  br i1 %or.cond, label %3, label %bb.f
...
3:                                                ; preds = %bb.e, %bb.f
  %4 = phi i32 [ %i.ak, %bb.e ], [ %.pre, %bb.f ] ; 2 uses
  %5 = icmp sgt i32 %4, 0
  br i1 %5, label %.preheader.lr.ph, label %._crit_edge41.split

.preheader.lr.ph:                                 ; preds = %3
  %6 = load i32, ptr @hsize, align 4, !tbaa !4    ; 2 uses
...
._crit_edge41.split:                              ; preds = %.preheader.preheader, %.preheader.lr.ph, %3
  ret void
}
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.u = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %i.t) #13
  %i.v = add i64 %i.u, %i.s
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ae = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %i.ad, ptr noundef nonnull @.str.14) #11 ; 0 uses
  %.pre = load i32, ptr @vsize, align 4, !tbaa !4
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ah = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %i.ag, ptr noundef nonnull @.str.16) #11 ; 0 uses
  br label %.thread
...
bb.f:                                             ; preds = %bb.b, %bb.a
  ...
  %i.av = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 51, i32 noundef 1, ptr noundef nonnull @.str.17, i32 noundef 2, ptr noundef nonnull %i.at, ptr noundef nonnull %i.au, i32 noundef %i.o, i32 noundef %i.q) #11 ; 0 uses
  br label %.loopexit
...
bb.g:                                             ; preds = %bb.f, %bb.e
  %i.ca = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 51, i32 noundef 4, ptr noundef nonnull @.str.21, i32 noundef 2, ptr noundef nonnull %i.a, ptr noundef nonnull %i.d, i32 noundef undef, i32 noundef undef) #11 ; 0 uses
  br label %.loopexit48
