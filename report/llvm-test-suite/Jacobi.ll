...
vector.ph117:                                     ; preds = %vector.memcheck106
  %n.vec119 = and i64 %7, 8589934590              ; 3 uses
  %i.bj = add nuw nsw i64 %indvars.iv84, %n.vec119
...
middle.block129:                                  ; preds = %vector.body124
  %cmp.n130 = icmp eq i64 %7, %n.vec119
  br i1 %cmp.n130, label %.lr.ph53.i.preheader, label %scalar.ph115.preheader

scalar.ph115.preheader:                           ; preds = %vector.memcheck106, %.lr.ph.i, %middle.block129
  %indvars.iv.i.ph = phi i64 [ %indvars.iv84, %vector.memcheck106 ], [ %indvars.iv84, %.lr.ph.i ], [ %i.bj, %middle.block129 ]
