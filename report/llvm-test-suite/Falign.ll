...
._crit_edge581:                                   ; preds = %bb.bk, %._crit_edge581.unr-lcssa
  ...
  %i.xo = load ptr, ptr @Falign_noudp.cut1, align 8, !tbaa !15 ; 13 uses
...
begin_hunk_1_@Falign_noudp:bb.a
  ...
  %8 = load i32, ptr %i.ze, align 8, !tbaa !75    ; 2 uses
  %i.zf = load i32, ptr %i.xo, align 4, !tbaa !4
  %i.zg = icmp sgt i32 %8, %i.zf
...
bb.bn:                                            ; preds = %bb.bm
  ...
  store i32 %8, ptr %i.zm, align 4, !tbaa !4
