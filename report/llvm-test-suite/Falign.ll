...
.lr.ph434:                                        ; preds = %.preheader378
  ...
  %narrow = add nsw i32 %i.k, 1                   ; 2 uses
...
vector.ph707:                                     ; preds = %vector.memcheck695
  ...
  %invariant.gep799 = getelementptr [8 x i8], ptr %.pre630.pre, i64 %i.mf
  br label %vector.body710

vector.body710:                                   ; preds = %vector.body710, %vector.ph707
  %index711 = phi i64 [ 0, %vector.ph707 ], [ %index.next713, %vector.body710 ] ; 3 uses
  %7 = trunc i64 %index711 to i32
  %8 = add i32 %narrow, %7                        ; 4 uses
  %.neg731 = xor i32 %8, -1
  %i.nc = add i32 %8, 2
  %i.nd = add i32 %8, 3
end_hunk_1
begin_hunk_2_@Fgetlag:bb.a
  ...
  %gep800 = getelementptr [8 x i8], ptr %invariant.gep799, i64 %index711 ; 2 uses
...
vector.ph820:                                     ; preds = %vector.memcheck808
  ...
  %invariant.gep911 = getelementptr [8 x i8], ptr %.pre735.pre, i64 %i.lr
  br label %vector.body823

vector.body823:                                   ; preds = %vector.body823, %vector.ph820
  %index824 = phi i64 [ 0, %vector.ph820 ], [ %index.next826, %vector.body823 ] ; 3 uses
  %8 = trunc i64 %index824 to i32
  %9 = add i32 %narrow, %8                        ; 4 uses
  %.neg844 = xor i32 %9, -1
  %i.mo = add i32 %9, 2
  %i.mp = add i32 %9, 3
end_hunk_4
begin_hunk_5_@Falign:bb.a
  ...
  %gep912 = getelementptr [8 x i8], ptr %invariant.gep911, i64 %index824 ; 2 uses
...
.lr.ph559:                                        ; preds = %.preheader495
  ...
  %narrow = add nsw i32 %i.i, 1                   ; 2 uses
...
vector.ph930:                                     ; preds = %vector.memcheck918
  ...
  %invariant.gep1023 = getelementptr [8 x i8], ptr %.pre814.pre, i64 %i.nc
  br label %vector.body933

vector.body933:                                   ; preds = %vector.body933, %vector.ph930
  %index934 = phi i64 [ 0, %vector.ph930 ], [ %index.next936, %vector.body933 ] ; 3 uses
  %8 = trunc i64 %index934 to i32
  %9 = add i32 %narrow, %8                        ; 4 uses
  %.neg954 = xor i32 %9, -1
  %i.nz = add i32 %9, 2
  %i.oa = add i32 %9, 3
...
begin_hunk_8_@Falign_noudp:bb.a
  ...
  %gep1024 = getelementptr [8 x i8], ptr %invariant.gep1023, i64 %index934 ; 2 uses
...
.lr.ph502:                                        ; preds = %.preheader436
  ...
  %narrow = add nsw i32 %i.j, 1                   ; 2 uses
...
vector.ph849:                                     ; preds = %vector.memcheck837
  ...
  %invariant.gep940 = getelementptr [8 x i8], ptr %.pre747.pre, i64 %i.nd
  br label %vector.body852

vector.body852:                                   ; preds = %vector.body852, %vector.ph849
  %index853 = phi i64 [ 0, %vector.ph849 ], [ %index.next855, %vector.body852 ] ; 3 uses
  %8 = trunc i64 %index853 to i32
  %9 = add i32 %narrow, %8                        ; 4 uses
  %.neg873 = xor i32 %9, -1
  %i.oa = add i32 %9, 2
  %i.ob = add i32 %9, 3
...
begin_hunk_11_@Falign_udpari_long:bb.a
  ...
  %gep941 = getelementptr [8 x i8], ptr %invariant.gep940, i64 %index853 ; 2 uses
