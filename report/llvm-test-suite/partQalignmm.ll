...
vector.memcheck874:                               ; preds = %.lr.ph650
  ...
  %19 = or <4 x i1> %i.is, %i.jf
  %20 = or <4 x i1> %19, %i.js
  %21 = or <4 x i1> %20, %i.kf
  %i.kg = shufflevector <4 x i1> %21, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.kh = or <8 x i1> %i.kg, %i.id
...
vector.memcheck1020:                              ; preds = %.lr.ph654
  ...
  %22 = or <4 x i1> %i.qb, %i.qo
  %23 = or <4 x i1> %22, %i.rb
  %24 = or <4 x i1> %23, %i.ro
  %i.rp = shufflevector <4 x i1> %24, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.rq = or <8 x i1> %i.rp, %i.pm
