...
begin_hunk_0_@Deinterlace:bb.a
  ...
  %i.ag = getelementptr inbounds nuw i8, ptr %i.u, i64 %indvars.iv79
  %i.ah = load i8, ptr %i.ag, align 1, !tbaa !15
  %i.ai = zext i8 %i.ah to i32
  %i.aj = shl nuw nsw i32 %i.ai, 1
  %i.ak = getelementptr inbounds nuw i8, ptr %i.w, i64 %indvars.iv79
  %i.al = load i8, ptr %i.ak, align 1, !tbaa !15
  %i.am = zext i8 %i.al to i32
  %i.an = getelementptr inbounds nuw i8, ptr %i.x, i64 %indvars.iv79
  %i.ao = load i8, ptr %i.an, align 1, !tbaa !15
  %i.ap = zext i8 %i.ao to i32
  %.neg62.us.us = add nuw nsw i32 %i.af, %i.aj
  %i.aq = add nuw nsw i32 %i.am, %i.ap
  %i.ar = sub nsw i32 %.neg62.us.us, %i.aq        ; 2 uses
  ...
  %i.ba = getelementptr inbounds nuw i8, ptr %i.p, i64 %indvars.iv79
  store i8 %i.az, ptr %i.ba, align 1, !tbaa !15
  %indvars.iv.next80.a = add nuw nsw i64 %indvars.iv79, 1 ; 2 uses
  %exitcond83.not = icmp eq i64 %indvars.iv.next80.a, %i.k
  br i1 %exitcond83.not, label %..loopexit_crit_edge.us.us, label %bb.b, !llvm.loop !79

..loopexit_crit_edge.us.us:                       ; preds = %bb.b
  %indvars.iv.next85 = add nuw nsw i64 %indvars.iv84, 2 ; 2 uses
  %i.bb = icmp samesign ult i64 %indvars.iv.next85, %i.n
  br i1 %i.bb, label %.lr.ph66.us.us, label %._crit_edge, !llvm.loop !80

.lr.ph68.split:                                   ; preds = %.lr.ph68
  br i1 %i.i, label %.preheader.us.preheader, label %._crit_edge

.preheader.us.preheader:                          ; preds = %.lr.ph68.split
  ...
  %min.iters.check92 = icmp ult i32 %3, 32
  %n.mod.vf = and i64 %i.bd, 24
  %n.vec = and i64 %i.bd, 2147483616              ; 4 uses
  %cmp.n = icmp eq i64 %n.vec, %i.bd
  %min.epilog.iters.check = icmp eq i64 %n.mod.vf, 0
  %n.vec97 = and i64 %i.bd, 2147483640            ; 3 uses
  %cmp.n102 = icmp eq i64 %n.vec97, %i.bd
  %xtraiter = and i64 %i.bd, 1
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  %i.bg = add nsw i64 %i.bd, -1
  br label %iter.check

iter.check:                                       ; preds = %.preheader.us.preheader, %..loopexit63_crit_edge.us
  %indvars.iv76 = phi i64 [ %i.bc, %.preheader.us.preheader ], [ %indvars.iv.next77, %..loopexit63_crit_edge.us ] ; 4 uses
  %i.bh = mul nuw nsw i64 %indvars.iv76, %i.bd
  %i.bi = getelementptr inbounds nuw i8, ptr %0, i64 %i.bh ; 7 uses
  %i.bj = icmp eq i64 %indvars.iv76, 0
  %.pn.us70 = select i1 %i.bj, i64 %i.b, i64 %i.c ; 2 uses
  %i.bk = getelementptr inbounds i8, ptr %i.bi, i64 %.pn.us70 ; 5 uses
  %i.bl = icmp eq i64 %indvars.iv76, %i.be
  %.pn58.us71 = select i1 %i.bl, i64 %i.c, i64 %i.b ; 2 uses
  %i.bm = getelementptr inbounds i8, ptr %i.bi, i64 %.pn58.us71 ; 5 uses
  br i1 %min.iters.check, label %vec.epilog.scalar.ph.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %iter.check
  %i.bn = add nsw i64 %.pn.us70, 31
  %diff.check = icmp ult i64 %i.bn, 32
  %i.bo = add nsw i64 %.pn58.us71, 31
  %diff.check91 = icmp ult i64 %i.bo, 32
...
vector.main.loop.iter.check:                      ; preds = %vector.memcheck
  br i1 %min.iters.check92, label %vec.epilog.ph, label %vector.body
...
vector.body:                                      ; preds = %vector.main.loop.iter.check, %vector.body
  ...
  %wide.load93 = load <16 x i8>, ptr %i.bq, align 1, !tbaa !15
  %i.br = zext <16 x i8> %wide.load to <16 x i16>
  %i.bs = zext <16 x i8> %wide.load93 to <16 x i16>
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bm, i64 %index ; 2 uses
  %i.bu = getelementptr inbounds nuw i8, ptr %i.bt, i64 16
  %wide.load94.a = load <16 x i8>, ptr %i.bt, align 1, !tbaa !15
  %wide.load95.a = load <16 x i8>, ptr %i.bu, align 1, !tbaa !15
  %i.bv = zext <16 x i8> %wide.load94.a to <16 x i16>
  %i.bw = zext <16 x i8> %wide.load95.a to <16 x i16>
...
middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %..loopexit63_crit_edge.us, label %vec.epilog.iter.check
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index98 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next101, %vec.epilog.vector.body ] ; 4 uses
  %i.ci = getelementptr inbounds nuw i8, ptr %i.bk, i64 %index98
  %wide.load99 = load <8 x i8>, ptr %i.ci, align 1, !tbaa !15
  %i.cj = zext <8 x i8> %wide.load99 to <8 x i16>
  %i.ck = getelementptr inbounds nuw i8, ptr %i.bm, i64 %index98
  %wide.load100 = load <8 x i8>, ptr %i.ck, align 1, !tbaa !15
  %i.cl = zext <8 x i8> %wide.load100 to <8 x i16>
  ...
  %i.cq = getelementptr inbounds nuw i8, ptr %i.bi, i64 %index98
  store <8 x i8> %i.cp, ptr %i.cq, align 1, !tbaa !15
  %index.next101 = add nuw i64 %index98, 8        ; 2 uses
  %i.cr = icmp eq i64 %index.next101, %n.vec97
  br i1 %i.cr, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !83

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  br i1 %cmp.n102, label %..loopexit63_crit_edge.us, label %vec.epilog.scalar.ph.preheader

vec.epilog.scalar.ph.preheader:                   ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv.ph = phi i64 [ 0, %iter.check ], [ 0, %vector.memcheck ], [ %n.vec, %vec.epilog.iter.check ], [ %n.vec97, %vec.epilog.middle.block ] ; 6 uses
...
vec.epilog.scalar.ph.prol.loopexit:               ; preds = %vec.epilog.scalar.ph.prol, %vec.epilog.scalar.ph.preheader
  ...
  br i1 %i.dd, label %..loopexit63_crit_edge.us, label %vec.epilog.scalar.ph
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  ...
  br i1 %exitcond.not.1, label %..loopexit63_crit_edge.us, label %vec.epilog.scalar.ph, !llvm.loop !84

..loopexit63_crit_edge.us:                        ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %vec.epilog.middle.block, %middle.block
  %indvars.iv.next77 = add nuw nsw i64 %indvars.iv76, 2 ; 2 uses
  %i.ea = icmp samesign ult i64 %indvars.iv.next77, %i.bf
  br i1 %i.ea, label %iter.check, label %._crit_edge, !llvm.loop !80

._crit_edge:                                      ; preds = %..loopexit63_crit_edge.us, %..loopexit_crit_edge.us.us, %.lr.ph68.split.us, %.lr.ph68.split, %bb.a
  ret void
}
