begin_hunk_0_@ctab_insert:bb.a
  ...
  call fastcc void @ctab_insert(ptr noundef %i.z, ptr noundef nonnull %i.a), !inline_history !28
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %i.aa = load i32, ptr %i.c, align 4, !tbaa !25
  %i.ab = sext i32 %i.aa to i64
  %.not.i.not = icmp slt i64 %indvars.iv, %i.ab
  br i1 %.not.i.not, label %bb.e, label %.preheader, !llvm.loop !29
...
bb.f:                                             ; preds = %.lr.ph38
  %i.ag = tail call i32 @DisposeObject(ptr noundef nonnull %i.af) #8, !inline_history !28 ; 0 uses
...
begin_hunk_2_@ctab_insert:bb.a
  ...
  br i1 %i.aj, label %.lr.ph38, label %ctab_rehash.exit, !llvm.loop !30

ctab_rehash.exit:                                 ; preds = %bb.g, %.preheader
  tail call void @free(ptr noundef nonnull %i.b) #8, !inline_history !28
...
begin_hunk_3_@ctab_insert:bb.a
  ...
  br i1 %.not, label %._crit_edge, label %.lr.ph42, !llvm.loop !31
