...
.preheader59:                                     ; preds = %.preheader60, %.preheader59
  ...
  %i.cq = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cp, <2 x double> %i.cn, <2 x double> %i.bw) ; 2 uses
  ...
  %i.da = fsub double %i.cz, %i.as
  %4 = tail call double @llvm.fmuladd.f64(double %i.bb, double %i.da, double %i.cx)
  %i.db = tail call double @llvm.fmuladd.f64(double %i.bb, double %4, double %i.cs)
  %i.dc = tail call double @llvm.fmuladd.f64(double %i.bc, double %i.db, double %i.ct) ; 2 uses
  %5 = extractelement <2 x double> %i.cq, i64 0   ; 3 uses
  %6 = extractelement <2 x double> %i.cq, i64 1   ; 3 uses
  %7 = fsub double %5, %6
  %8 = fmul double %i.bp, -5.000000e+00
  %9 = tail call double @llvm.fmuladd.f64(double %6, double 2.000000e+00, double %8)
  %10 = tail call double @llvm.fmuladd.f64(double %5, double 4.000000e+00, double %9)
  %11 = fsub double %10, %i.dc
  %i.dd = fsub double %i.bp, %5
  %12 = tail call double @llvm.fmuladd.f64(double %i.dd, double 3.000000e+00, double %i.dc)
  %13 = fsub double %12, %6
  %i.de = tail call double @llvm.fmuladd.f64(double %i.l, double %13, double %11)
  %i.df = tail call double @llvm.fmuladd.f64(double %i.l, double %i.de, double %7)
