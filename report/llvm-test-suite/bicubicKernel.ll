...
.preheader59:                                     ; preds = %.preheader60, %.preheader59
  ...
  %i.dt = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ds, <2 x double> <double 2.000000e+00, double 3.000000e+00>, <2 x double> %i.dq)
  %4 = insertelement <2 x double> %i.dc, double -0.000000e+00, i64 1
  %5 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %4, <2 x double> <double 4.000000e+00, double 0.000000e+00>, <2 x double> %i.dt)
  %6 = shufflevector <2 x double> %i.dp, <2 x double> %i.dc, <2 x i32> <i32 1, i32 3>
  %7 = fsub <2 x double> %5, %6                   ; 2 uses
  %8 = extractelement <2 x double> %7, i64 0
  %i.du = extractelement <2 x double> %7, i64 1
