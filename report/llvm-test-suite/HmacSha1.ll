...
; Function Attrs: mustprogress uwtable
define dso_local void @_ZN7NCrypto5NSha15CHmac5FinalEPhm(ptr noundef nonnull align 8 dereferenceable(208) %0, ptr nofree noundef writeonly captures(none) %1, i64 noundef %2) local_unnamed_addr #0 align 2 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = load <16 x i8>, ptr %i.b, align 16, !tbaa !8 ; 4 uses
  %i.g = shufflevector <16 x i8> %i.f, <16 x i8> poison, <4 x i32> <i32 0, i32 4, i32 8, i32 12>
  %i.h = zext <4 x i8> %i.g to <4 x i32>
  %i.i = shl nuw <4 x i32> %i.h, splat (i32 24)
  %i.j = shufflevector <16 x i8> %i.f, <16 x i8> poison, <4 x i32> <i32 1, i32 5, i32 9, i32 13>
  %i.k = zext <4 x i8> %i.j to <4 x i32>
  %i.l = shl nuw nsw <4 x i32> %i.k, splat (i32 16)
  %i.m = or disjoint <4 x i32> %i.l, %i.i
  %i.n = shufflevector <16 x i8> %i.f, <16 x i8> poison, <4 x i32> <i32 2, i32 6, i32 10, i32 14>
  %i.o = zext <4 x i8> %i.n to <4 x i32>
  %i.p = shl nuw nsw <4 x i32> %i.o, splat (i32 8)
  %i.q = or disjoint <4 x i32> %i.m, %i.p
  %i.r = shufflevector <16 x i8> %i.f, <16 x i8> poison, <4 x i32> <i32 3, i32 7, i32 11, i32 15>
  %i.s = zext <4 x i8> %i.r to <4 x i32>
  %i.t = or disjoint <4 x i32> %i.q, %i.s
  %i.u = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  %i.v = load i32, ptr %i.u, align 16
  %i.w = call i32 @llvm.bswap.i32(i32 %i.v)
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %.preheader, %bb.b
  %i.bh = phi i32 [ %.pre45, %.loopexit.loopexit ], [ 0, %.preheader ], [ %i.w, %bb.b ]
  %i.bi = phi <4 x i32> [ %i.bg, %.loopexit.loopexit ], [ zeroinitializer, %.preheader ], [ %i.t, %bb.b ]
  ...
  %i.bw = xor i32 %i.bv, 909522486
  store i32 %i.bw, ptr %i.bu, align 4, !tbaa !4
  %i.bx = getelementptr inbounds nuw i8, ptr %i.a, i64 56 ; 2 uses
  %i.by = load i32, ptr %i.bx, align 8, !tbaa !4
  %i.bz = xor i32 %i.by, 909522486
  store i32 %i.bz, ptr %i.bx, align 8, !tbaa !4
  %i.ca = getelementptr inbounds nuw i8, ptr %i.a, i64 60 ; 2 uses
  %i.cb = load i32, ptr %i.ca, align 4, !tbaa !4
  %i.cc = xor i32 %i.cb, 909522486
  store i32 %i.cc, ptr %i.ca, align 4, !tbaa !4
  call void @_ZN7NCrypto5NSha112CContextBase4InitEv(ptr noundef nonnull align 8 dereferenceable(100) %0)
  %i.cd = getelementptr inbounds nuw i8, ptr %0, i64 32
  store i32 0, ptr %i.cd, align 8, !tbaa !9
  ...
  %i.ce = load <4 x i32>, ptr %i.a, align 16, !tbaa !4
  %i.cf = xor <4 x i32> %i.ce, splat (i32 1785358954)
  store <4 x i32> %i.cf, ptr %i.a, align 16, !tbaa !4
  %i.cg = load <4 x i32>, ptr %i.bk, align 16, !tbaa !4
  %i.ch = xor <4 x i32> %i.cg, splat (i32 1785358954)
  store <4 x i32> %i.ch, ptr %i.bk, align 16, !tbaa !4
  %i.ci = load <4 x i32>, ptr %i.bn, align 16, !tbaa !4
  %i.cj = xor <4 x i32> %i.ci, splat (i32 1785358954)
  store <4 x i32> %i.cj, ptr %i.bn, align 16, !tbaa !4
  %i.ck = load <4 x i32>, ptr %i.br, align 16, !tbaa !4
  %i.cl = xor <4 x i32> %i.ck, splat (i32 1785358954)
  store <4 x i32> %i.cl, ptr %i.br, align 16, !tbaa !4
  %i.cm = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  call void @_ZN7NCrypto5NSha112CContextBase4InitEv(ptr noundef nonnull align 8 dereferenceable(100) %i.cm)
  %i.cn = getelementptr inbounds nuw i8, ptr %0, i64 136
  store i32 0, ptr %i.cn, align 8, !tbaa !9
  call void @_ZN7NCrypto5NSha110CContext326UpdateEPKjm(ptr noundef nonnull align 8 dereferenceable(100) %i.cm, ptr noundef nonnull %i.a, i64 noundef 16)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #6
  ret void
}
...
; Function Attrs: mustprogress uwtable
define dso_local void @_ZN7NCrypto5NSha17CHmac325FinalEPjm(ptr noundef nonnull align 8 dereferenceable(208) %0, ptr nofree noundef writeonly captures(none) %1, i64 noundef %2) local_unnamed_addr #0 align 2 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define dso_local void @_ZN7NCrypto5NSha17CHmac3216GetLoopXorDigestEPjj(ptr noundef nonnull align 8 dereferenceable(208) %0, ptr nofree noundef captures(none) %1, i32 noundef %2) local_unnamed_addr #0 align 2 {
.preheader:
