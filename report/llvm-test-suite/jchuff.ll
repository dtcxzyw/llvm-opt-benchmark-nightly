...
begin_hunk_0_@encode_mcu_huff:bb.a
  ...
  %i.an = tail call i32 %i.am(ptr noundef %i.ai) #9
...
begin_hunk_1_@encode_mcu_huff:bb.a
  ...
  %i.bd = tail call i32 %i.bc(ptr noundef %i.ay) #9
...
begin_hunk_2_@encode_mcu_huff:bb.a
  ...
  br i1 %i.bj, label %bb.d, label %.loopexit.i.loopexit, !llvm.loop !96
...
begin_hunk_3_@encode_mcu_huff:bb.a
  ...
  %i.bu = tail call i32 %i.bt(ptr noundef %i.bp) #9
...
begin_hunk_4_@encode_mcu_huff:bb.a
  ...
  %i.cj = tail call i32 %i.ci(ptr noundef %.pre113) #9
...
begin_hunk_5_@encode_mcu_huff:bb.a
  ...
  br i1 %i.cv, label %bb.n, label %emit_restart.exit, !llvm.loop !97
...
begin_hunk_6_@encode_mcu_huff:bb.a
  ...
  br i1 %.not.i, label %._crit_edge.i, label %.lr.ph.i40, !llvm.loop !98
...
begin_hunk_7_@encode_mcu_huff:bb.a
  ...
  tail call void %i.es(ptr noundef nonnull %i.ep) #9
  br label %bb.q
...
begin_hunk_8_@encode_mcu_huff:bb.a
  ...
  %i.fp = tail call i32 %i.fo(ptr noundef %i.fk) #9
...
begin_hunk_9_@encode_mcu_huff:bb.a
  ...
  %i.gg = tail call i32 %i.gf(ptr noundef %i.gb) #9
...
begin_hunk_10_@encode_mcu_huff:bb.a
  ...
  br i1 %i.gn, label %.lr.ph.i.i, label %.loopexit153.i, !llvm.loop !96
...
begin_hunk_11_@encode_mcu_huff:bb.a
  ...
  %i.hm = tail call i32 %i.hl(ptr noundef %i.hh) #9
...
begin_hunk_12_@encode_mcu_huff:bb.a
  ...
  %i.id = tail call i32 %i.ic(ptr noundef %i.hy) #9
...
begin_hunk_13_@encode_mcu_huff:bb.a
  ...
  br i1 %i.ik, label %.lr.ph.i74.i, label %emit_bits.exit81.i, !llvm.loop !96
...
begin_hunk_14_@encode_mcu_huff:bb.a
  ...
  tail call void %i.jl(ptr noundef nonnull %i.ji) #9
  br label %bb.af
...
begin_hunk_15_@encode_mcu_huff:bb.a
  ...
  %i.kh = tail call i32 %i.kg(ptr noundef %i.kc) #9
...
begin_hunk_16_@encode_mcu_huff:bb.a
  ...
  %i.ky = tail call i32 %i.kx(ptr noundef %i.kt) #9
...
begin_hunk_17_@encode_mcu_huff:bb.a
  ...
  br i1 %i.lf, label %.lr.ph.i87.i, label %.loopexit.i42, !llvm.loop !96
...
begin_hunk_18_@encode_mcu_huff:bb.a
  ...
  br i1 %i.li, label %.lr.ph173.i, label %._crit_edge174.i, !llvm.loop !99
...
begin_hunk_19_@encode_mcu_huff:bb.a
  ...
  tail call void %i.mc(ptr noundef nonnull %i.lz) #9
  br label %bb.am
...
begin_hunk_20_@encode_mcu_huff:bb.a
  ...
  %i.my = tail call i32 %i.mx(ptr noundef %i.mt) #9
...
begin_hunk_21_@encode_mcu_huff:bb.a
  ...
  %i.np = tail call i32 %i.no(ptr noundef %i.nk) #9
...
begin_hunk_22_@encode_mcu_huff:bb.a
  ...
  br i1 %i.nw, label %.lr.ph.i100.i, label %.loopexit150.i, !llvm.loop !96
...
begin_hunk_23_@encode_mcu_huff:bb.a
  ...
  %i.ou = tail call i32 %i.ot(ptr noundef %i.op) #9
...
begin_hunk_24_@encode_mcu_huff:bb.a
  ...
  %i.pl = tail call i32 %i.pk(ptr noundef %i.pg) #9
...
begin_hunk_25_@encode_mcu_huff:bb.a
  ...
  br i1 %i.ps, label %.lr.ph.i113.i, label %.thread.i, !llvm.loop !96
...
bb.ax:                                            ; preds = %bb.ad
  ...
  br i1 %exitcond.not.i, label %bb.ay, label %bb.ad, !llvm.loop !100
...
begin_hunk_26_@encode_mcu_huff:bb.a
  ...
  br i1 %exitcond.not213.i, label %encode_one_block.exit, label %.outer.i, !llvm.loop !100
...
begin_hunk_27_@encode_mcu_huff:bb.a
  ...
  tail call void %i.qd(ptr noundef nonnull %i.qa) #9
  br label %bb.ba
...
begin_hunk_28_@encode_mcu_huff:bb.a
  ...
  %i.qz = tail call i32 %i.qy(ptr noundef %i.qu) #9
...
begin_hunk_29_@encode_mcu_huff:bb.a
  ...
  %i.rq = tail call i32 %i.rp(ptr noundef %i.rl) #9
...
begin_hunk_30_@encode_mcu_huff:bb.a
  ...
  br i1 %i.rx, label %.lr.ph.i126.i, label %emit_bits.exit133.i, !llvm.loop !96
...
begin_hunk_31_@encode_mcu_huff:bb.a
  ...
  br i1 %i.sf, label %bb.o, label %._crit_edge, !llvm.loop !101
...
begin_hunk_32_@finish_pass_huff:bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %.sroa.24, ptr noundef nonnull align 4 dereferenceable(20) %.sroa.24.16..sroa_idx18, i64 20, i1 false), !tbaa.struct !102
...
begin_hunk_33_@finish_pass_huff:bb.a
  ...
  %i.w = tail call i32 %i.v(ptr noundef %0) #9
...
begin_hunk_34_@finish_pass_huff:bb.a
  ...
  %i.ai = tail call i32 %i.ah(ptr noundef %0) #9
...
begin_hunk_35_@finish_pass_huff:bb.a
  ...
  br i1 %i.ao, label %bb.b, label %flush_bits.exit, !llvm.loop !96
...
begin_hunk_36_@finish_pass_huff:bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %.sroa.24.16..sroa_idx18, ptr noundef nonnull align 4 dereferenceable(20) %.sroa.24, i64 20, i1 false), !tbaa.struct !102
