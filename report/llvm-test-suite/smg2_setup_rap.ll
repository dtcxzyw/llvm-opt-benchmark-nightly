...
.preheader952.us.us.us.us.us.preheader:           ; preds = %.preheader954.lr.ph
  ...
  %6 = zext i32 %i.cb to i64                      ; 7 uses
  %7 = zext i32 %i.cj to i64                      ; 4 uses
...
.preheader953.us.us.us.us.us.preheader:           ; preds = %.preheader955.lr.ph
  ...
  %8 = zext nneg i32 %i.cb to i64                 ; 2 uses
  %9 = zext nneg i32 %i.cj to i64
...
.preheader884.us.us.us.us.us.preheader:           ; preds = %.preheader886.lr.ph
  ...
  %6 = zext i32 %i.bz to i64                      ; 7 uses
  %7 = zext i32 %i.ch to i64                      ; 2 uses
  ...
  %i.hy = shl nuw nsw i64 %7, 3                   ; 2 uses
  %scevgep1188 = getelementptr i8, ptr %scevgep1187, i64 %i.hy
  %scevgep1190 = getelementptr i8, ptr %i.bd, i64 16
  %i.hz = getelementptr i8, ptr %scevgep1190, i64 %i.hu
  %scevgep1191 = getelementptr i8, ptr %i.hz, i64 %i.hy
...
.preheader885.us.us.us.us.us.preheader:           ; preds = %.preheader887.lr.ph
  ...
  %8 = zext i32 %i.bz to i64                      ; 7 uses
  %9 = zext i32 %i.ch to i64                      ; 2 uses
  ...
  %i.rs = shl nuw nsw i64 %9, 3                   ; 2 uses
  %scevgep1492 = getelementptr i8, ptr %scevgep1491, i64 %i.rs
  %scevgep1494 = getelementptr i8, ptr %i.bd, i64 16
  %i.rt = getelementptr i8, ptr %scevgep1494, i64 %i.ro
  %scevgep1495 = getelementptr i8, ptr %i.rt, i64 %i.rs
