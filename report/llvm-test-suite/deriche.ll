...
bb.y:                                             ; preds = %bb.y, %.preheader.i125
  ...
  %i.oa = bitcast double %i.ny to i64             ; 5 uses
  %3 = lshr i64 %i.oa, 56
  %.sroa.0.6.extract.shift.i.i = lshr i64 %i.oa, 48
  %.sroa.0.5.extract.shift.i.i = lshr i64 %i.oa, 40
  ...
  %5 = insertelement <4 x i64> poison, i64 %i.oa, i64 0
  %6 = shufflevector <4 x i64> %5, <4 x i64> poison, <4 x i32> zeroinitializer
  %7 = lshr <4 x i64> %6, <i64 8, i64 16, i64 24, i64 32>
  %8 = trunc <4 x i64> %7 to <4 x i8>
  %.sroa.0.0.extract.trunc.i.i = trunc i64 %i.oa to i8
  %9 = insertelement <8 x i8> poison, i8 %.sroa.0.0.extract.trunc.i.i, i64 0
  %10 = shufflevector <4 x i8> %8, <4 x i8> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %11 = shufflevector <8 x i8> %9, <8 x i8> %10, <8 x i32> <i32 0, i32 8, i32 9, i32 10, i32 11, i32 poison, i32 poison, i32 poison>
  %12 = insertelement <8 x i8> %11, i8 %.sroa.0.5.extract.trunc.i.i, i64 5
  %13 = insertelement <8 x i8> %12, i8 %.sroa.0.6.extract.trunc.i.i, i64 6
  %14 = insertelement <8 x i8> %13, i8 %4, i64 7
  %15 = and <8 x i8> %14, splat (i8 15)
  %16 = or disjoint <8 x i8> %15, splat (i8 48)
  %i.ob = shufflevector <8 x i8> %16, <8 x i8> poison, <16 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3, i32 4, i32 4, i32 5, i32 5, i32 6, i32 6, i32 7, i32 7>
