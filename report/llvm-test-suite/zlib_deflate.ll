...
begin_hunk_0_@deflate:bb.a
  ...
  %spec.select = select i1 %.not393, i32 %i.ch, i32 %i.ck ; 2 uses
  %i.cl = urem i32 %spec.select, 31
  %reass.sub = sub nuw nsw i32 %spec.select, %i.cl
  %2 = add i32 %reass.sub, 31                     ; 2 uses
  %i.cm = lshr i32 %2, 8
...
begin_hunk_1_@deflate:bb.a
  ...
  store i8 %i.cs, ptr %i.cw, align 1, !tbaa !8
