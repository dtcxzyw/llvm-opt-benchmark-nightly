...
begin_hunk_0_@deflate_stored:bb.a
  %.pre271 = zext i32 %.pre265 to i64
  br label %bb.w

bb.p:                                             ; preds = %split
  %i.ex = load i32, ptr %i.d, align 8, !tbaa !32  ; 4 uses
  %.not236 = icmp ult i32 %i.ew, %i.ex
  br i1 %.not236, label %bb.r, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.ey = getelementptr inbounds nuw i8, ptr %0, i64 5928
  store i32 2, ptr %i.ey, align 8, !tbaa !94
  %i.ez = load ptr, ptr %i.s, align 8, !tbaa !38
  %i.fa = load ptr, ptr %i.et, align 8, !tbaa !72
  ...
  %i.fe = load i32, ptr %i.d, align 8, !tbaa !32  ; 3 uses
  store i32 %i.fe, ptr %i.m, align 4, !tbaa !62
  br label %bb.v

bb.r:                                             ; preds = %bb.p
  %i.ff = getelementptr inbounds nuw i8, ptr %0, i64 104
  %i.fg = load i64, ptr %i.ff, align 8, !tbaa !51
  %i.fh = load i32, ptr %i.m, align 4, !tbaa !62  ; 2 uses
  %i.fi = zext i32 %i.fh to i64
  %i.fj = sub i64 %i.fg, %i.fi
  %i.fk = zext i32 %i.ew to i64                   ; 3 uses
  %.not237 = icmp ugt i64 %i.fj, %i.fk
  br i1 %.not237, label %bb.u, label %bb.s
...
bb.w:                                             ; preds = %._crit_edge264, %bb.v
  ...
  %i.gl = phi i32 [ %.pre265, %._crit_edge264 ], [ %i.gf, %bb.v ] ; 3 uses
