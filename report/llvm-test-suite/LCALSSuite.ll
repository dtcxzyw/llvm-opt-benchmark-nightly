...
_ZNKSt6vectorI8LoopStatSaIS0_EE12_M_check_lenEmPKc.exit.i: ; preds = %bb.by
  ...
  %i.apu = select i1 %i.aps, i64 32940614417338485, i64 %i.apt ; 2 uses
...
bb.s:                                             ; preds = %bb.q
  ...
  %11 = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %10) #22 ; 5 uses
...
_ZNSt12_Vector_baseIiSaIiEE13_M_deallocateEPim.exit: ; preds = %bb.z, %bb.aa
  ...
  %i.cr = getelementptr inbounds nuw [4 x i8], ptr %11, i64 %7
...
bb.s:                                             ; preds = %bb.q
  ...
  %11 = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %10) #22 ; 5 uses
  %i.bh = getelementptr inbounds i8, ptr %11, i64 %9 ; 4 uses
...
bb.t:                                             ; preds = %_ZSt24__uninitialized_fill_n_aIPemeeET_S1_T0_RKT1_RSaIT2_E.exit80
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 16 %11, ptr align 16 %i.bb, i64 %9, i1 false)
...
bb.v:                                             ; preds = %bb.u
  ...
  store x86_fp80 %i.bz, ptr %11, align 16, !tbaa !92
  br label %_ZSt34__uninitialized_move_if_noexcept_aIPeS0_SaIeEET0_T_S3_S2_RT1_.exit
...
bb.w:                                             ; preds = %_ZSt34__uninitialized_move_if_noexcept_aIPeS0_SaIeEET0_T_S3_S2_RT1_.exit
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 %i.ca, ptr align 16 %1, i64 %i.cb, i1 false)
  br label %bb.z
...
_ZNSt12_Vector_baseIeSaIeEE13_M_deallocateEPem.exit: ; preds = %bb.z, %bb.aa
  ...
  %i.cg = getelementptr inbounds nuw [16 x i8], ptr %11, i64 %7
