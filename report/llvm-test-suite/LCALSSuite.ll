...
define dso_local void @_Z22defineLoopSuiteRunInfoRKSt6vectorI13LoopVariantIDSaIS0_EEPbdd(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(24) %0, ptr noundef readonly captures(none) %1, double noundef %2, double noundef %3) local_unnamed_addr #1 personality ptr @__gxx_personality_v0 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define dso_local void @_Z8loopInitjR8LoopStat(i32 noundef %0, ptr noundef nonnull writeonly align 8 captures(none) dereferenceable(280) initializes((0, 1)) %1) local_unnamed_addr #1 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define dso_local void @_Z12loopFinalizejR8LoopStat10LoopLength(i32 noundef %0, ptr noundef nonnull readonly align 8 captures(none) dereferenceable(280) %1, i32 noundef %2) local_unnamed_addr #1 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define dso_local noundef zeroext i1 @_Z14recursiveMkdirRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(32) %0) local_unnamed_addr #1 {
bb.a:
