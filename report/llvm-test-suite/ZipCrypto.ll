...
begin_hunk_0_@_ZThn8_N7NCrypto4NZip8CEncoder7ReleaseEv:bb.a
  ...
  tail call void %i.g(ptr noundef nonnull align 8 dereferenceable(44) %i.d) #15, !inline_history !19
...
begin_hunk_1_@_ZThn8_N7NCrypto4NZip8CDecoder7ReleaseEv:bb.a
  ...
  %i.f = getelementptr inbounds nuw i8, ptr %i.e, i64 32
  %i.g = load ptr, ptr %i.f, align 8
  tail call void %i.g(ptr noundef nonnull align 8 dereferenceable(44) %i.d) #15, !inline_history !20
...
!19 = !{ptr @_ZN7NCrypto4NZip8CEncoder7ReleaseEv}
!20 = !{ptr @_ZN7NCrypto4NZip8CDecoder7ReleaseEv}
end_hunk_2
