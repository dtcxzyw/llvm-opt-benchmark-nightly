...
begin_hunk_1_@Lzma2Dec_DecodeToDic:bb.a
  ...
  %6 = getelementptr inbounds nuw i8, ptr %.0103159, i64 %i.co
...
bb.ap:                                            ; preds = %bb.ao, %bb.an
  ...
  %i.dl = load i64, ptr %i.a, align 8, !tbaa !20  ; 4 uses
  %7 = getelementptr inbounds nuw i8, ptr %.0103159, i64 %i.dl ; 2 uses
...
bb.aw:                                            ; preds = %LzmaDec_UpdateWithUncompressed.exit, %bb.au, %bb.av
  %.3106 = phi ptr [ %6, %LzmaDec_UpdateWithUncompressed.exit ], [ %7, %bb.au ], [ %7, %bb.av ]
