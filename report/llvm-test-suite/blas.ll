...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.i
  %lsr.iv293 = phi ptr [ %lsr.iv291, %.lr.ph.preheader ], [ %scevgep294, %bb.i ] ; 3 uses
...
.lr.ph167:                                        ; preds = %.lr.ph167.preheader, %bb.m
  %lsr.iv301 = phi ptr [ %lsr.iv299, %.lr.ph167.preheader ], [ %scevgep302, %bb.m ] ; 2 uses
...
begin_hunk_4_@snrm2:bb.a
  ...
  %exitcond194.not = icmp eq i32 %.2111155, %lsr.iv.next
