...
begin_hunk_0_@encode_one_slice:bb.a
  ...
  %3 = load <4 x i32>, ptr @listXsize, align 16, !tbaa !4
  %4 = icmp ult <4 x i32> %3, splat (i32 2)
  %5 = select <4 x i1> %4, <4 x ptr> <ptr @writeSE_Dummy, ptr @writeSE_Dummy, ptr @writeSE_Dummy, ptr @writeSE_Dummy>, <4 x ptr> <ptr @writeRefFrame_CABAC, ptr @writeRefFrame_CABAC, ptr @writeRefFrame_CABAC, ptr @writeRefFrame_CABAC>
  store <4 x ptr> %5, ptr @writeRefFrame, align 16, !tbaa !8
