...
.lr.ph.split.us:                                  ; preds = %.lr.ph, %bb.f
  ...
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %bb.f ], [ 0, %.lr.ph ] ; 2 uses
  %i.h = load ptr, ptr %i.d, align 8, !tbaa !12
  %i.i = getelementptr inbounds nuw [12 x i8], ptr %i.h, i64 %indvars.iv43 ; 3 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c, %bb.b, %.lr.ph.split.us
  %.sroa.0.0.us = phi i64 [ %.sroa.0.0.insert.insert.us, %.lr.ph.split.us ], [ %.sroa.0.2.insert.insert.us, %bb.b ], [ %.sroa.0.0.insert.insert.us, %bb.c ], [ %.sroa.0.4.insert.shift.us, %bb.d ]
...
.lr.ph.split:                                     ; preds = %.lr.ph, %bb.l
  %indvars.iv.a = phi i64 [ %indvars.iv.next, %bb.l ], [ 0, %.lr.ph ] ; 2 uses
  %i.ab = load ptr, ptr %i.d, align 8, !tbaa !12
  %i.ac = getelementptr inbounds nuw [12 x i8], ptr %i.ab, i64 %indvars.iv.a ; 3 uses
...
bb.k:                                             ; preds = %bb.h, %bb.i, %bb.j, %.lr.ph.split
  %.sroa.0.0 = phi i64 [ %.sroa.0.0.insert.insert, %.lr.ph.split ], [ %.sroa.0.2.insert.insert, %bb.j ], [ %.sroa.0.0.insert.insert, %bb.i ], [ %.sroa.0.4.insert.shift, %bb.h ]
  tail call void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %2)
