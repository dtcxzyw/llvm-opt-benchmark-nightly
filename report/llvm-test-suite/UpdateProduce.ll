...
.lr.ph.split.us:                                  ; preds = %.lr.ph, %bb.f
  ...
  %indvars.iv44 = phi i64 [ %indvars.iv.next44, %bb.f ], [ 0, %.lr.ph ] ; 2 uses
  %indvars.iv43 = phi i64 [ %.sroa.0.2.us, %bb.f ], [ undef, %.lr.ph ]
  %i.h = load ptr, ptr %i.d, align 8, !tbaa !12
  %i.i = getelementptr inbounds nuw [12 x i8], ptr %i.h, i64 %indvars.iv44 ; 3 uses
  %.sroa.0.4.insert.mask31.us = and i64 %indvars.iv43, 4278190080
...
bb.d:                                             ; preds = %.lr.ph.split.us
  ...
  br i1 %i.r, label %.split38.us, label %bb.e

bb.e:                                             ; preds = %bb.d, %bb.c, %bb.b, %.lr.ph.split.us
  %.sroa.0.0.us = phi i64 [ %.sroa.0.0.insert.insert.us, %.lr.ph.split.us ], [ %.sroa.0.2.insert.insert.us, %bb.b ], [ %.sroa.0.0.insert.insert.us, %bb.c ], [ %.sroa.0.4.insert.insert.us, %bb.d ] ; 2 uses
  ...
  store i64 %.sroa.0.0.us, ptr %i.v, align 4
...
bb.f:                                             ; preds = %.lr.ph.split.us, %bb.e
  ...
  %.sroa.0.2.us = phi i64 [ %.sroa.0.0.us, %bb.e ], [ %.sroa.0.0.insert.insert.us, %.lr.ph.split.us ]
  %indvars.iv.next44 = add nuw nsw i64 %indvars.iv44, 1 ; 2 uses
  %i.z = sext i32 %i.y to i64
  %i.aa = icmp slt i64 %indvars.iv.next44, %i.z
...
bb.h:                                             ; preds = %.lr.ph.split
  ...
  br i1 %i.ao, label %.split38.us, label %bb.k

.split38.us:                                      ; preds = %bb.h, %bb.d
...
bb.k:                                             ; preds = %bb.h, %bb.i, %bb.j, %.lr.ph.split
  %.sroa.0.0 = phi i64 [ %.sroa.0.0.insert.insert, %.lr.ph.split ], [ %.sroa.0.2.insert.insert, %bb.j ], [ %.sroa.0.0.insert.insert, %bb.i ], [ %.sroa.0.4.insert.insert, %bb.h ] ; 2 uses
  tail call void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %2)
  ...
  store i64 %.sroa.0.0, ptr %i.au, align 4
...
bb.l:                                             ; preds = %bb.g, %bb.k
  %.sroa.0.2 = phi i64 [ %.sroa.0.0, %bb.k ], [ %.sroa.0.0.insert.insert, %bb.g ]
