...
bb.q:                                             ; preds = %clause_LiteralAtom.exit
  %i.ip = tail call ptr @term_Copy(ptr noundef %.0.i206) #14, !inline_history !106
  ...
  %i.is = tail call ptr @clause_Create(ptr noundef nonnull %i.iq, ptr noundef null, ptr noundef null, ptr noundef nonnull %.val.i, ptr noundef %.val57.i) #14, !inline_history !106 ; 6 uses
...
begin_hunk_1_@red_CRwTautologyCheck:bb.a
  ...
  %i.jc = call fastcc i32 @red_SortSimplification(ptr noundef %.val65.i, ptr noundef nonnull %i.is, i32 noundef -1, i32 noundef %i.ih, ptr noundef nonnull %.val.i, ptr noundef %.val57.i, ptr noundef %i.b), !inline_history !106
...
begin_hunk_2_@red_CRwTautologyCheck:bb.a
  ...
  br i1 %.not43.i, label %._crit_edge58.i, label %.lr.ph57.i, !llvm.loop !107
...
red_CRwLitTautologyCheck.exit.thread:             ; preds = %.thread, %bb.t
  tail call void @clause_Delete(ptr noundef nonnull %i.is) #14, !inline_history !106
...
bb.x:                                             ; preds = %bb.w
  %i.ju = tail call ptr @clause_CopyConstraint(ptr noundef %1) #14, !inline_history !106
  br label %bb.z

bb.y:                                             ; preds = %bb.w
  %i.jv = tail call ptr @clause_CopyAntecedentExcept(ptr noundef %1, i32 noundef %2) #14, !inline_history !106
  br label %bb.z

bb.z:                                             ; preds = %bb.y, %bb.x
  %.044.i = phi ptr [ %i.ju, %bb.x ], [ %i.jv, %bb.y ]
  %i.jw = tail call ptr @term_Copy(ptr noundef %.0.i206) #14, !inline_history !106
...
bb.aa:                                            ; preds = %bb.v
  %i.jz = tail call ptr @term_Copy(ptr noundef %.0.i206) #14, !inline_history !106
  ...
  %i.kc = tail call ptr @clause_CopySuccedentExcept(ptr noundef %1, i32 noundef %2) #14, !inline_history !106
  br label %bb.ab

bb.ab:                                            ; preds = %bb.aa, %bb.z
  %.1.i = phi ptr [ %.044.i, %bb.z ], [ %i.ka, %bb.aa ] ; 3 uses
  %.0.i = phi ptr [ %i.jx, %bb.z ], [ %i.kc, %bb.aa ] ; 3 uses
  %i.kd = tail call ptr @clause_Create(ptr noundef null, ptr noundef %.1.i, ptr noundef %.0.i, ptr noundef nonnull %.val.i, ptr noundef %.val57.i) #14, !inline_history !106 ; 2 uses
...
begin_hunk_6_@red_CRwTautologyCheck:bb.a
  ...
  br i1 %i.np, label %.lr.ph.i174, label %._crit_edge.loopexit.i, !llvm.loop !108
...
begin_hunk_7_@red_CRwTautologyCheck:bb.a
  ...
  br i1 %exitcond.not.i168, label %._crit_edge137.i, label %bb.ac, !llvm.loop !109
...
begin_hunk_8_@red_CRwTautologyCheck:bb.a
  ...
  br i1 %exitcond.not.i168212, label %._crit_edge137.i.thread.thread, label %.outer, !llvm.loop !109
...
begin_hunk_9_@red_CRwTautologyCheck:bb.a
  ...
  %i.pd = call fastcc i32 @red_SelectedStaticReductions(ptr noundef %0, ptr noundef %i.a, ptr noundef %i.b, ptr noundef %i.c, i32 noundef %6), !inline_history !106
...
clause_IsEmptyClause.exit.thread:                 ; preds = %bb.aq, %bb.ar, %clause_IsEmptyClause.exit
  %i.pj = tail call i32 @cc_Tautology(ptr noundef nonnull %i.pe) #14, !inline_history !106
...
bb.at:                                            ; preds = %bb.as
  tail call fastcc void @clause_UpdateSplitDataFromPartner(ptr noundef nonnull %i.pe, ptr noundef nonnull %i.pk), !inline_history !106
  br label %bb.au
...
begin_hunk_12_@red_CRwTautologyCheck:bb.a
  ...
  br i1 %.not17.i.i, label %bb.ax, label %.preheader.i277, !llvm.loop !110
...
begin_hunk_13_@red_CRwTautologyCheck:bb.a
  ...
  br i1 %.not.i279, label %._crit_edge.i280, label %.lr.ph.i274, !llvm.loop !111
...
begin_hunk_14_@red_CRwTautologyCheck:bb.a
  ...
  br i1 %.not42.i, label %._crit_edge52.i, label %.lr.ph51.i, !llvm.loop !112
...
begin_hunk_15_@red_CRwTautologyCheck:bb.a
  ...
  br i1 %.not43.i286, label %._crit_edge58.i287, label %.lr.ph57.i283, !llvm.loop !107
...
red_CRwLitTautologyCheck.exit.thread265:          ; preds = %red_CRwCalculateAdditionalParents.exit, %bb.au
  tail call void @clause_DeleteClauseList(ptr noundef %.pre247) #14, !inline_history !106
  br label %red_CRwLitTautologyCheck.exit.thread263

.thread267:                                       ; preds = %clause_IsEmptyClause.exit.thread, %clause_IsEmptyClause.exit
  tail call void @clause_Delete(ptr noundef nonnull %i.pe) #14, !inline_history !106
  %.pre246 = load ptr, ptr %i.c, align 8
  tail call void @clause_DeleteClauseList(ptr noundef %.pre246) #14, !inline_history !106
...
bb.bg:                                            ; preds = %bb.n, %bb.bf
  ...
  br i1 %exitcond.not314, label %._crit_edge236, label %bb.n, !llvm.loop !113
...
begin_hunk_18_@red_CRwTautologyCheck:bb.a
  ...
  br i1 %exitcond.not.i161.5, label %flag_TransferAllFlags.exit162, label %scalar.ph329, !llvm.loop !114
