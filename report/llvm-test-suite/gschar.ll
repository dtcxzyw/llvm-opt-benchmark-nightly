...
begin_hunk_0_@continue_show_update:bb.a
  ...
  %i.y = tail call i32 (ptr, double, double, ...) @gs_rmoveto(ptr noundef %i.p, double noundef %i.u, double noundef %i.x) #12 ; 0 uses
  br label %bb.e
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.am = load float, ptr %i.al, align 4, !tbaa !90
  %i.an = fpext float %i.am to double
  %i.ao = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.ap = load float, ptr %i.ao, align 8, !tbaa !91
  %i.aq = fpext float %i.ap to double
  %i.ar = tail call i32 (ptr, double, double, ...) @gs_rmoveto(ptr noundef %i.p, double noundef %i.an, double noundef %i.aq) #12 ; 0 uses
  br label %bb.g
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  %i.av = load i8, ptr %i.au, align 8, !tbaa !92
...
begin_hunk_2_@continue_show_update:bb.a
  ...
  store i8 0, ptr %i.bb, align 1, !tbaa !96
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.x = load float, ptr %i.w, align 4, !tbaa !90
  %i.y = fpext float %i.x to double
  %i.z = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.aa = load float, ptr %i.z, align 8, !tbaa !91
...
begin_hunk_4_@show_move:bb.a
  ...
  %i.ag = load i8, ptr %i.af, align 8, !tbaa !92
...
begin_hunk_5_@show_move:bb.a
  ...
  store i8 0, ptr %i.am, align 1, !tbaa !96
...
begin_hunk_6_@show_proceed:bb.a
  ...
  %i.ay = tail call i32 (ptr, double, double, ...) @gs_rmoveto(ptr noundef %i.as, double noundef %i.av, double noundef %i.ax) #12 ; 0 uses
  br label %bb.k
...
bb.l:                                             ; preds = %bb.k
  %i.bi = load float, ptr %i.n, align 4, !tbaa !90
  %i.bj = fpext float %i.bi to double
  %i.bk = load float, ptr %i.o, align 8, !tbaa !91
  %i.bl = fpext float %i.bk to double
  %i.bm = tail call i32 (ptr, double, double, ...) @gs_rmoveto(ptr noundef %i.as, double noundef %i.bj, double noundef %i.bl) #12 ; 0 uses
  br label %bb.m
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  %i.bq = load i8, ptr %i.bp, align 8, !tbaa !92
...
begin_hunk_8_@show_proceed:bb.a
  ...
  store i8 0, ptr %i.bv, align 1, !tbaa !96
...
bb.o:                                             ; preds = %bb.h
  ...
  %i.ca = load i8, ptr %i.bz, align 8, !tbaa !92
...
begin_hunk_10_@show_proceed:bb.a
  ...
  store i8 0, ptr %i.cg, align 1, !tbaa !96
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.db = load i64, ptr %i.da, align 8, !tbaa !99 ; 2 uses
...
begin_hunk_12_@show_proceed:bb.a
  ...
  store float %i.do, ptr %i.v, align 8, !tbaa !100
  ...
  store float %i.ds, ptr %i.w, align 8, !tbaa !101
  ...
  %i.dv = load ptr, ptr %i.du, align 8, !tbaa !102
  %i.dw = zext i8 %.090 to i32
  %i.dx = getelementptr inbounds nuw i8, ptr %i.dt, i64 176
  %i.dy = load ptr, ptr %i.dx, align 8, !tbaa !103
...
begin_hunk_13_@show_proceed:bb.a
  ...
  %i.eu = tail call i32 (ptr, double, double, ...) @gs_rmoveto(ptr noundef %i.eo, double noundef %i.er, double noundef %i.et) #12 ; 0 uses
  br label %bb.ad
...
bb.ae:                                            ; preds = %bb.ad
  %i.fe = load float, ptr %i.n, align 4, !tbaa !90
  %i.ff = fpext float %i.fe to double
  %i.fg = load float, ptr %i.o, align 8, !tbaa !91
  %i.fh = fpext float %i.fg to double
  %i.fi = tail call i32 (ptr, double, double, ...) @gs_rmoveto(ptr noundef %i.eo, double noundef %i.ff, double noundef %i.fh) #12 ; 0 uses
  br label %bb.af
...
bb.af:                                            ; preds = %bb.ae, %bb.ad
  ...
  %i.fm = load i8, ptr %i.fl, align 8, !tbaa !92
...
begin_hunk_15_@show_proceed:bb.a
  ...
  store i8 0, ptr %i.fr, align 1, !tbaa !96
...
begin_hunk_16_@continue_stringwidth_update:bb.a
  ...
  %i.q = load i8, ptr %i.p, align 8, !tbaa !92
...
begin_hunk_17_@continue_stringwidth_update:bb.a
  ...
  store i8 0, ptr %i.w, align 1, !tbaa !96
...
begin_hunk_18_@stringwidth_move:bb.a
  ...
  %i.e = load i8, ptr %i.d, align 8, !tbaa !92
...
begin_hunk_19_@stringwidth_move:bb.a
  ...
  store i8 0, ptr %i.k, align 1, !tbaa !96
  br label %bb.c
...
begin_hunk_20_@stringwidth_proceed:bb.a
  ...
  %i.aq = load i8, ptr %i.ap, align 8, !tbaa !92
...
begin_hunk_21_@stringwidth_proceed:bb.a
  ...
  store i8 0, ptr %i.av, align 1, !tbaa !96
...
begin_hunk_23_@stringwidth_proceed:bb.a
  ...
  %i.ci = load i8, ptr %i.ch, align 8, !tbaa !92
...
!91 = !{!9, !13, i64 24}
!92 = !{!93, !6, i64 136}
!93 = !{!"gx_path_s", !38, i64 0, !94, i64 16, !95, i64 48, !94, i64 56, !11, i64 88, !11, i64 96, !5, i64 104, !5, i64 108, !5, i64 112, !23, i64 120, !6, i64 136, !6, i64 137, !6, i64 138}
!94 = !{!"gs_fixed_rect_s", !23, i64 0, !23, i64 16}
!95 = !{!"p1 _ZTS9segment_s", !11, i64 0}
!96 = !{!93, !6, i64 137}
!97 = !{!37, !6, i64 437}
!98 = !{!93, !18, i64 120}
!99 = !{!93, !18, i64 128}
