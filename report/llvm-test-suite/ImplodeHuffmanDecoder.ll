...
.thread:                                          ; preds = %_ZN5NBitl8CDecoderI9CInBufferE8GetValueEj.exit, %bb.e, %bb.f, %bb.g, %bb.h, %bb.i, %bb.j, %bb.k, %bb.l, %bb.m, %bb.n, %bb.o, %bb.p, %bb.q, %bb.r, %bb.s
  %.01623.lcssa = phi i64 [ 16, %_ZN5NBitl8CDecoderI9CInBufferE8GetValueEj.exit ], [ 15, %bb.e ], [ 14, %bb.f ], [ 13, %bb.g ], [ 12, %bb.h ], [ 11, %bb.i ], [ 10, %bb.j ], [ 9, %bb.k ], [ 8, %bb.l ], [ 7, %bb.m ], [ 6, %bb.n ], [ 5, %bb.o ], [ 4, %bb.p ], [ 3, %bb.q ], [ 2, %bb.r ], [ 1, %bb.s ] ; 2 uses
  %.01623.lcssa.a = phi i32 [ 16, %_ZN5NBitl8CDecoderI9CInBufferE8GetValueEj.exit ], [ 15, %bb.e ], [ 14, %bb.f ], [ 13, %bb.g ], [ 12, %bb.h ], [ 11, %bb.i ], [ 10, %bb.j ], [ 9, %bb.k ], [ 8, %bb.l ], [ 7, %bb.m ], [ 6, %bb.n ], [ 5, %bb.o ], [ 4, %bb.p ], [ 3, %bb.q ], [ 2, %bb.r ], [ 1, %bb.s ] ; 3 uses
...
begin_hunk_1_@_ZN9NCompress8NImplode8NHuffman8CDecoder12DecodeSymbolEPN5NBitl8CDecoderI9CInBufferEE:bb.a
  ...
  %i.ck = getelementptr inbounds nuw [4 x i8], ptr %i.cj, i64 %.01623.lcssa
  %i.cl = load i32, ptr %i.ck, align 4, !tbaa !4
  %i.cm = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %.01623.lcssa
