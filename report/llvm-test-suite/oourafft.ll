...
._crit_edge405:                                   ; preds = %.lr.ph404, %middle.block1105, %.lr.ph413
...
vector.memcheck733:                               ; preds = %.lr.ph408
...
scalar.ph876.preheader:                           ; preds = %vector.memcheck733, %.lr.ph408, %middle.block913
  %indvars.iv426.ph = phi i64 [ %i.kl, %vector.memcheck733 ], [ %i.kl, %.lr.ph408 ], [ %i.pi, %middle.block913 ]
...
._crit_edge409:                                   ; preds = %scalar.ph876, %middle.block913, %._crit_edge405
