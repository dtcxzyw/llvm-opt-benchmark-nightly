...
begin_hunk_0_@main:bb.a
  %.01216.i = phi double [ 0.000000e+00, %putdata.exit ], [ %i.au, %bb.b ] ; 2 uses
  %.01315.i = phi i32 [ 0, %putdata.exit ], [ %i.am, %bb.b ]
  %i.ak = mul nuw nsw i32 %.01315.i, 7141
  ...
  %i.at = fcmp ogt double %.01216.i, %i.as
  %i.au = select i1 %i.at, double %.01216.i, double %i.as ; 3 uses
...
.lr.ph245.i:                                      ; preds = %bb.d, %._crit_edge.i
  %.0233243.i = phi i32 [ %i.q, %._crit_edge.i ], [ 1, %bb.d ] ; 6 uses
  %.0234242.i = phi i32 [ %i.d, %._crit_edge.i ], [ %0, %bb.d ]
  %i.d = lshr i32 %.0234242.i, 1                  ; 5 uses
  %i.e = icmp sgt i32 %.0233243.i, 0
  br i1 %i.e, label %.lr.ph.preheader.i, label %._crit_edge.i

.lr.ph.preheader.i:                               ; preds = %.lr.ph245.i
  %i.f = zext nneg i32 %.0233243.i to i64         ; 4 uses
  %invariant.gep.i = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.f ; 2 uses
  %min.iters.check = icmp ult i32 %.0233243.i, 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load53 = load <4 x i32>, ptr %i.h, align 4, !tbaa !4
  %i.i = add nsw <4 x i32> %wide.load, %broadcast.splat
  %i.j = add nsw <4 x i32> %wide.load53, %broadcast.splat
...
.preheader.lr.ph.i:                               ; preds = %.preheader238.i, %._crit_edge246.thread.i
  %.0233.lcssa289291.i = phi i32 [ %i.q, %.preheader238.i ], [ 1, %._crit_edge246.thread.i ] ; 2 uses
  %i.x = phi i32 [ %i.t, %.preheader238.i ], [ 2, %._crit_edge246.thread.i ] ; 5 uses
  %i.y = shl nsw i32 %.0233.lcssa289291.i, 2      ; 2 uses
  %i.z = zext nneg i32 %i.x to i64                ; 3 uses
  %wide.trip.count278.i = zext nneg i32 %.0233.lcssa289291.i to i64
