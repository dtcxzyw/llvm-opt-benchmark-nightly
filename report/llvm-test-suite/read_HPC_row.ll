...
bb.c:                                             ; preds = %bb.a
  ...
  %i.o = load i32, ptr %i.a, align 4, !tbaa !4    ; 11 uses
...
begin_hunk_2_@_Z12read_HPC_rowPcPP24HPC_Sparse_Matrix_STRUCTPPdS4_S4_:bb.a
  ...
  %5 = load i32, ptr %i.a, align 4, !tbaa !4
...
begin_hunk_3_@_Z12read_HPC_rowPcPP24HPC_Sparse_Matrix_STRUCTPPdS4_S4_:bb.a
  ...
  %i.ak = load i32, ptr %i.a, align 4, !tbaa !4
  %i.al = icmp slt i32 %i.aj, %i.ak
  br i1 %i.al, label %.lr.ph, label %._crit_edge, !llvm.loop !11

._crit_edge:                                      ; preds = %bb.e, %bb.c
  %.0157.lcssa = phi i32 [ 0, %bb.c ], [ %.1158, %bb.e ] ; 3 uses
...
.preheader165:                                    ; preds = %.preheader165.loopexit.unr-lcssa, %.lr.ph171.epil, %._crit_edge
  %6 = load i32, ptr %i.a, align 4, !tbaa !4
  %7 = icmp sgt i32 %6, 0
  br i1 %7, label %.lr.ph179, label %._crit_edge180.thread
