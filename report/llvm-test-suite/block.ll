...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %0 = fadd <4 x double> %wide.vec, %wide.vec446
  ...
  %1 = fadd <4 x double> %0, %wide.vec449
  ...
  %2 = fadd <4 x double> %1, %wide.vec452
  %3 = shufflevector <4 x double> %2, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %i.hn = fadd <2 x double> %3, %strided.vec445
