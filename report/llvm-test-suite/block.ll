...
.preheader347:                                    ; preds = %bb.q, %._crit_edge429.split
  %indvars.iv543 = phi i64 [ 0, %bb.q ], [ %indvars.iv.next544, %._crit_edge429.split ] ; 6 uses
...
bb.u:                                             ; preds = %bb.t, %bb.s
  ...
  %i.fu = trunc nuw nsw i64 %indvars.iv543 to i32 ; 4 uses
...
add_sorted_list.exit:                             ; preds = %.lr.ph34.i, %._crit_edge30.i
  ...
  %i.ju = load i32, ptr @z_block_half, align 4, !tbaa !4 ; 6 uses
  %i.jv = mul nuw nsw i32 %i.ju, %i.fy
...
.preheader342.lr.ph.split.split.split:            ; preds = %.preheader342.lr.ph
  ...
  %i.kb = zext nneg i32 %i.jv to i64
  ...
  %i.ki = shl nuw i64 %indvars.iv543, 1
  %0 = and i64 %i.ki, -8
  %1 = zext nneg i32 %i.ju to i64
  %2 = mul i64 %0, %1                             ; 2 uses
  %i.kj = shl nuw nsw i64 %wide.trip.count518, 3
...
vector.memcheck:                                  ; preds = %.preheader
  ...
  %scevgep753 = getelementptr nuw i8, ptr %scevgep752, i64 %2 ; 4 uses
  %scevgep753.a = getelementptr i8, ptr %i.kx, i64 %2
  %scevgep754 = getelementptr i8, ptr %scevgep753.a, i64 %i.kj ; 4 uses
...
bb.m:                                             ; preds = %add_sorted_list.exit, %._crit_edge268.split
  %indvars.iv333 = phi i64 [ 0, %add_sorted_list.exit ], [ %indvars.iv.next334, %._crit_edge268.split ] ; 5 uses
...
del_sorted_list.exit:                             ; preds = %.lr.ph33.i, %.preheader.i
  ...
  %i.fm = trunc nuw nsw i64 %indvars.iv333 to i32 ; 2 uses
  ...
  %i.fs = load i32, ptr @z_block_half, align 4, !tbaa !4 ; 6 uses
  %i.ft = mul nuw nsw i32 %i.fs, %i.fr
...
.preheader228.lr.ph.split.split.split:            ; preds = %.preheader228.lr.ph
  ...
  %i.gg = shl nuw i64 %indvars.iv333, 1
  %0 = and i64 %i.gg, -8
  %1 = zext nneg i32 %i.fs to i64
  %2 = mul i64 %0, %1                             ; 2 uses
  %i.gh = shl nuw nsw i64 %wide.trip.count308, 3
...
vector.memcheck:                                  ; preds = %.preheader
  ...
  %scevgep420 = getelementptr nuw i8, ptr %scevgep, i64 %2 ; 4 uses
  %scevgep420.a = getelementptr i8, ptr %i.hf, i64 %2
  %scevgep421 = getelementptr i8, ptr %scevgep420.a, i64 %i.gh ; 4 uses
