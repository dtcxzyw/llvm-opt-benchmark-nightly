...
begin_hunk_0_@UpdateDecoders:bb.a
  br i1 %or.cond.i, label %.preheader.us.preheader.i, label %Error_Concealment.exit

.preheader.us.preheader.i:                        ; preds = %.lr.ph
  %i.z = lshr i32 %i.w, 4
  %i.aa = lshr i32 %i.u, 4
  %wide.trip.count22.i = zext nneg i32 %i.aa to i64
  %wide.trip.count.i = zext nneg i32 %i.z to i64
  br label %.preheader.us.i

.preheader.us.i:                                  ; preds = %._crit_edge.us.i, %.preheader.us.preheader.i
  %indvars.iv19.i = phi i64 [ 0, %.preheader.us.preheader.i ], [ %indvars.iv.next20.i, %._crit_edge.us.i ] ; 3 uses
  %i.ab = getelementptr inbounds nuw [8 x i8], ptr %i.n, i64 %indvars.iv19.i
  %i.ac = trunc nuw nsw i64 %indvars.iv19.i to i32
  br label %bb.b

bb.b:                                             ; preds = %bb.d, %.preheader.us.i
  %indvars.iv.i = phi i64 [ 0, %.preheader.us.i ], [ %indvars.iv.next.i, %bb.d ] ; 3 uses
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  br i1 %exitcond.not.i, label %._crit_edge.us.i, label %bb.b, !llvm.loop !81
...
._crit_edge.us.i:                                 ; preds = %bb.d
  ...
  br i1 %exitcond23.not.i, label %Error_Concealment.exit.loopexit, label %.preheader.us.i, !llvm.loop !82

Error_Concealment.exit.loopexit:                  ; preds = %._crit_edge.us.i
  %.pre = load ptr, ptr @decs, align 8, !tbaa !8  ; 2 uses
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %.pre, i64 24
  %.pre10 = load ptr, ptr %.phi.trans.insert, align 8, !tbaa !80
  %.phi.trans.insert11 = getelementptr inbounds nuw [8 x i8], ptr %.pre10, i64 %indvars.iv
  %.pre12 = load ptr, ptr %.phi.trans.insert11, align 8, !tbaa !47
  %.pre13 = load ptr, ptr @img, align 8, !tbaa !8 ; 2 uses
  %.phi.trans.insert14 = getelementptr inbounds nuw i8, ptr %.pre13, i64 68
  %.pre15 = load i32, ptr %.phi.trans.insert14, align 4, !tbaa !75
  br label %Error_Concealment.exit

Error_Concealment.exit:                           ; preds = %Error_Concealment.exit.loopexit, %.lr.ph
  %i.ah = phi i32 [ %.pre15, %Error_Concealment.exit.loopexit ], [ %i.u, %.lr.ph ]
  %i.ai = phi ptr [ %.pre13, %Error_Concealment.exit.loopexit ], [ %i.s, %.lr.ph ] ; 3 uses
  %i.aj = phi ptr [ %.pre12, %Error_Concealment.exit.loopexit ], [ %i.l, %.lr.ph ]
...
bb.e:                                             ; preds = %bb.e, %.lr.ph.i
  %indvars.iv.i6 = phi i64 [ 0, %.lr.ph.i ], [ %indvars.iv.next.i7, %bb.e ] ; 3 uses
  %i.ay = phi ptr [ %i.ai, %.lr.ph.i ], [ %i.bi, %bb.e ]
  %i.az = load ptr, ptr %i.ax, align 8, !tbaa !47
  %i.ba = getelementptr inbounds nuw [8 x i8], ptr %i.az, i64 %indvars.iv.i6
  %i.bb = load ptr, ptr %i.ba, align 8, !tbaa !48
  %i.bc = getelementptr inbounds nuw [8 x i8], ptr %i.aj, i64 %indvars.iv.i6
  ...
  %i.bm = icmp slt i64 %indvars.iv.next.i7, %i.bl
...
bb.a:
  ...
  br i1 %or.cond, label %.preheader.us.preheader, label %._crit_edge48
...
.preheader.us.preheader:                          ; preds = %bb.a
  ...
  %wide.trip.count58 = zext nneg i32 %i.i to i64
  %wide.trip.count = zext nneg i32 %i.h to i64
  br label %.preheader.us

.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  %indvars.iv55 = phi i64 [ 0, %.preheader.us.preheader ], [ %indvars.iv.next56, %._crit_edge.us ] ; 2 uses
  %.047.us = phi i32 [ 0, %.preheader.us.preheader ], [ %.537.us, %._crit_edge.us ]
  %.02445.us = phi i64 [ 0, %.preheader.us.preheader ], [ %i.bj, %._crit_edge.us ]
  %.02644.us = phi i32 [ -1, %.preheader.us.preheader ], [ %.22834.us, %._crit_edge.us ]
  %i.m = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %indvars.iv55 ; 2 uses
  %sext = shl i64 %.02445.us, 32
  %i.n = ashr exact i64 %sext, 32                 ; 2 uses
  br label %bb.b

bb.b:                                             ; preds = %.preheader.us, %bb.f
  %indvars.iv50 = phi i64 [ %i.n, %.preheader.us ], [ %indvars.iv.next51, %bb.f ] ; 2 uses
  %indvars.iv = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next, %bb.f ] ; 3 uses
  %.141.us = phi i32 [ %.047.us, %.preheader.us ], [ %.537.us, %bb.f ]
  %.12738.us = phi i32 [ %.02644.us, %.preheader.us ], [ %.22834.us, %bb.f ] ; 3 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.u = getelementptr inbounds [536 x i8], ptr %i.t, i64 %indvars.iv50
  %i.v = load i32, ptr %i.u, align 8, !tbaa !88
  %.not29.us = icmp eq i32 %i.v, %.12738.us
  br i1 %.not29.us, label %bb.e, label %bb.d
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %.2.us = select i1 %i.an, i32 3, i32 0          ; 2 uses
  %i.ao = add nuw nsw i32 %.2.us, 2
  %i.ap = extractelement <2 x i1> %i.am, i64 0
  %.3.us = select i1 %i.ap, i32 %i.ao, i32 %.2.us
  ...
  %i.az = add nsw i32 %.12738.us, 1               ; 2 uses
  br i1 %i.ay, label %.thread.us, label %bb.e

bb.e:                                             ; preds = %bb.d, %bb.c
  %.228.us = phi i32 [ %i.az, %bb.d ], [ %.12738.us, %bb.c ] ; 2 uses
  %.5.us = phi i32 [ %.3.us, %bb.d ], [ %.141.us, %bb.c ] ; 2 uses
...
.sink.split:                                      ; preds = %.thread.us, %bb.e
  %.sink = phi i8 [ 0, %bb.e ], [ 1, %.thread.us ]
  %.537.us.ph = phi i32 [ 0, %bb.e ], [ %.536.us, %.thread.us ]
  %.22834.us.ph = phi i32 [ %.228.us, %bb.e ], [ %.22835.us, %.thread.us ]
...
bb.f:                                             ; preds = %.sink.split, %.thread.us
  %.537.us = phi i32 [ %.536.us, %.thread.us ], [ %.537.us.ph, %.sink.split ] ; 2 uses
  %.22834.us = phi i32 [ %.22835.us, %.thread.us ], [ %.22834.us.ph, %.sink.split ] ; 2 uses
  %indvars.iv.next51 = add nsw i64 %indvars.iv50, 1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %._crit_edge.us, label %bb.b, !llvm.loop !93

._crit_edge.us:                                   ; preds = %bb.f
  %i.bj = add nsw i64 %i.l, %i.n
  %indvars.iv.next56 = add nuw nsw i64 %indvars.iv55, 1 ; 2 uses
  %exitcond59.not = icmp eq i64 %indvars.iv.next56, %wide.trip.count58
  br i1 %exitcond59.not, label %._crit_edge48, label %.preheader.us, !llvm.loop !94

._crit_edge48:                                    ; preds = %._crit_edge.us, %bb.a
  ret void
}
...
.preheader.us.preheader:                          ; preds = %bb.a
  %i.h = lshr i32 %i.e, 4
  %i.i = lshr i32 %i.c, 4
  %wide.trip.count22 = zext nneg i32 %i.i to i64
  %wide.trip.count = zext nneg i32 %i.h to i64
  br label %.preheader.us

.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  %indvars.iv19 = phi i64 [ 0, %.preheader.us.preheader ], [ %indvars.iv.next20, %._crit_edge.us ] ; 3 uses
  %i.j = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv19
  %i.k = trunc nuw nsw i64 %indvars.iv19 to i32
  br label %bb.b
...
._crit_edge.us:                                   ; preds = %bb.d
  ...
  br i1 %exitcond23.not, label %._crit_edge16, label %.preheader.us, !llvm.loop !82
