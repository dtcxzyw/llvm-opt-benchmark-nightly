...
bb.d:                                             ; preds = %bb.c, %bb.b
  %i.r = tail call i32 @rand() #7
  %i.s = load ptr, ptr @input, align 8, !tbaa !8
  %i.t = getelementptr inbounds nuw i8, ptr %i.s, i64 4724
  %i.u = load i32, ptr %i.t, align 4, !tbaa !89
  %i.v = tail call i32 @rand() #7
  %i.w = load ptr, ptr @input, align 8, !tbaa !8
  %i.x = getelementptr inbounds nuw i8, ptr %i.w, i64 4720
  %i.y = load i32, ptr %i.x, align 8, !tbaa !90
  %i.z = insertelement <2 x i32> poison, i32 %i.v, i64 0
  %i.aa = insertelement <2 x i32> %i.z, i32 %i.r, i64 1
  %i.ab = sitofp <2 x i32> %i.aa to <2 x double>
  %i.ac = fdiv nnan <2 x double> %i.ab, splat (double f0x41DFFFFFFFC00000)
  %i.ad = fmul nnan <2 x double> %i.ac, splat (double 1.000000e+02)
  %i.ae = insertelement <2 x i32> poison, i32 %i.y, i64 0
  %i.af = insertelement <2 x i32> %i.ae, i32 %i.u, i64 1
  %i.ag = sitofp <2 x i32> %i.af to <2 x double>
  %i.ah = fcmp olt <2 x double> %i.ad, %i.ag      ; 2 uses
  %i.ai = extractelement <2 x i1> %i.ah, i64 1
  %.2 = select i1 %i.ai, i32 3, i32 0             ; 2 uses
  %i.aj = add nuw nsw i32 %.2, 2
  %i.ak = extractelement <2 x i1> %i.ah, i64 0
  %.3 = select i1 %i.ak, i32 %i.aj, i32 %.2
  %i.al = tail call i32 @rand() #7
  %i.am = sitofp i32 %i.al to double
  %i.an = fdiv nnan double %i.am, f0x41DFFFFFFFC00000
  %i.ao = fmul nnan double %i.an, 1.000000e+02
  %i.ap = load ptr, ptr @input, align 8, !tbaa !8
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 4716
  %i.ar = load i32, ptr %i.aq, align 4, !tbaa !91
  %i.as = sitofp i32 %i.ar to double
  %i.at = fcmp olt double %i.ao, %i.as
  %i.au = add nsw i32 %.12738, 1                  ; 2 uses
  br i1 %i.at, label %.thread, label %bb.e

bb.e:                                             ; preds = %bb.d, %bb.c
  %.228 = phi i32 [ %i.au, %bb.d ], [ %.12738, %bb.c ] ; 2 uses
...
.thread:                                          ; preds = %bb.d, %bb.e
  ...
  %.22835 = phi i32 [ %.228, %bb.e ], [ %i.au, %bb.d ] ; 2 uses
  %i.av = trunc nuw nsw i32 %.536 to i8
  %i.aw = load ptr, ptr %i.i, align 8, !tbaa !72
  %i.ax = getelementptr inbounds nuw i8, ptr %i.aw, i64 %indvars.iv
  store i8 %i.av, ptr %i.ax, align 1, !tbaa !73
  %i.ay = load ptr, ptr @input, align 8, !tbaa !8
  %i.az = getelementptr inbounds nuw i8, ptr %i.ay, i64 4016
  %i.ba = load i32, ptr %i.az, align 8, !tbaa !92
  %i.bb = icmp eq i32 %i.ba, 0
  br i1 %i.bb, label %.sink.split, label %bb.f
...
.sink.split:                                      ; preds = %.thread, %bb.e
  ...
  %i.bc = load ptr, ptr %i.i, align 8, !tbaa !72
  %i.bd = getelementptr inbounds nuw i8, ptr %i.bc, i64 %indvars.iv
  store i8 %.sink, ptr %i.bd, align 1, !tbaa !73
  br label %bb.f
