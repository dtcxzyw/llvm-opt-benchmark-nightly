...
bb.e:                                             ; preds = %.loopexit, %polybench_alloc_data.exit15
  %indvars.iv26.i = phi i64 [ 0, %polybench_alloc_data.exit15 ], [ %indvars.iv.next27.i, %.loopexit ] ; 7 uses
...
begin_hunk_2_@main:bb.a
  ...
  %i.ad = add <2 x i32> %i.ac, splat (i32 4002)
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.ai = sub nuw nsw i64 %indvars.iv26.i, %indvars.iv.i
  %.tr.i = trunc i64 %i.ai to i32
  %i.aj = shl i32 %.tr.i, 1
  %i.ak = add i32 %i.aj, 4002
