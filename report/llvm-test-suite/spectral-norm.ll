...
.lr.ph33:                                         ; preds = %.lr.ph33, %.lr.ph33.preheader.new
  ...
  %2 = phi <2 x double> [ zeroinitializer, %.lr.ph33.preheader.new ], [ %10, %.lr.ph33 ]
  ...
  %3 = insertelement <2 x double> poison, double %i.ac, i64 0 ; 2 uses
  %4 = insertelement <2 x double> %3, double %i.aa, i64 1
  %5 = shufflevector <2 x double> %3, <2 x double> poison, <2 x i32> zeroinitializer
  %6 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %4, <2 x double> %5, <2 x double> %2)
  ...
  %7 = insertelement <2 x double> poison, double %i.ag, i64 0 ; 2 uses
  %8 = insertelement <2 x double> %7, double %i.ae, i64 1
  %9 = shufflevector <2 x double> %7, <2 x double> poison, <2 x i32> zeroinitializer
  %10 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %8, <2 x double> %9, <2 x double> %6) ; 3 uses
...
.lr.ph33.epil.preheader:                          ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph33.preheader
  ...
  %.epil.init = phi <2 x double> [ zeroinitializer, %.lr.ph33.preheader ], [ %10, %._crit_edge.loopexit.unr-lcssa ]
  ...
  %11 = insertelement <2 x double> poison, double %i.ak, i64 0 ; 2 uses
  %12 = insertelement <2 x double> %11, double %i.ai, i64 1
  %13 = shufflevector <2 x double> %11, <2 x double> poison, <2 x i32> zeroinitializer
  %14 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %12, <2 x double> %13, <2 x double> %.epil.init)
  br label %._crit_edge.loopexit

._crit_edge.loopexit:                             ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph33.epil.preheader
  %.lcssa = phi <2 x double> [ %10, %._crit_edge.loopexit.unr-lcssa ], [ %14, %.lr.ph33.epil.preheader ] ; 2 uses
  %15 = extractelement <2 x double> %.lcssa, i64 0
  %16 = extractelement <2 x double> %.lcssa, i64 1
  %i.al = fdiv double %16, %15
  br label %._crit_edge
