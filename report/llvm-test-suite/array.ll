...
.lr.ph.us.us:                                     ; preds = %.lr.ph.us.us.preheader, %._crit_edge.us.us
  ...
  br i1 %exitcond55.not, label %..preheader_crit_edge.us.us.preheader, label %bb.b
...
bb.b:                                             ; preds = %.lr.ph.us.us
  ...
  br i1 %exitcond55.not.1, label %..preheader_crit_edge.us.us.preheader, label %bb.c
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  ...
  %i.ak = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv67
  %i.al = load ptr, ptr %i.ak, align 8, !tbaa !8  ; 4 uses
  br label %bb.d

bb.d:                                             ; preds = %.preheader.us, %bb.d
  %indvars.iv64 = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next65, %bb.d ] ; 6 uses
  %i.am = getelementptr inbounds nuw [8 x i8], ptr %i.al, i64 %indvars.iv64
  %i.an = load double, ptr %i.am, align 8, !tbaa !14
  %i.ao = getelementptr inbounds nuw [8 x i8], ptr %i.aj, i64 %indvars.iv64
  store double %i.an, ptr %i.ao, align 8, !tbaa !14
  %i.ap = or disjoint i64 %indvars.iv64, 1        ; 2 uses
  ...
  %i.at = or disjoint i64 %indvars.iv64, 2        ; 2 uses
  ...
  %i.ax = or disjoint i64 %indvars.iv64, 3        ; 2 uses
  ...
  %i.bb = icmp samesign ult i64 %indvars.iv.next65, %i.g
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %..preheader_crit_edge.us47
  %indvars.iv46 = phi i64 [ 0, %.lr.ph.preheader ], [ %indvars.iv.next53, %..preheader_crit_edge.us47 ] ; 3 uses
  %i.bc = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv46
  %i.bd = load ptr, ptr %i.bc, align 8, !tbaa !8  ; 3 uses
  %i.be = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv46
...
..preheader_crit_edge.us47:                       ; preds = %bb.f, %bb.e, %.lr.ph
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv46, 1 ; 2 uses
  %exitcond56.not = icmp eq i64 %indvars.iv.next53, %wide.trip.count49
  br i1 %exitcond56.not, label %._crit_edge42, label %.lr.ph, !llvm.loop !17
