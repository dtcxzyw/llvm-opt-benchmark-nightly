...
vector.body:                                      ; preds = %vector.body, %.lr.ph.i86.preheader
  ...
  %wide.vec = load <8 x float>, ptr %i.atw, align 16, !tbaa !21 ; 4 uses
  %3 = fmul <8 x float> %wide.vec, %wide.vec
  %4 = shufflevector <8 x float> %3, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %5 = fmul <8 x float> %wide.vec, %wide.vec
  %6 = shufflevector <8 x float> %5, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %i.atx = fadd <4 x float> %4, %6
  ...
  %wide.vec.1 = load <8 x float>, ptr %i.aub, align 16, !tbaa !21 ; 4 uses
  %7 = fmul <8 x float> %wide.vec.1, %wide.vec.1
  %8 = shufflevector <8 x float> %7, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %9 = fmul <8 x float> %wide.vec.1, %wide.vec.1
  %10 = shufflevector <8 x float> %9, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %i.auc = fadd <4 x float> %8, %10
...
vector.body:                                      ; preds = %vector.body, %.lr.ph.i98.preheader
  ...
  %wide.vec = load <8 x float>, ptr %i.atn, align 16, !tbaa !21 ; 3 uses
  %strided.vec = shufflevector <8 x float> %wide.vec, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6> ; 2 uses
  %3 = fmul <8 x float> %wide.vec, %wide.vec
  %4 = shufflevector <8 x float> %3, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %i.ato = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %strided.vec, <4 x float> %strided.vec, <4 x float> %4)
  ...
  %wide.vec.1 = load <8 x float>, ptr %i.ats, align 16, !tbaa !21 ; 3 uses
  %strided.vec.1 = shufflevector <8 x float> %wide.vec.1, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6> ; 2 uses
  %5 = fmul <8 x float> %wide.vec.1, %wide.vec.1
  %6 = shufflevector <8 x float> %5, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %i.att = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %strided.vec.1, <4 x float> %strided.vec.1, <4 x float> %6)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = fmul <8 x float> %wide.vec, %wide.vec
  %4 = shufflevector <8 x float> %3, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %i.f = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %strided.vec, <4 x float> %strided.vec, <4 x float> %4)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.d = shl nuw nsw i64 %index, 3
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 %i.d
  %wide.vec = load <8 x float>, ptr %i.e, align 4, !tbaa !21, !alias.scope !60 ; 4 uses
  %3 = fmul <8 x float> %wide.vec, %wide.vec
  %4 = shufflevector <8 x float> %3, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %5 = fmul <8 x float> %wide.vec, %wide.vec
  %6 = shufflevector <8 x float> %5, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %i.f = fadd <4 x float> %4, %6
  %i.g = tail call <4 x float> @llvm.sqrt.v4f32(<4 x float> %i.f)
  %i.h = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %index
