...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %._crit_edge.us
  ...
  fence syncscope("singlethread") acq_rel
  %brmerge = select i1 %bound0, i1 true, i1 %conflict.rdx43
