...
bb.i:                                             ; preds = %bb.h
  ...
  store i64 %5, ptr %i.t, align 8, !tbaa !50
...
bb.j:                                             ; preds = %bb.l
  ...
  %exitcond.not106.i = icmp eq i64 %i.z, %5
...
Xz_ReadIndex2.exit:                               ; preds = %bb.l, %bb.k, %.preheader.i, %.lr.ph, %.lr.ph.1, %.lr.ph.2, %.lr.ph.3, %.critedge.i, %._crit_edge, %bb.i, %bb.f, %bb.e, %bb.d, %bb.c
  %.020 = phi i32 [ %i.f, %bb.c ], [ 16, %.critedge.i ], [ 16, %bb.d ], [ 16, %bb.f ], [ 2, %bb.i ], [ 16, %.lr.ph ], [ %i.bh, %._crit_edge ], [ 16, %bb.e ], [ 16, %.lr.ph.3 ], [ 16, %.lr.ph.2 ], [ 16, %.lr.ph.1 ], [ 16, %.preheader.i ], [ 16, %bb.k ], [ 16, %bb.l ]
