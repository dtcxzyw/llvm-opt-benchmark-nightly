...
bb.f:                                             ; preds = %bb.d, %bb.ai
  %.054168 = phi i32 [ 0, %bb.d ], [ %i.dj, %bb.ai ] ; 2 uses
...
bb.g:                                             ; preds = %bb.f, %bb.f, %bb.f
  ...
  %i.y = fmul nnan float %i.x, 5.000000e-01       ; 4 uses
  %i.z = call noundef ptr @_Z22btAlignedAllocInternalmi(i64 noundef 64, i32 noundef 16) ; 17 uses
  %i.aa = fmul nnan float %i.y, 1.500000e+00      ; 2 uses
  invoke void @_ZN23btPolyhedralConvexShapeC2Ev(ptr noundef nonnull align 8 dereferenceable(64) %i.z)
          to label %.noexc unwind label %bb.t

.noexc:                                           ; preds = %bb.g
  store ptr getelementptr inbounds nuw inrange(-16, 208) (i8, ptr @_ZTV10btBoxShape, i64 16), ptr %i.z, align 8, !tbaa !12
  %i.ab = getelementptr inbounds nuw i8, ptr %i.z, i64 8
  store i32 0, ptr %i.ab, align 8, !tbaa !73
  %i.ac = invoke noundef float %i.b(ptr noundef nonnull align 8 dereferenceable(64) %i.z)
          to label %bb.h unwind label %bb.j

bb.h:                                             ; preds = %.noexc
  %i.ad = load ptr, ptr %i.z, align 8, !tbaa !12
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 88
  %i.af = load ptr, ptr %i.ae, align 8
  %i.ag = invoke noundef float %i.af(ptr noundef nonnull align 8 dereferenceable(64) %i.z)
          to label %bb.i unwind label %bb.k

bb.i:                                             ; preds = %bb.h
  %i.ah = load ptr, ptr %i.z, align 8, !tbaa !12
  %i.ai = getelementptr inbounds nuw i8, ptr %i.ah, i64 88
  %i.aj = load ptr, ptr %i.ai, align 8
  %i.ak = invoke noundef float %i.aj(ptr noundef nonnull align 8 dereferenceable(64) %i.z)
...
bb.m:                                             ; preds = %bb.l, %bb.k, %bb.j
  %.pn8.i = phi { ptr, i32 } [ %i.am, %bb.k ], [ %i.al, %bb.j ], [ %i.an, %bb.l ]
  invoke void @_ZN13btConvexShapeD2Ev(ptr noundef nonnull align 8 dereferenceable(64) %i.z)
...
bb.n:                                             ; preds = %bb.m
  ...
  call void @__clang_call_terminate(ptr %i.ap) #23
  unreachable

bb.o:                                             ; preds = %bb.i
  %i.aq = getelementptr inbounds nuw i8, ptr %i.z, i64 24
  %i.ar = getelementptr inbounds nuw i8, ptr %i.z, i64 32
  %i.as = load float, ptr %i.ar, align 8, !tbaa !36
  %i.at = fmul float %i.aa, %i.as
  %i.au = load <2 x float>, ptr %i.aq, align 8, !tbaa !36
  %i.av = insertelement <2 x float> poison, float %i.aa, i64 0
  %i.aw = shufflevector <2 x float> %i.av, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ax = fmul <2 x float> %i.aw, %i.au
  %i.ay = insertelement <2 x float> poison, float %i.ac, i64 0
  %i.az = insertelement <2 x float> %i.ay, float %i.ag, i64 1
  %i.ba = fsub <2 x float> %i.ax, %i.az
  %i.bb = fsub float %i.at, %i.ak
  %.sroa.3.12.vec.insert.i12.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.bb, i64 0
  %i.bc = getelementptr inbounds nuw i8, ptr %i.z, i64 40
  store <2 x float> %i.ba, ptr %i.bc, align 8
  %.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.z, i64 48
  store <2 x float> %.sroa.3.12.vec.insert.i12.i, ptr %.sroa.5.0..sroa_idx.i, align 8, !tbaa !60
  %i.bd = fcmp une float %i.y, 0.000000e+00
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #21
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %3, i8 0, i64 16, i1 false)
  br i1 %i.bd, label %bb.p, label %bb.q

bb.p:                                             ; preds = %bb.o
  %i.be = load ptr, ptr %i.z, align 8, !tbaa !12
  %i.bf = getelementptr inbounds nuw i8, ptr %i.be, i64 64
  %i.bg = load ptr, ptr %i.bf, align 8
  call void %i.bg(ptr noundef nonnull align 8 dereferenceable(24) %i.z, float noundef %i.y, ptr noundef nonnull align 4 dereferenceable(16) %3), !inline_history !75
  br label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.o
  %i.bh = call noundef ptr @_Z22btAlignedAllocInternalmi(i64 noundef 568, i32 noundef 16) ; 11 uses
  invoke void @_ZN11btRigidBodyC1EfP13btMotionStateP16btCollisionShapeRK9btVector3(ptr noundef nonnull align 8 dereferenceable(564) %i.bh, float noundef %i.y, ptr noundef null, ptr noundef nonnull %i.z, ptr noundef nonnull align 4 dereferenceable(16) %3)
          to label %_ZN15DemoApplication20localCreateRigidBodyEfRK11btTransformP16btCollisionShape.exit unwind label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.bi = landingpad { ptr, i32 }
          cleanup
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %i.bh)
...
common.resume:                                    ; preds = %.body, %bb.aa, %bb.ah, %_ZN17btCollisionObjectdlEPv.exit.i71, %_ZN17btCollisionObjectdlEPv.exit.i68, %_ZN17btCollisionObjectdlEPv.exit.i
  %common.resume.op = phi { ptr, i32 } [ %i.bi, %_ZN17btCollisionObjectdlEPv.exit.i ], [ %i.cf, %_ZN17btCollisionObjectdlEPv.exit.i68 ], [ %i.cz, %_ZN17btCollisionObjectdlEPv.exit.i71 ], [ %i.co, %bb.aa ], [ %eh.lpad-body, %.body ], [ %i.di, %bb.ah ]
...
_ZN15DemoApplication20localCreateRigidBodyEfRK11btTransformP16btCollisionShape.exit: ; preds = %bb.q
  ...
  %.sroa.7.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.bh, i64 12
  %.sroa.11.16..sroa_idx = getelementptr inbounds nuw i8, ptr %i.bh, i64 28
  ...
  %.sroa.12.16..sroa_idx = getelementptr inbounds nuw i8, ptr %i.bh, i64 32
  %.sroa.16.32..sroa_idx = getelementptr inbounds nuw i8, ptr %i.bh, i64 48
  ...
  %.sroa.17.32..sroa_idx = getelementptr inbounds nuw i8, ptr %i.bh, i64 52
  store i32 0, ptr %.sroa.17.32..sroa_idx, align 4, !tbaa !60
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bh, i64 56
  store <2 x float> %i.t, ptr %i.bm, align 8
  %.sroa.17.sroa.11.4..sroa_idx = getelementptr inbounds nuw i8, ptr %i.bh, i64 64
  store <2 x float> %.sroa.3.12.vec.insert.i58, ptr %.sroa.17.sroa.11.4..sroa_idx, align 8, !tbaa !60
  %i.bn = load ptr, ptr %i.a, align 8, !tbaa !8   ; 2 uses
  %i.bo = load ptr, ptr %i.bn, align 8, !tbaa !12
  %i.bp = getelementptr inbounds nuw i8, ptr %i.bo, i64 136
  %i.bq = load ptr, ptr %i.bp, align 8
  call void %i.bq(ptr noundef nonnull align 8 dereferenceable(228) %i.bn, ptr noundef nonnull %i.bh), !inline_history !75
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #21
  br label %bb.ai
...
.body:                                            ; preds = %bb.m, %bb.t
  %eh.lpad-body = phi { ptr, i32 } [ %i.br, %bb.t ], [ %.pn8.i, %bb.m ]
...
bb.u:                                             ; preds = %bb.f, %bb.f, %bb.f
  %i.bs = add nsw i32 %i.v, -2
  %i.bt = uitofp nneg i32 %i.bs to float
  %i.bu = fmul nnan float %i.bt, 5.000000e-01     ; 4 uses
  %i.bv = call noundef ptr @_Z22btAlignedAllocInternalmi(i64 noundef 64, i32 noundef 16) ; 9 uses
  invoke void @_ZN21btConvexInternalShapeC2Ev(ptr noundef nonnull align 8 dereferenceable(64) %i.bv)
          to label %bb.v unwind label %bb.aa

bb.v:                                             ; preds = %bb.u
  %i.bw = fmul nnan float %i.bu, 1.500000e+00     ; 2 uses
  store ptr getelementptr inbounds nuw inrange(-16, 144) (i8, ptr @_ZTV13btSphereShape, i64 16), ptr %i.bv, align 8, !tbaa !12
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bv, i64 8
  store i32 8, ptr %i.bx, align 8, !tbaa !73
  %i.by = getelementptr inbounds nuw i8, ptr %i.bv, i64 40
  store float %i.bw, ptr %i.by, align 8, !tbaa !36
  %i.bz = getelementptr inbounds nuw i8, ptr %i.bv, i64 56
  store float %i.bw, ptr %i.bz, align 8, !tbaa !85
  %i.ca = fcmp une float %i.bu, 0.000000e+00
...
bb.w:                                             ; preds = %bb.v
  %i.cb = load ptr, ptr %i.bv, align 8, !tbaa !12
  %i.cc = getelementptr inbounds nuw i8, ptr %i.cb, i64 64
  %i.cd = load ptr, ptr %i.cc, align 8
  call void %i.cd(ptr noundef nonnull align 8 dereferenceable(24) %i.bv, float noundef %i.bu, ptr noundef nonnull align 4 dereferenceable(16) %2), !inline_history !75
  br label %bb.x

bb.x:                                             ; preds = %bb.w, %bb.v
  %i.ce = call noundef ptr @_Z22btAlignedAllocInternalmi(i64 noundef 568, i32 noundef 16) ; 11 uses
  invoke void @_ZN11btRigidBodyC1EfP13btMotionStateP16btCollisionShapeRK9btVector3(ptr noundef nonnull align 8 dereferenceable(564) %i.ce, float noundef %i.bu, ptr noundef null, ptr noundef nonnull %i.bv, ptr noundef nonnull align 4 dereferenceable(16) %2)
...
_ZN15DemoApplication20localCreateRigidBodyEfRK11btTransformP16btCollisionShape.exit69: ; preds = %bb.x
  ...
  store float 1.000000e+00, ptr %i.ci, align 8
  %.sroa.7.0..sroa_idx79 = getelementptr inbounds nuw i8, ptr %i.ce, i64 12
  %.sroa.11.16..sroa_idx83 = getelementptr inbounds nuw i8, ptr %i.ce, i64 28
  ...
  %.sroa.12.16..sroa_idx87 = getelementptr inbounds nuw i8, ptr %i.ce, i64 32
  %.sroa.16.32..sroa_idx91 = getelementptr inbounds nuw i8, ptr %i.ce, i64 48
  ...
  %.sroa.17.32..sroa_idx95 = getelementptr inbounds nuw i8, ptr %i.ce, i64 52
  store i32 0, ptr %.sroa.17.32..sroa_idx95, align 4, !tbaa !60
  %i.cj = getelementptr inbounds nuw i8, ptr %i.ce, i64 56
  store <2 x float> %i.t, ptr %i.cj, align 8
  %.sroa.17.sroa.11.4..sroa_idx119 = getelementptr inbounds nuw i8, ptr %i.ce, i64 64
  ...
  call void %i.cn(ptr noundef nonnull align 8 dereferenceable(228) %i.ck, ptr noundef nonnull %i.ce), !inline_history !75
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #21
  br label %bb.ai
...
bb.aa:                                            ; preds = %bb.u
  %i.co = landingpad { ptr, i32 }
          cleanup
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %i.bv)
          to label %common.resume unwind label %bb.aj

bb.ab:                                            ; preds = %bb.f, %bb.f, %bb.f
  %i.cp = add nsw i32 %i.v, -5
  %i.cq = uitofp nneg i32 %i.cp to float
  %i.cr = fmul nnan float %i.cq, 5.000000e-01     ; 5 uses
  %i.cs = call noundef ptr @_Z22btAlignedAllocInternalmi(i64 noundef 72, i32 noundef 16) ; 5 uses
  %i.ct = fmul nnan float %i.cr, 2.000000e+00
  invoke void @_ZN14btCapsuleShapeC1Eff(ptr noundef nonnull align 8 dereferenceable(68) %i.cs, float noundef %i.cr, float noundef %i.ct)
          to label %bb.ac unwind label %bb.ah

bb.ac:                                            ; preds = %bb.ab
  %i.cu = fcmp une float %i.cr, 0.000000e+00
  call void @llvm.lifetime.start.p0(ptr nonnull %1) #21
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %1, i8 0, i64 16, i1 false)
  br i1 %i.cu, label %bb.ad, label %bb.ae

bb.ad:                                            ; preds = %bb.ac
  %i.cv = load ptr, ptr %i.cs, align 8, !tbaa !12
  %i.cw = getelementptr inbounds nuw i8, ptr %i.cv, i64 64
  %i.cx = load ptr, ptr %i.cw, align 8
  call void %i.cx(ptr noundef nonnull align 8 dereferenceable(24) %i.cs, float noundef %i.cr, ptr noundef nonnull align 4 dereferenceable(16) %1), !inline_history !75
  br label %bb.ae

bb.ae:                                            ; preds = %bb.ad, %bb.ac
  %i.cy = call noundef ptr @_Z22btAlignedAllocInternalmi(i64 noundef 568, i32 noundef 16) ; 11 uses
  invoke void @_ZN11btRigidBodyC1EfP13btMotionStateP16btCollisionShapeRK9btVector3(ptr noundef nonnull align 8 dereferenceable(564) %i.cy, float noundef %i.cr, ptr noundef null, ptr noundef nonnull %i.cs, ptr noundef nonnull align 4 dereferenceable(16) %1)
          to label %_ZN15DemoApplication20localCreateRigidBodyEfRK11btTransformP16btCollisionShape.exit72 unwind label %bb.af

bb.af:                                            ; preds = %bb.ae
  %i.cz = landingpad { ptr, i32 }
          cleanup
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %i.cy)
...
_ZN15DemoApplication20localCreateRigidBodyEfRK11btTransformP16btCollisionShape.exit72: ; preds = %bb.ae
  ...
  store float 1.000000e+00, ptr %i.dc, align 8
  %.sroa.7.0..sroa_idx80 = getelementptr inbounds nuw i8, ptr %i.cy, i64 12
  %.sroa.11.16..sroa_idx85 = getelementptr inbounds nuw i8, ptr %i.cy, i64 28
  ...
  %.sroa.12.16..sroa_idx88 = getelementptr inbounds nuw i8, ptr %i.cy, i64 32
  %.sroa.16.32..sroa_idx93 = getelementptr inbounds nuw i8, ptr %i.cy, i64 48
  ...
  %.sroa.17.32..sroa_idx96 = getelementptr inbounds nuw i8, ptr %i.cy, i64 52
  store i32 0, ptr %.sroa.17.32..sroa_idx96, align 4, !tbaa !60
  %i.dd = getelementptr inbounds nuw i8, ptr %i.cy, i64 56
  store <2 x float> %i.t, ptr %i.dd, align 8
  %.sroa.17.sroa.11.4..sroa_idx121 = getelementptr inbounds nuw i8, ptr %i.cy, i64 64
  ...
  %i.df = load ptr, ptr %i.de, align 8, !tbaa !12
  %i.dg = getelementptr inbounds nuw i8, ptr %i.df, i64 136
  %i.dh = load ptr, ptr %i.dg, align 8
  call void %i.dh(ptr noundef nonnull align 8 dereferenceable(228) %i.de, ptr noundef nonnull %i.cy), !inline_history !75
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #21
  br label %bb.ai
...
bb.ah:                                            ; preds = %bb.ab
  %i.di = landingpad { ptr, i32 }
          cleanup
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %i.cs)
          to label %common.resume unwind label %bb.aj
...
bb.ai:                                            ; preds = %_ZN15DemoApplication20localCreateRigidBodyEfRK11btTransformP16btCollisionShape.exit72, %_ZN15DemoApplication20localCreateRigidBodyEfRK11btTransformP16btCollisionShape.exit69, %_ZN15DemoApplication20localCreateRigidBodyEfRK11btTransformP16btCollisionShape.exit, %bb.f
  %i.dj = add nuw nsw i32 %.054168, 1             ; 2 uses
  %exitcond.not = icmp eq i32 %i.dj, 10
...
bb.aj:                                            ; preds = %bb.ah, %bb.aa, %.body
  ...
  call void @__clang_call_terminate(ptr %i.dl) #23
  unreachable
}
...
bb.i:                                             ; preds = %bb.g, %_ZN15DemoApplication20localCreateRigidBodyEfRK11btTransformP16btCollisionShape.exit
  %.082 = phi i32 [ 0, %bb.g ], [ %i.ar, %_ZN15DemoApplication20localCreateRigidBodyEfRK11btTransformP16btCollisionShape.exit ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %1) #21
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %1, i8 0, i64 16, i1 false)
...
_ZN15DemoApplication20localCreateRigidBodyEfRK11btTransformP16btCollisionShape.exit: ; preds = %bb.i
  ...
  store <2 x float> %i.ak, ptr %i.am, align 8
  ...
  %i.an = load ptr, ptr %i.g, align 8, !tbaa !8   ; 2 uses
  %i.ao = load ptr, ptr %i.an, align 8, !tbaa !12
  %i.ap = getelementptr inbounds nuw i8, ptr %i.ao, i64 136
  %i.aq = load ptr, ptr %i.ap, align 8
  call void %i.aq(ptr noundef nonnull align 8 dereferenceable(228) %i.an, ptr noundef nonnull %i.ac), !inline_history !75
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #21
  %i.ar = add nuw nsw i32 %.082, 1                ; 2 uses
  %exitcond90.not = icmp eq i32 %i.ar, 10
