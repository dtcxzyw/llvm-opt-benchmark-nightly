...
bb.b:                                             ; preds = %bb.a
  ...
  %8 = load ptr, ptr %i.d, align 8, !tbaa !34
  invoke void @_ZN21btCollisionDispatcherC1EP24btCollisionConfiguration(ptr noundef nonnull align 8 dereferenceable(10632) %i.e, ptr noundef %8)
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.j = call noalias noundef nonnull dereferenceable(240) ptr @_Znwm(i64 noundef 240) #20 ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %9 = load ptr, ptr %i.k, align 8, !tbaa !39
  %i.o = load ptr, ptr %i.d, align 8, !tbaa !34
  invoke void @_ZN23btDiscreteDynamicsWorldC1EP12btDispatcherP21btBroadphaseInterfaceP18btConstraintSolverP24btCollisionConfiguration(ptr noundef nonnull align 8 dereferenceable(372) %i.l, ptr noundef %i.m, ptr noundef %i.n, ptr noundef %9, ptr noundef %i.o)
