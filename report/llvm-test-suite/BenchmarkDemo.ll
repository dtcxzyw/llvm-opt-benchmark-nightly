...
bb.j:                                             ; preds = %.preheader.us, %_ZN15DemoApplication20localCreateRigidBodyEfRK11btTransformP16btCollisionShape.exit.us
  ...
  %i.bb = phi <4 x float> [ %i.ba, %.preheader.us ], [ %i.ej, %_ZN15DemoApplication20localCreateRigidBodyEfRK11btTransformP16btCollisionShape.exit.us ] ; 7 uses
...
_ZN15DemoApplication20localCreateRigidBodyEfRK11btTransformP16btCollisionShape.exit.us: ; preds = %bb.j
  ...
  %13 = call noundef float @cosf(float noundef %i.av) #21, !tbaa !4
  %14 = insertelement <2 x float> poison, float %i.dz, i64 0
  %15 = shufflevector <2 x float> %14, <2 x float> poison, <2 x i32> zeroinitializer
  %16 = fmul <2 x float> %15, <float 1.000000e+00, float 0.000000e+00> ; 3 uses
  %17 = shufflevector <2 x float> %16, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 0, i32 1>
  ...
  %i.ed = insertelement <4 x float> %i.ec, float %13, i64 1 ; 2 uses
  ...
  %19 = shufflevector <2 x float> %16, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1> ; 2 uses
  %20 = shufflevector <4 x float> %19, <4 x float> %i.ed, <4 x i32> <i32 1, i32 5, i32 1, i32 poison>
  %i.eh = insertelement <4 x float> %20, float %i.dz, i64 3
  %21 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.eg, <4 x float> %i.eh, <4 x float> %i.ef)
  %22 = shufflevector <4 x float> %i.bb, <4 x float> poison, <4 x i32> <i32 3, i32 poison, i32 0, i32 2>
  %23 = insertelement <4 x float> %22, float %10, i64 1
  %i.ei = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %23, <4 x float> %17, <4 x float> %21)
  %24 = insertelement <4 x float> poison, float %9, i64 0
  %25 = insertelement <4 x float> %24, float %10, i64 2
  %26 = insertelement <4 x float> %25, float %7, i64 3
  %27 = shufflevector <4 x float> %26, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
  %i.ej = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %27, <4 x float> %19, <4 x float> %i.ei) ; 5 uses
...
._crit_edge.us:                                   ; preds = %_ZN15DemoApplication20localCreateRigidBodyEfRK11btTransformP16btCollisionShape.exit.us
  ...
  %i.eq = call noundef float @sinf(float noundef %i.ax) #21, !tbaa !4 ; 2 uses
  %i.er = call noundef float @cosf(float noundef %i.ax) #21, !tbaa !4
  %i.es = insertelement <2 x float> poison, float %i.eq, i64 0 ; 2 uses
  %i.et = shufflevector <2 x float> %i.es, <2 x float> poison, <2 x i32> zeroinitializer
  %i.eu = fmul <2 x float> %i.et, <float 0.000000e+00, float 1.000000e+00> ; 4 uses
  %i.ev = shufflevector <2 x float> %i.eu, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 0, i32 0>
  %28 = extractelement <2 x float> %i.eu, i64 0
  %29 = fneg float %28
  %30 = shufflevector <4 x float> %i.ej, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
  %31 = insertelement <4 x float> poison, float %29, i64 0
  %32 = insertelement <4 x float> %31, float %i.er, i64 1 ; 2 uses
  %33 = shufflevector <4 x float> %32, <4 x float> poison, <4 x i32> <i32 1, i32 0, i32 1, i32 1>
  %i.ew = fmul <4 x float> %30, %33
  %i.ex = shufflevector <4 x float> %i.ej, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %34 = shufflevector <2 x float> %i.eu, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %35 = shufflevector <4 x float> %34, <4 x float> %32, <4 x i32> <i32 0, i32 5, i32 0, i32 poison>
  %36 = insertelement <4 x float> %35, float %i.eq, i64 3
  %i.ey = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ex, <4 x float> %36, <4 x float> %i.ew)
  %i.ez = shufflevector <4 x float> %i.ej, <4 x float> %i.en, <4 x i32> <i32 3, i32 7, i32 0, i32 2>
  %37 = shufflevector <2 x float> %i.eu, <2 x float> %i.es, <4 x i32> <i32 0, i32 2, i32 2, i32 0>
  %i.fa = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ez, <4 x float> %37, <4 x float> %i.ey)
