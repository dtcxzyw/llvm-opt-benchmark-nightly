...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.w, 4294967288               ; 6 uses
  ...
  %4 = shl nuw nsw i64 %n.vec, 1
  %i.ad = getelementptr i8, ptr %i.i, i64 %4      ; 2 uses
...
vector.ph115:                                     ; preds = %vector.memcheck99
  %n.vec117 = and i64 %i.am, 4294967288           ; 7 uses
  %i.aq = shl nuw nsw i64 %n.vec117, 1
  %i.ar = getelementptr i8, ptr %.04852, i64 %i.aq ; 2 uses
  %.cast118 = trunc nuw i64 %n.vec117 to i32
  %i.as = sub i32 %i.aj, %.cast118
  %4 = shl nuw nsw i64 %n.vec117, 1
  %i.at = getelementptr i8, ptr %i.j, i64 %4      ; 2 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.dt, 4294967288              ; 7 uses
  ...
  %i.ea = getelementptr i8, ptr %i.cq, i64 %5     ; 2 uses
