...
_ZN5ArrayIN10ContextMap1EELi64EEC2Ei.exit:        ; preds = %bb.b, %bb.f
  %i.u = phi ptr [ null, %bb.b ], [ %i.s, %bb.f ]
...
vector.ph71:                                      ; preds = %.lr.ph
  ...
  %broadcast.splat.a = shufflevector <2 x ptr> %broadcast.splatinsert, <2 x ptr> poison, <2 x i32> zeroinitializer ; 4 uses
...
vector.body72:                                    ; preds = %vector.body72, %vector.ph71
  ...
  %i.fh = getelementptr inbounds nuw [8 x i8], ptr %i.bw, i64 %index73 ; 3 uses
  %i.fi = getelementptr inbounds nuw i8, ptr %i.fh, i64 16 ; 2 uses
  store <2 x ptr> %broadcast.splat.a, ptr %i.fh, align 8, !tbaa !8
  store <2 x ptr> %broadcast.splat.a, ptr %i.fi, align 8, !tbaa !8
  %i.fj = getelementptr inbounds nuw [8 x i8], ptr %i.bv, i64 %index73 ; 2 uses
  %i.fk = getelementptr inbounds nuw i8, ptr %i.fj, i64 16
  store <2 x ptr> %broadcast.splat.a, ptr %i.fj, align 8, !tbaa !8
  store <2 x ptr> %broadcast.splat.a, ptr %i.fk, align 8, !tbaa !8
  %wide.load = load <2 x ptr>, ptr %i.fh, align 8, !tbaa !8
  %wide.load74 = load <2 x ptr>, ptr %i.fi, align 8, !tbaa !8
  %3 = getelementptr inbounds nuw i8, <2 x ptr> %wide.load, i64 3
  %4 = getelementptr inbounds nuw i8, <2 x ptr> %wide.load74, i64 3
  %i.fl = getelementptr inbounds nuw [8 x i8], ptr %i.bu, i64 %index73 ; 2 uses
  %i.fm = getelementptr inbounds nuw i8, ptr %i.fl, i64 16
  store <2 x ptr> %3, ptr %i.fl, align 8, !tbaa !8
  store <2 x ptr> %4, ptr %i.fm, align 8, !tbaa !8
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.fw = getelementptr inbounds nuw [8 x i8], ptr %i.bw, i64 %indvars.iv ; 2 uses
