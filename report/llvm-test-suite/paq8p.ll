...
begin_hunk_1_@_Z8wavModelR5Mixer:bb.a
  ...
  %i.od = load i32, ptr @_ZL1S, align 4, !tbaa !4 ; 6 uses
  %.b278 = load i1, ptr @_ZL1D, align 4           ; 3 uses
  %i.oe = select i1 %.b278, i32 12, i32 0         ; 3 uses
...
.lr.ph592.split.preheader:                        ; preds = %.lr.ph592
  %i.oi = add i32 %i.oe, %i.od
  %reass.sub887 = sub i32 %i.oi, %i.mt
  %i.oj = sub i32 %i.ms, %i.od
  %i.ok = and i32 %i.oj, 1
...
.lr.ph592.split.prol.loopexit:                    ; preds = %.lr.ph592.split.prol, %.lr.ph592.split.preheader
  ...
  %i.oo = icmp eq i32 %reass.sub887, 2
