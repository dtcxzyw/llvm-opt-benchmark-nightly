...
.lr.ph:                                           ; preds = %bb.n, %.lr.ph.preheader.new
  ...
  %i.fz = getelementptr inbounds nuw [4 x i8], ptr %i.co, i64 %indvars.iv ; 2 uses
  %i.ga = load float, ptr %i.fz, align 4, !tbaa !12
  %i.gb = fadd float %i.ga, %i.b                  ; 4 uses
  ...
  %i.gf = fcmp olt float %i.ge, %i.gb
  br i1 %i.gf, label %bb.l, label %.lr.ph.1

bb.l:                                             ; preds = %.lr.ph
  store float %i.gb, ptr %.0269, align 4, !tbaa !12
  br label %.lr.ph.1

.lr.ph.1:                                         ; preds = %.lr.ph, %bb.l
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.gg = getelementptr inbounds nuw [4 x i8], ptr %i.co, i64 %indvars.iv.next ; 2 uses
  %i.gh = load float, ptr %i.gg, align 4, !tbaa !12
  %i.gi = fadd float %i.gh, %i.b                  ; 4 uses
  ...
  %i.gm = fcmp olt float %i.gl, %i.gi
  br i1 %i.gm, label %bb.m, label %bb.n

bb.m:                                             ; preds = %.lr.ph.1
  store float %i.gi, ptr %.0269, align 4, !tbaa !12
  br label %bb.n
...
begin_hunk_1_@MSalign11:bb.a
  ...
  %i.gn = getelementptr inbounds nuw [4 x i8], ptr %i.co, i64 %indvars.iv.epil.init ; 2 uses
  %i.go = load float, ptr %i.gn, align 4, !tbaa !12
  %i.gp = fadd float %i.go, %i.b                  ; 4 uses
  ...
  %i.gt = fcmp olt float %i.gs, %i.gp
  br i1 %i.gt, label %bb.o, label %._crit_edge

bb.o:                                             ; preds = %.lr.ph.epil.preheader
  store float %i.gp, ptr %.0269, align 4, !tbaa !12
  br label %._crit_edge
...
begin_hunk_2_@MSalign11:bb.a
  ...
  %i.gy = getelementptr inbounds nuw [4 x i8], ptr %i.cl, i64 %indvars.iv383.epil.init ; 2 uses
  %i.gz = load float, ptr %i.gy, align 4, !tbaa !12
  %i.ha = fadd float %i.gz, %i.b                  ; 4 uses
...
bb.p:                                             ; preds = %.lr.ph332.epil.preheader
  store float %i.ha, ptr %.0270, align 4, !tbaa !12
  br label %.lr.ph335
...
.lr.ph332:                                        ; preds = %bb.s, %.lr.ph332.preheader.new
  ...
  %i.id = getelementptr inbounds nuw [4 x i8], ptr %i.cl, i64 %indvars.iv383 ; 2 uses
  %i.ie = load float, ptr %i.id, align 4, !tbaa !12
  %i.if = fadd float %i.ie, %i.b                  ; 4 uses
  ...
  %i.ii = fcmp olt float %i.ih, %i.if
  br i1 %i.ii, label %bb.q, label %.lr.ph332.1

bb.q:                                             ; preds = %.lr.ph332
  store float %i.if, ptr %.0270, align 4, !tbaa !12
  br label %.lr.ph332.1

.lr.ph332.1:                                      ; preds = %.lr.ph332, %bb.q
  %indvars.iv.next384 = add nuw nsw i64 %indvars.iv383, 1 ; 2 uses
  %i.ij = getelementptr inbounds nuw [4 x i8], ptr %i.cl, i64 %indvars.iv.next384 ; 2 uses
  %i.ik = load float, ptr %i.ij, align 4, !tbaa !12
  %i.il = fadd float %i.ik, %i.b                  ; 4 uses
  ...
  %i.io = fcmp olt float %i.in, %i.il
  br i1 %i.io, label %bb.r, label %bb.s

bb.r:                                             ; preds = %.lr.ph332.1
  store float %i.il, ptr %.0270, align 4, !tbaa !12
  br label %bb.s
...
bb.t:                                             ; preds = %.lr.ph356, %._crit_edge349
  ...
  %.0271352 = phi ptr [ %i.cn, %.lr.ph356 ], [ %.0272351, %._crit_edge349 ] ; 8 uses
...
begin_hunk_5_@MSalign11:bb.a
  ...
  %i.lr = fpext float %i.ln to double             ; 2 uses
  %i.ls = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.lq, ptr noundef nonnull @.str.3, double noundef %i.lr, double noundef %i.lr) #11 ; 0 uses
...
begin_hunk_6_@MSalign11:bb.a
  ...
  %.0256344 = getelementptr inbounds nuw i8, ptr %.0271352.pn, i64 4 ; 4 uses
...
bb.aa:                                            ; preds = %bb.z, %bb.y
  ...
  %i.mv = fadd float %.3263, %i.mu                ; 5 uses
...
bb.ac:                                            ; preds = %bb.ab
  store float %i.mv, ptr %i.lp, align 4, !tbaa !12
  %.pre430 = load float, ptr %.0256344, align 4, !tbaa !12
  br label %bb.ad

bb.ad:                                            ; preds = %bb.ab, %bb.ac
  %i.na = phi float [ %i.mv, %bb.ab ], [ %.pre430, %bb.ac ] ; 2 uses
