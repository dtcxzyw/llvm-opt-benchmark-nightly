...
define internal fastcc void @DivideInternalFPF(ptr noundef captures(none) %0, ptr noundef captures(none) %1, ptr noundef %2) unnamed_addr #3 {
bb.a:
...
bb.k:                                             ; preds = %bb.a, %bb.a, %bb.a, %bb.a
  ...
  %.sroa.3.0.copyload = load i16, ptr %.sroa.3.0..sroa_idx, align 1 ; 2 uses
  %.sroa.6.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 6
  %.sroa.6.0.copyload = load i16, ptr %.sroa.6.0..sroa_idx, align 1 ; 2 uses
  %.sroa.9.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 8
  %.sroa.9.0.copyload = load i16, ptr %.sroa.9.0..sroa_idx, align 1 ; 2 uses
  %.sroa.12.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 10
  %.sroa.12.0.copyload = load i16, ptr %.sroa.12.0..sroa_idx, align 1 ; 2 uses
...
define dso_local i64 @DoEmFloatIteration(ptr noundef captures(none) %0, ptr noundef captures(none) %1, ptr noundef %2, i64 noundef %3, i64 noundef %4) local_unnamed_addr #0 {
bb.a:
...
.preheader.us:                                    ; preds = %bb.a, %..loopexit_crit_edge.us
  %.in = phi i64 [ %i.b, %..loopexit_crit_edge.us ], [ %4, %bb.a ]
  %i.b = add i64 %.in, -1                         ; 2 uses
  br label %bb.b

bb.b:                                             ; preds = %.preheader.us, %MultiplyInternalFPF.exit.us
  %.031.us = phi i64 [ 0, %.preheader.us ], [ %i.fb, %MultiplyInternalFPF.exit.us ] ; 14 uses
  %i.c = and i64 %.031.us, 15
  %i.d = getelementptr inbounds nuw i8, ptr @DoEmFloatIteration.jtable, i64 %i.c
  %i.e = load i8, ptr %i.d, align 1, !tbaa !18
  switch i8 %i.e, label %MultiplyInternalFPF.exit.us [
    i8 0, label %bb.ah
    i8 1, label %bb.ag
    i8 2, label %bb.d
    i8 3, label %bb.c
...
bb.c:                                             ; preds = %bb.b
  %i.f = getelementptr inbounds nuw [12 x i8], ptr %0, i64 %.031.us
  %i.g = getelementptr inbounds nuw [12 x i8], ptr %1, i64 %.031.us
  %i.h = getelementptr inbounds nuw [12 x i8], ptr %2, i64 %.031.us
  tail call fastcc void @DivideInternalFPF(ptr noundef %i.f, ptr noundef %i.g, ptr noundef %i.h)
  br label %MultiplyInternalFPF.exit.us

bb.d:                                             ; preds = %bb.b
  %i.i = getelementptr inbounds nuw [12 x i8], ptr %0, i64 %.031.us ; 20 uses
  %i.j = getelementptr inbounds nuw [12 x i8], ptr %1, i64 %.031.us ; 19 uses
  %i.k = getelementptr inbounds nuw [12 x i8], ptr %2, i64 %.031.us ; 30 uses
  %i.l = load i8, ptr %i.i, align 2, !tbaa !11    ; 2 uses
  %i.m = zext i8 %i.l to i32
  %i.n = mul nuw nsw i32 %i.m, 5
  %i.o = load i8, ptr %i.j, align 2, !tbaa !11
  %i.p = zext i8 %i.o to i32
  %i.q = add nuw nsw i32 %i.n, %i.p
  switch i32 %i.q, label %bb.aa [
    i32 16, label %bb.z
    i32 17, label %bb.z
    i32 18, label %bb.z
    i32 0, label %bb.z
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.t = load i16, ptr %i.r, align 2, !tbaa !14   ; 2 uses
  %i.u = load i16, ptr %i.s, align 2, !tbaa !14   ; 2 uses
  %i.v = icmp ugt i16 %i.t, %i.u
  br i1 %i.v, label %choose_nan.exit.i.us, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.w = icmp ult i16 %i.t, %i.u
  br i1 %i.w, label %choose_nan.exit.i.us, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.x = getelementptr inbounds nuw i8, ptr %i.i, i64 6
  %i.y = load i16, ptr %i.x, align 2, !tbaa !14   ; 2 uses
  %i.z = getelementptr inbounds nuw i8, ptr %i.j, i64 6
  %i.aa = load i16, ptr %i.z, align 2, !tbaa !14  ; 2 uses
  %i.ab = icmp ugt i16 %i.y, %i.aa
  br i1 %i.ab, label %choose_nan.exit.i.us, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.ac = icmp ult i16 %i.y, %i.aa
  br i1 %i.ac, label %choose_nan.exit.i.us, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.ad = getelementptr inbounds nuw i8, ptr %i.i, i64 8
  %i.ae = load i16, ptr %i.ad, align 2, !tbaa !14 ; 2 uses
  %i.af = getelementptr inbounds nuw i8, ptr %i.j, i64 8
  %i.ag = load i16, ptr %i.af, align 2, !tbaa !14 ; 2 uses
  %i.ah = icmp ugt i16 %i.ae, %i.ag
  br i1 %i.ah, label %choose_nan.exit.i.us, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.ai = icmp ult i16 %i.ae, %i.ag
  br i1 %i.ai, label %choose_nan.exit.i.us, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.aj = getelementptr inbounds nuw i8, ptr %i.i, i64 10
  %i.ak = load i16, ptr %i.aj, align 2, !tbaa !14 ; 2 uses
  %i.al = getelementptr inbounds nuw i8, ptr %i.j, i64 10
  %i.am = load i16, ptr %i.al, align 2, !tbaa !14 ; 2 uses
  %i.an = icmp ugt i16 %i.ak, %i.am
  br i1 %i.an, label %choose_nan.exit.i.us, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.ao = icmp ult i16 %i.ak, %i.am
  %spec.select119.i.us = select i1 %i.ao, ptr %i.j, ptr %i.i
  br label %choose_nan.exit.i.us

choose_nan.exit.i.us:                             ; preds = %bb.l, %bb.k, %bb.j, %bb.i, %bb.h, %bb.g, %bb.f, %bb.e
  %.sink.i.i.us = phi ptr [ %i.j, %bb.f ], [ %i.j, %bb.h ], [ %i.i, %bb.e ], [ %i.j, %bb.j ], [ %i.i, %bb.k ], [ %i.i, %bb.i ], [ %i.i, %bb.g ], [ %spec.select119.i.us, %bb.l ]
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(12) %.sink.i.i.us, ptr noundef nonnull readonly align 1 dereferenceable(12) %i.k, i64 12, i1 false)
  br label %bb.aa

bb.m:                                             ; preds = %bb.d, %bb.d, %bb.d, %bb.d
  %.sroa.3.0..sroa_idx.i.us = getelementptr inbounds nuw i8, ptr %i.j, i64 4
  %.sroa.3.0.copyload.i.us = load i16, ptr %.sroa.3.0..sroa_idx.i.us, align 1 ; 2 uses
  %.sroa.5.0..sroa_idx.i.us = getelementptr inbounds nuw i8, ptr %i.j, i64 6
  %.sroa.5.0.copyload.i.us = load i16, ptr %.sroa.5.0..sroa_idx.i.us, align 1 ; 2 uses
  %.sroa.7.0..sroa_idx.i.us = getelementptr inbounds nuw i8, ptr %i.j, i64 8
  %.sroa.7.0.copyload.i.us = load i16, ptr %.sroa.7.0..sroa_idx.i.us, align 1 ; 2 uses
  %.sroa.9.0..sroa_idx.i.us = getelementptr inbounds nuw i8, ptr %i.j, i64 10
  %.sroa.9.0.copyload.i.us = load i16, ptr %.sroa.9.0..sroa_idx.i.us, align 1 ; 2 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %i.i, i64 4 ; 2 uses
...
bb.n:                                             ; preds = %bb.m
  %i.at = or i16 %.sroa.5.0.copyload.i.us, %.sroa.3.0.copyload.i.us
  %i.au = or i16 %i.at, %.sroa.7.0.copyload.i.us
  %i.av = or i16 %i.au, %.sroa.9.0.copyload.i.us
  %.not.i56.not.i.us = icmp eq i16 %i.av, 0
  br i1 %.not.i56.not.i.us, label %bb.o, label %bb.p

bb.o:                                             ; preds = %bb.n, %bb.m
  store i8 3, ptr %i.k, align 2, !tbaa !11
  %i.aw = getelementptr inbounds nuw i8, ptr %i.k, i64 1
  store i8 0, ptr %i.aw, align 1, !tbaa !8
  %i.ax = getelementptr inbounds nuw i8, ptr %i.k, i64 2
  store i16 -32767, ptr %i.ax, align 2, !tbaa !15
  %i.ay = getelementptr inbounds nuw i8, ptr %i.k, i64 4
  store i64 0, ptr %i.ay, align 2
  %.pre.i.us = load i8, ptr %i.i, align 2, !tbaa !11
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %bb.n
  %i.az = phi i8 [ %.pre.i.us, %bb.o ], [ %i.l, %bb.n ]
  %i.ba = icmp eq i8 %i.az, 1
  br i1 %i.ba, label %.preheader121.i.us, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.bb = load i8, ptr %i.j, align 2, !tbaa !11
  %i.bc = icmp eq i8 %i.bb, 1
  %spec.select.i.us = select i1 %i.bc, i8 1, i8 2
  br label %.preheader121.i.us

.preheader121.i.us:                               ; preds = %bb.q, %bb.p
  %storemerge.i.us = phi i8 [ 1, %bb.p ], [ %spec.select.i.us, %bb.q ]
  store i8 %storemerge.i.us, ptr %i.k, align 2, !tbaa !11
  %i.bd = getelementptr inbounds nuw i8, ptr %i.i, i64 1
  %i.be = load i8, ptr %i.bd, align 1, !tbaa !8
  %i.bf = getelementptr inbounds nuw i8, ptr %i.j, i64 1
  %i.bg = load i8, ptr %i.bf, align 1, !tbaa !8
  %i.bh = xor i8 %i.bg, %i.be
  %i.bi = getelementptr inbounds nuw i8, ptr %i.k, i64 1
  store i8 %i.bh, ptr %i.bi, align 1, !tbaa !8
  %i.bj = getelementptr inbounds nuw i8, ptr %i.i, i64 2
  %i.bk = load i16, ptr %i.bj, align 2, !tbaa !15
  %i.bl = getelementptr inbounds nuw i8, ptr %i.j, i64 2
  %i.bm = load i16, ptr %i.bl, align 2, !tbaa !15
  %i.bn = add i16 %i.bm, %i.bk                    ; 2 uses
  %i.bo = getelementptr inbounds nuw i8, ptr %i.k, i64 2 ; 2 uses
  store i16 %i.bn, ptr %i.bo, align 2, !tbaa !15
  %i.bp = getelementptr inbounds nuw i8, ptr %i.k, i64 4 ; 3 uses
  store i64 0, ptr %i.bp, align 2
  %i.bq = getelementptr inbounds nuw i8, ptr %i.k, i64 6 ; 3 uses
  %i.br = getelementptr inbounds nuw i8, ptr %i.k, i64 8 ; 3 uses
  %i.bs = getelementptr inbounds nuw i8, ptr %i.k, i64 10 ; 4 uses
  br label %bb.r

bb.r:                                             ; preds = %bb.s, %.preheader121.i.us
  %i.bt = phi i16 [ 0, %.preheader121.i.us ], [ %.promoted141.i.us, %bb.s ] ; 3 uses
  %i.bu = phi i16 [ 0, %.preheader121.i.us ], [ %spec.select.1.i61.i.us, %bb.s ] ; 2 uses
  %i.bv = phi i16 [ 0, %.preheader121.i.us ], [ %spec.select.2.i63.i.us, %bb.s ] ; 2 uses
  %i.bw = phi i16 [ 0, %.preheader121.i.us ], [ %spec.select.3.i65.i.us, %bb.s ] ; 2 uses
  %.1140.i.us = phi i32 [ 0, %.preheader121.i.us ], [ %i.di, %bb.s ]
  %.sroa.3.0139.i.us = phi i16 [ %.sroa.3.0.copyload.i.us, %.preheader121.i.us ], [ %i.bx, %bb.s ] ; 2 uses
  %.sroa.5.0138.i.us = phi i16 [ %.sroa.5.0.copyload.i.us, %.preheader121.i.us ], [ %spec.select.1.i.i.us, %bb.s ] ; 2 uses
  %.sroa.7.0137.i.us = phi i16 [ %.sroa.7.0.copyload.i.us, %.preheader121.i.us ], [ %spec.select.2.i.i.us, %bb.s ] ; 2 uses
  %.sroa.9.0136.i.us = phi i16 [ %.sroa.9.0.copyload.i.us, %.preheader121.i.us ], [ %spec.select.3.i.i.us, %bb.s ] ; 2 uses
  %spec.select.i67125135.i.us = phi i16 [ 0, %.preheader121.i.us ], [ %spec.select.i67.i.us, %bb.s ] ; 2 uses
  %spec.select.1.i69127134.i.us = phi i16 [ 0, %.preheader121.i.us ], [ %spec.select.1.i69.i.us, %bb.s ] ; 2 uses
  %spec.select.2.i71129133.i.us = phi i16 [ 0, %.preheader121.i.us ], [ %spec.select.2.i71.i.us, %bb.s ] ; 2 uses
  %spec.select.3.i73131132.i.us = phi i16 [ 0, %.preheader121.i.us ], [ %spec.select.3.i73.i.us, %bb.s ]
  %i.bx = lshr i16 %.sroa.3.0139.i.us, 1
  %spec.select.1.i.i.us = tail call i16 @llvm.fshl.i16(i16 %.sroa.3.0139.i.us, i16 %.sroa.5.0138.i.us, i16 15)
  %spec.select.2.i.i.us = tail call i16 @llvm.fshl.i16(i16 %.sroa.5.0138.i.us, i16 %.sroa.7.0137.i.us, i16 15)
  %i.by = and i16 %.sroa.9.0136.i.us, 1
  %spec.select.3.i.i.us = tail call i16 @llvm.fshl.i16(i16 %.sroa.7.0137.i.us, i16 %.sroa.9.0136.i.us, i16 15)
  %.not55.i.us = icmp eq i16 %i.by, 0
  br i1 %.not55.i.us, label %.thread.i.us, label %.preheader120.preheader.i.us

.preheader120.preheader.i.us:                     ; preds = %bb.r
  %i.bz = load i16, ptr %i.as, align 2, !tbaa !14
  %i.ca = zext i16 %i.bw to i32
  %i.cb = zext i16 %i.bz to i32
  %i.cc = add nuw nsw i32 %i.cb, %i.ca
  %.fr.i.us = freeze i32 %i.cc                    ; 2 uses
  %i.cd = lshr i32 %.fr.i.us, 16
  %i.ce = and i32 %i.cd, 1
  %i.cf = trunc i32 %.fr.i.us to i16              ; 2 uses
  store i16 %i.cf, ptr %i.bs, align 2, !tbaa !14
  %i.cg = load i16, ptr %i.ar, align 2, !tbaa !14
  %i.ch = zext i16 %i.bv to i32
  %i.ci = zext i16 %i.cg to i32
  %i.cj = add nuw nsw i32 %i.ci, %i.ch
  %.fr = freeze i32 %i.cj
  %i.ck = add i32 %.fr, %i.ce                     ; 2 uses
  %i.cl = lshr i32 %i.ck, 16
  %i.cm = and i32 %i.cl, 1
  %i.cn = trunc i32 %i.ck to i16                  ; 2 uses
  store i16 %i.cn, ptr %i.br, align 2, !tbaa !14
  %i.co = load i16, ptr %i.aq, align 2, !tbaa !14
  %i.cp = zext i16 %i.bu to i32
  %i.cq = zext i16 %i.co to i32
  %i.cr = add nuw nsw i32 %i.cq, %i.cp
  %.fr34 = freeze i32 %i.cr
  %i.cs = add i32 %.fr34, %i.cm                   ; 2 uses
  %i.ct = lshr i32 %i.cs, 16
  %i.cu = and i32 %i.ct, 1
  %i.cv = trunc i32 %i.cs to i16                  ; 2 uses
  store i16 %i.cv, ptr %i.bq, align 2, !tbaa !14
  %i.cw = load i16, ptr %i.ap, align 2, !tbaa !14
  %i.cx = zext i16 %i.bt to i32
  %i.cy = zext i16 %i.cw to i32
  %i.cz = add nuw nsw i32 %i.cy, %i.cx
  %i.da = add nuw nsw i32 %i.cz, %i.cu
  %.fr.3.i.us = freeze i32 %i.da                  ; 2 uses
  %i.db = lshr i32 %.fr.3.i.us, 16
  %i.dc = trunc nuw i32 %i.db to i16
  %i.dd = trunc i32 %.fr.3.i.us to i16            ; 2 uses
  %spec.select118.i.us = tail call i16 @llvm.fshl.i16(i16 %i.dc, i16 %i.dd, i16 15)
  br label %bb.s

.thread.i.us:                                     ; preds = %bb.r
  %i.de = lshr i16 %i.bt, 1
  br label %bb.s

bb.s:                                             ; preds = %.thread.i.us, %.preheader120.preheader.i.us
  %i.df = phi i16 [ %i.cf, %.preheader120.preheader.i.us ], [ %i.bw, %.thread.i.us ] ; 2 uses
  %i.dg = phi i16 [ %i.cn, %.preheader120.preheader.i.us ], [ %i.bv, %.thread.i.us ] ; 2 uses
  %i.dh = phi i16 [ %i.cv, %.preheader120.preheader.i.us ], [ %i.bu, %.thread.i.us ] ; 2 uses
  %.in.i.us = phi i16 [ %i.dd, %.preheader120.preheader.i.us ], [ %i.bt, %.thread.i.us ]
  %.promoted141.i.us = phi i16 [ %spec.select118.i.us, %.preheader120.preheader.i.us ], [ %i.de, %.thread.i.us ] ; 4 uses
  store i16 %.promoted141.i.us, ptr %i.bp, align 2, !tbaa !14
  %spec.select.1.i61.i.us = tail call i16 @llvm.fshl.i16(i16 %.in.i.us, i16 %i.dh, i16 15) ; 3 uses
  store i16 %spec.select.1.i61.i.us, ptr %i.bq, align 2, !tbaa !14
  %spec.select.2.i63.i.us = tail call i16 @llvm.fshl.i16(i16 %i.dh, i16 %i.dg, i16 15) ; 3 uses
  store i16 %spec.select.2.i63.i.us, ptr %i.br, align 2, !tbaa !14
  %spec.select.3.i65.i.us = tail call i16 @llvm.fshl.i16(i16 %i.dg, i16 %i.df, i16 15) ; 4 uses
  store i16 %spec.select.3.i65.i.us, ptr %i.bs, align 2, !tbaa !14
  %spec.select.i67.i.us = tail call i16 @llvm.fshl.i16(i16 %i.df, i16 %spec.select.i67125135.i.us, i16 15) ; 3 uses
  %spec.select.1.i69.i.us = tail call i16 @llvm.fshl.i16(i16 %spec.select.i67125135.i.us, i16 %spec.select.1.i69127134.i.us, i16 15) ; 3 uses
  %spec.select.2.i71.i.us = tail call i16 @llvm.fshl.i16(i16 %spec.select.1.i69127134.i.us, i16 %spec.select.2.i71129133.i.us, i16 15) ; 3 uses
  %spec.select.3.i73.i.us = tail call i16 @llvm.fshl.i16(i16 %spec.select.2.i71129133.i.us, i16 %spec.select.3.i73131132.i.us, i16 15) ; 3 uses
  %i.di = add nuw nsw i32 %.1140.i.us, 1          ; 2 uses
  %exitcond.not.i.us = icmp eq i32 %i.di, 64
  br i1 %exitcond.not.i.us, label %.preheader.i.us, label %bb.r, !llvm.loop !19

.preheader.i.us:                                  ; preds = %bb.s
  %i.dj = icmp sgt i16 %.promoted141.i.us, -1
  br i1 %i.dj, label %.lr.ph.i.us, label %bb.t

.lr.ph.i.us:                                      ; preds = %.preheader.i.us, %.lr.ph.i.us
  %i.dk = phi i16 [ %i.dq, %.lr.ph.i.us ], [ %i.bn, %.preheader.i.us ]
  %i.dl = phi i16 [ %spec.select.2.i87.i.us, %.lr.ph.i.us ], [ %spec.select.1.i61.i.us, %.preheader.i.us ] ; 2 uses
  %i.dm = phi i16 [ %spec.select.1.i85.i.us, %.lr.ph.i.us ], [ %spec.select.2.i63.i.us, %.preheader.i.us ] ; 2 uses
  %i.dn = phi i16 [ %spec.select.i83.i.us, %.lr.ph.i.us ], [ %spec.select.3.i65.i.us, %.preheader.i.us ] ; 2 uses
  %spec.select.2.i79151.i.us = phi i16 [ %spec.select.2.i79.i.us, %.lr.ph.i.us ], [ %spec.select.1.i69.i.us, %.preheader.i.us ] ; 2 uses
  %spec.select.1.i77149.i.us = phi i16 [ %spec.select.1.i77.i.us, %.lr.ph.i.us ], [ %spec.select.2.i71.i.us, %.preheader.i.us ] ; 2 uses
  %i.do = phi i16 [ %i.dp, %.lr.ph.i.us ], [ %spec.select.3.i73.i.us, %.preheader.i.us ] ; 2 uses
  %spec.select.3.i89142146.i.us = phi i16 [ %spec.select.3.i89.i.us, %.lr.ph.i.us ], [ %.promoted141.i.us, %.preheader.i.us ]
  %spec.select.3.i81144145.i.us = phi i16 [ %spec.select.3.i81.i.us, %.lr.ph.i.us ], [ %spec.select.i67.i.us, %.preheader.i.us ] ; 2 uses
  %i.dp = shl i16 %i.do, 1                        ; 2 uses
  %spec.select.1.i77.i.us = tail call i16 @llvm.fshl.i16(i16 %spec.select.1.i77149.i.us, i16 %i.do, i16 1) ; 2 uses
  %spec.select.2.i79.i.us = tail call i16 @llvm.fshl.i16(i16 %spec.select.2.i79151.i.us, i16 %spec.select.1.i77149.i.us, i16 1) ; 2 uses
  %spec.select.3.i81.i.us = tail call i16 @llvm.fshl.i16(i16 %spec.select.3.i81144145.i.us, i16 %spec.select.2.i79151.i.us, i16 1) ; 2 uses
  %spec.select.i83.i.us = tail call i16 @llvm.fshl.i16(i16 %i.dn, i16 %spec.select.3.i81144145.i.us, i16 1) ; 3 uses
  %spec.select.1.i85.i.us = tail call i16 @llvm.fshl.i16(i16 %i.dm, i16 %i.dn, i16 1) ; 2 uses
  %spec.select.2.i87.i.us = tail call i16 @llvm.fshl.i16(i16 %i.dl, i16 %i.dm, i16 1) ; 2 uses
  %spec.select.3.i89.i.us = tail call i16 @llvm.fshl.i16(i16 %spec.select.3.i89142146.i.us, i16 %i.dl, i16 1) ; 3 uses
  %i.dq = add i16 %i.dk, -1                       ; 2 uses
  %i.dr = icmp sgt i16 %spec.select.3.i89.i.us, -1
  br i1 %i.dr, label %.lr.ph.i.us, label %._crit_edge.i.us, !llvm.loop !20

._crit_edge.i.us:                                 ; preds = %.lr.ph.i.us
  store i16 %spec.select.i83.i.us, ptr %i.bs, align 2, !tbaa !14
  store i16 %spec.select.1.i85.i.us, ptr %i.br, align 2, !tbaa !14
  store i16 %spec.select.2.i87.i.us, ptr %i.bq, align 2, !tbaa !14
  store i16 %spec.select.3.i89.i.us, ptr %i.bp, align 2, !tbaa !14
  store i16 %i.dq, ptr %i.bo, align 2, !tbaa !15
  br label %bb.t

bb.t:                                             ; preds = %._crit_edge.i.us, %.preheader.i.us
  %i.ds = phi i16 [ %spec.select.i83.i.us, %._crit_edge.i.us ], [ %spec.select.3.i65.i.us, %.preheader.i.us ]
  %.sroa.6.0.i.us = phi i16 [ %spec.select.2.i79.i.us, %._crit_edge.i.us ], [ %spec.select.1.i69.i.us, %.preheader.i.us ]
  %.sroa.11.0.i.us = phi i16 [ %spec.select.1.i77.i.us, %._crit_edge.i.us ], [ %spec.select.2.i71.i.us, %.preheader.i.us ]
  %.sroa.16.0.i.us = phi i16 [ %i.dp, %._crit_edge.i.us ], [ %spec.select.3.i73.i.us, %.preheader.i.us ]
  %spec.select.3.i81144.lcssa.i.us = phi i16 [ %spec.select.3.i81.i.us, %._crit_edge.i.us ], [ %spec.select.i67.i.us, %.preheader.i.us ]
  %i.dt = or i16 %.sroa.11.0.i.us, %.sroa.6.0.i.us
  %i.du = or i16 %i.dt, %.sroa.16.0.i.us
  %i.dv = or i16 %i.du, %spec.select.3.i81144.lcssa.i.us
  %.not.i90.not.i.us = icmp eq i16 %i.dv, 0
  br i1 %.not.i90.not.i.us, label %bb.u, label %bb.aa

bb.u:                                             ; preds = %bb.t
  %i.dw = or i16 %i.ds, 1
  store i16 %i.dw, ptr %i.bs, align 2, !tbaa !14
  br label %bb.aa

bb.v:                                             ; preds = %bb.d, %bb.d, %bb.d, %bb.d
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(12) %i.j, ptr noundef nonnull align 1 dereferenceable(12) %i.k, i64 12, i1 false)
  br label %bb.aa

bb.w:                                             ; preds = %bb.d, %bb.d, %bb.d, %bb.d
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(12) %i.i, ptr noundef nonnull align 1 dereferenceable(12) %i.k, i64 12, i1 false)
  br label %bb.aa

bb.x:                                             ; preds = %bb.d, %bb.d
  store i8 4, ptr %i.k, align 2, !tbaa !11
  %i.dx = getelementptr inbounds nuw i8, ptr %i.k, i64 2
  store i16 32767, ptr %i.dx, align 2, !tbaa !15
  %i.dy = getelementptr inbounds nuw i8, ptr %i.k, i64 1
  store i8 1, ptr %i.dy, align 1, !tbaa !8
  %i.dz = getelementptr inbounds nuw i8, ptr %i.k, i64 4
  store i16 16384, ptr %i.dz, align 2, !tbaa !14
  %scevgep.i.i.us = getelementptr nuw i8, ptr %i.k, i64 6
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 2 dereferenceable(6) %scevgep.i.i.us, i8 0, i64 6, i1 false), !tbaa !14
  br label %bb.aa

bb.y:                                             ; preds = %bb.d, %bb.d, %bb.d, %bb.d
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(12) %i.j, ptr noundef nonnull align 1 dereferenceable(12) %i.k, i64 12, i1 false)
  %i.ea = getelementptr inbounds nuw i8, ptr %i.i, i64 1
  %i.eb = load i8, ptr %i.ea, align 1, !tbaa !8
  %i.ec = getelementptr inbounds nuw i8, ptr %i.k, i64 1 ; 2 uses
  %i.ed = load i8, ptr %i.ec, align 1, !tbaa !8
  %i.ee = xor i8 %i.ed, %i.eb
  store i8 %i.ee, ptr %i.ec, align 1, !tbaa !8
  br label %bb.aa

bb.z:                                             ; preds = %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(12) %i.i, ptr noundef nonnull align 1 dereferenceable(12) %i.k, i64 12, i1 false)
  %i.ef = getelementptr inbounds nuw i8, ptr %i.j, i64 1
  %i.eg = load i8, ptr %i.ef, align 1, !tbaa !8
  %i.eh = getelementptr inbounds nuw i8, ptr %i.k, i64 1 ; 2 uses
  %i.ei = load i8, ptr %i.eh, align 1, !tbaa !8
  %i.ej = xor i8 %i.ei, %i.eg
  store i8 %i.ej, ptr %i.eh, align 1, !tbaa !8
  br label %bb.aa

bb.aa:                                            ; preds = %bb.z, %bb.y, %bb.x, %bb.w, %bb.v, %bb.u, %bb.t, %choose_nan.exit.i.us, %bb.d
  %i.ek = load i8, ptr %i.k, align 2, !tbaa !11   ; 2 uses
  %.off.i.i.us = add i8 %i.ek, -1
  %switch.i.i.us = icmp ult i8 %.off.i.i.us, 2
  br i1 %switch.i.i.us, label %bb.ab, label %MultiplyInternalFPF.exit.us

bb.ab:                                            ; preds = %bb.aa
  %i.el = getelementptr inbounds nuw i8, ptr %i.k, i64 4 ; 3 uses
...
bb.ac:                                            ; preds = %bb.ab
  %puts.i.i.i.us = tail call i32 @puts(ptr nonnull dereferenceable(1) @str) ; 0 uses
  %.pr.pre.pre.i.i.us = load i8, ptr %i.k, align 2, !tbaa !11
  br label %bb.ad

bb.ad:                                            ; preds = %bb.ac, %bb.ab
  %.pr.pre.i.i.us = phi i8 [ %.pr.pre.pre.i.i.us, %bb.ac ], [ %i.ek, %bb.ab ] ; 2 uses
  %i.ep = getelementptr inbounds nuw i8, ptr %i.k, i64 2 ; 2 uses
  %i.eq = load i16, ptr %i.ep, align 2, !tbaa !15
  %i.er = icmp eq i16 %i.eq, -32768
  br i1 %i.er, label %bb.ae, label %denormalize.exit.i.i.us

denormalize.exit.i.i.us:                          ; preds = %bb.ad
  %.not.i91.i.us = icmp eq i8 %.pr.pre.i.i.us, 0
  br i1 %.not.i91.i.us, label %MultiplyInternalFPF.exit.us, label %denormalize.exit.i._crit_edge.i.us

denormalize.exit.i._crit_edge.i.us:               ; preds = %denormalize.exit.i.i.us
  %.pre167.i.us = load i16, ptr %i.eo, align 2, !tbaa !14
  br label %bb.af

bb.ae:                                            ; preds = %bb.ad
  store i16 -32767, ptr %i.ep, align 2, !tbaa !15
  %.not.i12.i.i.i.us = icmp eq i8 %.pr.pre.i.i.us, 0
  br i1 %.not.i12.i.i.i.us, label %MultiplyInternalFPF.exit.us, label %denormalize.exit.thread7.i.i.us

denormalize.exit.thread7.i.i.us:                  ; preds = %bb.ae
  %.promoted.i.i.i.i.us = load i16, ptr %i.el, align 2, !tbaa !14 ; 2 uses
  %.promoted20.i.i.i.i.us = load i16, ptr %i.em, align 2, !tbaa !14 ; 2 uses
  %.promoted21.i.i.i.i.us = load i16, ptr %i.en, align 2, !tbaa !14 ; 2 uses
  %.promoted22.i.i.i.i.us = load i16, ptr %i.eo, align 2, !tbaa !14
  %spec.select.1.i.i.i.i.i.us = tail call i16 @llvm.fshl.i16(i16 %.promoted.i.i.i.i.us, i16 %.promoted20.i.i.i.i.us, i16 15)
  %spec.select.2.i.i.i.i.i.us = tail call i16 @llvm.fshl.i16(i16 %.promoted20.i.i.i.i.us, i16 %.promoted21.i.i.i.i.us, i16 15)
  %spec.select.3.i.i.i.i.i.us = tail call i16 @llvm.fshl.i16(i16 %.promoted21.i.i.i.i.us, i16 %.promoted22.i.i.i.i.us, i16 15)
  %i.es = lshr i16 %.promoted.i.i.i.i.us, 1
  store i16 %i.es, ptr %i.el, align 2, !tbaa !14
  store i16 %spec.select.1.i.i.i.i.i.us, ptr %i.em, align 2, !tbaa !14
  store i16 %spec.select.2.i.i.i.i.i.us, ptr %i.en, align 2, !tbaa !14
  br label %bb.af

bb.af:                                            ; preds = %denormalize.exit.thread7.i.i.us, %denormalize.exit.i._crit_edge.i.us
  %i.et = phi i16 [ %.pre167.i.us, %denormalize.exit.i._crit_edge.i.us ], [ %spec.select.3.i.i.i.i.i.us, %denormalize.exit.thread7.i.i.us ]
  %i.eu = and i16 %i.et, -8
  store i16 %i.eu, ptr %i.eo, align 2, !tbaa !14
  br label %MultiplyInternalFPF.exit.us

bb.ag:                                            ; preds = %bb.b
  %i.ev = getelementptr inbounds nuw [12 x i8], ptr %0, i64 %.031.us
  %i.ew = getelementptr inbounds nuw [12 x i8], ptr %1, i64 %.031.us
  %i.ex = getelementptr inbounds nuw [12 x i8], ptr %2, i64 %.031.us
  tail call fastcc void @AddSubInternalFPF(i8 noundef zeroext 1, ptr noundef %i.ev, ptr noundef %i.ew, ptr noundef %i.ex)
  br label %MultiplyInternalFPF.exit.us

bb.ah:                                            ; preds = %bb.b
  %i.ey = getelementptr inbounds nuw [12 x i8], ptr %0, i64 %.031.us
  %i.ez = getelementptr inbounds nuw [12 x i8], ptr %1, i64 %.031.us
  %i.fa = getelementptr inbounds nuw [12 x i8], ptr %2, i64 %.031.us
  tail call fastcc void @AddSubInternalFPF(i8 noundef zeroext 0, ptr noundef %i.ey, ptr noundef %i.ez, ptr noundef %i.fa)
  br label %MultiplyInternalFPF.exit.us

MultiplyInternalFPF.exit.us:                      ; preds = %bb.ah, %bb.ag, %bb.af, %bb.ae, %denormalize.exit.i.i.us, %bb.aa, %bb.c, %bb.b
  %i.fb = add nuw i64 %.031.us, 1                 ; 2 uses
  %exitcond.not = icmp eq i64 %i.fb, %3
  br i1 %exitcond.not, label %..loopexit_crit_edge.us, label %bb.b, !llvm.loop !21

..loopexit_crit_edge.us:                          ; preds = %MultiplyInternalFPF.exit.us
  %.not.us = icmp eq i64 %i.b, 0
  br i1 %.not.us, label %._crit_edge, label %.preheader.us, !llvm.loop !22

._crit_edge:                                      ; preds = %..loopexit_crit_edge.us, %bb.a
  %i.fc = tail call i64 @StopStopwatch(i64 noundef %i.a) #9
  ret i64 %i.fc
}
...
; Function Attrs: nofree nounwind uwtable
define internal fastcc void @AddSubInternalFPF(i8 noundef zeroext range(i8 0, 2) %0, ptr noundef captures(none) %1, ptr noundef captures(none) %2, ptr noundef captures(none) %3) unnamed_addr #3 {
bb.a:
...
bb.g:                                             ; preds = %bb.a, %bb.a, %bb.a, %bb.a
  ...
  %.sroa.10149.0.copyload = load i16, ptr %.sroa.10149.0..sroa_idx, align 1 ; 4 uses
  %.sroa.11.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 4
  %.sroa.11.0.copyload = load i16, ptr %.sroa.11.0..sroa_idx, align 1 ; 5 uses
  %.sroa.16.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 6
  %.sroa.16.0.copyload = load i16, ptr %.sroa.16.0..sroa_idx, align 1 ; 5 uses
  %.sroa.20.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 8
  %.sroa.20.0.copyload = load i16, ptr %.sroa.20.0..sroa_idx, align 1 ; 5 uses
  %.sroa.24.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 10
  %.sroa.24.0.copyload = load i16, ptr %.sroa.24.0..sroa_idx, align 1 ; 5 uses
  ...
  %.sroa.9.0.copyload = load i16, ptr %.sroa.9.0..sroa_idx, align 1 ; 3 uses
  %.sroa.10.0..sroa_idx = getelementptr inbounds nuw i8, ptr %2, i64 4
  %.sroa.10.0.copyload = load i16, ptr %.sroa.10.0..sroa_idx, align 1 ; 5 uses
  %.sroa.15.0..sroa_idx = getelementptr inbounds nuw i8, ptr %2, i64 6
  %.sroa.15.0.copyload = load i16, ptr %.sroa.15.0..sroa_idx, align 1 ; 5 uses
  %.sroa.19.0..sroa_idx = getelementptr inbounds nuw i8, ptr %2, i64 8
  %.sroa.19.0.copyload = load i16, ptr %.sroa.19.0..sroa_idx, align 1 ; 5 uses
  %.sroa.23.0..sroa_idx = getelementptr inbounds nuw i8, ptr %2, i64 10
  %.sroa.23.0.copyload = load i16, ptr %.sroa.23.0..sroa_idx, align 1 ; 5 uses
...
; Function Attrs: nofree nounwind uwtable
define dso_local void @RoundInternalFPF(ptr noundef captures(none) %0) local_unnamed_addr #3 {
bb.a:
  %i.a = load i8, ptr %0, align 2, !tbaa !11      ; 2 uses
  %.off = add i8 %i.a, -1
...
define internal fastcc void @normalize(ptr noundef captures(none) %0) unnamed_addr #4 {
bb.a:
