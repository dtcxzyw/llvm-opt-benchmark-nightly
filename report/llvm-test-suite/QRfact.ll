...
.lr.ph166:                                        ; preds = %.lr.ph166.preheader, %bb.k
  ...
  %smin = tail call i64 @llvm.smin.i64(i64 %i.lc, i64 %i.je)
  %smax192 = tail call i64 @llvm.smax.i64(i64 %i.jo, i64 %smin)
  %smax193 = tail call i64 @llvm.smax.i64(i64 %smax192, i64 %indvars.iv174)
  %i.ld = shl i64 %smax193, 3                     ; 2 uses
  %smax178 = tail call i64 @llvm.smax.i64(i64 %indvars.iv174, i64 %i.jo) ; 8 uses
  %i.le = fcmp oeq double %.0132164, 0.000000e+00
  br i1 %i.le, label %Givens.exit, label %bb.f

bb.f:                                             ; preds = %.lr.ph166
  %i.lf = tail call double @llvm.fabs.f64(double %.0132164)
  %i.lg = tail call double @llvm.fabs.f64(double %.0134163)
  %i.lh = fcmp ogt double %i.lf, %i.lg
  br i1 %i.lh, label %bb.g, label %bb.h

bb.g:                                             ; preds = %bb.f
  %i.li = fneg double %.0134163
  %i.lj = fdiv double %i.li, %.0132164            ; 3 uses
  %i.lk = tail call double @llvm.fmuladd.f64(double %i.lj, double %i.lj, double 1.000000e+00)
  %sqrt.i = tail call double @llvm.sqrt.f64(double %i.lk)
  %i.ll = fdiv double 1.000000e+00, %sqrt.i       ; 3 uses
  %i.lm = fmul double %i.lj, %i.ll                ; 2 uses
...
bb.h:                                             ; preds = %bb.f
  %i.lp = fneg double %.0132164
  %i.lq = fdiv double %i.lp, %.0134163            ; 3 uses
  ...
  %i.ls = fdiv double 1.000000e+00, %sqrt21.i     ; 3 uses
  %i.lt = fmul double %i.lq, %i.ls                ; 2 uses
  %i.lu = insertelement <2 x double> poison, double %i.lt, i64 0
  %i.lv = insertelement <2 x double> %i.lu, double %i.ls, i64 1
  br label %Givens.exit

Givens.exit:                                      ; preds = %.lr.ph166, %bb.g, %bb.h
  %.0149 = phi double [ %i.ls, %bb.h ], [ %i.lm, %bb.g ], [ 1.000000e+00, %.lr.ph166 ] ; 3 uses
  %.0148 = phi double [ %i.lt, %bb.h ], [ %i.ll, %bb.g ], [ 0.000000e+00, %.lr.ph166 ] ; 3 uses
  %i.lw = phi <2 x double> [ %i.lv, %bb.h ], [ %i.lo, %bb.g ], [ <double 0.000000e+00, double 1.000000e+00>, %.lr.ph166 ] ; 2 uses
  %i.lx = trunc i64 %indvars.iv181 to i32
  %i.ly = add i32 %i.lx, -1
  %i.lz = tail call i32 @llvm.smax.i32(i32 %i.ly, i32 %.1.lcssa.ph188)
  %i.ma = add nsw i64 %indvars.iv181, 2           ; 2 uses
  %i.mb = trunc nsw i64 %i.ma to i32
  %i.mc = tail call i32 @llvm.smin.i32(i32 %.0.lcssa.ph, i32 %i.mb) ; 3 uses
  %.not157 = icmp sgt i32 %i.lz, %i.mc
  br i1 %.not157, label %._crit_edge, label %.lr.ph159

.lr.ph159:                                        ; preds = %Givens.exit
  %i.md = getelementptr inbounds [8 x i8], ptr %0, i64 %indvars.iv181 ; 2 uses
  %i.me = load ptr, ptr %i.md, align 8, !tbaa !10 ; 4 uses
  %i.mf = getelementptr i8, ptr %i.md, i64 8
  %i.mg = load ptr, ptr %i.mf, align 8, !tbaa !10 ; 4 uses
  %i.mh = sext i32 %i.mc to i64                   ; 2 uses
...
vector.memcheck:                                  ; preds = %.lr.ph159
  %scevgep = getelementptr i8, ptr %i.me, i64 %i.la
  %scevgep191 = getelementptr i8, ptr %i.me, i64 8
  %scevgep194 = getelementptr i8, ptr %scevgep191, i64 %i.ld
  %scevgep195 = getelementptr i8, ptr %i.mg, i64 %i.la
  %scevgep196 = getelementptr i8, ptr %i.mg, i64 8
  %scevgep197 = getelementptr i8, ptr %scevgep196, i64 %i.ld
...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.ml, -2                      ; 3 uses
  %i.mm = add i64 %smax178, %n.vec
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.mn = add i64 %smax178, %index                ; 2 uses
  %i.mo = getelementptr inbounds [8 x i8], ptr %i.me, i64 %i.mn ; 2 uses
  %wide.load = load <2 x double>, ptr %i.mo, align 8, !tbaa !8, !alias.scope !17, !noalias !20 ; 2 uses
  %i.mp = getelementptr inbounds [8 x i8], ptr %i.mg, i64 %i.mn ; 2 uses
  %wide.load200 = load <2 x double>, ptr %i.mp, align 8, !tbaa !8, !alias.scope !20 ; 2 uses
  %i.mq = fneg <2 x double> %wide.load200
  %i.mr = fmul <2 x double> %broadcast.splat, %i.mq
  %i.ms = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat199, <2 x double> %wide.load, <2 x double> %i.mr)
  store <2 x double> %i.ms, ptr %i.mo, align 8, !tbaa !8, !alias.scope !17, !noalias !20
  %i.mt = fmul <2 x double> %broadcast.splat199, %wide.load200
  %i.mu = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat, <2 x double> %wide.load, <2 x double> %i.mt)
  store <2 x double> %i.mu, ptr %i.mp, align 8, !tbaa !8, !alias.scope !20
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.mv = icmp eq i64 %index.next, %n.vec
  br i1 %i.mv, label %middle.block, label %vector.body, !llvm.loop !22
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph159, %middle.block
  %indvars.iv176.ph = phi i64 [ %smax178, %vector.memcheck ], [ %smax178, %.lr.ph159 ], [ %i.mm, %middle.block ]
  %i.mw = insertelement <2 x double> poison, double %.0148, i64 0
  %i.mx = insertelement <2 x double> %i.mw, double %.0149, i64 1 ; 2 uses
  br label %scalar.ph
...
.prol.loopexit.unr-lcssa:                         ; preds = %.lr.ph162
  ...
  %i.nl = fmul <2 x double> %i.na, %i.nk
  ...
  %i.np = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.na, <2 x double> %i.no, <2 x double> %i.nm)
  store <2 x double> %i.np, ptr %i.ne, align 8, !tbaa !8
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.unr-lcssa, %.lr.ph162
  ...
  %i.nq = icmp eq i64 %smax204, %smax205
  br i1 %i.nq, label %._crit_edge, label %.lr.ph162.new

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv176 = phi i64 [ %indvars.iv.next177, %scalar.ph ], [ %indvars.iv176.ph, %scalar.ph.preheader ] ; 4 uses
  %i.nr = getelementptr inbounds [8 x i8], ptr %i.me, i64 %indvars.iv176 ; 2 uses
  %i.ns = load double, ptr %i.nr, align 8, !tbaa !8
  %i.nt = getelementptr inbounds [8 x i8], ptr %i.mg, i64 %indvars.iv176 ; 2 uses
  %i.nu = load double, ptr %i.nt, align 8, !tbaa !8 ; 2 uses
  %i.nv = fneg double %i.nu
  %i.nw = insertelement <2 x double> poison, double %i.nv, i64 0
  %i.nx = insertelement <2 x double> %i.nw, double %i.nu, i64 1
  %i.ny = fmul <2 x double> %i.mx, %i.nx
  %i.nz = shufflevector <2 x double> %i.ny, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.oa = insertelement <2 x double> poison, double %i.ns, i64 0
  %i.ob = shufflevector <2 x double> %i.oa, <2 x double> poison, <2 x i32> zeroinitializer
  %i.oc = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.mx, <2 x double> %i.ob, <2 x double> %i.nz) ; 2 uses
  %i.od = extractelement <2 x double> %i.oc, i64 1
  store double %i.od, ptr %i.nr, align 8, !tbaa !8
  %i.oe = extractelement <2 x double> %i.oc, i64 0
  store double %i.oe, ptr %i.nt, align 8, !tbaa !8
  %indvars.iv.next177 = add nsw i64 %indvars.iv176, 1
  %.not.not = icmp slt i64 %indvars.iv176, %i.mh
...
.lr.ph162.new:                                    ; preds = %.prol.loopexit, %.lr.ph162.new
  ...
  %i.of = getelementptr inbounds [8 x i8], ptr %0, i64 %indvars.iv179
  %i.og = load ptr, ptr %i.of, align 8, !tbaa !10
  %i.oh = getelementptr [8 x i8], ptr %i.og, i64 %indvars.iv181 ; 3 uses
  %i.oi = load double, ptr %i.oh, align 8, !tbaa !8
  ...
  %i.oo = fmul <2 x double> %i.na, %i.on
  %i.op = shufflevector <2 x double> %i.oo, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.oq = insertelement <2 x double> poison, double %i.oi, i64 0
  %i.or = shufflevector <2 x double> %i.oq, <2 x double> poison, <2 x i32> zeroinitializer
  %i.os = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.na, <2 x double> %i.or, <2 x double> %i.op)
  store <2 x double> %i.os, ptr %i.oh, align 8, !tbaa !8
  %indvars.iv.next180 = add nsw i64 %indvars.iv179, 1 ; 2 uses
  %i.ot = getelementptr inbounds [8 x i8], ptr %0, i64 %indvars.iv.next180
  %i.ou = load ptr, ptr %i.ot, align 8, !tbaa !10
  %i.ov = getelementptr [8 x i8], ptr %i.ou, i64 %indvars.iv181 ; 3 uses
  %i.ow = load double, ptr %i.ov, align 8, !tbaa !8
  %i.ox = getelementptr i8, ptr %i.ov, i64 8
  %i.oy = load double, ptr %i.ox, align 8, !tbaa !8 ; 2 uses
  ...
  %i.pc = fmul <2 x double> %i.na, %i.pb
  %i.pd = shufflevector <2 x double> %i.pc, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.pe = insertelement <2 x double> poison, double %i.ow, i64 0
  %i.pf = shufflevector <2 x double> %i.pe, <2 x double> poison, <2 x i32> zeroinitializer
  %i.pg = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.na, <2 x double> %i.pf, <2 x double> %i.pd)
  store <2 x double> %i.pg, ptr %i.ov, align 8, !tbaa !8
  %indvars.iv.next180.1 = add nsw i64 %indvars.iv179, 2
  %.not137.not.1 = icmp slt i64 %indvars.iv.next180, %i.my
...
bb.i:                                             ; preds = %bb.i, %._crit_edge
  ...
  %i.ph = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv.i
  %i.pi = load ptr, ptr %i.ph, align 8, !tbaa !10 ; 2 uses
  %i.pj = getelementptr inbounds [8 x i8], ptr %i.pi, i64 %indvars.iv181 ; 2 uses
  %i.pk = load double, ptr %i.pj, align 8, !tbaa !8
  %i.pl = getelementptr inbounds [8 x i8], ptr %i.pi, i64 %indvars.iv.next182
  %i.pm = load double, ptr %i.pl, align 8, !tbaa !8 ; 2 uses
  %i.pn = fneg double %i.pm
  %i.po = insertelement <2 x double> poison, double %i.pn, i64 0
  %i.pp = insertelement <2 x double> %i.po, double %i.pm, i64 1
  %i.pq = fmul <2 x double> %i.lw, %i.pp
  %i.pr = shufflevector <2 x double> %i.pq, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.ps = insertelement <2 x double> poison, double %i.pk, i64 0
  %i.pt = shufflevector <2 x double> %i.ps, <2 x double> poison, <2 x i32> zeroinitializer
  %i.pu = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.lw, <2 x double> %i.pt, <2 x double> %i.pr)
  %i.pv = shufflevector <2 x double> %i.pu, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  store <2 x double> %i.pv, ptr %i.pj, align 8, !tbaa !8
...
ApplyRGivens.exit:                                ; preds = %bb.i
  %i.pw = icmp slt i64 %indvars.iv181, %i.jp
  br i1 %i.pw, label %bb.j, label %bb.k

bb.j:                                             ; preds = %ApplyRGivens.exit
  %i.px = getelementptr inbounds [8 x i8], ptr %0, i64 %indvars.iv.next182
  %i.py = load ptr, ptr %i.px, align 8, !tbaa !10
  %i.pz = getelementptr inbounds [8 x i8], ptr %i.py, i64 %indvars.iv181
  %i.qa = load double, ptr %i.pz, align 8, !tbaa !8
  %i.qb = getelementptr inbounds [8 x i8], ptr %0, i64 %i.ma
  %i.qc = load ptr, ptr %i.qb, align 8, !tbaa !10
  %i.qd = getelementptr inbounds [8 x i8], ptr %i.qc, i64 %indvars.iv181
  %i.qe = load double, ptr %i.qd, align 8, !tbaa !8
  br label %bb.k

bb.k:                                             ; preds = %ApplyRGivens.exit, %bb.j
  %.1135 = phi double [ %i.qa, %bb.j ], [ %.0134163, %ApplyRGivens.exit ]
  %.1133 = phi double [ %i.qe, %bb.j ], [ %.0132164, %ApplyRGivens.exit ]
