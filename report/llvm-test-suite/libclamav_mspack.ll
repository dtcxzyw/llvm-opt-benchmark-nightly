...
.preheader:                                       ; preds = %bb.j, %bb.s
  %i.cd = phi i32 [ %2, %bb.s ], [ 16, %bb.j ]    ; 2 uses
...
begin_hunk_6_@qtm_decompress:bb.a
  ...
  %i.ain = sub nsw i32 32, %i.ail
  %i.aio = lshr i32 %.30729, %i.ain
  %i.aip = or disjoint i32 %i.aio, %i.aim         ; 2 uses
  %i.aiq = shl i32 %.30729, %i.ail                ; 3 uses
  %i.air = trunc nuw i32 %i.ail to i8
  %i.ais = sub i8 %.30, %i.air                    ; 3 uses
  %i.ait = sub nsw i32 %i.ahl, %i.ail
  %3 = and i32 %i.ait, 255                        ; 2 uses
  %.not949 = icmp eq i32 %3, 0
  br i1 %.not949, label %bb.gq, label %.backedge

.backedge:                                        ; preds = %bb.gp, %bb.gq
  %.be = phi i32 [ %3, %bb.gp ], [ 8, %bb.gq ]
