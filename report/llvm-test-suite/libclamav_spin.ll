...
vector.body:                                      ; preds = %vector.body, %iter.check
  ...
  %wide.load802 = load <16 x i8>, ptr %i.ar, align 1, !tbaa !12
  ...
  %reverse804 = xor <16 x i8> %wide.load, %i.as
  ...
  %reverse805 = xor <16 x i8> %wide.load802, %i.au
  store <16 x i8> %reverse804, ptr %i.aq, align 1, !tbaa !12
  store <16 x i8> %reverse805, ptr %i.ar, align 1, !tbaa !12
...
vec.epilog.ph:                                    ; preds = %vector.body
  ...
  %i.ax = add i8 %i.x, 8
  %broadcast.splatinsert808 = insertelement <8 x i8> poison, i8 %i.an, i64 0
  %broadcast.splat809 = shufflevector <8 x i8> %broadcast.splatinsert808, <8 x i8> poison, <8 x i32> zeroinitializer ; 3 uses
  %i.ay = add <8 x i8> %broadcast.splat809, <i8 0, i8 -1, i8 -2, i8 -3, i8 -4, i8 -5, i8 -6, i8 -7>
  %i.az = getelementptr i8, ptr %i.t, i64 8187    ; 2 uses
  %wide.load813 = load <8 x i8>, ptr %i.az, align 1, !tbaa !12
  %i.ba = shufflevector <8 x i8> %i.ay, <8 x i8> poison, <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  %reverse815 = xor <8 x i8> %wide.load813, %i.ba
  store <8 x i8> %reverse815, ptr %i.az, align 1, !tbaa !12
  %vec.ind.next817 = add <8 x i8> %broadcast.splat809, <i8 -8, i8 -9, i8 -10, i8 -11, i8 -12, i8 -13, i8 -14, i8 -15>
  %i.bb = getelementptr i8, ptr %i.t, i64 8179    ; 2 uses
  %wide.load813.1 = load <8 x i8>, ptr %i.bb, align 1, !tbaa !12
  %i.bc = shufflevector <8 x i8> %vec.ind.next817, <8 x i8> poison, <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  %reverse815.1 = xor <8 x i8> %wide.load813.1, %i.bc
  store <8 x i8> %reverse815.1, ptr %i.bb, align 1, !tbaa !12
  %vec.ind.next817.1 = add <8 x i8> %broadcast.splat809, <i8 -16, i8 -17, i8 -18, i8 -19, i8 -20, i8 -21, i8 -22, i8 -23>
  %i.bd = getelementptr i8, ptr %i.t, i64 8171    ; 2 uses
  %wide.load813.2 = load <8 x i8>, ptr %i.bd, align 1, !tbaa !12
  %i.be = shufflevector <8 x i8> %vec.ind.next817.1, <8 x i8> poison, <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  %reverse815.2 = xor <8 x i8> %wide.load813.2, %i.be
  store <8 x i8> %reverse815.2, ptr %i.bd, align 1, !tbaa !12
...
.lr.ph698.split:                                  ; preds = %.lr.ph698.split.preheader, %.lr.ph698.split
  ...
  br i1 %exitcond745.not, label %._crit_edge699.split, label %.lr.ph698.split, !llvm.loop !46

._crit_edge699.split:                             ; preds = %.lr.ph698.split, %bb.bp
  tail call void @free(ptr noundef %i.gu) #7
  br label %.critedge605

.critedge605:                                     ; preds = %bb.bo, %.thread619, %.thread, %._crit_edge679, %.critedge, %bb.a, %._crit_edge699.split, %._crit_edge704, %bb.ag, %bb.ae, %bb.ac, %bb.aa, %bb.x, %bb.t, %bb.p, %bb.k, %bb.g, %bb.e, %bb.c
  %.11 = phi i32 [ 1, %bb.k ], [ 1, %bb.c ], [ 1, %bb.e ], [ 1, %bb.g ], [ 1, %bb.p ], [ 1, %bb.t ], [ 1, %.critedge ], [ 1, %bb.aa ], [ 1, %bb.ae ], [ 1, %.thread ], [ 1, %._crit_edge679 ], [ 1, %bb.a ], [ 1, %._crit_edge704 ], [ 1, %._crit_edge699.split ], [ %.0, %bb.bo ], [ 1, %bb.ag ], [ 1, %bb.ac ], [ 1, %bb.x ], [ 1, %.thread619 ]
  ret i32 %.11
}
