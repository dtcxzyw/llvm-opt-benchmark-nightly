...
bb.e:                                             ; preds = %.lr.ph, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit45
  ...
  %.sroa.0115.0128 = phi ptr [ %i.bq, %.lr.ph ], [ %i.ei, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit45 ] ; 3 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.0115.0128) ]
...
begin_hunk_1_@_ZN9benchmark8internal17BenchmarkInstanceC2EPNS0_9BenchmarkEiiRKSt6vectorIlSaIlEEi:bb.a
  ...
  %i.dc = getelementptr inbounds nuw [32 x i8], ptr %i.db, i64 %.025129 ; 3 uses
