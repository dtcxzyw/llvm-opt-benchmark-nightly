...
.split142:                                        ; preds = %bb.d, %.split.split.us, %bb.a
...
thread-pre-split.i:                               ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i, %middle.block, %vec.epilog.middle.block, %bb.bb, %bb.t, %bb.m
  %.0200.ph.i = phi ptr [ %i.bg, %bb.t ], [ %i.az, %bb.m ], [ %i.ee, %bb.bb ], [ %i.mw, %vec.epilog.middle.block ], [ %i.mp, %middle.block ], [ %.lcssa297.unr, %.lr.ph.i.prol.loopexit ], [ %i.od, %.lr.ph.i ]
...
bb.i:                                             ; preds = %thread-pre-split.i, %bb.h
  ...
  %.0200.i = phi ptr [ %.0200.ph.i, %thread-pre-split.i ], [ %i.af, %bb.h ] ; 19 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  %.not285.i = icmp ult ptr %.0200.i, %i.af
...
bb.l:                                             ; preds = %bb.k
  %i.az = getelementptr inbounds nuw i8, ptr %.0200.i, i64 1 ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  store i8 %i.ba, ptr %.0200.i, align 1, !tbaa !11
...
bb.r:                                             ; preds = %bb.q
  ...
  %.not243.i = icmp ult ptr %.0200.i, %i.af
...
bb.s:                                             ; preds = %bb.r
  %i.bg = getelementptr inbounds nuw i8, ptr %.0200.i, i64 1 ; 2 uses
...
bb.t:                                             ; preds = %bb.s
  ...
  store i8 %i.bh, ptr %.0200.i, align 1, !tbaa !11
  br label %thread-pre-split.i
...
bb.ew:                                            ; preds = %bb.ev, %bb.cx
  %.0195.i = phi i16 [ %i.mb, %bb.ev ], [ %i.il, %bb.cx ] ; 8 uses
  %i.mc = icmp eq i16 %.0195.i, 0
  %i.md = zext i16 %.0195.i to i32
...
iter.check:                                       ; preds = %bb.ey
  %min.iters.check = icmp ult i16 %.0195.i, 4
...
vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check286 = icmp ult i16 %.0195.i, 32
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %i.mo = sub i16 %.0195.i, %i.mn
  %i.mp = getelementptr i8, ptr %.0200.i, i64 %n.vec ; 2 uses
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %next.gep = getelementptr i8, ptr %.0200.i, i64 %index ; 3 uses
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %i.mu = trunc nuw i64 %n.vec289 to i16
  %i.mv = sub i16 %.0195.i, %i.mu
  %i.mw = getelementptr i8, ptr %.0200.i, i64 %n.vec289 ; 2 uses
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index290 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next293, %vec.epilog.vector.body ] ; 2 uses
  %next.gep291 = getelementptr i8, ptr %.0200.i, i64 %index290 ; 2 uses
...
.lr.ph.i.preheader:                               ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.1196504.i.ph = phi i16 [ %.0195.i, %iter.check ], [ %i.mo, %vec.epilog.iter.check ], [ %i.mv, %vec.epilog.middle.block ] ; 4 uses
  %.2202503.i.ph = phi ptr [ %.0200.i, %iter.check ], [ %i.mp, %vec.epilog.iter.check ], [ %i.mw, %vec.epilog.middle.block ] ; 2 uses
  %i.mz = add i16 %.1196504.i.ph, -1
  %xtraiter = and i16 %.1196504.i.ph, 7           ; 2 uses
  %lcmp.mod.not = icmp eq i16 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.lr.ph.i.prol.loopexit, label %.lr.ph.i.prol

.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader, %.lr.ph.i.prol
  %.1196504.i.prol = phi i16 [ %i.na, %.lr.ph.i.prol ], [ %.1196504.i.ph, %.lr.ph.i.preheader ]
  %.2202503.i.prol = phi ptr [ %i.nd, %.lr.ph.i.prol ], [ %.2202503.i.ph, %.lr.ph.i.preheader ] ; 3 uses
  %prol.iter = phi i16 [ %prol.iter.next, %.lr.ph.i.prol ], [ 0, %.lr.ph.i.preheader ]
  %i.na = add i16 %.1196504.i.prol, -1            ; 2 uses
  %i.nb = getelementptr inbounds i8, ptr %.2202503.i.prol, i64 %i.mg
  %i.nc = load i8, ptr %i.nb, align 1, !tbaa !11
  store i8 %i.nc, ptr %.2202503.i.prol, align 1, !tbaa !11
  %i.nd = getelementptr inbounds nuw i8, ptr %.2202503.i.prol, i64 1 ; 3 uses
...
.lr.ph.i.prol.loopexit:                           ; preds = %.lr.ph.i.prol, %.lr.ph.i.preheader
  ...
  %.1196504.i.unr = phi i16 [ %.1196504.i.ph, %.lr.ph.i.preheader ], [ %i.na, %.lr.ph.i.prol ]
  %.2202503.i.unr = phi ptr [ %.2202503.i.ph, %.lr.ph.i.preheader ], [ %i.nd, %.lr.ph.i.prol ]
  %i.ne = icmp ult i16 %i.mz, 7
  br i1 %i.ne, label %thread-pre-split.i, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  %.1196504.i = phi i16 [ %i.oa, %.lr.ph.i ], [ %.1196504.i.unr, %.lr.ph.i.prol.loopexit ]
  %.2202503.i = phi ptr [ %i.od, %.lr.ph.i ], [ %.2202503.i.unr, %.lr.ph.i.prol.loopexit ] ; 10 uses
  %i.nf = getelementptr inbounds i8, ptr %.2202503.i, i64 %i.mg
  %i.ng = load i8, ptr %i.nf, align 1, !tbaa !11
  store i8 %i.ng, ptr %.2202503.i, align 1, !tbaa !11
  %i.nh = getelementptr inbounds nuw i8, ptr %.2202503.i, i64 1 ; 2 uses
  ...
  %i.nk = getelementptr inbounds nuw i8, ptr %.2202503.i, i64 2 ; 2 uses
  ...
  %i.nn = getelementptr inbounds nuw i8, ptr %.2202503.i, i64 3 ; 2 uses
  ...
  %i.nq = getelementptr inbounds nuw i8, ptr %.2202503.i, i64 4 ; 2 uses
  ...
  %i.nt = getelementptr inbounds nuw i8, ptr %.2202503.i, i64 5 ; 2 uses
  ...
  %i.nw = getelementptr inbounds nuw i8, ptr %.2202503.i, i64 6 ; 2 uses
  ...
  %i.nz = getelementptr inbounds nuw i8, ptr %.2202503.i, i64 7 ; 2 uses
  %i.oa = add i16 %.1196504.i, -8                 ; 2 uses
  ...
  %i.od = getelementptr inbounds nuw i8, ptr %.2202503.i, i64 8 ; 2 uses
