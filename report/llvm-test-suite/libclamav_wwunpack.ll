...
bb.g:                                             ; preds = %bb.f
  ...
  %i.af = getelementptr inbounds i8, ptr %0, i64 %i.ae ; 11 uses
...
bb.ey:                                            ; preds = %bb.ex
  ...
  %9 = icmp ugt ptr %i.mj, %i.af
  %or.cond299.not478.not510.i = and i1 %.not273.i, %9
  %.not274.i = icmp uge ptr %.0198.i, %i.af
  %or.cond300.not508.i = select i1 %or.cond299.not478.not510.i, i1 %.not274.i, i1 false
