...
thread-pre-split.i:                               ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i, %middle.block.a, %bb.bb, %bb.t, %bb.m
  %.0198.ph.i = phi ptr [ %i.bg, %bb.t ], [ %i.az, %bb.m ], [ %i.ee, %bb.bb ], [ %i.mm, %middle.block.a ], [ %.lcssa289.unr, %.lr.ph.i.prol.loopexit ], [ %i.nw, %.lr.ph.i ]
...
bb.i:                                             ; preds = %thread-pre-split.i, %bb.h
  ...
  %.0198.i = phi ptr [ %.0198.ph.i, %thread-pre-split.i ], [ %i.af, %bb.h ] ; 17 uses
...
bb.ew:                                            ; preds = %bb.ev, %bb.cx
  %.0201.i = phi i16 [ %i.mb, %bb.ev ], [ %i.il, %bb.cx ] ; 6 uses
...
bb.ex:                                            ; preds = %bb.ew
  ...
  %i.mg = sub nsw i64 0, %i.mf                    ; 11 uses
...
bb.ey:                                            ; preds = %bb.ex
  %i.mi = zext i16 %.0201.i to i64                ; 4 uses
...
.lr.ph.i.preheader.a:                             ; preds = %bb.ey
  %min.iters.check = icmp ult i16 %.0201.i, 32
  %diff.check = icmp samesign ult i32 %i.ik, 32
  %or.cond = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond, label %.lr.ph.i.preheader288, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph.i.preheader.a
  %n.vec = and i64 %i.mi, 65504                   ; 4 uses
...
begin_hunk_5_@wwunpack:bb.a
  ...
  br i1 %i.mr, label %middle.block.a, label %vector.body, !llvm.loop !12

middle.block.a:                                   ; preds = %vector.body
  %cmp.n.a = icmp eq i64 %n.vec, %i.mi
  br i1 %cmp.n.a, label %thread-pre-split.i, label %.lr.ph.i.preheader288

.lr.ph.i.preheader288:                            ; preds = %.lr.ph.i.preheader.a, %middle.block.a
  %.2200504.i.ph = phi ptr [ %.0198.i, %.lr.ph.i.preheader.a ], [ %i.mm, %middle.block.a ] ; 2 uses
  %.1202503.i.ph = phi i16 [ %.0201.i, %.lr.ph.i.preheader.a ], [ %i.mn, %middle.block.a ] ; 4 uses
...
begin_hunk_7_@wwunpack:bb.a
  ...
  br i1 %.not276.i.7, label %thread-pre-split.i, label %.lr.ph.i, !llvm.loop !18
