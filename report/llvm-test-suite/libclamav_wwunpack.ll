...
bb.d:                                             ; preds = %.split.split.a
  ...
  br i1 %.not101, label %bb.e, label %.split146.us

.split146.us:                                     ; preds = %bb.d, %bb.b
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %i.ab, label %.split148.us, label %bb.f

.split148.us:                                     ; preds = %bb.e, %bb.c
  %.us-phi = phi i32 [ %i.o, %bb.c ], [ %i.w, %bb.e ]
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %or.cond114, label %.split150, label %bb.g

.split150:                                        ; preds = %bb.f, %bb.c
  %.us-phi151 = phi ptr [ %i.s, %bb.c ], [ %i.aa, %bb.f ]
...
thread-pre-split.i:                               ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i, %middle.block, %vec.epilog.middle.block, %bb.ba, %bb.s, %bb.l
  %.0198.ph.i = phi ptr [ %i.bg, %bb.s ], [ %i.az, %bb.l ], [ %i.ee, %bb.ba ], [ %i.mu, %vec.epilog.middle.block ], [ %i.mn, %middle.block ], [ %.lcssa296.unr, %.lr.ph.i.prol.loopexit ], [ %i.od, %.lr.ph.i ]
  %.pr.i = load i32, ptr %i.b, align 4, !tbaa !4
  %.pre.i = load i8, ptr %i.d, align 1, !tbaa !11
  br label %bb.h

bb.h:                                             ; preds = %thread-pre-split.i, %bb.g
  %i.aq = phi i8 [ %.pre.i, %thread-pre-split.i ], [ 32, %bb.g ]
  %i.ar = phi i32 [ %.pr.i, %thread-pre-split.i ], [ %.val.i.i, %bb.g ] ; 2 uses
  %.0198.i = phi ptr [ %.0198.ph.i, %thread-pre-split.i ], [ %i.af, %bb.g ] ; 19 uses
  ...
  br i1 %or.cond.i, label %bb.i, label %bb.m

bb.i:                                             ; preds = %bb.h
  %i.aw = load ptr, ptr %i.a, align 8, !tbaa !8   ; 3 uses
  %.not283.i = icmp ult ptr %i.aw, %i.aa
  br i1 %.not283.i, label %getbits.exit.thread, label %bb.j
...
bb.j:                                             ; preds = %bb.i
  ...
  br i1 %or.cond505.i, label %getbits.exit.thread, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.az = getelementptr inbounds nuw i8, ptr %.0198.i, i64 1 ; 2 uses
  %.not286.not.i = icmp ugt ptr %i.az, %i.ao
  br i1 %.not286.not.i, label %getbits.exit.thread, label %bb.l
...
bb.q:                                             ; preds = %bb.p
  ...
  br i1 %or.cond506.i, label %getbits.exit.thread, label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.bg = getelementptr inbounds nuw i8, ptr %.0198.i, i64 1 ; 2 uses
  %.not244.not.i = icmp ugt ptr %i.bg, %i.ao
  br i1 %.not244.not.i, label %getbits.exit.thread, label %bb.s
...
bb.u:                                             ; preds = %bb.t, %.thread.i
  %i.bk = phi i32 [ %i.bd, %.thread.i ], [ %i.bi, %bb.t ]
  %i.bl = phi i32 [ %.val.i305.i, %.thread.i ], [ %i.as, %bb.t ]
  %i.bm = phi i8 [ 32, %.thread.i ], [ %i.at, %bb.t ]
  %i.bn = shl i32 %i.bl, 2
  %i.bo = add i8 %i.bm, -2
  br label %bb.ab
...
bb.w:                                             ; preds = %bb.v
  ...
  br i1 %.not.i.i.i, label %getbits.exit.thread, label %bb.x

bb.x:                                             ; preds = %bb.w
  %i.br = getelementptr inbounds nuw i8, ptr %i.bq, i64 4 ; 2 uses
  %.not18.not.i.i.i = icmp ugt ptr %i.br, %i.al
  br i1 %.not18.not.i.i.i, label %getbits.exit.thread, label %bb.y
...
bb.z:                                             ; preds = %bb.v
  ...
  br i1 %.not.i38.i.i, label %getbits.exit.thread, label %bb.aa
...
bb.fa:                                            ; preds = %.lr.ph, %bb.fa
  %.089154 = phi i16 [ %8, %.lr.ph ], [ %i.oz, %bb.fa ]
  %.1153 = phi ptr [ %i.ox, %.lr.ph ], [ %i.pk, %bb.fa ] ; 5 uses
...
._crit_edge:                                      ; preds = %bb.fa, %bb.ez
  %.1.lcssa = phi ptr [ %i.ox, %bb.ez ], [ %i.pk, %bb.fa ]
