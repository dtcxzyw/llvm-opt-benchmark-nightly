...
bb.i:                                             ; preds = %bb.e
  ...
  %10 = insertelement <2 x float> %9, float %i.ds, i64 1
  %.sroa.526.8.vec.insert29.i = insertelement <2 x float> <float poison, float 5.000000e-01>, float %i.dt, i64 0
  %11 = fmul <2 x float> %10, %.sroa.526.8.vec.insert29.i
  br label %bb.j
...
bb.j:                                             ; preds = %_Z13btPlaneSpace1RK9btVector3RS_S2_.exit.i, %bb.i
  ...
  %.sroa.526.0.i = phi <2 x float> [ %.sroa.526.12.vec.insert.i, %_Z13btPlaneSpace1RK9btVector3RS_S2_.exit.i ], [ %11, %bb.i ] ; 5 uses
...
bb.g:                                             ; preds = %bb.c
  ...
  %7 = insertelement <2 x float> %6, float %i.dg, i64 1
  %.sroa.526.8.vec.insert29.i = insertelement <2 x float> <float poison, float 5.000000e-01>, float %i.dh, i64 0
  %8 = fmul <2 x float> %7, %.sroa.526.8.vec.insert29.i
  br label %bb.h
...
bb.h:                                             ; preds = %bb.g, %_Z13btPlaneSpace1RK9btVector3RS_S2_.exit.i
  ...
  %.sroa.526.0.i = phi <2 x float> [ %.sroa.526.12.vec.insert.i, %_Z13btPlaneSpace1RK9btVector3RS_S2_.exit.i ], [ %8, %bb.g ] ; 5 uses
...
bb.a:
  ...
  %i.by = fmul float %i.bw, 0.000000e+00
  %i.bz = fmul float %i.bj, %i.bo                 ; 7 uses
  %i.ca = fadd float %i.bs, %i.by
  %i.cb = call float @llvm.fmuladd.f32(float %i.bs, float 0.000000e+00, float %i.bz)
  %i.cc = fneg float %i.bt
  %i.cd = shufflevector <2 x float> %i.br, <2 x float> poison, <2 x i32> <i32 poison, i32 0> ; 2 uses
  %i.ce = insertelement <2 x float> %i.cd, float %i.bz, i64 0
  ...
  %i.ck = fmul float %i.bz, -0.000000e+00
  ...
  %i.cs = call float @llvm.fmuladd.f32(float %i.cr, float %i.bz, float %i.cq) ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %5 = fadd float %i.dt, 1.000000e+00
  %6 = fmul float %5, 2.000000e+00
  %7 = call noundef float @sqrtf(float noundef %6) #17, !tbaa !4 ; 2 uses
  %8 = insertelement <2 x float> poison, float %i.dv, i64 0
  %9 = fneg <2 x float> %i.do
  %10 = shufflevector <2 x float> %8, <2 x float> %9, <2 x i32> <i32 0, i32 2>
  %11 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.do, <2 x float> zeroinitializer, <2 x float> %10) ; 2 uses
  %i.dy = fdiv float 1.000000e+00, %7             ; 3 uses
  %i.dz = extractelement <2 x float> %11, i64 1
  %i.ea = fmul float %i.dz, %i.dy
  %i.eb = fmul float %i.dx, %i.dy
  %12 = insertelement <2 x float> %11, float %7, i64 1
  %.sroa.020.0.vec.insert23.i.a = insertelement <2 x float> <float poison, float 5.000000e-01>, float %i.dy, i64 0
  %13 = fmul <2 x float> %12, %.sroa.020.0.vec.insert23.i.a
  %.sroa.526.8.vec.insert29.i = insertelement <2 x float> poison, float %i.ea, i64 0
  %.sroa.526.12.vec.insert31.i = insertelement <2 x float> %.sroa.526.8.vec.insert29.i, float %i.eb, i64 1
  br label %_Z15shortestArcQuatRK9btVector3S1_.exit

_Z15shortestArcQuatRK9btVector3S1_.exit:          ; preds = %bb.a, %bb.b
  %.sroa.020.0.i = phi <2 x float> [ %.sroa.526.12.vec.insert31.i, %bb.b ], [ <float 0.000000e+00, float -1.000000e+00>, %bb.a ] ; 4 uses
  %.sroa.526.0.i = phi <2 x float> [ %13, %bb.b ], [ zeroinitializer, %bb.a ] ; 4 uses
  ...
  %i.ei = call float @llvm.fmuladd.f32(float %.sroa.574.8.vec.extract, float %i.bz, float %i.eh) ; 2 uses
  %i.ej = fmul float %i.bs, %i.ed
  %i.ek = call float @llvm.fmuladd.f32(float %.sroa.574.12.vec.extract, float %i.bz, float %i.ej)
  ...
  %i.ey = insertelement <2 x float> poison, float %i.bz, i64 0
