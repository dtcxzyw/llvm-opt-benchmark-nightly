...
bb.h:                                             ; preds = %bb.g, %_Z13btPlaneSpace1RK9btVector3RS_S2_.exit.i
  ...
  %i.fx = tail call float @llvm.fmuladd.f32(float %i.ee, float %.sroa.059.4.vec.extract, float %i.fw) ; 3 uses
  %5 = tail call float @llvm.fmuladd.f32(float %i.ft, float %i.ed, float %i.en)
  %6 = tail call float @llvm.fmuladd.f32(float %i.ea, float %.sroa.059.0.vec.extract, float %5) ; 3 uses
  %7 = fneg float %6
  %8 = fmul float %i.ch, %7
  %9 = insertelement <2 x float> poison, float %i.ft, i64 0
  %10 = insertelement <2 x float> %9, float %i.fx, i64 1
  %11 = insertelement <2 x float> %.sroa.526.0.i, float %i.ce, i64 1
  %i.fy = insertelement <2 x float> poison, float %i.el, i64 0
  %i.fz = insertelement <2 x float> %i.fy, float %8, i64 1
  %i.ga = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %10, <2 x float> %11, <2 x float> %i.fz) ; 3 uses
  %i.gb = insertelement <2 x float> %i.ga, float %i.fx, i64 1
  ...
  store float %6, ptr %i.gm, align 8, !tbaa !27
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !31, !nonnull !32, !align !33 ; 13 uses
  %i.k = getelementptr inbounds nuw i8, ptr %i.j, i64 8 ; 2 uses
  %i.l = getelementptr inbounds nuw i8, ptr %0, i64 648
  %2 = load float, ptr %i.k, align 8, !tbaa !27
  %3 = load float, ptr %i.l, align 8, !tbaa !27   ; 2 uses
  %4 = getelementptr inbounds nuw i8, ptr %i.j, i64 12
  ...
  %i.ab = load ptr, ptr %i.aa, align 8, !tbaa !37, !nonnull !32, !align !33 ; 12 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %i.ab, i64 8 ; 2 uses
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 712
  %8 = load float, ptr %i.ac, align 8, !tbaa !27
  %i.ae = load float, ptr %i.ad, align 8, !tbaa !27 ; 2 uses
  %i.af = getelementptr inbounds nuw i8, ptr %i.ab, i64 12
  %i.ag = load float, ptr %i.af, align 4, !tbaa !27
  %i.ah = getelementptr inbounds nuw i8, ptr %0, i64 716
  %i.ai = load float, ptr %i.ah, align 4, !tbaa !27 ; 2 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ab, i64 16 ; 2 uses
  %9 = load float, ptr %i.aj, align 8, !tbaa !27
  %i.ak = getelementptr inbounds nuw i8, ptr %0, i64 720
  %i.al = load float, ptr %i.ak, align 8, !tbaa !27 ; 2 uses
  %i.am = getelementptr inbounds nuw i8, ptr %i.ab, i64 56 ; 2 uses
  %10 = load float, ptr %i.am, align 8, !tbaa !27
  %i.an = getelementptr inbounds nuw i8, ptr %i.ab, i64 24 ; 2 uses
  %i.ao = getelementptr inbounds nuw i8, ptr %i.ab, i64 32 ; 2 uses
  %i.ap = load float, ptr %i.ao, align 8, !tbaa !27
  %11 = getelementptr inbounds nuw i8, ptr %i.ab, i64 60 ; 2 uses
  %12 = getelementptr inbounds nuw i8, ptr %i.ab, i64 40 ; 2 uses
  %13 = getelementptr inbounds nuw i8, ptr %i.ab, i64 48 ; 2 uses
  %14 = load float, ptr %13, align 8, !tbaa !27
  call void @llvm.lifetime.start.p0(ptr nonnull %1) #17
  %15 = fmul float %5, %7
  %16 = tail call float @llvm.fmuladd.f32(float %2, float %3, float %15)
  %17 = tail call noundef float @llvm.fmuladd.f32(float %i.n, float %i.p, float %16)
  %18 = fadd float %17, %i.r                      ; 2 uses
  %19 = fmul float %i.ag, %i.ai
  %20 = tail call float @llvm.fmuladd.f32(float %8, float %i.ae, float %19)
  %21 = tail call noundef float @llvm.fmuladd.f32(float %9, float %i.al, float %20)
  %22 = load <2 x float>, ptr %i.an, align 8, !tbaa !27 ; 2 uses
  %23 = load <2 x float>, ptr %12, align 8, !tbaa !27 ; 2 uses
  %24 = load <2 x float>, ptr %11, align 4, !tbaa !27
  %i.aq = insertelement <2 x float> poison, float %i.ai, i64 0
  %25 = shufflevector <2 x float> %i.aq, <2 x float> poison, <2 x i32> zeroinitializer
  %26 = shufflevector <2 x float> %22, <2 x float> %23, <2 x i32> <i32 1, i32 3>
  %27 = fmul <2 x float> %25, %26
  %28 = shufflevector <2 x float> %22, <2 x float> %23, <2 x i32> <i32 0, i32 2>
  %29 = insertelement <2 x float> poison, float %i.ae, i64 0
  %30 = shufflevector <2 x float> %29, <2 x float> poison, <2 x i32> zeroinitializer
  %31 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %28, <2 x float> %30, <2 x float> %27)
  %32 = insertelement <2 x float> poison, float %i.ap, i64 0
  %33 = insertelement <2 x float> %32, float %14, i64 1
  %34 = insertelement <2 x float> poison, float %i.al, i64 0
  %35 = shufflevector <2 x float> %34, <2 x float> poison, <2 x i32> zeroinitializer
  %36 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %33, <2 x float> %35, <2 x float> %31)
  %37 = insertelement <4 x float> <float 1.000000e+00, float poison, float poison, float poison>, float %10, i64 1
  %38 = shufflevector <2 x float> %24, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %39 = shufflevector <4 x float> %37, <4 x float> %38, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %40 = insertelement <4 x float> <float -0.000000e+00, float poison, float poison, float poison>, float %21, i64 1
  %41 = shufflevector <2 x float> %36, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %42 = shufflevector <4 x float> %40, <4 x float> %41, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %43 = fadd <4 x float> %39, %42                 ; 4 uses
  %44 = extractelement <4 x float> %43, i64 1
  %45 = fsub float %44, %18                       ; 3 uses
  %46 = load <2 x float>, ptr %i.s, align 8, !tbaa !27 ; 2 uses
  %i.ar = load <2 x float>, ptr %i.w, align 8, !tbaa !27 ; 2 uses
  %i.as = load <2 x float>, ptr %i.v, align 4, !tbaa !27
  %47 = insertelement <2 x float> poison, float %7, i64 0
  %48 = shufflevector <2 x float> %47, <2 x float> poison, <2 x i32> zeroinitializer
  %i.at = shufflevector <2 x float> %46, <2 x float> %i.ar, <2 x i32> <i32 1, i32 3>
  %i.au = fmul <2 x float> %48, %i.at
  %i.av = shufflevector <2 x float> %46, <2 x float> %i.ar, <2 x i32> <i32 0, i32 2>
  %49 = insertelement <2 x float> poison, float %3, i64 0
  %i.aw = shufflevector <2 x float> %49, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ax = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.av, <2 x float> %i.aw, <2 x float> %i.au)
  %50 = insertelement <2 x float> poison, float %i.u, i64 0
  %i.ay = insertelement <2 x float> %50, float %i.y, i64 1
  ...
  %i.bc = fadd <2 x float> %i.as, %i.bb           ; 3 uses
  %51 = shufflevector <4 x float> %43, <4 x float> poison, <2 x i32> <i32 2, i32 3>
  %i.bd = fsub <2 x float> %51, %i.bc             ; 4 uses
  %foldExtExtBinop = fmul <2 x float> %i.bd, %i.bd
  %i.be = extractelement <2 x float> %foldExtExtBinop, i64 0
  %i.bf = tail call float @llvm.fmuladd.f32(float %45, float %45, float %i.be)
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.bk = fmul float %45, %i.bj                   ; 2 uses
...
_Z13btPlaneSpace1RK9btVector3RS_S2_.exit:         ; preds = %bb.g, %bb.h
  ...
  %i.dg = extractelement <2 x float> %i.bc, i64 0
  %i.dh = extractelement <2 x float> %i.bc, i64 1
  br label %bb.j
...
bb.j:                                             ; preds = %_Z13btPlaneSpace1RK9btVector3RS_S2_.exit, %bb.j
  ...
  %i.dl = load float, ptr %i.aj, align 8, !tbaa !27, !noalias !41
  %i.dm = load float, ptr %i.ao, align 8, !tbaa !27, !noalias !41
  %i.dn = load float, ptr %13, align 8, !tbaa !27, !noalias !41
  %i.do = load float, ptr %i.q, align 8, !tbaa !27
  %i.dp = fsub float %18, %i.do                   ; 2 uses
  ...
  %i.du = load float, ptr %i.am, align 8, !tbaa !27
  ...
  %i.ei = load <2 x float>, ptr %i.an, align 8, !tbaa !27, !noalias !41
  %i.ej = load <2 x float>, ptr %12, align 8, !tbaa !27, !noalias !41
  %i.ek = load float, ptr %i.x, align 8, !tbaa !27, !noalias !38
  %i.el = load <2 x float>, ptr %11, align 4, !tbaa !27
  %i.em = insertelement <4 x float> %43, float %i.ek, i64 0
  ...
  %i.ep = shufflevector <4 x float> %i.en, <4 x float> %i.eo, <4 x i32> <i32 0, i32 1, i32 4, i32 5> ; 2 uses
  %i.eq = fsub <4 x float> %i.em, %i.ep
  %i.er = shufflevector <4 x float> %i.eq, <4 x float> poison, <4 x i32> <i32 0, i32 3, i32 1, i32 2>
  %52 = fsub <4 x float> %43, %i.ep
  ...
  %i.fr = insertelement <4 x float> %i.fq, float %i.fp, i64 0
  %i.fs = insertelement <4 x float> %i.fr, float %i.es, i64 1
  %i.ft = fmul <4 x float> %i.fs, %52
...
bb.a:
  ...
  %5 = extractelement <2 x float> %i.k, i64 1     ; 2 uses
  %6 = call float @llvm.fmuladd.f32(float %.sroa.588.8.vec.extract, float %5, float %i.x) ; 4 uses
  %foldExtExtBinop = fmul <2 x float> %.fca.0.load.i, %i.k
  %i.aa = extractelement <2 x float> %foldExtExtBinop, i64 0
  %7 = call float @llvm.fmuladd.f32(float %.sroa.588.12.vec.extract, float %i.c, float %i.aa)
  %i.ab = call float @llvm.fmuladd.f32(float %.sroa.087.4.vec.extract, float %5, float %7)
  ...
  %i.ah = call float @llvm.fmuladd.f32(float %i.ag, float %.sroa.085.0.vec.extract, float %i.af)
  %i.ai = fneg float %6
  %i.aj = call float @llvm.fmuladd.f32(float %i.ai, float %.sroa.586.8.vec.extract, float %i.ah) ; 3 uses
  %i.ak = fneg float %.sroa.085.0.vec.extract
  %i.al = shufflevector <2 x float> %i.z, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.am = insertelement <2 x float> %i.al, float %6, i64 1
  %i.an = shufflevector <2 x float> %.fca.1.load.i18, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.ao = fmul <2 x float> %i.am, %i.an
  %i.ap = fmul float %6, %i.ak
  ...
  %i.av = insertelement <2 x float> poison, float %6, i64 0
  ...
  %i.bu = fmul float %i.bs, 0.000000e+00
  ...
  %i.by = insertelement <2 x float> %i.bx, float %9, i64 0
  ...
  %i.cl = call float @llvm.fmuladd.f32(float %i.ck, float %9, float %i.cj) ; 3 uses
...
_Z15shortestArcQuatRK9btVector3S1_.exit:          ; preds = %bb.a, %bb.b
  ...
  %i.el = call float @llvm.fmuladd.f32(float %.sroa.574.8.vec.extract, float %9, float %i.ek) ; 2 uses
  %i.em = fmul float %i.bo, %i.eg
  %i.en = call float @llvm.fmuladd.f32(float %.sroa.574.12.vec.extract, float %9, float %i.em)
  ...
  %i.fb = insertelement <2 x float> poison, float %9, i64 0
