...
bb.c:                                             ; preds = %bb.b
  ...
  %2 = getelementptr inbounds nuw i8, ptr %i.ab, i64 64
  ...
  %i.bi = fadd <2 x float> %i.bf, %i.bh           ; 2 uses
  ...
  %3 = load <2 x float>, ptr %i.s, align 8, !tbaa !27 ; 2 uses
  %4 = load <2 x float>, ptr %i.w, align 8, !tbaa !27 ; 2 uses
  %5 = load <2 x float>, ptr %i.v, align 4, !tbaa !27
  %i.bm = load <2 x float>, ptr %i.ak, align 8, !tbaa !27 ; 2 uses
  %i.bn = load <2 x float>, ptr %i.ao, align 8, !tbaa !27 ; 2 uses
  %i.bo = load <2 x float>, ptr %i.an, align 4, !tbaa !27
  %i.bp = shufflevector <2 x float> %i.as, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.bq = shufflevector <2 x float> %3, <2 x float> %4, <2 x i32> <i32 1, i32 3>
  %i.br = fmul <2 x float> %i.bp, %i.bq
  %i.bs = shufflevector <2 x float> %3, <2 x float> %4, <2 x i32> <i32 0, i32 2>
  ...
  %i.ca = fadd <2 x float> %5, %i.bz              ; 3 uses
  ...
  %i.ce = shufflevector <2 x float> %i.bm, <2 x float> %i.bn, <2 x i32> <i32 0, i32 2>
  ...
  %i.cl = fadd <2 x float> %i.bo, %i.ck           ; 3 uses
...
_Z13btPlaneSpace1RK9btVector3RS_S2_.exit:         ; preds = %bb.g, %bb.h
  ...
  %6 = extractelement <2 x float> %i.cl, i64 0
  %i.ep = extractelement <2 x float> %i.cl, i64 1
  %i.eq = extractelement <2 x float> %i.ca, i64 0
...
bb.j:                                             ; preds = %_Z13btPlaneSpace1RK9btVector3RS_S2_.exit, %bb.j
  ...
  %8 = load float, ptr %i.x, align 8, !tbaa !27, !noalias !38
  ...
  %i.fa = fsub float %i.eq, %i.ez                 ; 2 uses
  %i.fb = load float, ptr %i.z, align 8, !tbaa !27
  %i.fc = fsub float %7, %i.fb                    ; 2 uses
  %i.fd = load float, ptr %i.ai, align 8, !tbaa !27
  %9 = fsub float %i.bj, %i.fd                    ; 2 uses
  %10 = load float, ptr %i.an, align 4, !tbaa !27
  %11 = fsub float %6, %10                        ; 2 uses
  %12 = load float, ptr %2, align 8, !tbaa !27
  %13 = fsub float %i.ep, %12                     ; 2 uses
  ...
  %i.fu = load float, ptr %i.fm, align 4, !tbaa !27 ; 3 uses
  ...
  %14 = load float, ptr %i.er, align 4, !tbaa !27 ; 3 uses
  %15 = fneg float %i.ft                          ; 2 uses
  %16 = fmul float %i.ey, %15
  %i.fy = tail call float @llvm.fmuladd.f32(float %i.fc, float %14, float %16) ; 2 uses
  %i.fz = fneg float %14                          ; 2 uses
  ...
  %17 = tail call noundef float @llvm.fmuladd.f32(float %8, float %i.gb, float %i.gm) ; 3 uses
  %.sroa.3.12.vec.insert.i18.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %17, i64 0
  store <2 x float> %i.gk, ptr %i.fh, align 4
  store <2 x float> %.sroa.3.12.vec.insert.i18.i, ptr %.sroa.46.0..sroa_idx.i, align 4, !tbaa !26
  %18 = fmul float %13, %i.fu
  %19 = tail call float @llvm.fmuladd.f32(float %11, float %15, float %18) ; 2 uses
  %20 = fmul float %9, %i.ft
  %21 = tail call float @llvm.fmuladd.f32(float %13, float %i.fz, float %20) ; 2 uses
  %22 = fmul float %11, %14
  %23 = tail call float @llvm.fmuladd.f32(float %9, float %i.fv, float %22) ; 2 uses
  %i.gn = insertelement <2 x float> poison, float %21, i64 0
  %24 = shufflevector <2 x float> %i.gn, <2 x float> poison, <2 x i32> zeroinitializer
  %25 = fmul <2 x float> %i.fr, %24
  %26 = insertelement <2 x float> poison, float %19, i64 0
  %27 = shufflevector <2 x float> %26, <2 x float> poison, <2 x i32> zeroinitializer
  %i.go = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.fq, <2 x float> %27, <2 x float> %25)
  %28 = insertelement <2 x float> poison, float %23, i64 0
  %29 = shufflevector <2 x float> %28, <2 x float> poison, <2 x i32> zeroinitializer
  %30 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.fs, <2 x float> %29, <2 x float> %i.go) ; 4 uses
  %i.gp = fmul float %i.ev, %21
  %i.gq = tail call float @llvm.fmuladd.f32(float %i.eu, float %19, float %i.gp)
  %i.gr = tail call noundef float @llvm.fmuladd.f32(float %i.ew, float %23, float %i.gq) ; 3 uses
  %.sroa.3.12.vec.insert.i33.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.gr, i64 0
  store <2 x float> %30, ptr %i.fi, align 4
  ...
  %i.gw = fmul float %17, %i.gv                   ; 2 uses
  ...
  %i.gx = extractelement <2 x float> %30, i64 0
  %i.gy = load <2 x float>, ptr %i.el, align 4, !tbaa !27
  %i.gz = fmul <2 x float> %30, %i.gy             ; 3 uses
  ...
  %i.hf = tail call noundef float @llvm.fmuladd.f32(float %i.gw, float %17, float %i.he)
  %i.hg = fadd float %i.ff, %i.hf
  %i.hh = fadd float %i.fg, %i.hg
  %foldExtExtBinop293 = fmul <2 x float> %30, %i.gz
