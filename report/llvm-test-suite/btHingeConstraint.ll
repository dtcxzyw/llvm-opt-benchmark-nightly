...
bb.a:                                             ; preds = %.preheader.preheader
  ...
  %8 = load <4 x float>, ptr %i.y, align 8
  %9 = shufflevector <4 x float> %8, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %i.ab = load float, ptr %i.z, align 8, !tbaa !27
  %10 = load float, ptr %i.aa, align 8, !tbaa !27
  %i.ac = insertelement <2 x float> %9, float %i.ab, i64 1
  ...
  %.sroa.0.0.vec.insert.i66 = load <2 x float>, ptr %i.af, align 4
...
bb.c:                                             ; preds = %bb.b
  ...
  %11 = load <4 x float>, ptr %i.al, align 8      ; 2 uses
  ...
  %.sroa.0.0.vec.insert.i76 = load <2 x float>, ptr %i.aq, align 4
...
bb.c:                                             ; preds = %bb.b
  ...
  %2 = load <4 x float>, ptr %i.ad, align 4
  ...
  %i.ce = shufflevector <4 x float> %2, <4 x float> poison, <2 x i32> zeroinitializer
...
bb.a:
  ...
  %6 = load <4 x float>, ptr %i.ao, align 4
  ...
  %i.eq = insertelement <4 x float> %6, float %i.en, i64 1
