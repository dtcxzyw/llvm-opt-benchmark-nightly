...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !31, !nonnull !32, !align !33 ; 48 uses
  ...
  %4 = load float, ptr %i.p, align 8, !tbaa !27   ; 2 uses
  %i.q = getelementptr inbounds nuw i8, ptr %i.e, i64 60
  %5 = load float, ptr %i.q, align 4, !tbaa !27   ; 2 uses
  ...
  %6 = load <2 x float>, ptr %i.n, align 8, !tbaa !27 ; 2 uses
  %7 = load float, ptr %i.o, align 4, !tbaa !27
  ...
  %9 = load <2 x float>, ptr %i.h, align 4, !tbaa !27 ; 3 uses
  %i.z = load <2 x float>, ptr %i.s, align 4, !tbaa !27 ; 3 uses
  %10 = shufflevector <2 x float> %i.z, <2 x float> %9, <2 x i32> <i32 0, i32 2>
  ...
  %i.ac = fmul <2 x float> %10, %i.ab
  %i.ad = shufflevector <2 x float> %i.u, <2 x float> %i.t, <2 x i32> <i32 0, i32 2>
  ...
  %i.ah = shufflevector <2 x float> %i.z, <2 x float> %9, <2 x i32> <i32 1, i32 3>
  ...
  %11 = fmul float %i.w, %7
  %12 = tail call float @llvm.fmuladd.f32(float %8, float %i.x, float %11)
  %13 = tail call noundef float @llvm.fmuladd.f32(float %4, float %i.y, float %12)
  %14 = fadd float %5, %13                        ; 2 uses
  %15 = getelementptr inbounds nuw i8, ptr %i.e, i64 64
  %16 = load float, ptr %15, align 8, !tbaa !27
  %17 = insertelement <2 x float> poison, float %16, i64 0
  %18 = insertelement <2 x float> %17, float %i.m, i64 1 ; 2 uses
  %i.al = fadd <2 x float> %18, %i.ak             ; 3 uses
  ...
  %i.bz = fadd <3 x float> %i.bx, %i.by           ; 4 uses
  %i.ca = getelementptr inbounds nuw i8, ptr %0, i64 780
  %i.cb = load i8, ptr %i.ca, align 4, !tbaa !24, !range !34, !noundef !32
  %i.cc = trunc nuw i8 %i.cb to i1
  %19 = shufflevector <2 x float> %9, <2 x float> %i.z, <3 x i32> <i32 3, i32 1, i32 poison>
  %i.cd = insertelement <3 x float> %19, float %4, i64 2
  %i.ce = shufflevector <2 x float> %i.u, <2 x float> %i.t, <3 x i32> <i32 0, i32 2, i32 poison>
  %i.cf = shufflevector <2 x float> %6, <2 x float> poison, <3 x i32> <i32 0, i32 1, i32 poison> ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  %i.cq = fsub float %14, %5                      ; 3 uses
  %i.cr = fsub <2 x float> %i.al, %18             ; 4 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.dh = extractelement <2 x float> %i.cr, i64 1
  ...
  %20 = shufflevector <2 x float> %i.cr, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %21 = insertelement <2 x float> %20, float %i.cq, i64 0
  %22 = fneg <2 x float> %21
  %23 = fmul <2 x float> %i.dt, %22
  %i.du = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.do, <2 x float> %i.cr, <2 x float> %23)
  %i.dv = extractelement <2 x float> %i.do, i64 0
  %i.dw = fmul float %i.dv, %i.di
  %i.dx = extractelement <2 x float> %i.dt, i64 1
  %i.dy = tail call float @llvm.fmuladd.f32(float %i.dx, float %i.cq, float %i.dw)
...
_ZNK12btSolverBody31getVelocityInLocalPointObsoleteERK9btVector3RS0_.exit79: ; preds = %_ZNK12btSolverBody31getVelocityInLocalPointObsoleteERK9btVector3RS0_.exit, %bb.e
  ...
  %24 = extractelement <2 x float> %i.al, i64 1
  %25 = fsub float %24, %i.fr
  %26 = extractelement <3 x float> %i.bz, i64 1
  %i.fs = fsub float %14, %26
  %27 = extractelement <3 x float> %i.bz, i64 2
  %28 = extractelement <2 x float> %i.al, i64 0
  %29 = fsub float %28, %27
  ...
  %i.gv = shufflevector <2 x float> %i.cr, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.gw = shufflevector <4 x float> %i.gu, <4 x float> %i.gv, <4 x i32> <i32 0, i32 4, i32 5, i32 poison> ; 2 uses
  %30 = shufflevector <4 x float> %i.gw, <4 x float> poison, <4 x i32> <i32 2, i32 0, i32 1, i32 poison>
  br label %bb.f
...
bb.f:                                             ; preds = %_ZNK12btSolverBody31getVelocityInLocalPointObsoleteERK9btVector3RS0_.exit79, %bb.f
  ...
  %i.ha = fdiv float 1.000000e+00, %i.gz
  %i.hb = getelementptr inbounds nuw i8, ptr %i.gx, i64 8 ; 2 uses
  %i.hc = load float, ptr %i.hb, align 4, !tbaa !27 ; 5 uses
  ...
  %i.hm = fmul float %i.fs, %i.hh
  %i.hn = tail call float @llvm.fmuladd.f32(float %25, float %i.hj, float %i.hm)
  %i.ho = tail call noundef float @llvm.fmuladd.f32(float %29, float %i.hc, float %i.hn)
  ...
  %i.hw = insertelement <4 x float> %i.hv, float %i.ha, i64 3 ; 2 uses
  %i.hx = fneg <4 x float> %i.hw                  ; 2 uses
  %i.hy = fneg float %i.hh
  %i.hz = insertelement <4 x float> %i.gw, float %i.hl, i64 3
  %i.ia = fmul <4 x float> %i.hz, %i.hx
  %i.ib = insertelement <4 x float> %30, float %i.hq, i64 3
  %i.ic = shufflevector <2 x float> %i.hg, <2 x float> poison, <4 x i32> <i32 1, i32 poison, i32 0, i32 poison>
  %31 = shufflevector <4 x float> %i.ic, <4 x float> %i.hw, <4 x i32> <i32 0, i32 6, i32 2, i32 7>
  %i.id = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ib, <4 x float> %31, <4 x float> %i.ia) ; 9 uses
