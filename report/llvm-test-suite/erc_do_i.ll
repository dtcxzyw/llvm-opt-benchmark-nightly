...
begin_hunk_0_@ercPixConcealIMB:bb.a
  %i.hl = add nuw nsw i32 %.075.us.us.us.i.a, 1   ; 2 uses
...
.preheader.us.i.a:                                ; preds = %.preheader.us.i.preheader, %._crit_edge.split.us.us.split.i.split
...
bb.ad:                                            ; preds = %bb.ai, %.preheader.us.i.a
  %indvars.iv101.i = phi i64 [ %indvars.iv.next102.i, %bb.ai ], [ 0, %.preheader.us.i.a ] ; 4 uses
...
._crit_edge.split.us.us.split.i.split:            ; preds = %bb.ai
  ...
  br i1 %exitcond114.not.i, label %pixMeanInterpolateBlock.exit, label %.preheader.us.i.a, !llvm.loop !33
...
.preheader.i:                                     ; preds = %.preheader.i.preheader, %._crit_edge.split.i.split
  ...
  %i.ka = mul nsw i64 %indvars.iv92.i, %i.ay      ; 2 uses
  %gep.i = getelementptr [2 x i8], ptr %invariant.gep.i, i64 %i.ka
  %indvars.iv.next93.i = add nuw nsw i64 %indvars.iv92.i, 1 ; 3 uses
  %i.kb = getelementptr inbounds [2 x i8], ptr %i.aj, i64 %i.ka
  %i.kc = trunc i64 %indvars.iv92.i to i32
  %i.kd = sub i32 %i.ao, %i.kc                    ; 2 uses
  %i.ke = trunc nuw nsw i64 %indvars.iv.next93.i to i32 ; 2 uses
  %invariant.gep161.sink.i = getelementptr [2 x i8], ptr %i.an, i64 %indvars.iv94.i
  br label %bb.aj
...
bb.al:                                            ; preds = %bb.ak, %bb.aj
  %.058.i = phi i32 [ %i.ki, %bb.ak ], [ 0, %bb.aj ]
  %.057.i = phi i32 [ %i.kd, %bb.ak ], [ 0, %bb.aj ]
  ...
  %i.ko = add nsw i32 %i.kn, %.058.i              ; 2 uses
  %i.kp = add nsw i32 %.057.i, %i.km              ; 2 uses
...
bb.an:                                            ; preds = %bb.am, %bb.al
  %.260.i = phi i32 [ %i.ku, %bb.am ], [ %i.ko, %bb.al ]
...
bb.aq:                                            ; preds = %bb.ap, %bb.ao
  %.sink176.i = phi i16 [ %13, %bb.ap ], [ %i.kz, %bb.ao ]
  %gep162.i = getelementptr [2 x i8], ptr %invariant.gep161.sink.i, i64 %indvars.iv.i
  store i16 %.sink176.i, ptr %gep162.i, align 2, !tbaa !30
...
._crit_edge.split.i.split:                        ; preds = %bb.aq
  %indvars.iv.next95.i = add nsw i64 %indvars.iv94.i, %i.ay
  %exitcond100.not.i = icmp eq i64 %indvars.iv.next93.i, %wide.trip.count141.i
