...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph, %vec.epilog.scalar.ph.preheader
  ...
  store i16 %i.fq, ptr %gep171.i.us.us, align 2, !tbaa !30
  ...
  store i16 %i.ft, ptr %gep171.i.us.us.1, align 2, !tbaa !30
  ...
  store i16 %i.fw, ptr %gep171.i.us.us.2, align 2, !tbaa !30
  ...
  store i16 %i.fz, ptr %gep171.i.us.us.3, align 2, !tbaa !30
...
bb.ac:                                            ; preds = %bb.ac, %.preheader.us.us.us.us.i
  ...
  store i16 %i.gw, ptr %gep175.i.3, align 2, !tbaa !30
...
vector.body158:                                   ; preds = %vector.main.loop.iter.check154, %vector.body158
  ...
  %wide.load160 = load <8 x i16>, ptr %i.ha, align 2, !tbaa !30
  %wide.load161 = load <8 x i16>, ptr %i.hb, align 2, !tbaa !30
  ...
  br i1 %i.hg, label %middle.block163, label %vector.body158, !llvm.loop !40
...
vec.epilog.iter.check168:                         ; preds = %middle.block163
  br i1 %min.epilog.iters.check169.not.not, label %.lr.ph.split.us.us.split.us.us.split.us.split.split.us.us.i.preheader, label %vec.epilog.vector.body172.preheader, !prof !37
...
vec.epilog.vector.body172:                        ; preds = %vec.epilog.vector.body172.preheader, %vec.epilog.vector.body172
  ...
  %wide.load174 = load <8 x i16>, ptr %i.hh, align 2, !tbaa !30
  ...
  br i1 %i.hk, label %._crit_edge.split.us.us.split.us.us.split.us.split.us85.i, label %vec.epilog.vector.body172, !llvm.loop !41
...
._crit_edge.split.us.us.split.us.us.split.us.split.us85.i: ; preds = %vec.epilog.vector.body172, %.lr.ph.split.us.us.split.us.us.split.us.split.split.us.us.i, %middle.block163
  ...
  br i1 %exitcond137.not.i, label %pixMeanInterpolateBlock.exit, label %iter.check166, !llvm.loop !33
...
.lr.ph.split.us.us.split.us.us.split.us.split.split.us.us.i: ; preds = %.lr.ph.split.us.us.split.us.us.split.us.split.split.us.us.i, %.lr.ph.split.us.us.split.us.us.split.us.split.split.us.us.i.preheader
  ...
  store i16 %i.ho, ptr %gep173.i, align 2, !tbaa !30
  ...
  store i16 %i.hr, ptr %gep173.i.1, align 2, !tbaa !30
  ...
  store i16 %i.hu, ptr %gep173.i.2, align 2, !tbaa !30
  ...
  store i16 %i.hx, ptr %gep173.i.3, align 2, !tbaa !30
...
.preheader.us.us.i.split.split.us:                ; preds = %.preheader.us.us.i.split.split.us, %.preheader.us.us.i.split.split.us.preheader
  ...
  store i16 %i.il, ptr %gep171.i.us87, align 2, !tbaa !30
  ...
  store i16 %i.ix, ptr %gep171.i.us87.1, align 2, !tbaa !30
...
bb.ai:                                            ; preds = %bb.ah, %bb.ag
  ...
  store i16 %.sink176.i, ptr %gep167.i, align 2, !tbaa !30
...
bb.ao:                                            ; preds = %bb.an
  %i.kz = load i16, ptr %i.kb, align 2, !tbaa !30
...
bb.ap:                                            ; preds = %bb.an
  ...
  %i.lh = load i32, ptr %.in.i, align 4, !tbaa !4
...
bb.aq:                                            ; preds = %bb.ap, %bb.ao
  ...
  store i16 %.sink177.i, ptr %gep163.i, align 2, !tbaa !30
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count141.i
  br i1 %exitcond.not.i, label %._crit_edge.split.i.split, label %bb.aj, !llvm.loop !32
...
._crit_edge.split.i.split:                        ; preds = %bb.aq
  ...
  br i1 %exitcond100.not.i, label %pixMeanInterpolateBlock.exit, label %.preheader.i, !llvm.loop !33
