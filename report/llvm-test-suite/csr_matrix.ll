...
bb.e:                                             ; preds = %._crit_edge.us229
  %i.bt = getelementptr inbounds nuw [4 x i8], ptr %i.r, i64 %indvars.iv328
  %i.bu = load i32, ptr %i.bt, align 4, !tbaa !4
  %i.bv = sext i32 %i.bu to i64
  %i.bw = getelementptr inbounds [4 x i8], ptr %i.as, i64 %i.bv
  store i32 %i.bk, ptr %i.bw, align 4, !tbaa !4
  br label %bb.f
...
bb.f:                                             ; preds = %bb.e, %._crit_edge.us229
  ...
  br i1 %exitcond332.not, label %.loopexit210, label %.lr.ph226.us, !llvm.loop !59
...
scalar.ph519:                                     ; preds = %scalar.ph519.preheader, %scalar.ph519
  ...
  %i.bx = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %indvars.iv323
  %i.by = load i32, ptr %i.bx, align 4, !tbaa !4
  %i.bz = icmp eq i32 %i.by, %i.bk
  %spec.select198.us = select i1 %i.bz, i32 1, i32 %.2155225.us ; 2 uses
  ...
  br i1 %exitcond327.not, label %._crit_edge.us229, label %scalar.ph519, !llvm.loop !60
...
.lr.ph228.split:                                  ; preds = %.lr.ph228.split, %.lr.ph228.split.preheader.new
  ...
  br i1 %niter.ncmp.3, label %.loopexit210.loopexit569.unr-lcssa, label %.lr.ph228.split, !llvm.loop !59
