...
define internal fastcc void @ren_ResetTermStamp(ptr nofree noundef captures(none) initializes((24, 28)) %0) unnamed_addr #2 {
bb.a:
...
; Function Attrs: nounwind uwtable
define internal fastcc range(i32 -1, 2) i32 @ren_Polarity(ptr nofree noundef readonly captures(address) %0) unnamed_addr #0 {
bb.a:
...
; Function Attrs: nounwind uwtable
define internal fastcc range(i32 0, 2) i32 @ren_AExtraFactorOk(ptr nofree noundef readnone captures(address) %0, ptr nofree noundef readonly captures(address) %1) unnamed_addr #0 {
bb.a:
  %i.a = icmp eq ptr %0, %1
...
; Function Attrs: nounwind uwtable
define internal fastcc range(i32 0, 2) i32 @ren_NotPExtraFactorOk(ptr nofree noundef readonly captures(none) %0) unnamed_addr #0 {
bb.a:
...
; Function Attrs: nounwind uwtable
define internal fastcc range(i32 0, 2) i32 @ren_BExtraFactorOk(ptr nofree noundef readnone captures(address) %0, ptr nofree noundef readonly captures(address) %1) unnamed_addr #0 {
bb.a:
  %i.a = icmp eq ptr %0, %1
...
; Function Attrs: nounwind uwtable
define internal fastcc range(i32 0, 2) i32 @ren_PFactorBigger3(ptr nofree noundef readonly captures(none) %0) unnamed_addr #0 {
bb.a:
  %i.a = load i32, ptr @term_STAMP, align 4       ; 2 uses
  %i.b = getelementptr i8, ptr %0, i64 24
...
; Function Attrs: nounwind uwtable
define internal fastcc range(i32 0, 2) i32 @ren_AFactorBigger3(ptr nofree noundef readnone captures(address) %0, ptr nofree noundef readonly captures(address) %1) unnamed_addr #0 {
bb.a:
  %i.a = icmp eq ptr %0, %1
...
; Function Attrs: nounwind uwtable
define internal fastcc range(i32 0, 2) i32 @ren_BFactorBigger3(ptr nofree noundef readnone captures(address) %0, ptr nofree noundef readonly captures(address) %1) unnamed_addr #0 {
bb.a:
  %i.a = icmp eq ptr %0, %1
