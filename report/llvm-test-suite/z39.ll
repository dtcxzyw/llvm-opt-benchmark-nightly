...
define dso_local i32 @strcollcmp(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
bb.a:
...
define dso_local range(i32 0, 2) i32 @StringBeginsWith(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #5 {
bb.a:
  br label %bb.b

bb.b:                                             ; preds = %bb.c, %bb.a
  %.07 = phi ptr [ %0, %bb.a ], [ %i.b, %bb.c ]   ; 2 uses
  %.0 = phi ptr [ %1, %bb.a ], [ %i.c, %bb.c ]    ; 2 uses
  %i.a = load i8, ptr %.07, align 1, !tbaa !8     ; 2 uses
  %.not = icmp eq i8 %i.a, 0
  %.pre = load i8, ptr %.0, align 1, !tbaa !8     ; 3 uses
  %.not11 = icmp eq i8 %.pre, 0
  %or.cond = select i1 %.not, i1 true, i1 %.not11
  br i1 %or.cond, label %.critedge, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.b = getelementptr inbounds nuw i8, ptr %.07, i64 1
  %i.c = getelementptr inbounds nuw i8, ptr %.0, i64 1
  %.not12 = icmp eq i8 %i.a, %.pre
  br i1 %.not12, label %bb.b, label %.loopexit, !llvm.loop !9

.critedge:                                        ; preds = %bb.b
  %i.d = icmp eq i8 %.pre, 0
  %i.e = zext i1 %i.d to i32
  br label %.loopexit

.loopexit:                                        ; preds = %bb.c, %.critedge
  %.08 = phi i32 [ %i.e, %.critedge ], [ 0, %bb.c ]
  ret i32 %.08
}
...
bb.c:                                             ; preds = %bb.d, %bb.b
  %.014 = phi ptr [ %1, %bb.b ], [ %i.k, %bb.d ]  ; 2 uses
  %.013 = phi ptr [ %i.h, %bb.b ], [ %i.j, %bb.d ] ; 2 uses
  %i.i = load i8, ptr %.013, align 1, !tbaa !8    ; 2 uses
  %.not = icmp eq i8 %i.i, 0
  %.pre = load i8, ptr %.014, align 1, !tbaa !8   ; 3 uses
  %.not19 = icmp eq i8 %.pre, 0
  %or.cond = select i1 %.not, i1 true, i1 %.not19
  br i1 %or.cond, label %.critedge, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.j = getelementptr inbounds nuw i8, ptr %.013, i64 1
  %i.k = getelementptr inbounds nuw i8, ptr %.014, i64 1
  %.not20 = icmp eq i8 %i.i, %.pre
  br i1 %.not20, label %bb.c, label %.loopexit, !llvm.loop !11
...
.loopexit:                                        ; preds = %bb.d, %bb.a, %.critedge
  %.0 = phi i32 [ %i.m, %.critedge ], [ 0, %bb.a ], [ 0, %bb.d ]
  ret i32 %.0
}
...
; Function Attrs: nofree norecurse nosync nounwind memory(argmem: read) uwtable
define dso_local range(i32 0, 2) i32 @StringContains(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #5 {
bb.a:
  %i.a = load i8, ptr %0, align 1, !tbaa !8
  %.not10 = icmp eq i8 %i.a, 0
  br i1 %.not10, label %._crit_edge, label %.preheader

.preheader:                                       ; preds = %bb.a, %StringBeginsWith.exit.thread
  %.011 = phi ptr [ %i.e, %StringBeginsWith.exit.thread ], [ %0, %bb.a ] ; 2 uses
  br label %bb.b

bb.b:                                             ; preds = %.preheader, %bb.c
  %.07.i = phi ptr [ %i.c, %bb.c ], [ %.011, %.preheader ] ; 2 uses
  %.0.i = phi ptr [ %i.d, %bb.c ], [ %1, %.preheader ] ; 2 uses
  %i.b = load i8, ptr %.07.i, align 1, !tbaa !8   ; 2 uses
  %.not.i = icmp eq i8 %i.b, 0
  %.pre.i = load i8, ptr %.0.i, align 1, !tbaa !8 ; 2 uses
  %.not11.i = icmp eq i8 %.pre.i, 0               ; 2 uses
  %or.cond.i = select i1 %.not.i, i1 true, i1 %.not11.i
  br i1 %or.cond.i, label %StringBeginsWith.exit, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.c = getelementptr inbounds nuw i8, ptr %.07.i, i64 1
  %i.d = getelementptr inbounds nuw i8, ptr %.0.i, i64 1
  %.not12.i = icmp eq i8 %i.b, %.pre.i
  br i1 %.not12.i, label %bb.b, label %StringBeginsWith.exit.thread, !llvm.loop !9

StringBeginsWith.exit:                            ; preds = %bb.b
  br i1 %.not11.i, label %._crit_edge, label %StringBeginsWith.exit.thread

StringBeginsWith.exit.thread:                     ; preds = %bb.c, %StringBeginsWith.exit
...
._crit_edge:                                      ; preds = %StringBeginsWith.exit, %StringBeginsWith.exit.thread, %bb.a
  %.05 = phi i32 [ 0, %bb.a ], [ 0, %StringBeginsWith.exit.thread ], [ 1, %StringBeginsWith.exit ]
  ret i32 %.05
}
...
bb.c:                                             ; preds = %bb.b, %bb.a
  store i8 34, ptr @StringQuotedWord.buff, align 16, !tbaa !8
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 64 ; 2 uses
  %i.g = load i8, ptr %i.f, align 1, !tbaa !8     ; 2 uses
  %.not17 = icmp eq i8 %i.g, 0
  br i1 %.not17, label %._crit_edge22, label %.lr.ph21

.lr.ph21:                                         ; preds = %bb.c, %._crit_edge
  %i.h = phi i8 [ %i.r, %._crit_edge ], [ %i.g, %bb.c ]
  %.01119 = phi ptr [ %.1.lcssa, %._crit_edge ], [ getelementptr inbounds nuw (i8, ptr @StringQuotedWord.buff, i64 1), %bb.c ] ; 2 uses
  %.01218 = phi ptr [ %i.q, %._crit_edge ], [ %i.f, %bb.c ]
  %i.i = zext i8 %i.h to i64
  %i.j = getelementptr inbounds nuw [8 x i8], ptr @quoted_string, i64 %i.i
  %i.k = load ptr, ptr %i.j, align 8, !tbaa !15   ; 2 uses
  %i.l = load i8, ptr %i.k, align 1, !tbaa !8     ; 2 uses
  %.not1314 = icmp eq i8 %i.l, 0
  br i1 %.not1314, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph21, %.lr.ph
  %i.m = phi i8 [ %i.p, %.lr.ph ], [ %i.l, %.lr.ph21 ]
  %.016 = phi ptr [ %i.n, %.lr.ph ], [ %i.k, %.lr.ph21 ]
  %.115 = phi ptr [ %i.o, %.lr.ph ], [ %.01119, %.lr.ph21 ] ; 2 uses
  %i.n = getelementptr inbounds nuw i8, ptr %.016, i64 1 ; 2 uses
  %i.o = getelementptr inbounds nuw i8, ptr %.115, i64 1 ; 2 uses
  store i8 %i.m, ptr %.115, align 1, !tbaa !8
  %i.p = load i8, ptr %i.n, align 1, !tbaa !8     ; 2 uses
  %.not13 = icmp eq i8 %i.p, 0
  br i1 %.not13, label %._crit_edge, label %.lr.ph, !llvm.loop !17

._crit_edge:                                      ; preds = %.lr.ph, %.lr.ph21
  %.1.lcssa = phi ptr [ %.01119, %.lr.ph21 ], [ %i.o, %.lr.ph ] ; 2 uses
  %i.q = getelementptr inbounds nuw i8, ptr %.01218, i64 1 ; 2 uses
  %i.r = load i8, ptr %i.q, align 1, !tbaa !8     ; 2 uses
  %.not = icmp eq i8 %i.r, 0
  br i1 %.not, label %._crit_edge22, label %.lr.ph21, !llvm.loop !18

._crit_edge22:                                    ; preds = %._crit_edge, %bb.c
  %.011.lcssa = phi ptr [ getelementptr inbounds nuw (i8, ptr @StringQuotedWord.buff, i64 1), %bb.c ], [ %.1.lcssa, %._crit_edge ] ; 2 uses
  %i.s = getelementptr inbounds nuw i8, ptr %.011.lcssa, i64 1
  store i8 34, ptr %.011.lcssa, align 1, !tbaa !8
