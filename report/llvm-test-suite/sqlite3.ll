...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.aka = select <2 x i1> %i.ajs, <2 x i64> %i.ajy, <2 x i64> splat (i64 -1)
  %i.akb = select <2 x i1> %i.ajt, <2 x i64> %i.ajz, <2 x i64> splat (i64 -1)
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.akm = select i1 %i.aki, i64 %i.akl, i64 -1
