...
begin_hunk_1_@zeroPage:bb.a
  ...
  %i.ab = trunc nuw nsw i32 %3 to i16             ; 2 uses
  %i.ac = sub i16 %i.aa, %i.ab
...
begin_hunk_2_@zeroPage:bb.a
  ...
  store i16 %i.ab, ptr %i.ba, align 2, !tbaa !809
...
begin_hunk_5_@balance_nonroot:bb.a
  ...
  %i.xa = trunc nuw nsw i32 %6 to i16             ; 2 uses
  %i.xb = sub i16 %i.wz, %i.xa
...
begin_hunk_6_@balance_nonroot:bb.a
  ...
  store i16 %i.xa, ptr %i.xo, align 2, !tbaa !809
...
begin_hunk_7_@balance_quick:bb.a
  ...
  %i.ai = and i32 %i.ah, 4
  %4 = xor i32 %i.ai, 12
  %5 = add nuw nsw i32 %4, %i.z                   ; 2 uses
...
begin_hunk_8_@balance_quick:bb.a
  ...
  %i.at = trunc nuw nsw i32 %5 to i16             ; 2 uses
  %i.au = sub i16 %i.as, %i.at
...
begin_hunk_9_@balance_quick:bb.a
  ...
  store i16 %i.at, ptr %i.bs, align 2, !tbaa !809
