...
iter.check:                                       ; preds = %bb.cv
  %i.ok = call i32 @llvm.smin.i32(i32 %.2372, i32 340)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %offset.idx = sub i64 %smin, %index             ; 2 uses
  %i.pd = trunc i64 %offset.idx to i32
  %i.pe = sub nsw i32 %i.pd, %i.oj
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index1746 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next1750, %vec.epilog.vector.body ] ; 2 uses
  %i.po = sub i64 %smin, %index1746               ; 2 uses
  %i.pp = trunc i64 %i.po to i32
  %i.pq = sub nsw i32 %i.pp, %i.oj
