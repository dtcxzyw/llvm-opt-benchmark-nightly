...
bb.l:                                             ; preds = %bb.k, %bb.j, %bb.i
  ...
  %.0.i = phi i32 [ 1, %bb.j ], [ 0, %bb.k ], [ 0, %bb.i ] ; 2 uses
  br label %bb.m
...
bb.n:                                             ; preds = %.preheader.i
  ...
  %4 = sub nuw nsw i32 1, %.0.i
  %spec.select.i = select i1 %.not.i, i32 %.0.i, i32 %4
...
sqlite3FitsIn64Bits.exit:                         ; preds = %bb.p, %bb.q
  ...
  %.not50 = icmp slt i32 %.0.i.i22, %spec.select.i
...
begin_hunk_4_@codeInteger:bb.a
  ...
  %spec.select = select i1 %.not.i, i64 %i.cb, i64 %i.cc
