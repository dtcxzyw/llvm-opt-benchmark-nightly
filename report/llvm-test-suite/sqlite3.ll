...
bb.c:                                             ; preds = %bb.a
  %i.f = icmp eq i8 %3, 0                         ; 3 uses
  %i.g = select i1 %i.f, i32 16, i32 2
...
bb.f:                                             ; preds = %bb.e
  %.not57 = icmp samesign ult i32 %.046, 32
  %i.p = icmp eq i8 %3, 1
...
bb.e:                                             ; preds = %bb.c, %bb.d
  %.046.i9 = phi i16 [ 98, %bb.d ], [ 66, %bb.c ]
  %.3.i7 = phi i32 [ %.249.i, %bb.d ], [ %2, %bb.c ] ; 2 uses
  %3 = phi i32 [ 1, %bb.d ], [ 0, %bb.c ]
  %.0.i = add nsw i32 %3, %.3.i7                  ; 2 uses
...
begin_hunk_5_@sqlite3_result_error:bb.a
  ...
  store i32 %.3.i7, ptr %i.l, align 8, !tbaa !123
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 52
  store i16 %.046.i9, ptr %i.m, align 4, !tbaa !124
...
begin_hunk_6_@sqlite3FindFunction:bb.a
  ...
  %i.aq = icmp eq i32 %spec.store.select, %i.ap   ; 4 uses
...
bb.i:                                             ; preds = %bb.h
  %6 = select i1 %i.aq, i32 6, i32 3
  br label %bb.k

bb.j:                                             ; preds = %bb.h
  %spec.select = select i1 %i.aq, i32 4, i32 1
  ...
  %7 = select i1 %i.aq, i32 5, i32 2
  %spec.select118 = select i1 %or.cond115, i32 %7, i32 %spec.select
  br label %bb.k
...
bb.j:                                             ; preds = %bb.h, %bb.i
  %.046.i34 = phi i16 [ 98, %bb.i ], [ 66, %bb.h ]
  %.3.i32 = phi i32 [ %.249.i26, %bb.i ], [ %4, %bb.h ] ; 2 uses
  %5 = phi i32 [ 1, %bb.i ], [ 0, %bb.h ]
  %.0.i = add nsw i32 %5, %.3.i32                 ; 2 uses
...
begin_hunk_8_@sqlite3VdbeSetColName:bb.a
  ...
  store i32 %.3.i32, ptr %i.ah, align 8, !tbaa !123
  %i.ai = getelementptr inbounds nuw i8, ptr %i.k, i64 36
  store i16 %.046.i34, ptr %i.ai, align 4, !tbaa !124
...
bb.bx:                                            ; preds = %sqlite3PagerLockingMode.exit804, %bb.br
  ...
  %i.lw = icmp eq i8 %.0619.in, 1                 ; 3 uses
...
begin_hunk_10_@sqlite3Pragma:bb.a
  ...
  %5 = select i1 %i.lw, i32 10, i32 7
  %i.oh = tail call ptr @sqlite3_malloc(i32 noundef %5) ; 4 uses
  %.not.i.i.i1502 = icmp eq ptr %i.oh, null
  br i1 %.not.i.i.i1502, label %sqlite3StrNDup.exit.i.i1503, label %bb.ci

bb.ci:                                            ; preds = %bb.ch
  %6 = select i1 %i.lw, i64 9, i64 6              ; 2 uses
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(6) %i.oh, ptr noundef nonnull readonly align 1 dereferenceable(6) %spec.select718, i64 %6, i1 false)
...
findTerm.exit264.i:                               ; preds = %.thread.us.i261.i, %bb.cq
  ...
  %.not208.i = icmp eq ptr %.039.i255.i, null     ; 3 uses
  %i.pl = fdiv double %i.od, 3.000000e+00
  %.0185.i = select i1 %.not208.i, i32 512, i32 66048
...
findTerm.exit276.i:                               ; preds = %bb.ct
  %7 = select i1 %.not208.i, i32 131584, i32 197120
