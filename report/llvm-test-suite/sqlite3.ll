...
.thread201.i.i:                                   ; preds = %bb.ag, %.thread220.i.i, %bb.af, %bb.ae
  ...
  %.0158207.i.i = phi i32 [ %7, %.thread220.i.i ], [ %7, %bb.ag ], [ 0, %bb.ae ], [ 0, %bb.af ]
...
begin_hunk_15_@sqlite3BtreeFactory:bb.a
  ...
  %.0158206.i.i = phi i32 [ %7, %bb.ag ], [ %.0158207.i.i, %.thread201.i.i ], [ 0, %bb.ab ] ; 2 uses
...
begin_hunk_16_@sqlite3BtreeFactory:bb.a
  ...
  store i8 %10, ptr %i.gz, align 1, !tbaa !848
...
begin_hunk_17_@sqlite3BtreeFactory:bb.a
  ...
  store i8 %11, ptr %i.hj, align 4, !tbaa !881
...
bb.d:                                             ; preds = %bb.c
  ...
  %6 = icmp ne i8 %5, 0
  %7 = zext i1 %6 to i8
  store i8 %7, ptr %i.m, align 8, !tbaa !1299
  br label %bb.l
