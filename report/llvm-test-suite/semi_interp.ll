...
bb.c:                                             ; preds = %bb.b
  ...
  %i.bt = getelementptr inbounds nuw [24 x i8], ptr %i.bs, i64 %indvars.iv642 ; 4 uses
  ...
  %i.cf = getelementptr inbounds nuw [24 x i8], ptr %i.ce, i64 %indvars.iv642 ; 5 uses
  ...
  %i.cq = getelementptr inbounds nuw [4 x i8], ptr %i.cp, i64 %indvars.iv642
...
.preheader544.us.us:                              ; preds = %.preheader544.us.us.preheader, %._crit_edge556.split.us.us.us
  %.0451565.us.us = phi i32 [ %i.ho, %._crit_edge556.split.us.us.us ], [ %i.ew, %.preheader544.us.us.preheader ]
  %.0454564.us.us = phi i32 [ %i.hn, %._crit_edge556.split.us.us.us ], [ %i.dv, %.preheader544.us.us.preheader ]
  %.1488563.us.us = phi i32 [ %i.hp, %._crit_edge556.split.us.us.us ], [ 0, %.preheader544.us.us.preheader ]
  br label %.preheader543.us.us.us

.preheader543.us.us.us:                           ; preds = %._crit_edge.us.us.us, %.preheader544.us.us
  %.1452555.us.us.us = phi i32 [ %.0451565.us.us, %.preheader544.us.us ], [ %i.hl, %._crit_edge.us.us.us ]
  %.1455554.us.us.us = phi i32 [ %.0454564.us.us, %.preheader544.us.us ], [ %i.hk, %._crit_edge.us.us.us ]
  %.1484553.us.us.us = phi i32 [ 0, %.preheader544.us.us ], [ %i.hm, %._crit_edge.us.us.us ]
  %i.fx = sext i32 %.1452555.us.us.us to i64      ; 5 uses
  %i.fy = sext i32 %.1455554.us.us.us to i64      ; 5 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %invariant.gep742 = getelementptr [8 x i8], ptr %i.cm, i64 %i.fy
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load692 = load <2 x double>, ptr %i.gi, align 8, !tbaa !47
  %gep743 = getelementptr [8 x i8], ptr %invariant.gep742, i64 %index ; 2 uses
  %i.gj = getelementptr inbounds nuw i8, ptr %gep743, i64 16
  store <2 x double> %wide.load, ptr %gep743, align 8, !tbaa !47
  store <2 x double> %wide.load692, ptr %i.gj, align 8, !tbaa !47
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.preheader543.us.us.us, %middle.block
  %indvars.iv635.ph = phi i64 [ %i.fy, %vector.memcheck ], [ %i.fy, %.preheader543.us.us.us ], [ %i.gg, %middle.block ] ; 2 uses
  %indvars.iv633.ph = phi i64 [ %i.fx, %vector.memcheck ], [ %i.fx, %.preheader543.us.us.us ], [ %i.gh, %middle.block ] ; 2 uses
  %.1477549.us.us.us.ph = phi i32 [ 0, %vector.memcheck ], [ 0, %.preheader543.us.us.us ], [ %i.fw, %middle.block ] ; 4 uses
  %i.gl = sub i32 %i.fe, %.1477549.us.us.us.ph
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  %.1477549.us.us.us.prol = phi i32 [ %i.gp, %scalar.ph.prol ], [ %.1477549.us.us.us.ph, %scalar.ph.preheader ]
  %prol.iter = phi i32 [ %prol.iter.next, %scalar.ph.prol ], [ 0, %scalar.ph.preheader ]
  %i.gm = getelementptr inbounds [8 x i8], ptr %i.ct, i64 %indvars.iv633.prol
  %i.gn = load double, ptr %i.gm, align 8, !tbaa !47
  %i.go = getelementptr inbounds [8 x i8], ptr %i.cm, i64 %indvars.iv635.prol
  store double %i.gn, ptr %i.go, align 8, !tbaa !47
  %indvars.iv.next636.prol = add nsw i64 %indvars.iv635.prol, %i.fu ; 3 uses
  %indvars.iv.next634.prol = add nsw i64 %indvars.iv633.prol, 1 ; 3 uses
  %i.gp = add nuw nsw i32 %.1477549.us.us.us.prol, 1 ; 2 uses
...
scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  ...
  %.1477549.us.us.us.unr = phi i32 [ %.1477549.us.us.us.ph, %scalar.ph.preheader ], [ %i.gp, %scalar.ph.prol ]
  %i.gq = sub i32 %.1477549.us.us.us.ph, %i.fe
  %i.gr = icmp ugt i32 %i.gq, -4
  br i1 %i.gr, label %._crit_edge.us.us.us, label %scalar.ph
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %.1477549.us.us.us = phi i32 [ %i.hh, %scalar.ph ], [ %.1477549.us.us.us.unr, %scalar.ph.prol.loopexit ]
  %i.gs = getelementptr inbounds [8 x i8], ptr %i.ct, i64 %indvars.iv633
  %i.gt = load double, ptr %i.gs, align 8, !tbaa !47
  %i.gu = getelementptr inbounds [8 x i8], ptr %i.cm, i64 %indvars.iv635
  store double %i.gt, ptr %i.gu, align 8, !tbaa !47
  %indvars.iv.next636 = add nsw i64 %indvars.iv635, %i.fu ; 2 uses
  %i.gv = getelementptr [8 x i8], ptr %i.ct, i64 %indvars.iv633
  %i.gw = getelementptr i8, ptr %i.gv, i64 8
  %i.gx = load double, ptr %i.gw, align 8, !tbaa !47
  %i.gy = getelementptr inbounds [8 x i8], ptr %i.cm, i64 %indvars.iv.next636
  store double %i.gx, ptr %i.gy, align 8, !tbaa !47
  %indvars.iv.next636.1 = add nsw i64 %indvars.iv.next636, %i.fu ; 2 uses
  %i.gz = getelementptr [8 x i8], ptr %i.ct, i64 %indvars.iv633
  %i.ha = getelementptr i8, ptr %i.gz, i64 16
  %i.hb = load double, ptr %i.ha, align 8, !tbaa !47
  %i.hc = getelementptr inbounds [8 x i8], ptr %i.cm, i64 %indvars.iv.next636.1
  store double %i.hb, ptr %i.hc, align 8, !tbaa !47
  %indvars.iv.next636.2 = add nsw i64 %indvars.iv.next636.1, %i.fu ; 2 uses
  %i.hd = getelementptr [8 x i8], ptr %i.ct, i64 %indvars.iv633
  %i.he = getelementptr i8, ptr %i.hd, i64 24
  %i.hf = load double, ptr %i.he, align 8, !tbaa !47
  %i.hg = getelementptr inbounds [8 x i8], ptr %i.cm, i64 %indvars.iv.next636.2
  store double %i.hf, ptr %i.hg, align 8, !tbaa !47
  %indvars.iv.next636.3 = add nsw i64 %indvars.iv.next636.2, %i.fu ; 2 uses
  %indvars.iv.next634.3 = add nsw i64 %indvars.iv633, 4 ; 2 uses
  %i.hh = add nuw nsw i32 %.1477549.us.us.us, 4   ; 2 uses
...
._crit_edge.us.us.us:                             ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  %indvars.iv.next636.lcssa = phi i64 [ %i.gg, %middle.block ], [ %indvars.iv.next636.lcssa732.unr, %scalar.ph.prol.loopexit ], [ %indvars.iv.next636.3, %scalar.ph ]
  %indvars.iv.next634.lcssa = phi i64 [ %i.gh, %middle.block ], [ %indvars.iv.next634.lcssa731.unr, %scalar.ph.prol.loopexit ], [ %indvars.iv.next634.3, %scalar.ph ]
  %i.hi = trunc nsw i64 %indvars.iv.next636.lcssa to i32
  %i.hj = trunc nsw i64 %indvars.iv.next634.lcssa to i32
  %i.hk = add nsw i32 %i.fq, %i.hi                ; 2 uses
  %i.hl = add nsw i32 %i.fr, %i.hj                ; 2 uses
  %i.hm = add nuw nsw i32 %.1484553.us.us.us, 1   ; 2 uses
  %exitcond640.not = icmp eq i32 %i.hm, %i.ff
...
._crit_edge556.split.us.us.us:                    ; preds = %._crit_edge.us.us.us
  ...
  %i.hp = add nuw nsw i32 %.1488563.us.us, 1      ; 2 uses
  %exitcond641.not = icmp eq i32 %i.hp, %i.fg
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  br i1 %i.ia, label %.lr.ph610, label %._crit_edge611

.lr.ph610:                                        ; preds = %bb.m, %._crit_edge607
  %i.ib = phi i32 [ %i.sc, %._crit_edge607 ], [ %i.hz, %bb.m ]
  %indvars.iv658 = phi i64 [ %indvars.iv.next659, %._crit_edge607 ], [ 0, %bb.m ] ; 6 uses
  %i.ic = load ptr, ptr %.1444, align 8, !tbaa !63
  %i.id = getelementptr inbounds nuw [8 x i8], ptr %i.ic, i64 %indvars.iv658
...
bb.r:                                             ; preds = %bb.q, %bb.p
  ...
  %i.jz = getelementptr inbounds nuw [4 x i8], ptr %i.jy, i64 %indvars.iv658
...
bb.v:                                             ; preds = %bb.t, %bb.u
  ...
  br i1 %i.ln, label %.lr.ph, label %._crit_edge607
...
.lr.ph:                                           ; preds = %bb.v
  ...
  %diff.check701 = icmp ult i64 %i.ly, 32
  %diff.check703 = icmp ult i64 %i.lz, 32
...
bb.w:                                             ; preds = %.lr.ph, %._crit_edge600.split
  ...
  %i.mb = getelementptr inbounds nuw [24 x i8], ptr %i.ma, i64 %indvars.iv655 ; 4 uses
...
bb.ac:                                            ; preds = %bb.aa, %bb.ab
  ...
  br i1 %i.or, label %.preheader541.lr.ph, label %._crit_edge600.split

.preheader541.lr.ph:                              ; preds = %bb.ac
  %factor.op.mul599 = mul i32 %i.op, %i.om
  %factor.op.mul598 = mul i32 %i.op, %i.od
...
.preheader540.us.us.preheader:                    ; preds = %.preheader541.lr.ph
  ...
  %min.iters.check706 = icmp ugt i32 %i.oo, 5
  %ident.check696.not = icmp eq i32 %i.oh, 1
  %or.cond727 = select i1 %min.iters.check706, i1 %ident.check696.not, i1 false
  %n.vec709 = and i64 %i.pb, 2147483644           ; 5 uses
  %i.pc = trunc nuw nsw i64 %n.vec709 to i32
  %cmp.n722 = icmp eq i64 %n.vec709, %i.pb
  br label %.preheader540.us.us

.preheader540.us.us:                              ; preds = %.preheader540.us.us.preheader, %._crit_edge584.split.us.us.us
  %.0448594.us.us = phi i32 [ %i.rw, %._crit_edge584.split.us.us.us ], [ %i.nf, %.preheader540.us.us.preheader ]
  %.3457593.us.us = phi i32 [ %i.rx, %._crit_edge584.split.us.us.us ], [ %i.oc, %.preheader540.us.us.preheader ]
  %.3490592.us.us = phi i32 [ %i.ry, %._crit_edge584.split.us.us.us ], [ 0, %.preheader540.us.us.preheader ]
  br label %.preheader.us.us.us

.preheader.us.us.us:                              ; preds = %._crit_edge578.us.us.us, %.preheader540.us.us
  %.1449583.us.us.us = phi i32 [ %.0448594.us.us, %.preheader540.us.us ], [ %i.rt, %._crit_edge578.us.us.us ]
  %.4582.us.us.us = phi i32 [ %.3457593.us.us, %.preheader540.us.us ], [ %i.ru, %._crit_edge578.us.us.us ]
  %.3486581.us.us.us = phi i32 [ 0, %.preheader540.us.us ], [ %i.rv, %._crit_edge578.us.us.us ]
  %i.pd = sext i32 %.1449583.us.us.us to i64      ; 5 uses
  %i.pe = sext i32 %.4582.us.us.us to i64         ; 5 uses
...
vector.memcheck697:                               ; preds = %.preheader.us.us.us
  ...
  %i.pi = add i64 %i.pg, %.0459698
  %i.pj = sub i64 %i.ph, %i.pi
  %diff.check699 = icmp ult i64 %i.pj, 32
  %i.pk = add i64 %i.lv, %i.pf
  %i.pl = add i64 %i.lx, %i.pg
  %i.pm = sub i64 %i.pk, %i.pl
  %diff.check700 = icmp ult i64 %i.pm, 32
...
vector.ph707:                                     ; preds = %vector.memcheck697
  %i.pn = add nsw i64 %n.vec709, %i.pe            ; 2 uses
  %i.po = add nsw i64 %n.vec709, %i.pd            ; 2 uses
...
vector.body710:                                   ; preds = %vector.body710, %vector.ph707
  ...
  %i.pp = add i64 %index711, %i.pe                ; 3 uses
  %i.pq = add i64 %index711, %i.pd                ; 2 uses
  %i.pr = getelementptr inbounds [8 x i8], ptr %.0458, i64 %i.pq ; 2 uses
  %i.ps = getelementptr inbounds nuw i8, ptr %i.pr, i64 16
  %wide.load712 = load <2 x double>, ptr %i.pr, align 8, !tbaa !47
  %wide.load713 = load <2 x double>, ptr %i.ps, align 8, !tbaa !47
  %i.pt = getelementptr inbounds [8 x i8], ptr %i.ky, i64 %i.pp ; 2 uses
  %i.pu = getelementptr inbounds nuw i8, ptr %i.pt, i64 16
  %wide.load714 = load <2 x double>, ptr %i.pt, align 8, !tbaa !47
  %wide.load715 = load <2 x double>, ptr %i.pu, align 8, !tbaa !47
  %i.pv = getelementptr inbounds [8 x i8], ptr %.0459, i64 %i.pq ; 2 uses
  %i.pw = getelementptr inbounds nuw i8, ptr %i.pv, i64 16
  %wide.load716 = load <2 x double>, ptr %i.pv, align 8, !tbaa !47
  %wide.load717 = load <2 x double>, ptr %i.pw, align 8, !tbaa !47
  %i.px = getelementptr inbounds [8 x i8], ptr %i.lk, i64 %i.pp ; 2 uses
  %i.py = getelementptr inbounds nuw i8, ptr %i.px, i64 16
  %wide.load718 = load <2 x double>, ptr %i.px, align 8, !tbaa !47
  %wide.load719 = load <2 x double>, ptr %i.py, align 8, !tbaa !47
  %i.pz = fmul <2 x double> %wide.load716, %wide.load718
  %i.qa = fmul <2 x double> %wide.load717, %wide.load719
  %i.qb = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load712, <2 x double> %wide.load714, <2 x double> %i.pz)
  %i.qc = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load713, <2 x double> %wide.load715, <2 x double> %i.qa)
  ...
  %i.qf = icmp eq i64 %index.next720, %n.vec709
  br i1 %i.qf, label %middle.block721, label %vector.body710, !llvm.loop !69
...
scalar.ph705.preheader:                           ; preds = %vector.memcheck697, %.preheader.us.us.us, %middle.block721
  %indvars.iv647.ph = phi i64 [ %i.pe, %vector.memcheck697 ], [ %i.pe, %.preheader.us.us.us ], [ %i.pn, %middle.block721 ] ; 5 uses
  %indvars.iv645.ph = phi i64 [ %i.pd, %vector.memcheck697 ], [ %i.pd, %.preheader.us.us.us ], [ %i.po, %middle.block721 ] ; 4 uses
  %.3479575.us.us.us.ph = phi i32 [ 0, %vector.memcheck697 ], [ 0, %.preheader.us.us.us ], [ %i.pc, %middle.block721 ] ; 4 uses
  %i.qg = sub i32 %i.oo, %.3479575.us.us.us.ph
  %.neg = add i32 %.3479575.us.us.us.ph, 1
  %xtraiter735 = and i32 %i.qg, 1
...
scalar.ph705.prol:                                ; preds = %scalar.ph705.preheader
  %i.qh = getelementptr inbounds [8 x i8], ptr %.0458, i64 %indvars.iv645.ph
  %i.qi = load double, ptr %i.qh, align 8, !tbaa !47
  %i.qj = getelementptr inbounds [8 x i8], ptr %i.ky, i64 %indvars.iv647.ph
  %i.qk = load double, ptr %i.qj, align 8, !tbaa !47
  %i.ql = getelementptr inbounds [8 x i8], ptr %.0459, i64 %indvars.iv645.ph
  %i.qm = load double, ptr %i.ql, align 8, !tbaa !47
  %i.qn = getelementptr inbounds [8 x i8], ptr %i.lk, i64 %indvars.iv647.ph
  ...
  %i.qr = getelementptr inbounds [8 x i8], ptr %i.kc, i64 %indvars.iv647.ph
  store double %i.qq, ptr %i.qr, align 8, !tbaa !47
  %indvars.iv.next646.prol = add nsw i64 %indvars.iv645.ph, 1 ; 2 uses
  %indvars.iv.next648.prol = add nsw i64 %indvars.iv647.ph, %i.pa ; 2 uses
  %i.qs = add nuw nsw i32 %.3479575.us.us.us.ph, 1
...
scalar.ph705.prol.loopexit:                       ; preds = %scalar.ph705.prol, %scalar.ph705.preheader
  ...
  %indvars.iv647.unr = phi i64 [ %indvars.iv647.ph, %scalar.ph705.preheader ], [ %indvars.iv.next648.prol, %scalar.ph705.prol ]
  %indvars.iv645.unr = phi i64 [ %indvars.iv645.ph, %scalar.ph705.preheader ], [ %indvars.iv.next646.prol, %scalar.ph705.prol ]
  %.3479575.us.us.us.unr = phi i32 [ %.3479575.us.us.us.ph, %scalar.ph705.preheader ], [ %i.qs, %scalar.ph705.prol ]
  %i.qt = icmp eq i32 %i.oo, %.neg
  br i1 %i.qt, label %._crit_edge578.us.us.us, label %scalar.ph705
...
scalar.ph705:                                     ; preds = %scalar.ph705.prol.loopexit, %scalar.ph705
  ...
  %indvars.iv645 = phi i64 [ %indvars.iv.next646.1, %scalar.ph705 ], [ %indvars.iv645.unr, %scalar.ph705.prol.loopexit ] ; 4 uses
  %.3479575.us.us.us = phi i32 [ %i.rq, %scalar.ph705 ], [ %.3479575.us.us.us.unr, %scalar.ph705.prol.loopexit ]
  %i.qu = getelementptr inbounds [8 x i8], ptr %.0458, i64 %indvars.iv645
  %i.qv = load double, ptr %i.qu, align 8, !tbaa !47
  %i.qw = getelementptr inbounds [8 x i8], ptr %i.ky, i64 %indvars.iv647
  %i.qx = load double, ptr %i.qw, align 8, !tbaa !47
  %i.qy = getelementptr inbounds [8 x i8], ptr %.0459, i64 %indvars.iv645
  %i.qz = load double, ptr %i.qy, align 8, !tbaa !47
  %i.ra = getelementptr inbounds [8 x i8], ptr %i.lk, i64 %indvars.iv647
  ...
  %i.re = getelementptr inbounds [8 x i8], ptr %i.kc, i64 %indvars.iv647
  store double %i.rd, ptr %i.re, align 8, !tbaa !47
  %indvars.iv.next646 = add nsw i64 %indvars.iv645, 1 ; 2 uses
  %indvars.iv.next648 = add nsw i64 %indvars.iv647, %i.pa ; 4 uses
  %i.rf = getelementptr inbounds [8 x i8], ptr %.0458, i64 %indvars.iv.next646
  %i.rg = load double, ptr %i.rf, align 8, !tbaa !47
  %i.rh = getelementptr inbounds [8 x i8], ptr %i.ky, i64 %indvars.iv.next648
  %i.ri = load double, ptr %i.rh, align 8, !tbaa !47
  %i.rj = getelementptr inbounds [8 x i8], ptr %.0459, i64 %indvars.iv.next646
  %i.rk = load double, ptr %i.rj, align 8, !tbaa !47
  %i.rl = getelementptr inbounds [8 x i8], ptr %i.lk, i64 %indvars.iv.next648
  ...
  %i.rp = getelementptr inbounds [8 x i8], ptr %i.kc, i64 %indvars.iv.next648
  store double %i.ro, ptr %i.rp, align 8, !tbaa !47
  %indvars.iv.next646.1 = add nsw i64 %indvars.iv645, 2 ; 2 uses
  %indvars.iv.next648.1 = add nsw i64 %indvars.iv.next648, %i.pa ; 2 uses
  %i.rq = add nuw nsw i32 %.3479575.us.us.us, 2   ; 2 uses
  %exitcond652.not.1 = icmp eq i32 %i.rq, %i.oo
...
._crit_edge578.us.us.us:                          ; preds = %scalar.ph705.prol.loopexit, %scalar.ph705, %middle.block721
  %indvars.iv.next646.lcssa = phi i64 [ %i.po, %middle.block721 ], [ %indvars.iv.next646.lcssa729.unr, %scalar.ph705.prol.loopexit ], [ %indvars.iv.next646.1, %scalar.ph705 ]
  %indvars.iv.next648.lcssa = phi i64 [ %i.pn, %middle.block721 ], [ %indvars.iv.next648.lcssa728.unr, %scalar.ph705.prol.loopexit ], [ %indvars.iv.next648.1, %scalar.ph705 ]
  %i.rr = trunc nsw i64 %indvars.iv.next648.lcssa to i32
  %i.rs = trunc nsw i64 %indvars.iv.next646.lcssa to i32
  %i.rt = add nsw i32 %i.ow, %i.rs                ; 2 uses
  %i.ru = add nsw i32 %i.ox, %i.rr                ; 2 uses
  %i.rv = add nuw nsw i32 %.3486581.us.us.us, 1   ; 2 uses
  %exitcond653.not = icmp eq i32 %i.rv, %i.op
...
._crit_edge584.split.us.us.us:                    ; preds = %._crit_edge578.us.us.us
  ...
  %i.ry = add nuw nsw i32 %.3490592.us.us, 1      ; 2 uses
  %exitcond654.not = icmp eq i32 %i.ry, %i.oq
...
._crit_edge600.split:                             ; preds = %._crit_edge584.split.us.us.us, %.preheader541.lr.ph, %bb.ac
  ...
  %i.sb = icmp slt i64 %indvars.iv.next656, %i.sa
  br i1 %i.sb, label %bb.w, label %._crit_edge607.loopexit, !llvm.loop !73

._crit_edge607.loopexit:                          ; preds = %._crit_edge600.split
  %.pre662 = load i32, ptr %i.hy, align 8, !tbaa !60
  br label %._crit_edge607

._crit_edge607:                                   ; preds = %._crit_edge607.loopexit, %bb.v
  %i.sc = phi i32 [ %.pre662, %._crit_edge607.loopexit ], [ %i.ib, %bb.v ] ; 2 uses
  %indvars.iv.next659 = add nuw nsw i64 %indvars.iv658, 1 ; 2 uses
  %i.sd = sext i32 %i.sc to i64
  %i.se = icmp slt i64 %indvars.iv.next659, %i.sd
  br i1 %i.se, label %.lr.ph610, label %._crit_edge611, !llvm.loop !74
