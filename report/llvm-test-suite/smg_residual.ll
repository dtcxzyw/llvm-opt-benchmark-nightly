...
.preheader554.us.us.us.preheader:                 ; preds = %.preheader555.lr.ph.us
  ...
  %5 = shl nsw i64 %i.ii, 3                       ; 2 uses
  %i.nr = shl nsw i64 %i.jd, 3                    ; 2 uses
  %6 = getelementptr i8, ptr %i.ie, i64 %5
  %scevgep749 = getelementptr i8, ptr %6, i64 %i.nr
  %scevgep751 = getelementptr i8, ptr %i.ie, i64 8
  %7 = getelementptr i8, ptr %scevgep751, i64 %5
  %i.ns = getelementptr i8, ptr %7, i64 %i.nr
