...
.preheader.i:                                     ; preds = %bb.bx, %bb.cb
  ...
  %.4.i = phi ptr [ %.5.i, %bb.cb ], [ %i.ft, %bb.bx ] ; 2 uses
...
bb.cb:                                            ; preds = %bb.ca, %bb.bz
  ...
  %.pn.i = phi i64 [ 1, %bb.ca ], [ 2, %bb.bz ]
  %.5.i = getelementptr inbounds nuw i8, ptr %.4.i, i64 %.pn.i ; 2 uses
...
.preheader.i:                                     ; preds = %bb.bt, %bb.bx
  ...
  %.4.i = phi ptr [ %.5.i, %bb.bx ], [ %i.fo, %bb.bt ] ; 2 uses
...
.preheader:                                       ; preds = %bb.bs, %bb.bw
  ...
  %.4 = phi ptr [ %.5, %bb.bw ], [ %2, %bb.bs ]   ; 2 uses
...
bb.bw:                                            ; preds = %bb.bv, %bb.bu
  ...
  %.pn = phi i64 [ 1, %bb.bv ], [ 2, %bb.bu ]
  %.5 = getelementptr inbounds nuw i8, ptr %.4, i64 %.pn ; 2 uses
