...
bb.a:
  ...
  %3 = load double, ptr %i.h, align 8, !tbaa !8
  %4 = getelementptr inbounds nuw i8, ptr %i.h, i64 8
  %i.i = load double, ptr %4, align 8, !tbaa !8
  ...
  %5 = load double, ptr %i.v, align 8, !tbaa !8
  %i.w = getelementptr inbounds nuw i8, ptr %i.v, i64 8
  %i.x = load double, ptr %i.w, align 8, !tbaa !8
  %6 = getelementptr inbounds nuw i8, ptr %i.v, i64 16
  %i.y = load double, ptr %6, align 8, !tbaa !8
  %i.z = tail call double @llvm.fmuladd.f64(double %i.y, double %i.f, double %i.x)
  %i.aa = tail call double @llvm.fmuladd.f64(double %i.z, double %i.f, double %5) ; 17 uses
...
bb.m:                                             ; preds = %bb.l, %bb.k, %bb.j, %bb.i, %bb.h, %bb.g, %bb.f, %bb.e, %bb.d, %anpm.exit182
  ...
  %7 = tail call double @llvm.fmuladd.f64(double %i.k, double %i.f, double %i.i)
  %8 = tail call double @llvm.fmuladd.f64(double %7, double %i.f, double %3)
  %i.ng = extractelement <2 x double> %i.nf, i64 0
  %9 = tail call double @llvm.fmuladd.f64(double %i.ng, double f0x3E7AD7F29ABCAF48, double %8)
  %i.nh = extractelement <2 x double> %i.nf, i64 1
  %10 = tail call double @llvm.fmuladd.f64(double %i.nh, double f0x3E7AD7F29ABCAF48, double %9)
  %i.ni = extractelement <2 x double> %i.mz, i64 0
  %11 = tail call double @llvm.fmuladd.f64(double %i.ni, double f0x3E7AD7F29ABCAF48, double %10)
  %12 = extractelement <2 x double> %i.mz, i64 1
  %i.nj = tail call double @llvm.fmuladd.f64(double %12, double f0x3E7AD7F29ABCAF48, double %11)
  %13 = extractelement <2 x double> %i.mt, i64 0
  %i.nk = tail call double @llvm.fmuladd.f64(double %13, double f0x3E7AD7F29ABCAF48, double %i.nj)
  %14 = extractelement <2 x double> %i.mt, i64 1
  %i.nl = tail call double @llvm.fmuladd.f64(double %14, double f0x3E7AD7F29ABCAF48, double %i.nk)
  %15 = extractelement <2 x double> %i.mn, i64 0
  %16 = tail call double @llvm.fmuladd.f64(double %15, double f0x3E7AD7F29ABCAF48, double %i.nl)
  %17 = extractelement <2 x double> %i.mn, i64 1
  %18 = tail call double @llvm.fmuladd.f64(double %17, double f0x3E7AD7F29ABCAF48, double %16)
  %19 = fmul double %i.hr, %i.hs
  %20 = tail call double @llvm.fmuladd.f64(double %i.ho, double %i.hp, double %19)
  %i.nm = fmul double %i.f, %20
  %21 = tail call double @llvm.fmuladd.f64(double %i.nm, double f0x3E7AD7F29ABCAF48, double %18) ; 5 uses
  %22 = tail call double @llvm.fmuladd.f64(double %i.aw, double %i.f, double %i.au)
  %i.nn = fmul double %i.f, %22
  %23 = fmul double %.lcssa, 5.000000e-01         ; 2 uses
  %24 = fadd double %i.aa, 1.000000e+00
  %25 = fsub double 1.000000e+00, %i.aa
  %i.no = fdiv double %24, %25
  %26 = tail call double @sqrt(double noundef %i.no) #7, !tbaa !4
  %27 = tail call double @sin(double noundef %23) #7, !tbaa !4
  %28 = fmul double %26, %27
  %29 = tail call double @cos(double noundef %23) #7, !tbaa !4
  %30 = tail call double @atan2(double noundef %28, double noundef %29) #7, !tbaa !4
  %31 = fmul double %30, 2.000000e+00
  %32 = tail call double @cos(double noundef %.lcssa) #7, !tbaa !4
  %33 = insertelement <2 x double> poison, double %i.as, i64 0
  %34 = insertelement <2 x double> %33, double %i.ix, i64 1
  %35 = insertelement <2 x double> <double 3.600000e+03, double poison>, double %32, i64 1
  %36 = insertelement <2 x double> <double poison, double 1.000000e+00>, double %i.nn, i64 0
  %37 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %34, <2 x double> %35, <2 x double> %36) ; 2 uses
  %38 = extractelement <2 x double> %37, i64 0
  %39 = fmul double %38, f0x3ED455A5B2FF8F9D
  %40 = getelementptr inbounds [8 x i8], ptr @amas, i64 %i.g
  %41 = load double, ptr %40, align 8, !tbaa !8
  %42 = fdiv double 1.000000e+00, %41
  %43 = fadd double %42, 1.000000e+00
  %44 = fmul double %21, %21
  %45 = fmul double %21, %44
  %46 = fdiv double %43, %45
  %47 = tail call double @sqrt(double noundef %46) #7, !tbaa !4
  %48 = fmul double %39, 5.000000e-01             ; 2 uses
  %49 = tail call double @sin(double noundef %48) #7, !tbaa !4 ; 2 uses
  %50 = tail call double @cos(double noundef %.0.i181) #7, !tbaa !4
  %51 = fmul double %49, %50                      ; 6 uses
  %52 = tail call double @sin(double noundef %.0.i181) #7, !tbaa !4
  %53 = fadd double %.0.i, %31                    ; 2 uses
  %54 = tail call double @sin(double noundef %53) #7, !tbaa !4 ; 3 uses
  %i.np = tail call double @cos(double noundef %53) #7, !tbaa !4 ; 3 uses
  %55 = fneg double %54
  %56 = fmul double %51, %55
  %57 = tail call double @llvm.fmuladd.f64(double %i.ix, double %i.aa, double 1.000000e+00)
  %i.nq = tail call double @sqrt(double noundef %57) #7, !tbaa !4
  %58 = fdiv double %21, %i.nq                    ; 2 uses
  %i.nr = tail call double @cos(double noundef %48) #7, !tbaa !4 ; 2 uses
  %i.ns = tail call double @sin(double noundef %.0.i) #7, !tbaa !4
  %59 = tail call double @llvm.fmuladd.f64(double %i.aa, double %i.ns, double %54)
  %i.nt = tail call double @cos(double noundef %.0.i) #7, !tbaa !4
  %60 = tail call double @llvm.fmuladd.f64(double %i.aa, double %i.nt, double %i.np)
  %i.nu = fmul double %58, %60                    ; 3 uses
  %61 = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.nv = insertelement <2 x double> poison, double %21, i64 0
  %62 = insertelement <2 x double> %i.nv, double %47, i64 1
  %63 = shufflevector <2 x double> <double poison, double f0x3F919D6D51A6B69A>, <2 x double> %37, <2 x i32> <i32 3, i32 1>
  %64 = fmul <2 x double> %62, %63                ; 4 uses
  %i.nw = insertelement <2 x double> poison, double %49, i64 0
  %i.nx = insertelement <2 x double> %i.nw, double %58, i64 1
  %i.ny = insertelement <2 x double> poison, double %52, i64 0
  %65 = insertelement <2 x double> %i.ny, double %59, i64 1
  %66 = fmul <2 x double> %i.nx, %65              ; 4 uses
  %67 = extractelement <2 x double> %66, i64 0    ; 2 uses
  %68 = tail call double @llvm.fmuladd.f64(double %67, double %i.np, double %56)
  %69 = extractelement <2 x double> %64, i64 0
  %70 = shufflevector <2 x double> %66, <2 x double> poison, <2 x i32> <i32 poison, i32 0> ; 2 uses
  %i.nz = insertelement <2 x double> %70, double %68, i64 0
  %i.oa = fmul <2 x double> %i.nz, splat (double 2.000000e+00) ; 3 uses
  %i.ob = extractelement <2 x double> %i.oa, i64 1
  %i.oc = fmul double %51, %i.ob                  ; 2 uses
  %i.od = extractelement <2 x double> %i.oa, i64 0
  %i.oe = fneg double %i.od                       ; 2 uses
  %i.of = insertelement <2 x double> %70, double %51, i64 0
  %i.og = insertelement <2 x double> <double poison, double -1.000000e+00>, double %54, i64 0
  %i.oh = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.oa, <2 x double> %i.of, <2 x double> %i.og) ; 2 uses
  %foldExtExtBinop.a = fmul <2 x double> %64, %i.oh
  %i.oi = fmul double %i.nr, %i.oe
  %i.oj = fmul double %69, %i.oi
  %i.ok = fmul double %i.oc, %i.nu
  %i.ol = insertelement <2 x double> %i.oh, double %i.oe, i64 0
  %i.om = insertelement <2 x double> poison, double %i.np, i64 0
  %i.on = insertelement <2 x double> %i.om, double %i.ok, i64 1
  %i.oo = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ol, <2 x double> %66, <2 x double> %i.on)
  %i.op = fmul <2 x double> %64, %i.oo            ; 2 uses
  ...
  store <2 x double> %i.ov, ptr %61, align 8, !tbaa !8
  %i.ow = fmul double %51, -2.000000e+00
  %i.ox = tail call double @llvm.fmuladd.f64(double %i.ow, double %51, double 1.000000e+00)
  %71 = extractelement <2 x double> %66, i64 1    ; 2 uses
  %72 = fneg double %71
  %73 = fmul double %i.oc, %72
  %74 = tail call double @llvm.fmuladd.f64(double %i.ox, double %i.nu, double %73)
  %75 = extractelement <2 x double> %64, i64 1    ; 2 uses
  %76 = fmul double %75, %74
  %77 = fmul double %i.nr, 2.000000e+00
  %i.oy = fmul double %51, %i.nu
  %78 = tail call double @llvm.fmuladd.f64(double %67, double %71, double %i.oy)
  %i.oz = fmul double %77, %78
  %i.pa = fmul double %75, %i.oz
  ...
  %i.ph = insertelement <2 x double> poison, double %76, i64 0
