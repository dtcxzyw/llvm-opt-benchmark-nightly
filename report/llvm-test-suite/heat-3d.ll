...
polybench_alloc_data.exit:                        ; preds = %bb.a
  ...
  %i.l = load ptr, ptr %i.b, align 8, !tbaa !11   ; 2 uses
...
polybench_alloc_data.exit12:                      ; preds = %polybench_alloc_data.exit
  ...
  %i.r = load ptr, ptr %i.a, align 8, !tbaa !11   ; 10 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <2 x double> %i.ap, ptr %i.ar, align 8, !tbaa !9
...
.preheader115.i:                                  ; preds = %bb.f, %.preheader117.i
  ...
  %indvars.iv130.i = phi i64 [ %indvars.iv.next131.i, %bb.f ], [ 1, %.preheader117.i ] ; 4 uses
  %i.bh = mul nuw nsw i64 %indvars.iv130.i, 115200 ; 2 uses
  %i.bi = getelementptr i8, ptr %i.r, i64 %i.bh
  %scevgep45 = getelementptr i8, ptr %i.bi, i64 968
  %i.bj = getelementptr i8, ptr %i.r, i64 %i.bh
  %scevgep46 = getelementptr i8, ptr %i.bj, i64 114232
  %2 = mul nuw nsw i64 %indvar43, 115200          ; 2 uses
  %i.bk = getelementptr i8, ptr %i.e, i64 %2
  %scevgep47 = getelementptr i8, ptr %i.bk, i64 968
  %i.bl = getelementptr i8, ptr %i.e, i64 %2
...
vector.body54:                                    ; preds = %.preheader113.i, %vector.body54
  ...
  %wide.load56 = load <2 x double>, ptr %i.bx, align 8, !tbaa !9, !alias.scope !39
  %i.by = getelementptr inbounds nuw [8 x i8], ptr %i.br, i64 %i.bw ; 2 uses
  %wide.load57 = load <2 x double>, ptr %i.by, align 8, !tbaa !9, !alias.scope !39 ; 4 uses
  ...
  %wide.load58 = load <2 x double>, ptr %i.ca, align 8, !tbaa !9, !alias.scope !39
  %i.cb = fadd <2 x double> %i.bz, %wide.load58
  %i.cc = getelementptr inbounds nuw [8 x i8], ptr %i.bt, i64 %i.bw
  %wide.load59 = load <2 x double>, ptr %i.cc, align 8, !tbaa !9, !alias.scope !39
  ...
  %wide.load60 = load <2 x double>, ptr %i.ce, align 8, !tbaa !9, !alias.scope !39
  ...
  %wide.load61 = load <2 x double>, ptr %i.cj, align 8, !tbaa !9, !alias.scope !39
  ...
  %wide.load62 = load <2 x double>, ptr %i.cl, align 8, !tbaa !9, !alias.scope !39
  ...
  store <2 x double> %i.co, ptr %i.cp, align 8, !tbaa !9, !alias.scope !40, !noalias !39
  %index.next63 = add nuw i64 %index55, 2         ; 2 uses
  %i.cq = icmp eq i64 %index.next63, 118
  br i1 %i.cq, label %middle.block64, label %vector.body54, !llvm.loop !21
...
scalar.ph52:                                      ; preds = %.preheader113.i, %scalar.ph52
  ...
  %i.dc = load <2 x double>, ptr %i.ct, align 8, !tbaa !9 ; 4 uses
  ...
  store double %i.du, ptr %i.dv, align 8, !tbaa !9
  %exitcond.not.i17 = icmp eq i64 %indvars.iv.next.i16, 119
  br i1 %exitcond.not.i17, label %middle.block64, label %scalar.ph52, !llvm.loop !22
...
.preheader114.i:                                  ; preds = %bb.f, %bb.g
  ...
  %indvars.iv142.i = phi i64 [ %indvars.iv.next143.i, %bb.g ], [ 1, %bb.f ] ; 4 uses
  %i.dw = mul nuw nsw i64 %indvars.iv142.i, 115200 ; 2 uses
  %i.dx = getelementptr i8, ptr %i.e, i64 %i.dw
  %scevgep = getelementptr i8, ptr %i.dx, i64 968
  %i.dy = getelementptr i8, ptr %i.e, i64 %i.dw
  %scevgep27 = getelementptr i8, ptr %i.dy, i64 114232
  %3 = mul nuw nsw i64 %indvar, 115200            ; 2 uses
  %i.dz = getelementptr i8, ptr %i.r, i64 %3
  %scevgep28 = getelementptr i8, ptr %i.dz, i64 968
  %i.ea = getelementptr i8, ptr %i.r, i64 %3
...
vector.body32:                                    ; preds = %.preheader.i18, %vector.body32
  ...
  %wide.load = load <2 x double>, ptr %i.em, align 8, !tbaa !9, !alias.scope !41
  %i.en = getelementptr inbounds nuw [8 x i8], ptr %i.eg, i64 %i.el ; 2 uses
  %wide.load34 = load <2 x double>, ptr %i.en, align 8, !tbaa !9, !alias.scope !41 ; 4 uses
  ...
  %wide.load35 = load <2 x double>, ptr %i.ep, align 8, !tbaa !9, !alias.scope !41
  %i.eq = fadd <2 x double> %i.eo, %wide.load35
  %i.er = getelementptr inbounds nuw [8 x i8], ptr %i.ei, i64 %i.el
  %wide.load36 = load <2 x double>, ptr %i.er, align 8, !tbaa !9, !alias.scope !41
  ...
  %wide.load37 = load <2 x double>, ptr %i.et, align 8, !tbaa !9, !alias.scope !41
  ...
  %wide.load38 = load <2 x double>, ptr %i.ey, align 8, !tbaa !9, !alias.scope !41
  ...
  %wide.load39 = load <2 x double>, ptr %i.fa, align 8, !tbaa !9, !alias.scope !41
  ...
  store <2 x double> %i.fd, ptr %i.fe, align 8, !tbaa !9, !alias.scope !42, !noalias !41
  %index.next40 = add nuw i64 %index33, 2         ; 2 uses
  %i.ff = icmp eq i64 %index.next40, 118
  br i1 %i.ff, label %middle.block41, label %vector.body32, !llvm.loop !28
...
scalar.ph30:                                      ; preds = %.preheader.i18, %scalar.ph30
  ...
  %i.fq = load double, ptr %i.fp, align 8, !tbaa !9
  %indvars.iv.next135.i = add nuw nsw i64 %indvars.iv134.i, 1 ; 2 uses
  %i.fr = load <2 x double>, ptr %i.fi, align 8, !tbaa !9 ; 4 uses
  ...
  store double %i.gj, ptr %i.gk, align 8, !tbaa !9
  %exitcond137.not.i = icmp eq i64 %indvars.iv.next135.i, 119
  br i1 %exitcond137.not.i, label %middle.block41, label %scalar.ph30, !llvm.loop !29
...
middle.block41:                                   ; preds = %vector.body32, %scalar.ph30
  ...
  br i1 %exitcond141.not.i, label %bb.g, label %.preheader.i18, !llvm.loop !30
...
kernel_heat_3d.exit:                              ; preds = %bb.h
  ...
  store i8 0, ptr %i.gn, align 1, !tbaa !43
...
bb.i:                                             ; preds = %bb.i, %.preheader.i19
  ...
  %i.gt = load i64, ptr %i.gq, align 8, !tbaa !9  ; 4 uses
  ...
  store <16 x i8> %i.hm, ptr %i.gs, align 1, !tbaa !43
  %indvars.iv.next.i21 = add nuw nsw i64 %indvars.iv.i20, 1 ; 2 uses
  %exitcond.not.i22 = icmp eq i64 %indvars.iv.next.i21, 120
  br i1 %exitcond.not.i22, label %bb.j, label %bb.i, !llvm.loop !33

bb.j:                                             ; preds = %bb.i
  %i.hn = load ptr, ptr @stderr, align 8, !tbaa !13
  ...
  br i1 %exitcond30.not.i, label %bb.k, label %.preheader.i19, !llvm.loop !34
