...
.preheader115.i:                                  ; preds = %bb.f, %.preheader117.i
  ...
  %i.be = mul nuw nsw i64 %indvars.iv130.i, 115200 ; 2 uses
  %i.bf = getelementptr i8, ptr %i.p, i64 %i.be
  %scevgep47 = getelementptr i8, ptr %i.bf, i64 968
  %i.bg = getelementptr i8, ptr %i.p, i64 %i.be
  %scevgep48 = getelementptr i8, ptr %i.bg, i64 114232
  %2 = mul nuw nsw i64 %indvar45, 115200          ; 2 uses
  %i.bh = getelementptr i8, ptr %i.e, i64 %2
  %scevgep49 = getelementptr i8, ptr %i.bh, i64 968
  %i.bi = getelementptr i8, ptr %i.e, i64 %2
...
.preheader114.i:                                  ; preds = %bb.f, %bb.g
  ...
  %i.dt = mul nuw nsw i64 %indvars.iv142.i, 115200 ; 2 uses
  %i.du = getelementptr i8, ptr %i.e, i64 %i.dt
  %scevgep = getelementptr i8, ptr %i.du, i64 968
  %i.dv = getelementptr i8, ptr %i.e, i64 %i.dt
  %scevgep29 = getelementptr i8, ptr %i.dv, i64 114232
  %3 = mul nuw nsw i64 %indvar, 115200            ; 2 uses
  %i.dw = getelementptr i8, ptr %i.p, i64 %3
  %scevgep30 = getelementptr i8, ptr %i.dw, i64 968
  %i.dx = getelementptr i8, ptr %i.p, i64 %3
