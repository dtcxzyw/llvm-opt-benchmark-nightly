...
._crit_edge:                                      ; preds = %bb.o, %check_next.exit37
  ...
  %i.bs = load i8, ptr %i.br, align 8, !tbaa !41  ; 25 uses
  ...
  %.val.val33 = load i64, ptr %i.bu, align 8, !tbaa !51 ; 13 uses
...
pred.store.continue112:                           ; preds = %pred.store.if111, %pred.store.continue110
  ...
  br i1 %i.el, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !67
...
bb.t:                                             ; preds = %bb.s, %bb.r
  ...
  store i8 %i.ew, ptr %i.br, align 8, !tbaa !41
  ...
  %.val12.val13.i = load i64, ptr %i.ex, align 8, !tbaa !51 ; 13 uses
...
pred.store.continue190:                           ; preds = %pred.store.if189, %pred.store.continue188
  ...
  br i1 %i.ho, label %vec.epilog.middle.block192, label %vec.epilog.vector.body171, !llvm.loop !72

end_hunk_5
begin_hunk_6_@read_numeral:bb.a
bb.w:                                             ; preds = %buffreplace.exit.i
  %i.hv = load i8, ptr %i.br, align 8, !tbaa !41  ; 3 uses
  ...
  %.val.val14.i = load i64, ptr %i.hw, align 8, !tbaa !51 ; 13 uses
...
pred.store.continue271:                           ; preds = %pred.store.if270, %pred.store.continue269
  ...
  br i1 %i.kn, label %vec.epilog.middle.block273, label %vec.epilog.vector.body252, !llvm.loop !75
...
!66 = !{!"branch_weights", i32 8, i32 8}
!67 = distinct !{!67, !53, !64, !65}
!68 = distinct !{!68, !53, !65, !64}
!69 = !{!70, !23, i64 0}
end_hunk_9
