...
begin_hunk_0_@EPZSPelBlockMotionSearch:bb.a
  ...
  %18 = sub nuw nsw i32 2, %i.agx
  %19 = shl nuw nsw i32 2, %18                    ; 2 uses
  %i.agy = icmp samesign ult i32 %i.agw, %19
...
begin_hunk_1_@EPZSPelBlockMotionSearch:bb.a
  ...
  %i.ahd = icmp samesign ult i32 %i.ahc, %19
...
._crit_edge669:                                   ; preds = %bb.dt, %bb.dv
  ...
  %20 = sub nuw nsw i32 2, %i.ajy
  %21 = shl nuw nsw i32 2, %20                    ; 2 uses
  %i.alx = icmp samesign ult i32 %i.alw, %21
...
begin_hunk_3_@EPZSPelBlockMotionSearch:bb.a
  ...
  %i.amc = icmp samesign ult i32 %i.amb, %21
...
begin_hunk_4_@EPZSBiPredBlockMotionSearch:bb.a
  ...
  %20 = sub nuw nsw i32 2, %i.nz
  %21 = shl nuw nsw i32 2, %20                    ; 2 uses
  %i.oa = icmp samesign ult i32 %i.ny, %21
...
begin_hunk_5_@EPZSBiPredBlockMotionSearch:bb.a
  ...
  %i.of = icmp samesign ult i32 %i.oe, %21
...
._crit_edge543:                                   ; preds = %bb.bs, %bb.bu
  ...
  %22 = sub nuw nsw i32 2, %i.rg
  %23 = shl nuw nsw i32 2, %22                    ; 2 uses
  %i.sm = icmp samesign ult i32 %i.sl, %23
...
begin_hunk_7_@EPZSBiPredBlockMotionSearch:bb.a
  ...
  %i.sr = icmp samesign ult i32 %i.sq, %23
