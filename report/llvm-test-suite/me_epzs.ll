...
bb.f:                                             ; preds = %bb.e, %bb.d, %bb.c
  %i.an = phi i1 [ false, %bb.d ], [ false, %bb.c ], [ %i.am, %bb.e ] ; 4 uses
...
begin_hunk_1_@EPZSSubPelBlockMotionSearch:bb.a
  ...
  %spec.select444 = select i1 %i.an, i32 4, i32 1 ; 2 uses
...
.lr.ph:                                           ; preds = %bb.n
  ...
  %i.dn = zext nneg i32 %spec.select444 to i64
...
begin_hunk_3_@EPZSSubPelBlockMotionSearch:bb.a
  ...
  %i.gg = zext nneg i32 %spec.select444 to i64
...
bb.al:                                            ; preds = %bb.aj, %bb.ak
  ...
  %12 = select i1 %i.an, i32 5, i32 2             ; 2 uses
