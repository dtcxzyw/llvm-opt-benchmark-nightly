...
begin_hunk_0_@_ZN8NArchive2NZ8CHandler5CloseEv:bb.a
  ...
  %i.f = tail call noundef i32 %i.e(ptr noundef nonnull align 8 dereferenceable(8) %i.b), !inline_history !36 ; 0 uses
...
_ZN9CMyComPtrI20ISequentialOutStreamEC2EPS0_.exit: ; preds = %bb.p
  %i.ag = load ptr, ptr %5, align 8, !tbaa !37    ; 4 uses
...
.noexc:                                           ; preds = %bb.q, %_ZN9CMyComPtrI20ISequentialOutStreamEC2EPS0_.exit
  %i.al = load ptr, ptr %i.ad, align 8, !tbaa !37 ; 3 uses
...
bb.s:                                             ; preds = %.noexc, %bb.r
  store ptr %i.ag, ptr %i.ad, align 8, !tbaa !37
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ab, i64 24
  store i64 0, ptr %i.aq, align 8, !tbaa !41
  %i.ar = load ptr, ptr %5, align 8, !tbaa !37    ; 3 uses
...
bb.ah:                                            ; preds = %bb.ag
  ...
  store i32 0, ptr %i.bu, align 4, !tbaa !40
  ...
  store i32 0, ptr %i.bw, align 4, !tbaa !44
...
_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit:   ; preds = %bb.au, %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit, %bb.j
  ...
  %.pr = load ptr, ptr %5, align 8, !tbaa !37     ; 3 uses
...
_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit112: ; preds = %bb.z, %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit110, %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit110.thread, %bb.y, %bb.m, %bb.k
  ...
  %i.ek = load ptr, ptr %5, align 8, !tbaa !37    ; 3 uses
...
bb.a:
  ...
  store i32 %i.c, ptr %i.a, align 8, !tbaa !40
  ret i32 %i.c
}
...
begin_hunk_12_@_ZN8NArchive2NZ8CHandlerD0Ev:bb.a
  ...
  %i.f = invoke noundef i32 %i.e(ptr noundef nonnull align 8 dereferenceable(8) %i.b)
          to label %_ZN8NArchive2NZ8CHandlerD2Ev.exit unwind label %bb.c, !inline_history !50 ; 0 uses

bb.c:                                             ; preds = %bb.b
  %i.g = landingpad { ptr, i32 }
          catch ptr null
  %i.h = extractvalue { ptr, i32 } %i.g, 0
  tail call void @__clang_call_terminate(ptr %i.h) #17, !inline_history !50
  unreachable
...
!36 = distinct !{null}
!37 = !{!38, !39, i64 0}
!38 = !{!"_ZTS9CMyComPtrI20ISequentialOutStreamE", !39, i64 0}
!39 = !{!"p1 _ZTS20ISequentialOutStream", !11, i64 0}
!40 = !{!23, !5, i64 0}
!41 = !{!42, !26, i64 24}
!42 = !{!"_ZTS15CDummyOutStream", !43, i64 0, !23, i64 8, !38, i64 16, !26, i64 24}
!43 = !{!"_ZTS20ISequentialOutStream", !22, i64 0}
!44 = !{!45, !5, i64 52}
!45 = !{!"_ZTSN9NCompress2NZ8CDecoderE", !46, i64 0, !47, i64 8, !23, i64 16, !48, i64 24, !35, i64 32, !35, i64 40, !6, i64 48, !5, i64 52}
!46 = !{!"_ZTS14ICompressCoder", !22, i64 0}
!47 = !{!"_ZTS30ICompressSetDecoderProperties2", !22, i64 0}
!48 = !{!"p1 short", !11, i64 0}
!49 = !{!11, !11, i64 0}
!50 = !{ptr @_ZN8NArchive2NZ8CHandlerD2Ev}
end_hunk_14
