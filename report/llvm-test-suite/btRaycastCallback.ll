...
bb.a:
  ...
  %i.j = load <2 x float>, ptr %i.a, align 8, !tbaa !18 ; 2 uses
  %i.k = load float, ptr %i.b, align 4, !tbaa !18 ; 2 uses
  %i.l = load float, ptr %1, align 4, !tbaa !18   ; 2 uses
  %i.m = load float, ptr %i.c, align 4, !tbaa !18 ; 2 uses
  %2 = load <2 x float>, ptr %i.g, align 8, !tbaa !18 ; 2 uses
  %3 = insertelement <2 x float> poison, float %i.k, i64 0
  %4 = shufflevector <2 x float> %3, <2 x float> poison, <2 x i32> zeroinitializer
  %5 = shufflevector <2 x float> %i.j, <2 x float> %2, <2 x i32> <i32 1, i32 3>
  ...
  %i.p = shufflevector <2 x float> %i.j, <2 x float> %2, <2 x i32> <i32 0, i32 2>
  %i.q = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.o, <2 x float> %i.p, <2 x float> %6)
  ...
  %i.z = fmul float %i.k, %i.y
  %i.aa = tail call float @llvm.fmuladd.f32(float %i.l, float %i.w, float %i.z)
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 104
  %i.ac = load float, ptr %i.ab, align 8, !tbaa !18
  %i.ad = tail call noundef float @llvm.fmuladd.f32(float %i.m, float %i.ac, float %i.aa)
