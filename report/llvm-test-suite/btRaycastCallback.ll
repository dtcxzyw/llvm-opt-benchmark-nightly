...
begin_hunk_0_@_ZN21btConvexInternalShape9setMarginEf:bb.a
bb.a:
...
bb.a:
  ...
  %i.b = load float, ptr %1, align 4, !tbaa !18   ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.d = load float, ptr %i.c, align 4, !tbaa !18 ; 2 uses
  %i.e = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.f = load float, ptr %i.e, align 4, !tbaa !18 ; 2 uses
  ...
  %i.l = load float, ptr %i.k, align 8, !tbaa !18
  %i.m = load <2 x float>, ptr %i.a, align 8, !tbaa !18 ; 2 uses
  %i.n = load <2 x float>, ptr %i.j, align 8, !tbaa !18 ; 2 uses
  ...
  %i.ab = load float, ptr %i.aa, align 8, !tbaa !18
  ...
  %i.ah = load float, ptr %i.ag, align 8, !tbaa !18
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.l = load float, ptr %i.k, align 4, !tbaa !18 ; 2 uses
  %i.m = getelementptr inbounds nuw i8, ptr %i.i, i64 8
  %i.n = load float, ptr %i.m, align 4, !tbaa !18 ; 2 uses
  %4 = load <4 x float>, ptr %i.c, align 8
  %5 = shufflevector <4 x float> %4, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %i.o = load float, ptr %i.e, align 8, !tbaa !18
  %i.p = load <2 x float>, ptr %i.b, align 8, !tbaa !18 ; 2 uses
  %i.q = load <2 x float>, ptr %i.d, align 8, !tbaa !18 ; 2 uses
  ...
  %i.ad = load float, ptr %i.f, align 8, !tbaa !18
  %i.ae = load float, ptr %i.g, align 4, !tbaa !18
  %i.af = fmul float %i.l, %i.ae
  %i.ag = tail call float @llvm.fmuladd.f32(float %i.j, float %i.ad, float %i.af)
  %i.ah = load float, ptr %i.h, align 8, !tbaa !18
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.aq, ptr noundef nonnull align 8 dereferenceable(16) %i.ap, i64 16, i1 false), !tbaa.struct !10
...
bb.a:
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %i.c, i64 16, i1 false), !tbaa.struct !10
  ret void
}
...
bb.a:
  ...
  %i.i = load <2 x float>, ptr %i.a, align 8, !tbaa !18 ; 4 uses
  %i.j = load <2 x float>, ptr %i.b, align 8, !tbaa !18 ; 2 uses
  %i.k = load <2 x float>, ptr %i.c, align 4, !tbaa !18 ; 2 uses
  %i.l = load <2 x float>, ptr %i.e, align 8, !tbaa !18 ; 2 uses
  %i.m = load <2 x float>, ptr %i.f, align 4, !tbaa !18 ; 2 uses
  %i.n = load <2 x float>, ptr %i.d, align 4, !tbaa !18 ; 5 uses
  ...
  %i.ao = load <2 x float>, ptr %1, align 4, !tbaa !18 ; 2 uses
...
.preheader:                                       ; preds = %bb.a
  ...
  %i.bk = load float, ptr %i.bd, align 8, !tbaa !18
  %5 = load <4 x float>, ptr %1, align 4
  %6 = shufflevector <4 x float> %5, <4 x float> poison, <2 x i32> <i32 2, i32 poison>
  %i.bl = load <2 x float>, ptr %3, align 8, !tbaa !18 ; 4 uses
  %i.bm = extractelement <2 x float> %i.an, i64 0 ; 3 uses
  %i.bn = load <2 x float>, ptr %4, align 8, !tbaa !18 ; 2 uses
  %i.bo = load <2 x float>, ptr %i.bc, align 4, !tbaa !18 ; 3 uses
  ...
  %i.ck = load <2 x float>, ptr %1, align 4, !tbaa !18 ; 2 uses
  ...
  %7 = shufflevector <2 x float> %6, <2 x float> %i.bo, <2 x i32> <i32 0, i32 3>
...
bb.b:                                             ; preds = %.preheader
  ...
  %i.cz = load float, ptr %i.bd, align 8, !tbaa !18
  %8 = load <4 x float>, ptr %1, align 4
  %9 = shufflevector <4 x float> %8, <4 x float> poison, <2 x i32> <i32 2, i32 poison>
  %i.da = load <2 x float>, ptr %3, align 8, !tbaa !18 ; 4 uses
  %i.db = load <2 x float>, ptr %4, align 8, !tbaa !18 ; 2 uses
  %i.dc = load <2 x float>, ptr %i.bc, align 4, !tbaa !18 ; 3 uses
  ...
  %i.dy = load <2 x float>, ptr %1, align 4, !tbaa !18 ; 2 uses
  ...
  %10 = shufflevector <2 x float> %9, <2 x float> %i.dc, <2 x i32> <i32 0, i32 3>
  %i.eg = shufflevector <2 x float> %i.dx, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.eh = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %10, <2 x float> %i.eg, <2 x float> %i.ef) ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.en = load float, ptr %i.bd, align 8, !tbaa !18
  %11 = load <4 x float>, ptr %1, align 4
  %12 = shufflevector <4 x float> %11, <4 x float> poison, <2 x i32> <i32 2, i32 poison>
  %i.eo = load <2 x float>, ptr %3, align 8, !tbaa !18 ; 4 uses
  %i.ep = load <2 x float>, ptr %4, align 8, !tbaa !18 ; 2 uses
  %i.eq = load <2 x float>, ptr %i.bc, align 4, !tbaa !18 ; 3 uses
  ...
  %i.fm = load <2 x float>, ptr %1, align 4, !tbaa !18 ; 2 uses
  ...
  %13 = shufflevector <2 x float> %12, <2 x float> %i.eq, <2 x i32> <i32 0, i32 3>
  %i.fu = shufflevector <2 x float> %i.fl, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.fv = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %13, <2 x float> %i.fu, <2 x float> %i.ft) ; 2 uses
