begin_hunk_0
  ...
  %i.fu = add <8 x i32> %i.ft, %invariant.op      ; 8 uses
...
begin_hunk_1
  ...
  %i.hq = add <8 x i32> %i.hp, %invariant.op205   ; 8 uses
...
begin_hunk_2
  ...
  %i.jm = add <8 x i32> %i.jl, %invariant.op206   ; 8 uses
...
begin_hunk_3
  ...
  %i.lk = add <8 x i32> %i.lj, %invariant.op207   ; 8 uses
...
begin_hunk_4
  ...
  %i.nj = add <8 x i32> %i.ni, %invariant.op208   ; 8 uses
...
begin_hunk_5
  ...
  %i.pf = add <8 x i32> %i.pe, %invariant.op209   ; 8 uses
...
begin_hunk_6
  ...
  %i.rb = add <8 x i32> %i.ra, %invariant.op210   ; 8 uses
...
begin_hunk_7
  ...
  %i.sz = add <8 x i32> %i.sy, %invariant.op211   ; 8 uses
...
begin_hunk_8
  ...
  %i.ux = add <8 x i32> %i.uw, %invariant.op212   ; 8 uses
...
begin_hunk_9
  ...
  %i.wt = add <8 x i32> %i.ws, %invariant.op213   ; 8 uses
...
begin_hunk_10
  ...
  %i.yp = add <8 x i32> %i.yo, %invariant.op214   ; 8 uses
...
begin_hunk_11
  ...
  %i.aan = add <8 x i32> %i.aam, %invariant.op215 ; 8 uses
...
begin_hunk_12
  ...
  %i.acn = add <8 x i32> %i.acm, %invariant.op216 ; 8 uses
...
begin_hunk_13
  ...
  %i.aej = add <8 x i32> %i.aei, %invariant.op217 ; 8 uses
...
begin_hunk_14
  ...
  %i.agf = add <8 x i32> %i.age, %invariant.op218 ; 8 uses
...
begin_hunk_15
  ...
  %i.aid = add <8 x i32> %i.aic, %invariant.op219 ; 8 uses
...
begin_hunk_16
  ...
  %invariant.op = sub <8 x i32> splat (i32 256), %i.bqr
  %invariant.op205 = sub <8 x i32> splat (i32 256), %i.bqr
  %invariant.op206 = sub <8 x i32> splat (i32 256), %i.bqr
  %invariant.op207 = sub <8 x i32> splat (i32 256), %i.bqr
  %invariant.op208 = sub <8 x i32> splat (i32 256), %i.bqr
  %invariant.op209 = sub <8 x i32> splat (i32 256), %i.bqr
  %invariant.op210 = sub <8 x i32> splat (i32 256), %i.bqr
  %invariant.op211 = sub <8 x i32> splat (i32 256), %i.bqr
  %invariant.op212 = sub <8 x i32> splat (i32 256), %i.bqr
  %invariant.op213 = sub <8 x i32> splat (i32 256), %i.bqr
  %invariant.op214 = sub <8 x i32> splat (i32 256), %i.bqr
  %invariant.op215 = sub <8 x i32> splat (i32 256), %i.bqr
  %invariant.op216 = sub <8 x i32> splat (i32 256), %i.bqr
  %invariant.op217 = sub <8 x i32> splat (i32 256), %i.bqr
  %invariant.op218 = sub <8 x i32> splat (i32 256), %i.bqr
  %invariant.op219 = sub <8 x i32> splat (i32 256), %i.bqr
...
begin_hunk_17
  ...
  %t2248.us = mul nsw i32 %i.jc, %i.hz
  %0 = sub nsw i32 %i.ix, %i.ib
  %t2248.us.a = mul nsw i32 %0, %i.hz
  %1 = trunc i64 %indvars.iv490.a to i32
  %i.jd = sub i32 %1, %f7.v4.min_realized
  %t2250.us = mul i32 %i.jd, %f7.stride.1
  %invariant.op.us341 = sub i32 %t2250.us, %f7.v3.min_realized
  ...
  %i.jg = sext i32 %t2248.us.a to i64             ; 4 uses
  %i.jh = sext i32 %t2248.us to i64               ; 4 uses
...
begin_hunk_18
  ...
  %t2251.us = add i32 %f129.s0.v3.v363.base.us, %invariant.op.us341 ; 2 uses
...
begin_hunk_19
  ...
  %t2286.us = mul nsw i32 %i.ahf, %i.dq
  %2 = sub nsw i32 %i.aha, %i.hp
  %t2286.us.a = mul nsw i32 %2, %i.dq
  %3 = trunc i64 %indvars.iv494.a to i32
  %i.ahg = sub i32 %3, %f6.v4.min_realized
  %t2288.us = mul i32 %i.ahg, %f6.stride.1
  %invariant.op.us347 = sub i32 %t2288.us, %f6.v3.min_realized
  ...
  %i.ahl = sext i32 %t2286.us.a to i64            ; 4 uses
  %i.ahm = sext i32 %t2286.us to i64              ; 4 uses
...
begin_hunk_20
  ...
  %t2289.us = add i32 %f128.s0.v3.v343.base.us, %invariant.op.us347 ; 2 uses
...
begin_hunk_21
  ...
  %t2324.us = mul nsw i32 %i.bez, %i.eq
  %4 = sub nsw i32 %i.beu, %i.agh
  %t2324.us.a = mul nsw i32 %4, %i.eq
  %5 = trunc i64 %indvars.iv498 to i32
  %i.bfa = sub i32 %5, %f5.v4.min_realized
  %t2326.us = mul i32 %i.bfa, %f5.stride.1
  %invariant.op.us353 = sub i32 %t2326.us, %f5.v3.min_realized
  ...
  %i.bff = sext i32 %t2324.us.a to i64            ; 4 uses
  %i.bfg = sext i32 %t2324.us to i64              ; 4 uses
...
begin_hunk_22
  ...
  %t2327.us = add i32 %f127.s0.v3.v323.base.us, %invariant.op.us353 ; 2 uses
...
begin_hunk_23
  ...
  %t2362.us = mul nsw i32 %i.ccu, %i.fu
  %6 = sub nsw i32 %i.ccp, %f127.v4.min_realized
  %t2362.us.a = mul nsw i32 %6, %i.fu
  %7 = trunc i64 %indvars.iv502 to i32
  %i.ccv = sub i32 %7, %f4.v4.min_realized
  %t2364.us = mul i32 %i.ccv, %f4.stride.1
  %invariant.op.us359 = sub i32 %t2364.us, %f4.v3.min_realized
  ...
  %i.cda = sext i32 %t2362.us.a to i64            ; 4 uses
  %i.cdb = sext i32 %t2362.us to i64              ; 4 uses
...
begin_hunk_24
  ...
  %t2365.us = add i32 %f126.s0.v3.v303.base.us, %invariant.op.us359 ; 2 uses
...
begin_hunk_25
  ...
  %invariant.op681 = sub i32 %i.dyp, %i.dyn
...
begin_hunk_26
  ...
  %.scalar = add i32 %i.eiu, %invariant.op681
  %i.eiv = insertelement <8 x i32> poison, i32 %.scalar, i64 0
...
begin_hunk_27
  ...
  %invariant.op682 = sub i32 %i.nfe, %.pre-phi546
...
begin_hunk_28
  ...
  %.scalar522 = add i32 %i.nga, %invariant.op682
  %i.ngb = insertelement <8 x i32> poison, i32 %.scalar522, i64 0
...
begin_hunk_29
  ...
  %invariant.op683 = sub i32 %i.niq, %.pre-phi546
...
begin_hunk_30
  ...
  %.scalar524 = add i32 %i.nld, %invariant.op683
  %i.nle = insertelement <8 x i32> poison, i32 %.scalar524, i64 0
...
begin_hunk_31
  ...
  %t2870.us = mul nsw i32 %i.nvu, %i.nrl
  %8 = sub nsw i32 %i.nvp, %i.nrn
  %t2870.us.a = mul nsw i32 %8, %i.nrl
  %9 = trunc i64 %indvars.iv to i32
  %i.nvv = sub i32 %9, %f7.v4.min_realized
  %t2872.us = mul i32 %i.nvv, %f7.stride.1
  %invariant.op.us = sub i32 %t2872.us, %f7.v3.min_realized
  ...
  %i.nvy = sext i32 %t2870.us.a to i64            ; 4 uses
  %i.nvz = sext i32 %t2870.us to i64              ; 4 uses
...
begin_hunk_32
  ...
  %t2873.us = add i32 %f129.s0.v3.v363.base151.us, %invariant.op.us ; 2 uses
...
begin_hunk_33
  ...
  %t2908.us = mul nsw i32 %i.otk, %i.dq
  %10 = sub nsw i32 %i.otf, %i.nsc
  %t2908.us.a = mul nsw i32 %10, %i.dq
  %11 = trunc i64 %indvars.iv475 to i32
  %i.otl = sub i32 %11, %f6.v4.min_realized
  %t2910.us = mul i32 %i.otl, %f6.stride.1
  %invariant.op.us320 = sub i32 %t2910.us, %f6.v3.min_realized
  ...
  %i.otq = sext i32 %t2908.us.a to i64            ; 4 uses
  %i.otr = sext i32 %t2908.us to i64              ; 4 uses
...
begin_hunk_34
  ...
  %t2911.us = add i32 %f128.s0.v3.v343.base161.us, %invariant.op.us320 ; 2 uses
...
begin_hunk_35
  ...
  %t2946.us = mul nsw i32 %i.pqu, %i.nny
  %12 = sub nsw i32 %i.pqp, %i.nsq
  %t2946.us.a = mul nsw i32 %12, %i.nny
  %13 = trunc i64 %indvars.iv479 to i32
  %i.pqv = sub i32 %13, %f5.v4.min_realized
  %t2948.us = mul i32 %i.pqv, %f5.stride.1
  %invariant.op.us325 = sub i32 %t2948.us, %f5.v3.min_realized
  ...
  %i.pra = sext i32 %t2946.us.a to i64            ; 4 uses
  %i.prb = sext i32 %t2946.us to i64              ; 4 uses
...
begin_hunk_36
  ...
  %t2949.us = add i32 %f127.s0.v3.v323.base171.us, %invariant.op.us325 ; 2 uses
...
begin_hunk_37
  ...
  %t2984.us = mul nsw i32 %i.qod, %i.npc
  %14 = sub nsw i32 %i.qny, %f127.v4.min_realized124
  %t2984.us.a = mul nsw i32 %14, %i.npc
  %15 = trunc i64 %indvars.iv483 to i32
  %i.qoe = sub i32 %15, %f4.v4.min_realized
  %t2986.us = mul i32 %i.qoe, %f4.stride.1
  %invariant.op.us330 = sub i32 %t2986.us, %f4.v3.min_realized
  ...
  %i.qoj = sext i32 %t2984.us.a to i64            ; 4 uses
  %i.qok = sext i32 %t2984.us to i64              ; 4 uses
...
begin_hunk_38
  ...
  %t2987.us = add i32 %f126.s0.v3.v303.base181.us, %invariant.op.us330 ; 2 uses
...
begin_hunk_39
  ...
  %invariant.op680 = sub i32 %i.sis, %i.nut
...
begin_hunk_40
  ...
  %.scalar526 = add i32 %i.sjf, %invariant.op680
  %i.sjg = insertelement <8 x i32> poison, i32 %.scalar526, i64 0
