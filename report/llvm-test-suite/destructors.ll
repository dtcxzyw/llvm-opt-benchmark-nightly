begin_hunk_0_@par_for___local_laplacian_f8.s0.v6:entry
  ...
  %0 = add i32 %i.au, 2
  %1 = or disjoint i32 %i.au, 1
  %i.aw = sub i32 %0, %f7.v4.min_realized
  %i.ax = sub i32 %1, %f7.v4.min_realized
...
begin_hunk_1_@par_for___local_laplacian_f9.s0.v6:entry
  ...
  %0 = add i32 %i.ar, 2
  %1 = or disjoint i32 %i.ar, 1
  %i.at = sub i32 %0, %f8.v4.min_realized
  %i.au = sub i32 %1, %f8.v4.min_realized
