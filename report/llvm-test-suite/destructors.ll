...
"for f76.s0.v4.preheader1022":                    ; preds = %"for f76.s0.v4.preheader"
  ...
  %narrow = add nuw i32 %reass.sub1003, 1
  %i.akm = zext i32 %narrow to i64                ; 2 uses
  ...
  %n.vec1364 = and i64 %i.akm, 4294967292         ; 4 uses
  %i.akp = trunc nuw i64 %n.vec1364 to i32        ; 2 uses
  %i.akq = shl i32 %i.akp, 1                      ; 4 uses
  %i.akr = shl nuw nsw i64 %n.vec1364, 2
  %i.aks = sub i32 %i.aiz, %i.akp
  %cmp.n1391 = icmp eq i64 %n.vec1364, %i.akm
...
"for f77.s0.v4.preheader1021":                    ; preds = %"for f77.s0.v4.preheader"
  ...
  %narrow1509 = add nuw i32 %reass.sub1007, 1
  %i.atj = zext i32 %narrow1509 to i64            ; 2 uses
  %14 = insertelement <4 x i32> poison, i32 %reass.sub1007, i64 0
  %min.iters.check1414 = icmp ult i32 %reass.sub1007, 7
  %i.atk = shl <4 x i32> %14, <i32 1, i32 poison, i32 poison, i32 poison>
  %i.atl = shufflevector <4 x i32> %i.atk, <4 x i32> poison, <4 x i32> zeroinitializer
  %invariant.op1531.a = add <4 x i32> %i.ati, %i.atl
  %n.vec1417 = and i64 %i.atj, 4294967292         ; 4 uses
  %i.atm = trunc nuw i64 %n.vec1417 to i32        ; 2 uses
  %i.atn = shl i32 %i.atm, 1                      ; 4 uses
  %i.ato = shl nuw nsw i64 %n.vec1417, 2
  %i.atp = sub i32 %i.arw, %i.atm
  %cmp.n1447 = icmp eq i64 %n.vec1417, %i.atj
...
"for f78.s0.v4.preheader1020":                    ; preds = %"for f78.s0.v4.preheader"
  ...
  %narrow1510 = add nuw nsw i32 %f10.v3.extent_realized.s, 1
  %i.bad = zext nneg i32 %narrow1510 to i64       ; 2 uses
  %15 = insertelement <4 x i32> poison, i32 %f10.v3.extent_realized.s, i64 0
  %min.iters.check1470 = icmp ult i32 %f10.v3.extent_realized.s, 7
  %i.bae = shl nsw <4 x i32> %15, <i32 1, i32 poison, i32 poison, i32 poison>
  %i.baf = shufflevector <4 x i32> %i.bae, <4 x i32> poison, <4 x i32> zeroinitializer
  %invariant.op1543 = add <4 x i32> %i.bac, %i.baf
  %n.vec1473 = and i64 %i.bad, 2147483644         ; 4 uses
  %i.bag = trunc nuw nsw i64 %n.vec1473 to i32    ; 2 uses
  %i.bah = shl nuw i32 %i.bag, 1                  ; 4 uses
  %i.bai = add nsw i64 %n.vec1473, %i.ayw
  %i.baj = sub nsw i32 %i.app, %i.bag
  %cmp.n1502 = icmp eq i64 %n.vec1473, %i.bad
...
"for f10.s0.v4.preheader4":                       ; preds = %"for f10.s0.v4.preheader"
  ...
  %0 = zext i32 %i.r to i64                       ; 2 uses
  %1 = insertelement <4 x i32> poison, i32 %f10.v3.extent_realized.s, i64 0
  %min.iters.check = icmp ult i32 %i.r, 8
  %i.bp = shl nuw <4 x i32> %1, <i32 1, i32 poison, i32 poison, i32 poison>
  %i.bq = shufflevector <4 x i32> %i.bp, <4 x i32> poison, <4 x i32> zeroinitializer
  %invariant.op48 = add <4 x i32> %i.bo, %i.bq
  %n.vec = and i64 %0, 4294967292                 ; 4 uses
