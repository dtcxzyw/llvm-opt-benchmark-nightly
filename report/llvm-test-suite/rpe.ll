...
begin_hunk_0_@Gsm_RPE_Encoding:bb.a
  ...
  %5 = icmp slt i16 %i.ky, 0
  %6 = tail call i16 @llvm.ssub.sat.i16(i16 0, i16 %i.ky)
  %7 = select i1 %5, i16 %6, i16 %i.ky
  %8 = shufflevector <8 x i16> %i.lj, <8 x i16> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %9 = tail call <4 x i16> @llvm.smax.v4i16(<4 x i16> %8, <4 x i16> %i.lq)
  %10 = shufflevector <4 x i16> %9, <4 x i16> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %11 = shufflevector <8 x i16> %10, <8 x i16> %i.lj, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 15>
  %12 = tail call i16 @llvm.vector.reduce.smax.v8i16(<8 x i16> %11)
  %.138.11.i = tail call i16 @llvm.smax.i16(i16 %12, i16 %7) ; 4 uses
