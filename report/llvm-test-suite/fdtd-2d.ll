...
bb.k:                                             ; preds = %bb.k, %.preheader.i95
  ...
  %3 = lshr i64 %i.rr, 24
  %4 = lshr i64 %i.rr, 16
  %i.rs = lshr i64 %i.rr, 8
  %i.rt = trunc nuw i64 %2 to i8
  ...
  %5 = trunc i64 %3 to i8
  %6 = trunc i64 %4 to i8
  %7 = insertelement <2 x i64> poison, i64 %i.rr, i64 0
  %8 = insertelement <2 x i64> %7, i64 %i.rs, i64 1
  ...
  %i.ru = insertelement <8 x i8> %10, i8 %6, i64 2
  %11 = insertelement <8 x i8> %i.ru, i8 %5, i64 3
  ...
  %i.rv = insertelement <8 x i8> %14, i8 %i.rt, i64 7
...
bb.m:                                             ; preds = %bb.m, %bb.l
  ...
  %i.sf = load i64, ptr %i.sc, align 8, !tbaa !8  ; 8 uses
  %15 = lshr i64 %i.sf, 56
  %.sroa.0.6.extract.shift.i40.i = lshr i64 %i.sf, 48
  %.sroa.0.5.extract.shift.i38.i = lshr i64 %i.sf, 40
  %.sroa.0.4.extract.shift.i36.i = lshr i64 %i.sf, 32
  %16 = lshr i64 %i.sf, 24
  %17 = lshr i64 %i.sf, 16
  %i.sg = lshr i64 %i.sf, 8
  %i.sh = trunc nuw i64 %15 to i8
  ...
  %20 = insertelement <2 x i64> poison, i64 %i.sf, i64 0
  %21 = insertelement <2 x i64> %20, i64 %i.sg, i64 1
  ...
  %i.si = insertelement <8 x i8> %23, i8 %19, i64 2
  %24 = insertelement <8 x i8> %i.si, i8 %18, i64 3
  %25 = insertelement <8 x i8> %24, i8 %.sroa.0.4.extract.trunc.i37.i, i64 4
  %26 = insertelement <8 x i8> %25, i8 %.sroa.0.5.extract.trunc.i39.i, i64 5
  %27 = insertelement <8 x i8> %26, i8 %.sroa.0.6.extract.trunc.i41.i, i64 6
  %i.sj = insertelement <8 x i8> %27, i8 %i.sh, i64 7
...
bb.o:                                             ; preds = %bb.o, %bb.n
  ...
  %i.st = load i64, ptr %i.sq, align 8, !tbaa !8  ; 8 uses
  %28 = lshr i64 %i.st, 56
  %.sroa.0.6.extract.shift.i47.i = lshr i64 %i.st, 48
  %.sroa.0.5.extract.shift.i45.i = lshr i64 %i.st, 40
  %.sroa.0.4.extract.shift.i43.i = lshr i64 %i.st, 32
  %29 = lshr i64 %i.st, 24
  %30 = lshr i64 %i.st, 16
  %i.su = lshr i64 %i.st, 8
  %i.sv = trunc nuw i64 %28 to i8
  ...
  %33 = insertelement <2 x i64> poison, i64 %i.st, i64 0
  %34 = insertelement <2 x i64> %33, i64 %i.su, i64 1
  %35 = trunc <2 x i64> %34 to <2 x i8>
  %36 = shufflevector <2 x i8> %35, <2 x i8> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.sw = insertelement <8 x i8> %36, i8 %32, i64 2
  %37 = insertelement <8 x i8> %i.sw, i8 %31, i64 3
  %38 = insertelement <8 x i8> %37, i8 %.sroa.0.4.extract.trunc.i44.i, i64 4
  %39 = insertelement <8 x i8> %38, i8 %.sroa.0.5.extract.trunc.i46.i, i64 5
  %40 = insertelement <8 x i8> %39, i8 %.sroa.0.6.extract.trunc.i48.i, i64 6
  %i.sx = insertelement <8 x i8> %40, i8 %i.sv, i64 7
