...
bb.k:                                             ; preds = %bb.k, %.preheader.i95
  ...
  %3 = insertelement <2 x i64> %2, i64 %i.rv, i64 1
  ...
  %i.rz = insertelement <8 x i8> %5, i8 %i.ry, i64 2
...
bb.m:                                             ; preds = %bb.m, %bb.l
  ...
  %6 = insertelement <2 x i64> poison, i64 %i.so, i64 0
  %7 = insertelement <2 x i64> %6, i64 %i.ss, i64 1
  ...
  %i.sw = insertelement <8 x i8> %9, i8 %i.sv, i64 2
...
bb.o:                                             ; preds = %bb.o, %bb.n
  ...
  %10 = insertelement <2 x i64> poison, i64 %i.tl, i64 0
  %11 = insertelement <2 x i64> %10, i64 %i.tp, i64 1
  %12 = trunc <2 x i64> %11 to <2 x i8>
  %13 = shufflevector <2 x i8> %12, <2 x i8> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.tt = insertelement <8 x i8> %13, i8 %i.ts, i64 2
