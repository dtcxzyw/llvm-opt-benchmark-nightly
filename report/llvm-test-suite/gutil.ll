...
.lr.ph46.i:                                       ; preds = %bb.b, %.loopexit.i
  %.02945.i = phi ptr [ %.4.i, %.loopexit.i ], [ null, %bb.b ] ; 3 uses
  %.03044.i = phi i32 [ %.434.i, %.loopexit.i ], [ 0, %bb.b ] ; 3 uses
  %.03643.i = phi ptr [ %i.ar, %.loopexit.i ], [ %0, %bb.b ] ; 2 uses
  %i.n = getelementptr inbounds nuw i8, ptr %.03643.i, i64 8
...
bb.c:                                             ; preds = %.lr.ph46.i
  ...
  %.035.in37.i = getelementptr inbounds nuw i8, ptr %i.o, i64 16
  %.03538.i = load ptr, ptr %.035.in37.i, align 8, !tbaa !125 ; 3 uses
  %i.v = load ptr, ptr %.03538.i, align 8, !tbaa !8
  %i.w = load ptr, ptr %i.v, align 8
  %i.x = tail call noundef i32 %i.w(ptr noundef nonnull align 8 dereferenceable(24) %.03538.i), !inline_history !117
  %i.y = icmp eq i32 %i.x, 252
  br i1 %i.y, label %.lr.ph.i, label %.loopexit.i

.lr.ph.i:                                         ; preds = %bb.c, %bb.f
  %.03541.i = phi ptr [ %.035.i, %bb.f ], [ %.03538.i, %bb.c ] ; 2 uses
  %.140.i = phi ptr [ %.3.i, %bb.f ], [ %.02945.i, %bb.c ] ; 2 uses
  %.13139.i = phi i32 [ %.333.i, %bb.f ], [ %.03044.i, %bb.c ] ; 3 uses
  %i.z = getelementptr inbounds nuw i8, ptr %.03541.i, i64 8
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.al = add nsw i32 %.13139.i, 1
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.d, %.lr.ph.i
  %.333.i = phi i32 [ %.13139.i, %.lr.ph.i ], [ %i.al, %bb.e ], [ %.13139.i, %bb.d ] ; 2 uses
  %.3.i = phi ptr [ %.140.i, %.lr.ph.i ], [ %i.ak, %bb.e ], [ %.140.i, %bb.d ] ; 2 uses
  %.035.in.i = getelementptr inbounds nuw i8, ptr %.03541.i, i64 16
  %.035.i = load ptr, ptr %.035.in.i, align 8, !tbaa !125 ; 3 uses
  %i.am = load ptr, ptr %.035.i, align 8, !tbaa !8
  %i.an = load ptr, ptr %i.am, align 8
  %i.ao = tail call noundef i32 %i.an(ptr noundef nonnull align 8 dereferenceable(24) %.035.i), !inline_history !117
  %i.ap = icmp eq i32 %i.ao, 252
  br i1 %i.ap, label %.lr.ph.i, label %.loopexit.i, !llvm.loop !132

.loopexit.i:                                      ; preds = %bb.f, %bb.c, %.lr.ph46.i
  %.434.i = phi i32 [ %.03044.i, %.lr.ph46.i ], [ %.03044.i, %bb.c ], [ %.333.i, %bb.f ] ; 3 uses
  %.4.i = phi ptr [ %.02945.i, %.lr.ph46.i ], [ %.02945.i, %bb.c ], [ %.3.i, %bb.f ] ; 2 uses
  %i.aq = getelementptr inbounds nuw i8, ptr %.03643.i, i64 16
...
_ZN2kcL42lookup_and_create_ac_parameter_declarationEPNS_7impl_IDEPNS_24impl_ac_declaration_listE.exit: ; preds = %._crit_edge.i, %bb.h
  %.0.i = phi ptr [ %i.br, %bb.h ], [ %.4.i, %._crit_edge.i ]
  %i.bs = tail call noundef ptr @_ZN2kc21Consac_parameter_listEPNS_29impl_ac_parameter_declarationEPNS_22impl_ac_parameter_listE(ptr noundef %.0.i, ptr noundef %i.i)
  br label %bb.k
...
define dso_local noundef nonnull ptr @_ZN2kc13impl_charruns3setEi(ptr noundef nonnull returned writeonly align 8 captures(ret: address, provenance) dereferenceable(12) initializes((8, 12)) %0, i32 noundef %1) local_unnamed_addr #4 align 2 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define dso_local noundef ptr @_ZN2kc10f_mkselvarEPKci(ptr noundef readonly captures(none) %0, i32 noundef %1) local_unnamed_addr #0 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define dso_local noundef ptr @_ZN2kc11f_mkselvar2EPKcii(ptr noundef readonly captures(none) %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #0 {
bb.a:
  %i.a = alloca [8192 x i8], align 16             ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #13
  %i.b = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #12
...
; Function Attrs: mustprogress uwtable
define dso_local noundef nonnull ptr @_ZN2kc13f_mk_filenameEPNS_20impl_casestring__StrEPKc(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
...
bb.d:                                             ; preds = %bb.a, %bb.c, %bb.b
  %.137 = phi ptr [ %i.f, %bb.b ], [ %i.g, %bb.c ], [ %spec.select, %bb.a ] ; 2 uses
  %i.h = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %.137) #12 ; 5 uses
  ...
  %i.m = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %i.l, ptr noundef nonnull dereferenceable(1) %.137) #13 ; 0 uses
...
bb.g:                                             ; preds = %bb.f, %bb.e
  %.035 = phi i64 [ %i.r, %bb.f ], [ %i.h, %bb.e ] ; 6 uses
  %i.s = icmp ugt i64 %.035, 1
  br i1 %i.s, label %bb.h, label %.thread

bb.h:                                             ; preds = %bb.g
  %i.t = getelementptr i8, ptr %i.l, i64 %.035
...
thread-pre-split:                                 ; preds = %bb.k, %thread-pre-split
  ...
  %.03847 = phi ptr [ %1, %bb.k ], [ %i.ad, %thread-pre-split ]
  %i.ad = getelementptr inbounds nuw i8, ptr %.03847, i64 1 ; 2 uses
...
; Function Attrs: mustprogress uwtable
define dso_local noundef nonnull ptr @_ZN2kc13f_mk_filenameEPNS_20impl_casestring__StrERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(ptr noundef readonly captures(none) %0, ptr noundef nonnull readonly align 8 captures(none) dereferenceable(32) %1) local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define dso_local noundef nonnull ptr @_ZN2kc26f_make_identifier_basenameEPKc(ptr noundef readonly captures(none) %0) local_unnamed_addr #0 {
bb.a:
...
.lr.ph:                                           ; preds = %bb.a, %bb.c
  %i.g = phi i64 [ %i.m, %bb.c ], [ 0, %bb.a ]
  %.015 = phi i32 [ %i.l, %bb.c ], [ 0, %bb.a ]
  %i.h = getelementptr inbounds nuw i8, ptr %i.d, i64 %i.g ; 2 uses
  %i.i = load i8, ptr %i.h, align 1, !tbaa !139
  %i.j = sext i8 %i.i to i32
  %i.k = tail call i32 @isalnum(i32 noundef %i.j) #12
  %.not = icmp eq i32 %i.k, 0
  br i1 %.not, label %bb.b, label %bb.c

bb.b:                                             ; preds = %.lr.ph
  store i8 95, ptr %i.h, align 1, !tbaa !139
  br label %bb.c

bb.c:                                             ; preds = %.lr.ph, %bb.b
  %i.l = add i32 %.015, 1                         ; 2 uses
  %i.m = zext i32 %i.l to i64                     ; 2 uses
  %i.n = icmp ugt i64 %i.b, %i.m
  br i1 %i.n, label %.lr.ph, label %._crit_edge, !llvm.loop !145
}
...
; Function Attrs: mustprogress uwtable
define dso_local noundef ptr @_ZN2kc37f_rewriterulesinfoofalternativeinviewEPNS_16impl_alternativeEPNS_7impl_IDE(ptr noundef readonly captures(none) %0, ptr noundef %1) local_unnamed_addr #0 {
bb.a:
