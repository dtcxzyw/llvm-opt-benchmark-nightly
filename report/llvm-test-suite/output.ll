...
.preheader51.us:                                  ; preds = %.preheader51.us.preheader, %bb.d
  %.03959.us = phi i32 [ %i.x, %bb.d ], [ %i.s, %.preheader51.us.preheader ] ; 4 uses
  br label %bb.f

._crit_edge.us:                                   ; preds = %bb.e, %..preheader50_crit_edge.us
  %.lcssa.us = phi i1 [ %.not47.us, %..preheader50_crit_edge.us ], [ %i.ab, %bb.e ]
  br i1 %.lcssa.us, label %.preheader49, label %bb.d

bb.d:                                             ; preds = %._crit_edge.us
  %i.x = add nsw i32 %.03959.us, 1                ; 2 uses
  %exitcond92.not = icmp eq i32 %i.x, 32767
  br i1 %exitcond92.not, label %._crit_edge60, label %.preheader51.us, !llvm.loop !126

bb.e:                                             ; preds = %.lr.ph56.us, %bb.e
  %indvars.iv89 = phi i64 [ 0, %.lr.ph56.us ], [ %indvars.iv.next90, %bb.e ] ; 2 uses
  %i.y = getelementptr inbounds nuw [2 x i8], ptr %i.aq, i64 %indvars.iv89
  %i.z = load i16, ptr %i.y, align 2, !tbaa !26
  %i.aa = sext i16 %i.z to i32
  %i.ab = icmp ne i32 %.03959.us, %i.aa           ; 2 uses
  %indvars.iv.next90 = add nuw nsw i64 %indvars.iv89, 1 ; 2 uses
  %i.ac = icmp slt i64 %indvars.iv.next90, %i.b
  %i.ad = select i1 %i.ab, i1 %i.ac, i1 false
  br i1 %i.ad, label %bb.e, label %._crit_edge.us, !llvm.loop !127

bb.f:                                             ; preds = %.preheader51.us, %bb.h
  %indvars.iv86 = phi i64 [ 0, %.preheader51.us ], [ %indvars.iv.next87, %bb.h ] ; 2 uses
  %i.ae = getelementptr inbounds nuw [2 x i8], ptr %i.l, i64 %indvars.iv86
  %i.af = load i16, ptr %i.ae, align 2, !tbaa !26
  %i.ag = sext i16 %i.af to i32
  %i.ah = add nsw i32 %.03959.us, %i.ag           ; 3 uses
  %i.ai = icmp sgt i32 %i.ah, 32767
...
bb.h:                                             ; preds = %bb.g, %bb.f
  %i.aj = load ptr, ptr @table, align 8, !tbaa !23
  %i.ak = sext i32 %i.ah to i64
  %i.al = getelementptr inbounds [2 x i8], ptr %i.aj, i64 %i.ak
  %i.am = load i16, ptr %i.al, align 2, !tbaa !26
  %.not47.us = icmp eq i16 %i.am, 0               ; 3 uses
  %indvars.iv.next87 = add nuw nsw i64 %indvars.iv86, 1 ; 2 uses
  %i.an = icmp samesign ult i64 %indvars.iv.next87, %i.w
  %i.ao = select i1 %.not47.us, i1 %i.an, i1 false
  br i1 %i.ao, label %bb.f, label %..preheader50_crit_edge.us, !llvm.loop !128

..preheader50_crit_edge.us:                       ; preds = %bb.h
...
.preheader51.us62:                                ; preds = %.preheader51.lr.ph.split, %bb.i
  %.03959.us63 = phi i32 [ %i.as, %bb.i ], [ %i.s, %.preheader51.lr.ph.split ] ; 3 uses
  br label %bb.j

bb.i:                                             ; preds = %._crit_edge.us67
  %i.as = add nsw i32 %.03959.us63, 1             ; 2 uses
  %exitcond.not = icmp eq i32 %i.as, 32767
  br i1 %exitcond.not, label %._crit_edge60, label %.preheader51.us62, !llvm.loop !126

bb.j:                                             ; preds = %.preheader51.us62, %bb.j
  %indvars.iv = phi i64 [ 0, %.preheader51.us62 ], [ %indvars.iv.next, %bb.j ] ; 2 uses
  %i.at = getelementptr inbounds nuw [2 x i8], ptr %i.ar, i64 %indvars.iv
  %i.au = load i16, ptr %i.at, align 2, !tbaa !26
  %i.av = sext i16 %i.au to i32
  %i.aw = icmp ne i32 %.03959.us63, %i.av         ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.ax = icmp slt i64 %indvars.iv.next, %i.b
  %i.ay = select i1 %i.aw, i1 %i.ax, i1 false
  br i1 %i.ay, label %bb.j, label %._crit_edge.us67, !llvm.loop !127

._crit_edge.us67:                                 ; preds = %bb.j
  br i1 %i.aw, label %.preheader49, label %bb.i

.preheader49:                                     ; preds = %._crit_edge.us67, %._crit_edge.us
  %.us-phi = phi i32 [ %.03959.us, %._crit_edge.us ], [ %.03959.us63, %._crit_edge.us67 ] ; 6 uses
  %.us-phi61 = phi i32 [ %i.ah, %._crit_edge.us ], [ undef, %._crit_edge.us67 ]
...
._crit_edge60:                                    ; preds = %bb.i, %bb.d, %bb.c
  tail call void @berror(ptr noundef nonnull @.str.34) #13
  br label %bb.n
