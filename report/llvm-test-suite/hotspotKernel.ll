...
bb.a:
  ...
  %i.z = insertelement <2 x ptr> %i.y, ptr %1, i64 1 ; 6 uses
  %i.aa = getelementptr i8, <2 x ptr> %i.z, <2 x i64> <i64 2093056, i64 2097152>
  %i.ab = getelementptr i8, <2 x ptr> %i.v, i64 8 ; 2 uses
  %i.ac = getelementptr i8, <2 x ptr> %i.z, <2 x i64> <i64 2097144, i64 2097152>
  ...
  %i.ag = getelementptr i8, <2 x ptr> %i.z, <2 x i64> <i64 4104, i64 8>
  %i.ah = getelementptr i8, <2 x ptr> %i.z, <2 x i64> <i64 2093048, i64 2097144>
  %9 = shufflevector <2 x ptr> %i.w, <2 x ptr> %i.z, <2 x i32> <i32 1, i32 3>
  %i.ai = shufflevector <2 x ptr> %i.ab, <2 x ptr> %i.z, <2 x i32> <i32 1, i32 3>
