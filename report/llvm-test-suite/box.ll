...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.gep153 = getelementptr inbounds [8 x i8], ptr %i.az, <2 x i64> %i.bb
  ...
  store <2 x ptr> %wide.gep153, ptr %i.bd, align 8, !tbaa !32, !alias.scope !38, !noalias !35
...
._crit_edge:                                      ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block, %.loopexit
  ...
  br i1 %i.dg, label %.preheader.lr.ph, label %._crit_edge132.split

.preheader.lr.ph:                                 ; preds = %._crit_edge
  %i.dh = load i32, ptr %i.f, align 4, !tbaa !20
  %i.di = add nsw i32 %i.dh, %8                   ; 2 uses
  %i.dj = icmp sgt i32 %i.di, %i.dd
  br i1 %i.dj, label %.preheader.lr.ph.split, label %._crit_edge132.split
...
.preheader:                                       ; preds = %.preheader.lr.ph.split, %._crit_edge130
  %.0131 = phi i32 [ %i.dd, %.preheader.lr.ph.split ], [ %i.dx, %._crit_edge130 ] ; 3 uses
  %i.dp = add nsw i32 %.0131, %8
  %i.dq = mul nsw i32 %i.dk, %i.dp
  %invariant.op = add i32 %8, %i.dq
  br label %bb.b

bb.b:                                             ; preds = %.preheader, %bb.b
  %indvars.iv135 = phi i64 [ %i.dl, %.preheader ], [ %indvars.iv.next136, %bb.b ] ; 2 uses
  %i.dr = trunc i64 %indvars.iv135 to i32         ; 2 uses
  %.reass = add i32 %invariant.op, %i.dr
  %i.ds = xor i32 %.0131, %i.dr
  %.not122 = trunc i32 %i.ds to i1                ; 3 uses
  %i.dt = sext i32 %.reass to i64                 ; 3 uses
  %i.du = getelementptr inbounds [8 x i8], ptr %i.dm, i64 %i.dt
  %. = sext i1 %.not122 to i64
  %.150 = select i1 %.not122, double 1.000000e+00, double 0.000000e+00
  %.151 = select i1 %.not122, double 0.000000e+00, double 1.000000e+00
  store i64 %., ptr %i.du, align 8, !tbaa !47
  %i.dv = getelementptr inbounds [8 x i8], ptr %i.dn, i64 %i.dt
  store double %.150, ptr %i.dv, align 8, !tbaa !49
  %i.dw = getelementptr inbounds [8 x i8], ptr %i.do, i64 %i.dt
  store double %.151, ptr %i.dw, align 8, !tbaa !49
  %indvars.iv.next136 = add i64 %indvars.iv135, 1 ; 2 uses
  %lftr.wideiv = trunc i64 %indvars.iv.next136 to i32
  %exitcond138.not = icmp eq i32 %i.di, %lftr.wideiv
  br i1 %exitcond138.not, label %._crit_edge130, label %bb.b, !llvm.loop !50

._crit_edge130:                                   ; preds = %bb.b
  %i.dx = add nsw i32 %.0131, 1                   ; 2 uses
  %exitcond139.not = icmp eq i32 %i.dx, %i.df
  br i1 %exitcond139.not, label %._crit_edge132.split, label %.preheader, !llvm.loop !51

._crit_edge132.split:                             ; preds = %._crit_edge130, %.preheader.lr.ph, %._crit_edge
