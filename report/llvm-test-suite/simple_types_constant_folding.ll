...
vector.body:                                      ; preds = %vector.main.loop.iter.check, %vector.body
  ...
  %wide.load = load <16 x i8>, ptr %i.f, align 1, !tbaa !33
  %wide.load31 = load <16 x i8>, ptr %i.g, align 1, !tbaa !33
  %3 = udiv <16 x i8> %wide.load, splat (i8 120)
  %4 = udiv <16 x i8> %wide.load31, splat (i8 120)
  %i.h = add <16 x i8> %3, %vec.phi               ; 2 uses
  %i.i = add <16 x i8> %4, %vec.phi30             ; 2 uses
  %index.next = add nuw i64 %index, 32            ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load36 = load <8 x i8>, ptr %i.m, align 1, !tbaa !33
  %5 = udiv <8 x i8> %wide.load36, splat (i8 120)
  %i.n = add <8 x i8> %5, %vec.phi35              ; 2 uses
  %index.next37 = add nuw i64 %index34, 8         ; 2 uses
