...
begin_hunk_0_@put_gray_rows:bb.a
  ...
  %i.l = load ptr, ptr %i.i, align 8, !tbaa !73   ; 5 uses
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 128
  %i.n = load i32, ptr %i.m, align 8, !tbaa !49   ; 5 uses
...
begin_hunk_1_@put_gray_rows:bb.a
  ...
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !73   ; 4 uses
  %i.s = zext i32 %i.n to i64                     ; 2 uses
  %min.iters.check = icmp ult i32 %i.n, 32
  %i.t = ptrtoaddr ptr %i.r to i64
  %i.u = sub i64 %i.o, %i.t
  %diff.check = icmp ult i64 %i.u, 32
  %or.cond = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond, label %.lr.ph.preheader34, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph.preheader.a
  %n.vec = and i64 %i.s, 4294967264               ; 5 uses
...
begin_hunk_2_@put_gray_rows:bb.a
  ...
  br i1 %i.aa, label %middle.block.a, label %vector.body, !llvm.loop !81

middle.block.a:                                   ; preds = %vector.body
  %cmp.n.a = icmp eq i64 %n.vec, %i.s
  br i1 %cmp.n.a, label %._crit_edge, label %.lr.ph.preheader34

.lr.ph.preheader34:                               ; preds = %.lr.ph.preheader.a, %middle.block.a
  %.01522.ph = phi i32 [ %i.n, %.lr.ph.preheader.a ], [ %i.v, %middle.block.a ] ; 4 uses
  %.01621.ph = phi ptr [ %i.l, %.lr.ph.preheader.a ], [ %i.w, %middle.block.a ] ; 2 uses
  %.01720.ph = phi ptr [ %i.r, %.lr.ph.preheader.a ], [ %i.x, %middle.block.a ] ; 2 uses
...
begin_hunk_4_@put_gray_rows:bb.a
  ...
  br i1 %.not.7, label %._crit_edge, label %.lr.ph, !llvm.loop !86

._crit_edge:                                      ; preds = %.lr.ph.prol.loopexit, %.lr.ph, %middle.block.a, %bb.a
  %.016.lcssa = phi ptr [ %i.l, %bb.a ], [ %i.w, %middle.block.a ], [ %.lcssa.unr, %.lr.ph.prol.loopexit ], [ %i.be, %.lr.ph ]
...
begin_hunk_5_@put_pixel_rows:bb.a
  ...
  br i1 %.not.1, label %._crit_edge, label %.lr.ph, !llvm.loop !87
...
bb.a:
  ...
  %i.d = load i32, ptr %i.c, align 4, !tbaa !89   ; 7 uses
...
begin_hunk_7_@write_colormap:bb.a
  ...
  br i1 %exitcond42.not, label %.loopexit, label %.preheader.split.us, !llvm.loop !90
...
begin_hunk_8_@write_colormap:bb.a
  ...
  br i1 %exitcond30.not, label %.loopexit, label %.lr.ph.split.us, !llvm.loop !92
...
begin_hunk_9_@write_colormap:bb.a
  ...
  br i1 %exitcond40.not, label %.loopexit, label %.lr.ph7.split.us, !llvm.loop !93
...
begin_hunk_10_@write_colormap:bb.a
  ...
  br i1 %exitcond35.not, label %.loopexit, label %.lr.ph7.split, !llvm.loop !93
...
begin_hunk_11_@write_colormap:bb.a
  ...
  br i1 %exitcond.not, label %.loopexit, label %.lr.ph.split, !llvm.loop !92
...
begin_hunk_12_@write_colormap:bb.a
  ...
  br i1 %exitcond41.not, label %.loopexit, label %.preheader.split, !llvm.loop !90
...
begin_hunk_13_@write_colormap:bb.a
  ...
  br i1 %exitcond44.not, label %._crit_edge, label %.lr.ph13.split.us, !llvm.loop !94
...
begin_hunk_14_@write_colormap:bb.a
  ...
  br i1 %exitcond43.not, label %._crit_edge, label %.lr.ph13.split, !llvm.loop !94
