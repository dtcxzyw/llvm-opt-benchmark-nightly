begin_hunk_0_@_ZN28CSequentialInStreamForBinderD0Ev:bb.a
  ...
  %i.e = tail call i32 @pthread_mutex_lock(ptr noundef nonnull align 8 dereferenceable(89) %i.d) #12 ; 0 uses
  ...
  %i.i = tail call i32 @pthread_cond_broadcast(ptr noundef nonnull %i.h) #12 ; 0 uses
  %i.j = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(89) %i.g) #12 ; 0 uses
...
begin_hunk_1_@_ZN29CSequentialOutStreamForBinderD0Ev:bb.a
  ...
  %i.d = invoke noundef i32 @Event_Set(ptr noundef nonnull align 8 dereferenceable(104) %i.c)
          to label %_ZN29CSequentialOutStreamForBinderD2Ev.exit unwind label %bb.b ; 0 uses
