...
vector.body125:                                   ; preds = %vector.body125, %vector.ph124
  ...
  %i.bk = getelementptr [8 x i8], ptr %3, i64 %index126 ; 2 uses
  %i.bl = getelementptr i8, ptr %i.bk, i64 1816
  %i.bm = getelementptr [8 x i8], ptr %3, i64 %index126
  %i.bn = getelementptr i8, ptr %i.bm, i64 1824
...
vector.body104:                                   ; preds = %vector.body104, %vector.ph103
  ...
  %i.ei = getelementptr [8 x i8], ptr %3, i64 %index105 ; 2 uses
  %i.ej = getelementptr i8, ptr %i.ei, i64 1816
  %i.ek = getelementptr [8 x i8], ptr %3, i64 %index105
  %i.el = getelementptr i8, ptr %i.ek, i64 1824
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.hg = getelementptr [8 x i8], ptr %3, i64 %index ; 2 uses
  %i.hh = getelementptr i8, ptr %i.hg, i64 1816
  %i.hi = getelementptr [8 x i8], ptr %3, i64 %index
  %i.hj = getelementptr i8, ptr %i.hi, i64 1824
...
vector.body104:                                   ; preds = %vector.body104, %vector.ph103
  %index105 = phi i64 [ 0, %vector.ph103 ], [ %index.next110, %vector.body104 ] ; 3 uses
  %vector.recur107 = phi <2 x i64> [ %vector.recur.init106, %vector.ph103 ], [ %wide.load108, %vector.body104 ]
  %i.ek = getelementptr [8 x i8], ptr %3, i64 %index105 ; 2 uses
  %i.el = getelementptr i8, ptr %i.ek, i64 1816
  %i.em = getelementptr [8 x i8], ptr %3, i64 %index105
  %i.en = getelementptr i8, ptr %i.em, i64 1824
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 3 uses
  %vector.recur = phi <2 x i64> [ %vector.recur.init, %vector.ph ], [ %wide.load, %vector.body ]
  %i.hk = getelementptr [8 x i8], ptr %3, i64 %index ; 2 uses
  %i.hl = getelementptr i8, ptr %i.hk, i64 1816
  %i.hm = getelementptr [8 x i8], ptr %3, i64 %index
  %i.hn = getelementptr i8, ptr %i.hm, i64 1824
