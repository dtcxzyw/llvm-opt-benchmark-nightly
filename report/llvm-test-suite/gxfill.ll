...
bb.b:                                             ; preds = %.lr.ph, %bb.bo
  %.0225 = phi ptr [ undef, %.lr.ph ], [ %.091221, %bb.bo ] ; 5 uses
  %.087224 = phi i32 [ undef, %.lr.ph ], [ %.086, %bb.bo ] ; 2 uses
  %.087223 = phi ptr [ undef, %.lr.ph ], [ %.188, %bb.bo ] ; 6 uses
  %.089222 = phi ptr [ undef, %.lr.ph ], [ %.190, %bb.bo ] ; 9 uses
  %.091221 = phi ptr [ %i.b, %.lr.ph ], [ %i.ko, %bb.bo ] ; 10 uses
  %i.m = getelementptr inbounds nuw i8, ptr %.091221, i64 16 ; 2 uses
  %i.n = load i32, ptr %i.m, align 8, !tbaa !55
  %cond = icmp eq i32 %i.n, 0
  br i1 %cond, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  %i.o = getelementptr inbounds nuw i8, ptr %.091221, i64 40
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !57
  br label %bb.bo

bb.d:                                             ; preds = %bb.b
  %i.q = getelementptr inbounds nuw i8, ptr %.091221, i64 24 ; 6 uses
  %i.r = getelementptr inbounds nuw i8, ptr %.091221, i64 32 ; 4 uses
  %i.s = load i64, ptr %i.r, align 8, !tbaa !59   ; 6 uses
  %i.t = getelementptr inbounds nuw i8, ptr %.0225, i64 24 ; 6 uses
  %i.u = getelementptr inbounds nuw i8, ptr %.0225, i64 32 ; 2 uses
...
bb.j:                                             ; preds = %bb.g, %bb.h, %bb.i, %bb.e
  ...
  %i.ak = icmp sgt i32 %i.aj, %.087224
  br i1 %i.ak, label %bb.k, label %bb.ac

bb.k:                                             ; preds = %bb.j
  %.not103 = icmp eq i32 %.087224, 0
  br i1 %.not103, label %bb.t, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.al = load ptr, ptr %.0225, align 8, !tbaa !61 ; 2 uses
...
begin_hunk_2_@add_y_list:bb.a
  ...
  store ptr %.091221, ptr %i.cx, align 8, !tbaa !66
...
bb.ac:                                            ; preds = %bb.t, %add_y_line.exit120, %bb.j
  %i.eb = icmp eq ptr %.091221, %.087223
...
bb.ae:                                            ; preds = %bb.ad
  %i.ed = getelementptr inbounds nuw i8, ptr %.089222, i64 32 ; 2 uses
...
bb.af:                                            ; preds = %bb.ae
  %i.eh = getelementptr inbounds nuw i8, ptr %.089222, i64 24
...
begin_hunk_5_@add_y_list:bb.a
  ...
  store ptr %.0225, ptr %i.fm, align 8, !tbaa !66
...
begin_hunk_6_@add_y_list:bb.a
  ...
  %i.gu = getelementptr inbounds nuw i8, ptr %.089222, i64 24
...
begin_hunk_7_@add_y_list:bb.a
  ...
  %.sink.i135 = phi ptr [ %.091221, %bb.aw ], [ %.089222, %bb.av ]
...
begin_hunk_8_@add_y_list:bb.a
  ...
  store ptr %.0225, ptr %i.jj, align 8, !tbaa !66
...
bb.bo:                                            ; preds = %bb.ac, %bb.bf, %add_y_line.exit159, %bb.at, %add_y_line.exit144, %bb.c
  %.190 = phi ptr [ %.091221, %bb.c ], [ %.089222, %add_y_line.exit144 ], [ %.089222, %bb.at ], [ %.089222, %add_y_line.exit159 ], [ %.089222, %bb.bf ], [ %.089222, %bb.ac ]
  %.188 = phi ptr [ %i.p, %bb.c ], [ %.087223, %add_y_line.exit144 ], [ %.087223, %bb.at ], [ %.087223, %add_y_line.exit159 ], [ %.087223, %bb.bf ], [ %.087223, %bb.ac ]
  %.086 = phi i32 [ 0, %bb.c ], [ %i.aj, %add_y_line.exit144 ], [ %i.aj, %bb.at ], [ -1, %add_y_line.exit159 ], [ %i.aj, %bb.bf ], [ %i.aj, %bb.ac ]
  %i.kn = getelementptr inbounds nuw i8, ptr %.091221, i64 8
...
.preheader247:                                    ; preds = %.preheader247.lr.ph, %bb.bg
  ...
  %.0181281 = phi i64 [ %i.f, %.preheader247.lr.ph ], [ %.1176, %bb.bg ] ; 3 uses
...
.preheader:                                       ; preds = %.thread236
  ...
  %.not215272 = icmp eq ptr %.2198271, %.1183
  br i1 %.not215272, label %._crit_edge, label %.lr.ph274

.preheader246:                                    ; preds = %.lr.ph263, %.thread236
  %.2187270 = phi i64 [ %.4.a, %.thread236 ], [ -2147483648, %.lr.ph263 ] ; 2 uses
  %.0182260 = phi ptr [ %.1183, %.thread236 ], [ %.0196259, %.lr.ph263 ] ; 2 uses
  %.1185259 = phi ptr [ %i.fa, %.thread236 ], [ %.0196259, %.lr.ph263 ] ; 14 uses
  %.0194267 = phi ptr [ %.1185259, %.thread236 ], [ undef, %.lr.ph263 ] ; 8 uses
  %.0188257 = phi i32 [ %.1192, %.thread236 ], [ 0, %.lr.ph263 ] ; 5 uses
  %.2192256 = phi i64 [ %.4, %.thread236 ], [ %spec.select, %.lr.ph263 ] ; 5 uses
  %i.at = getelementptr inbounds nuw i8, ptr %.1185259, i64 16 ; 3 uses
  %i.au = getelementptr inbounds nuw i8, ptr %.1185259, i64 24
  %i.av = load i64, ptr %i.au, align 8, !tbaa !87 ; 6 uses
  %i.aw = icmp eq i64 %.2192256, %i.av
  br i1 %i.aw, label %bb.l, label %bb.i

bb.i:                                             ; preds = %.preheader246
  %i.ax = getelementptr inbounds nuw i8, ptr %.1185259, i64 32
  %i.ay = load i64, ptr %i.ax, align 8, !tbaa !65
  %.not225 = icmp sgt i64 %.2192256, %i.ay
  %i.az = getelementptr inbounds nuw i8, ptr %.1185259, i64 8
  %i.ba = load i64, ptr %i.az, align 8, !tbaa !69 ; 4 uses
  %i.bb = sub nsw i64 %.2192256, %i.ba            ; 2 uses
  br i1 %.not225, label %bb.k, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.bc = load i64, ptr %i.at, align 8, !tbaa !83 ; 2 uses
  %i.bd = load i64, ptr %.1185259, align 8, !tbaa !81 ; 2 uses
...
bb.k:                                             ; preds = %bb.i
  ...
  %i.bk = load i64, ptr %.1185259, align 8, !tbaa !81 ; 2 uses
...
bb.l:                                             ; preds = %.preheader246
  ...
  %i.bt = getelementptr inbounds nuw i8, ptr %.1185259, i64 48 ; 2 uses
  store i64 %i.bs, ptr %i.bt, align 8, !tbaa !89
  %i.bu = icmp slt i64 %i.bs, %.2187270
  br i1 %i.bu, label %._crit_edge293, label %bb.z

._crit_edge293:                                   ; preds = %bb.l
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %.1185259, i64 8
  %.pre = load i64, ptr %.phi.trans.insert, align 8, !tbaa !69
  %.pre294 = load i64, ptr %.1185259, align 8, !tbaa !81
  br label %bb.m
...
begin_hunk_15_@fill_loop:bb.a
  ...
  %i.bz = getelementptr inbounds nuw i8, ptr %.1185259, i64 48 ; 2 uses
  store i64 %i.by, ptr %i.bz, align 8, !tbaa !89
  %i.ca = icmp slt i64 %i.by, %.2187270
...
begin_hunk_16_@fill_loop:bb.a
  ...
  %i.cf = getelementptr inbounds nuw i8, ptr %.0194267, i64 16
  %i.cg = getelementptr inbounds nuw i8, ptr %.0194267, i64 24
  %i.ch = load i64, ptr %i.cg, align 8, !tbaa !87 ; 3 uses
  %i.ci = getelementptr inbounds nuw i8, ptr %.0194267, i64 8
  ...
  %i.co = load i64, ptr %.0194267, align 8, !tbaa !81 ; 3 uses
...
begin_hunk_17_@fill_loop:bb.a
  ...
  %i.dq = getelementptr inbounds nuw i8, ptr %.0194267, i64 32
  %i.dr = getelementptr inbounds nuw i8, ptr %.1185259, i64 32
  br label %bb.n
...
bb.y:                                             ; preds = %bb.x
  %i.er = getelementptr inbounds nuw i8, ptr %.0194267, i64 48
  store i64 %i.ed, ptr %i.er, align 8, !tbaa !89
  store i64 %i.ep, ptr %i.ce, align 8, !tbaa !89
  %i.es = add nsw i32 %.0188257, 4
  %i.et = trunc i32 %.0188257 to i16              ; 2 uses
  %i.eu = add i16 %i.et, 7
  %i.ev = getelementptr inbounds nuw i8, ptr %.0194267, i64 70
  store i16 %i.eu, ptr %i.ev, align 2, !tbaa !90
  %i.ew = add i16 %i.et, 5
  br label %.thread236

bb.z:                                             ; preds = %bb.l
  %i.ex = trunc i32 %.0188257 to i16
  br label %.thread236

.thread236:                                       ; preds = %.thread235, %bb.z, %bb.y
  %.sink = phi i16 [ %i.ex, %bb.z ], [ %i.ew, %bb.y ], [ -2, %.thread235 ]
  %.4 = phi i64 [ %.2192256, %bb.z ], [ %.3188, %bb.y ], [ %.2192256, %.thread235 ] ; 6 uses
  %.1192 = phi i32 [ %.0188257, %bb.z ], [ %i.es, %bb.y ], [ %.0188257, %.thread235 ] ; 2 uses
  %.1183 = phi ptr [ %.0182260, %bb.z ], [ %.0194267, %bb.y ], [ %.0182260, %.thread235 ] ; 3 uses
  %.4.a = phi i64 [ %i.bs, %bb.z ], [ %i.ep, %bb.y ], [ %i.by, %.thread235 ]
  %i.ey = getelementptr inbounds nuw i8, ptr %.1185259, i64 70
  store i16 %.sink, ptr %i.ey, align 2, !tbaa !90
  %i.ez = getelementptr inbounds nuw i8, ptr %.1185259, i64 80
...
bb.ag:                                            ; preds = %._crit_edge, %swap_group.exit
  ...
  %.1179278 = phi i64 [ undef, %._crit_edge ], [ %.2180, %swap_group.exit ] ; 6 uses
  %.1182277 = phi i64 [ undef, %._crit_edge ], [ %.2183, %swap_group.exit ] ; 6 uses
...
begin_hunk_23_@fill_loop:bb.a
  ...
  %i.hk = tail call i32 (i64, i64, i64, i64, i64, i64, i32, ptr, ptr, ...) @gz_fill_trapezoid_fixed(i64 noundef %i.hg, i64 noundef %i.hh, i64 noundef %.0181281, i64 noundef %i.hi, i64 noundef %i.hj, i64 noundef %i.gh, i32 noundef 0, ptr noundef %0, ptr noundef nonnull %4) #10 ; 0 uses
  br label %bb.an
...
bb.an:                                            ; preds = %bb.am, %bb.al, %bb.aj, %bb.ak
  ...
  %.2183 = phi i64 [ %.1182277, %bb.aj ], [ %.1182277, %bb.ak ], [ %.1182277, %bb.al ], [ %spec.select229, %bb.am ]
  %.2180 = phi i64 [ %.1179278, %bb.aj ], [ %.1179278, %bb.ak ], [ %.1179278, %bb.al ], [ %spec.select230, %bb.am ]
...
bb.bg:                                            ; preds = %.critedge.thread, %bb.bf
  ...
  %.1176 = phi i64 [ %.4, %bb.bf ], [ %i.n, %.critedge.thread ] ; 2 uses
