begin_hunk_0_@jpeg_start_decompress:bb.a
  ...
  tail call void %i.ak(ptr noundef nonnull %0) #4
...
begin_hunk_1_@jpeg_start_decompress:bb.a
  ...
  %i.ap = load i32, ptr %i.ao, align 8, !tbaa !55
...
begin_hunk_2_@jpeg_start_decompress:bb.a
  ...
  %.pre.pre.i = load i32, ptr %i.aq, align 8, !tbaa !54
...
.preheader.i:                                     ; preds = %.preheader.i.backedge, %.preheader.lr.ph.i
  ...
  %i.av = load i32, ptr %i.ar, align 4, !tbaa !56 ; 2 uses
...
begin_hunk_3_@jpeg_start_decompress:bb.a
  ...
  tail call void %i.bc(ptr noundef nonnull %0) #4
  %.pre38.i = load i32, ptr %i.aq, align 8, !tbaa !54
  br label %bb.o

bb.o:                                             ; preds = %bb.n, %bb.m
  %i.bd = phi i32 [ %.pre38.i, %bb.n ], [ %i.au, %bb.m ]
  %i.be = load ptr, ptr %i.at, align 8, !tbaa !57
  %i.bf = getelementptr inbounds nuw i8, ptr %i.be, i64 8
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !58
  tail call void %i.bg(ptr noundef nonnull %0, ptr noundef null, ptr noundef nonnull %i.aq, i32 noundef 0) #4
  %i.bh = load i32, ptr %i.aq, align 8, !tbaa !54 ; 2 uses
...
bb.p:                                             ; preds = %.preheader.i
  ...
  tail call void %i.bk(ptr noundef nonnull %0) #4
  %i.bl = load ptr, ptr %i.am, align 8, !tbaa !51
  %i.bm = load ptr, ptr %i.bl, align 8, !tbaa !52
  tail call void %i.bm(ptr noundef nonnull %0) #4
  store i32 0, ptr %i.aq, align 8, !tbaa !54
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  %i.ac = load i32, ptr %i.i, align 8, !tbaa !54
  %i.ad = add i32 %i.ac, %i.ab
  store i32 %i.ad, ptr %i.i, align 8, !tbaa !54
  br label %bb.h
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.i = load i32, ptr %i.h, align 8, !tbaa !54   ; 2 uses
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  %i.x = load i32, ptr %i.w, align 8, !tbaa !65
...
bb.j:                                             ; preds = %bb.i
  %i.ak = load i32, ptr %i.h, align 8, !tbaa !54
  %i.al = add i32 %i.ak, %i.aa
  store i32 %i.al, ptr %i.h, align 8, !tbaa !54
  br label %bb.k
...
begin_hunk_12_@jpeg_start_output:bb.a
  ...
  tail call void %i.r(ptr noundef nonnull %0) #4
...
begin_hunk_14_@jpeg_start_output:bb.a
  ...
  %.pre.pre.i = load i32, ptr %i.x, align 8, !tbaa !54
  br label %.preheader.i

.preheader.i:                                     ; preds = %.preheader.i.backedge, %.preheader.lr.ph.i
  %i.ab = phi i32 [ %.pre.pre.i, %.preheader.lr.ph.i ], [ %.be, %.preheader.i.backedge ] ; 3 uses
  %i.ac = load i32, ptr %i.y, align 4, !tbaa !56  ; 2 uses
...
begin_hunk_15_@jpeg_start_output:bb.a
  ...
  tail call void %i.aj(ptr noundef nonnull %0) #4
  %.pre38.i = load i32, ptr %i.x, align 8, !tbaa !54
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %bb.h
  %i.ak = phi i32 [ %.pre38.i, %bb.i ], [ %i.ab, %bb.h ]
  %i.al = load ptr, ptr %i.aa, align 8, !tbaa !57
  %i.am = getelementptr inbounds nuw i8, ptr %i.al, i64 8
  %i.an = load ptr, ptr %i.am, align 8, !tbaa !58
  tail call void %i.an(ptr noundef nonnull %0, ptr noundef null, ptr noundef nonnull %i.x, i32 noundef 0) #4
  %i.ao = load i32, ptr %i.x, align 8, !tbaa !54  ; 2 uses
...
begin_hunk_18_@jpeg_finish_output:bb.a
  ...
  br i1 %i.x, label %.loopexit, label %bb.f, !llvm.loop !72
...
!57 = !{!9, !22, i64 536}
!58 = !{!59, !11, i64 8}
!59 = !{!"jpeg_d_main_controller", !11, i64 0, !11, i64 8}
!60 = distinct !{!60, !61}
...
!67 = !{!9, !23, i64 544}
!68 = !{!69, !11, i64 24}
!69 = !{!"jpeg_d_coef_controller", !11, i64 0, !11, i64 8, !11, i64 16, !11, i64 24, !70, i64 32}
!70 = !{!"p2 _ZTS20jvirt_barray_control", !17, i64 0}
!71 = !{!35, !5, i64 36}
!72 = distinct !{!72, !61}
end_hunk_19
