...
bb.b:                                             ; preds = %.lr.ph95, %_ZN3vecIP6ClauseE6shrinkEi.exit
  %i.m = phi i32 [ %i.d, %.lr.ph95 ], [ %i.dz, %_ZN3vecIP6ClauseE6shrinkEi.exit ] ; 2 uses
...
.lr.ph80.preheader:                               ; preds = %bb.k
  ...
  %i.cl = sub i64 %.06084128, %.06383127
...
vector.ph:                                        ; preds = %.lr.ph80.preheader
  ...
  %i.cn = getelementptr i8, ptr %i.ac, i64 %i.cm  ; 2 uses
  %i.co = getelementptr i8, ptr %i.bz, i64 %i.cm  ; 2 uses
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.cp = shl i64 %index, 3                       ; 2 uses
  %next.gep = getelementptr i8, ptr %i.ac, i64 %i.cp ; 2 uses
  %next.gep129 = getelementptr i8, ptr %i.bz, i64 %i.cp ; 2 uses
  %i.cq = getelementptr i8, ptr %next.gep, i64 16
  %wide.load = load <2 x ptr>, ptr %next.gep, align 8, !tbaa !46
  %wide.load130 = load <2 x ptr>, ptr %i.cq, align 8, !tbaa !46
  %i.cr = getelementptr i8, ptr %next.gep129, i64 16
  store <2 x ptr> %wide.load, ptr %next.gep129, align 8, !tbaa !46
  store <2 x ptr> %wide.load130, ptr %i.cr, align 8, !tbaa !46
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.cs = icmp eq i64 %index.next, %n.vec
  br i1 %i.cs, label %middle.block, label %vector.body, !llvm.loop !84
...
.lr.ph80.preheader132:                            ; preds = %.lr.ph80.preheader, %middle.block
  %.16178.ph = phi ptr [ %i.ac, %.lr.ph80.preheader ], [ %i.cn, %middle.block ]
  %.16477.ph = phi ptr [ %i.bz, %.lr.ph80.preheader ], [ %i.co, %middle.block ]
  br label %.lr.ph80

.lr.ph80:                                         ; preds = %.lr.ph80.preheader132, %.lr.ph80
  %.16178 = phi ptr [ %i.ct, %.lr.ph80 ], [ %.16178.ph, %.lr.ph80.preheader132 ] ; 2 uses
  %.16477 = phi ptr [ %i.cv, %.lr.ph80 ], [ %.16477.ph, %.lr.ph80.preheader132 ] ; 2 uses
  %i.ct = getelementptr inbounds nuw i8, ptr %.16178, i64 8 ; 3 uses
  %i.cu = load ptr, ptr %.16178, align 8, !tbaa !46
  %i.cv = getelementptr inbounds nuw i8, ptr %.16477, i64 8 ; 2 uses
  store ptr %i.cu, ptr %.16477, align 8, !tbaa !46
  %i.cw = icmp ult ptr %i.ct, %i.z
  br i1 %i.cw, label %.lr.ph80, label %.loopexit, !llvm.loop !85

bb.l:                                             ; preds = %._crit_edge
  %i.cx = select i1 %i.ao, i8 -1, i8 1
  store i8 %i.cx, ptr %i.am, align 1, !tbaa !67
  %i.cy = load i32, ptr %i.i, align 8, !tbaa !55
  %i.cz = load ptr, ptr %i.j, align 8, !tbaa !54
  %i.da = getelementptr inbounds [4 x i8], ptr %i.cz, i64 %i.al
  store i32 %i.cy, ptr %i.da, align 4, !tbaa !4
  %i.db = load ptr, ptr %i.k, align 8, !tbaa !45
  %i.dc = getelementptr inbounds [8 x i8], ptr %i.db, i64 %i.al
  store ptr %i.ad, ptr %i.dc, align 8, !tbaa !46
  %i.dd = load i32, ptr %i.c, align 8, !tbaa !51  ; 3 uses
  %i.de = load i32, ptr %i.l, align 4, !tbaa !73
  %i.df = icmp eq i32 %i.dd, %i.de
  %.pre.i.i = load ptr, ptr %i.b, align 8, !tbaa !50 ; 2 uses
  br i1 %i.df, label %bb.m, label %_ZN6Solver16uncheckedEnqueueE3LitP6Clause.exit

bb.m:                                             ; preds = %bb.l
  %i.dg = mul nsw i32 %i.dd, 3
  %i.dh = add nsw i32 %i.dg, 1
  %i.di = ashr i32 %i.dh, 1
  %i.dj = tail call noundef i32 @llvm.smax.i32(i32 %i.di, i32 2) ; 2 uses
  store i32 %i.dj, ptr %i.l, align 4, !tbaa !73
  %i.dk = zext nneg i32 %i.dj to i64
  %i.dl = shl nuw nsw i64 %i.dk, 2
  %i.dm = tail call ptr @realloc(ptr noundef %.pre.i.i, i64 noundef %i.dl) #19 ; 2 uses
  store ptr %i.dm, ptr %i.b, align 8, !tbaa !50
...
_ZN6Solver16uncheckedEnqueueE3LitP6Clause.exit:   ; preds = %bb.l, %bb.m
  %i.dn = phi i32 [ %.pre2.i.i, %bb.m ], [ %i.dd, %bb.l ] ; 2 uses
  %i.do = phi ptr [ %i.dm, %bb.m ], [ %.pre.i.i, %bb.l ]
  %i.dp = add nsw i32 %i.dn, 1
  store i32 %i.dp, ptr %i.c, align 8, !tbaa !51
  %i.dq = sext i32 %i.dn to i64
  %i.dr = getelementptr inbounds [4 x i8], ptr %i.do, i64 %i.dq
  store i32 %.sroa.014.0.copyload, ptr %i.dr, align 4, !tbaa !4
  br label %.loopexit

.loopexit:                                        ; preds = %.lr.ph80, %middle.block, %bb.k, %bb.j, %bb.f, %_ZN6Solver16uncheckedEnqueueE3LitP6Clause.exit
  %.265 = phi ptr [ %i.au, %bb.f ], [ %.06383, %bb.j ], [ %i.bz, %_ZN6Solver16uncheckedEnqueueE3LitP6Clause.exit ], [ %i.bz, %bb.k ], [ %i.co, %middle.block ], [ %i.cv, %.lr.ph80 ] ; 2 uses
  %.262 = phi ptr [ %i.ac, %bb.f ], [ %i.ac, %bb.j ], [ %i.ac, %_ZN6Solver16uncheckedEnqueueE3LitP6Clause.exit ], [ %i.ac, %bb.k ], [ %i.cn, %middle.block ], [ %i.ct, %.lr.ph80 ] ; 2 uses
...
._crit_edge88:                                    ; preds = %.loopexit, %bb.b
  ...
  %i.ds = ptrtoint ptr %.060.lcssa to i64
  %i.dt = ptrtoint ptr %.063.lcssa to i64
  %i.du = sub i64 %i.ds, %i.dt
  %i.dv = lshr exact i64 %i.du, 3
  %i.dw = trunc i64 %i.dv to i32                  ; 2 uses
  %i.dx = icmp sgt i32 %i.dw, 0
  br i1 %i.dx, label %.lr.ph.i, label %_ZN3vecIP6ClauseE6shrinkEi.exit

.lr.ph.i:                                         ; preds = %._crit_edge88
  %.promoted.i = load i32, ptr %i.w, align 8, !tbaa !44
  %i.dy = sub i32 %.promoted.i, %i.dw
  store i32 %i.dy, ptr %i.w, align 8, !tbaa !44
  br label %_ZN3vecIP6ClauseE6shrinkEi.exit

_ZN3vecIP6ClauseE6shrinkEi.exit:                  ; preds = %._crit_edge88, %.lr.ph.i
  %i.dz = load i32, ptr %i.a, align 8, !tbaa !80  ; 2 uses
  %i.ea = load i32, ptr %i.c, align 8, !tbaa !51
  %i.eb = icmp slt i32 %i.dz, %i.ea
  br i1 %i.eb, label %bb.b, label %._crit_edge96.loopexit, !llvm.loop !87

._crit_edge96.loopexit:                           ; preds = %_ZN3vecIP6ClauseE6shrinkEi.exit
  %i.ec = zext nneg i32 %i.u to i64
  br label %._crit_edge96

._crit_edge96:                                    ; preds = %._crit_edge96.loopexit, %bb.a
  %.059.lcssa = phi i64 [ 0, %bb.a ], [ %i.ec, %._crit_edge96.loopexit ] ; 2 uses
  %.0.lcssa = phi ptr [ null, %bb.a ], [ %.1.lcssa, %._crit_edge96.loopexit ]
  %i.ed = getelementptr inbounds nuw i8, ptr %0, i64 128 ; 2 uses
  %i.ee = load i64, ptr %i.ed, align 8, !tbaa !88
  %i.ef = add i64 %i.ee, %.059.lcssa
  store i64 %i.ef, ptr %i.ed, align 8, !tbaa !88
  %i.eg = getelementptr inbounds nuw i8, ptr %0, i64 384 ; 2 uses
  %i.eh = load i64, ptr %i.eg, align 8, !tbaa !89
  %i.ei = sub nsw i64 %i.eh, %.059.lcssa
  store i64 %i.ei, ptr %i.eg, align 8, !tbaa !89
  ret ptr %.0.lcssa
}
