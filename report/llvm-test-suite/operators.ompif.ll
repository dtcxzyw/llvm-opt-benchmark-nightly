...
bb.e:                                             ; preds = %.lr.ph227, %._crit_edge224
  ...
  %6 = extractelement <2 x i32> %i.x, i64 1       ; 12 uses
  %7 = extractelement <2 x i32> %i.x, i64 0       ; 12 uses
...
.preheader.us.us.us:                              ; preds = %._crit_edge.us.us.us, %.preheader210.us.us
  ...
  %i.et = mul i32 %7, %indvar258                  ; 4 uses
...
bb.b:                                             ; preds = %.lr.ph297, %._crit_edge294
  ...
  %i.aj = getelementptr inbounds [216 x i8], ptr %i.ai, i64 %i.e ; 8 uses
...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  %i.bi = load i32, ptr %i.aq, align 8, !tbaa !348
  %i.bj = add nsw i32 %i.bi, %.0286292
  %i.bk = sitofp i32 %i.bj to double
  %i.bl = fadd nnan double %i.bk, 5.000000e-01
  %i.bm = load i32, ptr %i.ar, align 4, !tbaa !67 ; 3 uses
  %i.bn = add nsw i32 %i.bm, %.0284289
  %7 = load i32, ptr %i.as, align 8, !tbaa !65
  %8 = add nsw i32 %i.bm, %.0285290
  %9 = mul nsw i32 %7, %8
  %i.bo = add nsw i32 %i.bn, %9
  %10 = load i32, ptr %i.at, align 4, !tbaa !66
  %11 = add nsw i32 %i.bm, %.0286292
  %12 = mul nsw i32 %10, %11
  %13 = add nsw i32 %i.bo, %12
  %14 = load <2 x i32>, ptr %i.ap, align 8, !tbaa !4
  %15 = insertelement <2 x i32> poison, i32 %.0284289, i64 0
  %16 = insertelement <2 x i32> %15, i32 %.0285290, i64 1
  %17 = add nsw <2 x i32> %14, %16
  %18 = sitofp <2 x i32> %17 to <2 x double>
  %19 = fadd nnan <2 x double> %18, splat (double 5.000000e-01)
  %20 = fmul <2 x double> %6, %19                 ; 3 uses
  %21 = fmul double %2, %i.bl                     ; 2 uses
  %22 = extractelement <2 x double> %20, i64 0
  %i.bp = fadd double %22, -5.000000e-01          ; 2 uses
  %i.bq = tail call double @pow(double noundef %i.bp, double noundef 2.000000e+00) #10, !tbaa !4
  %23 = extractelement <2 x double> %20, i64 1
  %i.br = fadd double %23, -5.000000e-01          ; 2 uses
  %i.bs = tail call double @pow(double noundef %i.br, double noundef 2.000000e+00) #10, !tbaa !4
  %i.bt = fadd double %i.bq, %i.bs
  %i.bu = fadd double %21, -5.000000e-01          ; 2 uses
  ...
  %24 = insertelement <4 x double> poison, double %i.bw, i64 0
  %25 = shufflevector <2 x double> %20, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %26 = shufflevector <4 x double> %24, <4 x double> %25, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %27 = insertelement <4 x double> %26, double %21, i64 3
  %28 = fmul <4 x double> %27, <double -2.000000e+01, double f0x401921FB54442D18, double f0x401921FB54442D18, double f0x401921FB54442D18> ; 4 uses
  %29 = extractelement <4 x double> %28, i64 3    ; 10 uses
  %30 = extractelement <4 x double> %28, i64 2    ; 10 uses
  %31 = extractelement <4 x double> %28, i64 1    ; 10 uses
  %32 = extractelement <4 x double> %28, i64 0    ; 10 uses
  %33 = tail call double @exp(double noundef %32) #10, !tbaa !4
  %i.df = tail call double @sin(double noundef %31) #10, !tbaa !4
  %i.dg = fmul double %33, %i.df
  %34 = tail call double @sin(double noundef %30) #10, !tbaa !4
  %i.dh = fmul double %i.dg, %34
  %i.di = tail call double @sin(double noundef %29) #10, !tbaa !4
  %i.dj = fmul double %i.dh, %i.di                ; 8 uses
  %i.dk = fmul double %i.bx, -2.000000e+01        ; 3 uses
  %i.dl = tail call double @exp(double noundef %32) #10, !tbaa !4
  %i.dm = fmul double %i.dl, f0x401921FB54442D18
  %i.dn = tail call double @cos(double noundef %31) #10, !tbaa !4
  %i.do = fmul double %i.dm, %i.dn
  %i.dp = tail call double @sin(double noundef %30) #10, !tbaa !4
  %i.dq = fmul double %i.do, %i.dp
  %i.dr = tail call double @sin(double noundef %29) #10, !tbaa !4
  ...
  %i.dv = tail call double @exp(double noundef %32) #10, !tbaa !4
  %i.dw = fmul double %i.dv, f0x401921FB54442D18
  %i.dx = tail call double @sin(double noundef %31) #10, !tbaa !4
  %i.dy = fmul double %i.dw, %i.dx
  %i.dz = tail call double @cos(double noundef %30) #10, !tbaa !4
  %i.ea = fmul double %i.dy, %i.dz
  %i.eb = tail call double @sin(double noundef %29) #10, !tbaa !4
  ...
  %i.ef = tail call double @exp(double noundef %32) #10, !tbaa !4
  %i.eg = fmul double %i.ef, f0x401921FB54442D18
  %i.eh = tail call double @sin(double noundef %31) #10, !tbaa !4
  %i.ei = fmul double %i.eg, %i.eh
  %i.ej = tail call double @sin(double noundef %30) #10, !tbaa !4
  %i.ek = fmul double %i.ei, %i.ej
  %i.el = tail call double @cos(double noundef %29) #10, !tbaa !4
  ...
  %i.er = tail call double @exp(double noundef %32) #10, !tbaa !4
  %i.es = fmul double %i.eq, %i.er
  %i.et = tail call double @cos(double noundef %31) #10, !tbaa !4
  %i.eu = fmul double %i.es, %i.et
  %i.ev = tail call double @sin(double noundef %30) #10, !tbaa !4
  %i.ew = fmul double %i.eu, %i.ev
  %i.ex = tail call double @sin(double noundef %29) #10, !tbaa !4
  %i.ey = tail call double @llvm.fmuladd.f64(double %i.ew, double %i.ex, double %i.ep)
  %i.ez = tail call double @exp(double noundef %32) #10, !tbaa !4
  %i.fa = fmul double %i.ez, f0x4043BD3CC9BE45DE
  %i.fb = tail call double @sin(double noundef %31) #10, !tbaa !4
  %i.fc = fmul double %i.fa, %i.fb
  %i.fd = tail call double @sin(double noundef %30) #10, !tbaa !4
  %i.fe = tail call double @sin(double noundef %29) #10, !tbaa !4
  ...
  %i.fl = tail call double @exp(double noundef %32) #10, !tbaa !4
  %i.fm = fmul double %i.fk, %i.fl
  %i.fn = tail call double @sin(double noundef %31) #10, !tbaa !4
  %i.fo = fmul double %i.fm, %i.fn
  %i.fp = tail call double @cos(double noundef %30) #10, !tbaa !4
  %i.fq = fmul double %i.fo, %i.fp
  %i.fr = tail call double @sin(double noundef %29) #10, !tbaa !4
  %i.fs = tail call double @llvm.fmuladd.f64(double %i.fq, double %i.fr, double %i.fj)
  %i.ft = tail call double @exp(double noundef %32) #10, !tbaa !4
  %i.fu = fmul double %i.ft, f0x4043BD3CC9BE45DE
  %i.fv = tail call double @sin(double noundef %31) #10, !tbaa !4
  %i.fw = fmul double %i.fu, %i.fv
  %i.fx = tail call double @sin(double noundef %30) #10, !tbaa !4
  %i.fy = tail call double @sin(double noundef %29) #10, !tbaa !4
  ...
  %i.gf = tail call double @exp(double noundef %32) #10, !tbaa !4
  %i.gg = fmul double %i.ge, %i.gf
  %i.gh = tail call double @sin(double noundef %31) #10, !tbaa !4
  %i.gi = fmul double %i.gg, %i.gh
  %i.gj = tail call double @sin(double noundef %30) #10, !tbaa !4
  %i.gk = fmul double %i.gi, %i.gj
  %i.gl = tail call double @cos(double noundef %29) #10, !tbaa !4
  %i.gm = tail call double @llvm.fmuladd.f64(double %i.gk, double %i.gl, double %i.gd)
  %i.gn = tail call double @exp(double noundef %32) #10, !tbaa !4
  %i.go = fmul double %i.gn, f0x4043BD3CC9BE45DE
  %i.gp = tail call double @sin(double noundef %31) #10, !tbaa !4
  %i.gq = fmul double %i.go, %i.gp
  %i.gr = tail call double @sin(double noundef %30) #10, !tbaa !4
  %i.gs = tail call double @sin(double noundef %29) #10, !tbaa !4
  ...
  %i.hl = sext i32 %13 to i64                     ; 4 uses
  ...
  br i1 %i.hy, label %bb.c, label %._crit_edge.loopexit, !llvm.loop !349
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader
  ...
  br i1 %i.ic, label %.preheader, label %._crit_edge291.loopexit, !llvm.loop !350
...
._crit_edge291:                                   ; preds = %.preheader.lr.ph, %._crit_edge291.loopexit, %.preheader288
  ...
  br i1 %i.ih, label %.preheader288, label %._crit_edge294, !llvm.loop !352
...
._crit_edge294:                                   ; preds = %._crit_edge291, %.preheader288.lr.ph, %bb.b
  ...
  br i1 %i.ik, label %bb.b, label %._crit_edge298, !llvm.loop !353
...
!348 = !{!36, !5, i64 16}
!349 = distinct !{!349, !46}
!350 = distinct !{!350, !46, !351}
!351 = !{!"llvm.loop.unswitch.partial.disable"}
!352 = distinct !{!352, !46, !351}
!353 = distinct !{!353, !46}
end_hunk_2
