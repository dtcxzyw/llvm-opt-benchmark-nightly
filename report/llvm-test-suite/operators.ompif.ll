...
bb.b:                                             ; preds = %.lr.ph, %._crit_edge
  ...
  %4 = extractelement <2 x i32> %i.ac, i64 1      ; 19 uses
  %5 = extractelement <2 x i32> %i.ac, i64 0      ; 13 uses
  %6 = getelementptr inbounds nuw i8, ptr %i.m, i64 176
  %i.ad = load ptr, ptr %6, align 8, !tbaa !35
  %7 = getelementptr inbounds [8 x i8], ptr %i.ad, i64 %i.h
  %8 = load ptr, ptr %7, align 8, !tbaa !42       ; 17 uses
  %9 = add i32 %5, 1                              ; 2 uses
  %i.ae = add i32 %9, %4                          ; 3 uses
  %i.af = mul i32 %i.ae, %i.aa
  %i.ag = sext i32 %i.af to i64                   ; 2 uses
  %i.ah = getelementptr inbounds [8 x i8], ptr %8, i64 %i.ag ; 24 uses
...
.preheader102.us.us.preheader:                    ; preds = %bb.b
  ...
  %scevgep155 = getelementptr i8, ptr %8, i64 %i.bd
  %i.be = shl i32 %4, 1
  %i.bf = shl i32 %5, 1
  %scevgep157 = getelementptr i8, ptr %8, i64 -8
  ...
  %scevgep160 = getelementptr i8, ptr %8, i64 %i.bd
  %i.bi = add i32 %5, %4
  %scevgep162 = getelementptr i8, ptr %8, i64 -8
  %scevgep163 = getelementptr i8, ptr %scevgep162, i64 %i.bh
  %scevgep165 = getelementptr i8, ptr %8, i64 %i.bd
  %i.bj = add i32 %4, 1
  %scevgep167 = getelementptr i8, ptr %8, i64 -8
  %scevgep168 = getelementptr i8, ptr %scevgep167, i64 %i.bh
  %scevgep170 = getelementptr i8, ptr %8, i64 %i.bd
  %scevgep172 = getelementptr i8, ptr %8, i64 -8
  %scevgep173 = getelementptr i8, ptr %scevgep172, i64 %i.bh
  %scevgep175 = getelementptr i8, ptr %8, i64 %i.bd
  %scevgep177 = getelementptr i8, ptr %8, i64 -8
  %scevgep178 = getelementptr i8, ptr %scevgep177, i64 %i.bh
  %scevgep180 = getelementptr i8, ptr %8, i64 %i.bd
  %scevgep182 = getelementptr i8, ptr %8, i64 -8
  %scevgep183 = getelementptr i8, ptr %scevgep182, i64 %i.bh
  %scevgep185 = getelementptr i8, ptr %8, i64 %i.bd
  %scevgep187 = getelementptr i8, ptr %8, i64 -8
  %scevgep188 = getelementptr i8, ptr %scevgep187, i64 %i.bh
  %scevgep190 = getelementptr i8, ptr %8, i64 %i.bd
  %scevgep192 = getelementptr i8, ptr %8, i64 -8
...
.preheader102.us.us:                              ; preds = %.preheader102.us.us.preheader, %._crit_edge105.split.us.us.us
  ...
  %i.cc = mul i32 %i.aw, %.0100106.us.us          ; 4 uses
  %i.cd = insertelement <2 x i32> poison, i32 %i.cb, i64 0
  %10 = insertelement <2 x i32> %i.cd, i32 %i.cc, i64 1
  %i.ce = or disjoint <2 x i32> %10, <i32 0, i32 1>
  %11 = add i32 %5, %i.cc
  ...
  %12 = shufflevector <4 x i32> %i.ch, <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %13 = shufflevector <2 x i32> %i.ce, <2 x i32> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %14 = shufflevector <8 x i32> %i.cl, <8 x i32> %13, <8 x i32> <i32 0, i32 8, i32 9, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %15 = insertelement <8 x i32> %14, i32 %11, i64 3
  %i.cm = shufflevector <8 x i32> %15, <8 x i32> %12, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11> ; 2 uses
...
.preheader.us.us.us:                              ; preds = %._crit_edge.us.us.us, %.preheader102.us.us
  ...
  %i.ds = mul i32 %.099104.us.us.us, %5
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %i.ff = add nsw i32 %i.ek, %5                   ; 2 uses
  %i.fg = add nsw i32 %i.el, %5                   ; 2 uses
  ...
  %i.fq = add nsw i32 %i.eu, %5                   ; 2 uses
  %i.fr = add nsw i32 %i.ev, %5                   ; 2 uses
  ...
  %i.gb = add nsw i32 %i.ek, %4
  %i.gc = add nsw i32 %i.el, %4
  ...
  %i.gm = add nsw i32 %i.eu, %4
  %i.gn = add nsw i32 %i.ev, %4
  ...
  %i.gx = add nsw i32 %i.ff, %4
  %i.gy = add nsw i32 %i.fg, %4
  ...
  %i.hi = add nsw i32 %i.fq, %4
  %i.hj = add nsw i32 %i.fr, %4
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.ih = add nsw i32 %reass.mul.us.us.us, %5     ; 2 uses
  ...
  %i.im = add nsw i32 %i.ic, %5                   ; 2 uses
  ...
  %i.ir = add nsw i32 %reass.mul.us.us.us, %4
