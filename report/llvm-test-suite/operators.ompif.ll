...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  %5 = tail call double @llvm.fmuladd.f64(double %i.ek, double -4.000000e+01, double %i.hk)
  ...
  %6 = fmul double %i.hp, %i.hq
  %i.hr = tail call double @cos(double noundef %i.ec) #10, !tbaa !4
  %7 = tail call double @llvm.fmuladd.f64(double %6, double %i.hr, double %5)
  %i.hs = tail call double @exp(double noundef %i.ed) #10, !tbaa !4
  %i.ht = tail call double @sin(double noundef %i.eb) #10, !tbaa !4
  %8 = tail call double @sin(double noundef %i.ea) #10, !tbaa !4
  %9 = tail call double @sin(double noundef %i.ec) #10, !tbaa !4
  %10 = fneg double %8
  %11 = extractelement <2 x double> %i.fi, i64 1
  %i.hu = fmul double %i.dq, %11
  ...
  %i.hz = insertelement <2 x double> <double poison, double 4.500000e+01>, double %i.ht, i64 0
  %i.ia = fmul <2 x double> %i.hy, %i.hz
  %i.ib = insertelement <2 x double> poison, double %10, i64 0
  ...
  %i.if = insertelement <2 x double> %i.ie, double %9, i64 0
  %i.ig = insertelement <2 x double> poison, double %7, i64 0
  %i.ih = insertelement <2 x double> %i.ig, double %i.hu, i64 1
