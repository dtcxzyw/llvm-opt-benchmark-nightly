...
bb.b:                                             ; preds = %.lr.ph, %._crit_edge
  ...
  %.0144164 = phi double [ -1.000000e+00, %.lr.ph ], [ %.1145, %._crit_edge ] ; 2 uses
...
.preheader148.us.us:                              ; preds = %.preheader148.us.us.preheader, %._crit_edge153.split.us.us.us
  %.0156.us.us = phi double [ %.3.us.us.us, %._crit_edge153.split.us.us.us ], [ -1.000000e+00, %.preheader148.us.us.preheader ]
  %.0141155.us.us = phi i32 [ %i.dj, %._crit_edge153.split.us.us.us ], [ 0, %.preheader148.us.us.preheader ] ; 2 uses
  %i.bd = mul nsw i32 %.0141155.us.us, %i.q
...
.preheader.us.us.us:                              ; preds = %._crit_edge.us.us.us, %.preheader148.us.us
  ...
  %.1145151.us.us.us = phi double [ %.0156.us.us, %.preheader148.us.us ], [ %.3.us.us.us, %._crit_edge.us.us.us ]
...
bb.c:                                             ; preds = %bb.c, %.preheader.us.us.us
  ...
  %.2150.us.us.us = phi double [ %.3.us.us.us, %bb.c ], [ %.1145151.us.us.us, %.preheader.us.us.us ] ; 2 uses
  ...
  %i.dh = fcmp ogt double %i.dg, %.2150.us.us.us
  %.3.us.us.us = select i1 %i.dh, double %i.dg, double %.2150.us.us.us ; 4 uses
...
._crit_edge153.split.us.us.us:                    ; preds = %._crit_edge.us.us.us
  %i.dj = add nuw nsw i32 %.0141155.us.us, 1      ; 2 uses
...
._crit_edge:                                      ; preds = %._crit_edge153.split.us.us.us, %.preheader148.lr.ph, %bb.b
  %.0.lcssa = phi double [ -1.000000e+00, %bb.b ], [ -1.000000e+00, %.preheader148.lr.ph ], [ %.3.us.us.us, %._crit_edge153.split.us.us.us ] ; 2 uses
  %i.dk = fcmp ogt double %.0.lcssa, %.0144164
  %.1145 = select i1 %i.dk, double %.0.lcssa, double %.0144164 ; 2 uses
...
._crit_edge166:                                   ; preds = %._crit_edge, %bb.a
  %.0144.lcssa = phi double [ -1.000000e+00, %bb.a ], [ %.1145, %._crit_edge ] ; 2 uses
...
bb.f:                                             ; preds = %bb.e, %bb.d
  %i.dv = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %1, double noundef %.0144.lcssa) ; 0 uses
...
bb.g:                                             ; preds = %bb.f, %._crit_edge166
  ...
  store double %.0144.lcssa, ptr %i.dz, align 8, !tbaa !44
  ret void
}
...
bb.d:                                             ; preds = %bb.c, %._crit_edge226
  %.0207227 = phi i32 [ 0, %bb.c ], [ %i.kp, %._crit_edge226 ] ; 4 uses
  %i.m = and i32 %.0207227, 1
...
.lr.ph:                                           ; preds = %bb.e
  ...
  %scevgep260.a = getelementptr i8, ptr %i.as, i64 %i.cj
  %scevgep262.a = getelementptr i8, ptr %i.as, i64 8
  %scevgep263.a = getelementptr i8, ptr %scevgep262.a, i64 %i.cj
...
bb.b:                                             ; preds = %.lr.ph, %._crit_edge70.split
  ...
  %i.p = getelementptr inbounds nuw i8, ptr %i.m, i64 52
  %i.q = load i32, ptr %i.p, align 4, !tbaa !66   ; 2 uses
  %i.r = getelementptr inbounds nuw i8, ptr %i.m, i64 44
  %i.s = load i32, ptr %i.r, align 4, !tbaa !67
  %i.t = getelementptr inbounds nuw i8, ptr %i.m, i64 20
  %i.u = getelementptr inbounds nuw i8, ptr %i.m, i64 28
...
vector.body:                                      ; preds = %vector.scevcheck, %vector.body
  ...
  %wide.load = load <2 x double>, ptr %i.be, align 8, !tbaa !44
  %wide.load89 = load <2 x double>, ptr %i.bf, align 8, !tbaa !44
  ...
  store <2 x double> %i.bg, ptr %i.bi, align 8, !tbaa !44
  store <2 x double> %i.bh, ptr %i.bj, align 8, !tbaa !44
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader
  ...
  store double %i.bq, ptr %i.br, align 8, !tbaa !44
...
scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader.new
  ...
  store double %i.by, ptr %i.bz, align 8, !tbaa !44
  ...
  %i.cd = load double, ptr %i.cc, align 8, !tbaa !44
  %i.ce = fadd double %4, %i.cd
  %i.cf = getelementptr inbounds [8 x i8], ptr %i.ai, i64 %i.cb
  store double %i.ce, ptr %i.cf, align 8, !tbaa !44
...
bb.b:                                             ; preds = %.lr.ph, %._crit_edge81.split
  ...
  %.06783 = phi i32 [ undef, %.lr.ph ], [ %.1, %._crit_edge81.split ]
...
bb.e:                                             ; preds = %bb.d, %bb.c, %5, %bb.b
  %.1 = phi i32 [ %.06783, %bb.b ], [ 1, %5 ], [ %i.o, %bb.c ], [ %i.q, %bb.d ] ; 6 uses
...
.preheader73:                                     ; preds = %.preheader73.preheader, %._crit_edge78
  %.06780 = phi i32 [ %i.da, %._crit_edge78 ], [ 0, %.preheader73.preheader ] ; 3 uses
  %i.au = mul nsw i32 %.06780, %i.q
  br label %.preheader

.preheader:                                       ; preds = %.preheader73, %._crit_edge
  %.06877 = phi i32 [ 0, %.preheader73 ], [ %i.cz, %._crit_edge ] ; 3 uses
  %i.av = mul nsw i32 %.06877, %i.o
  %i.aw = add i32 %i.av, %i.au                    ; 6 uses
  %i.ax = add i32 %i.aw, %i.y
  %i.ay = icmp slt i32 %i.ax, %i.aw
  %or.cond = select i1 %min.iters.check, i1 true, i1 %i.ay
...
vector.body:                                      ; preds = %.preheader, %vector.body
  ...
  %i.az = trunc nuw nsw i64 %index to i32
  %i.ba = add i32 %i.aw, %i.az                    ; 2 uses
  %i.bb = sub nsw i32 %i.ba, %.1
  %i.bc = sext i32 %i.bb to i64
  %i.bd = getelementptr inbounds [8 x i8], ptr %i.ai, i64 %i.bc ; 2 uses
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 16
  %wide.load = load <2 x double>, ptr %i.bd, align 8, !tbaa !44
  %wide.load101 = load <2 x double>, ptr %i.be, align 8, !tbaa !44
  %i.bf = sext i32 %i.ba to i64                   ; 2 uses
  %i.bg = getelementptr inbounds [8 x i8], ptr %i.ai, i64 %i.bf ; 2 uses
  %i.bh = getelementptr inbounds nuw i8, ptr %i.bg, i64 16
  %wide.load102 = load <2 x double>, ptr %i.bg, align 8, !tbaa !44
  %wide.load103 = load <2 x double>, ptr %i.bh, align 8, !tbaa !44
  %i.bi = fadd <2 x double> %wide.load, %wide.load102
  %i.bj = fadd <2 x double> %wide.load101, %wide.load103
  %i.bk = fmul <2 x double> %i.bi, splat (double 5.000000e-01)
  %i.bl = fmul <2 x double> %i.bj, splat (double 5.000000e-01)
  %i.bm = getelementptr inbounds [8 x i8], ptr %i.am, i64 %i.bf ; 2 uses
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bm, i64 16
  store <2 x double> %i.bk, ptr %i.bm, align 8, !tbaa !44
  store <2 x double> %i.bl, ptr %i.bn, align 8, !tbaa !44
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.bo = icmp eq i64 %index.next, %n.vec
  br i1 %i.bo, label %middle.block, label %vector.body, !llvm.loop !336
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader
  %i.bp = trunc nuw nsw i64 %indvars.iv.ph to i32
  %i.bq = add i32 %i.aw, %i.bp                    ; 2 uses
  %i.br = sub nsw i32 %i.bq, %.1
  %i.bs = sext i32 %i.br to i64
  %i.bt = getelementptr inbounds [8 x i8], ptr %i.ai, i64 %i.bs
  %i.bu = load double, ptr %i.bt, align 8, !tbaa !44
  %i.bv = sext i32 %i.bq to i64                   ; 2 uses
  %i.bw = getelementptr inbounds [8 x i8], ptr %i.ai, i64 %i.bv
  %i.bx = load double, ptr %i.bw, align 8, !tbaa !44
  %i.by = fadd double %i.bu, %i.bx
  %i.bz = fmul double %i.by, 5.000000e-01
  %i.ca = getelementptr inbounds [8 x i8], ptr %i.am, i64 %i.bv
  store double %i.bz, ptr %i.ca, align 8, !tbaa !44
  %indvars.iv.next.prol = or disjoint i64 %indvars.iv.ph, 1
  br label %scalar.ph.prol.loopexit

scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  %indvars.iv.unr = phi i64 [ %indvars.iv.ph, %scalar.ph.preheader ], [ %indvars.iv.next.prol, %scalar.ph.prol ]
  %i.cb = icmp eq i64 %indvars.iv.ph, %i.ar
  br i1 %i.cb, label %._crit_edge, label %scalar.ph.preheader.new

scalar.ph.preheader.new:                          ; preds = %scalar.ph.prol.loopexit
  %invariant.op = add i32 1, %i.aw
  br label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader.new
  %indvars.iv = phi i64 [ %indvars.iv.unr, %scalar.ph.preheader.new ], [ %indvars.iv.next.1, %scalar.ph ] ; 3 uses
  %i.cc = trunc nuw nsw i64 %indvars.iv to i32
  %i.cd = add i32 %i.aw, %i.cc                    ; 2 uses
  %i.ce = sub nsw i32 %i.cd, %.1
  %i.cf = sext i32 %i.ce to i64
  %i.cg = getelementptr inbounds [8 x i8], ptr %i.ai, i64 %i.cf
  ...
  %i.cn = getelementptr inbounds [8 x i8], ptr %i.am, i64 %i.ci
  store double %i.cm, ptr %i.cn, align 8, !tbaa !44
  %i.co = trunc i64 %indvars.iv to i32
  %.reass = add i32 %i.co, %invariant.op          ; 2 uses
  %i.cp = sub nsw i32 %.reass, %.1
  %i.cq = sext i32 %i.cp to i64
  %i.cr = getelementptr inbounds [8 x i8], ptr %i.ai, i64 %i.cq
  %i.cs = load double, ptr %i.cr, align 8, !tbaa !44
  %i.ct = sext i32 %.reass to i64                 ; 2 uses
  ...
  %i.cy = getelementptr inbounds [8 x i8], ptr %i.am, i64 %i.ct
  store double %i.cx, ptr %i.cy, align 8, !tbaa !44
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, %wide.trip.count
  br i1 %exitcond.not.1, label %._crit_edge, label %scalar.ph, !llvm.loop !337

._crit_edge:                                      ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  %i.cz = add nuw i32 %.06877, 1
...
._crit_edge85:                                    ; preds = %._crit_edge81.split, %bb.a
  %i.db = tail call i64 (...) @CycleTime() #10
  %i.dc = sub i64 %i.db, %i.a
  %i.dd = getelementptr inbounds nuw i8, ptr %0, i64 960
  %i.de = getelementptr inbounds [8 x i8], ptr %i.dd, i64 %i.b ; 2 uses
  %i.df = load i64, ptr %i.de, align 8, !tbaa !63
  %i.dg = add i64 %i.dc, %i.df
  store i64 %i.dg, ptr %i.de, align 8, !tbaa !63
  ret void
}
...
.preheader91.us.us:                               ; preds = %.preheader91.us.us.preheader, %._crit_edge98.split.us.us.us
  %.0101.us.us = phi double [ %.lcssa, %._crit_edge98.split.us.us.us ], [ 0.000000e+00, %.preheader91.us.us.preheader ]
  %.082100.us.us = phi i32 [ %i.cb, %._crit_edge98.split.us.us.us ], [ 0, %.preheader91.us.us.preheader ] ; 2 uses
  %i.ay = mul nsw i32 %.082100.us.us, %i.z
  br label %.preheader.us.us.us

.preheader.us.us.us:                              ; preds = %._crit_edge.us.us.us, %.preheader91.us.us
  %.197.us.us.us = phi double [ %.0101.us.us, %.preheader91.us.us ], [ %.lcssa, %._crit_edge.us.us.us ] ; 2 uses
  %.08396.us.us.us = phi i32 [ 0, %.preheader91.us.us ], [ %i.ca, %._crit_edge.us.us.us ] ; 2 uses
  %i.az = mul nsw i32 %.08396.us.us.us, %i.x
...
._crit_edge.us.us.us:                             ; preds = %._crit_edge.us.us.us.unr-lcssa, %.epil.preheader
  ...
  %i.ca = add nuw nsw i32 %.08396.us.us.us, 1     ; 2 uses
