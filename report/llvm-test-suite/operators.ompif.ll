...
.preheader.us.us.us:                              ; preds = %._crit_edge.us.us.us, %.preheader148.us.us
  %.0143152.us.us.us = phi i32 [ 0, %.preheader148.us.us ], [ %i.dm, %._crit_edge.us.us.us ] ; 2 uses
  %.1145151.us.us.us = phi double [ %.0144156.us.us, %.preheader148.us.us ], [ %.3.us.us.us, %._crit_edge.us.us.us ]
  %i.bg = mul nsw i32 %.0143152.us.us.us, %i.o
...
._crit_edge.us.us.us:                             ; preds = %bb.c
  %i.dm = add nuw nsw i32 %.0143152.us.us.us, 1   ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph, %._crit_edge81
  ...
  %.06785 = phi i32 [ undef, %.lr.ph ], [ %.1, %._crit_edge81 ]
...
bb.e:                                             ; preds = %bb.d, %bb.c, %5, %bb.b
  %.1 = phi i32 [ %.06785, %bb.b ], [ 1, %5 ], [ %i.o, %bb.c ], [ %i.q, %bb.d ] ; 6 uses
