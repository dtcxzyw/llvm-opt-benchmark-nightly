...
bb.b:                                             ; preds = %.lr.ph, %._crit_edge
  ...
  %4 = load <2 x i32>, ptr %i.ab, align 8, !tbaa !4 ; 3 uses
  %5 = extractelement <2 x i32> %4, i64 1         ; 19 uses
  %6 = extractelement <2 x i32> %4, i64 0         ; 13 uses
  ...
  %i.ag = add i32 %6, 1                           ; 2 uses
  %i.ah = add i32 %i.ag, %5                       ; 3 uses
...
.preheader102.us.us.preheader:                    ; preds = %bb.b
  %7 = shufflevector <2 x i32> %4, <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 0> ; 2 uses
  %wide.trip.count = zext nneg i32 %i.u to i64    ; 6 uses
  %i.ax = add nsw i64 %wide.trip.count, -1        ; 3 uses
  %i.ay = shl i32 %5, 1
  %i.az = shl i32 %6, 1                           ; 2 uses
  %8 = shufflevector <4 x i32> <i32 1, i32 0, i32 1, i32 poison>, <4 x i32> %7, <4 x i32> <i32 0, i32 1, i32 2, i32 5>
  %9 = add <4 x i32> %7, %8
...
.preheader.us.us.us:                              ; preds = %._crit_edge.us.us.us, %.preheader102.us.us
  ...
  %i.dy = mul i32 %.099104.us.us.us, %6
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %i.fl = add nsw i32 %i.eq, %6                   ; 2 uses
  %i.fm = add nsw i32 %i.er, %6                   ; 2 uses
  ...
  %i.fw = add nsw i32 %i.fa, %6                   ; 2 uses
  %i.fx = add nsw i32 %i.fb, %6                   ; 2 uses
  ...
  %i.gh = add nsw i32 %i.eq, %5
  %i.gi = add nsw i32 %i.er, %5
  ...
  %i.gs = add nsw i32 %i.fa, %5
  %i.gt = add nsw i32 %i.fb, %5
  ...
  %i.hd = add nsw i32 %i.fl, %5
  %i.he = add nsw i32 %i.fm, %5
  ...
  %i.ho = add nsw i32 %i.fw, %5
  %i.hp = add nsw i32 %i.fx, %5
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.in = add nsw i32 %reass.mul.us.us.us, %6     ; 2 uses
  ...
  %i.is = add nsw i32 %i.ii, %6                   ; 2 uses
  ...
  %i.ix = add nsw i32 %reass.mul.us.us.us, %5
...
bb.b:                                             ; preds = %.lr.ph, %._crit_edge224
  ...
  %3 = load <2 x i32>, ptr %i.ab, align 8, !tbaa !4 ; 5 uses
  %4 = extractelement <2 x i32> %3, i64 1         ; 28 uses
  %5 = extractelement <2 x i32> %3, i64 0         ; 25 uses
...
.preheader200.us.us.preheader:                    ; preds = %.preheader200.lr.ph
  ...
  %6 = shufflevector <2 x i32> %3, <2 x i32> poison, <4 x i32> <i32 1, i32 0, i32 poison, i32 poison>
...
.preheader200.us.us:                              ; preds = %.preheader200.us.us.preheader, %._crit_edge203.split.us.us.us
  ...
  %i.ck = mul i32 %i.be, %.0185204.us.us          ; 3 uses
  %7 = insertelement <2 x i32> poison, i32 %i.ck, i64 0
  %i.cl = add i32 %i.bg, %i.ck
  %8 = mul nsw i32 %.0185204.us.us, %i.r
  %i.cm = mul i32 %.0185204.us.us, %4
  %9 = insertelement <4 x i32> poison, i32 %i.cl, i64 0
  ...
  %i.cn = insertelement <4 x i32> %12, i32 %i.ck, i64 3 ; 2 uses
...
.preheader197.us.us.us:                           ; preds = %._crit_edge.us.us.us, %.preheader200.us.us
  ...
  %i.dh = mul i32 %.0182202.us.us.us, %5
  %reass.add193.us.us.us = add i32 %i.dh, %i.cm   ; 3 uses
...
vector.body454:                                   ; preds = %vector.memcheck409, %vector.body454
  ...
  %i.ep = add nsw i32 %i.ef, %5                   ; 2 uses
  %i.eq = add nsw i32 %i.eg, %5                   ; 2 uses
  ...
  %i.fa = add nsw i32 %i.ef, %4
  %i.fb = add nsw i32 %i.eg, %4
  %i.fc = sext i32 %i.fa to i64
  %i.fd = sext i32 %i.fb to i64
  ...
  %i.fj = insertelement <2 x double> %i.fi, double %i.fh, i64 1
  %i.fk = fadd <2 x double> %i.ez, %i.fj
  %i.fl = add nsw i32 %i.ep, %4
  %i.fm = add nsw i32 %i.eq, %4
  %i.fn = sext i32 %i.fl to i64
  %i.fo = sext i32 %i.fm to i64
...
scalar.ph449:                                     ; preds = %scalar.ph449.preheader, %scalar.ph449
  ...
  %i.gf = add nsw i32 %reass.mul195.us.us.us, %5  ; 2 uses
  ...
  %i.gk = add nsw i32 %reass.mul195.us.us.us, %4
...
.preheader199.us.us.preheader:                    ; preds = %.preheader199.lr.ph
  ...
  %13 = shufflevector <2 x i32> <i32 poison, i32 1>, <2 x i32> %3, <2 x i32> <i32 3, i32 1> ; 2 uses
...
.preheader199.us.us:                              ; preds = %.preheader199.us.us.preheader, %._crit_edge212.split.us.us.us
  ...
  %i.ik = mul i32 %i.he, %.1186213.us.us          ; 3 uses
  %14 = insertelement <2 x i32> poison, i32 %i.ik, i64 0
  %15 = shufflevector <2 x i32> %14, <2 x i32> poison, <2 x i32> zeroinitializer ; 2 uses
  %16 = add <2 x i32> %13, %15
  %17 = or disjoint <2 x i32> %13, %15
  %i.il = add i32 %i.hg, %i.ik
  %i.im = mul nsw i32 %.1186213.us.us, %i.r
  %i.in = mul i32 %.1186213.us.us, %4
  %i.io = insertelement <4 x i32> poison, i32 %i.il, i64 0
  %18 = shufflevector <2 x i32> %16, <2 x i32> %17, <4 x i32> <i32 0, i32 3, i32 poison, i32 poison>
  %19 = shufflevector <4 x i32> %i.io, <4 x i32> %18, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %i.ip = insertelement <4 x i32> %19, i32 %i.ik, i64 3 ; 2 uses
...
.preheader196.us.us.us:                           ; preds = %._crit_edge210.us.us.us, %.preheader199.us.us
  ...
  %i.jj = mul i32 %.1183211.us.us.us, %5
...
vector.body391:                                   ; preds = %vector.memcheck346, %vector.body391
  ...
  %i.lc = add nsw i32 %i.kh, %4
  %i.ld = add nsw i32 %i.ki, %4
  ...
  %i.ln = add nsw i32 %i.kr, %4
  %i.lo = add nsw i32 %i.ks, %4
...
scalar.ph386:                                     ; preds = %scalar.ph386.preheader, %scalar.ph386
  ...
  %i.mm = add nsw i32 %reass.mul192.us.us.us, %4
...
.preheader198.us.us.preheader:                    ; preds = %.preheader198.lr.ph
  ...
  %20 = insertelement <2 x i32> %3, i32 1, i64 1  ; 2 uses
...
.preheader198.us.us:                              ; preds = %.preheader198.us.us.preheader, %._crit_edge222.split.us.us.us
  ...
  %i.om = mul i32 %i.ng, %.2187223.us.us          ; 3 uses
  %21 = insertelement <2 x i32> poison, i32 %i.om, i64 0
  %22 = shufflevector <2 x i32> %21, <2 x i32> poison, <2 x i32> zeroinitializer ; 2 uses
  %23 = add <2 x i32> %20, %22
  %24 = or disjoint <2 x i32> %20, %22
  %i.on = add i32 %i.ni, %i.om
  %i.oo = mul nsw i32 %.2187223.us.us, %i.r
  %i.op = mul i32 %.2187223.us.us, %4
  %i.oq = insertelement <4 x i32> poison, i32 %i.on, i64 0
  %25 = shufflevector <2 x i32> %23, <2 x i32> %24, <4 x i32> <i32 0, i32 3, i32 poison, i32 poison>
  %26 = shufflevector <4 x i32> %i.oq, <4 x i32> %25, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %i.or = insertelement <4 x i32> %26, i32 %i.om, i64 3 ; 2 uses
...
.preheader.us.us.us:                              ; preds = %._crit_edge220.us.us.us, %.preheader198.us.us
  ...
  %i.pl = mul i32 %.2184221.us.us.us, %5
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %i.re = add nsw i32 %i.qj, %5
  %i.rf = add nsw i32 %i.qk, %5
  ...
  %i.rp = add nsw i32 %i.qt, %5
  %i.rq = add nsw i32 %i.qu, %5
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.so = add nsw i32 %reass.mul.us.us.us, %5
