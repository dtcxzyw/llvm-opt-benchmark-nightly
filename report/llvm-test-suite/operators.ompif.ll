...
bb.b:                                             ; preds = %.lr.ph, %._crit_edge66.split
  ...
  %i.r = load i32, ptr %i.q, align 4, !tbaa !67   ; 10 uses
...
.preheader61.lr.ph:                               ; preds = %bb.b
  ...
  %i.ah = load i32, ptr %i.ag, align 4, !tbaa !70 ; 4 uses
...
.preheader61.preheader:                           ; preds = %.preheader61.lr.ph
  ...
  %3 = zext i32 %i.ar to i64
  %4 = add nuw nsw i64 %3, 1                      ; 2 uses
  %i.av = add i32 %i.ah, %i.r
  %i.aw = add i32 %i.ah, -1
...
scalar.ph.preheader:                              ; preds = %vector.scevcheck, %.preheader, %middle.block
  ...
  %i.bo = sub i32 %i.av, %i.bn
  %i.bp = sub i32 %i.ax, %i.bn
...
.preheader78.us.preheader:                        ; preds = %.preheader78.lr.ph
  ...
  %21 = add i32 %i.x, %i.r
  %i.bd = add i32 %i.x, -1
  %i.be = add i32 %i.bd, %i.r
  %min.iters.check160 = icmp ult i32 %i.ba, 3
  %n.vec163 = and i64 %i.bc, 8589934588           ; 3 uses
  %i.bf = add nsw i64 %n.vec163, %i.ao
  %cmp.n168 = icmp eq i64 %i.bc, %n.vec163
  %min.iters.check146 = icmp ult i32 %i.ax, 3
  %n.vec149 = and i64 %11, 8589934588             ; 3 uses
  %i.bg = add nsw i64 %n.vec149, %i.ao
  %cmp.n154 = icmp eq i64 %11, %n.vec149
  %min.iters.check = icmp ult i32 %i.as, 3
  %n.vec = and i64 %5, 8589934588                 ; 3 uses
...
.lr.ph.split.us.us.preheader175:                  ; preds = %.lr.ph.split.us.us.preheader, %middle.block153
  ...
  %i.cm = sub i32 %18, %i.cl
  %i.cn = sub i32 %20, %i.cl
...
.lr.ph.split.us92.preheader:                      ; preds = %.preheader.us89
  ...
  %or.cond173 = select i1 %min.iters.check, i1 true, i1 %i.cw
...
scalar.ph159.preheader:                           ; preds = %vector.scevcheck156, %.preheader.us.us, %middle.block167
  %indvars.iv.ph = phi i64 [ %i.ao, %vector.scevcheck156 ], [ %i.ao, %.preheader.us.us ], [ %i.bf, %middle.block167 ] ; 3 uses
  %i.eu = trunc i64 %indvars.iv.ph to i32         ; 2 uses
  %i.ev = sub i32 %15, %i.eu
  %i.ew = sub i32 %17, %i.eu
