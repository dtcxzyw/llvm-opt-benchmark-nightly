...
.preheader65:                                     ; preds = %.preheader65.preheader, %._crit_edge68
  %.06469 = phi i32 [ %i.ch, %._crit_edge68 ], [ 0, %.preheader65.preheader ] ; 2 uses
  %i.av = mul nsw i32 %.06469, %i.q
  br label %.preheader

.preheader:                                       ; preds = %.preheader65, %._crit_edge
  %.06367 = phi i32 [ 0, %.preheader65 ], [ %i.cg, %._crit_edge ] ; 2 uses
  %i.aw = mul nsw i32 %.06367, %i.o
...
._crit_edge:                                      ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  %i.cg = add nuw nsw i32 %.06367, 1              ; 2 uses
...
._crit_edge68:                                    ; preds = %._crit_edge
  %i.ch = add nuw nsw i32 %.06469, 1              ; 2 uses
...
.preheader73:                                     ; preds = %.preheader73.preheader, %._crit_edge78
  %.07080 = phi i32 [ %i.da, %._crit_edge78 ], [ 0, %.preheader73.preheader ] ; 3 uses
  %i.au = mul nsw i32 %.07080, %i.q
  br label %.preheader

.preheader:                                       ; preds = %.preheader73, %._crit_edge
  %.06977 = phi i32 [ 0, %.preheader73 ], [ %i.cz, %._crit_edge ] ; 3 uses
  %i.av = mul nsw i32 %.06977, %i.o
