Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/llvm-test-suite/original/zht?download=true
inline.NumInlined: 2
begin_hunk_0
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.n = load <2 x float>, ptr %i.a, align 8, !tbaa !14
  %i.o = fpext <2 x float> %i.n to <2 x double>   ; 2 uses
  %i.p = extractelement <2 x double> %i.o, i64 0
  %i.q = extractelement <2 x double> %i.o, i64 1
  %i.r = call i32 @gs_screen_init(ptr noundef nonnull %i.k, ptr noundef %i.m, double noundef %i.p, double noundef %i.q) #3 ; 2 uses
  %i.s = icmp slt i32 %i.r, 0
  br i1 %i.s, label %bb.f, label %bb.g

bb.f:                                             ; preds = %bb.e
  %i.t = load i32, ptr @gs_screen_enum_sizeof, align 4, !tbaa !4
  call void @alloc_free(ptr noundef nonnull %i.k, i32 noundef 1, i32 noundef %i.t, ptr noundef nonnull @.str) #3
  br label %bb.n

bb.g:                                             ; preds = %bb.e
  %i.u = load ptr, ptr @esp, align 8, !tbaa !16   ; 6 uses
  %i.v = getelementptr inbounds nuw i8, ptr %i.u, i64 48 ; 3 uses
  %i.w = load ptr, ptr @estop, align 8, !tbaa !16
  %i.x = icmp ugt ptr %i.v, %i.w
  br i1 %i.x, label %bb.n, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.y = getelementptr inbounds nuw i8, ptr %i.u, i64 16
  store i16 0, ptr %i.y, align 8, !tbaa !18
  %i.z = getelementptr inbounds nuw i8, ptr %i.u, i64 24
  store i16 33, ptr %i.z, align 8, !tbaa !8
  %i.aa = getelementptr inbounds nuw i8, ptr %i.u, i64 32 ; 2 uses
  store ptr %i.aa, ptr @esp, align 8, !tbaa !16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.aa, ptr noundef nonnull align 8 dereferenceable(16) %0, i64 16, i1 false), !tbaa.struct !19
  store ptr %i.v, ptr @esp, align 8, !tbaa !16
  store ptr %i.k, ptr %i.v, align 8, !tbaa !18
  %i.ab = getelementptr inbounds nuw i8, ptr %i.u, i64 56
  store i16 52, ptr %i.ab, align 8, !tbaa !8
  %i.ac = load i32, ptr @gs_screen_enum_sizeof, align 4, !tbaa !4
  %i.ad = trunc i32 %i.ac to i16
  %i.ae = getelementptr inbounds nuw i8, ptr %i.u, i64 58
  store i16 %i.ad, ptr %i.ae, align 2, !tbaa !21
  %i.af = load ptr, ptr @osp, align 8, !tbaa !16
  %i.ag = getelementptr inbounds i8, ptr %i.af, i64 -48
  store ptr %i.ag, ptr @osp, align 8, !tbaa !16
...
bb.j:                                             ; preds = %bb.i
  %i.ak = load ptr, ptr @esp, align 8, !tbaa !16  ; 2 uses
  %i.al = getelementptr inbounds i8, ptr %i.ak, i64 -16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) getelementptr inbounds nuw (i8, ptr @istate, i64 8), ptr noundef nonnull align 8 dereferenceable(16) %i.al, i64 16, i1 false), !tbaa.struct !19
  %i.am = getelementptr inbounds i8, ptr %i.ak, i64 -48
  store ptr %i.am, ptr @esp, align 8, !tbaa !16
  br label %screen_sample.exit

bb.k:                                             ; preds = %bb.i
  store ptr %i.b, ptr @osp, align 8, !tbaa !16
  %i.an = load ptr, ptr @ostop, align 8, !tbaa !16
  %i.ao = icmp ugt ptr %i.b, %i.an
...
bb.m:                                             ; preds = %bb.k
  %i.ap = load float, ptr %1, align 4, !tbaa !23
  %i.aq = getelementptr inbounds i8, ptr %0, i64 -32
  store float %i.ap, ptr %i.aq, align 8, !tbaa !18
  %i.ar = getelementptr inbounds i8, ptr %0, i64 -24
  store i16 44, ptr %i.ar, align 8, !tbaa !8
  %i.as = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.at = load float, ptr %i.as, align 4, !tbaa !25
  store float %i.at, ptr %i.b, align 8, !tbaa !18
...
bb.n:                                             ; preds = %bb.g, %bb.d, %bb.c, %bb.b, %bb.a, %screen_sample.exit, %bb.f
  %.0 = phi i32 [ %.0.i, %screen_sample.exit ], [ %i.c, %bb.a ], [ -20, %bb.b ], [ -7, %bb.c ], [ %i.r, %bb.f ], [ -25, %bb.d ], [ -5, %bb.g ]
