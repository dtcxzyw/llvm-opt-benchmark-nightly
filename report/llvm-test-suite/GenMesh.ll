...
_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit67: ; preds = %bb.z
  %i.eb = load ptr, ptr %0, align 8, !tbaa !17    ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  %i.x = fadd double %i.r, f0xBD719799812DEA11
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.am = select <2 x i1> %i.al, <2 x double> %i.ak, <2 x double> %i.ag ; 2 uses
  %i.an = extractelement <2 x double> %i.am, i64 0
  %i.ao = extractelement <2 x double> %i.am, i64 1
  %i.ap = fcmp ole double %i.ao, %i.an
  %i.aq = select i1 %i.ap, i32 %.038.i, i32 %.0.i ; 5 uses
  %i.ar = getelementptr inbounds nuw i8, ptr %0, i64 56 ; 2 uses
  store i32 %i.aq, ptr %i.ar, align 8, !tbaa !24
  %i.as = sdiv i32 %i.l, %i.aq                    ; 4 uses
...
bb.f:                                             ; preds = %bb.e
  store i32 %i.as, ptr %i.ar, align 8, !tbaa !9
  store i32 %i.aq, ptr %i.at, align 4, !tbaa !9
...
_ZN7GenMesh9calcNumPEEv.exit:                     ; preds = %bb.e, %bb.f
  ...
  store i32 %i.bi, ptr %i.bj, align 8, !tbaa !29
  %i.bk = load i32, ptr %i.b, align 4, !tbaa !22  ; 2 uses
  %i.bl = mul nsw i32 %i.bk, %i.az
  %i.bm = sdiv i32 %i.bl, %i.au                   ; 2 uses
  %i.bn = getelementptr inbounds nuw i8, ptr %0, i64 84
  store i32 %i.bm, ptr %i.bn, align 4, !tbaa !30
  ...
  store i32 %i.br, ptr %i.bs, align 4, !tbaa !31
  %i.bt = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.bu = load i64, ptr %i.bt, align 8, !tbaa !15 ; 3 uses
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit: ; preds = %_ZN7GenMesh9calcNumPEEv.exit
  %i.bv = load ptr, ptr %0, align 8, !tbaa !17    ; 3 uses
...
bb.c:                                             ; preds = %bb.b
  %i.w = fadd double %i.q, f0xBD719799812DEA11
