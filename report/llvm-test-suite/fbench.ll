Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/llvm-test-suite/original/fbench?download=true
inline.NumInlined: 1
inline.NumDeleted: 1
loop-unroll.NumCompletelyUnrolled: 4
loop-unroll.NumUnrolled: 4
begin_hunk_0_@main:.preheader43
  %.pre61 = load double, ptr @od_sa.1, align 8, !tbaa !8
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %.preheader, %.preheader43.._crit_edge_crit_edge
  %i.af = phi double [ %.pre61, %.preheader43.._crit_edge_crit_edge ], [ %i.j, %.preheader ]
...
bb.a:                                             ; preds = %._crit_edge, %._crit_edge62
  %indvars.iv57 = phi i64 [ 0, %._crit_edge ], [ %.pre63, %._crit_edge62 ] ; 3 uses
  %.052 = phi i32 [ 0, %._crit_edge ], [ %.3, %._crit_edge62 ] ; 3 uses
  %i.ax = getelementptr inbounds nuw [80 x i8], ptr @outarr, i64 %indvars.iv57 ; 3 uses
  %i.ay = getelementptr inbounds nuw [8 x i8], ptr @refarr, i64 %indvars.iv57
  ...
  %.pre63 = add nuw nsw i64 %indvars.iv57, 1      ; 3 uses
  br i1 %.not39, label %._crit_edge62, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.bb = trunc nuw nsw i64 %.pre63 to i32
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %.148 = phi i32 [ %.052, %.lr.ph.preheader ], [ %spec.select, %.lr.ph ]
  ...
  %spec.select = add nsw i32 %.148, %i.br         ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %._crit_edge50, label %.lr.ph, !llvm.loop !16

._crit_edge50:                                    ; preds = %.lr.ph, %bb.b
  %.1.lcssa = phi i32 [ %.052, %bb.b ], [ %spec.select, %.lr.ph ]
  %putchar = tail call i32 @putchar(i32 10)       ; 0 uses
  br label %._crit_edge62

._crit_edge62:                                    ; preds = %bb.a, %._crit_edge50
  %.3 = phi i32 [ %.1.lcssa, %._crit_edge50 ], [ %.052, %bb.a ] ; 4 uses
  %exitcond60.not = icmp eq i64 %.pre63, 8
  br i1 %exitcond60.not, label %bb.c, label %bb.a, !llvm.loop !17
