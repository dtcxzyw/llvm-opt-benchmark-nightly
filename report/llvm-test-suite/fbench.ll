...
bb.b:                                             ; preds = %.lr.ph.split.us.preheader
  ...
  %2 = fadd double %i.h, -1.000000e+00
  %3 = fsub double %i.a, %i.j
  %i.l = insertelement <2 x double> poison, double %3, i64 0
  %4 = insertelement <2 x double> %i.l, double %2, i64 1
...
bb.f:                                             ; preds = %.lr.ph.split.us.1
  ...
  %5 = fadd double %i.az, -1.000000e+00
  %6 = fsub double %i.a, %i.bb
  %i.bd = insertelement <2 x double> poison, double %6, i64 0
  %7 = insertelement <2 x double> %i.bd, double %5, i64 1
...
bb.m:                                             ; preds = %.lr.ph.split.us.2
  ...
  %8 = fadd double %i.cy, -1.000000e+00
  %9 = fsub double %i.a, %i.da
  %i.dc = insertelement <2 x double> poison, double %9, i64 0
  %10 = insertelement <2 x double> %i.dc, double %8, i64 1
...
bb.t:                                             ; preds = %.lr.ph.split.us.3
  ...
  %11 = fadd double %i.ex, -1.000000e+00
  %12 = fsub double %i.a, %i.ez
  %i.fb = insertelement <2 x double> poison, double %12, i64 0
  %13 = insertelement <2 x double> %i.fb, double %11, i64 1
...
bb.aa:                                            ; preds = %.lr.ph.split.preheader
  ...
  %14 = fadd double %i.h, -1.000000e+00
  %15 = fsub double %i.a, %i.gr
  %i.gt = insertelement <2 x double> poison, double %15, i64 0
  %16 = insertelement <2 x double> %i.gt, double %14, i64 1
...
bb.ad:                                            ; preds = %.lr.ph.split.1
  ...
  %17 = fadd double %i.hp, -1.000000e+00
  %18 = fsub double %i.a, %i.hr
  %i.ht = insertelement <2 x double> poison, double %18, i64 0
  %19 = insertelement <2 x double> %i.ht, double %17, i64 1
...
bb.ag:                                            ; preds = %.lr.ph.split.2
  ...
  %20 = fadd double %i.jf, -1.000000e+00
  %21 = fsub double %i.a, %i.jh
  %i.jj = insertelement <2 x double> poison, double %21, i64 0
  %22 = insertelement <2 x double> %i.jj, double %20, i64 1
...
bb.aj:                                            ; preds = %.lr.ph.split.3
  ...
  %23 = fadd double %i.kv, -1.000000e+00
  %24 = fsub double %i.a, %i.kx
  %i.kz = insertelement <2 x double> poison, double %24, i64 0
  %25 = insertelement <2 x double> %i.kz, double %23, i64 1
