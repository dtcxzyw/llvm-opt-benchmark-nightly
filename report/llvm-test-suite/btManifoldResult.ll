...
bb.b:                                             ; preds = %bb.a
  ...
  %6 = load float, ptr %i.ai, align 8, !tbaa !27, !noalias !28
  %i.ax = load float, ptr %i.ap, align 8, !tbaa !27, !noalias !28
  %i.ay = load float, ptr %i.aq, align 8, !tbaa !27, !noalias !28
  %i.az = load float, ptr %i.ar, align 4, !tbaa !27, !noalias !28
  %i.ba = load float, ptr %i.as, align 4, !tbaa !27, !noalias !28
  %i.bb = load float, ptr %i.at, align 4, !tbaa !27, !noalias !28
  %i.bc = load float, ptr %i.au, align 8, !tbaa !27, !noalias !28
  %i.bd = load float, ptr %i.av, align 8, !tbaa !27, !noalias !28
  %i.be = load float, ptr %i.aw, align 8, !tbaa !27, !noalias !28
  %i.bf = load float, ptr %5, align 4, !tbaa !27
  %7 = fmul float %3, %i.bf
  %8 = load float, ptr %i.j, align 4, !tbaa !27   ; 2 uses
  %9 = load <2 x float>, ptr %1, align 4, !tbaa !27
  %10 = insertelement <2 x float> poison, float %3, i64 0
  %11 = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer
  %12 = fmul <2 x float> %11, %9
  %13 = load <2 x float>, ptr %2, align 4, !tbaa !27 ; 3 uses
  %14 = fadd <2 x float> %12, %13                 ; 3 uses
  %15 = fadd float %7, %8                         ; 2 uses
  %i.bg = insertelement <2 x float> <float poison, float 0.000000e+00>, float %15, i64 0
  %16 = extractelement <2 x float> %14, i64 1
  %17 = fsub float %16, %i.o                      ; 2 uses
  %18 = extractelement <2 x float> %14, i64 0
  %19 = fsub float %18, %i.m                      ; 2 uses
  %20 = fsub float %15, %i.q                      ; 2 uses
  ...
  %i.bj = fmul <2 x float> %22, %i.bi
  %23 = insertelement <2 x float> poison, float %i.z, i64 0
  %i.bk = insertelement <2 x float> %23, float %i.ac, i64 1
  %i.bl = insertelement <2 x float> poison, float %19, i64 0
  %i.bm = shufflevector <2 x float> %i.bl, <2 x float> poison, <2 x i32> zeroinitializer
  %i.bn = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bk, <2 x float> %i.bm, <2 x float> %i.bj)
  ...
  %26 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bp, <2 x float> %25, <2 x float> %i.bn)
  %i.bq = fmul float %17, %i.ag
  %i.br = tail call float @llvm.fmuladd.f32(float %i.af, float %19, float %i.bq)
  %27 = tail call noundef float @llvm.fmuladd.f32(float %i.ah, float %20, float %i.br)
  %.sroa.3.12.vec.insert.i4.i38 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %27, i64 0
  %28 = extractelement <2 x float> %13, i64 1
  %i.bs = fsub float %28, %i.am                   ; 2 uses
  %i.bt = extractelement <2 x float> %13, i64 0
  %i.bu = fsub float %i.bt, %i.ak                 ; 2 uses
  %i.bv = fsub float %8, %i.ao                    ; 2 uses
  ...
  %i.by = insertelement <2 x float> poison, float %i.ax, i64 0
  %i.bz = insertelement <2 x float> %i.by, float %i.ba, i64 1
  %i.ca = fmul <2 x float> %i.bx, %i.bz
  %i.cb = insertelement <2 x float> poison, float %6, i64 0
  %i.cc = insertelement <2 x float> %i.cb, float %i.az, i64 1
  ...
  %i.cg = insertelement <2 x float> poison, float %i.ay, i64 0
  %i.ch = insertelement <2 x float> %i.cg, float %i.bb, i64 1
  ...
  %i.cl = fmul float %i.bs, %i.bd
  %i.cm = tail call float @llvm.fmuladd.f32(float %i.bc, float %i.bu, float %i.cl)
  %i.cn = tail call noundef float @llvm.fmuladd.f32(float %i.be, float %i.bv, float %i.cm)
  %.sroa.3.12.vec.insert.i4.i43 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.cn, i64 0
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #8
  store <2 x float> %26, ptr %4, align 8
  ...
  store <2 x float> %14, ptr %i.cy, align 8
