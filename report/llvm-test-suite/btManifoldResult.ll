...
bb.b:                                             ; preds = %bb.a
  ...
  %5 = load <2 x float>, ptr %1, align 4, !tbaa !27
  %6 = insertelement <2 x float> poison, float %3, i64 0
  %7 = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> zeroinitializer
  %8 = fmul <2 x float> %7, %5
  %9 = load <2 x float>, ptr %2, align 4, !tbaa !27 ; 3 uses
  %10 = fadd <2 x float> %8, %9                   ; 3 uses
  %i.m = getelementptr inbounds nuw i8, ptr %2, i64 8
  ...
  %i.bl = fsub float %13, %i.bk                   ; 2 uses
  ...
  %i.bo = fsub float %14, %i.bn                   ; 2 uses
  ...
  store <2 x float> %10, ptr %i.dl, align 8
