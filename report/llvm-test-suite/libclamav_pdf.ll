...
bb.g:                                             ; preds = %bb.f, %bb.e
  %.0270 = phi ptr [ %i.k, %bb.f ], [ %i.i, %bb.e ] ; 4 uses
  %.0270445 = ptrtoint ptr %.0270 to i64
...
._crit_edge420:                                   ; preds = %bb.p, %.lr.ph419, %bb.o
  %.0281.lcssa = phi ptr [ %i.an, %bb.o ], [ %.0281417, %.lr.ph419 ], [ %i.v, %bb.p ] ; 10 uses
  %i.ba = ptrtoint ptr %.0273416 to i64
  %i.bb = ptrtoint ptr %.0281.lcssa to i64        ; 2 uses
...
cli_pmemstr.exit:                                 ; preds = %.lr.ph.i, %bb.t, %bb.q, %.preheader.i
  ...
  br i1 %i.ch, label %.lr.ph424.preheader, label %._crit_edge425

.lr.ph424.preheader:                              ; preds = %cli_pmemstr.exit
  %4 = add i64 %.0270445, 6
  %5 = sub i64 %4, %i.bb
  %scevgep = getelementptr i8, ptr %.0281.lcssa, i64 %5
  br label %.lr.ph424
...
.lr.ph424:                                        ; preds = %.lr.ph424.preheader, %bb.y
  %.0284423 = phi ptr [ %i.cp, %bb.y ], [ %.0281.lcssa, %.lr.ph424.preheader ] ; 5 uses
...
bb.y:                                             ; preds = %bb.x, %.lr.ph424
  %i.cp = getelementptr inbounds i8, ptr %.0284423, i64 -1 ; 2 uses
...
._crit_edge425:                                   ; preds = %bb.y, %bb.x, %bb.x, %cli_pmemstr.exit
  %.0284.lcssa = phi ptr [ %.0281.lcssa, %cli_pmemstr.exit ], [ %.0284423, %bb.x ], [ %.0284423, %bb.x ], [ %scevgep, %bb.y ] ; 4 uses
