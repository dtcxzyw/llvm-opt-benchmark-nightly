...
bb.n:                                             ; preds = %bb.n, %.preheader.i54
  ...
  %.inner = and i64 %i.jf, 1085102592571150095
  %.inner126 = or disjoint i64 %.inner, 3472328296227680304
  %4 = bitcast i64 %.inner126 to <8 x i8>
  %i.jg = shufflevector <8 x i8> %4, <8 x i8> poison, <16 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3, i32 4, i32 4, i32 5, i32 5, i32 6, i32 6, i32 7, i32 7>
