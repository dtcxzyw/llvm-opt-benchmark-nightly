...
.preheader251:                                    ; preds = %bb.aw
  ...
  %3 = shufflevector <4 x i32> %i.nc, <4 x i32> %i.nd, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %4 = sub nsw <4 x i32> %i.mc, %i.na             ; 2 uses
  %5 = shufflevector <4 x i32> %i.nb, <4 x i32> %4, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %6 = add nsw <8 x i32> %3, %5
  %7 = shufflevector <4 x i32> %i.nb, <4 x i32> %4, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %8 = shufflevector <4 x i32> %i.nc, <4 x i32> %i.nd, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %9 = sub nsw <8 x i32> %7, %8
