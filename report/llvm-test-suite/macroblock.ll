...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.b
  ...
  %indvars.iv.a = phi i32 [ %i.i, %.lr.ph.preheader ], [ %indvars.iv.next84, %bb.b ] ; 2 uses
  ...
  %.lobit = and i32 %indvars.iv.a, 8              ; 2 uses
...
.preheader:                                       ; preds = %.lr.ph, %.preheader
  ...
  %.167.a = phi i32 [ 0, %.lr.ph ], [ %indvars.iv.next, %.preheader ] ; 2 uses
  %.167 = phi i32 [ %.04570, %.lr.ph ], [ %i.ev, %.preheader ]
  ...
  %2 = sext i32 %.167.a to i64                    ; 5 uses
  ...
  %i.ap = getelementptr inbounds [4 x i8], ptr @diff64, i64 %2 ; 2 uses
  ...
  %i.bc = getelementptr [4 x i8], ptr @diff64, i64 %2
  ...
  %i.bq = getelementptr [4 x i8], ptr @diff64, i64 %2
  ...
  %i.ce = getelementptr [4 x i8], ptr @diff64, i64 %2
  ...
  %3 = tail call i32 @distortion4x4(ptr noundef nonnull %i.ap) #17
  %4 = add nsw i32 %3, %.167
  %indvars.iv.next75 = or disjoint i64 %2, 16     ; 4 uses
  ...
  %i.cy = getelementptr inbounds [4 x i8], ptr @diff64, i64 %indvars.iv.next75 ; 2 uses
  ...
  %i.dl = getelementptr [4 x i8], ptr @diff64, i64 %indvars.iv.next75
  ...
  %i.dz = getelementptr [4 x i8], ptr @diff64, i64 %indvars.iv.next75
  ...
  %i.en = getelementptr [4 x i8], ptr @diff64, i64 %indvars.iv.next75
...
bb.b:                                             ; preds = %.preheader
  ...
  %indvars.iv.next84 = add i32 %indvars.iv.a, 8
