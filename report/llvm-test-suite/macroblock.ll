...
bb.u:                                             ; preds = %bb.t, %bb.s
  ...
  %5 = zext nneg i32 %i.dm to i64
  %6 = zext nneg i32 %i.dt to i64                 ; 2 uses
  %7 = zext nneg i32 %i.du to i64
  %8 = zext nneg i32 %i.ea to i64                 ; 2 uses
  ...
  %invariant.gep798 = getelementptr inbounds nuw [2 x i8], ptr %i.a, i64 %5 ; 2 uses
  %wide.trip.count690 = zext i32 %i.dy to i64     ; 3 uses
  %invariant.gep800 = getelementptr inbounds nuw [2 x i8], ptr %i.b, i64 %7 ; 2 uses
...
vector.body842:                                   ; preds = %vector.body842, %vector.ph839
  ...
  %i.azd = getelementptr inbounds nuw [2 x i8], ptr %invariant.gep798, i64 %index843 ; 2 uses
...
.lr.ph501:                                        ; preds = %.lr.ph501.preheader871, %.lr.ph501
  ...
  %gep799 = getelementptr inbounds nuw [2 x i8], ptr %invariant.gep798, i64 %indvars.iv682
...
vector.body824:                                   ; preds = %vector.body824, %vector.ph821
  ...
  %i.bao = getelementptr inbounds nuw [2 x i8], ptr %invariant.gep800, i64 %index825 ; 2 uses
...
.lr.ph507:                                        ; preds = %.lr.ph507.preheader870, %.lr.ph507
  ...
  %gep801 = getelementptr inbounds nuw [2 x i8], ptr %invariant.gep800, i64 %indvars.iv687
