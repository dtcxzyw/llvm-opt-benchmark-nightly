...
bb.d:                                             ; preds = %bb.c
  %i.g = load i32, ptr @cube, align 8, !tbaa !24  ; 3 uses
  ...
  %i.o = tail call ptr (ptr, i32, ...) @set_clear(ptr noundef %i.n, i32 noundef %i.g) #6 ; 4 uses
  %i.p = load i32, ptr @cube, align 8, !tbaa !24  ; 3 uses
  ...
  %i.x = tail call ptr (ptr, i32, ...) @set_clear(ptr noundef %i.w, i32 noundef %i.p) #6 ; 4 uses
...
bb.t:                                             ; preds = %bb.l
  %i.dc = load i32, ptr @cube, align 8, !tbaa !24 ; 3 uses
  ...
  %i.dk = tail call ptr (ptr, i32, ...) @set_clear(ptr noundef %i.dj, i32 noundef %i.dc) #6 ; 4 uses
  %i.dl = load i32, ptr @cube, align 8, !tbaa !24 ; 3 uses
  ...
  %i.dt = tail call ptr (ptr, i32, ...) @set_clear(ptr noundef %i.ds, i32 noundef %i.dl) #6 ; 4 uses
