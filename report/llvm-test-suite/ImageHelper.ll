...
begin_hunk_0_@_Z9saveImagePiPKcii:bb.a
  ...
  %i.u = invoke noundef signext i8 %i.t(ptr noundef nonnull align 8 dereferenceable(570) %i.ag, i8 noundef signext 10)
          to label %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i.us unwind label %.loopexit.split.us, !inline_history !32
...
_ZNSolsEPFRSoS_E.exit.us:                         ; preds = %.noexc38.us
  ...
  br i1 %exitcond53.not, label %_ZNSt14basic_ofstreamIcSt11char_traitsIcEE4openEPKcSt13_Ios_Openmode.exit._crit_edge, label %.preheader.us, !llvm.loop !33
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit.us: ; preds = %.invoke
  ...
  br i1 %exitcond48.not, label %._crit_edge.us, label %.invoke61, !llvm.loop !34
...
begin_hunk_5_@_Z9saveImagePiPKcii:bb.a
  ...
  %i.aw = invoke noundef signext i8 %i.av(ptr noundef nonnull align 8 dereferenceable(570) %i.an, i8 noundef signext 10)
          to label %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i unwind label %.loopexit.split, !inline_history !32
...
_ZNSolsEPFRSoS_E.exit:                            ; preds = %.noexc38
  ...
  br i1 %exitcond.not, label %_ZNSt14basic_ofstreamIcSt11char_traitsIcEE4openEPKcSt13_Ios_Openmode.exit._crit_edge, label %.preheader, !llvm.loop !33
...
._crit_edge.us:                                   ; preds = %bb.b
  ...
  br i1 %exitcond24.not, label %._crit_edge21, label %.preheader.us, !llvm.loop !43
...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %exitcond.not, label %._crit_edge.us, label %bb.b, !llvm.loop !44

._crit_edge.us:                                   ; preds = %bb.c
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1 ; 2 uses
  %exitcond29.not = icmp eq i64 %indvars.iv.next26, %wide.trip.count28
  br i1 %exitcond29.not, label %._crit_edge22, label %.preheader.us, !llvm.loop !45
...
bb.e:                                             ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit
  %i.p = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(ptr noundef nonnull align 8 dereferenceable(8) %i.o)
          to label %_ZNSolsEPFRSoS_E.exit unwind label %bb.f, !inline_history !46 ; 0 uses
...
bb.e:                                             ; preds = %bb.d
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %i.j
  br i1 %exitcond.not, label %._crit_edge.us, label %bb.b, !llvm.loop !47

._crit_edge.us:                                   ; preds = %bb.e
  %indvars.iv.next34 = add nuw nsw i64 %indvars.iv33, 1 ; 2 uses
  %exitcond37.not = icmp eq i64 %indvars.iv.next34, %wide.trip.count36
  br i1 %exitcond37.not, label %._crit_edge30, label %.preheader.us, !llvm.loop !48
...
bb.g:                                             ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit
  %i.t = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(ptr noundef nonnull align 8 dereferenceable(8) %i.s)
          to label %_ZNSolsEPFRSoS_E.exit unwind label %bb.h, !inline_history !46 ; 0 uses
...
!31 = !{!6, !6, i64 0}
!32 = distinct !{ptr @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_, null}
!33 = distinct !{!33, !9}
!34 = distinct !{!34, !9}
!35 = !{!36, !39, i64 240}
!36 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !14, i64 0, !37, i64 216, !6, i64 224, !28, i64 225, !38, i64 232, !39, i64 240, !40, i64 248, !41, i64 256}
