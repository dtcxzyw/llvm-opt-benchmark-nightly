begin_hunk_0_@finish_output_gif:bb.a
  ...
  tail call void %i.ag(ptr noundef nonnull %i.ad) #6, !inline_history !81
  br label %.thread.i
...
begin_hunk_1_@finish_output_gif:bb.a
  ...
  tail call void %i.ax(ptr noundef nonnull %i.au) #6, !inline_history !81
  br label %bb.j
...
begin_hunk_2_@emit_header:bb.a
  ...
  br i1 %i.n, label %bb.c, label %bb.d, !llvm.loop !82
...
begin_hunk_4_@emit_header:bb.a
  ...
  br i1 %exitcond82.not, label %._crit_edge, label %.lr.ph.split.us, !llvm.loop !84
...
begin_hunk_6_@emit_header:bb.a
  ...
  %i.dy = load i32, ptr %i.dx, align 4, !tbaa !83 ; 2 uses
...
begin_hunk_7_@output:bb.a
  ...
  tail call void %i.ai(ptr noundef nonnull %i.af) #6, !inline_history !85
