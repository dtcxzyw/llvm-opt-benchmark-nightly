...
bb.d:                                             ; preds = %.critedge
  ...
  %.val5.val.i.i57.a = load i32, ptr @fol_NOT, align 4
  %.not.i.i58 = icmp eq i32 %.val5.val.i.i57, %.val5.val.i.i57.a
...
.critedge.thread:                                 ; preds = %bb.d, %.critedge
  ...
  %i.af = zext nneg i32 %spec.select66135138 to i64 ; 3 uses
...
.lr.ph118:                                        ; preds = %.lr.ph118.preheader, %bb.i
  ...
  %indvars.iv123 = phi i64 [ %i.af, %.lr.ph118.preheader ], [ %indvars.iv.next124, %bb.i ]
