...
begin_hunk_0_@inf_BackwardSortResolution:bb.a
  ...
  br i1 %.not169183, label %clause_LiteralIsSort.exit.thread, label %.lr.ph187

.lr.ph187:                                        ; preds = %bb.d, %term_IsAtom.exit.thread
  %.1185 = phi ptr [ %.5, %term_IsAtom.exit.thread ], [ %.0191, %bb.d ] ; 5 uses
  %.070184 = phi ptr [ %.val.i158, %term_IsAtom.exit.thread ], [ %i.ah, %bb.d ] ; 4 uses
...
begin_hunk_1_@inf_BackwardSortResolution:bb.a
  ...
  %i.cd = call noundef ptr @memory_Malloc(i32 noundef 16) #12 ; 4 uses
  %6 = getelementptr inbounds nuw i8, ptr %i.cd, i64 8
...
begin_hunk_2_@inf_BackwardEmptySort:bb.a
  ...
  br i1 %.not202221, label %clause_LiteralIsSort.exit.thread, label %.lr.ph225

.lr.ph225:                                        ; preds = %bb.d, %term_IsAtom.exit.thread
  %.1223 = phi ptr [ %.6, %term_IsAtom.exit.thread ], [ %.0229, %bb.d ] ; 5 uses
  %.084222 = phi ptr [ %.val.i191, %term_IsAtom.exit.thread ], [ %i.ah, %bb.d ] ; 4 uses
...
begin_hunk_3_@inf_BackwardEmptySort:bb.a
  ...
  %i.cw = call noundef ptr @memory_Malloc(i32 noundef 16) #12 ; 4 uses
