...
.lr.ph20.i:                                       ; preds = %bb.a
  ...
  br i1 %i.o, label %.lr.ph.us.i.epil.preheader, label %.lr.ph20.i.new

.lr.ph20.i.new:                                   ; preds = %.lr.ph20.i
  %unroll_iter = and i64 %wide.trip.count.i, 2147483644
  br label %.lr.ph.us.i

.lr.ph.us.i:                                      ; preds = %.lr.ph.us.i, %.lr.ph20.i.new
  %indvars.iv.i = phi i64 [ 0, %.lr.ph20.i.new ], [ %indvars.iv.next.i.3, %.lr.ph.us.i ] ; 5 uses
  %niter = phi i64 [ 0, %.lr.ph20.i.new ], [ %niter.next.3, %.lr.ph.us.i ]
  ...
  br i1 %niter.ncmp.3, label %expand_right_edge.exit.loopexit.unr-lcssa, label %.lr.ph.us.i, !llvm.loop !61

expand_right_edge.exit.loopexit.unr-lcssa:        ; preds = %.lr.ph.us.i
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %expand_right_edge.exit, label %.lr.ph.us.i.epil.preheader

.lr.ph.us.i.epil.preheader:                       ; preds = %expand_right_edge.exit.loopexit.unr-lcssa, %.lr.ph20.i
  ...
  br label %.lr.ph.us.i.epil

.lr.ph.us.i.epil:                                 ; preds = %.lr.ph.us.i.epil, %.lr.ph.us.i.epil.preheader
  %indvars.iv.i.epil = phi i64 [ %indvars.iv.i.epil.init, %.lr.ph.us.i.epil.preheader ], [ %indvars.iv.next.i.epil, %.lr.ph.us.i.epil ] ; 2 uses
  %epil.iter = phi i64 [ 0, %.lr.ph.us.i.epil.preheader ], [ %epil.iter.next, %.lr.ph.us.i.epil ]
...
.lr.ph20.i:                                       ; preds = %bb.a
  ...
  br i1 %i.n, label %.lr.ph.us.i.epil.preheader, label %.lr.ph20.i.new
...
expand_right_edge.exit:                           ; preds = %expand_right_edge.exit.loopexit.unr-lcssa, %.lr.ph.us.i.epil, %bb.a
  ...
  %5 = icmp ne i32 %i.c, 0
  %or.cond = and i1 %4, %5
  br i1 %or.cond, label %.lr.ph.us, label %._crit_edge30

.lr.ph.us:                                        ; preds = %expand_right_edge.exit, %._crit_edge.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %._crit_edge.us ], [ 0, %expand_right_edge.exit ] ; 3 uses
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.us
  %.02026.us = phi ptr [ %i.at, %.lr.ph.us ], [ %i.bp, %bb.b ] ; 3 uses
  %.02125.us = phi ptr [ %i.av, %.lr.ph.us ], [ %i.bq, %bb.b ] ; 5 uses
  %.02324.us = phi i32 [ 0, %.lr.ph.us ], [ %i.br, %bb.b ]
  %i.aw = load i8, ptr %.02125.us, align 1, !tbaa !60
  %i.ax = zext i8 %i.aw to i16
  %i.ay = getelementptr inbounds nuw i8, ptr %.02125.us, i64 1
  ...
  %i.be = getelementptr inbounds nuw i8, ptr %.02026.us, i64 1
  store i8 %i.bd, ptr %.02026.us, align 1, !tbaa !60
  %i.bf = getelementptr inbounds nuw i8, ptr %.02125.us, i64 2
  %i.bg = load i8, ptr %i.bf, align 1, !tbaa !60
  %i.bh = zext i8 %i.bg to i16
  %i.bi = getelementptr inbounds nuw i8, ptr %.02125.us, i64 3
  ...
  %i.bp = getelementptr inbounds nuw i8, ptr %.02026.us, i64 2
  store i8 %i.bo, ptr %i.be, align 1, !tbaa !60
  %i.bq = getelementptr inbounds nuw i8, ptr %.02125.us, i64 4
  %i.br = add nuw i32 %.02324.us, 2               ; 2 uses
...
._crit_edge.us:                                   ; preds = %bb.b
  ...
  br i1 %i.bu, label %.lr.ph.us, label %._crit_edge30, !llvm.loop !69
...
.lr.ph20.i:                                       ; preds = %bb.a
  ...
  br i1 %i.q, label %.lr.ph.us.i.epil.preheader, label %.lr.ph20.i.new
...
expand_right_edge.exit:                           ; preds = %expand_right_edge.exit.loopexit.unr-lcssa, %.lr.ph.us.i.epil, %bb.a
  ...
  %5 = icmp ne i32 %i.c, 0
  %or.cond = and i1 %4, %5
  br i1 %or.cond, label %.lr.ph.us, label %._crit_edge40

.lr.ph.us:                                        ; preds = %expand_right_edge.exit, %._crit_edge.us
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %._crit_edge.us ], [ 0, %expand_right_edge.exit ] ; 2 uses
  %indvars.iv = phi i64 [ %indvars.iv.next, %._crit_edge.us ], [ 0, %expand_right_edge.exit ] ; 2 uses
  %i.as = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv42
  %i.at = load ptr, ptr %i.as, align 8, !tbaa !58
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.us
  %.02635.us = phi ptr [ %i.at, %.lr.ph.us ], [ %i.ch, %bb.b ] ; 3 uses
  %.02734.us = phi ptr [ %i.ax, %.lr.ph.us ], [ %i.cj, %bb.b ] ; 5 uses
  %.02833.us = phi ptr [ %i.av, %.lr.ph.us ], [ %i.ci, %bb.b ] ; 5 uses
  %.03032.us = phi i32 [ 0, %.lr.ph.us ], [ %i.ck, %bb.b ]
  %i.ay = load i8, ptr %.02833.us, align 1, !tbaa !60
  %i.az = zext i8 %i.ay to i16
  %i.ba = getelementptr inbounds nuw i8, ptr %.02833.us, i64 1
  %i.bb = load i8, ptr %i.ba, align 1, !tbaa !60
  %i.bc = zext i8 %i.bb to i16
  %i.bd = load i8, ptr %.02734.us, align 1, !tbaa !60
  %i.be = zext i8 %i.bd to i16
  %i.bf = getelementptr inbounds nuw i8, ptr %.02734.us, i64 1
  %i.bg = load i8, ptr %i.bf, align 1, !tbaa !60
  %i.bh = zext i8 %i.bg to i16
  ...
  %i.bo = getelementptr inbounds nuw i8, ptr %.02635.us, i64 1
  store i8 %i.bn, ptr %.02635.us, align 1, !tbaa !60
  %i.bp = getelementptr inbounds nuw i8, ptr %.02833.us, i64 2
  %i.bq = getelementptr inbounds nuw i8, ptr %.02734.us, i64 2
  %i.br = load i8, ptr %i.bp, align 1, !tbaa !60
  %i.bs = zext i8 %i.br to i16
  %i.bt = getelementptr inbounds nuw i8, ptr %.02833.us, i64 3
  %i.bu = load i8, ptr %i.bt, align 1, !tbaa !60
  %i.bv = zext i8 %i.bu to i16
  %i.bw = load i8, ptr %i.bq, align 1, !tbaa !60
  %i.bx = zext i8 %i.bw to i16
  %i.by = getelementptr inbounds nuw i8, ptr %.02734.us, i64 3
  ...
  %i.ch = getelementptr inbounds nuw i8, ptr %.02635.us, i64 2
  store i8 %i.cg, ptr %i.bo, align 1, !tbaa !60
  %i.ci = getelementptr inbounds nuw i8, ptr %.02833.us, i64 4
  %i.cj = getelementptr inbounds nuw i8, ptr %.02734.us, i64 4
  %i.ck = add nuw i32 %.03032.us, 2               ; 2 uses
...
._crit_edge.us:                                   ; preds = %bb.b
  ...
  %i.cn = icmp slt i64 %indvars.iv.next43, %i.cm
  br i1 %i.cn, label %.lr.ph.us, label %._crit_edge40, !llvm.loop !75
...
.lr.ph20.i:                                       ; preds = %bb.a
  ...
  br i1 %i.x, label %.lr.ph.us.i.epil.preheader, label %.lr.ph20.i.new
...
expand_right_edge.exit.loopexit.unr-lcssa:        ; preds = %.lr.ph.us.i
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %expand_right_edge.exit.loopexit, label %.lr.ph.us.i.epil.preheader

.lr.ph.us.i.epil.preheader:                       ; preds = %expand_right_edge.exit.loopexit.unr-lcssa, %.lr.ph20.i
  %indvars.iv.i.epil.init = phi i64 [ 0, %.lr.ph20.i ], [ %indvars.iv.next.i.3, %expand_right_edge.exit.loopexit.unr-lcssa ]
  %lcmp.mod113.a = icmp ne i64 %xtraiter, 0
  tail call void @llvm.assume(i1 %lcmp.mod113.a)
  br label %.lr.ph.us.i.epil
...
expand_right_edge.exit:                           ; preds = %expand_right_edge.exit.loopexit, %bb.a
  ...
  br i1 %i.bb, label %.lr.ph, label %._crit_edge66
...
.lr.ph.split.us:                                  ; preds = %.lr.ph
  ...
  br i1 %i.bf, label %.lr.ph.split.us.split.us, label %.lr.ph.split.us.split

.lr.ph.split.us.split.us:                         ; preds = %.lr.ph.split.us
  br i1 %i.bc, label %.preheader.lr.ph.us.us.us.preheader, label %.lr.ph.split.us.split.us.split

.preheader.lr.ph.us.us.us.preheader:              ; preds = %.lr.ph.split.us.split.us
  %i.bg = zext nneg i32 %i.m to i64               ; 2 uses
  %xtraiter114 = and i32 %i.h, 7                  ; 3 uses
  %i.bh = icmp ult i32 %i.h, 8
  %unroll_iter119 = and i32 %i.h, 2147483640
...
.preheader.lr.ph.us.us.us:                        ; preds = %.preheader.lr.ph.us.us.us.preheader, %._crit_edge.split.us.split.us.us.us.us
  %indvars.iv93 = phi i64 [ 0, %.preheader.lr.ph.us.us.us.preheader ], [ %indvars.iv.next94, %._crit_edge.split.us.split.us.us.us.us ] ; 2 uses
  %indvars.iv91 = phi i64 [ 0, %.preheader.lr.ph.us.us.us.preheader ], [ %indvars.iv.next92, %._crit_edge.split.us.split.us.us.us.us ] ; 2 uses
  %i.bi = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv93
...
.preheader.us.us.us.us.us:                        ; preds = %._crit_edge54.split.us.us.us.us.us.us, %.preheader.lr.ph.us.us.us
  %.04058.us.us.us.us.us = phi ptr [ %i.bj, %.preheader.lr.ph.us.us.us ], [ %i.da, %._crit_edge54.split.us.us.us.us.us.us ] ; 2 uses
  %.04357.us.us.us.us.us = phi i32 [ 0, %.preheader.lr.ph.us.us.us ], [ %i.dc, %._crit_edge54.split.us.us.us.us.us.us ] ; 2 uses
  %.04456.us.us.us.us.us = phi i32 [ 0, %.preheader.lr.ph.us.us.us ], [ %i.db, %._crit_edge54.split.us.us.us.us.us.us ]
  %i.bk = zext i32 %.04357.us.us.us.us.us to i64
  br label %.lr.ph.us.us.us.us.us.us

.lr.ph.us.us.us.us.us.us:                         ; preds = %._crit_edge.us.us.us.us.us.us, %.preheader.us.us.us.us.us
  %indvars.iv86 = phi i64 [ %indvars.iv.next87.a, %._crit_edge.us.us.us.us.us.us ], [ 0, %.preheader.us.us.us.us.us ] ; 2 uses
  %.052.us.us.us.us.us.us = phi i64 [ %.lcssa, %._crit_edge.us.us.us.us.us.us ], [ 0, %.preheader.us.us.us.us.us ] ; 2 uses
  ...
  br i1 %i.bh, label %.epil.preheader, label %.lr.ph.us.us.us.us.us.us.new

.lr.ph.us.us.us.us.us.us.new:                     ; preds = %.lr.ph.us.us.us.us.us.us, %.lr.ph.us.us.us.us.us.us.new
  %.150.us.us.us.us.us.us = phi i64 [ %i.cs, %.lr.ph.us.us.us.us.us.us.new ], [ %.052.us.us.us.us.us.us, %.lr.ph.us.us.us.us.us.us ]
  %.04149.us.us.us.us.us.us = phi ptr [ %i.cp, %.lr.ph.us.us.us.us.us.us.new ], [ %i.bm, %.lr.ph.us.us.us.us.us.us ] ; 9 uses
  %niter120 = phi i32 [ %niter120.next.7, %.lr.ph.us.us.us.us.us.us.new ], [ 0, %.lr.ph.us.us.us.us.us.us ]
  %i.bn = getelementptr inbounds nuw i8, ptr %.04149.us.us.us.us.us.us, i64 1
  %i.bo = load i8, ptr %.04149.us.us.us.us.us.us, align 1, !tbaa !60
  %i.bp = zext i8 %i.bo to i64
  %i.bq = add nsw i64 %.150.us.us.us.us.us.us, %i.bp
  %i.br = getelementptr inbounds nuw i8, ptr %.04149.us.us.us.us.us.us, i64 2
  %i.bs = load i8, ptr %i.bn, align 1, !tbaa !60
  %i.bt = zext i8 %i.bs to i64
  %i.bu = add nsw i64 %i.bq, %i.bt
  %i.bv = getelementptr inbounds nuw i8, ptr %.04149.us.us.us.us.us.us, i64 3
  %i.bw = load i8, ptr %i.br, align 1, !tbaa !60
  %i.bx = zext i8 %i.bw to i64
  %i.by = add nsw i64 %i.bu, %i.bx
  %i.bz = getelementptr inbounds nuw i8, ptr %.04149.us.us.us.us.us.us, i64 4
  %i.ca = load i8, ptr %i.bv, align 1, !tbaa !60
  %i.cb = zext i8 %i.ca to i64
  %i.cc = add nsw i64 %i.by, %i.cb
  %i.cd = getelementptr inbounds nuw i8, ptr %.04149.us.us.us.us.us.us, i64 5
  %i.ce = load i8, ptr %i.bz, align 1, !tbaa !60
  %i.cf = zext i8 %i.ce to i64
  %i.cg = add nsw i64 %i.cc, %i.cf
  %i.ch = getelementptr inbounds nuw i8, ptr %.04149.us.us.us.us.us.us, i64 6
  %i.ci = load i8, ptr %i.cd, align 1, !tbaa !60
  %i.cj = zext i8 %i.ci to i64
  %i.ck = add nsw i64 %i.cg, %i.cj
  %i.cl = getelementptr inbounds nuw i8, ptr %.04149.us.us.us.us.us.us, i64 7
  %i.cm = load i8, ptr %i.ch, align 1, !tbaa !60
  %i.cn = zext i8 %i.cm to i64
  %i.co = add nsw i64 %i.ck, %i.cn
  %i.cp = getelementptr inbounds nuw i8, ptr %.04149.us.us.us.us.us.us, i64 8 ; 2 uses
...
.epil.preheader:                                  ; preds = %._crit_edge.us.us.us.us.us.us.unr-lcssa, %.lr.ph.us.us.us.us.us.us
  %.150.us.us.us.us.us.us.epil.init = phi i64 [ %.052.us.us.us.us.us.us, %.lr.ph.us.us.us.us.us.us ], [ %i.cs, %._crit_edge.us.us.us.us.us.us.unr-lcssa ]
  %.04149.us.us.us.us.us.us.epil.init = phi ptr [ %i.bm, %.lr.ph.us.us.us.us.us.us ], [ %i.cp, %._crit_edge.us.us.us.us.us.us.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod118)
  br label %bb.b

bb.b:                                             ; preds = %bb.b, %.epil.preheader
  %.150.us.us.us.us.us.us.epil = phi i64 [ %.150.us.us.us.us.us.us.epil.init, %.epil.preheader ], [ %i.cw, %bb.b ]
  %.04149.us.us.us.us.us.us.epil = phi ptr [ %.04149.us.us.us.us.us.us.epil.init, %.epil.preheader ], [ %i.ct, %bb.b ] ; 2 uses
  %epil.iter115 = phi i32 [ 0, %.epil.preheader ], [ %epil.iter115.next, %bb.b ]
  %i.ct = getelementptr inbounds nuw i8, ptr %.04149.us.us.us.us.us.us.epil, i64 1
  %i.cu = load i8, ptr %.04149.us.us.us.us.us.us.epil, align 1, !tbaa !60
...
._crit_edge.us.us.us.us.us.us:                    ; preds = %bb.b, %._crit_edge.us.us.us.us.us.us.unr-lcssa
  ...
  %indvars.iv.next87.a = add nuw nsw i64 %indvars.iv86, 1 ; 2 uses
  %exitcond89.not = icmp eq i64 %indvars.iv.next87.a, %i.bg
...
._crit_edge54.split.us.us.us.us.us.us:            ; preds = %._crit_edge.us.us.us.us.us.us
  ...
  %i.da = getelementptr inbounds nuw i8, ptr %.04058.us.us.us.us.us, i64 1
  store i8 %i.cz, ptr %.04058.us.us.us.us.us, align 1, !tbaa !60
...
.preheader.lr.ph.us.us:                           ; preds = %.preheader.lr.ph.us.us, %.lr.ph.split.us.split.us.split
  %indvars.iv83 = phi i64 [ %indvars.iv.next84, %.preheader.lr.ph.us.us ], [ 0, %.lr.ph.split.us.split.us.split ] ; 2 uses
  %i.dj = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv83
...
.preheader.lr.ph.us:                              ; preds = %.lr.ph.split.us.split, %.preheader.lr.ph.us
  %indvars.iv = phi i64 [ 0, %.lr.ph.split.us.split ], [ %indvars.iv.next, %.preheader.lr.ph.us ] ; 2 uses
