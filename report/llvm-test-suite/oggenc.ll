...
.lr.ph378:                                        ; preds = %.lr.ph378.preheader, %bb.f
  ...
  %i.ij = sub nuw nsw i64 %indvars.iv425, %i.gb   ; 5 uses
  %i.ik = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %indvars.iv425
  %i.il = load float, ptr %i.ik, align 4
  %i.im = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.ij
  ...
  %i.ir = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %i.ij
  ...
  %i.iw = getelementptr inbounds nuw [4 x i8], ptr %i.e, i64 %i.ij
  ...
  %i.jb = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.ij
  ...
  %i.jg = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.ij
