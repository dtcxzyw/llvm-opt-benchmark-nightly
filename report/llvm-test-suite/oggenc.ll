...
vector.body226:                                   ; preds = %vector.body226, %vector.ph223
  ...
  %i.hs = getelementptr inbounds i8, ptr %next.gep228, i64 -32 ; 2 uses
  %wide.vec237 = load <8 x float>, ptr %i.hs, align 4, !alias.scope !519 ; 2 uses
  %reverse239 = shufflevector <8 x float> %wide.vec237, <8 x float> poison, <4 x i32> <i32 6, i32 4, i32 2, i32 0>
  %reverse241 = shufflevector <8 x float> %wide.vec237, <8 x float> poison, <4 x i32> <i32 7, i32 5, i32 3, i32 1>
  ...
  %wide.vec242 = load <8 x float>, ptr %i.hs, align 4, !alias.scope !519 ; 2 uses
  %reverse244 = shufflevector <8 x float> %wide.vec242, <8 x float> poison, <4 x i32> <i32 6, i32 4, i32 2, i32 0>
  %reverse246 = shufflevector <8 x float> %wide.vec242, <8 x float> poison, <4 x i32> <i32 7, i32 5, i32 3, i32 1>
  %i.hw = fmul <4 x float> %i.hr, %reverse244
  %i.hx = fmul <4 x float> %i.gw, %reverse246
...
.lr.ph137:                                        ; preds = %.lr.ph137.preheader309, %.lr.ph137
  ...
  %.1112134 = phi ptr [ %i.ia, %.lr.ph137 ], [ %.1112134.ph, %.lr.ph137.preheader309 ] ; 2 uses
  ...
  %i.ia = getelementptr inbounds i8, ptr %.1112134, i64 -8 ; 4 uses
  ...
  %i.if = fsub float %i.id, %i.ie                 ; 2 uses
  %i.ig = load float, ptr %i.ib, align 4
  %i.ih = getelementptr inbounds nuw i8, ptr %.1116133, i64 8
  %i.ii = load float, ptr %i.ih, align 4
  %i.ij = fsub float %i.ig, %i.ii                 ; 2 uses
  %3 = getelementptr inbounds i8, ptr %.1112134, i64 -4 ; 2 uses
  %4 = load float, ptr %3, align 4
  %5 = fmul float %i.ij, %4
  %6 = load float, ptr %i.ia, align 4
  %7 = fmul float %i.if, %6
  %8 = fadd float %5, %7
  %9 = getelementptr inbounds nuw [4 x i8], ptr %i.i, i64 %indvars.iv161 ; 2 uses
  store float %8, ptr %9, align 4
  %10 = load float, ptr %i.ia, align 4
  %11 = fmul float %i.ij, %10
  %12 = load float, ptr %3, align 4
  %13 = fmul float %i.if, %12
  %14 = fsub float %11, %13
