...
.lr.ph.preheader:                                 ; preds = %.loopexit667
  ...
  %n.vec1274 = and i64 %11, 2147483644            ; 6 uses
  %i.ew = mul nsw i64 %n.vec1274, %10
  %i.ex = trunc nuw nsw i64 %n.vec1274 to i32
  %invariant.gep1824 = getelementptr [4 x i8], ptr %4, i64 %10
  %.idx1764 = shl nsw i64 %10, 3
  ...
  %cmp.n1279 = icmp eq i64 %n.vec1274, %11
  br label %.lr.ph
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %._crit_edge688
  ...
  %scevgep1242 = getelementptr i8, ptr %i.en, i64 %i.fi ; 4 uses
  ...
  %scevgep1247 = getelementptr i8, ptr %13, i64 %i.fi ; 4 uses
