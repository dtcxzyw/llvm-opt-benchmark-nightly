...
vector.body1240:                                  ; preds = %vector.body1240, %vector.ph1237
  ...
  %strided.vec1242 = shufflevector <8 x float> %wide.vec, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  ...
  %strided.vec1244 = shufflevector <8 x float> %wide.vec1243, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %strided.vec1245 = shufflevector <8 x float> %wide.vec1243, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %10 = fmul <4 x float> %strided.vec, %strided.vec1244
  %11 = fmul <4 x float> %strided.vec1242, %strided.vec1245
  %i.co = fadd <4 x float> %10, %11
...
vector.body1343:                                  ; preds = %vector.body1343, %vector.ph1340
  ...
  %i.je = getelementptr inbounds [4 x i8], ptr %7, i64 %.reass1619 ; 2 uses
  %wide.vec1348 = load <8 x float>, ptr %i.je, align 4, !alias.scope !998 ; 2 uses
  ...
  %12 = fadd <4 x float> %strided.vec1346, %strided.vec1349
  %i.jf = getelementptr inbounds [4 x i8], ptr %5, i64 %.reass1617
  %13 = fsub <4 x float> %strided.vec1347, %strided.vec1350
  %i.jg = getelementptr inbounds [4 x i8], ptr %5, i64 %.reass1619
  %wide.vec1351 = load <8 x float>, ptr %i.jd, align 4, !alias.scope !995 ; 2 uses
  ...
  %wide.vec1351.a = load <8 x float>, ptr %i.je, align 4, !alias.scope !998 ; 2 uses
  %strided.vec1355 = shufflevector <8 x float> %wide.vec1351.a, <8 x float> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %strided.vec1356 = shufflevector <8 x float> %wide.vec1351.a, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %14 = fadd <4 x float> %strided.vec1353, %strided.vec1356
  %interleaved.vec1357 = shufflevector <4 x float> %12, <4 x float> %14, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x float> %interleaved.vec1357, ptr %i.jf, align 4
  %15 = fsub <4 x float> %strided.vec1355, %strided.vec1352
  %interleaved.vec1358 = shufflevector <4 x float> %13, <4 x float> %15, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
...
vector.body1742:                                  ; preds = %vector.body1742, %vector.ph1739
  ...
  %10 = fmul <4 x float> %strided.vec1745, %strided.vec1748
  %11 = fmul <4 x float> %strided.vec1746, %strided.vec1749
  %i.ahq = fsub <4 x float> %10, %11
