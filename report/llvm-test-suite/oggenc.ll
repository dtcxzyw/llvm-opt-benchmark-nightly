...
.preheader665.us.preheader:                       ; preds = %.preheader666
  ...
  %10 = sext i32 %1 to i64                        ; 9 uses
  %11 = zext nneg i32 %2 to i64                   ; 2 uses
...
.lr.ph692:                                        ; preds = %.loopexit667
  ...
  %n.vec1276 = and i64 %13, 2147483644            ; 6 uses
  %i.fh = mul nsw i64 %n.vec1276, %12
  %i.fi = trunc nuw nsw i64 %n.vec1276 to i32
  %invariant.gep1832 = getelementptr [4 x i8], ptr %4, i64 %12
  %.idx1770 = shl nsw i64 %12, 3
  %invariant.gep1834 = getelementptr i8, ptr %4, i64 %.idx1770
  %.idx1771 = mul nsw i64 %12, 12
  %invariant.gep1836 = getelementptr i8, ptr %4, i64 %.idx1771
  %cmp.n1281 = icmp eq i64 %n.vec1276, %13
  br label %bb.b
