...
vector.body1222:                                  ; preds = %vector.body1222, %vector.ph1219
  ...
  %i.cq = add i64 %indvars.iv883, %i.cp           ; 4 uses
  %gep1825.a = getelementptr inbounds [4 x i8], ptr %4, i64 %i.cq
  %gep1827.a = getelementptr [4 x i8], ptr %invariant.gep, i64 %i.cq
  ...
  %i.cz = getelementptr [4 x i8], ptr %i.co, i64 %index1223
  store <4 x float> %i.cy, ptr %i.cz, align 4, !alias.scope !1160, !noalias !1157
  %index.next1224 = add nuw i64 %index1223, 4     ; 2 uses
