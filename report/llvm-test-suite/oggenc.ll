...
.epil.preheader:                                  ; preds = %._crit_edge108.us.i.i.unr-lcssa, %.lr.ph107.us.i.i
  ...
  %.071105.us.i.i.epil.init = phi float [ 0.000000e+00, %.lr.ph107.us.i.i ], [ %i.bt, %._crit_edge108.us.i.i.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod41)
  %i.cd = fadd float %.071105.us.i.i.epil.init, 1.000000e+00
...
._crit_edge108.us.i.i:                            ; preds = %._crit_edge108.us.i.i.unr-lcssa, %.epil.preheader
  ...
  %i.cm = add nuw nsw i32 %.177111.us.i.i, 1      ; 2 uses
...
._crit_edge114.loopexit.i.i:                      ; preds = %._crit_edge108.us.i.i
  ...
  %i.co = add i32 %i.cn, %.079117.i.i
  br label %._crit_edge114.i.i

._crit_edge114.i.i:                               ; preds = %._crit_edge114.loopexit.i.i, %.lr.ph113.split.preheader.i.i, %.lr.ph119.i.i
  %.180.lcssa.i.i = phi i32 [ %.079117.i.i, %.lr.ph119.i.i ], [ %i.co, %._crit_edge114.loopexit.i.i ], [ %i.az, %.lr.ph113.split.preheader.i.i ]
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %exitcond.not, label %._crit_edge, label %scalar.ph, !llvm.loop !628
...
.lr.ph197:                                        ; preds = %.lr.ph197.preheader, %.lr.ph197
  ...
  br i1 %6, label %.lr.ph197, label %.preheader192, !llvm.loop !629
...
bb.e:                                             ; preds = %bb.e, %.lr.ph200.new
  ...
  br i1 %niter.ncmp.3, label %.lr.ph208.preheader.loopexit.unr-lcssa, label %bb.e, !llvm.loop !630
...
bb.f:                                             ; preds = %bb.f, %.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %.lr.ph208.preheader, label %bb.f, !llvm.loop !631
...
.lr.ph208:                                        ; preds = %.lr.ph208.preheader, %.lr.ph208
  ...
  br i1 %exitcond217.not, label %._crit_edge209, label %.lr.ph208, !llvm.loop !632
...
._crit_edge209:                                   ; preds = %.lr.ph208
  ...
  br i1 %exitcond218.not, label %bb.g, label %.preheader, !llvm.loop !633
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %i.ap, align 4, !alias.scope !634
  %wide.load92 = load <4 x float>, ptr %i.aq, align 4, !alias.scope !634
  ...
  %wide.load93 = load <4 x float>, ptr %i.ar, align 4, !alias.scope !637, !noalias !634
  %wide.load94 = load <4 x float>, ptr %i.as, align 4, !alias.scope !637, !noalias !634
  %i.at = fmul <4 x float> %wide.load, %wide.load93
  %i.au = fmul <4 x float> %wide.load92, %wide.load94
  store <4 x float> %i.at, ptr %i.ar, align 4, !alias.scope !637, !noalias !634
  store <4 x float> %i.au, ptr %i.as, align 4, !alias.scope !637, !noalias !634
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.av = icmp eq i64 %index.next, %n.vec
  br i1 %i.av, label %middle.block, label %vector.body, !llvm.loop !639
...
.lr.ph61.i.preheader:                             ; preds = %.preheader57.i
  ...
  br i1 %min.iters.check620, label %.lr.ph61.i.preheader754, label %vector.memcheck612
...
vector.memcheck612:                               ; preds = %.lr.ph61.i.preheader
  ...
  br i1 %found.conflict618, label %.lr.ph61.i.preheader754, label %vector.ph621

vector.ph621:                                     ; preds = %vector.memcheck612
  %n.vec622 = and i64 %i.fy, -8                   ; 4 uses
  %i.gc = add i64 %.050.lcssa.i, %n.vec622
...
vector.body623:                                   ; preds = %vector.body623, %vector.ph621
  %index624 = phi i64 [ 0, %vector.ph621 ], [ %index.next629, %vector.body623 ] ; 3 uses
  %i.ge = getelementptr inbounds nuw [4 x i8], ptr %i.eu, i64 %index624 ; 2 uses
  %i.gf = getelementptr inbounds nuw i8, ptr %i.ge, i64 16
  %wide.load625 = load <4 x float>, ptr %i.ge, align 4, !alias.scope !850
  %wide.load626 = load <4 x float>, ptr %i.gf, align 4, !alias.scope !850
  %i.gg = getelementptr inbounds nuw [4 x i8], ptr %i.gd, i64 %index624 ; 3 uses
  %i.gh = getelementptr inbounds nuw i8, ptr %i.gg, i64 16 ; 2 uses
  %wide.load627 = load <4 x float>, ptr %i.gg, align 4, !alias.scope !853, !noalias !850
  %wide.load628 = load <4 x float>, ptr %i.gh, align 4, !alias.scope !853, !noalias !850
  %i.gi = fmul <4 x float> %wide.load625, %wide.load627
  %i.gj = fmul <4 x float> %wide.load626, %wide.load628
  store <4 x float> %i.gi, ptr %i.gg, align 4, !alias.scope !853, !noalias !850
  store <4 x float> %i.gj, ptr %i.gh, align 4, !alias.scope !853, !noalias !850
  %index.next629 = add nuw i64 %index624, 8       ; 2 uses
  %i.gk = icmp eq i64 %index.next629, %n.vec622
  br i1 %i.gk, label %middle.block630, label %vector.body623, !llvm.loop !855

middle.block630:                                  ; preds = %vector.body623
  %cmp.n631 = icmp eq i64 %i.fy, %n.vec622
  br i1 %cmp.n631, label %._crit_edge.i, label %.lr.ph61.i.preheader754

.lr.ph61.i.preheader754:                          ; preds = %vector.memcheck612, %.lr.ph61.i.preheader, %middle.block630
  %indvars.iv72.i.ph = phi i64 [ %.050.lcssa.i, %vector.memcheck612 ], [ %.050.lcssa.i, %.lr.ph61.i.preheader ], [ %i.gc, %middle.block630 ]
  %indvars.iv.i.ph = phi i64 [ 0, %vector.memcheck612 ], [ 0, %.lr.ph61.i.preheader ], [ %n.vec622, %middle.block630 ]
  br label %.lr.ph61.i

.lr.ph61.i:                                       ; preds = %.lr.ph61.i.preheader754, %.lr.ph61.i
  %indvars.iv72.i = phi i64 [ %indvars.iv.next73.i, %.lr.ph61.i ], [ %indvars.iv72.i.ph, %.lr.ph61.i.preheader754 ] ; 2 uses
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %.lr.ph61.i ], [ %indvars.iv.i.ph, %.lr.ph61.i.preheader754 ] ; 2 uses
  ...
  br i1 %i.gq, label %.lr.ph61.i, label %._crit_edge.i, !llvm.loop !856

._crit_edge.i:                                    ; preds = %.lr.ph61.i, %middle.block630, %.preheader57.i
...
vector.memcheck:                                  ; preds = %vector.scevcheck
  ...
  %sext742 = add i64 %i.hl, -4294967296           ; 2 uses
  %i.hm = ashr exact i64 %sext742, 32
  ...
  %i.hq = ashr exact i64 %sext742, 30
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %sext743 = shl i64 %i.hw, 32
  %i.hx = ashr exact i64 %sext743, 30
  ...
  %wide.load = load <4 x float>, ptr %i.hz, align 4, !alias.scope !857
  %wide.load607 = load <4 x float>, ptr %i.ia, align 4, !alias.scope !857
  ...
  %wide.load609 = load <4 x float>, ptr %i.ib, align 4, !alias.scope !860, !noalias !857
  %wide.load610 = load <4 x float>, ptr %i.ic, align 4, !alias.scope !860, !noalias !857
  %i.id = fmul <4 x float> %reverse, %wide.load609
  %i.ie = fmul <4 x float> %reverse608, %wide.load610
  store <4 x float> %i.id, ptr %i.ib, align 4, !alias.scope !860, !noalias !857
  store <4 x float> %i.ie, ptr %i.ic, align 4, !alias.scope !860, !noalias !857
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.if = icmp eq i64 %index.next, %n.vec
  br i1 %i.if, label %middle.block, label %vector.body, !llvm.loop !862
...
.lr.ph65.i:                                       ; preds = %.lr.ph65.i.preheader, %.lr.ph65.i
  ...
  br i1 %i.iq, label %.lr.ph65.i, label %.preheader.i.loopexit, !llvm.loop !863
...
.lr.ph:                                           ; preds = %_vorbis_apply_window.exit, %.lr.ph
  ...
  br i1 %2, label %.lr.ph, label %._crit_edge, !llvm.loop !864
...
bb.q:                                             ; preds = %bb.p, %bb.o
  ...
  br i1 %i.kb, label %bb.k, label %._crit_edge461.loopexit, !llvm.loop !865
...
.lr.ph469:                                        ; preds = %_vorbis_block_alloc.exit382
  ...
  %min.iters.check705 = icmp ult i32 %.pre-phi540, 8
  %n.vec707 = and i64 %wide.trip.count, 4294967288 ; 3 uses
  %cmp.n714 = icmp eq i64 %n.vec707, %wide.trip.count
...
.lr.ph463.preheader:                              ; preds = %_vorbis_block_alloc.exit385
  br i1 %min.iters.check705, label %.lr.ph463.preheader752, label %vector.memcheck703

vector.memcheck703:                               ; preds = %.lr.ph463.preheader
  %i.mu = add i64 %i.ls, %i.mc
  %i.mv = sub i64 %i.ly, %i.mu
  %diff.check = icmp ugt i64 %i.mv, -32
  br i1 %diff.check, label %.lr.ph463.preheader752, label %vector.body708

vector.body708:                                   ; preds = %vector.memcheck703, %vector.body708
  %index709 = phi i64 [ %index.next712, %vector.body708 ], [ 0, %vector.memcheck703 ] ; 3 uses
  %i.mw = getelementptr inbounds nuw [4 x i8], ptr %i.lx, i64 %index709 ; 2 uses
  %i.mx = getelementptr inbounds nuw i8, ptr %i.mw, i64 16
  %wide.load710 = load <4 x i32>, ptr %i.mw, align 4
  %wide.load711 = load <4 x i32>, ptr %i.mx, align 4
  %i.my = and <4 x i32> %wide.load710, splat (i32 2147483647)
end_hunk_2
...
.preheader:                                       ; preds = %bb.d
  %.not88 = icmp eq i8 %i.s, 0
  br i1 %.not88, label %.thread82, label %.lr.ph
...
bb.e:                                             ; preds = %.lr.ph, %bb.e
  ...
  br i1 %i.af, label %bb.e, label %.thread82, !llvm.loop !917

.thread82:                                        ; preds = %bb.e, %.preheader
  store i32 %i.u, ptr %i.k, align 8
  br label %bb.f

bb.f:                                             ; preds = %.thread82, %bb.a
  %i.ag = phi i32 [ %i.u, %.thread82 ], [ %i.l, %bb.a ]
...
.lr.ph.i.epil.preheader:                          ; preds = %.preheader.i.loopexit.unr-lcssa, %.lr.ph.i.preheader
  ...
  %lcmp.mod101 = trunc i32 %i.an to i1
...
.lr.ph35.i.preheader.new:                         ; preds = %.lr.ph35.i.preheader
  ...
  %unroll_iter106 = zext nneg i32 %2 to i64
  br label %.lr.ph35.i
...
.lr.ph35.i:                                       ; preds = %.lr.ph35.i, %.lr.ph35.i.preheader.new
  ...
  %niter107 = phi i64 [ 0, %.lr.ph35.i.preheader.new ], [ %niter107.next.1, %.lr.ph35.i ]
  ...
  br i1 %niter107.ncmp.1, label %ogg_page_checksum_set.exit.loopexit.unr-lcssa, label %.lr.ph35.i, !llvm.loop !107

ogg_page_checksum_set.exit.loopexit.unr-lcssa:    ; preds = %.lr.ph35.i
  %3 = and i32 %i.aq, 1
  %lcmp.mod103.not = icmp eq i32 %3, 0
  br i1 %lcmp.mod103.not, label %ogg_page_checksum_set.exit, label %.lr.ph35.i.epil.preheader
...
.lr.ph35.i.epil.preheader:                        ; preds = %ogg_page_checksum_set.exit.loopexit.unr-lcssa, %.lr.ph35.i.preheader
  ...
  %lcmp.mod105 = trunc i32 %i.aq to i1
...
bb.l:                                             ; preds = %bb.h, %bb.c
  %.pre91 = phi ptr [ %.pre91.pre, %bb.h ], [ %i.b, %bb.c ] ; 2 uses
  store i32 0, ptr %i.k, align 8
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.el = getelementptr inbounds i8, ptr %.pre91, i64 %i.ek
  br label %bb.n

bb.n:                                             ; preds = %bb.m, %bb.l
  %.063 = phi ptr [ %i.ei, %bb.l ], [ %i.el, %bb.m ]
  %i.em = ptrtoint ptr %.063 to i64               ; 2 uses
  %i.en = ptrtoint ptr %.pre91 to i64
...
.lr.ph795:                                        ; preds = %._crit_edge766.split
  ...
  %scevgep1432 = getelementptr i8, ptr %8, i64 %i.oo
  %scevgep1435 = getelementptr i8, ptr %8, i64 %i.oo
  %scevgep1438 = getelementptr i8, ptr %6, i64 %i.oo
  %scevgep1441 = getelementptr i8, ptr %6, i64 %i.oo
  ...
  %invariant.op1631 = sub i64 %i.b, %i.oq
  %invariant.op1633 = add i64 %i.ot, -1
  %invariant.op1635 = add i64 %i.ou, -1
  %invariant.op1637 = add i64 %i.ow, -1
  %invariant.op1639 = add i64 %i.oy, -1
  %invariant.op1641 = add i64 %i.oz, -1
  %n.vec1499 = and i64 %wide.trip.count1013, 2147483644 ; 7 uses
  %i.pe = add nsw i64 %n.vec1499, %i.oh
  %i.pf = add nuw nsw i64 %n.vec1499, %i.og
  %invariant.gep1615 = getelementptr [4 x i8], ptr %6, i64 %i.og
  %invariant.gep1619 = getelementptr [4 x i8], ptr %6, i64 %i.oh
  ...
  %i.pg = trunc nuw nsw i64 %n.vec1465 to i32
...
.lr.ph799.preheader:                              ; preds = %.preheader667
  ...
  %scevgep1518 = getelementptr i8, ptr %8, i64 %i.ph
  %scevgep1520 = getelementptr i8, ptr %6, i64 %i.ph
...
bb.e:                                             ; preds = %.lr.ph795, %._crit_edge788.split
  ...
  %scevgep1431 = getelementptr i8, ptr %8, i64 %i.pp ; 3 uses
  %scevgep1433 = getelementptr i8, ptr %scevgep1432, i64 %i.pp ; 3 uses
  %i.pq = sext i32 %indvars.iv1000 to i64
  %i.pr = shl nsw i64 %i.pq, 2                    ; 2 uses
  %scevgep1434 = getelementptr i8, ptr %8, i64 %i.pr ; 3 uses
  %scevgep1436 = getelementptr i8, ptr %scevgep1435, i64 %i.pr ; 3 uses
...
vector.ph1498:                                    ; preds = %vector.memcheck1482
  %i.qb = add nsw i64 %n.vec1499, %i.ps
  %i.qc = add nsw i64 %n.vec1499, %i.pt
  %broadcast.splat1501 = shufflevector <2 x float> %i.py, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %broadcast.splat1503 = shufflevector <2 x float> %i.px, <2 x float> poison, <4 x i32> zeroinitializer
  %invariant.gep1617 = getelementptr [4 x i8], ptr %8, i64 %i.pt
  %invariant.gep1621 = getelementptr [4 x i8], ptr %8, i64 %i.ps
...
vector.body1504:                                  ; preds = %vector.body1504, %vector.ph1498
  ...
  %i.qd = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %index1505
  %wide.load1506 = load <4 x float>, ptr %i.qd, align 4
  %gep1616 = getelementptr [4 x i8], ptr %invariant.gep1615, i64 %index1505
  %wide.load1507 = load <4 x float>, ptr %gep1616, align 4
  %i.qe = fmul <4 x float> %broadcast.splat1501, %wide.load1507
  %i.qf = fadd <4 x float> %wide.load1506, %i.qe
  %gep1618 = getelementptr [4 x i8], ptr %invariant.gep1617, i64 %index1505
  store <4 x float> %i.qf, ptr %gep1618, align 4
  %gep1620 = getelementptr [4 x i8], ptr %invariant.gep1619, i64 %index1505
  %wide.load1508 = load <4 x float>, ptr %gep1620, align 4
  %i.qg = fmul <4 x float> %broadcast.splat1503, %wide.load1508
  %gep1622 = getelementptr [4 x i8], ptr %invariant.gep1621, i64 %index1505
  store <4 x float> %i.qg, ptr %gep1622, align 4
  %index.next1509 = add nuw i64 %index1505, 4     ; 2 uses
  %i.qh = icmp eq i64 %index.next1509, %n.vec1499
  br i1 %i.qh, label %middle.block1510, label %vector.body1504, !llvm.loop !1019
...
.lr.ph773.preheader1571:                          ; preds = %vector.memcheck1482, %.lr.ph773.preheader, %middle.block1510
  %indvars.iv1002.ph = phi i64 [ %i.ps, %vector.memcheck1482 ], [ %i.ps, %.lr.ph773.preheader ], [ %i.qb, %middle.block1510 ]
  %indvars.iv998.ph = phi i64 [ %i.oh, %vector.memcheck1482 ], [ %i.oh, %.lr.ph773.preheader ], [ %i.pe, %middle.block1510 ]
  %indvars.iv996.ph = phi i64 [ %i.og, %vector.memcheck1482 ], [ %i.og, %.lr.ph773.preheader ], [ %i.pf, %middle.block1510 ]
  %indvars.iv994.ph = phi i64 [ %i.pt, %vector.memcheck1482 ], [ %i.pt, %.lr.ph773.preheader ], [ %i.qc, %middle.block1510 ]
...
.lr.ph780.preheader:                              ; preds = %.preheader668
  ...
  %i.qm = add nsw i64 %n.vec1465, %i.pt
  %i.qn = add nsw i64 %n.vec1465, %i.ps
  %invariant.gep1625 = getelementptr [4 x i8], ptr %8, i64 %i.pt
  %invariant.gep1629 = getelementptr [4 x i8], ptr %8, i64 %i.ps
  br label %.lr.ph780
...
.lr.ph767:                                        ; preds = %.loopexit661.thread, %.loopexit661
  %i.qq = phi i32 [ %i.qn, %.loopexit661.thread ], [ %i.qp, %.loopexit661 ] ; 5 uses
  %i.qr = mul i32 %3, %i.qq                       ; 2 uses
  %i.qs = icmp sgt i32 %3, 0
  %.not = icmp eq i32 %i.o, 2
  %10 = icmp slt i32 %3, 1
  %i.qt = sext i32 %i.qr to i64                   ; 5 uses
  %i.qu = sext i32 %3 to i64                      ; 5 uses
  %i.qv = add i32 %1, -2
  %i.qw = mul i32 %3, %i.qv
  %i.qx = shl i32 %3, 1
  ...
  %i.rb = add nuw nsw i64 %i.ra, 4                ; 4 uses
  %scevgep1410 = getelementptr i8, ptr %6, i64 %i.rb
  %scevgep1413 = getelementptr i8, ptr %6, i64 %i.rb
  %scevgep1416 = getelementptr i8, ptr %8, i64 %i.rb
  %scevgep1419 = getelementptr i8, ptr %8, i64 %i.rb
  %i.rc = shl nsw i64 %i.qt, 2                    ; 2 uses
  %i.rd = add i64 %i.rc, %i.b
  %i.re = shl nsw i64 %i.qu, 2                    ; 2 uses
  %i.rf = add i64 %i.re, %i.b
  %i.rg = sub i64 %i.a, %i.rf
  %i.rh = sub i64 %i.a, %i.b
  %i.ri = add i64 %i.rc, %i.b
  %i.rj = sub i64 %i.a, %i.ri
  %i.rk = add i64 %i.re, %i.b
  %i.rl = sub i64 %i.a, %i.rk
  %i.rm = sub i64 %i.a, %i.b
  %i.rn = insertelement <2 x float> poison, float %i.i, i64 0
  %i.ro = shufflevector <2 x float> %i.rn, <2 x float> poison, <2 x i32> zeroinitializer
  %i.rp = insertelement <2 x float> poison, float %i.k, i64 0
  %i.rq = shufflevector <2 x float> %i.rp, <2 x float> poison, <2 x i32> zeroinitializer
  %min.iters.check1474 = icmp ult i32 %3, 8
  %invariant.op1830 = sub i64 %i.a, %i.rd
  %invariant.op1832 = add i64 %i.rg, -1
  %invariant.op1834 = add i64 %i.rh, -1
  %invariant.op1836 = add i64 %i.rj, -1
  %invariant.op1838 = add i64 %i.rl, -1
  %invariant.op1840 = add i64 %i.rm, -1
  %n.vec1476 = and i64 %wide.trip.count1029, 2147483644 ; 7 uses
  %i.rr = add nuw nsw i64 %n.vec1476, %i.qu
  %i.rs = add nsw i64 %n.vec1476, %i.qt
  %invariant.gep1814 = getelementptr [4 x i8], ptr %8, i64 %i.qu
  %invariant.gep1818 = getelementptr [4 x i8], ptr %8, i64 %i.qt
  ...
  %i.rt = trunc nuw nsw i64 %n.vec1443 to i32
...
.preheader659:                                    ; preds = %._crit_edge760.split
  %i.rv = icmp sgt i32 %3, 0                      ; 3 uses
  %or.cond867 = and i1 %i.dv, %i.rv
...
bb.d:                                             ; preds = %.lr.ph767, %._crit_edge760.split
  ...
  %indvars.iv1010 = phi i32 [ %i.qr, %.lr.ph767 ], [ %indvars.iv.next1011, %._crit_edge760.split ] ; 4 uses
  %.0554765 = phi i32 [ 1, %.lr.ph767 ], [ %i.ut, %._crit_edge760.split ]
  %i.rw = phi <2 x float> [ <float 0.000000e+00, float 1.000000e+00>, %.lr.ph767 ], [ %i.sm, %._crit_edge760.split ] ; 2 uses
  %i.rx = sext i32 %indvars.iv1010 to i64
  ...
  %scevgep1409 = getelementptr i8, ptr %6, i64 %i.sc ; 3 uses
  %scevgep1411 = getelementptr i8, ptr %scevgep1410, i64 %i.sc ; 3 uses
  %i.sd = sext i32 %indvars.iv1010 to i64
  %i.se = shl nsw i64 %i.sd, 2                    ; 2 uses
  %scevgep1412 = getelementptr i8, ptr %6, i64 %i.se ; 3 uses
  %scevgep1414 = getelementptr i8, ptr %scevgep1413, i64 %i.se ; 3 uses
  %i.sf = sext i32 %indvars.iv1010 to i64         ; 8 uses
  %i.sg = sext i32 %indvars.iv1014 to i64         ; 8 uses
  %i.sh = fmul <2 x float> %i.rw, %i.ro           ; 2 uses
  %i.si = shufflevector <2 x float> %i.rw, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.sj = fmul <2 x float> %i.si, %i.rq           ; 2 uses
  %i.sk = fadd <2 x float> %i.sh, %i.sj           ; 4 uses
  %i.sl = fsub <2 x float> %i.sh, %i.sj           ; 4 uses
  %i.sm = shufflevector <2 x float> %i.sk, <2 x float> %i.sl, <2 x i32> <i32 0, i32 3>
  br i1 %i.qs, label %.lr.ph743.preheader, label %._crit_edge760.split
...
vector.ph1475:                                    ; preds = %vector.memcheck1460
  %i.so = add nsw i64 %n.vec1476, %i.sg
  %i.sp = add nsw i64 %n.vec1476, %i.sf
  %broadcast.splat1478 = shufflevector <2 x float> %i.sl, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %broadcast.splat1480 = shufflevector <2 x float> %i.sk, <2 x float> poison, <4 x i32> zeroinitializer
  %invariant.gep1816 = getelementptr [4 x i8], ptr %6, i64 %i.sg
  %invariant.gep1820 = getelementptr [4 x i8], ptr %6, i64 %i.sf
...
vector.body1481:                                  ; preds = %vector.body1481, %vector.ph1475
  ...
  %i.sq = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %index1482
  %wide.load1483 = load <4 x float>, ptr %i.sq, align 4
  %gep1815 = getelementptr [4 x i8], ptr %invariant.gep1814, i64 %index1482
  %wide.load1484 = load <4 x float>, ptr %gep1815, align 4
  %i.sr = fmul <4 x float> %broadcast.splat1478, %wide.load1484
  %i.ss = fadd <4 x float> %wide.load1483, %i.sr
  %gep1817 = getelementptr [4 x i8], ptr %invariant.gep1816, i64 %index1482
  store <4 x float> %i.ss, ptr %gep1817, align 4
  %gep1819 = getelementptr [4 x i8], ptr %invariant.gep1818, i64 %index1482
  %wide.load1485 = load <4 x float>, ptr %gep1819, align 4
  %i.st = fmul <4 x float> %broadcast.splat1480, %wide.load1485
  %gep1821 = getelementptr [4 x i8], ptr %invariant.gep1820, i64 %index1482
  store <4 x float> %i.st, ptr %gep1821, align 4
  %index.next1486 = add nuw i64 %index1482, 4     ; 2 uses
  %i.su = icmp eq i64 %index.next1486, %n.vec1476
  br i1 %i.su, label %middle.block1487, label %vector.body1481, !llvm.loop !1202
...
.lr.ph743.preheader1780:                          ; preds = %vector.memcheck1460, %.lr.ph743.preheader, %middle.block1487
  %indvars.iv1016.ph = phi i64 [ %i.sg, %vector.memcheck1460 ], [ %i.sg, %.lr.ph743.preheader ], [ %i.so, %middle.block1487 ]
  %indvars.iv1012.ph = phi i64 [ %i.sf, %vector.memcheck1460 ], [ %i.sf, %.lr.ph743.preheader ], [ %i.sp, %middle.block1487 ]
  %indvars.iv1008.ph = phi i64 [ 0, %vector.memcheck1460 ], [ 0, %.lr.ph743.preheader ], [ %n.vec1476, %middle.block1487 ]
  %indvars.iv1006.ph = phi i64 [ %i.qu, %vector.memcheck1460 ], [ %i.qu, %.lr.ph743.preheader ], [ %i.rr, %middle.block1487 ]
  %indvars.iv1004.ph = phi i64 [ %i.qt, %vector.memcheck1460 ], [ %i.qt, %.lr.ph743.preheader ], [ %i.rs, %middle.block1487 ]
  %i.sv = extractelement <2 x float> %i.sl, i64 1
  %i.sw = extractelement <2 x float> %i.sk, i64 0
  br label %.lr.ph743
...
.lr.ph743:                                        ; preds = %.lr.ph743.preheader1780, %.lr.ph743
  ...
  %i.sx = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %indvars.iv1008
  %i.sy = load float, ptr %i.sx, align 4
  %indvars.iv.next1007 = add nuw nsw i64 %indvars.iv1006, 1
  %i.sz = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %indvars.iv1006
  %i.ta = load float, ptr %i.sz, align 4
  %i.tb = fmul float %i.sv, %i.ta
  %i.tc = fadd float %i.sy, %i.tb
  %indvars.iv.next1017 = add nsw i64 %indvars.iv1016, 1
  %i.td = getelementptr inbounds [4 x i8], ptr %6, i64 %indvars.iv1016
  store float %i.tc, ptr %i.td, align 4
  %indvars.iv.next1005 = add nsw i64 %indvars.iv1004, 1
  %i.te = getelementptr inbounds [4 x i8], ptr %8, i64 %indvars.iv1004
  %i.tf = load float, ptr %i.te, align 4
  %i.tg = fmul float %i.sw, %i.tf
  %indvars.iv.next1013 = add nsw i64 %indvars.iv1012, 1
  %i.th = getelementptr inbounds [4 x i8], ptr %6, i64 %indvars.iv1012
  store float %i.tg, ptr %i.th, align 4
...
._crit_edge744:                                   ; preds = %.lr.ph743, %middle.block1487
  %i.ti = extractelement <2 x float> %i.sk, i64 0 ; 3 uses
  %i.tj = extractelement <2 x float> %i.sl, i64 1 ; 3 uses
...
.lr.ph751.preheader:                              ; preds = %._crit_edge744
  ...
  %i.tk = add nsw i64 %n.vec1443, %i.sg
  %i.tl = add nsw i64 %n.vec1443, %i.sf
  %invariant.gep1824 = getelementptr [4 x i8], ptr %6, i64 %i.sg
  %invariant.gep1828 = getelementptr [4 x i8], ptr %6, i64 %i.sf
end_hunk_5
