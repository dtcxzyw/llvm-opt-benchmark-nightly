...
.lr.ph116.preheader:                              ; preds = %.lr.ph119
  ...
  %n.vec171 = and i64 %5, 9223372036854775800     ; 3 uses
  %i.de = sub nsw i64 %i.cz, %n.vec171
  %cmp.n178 = icmp eq i64 %5, %n.vec171
  br label %.lr.ph116
...
.preheader.i:                                     ; preds = %.loopexit254, %.preheader.preheader.i
  %indvars.iv22.i = phi i64 [ 2, %.preheader.preheader.i ], [ %indvars.iv.next23.i, %.loopexit254 ] ; 4 uses
  %smin = tail call i64 @llvm.smin.i64(i64 %indvars.iv22.i, i64 %i.eb)
  %i.ee = sub nsw i64 %i.eb, %smin
  %3 = add nuw nsw i64 %i.ee, 1                   ; 2 uses
  %min.iters.check219 = icmp samesign ult i64 %indvars.iv22.i, %i.eb
  br i1 %min.iters.check219, label %vector.ph220, label %scalar.ph218.preheader

vector.ph220:                                     ; preds = %.preheader.i
  %n.vec222 = and i64 %3, 9223372036854775806     ; 3 uses
...
middle.block232:                                  ; preds = %vector.body223
  %cmp.n233 = icmp eq i64 %3, %n.vec222
...
.preheader.preheader.i108:                        ; preds = %cheby.exit
  %i.ew = zext nneg i32 %i.j to i64               ; 7 uses
...
.preheader.i110:                                  ; preds = %.loopexit253, %.preheader.preheader.i108
  %indvars.iv22.i111 = phi i64 [ 2, %.preheader.preheader.i108 ], [ %indvars.iv.next23.i115, %.loopexit253 ] ; 4 uses
  %smin235 = tail call i64 @llvm.smin.i64(i64 %indvars.iv22.i111, i64 %i.ew)
  %i.fa = sub nsw i64 %i.ew, %smin235
  %4 = add nuw nsw i64 %i.fa, 1                   ; 2 uses
  %min.iters.check237 = icmp samesign ult i64 %indvars.iv22.i111, %i.ew
  br i1 %min.iters.check237, label %vector.ph238, label %scalar.ph236.preheader

vector.ph238:                                     ; preds = %.preheader.i110
  %n.vec240 = and i64 %4, 9223372036854775806     ; 3 uses
...
middle.block250:                                  ; preds = %vector.body241
  %cmp.n251 = icmp eq i64 %4, %n.vec240
...
.lr.ph249.preheader:                              ; preds = %.preheader
  ...
  %7 = insertelement <4 x ptr> poison, ptr %scevgep409, i64 0
  %8 = insertelement <4 x ptr> %7, ptr %scevgep410, i64 1
  %9 = insertelement <4 x ptr> %8, ptr %scevgep411, i64 2
  %10 = insertelement <4 x ptr> %9, ptr %scevgep413, i64 3 ; 8 uses
  ...
  %i.el = insertelement <4 x ptr> %i.ek, ptr %scevgep412, i64 3 ; 8 uses
  %11 = tail call i64 @llvm.umax.i64(i64 %i.ck, i64 4)
  %12 = add nsw i64 %11, -3                       ; 2 uses
  %13 = lshr i64 %12, 1
  %14 = add nuw nsw i64 %13, 1                    ; 2 uses
  %min.iters.check757 = icmp ult i64 %12, 46
...
vector.memcheck375:                               ; preds = %vector.scevcheck350
  ...
  %i.gf = icmp ult <4 x ptr> %i.el, %i.ge
  ...
  %i.gm = icmp ult <4 x ptr> %i.el, %i.gl
  ...
  %i.gt = icmp ult <4 x ptr> %i.el, %i.gs
  ...
  %i.ha = icmp ult <4 x ptr> %i.el, %i.gz
  ...
  %i.hh = icmp ult <4 x ptr> %i.el, %i.hg
  ...
  %i.ho = icmp ult <4 x ptr> %i.el, %i.hn
  ...
  %i.hv = icmp ult <4 x ptr> %i.el, %i.hu
  ...
  %i.ic = icmp ult <4 x ptr> %i.el, %i.ib
...
.lr.ph246.preheader:                              ; preds = %.preheader
  ...
  %7 = tail call i64 @llvm.umax.i64(i64 %i.ek, i64 4)
  %8 = add nsw i64 %7, -3                         ; 2 uses
  %9 = lshr i64 %8, 1
  %10 = add nuw nsw i64 %9, 1                     ; 2 uses
  %min.iters.check770 = icmp ult i64 %8, 46
  ...
  %n.vec773 = and i64 %10, 9223372036854775804    ; 4 uses
  ...
  %cmp.n812 = icmp eq i64 %10, %n.vec773
  br label %.lr.ph246
...
.lr.ph161.preheader:                              ; preds = %._crit_edge
  ...
  %6 = insertelement <4 x ptr> poison, ptr %scevgep292, i64 0
  %7 = shufflevector <4 x ptr> %6, <4 x ptr> poison, <4 x i32> zeroinitializer
  %8 = insertelement <4 x ptr> poison, ptr %scevgep291, i64 0
  %9 = shufflevector <4 x ptr> %8, <4 x ptr> poison, <4 x i32> zeroinitializer
  %10 = tail call i64 @llvm.umax.i64(i64 %i.dh, i64 4)
  %11 = add nsw i64 %10, -3                       ; 2 uses
  %12 = lshr i64 %11, 1
  %13 = add nuw nsw i64 %12, 1                    ; 2 uses
  %min.iters.check474 = icmp ult i64 %11, 22
