...
begin_hunk_0_@vorbis_synthesis_blockin:bb.a
  ...
  %i.an = ashr i64 %i.am, %i.ah                   ; 7 uses
...
begin_hunk_1_@vorbis_synthesis_blockin:bb.a
  ...
  %i.cg = shl i64 %i.an, 2
  %i.ch = and i64 %i.cg, 8589934588               ; 2 uses
...
begin_hunk_2_@vorbis_synthesis_blockin:bb.a
  ...
  %2 = and i64 %i.an, 2147483647
  %3 = add nsw i64 %2, %i.bs
  %4 = shl nsw i64 %3, 2
...
vector.memcheck456:                               ; preds = %.lr.ph.preheader
  %scevgep457 = getelementptr i8, ptr %i.do, i64 %4 ; 2 uses
