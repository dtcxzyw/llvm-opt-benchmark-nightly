...
bb.ah:                                            ; preds = %_vp_offset_and_mix.exit405, %floor1_interpolate_fit.exit
  ...
  %i.so = shl i32 %indvars.iv502.tr, 16
...
vector.memcheck668:                               ; preds = %.lr.ph.i407
  ...
  %scevgep669 = getelementptr i8, ptr %i.tp, i64 %i.sv ; 2 uses
  %scevgep670 = getelementptr i8, ptr %i.sl, i64 %i.sv
  %scevgep671 = getelementptr i8, ptr %i.sn, i64 %i.sv
  %bound0672 = icmp ult ptr %i.tl, %scevgep670
  %bound1673 = icmp ult ptr %i.sl, %scevgep669
  %found.conflict674 = and i1 %bound0672, %bound1673
  %bound0675 = icmp ult ptr %i.tl, %scevgep671
  %bound1676 = icmp ult ptr %i.sn, %scevgep669
...
vector.ph681:                                     ; preds = %vector.memcheck668
  %n.vec683 = and i64 %i.ss, 2147483644           ; 3 uses
  %broadcast.splatinsert684 = insertelement <4 x i32> poison, i32 %i.to, i64 0
  %broadcast.splat685 = shufflevector <4 x i32> %broadcast.splatinsert684, <4 x i32> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert686 = insertelement <4 x i32> poison, i32 %i.sp, i64 0
...
vector.body688:                                   ; preds = %pred.store.continue701, %vector.ph681
  ...
  %wide.load692 = load <4 x i32>, ptr %i.tq, align 4, !alias.scope !870
  %i.ua = and <4 x i32> %wide.load692, splat (i32 32768)
  %i.ub = icmp ne <4 x i32> %i.ua, zeroinitializer
  %wide.load693 = load <4 x i32>, ptr %i.tt, align 4, !alias.scope !873
  %i.uc = and <4 x i32> %wide.load693, splat (i32 32768)
  ...
  br i1 %i.uf, label %pred.store.if694, label %pred.store.continue695
...
pred.store.continue695:                           ; preds = %pred.store.if694, %vector.body688
  ...
  br i1 %i.ui, label %pred.store.if696, label %pred.store.continue697

pred.store.if696:                                 ; preds = %pred.store.continue695
  %i.uj = getelementptr inbounds nuw [4 x i8], ptr %i.tl, i64 %index689
...
pred.store.continue697:                           ; preds = %pred.store.if696, %pred.store.continue695
  ...
  br i1 %i.un, label %pred.store.if698, label %pred.store.continue699

pred.store.if698:                                 ; preds = %pred.store.continue697
  %i.uo = getelementptr inbounds nuw [4 x i8], ptr %i.tl, i64 %index689
...
pred.store.continue699:                           ; preds = %pred.store.if698, %pred.store.continue697
  ...
  br i1 %i.us, label %pred.store.if700, label %pred.store.continue701

pred.store.if700:                                 ; preds = %pred.store.continue699
  %i.ut = getelementptr inbounds nuw [4 x i8], ptr %i.tl, i64 %index689
...
pred.store.continue701:                           ; preds = %pred.store.if700, %pred.store.continue699
  ...
  %i.ux = icmp eq i64 %index.next702, %n.vec683
  br i1 %i.ux, label %middle.block703, label %vector.body688, !llvm.loop !878

middle.block703:                                  ; preds = %pred.store.continue701
  %cmp.n704 = icmp eq i64 %n.vec683, %i.ss
...
scalar.ph679:                                     ; preds = %scalar.ph679.preheader, %bb.ao
  %.02327.i = phi i64 [ %i.vp, %bb.ao ], [ %.02327.i.ph, %scalar.ph679.preheader ] ; 4 uses
...
floor1_interpolate_fit.exit:                      ; preds = %bb.ao, %middle.block703, %bb.ah, %_vorbis_block_alloc.exit.i
  %.0.i406 = phi ptr [ null, %bb.ah ], [ %i.tl, %_vorbis_block_alloc.exit.i ], [ %i.tl, %middle.block703 ], [ %i.tl, %bb.ao ]
  %i.vq = load ptr, ptr %i.mv, align 8
  %i.vr = getelementptr inbounds nuw [8 x i8], ptr %i.vq, i64 %indvars.iv502
...
.preheader450:                                    ; preds = %floor1_interpolate_fit.exit, %floor1_interpolate_fit.exit419
  ...
  %i.wc = shl i32 %indvars.iv506.tr, 16
...
.lr.ph.i413:                                      ; preds = %_vorbis_block_alloc.exit.i412
  ...
  %min.iters.check646 = icmp ult i32 %i.wf, 4
...
vector.memcheck635:                               ; preds = %.lr.ph.i413
  ...
  %scevgep636 = getelementptr i8, ptr %i.xd, i64 %i.wj ; 2 uses
  %scevgep637 = getelementptr i8, ptr %i.vz, i64 %i.wj
  %scevgep638 = getelementptr i8, ptr %i.wb, i64 %i.wj
  %bound0639 = icmp ult ptr %i.wz, %scevgep637
  %bound1640 = icmp ult ptr %i.vz, %scevgep636
  %found.conflict641 = and i1 %bound0639, %bound1640
  %bound0642 = icmp ult ptr %i.wz, %scevgep638
  %bound1643 = icmp ult ptr %i.wb, %scevgep636
...
vector.ph647:                                     ; preds = %vector.memcheck635
  %n.vec649 = and i64 %i.wg, 2147483644           ; 3 uses
...
vector.body652:                                   ; preds = %pred.store.continue663, %vector.ph647
  ...
  %i.xe = getelementptr inbounds nuw [4 x i8], ptr %i.vz, i64 %index653 ; 2 uses
  %wide.load654 = load <4 x i32>, ptr %i.xe, align 4, !alias.scope !881
  %i.xf = and <4 x i32> %wide.load654, splat (i32 32767)
  %i.xg = mul nsw <4 x i32> %i.xf, %broadcast.splat
  %i.xh = getelementptr inbounds nuw [4 x i8], ptr %i.wb, i64 %index653 ; 2 uses
  %wide.load655 = load <4 x i32>, ptr %i.xh, align 4, !alias.scope !884
  %i.xi = and <4 x i32> %wide.load655, splat (i32 32767)
  %i.xj = mul nuw nsw <4 x i32> %i.xi, %broadcast.splat651
  %i.xk = add nsw <4 x i32> %i.xg, splat (i32 32768)
  %i.xl = add <4 x i32> %i.xk, %i.xj
  %i.xm = ashr <4 x i32> %i.xl, splat (i32 16)    ; 5 uses
  %i.xn = getelementptr inbounds nuw [4 x i8], ptr %i.wz, i64 %index653 ; 2 uses
  store <4 x i32> %i.xm, ptr %i.xn, align 4, !alias.scope !886, !noalias !888
  %wide.load656 = load <4 x i32>, ptr %i.xe, align 4, !alias.scope !881
  %i.xo = and <4 x i32> %wide.load656, splat (i32 32768)
  %i.xp = icmp ne <4 x i32> %i.xo, zeroinitializer
  %wide.load657 = load <4 x i32>, ptr %i.xh, align 4, !alias.scope !884
  %i.xq = and <4 x i32> %wide.load657, splat (i32 32768)
...
pred.store.continue:                              ; preds = %pred.store.if, %vector.body652
  ...
  br i1 %i.xw, label %pred.store.if658, label %pred.store.continue659

pred.store.if658:                                 ; preds = %pred.store.continue
  %i.xx = getelementptr inbounds nuw [4 x i8], ptr %i.wz, i64 %index653
...
pred.store.continue659:                           ; preds = %pred.store.if658, %pred.store.continue
  ...
  br i1 %i.yb, label %pred.store.if660, label %pred.store.continue661

pred.store.if660:                                 ; preds = %pred.store.continue659
  %i.yc = getelementptr inbounds nuw [4 x i8], ptr %i.wz, i64 %index653
...
pred.store.continue661:                           ; preds = %pred.store.if660, %pred.store.continue659
  ...
  br i1 %i.yg, label %pred.store.if662, label %pred.store.continue663

pred.store.if662:                                 ; preds = %pred.store.continue661
  %i.yh = getelementptr inbounds nuw [4 x i8], ptr %i.wz, i64 %index653
...
pred.store.continue663:                           ; preds = %pred.store.if662, %pred.store.continue661
  ...
  %i.yl = icmp eq i64 %index.next664, %n.vec649
  br i1 %i.yl, label %middle.block665, label %vector.body652, !llvm.loop !889

middle.block665:                                  ; preds = %pred.store.continue663
  %cmp.n666 = icmp eq i64 %n.vec649, %i.wg
end_hunk_1
