...
bb.k:                                             ; preds = %.lr.ph462, %bb.q
  ...
  %i.dr = getelementptr inbounds nuw [8 x i8], ptr %i.dq, i64 %indvars.iv500
...
_vorbis_block_alloc.exit375:                      ; preds = %bb.k, %bb.n
  ...
  %i.ei = getelementptr inbounds nuw [8 x i8], ptr %i.al, i64 %indvars.iv500 ; 2 uses
...
.lr.ph61.i.preheader:                             ; preds = %.preheader57.i
  ...
  %min.iters.check628 = icmp ult i64 %i.fy, 8
...
vector.memcheck620:                               ; preds = %.lr.ph61.i.preheader
  ...
  %scevgep621 = getelementptr i8, ptr %i.ds, i64 %i.fz
  %i.ga = shl i64 %i.fn, 2                        ; 2 uses
  %scevgep622 = getelementptr i8, ptr %i.ds, i64 %i.ga
  %i.gb = sub i64 %i.ga, %i.fz
  %scevgep623 = getelementptr i8, ptr %i.eu, i64 %i.gb
  %bound0624 = icmp ult ptr %scevgep621, %scevgep623
  %bound1625 = icmp ult ptr %i.eu, %scevgep622
...
vector.ph629:                                     ; preds = %vector.memcheck620
  %n.vec631 = and i64 %i.fy, -8                   ; 4 uses
  %i.gc = add i64 %.050.lcssa.i, %n.vec631
  %i.gd = getelementptr [4 x i8], ptr %i.ds, i64 %.050.lcssa.i
...
vector.body632:                                   ; preds = %vector.body632, %vector.ph629
  ...
  %i.ge = getelementptr inbounds nuw [4 x i8], ptr %i.eu, i64 %index633 ; 2 uses
  %i.gf = getelementptr inbounds nuw i8, ptr %i.ge, i64 16
  %wide.load634 = load <4 x float>, ptr %i.ge, align 4, !alias.scope !852
  %wide.load635 = load <4 x float>, ptr %i.gf, align 4, !alias.scope !852
  %i.gg = getelementptr [4 x i8], ptr %i.gd, i64 %index633 ; 3 uses
  %i.gh = getelementptr inbounds nuw i8, ptr %i.gg, i64 16 ; 2 uses
  %wide.load636 = load <4 x float>, ptr %i.gg, align 4, !alias.scope !855, !noalias !852
  %wide.load637 = load <4 x float>, ptr %i.gh, align 4, !alias.scope !855, !noalias !852
  %i.gi = fmul <4 x float> %wide.load634, %wide.load636
  %i.gj = fmul <4 x float> %wide.load635, %wide.load637
  ...
  %i.gk = icmp eq i64 %index.next638, %n.vec631
  br i1 %i.gk, label %middle.block639, label %vector.body632, !llvm.loop !857

middle.block639:                                  ; preds = %vector.body632
  %cmp.n640 = icmp eq i64 %i.fy, %n.vec631
...
.lr.ph61.i.preheader770:                          ; preds = %vector.memcheck620, %.lr.ph61.i.preheader, %middle.block639
  %indvars.iv72.i.ph = phi i64 [ %.050.lcssa.i, %vector.memcheck620 ], [ %.050.lcssa.i, %.lr.ph61.i.preheader ], [ %i.gc, %middle.block639 ]
...
vector.memcheck:                                  ; preds = %vector.scevcheck
  ...
  %scevgep609 = getelementptr i8, ptr %i.ds, i64 %i.hj
  %i.hk = shl i64 %i.fs, 2
  %scevgep610 = getelementptr i8, ptr %i.ds, i64 %i.hk
  %scevgep611 = getelementptr i8, ptr %i.fc, i64 4
  %i.hl = shl i64 %i.fr, 32
  %sext756 = add i64 %i.hl, -4294967296           ; 2 uses
  %i.hm = ashr exact i64 %sext756, 32
  %i.hn = add nsw i64 %i.hm, %i.gr
  %i.ho = sub i64 %i.hn, %i.fs
  %i.hp = shl i64 %i.ho, 2
  %scevgep612 = getelementptr i8, ptr %scevgep611, i64 %i.hp
  %scevgep613 = getelementptr i8, ptr %i.fc, i64 4
  %i.hq = ashr exact i64 %sext756, 30
  %scevgep614 = getelementptr i8, ptr %scevgep613, i64 %i.hq
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %sext757 = shl i64 %i.hw, 32
  %i.hx = ashr exact i64 %sext757, 30
  ...
  %wide.load615 = load <4 x float>, ptr %i.ia, align 4, !alias.scope !859
  ...
  %wide.load617 = load <4 x float>, ptr %i.ib, align 4, !alias.scope !862, !noalias !859
  %wide.load618 = load <4 x float>, ptr %i.ic, align 4, !alias.scope !862, !noalias !859
  %i.id = fmul <4 x float> %reverse, %wide.load617
  %i.ie = fmul <4 x float> %reverse616, %wide.load618
...
.preheader.i:                                     ; preds = %.preheader.i.loopexit, %._crit_edge.i
  %.pre-phi = phi i64 [ %.pre538, %.preheader.i.loopexit ], [ %i.gr, %._crit_edge.i ] ; 3 uses
...
_vorbis_apply_window.exit:                        ; preds = %.lr.ph68.i.preheader, %.preheader.i
  ...
  %i.jd = getelementptr inbounds nuw [4 x i8], ptr %i.cc, i64 %indvars.iv500 ; 3 uses
...
bb.q:                                             ; preds = %bb.p, %bb.o
  ...
  %i.jy = fcmp ogt float %i.jx, %.0346460
  %.1347 = select i1 %i.jy, float %i.jx, float %.0346460 ; 2 uses
  %indvars.iv.next501 = add nuw nsw i64 %indvars.iv500, 1 ; 2 uses
  %i.jz = load i32, ptr %i.m, align 4
  %i.ka = sext i32 %i.jz to i64
  %i.kb = icmp slt i64 %indvars.iv.next501, %i.ka
  br i1 %i.kb, label %bb.k, label %._crit_edge463.loopexit, !llvm.loop !867

._crit_edge463.loopexit:                          ; preds = %bb.q
  %.pre = load i64, ptr %i.s, align 8
  %.pre533 = load i64, ptr %i.v, align 8
  %.pre534 = load ptr, ptr %i.y, align 8
  br label %._crit_edge463

._crit_edge463:                                   ; preds = %_vorbis_block_alloc.exit373.._crit_edge463_crit_edge, %._crit_edge463.loopexit
  %.pre-phi552 = phi i64 [ %.pre551, %_vorbis_block_alloc.exit373.._crit_edge463_crit_edge ], [ %i.db, %._crit_edge463.loopexit ] ; 13 uses
  %.pre-phi546 = phi i64 [ %.pre545, %_vorbis_block_alloc.exit373.._crit_edge463_crit_edge ], [ %i.cy, %._crit_edge463.loopexit ] ; 5 uses
  %.pre-phi544 = phi i32 [ %.pre543, %_vorbis_block_alloc.exit373.._crit_edge463_crit_edge ], [ %i.cx, %._crit_edge463.loopexit ] ; 2 uses
  %i.kc = phi ptr [ %i.bu, %_vorbis_block_alloc.exit373.._crit_edge463_crit_edge ], [ %.pre534, %._crit_edge463.loopexit ] ; 3 uses
  %i.kd = phi i64 [ %i.bs, %_vorbis_block_alloc.exit373.._crit_edge463_crit_edge ], [ %.pre533, %._crit_edge463.loopexit ] ; 2 uses
  %i.ke = phi i64 [ %i.bw, %_vorbis_block_alloc.exit373.._crit_edge463_crit_edge ], [ %.pre, %._crit_edge463.loopexit ] ; 3 uses
  %.0346.lcssa = phi float [ %i.by, %_vorbis_block_alloc.exit373.._crit_edge463_crit_edge ], [ %.1347, %._crit_edge463.loopexit ] ; 2 uses
  %i.kf = add nsw i64 %i.ke, %.pre-phi552
  %i.kg = icmp sgt i64 %i.kf, %i.kd
  br i1 %i.kg, label %bb.r, label %_vorbis_block_alloc.exit379

bb.r:                                             ; preds = %._crit_edge463
...
bb.t:                                             ; preds = %bb.s, %bb.r
  ...
  %i.ko = tail call noalias ptr @malloc(i64 noundef %.pre-phi552) #69 ; 2 uses
  store ptr %i.ko, ptr %i.y, align 8
  br label %_vorbis_block_alloc.exit379

_vorbis_block_alloc.exit379:                      ; preds = %._crit_edge463, %bb.t
  %i.kp = phi i64 [ %.pre-phi552, %bb.t ], [ %i.kd, %._crit_edge463 ]
  %i.kq = phi i64 [ 0, %bb.t ], [ %i.ke, %._crit_edge463 ] ; 2 uses
  %i.kr = phi ptr [ %i.ko, %bb.t ], [ %i.kc, %._crit_edge463 ] ; 4 uses
  %i.ks = getelementptr inbounds i8, ptr %i.kr, i64 %i.kq ; 4 uses
  %i.kt = add nsw i64 %i.kq, %.pre-phi552         ; 3 uses
  %i.ku = add nsw i64 %i.kt, %.pre-phi552
...
bb.w:                                             ; preds = %bb.v, %bb.u
  store i64 %.pre-phi552, ptr %i.v, align 8
  %i.ld = tail call noalias ptr @malloc(i64 noundef %.pre-phi552) #69 ; 2 uses
...
_vorbis_block_alloc.exit382:                      ; preds = %_vorbis_block_alloc.exit379, %bb.w
  ...
  %i.lh = add nsw i64 %i.le, %.pre-phi552
  store i64 %i.lh, ptr %i.s, align 8
  %i.li = load i32, ptr %i.m, align 4
  %.not357469 = icmp sgt i32 %i.li, 0
  br i1 %.not357469, label %.lr.ph471, label %.critedge366

.lr.ph471:                                        ; preds = %_vorbis_block_alloc.exit382
  ...
  %wide.trip.count = zext i32 %.pre-phi544 to i64 ; 5 uses
  %i.ls = shl nsw i64 %.pre-phi546, 2
  %min.iters.check716 = icmp ult i32 %.pre-phi544, 8
  %n.vec719 = and i64 %wide.trip.count, 4294967288 ; 3 uses
  %cmp.n726 = icmp eq i64 %n.vec719, %wide.trip.count
  %xtraiter = and i64 %wide.trip.count, 1
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  %i.lt = add nsw i64 %wide.trip.count, -1
  br label %bb.x

bb.x:                                             ; preds = %.lr.ph471, %.loopexit451
  %indvars.iv514 = phi i64 [ 0, %.lr.ph471 ], [ %indvars.iv.next515, %.loopexit451 ] ; 6 uses
  %i.lu = getelementptr inbounds nuw [4 x i8], ptr %i.lj, i64 %indvars.iv514
  %i.lv = load i32, ptr %i.lu, align 4
  %i.lw = getelementptr inbounds nuw [8 x i8], ptr %i.al, i64 %indvars.iv514
  %i.lx = load ptr, ptr %i.lw, align 8            ; 5 uses
  %i.ly = ptrtoaddr ptr %i.lx to i64
  %i.lz = load ptr, ptr %0, align 8
  %i.ma = getelementptr inbounds nuw [8 x i8], ptr %i.lz, i64 %indvars.iv514
  %i.mb = load ptr, ptr %i.ma, align 8            ; 9 uses
  %i.mc = ptrtoaddr ptr %i.mb to i64
  %i.md = getelementptr inbounds [4 x i8], ptr %i.mb, i64 %.pre-phi546 ; 8 uses
  store i32 %i.ch, ptr %i.cs, align 4
...
_vorbis_block_alloc.exit385:                      ; preds = %bb.x, %bb.aa
  ...
  %i.mt = getelementptr inbounds nuw [8 x i8], ptr %i.bv, i64 %indvars.iv514 ; 9 uses
  ...
  br i1 %i.lm, label %.lr.ph465.preheader, label %._crit_edge466

.lr.ph465.preheader:                              ; preds = %_vorbis_block_alloc.exit385
  br i1 %min.iters.check716, label %.lr.ph465.preheader768, label %vector.memcheck714

vector.memcheck714:                               ; preds = %.lr.ph465.preheader
  %i.mu = add i64 %i.ls, %i.mc
  %i.mv = sub i64 %i.ly, %i.mu
  %diff.check = icmp ugt i64 %i.mv, -32
  br i1 %diff.check, label %.lr.ph465.preheader768, label %vector.body720

vector.body720:                                   ; preds = %vector.memcheck714, %vector.body720
  %index721 = phi i64 [ %index.next724, %vector.body720 ], [ 0, %vector.memcheck714 ] ; 3 uses
  %i.mw = getelementptr inbounds nuw [4 x i8], ptr %i.lx, i64 %index721 ; 2 uses
  %i.mx = getelementptr inbounds nuw i8, ptr %i.mw, i64 16
  %wide.load722 = load <4 x i32>, ptr %i.mw, align 4
  %wide.load723 = load <4 x i32>, ptr %i.mx, align 4
  %i.my = and <4 x i32> %wide.load722, splat (i32 2147483647)
end_hunk_2
