...
begin_hunk_0_@floor1_interpolate_fit:bb.a
  ...
  %i.ai = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %index ; 2 uses
...
begin_hunk_1_@mapping0_forward:bb.a
  ...
  %i.tu = getelementptr inbounds nuw [4 x i8], ptr %i.so, i64 %index694 ; 2 uses
...
begin_hunk_2_@mapping0_forward:bb.a
  ...
  %i.xi = getelementptr inbounds nuw [4 x i8], ptr %i.wc, i64 %index658 ; 2 uses
