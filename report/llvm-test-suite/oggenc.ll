...
.preheader.preheader:                             ; preds = %.preheader97
  ...
  %scevgep143 = getelementptr i8, ptr %i.d, i64 %i.m ; 2 uses
  br label %.preheader
...
begin_hunk_2
  ...
  %.pre = load double, ptr %scevgep143, align 8
  br label %.lr.ph107
...
begin_hunk_3
  ...
  %i.x = ashr exact i64 %sext92, 32               ; 5 uses
...
begin_hunk_5
  ...
  %umin = tail call i64 @llvm.umin.i64(i64 %i.fb, i64 %i.am)
...
._crit_edge464:                                   ; preds = %_vorbis_block_alloc.exit373.._crit_edge464_crit_edge, %._crit_edge464.loopexit
  ...
  %.pre-phi546 = phi i64 [ %.pre545, %_vorbis_block_alloc.exit373.._crit_edge464_crit_edge ], [ %i.cy, %._crit_edge464.loopexit ] ; 5 uses
...
begin_hunk_7
  ...
  %1 = shl nsw i64 %.pre-phi546, 2                ; 2 uses
  %diff.check743 = icmp ult i64 %1, 16
  %diff.check728 = icmp ult i64 %1, 16
  br label %bb.az
