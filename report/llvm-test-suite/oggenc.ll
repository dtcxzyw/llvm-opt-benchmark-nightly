...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  %i.bi = getelementptr inbounds [8 x i8], ptr %i.bc, i64 %i.bh ; 2 uses
  ...
  %i.bn = fsub double 1.000000e+00, %i.bf
  %i.bo = load <2 x double>, ptr %i.bi, align 8
  %i.bp = insertelement <2 x double> poison, double %i.bn, i64 0
  %i.bq = insertelement <2 x double> %i.bp, double %i.bf, i64 1
  %i.br = fmul <2 x double> %i.bq, %i.bo
  %i.bs = tail call reassoc double @llvm.vector.reduce.fadd.v2f64(double -0.000000e+00, <2 x double> %i.br) ; 2 uses
  %i.bt = fptosi double %i.bs to i32              ; 3 uses
  ...
  %or.cond.i = and i1 %i.bx, %i.bw                ; 2 uses
  %i.by = sext i1 %or.cond.i to i32
  %.045.i = add nsw i32 %i.by, %i.bt
  %.0.i = select i1 %or.cond.i, double 1.000000e+00, double %i.bv ; 9 uses
  %i.bz = sext i32 %.045.i to i64
  %i.ca = getelementptr inbounds [492 x i8], ptr %i.ba, i64 %i.bz ; 16 uses
  %i.cb = getelementptr inbounds nuw i8, ptr %i.ca, i64 4
  %i.cc = fsub double 1.000000e+00, %.0.i         ; 8 uses
  %i.cd = getelementptr i8, ptr %i.ca, i64 496
  %i.ce = getelementptr inbounds nuw i8, ptr %.val181, i64 4948
  %i.cf = getelementptr inbounds nuw i8, ptr %i.ca, i64 32
  %i.cg = getelementptr i8, ptr %i.ca, i64 524
  %i.ch = getelementptr inbounds nuw i8, ptr %.val181, i64 4976
  %i.ci = load float, ptr %i.cb, align 4
  %i.cj = fpext float %i.ci to double
  %i.ck = fmul double %i.cc, %i.cj
  %i.cl = load float, ptr %i.cd, align 4
  %i.cm = fpext float %i.cl to double
  %i.cn = fmul double %.0.i, %i.cm
  %i.co = fadd double %i.cn, %i.ck
  %i.cp = fptrunc double %i.co to float
  store float %i.cp, ptr %i.ce, align 4
  %i.cq = load float, ptr %i.cf, align 4
  %i.cr = fpext float %i.cq to double
  %i.cs = fmul double %i.cc, %i.cr
  %i.ct = load float, ptr %i.cg, align 4
  %i.cu = fpext float %i.ct to double
  %i.cv = fmul double %.0.i, %i.cu
  %i.cw = fadd double %i.cv, %i.cs
  %i.cx = fptrunc double %i.cw to float
  store float %i.cx, ptr %i.ch, align 4
  %i.cy = getelementptr inbounds nuw i8, ptr %i.ca, i64 8
  %i.cz = load float, ptr %i.cy, align 4
  %i.da = fpext float %i.cz to double
  %i.db = fmul double %i.cc, %i.da
  %i.dc = getelementptr i8, ptr %i.ca, i64 500
  %i.dd = load float, ptr %i.dc, align 4
  %i.de = fpext float %i.dd to double
  %i.df = fmul double %.0.i, %i.de
  %i.dg = fadd double %i.db, %i.df
  %i.dh = fptrunc double %i.dg to float
  %i.di = getelementptr inbounds nuw i8, ptr %.val181, i64 4952
  store float %i.dh, ptr %i.di, align 4
  %i.dj = getelementptr inbounds nuw i8, ptr %i.ca, i64 36
  %i.dk = load float, ptr %i.dj, align 4
  %i.dl = fpext float %i.dk to double
  %i.dm = fmul double %i.cc, %i.dl
  %i.dn = getelementptr i8, ptr %i.ca, i64 528
  %i.do = load float, ptr %i.dn, align 4
  %i.dp = fpext float %i.do to double
  %i.dq = fmul double %.0.i, %i.dp
  %i.dr = fadd double %i.dm, %i.dq
  %i.ds = fptrunc double %i.dr to float
  %i.dt = getelementptr inbounds nuw i8, ptr %.val181, i64 4980
  ...
  %i.dx = fmul double %i.cc, %i.dw
  %i.dy = getelementptr i8, ptr %i.ca, i64 504
  %i.dz = load float, ptr %i.dy, align 4
  %i.ea = fpext float %i.dz to double
  %i.eb = fmul double %.0.i, %i.ea
  %i.ec = fadd double %i.dx, %i.eb
  %i.ed = fptrunc double %i.ec to float
  %i.ee = getelementptr inbounds nuw i8, ptr %.val181, i64 4956
  store float %i.ed, ptr %i.ee, align 4
  %i.ef = getelementptr inbounds nuw i8, ptr %i.ca, i64 40
  %i.eg = load float, ptr %i.ef, align 4
  %i.eh = fpext float %i.eg to double
  %i.ei = fmul double %i.cc, %i.eh
  %i.ej = getelementptr i8, ptr %i.ca, i64 532
  %i.ek = load float, ptr %i.ej, align 4
  %i.el = fpext float %i.ek to double
  %i.em = fmul double %.0.i, %i.el
  %i.en = fadd double %i.ei, %i.em
end_hunk_0
begin_hunk_1_@vorbis_encode_setup_init:bb.a
vorbis_encode_map_n_res_setup.exit:               ; preds = %._crit_edge.i
  %i.bpc = load ptr, ptr %i.a, align 8            ; 2 uses
  %i.bpd = getelementptr inbounds nuw i8, ptr %i.bpc, i64 5512
  %i.bpe = load ptr, ptr %i.bpd, align 8
  %i.bpf = getelementptr inbounds nuw i8, ptr %i.bpe, i64 8
  %i.bpg = load ptr, ptr %i.bpf, align 8          ; 2 uses
  %i.bph = icmp eq ptr %i.bpg, null
  br i1 %i.bph, label %setting_to_approx_bitrate.exit, label %bb.cn

bb.cn:                                            ; preds = %vorbis_encode_map_n_res_setup.exit
  %i.bpi = load i32, ptr %i.beh, align 4
  %i.bpj = getelementptr inbounds nuw i8, ptr %i.bpc, i64 5528
  %i.bpk = load double, ptr %i.bpj, align 8       ; 2 uses
  %i.bpl = fptosi double %i.bpk to i32            ; 2 uses
  %i.bpm = sitofp i32 %i.bpl to double
  %i.bpn = fsub double %i.bpk, %i.bpm             ; 2 uses
  %i.bpo = sext i32 %i.bpl to i64
  %i.bpp = getelementptr inbounds [8 x i8], ptr %i.bpg, i64 %i.bpo
  %i.bpq = fsub double 1.000000e+00, %i.bpn
  %i.bpr = load <2 x double>, ptr %i.bpp, align 8
  %i.bps = insertelement <2 x double> poison, double %i.bpq, i64 0
  %i.bpt = insertelement <2 x double> %i.bps, double %i.bpn, i64 1
  %i.bpu = fmul <2 x double> %i.bpr, %i.bpt
  %i.bpv = tail call reassoc double @llvm.vector.reduce.fadd.v2f64(double -0.000000e+00, <2 x double> %i.bpu)
  %i.bpw = sitofp i32 %i.bpi to double
  %i.bpx = fmul double %i.bpv, %i.bpw
  %i.bpy = fptosi double %i.bpx to i64
  br label %setting_to_approx_bitrate.exit

setting_to_approx_bitrate.exit:                   ; preds = %vorbis_encode_map_n_res_setup.exit, %bb.cn
  %.0.i257 = phi i64 [ %i.bpy, %bb.cn ], [ -1, %vorbis_encode_map_n_res_setup.exit ]
  %i.bpz = getelementptr inbounds nuw i8, ptr %0, i64 24
  store i64 %.0.i257, ptr %i.bpz, align 8
  %i.bqa = getelementptr inbounds nuw i8, ptr %i.b, i64 5568 ; 2 uses
  %i.bqb = load i64, ptr %i.bqa, align 8
  %i.bqc = getelementptr inbounds nuw i8, ptr %0, i64 32
  store i64 %i.bqb, ptr %i.bqc, align 8
  %i.bqd = getelementptr inbounds nuw i8, ptr %i.b, i64 5592 ; 2 uses
  %i.bqe = load i64, ptr %i.bqd, align 8
  %i.bqf = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i64 %i.bqe, ptr %i.bqf, align 8
  %i.bqg = getelementptr inbounds nuw i8, ptr %i.b, i64 5600 ; 2 uses
  %i.bqh = load double, ptr %i.bqg, align 8
  %i.bqi = fptosi double %i.bqh to i64
  %i.bqj = getelementptr inbounds nuw i8, ptr %0, i64 40
  store i64 %i.bqi, ptr %i.bqj, align 8
  %i.bqk = getelementptr inbounds nuw i8, ptr %i.b, i64 5560
  %i.bql = load i32, ptr %i.bqk, align 8
  %.not = icmp eq i32 %i.bql, 0
  br i1 %.not, label %bb.cp, label %bb.co

bb.co:                                            ; preds = %setting_to_approx_bitrate.exit
  %i.bqm = getelementptr inbounds nuw i8, ptr %i.b, i64 5608
  %i.bqn = getelementptr inbounds nuw i8, ptr %i.b, i64 5440
  %i.bqo = load <2 x double>, ptr %i.bqm, align 8
  store <2 x double> %i.bqo, ptr %i.bqn, align 8
  %i.bqp = load double, ptr %i.bqg, align 8
  %i.bqq = getelementptr inbounds nuw i8, ptr %i.b, i64 5456
  store double %i.bqp, ptr %i.bqq, align 8
  %i.bqr = load i64, ptr %i.bqa, align 8
  %i.bqs = sitofp i64 %i.bqr to double
  %i.bqt = getelementptr inbounds nuw i8, ptr %i.b, i64 5464
  store double %i.bqs, ptr %i.bqt, align 8
  %i.bqu = load i64, ptr %i.bqd, align 8
  %i.bqv = sitofp i64 %i.bqu to double
  %i.bqw = getelementptr inbounds nuw i8, ptr %i.b, i64 5472
  store double %i.bqv, ptr %i.bqw, align 8
  %i.bqx = getelementptr inbounds nuw i8, ptr %i.b, i64 5576
  %i.bqy = load i64, ptr %i.bqx, align 8
  %i.bqz = sitofp i64 %i.bqy to double
  %i.bra = getelementptr inbounds nuw i8, ptr %i.b, i64 5480
  store double %i.bqz, ptr %i.bra, align 8
  %i.brb = getelementptr inbounds nuw i8, ptr %i.b, i64 5584
  %i.brc = load i64, ptr %i.brb, align 8
  %i.brd = sitofp i64 %i.brc to double
  %i.bre = getelementptr inbounds nuw i8, ptr %i.b, i64 5488
  store double %i.brd, ptr %i.bre, align 8
  %i.brf = getelementptr inbounds nuw i8, ptr %i.b, i64 5496
  store <2 x double> <double -9.999990e+05, double 9.999990e+05>, ptr %i.brf, align 8
  br label %bb.cp
...
ogg_stream_packetout.exit164:                     ; preds = %ogg_stream_packetout.exit164.outer, %.thread303
  ...
  %.075 = phi i32 [ %i.kf, %.thread303 ], [ %.075.ph, %ogg_stream_packetout.exit164.outer ] ; 2 uses
...
begin_hunk_7_@vorbis_staticbook_pack:bb.a
  %factor.op.mul226 = mul i64 %factor.op.mul224, %i.gx
  %factor.op.mul227 = mul i64 %factor.op.mul225, %.022.us.i
  %factor.op.mul228 = mul i64 %factor.op.mul226, %i.gx
  br label %bb.aa
...
bb.ab:                                            ; preds = %._crit_edge.us.i
  %i.gy = icmp sgt i64 %.lcssa197, %i.gl
  %.1.v.us.i = select i1 %i.gy, i64 -1, i64 1
...
bb.ac:                                            ; preds = %bb.ac, %.epil.preheader
  %.02031.us.i.epil = phi i64 [ %.02031.us.i.epil.init, %.epil.preheader ], [ %i.ha, %bb.ac ]
  %.02130.us.i.epil = phi i64 [ %.02130.us.i.epil.init, %.epil.preheader ], [ %i.gz, %bb.ac ]
  %epil.iter = phi i64 [ 0, %.epil.preheader ], [ %epil.iter.next, %bb.ac ]
  %i.gz = mul nsw i64 %.02130.us.i.epil, %.022.us.i ; 2 uses
  %i.ha = mul nsw i64 %.02031.us.i.epil, %i.gx    ; 2 uses
...
._crit_edge.us.i:                                 ; preds = %bb.ac, %._crit_edge.us.i.unr-lcssa
  %.lcssa197 = phi i64 [ %.reass.reass.reass.reass.reass.reass.reass, %._crit_edge.us.i.unr-lcssa ], [ %i.gz, %bb.ac ] ; 2 uses
  %.lcssa = phi i64 [ %.reass216.reass.reass.reass.reass.reass.reass, %._crit_edge.us.i.unr-lcssa ], [ %i.ha, %bb.ac ]
  %.not.us.i = icmp sle i64 %.lcssa197, %i.gl
  %i.hb = icmp sgt i64 %.lcssa, %i.gl
  %or.cond.us.i = select i1 %.not.us.i, i1 %i.hb, i1 false
...
bb.ad:                                            ; preds = %bb.y
  %i.hc = load i64, ptr %i.b, align 8
  %i.hd = load i64, ptr %0, align 8
  %i.he = mul nsw i64 %i.hd, %i.hc
  br label %_book_maptype1_quantvals.exit

_book_maptype1_quantvals.exit:                    ; preds = %._crit_edge.us.i, %bb.ad
  %.0 = phi i64 [ %i.he, %bb.ad ], [ %.022.us.i, %._crit_edge.us.i ]
  %sext = shl i64 %.0, 32
  %i.hf = ashr exact i64 %sext, 32                ; 2 uses
  %i.hg = icmp sgt i64 %i.hf, 0
  br i1 %i.hg, label %.lr.ph147, label %.loopexit

.lr.ph147:                                        ; preds = %_book_maptype1_quantvals.exit, %.lr.ph147
  %.5146 = phi i64 [ %i.hm, %.lr.ph147 ], [ 0, %_book_maptype1_quantvals.exit ] ; 2 uses
  %i.hh = load ptr, ptr %i.fx, align 8
  %i.hi = getelementptr inbounds nuw [8 x i8], ptr %i.hh, i64 %.5146
  %i.hj = load i64, ptr %i.hi, align 8
  %i.hk = tail call i64 @llvm.abs.i64(i64 %i.hj, i1 true)
  %i.hl = load i32, ptr %i.gd, align 8
  tail call void @oggpack_write(ptr noundef %1, i64 noundef %i.hk, i32 noundef %i.hl)
  %i.hm = add nuw nsw i64 %.5146, 1               ; 2 uses
  %exitcond155.not = icmp eq i64 %i.hm, %i.hf
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.aq = icmp samesign ugt i32 %i.t, 23
  br i1 %i.aq, label %bb.f, label %bb.g

bb.f:                                             ; preds = %bb.e
  %i.ar = load i32, ptr %i.r, align 8
  %i.as = sub nsw i32 24, %i.ar
  %i.at = zext nneg i32 %i.as to i64
  %i.au = lshr i64 %i.q, %i.at
  %i.av = trunc i64 %i.au to i8
  %i.aw = load ptr, ptr %i.w, align 8
  %i.ax = getelementptr inbounds nuw i8, ptr %i.aw, i64 3
  store i8 %i.av, ptr %i.ax, align 1
  %i.ay = icmp samesign ugt i32 %i.t, 31
  br i1 %i.ay, label %.sink.split, label %bb.g

.sink.split:                                      ; preds = %bb.f
  %i.az = load i32, ptr %i.r, align 8             ; 2 uses
  %.not41 = icmp eq i32 %i.az, 0
  %i.ba = sub nsw i32 32, %i.az
  %i.bb = zext nneg i32 %i.ba to i64
  %i.bc = lshr i64 %i.q, %i.bb
  %i.bd = trunc i64 %i.bc to i8
  %.sink = select i1 %.not41, i8 0, i8 %i.bd
  %i.be = load ptr, ptr %i.w, align 8
...
bb.g:                                             ; preds = %.sink.split, %bb.d, %bb.f, %bb.e, %bb.c
  ...
  %i.bk = load ptr, ptr %i.w, align 8
  %i.bl = getelementptr inbounds i8, ptr %i.bk, i64 %i.bh
  store ptr %i.bl, ptr %i.w, align 8
  %i.bm = and i32 %i.t, 7
  store i32 %i.bm, ptr %i.r, align 8
  ret void
}
