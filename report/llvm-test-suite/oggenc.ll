...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %4 = load <3 x i64>, ptr %i.hw, align 8
  %strided.vec = shufflevector <3 x i64> %4, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %5 = load <3 x i64>, ptr %i.hx, align 8
  %strided.vec353 = shufflevector <3 x i64> %5, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %4 = load <3 x i64>, ptr %i.ft, align 8, !alias.scope !223
  %strided.vec = shufflevector <3 x i64> %4, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %5 = load <3 x i64>, ptr %i.fu, align 8, !alias.scope !223
  %strided.vec256 = shufflevector <3 x i64> %5, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %4 = load <3 x i64>, ptr %i.dm, align 8
  %strided.vec = shufflevector <3 x i64> %4, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %5 = load <3 x i64>, ptr %i.dn, align 8
  %strided.vec14 = shufflevector <3 x i64> %5, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
