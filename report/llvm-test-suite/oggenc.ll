...
vector.ph:                                        ; preds = %.lr.ph105.preheader
  ...
  %9 = shl i64 %n.vec, 2
  %i.cv = getelementptr i8, ptr %1, i64 %9        ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %offset.idx143 = shl i64 %index, 2
  %next.gep144 = getelementptr i8, ptr %1, i64 %offset.idx143 ; 2 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %.fr.i, 2147483640             ; 5 uses
  %i.ew = shl nuw nsw i64 %n.vec, 2
  %i.ex = getelementptr i8, ptr %i.ep, i64 %i.ew
  %4 = shl nuw nsw i64 %n.vec, 2
  %i.ey = getelementptr i8, ptr %i.o, i64 %4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep16 = getelementptr i8, ptr %i.o, i64 %offset.idx15 ; 3 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.j, 2147483644               ; 7 uses
...
begin_hunk_3_@dradf4:bb.a
  ...
  %.0224243.ph = phi i32 [ 0, %vector.memcheck ], [ 0, %vector.scevcheck ], [ 0, %.lr.ph ], [ %7, %middle.block ]
  %.0231240.ph = phi i32 [ 0, %vector.memcheck ], [ 0, %vector.scevcheck ], [ 0, %.lr.ph ], [ %i.ap, %middle.block ]
  br label %scalar.ph
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %.0224243 = phi i32 [ %i.cj, %scalar.ph ], [ %.0224243.ph, %scalar.ph.preheader ]
...
begin_hunk_4_@dradf4:bb.a
  ...
  %n.vec769 = and i64 %i.fa, 9223372036854775804  ; 6 uses
  %8 = shl nuw i64 %n.vec769, 1
  %9 = shl nuw i64 %n.vec769, 1
  %i.fv = shl nuw i64 %n.vec769, 1
  %i.fw = shl nuw i64 %n.vec769, 1
...
vector.ph767:                                     ; preds = %vector.memcheck384
  %i.jd = sub i64 %i.gd, %8
  %i.je = add i64 %9, %i.gc
  %i.jf = add i64 %indvars.iv274, %i.fv
  %invariant.op = add i64 %indvars.iv274, 2
  br label %vector.body770

vector.body770:                                   ; preds = %vector.body770, %vector.ph767
  %index771 = phi i64 [ 0, %vector.ph767 ], [ %index.next802, %vector.body770 ] ; 5 uses
  %i.jg = shl i64 %index771, 1
  %offset.idx772 = sub i64 %i.gd, %i.jg           ; 2 uses
  %i.jh = shl i64 %index771, 1
  %offset.idx773 = add i64 %i.jh, %i.gc           ; 2 uses
  %10 = shl i64 %index771, 1
  %11 = shl i64 %index771, 1                      ; 3 uses
  %.reass = add i64 %10, %invariant.op            ; 2 uses
  %i.ji = add nuw nsw i64 %.reass, %i.co          ; 2 uses
  %i.jj = getelementptr inbounds [4 x i8], ptr %4, i64 %11
...
begin_hunk_6_@dradf4:bb.a
  ...
  %i.jt = getelementptr inbounds [4 x i8], ptr %5, i64 %11
...
begin_hunk_7_@dradf4:bb.a
  ...
  %i.kc = getelementptr inbounds [4 x i8], ptr %6, i64 %11
...
begin_hunk_8_@dradfg:bb.a
  ...
  %n.vec1242 = and i64 %i.bz, 4294967292          ; 5 uses
  %10 = shl nuw nsw i64 %n.vec1242, 1
  %i.ca = shl nuw nsw i64 %n.vec1242, 1
...
vector.ph1240:                                    ; preds = %vector.memcheck1223
  %i.ck = add nsw i64 %10, %i.ch
  %invariant.op = add i64 %i.ch, 1
  br label %vector.body1243

vector.body1243:                                  ; preds = %vector.body1243, %vector.ph1240
  %index1244 = phi i64 [ 0, %vector.ph1240 ], [ %index.next1257, %vector.body1243 ] ; 3 uses
  %11 = shl i64 %index1244, 1
  %.idx = shl i64 %index1244, 3
  %gep1634 = getelementptr i8, ptr %invariant.gep1633, i64 %.idx
  %i.cl = getelementptr i8, ptr %gep1634, i64 4   ; 2 uses
  %wide.vec = load <8 x float>, ptr %i.cl, align 4, !alias.scope !970 ; 2 uses
  %.reass = add i64 %11, %invariant.op            ; 2 uses
...
begin_hunk_10_@dradfg:bb.a
  ...
  %n.vec1347 = and i64 %i.fu, 4294967292          ; 5 uses
  %12 = shl nuw nsw i64 %n.vec1347, 1
  %i.fv = shl nuw nsw i64 %n.vec1347, 1
...
vector.body1349:                                  ; preds = %vector.body1349, %vector.ph1345
  %index1350 = phi i64 [ 0, %vector.ph1345 ], [ %index.next1367, %vector.body1349 ] ; 3 uses
  %13 = shl i64 %index1350, 1
  %i.gg = shl i64 %index1350, 1
  %.reass1636 = add i64 %13, %invariant.op1635    ; 2 uses
...
begin_hunk_12_@dradb4:bb.a
  ...
  %n.vec774 = and i64 %i.ik, 9223372036854775804  ; 8 uses
  %7 = shl nuw i64 %n.vec774, 1
  %8 = shl nuw i64 %n.vec774, 1
  %9 = shl nuw i64 %n.vec774, 1
  %10 = shl nuw i64 %n.vec774, 1
  %i.jv = shl nuw i64 %n.vec774, 1
  %11 = shl nuw i64 %n.vec774, 1
  %i.jw = or disjoint i64 %11, 2
...
vector.ph772:                                     ; preds = %vector.memcheck397
  %i.nd = add i64 %indvars.iv280, %7
  %12 = sub i64 %i.kf, %8
  %13 = sub i64 %i.ke, %9
  %i.ne = add i64 %10, %i.ke
...
vector.body775:                                   ; preds = %vector.body775, %vector.ph772
  %index776 = phi i64 [ 0, %vector.ph772 ], [ %index.next817, %vector.body775 ] ; 7 uses
  %i.ng = shl i64 %index776, 1
  %offset.idx777 = add i64 %indvars.iv280, %i.ng  ; 2 uses
  %14 = shl i64 %index776, 1
  %offset.idx778 = sub i64 %i.kf, %14
  %15 = shl i64 %index776, 1
  %offset.idx779 = sub i64 %i.ke, %15
  %16 = shl i64 %index776, 1                      ; 3 uses
  %.idx = shl i64 %index776, 3
  %gep937 = getelementptr i8, ptr %invariant.gep936, i64 %.idx
  %i.nh = getelementptr i8, ptr %gep937, i64 4
  ...
  %i.ni = getelementptr [4 x i8], ptr %2, i64 %offset.idx778
  ...
  %.idx893 = shl i64 %index776, 3
  %gep939 = getelementptr i8, ptr %invariant.gep938, i64 %.idx893
  %i.nm = getelementptr i8, ptr %gep939, i64 4
  ...
  %i.nn = getelementptr [4 x i8], ptr %2, i64 %offset.idx779
...
begin_hunk_14_@dradb4:bb.a
  ...
  %i.of = getelementptr inbounds [4 x i8], ptr %4, i64 %16 ; 2 uses
...
begin_hunk_15_@dradb4:bb.a
  ...
  %i.oo = getelementptr inbounds [4 x i8], ptr %5, i64 %16 ; 2 uses
...
begin_hunk_16_@dradb4:bb.a
  ...
  %i.oy = getelementptr inbounds [4 x i8], ptr %6, i64 %16 ; 2 uses
...
scalar.ph770.preheader:                           ; preds = %vector.memcheck397, %vector.scevcheck372, %.lr.ph246.us, %middle.block818
  ...
  %indvars.iv278.ph = phi i64 [ %i.kf, %vector.memcheck397 ], [ %i.kf, %vector.scevcheck372 ], [ %i.kf, %.lr.ph246.us ], [ %12, %middle.block818 ]
  %indvars.iv274.ph = phi i64 [ %i.ke, %vector.memcheck397 ], [ %i.ke, %vector.scevcheck372 ], [ %i.ke, %.lr.ph246.us ], [ %13, %middle.block818 ]
...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.g, 2147483644               ; 5 uses
...
.lr.ph.preheader375:                              ; preds = %vector.memcheck, %vector.scevcheck, %.lr.ph.preheader, %middle.block
  ...
  %.0100115.ph = phi i32 [ 0, %vector.memcheck ], [ 0, %vector.scevcheck ], [ 0, %.lr.ph.preheader ], [ %5, %middle.block ]
...
begin_hunk_20_@dradb2:bb.a
  ...
  %n.vec295 = and i64 %i.bk, 9223372036854775804  ; 7 uses
  %6 = shl nuw i64 %n.vec295, 1
  %7 = shl nuw i64 %n.vec295, 1
  %8 = shl nuw i64 %n.vec295, 1
  %i.bl = shl nuw i64 %n.vec295, 1
  %i.bm = shl nuw i64 %n.vec295, 1
  %i.bn = or disjoint i64 %i.bm, 2
...
vector.body296:                                   ; preds = %vector.body296, %vector.ph293
  %index297 = phi i64 [ 0, %vector.ph293 ], [ %index.next325, %vector.body296 ] ; 6 uses
  %i.cc = shl i64 %index297, 1
  %offset.idx300 = sub i64 %i.bp, %i.cc
  %.idx = shl i64 %index297, 3
  %gep378 = getelementptr i8, ptr %invariant.gep377, i64 %.idx
  %i.cd = getelementptr i8, ptr %gep378, i64 4    ; 2 uses
  ...
  %i.ce = getelementptr [4 x i8], ptr %2, i64 %offset.idx300
  ...
  %.idx372 = shl i64 %index297, 3
  %9 = getelementptr i8, ptr %i.cb, i64 %.idx372
...
begin_hunk_23_@dradb2:bb.a
  ...
  %.idx373 = shl i64 %index297, 3
  %10 = getelementptr i8, ptr %4, i64 %.idx373    ; 2 uses
  %wide.vec318 = load <8 x float>, ptr %10, align 4, !alias.scope !1109 ; 2 uses
  ...
  %.idx374 = shl i64 %index297, 3
  %gep380 = getelementptr i8, ptr %invariant.gep379, i64 %.idx374
  %i.co = getelementptr i8, ptr %gep380, i64 4
  %wide.vec321 = load <8 x float>, ptr %10, align 4, !alias.scope !1109 ; 2 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.k, 2147483644               ; 6 uses
  %6 = mul nuw nsw i64 %n.vec, 3
  %i.aj = mul nuw nsw i64 %n.vec, 3
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %offset.idx = mul i64 %index, 3                 ; 4 uses
  %i.am = mul i64 %index, 3                       ; 4 uses
...
begin_hunk_25_@dradb3:bb.a
  ...
  %i.bi = getelementptr inbounds [4 x i8], ptr %2, i64 %offset.idx
  %i.bj = getelementptr [4 x i8], ptr %2, i64 %offset.idx
  %i.bk = getelementptr i8, ptr %i.bj, i64 12
  %i.bl = getelementptr [4 x i8], ptr %2, i64 %offset.idx
  %i.bm = getelementptr i8, ptr %i.bl, i64 24
  %i.bn = getelementptr [4 x i8], ptr %2, i64 %offset.idx
...
.lr.ph.preheader569:                              ; preds = %vector.memcheck, %vector.scevcheck, %.lr.ph.preheader, %middle.block
  %indvars.iv169.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %vector.scevcheck ], [ 0, %.lr.ph.preheader ], [ %6, %middle.block ]
...
begin_hunk_27_@dradb3:bb.a
  ...
  %n.vec479 = and i64 %i.ef, 9223372036854775804  ; 9 uses
  %7 = shl nuw i64 %n.vec479, 1
  %8 = shl nuw i64 %n.vec479, 1
  %9 = shl nuw i64 %n.vec479, 1
  %10 = shl nuw i64 %n.vec479, 1
  %11 = shl nuw i64 %n.vec479, 1
  %i.el = shl nuw i64 %n.vec479, 1
  %i.em = shl nuw i64 %n.vec479, 1
  %i.en = or disjoint i64 %i.em, 2
...
vector.ph477:                                     ; preds = %vector.memcheck259
  %i.fw = add i64 %indvars.iv196, %7
  %i.fx = add i64 %8, %i.ez
  %i.fy = add i64 %9, %i.ey
  %i.fz = add i64 %10, %i.ex
  %i.ga = sub i64 %i.ew, %11
...
vector.body480:                                   ; preds = %vector.body480, %vector.ph477
  %index481 = phi i64 [ 0, %vector.ph477 ], [ %index.next519, %vector.body480 ] ; 8 uses
  %i.gd = shl i64 %index481, 1
  %offset.idx486 = sub i64 %i.ew, %i.gd
  %i.ge = shl i64 %index481, 1                    ; 2 uses
  %.idx = shl i64 %index481, 3
  %gep571 = getelementptr i8, ptr %invariant.gep570, i64 %.idx
  %i.gf = getelementptr i8, ptr %gep571, i64 4    ; 2 uses
  ...
  %i.gg = getelementptr [4 x i8], ptr %2, i64 %offset.idx486
  ...
  %.idx529 = shl i64 %index481, 3
  %gep573 = getelementptr i8, ptr %invariant.gep572, i64 %.idx529
  %i.gj = getelementptr i8, ptr %gep573, i64 4
  ...
  %.idx530 = shl i64 %index481, 3
  %12 = getelementptr i8, ptr %i.gc, i64 %.idx530
  %i.gn = getelementptr i8, ptr %12, i64 4
...
begin_hunk_30_@dradb3:bb.a
  ...
  %i.ha = getelementptr inbounds [4 x i8], ptr %4, i64 %i.ge ; 2 uses
  ...
  %.idx531 = shl i64 %index481, 3
  %gep575 = getelementptr i8, ptr %invariant.gep574, i64 %.idx531
  %i.he = getelementptr i8, ptr %gep575, i64 4
...
begin_hunk_31_@dradb3:bb.a
  ...
  %i.hi = getelementptr inbounds [4 x i8], ptr %5, i64 %i.ge ; 2 uses
  ...
  %.idx532 = shl i64 %index481, 3
  %gep577 = getelementptr i8, ptr %invariant.gep576, i64 %.idx532
  %i.hm = getelementptr i8, ptr %gep577, i64 4
...
begin_hunk_32_@dradbg:bb.a
  ...
  %n.vec1403 = and i64 %i.ke, 4294967292          ; 7 uses
  %10 = shl nuw nsw i64 %n.vec1403, 1
  %11 = shl nuw nsw i64 %n.vec1403, 1
  %i.kj = shl nuw nsw i64 %n.vec1403, 1
...
vector.ph1401:                                    ; preds = %vector.memcheck1311
  %i.mj = add i64 %indvars.iv933, %10
  %i.mk = add i64 %indvars.iv927, %11
...
vector.body1404:                                  ; preds = %vector.body1404, %vector.ph1401
  %index1405 = phi i64 [ 0, %vector.ph1401 ], [ %index.next1424, %vector.body1404 ] ; 5 uses
  %i.mq = shl i64 %index1405, 1
  %offset.idx1409 = sub i64 %indvars.iv919, %i.mq
  %.idx1803 = shl i64 %index1405, 3
  %12 = getelementptr i8, ptr %i.mn, i64 %.idx1803
  ...
  %i.ms = getelementptr [4 x i8], ptr %4, i64 %offset.idx1409
  ...
  %.idx1804 = shl i64 %index1405, 3
  %13 = getelementptr i8, ptr %i.mo, i64 %.idx1804
...
begin_hunk_35_@dradbg:bb.a
  ...
  %.idx1805 = shl i64 %index1405, 3
  %14 = getelementptr i8, ptr %i.mp, i64 %.idx1805
...
begin_hunk_36_@dradbg:bb.a
  ...
  %n.vec1686 = and i64 %i.wz, 4294967292          ; 5 uses
  %15 = shl nuw nsw i64 %n.vec1686, 1
  %i.xa = shl nuw nsw i64 %n.vec1686, 1
...
vector.ph1684:                                    ; preds = %.preheader655.us
  %i.xp = add i64 %indvars.iv1066, %15
...
vector.body1688:                                  ; preds = %vector.body1688, %vector.ph1684
  %index1689 = phi i64 [ 0, %vector.ph1684 ], [ %index.next1706, %vector.body1688 ] ; 3 uses
  %16 = shl i64 %index1689, 1
  %i.xr = shl i64 %index1689, 1
  %offset.idx1691 = add i64 %indvars.iv1060, %i.xr ; 2 uses
  %.reass1882 = add i64 %16, %invariant.op1881    ; 2 uses
...
begin_hunk_38_@dradbg:bb.a
  ...
  %n.vec1771 = and i64 %i.aej, 4294967292         ; 5 uses
  %17 = shl nuw nsw i64 %n.vec1771, 1
  %i.aek = shl nuw nsw i64 %n.vec1771, 1
...
vector.ph1769:                                    ; preds = %.preheader.us
  %i.aeu = add i64 %indvars.iv1127, %17
  %invariant.op1885 = add i64 %indvars.iv1127, 1
  br label %vector.body1773

vector.body1773:                                  ; preds = %vector.body1773, %vector.ph1769
  %index1774 = phi i64 [ 0, %vector.ph1769 ], [ %index.next1790, %vector.body1773 ] ; 3 uses
  %18 = shl i64 %index1774, 1
  %.idx1808 = shl i64 %index1774, 3
  %gep1884 = getelementptr i8, ptr %invariant.gep1883, i64 %.idx1808
  %i.aev = getelementptr i8, ptr %gep1884, i64 4  ; 2 uses
  %wide.vec1777 = load <8 x float>, ptr %i.aev, align 4, !alias.scope !1242 ; 2 uses
  %.reass1886 = add i64 %18, %invariant.op1885    ; 2 uses
