...
.lr.ph1028.preheader.i:                           ; preds = %LitEnc_GetPriceMatched.exit888.i
  ...
  %xtraiter667 = and i64 %i.bfg, 3                ; 2 uses
  %lcmp.mod668.not = icmp eq i64 %xtraiter667, 0
  br i1 %lcmp.mod668.not, label %.lr.ph1028.i.prol.loopexit, label %.lr.ph1028.i.prol
...
.lr.ph1028.i.prol:                                ; preds = %.lr.ph1028.preheader.i, %.lr.ph1028.i.prol
  ...
  %prol.iter669 = phi i64 [ %prol.iter669.next, %.lr.ph1028.i.prol ], [ 0, %.lr.ph1028.preheader.i ]
  ...
  %prol.iter669.next = add i64 %prol.iter669, 1   ; 2 uses
  %prol.iter669.cmp.not = icmp eq i64 %prol.iter669.next, %xtraiter667
  br i1 %prol.iter669.cmp.not, label %.lr.ph1028.i.prol.loopexit, label %.lr.ph1028.i.prol, !llvm.loop !177
...
._crit_edge1029.i:                                ; preds = %.lr.ph1028.i.prol.loopexit, %.lr.ph1028.i, %LitEnc_GetPriceMatched.exit888.i
  ...
  %i.bgk = add i32 %11, %i.bea
  %i.bgl = add i32 %i.bgk, %i.bba                 ; 2 uses
  %i.bgm = zext i32 %i.bfc to i64
  %i.bgn = getelementptr inbounds nuw [48 x i8], ptr %i.dz, i64 %i.bgm ; 8 uses
  %i.bgo = load i32, ptr %i.bgn, align 4, !tbaa !157
  %i.bgp = icmp ult i32 %i.bgl, %i.bgo
  br i1 %i.bgp, label %bb.fv, label %bb.fw

bb.fv:                                            ; preds = %._crit_edge1029.i
  store i32 %i.bgl, ptr %i.bgn, align 4, !tbaa !157
  %i.bgq = getelementptr inbounds nuw i8, ptr %i.bgn, i64 24
  store i32 %i.bfb, ptr %i.bgq, align 4, !tbaa !148
  %i.bgr = getelementptr inbounds nuw i8, ptr %i.bgn, i64 28
  store i32 0, ptr %i.bgr, align 4, !tbaa !150
  %i.bgs = getelementptr inbounds nuw i8, ptr %i.bgn, i64 8
  store i32 1, ptr %i.bgs, align 4, !tbaa !158
  %i.bgt = getelementptr inbounds nuw i8, ptr %i.bgn, i64 12
  store i32 1, ptr %i.bgt, align 4, !tbaa !164
  %i.bgu = getelementptr inbounds nuw i8, ptr %i.bgn, i64 16
  store i32 %i.aku, ptr %i.bgu, align 4, !tbaa !166
  %i.bgv = getelementptr inbounds nuw i8, ptr %i.bgn, i64 20
  store i32 %i.bbc, ptr %i.bgv, align 4, !tbaa !167
  br label %bb.fw
...
bb.fx:                                            ; preds = %bb.fw
  %i.bgw = icmp ugt i32 %.1.i848.i, %.spec.select833.i
  br i1 %i.bgw, label %.preheader963.i, label %bb.fz

.preheader963.i:                                  ; preds = %bb.fx, %.preheader963.i
  %storemerge.i = phi i32 [ %i.bhb, %.preheader963.i ], [ 0, %bb.fx ] ; 2 uses
  %i.bgx = zext i32 %storemerge.i to i64          ; 2 uses
  %i.bgy = getelementptr inbounds nuw [4 x i8], ptr %i.do, i64 %i.bgx
  %i.bgz = load i32, ptr %i.bgy, align 4, !tbaa !4
  %i.bha = icmp ugt i32 %.spec.select833.i, %i.bgz
  %i.bhb = add i32 %storemerge.i, 2               ; 2 uses
  br i1 %i.bha, label %.preheader963.i, label %bb.fy, !llvm.loop !180

bb.fy:                                            ; preds = %.preheader963.i
  %i.bhc = getelementptr inbounds nuw [4 x i8], ptr %i.do, i64 %i.bgx
  store i32 %.spec.select833.i, ptr %i.bhc, align 4, !tbaa !4
  br label %bb.fz

bb.fz:                                            ; preds = %bb.fy, %bb.fx
  %.0900.i = phi i32 [ %i.bhb, %bb.fy ], [ %i.alb, %bb.fx ]
...
bb.ga:                                            ; preds = %bb.fz
  %i.bhd = zext nneg i16 %i.atq to i64
  %i.bhe = getelementptr inbounds nuw [4 x i8], ptr %i.ei, i64 %i.bhd
  %i.bhf = load i32, ptr %i.bhe, align 4, !tbaa !4
  %i.bhg = add i32 %i.bhf, %i.atn
  %i.bhh = add i32 %.0738.i, %i.aku
  %i.bhi = icmp ult i32 %.8.i, %i.bhh
  br i1 %i.bhi, label %.lr.ph1038.preheader.i, label %.preheader962.i

.lr.ph1038.preheader.i:                           ; preds = %bb.ga
  %i.bhj = zext i32 %.8.i to i64                  ; 4 uses
  ...
  %i.bhk = add i32 %umin454, %i.aku               ; 3 uses
  %i.bhl = zext i32 %i.bhk to i64                 ; 3 uses
  %i.bhm = sub nsw i64 %i.bhl, %i.bhj
  %xtraiter670 = and i64 %i.bhm, 3                ; 2 uses
  %lcmp.mod671.not = icmp eq i64 %xtraiter670, 0
  br i1 %lcmp.mod671.not, label %.lr.ph1038.i.prol.loopexit, label %.lr.ph1038.i.prol

.lr.ph1038.i.prol:                                ; preds = %.lr.ph1038.preheader.i, %.lr.ph1038.i.prol
  %indvars.iv1150.i.prol = phi i64 [ %indvars.iv.next1151.i.prol, %.lr.ph1038.i.prol ], [ %i.bhj, %.lr.ph1038.preheader.i ]
  %prol.iter672 = phi i64 [ %prol.iter672.next, %.lr.ph1038.i.prol ], [ 0, %.lr.ph1038.preheader.i ]
  %indvars.iv.next1151.i.prol = add nuw nsw i64 %indvars.iv1150.i.prol, 1 ; 3 uses
  %i.bhn = getelementptr inbounds nuw [48 x i8], ptr %i.dz, i64 %indvars.iv.next1151.i.prol
  store i32 1073741824, ptr %i.bhn, align 4, !tbaa !157
  %prol.iter672.next = add i64 %prol.iter672, 1   ; 2 uses
  %prol.iter672.cmp.not = icmp eq i64 %prol.iter672.next, %xtraiter670
  br i1 %prol.iter672.cmp.not, label %.lr.ph1038.i.prol.loopexit, label %.lr.ph1038.i.prol, !llvm.loop !181

.lr.ph1038.i.prol.loopexit:                       ; preds = %.lr.ph1038.i.prol, %.lr.ph1038.preheader.i
  %indvars.iv1150.i.unr = phi i64 [ %i.bhj, %.lr.ph1038.preheader.i ], [ %indvars.iv.next1151.i.prol, %.lr.ph1038.i.prol ]
  %i.bho = sub nsw i64 %i.bhj, %i.bhl
  %i.bhp = icmp ugt i64 %i.bho, -4
  br i1 %i.bhp, label %.preheader962.i, label %.lr.ph1038.i

.preheader962.i:                                  ; preds = %.lr.ph1038.i.prol.loopexit, %.lr.ph1038.i, %bb.ga
  %.9.lcssa.i = phi i32 [ %.8.i, %bb.ga ], [ %i.bhk, %.lr.ph1038.i ], [ %i.bhk, %.lr.ph1038.i.prol.loopexit ]
  br label %bb.gb
...
.lr.ph1038.i:                                     ; preds = %.lr.ph1038.i.prol.loopexit, %.lr.ph1038.i
  ...
  %i.bhr = getelementptr inbounds nuw i8, ptr %i.bhq, i64 48
  store i32 1073741824, ptr %i.bhr, align 4, !tbaa !157
  %i.bhs = getelementptr inbounds nuw [48 x i8], ptr %i.dz, i64 %indvars.iv1150.i
  %i.bht = getelementptr inbounds nuw i8, ptr %i.bhs, i64 96
  store i32 1073741824, ptr %i.bht, align 4, !tbaa !157
  %i.bhu = getelementptr inbounds nuw [48 x i8], ptr %i.dz, i64 %indvars.iv1150.i
  %i.bhv = getelementptr inbounds nuw i8, ptr %i.bhu, i64 144
  store i32 1073741824, ptr %i.bhv, align 4, !tbaa !157
  %indvars.iv.next1151.i.3 = add nuw nsw i64 %indvars.iv1150.i, 4 ; 3 uses
  %i.bhw = getelementptr inbounds nuw [48 x i8], ptr %i.dz, i64 %indvars.iv.next1151.i.3
  store i32 1073741824, ptr %i.bhw, align 4, !tbaa !157
  %exitcond455.not.3 = icmp eq i64 %indvars.iv.next1151.i.3, %i.bhl
  br i1 %exitcond455.not.3, label %.preheader962.i, label %.lr.ph1038.i, !llvm.loop !182

bb.gb:                                            ; preds = %bb.gb, %.preheader962.i
  %.0726.i = phi i32 [ %i.bib, %bb.gb ], [ 0, %.preheader962.i ] ; 4 uses
  %i.bhx = zext i32 %.0726.i to i64
  %i.bhy = getelementptr inbounds nuw [4 x i8], ptr %i.do, i64 %i.bhx
  %i.bhz = load i32, ptr %i.bhy, align 4, !tbaa !4
  %i.bia = icmp ugt i32 %.2749.i, %i.bhz
  %i.bib = add i32 %.0726.i, 2
  br i1 %i.bia, label %bb.gb, label %bb.gc, !llvm.loop !183

bb.gc:                                            ; preds = %bb.gb
  %i.bic = or disjoint i32 %.0726.i, 1
  %i.bid = zext i32 %i.bic to i64
  %i.bie = getelementptr inbounds nuw [4 x i8], ptr %i.do, i64 %i.bid
  %i.bif = load i32, ptr %i.bie, align 4, !tbaa !4 ; 3 uses
  %notsub822.i = add i32 %i.bif, -524288
  %isneg.inv823.i = icmp slt i32 %notsub822.i, 0
  %i.big = select i1 %isneg.inv823.i, i32 6, i32 18 ; 2 uses
  %i.bih = lshr i32 %i.bif, %i.big
  %i.bii = zext nneg i32 %i.bih to i64
  %i.bij = getelementptr inbounds nuw i8, ptr %i.ew, i64 %i.bii
  %i.bik = load i8, ptr %i.bij, align 1, !tbaa !21
  %i.bil = zext i8 %i.bik to i32
  %i.bim = shl nuw nsw i32 %i.big, 1
  %i.bin = add nuw nsw i32 %i.bim, %i.bil
  %i.bio = getelementptr inbounds nuw [1088 x i8], ptr %i.ev, i64 %i.aqq
  %i.bip = getelementptr inbounds nuw [4 x i8], ptr @kMatchNextStates, i64 %i.aqo
  %i.biq = add i32 %i.aux, 1
  %i.bir = add i32 %i.biq, %.2749.i
  %umin456 = tail call i64 @llvm.umin.i64(i64 %i.ayh, i64 %i.akv)
  br label %bb.gd

bb.gd:                                            ; preds = %.thread929.i, %bb.gc
  %indvars.iv458 = phi i32 [ %indvars.iv.next459, %.thread929.i ], [ %i.bir, %bb.gc ] ; 2 uses
  ...
  %.0722.i = phi i32 [ %.3725936.i, %.thread929.i ], [ %i.bif, %bb.gc ] ; 7 uses
  %.0717.i = phi i32 [ %.4721937.i, %.thread929.i ], [ %i.bin, %bb.gc ] ; 3 uses
  %.10.i = phi i32 [ %.14938.i, %.thread929.i ], [ %.9.lcssa.i, %bb.gc ] ; 5 uses
  %i.bis = zext i32 %indvars.iv458 to i64
  %umin460 = tail call i64 @llvm.umin.i64(i64 %umin456, i64 %i.bis)
  %indvars.iv1155.i = add i32 %indvars.iv1155.in.i, 1 ; 6 uses
  %i.bit = zext i32 %indvars.iv1155.i to i64
  %i.biu = add i32 %indvars.iv1155.in.i, -2       ; 2 uses
  %i.biv = zext i32 %i.biu to i64
  %i.biw = getelementptr inbounds nuw [4 x i8], ptr %i.bio, i64 %i.biv
  %i.bix = load i32, ptr %i.biw, align 4, !tbaa !4
  %i.biy = add i32 %i.bhg, %i.bix
  %i.biz = icmp ult i32 %indvars.iv1155.in.i, 5
  %i.bja = select i1 %i.biz, i32 %i.biu, i32 3
  %i.bjb = icmp ult i32 %.0722.i, 128
  %i.bjc = zext i32 %i.bja to i64                 ; 2 uses
  br i1 %i.bjb, label %bb.ge, label %bb.gf

bb.ge:                                            ; preds = %bb.gd
  %i.bjd = getelementptr inbounds nuw [512 x i8], ptr %i.ez, i64 %i.bjc
  %i.bje = zext nneg i32 %.0722.i to i64
  %i.bjf = getelementptr inbounds nuw [4 x i8], ptr %i.bjd, i64 %i.bje
  %i.bjg = load i32, ptr %i.bjf, align 4, !tbaa !4
  br label %bb.gg

bb.gf:                                            ; preds = %bb.gd
  %i.bjh = getelementptr inbounds nuw [256 x i8], ptr %i.ey, i64 %i.bjc
  %i.bji = zext nneg i32 %.0717.i to i64
  %i.bjj = getelementptr inbounds nuw [4 x i8], ptr %i.bjh, i64 %i.bji
  %i.bjk = load i32, ptr %i.bjj, align 4, !tbaa !4
  %i.bjl = and i32 %.0722.i, 15
  %i.bjm = zext nneg i32 %i.bjl to i64
  %i.bjn = getelementptr inbounds nuw [4 x i8], ptr %i.ex, i64 %i.bjm
  %i.bjo = load i32, ptr %i.bjn, align 4, !tbaa !4
  %i.bjp = add i32 %i.bjo, %i.bjk
  br label %bb.gg

bb.gg:                                            ; preds = %bb.gf, %bb.ge
  %.pn824.i = phi i32 [ %i.bjg, %bb.ge ], [ %i.bjp, %bb.gf ]
  %.0711.i = add i32 %i.biy, %.pn824.i            ; 3 uses
  %i.bjq = add i32 %indvars.iv1155.in.i, %i.aku   ; 2 uses
  %i.bjr = zext i32 %i.bjq to i64
  %i.bjs = getelementptr inbounds nuw [48 x i8], ptr %i.dz, i64 %i.bjr ; 5 uses
  %i.bjt = load i32, ptr %i.bjs, align 4, !tbaa !157
  %i.bju = icmp ult i32 %.0711.i, %i.bjt
  br i1 %i.bju, label %bb.gh, label %bb.gi

bb.gh:                                            ; preds = %bb.gg
  store i32 %.0711.i, ptr %i.bjs, align 4, !tbaa !157
  %i.bjv = getelementptr inbounds nuw i8, ptr %i.bjs, i64 24
  store i32 %i.aku, ptr %i.bjv, align 4, !tbaa !148
  %i.bjw = add i32 %.0722.i, 4
  %i.bjx = getelementptr inbounds nuw i8, ptr %i.bjs, i64 28
  store i32 %i.bjw, ptr %i.bjx, align 4, !tbaa !150
end_hunk_0
