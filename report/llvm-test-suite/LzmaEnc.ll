...
.critedge.us.1.i:                                 ; preds = %bb.ac, %.critedge.us.1.split.loop.exit319.i
  ...
  br i1 %.not164.us.1.i, label %bb.ad, label %.split232.us.i
...
.critedge.us.2.i:                                 ; preds = %bb.af, %.critedge.us.2.split.loop.exit321.i
  ...
  br i1 %.not164.us.2.i, label %bb.ag, label %.split232.us.i
...
.critedge.us.3.i:                                 ; preds = %bb.ai, %.critedge.us.3.split.loop.exit323.i
  ...
  br i1 %.not164.us.3.i, label %bb.aj, label %.split232.us.i
...
.split232.us.i:                                   ; preds = %.critedge.us.3.i, %.critedge.us.2.i, %.critedge.us.1.i, %.critedge.us.i
  ...
  %4 = add i32 %.us-phi233.i, -1                  ; 2 uses
...
.split235.us.i:                                   ; preds = %bb.ap, %bb.ao, %.split.3.i, %bb.aj, %bb.ah, %.split.us.3.i
  %.us-phi236.i = phi i32 [ %spec.select.us.3.i, %bb.aj ], [ %.2152.ph.us.2.i, %bb.ah ], [ %.2152.ph.us.2.i, %.split.us.3.i ], [ %.2152.ph.2.i, %bb.ao ], [ %.2152.ph.2.i, %.split.3.i ], [ 2, %bb.ap ] ; 6 uses
  %.us-phi237.i = phi i32 [ %spec.select165.us.3.i, %bb.aj ], [ %.2147.ph.us.2.i, %bb.ah ], [ %.2147.ph.us.2.i, %.split.us.3.i ], [ %.2147.ph.2.i, %bb.ao ], [ %.2147.ph.2.i, %.split.3.i ], [ %spec.select165.3.i, %bb.ap ]
...
MovePos.exit.sink.split.i:                        ; preds = %.preheader.i, %.preheader.1.i, %.preheader.2.i, %.preheader.3.i, %.split255.us.i, %MovePos.exit177.i, %bb.aq, %.split232.us.i
  %.1342 = phi i32 [ %.us-phi237.i, %MovePos.exit177.i ], [ %i.ss, %.split255.us.i ], [ %i.lx, %bb.aq ], [ %.us-phi.i, %.split232.us.i ], [ 2, %.preheader.2.i ], [ 1, %.preheader.1.i ], [ 0, %.preheader.i ], [ 3, %.preheader.3.i ]
  %.sink328.i = phi i32 [ %5, %MovePos.exit177.i ], [ %i.st, %.split255.us.i ], [ %i.ly, %bb.aq ], [ %4, %.split232.us.i ], [ 1, %.preheader.2.i ], [ 1, %.preheader.1.i ], [ 1, %.preheader.i ], [ 1, %.preheader.3.i ] ; 2 uses
...
GetOptimumFast.exit.thread:                       ; preds = %.split255.us.i, %.split232.us.i
  %.0.ph = phi i32 [ %.us-phi.i, %.split232.us.i ], [ %i.ss, %.split255.us.i ]
  %6 = phi i1 [ true, %.split232.us.i ], [ false, %.split255.us.i ]
...
bb.hf:                                            ; preds = %GetOptimumFast.exit.thread, %GetOptimumFast.exit
  ...
  %.0205354 = phi i32 [ %.0205.ph, %GetOptimumFast.exit.thread ], [ %.0205, %GetOptimumFast.exit ] ; 6 uses
  %.0352 = phi i32 [ %.0.ph, %GetOptimumFast.exit.thread ], [ %.0, %GetOptimumFast.exit ] ; 8 uses
