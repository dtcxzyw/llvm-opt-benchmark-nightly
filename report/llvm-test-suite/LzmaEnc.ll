...
bb.dt:                                            ; preds = %bb.dr
  ...
  %i.ain = select i1 %isneg.inv.i, i32 6, i32 18  ; 2 uses
  ...
  %4 = zext i8 %i.air to i32
  %5 = shl nuw nsw i32 %i.ain, 1
  ...
  %i.aiy = getelementptr inbounds nuw [4 x i8], ptr %i.aix, i64 %7
...
begin_hunk_1_@LzmaEnc_CodeOneBlock:bb.a
  ...
  %i.bii = select i1 %isneg.inv823.i, i32 6, i32 18 ; 2 uses
  ...
  %8 = shl nuw nsw i32 %i.bii, 1
  %i.bio = add nuw nsw i32 %8, %i.bin
...
bb.gq:                                            ; preds = %bb.gp
  ...
  %i.bpy = select i1 %isneg.inv826.i, i32 6, i32 18 ; 2 uses
  ...
  %9 = shl nuw nsw i32 %i.bpy, 1
  %i.bqe = add nuw nsw i32 %9, %i.bqd
...
bb.ig:                                            ; preds = %RangeEnc_EncodeBit.exit299
  ...
  %i.cbb = select i1 %isneg.inv, i32 6, i32 18    ; 2 uses
  ...
  %10 = shl nuw nsw i32 %i.cbb, 1
  %i.cbh = add nuw nsw i32 %10, %i.cbg
  br label %bb.ih
