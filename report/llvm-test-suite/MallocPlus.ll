...
begin_hunk_0_@_ZN10MallocPlus18memory_reorder_allEPi:bb.a
  ...
  %i.ak = load i64, ptr %i.aj, align 8, !tbaa !14 ; 11 uses
...
bb.i:                                             ; preds = %bb.h
  %i.aq = sub nuw i64 %i.ak, %i.ao                ; 5 uses
  ...
  %4 = sub nuw nsw i64 2305843009213693951, %i.ao
...
bb.k:                                             ; preds = %bb.i
  %5 = icmp ugt i64 %i.ak, 2305843009213693951
