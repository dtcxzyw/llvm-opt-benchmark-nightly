...
vector.body230:                                   ; preds = %vector.body230, %do_out_error.exit.i
  ...
  %1 = shufflevector <2 x double> %i.aav, <2 x double> %i.abn, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.age = shufflevector <2 x double> %i.ach, <2 x double> %i.adb, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %2 = shufflevector <4 x double> %1, <4 x double> %i.age, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %3 = shufflevector <2 x double> %i.aar, <2 x double> %i.abh, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.agf = shufflevector <2 x double> %i.acb, <2 x double> %i.acv, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.agg = shufflevector <4 x double> %3, <4 x double> %i.agf, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %4 = fadd <8 x double> %2, %i.agg
  %5 = shufflevector <2 x double> %i.adv, <2 x double> %i.aep, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.agh = shufflevector <2 x double> %i.afj, <2 x double> %i.agd, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %6 = shufflevector <4 x double> %5, <4 x double> %i.agh, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %7 = shufflevector <2 x double> %i.adp, <2 x double> %i.aej, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.agi = shufflevector <2 x double> %i.afd, <2 x double> %i.afx, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.agj = shufflevector <4 x double> %7, <4 x double> %i.agi, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %8 = fadd <8 x double> %6, %i.agj
  %interleaved.vec = shufflevector <8 x double> %4, <8 x double> %8, <16 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14, i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15>
  ...
  %9 = shufflevector <2 x double> %i.aar, <2 x double> %i.abh, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.agq = shufflevector <2 x double> %i.acb, <2 x double> %i.acv, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %10 = shufflevector <4 x double> %9, <4 x double> %i.agq, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %11 = shufflevector <2 x double> %i.aaz, <2 x double> %i.abt, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.agr = shufflevector <2 x double> %i.acn, <2 x double> %i.adh, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.ags = shufflevector <4 x double> %11, <4 x double> %i.agr, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %12 = fadd <8 x double> %10, %i.ags
  %13 = shufflevector <2 x double> %i.adp, <2 x double> %i.aej, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.agt = shufflevector <2 x double> %i.afd, <2 x double> %i.afx, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %14 = shufflevector <4 x double> %13, <4 x double> %i.agt, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %15 = shufflevector <2 x double> %i.aeb, <2 x double> %i.aev, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.agu = shufflevector <2 x double> %i.afp, <2 x double> %i.agp, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.agv = shufflevector <4 x double> %15, <4 x double> %i.agu, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %16 = fadd <8 x double> %14, %i.agv
  %interleaved.vec233 = shufflevector <8 x double> %12, <8 x double> %16, <16 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14, i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15>
