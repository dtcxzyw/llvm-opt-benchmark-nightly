...
.preheader.thread.i:                              ; preds = %.lr.ph.i
  ...
  %.not2231.i = icmp eq i32 %i.b, 0
  br i1 %.not2231.i, label %LoadNumArrayWithRand.exit.thread, label %.lr.ph21.us.i.preheader

.lr.ph21.us.i.preheader:                          ; preds = %.preheader.thread.i
  ...
  br label %.lr.ph21.us.i

LoadNumArrayWithRand.exit.thread:                 ; preds = %.preheader.thread.i
  %i.e = tail call i64 (...) @StartStopwatch() #11
  br label %.lr.ph

.lr.ph21.us.i:                                    ; preds = %.lr.ph21.us.i.preheader, %..loopexit_crit_edge.us.i
  %indvar = phi i64 [ 0, %.lr.ph21.us.i.preheader ], [ %indvar.next, %..loopexit_crit_edge.us.i ] ; 2 uses
  %i.f = phi i32 [ %i.b, %.lr.ph21.us.i.preheader ], [ %i.ak, %..loopexit_crit_edge.us.i ]
  %.023.us.i = phi ptr [ %0, %.lr.ph21.us.i.preheader ], [ %i.g, %..loopexit_crit_edge.us.i ]
  %i.g = getelementptr inbounds nuw [8 x i8], ptr %.023.us.i, i64 %1 ; 7 uses
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph21.us.i
  %i.h = mul i64 %i.d, %indvar
  %i.i = add i64 %i.c, %i.h
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %wide.load = load <2 x i64>, ptr %i.j, align 8, !tbaa !15
  %wide.load42 = load <2 x i64>, ptr %i.k, align 8, !tbaa !15
  %i.l = getelementptr inbounds nuw [8 x i8], ptr %i.g, i64 %index ; 2 uses
  %i.m = getelementptr inbounds nuw i8, ptr %i.l, i64 16
  store <2 x i64> %wide.load, ptr %i.l, align 8, !tbaa !15
  store <2 x i64> %wide.load42, ptr %i.m, align 8, !tbaa !15
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph21.us.i, %middle.block
  %.120.us.i.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %.lr.ph21.us.i ], [ %n.vec, %middle.block ] ; 3 uses
  br i1 %lcmp.mod.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol

scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  %.120.us.i.prol = phi i64 [ %i.r, %scalar.ph.prol ], [ %.120.us.i.ph, %scalar.ph.preheader ] ; 3 uses
  %prol.iter = phi i64 [ %prol.iter.next, %scalar.ph.prol ], [ 0, %scalar.ph.preheader ]
  %i.o = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %.120.us.i.prol
  %i.p = load i64, ptr %i.o, align 8, !tbaa !15
  %i.q = getelementptr inbounds nuw [8 x i8], ptr %i.g, i64 %.120.us.i.prol
  store i64 %i.p, ptr %i.q, align 8, !tbaa !15
  %i.r = add nuw nsw i64 %.120.us.i.prol, 1       ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !22

scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  %.120.us.i.unr = phi i64 [ %.120.us.i.ph, %scalar.ph.preheader ], [ %i.r, %scalar.ph.prol ]
  %i.s = sub i64 %.120.us.i.ph, %1
  %i.t = icmp ugt i64 %i.s, -4
  br i1 %i.t, label %..loopexit_crit_edge.us.i, label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  %.120.us.i = phi i64 [ %i.aj, %scalar.ph ], [ %.120.us.i.unr, %scalar.ph.prol.loopexit ] ; 6 uses
  %i.u = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %.120.us.i
  %i.v = load i64, ptr %i.u, align 8, !tbaa !15
  %i.w = getelementptr inbounds nuw [8 x i8], ptr %i.g, i64 %.120.us.i
  store i64 %i.v, ptr %i.w, align 8, !tbaa !15
  %i.x = add nuw nsw i64 %.120.us.i, 1            ; 2 uses
  %i.y = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %i.x
  %i.z = load i64, ptr %i.y, align 8, !tbaa !15
  %i.aa = getelementptr inbounds nuw [8 x i8], ptr %i.g, i64 %i.x
  store i64 %i.z, ptr %i.aa, align 8, !tbaa !15
  %i.ab = add nuw nsw i64 %.120.us.i, 2           ; 2 uses
  ...
  %i.af = add nuw nsw i64 %.120.us.i, 3           ; 2 uses
  ...
  %i.aj = add nuw nsw i64 %.120.us.i, 4           ; 2 uses
  %exitcond28.not.i.3 = icmp eq i64 %i.aj, %1
  br i1 %exitcond28.not.i.3, label %..loopexit_crit_edge.us.i, label %scalar.ph, !llvm.loop !24

..loopexit_crit_edge.us.i:                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  %i.ak = add i32 %i.f, -1                        ; 2 uses
  %.not.us.i = icmp eq i32 %i.ak, 0
  %indvar.next = add i64 %indvar, 1
  br i1 %.not.us.i, label %LoadNumArrayWithRand.exit, label %.lr.ph21.us.i, !llvm.loop !25

.lr.ph.i:                                         ; preds = %bb.a, %.lr.ph.i
  %.01519.i = phi i64 [ %i.ao, %.lr.ph.i ], [ 0, %bb.a ] ; 2 uses
  %i.al = tail call i32 @randnum(i32 noundef 0) #11
  %i.am = sext i32 %i.al to i64
  %i.an = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %.01519.i
  store i64 %i.am, ptr %i.an, align 8, !tbaa !15
  %i.ao = add nuw i64 %.01519.i, 1                ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.ao, %1
  br i1 %exitcond.not.i, label %.preheader.thread.i, label %.lr.ph.i, !llvm.loop !26

LoadNumArrayWithRand.exit:                        ; preds = %..loopexit_crit_edge.us.i, %bb.a
...
.lr.ph.split:                                     ; preds = %.lr.ph, %NumHeapSort.exit.loopexit
  %.012 = phi i64 [ %i.by, %NumHeapSort.exit.loopexit ], [ 0, %.lr.ph ] ; 2 uses
  %i.av = mul i64 %.012, %1
...
NumSift.exit.i:                                   ; preds = %bb.e, %.lr.ph.i11
  ...
  br i1 %.not.i, label %.lr.ph31.i.preheader, label %.lr.ph.i11, !llvm.loop !28
...
NumHeapSort.exit.loopexit:                        ; preds = %NumSift.exit26.i
  %i.by = add nuw nsw i64 %.012, 1                ; 2 uses
...
.preheader73.i:                                   ; preds = %._crit_edge.i
  %i.v = icmp samesign ult i32 %1, 2              ; 2 uses
  %.not98.i = icmp eq i64 %2, 0
  %or.cond.i = or i1 %i.v, %.not98.i
  br i1 %or.cond.i, label %._crit_edge84.i, label %.lr.ph79.us.i.preheader

.lr.ph79.us.i.preheader:                          ; preds = %.preheader73.i
  %i.w = add i64 %2, -1                           ; 2 uses
  %i.x = add i64 %2, 100
  %min.iters.check = icmp ult i64 %2, 4
  %i.y = and i64 %i.w, 4294967295
  %i.z = icmp eq i64 %i.y, 4294967295
  %i.aa = icmp ugt i64 %i.w, 4294967295
  %i.ab = or i1 %i.z, %i.aa
  %min.iters.check57 = icmp ult i64 %2, 32
  %n.mod.vf = and i64 %2, 28
  %n.vec = and i64 %2, 8589934560                 ; 5 uses
  %i.ac = trunc i64 %n.vec to i32
