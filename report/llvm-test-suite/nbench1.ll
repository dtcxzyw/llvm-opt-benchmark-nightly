...
.lr.ph79.i.preheader:                             ; preds = %.preheader73.i
  ...
  %min.iters.check59 = icmp ult i64 %2, 32
  %i.ad = and i64 %2, 28
  %n.vec = and i64 %2, 8589934560                 ; 4 uses
  %cmp.n = icmp eq i64 %2, %n.vec
  %min.epilog.iters.check = icmp eq i64 %i.ad, 0
  %n.vec61 = and i64 %2, 8589934588               ; 3 uses
  %cmp.n65 = icmp eq i64 %2, %n.vec61
  br label %iter.check
...
vector.main.loop.iter.check:                      ; preds = %vector.scevcheck
  br i1 %min.iters.check59, label %vec.epilog.ph, label %vector.body
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.ao = getelementptr inbounds nuw i8, ptr %0, i64 %index62
  %wide.load63 = load <4 x i8>, ptr %i.ao, align 1, !tbaa !32
  %i.ap = getelementptr inbounds nuw i8, ptr %i.af, i64 %index62
  store <4 x i8> %wide.load63, ptr %i.ap, align 1, !tbaa !32
  %index.next64 = add nuw i64 %index62, 4         ; 2 uses
  %i.aq = icmp eq i64 %index.next64, %n.vec61
  br i1 %i.aq, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !37

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  br i1 %cmp.n65, label %._crit_edge80.i, label %vec.epilog.scalar.ph.preheader

vec.epilog.scalar.ph.preheader:                   ; preds = %vector.scevcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv.i.ph = phi i64 [ 0, %vector.scevcheck ], [ 0, %iter.check ], [ %n.vec, %vec.epilog.iter.check ], [ %n.vec61, %vec.epilog.middle.block ]
...
.lr.ph91.i.preheader.preheader:                   ; preds = %.preheader.i
  %3 = shl i64 %.028, 3
  %4 = add i64 %3, 8
  %min.iters.check71 = icmp ult i64 %indvars.iv, 10
  %i.bk = and i64 %.028, 4294967295
  %i.bl = icmp eq i64 %i.bk, 4294967295
  %i.bm = icmp ugt i64 %.028, 4294967295
  %i.bn = or i1 %i.bl, %i.bm
  %n.vec73 = and i64 %indvars.iv, -4              ; 3 uses
  %cmp.n80 = icmp eq i64 %indvars.iv, %n.vec73
...
.lr.ph91.i.preheader:                             ; preds = %.lr.ph91.i.preheader.preheader, %._crit_edge92.i
  %indvar68 = phi i64 [ 0, %.lr.ph91.i.preheader.preheader ], [ %indvar.next69, %._crit_edge92.i ] ; 2 uses
  ...
  br i1 %min.iters.check71, label %.lr.ph91.i.preheader145, label %vector.scevcheck66

vector.scevcheck66:                               ; preds = %.lr.ph91.i.preheader
  %6 = add i64 %indvar68, 1
  %7 = mul i64 %4, %6
  %8 = add i64 %7, -1
  %diff.check70 = icmp ult i64 %8, 31
  %or.cond138 = select i1 %i.bn, i1 true, i1 %diff.check70
  br i1 %or.cond138, label %.lr.ph91.i.preheader145, label %vector.body74

vector.body74:                                    ; preds = %vector.scevcheck66, %vector.body74
  %index75 = phi i64 [ %index.next78, %vector.body74 ], [ 0, %vector.scevcheck66 ] ; 3 uses
  %i.cq = getelementptr inbounds nuw [8 x i8], ptr %i.ba, i64 %index75 ; 2 uses
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cq, i64 16
  %wide.load76 = load <2 x i64>, ptr %i.cq, align 8, !tbaa !15
  %wide.load77 = load <2 x i64>, ptr %i.cr, align 8, !tbaa !15
  %i.cs = getelementptr inbounds nuw [8 x i8], ptr %5, i64 %index75 ; 2 uses
  %i.ct = getelementptr inbounds nuw i8, ptr %i.cs, i64 16
  store <2 x i64> %wide.load76, ptr %i.cs, align 8, !tbaa !15
  store <2 x i64> %wide.load77, ptr %i.ct, align 8, !tbaa !15
  %index.next78 = add nuw i64 %index75, 4         ; 2 uses
  %i.cu = icmp eq i64 %index.next78, %n.vec73
  br i1 %i.cu, label %middle.block79, label %vector.body74, !llvm.loop !42

middle.block79:                                   ; preds = %vector.body74
  br i1 %cmp.n80, label %._crit_edge92.i, label %.lr.ph91.i.preheader145

.lr.ph91.i.preheader145:                          ; preds = %vector.scevcheck66, %.lr.ph91.i.preheader, %middle.block79
  %indvars.iv40.ph = phi i64 [ 0, %vector.scevcheck66 ], [ 0, %.lr.ph91.i.preheader ], [ %n.vec73, %middle.block79 ]
  br label %.lr.ph91.i

.lr.ph91.i:                                       ; preds = %.lr.ph91.i.preheader145, %.lr.ph91.i
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %.lr.ph91.i ], [ %indvars.iv40.ph, %.lr.ph91.i.preheader145 ] ; 3 uses
...
._crit_edge92.i:                                  ; preds = %.lr.ph91.i, %middle.block79
...
.lr.ph.split.preheader:                           ; preds = %.lr.ph
  %min.iters.check111 = icmp ult i64 %.028, 4     ; 2 uses
  %n.vec127 = and i64 %.028, -4                   ; 3 uses
  %i.dg = or disjoint i64 %n.vec127, 1
  %cmp.n136 = icmp eq i64 %.028, %n.vec127
  %n.vec113 = and i64 %.028, -4                   ; 3 uses
  %i.dh = or disjoint i64 %n.vec113, 1
  %cmp.n122 = icmp eq i64 %.028, %n.vec113
...
bb.e:                                             ; preds = %.preheader.i19, %stradjust.exit49.i
  %indvar82 = phi i64 [ 0, %.preheader.i19 ], [ %indvar.next83, %stradjust.exit49.i ] ; 6 uses
...
.lr.ph.split.i.i.preheader:                       ; preds = %.lr.ph.i.i
  br i1 %min.iters.check111, label %.lr.ph.split.i.i.preheader143, label %vector.ph126

vector.ph126:                                     ; preds = %.lr.ph.split.i.i.preheader
  %broadcast.splatinsert128 = insertelement <2 x i64> poison, i64 %i.en, i64 0
...
vector.body130:                                   ; preds = %vector.body130, %vector.ph126
  ...
  %i.eo = getelementptr inbounds nuw [8 x i8], ptr %.01533, i64 %index131 ; 2 uses
  %i.ep = getelementptr inbounds nuw i8, ptr %i.eo, i64 8 ; 2 uses
  %i.eq = getelementptr inbounds nuw i8, ptr %i.eo, i64 24 ; 2 uses
  %wide.load132 = load <2 x i64>, ptr %i.ep, align 8, !tbaa !15
  %wide.load133 = load <2 x i64>, ptr %i.eq, align 8, !tbaa !15
  %i.er = add <2 x i64> %wide.load132, %broadcast.splat129
  %i.es = add <2 x i64> %wide.load133, %broadcast.splat129
  ...
  %i.et = icmp eq i64 %index.next134, %n.vec127
  br i1 %i.et, label %middle.block135, label %vector.body130, !llvm.loop !47

middle.block135:                                  ; preds = %vector.body130
  br i1 %cmp.n136, label %stradjust.exit.i, label %.lr.ph.split.i.i.preheader143

.lr.ph.split.i.i.preheader143:                    ; preds = %.lr.ph.split.i.i.preheader, %middle.block135
  %.046.i.i.ph = phi i64 [ 1, %.lr.ph.split.i.i.preheader ], [ %i.dg, %middle.block135 ]
  br label %.lr.ph.split.i.i

.lr.ph.split.us.i.i.preheader:                    ; preds = %.lr.ph.i.i
  br i1 %min.iters.check111, label %.lr.ph.split.us.i.i.preheader142, label %vector.ph112

vector.ph112:                                     ; preds = %.lr.ph.split.us.i.i.preheader
  %broadcast.splatinsert114 = insertelement <2 x i64> poison, i64 %i.en, i64 0
...
vector.body116:                                   ; preds = %vector.body116, %vector.ph112
  ...
  %i.eu = getelementptr inbounds nuw [8 x i8], ptr %.01533, i64 %index117 ; 2 uses
  %i.ev = getelementptr inbounds nuw i8, ptr %i.eu, i64 8 ; 2 uses
  %i.ew = getelementptr inbounds nuw i8, ptr %i.eu, i64 24 ; 2 uses
  %wide.load118 = load <2 x i64>, ptr %i.ev, align 8, !tbaa !15
  %wide.load119 = load <2 x i64>, ptr %i.ew, align 8, !tbaa !15
  %i.ex = sub <2 x i64> %wide.load118, %broadcast.splat115
  %i.ey = sub <2 x i64> %wide.load119, %broadcast.splat115
  ...
  %i.ez = icmp eq i64 %index.next120, %n.vec113
  br i1 %i.ez, label %middle.block121, label %vector.body116, !llvm.loop !48

middle.block121:                                  ; preds = %vector.body116
  br i1 %cmp.n122, label %stradjust.exit.i, label %.lr.ph.split.us.i.i.preheader142

.lr.ph.split.us.i.i.preheader142:                 ; preds = %.lr.ph.split.us.i.i.preheader, %middle.block121
  %.046.us.i.i.ph = phi i64 [ 1, %.lr.ph.split.us.i.i.preheader ], [ %i.dh, %middle.block121 ]
  br label %.lr.ph.split.us.i.i

.lr.ph.split.us.i.i:                              ; preds = %.lr.ph.split.us.i.i.preheader142, %.lr.ph.split.us.i.i
  %.046.us.i.i = phi i64 [ %.0.us.i.i, %.lr.ph.split.us.i.i ], [ %.046.us.i.i.ph, %.lr.ph.split.us.i.i.preheader142 ] ; 3 uses
...
.lr.ph.split.i.i:                                 ; preds = %.lr.ph.split.i.i.preheader143, %.lr.ph.split.i.i
  %.046.i.i = phi i64 [ %.0.i.i, %.lr.ph.split.i.i ], [ %.046.i.i.ph, %.lr.ph.split.i.i.preheader143 ] ; 3 uses
...
stradjust.exit.i:                                 ; preds = %.lr.ph.split.i.i, %.lr.ph.split.us.i.i, %middle.block135, %middle.block121, %bb.e
