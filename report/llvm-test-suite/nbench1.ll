...
begin_hunk_0_@DoAssignIteration:bb.a
  ...
  %i.qk = getelementptr [2 x i8], ptr %i.a, i64 %index25 ; 3 uses
  %i.ql = getelementptr i8, ptr %i.qk, i64 16
...
pred.store.if29:                                  ; preds = %pred.store.continue
  %i.qs = getelementptr [2 x i8], ptr %i.a, i64 %i.nx
...
pred.store.if31:                                  ; preds = %pred.store.continue30
  %i.qu = getelementptr [2 x i8], ptr %i.a, i64 %i.ny
...
pred.store.if33:                                  ; preds = %pred.store.continue32
  %i.qw = getelementptr [2 x i8], ptr %i.a, i64 %i.nz
...
pred.store.if35:                                  ; preds = %pred.store.continue34
  %i.qy = getelementptr [2 x i8], ptr %i.a, i64 %i.oa
...
pred.store.if37:                                  ; preds = %pred.store.continue36
  %i.ra = getelementptr [2 x i8], ptr %i.a, i64 %i.ob
...
pred.store.if39:                                  ; preds = %pred.store.continue38
  %i.rc = getelementptr [2 x i8], ptr %i.a, i64 %i.oc
...
pred.store.if41:                                  ; preds = %pred.store.continue40
  %i.re = getelementptr [2 x i8], ptr %i.a, i64 %i.od
...
pred.store.if43:                                  ; preds = %pred.store.continue42
  %i.rg = getelementptr [2 x i8], ptr %i.a, i64 %i.oe
...
pred.store.if45:                                  ; preds = %pred.store.continue44
  %i.ri = getelementptr [2 x i8], ptr %i.a, i64 %i.of
...
pred.store.if47:                                  ; preds = %pred.store.continue46
  %i.rk = getelementptr [2 x i8], ptr %i.a, i64 %i.og
...
pred.store.if49:                                  ; preds = %pred.store.continue48
  %i.rm = getelementptr [2 x i8], ptr %i.a, i64 %i.oh
...
pred.store.if51:                                  ; preds = %pred.store.continue50
  %i.ro = getelementptr [2 x i8], ptr %i.a, i64 %i.oi
...
pred.store.if53:                                  ; preds = %pred.store.continue52
  %i.rq = getelementptr [2 x i8], ptr %i.a, i64 %i.oj
...
pred.store.if55:                                  ; preds = %pred.store.continue54
  %i.rs = getelementptr [2 x i8], ptr %i.a, i64 %i.ok
...
pred.store.if57:                                  ; preds = %pred.store.continue56
  %i.ru = getelementptr [2 x i8], ptr %i.a, i64 %i.ol
