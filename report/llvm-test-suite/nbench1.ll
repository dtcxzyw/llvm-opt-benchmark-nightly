...
bb.c:                                             ; preds = %._crit_edge33.i.i
  %i.bk = getelementptr inbounds nuw [8 x i8], ptr %i.av, i64 %.026.i.i
...
._crit_edge33.i22.i:                              ; preds = %bb.f, %bb.e
  ...
  %.026.i23.i = phi i64 [ %spec.select.i26.i, %bb.f ], [ %i.bo, %bb.e ] ; 2 uses
  %i.by = getelementptr inbounds nuw [8 x i8], ptr %i.av, i64 %.032.i21.i ; 2 uses
...
bb.g:                                             ; preds = %._crit_edge33.i22.i
  %i.cb = getelementptr inbounds nuw [8 x i8], ptr %i.av, i64 %.026.i23.i
