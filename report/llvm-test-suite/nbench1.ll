...
.lr.ph91.i.preheader.preheader:                   ; preds = %.preheader.i
  %min.iters.check71 = icmp ult i64 %indvars.iv, 8
...
vector.scevcheck66:                               ; preds = %.lr.ph91.i.preheader.preheader, %._crit_edge92.i
  ...
  %or.cond138 = select i1 %min.iters.check71, i1 true, i1 %i.bn
...
vector.body74:                                    ; preds = %vector.scevcheck66, %vector.body74
  ...
  %i.cs = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %index75 ; 2 uses
...
.lr.ph91.i.preheader145:                          ; preds = %vector.scevcheck66, %middle.block79
  %indvars.iv40.ph = phi i64 [ %n.vec73, %middle.block79 ], [ 0, %vector.scevcheck66 ]
  br label %.lr.ph91.i
...
._crit_edge92.i:                                  ; preds = %.lr.ph91.i, %middle.block79
  ...
  br i1 %exitcond105.not.i, label %LoadStringArray.exit.thread, label %vector.scevcheck66, !llvm.loop !44
