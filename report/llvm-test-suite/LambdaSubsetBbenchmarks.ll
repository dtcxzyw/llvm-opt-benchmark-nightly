...
.lr.ph.us.preheader:                              ; preds = %.lr.ph41
  ...
  %diff.check47.a = icmp ult i64 %i.aa, 32
  %conflict.rdx = or i1 %diff.check, %diff.check47.a
  %diff.check48 = icmp ult i64 %i.ab, 32
  %conflict.rdx49 = or i1 %conflict.rdx, %diff.check48
  %diff.check50 = icmp ult i64 %i.ac, 32
  %conflict.rdx51 = or i1 %conflict.rdx49, %diff.check50
  %diff.check52 = icmp ult i64 %i.ad, 32
  %conflict.rdx53 = or i1 %conflict.rdx51, %diff.check52
  %diff.check54 = icmp ult i64 %i.ae, 32
  %conflict.rdx55 = or i1 %conflict.rdx53, %diff.check54
  %diff.check56 = icmp ult i64 %i.af, 32
  %conflict.rdx57 = or i1 %conflict.rdx55, %diff.check56
  %diff.check58 = icmp ult i64 %i.ag, 32
  %conflict.rdx59 = or i1 %conflict.rdx57, %diff.check58
  %diff.check60 = icmp ult i64 %i.ah, 32
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %"._Z6forallIZL15BM_INIT3_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge.us"
  ...
  %brmerge = select i1 %min.iters.check, i1 true, i1 %conflict.rdx61
...
vector.body:                                      ; preds = %.lr.ph.us, %vector.body
  ...
  %wide.load62.a = load <2 x double>, ptr %i.aj, align 8, !tbaa !40
  %i.ak = fneg <2 x double> %wide.load
  %i.al = fneg <2 x double> %wide.load62.a
  %i.am = getelementptr inbounds nuw [8 x i8], ptr %i.o, i64 %index ; 2 uses
  %i.an = getelementptr inbounds nuw i8, ptr %i.am, i64 16
  %wide.load63.a = load <2 x double>, ptr %i.am, align 8, !tbaa !40
  %wide.load64 = load <2 x double>, ptr %i.an, align 8, !tbaa !40
  %i.ao = fsub <2 x double> %i.ak, %wide.load63.a ; 3 uses
  %i.ap = fsub <2 x double> %i.al, %wide.load64   ; 3 uses
...
middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %"._Z6forallIZL15BM_INIT3_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge.us", label %scalar.ph.preheader

scalar.ph.preheader:                              ; preds = %.lr.ph.us, %middle.block
  %indvars.iv.ph = phi i64 [ %n.vec, %middle.block ], [ 0, %.lr.ph.us ] ; 8 uses
...
scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  ...
  br i1 %i.bg, label %"._Z6forallIZL15BM_INIT3_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge.us", label %scalar.ph
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  br i1 %exitcond.not.1, label %"._Z6forallIZL15BM_INIT3_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge.us", label %scalar.ph, !llvm.loop !46
...
.lr.ph.us.preheader:                              ; preds = %.lr.ph41
  ...
  %scevgep47.a = getelementptr i8, ptr %i.i, i64 %i.v ; 2 uses
  %scevgep48.a = getelementptr i8, ptr %i.h, i64 %i.v ; 3 uses
  %scevgep49.a = getelementptr i8, ptr %i.g, i64 %i.v ; 2 uses
  %scevgep50 = getelementptr i8, ptr %i.l, i64 %i.v ; 2 uses
  ...
  %i.y = insertelement <8 x ptr> poison, ptr %scevgep47.a, i64 0
  %i.z = insertelement <8 x ptr> %i.y, ptr %scevgep, i64 1
  %i.aa = insertelement <8 x ptr> %i.z, ptr %scevgep49.a, i64 2
  %i.ab = insertelement <8 x ptr> %i.aa, ptr %scevgep48.a, i64 7
  ...
  %i.ae = insertelement <8 x ptr> %i.ad, ptr %scevgep48.a, i64 1
  %i.af = insertelement <8 x ptr> %i.ae, ptr %scevgep, i64 2
  %i.ag = insertelement <8 x ptr> %i.af, ptr %scevgep50, i64 3
  %i.ah = insertelement <8 x ptr> %i.ag, ptr %scevgep47.a, i64 5
  %i.ai = insertelement <8 x ptr> %i.ah, ptr %scevgep49.a, i64 7
  ...
  %bound078 = icmp ult ptr %i.h, %scevgep50
  %bound179 = icmp ult ptr %i.l, %scevgep48.a
  %found.conflict80 = and i1 %bound078, %bound179
  %i.aq = bitcast <8 x i1> %i.ap to i8
  %i.ar = icmp ne i8 %i.aq, 0
  %op.rdx = or i1 %i.ar, %found.conflict80
...
vector.body:                                      ; preds = %.lr.ph.us, %vector.body
  ...
  %wide.load82 = load <2 x double>, ptr %i.at, align 8, !tbaa !40, !alias.scope !51 ; 2 uses
  %i.au = fmul <2 x double> %wide.load, %wide.load82
  ...
  %i.aw = fadd <2 x double> %wide.load, %wide.load82
  ...
  %wide.load85.a = load <2 x double>, ptr %i.as, align 8, !tbaa !40, !alias.scope !48
  %wide.load86 = load <2 x double>, ptr %i.at, align 8, !tbaa !40, !alias.scope !51
  %i.ay = fsub <2 x double> %wide.load85.a, %wide.load86
...
middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %"._Z6forallIZL19BM_MULADDSUB_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge.us", label %scalar.ph.preheader
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %exitcond.not, label %"._Z6forallIZL19BM_MULADDSUB_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge.us", label %scalar.ph, !llvm.loop !63
...
bb.a:                                             ; preds = %.lr.ph.us, %"_ZZL17BM_IF_QUAD_LAMBDARN9benchmark5StateEENK3$_0clEi.exit.us"
  %indvars.iv = phi i64 [ 0, %.lr.ph.us ], [ %indvars.iv.next, %"_ZZL17BM_IF_QUAD_LAMBDARN9benchmark5StateEENK3$_0clEi.exit.us" ] ; 7 uses
...
"_ZZL17BM_IF_QUAD_LAMBDARN9benchmark5StateEENK3$_0clEi.exit.us": ; preds = %bb.b, %bb.c
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %"._Z6forallIZL17BM_IF_QUAD_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge.us", label %bb.a, !llvm.loop !64
