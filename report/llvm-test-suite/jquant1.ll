...
select_ncolors.exit.i:                            ; preds = %._crit_edge.us70.i.loopexit.i, %._crit_edge.us70.i.us.i, %.lr.ph64.us.preheader.i.i, %bb.i
  %.us-phi73.i.i = phi i32 [ 1, %bb.i ], [ %.lcssa61, %.lr.ph64.us.preheader.i.i ], [ %i.bm, %._crit_edge.us70.i.us.i ], [ %.2.lcssa.us.i.ph.i, %._crit_edge.us70.i.loopexit.i ] ; 6 uses
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  br i1 %i.dz, label %.lr.ph74.preheader.i, label %create_colormap.exit

.lr.ph74.preheader.i:                             ; preds = %bb.o
  %i.ea = sext i32 %.us-phi73.i.i to i64
  br label %.lr.ph74.i

.lr.ph74.i:                                       ; preds = %._crit_edge.i, %.lr.ph74.preheader.i
  %i.eb = phi i32 [ %i.dy, %.lr.ph74.preheader.i ], [ %i.fl, %._crit_edge.i ] ; 2 uses
  %indvars.iv92.i = phi i64 [ 0, %.lr.ph74.preheader.i ], [ %indvars.iv.next93.i, %._crit_edge.i ] ; 3 uses
  %.06071.i = phi i32 [ %.us-phi73.i.i, %.lr.ph74.preheader.i ], [ %.fr76.i, %._crit_edge.i ] ; 2 uses
  %i.ec = getelementptr inbounds nuw [4 x i8], ptr %i.ab, i64 %indvars.iv92.i
  %i.ed = load i32, ptr %i.ec, align 4, !tbaa !4  ; 4 uses
  %i.ee = sdiv i32 %.06071.i, %i.ed
  %.fr76.i = freeze i32 %i.ee                     ; 5 uses
  %i.ef = icmp sgt i32 %i.ed, 0
  br i1 %i.ef, label %.lr.ph70.i, label %._crit_edge.i

.lr.ph70.i:                                       ; preds = %.lr.ph74.i
  ...
  br i1 %i.ek, label %.lr.ph70.split.us.preheader.i, label %._crit_edge.i

.lr.ph70.split.us.preheader.i:                    ; preds = %.lr.ph70.i
  %i.em = zext nneg i32 %.fr76.i to i64           ; 3 uses
  %i.en = sext i32 %.06071.i to i64
  %wide.trip.count90.i = zext nneg i32 %i.ed to i64
  %xtraiter76 = and i64 %i.em, 3                  ; 3 uses
  %i.eo = icmp ult i32 %.fr76.i, 4
  %unroll_iter80 = and i64 %i.em, 2147483644
  %lcmp.mod78.not = icmp eq i64 %xtraiter76, 0
  %lcmp.mod79 = icmp ne i64 %xtraiter76, 0
  br label %.lr.ph70.split.us.i

.lr.ph70.split.us.i:                              ; preds = %._crit_edge68.split.us.us.i, %.lr.ph70.split.us.preheader.i
  %indvars.iv87.i = phi i64 [ 0, %.lr.ph70.split.us.preheader.i ], [ %indvars.iv.next88.i, %._crit_edge68.split.us.us.i ] ; 3 uses
  %indvars.iv82.i = phi i64 [ 0, %.lr.ph70.split.us.preheader.i ], [ %indvars.iv.next83.i, %._crit_edge68.split.us.us.i ] ; 2 uses
  %i.ep = trunc i64 %indvars.iv87.i to i32
  %i.eq = mul i32 %.fr76.i, %i.ep
  %i.er = icmp slt i32 %i.eq, %.us-phi73.i.i
  br i1 %i.er, label %.preheader.lr.ph.us.i, label %._crit_edge68.split.us.us.i

._crit_edge68.split.us.us.i:                      ; preds = %._crit_edge.us.us.i, %.lr.ph70.split.us.i
  ...
  br i1 %exitcond91.not.i, label %._crit_edge.loopexit.i, label %.lr.ph70.split.us.i, !llvm.loop !67

.preheader.us.us.i.new:                           ; preds = %.preheader.us.i, %.preheader.us.us.i.new
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i.3, %.preheader.us.us.i.new ], [ 0, %.preheader.us.i ] ; 5 uses
  %niter81 = phi i64 [ %niter81.next.3, %.preheader.us.us.i.new ], [ 0, %.preheader.us.i ]
  ...
  br i1 %niter81.ncmp.3, label %._crit_edge.us.us.i.unr-lcssa, label %.preheader.us.us.i.new, !llvm.loop !69

.preheader.us.i:                                  ; preds = %.preheader.lr.ph.us.i, %._crit_edge.us.us.i
  %indvars.iv84.i = phi i64 [ %indvars.iv82.i, %.preheader.lr.ph.us.i ], [ %indvars.iv.next85.i, %._crit_edge.us.us.i ] ; 6 uses
  br i1 %i.eo, label %.epil.preheader75, label %.preheader.us.us.i.new

._crit_edge.us.us.i.unr-lcssa:                    ; preds = %.preheader.us.us.i.new
  br i1 %lcmp.mod78.not, label %._crit_edge.us.us.i, label %.epil.preheader75

.epil.preheader75:                                ; preds = %._crit_edge.us.us.i.unr-lcssa, %.preheader.us.i
  %indvars.iv.i.epil.init = phi i64 [ 0, %.preheader.us.i ], [ %indvars.iv.next.i.3, %._crit_edge.us.us.i.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod79)
  br label %bb.p

bb.p:                                             ; preds = %bb.p, %.epil.preheader75
  %indvars.iv.i.epil = phi i64 [ %indvars.iv.i.epil.init, %.epil.preheader75 ], [ %indvars.iv.next.i.epil, %bb.p ] ; 2 uses
  %epil.iter77 = phi i64 [ 0, %.epil.preheader75 ], [ %epil.iter77.next, %bb.p ]
  ...
  br i1 %epil.iter77.cmp.not, label %._crit_edge.us.us.i, label %bb.p, !llvm.loop !70

._crit_edge.us.us.i:                              ; preds = %bb.p, %._crit_edge.us.us.i.unr-lcssa
  %indvars.iv.next85.i = add nsw i64 %indvars.iv84.i, %i.en ; 2 uses
  %i.fk = icmp slt i64 %indvars.iv.next85.i, %i.ea
  br i1 %i.fk, label %.preheader.us.i, label %._crit_edge68.split.us.us.i, !llvm.loop !71

.preheader.lr.ph.us.i:                            ; preds = %.lr.ph70.split.us.i
...
._crit_edge.loopexit.i:                           ; preds = %._crit_edge68.split.us.us.i
  %.pre95.i = load i32, ptr %i.j, align 8, !tbaa !44
  br label %._crit_edge.i

._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %.lr.ph70.i, %.lr.ph74.i
  %i.fl = phi i32 [ %i.eb, %.lr.ph74.i ], [ %.pre95.i, %._crit_edge.loopexit.i ], [ %i.eb, %.lr.ph70.i ] ; 2 uses
  %indvars.iv.next93.i = add nuw nsw i64 %indvars.iv92.i, 1 ; 2 uses
  %i.fm = sext i32 %i.fl to i64
  %i.fn = icmp slt i64 %indvars.iv.next93.i, %i.fm
  br i1 %i.fn, label %.lr.ph74.i, label %create_colormap.exit, !llvm.loop !72

create_colormap.exit:                             ; preds = %._crit_edge.i, %bb.o
...
bb.q:                                             ; preds = %create_colormap.exit
  ...
  br i1 %i.fz, label %.lr.ph.i24, label %alloc_fs_workspace.exit
...
bb.r:                                             ; preds = %bb.r, %.lr.ph.i24
  %indvars.iv.i25 = phi i64 [ 0, %.lr.ph.i24 ], [ %indvars.iv.next.i26, %bb.r ] ; 2 uses
  ...
  %i.gg = getelementptr inbounds nuw [8 x i8], ptr %i.gb, i64 %indvars.iv.i25
  ...
  %i.gj = icmp slt i64 %indvars.iv.next.i26, %i.gi
