Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/llvm-test-suite/original/LzmaHandler?download=true
...
bb.b:                                             ; preds = %bb.a
  %i.b = load i8, ptr %1, align 1, !tbaa !13      ; 2 uses
  store i8 %i.b, ptr %i.a, align 8, !tbaa !12
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.h = load i8, ptr %i.f, align 1, !tbaa !13    ; 2 uses
  store i8 %i.h, ptr %i.g, align 1, !tbaa !13
  ...
  store i8 %i.j, ptr %i.k, align 2, !tbaa !13
  ...
  store i8 %i.p, ptr %i.q, align 4, !tbaa !13
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.h = tail call noundef i32 %i.g(ptr noundef nonnull align 8 dereferenceable(8) %i.d), !inline_history !52 ; 0 uses
  %i.i = load ptr, ptr %i.a, align 8, !tbaa !19   ; 3 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.m = tail call noundef i32 %i.l(ptr noundef nonnull align 8 dereferenceable(8) %i.i), !inline_history !52 ; 0 uses
...
bb.k:                                             ; preds = %bb.i
  %i.t = load ptr, ptr %3, align 8, !tbaa !19     ; 3 uses
...
bb.m:                                             ; preds = %bb.k
  %i.w = load ptr, ptr %i.t, align 8, !tbaa !26
  ...
  %i.y = invoke noundef i32 %i.x(ptr noundef nonnull align 8 dereferenceable(8) %i.t, ptr noundef nonnull align 4 dereferenceable(16) @IID_ISequentialOutStream, ptr noundef nonnull %i.o)
          to label %_ZNK9CMyComPtrI14ICompressCoderE14QueryInterfaceI20ISequentialOutStreamEEiRK4GUIDPPT_.exit unwind label %bb.l, !inline_history !53 ; 0 uses
...
bb.q:                                             ; preds = %bb.l, %bb.j
  ...
  %i.ah = load ptr, ptr %3, align 8, !tbaa !19    ; 3 uses
...
bb.t:                                             ; preds = %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit, %bb.g, %bb.f
  %i.ao = load ptr, ptr %0, align 8, !tbaa !24    ; 2 uses
...
bb.u:                                             ; preds = %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit.thread, %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit, %bb.t
  %.2 = phi i32 [ %i.as, %bb.t ], [ %.114.ph, %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit ], [ -2147467263, %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit.thread ]
  ret i32 %.2
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = invoke noundef i32 %i.f(ptr noundef nonnull align 8 dereferenceable(273) %i.c)
          to label %_ZN8NArchive5NLzma8CDecoder15ReleaseInStreamEv.exit unwind label %bb.g, !inline_history !0 ; 0 uses
