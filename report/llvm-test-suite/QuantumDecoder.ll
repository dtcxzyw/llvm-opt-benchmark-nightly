...
begin_hunk_0_@_ZN9NCompress8NQuantum8CDecoder8CodeRealEP19ISequentialInStreamP20ISequentialOutStreamPKyS7_P21ICompressProgressInfo:bb.a
  ...
  %i.bb = invoke noundef i32 %i.ba(ptr noundef nonnull align 8 dereferenceable(8) %i.ax)
          to label %.noexc.i unwind label %bb.o   ; 0 uses
...
begin_hunk_1_@_ZN9NCompress8NQuantum8CDecoder8CodeRealEP19ISequentialInStreamP20ISequentialOutStreamPKyS7_P21ICompressProgressInfo:bb.a
  ...
  %i.bf = invoke noundef i32 %i.be(ptr noundef nonnull align 8 dereferenceable(2020) %0)
          to label %_ZN9NCompress8NQuantum8CDecoder15CDecoderFlusherD2Ev.exit unwind label %bb.o ; 0 uses
...
begin_hunk_3_@_ZN9NCompress8NQuantum8CDecoder15CDecoderFlusherD2Ev:bb.a
  ...
  %i.q = invoke noundef i32 %i.p(ptr noundef nonnull align 8 dereferenceable(2020) %i.g)
          to label %_ZN9NCompress8NQuantum8CDecoder14ReleaseStreamsEv.exit unwind label %bb.d ; 0 uses
...
.sink.split.sink.split:                           ; preds = %bb.d, %bb.c
  ...
  %i.k = load i32, ptr %.sink, align 4, !tbaa !114
  br label %.sink.split
...
begin_hunk_6_@_ZN9NCompress8NQuantum8CDecoder15ReleaseInStreamEv:bb.a
  ...
  %i.f = tail call noundef i32 %i.e(ptr noundef nonnull align 8 dereferenceable(8) %i.b), !inline_history !117 ; 0 uses
...
_ZeqRK4GUIDS1_.exit44.thread.sink.split:          ; preds = %_ZeqRK4GUIDS1_.exit44, %_ZeqRK4GUIDS1_.exit26, %_ZeqRK4GUIDS1_.exit
  ...
  store ptr %i.ej, ptr %2, align 8, !tbaa !119
...
bb.a:
  ...
  store i32 %i.c, ptr %i.a, align 8, !tbaa !120
  ret i32 %i.c
}
...
begin_hunk_15_@_ZThn8_N9NCompress8NQuantum8CDecoder7ReleaseEv:bb.a
  ...
  tail call void %i.g(ptr noundef nonnull align 8 dereferenceable(2020) %i.d) #12, !inline_history !121
...
bb.a:
  ...
  tail call void @_ZN9NCompress8NQuantum8CDecoderD2Ev(ptr noundef nonnull align 8 dereferenceable(2020) %i.a) #12, !inline_history !122
  tail call void @_ZdlPvm(ptr noundef nonnull align 8 dereferenceable(2020) %i.a, i64 noundef 2024) #14, !inline_history !122
  ret void
}
...
!118 = distinct !{ptr @_ZN9NCompress8NQuantum8CDecoder15ReleaseInStreamEv, null, null, null, null}
!119 = !{!24, !24, i64 0}
!120 = !{!20, !5, i64 0}
!121 = !{ptr @_ZN9NCompress8NQuantum8CDecoder7ReleaseEv}
!122 = !{ptr @_ZN9NCompress8NQuantum8CDecoderD0Ev}
!123 = distinct !{!123, !42}
end_hunk_22
