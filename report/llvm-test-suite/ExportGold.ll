...
.lr.ph.i313.preheader:                            ; preds = %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit
  ...
  %i.te = ptrtoint ptr %i.ta to i64
  %8 = add i64 %i.td, -4
  %9 = sub i64 %8, %i.te                          ; 2 uses
  %i.tf = lshr i64 %9, 2
  %i.tg = add nuw nsw i64 %i.tf, 1                ; 2 uses
  %min.iters.check1395 = icmp ult i64 %9, 28
...
.lr.ph.i321.preheader:                            ; preds = %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit319
  ...
  %10 = add i64 %i.tw, -4
  %11 = sub i64 %10, %i.tx                        ; 2 uses
  %i.ty = lshr i64 %11, 2
  %i.tz = add nuw nsw i64 %i.ty, 1                ; 2 uses
  %min.iters.check1413 = icmp ult i64 %11, 28
...
bb.es:                                            ; preds = %bb.er
  ...
  %12 = add i64 %.0.i.i.i.i.i3321459, -4
  %i.aop = sub i64 %12, %.sroa.0889.01460         ; 2 uses
  %i.aoq = lshr i64 %i.aop, 2
  %i.aor = add nuw nsw i64 %i.aoq, 1              ; 2 uses
  %min.iters.check1462 = icmp ult i64 %i.aop, 28
  br i1 %min.iters.check1462, label %.lr.ph.i443.preheader, label %vector.ph1463

vector.ph1463:                                    ; preds = %bb.es
  %n.vec1465 = and i64 %i.aor, 9223372036854775800 ; 3 uses
  %i.aos = shl i64 %n.vec1465, 2
  %i.aot = getelementptr i8, ptr %.sroa.0889.0, i64 %i.aos
...
vector.body1466:                                  ; preds = %vector.body1466, %vector.ph1463
  ...
  %vec.phi1468 = phi <4 x i32> [ zeroinitializer, %vector.ph1463 ], [ %i.aow, %vector.body1466 ]
  %vec.phi1469 = phi <4 x i32> [ zeroinitializer, %vector.ph1463 ], [ %i.aox, %vector.body1466 ]
  %i.aou = shl i64 %index1467, 2
  %next.gep1470 = getelementptr i8, ptr %.sroa.0889.0, i64 %i.aou ; 2 uses
  %i.aov = getelementptr i8, ptr %next.gep1470, i64 16
  %wide.load1471 = load <4 x i32>, ptr %next.gep1470, align 4, !tbaa !4
  %wide.load1472 = load <4 x i32>, ptr %i.aov, align 4, !tbaa !4
  %i.aow = add <4 x i32> %wide.load1471, %vec.phi1468 ; 2 uses
  %i.aox = add <4 x i32> %wide.load1472, %vec.phi1469 ; 2 uses
  %index.next1473 = add nuw i64 %index1467, 8     ; 2 uses
  %i.aoy = icmp eq i64 %index.next1473, %n.vec1465
  br i1 %i.aoy, label %middle.block1474, label %vector.body1466, !llvm.loop !123

middle.block1474:                                 ; preds = %vector.body1466
  %bin.rdx1475 = add <4 x i32> %i.aox, %i.aow
  %i.aoz = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx1475) ; 2 uses
  %cmp.n1476 = icmp eq i64 %i.aor, %n.vec1465
...
.lr.ph.i443.preheader:                            ; preds = %bb.es, %middle.block1474
  %.07.i444.ph = phi i32 [ 0, %bb.es ], [ %i.aoz, %middle.block1474 ]
  %.sroa.02.06.i445.ph = phi ptr [ %.sroa.0889.0, %bb.es ], [ %i.aot, %middle.block1474 ]
  br label %.lr.ph.i443

.lr.ph.i443:                                      ; preds = %.lr.ph.i443.preheader, %.lr.ph.i443
  %.07.i444 = phi i32 [ %i.apb, %.lr.ph.i443 ], [ %.07.i444.ph, %.lr.ph.i443.preheader ]
  %.sroa.02.06.i445 = phi ptr [ %i.apc, %.lr.ph.i443 ], [ %.sroa.02.06.i445.ph, %.lr.ph.i443.preheader ] ; 2 uses
  %i.apa = load i32, ptr %.sroa.02.06.i445, align 4, !tbaa !4
  %i.apb = add nsw i32 %i.apa, %.07.i444          ; 2 uses
  %i.apc = getelementptr inbounds nuw i8, ptr %.sroa.02.06.i445, i64 4 ; 2 uses
  %.not.i446 = icmp eq ptr %i.apc, %.0.i.i.i.i.i332
...
_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit449: ; preds = %.lr.ph.i443, %middle.block1474
  %.lcssa1380 = phi i32 [ %i.aoz, %middle.block1474 ], [ %i.apb, %.lr.ph.i443 ] ; 3 uses
  %i.apd = sext i32 %.lcssa1380 to i64            ; 2 uses
  %i.ape = icmp slt i32 %.lcssa1380, 0
  br i1 %i.ape, label %bb.et, label %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i450
...
_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i450: ; preds = %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit449
  ...
  %i.apf = shl nuw nsw i64 %i.apd, 2              ; 3 uses
  %i.apg = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.apf) #18
          to label %.noexc457 unwind label %bb.fe ; 6 uses

.noexc457:                                        ; preds = %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i450
  store i32 0, ptr %i.apg, align 4, !tbaa !4
  %i.aph = add nsw i64 %i.apd, -1                 ; 2 uses
  %i.api = icmp eq i64 %i.aph, 0
  br i1 %i.api, label %_ZNSt6vectorIiSaIiEEC2EmRKS0_.exit458, label %_ZSt6fill_nIPimiET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i452

_ZSt6fill_nIPimiET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i452: ; preds = %.noexc457
  %i.apj = getelementptr i8, ptr %i.apg, i64 4
  %.idx.i.i.i.i.i.i.i453 = shl nuw nsw i64 %i.aph, 2
  call void @llvm.memset.p0.i64(ptr align 4 %i.apj, i8 0, i64 %.idx.i.i.i.i.i.i.i453, i1 false), !tbaa !4
...
_ZNSt6vectorIiSaIiEEC2EmRKS0_.exit458:            ; preds = %_ZSt6fill_nIPimiET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i452, %.noexc457
  invoke void @_ZN8Parallel7gathervIiEEvPKT_iPS1_PKi(ptr noundef nonnull %.sroa.0823.0.lcssa, i32 noundef %i.aoo, ptr noundef nonnull %i.apg, ptr noundef nonnull %.sroa.0889.0)
          to label %bb.eu unwind label %bb.ff

bb.eu:                                            ; preds = %_ZNSt6vectorIiSaIiEEC2EmRKS0_.exit458
  %i.apk = load i32, ptr @_ZN8Parallel4mypeE, align 4, !tbaa !4
  %i.apl = icmp eq i32 %i.apk, 0
  br i1 %i.apl, label %bb.ev, label %_ZNSt6vectorIiSaIiEED2Ev.exit500

bb.ev:                                            ; preds = %bb.eu
  %i.apm = load i32, ptr %i.ul, align 8, !tbaa !108
  %i.apn = icmp sgt i32 %i.apm, 0
  br i1 %i.apn, label %bb.ew, label %.thread938

bb.ew:                                            ; preds = %bb.ev
  %i.apo = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %4, ptr noundef nonnull @.str.29, i64 noundef 6)
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit460: ; preds = %bb.ew
  ...
  %i.apt = getelementptr inbounds nuw i8, ptr %i.aps, i64 240
  %i.apu = load ptr, ptr %i.apt, align 8, !tbaa !45 ; 6 uses
  %.not.i.i.i746 = icmp eq ptr %i.apu, null
...
_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i747: ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit460
  %i.apv = getelementptr inbounds nuw i8, ptr %i.apu, i64 56
  %i.apw = load i8, ptr %i.apv, align 8, !tbaa !53
  %.not.i1.i.i748 = icmp eq i8 %i.apw, 0
  br i1 %.not.i1.i.i748, label %bb.ey, label %bb.ex

bb.ex:                                            ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i747
  %i.apx = getelementptr inbounds nuw i8, ptr %i.apu, i64 67
  %i.apy = load i8, ptr %i.apx, align 1, !tbaa !25
...
bb.ey:                                            ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i747
  invoke void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %i.apu)
          to label %.noexc752 unwind label %bb.ff

.noexc752:                                        ; preds = %bb.ey
  %i.apz = load ptr, ptr %i.apu, align 8, !tbaa !33
  %i.aqa = getelementptr inbounds nuw i8, ptr %i.apz, i64 48
  %i.aqb = load ptr, ptr %i.aqa, align 8
  %i.aqc = invoke noundef signext i8 %i.aqb(ptr noundef nonnull align 8 dereferenceable(570) %i.apu, i8 noundef signext 10)
...
_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i749: ; preds = %.noexc752, %bb.ex
  %.0.i.i.i750 = phi i8 [ %i.apy, %bb.ex ], [ %i.aqc, %.noexc752 ]
  %i.aqd = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %4, i8 noundef signext %.0.i.i.i750)
          to label %.noexc754 unwind label %bb.ff

.noexc754:                                        ; preds = %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i749
  %i.aqe = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %i.aqd)
          to label %bb.ez unwind label %bb.ff     ; 0 uses

bb.ez:                                            ; preds = %.noexc754
  %i.aqf = load ptr, ptr %4, align 8, !tbaa !33
  %i.aqg = getelementptr i8, ptr %i.aqf, i64 -24
  %i.aqh = load i64, ptr %i.aqg, align 8
  %i.aqi = getelementptr inbounds i8, ptr %4, i64 %i.aqh
  %i.aqj = getelementptr inbounds nuw i8, ptr %i.aqi, i64 16
  store i64 10, ptr %i.aqj, align 8, !tbaa !82
  %i.aqk = load i32, ptr %i.ul, align 8, !tbaa !108
  %i.aql = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %4, i32 noundef %i.aqk)
          to label %bb.fa unwind label %bb.ff     ; 3 uses

bb.fa:                                            ; preds = %bb.ez
  %i.aqm = load ptr, ptr %i.aql, align 8, !tbaa !33
  %i.aqn = getelementptr i8, ptr %i.aqm, i64 -24
  %i.aqo = load i64, ptr %i.aqn, align 8
  %i.aqp = getelementptr inbounds i8, ptr %i.aql, i64 %i.aqo
  %i.aqq = getelementptr inbounds nuw i8, ptr %i.aqp, i64 240
  %i.aqr = load ptr, ptr %i.aqq, align 8, !tbaa !45 ; 6 uses
  %.not.i.i.i757 = icmp eq ptr %i.aqr, null
...
_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i758: ; preds = %bb.fa
  %i.aqs = getelementptr inbounds nuw i8, ptr %i.aqr, i64 56
  %i.aqt = load i8, ptr %i.aqs, align 8, !tbaa !53
  %.not.i1.i.i759 = icmp eq i8 %i.aqt, 0
  br i1 %.not.i1.i.i759, label %bb.fc, label %bb.fb

bb.fb:                                            ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i758
  %i.aqu = getelementptr inbounds nuw i8, ptr %i.aqr, i64 67
  %i.aqv = load i8, ptr %i.aqu, align 1, !tbaa !25
...
bb.fc:                                            ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i758
  invoke void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %i.aqr)
          to label %.noexc763 unwind label %bb.ff

.noexc763:                                        ; preds = %bb.fc
  %i.aqw = load ptr, ptr %i.aqr, align 8, !tbaa !33
  %i.aqx = getelementptr inbounds nuw i8, ptr %i.aqw, i64 48
  %i.aqy = load ptr, ptr %i.aqx, align 8
  %i.aqz = invoke noundef signext i8 %i.aqy(ptr noundef nonnull align 8 dereferenceable(570) %i.aqr, i8 noundef signext 10)
...
_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i760: ; preds = %.noexc763, %bb.fb
  %.0.i.i.i761 = phi i8 [ %i.aqv, %bb.fb ], [ %i.aqz, %.noexc763 ]
  %i.ara = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %i.aql, i8 noundef signext %.0.i.i.i761)
          to label %.noexc765 unwind label %bb.ff

.noexc765:                                        ; preds = %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i760
  %i.arb = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %i.ara)
          to label %_ZNSolsEPFRSoS_E.exit464.preheader unwind label %bb.ff ; 0 uses

_ZNSolsEPFRSoS_E.exit464.preheader:               ; preds = %.noexc765
  %i.arc = load i32, ptr %i.ul, align 8, !tbaa !108
  %i.ard = icmp sgt i32 %i.arc, 0
  br i1 %i.ard, label %.lr.ph1133, label %._crit_edge1143

.preheader1005:                                   ; preds = %_ZNSolsEPFRSoS_E.exit466
  %i.are = icmp sgt i32 %i.ash, 0
end_hunk_1
