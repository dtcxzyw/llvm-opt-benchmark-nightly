...
.lr.ph.i309.preheader:                            ; preds = %bb.bw
  ...
  br i1 %min.iters.check, label %.lr.ph.i309.preheader1500, label %vector.ph
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit, label %.lr.ph.i309.preheader1500

.lr.ph.i309.preheader1500:                        ; preds = %.lr.ph.i309.preheader, %middle.block
...
.lr.ph.i309:                                      ; preds = %.lr.ph.i309.preheader1500, %.lr.ph.i309
  %.07.i = phi i32 [ %i.sx, %.lr.ph.i309 ], [ %.07.i.ph, %.lr.ph.i309.preheader1500 ]
  %.sroa.02.06.i = phi ptr [ %i.sy, %.lr.ph.i309 ], [ %.sroa.02.06.i.ph, %.lr.ph.i309.preheader1500 ] ; 2 uses
...
.lr.ph.i313.preheader:                            ; preds = %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit
  ...
  br i1 %min.iters.check1395, label %.lr.ph.i313.preheader1496, label %vector.ph1396
...
middle.block1407:                                 ; preds = %vector.body1399
  ...
  br i1 %cmp.n1409, label %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit319, label %.lr.ph.i313.preheader1496

.lr.ph.i313.preheader1496:                        ; preds = %.lr.ph.i313.preheader, %middle.block1407
...
.lr.ph.i313:                                      ; preds = %.lr.ph.i313.preheader1496, %.lr.ph.i313
  %.07.i314 = phi i32 [ %i.tq, %.lr.ph.i313 ], [ %.07.i314.ph, %.lr.ph.i313.preheader1496 ]
  %.sroa.02.06.i315 = phi ptr [ %i.tr, %.lr.ph.i313 ], [ %.sroa.02.06.i315.ph, %.lr.ph.i313.preheader1496 ] ; 2 uses
...
.lr.ph.i321.preheader:                            ; preds = %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit319
  ...
  br i1 %min.iters.check1413, label %.lr.ph.i321.preheader1492, label %vector.ph1414
...
middle.block1425:                                 ; preds = %vector.body1417
  ...
  br i1 %cmp.n1427, label %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit327, label %.lr.ph.i321.preheader1492

.lr.ph.i321.preheader1492:                        ; preds = %.lr.ph.i321.preheader, %middle.block1425
...
.lr.ph.i321:                                      ; preds = %.lr.ph.i321.preheader1492, %.lr.ph.i321
  %.07.i322 = phi i32 [ %i.uj, %.lr.ph.i321 ], [ %.07.i322.ph, %.lr.ph.i321.preheader1492 ]
  %.sroa.02.06.i323 = phi ptr [ %i.uk, %.lr.ph.i321 ], [ %.sroa.02.06.i323.ph, %.lr.ph.i321.preheader1492 ] ; 2 uses
...
_ZNSt6vectorIiSaIiEEC2EmRKS0_.exit336:            ; preds = %_ZSt6fill_nIPimiET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i330, %.noexc335, %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i328
  ...
  %.sroa.0889.01430 = ptrtoint ptr %.sroa.0889.0 to i64 ; 3 uses
...
scalar.ph1431.preheader:                          ; preds = %.lr.ph1095, %middle.block1441
  ...
  %xtraiter1506 = and i64 %wide.trip.count, 3     ; 2 uses
  %lcmp.mod1507.not = icmp eq i64 %xtraiter1506, 0
  br i1 %lcmp.mod1507.not, label %scalar.ph1431.prol.loopexit, label %scalar.ph1431.prol
...
scalar.ph1431.prol:                               ; preds = %scalar.ph1431.preheader, %scalar.ph1431.prol
  ...
  %prol.iter1508 = phi i64 [ %prol.iter1508.next, %scalar.ph1431.prol ], [ 0, %scalar.ph1431.preheader ]
  ...
  %prol.iter1508.next = add i64 %prol.iter1508, 1 ; 2 uses
  %prol.iter1508.cmp.not = icmp eq i64 %prol.iter1508.next, %xtraiter1506
  br i1 %prol.iter1508.cmp.not, label %scalar.ph1431.prol.loopexit, label %scalar.ph1431.prol, !llvm.loop !110
...
bb.es:                                            ; preds = %bb.er
  ...
  %min.iters.check1460 = icmp ult i64 %i.aoq, 28
  br i1 %min.iters.check1460, label %.lr.ph.i443.preheader, label %vector.ph1461

vector.ph1461:                                    ; preds = %bb.es
  %n.vec1463 = and i64 %i.aos, 9223372036854775800 ; 3 uses
  %i.aot = shl i64 %n.vec1463, 2
  %i.aou = getelementptr i8, ptr %.sroa.0889.0, i64 %i.aot
  br label %vector.body1464

vector.body1464:                                  ; preds = %vector.body1464, %vector.ph1461
  %index1465 = phi i64 [ 0, %vector.ph1461 ], [ %index.next1471, %vector.body1464 ] ; 2 uses
  %vec.phi1466 = phi <4 x i32> [ zeroinitializer, %vector.ph1461 ], [ %i.aox, %vector.body1464 ]
  %vec.phi1467 = phi <4 x i32> [ zeroinitializer, %vector.ph1461 ], [ %i.aoy, %vector.body1464 ]
  %i.aov = shl i64 %index1465, 2
  %next.gep1468 = getelementptr i8, ptr %.sroa.0889.0, i64 %i.aov ; 2 uses
  %i.aow = getelementptr i8, ptr %next.gep1468, i64 16
  %wide.load1469 = load <4 x i32>, ptr %next.gep1468, align 4, !tbaa !4
  %wide.load1470 = load <4 x i32>, ptr %i.aow, align 4, !tbaa !4
  %i.aox = add <4 x i32> %wide.load1469, %vec.phi1466 ; 2 uses
  %i.aoy = add <4 x i32> %wide.load1470, %vec.phi1467 ; 2 uses
  %index.next1471 = add nuw i64 %index1465, 8     ; 2 uses
  %i.aoz = icmp eq i64 %index.next1471, %n.vec1463
  br i1 %i.aoz, label %middle.block1472, label %vector.body1464, !llvm.loop !123

middle.block1472:                                 ; preds = %vector.body1464
  %bin.rdx1473 = add <4 x i32> %i.aoy, %i.aox
  %i.apa = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx1473) ; 2 uses
  %cmp.n1474 = icmp eq i64 %i.aos, %n.vec1463
  br i1 %cmp.n1474, label %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit449, label %.lr.ph.i443.preheader

.lr.ph.i443.preheader:                            ; preds = %bb.es, %middle.block1472
  %.07.i444.ph = phi i32 [ 0, %bb.es ], [ %i.apa, %middle.block1472 ]
  %.sroa.02.06.i445.ph = phi ptr [ %.sroa.0889.0, %bb.es ], [ %i.aou, %middle.block1472 ]
  br label %.lr.ph.i443
...
_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit449: ; preds = %.lr.ph.i443, %middle.block1472
  %.lcssa1380 = phi i32 [ %i.apa, %middle.block1472 ], [ %i.apc, %.lr.ph.i443 ] ; 3 uses
