...
addbyte.exit94:                                   ; preds = %bb.ef, %bb.ax, %bb.ex, %bb.eu, %bb.ep, %bb.em, %addbyte.exit233, %bb.ee, %bb.eb, %bb.dz, %bb.dm, %bb.dj, %addbyte.exit187, %bb.dc, %bb.cz, %._crit_edge, %bb.bh, %bb.be, %addbyte.exit87, %bb.eq, %bb.er, %bb.es, %addbyte.exit201, %bb.bu, %bb.bt, %def_label.exit, %bb.ah, %bb.ag
  ...
  %.sroa.0.1 = phi i64 [ %.sroa.0.0297, %bb.ep ], [ %.sroa.0.0297, %bb.ah ], [ %.sroa.0.0297, %def_label.exit ], [ %.sroa.0.0297, %bb.ag ], [ %1, %bb.bt ], [ %.sroa.0.0297, %bb.bu ], [ %.sroa.0.0297, %bb.bh ], [ %.sroa.0.0297, %bb.dc ], [ %.sroa.0.0297, %addbyte.exit201 ], [ %.sroa.0.0297, %bb.dm ], [ %.sroa.0.0297, %bb.ee ], [ %.sroa.0.0297, %bb.eq ], [ %.sroa.0.0297, %bb.er ], [ %.sroa.0.0297, %bb.es ], [ %.sroa.0.0297, %bb.ex ], [ %.sroa.0.0297, %addbyte.exit87 ], [ %.sroa.0.0297, %bb.be ], [ %.sroa.0.0297, %._crit_edge ], [ %.sroa.0.0297, %bb.cz ], [ %.sroa.0.0297, %addbyte.exit187 ], [ %.sroa.0.0297, %bb.dj ], [ %.sroa.0.0297, %bb.dz ], [ %.sroa.0.0297, %bb.eb ], [ %.sroa.0.0297, %bb.ax ], [ %.sroa.0.0297, %addbyte.exit233 ], [ %.sroa.0.0297, %bb.em ], [ %.sroa.0.0297, %bb.eu ], [ %.sroa.0.0297, %bb.ef ]
...
addbyte.exit:                                     ; preds = %bb.af, %bb.ac, %bb.aa, %bb.x, %bb.u, %bb.r, %bb.p, %bb.m, %bb.h, %bb.e, %addbyte.exit94, %bb.k
  ...
  %.sroa.0.2 = phi i64 [ %.sroa.0.1, %addbyte.exit94 ], [ %.sroa.0.0297, %bb.u ], [ %.sroa.0.0297, %bb.aa ], [ %.sroa.0.0297, %bb.k ], [ %.sroa.0.0297, %bb.h ], [ %.sroa.0.0297, %bb.p ], [ %.sroa.0.0297, %bb.e ], [ %.sroa.0.0297, %bb.m ], [ %.sroa.0.0297, %bb.r ], [ %.sroa.0.0297, %bb.x ], [ %.sroa.0.0297, %bb.ac ], [ %.sroa.0.0297, %bb.af ]
