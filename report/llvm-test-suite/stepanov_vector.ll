...
begin_hunk_0_@main:bb.a
  ...
  %i.l = load ptr, ptr @dpb, align 8, !tbaa !33   ; 5 uses
  %i.m = load ptr, ptr @dpe, align 8, !tbaa !33   ; 3 uses
  %i.n = load double, ptr @init_value, align 8, !tbaa !32 ; 2 uses
  %.not4.i = icmp eq ptr %i.l, %i.m
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i, label %.lr.ph.i.preheader1168
...
begin_hunk_2_@main:bb.a
  ...
  br i1 %.not.i, label %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i, label %.lr.ph.i, !llvm.loop !38

_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i:  ; preds = %.lr.ph.i, %middle.block, %.thread
  ...
  %26 = load double, ptr @init_value, align 8, !tbaa !32 ; 2 uses
  %broadcast.splatinsert984 = insertelement <2 x double> poison, double %26, i64 0
...
begin_hunk_3_@main:bb.a
  ...
  %27 = load ptr, ptr @dpb, align 8, !tbaa !33    ; 2 uses
  %28 = load ptr, ptr @dpe, align 8, !tbaa !33    ; 2 uses
...
.lr.ph.i67:                                       ; preds = %_ZN9benchmark4fillIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEdEEvT_S8_T0_.exit
  %.not6.i.i = icmp eq ptr %27, %28
  br i1 %.not6.i.i, label %_ZN9benchmark10accumulateIPddEET0_T_S3_S2_.exit.us.i, label %.lr.ph.i.preheader.i
...
_ZN9benchmark10accumulateIPddEET0_T_S3_S2_.exit.us.i: ; preds = %.lr.ph.i67, %_Z9check_sumd.exit.us.i
  ...
  %i.ax = phi double [ %i.bd, %_Z9check_sumd.exit.us.i ], [ %26, %.lr.ph.i67 ] ; 2 uses
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.i.preheader.i
  ...
  %.057.i.i = phi ptr [ %i.bh, %.lr.ph.i.i ], [ %27, %.lr.ph.i.preheader.i ] ; 2 uses
