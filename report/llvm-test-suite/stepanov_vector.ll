...
vector.body986:                                   ; preds = %vector.body986, %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i
  ...
  %i.z = shl nuw nsw i64 %index987, 3
...
_Z13verify_sortedISt16reverse_iteratorIS0_IN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEEEEvT_SA_.exit.i: ; preds = %_ZN9benchmark13insertionSortISt16reverse_iteratorIS1_IN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEEEdEEvT_SB_.exit.i.2, %_ZN9benchmark9is_sortedISt16reverse_iteratorIS1_IN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEEEEEbT_SB_.exit.i.i
  %.pr671 = phi i32 [ %.pre.i213, %_ZN9benchmark9is_sortedISt16reverse_iteratorIS1_IN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEEEEEbT_SB_.exit.i.i ], [ %i.qc, %_ZN9benchmark13insertionSortISt16reverse_iteratorIS1_IN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEEEdEEvT_SB_.exit.i.2 ] ; 5 uses
end_hunk_1
...
.lr.ph.i244.preheader:                            ; preds = %bb.ag
  %.not2.i.i245 = icmp eq ptr %i.sc, %i.sd
  %i.si = getelementptr inbounds i8, ptr %i.se, i64 -8
  br label %.lr.ph.i244

.lr.ph.i244:                                      ; preds = %.lr.ph.i244.preheader, %_Z13verify_sortedISt16reverse_iteratorIPdEEvT_S3_.exit.i252
  %.08.i = phi i32 [ %i.sv, %_Z13verify_sortedISt16reverse_iteratorIPdEEvT_S3_.exit.i252 ], [ 0, %.lr.ph.i244.preheader ]
...
.lr.ph.i.i246:                                    ; preds = %.lr.ph.i244, %.lr.ph.i.i246
  %.sroa.03.0.i = phi ptr [ %i.sm, %.lr.ph.i.i246 ], [ %i.se, %.lr.ph.i244 ]
  %i.sj = phi ptr [ %i.sk, %.lr.ph.i.i246 ], [ %i.sc, %.lr.ph.i244 ]
  %i.sk = getelementptr inbounds i8, ptr %i.sj, i64 -8 ; 3 uses
  %i.sl = load double, ptr %i.sk, align 8, !tbaa !32
  %i.sm = getelementptr inbounds i8, ptr %.sroa.03.0.i, i64 -8 ; 2 uses
...
_ZN9benchmark4copyISt16reverse_iteratorIS1_IPdEES4_EEvT_S5_T0_.exit.i291: ; preds = %.lr.ph.i.i288, %middle.block1037, %bb.aj
  store ptr %i.ur, ptr %i.uv, align 8, !tbaa !44
  store ptr %i.us, ptr %i.uw, align 8, !tbaa !44
...
_ZN9benchmark9is_sortedISt16reverse_iteratorIS1_IN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEEEEEbT_SB_.exit.i.i324: ; preds = %bb.an, %.noexc326.1, %.noexc326, %.noexc326.preheader
  %i.wz = load i32, ptr @current_test, align 4, !tbaa !4
end_hunk_2
...
.lr.ph.i328.preheader:                            ; preds = %bb.ap
  %.not2.i.i330 = icmp eq ptr %i.xi, %i.xj
  %i.xo = getelementptr inbounds i8, ptr %i.xk, i64 -8
  br label %.lr.ph.i328

.lr.ph.i328:                                      ; preds = %.lr.ph.i328.preheader, %_Z13verify_sortedISt16reverse_iteratorIPdEEvT_S3_.exit.i338
  %.08.i329 = phi i32 [ %i.yb, %_Z13verify_sortedISt16reverse_iteratorIPdEEvT_S3_.exit.i338 ], [ 0, %.lr.ph.i328.preheader ]
...
.lr.ph.i.i331:                                    ; preds = %.lr.ph.i328, %.lr.ph.i.i331
  %.sroa.03.0.i332 = phi ptr [ %i.xs, %.lr.ph.i.i331 ], [ %i.xk, %.lr.ph.i328 ]
  %i.xp = phi ptr [ %i.xq, %.lr.ph.i.i331 ], [ %i.xi, %.lr.ph.i328 ]
  %i.xq = getelementptr inbounds i8, ptr %i.xp, i64 -8 ; 3 uses
  %i.xr = load double, ptr %i.xq, align 8, !tbaa !32
  %i.xs = getelementptr inbounds i8, ptr %.sroa.03.0.i332, i64 -8 ; 2 uses
...
_ZN9benchmark4copyISt16reverse_iteratorIS1_IPdEES4_EEvT_S5_T0_.exit.i377: ; preds = %.lr.ph.i.i374, %middle.block1055, %bb.as
  store ptr %i.zx, ptr %i.aab, align 8, !tbaa !44
  store ptr %i.zy, ptr %i.aac, align 8, !tbaa !44
