...
vector.ph993:                                     ; preds = %.lr.ph.i146.preheader
  %n.vec995 = and i64 %i.kh, 4611686018427387900  ; 3 uses
  %i.kj = shl i64 %n.vec995, 3                    ; 2 uses
  %i.kk = getelementptr i8, ptr %i.ka, i64 %i.kj
  %i.kl = getelementptr i8, ptr %i.jr, i64 %i.kj
  br label %vector.body996

vector.body996:                                   ; preds = %vector.body996, %vector.ph993
  %index997 = phi i64 [ 0, %vector.ph993 ], [ %index.next1003, %vector.body996 ] ; 2 uses
  %offset.idx998 = shl i64 %index997, 3           ; 2 uses
  %next.gep999 = getelementptr i8, ptr %i.ka, i64 %offset.idx998 ; 2 uses
  %next.gep1001 = getelementptr i8, ptr %i.jr, i64 %offset.idx998 ; 2 uses
...
begin_hunk_1_@main:bb.a
  ...
  %n.vec1014 = and i64 %i.lj, 4611686018427387900 ; 3 uses
  %i.lk = mul i64 %n.vec1014, -8                  ; 2 uses
...
vector.body1015:                                  ; preds = %.lr.ph.i.i150.preheader, %vector.body1015
  %index1016 = phi i64 [ %index.next1026, %vector.body1015 ], [ 0, %.lr.ph.i.i150.preheader ] ; 2 uses
  %offset.idx1017 = mul i64 %index1016, -8        ; 2 uses
  %next.gep1018 = getelementptr i8, ptr %i.kw, i64 %offset.idx1017 ; 2 uses
  %next.gep1020 = getelementptr i8, ptr %i.ku, i64 %offset.idx1017 ; 2 uses
...
begin_hunk_3_@main:bb.a
  ...
  %n.vec1037 = and i64 %i.pw, 4611686018427387900 ; 3 uses
  %i.px = shl i64 %n.vec1037, 3                   ; 2 uses
  %i.py = getelementptr i8, ptr %i.pl, i64 %i.px
  %i.pz = getelementptr i8, ptr %i.pj, i64 %i.px
...
vector.body1038:                                  ; preds = %.lr.ph.i.i190.preheader, %vector.body1038
  %index1039 = phi i64 [ %index.next1046, %vector.body1038 ], [ 0, %.lr.ph.i.i190.preheader ] ; 2 uses
  %offset.idx1040 = shl i64 %index1039, 3         ; 2 uses
  %next.gep1041 = getelementptr i8, ptr %i.pl, i64 %offset.idx1040 ; 2 uses
  %next.gep1043 = getelementptr i8, ptr %i.pj, i64 %offset.idx1040 ; 2 uses
...
begin_hunk_5_@main:bb.a
  ...
  %n.vec1057 = and i64 %i.tl, 4611686018427387900 ; 3 uses
  %i.tm = mul i64 %n.vec1057, -8                  ; 2 uses
  %i.tn = getelementptr i8, ptr %i.sy, i64 %i.tm
  %i.to = getelementptr i8, ptr %i.sw, i64 %i.tm
...
vector.body1058:                                  ; preds = %.lr.ph.i.i246.preheader, %vector.body1058
  %index1059 = phi i64 [ %index.next1070, %vector.body1058 ], [ 0, %.lr.ph.i.i246.preheader ] ; 2 uses
  %offset.idx1060 = mul i64 %index1059, -8        ; 2 uses
  %next.gep1061 = getelementptr i8, ptr %i.sy, i64 %offset.idx1060 ; 2 uses
  %next.gep1063 = getelementptr i8, ptr %i.sw, i64 %offset.idx1060 ; 2 uses
...
begin_hunk_7_@main:bb.a
  ...
  %n.vec1081 = and i64 %i.wp, 4611686018427387900 ; 3 uses
  %i.wq = shl i64 %n.vec1081, 3                   ; 2 uses
  %i.wr = getelementptr i8, ptr %i.wc, i64 %i.wq
  %i.ws = getelementptr i8, ptr %i.wa, i64 %i.wq
...
vector.body1082:                                  ; preds = %.lr.ph.i.i288.preheader, %vector.body1082
  %index1083 = phi i64 [ %index.next1090, %vector.body1082 ], [ 0, %.lr.ph.i.i288.preheader ] ; 2 uses
  %offset.idx1084 = shl i64 %index1083, 3         ; 2 uses
  %next.gep1085 = getelementptr i8, ptr %i.wc, i64 %offset.idx1084 ; 2 uses
  %next.gep1087 = getelementptr i8, ptr %i.wa, i64 %offset.idx1084 ; 2 uses
...
begin_hunk_9_@main:bb.a
  ...
  %n.vec1101 = and i64 %i.zk, 4611686018427387900 ; 3 uses
  %i.zl = mul i64 %n.vec1101, -8                  ; 2 uses
  %i.zm = getelementptr i8, ptr %i.yx, i64 %i.zl
  %i.zn = getelementptr i8, ptr %i.yv, i64 %i.zl
...
vector.body1102:                                  ; preds = %.lr.ph.i.i331.preheader, %vector.body1102
  %index1103 = phi i64 [ %index.next1114, %vector.body1102 ], [ 0, %.lr.ph.i.i331.preheader ] ; 2 uses
  %offset.idx1104 = mul i64 %index1103, -8        ; 2 uses
  %next.gep1105 = getelementptr i8, ptr %i.yx, i64 %offset.idx1104 ; 2 uses
  %next.gep1107 = getelementptr i8, ptr %i.yv, i64 %offset.idx1104 ; 2 uses
...
begin_hunk_11_@main:bb.a
  ...
  %n.vec1125 = and i64 %i.aco, 4611686018427387900 ; 3 uses
  %i.acp = shl i64 %n.vec1125, 3                  ; 2 uses
  %i.acq = getelementptr i8, ptr %i.acb, i64 %i.acp
  %i.acr = getelementptr i8, ptr %i.abz, i64 %i.acp
...
vector.body1126:                                  ; preds = %.lr.ph.i.i374.preheader, %vector.body1126
  %index1127 = phi i64 [ %index.next1134, %vector.body1126 ], [ 0, %.lr.ph.i.i374.preheader ] ; 2 uses
  %offset.idx1128 = shl i64 %index1127, 3         ; 2 uses
  %next.gep1129 = getelementptr i8, ptr %i.acb, i64 %offset.idx1128 ; 2 uses
  %next.gep1131 = getelementptr i8, ptr %i.abz, i64 %offset.idx1128 ; 2 uses
