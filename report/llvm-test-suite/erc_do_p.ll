...
bb.e:                                             ; preds = %bb.c, %bb.d
  ...
  %3 = select i1 %i.ez, i32 2, i32 1              ; 2 uses
...
bb.i:                                             ; preds = %.lr.ph, %.loopexit
  ...
  %4 = load i16, ptr %i.hr, align 2, !tbaa !61
  %5 = sext i16 %4 to i32
  %6 = sdiv i32 %5, %3                            ; 4 uses
  %7 = getelementptr inbounds nuw i8, ptr %i.hr, i64 2
  %8 = load i16, ptr %7, align 2, !tbaa !61
  %9 = sext i16 %8 to i32
  %10 = sdiv i32 %9, %3                           ; 4 uses
  ...
  store i16 %11, ptr %i.id, align 2, !tbaa !61
  %12 = trunc nsw i32 %10 to i16
  %13 = getelementptr inbounds nuw i8, ptr %i.id, i64 2
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %i.jh = add nsw i32 %6, %i.jg
  %i.ji = add nsw i32 %10, %i.hg
...
.preheader.preheader.i:                           ; preds = %bb.k
  ...
  %i.mq = add i32 %i.mp, %6                       ; 3 uses
  %i.mr = mul i32 %i.lx, %i.lo
  %i.ms = add i32 %i.mr, %10                      ; 3 uses
