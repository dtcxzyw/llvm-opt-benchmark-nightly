...
vector.body:                                      ; preds = %vector.main.loop.iter.check, %vector.body
  ...
  %offset.idx = add i64 %index, %i.ec             ; 3 uses
  %i.fj = trunc i64 %offset.idx to i32
  %.reass29 = add i32 %invariant.op, %i.fj
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.fv = add i64 %index22, %i.ec                 ; 3 uses
  %i.fw = trunc i64 %i.fv to i32
  %.reass31 = add i32 %invariant.op, %i.fw
