...
.preheader1391.i:                                 ; preds = %CreateDecodeTables.exit.i, %.preheader1391.lr.ph.i
  ...
  br i1 %1, label %.lr.ph1534.i, label %.preheader68.i.thread2016.i

.preheader68.i.thread2016.i:                      ; preds = %.preheader1391.i
...
middle.block541:                                  ; preds = %vector.body533
  ...
  br i1 %cmp.n543, label %._crit_edge1535.i, label %scalar.ph528.preheader
...
scalar.ph528:                                     ; preds = %scalar.ph528.preheader, %scalar.ph528
  ...
  br i1 %exitcond1746.not.i, label %._crit_edge1535.i, label %scalar.ph528, !llvm.loop !94

._crit_edge1535.i:                                ; preds = %scalar.ph528, %middle.block541
...
.preheader69.i.i:                                 ; preds = %._crit_edge.i.i, %._crit_edge1535.i
  %.05774.i.i = phi i32 [ %i.awh, %._crit_edge.i.i ], [ %.1.i.lcssa, %._crit_edge1535.i ] ; 5 uses
  %.05873.i.i = phi i32 [ %.260.i.i.lcssa, %._crit_edge.i.i ], [ 0, %._crit_edge1535.i ] ; 2 uses
  br i1 %i.anv, label %.epil.preheader, label %.preheader69.i.i.new
...
.preheader69.i.i.new:                             ; preds = %.preheader69.i.i, %bb.eg
  %indvars.iv.i1359.i = phi i64 [ %indvars.iv.next.i1360.i.1, %bb.eg ], [ 0, %.preheader69.i.i ] ; 4 uses
  %.15970.i.i = phi i32 [ %.260.i.i.1, %bb.eg ], [ %.05873.i.i, %.preheader69.i.i ] ; 3 uses
  %niter = phi i64 [ %niter.next.1, %bb.eg ], [ 0, %.preheader69.i.i ]
  ...
  %i.avm = icmp eq i32 %.05774.i.i, %i.avl
  br i1 %i.avm, label %bb.ed, label %bb.ee

bb.ed:                                            ; preds = %.preheader69.i.i.new
  %i.avn = sext i32 %.15970.i.i to i64
  ...
  %i.avq = add nsw i32 %.15970.i.i, 1
  br label %bb.ee

bb.ee:                                            ; preds = %bb.ed, %.preheader69.i.i.new
  %.260.i.i = phi i32 [ %i.avq, %bb.ed ], [ %.15970.i.i, %.preheader69.i.i.new ] ; 3 uses
  ...
  %i.avu = icmp eq i32 %.05774.i.i, %i.avt
  br i1 %i.avu, label %bb.ef, label %bb.eg

bb.ef:                                            ; preds = %bb.ee
  %i.avv = sext i32 %.260.i.i to i64
  ...
  %i.avy = add nsw i32 %.260.i.i, 1
  br label %bb.eg

bb.eg:                                            ; preds = %bb.ef, %bb.ee
  %.260.i.i.1 = phi i32 [ %i.avy, %bb.ef ], [ %.260.i.i, %bb.ee ] ; 3 uses
  %indvars.iv.next.i1360.i.1 = add nuw nsw i64 %indvars.iv.i1359.i, 2 ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.i.i.unr-lcssa, label %.preheader69.i.i.new, !llvm.loop !95

._crit_edge.i.i.unr-lcssa:                        ; preds = %bb.eg
  br i1 %lcmp.mod721.not, label %._crit_edge.i.i, label %.epil.preheader

.epil.preheader:                                  ; preds = %._crit_edge.i.i.unr-lcssa, %.preheader69.i.i
  %indvars.iv.i1359.i.epil.init = phi i64 [ 0, %.preheader69.i.i ], [ %indvars.iv.next.i1360.i.1, %._crit_edge.i.i.unr-lcssa ] ; 2 uses
  %.15970.i.i.epil.init = phi i32 [ %.05873.i.i, %.preheader69.i.i ], [ %.260.i.i.1, %._crit_edge.i.i.unr-lcssa ] ; 3 uses
  ...
  %i.awc = icmp eq i32 %.05774.i.i, %i.awb
  br i1 %i.awc, label %bb.eh, label %._crit_edge.i.i

bb.eh:                                            ; preds = %.epil.preheader
  %i.awd = sext i32 %.15970.i.i.epil.init to i64
  ...
  %i.awg = add nsw i32 %.15970.i.i.epil.init, 1
  br label %._crit_edge.i.i

._crit_edge.i.i:                                  ; preds = %.epil.preheader, %bb.eh, %._crit_edge.i.i.unr-lcssa
  %.260.i.i.lcssa = phi i32 [ %.260.i.i.1, %._crit_edge.i.i.unr-lcssa ], [ %i.awg, %bb.eh ], [ %.15970.i.i.epil.init, %.epil.preheader ]
  %i.awh = add nuw nsw i32 %.05774.i.i, 1
  %exitcond88.not.i.i = icmp eq i32 %.05774.i.i, %spec.select.i.lcssa
  br i1 %exitcond88.not.i.i, label %.preheader68.i.i, label %.preheader69.i.i, !llvm.loop !96
...
.preheader66.i.i:                                 ; preds = %.preheader66.loopexit.i.i, %.preheader68.i.thread2016.i
  %.0925.lcssa20082014.i = phi i32 [ %spec.select.i.lcssa, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ] ; 5 uses
  %.0922.lcssa20092012.i = phi i32 [ %.1.i.lcssa, %.preheader66.loopexit.i.i ], [ 32, %.preheader68.i.thread2016.i ] ; 7 uses
  %i.awp = phi i32 [ %.pre1916.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.awq = phi i32 [ %.pre1914.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.awr = phi i32 [ %.pre151.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.aws = phi i32 [ %.pre149.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.awt = phi i32 [ %.pre147.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.awu = phi i32 [ %.pre145.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.awv = phi i32 [ %.pre143.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.aww = phi i32 [ %.pre141.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.awx = phi i32 [ %.pre139.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.awy = phi i32 [ %.pre137.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.awz = phi i32 [ %.pre135.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.axa = phi i32 [ %.pre133.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.axb = phi i32 [ %.pre131.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.axc = phi i32 [ %.pre129.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.axd = phi i32 [ %.pre127.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.axe = phi i32 [ %.pre125.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.axf = phi i32 [ %.pre123.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.axg = phi i32 [ %.pre121.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.axh = phi i32 [ %.pre119.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.axi = phi i32 [ %.pre117.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.axj = phi i32 [ %.pre115.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ]
  %i.axk = phi i32 [ %.pre.i.i, %.preheader66.loopexit.i.i ], [ 0, %.preheader68.i.thread2016.i ] ; 2 uses
  ...
  %.not6279.i.i = icmp samesign ugt i32 %.0922.lcssa20092012.i, %.0925.lcssa20082014.i
...
.lr.ph82.preheader.i.i:                           ; preds = %.preheader66.i.i
  %i.baj = zext nneg i32 %.0922.lcssa20092012.i to i64 ; 3 uses
  %i.bak = add nuw nsw i32 %.0925.lcssa20082014.i, 1
  ...
  %narrow = sub nuw i32 %i.bak, %.0922.lcssa20092012.i ; 2 uses
  %3 = zext i32 %narrow to i64                    ; 2 uses
  %xtraiter729 = and i64 %3, 1
  %i.bal = icmp eq i32 %.0925.lcssa20082014.i, %.0922.lcssa20092012.i
...
.lr.ph82.preheader.i.i.new:                       ; preds = %.lr.ph82.preheader.i.i
  %unroll_iter733 = and i64 %3, 4294967294
...
.lr.ph82.i.i.epil.preheader:                      ; preds = %.preheader.i.i.loopexit.unr-lcssa, %.lr.ph82.preheader.i.i
  ...
  %lcmp.mod732 = trunc i32 %narrow to i1
...
.preheader.i.i:                                   ; preds = %.lr.ph82.i.i.epil.preheader, %.preheader.i.i.loopexit.unr-lcssa, %.preheader66.i.i
  %.not63.not83.i.i = icmp samesign ult i32 %.0922.lcssa20092012.i, %.0925.lcssa20082014.i
...
.lr.ph85.preheader.i.i:                           ; preds = %.preheader.i.i
  %i.bat = zext i32 %.0922.lcssa20092012.i to i64 ; 4 uses
  %wide.trip.count112.i.i = zext nneg i32 %.0925.lcssa20082014.i to i64 ; 2 uses
...
CreateDecodeTables.exit.i:                        ; preds = %.lr.ph85.i.i, %middle.block525, %.preheader.i.i
  ...
  store i32 %.0922.lcssa20092012.i, ptr %i.bca, align 4, !tbaa !4
