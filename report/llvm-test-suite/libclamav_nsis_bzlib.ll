...
vector.body547.2:                                 ; preds = %vector.body547.1
  ...
  %wide.load549.2 = load <16 x i8>, ptr %i.avl, align 1, !tbaa !34
  %wide.load550.2 = load <16 x i8>, ptr %i.avm, align 1, !tbaa !34
  ...
  store <16 x i8> %wide.load549.2, ptr %i.avo, align 1, !tbaa !34
  store <16 x i8> %wide.load550.2, ptr %i.avp, align 1, !tbaa !34
  %i.avq = icmp eq i64 %n.vec546, 96
  br i1 %i.avq, label %middle.block552, label %vector.body547.3

vector.body547.3:                                 ; preds = %vector.body547.2
  ...
  %wide.load549.3 = load <16 x i8>, ptr %i.avu, align 1, !tbaa !34
  %wide.load550.3 = load <16 x i8>, ptr %i.avv, align 1, !tbaa !34
  ...
  store <16 x i8> %wide.load549.3, ptr %i.avx, align 1, !tbaa !34
  store <16 x i8> %wide.load550.3, ptr %i.avy, align 1, !tbaa !34
  %i.avz = icmp eq i64 %n.vec546, 128
  br i1 %i.avz, label %middle.block552, label %vector.body547.4

vector.body547.4:                                 ; preds = %vector.body547.3
  ...
  %wide.load549.4 = load <16 x i8>, ptr %i.awd, align 1, !tbaa !34
  %wide.load550.4 = load <16 x i8>, ptr %i.awe, align 1, !tbaa !34
  ...
  store <16 x i8> %wide.load549.4, ptr %i.awg, align 1, !tbaa !34
  store <16 x i8> %wide.load550.4, ptr %i.awh, align 1, !tbaa !34
  %i.awi = icmp eq i64 %n.vec546, 160
  br i1 %i.awi, label %middle.block552, label %vector.body547.5

vector.body547.5:                                 ; preds = %vector.body547.4
  ...
  %wide.load549.5 = load <16 x i8>, ptr %i.awm, align 1, !tbaa !34
  %wide.load550.5 = load <16 x i8>, ptr %i.awn, align 1, !tbaa !34
  ...
  store <16 x i8> %wide.load549.5, ptr %i.awp, align 1, !tbaa !34
  store <16 x i8> %wide.load550.5, ptr %i.awq, align 1, !tbaa !34
  %i.awr = icmp eq i64 %n.vec546, 192
  br i1 %i.awr, label %middle.block552, label %vector.body547.6

vector.body547.6:                                 ; preds = %vector.body547.5
  ...
  %wide.load549.6 = load <16 x i8>, ptr %i.awv, align 1, !tbaa !34
  %wide.load550.6 = load <16 x i8>, ptr %i.aww, align 1, !tbaa !34
  ...
  store <16 x i8> %wide.load549.6, ptr %i.awy, align 1, !tbaa !34
  store <16 x i8> %wide.load550.6, ptr %i.awz, align 1, !tbaa !34
  br label %middle.block552

middle.block552:                                  ; preds = %vector.body547.6, %vector.body547.5, %vector.body547.4, %vector.body547.3, %vector.body547.2, %vector.body547.1, %vector.ph544
  %cmp.n553 = icmp eq i64 %n.vec546, %i.aud
  br i1 %cmp.n553, label %._crit_edge1526.i, label %vec.epilog.iter.check558

vec.epilog.iter.check558:                         ; preds = %middle.block552
  %min.epilog.iters.check559 = icmp eq i64 %n.mod.vf545, 0
  br i1 %min.epilog.iters.check559, label %.lr.ph1525.i.preheader, label %vec.epilog.ph560, !prof !85

vec.epilog.ph560:                                 ; preds = %vector.main.loop.iter.check542, %vec.epilog.iter.check558
  %vec.epilog.resume.val554 = phi i64 [ %n.vec546, %vec.epilog.iter.check558 ], [ 0, %vector.main.loop.iter.check542 ]
  %n.vec562 = and i64 %i.aud, 252                 ; 2 uses
  %i.axa = and i64 %i.aud, 3
  br label %vec.epilog.vector.body563

vec.epilog.vector.body563:                        ; preds = %vec.epilog.vector.body563, %vec.epilog.ph560
  %index564 = phi i64 [ %vec.epilog.resume.val554, %vec.epilog.ph560 ], [ %index.next566, %vec.epilog.vector.body563 ] ; 2 uses
  %i.axb = sub i64 %i.aud, %index564              ; 2 uses
  ...
  %i.axf = getelementptr inbounds i8, ptr %i.axe, i64 -3
  %wide.load565 = load <4 x i8>, ptr %i.axf, align 1, !tbaa !34
  %i.axg = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.axb
  %i.axh = getelementptr inbounds i8, ptr %i.axg, i64 -3
  store <4 x i8> %wide.load565, ptr %i.axh, align 1, !tbaa !34
  %index.next566 = add nuw i64 %index564, 4       ; 2 uses
  %i.axi = icmp eq i64 %index.next566, %n.vec562
  br i1 %i.axi, label %vec.epilog.middle.block567, label %vec.epilog.vector.body563, !llvm.loop !88

vec.epilog.middle.block567:                       ; preds = %vec.epilog.vector.body563
  %cmp.n568 = icmp eq i64 %n.vec562, %i.aud
  br i1 %cmp.n568, label %._crit_edge1526.i, label %.lr.ph1525.i.preheader

.lr.ph1525.i.preheader:                           ; preds = %vector.memcheck538, %vector.scevcheck537, %iter.check556, %vec.epilog.iter.check558, %vec.epilog.middle.block567
  %indvars.iv.i.ph = phi i64 [ %i.aud, %iter.check556 ], [ %i.aud, %vector.scevcheck537 ], [ %i.aud, %vector.memcheck538 ], [ %i.aup, %vec.epilog.iter.check558 ], [ %i.axa, %vec.epilog.middle.block567 ] ; 6 uses
...
._crit_edge1526.i:                                ; preds = %.lr.ph1525.i.prol.loopexit, %.lr.ph1525.i, %middle.block552, %vec.epilog.middle.block567, %bb.dj
  ...
  br i1 %exitcond.not.i, label %._crit_edge1529.i, label %bb.dj, !llvm.loop !90
...
.preheader1391.lr.ph.i:                           ; preds = %.preheader1392.i
  ...
  %min.iters.check520 = icmp ult i32 %.5988.i, 8
  %n.vec523 = and i64 %wide.trip.count.i.i, 2147483640 ; 3 uses
  %cmp.n534 = icmp eq i64 %n.vec523, %wide.trip.count.i.i
  %xtraiter740 = and i64 %wide.trip.count.i.i, 1
  %i.ayw = icmp eq i32 %.5988.i, 1
  %unroll_iter = and i64 %wide.trip.count.i.i, 2147483646
  %lcmp.mod741.not = icmp eq i64 %xtraiter740, 0
  %lcmp.mod743 = trunc i32 %.5988.i to i1
  %xtraiter744 = and i64 %wide.trip.count.i.i, 3  ; 3 uses
  %i.ayx = icmp ult i32 %.5988.i, 4
  %unroll_iter747 = and i64 %wide.trip.count.i.i, 2147483644
  %lcmp.mod745.not = icmp eq i64 %xtraiter744, 0
  %lcmp.mod746 = icmp ne i64 %xtraiter744, 0
...
bb.ec:                                            ; preds = %._crit_edge1643.i
  ...
  br label %bb.dq, !llvm.loop !91

bb.ed:                                            ; preds = %bb.dq
  %i.bfs = add nsw i32 %.2966.i, 1
  br label %bb.dk, !llvm.loop !92
...
.lr.ph1534.i:                                     ; preds = %.preheader1391.i
  ...
  br i1 %min.iters.check520, label %scalar.ph519.preheader, label %vector.body524

vector.body524:                                   ; preds = %.lr.ph1534.i, %vector.body524
  %index525 = phi i64 [ %index.next531, %vector.body524 ], [ 0, %.lr.ph1534.i ] ; 2 uses
  %vec.phi = phi <4 x i32> [ %i.bgb, %vector.body524 ], [ splat (i32 32), %.lr.ph1534.i ]
  %vec.phi526 = phi <4 x i32> [ %i.bgc, %vector.body524 ], [ splat (i32 32), %.lr.ph1534.i ]
  %vec.phi527 = phi <4 x i32> [ %i.bfz, %vector.body524 ], [ zeroinitializer, %.lr.ph1534.i ]
  %vec.phi528 = phi <4 x i32> [ %i.bga, %vector.body524 ], [ zeroinitializer, %.lr.ph1534.i ]
  %i.bfv = getelementptr inbounds nuw i8, ptr %i.bfu, i64 %index525 ; 2 uses
  %i.bfw = getelementptr inbounds nuw i8, ptr %i.bfv, i64 4
  %wide.load529 = load <4 x i8>, ptr %i.bfv, align 1, !tbaa !34
  %wide.load530 = load <4 x i8>, ptr %i.bfw, align 1, !tbaa !34
  %i.bfx = zext <4 x i8> %wide.load529 to <4 x i32> ; 2 uses
  %i.bfy = zext <4 x i8> %wide.load530 to <4 x i32> ; 2 uses
  %i.bfz = tail call <4 x i32> @llvm.umax.v4i32(<4 x i32> %vec.phi527, <4 x i32> %i.bfx) ; 2 uses
  %i.bga = tail call <4 x i32> @llvm.umax.v4i32(<4 x i32> %vec.phi528, <4 x i32> %i.bfy) ; 2 uses
  %i.bgb = tail call <4 x i32> @llvm.umin.v4i32(<4 x i32> %vec.phi, <4 x i32> %i.bfx) ; 2 uses
  %i.bgc = tail call <4 x i32> @llvm.umin.v4i32(<4 x i32> %vec.phi526, <4 x i32> %i.bfy) ; 2 uses
  %index.next531 = add nuw i64 %index525, 8       ; 2 uses
  %i.bgd = icmp eq i64 %index.next531, %n.vec523
  br i1 %i.bgd, label %middle.block532, label %vector.body524, !llvm.loop !93

middle.block532:                                  ; preds = %vector.body524
  ...
  %rdx.minmax533 = tail call <4 x i32> @llvm.umax.v4i32(<4 x i32> %i.bfz, <4 x i32> %i.bga)
  %i.bgf = tail call i32 @llvm.vector.reduce.umax.v4i32(<4 x i32> %rdx.minmax533) ; 2 uses
  br i1 %cmp.n534, label %.preheader69.us.i.preheader.i, label %scalar.ph519.preheader

scalar.ph519.preheader:                           ; preds = %.lr.ph1534.i, %middle.block532
  %indvars.iv1741.i.ph = phi i64 [ 0, %.lr.ph1534.i ], [ %n.vec523, %middle.block532 ]
  %.09221533.i.ph = phi i32 [ 32, %.lr.ph1534.i ], [ %i.bge, %middle.block532 ]
  %.09251532.i.ph = phi i32 [ 0, %.lr.ph1534.i ], [ %i.bgf, %middle.block532 ]
  br label %scalar.ph519

scalar.ph519:                                     ; preds = %scalar.ph519.preheader, %scalar.ph519
  %indvars.iv1741.i = phi i64 [ %indvars.iv.next1742.i, %scalar.ph519 ], [ %indvars.iv1741.i.ph, %scalar.ph519.preheader ] ; 2 uses
  %.09221533.i = phi i32 [ %.1.i, %scalar.ph519 ], [ %.09221533.i.ph, %scalar.ph519.preheader ]
  %.09251532.i = phi i32 [ %spec.select.i, %scalar.ph519 ], [ %.09251532.i.ph, %scalar.ph519.preheader ]
  ...
  br i1 %exitcond1746.not.i, label %.preheader69.us.i.preheader.i, label %scalar.ph519, !llvm.loop !94

.preheader69.us.i.preheader.i:                    ; preds = %scalar.ph519, %middle.block532
  %spec.select.i.lcssa = phi i32 [ %i.bgf, %middle.block532 ], [ %spec.select.i, %scalar.ph519 ] ; 2 uses
  %.1.i.lcssa = phi i32 [ %i.bge, %middle.block532 ], [ %.1.i, %scalar.ph519 ] ; 2 uses
...
._crit_edge.us.i.i.unr-lcssa:                     ; preds = %bb.eh
  br i1 %lcmp.mod741.not, label %._crit_edge.us.i.i, label %.epil.preheader
...
.preheader66.loopexit.i.i.unr-lcssa:              ; preds = %.lr.ph.i.i
  br i1 %lcmp.mod745.not, label %.preheader66.loopexit.i.i, label %.lr.ph.i.i.epil.preheader
...
.lr.ph.i.i.epil.preheader:                        ; preds = %.preheader66.loopexit.i.i.unr-lcssa, %.preheader68.i.i
  ...
  tail call void @llvm.assume(i1 %lcmp.mod746)
...
.lr.ph.i.i.epil:                                  ; preds = %.lr.ph.i.i.epil, %.lr.ph.i.i.epil.preheader
  ...
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter744
...
.lr.ph.i.i:                                       ; preds = %.preheader68.i.i, %.lr.ph.i.i
  ...
  %niter748 = phi i64 [ %niter748.next.3, %.lr.ph.i.i ], [ 0, %.preheader68.i.i ]
  ...
  %niter748.next.3 = add i64 %niter748, 4         ; 2 uses
  %niter748.ncmp.3 = icmp eq i64 %niter748.next.3, %unroll_iter747
  br i1 %niter748.ncmp.3, label %.preheader66.loopexit.i.i.unr-lcssa, label %.lr.ph.i.i, !llvm.loop !99

.lr.ph82.preheader.i.i:                           ; preds = %.preheader66.i.i
  %i.blk = zext nneg i32 %.0922.lcssa20102017.i to i64 ; 4 uses
  %i.bll = add nuw nsw i32 %.0925.lcssa20082018.i, 1
  %wide.trip.count107.i.i = zext nneg i32 %i.bll to i64
  ...
  %3 = sub nsw i64 %wide.trip.count107.i.i, %i.blk ; 3 uses
...
.lr.ph85.preheader.i.i:                           ; preds = %.preheader.i.i
  ...
  %min.iters.check508 = icmp ult i64 %i.blv, 4
  br i1 %min.iters.check508, label %.lr.ph85.i.i.preheader, label %vector.ph509

vector.ph509:                                     ; preds = %.lr.ph85.preheader.i.i
  %n.vec511 = and i64 %i.blv, -4                  ; 3 uses
  %i.blw = add nsw i64 %n.vec511, %i.blu
  br label %vector.body512

vector.body512:                                   ; preds = %vector.body512, %vector.ph509
  %index513 = phi i64 [ 0, %vector.ph509 ], [ %index.next516, %vector.body512 ] ; 2 uses
  %i.blx = add i64 %index513, %i.blu              ; 2 uses
  %i.bly = getelementptr inbounds nuw [4 x i8], ptr %i.bin, i64 %i.blx
  %wide.load514 = load <4 x i32>, ptr %i.bly, align 4, !tbaa !4
  %i.blz = shl <4 x i32> %wide.load514, splat (i32 1)
  ...
  %wide.load515 = load <4 x i32>, ptr %i.bmc, align 4, !tbaa !4
  %i.bmd = sub <4 x i32> %i.bma, %wide.load515
  store <4 x i32> %i.bmd, ptr %i.bmc, align 4, !tbaa !4
  %index.next516 = add nuw i64 %index513, 4       ; 2 uses
  %i.bme = icmp eq i64 %index.next516, %n.vec511
  br i1 %i.bme, label %middle.block517, label %vector.body512, !llvm.loop !100

middle.block517:                                  ; preds = %vector.body512
  %cmp.n518 = icmp eq i64 %i.blv, %n.vec511
  br i1 %cmp.n518, label %CreateDecodeTables.exit.i, label %.lr.ph85.i.i.preheader

.lr.ph85.i.i.preheader:                           ; preds = %.lr.ph85.preheader.i.i, %middle.block517
  %indvars.iv109.i.i.ph = phi i64 [ %i.blu, %.lr.ph85.preheader.i.i ], [ %i.blw, %middle.block517 ]
...
.lr.ph82.i.i:                                     ; preds = %.lr.ph82.i.i, %.lr.ph82.preheader.i.i.new
  ...
  %niter754 = phi i64 [ 0, %.lr.ph82.preheader.i.i.new ], [ %niter754.next.1, %.lr.ph82.i.i ]
  ...
  %niter754.next.1 = add i64 %niter754, 2         ; 2 uses
  %niter754.ncmp.1 = icmp eq i64 %niter754.next.1, %unroll_iter753
  br i1 %niter754.ncmp.1, label %.preheader.i.i.loopexit.unr-lcssa, label %.lr.ph82.i.i, !llvm.loop !101
...
CreateDecodeTables.exit.i:                        ; preds = %.lr.ph85.i.i, %middle.block517, %.preheader.i.i
...
.lr.ph.preheader:                                 ; preds = %.lr.ph1549.i
  ...
  %.promoted846 = load ptr, ptr %i.bnv, align 8, !tbaa !77
  %.promoted847 = load i32, ptr %i.bnx, align 4, !tbaa !23
  br label %.lr.ph
end_hunk_0
