begin_hunk_0_@_ZN16COpenCallbackImpD2Ev:bb.a
  ...
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %i.l)
          to label %_ZN13CObjectVectorI11CStringBaseIwEED2Ev.exit unwind label %bb.d
...
_ZN13CObjectVectorI11CStringBaseIwEED2Ev.exit:    ; preds = %_ZN9CMyComPtrI20IArchiveOpenCallbackED2Ev.exit
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %i.l) #20
...
begin_hunk_1_@_ZThn8_N16COpenCallbackImp7ReleaseEv:bb.a
  ...
  tail call void %i.g(ptr noundef nonnull align 8 dereferenceable(192) %i.d) #20
...
bb.a:
  ...
  tail call void @_ZN16COpenCallbackImpD2Ev(ptr noundef nonnull align 8 dereferenceable(192) %i.a) #20
  tail call void @_ZdlPvm(ptr noundef nonnull align 8 dereferenceable(192) %i.a, i64 noundef 192) #24
  ret void
}
...
bb.g:                                             ; preds = %_ZN11CStringBaseIwED2Ev.exit.i, %bb.d
  ...
  br i1 %exitcond.not, label %._crit_edge.i, label %bb.d, !llvm.loop !81
...
begin_hunk_8_@_ZThn8_N13CInFileStream7ReleaseEv:bb.a
  ...
  %i.f = getelementptr inbounds nuw i8, ptr %i.e, i64 32
  %i.g = load ptr, ptr %i.f, align 8
  tail call void %i.g(ptr noundef nonnull align 8 dereferenceable(1112) %i.d) #20
...
bb.a:
  %i.a = getelementptr inbounds i8, ptr %0, i64 -8 ; 2 uses
  tail call void @_ZN16CInFileStreamVolD2Ev(ptr noundef nonnull align 8 dereferenceable(1144) %i.a) #20
  tail call void @_ZdlPvm(ptr noundef nonnull align 8 dereferenceable(1144) %i.a, i64 noundef 1144) #24
  ret void
}
...
bb.d:                                             ; preds = %bb.a, %_ZN11CStringBaseIwED2Ev.exit
  ...
  br i1 %i.q, label %bb.a, label %._crit_edge, !llvm.loop !81
}
...
begin_hunk_14_@_ZN11CStringBaseIwEpLEPKw:bb.a
  ...
  br i1 %exitcond.not.i.i.3, label %._crit_edge.thread.i.i, label %scalar.ph, !llvm.loop !87
