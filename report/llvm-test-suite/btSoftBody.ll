...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %4 = call float @llvm.fmuladd.f32(float %i.au, float %i.s, float %i.ax)
  %i.ay = getelementptr inbounds nuw i8, ptr %i.n, i64 112
  %i.az = load float, ptr %i.ay, align 4, !tbaa !159
  %5 = call noundef float @llvm.fmuladd.f32(float %i.az, float %i.ac, float %4)
  %i.ba = getelementptr inbounds nuw i8, ptr %i.n, i64 128
  %i.bb = load float, ptr %i.ba, align 4, !tbaa !159
  %6 = fadd float %i.bb, %5
  %i.bc = getelementptr inbounds nuw i8, ptr %i.l, i64 80 ; 2 uses
  %i.bd = getelementptr inbounds nuw i8, ptr %i.n, i64 328
  %i.be = getelementptr inbounds nuw i8, ptr %i.n, i64 344
  %i.bf = getelementptr inbounds nuw i8, ptr %i.n, i64 348
  %i.bg = load float, ptr %i.bf, align 4, !tbaa !159 ; 2 uses
  %7 = getelementptr inbounds nuw i8, ptr %i.l, i64 88
  %8 = load float, ptr %7, align 8, !tbaa !159    ; 2 uses
  %9 = getelementptr inbounds nuw i8, ptr %i.n, i64 352
  %10 = load float, ptr %9, align 4, !tbaa !159   ; 2 uses
  %11 = getelementptr inbounds nuw i8, ptr %i.l, i64 84
  %12 = load float, ptr %11, align 4, !tbaa !159  ; 2 uses
  %13 = fneg float %12
  %14 = fmul float %10, %13
  %15 = call float @llvm.fmuladd.f32(float %i.bg, float %8, float %14)
  %16 = load float, ptr %i.bc, align 8, !tbaa !159 ; 2 uses
  %17 = load float, ptr %i.be, align 4, !tbaa !159 ; 2 uses
  %18 = fneg float %8
  %19 = fmul float %17, %18
  %20 = call float @llvm.fmuladd.f32(float %10, float %16, float %19)
  %21 = fneg float %16
  %22 = fmul float %i.bg, %21
  %23 = call float @llvm.fmuladd.f32(float %17, float %12, float %22)
  %i.bh = load float, ptr %i.bd, align 4, !tbaa !159
  %i.bi = fadd float %15, %i.bh
  %i.bj = getelementptr inbounds nuw i8, ptr %i.n, i64 332
  %i.bk = load float, ptr %i.bj, align 4, !tbaa !159
  %i.bl = fadd float %i.bk, %20
  %i.bm = getelementptr inbounds nuw i8, ptr %i.n, i64 336
  %i.bn = load float, ptr %i.bm, align 4, !tbaa !159
  %i.bo = fadd float %23, %i.bn
  ...
  call void @_ZN11btRigidBody12applyImpulseERK9btVector3S2_(ptr noundef nonnull align 8 dereferenceable(564) %i.n, ptr noundef nonnull align 4 dereferenceable(16) %3, ptr noundef nonnull align 4 dereferenceable(16) %i.bc)
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #34
