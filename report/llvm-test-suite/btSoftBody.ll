...
begin_hunk_1_@_ZN10btSoftBody18initializeClustersEv:bb.a
  ...
  %1 = shufflevector <2 x float> %i.cb, <2 x float> poison, <2 x i32> <i32 1, i32 0>
...
begin_hunk_2_@_ZN10btSoftBody18initializeClustersEv:bb.a
  ...
  %2 = shufflevector <2 x float> %i.cp, <2 x float> poison, <2 x i32> <i32 1, i32 0>
...
begin_hunk_4_@_ZN10btSoftBody18initializeClustersEv:bb.a
  ...
  %3 = shufflevector <2 x float> %i.dd, <2 x float> poison, <2 x i32> <i32 1, i32 0>
...
_ZN10btSoftBody10clusterComEPKNS_7ClusterE.exit:  ; preds = %.epil.preheader, %_ZN10btSoftBody10clusterComEPKNS_7ClusterE.exit.loopexit.unr-lcssa, %._crit_edge.thread
  %4 = phi float [ %i.bg, %._crit_edge.thread ], [ %i.bm, %_ZN10btSoftBody10clusterComEPKNS_7ClusterE.exit.loopexit.unr-lcssa ], [ %i.bm, %.epil.preheader ] ; 2 uses
  ...
  %5 = phi <2 x float> [ zeroinitializer, %._crit_edge.thread ], [ %i.cu, %_ZN10btSoftBody10clusterComEPKNS_7ClusterE.exit.loopexit.unr-lcssa ], [ %i.di, %.epil.preheader ]
  %i.dj = fmul float %4, %.sroa.015.0.lcssa.i     ; 2 uses
  %i.dk = insertelement <2 x float> poison, float %4, i64 0
  %i.dl = shufflevector <2 x float> %i.dk, <2 x float> poison, <2 x i32> zeroinitializer
  %i.dm = fmul <2 x float> %i.dl, %5              ; 3 uses
