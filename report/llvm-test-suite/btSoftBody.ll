...
bb.a:
  ...
  store float 0.000000e+00, ptr %7, align 4, !tbaa !159, !alias.scope !547
  ...
  %11 = load <2 x float>, ptr %5, align 4, !tbaa !159, !noalias !539 ; 2 uses
  %12 = load float, ptr %i.d, align 4, !tbaa !159, !noalias !539 ; 3 uses
  %13 = extractelement <2 x float> %11, i64 0     ; 4 uses
  %14 = fneg float %13                            ; 3 uses
  %15 = fneg float %12                            ; 4 uses
  %i.v = insertelement <2 x float> poison, float %i.f, i64 0
  %i.w = shufflevector <2 x float> %i.v, <2 x float> poison, <2 x i32> zeroinitializer
  %i.x = fmul <2 x float> %i.w, %i.t
  %16 = fmul float %13, %i.f
  %17 = insertelement <2 x float> <float 0.000000e+00, float poison>, float %i.b, i64 1 ; 4 uses
  %18 = shufflevector <2 x float> %11, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %19 = insertelement <2 x float> %18, float %14, i64 1 ; 3 uses
  %20 = fmul float %13, %i.j
  ...
  %i.ae = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ad, <2 x float> %17, <2 x float> %i.aa)
  ...
  %i.ai = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.b, i64 0 ; 2 uses
  %i.aj = insertelement <2 x float> <float 0.000000e+00, float poison>, float %i.c, i64 1 ; 2 uses
  %i.ak = insertelement <2 x float> %18, float %15, i64 0 ; 3 uses
  ...
  %21 = load float, ptr %i.h, align 4, !tbaa !159, !noalias !544 ; 2 uses
  %22 = load float, ptr %4, align 4, !tbaa !159, !noalias !544 ; 2 uses
  %23 = load float, ptr %i.k, align 4, !tbaa !159, !noalias !544 ; 2 uses
  %24 = load float, ptr %i.g, align 4, !tbaa !159, !noalias !544 ; 2 uses
  %25 = insertelement <2 x float> poison, float %22, i64 0
  %26 = shufflevector <2 x float> %25, <2 x float> poison, <2 x i32> zeroinitializer
  %27 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %26, <2 x float> %17, <2 x float> %i.x)
  %28 = insertelement <2 x float> poison, float %24, i64 0
  %29 = shufflevector <2 x float> %28, <2 x float> poison, <2 x i32> zeroinitializer
  %30 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %29, <2 x float> %19, <2 x float> %27) ; 3 uses
  %i.aq = insertelement <2 x float> poison, float %21, i64 0
  %i.ar = shufflevector <2 x float> %i.aq, <2 x float> poison, <2 x i32> zeroinitializer
  %i.as = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ar, <2 x float> %17, <2 x float> %i.u)
  %i.at = insertelement <2 x float> poison, float %23, i64 0
  %i.au = shufflevector <2 x float> %i.at, <2 x float> poison, <2 x i32> zeroinitializer
  %i.av = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.au, <2 x float> %19, <2 x float> %i.as) ; 3 uses
  %i.aw = tail call float @llvm.fmuladd.f32(float %22, float %15, float %16)
  %i.ax = tail call noundef float @llvm.fmuladd.f32(float %24, float 0.000000e+00, float %i.aw) ; 2 uses
  %i.ay = tail call float @llvm.fmuladd.f32(float %21, float %15, float %20)
  %i.az = tail call noundef float @llvm.fmuladd.f32(float %23, float 0.000000e+00, float %i.ay) ; 2 uses
  %31 = tail call float @llvm.fmuladd.f32(float %i.m, float %15, float %i.ab)
  %i.ba = tail call noundef float @llvm.fmuladd.f32(float %i.q, float 0.000000e+00, float %31) ; 2 uses
  %32 = fmul <2 x float> %i.ai, %i.av
  %33 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aj, <2 x float> %30, <2 x float> %32)
  %34 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ak, <2 x float> %i.ah, <2 x float> %33)
  %i.bb = fmul <2 x float> %17, %i.av
  %i.bc = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.t, <2 x float> %30, <2 x float> %i.bb)
  %35 = insertelement <2 x float> poison, float %14, i64 0
  %36 = shufflevector <2 x float> %35, <2 x float> poison, <2 x i32> zeroinitializer
  %37 = fmul <2 x float> %i.av, %36
  %38 = fmul float %i.az, %14
  %i.bd = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.al, <2 x float> %i.ah, <2 x float> %i.bc)
  %39 = insertelement <2 x float> poison, float %12, i64 0
  %40 = shufflevector <2 x float> %39, <2 x float> poison, <2 x i32> zeroinitializer
  %i.be = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %40, <2 x float> %30, <2 x float> %37)
  %41 = tail call float @llvm.fmuladd.f32(float %12, float %i.ax, float %38)
  %i.bf = insertelement <2 x float> poison, float %i.az, i64 0
  %i.bg = shufflevector <2 x float> %i.bf, <2 x float> poison, <2 x i32> zeroinitializer
  %i.bh = fmul <2 x float> %i.ai, %i.bg
  ...
  %i.bk = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aj, <2 x float> %i.bj, <2 x float> %i.bh)
  ...
  %i.bn = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ak, <2 x float> %i.bm, <2 x float> %i.bk)
  %i.bo = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ah, <2 x float> zeroinitializer, <2 x float> %i.be)
  %i.bp = tail call noundef float @llvm.fmuladd.f32(float %i.ba, float 0.000000e+00, float %41)
  %i.bq = fsub <2 x float> %i.an, %34
  %i.br = fsub <2 x float> zeroinitializer, %i.bd ; 7 uses
  %i.bs = fsub <2 x float> zeroinitializer, %i.bn ; 4 uses
  %i.bt = fsub <2 x float> zeroinitializer, %i.bo ; 5 uses
  %i.bu = fsub float %3, %i.bp
  %i.bv = fadd <2 x float> %i.ap, %i.bq           ; 5 uses
  %i.bw = fadd float %2, %i.bu                    ; 3 uses
  %42 = extractelement <2 x float> %i.bv, i64 1   ; 2 uses
  %43 = fneg float %42
  %i.bx = fneg <2 x float> %i.bs                  ; 3 uses
  %i.by = shufflevector <2 x float> %i.bx, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.bz = extractelement <2 x float> %i.br, i64 0 ; 2 uses
  %44 = fneg float %i.bw
  %45 = shufflevector <2 x float> %i.bt, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.ca = insertelement <2 x float> %45, float %i.bw, i64 1 ; 2 uses
  %i.cb = fneg <2 x float> %i.ca
  %46 = fmul float %i.bz, %44
  %47 = insertelement <2 x float> %i.bx, float %43, i64 0
  %48 = fmul <2 x float> %i.bt, %47
  %i.cc = extractelement <2 x float> %i.bt, i64 0 ; 2 uses
  %foldExtExtBinop = fmul <2 x float> %i.bt, %i.bx
  %i.cd = extractelement <2 x float> %foldExtExtBinop, i64 0
  %i.ce = extractelement <2 x float> %i.br, i64 1
  %i.cf = extractelement <2 x float> %i.bv, i64 0 ; 3 uses
  %49 = shufflevector <2 x float> %i.bv, <2 x float> %i.br, <2 x i32> <i32 0, i32 3>
  %50 = fmul <2 x float> %49, %i.cb
  %i.cg = tail call noundef float @llvm.fmuladd.f32(float %i.cf, float %i.bw, float %i.cd)
  %51 = shufflevector <2 x float> %i.br, <2 x float> %i.bs, <2 x i32> <i32 1, i32 2>
  %52 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bt, <2 x float> %51, <2 x float> %50) ; 2 uses
  %shift42 = shufflevector <2 x float> %52, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop43 = fmul <2 x float> %i.br, %shift42
  %53 = extractelement <2 x float> %foldExtExtBinop43, i64 0
  %i.ch = extractelement <2 x float> %i.bs, i64 1
  %54 = tail call noundef float @llvm.fmuladd.f32(float %i.cc, float %i.ch, float %46)
  %55 = shufflevector <2 x float> %i.br, <2 x float> %i.bv, <2 x i32> <i32 0, i32 3>
  %i.ci = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %55, <2 x float> %i.ca, <2 x float> %48) ; 2 uses
  %i.cj = extractelement <2 x float> %i.ci, i64 1
  %56 = fmul <2 x float> %i.bv, %i.by
  %57 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.br, <2 x float> %i.bs, <2 x float> %56) ; 2 uses
  %58 = extractelement <2 x float> %57, i64 1
  %i.ck = tail call float @llvm.fmuladd.f32(float %i.cf, float %i.cj, float %53)
  %i.cl = tail call noundef float @llvm.fmuladd.f32(float %i.cc, float %58, float %i.ck)
  %i.cm = insertelement <2 x float> poison, float %1, i64 0
  %i.cn = insertelement <2 x float> %i.cm, float %i.cl, i64 1
  %i.co = fdiv <2 x float> splat (float 1.000000e+00), %i.cn ; 7 uses
  %59 = shufflevector <2 x float> %i.co, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %i.cp = extractelement <2 x float> %i.co, i64 1 ; 3 uses
  %i.cq = extractelement <2 x float> %i.co, i64 0 ; 3 uses
  %i.cr = fmul float %54, %i.cp                   ; 3 uses
  %60 = shufflevector <2 x float> %i.co, <2 x float> poison, <2 x i32> <i32 1, i32 1> ; 3 uses
  %i.cs = fmul <2 x float> %i.ci, %60             ; 4 uses
  %61 = fmul float %i.cg, %i.cp                   ; 2 uses
  %62 = fmul <2 x float> %52, %60                 ; 3 uses
  %i.ct = fmul <2 x float> %57, %60               ; 4 uses
  %63 = fneg float %i.ce
  %64 = fmul float %i.bz, %63
  %65 = tail call noundef float @llvm.fmuladd.f32(float %i.cf, float %42, float %64)
  %66 = fmul float %65, %i.cp                     ; 3 uses
  %67 = fmul float %61, 0.000000e+00              ; 2 uses
  %68 = insertelement <2 x float> %i.co, float 0.000000e+00, i64 1
  %69 = fmul <2 x float> %62, %68                 ; 2 uses
  %70 = extractelement <2 x float> %i.cs, i64 1
  %71 = insertelement <2 x float> %i.cs, float %i.cr, i64 0
  %72 = shufflevector <2 x float> %i.co, <2 x float> poison, <2 x i32> zeroinitializer
  %73 = insertelement <2 x float> %69, float %67, i64 0
  %74 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %71, <2 x float> %72, <2 x float> %73)
  %75 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ct, <2 x float> zeroinitializer, <2 x float> %74)
  %76 = extractelement <2 x float> %62, i64 0
  %i.cu = fmul float %76, 0.000000e+00            ; 2 uses
  %i.cv = extractelement <2 x float> %i.cs, i64 0 ; 2 uses
  %i.cw = tail call float @llvm.fmuladd.f32(float %i.cv, float %i.cq, float %i.cu)
  %77 = tail call noundef float @llvm.fmuladd.f32(float %66, float 0.000000e+00, float %i.cw)
  %shift45 = shufflevector <2 x float> %62, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop46 = fmul <2 x float> %i.co, %shift45
  %i.cx = extractelement <2 x float> %foldExtExtBinop46, i64 0
  %i.cy = tail call float @llvm.fmuladd.f32(float %70, float 0.000000e+00, float %i.cx)
  %78 = extractelement <2 x float> %i.ct, i64 1
  %79 = tail call noundef float @llvm.fmuladd.f32(float %78, float 0.000000e+00, float %i.cy)
  %80 = fmul float %i.cq, %61
  %81 = tail call float @llvm.fmuladd.f32(float %i.cr, float 0.000000e+00, float %80)
  %82 = extractelement <2 x float> %i.ct, i64 0
  %i.cz = tail call noundef float @llvm.fmuladd.f32(float %82, float 0.000000e+00, float %81)
  %i.da = tail call float @llvm.fmuladd.f32(float %i.cr, float 0.000000e+00, float %67)
  %83 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cs, <2 x float> zeroinitializer, <2 x float> %69)
  %84 = shufflevector <2 x float> %i.ct, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %85 = shufflevector <4 x float> <float 0.000000e+00, float 0.000000e+00, float poison, float poison>, <4 x float> %84, <4 x i32> <i32 0, i32 1, i32 5, i32 4>
  %86 = insertelement <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, float %66, i64 0
  %87 = shufflevector <4 x float> %86, <4 x float> %59, <4 x i32> <i32 0, i32 1, i32 4, i32 poison>
  %88 = shufflevector <4 x float> %87, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %89 = shufflevector <2 x float> %83, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 1, i32 poison>
  %90 = insertelement <4 x float> %89, float 0.000000e+00, i64 1
  %91 = insertelement <4 x float> %90, float %i.da, i64 3
  %92 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %85, <4 x float> %88, <4 x float> %91)
  %93 = tail call float @llvm.fmuladd.f32(float %i.cv, float 0.000000e+00, float %i.cu)
  %94 = tail call noundef float @llvm.fmuladd.f32(float %66, float %i.cq, float %93)
  %95 = shufflevector <2 x float> %75, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  store <2 x float> %95, ptr %0, align 4, !tbaa !159, !alias.scope !547
  store float %77, ptr %6, align 4, !tbaa !159, !alias.scope !547
  store float %79, ptr %8, align 4, !tbaa !159, !alias.scope !547
  store float %i.cz, ptr %9, align 4, !tbaa !159, !alias.scope !547
  store <4 x float> %92, ptr %10, align 4, !tbaa !159, !alias.scope !547
  %96 = getelementptr inbounds nuw i8, ptr %0, i64 40
  store float %94, ptr %96, align 4, !tbaa !159, !alias.scope !547
...
.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  ...
  %i.cv = fmul <2 x float> %i.cr, splat (float 5.000000e-01) ; 5 uses
  %i.cw = extractelement <2 x float> %i.cv, i64 0 ; 4 uses
...
bb.b:                                             ; preds = %.preheader
  ...
  %5 = fmul float %i.fd, %3
  %6 = fmul float %i.ey, %4
  %i.ff = insertelement <2 x float> poison, float %6, i64 0
  %7 = insertelement <2 x float> %i.ff, float %5, i64 1
  ...
  %8 = shufflevector <2 x float> %i.ex, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %9 = insertelement <2 x float> %8, float %i.fd, i64 1
  %i.ft = fneg <2 x float> %9
  ...
  %i.fx = insertelement <2 x float> %8, float %i.fn, i64 0
...
_ZNK10btSoftBody4Body5xformEv.exit17:             ; preds = %bb.o, %bb.q
  %.0.i13 = phi ptr [ %i.bs, %bb.o ], [ %spec.select.i15, %bb.q ] ; 7 uses
  %i.bw = getelementptr inbounds nuw i8, ptr %0, i64 72
  %i.bx = load float, ptr %i.bw, align 8, !tbaa !159 ; 2 uses
  %3 = getelementptr inbounds nuw i8, ptr %.0.i13, i64 4
  %i.by = getelementptr inbounds nuw i8, ptr %0, i64 76
  %i.bz = load float, ptr %i.by, align 4, !tbaa !159 ; 2 uses
  ...
  %i.cd = load float, ptr %i.cc, align 8, !tbaa !159 ; 2 uses
  ...
  %i.cj = load float, ptr %i.ci, align 4, !tbaa !159
  ...
  %4 = load float, ptr %3, align 4, !tbaa !159
  %5 = load float, ptr %.0.i13, align 4, !tbaa !159
  %i.cn = load <2 x float>, ptr %i.ce, align 4, !tbaa !159 ; 2 uses
  %i.co = load <2 x float>, ptr %i.ch, align 4, !tbaa !159 ; 2 uses
  ...
  %7 = tail call float @llvm.fmuladd.f32(float %5, float %i.bx, float %6)
  ...
  %i.db = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cy, <2 x float> %i.da, <2 x float> %i.cw) ; 7 uses
  %8 = tail call noundef float @llvm.fmuladd.f32(float %i.cb, float %i.cd, float %7) ; 4 uses
  %.sroa.0.0.vec.insert.i18 = insertelement <2 x float> poison, float %8, i64 0
  %9 = shufflevector <2 x float> %.sroa.0.0.vec.insert.i18, <2 x float> %i.db, <2 x i32> <i32 0, i32 2>
  %i.dc = shufflevector <2 x float> <float poison, float 0.000000e+00>, <2 x float> %i.db, <2 x i32> <i32 3, i32 1>
  store <2 x float> %9, ptr %i.ck, align 8
  ...
  %10 = shufflevector <2 x float> %i.db, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %11 = insertelement <2 x float> %10, float %8, i64 1
  %i.df = fmul <2 x float> %11, %i.de
  ...
  %i.dn = tail call float @llvm.fmuladd.f32(float %8, float %i.dm, float %i.dl) ; 3 uses
...
_ZL12NormalizeAnyRK9btVector3.exit:               ; preds = %_ZNK10btSoftBody4Body5xformEv.exit17, %bb.r
  ...
  %i.ea = tail call float @llvm.fmuladd.f32(float %i.cm, float %8, float %i.dz)
...
_ZNK10btSoftBody4Body15invWorldInertiaEv.exit35:  ; preds = %bb.aa, %bb.ab
  ...
  %i.gc = load <2 x float>, ptr %i.fo, align 4, !tbaa !159, !noalias !617
  %i.gd = load <2 x float>, ptr %i.fp, align 4, !tbaa !159, !noalias !617
  %i.ge = fadd <2 x float> %i.gc, %i.gd           ; 6 uses
  %12 = fadd float %i.fm, %i.fn                   ; 4 uses
  ...
  %i.hh = extractelement <2 x float> %foldExtExtBinop79, i64 0
  %i.hi = extractelement <2 x float> %i.ha, i64 0
  %i.hj = tail call float @llvm.fmuladd.f32(float %12, float %i.hi, float %i.hh)
  ...
  %13 = shufflevector <2 x float> %i.ge, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %14 = insertelement <2 x float> %13, float %12, i64 1 ; 2 uses
  %i.hr = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> %i.gv, <2 x float> %i.hq)
  %i.hs = fmul <2 x float> %i.hr, %i.ho           ; 3 uses
  %i.ht = fneg <2 x float> %i.gm
  %i.hu = fmul <2 x float> %14, %i.ht
  ...
  %i.ie = tail call noundef float @llvm.fmuladd.f32(float %12, float %i.hb, float %i.id)
