...
bb.b:                                             ; preds = %.lr.ph, %bb.i
  ...
  %.0253557 = phi i32 [ 0, %.lr.ph ], [ %i.bd, %bb.i ] ; 4 uses
  %i.y = load ptr, ptr %i.s, align 8, !tbaa !113
  %i.z = sext i32 %.0253557 to i64                ; 2 uses
...
bb.i:                                             ; preds = %bb.e, %bb.f, %bb.b
  ...
  %.1254 = phi i32 [ %i.az, %bb.f ], [ %.0253557, %bb.e ], [ %.0253557, %bb.b ]
  %i.bd = add nsw i32 %.1254, 1                   ; 2 uses
...
bb.q:                                             ; preds = %bb.u, %.preheader.i
  %.064.i = phi i32 [ 0, %.preheader.i ], [ %i.fs, %bb.u ]
...
bb.u:                                             ; preds = %bb.t, %bb.s
  ...
  %i.fs = add nuw nsw i32 %.064.i, 1              ; 2 uses
...
bb.ab:                                            ; preds = %bb.z, %bb.aa, %bb.x, %bb.y
  %.0260 = phi float [ %i.ho, %bb.x ], [ %i.hq, %bb.y ], [ %i.hs, %bb.aa ], [ 0.000000e+00, %bb.z ]
  invoke void @_ZN10btSoftBody10appendNodeERK9btVector3f(ptr noundef nonnull align 8 dereferenceable(1496) %0, ptr noundef nonnull align 4 dereferenceable(16) %7, float noundef %.0260)
...
bb.ak:                                            ; preds = %.lr.ph577, %.loopexit537
  ...
  %.6259576 = phi i32 [ 0, %.lr.ph577 ], [ %.10, %.loopexit537 ] ; 5 uses
  %i.km = load ptr, ptr %i.ih, align 8, !tbaa !117 ; 2 uses
  %i.kn = sext i32 %.6259576 to i64               ; 2 uses
...
bb.am:                                            ; preds = %bb.bo, %bb.bn, %bb.al
  ...
  %i.lr = icmp sgt i32 %.6259576, -1
  br i1 %i.lr, label %bb.an, label %bb.ao

bb.an:                                            ; preds = %bb.am
  %i.ls = zext nneg i32 %.6259576 to i64
