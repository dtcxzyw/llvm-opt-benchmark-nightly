...
bb.e:                                             ; preds = %.lr.ph, %bb.e
  ...
  %3 = load float, ptr %i.k, align 4, !tbaa !159
  ...
  %5 = load float, ptr %i.k, align 4, !tbaa !159
  ...
  %7 = load float, ptr %i.k, align 4, !tbaa !159
...
.lr.ph110:                                        ; preds = %_ZNK10btSoftBody9getVolumeEv.exit
  ...
  %.promoted113 = load float, ptr %i.mm, align 8, !tbaa !159
  ...
  %3 = insertelement <2 x float> poison, float %.promoted113, i64 0
  %i.mp = insertelement <2 x float> %3, float %.promoted, i64 1
  br label %bb.r
...
.lr.ph150:                                        ; preds = %bb.p
  ...
  %.sroa.5101.0.copyload = load float, ptr %.sroa.5101.0..sroa_idx, align 8
  ...
  %5 = insertelement <2 x float> poison, float %.sroa.5101.0.copyload, i64 0
  %i.jr = insertelement <2 x float> %5, float %.sroa.9.16.copyload, i64 1
...
bb.aw:                                            ; preds = %_ZNK10btSoftBody4Body15invWorldInertiaEv.exit57
  ...
  %4 = load float, ptr %i.ig, align 4, !tbaa !159
...
_ZNK10btSoftBody4Body8velocityERK9btVector3.exit30: ; preds = %bb.e, %bb.f, %bb.g
  ...
  %5 = load float, ptr %i.dq, align 4, !tbaa !159
...
_ZNK10btSoftBody4Body5xformEv.exit17:             ; preds = %bb.o, %bb.q
  ...
  %3 = load float, ptr %i.bw, align 8, !tbaa !159
  %i.bx = getelementptr inbounds nuw i8, ptr %0, i64 76
  %4 = load float, ptr %i.bx, align 4, !tbaa !159
  ...
  %5 = load float, ptr %i.ca, align 8, !tbaa !159
  ...
  %i.cn = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %i.ct = shufflevector <2 x float> %7, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %8 = insertelement <2 x float> poison, float %i.cd, i64 0
  %i.cx = insertelement <2 x float> %8, float %i.cg, i64 1
  %i.cy = insertelement <2 x float> poison, float %5, i64 0
  %i.cz = shufflevector <2 x float> %i.cy, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.da = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cx, <2 x float> %i.cz, <2 x float> %i.cu) ; 6 uses
...
_ZNK10btSoftBody4Body15angularVelocityEv.exit14:  ; preds = %bb.e, %bb.f, %bb.g
  ...
  %5 = load float, ptr %i.bh, align 4, !tbaa !159
...
bb.e:                                             ; preds = %bb.d
  ...
  %3 = load float, ptr %i.aj, align 4, !tbaa !159
...
bb.i:                                             ; preds = %_ZNK10btSoftBody4Body8velocityERK9btVector3.exit30._crit_edge, %bb.h
  ...
  %7 = load float, ptr %i.eg, align 4, !tbaa !159
...
bb.b:                                             ; preds = %bb.a
  ...
  %3 = load float, ptr %i.av, align 8, !tbaa !159
...
bb.e:                                             ; preds = %bb.c, %_ZN11btSparseSdfILi3EE15DistanceToShapeERK9btVector3P16btCollisionShape.exit.3
  ...
  %5 = load float, ptr %i.i, align 8, !tbaa !705
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #34
  %6 = insertelement <2 x float> poison, float %5, i64 0
  %i.ah = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> zeroinitializer
