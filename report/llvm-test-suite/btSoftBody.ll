...
bb.b:                                             ; preds = %bb.a
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 820 ; 2 uses
  %i.c = load i32, ptr %i.b, align 4, !tbaa !110  ; 15 uses
...
begin_hunk_1_@_ZN10btSoftBody26generateBendingConstraintsEiPNS_8MaterialE:bb.a
  ...
  %5 = load i32, ptr %i.b, align 4, !tbaa !110
...
begin_hunk_2_@_ZN10btSoftBody26generateBendingConstraintsEiPNS_8MaterialE:bb.a
  ...
  invoke void @_ZN20btAlignedObjectArrayI9NodeLinksE6resizeEiRKS0_(ptr noundef nonnull align 8 dereferenceable(25) %3, i32 noundef %5, ptr noundef nonnull align 8 dereferenceable(32) %4)
...
begin_hunk_3_@_ZN11btSparseSdfILi3EE8EvaluateERK9btVector3P16btCollisionShapeRS1_f:bb.a
  ...
  %i.ct = getelementptr inbounds [8 x i8], ptr %i.cr, i64 %i.cs ; 3 uses
  %i.cu = load ptr, ptr %i.ct, align 8, !tbaa !573 ; 2 uses
...
begin_hunk_4_@_ZN11btSparseSdfILi3EE8EvaluateERK9btVector3P16btCollisionShapeRS1_f:bb.a
  ...
  %5 = load ptr, ptr %i.ct, align 8, !tbaa !573
  %i.dy = getelementptr inbounds nuw i8, ptr %i.dx, i64 288
  store ptr %5, ptr %i.dy, align 8, !tbaa !580
