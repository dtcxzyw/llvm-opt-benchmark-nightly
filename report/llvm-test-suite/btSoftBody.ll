...
_ZNK10btSoftBody4Body5xformEv.exit17:             ; preds = %bb.o, %bb.q
  ...
  %5 = load float, ptr %3, align 4, !tbaa !159
  %6 = load float, ptr %i.bw, align 8, !tbaa !159
  %7 = load float, ptr %4, align 8, !tbaa !159
  ...
  %11 = insertelement <2 x float> poison, float %i.cb, i64 0
  %i.cu = insertelement <2 x float> %11, float %i.ce, i64 1
  %i.cv = insertelement <2 x float> poison, float %7, i64 0
  %12 = shufflevector <2 x float> %i.cv, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.cw = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cu, <2 x float> %12, <2 x float> %i.cr) ; 6 uses
  %i.cx = insertelement <2 x float> poison, float %i.ce, i64 0
  %i.cy = insertelement <2 x float> %i.cx, float %i.by, i64 1
  %i.cz = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cy, <2 x float> %12, <2 x float> %i.ct) ; 3 uses
...
bb.a:
  ...
  %4 = insertelement <4 x float> poison, float %.sroa.7.0.copyload, i64 0
  %i.bi = shufflevector <4 x float> %4, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %5 = insertelement <4 x float> poison, float %.sroa.11.0.copyload, i64 0
  %6 = shufflevector <4 x float> %5, <4 x float> poison, <4 x i32> zeroinitializer
  %i.dh = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.dg, <4 x float> %6, <4 x float> %i.cb) ; 4 uses
