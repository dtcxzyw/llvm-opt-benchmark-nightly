...
bb.aa:                                            ; preds = %.lr.ph355.split, %.loopexit
  ...
  %i.lh = load ptr, ptr %i.lg, align 8, !tbaa !209 ; 10 uses
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %i.mj = getelementptr inbounds nuw i8, ptr %i.kw, i64 16
  %i.mk = getelementptr inbounds nuw i8, ptr %i.kz, i64 16
  %i.ml = getelementptr inbounds nuw i8, ptr %i.lh, i64 16
  %i.mm = load float, ptr %i.kq, align 4, !tbaa !159
  %i.mn = load float, ptr %i.kr, align 8, !tbaa !159
  %1 = load <2 x float>, ptr %i.mj, align 4, !tbaa !159
  %2 = load <2 x float>, ptr %i.mk, align 4, !tbaa !159
  %3 = fadd <2 x float> %1, %2
  %4 = load <2 x float>, ptr %i.ml, align 4, !tbaa !159
  %5 = fadd <2 x float> %3, %4
  %6 = fmul <2 x float> %5, <float 1.000000e+00, float f0x3EAAAAAB>
  %7 = insertelement <2 x float> <float f0x3EAAAAAB, float poison>, float %i.mn, i64 1
  %8 = fmul <2 x float> %6, %7                    ; 2 uses
  %9 = extractelement <2 x float> %8, i64 0
  %10 = extractelement <2 x float> %8, i64 1
  %i.mo = tail call float @llvm.fmuladd.f32(float %9, float %i.mm, float %10)
