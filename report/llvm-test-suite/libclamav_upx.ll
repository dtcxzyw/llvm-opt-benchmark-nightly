...
vector.memcheck:                                  ; preds = %vector.scevcheck
  %i.df = and i64 %indvars.iv, 4294967295
  %i.dg = zext i32 %i.da to i64
  %i.dh = sub nsw i64 %i.dg, %i.df
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  %i.di = and i64 %i.cv, 28
  %n.vec = and i64 %i.cv, 4294967264              ; 4 uses
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 3 uses
  %i.dj = trunc nuw i64 %index to i32
  %i.dk = add i32 %i.da, %i.dj
  %i.dl = zext i32 %i.dk to i64
  %i.dm = getelementptr inbounds nuw i8, ptr %2, i64 %i.dl ; 2 uses
  %i.dn = getelementptr inbounds nuw i8, ptr %i.dm, i64 16
  %wide.load = load <16 x i8>, ptr %i.dm, align 1, !tbaa !8
  %wide.load328 = load <16 x i8>, ptr %i.dn, align 1, !tbaa !8
  %i.do = add nuw i64 %index, %indvars.iv
  %i.dp = and i64 %i.do, 4294967295
  %i.dq = getelementptr inbounds nuw i8, ptr %2, i64 %i.dp ; 2 uses
  %i.dr = getelementptr inbounds nuw i8, ptr %i.dq, i64 16
  store <16 x i8> %wide.load, ptr %i.dq, align 1, !tbaa !8
  store <16 x i8> %wide.load328, ptr %i.dr, align 1, !tbaa !8
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.ds = icmp eq i64 %index.next, %n.vec
  br i1 %i.ds, label %middle.block, label %vector.body, !llvm.loop !11
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.dt = trunc nuw i64 %index330 to i32
  %i.du = add i32 %i.da, %i.dt
  %i.dv = zext i32 %i.du to i64
  %i.dw = getelementptr inbounds nuw i8, ptr %2, i64 %i.dv
  %wide.load331 = load <4 x i8>, ptr %i.dw, align 1, !tbaa !8
  %i.dx = add nuw i64 %index330, %indvars.iv
  %i.dy = and i64 %i.dx, 4294967295
  %i.dz = getelementptr inbounds nuw i8, ptr %2, i64 %i.dy
  store <4 x i8> %wide.load331, ptr %i.dz, align 1, !tbaa !8
  %index.next332 = add nuw i64 %index330, 4       ; 2 uses
  %i.ea = icmp eq i64 %index.next332, %n.vec329
  br i1 %i.ea, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !15
...
._crit_edge:                                      ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %vec.epilog.middle.block, %middle.block
  %i.fa = add i32 %i.cp, %i.l
  br label %bb.b

bb.ai:                                            ; preds = %bb.r
  %i.fb = tail call fastcc i32 @pefromupx(ptr noundef nonnull %0, i32 noundef %1, ptr noundef %2, ptr noundef %3, i32 noundef %6, i32 noundef %4, i32 noundef %5, ptr noundef @__const.upx_inflate2b.magic, i32 noundef %i.l)
...
doubleebx.exit.thread:                            ; preds = %bb.w, %bb.x, %bb.u, %bb.v, %bb.af, %bb.ag, %bb.ah, %bb.q, %bb.d, %bb.e, %bb.g, %bb.h, %bb.m, %bb.n, %bb.k, %bb.l, %bb.ab, %bb.ac, %bb.z, %bb.aa, %bb.ai
  %.0111 = phi i32 [ %i.fb, %bb.ai ], [ -1, %bb.ab ], [ -1, %bb.m ], [ -1, %bb.d ], [ -1, %bb.aa ], [ -1, %bb.z ], [ -1, %bb.ac ], [ -1, %bb.l ], [ -1, %bb.k ], [ -1, %bb.n ], [ -1, %bb.h ], [ -1, %bb.g ], [ -1, %bb.e ], [ -1, %bb.q ], [ -1, %bb.ah ], [ -1, %bb.ag ], [ -1, %bb.af ], [ -1, %bb.v ], [ -1, %bb.u ], [ -1, %bb.x ], [ -1, %bb.w ]
  ret i32 %.0111
}
...
vector.memcheck:                                  ; preds = %vector.scevcheck
  %i.dq = and i64 %indvars.iv, 4294967295
  %i.dr = zext i32 %i.dl to i64
  %i.ds = sub nsw i64 %i.dr, %i.dq
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  %i.dt = and i64 %i.dg, 28
  %n.vec = and i64 %i.dg, 4294967264              ; 4 uses
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 3 uses
  %i.du = trunc nuw i64 %index to i32
  %i.dv = add i32 %i.dl, %i.du
  %i.dw = zext i32 %i.dv to i64
  %i.dx = getelementptr inbounds nuw i8, ptr %2, i64 %i.dw ; 2 uses
  %i.dy = getelementptr inbounds nuw i8, ptr %i.dx, i64 16
  %wide.load = load <16 x i8>, ptr %i.dx, align 1, !tbaa !8
  %wide.load340 = load <16 x i8>, ptr %i.dy, align 1, !tbaa !8
  %i.dz = add nuw i64 %index, %indvars.iv
  %i.ea = and i64 %i.dz, 4294967295
  %i.eb = getelementptr inbounds nuw i8, ptr %2, i64 %i.ea ; 2 uses
  %i.ec = getelementptr inbounds nuw i8, ptr %i.eb, i64 16
  store <16 x i8> %wide.load, ptr %i.eb, align 1, !tbaa !8
  store <16 x i8> %wide.load340, ptr %i.ec, align 1, !tbaa !8
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.ed = icmp eq i64 %index.next, %n.vec
  br i1 %i.ed, label %middle.block, label %vector.body, !llvm.loop !26
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.ee = trunc nuw i64 %index342 to i32
  %i.ef = add i32 %i.dl, %i.ee
  %i.eg = zext i32 %i.ef to i64
  %i.eh = getelementptr inbounds nuw i8, ptr %2, i64 %i.eg
  %wide.load343 = load <4 x i8>, ptr %i.eh, align 1, !tbaa !8
  %i.ei = add nuw i64 %index342, %indvars.iv
  %i.ej = and i64 %i.ei, 4294967295
  %i.ek = getelementptr inbounds nuw i8, ptr %2, i64 %i.ej
  store <4 x i8> %wide.load343, ptr %i.ek, align 1, !tbaa !8
  %index.next344 = add nuw i64 %index342, 4       ; 2 uses
  %i.el = icmp eq i64 %index.next344, %n.vec341
  br i1 %i.el, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !27
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader
  %i.em = trunc nuw i64 %indvars.iv298.ph to i32
  %i.en = add i32 %i.dl, %i.em
  %i.eo = zext i32 %i.en to i64
  %i.ep = getelementptr inbounds nuw i8, ptr %2, i64 %i.eo
  %i.eq = load i8, ptr %i.ep, align 1, !tbaa !8
  %i.er = add nuw i64 %indvars.iv298.ph, %indvars.iv
...
._crit_edge:                                      ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %vec.epilog.middle.block, %middle.block
  %i.fl = add i32 %i.da, %i.l
  br label %bb.b

bb.ao:                                            ; preds = %bb.v
  %i.fm = tail call fastcc i32 @pefromupx(ptr noundef nonnull %0, i32 noundef %1, ptr noundef %2, ptr noundef %3, i32 noundef %6, i32 noundef %4, i32 noundef %5, ptr noundef @__const.upx_inflate2d.magic, i32 noundef %i.l)
  br label %doubleebx.exit.thread
...
doubleebx.exit.thread:                            ; preds = %bb.ac, %bb.ad, %bb.y, %bb.z, %bb.al, %bb.am, %bb.an, %bb.u, %bb.d, %bb.e, %bb.g, %bb.h, %bb.q, %bb.r, %bb.m, %bb.n, %bb.k, %bb.l, %bb.ah, %bb.ai, %bb.af, %bb.ag, %bb.ao
  %.0118 = phi i32 [ -1, %bb.d ], [ -1, %bb.ah ], [ -1, %bb.q ], [ %i.fm, %bb.ao ], [ -1, %bb.ag ], [ -1, %bb.af ], [ -1, %bb.ai ], [ -1, %bb.l ], [ -1, %bb.k ], [ -1, %bb.n ], [ -1, %bb.m ], [ -1, %bb.r ], [ -1, %bb.h ], [ -1, %bb.g ], [ -1, %bb.e ], [ -1, %bb.u ], [ -1, %bb.an ], [ -1, %bb.am ], [ -1, %bb.al ], [ -1, %bb.z ], [ -1, %bb.y ], [ -1, %bb.ad ], [ -1, %bb.ac ]
  ret i32 %.0118
}
