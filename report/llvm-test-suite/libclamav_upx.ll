...
bb.k:                                             ; preds = %bb.j
  ...
  %.fr447 = freeze i32 %i.bi                      ; 6 uses
  %.not255 = icmp ult i32 %.val306, %.fr447
...
.lr.ph396:                                        ; preds = %.preheader377, %.critedge9
  %.1204395 = phi ptr [ %i.bt, %.critedge9 ], [ %i.bo, %.preheader377 ] ; 6 uses
...
select.unfold.us.preheader:                       ; preds = %.lr.ph419
  ...
  %i.ct = sub i64 0, %i.cs
  %scevgep.a = getelementptr i8, ptr %2, i64 %i.ct
...
checkpe.exit319:                                  ; preds = %select.unfold, %bb.z, %select.unfold.us.preheader
  %.4207.lcssa = phi ptr [ %scevgep.a, %select.unfold.us.preheader ], [ %.4207417, %bb.z ], [ %i.dc, %select.unfold ] ; 2 uses
