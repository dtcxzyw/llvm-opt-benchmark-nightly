...
vector.scevcheck:                                 ; preds = %iter.check
  %i.dc = add nsw i64 %i.cw, -1                   ; 3 uses
  ...
  %i.dj = icmp ugt i64 %i.dc, 4294967295
  %i.dk = or i1 %i.di, %i.dj
  %i.dl = or i1 %i.df, %i.dk
  %i.dm = zext i32 %i.db to i64
  %i.dn = sub nsw i64 %i.dm, %i.ct
