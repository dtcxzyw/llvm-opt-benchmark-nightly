...
bb.u:                                             ; preds = %bb.t
  ...
  %.not43.i = icmp ugt i32 %i.ce, %.fr449
...
select.unfold.us.preheader:                       ; preds = %.lr.ph419
  ...
  %i.ct = sub i64 0, %i.cs
  %scevgep467 = getelementptr i8, ptr %2, i64 %i.ct
...
checkpe.exit319:                                  ; preds = %select.unfold, %bb.z, %select.unfold.us.preheader
  %.4207.lcssa = phi ptr [ %scevgep467, %select.unfold.us.preheader ], [ %.4207417, %bb.z ], [ %i.dc, %select.unfold ] ; 2 uses
