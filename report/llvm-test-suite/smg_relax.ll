...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %4 = icmp sgt i32 %.fr84, 2
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 192 ; 5 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 72
  %.166.us = load ptr, ptr %i.ab, align 8, !tbaa !48 ; 2 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %0, i64 64
  %.168.us = load i32, ptr %i.ac, align 8, !tbaa !4 ; 3 uses
  %i.ad = icmp sgt i32 %.168.us, 0                ; 2 uses
  br i1 %4, label %.preheader.lr.ph.us, label %.preheader.lr.ph

.preheader.us78.preheader:                        ; preds = %bb.g, %.preheader.lr.ph.us
  store i32 1, ptr %i.aa, align 8, !tbaa !49
  %i.ae = load i32, ptr %i.z, align 8, !tbaa !24  ; 3 uses
  %.166.in.us.1 = getelementptr inbounds nuw i8, ptr %0, i64 80
  %.166.us.1 = load ptr, ptr %.166.in.us.1, align 8, !tbaa !48
  %.168.in.us.1 = getelementptr inbounds nuw i8, ptr %0, i64 68
  %.168.us.1 = load i32, ptr %.168.in.us.1, align 4, !tbaa !4 ; 2 uses
...
._crit_edge.split.us.us.us.us.1:                  ; preds = %bb.f
  ...
  store i32 %i.aq, ptr %i.aa, align 8, !tbaa !49
...
.preheader.preheader:                             ; preds = %bb.h, %.preheader.lr.ph
  store i32 1, ptr %i.aa, align 8, !tbaa !49
  %i.bj = load i32, ptr %i.z, align 8, !tbaa !24  ; 3 uses
  %.166.in.1 = getelementptr inbounds nuw i8, ptr %0, i64 80
  %.166.1 = load ptr, ptr %.166.in.1, align 8, !tbaa !48
  %.168.in.1 = getelementptr inbounds nuw i8, ptr %0, i64 68
  %.168.1 = load i32, ptr %.168.in.1, align 4, !tbaa !4 ; 2 uses
...
._crit_edge.split.us75.1:                         ; preds = %bb.i
  ...
  store i32 %i.bv, ptr %i.aa, align 8, !tbaa !49
...
.split83.us.sink.split:                           ; preds = %.preheader.lr.ph.1, %.preheader.lr.ph.us.1
  ...
  store i32 %.sink, ptr %i.aa, align 8, !tbaa !49
  br label %.split83.us
