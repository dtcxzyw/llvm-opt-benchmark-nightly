...
begin_hunk_0_@_ZN4MeshC2Eiiiiddiii:.preheader217
  ...
  %i.ah = getelementptr inbounds nuw i8, ptr %0, i64 1024 ; 4 uses
...
begin_hunk_1_@_ZN4MeshC2Eiiiiddiii:.preheader217
  ...
  %10 = load ptr, ptr %i.dl, align 8, !tbaa !62   ; 2 uses
  %i.dm = load ptr, ptr %i.ah, align 8, !tbaa !63 ; 2 uses
  %11 = ptrtoint ptr %10 to i64
  %i.dn = ptrtoint ptr %i.dm to i64
  %12 = sub i64 %11, %i.dn
  %i.do = ashr exact i64 %12, 2                   ; 3 uses
...
bb.e:                                             ; preds = %bb.d
  %i.ds = getelementptr inbounds nuw [4 x i8], ptr %i.dm, i64 %i.dk ; 2 uses
  %.not.i.i = icmp eq ptr %10, %i.ds
