...
.thread542:                                       ; preds = %.thread.i, %_ZNSt6vectorIiSaIiEEC2ERKS1_.exit
  ...
  %i.be = phi ptr [ %i.m, %_ZNSt6vectorIiSaIiEEC2ERKS1_.exit ], [ %i.s, %.thread.i ] ; 5 uses
...
begin_hunk_3_@_ZN4Mesh13refine_smoothERSt6vectorIiSaIiEERiS4_:bb.a
  ...
  call void @cpu_timer_start(ptr noundef nonnull %4)
  br i1 %5, label %bb.o, label %_ZNSt6vectorIiSaIiEE5clearEv.exit

bb.o:                                             ; preds = %.thread542
...
begin_hunk_4_@_ZN4Mesh13refine_smoothERSt6vectorIiSaIiEERiS4_:bb.a
  ...
  %spec.select = select i1 %.not, ptr %i.be, ptr %i.bp
...
begin_hunk_5_@_ZN4Mesh13refine_smoothERSt6vectorIiSaIiEERiS4_:bb.a
  ...
  %i.cb = load i64, ptr %i.be, align 8, !tbaa !47 ; 2 uses
...
_ZNSt6vectorIiSaIiEE5clearEv.exit:                ; preds = %.thread547, %.critedge, %.thread542, %bb.o
  %6 = phi ptr [ %i.be, %.critedge ], [ %i.be, %.thread542 ], [ %i.be, %bb.o ], [ %i.p, %.thread547 ]
  %.sroa.0489.2590 = phi ptr [ %.sroa.0489.1.lcssa, %.critedge ], [ null, %.thread542 ], [ null, %bb.o ], [ null, %.thread547 ] ; 11 uses
  %.sroa.67.2589 = phi ptr [ %.sroa.67.1.lcssa, %.critedge ], [ null, %.thread542 ], [ null, %bb.o ], [ null, %.thread547 ] ; 7 uses
  %.sroa.49.3 = phi ptr [ %spec.select641, %.critedge ], [ null, %.thread542 ], [ null, %bb.o ], [ null, %.thread547 ] ; 6 uses
...
begin_hunk_7_@_ZN4Mesh13refine_smoothERSt6vectorIiSaIiEERiS4_:bb.a
  ...
  %i.ix = load i64, ptr %6, align 8, !tbaa !47    ; 6 uses
...
bb.ce:                                            ; preds = %bb.cd, %.thread599
  ...
  %i.so = phi i32 [ %i.sl, %.thread599 ], [ 0, %bb.cd ]
  ...
  %7 = icmp ne i32 %.pre695, 0
  %i.ss = icmp ne i32 %.pre696, 0
  %8 = select i1 %7, i1 true, i1 %i.ss
  %9 = zext i1 %8 to i8
  br label %_ZNSt6vectorIiSaIiEED2Ev.exit453

_ZNSt6vectorIiSaIiEED2Ev.exit453:                 ; preds = %.thread604, %bb.ce
  %.not364 = phi i8 [ 0, %.thread604 ], [ %9, %bb.ce ]
  %i.st = phi i32 [ 0, %.thread604 ], [ %i.so, %bb.ce ]
  %i.su = getelementptr inbounds nuw i8, ptr %0, i64 616
  store i8 %.not364, ptr %i.su, align 8, !tbaa !109
