...
.preheader213.preheader:                          ; preds = %bb.a
  ...
  br i1 %i.ab, label %.preheader213.epil.preheader, label %.preheader213.preheader.new

.preheader213.preheader.new:                      ; preds = %.preheader213.preheader
  %unroll_iter = and i64 %wide.trip.count, 2147483640
  br label %.preheader213

.preheader213:                                    ; preds = %.preheader213, %.preheader213.preheader.new
  %indvars.iv = phi i64 [ 0, %.preheader213.preheader.new ], [ %indvars.iv.next.7, %.preheader213 ] ; 9 uses
  %niter = phi i64 [ 0, %.preheader213.preheader.new ], [ %niter.next.7, %.preheader213 ]
...
.preheader212.preheader.unr-lcssa:                ; preds = %.preheader213
  ...
  br i1 %lcmp.mod.not, label %.preheader212.preheader, label %.preheader213.epil.preheader

.preheader213.epil.preheader:                     ; preds = %.preheader212.preheader.unr-lcssa, %.preheader213.preheader
  %indvars.iv.epil.init = phi i64 [ 0, %.preheader213.preheader ], [ %indvars.iv.next.7, %.preheader212.preheader.unr-lcssa ]
  %lcmp.mod254 = icmp ne i64 %xtraiter, 0
  tail call void @llvm.assume(i1 %lcmp.mod254)
  br label %.preheader213.epil

.preheader213.epil:                               ; preds = %.preheader213.epil, %.preheader213.epil.preheader
  %indvars.iv.epil = phi i64 [ %indvars.iv.epil.init, %.preheader213.epil.preheader ], [ %indvars.iv.next.epil, %.preheader213.epil ] ; 2 uses
  %epil.iter = phi i64 [ 0, %.preheader213.epil.preheader ], [ %epil.iter.next, %.preheader213.epil ]
  ...
  br i1 %epil.iter.cmp.not, label %.preheader212.preheader, label %.preheader213.epil, !llvm.loop !250

.preheader212.preheader:                          ; preds = %.preheader213.epil, %.preheader212.preheader.unr-lcssa
  ...
  br i1 %i.be, label %.preheader212.epil.preheader, label %.preheader212.preheader.new

.preheader212.preheader.new:                      ; preds = %.preheader212.preheader
  %unroll_iter259 = and i64 %wide.trip.count, 2147483640
  br label %.preheader212

.preheader212:                                    ; preds = %.preheader212, %.preheader212.preheader.new
  %indvars.iv230 = phi i64 [ 0, %.preheader212.preheader.new ], [ %indvars.iv.next231.7, %.preheader212 ] ; 9 uses
  %niter260 = phi i64 [ 0, %.preheader212.preheader.new ], [ %niter260.next.7, %.preheader212 ]
...
.preheader212.epil.preheader:                     ; preds = %.preheader211.loopexit.unr-lcssa, %.preheader212.preheader
  %indvars.iv230.epil.init = phi i64 [ 0, %.preheader212.preheader ], [ %indvars.iv.next231.7, %.preheader211.loopexit.unr-lcssa ]
  %lcmp.mod258 = icmp ne i64 %xtraiter255, 0
  tail call void @llvm.assume(i1 %lcmp.mod258)
  br label %.preheader212.epil

.preheader212.epil:                               ; preds = %.preheader212.epil, %.preheader212.epil.preheader
  %indvars.iv230.epil = phi i64 [ %indvars.iv230.epil.init, %.preheader212.epil.preheader ], [ %indvars.iv.next231.epil, %.preheader212.epil ] ; 2 uses
  %epil.iter256 = phi i64 [ 0, %.preheader212.epil.preheader ], [ %epil.iter256.next, %.preheader212.epil ]
...
.preheader:                                       ; preds = %bb.j, %.preheader211
  ...
  br i1 %i.da, label %.lr.ph222, label %._crit_edge223
...
._crit_edge223:                                   ; preds = %bb.s, %.preheader
  ret void
