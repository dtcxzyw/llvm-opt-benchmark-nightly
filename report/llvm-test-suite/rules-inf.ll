...
8:                                                ; preds = %bb.d
  ...
  br i1 %9, label %clause_SetSplitDataFromParents.exit, label %._crit_edge.i.a

._crit_edge.i.a:                                  ; preds = %8, %._crit_edge.i
...
clause_SetSplitDataFromParents.exit:              ; preds = %bb.ad, %bb.q, %8, %.preheader.i, %.preheader78.i
