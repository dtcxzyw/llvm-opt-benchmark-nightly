...
bb.g:                                             ; preds = %bb.f, %bb.c
  ...
  %i.aq = load float, ptr %i.i, align 4, !tbaa !43 ; 4 uses
  br i1 %i.an, label %.split.us, label %.split

.split.us:                                        ; preds = %bb.g
  %i.ar = load <2 x float>, ptr %i.k, align 4, !tbaa !43 ; 3 uses
...
bb.j:                                             ; preds = %bb.i, %bb.h
  ...
  %5 = load float, ptr %i.ba, align 4, !tbaa !43
  %6 = fmul float %5, %i.aq
  %7 = getelementptr inbounds nuw i8, ptr %i.ba, i64 4
  %8 = load <2 x float>, ptr %7, align 4, !tbaa !43
  %9 = fmul <2 x float> %8, %i.ar
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  %i.bj = getelementptr inbounds i8, ptr %i.ao, i64 %i.bi ; 2 uses
  %10 = load float, ptr %i.bj, align 4, !tbaa !43
  %11 = fmul float %10, %i.aq
  %12 = getelementptr inbounds nuw i8, ptr %i.bj, i64 4
  %13 = load <2 x float>, ptr %12, align 4, !tbaa !43
  %14 = fmul <2 x float> %13, %i.ar
...
_Z8btSetMinIfEvRT_RKS0_.exit.i.loopexit:          ; preds = %bb.o, %bb.n
  ...
  %i.bq = getelementptr inbounds i8, ptr %i.ao, i64 %i.bp ; 2 uses
  %15 = load float, ptr %i.bq, align 4, !tbaa !43
  %16 = fmul float %15, %i.aq
  %17 = getelementptr inbounds nuw i8, ptr %i.bq, i64 4
  %18 = load <2 x float>, ptr %17, align 4, !tbaa !43
  %19 = fmul <2 x float> %18, %i.ar
  br label %_Z8btSetMinIfEvRT_RKS0_.exit.i

.split:                                           ; preds = %bb.g
  %20 = fpext float %i.aq to double               ; 3 uses
  %21 = load <2 x float>, ptr %i.k, align 4, !tbaa !43
  %22 = fpext <2 x float> %21 to <2 x double>     ; 3 uses
...
_Z8btSetMinIfEvRT_RKS0_.exit.i:                   ; preds = %_Z8btSetMinIfEvRT_RKS0_.exit.i.loopexit147, %_Z8btSetMinIfEvRT_RKS0_.exit.i.loopexit
  %.sroa.24.0 = phi float [ %6, %_Z8btSetMinIfEvRT_RKS0_.exit.i.loopexit ], [ %63, %_Z8btSetMinIfEvRT_RKS0_.exit.i.loopexit147 ] ; 3 uses
  %.sroa.13.0 = phi float [ %11, %_Z8btSetMinIfEvRT_RKS0_.exit.i.loopexit ], [ %70, %_Z8btSetMinIfEvRT_RKS0_.exit.i.loopexit147 ] ; 3 uses
  %.sroa.0.0 = phi float [ %16, %_Z8btSetMinIfEvRT_RKS0_.exit.i.loopexit ], [ %77, %_Z8btSetMinIfEvRT_RKS0_.exit.i.loopexit147 ] ; 3 uses
  %23 = phi <2 x float> [ %19, %_Z8btSetMinIfEvRT_RKS0_.exit.i.loopexit ], [ %81, %_Z8btSetMinIfEvRT_RKS0_.exit.i.loopexit147 ] ; 4 uses
  %24 = phi <2 x float> [ %14, %_Z8btSetMinIfEvRT_RKS0_.exit.i.loopexit ], [ %74, %_Z8btSetMinIfEvRT_RKS0_.exit.i.loopexit147 ] ; 4 uses
  %25 = phi <2 x float> [ %9, %_Z8btSetMinIfEvRT_RKS0_.exit.i.loopexit ], [ %67, %_Z8btSetMinIfEvRT_RKS0_.exit.i.loopexit147 ] ; 4 uses
  %26 = extractelement <2 x float> %23, i64 1     ; 2 uses
  %27 = fcmp olt float %26, f0x5D5E0B6B
  %.sroa.18133.0 = select i1 %27, float %26, float f0x5D5E0B6B ; 2 uses
  %28 = fcmp ogt float %.sroa.0.0, f0xDD5E0B6B
  %.sroa.0113.0 = select i1 %28, float %.sroa.0.0, float f0xDD5E0B6B ; 2 uses
  %29 = fcmp ogt <2 x float> %23, splat (float f0xDD5E0B6B)
  %30 = extractelement <2 x float> %24, i64 1     ; 2 uses
  %31 = fcmp olt float %30, %.sroa.18133.0
  %.sroa.18133.1 = select i1 %31, float %30, float %.sroa.18133.0 ; 2 uses
  %32 = fcmp olt float %.sroa.0113.0, %.sroa.13.0
  %.sroa.0113.1 = select i1 %32, float %.sroa.13.0, float %.sroa.0113.0 ; 2 uses
  %33 = shufflevector <2 x float> %23, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %34 = insertelement <2 x float> %33, float %.sroa.0.0, i64 0 ; 2 uses
  %35 = fcmp olt <2 x float> %34, splat (float f0x5D5E0B6B)
  %36 = select <2 x i1> %35, <2 x float> %34, <2 x float> splat (float f0x5D5E0B6B) ; 2 uses
  %37 = shufflevector <2 x float> %24, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %38 = insertelement <2 x float> %37, float %.sroa.13.0, i64 0 ; 2 uses
  %39 = fcmp olt <2 x float> %38, %36
  %40 = select <2 x i1> %39, <2 x float> %38, <2 x float> %36 ; 2 uses
  %41 = shufflevector <2 x float> %25, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %42 = insertelement <2 x float> %41, float %.sroa.24.0, i64 0 ; 2 uses
  %43 = fcmp olt <2 x float> %42, %40
  %44 = select <2 x i1> %43, <2 x float> %42, <2 x float> %40
  %45 = extractelement <2 x float> %25, i64 1     ; 2 uses
  %46 = fcmp olt float %45, %.sroa.18133.1
  %.sroa.18133.2 = select i1 %46, float %45, float %.sroa.18133.1
  %47 = fcmp olt float %.sroa.0113.1, %.sroa.24.0
  %.sroa.0113.2 = select i1 %47, float %.sroa.24.0, float %.sroa.0113.1
  %i.br = load <2 x float>, ptr %i.l, align 8, !tbaa !43 ; 2 uses
  %i.bs = load <2 x float>, ptr %i.n, align 8, !tbaa !43 ; 2 uses
  %48 = extractelement <2 x float> %i.br, i64 0
  %49 = fsub float %.sroa.0113.2, %48
  %50 = extractelement <2 x float> %i.bs, i64 0
  %51 = fmul float %49, %50
  %i.bt = shufflevector <2 x float> %44, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.bu = insertelement <4 x float> %i.bt, float %.sroa.18133.2, i64 2
  %52 = insertelement <4 x float> %i.bu, float %51, i64 3
  %53 = shufflevector <2 x float> %i.br, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %54 = insertelement <4 x float> %53, float -1.000000e+00, i64 3
  %55 = shufflevector <2 x float> %i.bs, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %56 = insertelement <4 x float> %55, float 1.000000e+00, i64 3
  %57 = getelementptr inbounds nuw i8, ptr %i.s, i64 8
  %i.bv = select <2 x i1> %29, <2 x float> %23, <2 x float> splat (float f0xDD5E0B6B) ; 2 uses
  %58 = fcmp olt <2 x float> %i.bv, %24
  %59 = select <2 x i1> %58, <2 x float> %24, <2 x float> %i.bv ; 2 uses
  %i.bw = fcmp olt <2 x float> %59, %25
  %i.bx = select <2 x i1> %i.bw, <2 x float> %25, <2 x float> %59
  ...
  %60 = fmul <2 x float> %i.ca, %i.bz
  %i.cb = shufflevector <2 x float> %i.by, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %i.cc = shufflevector <4 x float> %54, <4 x float> %i.cb, <4 x i32> <i32 0, i32 1, i32 5, i32 3>
  %i.cd = fsub <4 x float> %52, %i.cc
  %i.ce = shufflevector <2 x float> %i.bz, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %i.cf = shufflevector <4 x float> %56, <4 x float> %i.ce, <4 x i32> <i32 0, i32 1, i32 5, i32 3>
  %i.cg = fmul <4 x float> %i.cd, %i.cf
  %i.ch = fptoui <4 x float> %i.cg to <4 x i16>   ; 2 uses
...
bb.r:                                             ; preds = %bb.q, %bb.p
  ...
  %i.cw = getelementptr inbounds i8, ptr %i.ao, i64 %i.cv ; 2 uses
  %61 = load double, ptr %i.cw, align 8, !tbaa !69
  %62 = fmul double %61, %20
  %63 = fptrunc double %62 to float
  %64 = getelementptr inbounds nuw i8, ptr %i.cw, i64 8
  %65 = load <2 x double>, ptr %64, align 8, !tbaa !69
  %66 = fmul <2 x double> %65, %22
...
bb.u:                                             ; preds = %bb.t, %bb.s
  ...
  %i.df = getelementptr inbounds i8, ptr %i.ao, i64 %i.de ; 2 uses
  %68 = load double, ptr %i.df, align 8, !tbaa !69
  %69 = fmul double %68, %20
  %70 = fptrunc double %69 to float
  %71 = getelementptr inbounds nuw i8, ptr %i.df, i64 8
  %72 = load <2 x double>, ptr %71, align 8, !tbaa !69
  %73 = fmul <2 x double> %72, %22
...
_Z8btSetMinIfEvRT_RKS0_.exit.i.loopexit147:       ; preds = %bb.w, %bb.v
  ...
  %i.dm = getelementptr inbounds i8, ptr %i.ao, i64 %i.dl ; 2 uses
  %75 = load double, ptr %i.dm, align 8, !tbaa !69
  %76 = fmul double %75, %20
  %77 = fptrunc double %76 to float
  %78 = getelementptr inbounds nuw i8, ptr %i.dm, i64 8
  %79 = load <2 x double>, ptr %78, align 8, !tbaa !69
  %80 = fmul <2 x double> %79, %22
...
_Z8btSetMinIfEvRT_RKS0_.exit.i:
  %4 = load float, ptr %1, align 4, !tbaa !43     ; 4 uses
  %5 = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 16
  %6 = load float, ptr %i.a, align 4, !tbaa !43   ; 4 uses
  %7 = getelementptr inbounds nuw i8, ptr %1, i64 20
  %i.b = getelementptr inbounds nuw i8, ptr %1, i64 32
  %8 = load float, ptr %i.b, align 4, !tbaa !43   ; 4 uses
  ...
  %10 = load <2 x float>, ptr %i.e, align 4, !tbaa !43 ; 2 uses
  %11 = load <2 x float>, ptr %i.g, align 4, !tbaa !43 ; 2 uses
  %12 = load <2 x float>, ptr %5, align 4, !tbaa !43 ; 4 uses
  %i.i = load <2 x float>, ptr %7, align 4, !tbaa !43 ; 4 uses
  %i.j = load <2 x float>, ptr %9, align 4, !tbaa !43 ; 4 uses
...
_ZN20btAlignedObjectArrayI18btQuantizedBvhNodeE9push_backERKS0_.exit: ; preds = %_Z8btSetMinIfEvRT_RKS0_.exit.i, %bb.a, %_ZN20btAlignedObjectArrayI18btQuantizedBvhNodeE10deallocateEv.exit.i.i
  ...
  %13 = shl i32 %2, 21
  %14 = or i32 %13, %3
  %15 = fcmp ogt <2 x float> %12, splat (float f0xDD5E0B6B)
  %16 = fcmp olt <2 x float> %12, splat (float f0x5D5E0B6B)
  %17 = fcmp ogt float %4, f0xDD5E0B6B
  %.sroa.0.1 = select i1 %17, float %4, float f0xDD5E0B6B ; 2 uses
  %18 = fcmp olt float %.sroa.0.1, %6
  %.sroa.0.2 = select i1 %18, float %6, float %.sroa.0.1 ; 2 uses
  %19 = fcmp olt float %.sroa.0.2, %8
  %.sroa.0.3 = select i1 %19, float %8, float %.sroa.0.2 ; 3 uses
  %20 = fcmp olt float %4, f0x5D5E0B6B
  %.sroa.046.1 = select i1 %20, float %4, float f0x5D5E0B6B ; 2 uses
  %21 = fcmp olt float %6, %.sroa.046.1
  %.sroa.046.2 = select i1 %21, float %6, float %.sroa.046.1 ; 2 uses
  %22 = fcmp olt float %8, %.sroa.046.2
  %.sroa.046.3 = select i1 %22, float %8, float %.sroa.046.2 ; 3 uses
  %23 = fsub float %.sroa.0.3, %.sroa.046.3
  %24 = fcmp olt float %23, 2.000000e-03          ; 2 uses
  %25 = fadd float %.sroa.0.3, 1.000000e-03
  %.sroa.0.0 = select i1 %24, float %25, float %.sroa.0.3
  %26 = extractelement <2 x float> %10, i64 0
  %27 = fsub float %.sroa.0.0, %26
  %28 = extractelement <2 x float> %11, i64 0
  %29 = fmul float %27, %28
  %30 = fadd float %.sroa.046.3, -1.000000e-03
  %.sroa.046.0 = select i1 %24, float %30, float %.sroa.046.3
  %31 = getelementptr inbounds nuw i8, ptr %i.n, i64 16
  %32 = load ptr, ptr %31, align 8, !tbaa !33
  %33 = sext i32 %i.as to i64
  %34 = getelementptr inbounds [16 x i8], ptr %32, i64 %33 ; 3 uses
  %35 = insertelement <4 x float> poison, float %.sroa.046.0, i64 0
  %36 = shufflevector <2 x float> %10, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %37 = insertelement <4 x float> %36, float -1.000000e+00, i64 3
  %38 = shufflevector <2 x float> %i.k, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %39 = shufflevector <4 x float> %37, <4 x float> %38, <4 x i32> <i32 0, i32 1, i32 5, i32 3>
  %i.at = shufflevector <2 x float> %11, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  ...
  %i.aw = shufflevector <4 x float> %i.au, <4 x float> %i.av, <4 x i32> <i32 0, i32 1, i32 5, i32 3>
  %.sroa.7.0..sroa_idx = getelementptr inbounds nuw i8, ptr %34, i64 8
  %40 = select <2 x i1> %15, <2 x float> %12, <2 x float> splat (float f0xDD5E0B6B) ; 2 uses
  %41 = fcmp olt <2 x float> %40, %i.i
  %42 = select <2 x i1> %41, <2 x float> %i.i, <2 x float> %40 ; 2 uses
  %43 = fcmp olt <2 x float> %42, %i.j
  %44 = select <2 x i1> %43, <2 x float> %i.j, <2 x float> %42 ; 3 uses
  %45 = select <2 x i1> %16, <2 x float> %12, <2 x float> splat (float f0x5D5E0B6B) ; 2 uses
  %46 = fcmp olt <2 x float> %i.i, %45
  %47 = select <2 x i1> %46, <2 x float> %i.i, <2 x float> %45 ; 2 uses
  %48 = fcmp olt <2 x float> %i.j, %47
  %49 = select <2 x i1> %48, <2 x float> %i.j, <2 x float> %47 ; 3 uses
  %50 = fsub <2 x float> %44, %49
  %51 = fcmp olt <2 x float> %50, splat (float 2.000000e-03) ; 2 uses
  %52 = fadd <2 x float> %44, splat (float 1.000000e-03)
  %i.ax = select <2 x i1> %51, <2 x float> %52, <2 x float> %44
  ...
  %53 = fadd <2 x float> %49, splat (float -1.000000e-03)
  %54 = select <2 x i1> %51, <2 x float> %53, <2 x float> %49
  %55 = shufflevector <2 x float> %54, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %56 = shufflevector <4 x float> %35, <4 x float> %55, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %57 = insertelement <4 x float> %56, float %29, i64 3
  %58 = fsub <4 x float> %57, %39
  %59 = fmul <4 x float> %58, %i.aw
  %60 = fptoui <4 x float> %59 to <4 x i16>       ; 2 uses
  ...
  store <4 x i16> %63, ptr %34, align 4
  store <2 x i16> %i.bc, ptr %.sroa.7.0..sroa_idx, align 4
  %.sroa.9.0..sroa_idx = getelementptr inbounds nuw i8, ptr %34, i64 12
