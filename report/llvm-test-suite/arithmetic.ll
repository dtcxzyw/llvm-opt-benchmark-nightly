...
.lr.ph.preheader.i:                               ; preds = %bb.d
  ...
  br i1 %min.iters.check, label %.lr.ph.i.preheader, label %vector.ph50
...
middle.block55:                                   ; preds = %vector.body51
  ...
  br i1 %cmp.n, label %update_model.exit, label %.lr.ph.i.preheader

.lr.ph.i.preheader:                               ; preds = %middle.block55, %.lr.ph.preheader.i
...
.lr.ph.i.3:                                       ; preds = %.lr.ph.i.2
  ...
  br i1 %.not62, label %update_model.exit, label %.lr.ph.i
...
update_model.exit:                                ; preds = %.lr.ph.i.preheader, %.lr.ph.i.1, %.lr.ph.i.2, %.lr.ph.i.3, %.lr.ph.i, %.lr.ph.i.5, %.lr.ph.i.6, %middle.block55, %bb.d
