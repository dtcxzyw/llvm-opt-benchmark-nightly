...
define dso_local void @Ppmd8_Construct(ptr noundef writeonly captures(none) initializes((56, 64)) %0) local_unnamed_addr #0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 56
  store ptr null, ptr %i.a, align 8, !tbaa !8
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 166 ; 7 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 128
  br label %iter.check

iter.check:                                       ; preds = %bb.a, %.loopexit
  %indvars.iv = phi i64 [ 0, %bb.a ], [ %indvars.iv.next, %.loopexit ] ; 5 uses
  %.02936 = phi i32 [ 0, %bb.a ], [ %.lcssa, %.loopexit ] ; 6 uses
  ...
  %i.k = icmp ugt i32 %.02936, %i.j
  %or.cond = select i1 %min.iters.check, i1 true, i1 %i.k
  br i1 %or.cond, label %vec.epilog.scalar.ph.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check51 = icmp samesign ult i32 %i.h, 32
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %i.l = add i32 %.02936, %n.vec                  ; 2 uses
  %i.m = and i32 %i.h, 31
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec54 = and i32 %i.h, 2147483644             ; 3 uses
  %i.s = add i32 %.02936, %n.vec54                ; 2 uses
  %i.t = and i32 %i.h, 3
  %broadcast.splatinsert55 = insertelement <4 x i8> poison, i8 %i.i, i64 0
  %broadcast.splat56 = shufflevector <4 x i8> %broadcast.splatinsert55, <4 x i8> poison, <4 x i32> zeroinitializer
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index57 = phi i32 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next58, %vec.epilog.vector.body ] ; 2 uses
  %i.u = add i32 %.02936, %index57
  %i.v = zext i32 %i.u to i64
  %i.w = getelementptr inbounds nuw i8, ptr %i.b, i64 %i.v
  store <4 x i8> %broadcast.splat56, ptr %i.w, align 1, !tbaa !15
  %index.next58 = add nuw i32 %index57, 4         ; 2 uses
  %i.x = icmp eq i32 %index.next58, %n.vec54
  br i1 %i.x, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !21

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n59 = icmp eq i32 %i.h, %n.vec54
  br i1 %cmp.n59, label %.loopexit, label %vec.epilog.scalar.ph.preheader

vec.epilog.scalar.ph.preheader:                   ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.130.ph = phi i32 [ %.02936, %iter.check ], [ %i.l, %vec.epilog.iter.check ], [ %i.s, %vec.epilog.middle.block ] ; 2 uses
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph.prol
  %.130.prol = phi i32 [ %i.z, %vec.epilog.scalar.ph.prol ], [ %.130.ph, %vec.epilog.scalar.ph.preheader ] ; 2 uses
  ...
  %i.z = add i32 %.130.prol, 1                    ; 3 uses
  %i.aa = zext i32 %.130.prol to i64
...
vec.epilog.scalar.ph.prol.loopexit:               ; preds = %vec.epilog.scalar.ph.prol, %vec.epilog.scalar.ph.preheader
  %.lcssa63.unr = phi i32 [ poison, %vec.epilog.scalar.ph.preheader ], [ %i.z, %vec.epilog.scalar.ph.prol ]
  %.130.unr = phi i32 [ %.130.ph, %vec.epilog.scalar.ph.preheader ], [ %i.z, %vec.epilog.scalar.ph.prol ]
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  %.130 = phi i32 [ %i.an, %vec.epilog.scalar.ph ], [ %.130.unr, %vec.epilog.scalar.ph.prol.loopexit ] ; 5 uses
  %.0 = phi i32 [ %i.aq, %vec.epilog.scalar.ph ], [ %.0.unr, %vec.epilog.scalar.ph.prol.loopexit ]
  %i.ae = add i32 %.130, 1
  %i.af = zext i32 %.130 to i64
...
.loopexit:                                        ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %vec.epilog.middle.block, %middle.block
  %.lcssa = phi i32 [ %i.s, %vec.epilog.middle.block ], [ %i.l, %middle.block ], [ %.lcssa63.unr, %vec.epilog.scalar.ph.prol.loopexit ], [ %i.an, %vec.epilog.scalar.ph ] ; 2 uses
...
.lr.ph:                                           ; preds = %.loopexit
  %i.at = getelementptr inbounds nuw i8, ptr %0, i64 600
  store i8 0, ptr %i.at, align 8, !tbaa !15
  %i.au = getelementptr inbounds nuw i8, ptr %0, i64 601
  store i8 2, ptr %i.au, align 1, !tbaa !15
  %i.av = getelementptr inbounds nuw i8, ptr %0, i64 602
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 2 dereferenceable(9) %i.av, i8 4, i64 9, i1 false)
  %i.aw = getelementptr inbounds nuw i8, ptr %0, i64 611
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(245) %i.aw, i8 6, i64 245, i1 false)
  %i.ax = getelementptr inbounds nuw i8, ptr %0, i64 856 ; 3 uses
  store <4 x i8> <i8 0, i8 1, i8 2, i8 3>, ptr %i.ax, align 8, !tbaa !15
  %i.ay = getelementptr inbounds nuw i8, ptr %0, i64 860
  store i8 4, ptr %i.ay, align 4, !tbaa !15
  br label %bb.b

bb.b:                                             ; preds = %bb.c, %.lr.ph
  %indvars.iv47 = phi i64 [ 5, %.lr.ph ], [ %indvars.iv.next48.1, %bb.c ] ; 3 uses
  %.02840 = phi i32 [ 5, %.lr.ph ], [ %.1.1, %bb.c ] ; 3 uses
  %.239 = phi i32 [ 1, %.lr.ph ], [ %.3.1, %bb.c ]
  %i.az = trunc i32 %.02840 to i8
  %i.ba = getelementptr inbounds nuw i8, ptr %i.ax, i64 %indvars.iv47
  ...
  br i1 %exitcond50.not, label %._crit_edge, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.bb = add i32 %.239, -1                       ; 2 uses
  %i.bc = icmp eq i32 %i.bb, 0                    ; 2 uses
  %i.bd = zext i1 %i.bc to i32
  %.1 = add i32 %.02840, %i.bd                    ; 3 uses
  %i.be = add i32 %.02840, -3
  %.3 = select i1 %i.bc, i32 %i.be, i32 %i.bb
  %i.bf = trunc i32 %.1 to i8
  %i.bg = getelementptr inbounds nuw i8, ptr %i.ax, i64 %indvars.iv.next48
  store i8 %i.bf, ptr %i.bg, align 1, !tbaa !15
  %i.bh = add i32 %.3, -1                         ; 2 uses
  %i.bi = icmp eq i32 %i.bh, 0                    ; 2 uses
  %i.bj = add i32 %.1, -3
  %.3.1 = select i1 %i.bi, i32 %i.bj, i32 %i.bh
...
define dso_local void @Ppmd8_Free(ptr noundef captures(none) initializes((48, 52)) %0, ptr noundef %1) local_unnamed_addr #3 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !26
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 56 ; 2 uses
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !8
  tail call void %i.b(ptr noundef %1, ptr noundef %i.d) #10
...
; Function Attrs: nounwind uwtable
define dso_local range(i32 0, 2) i32 @Ppmd8_Alloc(ptr noundef captures(none) %0, i32 noundef %1, ptr noundef %2) local_unnamed_addr #3 {
bb.a:
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  tail call void %i.g(ptr noundef %2, ptr noundef %i.b) #10, !inline_history !29
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 48 ; 2 uses
  store i32 0, ptr %i.h, align 8, !tbaa !28
  store ptr null, ptr %i.a, align 8, !tbaa !8
  %i.i = and i32 %1, 3
  %i.j = sub nuw nsw i32 4, %i.i                  ; 2 uses
  ...
  %i.o = tail call ptr %i.l(ptr noundef nonnull %2, i64 noundef %i.n) #10 ; 2 uses
  store ptr %i.o, ptr %i.a, align 8, !tbaa !8
...
define dso_local void @Ppmd8_Init(ptr noundef captures(none) initializes((0, 28), (32, 48), (52, 56), (64, 96), (100, 104), (296, 600)) %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #4 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 36
  store i32 %1, ptr %i.a, align 4, !tbaa !32
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 100
  store i32 %2, ptr %i.b, align 4, !tbaa !33
  tail call fastcc void @RestartModel(ptr noundef %0)
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 1116
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 1118
  store i8 7, ptr %i.d, align 2, !tbaa !34
  store i16 0, ptr %i.c, align 4, !tbaa !35
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 1119
  store i8 64, ptr %i.e, align 1, !tbaa !36
  ret void
}

; Function Attrs: nofree norecurse nosync nounwind memory(write, argmem: readwrite, inaccessiblemem: none, target_mem: none) uwtable
define internal fastcc void @RestartModel(ptr noundef captures(none) initializes((0, 28), (32, 36), (40, 48), (52, 56), (64, 96), (296, 600)) %0) unnamed_addr #4 {
end_hunk_0
...
iter.check:                                       ; preds = %._crit_edge130, %bb.l
  ...
  %i.dn = phi ptr [ %.pre133, %._crit_edge130 ], [ %i.dj, %bb.l ] ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.ld, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !80
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  br i1 %.not113, label %.loopexit, label %vec.epilog.scalar.ph, !llvm.loop !81
...
bb.m:                                             ; preds = %._crit_edge134, %.loopexit
  %.pre-phi142 = phi i64 [ %.pre141, %._crit_edge134 ], [ %i.dr, %.loopexit ]
  %i.lm = phi ptr [ %.pre137, %._crit_edge134 ], [ %i.dm, %.loopexit ]
  %i.ln = phi i8 [ %.pre136, %._crit_edge134 ], [ %i.lk, %.loopexit ]
  %i.lo = phi ptr [ %.pre133, %._crit_edge134 ], [ %i.dn, %.loopexit ] ; 2 uses
...
.preheader:                                       ; preds = %bb.f, %.preheader
  ...
  br i1 %.not212, label %bb.g, label %.preheader, !llvm.loop !82
...
.preheader.i:                                     ; preds = %bb.w, %.preheader.i
  ...
  br i1 %.not72.i, label %.loopexit.i, label %.preheader.i, !llvm.loop !83
...
bb.az:                                            ; preds = %AllocUnits.exit232, %AllocUnits.exit232.thread
  ...
  %i.ke = load i32, ptr %i.fc, align 4, !tbaa !85
...
.critedge226:                                     ; preds = %bb.bc, %bb.bb
  ...
  br i1 %.not217, label %._crit_edge, label %bb.an, !llvm.loop !86
...
define internal fastcc ptr @ShrinkUnits(ptr noundef captures(none) %0, ptr noundef %1, i32 noundef range(i32 1, 130) %2, i32 noundef range(i32 1, 129) %3) unnamed_addr #7 {
bb.a:
...
.new:                                             ; preds = %.prol.loopexit, %.new
  ...
  br i1 %.not37.1, label %.unr-lcssa, label %.new, !llvm.loop !87
...
bb.b:                                             ; preds = %bb.a
  store ptr %i.c, ptr %i.a, align 16, !tbaa !88
  br label %bb.c
...
bb.f:                                             ; preds = %bb.f, %bb.e
  ...
  br i1 %.not106, label %bb.g, label %bb.f, !llvm.loop !89
...
bb.l:                                             ; preds = %bb.j
  ...
  store ptr %.184, ptr %i.as, align 8, !tbaa !88
...
bb.o:                                             ; preds = %bb.o, %bb.n
  ...
  br i1 %.not108, label %bb.p, label %bb.o, !llvm.loop !90
...
bb.z:                                             ; preds = %bb.v, %bb.y, %bb.x
  ...
  br i1 %.not113, label %.thread, label %bb.u, !llvm.loop !91
...
; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define internal fastcc void @RestoreModel(ptr noundef initializes((80, 88)) %0, ptr noundef readnone captures(address) %1) unnamed_addr #6 {
bb.a:
...
.new:                                             ; preds = %.prol.loopexit, %.new
  ...
  br i1 %.not.i56.1, label %Refresh.exit, label %.new, !llvm.loop !92
...
bb.g:                                             ; preds = %SpecialFreeUnit.exit, %Refresh.exit
  ...
  br i1 %.not, label %.preheader67, label %bb.b, !llvm.loop !93
...
.new140:                                          ; preds = %.prol.loopexit139, %.new140
  ...
  br i1 %.not.i62.1, label %Refresh.exit63, label %.new140, !llvm.loop !92
...
bb.k:                                             ; preds = %bb.h, %Refresh.exit63, %bb.i
  ...
  br i1 %.not53, label %._crit_edge, label %.lr.ph77, !llvm.loop !94
...
.lr.ph79:                                         ; preds = %.preheader66, %.lr.ph79
  ...
  br i1 %.not54, label %..preheader_crit_edge, label %.lr.ph79, !llvm.loop !95
...
.lr.ph.i:                                         ; preds = %bb.p, %.lr.ph.i
  ...
  br i1 %i.iw, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !96
...
bb.r:                                             ; preds = %bb.s, %.loopexit
  ...
  br i1 %i.jg, label %bb.s, label %.loopexit, !llvm.loop !97
...
bb.s:                                             ; preds = %bb.r
  ...
  br i1 %i.jm, label %._crit_edge37.i, label %bb.r, !llvm.loop !98

._crit_edge37.i:                                  ; preds = %bb.s, %bb.q
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 38
  br i1 %exitcond.not.i, label %ExpandTextArea.exit, label %bb.q, !llvm.loop !99
...
ExpandTextArea.exit:                              ; preds = %._crit_edge37.i
  ...
  br i1 %i.jr, label %bb.n, label %bb.t, !llvm.loop !100
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define internal fastcc ptr @AllocUnitsRare(ptr noundef %0, i32 noundef range(i32 0, 257) %1) unnamed_addr #7 {
bb.a:
...
.lr.ph.i:                                         ; preds = %bb.g, %.lr.ph.i
  ...
  br i1 %i.ai, label %.lr.ph.i, label %.loopexit.i, !llvm.loop !101
...
.loopexit.i:                                      ; preds = %.lr.ph.i, %bb.g, %bb.f
  ...
  br i1 %.not57.i, label %._crit_edge.i, label %bb.f, !llvm.loop !102

._crit_edge.i:                                    ; preds = %.loopexit.i, %bb.e
  %.1.lcssa.i = phi ptr [ %.064.i, %bb.e ], [ %.2.i, %.loopexit.i ] ; 2 uses
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 38
  br i1 %exitcond.not.i, label %bb.h, label %bb.e, !llvm.loop !103
...
bb.i:                                             ; preds = %bb.k, %.lr.ph75.i
  ...
  br i1 %i.ax, label %bb.k, label %.preheader.i, !llvm.loop !104
...
.lr.ph67.i.prol.loopexit:                         ; preds = %.lr.ph67.i.prol, %.lr.ph67.i.preheader
  ...
  %.lcssa64.unr = phi i32 [ poison, %.lr.ph67.i.preheader ], [ %i.bi, %.lr.ph67.i.prol ]
...
.lr.ph67.i:                                       ; preds = %.lr.ph67.i.prol.loopexit, %.lr.ph67.i
  ...
  br i1 %i.ci, label %.lr.ph67.i, label %._crit_edge68.i, !llvm.loop !105
...
._crit_edge68.i:                                  ; preds = %.lr.ph67.i.prol.loopexit, %.lr.ph67.i, %.preheader.i
  ...
  %.047.lcssa.i = phi i32 [ %i.aw, %.preheader.i ], [ %.lcssa64.unr, %.lr.ph67.i.prol.loopexit ], [ %i.cg, %.lr.ph67.i ] ; 3 uses
...
bb.n:                                             ; preds = %.lr.ph
  ...
  br i1 %i.eq, label %._crit_edge, label %.lr.ph, !llvm.loop !106
...
.lr.ph:                                           ; preds = %bb.m, %bb.n
  ...
  br i1 %i.fp, label %bb.n, label %bb.p, !llvm.loop !106
...
define internal fastcc i32 @GetUsedMemory(ptr noundef readonly captures(none) %0) unnamed_addr #8 {
bb.a:
...
.new:                                             ; preds = %.prol.loopexit, %.new
  ...
  br i1 %.not.i98.1, label %.unr-lcssa, label %.new, !llvm.loop !107
...
bb.t:                                             ; preds = %bb.p, %bb.s, %bb.r
  ...
  br i1 %.not97, label %._crit_edge, label %bb.o, !llvm.loop !108
...
.new162:                                          ; preds = %.prol.loopexit161, %.new162
  ...
  br i1 %.not.i103.1, label %Refresh.exit, label %.new162, !llvm.loop !92
...
!79 = !{!"branch_weights", i32 8, i32 24}
!80 = distinct !{!80, !17, !18, !19}
!81 = distinct !{!81, !17, !19, !18}
!82 = distinct !{!82, !17}
!83 = distinct !{!83, !17}
!84 = distinct !{!84, !17}
!85 = !{!9, !5, i64 28}
