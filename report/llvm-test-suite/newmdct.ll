...
bb.b:                                             ; preds = %bb.a, %bb.b
  ...
  %.01991 = phi ptr [ getelementptr inbounds nuw (i8, ptr @enwindow, i64 56), %bb.a ], [ %i.fq, %bb.b ] ; 11 uses
  ...
  %2 = load <12 x double>, ptr %i.dd, align 8, !tbaa !9 ; 12 uses
  %i.gg = insertelement <2 x double> poison, double %i.dr, i64 0
  %i.gh = insertelement <2 x double> %i.gg, double %i.du, i64 1
  %i.gi = shufflevector <12 x double> %2, <12 x double> poison, <2 x i32> zeroinitializer
  %i.gj = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gh, <2 x double> %i.gi, <2 x double> %i.do)
  ...
  %3 = shufflevector <12 x double> %2, <12 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.gn = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gm, <2 x double> %3, <2 x double> %i.gj)
  ...
  %4 = shufflevector <12 x double> %2, <12 x double> poison, <2 x i32> <i32 2, i32 2>
  %i.gr = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gq, <2 x double> %4, <2 x double> %i.gn)
  ...
  %5 = shufflevector <12 x double> %2, <12 x double> poison, <2 x i32> <i32 3, i32 3>
  %i.gv = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gu, <2 x double> %5, <2 x double> %i.gr)
  ...
  %6 = shufflevector <12 x double> %2, <12 x double> poison, <2 x i32> <i32 4, i32 4>
  %i.gy = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gx, <2 x double> %6, <2 x double> %i.gv)
  ...
  %7 = shufflevector <12 x double> %2, <12 x double> poison, <2 x i32> <i32 5, i32 5>
  %i.hb = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ha, <2 x double> %7, <2 x double> %i.gy)
  %i.hc = shufflevector <8 x double> %i.gc, <8 x double> poison, <2 x i32> <i32 4, i32 2> ; 2 uses
  %i.hd = insertelement <2 x double> %i.hc, double %i.et, i64 0
  %8 = shufflevector <12 x double> %2, <12 x double> poison, <2 x i32> <i32 6, i32 6>
  %i.he = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hd, <2 x double> %8, <2 x double> %i.hb)
  %i.hf = shufflevector <8 x double> %i.gc, <8 x double> poison, <2 x i32> <i32 5, i32 3> ; 2 uses
  %i.hg = insertelement <2 x double> %i.hf, double %i.ey, i64 0
  %9 = shufflevector <12 x double> %2, <12 x double> poison, <2 x i32> <i32 7, i32 7>
  %i.hh = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hg, <2 x double> %9, <2 x double> %i.he)
  %i.hi = insertelement <2 x double> %i.hc, double %i.ff, i64 1
  %10 = shufflevector <12 x double> %2, <12 x double> poison, <2 x i32> <i32 8, i32 8>
  %i.hj = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hi, <2 x double> %10, <2 x double> %i.hh)
  %i.hk = insertelement <2 x double> %i.hf, double %i.fk, i64 1
  %11 = shufflevector <12 x double> %2, <12 x double> poison, <2 x i32> <i32 9, i32 9>
  %i.hl = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hk, <2 x double> %11, <2 x double> %i.hj)
  %i.hm = shufflevector <8 x double> %i.gc, <8 x double> poison, <2 x i32> <i32 6, i32 poison>
  %i.hn = insertelement <2 x double> %i.hm, double %i.fp, i64 1
  %12 = shufflevector <12 x double> %2, <12 x double> poison, <2 x i32> <i32 10, i32 10>
  %i.ho = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hn, <2 x double> %12, <2 x double> %i.hl)
  %i.hp = shufflevector <8 x double> %i.gc, <8 x double> poison, <2 x i32> <i32 7, i32 poison>
  %i.hq = insertelement <2 x double> %i.hp, double %i.gf, i64 1
  %13 = shufflevector <12 x double> %2, <12 x double> poison, <2 x i32> <i32 11, i32 11>
  %i.hr = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hq, <2 x double> %13, <2 x double> %i.ho) ; 3 uses
