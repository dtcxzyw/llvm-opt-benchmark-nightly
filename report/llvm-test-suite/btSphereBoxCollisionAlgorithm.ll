...
bb.a:
  ...
  %i.aa = load <2 x float>, ptr %6, align 4       ; 4 uses
  ...
  %i.an = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ae, <2 x float> %i.am, <2 x float> %i.ak) ; 4 uses
  ...
  %8 = fsub float %i.aq, %.sroa.6174.0.copyload   ; 3 uses
  %foldExtExtBinop239 = fsub <2 x float> %i.an, %i.aa ; 3 uses
  %i.ar = extractelement <2 x float> %foldExtExtBinop239, i64 1
  %9 = fmul float %i.ar, 0.000000e+00             ; 2 uses
  %10 = extractelement <2 x float> %foldExtExtBinop239, i64 0 ; 3 uses
  %i.as = fsub float %9, %10
  %i.at = tail call noundef float @llvm.fmuladd.f32(float %8, float 0.000000e+00, float %i.as)
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %11 = extractelement <2 x float> %foldExtExtBinop239, i64 1
  %i.ay = fneg float %11
  %i.az = tail call float @llvm.fmuladd.f32(float %10, float 0.000000e+00, float %i.ay)
  %i.ba = tail call noundef float @llvm.fmuladd.f32(float %8, float 0.000000e+00, float %i.az)
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  %i.bf = tail call float @llvm.fmuladd.f32(float %10, float 0.000000e+00, float %9)
  %i.bg = fsub float %i.bf, %8
