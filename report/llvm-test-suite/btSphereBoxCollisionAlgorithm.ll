...
bb.a:
  ...
  %8 = getelementptr inbounds nuw i8, ptr %1, i64 28 ; 2 uses
...
bb.m:                                             ; preds = %.thread, %bb.l
  ...
  %i.el = load float, ptr %i.ek, align 4, !tbaa !33 ; 4 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.fa = load <2 x float>, ptr %i.x, align 8, !tbaa !33
  %9 = load float, ptr %7, align 4, !tbaa !33
  %10 = load <2 x float>, ptr %i.aa, align 8, !tbaa !33
  %11 = load float, ptr %8, align 4, !tbaa !33
  %12 = fmul float %i.el, %11
  %13 = fmul float %i.el, %9
  %i.fb = shufflevector <2 x float> %i.fa, <2 x float> %10, <2 x i32> <i32 0, i32 2>
  ...
  %i.fe = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.fb, <2 x float> %i.fd, <2 x float> %15)
  ...
  %i.fw = load <2 x float>, ptr %i.x, align 8, !tbaa !33
  %16 = load float, ptr %7, align 4, !tbaa !33
  %i.fx = load float, ptr %i.ex, align 4, !tbaa !33 ; 3 uses
  %i.fy = load float, ptr %3, align 4, !tbaa !33  ; 2 uses
  %i.fz = load float, ptr %.sroa.47.0..sroa_idx, align 4, !tbaa !33 ; 2 uses
  %i.ga = load <2 x float>, ptr %i.aa, align 8, !tbaa !33
  %17 = load float, ptr %8, align 4, !tbaa !33
  %18 = fmul float %i.fx, %17
  %19 = fmul float %16, %i.fx
  %20 = shufflevector <2 x float> %i.fw, <2 x float> %i.ga, <2 x i32> <i32 0, i32 2>
  %21 = insertelement <2 x float> poison, float %i.fy, i64 0
  %22 = shufflevector <2 x float> %21, <2 x float> poison, <2 x i32> zeroinitializer
  %i.gb = insertelement <2 x float> poison, float %19, i64 0
  %23 = insertelement <2 x float> %i.gb, float %18, i64 1
  %i.gc = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %20, <2 x float> %22, <2 x float> %23)
...
bb.a:
  ...
  %8 = getelementptr inbounds nuw i8, ptr %1, i64 12 ; 2 uses
  %9 = getelementptr inbounds nuw i8, ptr %1, i64 28 ; 2 uses
...
.critedge46:                                      ; preds = %bb.q, %..critedge46_crit_edge
  ...
  %i.cw = load <2 x float>, ptr %i.a, align 4, !tbaa !33
  %10 = load float, ptr %8, align 4, !tbaa !33
  %i.cx = load float, ptr %i.co, align 4, !tbaa !33 ; 3 uses
  %i.cy = load float, ptr %2, align 4, !tbaa !33  ; 2 uses
  %i.cz = load float, ptr %.sroa.47.0..sroa_idx, align 4, !tbaa !33 ; 2 uses
  %i.da = load <2 x float>, ptr %i.d, align 4, !tbaa !33
  %11 = load float, ptr %9, align 4, !tbaa !33
  %12 = fmul float %i.cx, %11
  %13 = fmul float %10, %i.cx
  %14 = shufflevector <2 x float> %i.cw, <2 x float> %i.da, <2 x i32> <i32 0, i32 2>
  %15 = insertelement <2 x float> poison, float %i.cy, i64 0
  %16 = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> zeroinitializer
  %i.db = insertelement <2 x float> poison, float %13, i64 0
  %17 = insertelement <2 x float> %i.db, float %12, i64 1
  %i.dc = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> %16, <2 x float> %17)
  ...
  %i.dv = load <2 x float>, ptr %i.a, align 4, !tbaa !33
  %18 = load float, ptr %8, align 4, !tbaa !33
  %i.dw = load float, ptr %i.ds, align 4, !tbaa !33 ; 3 uses
  %i.dx = load float, ptr %3, align 4, !tbaa !33  ; 2 uses
  %i.dy = load float, ptr %.sroa.45.0..sroa_idx, align 4, !tbaa !33 ; 2 uses
  %i.dz = load <2 x float>, ptr %i.d, align 4, !tbaa !33
  %19 = load float, ptr %9, align 4, !tbaa !33
  %20 = fmul float %i.dw, %19
  %21 = fmul float %18, %i.dw
  %22 = shufflevector <2 x float> %i.dv, <2 x float> %i.dz, <2 x i32> <i32 0, i32 2>
  %23 = insertelement <2 x float> poison, float %i.dx, i64 0
  %24 = shufflevector <2 x float> %23, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ea = insertelement <2 x float> poison, float %21, i64 0
  %25 = insertelement <2 x float> %i.ea, float %20, i64 1
  %i.eb = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %22, <2 x float> %24, <2 x float> %25)
