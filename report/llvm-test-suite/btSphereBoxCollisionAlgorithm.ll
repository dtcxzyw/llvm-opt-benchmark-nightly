...
bb.a:
  ...
  %7 = load <3 x float>, ptr %4, align 4, !tbaa !33
  %8 = load <3 x float>, ptr %i.y, align 8, !tbaa !33
  %9 = fsub <3 x float> %7, %8                    ; 6 uses
  ...
  %11 = fmul <2 x float> %10, %i.ak
  %12 = shufflevector <3 x float> %9, <3 x float> poison, <2 x i32> zeroinitializer
  %13 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aj, <2 x float> %12, <2 x float> %11)
  %14 = shufflevector <3 x float> %9, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.am = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.al, <2 x float> %14, <2 x float> %13) ; 6 uses
  %15 = extractelement <3 x float> %9, i64 1
  %16 = fmul float %15, %i.ah
  %17 = extractelement <3 x float> %9, i64 0
  %18 = tail call float @llvm.fmuladd.f32(float %i.ag, float %17, float %16)
  %19 = extractelement <3 x float> %9, i64 2
  %i.an = tail call noundef float @llvm.fmuladd.f32(float %i.ai, float %19, float %18) ; 5 uses
  ...
  %i.at = fsub <2 x float> %i.am, %i.aq           ; 2 uses
...
bb.c:                                             ; preds = %bb.b, %bb.a
  %.sroa.0167.1 = phi <2 x float> [ %.sroa.0.4.vec.insert.i78, %bb.b ], [ %i.am, %bb.a ] ; 4 uses
...
bb.m:                                             ; preds = %.thread, %bb.l
  ...
  %i.db = fsub <2 x float> %i.am, %.sroa.0167.1.5289 ; 4 uses
  ...
  %i.dv = fsub <2 x float> %i.am, %i.du           ; 3 uses
