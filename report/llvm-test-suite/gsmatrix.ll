...
bb.g:                                             ; preds = %bb.a
  ...
  %i.bn = load float, ptr %i.bm, align 8, !tbaa !14
  ...
  store float %i.bv, ptr %i.bo, align 8, !tbaa !14
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.q = load float, ptr %i.p, align 8, !tbaa !14
  ...
  store float %i.aa, ptr %i.r, align 8, !tbaa !14
...
.thread:                                          ; preds = %bb.e
  ...
  %i.ar = load float, ptr %i.aq, align 8, !tbaa !14
  %i.as = fneg float %i.h
  ...
  store float %i.bs, ptr %i.bf, align 8, !tbaa !14
...
bb.d:                                             ; preds = %bb.b, %bb.a
  ...
  %6 = tail call double @sin(double noundef %i.j) #6, !tbaa !7
  %i.k = tail call double @cos(double noundef %i.j) #6, !tbaa !7
...
._crit_edge:                                      ; preds = %bb.c, %._crit_edge.loopexit, %bb.d
  ...
  %i.an = load float, ptr %i.am, align 8, !tbaa !14
  %i.ao = getelementptr inbounds nuw i8, ptr %2, i64 64
  store float %i.an, ptr %i.ao, align 8, !tbaa !14
...
bb.b:                                             ; preds = %bb.a
  ...
  store float %i.ab, ptr %3, align 4, !tbaa !21
  br label %bb.c
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.i = load float, ptr %i.h, align 8, !tbaa !14
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.aj = load float, ptr %i.ai, align 8, !tbaa !14
  %i.ak = fneg float %i.z
...
bb.e:                                             ; preds = %bb.d
  ...
  store float %i.bp, ptr %3, align 4, !tbaa !21
  br label %bb.f
