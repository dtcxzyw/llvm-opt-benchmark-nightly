...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %16 = insertelement <2 x float> poison, float %i.al, i64 0
  %i.bq = zext nneg i32 %i.bm to i64
  %17 = insertelement <2 x float> poison, float %i.al, i64 0
  br label %.peel.begin
...
.peel.next.preheader:                             ; preds = %bb.g, %bb.h
  br i1 %.not, label %.peel.next.peel, label %.peel.next.preheader.split

.peel.next.preheader.split:                       ; preds = %.peel.next.preheader
  %18 = insertelement <2 x float> poison, float %i.bv, i64 0
...
.peel.next.peel:                                  ; preds = %.peel.next.preheader, %bb.t
  ...
  %20 = insertelement <2 x float> poison, float %i.bv, i64 0
  %21 = shufflevector <2 x float> %20, <2 x float> poison, <2 x i32> zeroinitializer
  %i.du = insertelement <2 x float> poison, float %i.dn, i64 0
  %22 = insertelement <2 x float> %i.du, float %i.do, i64 1
  %i.dv = fmul <2 x float> %21, %22               ; 3 uses
  %23 = shufflevector <2 x float> %i.dv, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %24 = fmul <2 x float> %i.dt, %23
  %i.dw = load <2 x float>, ptr %1, align 4, !tbaa !9
  %i.dx = fadd <2 x float> %24, %i.dw
  %25 = shufflevector <2 x float> %i.dv, <2 x float> poison, <2 x i32> zeroinitializer
  %26 = fmul <2 x float> %i.ah, %25
  %i.dy = insertelement <2 x float> %17, float %i.dp, i64 1
  %27 = fmul <2 x float> %i.dy, %i.dv             ; 2 uses
  %28 = extractelement <2 x float> %27, i64 1
  %29 = fadd float %28, %i.dq
  %i.dz = fadd <2 x float> %26, %i.dx
  %30 = extractelement <2 x float> %27, i64 0
  %i.ea = fadd float %30, %29
...
.peel.next:                                       ; preds = %.peel.next.preheader.split, %bb.t
  %indvars.iv = phi i64 [ %indvars.iv.next, %bb.t ], [ 1, %.peel.next.preheader.split ] ; 4 uses
  ...
  %31 = insertelement <2 x float> poison, float %i.ez, i64 0
  %i.fg = insertelement <2 x float> %31, float %i.fa, i64 1
  %32 = fmul <2 x float> %19, %i.fg               ; 3 uses
  %33 = shufflevector <2 x float> %32, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %34 = fmul <2 x float> %i.ff, %33
  %i.fh = load <2 x float>, ptr %1, align 4, !tbaa !9
  %i.fi = fadd <2 x float> %34, %i.fh
  %35 = shufflevector <2 x float> %32, <2 x float> poison, <2 x i32> zeroinitializer
  %36 = fmul <2 x float> %i.ah, %35
  %i.fj = insertelement <2 x float> %16, float %i.fb, i64 1
  %37 = fmul <2 x float> %i.fj, %32               ; 2 uses
  %38 = extractelement <2 x float> %37, i64 1
  %39 = fadd float %38, %i.fc
  %i.fk = fadd <2 x float> %36, %i.fi
  %40 = extractelement <2 x float> %37, i64 0
  %i.fl = fadd float %40, %39
