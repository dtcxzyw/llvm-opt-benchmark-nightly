...
bb.c:                                             ; preds = %bb.b
  ...
  %.sroa.12500.8.vec.extract = load float, ptr %.sroa.12500.0..sroa_idx, align 4, !tbaa !88 ; 2 uses
  ...
  %34 = insertelement <2 x float> poison, float %i.ah, i64 0
  %i.au = insertelement <2 x float> %34, float %i.al, i64 1
  %i.av = insertelement <2 x float> poison, float %.sroa.12500.8.vec.extract, i64 0
  ...
  %.sroa.12500.8.vec.extract508 = load float, ptr %.sroa.12500.0..sroa_idx501, align 4, !tbaa !88 ; 2 uses
  ...
  %35 = insertelement <2 x float> poison, float %i.bw, i64 0
  %i.cj = insertelement <2 x float> %35, float %i.ca, i64 1
  %i.ck = insertelement <2 x float> poison, float %.sroa.12500.8.vec.extract508, i64 0
