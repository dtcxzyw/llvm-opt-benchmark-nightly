begin_hunk_0_@SeqInStream_Read:bb.a
  ...
  %i.c = call i32 %i.b(ptr noundef nonnull %0, ptr noundef %.01427.i, ptr noundef nonnull %i.a) #7, !inline_history !13 ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  %i.f = load ptr, ptr %i.a, align 8, !tbaa !19
...
begin_hunk_4_@LookInStream_Read:bb.a
  ...
  store i64 %.01626.i, ptr %i.a, align 8, !tbaa !8
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !21
  %i.d = call i32 %i.c(ptr noundef %0, ptr noundef %.01427.i, ptr noundef nonnull %i.a) #7, !inline_history !22 ; 2 uses
...
bb.a:
  ...
  store ptr @LookToRead_Skip, ptr %i.b, align 8, !tbaa !25
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 16
  store ptr @LookToRead_Read, ptr %i.c, align 8, !tbaa !26
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 24
  store ptr @LookToRead_Seek, ptr %i.d, align 8, !tbaa !27
  ret void
}
...
.thread:                                          ; preds = %bb.b, %bb.e, %bb.d
  ...
  store ptr %i.s, ptr %1, align 8, !tbaa !19
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #7
  ret i32 %.018
}
end_hunk_8
...
.thread:                                          ; preds = %bb.b, %bb.e, %bb.g, %bb.f
  ...
  %i.q = load i64, ptr %i.c, align 8, !tbaa !29
  %i.r = getelementptr inbounds nuw i8, ptr %i.p, i64 %i.q
  store ptr %i.r, ptr %1, align 8, !tbaa !19
  ret i32 %.02126
}
...
begin_hunk_15_@LookToRead_Read:bb.a
  ...
  %i.n = load i64, ptr %i.c, align 8, !tbaa !29
  %i.o = add i64 %i.n, %spec.select
  store i64 %i.o, ptr %i.c, align 8, !tbaa !29
...
bb.a:
  store ptr @SecToLook_Read, ptr %0, align 8, !tbaa !34
  ret void
}
...
bb.b:                                             ; preds = %bb.a
  %i.f = load ptr, ptr %i.c, align 8, !tbaa !18
  %i.g = call i32 %i.f(ptr noundef nonnull %i.c, ptr noundef nonnull %i.a, ptr noundef nonnull %2) #7, !inline_history !37 ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.m = call i32 %i.k(ptr noundef nonnull %i.c, i64 noundef %i.l) #7, !inline_history !37
...
bb.a:
  store ptr @SecToRead_Read, ptr %0, align 8, !tbaa !34
  ret void
}
...
!13 = !{ptr @SeqInStream_Read2}
!14 = !{!15, !15, i64 0}
!15 = !{!"long long", !6, i64 0}
!16 = !{!17, !12, i64 24}
!17 = !{!"", !12, i64 0, !12, i64 8, !12, i64 16, !12, i64 24}
!18 = !{!17, !12, i64 0}
!19 = !{!12, !12, i64 0}
!20 = !{!17, !12, i64 8}
!21 = !{!17, !12, i64 16}
!22 = !{ptr @LookInStream_Read2}
!23 = !{!24, !12, i64 0}
!24 = !{!"", !17, i64 0, !12, i64 32, !9, i64 40, !9, i64 48, !6, i64 56}
!25 = !{!24, !12, i64 8}
!26 = !{!24, !12, i64 16}
!27 = !{!24, !12, i64 24}
!28 = !{!24, !9, i64 48}
...
!33 = !{!32, !12, i64 8}
!34 = !{!35, !12, i64 0}
!35 = !{!"", !11, i64 0, !12, i64 8}
!36 = !{!35, !12, i64 8}
!37 = !{ptr @LookInStream_LookRead}
end_hunk_21
