...
begin_hunk_0_@_ZNKSt7__cxx1112regex_traitsIcE5valueEci:bb.a
  ...
  store ptr %i.b, ptr %4, align 8, !tbaa !46
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE12_M_constructEmc(ptr noundef nonnull align 8 dereferenceable(32) %4, i64 noundef 1, i8 noundef signext %1)
          to label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2IS3_EEmcRKS3_.exit unwind label %bb.c
...
bb.b:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2IS3_EEmcRKS3_.exit
...
bb.e:                                             ; preds = %bb.c
  ...
  %i.u = load ptr, ptr %i.t, align 8, !tbaa !716  ; 6 uses
...
bb.g:                                             ; preds = %bb.e
  %i.z = load ptr, ptr %i.s, align 8, !tbaa !648  ; 8 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load29 = load <4 x i32>, ptr %i.aw, align 2, !alias.scope !720, !noalias !717
  %i.ax = getelementptr i8, ptr %next.gep, i64 16
  store <4 x i32> %wide.load, ptr %next.gep, align 2, !alias.scope !717, !noalias !720
  store <4 x i32> %wide.load29, ptr %i.ax, align 2, !alias.scope !717, !noalias !720
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ay = icmp eq i64 %index.next, %n.vec
  br i1 %i.ay, label %middle.block, label %vector.body, !llvm.loop !722
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i.preheader31, %.lr.ph.i.i.i.i.i
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !717)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !720)
  %i.az = load i32, ptr %.0911.i.i.i.i.i, align 2, !alias.scope !720, !noalias !717
  store i32 %i.az, ptr %.012.i.i.i.i.i, align 2, !alias.scope !717, !noalias !720
...
_ZNSt6vectorINSt7__cxx1112regex_traitsIcE10_RegexMaskESaIS3_EE17_M_realloc_insertIJRKS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i: ; preds = %bb.i, %_ZNSt6vectorINSt7__cxx1112regex_traitsIcE10_RegexMaskESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit22.i.i
  ...
  store ptr %i.bc, ptr %i.t, align 8, !tbaa !716
  %i.bd = getelementptr inbounds nuw [4 x i8], ptr %i.ak, i64 %i.ai
  store ptr %i.bd, ptr %i.v, align 8, !tbaa !645
  br label %_ZNSt6vectorINSt7__cxx1112regex_traitsIcE10_RegexMaskESaIS3_EE9push_backERKS3_.exit
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load29 = load <4 x i32>, ptr %i.aw, align 2, !alias.scope !766, !noalias !763
  %i.ax = getelementptr i8, ptr %next.gep, i64 16
  store <4 x i32> %wide.load, ptr %next.gep, align 2, !alias.scope !763, !noalias !766
  store <4 x i32> %wide.load29, ptr %i.ax, align 2, !alias.scope !763, !noalias !766
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ay = icmp eq i64 %index.next, %n.vec
  br i1 %i.ay, label %middle.block, label %vector.body, !llvm.loop !768
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i.preheader31, %.lr.ph.i.i.i.i.i
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !763)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !766)
  %i.az = load i32, ptr %.0911.i.i.i.i.i, align 2, !alias.scope !766, !noalias !763
  store i32 %i.az, ptr %.012.i.i.i.i.i, align 2, !alias.scope !763, !noalias !766
  %i.ba = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i, i64 4 ; 2 uses
  %i.bb = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i, i64 4 ; 2 uses
  %.not.i.i.i.i.i = icmp eq ptr %i.ba, %i.u
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load29 = load <4 x i32>, ptr %i.aw, align 2, !alias.scope !792, !noalias !789
  %i.ax = getelementptr i8, ptr %next.gep, i64 16
  store <4 x i32> %wide.load, ptr %next.gep, align 2, !alias.scope !789, !noalias !792
  store <4 x i32> %wide.load29, ptr %i.ax, align 2, !alias.scope !789, !noalias !792
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ay = icmp eq i64 %index.next, %n.vec
  br i1 %i.ay, label %middle.block, label %vector.body, !llvm.loop !794
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i.preheader31, %.lr.ph.i.i.i.i.i
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !789)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !792)
  %i.az = load i32, ptr %.0911.i.i.i.i.i, align 2, !alias.scope !792, !noalias !789
  store i32 %i.az, ptr %.012.i.i.i.i.i, align 2, !alias.scope !789, !noalias !792
  %i.ba = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i, i64 4 ; 2 uses
  %i.bb = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i, i64 4 ; 2 uses
  %.not.i.i.i.i.i = icmp eq ptr %i.ba, %i.u
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load29 = load <4 x i32>, ptr %i.aw, align 2, !alias.scope !811, !noalias !808
  %i.ax = getelementptr i8, ptr %next.gep, i64 16
  store <4 x i32> %wide.load, ptr %next.gep, align 2, !alias.scope !808, !noalias !811
  store <4 x i32> %wide.load29, ptr %i.ax, align 2, !alias.scope !808, !noalias !811
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ay = icmp eq i64 %index.next, %n.vec
  br i1 %i.ay, label %middle.block, label %vector.body, !llvm.loop !813
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i.preheader31, %.lr.ph.i.i.i.i.i
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !808)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !811)
  %i.az = load i32, ptr %.0911.i.i.i.i.i, align 2, !alias.scope !811, !noalias !808
  store i32 %i.az, ptr %.012.i.i.i.i.i, align 2, !alias.scope !808, !noalias !811
  %i.ba = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i, i64 4 ; 2 uses
  %i.bb = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i, i64 4 ; 2 uses
  %.not.i.i.i.i.i = icmp eq ptr %i.ba, %i.u
