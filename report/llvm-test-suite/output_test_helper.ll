...
bb.a:
  %2 = alloca %"struct.std::__detail::_State", align 8 ; 11 uses
  %3 = alloca %"struct.std::__detail::_State", align 8 ; 14 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #33
  store i32 11, ptr %2, align 8, !tbaa !337
...
bb.b:                                             ; preds = %bb.a
  %.sroa.0.0.copyload = load <2 x i64>, ptr %1, align 8, !tbaa !19
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.e, i8 0, i64 16, i1 false)
  br label %bb.c

bb.c:                                             ; preds = %bb.b, %bb.a
  %.sroa.0.0.copyload.i.i.i = phi <2 x i64> [ zeroinitializer, %bb.a ], [ %.sroa.0.0.copyload, %bb.b ]
  store <2 x i64> %.sroa.0.0.copyload.i.i.i, ptr %i.b, align 8, !tbaa !19
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %3, ptr noundef nonnull align 8 dereferenceable(48) %2, i64 16, i1 false), !tbaa.struct !467
  ...
  store ptr %i.d, ptr %i.j, align 8, !tbaa !361
...
bb.d:                                             ; preds = %bb.c
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.i, ptr noundef nonnull align 8 dereferenceable(32) %i.b, i64 16, i1 false), !tbaa.struct !524
...
bb.e:                                             ; preds = %_ZNSt8__detail6_StateIcEC2EOS1_.exit
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %i.n, ptr noundef nonnull align 8 dereferenceable(48) %3, i64 48, i1 false), !tbaa.struct !467
  %i.q = load i32, ptr %3, align 8, !tbaa !337
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.v = load ptr, ptr %i.u, align 8, !tbaa !361
  store ptr %i.v, ptr %i.t, align 8, !tbaa !361
...
bb.g:                                             ; preds = %bb.f
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.s, ptr noundef nonnull align 8 dereferenceable(32) %i.y, i64 16, i1 false), !tbaa.struct !524
...
bb.h:                                             ; preds = %_ZNSt8__detail6_StateIcEC2EOS1_.exit
  invoke void @_ZNSt6vectorINSt8__detail6_StateIcEESaIS2_EE17_M_realloc_insertIJS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_(ptr noundef nonnull align 8 dereferenceable(24) %i.l, ptr %i.n, ptr noundef nonnull align 8 dereferenceable(48) %3)
...
bb.j:                                             ; preds = %_ZNSt6vectorINSt8__detail6_StateIcEESaIS2_EE9push_backEOS2_.exit.i
  %i.aj = load i32, ptr %3, align 8, !tbaa !337
...
end_hunk_4
begin_hunk_5_@_ZNSt8__detail4_NFAINSt7__cxx1112regex_traitsIcEEE17_M_insert_matcherESt8functionIFbcEE:bb.a
  unreachable

_ZNSt8__detail6_StateIcED2Ev.exit:                ; preds = %bb.j, %bb.k, %bb.l
  %i.ar = load i32, ptr %2, align 8, !tbaa !337
  %i.as = icmp eq i32 %i.ar, 11
  br i1 %i.as, label %bb.n, label %_ZNSt8__detail6_StateIcED2Ev.exit7

end_hunk_5
begin_hunk_6_@_ZNSt8__detail4_NFAINSt7__cxx1112regex_traitsIcEEE17_M_insert_matcherESt8functionIFbcEE:bb.a
...
bb.q:                                             ; preds = %bb.i, %bb.h
  %i.ay = landingpad { ptr, i32 }
          cleanup
  call void @_ZNSt8__detail6_StateIcED2Ev(ptr noundef nonnull align 8 dereferenceable(48) %3) #33
