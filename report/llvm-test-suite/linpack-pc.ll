...
.lr.ph103.preheader:                              ; preds = %bb.a
  ...
  %scevgep118 = getelementptr i8, ptr %0, i64 %i.g
...
.lr.ph103:                                        ; preds = %.lr.ph103.preheader, %.loopexit
  ...
  %5 = add nuw i64 %indvars.iv107, 1
  %i.n = mul i64 %i.f, %5
  %scevgep = getelementptr i8, ptr %0, i64 %i.n
  %6 = shl nuw nsw i64 %indvars.iv107, 2
  %i.o = getelementptr i8, ptr %0, i64 %6
  %scevgep116 = getelementptr i8, ptr %i.o, i64 4
  %7 = trunc i64 %indvars.iv107 to i32
  %8 = mul i32 %1, %7
  %9 = sext i32 %8 to i64
  %10 = shl nsw i64 %9, 2                         ; 2 uses
  %scevgep117 = getelementptr i8, ptr %scevgep116, i64 %10
  %scevgep119 = getelementptr i8, ptr %scevgep118, i64 %10
...
.lr.ph:                                           ; preds = %.lr.ph25.i, %middle.block134
  ...
  %bound1 = icmp ult ptr %scevgep117, %scevgep115
  %found.conflict = and i1 %bound0, %bound1
