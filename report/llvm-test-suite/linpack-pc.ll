...
.lr.ph103.i:                                      ; preds = %.lr.ph103.i.preheader, %.loopexit.i
  ...
  %indvars.iv107.i = phi i64 [ %indvars.iv.next108.i, %.loopexit.i ], [ 0, %.lr.ph103.i.preheader ] ; 12 uses
  ...
  %i.xa = mul nuw nsw i64 %indvars.iv107.i, 804
...
idamax.exit.loopexit.i:                           ; preds = %idamax.exit.loopexit.i.unr-lcssa, %.lr.ph48.i.i.epil.preheader
  ...
  %.idx387 = mul nuw nsw i64 %indvars.iv107.i, 804
  %i.xx = getelementptr i8, ptr @main.a, i64 %.idx387
...
.lr.ph103.i199:                                   ; preds = %.lr.ph103.i199.preheader, %.loopexit.i213
  ...
  %indvars.iv107.i200 = phi i64 [ %indvars.iv.next108.i212, %.loopexit.i213 ], [ 0, %.lr.ph103.i199.preheader ] ; 12 uses
  ...
  %i.adm = mul nuw nsw i64 %indvars.iv107.i200, 804
...
idamax.exit.loopexit.i211:                        ; preds = %idamax.exit.loopexit.i211.unr-lcssa, %.lr.ph48.i.i203.epil.preheader
  ...
  %.idx385 = mul nuw nsw i64 %indvars.iv107.i200, 804
  %i.aej = getelementptr i8, ptr @main.a, i64 %.idx385
...
.lr.ph103.i309:                                   ; preds = %.lr.ph103.i309.preheader, %.loopexit.i323
  ...
  %indvars.iv107.i310 = phi i64 [ %indvars.iv.next108.i322, %.loopexit.i323 ], [ 0, %.lr.ph103.i309.preheader ] ; 12 uses
  ...
  %i.aqn = mul nuw nsw i64 %indvars.iv107.i310, 800
...
idamax.exit.loopexit.i321:                        ; preds = %idamax.exit.loopexit.i321.unr-lcssa, %.lr.ph48.i.i313.epil.preheader
  ...
  %.idx381 = mul nuw nsw i64 %indvars.iv107.i310, 800
  %i.ark = getelementptr i8, ptr @main.aa, i64 %.idx381
