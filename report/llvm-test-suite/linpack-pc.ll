...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  %10 = fmul float %1, %9
  store float %10, ptr %8, align 4, !tbaa !18
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %i.f, align 4, !tbaa !18, !alias.scope !236, !noalias !237
  %wide.load63 = load <4 x float>, ptr %i.g, align 4, !tbaa !18, !alias.scope !236, !noalias !237
  %i.h = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %index ; 2 uses
  %i.i = getelementptr inbounds nuw i8, ptr %i.h, i64 16
  %wide.load64 = load <4 x float>, ptr %i.h, align 4, !tbaa !18, !alias.scope !237
  %wide.load65 = load <4 x float>, ptr %i.i, align 4, !tbaa !18, !alias.scope !237
  ...
  store <4 x float> %i.l, ptr %i.f, align 4, !tbaa !18, !alias.scope !236, !noalias !237
  store <4 x float> %i.m, ptr %i.g, align 4, !tbaa !18, !alias.scope !236, !noalias !237
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.n = icmp eq i64 %index.next, %n.vec
  br i1 %i.n, label %middle.block, label %vector.body, !llvm.loop !229
...
vector.body81:                                    ; preds = %vector.body81, %vector.ph77
  ...
  %wide.load83 = load <4 x float>, ptr %gep, align 4, !tbaa !18, !alias.scope !238, !noalias !239
  %wide.load84 = load <4 x float>, ptr %i.at, align 4, !tbaa !18, !alias.scope !238, !noalias !239
  %gep99 = getelementptr [4 x i8], ptr %invariant.gep98, i64 %index82 ; 2 uses
  %i.au = getelementptr inbounds nuw i8, ptr %gep99, i64 16
  %wide.load85 = load <4 x float>, ptr %gep99, align 4, !tbaa !18, !alias.scope !239
  %wide.load86 = load <4 x float>, ptr %i.au, align 4, !tbaa !18, !alias.scope !239
  ...
  store <4 x float> %i.ax, ptr %gep, align 4, !tbaa !18, !alias.scope !238, !noalias !239
  store <4 x float> %i.ay, ptr %i.at, align 4, !tbaa !18, !alias.scope !238, !noalias !239
  %index.next87 = add nuw i64 %index82, 8         ; 2 uses
  %i.az = icmp eq i64 %index.next87, %n.vec78
  br i1 %i.az, label %middle.block88, label %vector.body81, !llvm.loop !233
...
.lr.ph47:                                         ; preds = %.lr.ph47.prol.loopexit, %.lr.ph47
  ...
  br i1 %exitcond57.not.1, label %.loopexit, label %.lr.ph47, !llvm.loop !234
