...
begin_hunk_1_@dmxpy:bb.a
  ...
  %i.bm = fmul <4 x float> %broadcast.splat397.a, %wide.load390
  %i.bn = fmul <4 x float> %broadcast.splat397.a, %wide.load391
  ...
  %i.bs = fmul <4 x float> %broadcast.splat393, %wide.load394
  %i.bt = fmul <4 x float> %broadcast.splat393, %wide.load395
...
vector.ph445:                                     ; preds = %vector.memcheck402
  ...
  %i.ft = load float, ptr %i.dl, align 4, !tbaa !11, !alias.scope !120
  ...
  %i.fu = load float, ptr %i.dp, align 4, !tbaa !11, !alias.scope !123
  ...
  %i.fv = load float, ptr %i.dt, align 4, !tbaa !11, !alias.scope !125
  ...
  %i.fw = load float, ptr %i.dw, align 4, !tbaa !11, !alias.scope !127
...
begin_hunk_3_@dmxpy:bb.a
  ...
  %i.fz = fmul <4 x float> %broadcast.splat462.a, %wide.load451
  ...
  %i.gc = fmul <4 x float> %broadcast.splat459.a, %wide.load454
  ...
  %i.gf = fmul <4 x float> %broadcast.splat456, %wide.load457
  ...
  %i.gi = fmul <4 x float> %broadcast.splat453, %wide.load460
...
vector.ph550:                                     ; preds = %vector.memcheck467
  ...
  %i.lq = load float, ptr %i.hi, align 4, !tbaa !11, !alias.scope !142
  ...
  %i.lr = load float, ptr %i.hm, align 4, !tbaa !11, !alias.scope !145
  ...
  %i.ls = load float, ptr %i.hq, align 4, !tbaa !11, !alias.scope !147
  ...
  %i.lt = load float, ptr %i.hu, align 4, !tbaa !11, !alias.scope !149
  ...
  %i.lu = load float, ptr %i.hy, align 4, !tbaa !11, !alias.scope !151
  ...
  %i.lv = load float, ptr %i.ic, align 4, !tbaa !11, !alias.scope !153
  ...
  %i.lw = load float, ptr %i.ig, align 4, !tbaa !11, !alias.scope !155
  ...
  %i.lx = load float, ptr %i.ij, align 4, !tbaa !11, !alias.scope !157
...
begin_hunk_5_@dmxpy:bb.a
  ...
  %i.ma = fmul <4 x float> %broadcast.splat579.a, %wide.load556
  ...
  %i.md = fmul <4 x float> %broadcast.splat576.a, %wide.load559
  ...
  %i.mg = fmul <4 x float> %broadcast.splat573.a, %wide.load562
  ...
  %i.mj = fmul <4 x float> %broadcast.splat570.a, %wide.load565
  ...
  %i.mm = fmul <4 x float> %broadcast.splat567, %wide.load568
  ...
  %i.mp = fmul <4 x float> %broadcast.splat564, %wide.load571
  ...
  %i.ms = fmul <4 x float> %broadcast.splat561, %wide.load574
  ...
  %i.mv = fmul <4 x float> %broadcast.splat558, %wide.load577
...
vector.ph704:                                     ; preds = %.preheader.us
  %i.wm = load float, ptr %i.us, align 4, !tbaa !11, !alias.scope !180
  ...
  %i.wn = load float, ptr %i.uv, align 4, !tbaa !11, !alias.scope !180
  ...
  %i.wo = load float, ptr %i.uy, align 4, !tbaa !11, !alias.scope !180
  ...
  %i.wp = load float, ptr %i.vb, align 4, !tbaa !11, !alias.scope !180
  ...
  %i.wq = load float, ptr %i.ve, align 4, !tbaa !11, !alias.scope !180
  ...
  %i.wr = load float, ptr %i.vh, align 4, !tbaa !11, !alias.scope !180
  ...
  %i.ws = load float, ptr %i.vk, align 4, !tbaa !11, !alias.scope !180
  ...
  %i.wt = load float, ptr %i.vn, align 4, !tbaa !11, !alias.scope !180
  ...
  %i.wu = load float, ptr %i.vq, align 4, !tbaa !11, !alias.scope !180
  ...
  %i.wv = load float, ptr %i.vt, align 4, !tbaa !11, !alias.scope !180
  ...
  %i.ww = load float, ptr %i.vw, align 4, !tbaa !11, !alias.scope !180
  ...
  %i.wx = load float, ptr %i.vz, align 4, !tbaa !11, !alias.scope !180
  ...
  %i.wy = load float, ptr %i.wc, align 4, !tbaa !11, !alias.scope !180
  ...
  %i.wz = load float, ptr %i.wf, align 4, !tbaa !11, !alias.scope !180
  ...
  %i.xa = load float, ptr %i.wi, align 4, !tbaa !11, !alias.scope !180
  ...
  %i.xb = load float, ptr %i.wk, align 4, !tbaa !11, !alias.scope !180
...
begin_hunk_7_@dmxpy:bb.a
  ...
  %i.xe = fmul <4 x float> %broadcast.splat757.a, %wide.load710
  ...
  %i.xh = fmul <4 x float> %broadcast.splat754.a, %wide.load713
  ...
  %i.xk = fmul <4 x float> %broadcast.splat751.a, %wide.load716
  ...
  %i.xn = fmul <4 x float> %broadcast.splat748.a, %wide.load719
  ...
  %i.xq = fmul <4 x float> %broadcast.splat745.a, %wide.load722
  ...
  %i.xt = fmul <4 x float> %broadcast.splat742.a, %wide.load725
  ...
  %i.xw = fmul <4 x float> %broadcast.splat739.a, %wide.load728
  ...
  %i.xz = fmul <4 x float> %broadcast.splat736.a, %wide.load731
  ...
  %i.yc = fmul <4 x float> %broadcast.splat733, %wide.load734
  ...
  %i.yf = fmul <4 x float> %broadcast.splat730, %wide.load737
  ...
  %i.yi = fmul <4 x float> %broadcast.splat727, %wide.load740
  ...
  %i.yl = fmul <4 x float> %broadcast.splat724, %wide.load743
  ...
  %i.yo = fmul <4 x float> %broadcast.splat721, %wide.load746
  ...
  %i.yr = fmul <4 x float> %broadcast.splat718, %wide.load749
  ...
  %i.yu = fmul <4 x float> %broadcast.splat715, %wide.load752
  ...
  %i.yx = fmul <4 x float> %broadcast.splat712, %wide.load755
