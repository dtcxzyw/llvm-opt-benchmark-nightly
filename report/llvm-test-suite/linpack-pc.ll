...
.lr.ph103:                                        ; preds = %.lr.ph103.preheader, %.loopexit
  ...
  %i.n = add nsw i64 %i.m, %wide.trip.count       ; 3 uses
  %5 = sub i64 %i.k, %indvars.iv107               ; 3 uses
  %6 = sub i64 %i.k, %indvars.iv107               ; 3 uses
...
bb.b:                                             ; preds = %.lr.ph103
  ...
  %i.af = icmp eq i64 %i.l, %indvars.iv107
...
begin_hunk_3
  ...
  %lcmp.mod142 = trunc i64 %i.n to i1
...
middle.block137:                                  ; preds = %vector.body132
  %cmp.n138 = icmp eq i64 %5, %n.vec129
...
.lr.ph:                                           ; preds = %.lr.ph25.i, %middle.block137
  ...
  %i.bp = sub i64 %i.k, %indvars.iv107
  %i.bq = and i64 %i.bp, 1
...
.lr.ph.i.preheader140:                            ; preds = %.lr.ph.i.preheader, %middle.block
  ...
  br i1 %lcmp.mod144.not.not, label %.lr.ph.i.prol.loopexit, label %.lr.ph.i.prol
