...
.lr.ph135:                                        ; preds = %._crit_edge140, %._crit_edge131
  ...
  %i.dw = shl nuw nsw i64 %indvar174, 1
  %i.dx = add nuw i64 %i.dw, 2
...
scalar.ph266.preheader:                           ; preds = %vector.body281, %vector.memcheck230, %.lr.ph135
  ...
  %indvars.iv153.ph = phi i64 [ %.098142, %vector.memcheck230 ], [ %.098142, %.lr.ph135 ], [ %i.ek, %vector.body281 ]
  %.3133.ph = phi i32 [ %i.eb, %vector.memcheck230 ], [ %i.eb, %.lr.ph135 ], [ %0, %vector.body281 ]
  br label %scalar.ph266

vector.memcheck230:                               ; preds = %.lr.ph135
  %i.eg = shl nuw nsw i64 %indvar174, 3
  %i.eh = or disjoint i64 %i.eg, 4                ; 4 uses
  %scevgep241 = getelementptr i8, ptr %i.ds, i64 %i.eh
  %scevgep238 = getelementptr i8, ptr %i.dt, i64 %i.eh
  %scevgep235 = getelementptr i8, ptr %i.dq, i64 %i.eh
  %scevgep232 = getelementptr i8, ptr %i.dr, i64 %i.eh
  %i.ei = shl i64 %.098142, 1                     ; 8 uses
  %scevgep231 = getelementptr i8, ptr %i.dr, i64 %i.ei ; 3 uses
  %scevgep233 = getelementptr i8, ptr %scevgep232, i64 %i.ei ; 3 uses
  %scevgep234 = getelementptr i8, ptr %i.dq, i64 %i.ei ; 3 uses
  %scevgep236 = getelementptr i8, ptr %scevgep235, i64 %i.ei ; 3 uses
  %scevgep237 = getelementptr i8, ptr %i.dt, i64 %i.ei ; 3 uses
  %scevgep239 = getelementptr i8, ptr %scevgep238, i64 %i.ei ; 3 uses
  %scevgep240 = getelementptr i8, ptr %i.ds, i64 %i.ei ; 3 uses
  %scevgep242 = getelementptr i8, ptr %scevgep241, i64 %i.ei ; 3 uses
...
vector.ph268:                                     ; preds = %vector.memcheck230
  %n.vec269 = and i64 %i.dv, 9223372036854775800  ; 4 uses
...
.lr.ph139.loopexit:                               ; preds = %scalar.ph266
  %i.fb = trunc i32 %i.ea to i16                  ; 3 uses
...
scalar.ph202.preheader:                           ; preds = %vector.body216, %vector.memcheck, %.lr.ph139.loopexit
  ...
  %.4138.ph = phi i32 [ %i.ea, %vector.memcheck ], [ %i.ea, %.lr.ph139.loopexit ], [ %i.fo, %vector.body216 ]
...
vector.ph204:                                     ; preds = %vector.memcheck
  %n.vec205 = and i64 %i.dx, -8                   ; 3 uses
...
vector.body216:                                   ; preds = %vector.body216, %vector.ph204
  ...
  %interleaved.vec224 = shufflevector <4 x i16> %i.ga, <4 x i16> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
  store <8 x i16> %interleaved.vec224, ptr %i.gc, align 2, !tbaa !47, !alias.scope !85
  %index.next225 = add nuw i64 %index217, 8       ; 2 uses
  %vec.ind.next = add <4 x i16> %vec.ind, splat (i16 8)
  %i.gd = icmp eq i64 %index.next225, %n.vec205
  br i1 %i.gd, label %scalar.ph202.preheader, label %vector.body216, !llvm.loop !86

scalar.ph266:                                     ; preds = %scalar.ph266.preheader, %scalar.ph266
  %indvar = phi i64 [ %indvar.next, %scalar.ph266 ], [ %indvar.ph, %scalar.ph266.preheader ] ; 2 uses
  %indvars.iv153 = phi i64 [ %indvars.iv.next154, %scalar.ph266 ], [ %indvars.iv153.ph, %scalar.ph266.preheader ] ; 6 uses
  %.3133 = phi i32 [ %i.gp, %scalar.ph266 ], [ %.3133.ph, %scalar.ph266.preheader ] ; 2 uses
  %i.ge = trunc i32 %.3133 to i16                 ; 3 uses
  %i.gf = getelementptr inbounds [2 x i8], ptr %i.dr, i64 %indvars.iv153
  store i16 %i.ge, ptr %i.gf, align 2, !tbaa !47
  %i.gg = getelementptr inbounds [2 x i8], ptr %i.dq, i64 %indvars.iv153
  store i16 %i.ec, ptr %i.gg, align 2, !tbaa !47
  %i.gh = shl i16 %i.ge, 1                        ; 2 uses
  %i.gi = getelementptr inbounds [2 x i8], ptr %i.dt, i64 %indvars.iv153
  store i16 %i.gh, ptr %i.gi, align 2, !tbaa !47
  %i.gj = add nsw i64 %indvars.iv153, 1           ; 4 uses
  %i.gk = getelementptr inbounds [2 x i8], ptr %i.ds, i64 %indvars.iv153
  store i16 %i.ed, ptr %i.gk, align 2, !tbaa !47
  %i.gl = getelementptr inbounds [2 x i8], ptr %i.dr, i64 %i.gj
  store i16 %i.ge, ptr %i.gl, align 2, !tbaa !47
  %i.gm = getelementptr inbounds [2 x i8], ptr %i.dq, i64 %i.gj
  store i16 %i.ee, ptr %i.gm, align 2, !tbaa !47
  %i.gn = getelementptr inbounds [2 x i8], ptr %i.dt, i64 %i.gj
  store i16 %i.gh, ptr %i.gn, align 2, !tbaa !47
...
scalar.ph202:                                     ; preds = %scalar.ph202.preheader, %scalar.ph202
  %indvars.iv156 = phi i64 [ %indvars.iv.next157, %scalar.ph202 ], [ %indvars.iv156.ph, %scalar.ph202.preheader ] ; 6 uses
  %.4138 = phi i32 [ %i.hb, %scalar.ph202 ], [ %.4138.ph, %scalar.ph202.preheader ] ; 2 uses
  %i.gq = getelementptr inbounds [2 x i8], ptr %i.dr, i64 %indvars.iv156
  store i16 %i.fb, ptr %i.gq, align 2, !tbaa !47
  %i.gr = trunc i32 %.4138 to i16                 ; 3 uses
  %i.gs = getelementptr inbounds [2 x i8], ptr %i.dq, i64 %indvars.iv156
  store i16 %i.gr, ptr %i.gs, align 2, !tbaa !47
  %i.gt = getelementptr inbounds [2 x i8], ptr %i.dt, i64 %indvars.iv156
  store i16 %i.fc, ptr %i.gt, align 2, !tbaa !47
  %i.gu = shl i16 %i.gr, 1                        ; 2 uses
  %i.gv = add nsw i64 %indvars.iv156, 1           ; 4 uses
  %i.gw = getelementptr inbounds [2 x i8], ptr %i.ds, i64 %indvars.iv156
  store i16 %i.gu, ptr %i.gw, align 2, !tbaa !47
  %i.gx = getelementptr inbounds [2 x i8], ptr %i.dr, i64 %i.gv
  store i16 %i.fd, ptr %i.gx, align 2, !tbaa !47
  %i.gy = getelementptr inbounds [2 x i8], ptr %i.dq, i64 %i.gv
  store i16 %i.gr, ptr %i.gy, align 2, !tbaa !47
  %i.gz = getelementptr inbounds [2 x i8], ptr %i.dt, i64 %i.gv
  store i16 %i.fe, ptr %i.gz, align 2, !tbaa !47
  %indvars.iv.next157 = add nsw i64 %indvars.iv156, 2 ; 2 uses
  %i.ha = getelementptr inbounds [2 x i8], ptr %i.ds, i64 %i.gv
  store i16 %i.gu, ptr %i.ha, align 2, !tbaa !47
  %i.hb = add i32 %.4138, 1                       ; 2 uses
  %exitcond161.not = icmp eq i32 %i.hb, %indvars.iv159
  br i1 %exitcond161.not, label %._crit_edge140, label %scalar.ph202, !llvm.loop !88

._crit_edge140:                                   ; preds = %scalar.ph202
  %i.hc = add nuw nsw i32 %.0143, 1
  %indvars.iv.next160 = add nuw i32 %indvars.iv159, 1
  %exitcond162.not = icmp eq i32 %indvars.iv159, %i.du
  %indvar.next175 = add i64 %indvar174, 1
  br i1 %exitcond162.not, label %bb.p, label %.lr.ph135, !llvm.loop !89

bb.p:                                             ; preds = %._crit_edge140
  %i.hd = load ptr, ptr @input, align 8, !tbaa !8 ; 7 uses
  %i.he = getelementptr inbounds nuw i8, ptr %i.hd, i64 5776
  %i.hf = load i32, ptr %i.he, align 8, !tbaa !90
  %i.hg = icmp eq i32 %i.hf, 1
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %i.hd, i64 5780
  %.pre = load i32, ptr %.phi.trans.insert, align 4, !tbaa !4 ; 2 uses
  br i1 %i.hg, label %.thread, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.hh = getelementptr inbounds nuw i8, ptr %i.hd, i64 5784
  %i.hi = load i32, ptr %i.hh, align 8, !tbaa !4  ; 2 uses
  %i.hj = icmp eq i32 %.pre, %i.hi
  %i.hk = zext i1 %i.hj to i32
  %i.hl = getelementptr inbounds nuw i8, ptr %i.hd, i64 5788
  %i.hm = load i32, ptr %i.hl, align 4, !tbaa !4
  %i.hn = icmp eq i32 %i.hi, %i.hm
  %i.ho = zext i1 %i.hn to i32
  br label %.thread

.thread:                                          ; preds = %bb.p, %bb.q
  %.sink = phi i32 [ %i.hk, %bb.q ], [ 0, %bb.p ]
  %not.108 = phi i32 [ %i.ho, %bb.q ], [ 0, %bb.p ]
  store i32 %.sink, ptr @start_me_refinement_hp, align 4, !tbaa !4
  store i32 %not.108, ptr @start_me_refinement_qp, align 4, !tbaa !4
  switch i32 %.pre, label %bb.s [
    i32 0, label %bb.t
    i32 1, label %bb.r
  ]
...
bb.t:                                             ; preds = %.thread, %bb.r, %bb.s
  %computeSAD.sink = phi ptr [ @computeSATD, %bb.s ], [ @computeSSE, %bb.r ], [ @computeSAD, %.thread ]
  %computeSADWP.sink = phi ptr [ @computeSATDWP, %bb.s ], [ @computeSSEWP, %bb.r ], [ @computeSADWP, %.thread ]
  %computeBiPredSAD1.sink = phi ptr [ @computeBiPredSATD1, %bb.s ], [ @computeBiPredSSE1, %bb.r ], [ @computeBiPredSAD1, %.thread ]
  %computeBiPredSAD2.sink = phi ptr [ @computeBiPredSATD2, %bb.s ], [ @computeBiPredSSE2, %bb.r ], [ @computeBiPredSAD2, %.thread ]
  store ptr %computeSAD.sink, ptr @computeUniPred, align 16, !tbaa !8
  store ptr %computeSADWP.sink, ptr getelementptr inbounds nuw (i8, ptr @computeUniPred, i64 24), align 8, !tbaa !8
  store ptr %computeBiPredSAD1.sink, ptr @computeBiPred1, align 16, !tbaa !8
  store ptr %computeBiPredSAD2.sink, ptr @computeBiPred2, align 16, !tbaa !8
  %i.hp = getelementptr inbounds nuw i8, ptr %i.hd, i64 5784
  %i.hq = load i32, ptr %i.hp, align 8, !tbaa !4
  switch i32 %i.hq, label %bb.v [
    i32 0, label %bb.u
    i32 1, label %bb.w
  ]
...
bb.w:                                             ; preds = %bb.t, %bb.v, %bb.u
  %computeSATD.sink = phi ptr [ @computeSATD, %bb.v ], [ @computeSAD, %bb.u ], [ @computeSSE, %bb.t ]
  %computeSATDWP.sink = phi ptr [ @computeSATDWP, %bb.v ], [ @computeSADWP, %bb.u ], [ @computeSSEWP, %bb.t ]
  %computeBiPredSATD1.sink = phi ptr [ @computeBiPredSATD1, %bb.v ], [ @computeBiPredSAD1, %bb.u ], [ @computeBiPredSSE1, %bb.t ]
  %computeBiPredSATD2.sink = phi ptr [ @computeBiPredSATD2, %bb.v ], [ @computeBiPredSAD2, %bb.u ], [ @computeBiPredSSE2, %bb.t ]
  store ptr %computeSATD.sink, ptr getelementptr inbounds nuw (i8, ptr @computeUniPred, i64 8), align 8, !tbaa !8
  store ptr %computeSATDWP.sink, ptr getelementptr inbounds nuw (i8, ptr @computeUniPred, i64 32), align 16, !tbaa !8
  store ptr %computeBiPredSATD1.sink, ptr getelementptr inbounds nuw (i8, ptr @computeBiPred1, i64 8), align 8, !tbaa !8
  store ptr %computeBiPredSATD2.sink, ptr getelementptr inbounds nuw (i8, ptr @computeBiPred2, i64 8), align 8, !tbaa !8
  %i.hr = getelementptr inbounds nuw i8, ptr %i.hd, i64 5788
  %i.hs = load i32, ptr %i.hr, align 4, !tbaa !4
  switch i32 %i.hs, label %bb.y [
    i32 0, label %bb.x
    i32 1, label %bb.z
  ]
...
bb.z:                                             ; preds = %bb.w, %bb.y, %bb.x
  %computeSATD.sink173 = phi ptr [ @computeSATD, %bb.y ], [ @computeSAD, %bb.x ], [ @computeSSE, %bb.w ]
  %computeSATDWP.sink172 = phi ptr [ @computeSATDWP, %bb.y ], [ @computeSADWP, %bb.x ], [ @computeSSEWP, %bb.w ]
  %computeBiPredSATD1.sink171 = phi ptr [ @computeBiPredSATD1, %bb.y ], [ @computeBiPredSAD1, %bb.x ], [ @computeBiPredSSE1, %bb.w ]
  %computeBiPredSATD2.sink170 = phi ptr [ @computeBiPredSATD2, %bb.y ], [ @computeBiPredSAD2, %bb.x ], [ @computeBiPredSSE2, %bb.w ]
  store ptr %computeSATD.sink173, ptr getelementptr inbounds nuw (i8, ptr @computeUniPred, i64 16), align 16, !tbaa !8
  store ptr %computeSATDWP.sink172, ptr getelementptr inbounds nuw (i8, ptr @computeUniPred, i64 40), align 8, !tbaa !8
  store ptr %computeBiPredSATD1.sink171, ptr getelementptr inbounds nuw (i8, ptr @computeBiPred1, i64 16), align 16, !tbaa !8
  store ptr %computeBiPredSATD2.sink170, ptr getelementptr inbounds nuw (i8, ptr @computeBiPred2, i64 16), align 16, !tbaa !8
  store ptr @FastLine4X, ptr @get_line, align 16, !tbaa !8
  store ptr @UMVLine4X, ptr getelementptr inbounds nuw (i8, ptr @get_line, i64 8), align 8, !tbaa !8
  store ptr @FastLine8X_chroma, ptr @get_crline, align 16, !tbaa !8
  store ptr @UMVLine8X_chroma, ptr getelementptr inbounds nuw (i8, ptr @get_crline, i64 8), align 8, !tbaa !8
  %i.ht = getelementptr inbounds nuw i8, ptr %i.hd, i64 5244
  %i.hu = load i32, ptr %i.ht, align 4, !tbaa !91
  %i.hv = icmp eq i32 %i.hu, 0
  br i1 %i.hv, label %bb.aa, label %bb.ab

bb.aa:                                            ; preds = %bb.z
  tail call void (...) @InitializeFastFullIntegerSearch() #9
  br label %bb.ab
...
bb.a:
  %i.a = load i32, ptr @max_mvd, align 4, !tbaa !4
  %i.b = load ptr, ptr @mvbits, align 8, !tbaa !53
