...
.loopexit:                                        ; preds = %._crit_edge489.split, %._crit_edge489.split.us.us, %bb.v, %.preheader474.lr.ph, %bb.ac, %bb.af, %bb.ab, %bb.s
  %.0415 = phi i32 [ %i.hj, %bb.s ], [ %i.ri, %bb.af ], [ %i.pk, %bb.ab ], [ %i.pr, %bb.ac ], [ %i.ja, %.preheader474.lr.ph ], [ %i.ja, %._crit_edge489.split.us.us ], [ %i.ja, %bb.v ], [ %i.ja, %._crit_edge489.split ] ; 6 uses
