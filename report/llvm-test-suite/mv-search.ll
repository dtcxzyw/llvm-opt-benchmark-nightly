...
begin_hunk_0_@BlockMotionSearch:bb.a
  ...
  %i.mk = add nuw nsw i32 %.3413487.us491, 2      ; 2 uses
  %niter599.next.1 = add i32 %niter599, 2         ; 2 uses
  %niter599.ncmp.1 = icmp eq i32 %niter599.next.1, %unroll_iter598
  br i1 %niter599.ncmp.1, label %._crit_edge489.split.us492.unr-lcssa, label %.preheader474.us.new, !llvm.loop !132

._crit_edge489.split.us492.unr-lcssa:             ; preds = %.preheader474.us.new
  br i1 %lcmp.mod596.not, label %._crit_edge489.split.us492, label %.epil.preheader593

.epil.preheader593:                               ; preds = %._crit_edge489.split.us492.unr-lcssa, %.preheader474.us
  %.3413487.us491.epil.init = phi i32 [ 0, %.preheader474.us ], [ %i.mk, %._crit_edge489.split.us492.unr-lcssa ]
  call void @llvm.assume(i1 %lcmp.mod597)
  %i.ml = load i32, ptr %i.lh, align 4, !tbaa !130
  %i.mm = ashr i32 %i.ml, 2
  %i.mn = add nsw i32 %.3413487.us491.epil.init, %i.g
  ...
  br label %._crit_edge489.split.us492

._crit_edge489.split.us492:                       ; preds = %._crit_edge489.split.us492.unr-lcssa, %.epil.preheader593
  %i.mx = add nuw nsw i32 %.0406490.us, 1         ; 2 uses
  %exitcond532.not = icmp eq i32 %i.mx, %i.jb
  br i1 %exitcond532.not, label %.loopexit, label %.preheader474.us, !llvm.loop !133
...
bb.z:                                             ; preds = %bb.y, %bb.x
  ...
  %.pre549.a = load i32, ptr %i.a, align 4, !tbaa !4 ; 7 uses
  br i1 %.not440, label %bb.aa, label %._crit_edge556

._crit_edge556:                                   ; preds = %bb.z
  %.pre557 = shl nsw i32 %i.mz, 1                 ; 2 uses
  %.pre558 = shl i32 %.pre549.a, %.pre557
  br label %bb.ab

bb.aa:                                            ; preds = %bb.z
  %i.ns = sub nsw i32 0, %.pre549.a
  %i.nt = shl nsw i32 %i.mz, 1                    ; 3 uses
  %i.nu = shl i32 %i.ns, %i.nt                    ; 2 uses
  %i.nv = shl i32 %.pre549.a, %i.nt               ; 3 uses
...
bb.ab:                                            ; preds = %._crit_edge556, %bb.aa
  %.pre-phi559 = phi i32 [ %.pre558, %._crit_edge556 ], [ %i.nv, %bb.aa ]
  %.pre-phi = phi i32 [ %.pre557, %._crit_edge556 ], [ %i.nt, %bb.aa ] ; 4 uses
  %i.oe = phi i16 [ %i.no, %._crit_edge556 ], [ %i.od, %bb.aa ]
  %i.of = phi i16 [ %i.nn, %._crit_edge556 ], [ %i.nz, %bb.aa ]
  %i.og = add nsw i32 %.pre549.a, -2047
  %i.oh = shl i32 %i.og, %.pre-phi
  %i.oi = sub nsw i32 2047, %.pre549.a
  ...
  %i.pk = call i32 @EPZSPelBlockMotionSearch(ptr noundef nonnull @orig_pic, i16 noundef signext %0, i32 noundef %1, i32 noundef %i.bh, ptr noundef %i.pg, ptr noundef %i.pi, i32 noundef %i.r, i32 noundef %i.u, i32 noundef %4, ptr noundef nonnull %i.as, ptr noundef nonnull %i.b, i32 noundef %.pre-phi559, i32 noundef 2147483647, i32 noundef %i.pj) #9
  br label %.loopexit
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.qh = call noundef i32 @llvm.smin.i32(i32 %i.qg, i32 %.pre552)
...
bb.af:                                            ; preds = %bb.ae, %bb.ad
  ...
  %i.ql = add nsw i32 %.pre552, -2047
  %i.qm = sub nsw i32 2047, %.pre552
...
.thread468:                                       ; preds = %bb.ap, %bb.as, %bb.az, %bb.ba, %bb.ay, %bb.ax
  ...
  br i1 %i.uq, label %.preheader473.lr.ph, label %._crit_edge498
...
.preheader473.lr.ph:                              ; preds = %.thread468
  ...
  br i1 %i.us, label %.preheader473.us.preheader, label %._crit_edge498

.preheader473.us.preheader:                       ; preds = %.preheader473.lr.ph
  %i.uu = add nsw i32 %i.ur, %i.f
  %i.uv = sext i32 %i.uu to i64
  %i.uw = sext i32 %i.up to i64
  br label %.preheader473.us

.preheader473.us:                                 ; preds = %.preheader473.us.preheader, %._crit_edge496.us
  %indvars.iv538 = phi i64 [ %i.af, %.preheader473.us.preheader ], [ %indvars.iv.next539, %._crit_edge496.us ] ; 2 uses
  %i.ux = getelementptr inbounds [8 x i8], ptr %i.au, i64 %indvars.iv538
  %i.uy = load ptr, ptr %i.ux, align 8, !tbaa !95
  %.pre553 = load i16, ptr %i.b, align 4, !tbaa !47
  br label %bb.bb
end_hunk_0
