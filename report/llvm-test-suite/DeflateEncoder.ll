...
vector.ph:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !44   ; 5 uses
  br label %vector.body
...
_ZN9NCompress8NDeflate8NEncoder16Huffman_GetPriceEPKjPKhj.exit.i: ; preds = %vector.body
  ...
  %2 = getelementptr inbounds nuw i8, ptr %i.d, i64 24
  %3 = getelementptr inbounds nuw i8, ptr %i.d, i64 28
  %i.r = getelementptr inbounds nuw i8, ptr %i.d, i64 29
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 3408
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 2224
  %5 = load i8, ptr %i.s, align 8, !tbaa !62
  %i.t = load i32, ptr %4, align 8, !tbaa !4
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 2225
  %i.v = load i8, ptr %i.u, align 1, !tbaa !62
  %i.w = getelementptr inbounds nuw i8, ptr %0, i64 2226
  %6 = getelementptr inbounds nuw i8, ptr %0, i64 3416
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 3424
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 3428
  %i.z = getelementptr inbounds nuw i8, ptr %0, i64 3432
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 3436
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 3440
  %i.ac = getelementptr inbounds nuw i8, ptr %0, i64 3448
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 3452
  %i.ae = getelementptr inbounds nuw i8, ptr %0, i64 2242
  %7 = load i8, ptr %i.ae, align 2, !tbaa !62
  %i.af = getelementptr inbounds nuw i8, ptr %0, i64 3480
  %8 = load i32, ptr %i.af, align 8, !tbaa !4     ; 2 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %0, i64 2243
  %i.ah = load i8, ptr %i.ag, align 1, !tbaa !62
  %i.ai = getelementptr inbounds nuw i8, ptr %0, i64 3484
  %9 = load i32, ptr %i.ai, align 4, !tbaa !4     ; 2 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %0, i64 2244
  %10 = getelementptr inbounds nuw i8, ptr %0, i64 3488 ; 2 uses
  %i.ak = getelementptr inbounds nuw i8, ptr %0, i64 3492
  %i.al = getelementptr inbounds nuw i8, ptr %0, i64 2248
  %i.am = getelementptr inbounds nuw i8, ptr %0, i64 3504
  %i.an = getelementptr inbounds nuw i8, ptr %0, i64 3524
  %i.ao = getelementptr inbounds nuw i8, ptr %0, i64 3528
  %i.ap = getelementptr inbounds nuw i8, ptr %0, i64 3532
  %11 = load i32, ptr %i.x, align 8, !tbaa !4
  %12 = load i32, ptr %i.y, align 4, !tbaa !4
  %i.aq = load i32, ptr %i.z, align 8, !tbaa !4
  %i.ar = load i32, ptr %i.aa, align 4, !tbaa !4
  %13 = add i32 %i.aq, %i.ar
  %14 = shl i32 %13, 1
  %15 = load i32, ptr %i.ac, align 8, !tbaa !4
  %16 = add i32 %8, %9
  %17 = shl i32 %16, 3
  %18 = zext i8 %5 to i32
  %19 = mul i32 %i.t, %18
  %20 = load <16 x i8>, ptr %i.w, align 2, !tbaa !62
  %21 = load <16 x i32>, ptr %6, align 8, !tbaa !4 ; 2 uses
  %22 = load i32, ptr %i.ad, align 4, !tbaa !4
  %i.as = add i32 %15, %22
  %i.at = shl i32 %i.as, 2
  %i.au = zext <16 x i8> %20 to <16 x i32>
  %i.av = mul <16 x i32> %21, %i.au
  %i.aw = zext i8 %7 to i32
  %23 = mul i32 %8, %i.aw
  %i.ax = zext i8 %i.ah to i32
  %24 = mul i32 %9, %i.ax
  %i.ay = load <8 x i8>, ptr %i.al, align 8, !tbaa !62
  %i.az = load <8 x i32>, ptr %i.am, align 8, !tbaa !4
  %25 = load i32, ptr %i.ap, align 4, !tbaa !4
  %26 = load i32, ptr %i.ao, align 8, !tbaa !4
  %27 = load i32, ptr %i.an, align 4, !tbaa !4
  %28 = load <6 x i32>, ptr %i.ab, align 8, !tbaa !4
  %29 = shufflevector <6 x i32> %28, <6 x i32> poison, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %30 = shufflevector <8 x i32> %i.az, <8 x i32> poison, <12 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison>
  %31 = shufflevector <4 x i32> %29, <4 x i32> poison, <12 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %32 = shufflevector <12 x i32> %30, <12 x i32> %31, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 12, i32 13, i32 14, i32 15, i32 poison, i32 poison, i32 poison, i32 poison>
  %33 = shufflevector <16 x i32> %21, <16 x i32> poison, <16 x i32> <i32 12, i32 13, i32 14, i32 15, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %34 = shufflevector <16 x i32> %32, <16 x i32> %33, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 16, i32 17, i32 18, i32 19>
  %35 = zext <8 x i8> %i.ay to <8 x i32>
  %i.ba = shufflevector <8 x i32> %35, <8 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.bb = shufflevector <16 x i32> %i.ba, <16 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 3, i32 3, i32 5, i32 5, i32 6, i32 6, i32 7, i32 7>, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %i.bc = mul <16 x i32> %34, %i.bb
  %36 = load <8 x i32>, ptr %i.ak, align 4, !tbaa !4 ; 2 uses
  %37 = load <4 x i8>, ptr %i.aj, align 4, !tbaa !62
  %38 = load <4 x i32>, ptr %10, align 8
  %i.bd = load i32, ptr %10, align 8, !tbaa !4
  %39 = mul i32 %i.bd, 9
  %40 = zext <4 x i8> %37 to <4 x i32>
  %41 = shufflevector <8 x i32> %36, <8 x i32> poison, <4 x i32> <i32 poison, i32 poison, i32 1, i32 2>
  %42 = shufflevector <4 x i32> %38, <4 x i32> %41, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %43 = mul <4 x i32> %42, %40
  %44 = mul <8 x i32> %36, <i32 9, i32 10, i32 10, i32 11, i32 11, i32 12, i32 12, i32 13>
  %45 = mul i32 %27, 13
  %46 = load <16 x i8>, ptr %i.d, align 1, !tbaa !62
  %47 = load <8 x i8>, ptr %1, align 1, !tbaa !62
  %48 = load <4 x i8>, ptr %2, align 1, !tbaa !62
  %49 = load <2 x i8>, ptr %i.r, align 1, !tbaa !62
  %50 = load i8, ptr %3, align 1, !tbaa !62
  %51 = load <33 x i32>, ptr %i.q, align 4, !tbaa !4
  %52 = shufflevector <33 x i32> %51, <33 x i32> poison, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 32>
  %53 = shufflevector <4 x i8> %48, <4 x i8> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %54 = insertelement <32 x i8> %53, i8 %50, i64 28
  %55 = shufflevector <2 x i8> %49, <2 x i8> poison, <32 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %56 = shufflevector <32 x i8> %54, <32 x i8> %55, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 24, i32 25, i32 26, i32 27, i32 28, i32 32, i32 33, i32 poison>
  %57 = insertelement <32 x i8> %56, i8 %i.v, i64 31
  %58 = shufflevector <16 x i8> %46, <16 x i8> poison, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %59 = shufflevector <32 x i8> %58, <32 x i8> %57, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %60 = shufflevector <8 x i8> %47, <8 x i8> poison, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %61 = shufflevector <32 x i8> %59, <32 x i8> %60, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %62 = zext <32 x i8> %61 to <32 x i32>
  %63 = mul <32 x i32> %52, %62                   ; 2 uses
  %64 = shufflevector <32 x i32> %63, <32 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %65 = add <16 x i32> %64, %i.av
  %rdx.op23 = add <16 x i32> %65, %i.bc           ; 2 uses
  %66 = shufflevector <16 x i32> %rdx.op23, <16 x i32> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %67 = shufflevector <32 x i32> %66, <32 x i32> %63, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %68 = shufflevector <16 x i32> %rdx.op23, <16 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %rdx.op24 = add <8 x i32> %68, %44
  %69 = shufflevector <8 x i32> %rdx.op24, <8 x i32> poison, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %70 = shufflevector <32 x i32> %69, <32 x i32> %67, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %71 = tail call i32 @llvm.vector.reduce.add.v32i32(<32 x i32> %70)
  %72 = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %43)
  %op.rdx41 = add i32 %72, %19
  %op.rdx42 = add i32 %23, %24
  %op.rdx43 = add i32 %39, %45
  %73 = add i32 %26, %25
  %op.rdx44 = mul i32 %73, 14
  %op.rdx45 = add i32 %14, %i.at
  %op.rdx46 = add i32 %17, %12
  %op.rdx47 = add i32 %11, %i.p
  %op.rdx48 = add i32 %op.rdx41, %op.rdx42
  %op.rdx49 = add i32 %op.rdx43, %op.rdx44
  %op.rdx50 = add i32 %op.rdx45, %op.rdx46
  %op.rdx51 = add i32 %op.rdx47, %71
