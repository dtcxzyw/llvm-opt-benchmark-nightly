...
bb.f:                                             ; preds = %bb.e
  ...
  %i.n = load i16, ptr %i.a, align 2, !tbaa !9    ; 3 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.s = load i8, ptr %2, align 1, !tbaa !32
  ...
  %i.am = load i8, ptr %2, align 1, !tbaa !32     ; 3 uses
...
bb.n:                                             ; preds = %bb.m, %bb.l
  %i.as = load i16, ptr %i.a, align 2, !tbaa !9
...
.preheader41.i:                                   ; preds = %bb.n
  %i.av = load i16, ptr %i.a, align 2, !tbaa !9
...
bb.q:                                             ; preds = %.lr.ph.i
  %i.ba = load i8, ptr %i.ay, align 1, !tbaa !11
  %i.bb = icmp eq i8 %i.ba, 0
  %.pre.pre.i = load i16, ptr %i.a, align 2, !tbaa !9 ; 3 uses
...
.preheader40.i:                                   ; preds = %bb.r
  ...
  %i.bg = load i16, ptr %i.a, align 2, !tbaa !9
...
bb.t:                                             ; preds = %bb.v
  ...
  store i16 %indvars13, ptr %i.b, align 2, !tbaa !9
  %i.bh = zext i16 %.pre50.pre.i to i64
  %i.bi = icmp samesign ult i64 %indvars.iv.next12, %i.bh
  br i1 %i.bi, label %.lr.ph45.i, label %._crit_edge46.i, !llvm.loop !30
...
bb.v:                                             ; preds = %.lr.ph45.i
  %i.bl = load i8, ptr %i.bj, align 1, !tbaa !11
  %i.bm = icmp eq i8 %i.bl, 0
  %.pre50.pre.i = load i16, ptr %i.a, align 2, !tbaa !9 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  %i.m = load i16, ptr %i.a, align 2, !tbaa !9
  %i.n = zext i16 %i.m to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.10, i32 noundef %i.n) #11
  %i.o = load i16, ptr %i.a, align 2, !tbaa !9    ; 3 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.v = load i8, ptr %3, align 1, !tbaa !42
  %i.w = zext i8 %i.v to i32
  ...
  %i.an = load i8, ptr %i.am, align 1, !tbaa !48
...
bb.o:                                             ; preds = %bb.n, %bb.m
  %i.ba = load i16, ptr %i.a, align 2, !tbaa !9
...
.preheader49.i:                                   ; preds = %bb.o
  %i.bd = load i16, ptr %i.a, align 2, !tbaa !9
...
bb.p:                                             ; preds = %bb.r
  ...
  br i1 %i.bf, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !39
...
bb.r:                                             ; preds = %.lr.ph.i
  %i.bi = load i8, ptr %i.bg, align 1, !tbaa !11
...
.preheader48.i:                                   ; preds = %bb.s
  store i16 0, ptr %i.b, align 2, !tbaa !9
  %i.bo = load i16, ptr %i.a, align 2, !tbaa !9
...
bb.u:                                             ; preds = %bb.w
  ...
  store i16 %indvars19, ptr %i.b, align 2, !tbaa !9
  %i.bp = zext i16 %.pre58.pre.i to i64
  %i.bq = icmp samesign ult i64 %indvars.iv.next18, %i.bp
  br i1 %i.bq, label %.lr.ph53.i, label %._crit_edge54.i, !llvm.loop !40
...
bb.w:                                             ; preds = %.lr.ph53.i
  %i.bt = load i8, ptr %i.br, align 1, !tbaa !11
  %i.bu = icmp eq i8 %i.bt, 0
  %.pre58.pre.i = load i16, ptr %i.a, align 2, !tbaa !9 ; 2 uses
...
bb.x:                                             ; preds = %._crit_edge54.i
  ...
  store ptr %i.by, ptr %i.bz, align 8, !tbaa !52
  call void @free(ptr noundef %i.bc) #11
  call void @free(ptr noundef nonnull %i.bn) #11
...
bb.aa:                                            ; preds = %bb.y
  %i.cl = load <2 x i32>, ptr %i.t, align 1, !tbaa !7
  store <2 x i32> %i.cl, ptr %2, align 8, !tbaa !7
  %i.cm = load i8, ptr %i.aj, align 1, !tbaa !47
  %i.cn = getelementptr inbounds nuw i8, ptr %2, i64 8
  store i8 %i.cm, ptr %i.cn, align 8, !tbaa !15
  %i.co = load i8, ptr %i.ag, align 1, !tbaa !46
  %i.cp = and i8 %i.co, 1
  %i.cq = zext nneg i8 %i.cp to i32
  %i.cr = getelementptr inbounds nuw i8, ptr %2, i64 24
  store i32 %i.cq, ptr %i.cr, align 8, !tbaa !16
  %i.cs = getelementptr inbounds nuw i8, ptr %2, i64 28
  store i32 -1, ptr %i.cs, align 4, !tbaa !17
  %i.ct = load ptr, ptr %i.bz, align 8, !tbaa !52
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.h = load i32, ptr %2, align 8, !tbaa !18
