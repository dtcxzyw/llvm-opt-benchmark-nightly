...
vector.body:                                      ; preds = %vector.ph
  %7 = getelementptr inbounds nuw i8, ptr %.0.lcssa.sroa.phi.a, i64 32
  %i.fg = getelementptr inbounds nuw i8, ptr %.0.lcssa.sroa.phi.a, i64 48
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader140, %.lr.ph.i
  ...
  br i1 %i.x, label %.lr.ph.i, label %ix_max.exit, !llvm.loop !54
...
bb.e:                                             ; preds = %bb.e, %bb.d
  ...
  br i1 %i.ax, label %bb.e, label %count_bit_noESC.exit, !llvm.loop !55
...
bb.af:                                            ; preds = %bb.ae, %bb.ad
  ...
  br i1 %i.fc, label %bb.ab, label %count_bit_ESC.exit, !llvm.loop !56
