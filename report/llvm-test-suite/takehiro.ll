...
.thread147.i:                                     ; preds = %..thread147.i_crit_edge, %bb.ac, %bb.ab
  %6 = phi i32 [ %.pre243, %..thread147.i_crit_edge ], [ %.178.9.i, %bb.ac ], [ %i.lw, %bb.ab ] ; 2 uses
...
.thread151.i:                                     ; preds = %..thread151.i_crit_edge, %bb.ae, %.thread147.i
  %7 = phi i32 [ %.pre244, %..thread151.i_crit_edge ], [ %i.lz, %bb.ae ], [ %6, %.thread147.i ]
...
.thread158.i:                                     ; preds = %..thread158.i_crit_edge, %bb.an, %bb.am
  %8 = phi i32 [ %.pre245, %..thread158.i_crit_edge ], [ %i.ml, %bb.an ], [ %i.mm, %bb.am ] ; 2 uses
...
.thread162.i:                                     ; preds = %..thread162.i_crit_edge, %bb.ap, %.thread158.i
  %9 = phi i32 [ %.pre246, %..thread162.i_crit_edge ], [ %i.mq, %bb.ap ], [ %8, %.thread158.i ]
