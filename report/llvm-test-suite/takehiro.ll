...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %5 = getelementptr [4 x i8], ptr %.0.lcssa.sroa.phi.a, i64 %index ; 2 uses
...
begin_hunk_23_@choose_table:bb.a
  ...
  br i1 %i.p, label %middle.block, label %vector.body, !llvm.loop !54
...
begin_hunk_24_@choose_table:bb.a
  ...
  br i1 %i.v, label %.lr.ph.i, label %ix_max.exit, !llvm.loop !55
...
begin_hunk_25_@choose_table:bb.a
  ...
  br i1 %i.av, label %bb.e, label %count_bit_noESC.exit, !llvm.loop !56
...
begin_hunk_26_@choose_table:bb.a
  ...
  br i1 %i.fa, label %bb.ab, label %count_bit_ESC.exit, !llvm.loop !57
