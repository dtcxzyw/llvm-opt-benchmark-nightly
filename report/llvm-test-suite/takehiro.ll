...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ac = load i32, ptr %i.ab, align 4, !tbaa !8  ; 9 uses
...
bb.e:                                             ; preds = %bb.e, %bb.d
  ...
  %i.ak = load i32, ptr %.030.i, align 4, !tbaa !8 ; 2 uses
  ...
  store i32 %i.an, ptr %.024.i, align 4, !tbaa !8
  ...
  %i.ay = load i32, ptr %i.aj, align 4, !tbaa !8  ; 2 uses
  ...
  store i32 %i.bb, ptr %i.ap, align 4, !tbaa !8
  ...
  %i.bl = load i32, ptr %i.ax, align 4, !tbaa !8  ; 2 uses
  ...
  store i32 %i.bo, ptr %i.bd, align 4, !tbaa !8
  ...
  br i1 %i.bx, label %bb.e, label %count_bit_short_noESC.exit, !llvm.loop !49

count_bit_short_noESC.exit:                       ; preds = %bb.e
  store ptr %i.bq, ptr @cb_esc_end, align 8, !tbaa !26
...
bb.g:                                             ; preds = %bb.g, %bb.f
  ...
  %i.cf = load i32, ptr %.0.i, align 4, !tbaa !8
  ...
  br i1 %i.cl, label %bb.g, label %count_bit_noESC2.exit, !llvm.loop !0
...
bb.i:                                             ; preds = %bb.i, %bb.h
  ...
  %i.ct = load i32, ptr %.0.i68, align 4, !tbaa !8
...
bb.ae:                                            ; preds = %bb.ad
  ...
  store i32 %i.hp, ptr %i.fm, align 4, !tbaa !8
  %i.hq = load i32, ptr %2, align 8, !tbaa !29    ; 2 uses
  %i.hr = load i32, ptr %4, align 8, !tbaa !8
  %i.hs = icmp slt i32 %i.hq, %i.hr
  br i1 %i.hs, label %bb.ag, label %bb.af

bb.af:                                            ; preds = %bb.ae
  store i32 2, ptr %i.fn, align 4, !tbaa !20
  %i.ht = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.hg
  %i.hu = load i32, ptr %i.ht, align 4, !tbaa !8
  store i32 %i.hu, ptr %i.fo, align 8, !tbaa !8
  ...
  %.pre65 = load i32, ptr %2, align 8, !tbaa !29
  br label %bb.ag
...
bb.ag:                                            ; preds = %bb.af, %bb.ae, %bb.ad
  ...
  store i32 %i.hz, ptr %4, align 8, !tbaa !8
...
bb.ah:                                            ; preds = %bb.ag
  ...
  store i32 %i.if, ptr %i.fm, align 4, !tbaa !8
  %i.ig = load i32, ptr %2, align 8, !tbaa !29    ; 2 uses
  %i.ih = load i32, ptr %4, align 8, !tbaa !8
  %i.ii = icmp slt i32 %i.ig, %i.ih
  br i1 %i.ii, label %bb.aj, label %bb.ai

bb.ai:                                            ; preds = %bb.ah
  store i32 3, ptr %i.fn, align 4, !tbaa !20
  %i.ij = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.hw
  %i.ik = load i32, ptr %i.ij, align 4, !tbaa !8
  store i32 %i.ik, ptr %i.fo, align 8, !tbaa !8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(120) %2, ptr noundef nonnull align 8 dereferenceable(120) %4, i64 120, i1 false)
  %.pre66 = load i32, ptr %2, align 8, !tbaa !29
  br label %bb.aj
...
bb.aj:                                            ; preds = %bb.ai, %bb.ah, %bb.ag
  ...
  store i32 %i.ip, ptr %4, align 8, !tbaa !8
...
bb.ak:                                            ; preds = %bb.aj
  ...
  store i32 %i.iv, ptr %i.fm, align 4, !tbaa !8
  %i.iw = load i32, ptr %2, align 8, !tbaa !29    ; 2 uses
  %i.ix = load i32, ptr %4, align 8, !tbaa !8
  %i.iy = icmp slt i32 %i.iw, %i.ix
  br i1 %i.iy, label %bb.am, label %bb.al

bb.al:                                            ; preds = %bb.ak
  store i32 4, ptr %i.fn, align 4, !tbaa !20
  %i.iz = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.im
  %i.ja = load i32, ptr %i.iz, align 4, !tbaa !8
  store i32 %i.ja, ptr %i.fo, align 8, !tbaa !8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(120) %2, ptr noundef nonnull align 8 dereferenceable(120) %4, i64 120, i1 false)
  %.pre67 = load i32, ptr %2, align 8, !tbaa !29
  br label %bb.am
...
bb.am:                                            ; preds = %bb.al, %bb.ak, %bb.aj
  ...
  store i32 %i.jf, ptr %4, align 8, !tbaa !8
...
bb.an:                                            ; preds = %bb.am
  ...
  store i32 %i.jl, ptr %i.fm, align 4, !tbaa !8
  %i.jm = load i32, ptr %2, align 8, !tbaa !29    ; 2 uses
  %i.jn = load i32, ptr %4, align 8, !tbaa !8
  %i.jo = icmp slt i32 %i.jm, %i.jn
  br i1 %i.jo, label %bb.ap, label %bb.ao

bb.ao:                                            ; preds = %bb.an
  store i32 5, ptr %i.fn, align 4, !tbaa !20
  %i.jp = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.jc
  %i.jq = load i32, ptr %i.jp, align 4, !tbaa !8
  store i32 %i.jq, ptr %i.fo, align 8, !tbaa !8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(120) %2, ptr noundef nonnull align 8 dereferenceable(120) %4, i64 120, i1 false)
  %.pre68 = load i32, ptr %2, align 8, !tbaa !29
  br label %bb.ap
...
bb.ap:                                            ; preds = %bb.ao, %bb.an, %bb.am
  ...
  %i.ju = load i32, ptr %i.jt, align 4, !tbaa !8
  %i.jv = add nsw i32 %i.ju, %i.fy                ; 2 uses
  store i32 %i.jv, ptr %4, align 8, !tbaa !8
...
bb.aq:                                            ; preds = %bb.ap
  ...
  store i32 %i.kb, ptr %i.fm, align 4, !tbaa !8
  %i.kc = load i32, ptr %2, align 8, !tbaa !29    ; 2 uses
  %i.kd = load i32, ptr %4, align 8, !tbaa !8
  %i.ke = icmp slt i32 %i.kc, %i.kd
  br i1 %i.ke, label %bb.as, label %bb.ar

bb.ar:                                            ; preds = %bb.aq
  store i32 6, ptr %i.fn, align 4, !tbaa !20
  %i.kf = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.js
  %i.kg = load i32, ptr %i.kf, align 4, !tbaa !8
  store i32 %i.kg, ptr %i.fo, align 8, !tbaa !8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(120) %2, ptr noundef nonnull align 8 dereferenceable(120) %4, i64 120, i1 false)
  %.pre69 = load i32, ptr %2, align 8, !tbaa !29
  br label %bb.as
...
bb.as:                                            ; preds = %bb.ar, %bb.aq, %bb.ap
  ...
  store i32 %i.kl, ptr %4, align 8, !tbaa !8
...
bb.at:                                            ; preds = %bb.as
  ...
  store i32 %i.kr, ptr %i.fm, align 4, !tbaa !8
  %i.ks = load i32, ptr %2, align 8, !tbaa !29
  %i.kt = load i32, ptr %4, align 8, !tbaa !8
  %i.ku = icmp slt i32 %i.ks, %i.kt
  br i1 %i.ku, label %.loopexit, label %bb.au

bb.au:                                            ; preds = %bb.at
  store i32 7, ptr %i.fn, align 4, !tbaa !20
  %i.kv = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.ki
  %i.kw = load i32, ptr %i.kv, align 4, !tbaa !8
  store i32 %i.kw, ptr %i.fo, align 8, !tbaa !8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(120) %2, ptr noundef nonnull align 8 dereferenceable(120) %4, i64 120, i1 false)
  br label %.loopexit
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec129 = load <8 x i32>, ptr %next.gep127, align 4, !tbaa !8 ; 2 uses
...
bb.e:                                             ; preds = %bb.e, %bb.d
  ...
  %i.ai = load i32, ptr %.024.i, align 4, !tbaa !8 ; 2 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %.024.i, i64 8 ; 2 uses
  %i.ak = load i32, ptr %i.ah, align 4, !tbaa !8  ; 2 uses
  ...
  store i32 %i.an, ptr %.020.i, align 4, !tbaa !8
  %i.aq = sext i32 %i.an to i64
  %i.ar = getelementptr inbounds i8, ptr %i.ag, i64 %i.aq
  %i.as = load i8, ptr %i.ar, align 1, !tbaa !18
  %i.at = zext i8 %i.as to i32
...
count_bit_noESC.exit:                             ; preds = %bb.e
  store ptr %i.ap, ptr @cb_esc_end, align 8, !tbaa !26
...
bb.g:                                             ; preds = %bb.g, %bb.f
  ...
  %i.bd = load i32, ptr %.0.i, align 4, !tbaa !8
  ...
  br i1 %i.bj, label %bb.g, label %count_bit_noESC2.exit, !llvm.loop !0
...
bb.i:                                             ; preds = %bb.i, %bb.h
  ...
  %i.br = load i32, ptr %.0.i68, align 4, !tbaa !8
  ...
  br i1 %i.bx, label %bb.i, label %count_bit_noESC2.exit69, !llvm.loop !0
...
bb.j:                                             ; preds = %count_bit_noESC.exit
  %i.bz = load ptr, ptr getelementptr inbounds nuw (i8, ptr @ht, i64 376), align 8, !tbaa !25
  br label %bb.k
...
bb.k:                                             ; preds = %bb.k, %bb.j
  ...
  %i.cb = load i32, ptr %.0.i71, align 4, !tbaa !8
  ...
  br i1 %i.ch, label %bb.k, label %count_bit_noESC2.exit72, !llvm.loop !0
...
..thread162.i_crit_edge:                          ; preds = %bb.aq
  %.pre246 = load i32, ptr %i.ls, align 4, !tbaa !68
...
bb.ar:                                            ; preds = %.thread162.i
  store i32 %i.my, ptr %i.ls, align 4, !tbaa !68
...
bb.at:                                            ; preds = %.thread164.i
  ...
  %i.ne = load i32, ptr %i.ls, align 4, !tbaa !68 ; 2 uses
  %i.nf = icmp sgt i32 %i.ne, %i.nd
  br i1 %i.nf, label %.split.i, label %.thread169.i

.split.i:                                         ; preds = %bb.at
  store i32 %i.nd, ptr %i.ls, align 4, !tbaa !68
...
..thread169.i_crit_edge:                          ; preds = %bb.au
  %.pre247 = load i32, ptr %i.ls, align 4, !tbaa !68
  br label %.thread169.i
...
bb.av:                                            ; preds = %.thread169.i
  store i32 %i.nj, ptr %i.ls, align 4, !tbaa !68
...
..thread174.i_crit_edge:                          ; preds = %bb.aw
  %.pre248 = load i32, ptr %i.ls, align 4, !tbaa !68
  br label %.thread174.i
...
.split175.i:                                      ; preds = %.thread174.i
  store i32 %i.np, ptr %i.ls, align 4, !tbaa !68
...
bb.ax:                                            ; preds = %.thread172.i
  ...
  %i.nu = load i32, ptr %i.ls, align 4, !tbaa !68 ; 2 uses
  %i.nv = icmp sgt i32 %i.nu, %i.nt
  br i1 %i.nv, label %bb.ay, label %.thread179.i

bb.ay:                                            ; preds = %bb.ax
  store i32 %i.nt, ptr %i.ls, align 4, !tbaa !68
...
..thread179.i_crit_edge:                          ; preds = %bb.az
  %.pre249 = load i32, ptr %i.ls, align 4, !tbaa !68
...
bb.ba:                                            ; preds = %.thread179.i
  store i32 %i.nz, ptr %i.ls, align 4, !tbaa !68
...
..thread183.i_crit_edge:                          ; preds = %bb.bb
  %.pre250 = load i32, ptr %i.ls, align 4, !tbaa !68
  br label %.thread183.i
...
bb.bc:                                            ; preds = %.thread183.i
  store i32 %i.oe, ptr %i.ls, align 4, !tbaa !68
...
..thread188.i_crit_edge:                          ; preds = %bb.be
  %.pre251 = load i32, ptr %i.ls, align 4, !tbaa !68
...
bb.bf:                                            ; preds = %.thread188.i
  store i32 %i.oq, ptr %i.ls, align 4, !tbaa !68
...
scfsi_calc.exit:                                  ; preds = %bb.af, %bb.aq, %bb.aw, %bb.bb, %bb.bf, %.thread188.i, %bb.be, %.thread172.thread.i, %bb.y, %bb.x, %bb.w, %bb.v, %bb.u
  %i.os = load i32, ptr %i.ce, align 4, !tbaa !68
  %i.ot = load i32, ptr %i.e, align 8, !tbaa !29
  %i.ou = add i32 %i.ot, %i.os
  store i32 %i.ou, ptr %i.e, align 8, !tbaa !29
  ret void
}
...
!10 = !{!"p1 int", !9, i64 0}
!11 = !{!"", !7, i64 0, !7, i64 4, !7, i64 8, !7, i64 12, !7, i64 16, !7, i64 20, !7, i64 24, !7, i64 28, !6, i64 32, !6, i64 44, !7, i64 56, !7, i64 60, !7, i64 64, !7, i64 68, !7, i64 72, !7, i64 76, !7, i64 80, !7, i64 84, !7, i64 88, !10, i64 96, !6, i64 104}
!12 = !{!"llvm.loop.mustprogress"}
!13 = !{!"long", !6, i64 0}
!14 = !{!"p1 omnipotent char", !9, i64 0}
!15 = !{!"float", !6, i64 0}
!16 = !{!"", !13, i64 0, !7, i64 8, !7, i64 12, !7, i64 16, !7, i64 20, !7, i64 24, !7, i64 28, !7, i64 32, !7, i64 36, !7, i64 40, !7, i64 44, !7, i64 48, !7, i64 52, !7, i64 56, !7, i64 60, !7, i64 64, !7, i64 68, !7, i64 72, !7, i64 76, !7, i64 80, !7, i64 84, !7, i64 88, !7, i64 92, !7, i64 96, !7, i64 100, !7, i64 104, !7, i64 108, !7, i64 112, !7, i64 116, !7, i64 120, !7, i64 124, !14, i64 128, !14, i64 136, !7, i64 144, !7, i64 148, !15, i64 152, !7, i64 156, !7, i64 160, !7, i64 164, !13, i64 168, !13, i64 176, !7, i64 184, !7, i64 188, !7, i64 192, !7, i64 196, !7, i64 200, !7, i64 204, !7, i64 208, !7, i64 212, !15, i64 216, !7, i64 220, !7, i64 224, !7, i64 228, !15, i64 232, !15, i64 236, !15, i64 240, !15, i64 244, !7, i64 248, !7, i64 252, !7, i64 256, !7, i64 260, !7, i64 264, !7, i64 268, !7, i64 272, !7, i64 276}
!17 = !{!11, !7, i64 4}
!18 = !{!6, !6, i64 0}
!19 = !{!11, !7, i64 56}
!20 = !{!11, !7, i64 60}
...
!23 = !{!"p1 long", !9, i64 0}
!24 = !{!"huffcodetab", !7, i64 0, !7, i64 4, !23, i64 8, !14, i64 16}
!25 = !{!24, !14, i64 16}
!26 = !{!10, !10, i64 0}
!27 = !{!24, !7, i64 4}
!28 = !{!24, !7, i64 0}
...
!45 = !{!44, !7, i64 0}
!46 = !{!44, !7, i64 4}
!47 = distinct !{!47, !12, !21, !22}
!48 = distinct !{!48, !12, !22, !21}
!49 = distinct !{!49, !12}
!50 = distinct !{!50, !12}
!51 = distinct !{!51, !12, !22, !21}
!52 = distinct !{!52, !12}
!53 = distinct !{!53, !12, !21, !22}
!54 = distinct !{!54, !12, !22, !21}
!55 = distinct !{!55, !12}
!56 = distinct !{!56, !12}
!57 = distinct !{!57, !12}
!58 = distinct !{!58, !12}
!59 = distinct !{!59, !12}
!60 = distinct !{!60, !12}
!61 = distinct !{!61, !12, !21, !22}
!62 = distinct !{!62, !12, !22, !21}
!63 = distinct !{!63, !12}
!64 = distinct !{!64, !12}
!65 = distinct !{!65, !12}
!66 = !{!11, !7, i64 80}
