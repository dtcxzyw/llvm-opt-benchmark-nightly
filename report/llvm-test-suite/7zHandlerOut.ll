...
.lr.ph.split:                                     ; preds = %.lr.ph.split.preheader, %bb.b
  %.0388 = phi i32 [ %.18, %bb.b ], [ undef, %.lr.ph.split.preheader ] ; 3 uses
  %.0166386 = phi i32 [ %i.bi, %bb.b ], [ 0, %.lr.ph.split.preheader ] ; 11 uses
  %.0189385 = phi i1 [ %.5194, %bb.b ], [ undef, %.lr.ph.split.preheader ] ; 10 uses
...
.thread:                                          ; preds = %_ZN8NArchive3N7zL7GetTimeEP22IArchiveUpdateCallbackibjRyRb.exit, %_ZN8NArchive3N7zL7GetTimeEP22IArchiveUpdateCallbackibjRyRb.exit276, %bb.bj, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit288.a, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit291, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit293, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit268, %_ZN13CObjectVectorIN8NArchive3N7z11CUpdateItemEE3AddERKS2_.exit, %bb.g, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit295
  ...
  %.18 = phi i32 [ %.17, %_ZN13CObjectVectorIN8NArchive3N7z11CUpdateItemEE3AddERKS2_.exit ], [ -2147024809, %bb.g ], [ %.16, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit295 ], [ %.3, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit268 ], [ %.1.i, %_ZN8NArchive3N7zL7GetTimeEP22IArchiveUpdateCallbackibjRyRb.exit ], [ %.1.i272, %_ZN8NArchive3N7zL7GetTimeEP22IArchiveUpdateCallbackibjRyRb.exit276 ], [ %.1.i279, %bb.bj ], [ %.8, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit288.a ], [ %.10, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit291 ], [ %.12, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit293 ] ; 2 uses
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i306.preheader: ; preds = %bb.eg, %bb.ee
  %.0.i.i308.ph = phi ptr [ %i.mk, %bb.ee ], [ %i.mt, %bb.eg ]
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i306:     ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i306.preheader, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i306
  %.04.i.i307 = phi ptr [ %i.my, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i306 ], [ %.pre421, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i306.preheader ] ; 2 uses
  %.0.i.i308 = phi ptr [ %i.na, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i306 ], [ %.0.i.i308.ph, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i306.preheader ] ; 2 uses
  %i.my = getelementptr inbounds nuw i8, ptr %.04.i.i307, i64 4
  %i.mz = load i32, ptr %.04.i.i307, align 4, !tbaa !32 ; 2 uses
  %i.na = getelementptr inbounds nuw i8, ptr %.0.i.i308, i64 4
  store i32 %i.mz, ptr %.0.i.i308, align 4, !tbaa !32
...
bb.er:                                            ; preds = %bb.er, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i315
  %.04.i.i316 = phi ptr [ %i.oi, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i315 ], [ %i.oj, %bb.er ] ; 2 uses
  %.0.i.i317 = phi ptr [ %i.oh, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i315 ], [ %i.ol, %bb.er ] ; 2 uses
  %i.oj = getelementptr inbounds nuw i8, ptr %.04.i.i316, i64 4
  %i.ok = load i32, ptr %.04.i.i316, align 4, !tbaa !32 ; 2 uses
  %i.ol = getelementptr inbounds nuw i8, ptr %.0.i.i317, i64 4
  store i32 %i.ok, ptr %.0.i.i317, align 4, !tbaa !32
...
.thread356:                                       ; preds = %bb.do, %.thread351, %_ZN8NArchive3N7z22CCompressionMethodModeD2Ev.exit338
  %.28 = phi i32 [ %.27, %_ZN8NArchive3N7z22CCompressionMethodModeD2Ev.exit338 ], [ %.us-phi, %.thread351 ], [ %.18, %bb.do ]
...
bb.gi:                                            ; preds = %.body301, %bb.dq
  ...
  %.18142 = extractvalue { ptr, i32 } %.pn249.pn.pn.pn.pn.pn.pn.pn.pn.pn, 0
  %.18165 = extractvalue { ptr, i32 } %.pn249.pn.pn.pn.pn.pn.pn.pn.pn.pn, 1
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #19
  %i.vi = call i32 @llvm.eh.typeid.for.p0(ptr nonnull @_ZTIPKc) #19
  %i.vj = icmp eq i32 %.18165, %i.vi
  %i.vk = call ptr @__cxa_begin_catch(ptr %.18142) #19
...
bb.e:                                             ; preds = %bb.e, %_ZN11CStringBaseIwE11SetCapacityEi.exit
  ...
  %i.v = load i32, ptr %.04.i, align 4, !tbaa !32 ; 2 uses
  %i.w = getelementptr inbounds nuw i8, ptr %.0.i, i64 4
  store i32 %i.v, ptr %.0.i, align 4, !tbaa !32
...
_ZN11CStringBaseIwE11SetCapacityEi.exit:          ; preds = %bb.a, %_ZN11CStringBaseIwE11SetCapacityEi.exit
  %.04.i = phi ptr [ %i.j, %_ZN11CStringBaseIwE11SetCapacityEi.exit ], [ %1, %bb.a ] ; 2 uses
  %.0.i = phi ptr [ %i.l, %_ZN11CStringBaseIwE11SetCapacityEi.exit ], [ %i.i, %bb.a ] ; 2 uses
  %i.j = getelementptr inbounds nuw i8, ptr %.04.i, i64 4
  %i.k = load i32, ptr %.04.i, align 4, !tbaa !32 ; 2 uses
  %i.l = getelementptr inbounds nuw i8, ptr %.0.i, i64 4
  store i32 %i.k, ptr %.0.i, align 4, !tbaa !32
...
bb.f:                                             ; preds = %bb.f, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i
  %.04.i.i = phi ptr [ %i.m, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i ], [ %i.w, %bb.f ] ; 2 uses
  %.0.i.i = phi ptr [ %i.v, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i ], [ %i.y, %bb.f ] ; 2 uses
  %i.w = getelementptr inbounds nuw i8, ptr %.04.i.i, i64 4
  %i.x = load i32, ptr %.04.i.i, align 4, !tbaa !32 ; 2 uses
  %i.y = getelementptr inbounds nuw i8, ptr %.0.i.i, i64 4
  store i32 %i.x, ptr %.0.i.i, align 4, !tbaa !32
