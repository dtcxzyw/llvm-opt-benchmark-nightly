...
.lr.ph363:                                        ; preds = %._crit_edge357
  ...
  %i.pa = insertelement <2 x double> poison, double %i.ot, i64 0
  %i.pb = insertelement <2 x double> %i.pa, double %i.ov, i64 1
  br label %bb.i
...
bb.i:                                             ; preds = %.lr.ph363, %bb.i
  ...
  %0 = insertelement <2 x double> poison, double %i.pj, i64 0
  %i.pk = insertelement <2 x double> %0, double %i.ou, i64 1
  ...
  %i.pn = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.pk, <2 x double> %i.pm, <2 x double> %i.pb) ; 2 uses
...
.lr.ph370:                                        ; preds = %._crit_edge364
  ...
  %i.sz = insertelement <2 x double> poison, double %i.ss, i64 0
  %i.ta = insertelement <2 x double> %i.sz, double %i.su, i64 1
  br label %bb.j
...
bb.j:                                             ; preds = %.lr.ph370, %bb.j
  ...
  %1 = insertelement <2 x double> poison, double %i.ti, i64 0
  %i.tj = insertelement <2 x double> %1, double %i.st, i64 1
  ...
  %i.tm = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.tj, <2 x double> %i.tl, <2 x double> %i.ta) ; 2 uses
...
.lr.ph384:                                        ; preds = %._crit_edge378
  ...
  %i.zu = insertelement <2 x double> poison, double %i.zn, i64 0
...
bb.k:                                             ; preds = %.lr.ph384, %bb.k
  ...
  %2 = insertelement <2 x double> poison, double %i.aad, i64 0
  %i.aag = insertelement <2 x double> %2, double %i.zo, i64 1
  %i.aah = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.aaf, <2 x double> %i.aag, <2 x double> %i.zv) ; 3 uses
