...
begin_hunk_0_@_ZN8NArchive4NZip11COutArchive31PrepareWriteCompressedDataZip64Etbb:bb.a
  ...
  %i.c = select i1 %2, i32 20, i32 0              ; 2 uses
  %4 = or disjoint i32 %i.c, 11
...
bb.a:
  %i.a = icmp ugt i64 %2, 4160749567              ; 2 uses
  %i.b = zext i1 %i.a to i8
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 80
  store i8 %i.b, ptr %i.c, align 8, !tbaa !25
  %i.d = select i1 %i.a, i32 20, i32 0            ; 2 uses
  %4 = or disjoint i32 %i.d, 11
...
bb.a:
  ...
  %i.c = or i1 %i.a, %i.b                         ; 2 uses
  %i.d = zext i1 %i.c to i8
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 80
  store i8 %i.d, ptr %i.e, align 8, !tbaa !25
  %i.f = select i1 %i.c, i32 20, i32 0            ; 2 uses
  %5 = or disjoint i32 %i.f, 11
