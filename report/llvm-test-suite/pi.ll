begin_hunk_0
  ...
  %2 = uitofp nneg i64 %i.b to double
  %3 = fdiv double %2, 7.438300e+04
  %4 = fptrunc double %3 to float                 ; 3 uses
...
begin_hunk_1
  ...
  %i.j = tail call float @llvm.fmuladd.f32(float %4, float %4, float %i.i) ; 2 uses
