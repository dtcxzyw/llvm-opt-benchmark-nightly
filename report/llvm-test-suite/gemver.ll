...
vector.ph73:                                      ; preds = %.preheader69.i
  %i.db = load double, ptr %i.cz, align 8, !tbaa !8, !alias.scope !19
  ...
  %i.dc = load double, ptr %i.da, align 8, !tbaa !8, !alias.scope !22
...
begin_hunk_1_@main:bb.a
  ...
  %i.dh = fmul <2 x double> %broadcast.splat84.a, %wide.load77
  %i.di = fmul <2 x double> %broadcast.splat84.a, %wide.load78
  ...
  %i.dn = fmul <2 x double> %broadcast.splat80, %wide.load81
  %i.do = fmul <2 x double> %broadcast.splat80, %wide.load82
