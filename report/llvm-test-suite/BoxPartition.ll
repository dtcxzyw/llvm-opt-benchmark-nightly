...
.lr.ph299.split.split.split.us380.split.us.split.us.us.us.us.us.us.i.us.preheader: ; preds = %.lr.ph299.split.split.split.us380.split.us.us.us.us.us.us.i.us
  %smax107 = tail call i32 @llvm.smax.i32(i32 %i.ct, i32 0)
  %umin108 = tail call i32 @llvm.umin.i32(i32 %smax107, i32 %i.bd) ; 2 uses
  %i.dh = add nuw i32 %umin108, 1                 ; 2 uses
  %min.iters.check110 = icmp samesign ult i32 %umin108, 15
  br i1 %min.iters.check110, label %.lr.ph299.split.split.split.us380.split.us.split.us.us.us.us.us.us.i.us.preheader141, label %vector.ph111

vector.ph111:                                     ; preds = %.lr.ph299.split.split.split.us380.split.us.split.us.us.us.us.us.us.i.us.preheader
  %n.vec113 = and i32 %i.dh, -16                  ; 3 uses
  %i.di = sub i32 %n.vec113, %3
  %broadcast.splatinsert116.a = insertelement <16 x i32> poison, i32 %i.ct, i64 0
  %broadcast.splat117.a = shufflevector <16 x i32> %broadcast.splatinsert116.a, <16 x i32> poison, <16 x i32> zeroinitializer
  %broadcast.splatinsert118 = insertelement <16 x i32> poison, i32 %i.dg, i64 0
  %broadcast.splat119 = shufflevector <16 x i32> %broadcast.splatinsert118, <16 x i32> poison, <16 x i32> zeroinitializer
  %invariant.op = add <16 x i32> %broadcast.splat115.a, %broadcast.splat119
  br label %vector.body123

vector.body123:                                   ; preds = %vector.body.interim128, %vector.ph111
  %index124 = phi i32 [ 0, %vector.ph111 ], [ %index.next126, %vector.body.interim128 ]
  %vec.ind125 = phi <16 x i32> [ %induction122, %vector.ph111 ], [ %vec.ind.next127, %vector.body.interim128 ] ; 3 uses
  %i.dj = add nsw <16 x i32> %vec.ind125, %broadcast.splat115.a
  %i.dk = icmp sge <16 x i32> %i.dj, %broadcast.splat117.a
  %.reass = add <16 x i32> %vec.ind125, %invariant.op
  ...
  br i1 %.not, label %vector.body.interim128, label %_ZL19box_map_local_entryRK3Boxiiii.exit.thread.i

vector.body.interim128:                           ; preds = %vector.body123
  %vec.ind.next127 = add <16 x i32> %vec.ind125, splat (i32 16)
  %index.next126 = add nuw i32 %index124, 16      ; 2 uses
  %i.dp = icmp eq i32 %index.next126, %n.vec113
  br i1 %i.dp, label %middle.block129, label %vector.body123, !llvm.loop !11

middle.block129:                                  ; preds = %vector.body.interim128
  %cmp.n130 = icmp eq i32 %i.dh, %n.vec113
...
vector.body:                                      ; preds = %vector.body.interim, %vector.ph
  ...
  %i.fi = icmp sge <16 x i32> %i.fh, %broadcast.splat102.a
...
bb.v:                                             ; preds = %_ZL10resize_intPPiS_i.exit.us.us.us.us.us.us.us.us.us.i.us, %bb.q
  ...
  %exitcond765.not.i.us = icmp eq i32 %i.hw, %i.ay
...
._crit_edge.sink.split.i:                         ; preds = %.lr.ph648.split.us.i, %.lr.ph648.split.preheader.i
  ...
  %i.hz = shl nuw nsw i64 %.sink811.i, 2          ; 2 uses
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.ai, i8 0, i64 %i.hz, i1 false), !tbaa !4
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.aj, i8 0, i64 %i.hz, i1 false), !tbaa !4
...
_ZL18box_partition_mapsiiPK3BoxiPPiS3_S3_S3_.exit: ; preds = %_ZL12box_disjointRK3BoxS1_.exit.thread.us.us.i.us, %.lr.ph648.split.us.split.us.i.preheader45, %.preheader277.i, %._crit_edge.sink.split.i
  ...
  %i.ia = getelementptr inbounds [4 x i8], ptr %i.ai, i64 %i.a
  store i32 %.0.lcssa.i, ptr %i.ia, align 4, !tbaa !4
  %i.ib = getelementptr inbounds [4 x i8], ptr %i.aj, i64 %i.a
  store i32 %.0159.lcssa.i, ptr %i.ib, align 4, !tbaa !4
