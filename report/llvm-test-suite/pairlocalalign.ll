...
bb.o:                                             ; preds = %bb.n, %bb.m, %bb.l, %bb.k, %bb.j
  ...
  %2 = load i32, ptr @poffset, align 4, !tbaa !4
  %3 = insertelement <2 x i32> poison, i32 %i.bi, i64 0
  %4 = insertelement <2 x i32> %3, i32 %2, i64 1
  %5 = sitofp <2 x i32> %4 to <2 x double>
  %6 = fdiv <2 x double> %5, splat (double 1.000000e+03) ; 2 uses
  %7 = extractelement <2 x double> %6, i64 0
  %8 = extractelement <2 x double> %6, i64 1
  %i.bj = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.be, ptr noundef nonnull @.str.26, double noundef %i.bh, double noundef %7, double noundef %8) #19 ; 0 uses
...
bb.ab:                                            ; preds = %bb.aa, %bb.t
  ...
  %10 = insertelement <2 x i32> poison, i32 %i.ck, i64 0
  %11 = insertelement <2 x i32> %10, i32 %9, i64 1
  %12 = sitofp <2 x i32> %11 to <2 x double>
  %13 = fdiv <2 x double> %12, splat (double 1.000000e+03) ; 2 uses
  %14 = extractelement <2 x double> %13, i64 0
  %15 = extractelement <2 x double> %13, i64 1
  %i.cl = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.au, ptr noundef nonnull @.str.26, double noundef %i.cj, double noundef %14, double noundef %15) #20 ; 0 uses
