...
bb.cc:                                            ; preds = %bb.ca
  %i.ls = load i8, ptr @alg, align 1, !tbaa !8
  switch i8 %i.ls, label %bb.ec [
    i8 97, label %bb.cd
    i8 116, label %bb.ce
    i8 65, label %bb.cf
end_hunk_0
...
bb.eb:                                            ; preds = %bb.ea, %recalllara.exit.i, %recallpairfoldalign.exit.i, %bb.ci, %bb.ch, %bb.cg, %bb.cf, %bb.ce, %bb.cd, %bb.cb
  %.2241.ph.i = phi float [ %i.qy, %bb.ea ], [ %i.lr, %bb.cb ], [ %i.qb, %recalllara.exit.i ], [ %.0.i.i, %recallpairfoldalign.exit.i ], [ %i.mh, %bb.ci ], [ %i.me, %bb.ch ], [ %i.mc, %bb.cg ], [ %i.lz, %bb.cf ], [ %i.ly, %bb.ce ], [ %i.lv, %bb.cd ] ; 2 uses
  %.pr1.i = load i8, ptr @alg, align 1, !tbaa !8
  %i.qz = icmp eq i8 %.pr1.i, 116
  br i1 %i.qz, label %bb.ee, label %bb.ec

bb.ec:                                            ; preds = %bb.eb, %bb.cc
  %.22413.i = phi float [ %.2241.ph.i, %bb.eb ], [ %.124034.i, %bb.cc ] ; 2 uses
...
bb.ee:                                            ; preds = %bb.ed, %bb.eb
  %.22414.i = phi float [ %.22413.i, %bb.ed ], [ %.2241.ph.i, %bb.eb ] ; 8 uses
  %i.re = fpext float %.22414.i to double
...
begin_hunk_7
  ...
  %i.rr = fptosi float %.22414.i to i32
...
begin_hunk_8
  ...
  %i.sa = fptosi float %.22414.i to i32
...
bb.ej:                                            ; preds = %bb.ei, %bb.eh, %bb.eg, %bb.ef, %bb.ef, %bb.ee
  %.22415.i = phi float [ %.22414.i, %bb.ef ], [ %.22414.i, %bb.ef ], [ %.22414.i, %bb.ee ], [ %.22414.i, %bb.eh ], [ %.22414.i, %bb.eg ], [ %.22413.i, %bb.ei ] ; 3 uses
...
bb.ek:                                            ; preds = %bb.ej
  ...
  %i.sk = fpext float %.22415.i to double
  %i.sl = add i32 %i.lm, 1
...
bb.el:                                            ; preds = %bb.ek, %bb.ej, %bb.bz
  %.3242.i = phi float [ %.124034.i, %bb.bz ], [ %.22415.i, %bb.ek ], [ %.22415.i, %bb.ej ] ; 2 uses
