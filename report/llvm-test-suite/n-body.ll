...
.loopexit.i.4:
  %i.a = load double, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 96), align 16, !tbaa !15 ; 3 uses
  ...
  %i.y = load <2 x double>, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 184), align 8 ; 2 uses
  ...
  %i.ab = load <2 x double>, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 128), align 16 ; 2 uses
  %i.ac = load double, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 240), align 16, !tbaa !12
  %i.ad = load double, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 184), align 8, !tbaa !12
  %2 = load <2 x double>, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 112), align 16
  %3 = load <2 x double>, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 120), align 8
  %4 = load <2 x double>, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 216), align 8, !tbaa !10 ; 4 uses
  %5 = extractelement <2 x double> %4, i64 0      ; 3 uses
  %6 = load <2 x double>, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 24), align 8, !tbaa !10
  %7 = load <2 x double>, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 80), align 16, !tbaa !10 ; 4 uses
  %8 = shufflevector <2 x double> %i.g, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %9 = load <2 x double>, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 136), align 8, !tbaa !10 ; 3 uses
  %10 = load <2 x double>, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 192), align 16, !tbaa !10 ; 3 uses
  %11 = load <2 x double>, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 248), align 8, !tbaa !10 ; 4 uses
  %foldExtExtBinop = fmul <2 x double> %11, %11
  %12 = extractelement <2 x double> %foldExtExtBinop, i64 1
  %i.ae = extractelement <2 x double> %11, i64 0  ; 2 uses
  %i.af = tail call double @llvm.fmuladd.f64(double %i.ae, double %i.ae, double %12)
  %13 = extractelement <2 x double> %10, i64 0    ; 2 uses
  %14 = shufflevector <2 x double> %10, <2 x double> %9, <2 x i32> <i32 1, i32 3> ; 2 uses
  %15 = fmul <2 x double> %14, %14                ; 2 uses
  %16 = extractelement <2 x double> %15, i64 0
  %17 = tail call double @llvm.fmuladd.f64(double %13, double %13, double %16)
  %18 = tail call double @llvm.fmuladd.f64(double %i.b, double %i.b, double %17)
  %19 = extractelement <2 x double> %9, i64 0     ; 2 uses
  %20 = extractelement <2 x double> %15, i64 1
  %21 = tail call double @llvm.fmuladd.f64(double %19, double %19, double %20)
  %foldExtExtBinop42 = fmul <2 x double> %7, %7
  %22 = extractelement <2 x double> %foldExtExtBinop42, i64 1
  %23 = extractelement <2 x double> %7, i64 0     ; 2 uses
  %24 = tail call double @llvm.fmuladd.f64(double %23, double %23, double %22)
  %25 = tail call double @llvm.fmuladd.f64(double %i.a, double %i.a, double %24)
  %i.ag = shufflevector <2 x double> %4, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %26 = fmul double %i.am, 5.000000e-01
  %27 = fmul double %i.ak, 5.000000e-01
  %28 = fmul double %i.ah, 5.000000e-01
  %29 = tail call double @llvm.fmuladd.f64(double %i.a, double %i.h, double %i.aj)
  %30 = tail call double @llvm.fmuladd.f64(double %i.al, double %i.ak, double %29)
  %i.ao = insertelement <2 x double> poison, double %i.ah, i64 0
  %i.ap = shufflevector <2 x double> %i.ao, <2 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  %31 = insertelement <2 x double> %i.g, double %i.ak, i64 1
  %32 = fmul <2 x double> %i.ap, %31
  %33 = fdiv <2 x double> %32, %i.x               ; 2 uses
  %i.aq = fmul double %i.h, %i.ak
  %i.ar = tail call double @llvm.fmuladd.f64(double %i.b, double %5, double %30)
  %i.as = tail call double @llvm.fmuladd.f64(double %i.an, double %i.am, double %i.ar)
  %i.at = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> %i.ap, <2 x double> zeroinitializer)
  %i.au = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %7, <2 x double> %8, <2 x double> %i.at)
  %i.av = insertelement <2 x double> poison, double %i.ak, i64 0
  %34 = shufflevector <2 x double> %i.av, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %35 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %9, <2 x double> %34, <2 x double> %i.au)
  %36 = tail call double @llvm.fmuladd.f64(double %i.an, double %i.an, double %i.af)
  %i.aw = tail call double @llvm.fmuladd.f64(double %i.al, double %i.al, double %21)
  %37 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %10, <2 x double> %i.ag, <2 x double> %35)
  %38 = insertelement <2 x double> poison, double %i.am, i64 0
  %39 = shufflevector <2 x double> %38, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ax = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %11, <2 x double> %39, <2 x double> %37)
  %i.ay = fdiv <2 x double> %i.ax, splat (double f0xC043BD3CC9BE45DE) ; 2 uses
  %40 = extractelement <2 x double> %i.ay, i64 0  ; 3 uses
  store double %40, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 24), align 8, !tbaa !19
  %41 = extractelement <2 x double> %i.ay, i64 1  ; 3 uses
  store double %41, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 32), align 16, !tbaa !20
  %42 = insertelement <2 x double> poison, double %i.aq, i64 0
  %43 = insertelement <2 x double> %42, double %i.as, i64 1
  %44 = fmul double %5, 5.000000e-01
  %45 = fmul double %41, %41
  %i.az = tail call double @llvm.fmuladd.f64(double %40, double %40, double %45)
  %i.ba = extractelement <2 x double> %33, i64 0
  %i.bb = extractelement <2 x double> %33, i64 1
  ...
  %i.bo = insertelement <2 x double> %4, double %i.am, i64 1 ; 3 uses
  %i.bp = fmul <2 x double> %i.ap, %i.bo
  ...
  %i.bv = insertelement <2 x double> %i.y, double %i.ac, i64 1
  ...
  %i.ca = fmul <2 x double> %8, %i.bo
  %i.cb = load <2 x double>, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 168), align 8, !tbaa !10 ; 2 uses
  %i.cc = fmul <2 x double> %34, %i.bo
  %i.cd = load <2 x double>, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 232), align 8, !tbaa !10 ; 2 uses
  %i.ce = shufflevector <2 x double> %i.ab, <2 x double> poison, <2 x i32> zeroinitializer
  %i.cf = insertelement <2 x double> %i.cd, double %i.ad, i64 0
  %i.cg = fsub <2 x double> %i.ce, %i.cf          ; 2 uses
  %i.ch = shufflevector <2 x double> %2, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ci = shufflevector <2 x double> %i.cb, <2 x double> %4, <2 x i32> <i32 0, i32 3>
  ...
  %46 = load <2 x double>, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 56), align 8, !tbaa !10 ; 4 uses
  %47 = load <2 x double>, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 112), align 16, !tbaa !10 ; 2 uses
  %48 = insertelement <2 x double> %i.aa, double %i.cv, i64 1
  %49 = insertelement <2 x double> %i.ab, double %i.cw, i64 1
  %50 = fsub <2 x double> %48, %49                ; 2 uses
  %51 = load <2 x double>, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 168), align 8, !tbaa !10 ; 2 uses
  %52 = load <2 x double>, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 224), align 16, !tbaa !10 ; 2 uses
  %53 = shufflevector <2 x double> %46, <2 x double> %51, <2 x i32> <i32 0, i32 2>
  %54 = shufflevector <2 x double> %47, <2 x double> %52, <2 x i32> <i32 0, i32 2>
  %i.cx = fsub <2 x double> %53, %54              ; 2 uses
  %55 = shufflevector <2 x double> %46, <2 x double> %51, <2 x i32> <i32 1, i32 3>
  %56 = shufflevector <2 x double> %47, <2 x double> %52, <2 x i32> <i32 1, i32 3>
  %57 = fsub <2 x double> %55, %56                ; 2 uses
  %58 = fmul <2 x double> %57, %57
  %59 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cx, <2 x double> %i.cx, <2 x double> %58)
  %i.cy = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %50, <2 x double> %50, <2 x double> %59)
  ...
  %i.db = fdiv <2 x double> %43, %i.da            ; 2 uses
  ...
  %i.de = tail call double @llvm.fmuladd.f64(double %28, double %i.dd, double 0.000000e+00)
  %i.df = fsub double %i.de, %i.ba
  %i.dg = fsub double %i.df, %i.bb
  %i.dh = fsub double %i.dg, %i.br
  %i.di = fsub double %i.dh, %i.bs
  %i.dj = tail call double @llvm.fmuladd.f64(double %i.i, double %25, double %i.di)
  %i.dk = extractelement <2 x double> %i.db, i64 0
  %i.dl = fsub double %i.dj, %i.dk
  %60 = shufflevector <2 x double> %46, <2 x double> poison, <2 x i32> zeroinitializer
  %61 = fsub <2 x double> %60, %i.by              ; 2 uses
  %62 = shufflevector <2 x double> %46, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %63 = fsub <2 x double> %62, %i.bz              ; 2 uses
  %64 = fmul <2 x double> %63, %63
  %65 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %61, <2 x double> %61, <2 x double> %64)
  %66 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bw, <2 x double> %i.bw, <2 x double> %65)
  %67 = tail call <2 x double> @llvm.sqrt.v2f64(<2 x double> %66)
  %68 = fdiv <2 x double> %i.ca, %67              ; 2 uses
  %69 = extractelement <2 x double> %68, i64 0
  %i.dm = fsub double %i.dl, %69
  %70 = extractelement <2 x double> %68, i64 1
  %i.dn = fsub double %i.dm, %70
  %i.do = tail call double @llvm.fmuladd.f64(double %27, double %i.aw, double %i.dn)
  %i.dp = fsub double %i.do, %i.cs
  %i.dq = fsub double %i.dp, %i.ct
  %i.dr = tail call double @llvm.fmuladd.f64(double %44, double %18, double %i.dq)
  %i.ds = extractelement <2 x double> %i.cz, i64 1
  %i.dt = fdiv double %i.cu, %i.ds
  %i.du = fsub double %i.dr, %i.dt
  %i.dv = tail call double @llvm.fmuladd.f64(double %26, double %36, double %i.du)
