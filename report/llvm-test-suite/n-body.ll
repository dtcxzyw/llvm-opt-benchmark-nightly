...
.loopexit.i.4:
  %2 = load double, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 48), align 16, !tbaa !14 ; 3 uses
  %3 = load double, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 40), align 8, !tbaa !15
  %4 = tail call double @llvm.fmuladd.f64(double %3, double %2, double 0.000000e+00)
  %5 = load double, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 96), align 16, !tbaa !15 ; 2 uses
  %6 = load double, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 160), align 16, !tbaa !14 ; 5 uses
  %7 = load double, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 152), align 8, !tbaa !15 ; 3 uses
  %8 = load double, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 208), align 16, !tbaa !15 ; 3 uses
  %i.a = load double, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 272), align 16, !tbaa !14 ; 5 uses
  %i.b = load double, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 264), align 8, !tbaa !15 ; 3 uses
  ...
  %11 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.c, <2 x double> %10, <2 x double> zeroinitializer)
  ...
  %16 = fmul double %i.a, 5.000000e-01
  ...
  %17 = tail call double @llvm.fmuladd.f64(double %i.i, double %i.i, double %i.h)
  %i.j = tail call double @llvm.fmuladd.f64(double %i.b, double %i.b, double %17)
  ...
  %i.n = tail call double @llvm.fmuladd.f64(double %8, double %8, double %i.m)
  ...
  %19 = tail call double @llvm.fmuladd.f64(double %i.p, double %i.p, double %i.o)
  %i.q = tail call double @llvm.fmuladd.f64(double %7, double %7, double %19)
  ...
  %21 = tail call double @llvm.fmuladd.f64(double %5, double %i.z, double %4)
  %22 = tail call double @llvm.fmuladd.f64(double %7, double %6, double %21)
  %i.aa = shufflevector <2 x double> %i.y, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %23 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.d, <2 x double> %i.aa, <2 x double> %11)
  %24 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.e, <2 x double> %13, <2 x double> %23)
  ...
  %25 = insertelement <2 x double> %i.y, double %6, i64 1
  ...
  %27 = fdiv <2 x double> %26, %i.aq              ; 2 uses
  ...
  %29 = tail call double @llvm.fmuladd.f64(double %8, double %i.bo, double %22)
  %30 = tail call double @llvm.fmuladd.f64(double %i.b, double %i.a, double %29)
  %i.bp = shufflevector <2 x double> %i.bn, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bq = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.f, <2 x double> %i.bp, <2 x double> %24)
  %31 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.g, <2 x double> %15, <2 x double> %i.bq)
  %32 = fdiv <2 x double> %31, splat (double f0xC043BD3CC9BE45DE) ; 4 uses
  store <2 x double> %32, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 24), align 8, !tbaa !10
  %33 = fdiv double %30, f0xC043BD3CC9BE45DE      ; 3 uses
  store double %33, ptr getelementptr inbounds nuw (i8, ptr @bodies, i64 40), align 8, !tbaa !15
  %i.br = fmul double %i.bo, 5.000000e-01
  %foldExtExtBinop48 = fmul <2 x double> %32, %32
  %34 = extractelement <2 x double> %foldExtExtBinop48, i64 1
  %35 = extractelement <2 x double> %32, i64 0    ; 2 uses
  %i.bs = tail call double @llvm.fmuladd.f64(double %35, double %35, double %34)
  %i.bt = tail call double @llvm.fmuladd.f64(double %33, double %33, double %i.bs)
  %i.bu = tail call double @llvm.fmuladd.f64(double %20, double %i.bt, double 0.000000e+00)
  %i.bv = extractelement <2 x double> %27, i64 0
  %36 = fsub double %i.bu, %i.bv
  %i.bw = extractelement <2 x double> %27, i64 1
  %37 = fsub double %36, %i.bw
  ...
  %i.cj = insertelement <2 x double> %i.bn, double %i.a, i64 1 ; 3 uses
  %i.ck = fmul <2 x double> %10, %i.cj
  %i.cl = fdiv <2 x double> %i.ck, %i.ci          ; 2 uses
  %i.cm = extractelement <2 x double> %i.cl, i64 0
  %38 = fsub double %37, %i.cm
  %i.cn = extractelement <2 x double> %i.cl, i64 1
  %39 = fsub double %38, %i.cn
  %i.co = extractelement <2 x double> %i.bg, i64 0
  %40 = tail call double @llvm.fmuladd.f64(double %i.ab, double %i.co, double %39)
  ...
  %41 = tail call double @llvm.fmuladd.f64(double %i.ei, double %i.ei, double %i.em)
  %i.en = insertelement <2 x double> %i.at, double %i.ee, i64 1
  %42 = insertelement <2 x double> %i.au, double %i.ef, i64 1
  %43 = fsub <2 x double> %i.en, %42              ; 2 uses
  %i.eo = shufflevector <2 x double> %i.bg, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.ep = insertelement <2 x double> %i.eo, double %41, i64 1
  %i.eq = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %43, <2 x double> %43, <2 x double> %i.ep)
  %i.er = tail call <2 x double> @llvm.sqrt.v2f64(<2 x double> %i.eq) ; 2 uses
  %i.es = extractelement <2 x double> %i.er, i64 0
  %44 = fdiv double %28, %i.es
  %i.et = fsub double %40, %44
  %i.eu = fsub double %i.et, %i.di
  %i.ev = fsub double %i.eu, %i.dj
  %i.ew = tail call double @llvm.fmuladd.f64(double %18, double %i.q, double %i.ev)
  %i.ex = fsub double %i.ew, %i.eb
  %i.ey = fsub double %i.ex, %i.ec
  %i.ez = tail call double @llvm.fmuladd.f64(double %i.br, double %i.n, double %i.ey)
  %i.fa = extractelement <2 x double> %i.er, i64 1
  %i.fb = fdiv double %i.ed, %i.fa
  %i.fc = fsub double %i.ez, %i.fb
  %i.fd = tail call double @llvm.fmuladd.f64(double %16, double %i.j, double %i.fc)
