...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %i.o = sub nsw i64 %i.l, %n.vec
  %i.p = getelementptr i8, ptr %1, i64 %n.vec     ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.q = xor i64 %index, -1
  %gep = getelementptr i8, ptr %invariant.gep, i64 %i.q ; 2 uses
  %i.r = getelementptr inbounds i8, ptr %gep, i64 -15
  %i.s = getelementptr inbounds i8, ptr %gep, i64 -31
  %wide.load = load <16 x i8>, ptr %i.r, align 1, !tbaa !8
  %wide.load31 = load <16 x i8>, ptr %i.s, align 1, !tbaa !8
  ...
  store <16 x i8> %reverse32, ptr %i.t, align 1, !tbaa !8
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec34 = and i64 %i.m, 2147483640             ; 4 uses
  %i.v = sub nsw i64 %i.l, %n.vec34
  %i.w = getelementptr i8, ptr %1, i64 %n.vec34   ; 2 uses
  %invariant.gep45 = getelementptr i8, ptr %i.a, i64 %i.l
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.x = xor i64 %index35, -1
  %gep46 = getelementptr i8, ptr %invariant.gep45, i64 %i.x
  %i.y = getelementptr inbounds i8, ptr %gep46, i64 -7
  %wide.load37 = load <8 x i8>, ptr %i.y, align 1, !tbaa !8
  %reverse38 = shufflevector <8 x i8> %wide.load37, <8 x i8> poison, <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  store <8 x i8> %reverse38, ptr %next.gep36, align 1, !tbaa !8
  %index.next39 = add nuw i64 %index35, 8         ; 2 uses
...
vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n40 = icmp eq i64 %i.m, %n.vec34
  br i1 %cmp.n40, label %.loopexit, label %.preheader.preheader

.preheader.preheader:                             ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv27.ph = phi i64 [ %i.l, %iter.check ], [ %i.o, %vec.epilog.iter.check ], [ %i.v, %vec.epilog.middle.block ]
  %.017.ph = phi ptr [ %1, %iter.check ], [ %i.p, %vec.epilog.iter.check ], [ %i.w, %vec.epilog.middle.block ]
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %.preheader ], [ %indvars.iv27.ph, %.preheader.preheader ] ; 2 uses
  %.017 = phi ptr [ %i.ac, %.preheader ], [ %.017.ph, %.preheader.preheader ] ; 2 uses
  %indvars.iv.next28 = add nsw i64 %indvars.iv27, -1 ; 2 uses
  %i.aa = getelementptr inbounds i8, ptr %i.a, i64 %indvars.iv.next28
  %i.ab = load i8, ptr %i.aa, align 1, !tbaa !8
  %i.ac = getelementptr inbounds nuw i8, ptr %.017, i64 1 ; 2 uses
  store i8 %i.ab, ptr %.017, align 1, !tbaa !8
  %i.ad = icmp sgt i64 %indvars.iv27, 1
  br i1 %i.ad, label %.preheader, label %.loopexit, !llvm.loop !16

.loopexit:                                        ; preds = %.preheader, %vec.epilog.middle.block, %middle.block
  %.lcssa = phi ptr [ %i.w, %vec.epilog.middle.block ], [ %i.p, %middle.block ], [ %i.ac, %.preheader ]
...
bb.b:                                             ; preds = %bb.b, %bb.a
  %indvars.iv12 = phi i32 [ %indvars.iv.next13, %bb.b ], [ 1, %bb.a ] ; 2 uses
...
.preheader.preheader:                             ; preds = %bb.b
  %i.g = sext i32 %indvars.iv12 to i64            ; 5 uses
  %i.h = tail call i64 @llvm.smin.i64(i64 %i.g, i64 1)
  %2 = sub i64 %i.g, %i.h
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %1, i64 %index ; 2 uses
  %i.m = xor i64 %index, -1
  %gep = getelementptr i8, ptr %invariant.gep, i64 %i.m ; 2 uses
  %i.n = getelementptr inbounds i8, ptr %gep, i64 -15
  %i.o = getelementptr inbounds i8, ptr %gep, i64 -31
  %wide.load = load <16 x i8>, ptr %i.n, align 1, !tbaa !8
  %wide.load2 = load <16 x i8>, ptr %i.o, align 1, !tbaa !8
  %reverse = shufflevector <16 x i8> %wide.load, <16 x i8> poison, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  ...
  %i.p = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %reverse, ptr %next.gep, align 1, !tbaa !8
  store <16 x i8> %reverse3, ptr %i.p, align 1, !tbaa !8
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.q = icmp eq i64 %index.next, %n.vec
  br i1 %i.q, label %middle.block, label %vector.body, !llvm.loop !22
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec5 = and i64 %i.i, 2147483640              ; 4 uses
  %i.r = sub nsw i64 %i.h, %n.vec5
  %i.s = getelementptr i8, ptr %1, i64 %n.vec5    ; 2 uses
  %invariant.gep16 = getelementptr i8, ptr %i.a, i64 %i.h
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index6 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next10, %vec.epilog.vector.body ] ; 3 uses
  %next.gep7 = getelementptr i8, ptr %1, i64 %index6
  %i.t = xor i64 %index6, -1
  %gep17 = getelementptr i8, ptr %invariant.gep16, i64 %i.t
  %i.u = getelementptr inbounds i8, ptr %gep17, i64 -7
  %wide.load8 = load <8 x i8>, ptr %i.u, align 1, !tbaa !8
  %reverse9 = shufflevector <8 x i8> %wide.load8, <8 x i8> poison, <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  store <8 x i8> %reverse9, ptr %next.gep7, align 1, !tbaa !8
  %index.next10 = add nuw i64 %index6, 8          ; 2 uses
  %i.v = icmp eq i64 %index.next10, %n.vec5
  br i1 %i.v, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !23

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n11 = icmp eq i64 %i.i, %n.vec5
  br i1 %cmp.n11, label %_Z21ConvertUInt64ToStringyPcj.exit, label %.preheader.i.preheader

.preheader.i.preheader:                           ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv27.i.ph = phi i64 [ %i.h, %iter.check ], [ %i.k, %vec.epilog.iter.check ], [ %i.r, %vec.epilog.middle.block ]
  %.017.i.ph = phi ptr [ %1, %iter.check ], [ %i.l, %vec.epilog.iter.check ], [ %i.s, %vec.epilog.middle.block ]
  br label %.preheader.i

.preheader.i:                                     ; preds = %.preheader.i.preheader, %.preheader.i
  %indvars.iv27.i = phi i64 [ %indvars.iv.next28.i, %.preheader.i ], [ %indvars.iv27.i.ph, %.preheader.i.preheader ] ; 2 uses
  %.017.i = phi ptr [ %i.y, %.preheader.i ], [ %.017.i.ph, %.preheader.i.preheader ] ; 2 uses
  %indvars.iv.next28.i = add nsw i64 %indvars.iv27.i, -1 ; 2 uses
  %i.w = getelementptr inbounds i8, ptr %i.a, i64 %indvars.iv.next28.i
  %i.x = load i8, ptr %i.w, align 1, !tbaa !8
  %i.y = getelementptr inbounds nuw i8, ptr %.017.i, i64 1 ; 2 uses
  store i8 %i.x, ptr %.017.i, align 1, !tbaa !8
  %i.z = icmp sgt i64 %indvars.iv27.i, 1
  br i1 %i.z, label %.preheader.i, label %_Z21ConvertUInt64ToStringyPcj.exit, !llvm.loop !24

_Z21ConvertUInt64ToStringyPcj.exit:               ; preds = %.preheader.i, %vec.epilog.middle.block, %middle.block
  %.lcssa = phi ptr [ %i.s, %vec.epilog.middle.block ], [ %i.l, %middle.block ], [ %i.y, %.preheader.i ]
  store i8 0, ptr %.lcssa, align 1, !tbaa !8
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #4
  ret void
}
...
bb.b:                                             ; preds = %bb.b, %bb.a
  %indvars.iv12.i = phi i32 [ %indvars.iv.next13.i, %bb.b ], [ 1, %bb.a ] ; 2 uses
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %bb.b ], [ 0, %bb.a ] ; 2 uses
...
.preheader.preheader.i:                           ; preds = %bb.b
  %i.h = sext i32 %indvars.iv12.i to i64          ; 5 uses
  %i.i = tail call i64 @llvm.smin.i64(i64 %i.h, i64 1)
  %2 = sub i64 %i.h, %i.i
  %3 = add i64 %2, 1                              ; 3 uses
  %min.iters.check = icmp ult i64 %3, 8
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %i.m = sub nsw i64 %i.j, %n.vec
  %i.n = getelementptr i8, ptr %.0, i64 %n.vec    ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.o = xor i64 %index, -1
  %gep = getelementptr i8, ptr %invariant.gep, i64 %i.o ; 2 uses
  %i.p = getelementptr inbounds i8, ptr %gep, i64 -15
  %i.q = getelementptr inbounds i8, ptr %gep, i64 -31
  %wide.load = load <16 x i8>, ptr %i.p, align 1, !tbaa !8
  %wide.load8 = load <16 x i8>, ptr %i.q, align 1, !tbaa !8
  %reverse = shufflevector <16 x i8> %wide.load, <16 x i8> poison, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  ...
  store <16 x i8> %reverse, ptr %next.gep, align 1, !tbaa !8
  store <16 x i8> %reverse9, ptr %i.r, align 1, !tbaa !8
  %index.next = add nuw i64 %index, 32            ; 2 uses
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec11 = and i64 %i.k, 2147483640             ; 4 uses
  %i.t = sub nsw i64 %i.j, %n.vec11
  %i.u = getelementptr i8, ptr %.0, i64 %n.vec11  ; 2 uses
  %invariant.gep22 = getelementptr i8, ptr %i.a, i64 %i.j
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index12 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next16, %vec.epilog.vector.body ] ; 3 uses
  %next.gep13 = getelementptr i8, ptr %.0, i64 %index12
  %i.v = xor i64 %index12, -1
  %gep23 = getelementptr i8, ptr %invariant.gep22, i64 %i.v
  %i.w = getelementptr inbounds i8, ptr %gep23, i64 -7
  %wide.load14 = load <8 x i8>, ptr %i.w, align 1, !tbaa !8
  %reverse15 = shufflevector <8 x i8> %wide.load14, <8 x i8> poison, <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  store <8 x i8> %reverse15, ptr %next.gep13, align 1, !tbaa !8
  %index.next16 = add nuw i64 %index12, 8         ; 2 uses
  %i.x = icmp eq i64 %index.next16, %n.vec11
  br i1 %i.x, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !28

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n17 = icmp eq i64 %i.k, %n.vec11
  br i1 %cmp.n17, label %_Z21ConvertUInt64ToStringyPcj.exit, label %.preheader.i.preheader

.preheader.i.preheader:                           ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv27.i.ph = phi i64 [ %i.j, %iter.check ], [ %i.m, %vec.epilog.iter.check ], [ %i.t, %vec.epilog.middle.block ]
  %.017.i.ph = phi ptr [ %.0, %iter.check ], [ %i.n, %vec.epilog.iter.check ], [ %i.u, %vec.epilog.middle.block ]
  br label %.preheader.i

.preheader.i:                                     ; preds = %.preheader.i.preheader, %.preheader.i
  %indvars.iv27.i = phi i64 [ %indvars.iv.next28.i, %.preheader.i ], [ %indvars.iv27.i.ph, %.preheader.i.preheader ] ; 2 uses
  %.017.i = phi ptr [ %i.aa, %.preheader.i ], [ %.017.i.ph, %.preheader.i.preheader ] ; 2 uses
  %indvars.iv.next28.i = add nsw i64 %indvars.iv27.i, -1 ; 2 uses
  %i.y = getelementptr inbounds i8, ptr %i.a, i64 %indvars.iv.next28.i
  %i.z = load i8, ptr %i.y, align 1, !tbaa !8
  %i.aa = getelementptr inbounds nuw i8, ptr %.017.i, i64 1 ; 2 uses
  store i8 %i.z, ptr %.017.i, align 1, !tbaa !8
  %i.ab = icmp sgt i64 %indvars.iv27.i, 1
  br i1 %i.ab, label %.preheader.i, label %_Z21ConvertUInt64ToStringyPcj.exit, !llvm.loop !29

_Z21ConvertUInt64ToStringyPcj.exit:               ; preds = %.preheader.i, %vec.epilog.middle.block, %middle.block
  %.lcssa = phi ptr [ %i.u, %vec.epilog.middle.block ], [ %i.n, %middle.block ], [ %i.aa, %.preheader.i ]
  store i8 0, ptr %.lcssa, align 1, !tbaa !8
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #4
  ret void
}
...
bb.d:                                             ; preds = %bb.d, %bb.c
  %indvars.iv12.i = phi i32 [ %indvars.iv.next13.i, %bb.d ], [ 1, %bb.c ] ; 2 uses
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %bb.d ], [ 0, %bb.c ] ; 2 uses
...
.preheader.preheader.i:                           ; preds = %bb.d
  %i.j = sext i32 %indvars.iv12.i to i64          ; 5 uses
  %i.k = tail call i64 @llvm.smin.i64(i64 %i.j, i64 1)
  %2 = sub i64 %i.j, %i.k
  %3 = add i64 %2, 1                              ; 3 uses
  %min.iters.check = icmp ult i64 %3, 8
  br i1 %min.iters.check, label %.preheader.i.preheader, label %vector.ph
