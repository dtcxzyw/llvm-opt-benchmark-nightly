...
._crit_edge.1.1:                                  ; preds = %scalar.ph708, %middle.block718, %.critedge.1.1
...
.lr.ph221.2:                                      ; preds = %.critedge.2
  ...
  %min.iters.check696 = icmp ult i64 %i.ek, 8
  br i1 %min.iters.check696, label %scalar.ph695.preheader, label %vector.ph697

vector.ph697:                                     ; preds = %.lr.ph221.2
  %n.vec699 = and i64 %i.ek, -8                   ; 3 uses
  %i.el = sub nsw i64 %i.ei, %n.vec699
  br label %vector.body700

vector.body700:                                   ; preds = %vector.body700, %vector.ph697
  %index701 = phi i64 [ 0, %vector.ph697 ], [ %index.next704, %vector.body700 ] ; 2 uses
  %i.em = sub i64 %i.ei, %index701
  ...
  %wide.load702 = load <4 x i32>, ptr %i.eo, align 4, !tbaa !4
  %wide.load703 = load <4 x i32>, ptr %i.ep, align 4, !tbaa !4
  %i.eq = getelementptr i8, ptr %i.en, i64 -12
  %i.er = getelementptr i8, ptr %i.en, i64 -28
  store <4 x i32> %wide.load702, ptr %i.eq, align 4, !tbaa !4
  store <4 x i32> %wide.load703, ptr %i.er, align 4, !tbaa !4
  %index.next704 = add nuw i64 %index701, 8       ; 2 uses
  %i.es = icmp eq i64 %index.next704, %n.vec699
  br i1 %i.es, label %middle.block705, label %vector.body700, !llvm.loop !25

middle.block705:                                  ; preds = %vector.body700
  %cmp.n706 = icmp eq i64 %i.ek, %n.vec699
  br i1 %cmp.n706, label %._crit_edge.2, label %scalar.ph695.preheader

scalar.ph695.preheader:                           ; preds = %.lr.ph221.2, %middle.block705
  %indvars.iv322.2.ph = phi i64 [ %i.ei, %.lr.ph221.2 ], [ %i.el, %middle.block705 ]
  br label %scalar.ph695

scalar.ph695:                                     ; preds = %scalar.ph695.preheader, %scalar.ph695
  %indvars.iv322.2 = phi i64 [ %indvars.iv.next323.2, %scalar.ph695 ], [ %indvars.iv322.2.ph, %scalar.ph695.preheader ] ; 2 uses
  ...
  br i1 %i.ew, label %scalar.ph695, label %._crit_edge.2, !llvm.loop !26

._crit_edge.2:                                    ; preds = %scalar.ph695, %middle.block705, %.critedge.2
...
.lr.ph234.us.us.preheader:                        ; preds = %bb.ad
  ...
  %min.iters.check761 = icmp ult i64 %i.hl, 8
  %n.vec764 = and i64 %i.hl, -8                   ; 3 uses
  %i.hm = add nsw i64 %i.hi, %n.vec764
  %cmp.n769 = icmp eq i64 %i.hl, %n.vec764
...
.lr.ph230.us.us.us:                               ; preds = %.lr.ph234.us.us, %._crit_edge231.us.us.us
  ...
  br i1 %min.iters.check761, label %scalar.ph760.preheader, label %vector.ph762

vector.ph762:                                     ; preds = %.lr.ph230.us.us.us
...
vector.body765:                                   ; preds = %vector.body765, %vector.ph762
  %index766 = phi i64 [ 0, %vector.ph762 ], [ %index.next767, %vector.body765 ] ; 2 uses
  %i.hr = getelementptr [4 x i8], ptr %i.hq, i64 %index766 ; 2 uses
  ...
  %index.next767 = add nuw i64 %index766, 8       ; 2 uses
  %i.ht = icmp eq i64 %index.next767, %n.vec764
  br i1 %i.ht, label %middle.block768, label %vector.body765, !llvm.loop !32

middle.block768:                                  ; preds = %vector.body765
  br i1 %cmp.n769, label %._crit_edge231.us.us.us, label %scalar.ph760.preheader

scalar.ph760.preheader:                           ; preds = %.lr.ph230.us.us.us, %middle.block768
  %indvars.iv390.ph = phi i64 [ %i.hi, %.lr.ph230.us.us.us ], [ %i.hm, %middle.block768 ]
  br label %scalar.ph760

scalar.ph760:                                     ; preds = %scalar.ph760.preheader, %scalar.ph760
  %indvars.iv390 = phi i64 [ %indvars.iv.next391, %scalar.ph760 ], [ %indvars.iv390.ph, %scalar.ph760.preheader ] ; 2 uses
  ...
  br i1 %exitcond394.not, label %._crit_edge231.us.us.us, label %scalar.ph760, !llvm.loop !33

._crit_edge231.us.us.us:                          ; preds = %scalar.ph760, %middle.block768
...
.lr.ph280.preheader:                              ; preds = %._crit_edge267.2
  ...
  %min.iters.check772 = icmp ult i32 %i.q, 8
  br i1 %min.iters.check772, label %.lr.ph280.preheader785, label %vector.ph773

vector.ph773:                                     ; preds = %.lr.ph280.preheader
  %n.vec775 = and i64 %wide.trip.count416, 2147483640 ; 3 uses
  br label %vector.body776

vector.body776:                                   ; preds = %vector.body776, %vector.ph773
  %index777 = phi i64 [ 0, %vector.ph773 ], [ %index.next781, %vector.body776 ] ; 2 uses
  %vec.phi = phi <4 x i32> [ zeroinitializer, %vector.ph773 ], [ %i.ic, %vector.body776 ]
  %vec.phi778 = phi <4 x i32> [ zeroinitializer, %vector.ph773 ], [ %i.id, %vector.body776 ]
  %i.hw = getelementptr inbounds nuw [4 x i8], ptr %i.s, i64 %index777 ; 2 uses
  %i.hx = getelementptr inbounds nuw i8, ptr %i.hw, i64 16
  %wide.load779 = load <4 x i32>, ptr %i.hw, align 4, !tbaa !4
  %wide.load780 = load <4 x i32>, ptr %i.hx, align 4, !tbaa !4
  %i.hy = icmp ne <4 x i32> %wide.load779, zeroinitializer
  %i.hz = icmp ne <4 x i32> %wide.load780, zeroinitializer
  %i.ia = zext <4 x i1> %i.hy to <4 x i32>
  %i.ib = zext <4 x i1> %i.hz to <4 x i32>
  %i.ic = add <4 x i32> %vec.phi, %i.ia           ; 2 uses
  %i.id = add <4 x i32> %vec.phi778, %i.ib        ; 2 uses
  %index.next781 = add nuw i64 %index777, 8       ; 2 uses
  %i.ie = icmp eq i64 %index.next781, %n.vec775
  br i1 %i.ie, label %middle.block782, label %vector.body776, !llvm.loop !37

middle.block782:                                  ; preds = %vector.body776
  %bin.rdx = add <4 x i32> %i.id, %i.ic
  %i.if = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx) ; 2 uses
  %cmp.n783 = icmp eq i64 %n.vec775, %wide.trip.count416
  br i1 %cmp.n783, label %._crit_edge281, label %.lr.ph280.preheader785

.lr.ph280.preheader785:                           ; preds = %.lr.ph280.preheader, %middle.block782
  %indvars.iv413.ph = phi i64 [ 0, %.lr.ph280.preheader ], [ %n.vec775, %middle.block782 ]
  %.0177279.ph = phi i32 [ 0, %.lr.ph280.preheader ], [ %i.if, %middle.block782 ]
  br label %.lr.ph280
...
.lr.ph258.us.1.preheader:                         ; preds = %.lr.ph266.split.us.1
  ...
  %lcmp.mod817 = icmp ne i32 %xtraiter, 0
