...
CHrotate.exit:                                    ; preds = %bb.ce, %bb.cd, %bb.cb, %bb.bk, %bb.bj, %bb.bh, %bb.ap, %bb.ao, %bb.am, %bb.x, %bb.w, %bb.u
  ...
  br i1 %.not, label %._crit_edge, label %bb.m, !llvm.loop !28
...
define dso_local void @CHtraverse(ptr nofree noundef readonly captures(address_is_null) %0) local_unnamed_addr #4 {
bb.a:
...
tailrecurse:                                      ; preds = %bb.a, %tailrecurse
  ...
  %i.i = load double, ptr %.tr9, align 8, !tbaa !16
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.s = load i32, ptr %0, align 8, !tbaa !32
  store double %i.o, ptr %i.a, align 8, !tbaa !26
  %.sroa.42.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store double %i.r, ptr %.sroa.42.0..sroa_idx, align 8, !tbaa !26
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store i32 %i.s, ptr %.sroa.5.0..sroa_idx, align 8, !tbaa !7
  %i.t = getelementptr inbounds nuw i8, ptr %i.a, i64 24
  store ptr %0, ptr %i.t, align 8, !tbaa !23
  ret ptr %i.a
}
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = load double, ptr %i.d, align 8, !tbaa !16 ; 2 uses
  %i.f = load double, ptr %i.a, align 8, !tbaa !16 ; 2 uses
...
bb.h:                                             ; preds = %bb.c, %bb.f, %bb.e
  ...
  br i1 %.not40, label %.sink.split, label %8
...
.sink.split:                                      ; preds = %8, %bb.h
  %.sink51 = phi ptr [ %.pre, %8 ], [ %i.d, %bb.h ] ; 2 uses
  %10 = getelementptr inbounds nuw i8, ptr %i.a, i64 40
  store ptr %.sink51, ptr %10, align 8, !tbaa !20
  %i.z = getelementptr inbounds nuw i8, ptr %.sink51, i64 48
  store ptr null, ptr %i.z, align 8, !tbaa !19
  br label %bb.i

bb.i:                                             ; preds = %.sink.split, %4
  %i.aa = load ptr, ptr %0, align 8, !tbaa !22
  %i.ab = getelementptr inbounds nuw i8, ptr %i.aa, i64 32
  store ptr %i.a, ptr %i.ab, align 8, !tbaa !21
  br label %bb.j
...
bb.a:
  ...
  store <2 x double> <double f0x47EFFFFFE0000000, double 1.000000e+03>, ptr %1, align 16, !tbaa !26
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 16
  store i32 1000, ptr %i.a, align 16, !tbaa !27
  %i.b = load ptr, ptr %0, align 8, !tbaa !22
  %.not = icmp eq ptr %i.b, null
...
bb.h:                                             ; preds = %bb.f
  store <2 x double> <double f0x47EFFFFFE0000000, double 1.000000e+03>, ptr %2, align 16, !tbaa !26
  %i.p = getelementptr inbounds nuw i8, ptr %2, i64 16 ; 2 uses
  store i32 1000, ptr %i.p, align 16, !tbaa !27
  ...
  store <2 x double> splat (double -1.000000e+00), ptr %2, align 16, !tbaa !26
  store i32 -1, ptr %i.p, align 16, !tbaa !27
...
!7 = !{!6, !6, i64 0}
!8 = !{!"double", !5, i64 0}
!9 = !{!"key", !8, i64 0, !8, i64 8, !6, i64 16}
!10 = !{!9, !8, i64 0}
!11 = !{!"any pointer", !5, i64 0}
!12 = !{!"p1 _ZTS8CHpoints", !11, i64 0}
!13 = !{!"CHsplay_element", !9, i64 0, !12, i64 24}
!14 = !{!"p1 _ZTS12CHsplay_node", !11, i64 0}
!15 = !{!"CHsplay_node", !13, i64 0, !14, i64 32, !14, i64 40, !14, i64 48}
!16 = !{!15, !8, i64 0}
!17 = !{!15, !8, i64 8}
!18 = !{!15, !6, i64 16}
!19 = !{!15, !14, i64 48}
...
!22 = !{!14, !14, i64 0}
!23 = !{!15, !12, i64 24}
!24 = !{!"point", !6, i64 0, !6, i64 4}
!25 = !{!"CHpoints", !6, i64 0, !24, i64 4, !6, i64 12, !12, i64 16, !12, i64 24}
!26 = !{!8, !8, i64 0}
!27 = !{!9, !6, i64 16}
!28 = distinct !{!28, !29}
