...
bb.w:                                             ; preds = %bb.k
  ...
  %.shift108 = getelementptr inbounds nuw i8, ptr %i.br, i64 1
  %2 = load i8, ptr %.shift108, align 1, !tbaa !53
  %3 = and i8 %2, 31
  %i.bs = zext nneg i8 %3 to i32
...
bb.ab:                                            ; preds = %bb.k
  ...
  %.shift = getelementptr inbounds nuw i8, ptr %i.cq, i64 1
  %4 = load i8, ptr %.shift, align 1, !tbaa !53
  %5 = and i8 %4, 31
  %i.cr = zext nneg i8 %5 to i32
...
bb.af:                                            ; preds = %bb.ae
  ...
  %.shift106 = getelementptr inbounds nuw i8, ptr %i.dk, i64 1
  %6 = load i8, ptr %.shift106, align 1, !tbaa !53
  %7 = and i8 %6, 31
  %i.dl = zext nneg i8 %7 to i32
