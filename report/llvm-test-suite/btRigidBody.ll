...
bb.d:                                             ; preds = %bb.c
  ...
  tail call void @__clang_call_terminate(ptr %i.h) #19, !inline_history !76
  unreachable
...
begin_hunk_3_@_ZN15btTransformUtil22calculateDiffAxisAngleERK11btTransformS2_R9btVector3Rf:bb.a
  ...
  store <2 x float> %i.ci, ptr %4, align 8, !tbaa !29, !alias.scope !81
  %i.cs = getelementptr inbounds nuw i8, ptr %4, i64 8
  store float %i.cl, ptr %i.cs, align 8, !tbaa !29, !alias.scope !81
  %i.ct = getelementptr inbounds nuw i8, ptr %4, i64 12
  store float 0.000000e+00, ptr %i.ct, align 4, !tbaa !29, !alias.scope !81
...
begin_hunk_4_@_ZN15btTransformUtil22calculateDiffAxisAngleERK11btTransformS2_R9btVector3Rf:bb.a
  ...
  store <2 x float> %i.dd, ptr %i.cu, align 8, !tbaa !29, !alias.scope !81
  %i.de = getelementptr inbounds nuw i8, ptr %4, i64 24
  store float %i.co, ptr %i.de, align 8, !tbaa !29, !alias.scope !81
  %i.df = getelementptr inbounds nuw i8, ptr %4, i64 28
  store float 0.000000e+00, ptr %i.df, align 4, !tbaa !29, !alias.scope !81
...
begin_hunk_5_@_ZN15btTransformUtil22calculateDiffAxisAngleERK11btTransformS2_R9btVector3Rf:bb.a
  ...
  store <2 x float> %i.dp, ptr %i.dg, align 8, !tbaa !29, !alias.scope !81
  %i.dq = getelementptr inbounds nuw i8, ptr %4, i64 40
  store float %i.cr, ptr %i.dq, align 8, !tbaa !29, !alias.scope !81
  %i.dr = getelementptr inbounds nuw i8, ptr %4, i64 44
  store float 0.000000e+00, ptr %i.dr, align 4, !tbaa !29, !alias.scope !81
...
!74 = distinct !{!74, !70}
!75 = !{!22, !16, i64 272}
!76 = !{ptr @_ZN11btRigidBodyD2Ev}
!77 = !{!22, !28, i64 208}
!78 = !{!79}
!79 = distinct !{!79, !80, !"_ZNK11btMatrix3x37inverseEv: argument 0"}
!80 = distinct !{!80, !"_ZNK11btMatrix3x37inverseEv"}
!81 = !{!82}
!82 = distinct !{!82, !83, !"_ZmlRK11btMatrix3x3S1_: argument 0"}
