...
.lr.ph3632:                                       ; preds = %bb.u
  ...
  %i.on = load i32, ptr %i.b, align 4             ; 43 uses
  ...
  %11 = zext i32 %i.on to i64                     ; 2 uses
  %12 = add i32 %i.on, -1
  %i.pm = zext i32 %12 to i64
  ...
  %n.vec4689 = and i64 %8, 2147483646             ; 6 uses
  %i.ps = trunc nuw nsw i64 %n.vec4689 to i32
  %cmp.n4705 = icmp eq i64 %n.vec4689, %8
  %min.iters.check4541 = icmp ugt i32 %i.on, 7
  %n.vec4544 = and i64 %7, 2147483646             ; 6 uses
  %i.pt = trunc nuw nsw i64 %n.vec4544 to i32
  %cmp.n4562 = icmp eq i64 %n.vec4544, %7
  %min.iters.check4372 = icmp ugt i32 %i.on, 7
  %n.vec4375 = and i64 %6, 2147483646             ; 6 uses
  %i.pu = trunc nuw nsw i64 %n.vec4375 to i32
  %cmp.n4395 = icmp eq i64 %n.vec4375, %6
  br label %bb.v
