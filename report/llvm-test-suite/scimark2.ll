...
bb.g:                                             ; preds = %bb.e, %bb.f, %bb.a
  ...
  %3 = insertelement <2 x double> %2, double %i.w, i64 1
  %4 = fdiv <2 x double> %3, splat (double 1.000000e+07) ; 2 uses
  %5 = extractelement <2 x double> %4, i64 0
  %i.ag = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, double noundef %5) ; 0 uses
  %6 = extractelement <2 x double> %4, i64 1
  %i.ah = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.7, double noundef %6, i32 noundef %.145) ; 0 uses
  %7 = insertelement <2 x double> poison, double %i.x, i64 0
  %8 = insertelement <2 x double> %7, double %i.y, i64 1
  %9 = fdiv <2 x double> %8, splat (double 1.000000e+07) ; 2 uses
  %10 = extractelement <2 x double> %9, i64 0
  %i.ai = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.8, double noundef %10, i32 noundef %.147, i32 noundef %.147) ; 0 uses
  %11 = extractelement <2 x double> %9, i64 1
  %i.aj = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.9, double noundef %11) ; 0 uses
  %12 = insertelement <2 x double> poison, double %i.z, i64 0
  %13 = insertelement <2 x double> %12, double %i.aa, i64 1
  %14 = fdiv <2 x double> %13, splat (double 1.000000e+07) ; 2 uses
  %15 = extractelement <2 x double> %14, i64 0
  %i.ak = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.10, double noundef %15, i32 noundef %.151, i32 noundef %.149) ; 0 uses
  %16 = extractelement <2 x double> %14, i64 1
  %i.al = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.11, double noundef %16, i32 noundef %.147, i32 noundef %.147) ; 0 uses
