...
bb.f:                                             ; preds = %.lr.ph, %bb.f
  ...
  %i.cl = fmul <2 x float> %i.cc, %i.ck           ; 7 uses
  %i.cm = extractelement <2 x float> %i.cl, i64 0 ; 2 uses
  %i.cn = fmul float %i.cd, %i.ci                 ; 6 uses
  %i.co = fneg float %i.cm                        ; 2 uses
  %i.cp = shufflevector <2 x float> %i.cl, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.cq = insertelement <2 x float> %i.cp, float %i.cn, i64 0 ; 2 uses
  %i.cr = fneg <2 x float> %i.cq
  %i.cs = insertelement <2 x float> %i.cp, float %i.cn, i64 1 ; 2 uses
  %i.ct = fneg <2 x float> %i.cs                  ; 2 uses
  %7 = fmul <2 x float> %i.bq, %i.ct
  %8 = fmul float %i.bh, %i.co
  ...
  %i.cw = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cv, <2 x float> %i.bo, <2 x float> %7)
  %9 = tail call float @llvm.fmuladd.f32(float %i.cb, float %i.bs, float %8)
  %i.cx = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cr, <2 x float> %i.bt, <2 x float> %i.cw)
  %i.cy = extractelement <2 x float> %i.ct, i64 0
  %10 = tail call float @llvm.fmuladd.f32(float %i.cy, float %i.br, float %9)
  %11 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cl, <2 x float> %i.bg, <2 x float> %i.cx) ; 4 uses
  %i.cz = extractelement <2 x float> %11, i64 1   ; 2 uses
  %i.da = tail call float @llvm.fmuladd.f32(float %i.cn, float %i.bb, float %10) ; 4 uses
  %12 = fmul float %i.bs, %i.cm
  %i.db = tail call float @llvm.fmuladd.f32(float %i.cb, float %i.bh, float %12)
  %13 = extractelement <2 x float> %i.cl, i64 1
  %14 = tail call float @llvm.fmuladd.f32(float %13, float %i.bb, float %i.db)
  %i.dc = tail call float @llvm.fmuladd.f32(float %i.cn, float %i.br, float %14)
  %i.dd = extractelement <2 x float> %11, i64 0
  %15 = fneg <2 x float> %11                      ; 2 uses
  %16 = fmul float %i.cb, %i.dd
  %i.de = fmul float %i.cb, %i.da
  %17 = insertelement <2 x float> poison, float %i.dc, i64 0
  %18 = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %19 = insertelement <2 x float> poison, float %i.de, i64 0
  %20 = insertelement <2 x float> %19, float %16, i64 1
  %21 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %18, <2 x float> %i.cl, <2 x float> %20)
  %22 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %11, <2 x float> %i.cq, <2 x float> %21)
  %23 = fneg float %i.da
  %i.df = fneg float %i.cz
  %24 = insertelement <2 x float> poison, float %i.df, i64 0
  %25 = insertelement <2 x float> %24, float %23, i64 1
  %26 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %25, <2 x float> %i.cs, <2 x float> %22)
  %27 = fmul float %i.da, %i.co
  %28 = fmul float %i.cb, %i.cz
  %i.dg = insertelement <2 x float> %i.cv, float %i.cn, i64 0
  %i.dh = insertelement <2 x float> poison, float %28, i64 0
  %i.di = insertelement <2 x float> %i.dh, float %27, i64 1
  %i.dj = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %18, <2 x float> %i.dg, <2 x float> %i.di)
  %i.dk = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %i.dl = insertelement <2 x float> %i.dk, float %i.da, i64 0
  ...
  %i.dp = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %15, <2 x float> %i.do, <2 x float> %i.dn)
