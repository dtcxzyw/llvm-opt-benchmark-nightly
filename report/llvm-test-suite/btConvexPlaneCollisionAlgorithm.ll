...
bb.a:
  ...
  %i.e = select i1 %i.c, ptr %2, ptr %3           ; 11 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.js = load <2 x float>, ptr %i.p, align 8, !tbaa !32 ; 2 uses
  %i.jt = load float, ptr %i.ah, align 4, !tbaa !32 ; 2 uses
  %i.ju = load float, ptr %i.j, align 4, !tbaa !32 ; 2 uses
  %i.jv = load float, ptr %i.is, align 4, !tbaa !32 ; 2 uses
  %i.jw = load <2 x float>, ptr %i.q, align 8, !tbaa !32 ; 2 uses
  %9 = insertelement <2 x float> poison, float %i.jt, i64 0
  %10 = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> zeroinitializer
  %11 = shufflevector <2 x float> %i.js, <2 x float> %i.jw, <2 x i32> <i32 1, i32 3>
  %12 = fmul <2 x float> %10, %11
  %13 = shufflevector <2 x float> %i.js, <2 x float> %i.jw, <2 x i32> <i32 0, i32 2>
  %i.jx = insertelement <2 x float> poison, float %i.ju, i64 0
  %14 = shufflevector <2 x float> %i.jx, <2 x float> poison, <2 x i32> zeroinitializer
  %i.jy = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %13, <2 x float> %14, <2 x float> %12)
