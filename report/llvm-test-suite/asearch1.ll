...
.lr.ph264:                                        ; preds = %.preheader
  ...
  %min.iters.check427 = icmp ult i32 %3, 7
  ...
  %cmp.n405 = icmp eq i64 %6, %n.vec390
  %7 = add i32 %2, -1                             ; 2 uses
  %8 = zext i32 %7 to i64
  %9 = add nuw nsw i64 %8, 1                      ; 2 uses
  %min.iters.check361 = icmp ult i32 %7, 7
  %invariant.op472 = sub i32 -2, %2
  %invariant.op474 = sub i32 -2, %2
  %invariant.op476 = sub i32 -2, %2
  %n.vec364 = and i64 %9, 8589934588              ; 3 uses
  ...
  %cmp.n379 = icmp eq i64 %9, %n.vec364
  ...
  %cmp.n339 = icmp eq i64 %12, %n.vec325
  br label %bb.j
...
vector.scevcheck381:                              ; preds = %.lr.ph239
  ...
  %i.hc = icmp ult i32 %.reass467, %i.bw
  %.reass469 = add i32 %i.gz, %invariant.op468
  %i.hd = icmp ult i32 %.reass469, %i.bw
  %.reass471 = add i32 %i.hb, %invariant.op470
  %i.he = icmp ult i32 %.reass471, %i.bw
