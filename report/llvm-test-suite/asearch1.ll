...
vector.body457:                                   ; preds = %vector.body457, %vector.ph448
  %index458 = phi i64 [ 0, %vector.ph448 ], [ %index.next469, %vector.body457 ] ; 3 uses
  %offset.idx459 = add i64 %index458, %i.bp       ; 2 uses
  %i.ec = trunc i64 %index458 to i32
  %3 = add i32 %i.ap, %i.ec                       ; 3 uses
...
vector.body410:                                   ; preds = %vector.body410, %vector.ph401
  %index411 = phi i64 [ 0, %vector.ph401 ], [ %index.next422, %vector.body410 ] ; 3 uses
  %offset.idx412 = add i64 %index411, %i.bp       ; 2 uses
  %i.id = trunc i64 %index411 to i32
  %4 = add i32 %i.ap, %i.id                       ; 3 uses
...
vector.body378:                                   ; preds = %vector.body378, %vector.ph369
  %index379 = phi i64 [ 0, %vector.ph369 ], [ %index.next390, %vector.body378 ] ; 3 uses
  %offset.idx380 = add i64 %index379, %i.bp       ; 2 uses
  %i.ll = trunc i64 %index379 to i32
  %5 = add i32 %i.ap, %i.ll                       ; 3 uses
...
vector.body332:                                   ; preds = %vector.body332, %vector.ph323
  %index333 = phi i64 [ 0, %vector.ph323 ], [ %index.next343, %vector.body332 ] ; 3 uses
  %offset.idx334 = add i64 %index333, %i.bp       ; 2 uses
  %i.pm = trunc i64 %index333 to i32
  %6 = add i32 %i.ap, %i.pm                       ; 3 uses
