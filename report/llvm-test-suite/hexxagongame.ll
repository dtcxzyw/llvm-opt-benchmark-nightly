...
bb.e:                                             ; preds = %bb.c, %bb.d
  %i.c = tail call noalias noundef nonnull dereferenceable(32) ptr @_Znwm(i64 noundef 32) #11 ; 4 uses
...
.lr.ph.i:                                         ; preds = %bb.b, %.lr.ph.i
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %.08.i, i64 noundef 32) #12
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %.08, i64 noundef 32) #12
...
bb.a:
  ...
  %i.a = tail call noalias noundef nonnull dereferenceable(32) ptr @_Znwm(i64 noundef 32) #11 ; 7 uses
...
bb.b:                                             ; preds = %bb.a
  call void @_ZdlPvm(ptr noundef nonnull %i.a, i64 noundef 32) #12
  br label %bb.c
...
bb.d:                                             ; preds = %bb.b
  %2 = load i64, ptr %i.a, align 16
  %3 = xor i64 %2, 7957692733743195464
  %4 = getelementptr i8, ptr %i.a, i64 5
  %5 = load i64, ptr %4, align 1
  %6 = xor i64 %5, 734419002770485095
  %7 = or i64 %3, %6
  %8 = icmp ne i64 %7, 0
  %9 = zext i1 %8 to i32
...
bb.i:                                             ; preds = %_ZN12HexxagonGame11destroyRestEv.exit.thread, %_ZN12HexxagonGame11destroyRestEv.exit
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %i.s, i64 noundef 32) #12
  br label %bb.j
...
begin_hunk_12
  ...
  %i.x = tail call noalias noundef nonnull dereferenceable(32) ptr @_Znwm(i64 noundef 32) #11 ; 7 uses
...
.lr.ph.i40:                                       ; preds = %_ZN12HexxagonGame4prevEv.exit, %.lr.ph.i40
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %.08.i41, i64 noundef 32) #12
