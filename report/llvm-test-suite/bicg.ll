...
bb.i:                                             ; preds = %bb.i, %kernel_bicg.exit
  ...
  %i.bz = load i64, ptr %i.bw, align 8, !tbaa !8  ; 4 uses
  %i.ca = lshr i64 %i.bz, 56
  %i.cb = trunc nuw i64 %i.ca to i8
  ...
  %6 = insertelement <4 x i64> poison, i64 %i.bz, i64 0
  ...
  %.sroa.0.0.extract.trunc.i.i = trunc i64 %i.bz to i8
  %i.cc = insertelement <8 x i8> poison, i8 %.sroa.0.0.extract.trunc.i.i, i64 0
  %10 = shufflevector <4 x i8> %9, <4 x i8> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %11 = shufflevector <8 x i8> %i.cc, <8 x i8> %10, <8 x i32> <i32 0, i32 8, i32 9, i32 10, i32 11, i32 poison, i32 poison, i32 poison>
  ...
  %i.cd = insertelement <8 x i8> %13, i8 %i.cb, i64 7
...
bb.k:                                             ; preds = %bb.k, %bb.j
  ...
  %i.cn = load i64, ptr %i.ck, align 8, !tbaa !8  ; 4 uses
  %i.co = lshr i64 %i.cn, 56
  %i.cp = trunc nuw i64 %i.co to i8
  %14 = insertelement <2 x i64> poison, i64 %i.cn, i64 0
  ...
  %18 = insertelement <4 x i64> poison, i64 %i.cn, i64 0
  ...
  %.sroa.0.0.extract.trunc.i27.i = trunc i64 %i.cn to i8
  %i.cq = insertelement <8 x i8> poison, i8 %.sroa.0.0.extract.trunc.i27.i, i64 0
  %22 = shufflevector <4 x i8> %21, <4 x i8> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %23 = shufflevector <8 x i8> %i.cq, <8 x i8> %22, <8 x i32> <i32 0, i32 8, i32 9, i32 10, i32 11, i32 poison, i32 poison, i32 poison>
  ...
  %i.cr = insertelement <8 x i8> %25, i8 %i.cp, i64 7
