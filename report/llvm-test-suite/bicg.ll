...
define dso_local noundef i32 @main(i32 noundef %0, ptr noundef readnone captures(none) %1) local_unnamed_addr #7 {
bb.a:
...
bb.i:                                             ; preds = %bb.i, %kernel_bicg.exit
  ...
  %5 = trunc i64 %3 to i8
  %6 = trunc i64 %4 to i8
  %7 = insertelement <2 x i64> poison, i64 %i.bz, i64 0
  %8 = insertelement <2 x i64> %7, i64 %i.ca, i64 1
  ...
  %i.cc = insertelement <8 x i8> %10, i8 %6, i64 2
  %11 = insertelement <8 x i8> %i.cc, i8 %5, i64 3
  ...
  %i.cd = insertelement <8 x i8> %14, i8 %i.cb, i64 7
  %i.ce = and <8 x i8> %i.cd, splat (i8 15)
  %i.cf = or disjoint <8 x i8> %i.ce, splat (i8 48)
  %i.cg = shufflevector <8 x i8> %i.cf, <8 x i8> poison, <16 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3, i32 4, i32 4, i32 5, i32 5, i32 6, i32 6, i32 7, i32 7>
  store <16 x i8> %i.cg, ptr %i.by, align 1, !tbaa !22
...
bb.j:                                             ; preds = %bb.i
  %i.ch = getelementptr inbounds nuw i8, ptr %i.bu, i64 1900
  store i8 0, ptr %i.ch, align 1, !tbaa !22
  %i.ci = load ptr, ptr @stderr, align 8, !tbaa !12
  %i.cj = call i32 @fputs(ptr noundef nonnull %i.bu, ptr noundef %i.ci) #13 ; 0 uses
  br label %bb.k

bb.k:                                             ; preds = %bb.k, %bb.j
  %indvars.iv38.i = phi i64 [ 0, %bb.j ], [ %indvars.iv.next39.i, %bb.k ] ; 3 uses
  %i.ck = getelementptr inbounds nuw [8 x i8], ptr %i.s, i64 %indvars.iv38.i
  %i.cl = shl nuw nsw i64 %indvars.iv38.i, 4
  %i.cm = getelementptr inbounds nuw i8, ptr %i.bu, i64 %i.cl
  %i.cn = load i64, ptr %i.ck, align 8, !tbaa !8  ; 8 uses
  %15 = lshr i64 %i.cn, 56
  %.sroa.0.6.extract.shift.i32.i = lshr i64 %i.cn, 48
  %.sroa.0.5.extract.shift.i30.i = lshr i64 %i.cn, 40
  %.sroa.0.4.extract.shift.i28.i = lshr i64 %i.cn, 32
  %16 = lshr i64 %i.cn, 24
  %17 = lshr i64 %i.cn, 16
  %i.co = lshr i64 %i.cn, 8
  %i.cp = trunc nuw i64 %15 to i8
  ...
  %20 = insertelement <2 x i64> poison, i64 %i.cn, i64 0
  %21 = insertelement <2 x i64> %20, i64 %i.co, i64 1
  %22 = trunc <2 x i64> %21 to <2 x i8>
  %23 = shufflevector <2 x i8> %22, <2 x i8> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.cq = insertelement <8 x i8> %23, i8 %19, i64 2
  %24 = insertelement <8 x i8> %i.cq, i8 %18, i64 3
  %25 = insertelement <8 x i8> %24, i8 %.sroa.0.4.extract.trunc.i29.i, i64 4
  %26 = insertelement <8 x i8> %25, i8 %.sroa.0.5.extract.trunc.i31.i, i64 5
  %27 = insertelement <8 x i8> %26, i8 %.sroa.0.6.extract.trunc.i33.i, i64 6
  %i.cr = insertelement <8 x i8> %27, i8 %i.cp, i64 7
  %i.cs = and <8 x i8> %i.cr, splat (i8 15)
  %i.ct = or disjoint <8 x i8> %i.cs, splat (i8 48)
  %i.cu = shufflevector <8 x i8> %i.ct, <8 x i8> poison, <16 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3, i32 4, i32 4, i32 5, i32 5, i32 6, i32 6, i32 7, i32 7>
  store <16 x i8> %i.cu, ptr %i.cm, align 1, !tbaa !22
...
print_array.exit:                                 ; preds = %bb.k
  %i.cv = getelementptr inbounds nuw i8, ptr %i.bu, i64 2100
  store i8 0, ptr %i.cv, align 1, !tbaa !22
  %i.cw = load ptr, ptr @stderr, align 8, !tbaa !12
  %i.cx = call i32 @fputs(ptr noundef nonnull %i.bu, ptr noundef %i.cw) #13 ; 0 uses
