...
bb.i:                                             ; preds = %bb.i, %kernel_bicg.exit
  ...
  %i.ch = insertelement <8 x i8> %4, i8 %i.cg, i64 2
...
bb.k:                                             ; preds = %bb.k, %bb.j
  ...
  %5 = trunc i64 %i.da to i8
  %.sroa.0.0.extract.trunc.i27.i = trunc i64 %i.cw to i8
  %6 = insertelement <8 x i8> poison, i8 %.sroa.0.0.extract.trunc.i27.i, i64 0
  %7 = insertelement <8 x i8> %6, i8 %5, i64 1
  %i.de = insertelement <8 x i8> %7, i8 %i.dd, i64 2
