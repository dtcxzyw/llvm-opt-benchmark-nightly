...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %scalar.ph ], [ %indvars.iv.ph, %scalar.ph.preheader ] ; 14 uses
  %i.hl = getelementptr inbounds [8 x i8], ptr %i.r, i64 %indvars.iv
  %i.hm = getelementptr inbounds [8 x i8], ptr %i.w, i64 %indvars.iv
  %i.hn = getelementptr inbounds [8 x i8], ptr %i.c, i64 %indvars.iv
  %i.ho = getelementptr inbounds [8 x i8], ptr %i.y, i64 %indvars.iv
  %i.hp = getelementptr inbounds [8 x i8], ptr %i.ab, i64 %indvars.iv
  %i.hq = getelementptr inbounds [8 x i8], ptr %i.ad, i64 %indvars.iv
  %i.hr = getelementptr inbounds [8 x i8], ptr %i.e, i64 %indvars.iv
  %i.hs = getelementptr inbounds [8 x i8], ptr %i.af, i64 %indvars.iv
  %i.ht = getelementptr inbounds [8 x i8], ptr %i.ai, i64 %indvars.iv
  %i.hu = getelementptr inbounds [8 x i8], ptr %i.ak, i64 %indvars.iv
  %i.hv = getelementptr inbounds [8 x i8], ptr %i.g, i64 %indvars.iv
  %i.hw = getelementptr inbounds [8 x i8], ptr %i.am, i64 %indvars.iv
  %i.hx = getelementptr inbounds [8 x i8], ptr %i.i, i64 %indvars.iv
  %i.hy = load <2 x double>, ptr %i.hl, align 8, !tbaa !11 ; 3 uses
  %i.hz = load <2 x double>, ptr %i.hm, align 8, !tbaa !11 ; 2 uses
  %2 = load <2 x double>, ptr %i.ho, align 8, !tbaa !11 ; 4 uses
  ...
  %i.ib = fsub <2 x double> %3, %i.ia             ; 3 uses
  %i.ic = load <2 x double>, ptr %i.hn, align 8, !tbaa !11 ; 3 uses
  %4 = shufflevector <2 x double> %i.hz, <2 x double> %2, <2 x i32> <i32 1, i32 3>
  %i.id = fsub <2 x double> %4, %i.ic             ; 4 uses
  %i.ie = shufflevector <2 x double> %i.id, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %5 = shufflevector <2 x double> %i.hy, <2 x double> %2, <2 x i32> <i32 1, i32 2>
  %i.if = shufflevector <2 x double> %i.ic, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ig = fsub <2 x double> %5, %i.if             ; 3 uses
  %6 = shufflevector <2 x double> %i.ic, <2 x double> %i.hy, <2 x i32> <i32 0, i32 2>
  %7 = fsub <2 x double> %2, %6
  %8 = load <2 x double>, ptr %i.hp, align 8, !tbaa !11 ; 3 uses
  %9 = load <2 x double>, ptr %i.hq, align 8, !tbaa !11 ; 2 uses
  %10 = load <2 x double>, ptr %i.hs, align 8, !tbaa !11 ; 4 uses
  %11 = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.ih = shufflevector <2 x double> %8, <2 x double> %9, <2 x i32> <i32 0, i32 2>
  %i.ii = fsub <2 x double> %11, %i.ih            ; 3 uses
  %i.ij = load <2 x double>, ptr %i.hr, align 8, !tbaa !11 ; 3 uses
  %12 = shufflevector <2 x double> %9, <2 x double> %10, <2 x i32> <i32 1, i32 3>
  %i.ik = fsub <2 x double> %12, %i.ij            ; 5 uses
  %i.il = shufflevector <2 x double> %i.ik, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %13 = shufflevector <2 x double> %8, <2 x double> %10, <2 x i32> <i32 1, i32 2>
  %14 = shufflevector <2 x double> %i.ij, <2 x double> poison, <2 x i32> zeroinitializer
  %15 = fsub <2 x double> %13, %14                ; 3 uses
  %16 = shufflevector <2 x double> %i.ij, <2 x double> %8, <2 x i32> <i32 0, i32 2>
  %17 = fsub <2 x double> %10, %16
  %18 = load <2 x double>, ptr %i.ht, align 8, !tbaa !11 ; 3 uses
  %19 = load <2 x double>, ptr %i.hu, align 8, !tbaa !11 ; 2 uses
  %20 = load <2 x double>, ptr %i.hw, align 8, !tbaa !11 ; 4 uses
  %21 = shufflevector <2 x double> %20, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %22 = shufflevector <2 x double> %18, <2 x double> %19, <2 x i32> <i32 0, i32 2>
  %23 = fsub <2 x double> %21, %22                ; 3 uses
  %i.im = load <2 x double>, ptr %i.hv, align 8, !tbaa !11 ; 3 uses
  %24 = shufflevector <2 x double> %19, <2 x double> %20, <2 x i32> <i32 1, i32 3>
  %i.in = fsub <2 x double> %24, %i.im            ; 3 uses
  %i.io = shufflevector <2 x double> %i.in, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.ip = shufflevector <2 x double> %i.im, <2 x double> %18, <2 x i32> <i32 0, i32 2>
  %i.iq = fsub <2 x double> %20, %i.ip
  %25 = shufflevector <2 x double> %18, <2 x double> %20, <2 x i32> <i32 1, i32 2>
  %26 = shufflevector <2 x double> %i.im, <2 x double> poison, <2 x i32> zeroinitializer
  %27 = fsub <2 x double> %25, %26                ; 3 uses
  %i.ir = fadd <2 x double> %7, %i.ie
  %i.is = fadd <2 x double> %17, %i.il
  %i.it = fadd <2 x double> %i.iq, %i.io
  %i.iu = fneg <2 x double> %15
  %i.iv = fmul <2 x double> %23, %i.iu
  %i.iw = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ii, <2 x double> %27, <2 x double> %i.iv)
  %i.ix = fneg <2 x double> %27
  %i.iy = fmul <2 x double> %i.ib, %i.ix
  %i.iz = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %23, <2 x double> %i.ig, <2 x double> %i.iy)
  %i.ja = fneg <2 x double> %i.ig
  %i.jb = fmul <2 x double> %i.ii, %i.ja
  %i.jc = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ib, <2 x double> %15, <2 x double> %i.jb)
  ...
  %shift238 = shufflevector <2 x double> %i.ib, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop239 = fadd <2 x double> %shift238, %i.ig
  %shift238.a = shufflevector <2 x double> %i.ii, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop239.a = fadd <2 x double> %shift238.a, %15
  %shift241 = shufflevector <2 x double> %23, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop242 = fadd <2 x double> %shift241, %27
  %28 = extractelement <2 x double> %foldExtExtBinop242, i64 0
  ...
  %i.jp = shufflevector <2 x double> %i.jo, <2 x double> %foldExtExtBinop239.a, <2 x i32> <i32 1, i32 2>
  %i.jq = fmul <2 x double> %i.jn, %i.jp
  %i.jr = shufflevector <2 x double> %i.id, <2 x double> %foldExtExtBinop239, <2 x i32> <i32 1, i32 2>
  ...
  %i.jw = call double @llvm.fmuladd.f64(double %28, double %i.ju, double %i.jv)
