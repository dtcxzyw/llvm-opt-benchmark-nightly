...
begin_hunk_1
  ...
  %wide.trip.count = and i64 %i.az, 2147483647    ; 8 uses
  ...
  %i.bc = shl nuw nsw i64 %wide.trip.count, 3     ; 7 uses
  %scevgep332.a = getelementptr i8, ptr %i.c, i64 %i.bc ; 6 uses
  %scevgep339.a = getelementptr i8, ptr %i.q, i64 %i.bc
  %scevgep340.a = getelementptr i8, ptr %i.g, i64 %i.bc
  %scevgep341.a = getelementptr i8, ptr %i.k, i64 %i.bc
  %scevgep342.a = getelementptr i8, ptr %i.o, i64 %i.bc
  %scevgep343.a = getelementptr i8, ptr %i.u, i64 %i.bc
  %scevgep344 = getelementptr i8, ptr %i.m, i64 %i.bc
...
begin_hunk_2
  ...
  %bound1352 = icmp ult ptr %i.o, %scevgep332.a
  ...
  %bound1356 = icmp ult ptr %i.u, %scevgep332.a
  ...
  %bound1360 = icmp ult ptr %i.m, %scevgep332.a
  ...
  %bound0 = icmp ult ptr %i.c, %scevgep339.a
  %bound1 = icmp ult ptr %i.q, %scevgep332.a
