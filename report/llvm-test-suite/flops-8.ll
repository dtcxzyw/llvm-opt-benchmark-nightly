...
bb.b:                                             ; preds = %bb.a, %bb.b
  %.045 = phi double [ 0.000000e+00, %bb.a ], [ %i.ai, %bb.b ]
  %.04144 = phi i64 [ 1, %bb.a ], [ %i.aj, %bb.b ] ; 2 uses
  ...
  %i.z = tail call double @llvm.fmuladd.f64(double %i.t, double %i.y, double %i.k) ; 2 uses
  %i.aa = fmul double %i.z, %i.z
  %i.ab = fmul double %i.s, %i.aa
  %i.ac = tail call double @llvm.fmuladd.f64(double %i.l, double %i.t, double %i.m)
  %i.ad = tail call double @llvm.fmuladd.f64(double %i.ac, double %i.t, double %i.n)
  %i.ae = tail call double @llvm.fmuladd.f64(double %i.ad, double %i.t, double %i.o)
  %i.af = tail call double @llvm.fmuladd.f64(double %i.ae, double %i.t, double %i.p)
  %i.ag = tail call double @llvm.fmuladd.f64(double %i.af, double %i.t, double %i.q)
  %i.ah = tail call double @llvm.fmuladd.f64(double %i.ag, double %i.t, double %i.k)
  %i.ai = tail call double @llvm.fmuladd.f64(double %i.ab, double %i.ah, double %.045) ; 2 uses
  %i.aj = add nuw nsw i64 %.04144, 1              ; 2 uses
  %exitcond.not = icmp eq i64 %i.aj, 156250000
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.ar = fdiv double %i.aq, %i.ao                ; 2 uses
  store double %i.ar, ptr @sa, align 8, !tbaa !8
  store double f0x3FD2AAAAAAAAAAAB, ptr @sb, align 8, !tbaa !8
  %i.as = fadd double %i.ar, f0xBFD2AAAAAAAAAAAB  ; 2 uses
  store double %i.as, ptr @sc, align 8, !tbaa !8
  %i.at = fmul double %i.as, 1.000000e-30
  %i.au = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %i.at, double noundef 0.000000e+00, double noundef 0.000000e+00) ; 0 uses
  ret i32 0
}
