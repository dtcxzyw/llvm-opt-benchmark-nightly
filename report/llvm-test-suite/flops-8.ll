...
bb.b:                                             ; preds = %bb.a, %bb.b
  %.045 = phi double [ 0.000000e+00, %bb.a ], [ %i.af, %bb.b ]
  %.04144 = phi i64 [ 1, %bb.a ], [ %i.ag, %bb.b ] ; 2 uses
  %i.r = uitofp nneg i64 %.04144 to double
  ...
  %i.v = tail call double @llvm.fmuladd.f64(double %i.t, double %i.u, double %i.g)
  %i.w = tail call double @llvm.fmuladd.f64(double %i.t, double %i.v, double %i.h)
  %i.x = tail call double @llvm.fmuladd.f64(double %i.t, double %i.w, double %i.i)
  %i.y = tail call double @llvm.fmuladd.f64(double %i.t, double %i.x, double %i.j)
  %2 = insertelement <2 x double> poison, double %i.t, i64 0
  %3 = shufflevector <2 x double> %2, <2 x double> poison, <2 x i32> zeroinitializer
  %4 = insertelement <2 x double> poison, double %i.y, i64 0
  %5 = insertelement <2 x double> %4, double %i.l, i64 1
  %6 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %3, <2 x double> %5, <2 x double> %1) ; 3 uses
  %foldExtExtBinop = fmul <2 x double> %6, %6
  %7 = extractelement <2 x double> %foldExtExtBinop, i64 0
  %i.z = fmul double %i.s, %7
  %8 = extractelement <2 x double> %6, i64 1
  %i.aa = tail call double @llvm.fmuladd.f64(double %8, double %i.t, double %i.n)
  %i.ab = tail call double @llvm.fmuladd.f64(double %i.aa, double %i.t, double %i.o)
  %i.ac = tail call double @llvm.fmuladd.f64(double %i.ab, double %i.t, double %i.p)
  %i.ad = tail call double @llvm.fmuladd.f64(double %i.ac, double %i.t, double %i.q)
  %i.ae = tail call double @llvm.fmuladd.f64(double %i.ad, double %i.t, double %i.k)
  %i.af = tail call double @llvm.fmuladd.f64(double %i.z, double %i.ae, double %.045) ; 2 uses
  %i.ag = add nuw nsw i64 %.04144, 1              ; 2 uses
  %exitcond.not = icmp eq i64 %i.ag, 156250000
  br i1 %exitcond.not, label %bb.c, label %bb.b, !llvm.loop !10

bb.c:                                             ; preds = %bb.b
  %i.ah = fdiv double %i.a, %i.b                  ; 3 uses
  %i.ai = fmul double %i.ah, %i.ah                ; 12 uses
  %i.aj = tail call double @llvm.fmuladd.f64(double %i.l, double %i.ai, double %i.m)
  %i.ak = tail call double @llvm.fmuladd.f64(double %i.aj, double %i.ai, double %i.n)
  %i.al = tail call double @llvm.fmuladd.f64(double %i.ak, double %i.ai, double %i.o)
  %i.am = tail call double @llvm.fmuladd.f64(double %i.al, double %i.ai, double %i.p)
  %i.an = tail call double @llvm.fmuladd.f64(double %i.am, double %i.ai, double %i.q)
  %i.ao = tail call double @llvm.fmuladd.f64(double %i.an, double %i.ai, double %i.k)
  %i.ap = fmul double %i.ah, %i.ao
  %i.aq = tail call double @llvm.fmuladd.f64(double %i.e, double %i.ai, double %i.f)
  %i.ar = tail call double @llvm.fmuladd.f64(double %i.ai, double %i.aq, double %i.g)
  %i.as = tail call double @llvm.fmuladd.f64(double %i.ai, double %i.ar, double %i.h)
  %i.at = tail call double @llvm.fmuladd.f64(double %i.ai, double %i.as, double %i.i)
  %i.au = tail call double @llvm.fmuladd.f64(double %i.ai, double %i.at, double %i.j)
  %i.av = tail call double @llvm.fmuladd.f64(double %i.ai, double %i.au, double %i.k) ; 2 uses
  %i.aw = fmul double %i.ap, %i.av
  %i.ax = fmul double %i.av, %i.aw
  %i.ay = load double, ptr @two, align 8, !tbaa !8 ; 2 uses
  %i.az = tail call double @llvm.fmuladd.f64(double %i.ay, double %i.af, double %i.ax)
  %i.ba = fmul double %i.d, %i.az
  %i.bb = fdiv double %i.ba, %i.ay                ; 2 uses
  store double %i.bb, ptr @sa, align 8, !tbaa !8
  store double f0x3FD2AAAAAAAAAAAB, ptr @sb, align 8, !tbaa !8
  %i.bc = fadd double %i.bb, f0xBFD2AAAAAAAAAAAB  ; 2 uses
  store double %i.bc, ptr @sc, align 8, !tbaa !8
  %i.bd = fmul double %i.bc, 1.000000e-30
  %i.be = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %i.bd, double noundef 0.000000e+00, double noundef 0.000000e+00) ; 0 uses
  ret i32 0
}
