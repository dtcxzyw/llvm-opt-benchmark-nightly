...
.preheader.us.us.us.preheader:                    ; preds = %.preheader.lr.ph.split.split.us.split.us
  ...
  %n.vec122 = and i64 %i.x, -4                    ; 3 uses
  %i.y = add nsw i64 %n.vec122, 10
  %broadcast.splatinsert123 = insertelement <4 x float> poison, float %i.s, i64 0
  %broadcast.splat124 = shufflevector <4 x float> %broadcast.splatinsert123, <4 x float> poison, <4 x i32> zeroinitializer
  %cmp.n130 = icmp eq i64 %i.x, %n.vec122
...
.preheader.us.us.us:                              ; preds = %.preheader.us.us.us.preheader, %._crit_edge58.split.us.split.us.split.us.us.us.us
  ...
  br i1 %min.iters.check120, label %scalar.ph119.preheader, label %vector.body125

vector.body125:                                   ; preds = %.preheader.us.us.us, %vector.body125
  %index126 = phi i64 [ %index.next128, %vector.body125 ], [ 0, %.preheader.us.us.us ] ; 2 uses
  %i.ab = getelementptr inbounds nuw [4 x i8], ptr %i.aa, i64 %index126
  %i.ac = getelementptr inbounds nuw i8, ptr %i.ab, i64 40 ; 2 uses
  %wide.load127 = load <4 x float>, ptr %i.ac, align 4, !tbaa !24
  %i.ad = fdiv <4 x float> %wide.load127, %broadcast.splat124
  store <4 x float> %i.ad, ptr %i.ac, align 4, !tbaa !24
  %index.next128 = add nuw i64 %index126, 4       ; 2 uses
  %i.ae = icmp eq i64 %index.next128, %n.vec122
  br i1 %i.ae, label %middle.block129, label %vector.body125, !llvm.loop !36

middle.block129:                                  ; preds = %vector.body125
  br i1 %cmp.n130, label %._crit_edge58.split.us.split.us.split.us.us.us.us, label %scalar.ph119.preheader

scalar.ph119.preheader:                           ; preds = %.preheader.us.us.us, %middle.block129
  %indvars.iv96.ph = phi i64 [ 10, %.preheader.us.us.us ], [ %i.y, %middle.block129 ]
...
._crit_edge58.split.us.split.us.split.us.us.us.us: ; preds = %scalar.ph119, %middle.block129
