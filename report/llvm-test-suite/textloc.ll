...
end_hunk_1
begin_hunk_2_@HorzVariance:bb.a
  %i.bs = load i8, ptr %gep119.prol, align 1, !tbaa !20
  %i.bt = uitofp i8 %i.bs to float
  %i.bu = fsub float %i.bt, %i.bq                 ; 2 uses
  %i.bv = tail call float @llvm.fmuladd.f32(float %i.bu, float %i.bu, float %.promoted.us) ; 2 uses
  store float %i.bv, ptr %i.br, align 4, !tbaa !24
  br label %.lr.ph54.us.new

.lr.ph54.us.new:                                  ; preds = %.lr.ph54.us.new, %.lr.ph54.us
  %indvars.iv79 = phi i64 [ %indvars.iv.next80.prol, %.lr.ph54.us ], [ %indvars.iv.next80.1, %.lr.ph54.us.new ] ; 3 uses
  %i.bw = phi float [ %i.bv, %.lr.ph54.us ], [ %i.cf, %.lr.ph54.us.new ]
...
end_hunk_2
begin_hunk_3_@HorzVariance:bb.a
.prol.loopexit:                                   ; preds = %bb.b
  br i1 %i.az, label %.lr.ph54.us, label %.lr.ph.us65.new

._crit_edge55.us:                                 ; preds = %.lr.ph54.us.new
  %i.ck = fdiv float %i.cf, %i.s                  ; 2 uses
