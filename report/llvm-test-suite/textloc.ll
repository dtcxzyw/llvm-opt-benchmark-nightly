...
vector.body126:                                   ; preds = %.preheader.us.us.us, %vector.body126
  ...
  %i.ab = getelementptr [4 x i8], ptr %i.aa, i64 %index127
  %i.ac = getelementptr i8, ptr %i.ab, i64 40     ; 2 uses
...
vector.body:                                      ; preds = %.preheader.us.us, %vector.body
  ...
  %i.ak = getelementptr [4 x i8], ptr %i.aj, i64 %index
  %i.al = getelementptr i8, ptr %i.ak, i64 40     ; 2 uses
