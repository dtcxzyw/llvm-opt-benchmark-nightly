...
bb.i:                                             ; preds = %bb.h, %bb.f, %bb.f
  %i.ar = getelementptr inbounds nuw i8, ptr %i.a, i64 2936
  %i.as = load i32, ptr %i.ar, align 8, !tbaa !45
  %i.at = icmp ne i32 %i.as, 0                    ; 2 uses
  %spec.select186 = select i1 %i.at, i64 3, i64 0
  br label %.thread

.thread:                                          ; preds = %bb.i, %bb.g, %bb.h
  %i.au = phi i1 [ false, %bb.g ], [ %i.at, %bb.i ], [ false, %bb.h ] ; 2 uses
  %14 = phi i64 [ 0, %bb.g ], [ %spec.select186, %bb.i ], [ 0, %bb.h ] ; 2 uses
...
.lr.ph:                                           ; preds = %bb.q
  ...
  %15 = getelementptr inbounds nuw [8 x i8], ptr @computeUniPred, i64 %14
...
bb.r:                                             ; preds = %.lr.ph.split.us
  ...
  %i.ex = load ptr, ptr %16, align 8, !tbaa !8
...
bb.t:                                             ; preds = %.lr.ph.split
  ...
  %i.gh = load ptr, ptr %16, align 8, !tbaa !8
...
.lr.ph196:                                        ; preds = %bb.z
  ...
  %17 = getelementptr inbounds nuw [8 x i8], ptr @computeUniPred, i64 %14
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %i.iu = load ptr, ptr %18, align 8, !tbaa !8
