...
bb.at:                                            ; preds = %bb.as
  %i.fy = invoke noalias noundef nonnull dereferenceable(592) ptr @_Znwm(i64 noundef 592) #13
          to label %bb.au unwind label %bb.ap     ; 13 uses

bb.au:                                            ; preds = %bb.at
  %i.fz = getelementptr inbounds nuw i8, ptr %i.fy, i64 16
  store i32 0, ptr %i.fz, align 4, !tbaa !21
  store <2 x ptr> <ptr getelementptr inbounds nuw inrange(-16, 64) (i8, ptr @_ZTVN7NCrypto6NWzAes10CBaseCoderE, i64 16), ptr getelementptr inbounds nuw inrange(-16, 48) (i8, ptr @_ZTVN7NCrypto6NWzAes10CBaseCoderE, i64 96)>, ptr %i.fy, align 8, !tbaa !18
...
bb.ax:                                            ; preds = %bb.au
  store <2 x ptr> <ptr getelementptr inbounds nuw inrange(-16, 64) (i8, ptr @_ZTVN7NCrypto6NWzAes8CEncoderE, i64 16), ptr getelementptr inbounds nuw inrange(-16, 48) (i8, ptr @_ZTVN7NCrypto6NWzAes8CEncoderE, i64 96)>, ptr %i.fy, align 8, !tbaa !18
...
bb.bh:                                            ; preds = %bb.bg
  %i.hk = invoke noalias noundef nonnull dereferenceable(48) ptr @_Znwm(i64 noundef 48) #13
          to label %bb.bi unwind label %bb.ap     ; 5 uses

bb.bi:                                            ; preds = %bb.bh
  %i.hl = getelementptr inbounds nuw i8, ptr %i.hk, i64 16
  store i32 0, ptr %i.hl, align 4, !tbaa !21
  store <2 x ptr> <ptr getelementptr inbounds nuw inrange(-16, 64) (i8, ptr @_ZTVN7NCrypto4NZip8CEncoderE, i64 16), ptr getelementptr inbounds nuw inrange(-16, 48) (i8, ptr @_ZTVN7NCrypto4NZip8CEncoderE, i64 96)>, ptr %i.hk, align 8, !tbaa !18
...
bb.bz:                                            ; preds = %bb.by
  %i.jg = invoke noalias noundef nonnull dereferenceable(40) ptr @_Znwm(i64 noundef 40) #13
          to label %bb.ca unwind label %bb.ap     ; 6 uses

bb.ca:                                            ; preds = %bb.bz
  %i.jh = getelementptr inbounds nuw i8, ptr %i.jg, i64 16
  store i32 0, ptr %i.jh, align 4, !tbaa !21
  store <2 x ptr> <ptr getelementptr inbounds nuw inrange(-16, 56) (i8, ptr @_ZTVN9NCompress10CCopyCoderE, i64 16), ptr getelementptr inbounds nuw inrange(-16, 48) (i8, ptr @_ZTVN9NCompress10CCopyCoderE, i64 88)>, ptr %i.jg, align 8, !tbaa !18
