...
.preheader109.us.us.preheader:                    ; preds = %.preheader109.lr.ph
  %i.c = add nsw i32 %1, -2
  %i.d = add nsw i32 %0, -2
  %wide.trip.count124 = zext i32 %i.d to i64
  %wide.trip.count = zext i32 %i.c to i64
  br label %.preheader109.us.us

.preheader109.us.us:                              ; preds = %.preheader109.us.us.preheader, %._crit_edge112.split.us.us.us
...
._crit_edge.us.us.us:                             ; preds = %bb.b
  ...
  br i1 %exitcond125.not, label %._crit_edge112.split.us.us.us, label %.preheader.us.us.us, !llvm.loop !10

._crit_edge112.split.us.us.us:                    ; preds = %._crit_edge.us.us.us
  %i.dc = add nuw nsw i32 %.0108113.us.us, 1      ; 2 uses
  %exitcond126.not = icmp eq i32 %i.dc, %4
  br i1 %exitcond126.not, label %._crit_edge, label %.preheader109.us.us, !llvm.loop !11

._crit_edge:                                      ; preds = %._crit_edge112.split.us.us.us, %.preheader109.lr.ph, %bb.a
  ret void
}
