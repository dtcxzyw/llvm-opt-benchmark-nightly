...
.lr.ph:                                           ; preds = %enqueue.exit, %thread-pre-split
  ...
  %i.t = phi ptr [ %i.bc, %thread-pre-split ], [ %i.o, %enqueue.exit ] ; 6 uses
...
bb.h:                                             ; preds = %dequeue.exit, %bb.n
  ...
  store i32 %i.aj, ptr @iCost, align 4, !tbaa !4
  %.not = icmp eq i32 %i.aj, 9999
  br i1 %.not, label %bb.n, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.ak = getelementptr inbounds [8 x i8], ptr @rgnNodes, i64 %i.ah ; 3 uses
  %i.al = load i32, ptr %i.ak, align 8, !tbaa !22 ; 2 uses
  %i.am = icmp eq i32 %i.al, 9999
  %.pre31 = load i32, ptr @iDist, align 4, !tbaa !4
  %.pre38 = add nsw i32 %.pre31, %i.aj            ; 3 uses
  %i.an = icmp sgt i32 %i.al, %.pre38
...
bb.j:                                             ; preds = %._crit_edge37
  ...
  %i.ar = tail call i64 @fwrite(ptr nonnull @.str.1, i64 15, i64 1, ptr %i.aq) #13 ; 0 uses
  tail call void @exit(i32 noundef 1) #14
  unreachable

bb.k:                                             ; preds = %._crit_edge37
  store i32 %storemerge1323, ptr %i.ap, align 8, !tbaa !15
...
bb.l:                                             ; preds = %bb.k
  store ptr %i.ap, ptr @qHead, align 8, !tbaa !13
  br label %enqueue.exit20

.preheader.i17:                                   ; preds = %bb.k, %.preheader.i17
  %.0.i18 = phi ptr [ %i.aw, %.preheader.i17 ], [ %i.ae, %bb.k ] ; 2 uses
  %i.av = getelementptr inbounds nuw i8, ptr %.0.i18, i64 16
  %i.aw = load ptr, ptr %i.av, align 8, !tbaa !19 ; 2 uses
  %.not17.i19 = icmp eq ptr %i.aw, null
  br i1 %.not17.i19, label %bb.m, label %.preheader.i17, !llvm.loop !20

bb.m:                                             ; preds = %.preheader.i17
  %i.ax = getelementptr inbounds nuw i8, ptr %.0.i18, i64 16
  store ptr %i.ap, ptr %i.ax, align 8, !tbaa !19
  br label %enqueue.exit20

enqueue.exit20:                                   ; preds = %bb.l, %bb.m
  %qHead.promoted25 = phi ptr [ %i.ap, %bb.l ], [ %qHead.promoted28, %bb.m ]
  %i.ay = phi ptr [ %i.ap, %bb.l ], [ %i.ae, %bb.m ]
  %i.az = load i32, ptr @g_qCount, align 4, !tbaa !4
  %i.ba = add nsw i32 %i.az, 1                    ; 2 uses
  store i32 %i.ba, ptr @g_qCount, align 4, !tbaa !4
...
bb.n:                                             ; preds = %bb.i, %bb.h, %enqueue.exit20
  ...
  store i32 %i.bd, ptr @i, align 4, !tbaa !4
  %i.be = icmp slt i32 %i.bb, 99
  br i1 %i.be, label %bb.h, label %thread-pre-split, !llvm.loop !23

._crit_edge:                                      ; preds = %thread-pre-split, %enqueue.exit
  %i.bf = sext i32 %1 to i64
  %i.bg = getelementptr inbounds [8 x i8], ptr @rgnNodes, i64 %i.bf
  %i.bh = load i32, ptr %i.bg, align 8, !tbaa !22
  %i.bi = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %i.bh) ; 0 uses
  %i.bj = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4) ; 0 uses
...
.preheader:                                       ; preds = %bb.e, %.preheader
  %.120 = phi i32 [ %i.p, %.preheader ], [ 0, %bb.e ] ; 2 uses
  %.11519 = phi i32 [ %i.q, %.preheader ], [ 50, %bb.e ]
  %i.n = srem i32 %.11519, 100                    ; 2 uses
  %i.o = call i32 @dijkstra(i32 noundef %.120, i32 noundef %i.n) ; 0 uses
  %i.p = add nuw nsw i32 %.120, 1                 ; 2 uses
