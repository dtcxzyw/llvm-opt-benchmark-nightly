...
.lr.ph41.i.preheader.new:                         ; preds = %._crit_edge.i
...
.lr.ph41.i.epil.preheader:                        ; preds = %.preheader.i.preheader.unr-lcssa, %._crit_edge.i
  %.03039.i.epil.init = phi i64 [ 0, %._crit_edge.i ], [ %i.as, %.preheader.i.preheader.unr-lcssa ]
  %.03138.i.epil.init = phi i64 [ 0, %._crit_edge.i ], [ %i.ar, %.preheader.i.preheader.unr-lcssa ]
...
.lr.ph41.preheader.new:                           ; preds = %._crit_edge
  %unroll_iter = and i64 %i.b, 9223372036854775804
  br label %.lr.ph41
...
.lr.ph41.epil.preheader:                          ; preds = %.preheader.lr.ph.unr-lcssa, %._crit_edge
  %.03039.epil.init = phi i64 [ 0, %._crit_edge ], [ %i.ax, %.preheader.lr.ph.unr-lcssa ]
  %.03138.epil.init = phi i64 [ 0, %._crit_edge ], [ %i.aw, %.preheader.lr.ph.unr-lcssa ]
