...
bb.j:                                             ; preds = %.lr.ph422, %bb.j
  ...
  %narrow = select i1 %i.wu, i1 %i.wt, i1 false   ; 2 uses
  %spec.store.select = zext i1 %narrow to i32     ; 2 uses
  %i.wv = xor i32 %.0302420, 1                    ; 3 uses
  %6 = and i32 %i.wv, %spec.store.select
  %7 = uitofp nneg i32 %6 to float
  %i.ww = fmul float %i.wn, %7
  ...
  %14 = uitofp nneg i32 %i.wv to float
  %i.xr = fmul float %i.wn, %14
...
bb.h:                                             ; preds = %bb.f, %bb.g
  ...
  %i.al = icmp eq i8 %i.ak, 45                    ; 2 uses
  %4 = zext i1 %i.al to i32                       ; 2 uses
  ...
  %5 = icmp eq i8 %i.ao, 45                       ; 2 uses
  %6 = zext i1 %5 to i32                          ; 2 uses
  ...
  %..093.us = select i1 %.not99.not.us, i32 0, i32 %.093107.us
  %.not100.us = icmp sgt i32 %i.aq, %.sink
  %7 = and i32 %.094105.us, %.093107.us
  %8 = and i32 %7, %4
  %.0.us = select i1 %.not100.us, i32 0, i32 %8
  %i.ar = xor i32 %.094105.us, 1                  ; 2 uses
  %9 = and i32 %i.ar, %4
  %i.as = xor i32 %.093107.us, 1                  ; 2 uses
  %10 = xor i1 %5, true
  %11 = zext i1 %10 to i32                        ; 2 uses
  %12 = and i32 %9, %11                           ; 2 uses
  %13 = and i32 %12, %i.as
  %14 = xor i1 %i.al, true
  %15 = zext i1 %14 to i32                        ; 2 uses
  %16 = and i32 %i.as, %6                         ; 2 uses
  %17 = and i32 %16, %i.ar
  %18 = and i32 %17, %15
  %19 = add nuw nsw i32 %13, %18
  %20 = and i32 %12, %.093107.us
  %21 = add nuw nsw i32 %19, %20
  %22 = and i32 %.094105.us, %15                  ; 2 uses
  %23 = and i32 %16, %22
  %i.at = add nuw nsw i32 %21, %23
  %24 = and i32 %..093.us, %6
  %25 = and i32 %24, %22
  %26 = and i32 %.0.us, %11
  %i.au = add nuw nsw i32 %i.at, %26
  %i.av = add nuw nsw i32 %i.au, %25
