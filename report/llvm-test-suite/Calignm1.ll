...
bb.r:                                             ; preds = %.lr.ph451, %bb.r
  ...
  %i.acn = getelementptr inbounds [4 x i8], ptr %i.acm, i64 %i.ach
  %i.aco = load float, ptr %i.acn, align 4, !tbaa !74
  %i.acp = fadd float %i.acj, %i.aco
  %i.acq = getelementptr inbounds [4 x i8], ptr %i.uw, i64 %i.ach
...
bb.s:                                             ; preds = %.lr.ph464.preheader, %._crit_edge465
  ...
  %i.afl = getelementptr inbounds [8 x i8], ptr %i.abe, i64 %i.afk
  %i.afm = getelementptr inbounds [8 x i8], ptr %i.abf, i64 %i.afk ; 3 uses
...
bb.u:                                             ; preds = %bb.s
  ...
  %6 = sext i32 %i.aha to i64
  %7 = sub nsw i64 %indvars.iv602, %6
  %i.ahb = getelementptr [4 x i8], ptr %i.agz, i64 %7
...
bb.y:                                             ; preds = %bb.x, %bb.w
  ...
  %i.ahv = trunc nuw nsw i64 %indvars.iv602 to i32 ; 2 uses
...
bb.ac:                                            ; preds = %bb.ab
  ...
  %8 = sext i32 %i.akb to i64
  %9 = sub nsw i64 %indvars.iv602, %8
  %i.akc = getelementptr [4 x i8], ptr %i.ajz, i64 %9
