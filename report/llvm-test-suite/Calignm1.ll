...
bb.j:                                             ; preds = %.lr.ph422, %bb.j
  ...
  %i.xa = load ptr, ptr %i.wz, align 8, !tbaa !65 ; 3 uses
  %i.xb = load ptr, ptr %i.xa, align 8, !tbaa !70 ; 4 uses
  %i.xc = load float, ptr %i.xb, align 4, !tbaa !74
  %i.xd = tail call float @llvm.fmuladd.f32(float %i.wy, float %i.wb, float %i.xc)
  store float %i.xd, ptr %i.xb, align 4, !tbaa !74
  %i.xe = getelementptr inbounds nuw i8, ptr %i.xa, i64 8
  %i.xf = load ptr, ptr %i.xe, align 8, !tbaa !70 ; 3 uses
  %i.xg = load float, ptr %i.xf, align 4, !tbaa !74
  %i.xh = tail call float @llvm.fmuladd.f32(float %i.wq, float %i.wb, float %i.xg)
  store float %i.xh, ptr %i.xf, align 4, !tbaa !74
  %i.xi = getelementptr inbounds nuw i8, ptr %i.xa, i64 16
  %i.xj = load ptr, ptr %i.xi, align 8, !tbaa !70 ; 3 uses
  %i.xk = load float, ptr %i.xj, align 4, !tbaa !74
  %i.xl = tail call float @llvm.fmuladd.f32(float %i.wq, float %i.wb, float %i.xk)
  store float %i.xl, ptr %i.xj, align 4, !tbaa !74
  ...
  %i.xr = load float, ptr %i.xq, align 4, !tbaa !74
  %i.xs = tail call float @llvm.fmuladd.f32(float %i.xp, float %i.wb, float %i.xr)
  store float %i.xs, ptr %i.xq, align 4, !tbaa !74
  ...
  br i1 %exitcond541.not, label %._crit_edge423, label %bb.j, !llvm.loop !42
...
._crit_edge423:                                   ; preds = %bb.j
  ...
  br i1 %exitcond546.not, label %.preheader378, label %.lr.ph422, !llvm.loop !43
...
.preheader377:                                    ; preds = %.preheader377, %.preheader377.lr.ph.new
  ...
  %i.yg = load ptr, ptr %i.yf, align 8, !tbaa !70
  %i.yh = getelementptr inbounds nuw [8 x i8], ptr %.pre626.pre.pre669, i64 %indvar
  %i.yi = load ptr, ptr %i.yh, align 8, !tbaa !70
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %i.yg, i8 0, i64 %i.ye, i1 false), !tbaa !74
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %i.yi, i8 0, i64 %i.ye, i1 false), !tbaa !74
  ...
  %i.ym = load ptr, ptr %i.yl, align 8, !tbaa !70
  %i.yn = getelementptr inbounds nuw [8 x i8], ptr %.pre626.pre.pre669, i64 %indvar.next
  %i.yo = load ptr, ptr %i.yn, align 8, !tbaa !70
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %i.ym, i8 0, i64 %i.yk, i1 false), !tbaa !74
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %i.yo, i8 0, i64 %i.yk, i1 false), !tbaa !74
  ...
  br i1 %niter818.ncmp.1, label %.preheader376.loopexit.unr-lcssa, label %.preheader377, !llvm.loop !44
...
.preheader377.epil.preheader:                     ; preds = %.preheader376.loopexit.unr-lcssa, %.preheader377.lr.ph
  ...
  %i.ys = load ptr, ptr %i.yr, align 8, !tbaa !70
  %i.yt = getelementptr inbounds nuw [8 x i8], ptr %.pre626.pre.pre669, i64 %indvar.epil.init
  %i.yu = load ptr, ptr %i.yt, align 8, !tbaa !70
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %i.ys, i8 0, i64 %i.yq, i1 false), !tbaa !74
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %i.yu, i8 0, i64 %i.yq, i1 false), !tbaa !74
...
bb.p:                                             ; preds = %bb.p, %.lr.ph441.new
  ...
  %i.aam = load float, ptr %i.aal, align 4, !tbaa !74
  %i.aan = fadd float %i.aaj, %i.aam              ; 2 uses
  store float %i.aan, ptr %i.aal, align 4, !tbaa !74
  ...
  %i.aaq = load float, ptr %i.aap, align 4, !tbaa !74
  %i.aar = fadd float %i.aan, %i.aaq              ; 2 uses
  store float %i.aar, ptr %i.aap, align 4, !tbaa !74
  ...
  %i.aau = load float, ptr %i.aat, align 4, !tbaa !74
  %i.aav = fadd float %i.aar, %i.aau              ; 2 uses
  store float %i.aav, ptr %i.aat, align 4, !tbaa !74
  ...
  %i.aax = load float, ptr %i.aaw, align 4, !tbaa !74
  %i.aay = fadd float %i.aav, %i.aax              ; 3 uses
  store float %i.aay, ptr %i.aaw, align 4, !tbaa !74
...
bb.q:                                             ; preds = %.lr.ph443, %bb.q
  ...
  %i.aba = load float, ptr %i.aaz, align 4, !tbaa !74
  %i.abb = fadd float %store_forwarded, %i.aba    ; 2 uses
  store float %i.abb, ptr %i.aaz, align 4, !tbaa !74
  %indvars.iv.next573 = add nsw i64 %indvars.iv572, -1
  %i.abc = icmp sgt i64 %indvars.iv572, 1
  br i1 %i.abc, label %bb.q, label %._crit_edge444, !llvm.loop !49
...
._crit_edge447:                                   ; preds = %._crit_edge444, %.lr.ph438, %.preheader375
  %i.abd = load ptr, ptr @Calignm1.v, align 8, !tbaa !65 ; 11 uses
  store ptr %i.abd, ptr @Calignm1.w, align 8, !tbaa !65
  %i.abe = load ptr, ptr @Calignm1.g, align 8, !tbaa !68 ; 6 uses
  %i.abf = load ptr, ptr %i.abe, align 8, !tbaa !65
  %i.abg = load ptr, ptr %i.abf, align 8, !tbaa !70 ; 2 uses
  %i.abh = load float, ptr %i.abg, align 4, !tbaa !74
  %i.abi = load ptr, ptr %i.abd, align 8, !tbaa !70 ; 8 uses
  ...
  %i.abm = load float, ptr %i.abl, align 4, !tbaa !74
  %i.abn = getelementptr inbounds nuw i8, ptr %i.abe, i64 8
  %i.abo = load ptr, ptr %i.abn, align 8, !tbaa !65
  %i.abp = getelementptr inbounds nuw i8, ptr %i.abo, i64 8
  %i.abq = load ptr, ptr %i.abp, align 8, !tbaa !70 ; 2 uses
  %i.abr = load float, ptr %i.abq, align 4, !tbaa !74
  %i.abs = fadd float %i.abm, %i.abr
  %i.abt = getelementptr inbounds nuw i8, ptr %.pre626.pre.pre670, i64 8
  %i.abu = load ptr, ptr %i.abt, align 8, !tbaa !70
  %i.abv = getelementptr inbounds nuw i8, ptr %i.abu, i64 8
  %i.abw = load float, ptr %i.abv, align 4, !tbaa !74
  %i.abx = fadd float %i.abs, %i.abw
  %i.aby = load float, ptr %i.uw, align 4, !tbaa !74
  %i.abz = fadd float %i.abx, %i.aby
  %i.aca = getelementptr inbounds nuw i8, ptr %i.abd, i64 8
  %i.acb = load ptr, ptr %i.aca, align 8, !tbaa !70 ; 2 uses
  %i.acc = load float, ptr %i.acb, align 4, !tbaa !74
  %i.acd = fadd float %i.abz, %i.acc
  store float %i.acd, ptr %i.acb, align 4, !tbaa !74
  br i1 %i.fd, label %.lr.ph451, label %._crit_edge452

.lr.ph451:                                        ; preds = %._crit_edge447
  %i.ace = load ptr, ptr @Calignm1.gl, align 8, !tbaa !65
...
bb.r:                                             ; preds = %.lr.ph451, %bb.r
  ...
  %i.acy = load ptr, ptr %i.acx, align 8, !tbaa !65
  %i.acz = getelementptr inbounds nuw i8, ptr %i.acy, i64 8
  %i.ada = load ptr, ptr %i.acz, align 8, !tbaa !70 ; 2 uses
  %i.adb = load float, ptr %i.ada, align 4, !tbaa !74
  %i.adc = fadd float %i.acw, %i.adb
  %i.add = getelementptr inbounds nuw [8 x i8], ptr %.pre626.pre.pre670, i64 %indvars.iv582
  %i.ade = load ptr, ptr %i.add, align 8, !tbaa !70
  ...
  %i.adg = load float, ptr %i.adf, align 4, !tbaa !74
  %i.adh = fadd float %i.adc, %i.adg
  %i.adi = getelementptr inbounds nuw [8 x i8], ptr %i.abd, i64 %indvars.iv582
  %i.adj = load ptr, ptr %i.adi, align 8, !tbaa !70 ; 2 uses
  %i.adk = load float, ptr %i.adj, align 4, !tbaa !74
  %i.adl = fadd float %i.adh, %i.adk
  store float %i.adl, ptr %i.adj, align 4, !tbaa !74
...
._crit_edge452:                                   ; preds = %bb.r, %._crit_edge447
  %i.adm = load i32, ptr @penalty, align 4, !tbaa !7
  %i.adn = sitofp i32 %i.adm to float             ; 4 uses
  %i.ado = load i32, ptr getelementptr inbounds nuw (i8, ptr @n_dis, i64 2496), align 16, !tbaa !7
  ...
  %i.adt = load float, ptr %i.ads, align 4, !tbaa !74
  %i.adu = fadd float %i.adt, %i.adr
  store float %i.adu, ptr %i.ads, align 4, !tbaa !74
...
.lr.ph457.epil.preheader:                         ; preds = %.lr.ph460.loopexit.unr-lcssa, %.lr.ph457.preheader
  ...
  %i.aeb = load float, ptr %i.aea, align 4, !tbaa !74
  %i.aec = fadd float %i.adz, %i.aeb
  store float %i.aec, ptr %i.aea, align 4, !tbaa !74
  br label %.lr.ph460

.lr.ph460:                                        ; preds = %.lr.ph457.epil.preheader, %.lr.ph460.loopexit.unr-lcssa, %.preheader372
  %i.aed = load ptr, ptr @Calignm1.m, align 8, !tbaa !70
  %i.aee = load ptr, ptr @Calignm1.mp, align 8, !tbaa !15
  %i.aef = shl i64 %i.ai, 2
  %i.aeg = add nuw nsw i64 %i.aef, 4
  %i.aeh = and i64 %i.aeg, 17179869180            ; 2 uses
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.aed, i8 0, i64 %i.aeh, i1 false), !tbaa !74
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.aee, i8 0, i64 %i.aeh, i1 false), !tbaa !7
...
.lr.ph457:                                        ; preds = %.lr.ph457, %.lr.ph457.preheader.new
  ...
  %i.ael = load float, ptr %i.aek, align 4, !tbaa !74
  %i.aem = fadd float %i.aej, %i.ael
  store float %i.aem, ptr %i.aek, align 4, !tbaa !74
  ...
  %i.aer = load float, ptr %i.aeq, align 4, !tbaa !74
  %i.aes = fadd float %i.aeo, %i.aer
  store float %i.aes, ptr %i.aeq, align 4, !tbaa !74
