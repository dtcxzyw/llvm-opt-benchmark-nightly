...
polybench_alloc_data.exit:                        ; preds = %bb.a
  ...
  %i.l = load ptr, ptr %i.b, align 8, !tbaa !11   ; 8 uses
...
polybench_alloc_data.exit22:                      ; preds = %polybench_alloc_data.exit
  ...
  %i.s = load ptr, ptr %i.a, align 8, !tbaa !11   ; 10 uses
...
vector.body87:                                    ; preds = %vector.body87, %vector.ph84
  ...
  store <2 x double> %i.ao, ptr %i.ap, align 8, !tbaa !9
  ...
  br i1 %i.ar, label %middle.block92, label %vector.body87, !llvm.loop !16
...
scalar.ph:                                        ; preds = %.preheader.i, %scalar.ph
  ...
  store double %i.ax, ptr %i.az, align 8, !tbaa !9
  %indvars.iv.next46.i = add nuw nsw i64 %indvars.iv45.i, 1 ; 2 uses
  %exitcond48.not.i = icmp eq i64 %indvars.iv.next46.i, 1200
  br i1 %exitcond48.not.i, label %middle.block92, label %scalar.ph, !llvm.loop !17
...
.preheader29.i:                                   ; preds = %.preheader29.i.preheader, %bb.e
  ...
  %i.bd = mul nuw nsw i64 %indvars.iv48.i, 8000
  %2 = getelementptr i8, ptr %i.s, i64 %i.bd
  %scevgep94 = getelementptr i8, ptr %2, i64 8000
...
vector.body111:                                   ; preds = %vector.body111, %vector.ph109
  ...
  %wide.load113 = load <2 x double>, ptr %i.bf, align 8, !tbaa !9
  %wide.load114 = load <2 x double>, ptr %i.bg, align 8, !tbaa !9
  %i.bh = fmul <2 x double> %wide.load113, splat (double 1.200000e+00)
  %i.bi = fmul <2 x double> %wide.load114, splat (double 1.200000e+00)
  store <2 x double> %i.bh, ptr %i.bf, align 8, !tbaa !9
  ...
  br i1 %i.bj, label %middle.block116, label %vector.body111, !llvm.loop !19
...
scalar.ph107:                                     ; preds = %scalar.ph107.preheader, %scalar.ph107
  ...
  %i.bw = load double, ptr %i.bv, align 8, !tbaa !9
  %i.bx = fmul double %i.bw, 1.200000e+00
  store double %i.bx, ptr %i.bv, align 8, !tbaa !9
  ...
  br i1 %exitcond.not.i27, label %.preheader28.i, label %scalar.ph107, !llvm.loop !20
...
vector.ph99:                                      ; preds = %.preheader.i28
  %i.bz = load double, ptr %i.by, align 8, !tbaa !9, !alias.scope !46
...
vector.body100:                                   ; preds = %vector.body100, %vector.ph99
  ...
  %i.ci = load double, ptr %i.cb, align 8, !tbaa !9, !alias.scope !47
  %i.cj = load double, ptr %i.cd, align 8, !tbaa !9, !alias.scope !47
  %i.ck = insertelement <2 x double> poison, double %i.ci, i64 0
  %i.cl = insertelement <2 x double> %i.ck, double %i.cj, i64 1
  %i.cm = load double, ptr %i.cf, align 8, !tbaa !9, !alias.scope !47
  %i.cn = load double, ptr %i.ch, align 8, !tbaa !9, !alias.scope !47
  ...
  %wide.load = load <2 x double>, ptr %i.cq, align 8, !tbaa !9, !alias.scope !48, !noalias !49
  %wide.load102 = load <2 x double>, ptr %i.cr, align 8, !tbaa !9, !alias.scope !48, !noalias !49
  ...
  store <2 x double> %i.cs, ptr %i.cq, align 8, !tbaa !9, !alias.scope !48, !noalias !49
  store <2 x double> %i.ct, ptr %i.cr, align 8, !tbaa !9, !alias.scope !48, !noalias !49
  %index.next105 = add nuw i64 %index101, 4       ; 2 uses
  %i.cu = icmp eq i64 %index.next105, %n.vec
  br i1 %i.cu, label %middle.block106, label %vector.body100, !llvm.loop !25
...
scalar.ph98.prol:                                 ; preds = %scalar.ph98.preheader
  %i.cv = load double, ptr %i.by, align 8, !tbaa !9
  ...
  %i.cx = load double, ptr %gep.i.prol, align 8, !tbaa !9
...
scalar.ph98:                                      ; preds = %scalar.ph98.prol.loopexit, %scalar.ph98
  ...
  %i.di = load double, ptr %i.by, align 8, !tbaa !9
  ...
  %i.dk = load double, ptr %gep.i.1, align 8, !tbaa !9
  ...
  br i1 %exitcond41.not.i.1, label %.loopexit155, label %scalar.ph98, !llvm.loop !26
...
.loopexit155:                                     ; preds = %scalar.ph98.prol.loopexit, %scalar.ph98, %middle.block106
  ...
  br i1 %exitcond45.not.i, label %bb.e, label %.preheader.i28, !llvm.loop !27
...
bb.e:                                             ; preds = %.loopexit155
  ...
  br i1 %exitcond53.not.i, label %.preheader29.i29, label %.preheader29.i, !llvm.loop !28

.preheader29.i29:                                 ; preds = %bb.e, %bb.f
  %indvars.iv48.i30 = phi i64 [ %indvars.iv.next49.i45, %bb.f ], [ 0, %bb.e ] ; 6 uses
  ...
  %i.dq = mul nuw nsw i64 %indvars.iv48.i30, 8000
  %3 = getelementptr i8, ptr %i.s, i64 %i.dq
  %scevgep121 = getelementptr i8, ptr %3, i64 8000
...
vector.body147:                                   ; preds = %vector.body147, %vector.ph145
  ...
  %wide.load149 = load <2 x double>, ptr %i.ds, align 8, !tbaa !9
  %wide.load150 = load <2 x double>, ptr %i.dt, align 8, !tbaa !9
  %i.du = fmul <2 x double> %wide.load149, splat (double 1.200000e+00)
  %i.dv = fmul <2 x double> %wide.load150, splat (double 1.200000e+00)
  store <2 x double> %i.du, ptr %i.ds, align 8, !tbaa !9
  store <2 x double> %i.dv, ptr %i.dt, align 8, !tbaa !9
  %index.next151 = add nuw i64 %index148, 4       ; 2 uses
  %i.dw = icmp eq i64 %index.next151, %n.vec146
  br i1 %i.dw, label %middle.block152, label %vector.body147, !llvm.loop !29
...
scalar.ph143:                                     ; preds = %scalar.ph143.preheader, %scalar.ph143
  ...
  store double %i.ek, ptr %i.ei, align 8, !tbaa !9
  ...
  br i1 %exitcond.not.i34, label %.preheader28.i35, label %scalar.ph143, !llvm.loop !30
...
vector.ph131:                                     ; preds = %.preheader.i36
  %i.em = load double, ptr %i.el, align 8, !tbaa !9, !alias.scope !50
...
vector.body133:                                   ; preds = %vector.body133, %vector.ph131
  ...
  %i.ev = load double, ptr %i.eo, align 8, !tbaa !9, !alias.scope !51
  %i.ew = load double, ptr %i.eq, align 8, !tbaa !9, !alias.scope !51
  %i.ex = insertelement <2 x double> poison, double %i.ev, i64 0
  %i.ey = insertelement <2 x double> %i.ex, double %i.ew, i64 1
  %i.ez = load double, ptr %i.es, align 8, !tbaa !9, !alias.scope !51
  %i.fa = load double, ptr %i.eu, align 8, !tbaa !9, !alias.scope !51
  ...
  %wide.load137 = load <2 x double>, ptr %i.ff, align 8, !tbaa !9, !alias.scope !52, !noalias !53
  %wide.load138 = load <2 x double>, ptr %i.fg, align 8, !tbaa !9, !alias.scope !52, !noalias !53
  %i.fh = fadd <2 x double> %wide.load137, %i.fd
  %i.fi = fadd <2 x double> %wide.load138, %i.fe
  store <2 x double> %i.fh, ptr %i.ff, align 8, !tbaa !9, !alias.scope !52, !noalias !53
  store <2 x double> %i.fi, ptr %i.fg, align 8, !tbaa !9, !alias.scope !52, !noalias !53
  %index.next139 = add nuw i64 %index134, 4       ; 2 uses
  %i.fj = icmp eq i64 %index.next139, %n.vec132
  br i1 %i.fj, label %middle.block140, label %vector.body133, !llvm.loop !35
...
scalar.ph129.prol:                                ; preds = %scalar.ph129.preheader
  %i.fk = load double, ptr %i.el, align 8, !tbaa !9
  ...
  %i.fm = load double, ptr %gep.i40.prol, align 8, !tbaa !9
  ...
  store double %i.fq, ptr %i.fo, align 8, !tbaa !9
...
scalar.ph129:                                     ; preds = %scalar.ph129.prol.loopexit, %scalar.ph129
  ...
  %i.fs = load double, ptr %i.el, align 8, !tbaa !9
  ...
  %i.fu = load double, ptr %gep.i40, align 8, !tbaa !9
  ...
  %i.fz = load double, ptr %i.el, align 8, !tbaa !9
  ...
  %i.gb = load double, ptr %gep.i40.1, align 8, !tbaa !9
  ...
  br i1 %exitcond41.not.i42.1, label %.loopexit, label %scalar.ph129, !llvm.loop !36
...
.loopexit:                                        ; preds = %scalar.ph129.prol.loopexit, %scalar.ph129, %middle.block140
  ...
  br i1 %exitcond45.not.i44, label %bb.f, label %.preheader.i36, !llvm.loop !37
...
bb.f:                                             ; preds = %.loopexit
  ...
  br i1 %exitcond53.not.i47, label %.preheader.i48, label %.preheader29.i29, !llvm.loop !38
...
bb.g:                                             ; preds = %.critedge.i.2, %.preheader.i48
  ...
  %i.gj = load double, ptr %i.gi, align 8, !tbaa !9 ; 2 uses
  %i.gk = getelementptr inbounds nuw [8 x i8], ptr %i.gh, i64 %indvars.iv.i49
  %i.gl = load double, ptr %i.gk, align 8, !tbaa !9 ; 2 uses
...
check_FP.exit.thread:                             ; preds = %.critedge.i.1, %.critedge.i, %bb.g
  ...
  %i.gr = load ptr, ptr @stderr, align 8, !tbaa !13
...
.critedge.i:                                      ; preds = %bb.g
  ...
  %i.gu = load double, ptr %i.gt, align 8, !tbaa !9 ; 2 uses
  %i.gv = getelementptr inbounds nuw [8 x i8], ptr %i.gh, i64 %indvars.iv.next.i50
  %i.gw = load double, ptr %i.gv, align 8, !tbaa !9 ; 2 uses
end_hunk_0
