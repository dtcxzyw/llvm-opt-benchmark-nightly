...
bb.b:                                             ; preds = %bb.e, %.lver.check
  %indvars.iv.i.lver.orig = phi i64 [ 0, %.lver.check ], [ %indvars.iv.next.pre-phi.i.lver.orig, %bb.e ] ; 15 uses
  %i.ak = sub nuw nsw i64 4, %indvars.iv.i.lver.orig
  %i.al = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %i.ak
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %i.cp = sub nuw nsw i64 3, %indvars.iv.i.lver.orig
  ...
  %i.ct = load i32, ptr %i.b, align 16, !tbaa !4  ; 8 uses
  ...
  %i.cz = sub nuw nsw i64 1, %indvars.iv.i.lver.orig
  %i.da = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %i.cz
  %i.db = load i32, ptr %i.da, align 4, !tbaa !4  ; 2 uses
  %i.dc = and i32 %i.db, %i.ct
  %i.dd = sub nuw nsw i64 2, %indvars.iv.i.lver.orig
  %i.de = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %i.dd
