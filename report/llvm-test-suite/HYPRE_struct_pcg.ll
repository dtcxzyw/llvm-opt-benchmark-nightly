...
bb.h:                                             ; preds = %bb.f, %bb.g
  ...
  %i.dq = load i32, ptr %i.b, align 4, !tbaa !4   ; 7 uses
  %i.dr = load i32, ptr %i.s, align 4, !tbaa !4   ; 3 uses
...
.preheader283.us.us:                              ; preds = %.preheader283.us.us.preheader, %._crit_edge295.split.us.us.us
  %.0238308.us.us = phi i32 [ %i.gq, %._crit_edge295.split.us.us.us ], [ %i.cy, %.preheader283.us.us.preheader ] ; 3 uses
  %.0240307.us.us = phi i32 [ %i.gp, %._crit_edge295.split.us.us.us ], [ %i.eq, %.preheader283.us.us.preheader ] ; 3 uses
  %.0243306.us.us = phi i32 [ %i.go, %._crit_edge295.split.us.us.us ], [ %i.bz, %.preheader283.us.us.preheader ] ; 3 uses
  %.1255305.us.us = phi i32 [ %i.gn, %._crit_edge295.split.us.us.us ], [ 0, %.preheader283.us.us.preheader ]
  br label %.preheader.us.us.us

.preheader.us.us.us:                              ; preds = %._crit_edge.us.us.us, %.preheader283.us.us
  %.1239294.us.us.us = phi i32 [ %i.gm, %._crit_edge.us.us.us ], [ %.0238308.us.us, %.preheader283.us.us ] ; 2 uses
  %.1241293.us.us.us = phi i32 [ %i.gl, %._crit_edge.us.us.us ], [ %.0240307.us.us, %.preheader283.us.us ] ; 2 uses
  %.1244292.us.us.us = phi i32 [ %i.gk, %._crit_edge.us.us.us ], [ %.0243306.us.us, %.preheader283.us.us ] ; 2 uses
  %.1253291.us.us.us = phi i32 [ %i.gj, %._crit_edge.us.us.us ], [ 0, %.preheader283.us.us ] ; 4 uses
  %i.ew = sext i32 %.1244292.us.us.us to i64      ; 4 uses
  %i.ex = sext i32 %.1241293.us.us.us to i64      ; 4 uses
  %i.ey = sext i32 %.1239294.us.us.us to i64      ; 4 uses
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %.preheader.us.us.us
  %4 = mul i32 %i.ea, %.1253291.us.us.us
  %5 = add i32 %.0243306.us.us, %4
  %6 = sext i32 %5 to i64
  %7 = shl nsw i64 %6, 3
  %8 = mul i32 %i.dz, %.1253291.us.us.us
  %9 = add i32 %.0238308.us.us, %8
  %10 = sext i32 %9 to i64
  %i.ez = shl nsw i64 %10, 3                      ; 2 uses
  %11 = add i64 %i.et, %i.ez
  %i.fa = add i64 %7, %i.ah
  %i.fb = add i64 %i.es, %i.ez
  %12 = mul i32 %i.dy, %.1253291.us.us.us
  %13 = add i32 %.0240307.us.us, %12
  %14 = sext i32 %13 to i64
  %15 = add nsw i64 %i.au, %14
  %i.fc = shl nsw i64 %15, 3
  %i.fd = add i64 %i.fc, %i.aq
  %16 = sub i64 %i.fd, %i.fb
  %diff.check = icmp ugt i64 %16, -16
  %i.fe = sub i64 %i.fa, %11
  %diff.check358 = icmp ugt i64 %i.fe, -16
  %conflict.rdx = or i1 %diff.check, %diff.check358
  br i1 %conflict.rdx, label %scalar.ph.preheader, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %i.ff = add nsw i64 %n.vec, %i.ey
  %i.fg = add nsw i64 %n.vec, %i.ex
  %i.fh = add nsw i64 %n.vec, %i.ew
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader
  ...
  %indvars.iv.next334.prol = add nsw i64 %indvars.iv333.ph, 1
  %indvars.iv.next332.prol = add nsw i64 %indvars.iv331.ph, 1
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %indvars.iv.next334.1 = add nsw i64 %indvars.iv333, 2
  %indvars.iv.next332.1 = add nsw i64 %indvars.iv331, 2
...
._crit_edge.us.us.us:                             ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  %i.gj = add nuw nsw i32 %.1253291.us.us.us, 1   ; 2 uses
  %i.gk = add i32 %.1244292.us.us.us, %i.ea
  %i.gl = add i32 %.1241293.us.us.us, %i.dy
  %i.gm = add i32 %.1239294.us.us.us, %i.dz
  %exitcond340.not = icmp eq i32 %i.gj, %i.dr
...
._crit_edge295.split.us.us.us:                    ; preds = %._crit_edge.us.us.us
  %i.gn = add nuw nsw i32 %.1255305.us.us, 1      ; 2 uses
  %i.go = add i32 %.0243306.us.us, %i.ej
  %i.gp = add i32 %.0240307.us.us, %i.ed
  %i.gq = add i32 %.0238308.us.us, %i.eg
  %exitcond341.not = icmp eq i32 %i.gn, %i.ds
