...
bb.yo:                                            ; preds = %bb.yn
  ...
  br i1 %i.bhg, label %bb.yp, label %.thread3844

bb.yp:                                            ; preds = %bb.yo
  %i.bhh = load i32, ptr %i.bhd, align 4, !tbaa !26
  %i.bhi = icmp eq i32 %i.cj, %i.bhh
  br i1 %i.bhi, label %bb.yq, label %.thread3844
...
bb.yq:                                            ; preds = %bb.yp
  ...
  br i1 %i.bhm, label %bb.yr, label %.thread3844
...
bb.yr:                                            ; preds = %bb.yq
  ...
  br i1 %i.bhv, label %bb.ys, label %.thread3844
...
bb.ys:                                            ; preds = %bb.yr
  ...
  br i1 %i.bif, label %.lr.ph3464.preheader, label %.thread3844

.lr.ph3464.preheader:                             ; preds = %bb.ys
  %xtraiter3981 = and i64 %i.bhc, 3               ; 3 uses
...
.lr.ph3464.epil.preheader:                        ; preds = %._crit_edge3465.loopexit.unr-lcssa, %.lr.ph3464.preheader
  ...
  %.022743463.epil.init = phi i32 [ %i.bhf, %.lr.ph3464.preheader ], [ %spec.select3053.3, %._crit_edge3465.loopexit.unr-lcssa ]
...
._crit_edge3465:                                  ; preds = %.lr.ph3464.epil, %._crit_edge3465.loopexit.unr-lcssa
  %spec.select3053.lcssa = phi i32 [ %spec.select3053.3, %._crit_edge3465.loopexit.unr-lcssa ], [ %spec.select3053.epil, %.lr.ph3464.epil ] ; 5 uses
...
bb.yw:                                            ; preds = %._crit_edge3465._crit_edge, %bb.yt
  %.pre-phi3616 = phi i64 [ %.pre3615, %._crit_edge3465._crit_edge ], [ %i.bjd, %bb.yt ]
  %i.bji = call ptr @cli_calloc(i64 noundef %.pre-phi3616, i64 noundef 1) #13 ; 14 uses
...
bb.ze:                                            ; preds = %bb.za, %bb.zc
  ...
  %exitcond3583.not = icmp eq i64 %indvars.iv.next3580, %wide.trip.count3583
  br i1 %exitcond3583.not, label %._crit_edge3469, label %bb.za, !llvm.loop !50
...
bb.zg:                                            ; preds = %._crit_edge3469
  ...
  %.pre3608 = load i32, ptr %i.bhj, align 4, !tbaa !30 ; 2 uses
  br i1 %.not2892, label %bb.zi, label %bb.zh

bb.zh:                                            ; preds = %bb.zg
  %i.bkh = call i32 @cli_readn(i32 noundef %0, ptr noundef nonnull %i.bkd, i32 noundef %.pre3608) #13
...
bb.zi:                                            ; preds = %bb.zh, %bb.zg
  %i.bkl = phi i32 [ %i.bkj, %bb.zh ], [ %.pre3608, %bb.zg ]
...
.thread3844:                                      ; preds = %bb.vh, %bb.aaa, %bb.zz, %bb.yn, %bb.yo, %bb.yp, %bb.yq, %bb.yr, %bb.ys
...
.lr.ph3473:                                       ; preds = %.lr.ph3473, %.lr.ph3473.preheader.new
  ...
  %i.bmf = getelementptr inbounds nuw [36 x i8], ptr %i.em, i64 %indvars.iv3584 ; 2 uses
  ...
  %i.bmk = getelementptr inbounds nuw [36 x i8], ptr %i.em, i64 %indvars.iv3584 ; 2 uses
...
.lr.ph3473.epil.preheader:                        ; preds = %._crit_edge3474.unr-lcssa, %.lr.ph3473.preheader
  ...
  %i.bmq = getelementptr inbounds nuw [36 x i8], ptr %i.em, i64 %indvars.iv3584.epil.init ; 2 uses
...
bb.aad:                                           ; preds = %._crit_edge3474
  ...
  br i1 %.not2908, label %._crit_edge3614, label %bb.aae

._crit_edge3614:                                  ; preds = %bb.aad
