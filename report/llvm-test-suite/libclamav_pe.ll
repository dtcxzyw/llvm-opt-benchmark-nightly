...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %5 = load i32, ptr %i.ajf, align 4, !tbaa !32, !alias.scope !78
...
.lr.ph3452.preheader3968:                         ; preds = %vector.memcheck, %vector.scevcheck, %.lr.ph3452.preheader, %middle.block
  %indvars.iv3562.ph = phi i64 [ 1, %vector.memcheck ], [ 1, %vector.scevcheck ], [ 1, %.lr.ph3452.preheader ], [ %6, %middle.block ] ; 5 uses
