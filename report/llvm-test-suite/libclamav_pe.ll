...
bb.ys:                                            ; preds = %bb.yr
  ...
  br i1 %i.bif, label %.preheader3341, label %.thread3844
...
._crit_edge3465:                                  ; preds = %._crit_edge3465.loopexit.unr-lcssa, %.lr.ph3464.epil, %.preheader3341
  %.02274.lcssa = phi i32 [ %i.bhf, %.preheader3341 ], [ %spec.select3053.3, %._crit_edge3465.loopexit.unr-lcssa ], [ %spec.select3053.epil, %.lr.ph3464.epil ] ; 5 uses
...
bb.ze:                                            ; preds = %bb.za, %bb.zc
  ...
  %exitcond3583.not = icmp eq i64 %indvars.iv.next3580, %i.bhc
