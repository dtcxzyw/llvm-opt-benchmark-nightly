...
._crit_edge3434:                                  ; preds = %bb.is
  ...
  %.not2730 = icmp eq i32 %.22376, 0
  br i1 %.not2730, label %.critedge81, label %bb.it

bb.it:                                            ; preds = %.thread3162, %._crit_edge3434
  %.023973374 = phi ptr [ %.023973430, %.thread3162 ], [ %.22399, %._crit_edge3434 ] ; 3 uses
  %.023743371 = phi i32 [ 1280, %.thread3162 ], [ %.22376, %._crit_edge3434 ] ; 3 uses
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.119, i32 noundef %.023743371) #13
  ...
  %wide.trip.count3551 = zext i32 %.023743371 to i64
  br label %bb.iu

bb.iu:                                            ; preds = %bb.it, %bb.ja
  %indvars.iv3548 = phi i64 [ 0, %bb.it ], [ %indvars.iv.next3549, %bb.ja ] ; 2 uses
  %i.ty = getelementptr inbounds nuw [4 x i8], ptr %.023973374, i64 %indvars.iv3548
...
bb.iz:                                            ; preds = %bb.iy, %bb.ix, %bb.iv
  ...
  call void @free(ptr noundef nonnull %.023973374) #13
...
.critedge81.sink.split:                           ; preds = %bb.ja, %.preheader3348
  %.sink3913.a = phi ptr [ %i.sa, %.preheader3348 ], [ %.023973374, %bb.ja ]
  %.52285.ph = phi i32 [ 0, %.preheader3348 ], [ %.023743371, %bb.ja ]
  call void @free(ptr noundef nonnull %.sink3913.a) #13
  br label %.critedge81

.critedge81:                                      ; preds = %.critedge81.sink.split, %._crit_edge3434, %bb.ia, %bb.hz, %bb.hy, %.thread3821
  %.52285 = phi i32 [ %i.ak, %.thread3821 ], [ %i.ak, %bb.hy ], [ %i.tt, %._crit_edge3434 ], [ %i.ak, %bb.ia ], [ %i.ak, %bb.hz ], [ %.52285.ph, %.critedge81.sink.split ]
...
bb.jr:                                            ; preds = %bb.jq
  ...
  br i1 %.not2742, label %.thread3832, label %bb.js
...
bb.jv:                                            ; preds = %bb.js
  ...
  br i1 %i.xa, label %bb.jw, label %.thread3832
...
.thread3832:                                      ; preds = %bb.jr, %._crit_edge3601, %bb.jv
...
bb.jy:                                            ; preds = %.thread3832
  call void @free(ptr noundef nonnull %i.em) #13
  br label %.critedge3020

bb.jz:                                            ; preds = %.thread3832
...
bb.kj:                                            ; preds = %bb.kd, %bb.ki
  %.02371 = phi i32 [ %i.yj, %bb.ki ], [ 0, %bb.kd ]
...
bb.kn:                                            ; preds = %bb.kl
  ...
  %i.yq = call i32 @unmew11(i32 noundef %i.vf, ptr noundef nonnull %i.xh, i32 noundef %i.wh, i32 noundef %i.wk, i32 noundef %i.yn, i32 noundef %i.yo, i32 noundef %i.yp, i32 noundef %.02371, ptr noundef null, ptr noundef null, i32 noundef %i.yl) #13
...
bb.mx:                                            ; preds = %bb.mw
  %i.afd = add i32 %.722873172, 1                 ; 2 uses
  ...
  %i.afi = zext i32 %.722873172 to i64
...
bb.ov:                                            ; preds = %bb.ou
  ...
  %i.ajf = icmp ult i32 %i.aje, %.02321.lcssa
  br i1 %i.ajf, label %bb.ow, label %bb.qv

bb.ow:                                            ; preds = %bb.ov
  %i.ajg = add i32 %.722873172, 1
  ...
  %i.ajl = zext i32 %.722873172 to i64
