...
begin_hunk_0_@InsertSym:bb.a
  ...
  %i.ma = load ptr, ptr %i.jn, align 16, !tbaa !15 ; 2 uses
...
begin_hunk_1_@InsertSym:bb.a
  ...
  %9 = load ptr, ptr @zz_tmp, align 8, !tbaa !14
  %i.me = getelementptr inbounds nuw i8, ptr %9, i64 8
...
begin_hunk_2_@InsertAlternativeName:bb.a
  ...
  %i.cm = load ptr, ptr %i.z, align 16, !tbaa !15 ; 2 uses
...
begin_hunk_3_@InsertAlternativeName:bb.a
  ...
  %3 = load ptr, ptr @zz_tmp, align 8, !tbaa !14
