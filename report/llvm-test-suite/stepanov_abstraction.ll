...
vector.ph343:                                     ; preds = %.lr.ph.i142.preheader
  %n.vec345 = and i64 %i.hf, 4611686018427387900  ; 3 uses
  %i.hi = shl i64 %n.vec345, 3                    ; 2 uses
  %i.hj = getelementptr i8, ptr %i.hb, i64 %i.hi
  %i.hk = getelementptr i8, ptr %i.gw, i64 %i.hi
  br label %vector.body346

vector.body346:                                   ; preds = %vector.body346, %vector.ph343
  %index347 = phi i64 [ 0, %vector.ph343 ], [ %index.next353, %vector.body346 ] ; 2 uses
  %offset.idx348 = shl i64 %index347, 3           ; 2 uses
  %next.gep349 = getelementptr i8, ptr %i.hb, i64 %offset.idx348 ; 2 uses
  %next.gep351 = getelementptr i8, ptr %i.gw, i64 %offset.idx348 ; 2 uses
...
vector.ph362:                                     ; preds = %_ZN9benchmark4copyIPdP12ValueWrapperIdEEEvT_S5_T0_.exit
  %n.vec364 = and i64 %i.hv, 4611686018427387900  ; 3 uses
  %i.hy = shl i64 %n.vec364, 3                    ; 2 uses
  %i.hz = getelementptr i8, ptr %i.hr, i64 %i.hy
  %i.ia = getelementptr i8, ptr %i.gw, i64 %i.hy
  br label %vector.body365

vector.body365:                                   ; preds = %vector.body365, %vector.ph362
  %index366 = phi i64 [ 0, %vector.ph362 ], [ %index.next373, %vector.body365 ] ; 2 uses
  %offset.idx367 = shl i64 %index366, 3           ; 2 uses
  %next.gep368 = getelementptr i8, ptr %i.hr, i64 %offset.idx367 ; 2 uses
  %next.gep370 = getelementptr i8, ptr %i.gw, i64 %offset.idx367 ; 2 uses
...
begin_hunk_2_@_Z19test_insertion_sortIPddEvT_S1_S1_S1_T0_PKc:bb.a
  ...
  %n.vec60 = and i64 %i.m, 4611686018427387900    ; 3 uses
  %i.n = shl i64 %n.vec60, 3                      ; 2 uses
  %i.o = getelementptr i8, ptr %2, i64 %i.n
  %i.p = getelementptr i8, ptr %0, i64 %i.n
...
vector.body61:                                    ; preds = %.lr.ph.i.preheader.us, %vector.body61
  %index62 = phi i64 [ %index.next69, %vector.body61 ], [ 0, %.lr.ph.i.preheader.us ] ; 2 uses
  %offset.idx63 = shl i64 %index62, 3             ; 2 uses
  %next.gep64 = getelementptr i8, ptr %2, i64 %offset.idx63 ; 2 uses
  %next.gep66 = getelementptr i8, ptr %0, i64 %offset.idx63 ; 2 uses
...
begin_hunk_4_@_Z19test_insertion_sortIPddEvT_S1_S1_S1_T0_PKc:bb.a
  ...
  %i.av = getelementptr i8, ptr %0, i64 %i.at
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  %next.gep51 = getelementptr i8, ptr %0, i64 %offset.idx ; 2 uses
...
begin_hunk_6_@_Z19test_insertion_sortI14PointerWrapperIdEdEvT_S2_S2_S2_T0_PKc:bb.a
  ...
  %n.vec67 = and i64 %i.m, 4611686018427387900    ; 3 uses
  %i.n = shl i64 %n.vec67, 3                      ; 2 uses
...
vector.body68:                                    ; preds = %.lr.ph.i.preheader.us, %vector.body68
  %index69 = phi i64 [ %index.next76, %vector.body68 ], [ 0, %.lr.ph.i.preheader.us ] ; 2 uses
  %offset.idx70 = shl i64 %index69, 3             ; 2 uses
  %next.gep71 = getelementptr i8, ptr %0, i64 %offset.idx70 ; 2 uses
  %next.gep73 = getelementptr i8, ptr %2, i64 %offset.idx70 ; 2 uses
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  %next.gep58 = getelementptr i8, ptr %2, i64 %offset.idx ; 2 uses
...
begin_hunk_14_@_Z19test_insertion_sortI14PointerWrapperI12ValueWrapperIdEES2_EvT_S4_S4_S4_T0_PKc:bb.a
  ...
  %n.vec68 = and i64 %i.m, 4611686018427387900    ; 3 uses
  %i.n = shl i64 %n.vec68, 3                      ; 2 uses
  %i.o = getelementptr i8, ptr %0, i64 %i.n
  %i.p = getelementptr i8, ptr %2, i64 %i.n
...
vector.body69:                                    ; preds = %.lr.ph.i.preheader.us, %vector.body69
  %index70 = phi i64 [ %index.next77, %vector.body69 ], [ 0, %.lr.ph.i.preheader.us ] ; 2 uses
  %offset.idx71 = shl i64 %index70, 3             ; 2 uses
  %next.gep72 = getelementptr i8, ptr %0, i64 %offset.idx71 ; 2 uses
  %next.gep74 = getelementptr i8, ptr %2, i64 %offset.idx71 ; 2 uses
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  %offset.idx = shl i64 %index, 3                 ; 2 uses
  %next.gep = getelementptr i8, ptr %0, i64 %offset.idx ; 2 uses
  %next.gep59 = getelementptr i8, ptr %2, i64 %offset.idx ; 2 uses
...
begin_hunk_26_@_Z14test_quicksortIPddEvT_S1_S1_S1_T0_PKc:bb.a
  ...
  %i.n = getelementptr i8, ptr %0, i64 %i.l
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  %offset.idx = shl i64 %index, 3                 ; 2 uses
  %next.gep = getelementptr i8, ptr %2, i64 %offset.idx ; 2 uses
  %next.gep16 = getelementptr i8, ptr %0, i64 %offset.idx ; 2 uses
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  %offset.idx = shl i64 %index, 3                 ; 2 uses
  %next.gep = getelementptr i8, ptr %0, i64 %offset.idx ; 2 uses
  %next.gep22 = getelementptr i8, ptr %2, i64 %offset.idx ; 2 uses
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  %offset.idx = shl i64 %index, 3                 ; 2 uses
  %next.gep = getelementptr i8, ptr %0, i64 %offset.idx ; 2 uses
  %next.gep23 = getelementptr i8, ptr %2, i64 %offset.idx ; 2 uses
  %i.x = getelementptr i8, ptr %next.gep, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep, align 8, !tbaa !32
