...
begin_hunk_0_@_Z9summarizePKciiii:bb.a
  %i.bs = fdiv double %i.bm, %i.br
  %i.bt = tail call double @exp(double noundef %i.bs) #16, !tbaa !4
...
.lr.ph.i68.preheader:                             ; preds = %_ZN9benchmark4fillIPddEEvT_S2_T0_.exit
  ...
  %min.iters.check312 = icmp ult i64 %i.ac, 24
...
.lr.ph.i71.preheader:                             ; preds = %_ZN9benchmark4fillIP12ValueWrapperIdES2_EEvT_S4_T0_.exit
  ...
  %min.iters.check326 = icmp ult i64 %i.ap, 24
...
vector.ph341:                                     ; preds = %.lr.ph.i142.preheader
  ...
  %i.hc = getelementptr i8, ptr %i.gu, i64 %i.hb
...
vector.body344:                                   ; preds = %vector.body344, %vector.ph341
  ...
  %next.gep346 = getelementptr i8, ptr %i.gu, i64 %i.he ; 2 uses
...
.lr.ph.i142.preheader375:                         ; preds = %.lr.ph.i142.preheader, %middle.block350
  %.07.i143.ph = phi ptr [ %i.gu, %.lr.ph.i142.preheader ], [ %i.hc, %middle.block350 ]
...
vector.ph358:                                     ; preds = %_ZN9benchmark4copyIPdP12ValueWrapperIdEEEvT_S5_T0_.exit
  %n.vec360 = and i64 %i.hp, 4611686018427387900  ; 3 uses
  %i.hs = shl i64 %n.vec360, 3                    ; 2 uses
  %i.ht = getelementptr i8, ptr %i.hl, i64 %i.hs
  %i.hu = getelementptr i8, ptr %i.gt, i64 %i.hs
...
vector.body361:                                   ; preds = %vector.body361, %vector.ph358
  ...
  %i.hv = shl i64 %index362, 3                    ; 2 uses
  %next.gep363 = getelementptr i8, ptr %i.hl, i64 %i.hv ; 2 uses
  %next.gep364 = getelementptr i8, ptr %i.gt, i64 %i.hv ; 2 uses
  %i.hw = getelementptr i8, ptr %next.gep364, i64 16
  %wide.load365 = load <2 x i64>, ptr %next.gep364, align 8, !tbaa !32
  %wide.load366 = load <2 x i64>, ptr %i.hw, align 8, !tbaa !32
  %i.hx = getelementptr i8, ptr %next.gep363, i64 16
  store <2 x i64> %wide.load365, ptr %next.gep363, align 8, !tbaa !32
  store <2 x i64> %wide.load366, ptr %i.hx, align 8, !tbaa !32
  %index.next367 = add nuw i64 %index362, 4       ; 2 uses
  %i.hy = icmp eq i64 %index.next367, %n.vec360
  br i1 %i.hy, label %middle.block368, label %vector.body361, !llvm.loop !64

middle.block368:                                  ; preds = %vector.body361
  %cmp.n369 = icmp eq i64 %i.hp, %n.vec360
...
.lr.ph.i146.preheader:                            ; preds = %_ZN9benchmark4copyIPdP12ValueWrapperIdEEEvT_S5_T0_.exit, %middle.block368
  %.07.i147.ph = phi ptr [ %i.hl, %_ZN9benchmark4copyIPdP12ValueWrapperIdEEEvT_S5_T0_.exit ], [ %i.ht, %middle.block368 ]
  %.046.i148.ph = phi ptr [ %i.gt, %_ZN9benchmark4copyIPdP12ValueWrapperIdEEEvT_S5_T0_.exit ], [ %i.hu, %middle.block368 ]
  br label %.lr.ph.i146

.lr.ph.i146:                                      ; preds = %.lr.ph.i146.preheader, %.lr.ph.i146
  %.07.i147 = phi ptr [ %i.ib, %.lr.ph.i146 ], [ %.07.i147.ph, %.lr.ph.i146.preheader ] ; 2 uses
  %.046.i148 = phi ptr [ %i.hz, %.lr.ph.i146 ], [ %.046.i148.ph, %.lr.ph.i146.preheader ] ; 2 uses
  %i.hz = getelementptr inbounds nuw i8, ptr %.046.i148, i64 8 ; 2 uses
  %i.ia = load i64, ptr %.046.i148, align 8, !tbaa !32
  %i.ib = getelementptr inbounds nuw i8, ptr %.07.i147, i64 8
  store i64 %i.ia, ptr %.07.i147, align 8, !tbaa !32
  %.not.i149 = icmp eq ptr %i.hz, %i.gs
...
_ZN9benchmark4copyIPdP12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEvT_SE_T0_.exit: ; preds = %.lr.ph.i146, %middle.block368, %_ZN9benchmark11fill_randomIPddEEvT_S2_.exit
  %i.ic = load ptr, ptr @dpb, align 8, !tbaa !33
  %i.id = load ptr, ptr @dpe, align 8, !tbaa !33
  tail call void @_Z19test_insertion_sortIPddEvT_S1_S1_S1_T0_PKc(ptr noundef %i.gt, ptr noundef %i.gs, ptr noundef %i.ic, ptr noundef %i.id, double noundef 0.000000e+00, ptr noundef nonnull @.str.32)
  ...
  %i.ie = load ptr, ptr @DVMpb, align 8, !tbaa !39
  %i.if = load ptr, ptr @DVMpe, align 8, !tbaa !39
  %i.ig = load ptr, ptr @DVpb, align 8, !tbaa !39
  %i.ih = load ptr, ptr @DVpe, align 8, !tbaa !39
  tail call void @_Z19test_insertion_sortIP12ValueWrapperIdES1_EvT_S3_S3_S3_T0_PKc(ptr noundef %i.ie, ptr noundef %i.if, ptr noundef %i.ig, ptr noundef %i.ih, double 0.000000e+00, ptr noundef nonnull @.str.34)
  ...
  %i.ii = load ptr, ptr @DV10Mpb, align 8, !tbaa !43
  %i.ij = load ptr, ptr @DV10Mpe, align 8, !tbaa !43
  %i.ik = load ptr, ptr @DV10pb, align 8, !tbaa !43
  %i.il = load ptr, ptr @DV10pe, align 8, !tbaa !43
  tail call void @_Z19test_insertion_sortIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEESA_EvT_SC_SC_SC_T0_PKc(ptr noundef %i.ii, ptr noundef %i.ij, ptr noundef %i.ik, ptr noundef %i.il, double 0.000000e+00, ptr noundef nonnull @.str.36)
  ...
  %i.im = load i32, ptr @iterations, align 4, !tbaa !4
  %i.in = shl nsw i32 %i.im, 3
  store i32 %i.in, ptr @iterations, align 4, !tbaa !4
  %i.io = load ptr, ptr @dMpb, align 8, !tbaa !33
  %i.ip = load ptr, ptr @dMpe, align 8, !tbaa !33
  %i.iq = load ptr, ptr @dpb, align 8, !tbaa !33
  %i.ir = load ptr, ptr @dpe, align 8, !tbaa !33
  tail call void @_Z14test_quicksortIPddEvT_S1_S1_S1_T0_PKc(ptr noundef %i.io, ptr noundef %i.ip, ptr noundef %i.iq, ptr noundef %i.ir, double noundef 0.000000e+00, ptr noundef nonnull @.str.38)
  ...
  %i.is = load ptr, ptr @DVMpb, align 8, !tbaa !39
  %i.it = load ptr, ptr @DVMpe, align 8, !tbaa !39
  %i.iu = load ptr, ptr @DVpb, align 8, !tbaa !39
  %i.iv = load ptr, ptr @DVpe, align 8, !tbaa !39
  tail call void @_Z14test_quicksortIP12ValueWrapperIdES1_EvT_S3_S3_S3_T0_PKc(ptr noundef %i.is, ptr noundef %i.it, ptr noundef %i.iu, ptr noundef %i.iv, double 0.000000e+00, ptr noundef nonnull @.str.40)
  ...
  %i.iw = load ptr, ptr @DV10Mpb, align 8, !tbaa !43
  %i.ix = load ptr, ptr @DV10Mpe, align 8, !tbaa !43
  %i.iy = load ptr, ptr @DV10pb, align 8, !tbaa !43
  %i.iz = load ptr, ptr @DV10pe, align 8, !tbaa !43
  tail call void @_Z14test_quicksortIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEESA_EvT_SC_SC_SC_T0_PKc(ptr noundef %i.iw, ptr noundef %i.ix, ptr noundef %i.iy, ptr noundef %i.iz, double 0.000000e+00, ptr noundef nonnull @.str.42)
  ...
  %i.ja = load ptr, ptr @dMpb, align 8, !tbaa !33
  %i.jb = load ptr, ptr @dMpe, align 8, !tbaa !33
  %i.jc = load ptr, ptr @dpb, align 8, !tbaa !33
  %i.jd = load ptr, ptr @dpe, align 8, !tbaa !33
  tail call void @_Z14test_heap_sortIPddEvT_S1_S1_S1_T0_PKc(ptr noundef %i.ja, ptr noundef %i.jb, ptr noundef %i.jc, ptr noundef %i.jd, double noundef 0.000000e+00, ptr noundef nonnull @.str.44)
  ...
  %i.je = load ptr, ptr @DVMpb, align 8, !tbaa !39
  %i.jf = load ptr, ptr @DVMpe, align 8, !tbaa !39
  %i.jg = load ptr, ptr @DVpb, align 8, !tbaa !39
  %i.jh = load ptr, ptr @DVpe, align 8, !tbaa !39
  tail call void @_Z14test_heap_sortIP12ValueWrapperIdES1_EvT_S3_S3_S3_T0_PKc(ptr noundef %i.je, ptr noundef %i.jf, ptr noundef %i.jg, ptr noundef %i.jh, double 0.000000e+00, ptr noundef nonnull @.str.46)
  ...
  %i.ji = load ptr, ptr @DV10Mpb, align 8, !tbaa !43
  %i.jj = load ptr, ptr @DV10Mpe, align 8, !tbaa !43
  %i.jk = load ptr, ptr @DV10pb, align 8, !tbaa !43
  %i.jl = load ptr, ptr @DV10pe, align 8, !tbaa !43
  tail call void @_Z14test_heap_sortIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEESA_EvT_SC_SC_SC_T0_PKc(ptr noundef %i.ji, ptr noundef %i.jj, ptr noundef %i.jk, ptr noundef %i.jl, double 0.000000e+00, ptr noundef nonnull @.str.48)
...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %i.p, label %_ZN9benchmark9is_sortedIPdEEbT_S2_.exit.i.us.us, label %bb.b, !llvm.loop !66
...
_Z13verify_sortedIPdEvT_S1_.exit.us.us:           ; preds = %bb.b, %_ZN9benchmark9is_sortedIPdEEbT_S2_.exit.i.us.us
  ...
  br i1 %i.u, label %_ZN9benchmark4copyIPdS1_EEvT_S2_T0_.exit.us.us, label %._crit_edge, !llvm.loop !67
...
vector.body60:                                    ; preds = %.lr.ph.i.preheader.us, %vector.body60
  ...
  br i1 %i.z, label %middle.block67, label %vector.body60, !llvm.loop !68
...
bb.d:                                             ; preds = %_ZN9benchmark4copyIPdS1_EEvT_S2_T0_.exit.loopexit.us
  ...
  br i1 %i.af, label %_ZN9benchmark9is_sortedIPdEEbT_S2_.exit.i.us, label %_ZN9benchmark4copyIPdS1_EEvT_S2_T0_.exit.loopexit.us, !llvm.loop !66

_ZN9benchmark9is_sortedIPdEEbT_S2_.exit.i.us:     ; preds = %bb.d
  %i.ag = load i32, ptr @current_test, align 4, !tbaa !4
  %i.ah = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.51, i32 noundef %i.ag) ; 0 uses
...
_Z13verify_sortedIPdEvT_S1_.exit.us:              ; preds = %_ZN9benchmark4copyIPdS1_EEvT_S2_T0_.exit.loopexit.us, %_ZN9benchmark9is_sortedIPdEEbT_S2_.exit.i.us
  ...
  br i1 %i.ak, label %.lr.ph.i.preheader.us, label %._crit_edge, !llvm.loop !67
...
bb.g:                                             ; preds = %_ZN9benchmark13insertionSortIPddEEvT_S2_.exit.loopexit.us
  ...
  br i1 %i.ba, label %_ZN9benchmark9is_sortedIPdEEbT_S2_.exit.i.us16, label %_ZN9benchmark13insertionSortIPddEEvT_S2_.exit.loopexit.us, !llvm.loop !66

_ZN9benchmark9is_sortedIPdEEbT_S2_.exit.i.us16:   ; preds = %bb.g
  %i.bb = load i32, ptr @current_test, align 4, !tbaa !4
  %i.bc = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.51, i32 noundef %i.bb) ; 0 uses
...
_Z13verify_sortedIPdEvT_S1_.exit.us17:            ; preds = %_ZN9benchmark13insertionSortIPddEEvT_S2_.exit.loopexit.us, %_ZN9benchmark9is_sortedIPdEEbT_S2_.exit.i.us16
  ...
  br i1 %i.bf, label %_ZN9benchmark4copyIPdS1_EEvT_S2_T0_.exit.us12, label %._crit_edge, !llvm.loop !67
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  br i1 %i.bk, label %middle.block, label %vector.body, !llvm.loop !72
...
bb.j:                                             ; preds = %_ZN9benchmark13insertionSortIPddEEvT_S2_.exit.loopexit
  ...
  br i1 %i.bu, label %_ZN9benchmark9is_sortedIPdEEbT_S2_.exit.i, label %_ZN9benchmark13insertionSortIPddEEvT_S2_.exit.loopexit, !llvm.loop !66
...
_Z13verify_sortedIPdEvT_S1_.exit:                 ; preds = %_ZN9benchmark13insertionSortIPddEEvT_S2_.exit.loopexit, %_ZN9benchmark9is_sortedIPdEEbT_S2_.exit.i
  ...
  br i1 %i.bz, label %.lr.ph.i.preheader, label %._crit_edge, !llvm.loop !67
...
_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.us.us: ; preds = %.lr.ph.split.us, %_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit.us.us
  %i.m = phi i32 [ %i.t, %_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit.us.us ], [ %i.c, %.lr.ph.split.us ]
  %.014.us.us = phi i32 [ %i.u, %_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit.us.us ], [ 0, %.lr.ph.split.us ]
  br label %bb.b

bb.b:                                             ; preds = %bb.c, %_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.us.us
  %.sroa.04.0.i.i.us.us = phi ptr [ %2, %_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.us.us ], [ %i.n, %bb.c ] ; 2 uses
  %i.n = getelementptr i8, ptr %.sroa.04.0.i.i.us.us, i64 8 ; 3 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.p = load double, ptr %.sroa.04.0.i.i.us.us, align 8, !tbaa !32
  %i.q = fcmp olt double %i.o, %i.p
  br i1 %i.q, label %_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i.us.us, label %bb.b, !llvm.loop !74

_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i.us.us: ; preds = %bb.c
  %i.r = load i32, ptr @current_test, align 4, !tbaa !4
  %i.s = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.51, i32 noundef %i.r) ; 0 uses
...
_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit.us.us: ; preds = %bb.b, %_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i.us.us
  %i.t = phi i32 [ %.pre27, %_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i.us.us ], [ %i.m, %bb.b ] ; 2 uses
  %i.u = add nuw nsw i32 %.014.us.us, 1           ; 2 uses
  %i.v = icmp slt i32 %i.u, %i.t
  br i1 %i.v, label %_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.us.us, label %._crit_edge, !llvm.loop !75

.lr.ph.i.preheader.us:                            ; preds = %.lr.ph.i.preheader.us.preheader, %_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit.us
  %i.w = phi i32 [ %i.ak, %_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit.us ], [ %i.c, %.lr.ph.i.preheader.us.preheader ]
  %.014.us = phi i32 [ %i.al, %_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit.us ], [ 0, %.lr.ph.i.preheader.us.preheader ]
...
vector.body67:                                    ; preds = %.lr.ph.i.preheader.us, %vector.body67
  ...
  br i1 %i.aa, label %middle.block74, label %vector.body67, !llvm.loop !76
...
.lr.ph.i.us.preheader:                            ; preds = %.lr.ph.i.preheader.us, %middle.block74
  %.sroa.05.08.i.us.ph = phi ptr [ %0, %.lr.ph.i.preheader.us ], [ %i.k, %middle.block74 ]
  %.sroa.03.07.i.us.ph = phi ptr [ %2, %.lr.ph.i.preheader.us ], [ %i.l, %middle.block74 ]
  br label %.lr.ph.i.us

.lr.ph.i.us:                                      ; preds = %.lr.ph.i.us.preheader, %.lr.ph.i.us
  %.sroa.05.08.i.us = phi ptr [ %i.ab, %.lr.ph.i.us ], [ %.sroa.05.08.i.us.ph, %.lr.ph.i.us.preheader ] ; 2 uses
  %.sroa.03.07.i.us = phi ptr [ %i.ad, %.lr.ph.i.us ], [ %.sroa.03.07.i.us.ph, %.lr.ph.i.us.preheader ] ; 2 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %.sroa.05.08.i.us, i64 8 ; 2 uses
  %i.ac = load double, ptr %.sroa.05.08.i.us, align 8, !tbaa !32
  %i.ad = getelementptr inbounds nuw i8, ptr %.sroa.03.07.i.us, i64 8
  store double %i.ac, ptr %.sroa.03.07.i.us, align 8, !tbaa !32
...
_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.loopexit.us: ; preds = %_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.loopexit.us.preheader, %bb.d
  %.sroa.04.0.i.i.us = phi ptr [ %i.ae, %bb.d ], [ %2, %_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.loopexit.us.preheader ] ; 2 uses
  %i.ae = getelementptr i8, ptr %.sroa.04.0.i.i.us, i64 8 ; 3 uses
...
bb.d:                                             ; preds = %_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.loopexit.us
  ...
  %i.ag = load double, ptr %.sroa.04.0.i.i.us, align 8, !tbaa !32
  %i.ah = fcmp olt double %i.af, %i.ag
  br i1 %i.ah, label %_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i.us, label %_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.loopexit.us, !llvm.loop !74

_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i.us: ; preds = %bb.d
  %i.ai = load i32, ptr @current_test, align 4, !tbaa !4
  %i.aj = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.51, i32 noundef %i.ai) ; 0 uses
...
_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit.us: ; preds = %_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.loopexit.us, %_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i.us
  %i.ak = phi i32 [ %.pre26, %_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i.us ], [ %i.w, %_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.loopexit.us ] ; 2 uses
  %i.al = add nuw nsw i32 %.014.us, 1             ; 2 uses
  %i.am = icmp slt i32 %i.al, %i.ak
  br i1 %i.am, label %.lr.ph.i.preheader.us, label %._crit_edge, !llvm.loop !75
...
_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.us16: ; preds = %.lr.ph.split, %_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit.us20
  %i.av = phi i32 [ %i.bg, %_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit.us20 ], [ %i.c, %.lr.ph.split ]
  %.014.us15 = phi i32 [ %i.bh, %_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit.us20 ], [ 0, %.lr.ph.split ]
...
.lr.ph.i12.us:                                    ; preds = %.critedge.i.us, %_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.us16
  ...
  %i.aw = load double, ptr %.sroa.010.019.i.us, align 8, !tbaa !32 ; 2 uses
  br label %bb.e

bb.e:                                             ; preds = %bb.f, %.lr.ph.i12.us
  %.sroa.0.016.i.us = phi ptr [ %.sroa.010.019.i.us, %.lr.ph.i12.us ], [ %i.ax, %bb.f ] ; 3 uses
  %i.ax = getelementptr i8, ptr %.sroa.0.016.i.us, i64 -8 ; 3 uses
  %i.ay = load double, ptr %i.ax, align 8, !tbaa !32 ; 2 uses
  %i.az = fcmp olt double %i.aw, %i.ay
  br i1 %i.az, label %bb.f, label %.critedge.i.us

bb.f:                                             ; preds = %bb.e
  store double %i.ay, ptr %.sroa.0.016.i.us, align 8, !tbaa !32
  %.not14.i.us = icmp eq ptr %i.ax, %2
  br i1 %.not14.i.us, label %.critedge.i.us, label %bb.e, !llvm.loop !78

.critedge.i.us:                                   ; preds = %bb.f, %bb.e
  %.sroa.06.0.lcssa.i.us = phi ptr [ %2, %bb.f ], [ %.sroa.0.016.i.us, %bb.e ]
  store double %i.aw, ptr %.sroa.06.0.lcssa.i.us, align 8, !tbaa !32
...
_ZN9benchmark13insertionSortI14PointerWrapperIdEdEEvT_S3_.exit.loopexit.us: ; preds = %.critedge.i.us, %bb.g
  %.sroa.04.0.i.i.us17 = phi ptr [ %i.ba, %bb.g ], [ %2, %.critedge.i.us ] ; 2 uses
  %i.ba = getelementptr i8, ptr %.sroa.04.0.i.i.us17, i64 8 ; 3 uses
...
bb.g:                                             ; preds = %_ZN9benchmark13insertionSortI14PointerWrapperIdEdEEvT_S3_.exit.loopexit.us
  ...
  %i.bc = load double, ptr %.sroa.04.0.i.i.us17, align 8, !tbaa !32
  %i.bd = fcmp olt double %i.bb, %i.bc
  br i1 %i.bd, label %_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i.us19, label %_ZN9benchmark13insertionSortI14PointerWrapperIdEdEEvT_S3_.exit.loopexit.us, !llvm.loop !74

_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i.us19: ; preds = %bb.g
  %i.be = load i32, ptr @current_test, align 4, !tbaa !4
  %i.bf = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.51, i32 noundef %i.be) ; 0 uses
...
_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit.us20: ; preds = %_ZN9benchmark13insertionSortI14PointerWrapperIdEdEEvT_S3_.exit.loopexit.us, %_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i.us19
  %i.bg = phi i32 [ %.pre25, %_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i.us19 ], [ %i.av, %_ZN9benchmark13insertionSortI14PointerWrapperIdEdEEvT_S3_.exit.loopexit.us ] ; 2 uses
  %i.bh = add nuw nsw i32 %.014.us15, 1           ; 2 uses
  %i.bi = icmp slt i32 %i.bh, %i.bg
  br i1 %i.bi, label %_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.us16, label %._crit_edge, !llvm.loop !75

.lr.ph.i.preheader:                               ; preds = %.lr.ph.i.preheader.preheader, %_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit
  %i.bj = phi i32 [ %i.cb, %_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit ], [ %i.c, %.lr.ph.i.preheader.preheader ]
  %.014 = phi i32 [ %i.cc, %_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit ], [ 0, %.lr.ph.i.preheader.preheader ]
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  br i1 %i.bn, label %middle.block, label %vector.body, !llvm.loop !80

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %.lr.ph.i12.preheader, label %.lr.ph.i.preheader81

.lr.ph.i.preheader81:                             ; preds = %.lr.ph.i.preheader, %middle.block
  %.sroa.05.08.i.ph = phi ptr [ %0, %.lr.ph.i.preheader ], [ %i.at, %middle.block ]
  %.sroa.03.07.i.ph = phi ptr [ %2, %.lr.ph.i.preheader ], [ %i.au, %middle.block ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader81, %.lr.ph.i
  %.sroa.05.08.i = phi ptr [ %i.bo, %.lr.ph.i ], [ %.sroa.05.08.i.ph, %.lr.ph.i.preheader81 ] ; 2 uses
  %.sroa.03.07.i = phi ptr [ %i.bq, %.lr.ph.i ], [ %.sroa.03.07.i.ph, %.lr.ph.i.preheader81 ] ; 2 uses
  %i.bo = getelementptr inbounds nuw i8, ptr %.sroa.05.08.i, i64 8 ; 2 uses
  %i.bp = load double, ptr %.sroa.05.08.i, align 8, !tbaa !32
  %i.bq = getelementptr inbounds nuw i8, ptr %.sroa.03.07.i, i64 8
  store double %i.bp, ptr %.sroa.03.07.i, align 8, !tbaa !32
...
.lr.ph.i12:                                       ; preds = %.lr.ph.i12.preheader, %.critedge.i
  ...
  %i.br = load double, ptr %.sroa.010.019.i, align 8, !tbaa !32 ; 2 uses
  br label %bb.h

bb.h:                                             ; preds = %bb.i, %.lr.ph.i12
  %.sroa.0.016.i = phi ptr [ %.sroa.010.019.i, %.lr.ph.i12 ], [ %i.bs, %bb.i ] ; 3 uses
...
.critedge.i:                                      ; preds = %bb.i, %bb.h
  ...
  store double %i.br, ptr %.sroa.06.0.lcssa.i, align 8, !tbaa !32
...
bb.j:                                             ; preds = %_ZN9benchmark13insertionSortI14PointerWrapperIdEdEEvT_S3_.exit.loopexit
  ...
  %i.bx = load double, ptr %.sroa.04.0.i.i, align 8, !tbaa !32
  %i.by = fcmp olt double %i.bw, %i.bx
  br i1 %i.by, label %_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i, label %_ZN9benchmark13insertionSortI14PointerWrapperIdEdEEvT_S3_.exit.loopexit, !llvm.loop !74
...
_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit: ; preds = %_ZN9benchmark13insertionSortI14PointerWrapperIdEdEEvT_S3_.exit.loopexit, %_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i
  %i.cb = phi i32 [ %.pre, %_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i ], [ %i.bj, %_ZN9benchmark13insertionSortI14PointerWrapperIdEdEEvT_S3_.exit.loopexit ] ; 2 uses
  %i.cc = add nuw nsw i32 %.014, 1                ; 2 uses
  %i.cd = icmp slt i32 %i.cc, %i.cb
  br i1 %i.cd, label %.lr.ph.i.preheader, label %._crit_edge, !llvm.loop !75
...
_ZN9benchmark4copyIP12ValueWrapperIdES3_EEvT_S4_T0_.exit.us.us: ; preds = %.lr.ph.split.us, %_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit.us.us
  %i.m = phi i32 [ %i.s, %_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit.us.us ], [ %i.c, %.lr.ph.split.us ]
  %.010.us.us = phi i32 [ %i.t, %_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit.us.us ], [ 0, %.lr.ph.split.us ]
  br label %bb.b
...
bb.c:                                             ; preds = %bb.b
  %i.n = load double, ptr %.08.i.i.us.us, align 8, !tbaa !52
  %i.o = load double, ptr %.pn.i.i.us.us, align 8, !tbaa !52
  %i.p = fcmp olt double %i.n, %i.o
  br i1 %i.p, label %_ZN9benchmark9is_sortedIP12ValueWrapperIdEEEbT_S4_.exit.i.us.us, label %bb.b, !llvm.loop !82
...
_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit.us.us: ; preds = %bb.b, %_ZN9benchmark9is_sortedIP12ValueWrapperIdEEEbT_S4_.exit.i.us.us
  %i.s = phi i32 [ %.pre24, %_ZN9benchmark9is_sortedIP12ValueWrapperIdEEEbT_S4_.exit.i.us.us ], [ %i.m, %bb.b ] ; 2 uses
  %i.t = add nuw nsw i32 %.010.us.us, 1           ; 2 uses
  %i.u = icmp slt i32 %i.t, %i.s
  br i1 %i.u, label %_ZN9benchmark4copyIP12ValueWrapperIdES3_EEvT_S4_T0_.exit.us.us, label %._crit_edge, !llvm.loop !83

.lr.ph.i.preheader.us:                            ; preds = %.lr.ph.i.preheader.us.preheader, %_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit.us
  %i.v = phi i32 [ %i.ai, %_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit.us ], [ %i.c, %.lr.ph.i.preheader.us.preheader ]
  %.010.us = phi i32 [ %i.aj, %_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit.us ], [ 0, %.lr.ph.i.preheader.us.preheader ]
  br i1 %or.cond, label %.lr.ph.i.us.preheader, label %vector.body60
...
vector.body60:                                    ; preds = %.lr.ph.i.preheader.us, %vector.body60
  ...
  %wide.load65 = load <2 x i64>, ptr %i.x, align 8, !tbaa !32
  %i.y = getelementptr i8, ptr %next.gep62, i64 16
  store <2 x i64> %wide.load64, ptr %next.gep62, align 8, !tbaa !32
  store <2 x i64> %wide.load65, ptr %i.y, align 8, !tbaa !32
  %index.next66 = add nuw i64 %index61, 4         ; 2 uses
  %i.z = icmp eq i64 %index.next66, %n.vec59
  br i1 %i.z, label %middle.block67, label %vector.body60, !llvm.loop !84
...
.lr.ph.i.us:                                      ; preds = %.lr.ph.i.us.preheader, %.lr.ph.i.us
  ...
  %i.ac = load i64, ptr %.046.i.us, align 8, !tbaa !32
  store i64 %i.ac, ptr %.07.i.us, align 8, !tbaa !32
  %.not.i.us = icmp eq ptr %i.aa, %1
...
bb.d:                                             ; preds = %_ZN9benchmark4copyIP12ValueWrapperIdES3_EEvT_S4_T0_.exit.loopexit.us
  %i.ad = load double, ptr %.08.i.i.us, align 8, !tbaa !52
  %i.ae = load double, ptr %.pn.i.i.us, align 8, !tbaa !52
  %i.af = fcmp olt double %i.ad, %i.ae
  br i1 %i.af, label %_ZN9benchmark9is_sortedIP12ValueWrapperIdEEEbT_S4_.exit.i.us, label %_ZN9benchmark4copyIP12ValueWrapperIdES3_EEvT_S4_T0_.exit.loopexit.us, !llvm.loop !82
...
_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit.us: ; preds = %_ZN9benchmark4copyIP12ValueWrapperIdES3_EEvT_S4_T0_.exit.loopexit.us, %_ZN9benchmark9is_sortedIP12ValueWrapperIdEEEbT_S4_.exit.i.us
  %i.ai = phi i32 [ %.pre23, %_ZN9benchmark9is_sortedIP12ValueWrapperIdEEEbT_S4_.exit.i.us ], [ %i.v, %_ZN9benchmark4copyIP12ValueWrapperIdES3_EEvT_S4_T0_.exit.loopexit.us ] ; 2 uses
  %i.aj = add nuw nsw i32 %.010.us, 1             ; 2 uses
  %i.ak = icmp slt i32 %i.aj, %i.ai
  br i1 %i.ak, label %.lr.ph.i.preheader.us, label %._crit_edge, !llvm.loop !83
...
_ZN9benchmark4copyIP12ValueWrapperIdES3_EEvT_S4_T0_.exit.us12: ; preds = %.lr.ph.split, %_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit.us17
  %i.at = phi i32 [ %i.be, %_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit.us17 ], [ %i.c, %.lr.ph.split ]
  %.010.us11 = phi i32 [ %i.bf, %_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit.us17 ], [ 0, %.lr.ph.split ]
  br label %.lr.ph.i8.us
...
.lr.ph.i8.us:                                     ; preds = %.critedge.i.us, %_ZN9benchmark4copyIP12ValueWrapperIdES3_EEvT_S4_T0_.exit.us12
  ...
  %i.au = load i64, ptr %.01622.i.us, align 8, !tbaa !32 ; 2 uses
  %i.av = bitcast i64 %i.au to double
  br label %bb.e

bb.e:                                             ; preds = %bb.f, %.lr.ph.i8.us
  %.019.i.us = phi ptr [ %.01622.i.us, %.lr.ph.i8.us ], [ %i.aw, %bb.f ] ; 3 uses
  %i.aw = getelementptr i8, ptr %.019.i.us, i64 -8 ; 3 uses
  %i.ax = load double, ptr %i.aw, align 8         ; 2 uses
  %i.ay = fcmp ogt double %i.ax, %i.av
  br i1 %i.ay, label %bb.f, label %.critedge.i.us

bb.f:                                             ; preds = %bb.e
  store double %i.ax, ptr %.019.i.us, align 8, !tbaa !32
  %.not17.i.us = icmp eq ptr %i.aw, %2
  br i1 %.not17.i.us, label %.critedge.i.us, label %bb.e, !llvm.loop !86

.critedge.i.us:                                   ; preds = %bb.f, %bb.e
  %.015.lcssa.i.us = phi ptr [ %2, %bb.f ], [ %.019.i.us, %bb.e ]
  store i64 %i.au, ptr %.015.lcssa.i.us, align 8, !tbaa !32
...
bb.g:                                             ; preds = %_ZN9benchmark13insertionSortIP12ValueWrapperIdES2_EEvT_S4_.exit.loopexit.us
  %i.az = load double, ptr %.08.i.i.us14, align 8, !tbaa !52
  %i.ba = load double, ptr %.pn.i.i.us13, align 8, !tbaa !52
  %i.bb = fcmp olt double %i.az, %i.ba
  br i1 %i.bb, label %_ZN9benchmark9is_sortedIP12ValueWrapperIdEEEbT_S4_.exit.i.us16, label %_ZN9benchmark13insertionSortIP12ValueWrapperIdES2_EEvT_S4_.exit.loopexit.us, !llvm.loop !82
...
_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit.us17: ; preds = %_ZN9benchmark13insertionSortIP12ValueWrapperIdES2_EEvT_S4_.exit.loopexit.us, %_ZN9benchmark9is_sortedIP12ValueWrapperIdEEEbT_S4_.exit.i.us16
  %i.be = phi i32 [ %.pre22, %_ZN9benchmark9is_sortedIP12ValueWrapperIdEEEbT_S4_.exit.i.us16 ], [ %i.at, %_ZN9benchmark13insertionSortIP12ValueWrapperIdES2_EEvT_S4_.exit.loopexit.us ] ; 2 uses
  %i.bf = add nuw nsw i32 %.010.us11, 1           ; 2 uses
  %i.bg = icmp slt i32 %i.bf, %i.be
  br i1 %i.bg, label %_ZN9benchmark4copyIP12ValueWrapperIdES3_EEvT_S4_T0_.exit.us12, label %._crit_edge, !llvm.loop !83

.lr.ph.i.preheader:                               ; preds = %.lr.ph.i.preheader.preheader, %_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit
  %i.bh = phi i32 [ %i.bz, %_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit ], [ %i.c, %.lr.ph.i.preheader.preheader ]
  %.010 = phi i32 [ %i.ca, %_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit ], [ 0, %.lr.ph.i.preheader.preheader ]
  br i1 %or.cond71, label %.lr.ph.i.preheader74, label %vector.body

vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %.lr.ph.i.preheader ] ; 2 uses
  %i.bi = shl i64 %index, 3                       ; 2 uses
  %next.gep = getelementptr i8, ptr %2, i64 %i.bi ; 2 uses
  %next.gep50 = getelementptr i8, ptr %0, i64 %i.bi ; 2 uses
  %i.bj = getelementptr i8, ptr %next.gep50, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep50, align 8, !tbaa !32
  %wide.load51 = load <2 x i64>, ptr %i.bj, align 8, !tbaa !32
  %i.bk = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 8, !tbaa !32
  store <2 x i64> %wide.load51, ptr %i.bk, align 8, !tbaa !32
  %index.next = add nuw i64 %index, 4             ; 2 uses
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader74, %.lr.ph.i
  %.07.i = phi ptr [ %i.bn, %.lr.ph.i ], [ %.07.i.ph, %.lr.ph.i.preheader74 ] ; 2 uses
  %.046.i = phi ptr [ %i.bm, %.lr.ph.i ], [ %.046.i.ph, %.lr.ph.i.preheader74 ] ; 2 uses
  %i.bm = getelementptr inbounds nuw i8, ptr %.046.i, i64 8 ; 2 uses
  %i.bn = getelementptr inbounds nuw i8, ptr %.07.i, i64 8
  %i.bo = load i64, ptr %.046.i, align 8, !tbaa !32
  store i64 %i.bo, ptr %.07.i, align 8, !tbaa !32
...
.lr.ph.i8:                                        ; preds = %.lr.ph.i8.preheader, %.critedge.i
  ...
  %i.bp = load i64, ptr %.01622.i, align 8, !tbaa !32 ; 2 uses
  %i.bq = bitcast i64 %i.bp to double
  br label %bb.h

bb.h:                                             ; preds = %bb.i, %.lr.ph.i8
  %.019.i = phi ptr [ %.01622.i, %.lr.ph.i8 ], [ %i.br, %bb.i ] ; 3 uses
  %i.br = getelementptr i8, ptr %.019.i, i64 -8   ; 3 uses
  %i.bs = load double, ptr %i.br, align 8         ; 2 uses
  %i.bt = fcmp ogt double %i.bs, %i.bq
  br i1 %i.bt, label %bb.i, label %.critedge.i

bb.i:                                             ; preds = %bb.h
  store double %i.bs, ptr %.019.i, align 8, !tbaa !32
  %.not17.i = icmp eq ptr %i.br, %2
  br i1 %.not17.i, label %.critedge.i, label %bb.h, !llvm.loop !86

.critedge.i:                                      ; preds = %bb.i, %bb.h
  %.015.lcssa.i = phi ptr [ %2, %bb.i ], [ %.019.i, %bb.h ]
  store i64 %i.bp, ptr %.015.lcssa.i, align 8, !tbaa !32
...
bb.j:                                             ; preds = %_ZN9benchmark13insertionSortIP12ValueWrapperIdES2_EEvT_S4_.exit.loopexit
  %i.bu = load double, ptr %.08.i.i, align 8, !tbaa !52
  %i.bv = load double, ptr %.pn.i.i, align 8, !tbaa !52
  %i.bw = fcmp olt double %i.bu, %i.bv
  br i1 %i.bw, label %_ZN9benchmark9is_sortedIP12ValueWrapperIdEEEbT_S4_.exit.i, label %_ZN9benchmark13insertionSortIP12ValueWrapperIdES2_EEvT_S4_.exit.loopexit, !llvm.loop !82
...
_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit: ; preds = %_ZN9benchmark13insertionSortIP12ValueWrapperIdES2_EEvT_S4_.exit.loopexit, %_ZN9benchmark9is_sortedIP12ValueWrapperIdEEEbT_S4_.exit.i
  %i.bz = phi i32 [ %.pre, %_ZN9benchmark9is_sortedIP12ValueWrapperIdEEEbT_S4_.exit.i ], [ %i.bh, %_ZN9benchmark13insertionSortIP12ValueWrapperIdES2_EEvT_S4_.exit.loopexit ] ; 2 uses
  %i.ca = add nuw nsw i32 %.010, 1                ; 2 uses
  %i.cb = icmp slt i32 %i.ca, %i.bz
  br i1 %i.cb, label %.lr.ph.i.preheader, label %._crit_edge, !llvm.loop !83
...
.lr.ph.i.preheader.us.preheader:                  ; preds = %.lr.ph.split.us
  ...
  %i.g = lshr i64 %i.f, 3
  %i.h = add nuw nsw i64 %i.g, 1                  ; 2 uses
  %min.iters.check64 = icmp ult i64 %i.f, 24
  %i.i = sub i64 %i.a, %i.b
  %diff.check62 = icmp ugt i64 %i.i, -32
  %or.cond = select i1 %min.iters.check64, i1 true, i1 %diff.check62
  %n.vec67 = and i64 %i.h, 4611686018427387900    ; 3 uses
  %i.j = shl i64 %n.vec67, 3                      ; 2 uses
  %i.k = getelementptr i8, ptr %0, i64 %i.j
  %i.l = getelementptr i8, ptr %2, i64 %i.j
  %cmp.n76 = icmp eq i64 %i.h, %n.vec67
  br label %.lr.ph.i.preheader.us
...
_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.us.us: ; preds = %.lr.ph.split.us, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit.us.us
  %i.m = phi i32 [ %i.t, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit.us.us ], [ %i.c, %.lr.ph.split.us ]
  %.015.us.us = phi i32 [ %i.u, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit.us.us ], [ 0, %.lr.ph.split.us ]
  br label %bb.b

bb.b:                                             ; preds = %bb.c, %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.us.us
  %.sroa.04.0.i.i.us.us = phi ptr [ %2, %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.us.us ], [ %i.n, %bb.c ] ; 2 uses
  %i.n = getelementptr i8, ptr %.sroa.04.0.i.i.us.us, i64 8 ; 3 uses
  %.not.i.i.us.us = icmp eq ptr %i.n, %3
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.p = load double, ptr %.sroa.04.0.i.i.us.us, align 8, !tbaa !52
  %i.q = fcmp olt double %i.o, %i.p
  br i1 %i.q, label %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i.us.us, label %bb.b, !llvm.loop !90
...
_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit.us.us: ; preds = %bb.b, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i.us.us
  %i.t = phi i32 [ %.pre28, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i.us.us ], [ %i.m, %bb.b ] ; 2 uses
  %i.u = add nuw nsw i32 %.015.us.us, 1           ; 2 uses
  %i.v = icmp slt i32 %i.u, %i.t
  br i1 %i.v, label %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.us.us, label %._crit_edge, !llvm.loop !91
...
.lr.ph.i.preheader.us:                            ; preds = %.lr.ph.i.preheader.us.preheader, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit.us
  %i.w = phi i32 [ %i.ak, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit.us ], [ %i.c, %.lr.ph.i.preheader.us.preheader ]
  %.015.us = phi i32 [ %i.al, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit.us ], [ 0, %.lr.ph.i.preheader.us.preheader ]
...
vector.body68:                                    ; preds = %.lr.ph.i.preheader.us, %vector.body68
  ...
  %i.x = shl i64 %index69, 3                      ; 2 uses
  %next.gep70 = getelementptr i8, ptr %0, i64 %i.x ; 2 uses
  %next.gep71 = getelementptr i8, ptr %2, i64 %i.x ; 2 uses
  %i.y = getelementptr i8, ptr %next.gep70, i64 16
  %wide.load72 = load <2 x i64>, ptr %next.gep70, align 8, !tbaa !32
  %wide.load73 = load <2 x i64>, ptr %i.y, align 8, !tbaa !32
  %i.z = getelementptr i8, ptr %next.gep71, i64 16
  store <2 x i64> %wide.load72, ptr %next.gep71, align 8, !tbaa !32
  store <2 x i64> %wide.load73, ptr %i.z, align 8, !tbaa !32
  %index.next74 = add nuw i64 %index69, 4         ; 2 uses
  %i.aa = icmp eq i64 %index.next74, %n.vec67
  br i1 %i.aa, label %middle.block75, label %vector.body68, !llvm.loop !92
...
.lr.ph.i.us.preheader:                            ; preds = %.lr.ph.i.preheader.us, %middle.block75
  %.sroa.05.08.i.us.ph = phi ptr [ %0, %.lr.ph.i.preheader.us ], [ %i.k, %middle.block75 ]
  %.sroa.03.07.i.us.ph = phi ptr [ %2, %.lr.ph.i.preheader.us ], [ %i.l, %middle.block75 ]
  br label %.lr.ph.i.us
...
.lr.ph.i.us:                                      ; preds = %.lr.ph.i.us.preheader, %.lr.ph.i.us
  ...
  %i.ad = load i64, ptr %.sroa.05.08.i.us, align 8, !tbaa !32
  store i64 %i.ad, ptr %.sroa.03.07.i.us, align 8, !tbaa !32
  %.not.i.us = icmp eq ptr %i.ab, %1
...
_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.loopexit.us: ; preds = %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.loopexit.us.preheader, %bb.d
  %.sroa.04.0.i.i.us = phi ptr [ %i.ae, %bb.d ], [ %2, %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.loopexit.us.preheader ] ; 2 uses
  %i.ae = getelementptr i8, ptr %.sroa.04.0.i.i.us, i64 8 ; 3 uses
  %.not.i.i.us = icmp eq ptr %i.ae, %3
...
bb.d:                                             ; preds = %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.loopexit.us
  %i.af = load double, ptr %i.ae, align 8, !tbaa !52
  %i.ag = load double, ptr %.sroa.04.0.i.i.us, align 8, !tbaa !52
  %i.ah = fcmp olt double %i.af, %i.ag
  br i1 %i.ah, label %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i.us, label %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.loopexit.us, !llvm.loop !90
...
_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit.us: ; preds = %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.loopexit.us, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i.us
  %i.ak = phi i32 [ %.pre27, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i.us ], [ %i.w, %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.loopexit.us ] ; 2 uses
  %i.al = add nuw nsw i32 %.015.us, 1             ; 2 uses
  %i.am = icmp slt i32 %i.al, %i.ak
  br i1 %i.am, label %.lr.ph.i.preheader.us, label %._crit_edge, !llvm.loop !91
...
_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.us17: ; preds = %.lr.ph.split, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit.us21
  %i.av = phi i32 [ %i.bh, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit.us21 ], [ %i.c, %.lr.ph.split ]
  %.015.us16 = phi i32 [ %i.bi, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit.us21 ], [ 0, %.lr.ph.split ]
...
.lr.ph.i13.us:                                    ; preds = %.critedge.i.us, %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.us17
  ...
  %i.aw = load i64, ptr %.sroa.010.019.i.us, align 8, !tbaa !32 ; 2 uses
  %i.ax = bitcast i64 %i.aw to double
  br label %bb.e

bb.e:                                             ; preds = %bb.f, %.lr.ph.i13.us
  %.sroa.0.016.i.us = phi ptr [ %.sroa.010.019.i.us, %.lr.ph.i13.us ], [ %i.ay, %bb.f ] ; 3 uses
  %i.ay = getelementptr i8, ptr %.sroa.0.016.i.us, i64 -8 ; 3 uses
  %i.az = load double, ptr %i.ay, align 8         ; 2 uses
  %i.ba = fcmp ogt double %i.az, %i.ax
  br i1 %i.ba, label %bb.f, label %.critedge.i.us

bb.f:                                             ; preds = %bb.e
  store double %i.az, ptr %.sroa.0.016.i.us, align 8, !tbaa !32
  %.not14.i.us = icmp eq ptr %i.ay, %2
  br i1 %.not14.i.us, label %.critedge.i.us, label %bb.e, !llvm.loop !94

.critedge.i.us:                                   ; preds = %bb.f, %bb.e
  %.sroa.05.0.lcssa.i.us = phi ptr [ %2, %bb.f ], [ %.sroa.0.016.i.us, %bb.e ]
  store i64 %i.aw, ptr %.sroa.05.0.lcssa.i.us, align 8, !tbaa !32
  %.sroa.010.0.i.us = getelementptr inbounds nuw i8, ptr %.sroa.010.019.i.us, i64 8 ; 2 uses
...
_ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIdEES3_EEvT_S5_.exit.loopexit.us: ; preds = %.critedge.i.us, %bb.g
  %.sroa.04.0.i.i.us18 = phi ptr [ %i.bb, %bb.g ], [ %2, %.critedge.i.us ] ; 2 uses
  %i.bb = getelementptr i8, ptr %.sroa.04.0.i.i.us18, i64 8 ; 3 uses
  %.not.i.i.us19 = icmp eq ptr %i.bb, %3
...
bb.g:                                             ; preds = %_ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIdEES3_EEvT_S5_.exit.loopexit.us
  ...
  %i.bd = load double, ptr %.sroa.04.0.i.i.us18, align 8, !tbaa !52
  %i.be = fcmp olt double %i.bc, %i.bd
  br i1 %i.be, label %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i.us20, label %_ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIdEES3_EEvT_S5_.exit.loopexit.us, !llvm.loop !90
...
_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i.us20: ; preds = %bb.g
  ...
  %i.bg = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.51, i32 noundef %i.bf) ; 0 uses
  %.pre26 = load i32, ptr @iterations, align 4, !tbaa !4
...
_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit.us21: ; preds = %_ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIdEES3_EEvT_S5_.exit.loopexit.us, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i.us20
  %i.bh = phi i32 [ %.pre26, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i.us20 ], [ %i.av, %_ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIdEES3_EEvT_S5_.exit.loopexit.us ] ; 2 uses
  %i.bi = add nuw nsw i32 %.015.us16, 1           ; 2 uses
  %i.bj = icmp slt i32 %i.bi, %i.bh
  br i1 %i.bj, label %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.us17, label %._crit_edge, !llvm.loop !91

.lr.ph.i.preheader:                               ; preds = %.lr.ph.i.preheader.preheader, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit
  %i.bk = phi i32 [ %i.cd, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit ], [ %i.c, %.lr.ph.i.preheader.preheader ]
  %.015 = phi i32 [ %i.ce, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit ], [ 0, %.lr.ph.i.preheader.preheader ]
  br i1 %or.cond79, label %.lr.ph.i.preheader82, label %vector.body

vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %.lr.ph.i.preheader ] ; 2 uses
  %i.bl = shl i64 %index, 3                       ; 2 uses
  %next.gep = getelementptr i8, ptr %0, i64 %i.bl ; 2 uses
  %next.gep58 = getelementptr i8, ptr %2, i64 %i.bl ; 2 uses
  %i.bm = getelementptr i8, ptr %next.gep, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep, align 8, !tbaa !32
  %wide.load59 = load <2 x i64>, ptr %i.bm, align 8, !tbaa !32
  %i.bn = getelementptr i8, ptr %next.gep58, i64 16
  store <2 x i64> %wide.load, ptr %next.gep58, align 8, !tbaa !32
  store <2 x i64> %wide.load59, ptr %i.bn, align 8, !tbaa !32
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.bo = icmp eq i64 %index.next, %n.vec
  br i1 %i.bo, label %middle.block, label %vector.body, !llvm.loop !96
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader82, %.lr.ph.i
  %.sroa.05.08.i = phi ptr [ %i.bp, %.lr.ph.i ], [ %.sroa.05.08.i.ph, %.lr.ph.i.preheader82 ] ; 2 uses
  %.sroa.03.07.i = phi ptr [ %i.bq, %.lr.ph.i ], [ %.sroa.03.07.i.ph, %.lr.ph.i.preheader82 ] ; 2 uses
  %i.bp = getelementptr inbounds nuw i8, ptr %.sroa.05.08.i, i64 8 ; 2 uses
  %i.bq = getelementptr inbounds nuw i8, ptr %.sroa.03.07.i, i64 8
  %i.br = load i64, ptr %.sroa.05.08.i, align 8, !tbaa !32
  store i64 %i.br, ptr %.sroa.03.07.i, align 8, !tbaa !32
  %.not.i = icmp eq ptr %i.bp, %1
...
.lr.ph.i13:                                       ; preds = %.lr.ph.i13.preheader, %.critedge.i
  ...
  %i.bs = load i64, ptr %.sroa.010.019.i, align 8, !tbaa !32 ; 2 uses
  %i.bt = bitcast i64 %i.bs to double
  br label %bb.h

bb.h:                                             ; preds = %bb.i, %.lr.ph.i13
  %.sroa.0.016.i = phi ptr [ %.sroa.010.019.i, %.lr.ph.i13 ], [ %i.bu, %bb.i ] ; 3 uses
  %i.bu = getelementptr i8, ptr %.sroa.0.016.i, i64 -8 ; 3 uses
  %i.bv = load double, ptr %i.bu, align 8         ; 2 uses
  %i.bw = fcmp ogt double %i.bv, %i.bt
  br i1 %i.bw, label %bb.i, label %.critedge.i

bb.i:                                             ; preds = %bb.h
  store double %i.bv, ptr %.sroa.0.016.i, align 8, !tbaa !32
  %.not14.i = icmp eq ptr %i.bu, %2
  br i1 %.not14.i, label %.critedge.i, label %bb.h, !llvm.loop !94

.critedge.i:                                      ; preds = %bb.i, %bb.h
  %.sroa.05.0.lcssa.i = phi ptr [ %2, %bb.i ], [ %.sroa.0.016.i, %bb.h ]
  store i64 %i.bs, ptr %.sroa.05.0.lcssa.i, align 8, !tbaa !32
  %.sroa.010.0.i = getelementptr inbounds nuw i8, ptr %.sroa.010.019.i, i64 8 ; 2 uses
...
_ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIdEES3_EEvT_S5_.exit.loopexit: ; preds = %.critedge.i, %bb.j
  %.sroa.04.0.i.i = phi ptr [ %i.bx, %bb.j ], [ %2, %.critedge.i ] ; 2 uses
  %i.bx = getelementptr i8, ptr %.sroa.04.0.i.i, i64 8 ; 3 uses
  %.not.i.i = icmp eq ptr %i.bx, %3
...
bb.j:                                             ; preds = %_ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIdEES3_EEvT_S5_.exit.loopexit
  ...
  %i.bz = load double, ptr %.sroa.04.0.i.i, align 8, !tbaa !52
  %i.ca = fcmp olt double %i.by, %i.bz
  br i1 %i.ca, label %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i, label %_ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIdEES3_EEvT_S5_.exit.loopexit, !llvm.loop !90

_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i: ; preds = %bb.j
  %i.cb = load i32, ptr @current_test, align 4, !tbaa !4
  %i.cc = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.51, i32 noundef %i.cb) ; 0 uses
  %.pre = load i32, ptr @iterations, align 4, !tbaa !4
...
_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit: ; preds = %_ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIdEES3_EEvT_S5_.exit.loopexit, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i
  %i.cd = phi i32 [ %.pre, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i ], [ %i.bk, %_ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIdEES3_EEvT_S5_.exit.loopexit ] ; 2 uses
  %i.ce = add nuw nsw i32 %.015, 1                ; 2 uses
  %i.cf = icmp slt i32 %i.ce, %i.cd
  br i1 %i.cf, label %.lr.ph.i.preheader, label %._crit_edge, !llvm.loop !91
...
_ZN9benchmark4copyIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESC_EEvT_SD_T0_.exit.us.us: ; preds = %.lr.ph.split.us, %_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit.us.us
  %i.m = phi i32 [ %i.s, %_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit.us.us ], [ %i.c, %.lr.ph.split.us ]
  %.010.us.us = phi i32 [ %i.t, %_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit.us.us ], [ 0, %.lr.ph.split.us ]
  br label %bb.b
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.o = load double, ptr %.pn.i.i.us.us, align 8, !tbaa !52
  %i.p = fcmp olt double %i.n, %i.o
  br i1 %i.p, label %_ZN9benchmark9is_sortedIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEbT_SD_.exit.i.us.us, label %bb.b, !llvm.loop !98
...
_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit.us.us: ; preds = %bb.b, %_ZN9benchmark9is_sortedIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEbT_SD_.exit.i.us.us
  %i.s = phi i32 [ %.pre24, %_ZN9benchmark9is_sortedIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEbT_SD_.exit.i.us.us ], [ %i.m, %bb.b ] ; 2 uses
  %i.t = add nuw nsw i32 %.010.us.us, 1           ; 2 uses
  %i.u = icmp slt i32 %i.t, %i.s
  br i1 %i.u, label %_ZN9benchmark4copyIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESC_EEvT_SD_T0_.exit.us.us, label %._crit_edge, !llvm.loop !99
...
.lr.ph.i.preheader.us:                            ; preds = %.lr.ph.i.preheader.us.preheader, %_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit.us
  %i.v = phi i32 [ %i.ai, %_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit.us ], [ %i.c, %.lr.ph.i.preheader.us.preheader ]
  %.010.us = phi i32 [ %i.aj, %_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit.us ], [ 0, %.lr.ph.i.preheader.us.preheader ]
  br i1 %or.cond, label %.lr.ph.i.us.preheader, label %vector.body60
...
vector.body60:                                    ; preds = %.lr.ph.i.preheader.us, %vector.body60
  ...
  %index.next66 = add nuw i64 %index61, 4         ; 2 uses
  %i.z = icmp eq i64 %index.next66, %n.vec59
  br i1 %i.z, label %middle.block67, label %vector.body60, !llvm.loop !100
...
bb.d:                                             ; preds = %_ZN9benchmark4copyIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESC_EEvT_SD_T0_.exit.loopexit.us
  ...
  %i.ae = load double, ptr %.pn.i.i.us, align 8, !tbaa !52
  %i.af = fcmp olt double %i.ad, %i.ae
  br i1 %i.af, label %_ZN9benchmark9is_sortedIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEbT_SD_.exit.i.us, label %_ZN9benchmark4copyIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESC_EEvT_SD_T0_.exit.loopexit.us, !llvm.loop !98
...
_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit.us: ; preds = %_ZN9benchmark4copyIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESC_EEvT_SD_T0_.exit.loopexit.us, %_ZN9benchmark9is_sortedIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEbT_SD_.exit.i.us
  %i.ai = phi i32 [ %.pre23, %_ZN9benchmark9is_sortedIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEbT_SD_.exit.i.us ], [ %i.v, %_ZN9benchmark4copyIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESC_EEvT_SD_T0_.exit.loopexit.us ] ; 2 uses
  %i.aj = add nuw nsw i32 %.010.us, 1             ; 2 uses
  %i.ak = icmp slt i32 %i.aj, %i.ai
  br i1 %i.ak, label %.lr.ph.i.preheader.us, label %._crit_edge, !llvm.loop !99
...
_ZN9benchmark4copyIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESC_EEvT_SD_T0_.exit.us12: ; preds = %.lr.ph.split, %_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit.us17
  %i.at = phi i32 [ %i.be, %_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit.us17 ], [ %i.c, %.lr.ph.split ]
  %.010.us11 = phi i32 [ %i.bf, %_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit.us17 ], [ 0, %.lr.ph.split ]
  br label %.lr.ph.i8.us
...
bb.g:                                             ; preds = %_ZN9benchmark13insertionSortIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESB_EEvT_SD_.exit.loopexit.us
  ...
  %i.ba = load double, ptr %.pn.i.i.us13, align 8, !tbaa !52
  %i.bb = fcmp olt double %i.az, %i.ba
  br i1 %i.bb, label %_ZN9benchmark9is_sortedIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEbT_SD_.exit.i.us16, label %_ZN9benchmark13insertionSortIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESB_EEvT_SD_.exit.loopexit.us, !llvm.loop !98
...
_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit.us17: ; preds = %_ZN9benchmark13insertionSortIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESB_EEvT_SD_.exit.loopexit.us, %_ZN9benchmark9is_sortedIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEbT_SD_.exit.i.us16
  %i.be = phi i32 [ %.pre22, %_ZN9benchmark9is_sortedIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEbT_SD_.exit.i.us16 ], [ %i.at, %_ZN9benchmark13insertionSortIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESB_EEvT_SD_.exit.loopexit.us ] ; 2 uses
  %i.bf = add nuw nsw i32 %.010.us11, 1           ; 2 uses
  %i.bg = icmp slt i32 %i.bf, %i.be
  br i1 %i.bg, label %_ZN9benchmark4copyIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESC_EEvT_SD_T0_.exit.us12, label %._crit_edge, !llvm.loop !99
...
.lr.ph.i.preheader:                               ; preds = %.lr.ph.i.preheader.preheader, %_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit
  %i.bh = phi i32 [ %i.bz, %_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit ], [ %i.c, %.lr.ph.i.preheader.preheader ]
  %.010 = phi i32 [ %i.ca, %_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit ], [ 0, %.lr.ph.i.preheader.preheader ]
  br i1 %or.cond71, label %.lr.ph.i.preheader74, label %vector.body
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.bl = icmp eq i64 %index.next, %n.vec
  br i1 %i.bl, label %middle.block, label %vector.body, !llvm.loop !104
...
bb.j:                                             ; preds = %_ZN9benchmark13insertionSortIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESB_EEvT_SD_.exit.loopexit
  ...
  %i.bv = load double, ptr %.pn.i.i, align 8, !tbaa !52
  %i.bw = fcmp olt double %i.bu, %i.bv
  br i1 %i.bw, label %_ZN9benchmark9is_sortedIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEbT_SD_.exit.i, label %_ZN9benchmark13insertionSortIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESB_EEvT_SD_.exit.loopexit, !llvm.loop !98
...
_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit: ; preds = %_ZN9benchmark13insertionSortIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESB_EEvT_SD_.exit.loopexit, %_ZN9benchmark9is_sortedIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEbT_SD_.exit.i
  %i.bz = phi i32 [ %.pre, %_ZN9benchmark9is_sortedIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEbT_SD_.exit.i ], [ %i.bh, %_ZN9benchmark13insertionSortIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESB_EEvT_SD_.exit.loopexit ] ; 2 uses
  %i.ca = add nuw nsw i32 %.010, 1                ; 2 uses
  %i.cb = icmp slt i32 %i.ca, %i.bz
  br i1 %i.cb, label %.lr.ph.i.preheader, label %._crit_edge, !llvm.loop !99
...
_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.us.us: ; preds = %.lr.ph.split.us, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit.us.us
  %i.m = phi i32 [ %i.t, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit.us.us ], [ %i.c, %.lr.ph.split.us ]
  %.015.us.us = phi i32 [ %i.u, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit.us.us ], [ 0, %.lr.ph.split.us ]
  br label %bb.b
...
bb.b:                                             ; preds = %bb.c, %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.us.us
  %.sroa.04.0.i.i.us.us = phi ptr [ %2, %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.us.us ], [ %i.n, %bb.c ] ; 2 uses
  %i.n = getelementptr i8, ptr %.sroa.04.0.i.i.us.us, i64 8 ; 3 uses
  %.not.i.i.us.us = icmp eq ptr %i.n, %3
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.p = load double, ptr %.sroa.04.0.i.i.us.us, align 8, !tbaa !52
  %i.q = fcmp olt double %i.o, %i.p
  br i1 %i.q, label %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEEbT_SE_.exit.i.us.us, label %bb.b, !llvm.loop !106
...
_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit.us.us: ; preds = %bb.b, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEEbT_SE_.exit.i.us.us
  %i.t = phi i32 [ %.pre28, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEEbT_SE_.exit.i.us.us ], [ %i.m, %bb.b ] ; 2 uses
  %i.u = add nuw nsw i32 %.015.us.us, 1           ; 2 uses
  %i.v = icmp slt i32 %i.u, %i.t
  br i1 %i.v, label %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.us.us, label %._crit_edge, !llvm.loop !107
...
.lr.ph.i.preheader.us:                            ; preds = %.lr.ph.i.preheader.us.preheader, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit.us
  %i.w = phi i32 [ %i.ak, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit.us ], [ %i.c, %.lr.ph.i.preheader.us.preheader ]
  %.015.us = phi i32 [ %i.al, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit.us ], [ 0, %.lr.ph.i.preheader.us.preheader ]
  br i1 %or.cond, label %.lr.ph.i.us.preheader, label %vector.body68
...
vector.body68:                                    ; preds = %.lr.ph.i.preheader.us, %vector.body68
  ...
  %index.next74 = add nuw i64 %index69, 4         ; 2 uses
  %i.aa = icmp eq i64 %index.next74, %n.vec67
  br i1 %i.aa, label %middle.block75, label %vector.body68, !llvm.loop !108
...
_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.loopexit.us: ; preds = %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.loopexit.us.preheader, %bb.d
  %.sroa.04.0.i.i.us = phi ptr [ %i.ae, %bb.d ], [ %2, %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.loopexit.us.preheader ] ; 2 uses
  %i.ae = getelementptr i8, ptr %.sroa.04.0.i.i.us, i64 8 ; 3 uses
  %.not.i.i.us = icmp eq ptr %i.ae, %3
...
bb.d:                                             ; preds = %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.loopexit.us
  ...
  %i.ag = load double, ptr %.sroa.04.0.i.i.us, align 8, !tbaa !52
  %i.ah = fcmp olt double %i.af, %i.ag
  br i1 %i.ah, label %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEEbT_SE_.exit.i.us, label %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.loopexit.us, !llvm.loop !106
...
_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit.us: ; preds = %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.loopexit.us, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEEbT_SE_.exit.i.us
  %i.ak = phi i32 [ %.pre27, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEEbT_SE_.exit.i.us ], [ %i.w, %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.loopexit.us ] ; 2 uses
  %i.al = add nuw nsw i32 %.015.us, 1             ; 2 uses
  %i.am = icmp slt i32 %i.al, %i.ak
  br i1 %i.am, label %.lr.ph.i.preheader.us, label %._crit_edge, !llvm.loop !107
...
_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.us17: ; preds = %.lr.ph.split, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit.us21
  %i.av = phi i32 [ %i.bh, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit.us21 ], [ %i.c, %.lr.ph.split ]
  %.015.us16 = phi i32 [ %i.bi, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit.us21 ], [ 0, %.lr.ph.split ]
  br label %.lr.ph.i13.us
...
bb.g:                                             ; preds = %_ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESC_EEvT_SE_.exit.loopexit.us
  ...
  %i.bd = load double, ptr %.sroa.04.0.i.i.us18, align 8, !tbaa !52
  %i.be = fcmp olt double %i.bc, %i.bd
  br i1 %i.be, label %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEEbT_SE_.exit.i.us20, label %_ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESC_EEvT_SE_.exit.loopexit.us, !llvm.loop !106
...
_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit.us21: ; preds = %_ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESC_EEvT_SE_.exit.loopexit.us, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEEbT_SE_.exit.i.us20
  %i.bh = phi i32 [ %.pre26, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEEbT_SE_.exit.i.us20 ], [ %i.av, %_ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESC_EEvT_SE_.exit.loopexit.us ] ; 2 uses
  %i.bi = add nuw nsw i32 %.015.us16, 1           ; 2 uses
  %i.bj = icmp slt i32 %i.bi, %i.bh
  br i1 %i.bj, label %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.us17, label %._crit_edge, !llvm.loop !107
...
.lr.ph.i.preheader:                               ; preds = %.lr.ph.i.preheader.preheader, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit
  %i.bk = phi i32 [ %i.cd, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit ], [ %i.c, %.lr.ph.i.preheader.preheader ]
  %.015 = phi i32 [ %i.ce, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit ], [ 0, %.lr.ph.i.preheader.preheader ]
  br i1 %or.cond79, label %.lr.ph.i.preheader82, label %vector.body
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.bo = icmp eq i64 %index.next, %n.vec
  br i1 %i.bo, label %middle.block, label %vector.body, !llvm.loop !112
...
bb.j:                                             ; preds = %_ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESC_EEvT_SE_.exit.loopexit
  ...
  %i.bz = load double, ptr %.sroa.04.0.i.i, align 8, !tbaa !52
  %i.ca = fcmp olt double %i.by, %i.bz
  br i1 %i.ca, label %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEEbT_SE_.exit.i, label %_ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESC_EEvT_SE_.exit.loopexit, !llvm.loop !106
...
_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit: ; preds = %_ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESC_EEvT_SE_.exit.loopexit, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEEbT_SE_.exit.i
  %i.cd = phi i32 [ %.pre, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEEbT_SE_.exit.i ], [ %i.bk, %_ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESC_EEvT_SE_.exit.loopexit ] ; 2 uses
  %i.ce = add nuw nsw i32 %.015, 1                ; 2 uses
  %i.cf = icmp slt i32 %i.ce, %i.cd
  br i1 %i.cf, label %.lr.ph.i.preheader, label %._crit_edge, !llvm.loop !107
...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %i.o, label %_ZN9benchmark9is_sortedIPdEEbT_S2_.exit.i.us, label %bb.b, !llvm.loop !66
...
_Z13verify_sortedIPdEvT_S1_.exit.us:              ; preds = %bb.b, %_ZN9benchmark9is_sortedIPdEEbT_S2_.exit.i.us
  ...
  br i1 %i.t, label %_ZN9benchmark4copyIPdS1_EEvT_S2_T0_.exit.us, label %._crit_edge, !llvm.loop !114
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  br i1 %i.x, label %middle.block, label %vector.body, !llvm.loop !115
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %i.ad, label %_ZN9benchmark9is_sortedIPdEEbT_S2_.exit.i, label %bb.d, !llvm.loop !66

_ZN9benchmark9is_sortedIPdEEbT_S2_.exit.i:        ; preds = %bb.e
  %i.ae = load i32, ptr @current_test, align 4, !tbaa !4
  %i.af = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.51, i32 noundef %i.ae) ; 0 uses
  br label %_Z13verify_sortedIPdEvT_S1_.exit
...
_Z13verify_sortedIPdEvT_S1_.exit:                 ; preds = %bb.d, %_ZN9benchmark9is_sortedIPdEEbT_S2_.exit.i
  ...
  br i1 %i.ai, label %.lr.ph.i.preheader, label %._crit_edge, !llvm.loop !114
...
_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.us: ; preds = %.lr.ph, %_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit.us
  %.012.us = phi i32 [ %i.s, %_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit.us ], [ 0, %.lr.ph ]
...
bb.b:                                             ; preds = %bb.c, %_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.us
  %.sroa.04.0.i.i.us = phi ptr [ %2, %_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.us ], [ %i.m, %bb.c ] ; 2 uses
  %i.m = getelementptr i8, ptr %.sroa.04.0.i.i.us, i64 8 ; 3 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.o = load double, ptr %.sroa.04.0.i.i.us, align 8, !tbaa !32
  %i.p = fcmp olt double %i.n, %i.o
  br i1 %i.p, label %_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i.us, label %bb.b, !llvm.loop !74
...
_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit.us: ; preds = %bb.b, %_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i.us
  ...
  br i1 %i.u, label %_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.us, label %._crit_edge, !llvm.loop !117

.lr.ph.i.preheader:                               ; preds = %.lr.ph.i.preheader.preheader, %_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit
  %.012 = phi i32 [ %i.ai, %_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit ], [ 0, %.lr.ph.i.preheader.preheader ]
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  br i1 %i.y, label %middle.block, label %vector.body, !llvm.loop !118
...
.lr.ph.i.preheader24:                             ; preds = %.lr.ph.i.preheader, %middle.block
  %.sroa.05.08.i.ph = phi ptr [ %0, %.lr.ph.i.preheader ], [ %i.k, %middle.block ]
  %.sroa.03.07.i.ph = phi ptr [ %2, %.lr.ph.i.preheader ], [ %i.l, %middle.block ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader24, %.lr.ph.i
  %.sroa.05.08.i = phi ptr [ %i.z, %.lr.ph.i ], [ %.sroa.05.08.i.ph, %.lr.ph.i.preheader24 ] ; 2 uses
  %.sroa.03.07.i = phi ptr [ %i.ab, %.lr.ph.i ], [ %.sroa.03.07.i.ph, %.lr.ph.i.preheader24 ] ; 2 uses
  %i.z = getelementptr inbounds nuw i8, ptr %.sroa.05.08.i, i64 8 ; 2 uses
  %i.aa = load double, ptr %.sroa.05.08.i, align 8, !tbaa !32
  %i.ab = getelementptr inbounds nuw i8, ptr %.sroa.03.07.i, i64 8
  store double %i.aa, ptr %.sroa.03.07.i, align 8, !tbaa !32
...
bb.d:                                             ; preds = %bb.e, %_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.loopexit
  %.sroa.04.0.i.i = phi ptr [ %2, %_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.loopexit ], [ %i.ac, %bb.e ] ; 2 uses
  %i.ac = getelementptr i8, ptr %.sroa.04.0.i.i, i64 8 ; 3 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ae = load double, ptr %.sroa.04.0.i.i, align 8, !tbaa !32
  %i.af = fcmp olt double %i.ad, %i.ae
  br i1 %i.af, label %_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i, label %bb.d, !llvm.loop !74
...
_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit: ; preds = %bb.d, %_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i
  ...
  br i1 %i.ak, label %.lr.ph.i.preheader, label %._crit_edge, !llvm.loop !117
...
_ZN9benchmark4copyIP12ValueWrapperIdES3_EEvT_S4_T0_.exit.us: ; preds = %.lr.ph, %_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit.us
  %.08.us = phi i32 [ %i.r, %_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit.us ], [ 0, %.lr.ph ]
...
bb.c:                                             ; preds = %bb.b
  %i.m = load double, ptr %.08.i.i.us, align 8, !tbaa !52
  %i.n = load double, ptr %.pn.i.i.us, align 8, !tbaa !52
  %i.o = fcmp olt double %i.m, %i.n
  br i1 %i.o, label %_ZN9benchmark9is_sortedIP12ValueWrapperIdEEEbT_S4_.exit.i.us, label %bb.b, !llvm.loop !82
...
_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit.us: ; preds = %bb.b, %_ZN9benchmark9is_sortedIP12ValueWrapperIdEEEbT_S4_.exit.i.us
  ...
  %i.s = load i32, ptr @iterations, align 4, !tbaa !4
  %i.t = icmp slt i32 %i.r, %i.s
  br i1 %i.t, label %_ZN9benchmark4copyIP12ValueWrapperIdES3_EEvT_S4_T0_.exit.us, label %._crit_edge, !llvm.loop !120

.lr.ph.i.preheader:                               ; preds = %.lr.ph.i.preheader.preheader, %_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit
  %.08 = phi i32 [ %i.ag, %_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit ], [ 0, %.lr.ph.i.preheader.preheader ]
  br i1 %or.cond, label %.lr.ph.i.preheader18, label %vector.body
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  %wide.load16 = load <2 x i64>, ptr %i.v, align 8, !tbaa !32
  %i.w = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 8, !tbaa !32
  store <2 x i64> %wide.load16, ptr %i.w, align 8, !tbaa !32
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.x = icmp eq i64 %index.next, %n.vec
  br i1 %i.x, label %middle.block, label %vector.body, !llvm.loop !121
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader18, %.lr.ph.i
  ...
  %i.aa = load i64, ptr %.046.i, align 8, !tbaa !32
  store i64 %i.aa, ptr %.07.i, align 8, !tbaa !32
  %.not.i = icmp eq ptr %i.y, %1
...
bb.e:                                             ; preds = %bb.d
  %i.ab = load double, ptr %.08.i.i, align 8, !tbaa !52
  %i.ac = load double, ptr %.pn.i.i, align 8, !tbaa !52
  %i.ad = fcmp olt double %i.ab, %i.ac
  br i1 %i.ad, label %_ZN9benchmark9is_sortedIP12ValueWrapperIdEEEbT_S4_.exit.i, label %bb.d, !llvm.loop !82
...
_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit: ; preds = %bb.d, %_ZN9benchmark9is_sortedIP12ValueWrapperIdEEEbT_S4_.exit.i
  ...
  %i.ah = load i32, ptr @iterations, align 4, !tbaa !4
  %i.ai = icmp slt i32 %i.ag, %i.ah
  br i1 %i.ai, label %.lr.ph.i.preheader, label %._crit_edge, !llvm.loop !120
...
_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.us: ; preds = %.lr.ph, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit.us
  %.013.us = phi i32 [ %i.s, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit.us ], [ 0, %.lr.ph ]
...
bb.b:                                             ; preds = %bb.c, %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.us
  %.sroa.04.0.i.i.us = phi ptr [ %2, %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.us ], [ %i.m, %bb.c ] ; 2 uses
  %i.m = getelementptr i8, ptr %.sroa.04.0.i.i.us, i64 8 ; 3 uses
  %.not.i.i.us = icmp eq ptr %i.m, %3
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.o = load double, ptr %.sroa.04.0.i.i.us, align 8, !tbaa !52
  %i.p = fcmp olt double %i.n, %i.o
  br i1 %i.p, label %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i.us, label %bb.b, !llvm.loop !90
...
_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit.us: ; preds = %bb.b, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i.us
  %i.s = add nuw nsw i32 %.013.us, 1              ; 2 uses
  %i.t = load i32, ptr @iterations, align 4, !tbaa !4
  %i.u = icmp slt i32 %i.s, %i.t
  br i1 %i.u, label %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.us, label %._crit_edge, !llvm.loop !123

.lr.ph.i.preheader:                               ; preds = %.lr.ph.i.preheader.preheader, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit
  %.013 = phi i32 [ %i.ai, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit ], [ 0, %.lr.ph.i.preheader.preheader ]
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  %i.v = shl i64 %index, 3                        ; 2 uses
  %next.gep = getelementptr i8, ptr %0, i64 %i.v  ; 2 uses
  %next.gep22 = getelementptr i8, ptr %2, i64 %i.v ; 2 uses
  %i.w = getelementptr i8, ptr %next.gep, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep, align 8, !tbaa !32
  %wide.load23 = load <2 x i64>, ptr %i.w, align 8, !tbaa !32
  %i.x = getelementptr i8, ptr %next.gep22, i64 16
  store <2 x i64> %wide.load, ptr %next.gep22, align 8, !tbaa !32
  store <2 x i64> %wide.load23, ptr %i.x, align 8, !tbaa !32
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.y = icmp eq i64 %index.next, %n.vec
  br i1 %i.y, label %middle.block, label %vector.body, !llvm.loop !124
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader25, %.lr.ph.i
  %.sroa.05.08.i = phi ptr [ %i.z, %.lr.ph.i ], [ %.sroa.05.08.i.ph, %.lr.ph.i.preheader25 ] ; 2 uses
  %.sroa.03.07.i = phi ptr [ %i.aa, %.lr.ph.i ], [ %.sroa.03.07.i.ph, %.lr.ph.i.preheader25 ] ; 2 uses
  %i.z = getelementptr inbounds nuw i8, ptr %.sroa.05.08.i, i64 8 ; 2 uses
  %i.aa = getelementptr inbounds nuw i8, ptr %.sroa.03.07.i, i64 8
  %i.ab = load i64, ptr %.sroa.05.08.i, align 8, !tbaa !32
  store i64 %i.ab, ptr %.sroa.03.07.i, align 8, !tbaa !32
  %.not.i = icmp eq ptr %i.z, %1
...
bb.d:                                             ; preds = %bb.e, %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.loopexit
  %.sroa.04.0.i.i = phi ptr [ %2, %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.loopexit ], [ %i.ac, %bb.e ] ; 2 uses
  %i.ac = getelementptr i8, ptr %.sroa.04.0.i.i, i64 8 ; 3 uses
  %.not.i.i = icmp eq ptr %i.ac, %3
  br i1 %.not.i.i, label %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.ad = load double, ptr %i.ac, align 8, !tbaa !52
  %i.ae = load double, ptr %.sroa.04.0.i.i, align 8, !tbaa !52
  %i.af = fcmp olt double %i.ad, %i.ae
  br i1 %i.af, label %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i, label %bb.d, !llvm.loop !90
...
_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit: ; preds = %bb.d, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i
  %i.ai = add nuw nsw i32 %.013, 1                ; 2 uses
  %i.aj = load i32, ptr @iterations, align 4, !tbaa !4
  %i.ak = icmp slt i32 %i.ai, %i.aj
  br i1 %i.ak, label %.lr.ph.i.preheader, label %._crit_edge, !llvm.loop !123
...
_ZN9benchmark4copyIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESC_EEvT_SD_T0_.exit.us: ; preds = %.lr.ph, %_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit.us
  %.08.us = phi i32 [ %i.r, %_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit.us ], [ 0, %.lr.ph ]
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.n = load double, ptr %.pn.i.i.us, align 8, !tbaa !52
  %i.o = fcmp olt double %i.m, %i.n
  br i1 %i.o, label %_ZN9benchmark9is_sortedIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEbT_SD_.exit.i.us, label %bb.b, !llvm.loop !98
...
_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit.us: ; preds = %bb.b, %_ZN9benchmark9is_sortedIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEbT_SD_.exit.i.us
  ...
  %i.s = load i32, ptr @iterations, align 4, !tbaa !4
  %i.t = icmp slt i32 %i.r, %i.s
  br i1 %i.t, label %_ZN9benchmark4copyIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESC_EEvT_SD_T0_.exit.us, label %._crit_edge, !llvm.loop !126

.lr.ph.i.preheader:                               ; preds = %.lr.ph.i.preheader.preheader, %_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit
  %.08 = phi i32 [ %i.ag, %_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit ], [ 0, %.lr.ph.i.preheader.preheader ]
  br i1 %or.cond, label %.lr.ph.i.preheader18, label %vector.body
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.x = icmp eq i64 %index.next, %n.vec
  br i1 %i.x, label %middle.block, label %vector.body, !llvm.loop !127
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ac = load double, ptr %.pn.i.i, align 8, !tbaa !52
  %i.ad = fcmp olt double %i.ab, %i.ac
  br i1 %i.ad, label %_ZN9benchmark9is_sortedIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEbT_SD_.exit.i, label %bb.d, !llvm.loop !98
...
_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit: ; preds = %bb.d, %_ZN9benchmark9is_sortedIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEbT_SD_.exit.i
  ...
  %i.ah = load i32, ptr @iterations, align 4, !tbaa !4
  %i.ai = icmp slt i32 %i.ag, %i.ah
  br i1 %i.ai, label %.lr.ph.i.preheader, label %._crit_edge, !llvm.loop !126
...
_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.us: ; preds = %.lr.ph, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit.us
  %.013.us = phi i32 [ %i.s, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit.us ], [ 0, %.lr.ph ]
...
bb.b:                                             ; preds = %bb.c, %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.us
  %.sroa.04.0.i.i.us = phi ptr [ %2, %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.us ], [ %i.m, %bb.c ] ; 2 uses
  %i.m = getelementptr i8, ptr %.sroa.04.0.i.i.us, i64 8 ; 3 uses
  %.not.i.i.us = icmp eq ptr %i.m, %3
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.o = load double, ptr %.sroa.04.0.i.i.us, align 8, !tbaa !52
  %i.p = fcmp olt double %i.n, %i.o
  br i1 %i.p, label %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEEbT_SE_.exit.i.us, label %bb.b, !llvm.loop !106
...
_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit.us: ; preds = %bb.b, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEEbT_SE_.exit.i.us
  ...
  %i.t = load i32, ptr @iterations, align 4, !tbaa !4
  %i.u = icmp slt i32 %i.s, %i.t
  br i1 %i.u, label %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.us, label %._crit_edge, !llvm.loop !129

.lr.ph.i.preheader:                               ; preds = %.lr.ph.i.preheader.preheader, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit
  %.013 = phi i32 [ %i.ai, %_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit ], [ 0, %.lr.ph.i.preheader.preheader ]
  br i1 %or.cond, label %.lr.ph.i.preheader25, label %vector.body
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.y = icmp eq i64 %index.next, %n.vec
  br i1 %i.y, label %middle.block, label %vector.body, !llvm.loop !130
...
bb.d:                                             ; preds = %bb.e, %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.loopexit
  %.sroa.04.0.i.i = phi ptr [ %2, %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.loopexit ], [ %i.ac, %bb.e ] ; 2 uses
  %i.ac = getelementptr i8, ptr %.sroa.04.0.i.i, i64 8 ; 3 uses
  %.not.i.i = icmp eq ptr %i.ac, %3
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ae = load double, ptr %.sroa.04.0.i.i, align 8, !tbaa !52
  %i.af = fcmp olt double %i.ad, %i.ae
  br i1 %i.af, label %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEEbT_SE_.exit.i, label %bb.d, !llvm.loop !106
...
_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit: ; preds = %bb.d, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEEbT_SE_.exit.i
  ...
  %i.aj = load i32, ptr @iterations, align 4, !tbaa !4
  %i.ak = icmp slt i32 %i.ai, %i.aj
  br i1 %i.ak, label %.lr.ph.i.preheader, label %._crit_edge, !llvm.loop !129
...
_Z13verify_sortedIPdEvT_S1_.exit.us:              ; preds = %bb.b, %_ZN9benchmark9is_sortedIPdEEbT_S2_.exit.i.us
  ...
  %i.s = load i32, ptr @iterations, align 4, !tbaa !4
  %i.t = icmp slt i32 %i.r, %i.s
  br i1 %i.t, label %_ZN9benchmark4copyIPdS1_EEvT_S2_T0_.exit.us, label %._crit_edge, !llvm.loop !132
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.x = icmp eq i64 %index.next, %n.vec
  br i1 %i.x, label %middle.block, label %vector.body, !llvm.loop !133
...
_Z13verify_sortedIPdEvT_S1_.exit:                 ; preds = %bb.d, %_ZN9benchmark9is_sortedIPdEEbT_S2_.exit.i
  ...
  %i.ah = load i32, ptr @iterations, align 4, !tbaa !4
  %i.ai = icmp slt i32 %i.ag, %i.ah
  br i1 %i.ai, label %.lr.ph.i.preheader, label %._crit_edge, !llvm.loop !132
...
_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit.us: ; preds = %bb.b, %_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i.us
  ...
  %i.t = load i32, ptr @iterations, align 4, !tbaa !4
  %i.u = icmp slt i32 %i.s, %i.t
  br i1 %i.u, label %_ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_.exit.us, label %._crit_edge, !llvm.loop !135
...
_Z13verify_sortedI14PointerWrapperIdEEvT_S2_.exit: ; preds = %bb.d, %_ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_.exit.i
  ...
  %i.aj = load i32, ptr @iterations, align 4, !tbaa !4
  %i.ak = icmp slt i32 %i.ai, %i.aj
  br i1 %i.ak, label %.lr.ph.i.preheader, label %._crit_edge, !llvm.loop !135
...
_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit.us: ; preds = %bb.b, %_ZN9benchmark9is_sortedIP12ValueWrapperIdEEEbT_S4_.exit.i.us
  ...
  %i.s = load i32, ptr @iterations, align 4, !tbaa !4
  %i.t = icmp slt i32 %i.r, %i.s
  br i1 %i.t, label %_ZN9benchmark4copyIP12ValueWrapperIdES3_EEvT_S4_T0_.exit.us, label %._crit_edge, !llvm.loop !138
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.x = icmp eq i64 %index.next, %n.vec
  br i1 %i.x, label %middle.block, label %vector.body, !llvm.loop !139
...
_Z13verify_sortedIP12ValueWrapperIdEEvT_S3_.exit: ; preds = %bb.d, %_ZN9benchmark9is_sortedIP12ValueWrapperIdEEEbT_S4_.exit.i
  ...
  %i.ah = load i32, ptr @iterations, align 4, !tbaa !4
  %i.ai = icmp slt i32 %i.ag, %i.ah
  br i1 %i.ai, label %.lr.ph.i.preheader, label %._crit_edge, !llvm.loop !138
...
_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit.us: ; preds = %bb.b, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i.us
  ...
  %i.t = load i32, ptr @iterations, align 4, !tbaa !4
  %i.u = icmp slt i32 %i.s, %i.t
  br i1 %i.u, label %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_.exit.us, label %._crit_edge, !llvm.loop !141
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.y = icmp eq i64 %index.next, %n.vec
  br i1 %i.y, label %middle.block, label %vector.body, !llvm.loop !142
...
_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_.exit: ; preds = %bb.d, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIdEEEEbT_S5_.exit.i
  ...
  %i.aj = load i32, ptr @iterations, align 4, !tbaa !4
  %i.ak = icmp slt i32 %i.ai, %i.aj
  br i1 %i.ak, label %.lr.ph.i.preheader, label %._crit_edge, !llvm.loop !141
...
_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit.us: ; preds = %bb.b, %_ZN9benchmark9is_sortedIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEbT_SD_.exit.i.us
  ...
  %i.s = load i32, ptr @iterations, align 4, !tbaa !4
  %i.t = icmp slt i32 %i.r, %i.s
  br i1 %i.t, label %_ZN9benchmark4copyIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESC_EEvT_SD_T0_.exit.us, label %._crit_edge, !llvm.loop !144
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.x = icmp eq i64 %index.next, %n.vec
  br i1 %i.x, label %middle.block, label %vector.body, !llvm.loop !145
...
_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_.exit: ; preds = %bb.d, %_ZN9benchmark9is_sortedIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEbT_SD_.exit.i
  ...
  %i.ah = load i32, ptr @iterations, align 4, !tbaa !4
  %i.ai = icmp slt i32 %i.ag, %i.ah
  br i1 %i.ai, label %.lr.ph.i.preheader, label %._crit_edge, !llvm.loop !144
...
_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit.us: ; preds = %bb.b, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEEbT_SE_.exit.i.us
  ...
  %i.t = load i32, ptr @iterations, align 4, !tbaa !4
  %i.u = icmp slt i32 %i.s, %i.t
  br i1 %i.u, label %_ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_.exit.us, label %._crit_edge, !llvm.loop !147
...
vector.body:                                      ; preds = %.lr.ph.i.preheader, %vector.body
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.y = icmp eq i64 %index.next, %n.vec
  br i1 %i.y, label %middle.block, label %vector.body, !llvm.loop !148
...
_Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_.exit: ; preds = %bb.d, %_ZN9benchmark9is_sortedI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEEbT_SE_.exit.i
  ...
  %i.aj = load i32, ptr @iterations, align 4, !tbaa !4
  %i.ak = icmp slt i32 %i.ai, %i.aj
  br i1 %i.ak, label %.lr.ph.i.preheader, label %._crit_edge, !llvm.loop !147
