...
.lr.ph.i:                                         ; preds = %.split.i
  ...
  %4 = tail call double @llvm.fmuladd.f64(double %i.az, double %i.az, double %i.bk)
  %sqrt.i.i.i = tail call double @llvm.sqrt.f64(double %4)
  %5 = insertelement <2 x i1> poison, i1 %i.bc, i64 0
  %6 = shufflevector <2 x i1> %5, <2 x i1> poison, <2 x i32> zeroinitializer ; 3 uses
  %i.bl = insertelement <2 x double> poison, double %i.bg, i64 0
  %i.bm = insertelement <2 x double> %i.bl, double %i.bf, i64 1
  %i.bn = insertelement <2 x double> <double 0.000000e+00, double poison>, double %i.be, i64 1
  %i.bo = select <2 x i1> %6, <2 x double> %i.bm, <2 x double> %i.bn ; 3 uses
  %7 = fmul double %i.bi, %i.az                   ; 3 uses
  %8 = fneg double %7
  %9 = fmul double %i.az, %8
  %i.bp = insertelement <2 x double> <double poison, double -0.000000e+00>, double %7, i64 0 ; 2 uses
  %10 = shufflevector <2 x double> %i.au, <2 x double> <double poison, double 0.000000e+00>, <2 x i32> <i32 1, i32 3> ; 2 uses
  %11 = insertelement <2 x double> poison, double %i.bh, i64 0
  %12 = insertelement <2 x double> %11, double %7, i64 1
  %13 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bp, <2 x double> %10, <2 x double> %12)
  %14 = insertelement <2 x double> %i.au, double 1.000000e+00, i64 0
  %15 = select <2 x i1> %6, <2 x double> %13, <2 x double> %14 ; 3 uses
  %i.bq = insertelement <2 x double> %i.bp, double %9, i64 1
  %16 = select <2 x i1> %6, <2 x double> %i.bq, <2 x double> %10 ; 3 uses
  %foldExtExtBinop = fmul <2 x double> %16, %16
  %17 = shufflevector <2 x double> <double poison, double -0.000000e+00>, <2 x double> %foldExtExtBinop, <2 x i32> <i32 3, i32 1>
  %18 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bo, <2 x double> %i.bo, <2 x double> %17)
  %i.br = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %15, <2 x double> %15, <2 x double> %18)
...
DistribVector.exit.i:                             ; preds = %DistribVector.exit.i, %.lr.ph.i
  ...
  %i.co = fmul <2 x double> %i.bo, %i.cl
  %i.cp = shufflevector <2 x double> %i.cl, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.cq = fmul <2 x double> %16, %i.cp
  %foldExtExtBinop33 = fmul <2 x double> %15, %i.cl
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.n = fsub double %i.k, %i.m                   ; 10 uses
...
.lr.ph:                                           ; preds = %bb.e
  ...
  %13 = tail call double @llvm.fmuladd.f64(double %i.v, double %i.v, double %i.ad)
  %i.ae = tail call double @llvm.fmuladd.f64(double %i.n, double %i.n, double %13)
  %sqrt.i = tail call double @llvm.sqrt.f64(double %i.ae) ; 2 uses
  %14 = fdiv double %i.ac, %sqrt.i
  ...
  %15 = insertelement <2 x i1> poison, i1 %i.ag, i64 0
  %16 = shufflevector <2 x i1> %15, <2 x i1> poison, <2 x i32> zeroinitializer ; 3 uses
  %i.am = insertelement <2 x double> poison, double %i.aj, i64 0
  %17 = insertelement <2 x double> %i.am, double %i.ai, i64 1
  %i.an = insertelement <2 x double> <double 0.000000e+00, double poison>, double %i.ah, i64 1
  %18 = select <2 x i1> %16, <2 x double> %17, <2 x double> %i.an ; 3 uses
  %19 = fmul double %i.t, %i.n                    ; 3 uses
  %20 = fneg double %19
  %21 = fmul double %i.n, %20
  %i.ao = insertelement <2 x double> <double poison, double -0.000000e+00>, double %19, i64 0 ; 2 uses
  %22 = shufflevector <2 x double> <double poison, double 0.000000e+00>, <2 x double> %i.j, <2 x i32> <i32 3, i32 1> ; 2 uses
  %i.ap = insertelement <2 x double> poison, double %i.ak, i64 0
  %i.aq = insertelement <2 x double> %i.ap, double %19, i64 1
  %23 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ao, <2 x double> %22, <2 x double> %i.aq)
  %i.ar = insertelement <2 x double> %i.j, double 1.000000e+00, i64 0
  %i.as = select <2 x i1> %16, <2 x double> %23, <2 x double> %i.ar ; 3 uses
  %i.at = insertelement <2 x double> %i.ao, double %21, i64 1
  %24 = select <2 x i1> %16, <2 x double> %i.at, <2 x double> %22 ; 3 uses
  %foldExtExtBinop = fmul <2 x double> %24, %24
  %25 = shufflevector <2 x double> <double poison, double -0.000000e+00>, <2 x double> %foldExtExtBinop, <2 x i32> <i32 3, i32 1>
  %26 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %18, <2 x double> %18, <2 x double> %25)
  %i.au = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.as, <2 x double> %i.as, <2 x double> %26)
  ...
  %i.ba = insertelement <2 x double> poison, double %14, i64 0
...
DistribVector.exit:                               ; preds = %.lr.ph, %DistribVector.exit
  ...
  %i.bs = fmul <2 x double> %18, %i.bp
  %i.bt = shufflevector <2 x double> %i.bp, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.bu = fmul <2 x double> %24, %i.bt
  %foldExtExtBinop131.a = fmul <2 x double> %i.as, %i.bp
...
.lr.ph93:                                         ; preds = %.preheader
  ...
  %.102 = select i1 %i.eu, double %i.ew, double %i.ev
  %.106 = select i1 %i.eu, double %i.ex, double 0.000000e+00
  %i.fe = fmul double %i.es, %i.ez                ; 3 uses
  %i.ff = fneg double %i.fe
  %i.fg = fmul double %i.es, %i.ff
  %27 = tail call double @llvm.fmuladd.f64(double %i.ei, double %i.ei, double %i.fa)
  %i.fh = insertelement <2 x double> %i.el, double %i.fe, i64 0
  %i.fi = insertelement <2 x double> poison, double %i.ey, i64 0
  %i.fj = insertelement <2 x double> %i.fi, double %27, i64 1
  ...
  %.103.a = select i1 %i.eu, double %i.fm, double 1.000000e+00 ; 2 uses
  %.102.a = select i1 %i.eu, double %i.fg, double 0.000000e+00 ; 3 uses
  %.106.a = select i1 %i.eu, double %i.fe, double %i.ez ; 2 uses
  %i.fn = fmul double %.102.a, %.102.a
  %28 = insertelement <2 x double> poison, double %.106, i64 0
  %29 = insertelement <2 x double> %28, double %.102, i64 1 ; 3 uses
  %i.fo = insertelement <2 x double> <double poison, double -0.000000e+00>, double %i.fn, i64 0
  %30 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %29, <2 x double> %29, <2 x double> %i.fo)
  %i.fp = insertelement <2 x double> poison, double %.103.a, i64 0
  %i.fq = insertelement <2 x double> %i.fp, double %.106.a, i64 1 ; 2 uses
  %i.fr = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.fq, <2 x double> %i.fq, <2 x double> %30)
  ...
  %i.fx = insertelement <2 x double> poison, double %.106.a, i64 0
  %i.fy = insertelement <2 x double> %i.fx, double %.102.a, i64 1
