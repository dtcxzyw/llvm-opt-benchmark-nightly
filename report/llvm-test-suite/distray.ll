...
.lr.ph.i:                                         ; preds = %.split.i
  ...
  %i.bo = insertelement <2 x double> <double poison, double -0.000000e+00>, double %i.bl, i64 0 ; 2 uses
  %4 = shufflevector <2 x double> %i.au, <2 x double> <double poison, double 0.000000e+00>, <2 x i32> <i32 1, i32 3> ; 2 uses
  %i.bp = insertelement <2 x double> poison, double %i.bh, i64 0
  %i.bq = insertelement <2 x double> %i.bp, double %i.bl, i64 1
  %i.br = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bo, <2 x double> %4, <2 x double> %i.bq)
  %i.bs = insertelement <2 x i1> poison, i1 %i.bc, i64 0
  %i.bt = shufflevector <2 x i1> %i.bs, <2 x i1> poison, <2 x i32> zeroinitializer ; 3 uses
  %5 = insertelement <2 x double> %i.au, double 1.000000e+00, i64 0
  %6 = select <2 x i1> %i.bt, <2 x double> %i.br, <2 x double> %5 ; 3 uses
  %i.bu = insertelement <2 x double> %i.bo, double %i.bn, i64 1
  %i.bv = select <2 x i1> %i.bt, <2 x double> %i.bu, <2 x double> %4 ; 3 uses
  %7 = insertelement <2 x double> poison, double %i.bg, i64 0
  %8 = insertelement <2 x double> %7, double %i.bf, i64 1
  %9 = insertelement <2 x double> <double 0.000000e+00, double poison>, double %i.be, i64 1
  %10 = select <2 x i1> %i.bt, <2 x double> %8, <2 x double> %9 ; 4 uses
  %foldExtExtBinop = fmul <2 x double> %10, %10
  %foldExtExtBinop31 = fmul <2 x double> %i.bv, %i.bv
  %11 = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %i.bw = insertelement <2 x double> %11, double %i.az, i64 0 ; 2 uses
  %i.bx = insertelement <2 x double> %foldExtExtBinop31, double %i.bk, i64 0
  %i.by = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bw, <2 x double> %i.bw, <2 x double> %i.bx) ; 2 uses
  %12 = extractelement <2 x double> %i.by, i64 0
  %sqrt.i.i.i = tail call double @llvm.sqrt.f64(double %12)
  %13 = shufflevector <2 x double> %i.by, <2 x double> %foldExtExtBinop, <2 x i32> <i32 1, i32 3>
  %14 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> %6, <2 x double> %13)
  %15 = fadd <2 x double> %14, <double -0.000000e+00, double 0.000000e+00>
  %16 = tail call <2 x double> @llvm.sqrt.v2f64(<2 x double> %15)
  %i.bz = insertelement <2 x double> poison, double %sqrt.i.i.i, i64 0
  %17 = shufflevector <2 x double> %i.bz, <2 x double> poison, <2 x i32> zeroinitializer
  %18 = fdiv <2 x double> %17, %16
  %19 = fmul <2 x double> %18, <double f0x3F51111111111111, double 7.812500e-04>
...
DistribVector.exit.i:                             ; preds = %DistribVector.exit.i, %.lr.ph.i
  ...
  %i.cf = add i64 %i.ce, 12345                    ; 2 uses
  %20 = insertelement <2 x i64> poison, i64 %i.cf, i64 0
  %21 = insertelement <2 x i64> %20, i64 %i.cd, i64 1
  %22 = and <2 x i64> %21, splat (i64 2147483647)
  %23 = and i64 %i.cf, 2147483647
  %i.cg = uitofp nneg <2 x i64> %22 to <2 x double>
  %i.ch = fdiv nnan <2 x double> %i.cg, splat (double f0x41CFFFFFFF800000)
  %i.ci = fsub nnan <2 x double> splat (double 1.000000e+00), %i.ch
  %i.cj = fmul <2 x double> %19, %i.ci            ; 4 uses
  %i.ck = extractelement <2 x double> %i.cj, i64 1
  %i.cl = fmul double %i.ck, 0.000000e+00
  store i64 %23, ptr @rnd, align 8, !tbaa !18
  %i.cm = fmul <2 x double> %10, %i.cj
  %i.cn = shufflevector <2 x double> %i.cj, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.co = fmul <2 x double> %i.bv, %i.cn
  %foldExtExtBinop.a = fmul <2 x double> %6, %i.cj
...
bb.c:                                             ; preds = %bb.b
  %13 = load <2 x double>, ptr @Lightpos, align 16, !tbaa !14
  %14 = load <2 x double>, ptr %4, align 16, !tbaa !14
  %15 = fsub <2 x double> %13, %14                ; 7 uses
  store <2 x double> %15, ptr %6, align 16, !tbaa !14
  %16 = load double, ptr getelementptr inbounds nuw (i8, ptr @Lightpos, i64 16), align 16, !tbaa !16
  %i.h = getelementptr inbounds nuw i8, ptr %4, i64 16
  %17 = load double, ptr %i.h, align 16, !tbaa !16
  %18 = fsub double %16, %17                      ; 9 uses
  %19 = getelementptr inbounds nuw i8, ptr %6, i64 16
  store double %18, ptr %19, align 16, !tbaa !16
  %20 = load double, ptr %5, align 8, !tbaa !26   ; 6 uses
  %21 = getelementptr inbounds nuw i8, ptr %5, i64 8
  %22 = load <2 x double>, ptr %21, align 8, !tbaa !14 ; 8 uses
  %23 = extractelement <2 x double> %22, i64 0
  %24 = extractelement <2 x double> %15, i64 1    ; 4 uses
  %25 = fmul double %24, %23
  %i.i = extractelement <2 x double> %15, i64 0   ; 4 uses
  %i.j = tail call double @llvm.fmuladd.f64(double %i.i, double %20, double %25)
  %i.k = extractelement <2 x double> %22, i64 1   ; 4 uses
  %i.l = tail call double @llvm.fmuladd.f64(double %18, double %i.k, double %i.j) ; 2 uses
...
.lr.ph:                                           ; preds = %bb.e
  ...
  %i.q = tail call double @llvm.fmuladd.f64(double %i.i, double %i.i, double %26)
  %rnd.promoted = load i64, ptr @rnd, align 8
  %i.r = tail call double @llvm.fabs.f64(double %18)
  %i.s = fcmp ogt double %i.r, 1.000000e-05
  %i.t = fneg double %i.i                         ; 3 uses
  %i.u = fmul double %18, %i.t                    ; 3 uses
  %i.v = fmul double %18, %i.u
  %i.w = fmul double %i.u, %i.t
  %i.x = getelementptr inbounds nuw i8, ptr %7, i64 16 ; 2 uses
  %i.y = fmul double %24, %18                     ; 3 uses
  %i.z = fneg double %i.y
  %i.aa = fmul double %18, %i.z
  %i.ab = insertelement <2 x double> <double poison, double -0.000000e+00>, double %i.y, i64 0 ; 2 uses
  %27 = shufflevector <2 x double> <double poison, double 0.000000e+00>, <2 x double> %15, <2 x i32> <i32 3, i32 1> ; 2 uses
  %i.ac = insertelement <2 x double> poison, double %i.w, i64 0
  %28 = insertelement <2 x double> %i.ac, double %i.y, i64 1
  %29 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ab, <2 x double> %27, <2 x double> %28)
  %30 = insertelement <2 x i1> poison, i1 %i.s, i64 0
  %31 = shufflevector <2 x i1> %30, <2 x i1> poison, <2 x i32> zeroinitializer ; 3 uses
  %32 = insertelement <2 x double> %15, double 1.000000e+00, i64 0
  %33 = select <2 x i1> %31, <2 x double> %29, <2 x double> %32 ; 3 uses
  %i.ad = insertelement <2 x double> %i.ab, double %i.aa, i64 1
  %34 = select <2 x i1> %31, <2 x double> %i.ad, <2 x double> %27 ; 3 uses
  %35 = insertelement <2 x double> poison, double %i.v, i64 0
  %36 = insertelement <2 x double> %35, double %i.u, i64 1
  %37 = insertelement <2 x double> <double 0.000000e+00, double poison>, double %i.t, i64 1
  %38 = select <2 x i1> %31, <2 x double> %36, <2 x double> %37 ; 4 uses
  %foldExtExtBinop = fmul <2 x double> %38, %38
  %foldExtExtBinop129 = fmul <2 x double> %34, %34
  %39 = shufflevector <2 x double> %38, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %i.ae = insertelement <2 x double> %39, double %18, i64 0 ; 2 uses
  %i.af = insertelement <2 x double> %foldExtExtBinop129, double %i.q, i64 0
  %i.ag = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ae, <2 x double> %i.ae, <2 x double> %i.af) ; 2 uses
  %40 = extractelement <2 x double> %i.ag, i64 0
  %sqrt.i = tail call double @llvm.sqrt.f64(double %40) ; 2 uses
  %41 = fdiv double %i.p, %sqrt.i
  %42 = shufflevector <2 x double> %i.ag, <2 x double> %foldExtExtBinop, <2 x i32> <i32 1, i32 3>
  %43 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %33, <2 x double> %33, <2 x double> %42)
  %44 = fadd <2 x double> %43, <double -0.000000e+00, double 0.000000e+00>
  %45 = tail call <2 x double> @llvm.sqrt.v2f64(<2 x double> %44)
  %46 = insertelement <2 x double> poison, double %sqrt.i, i64 0
  %47 = shufflevector <2 x double> %46, <2 x double> poison, <2 x i32> zeroinitializer
  %48 = fdiv <2 x double> %47, %45
  %i.ah = insertelement <2 x double> poison, double %41, i64 0
  %49 = shufflevector <2 x double> %i.ah, <2 x double> poison, <2 x i32> zeroinitializer
...
DistribVector.exit:                               ; preds = %.lr.ph, %DistribVector.exit
  ...
  %i.ai = phi i64 [ %rnd.promoted, %.lr.ph ], [ %54, %DistribVector.exit ]
  ...
  %i.am = add i64 %i.al, 12345                    ; 2 uses
  %51 = insertelement <2 x i64> poison, i64 %i.am, i64 0
  %52 = insertelement <2 x i64> %51, i64 %i.ak, i64 1
  %53 = and <2 x i64> %52, splat (i64 2147483647)
  %54 = and i64 %i.am, 2147483647                 ; 2 uses
  %i.an = uitofp nneg <2 x i64> %53 to <2 x double>
  %i.ao = fdiv nnan <2 x double> %i.an, splat (double f0x41CFFFFFFF800000)
  %i.ap = fsub nnan <2 x double> splat (double 1.000000e+00), %i.ao
  %i.aq = fmul <2 x double> %50, %i.ap            ; 4 uses
  %i.ar = extractelement <2 x double> %i.aq, i64 1
  %i.as = fmul double %i.ar, 0.000000e+00
  store i64 %54, ptr @rnd, align 8, !tbaa !18
  %i.at = fmul <2 x double> %38, %i.aq
  %i.au = shufflevector <2 x double> %i.aq, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.av = fmul <2 x double> %34, %i.au
...
bb.g:                                             ; preds = %select.unfold
  %55 = shufflevector <2 x double> %15, <2 x double> %22, <2 x i32> <i32 1, i32 2> ; 2 uses
  %i.bp = fmul <2 x double> %55, %55
  %i.bq = insertelement <2 x double> %15, double %20, i64 1 ; 2 uses
  %i.br = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bq, <2 x double> %i.bq, <2 x double> %i.bp)
  %56 = insertelement <2 x double> %22, double %18, i64 0 ; 2 uses
  %i.bs = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %56, <2 x double> %56, <2 x double> %i.br) ; 2 uses
...
bb.h:                                             ; preds = %.thread
  %foldExtExtBinop135 = fmul <2 x double> %22, %22
  %i.cu = extractelement <2 x double> %foldExtExtBinop135, i64 0
  %i.cv = tail call double @llvm.fmuladd.f64(double %20, double %20, double %i.cu)
  ...
  %foldExtExtBinop137 = fmul <2 x double> %22, %i.da
  %i.db = extractelement <2 x double> %foldExtExtBinop137, i64 0
  %i.dc = tail call double @llvm.fmuladd.f64(double %i.cx, double %20, double %i.db)
  ...
  %i.dh = tail call double @llvm.fmuladd.f64(double %i.dg, double %20, double %i.cx) ; 4 uses
  ...
  %i.dk = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.dj, <2 x double> %22, <2 x double> %i.da) ; 7 uses
