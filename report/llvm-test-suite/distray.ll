...
.split.i:                                         ; preds = %.split.i.preheader, %._crit_edge.i
  ...
  %i.au = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.at, <2 x double> %i.ah, <2 x double> %i.as) ; 6 uses
...
.lr.ph.i:                                         ; preds = %.split.i
  ...
  %i.bl = fmul double %i.bi, %i.az                ; 4 uses
  ...
  %i.bw = shufflevector <2 x i1> %i.bv, <2 x i1> poison, <2 x i32> zeroinitializer ; 3 uses
  ...
  %i.ca = select <2 x i1> %i.bw, <2 x double> %i.by, <2 x double> %i.bz ; 3 uses
  %4 = insertelement <2 x double> poison, double %i.bl, i64 0
  %5 = insertelement <2 x double> %4, double %i.bn, i64 1
  %6 = shufflevector <2 x double> %i.au, <2 x double> <double poison, double 0.000000e+00>, <2 x i32> <i32 1, i32 3>
  %7 = select <2 x i1> %i.bw, <2 x double> %5, <2 x double> %6 ; 3 uses
  %8 = insertelement <2 x double> poison, double %i.bg, i64 0
  %9 = insertelement <2 x double> %8, double %i.bf, i64 1
  %i.cb = insertelement <2 x double> <double 0.000000e+00, double poison>, double %i.be, i64 1
  %10 = select <2 x i1> %i.bw, <2 x double> %9, <2 x double> %i.cb ; 4 uses
  %foldExtExtBinop = fmul <2 x double> %10, %10
  %foldExtExtBinop31 = fmul <2 x double> %7, %7
  %11 = extractelement <2 x double> %foldExtExtBinop31, i64 1
  %12 = extractelement <2 x double> %10, i64 0    ; 2 uses
  %13 = tail call double @llvm.fmuladd.f64(double %12, double %12, double %11)
  %i.cc = insertelement <2 x double> %foldExtExtBinop, double %13, i64 0
  %14 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ca, <2 x double> %i.ca, <2 x double> %i.cc)
  ...
  %17 = shufflevector <2 x double> %i.cd, <2 x double> poison, <2 x i32> zeroinitializer
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.o = fsub <2 x double> %i.m, %i.n             ; 12 uses
...
.lr.ph:                                           ; preds = %bb.e
  ...
  %i.af = fcmp ogt double %i.ae, 1.000000e-05
  ...
  %i.al = fmul double %i.q, %i.p                  ; 4 uses
  ...
  %i.av = shufflevector <2 x i1> %i.au, <2 x i1> poison, <2 x i32> zeroinitializer ; 3 uses
  ...
  %i.ay = select <2 x i1> %i.av, <2 x double> %i.aw, <2 x double> %i.ax ; 3 uses
  %13 = insertelement <2 x double> poison, double %i.al, i64 0
  %14 = insertelement <2 x double> %13, double %i.an, i64 1
  %15 = insertelement <2 x double> %i.o, double 0.000000e+00, i64 1
  %16 = select <2 x i1> %i.av, <2 x double> %14, <2 x double> %15 ; 3 uses
  %17 = insertelement <2 x double> poison, double %i.ai, i64 0
  %18 = insertelement <2 x double> %17, double %i.ah, i64 1
  %i.az = insertelement <2 x double> <double 0.000000e+00, double poison>, double %i.ag, i64 1
  %19 = select <2 x i1> %i.av, <2 x double> %18, <2 x double> %i.az ; 4 uses
  %foldExtExtBinop131 = fmul <2 x double> %19, %19
  %foldExtExtBinop133 = fmul <2 x double> %16, %16
  %20 = extractelement <2 x double> %foldExtExtBinop133, i64 1
  %21 = extractelement <2 x double> %19, i64 0    ; 2 uses
  %22 = tail call double @llvm.fmuladd.f64(double %21, double %21, double %20)
  %i.ba = insertelement <2 x double> %foldExtExtBinop131, double %22, i64 0
  %23 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ay, <2 x double> %i.ay, <2 x double> %i.ba)
  %24 = fadd <2 x double> %23, <double -0.000000e+00, double 0.000000e+00>
  %25 = tail call <2 x double> @llvm.sqrt.v2f64(<2 x double> %24)
  %26 = insertelement <2 x double> poison, double %sqrt.i, i64 0
  %27 = shufflevector <2 x double> %26, <2 x double> poison, <2 x i32> zeroinitializer
  %28 = fdiv <2 x double> %27, %25
  %i.bb = insertelement <2 x double> poison, double %i.at, i64 0
  %29 = shufflevector <2 x double> %i.bb, <2 x double> poison, <2 x i32> zeroinitializer
...
DistribVector.exit:                               ; preds = %.lr.ph, %DistribVector.exit
  ...
  %i.bc = phi i64 [ %rnd.promoted, %.lr.ph ], [ %34, %DistribVector.exit ]
  ...
  %i.bg = add i64 %i.bf, 12345                    ; 2 uses
  %31 = insertelement <2 x i64> poison, i64 %i.bg, i64 0
  %32 = insertelement <2 x i64> %31, i64 %i.be, i64 1
  %33 = and <2 x i64> %32, splat (i64 2147483647)
  %34 = and i64 %i.bg, 2147483647                 ; 2 uses
  %i.bh = uitofp nneg <2 x i64> %33 to <2 x double>
  %i.bi = fdiv nnan <2 x double> %i.bh, splat (double f0x41CFFFFFFF800000)
  %i.bj = fsub nnan <2 x double> splat (double 1.000000e+00), %i.bi
  %i.bk = fmul <2 x double> %30, %i.bj            ; 4 uses
  %i.bl = extractelement <2 x double> %i.bk, i64 1
  %i.bm = fmul double %i.bl, 0.000000e+00
  store i64 %34, ptr @rnd, align 8, !tbaa !18
  %i.bn = fmul <2 x double> %19, %i.bk
  %i.bo = shufflevector <2 x double> %i.bk, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.bp = fmul <2 x double> %16, %i.bo
...
bb.h:                                             ; preds = %.thread
  ...
  %i.eh = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.eg, <2 x double> %i.t, <2 x double> %i.dx) ; 9 uses
...
.lr.ph93:                                         ; preds = %.preheader
  ...
  %i.fb = fmul double %i.eo, %i.ev                ; 4 uses
  ...
  %35 = insertelement <2 x i1> poison, i1 %i.eq, i64 0
  %36 = shufflevector <2 x i1> %35, <2 x i1> poison, <2 x i32> zeroinitializer ; 3 uses
  %37 = insertelement <2 x double> %i.fh, double %i.fb, i64 1
  %38 = shufflevector <2 x double> <double 1.000000e+00, double poison>, <2 x double> %i.eh, <2 x i32> <i32 0, i32 2>
  %39 = select <2 x i1> %36, <2 x double> %37, <2 x double> %38 ; 3 uses
  %40 = insertelement <2 x double> poison, double %i.fb, i64 0
  %41 = insertelement <2 x double> %40, double %i.fd, i64 1
  %42 = insertelement <2 x double> %i.eh, double 0.000000e+00, i64 1
  %43 = select <2 x i1> %36, <2 x double> %41, <2 x double> %42 ; 3 uses
  %i.fj = insertelement <2 x double> poison, double %i.et, i64 0
  %i.fk = insertelement <2 x double> %i.fj, double %i.es, i64 1
  %i.fl = insertelement <2 x double> <double 0.000000e+00, double poison>, double %i.er, i64 1
  %44 = select <2 x i1> %36, <2 x double> %i.fk, <2 x double> %i.fl ; 4 uses
  %foldExtExtBinop145 = fmul <2 x double> %44, %44
  %foldExtExtBinop147 = fmul <2 x double> %43, %43
  %45 = extractelement <2 x double> %foldExtExtBinop147, i64 1
  %46 = extractelement <2 x double> %44, i64 0    ; 2 uses
  %47 = tail call double @llvm.fmuladd.f64(double %46, double %46, double %45)
  %i.fm = insertelement <2 x double> %foldExtExtBinop145, double %47, i64 0
  %48 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %39, <2 x double> %39, <2 x double> %i.fm)
  %49 = fadd <2 x double> %48, <double -0.000000e+00, double 0.000000e+00>
  %50 = tail call <2 x double> @llvm.sqrt.v2f64(<2 x double> %49)
  %i.fn = insertelement <2 x double> poison, double %sqrt.i.i77, i64 0
  %51 = shufflevector <2 x double> %i.fn, <2 x double> poison, <2 x i32> zeroinitializer
...
DistribVector.exit80:                             ; preds = %.lr.ph93, %DistribVector.exit80
  ...
  %i.fw = fmul <2 x double> %i.fv, %52
  %i.fx = mul i64 %i.ft, 1103515245
  %i.fy = add i64 %i.fx, 12345                    ; 2 uses
  %53 = insertelement <2 x i64> poison, i64 %i.fy, i64 0
  %54 = insertelement <2 x i64> %53, i64 %i.ft, i64 1
  %55 = and <2 x i64> %54, splat (i64 2147483647)
  %56 = and i64 %i.fy, 2147483647
  %i.fz = uitofp nneg <2 x i64> %55 to <2 x double>
  ...
  store i64 %56, ptr @rnd, align 8, !tbaa !18
  %i.gf = fmul <2 x double> %44, %i.gc
  %i.gg = shufflevector <2 x double> %i.gc, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.gh = fmul <2 x double> %43, %i.gg
  %foldExtExtBinop149 = fmul <2 x double> %39, %i.gc
  %57 = extractelement <2 x double> %foldExtExtBinop149, i64 0
  %i.gi = fadd <2 x double> %i.gf, %i.gh
  %i.gj = fadd double %i.ge, %57
