begin_hunk_0_@_Z13SetPropertiesP8IUnknownRK13CObjectVectorI9CPropertyE:bb.a
  ...
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %3)
          to label %bb.bg unwind label %bb.be, !inline_history !36

bb.be:                                            ; preds = %bb.bd
  %i.gc = landingpad { ptr, i32 }
          catch ptr null
  %i.gd = extractvalue { ptr, i32 } %i.gc, 0
  call void @__clang_call_terminate(ptr %i.gd) #15, !inline_history !36
  unreachable
...
bb.bg:                                            ; preds = %bb.bd
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %3) #12, !inline_history !36
...
bb.a:
  ...
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %0)
          to label %_ZN13CObjectVectorI11CStringBaseIwEED2Ev.exit unwind label %bb.b, !inline_history !36

bb.b:                                             ; preds = %bb.a
  %i.a = landingpad { ptr, i32 }
          catch ptr null
  %i.b = extractvalue { ptr, i32 } %i.a, 0
  tail call void @__clang_call_terminate(ptr %i.b) #15, !inline_history !36
  unreachable

_ZN13CObjectVectorI11CStringBaseIwEED2Ev.exit:    ; preds = %bb.a
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %0) #12, !inline_history !36
...
bb.d:                                             ; preds = %bb.a, %_ZN11CStringBaseIwED2Ev.exit
  ...
  br i1 %i.q, label %bb.a, label %._crit_edge, !llvm.loop !37
}
...
begin_hunk_5_@_ZNK11CStringBaseIwE3MidEii:bb.a
  ...
  br i1 %i.ay, label %scalar.ph, label %._crit_edge, !llvm.loop !41
...
!34 = distinct !{!34, !32}
!35 = distinct !{!35, !32}
!36 = !{ptr @_ZN13CObjectVectorI11CStringBaseIwEED2Ev}
!37 = distinct !{!37, !32}
!38 = distinct !{!38, !32, !39, !40}
