...
bb.a:
  %i.a = load ptr, ptr @_ZL21s_loop_suite_run_info, align 8, !tbaa !75 ; 5 uses
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 552
  %i.c = load i64, ptr %i.b, align 8, !tbaa !120  ; 5 uses
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %i.e = load ptr, ptr %i.d, align 16, !tbaa !121 ; 5 uses
...
bb.c:                                             ; preds = %bb.c, %.lr.ph.new
  ...
  %i.y = load double, ptr %i.x, align 8, !tbaa !123
  ...
  %i.ad = load double, ptr %i.ac, align 8, !tbaa !123
  ...
  %i.ai = load double, ptr %i.ah, align 8, !tbaa !123
  %i.aj = fpext double %i.ai to x86_fp80
  %i.ak = fadd x86_fp80 %i.af, %i.aj              ; 3 uses
  %i.al = add nuw i64 %.05, 4                     ; 2 uses
  %niter.next.3 = add nuw i64 %niter, 4           ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %._crit_edge.loopexit.unr-lcssa, label %bb.c, !llvm.loop !163
}
...
bb.a:
  ...
  %i.b = load i8, ptr %i.a, align 8, !tbaa !165, !range !62, !noundef !63
  %i.c = trunc nuw i8 %i.b to i1
  br i1 %i.c, label %bb.b, label %_ZNSt6vectorIeSaIeEE9push_backERKe.exit

bb.b:                                             ; preds = %bb.a
  %i.d = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.e = load i64, ptr %i.d, align 8, !tbaa !166
  %i.f = load i64, ptr %2, align 8, !tbaa !167
  ...
  %i.l = load ptr, ptr %i.j, align 8, !tbaa !68
  ...
  %i.q = load ptr, ptr %i.p, align 8, !tbaa !168
  %.not.i = icmp eq ptr %i.o, %i.q
  br i1 %.not.i, label %bb.d, label %bb.c

bb.c:                                             ; preds = %bb.b
  store x86_fp80 %i.i, ptr %i.o, align 16, !tbaa !72
  %i.r = getelementptr inbounds nuw i8, ptr %i.o, i64 16
  store ptr %i.r, ptr %i.n, align 8, !tbaa !69
  br label %_ZNSt6vectorIeSaIeEE9push_backERKe.exit

bb.d:                                             ; preds = %bb.b
  %i.s = load ptr, ptr %i.m, align 8, !tbaa !70   ; 4 uses
...
_ZNKSt6vectorIeSaIeEE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.d
  ...
  store x86_fp80 %i.i, ptr %i.ae, align 16, !tbaa !72
...
_ZNSt6vectorIeSaIeEE17_M_realloc_insertIJRKeEEEvN9__gnu_cxx17__normal_iteratorIPeS1_EEDpOT_.exit.i: ; preds = %bb.g, %_ZNSt6vectorIeSaIeEE11_S_relocateEPeS2_S2_RS0_.exit16.i.i
  store ptr %i.ad, ptr %i.m, align 8, !tbaa !70
  store ptr %i.ag, ptr %i.n, align 8, !tbaa !69
  %i.ah = getelementptr inbounds nuw [16 x i8], ptr %i.ad, i64 %i.ab
  store ptr %i.ah, ptr %i.p, align 8, !tbaa !168
  br label %_ZNSt6vectorIeSaIeEE9push_backERKe.exit
...
bb.a:
  ...
  %i.c = load ptr, ptr %1, align 8, !tbaa !129    ; 3 uses
...
.lr.ph255:                                        ; preds = %bb.a, %.loopexit234
  ...
  %i.j = load i8, ptr %i.i, align 8, !tbaa !61, !range !62, !noundef !63
...
.preheader233:                                    ; preds = %.lr.ph255
  ...
  %i.o = load ptr, ptr %i.l, align 8, !tbaa !65   ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.ai = load ptr, ptr %i.af, align 8, !tbaa !70 ; 9 uses
...
.lr.ph.epil.preheader:                            ; preds = %._crit_edge.unr-lcssa, %.lr.ph.preheader
  ...
  %i.au = load x86_fp80, ptr %i.at, align 16, !tbaa !72 ; 7 uses
...
.lr.ph:                                           ; preds = %bb.g, %.lr.ph.preheader.new
  ...
  %i.bj = load x86_fp80, ptr %i.bi, align 16, !tbaa !72 ; 7 uses
...
.lr.ph.1:                                         ; preds = %.lr.ph, %bb.e
  ...
  %i.bu = load x86_fp80, ptr %i.bt, align 16, !tbaa !72 ; 7 uses
...
bb.g:                                             ; preds = %bb.f, %.lr.ph.1
  ...
  br i1 %niter.ncmp.1, label %._crit_edge.unr-lcssa, label %.lr.ph, !llvm.loop !169
...
.lr.ph248.epil:                                   ; preds = %.lr.ph248.epil, %.lr.ph248.epil.preheader
  ...
  %i.ce = load x86_fp80, ptr %i.cd, align 16, !tbaa !72
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge249, label %.lr.ph248.epil, !llvm.loop !170
...
._crit_edge249:                                   ; preds = %._crit_edge249.loopexit.unr-lcssa, %.lr.ph248.epil, %._crit_edge.thread
  ...
  %i.ck = load ptr, ptr %i.w, align 8, !tbaa !70
  %i.cl = getelementptr inbounds nuw [16 x i8], ptr %i.ck, i64 %i.ab
  store x86_fp80 %i.ch, ptr %i.cl, align 16, !tbaa !72
  %i.cm = load ptr, ptr %i.x, align 8, !tbaa !70
  %i.cn = getelementptr inbounds nuw [16 x i8], ptr %i.cm, i64 %i.ab
  store x86_fp80 %i.cj, ptr %i.cn, align 16, !tbaa !72
  %i.co = load ptr, ptr %i.y, align 8, !tbaa !70
  %i.cp = getelementptr inbounds nuw [16 x i8], ptr %i.co, i64 %i.ab
  store x86_fp80 %.sroa.0227.0..sroa.0227.0.228236.lcssa310, ptr %i.cp, align 16, !tbaa !72
  %i.cq = load ptr, ptr %i.z, align 8, !tbaa !70
  %i.cr = getelementptr inbounds nuw [16 x i8], ptr %i.cq, i64 %i.ab
  store x86_fp80 %.sroa.0229.0..sroa.0229.0.230235.lcssa311, ptr %i.cr, align 16, !tbaa !72
  %i.cs = load ptr, ptr %i.aa, align 8, !tbaa !70
  %i.ct = getelementptr inbounds nuw [16 x i8], ptr %i.cs, i64 %i.ab
  store x86_fp80 %.2132312, ptr %i.ct, align 16, !tbaa !72
  br label %bb.h
...
.lr.ph248:                                        ; preds = %.lr.ph248, %._crit_edge.new
  ...
  %i.cv = load x86_fp80, ptr %i.cu, align 16, !tbaa !72
  ...
  %i.da = load x86_fp80, ptr %i.cz, align 16, !tbaa !72
  ...
  %i.df = load x86_fp80, ptr %i.de, align 16, !tbaa !72
  ...
  %i.dk = load x86_fp80, ptr %i.dj, align 16, !tbaa !72
  ...
  br i1 %niter362.ncmp.3, label %._crit_edge249.loopexit.unr-lcssa, label %.lr.ph248, !llvm.loop !171
...
bb.h:                                             ; preds = %bb.b, %._crit_edge249
  ...
  br i1 %i.dn, label %bb.b, label %.loopexit234, !llvm.loop !172
...
.loopexit234:                                     ; preds = %bb.h, %.preheader233, %.lr.ph255
  ...
  br i1 %i.do, label %.lr.ph255, label %._crit_edge256, !llvm.loop !173

bb.i:                                             ; preds = %._crit_edge256
  %i.dp = load ptr, ptr @_ZL21s_loop_suite_run_info, align 8, !tbaa !75 ; 6 uses
  %i.dq = getelementptr inbounds nuw i8, ptr %i.dp, i64 64 ; 7 uses
  %i.dr = load i32, ptr %i.dq, align 16, !tbaa !118 ; 2 uses
...
_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_.exit:            ; preds = %bb.i
  ...
  tail call void @llvm.memset.p0.i64(ptr nonnull align 4 %i.du, i8 0, i64 %i.dt, i1 false), !tbaa !12
  %.pre = load i32, ptr %i.dq, align 16, !tbaa !118 ; 2 uses
...
.lr.ph.i.i.i.i.i.i.i.i.i148.prol:                 ; preds = %.noexc151, %.lr.ph.i.i.i.i.i.i.i.i.i148.prol
  ...
  store x86_fp80 0.000000e+00, ptr %.07.i.i.i.i.i.i.i.i.i.prol, align 16, !tbaa !72
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.i.i.i.i.i.i148.prol.loopexit, label %.lr.ph.i.i.i.i.i.i.i.i.i148.prol, !llvm.loop !174
...
.lr.ph.i.i.i.i.i.i.i.i.i148:                      ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i148.prol.loopexit, %.lr.ph.i.i.i.i.i.i.i.i.i148
  ...
  br i1 %.not.i.i.i.i.i.i.i.i.i149.7, label %_ZNSt6vectorIeSaIeEEC2EmRKeRKS0_.exit, label %.lr.ph.i.i.i.i.i.i.i.i.i148, !llvm.loop !175

_ZNSt6vectorIeSaIeEEC2EmRKeRKS0_.exit:            ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i148, %.lr.ph.i.i.i.i.i.i.i.i.i148.prol.loopexit
  %.pre291 = load i32, ptr %i.dq, align 16, !tbaa !118 ; 2 uses
...
.lr.ph.i.i.i.i.i.i.i.i.i153.prol:                 ; preds = %.noexc158, %.lr.ph.i.i.i.i.i.i.i.i.i153.prol
  ...
  store x86_fp80 0.000000e+00, ptr %.07.i.i.i.i.i.i.i.i.i154.prol, align 16, !tbaa !72
  ...
  br i1 %prol.iter367.cmp.not, label %.lr.ph.i.i.i.i.i.i.i.i.i153.prol.loopexit, label %.lr.ph.i.i.i.i.i.i.i.i.i153.prol, !llvm.loop !176
...
.lr.ph.i.i.i.i.i.i.i.i.i153:                      ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i153.prol.loopexit, %.lr.ph.i.i.i.i.i.i.i.i.i153
  ...
  br i1 %.not.i.i.i.i.i.i.i.i.i155.7, label %_ZNSt6vectorIeSaIeEEC2EmRKeRKS0_.exit159, label %.lr.ph.i.i.i.i.i.i.i.i.i153, !llvm.loop !175

_ZNSt6vectorIeSaIeEEC2EmRKeRKS0_.exit159:         ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i153, %.lr.ph.i.i.i.i.i.i.i.i.i153.prol.loopexit
  %.pre292 = load i32, ptr %i.dq, align 16, !tbaa !118 ; 2 uses
...
.lr.ph.i.i.i.i.i.i.i.i.i161.prol:                 ; preds = %.noexc166, %.lr.ph.i.i.i.i.i.i.i.i.i161.prol
  ...
  store x86_fp80 0.000000e+00, ptr %.07.i.i.i.i.i.i.i.i.i162.prol, align 16, !tbaa !72
  ...
  br i1 %prol.iter370.cmp.not, label %.lr.ph.i.i.i.i.i.i.i.i.i161.prol.loopexit, label %.lr.ph.i.i.i.i.i.i.i.i.i161.prol, !llvm.loop !177
...
.lr.ph.i.i.i.i.i.i.i.i.i161:                      ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i161.prol.loopexit, %.lr.ph.i.i.i.i.i.i.i.i.i161
  ...
  br i1 %.not.i.i.i.i.i.i.i.i.i163.7, label %_ZNSt6vectorIeSaIeEEC2EmRKeRKS0_.exit167, label %.lr.ph.i.i.i.i.i.i.i.i.i161, !llvm.loop !175

_ZNSt6vectorIeSaIeEEC2EmRKeRKS0_.exit167:         ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i161, %.lr.ph.i.i.i.i.i.i.i.i.i161.prol.loopexit
  %.pre293 = load i32, ptr %i.dq, align 16, !tbaa !118 ; 2 uses
