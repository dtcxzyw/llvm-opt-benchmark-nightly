...
bb.c:                                             ; preds = %.lr.ph, %.loopexit
  ...
  %i.az = tail call i32 (ptr, ptr, ...) @setp_disjoint(ptr noundef %i.s, ptr noundef %i.ay) #5
  %.not85 = icmp eq i32 %i.az, 0
  br i1 %.not85, label %bb.d, label %.loopexit

bb.d:                                             ; preds = %bb.c
  %i.ba = load ptr, ptr %i.as, align 8, !tbaa !14 ; 5 uses
  %i.bb = load i32, ptr %i.g, align 8, !tbaa !18
  %i.bc = load i32, ptr %i.at, align 4, !tbaa !17 ; 2 uses
  %i.bd = add nsw i32 %i.bc, 1
  store i32 %i.bd, ptr %i.at, align 4, !tbaa !17
  ...
  %i.bk = tail call ptr (ptr, ptr, ptr, ...) @set_and(ptr noundef %i.bg, ptr noundef %i.s, ptr noundef %i.bj) #5 ; 0 uses
  %i.bl = load i32, ptr %i.ad, align 4, !tbaa !4  ; 2 uses
  ...
  %i.bt = icmp ne i32 %i.bq, 0
  %umin179.neg = sext i1 %i.bt to i64
  %i.bu = add nsw i64 %i.bs, %umin179.neg         ; 3 uses
  %min.iters.check181 = icmp ult i64 %i.bu, 8
  %brmerge = select i1 %min.iters.check181, i1 true, i1 %conflict.rdx178
  br i1 %brmerge, label %scalar.ph180.preheader, label %vector.ph182

vector.ph182:                                     ; preds = %bb.d
  %n.vec184 = and i64 %i.bu, -8                   ; 3 uses
  %i.bv = sub nsw i64 %i.br, %n.vec184
  br label %vector.body185

vector.body185:                                   ; preds = %vector.body185, %vector.ph182
  %index186 = phi i64 [ 0, %vector.ph182 ], [ %index.next197, %vector.body185 ] ; 2 uses
  %i.bw = sub i64 %i.br, %index186                ; 3 uses
  %i.bx = getelementptr inbounds nuw [4 x i8], ptr %i.ad, i64 %i.bw ; 2 uses
  %i.by = getelementptr inbounds i8, ptr %i.bx, i64 -12
  %i.bz = getelementptr inbounds i8, ptr %i.bx, i64 -28
  %wide.load187 = load <4 x i32>, ptr %i.by, align 4, !tbaa !4
  %wide.load188 = load <4 x i32>, ptr %i.bz, align 4, !tbaa !4
  %i.ca = getelementptr inbounds nuw [4 x i8], ptr %i.an, i64 %i.bw ; 2 uses
  %i.cb = getelementptr inbounds i8, ptr %i.ca, i64 -12
  %i.cc = getelementptr inbounds i8, ptr %i.ca, i64 -28
  %wide.load191 = load <4 x i32>, ptr %i.cb, align 4, !tbaa !4
  %wide.load192 = load <4 x i32>, ptr %i.cc, align 4, !tbaa !4
  %i.cd = and <4 x i32> %wide.load191, %wide.load187
  %i.ce = and <4 x i32> %wide.load192, %wide.load188
  ...
  %index.next197 = add nuw i64 %index186, 8       ; 2 uses
  %i.ci = icmp eq i64 %index.next197, %n.vec184
  br i1 %i.ci, label %middle.block198, label %vector.body185, !llvm.loop !27

middle.block198:                                  ; preds = %vector.body185
  %cmp.n199 = icmp eq i64 %i.bu, %n.vec184
  br i1 %cmp.n199, label %.loopexit203, label %scalar.ph180.preheader

scalar.ph180.preheader:                           ; preds = %bb.d, %middle.block198
  %indvars.iv.ph = phi i64 [ %i.bv, %middle.block198 ], [ %i.br, %bb.d ]
  br label %scalar.ph180

scalar.ph180:                                     ; preds = %scalar.ph180.preheader, %scalar.ph180
  %indvars.iv = phi i64 [ %indvars.iv.next, %scalar.ph180 ], [ %indvars.iv.ph, %scalar.ph180.preheader ] ; 5 uses
  %i.cj = getelementptr inbounds nuw [4 x i8], ptr %i.ad, i64 %indvars.iv
  %i.ck = load i32, ptr %i.cj, align 4, !tbaa !4
  %i.cl = getelementptr inbounds nuw [4 x i8], ptr %i.an, i64 %indvars.iv
  ...
  br i1 %i.cp, label %scalar.ph180, label %.loopexit203, !llvm.loop !30

.loopexit203:                                     ; preds = %scalar.ph180, %middle.block198
  ...
  %i.cu = icmp ne i32 %i.cr, 0
  %umin153.neg = sext i1 %i.cu to i64
  %i.cv = add nsw i64 %i.ct, %umin153.neg         ; 3 uses
  %min.iters.check155 = icmp ult i64 %i.cv, 12
  br i1 %min.iters.check155, label %scalar.ph154.preheader, label %vector.memcheck142

vector.memcheck142:                               ; preds = %.loopexit203
  %i.cw = icmp ne i32 %i.cr, 0                    ; 2 uses
  %umin143 = zext i1 %i.cw to i64
  %i.cx = add nsw i64 %umin143, %i.bf
  %i.cy = shl nsw i64 %i.cx, 2
  %scevgep144 = getelementptr i8, ptr %i.ba, i64 %i.cy
  %scevgep145 = getelementptr i8, ptr %i.ba, i64 4
  %i.cz = shl nuw nsw i64 %i.cs, 2
  %i.da = add nsw i64 %i.bf, %i.cs
  %i.db = shl nsw i64 %i.da, 2
  %scevgep146 = getelementptr i8, ptr %scevgep145, i64 %i.db
  %i.dc = select i1 %i.cw, i64 4, i64 0
  %scevgep147 = getelementptr i8, ptr %i.c, i64 %i.dc
  %scevgep149 = getelementptr i8, ptr %scevgep148, i64 %i.cz
  ...
  br i1 %found.conflict152, label %scalar.ph154.preheader, label %vector.ph156

vector.ph156:                                     ; preds = %vector.memcheck142
  %n.vec158 = and i64 %i.cv, -8                   ; 3 uses
  %i.dd = sub nsw i64 %i.cs, %n.vec158
  br label %vector.body159

vector.body159:                                   ; preds = %vector.body159, %vector.ph156
  %index160 = phi i64 [ 0, %vector.ph156 ], [ %index.next171, %vector.body159 ] ; 2 uses
  %i.de = sub i64 %i.cs, %index160                ; 2 uses
  ...
  %wide.load161 = load <4 x i32>, ptr %i.dg, align 4, !tbaa !4, !alias.scope !31, !noalias !34
  %wide.load162 = load <4 x i32>, ptr %i.dh, align 4, !tbaa !4, !alias.scope !31, !noalias !34
  ...
  %wide.load165 = load <4 x i32>, ptr %i.dj, align 4, !tbaa !4, !alias.scope !34
  %wide.load166 = load <4 x i32>, ptr %i.dk, align 4, !tbaa !4, !alias.scope !34
  %i.dl = or <4 x i32> %wide.load165, %wide.load161
  %i.dm = or <4 x i32> %wide.load166, %wide.load162
  ...
  %i.dn = icmp eq i64 %index.next171, %n.vec158
  br i1 %i.dn, label %middle.block172, label %vector.body159, !llvm.loop !36

middle.block172:                                  ; preds = %vector.body159
  %cmp.n173 = icmp eq i64 %i.cv, %n.vec158
  br i1 %cmp.n173, label %.loopexit202, label %scalar.ph154.preheader

scalar.ph154.preheader:                           ; preds = %vector.memcheck142, %.loopexit203, %middle.block172
  %indvars.iv90.ph = phi i64 [ %i.cs, %vector.memcheck142 ], [ %i.cs, %.loopexit203 ], [ %i.dd, %middle.block172 ]
  br label %scalar.ph154

scalar.ph154:                                     ; preds = %scalar.ph154.preheader, %scalar.ph154
  %indvars.iv90 = phi i64 [ %indvars.iv.next91, %scalar.ph154 ], [ %indvars.iv90.ph, %scalar.ph154.preheader ] ; 4 uses
  ...
  br i1 %i.dt, label %scalar.ph154, label %.loopexit202, !llvm.loop !37

.loopexit202:                                     ; preds = %scalar.ph154, %middle.block172
  ...
  %i.dx = tail call ptr (ptr, ptr, ptr, ...) @set_or(ptr noundef nonnull %i.an, ptr noundef nonnull %i.an, ptr noundef %i.dw) #5 ; 0 uses
  ...
  %i.ee = zext nneg i32 %i.ed to i64              ; 4 uses
  %i.ef = add nuw nsw i64 %i.ee, 1
  %i.eg = icmp ne i32 %i.ed, 0
  %umin120.neg = sext i1 %i.eg to i64
  %i.eh = add nsw i64 %i.ef, %umin120.neg         ; 3 uses
  %min.iters.check122 = icmp ult i64 %i.eh, 8
  %brmerge204 = select i1 %min.iters.check122, i1 true, i1 %conflict.rdx
  br i1 %brmerge204, label %scalar.ph121.preheader, label %vector.ph123

vector.ph123:                                     ; preds = %.loopexit202
  %n.vec125 = and i64 %i.eh, -8                   ; 3 uses
  %i.ei = sub nsw i64 %i.ee, %n.vec125
  br label %vector.body126

vector.body126:                                   ; preds = %vector.body126, %vector.ph123
  %index127 = phi i64 [ 0, %vector.ph123 ], [ %index.next138, %vector.body126 ] ; 2 uses
  %i.ej = sub i64 %i.ee, %index127                ; 3 uses
  %i.ek = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.ej ; 2 uses
  %i.el = getelementptr inbounds i8, ptr %i.ek, i64 -12
  %i.em = getelementptr inbounds i8, ptr %i.ek, i64 -28
  %wide.load128 = load <4 x i32>, ptr %i.el, align 4, !tbaa !4
end_hunk_0
