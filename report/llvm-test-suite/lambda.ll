...
bb.s:                                             ; preds = %bb.r
  ...
  %i.au = invoke noundef ptr %i.at(ptr noundef nonnull align 8 dereferenceable(16) %i.j, ptr noundef %i.aq, i32 noundef %.6138, ptr noundef nonnull %i.c)
          to label %.preheader239 unwind label %bb.u ; 2 uses

.preheader239:                                    ; preds = %bb.s
  %.not166251 = icmp eq ptr %i.au, null
  br i1 %.not166251, label %.thread226, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader239
  %i.av = and i32 %.6138, -9
  br label %.thread234

.thread234:                                       ; preds = %.thread234.backedge, %.lr.ph
  %.0110253 = phi ptr [ %i.au, %.lr.ph ], [ %.1111, %.thread234.backedge ] ; 10 uses
  %.0118252 = phi ptr [ %i.j, %.lr.ph ], [ %.1119, %.thread234.backedge ] ; 4 uses
...
bb.v:                                             ; preds = %.thread234
  %i.bd = load ptr, ptr %.0110253, align 8, !tbaa !11
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 112
  %i.bf = load ptr, ptr %i.be, align 8
  invoke void %i.bf(ptr noundef nonnull align 8 dereferenceable(16) %.0110253, ptr noundef %i.ba, i32 noundef %i.av)
...
bb.x:                                             ; preds = %.thread234
  invoke void @_ZNK8exp_node14symbolic_printEPK9alst_nodei(ptr noundef nonnull align 8 dereferenceable(16) %.0110253, ptr noundef %i.ba, i32 noundef %.6138)
          to label %bb.y unwind label %bb.w
...
bb.z:                                             ; preds = %bb.y
  ...
  %i.bl = load ptr, ptr %.0110253, align 8, !tbaa !11
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 104
  %i.bn = load ptr, ptr %i.bm, align 8
  %i.bo = invoke noundef ptr %i.bn(ptr noundef nonnull align 8 dereferenceable(16) %.0110253, ptr noundef %i.bk, i32 noundef %.6138, ptr noundef nonnull %i.c)
          to label %bb.aa unwind label %bb.ac     ; 3 uses

bb.aa:                                            ; preds = %bb.z
  %.not171 = icmp eq ptr %i.bo, null
  %.not172 = icmp eq ptr %.0110253, %i.bo
  %or.cond191 = or i1 %.not171, %.not172
  br i1 %or.cond191, label %bb.ad, label %bb.ab

bb.ab:                                            ; preds = %bb.aa
  %i.bp = load ptr, ptr %.0110253, align 8, !tbaa !11
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bp, i64 16
  %i.br = load ptr, ptr %i.bq, align 8
  call void %i.br(ptr noundef nonnull align 8 dereferenceable(16) %.0110253) #7
  %i.bs = icmp eq ptr %.0110253, %.0118252
  %spec.store.select = select i1 %i.bs, ptr null, ptr %.0118252
  br label %bb.ad
...
bb.ad:                                            ; preds = %bb.ab, %bb.aa
  %.1119 = phi ptr [ %spec.store.select, %bb.ab ], [ %.0118252, %bb.aa ] ; 3 uses
  %.1111 = phi ptr [ %i.bo, %bb.ab ], [ %.0110253, %bb.aa ]
...
bb.ae:                                            ; preds = %bb.ad
  ...
  br i1 %.not174, label %.thread234.backedge, label %.preheader

.thread234.backedge:                              ; preds = %bb.ae, %bb.af
  br label %.thread234, !llvm.loop !16
...
bb.af:                                            ; preds = %.preheader
  ...
  br i1 %or.cond, label %.thread214, label %.thread234.backedge
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.ci = invoke noundef ptr %i.ch(ptr noundef nonnull align 8 dereferenceable(16) %i.j, ptr noundef %i.ce, i32 noundef %i.cd, ptr noundef nonnull %i.c)
          to label %.preheader238 unwind label %bb.am

.preheader238:                                    ; preds = %bb.ah, %bb.ao
...
bb.ao:                                            ; preds = %bb.al, %bb.ak
  ...
  br i1 %.not161, label %select.unfold204, label %.preheader238, !llvm.loop !19
...
bb.at:                                            ; preds = %bb.as
  ...
  br i1 %.not155, label %.thread226, label %bb.au
...
bb.ay:                                            ; preds = %bb.ax, %bb.av
  ...
  br i1 %i.dy, label %.sink.split, label %.thread226

.thread214:                                       ; preds = %bb.af, %bb.y, %bb.ad, %.preheader238, %bb.ar
  %.13 = phi ptr [ %.8126.ph, %bb.ar ], [ %.6124, %.preheader238 ], [ %.1119, %bb.af ], [ %.0118252, %bb.y ], [ %.1119, %bb.ad ] ; 2 uses
  %.not185 = icmp eq ptr %.13, null
  br i1 %.not185, label %.sink.split, label %.thread226

.thread226:                                       ; preds = %.preheader239, %bb.ay, %bb.at, %.thread214
  %.13229 = phi ptr [ %.13, %.thread214 ], [ %i.j, %bb.at ], [ %i.j, %bb.ay ], [ %i.j, %.preheader239 ] ; 2 uses
  %i.dz = load ptr, ptr %.13229, align 8, !tbaa !11
  %i.ea = getelementptr inbounds nuw i8, ptr %i.dz, i64 16
  %i.eb = load ptr, ptr %i.ea, align 8
  call void %i.eb(ptr noundef nonnull align 8 dereferenceable(16) %.13229) #7
  br label %.sink.split
...
.sink.split:                                      ; preds = %.thread226, %.thread214, %bb.ar, %bb.ay
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #7
  br label %.backedge
