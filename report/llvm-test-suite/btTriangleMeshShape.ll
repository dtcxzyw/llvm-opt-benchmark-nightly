...
bb.b:                                             ; preds = %bb.a
  ...
  %4 = select i1 %i.n, float %i.d, float %i.e
  %5 = select i1 %i.n, ptr %1, ptr %i.b
  %i.o = fcmp ogt float %4, %i.h
  %i.p = select i1 %i.o, ptr %5, ptr %i.c
...
bb.d:                                             ; preds = %bb.c
  ...
  %6 = select i1 %i.ag, float %i.v, float %i.w
  %7 = select i1 %i.ag, ptr %i.t, ptr %i.u
  %i.ah = fcmp ogt float %6, %i.aa
  %i.ai = select i1 %i.ah, ptr %7, ptr %i.y
...
_Z24TestTriangleAgainstAabb2PK9btVector3RS0_S2_.exit: ; preds = %bb.e
  ...
  %8 = select i1 %i.ba, float %i.ap, float %i.aq
  %9 = select i1 %i.ba, ptr %i.an, ptr %i.ao
  %i.bb = fcmp ogt float %8, %i.au
  %i.bc = select i1 %i.bb, ptr %9, ptr %i.as
