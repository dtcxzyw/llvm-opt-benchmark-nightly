...
define dso_local void @CreateNode(ptr nofree noundef writeonly captures(none) initializes((0, 8)) %0, i32 noundef %1) local_unnamed_addr #3 {
bb.a:
...
define dso_local void @Insert(i32 noundef %0, ptr nofree noundef captures(none) %1) local_unnamed_addr #5 {
bb.a:
...
define dso_local range(i32 0, 2) i32 @Checktree(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #6 {
bb.a:
