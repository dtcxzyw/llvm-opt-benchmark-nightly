...
vector.ph364:                                     ; preds = %vector.main.loop.iter.check
  ...
  %n.vec366 = and i64 %i.mu, 4294967264           ; 5 uses
  %.cast367 = trunc nuw i64 %n.vec366 to i32
  %i.mw = sub i32 %i.mt, %.cast367
  %i.mx = sub nsw i64 0, %n.vec366                ; 2 uses
  %i.my = getelementptr i8, ptr %.092144.i.i, i64 %i.mx ; 2 uses
  %i.mz = getelementptr i8, ptr %.096143.i.i, i64 %i.mx ; 2 uses
  br label %vector.body368

vector.body368:                                   ; preds = %vector.body368, %vector.ph364
  %index369 = phi i64 [ 0, %vector.ph364 ], [ %index.next374.a, %vector.body368 ] ; 2 uses
  %offset.idx370 = sub i64 0, %index369           ; 2 uses
  %next.gep371 = getelementptr i8, ptr %.092144.i.i, i64 %offset.idx370 ; 2 uses
  %next.gep373.a = getelementptr i8, ptr %.096143.i.i, i64 %offset.idx370 ; 2 uses
...
vector.ph342:                                     ; preds = %.lr.ph134.preheader.i.i
  %n.vec344 = and i64 %i.op, 2147483640           ; 4 uses
  %.cast = trunc nuw nsw i64 %n.vec344 to i32
  %i.or = sub nsw i32 %i.oo, %.cast
  %i.os = sub nsw i64 0, %n.vec344                ; 2 uses
  %i.ot = getelementptr i8, ptr %.193.lcssa.i.i, i64 %i.os ; 2 uses
  %i.ou = getelementptr i8, ptr %.197.lcssa.i.i, i64 %i.os ; 2 uses
...
vector.body345:                                   ; preds = %vector.body345, %vector.ph342
  %index346 = phi i64 [ 0, %vector.ph342 ], [ %index.next351, %vector.body345 ] ; 2 uses
  ...
  %offset.idx348 = sub i64 0, %index346           ; 2 uses
  %next.gep = getelementptr i8, ptr %.193.lcssa.i.i, i64 %offset.idx348 ; 2 uses
  %next.gep350 = getelementptr i8, ptr %.197.lcssa.i.i, i64 %offset.idx348 ; 2 uses
