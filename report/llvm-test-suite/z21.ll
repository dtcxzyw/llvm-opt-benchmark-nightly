begin_hunk_0_@SizeGalley:bb.a
  ...
  %i.aic = icmp ne i8 %i.aib, 32                  ; 11 uses
...
.preheader:                                       ; preds = %bb.gy
  ...
  %.606 = select i1 %i.aic, i8 31, i8 30          ; 4 uses
  %.605 = select i1 %i.aic, i32 31, i32 30        ; 4 uses
...
bb.hd:                                            ; preds = %bb.hb
  ...
  %i.ajb = getelementptr inbounds nuw [4 x i8], ptr %i.aja, i64 %.
  ...
  %i.ajf = getelementptr inbounds nuw [4 x i8], ptr %i.aje, i64 %.
...
bb.hh:                                            ; preds = %bb.hg
  ...
  %i.ajn = getelementptr inbounds nuw [4 x i8], ptr %i.ajm, i64 %.
  %i.ajo = load i32, ptr %i.ajn, align 4, !tbaa !8 ; 2 uses
  %i.ajp = getelementptr inbounds nuw i8, ptr %.1457.lcssa, i64 56
  %i.ajq = getelementptr inbounds nuw [4 x i8], ptr %i.ajp, i64 %.
