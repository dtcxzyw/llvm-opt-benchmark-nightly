...
.lr.ph69.preheader:                               ; preds = %bb.b
  %i.k = load ptr, ptr @fderives, align 8, !tbaa !14 ; 2 uses
  %i.l = load i32, ptr @start_symbol, align 4, !tbaa !9
...
vector.body118:                                   ; preds = %vector.body118, %vector.ph116
  ...
  %wide.load122 = load <4 x i32>, ptr %next.gep121, align 4, !tbaa !9
  %wide.load123 = load <4 x i32>, ptr %i.ae, align 4, !tbaa !9
  %i.af = getelementptr i8, ptr %next.gep120, i64 16
  store <4 x i32> %wide.load122, ptr %next.gep120, align 4, !tbaa !9
  store <4 x i32> %wide.load123, ptr %i.af, align 4, !tbaa !9
...
.lr.ph69:                                         ; preds = %.lr.ph69.preheader163, %.lr.ph69
  ...
  %i.ai = load i32, ptr %.04067, align 4, !tbaa !9
  %i.aj = getelementptr inbounds nuw i8, ptr %.068, i64 4 ; 2 uses
  store i32 %i.ai, ptr %.068, align 4, !tbaa !9
  %i.ak = icmp ult ptr %i.aj, %i.f
  br i1 %i.ak, label %.lr.ph69, label %.lr.ph80.preheader, !llvm.loop !26
...
.preheader58:                                     ; preds = %.preheader60
  ...
  %i.ap = and i64 %i.ao, -4
  %i.aq = add i64 %i.ap, 4
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.b, i8 0, i64 %i.aq, i1 false), !tbaa !9
...
.lr.ph66.split.us.preheader:                      ; preds = %.preheader58
  %i.as = load ptr, ptr @ritem, align 8, !tbaa !12
...
.lr.ph66.split.us:                                ; preds = %.lr.ph66.split.us.preheader, %..loopexit57_crit_edge.us
  ...
  %i.bk = load i16, ptr %.04265.us, align 2, !tbaa !19
  %i.bl = sext i16 %i.bk to i64
  %i.bm = getelementptr inbounds [2 x i8], ptr %i.as, i64 %i.bl
  %i.bn = load i16, ptr %i.bm, align 2, !tbaa !19
  %i.bo = sext i16 %i.bn to i32                   ; 2 uses
  %i.bp = load i32, ptr @ntokens, align 4, !tbaa !9
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %next.gep108, align 4, !tbaa !9, !alias.scope !41
  %wide.load109 = load <4 x i32>, ptr %i.bw, align 4, !tbaa !9, !alias.scope !41
  %i.bx = getelementptr i8, ptr %next.gep, i64 16 ; 2 uses
  %wide.load110 = load <4 x i32>, ptr %next.gep, align 4, !tbaa !9, !alias.scope !42, !noalias !41
  %wide.load111 = load <4 x i32>, ptr %i.bx, align 4, !tbaa !9, !alias.scope !42, !noalias !41
  %i.by = or <4 x i32> %wide.load110, %wide.load
  %i.bz = or <4 x i32> %wide.load111, %wide.load109
  store <4 x i32> %i.by, ptr %next.gep, align 4, !tbaa !9, !alias.scope !42, !noalias !41
  store <4 x i32> %i.bz, ptr %i.bx, align 4, !tbaa !9, !alias.scope !42, !noalias !41
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ca = icmp eq i64 %index.next, %n.vec
  br i1 %i.ca, label %middle.block, label %vector.body, !llvm.loop !30
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.cc = load i32, ptr %.14162.us, align 4, !tbaa !9
  %i.cd = getelementptr inbounds nuw i8, ptr %.263.us, i64 4 ; 2 uses
  %i.ce = load i32, ptr %.263.us, align 4, !tbaa !9
  %i.cf = or i32 %i.ce, %i.cc
  store i32 %i.cf, ptr %.263.us, align 4, !tbaa !9
  %i.cg = icmp ult ptr %i.cd, %i.f
  br i1 %i.cg, label %scalar.ph, label %..loopexit57_crit_edge.us, !llvm.loop !31

..loopexit57_crit_edge.us:                        ; preds = %scalar.ph, %middle.block, %.lr.ph66.split.us
  %i.ch = icmp ult ptr %i.bj, %i.h
  br i1 %i.ch, label %.lr.ph66.split.us, label %.lr.ph80.preheader, !llvm.loop !32

.loopexit56.thread:                               ; preds = %.preheader60, %bb.b
  %i.ci = load ptr, ptr @itemset, align 8, !tbaa !12 ; 2 uses
  store ptr %i.ci, ptr @itemsetend, align 8, !tbaa !12
  br label %.preheader

.lr.ph80.preheader:                               ; preds = %..loopexit57_crit_edge.us, %.lr.ph69, %.preheader58, %middle.block125
  %storemerge = load ptr, ptr @itemset, align 8, !tbaa !12 ; 2 uses
  store ptr %storemerge, ptr @itemsetend, align 8, !tbaa !12
  br label %.lr.ph80
...
iter.check:                                       ; preds = %.preheader
  %.143.lcssa131 = ptrtoaddr ptr %.143.lcssa to i64 ; 2 uses
...
vector.body139:                                   ; preds = %vector.body139, %vector.ph137
  ...
  %wide.load143.a = load <8 x i16>, ptr %next.gep142, align 2, !tbaa !19
  %wide.load144 = load <8 x i16>, ptr %i.cv, align 2, !tbaa !19
  %i.cw = getelementptr i8, ptr %next.gep141.a, i64 16
  store <8 x i16> %wide.load143.a, ptr %next.gep141.a, align 2, !tbaa !19
  store <8 x i16> %wide.load144, ptr %i.cw, align 2, !tbaa !19
  %index.next145 = add nuw i64 %index140, 16      ; 2 uses
  %i.cx = icmp eq i64 %index.next145, %n.vec138
  br i1 %i.cx, label %middle.block146, label %vector.body139, !llvm.loop !33
...
vec.epilog.iter.check:                            ; preds = %middle.block146
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph83.preheader, label %vec.epilog.ph, !prof !43
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load154 = load <4 x i16>, ptr %next.gep153, align 2, !tbaa !19
  store <4 x i16> %wide.load154, ptr %next.gep152.a, align 2, !tbaa !19
  %index.next155 = add nuw i64 %index151, 4       ; 2 uses
  %i.dc = icmp eq i64 %index.next155, %n.vec150
  br i1 %i.dc, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !34
...
.lr.ph80:                                         ; preds = %.lr.ph80.preheader, %.loopexit
  ...
  %i.df = load i32, ptr %.379, align 4, !tbaa !9  ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.dn = load i16, ptr %i.dm, align 2, !tbaa !19 ; 2 uses
...
.lr.ph71:                                         ; preds = %bb.e, %bb.f
  ...
  %i.dq = load i16, ptr %.34570, align 2, !tbaa !19 ; 2 uses
...
bb.f:                                             ; preds = %.lr.ph71
  ...
  store i16 %i.dq, ptr %i.dp, align 2, !tbaa !19
  %i.du = icmp ult ptr %i.ds, %i.h
  br i1 %i.du, label %.lr.ph71, label %.critedge, !llvm.loop !35
...
.critedge:                                        ; preds = %.lr.ph71, %bb.f, %bb.e
  ...
  store ptr %i.dw, ptr @itemsetend, align 8, !tbaa !12
  store i16 %i.dn, ptr %i.dv, align 2, !tbaa !19
  br label %bb.g
...
bb.g:                                             ; preds = %.critedge, %bb.d
  ...
  br i1 %.not53, label %.loopexit.loopexit, label %bb.d, !llvm.loop !36
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %bb.c
  ...
  br i1 %i.eb, label %.lr.ph80, label %.preheader, !llvm.loop !37
...
.lr.ph83:                                         ; preds = %.lr.ph83.preheader, %.lr.ph83
  ...
  %i.ee = load i16, ptr %.682, align 2, !tbaa !19
  %i.ef = getelementptr inbounds nuw i8, ptr %i.ec, i64 2 ; 2 uses
  store i16 %i.ee, ptr %i.ec, align 2, !tbaa !19
  %i.eg = icmp ult ptr %i.ed, %i.h
  br i1 %i.eg, label %.lr.ph83, label %._crit_edge, !llvm.loop !38
...
._crit_edge:                                      ; preds = %.lr.ph83, %vec.epilog.middle.block, %middle.block146
  ...
  store ptr %.lcssa, ptr @itemsetend, align 8, !tbaa !12
  br label %bb.h
...
bb.a:
  %i.a = load ptr, ptr @itemset, align 8, !tbaa !12 ; 2 uses
...
bb.c:                                             ; preds = %bb.b, %bb.a
  %i.b = load ptr, ptr @ruleset, align 8, !tbaa !14 ; 2 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c
  %i.c = load ptr, ptr @fderives, align 8, !tbaa !14 ; 2 uses
  %.not4 = icmp eq ptr %i.c, null
  br i1 %.not4, label %bb.g, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.d = load i32, ptr @ntokens, align 4, !tbaa !9
  %i.e = load i32, ptr @rulesetsize, align 4, !tbaa !9
