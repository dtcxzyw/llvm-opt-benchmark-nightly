begin_hunk_0
  ...
  %i.jr = sext i32 %i.jf to i64                   ; 17 uses
...
begin_hunk_1
  ...
  %wide.trip.count1303 = zext i32 %i.ji to i64    ; 19 uses
...
begin_hunk_2
  ...
  %i.kj = add nsw i64 %i.ki, -8                   ; 2 uses
  %i.kk = add nsw i64 %wide.trip.count1303, -1    ; 5 uses
  %i.kl = shl nsw i64 %i.jr, 3
  %i.km = add nsw i64 %i.kl, 8                    ; 3 uses
  %i.kn = add nsw i64 %i.jr, %wide.trip.count1303
  %i.ko = shl nsw i64 %i.kn, 3                    ; 3 uses
  %7 = shl nuw nsw i64 %wide.trip.count1303, 4
  %i.kp = add nsw i64 %7, -8                      ; 4 uses
  ...
  %i.kv = add nsw i64 %i.ku, -8                   ; 2 uses
  %8 = add nsw i64 %wide.trip.count1303, -1       ; 5 uses
  ...
  %n.vec1773 = and i64 %8, -2                     ; 2 uses
  %i.kz = or i64 %8, 1
  %cmp.n1783 = icmp eq i64 %8, %n.vec1773
  ...
  %n.vec1747 = and i64 %8, -4                     ; 3 uses
  %i.lc = or disjoint i64 %n.vec1747, 1
  %cmp.n1759 = icmp eq i64 %8, %n.vec1747
...
begin_hunk_3
  ...
  %n.vec1642 = and i64 %i.kk, -2                  ; 2 uses
  %i.lg = or i64 %i.kk, 1
  %cmp.n1652 = icmp eq i64 %i.kk, %n.vec1642
  ...
  %n.vec1616 = and i64 %i.kk, -4                  ; 3 uses
  %i.lj = or disjoint i64 %n.vec1616, 1
  %cmp.n1628 = icmp eq i64 %i.kk, %n.vec1616
...
vector.memcheck1761:                              ; preds = %.lr.ph1169.preheader
  ...
  %scevgep1763 = getelementptr i8, ptr %i.lz, i64 %i.kv
...
begin_hunk_5
  ...
  %scevgep1739 = getelementptr i8, ptr %i.nk, i64 %i.kv
...
vector.memcheck1654:                              ; preds = %.lr.ph1178.preheader
  ...
  %scevgep1656 = getelementptr i8, ptr %i.pj, i64 %i.kp ; 5 uses
  %scevgep1657 = getelementptr i8, ptr %i.pm, i64 8 ; 5 uses
  %scevgep1658 = getelementptr i8, ptr %i.pm, i64 %i.kp ; 5 uses
  %scevgep1659 = getelementptr i8, ptr %i.qi, i64 %i.km ; 5 uses
  %scevgep1660 = getelementptr i8, ptr %i.qi, i64 %i.ko ; 5 uses
  %scevgep1661 = getelementptr i8, ptr %i.pd, i64 %i.km ; 3 uses
  %scevgep1662 = getelementptr i8, ptr %i.pd, i64 %i.ko ; 3 uses
  %scevgep1663 = getelementptr i8, ptr %i.po, i64 8 ; 3 uses
  %scevgep1664 = getelementptr i8, ptr %i.po, i64 %i.kp ; 3 uses
  %scevgep1665 = getelementptr i8, ptr %i.qj, i64 8 ; 3 uses
  %scevgep1666 = getelementptr i8, ptr %i.qj, i64 %i.kp ; 3 uses
...
vector.memcheck1630:                              ; preds = %.lr.ph1188.preheader
  ...
  %i.sg = getelementptr i8, ptr %i.sf, i64 %i.kj
  %scevgep1633 = getelementptr i8, ptr %i.sa, i64 %i.km
  %scevgep1634 = getelementptr i8, ptr %i.sa, i64 %i.ko
  %bound01635 = icmp ult ptr %scevgep1631, %scevgep1634
  %bound11636 = icmp ult ptr %scevgep1633, %i.sg
...
begin_hunk_8
  ...
  %scevgep1608 = getelementptr i8, ptr %i.tr, i64 %i.kj
...
begin_hunk_9
  ...
  %i.wf = sext i32 %i.vt to i64                   ; 17 uses
...
begin_hunk_10
  ...
  %wide.trip.count1270 = zext i32 %i.vw to i64    ; 19 uses
...
begin_hunk_11
  ...
  %i.wx = add nsw i64 %i.ww, -8                   ; 2 uses
  %i.wy = add nsw i64 %wide.trip.count1270, -1    ; 5 uses
  %i.wz = shl nsw i64 %i.wf, 3
  %i.xa = add nsw i64 %i.wz, 8                    ; 3 uses
  %i.xb = add nsw i64 %i.wf, %wide.trip.count1270
  %i.xc = shl nsw i64 %i.xb, 3                    ; 3 uses
  %9 = shl nuw nsw i64 %wide.trip.count1270, 4
  %i.xd = add nsw i64 %9, -8                      ; 4 uses
  ...
  %i.xj = add nsw i64 %i.xi, -8                   ; 2 uses
  %10 = add nsw i64 %wide.trip.count1270, -1      ; 5 uses
  ...
  %n.vec1592 = and i64 %10, -2                    ; 2 uses
  %i.xn = or i64 %10, 1
  %cmp.n1602 = icmp eq i64 %10, %n.vec1592
  ...
  %n.vec1566 = and i64 %10, -4                    ; 3 uses
  %i.xq = or disjoint i64 %n.vec1566, 1
  %cmp.n1578 = icmp eq i64 %10, %n.vec1566
...
begin_hunk_12
  ...
  %n.vec1466 = and i64 %i.wy, -2                  ; 2 uses
  %i.xu = or i64 %i.wy, 1
  %cmp.n1474 = icmp eq i64 %i.wy, %n.vec1466
  ...
  %n.vec = and i64 %i.wy, -4                      ; 3 uses
  %i.xx = or disjoint i64 %n.vec, 1
  %cmp.n = icmp eq i64 %i.wy, %n.vec
...
vector.memcheck1580:                              ; preds = %.lr.ph1138.preheader
  ...
  %scevgep1582 = getelementptr i8, ptr %i.yn, i64 %i.xj
...
begin_hunk_14
  ...
  %scevgep1558 = getelementptr i8, ptr %i.zx, i64 %i.xj
...
vector.memcheck1476:                              ; preds = %.lr.ph1147.preheader
  ...
  %scevgep1478 = getelementptr i8, ptr %i.abu, i64 %i.xd ; 5 uses
  %scevgep1479 = getelementptr i8, ptr %i.aby, i64 8 ; 5 uses
  %scevgep1480 = getelementptr i8, ptr %i.aby, i64 %i.xd ; 5 uses
  %scevgep1481 = getelementptr i8, ptr %i.acs, i64 %i.xa ; 5 uses
  %scevgep1482 = getelementptr i8, ptr %i.acs, i64 %i.xc ; 5 uses
  %scevgep1483 = getelementptr i8, ptr %i.abn, i64 %i.xa ; 3 uses
  %scevgep1484 = getelementptr i8, ptr %i.abn, i64 %i.xc ; 3 uses
  %scevgep1485 = getelementptr i8, ptr %i.aca, i64 8 ; 3 uses
  %scevgep1486 = getelementptr i8, ptr %i.aca, i64 %i.xd ; 3 uses
  %scevgep1487 = getelementptr i8, ptr %i.act, i64 8 ; 3 uses
  %scevgep1488 = getelementptr i8, ptr %i.act, i64 %i.xd ; 3 uses
...
vector.memcheck1454:                              ; preds = %.lr.ph1157.preheader
  ...
  %i.aeu = getelementptr i8, ptr %i.aet, i64 %i.wx
  %scevgep1457 = getelementptr i8, ptr %i.aem, i64 %i.xa
  %scevgep1458 = getelementptr i8, ptr %i.aem, i64 %i.xc
  %bound01459 = icmp ult ptr %scevgep1455, %scevgep1458
  %bound11460 = icmp ult ptr %scevgep1457, %i.aeu
...
begin_hunk_17
  ...
  %scevgep1449 = getelementptr i8, ptr %i.agd, i64 %i.wx
