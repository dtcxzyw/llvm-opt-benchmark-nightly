...
.preheader238:                                    ; preds = %bb.a
  %6 = load ptr, ptr @imgY_sub_tmp, align 8       ; 6 uses
...
.preheader236:                                    ; preds = %scalar.ph348, %middle.block363
  %.pre321.pre = load ptr, ptr @imgY_sub_tmp, align 8 ; 4 uses
  %i.xb = add i32 %i.b, 37                        ; 3 uses
  %7 = icmp slt i32 %i.b, -34
  br i1 %7, label %.lr.ph248, label %.lr.ph244
...
.lr.ph244:                                        ; preds = %.preheader236
  ...
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %.pre321.pre, i64 16
...
begin_hunk_2
  ...
  %i.xj = getelementptr inbounds nuw [8 x i8], ptr %.pre321.pre, i64 %indvars.iv277 ; 4 uses
  %i.xk = getelementptr inbounds nuw [8 x i8], ptr %.pre321.pre, i64 %indvars.iv.next278
...
..loopexit235_crit_edge.us:                       ; preds = %scalar.ph366, %middle.block382
  ...
  br i1 %exitcond282.not, label %.preheader233.loopexit, label %.lr.ph.us245, !llvm.loop !106

.preheader233.loopexit:                           ; preds = %..loopexit235_crit_edge.us
  %.pre320 = load ptr, ptr @imgY_sub_tmp, align 8
  br label %.lr.ph248

.lr.ph248:                                        ; preds = %.preheader236, %.preheader236.thread, %.preheader233.loopexit
  %i.zn = phi i32 [ %i.xc, %.preheader236.thread ], [ %i.xb, %.preheader233.loopexit ], [ %i.xb, %.preheader236 ]
  %8 = phi ptr [ %6, %.preheader236.thread ], [ %.pre320, %.preheader233.loopexit ], [ %.pre321.pre, %.preheader236 ] ; 12 uses
...
begin_hunk_4
  ...
  %i.aae = getelementptr inbounds [8 x i8], ptr %8, i64 %indvars.iv.next290 ; 3 uses
  %i.aaf = load ptr, ptr %i.aae, align 8, !tbaa !61 ; 2 uses
  %i.aag = sext i32 %i.aad to i64
  %i.aah = getelementptr inbounds [8 x i8], ptr %8, i64 %i.aag
  ...
  %i.aam = getelementptr inbounds [8 x i8], ptr %8, i64 %i.aal
  ...
  %i.aar = getelementptr inbounds [8 x i8], ptr %8, i64 %i.aaq
...
begin_hunk_5
  ...
  %i.acv = getelementptr inbounds [8 x i8], ptr %8, i64 %indvars.iv.next290.1 ; 3 uses
  %i.acw = load ptr, ptr %i.acv, align 8, !tbaa !61 ; 2 uses
  %i.acx = sext i32 %i.acu to i64
  %i.acy = getelementptr inbounds [8 x i8], ptr %8, i64 %i.acx
  ...
  %i.add = getelementptr inbounds [8 x i8], ptr %8, i64 %i.adc
  ...
  %i.adi = getelementptr inbounds [8 x i8], ptr %8, i64 %i.adh
...
begin_hunk_6
  ...
  %i.afi = getelementptr inbounds [8 x i8], ptr %8, i64 %i.zq ; 3 uses
  %i.afj = load ptr, ptr %i.afi, align 8, !tbaa !61 ; 2 uses
  %i.afk = sext i32 %i.afh to i64
  %i.afl = getelementptr inbounds [8 x i8], ptr %8, i64 %i.afk
  ...
  %i.afq = getelementptr inbounds [8 x i8], ptr %8, i64 %i.afp
  ...
  %i.afv = getelementptr inbounds [8 x i8], ptr %8, i64 %i.afu
