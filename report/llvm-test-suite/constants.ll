...
begin_hunk_0_@constants:bb.a
  ...
  %i.apq = load double, ptr %i.app, align 8, !tbaa !8 ; 2 uses
  %i.apr = getelementptr inbounds nuw i8, ptr %i.aox, i64 24 ; 2 uses
  ...
  %2 = load double, ptr %i.apr, align 8, !tbaa !8
  store double %2, ptr %i.apt, align 8, !tbaa !8
