...
loop-unroll.NumUnrolled: 131
begin_hunk_0_@JTTmtx:bb.a
  %i.lc = sext i8 %i.lb to i64
...
.preheader64:                                     ; preds = %bb.i, %bb.k
  ...
  %i.f = icmp eq i64 %indvars.iv87.a, 0
...
bb.j:                                             ; preds = %bb.j, %.preheader64.new
  ...
  %i.i = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv78.a
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !16
  %i.k = getelementptr inbounds nuw [8 x i8], ptr %i.j, i64 %indvars.iv87.a
  ...
  %i.p = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv.next79.a
  %i.q = load ptr, ptr %i.p, align 8, !tbaa !16
  %i.r = getelementptr inbounds nuw [8 x i8], ptr %i.q, i64 %indvars.iv87.a
  store double %i.o, ptr %i.r, align 8, !tbaa !8
  %i.s = getelementptr inbounds nuw [8 x i8], ptr %i.e, i64 %indvars.iv.next79.a
  store double %i.o, ptr %i.s, align 8, !tbaa !8
  %indvars.iv.next79.1 = add nuw nsw i64 %indvars.iv78.a, 2 ; 2 uses
...
.epil.preheader:                                  ; preds = %.unr-lcssa, %.preheader64
  ...
  %i.x = getelementptr inbounds nuw [8 x i8], ptr %i.w, i64 %indvars.iv87.a
...
.loopexit:                                        ; preds = %.loopexit.loopexit76, %.preheader62.preheader
  ...
  %i.ez = getelementptr inbounds nuw i8, ptr %3, i64 6
  %i.fa = load i8, ptr %i.ez, align 1, !tbaa !15
  %i.fb = sext i8 %i.fa to i64
  %i.fc = getelementptr inbounds i8, ptr %4, i64 %i.fb
  store i8 2, ptr %i.fc, align 1, !tbaa !15
  %i.fd = getelementptr inbounds nuw i8, ptr %3, i64 7
  %i.fe = load i8, ptr %i.fd, align 1, !tbaa !15
  %i.ff = sext i8 %i.fe to i64
  %i.fg = getelementptr inbounds i8, ptr %4, i64 %i.ff
  ...
  %i.fk = getelementptr inbounds i8, ptr %4, i64 %i.fj
  store i8 3, ptr %i.fk, align 1, !tbaa !15
  %i.fl = getelementptr inbounds nuw i8, ptr %3, i64 9
