...
begin_hunk_0_@put_image:bb.a

bb.d:                                             ; preds = %bb.c
  %i.k = load ptr, ptr @stderr, align 8, !tbaa !8
  %i.l = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.k, ptr noundef nonnull @.str.24, ptr noundef %0) #22 ; 0 uses
...
begin_hunk_1_@susan_thin:bb.a
  %i.jz = add i32 %.1375.us, %.0436.us
  %i.ka = add nuw i32 %i.jz, %i.jy
  ...
  %i.kf = sitofp i32 %i.m to float
  %i.kg = fdiv float %i.ke, %i.kf
  %i.kh = fpext float %i.kg to double
  %i.ki = fcmp ogt double %i.kh, f0x3FE6666666666666
  br i1 %i.ki, label %bb.af, label %.thread410.us

bb.af:                                            ; preds = %bb.ae
  br i1 %i.jv, label %bb.ag, label %bb.aj
...
begin_hunk_2_@susan_edges:bb.a
  %i.air = add nuw nsw i32 %i.aiq, %i.aet
  %i.ais = add nuw nsw i32 %i.air, %i.afa
  %i.ait = add nuw nsw i32 %i.ais, %i.afh
  %i.aiu = add nuw nsw i32 %i.ait, %i.afo
  %i.aiv = add nuw nsw i32 %i.aiu, %i.afu
  %i.aiw = add nuw nsw i32 %i.aiv, %i.agd
  %i.aix = add nuw nsw i32 %i.aiw, %i.ahf
  %i.aiy = add nuw nsw i32 %i.aix, %reass.mul832
  %i.aiz = add nuw nsw i32 %i.aiy, %reass.mul830  ; 2 uses
  %i.aja = add nuw nsw i32 %i.aaa, %i.acg
  %i.ajb = add nuw nsw i32 %i.aan, %i.adv
  %i.ajc = add nuw nsw i32 %i.ajb, %i.aef
  %i.ajd = add nuw nsw i32 %i.aja, %i.afu
