...
bb.j:                                             ; preds = %bb.i, %._crit_edge294.split.thread
  ...
  br i1 %i.fg, label %bb.h, label %._crit_edge301.loopexit, !llvm.loop !33
...
._crit_edge301:                                   ; preds = %.preheader257.._crit_edge301_crit_edge, %._crit_edge301.loopexit
  ...
  br i1 %i.fk, label %.preheader257, label %.loopexit, !llvm.loop !34
...
bb.k:                                             ; preds = %.lr.ph, %bb.n
  ...
  %i.fs = mul nsw i32 %i.fq, %i.fo                ; 2 uses
...
bb.n:                                             ; preds = %bb.l, %bb.m
  ...
  br i1 %i.lg, label %bb.k, label %._crit_edge.loopexit, !llvm.loop !35
...
._crit_edge:                                      ; preds = %.preheader260.._crit_edge_crit_edge, %._crit_edge.loopexit
  ...
  br i1 %i.lk, label %.preheader260, label %.loopexit, !llvm.loop !36
...
bb.a:
  ...
  br i1 %i.e, label %.preheader873.lr.ph, label %._crit_edge879.split

.preheader873.lr.ph:                              ; preds = %bb.a
  ...
  %i.k = add nsw i32 %5, -6
  %i.l = sext i32 %i.k to i64                     ; 2 uses
  br i1 %i.g, label %.preheader873.preheader, label %.preheader872

.preheader873.preheader:                          ; preds = %.preheader873.lr.ph
  %i.m = zext nneg i32 %5 to i64
  %wide.trip.count885 = zext nneg i32 %i.d to i64
  %wide.trip.count = zext i32 %i.f to i64
  br label %.preheader873

.preheader873:                                    ; preds = %.preheader873.preheader, %._crit_edge
  %indvars.iv882 = phi i64 [ 3, %.preheader873.preheader ], [ %indvars.iv.next883, %._crit_edge ] ; 3 uses
  %i.n = add nsw i64 %indvars.iv882, -3
  %i.o = mul nsw i64 %i.n, %i.m
  %i.p = getelementptr inbounds i8, ptr %0, i64 %i.o
  %i.q = trunc i64 %indvars.iv882 to i32
  %i.r = mul i32 %5, %i.q
  %i.s = zext i32 %i.r to i64
  br label %bb.b

.preheader872:                                    ; preds = %._crit_edge, %.preheader873.lr.ph
  %i.t = add nsw i32 %6, -4
  %i.u = icmp sgt i32 %6, 8
  br i1 %i.u, label %.preheader.lr.ph, label %._crit_edge879.split

.preheader.lr.ph:                                 ; preds = %.preheader872
  ...
  br i1 %i.v, label %.preheader.preheader, label %._crit_edge879.split

.preheader.preheader:                             ; preds = %.preheader.lr.ph
  %i.ac = add nsw i32 %5, -4
  %i.ad = zext nneg i32 %5 to i64
  %wide.trip.count895 = zext nneg i32 %i.t to i64
  %wide.trip.count890 = zext i32 %i.ac to i64
  br label %.preheader

bb.b:                                             ; preds = %.preheader873, %bb.d
  %indvars.iv = phi i64 [ 3, %.preheader873 ], [ %indvars.iv.next, %bb.d ] ; 3 uses
...
._crit_edge:                                      ; preds = %bb.d
  ...
  br i1 %exitcond886.not, label %.preheader872, label %.preheader873, !llvm.loop !45

.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge877
  %indvars.iv892 = phi i64 [ 4, %.preheader.preheader ], [ %indvars.iv.next893, %._crit_edge877 ] ; 5 uses
  %i.ln = add nsw i64 %indvars.iv892, -3
  %i.lo = mul nsw i64 %i.ln, %i.ad
  %i.lp = getelementptr inbounds i8, ptr %0, i64 %i.lo ; 2 uses
  %i.lq = trunc i64 %indvars.iv892 to i32
  %i.lr = mul i32 %5, %i.lq
  %i.ls = zext i32 %i.lr to i64
  %i.lt = trunc nuw nsw i64 %indvars.iv892 to i32 ; 4 uses
  %i.lu = trunc nuw nsw i64 %indvars.iv892 to i32 ; 4 uses
  br label %bb.e

bb.e:                                             ; preds = %.preheader, %.critedge
  %indvars.iv887 = phi i64 [ 4, %.preheader ], [ %indvars.iv.next888, %.critedge ] ; 6 uses
  %i.lv = add nuw nsw i64 %indvars.iv887, %i.ls   ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.me, label %bb.g, label %bb.l

bb.g:                                             ; preds = %bb.f
  %i.mf = getelementptr inbounds nuw i8, ptr %i.lp, i64 %indvars.iv887 ; 3 uses
...
begin_hunk_2_@susan_edges:bb.a
  %i.ajj = add nuw nsw i32 %i.ajg, %i.afp
  %i.ajk = add nuw nsw i32 %i.aji, %i.agl
  %reass.add856 = sub nsw i32 %i.ajj, %i.ajk
  %reass.add857 = add nsw i32 %reass.add856, %i.agz
  %reass.mul858 = shl nsw i32 %reass.add857, 1
  %i.ajl = add nuw nsw i32 %i.aax, %i.acv
  %i.ajm = add nuw nsw i32 %i.abz, %i.adj
  %i.ajn = add nuw nsw i32 %i.ajm, %i.aeu
  %i.ajo = add nuw nsw i32 %i.ajl, %i.afi
  %i.ajp = add nuw nsw i32 %i.ajn, %i.age
  %i.ajq = sub nsw i32 %i.ajo, %i.ajp
  %i.ajr = add nsw i32 %i.ajq, %i.ahg
  %i.ajs = add nsw i32 %i.ajr, %reass.mul858
  %i.ajt = add nsw i32 %i.ajs, %reass.mul845
  %i.aju = icmp eq i32 %i.aja, 0
  br i1 %i.aju, label %.thread756, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.ajv = load i8, ptr %i.adx, align 1, !tbaa !18
  %i.ajw = zext i8 %i.ajv to i64
  %i.ajx = sub nsw i64 0, %i.ajw
  %i.ajy = getelementptr inbounds i8, ptr %i.md, i64 %i.ajx
  %i.ajz = load i8, ptr %i.ajy, align 1, !tbaa !18
  %i.aka = zext i8 %i.ajz to i32
  %i.akb = getelementptr inbounds nuw i8, ptr %i.adx, i64 1
  %i.akc = load i8, ptr %i.akb, align 1, !tbaa !18
  %i.akd = zext i8 %i.akc to i64
  %i.ake = sub nsw i64 0, %i.akd
  %i.akf = getelementptr inbounds i8, ptr %i.md, i64 %i.ake
  %i.akg = load i8, ptr %i.akf, align 1, !tbaa !18
  %i.akh = zext i8 %i.akg to i32
  %i.aki = getelementptr inbounds nuw i8, ptr %i.adx, i64 2
  %i.akj = load i8, ptr %i.aki, align 1, !tbaa !18
  %i.akk = zext i8 %i.akj to i64
  %i.akl = sub nsw i64 0, %i.akk
  %i.akm = getelementptr inbounds i8, ptr %i.md, i64 %i.akl
  %i.akn = load i8, ptr %i.akm, align 1, !tbaa !18
  %i.ako = zext i8 %i.akn to i32
  %i.akp = getelementptr inbounds nuw i8, ptr %i.adx, i64 4
  %i.akq = load i8, ptr %i.akp, align 1, !tbaa !18
  %i.akr = zext i8 %i.akq to i64
  %i.aks = sub nsw i64 0, %i.akr
  %i.akt = getelementptr inbounds i8, ptr %i.md, i64 %i.aks
  %i.aku = load i8, ptr %i.akt, align 1, !tbaa !18
  %i.akv = zext i8 %i.aku to i32
  %i.akw = getelementptr inbounds nuw i8, ptr %i.adx, i64 5
  %i.akx = load i8, ptr %i.akw, align 1, !tbaa !18
  %i.aky = zext i8 %i.akx to i64
  %i.akz = sub nsw i64 0, %i.aky
  %i.ala = getelementptr inbounds i8, ptr %i.md, i64 %i.akz
  %i.alb = load i8, ptr %i.ala, align 1, !tbaa !18
  %i.alc = zext i8 %i.alb to i32
  %i.ald = load i8, ptr %i.ady, align 1, !tbaa !18
  %i.ale = zext i8 %i.ald to i64
  %i.alf = sub nsw i64 0, %i.ale
  %i.alg = getelementptr inbounds i8, ptr %i.md, i64 %i.alf
  %i.alh = load i8, ptr %i.alg, align 1, !tbaa !18
  %i.ali = zext i8 %i.alh to i32
  %reass.add859 = add nuw nsw i32 %i.adq, %i.aco
  %reass.add860 = add nuw nsw i32 %reass.add859, %i.aen
  %reass.add861 = add nuw nsw i32 %reass.add860, %i.afp
  %reass.add862 = add nuw nsw i32 %reass.add861, %i.akh
  %reass.add863 = add nuw nsw i32 %reass.add862, %i.alc
  %reass.mul864 = shl nuw nsw i32 %reass.add863, 2
  %reass.add865 = add nuw nsw i32 %i.adw, %i.ach
  %reass.add866 = add nuw nsw i32 %reass.add865, %i.aeg
  %reass.add867 = add nuw nsw i32 %reass.add866, %i.afv
  %reass.add868 = add nuw nsw i32 %reass.add867, %i.aka
  %reass.add869 = add nuw nsw i32 %reass.add868, %i.ali
  %reass.mul870 = mul nuw nsw i32 %reass.add869, 9
  %i.alj = add nuw nsw i32 %i.aao, %i.aab
  %i.alk = add nuw nsw i32 %i.alj, %i.aax
  %i.all = add nuw nsw i32 %i.alk, %i.abe
  %i.alm = add nuw nsw i32 %i.all, %i.abs
  %i.aln = add nuw nsw i32 %i.alm, %i.abz
  %i.alo = add nuw nsw i32 %i.aln, %i.acv
  %i.alp = add nuw nsw i32 %i.alo, %i.adj
  %i.alq = add nuw nsw i32 %i.alp, %i.aeu
  %i.alr = add nuw nsw i32 %i.alq, %i.afi
  %i.als = add nuw nsw i32 %i.alr, %i.age
  %i.alt = add nuw nsw i32 %i.als, %i.agl
  %i.alu = add nuw nsw i32 %i.alt, %i.agz
  %i.alv = add nuw nsw i32 %i.alu, %i.ahg
  %i.alw = add nuw nsw i32 %i.alv, %i.aho
  %i.alx = add nuw nsw i32 %i.alw, %i.aib
  %i.aly = add nuw nsw i32 %i.alx, %i.ako
  %i.alz = add nuw nsw i32 %i.aly, %i.akv
  %i.ama = add nuw nsw i32 %i.alz, %reass.mul864
  %i.amb = add nuw nsw i32 %i.ama, %reass.mul870
  %i.amc = uitofp nneg i32 %i.amb to float
  %i.amd = uitofp nneg i32 %i.aja to float
  %i.ame = fdiv float %i.amc, %i.amd              ; 2 uses
  %i.amf = fcmp olt float %i.ame, 5.000000e-01
  br i1 %i.amf, label %.thread756, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.amg = fcmp ogt float %i.ame, 2.000000e+00
  br i1 %i.amg, label %.thread756, label %bb.o

bb.o:                                             ; preds = %bb.n
  %.inv = icmp slt i32 %i.ajt, 1
  %.752 = select i1 %.inv, i32 1, i32 -1
  br label %.thread756

.thread756:                                       ; preds = %bb.l, %bb.o, %bb.n, %bb.m
  %.1722 = phi i32 [ 1, %bb.n ], [ 0, %bb.m ], [ %.752, %bb.o ], [ 1, %bb.l ] ; 3 uses
  %.1 = phi i32 [ 0, %bb.n ], [ 1, %bb.m ], [ 1, %bb.o ], [ 0, %bb.l ] ; 3 uses
  %i.amh = add nsw i32 %.1722, %i.lt
  %i.ami = mul nsw i32 %i.amh, %5
  %i.amj = trunc nuw nsw i64 %indvars.iv887 to i32 ; 4 uses
  %i.amk = add nuw nsw i32 %.1, %i.amj
  %i.aml = add i32 %i.amk, %i.ami
  %i.amm = sext i32 %i.aml to i64
  %i.amn = getelementptr inbounds [4 x i8], ptr %1, i64 %i.amm
  %i.amo = load i32, ptr %i.amn, align 4, !tbaa !4
  %i.amp = icmp sgt i32 %i.lx, %i.amo
  br i1 %i.amp, label %bb.p, label %.critedge

bb.p:                                             ; preds = %.thread756
  %i.amq = sub nsw i32 %i.lt, %.1722
  %i.amr = mul nsw i32 %i.amq, %5
  %i.ams = sub nsw i32 %i.amj, %.1
  %i.amt = add i32 %i.ams, %i.amr
  %i.amu = sext i32 %i.amt to i64
  %i.amv = getelementptr inbounds [4 x i8], ptr %1, i64 %i.amu
  %i.amw = load i32, ptr %i.amv, align 4, !tbaa !4
  %.not749 = icmp slt i32 %i.lx, %i.amw
  br i1 %.not749, label %.critedge, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.amx = shl nsw i32 %.1722, 1                  ; 2 uses
  %i.amy = add nsw i32 %i.amx, %i.lt
  %i.amz = mul nsw i32 %i.amy, %5
  %i.ana = shl nuw nsw i32 %.1, 1                 ; 2 uses
  %i.anb = add nuw i32 %i.ana, %i.amj
  %i.anc = add i32 %i.anb, %i.amz
  %i.and = sext i32 %i.anc to i64
  %i.ane = getelementptr inbounds [4 x i8], ptr %1, i64 %i.and
  %i.anf = load i32, ptr %i.ane, align 4, !tbaa !4
  %i.ang = icmp sgt i32 %i.lx, %i.anf
  br i1 %i.ang, label %bb.r, label %.critedge

bb.r:                                             ; preds = %bb.q
  %i.anh = sub nsw i32 %i.lt, %i.amx
  %i.ani = mul nsw i32 %i.anh, %5
  %i.anj = sub nsw i32 %i.amj, %i.ana
  %i.ank = add i32 %i.anj, %i.ani
  %i.anl = sext i32 %i.ank to i64
  %i.anm = getelementptr inbounds [4 x i8], ptr %1, i64 %i.anl
  %i.ann = load i32, ptr %i.anm, align 4, !tbaa !4
  %.not750 = icmp slt i32 %i.lx, %i.ann
  br i1 %.not750, label %.critedge, label %.critedge.sink.split

.critedge.sink.split:                             ; preds = %bb.r, %bb.k
  %.sink = phi i8 [ 1, %bb.k ], [ 2, %bb.r ]
  %i.ano = getelementptr inbounds nuw i8, ptr %2, i64 %i.lv
  store i8 %.sink, ptr %i.ano, align 1, !tbaa !18
  br label %.critedge

.critedge:                                        ; preds = %.critedge.sink.split, %bb.k, %bb.j, %bb.i, %bb.h, %bb.e, %.thread756, %bb.p, %bb.q, %bb.r
  ...
  br i1 %exitcond891.not, label %._crit_edge877, label %bb.e, !llvm.loop !46

._crit_edge877:                                   ; preds = %.critedge
  ...
  br i1 %exitcond896.not, label %._crit_edge879.split, label %.preheader, !llvm.loop !47

._crit_edge879.split:                             ; preds = %._crit_edge877, %bb.a, %.preheader.lr.ph, %.preheader872
  ret i32 undef
}
...
bb.a:
  ...
  br i1 %i.e, label %.preheader277.lr.ph, label %._crit_edge283.split

.preheader277.lr.ph:                              ; preds = %bb.a
  %i.f = icmp sgt i32 %5, 2
  %i.g = add nsw i32 %5, -2
  %i.h = sext i32 %i.g to i64                     ; 2 uses
  br i1 %i.f, label %.preheader277.preheader, label %.preheader276

.preheader277.preheader:                          ; preds = %.preheader277.lr.ph
  %i.i = add nsw i32 %5, -1
  %i.j = zext nneg i32 %5 to i64
  %wide.trip.count289 = zext nneg i32 %i.d to i64
  %wide.trip.count = zext i32 %i.i to i64
  br label %.preheader277

.preheader277:                                    ; preds = %.preheader277.preheader, %._crit_edge
  %indvars.iv286 = phi i64 [ 1, %.preheader277.preheader ], [ %indvars.iv.next287, %._crit_edge ] ; 3 uses
  %i.k = add nsw i64 %indvars.iv286, -1
  %i.l = mul nsw i64 %i.k, %i.j
  %i.m = getelementptr inbounds i8, ptr %0, i64 %i.l
  %i.n = trunc i64 %indvars.iv286 to i32
  %i.o = mul i32 %5, %i.n
  %i.p = zext i32 %i.o to i64
  br label %bb.b

.preheader276:                                    ; preds = %._crit_edge, %.preheader277.lr.ph
  %i.q = add nsw i32 %6, -2
  %i.r = icmp sgt i32 %6, 4
  br i1 %i.r, label %.preheader.lr.ph, label %._crit_edge283.split

.preheader.lr.ph:                                 ; preds = %.preheader276
  %i.s = add i32 %5, -2                           ; 2 uses
  %i.t = icmp sgt i32 %5, 4
  %i.u = sext i32 %i.s to i64                     ; 5 uses
  br i1 %i.t, label %.preheader.preheader, label %._crit_edge283.split

.preheader.preheader:                             ; preds = %.preheader.lr.ph
  %i.v = zext nneg i32 %5 to i64
  %wide.trip.count299 = zext nneg i32 %i.q to i64
  %wide.trip.count294 = zext i32 %i.s to i64
  br label %.preheader

bb.b:                                             ; preds = %.preheader277, %bb.d
  %indvars.iv = phi i64 [ 1, %.preheader277 ], [ %indvars.iv.next, %bb.d ] ; 3 uses
...
._crit_edge:                                      ; preds = %bb.d
  ...
  br i1 %exitcond290.not, label %.preheader276, label %.preheader277, !llvm.loop !49

.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge281
  %indvars.iv296 = phi i64 [ 2, %.preheader.preheader ], [ %indvars.iv.next297, %._crit_edge281 ] ; 5 uses
  %i.cq = add nsw i64 %indvars.iv296, -1
  %i.cr = mul nsw i64 %i.cq, %i.v
  %i.cs = getelementptr inbounds i8, ptr %0, i64 %i.cr ; 3 uses
  %i.ct = trunc i64 %indvars.iv296 to i32
  %i.cu = mul i32 %5, %i.ct
  %i.cv = zext i32 %i.cu to i64
  %i.cw = trunc nuw nsw i64 %indvars.iv296 to i32 ; 2 uses
  %i.cx = trunc nuw nsw i64 %indvars.iv296 to i32 ; 2 uses
  br label %bb.e

bb.e:                                             ; preds = %.preheader, %.critedge
  %indvars.iv291 = phi i64 [ 2, %.preheader ], [ %indvars.iv.next292, %.critedge ] ; 7 uses
  %i.cy = add nuw nsw i64 %indvars.iv291, %i.cv   ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.dg, label %bb.g, label %._crit_edge301

._crit_edge301:                                   ; preds = %bb.f
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %i.cs, i64 %indvars.iv291 ; 3 uses
  %.phi.trans.insert302 = getelementptr inbounds i8, ptr %.phi.trans.insert, i64 -1
  %.pre = load i8, ptr %.phi.trans.insert302, align 1, !tbaa !18
  %.pre304 = load i8, ptr %.phi.trans.insert, align 1, !tbaa !18
  %.phi.trans.insert306 = getelementptr inbounds nuw i8, ptr %.phi.trans.insert, i64 1 ; 2 uses
  %.pre307 = load i8, ptr %.phi.trans.insert306, align 1, !tbaa !18
  %.phi.trans.insert310 = getelementptr inbounds i8, ptr %.phi.trans.insert306, i64 %i.u
  %.phi.trans.insert311 = getelementptr inbounds nuw i8, ptr %.phi.trans.insert310, i64 2
  %.phi.trans.insert312 = getelementptr inbounds i8, ptr %.phi.trans.insert311, i64 %i.u ; 3 uses
  %.pre313 = load i8, ptr %.phi.trans.insert312, align 1, !tbaa !18
  %.phi.trans.insert319 = getelementptr inbounds nuw i8, ptr %.phi.trans.insert312, i64 1
  %.pre320 = load i8, ptr %.phi.trans.insert319, align 1, !tbaa !18
  %.phi.trans.insert326 = getelementptr inbounds nuw i8, ptr %.phi.trans.insert312, i64 2
  %.pre327 = load i8, ptr %.phi.trans.insert326, align 1, !tbaa !18
  %.pre328 = zext i8 %.pre to i64
  %.pre329 = sub nsw i64 0, %.pre328
  %.pre331 = zext i8 %.pre304 to i64
  %.pre333 = sub nsw i64 0, %.pre331
  %.pre335 = zext i8 %.pre307 to i64
  %.pre337 = sub nsw i64 0, %.pre335
  %.pre339 = zext i8 %.pre313 to i64
  %.pre341 = sub nsw i64 0, %.pre339
  %.pre343 = zext i8 %.pre320 to i64
  %.pre345 = sub nsw i64 0, %.pre343
  %.pre347 = zext i8 %.pre327 to i64
  %.pre349 = sub nsw i64 0, %.pre347
  br label %bb.j

bb.g:                                             ; preds = %bb.f
  %i.dh = sub nuw nsw i32 730, %i.da
  %i.di = getelementptr inbounds nuw i8, ptr %i.cs, i64 %indvars.iv291 ; 3 uses
  ...
  br i1 %i.gd, label %bb.h, label %bb.j
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.gl = fcmp ogt float %.1249, 2.000000e+00     ; 2 uses
  %i.gm = or i1 %i.gi, %i.gl
  %spec.select = select i1 %i.gm, i32 1, i32 -1
  %not. = xor i1 %i.gl, true                      ; 2 uses
  %.0241 = select i1 %i.gk, i32 0, i32 %spec.select ; 2 uses
  %.0240 = zext i1 %not. to i32
  %i.gn = add nsw i32 %.0241, %i.cx
  %i.go = mul nsw i32 %i.gn, %5
  %i.gp = trunc nuw nsw i64 %indvars.iv291 to i32 ; 2 uses
  %i.gq = add nuw nsw i32 %i.gp, %.0240
  %i.gr = add i32 %i.gq, %i.go
  %i.gs = sext i32 %i.gr to i64
  %i.gt = getelementptr inbounds [4 x i8], ptr %1, i64 %i.gs
  %i.gu = load i32, ptr %i.gt, align 4, !tbaa !4
  %i.gv = icmp sgt i32 %i.da, %i.gu
  br i1 %i.gv, label %bb.i, label %.critedge

bb.i:                                             ; preds = %bb.h
  %.0240.neg284 = sext i1 %not. to i32
  %i.gw = sub nsw i32 %i.cx, %.0241
  %i.gx = mul nsw i32 %i.gw, %5
  %i.gy = add i32 %i.gp, %.0240.neg284
  %i.gz = add i32 %i.gy, %i.gx
  %i.ha = sext i32 %i.gz to i64
  %i.hb = getelementptr inbounds [4 x i8], ptr %1, i64 %i.ha
  %i.hc = load i32, ptr %i.hb, align 4, !tbaa !4
  %.not = icmp slt i32 %i.da, %i.hc
  br i1 %.not, label %.critedge, label %.critedge.sink.split

bb.j:                                             ; preds = %._crit_edge301, %bb.g
  %.pre-phi350 = phi i64 [ %.pre349, %._crit_edge301 ], [ %i.fm, %bb.g ]
  %.pre-phi346 = phi i64 [ %.pre345, %._crit_edge301 ], [ %i.ff, %bb.g ]
  %.pre-phi342 = phi i64 [ %.pre341, %._crit_edge301 ], [ %i.ev, %bb.g ]
  %.pre-phi338 = phi i64 [ %.pre337, %._crit_edge301 ], [ %i.dz, %bb.g ]
  %.pre-phi334 = phi i64 [ %.pre333, %._crit_edge301 ], [ %i.dt, %bb.g ]
  %.pre-phi330 = phi i64 [ %.pre329, %._crit_edge301 ], [ %i.dm, %bb.g ]
  %i.hd = getelementptr inbounds i8, ptr %i.df, i64 %.pre-phi330
  %i.he = load i8, ptr %i.hd, align 1, !tbaa !18
  %i.hf = zext i8 %i.he to i32                    ; 2 uses
  %i.hg = getelementptr inbounds i8, ptr %i.df, i64 %.pre-phi334
  %i.hh = load i8, ptr %i.hg, align 1, !tbaa !18
  %i.hi = zext i8 %i.hh to i32
  %i.hj = getelementptr inbounds i8, ptr %i.df, i64 %.pre-phi338
  %i.hk = load i8, ptr %i.hj, align 1, !tbaa !18
  %i.hl = zext i8 %i.hk to i32
  %i.hm = getelementptr inbounds i8, ptr %i.df, i64 %.pre-phi342
  %i.hn = load i8, ptr %i.hm, align 1, !tbaa !18
  %i.ho = zext i8 %i.hn to i32
  %i.hp = getelementptr inbounds i8, ptr %i.df, i64 %.pre-phi346
  %i.hq = load i8, ptr %i.hp, align 1, !tbaa !18
  %i.hr = zext i8 %i.hq to i32
  %i.hs = getelementptr inbounds i8, ptr %i.df, i64 %.pre-phi350
  %i.ht = load i8, ptr %i.hs, align 1, !tbaa !18
  %i.hu = zext i8 %i.ht to i32                    ; 3 uses
  %i.hv = add nuw nsw i32 %i.ho, %i.hl            ; 2 uses
  %i.hw = add nuw nsw i32 %i.hv, %i.hf            ; 2 uses
  %i.hx = add nuw nsw i32 %i.hw, %i.hi
  %i.hy = add nuw nsw i32 %i.hx, %i.hr
  %i.hz = add nuw nsw i32 %i.hy, %i.hu            ; 2 uses
  %.neg275 = add nuw nsw i32 %i.hu, %i.hf
  %i.ia = icmp eq i32 %i.hz, 0
  br i1 %i.ia, label %.thread263, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.ib = getelementptr inbounds nuw i8, ptr %i.cs, i64 %indvars.iv291
  %i.ic = getelementptr inbounds nuw i8, ptr %i.ib, i64 1
  %i.id = getelementptr inbounds i8, ptr %i.ic, i64 %i.u ; 2 uses
  %i.ie = getelementptr inbounds nuw i8, ptr %i.id, i64 2
  %i.if = load i8, ptr %i.id, align 1, !tbaa !18
  %i.ig = zext i8 %i.if to i64
  %i.ih = sub nsw i64 0, %i.ig
  %i.ii = getelementptr inbounds i8, ptr %i.df, i64 %i.ih
  %i.ij = load i8, ptr %i.ii, align 1, !tbaa !18
  %i.ik = zext i8 %i.ij to i32
  %i.il = load i8, ptr %i.ie, align 1, !tbaa !18
  %i.im = zext i8 %i.il to i64
  %i.in = sub nsw i64 0, %i.im
  %i.io = getelementptr inbounds i8, ptr %i.df, i64 %i.in
  %i.ip = load i8, ptr %i.io, align 1, !tbaa !18
  %i.iq = zext i8 %i.ip to i32
  %i.ir = add nuw nsw i32 %i.hw, %i.hu
  %i.is = add nuw nsw i32 %i.ir, %i.ik
  %i.it = add nuw nsw i32 %i.is, %i.iq
  %i.iu = uitofp nneg i32 %i.it to float
  %i.iv = uitofp nneg i32 %i.hz to float
  %i.iw = fdiv float %i.iu, %i.iv                 ; 2 uses
  %i.ix = fcmp olt float %i.iw, 5.000000e-01
  br i1 %i.ix, label %.thread263, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.iy = fcmp ogt float %i.iw, 2.000000e+00
  br i1 %i.iy, label %.thread263, label %bb.m

bb.m:                                             ; preds = %bb.l
  %.inv.not = icmp samesign ugt i32 %.neg275, %i.hv
  %.259 = select i1 %.inv.not, i32 -1, i32 1
  br label %.thread263

.thread263:                                       ; preds = %bb.j, %bb.m, %bb.l, %bb.k
  %.1242 = phi i32 [ 1, %bb.l ], [ 0, %bb.k ], [ %.259, %bb.m ], [ 1, %bb.j ] ; 2 uses
  %.1 = phi i32 [ 0, %bb.l ], [ 1, %bb.k ], [ 1, %bb.m ], [ 0, %bb.j ] ; 2 uses
  %i.iz = add nsw i32 %.1242, %i.cw
  %i.ja = mul nsw i32 %i.iz, %5
  %i.jb = trunc nuw nsw i64 %indvars.iv291 to i32 ; 2 uses
  %i.jc = add nuw nsw i32 %.1, %i.jb
  %i.jd = add i32 %i.jc, %i.ja
  %i.je = sext i32 %i.jd to i64
  %i.jf = getelementptr inbounds [4 x i8], ptr %1, i64 %i.je
  %i.jg = load i32, ptr %i.jf, align 4, !tbaa !4
  %i.jh = icmp sgt i32 %i.da, %i.jg
  br i1 %i.jh, label %bb.n, label %.critedge

bb.n:                                             ; preds = %.thread263
  %i.ji = sub nsw i32 %i.cw, %.1242
  %i.jj = mul nsw i32 %i.ji, %5
  %i.jk = sub nsw i32 %i.jb, %.1
  ...
  %.not258 = icmp slt i32 %i.da, %i.jo
  br i1 %.not258, label %.critedge, label %.critedge.sink.split

.critedge.sink.split:                             ; preds = %bb.n, %bb.i
  %.sink = phi i8 [ 1, %bb.i ], [ 2, %bb.n ]
  %i.jp = getelementptr inbounds nuw i8, ptr %2, i64 %i.cy
  store i8 %.sink, ptr %i.jp, align 1, !tbaa !18
  br label %.critedge

.critedge:                                        ; preds = %.critedge.sink.split, %bb.i, %bb.h, %bb.e, %.thread263, %bb.n
  %indvars.iv.next292 = add nuw nsw i64 %indvars.iv291, 1 ; 2 uses
  %exitcond295.not = icmp eq i64 %indvars.iv.next292, %wide.trip.count294
  br i1 %exitcond295.not, label %._crit_edge281, label %bb.e, !llvm.loop !50

._crit_edge281:                                   ; preds = %.critedge
  %indvars.iv.next297 = add nuw nsw i64 %indvars.iv296, 1 ; 2 uses
  %exitcond300.not = icmp eq i64 %indvars.iv.next297, %wide.trip.count299
  br i1 %exitcond300.not, label %._crit_edge283.split, label %.preheader, !llvm.loop !51

._crit_edge283.split:                             ; preds = %._crit_edge281, %bb.a, %.preheader.lr.ph, %.preheader276
  ret i32 undef
}
...
int_to_uchar.exit:                                ; preds = %.lr.ph39.i115.epil.preheader, %int_to_uchar.exit.loopexit316.unr-lcssa, %.lr.ph.split.i, %.lr.ph.split.us.i, %.lr.ph39.i.epil.preheader, %int_to_uchar.exit.loopexit308.unr-lcssa, %vec.epilog.scalar.ph.prol.loopexit, %bb.ao, %middle.block284, %vec.epilog.middle.block, %bb.au, %bb.aq, %.loopexit.i, %.preheader.i95, %susan_principle_small.exit, %setup_brightness_lut.exit
  %i.ox = phi i32 [ %i.bc, %.lr.ph39.i.epil.preheader ], [ %i.bc, %vec.epilog.scalar.ph.prol.loopexit ], [ %i.kx, %.lr.ph.split.i ], [ %i.bc, %middle.block284 ], [ %i.ba, %setup_brightness_lut.exit ], [ %i.kx, %bb.au ], [ %i.kx, %bb.aq ], [ %i.bc, %.loopexit.i ], [ %i.bc, %.preheader.i95 ], [ %i.bc, %susan_principle_small.exit ], [ %i.kx, %.lr.ph.split.us.i ], [ %i.bc, %vec.epilog.middle.block ], [ %i.bc, %bb.ao ], [ %i.bc, %int_to_uchar.exit.loopexit308.unr-lcssa ], [ %i.kx, %int_to_uchar.exit.loopexit316.unr-lcssa ], [ %i.kx, %.lr.ph39.i115.epil.preheader ]
  %i.oy = phi i32 [ %i.bb, %.lr.ph39.i.epil.preheader ], [ %i.bb, %vec.epilog.scalar.ph.prol.loopexit ], [ %i.kw, %.lr.ph.split.i ], [ %i.bb, %middle.block284 ], [ %i.az, %setup_brightness_lut.exit ], [ %i.kw, %bb.au ], [ %i.kw, %bb.aq ], [ %i.bb, %.loopexit.i ], [ %i.bb, %.preheader.i95 ], [ %i.bb, %susan_principle_small.exit ], [ %i.kw, %.lr.ph.split.us.i ], [ %i.bb, %vec.epilog.middle.block ], [ %i.bb, %bb.ao ], [ %i.bb, %int_to_uchar.exit.loopexit308.unr-lcssa ], [ %i.kw, %int_to_uchar.exit.loopexit316.unr-lcssa ], [ %i.kw, %.lr.ph39.i115.epil.preheader ]
  %i.oz = phi ptr [ %i.bw, %.lr.ph39.i.epil.preheader ], [ %i.gj, %vec.epilog.scalar.ph.prol.loopexit ], [ %i.lr, %.lr.ph.split.i ], [ %i.gj, %middle.block284 ], [ %i.ay, %setup_brightness_lut.exit ], [ %i.lr, %bb.au ], [ %i.lr, %bb.aq ], [ %i.gj, %.loopexit.i ], [ %i.gj, %.preheader.i95 ], [ %i.bw, %susan_principle_small.exit ], [ %i.lr, %.lr.ph.split.us.i ], [ %i.gj, %vec.epilog.middle.block ], [ %i.gj, %bb.ao ], [ %i.bw, %int_to_uchar.exit.loopexit308.unr-lcssa ], [ %i.lr, %int_to_uchar.exit.loopexit316.unr-lcssa ], [ %i.lr, %.lr.ph39.i115.epil.preheader ]
