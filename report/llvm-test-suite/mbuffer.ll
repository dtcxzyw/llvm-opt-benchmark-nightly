...
.lr.ph477:                                        ; preds = %.preheader471, %.lr.ph477
  ...
  %.idx550 = shl nuw nsw i64 %indvars.iv511, 4
  %i.dq = getelementptr inbounds nuw i8, ptr %i.dp, i64 %.idx550
...
bb.d:                                             ; preds = %bb.c, %._crit_edge
  ...
  br i1 %i.ir, label %.lr.ph486, label %._crit_edge487
...
.lr.ph486:                                        ; preds = %bb.d
  ...
  br i1 %i.iu, label %.lr.ph486.split.us, label %._crit_edge487

.lr.ph486.split.us:                               ; preds = %.lr.ph486
  %1 = lshr i32 %i.it, 2                          ; 2 uses
  %i.jb = getelementptr inbounds nuw i8, ptr %i.in, i64 6432
  %2 = load i32, ptr %i.jb, align 8, !tbaa !89
  %.not462.us = icmp eq i32 %2, 0
  %wide.trip.count528 = zext nneg i32 %i.iq to i64
  %wide.trip.count.a = zext nneg i32 %1 to i64
  %wide.trip.count523.a = zext nneg i32 %1 to i64
  br label %.lr.ph482.us.a

.lr.ph482.us.a:                                   ; preds = %._crit_edge483.us, %.lr.ph486.split.us
  %indvars.iv525.a = phi i64 [ %indvars.iv.next526, %._crit_edge483.us ], [ 0, %.lr.ph486.split.us ] ; 14 uses
  %i.jc = trunc nuw nsw i64 %indvars.iv525.a to i32 ; 2 uses
  %i.jd = lshr i32 %i.jc, 2
  %i.je = and i32 %i.jd, 1                        ; 2 uses
  %i.jf = lshr i32 %i.jc, 3
  %i.jg = mul nsw i32 %i.jf, %i.f
  %invariant.op.us = or disjoint i32 %i.jg, %i.je
  %.not464.us = icmp eq i32 %i.je, 0
  %i.jh = select i1 %.not464.us, i32 2, i32 4     ; 2 uses
...
bb.e:                                             ; preds = %.lr.ph482.split.us490, %bb.r
  %indvars.iv517 = phi i64 [ 0, %.lr.ph482.split.us490 ], [ %indvars.iv.next518, %bb.r ] ; 10 uses
  %i.jq = trunc nuw nsw i64 %indvars.iv517 to i32
  %i.jr = lshr i32 %i.jq, 1
  %i.js = and i32 %i.jr, 1073741822
  %.reass.us = add i32 %i.js, %invariant.op.us
  %i.jt = sext i32 %.reass.us to i64
  %i.ju = getelementptr inbounds i8, ptr %3, i64 %i.jt
  %i.jv = load i8, ptr %i.ju, align 1, !tbaa !214
  %.not463.us = icmp eq i8 %i.jv, 0
  %i.jw = getelementptr inbounds nuw i8, ptr %7, i64 %indvars.iv517
  %i.jx = load i8, ptr %i.jw, align 1, !tbaa !214 ; 4 uses
  br i1 %.not463.us, label %bb.n, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.jy = sext i8 %i.jx to i32                    ; 2 uses
  %i.jz = load ptr, ptr %8, align 8, !tbaa !212
  %i.ka = getelementptr inbounds nuw [8 x i8], ptr %i.jz, i64 %indvars.iv525.a
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  %i.kn = getelementptr inbounds nuw [8 x i8], ptr %i.km, i64 %indvars.iv525.a
...
bb.j:                                             ; preds = %bb.i, %bb.h
  ...
  %i.kx = getelementptr inbounds nuw [8 x i8], ptr %i.kw, i64 %indvars.iv525.a
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %i.lf = getelementptr inbounds nuw [8 x i8], ptr %i.le, i64 %indvars.iv525.a
...
bb.n:                                             ; preds = %bb.e
  %i.ll = load ptr, ptr %9, align 8, !tbaa !212
  %i.lm = getelementptr inbounds nuw [8 x i8], ptr %i.ll, i64 %indvars.iv525.a
...
bb.p:                                             ; preds = %bb.o, %bb.n
  ...
  %i.ly = getelementptr inbounds nuw [8 x i8], ptr %i.lx, i64 %indvars.iv525.a
...
bb.r:                                             ; preds = %bb.p, %bb.q, %bb.l, %bb.m
  %.sink566 = phi ptr [ %i.kk, %bb.l ], [ %i.kk, %bb.m ], [ %i.lw, %bb.q ], [ %i.lw, %bb.p ]
  %.sink = phi i64 [ 0, %bb.l ], [ %i.lk, %bb.m ], [ %i.md, %bb.q ], [ -1, %bb.p ]
  %i.me = getelementptr inbounds nuw i8, ptr %.sink566, i64 8
  %i.mf = load ptr, ptr %i.me, align 8, !tbaa !217
  %i.mg = getelementptr inbounds nuw [8 x i8], ptr %i.mf, i64 %indvars.iv525.a
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next518, %wide.trip.count.a
  br i1 %exitcond.not, label %._crit_edge483.us, label %bb.e, !llvm.loop !236

.lr.ph482.split.us490:                            ; preds = %.lr.ph482.us.a
  %3 = load ptr, ptr %i.iv, align 8, !tbaa !69
  %4 = load ptr, ptr %i.iw, align 8, !tbaa !90    ; 3 uses
  %5 = load ptr, ptr %4, align 8, !tbaa !212
  %6 = getelementptr inbounds nuw [8 x i8], ptr %5, i64 %indvars.iv525.a
  %7 = load ptr, ptr %6, align 8, !tbaa !213
  %8 = getelementptr inbounds nuw i8, ptr %4, i64 8
  %9 = getelementptr inbounds nuw i8, ptr %4, i64 8
  br label %bb.e

._crit_edge483.us:                                ; preds = %bb.r, %bb.s
  %indvars.iv.next526 = add nuw nsw i64 %indvars.iv525.a, 1 ; 2 uses
  %exitcond529.not = icmp eq i64 %indvars.iv.next526, %wide.trip.count528
  br i1 %exitcond529.not, label %._crit_edge487, label %.lr.ph482.us.a, !llvm.loop !237

.lr.ph482.split.us.us:                            ; preds = %.lr.ph482.us.a
  %10 = load ptr, ptr %i.iw, align 8, !tbaa !90   ; 2 uses
  %11 = load ptr, ptr %10, align 8, !tbaa !212
  %12 = getelementptr inbounds nuw [8 x i8], ptr %11, i64 %indvars.iv525.a
  %13 = load ptr, ptr %12, align 8, !tbaa !213
  %14 = getelementptr inbounds nuw i8, ptr %10, i64 8
  %15 = load ptr, ptr %14, align 8, !tbaa !212
  %16 = getelementptr inbounds nuw [8 x i8], ptr %15, i64 %indvars.iv525.a
  %17 = load ptr, ptr %16, align 8, !tbaa !213
  %18 = load ptr, ptr %i.iy, align 8, !tbaa !92   ; 2 uses
  %19 = load ptr, ptr %18, align 8, !tbaa !217
  %20 = getelementptr inbounds nuw [8 x i8], ptr %19, i64 %indvars.iv525.a
  %21 = load ptr, ptr %20, align 8, !tbaa !219
  %22 = getelementptr inbounds nuw i8, ptr %18, i64 8
  %23 = load ptr, ptr %22, align 8, !tbaa !217
  %24 = getelementptr inbounds nuw [8 x i8], ptr %23, i64 %indvars.iv525.a
  %25 = load ptr, ptr %24, align 8, !tbaa !219
  br label %26

26:                                               ; preds = %bb.s, %.lr.ph482.split.us.us
  %indvars.iv520 = phi i64 [ %indvars.iv.next521, %bb.s ], [ 0, %.lr.ph482.split.us.us ] ; 5 uses
  %27 = getelementptr inbounds nuw i8, ptr %13, i64 %indvars.iv520
  %28 = load i8, ptr %27, align 1, !tbaa !214     ; 2 uses
  %29 = getelementptr inbounds nuw i8, ptr %17, i64 %indvars.iv520
  %30 = load i8, ptr %29, align 1, !tbaa !214     ; 2 uses
...
33:                                               ; preds = %26
  ...
  %35 = getelementptr inbounds nuw [8 x i8], ptr %i.ix, i64 %34
  %36 = load i64, ptr %35, align 8, !tbaa !215
  br label %37

37:                                               ; preds = %33, %26
  %38 = phi i64 [ %36, %33 ], [ -1, %26 ]
  %39 = getelementptr inbounds nuw [8 x i8], ptr %21, i64 %indvars.iv520
  store i64 %38, ptr %39, align 8, !tbaa !215
  %40 = icmp sgt i8 %30, -1
  br i1 %40, label %41, label %bb.s

41:                                               ; preds = %37
  %42 = getelementptr inbounds nuw [8 x i8], ptr %i.ja, i64 %31
  %43 = load i64, ptr %42, align 8, !tbaa !215
  br label %bb.s

bb.s:                                             ; preds = %41, %37
  %44 = phi i64 [ %43, %41 ], [ -1, %37 ]
  %45 = getelementptr inbounds nuw [8 x i8], ptr %25, i64 %indvars.iv520
  store i64 %44, ptr %45, align 8, !tbaa !215
  %indvars.iv.next521 = add nuw nsw i64 %indvars.iv520, 1 ; 2 uses
  %exitcond524.not = icmp eq i64 %indvars.iv.next521, %wide.trip.count523.a
  br i1 %exitcond524.not, label %._crit_edge483.us, label %26, !llvm.loop !236

._crit_edge487:                                   ; preds = %._crit_edge483.us, %.lr.ph486, %bb.d
  ...
  br i1 %.not456, label %bb.t, label %.loopexit469.thread552

bb.t:                                             ; preds = %._crit_edge487
...
.preheader468:                                    ; preds = %bb.t
  %i.mo = icmp sgt i32 %i.ip, 7
  br i1 %i.mo, label %.lr.ph496, label %.loopexit

.lr.ph496:                                        ; preds = %.preheader468
  %i.mp = getelementptr inbounds nuw i8, ptr %0, i64 48 ; 4 uses
  %i.mq = getelementptr inbounds nuw i8, ptr %0, i64 56 ; 4 uses
  br label %bb.u

bb.u:                                             ; preds = %.lr.ph496, %._crit_edge494
  %i.mr = phi ptr [ %i.in, %.lr.ph496 ], [ %i.wb, %._crit_edge494 ] ; 4 uses
  %indvars.iv533 = phi i64 [ 0, %.lr.ph496 ], [ %indvars.iv.next534, %._crit_edge494 ] ; 17 uses
  %i.ms = getelementptr inbounds nuw i8, ptr %i.mr, i64 6392
  %i.mt = load i32, ptr %i.ms, align 8, !tbaa !78
  %i.mu = icmp sgt i32 %i.mt, 3
  br i1 %i.mu, label %.lr.ph493, label %._crit_edge494

.lr.ph493:                                        ; preds = %bb.u
  %i.mv = trunc nuw nsw i64 %indvars.iv533 to i32 ; 3 uses
  %i.mw = lshr i32 %i.mv, 1
  %i.mx = shl nuw nsw i64 %indvars.iv533, 1       ; 3 uses
  ...
  %i.nf = and i32 %i.mw, 1
  %invariant.op = or disjoint i32 %i.ne, %i.nf
  %i.ng = zext nneg i32 %i.nc to i64              ; 6 uses
  %i.nh = zext nneg i32 %i.nb to i64              ; 6 uses
  br label %bb.v

bb.v:                                             ; preds = %.lr.ph493, %bb.x
  %i.ni = phi ptr [ %i.mr, %.lr.ph493 ], [ %i.vu, %bb.x ]
  %i.nj = phi ptr [ %i.mr, %.lr.ph493 ], [ %i.vv, %bb.x ] ; 2 uses
  %indvars.iv530.a = phi i64 [ 0, %.lr.ph493 ], [ %indvars.iv.next531.a, %bb.x ] ; 30 uses
  %i.nk = trunc nuw nsw i64 %indvars.iv530.a to i32
  %i.nl = lshr i32 %i.nk, 1
  %i.nm = and i32 %i.nl, 1073741822
  %.reass = add i32 %i.nm, %invariant.op
  %i.nn = getelementptr inbounds nuw i8, ptr %i.nj, i64 6480
  %i.no = load ptr, ptr %i.nn, align 8, !tbaa !69
  %i.np = sext i32 %.reass to i64
  %i.nq = getelementptr inbounds i8, ptr %i.no, i64 %i.np
  %i.nr = load i8, ptr %i.nq, align 1, !tbaa !214
  %.not458 = icmp eq i8 %i.nr, 0
  br i1 %.not458, label %bb.x, label %bb.w
...
bb.w:                                             ; preds = %bb.v
  ...
  %i.nv = getelementptr inbounds nuw [8 x i8], ptr %i.nu, i64 %indvars.iv533
  %i.nw = load ptr, ptr %i.nv, align 8, !tbaa !213
  %i.nx = getelementptr inbounds nuw i8, ptr %i.nw, i64 %indvars.iv530.a
  ...
  %i.ob = getelementptr inbounds nuw [8 x i8], ptr %i.oa, i64 %indvars.iv533
  %i.oc = load ptr, ptr %i.ob, align 8, !tbaa !213
  %i.od = getelementptr inbounds nuw i8, ptr %i.oc, i64 %indvars.iv530.a
  ...
  %i.ok = getelementptr inbounds nuw i8, ptr %i.oj, i64 %indvars.iv530.a
  ...
  %i.oq = getelementptr inbounds nuw i8, ptr %i.op, i64 %indvars.iv530.a
  ...
  %i.ox = getelementptr inbounds nuw [8 x i8], ptr %i.ow, i64 %indvars.iv530.a
  ...
  %i.pe = getelementptr inbounds nuw [8 x i8], ptr %i.pd, i64 %indvars.iv533
  %i.pf = load ptr, ptr %i.pe, align 8, !tbaa !229
  %i.pg = getelementptr inbounds nuw [8 x i8], ptr %i.pf, i64 %indvars.iv530.a
  ...
  %i.pp = getelementptr inbounds nuw [8 x i8], ptr %i.po, i64 %indvars.iv530.a
  ...
  %i.pu = getelementptr inbounds nuw [8 x i8], ptr %i.pt, i64 %indvars.iv533
  %i.pv = load ptr, ptr %i.pu, align 8, !tbaa !229
  %i.pw = getelementptr inbounds nuw [8 x i8], ptr %i.pv, i64 %indvars.iv530.a
  ...
  %i.qg = getelementptr inbounds nuw i8, ptr %i.qf, i64 %indvars.iv530.a
  ...
  %i.ql = getelementptr inbounds nuw [8 x i8], ptr %i.qk, i64 %indvars.iv533
  %i.qm = load ptr, ptr %i.ql, align 8, !tbaa !213
  %i.qn = getelementptr inbounds nuw i8, ptr %i.qm, i64 %indvars.iv530.a
  ...
  %i.qv = getelementptr inbounds nuw i8, ptr %i.qu, i64 %indvars.iv530.a
  ...
  %i.rc = getelementptr inbounds nuw [8 x i8], ptr %i.rb, i64 %indvars.iv533
  %i.rd = load ptr, ptr %i.rc, align 8, !tbaa !213
  %i.re = getelementptr inbounds nuw i8, ptr %i.rd, i64 %indvars.iv530.a
  ...
  %i.rm = getelementptr inbounds nuw [8 x i8], ptr %i.rl, i64 %indvars.iv530.a
  ...
  %i.rs = getelementptr inbounds nuw [8 x i8], ptr %i.rr, i64 %indvars.iv533
  %i.rt = load ptr, ptr %i.rs, align 8, !tbaa !219
  %i.ru = getelementptr inbounds nuw [8 x i8], ptr %i.rt, i64 %indvars.iv530.a
  ...
  %i.rz = getelementptr inbounds nuw [8 x i8], ptr %i.ry, i64 %indvars.iv530.a
  ...
  %i.sd = getelementptr inbounds nuw [8 x i8], ptr %i.sc, i64 %indvars.iv533
  %i.se = load ptr, ptr %i.sd, align 8, !tbaa !219
  %i.sf = getelementptr inbounds nuw [8 x i8], ptr %i.se, i64 %indvars.iv530.a
  ...
  %i.sl = getelementptr inbounds nuw [8 x i8], ptr %i.sk, i64 %indvars.iv530.a
  %i.sm = load ptr, ptr %i.sl, align 8, !tbaa !226 ; 2 uses
end_hunk_0
begin_hunk_1_@compute_colocated:bb.a
._crit_edge980:                                   ; preds = %bb.bz
  %i.asq = icmp eq i8 %i.asb, -1
  br i1 %i.asq, label %bb.cc, label %bb.cf

bb.cc:                                            ; preds = %._crit_edge980
  %i.asr = getelementptr inbounds nuw i8, ptr %.pre978, i64 8
  %i.ass = load ptr, ptr %i.asr, align 8, !tbaa !212
  %i.ast = getelementptr inbounds nuw [8 x i8], ptr %i.ass, i64 %indvars.iv900
  %i.asu = load ptr, ptr %i.ast, align 8, !tbaa !213
  %i.asv = getelementptr inbounds nuw i8, ptr %i.asu, i64 %indvars.iv897
...
bb.cd:                                            ; preds = %bb.cc
  ...
  %i.atb = getelementptr inbounds nuw [8 x i8], ptr %i.ata, i64 %indvars.iv900
  %i.atc = load ptr, ptr %i.atb, align 8, !tbaa !229
  %i.atd = getelementptr inbounds nuw [8 x i8], ptr %i.atc, i64 %indvars.iv897
...
bb.cf:                                            ; preds = %.thread1030, %._crit_edge980, %bb.cc, %bb.cd, %bb.ce, %bb.cb
  %i.atn = phi i8 [ 0, %bb.cb ], [ 1, %bb.cd ], [ 1, %bb.cc ], [ 1, %._crit_edge980 ], [ %i.atm, %bb.ce ], [ 1, %.thread1030 ]
  %i.ato = load ptr, ptr %i.ajc, align 8, !tbaa !294
  %i.atp = getelementptr inbounds nuw [8 x i8], ptr %i.ato, i64 %indvars.iv900
  %i.atq = load ptr, ptr %i.atp, align 8, !tbaa !213
  %i.atr = getelementptr inbounds nuw i8, ptr %i.atq, i64 %indvars.iv897
...
._crit_edge848:                                   ; preds = %._crit_edge848.loopexit, %.preheader822
  ...
  %i.aua = icmp slt i64 %indvars.iv.next901, %i.atz
...
.preheader819.lr.ph:                              ; preds = %.preheader820
  ...
  br i1 %i.aul, label %.preheader819.lr.ph.split.us, label %.preheader818

.preheader819.lr.ph.split.us:                     ; preds = %.preheader819.lr.ph
  %i.aup = getelementptr inbounds nuw i8, ptr %i.auc, i64 15268
  %i.auq = load i32, ptr %i.aup, align 4, !tbaa !304
  %.not796.us = icmp eq i32 %i.auq, 0
  br i1 %.not796.us, label %.preheader819.lr.ph.split.us.split.us, label %.preheader819.lr.ph.split.us.split

.preheader819.lr.ph.split.us.split.us:            ; preds = %.preheader819.lr.ph.split.us
  %i.aur = load i32, ptr %i.aun, align 8, !tbaa !160
  %.not797.us.us.us = icmp eq i32 %i.aur, 0
  %i.aus = load ptr, ptr %i.aum, align 8, !tbaa !95 ; 2 uses
  %wide.trip.count935 = zext nneg i32 %i.aug to i64 ; 2 uses
  %wide.trip.count930 = zext nneg i32 %i.auk to i64 ; 2 uses
  br i1 %.not797.us.us.us, label %.preheader819.us.us.us, label %.preheader819.us.us

.preheader819.us.us.us:                           ; preds = %.preheader819.lr.ph.split.us.split.us, %._crit_edge859.split.us.us.us.split.us.us
  %indvars.iv932 = phi i64 [ %indvars.iv.next933, %._crit_edge859.split.us.us.us.split.us.us ], [ 0, %.preheader819.lr.ph.split.us.split.us ] ; 4 uses
  %i.aut = getelementptr inbounds nuw [8 x i8], ptr %i.aus, i64 %indvars.iv932
  %i.auu = load ptr, ptr %i.aut, align 8, !tbaa !213
  br label %bb.ch

bb.ch:                                            ; preds = %.thread.us.us.us.us.us, %.preheader819.us.us.us
  %indvars.iv927.a = phi i64 [ %indvars.iv.next928.a, %.thread.us.us.us.us.us ], [ 0, %.preheader819.us.us.us ] ; 4 uses
  %i.auv = getelementptr inbounds nuw i8, ptr %i.auu, i64 %indvars.iv927.a
  %i.auw = load i8, ptr %i.auv, align 1, !tbaa !214
  %.not798.us.us.us.us.us = icmp eq i8 %i.auw, 0
  br i1 %.not798.us.us.us.us.us, label %.thread.us.us.us.us.us, label %bb.ci

bb.ci:                                            ; preds = %bb.ch
  %i.aux = load ptr, ptr %i.auo, align 8, !tbaa !293 ; 2 uses
  %i.auy = load ptr, ptr %i.aux, align 8, !tbaa !238
  %i.auz = getelementptr inbounds nuw [8 x i8], ptr %i.auy, i64 %indvars.iv932
  %i.ava = load ptr, ptr %i.auz, align 8, !tbaa !229
  %i.avb = getelementptr inbounds nuw [8 x i8], ptr %i.ava, i64 %indvars.iv927.a
  ...
  %i.avi = getelementptr inbounds nuw [8 x i8], ptr %i.avh, i64 %indvars.iv932
  %i.avj = load ptr, ptr %i.avi, align 8, !tbaa !229
  %i.avk = getelementptr inbounds nuw [8 x i8], ptr %i.avj, i64 %indvars.iv927.a
  ...
  br label %.thread.us.us.us.us.us

.thread.us.us.us.us.us:                           ; preds = %bb.ch, %bb.ci
  %indvars.iv.next928.a = add nuw nsw i64 %indvars.iv927.a, 1 ; 2 uses
  %exitcond931.not = icmp eq i64 %indvars.iv.next928.a, %wide.trip.count930
  br i1 %exitcond931.not, label %._crit_edge859.split.us.us.us.split.us.us, label %bb.ch, !llvm.loop !318

._crit_edge859.split.us.us.us.split.us.us:        ; preds = %.thread.us.us.us.us.us
  ...
  br i1 %exitcond936.not, label %.preheader818, label %.preheader819.us.us.us, !llvm.loop !319

.preheader819.us.us:                              ; preds = %.preheader819.lr.ph.split.us.split.us, %._crit_edge859.split.us.us.us.split.split
  %indvars.iv922 = phi i64 [ %indvars.iv.next923, %._crit_edge859.split.us.us.us.split.split ], [ 0, %.preheader819.lr.ph.split.us.split.us ] ; 4 uses
  %i.avp = getelementptr inbounds nuw [8 x i8], ptr %i.aus, i64 %indvars.iv922
  %i.avq = load ptr, ptr %i.avp, align 8, !tbaa !213
  br label %.thread.us.us.us

.thread.us.us.us:                                 ; preds = %bb.ck, %.preheader819.us.us
  %indvars.iv917 = phi i64 [ %indvars.iv.next918, %bb.ck ], [ 0, %.preheader819.us.us ] ; 4 uses
  %i.avr = getelementptr inbounds nuw i8, ptr %i.avq, i64 %indvars.iv917
  %i.avs = load i8, ptr %i.avr, align 1, !tbaa !214
  %.not802.us.us.us = icmp eq i8 %i.avs, 0
  br i1 %.not802.us.us.us, label %bb.cj, label %bb.ck

bb.cj:                                            ; preds = %.thread.us.us.us
  %i.avt = load ptr, ptr %i.auo, align 8, !tbaa !293 ; 2 uses
  %i.avu = load ptr, ptr %i.avt, align 8, !tbaa !238
  %i.avv = getelementptr inbounds nuw [8 x i8], ptr %i.avu, i64 %indvars.iv922
  %i.avw = load ptr, ptr %i.avv, align 8, !tbaa !229
  %i.avx = getelementptr inbounds nuw [8 x i8], ptr %i.avw, i64 %indvars.iv917
  ...
  %i.awe = getelementptr inbounds nuw [8 x i8], ptr %i.awd, i64 %indvars.iv922
  %i.awf = load ptr, ptr %i.awe, align 8, !tbaa !229
  %i.awg = getelementptr inbounds nuw [8 x i8], ptr %i.awf, i64 %indvars.iv917
...
bb.ck:                                            ; preds = %bb.cj, %.thread.us.us.us
  %indvars.iv.next918 = add nuw nsw i64 %indvars.iv917, 1 ; 2 uses
  %exitcond921.not = icmp eq i64 %indvars.iv.next918, %wide.trip.count930
  br i1 %exitcond921.not, label %._crit_edge859.split.us.us.us.split.split, label %.thread.us.us.us, !llvm.loop !318

._crit_edge859.split.us.us.us.split.split:        ; preds = %bb.ck
  %indvars.iv.next923 = add nuw nsw i64 %indvars.iv922, 1 ; 2 uses
  %exitcond926.not = icmp eq i64 %indvars.iv.next923, %wide.trip.count935
  br i1 %exitcond926.not, label %.preheader818, label %.preheader819.us.us, !llvm.loop !319

.preheader819.lr.ph.split.us.split:               ; preds = %.preheader819.lr.ph.split.us
  %i.awl = load ptr, ptr %i.aum, align 8, !tbaa !95
  %wide.trip.count915 = zext nneg i32 %i.aug to i64
  %wide.trip.count = zext nneg i32 %i.auk to i64
  br label %.preheader819.us

.preheader819.us:                                 ; preds = %._crit_edge859.split.us865, %.preheader819.lr.ph.split.us.split
  %indvars.iv912 = phi i64 [ %indvars.iv.next913, %._crit_edge859.split.us865 ], [ 0, %.preheader819.lr.ph.split.us.split ] ; 6 uses
  %i.awm = getelementptr inbounds nuw [8 x i8], ptr %i.awl, i64 %indvars.iv912
  %i.awn = load ptr, ptr %i.awm, align 8, !tbaa !213
  br label %bb.cl

bb.cl:                                            ; preds = %.preheader819.us, %bb.co
  %indvars.iv909 = phi i64 [ 0, %.preheader819.us ], [ %indvars.iv.next910, %bb.co ] ; 6 uses
  %i.awo = getelementptr inbounds nuw i8, ptr %i.awn, i64 %indvars.iv909
  %i.awp = load i8, ptr %i.awo, align 1, !tbaa !214
  %.not800.us = icmp eq i8 %i.awp, 0
  br i1 %.not800.us, label %.thread.us862, label %bb.cm

bb.cm:                                            ; preds = %bb.cl
  %i.awq = load ptr, ptr %i.auo, align 8, !tbaa !293 ; 2 uses
  %i.awr = load ptr, ptr %i.awq, align 8, !tbaa !238
  %i.aws = getelementptr inbounds nuw [8 x i8], ptr %i.awr, i64 %indvars.iv912
  %i.awt = load ptr, ptr %i.aws, align 8, !tbaa !229
  %i.awu = getelementptr inbounds nuw [8 x i8], ptr %i.awt, i64 %indvars.iv909
  ...
  %i.axb = getelementptr inbounds nuw [8 x i8], ptr %i.axa, i64 %indvars.iv912
  %i.axc = load ptr, ptr %i.axb, align 8, !tbaa !229
  %i.axd = getelementptr inbounds nuw [8 x i8], ptr %i.axc, i64 %indvars.iv909
...
.thread.us862:                                    ; preds = %bb.cl
  %i.axi = load i32, ptr %i.aun, align 8, !tbaa !160
  %.not801.us863 = icmp eq i32 %i.axi, 0
  br i1 %.not801.us863, label %bb.co, label %bb.cn

bb.cn:                                            ; preds = %.thread.us862
  %i.axj = load ptr, ptr %i.auo, align 8, !tbaa !293 ; 2 uses
  %i.axk = load ptr, ptr %i.axj, align 8, !tbaa !238
  %i.axl = getelementptr inbounds nuw [8 x i8], ptr %i.axk, i64 %indvars.iv912
  %i.axm = load ptr, ptr %i.axl, align 8, !tbaa !229
  %i.axn = getelementptr inbounds nuw [8 x i8], ptr %i.axm, i64 %indvars.iv909
  ...
  %i.axu = getelementptr inbounds nuw [8 x i8], ptr %i.axt, i64 %indvars.iv912
  %i.axv = load ptr, ptr %i.axu, align 8, !tbaa !229
  %i.axw = getelementptr inbounds nuw [8 x i8], ptr %i.axv, i64 %indvars.iv909
...
bb.co:                                            ; preds = %bb.cn, %.thread.us862, %bb.cm
  %indvars.iv.next910 = add nuw nsw i64 %indvars.iv909, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next910, %wide.trip.count
  br i1 %exitcond.not, label %._crit_edge859.split.us865, label %bb.cl, !llvm.loop !318

._crit_edge859.split.us865:                       ; preds = %bb.co
  ...
  br i1 %exitcond916.not, label %.preheader818, label %.preheader819.us, !llvm.loop !319

.preheader818:                                    ; preds = %._crit_edge859.split.us865, %._crit_edge859.split.us.us.us.split.split, %._crit_edge859.split.us.us.us.split.us.us, %.preheader819.lr.ph, %.preheader820
  %2 = getelementptr inbounds nuw i8, ptr %i.auc, i64 15268 ; 2 uses
  %3 = load i32, ptr %2, align 4, !tbaa !304      ; 2 uses
  %.not794874 = icmp slt i32 %3, 0
  br i1 %.not794874, label %.loopexit, label %.preheader.lr.ph

.preheader.lr.ph:                                 ; preds = %.preheader818
  %4 = getelementptr inbounds nuw i8, ptr %i.auc, i64 14472
  br label %.preheader

.preheader:                                       ; preds = %.preheader.lr.ph, %._crit_edge873
  %i.ayb = phi i32 [ %3, %.preheader.lr.ph ], [ %i.azt, %._crit_edge873 ]
  %indvars.iv940 = phi i64 [ 0, %.preheader.lr.ph ], [ %indvars.iv.next941, %._crit_edge873 ] ; 6 uses
  %i.ayc = getelementptr inbounds nuw [4 x i8], ptr @listXsize, i64 %indvars.iv940 ; 2 uses
  %i.ayd = load i32, ptr %i.ayc, align 8, !tbaa !4
  %i.aye = icmp sgt i32 %i.ayd, 0
  br i1 %i.aye, label %.lr.ph872, label %._crit_edge873

.lr.ph872:                                        ; preds = %.preheader
  %i.ayf = load ptr, ptr @enc_picture, align 8    ; 3 uses
  %i.ayg = getelementptr inbounds nuw i8, ptr %i.ayf, i64 8
  %i.ayh = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv940 ; 2 uses
  ...
  %i.ayp = getelementptr inbounds nuw [128 x i8], ptr %4, i64 %indvars.iv940
  %i.ayq = trunc nuw nsw i64 %indvars.iv940 to i32
  br label %bb.cp

bb.cp:                                            ; preds = %.lr.ph872, %bb.cu
  %indvars.iv937 = phi i64 [ 0, %.lr.ph872 ], [ %indvars.iv.next938, %bb.cu ] ; 4 uses
  %i.ayr = getelementptr inbounds nuw [8 x i8], ptr %i.ayo, i64 %indvars.iv937
...
bb.cs:                                            ; preds = %bb.cp, %bb.cq, %bb.cr
  %.sink1065.in = phi ptr [ %i.ayg, %bb.cq ], [ %i.ayj, %bb.cr ], [ %i.ayi, %bb.cp ]
  %i.ayv = load i32, ptr %i.ayn, align 4, !tbaa !132 ; 2 uses
  %i.ayw = getelementptr inbounds nuw [8 x i8], ptr %i.ayo, i64 %indvars.iv937
...
bb.ct:                                            ; preds = %bb.cs
  %.sink1065 = load i32, ptr %.sink1065.in, align 4, !tbaa !4
  %i.aza = sub nsw i32 %.sink1065, %i.ayu
...
bb.cu:                                            ; preds = %bb.cs, %bb.ct
  %.sink1066 = phi i32 [ %i.azo, %bb.ct ], [ 9999, %bb.cs ]
  %i.azp = getelementptr inbounds nuw [4 x i8], ptr %i.ayp, i64 %indvars.iv937
  store i32 %.sink1066, ptr %i.azp, align 4, !tbaa !4
  ...
  %i.azs = icmp slt i64 %indvars.iv.next938, %i.azr
  br i1 %i.azs, label %bb.cp, label %._crit_edge873.loopexit, !llvm.loop !320

._crit_edge873.loopexit:                          ; preds = %bb.cu
  %.pre997 = load i32, ptr %2, align 4, !tbaa !304
  br label %._crit_edge873

._crit_edge873:                                   ; preds = %._crit_edge873.loopexit, %.preheader
  %i.azt = phi i32 [ %.pre997, %._crit_edge873.loopexit ], [ %i.ayb, %.preheader ] ; 2 uses
  %indvars.iv.next941 = add nuw nsw i64 %indvars.iv940, 2
  %i.azu = shl nsw i32 %i.azt, 2
  %i.azv = sext i32 %i.azu to i64
  %.not794.not = icmp slt i64 %indvars.iv940, %i.azv
  br i1 %.not794.not, label %.preheader, label %.loopexit, !llvm.loop !321

.loopexit:                                        ; preds = %._crit_edge873, %.preheader818, %.loopexit821
  ret void
}
