...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %1 = load <3 x i64>, ptr %i.t, align 8, !tbaa !215, !alias.scope !249
  %strided.vec = shufflevector <3 x i64> %1, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  ...
  %2 = load <3 x i64>, ptr %i.w, align 8, !tbaa !215, !alias.scope !252
  %strided.vec197 = shufflevector <3 x i64> %2, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body214:                                   ; preds = %vector.body214, %vector.ph211
  ...
  %3 = load <3 x i64>, ptr %i.at, align 8, !tbaa !215, !alias.scope !258
  %strided.vec217 = shufflevector <3 x i64> %3, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  ...
  %4 = load <3 x i64>, ptr %i.aw, align 8, !tbaa !215, !alias.scope !261
  %strided.vec219 = shufflevector <3 x i64> %4, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
