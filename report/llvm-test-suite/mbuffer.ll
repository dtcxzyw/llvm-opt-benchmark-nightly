...
.lr.ph486:                                        ; preds = %bb.d
  ...
  br i1 %i.iu, label %.lr.ph486.split, label %._crit_edge487
...
.lr.ph486.split:                                  ; preds = %.lr.ph486
  ...
  br i1 %.not462, label %.lr.ph486.split.us, label %.lr.ph486.split.split

.lr.ph486.split.us:                               ; preds = %.lr.ph486.split
  ...
  %wide.trip.count.a = zext nneg i32 %i.iq to i64
  %wide.trip.count523.a = zext nneg i32 %1 to i64
  br label %.lr.ph482.us

.lr.ph482.us:                                     ; preds = %._crit_edge483.split.us.us, %.lr.ph486.split.us
  %indvars.iv530 = phi i64 [ %indvars.iv.next531, %._crit_edge483.split.us.us ], [ 0, %.lr.ph486.split.us ] ; 5 uses
...
37:                                               ; preds = %34, %30
  ...
  %exitcond529.not = icmp eq i64 %indvars.iv.next526, %wide.trip.count523.a
...
._crit_edge483.split.us.us:                       ; preds = %37
  ...
  %exitcond534.not = icmp eq i64 %indvars.iv.next531, %wide.trip.count.a
  br i1 %exitcond534.not, label %._crit_edge487, label %.lr.ph482.us, !llvm.loop !237
...
.lr.ph482.us.a:                                   ; preds = %.lr.ph486.split.split, %bb.s
  %indvars.iv525.a = phi i64 [ 0, %.lr.ph486.split.split ], [ %indvars.iv.next521, %bb.s ] ; 10 uses
  ...
  %45 = getelementptr inbounds nuw [8 x i8], ptr %42, i64 %indvars.iv525.a
  %46 = load ptr, ptr %45, align 8, !tbaa !213
  br label %bb.e

bb.e:                                             ; preds = %.lr.ph482.us.a, %bb.r
  %indvars.iv517 = phi i64 [ 0, %.lr.ph482.us.a ], [ %indvars.iv.next518, %bb.r ] ; 10 uses
...
bb.r:                                             ; preds = %bb.q, %bb.p, %bb.m, %bb.l
  %.sink566 = phi ptr [ %i.kk, %bb.m ], [ %i.kk, %bb.l ], [ %i.lw, %bb.p ], [ %i.lw, %bb.q ]
  ...
  br i1 %exitcond.not, label %bb.s, label %bb.e, !llvm.loop !236

bb.s:                                             ; preds = %bb.r
  %indvars.iv.next521 = add nuw nsw i64 %indvars.iv525.a, 1 ; 2 uses
  %exitcond524.not = icmp eq i64 %indvars.iv.next521, %wide.trip.count523
  br i1 %exitcond524.not, label %._crit_edge487, label %.lr.ph482.us.a, !llvm.loop !237

._crit_edge487:                                   ; preds = %bb.s, %._crit_edge483.split.us.us, %.lr.ph486, %bb.d
...
.preheader819.us:                                 ; preds = %.preheader819.lr.ph.split.us.split, %._crit_edge859.split.us865
  %indvars.iv912 = phi i64 [ 0, %.preheader819.lr.ph.split.us.split ], [ %indvars.iv.next913, %._crit_edge859.split.us865 ] ; 6 uses
...
bb.co:                                            ; preds = %bb.cm, %bb.cn, %.thread.us862
