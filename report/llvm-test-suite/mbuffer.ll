...
begin_hunk_2_@dpb_split_field:bb.a
  ...
  %.not464.us = icmp eq i32 %i.jg, 0
  %1 = select i1 %.not464.us, i32 2, i32 4        ; 2 uses
  %2 = zext nneg i32 %1 to i64                    ; 4 uses
  %3 = getelementptr inbounds nuw [264 x i8], ptr %i.ix, i64 %2
  %i.jj = getelementptr inbounds nuw [264 x i8], ptr %i.in, i64 %2
  %4 = getelementptr inbounds nuw i8, ptr %i.jj, i64 288
  %5 = or disjoint i32 %1, 1
  %6 = zext nneg i32 %5 to i64                    ; 2 uses
  %i.jk = getelementptr inbounds nuw [264 x i8], ptr %i.iz, i64 %2
  %i.jl = getelementptr inbounds nuw [264 x i8], ptr %i.iz, i64 %6
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.kd = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %i.kc
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  %i.kh = getelementptr inbounds nuw [8 x i8], ptr %i.kg, i64 %2
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ko = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %i.kn
  %i.kp = load i64, ptr %i.ko, align 8, !tbaa !215
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %bb.h
  %i.kq = phi i64 [ %i.kp, %bb.i ], [ 0, %bb.h ]
  %i.kr = getelementptr inbounds nuw [8 x i8], ptr %i.kg, i64 %6
