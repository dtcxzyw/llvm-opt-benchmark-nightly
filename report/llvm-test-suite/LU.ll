...
.lr.ph.preheader:                                 ; preds = %bb.b
  ...
  br i1 %lcmp.mod.not.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol
...
begin_hunk_2
  ...
  %i.ag = icmp eq i64 %i.k, %indvars.iv125
...
.lr.ph93.preheader:                               ; preds = %bb.f
  %xtraiter137 = and i64 %4, 3                    ; 2 uses
