...
begin_hunk_0_@find_scalefac:bb.a
  br i1 %exitcond.not, label %.split96.us.loopexit, label %.lr.ph.preheader.i.us, !llvm.loop !17
...
.lr.ph.preheader.i76.us:                          ; preds = %.lr.ph, %calc_sfb_ave_noise.exit83.thread.us
  ...
  %i.aw = tail call double @pow(double noundef %exp2.us, double noundef 7.500000e-01) #9, !tbaa !9
...
.lr.ph.i77.us:                                    ; preds = %bb.m, %.lr.ph.preheader.i76.us
  ...
  %.02936.i79.us = phi double [ 0.000000e+00, %.lr.ph.preheader.i76.us ], [ %i.bs, %bb.m ]
  %i.ax = getelementptr inbounds [8 x i8], ptr %1, i64 %indvars.iv.i78.us
  %i.ay = load double, ptr %i.ax, align 8, !tbaa !11
...
bb.m:                                             ; preds = %bb.l, %bb.k, %bb.j
  %.028.i81.us = phi double [ %i.bo, %bb.l ], [ %i.bk, %bb.k ], [ %i.bk, %bb.j ] ; 2 uses
  %i.bs = tail call double @llvm.fmuladd.f64(double %.028.i81.us, double %.028.i81.us, double %.02936.i79.us) ; 2 uses
  %indvars.iv.next.i82.us = add nsw i64 %indvars.iv.i78.us, %i.c ; 2 uses
  %i.bt = icmp slt i64 %indvars.iv.next.i82.us, %i.d
  br i1 %i.bt, label %.lr.ph.i77.us, label %calc_sfb_ave_noise.exit83.loopexit.us, !llvm.loop !0
...
calc_sfb_ave_noise.exit83.thread.us:              ; preds = %.lr.ph.i77.us, %calc_sfb_ave_noise.exit83.loopexit.us
  ...
  br i1 %i.bv, label %.lr.ph.preheader.i76.us, label %._crit_edge, !llvm.loop !18
...
calc_sfb_ave_noise.exit83:                        ; preds = %.lr.ph, %calc_sfb_ave_noise.exit83
  ...
  %i.cd = tail call double @pow(double noundef %exp2, double noundef 7.500000e-01) #9, !tbaa !9 ; 0 uses
  %i.ce = fadd double %.368, -2.500000e-01        ; 2 uses
  %i.cf = fcmp ogt double %i.ce, %i.aq
  br i1 %i.cf, label %calc_sfb_ave_noise.exit83, label %._crit_edge, !llvm.loop !18
...
.preheader:                                       ; preds = %bb.a, %.preheader
  ...
  %.02328 = phi double [ 0.000000e+00, %bb.a ], [ %.2.2, %.preheader ] ; 2 uses
  ...
  %.024 = fdiv double %., %i.f                    ; 3 uses
  %i.l = load <2 x double>, ptr %i.i, align 8, !tbaa !11 ; 3 uses
  %i.m = extractelement <2 x double> %i.l, i64 0
  %i.n = fadd double %.024, %i.m                  ; 2 uses
  %i.o = fcmp ogt double %i.n, %.02328
  %.2 = select i1 %i.o, double %i.n, double %.02328 ; 2 uses
  ...
  store <2 x i32> %i.t, ptr %i.j, align 4, !tbaa !9
  %i.u = extractelement <2 x double> %i.l, i64 1
  %i.v = fadd double %.024, %i.u                  ; 2 uses
...
bb.a:
  ...
  %i.i = load i32, ptr getelementptr inbounds nuw (i8, ptr @pretab, i64 44), align 4, !tbaa !9
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.o = load double, ptr %i.n, align 16, !tbaa !11
  %i.p = load i32, ptr getelementptr inbounds nuw (i8, ptr @pretab, i64 48), align 16, !tbaa !9
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.w = load i32, ptr getelementptr inbounds nuw (i8, ptr @pretab, i64 52), align 4, !tbaa !9
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ac = load double, ptr %i.ab, align 16, !tbaa !11
  %i.ad = load i32, ptr getelementptr inbounds nuw (i8, ptr @pretab, i64 56), align 8, !tbaa !9
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ak = load i32, ptr getelementptr inbounds nuw (i8, ptr @pretab, i64 60), align 4, !tbaa !9
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.aq = load double, ptr %i.ap, align 16, !tbaa !11 ; 2 uses
  %i.ar = load i32, ptr getelementptr inbounds nuw (i8, ptr @pretab, i64 64), align 16, !tbaa !9
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.ax = load double, ptr %i.aw, align 8, !tbaa !11 ; 2 uses
  %i.ay = load i32, ptr getelementptr inbounds nuw (i8, ptr @pretab, i64 68), align 4, !tbaa !9
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.bm = load i32, ptr getelementptr inbounds nuw (i8, ptr @pretab, i64 76), align 4, !tbaa !9
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.bs = load double, ptr %i.br, align 16, !tbaa !11 ; 2 uses
  %i.bt = load i32, ptr getelementptr inbounds nuw (i8, ptr @pretab, i64 80), align 16, !tbaa !9
...
.thread.loopexit:                                 ; preds = %bb.j
  ...
  store double %i.l, ptr %i.g, align 8, !tbaa !11
  store double %i.s, ptr %i.n, align 16, !tbaa !11
  ...
  store double %i.cb, ptr %i.br, align 16, !tbaa !11
  br label %.thread

.thread:                                          ; preds = %bb.a, %bb.b, %bb.c, %bb.d, %bb.e, %bb.f, %bb.g, %bb.h, %bb.i, %bb.j, %.thread.loopexit
  %i.cc = uitofp nneg i32 %i.e to double          ; 2 uses
  br label %bb.k

bb.k:                                             ; preds = %.thread, %bb.k
  %indvars.iv = phi i64 [ 0, %.thread ], [ %indvars.iv.next, %bb.k ] ; 4 uses
  %.038 = phi double [ 0.000000e+00, %.thread ], [ %.1, %bb.k ] ; 2 uses
  %i.cd = getelementptr inbounds nuw [8 x i8], ptr %i.a, i64 %indvars.iv
  %i.ce = load double, ptr %i.cd, align 8, !tbaa !11 ; 2 uses
  %i.cf = fneg double %i.ce
  %i.cg = tail call double @llvm.fmuladd.f64(double %i.cf, double %i.cc, double 7.500000e-01)
  %i.ch = fadd double %i.cg, 1.000000e-04
  %i.ci = tail call double @llvm.floor.f64(double %i.ch)
  %i.cj = fptosi double %i.ci to i32
  %i.ck = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %indvars.iv
  store i32 %i.cj, ptr %i.ck, align 4, !tbaa !9
  %i.cl = icmp samesign ult i64 %indvars.iv, 11
  %. = select i1 %i.cl, double 1.500000e+01, double 7.000000e+00
  %.029 = fdiv double %., %i.cc
  %i.cm = fadd double %.029, %i.ce                ; 2 uses
  %i.cn = fcmp ogt double %i.cm, %.038
  %.1 = select i1 %i.cn, double %i.cm, double %.038 ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, 21
  br i1 %exitcond.not, label %bb.l, label %bb.k, !llvm.loop !19
...
bb.a:
  ...
  br i1 %i.j, label %cdce.call, label %cdce.end, !prof !32

cdce.call:                                        ; preds = %bb.a
  %i.k = tail call double @pow(double noundef 1.000000e+01, double noundef %i.i) #9, !tbaa !9 ; 0 uses
  br label %cdce.end

cdce.end:                                         ; preds = %bb.a, %cdce.call
  store float 1.000000e+00, ptr @masking_lower, align 4, !tbaa !33
...
bb.b:                                             ; preds = %.lr.ph160, %._crit_edge
  ...
  %i.bd = load i32, ptr @convert_mdct, align 4, !tbaa !9
...
bb.d:                                             ; preds = %bb.c, %bb.b
  %i.bf = load i32, ptr %i.o, align 4, !tbaa !35
...
bb.f:                                             ; preds = %bb.f, %bb.e
  ...
  %i.bu = call double @sqrt(double noundef %i.bt) #9, !tbaa !9
  %i.bv = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv
  store double %i.bu, ptr %i.bv, align 16, !tbaa !11
  ...
  %i.ca = call double @sqrt(double noundef %i.bz) #9, !tbaa !9
  ...
  br i1 %exitcond.not.1, label %bb.g, label %bb.f, !llvm.loop !21
...
.preheader142:                                    ; preds = %.preheader145, %.preheader142
  ...
  %i.cl = load i32, ptr %i.ch, align 4, !tbaa !9  ; 2 uses
  %i.cm = load i32, ptr %i.ci, align 4, !tbaa !9
  ...
  %i.cs = load float, ptr @masking_lower, align 4, !tbaa !33
  %i.ct = fpext float %i.cs to double
  %i.cu = load double, ptr %i.cj, align 8, !tbaa !11
  ...
  store double %i.cw, ptr %i.ck, align 8, !tbaa !11
end_hunk_0
