...
bb.a:
  ...
  %i.k = load <2 x float>, ptr %i.b, align 8, !tbaa !20
  %5 = load float, ptr %3, align 4, !tbaa !20
  %i.l = load float, ptr %i.c, align 4, !tbaa !20 ; 3 uses
  %i.m = load float, ptr %2, align 4, !tbaa !20   ; 2 uses
  %i.n = load float, ptr %i.f, align 4, !tbaa !20 ; 2 uses
  %i.o = load <2 x float>, ptr %i.h, align 8, !tbaa !20
  %6 = load float, ptr %4, align 4, !tbaa !20
  %7 = fmul float %i.l, %6
  %8 = fmul float %5, %i.l
  %9 = shufflevector <2 x float> %i.k, <2 x float> %i.o, <2 x i32> <i32 0, i32 2>
  %10 = insertelement <2 x float> poison, float %i.m, i64 0
  %11 = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer
  %i.p = insertelement <2 x float> poison, float %8, i64 0
  %12 = insertelement <2 x float> %i.p, float %7, i64 1
  %i.q = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %9, <2 x float> %11, <2 x float> %12)
...
bb.a:
  ...
  %i.bv = load float, ptr %i.bk, align 8, !tbaa !20 ; 3 uses
  ...
  %i.cb = load <2 x float>, ptr %i.bo, align 4, !tbaa !20
  %6 = load float, ptr %4, align 4, !tbaa !20
  %7 = load <2 x float>, ptr %i.bs, align 4, !tbaa !20
  %8 = load float, ptr %5, align 4, !tbaa !20
  %9 = fmul float %i.bv, %8
  %10 = fmul float %i.bv, %6
  %i.cc = shufflevector <2 x float> %i.cb, <2 x float> %7, <2 x i32> <i32 0, i32 2>
  ...
  %i.cf = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cc, <2 x float> %i.ce, <2 x float> %12)
