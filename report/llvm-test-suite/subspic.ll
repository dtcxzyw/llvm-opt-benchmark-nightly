...
bb.p:                                             ; preds = %bb.o
  ...
  %i.cr = or i1 %i.cq, %.not67
  %spec.select = select i1 %.not67, i32 1, i32 2
  %i.cs = xor i1 %.not67, true
  %i.ct = zext i1 %i.cs to i32
  br label %.thread

.thread:                                          ; preds = %bb.o, %bb.p
  %.095 = phi i32 [ %i.ct, %bb.p ], [ 0, %bb.o ]  ; 3 uses
  %.01793 = phi i1 [ %i.cr, %bb.p ], [ true, %bb.o ] ; 3 uses
...
.preheader.preheader.i:                           ; preds = %.thread
  ...
  %i.dd = shl nuw i32 %i.cx, %.095
  %i.de = sext i32 %i.dd to i64                   ; 2 uses
  %i.df = zext nneg i32 %i.cx to i64              ; 9 uses
  %i.dg = select i1 %.01793, i64 0, i64 %i.df     ; 2 uses
  %i.dh = add i64 %i.dg, %i.dc
  %i.di = sub i64 %i.db, %i.dh
  %min.iters.check = icmp ult i32 %i.cx, 4
  %diff.check = icmp ult i64 %i.di, 32
  %or.cond165 = select i1 %min.iters.check, i1 true, i1 %diff.check
  %min.iters.check97 = icmp ult i32 %i.cx, 32
  %n.mod.vf = and i64 %i.df, 28
  %n.vec = and i64 %i.df, 2147483616              ; 4 uses
  %cmp.n = icmp eq i64 %n.vec, %i.df
  %min.epilog.iters.check = icmp eq i64 %n.mod.vf, 0
  %n.vec100 = and i64 %i.df, 2147483644           ; 3 uses
  %cmp.n104 = icmp eq i64 %n.vec100, %i.df
  %xtraiter = and i64 %i.df, 3                    ; 2 uses
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br label %iter.check

iter.check:                                       ; preds = %._crit_edge.i23, %.preheader.preheader.i
  %indvars.iv36.i = phi i64 [ %i.dg, %.preheader.preheader.i ], [ %indvars.iv.next37.i, %._crit_edge.i23 ] ; 2 uses
  %indvars.iv34.i = phi i64 [ 0, %.preheader.preheader.i ], [ %indvars.iv.next35.i, %._crit_edge.i23 ] ; 2 uses
  %.02528.i = phi i32 [ 0, %.preheader.preheader.i ], [ %i.dy, %._crit_edge.i23 ]
  %invariant.gep.i = getelementptr i8, ptr %i.cv, i64 %indvars.iv36.i ; 7 uses
  %invariant.gep44.i = getelementptr i8, ptr %i.cw, i64 %indvars.iv34.i ; 7 uses
  br i1 %or.cond165, label %vec.epilog.scalar.ph.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %iter.check
  br i1 %min.iters.check97, label %vec.epilog.ph, label %vector.body
...
vector.body:                                      ; preds = %vector.main.loop.iter.check, %vector.body
  ...
  %wide.load98 = load <16 x i8>, ptr %i.dk, align 1, !tbaa !15
  %i.dl = getelementptr i8, ptr %invariant.gep44.i, i64 %index ; 2 uses
  %i.dm = getelementptr i8, ptr %i.dl, i64 16
  store <16 x i8> %wide.load, ptr %i.dl, align 1, !tbaa !15
  store <16 x i8> %wide.load98, ptr %i.dm, align 1, !tbaa !15
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.do = getelementptr i8, ptr %invariant.gep.i, i64 %index101
  %wide.load102 = load <4 x i8>, ptr %i.do, align 1, !tbaa !15
  %i.dp = getelementptr i8, ptr %invariant.gep44.i, i64 %index101
  store <4 x i8> %wide.load102, ptr %i.dp, align 1, !tbaa !15
  %index.next103 = add nuw i64 %index101, 4       ; 2 uses
  %i.dq = icmp eq i64 %index.next103, %n.vec100
  br i1 %i.dq, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !20

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  br i1 %cmp.n104, label %._crit_edge.i23, label %vec.epilog.scalar.ph.preheader

vec.epilog.scalar.ph.preheader:                   ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv.i.ph = phi i64 [ 0, %iter.check ], [ %n.vec, %vec.epilog.iter.check ], [ %n.vec100, %vec.epilog.middle.block ] ; 3 uses
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph.prol
  ...
  store i8 %i.dr, ptr %gep45.i.prol, align 1, !tbaa !15
...
vec.epilog.scalar.ph.prol.loopexit:               ; preds = %vec.epilog.scalar.ph.prol, %vec.epilog.scalar.ph.preheader
  ...
  br i1 %i.dt, label %._crit_edge.i23, label %vec.epilog.scalar.ph
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  ...
  store i8 %i.du, ptr %gep45.i, align 1, !tbaa !15
  ...
  store i8 %i.dv, ptr %gep45.i.1, align 1, !tbaa !15
  ...
  store i8 %i.dw, ptr %gep45.i.2, align 1, !tbaa !15
  ...
  store i8 %i.dx, ptr %gep45.i.3, align 1, !tbaa !15
  %indvars.iv.next.i.3 = add nuw nsw i64 %indvars.iv.i, 4 ; 2 uses
  %exitcond.not.i.3 = icmp eq i64 %indvars.iv.next.i.3, %i.df
  br i1 %exitcond.not.i.3, label %._crit_edge.i23, label %vec.epilog.scalar.ph, !llvm.loop !23

._crit_edge.i23:                                  ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %vec.epilog.middle.block, %middle.block
  %indvars.iv.next35.i = add nsw i64 %indvars.iv34.i, %i.de
  %indvars.iv.next37.i = add nsw i64 %indvars.iv36.i, %i.de
  %i.dy = add nuw nsw i32 %.02528.i, %i.cu        ; 2 uses
...
.preheader.preheader.i27:                         ; preds = %Copy_Frame.exit
  ...
  %i.ej = shl nuw i32 %i.ed, %.095
  %i.ek = sext i32 %i.ej to i64                   ; 2 uses
  %i.el = zext nneg i32 %i.ed to i64              ; 9 uses
  %i.em = select i1 %.01793, i64 0, i64 %i.el     ; 2 uses
  %i.en = add i64 %i.em, %i.ei
  %i.eo = sub i64 %i.eh, %i.en
  %min.iters.check107 = icmp ult i32 %i.ed, 4
  %diff.check106 = icmp ult i64 %i.eo, 32
  %or.cond166 = select i1 %min.iters.check107, i1 true, i1 %diff.check106
  %min.iters.check109 = icmp ult i32 %i.ed, 32
  %n.mod.vf111 = and i64 %i.el, 28
  %n.vec112 = and i64 %i.el, 2147483616           ; 4 uses
  %cmp.n119 = icmp eq i64 %n.vec112, %i.el
  %min.epilog.iters.check124 = icmp eq i64 %n.mod.vf111, 0
  %n.vec127 = and i64 %i.el, 2147483644           ; 3 uses
  %cmp.n133 = icmp eq i64 %n.vec127, %i.el
  %xtraiter168 = and i64 %i.el, 3                 ; 2 uses
  %lcmp.mod169.not = icmp eq i64 %xtraiter168, 0
  br label %iter.check121

iter.check121:                                    ; preds = %._crit_edge.i41, %.preheader.preheader.i27
  %indvars.iv36.i31 = phi i64 [ %i.em, %.preheader.preheader.i27 ], [ %indvars.iv.next37.i43, %._crit_edge.i41 ] ; 2 uses
  %indvars.iv34.i32 = phi i64 [ 0, %.preheader.preheader.i27 ], [ %indvars.iv.next35.i42, %._crit_edge.i41 ] ; 2 uses
  %.02528.i33 = phi i32 [ 0, %.preheader.preheader.i27 ], [ %i.fe, %._crit_edge.i41 ]
  %invariant.gep.i34 = getelementptr i8, ptr %i.ea, i64 %indvars.iv36.i31 ; 7 uses
  %invariant.gep44.i35 = getelementptr i8, ptr %i.ec, i64 %indvars.iv34.i32 ; 7 uses
  br i1 %or.cond166, label %vec.epilog.scalar.ph122.preheader, label %vector.main.loop.iter.check108

vector.main.loop.iter.check108:                   ; preds = %iter.check121
  br i1 %min.iters.check109, label %vec.epilog.ph125, label %vector.body113

vector.body113:                                   ; preds = %vector.main.loop.iter.check108, %vector.body113
  %index114 = phi i64 [ %index.next117, %vector.body113 ], [ 0, %vector.main.loop.iter.check108 ] ; 3 uses
  %i.ep = getelementptr i8, ptr %invariant.gep.i34, i64 %index114 ; 2 uses
  %i.eq = getelementptr i8, ptr %i.ep, i64 16
  %wide.load115 = load <16 x i8>, ptr %i.ep, align 1, !tbaa !15
  %wide.load116 = load <16 x i8>, ptr %i.eq, align 1, !tbaa !15
  %i.er = getelementptr i8, ptr %invariant.gep44.i35, i64 %index114 ; 2 uses
  %i.es = getelementptr i8, ptr %i.er, i64 16
  store <16 x i8> %wide.load115, ptr %i.er, align 1, !tbaa !15
  store <16 x i8> %wide.load116, ptr %i.es, align 1, !tbaa !15
  %index.next117 = add nuw i64 %index114, 32      ; 2 uses
  %i.et = icmp eq i64 %index.next117, %n.vec112
end_hunk_0
