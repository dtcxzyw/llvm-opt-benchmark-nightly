...
bb.a:
  ...
  %.sroa.7.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 2 ; 5 uses
  ...
  %4 = load <2 x i16>, ptr %.sroa.7.0..sroa_idx, align 2
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.g = zext i16 %.sroa.7.0.copyload to i32
  %i.h = shl nuw nsw i32 %i.g, 1
  %i.i = zext i16 %.sroa.9.0.copyload to i32      ; 2 uses
...
bb.d:                                             ; preds = %bb.b
  %i.m = zext i16 %.sroa.7.0.copyload to i32
  %i.n = mul nuw nsw i32 %i.m, 3
  %i.o = zext i16 %.sroa.9.0.copyload to i32
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %.sroa.7.0.in.in.a = phi i32 [ %i.q, %bb.d ], [ %i.l, %bb.c ]
  %5 = zext <2 x i16> %4 to <2 x i32>             ; 2 uses
  %.sroa.7.0.in = lshr i32 %.sroa.7.0.in.in.a, 2
  %.sroa.7.0 = trunc nuw i32 %.sroa.7.0.in to i16
  %i.r = zext <8 x i16> %i.b to <8 x i32>         ; 4 uses
  %6 = shufflevector <8 x i32> %i.r, <8 x i32> poison, <8 x i32> <i32 poison, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6>
  %7 = shufflevector <2 x i32> %5, <2 x i32> poison, <8 x i32> <i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %8 = shufflevector <8 x i32> %7, <8 x i32> %6, <8 x i32> <i32 0, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.s = shl nuw nsw <8 x i32> %8, splat (i32 1)
  %i.t = shufflevector <8 x i32> %i.r, <8 x i32> poison, <8 x i32> <i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5>
  %9 = shufflevector <2 x i32> %5, <2 x i32> poison, <8 x i32> <i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %10 = shufflevector <8 x i32> %9, <8 x i32> %i.t, <8 x i32> <i32 0, i32 poison, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.u = insertelement <8 x i32> %10, i32 %.pre-phi120, i64 1
