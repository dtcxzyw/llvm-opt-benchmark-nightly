...
begin_hunk_0_@_ZN22btSubsimplexConvexCast16calcTimeOfImpactERK11btTransformS2_S2_S2_RN12btConvexCast10CastResultE:bb.a
  ...
  %16 = shufflevector <2 x float> %i.x, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
...
begin_hunk_1_@_ZN22btSubsimplexConvexCast16calcTimeOfImpactERK11btTransformS2_S2_S2_RN12btConvexCast10CastResultE:bb.a
  ...
  %17 = shufflevector <4 x float> %i.fl, <4 x float> poison, <2 x i32> <i32 0, i32 1>
...
begin_hunk_2_@_ZN22btSubsimplexConvexCast16calcTimeOfImpactERK11btTransformS2_S2_S2_RN12btConvexCast10CastResultE:bb.a
  ...
  %18 = load <4 x float>, ptr %i.r, align 4
  ...
  %i.jl = shufflevector <4 x float> %18, <4 x float> %i.jk, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.jm = fmul <4 x float> %i.ji, %i.jl
  %19 = load <4 x float>, ptr %i.s, align 4
  ...
  %i.jr = shufflevector <4 x float> %19, <4 x float> %i.jq, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.js = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.jo, <4 x float> %i.jr, <4 x float> %i.jm)
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.c
  %.sroa.0149.1.a = phi float [ %i.ie, %bb.e ], [ %.sroa.0149.0240278, %bb.c ] ; 3 uses
  %.sroa.6151.1 = phi float [ %i.if, %bb.e ], [ %.sroa.6151.0241277, %bb.c ] ; 3 uses
  %.sroa.9.1 = phi float [ %i.ik, %bb.e ], [ %.sroa.9.0242276, %bb.c ] ; 3 uses
...
begin_hunk_3_@_ZN22btSubsimplexConvexCast16calcTimeOfImpactERK11btTransformS2_S2_S2_RN12btConvexCast10CastResultE:bb.a
  ...
  %i.kh = call float @llvm.fmuladd.f32(float %.sroa.0149.0.lcssa.a, float %.sroa.0149.0.lcssa.a, float %i.kg)
  %i.ki = call noundef float @llvm.fmuladd.f32(float %.sroa.9.0.lcssa, float %.sroa.9.0.lcssa, float %i.kh) ; 2 uses
...
bb.h:                                             ; preds = %.critedge
  ...
  %i.kl = fmul float %.sroa.0149.0.lcssa.a, %i.kk ; 2 uses
  %i.km = fmul float %.sroa.6151.0.lcssa, %i.kk   ; 2 uses
  %i.kn = fmul float %.sroa.9.0.lcssa, %i.kk      ; 2 uses
