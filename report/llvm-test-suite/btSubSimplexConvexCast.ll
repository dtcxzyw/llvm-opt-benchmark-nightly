...
bb.e:                                             ; preds = %bb.d
  ...
  %i.jq = shufflevector <4 x float> %21, <4 x float> %i.jp, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  ...
  %i.jw = shufflevector <4 x float> %23, <4 x float> %i.jv, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
