...
bb.a:
  ...
  %i.p = getelementptr inbounds nuw i8, ptr %3, i64 56 ; 2 uses
  ...
  %i.ag = load float, ptr %i.d, align 4, !tbaa !19 ; 2 uses
  %16 = fsub float %i.af, %i.ag
  %i.ah = load float, ptr %i.e, align 4, !tbaa !19
  %i.ai = load float, ptr %i.f, align 4, !tbaa !19 ; 2 uses
  %i.aj = fsub float %i.ah, %i.ai
  %17 = load float, ptr %i.g, align 4, !tbaa !19
  %18 = load float, ptr %i.h, align 4, !tbaa !19  ; 2 uses
  %19 = fsub float %17, %18
  %i.ak = load float, ptr %i.i, align 4, !tbaa !19
  %20 = fsub float %i.ak, %i.n
  %21 = load <2 x float>, ptr %i.k, align 4, !tbaa !19
  %22 = load <2 x float>, ptr %i.l, align 4, !tbaa !19 ; 2 uses
  %23 = fsub <2 x float> %21, %22                 ; 2 uses
  %i.al = fsub float %16, %20                     ; 5 uses
  ...
  %i.ao = fneg float %i.al                        ; 2 uses
  %i.ap = fneg float %i.am                        ; 2 uses
  ...
  %i.ba = fmul float %.sroa.14208.16.copyload, %i.ap
  %i.bb = tail call float @llvm.fmuladd.f32(float %.sroa.7201.0.copyload, float %i.ao, float %i.ba)
  ...
  %i.cn = insertelement <2 x float> poison, float %i.al, i64 0
  ...
  %i.cx = call float @llvm.fmuladd.f32(float %i.cu, float %i.al, float %i.cw)
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %26 = shufflevector <2 x float> %i.m, <2 x float> %22, <4 x i32> <i32 0, i32 1, i32 3, i32 poison>
  %i.eq = insertelement <4 x float> %26, float %i.ag, i64 3
...
bb.b:                                             ; preds = %bb.g, %.lr.ph
  ...
  %.sroa.26219.0237260 = phi float [ %i.ai, %.lr.ph ], [ %.sroa.26219.1, %bb.g ] ; 2 uses
  %.sroa.28220.0238259 = phi float [ %18, %.lr.ph ], [ %.sroa.28220.1, %bb.g ] ; 2 uses
  ...
  %i.fe = load float, ptr %6, align 8, !tbaa !19
  %27 = fneg float %i.fe                          ; 2 uses
  %i.ff = load float, ptr %i.ei, align 4, !tbaa !19
  %i.fg = fneg float %i.ff                        ; 2 uses
  %28 = load float, ptr %.sroa.416.0..sroa_idx, align 8, !tbaa !19
  %i.fh = fneg float %28                          ; 2 uses
  ...
  %i.fl = insertelement <2 x float> poison, float %27, i64 0
  ...
  %i.fs = call float @llvm.fmuladd.f32(float %.sroa.7201.0.copyload, float %27, float %i.fr)
  ...
  %i.go = load float, ptr %6, align 8, !tbaa !19  ; 2 uses
  %i.gp = load float, ptr %i.ei, align 4, !tbaa !19 ; 2 uses
  ...
  %i.ha = fmul float %.sroa.14.16.copyload, %i.gp
  %i.hb = call float @llvm.fmuladd.f32(float %.sroa.7.0.copyload, float %i.go, float %i.ha)
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.il = call float @llvm.fmuladd.f32(float %i.ia, float %i.al, float %i.ik)
...
bb.j:                                             ; preds = %bb.i, %bb.h
  ...
  %i.kw = call float @llvm.fmuladd.f32(float %i.ku, float %i.al, float %i.kv)
