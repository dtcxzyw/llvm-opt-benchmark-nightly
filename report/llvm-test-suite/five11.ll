...
bb.a:
  %i.a = ashr i32 %1, 3
  %i.b = and i32 %1, 7                            ; 3 uses
  %i.c = sub nuw nsw i32 8, %i.b                  ; 4 uses
  %i.d = sext i32 %i.a to i64                     ; 3 uses
  %i.e = getelementptr inbounds i8, ptr %0, i64 %i.d
  %i.f = load i8, ptr %i.e, align 1, !tbaa !19
  %i.g = zext i8 %i.f to i32
  %3 = lshr exact i32 256, %i.b
  %4 = add nuw nsw i32 %3, 255
  %i.h = and i32 %4, %i.g                         ; 2 uses
...
begin_hunk_1_@five11:.lr.ph.i
  ...
  %1 = lshr exact i32 256, %i.i
  %2 = add nuw nsw i32 %1, 255
  %i.n = and i32 %2, %i.m                         ; 2 uses
...
read_x_bits.exit32:                               ; preds = %.lr.ph.i27, %.lr.ph40
  %.017.lcssa.i = phi i32 [ 8, %.lr.ph40 ], [ 16, %.lr.ph.i27 ]
  %.0.lcssa.i = phi i32 [ %i.n, %.lr.ph40 ], [ %i.t, %.lr.ph.i27 ]
  %reass.sub = sub nuw nsw i32 %.017.lcssa.i, %i.i
  %i.u = add nsw i32 %reass.sub, -5
...
begin_hunk_3_@main:bb.a
  ...
  %4 = lshr exact i32 256, %i.t
  %5 = add nuw nsw i32 %4, 255
  %i.y = and i32 %5, %i.x                         ; 2 uses
...
read_x_bits.exit32.i:                             ; preds = %.lr.ph.i27.i, %.lr.ph40.i
  %.017.lcssa.i.i = phi i32 [ 8, %.lr.ph40.i ], [ 16, %.lr.ph.i27.i ]
  %.0.lcssa.i.i = phi i32 [ %i.y, %.lr.ph40.i ], [ %i.ae, %.lr.ph.i27.i ]
  %reass.sub = sub nuw nsw i32 %.017.lcssa.i.i, %i.t
  %i.af = add nsw i32 %reass.sub, -5
