...
bb.a:
  ...
  %23 = load <4 x float>, ptr %0, align 4         ; 2 uses
  ...
  %i.bg = shufflevector <4 x float> <float poison, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, <4 x float> %23, <4 x i32> <i32 5, i32 1, i32 2, i32 3>
  ...
  %i.bm = shufflevector <4 x float> %23, <4 x float> <float poison, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, <4 x i32> <i32 0, i32 5, i32 6, i32 7>
