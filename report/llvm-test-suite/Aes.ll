...
bb.b:                                             ; preds = %.lr.ph, %bb.d
  %.0915 = phi i64 [ %2, %.lr.ph ], [ %i.af, %bb.d ]
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %i.u = insertelement <16 x i8> %i.t, i8 %.sroa.7.6.extract.trunc, i64 6
  %i.v = insertelement <16 x i8> %i.u, i8 %.sroa.7.7.extract.trunc, i64 7
  %i.w = insertelement <16 x i8> %i.v, i8 %.sroa.12.8.extract.trunc, i64 8
  %i.x = insertelement <16 x i8> %i.w, i8 %.sroa.12.9.extract.trunc, i64 9
  %i.y = insertelement <16 x i8> %i.x, i8 %.sroa.12.10.extract.trunc, i64 10
  %i.z = insertelement <16 x i8> %i.y, i8 %.sroa.12.11.extract.trunc, i64 11
  %i.aa = insertelement <16 x i8> %i.z, i8 %.sroa.17.12.extract.trunc, i64 12
