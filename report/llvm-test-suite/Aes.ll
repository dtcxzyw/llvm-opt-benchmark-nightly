...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %.sroa.17.13.extract.trunc = trunc i32 %.sroa.17.13.extract.shift to i8
  %.sroa.17.12.extract.trunc = trunc i32 %i.m to i8
  ...
  %.sroa.12.9.extract.trunc = trunc i32 %.sroa.12.9.extract.shift to i8
  %.sroa.12.8.extract.trunc = trunc i32 %i.n to i8
  ...
  %.sroa.7.5.extract.trunc = trunc i32 %.sroa.7.5.extract.shift to i8
  ...
  %3 = insertelement <16 x i8> %i.w, i8 %.sroa.7.4.extract.trunc, i64 4
  %4 = insertelement <16 x i8> %3, i8 %.sroa.7.5.extract.trunc, i64 5
  %i.x = insertelement <16 x i8> %4, i8 %.sroa.7.6.extract.trunc, i64 6
  %i.y = insertelement <16 x i8> %i.x, i8 %.sroa.7.7.extract.trunc, i64 7
  %5 = insertelement <16 x i8> %i.y, i8 %.sroa.12.8.extract.trunc, i64 8
  %6 = insertelement <16 x i8> %5, i8 %.sroa.12.9.extract.trunc, i64 9
  %i.z = insertelement <16 x i8> %6, i8 %.sroa.12.10.extract.trunc, i64 10
  %i.aa = insertelement <16 x i8> %i.z, i8 %.sroa.12.11.extract.trunc, i64 11
  %7 = insertelement <16 x i8> %i.aa, i8 %.sroa.17.12.extract.trunc, i64 12
  %8 = insertelement <16 x i8> %7, i8 %.sroa.17.13.extract.trunc, i64 13
  %i.ab = insertelement <16 x i8> %8, i8 %.sroa.17.14.extract.trunc, i64 14
