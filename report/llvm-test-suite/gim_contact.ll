...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %4 = tail call float @llvm.fmuladd.f32(float %i.bd, float 1.000000e+03, float 1.000000e+00)
  %i.be = fptosi float %4 to i32
  %i.bf = getelementptr inbounds nuw i8, ptr %i.bc, i64 4
  %i.bg = load float, ptr %i.bf, align 4, !tbaa !16
  %5 = fmul float %i.bg, 1.333000e+03
  %6 = fptosi float %5 to i32
  %7 = getelementptr inbounds nuw i8, ptr %i.bc, i64 8
  %8 = load float, ptr %7, align 4, !tbaa !16
  %9 = tail call float @llvm.fmuladd.f32(float %8, float 2.133000e+03, float 3.000000e+00)
  %i.bh = fptosi float %9 to i32
  %i.bi = shl i32 %6, 4
