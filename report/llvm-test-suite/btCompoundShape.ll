...
bb.c:                                             ; preds = %.lr.ph180, %bb.c
  ...
  %i.bo = phi <2 x float> [ zeroinitializer, %.lr.ph180 ], [ %46, %bb.c ]
  ...
  %i.cm = load float, ptr %i.cg, align 4, !tbaa !21, !noalias !44 ; 3 uses
  %i.cn = load float, ptr %i.cj, align 4, !tbaa !21, !noalias !44 ; 3 uses
  ...
  %i.df = load <2 x float>, ptr %i.cb, align 4, !tbaa !21, !noalias !44 ; 3 uses
  %7 = shufflevector <2 x float> %i.df, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %8 = shufflevector <2 x float> %i.df, <2 x float> poison, <2 x i32> zeroinitializer
  %foldExtExtBinop = fmul <2 x float> %i.de, %i.de
  %9 = extractelement <2 x float> %foldExtExtBinop, i64 1 ; 2 uses
  %10 = extractelement <2 x float> %i.de, i64 0   ; 2 uses
  %11 = call float @llvm.fmuladd.f32(float %10, float %10, float %9)
  %12 = call noundef float @llvm.fmuladd.f32(float %i.cf, float %i.cf, float %11) ; 3 uses
  %i.dg = shufflevector <2 x float> %i.de, <2 x float> poison, <2 x i32> zeroinitializer
  %i.dh = fmul <2 x float> %i.dg, %i.de
  %i.di = insertelement <2 x float> <float poison, float 0.000000e+00>, float %12, i64 0
  %13 = fsub <2 x float> %i.di, %i.dh
  %14 = fsub float %12, %9
  %15 = fsub float %12, %i.db
  %16 = insertelement <2 x float> poison, float %i.dc, i64 0
  %i.dj = shufflevector <2 x float> %16, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %17 = fmul <2 x float> %13, %i.dj               ; 2 uses
  %18 = fmul float %14, %i.dc
  %19 = load <2 x float>, ptr %i.ch, align 4, !tbaa !21, !noalias !44 ; 4 uses
  %20 = load float, ptr %i.ck, align 4, !tbaa !21, !noalias !44
  %21 = load <2 x float>, ptr %6, align 4, !tbaa !21, !noalias !44 ; 4 uses
  %22 = shufflevector <2 x float> %i.df, <2 x float> %21, <2 x i32> <i32 0, i32 2> ; 2 uses
  %23 = insertelement <2 x float> poison, float %i.cp, i64 0
  %i.dk = shufflevector <2 x float> %23, <2 x float> poison, <2 x i32> zeroinitializer
  %i.dl = fmul <2 x float> %22, %i.dk             ; 3 uses
  %24 = shufflevector <2 x float> %19, <2 x float> %21, <2 x i32> <i32 0, i32 3>
  %25 = insertelement <2 x float> poison, float %i.cr, i64 0
  %26 = shufflevector <2 x float> %25, <2 x float> poison, <2 x i32> zeroinitializer
  %27 = fmul <2 x float> %24, %26                 ; 3 uses
  ...
  %i.do = fmul <2 x float> %7, %27
  %28 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dl, <2 x float> %8, <2 x float> %i.do)
  %29 = shufflevector <2 x float> %19, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %30 = shufflevector <2 x float> %21, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %31 = fmul <2 x float> %30, %27
  %i.dp = shufflevector <2 x float> %21, <2 x float> poison, <2 x i32> zeroinitializer
  %32 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dl, <2 x float> %i.dp, <2 x float> %31)
  %i.dq = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.dr = insertelement <2 x float> %i.dq, float %18, i64 1
  %i.ds = fmul float %15, %i.dc
  ...
  %33 = fsub <2 x float> zeroinitializer, %i.dv
  %34 = fmul <2 x float> %33, %i.dj               ; 2 uses
  ...
  %35 = fmul <2 x float> %i.dx, %27
  %i.dy = insertelement <2 x float> poison, float %i.cm, i64 0
  %36 = shufflevector <2 x float> %i.dy, <2 x float> poison, <2 x i32> zeroinitializer
  %37 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dl, <2 x float> %36, <2 x float> %35)
  %38 = insertelement <2 x float> poison, float %i.co, i64 0
  %39 = shufflevector <2 x float> %38, <2 x float> poison, <2 x i32> zeroinitializer
  %40 = insertelement <2 x float> poison, float %i.bn, i64 0
  %41 = insertelement <2 x float> %40, float %i.cy, i64 1
  %i.dz = load <2 x float>, ptr %i.ci, align 4, !tbaa !21, !noalias !44 ; 4 uses
  %i.ea = shufflevector <2 x float> %19, <2 x float> %i.dz, <2 x i32> <i32 1, i32 3>
  %i.eb = fmul <2 x float> %i.ea, %i.dn           ; 3 uses
  %42 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.eb, <2 x float> %29, <2 x float> %28)
  %i.ec = shufflevector <2 x float> %i.dz, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.ed = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.eb, <2 x float> %i.ec, <2 x float> %32)
  %i.ee = shufflevector <2 x float> %19, <2 x float> %i.dz, <2 x i32> <i32 0, i32 2>
  ...
  %i.ek = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ej, <2 x float> %22, <2 x float> %i.eh)
  ...
  %43 = insertelement <2 x float> %i.dz, float %20, i64 0
  %44 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.em, <2 x float> %43, <2 x float> %i.ek)
  %i.en = fadd <2 x float> %i.bo, %42
  %i.eo = fadd <2 x float> %i.ed, %i.bp
  %45 = fadd <2 x float> %44, %i.bq
  %46 = fadd <2 x float> %i.en, %17               ; 2 uses
  store <2 x float> %46, ptr %4, align 8, !tbaa !21
  %i.ep = fadd <2 x float> %i.eo, %i.dr           ; 2 uses
  store <2 x float> %i.ep, ptr %i.bf, align 8, !tbaa !21
  %i.eq = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.eb, <2 x float> %39, <2 x float> %37)
  %i.er = fadd <2 x float> %i.eq, %41
  %i.es = fadd <2 x float> %45, %34               ; 3 uses
