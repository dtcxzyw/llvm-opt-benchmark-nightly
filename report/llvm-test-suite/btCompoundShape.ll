...
begin_hunk_0_@_ZNK15btCompoundShape31calculatePrincipalAxisTransformEPfR11btTransformR9btVector3:bb.a
  ...
  %i.cg = getelementptr inbounds nuw [88 x i8], ptr %i.cf, i64 %indvars.iv186 ; 10 uses
  %6 = getelementptr inbounds nuw i8, ptr %i.cg, i64 48
  %i.ch = getelementptr inbounds nuw i8, ptr %i.cg, i64 56
  %7 = load float, ptr %i.ch, align 4, !tbaa !21
...
begin_hunk_1_@_ZNK15btCompoundShape31calculatePrincipalAxisTransformEPfR11btTransformR9btVector3:bb.a
  ...
  %8 = load <2 x float>, ptr %6, align 4, !tbaa !21 ; 2 uses
  %9 = shufflevector <2 x float> %8, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %10 = insertelement <4 x float> %9, float %7, i64 1
  %11 = shufflevector <2 x float> %8, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 poison, i32 poison>
  %12 = shufflevector <4 x float> %10, <4 x float> %11, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %i.cw = fsub <4 x float> %12, %i.bf             ; 6 uses
  ...
  %13 = shufflevector <2 x float> %i.cx, <2 x float> %i.da, <4 x i32> <i32 0, i32 2, i32 poison, i32 0>
  %i.dc = shufflevector <2 x float> %i.cz, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %14 = shufflevector <4 x float> %13, <4 x float> %i.dc, <4 x i32> <i32 0, i32 1, i32 4, i32 3> ; 2 uses
  %i.dd = shufflevector <4 x float> %i.cs, <4 x float> poison, <4 x i32> zeroinitializer
  %i.de = fmul <4 x float> %14, %i.dd             ; 4 uses
  %15 = shufflevector <2 x float> %i.cx, <2 x float> %i.da, <4 x i32> <i32 1, i32 3, i32 poison, i32 1>
  %16 = shufflevector <4 x float> %15, <4 x float> %i.dc, <4 x i32> <i32 0, i32 1, i32 5, i32 3> ; 2 uses
  %i.df = shufflevector <4 x float> %i.cs, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.dg = fmul <4 x float> %16, %i.df             ; 4 uses
...
begin_hunk_2_@_ZNK15btCompoundShape31calculatePrincipalAxisTransformEPfR11btTransformR9btVector3:bb.a
  ...
  %i.eg = shufflevector <4 x float> %16, <4 x float> poison, <4 x i32> <i32 1, i32 2, i32 2, i32 2>
  %i.eh = fmul <4 x float> %i.eg, %i.dg
  %i.ei = shufflevector <4 x float> %14, <4 x float> poison, <4 x i32> <i32 1, i32 2, i32 2, i32 2>
