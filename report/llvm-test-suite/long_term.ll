...
begin_hunk_0_@Gsm_Long_Term_Predictor:iter.check
  ...
  %wide.load34 = load <8 x i16>, ptr %i.e, align 2, !tbaa !8 ; 4 uses
  %i.f = icmp slt <8 x i16> %wide.load34, zeroinitializer
  %7 = icmp eq <8 x i16> %wide.load34, splat (i16 -32768)
  %8 = sub <8 x i16> zeroinitializer, %wide.load34
  %9 = select <8 x i1> %7, <8 x i16> splat (i16 32767), <8 x i16> %8
  %i.g = select <8 x i1> %i.f, <8 x i16> %9, <8 x i16> %wide.load34
  %i.h = getelementptr inbounds nuw i8, ptr %1, i64 48
  %wide.load34.1 = load <8 x i16>, ptr %i.h, align 2, !tbaa !8 ; 4 uses
  %i.i = icmp slt <8 x i16> %wide.load34.1, zeroinitializer
  %10 = icmp eq <8 x i16> %wide.load34.1, splat (i16 -32768)
  %11 = sub <8 x i16> zeroinitializer, %wide.load34.1
  %12 = select <8 x i1> %10, <8 x i16> splat (i16 32767), <8 x i16> %11
  %i.j = select <8 x i1> %i.i, <8 x i16> %12, <8 x i16> %wide.load34.1
  ...
  %13 = icmp eq <8 x i16> %wide.load, splat (i16 -32768)
  %14 = sub <8 x i16> zeroinitializer, %wide.load
  %15 = select <8 x i1> %13, <8 x i16> splat (i16 32767), <8 x i16> %14
  %i.m = select <8 x i1> %i.l, <8 x i16> %15, <8 x i16> %wide.load
  %i.n = getelementptr inbounds nuw i8, ptr %1, i64 32
  %wide.load.1 = load <8 x i16>, ptr %i.n, align 2, !tbaa !8 ; 4 uses
  %i.o = icmp slt <8 x i16> %wide.load.1, zeroinitializer
  %16 = icmp eq <8 x i16> %wide.load.1, splat (i16 -32768)
  %17 = sub <8 x i16> zeroinitializer, %wide.load.1
  %18 = select <8 x i1> %16, <8 x i16> splat (i16 32767), <8 x i16> %17
  %i.p = select <8 x i1> %i.o, <8 x i16> %18, <8 x i16> %wide.load.1
...
begin_hunk_1_@Gsm_Long_Term_Predictor:iter.check
  ...
  %wide.load37 = load <8 x i16>, ptr %i.u, align 2, !tbaa !8 ; 4 uses
  %i.v = icmp slt <8 x i16> %wide.load37, zeroinitializer
  %19 = icmp eq <8 x i16> %wide.load37, splat (i16 -32768)
  %20 = sub <8 x i16> zeroinitializer, %wide.load37
  %21 = select <8 x i1> %19, <8 x i16> splat (i16 32767), <8 x i16> %20
  %i.w = select <8 x i1> %i.v, <8 x i16> %21, <8 x i16> %wide.load37
