Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/llvm-test-suite/original/ZipStrong?download=true
...
define internal fastcc void @_ZN7NCrypto10NZipStrongL9DeriveKeyERNS_5NSha18CContextEPh(ptr noundef nonnull align 8 dereferenceable(100) %0, ptr nofree noundef nonnull writeonly captures(none) initializes((0, 32)) %1) unnamed_addr #0 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define dso_local noundef i32 @_ZN7NCrypto10NZipStrong10CBaseCoder17CryptoSetPasswordEPKhj(ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(408) initializes((336, 368)) %0, ptr noundef %1, i32 noundef %2) unnamed_addr #0 align 2 {
bb.a:
  %3 = alloca %"class.NCrypto::NSha1::CContext", align 8 ; 6 uses
...
define dso_local noundef i32 @_ZThn328_N7NCrypto10NZipStrong10CBaseCoder17CryptoSetPasswordEPKhj(ptr nofree noundef writeonly captures(none) initializes((8, 40)) %0, ptr noundef %1, i32 noundef %2) unnamed_addr #3 align 2 {
bb.a:
  %3 = alloca %"class.NCrypto::NSha1::CContext", align 8 ; 6 uses
...
._crit_edge:                                      ; preds = %bb.f
  ...
  %.pre25 = load ptr, ptr %.phi.trans.insert, align 8, !tbaa !32
  br label %bb.i
...
bb.h:                                             ; preds = %bb.g
  ...
  %.pre27 = add i32 %.pre, 16
  %.pre28 = zext i32 %.pre27 to i64
  br label %_ZN7CBufferIhE4FreeEv.exit

_ZN7CBufferIhE4FreeEv.exit:                       ; preds = %bb.g, %bb.h
  %.pre-phi29 = phi i64 [ %i.m, %bb.g ], [ %.pre28, %bb.h ]
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.o, i8 0, i64 16, i1 false)
  call void @_ZN7CBufferIhE11SetCapacityEm(ptr noundef nonnull align 8 dereferenceable(24) %i.n, i64 noundef %.pre-phi29)
  ...
  %.pre26 = load i32, ptr %i.j, align 4, !tbaa !30
  br label %bb.i

bb.i:                                             ; preds = %._crit_edge, %_ZN7CBufferIhE4FreeEv.exit
  %i.aa = phi i32 [ %i.i, %._crit_edge ], [ %.pre26, %_ZN7CBufferIhE4FreeEv.exit ]
  %i.ab = phi ptr [ %.pre25, %._crit_edge ], [ %i.y, %_ZN7CBufferIhE4FreeEv.exit ]
...
; Function Attrs: mustprogress uwtable
define dso_local noundef i32 @_ZN7NCrypto10NZipStrong8CDecoder13CheckPasswordERb(ptr noundef nonnull align 8 dereferenceable(432) %0, ptr nofree noundef nonnull writeonly align 1 captures(none) dereferenceable(1) initializes((0, 1)) %1) local_unnamed_addr #0 align 2 {
bb.a:
...
bb.e:                                             ; preds = %bb.d
  ...
  %.not67 = icmp eq i32 %i.q, %i.r
  br i1 %.not67, label %bb.f, label %bb.t
...
bb.g:                                             ; preds = %bb.f
  ...
  %.not69 = icmp eq i32 %i.ac, 0
  br i1 %.not69, label %bb.h, label %bb.t
...
bb.i:                                             ; preds = %bb.h
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 2 %i.f, ptr nonnull align 2 %i.af, i64 %i.ag, i1 false)
  ...
  br i1 %.not70, label %bb.j, label %bb.t
...
bb.j:                                             ; preds = %bb.i
  ...
  br i1 %.not71, label %bb.k, label %bb.t

bb.k:                                             ; preds = %bb.j
  %i.ap = add nuw nsw i32 %i.ad, %i.an
  %i.aq = load i32, ptr %i.b, align 4, !tbaa !30
  %.not72 = icmp eq i32 %i.ap, %i.aq
  br i1 %.not72, label %bb.l, label %bb.t
...
bb.l:                                             ; preds = %bb.k
  ...
  %.not73 = icmp eq i32 %i.av, 0
  br i1 %.not73, label %bb.m, label %bb.t
...
bb.m:                                             ; preds = %bb.l
  ...
  br i1 %.not74, label %bb.n, label %bb.t
...
bb.n:                                             ; preds = %bb.m
  ...
  br i1 %.not75, label %bb.o, label %bb.s
...
bb.o:                                             ; preds = %bb.n
  ...
  %.not76 = icmp eq i32 %i.bu, 0
  br i1 %.not76, label %bb.p, label %bb.s
...
bb.q:                                             ; preds = %bb.p
  ...
  %.not77 = icmp eq i32 %i.ch, %i.ci
  br i1 %.not77, label %bb.r, label %bb.s
