begin_hunk_0
  ...
  %i.na = sext i32 %i.mz to i64                   ; 4 uses
...
begin_hunk_1
  ...
  %i.nx = shl nsw i64 %i.na, 3                    ; 2 uses
  ...
  %4 = shl nsw i64 %i.na, 3                       ; 2 uses
  %scevgep1613 = getelementptr i8, ptr %i.mw, i64 %4
  %scevgep1615 = getelementptr i8, ptr %i.mw, i64 8
  %scevgep1616 = getelementptr i8, ptr %scevgep1615, i64 %4
  br label %bb.ad
