...
bb.r:                                             ; preds = %bb.q, %bb.f
  ...
  %.2126 = phi ptr [ %.1125.lcssa, %bb.q ], [ %.0124231, %bb.f ] ; 13 uses
...
.lr.ph224.preheader:                              ; preds = %.preheader
  %i.ex = zext nneg i32 %i.es to i64              ; 9 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %7 = getelementptr inbounds nuw i8, ptr %.2126, i64 4
  %wide.load = load <4 x i8>, ptr %.2126, align 1, !tbaa !25
  %wide.load316 = load <4 x i8>, ptr %7, align 1, !tbaa !25
  %invariant.gep = getelementptr inbounds nuw i8, ptr %i.bg, i64 %i.ex ; 2 uses
  %8 = getelementptr inbounds nuw i8, ptr %invariant.gep, i64 4
  store <4 x i8> %wide.load, ptr %invariant.gep, align 1, !tbaa !25
  store <4 x i8> %wide.load316, ptr %8, align 1, !tbaa !25
  %9 = icmp eq i64 %n.vec, 8
  br i1 %9, label %middle.block, label %vector.body

vector.body:                                      ; preds = %vector.ph
  %10 = add nuw nsw i64 %i.ex, 11
  %i.ff = getelementptr inbounds nuw i8, ptr %.2126, i64 8
  %i.fg = getelementptr inbounds nuw i8, ptr %.2126, i64 12
  %wide.load.a = load <4 x i8>, ptr %i.ff, align 1, !tbaa !25
  %wide.load316.a = load <4 x i8>, ptr %i.fg, align 1, !tbaa !25
  %gep = getelementptr inbounds nuw i8, ptr %6, i64 %i.ex ; 2 uses
...
middle.block:                                     ; preds = %vector.body, %vector.ph
  %.lcssa340 = phi i64 [ %i.fe, %vector.ph ], [ %10, %vector.body ]
  %i.fi = icmp samesign ult i64 %.lcssa340, 15
...
bb.af:                                            ; preds = %bb.ac, %bb.ae
  ...
  store ptr %.2126, ptr %i.bu, align 8, !tbaa !39
...
bb.ag:                                            ; preds = %bb.af
  %i.ft = load ptr, ptr %i.bu, align 8, !tbaa !39
...
.lr.ph224:                                        ; preds = %.lr.ph224.preheader333, %.lr.ph224
  ...
  br i1 %i.ge, label %.lr.ph224, label %._crit_edge.loopexit, !llvm.loop !40
...
bb.am:                                            ; preds = %bb.al
  %i.go = load ptr, ptr %i.bu, align 8, !tbaa !39
...
bb.an:                                            ; preds = %bb.ag, %bb.am
  ...
  br i1 %.not, label %._crit_edge233, label %bb.f, !llvm.loop !41
...
bb.o:                                             ; preds = %bb.m, %bb.n
  ...
  br i1 %i.cc, label %.preheader, label %.thread, !llvm.loop !44
...
bb.y:                                             ; preds = %bb.x, %bb.w
  ...
  br i1 %i.dt, label %bb.s, label %.thread, !llvm.loop !45
...
bb.bp:                                            ; preds = %bb.bn, %bb.bo
  ...
  br i1 %i.jh, label %bb.bj, label %bb.bq, !llvm.loop !46
...
bb.by:                                            ; preds = %bb.bw, %bb.bx
  ...
  br i1 %i.ki, label %bb.bs, label %bb.bz, !llvm.loop !47
...
bb.cg:                                            ; preds = %bb.cf, %bb.cd
  ...
  br i1 %.not545, label %bb.ch, label %bb.cd, !llvm.loop !48
...
bb.cp:                                            ; preds = %bb.cn, %bb.co
  ...
  br i1 %.not547, label %.thread, label %bb.cj, !llvm.loop !49
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %i.ab = load i32, ptr %i.c, align 8, !tbaa !42
  ...
  %i.ag = load i32, ptr %i.h, align 8, !tbaa !43
  ...
  %i.ao = load ptr, ptr %i.n, align 8, !tbaa !39
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  br i1 %i.dn, label %.preheader, label %.loopexit.loopexit.i, !llvm.loop !50
...
bb.v:                                             ; preds = %bb.u, %bb.t
  ...
  br i1 %i.fc, label %bb.q, label %.loopexit.loopexit1155.i, !llvm.loop !51
...
bb.bj:                                            ; preds = %bb.bi, %bb.bh
  ...
  br i1 %i.nb, label %bb.be, label %bb.bk, !llvm.loop !52
...
bb.dy:                                            ; preds = %bb.dx, %bb.dw
  ...
  br i1 %.not.i, label %bb.dz, label %bb.dw, !llvm.loop !53
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.adm, label %middle.block, label %vector.body, !llvm.loop !54
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.adp, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !56
...
vec.epilog.scalar.ph.preheader:                   ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  ...
  %.0782.i.ph174 = ptrtoaddr ptr %.0782.i.ph to i64 ; 2 uses
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  ...
  br i1 %.not1042.i.7, label %.loopexit1142.loopexit1156.i, label %vec.epilog.scalar.ph, !llvm.loop !59
...
.preheader.i:                                     ; preds = %.preheader.i.prol.loopexit, %.preheader.i
  ...
  br i1 %.not1041.i.1, label %.loopexit1142.i, label %.preheader.i, !llvm.loop !60
...
.loopexit1142.i:                                  ; preds = %.preheader.i.prol.loopexit, %.preheader.i, %.loopexit1142.loopexit1156.i, %bb.ah, %.loopexit.i
  ...
  br i1 %i.afq, label %bb.e, label %.loopexit1144.i, !llvm.loop !61
...
bb.ez:                                            ; preds = %bb.ey, %.loopexit1144.i
  ...
  store ptr %.40964.i, ptr %i.n, align 8, !tbaa !39
  ...
  store i32 %.71104.i, ptr %i.c, align 8, !tbaa !42
...
bb.ff:                                            ; preds = %bb.fe
  %i.ahq = load ptr, ptr %i.n, align 8, !tbaa !39
  ...
  br i1 %or.cond140, label %bb.b, label %.critedge, !llvm.loop !62
...
bb.a:
  ...
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !33
  tail call void %i.b(ptr noundef %1, ptr noundef %i.d) #7, !inline_history !65
  store ptr null, ptr %i.c, align 8, !tbaa !33
  %i.e = load ptr, ptr %i.a, align 8, !tbaa !63
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 2 uses
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !22
  tail call void %i.e(ptr noundef %1, ptr noundef %i.g) #7, !inline_history !66
...
bb.b:                                             ; preds = %bb.a
  ...
  store i32 %spec.store.select, ptr %i.d, align 4, !tbaa !67
...
bb.c:                                             ; preds = %bb.b
  ...
  store i32 %i.h, ptr %0, align 4, !tbaa !68
  %i.i = udiv i8 %i.e, 9
  %i.j = udiv i8 %i.e, 45
  %.zext = zext nneg i8 %i.j to i32
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i32 %.zext, ptr %i.k, align 4, !tbaa !69
  %i.l = urem i8 %i.i, 5
  %.zext19 = zext nneg i8 %i.l to i32
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 4
  store i32 %.zext19, ptr %i.m, align 4, !tbaa !70
  br label %bb.d
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  tail call void %i.t(ptr noundef %3, ptr noundef %i.o) #7, !inline_history !72
  store ptr null, ptr %i.n, align 8, !tbaa !33
  %i.u = load ptr, ptr %3, align 8, !tbaa !73
  %i.v = shl nuw nsw i32 %i.m, 1
  %i.w = zext nneg i32 %i.v to i64
  %i.x = tail call ptr %i.u(ptr noundef nonnull %3, i64 noundef %i.w) #7, !inline_history !74 ; 2 uses
  store ptr %i.x, ptr %i.n, align 8, !tbaa !33
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 104
  store i32 %i.m, ptr %i.y, align 8, !tbaa !71
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  tail call void %i.ah(ptr noundef %3, ptr noundef %i.ac) #7, !inline_history !66
  store ptr null, ptr %i.ab, align 8, !tbaa !22
  %i.ai = load ptr, ptr %3, align 8, !tbaa !73
...
bb.i:                                             ; preds = %bb.h
  %i.al = load ptr, ptr %i.ag, align 8, !tbaa !63
  %i.am = load ptr, ptr %i.n, align 8, !tbaa !33
  tail call void %i.al(ptr noundef nonnull %3, ptr noundef %i.am) #7, !inline_history !65
  store ptr null, ptr %i.n, align 8, !tbaa !33
  br label %LzmaProps_Decode.exit.thread
...
bb.d:                                             ; preds = %bb.c
  ...
  tail call void %i.s(ptr noundef %8, ptr noundef null) #7, !inline_history !75
  %i.t = load ptr, ptr %8, align 8, !tbaa !73
  %i.u = shl nuw nsw i32 %i.q, 1
  %i.v = zext nneg i32 %i.u to i64
  %i.w = tail call ptr %i.t(ptr noundef nonnull %8, i64 noundef %i.v) #7, !inline_history !76 ; 2 uses
  store ptr %i.w, ptr %i.e, align 8, !tbaa !33
  %i.x = getelementptr inbounds nuw i8, ptr %9, i64 104
  store i32 %i.q, ptr %i.x, align 8, !tbaa !71
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  %i.an = load ptr, ptr %i.r, align 8, !tbaa !63
  %i.ao = load ptr, ptr %i.e, align 8, !tbaa !33
  call void %i.an(ptr noundef nonnull %8, ptr noundef %i.ao) #7, !inline_history !65
...
!52 = distinct !{!52, !27}
!53 = distinct !{!53, !27}
!54 = distinct !{!54, !27, !37, !38}
!55 = !{!"branch_weights", i32 4, i32 28}
!56 = distinct !{!56, !27, !37, !38}
!57 = distinct !{!57, !58}
!58 = !{!"llvm.loop.unroll.disable"}
!59 = distinct !{!59, !27, !37}
!60 = distinct !{!60, !27}
!61 = distinct !{!61, !27}
!62 = distinct !{!62, !27}
!63 = !{!64, !12, i64 8}
!64 = !{!"", !12, i64 0, !12, i64 8}
!65 = !{ptr @LzmaDec_FreeProbs}
!66 = distinct !{null}
!67 = !{!10, !5, i64 12}
!68 = !{!10, !5, i64 0}
!69 = !{!10, !5, i64 8}
!70 = !{!10, !5, i64 4}
!71 = !{!9, !5, i64 104}
!72 = distinct !{null, ptr @LzmaDec_FreeProbs}
!73 = !{!64, !12, i64 0}
!74 = distinct !{null}
!75 = distinct !{ptr @LzmaDec_AllocateProbs, null, ptr @LzmaDec_FreeProbs}
!76 = distinct !{ptr @LzmaDec_AllocateProbs, null}
end_hunk_2
