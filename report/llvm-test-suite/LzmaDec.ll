...
begin_hunk_0_@LzmaDec_DecodeReal2:bb.a
  ...
  %.0812.i = phi i64 [ 3, %bb.bp ], [ 2, %bb.bo ]
  %3 = phi i32 [ 6, %bb.bp ], [ 4, %bb.bo ]       ; 2 uses
  store i16 %storemerge1036.i, ptr %i.nj, align 2, !tbaa !34
  %i.oe = getelementptr inbounds nuw [2 x i8], ptr %i.ni, i64 %.0812.i ; 2 uses
...
bb.bv:                                            ; preds = %bb.bu, %bb.bt
  ...
  %.1813.i = phi i32 [ %3, %bb.bt ], [ %i.oz, %bb.bu ] ; 2 uses
...
begin_hunk_3_@LzmaDec_DecodeReal2:bb.a
  ...
  %.1801.i = phi i64 [ 2, %bb.cu ], [ 3, %bb.cv ]
  %.1801.i.a = phi i32 [ 4, %bb.cu ], [ 6, %bb.cv ] ; 2 uses
  store i16 %.sink1174.i, ptr %i.tg, align 2, !tbaa !34
  %.not1037.i = icmp eq i32 %i.su, 2
  br i1 %.not1037.i, label %.thread1047.i, label %bb.cx

bb.cx:                                            ; preds = %bb.cw
  %i.uc = getelementptr inbounds nuw [2 x i8], ptr %i.tf, i64 %.1801.i ; 2 uses
...
begin_hunk_5_@LzmaDec_DecodeReal2:bb.a
  ...
  %i.ut = or disjoint i32 %.1801.i.a, 1
...
begin_hunk_6_@LzmaDec_DecodeReal2:bb.a
  ...
  %.1801.i.1 = phi i32 [ %.1801.i.a, %bb.db ], [ %i.ut, %bb.da ] ; 2 uses
...
begin_hunk_7_@LzmaDec_DecodeReal2:bb.a
  ...
  %.0791.i = phi i64 [ 2, %bb.ec ], [ 3, %bb.ed ]
  %4 = phi i32 [ 4, %bb.ec ], [ 6, %bb.ed ]       ; 2 uses
  store i16 %.sink1175.i, ptr %i.ba, align 2, !tbaa !34
  %i.zg = getelementptr inbounds nuw [2 x i8], ptr %i.az, i64 %.0791.i ; 2 uses
...
begin_hunk_10_@LzmaDec_DecodeReal2:bb.a
  ...
  %.1792.i = phi i32 [ %4, %bb.eh ], [ %i.aab, %bb.ei ] ; 2 uses
