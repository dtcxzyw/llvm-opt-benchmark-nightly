...
begin_hunk_3_@LzmaDec_DecodeToDic:bb.a
  ...
  %invariant.gep = getelementptr i8, ptr %i.bg, i64 %i.ex ; 2 uses
...
vector.body:                                      ; preds = %vector.ph
  ...
  %gep = getelementptr i8, ptr %6, i64 %i.ex      ; 2 uses
...
bb.a:
  ...
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !33
  tail call void %i.b(ptr noundef %1, ptr noundef %i.d) #8, !inline_history !65
  store ptr null, ptr %i.c, align 8, !tbaa !33
  %i.e = load ptr, ptr %i.a, align 8, !tbaa !63
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 2 uses
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !22
  tail call void %i.e(ptr noundef %1, ptr noundef %i.g) #8, !inline_history !66
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  tail call void %i.t(ptr noundef %3, ptr noundef %i.o) #8, !inline_history !72
  store ptr null, ptr %i.n, align 8, !tbaa !33
  %i.u = load ptr, ptr %3, align 8, !tbaa !73
  %i.v = shl nuw nsw i32 %i.m, 1
  %i.w = zext nneg i32 %i.v to i64
  %i.x = tail call ptr %i.u(ptr noundef nonnull %3, i64 noundef %i.w) #8, !inline_history !74 ; 2 uses
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  tail call void %i.ah(ptr noundef %3, ptr noundef %i.ac) #8, !inline_history !66
...
bb.i:                                             ; preds = %bb.h
  ...
  tail call void %i.al(ptr noundef nonnull %3, ptr noundef %i.am) #8, !inline_history !65
  store ptr null, ptr %i.n, align 8, !tbaa !33
...
begin_hunk_38_@LzmaDecode:bb.a
  ...
  tail call void %i.s(ptr noundef %8, ptr noundef null) #8, !inline_history !75
  %i.t = load ptr, ptr %8, align 8, !tbaa !73
  %i.u = shl nuw nsw i32 %i.q, 1
  %i.v = zext nneg i32 %i.u to i64
  %i.w = tail call ptr %i.t(ptr noundef nonnull %8, i64 noundef %i.v) #8, !inline_history !76 ; 2 uses
...
begin_hunk_39_@LzmaDecode:bb.a
  ...
  call void %i.an(ptr noundef nonnull %8, ptr noundef %i.ao) #8, !inline_history !65
