...
define internal fastcc i32 @LzmaDec_TryDummy(ptr noundef readonly captures(none) %0, ptr noundef readonly %1, i64 noundef %2) unnamed_addr #3 {
bb.a:
...
bb.ax:                                            ; preds = %bb.an, %bb.aw, %bb.ar, %bb.av, %bb.ac
  %.17466 = phi i32 [ %.10459, %bb.ac ], [ %i.fs, %bb.an ], [ %i.ha, %bb.aw ], [ %.14463, %bb.ar ], [ %.15464, %bb.av ] ; 2 uses
  %.17466.a = phi i32 [ 2, %bb.ac ], [ 3, %bb.an ], [ 3, %bb.aw ], [ 3, %bb.ar ], [ 3, %bb.av ] ; 3 uses
  %.pn = phi i64 [ 1636, %bb.ac ], [ 2664, %bb.an ], [ 2664, %bb.aw ], [ 2664, %bb.ar ], [ 2664, %bb.av ]
  %.17421 = phi i32 [ %i.ej, %bb.ac ], [ %i.fr, %bb.an ], [ %i.gz, %bb.aw ], [ %i.gh, %bb.ar ], [ %i.gx, %bb.av ] ; 3 uses
  %.15 = phi ptr [ %.8380, %bb.ac ], [ %.10382, %bb.an ], [ %.13385, %bb.aw ], [ %.12384, %bb.ar ], [ %.13385, %bb.av ] ; 4 uses
  %i.hb = getelementptr inbounds nuw i8, ptr %i.g, i64 %.pn ; 5 uses
...
.thread:                                          ; preds = %bb.cp, %bb.y, %bb.o, %bb.bq, %bb.bz
  %.3447.ph = phi i32 [ %.17466.a, %bb.bq ], [ %.17466.a, %bb.bz ], [ 1, %bb.o ], [ 1, %bb.y ], [ %.17466.a, %bb.cp ]
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %i.aa = load ptr, ptr %i.b, align 8, !tbaa !33  ; 12 uses
...
begin_hunk_7_@LzmaDec_DecodeReal2:bb.a
  ...
  %i.fm = getelementptr inbounds nuw [2 x i8], ptr %i.ar, i64 %i.fl ; 3 uses
...
bb.ab:                                            ; preds = %bb.aa
  %i.gj = getelementptr inbounds nuw [2 x i8], ptr %i.as, i64 %i.fl ; 3 uses
...
begin_hunk_9_@LzmaDec_DecodeReal2:bb.a
  ...
  %i.ha = getelementptr inbounds nuw [2 x i8], ptr %i.av, i64 %i.be
...
begin_hunk_10_@LzmaDec_DecodeReal2:bb.a
  ...
  %i.il = getelementptr inbounds nuw [2 x i8], ptr %i.at, i64 %i.fl ; 3 uses
...
begin_hunk_11_@LzmaDec_DecodeReal2:bb.a
  ...
  %i.jg = getelementptr inbounds nuw [2 x i8], ptr %i.au, i64 %i.fl ; 2 uses
...
begin_hunk_12_@LzmaDec_DecodeReal2:bb.a
  ...
  %.pn.i = phi i64 [ 1636, %bb.z ], [ 2664, %bb.at ]
  ...
  %.1851.i = getelementptr inbounds nuw i8, ptr %i.aa, i64 %.pn.i ; 7 uses
