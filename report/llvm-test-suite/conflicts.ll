...
.lr.ph74.us:                                      ; preds = %.lr.ph74.us.preheader, %._crit_edge78.us
  %.379.us = phi i32 [ %1, %._crit_edge78.us ], [ %i.bw, %.lr.ph74.us.preheader ] ; 2 uses
...
._crit_edge78.us:                                 ; preds = %.lr.ph77.us, %middle.block
  %1 = add nsw i32 %.379.us, 1                    ; 2 uses
  %exitcond98.not = icmp eq i32 %1, %i.ap
  br i1 %exitcond98.not, label %.loopexit, label %.lr.ph74.us, !llvm.loop !33
...
.lr.ph77.us:                                      ; preds = %.lr.ph77.us.preheader123, %.lr.ph77.us
  ...
  br i1 %i.cx, label %.lr.ph77.us, label %._crit_edge78.us, !llvm.loop !34

bb.j:                                             ; preds = %.lr.ph74.us, %bb.l
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  br i1 %i.df, label %bb.j, label %.lr.ph77.us.preheader, !llvm.loop !36
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %next.gep118, align 4, !tbaa !4, !alias.scope !37
  %wide.load119 = load <4 x i32>, ptr %i.dj, align 4, !tbaa !4, !alias.scope !37
  %i.dk = getelementptr i8, ptr %next.gep, i64 16 ; 2 uses
  %wide.load120 = load <4 x i32>, ptr %next.gep, align 4, !tbaa !4, !alias.scope !40, !noalias !37
  %wide.load121 = load <4 x i32>, ptr %i.dk, align 4, !tbaa !4, !alias.scope !40, !noalias !37
...
middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %._crit_edge78.us, label %.lr.ph77.us.preheader123
...
.loopexit:                                        ; preds = %bb.z, %.loopexitthread-pre-split
  ...
  br i1 %i.kb, label %.lr.ph275.a, label %._crit_edge276

.lr.ph275.a:                                      ; preds = %.loopexit
...
3:                                                ; preds = %.lr.ph275.a, %._crit_edge270
  %4 = phi i32 [ %i.jz, %.lr.ph275.a ], [ %5, %._crit_edge270 ]
...
._crit_edge270:                                   ; preds = %._crit_edge270.loopexit, %3
  ...
  br i1 %i.lz, label %3, label %._crit_edge276, !llvm.loop !100

._crit_edge276:                                   ; preds = %._crit_edge270, %.loopexit
