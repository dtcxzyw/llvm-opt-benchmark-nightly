...
bb.c:                                             ; preds = %._crit_edge
  ...
  %.pre99.a = load ptr, ptr @lookaheadset, align 8 ; 3 uses
...
bb.d:                                             ; preds = %.lr.ph65, %bb.e
  %indvars.iv90 = phi i64 [ 0, %.lr.ph65 ], [ %indvars.iv.next91, %bb.e ] ; 2 uses
  %i.u = getelementptr inbounds nuw [2 x i8], ptr %i.t, i64 %indvars.iv90
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.af = getelementptr inbounds [4 x i8], ptr %.pre99.a, i64 %i.ae ; 2 uses
...
.loopexit60.loopexit:                             ; preds = %bb.e, %bb.d
  %.pre100 = load i32, ptr @tokensetsize, align 4, !tbaa !4
  br label %.loopexit60

.loopexit60:                                      ; preds = %._crit_edge..loopexit60_crit_edge, %.loopexit60.loopexit, %bb.c
  %i.ai = phi i32 [ %i.l, %._crit_edge..loopexit60_crit_edge ], [ %.pre100, %.loopexit60.loopexit ], [ %i.l, %bb.c ]
  %i.aj = phi ptr [ %.pre, %._crit_edge..loopexit60_crit_edge ], [ %.pre99.a, %.loopexit60.loopexit ], [ %.pre99.a, %bb.c ] ; 2 uses
...
.lr.ph69.preheader:                               ; preds = %.loopexit60
  ...
  %wide.trip.count96 = sext i16 %i.ao to i64
  %.pre102 = load ptr, ptr @rprec, align 8, !tbaa !27
  %.pre104 = load ptr, ptr @LAruleno, align 8, !tbaa !27
  br label %.lr.ph69

.lr.ph69:                                         ; preds = %.lr.ph69.preheader, %.loopexit59
  %i.av = phi ptr [ %.pre104, %.lr.ph69.preheader ], [ %i.bp, %.loopexit59 ] ; 3 uses
  %i.aw = phi ptr [ %.pre102, %.lr.ph69.preheader ], [ %i.bq, %.loopexit59 ] ; 3 uses
  %indvars.iv93 = phi i64 [ %i.au, %.lr.ph69.preheader ], [ %indvars.iv.next94, %.loopexit59 ] ; 4 uses
  %i.ax = getelementptr inbounds [2 x i8], ptr %i.av, i64 %indvars.iv93
...
bb.f:                                             ; preds = %.lr.ph69
  ...
  %i.bf = mul nsw i64 %indvars.iv93, %i.be
...
bb.i:                                             ; preds = %bb.h
  %i.bo = trunc nsw i64 %indvars.iv93 to i32
  tail call void @resolve_sr_conflict(i32 noundef %0, i32 noundef %i.bo)
  %.pre101 = load ptr, ptr @rprec, align 8, !tbaa !27
  %.pre103 = load ptr, ptr @LAruleno, align 8, !tbaa !27
  br label %.loopexit59

.loopexit59:                                      ; preds = %bb.g, %.lr.ph69, %bb.i
  %i.bp = phi ptr [ %.pre103, %bb.i ], [ %i.av, %.lr.ph69 ], [ %i.av, %bb.g ]
  %i.bq = phi ptr [ %.pre101, %bb.i ], [ %i.aw, %.lr.ph69 ], [ %i.aw, %bb.g ]
  %indvars.iv.next94 = add nsw i64 %indvars.iv93, 1 ; 2 uses
  %exitcond97.not = icmp eq i64 %indvars.iv.next94, %wide.trip.count96
  br i1 %exitcond97.not, label %._crit_edge70.loopexit, label %.lr.ph69, !llvm.loop !32

._crit_edge70.loopexit:                           ; preds = %.loopexit59
  %.pre105 = load ptr, ptr @lookaheads, align 8, !tbaa !27
  %.phi.trans.insert = getelementptr inbounds [2 x i8], ptr %.pre105, i64 %i.b
  %.pre106 = load i16, ptr %.phi.trans.insert, align 2, !tbaa !29
  br label %._crit_edge70

._crit_edge70:                                    ; preds = %._crit_edge70.loopexit, %.loopexit60
  %i.br = phi i16 [ %.pre106, %._crit_edge70.loopexit ], [ %i.as, %.loopexit60 ] ; 2 uses
...
.lr.ph81:                                         ; preds = %._crit_edge70
  ...
  br i1 %i.bu, label %.lr.ph74.us.preheader, label %.loopexit

.lr.ph74.us.preheader:                            ; preds = %.lr.ph81
  ...
  %i.cg = add i64 %i.bv, 4
  %umax117 = tail call i64 @llvm.umax.i64(i64 %i.cf, i64 %i.cg)
  %i.ch = xor i64 %i.bv, -1
  %i.ci = add i64 %umax117, %i.ch                 ; 2 uses
...
.lr.ph74.us:                                      ; preds = %.lr.ph74.us.preheader, %._crit_edge78.us.us
  %.379.us = phi i32 [ %1, %._crit_edge78.us.us ], [ %i.bw, %.lr.ph74.us.preheader ] ; 2 uses
  %i.cn = load ptr, ptr @LA, align 8, !tbaa !11   ; 2 uses
  %i.co = load i32, ptr @tokensetsize, align 4, !tbaa !4
  %i.cp = mul i32 %i.co, %.379.us
  %i.cq = sext i32 %i.cp to i64                   ; 2 uses
  %i.cr = getelementptr [4 x i8], ptr %i.cn, i64 %i.cq ; 6 uses
  br label %bb.j

.lr.ph77.us:                                      ; preds = %.lr.ph77.us.preheader123, %.lr.ph77.us
  %.24676.us = phi ptr [ %i.cu, %.lr.ph77.us ], [ %.24676.us.ph, %.lr.ph77.us.preheader123 ] ; 3 uses
  %.24975.us = phi ptr [ %i.cs, %.lr.ph77.us ], [ %.24975.us.ph, %.lr.ph77.us.preheader123 ] ; 2 uses
  %i.cs = getelementptr inbounds nuw i8, ptr %.24975.us, i64 4
  %i.ct = load i32, ptr %.24975.us, align 4, !tbaa !4
  %i.cu = getelementptr inbounds nuw i8, ptr %.24676.us, i64 4 ; 2 uses
  %i.cv = load i32, ptr %.24676.us, align 4, !tbaa !4
  %i.cw = or i32 %i.cv, %i.ct
  store i32 %i.cw, ptr %.24676.us, align 4, !tbaa !4
  %i.cx = icmp ult ptr %i.cu, %i.ar
  br i1 %i.cx, label %.lr.ph77.us, label %._crit_edge78.us.us, !llvm.loop !33

bb.j:                                             ; preds = %bb.l, %.lr.ph74.us
  %.14572.us = phi ptr [ %i.bt, %.lr.ph74.us ], [ %i.da, %bb.l ] ; 2 uses
  %.14871.us = phi ptr [ %i.cr, %.lr.ph74.us ], [ %i.cy, %bb.l ] ; 2 uses
  %i.cy = getelementptr inbounds nuw i8, ptr %.14871.us, i64 4
  %i.cz = load i32, ptr %.14871.us, align 4, !tbaa !4
  %i.da = getelementptr inbounds nuw i8, ptr %.14572.us, i64 4 ; 2 uses
  %i.db = load i32, ptr %.14572.us, align 4, !tbaa !4
  %i.dc = and i32 %i.db, %i.cz
  %.not56.us = icmp eq i32 %i.dc, 0
  br i1 %.not56.us, label %bb.l, label %bb.k
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  br i1 %i.df, label %bb.j, label %.lr.ph77.us.preheader, !llvm.loop !35

.lr.ph77.us.preheader:                            ; preds = %bb.l
  br i1 %min.iters.check, label %.lr.ph77.us.preheader123, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph77.us.preheader
  %scevgep115 = getelementptr i8, ptr %i.cn, i64 %i.cd
  %i.dg = shl nsw i64 %i.cq, 2
  %scevgep116 = getelementptr i8, ptr %scevgep115, i64 %i.dg
  %bound0 = icmp ult ptr %i.bt, %scevgep116
  %bound1 = icmp ult ptr %i.cr, %scevgep
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %.lr.ph77.us.preheader123, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep118 = getelementptr i8, ptr %i.cr, i64 %i.di ; 2 uses
  %i.dj = getelementptr i8, ptr %next.gep118, i64 16
  %wide.load = load <4 x i32>, ptr %next.gep118, align 4, !tbaa !4, !alias.scope !36
  %wide.load119 = load <4 x i32>, ptr %i.dj, align 4, !tbaa !4, !alias.scope !36
  %i.dk = getelementptr i8, ptr %next.gep, i64 16 ; 2 uses
  %wide.load120 = load <4 x i32>, ptr %next.gep, align 4, !tbaa !4, !alias.scope !39, !noalias !36
  %wide.load121 = load <4 x i32>, ptr %i.dk, align 4, !tbaa !4, !alias.scope !39, !noalias !36
  %i.dl = or <4 x i32> %wide.load120, %wide.load
  %i.dm = or <4 x i32> %wide.load121, %wide.load119
...
middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %._crit_edge78.us.us, label %.lr.ph77.us.preheader123

.lr.ph77.us.preheader123:                         ; preds = %vector.memcheck, %.lr.ph77.us.preheader, %middle.block
  %.24676.us.ph = phi ptr [ %i.bt, %vector.memcheck ], [ %i.bt, %.lr.ph77.us.preheader ], [ %i.cm, %middle.block ]
  %.24975.us.ph = phi ptr [ %i.cr, %vector.memcheck ], [ %i.cr, %.lr.ph77.us.preheader ], [ %i.dh, %middle.block ]
  br label %.lr.ph77.us

._crit_edge78.us.us:                              ; preds = %.lr.ph77.us, %middle.block
  %1 = add nsw i32 %.379.us, 1                    ; 2 uses
  %exitcond91.not = icmp eq i32 %1, %i.ap
  br i1 %exitcond91.not, label %.loopexit, label %.lr.ph74.us, !llvm.loop !43
...
.lr.ph241:                                        ; preds = %.lr.ph241, %.lr.ph241.preheader.new
  ...
  %niter410 = phi i32 [ 0, %.lr.ph241.preheader.new ], [ %niter410.next.1, %.lr.ph241 ]
  ...
  %niter410.next.1 = add i32 %niter410, 2         ; 2 uses
  %niter410.ncmp.1 = icmp eq i32 %niter410.next.1, %unroll_iter409
  br i1 %niter410.ncmp.1, label %._crit_edge242.loopexit.unr-lcssa, label %.lr.ph241, !llvm.loop !88

._crit_edge242.loopexit.unr-lcssa:                ; preds = %.lr.ph241
  %lcmp.mod406.not = icmp eq i32 %xtraiter405, 0
  br i1 %lcmp.mod406.not, label %._crit_edge242, label %.lr.ph241.epil.preheader
...
.lr.ph241.epil.preheader:                         ; preds = %._crit_edge242.loopexit.unr-lcssa, %.lr.ph241.preheader
  ...
  %lcmp.mod408 = trunc i32 %i.hk to i1
...
.lr.ph247.preheader:                              ; preds = %bb.v
  %brmerge = select i1 %min.iters.check359, i1 true, i1 %found.conflict
  br i1 %brmerge, label %.lr.ph247.preheader401, label %vector.body363

vector.body363:                                   ; preds = %.lr.ph247.preheader, %vector.body363
  %index364 = phi i64 [ %index.next371, %vector.body363 ], [ 0, %.lr.ph247.preheader ] ; 2 uses
  %i.in = shl i64 %index364, 2                    ; 2 uses
  %next.gep365.a = getelementptr i8, ptr %i.ff, i64 %i.in ; 2 uses
  %next.gep366 = getelementptr i8, ptr %i.fn, i64 %i.in ; 3 uses
  %i.io = getelementptr i8, ptr %next.gep365.a, i64 16
  %wide.load367.a = load <4 x i32>, ptr %next.gep365.a, align 4, !tbaa !4, !alias.scope !89
  %wide.load368.a = load <4 x i32>, ptr %i.io, align 4, !tbaa !4, !alias.scope !89
  %i.ip = getelementptr i8, ptr %next.gep366, i64 16 ; 2 uses
  %wide.load369.a = load <4 x i32>, ptr %next.gep366, align 4, !tbaa !4, !alias.scope !92, !noalias !89
  %wide.load370 = load <4 x i32>, ptr %i.ip, align 4, !tbaa !4, !alias.scope !92, !noalias !89
  %i.iq = or <4 x i32> %wide.load369.a, %wide.load367.a
  %i.ir = or <4 x i32> %wide.load370, %wide.load368.a
  store <4 x i32> %i.iq, ptr %next.gep366, align 4, !tbaa !4, !alias.scope !92, !noalias !89
  store <4 x i32> %i.ir, ptr %i.ip, align 4, !tbaa !4, !alias.scope !92, !noalias !89
  %index.next371 = add nuw i64 %index364, 8       ; 2 uses
  %i.is = icmp eq i64 %index.next371, %n.vec362
  br i1 %i.is, label %middle.block372, label %vector.body363, !llvm.loop !94

middle.block372:                                  ; preds = %vector.body363
  br i1 %cmp.n373, label %._crit_edge248, label %.lr.ph247.preheader401

.lr.ph247.preheader401:                           ; preds = %.lr.ph247.preheader, %middle.block372
  %.6173245.ph = phi ptr [ %i.gp, %middle.block372 ], [ %i.ff, %.lr.ph247.preheader ]
  %.2177244.ph = phi ptr [ %i.gq, %middle.block372 ], [ %i.fn, %.lr.ph247.preheader ]
  br label %.lr.ph247

.lr.ph247:                                        ; preds = %.lr.ph247.preheader401, %.lr.ph247
  %.6173245 = phi ptr [ %i.it, %.lr.ph247 ], [ %.6173245.ph, %.lr.ph247.preheader401 ] ; 2 uses
  %.2177244 = phi ptr [ %i.iv, %.lr.ph247 ], [ %.2177244.ph, %.lr.ph247.preheader401 ] ; 3 uses
...
._crit_edge248:                                   ; preds = %.lr.ph247, %middle.block372, %bb.v
...
.loopexit:                                        ; preds = %bb.z, %.loopexitthread-pre-split
  ...
  br i1 %i.kb, label %.lr.ph275, label %._crit_edge276

.lr.ph275:                                        ; preds = %.loopexit
  %1 = icmp slt i16 %i.bx, %i.ca
  %2 = sext i32 %.2156 to i64                     ; 2 uses
  br i1 %1, label %.lr.ph275.a, label %._crit_edge276

.lr.ph275.a:                                      ; preds = %.lr.ph275
...
.lr.ph269:                                        ; preds = %.lr.ph275.a, %._crit_edge270
  %indvars.iv312 = phi i64 [ 0, %.lr.ph275.a ], [ %indvars.iv.next313, %._crit_edge270 ] ; 3 uses
  %.2159272 = phi ptr [ %i.kg, %.lr.ph275.a ], [ %spec.select206, %._crit_edge270 ] ; 2 uses
  %.4165271 = phi i32 [ 1, %.lr.ph275.a ], [ %spec.select205, %._crit_edge270 ] ; 3 uses
...
._crit_edge270:                                   ; preds = %bb.ai
  ...
  %3 = load i32, ptr @ntokens, align 4, !tbaa !4
  %i.ly = sext i32 %3 to i64
  %i.lz = icmp slt i64 %indvars.iv.next313, %i.ly
  br i1 %i.lz, label %.lr.ph269, label %._crit_edge276, !llvm.loop !100

._crit_edge276:                                   ; preds = %._crit_edge270, %.lr.ph275, %.loopexit
  %i.ma = icmp sgt i32 %.2156, -1
  br i1 %i.ma, label %bb.aj, label %bb.ak

bb.aj:                                            ; preds = %._crit_edge276
...
bb.ak:                                            ; preds = %bb.aj, %._crit_edge276
...
!64 = !{!65}
!65 = distinct !{!65, !63}
!66 = distinct !{!66, !18, !34, !42}
!67 = distinct !{!67, !18, !34}
!68 = distinct !{!68, !18}
!69 = !{!70}
!70 = distinct !{!70, !71}
...
!72 = !{!73}
!73 = distinct !{!73, !71}
!74 = distinct !{!74, !18, !34, !42}
!75 = distinct !{!75, !18, !34}
!76 = distinct !{!76, !18}
!77 = distinct !{!77, !57}
!78 = distinct !{!78, !57}
!79 = distinct !{!79, !18}
...
!81 = distinct !{!81, !18}
!82 = distinct !{!82, !18}
!83 = distinct !{!83, !18, !34, !42}
!84 = distinct !{!84, !18, !34}
!85 = distinct !{!85, !18}
!86 = distinct !{!86, !18, !34, !42}
!87 = distinct !{!87, !18, !34}
!88 = distinct !{!88, !18}
!89 = !{!90}
!90 = distinct !{!90, !91}
...
!92 = !{!93}
!93 = distinct !{!93, !91}
!94 = distinct !{!94, !18, !34, !42}
!95 = distinct !{!95, !18, !34}
!96 = distinct !{!96, !18}
!97 = distinct !{!97, !18}
!98 = distinct !{!98, !18}
!99 = distinct !{!99, !18}
