...
begin_hunk_0_@initialize_conflicts:bb.a
  store ptr %i.b, ptr @conflicts, align 8, !tbaa !13
  %i.c = load i32, ptr @tokensetsize, align 4, !tbaa !10
  %i.d = shl i32 %i.c, 2
  %i.e = tail call ptr (i32, ...) @mallocate(i32 noundef %i.d) #14
  store ptr %i.e, ptr @shiftset, align 8, !tbaa !15
  %i.f = load i32, ptr @tokensetsize, align 4, !tbaa !10
  %i.g = shl i32 %i.f, 2
  %i.h = tail call ptr (i32, ...) @mallocate(i32 noundef %i.g) #14
  store ptr %i.h, ptr @lookaheadset, align 8, !tbaa !15
  %i.i = load i32, ptr @nstates, align 4, !tbaa !10
  %i.j = shl i32 %i.i, 3
  %i.k = tail call ptr (i32, ...) @mallocate(i32 noundef %i.j) #14
  store ptr %i.k, ptr @err_table, align 8, !tbaa !18
  store i8 0, ptr @any_conflicts, align 1, !tbaa !19
  %i.l = load i32, ptr @nstates, align 4, !tbaa !10
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %i.o = load i32, ptr @nstates, align 4, !tbaa !10
  %i.p = icmp slt i32 %i.n, %i.o
  br i1 %i.p, label %.lr.ph, label %._crit_edge, !llvm.loop !42
...
bb.a:
  %i.a = load ptr, ptr @consistent, align 8, !tbaa !13
...
.lr.ph:                                           ; preds = %.preheader61
  %i.g = load ptr, ptr @lookaheadset, align 8, !tbaa !15
  br label %bb.b
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.i = load i32, ptr @tokensetsize, align 4, !tbaa !10 ; 2 uses
  %i.j = sext i32 %i.i to i64
  %i.k = icmp slt i64 %indvars.iv.next, %i.j
  br i1 %i.k, label %bb.b, label %._crit_edge, !llvm.loop !43

._crit_edge:                                      ; preds = %bb.b, %.preheader61
  %i.l = phi i32 [ %i.e, %.preheader61 ], [ %i.i, %bb.b ] ; 2 uses
  %i.m = load ptr, ptr @shift_table, align 8, !tbaa !22
  %i.n = getelementptr inbounds [8 x i8], ptr %i.m, i64 %i.b
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !24   ; 3 uses
...
._crit_edge..loopexit60_crit_edge:                ; preds = %._crit_edge
  %.pre = load ptr, ptr @lookaheadset, align 8, !tbaa !15
  br label %.loopexit60

bb.c:                                             ; preds = %._crit_edge
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 10
  %i.q = load i16, ptr %i.p, align 2, !tbaa !27   ; 2 uses
...
.lr.ph65:                                         ; preds = %bb.c
  ...
  %i.s = load ptr, ptr @accessing_symbol, align 8, !tbaa !29
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %exitcond.not, label %.loopexit60.loopexit, label %bb.d, !llvm.loop !44

.loopexit60.loopexit:                             ; preds = %bb.e, %bb.d
  %.pre93 = load i32, ptr @tokensetsize, align 4, !tbaa !10
  br label %.loopexit60
...
.lr.ph69.preheader:                               ; preds = %.loopexit60
  ...
  %.pre95 = load ptr, ptr @rprec, align 8, !tbaa !29
  %.pre97 = load ptr, ptr @LAruleno, align 8, !tbaa !29
  br label %.lr.ph69
...
.lr.ph69:                                         ; preds = %.lr.ph69.preheader, %.loopexit59
  ...
  %i.ay = load i16, ptr %i.ax, align 2, !tbaa !30
...
bb.f:                                             ; preds = %.lr.ph69
  %i.bc = load ptr, ptr @LA, align 8, !tbaa !15
  %i.bd = load i32, ptr @tokensetsize, align 4, !tbaa !10
  %i.be = sext i32 %i.bd to i64
  %i.bf = mul nsw i64 %indvars.iv86, %i.be
  %i.bg = getelementptr inbounds [4 x i8], ptr %i.bc, i64 %i.bf
  %i.bh = load ptr, ptr @lookaheadset, align 8, !tbaa !15
  br label %bb.g
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.bk = load i32, ptr %.044, align 4, !tbaa !10
  ...
  br i1 %.not58, label %bb.g, label %bb.i, !llvm.loop !45

bb.i:                                             ; preds = %bb.h
  %i.bo = trunc nsw i64 %indvars.iv86 to i32
  tail call void @resolve_sr_conflict(i32 noundef %0, i32 noundef %i.bo)
  %.pre94 = load ptr, ptr @rprec, align 8, !tbaa !29
  %.pre96 = load ptr, ptr @LAruleno, align 8, !tbaa !29
  br label %.loopexit59
...
.loopexit59:                                      ; preds = %bb.g, %.lr.ph69, %bb.i
  ...
  br i1 %exitcond90.not, label %._crit_edge70.loopexit, label %.lr.ph69, !llvm.loop !46

._crit_edge70.loopexit:                           ; preds = %.loopexit59
  %.pre98 = load ptr, ptr @lookaheads, align 8, !tbaa !29
  %.phi.trans.insert = getelementptr inbounds [2 x i8], ptr %.pre98, i64 %i.b
  %.pre99 = load i16, ptr %.phi.trans.insert, align 2, !tbaa !30
...
.lr.ph81:                                         ; preds = %._crit_edge70
  %i.bt = load ptr, ptr @lookaheadset, align 8, !tbaa !15 ; 9 uses
...
.lr.ph74.us.us:                                   ; preds = %.lr.ph74.us.us.preheader, %._crit_edge78.us.us
  ...
  %i.cl = load ptr, ptr @LA, align 8, !tbaa !15   ; 2 uses
  %i.cm = load i32, ptr @tokensetsize, align 4, !tbaa !10
...
bb.j:                                             ; preds = %bb.l, %.lr.ph74.us.us
  ...
  %i.cr = load i32, ptr %.14571.us.us, align 4, !tbaa !10
  %i.cs = getelementptr inbounds nuw i8, ptr %.172.us.us, i64 4 ; 2 uses
  %i.ct = load i32, ptr %.172.us.us, align 4, !tbaa !10
  %i.cu = and i32 %i.ct, %i.cr
  %.not56.us.us = icmp eq i32 %i.cu, 0
  br i1 %.not56.us.us, label %bb.l, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.cv = load ptr, ptr @conflicts, align 8, !tbaa !13
  %i.cw = getelementptr inbounds i8, ptr %i.cv, i64 %i.b
  store i8 1, ptr %i.cw, align 1, !tbaa !19
  store i8 1, ptr @any_conflicts, align 1, !tbaa !19
  br label %bb.l

bb.l:                                             ; preds = %bb.k, %bb.j
  %i.cx = icmp ult ptr %i.cs, %i.ar
  br i1 %i.cx, label %bb.j, label %..preheader_crit_edge.us.us.preheader, !llvm.loop !47
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %next.gep111, align 4, !tbaa !10, !alias.scope !54
  %wide.load112 = load <4 x i32>, ptr %i.db, align 4, !tbaa !10, !alias.scope !54
  %i.dc = getelementptr i8, ptr %next.gep, i64 16 ; 2 uses
  %wide.load113 = load <4 x i32>, ptr %next.gep, align 4, !tbaa !10, !alias.scope !55, !noalias !54
  %wide.load114 = load <4 x i32>, ptr %i.dc, align 4, !tbaa !10, !alias.scope !55, !noalias !54
  %i.dd = or <4 x i32> %wide.load113, %wide.load
  %i.de = or <4 x i32> %wide.load114, %wide.load112
  store <4 x i32> %i.dd, ptr %next.gep, align 4, !tbaa !10, !alias.scope !55, !noalias !54
  store <4 x i32> %i.de, ptr %i.dc, align 4, !tbaa !10, !alias.scope !55, !noalias !54
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.df = icmp eq i64 %index.next, %n.vec
  br i1 %i.df, label %middle.block, label %vector.body, !llvm.loop !51
...
..preheader_crit_edge.us.us:                      ; preds = %..preheader_crit_edge.us.us.preheader116, %..preheader_crit_edge.us.us
  ...
  %i.dh = load i32, ptr %.24675.us.us, align 4, !tbaa !10
  %i.di = getelementptr inbounds nuw i8, ptr %.276.us.us, i64 4 ; 2 uses
  %i.dj = load i32, ptr %.276.us.us, align 4, !tbaa !10
  %i.dk = or i32 %i.dj, %i.dh
  store i32 %i.dk, ptr %.276.us.us, align 4, !tbaa !10
  %i.dl = icmp ult ptr %i.di, %i.ar
  br i1 %i.dl, label %..preheader_crit_edge.us.us, label %._crit_edge78.us.us, !llvm.loop !52
...
._crit_edge78.us.us:                              ; preds = %..preheader_crit_edge.us.us, %middle.block
  ...
  br i1 %exitcond91.not, label %.loopexit, label %.lr.ph74.us.us, !llvm.loop !53
...
bb.a:
  %i.a = load i32, ptr @ntokens, align 4, !tbaa !10 ; 2 uses
  ...
  %i.g = load ptr, ptr @rprec, align 8, !tbaa !29
  %i.h = load ptr, ptr @LAruleno, align 8, !tbaa !29
...
.lr.ph:                                           ; preds = %bb.a
  %i.p = load ptr, ptr @lookaheadset, align 8, !tbaa !15
  %i.q = load ptr, ptr @LA, align 8, !tbaa !15
  %i.r = load i32, ptr @tokensetsize, align 4, !tbaa !10
...
bb.b:                                             ; preds = %.lr.ph, %flush_shift.exit
  ...
  %i.w = load i32, ptr %.06194, align 4, !tbaa !10 ; 2 uses
  %i.x = load i32, ptr %.06393, align 4, !tbaa !10 ; 2 uses
  %i.y = and i32 %i.w, %i.x
...
bb.c:                                             ; preds = %bb.b
  %i.aa = load ptr, ptr @sprec, align 8, !tbaa !29
  %i.ab = getelementptr inbounds nuw [2 x i8], ptr %i.aa, i64 %indvars.iv
  %i.ac = load i16, ptr %i.ab, align 2, !tbaa !30 ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %.pre98 = load i32, ptr %.06194, align 4, !tbaa !10
  br label %bb.g
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  store i32 %i.aq, ptr %.06194, align 4, !tbaa !10
  %i.ar = load ptr, ptr @shift_table, align 8, !tbaa !22
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.av = load i16, ptr %i.au, align 2, !tbaa !27 ; 4 uses
...
begin_hunk_1_@print_reductions:bb.a
  ...
  br i1 %exitcond306.not, label %.loopexitthread-pre-split, label %bb.y, !llvm.loop !96
...
.loopexitthread-pre-split:                        ; preds = %bb.ab, %bb.x, %._crit_edge259..loopexit_crit_edge
  ...
  %.pr = load i32, ptr @ntokens, align 4, !tbaa !10
  br label %.loopexit
...
.lr.ph269.preheader:                              ; preds = %.lr.ph275
  %i.ke = load ptr, ptr @LA, align 8, !tbaa !15
  %i.kf = load i32, ptr @tokensetsize, align 4, !tbaa !10
...
.lr.ph269:                                        ; preds = %.lr.ph269.preheader, %._crit_edge270
  ...
  %i.kk = load i32, ptr %i.ka, align 4, !tbaa !10
...
bb.ac:                                            ; preds = %.lr.ph269, %bb.ai
  ...
  %i.km = load i32, ptr %.7265, align 4, !tbaa !10
...
bb.af:                                            ; preds = %bb.ae
  %i.kq = load ptr, ptr @LAruleno, align 8, !tbaa !29
  br label %.sink.split

bb.ag:                                            ; preds = %bb.ad
  %.not199 = icmp eq i32 %.0267, 0
  %.pre319 = load ptr, ptr @LAruleno, align 8, !tbaa !29 ; 2 uses
  br i1 %.not199, label %.sink.split, label %bb.ah

bb.ah:                                            ; preds = %bb.ag
  %i.kr = getelementptr inbounds [2 x i8], ptr %.pre319, i64 %i.kd
  %i.ks = load i16, ptr %i.kr, align 2, !tbaa !30 ; 2 uses
  %i.kt = sext i16 %i.ks to i32
  %i.ku = load ptr, ptr @foutput, align 8, !tbaa !34
  %i.kv = load ptr, ptr @tags, align 8, !tbaa !36 ; 2 uses
  %i.kw = getelementptr inbounds nuw [8 x i8], ptr %i.kv, i64 %indvars.iv312
  %i.kx = load ptr, ptr %i.kw, align 8, !tbaa !13
  %i.ky = load ptr, ptr @rlhs, align 8, !tbaa !29
  ...
  %i.le = load ptr, ptr %i.ld, align 8, !tbaa !13
  ...
  %.pre318 = load ptr, ptr @LAruleno, align 8, !tbaa !29
  br label %.sink.split
...
.sink.split:                                      ; preds = %bb.ag, %bb.ah, %bb.af
  ...
  %i.lh = load i16, ptr %i.lg, align 2, !tbaa !30 ; 2 uses
  %i.li = sext i16 %i.lh to i32
  %i.lj = load ptr, ptr @foutput, align 8, !tbaa !34
  %i.lk = load ptr, ptr @tags, align 8, !tbaa !36 ; 2 uses
  %i.ll = getelementptr inbounds nuw [8 x i8], ptr %i.lk, i64 %indvars.iv312
  %i.lm = load ptr, ptr %i.ll, align 8, !tbaa !13
  %i.ln = load ptr, ptr @rlhs, align 8, !tbaa !29
  %i.lo = sext i16 %i.lh to i64
  %i.lp = getelementptr inbounds [2 x i8], ptr %i.ln, i64 %i.lo
  %i.lq = load i16, ptr %i.lp, align 2, !tbaa !30
...
bb.ai:                                            ; preds = %.sink.split, %bb.ae, %bb.ac
  ...
  %i.lv = load i32, ptr @tokensetsize, align 4, !tbaa !10
  ...
  br i1 %exitcond311.not, label %._crit_edge270, label %bb.ac, !llvm.loop !97
...
._crit_edge270:                                   ; preds = %bb.ai
  ...
  %i.ma = load i32, ptr @ntokens, align 4, !tbaa !10
  %i.mb = sext i32 %i.ma to i64
  %i.mc = icmp slt i64 %indvars.iv.next313, %i.mb
  br i1 %i.mc, label %.lr.ph269, label %._crit_edge276.split, !llvm.loop !98
...
bb.aj:                                            ; preds = %._crit_edge276.split
  %i.me = load ptr, ptr @foutput, align 8, !tbaa !34
  %i.mf = load ptr, ptr @tags, align 8, !tbaa !36
  %i.mg = load ptr, ptr @rlhs, align 8, !tbaa !29
  %i.mh = sext i32 %.2146 to i64
  %i.mi = getelementptr inbounds [2 x i8], ptr %i.mg, i64 %i.mh
  %i.mj = load i16, ptr %i.mi, align 2, !tbaa !30
  %i.mk = sext i16 %i.mj to i64
  %i.ml = getelementptr inbounds [8 x i8], ptr %i.mf, i64 %i.mk
  %i.mm = load ptr, ptr %i.ml, align 8, !tbaa !13
...
bb.ak:                                            ; preds = %bb.aj, %._crit_edge276.split
  %i.mo = load ptr, ptr @foutput, align 8, !tbaa !34
...
bb.a:
  %i.a = load ptr, ptr @conflicts, align 8, !tbaa !13 ; 2 uses
...
bb.c:                                             ; preds = %bb.b, %bb.a
  %i.b = load ptr, ptr @shiftset, align 8, !tbaa !15 ; 2 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c
  %i.c = load ptr, ptr @lookaheadset, align 8, !tbaa !15 ; 2 uses
...
!17 = !{!"p2 _ZTS4errs", !16, i64 0}
!18 = !{!17, !17, i64 0}
!19 = !{!8, !8, i64 0}
!20 = !{!"llvm.loop.mustprogress"}
!21 = !{!"p2 _ZTS6shifts", !16, i64 0}
!22 = !{!21, !21, i64 0}
!23 = !{!"p1 _ZTS6shifts", !11, i64 0}
!24 = !{!23, !23, i64 0}
!25 = !{!"short", !8, i64 0}
!26 = !{!"shifts", !23, i64 0, !25, i64 8, !25, i64 10, !8, i64 12}
!27 = !{!26, !25, i64 10}
...
!36 = !{!35, !35, i64 0}
!37 = !{!"errs", !25, i64 0, !8, i64 2}
!38 = !{!37, !25, i64 0}
!39 = !{!"p1 _ZTS4errs", !11, i64 0}
!40 = !{!39, !39, i64 0}
...
!49 = distinct !{!49, !48}
!50 = distinct !{!50, !48}
!51 = distinct !{!51, !20, !31, !32}
!52 = distinct !{!52, !20, !31}
!53 = distinct !{!53, !20}
!54 = !{!49}
!55 = !{!50}
!56 = distinct !{!56, !20}
...
!62 = distinct !{!62, !61}
!63 = distinct !{!63, !61}
!64 = distinct !{!64, !20, !31, !32}
!65 = distinct !{!65, !20, !31}
!66 = distinct !{!66, !20}
!67 = distinct !{!67, !"LVerDomain"}
!68 = distinct !{!68, !67}
!69 = distinct !{!69, !67}
!70 = distinct !{!70, !20, !31, !32}
!71 = distinct !{!71, !20, !31}
!72 = distinct !{!72, !20}
!73 = !{!62}
!74 = !{!63}
!75 = !{!68}
...
!81 = distinct !{!81, !20}
!82 = distinct !{!82, !20}
!83 = distinct !{!83, !20, !31, !32}
!84 = distinct !{!84, !20, !31}
!85 = distinct !{!85, !20}
!86 = distinct !{!86, !20, !31, !32}
!87 = distinct !{!87, !20, !31}
!88 = distinct !{!88, !20}
!89 = distinct !{!89, !"LVerDomain"}
!90 = distinct !{!90, !89}
!91 = distinct !{!91, !89}
!92 = distinct !{!92, !20, !31, !32}
!93 = distinct !{!93, !20, !31}
!94 = distinct !{!94, !20}
!95 = distinct !{!95, !20}
!96 = distinct !{!96, !20}
!97 = distinct !{!97, !20}
