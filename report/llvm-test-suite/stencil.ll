...
.preheader260:                                    ; preds = %.preheader260.lr.ph.split.split, %._crit_edge270.split
  ...
  %.pre403.pre.a = load double, ptr %.phi.trans.insert402.phi.trans.insert, align 8, !tbaa !27
...
.preheader258:                                    ; preds = %.preheader260, %._crit_edge
  %.pre403.a = phi double [ %.pre403.pre.a, %.preheader260 ], [ %.pre406.a, %._crit_edge ] ; 2 uses
  %.pre401.a = phi double [ %.pre401.pre, %.preheader260 ], [ %78, %._crit_edge ] ; 2 uses
  ...
  %.pre406.a = load double, ptr %.phi.trans.insert405, align 8, !tbaa !27
  %.phi.trans.insert411 = getelementptr inbounds nuw i8, ptr %i.gt, i64 8
  %.phi.trans.insert417.a = getelementptr inbounds nuw i8, ptr %i.gv, i64 8
  %10 = load <2 x double>, ptr %i.gt, align 8, !tbaa !27 ; 5 uses
  %.pre412.a = load double, ptr %.phi.trans.insert411, align 8, !tbaa !27 ; 2 uses
  %11 = load <2 x double>, ptr %i.gv, align 8, !tbaa !27 ; 5 uses
  %.pre418.a = load double, ptr %.phi.trans.insert417.a, align 8, !tbaa !27 ; 2 uses
  ...
  %15 = insertelement <4 x double> %14, double %.pre401.a, i64 0
  %16 = insertelement <4 x double> %15, double %.pre403.a, i64 2 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vector.recur512 = phi <2 x double> [ %vector.recur.init511.a, %vector.ph ], [ %wide.load517, %vector.body ] ; 2 uses
  %vector.recur514 = phi <2 x double> [ %vector.recur.init513.a, %vector.ph ], [ %i.ie, %vector.body ]
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.preheader258, %middle.block
  %.ph575.a = phi double [ %.pre418.a, %vector.memcheck ], [ %.pre418.a, %.preheader258 ], [ %vector.recur.extract, %middle.block ]
  %.ph576.a = phi double [ %13, %vector.memcheck ], [ %13, %.preheader258 ], [ %vector.recur.extract529, %middle.block ]
  %.ph577.a = phi double [ %.pre412.a, %vector.memcheck ], [ %.pre412.a, %.preheader258 ], [ %vector.recur.extract532, %middle.block ]
  %.ph578.a = phi double [ %12, %vector.memcheck ], [ %12, %.preheader258 ], [ %vector.recur.extract533, %middle.block ]
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %i.kc = phi double [ %41, %scalar.ph ], [ %.ph575.a, %scalar.ph.preheader ] ; 2 uses
  %i.kd = phi double [ %i.kc, %scalar.ph ], [ %.ph576.a, %scalar.ph.preheader ]
  %i.ke = phi double [ %i.kn, %scalar.ph ], [ %.ph577.a, %scalar.ph.preheader ] ; 2 uses
  %i.kf = phi double [ %i.ke, %scalar.ph ], [ %.ph578.a, %scalar.ph.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next.a, %scalar.ph ], [ %indvars.iv.ph, %scalar.ph.preheader ] ; 4 uses
  ...
  %indvars.iv.next.a = add nuw nsw i64 %indvars.iv, 1 ; 10 uses
  %i.kg = getelementptr inbounds nuw [8 x i8], ptr %i.go, i64 %indvars.iv.next.a
  %i.kh = load double, ptr %i.kg, align 8, !tbaa !27
  %i.ki = getelementptr inbounds nuw [8 x i8], ptr %i.gr, i64 %indvars.iv.next.a
  %i.kj = load double, ptr %i.ki, align 8, !tbaa !27
  %32 = insertelement <2 x double> poison, double %i.kh, i64 0
  %33 = insertelement <2 x double> %32, double %i.kj, i64 1 ; 2 uses
  ...
  %i.kk = getelementptr inbounds nuw [8 x i8], ptr %i.gn, i64 %indvars.iv.next.a
  %i.kl = load double, ptr %i.kk, align 8, !tbaa !27
  %37 = getelementptr inbounds nuw [8 x i8], ptr %i.gm, i64 %indvars.iv.next.a
  %38 = load double, ptr %37, align 8, !tbaa !27
  %i.km = getelementptr inbounds nuw [8 x i8], ptr %i.gt, i64 %indvars.iv.next.a
  %i.kn = load double, ptr %i.km, align 8, !tbaa !27 ; 2 uses
  %39 = getelementptr inbounds [8 x i8], ptr %6, i64 %28
  %i.ko = getelementptr inbounds nuw [8 x i8], ptr %6, i64 %indvars.iv.next.a
  %i.kp = load double, ptr %i.ko, align 8, !tbaa !27
  %i.kq = getelementptr inbounds nuw [8 x i8], ptr %5, i64 %indvars.iv.next.a
  %i.kr = load double, ptr %i.kq, align 8, !tbaa !27
  %40 = getelementptr inbounds nuw [8 x i8], ptr %i.gv, i64 %indvars.iv.next.a
  ...
  %48 = insertelement <2 x double> poison, double %i.kl, i64 0
  %49 = insertelement <2 x double> %48, double %i.kp, i64 1
  ...
  %54 = insertelement <2 x double> %53, double %i.kr, i64 1 ; 2 uses
  ...
  %62 = insertelement <2 x double> poison, double %i.kn, i64 0
