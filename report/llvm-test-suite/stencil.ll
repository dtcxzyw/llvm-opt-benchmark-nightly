...
.preheader258:                                    ; preds = %.preheader260, %._crit_edge
  %.pre403 = phi double [ %.pre403.pre, %.preheader260 ], [ %9, %._crit_edge ] ; 3 uses
  %.pre401 = phi double [ %.pre401.pre, %.preheader260 ], [ %8, %._crit_edge ] ; 3 uses
  ...
  %1 = load <2 x double>, ptr %i.gz, align 8, !tbaa !27 ; 6 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %2 = shufflevector <2 x double> %1, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vector.recur508 = phi <2 x double> [ %1, %vector.ph ], [ %wide.load518, %vector.body ] ; 2 uses
  %vector.recur510 = phi <2 x double> [ %2, %vector.ph ], [ %i.ja, %vector.body ]
  ...
  %wide.load518 = load <2 x double>, ptr %i.iz, align 8, !tbaa !27, !alias.scope !44 ; 4 uses
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.preheader258, %middle.block
  ...
  %.ph587 = phi <2 x double> [ %1, %vector.memcheck ], [ %1, %.preheader258 ], [ %wide.load518, %middle.block ]
  br label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %i.ku = phi double [ %i.ma, %scalar.ph ], [ %.ph579, %scalar.ph.preheader ] ; 2 uses
  %i.kv = phi double [ %i.ku, %scalar.ph ], [ %.ph580, %scalar.ph.preheader ]
  %i.kw = phi double [ %i.lt, %scalar.ph ], [ %.ph581, %scalar.ph.preheader ] ; 2 uses
  %i.kx = phi double [ %i.kw, %scalar.ph ], [ %.ph582, %scalar.ph.preheader ]
  %i.ky = phi double [ %i.lk, %scalar.ph ], [ %.ph583.a, %scalar.ph.preheader ] ; 2 uses
  %i.kz = phi double [ %i.ky, %scalar.ph ], [ %.ph584.a, %scalar.ph.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %scalar.ph ], [ %indvars.iv.ph, %scalar.ph.preheader ] ; 4 uses
  %3 = phi <2 x double> [ %i.la, %scalar.ph ], [ %.ph585, %scalar.ph.preheader ]
  %i.la = phi <2 x double> [ %i.mm, %scalar.ph ], [ %.ph586, %scalar.ph.preheader ] ; 2 uses
  %i.lb = phi <2 x double> [ %7, %scalar.ph ], [ %.ph587, %scalar.ph.preheader ] ; 2 uses
  ...
  %i.mj = fadd <2 x double> %i.mi, %3
  %i.mk = fadd <2 x double> %i.mj, %i.la
  ...
  %i.mo = insertelement <2 x double> poison, double %i.kx, i64 0
  %i.mp = insertelement <2 x double> %i.mo, double %i.kv, i64 1
  %i.mq = fadd <2 x double> %i.mn, %i.mp
  %i.mr = insertelement <2 x double> poison, double %i.kw, i64 0
  %i.ms = insertelement <2 x double> %i.mr, double %i.ku, i64 1
  ...
  %4 = shufflevector <2 x double> %i.lb, <2 x double> poison, <6 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison>
  %5 = shufflevector <6 x double> %i.mx, <6 x double> %4, <6 x i32> <i32 0, i32 6, i32 7, i32 poison, i32 poison, i32 poison>
  %i.my = insertelement <6 x double> %5, double %i.lm, i64 3
  ...
  %6 = shufflevector <2 x double> %i.lb, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %7 = insertelement <2 x double> %6, double %i.lm, i64 1
