...
.preheader264:                                    ; preds = %bb.a
  br i1 %i.u, label %.lr.ph.a, label %.loopexit256

.lr.ph.a:                                         ; preds = %.preheader264
  ...
  br i1 %or.cond, label %.loopexit256, label %.lr.ph.split.split.preheader
...
.lr.ph.split.split.preheader:                     ; preds = %.lr.ph.a
  ...
  %wide.trip.count374 = zext nneg i32 %.fr to i64
  %wide.trip.count369 = zext nneg i32 %.fr338 to i64 ; 2 uses
  ...
  %lcmp.mod654 = trunc i32 %.fr338 to i1
...
.lr.ph335:                                        ; preds = %.preheader255
  ...
  %.not244321 = icmp slt i32 %.fr, 1              ; 2 uses
  %.not248318 = icmp slt i32 %.fr338, 1           ; 2 uses
  %.not249314 = icmp slt i32 %.fr339, 1           ; 2 uses
  ...
  %brmerge = or i1 %.not248318, %.not249314
  ...
  %brmerge336 = or i1 %.not248318, %.not249314    ; 2 uses
  %wide.trip.count461 = zext nneg i32 %.fr to i64
  %wide.trip.count456 = zext i32 %.fr338 to i64   ; 2 uses
  ...
  %brmerge506 = or i1 %.not244321, %brmerge336
  %xtraiter655 = and i64 %wide.trip.count456, 1
  %i.bq = icmp eq i32 %.fr338, 1
  %unroll_iter658 = and i64 %wide.trip.count456, 4294967294
  %lcmp.mod656.not = icmp eq i64 %xtraiter655, 0
  %lcmp.mod657 = trunc i32 %.fr338 to i1
  br label %bb.b
...
bb.b:                                             ; preds = %.lr.ph335, %.loopexit
  ...
  %brmerge505 = or i1 %i.bx, %.not244321
  br i1 %brmerge505, label %.loopexit, label %.preheader252.lr.ph

.preheader252.lr.ph:                              ; preds = %bb.b
  br i1 %brmerge, label %.preheader251.lr.ph, label %.preheader252.lr.ph.split.split
...
.preheader253:                                    ; preds = %._crit_edge320
  br i1 %brmerge506, label %.loopexit, label %.preheader251.lr.ph.split.split

.preheader251.lr.ph:                              ; preds = %.preheader252.lr.ph
  br i1 %brmerge336, label %.loopexit, label %.preheader251.lr.ph.split.split

.preheader251.lr.ph.split.split:                  ; preds = %.preheader253, %.preheader251.lr.ph
...
.loopexit256:                                     ; preds = %.loopexit262, %.loopexit, %.lr.ph.a, %.preheader264, %.preheader255
  ret void
}
