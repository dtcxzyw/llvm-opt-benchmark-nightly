...
.preheader258:                                    ; preds = %.preheader260, %._crit_edge
  ...
  %i.gs = phi <2 x double> [ %i.gg, %.preheader260 ], [ %11, %._crit_edge ] ; 4 uses
  %i.gt = phi <2 x double> [ %i.gh, %.preheader260 ], [ %12, %._crit_edge ] ; 4 uses
  ...
  %.phi.trans.insert485 = getelementptr inbounds nuw i8, ptr %i.gx, i64 8
  %.phi.trans.insert491 = getelementptr inbounds nuw i8, ptr %i.gz, i64 8
  %i.hc = load <2 x double>, ptr %i.gx, align 8, !tbaa !27 ; 5 uses
  %.pre486 = load double, ptr %.phi.trans.insert485, align 8, !tbaa !27 ; 2 uses
  %i.hd = load <2 x double>, ptr %i.gz, align 8, !tbaa !27 ; 5 uses
  %.pre492 = load double, ptr %.phi.trans.insert491, align 8, !tbaa !27 ; 2 uses
  %1 = extractelement <2 x double> %i.hc, i64 0   ; 2 uses
  %2 = extractelement <2 x double> %i.hd, i64 0   ; 2 uses
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.preheader258, %middle.block
  ...
  %.ph644 = phi double [ %2, %vector.memcheck ], [ %2, %.preheader258 ], [ %vector.recur.extract596, %middle.block ]
  %.ph645 = phi double [ %.pre486, %vector.memcheck ], [ %.pre486, %.preheader258 ], [ %vector.recur.extract599, %middle.block ]
  %.ph646 = phi double [ %1, %vector.memcheck ], [ %1, %.preheader258 ], [ %vector.recur.extract600, %middle.block ]
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %3 = phi double [ %i.ls, %scalar.ph ], [ %.ph643, %scalar.ph.preheader ] ; 2 uses
  %4 = phi double [ %3, %scalar.ph ], [ %.ph644, %scalar.ph.preheader ]
  %i.ko = phi double [ %i.ll, %scalar.ph ], [ %.ph645, %scalar.ph.preheader ] ; 2 uses
  %i.kp = phi double [ %i.ko, %scalar.ph ], [ %.ph646, %scalar.ph.preheader ]
  %i.kq = phi double [ %i.le, %scalar.ph ], [ %.ph647.a, %scalar.ph.preheader ] ; 2 uses
  %i.kr = phi double [ %i.kq, %scalar.ph ], [ %.ph648.a, %scalar.ph.preheader ]
  %5 = phi double [ %i.lc, %scalar.ph ], [ %.ph649.a, %scalar.ph.preheader ] ; 2 uses
  %6 = phi double [ %5, %scalar.ph ], [ %.ph650.a, %scalar.ph.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %scalar.ph ], [ %indvars.iv.ph, %scalar.ph.preheader ] ; 4 uses
  %i.ks = phi <2 x double> [ %i.kt, %scalar.ph ], [ %.ph651, %scalar.ph.preheader ]
  %i.kt = phi <2 x double> [ %i.me, %scalar.ph ], [ %.ph652, %scalar.ph.preheader ] ; 2 uses
  ...
  %i.ll = load double, ptr %i.lk, align 8, !tbaa !27 ; 2 uses
  ...
  %i.ls = load double, ptr %i.lr, align 8, !tbaa !27 ; 2 uses
  ...
  %i.mb = fadd <2 x double> %i.ma, %i.ks
  %i.mc = fadd <2 x double> %i.mb, %i.kt
  ...
  %7 = insertelement <2 x double> poison, double %i.kp, i64 0
  %8 = insertelement <2 x double> %7, double %4, i64 1
  %i.mg = fadd <2 x double> %i.mf, %8
  %9 = insertelement <2 x double> poison, double %i.ko, i64 0
  %10 = insertelement <2 x double> %9, double %3, i64 1
  %i.mh = fadd <2 x double> %i.mg, %10
  %i.mi = insertelement <2 x double> poison, double %i.ll, i64 0
  %i.mj = insertelement <2 x double> %i.mi, double %i.ls, i64 1
  %i.mk = fadd <2 x double> %i.mh, %i.mj
  %i.ml = insertelement <6 x double> poison, double %i.lc, i64 0
  %i.mm = insertelement <6 x double> %i.ml, double %i.kr, i64 1
  %i.mn = insertelement <6 x double> %i.mm, double %i.kq, i64 2
  ...
  %op.rdx640 = fadd double %op.rdx639, %6
  %op.rdx641 = fadd double %op.rdx640, %5
...
._crit_edge:                                      ; preds = %scalar.ph, %middle.block
  ...
  %11 = shufflevector <2 x double> %i.hc, <2 x double> %i.hd, <2 x i32> <i32 1, i32 3>
  %12 = shufflevector <2 x double> %i.hc, <2 x double> %i.hd, <2 x i32> <i32 0, i32 2>
