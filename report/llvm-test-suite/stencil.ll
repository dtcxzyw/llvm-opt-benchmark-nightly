...
.preheader260:                                    ; preds = %.preheader260.lr.ph.split.split, %._crit_edge270.split
  ...
  %.pre407.pre = load double, ptr %.phi.trans.insert402.phi.trans.insert, align 8, !tbaa !27
  %1 = load <2 x double>, ptr %.pre397, align 8, !tbaa !27 ; 2 uses
  %2 = load <2 x double>, ptr %.pre400, align 8, !tbaa !27 ; 2 uses
  %3 = shufflevector <2 x double> %1, <2 x double> %2, <2 x i32> <i32 1, i32 3>
  %4 = shufflevector <2 x double> %1, <2 x double> %2, <2 x i32> <i32 0, i32 2>
...
.preheader258:                                    ; preds = %.preheader260, %._crit_edge
  %.pre409 = phi double [ %.pre407.pre, %.preheader260 ], [ %.pre404, %._crit_edge ] ; 2 uses
  %.pre407 = phi double [ %.pre401.pre, %.preheader260 ], [ %78, %._crit_edge ] ; 2 uses
  %5 = phi ptr [ %.pre400, %.preheader260 ], [ %i.gv, %._crit_edge ] ; 5 uses
  %6 = phi ptr [ %.pre398, %.preheader260 ], [ %5, %._crit_edge ] ; 7 uses
  %i.gm = phi ptr [ %.pre397, %.preheader260 ], [ %i.gt, %._crit_edge ] ; 5 uses
  %i.gn = phi ptr [ %.pre395, %.preheader260 ], [ %i.gm, %._crit_edge ] ; 7 uses
  %i.go = phi ptr [ %.pre394, %.preheader260 ], [ %i.gr, %._crit_edge ] ; 5 uses
  %i.gp = phi ptr [ %.pre, %.preheader260 ], [ %i.go, %._crit_edge ] ; 7 uses
  %indvars.iv324 = phi i64 [ 1, %.preheader260 ], [ %indvars.iv.next325, %._crit_edge ] ; 2 uses
  %7 = phi <2 x double> [ %3, %.preheader260 ], [ %76, %._crit_edge ] ; 4 uses
  %8 = phi <2 x double> [ %4, %.preheader260 ], [ %77, %._crit_edge ] ; 4 uses
  ...
  %.phi.trans.insert405 = getelementptr inbounds nuw i8, ptr %i.gr, i64 8
  %9 = load <2 x double>, ptr %i.gr, align 8, !tbaa !27 ; 4 uses
  %.pre404 = load double, ptr %.phi.trans.insert405, align 8, !tbaa !27
  %.phi.trans.insert411 = getelementptr inbounds nuw i8, ptr %i.gt, i64 8
  %.phi.trans.insert405.a = getelementptr inbounds nuw i8, ptr %i.gv, i64 8
  %10 = load <2 x double>, ptr %i.gt, align 8, !tbaa !27 ; 5 uses
  %.pre406 = load double, ptr %.phi.trans.insert411, align 8, !tbaa !27 ; 2 uses
  %11 = load <2 x double>, ptr %i.gv, align 8, !tbaa !27 ; 5 uses
  %.pre410 = load double, ptr %.phi.trans.insert405.a, align 8, !tbaa !27 ; 2 uses
  %12 = extractelement <2 x double> %10, i64 0    ; 2 uses
  %13 = extractelement <2 x double> %11, i64 0    ; 2 uses
  %14 = shufflevector <2 x double> %9, <2 x double> poison, <4 x i32> <i32 poison, i32 0, i32 poison, i32 1>
  %15 = insertelement <4 x double> %14, double %.pre407, i64 0
  %16 = insertelement <4 x double> %15, double %.pre409, i64 2 ; 2 uses
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %.preheader258
  %scevgep447 = getelementptr nuw i8, ptr %i.go, i64 16
  %scevgep448 = getelementptr i8, ptr %i.go, i64 %i.au
  %scevgep449 = getelementptr i8, ptr %i.gp, i64 %i.au
  %i.gy = insertelement <2 x ptr> poison, ptr %i.gr, i64 0
  %i.gz = insertelement <2 x ptr> %i.gy, ptr %i.gm, i64 1
  %i.ha = getelementptr i8, <2 x ptr> %i.gz, i64 16
  %scevgep451 = getelementptr i8, ptr %i.gr, i64 %i.au
  %scevgep453 = getelementptr i8, ptr %i.gm, i64 %i.au
  %scevgep454 = getelementptr i8, ptr %i.gn, i64 %i.au
  %scevgep455 = getelementptr i8, ptr %i.gt, i64 16
  %scevgep456 = getelementptr i8, ptr %i.gt, i64 %i.au
  %scevgep457 = getelementptr i8, ptr %5, i64 16
  %scevgep458 = getelementptr i8, ptr %5, i64 %i.au
  %scevgep459 = getelementptr i8, ptr %6, i64 %i.au
  ...
  %i.hl = insertelement <8 x ptr> %i.hk, ptr %i.gp, i64 1
...
vector.ph:                                        ; preds = %vector.memcheck
  %17 = shufflevector <2 x double> %11, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %18 = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %19 = shufflevector <2 x double> %7, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %20 = shufflevector <2 x double> %8, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %21 = shufflevector <2 x double> %9, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vector.recur = phi <2 x double> [ %11, %vector.ph ], [ %wide.load528, %vector.body ] ; 2 uses
  %vector.recur494 = phi <2 x double> [ %17, %vector.ph ], [ %i.js, %vector.body ]
  %vector.recur496 = phi <2 x double> [ %7, %vector.ph ], [ %wide.load527, %vector.body ] ; 2 uses
  %vector.recur498 = phi <2 x double> [ %8, %vector.ph ], [ %i.jm, %vector.body ]
  %vector.recur500 = phi <2 x double> [ %10, %vector.ph ], [ %wide.load523, %vector.body ] ; 2 uses
  %vector.recur502 = phi <2 x double> [ %18, %vector.ph ], [ %i.jb, %vector.body ]
  %vector.recur504 = phi <2 x double> [ %19, %vector.ph ], [ %wide.load522, %vector.body ] ; 2 uses
  %vector.recur506 = phi <2 x double> [ %20, %vector.ph ], [ %i.iv, %vector.body ]
  %vector.recur508 = phi <2 x double> [ %9, %vector.ph ], [ %wide.load518, %vector.body ] ; 2 uses
  %vector.recur510 = phi <2 x double> [ %21, %vector.ph ], [ %i.ik, %vector.body ]
  %vector.recur512 = phi <2 x double> [ %vector.recur.init503, %vector.ph ], [ %wide.load517, %vector.body ] ; 2 uses
  %vector.recur514 = phi <2 x double> [ %vector.recur.init505, %vector.ph ], [ %i.ie, %vector.body ]
  %i.hw = or disjoint i64 %index, 1               ; 4 uses
  %i.hx = getelementptr inbounds [8 x i8], ptr %i.gp, i64 %index
  %wide.load = load <2 x double>, ptr %i.hx, align 8, !tbaa !27, !alias.scope !39
  %i.hy = getelementptr inbounds nuw [8 x i8], ptr %i.gp, i64 %i.hw
  ...
  %i.ib = getelementptr inbounds nuw [8 x i8], ptr %i.gp, i64 %i.ia
  %wide.load516 = load <2 x double>, ptr %i.ib, align 8, !tbaa !27, !alias.scope !39
  %i.ic = fadd <2 x double> %i.hz, %wide.load516
  %i.id = getelementptr inbounds nuw [8 x i8], ptr %i.go, i64 %i.ia
  %wide.load517 = load <2 x double>, ptr %i.id, align 8, !tbaa !27, !alias.scope !42 ; 4 uses
  ...
  %wide.load518 = load <2 x double>, ptr %i.ij, align 8, !tbaa !27, !alias.scope !44 ; 4 uses
...
middle.block:                                     ; preds = %vector.body
  ...
  %22 = shufflevector <2 x double> %wide.load522, <2 x double> %wide.load527, <2 x i32> <i32 1, i32 3>
  %23 = shufflevector <2 x double> %wide.load522, <2 x double> %wide.load527, <2 x i32> <i32 0, i32 2>
  %24 = shufflevector <2 x double> %wide.load517, <2 x double> %wide.load518, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  br i1 %cmp.n, label %._crit_edge, label %scalar.ph.preheader

scalar.ph.preheader:                              ; preds = %vector.memcheck, %.preheader258, %middle.block
  %.ph580.a = phi double [ %.pre410, %vector.memcheck ], [ %.pre410, %.preheader258 ], [ %vector.recur.extract, %middle.block ]
  %.ph581.a = phi double [ %13, %vector.memcheck ], [ %13, %.preheader258 ], [ %vector.recur.extract529, %middle.block ]
  %.ph582 = phi double [ %.pre406, %vector.memcheck ], [ %.pre406, %.preheader258 ], [ %vector.recur.extract532, %middle.block ]
  %.ph583 = phi double [ %12, %vector.memcheck ], [ %12, %.preheader258 ], [ %vector.recur.extract533, %middle.block ]
  %indvars.iv.ph = phi i64 [ 1, %vector.memcheck ], [ 1, %.preheader258 ], [ %i.ba, %middle.block ]
  %.ph579 = phi <2 x double> [ %8, %vector.memcheck ], [ %8, %.preheader258 ], [ %23, %middle.block ]
  %.ph580 = phi <2 x double> [ %7, %vector.memcheck ], [ %7, %.preheader258 ], [ %22, %middle.block ]
  %.ph581 = phi <4 x double> [ %16, %vector.memcheck ], [ %16, %.preheader258 ], [ %24, %middle.block ]
  br label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %i.kc = phi double [ %41, %scalar.ph ], [ %.ph580.a, %scalar.ph.preheader ] ; 2 uses
  %i.kd = phi double [ %i.kc, %scalar.ph ], [ %.ph581.a, %scalar.ph.preheader ]
  %i.ke = phi double [ %i.ko, %scalar.ph ], [ %.ph582, %scalar.ph.preheader ] ; 2 uses
  %i.kf = phi double [ %i.ke, %scalar.ph ], [ %.ph583, %scalar.ph.preheader ]
  %indvars.iv = phi i64 [ %i.kg, %scalar.ph ], [ %indvars.iv.ph, %scalar.ph.preheader ] ; 4 uses
  %25 = phi <2 x double> [ %26, %scalar.ph ], [ %.ph579, %scalar.ph.preheader ]
  %26 = phi <2 x double> [ %54, %scalar.ph ], [ %.ph580, %scalar.ph.preheader ] ; 2 uses
  %27 = phi <4 x double> [ %75, %scalar.ph ], [ %.ph581, %scalar.ph.preheader ] ; 2 uses
  %28 = add nsw i64 %indvars.iv, -1               ; 3 uses
  %29 = getelementptr inbounds [8 x i8], ptr %i.gp, i64 %28
  %30 = load double, ptr %29, align 8, !tbaa !27
  %31 = getelementptr inbounds nuw [8 x i8], ptr %i.gp, i64 %indvars.iv
  %i.kg = add nuw nsw i64 %indvars.iv, 1          ; 10 uses
  %i.kh = getelementptr inbounds nuw [8 x i8], ptr %i.go, i64 %i.kg
  %i.ki = load double, ptr %i.kh, align 8, !tbaa !27
  %i.kj = getelementptr inbounds nuw [8 x i8], ptr %i.gr, i64 %i.kg
  %i.kk = load double, ptr %i.kj, align 8, !tbaa !27
  %32 = insertelement <2 x double> poison, double %i.ki, i64 0
  %33 = insertelement <2 x double> %32, double %i.kk, i64 1 ; 2 uses
  %34 = shufflevector <4 x double> %27, <4 x double> poison, <6 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison>
  %35 = shufflevector <2 x double> %33, <2 x double> poison, <6 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison>
  %36 = getelementptr inbounds [8 x i8], ptr %i.gn, i64 %28
  %i.kl = getelementptr inbounds nuw [8 x i8], ptr %i.gn, i64 %i.kg
  %i.km = load double, ptr %i.kl, align 8, !tbaa !27
  %37 = getelementptr inbounds nuw [8 x i8], ptr %i.gm, i64 %i.kg
  %38 = load double, ptr %37, align 8, !tbaa !27
  %i.kn = getelementptr inbounds nuw [8 x i8], ptr %i.gt, i64 %i.kg
  %i.ko = load double, ptr %i.kn, align 8, !tbaa !27 ; 2 uses
  %39 = getelementptr inbounds [8 x i8], ptr %6, i64 %28
  %i.kp = getelementptr inbounds nuw [8 x i8], ptr %6, i64 %i.kg
  %i.kq = load double, ptr %i.kp, align 8, !tbaa !27
  %i.kr = getelementptr inbounds nuw [8 x i8], ptr %5, i64 %i.kg
  %i.ks = load double, ptr %i.kr, align 8, !tbaa !27
  %40 = getelementptr inbounds nuw [8 x i8], ptr %i.gv, i64 %i.kg
  %41 = load double, ptr %40, align 8, !tbaa !27  ; 2 uses
  %42 = load <2 x double>, ptr %31, align 8, !tbaa !27
  %43 = load <2 x double>, ptr %36, align 8, !tbaa !27 ; 2 uses
  %44 = load <2 x double>, ptr %39, align 8, !tbaa !27 ; 2 uses
  %45 = shufflevector <2 x double> %43, <2 x double> %44, <2 x i32> <i32 0, i32 2>
  %46 = shufflevector <2 x double> %43, <2 x double> %44, <2 x i32> <i32 1, i32 3>
  %47 = fadd <2 x double> %45, %46
  %48 = insertelement <2 x double> poison, double %i.km, i64 0
  %49 = insertelement <2 x double> %48, double %i.kq, i64 1
  %50 = fadd <2 x double> %47, %49
  %51 = fadd <2 x double> %50, %25
  %52 = fadd <2 x double> %51, %26
  %53 = insertelement <2 x double> poison, double %38, i64 0
  %54 = insertelement <2 x double> %53, double %i.ks, i64 1 ; 2 uses
  %55 = fadd <2 x double> %52, %54
  %56 = insertelement <2 x double> poison, double %i.kf, i64 0
  %57 = insertelement <2 x double> %56, double %i.kd, i64 1
  %58 = fadd <2 x double> %55, %57
  %59 = insertelement <2 x double> poison, double %i.ke, i64 0
  %60 = insertelement <2 x double> %59, double %i.kc, i64 1
  %61 = fadd <2 x double> %58, %60
  %62 = insertelement <2 x double> poison, double %i.ko, i64 0
  %63 = insertelement <2 x double> %62, double %41, i64 1
  %64 = fadd <2 x double> %61, %63
  %65 = shufflevector <6 x double> %34, <6 x double> %35, <10 x i32> <i32 poison, i32 poison, i32 0, i32 2, i32 6, i32 1, i32 3, i32 7, i32 poison, i32 poison>
  %66 = shufflevector <2 x double> %64, <2 x double> poison, <10 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %67 = shufflevector <10 x double> %65, <10 x double> %66, <10 x i32> <i32 poison, i32 poison, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 10, i32 11>
  %68 = shufflevector <2 x double> %42, <2 x double> poison, <10 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %69 = shufflevector <10 x double> %68, <10 x double> %67, <10 x i32> <i32 0, i32 1, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19>
  %70 = call double @llvm.vector.reduce.fadd.v10f64(double %30, <10 x double> %69)
  %71 = fdiv double %70, 2.700000e+01
  %72 = getelementptr inbounds nuw [8 x i8], ptr %i.gx, i64 %indvars.iv
  store double %71, ptr %72, align 8, !tbaa !27
  %exitcond.not = icmp eq i64 %i.kg, %wide.trip.count
  %73 = shufflevector <4 x double> %27, <4 x double> poison, <4 x i32> <i32 2, i32 3, i32 poison, i32 poison>
  %74 = shufflevector <2 x double> %33, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %75 = shufflevector <4 x double> %73, <4 x double> %74, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  br i1 %exitcond.not, label %._crit_edge, label %scalar.ph, !llvm.loop !62

._crit_edge:                                      ; preds = %scalar.ph, %middle.block
  %exitcond328.not = icmp eq i64 %indvars.iv.next325, %wide.trip.count327
  %76 = shufflevector <2 x double> %10, <2 x double> %11, <2 x i32> <i32 1, i32 3>
  %77 = shufflevector <2 x double> %10, <2 x double> %11, <2 x i32> <i32 0, i32 2>
  %78 = extractelement <2 x double> %9, i64 0
...
.preheader259:                                    ; preds = %.preheader259.lr.ph.split.split, %._crit_edge281.split
  ...
  %i.kt = mul i64 %i.ae, %indvar
  %i.ku = getelementptr inbounds nuw [8 x i8], ptr %i.fy, i64 %indvars.iv345
  %i.kv = load ptr, ptr %i.ku, align 8, !tbaa !23 ; 3 uses
  %i.kw = getelementptr i8, ptr %i.aj, i64 %i.kt  ; 3 uses
...
.preheader257:                                    ; preds = %.preheader259, %.preheader257
  ...
  %i.kx = mul i64 %i.af, %indvar334
  %scevgep336 = getelementptr i8, ptr %i.kw, i64 %i.kx
  %i.ky = getelementptr inbounds nuw [8 x i8], ptr %i.kv, i64 %indvars.iv340
  %i.kz = load ptr, ptr %i.ky, align 8, !tbaa !25
  %scevgep = getelementptr nuw i8, ptr %i.kz, i64 8
  ...
  %i.la = mul i64 %i.af, %indvar.next335
  %scevgep336.1 = getelementptr i8, ptr %i.kw, i64 %i.la
  %i.lb = getelementptr inbounds nuw [8 x i8], ptr %i.kv, i64 %indvars.iv340
  %i.lc = getelementptr inbounds nuw i8, ptr %i.lb, i64 8
  %i.ld = load ptr, ptr %i.lc, align 8, !tbaa !25
  %scevgep.1 = getelementptr nuw i8, ptr %i.ld, i64 8
...
.preheader257.epil.preheader:                     ; preds = %._crit_edge281.split.unr-lcssa, %.preheader259
  ...
  %i.le = mul i64 %i.af, %indvar334.epil.init
  %scevgep336.epil = getelementptr i8, ptr %i.kw, i64 %i.le
  %i.lf = getelementptr inbounds nuw [8 x i8], ptr %i.kv, i64 %indvars.iv340.epil.init
  %i.lg = load ptr, ptr %i.lf, align 8, !tbaa !25
  %scevgep.epil = getelementptr nuw i8, ptr %i.lg, i64 8
