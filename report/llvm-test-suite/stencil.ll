...
.lr.ph:                                           ; preds = %.preheader264
  ...
  %1 = getelementptr i8, ptr %i.l, i64 %i.am
  %i.av = getelementptr i8, ptr %1, i64 8
  %i.aw = getelementptr i8, ptr %i.l, i64 %i.as
  %i.ax = getelementptr i8, ptr %i.aw, i64 %i.at
  %2 = add nsw i64 %wide.trip.count, -1           ; 3 uses
...
.preheader260:                                    ; preds = %.preheader260.lr.ph.split.split, %._crit_edge270.split
  ...
  %scevgep445 = getelementptr i8, ptr %i.av, i64 %i.fx ; 2 uses
  %scevgep446 = getelementptr i8, ptr %i.ax, i64 %i.fx ; 2 uses
