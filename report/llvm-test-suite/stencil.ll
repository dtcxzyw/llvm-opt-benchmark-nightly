...
vector.memcheck:                                  ; preds = %.preheader258
  ...
  %scevgep450 = getelementptr nuw i8, ptr %i.gt, i64 16
  %scevgep451 = getelementptr i8, ptr %i.gt, i64 %i.au
  %scevgep451.a = getelementptr i8, ptr %i.go, i64 16
  ...
  %i.hc = insertelement <8 x ptr> %i.hb, ptr %scevgep451, i64 2
  ...
  %1 = insertelement <8 x ptr> %i.hk, ptr %scevgep450, i64 2
  %2 = insertelement <8 x ptr> %1, ptr %scevgep451.a, i64 3
  %i.hl = insertelement <8 x ptr> %2, ptr %i.gp, i64 4
