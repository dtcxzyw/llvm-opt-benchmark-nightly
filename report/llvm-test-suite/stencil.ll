...
.preheader258:                                    ; preds = %.preheader260, %._crit_edge
  ...
  %.pre404 = load double, ptr %i.gr, align 8, !tbaa !27 ; 4 uses
  %.phi.trans.insert405.a = getelementptr inbounds nuw i8, ptr %i.gr, i64 8
  %.pre406 = load double, ptr %.phi.trans.insert405.a, align 8, !tbaa !27 ; 4 uses
  %.pre410 = load double, ptr %i.gt, align 8, !tbaa !27 ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vector.recur506 = phi <2 x double> [ %vector.recur.init505, %vector.ph ], [ %i.iv, %vector.body ]
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.preheader258, %middle.block
  ...
  %.ph580.a = phi double [ %.pre410, %vector.memcheck ], [ %.pre410, %.preheader258 ], [ %vector.recur.extract533, %middle.block ]
  %.ph581.a = phi double [ %.pre409, %vector.memcheck ], [ %.pre409, %.preheader258 ], [ %vector.recur.extract534, %middle.block ]
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %4 = phi double [ %i.kf, %scalar.ph ], [ %.ph580.a, %scalar.ph.preheader ]
  %5 = phi double [ %28, %scalar.ph ], [ %.ph581.a, %scalar.ph.preheader ] ; 2 uses
  %6 = phi double [ %5, %scalar.ph ], [ %.ph582, %scalar.ph.preheader ]
  %7 = phi double [ %i.ko, %scalar.ph ], [ %.ph583, %scalar.ph.preheader ] ; 2 uses
  %8 = phi double [ %7, %scalar.ph ], [ %.ph584, %scalar.ph.preheader ]
  %9 = phi double [ %i.km, %scalar.ph ], [ %.ph585, %scalar.ph.preheader ] ; 2 uses
  ...
  %i.kg = add nsw i64 %indvars.iv, -1             ; 3 uses
  %i.kh = getelementptr inbounds [8 x i8], ptr %2, i64 %i.kg
  %i.ki = load double, ptr %i.kh, align 8, !tbaa !27
  %i.kj = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv
  %i.kk = load double, ptr %i.kj, align 8, !tbaa !27
  %11 = fadd double %i.ki, %i.kk
  ...
  %16 = fadd double %15, %9
  %i.kl = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv.next
  %i.km = load double, ptr %i.kl, align 8, !tbaa !27 ; 2 uses
  %17 = fadd double %16, %i.km
  %18 = fadd double %17, %8
  %19 = fadd double %18, %7
  %i.kn = getelementptr inbounds nuw [8 x i8], ptr %i.gr, i64 %indvars.iv.next
  %i.ko = load double, ptr %i.kn, align 8, !tbaa !27 ; 2 uses
  %20 = fadd double %19, %i.ko
  %i.kp = getelementptr inbounds [8 x i8], ptr %i.gp, i64 %i.kg
  %i.kq = load double, ptr %i.kp, align 8, !tbaa !27
  %i.kr = getelementptr inbounds nuw [8 x i8], ptr %i.gp, i64 %indvars.iv
  %i.ks = load double, ptr %i.kr, align 8, !tbaa !27
  %21 = fadd double %i.kq, %i.ks
  ...
  %35 = getelementptr inbounds [8 x i8], ptr %i.gn, i64 %i.kg
