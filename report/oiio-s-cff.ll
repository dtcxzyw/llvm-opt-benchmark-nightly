...
184:                                              ; preds = %175, %181
  %.sink584 = phi i64 [ %183, %181 ], [ %180, %175 ] ; [#uses=1 type=i64]
  %spec.select431 = call i64 @llvm.abs.i64(i64 %.sink584, i1 true) ; [#uses=8 type=i64]
...
.lr.ph484:                                        ; preds = %.preheader, %.outer.backedge
  %317 = phi i8 [ %321, %.outer.backedge ], [ %316, %.preheader ] ; [#uses=3 type=i8]
  ...
  %319 = icmp eq i8 %317, %318                    ; [#uses=2 type=i1]
  switch i8 %317, label %.lr.ph484.split.split [
...
323:                                              ; preds = %.lr.ph500, %.lr.ph500
  ...
  %326 = icmp eq i8 %317, %325                    ; [#uses=1 type=i1]
...
355:                                              ; preds = %cff_index_get_sid_string.exit434.thread, %352
  %.sink585 = phi ptr [ %354, %cff_index_get_sid_string.exit434.thread ], [ %327, %352 ] ; [#uses=1 type=ptr]
  %356 = getelementptr inbounds nuw i8, ptr %1, i64 48 ; [#uses=1 type=ptr]
  store ptr %.sink585, ptr %356, align 8, !tbaa !167
...
460:                                              ; preds = %452, %458, %459
  %.sink588 = phi i16 [ 1, %458 ], [ 2, %459 ], [ 0, %452 ] ; [#uses=1 type=i16]
  %.sink587 = phi i32 [ 1094992453, %458 ], [ 1094992451, %459 ], [ 1094995778, %452 ] ; [#uses=1 type=i32]
  store i16 %.sink588, ptr %456, align 2, !tbaa !176
  store i32 %.sink587, ptr %457, align 8, !tbaa !179
...
begin_hunk_5
  ...
  %218 = or disjoint i16 %214, %217               ; [#uses=2 type=i16]
  %219 = sext i16 %218 to i64                     ; [#uses=1 type=i64]
  %220 = icmp eq i16 %218, -32768                 ; [#uses=1 type=i1]
...
begin_hunk_6
  ...
  %op.rdx = select i1 %20, i1 true, i1 %or.cond.1 ; [#uses=1 type=i1]
...
begin_hunk_7
  ...
  %.180 = select i1 %54, i32 %56, i32 %.079       ; [#uses=2 type=i32]
...
.lr.ph:                                           ; preds = %51
  ...
  %60 = zext nneg i32 %.180 to i64                ; [#uses=1 type=i64]
...
vector.ph:                                        ; preds = %.lr.ph
  %n.vec = and i64 %63, 4294967280                ; [#uses=5 type=i64]
  %64 = add nuw nsw i64 %n.vec, %59               ; [#uses=2 type=i64]
  %65 = trunc nuw i64 %n.vec to i32               ; [#uses=1 type=i32]
...
begin_hunk_9
  ...
  %73 = icmp samesign ult i32 %.078116, %.180     ; [#uses=1 type=i1]
