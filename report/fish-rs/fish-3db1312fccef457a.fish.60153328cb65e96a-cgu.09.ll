...
.lr.ph.split.us:                                  ; preds = %.lr.ph.preheader.i
  ...
  %i.aa = load i32, ptr %i.z, align 4, !range !23, !alias.scope !3345, !noundef !4
...
.lr.ph.i.us:                                      ; preds = %.lr.ph.split.us, %.lr.ph46
  ...
  %i.ai = load i32, ptr %i.ah, align 4, !range !23, !alias.scope !3345, !noundef !4
...
bb.h:                                             ; preds = %bb.g
  ...
  br i1 %.not40.i, label %.lr.ph36.split.i, label %._crit_edge37.i, !prof !3346
...
.lr.ph.i.i.i:                                     ; preds = %bb.l, %bb.o
  ...
  %i.au = load i32, ptr %i.at, align 4, !range !23, !alias.scope !3347, !noundef !4
...
bb.m:                                             ; preds = %.lr.ph.i.i.i
  ...
  %i.aw = load i32, ptr %i.av, align 4, !range !23, !alias.scope !3347, !noundef !4
...
.lr.ph.i.i.i7:                                    ; preds = %.preheader.i.i.i, %bb.r
  ...
  %i.bj = load i32, ptr %i.bi, align 4, !range !23, !alias.scope !3348, !noundef !4 ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph, %bb.e
  ...
  %i.m = load i32, ptr %i.l, align 8, !range !23, !noundef !4 ; 2 uses
  %i.n = getelementptr inbounds nuw [24 x i8], ptr %i.j, i64 %.sroa.0.077 ; 3 uses
  %i.o = getelementptr inbounds nuw i8, ptr %i.n, i64 16
  %i.p = load i32, ptr %i.o, align 8, !range !23, !noundef !4
...
bb.g:                                             ; preds = %bb.f
  %i.ab = load i32, ptr %i.q, align 8, !range !23, !noundef !4
...
.lr.ph79:                                         ; preds = %bb.h, %bb.p
  ...
  %i.ai = load ptr, ptr %.sroa.019.0, align 8, !nonnull !4, !align !13, !noundef !4 ; 2 uses
...
bb.i:                                             ; preds = %.lr.ph79
  ...
  %i.aq = load i32, ptr %i.ap, align 8, !range !23, !noundef !4
...
bb.k:                                             ; preds = %bb.i
  %i.aw = load ptr, ptr %.sroa.019.0, align 8, !nonnull !4, !align !13, !noundef !4 ; 2 uses
  %i.ax = getelementptr inbounds nuw i8, ptr %i.aw, i64 16
  %i.ay = load i64, ptr %i.ax, align 8, !noundef !4 ; 2 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.be = load i32, ptr %i.bd, align 8, !range !23, !noundef !4
...
._crit_edge:                                      ; preds = %bb.p, %bb.h
  %i.bk = load ptr, ptr %.sroa.019.0, align 8, !nonnull !4, !align !13, !noundef !4 ; 2 uses
...
bb.n:                                             ; preds = %._crit_edge
  ...
  %i.br = load i32, ptr %i.bq, align 8, !range !23, !noundef !4
...
bb.a:
  ...
  %i.i = load i64, ptr %i.g, align 8, !range !20, !noundef !4
...
bb.b:                                             ; preds = %bb.a
  ...
  %.pre = load i32, ptr %.phi.trans.insert, align 8, !range !28 ; 2 uses
