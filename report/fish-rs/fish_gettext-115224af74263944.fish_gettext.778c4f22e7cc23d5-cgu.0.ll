...
bb.e:                                             ; preds = %_RNCINvNtNtNtCs3oUPovFnLWP_4core4iter8adapters3map8map_foldTRNtCslSwhfOFuxKz_17fish_localization8LanguageRRINtNtCs5HGUHib7p01_3phf3map3MapReB2b_EENtCsaglNHct1YhZ_12fish_gettext27GettextLocalizationLanguageuNCNCNvB2l_19AVAILABLE_LANGUAGES00NCIB2_B2j_TB2j_uEuNCINvXs8_NtCskt5MLIAl8nl_9hashbrown3setINtB4f_7HashSetB2j_NtNtNtCsaL1QbXo9JQH_3std4hash6random11RandomStateEINtNtNtB8_6traits7collect6ExtendB2j_E6extendINtB4_3MapINtB1J_7EntriesBW_B1F_EB3h_EE0NCINvNvNtNtB5V_8iterator8Iterator8for_each4callB3Y_NCINvXs1i_NtB4h_3mapINtB8b_7HashMapB2j_uB52_EIB5R_B3Y_E6extendIB6z_B6y_B46_EE0E0E0E0B2l_.exit.i.i.i.i, %.lr.ph.i.i.i.i
  ...
  %.val4.i.i.i.i = load ptr, ptr %.sroa.0.011.i.i.i.i, align 8, !noalias !52, !nonnull !4, !noundef !4 ; 3 uses
  %i.r = getelementptr i8, ptr %.sroa.0.011.i.i.i.i, i64 8
  %.val5.i.i.i.i = load i64, ptr %i.r, align 8, !noalias !52, !noundef !4 ; 4 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !53)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !54
  store ptr %.val4.i.i.i.i, ptr %i.a, align 8, !noalias !55
  store i64 %.val5.i.i.i.i, ptr %i.n, align 8, !noalias !55
  ...
  call void @_RINvMs6_NtCskt5MLIAl8nl_9hashbrown3rawINtB6_8RawTableTNtCsaglNHct1YhZ_12fish_gettext27GettextLocalizationLanguageuEE7reserveNCINvNtB8_3map11make_hasherBQ_uNtNtNtCsaL1QbXo9JQH_3std4hash6random11RandomStateE0EBS_(ptr noalias nofree noundef nonnull align 8 dereferenceable(48) %0, i64 noundef 1, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %i.l), !noalias !56
  %.val.i.i.i.i.i.i.i.i.i.i = load ptr, ptr %0, align 8, !alias.scope !57, !noalias !58, !nonnull !4, !noundef !4 ; 8 uses
  %.val5.i.i.i.i.i.i.i.i.i.i = load i64, ptr %i.o, align 8, !alias.scope !57, !noalias !58, !noundef !4 ; 4 uses
  %i.t = lshr i64 %i.s, 57
...
bb.f:                                             ; preds = %bb.h, %bb.e
  ...
  %.sroa.0.0.copyload.i32.i.i.i.i.i.i.i.i.i.i.i = load <16 x i8>, ptr %i.y, align 1, !noalias !59 ; 3 uses
...
bb.i:                                             ; preds = %.thread.i.i.i.i.i.i.i.i.i.i.i
  ...
  %i.az = load i8, ptr %i.ay, align 1, !noalias !56, !noundef !4 ; 2 uses
  %i.ba = icmp sgt i8 %i.az, -1
  br i1 %i.ba, label %bb.j, label %bb.k, !prof !8

bb.j:                                             ; preds = %bb.i
  %.val62.i.i.i.i.i.i.i.i.i.i.i.i = load <16 x i8>, ptr %.val.i.i.i.i.i.i.i.i.i.i, align 16, !noalias !56
  ...
  %.pre.i.i.i.i.i.i.i.i.i = load i8, ptr %.phi.trans.insert.i.i.i.i.i.i.i.i.i, align 1, !noalias !64
  br label %bb.k
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  store i8 %i.u, ptr %i.bg, align 1, !noalias !64
  %i.bl = getelementptr i8, ptr %.val.i.i.i.i.i.i.i.i.i.i, i64 %i.bk
  %i.bm = getelementptr i8, ptr %i.bl, i64 16
  store i8 %i.u, ptr %i.bm, align 1, !noalias !64
  %i.bn = load <2 x i64>, ptr %i.p, align 8, !alias.scope !66, !noalias !67
  %i.bo = insertelement <2 x i64> <i64 poison, i64 -1>, i64 %i.bi, i64 0
  %i.bp = sub <2 x i64> %i.bn, %i.bo
  store <2 x i64> %i.bp, ptr %i.p, align 8, !alias.scope !66, !noalias !67
  ...
  store ptr %.val4.i.i.i.i, ptr %i.bs, align 8, !noalias !64
  %i.bt = getelementptr inbounds i8, ptr %i.br, i64 -8
  store i64 %.val5.i.i.i.i, ptr %i.bt, align 8, !noalias !65
...
bb.a:
  ...
  %i.e = load i64, ptr %i.d, align 8, !alias.scope !86, !noalias !87, !noundef !4 ; 2 uses
  %i.f = add i64 %i.e, %i.c                       ; 2 uses
  %i.g = icmp ult i64 %i.f, %i.e
  br i1 %i.g, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.a
  store i64 %i.f, ptr %i.d, align 8, !alias.scope !86, !noalias !87
  %i.h = getelementptr inbounds nuw i8, ptr %1, i64 64 ; 3 uses
  %i.i = load i64, ptr %i.h, align 8, !alias.scope !86, !noalias !87, !noundef !4 ; 6 uses
  %i.j = icmp eq i64 %i.i, 0
  br i1 %i.j, label %bb.e, label %bb.d

bb.c:                                             ; preds = %bb.a
  tail call void @_RNvNtNtCs3oUPovFnLWP_4core9panicking11panic_const24panic_const_add_overflow(ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @23) #20, !noalias !88
  unreachable
...
.lr.ph.i.i:                                       ; preds = %bb.e
  %.promoted.i.i = load i64, ptr %1, align 8, !alias.scope !86, !noalias !87
  ...
  %.promoted23.i.i = load i64, ptr %i.q, align 8, !alias.scope !86, !noalias !87
  %.promoted24.i.i = load i64, ptr %i.r, align 8, !alias.scope !89, !noalias !87
  %.promoted26.i.i = load i64, ptr %i.s, align 8, !alias.scope !89, !noalias !87
  br label %bb.ab
...
bb.g:                                             ; preds = %bb.f
  %.sroa.014.0.copyload.i.i.i = load i32, ptr %i.a, align 1, !alias.scope !90, !noalias !86
...
bb.i:                                             ; preds = %bb.h
  ...
  %.sroa.015.0.copyload.i.i.i = load i16, ptr %i.x, align 1, !alias.scope !90, !noalias !86
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.af = load i8, ptr %i.ae, align 1, !alias.scope !90, !noalias !86, !noundef !4
...
bb.l:                                             ; preds = %bb.d
  tail call void @_RNvNtNtCs3oUPovFnLWP_4core9panicking11panic_const24panic_const_sub_overflow(ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @24) #20, !noalias !88
  unreachable
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.an = load i64, ptr %i.am, align 8, !alias.scope !86, !noalias !87, !noundef !4
  %i.ao = or i64 %i.an, %i.al                     ; 3 uses
  store i64 %i.ao, ptr %i.am, align 8, !alias.scope !86, !noalias !87
  %i.ap = icmp ult i64 %i.c, %i.k
  br i1 %i.ap, label %bb.q, label %bb.p

bb.o:                                             ; preds = %bb.m
  tail call void @_RNvNtNtCs3oUPovFnLWP_4core9panicking11panic_const24panic_const_shl_overflow(ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @25) #20, !noalias !88
  unreachable

bb.p:                                             ; preds = %bb.n
  %i.aq = getelementptr inbounds nuw i8, ptr %1, i64 24 ; 2 uses
  %i.ar = load i64, ptr %i.aq, align 8, !alias.scope !86, !noalias !87, !noundef !4
  %i.as = xor i64 %i.ar, %i.ao                    ; 3 uses
  %i.at = load i64, ptr %1, align 8, !alias.scope !91, !noalias !87, !noundef !4
  %i.au = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 2 uses
  %i.av = load i64, ptr %i.au, align 8, !alias.scope !91, !noalias !87, !noundef !4 ; 3 uses
  ...
  %i.bb = load i64, ptr %i.ba, align 8, !alias.scope !91, !noalias !87, !noundef !4
  ...
  store i64 %i.bh, ptr %i.aq, align 8, !alias.scope !91, !noalias !87
  %i.bi = add i64 %i.bc, %i.ay                    ; 3 uses
  %i.bj = tail call noundef i64 @llvm.fshl.i64(i64 %i.ay, i64 %i.ay, i64 17)
  %i.bk = xor i64 %i.bi, %i.bj
  store i64 %i.bk, ptr %i.au, align 8, !alias.scope !91, !noalias !87
  %i.bl = tail call noundef i64 @llvm.fshl.i64(i64 %i.bi, i64 %i.bi, i64 32)
  store i64 %i.bl, ptr %i.ba, align 8, !alias.scope !91, !noalias !87
  %i.bm = xor i64 %i.bf, %i.ao
  store i64 %i.bm, ptr %1, align 8, !alias.scope !86, !noalias !87
  store i64 0, ptr %i.h, align 8, !alias.scope !86, !noalias !87
  br label %bb.e
...
._crit_edge.i.i:                                  ; preds = %bb.ab
  store i64 %i.db, ptr %i.q, align 8, !alias.scope !86, !noalias !87
  store i64 %i.de, ptr %i.r, align 8, !alias.scope !89, !noalias !87
  store i64 %i.df, ptr %i.s, align 8, !alias.scope !89, !noalias !87
  store i64 %i.dg, ptr %1, align 8, !alias.scope !86, !noalias !87
  br label %bb.r
...
bb.s:                                             ; preds = %bb.r
  ...
  %.sroa.014.0.copyload.i20.i.i = load i32, ptr %i.bp, align 1, !alias.scope !93, !noalias !86
...
bb.w:                                             ; preds = %bb.u
  ...
  %.sroa.015.0.copyload.i19.i.i = load i16, ptr %i.bw, align 1, !alias.scope !93, !noalias !86
...
bb.x:                                             ; preds = %bb.u
  tail call void @_RNvNtNtCs3oUPovFnLWP_4core9panicking11panic_const24panic_const_add_overflow(ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @19) #20, !noalias !94
  unreachable
...
bb.z:                                             ; preds = %bb.y
  ...
  %i.cg = load i8, ptr %i.cf, align 1, !alias.scope !93, !noalias !86, !noundef !4
...
bb.aa:                                            ; preds = %bb.y
  tail call void @_RNvNtNtCs3oUPovFnLWP_4core9panicking11panic_const24panic_const_add_overflow(ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @20) #20, !noalias !94
  unreachable
...
_RNvNtCs4gXUGq9oE06_9siphasher6common9u8to64_le.exit21.i.i: ; preds = %bb.z, %bb.v
  ...
  store i64 %.sroa.0.2.i18.i.i, ptr %i.cl, align 8, !alias.scope !86, !noalias !87
  br label %_RNvXsb_NtCs4gXUGq9oE06_9siphasher6sip128NtB5_11SipHasher13NtNtCs3oUPovFnLWP_4core4hash6Hasher5write.exit
...
bb.ab:                                            ; preds = %bb.ab, %.lr.ph.i.i
  ...
  %.sroa.07.0.copyload.i.i = load i64, ptr %i.cq, align 1, !alias.scope !87, !noalias !86 ; 2 uses
...
_RNvXsb_NtCs4gXUGq9oE06_9siphasher6sip128NtB5_11SipHasher13NtNtCs3oUPovFnLWP_4core4hash6Hasher5write.exit: ; preds = %bb.q, %_RNvNtCs4gXUGq9oE06_9siphasher6common9u8to64_le.exit21.i.i
  ...
  store i64 %storemerge.i.i, ptr %i.h, align 8, !alias.scope !86, !noalias !87
  ret void
}
...
bb.a:
  ...
  store <2 x i64> %i.e, ptr %i.b, align 16, !alias.scope !111
  ...
  store <2 x i64> %i.g, ptr %.sroa.59.0..sroa_idx.i, align 16, !alias.scope !111
  store <2 x i64> %i.c, ptr %.sroa.711.0..sroa_idx.i, align 16, !alias.scope !111
  %.sroa.913.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.b, i64 48 ; 2 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(24) %.sroa.913.0..sroa_idx.i, i8 0, i64 24, i1 false), !alias.scope !111
  %.val.i = load ptr, ptr %1, align 8, !noalias !112, !nonnull !4, !noundef !4
  %i.h = getelementptr inbounds nuw i8, ptr %1, i64 8
  %.val1.i = load i64, ptr %i.h, align 8, !noalias !112, !noundef !4
  ...
  store i8 -1, ptr %i.a, align 1, !noalias !113
  call fastcc void @_RNvXs3_NtNtCs3oUPovFnLWP_4core4hash3sipINtB5_6HasherNtB5_11Sip13RoundsENtB7_6Hasher5writeCsaglNHct1YhZ_12fish_gettext(ptr noalias nofree noundef nonnull align 8 dereferenceable(72) %i.b, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.a, i64 noundef 1) #21, !noalias !114
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !113
  %.sroa.0.0.copyload.i.i = load i64, ptr %i.b, align 16, !alias.scope !115
  %.sroa.10.0.copyload.i.i = load i64, ptr %.sroa.48.0..sroa_idx.i, align 8, !alias.scope !115
  %.sroa.17.0.copyload.i.i = load i64, ptr %.sroa.59.0..sroa_idx.i, align 16, !alias.scope !115 ; 3 uses
  %.sroa.22.0.copyload.i.i = load i64, ptr %.sroa.610.0..sroa_idx.i, align 8, !alias.scope !115
  %i.i = load i64, ptr %.sroa.913.0..sroa_idx.i, align 16, !alias.scope !115, !noundef !4
  %i.j = shl i64 %i.i, 56
  %i.k = getelementptr inbounds nuw i8, ptr %i.b, i64 56
  %i.l = load i64, ptr %i.k, align 8, !alias.scope !115, !noundef !4
