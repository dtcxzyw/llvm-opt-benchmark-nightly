...
begin_hunk_0_@_RNvMs_NtCs8frGy5WneL6_4fish5pagerNtB4_5Pager22rendering_needs_update:bb.a
  %i.av = load i8, ptr %i.au, align 8, !range !1936, !noundef !5
  %i.aw = getelementptr inbounds nuw i8, ptr %0, i64 273
  %i.ax = load i8, ptr %i.aw, align 1, !range !1936, !noundef !5
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.bp = load i8, ptr %i.bo, align 8, !range !1936, !noundef !5
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not, label %bb.c, label %._crit_edge, !prof !82
...
bb.b:                                             ; preds = %bb.a
  %i.e = load i64, ptr %0, align 8, !range !1852, !noundef !5
...
bb.h:                                             ; preds = %bb.c, %bb.c, %bb.c, %bb.c, %bb.c, %bb.c
  ...
  %i.t = load i64, ptr %i.s, align 8, !range !1852
...
bb.i:                                             ; preds = %bb.h, %bb.j
  ...
  %i.w = load i64, ptr %i.v, align 8, !range !1852, !noundef !5
  %i.x = trunc nuw i64 %i.w to i1
  br i1 %i.x, label %bb.k, label %bb.l, !prof !98
...
_RNvXs2_NtNtNtCs3oUPovFnLWP_4core4iter7sources8repeat_nINtB5_7RepeatNcENtNtNtB9_6traits8iterator8Iterator4nextCs8frGy5WneL6_4fish.exit.i60.i.i: ; preds = %.peel.next.i56.i.i
  %i.kf = invoke { i64, i64 } @_RNvNtCs8frGy5WneL6_4fish6screen16wcwidth_rendered(i32 noundef %.sroa.7.0.i57.i.i)
          to label %.noexc76.i.i unwind label %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.i.loopexit.split-lp.loopexit.i.i, !noalias !2866 ; 2 uses
...
.noexc76.i.i:                                     ; preds = %_RNvXs2_NtNtNtCs3oUPovFnLWP_4core4iter7sources8repeat_nINtB5_7RepeatNcENtNtNtB9_6traits8iterator8Iterator4nextCs8frGy5WneL6_4fish.exit.i60.i.i
  ...
  br i1 %i.ki, label %.loopexit.i64.i.i, label %.peel.next.i56.i.i, !llvm.loop !2867
...
_RINvMNtCs3oUPovFnLWP_4core6optionINtB3_6OptionIBw_cEE18get_or_insert_withNCNvMs3_NtNtNtB5_4iter8adapters8peekableINtB1h_8PeekableINtNtNtB1l_7sources8repeat_n7RepeatNcEE4peek0ECs8frGy5WneL6_4fish.exit.i72.i.i: ; preds = %bb.az
  invoke void @_RNvMNtCs8frGy5WneL6_4fish6screenNtB2_4Line6append(ptr noalias nofree noundef nonnull align 8 dereferenceable(40) %i.j, i32 noundef %.sroa.7.0.lcssa59.i69.i.i, i32 noundef %.sroa.6130.0.insert.shift.i.i, i64 noundef 3, i64 range(i64 0, 64051194700380387) %i.gx)
          to label %.noexc77.i.i unwind label %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.i.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.i.i, !noalias !2866
...
bb.ba:                                            ; preds = %bb.az
  invoke void @_RNvMNtCs8frGy5WneL6_4fish6screenNtB2_4Line6append(ptr noalias nofree noundef nonnull align 8 dereferenceable(40) %i.j, i32 noundef 8230, i32 noundef %.sroa.6130.0.insert.shift.i.i, i64 noundef 3, i64 range(i64 0, 64051194700380387) %i.gx)
          to label %.noexc78.i.i unwind label %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.i.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.i.i, !noalias !2866

.noexc78.i.i:                                     ; preds = %bb.ba
  %i.kn = invoke { i64, i64 } @_RNvNtCs8frGy5WneL6_4fish6screen16wcwidth_rendered(i32 noundef 8230)
          to label %.noexc79.i.i unwind label %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.i.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.i.i, !noalias !2866 ; 2 uses

.noexc79.i.i:                                     ; preds = %.noexc78.i.i
  %i.ko = extractvalue { i64, i64 } %i.kn, 0
  %i.kp = trunc nuw i64 %i.ko to i1
  br i1 %i.kp, label %bb.bb, label %.invoke290.i.invoke.i.i, !prof !98
...
_RNvXs2_NtNtNtCs3oUPovFnLWP_4core4iter7sources8repeat_nINtB5_7RepeatNcENtNtNtB9_6traits8iterator8Iterator4nextCs8frGy5WneL6_4fish.exit.thread.i73.i.i: ; preds = %.outer.i44.i.i, %.loopexit.i64.i.i, %.peel.next.i56.i.i, %bb.bb
  ...
  br i1 %i.ku, label %.invoke290.i.invoke.i.i, label %_RNvXs2_NtNtNtCs3oUPovFnLWP_4core4iter7sources8repeat_nINtB5_7RepeatNcENtNtNtB9_6traits8iterator8Iterator4nextCs8frGy5WneL6_4fish.exit.thread.i73.thread.i.i, !prof !2869
...
_RNvXs2_NtNtNtCs3oUPovFnLWP_4core4iter7sources8repeat_nINtB5_7RepeatNcENtNtNtB9_6traits8iterator8Iterator4nextCs8frGy5WneL6_4fish.exit.thread.i73.thread.i.i: ; preds = %_RNvXs2_NtNtNtCs3oUPovFnLWP_4core4iter7sources8repeat_nINtB5_7RepeatNcENtNtNtB9_6traits8iterator8Iterator4nextCs8frGy5WneL6_4fish.exit.thread.i73.i.i, %bb.ay
  ...
  br i1 %i.kv, label %bb.bc, label %.invoke286.i.i.i, !prof !98
...
bb.bc:                                            ; preds = %_RNvXs2_NtNtNtCs3oUPovFnLWP_4core4iter7sources8repeat_nINtB5_7RepeatNcENtNtNtB9_6traits8iterator8Iterator4nextCs8frGy5WneL6_4fish.exit.thread.i73.thread.i.i
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.g), !noalias !2860
  store i8 0, ptr %i.g, align 1, !noalias !2860
  store i8 0, ptr %.sroa.573.0..sroa_idx.i.i.i, align 1, !noalias !2860
  store i8 %.124.i.i.i, ptr %.sroa.676.0..sroa_idx.i.i.i, align 1, !noalias !2860
  store i8 %.spec.select.i.i.i.i, ptr %.sroa.7.0..sroa_idx.i.i.i, align 1, !noalias !2860
...
bb.be:                                            ; preds = %bb.bd
  ...
  %i.la = load ptr, ptr %i.kz, align 8, !alias.scope !2863, !noalias !2864, !nonnull !5, !noundef !5 ; 2 uses
  %i.lb = getelementptr inbounds nuw i8, ptr %i.gz, i64 40
  %i.lc = load i64, ptr %i.lb, align 8, !alias.scope !2863, !noalias !2864, !noundef !5
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f), !noalias !2860
  store i8 0, ptr %i.f, align 1, !noalias !2860
  store i8 0, ptr %.sroa.440.0..sroa_idx.i.i.i, align 1, !noalias !2860
  store i8 %.spec.select.i140.i.i.i, ptr %.sroa.541.0..sroa_idx.i.i.i, align 1, !noalias !2860
  store i8 %.spec.select.i.i.i.i, ptr %.sroa.642.0..sroa_idx.i.i.i, align 1, !noalias !2860
...
bb.bf:                                            ; preds = %bb.be
  ...
  %i.lg = invoke fastcc noundef i64 @_RINvNtCs8frGy5WneL6_4fish5pager14print_max_implNtNtNtCslLGyqsphxMB_10widestring6utfstr4iter10CharsUtf32NCINvB2_9print_maxBJ_E0EB4_(i64 noundef 3, i64 range(i64 0, 64051194700380387) %i.gx, ptr noundef nonnull %i.la, ptr noundef nonnull %i.lf, ptr noalias nofree noundef readonly captures(address, read_provenance) dereferenceable(4) %i.f, i64 noundef %i.le, i1 noundef zeroext false, ptr noalias nofree noundef align 8 dereferenceable(40) %i.j)
          to label %bb.bg unwind label %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.i.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.i.i, !noalias !2865 ; 2 uses
...
bb.bh:                                            ; preds = %bb.bg
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e), !noalias !2860
  store i8 0, ptr %i.e, align 1, !noalias !2860
  store i8 0, ptr %.sroa.573.0..sroa_idx74.i.i.i, align 1, !noalias !2860
  store i8 %.124.i.i.i, ptr %.sroa.676.0..sroa_idx77.i.i.i, align 1, !noalias !2860
  store i8 %.spec.select.i.i.i.i, ptr %.sroa.7.0..sroa_idx79.i.i.i, align 1, !noalias !2860
...
bb.bi:                                            ; preds = %bb.bh
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e), !noalias !2860
...
_RNvXs2_NtNtNtCs3oUPovFnLWP_4core4iter7sources8repeat_nINtB5_7RepeatNcENtNtNtB9_6traits8iterator8Iterator4nextCs8frGy5WneL6_4fish.exit.peel.i.i.i: ; preds = %bb.bj, %.outer.i.i.i
  ...
  %i.lm = invoke { i64, i64 } @_RNvNtCs8frGy5WneL6_4fish6screen16wcwidth_rendered(i32 noundef %.sroa.7.0.ph.i296.i.i)
          to label %.noexc35.i.i unwind label %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.i.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.i.i, !noalias !2866 ; 2 uses
...
_RNvXs2_NtNtNtCs3oUPovFnLWP_4core4iter7sources8repeat_nINtB5_7RepeatNcENtNtNtB9_6traits8iterator8Iterator4nextCs8frGy5WneL6_4fish.exit.i.i.i: ; preds = %.peel.next.i.i.i
  %i.lq = invoke { i64, i64 } @_RNvNtCs8frGy5WneL6_4fish6screen16wcwidth_rendered(i32 noundef %.sroa.7.0.i31.i.i)
          to label %.noexc36.i.i unwind label %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.i.loopexit.i.i, !noalias !2866 ; 2 uses
...
.noexc36.i.i:                                     ; preds = %_RNvXs2_NtNtNtCs3oUPovFnLWP_4core4iter7sources8repeat_nINtB5_7RepeatNcENtNtNtB9_6traits8iterator8Iterator4nextCs8frGy5WneL6_4fish.exit.i.i.i
  ...
  br i1 %i.lt, label %.loopexit.i33.i.i, label %.peel.next.i.i.i, !llvm.loop !2867
...
_RINvMNtCs3oUPovFnLWP_4core6optionINtB3_6OptionIBw_cEE18get_or_insert_withNCNvMs3_NtNtNtB5_4iter8adapters8peekableINtB1h_8PeekableINtNtNtB1l_7sources8repeat_n7RepeatNcEE4peek0ECs8frGy5WneL6_4fish.exit.i.i.i: ; preds = %bb.bk
  invoke void @_RNvMNtCs8frGy5WneL6_4fish6screenNtB2_4Line6append(ptr noalias nofree noundef nonnull align 8 dereferenceable(40) %i.j, i32 noundef %.sroa.7.0.lcssa59.i.i.i, i32 noundef %.sroa.6130.0.insert.shift.i.i, i64 noundef 3, i64 range(i64 0, 64051194700380387) %i.gx)
          to label %.noexc37.i.i unwind label %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.i.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.i.i, !noalias !2866
...
bb.gp:                                            ; preds = %bb.go
  ...
  %i.ze = load i64, ptr %i.zd, align 8, !alias.scope !2827, !noalias !2991, !noundef !5 ; 3 uses
...
.outer.1.i:                                       ; preds = %bb.gp
  ...
  %i.zj = load i64, ptr %i.zi, align 8, !alias.scope !2827, !noalias !2991, !noundef !5
...
bb.gu:                                            ; preds = %bb.gt
  ...
  %i.zy = load i64, ptr %i.zx, align 8, !alias.scope !2827, !noalias !2991, !noundef !5 ; 3 uses
...
.outer.2.i:                                       ; preds = %bb.gu
  ...
  %i.aad = load i64, ptr %i.aac, align 8, !alias.scope !2827, !noalias !2991, !noundef !5
...
bb.gz:                                            ; preds = %bb.gy
  ...
  %i.aaq = load i64, ptr %i.aap, align 8, !alias.scope !2827, !noalias !2991, !noundef !5 ; 3 uses
...
.outer.3.i:                                       ; preds = %bb.gz
  ...
  %i.aav = load i64, ptr %i.aau, align 8, !alias.scope !2827, !noalias !2991, !noundef !5
...
bb.he:                                            ; preds = %bb.hd
  ...
  %i.abh = load i64, ptr %i.abg, align 8, !alias.scope !2827, !noalias !2991, !noundef !5 ; 3 uses
...
.outer.4.i:                                       ; preds = %bb.he
  ...
  %i.abm = load i64, ptr %i.abl, align 8, !alias.scope !2827, !noalias !2991, !noundef !5
...
bb.hj:                                            ; preds = %bb.hi
  ...
  %i.abz = load i64, ptr %i.aby, align 8, !alias.scope !2827, !noalias !2991, !noundef !5 ; 3 uses
...
.outer.5.i:                                       ; preds = %bb.hj
  ...
  %i.ace = load i64, ptr %i.acd, align 8, !alias.scope !2827, !noalias !2991, !noundef !5
...
bb.hm:                                            ; preds = %bb.hl
  ...
  %i.acl = load i64, ptr %i.ack, align 8, !alias.scope !2827, !noalias !2991, !noundef !5 ; 3 uses
...
.outer.i:                                         ; preds = %bb.hm
  ...
  %i.acq = load i64, ptr %i.acp, align 8, !alias.scope !2827, !noalias !2991, !noundef !5
...
_RNvMs_NtCs8frGy5WneL6_4fish5pagerNtB4_5Pager20completion_try_print.exit: ; preds = %bb.x, %.noexc73
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ag), !noalias !2835
