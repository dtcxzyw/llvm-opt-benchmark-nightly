...
_RNCNvXsc_NtCs8frGy5WneL6_4fish9tokenizerNtB7_11PipeOrRedirINtNtCs3oUPovFnLWP_4core7convert7TryFromRNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrE8try_froms0_0B9_.exit: ; preds = %bb.f
  ...
  %spec.select = select i1 %.not22, i64 %i.af, i64 %i.ad ; 6 uses
  ...
  br i1 %i.ah, label %bb.r, label %bb.q
...
bb.x:                                             ; preds = %bb.t, %bb.w
  %.sroa.04.0 = phi i32 [ %i.bf, %bb.w ], [ 1, %bb.t ]
  ...
  %i.bh = icmp eq i32 %i.bg, 63                   ; 2 uses
  %3 = zext i1 %i.bh to i64
  %spec.select80 = add nuw i64 %spec.select, %3
  %spec.select81 = select i1 %i.bh, i8 5, i8 %spec.select78
  br label %bb.aw
...
bb.aw:                                            ; preds = %bb.x, %bb.p, %bb.aj, %bb.as, %bb.au, %bb.r, %bb.s, %bb.u, %bb.v, %bb.ac, %bb.ag
  %.sroa.0.0 = phi i64 [ %.sroa.0.3, %bb.as ], [ %spec.select70, %bb.p ], [ %i.bb, %bb.r ], [ %i.bb, %bb.s ], [ %i.bd, %bb.u ], [ %i.bd, %bb.v ], [ %i.cd, %bb.au ], [ %spec.select80, %bb.x ], [ %.sroa.0.2, %bb.ac ], [ %.sroa.0.2, %bb.ag ], [ %i.bs, %bb.aj ]
  ...
  %.sroa.4.0 = phi i32 [ 1, %bb.as ], [ 1, %bb.p ], [ 1, %bb.r ], [ %i.bc, %bb.s ], [ 1, %bb.u ], [ %i.be, %bb.v ], [ 1, %bb.au ], [ %.sroa.04.0, %bb.x ], [ 0, %bb.ac ], [ %i.bo, %bb.ag ], [ 1, %bb.aj ]
