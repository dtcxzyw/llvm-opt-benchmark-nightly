...
_RNCNvXsc_NtCs8frGy5WneL6_4fish9tokenizerNtB7_11PipeOrRedirINtNtCs3oUPovFnLWP_4core7convert7TryFromRNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrE8try_froms0_0B9_.exit32: ; preds = %bb.j
  ...
  br i1 %i.ao, label %bb.ao, label %bb.ap
...
8:                                                ; preds = %_RNCNvXsc_NtCs8frGy5WneL6_4fish9tokenizerNtB7_11PipeOrRedirINtNtCs3oUPovFnLWP_4core7convert7TryFromRNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrE8try_froms0_0B9_.exit, %5
  ...
  br i1 %10, label %bb.q, label %bb.r

bb.q:                                             ; preds = %8
  %i.aw = icmp eq i64 %.sroa.0.1, -1
  br i1 %i.aw, label %bb.t, label %bb.s

bb.r:                                             ; preds = %8
  %i.ax = tail call noundef i32 @_RNvYNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrNtCskr4qsHYS30i_15fish_widestring4WExt7char_atCs8frGy5WneL6_4fish(ptr noalias nofree noundef nonnull readonly align 4 captures(address, read_provenance) %1, i64 noundef %2, i64 noundef %.sroa.0.1)
  %i.ay = icmp eq i32 %i.ax, 38
  br i1 %i.ay, label %bb.v, label %bb.w

bb.s:                                             ; preds = %bb.q
  %i.az = add nuw i64 %.sroa.0.1, 1               ; 2 uses
  br i1 %.not20, label %bb.bd, label %bb.u
...
bb.u:                                             ; preds = %bb.s
  %i.ba = tail call fastcc noundef i32 @_RNvNtCs8frGy5WneL6_4fish9tokenizer8parse_fd(ptr noalias nofree noundef nonnull readonly align 4 captures(address, read_provenance) %1, i64 noundef %.sroa.0.1.i.i69)
  br label %bb.bd

bb.v:                                             ; preds = %bb.r
  %i.bb = icmp eq i64 %.sroa.0.1, -1
...
bb.x:                                             ; preds = %bb.v
  %i.bc = add nuw i64 %.sroa.0.1, 1               ; 2 uses
  br i1 %.not20, label %bb.bd, label %bb.z
...
bb.aa:                                            ; preds = %bb.w
  %i.be = tail call fastcc noundef i32 @_RNvNtCs8frGy5WneL6_4fish9tokenizer8parse_fd(ptr noalias nofree noundef nonnull readonly align 4 captures(address, read_provenance) %1, i64 noundef %.sroa.0.1.i.i69)
  br label %bb.ab

bb.ab:                                            ; preds = %bb.w, %bb.aa
  %.sroa.04.0 = phi i32 [ %i.be, %bb.aa ], [ 1, %bb.w ] ; 2 uses
  %i.bf = tail call noundef i32 @_RNvYNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrNtCskr4qsHYS30i_15fish_widestring4WExt7char_atCs8frGy5WneL6_4fish(ptr noalias nofree noundef nonnull readonly align 4 captures(address, read_provenance) %1, i64 noundef %2, i64 noundef %.sroa.0.1)
  %i.bg = icmp eq i32 %i.bf, 63
  br i1 %i.bg, label %bb.ac, label %bb.bd

bb.ac:                                            ; preds = %bb.ab
  %i.bh = icmp eq i64 %.sroa.0.1, -1
  br i1 %i.bh, label %bb.ae, label %bb.ad

bb.ad:                                            ; preds = %bb.ac
  %i.bi = add nuw i64 %.sroa.0.1, 1
  br label %bb.bd
...
bb.af:                                            ; preds = %_RNCNvXsc_NtCs8frGy5WneL6_4fish9tokenizerNtB7_11PipeOrRedirINtNtCs3oUPovFnLWP_4core7convert7TryFromRNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrE8try_froms0_0B9_.exit31
  ...
  br i1 %i.bj, label %bb.ai, label %bb.ah
...
bb.ag:                                            ; preds = %_RNCNvXsc_NtCs8frGy5WneL6_4fish9tokenizerNtB7_11PipeOrRedirINtNtCs3oUPovFnLWP_4core7convert7TryFromRNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrE8try_froms0_0B9_.exit31
  %i.bk = tail call noundef i32 @_RNvYNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrNtCskr4qsHYS30i_15fish_widestring4WExt7char_atCs8frGy5WneL6_4fish(ptr noalias nofree noundef nonnull readonly align 4 captures(address, read_provenance) %1, i64 noundef %2, i64 noundef %i.ah)
  %i.bl = icmp eq i32 %i.bk, 63
  br i1 %i.bl, label %bb.ak, label %bb.aj

bb.ah:                                            ; preds = %bb.af
  %i.bm = add nuw i64 %.sroa.0.1.i.i69, 2
  br label %bb.aj
...
bb.aj:                                            ; preds = %bb.ag, %bb.al, %bb.ah
  %.sroa.0.2 = phi i64 [ %i.bm, %bb.ah ], [ %i.bo, %bb.al ], [ %i.ah, %bb.ag ] ; 2 uses
  %.sroa.11.3 = phi i8 [ 4, %bb.ah ], [ 3, %bb.al ], [ 2, %bb.ag ] ; 2 uses
  br i1 %.not20, label %bb.bd, label %bb.an

bb.ak:                                            ; preds = %bb.ag
  %i.bn = icmp eq i64 %i.ah, -1
  br i1 %i.bn, label %bb.am, label %bb.al
...
bb.ao:                                            ; preds = %_RNCNvXsc_NtCs8frGy5WneL6_4fish9tokenizerNtB7_11PipeOrRedirINtNtCs3oUPovFnLWP_4core7convert7TryFromRNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrE8try_froms0_0B9_.exit32
  %i.bq = icmp eq i64 %i.am, -1
  br i1 %i.bq, label %bb.ar, label %bb.aq

bb.ap:                                            ; preds = %_RNCNvXsc_NtCs8frGy5WneL6_4fish9tokenizerNtB7_11PipeOrRedirINtNtCs3oUPovFnLWP_4core7convert7TryFromRNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrE8try_froms0_0B9_.exit32
  %i.br = tail call noundef i32 @_RNvYNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrNtCskr4qsHYS30i_15fish_widestring4WExt7char_atCs8frGy5WneL6_4fish(ptr noalias nofree noundef nonnull readonly align 4 captures(address, read_provenance) %1, i64 noundef %2, i64 noundef %i.am)
  %i.bs = icmp eq i32 %i.br, 62
  br i1 %i.bs, label %bb.as, label %bb.at

bb.aq:                                            ; preds = %bb.ao
  %i.bt = add nuw i64 %.sroa.0.1.i.i69, 2
  br label %bb.bd
...
bb.as:                                            ; preds = %bb.ap
  %i.bu = icmp eq i64 %i.am, -1
  br i1 %i.bu, label %bb.av, label %bb.au

bb.at:                                            ; preds = %bb.ap
  %i.bv = getelementptr inbounds nuw i8, ptr %0, i64 14
  store i8 2, ptr %i.bv, align 2
  br label %bb.be

bb.au:                                            ; preds = %bb.as
  %i.bw = add nuw i64 %.sroa.0.1.i.i69, 2         ; 3 uses
  %i.bx = tail call noundef i32 @_RNvYNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrNtCskr4qsHYS30i_15fish_widestring4WExt7char_atCs8frGy5WneL6_4fish(ptr noalias nofree noundef nonnull readonly align 4 captures(address, read_provenance) %1, i64 noundef %2, i64 noundef %i.bw)
  %i.by = icmp eq i32 %i.bx, 62
  br i1 %i.by, label %bb.aw, label %bb.az
...
bb.aw:                                            ; preds = %bb.au
  %i.bz = icmp eq i64 %i.bw, -1
  br i1 %i.bz, label %bb.ay, label %bb.ax

bb.ax:                                            ; preds = %bb.aw
  %i.ca = add nuw i64 %.sroa.0.1.i.i69, 3
  br label %bb.az
...
bb.az:                                            ; preds = %bb.au, %bb.ax
  %.sroa.0.3 = phi i64 [ %i.ca, %bb.ax ], [ %i.bw, %bb.au ] ; 4 uses
  %.sroa.11.4 = phi i8 [ 1, %bb.ax ], [ 0, %bb.au ]
  %i.cb = tail call noundef i32 @_RNvYNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrNtCskr4qsHYS30i_15fish_widestring4WExt7char_atCs8frGy5WneL6_4fish(ptr noalias nofree noundef nonnull readonly align 4 captures(address, read_provenance) %1, i64 noundef %2, i64 noundef %.sroa.0.3)
  %i.cc = icmp eq i32 %i.cb, 63
  br i1 %i.cc, label %bb.ba, label %bb.bd

bb.ba:                                            ; preds = %bb.az
  %i.cd = icmp eq i64 %.sroa.0.3, -1
  br i1 %i.cd, label %bb.bc, label %bb.bb

bb.bb:                                            ; preds = %bb.ba
  %i.ce = add nuw i64 %.sroa.0.3, 1
  br label %bb.bd
...
bb.bd:                                            ; preds = %bb.p, %bb.ab, %bb.ad, %bb.aq, %bb.az, %bb.bb, %bb.s, %bb.u, %bb.x, %bb.z, %bb.aj, %bb.an
  %.sroa.0.0 = phi i64 [ %.sroa.0.3, %bb.az ], [ %spec.select70, %bb.p ], [ %i.az, %bb.s ], [ %i.az, %bb.u ], [ %i.bc, %bb.x ], [ %i.bc, %bb.z ], [ %i.bi, %bb.ad ], [ %.sroa.0.1, %bb.ab ], [ %.sroa.0.2, %bb.aj ], [ %.sroa.0.2, %bb.an ], [ %i.bt, %bb.aq ], [ %i.ce, %bb.bb ]
  %.sroa.25.0 = phi i8 [ 1, %bb.az ], [ %spec.select71, %bb.p ], [ 0, %bb.s ], [ 0, %bb.u ], [ 0, %bb.x ], [ 0, %bb.z ], [ 0, %bb.ad ], [ 0, %bb.ab ], [ 0, %bb.aj ], [ 0, %bb.an ], [ 1, %bb.aq ], [ 1, %bb.bb ]
  %.sroa.22.0 = phi i8 [ 0, %bb.az ], [ 1, %bb.p ], [ 1, %bb.s ], [ 1, %bb.u ], [ 0, %bb.x ], [ 0, %bb.z ], [ 0, %bb.ad ], [ 0, %bb.ab ], [ 0, %bb.aj ], [ 0, %bb.an ], [ 1, %bb.aq ], [ 0, %bb.bb ]
  %.sroa.11.0 = phi i8 [ %.sroa.11.4, %bb.az ], [ 0, %bb.p ], [ %.sroa.11.1, %bb.s ], [ %.sroa.11.1, %bb.u ], [ 4, %bb.x ], [ 4, %bb.z ], [ 5, %bb.ad ], [ %.sroa.11.1, %bb.ab ], [ %.sroa.11.3, %bb.aj ], [ %.sroa.11.3, %bb.an ], [ 0, %bb.aq ], [ 5, %bb.bb ]
  %.sroa.4.0 = phi i32 [ 1, %bb.az ], [ 1, %bb.p ], [ 1, %bb.s ], [ %i.ba, %bb.u ], [ 1, %bb.x ], [ %i.bd, %bb.z ], [ %.sroa.04.0, %bb.ad ], [ %.sroa.04.0, %bb.ab ], [ 0, %bb.aj ], [ %i.bp, %bb.an ], [ 1, %bb.aq ], [ 1, %bb.bb ]
...
bb.be:                                            ; preds = %bb.d, %bb.n, %bb.at, %bb.bd
  ret void
}
