...
_RNCNvXsc_NtCs8frGy5WneL6_4fish9tokenizerNtB7_11PipeOrRedirINtNtCs3oUPovFnLWP_4core7convert7TryFromRNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrE8try_froms0_0B9_.exit31: ; preds = %bb.h
  ...
  br i1 %i.am, label %bb.y, label %bb.z
...
_RNCNvXsc_NtCs8frGy5WneL6_4fish9tokenizerNtB7_11PipeOrRedirINtNtCs3oUPovFnLWP_4core7convert7TryFromRNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrE8try_froms0_0B9_.exit32: ; preds = %bb.j
  ...
  br i1 %i.ar, label %bb.ah, label %bb.ai
...
bb.q:                                             ; preds = %_RNCNvXsc_NtCs8frGy5WneL6_4fish9tokenizerNtB7_11PipeOrRedirINtNtCs3oUPovFnLWP_4core7convert7TryFromRNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrE8try_froms0_0B9_.exit
  %i.az = tail call noundef i32 @_RNvYNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrNtCskr4qsHYS30i_15fish_widestring4WExt7char_atCs8frGy5WneL6_4fish(ptr noalias nofree noundef nonnull readonly align 4 captures(address, read_provenance) %1, i64 noundef %2, i64 noundef %spec.select)
  %i.ba = icmp eq i32 %i.az, 38
  br i1 %i.ba, label %6, label %bb.t

bb.r:                                             ; preds = %3
  %i.bb = add nuw i64 %spec.select, 1             ; 2 uses
...
6:                                                ; preds = %bb.q
  %7 = icmp eq i64 %spec.select, -1
  br i1 %7, label %8, label %bb.u

bb.t:                                             ; preds = %bb.q
  br i1 %.not20, label %bb.x, label %bb.w

bb.u:                                             ; preds = %6
  %i.bd = add nuw i64 %spec.select, 1             ; 2 uses
...
bb.w:                                             ; preds = %bb.t
  %i.bf = tail call fastcc noundef i32 @_RNvNtCs8frGy5WneL6_4fish9tokenizer8parse_fd(ptr noalias nofree noundef nonnull readonly align 4 captures(address, read_provenance) %1, i64 noundef %.sroa.0.1.i.i69)
  br label %bb.x

bb.x:                                             ; preds = %bb.t, %bb.w
  %.sroa.04.0 = phi i32 [ %i.bf, %bb.w ], [ 1, %bb.t ] ; 2 uses
  %i.bg = tail call noundef i32 @_RNvYNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrNtCskr4qsHYS30i_15fish_widestring4WExt7char_atCs8frGy5WneL6_4fish(ptr noalias nofree noundef nonnull readonly align 4 captures(address, read_provenance) %1, i64 noundef %2, i64 noundef %spec.select)
  %i.bh = icmp eq i32 %i.bg, 63
  br i1 %i.bh, label %9, label %bb.aw

9:                                                ; preds = %bb.x
  %10 = icmp eq i64 %spec.select, -1
  br i1 %10, label %13, label %11

11:                                               ; preds = %9
  %12 = add nuw i64 %spec.select, 1
  br label %bb.aw
...
bb.z:                                             ; preds = %_RNCNvXsc_NtCs8frGy5WneL6_4fish9tokenizerNtB7_11PipeOrRedirINtNtCs3oUPovFnLWP_4core7convert7TryFromRNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrE8try_froms0_0B9_.exit31
  %i.bj = tail call noundef i32 @_RNvYNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrNtCskr4qsHYS30i_15fish_widestring4WExt7char_atCs8frGy5WneL6_4fish(ptr noalias nofree noundef nonnull readonly align 4 captures(address, read_provenance) %1, i64 noundef %2, i64 noundef %i.ak)
  %i.bk = icmp eq i32 %i.bj, 63
  br i1 %i.bk, label %bb.ad, label %bb.ac

bb.aa:                                            ; preds = %bb.y
  %i.bl = add nuw i64 %.sroa.0.1.i.i69, 2
  br label %bb.ac
...
bb.ac:                                            ; preds = %bb.z, %bb.ae, %bb.aa
  %.sroa.0.2 = phi i64 [ %i.bl, %bb.aa ], [ %i.bn, %bb.ae ], [ %i.ak, %bb.z ] ; 2 uses
  %.sroa.11.3 = phi i8 [ 4, %bb.aa ], [ 3, %bb.ae ], [ 2, %bb.z ] ; 2 uses
  br i1 %.not20, label %bb.aw, label %bb.ag

bb.ad:                                            ; preds = %bb.z
  %i.bm = icmp eq i64 %i.ak, -1
  br i1 %i.bm, label %bb.af, label %bb.ae

bb.ae:                                            ; preds = %bb.ad
  %i.bn = add nuw i64 %.sroa.0.1.i.i69, 2
  br label %bb.ac
...
bb.ag:                                            ; preds = %bb.ac
  %i.bo = tail call fastcc noundef i32 @_RNvNtCs8frGy5WneL6_4fish9tokenizer8parse_fd(ptr noalias nofree noundef nonnull readonly align 4 captures(address, read_provenance) %1, i64 noundef %.sroa.0.1.i.i69)
  br label %bb.aw
...
bb.ah:                                            ; preds = %_RNCNvXsc_NtCs8frGy5WneL6_4fish9tokenizerNtB7_11PipeOrRedirINtNtCs3oUPovFnLWP_4core7convert7TryFromRNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrE8try_froms0_0B9_.exit32
  %i.bp = icmp eq i64 %i.ap, -1
  br i1 %i.bp, label %bb.ak, label %bb.aj
...
bb.al:                                            ; preds = %bb.ai
  %i.bt = icmp eq i64 %i.ap, -1
  br i1 %i.bt, label %bb.ao, label %bb.an

bb.am:                                            ; preds = %bb.ai
  %i.bu = getelementptr inbounds nuw i8, ptr %0, i64 14
  store i8 2, ptr %i.bu, align 2
  br label %bb.ax

bb.an:                                            ; preds = %bb.al
  %i.bv = add nuw i64 %.sroa.0.1.i.i69, 2         ; 3 uses
  %i.bw = tail call noundef i32 @_RNvYNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrNtCskr4qsHYS30i_15fish_widestring4WExt7char_atCs8frGy5WneL6_4fish(ptr noalias nofree noundef nonnull readonly align 4 captures(address, read_provenance) %1, i64 noundef %2, i64 noundef %i.bv)
  %i.bx = icmp eq i32 %i.bw, 62
  br i1 %i.bx, label %bb.ap, label %bb.as
...
bb.ap:                                            ; preds = %bb.an
  ...
  br i1 %i.by, label %bb.ar, label %bb.aq

bb.aq:                                            ; preds = %bb.ap
  %i.bz = add nuw i64 %.sroa.0.1.i.i69, 3
  br label %bb.as
...
bb.as:                                            ; preds = %bb.an, %bb.aq
  %.sroa.0.3 = phi i64 [ %i.bz, %bb.aq ], [ %i.bv, %bb.an ] ; 4 uses
  %.sroa.11.4 = phi i8 [ 1, %bb.aq ], [ 0, %bb.an ]
  %i.ca = tail call noundef i32 @_RNvYNtNtCslLGyqsphxMB_10widestring6utfstr8Utf32StrNtCskr4qsHYS30i_15fish_widestring4WExt7char_atCs8frGy5WneL6_4fish(ptr noalias nofree noundef nonnull readonly align 4 captures(address, read_provenance) %1, i64 noundef %2, i64 noundef %.sroa.0.3)
  %i.cb = icmp eq i32 %i.ca, 63
  br i1 %i.cb, label %bb.at, label %bb.aw

bb.at:                                            ; preds = %bb.as
  %i.cc = icmp eq i64 %.sroa.0.3, -1
  br i1 %i.cc, label %bb.av, label %bb.au

bb.au:                                            ; preds = %bb.at
  %i.cd = add nuw i64 %.sroa.0.3, 1
  br label %bb.aw
...
bb.aw:                                            ; preds = %bb.p, %bb.x, %11, %bb.aj, %bb.as, %bb.au, %bb.r, %bb.s, %bb.u, %bb.v, %bb.ac, %bb.ag
  %.sroa.0.0 = phi i64 [ %.sroa.0.3, %bb.as ], [ %spec.select70, %bb.p ], [ %i.bb, %bb.r ], [ %i.bb, %bb.s ], [ %i.bd, %bb.u ], [ %i.bd, %bb.v ], [ %12, %11 ], [ %spec.select, %bb.x ], [ %.sroa.0.2, %bb.ac ], [ %.sroa.0.2, %bb.ag ], [ %i.bs, %bb.aj ], [ %i.cd, %bb.au ]
  %.sroa.25.0 = phi i8 [ 1, %bb.as ], [ %spec.select71, %bb.p ], [ 0, %bb.r ], [ 0, %bb.s ], [ 0, %bb.u ], [ 0, %bb.v ], [ 0, %11 ], [ 0, %bb.x ], [ 0, %bb.ac ], [ 0, %bb.ag ], [ 1, %bb.aj ], [ 1, %bb.au ]
  %.sroa.22.0 = phi i8 [ 0, %bb.as ], [ 1, %bb.p ], [ 1, %bb.r ], [ 1, %bb.s ], [ 0, %bb.u ], [ 0, %bb.v ], [ 0, %11 ], [ 0, %bb.x ], [ 0, %bb.ac ], [ 0, %bb.ag ], [ 1, %bb.aj ], [ 0, %bb.au ]
  %.sroa.11.0 = phi i8 [ %.sroa.11.4, %bb.as ], [ 0, %bb.p ], [ %spec.select78, %bb.r ], [ %spec.select78, %bb.s ], [ 4, %bb.u ], [ 4, %bb.v ], [ 5, %11 ], [ %spec.select78, %bb.x ], [ %.sroa.11.3, %bb.ac ], [ %.sroa.11.3, %bb.ag ], [ 0, %bb.aj ], [ 5, %bb.au ]
  %.sroa.4.0 = phi i32 [ 1, %bb.as ], [ 1, %bb.p ], [ 1, %bb.r ], [ %i.bc, %bb.s ], [ 1, %bb.u ], [ %i.be, %bb.v ], [ %.sroa.04.0, %11 ], [ %.sroa.04.0, %bb.x ], [ 0, %bb.ac ], [ %i.bo, %bb.ag ], [ 1, %bb.aj ], [ 1, %bb.au ]
