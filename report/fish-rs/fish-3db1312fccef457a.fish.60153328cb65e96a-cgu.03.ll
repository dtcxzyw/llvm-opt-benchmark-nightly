...
begin_hunk_0_@_RNvMs0_NtCs8frGy5WneL6_4fish8completeNtB5_10Completion15from_completion:bb.a
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %0, ptr noundef nonnull readonly align 8 dereferenceable(24) %1, i64 24, i1 false), !alias.scope !806, !noalias !807
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 24
  store i64 0, ptr %i.a, align 8, !alias.scope !808, !noalias !809
  %.sroa.4.0..sroa_idx1 = getelementptr inbounds nuw i8, ptr %0, i64 32
  store ptr inttoptr (i64 4 to ptr), ptr %.sroa.4.0..sroa_idx1, align 8, !alias.scope !808, !noalias !809
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.at = load i64, ptr %i.as, align 8, !noalias !843, !noundef !5 ; 7 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.ay = load i64, ptr %i.ax, align 8, !noalias !843, !noundef !5 ; 6 uses
...
bb.s:                                             ; preds = %bb.q
  ...
  br i1 %or.cond, label %bb.u, label %bb.t, !prof !15
...
bb.ab:                                            ; preds = %bb.x
  ...
  %i.bl = load i8, ptr %i.e, align 8, !range !4, !alias.scope !844, !noalias !845, !noundef !5
  %i.bm = trunc nuw i8 %i.bl to i1
  br i1 %i.bm, label %bb.ac, label %.preheader.preheader, !prof !11

bb.ac:                                            ; preds = %bb.ab
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !846
  %i.bn = getelementptr inbounds nuw i8, ptr %i.e, i64 1
  %i.bo = load i8, ptr %i.bn, align 1, !range !24, !alias.scope !844, !noalias !845, !noundef !5
  store i8 %i.bo, ptr %i.a, align 1, !noalias !846
