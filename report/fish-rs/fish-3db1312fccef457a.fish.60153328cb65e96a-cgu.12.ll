...
bb.b:                                             ; preds = %bb.a
  %i.bm = load ptr, ptr %2, align 8, !nonnull !9, !align !16, !noundef !9 ; 7 uses
  %i.bn = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.bo = load i64, ptr %i.bn, align 8, !noundef !9 ; 7 uses
...
bb.g:                                             ; preds = %bb.e
  %i.cf = load i64, ptr %i.by, align 8, !noundef !9 ; 3 uses
...
bb.k:                                             ; preds = %bb.f
  %i.ci = load i64, ptr %i.by, align 8, !noundef !9 ; 2 uses
  %i.cj = add i64 %i.ci, -1                       ; 3 uses
  %i.ck = icmp eq i64 %i.ci, 0
  br i1 %i.ck, label %.invoke, label %bb.o

bb.l:                                             ; preds = %bb.f
  %i.cl = load i64, ptr %i.by, align 8, !noundef !9 ; 2 uses
...
bb.q:                                             ; preds = %bb.o
  ...
  %i.cr = load ptr, ptr %i.cq, align 8, !nonnull !9, !align !16, !noundef !9
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.cy = load ptr, ptr %i.cx, align 8, !nonnull !9, !align !16, !noundef !9
  %i.cz = getelementptr inbounds nuw i8, ptr %i.cx, i64 8
  %i.da = load i64, ptr %i.cz, align 8, !noundef !9
...
bb.aa:                                            ; preds = %bb.y
  ...
  %i.dj = load ptr, ptr %i.di, align 8, !nonnull !9, !align !16, !noundef !9
  %i.dk = getelementptr inbounds nuw i8, ptr %i.di, i64 8
  %i.dl = load i64, ptr %i.dk, align 8, !noundef !9
  br label %bb.ad
...
bb.ae:                                            ; preds = %bb.z
  %i.dp = load ptr, ptr %i.bd, align 8, !noundef !9
...
bb.ai:                                            ; preds = %bb.ag
  ...
  store i64 -1, ptr %i.ba, align 8, !alias.scope !3602, !noalias !3603
  %.sroa.0210.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.ba, i64 8
  store ptr %i.du, ptr %.sroa.0210.sroa.4.0..sroa_idx, align 8, !alias.scope !3602, !noalias !3603
  %.sroa.0210.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.ba, i64 16
  store i64 %i.dv, ptr %.sroa.0210.sroa.5.0..sroa_idx, align 8, !alias.scope !3602, !noalias !3603
  %.sroa.4211.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.ba, i64 24
  store ptr %i.bm, ptr %.sroa.4211.0..sroa_idx, align 8, !alias.scope !3602, !noalias !3603
  %.sroa.6212.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.ba, i64 32
  store i64 %i.bo, ptr %.sroa.6212.0..sroa_idx, align 8, !alias.scope !3602, !noalias !3603
  %.sroa.7213.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.ba, i64 40
  store ptr null, ptr %.sroa.7213.0..sroa_idx, align 8, !alias.scope !3602, !noalias !3603
  %.sroa.8215.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.ba, i64 56
  store ptr null, ptr %.sroa.8215.0..sroa_idx, align 8, !alias.scope !3602, !noalias !3603
  %.sroa.9216.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.ba, i64 64
  store i8 0, ptr %.sroa.9216.0..sroa_idx, align 8, !alias.scope !3602, !noalias !3603
...
bb.al:                                            ; preds = %bb.af
  ...
  %i.dy = load ptr, ptr %i.bc, align 8, !alias.scope !3607, !nonnull !9, !noundef !9
  %i.dz = atomicrmw sub ptr %i.dy, i64 1 release, align 8, !noalias !3607
...
bb.an:                                            ; preds = %bb.af
  ...
  %i.ec = load ptr, ptr %i.eb, align 8, !nonnull !9, !noundef !9
  %i.ed = getelementptr inbounds nuw i8, ptr %i.be, i64 16
  %i.ee = load i64, ptr %i.ed, align 8, !noundef !9
  call void @llvm.experimental.noalias.scope.decl(metadata !3608)
  call void @llvm.experimental.noalias.scope.decl(metadata !3609)
  call void @llvm.experimental.noalias.scope.decl(metadata !3610)
  %i.ef = load ptr, ptr %i.bc, align 8, !alias.scope !3611, !nonnull !9, !noundef !9
  %i.eg = atomicrmw sub ptr %i.ef, i64 1 release, align 8, !noalias !3611
...
bb.as:                                            ; preds = %.sink.split, %bb.ar
  ...
  %i.em = load ptr, ptr %i.el, align 8, !nonnull !9, !noundef !9
  %i.en = getelementptr inbounds nuw i8, ptr %i.at, i64 16 ; 2 uses
  %i.eo = load i64, ptr %i.en, align 8, !noundef !9
