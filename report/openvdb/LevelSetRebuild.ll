...
bb.a:
  ...
  %spec.select = zext i1 %i.c to i32              ; 2 uses
  %5 = or disjoint i32 %spec.select, 2
  %.1 = select i1 %i.h, i32 %5, i32 %spec.select  ; 2 uses
  %6 = or disjoint i32 %.1, 4
  %.2 = select i1 %i.n, i32 %6, i32 %.1           ; 2 uses
  %7 = or disjoint i32 %.2, 8
  %.3 = select i1 %i.r, i32 %7, i32 %.2           ; 2 uses
  %8 = or i32 %.3, 16
  %.4 = select i1 %i.z, i32 %8, i32 %.3           ; 2 uses
  %9 = or i32 %.4, 32
  %.5 = select i1 %i.ae, i32 %9, i32 %.4          ; 2 uses
  %10 = or i32 %.5, 64
  %.6 = select i1 %i.aj, i32 %10, i32 %.5         ; 2 uses
  %11 = or i32 %.6, 128
  %.7 = select i1 %i.an, i32 %11, i32 %.6
  %12 = zext nneg i32 %.7 to i64
  %i.ao = getelementptr inbounds nuw i8, ptr @_ZN7openvdb5v13_05tools23volume_to_mesh_internalL10sAdaptableE, i64 %12
