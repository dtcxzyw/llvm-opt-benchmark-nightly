...
bb.a:
  ...
  %.sroa.882.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 8
  %.sroa.1386.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 272
  %.sroa.882.0.copyload = load double, ptr %.sroa.882.0..sroa_idx, align 8 ; 2 uses
  %.sroa.078.0.copyload = load double, ptr %1, align 8 ; 2 uses
  %.sroa.1386.0.copyload = load double, ptr %.sroa.1386.0..sroa_idx, align 8 ; 2 uses
  %i.c = load <4 x double>, ptr %i.a, align 8, !tbaa !1192, !noalias !789 ; 3 uses
  %2 = insertelement <2 x double> poison, double %.sroa.078.0.copyload, i64 0
  %i.d = shufflevector <2 x double> %2, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %3 = insertelement <2 x double> poison, double %.sroa.882.0.copyload, i64 0
  ...
  %i.j = fsub <2 x double> %4, %i.i               ; 4 uses
  %5 = insertelement <2 x double> poison, double %.sroa.1386.0.copyload, i64 0
  %6 = shufflevector <2 x double> %5, <2 x double> poison, <2 x i32> zeroinitializer
  %i.k = shufflevector <4 x double> %i.h, <4 x double> %i.c, <2 x i32> <i32 1, i32 6>
  %i.l = fsub <2 x double> %6, %i.k               ; 4 uses
