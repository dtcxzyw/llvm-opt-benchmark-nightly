...
_ZNK7openvdb5v13_04math9CoordBBox8isInsideERKS2_.exit.thread: ; preds = %bb.a, %_ZNK7openvdb5v13_04math9CoordBBox8isInsideERKS2_.exit
  ...
  %i.aa = load i32, ptr %i.z, align 8, !tbaa !2427 ; 2 uses
...
.lr.ph:                                           ; preds = %bb.b
  ...
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !2428 ; 8 uses
  br label %bb.c
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.au = load i64, ptr %i.at, align 8, !tbaa !1112 ; 2 uses
...
.lr.ph111.1:                                      ; preds = %.lr.ph.i.i.i.i
  ...
  %i.bb = load i64, ptr %i.ba, align 8, !tbaa !1112 ; 2 uses
  %.not22.i.i.i.i.1 = icmp eq i64 %i.bb, 0
  br i1 %.not22.i.i.i.i.1, label %.lr.ph.i.i.i.i.1, label %.critedge.loopexit.i.i.i.i, !llvm.loop !187
...
.lr.ph111.2:                                      ; preds = %.lr.ph.i.i.i.i.1
  ...
  %i.bd = load i64, ptr %i.bc, align 8, !tbaa !1112 ; 2 uses
  %.not22.i.i.i.i.2 = icmp eq i64 %i.bd, 0
  br i1 %.not22.i.i.i.i.2, label %.lr.ph.i.i.i.i.2, label %.critedge.loopexit.i.i.i.i, !llvm.loop !187
...
.lr.ph111.3:                                      ; preds = %.lr.ph.i.i.i.i.2
  ...
  %i.bf = load i64, ptr %i.be, align 8, !tbaa !1112 ; 2 uses
  %.not22.i.i.i.i.3 = icmp eq i64 %i.bf, 0
  br i1 %.not22.i.i.i.i.3, label %.lr.ph.i.i.i.i.3, label %.critedge.loopexit.i.i.i.i, !llvm.loop !187
...
.lr.ph111.4:                                      ; preds = %.lr.ph.i.i.i.i.3
  ...
  %i.bh = load i64, ptr %i.bg, align 8, !tbaa !1112 ; 2 uses
  %.not22.i.i.i.i.4 = icmp eq i64 %i.bh, 0
  br i1 %.not22.i.i.i.i.4, label %.lr.ph.i.i.i.i.4, label %.critedge.loopexit.i.i.i.i, !llvm.loop !187
...
.lr.ph111.5:                                      ; preds = %.lr.ph.i.i.i.i.4
  ...
  %i.bj = load i64, ptr %i.bi, align 8, !tbaa !1112 ; 2 uses
  %.not22.i.i.i.i.5 = icmp eq i64 %i.bj, 0
  br i1 %.not22.i.i.i.i.5, label %.lr.ph.i.i.i.i.5, label %.critedge.loopexit.i.i.i.i, !llvm.loop !187
...
.lr.ph111.6:                                      ; preds = %.lr.ph.i.i.i.i.5
  ...
  %i.bl = load i64, ptr %i.bk, align 8, !tbaa !1112 ; 2 uses
  %.not22.i.i.i.i.6 = icmp eq i64 %i.bl, 0
  br i1 %.not22.i.i.i.i.6, label %_ZN7openvdb5v13_04tree12IteratorBaseINS0_4util14OnMaskIteratorINS3_8NodeMaskILj3EEEEEKNS1_8LeafNodeIfLj3EEEEppEv.exit.thread, label %.critedge.loopexit.i.i.i.i, !llvm.loop !187
...
.lr.ph111:                                        ; preds = %.lr.ph.i.i.i.i.preheader
  ...
  %i.bn = load i64, ptr %i.bm, align 8, !tbaa !1112 ; 2 uses
  %.not22.i.i.i.i = icmp eq i64 %i.bn, 0
  br i1 %.not22.i.i.i.i, label %.lr.ph.i.i.i.i, label %.critedge.loopexit.i.i.i.i, !llvm.loop !187
...
_ZN7openvdb5v13_04tree12IteratorBaseINS0_4util14OnMaskIteratorINS3_8NodeMaskILj3EEEEEKNS1_8LeafNodeIfLj3EEEEppEv.exit: ; preds = %bb.d, %.critedge.i.i.i.i
  ...
  br i1 %.not60, label %_ZN7openvdb5v13_04tree12IteratorBaseINS0_4util14OnMaskIteratorINS3_8NodeMaskILj3EEEEEKNS1_8LeafNodeIfLj3EEEEppEv.exit.thread, label %bb.c, !llvm.loop !6611
...
_ZN7openvdb5v13_04tree12IteratorBaseINS0_4util14OnMaskIteratorINS3_8NodeMaskILj3EEEEEKNS1_8LeafNodeIfLj3EEEEppEv.exit.thread: ; preds = %bb.c, %_ZN7openvdb5v13_04tree12IteratorBaseINS0_4util14OnMaskIteratorINS3_8NodeMaskILj3EEEEEKNS1_8LeafNodeIfLj3EEEEppEv.exit, %.lr.ph.i.i.i.i.preheader, %.lr.ph111.6, %.lr.ph.i.i.i.i, %.lr.ph.i.i.i.i.1, %.lr.ph.i.i.i.i.2, %.lr.ph.i.i.i.i.3, %.lr.ph.i.i.i.i.4, %.lr.ph.i.i.i.i.5
  %i.bt = load i32, ptr %i.a, align 8, !tbaa !741 ; 2 uses
  %i.bu = add nsw i32 %i.bt, %i.ai
  %i.bv = load i32, ptr %i.d, align 4, !tbaa !741 ; 2 uses
  %i.bw = add nsw i32 %i.bv, %i.aj
  %i.bx = load i32, ptr %i.g, align 8, !tbaa !741 ; 2 uses
...
bb.f:                                             ; preds = %_ZN7openvdb5v13_04tree12IteratorBaseINS0_4util14OnMaskIteratorINS3_8NodeMaskILj3EEEEEKNS1_8LeafNodeIfLj3EEEEppEv.exit.thread, %bb.b
  ...
  %i.cc = load i32, ptr %1, align 4, !tbaa !741
  %i.cd = call i32 @llvm.smin.i32(i32 %.sroa.09.sroa.0.1, i32 %i.cc)
  store i32 %i.cd, ptr %1, align 4, !tbaa !741
  %i.ce = load i32, ptr %i.l, align 4, !tbaa !741
  ...
  store i32 %i.ck, ptr %i.ci, align 4, !tbaa !741
  br label %bb.g
...
bb.a:
  ...
  %i.a = load ptr, ptr %0, align 8, !tbaa !2424   ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr %i.b, ptr %1, align 8, !tbaa !803
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 8
  store i64 0, ptr %i.c, align 8, !tbaa !805
  store i8 0, ptr %i.b, align 8, !tbaa !768
...
bb.c:                                             ; preds = %bb.b
  %i.d = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %2, ptr noundef nonnull @.str.55, i64 noundef 31)
...
bb.d:                                             ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit
  %i.e = call noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_(ptr noundef nonnull align 8 dereferenceable(32) %1, ptr noundef nonnull align 8 dereferenceable(32) %3) #24 ; 0 uses
  %i.f = load ptr, ptr %3, align 8, !tbaa !806    ; 2 uses
  %i.g = getelementptr inbounds nuw i8, ptr %3, i64 16 ; 2 uses
  %i.h = icmp eq ptr %i.f, %i.g
  br i1 %i.h, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.d
  %i.i = load i64, ptr %i.g, align 8, !tbaa !768
  %i.j = add i64 %i.i, 1
...
bb.i:                                             ; preds = %bb.h, %bb.e
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #24
  %i.n = call ptr @__cxa_begin_catch(ptr %.1) #24 ; 0 uses
  invoke void @__cxa_end_catch()
          to label %bb.j unwind label %bb.k

bb.j:                                             ; preds = %bb.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  %i.o = call ptr @__cxa_allocate_exception(i64 40) #24 ; 3 uses
  call void @_ZN7openvdb5v13_09ExceptionC2EPKcPKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(ptr noundef nonnull align 8 dereferenceable(40) %i.o, ptr noundef nonnull @.str.42, ptr noundef nonnull align 8 dereferenceable(32) %1) #24
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN7openvdb5v13_010ValueErrorE, i64 16), ptr %i.o, align 8, !tbaa !743
  invoke void @__cxa_throw(ptr nonnull %i.o, ptr nonnull @_ZTIN7openvdb5v13_010ValueErrorE, ptr nonnull @_ZN7openvdb5v13_09ExceptionD2Ev) #29
          to label %bb.m unwind label %bb.k

bb.k:                                             ; preds = %bb.j, %bb.i
  %i.p = landingpad { ptr, i32 }
          cleanup
  %i.q = load ptr, ptr %1, align 8, !tbaa !806    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i4: ; preds = %bb.k
  %i.s = load i64, ptr %i.b, align 8, !tbaa !768
  %i.t = add i64 %i.s, 1
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.j = load i64, ptr %i.i, align 8, !tbaa !1112 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.n = load i64, ptr %i.m, align 8, !tbaa !1112 ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.p = load i64, ptr %i.o, align 8, !tbaa !1112 ; 2 uses
...
_ZNK7openvdb5v13_04util8NodeMaskILj3EE7beginOnEv.exit: ; preds = %bb.h, %.critedge.thread.i.i
  ...
  store ptr %1, ptr %0, align 8, !tbaa !2431
...
_ZNK7openvdb5v13_04tree10LeafBufferIfLj3EE10loadValuesEv.exit.i.i.i: ; preds = %bb.i, %_ZNK7openvdb5v13_04util8NodeMaskILj3EE7beginOnEv.exit
  %i.y = load ptr, ptr %1, align 8, !tbaa !768    ; 2 uses
  %i.z = icmp eq ptr %i.y, null
end_hunk_0
begin_hunk_1_@_ZNK7openvdb5v13_04tree8LeafNodeIdLj3EE21evalActiveBoundingBoxERNS0_4math9CoordBBoxEb:bb.a
  %i.m = load i32, ptr %i.l, align 4
  %i.n = icmp sgt i32 %i.m, %.sroa.09.sroa.10.0.extract.trunc
  %or.cond = select i1 %i.k, i1 true, i1 %i.n
  %i.o = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 3 uses
...
.lr.ph.i.i.i.i.5:                                 ; preds = %.lr.ph111.5
  %exitcond.not.i.i.i.i.5 = icmp eq i64 %indvars.iv.next.i.i.i.i.5, 7
  br i1 %exitcond.not.i.i.i.i.5, label %_ZN7openvdb5v13_04tree12IteratorBaseINS0_4util14OnMaskIteratorINS3_8NodeMaskILj3EEEEEKNS1_8LeafNodeIdLj3EEEEppEv.exit.thread, label %.lr.ph111.6
...
.lr.ph111.6:                                      ; preds = %.lr.ph.i.i.i.i.5
  ...
  %i.bl = load i64, ptr %i.bk, align 8, !tbaa !1112 ; 2 uses
  %.not22.i.i.i.i.6 = icmp eq i64 %i.bl, 0
  br i1 %.not22.i.i.i.i.6, label %_ZN7openvdb5v13_04tree12IteratorBaseINS0_4util14OnMaskIteratorINS3_8NodeMaskILj3EEEEEKNS1_8LeafNodeIdLj3EEEEppEv.exit.thread, label %.critedge.loopexit.i.i.i.i, !llvm.loop !187
...
_ZN7openvdb5v13_04tree12IteratorBaseINS0_4util14OnMaskIteratorINS3_8NodeMaskILj3EEEEEKNS1_8LeafNodeIdLj3EEEEppEv.exit: ; preds = %bb.d, %.critedge.i.i.i.i
  %.118.i.i.i.i = phi i32 [ %i.bs, %.critedge.i.i.i.i ], [ %i.ao, %bb.d ] ; 2 uses
  %.not60 = icmp eq i32 %.118.i.i.i.i, 512
  br i1 %.not60, label %_ZN7openvdb5v13_04tree12IteratorBaseINS0_4util14OnMaskIteratorINS3_8NodeMaskILj3EEEEEKNS1_8LeafNodeIdLj3EEEEppEv.exit.thread, label %bb.c, !llvm.loop !8367
...
bb.a:
  ...
  %2 = alloca %"class.std::__cxx11::basic_ostringstream", align 8 ; 8 uses
  %3 = alloca %"class.std::__cxx11::basic_string", align 8 ; 7 uses
  %i.a = load ptr, ptr %0, align 8, !tbaa !3278   ; 2 uses
  %.not = icmp eq ptr %i.a, null
  br i1 %.not, label %bb.b, label %bb.l
...
; Function Attrs: mustprogress uwtable
define linkonce_odr void @_ZNK7openvdb5v13_04tree8LeafNodeIdLj3EE13cbeginValueOnEv(ptr dead_on_unwind noalias writable sret(%"struct.openvdb::v13_0::tree::LeafNode<double, 3>::ValueIter") align 8 %0, ptr noundef nonnull align 8 dereferenceable(96) %1) local_unnamed_addr #6 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 2 uses
  %i.b = load i64, ptr %i.a, align 8, !tbaa !1112 ; 2 uses
  %.not.i.i = icmp eq i64 %i.b, 0
...
_ZNK7openvdb5v13_04util8NodeMaskILj3EE7beginOnEv.exit: ; preds = %bb.h, %.critedge.thread.i.i
  %i.u = phi i32 [ %i.t, %.critedge.thread.i.i ], [ 512, %bb.h ]
  store ptr %1, ptr %0, align 8, !tbaa !3280
  %i.v = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i32 %i.u, ptr %i.v, align 8
  %.sroa.41.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 16
  store ptr %i.a, ptr %.sroa.41.0..sroa_idx, align 8
