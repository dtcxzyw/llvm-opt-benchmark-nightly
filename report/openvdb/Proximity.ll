...
_ZN7openvdb5v13_04math13isApproxEqualIdEEbRKNS1_4Vec3IT_EES7_.exit.thread: ; preds = %_ZN7openvdb5v13_04math18isRelOrApproxEqualIdEEbRKT_S5_S5_S5_.exit.i.i._ZN7openvdb5v13_04math13isApproxEqualIdEEbRKNS1_4Vec3IT_EES7_.exit.thread_crit_edge, %_ZN7openvdb5v13_04math18isRelOrApproxEqualIdEEbRKT_S5_S5_S5_.exit.i.i136, %_ZN7openvdb5v13_04math18isRelOrApproxEqualIdEEbRKT_S5_S5_S5_.exit6.i.i134, %_ZN7openvdb5v13_04math18isRelOrApproxEqualIdEEbRKT_S5_S5_S5_.exit6.i.i, %_ZN7openvdb5v13_04math13isApproxEqualIdEEbRKNS1_4Vec3IT_EES7_.exit138, %_ZN7openvdb5v13_04math13isApproxEqualIdEEbRKNS1_4Vec3IT_EES7_.exit
  ...
  %6 = load <2 x double>, ptr %.sroa.7237.0..sroa_idx, align 8
  %i.cl = load <3 x double>, ptr %4, align 8      ; 2 uses
  %7 = shufflevector <3 x double> %i.cl, <3 x double> poison, <3 x i32> <i32 2, i32 0, i32 poison>
  %8 = shufflevector <2 x double> %6, <2 x double> poison, <3 x i32> <i32 poison, i32 poison, i32 0>
  %9 = shufflevector <3 x double> %7, <3 x double> %8, <3 x i32> <i32 0, i32 1, i32 5> ; 2 uses
  %10 = insertelement <3 x double> poison, double %i.bu, i64 0
  %11 = insertelement <3 x double> %10, double %i.a, i64 1
  %12 = insertelement <3 x double> %11, double %i.br, i64 2
  %13 = fsub <3 x double> %9, %12                 ; 3 uses
  %14 = shufflevector <3 x double> %13, <3 x double> poison, <2 x i32> <i32 2, i32 2>
  %15 = fmul <2 x double> %i.cf, %14
  %16 = shufflevector <3 x double> %13, <3 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.cm = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ca, <2 x double> %16, <2 x double> %15)
  %i.cn = shufflevector <3 x double> %13, <3 x double> poison, <2 x i32> zeroinitializer
...
bb.k:                                             ; preds = %_ZN7openvdb5v13_04math13isApproxEqualIdEEbRKNS1_4Vec3IT_EES7_.exit162.thread
  %17 = insertelement <3 x double> poison, double %.sroa.17262.0.copyload, i64 0
  %18 = insertelement <3 x double> %17, double %i.b, i64 1
  %19 = insertelement <3 x double> %18, double %.sroa.10258.0.copyload, i64 2
  %20 = fsub <3 x double> %9, %19                 ; 3 uses
  %21 = shufflevector <3 x double> %20, <3 x double> poison, <2 x i32> <i32 2, i32 2>
  %i.hk = fmul <2 x double> %i.cf, %21
  %22 = shufflevector <3 x double> %20, <3 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.hl = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ca, <2 x double> %22, <2 x double> %i.hk)
  %i.hm = shufflevector <3 x double> %20, <3 x double> poison, <2 x i32> zeroinitializer
