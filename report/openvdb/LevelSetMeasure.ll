...
bb.g:                                             ; preds = %bb.f
  ...
  %3 = shufflevector <4 x double> %i.dn, <4 x double> poison, <2 x i32> <i32 2, i32 2> ; 2 uses
  %4 = shufflevector <4 x double> %i.dn, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  ...
  %6 = shufflevector <4 x double> %i.dn, <4 x double> poison, <2 x i32> <i32 3, i32 poison> ; 2 uses
  %7 = insertelement <2 x double> %6, double %sqrt.i22, i64 1 ; 2 uses
  %8 = shufflevector <2 x double> %7, <2 x double> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %9 = shufflevector <4 x double> %i.dn, <4 x double> %8, <2 x i32> <i32 1, i32 5>
  %10 = fmul <2 x double> %7, %9                  ; 4 uses
  ...
  %i.gm = extractelement <2 x double> %i.fx, i64 0 ; 2 uses
  %i.gn = fneg double %i.gm
  %12 = fmul double %i.gm, %i.gn
  ...
  %13 = insertelement <2 x double> %i.gl, double %12, i64 0
  ...
  %shift80 = shufflevector <2 x double> %i.hb, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop81 = fmul <2 x double> %5, %shift80
  %14 = extractelement <2 x double> %foldExtExtBinop81, i64 0
  %i.hc = extractelement <2 x double> %i.hb, i64 0
  %i.hd = call double @llvm.fmuladd.f64(double %11, double %i.hc, double %14)
  ...
  %i.hj = insertelement <2 x double> %6, double %i.fw, i64 1
  %i.hk = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hj, <2 x double> %i.fx, <2 x double> %i.hi)
  %15 = shufflevector <2 x double> %3, <2 x double> %5, <2 x i32> <i32 0, i32 3>
  %16 = shufflevector <2 x double> %i.fx, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %17 = fmul <2 x double> %10, %16
  %i.hl = insertelement <2 x double> %17, double %i.hd, i64 1
  %i.hm = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %15, <2 x double> %i.hk, <2 x double> %i.hl)
  ...
  %i.hu = insertelement <2 x double> %10, double %sqrt.i22, i64 0
  %i.hv = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> <i32 1, i32 1>
...
bb.f:                                             ; preds = %_ZNK7openvdb5v13_05tools10DiracDeltaIdEclEd.exit
  ...
  %i.do = fmul <4 x double> %i.dn, <double 1.000000e+00, double 5.000000e-01, double 5.000000e-01, double 5.000000e-01> ; 7 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %3 = shufflevector <4 x double> %i.do, <4 x double> poison, <2 x i32> <i32 2, i32 2> ; 2 uses
  %4 = shufflevector <4 x double> %i.do, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %5 = fmul <2 x double> %3, %4                   ; 2 uses
  %sqrt.i23 = call double @llvm.sqrt.f64(double %i.dv) ; 2 uses
  ...
  %6 = shufflevector <4 x double> %i.do, <4 x double> poison, <2 x i32> <i32 3, i32 poison> ; 2 uses
  %7 = insertelement <2 x double> %6, double %sqrt.i23, i64 1 ; 2 uses
  %8 = shufflevector <2 x double> %7, <2 x double> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %9 = shufflevector <4 x double> %i.do, <4 x double> %8, <2 x i32> <i32 1, i32 5>
  %10 = fmul <2 x double> %7, %9                  ; 3 uses
  %11 = extractelement <2 x double> %10, i64 0    ; 2 uses
  %i.fw = fmul double %11, %i.fi
  ...
  %foldExtExtBinop = fmul <2 x double> %5, %shift
  %12 = extractelement <2 x double> %foldExtExtBinop, i64 0
  %i.gz = extractelement <2 x double> %i.gy, i64 0
  %i.ha = call double @llvm.fmuladd.f64(double %11, double %i.gz, double %12)
  ...
  %i.hg = insertelement <2 x double> %6, double %i.fg, i64 1
  %i.hh = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hg, <2 x double> %i.fh, <2 x double> %i.hf)
  %13 = shufflevector <2 x double> %3, <2 x double> %5, <2 x i32> <i32 0, i32 3>
  %i.hi = insertelement <2 x double> poison, double %i.fw, i64 0
  %i.hj = insertelement <2 x double> %i.hi, double %i.ha, i64 1
  %i.hk = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %13, <2 x double> %i.hh, <2 x double> %i.hj)
  ...
  %i.hq = insertelement <2 x double> %10, double %sqrt.i23, i64 0
  %i.hr = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> <i32 1, i32 1>
