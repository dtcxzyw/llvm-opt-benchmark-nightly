...
_ZN7openvdb5v13_04math11BaseStencilINS1_17SevenPointStencilINS0_4GridINS0_4tree4TreeINS5_8RootNodeINS5_12InternalNodeINS8_INS5_8LeafNodeIdLj3EEELj4EEELj5EEEEEEEEELb1EEESF_Lb1EE6moveToINSA_9ValueIterINS0_4util14OnMaskIteratorINSK_8NodeMaskILj3EEEEEKSA_KdNSA_7ValueOnEEEEEvRKT_.exit: ; preds = %.noexc65
  %i.gx = load ptr, ptr %i.aj, align 8, !tbaa !1228 ; 5 uses
  %i.gy = load double, ptr %i.gx, align 8, !tbaa !234 ; 6 uses
  ...
  %i.hg = getelementptr inbounds nuw i8, ptr %i.gx, i64 32
  ...
  %i.hk = fsub double %i.hh, %i.gy                ; 2 uses
  %i.hl = fsub double %i.hi, %i.gy                ; 2 uses
  ...
  %8 = load <3 x double>, ptr %i.hg, align 8, !tbaa !234, !noalias !4933
  %9 = insertelement <3 x double> poison, double %i.gy, i64 0
  %10 = shufflevector <3 x double> %9, <3 x double> poison, <3 x i32> zeroinitializer
  %11 = fsub <3 x double> %8, %10
  %12 = fneg <3 x double> %11                     ; 5 uses
  %13 = shufflevector <3 x double> %12, <3 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.hz = fmul <2 x double> %i.ho, %13
  %i.ia = shufflevector <3 x double> %12, <3 x double> poison, <2 x i32> zeroinitializer
  %i.ib = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ia, <2 x double> %i.hn, <2 x double> %i.hz)
  %14 = shufflevector <3 x double> %12, <3 x double> poison, <2 x i32> <i32 2, i32 2>
  %i.ic = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %14, <2 x double> %i.hv, <2 x double> %i.ib) ; 4 uses
  %i.id = insertelement <2 x double> %13, double %i.hk, i64 0
  ...
  %15 = shufflevector <3 x double> %12, <3 x double> poison, <2 x i32> <i32 poison, i32 0>
  %i.ih = insertelement <2 x double> %15, double %i.hl, i64 0
  ...
  %16 = extractelement <3 x double> %12, i64 2
  %i.in = extractelement <2 x double> %i.ik, i64 1
  %i.io = call double @llvm.fmuladd.f64(double %16, double %i.hf, double %i.in) ; 4 uses
...
_ZN7openvdb5v13_04math11BaseStencilINS1_17SevenPointStencilINS0_4GridINS0_4tree4TreeINS5_8RootNodeINS5_12InternalNodeINS8_INS5_8LeafNodeIdLj3EEELj4EEELj5EEEEEEEEELb1EEESF_Lb1EE6moveToINSA_9ValueIterINS0_4util14OnMaskIteratorINSK_8NodeMaskILj3EEEEEKSA_KdNSA_7ValueOnEEEEEvRKT_.exit: ; preds = %.noexc65
  ...
  %i.hx = shufflevector <2 x double> %i.hw, <2 x double> poison, <2 x i32> zeroinitializer
  %i.hy = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hx, <2 x double> %i.hv, <2 x double> %i.hu) ; 4 uses
  %8 = load <3 x double>, ptr %i.hg, align 8, !tbaa !234, !noalias !5361
  %9 = insertelement <3 x double> poison, double %i.gy, i64 0
  %10 = shufflevector <3 x double> %9, <3 x double> poison, <3 x i32> zeroinitializer
  %11 = fsub <3 x double> %8, %10
  %12 = fneg <3 x double> %11                     ; 5 uses
...
_ZN7openvdb5v13_04math11BaseStencilINS1_17SevenPointStencilINS0_4GridINS0_4tree4TreeINS5_8RootNodeINS5_12InternalNodeINS8_INS5_8LeafNodeIdLj3EEELj4EEELj5EEEEEEEEELb1EEESF_Lb1EE6moveToINSA_9ValueIterINS0_4util14OnMaskIteratorINSK_8NodeMaskILj3EEEEEKSA_KdNSA_7ValueOnEEEEEvRKT_.exit: ; preds = %.noexc67
  %i.gz = load ptr, ptr %i.aj, align 8, !tbaa !1228 ; 5 uses
  %i.ha = load double, ptr %i.gz, align 8, !tbaa !234 ; 6 uses
  ...
  %i.hm = fsub double %i.hj, %i.ha                ; 2 uses
  %i.hn = fsub double %i.hk, %i.ha                ; 2 uses
  ...
  %i.hr = insertelement <2 x double> poison, double %i.hm, i64 0
  ...
  %8 = load <3 x double>, ptr %i.hi, align 8, !tbaa !234, !noalias !5400
  %9 = insertelement <3 x double> poison, double %i.ha, i64 0
  %10 = shufflevector <3 x double> %9, <3 x double> poison, <3 x i32> zeroinitializer
  %11 = fsub <3 x double> %8, %10
  %12 = fneg <3 x double> %11                     ; 5 uses
  %13 = shufflevector <3 x double> %12, <3 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.ib = fmul <2 x double> %i.hq, %13
  %i.ic = shufflevector <3 x double> %12, <3 x double> poison, <2 x i32> zeroinitializer
  %i.id = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ic, <2 x double> %i.hp, <2 x double> %i.ib)
  %14 = shufflevector <3 x double> %12, <3 x double> poison, <2 x i32> <i32 2, i32 2>
  %i.ie = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %14, <2 x double> %i.hx, <2 x double> %i.id) ; 4 uses
  %i.if = insertelement <2 x double> %13, double %i.hm, i64 0
  ...
  %15 = shufflevector <3 x double> %12, <3 x double> poison, <2 x i32> <i32 poison, i32 0>
  %i.ij = insertelement <2 x double> %15, double %i.hn, i64 0
  ...
  %i.iq = call double @llvm.fmuladd.f64(double %16, double %i.hh, double %i.ip) ; 4 uses
...
_ZN7openvdb5v13_04math11BaseStencilINS1_17SevenPointStencilINS0_4GridINS0_4tree4TreeINS5_8RootNodeINS5_12InternalNodeINS8_INS5_8LeafNodeIdLj3EEELj4EEELj5EEEEEEEEELb1EEESF_Lb1EE6moveToINSA_9ValueIterINS0_4util14OnMaskIteratorINSK_8NodeMaskILj3EEEEEKSA_KdNSA_7ValueOnEEEEEvRKT_.exit: ; preds = %.noexc65
  ...
  %i.hx = shufflevector <2 x double> %i.hw, <2 x double> poison, <2 x i32> zeroinitializer
  %i.hy = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hx, <2 x double> %i.hv, <2 x double> %i.hu) ; 4 uses
  %8 = load <3 x double>, ptr %i.hg, align 8, !tbaa !234, !noalias !5850
  %9 = insertelement <3 x double> poison, double %i.gy, i64 0
  %10 = shufflevector <3 x double> %9, <3 x double> poison, <3 x i32> zeroinitializer
  %11 = fsub <3 x double> %8, %10
  %12 = fneg <3 x double> %11                     ; 5 uses
...
_ZN7openvdb5v13_04math11BaseStencilINS1_17SevenPointStencilINS0_4GridINS0_4tree4TreeINS5_8RootNodeINS5_12InternalNodeINS8_INS5_8LeafNodeIdLj3EEELj4EEELj5EEEEEEEEELb1EEESF_Lb1EE6moveToINSA_9ValueIterINS0_4util14OnMaskIteratorINSK_8NodeMaskILj3EEEEEKSA_KdNSA_7ValueOnEEEEEvRKT_.exit: ; preds = %.noexc67
  ...
  %i.hz = shufflevector <2 x double> %i.hy, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ia = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hz, <2 x double> %i.hx, <2 x double> %i.hw) ; 4 uses
  %8 = load <3 x double>, ptr %i.hi, align 8, !tbaa !234, !noalias !5889
  %9 = insertelement <3 x double> poison, double %i.ha, i64 0
  %10 = shufflevector <3 x double> %9, <3 x double> poison, <3 x i32> zeroinitializer
  %11 = fsub <3 x double> %8, %10
  %12 = fneg <3 x double> %11                     ; 5 uses
...
_ZN7openvdb5v13_04math11BaseStencilINS1_17SevenPointStencilINS0_4GridINS0_4tree4TreeINS5_8RootNodeINS5_12InternalNodeINS8_INS5_8LeafNodeIdLj3EEELj4EEELj5EEEEEEEEELb1EEESF_Lb1EE6moveToINSA_9ValueIterINS0_4util14OnMaskIteratorINSK_8NodeMaskILj3EEEEEKSA_KdNSA_7ValueOnEEEEEvRKT_.exit: ; preds = %.noexc67
  ...
  %i.hz = shufflevector <2 x double> %i.hy, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ia = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hz, <2 x double> %i.hx, <2 x double> %i.hw) ; 4 uses
  %8 = load <3 x double>, ptr %i.hi, align 8, !tbaa !234, !noalias !5913
  %9 = insertelement <3 x double> poison, double %i.ha, i64 0
  %10 = shufflevector <3 x double> %9, <3 x double> poison, <3 x i32> zeroinitializer
  %11 = fsub <3 x double> %8, %10
  %12 = fneg <3 x double> %11                     ; 5 uses
