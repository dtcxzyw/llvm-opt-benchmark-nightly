...
bb.a:
  ...
  %spec.select = zext i1 %i.an to i32             ; 2 uses
  %5 = or disjoint i32 %spec.select, 2
  %.1 = select i1 %i.am, i32 %5, i32 %spec.select ; 2 uses
  %6 = or disjoint i32 %.1, 4
  %.2 = select i1 %i.al, i32 %6, i32 %.1          ; 2 uses
  %7 = or disjoint i32 %.2, 8
  %.3 = select i1 %i.ak, i32 %7, i32 %.2          ; 2 uses
  %8 = or i32 %.3, 16
  %.4 = select i1 %i.aj, i32 %8, i32 %.3          ; 2 uses
  %9 = or i32 %.4, 32
  %.5 = select i1 %i.ai, i32 %9, i32 %.4          ; 2 uses
  %10 = or i32 %.5, 64
  %.6 = select i1 %i.ah, i32 %10, i32 %.5         ; 2 uses
  %11 = or i32 %.6, 128
  %.7 = select i1 %i.ag, i32 %11, i32 %.6
