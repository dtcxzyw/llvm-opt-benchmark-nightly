...
.lr.ph:                                           ; preds = %1
  ...
  %.fr = freeze i1 %10                            ; [#uses=1 type=i1]
...
78:                                               ; preds = %sdslen.exit
  ...
  %.fr447 = freeze i8 %79                         ; [#uses=1 type=i8]
  %80 = icmp ne i8 %.fr447, 42                    ; [#uses=1 type=i1]
...
begin_hunk_2
  ...
  %or.cond11 = and i1 %16, %134                   ; [#uses=1 type=i1]
...
.split384.us.preheader:                           ; preds = %.thread, %146
  %.0225449 = phi i32 [ %145, %.thread ], [ -1, %146 ] ; [#uses=1 type=i32]
...
begin_hunk_4
  ...
  %149 = call i64 @kvstoreScan(ptr noundef %148, i64 noundef %.0.us, i32 noundef %.0225449, ptr noundef nonnull @scanCallback, ptr noundef nonnull @scanShouldSkipDict, ptr noundef nonnull %5) #21 ; [#uses=4 type=i64]
...
begin_hunk_5
  ...
  %9 = load i32, ptr %8, align 8, !tbaa !92       ; [#uses=1 type=i32]
  %.fr131 = freeze i32 %9                         ; [#uses=9 type=i32]
...
.lr.ph:                                           ; preds = %1
  ...
  %14 = icmp sgt i32 %.fr131, -1                  ; [#uses=1 type=i1]
  %15 = zext nneg i32 %.fr131 to i64              ; [#uses=1 type=i64]
  br i1 %14, label %.lr.ph.split, label %.lr.ph.split.us

.lr.ph.split.us:                                  ; preds = %.lr.ph, %selectDb.exit116.us
  %16 = phi i32 [ %44, %selectDb.exit116.us ], [ %.fr131, %.lr.ph ] ; [#uses=1 type=i32]
...
.lr.ph.split:                                     ; preds = %.lr.ph, %selectDb.exit116
  %48 = phi i32 [ %80, %selectDb.exit116 ], [ %.fr131, %.lr.ph ] ; [#uses=1 type=i32]
...
begin_hunk_8
  ...
  %.not.i113 = icmp slt i32 %.fr131, %76          ; [#uses=1 type=i1]
...
._crit_edge:                                      ; preds = %selectDb.exit116.us, %selectDb.exit116, %1
  %84 = phi i32 [ %.fr131, %1 ], [ %80, %selectDb.exit116 ], [ %44, %selectDb.exit116.us ] ; [#uses=2 type=i32]
...
87:                                               ; preds = %._crit_edge
  %88 = icmp ne i32 %.fr131, 0                    ; [#uses=1 type=i1]
...
._crit_edge136:                                   ; preds = %99
  %.pre137 = load i32, ptr %2, align 4            ; [#uses=1 type=i32]
  br label %108
...
108:                                              ; preds = %._crit_edge136, %91
  %109 = phi i32 [ %.pre137, %._crit_edge136 ], [ %84, %91 ] ; [#uses=1 type=i32]
  %110 = icmp ne i32 %.fr131, 0                   ; [#uses=1 type=i1]
...
.preheader:                                       ; preds = %.preheader.lr.ph, %.loopexit
  %.043 = phi i32 [ 2, %.preheader.lr.ph ], [ %.pre-phi, %.loopexit ] ; [#uses=1 type=i32]
  %.02742 = phi i32 [ 0, %.preheader.lr.ph ], [ %.128, %.loopexit ] ; [#uses=3 type=i32]
  %.043.fr = freeze i32 %.043                     ; [#uses=3 type=i32]
  %34 = sext i32 %.043.fr to i64                  ; [#uses=1 type=i64]
  ...
  %39 = add i32 %.043.fr, 1                       ; [#uses=5 type=i32]
...
begin_hunk_14
  ...
  %48 = add nsw i32 %47, %.043.fr                 ; [#uses=1 type=i32]
...
12:                                               ; preds = %.lr.ph
  %13 = add i32 %.04361, 1                        ; [#uses=1 type=i32]
  br label %26
...
16:                                               ; preds = %14
  %17 = add i32 %.04361, 1                        ; [#uses=1 type=i32]
  br label %26
...
20:                                               ; preds = %18
  %21 = add i32 %.04361, 2                        ; [#uses=1 type=i32]
  br label %26
...
26:                                               ; preds = %16, %22, %20, %12
  ...
  %27 = add i32 %.245.ph, 1                       ; [#uses=2 type=i32]
