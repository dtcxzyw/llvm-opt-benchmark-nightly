begin_hunk_0
  ...
  switch i8 %28, label %default.unreachable131 [
    i8 0, label %.thread
    i8 1, label %34
    i8 2, label %35
    i8 3, label %42
...
default.unreachable131:                           ; preds = %42, %3
  unreachable
...
.lr.ph.i19.i.i.i.i:                               ; preds = %319
  ...
  %324 = load i64, ptr %214, align 8, !alias.scope !1552, !noalias !1559 ; [#uses=1 type=i64]
  %.fr99.i.i.i = freeze i64 %324                  ; [#uses=7 type=i64]
  ...
  %327 = add i64 %.fr99.i.i.i, -1                 ; [#uses=2 type=i64]
  %.first_iter.i.i.i.i = icmp ult i64 %327, %292  ; [#uses=1 type=i1]
  %328 = icmp ult i64 %.fr99.i.i.i, %292          ; [#uses=1 type=i1]
  %.not.i.us.i.i.i198 = icmp eq i64 %.fr99.i.i.i, 0 ; [#uses=2 type=i1]
  br label %329
...
.preheader33.i.i.i.i.preheader:                   ; preds = %329
  br i1 %328, label %.lr.ph197, label %.preheader.i.preheader.i.i.i
...
.preheader33.i.i.i.i:                             ; preds = %358
  %345 = add nuw nsw i64 %.sroa.04.0.i22.i.i.i.i196, 1 ; [#uses=2 type=i64]
  %346 = icmp ult i64 %345, %292                  ; [#uses=1 type=i1]
  br i1 %346, label %.lr.ph197, label %.preheader.i.preheader.i.i.i
...
.preheader.i.us.i.i.i.preheader:                  ; preds = %.preheader.i.preheader.i.i.i
  br i1 %.not.i.us.i.i.i198, label %_RNvXsv_NtNtCsbvkFyIu7lgC_4core3str7patternNtB5_11StrSearcherNtB5_8Searcher10next_match.exit.i.i.i.i, label %.lr.ph200

.preheader.i.us.i.i.i:                            ; preds = %350
  %.not.i.us.i.i.i = icmp eq i64 %347, 0          ; [#uses=1 type=i1]
  br i1 %.not.i.us.i.i.i, label %_RNvXsv_NtNtCsbvkFyIu7lgC_4core3str7patternNtB5_11StrSearcherNtB5_8Searcher10next_match.exit.i.i.i.i, label %.lr.ph200

.lr.ph200:                                        ; preds = %.preheader.i.us.i.i.i.preheader, %.preheader.i.us.i.i.i
  %.sroa.2.0.i23.i.us.i.i.i199 = phi i64 [ %347, %.preheader.i.us.i.i.i ], [ %.fr99.i.i.i, %.preheader.i.us.i.i.i.preheader ] ; [#uses=1 type=i64]
  %347 = add i64 %.sroa.2.0.i23.i.us.i.i.i199, -1 ; [#uses=4 type=i64]
...
.lr.ph197:                                        ; preds = %.preheader33.i.i.i.i.preheader, %.preheader33.i.i.i.i
  %.sroa.04.0.i22.i.i.i.i196 = phi i64 [ %345, %.preheader33.i.i.i.i ], [ %.fr99.i.i.i, %.preheader33.i.i.i.i.preheader ] ; [#uses=4 type=i64]
  %356 = add i64 %.sroa.04.0.i22.i.i.i.i196, %330 ; [#uses=2 type=i64]
  %357 = icmp ult i64 %356, %288                  ; [#uses=1 type=i1]
  br i1 %357, label %358, label %363

.preheader.i.i.i.i:                               ; preds = %.preheader.i.preheader.i.i.i
  br i1 %.not.i.us.i.i.i198, label %_RNvXsv_NtNtCsbvkFyIu7lgC_4core3str7patternNtB5_11StrSearcherNtB5_8Searcher10next_match.exit.i.i.i.i, label %.invoke.i.i.i

358:                                              ; preds = %.lr.ph197
  %359 = getelementptr inbounds nuw i8, ptr %290, i64 %.sroa.04.0.i22.i.i.i.i196 ; [#uses=1 type=ptr]
...
363:                                              ; preds = %.lr.ph197
  %364 = add i64 %330, %.fr99.i.i.i               ; [#uses=1 type=i64]
...
365:                                              ; preds = %358
  %reass.sub57 = sub i64 %330, %.fr99.i.i.i       ; [#uses=1 type=i64]
  %366 = add i64 %reass.sub57, 1                  ; [#uses=1 type=i64]
  %367 = add i64 %366, %.sroa.04.0.i22.i.i.i.i196 ; [#uses=1 type=i64]
  br label %341
...
390:                                              ; preds = %377
  ...
  br i1 %391, label %.lr.ph193, label %.preheader34.i.i.i.i.preheader
...
394:                                              ; preds = %413
  %395 = add nuw nsw i64 %.sroa.04.0.i.i.i.i.i192, 1 ; [#uses=2 type=i64]
  %396 = icmp ult i64 %395, %292                  ; [#uses=1 type=i1]
  br i1 %396, label %.lr.ph193, label %.preheader34.i.i.i.i.preheader

.preheader34.i.i.i.i.preheader:                   ; preds = %394, %390
  %397 = icmp ult i64 %379, %373                  ; [#uses=1 type=i1]
  br i1 %397, label %.lr.ph195, label %_RNvXsv_NtNtCsbvkFyIu7lgC_4core3str7patternNtB5_11StrSearcherNtB5_8Searcher10next_match.exit.i.i.i.i

.lr.ph193:                                        ; preds = %390, %394
  %.sroa.04.0.i.i.i.i.i192 = phi i64 [ %395, %394 ], [ %.sroa.0.0.i.i.i.i.i.i, %390 ] ; [#uses=4 type=i64]
  %398 = add i64 %.sroa.04.0.i.i.i.i.i192, %378   ; [#uses=2 type=i64]
...
.preheader34.i.i.i.i:                             ; preds = %406
  ...
  br i1 %400, label %.lr.ph195, label %_RNvXsv_NtNtCsbvkFyIu7lgC_4core3str7patternNtB5_11StrSearcherNtB5_8Searcher10next_match.exit.i.i.i.i

.lr.ph195:                                        ; preds = %.preheader34.i.i.i.i.preheader, %.preheader34.i.i.i.i
  %.sroa.2.0.i.i.i.i.i194 = phi i64 [ %401, %.preheader34.i.i.i.i ], [ %373, %.preheader34.i.i.i.i.preheader ] ; [#uses=1 type=i64]
  %401 = add i64 %.sroa.2.0.i.i.i.i.i194, -1      ; [#uses=6 type=i64]
...
413:                                              ; preds = %.lr.ph193
  %414 = getelementptr inbounds nuw i8, ptr %290, i64 %.sroa.04.0.i.i.i.i.i192 ; [#uses=1 type=ptr]
...
420:                                              ; preds = %413
  ...
  %422 = add i64 %421, %.sroa.04.0.i.i.i.i.i192   ; [#uses=1 type=i64]
  br label %.sink.split.i.i.i.i.i
...
.invoke.i.i.i:                                    ; preds = %.lr.ph, %403, %.lr.ph195, %.lr.ph200, %418, %363, %.preheader.i.i.i.i
  %435 = phi i64 [ %327, %.preheader.i.i.i.i ], [ %umax.i.i.i.i.i, %418 ], [ %404, %403 ], [ %348, %.lr.ph200 ], [ %umax.i25.i.i.i.i, %363 ], [ %401, %.lr.ph195 ], [ %433, %.lr.ph ] ; [#uses=1 type=i64]
  %436 = phi i64 [ %292, %.preheader.i.i.i.i ], [ %288, %418 ], [ %288, %403 ], [ %288, %.lr.ph200 ], [ %288, %363 ], [ %292, %.lr.ph195 ], [ %189, %.lr.ph ] ; [#uses=1 type=i64]
  %437 = phi ptr [ @4, %.preheader.i.i.i.i ], [ @6, %418 ], [ @5, %403 ], [ @5, %.lr.ph200 ], [ @6, %363 ], [ @4, %.lr.ph195 ], [ @52, %.lr.ph ] ; [#uses=1 type=ptr]
