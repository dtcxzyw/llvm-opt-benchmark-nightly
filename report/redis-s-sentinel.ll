...
.thread324:                                       ; preds = %76
  %89 = load i32, ptr %85, align 8, !tbaa !39     ; [#uses=2 type=i32]
  %90 = and i32 %89, 9                            ; [#uses=1 type=i32]
...
92:                                               ; preds = %._crit_edge376, %.thread324
  %93 = phi i32 [ %89, %.thread324 ], [ %.pre377, %._crit_edge376 ] ; [#uses=1 type=i32]
