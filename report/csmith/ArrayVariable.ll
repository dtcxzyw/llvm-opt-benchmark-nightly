...
begin_hunk_0_@_ZN13ArrayVariable10rnd_mutateEv:bb.a
  br i1 %.not.i.i.i123, label %_ZNSt6vectorIPK10ExpressionSaIS2_EED2Ev.exit124, label %bb.cl

bb.cl:                                            ; preds = %_ZNSt13_Bvector_baseISaIbEED2Ev.exit122
  %i.iq = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.ir = load ptr, ptr %i.iq, align 8, !tbaa !76
  %i.is = ptrtoint ptr %i.ir to i64
  %i.it = ptrtoint ptr %i.ip to i64
  %i.iu = sub i64 %i.is, %i.it
  call void @_ZdlPvm(ptr noundef nonnull %i.ip, i64 noundef %i.iu) #20
  br label %_ZNSt6vectorIPK10ExpressionSaIS2_EED2Ev.exit124

_ZNSt6vectorIPK10ExpressionSaIS2_EED2Ev.exit124:  ; preds = %_ZNSt13_Bvector_baseISaIbEED2Ev.exit122, %bb.cl
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #21
  br label %bb.cn

bb.cm:                                            ; preds = %bb.a, %_ZNSt6vectorIP8VariableSaIS1_EED2Ev.exit, %_ZNSt6vectorIPK10ExpressionSaIS2_EED2Ev.exit
  %.1076 = phi ptr [ %.066, %_ZNSt6vectorIP8VariableSaIS1_EED2Ev.exit ], [ %.975, %_ZNSt6vectorIPK10ExpressionSaIS2_EED2Ev.exit ], [ null, %bb.a ]
  ret ptr %.1076

bb.cn:                                            ; preds = %_ZNSt6vectorIPK10ExpressionSaIS2_EED2Ev.exit124, %_ZNSt6vectorIP8VariableSaIS1_EED2Ev.exit104
  %.pn98.pn = phi { ptr, i32 } [ %.pn98, %_ZNSt6vectorIP8VariableSaIS1_EED2Ev.exit104 ], [ %.pn96, %_ZNSt6vectorIPK10ExpressionSaIS2_EED2Ev.exit124 ]
  resume { ptr, i32 } %.pn98.pn
}

declare noundef zeroext i1 @_Z12rnd_flipcoinjPK6FilterPKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(i32 noundef, ptr noundef, ptr noundef) local_unnamed_addr #2

; Function Attrs: mustprogress uwtable
define dso_local noundef zeroext i1 @_ZNK13ArrayVariable10is_variantEPK8Variable(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(288) %0, ptr nofree noundef readonly %1) local_unnamed_addr #0 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 96
  %i.b = load i8, ptr %i.a, align 8, !tbaa !167, !range !168, !noundef !101
  %i.c = trunc nuw i8 %i.b to i1
  br i1 %i.c, label %bb.b, label %.thread

bb.b:                                             ; preds = %bb.a
  %i.d = tail call ptr @__dynamic_cast(ptr nonnull %1, ptr nonnull @_ZTI8Variable, ptr nonnull @_ZTI13ArrayVariable, i64 0) #21 ; 3 uses
...
bb.c:                                             ; preds = %bb.b
  %i.j = getelementptr inbounds nuw i8, ptr %i.d, i64 240 ; 2 uses
  ...
  %i.p = sub i64 %i.n, %i.o
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 240 ; 2 uses
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 248 ; 2 uses
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !75   ; 2 uses
  %i.t = load ptr, ptr %i.q, align 8, !tbaa !78   ; 3 uses
...
.preheader:                                       ; preds = %bb.c
  %.not2833 = icmp eq ptr %i.s, %i.t
  br i1 %.not2833, label %.thread, label %.lr.ph

bb.d:                                             ; preds = %.critedge
  %i.y = add nuw i64 %.01934, 1                   ; 2 uses
  %i.z = load ptr, ptr %i.r, align 8, !tbaa !75
...
bb.b:                                             ; preds = %.lr.ph, %bb.c
  %.08 = phi ptr [ %1, %.lr.ph ], [ %i.e, %bb.c ] ; 2 uses
  %i.c = icmp eq ptr %.08, %i.b                   ; 3 uses
  br i1 %i.c, label %._crit_edge, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.d = getelementptr inbounds nuw i8, ptr %.08, i64 24
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !173  ; 2 uses
  %.not.not = icmp eq ptr %i.e, null
  br i1 %.not.not, label %._crit_edge, label %bb.b, !llvm.loop !169

._crit_edge:                                      ; preds = %bb.b, %bb.c, %bb.a
  %.not.lcssa = phi i1 [ false, %bb.a ], [ %i.c, %bb.c ], [ %i.c, %bb.b ]
  ret i1 %.not.lcssa
}
