...
bb.ca:                                            ; preds = %bb.bz
  ...
  %i.lu = load float, ptr %i.lt, align 4, !noundef !4
  ...
  %i.lx = load float, ptr %i.lw, align 4, !noundef !4
...
bb.cc:                                            ; preds = %bb.cb
  ...
  %i.ma = load float, ptr %i.lz, align 8, !noundef !4
  ...
  %i.md = load float, ptr %i.mc, align 4, !noundef !4
...
bb.ce:                                            ; preds = %bb.cd
  ...
  %i.mg = load float, ptr %i.mf, align 4, !noundef !4
...
bb.cf:                                            ; preds = %bb.z
  ...
  %i.mj = load i64, ptr %i.co, align 8, !noundef !4
...
bb.ch:                                            ; preds = %bb.cg
  ...
  %i.mr = load i64, ptr %0, align 8, !noundef !4
...
.noexc112:                                        ; preds = %bb.ci
  ...
  %i.my = load i64, ptr %i.mx, align 8, !alias.scope !12746, !noundef !4
  %i.mz = getelementptr inbounds nuw i8, ptr %i.mw, i64 1024 ; 2 uses
  %i.na = load i64, ptr %i.mz, align 8, !alias.scope !12749, !noundef !4
  %i.nb = add i64 %i.na, %i.my
  store i64 %i.nb, ptr %i.mx, align 8, !alias.scope !12752
...
vector.body340:                                   ; preds = %.noexc112, %vector.body340
  ...
  %wide.load342 = load <4 x i32>, ptr %i.nc, align 8, !alias.scope !12755, !noalias !12758
  %wide.load343 = load <4 x i32>, ptr %i.nd, align 8, !alias.scope !12755, !noalias !12758
  %i.ne = getelementptr inbounds nuw [4 x i8], ptr %i.mw, i64 %index341 ; 2 uses
  %i.nf = getelementptr inbounds nuw i8, ptr %i.ne, i64 16
  %wide.load344 = load <4 x i32>, ptr %i.ne, align 8, !alias.scope !12758
  %wide.load345 = load <4 x i32>, ptr %i.nf, align 8, !alias.scope !12758
  %i.ng = add <4 x i32> %wide.load344, %wide.load342
  %i.nh = add <4 x i32> %wide.load345, %wide.load343
  store <4 x i32> %i.ng, ptr %i.nc, align 8, !alias.scope !12755, !noalias !12758
  store <4 x i32> %i.nh, ptr %i.nd, align 8, !alias.scope !12755, !noalias !12758
  ...
  %wide.load342.1 = load <4 x i32>, ptr %i.ni, align 8, !alias.scope !12755, !noalias !12758
  %wide.load343.1 = load <4 x i32>, ptr %i.nj, align 8, !alias.scope !12755, !noalias !12758
  ...
  %wide.load344.1 = load <4 x i32>, ptr %i.nk, align 8, !alias.scope !12758
  %wide.load345.1 = load <4 x i32>, ptr %i.nl, align 8, !alias.scope !12758
  %i.nm = add <4 x i32> %wide.load344.1, %wide.load342.1
  %i.nn = add <4 x i32> %wide.load345.1, %wide.load343.1
  store <4 x i32> %i.nm, ptr %i.ni, align 8, !alias.scope !12755, !noalias !12758
  store <4 x i32> %i.nn, ptr %i.nj, align 8, !alias.scope !12755, !noalias !12758
  %index.next346.1 = add nuw nsw i64 %index341, 16 ; 2 uses
  %i.no = icmp eq i64 %index.next346.1, 256
  br i1 %i.no, label %middle.block347, label %vector.body340, !llvm.loop !12760
...
.noexc112.1:                                      ; preds = %bb.ck
  ...
  %i.ph = load i64, ptr %i.pg, align 8, !alias.scope !12746, !noundef !4
  %i.pi = getelementptr inbounds nuw i8, ptr %i.pf, i64 1024 ; 2 uses
  %i.pj = load i64, ptr %i.pi, align 8, !alias.scope !12749, !noundef !4
  %i.pk = add i64 %i.pj, %i.ph
  store i64 %i.pk, ptr %i.pg, align 8, !alias.scope !12752
...
vector.body:                                      ; preds = %.noexc112.1, %vector.body
  ...
  %wide.load = load <4 x i32>, ptr %i.pl, align 8, !alias.scope !12762, !noalias !12765
  %wide.load330 = load <4 x i32>, ptr %i.pm, align 8, !alias.scope !12762, !noalias !12765
  %i.pn = getelementptr inbounds nuw [4 x i8], ptr %i.pf, i64 %index ; 2 uses
  %i.po = getelementptr inbounds nuw i8, ptr %i.pn, i64 16
  %wide.load331 = load <4 x i32>, ptr %i.pn, align 8, !alias.scope !12765
  %wide.load332 = load <4 x i32>, ptr %i.po, align 8, !alias.scope !12765
  %i.pp = add <4 x i32> %wide.load331, %wide.load
  %i.pq = add <4 x i32> %wide.load332, %wide.load330
  store <4 x i32> %i.pp, ptr %i.pl, align 8, !alias.scope !12762, !noalias !12765
  store <4 x i32> %i.pq, ptr %i.pm, align 8, !alias.scope !12762, !noalias !12765
  %index.next = or disjoint i64 %index, 8         ; 2 uses
  ...
  %wide.load.1 = load <4 x i32>, ptr %i.pr, align 8, !alias.scope !12762, !noalias !12765
  %wide.load330.1 = load <4 x i32>, ptr %i.ps, align 8, !alias.scope !12762, !noalias !12765
  %i.pt = getelementptr inbounds nuw [4 x i8], ptr %i.pf, i64 %index.next ; 2 uses
  %i.pu = getelementptr inbounds nuw i8, ptr %i.pt, i64 16
  %wide.load331.1 = load <4 x i32>, ptr %i.pt, align 8, !alias.scope !12765
  %wide.load332.1 = load <4 x i32>, ptr %i.pu, align 8, !alias.scope !12765
  %i.pv = add <4 x i32> %wide.load331.1, %wide.load.1
  %i.pw = add <4 x i32> %wide.load332.1, %wide.load330.1
  store <4 x i32> %i.pv, ptr %i.pr, align 8, !alias.scope !12762, !noalias !12765
  store <4 x i32> %i.pw, ptr %i.ps, align 8, !alias.scope !12762, !noalias !12765
  %index.next.1 = add nuw nsw i64 %index, 16      ; 2 uses
  %i.px = icmp eq i64 %index.next.1, 256
  br i1 %i.px, label %middle.block, label %vector.body, !llvm.loop !12767
...
.loopexit:                                        ; preds = %bb.cl
  ...
  %i.rg = load float, ptr %i.rf, align 4, !noundef !4
...
"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i": ; preds = %.loopexit.split-lp.thread, %.thread, %.loopexit.split-lp
  ...
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.sroa.10.0.i.i.i, i64 noundef %i.bw, i64 noundef 8) #45
  br label %bb.cm
}

; Function Attrs: nonlazybind uwtable
define internal fastcc void @_ZN6brotli3enc9metablock34BrotliBuildMetaBlockGreedyInternal17h9719acd4736b0fc5E(ptr noalias noundef nonnull readonly align 1 captures(none) %0, i64 noundef %1, i64 noundef range(i64 0, 4294967296) %2, i64 noundef range(i64 0, 4294967296) %3, i8 noundef %4, i8 noundef %5, i8 noundef range(i8 0, 4) %6, i64 noundef %7, ptr noalias noundef nonnull readonly align 4 captures(none) %8, i64 noundef %9, ptr noalias noundef nonnull readonly align 4 captures(none) %10, i64 noundef %11, i64 noundef %12, ptr noalias nofree noundef nonnull align 8 dereferenceable(264) %13) unnamed_addr #0 personality ptr @rust_eh_personality {
bb.a:
...
.lr.ph.preheader:                                 ; preds = %bb.a
  %i.d = add i64 %12, -1
  %.not288.not = icmp ugt i64 %11, %i.d
  br i1 %.not288.not, label %.lr.ph.preheader552, label %bb.cl

.lr.ph.preheader552:                              ; preds = %.lr.ph.preheader
  %xtraiter = and i64 %12, 3                      ; 3 uses
  %i.e = icmp ult i64 %12, 4
  br i1 %i.e, label %.lr.ph.epil.preheader, label %.lr.ph.preheader552.new

.lr.ph.preheader552.new:                          ; preds = %.lr.ph.preheader552
  %unroll_iter = and i64 %12, -4
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader552.new
  %i.f = phi i64 [ 1, %.lr.ph.preheader552.new ], [ %i.z, %.lr.ph ] ; 5 uses
  %.sroa.08.0119 = phi i64 [ 0, %.lr.ph.preheader552.new ], [ %i.y, %.lr.ph ]
  %.sroa.019.0118 = phi i64 [ 0, %.lr.ph.preheader552.new ], [ %i.t, %.lr.ph ]
  %niter = phi i64 [ 0, %.lr.ph.preheader552.new ], [ %niter.next.3, %.lr.ph ]
