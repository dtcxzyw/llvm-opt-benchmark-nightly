...
begin_hunk_0_@_ZN4jiff3fmt7strtime14BrokenDownTime7to_date7to_date17h8186537ab608891cE:bb.a
  %i.aj = load i8, ptr %i.ai, align 1, !alias.scope !3414, !noalias !3415
  call void @llvm.lifetime.start.p0(ptr nonnull %i.p), !noalias !3416
  call fastcc void @_ZN4jiff5civil4date4Date3new17h8f75b13fdc83d48aE(ptr noalias noundef align 8 captures(address) dereferenceable(16) %i.p, i16 noundef %i.z, i8 noundef %i.aj, i8 noundef %i.ah), !noalias !3416
  tail call void @llvm.experimental.noalias.scope.decl(metadata !3417)
  %i.ak = load i16, ptr %i.p, align 8, !range !62, !alias.scope !3417, !noalias !3418, !noundef !11
...
.thread105:                                       ; preds = %bb.c
  ...
  %.sroa.0.0.copyload.i.i = load i32, ptr %i.am, align 2, !alias.scope !3417, !noalias !3418
  call void @llvm.lifetime.end.p0(ptr nonnull %i.p), !noalias !3416
  br label %.thread130
...
bb.e:                                             ; preds = %bb.c
  ...
  %i.aq = load ptr, ptr %i.ap, align 8, !alias.scope !3417, !noalias !3418, !noundef !11
  call void @llvm.lifetime.start.p0(ptr nonnull %i.o), !noalias !3419
  store i8 9, ptr %i.o, align 8, !noalias !3419
  %i.ar = call fastcc noundef ptr @"_ZN92_$LT$core..result..Result$LT$T$C$E$GT$$u20$as$u20$jiff..error..ErrorContext$LT$T$C$E$GT$$GT$7context28_$u7b$$u7b$closure$u7d$$u7d$17h8d1c818ace875e4eE"(ptr noalias noundef align 8 captures(address) dereferenceable(24) %i.o, ptr noundef %i.aq), !noalias !3419
  call void @llvm.lifetime.end.p0(ptr nonnull %i.o), !noalias !3419
  call void @llvm.lifetime.end.p0(ptr nonnull %i.p), !noalias !3416
...
bb.k:                                             ; preds = %bb.j
  %i.bg = tail call fastcc noundef nonnull ptr @_ZN4jiff5error5Error6bounds17h66a72a993116514bE(i8 noundef range(i8 0, 52) 46), !noalias !3420
  call void @llvm.lifetime.start.p0(ptr nonnull %i.l), !noalias !3421
  store ptr %i.bg, ptr %i.l, align 8, !noalias !3421
  invoke void @_ZN4core6result13unwrap_failed17h0501379eaec3e720E(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) @52, i64 noundef 43, ptr noundef nonnull align 1 %i.l, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @48, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @200) #45
          to label %bb.o unwind label %bb.l, !noalias !3422

bb.l:                                             ; preds = %bb.k
  %i.bh = landingpad { ptr, i32 }
          cleanup
  call void @llvm.experimental.noalias.scope.decl(metadata !3423)
  %i.bi = load ptr, ptr %i.l, align 8, !alias.scope !3424, !noalias !3422, !noundef !11 ; 2 uses
  %i.bj = icmp eq ptr %i.bi, null
  br i1 %i.bj, label %"_ZN4core3ptr39drop_in_place$LT$jiff..error..Error$GT$17hadb9d69fbefd2150E.exit.i", label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.bk = atomicrmw sub ptr %i.bi, i64 1 release, align 8, !noalias !3425
...
bb.n:                                             ; preds = %bb.m
  ...
  invoke void @"_ZN5alloc4sync16Arc$LT$T$C$A$GT$9drop_slow17h9b7ec78a5db80eeeE"(ptr noalias noundef nonnull readonly align 8 dereferenceable(8) %i.l)
          to label %"_ZN4core3ptr39drop_in_place$LT$jiff..error..Error$GT$17hadb9d69fbefd2150E.exit.i" unwind label %bb.p, !noalias !3427, !inline_history !25
...
bb.p:                                             ; preds = %bb.n
  ...
  call void @_ZN4core9panicking16panic_in_cleanup17h5eff40bcc4481d72E() #46, !noalias !3422
  unreachable
...
"_ZN4core6result19Result$LT$T$C$E$GT$6unwrap17heaadf476ce029772E.exit.i": ; preds = %bb.j
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.n), !noalias !3427
  call void @llvm.lifetime.start.p0(ptr nonnull %i.m), !noalias !3427
  ...
  store i32 %.sroa.4.5.insert.insert.i, ptr %i.bn, align 2, !noalias !3427
  %i.bo = getelementptr inbounds nuw i8, ptr %i.m, i64 2
  store i8 2, ptr %i.bo, align 2, !noalias !3427
  store i8 0, ptr %i.m, align 2, !noalias !3427
  %i.bp = getelementptr inbounds nuw i8, ptr %i.m, i64 6
  store i32 %.sroa.012.0.insert.insert.i, ptr %i.bp, align 2, !noalias !3427
  call fastcc void @_ZN4jiff5civil4date8DateWith5build17h16f59ab13caeb75bE(ptr noalias noundef align 8 captures(address) dereferenceable(16) %i.n, ptr noalias noundef readonly align 2 captures(address) dereferenceable(14) %i.m), !noalias !3427
  call void @llvm.lifetime.end.p0(ptr nonnull %i.m), !noalias !3427
  tail call void @llvm.experimental.noalias.scope.decl(metadata !3428)
  %i.bq = load i16, ptr %i.n, align 8, !range !62, !alias.scope !3428, !noalias !3429, !noundef !11
...
.thread140:                                       ; preds = %"_ZN4core6result19Result$LT$T$C$E$GT$6unwrap17heaadf476ce029772E.exit.i"
  ...
  %.sroa.0.0.copyload.i17.i = load i32, ptr %i.bs, align 2, !alias.scope !3428, !noalias !3429
  call void @llvm.lifetime.end.p0(ptr nonnull %i.n), !noalias !3427
  br label %.thread130
...
bb.q:                                             ; preds = %"_ZN4core6result19Result$LT$T$C$E$GT$6unwrap17heaadf476ce029772E.exit.i"
  ...
  %i.bu = load ptr, ptr %i.bt, align 8, !alias.scope !3428, !noalias !3429, !noundef !11
  call void @llvm.lifetime.start.p0(ptr nonnull %i.k), !noalias !3430
  store i8 9, ptr %i.k, align 8, !noalias !3430
  %i.bv = call fastcc noundef ptr @"_ZN92_$LT$core..result..Result$LT$T$C$E$GT$$u20$as$u20$jiff..error..ErrorContext$LT$T$C$E$GT$$GT$7context28_$u7b$$u7b$closure$u7d$$u7d$17h8d1c818ace875e4eE"(ptr noalias noundef align 8 captures(address) dereferenceable(24) %i.k, ptr noundef %i.bu), !noalias !3430
  call void @llvm.lifetime.end.p0(ptr nonnull %i.k), !noalias !3430
  call void @llvm.lifetime.end.p0(ptr nonnull %i.n), !noalias !3427
...
bb.r:                                             ; preds = %bb.i
  ...
  %i.by = load i8, ptr %i.bx, align 2, !range !21, !alias.scope !3431, !noalias !3432, !noundef !11
  %i.bz = trunc nuw i8 %i.by to i1
  %i.ca = getelementptr inbounds nuw i8, ptr %1, i64 99
  %i.cb = load i8, ptr %i.ca, align 1, !alias.scope !3431, !noalias !3432 ; 2 uses
  %i.cc = getelementptr inbounds nuw i8, ptr %1, i64 109
  %i.cd = load i8, ptr %i.cc, align 1, !range !26, !alias.scope !3431, !noalias !3432, !noundef !11 ; 6 uses
...
bb.t:                                             ; preds = %bb.s
  %i.ck = tail call fastcc noundef nonnull ptr @_ZN4jiff5error5Error6bounds17h66a72a993116514bE(i8 noundef range(i8 0, 52) 46), !noalias !3433
  call void @llvm.lifetime.start.p0(ptr nonnull %i.g), !noalias !3434
  store i8 9, ptr %i.g, align 8, !noalias !3434
  %i.cl = call fastcc noundef ptr @"_ZN92_$LT$core..result..Result$LT$T$C$E$GT$$u20$as$u20$jiff..error..ErrorContext$LT$T$C$E$GT$$GT$7context28_$u7b$$u7b$closure$u7d$$u7d$17h8d1c818ace875e4eE"(ptr noalias noundef align 8 captures(address) dereferenceable(24) %i.g, ptr noundef nonnull %i.ck), !noalias !3434
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g), !noalias !3434
  br label %bb.aa
...
bb.u:                                             ; preds = %bb.s
  ...
  %i.cw = sub nuw nsw i32 %i.cv, %i.cu
...
bb.x:                                             ; preds = %bb.w
  call void @llvm.lifetime.start.p0(ptr nonnull %i.j), !noalias !3435
  %i.dl = getelementptr inbounds nuw i8, ptr %i.j, i64 1
  store i8 %i.cd, ptr %i.dl, align 1, !noalias !3435
  store i8 12, ptr %i.j, align 8, !noalias !3435
  %i.dm = call noundef ptr @"_ZN4jiff5error3fmt7strtime108_$LT$impl$u20$core..convert..From$LT$jiff..error..fmt..strtime..Error$GT$$u20$for$u20$jiff..error..Error$GT$4from17h57bc27f59ec061bdE"(ptr noalias noundef nonnull readonly align 8 captures(address) dereferenceable(24) %i.j), !noalias !3435
  call void @llvm.lifetime.end.p0(ptr nonnull %i.j), !noalias !3435
  br label %bb.aa

bb.y:                                             ; preds = %bb.w, %bb.v
  %.sroa.015.0.i = phi i16 [ %i.dh, %bb.v ], [ %i.dj, %bb.w ]
  call void @llvm.lifetime.start.p0(ptr nonnull %i.i), !noalias !3435
  call void @llvm.lifetime.start.p0(ptr nonnull %i.h), !noalias !3435
  ...
  store i32 %.sroa.4.5.insert.insert.i75, ptr %i.dn, align 2, !noalias !3435
  %i.do = getelementptr inbounds nuw i8, ptr %i.h, i64 2
  store i8 2, ptr %i.do, align 2, !noalias !3435
  store i8 0, ptr %i.h, align 2, !noalias !3435
  %i.dp = getelementptr inbounds nuw i8, ptr %i.h, i64 6
  store i32 %.sroa.066.0.insert.insert.i, ptr %i.dp, align 2, !noalias !3435
  call fastcc void @_ZN4jiff5civil4date8DateWith5build17h16f59ab13caeb75bE(ptr noalias noundef align 8 captures(address) dereferenceable(16) %i.i, ptr noalias noundef readonly align 2 captures(address) dereferenceable(14) %i.h), !noalias !3435
  call void @llvm.lifetime.end.p0(ptr nonnull %i.h), !noalias !3435
  tail call void @llvm.experimental.noalias.scope.decl(metadata !3436)
  %i.dq = load i16, ptr %i.i, align 8, !range !62, !alias.scope !3436, !noalias !3437, !noundef !11
  %i.dr = trunc nuw i16 %i.dq to i1
  br i1 %i.dr, label %bb.z, label %.thread144

bb.z:                                             ; preds = %bb.y
  %i.ds = getelementptr inbounds nuw i8, ptr %i.i, i64 8
  %i.dt = load ptr, ptr %i.ds, align 8, !alias.scope !3436, !noalias !3437, !noundef !11
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f), !noalias !3438
  store i8 9, ptr %i.f, align 8, !noalias !3438
  %i.du = call fastcc noundef ptr @"_ZN92_$LT$core..result..Result$LT$T$C$E$GT$$u20$as$u20$jiff..error..ErrorContext$LT$T$C$E$GT$$GT$7context28_$u7b$$u7b$closure$u7d$$u7d$17h8d1c818ace875e4eE"(ptr noalias noundef align 8 captures(address) dereferenceable(24) %i.f, ptr noundef %i.dt), !noalias !3438
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f), !noalias !3438
  call void @llvm.lifetime.end.p0(ptr nonnull %i.i), !noalias !3435
  br label %bb.aa

.thread144:                                       ; preds = %bb.y
  %i.dv = getelementptr inbounds nuw i8, ptr %i.i, i64 2
  %.sroa.0.0.copyload.i91.i = load i32, ptr %i.dv, align 2, !alias.scope !3436, !noalias !3437
  call void @llvm.lifetime.end.p0(ptr nonnull %i.i), !noalias !3435
  br label %.thread130
...
bb.ab:                                            ; preds = %bb.r
  ...
  %i.dy = load i8, ptr %i.dx, align 4, !range !21, !alias.scope !3439, !noalias !3440, !noundef !11
  %i.dz = trunc nuw i8 %i.dy to i1
  %i.ea = getelementptr inbounds nuw i8, ptr %1, i64 101
  %i.eb = load i8, ptr %i.ea, align 1, !alias.scope !3439, !noalias !3440 ; 2 uses
...
bb.ad:                                            ; preds = %bb.ac
  %i.ej = tail call fastcc noundef nonnull ptr @_ZN4jiff5error5Error6bounds17h66a72a993116514bE(i8 noundef range(i8 0, 52) 46), !noalias !3441
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !3442
  store i8 9, ptr %i.b, align 8, !noalias !3442
  %i.ek = call fastcc noundef ptr @"_ZN92_$LT$core..result..Result$LT$T$C$E$GT$$u20$as$u20$jiff..error..ErrorContext$LT$T$C$E$GT$$GT$7context28_$u7b$$u7b$closure$u7d$$u7d$17h8d1c818ace875e4eE"(ptr noalias noundef align 8 captures(address) dereferenceable(24) %i.b, ptr noundef nonnull %i.ej), !noalias !3442
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !3442
  br label %bb.ak
...
bb.ae:                                            ; preds = %bb.ac
  ...
  %i.ev = sub nuw nsw i32 %i.eu, %i.et
...
bb.ah:                                            ; preds = %bb.ag
  ...
  store i8 %i.cd, ptr %i.fj, align 1, !noalias !3443
  store i8 11, ptr %i.e, align 8, !noalias !3443
  %i.fk = call noundef ptr @"_ZN4jiff5error3fmt7strtime108_$LT$impl$u20$core..convert..From$LT$jiff..error..fmt..strtime..Error$GT$$u20$for$u20$jiff..error..Error$GT$4from17h57bc27f59ec061bdE"(ptr noalias noundef nonnull readonly align 8 captures(address) dereferenceable(24) %i.e), !noalias !3443
...
bb.ai:                                            ; preds = %bb.ag, %bb.af
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !3443
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !3443
  ...
  store i32 %.sroa.4.5.insert.insert.i82, ptr %i.fl, align 2, !noalias !3443
  %i.fm = getelementptr inbounds nuw i8, ptr %i.c, i64 2
  store i8 2, ptr %i.fm, align 2, !noalias !3443
  store i8 0, ptr %i.c, align 2, !noalias !3443
  %i.fn = getelementptr inbounds nuw i8, ptr %i.c, i64 6
  store i32 %.sroa.065.0.insert.insert.i, ptr %i.fn, align 2, !noalias !3443
  call fastcc void @_ZN4jiff5civil4date8DateWith5build17h16f59ab13caeb75bE(ptr noalias noundef align 8 captures(address) dereferenceable(16) %i.d, ptr noalias noundef readonly align 2 captures(address) dereferenceable(14) %i.c), !noalias !3443
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !3443
  tail call void @llvm.experimental.noalias.scope.decl(metadata !3444)
  %i.fo = load i16, ptr %i.d, align 8, !range !62, !alias.scope !3444, !noalias !3445, !noundef !11
  %i.fp = trunc nuw i16 %i.fo to i1
  br i1 %i.fp, label %bb.aj, label %.thread151

bb.aj:                                            ; preds = %bb.ai
  %i.fq = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  %i.fr = load ptr, ptr %i.fq, align 8, !alias.scope !3444, !noalias !3445, !noundef !11
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !3446
  store i8 9, ptr %i.a, align 8, !noalias !3446
  %i.fs = call fastcc noundef ptr @"_ZN92_$LT$core..result..Result$LT$T$C$E$GT$$u20$as$u20$jiff..error..ErrorContext$LT$T$C$E$GT$$GT$7context28_$u7b$$u7b$closure$u7d$$u7d$17h8d1c818ace875e4eE"(ptr noalias noundef align 8 captures(address) dereferenceable(24) %i.a, ptr noundef %i.fr), !noalias !3446
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !3446
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !3443
  br label %bb.ak

.thread151:                                       ; preds = %bb.ai
  %i.ft = getelementptr inbounds nuw i8, ptr %i.d, i64 2
  %.sroa.0.0.copyload.i89.i = load i32, ptr %i.ft, align 2, !alias.scope !3444, !noalias !3445
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !3443
  br label %.thread130
