...
6:                                                ; preds = %.backedge.i55, %.lr.ph.i
  %.sroa.4.032.i = phi i64 [ %i.vt, %.lr.ph.i ], [ %7, %.backedge.i55 ] ; 4 uses
  %7 = add nsw i64 %.sroa.4.032.i, -1             ; 2 uses
  %.not10.i = icmp ult i64 %.sroa.4.032.i, %.sroa.521.sroa.5.0.copyload
  br i1 %.not10.i, label %bb.dh, label %.backedge.i55
...
_ZN5milli6prompt8truncate17h982bb0acbc2e5e52E.exit: ; preds = %.backedge.i55, %bb.dh, %bb.dg, %bb.df
  ...
  %i.vz = icmp eq i64 %.val44, 0
  br i1 %i.vz, label %"_ZN4core3ptr96drop_in_place$LT$milli..prompt..fields..OwnedFields$LT$milli..prompt..document..Document$GT$$GT$17ha3271bc253efce60E.exit52", label %"_ZN4core3ptr96drop_in_place$LT$milli..prompt..fields..OwnedFields$LT$milli..prompt..document..Document$GT$$GT$17ha3271bc253efce60E.exit52.sink.split"
...
"_ZN4core3ptr96drop_in_place$LT$milli..prompt..fields..OwnedFields$LT$milli..prompt..document..Document$GT$$GT$17ha3271bc253efce60E.exit52.sink.split": ; preds = %_ZN5milli6prompt8truncate17h982bb0acbc2e5e52E.exit, %bb.de
  ...
  %i.wb = mul nuw i64 %.val44.sink, 48
  call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val45, i64 noundef %i.wb, i64 noundef range(i64 1, -9223372036854775807) 8) #101, !noalias !10
