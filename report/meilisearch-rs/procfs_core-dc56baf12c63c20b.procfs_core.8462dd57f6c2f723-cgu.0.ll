...
bb.ag:                                            ; preds = %"_ZN4core6result19Result$LT$T$C$E$GT$6unwrap17h397c910180e990c0E.exit"
  ...
  %i.ei = trunc i32 %i.ec to i16
  %i.ej = trunc nuw i32 %i.eg to i16
  %i.ek = trunc i32 %i.dw to i16
  %i.el = trunc nuw i32 %i.ef to i16
  %i.em = trunc i32 %i.dt to i16
  %i.en = trunc nuw i32 %i.ee to i16
  %i.eo = trunc i32 %i.do to i16
  %i.ep = trunc nuw i32 %i.ed to i16
  %i.eq = insertelement <8 x i16> poison, i16 %i.ep, i64 0
  %i.er = insertelement <8 x i16> %i.eq, i16 %i.eo, i64 1
  %i.es = insertelement <8 x i16> %i.er, i16 %i.en, i64 2
  %i.et = insertelement <8 x i16> %i.es, i16 %i.em, i64 3
  %i.eu = insertelement <8 x i16> %i.et, i16 %i.el, i64 4
  %i.ev = insertelement <8 x i16> %i.eu, i16 %i.ek, i64 5
  %i.ew = insertelement <8 x i16> %i.ev, i16 %i.ej, i64 6
  %i.ex = insertelement <8 x i16> %i.ew, i16 %i.ei, i64 7
