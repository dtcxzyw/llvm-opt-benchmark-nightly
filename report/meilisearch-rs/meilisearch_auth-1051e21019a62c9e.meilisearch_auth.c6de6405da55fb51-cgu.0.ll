...
_ZN16meilisearch_auth5store18try_split_array_at17h2d72f07d07204513E.exit.i.i.i.i.i: ; preds = %bb.w
  ...
  br i1 %4, label %.noexc44.i, label %.noexc8.i.i.i.i.i
...
bb.d:                                             ; preds = %bb.a
  ...
  %.sroa.086.0.copyload = load i48, ptr %i.ad, align 2 ; 6 uses
...
"_ZN114_$LT$time..offset_date_time..OffsetDateTime$u20$as$u20$time..formatting..component_provider..ComponentProvider$GT$8iso_year17h57fc8a8108d781a0E.exit.i": ; preds = %bb.dc, %bb.db, %bb.cz
  ...
  %5 = trunc i48 %.sroa.024.3.extract.shift.i to i1
  %trunc.i209.i = trunc nuw i48 %sum.shift.i to i8
...
.thread.i.i:                                      ; preds = %bb.dl, %bb.dh
  ...
  br i1 %5, label %bb.dp, label %bb.dr
...
bb.cy:                                            ; preds = %bb.co
  call void @llvm.lifetime.end.p0(ptr nonnull %i.al), !noalias !9762
  %3 = trunc nuw i8 %.sroa.524.02300.i.i.i.i to i1
  br i1 %3, label %bb.gp, label %.invoke, !prof !22

bb.cz:                                            ; preds = %bb.cp
  call void @llvm.lifetime.end.p0(ptr nonnull %i.al), !noalias !9762
  %4 = trunc nuw i8 %.sroa.532.02298.i.i.i.i to i1
  br i1 %4, label %bb.gv, label %.invoke, !prof !22
