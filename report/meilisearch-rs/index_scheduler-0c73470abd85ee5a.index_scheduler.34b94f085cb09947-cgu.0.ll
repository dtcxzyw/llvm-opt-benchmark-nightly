...
end_hunk_14
begin_hunk_15_@"_ZN8indexmap5inner17Core$LT$K$C$V$GT$15reserve_entries17he8fdee756bd21cb2E":bb.a
  tail call void @llvm.experimental.noalias.scope.decl(metadata !234601)
  %i.p = add i64 %i.k, %1                         ; 4 uses
  %i.q = icmp ult i64 %i.p, %i.k
  br i1 %i.q, label %bb.f, label %bb.c, !prof !121

bb.c:                                             ; preds = %bb.b
  %i.r = mul nuw nsw i64 %i.p, 104
  %or.cond.i.i.i.i = icmp ugt i64 %i.p, 88686269585142075
  br i1 %or.cond.i.i.i.i, label %bb.f, label %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i, !prof !2997

_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i: ; preds = %bb.c
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !234604
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !234604
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.t = icmp eq i64 %.pre, 0
  br i1 %i.t, label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$14current_memory17h5e7bdf809e413b8aE.exit.i.i.i", label %bb.d

bb.d:                                             ; preds = %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i
  %.val28.i.i.i = load ptr, ptr %i.s, align 8, !alias.scope !234606, !noalias !234607, !nonnull !14, !noundef !14
  %i.u = mul nuw i64 %.pre, 104
  store ptr %.val28.i.i.i, ptr %i.c, align 8, !alias.scope !234608, !noalias !234604
  %.sroa.5.0..sroa_idx.i.i.i.i = getelementptr inbounds nuw i8, ptr %i.c, i64 16
  store i64 %i.u, ptr %.sroa.5.0..sroa_idx.i.i.i.i, align 8, !alias.scope !234608, !noalias !234604
  br label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$14current_memory17h5e7bdf809e413b8aE.exit.i.i.i"

"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$14current_memory17h5e7bdf809e413b8aE.exit.i.i.i": ; preds = %bb.d, %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i
  %.sink.i.i.i.i = phi i64 [ 8, %bb.d ], [ 0, %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i ]
  %i.v = getelementptr inbounds nuw i8, ptr %i.c, i64 8
  store i64 %.sink.i.i.i.i, ptr %i.v, align 8, !alias.scope !234608, !noalias !234604
  call fastcc void @_ZN5alloc7raw_vec11finish_grow17h420bbf6261080cfeE(ptr noalias noundef align 8 captures(address) dereferenceable(24) %i.d, i64 noundef 8, i64 noundef %i.r, ptr noalias noundef readonly align 8 captures(address) dereferenceable(24) %i.c), !noalias !234604
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !234604
  %i.w = load i64, ptr %i.d, align 8, !range !751, !noalias !234604, !noundef !14
  %i.x = trunc nuw i64 %i.w to i1
  %i.y = getelementptr inbounds nuw i8, ptr %i.d, i64 8 ; 2 uses
  br i1 %i.x, label %bb.e, label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$10grow_exact17h6592b079710fe321E.exit.i.i"

bb.e:                                             ; preds = %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$14current_memory17h5e7bdf809e413b8aE.exit.i.i.i"
  %i.z = load i64, ptr %i.y, align 8, !range !2917, !noalias !234604, !noundef !14
  %i.aa = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  %i.ab = load i64, ptr %i.aa, align 8, !noalias !234604
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !234604
  br label %bb.f

"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$10grow_exact17h6592b079710fe321E.exit.i.i": ; preds = %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$14current_memory17h5e7bdf809e413b8aE.exit.i.i.i"
  %i.ac = load ptr, ptr %i.y, align 8, !noalias !234604, !nonnull !14, !noundef !14
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !234604
  store ptr %i.ac, ptr %i.s, align 8, !alias.scope !234606, !noalias !234607
  br label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$13reserve_exact17h000363cad3486ebcE.exit.sink.split"
...
bb.f:                                             ; preds = %bb.e, %bb.c, %bb.b
  ...
  tail call void @_ZN5alloc7raw_vec12handle_error17h5794e6eba25188a7E(i64 noundef %.sroa.0.0.i.ph.i, i64 %.sroa.3.0.i.ph.i, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) @5992) #80, !noalias !234595
  unreachable

bb.g:                                             ; preds = %bb.a
  tail call void @llvm.experimental.noalias.scope.decl(metadata !234611)
  %i.ad = sub nsw i64 %.pre, %i.k                 ; 3 uses
  %i.ae = icmp ugt i64 %i.m, %i.ad
  br i1 %i.ae, label %bb.h, label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$13reserve_exact17h000363cad3486ebcE.exit"

bb.h:                                             ; preds = %bb.g
  tail call void @llvm.experimental.noalias.scope.decl(metadata !234614)
  %i.af = icmp ult i64 %i.i, %i.k
  br i1 %i.af, label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$17try_reserve_exact17hb0f300f6159901f7E.exit.thread", label %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i, !prof !121

_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i: ; preds = %bb.h
  %i.ag = mul nuw nsw i64 %.sroa.0.0.i, 104
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !234617
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !234617
  %i.ah = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.ai = icmp eq i64 %.pre, 0
  br i1 %i.ai, label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$14current_memory17h5e7bdf809e413b8aE.exit.i.i", label %bb.i

bb.i:                                             ; preds = %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i
  %.val28.i.i = load ptr, ptr %i.ah, align 8, !alias.scope !234617, !nonnull !14, !noundef !14
  %i.aj = mul nuw i64 %.pre, 104
  store ptr %.val28.i.i, ptr %i.a, align 8, !alias.scope !234618, !noalias !234617
  %.sroa.5.0..sroa_idx.i.i.i = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store i64 %i.aj, ptr %.sroa.5.0..sroa_idx.i.i.i, align 8, !alias.scope !234618, !noalias !234617
  br label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$14current_memory17h5e7bdf809e413b8aE.exit.i.i"

"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$14current_memory17h5e7bdf809e413b8aE.exit.i.i": ; preds = %bb.i, %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i
  %.sink.i.i.i = phi i64 [ 8, %bb.i ], [ 0, %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i ]
  %i.ak = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store i64 %.sink.i.i.i, ptr %i.ak, align 8, !alias.scope !234618, !noalias !234617
  call fastcc void @_ZN5alloc7raw_vec11finish_grow17h420bbf6261080cfeE(ptr noalias noundef align 8 captures(address) dereferenceable(24) %i.b, i64 noundef 8, i64 noundef %i.ag, ptr noalias noundef readonly align 8 captures(address) dereferenceable(24) %i.a), !noalias !234617
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !234617
  %i.al = load i64, ptr %i.b, align 8, !range !751, !noalias !234617, !noundef !14
  %i.am = trunc nuw i64 %i.al to i1
  br i1 %i.am, label %bb.j, label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$10grow_exact17h6592b079710fe321E.exit.i"

bb.j:                                             ; preds = %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$14current_memory17h5e7bdf809e413b8aE.exit.i.i"
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !234617
  br label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$17try_reserve_exact17hb0f300f6159901f7E.exit.thread"

"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$10grow_exact17h6592b079710fe321E.exit.i": ; preds = %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$14current_memory17h5e7bdf809e413b8aE.exit.i.i"
  %i.an = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %i.ao = load ptr, ptr %i.an, align 8, !noalias !234617, !nonnull !14, !noundef !14
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !234617
  store ptr %i.ao, ptr %i.ah, align 8, !alias.scope !234617
  br label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$13reserve_exact17h000363cad3486ebcE.exit.sink.split"

"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$13reserve_exact17h000363cad3486ebcE.exit.sink.split": ; preds = %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$10grow_exact17h6592b079710fe321E.exit.i.i", %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$10grow_exact17h6592b079710fe321E.exit.i"
  %.sroa.0.0.i.sink = phi i64 [ %.sroa.0.0.i, %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$10grow_exact17h6592b079710fe321E.exit.i" ], [ %i.p, %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$10grow_exact17h6592b079710fe321E.exit.i.i" ]
  store i64 %.sroa.0.0.i.sink, ptr %0, align 8
  br label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$13reserve_exact17h000363cad3486ebcE.exit"

"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$13reserve_exact17h000363cad3486ebcE.exit": ; preds = %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$13reserve_exact17h000363cad3486ebcE.exit.sink.split", %bb.g, %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$17try_reserve_exact17hb0f300f6159901f7E.exit.thread"
  ret void
}

; Function Attrs: cold nonlazybind uwtable
define internal fastcc void @"_ZN8smallvec17SmallVec$LT$A$GT$21reserve_one_unchecked17hfe31040dc4c6d183E"(ptr noalias nofree noundef nonnull align 8 captures(none) dereferenceable(32) %0) unnamed_addr #12 personality ptr @rust_eh_personality {
bb.a:
  %i.a = alloca [16 x i8], align 8                ; 3 uses
  %i.b = load i64, ptr %0, align 8, !alias.scope !234621, !noalias !234624, !noundef !14 ; 7 uses
  %i.c = icmp ugt i64 %i.b, 3                     ; 2 uses
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 4 uses
  %i.e = load ptr, ptr %i.d, align 8, !alias.scope !234621, !noalias !234624, !nonnull !14 ; 3 uses
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.g = load i64, ptr %i.f, align 8, !alias.scope !234621, !noalias !234624
  %.sink10.i = select i1 %i.c, i64 %i.g, i64 %i.b ; 3 uses
  %i.h = icmp eq i64 %.sink10.i, -1
  br i1 %i.h, label %bb.t, label %bb.b, !prof !121
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.l, label %bb.t, label %bb.c, !prof !121

bb.c:                                             ; preds = %bb.b
  %i.m = add nuw i64 %.sroa.02.0, 1               ; 4 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !234626)
  ...
  %i.o = load i64, ptr %.sink9.i.i, align 8, !alias.scope !234626, !noundef !14 ; 5 uses
  %.not.i = icmp ult i64 %i.m, %i.o
  br i1 %.not.i, label %bb.d, label %bb.e, !prof !121

bb.d:                                             ; preds = %bb.c
  tail call void @_ZN4core9panicking5panic17ha264d2bb233f2b69E(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) @5999, i64 noundef 32, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @6000) #80, !noalias !234626
  unreachable
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %.not47.i, label %_ZN8smallvec10infallible17h5e85771fee159365E.exit, label %bb.h

bb.g:                                             ; preds = %bb.e
  br i1 %i.n, label %_ZN8smallvec10infallible17h5e85771fee159365E.exit, label %bb.o

bb.h:                                             ; preds = %bb.f
  %i.q = shl nuw i64 %i.m, 3                      ; 4 uses
  %i.r = icmp ugt i64 %.sroa.02.0, 2305843009213693950
  br i1 %i.r, label %bb.s, label %bb.i, !prof !121

bb.i:                                             ; preds = %bb.h
  %i.s = tail call noundef zeroext i1 @_ZN4core5alloc6layout6Layout19is_size_align_valid17h26adf6c6175f55f5E(i64 noundef %i.q, i64 noundef 8), !noalias !234629
  br i1 %i.s, label %_ZN8smallvec12layout_array17he0f6319a9a076c0aE.exit.i, label %bb.s

_ZN8smallvec12layout_array17he0f6319a9a076c0aE.exit.i: ; preds = %bb.i
  br i1 %i.n, label %bb.l, label %bb.j

bb.j:                                             ; preds = %_ZN8smallvec12layout_array17he0f6319a9a076c0aE.exit.i
  %i.t = shl nuw i64 %.sink.i.i, 3                ; 2 uses
  %i.u = icmp ugt i64 %i.b, 2305843009213693951
  br i1 %i.u, label %bb.s, label %bb.k, !prof !121

bb.k:                                             ; preds = %bb.j
  %i.v = tail call noundef zeroext i1 @_ZN4core5alloc6layout6Layout19is_size_align_valid17h26adf6c6175f55f5E(i64 noundef %i.t, i64 noundef 8), !noalias !234632
  br i1 %i.v, label %_ZN8smallvec12layout_array17he0f6319a9a076c0aE.exit55.i, label %bb.s

bb.l:                                             ; preds = %_ZN8smallvec12layout_array17he0f6319a9a076c0aE.exit.i
  tail call void @_RNvCskdKJRKLKjqM_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #79, !noalias !234626
  %i.w = tail call noundef align 8 ptr @_RNvCskdKJRKLKjqM_7___rustc12___rust_alloc(i64 noundef %i.q, i64 noundef 8) #79, !noalias !234626 ; 3 uses
  %.not73.i = icmp eq ptr %i.w, null
  br i1 %.not73.i, label %bb.r, label %bb.n

_ZN8smallvec12layout_array17he0f6319a9a076c0aE.exit55.i: ; preds = %bb.k
  %i.x = tail call noundef align 8 ptr @_RNvCskdKJRKLKjqM_7___rustc14___rust_realloc(ptr noundef nonnull %i.e, i64 noundef %i.t, i64 noundef 8, i64 noundef %i.q) #79, !noalias !234626 ; 2 uses
  %.not72.i = icmp eq ptr %i.x, null
  br i1 %.not72.i, label %bb.r, label %bb.m

bb.m:                                             ; preds = %_ZN8smallvec12layout_array17he0f6319a9a076c0aE.exit55.i, %bb.n
  %.sroa.021.0.i = phi ptr [ %i.w, %bb.n ], [ %i.x, %_ZN8smallvec12layout_array17he0f6319a9a076c0aE.exit55.i ]
  store ptr %.sroa.021.0.i, ptr %i.d, align 8, !alias.scope !234626
  store i64 %i.o, ptr %i.f, align 8, !alias.scope !234626
  store i64 %i.m, ptr %0, align 8, !alias.scope !234626
  br label %_ZN8smallvec10infallible17h5e85771fee159365E.exit
...
bb.o:                                             ; preds = %bb.g
  ...
  store i64 %i.o, ptr %0, align 8, !alias.scope !234626
  %i.aa = shl nuw i64 %.sink.i.i, 3               ; 2 uses
  %i.ab = icmp ugt i64 %i.b, 2305843009213693951
  br i1 %i.ab, label %bb.q, label %bb.p, !prof !121

bb.p:                                             ; preds = %bb.o
  %i.ac = tail call noundef zeroext i1 @_ZN4core5alloc6layout6Layout19is_size_align_valid17h26adf6c6175f55f5E(i64 noundef %i.aa, i64 noundef 8), !noalias !234635
  br i1 %i.ac, label %_ZN8smallvec10deallocate17ha82d9c3e634ac593E.exit.i, label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.o
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !234638
  store i64 0, ptr %i.a, align 8, !noalias !234638
  call void @_ZN4core6result13unwrap_failed17h0501379eaec3e720E(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) @2141, i64 noundef 43, ptr noundef nonnull align 1 %i.a, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @2143, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @5996) #80, !noalias !234638
  unreachable

_ZN8smallvec10deallocate17ha82d9c3e634ac593E.exit.i: ; preds = %bb.p
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %i.e, i64 noundef %i.aa, i64 noundef 8) #79, !noalias !234626
  br label %_ZN8smallvec10infallible17h5e85771fee159365E.exit

bb.r:                                             ; preds = %_ZN8smallvec12layout_array17he0f6319a9a076c0aE.exit55.i, %bb.l
  tail call void @_ZN5alloc5alloc18handle_alloc_error17h8f86e24af4223f3dE(i64 noundef range(i64 0, -9223372036854775806) 8, i64 noundef %i.q) #80
  unreachable

bb.s:                                             ; preds = %bb.k, %bb.h, %bb.i, %bb.j
  tail call void @_ZN4core9panicking5panic17ha264d2bb233f2b69E(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) @359, i64 noundef 17, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @5997) #80
  unreachable

_ZN8smallvec10infallible17h5e85771fee159365E.exit: ; preds = %_ZN8smallvec10deallocate17ha82d9c3e634ac593E.exit.i, %bb.g, %bb.f, %bb.m
  ret void

bb.t:                                             ; preds = %bb.b, %bb.a
  tail call void @_ZN4core6option13expect_failed17h1729d0bd73171c50E(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) @359, i64 noundef 17, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @5998) #80
  unreachable
}

; Function Attrs: nonlazybind uwtable
define internal fastcc void @"_ZN8tempfile4file22NamedTempFile$LT$F$GT$7persist17hffff68a7f64181deE"(ptr dead_on_unwind noalias nofree noundef nonnull writable writeonly align 8 captures(none) dereferenceable(40) %0, ptr noalias nofree noundef nonnull readonly align 8 captures(none) dead_on_return dereferenceable(32) %1, ptr noalias nofree noundef nonnull readonly align 8 captures(none) dead_on_return dereferenceable(24) %2) unnamed_addr #1 personality ptr @rust_eh_personality {
bb.a:
  %i.a = alloca [24 x i8], align 8                ; 6 uses
  ...
  %i.d = load i32, ptr %i.c, align 8, !range !40822, !noundef !14 ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.8)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !234641)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !234644)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !234646)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  %i.e = load ptr, ptr %i.b, align 8, !alias.scope !234644, !noalias !234648, !nonnull !14, !align !584, !noundef !14 ; 2 uses
  %i.f = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %i.g = load i64, ptr %i.f, align 8, !alias.scope !234644, !noalias !234648, !noundef !14 ; 3 uses
  %i.h = getelementptr inbounds nuw i8, ptr %2, i64 8
  %.val14.i = load ptr, ptr %i.h, align 8, !alias.scope !234646, !noalias !234649, !nonnull !14, !noundef !14 ; 3 uses
  %i.i = getelementptr inbounds nuw i8, ptr %2, i64 16
  %.val15.i = load i64, ptr %i.i, align 8, !alias.scope !234646, !noalias !234649, !noundef !14
  %i.j = invoke noundef ptr @_ZN8tempfile4file3imp8platform7persist17h057a8b1cbc700ba0E(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %i.e, i64 noundef %i.g, ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %.val14.i, i64 noundef %.val15.i, i1 noundef zeroext true)
          to label %bb.d unwind label %bb.c, !noalias !234650 ; 3 uses

bb.b:                                             ; preds = %bb.c
  call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val14.i, i64 noundef %.val.i.i, i64 noundef range(i64 1, -9223372036854775807) 1) #79, !noalias !234651
  br label %bb.j

bb.c:                                             ; preds = %bb.f, %bb.a
  %i.k = landingpad { ptr, i32 }
          cleanup
  call void @llvm.experimental.noalias.scope.decl(metadata !234656)
  %.val.i.i = load i64, ptr %2, align 8, !range !9, !alias.scope !234657, !noalias !234649, !noundef !14 ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  %.sroa.6.8..sroa_idx7 = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  %.sroa.6.8.copyload8 = load i8, ptr %.sroa.6.8..sroa_idx7, align 8, !alias.scope !234649, !noalias !234646
  %i.m = getelementptr inbounds nuw i8, ptr %1, i64 17
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(7) %.sroa.8, ptr noundef nonnull align 1 dereferenceable(7) %i.m, i64 7, i1 false)
  br label %"_ZN4core3ptr61drop_in_place$LT$alloc..boxed..Box$LT$std..path..Path$GT$$GT$17habf92843024b967fE.exit.i"

bb.f:                                             ; preds = %bb.d
  store i64 0, ptr %i.a, align 8, !noalias !234650
  %.sroa.47.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store ptr inttoptr (i64 1 to ptr), ptr %.sroa.47.0..sroa_idx.i, align 8, !noalias !234650
  %.sroa.58.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store i64 0, ptr %.sroa.58.0..sroa_idx.i, align 8, !noalias !234650
  %i.n = invoke { ptr, i64 } @_ZN3std3ffi6os_str8OsString17into_boxed_os_str17h464c67547c0e3b4fE(ptr noalias noundef nonnull readonly align 8 captures(address) dereferenceable(24) %i.a)
          to label %bb.g unwind label %bb.c, !noalias !234650 ; 0 uses

bb.g:                                             ; preds = %bb.f
  %i.o = icmp eq i64 %i.g, 0
  br i1 %i.o, label %"_ZN4core3ptr61drop_in_place$LT$alloc..boxed..Box$LT$std..path..Path$GT$$GT$17habf92843024b967fE.exit.i", label %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i"

"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i": ; preds = %bb.g
  call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %i.e, i64 noundef %i.g, i64 noundef 1) #79, !noalias !234650
  br label %"_ZN4core3ptr61drop_in_place$LT$alloc..boxed..Box$LT$std..path..Path$GT$$GT$17habf92843024b967fE.exit.i"

"_ZN4core3ptr61drop_in_place$LT$alloc..boxed..Box$LT$std..path..Path$GT$$GT$17habf92843024b967fE.exit.i": ; preds = %bb.g, %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i", %bb.e
  %.sroa.6.0 = phi i8 [ %.sroa.6.8.copyload8, %bb.e ], [ 2, %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i" ], [ 2, %bb.g ] ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !234660)
  %.val.i16.i = load i64, ptr %2, align 8, !range !9, !alias.scope !234663, !noalias !234649, !noundef !14 ; 2 uses
  %i.p = icmp eq i64 %.val.i16.i, 0
  br i1 %i.p, label %bb.k, label %bb.h

bb.h:                                             ; preds = %"_ZN4core3ptr61drop_in_place$LT$alloc..boxed..Box$LT$std..path..Path$GT$$GT$17habf92843024b967fE.exit.i"
  call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val14.i, i64 noundef %.val.i16.i, i64 noundef range(i64 1, -9223372036854775807) 1) #79, !noalias !234666
  br label %bb.k

bb.i:                                             ; preds = %bb.j
  %i.q = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_ZN4core9panicking16panic_in_cleanup17h5eff40bcc4481d72E() #82, !noalias !234648
  unreachable

bb.j:                                             ; preds = %bb.c, %bb.b
  invoke fastcc void @"_ZN4core3ptr45drop_in_place$LT$tempfile..file..TempPath$GT$17he4ee401612c1d2d0E"(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.b) #81
          to label %bb.o unwind label %bb.i, !noalias !234648

bb.k:                                             ; preds = %bb.h, %"_ZN4core3ptr61drop_in_place$LT$alloc..boxed..Box$LT$std..path..Path$GT$$GT$17habf92843024b967fE.exit.i"
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a)
  %.not = icmp eq i8 %.sroa.6.0, 2
  br i1 %.not, label %bb.m, label %bb.l

bb.l:                                             ; preds = %bb.k
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %i.j) ]
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.4.0..sroa_idx, ptr noundef nonnull align 8 dereferenceable(16) %1, i64 16, i1 false)
  %.sroa.4.sroa.0.sroa.5.0..sroa.4.0..sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 25
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(7) %.sroa.4.sroa.0.sroa.5.0..sroa.4.0..sroa_idx.sroa_idx, ptr noundef nonnull align 1 dereferenceable(7) %.sroa.8, i64 7, i1 false)
  store ptr %i.j, ptr %0, align 8
  %.sroa.4.sroa.4.0..sroa.4.0..sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 32
  store i32 %i.d, ptr %.sroa.4.sroa.4.0..sroa.4.0..sroa_idx.sroa_idx, align 8
  br label %bb.n
...
bb.n:                                             ; preds = %bb.m, %bb.l
  ...
  store i8 %.sroa.6.0, ptr %i.r, align 8
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.8)
  ret void

bb.o:                                             ; preds = %bb.j
  %i.s = call noundef i32 @close(i32 noundef %i.d) #79 ; 0 uses
  resume { ptr, i32 } %i.k
}

; Function Attrs: nonlazybind uwtable
define internal fastcc void @_ZN8tempfile7Builder11tempfile_in17h435e04a9a0253d18E(ptr dead_on_unwind noalias nofree noundef nonnull writable writeonly align 8 captures(none) dereferenceable(32) %0, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(56) %1, ptr noalias noundef nonnull readonly align 8 captures(none) dereferenceable(24) %2) unnamed_addr #1 personality ptr @rust_eh_personality {
bb.a:
  ...
  %.val.i = load ptr, ptr %i.l, align 8, !nonnull !14, !noundef !14 ; 3 uses
  %i.m = getelementptr inbounds nuw i8, ptr %2, i64 16
  %.val1.i = load i64, ptr %i.m, align 8, !noundef !14 ; 3 uses
  %i.n = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.o = load ptr, ptr %i.n, align 8, !nonnull !14, !align !584, !noundef !14
  %i.p = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.q = load i64, ptr %i.p, align 8, !noundef !14
  %i.r = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.s = load ptr, ptr %i.r, align 8, !nonnull !14, !align !584, !noundef !14
  %i.t = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.u = load i64, ptr %i.t, align 8, !noundef !14
  %i.v = getelementptr inbounds nuw i8, ptr %1, i64 40
  %i.w = load i64, ptr %i.v, align 8, !noundef !14 ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !234669)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !234672)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.h)
  %i.x = invoke noundef zeroext i1 @_ZN3std4path4Path11is_absolute17hf19889a9c7aed189E(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %.val.i, i64 noundef %.val1.i)
          to label %bb.b unwind label %.loopexit.split-lp.loopexit.split-lp.i, !noalias !234674

.body.i:                                          ; preds = %.loopexit.split-lp.loopexit.i, %bb.ad, %bb.ac, %bb.o, %.loopexit.split-lp.loopexit.split-lp.i, %.loopexit.i
  %.sroa.7.0.i = phi ptr [ %.sroa.7.2.i, %bb.ac ], [ %.sroa.7.2.i, %bb.o ], [ %.sroa.7.2.i, %bb.ad ], [ %.sroa.7.2.i, %.loopexit.i ], [ %.sroa.7.1.ph.ph.i, %.loopexit.split-lp.loopexit.split-lp.i ], [ %.sroa.7.2.i, %.loopexit.split-lp.loopexit.i ] ; 2 uses
  %.sroa.060.0.i = phi i64 [ %.sroa.060.2.i, %bb.ac ], [ %.sroa.060.2.i, %bb.o ], [ %.sroa.060.2.i, %bb.ad ], [ %.sroa.060.2.i, %.loopexit.i ], [ %.sroa.060.1.ph.ph.i, %.loopexit.split-lp.loopexit.split-lp.i ], [ %.sroa.060.2.i, %.loopexit.split-lp.loopexit.i ] ; 2 uses
  %.sroa.017.0.i = phi i8 [ %.sroa.017.2.i, %bb.ac ], [ %.sroa.017.2.i, %bb.o ], [ %.sroa.017.2.i, %bb.ad ], [ %.sroa.017.2.i, %.loopexit.i ], [ %.sroa.017.1.ph.ph.i, %.loopexit.split-lp.loopexit.split-lp.i ], [ %.sroa.017.2.i, %.loopexit.split-lp.loopexit.i ]
  %.pn.i = phi { ptr, i32 } [ %i.cn, %bb.ac ], [ %lpad.thr_comm.i.i.i, %bb.o ], [ %i.cn, %bb.ad ], [ %lpad.loopexit.i, %.loopexit.i ], [ %lpad.loopexit.split-lp84.i, %.loopexit.split-lp.loopexit.split-lp.i ], [ %lpad.loopexit83.i, %.loopexit.split-lp.loopexit.i ] ; 2 uses
  %i.y = trunc nuw i8 %.sroa.017.0.i to i1
  %i.z = icmp ne i64 %.sroa.060.0.i, 0
  %or.cond81.not.i = select i1 %i.y, i1 %i.z, i1 false
  br i1 %or.cond81.not.i, label %bb.am, label %.thread.i
