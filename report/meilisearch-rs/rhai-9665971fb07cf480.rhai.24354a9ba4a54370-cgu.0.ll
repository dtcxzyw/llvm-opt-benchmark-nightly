...
.thread726:                                       ; preds = %bb.gl
  ...
  %.val396728 = load i64, ptr %.sroa.6553.0.copyload, align 8, !alias.scope !39249, !noundef !55
  %i.sb = getelementptr i8, ptr %.sroa.6553.0.copyload, i64 8
  %.val397729 = load i64, ptr %i.sb, align 8, !alias.scope !39250, !noundef !55
  br label %bb.hc
...
bb.gr:                                            ; preds = %.noexc462
  %.val396 = load i64, ptr %i.rv, align 8, !alias.scope !39249, !noundef !55 ; 2 uses
  %i.sf = getelementptr i8, ptr %i.rv, i64 8
  %.val397 = load i64, ptr %i.sf, align 8, !alias.scope !39250, !noundef !55 ; 2 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.6553.0.copyload) ]
...
.thread:                                          ; preds = %bb.gu
  ...
  %i.sy = load i64, ptr %.sroa.6555.0.copyload, align 8, !alias.scope !39251, !noalias !39252, !noundef !55
  %i.sz = getelementptr inbounds nuw i8, ptr %.sroa.6555.0.copyload, i64 8
  %i.ta = load i64, ptr %i.sz, align 8, !alias.scope !39253, !noalias !39252, !noundef !55
  %i.tb = getelementptr inbounds nuw i8, ptr %.sroa.6555.0.copyload, i64 16
  %i.tc = load i8, ptr %i.tb, align 8, !range !57, !alias.scope !39254, !noalias !39252, !noundef !55
  br label %bb.hb
...
bb.gz:                                            ; preds = %.noexc476
  %i.tg = load i64, ptr %i.ss, align 8, !alias.scope !39251, !noalias !39252, !noundef !55 ; 2 uses
  %i.th = getelementptr inbounds nuw i8, ptr %i.ss, i64 8
  %i.ti = load i64, ptr %i.th, align 8, !alias.scope !39253, !noalias !39252, !noundef !55 ; 2 uses
  %i.tj = getelementptr inbounds nuw i8, ptr %i.ss, i64 16
  %i.tk = load i8, ptr %i.tj, align 8, !range !57, !alias.scope !39254, !noalias !39252, !noundef !55 ; 2 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.6555.0.copyload) ]
...
.cont560:                                         ; preds = %bb.hb, %bb.hc
  ...
  %i.ts = load i64, ptr %i.ee, align 8, !alias.scope !39255, !noalias !39256, !noundef !55 ; 2 uses
  %i.tt = icmp ugt i64 %i.ts, 3                   ; 2 uses
  %i.tu = load ptr, ptr %i.ca, align 8, !alias.scope !39255, !noalias !39256, !nonnull !55
  ...
  %i.tv = load i64, ptr %.sink9.i.i487, align 8, !alias.scope !39257, !noalias !39258, !noundef !55 ; 2 uses
...
.noexc492:                                        ; preds = %bb.hd
  %i.tx = load ptr, ptr %i.ca, align 8, !alias.scope !39257, !noalias !39258, !nonnull !55, !noundef !55
  %.pre.i491 = load i64, ptr %i.es, align 8, !alias.scope !39257, !noalias !39258
  br label %bb.he
...
bb.he:                                            ; preds = %.noexc492, %.cont560
  ...
  %i.ua = load i64, ptr %.sroa.01.0.i489, align 8, !alias.scope !39257, !noalias !39258, !noundef !55
  %i.ub = add i64 %i.ua, 1
  store i64 %i.ub, ptr %.sroa.01.0.i489, align 8, !alias.scope !39257, !noalias !39258
  br label %.noexc

.noexc:                                           ; preds = %bb.hc, %bb.he, %bb.hb, %bb.hj
  call void @llvm.lifetime.start.p0(ptr nonnull %i.al)
  call void @llvm.experimental.noalias.scope.decl(metadata !39259)
...
bb.hf:                                            ; preds = %.noexc
  ...
  %i.uf = load <2 x i64>, ptr getelementptr inbounds nuw (i8, ptr @_ZN4rhai6config7hashing12HASHING_SEED17h27f2e76f87a01d6fE, i64 32), align 8 ; 2 uses
  %i.ug = call i64 @llvm.vector.reduce.or.v2i64(<2 x i64> %i.uf)
  %op.rdx = or i64 %i.ug, %.val832
  %op.rdx2801 = or i64 %op.rdx, %.val
  %i.uh = icmp eq i64 %op.rdx2801, 0
  br i1 %i.uh, label %bb.hg, label %bb.hi

bb.hg:                                            ; preds = %bb.hf, %.noexc
  %i.ui = load atomic ptr, ptr @_ZN5ahash12random_state15get_fixed_seeds5SEEDS17hb5e35b2bbb578097E acquire, align 8 ; 2 uses
  %i.uj = icmp eq ptr %i.ui, null
  br i1 %i.uj, label %bb.hh, label %.noexc331, !prof !66

bb.hh:                                            ; preds = %bb.hg
  %i.uk = invoke noundef align 8 dereferenceable(64) ptr @"_ZN9once_cell4race8once_box16OnceBox$LT$T$GT$4init17h356f4c85e7ef4921E"(ptr noundef nonnull align 8 @_ZN5ahash12random_state15get_fixed_seeds5SEEDS17hb5e35b2bbb578097E)
          to label %.noexc331 unwind label %bb.gj

.noexc331:                                        ; preds = %bb.hg, %bb.hh
  %.sroa.0.0.i493 = phi ptr [ %i.ui, %bb.hg ], [ %i.uk, %bb.hh ] ; 3 uses
  %i.ul = load i64, ptr %.sroa.0.0.i493, align 8, !noalias !39259, !noundef !55
  %i.um = getelementptr inbounds nuw i8, ptr %.sroa.0.0.i493, i64 8
  %i.un = load i64, ptr %i.um, align 8, !noalias !39259, !noundef !55
  %i.uo = getelementptr inbounds nuw i8, ptr %.sroa.0.0.i493, i64 16
  %i.up = load <2 x i64>, ptr %i.uo, align 8, !noalias !39259
  br label %_ZN4rhai4func7hashing10get_hasher17hfd55d227dd606c81E.exit

bb.hi:                                            ; preds = %bb.hf
  %i.uq = xor i64 %.val, 4983270260364809079
  %i.ur = xor i64 %.val832, -4732044268327596948
  %i.us = xor <2 x i64> %i.uf, <i64 -4563226453097033507, i64 4577018097722394903>
  br label %_ZN4rhai4func7hashing10get_hasher17hfd55d227dd606c81E.exit

bb.hj:                                            ; preds = %bb.gt
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ao)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ap)
  %i.ut = load i64, ptr %i.ee, align 8, !alias.scope !39260, !noalias !39261, !noundef !55 ; 2 uses
  %i.uu = icmp ugt i64 %i.ut, 3
  %i.uv = load i64, ptr %i.es, align 8, !alias.scope !39260, !noalias !39261
  %.sink10.i484 = select i1 %i.uu, i64 %i.uv, i64 %i.ut
  %i.uw = icmp ne i64 %.sink10.i484, 0
  %i.ux = and i8 %.val406, 14
  %switch = icmp eq i8 %i.ux, 4
  %or.cond828 = and i1 %switch, %i.uw
...
bb.hk:                                            ; preds = %bb.hj
  ...
  %i.uy = invoke fastcc { i16, i16 } @_ZN4rhai3ast4expr4Expr14start_position17h6e2b0253b346af39E(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(16) %i.as)
...
_ZN4rhai4func7hashing10get_hasher17hfd55d227dd606c81E.exit: ; preds = %bb.hi, %.noexc331
  %storemerge1415 = phi i64 [ %i.ur, %bb.hi ], [ %i.un, %.noexc331 ]
  %storemerge1414 = phi i64 [ %i.uq, %bb.hi ], [ %i.ul, %.noexc331 ]
  %i.ve = phi <2 x i64> [ %i.us, %bb.hi ], [ %i.up, %.noexc331 ]
  store i64 %storemerge1415, ptr %i.ev, align 16, !alias.scope !39259
  store i64 %storemerge1414, ptr %i.ew, align 8, !alias.scope !39259
  store <2 x i64> %i.ve, ptr %i.al, align 16, !alias.scope !39259
...
bb.hp:                                            ; preds = %_ZN4rhai4func7hashing10get_hasher17hfd55d227dd606c81E.exit
  %i.vf = load i64, ptr %i.ev, align 16, !noundef !55 ; 2 uses
  %i.vg = load i64, ptr %i.ew, align 8, !noundef !55
  %i.vh = zext i64 %i.vf to i128
  %i.vi = zext i64 %i.vg to i128
  %i.vj = mul nuw i128 %i.vi, %i.vh               ; 2 uses
  %i.vk = lshr i128 %i.vj, 64
  %i.vl = xor i128 %i.vk, %i.vj
  %i.vm = trunc i128 %i.vl to i64                 ; 2 uses
  %i.vn = call i64 @llvm.fshl.i64(i64 %i.vm, i64 %i.vm, i64 %i.vf) ; 5 uses
  ...
  %i.vo = lshr i64 %i.vn, 57
  %i.vp = trunc nuw nsw i64 %i.vo to i8           ; 3 uses
  %i.vq = load i64, ptr %i.ey, align 8, !alias.scope !39265, !noalias !39266, !noundef !55 ; 3 uses
  %i.vr = load ptr, ptr %i.cb, align 8, !alias.scope !39265, !noalias !39266, !nonnull !55, !noundef !55 ; 3 uses
  %.sroa.0.0.vec.insert.i.i.i = insertelement <16 x i8> poison, i8 %i.vp, i64 0
  %.sroa.0.15.vec.insert.i.i.i = shufflevector <16 x i8> %.sroa.0.0.vec.insert.i.i.i, <16 x i8> poison, <16 x i32> zeroinitializer
  br label %bb.hq

bb.hq:                                            ; preds = %bb.hs, %bb.hp
  %.sroa.9.0.i.i.i = phi i64 [ 0, %bb.hp ], [ %i.wi, %bb.hs ]
  %.pn.i.i = phi i64 [ %i.vn, %bb.hp ], [ %i.wj, %bb.hs ]
  %.sroa.01.0.i.i.i497 = and i64 %.pn.i.i, %i.vq  ; 3 uses
  %i.vs = getelementptr inbounds nuw i8, ptr %i.vr, i64 %.sroa.01.0.i.i.i497
  %.sroa.0.0.copyload.i26.i.i = load <16 x i8>, ptr %i.vs, align 1, !noalias !39267 ; 2 uses
  %i.vt = icmp eq <16 x i8> %.sroa.0.0.copyload.i26.i.i, %.sroa.0.15.vec.insert.i.i.i
  %i.vu = bitcast <16 x i1> %i.vt to i16          ; 2 uses
  %.not.i.not32.i.i = icmp eq i16 %i.vu, 0
  br i1 %.not.i.not32.i.i, label %._crit_edge.i.i, label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %bb.hq, %bb.hr
  %.sroa.06.0.i33.i.i = phi i16 [ %i.wh, %bb.hr ], [ %i.vu, %bb.hq ] ; 3 uses
  %i.vv = call range(i16 0, 17) i16 @llvm.cttz.i16(i16 %.sroa.06.0.i33.i.i, i1 true)
  %i.vw = zext nneg i16 %i.vv to i64
  %i.vx = add i64 %.sroa.01.0.i.i.i497, %i.vw
  %i.vy = and i64 %i.vx, %i.vq
  %i.vz = sub nsw i64 0, %i.vy
  %i.wa = getelementptr inbounds [32 x i8], ptr %i.vr, i64 %i.vz ; 2 uses
  %i.wb = getelementptr inbounds i8, ptr %i.wa, i64 -32
  %.val3.i.i.i = load i64, ptr %i.wb, align 8, !noalias !39268, !noundef !55
  %i.wc = icmp eq i64 %.val3.i.i.i, %i.vn
  br i1 %i.wc, label %.loopexit, label %bb.hr, !prof !74

._crit_edge.i.i:                                  ; preds = %bb.hr, %bb.hq
  %i.wd = icmp eq <16 x i8> %.sroa.0.0.copyload.i26.i.i, splat (i8 -1)
  %i.we = bitcast <16 x i1> %i.wd to i16
  %i.wf = icmp eq i16 %i.we, 0
  br i1 %i.wf, label %bb.hs, label %bb.ht, !prof !66

bb.hr:                                            ; preds = %.lr.ph.i.i
  %i.wg = add i16 %.sroa.06.0.i33.i.i, -1
  %i.wh = and i16 %i.wg, %.sroa.06.0.i33.i.i      ; 2 uses
  %.not.i.not.i.i = icmp eq i16 %i.wh, 0
  br i1 %.not.i.not.i.i, label %._crit_edge.i.i, label %.lr.ph.i.i

bb.hs:                                            ; preds = %._crit_edge.i.i
  %i.wi = add i64 %.sroa.9.0.i.i.i, 16            ; 2 uses
  %i.wj = add i64 %.sroa.01.0.i.i.i497, %i.wi
  br label %bb.hq

bb.ht:                                            ; preds = %._crit_edge.i.i
  %i.wk = load i64, ptr %i.ez, align 8, !alias.scope !39269, !noalias !39270, !noundef !55
  %i.wl = icmp eq i64 %i.wk, 0
  br i1 %i.wl, label %bb.hu, label %bb.hv, !prof !66

bb.hu:                                            ; preds = %bb.ht
  %i.wm = invoke { i64, i64 } @"_ZN9hashbrown3raw21RawTable$LT$T$C$A$GT$14reserve_rehash17h92108be9e7e5ba8eE"(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.cb, i64 noundef 1, ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %i.ex, i1 noundef zeroext true)
          to label %.noexc500 unwind label %bb.gj ; 0 uses

.noexc500:                                        ; preds = %bb.hu
  %.val5.i.i.pre = load ptr, ptr %i.cb, align 8, !alias.scope !39271, !noalias !39272
  %.val6.i.i.pre = load i64, ptr %i.ey, align 8, !alias.scope !39271, !noalias !39272
  br label %bb.hv

bb.hv:                                            ; preds = %.noexc500, %bb.ht
  %.val6.i.i = phi i64 [ %.val6.i.i.pre, %.noexc500 ], [ %i.vq, %bb.ht ] ; 4 uses
  %.val5.i.i = phi ptr [ %.val5.i.i.pre, %.noexc500 ], [ %i.vr, %bb.ht ] ; 8 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !39271)
  %.sroa.0.04.i.i.i.i = and i64 %.val6.i.i, %i.vn ; 3 uses
  %i.wn = getelementptr inbounds nuw i8, ptr %.val5.i.i, i64 %.sroa.0.04.i.i.i.i
  %.sroa.0.0.copyload.i35.i.i.i.i = load <16 x i8>, ptr %i.wn, align 1, !noalias !39273
  %i.wo = icmp slt <16 x i8> %.sroa.0.0.copyload.i35.i.i.i.i, zeroinitializer
  %i.wp = bitcast <16 x i1> %i.wo to i16          ; 2 uses
  %.not.not.i.not6.i.i.i.i = icmp eq i16 %i.wp, 0
end_hunk_0
