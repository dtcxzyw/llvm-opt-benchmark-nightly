...
.loopexit1084:                                    ; preds = %"_ZN4core3ptr48drop_in_place$LT$rhai..ast..expr..BinaryExpr$GT$17h6e6f78e223e3d862E.exit", %bb.cu, %bb.cv
  %i.ps = getelementptr inbounds nuw i8, ptr %.pre1244, i64 328 ; 5 uses
  %i.pt = load i64, ptr %i.ps, align 8, !alias.scope !50999, !noalias !51002, !noundef !3 ; 3 uses
  %i.pu = icmp ugt i64 %i.pt, 3                   ; 2 uses
  %i.pv = getelementptr inbounds nuw i8, ptr %.pre1244, i64 240 ; 5 uses
...
bb.em:                                            ; preds = %.loopexit1084, %bb.fc
...
bb.ep:                                            ; preds = %bb.eo
  %i.qe = getelementptr inbounds nuw i8, ptr %.pre1244, i64 56
  %i.qf = load i64, ptr %i.qe, align 8, !noundef !3
  %i.qg = icmp eq i64 %i.qf, 0
  br i1 %i.qg, label %bb.es, label %bb.er

bb.eq:                                            ; preds = %bb.eo
  %.pre1249.a = load i64, ptr %i.ps, align 8, !alias.scope !51004, !noalias !51007
  %.pre1250 = load i64, ptr %i.pv, align 8, !alias.scope !51004, !noalias !51007
  br label %bb.fa
...
bb.eu:                                            ; preds = %bb.et
  ...
  %.pre1247.a = load i64, ptr %i.ps, align 8, !alias.scope !51019, !noalias !51024
...
bb.ev:                                            ; preds = %bb.eu, %bb.et
  ...
  %i.qp = phi i64 [ %.pre1247.a, %bb.eu ], [ %i.ql, %bb.et ] ; 2 uses
  ...
  %i.qu = getelementptr inbounds nuw i8, ptr %.pre1244, i64 224
  %i.qv = getelementptr inbounds nuw i8, ptr %.pre1244, i64 72
  br label %bb.ew
...
bb.ey:                                            ; preds = %bb.ex
  ...
  invoke fastcc void @_ZN4rhai9optimizer13optimize_expr17haeffafea56131100E(ptr noalias noundef align 8 dereferenceable(16) %i.ri, ptr noalias noundef align 8 dereferenceable(336) %1, i1 noundef zeroext false)
          to label %bb.ez unwind label %.loopexit1083
...
bb.ez:                                            ; preds = %bb.ey
  ...
  invoke fastcc void @_ZN4rhai9optimizer13optimize_expr17haeffafea56131100E(ptr noalias noundef align 8 dereferenceable(16) %i.rj, ptr noalias noundef align 8 dereferenceable(336) %1, i1 noundef zeroext false)
          to label %bb.ew unwind label %.loopexit1083

bb.fa:                                            ; preds = %.loopexit1084, %bb.eq
  %i.rk = phi i64 [ %i.pw, %.loopexit1084 ], [ %.pre1250, %bb.eq ]
  %i.rl = phi i64 [ %i.pt, %.loopexit1084 ], [ %.pre1249.a, %bb.eq ] ; 2 uses
...
bb.fh:                                            ; preds = %bb.fe
  ...
  %i.sg = getelementptr inbounds nuw i8, ptr %.pre1244, i64 24
...
bb.fq:                                            ; preds = %bb.fn
  ...
  %i.sw = invoke fastcc { i16, i16 } @_ZN4rhai3ast4expr4Expr14start_position17h6e2b0253b346af39E(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(16) %.pre1244)
...
bb.ga:                                            ; preds = %bb.fx
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.td, ptr noundef nonnull align 8 dereferenceable(16) %i.ay, i64 16, i1 false)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ay)
  %i.tg = getelementptr inbounds nuw i8, ptr %i.az, i64 8
  store ptr %i.td, ptr %i.tg, align 8
  store i8 11, ptr %i.az, align 8
  invoke fastcc void @_ZN4rhai9optimizer13optimize_stmt17h1fd8d7a6bfb03e75E(ptr noalias noundef align 8 dereferenceable(16) %i.az, ptr noalias noundef align 8 dereferenceable(336) %1, i1 noundef zeroext true)
          to label %bb.gc unwind label %bb.ge

bb.gb:                                            ; preds = %bb.gc
  %i.th = landingpad { ptr, i32 }
          cleanup
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef nonnull align 8 dereferenceable(16) %i.ax, i64 16, i1 false)
  br label %.body637

bb.gc:                                            ; preds = %bb.ga
  call void @llvm.lifetime.start.p0(ptr nonnull %i.ax)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.ax, ptr noundef nonnull align 8 dereferenceable(16) %i.az, i64 16, i1 false)
  invoke fastcc void @"_ZN4core3ptr42drop_in_place$LT$rhai..ast..stmt..Stmt$GT$17h8c7cea9300790c9cE"(ptr noalias noundef align 8 dereferenceable(16) %0)
...
bb.ge:                                            ; preds = %bb.ga
  %i.ti = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @"_ZN4core3ptr42drop_in_place$LT$rhai..ast..stmt..Stmt$GT$17h8c7cea9300790c9cE"(ptr noalias noundef align 8 dereferenceable(16) %i.az) #72
          to label %.body637 unwind label %bb.ag
