...
.loopexit:                                        ; preds = %bb.ew, %bb.dv, %bb.ek, %bb.fv
  ...
  call fastcc void @"_ZN4core3ptr48drop_in_place$LT$rhai..types..dynamic..Union$GT$17h49c4795ab223165bE"(ptr noalias noundef readonly align 8 dereferenceable(16) %i.bs), !inline_history !1408
...
.loopexit1082:                                    ; preds = %"_ZN4core3ptr48drop_in_place$LT$rhai..ast..expr..BinaryExpr$GT$17h6e6f78e223e3d862E.exit", %bb.cu, %bb.cv
  ...
  %i.pt = load i64, ptr %i.ps, align 8, !alias.scope !50984, !noalias !50987, !noundef !3 ; 3 uses
  %i.pu = icmp ugt i64 %i.pt, 3                   ; 2 uses
  %i.pv = getelementptr inbounds nuw i8, ptr %.pre1242, i64 240 ; 5 uses
  %i.pw = load i64, ptr %i.pv, align 8, !alias.scope !50984, !noalias !50987 ; 2 uses
...
bb.en:                                            ; preds = %.loopexit1082
  %i.qa = load ptr, ptr %i.lr, align 8, !alias.scope !50984, !noalias !50987, !nonnull !3
...
bb.eq:                                            ; preds = %bb.eo
  %.pre1247.a = load i64, ptr %i.ps, align 8, !alias.scope !50989, !noalias !50992
  %.pre1248 = load i64, ptr %i.pv, align 8, !alias.scope !50989, !noalias !50992
  br label %bb.fa
...
bb.es:                                            ; preds = %bb.er, %bb.ep
  %i.qi = load i64, ptr %i.ps, align 8, !alias.scope !50994, !noalias !50997, !noundef !3 ; 2 uses
  %i.qj = load i64, ptr %i.pv, align 8, !alias.scope !50994, !noalias !50997
...
bb.et:                                            ; preds = %bb.es
  ...
  %i.ql = load i64, ptr %i.ps, align 8, !alias.scope !50999, !noalias !51002, !noundef !3 ; 3 uses
  %i.qm = icmp ugt i64 %i.ql, 3
  %i.qn = load i64, ptr %i.pv, align 8, !alias.scope !50999, !noalias !51002 ; 2 uses
...
bb.eu:                                            ; preds = %bb.et
  ...
  %.pre1245.a = load i64, ptr %i.ps, align 8, !alias.scope !51004, !noalias !51009
  %.val.i766.pre = load i64, ptr %i.pv, align 8, !alias.scope !51011
  br label %bb.ev
...
bb.ev:                                            ; preds = %bb.eu, %bb.et
  ...
  %i.qr = load ptr, ptr %i.lr, align 8, !alias.scope !51004, !noalias !51009, !nonnull !3
...
bb.ex:                                            ; preds = %bb.ew
  ...
  %i.qy = load i8, ptr %i.qx, align 8, !range !12402, !noundef !3
  ...
  %i.ra = load i64, ptr %i.qu, align 8, !alias.scope !51012, !noalias !51017, !noundef !3 ; 2 uses
  %i.rb = icmp ugt i64 %i.ra, 5                   ; 2 uses
  %.val.i767 = load i64, ptr %i.qv, align 8, !alias.scope !51020, !noalias !51021
...
bb.ey:                                            ; preds = %bb.ex
  %i.rh = load ptr, ptr %i.lq, align 8, !alias.scope !51012, !noalias !51017, !nonnull !3
...
bb.fa:                                            ; preds = %.loopexit1082, %bb.eq
  ...
  %i.rn = load ptr, ptr %i.lr, align 8, !alias.scope !50989, !noalias !50992, !nonnull !3
...
bb.fb:                                            ; preds = %bb.fa
  ...
  %i.rs = load i8, ptr %i.rr, align 8, !range !12402, !noundef !3
  %.not597 = icmp eq i8 %i.rs, 2
  %i.rt = getelementptr inbounds nuw i8, ptr %i.rq, i64 16 ; 3 uses
  %.sroa.0477.0 = select i1 %.not597, ptr %i.rt, ptr %i.rq
  %i.ru = load i64, ptr %.sroa.0477.0, align 8, !noundef !3
...
bb.fd:                                            ; preds = %bb.fb
  %i.rw = load i8, ptr %i.rv, align 8, !range !7721, !noundef !3
...
bb.ff:                                            ; preds = %bb.fd
  %i.sb = load i8, ptr %i.rr, align 8, !range !12402, !noundef !3
...
bb.fi:                                            ; preds = %bb.fh
  ...
  %i.si = load i8, ptr %i.rr, align 8, !range !12402, !noundef !3
...
bb.fj:                                            ; preds = %bb.fi
  ...
  %i.sn = invoke fastcc noundef ptr @_ZN5alloc5alloc15exchange_malloc17hd05661b5acd38f93E(i64 noundef 16, i64 noundef 8)
          to label %bb.fm unwind label %bb.fk, !noalias !51022 ; 2 uses
...
bb.fn:                                            ; preds = %bb.fm
  ...
  %i.st = invoke fastcc noundef ptr @_ZN5alloc5alloc15exchange_malloc17hd05661b5acd38f93E(i64 noundef 304, i64 noundef 8)
          to label %bb.fq unwind label %bb.fo, !noalias !51025 ; 4 uses
...
.thread992:                                       ; preds = %bb.fk, %.thread996
  ...
  invoke fastcc void @"_ZN69_$LT$smallvec..SmallVec$LT$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h4b307487833700cdE"(ptr noalias noundef nonnull readonly align 8 dereferenceable(144) %i.av)
          to label %bb.fw unwind label %bb.ag, !inline_history !13088
...
bb.fx:                                            ; preds = %bb.ff
  ...
  %i.td = invoke fastcc noundef ptr @_ZN5alloc5alloc15exchange_malloc17hd05661b5acd38f93E(i64 noundef 16, i64 noundef 8)
          to label %bb.ga unwind label %bb.fy, !noalias !51028 ; 2 uses
