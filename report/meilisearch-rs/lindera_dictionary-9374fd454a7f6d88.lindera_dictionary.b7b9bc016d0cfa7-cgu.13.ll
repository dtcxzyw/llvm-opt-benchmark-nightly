...
.preheader109.i.preheader:                        ; preds = %bb.f
  br i1 %.not95119.i, label %.loopexit.i, label %.lr.ph
...
.lr.ph:                                           ; preds = %.preheader109.i.preheader, %.preheader109.i
...
.preheader110.i.preheader:                        ; preds = %bb.f
  br i1 %.not96120.i, label %.loopexit.i, label %.lr.ph
...
.lr.ph:                                           ; preds = %.preheader110.i.preheader, %.preheader110.i
