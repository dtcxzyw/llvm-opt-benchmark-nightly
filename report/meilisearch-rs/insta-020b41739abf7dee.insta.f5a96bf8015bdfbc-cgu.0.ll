...
bb.ac:                                            ; preds = %.loopexit416
  %i.dd = load i8, ptr %i.t, align 16, !range !910, !noundef !15 ; 2 uses
...
bb.ad:                                            ; preds = %bb.ac
  ...
  %i.dg = invoke fastcc noundef ptr @_ZN5alloc5alloc15exchange_malloc17hd05661b5acd38f93E(i64 noundef 24, i64 noundef 8)
          to label %bb.al unwind label %bb.ae, !noalias !18560 ; 4 uses
...
bb.af:                                            ; preds = %bb.ae
  ...
  call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.sroa.4327.0.copyload, i64 noundef %.sroa.0326.0.copyload, i64 noundef range(i64 1, -9223372036854775807) 1) #51, !noalias !18563
  br label %bb.ec
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.dj = load i64, ptr %i.di, align 16, !range !604, !noundef !15 ; 2 uses
...
bb.ao:                                            ; preds = %bb.an
  ...
  br i1 %i.dz, label %bb.ap, label %bb.dw, !prof !49
...
bb.av:                                            ; preds = %bb.au
  %i.eh = load ptr, ptr %.sroa.470.0..sroa_idx, align 8, !alias.scope !18566, !noalias !18569, !nonnull !15, !noundef !15
  %i.ei = getelementptr inbounds nuw i8, ptr %i.eh, i64 %i.ef
  %i.ej = load i8, ptr %i.ei, align 1, !noalias !18571, !noundef !15
  %i.ek = icmp sgt i8 %i.ej, -65
  br i1 %i.ek, label %.split.i157, label %bb.aw, !prof !206
...
.split.i157:                                      ; preds = %bb.av, %bb.au
  store i64 %i.ef, ptr %.sroa.571.0..sroa_idx, align 8, !alias.scope !18566, !noalias !18569
  br label %_ZN5alloc6string6String8truncate17hf71e28f22521745fE.exit

bb.ax:                                            ; preds = %bb.as
  %i.el = load ptr, ptr %.sroa.470.0..sroa_idx, align 8, !nonnull !15, !noundef !15 ; 5 uses
...
"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17ha696533577fe6bb3E.exit191": ; preds = %"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17ha696533577fe6bb3E.exit191.backedge", %bb.ak
  call void @llvm.experimental.noalias.scope.decl(metadata !18572)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f), !noalias !18575
  store i64 0, ptr %i.f, align 8, !noalias !18575
  store ptr inttoptr (i64 1 to ptr), ptr %.sroa.45.0..sroa_idx.i.i, align 8, !noalias !18575
  store i64 0, ptr %.sroa.56.0..sroa_idx.i.i, align 8, !noalias !18575
  %i.ep = invoke fastcc { i64, ptr } @_ZN3std2io16append_to_string17h5d3e27cd4598480fE(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.f, ptr noalias noundef nonnull align 8 dereferenceable(56) %i.o)
          to label %_ZN3std2io7BufRead9read_line17h40241fd8143992b6E.exit.i.i unwind label %bb.ay, !noalias !18580 ; 2 uses
...
bb.ay:                                            ; preds = %"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17ha696533577fe6bb3E.exit191"
  ...
  %.val.i.i.i = load i64, ptr %i.f, align 8, !alias.scope !18581, !noalias !18575 ; 2 uses
  %i.er = icmp eq i64 %.val.i.i.i, 0
  br i1 %i.er, label %.body136, label %bb.az

bb.az:                                            ; preds = %bb.ay
  %.val1.i.i.i = load ptr, ptr %.sroa.45.0..sroa_idx.i.i, align 8, !alias.scope !18581, !noalias !18575, !nonnull !15, !noundef !15
  call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val1.i.i.i, i64 noundef %.val.i.i.i, i64 noundef range(i64 1, -9223372036854775807) 1) #51, !noalias !18584
  br label %.body136
...
bb.bb:                                            ; preds = %bb.ba, %_ZN3std2io7BufRead9read_line17h40241fd8143992b6E.exit.i.i
  ...
  %.val.i10.i.i = load i64, ptr %i.f, align 8, !alias.scope !18585, !noalias !18575 ; 2 uses
...
bb.bc:                                            ; preds = %bb.bb
  %.val1.i11.i.i = load ptr, ptr %.sroa.45.0..sroa_idx.i.i, align 8, !alias.scope !18585, !noalias !18575, !nonnull !15, !noundef !15
  call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val1.i11.i.i, i64 noundef %.val.i10.i.i, i64 noundef range(i64 1, -9223372036854775807) 1) #51, !noalias !18588
...
bb.bd:                                            ; preds = %bb.ba
  %i.ex = load ptr, ptr %.sroa.45.0..sroa_idx.i.i, align 8, !noalias !18575, !nonnull !15, !noundef !15 ; 3 uses
  %i.ey = load i64, ptr %.sroa.56.0..sroa_idx.i.i, align 8, !noalias !18575, !noundef !15 ; 6 uses
...
"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$9ends_with17hf312aae698a97916E.exit.i.i": ; preds = %bb.bd
  ...
  %rhsc.i.i = load i8, ptr %i.fa, align 1, !noalias !18580
...
"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$9ends_with17hf312aae698a97916E.exit.thread.i.i": ; preds = %"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$9ends_with17hf312aae698a97916E.exit17.i.i", %bb.be, %"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$9ends_with17hf312aae698a97916E.exit.i.i", %bb.bd
  ...
  %.sroa.0.0.copyload1.i = load i64, ptr %i.f, align 8, !noalias !18589
  br label %"_ZN82_$LT$std..io..Lines$LT$B$GT$$u20$as$u20$core..iter..traits..iterator..Iterator$GT$4next17h0286c1abf63691a9E.exit.i"
...
bb.be:                                            ; preds = %"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$9ends_with17hf312aae698a97916E.exit.i.i"
  ...
  store i64 %i.fd, ptr %.sroa.56.0..sroa_idx.i.i, align 8, !alias.scope !18590, !noalias !18575
...
"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$9ends_with17hf312aae698a97916E.exit17.i.i": ; preds = %bb.be
  ...
  %rhsc32.i.i = load i8, ptr %i.ff, align 1, !noalias !18580
...
"_ZN82_$LT$std..io..Lines$LT$B$GT$$u20$as$u20$core..iter..traits..iterator..Iterator$GT$4next17h0286c1abf63691a9E.exit.i": ; preds = %"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$9ends_with17hf312aae698a97916E.exit.thread.i.i", %bb.bc, %bb.bb
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f), !noalias !18575
...
bb.bf:                                            ; preds = %"_ZN82_$LT$std..io..Lines$LT$B$GT$$u20$as$u20$core..iter..traits..iterator..Iterator$GT$4next17h0286c1abf63691a9E.exit.i"
  %i.fi = load i64, ptr %.sroa.2.0..sroa_idx, align 8, !alias.scope !18572, !noalias !18593, !noundef !15 ; 2 uses
  %i.fj = add i64 %i.fi, 1
  store i64 %i.fj, ptr %.sroa.2.0..sroa_idx, align 8, !alias.scope !18572, !noalias !18593
...
bb.bg:                                            ; preds = %"_ZN82_$LT$std..io..Lines$LT$B$GT$$u20$as$u20$core..iter..traits..iterator..Iterator$GT$4next17h0286c1abf63691a9E.exit.i"
  call void @llvm.experimental.noalias.scope.decl(metadata !18594)
  call void @llvm.experimental.noalias.scope.decl(metadata !18597)
  call void @llvm.experimental.noalias.scope.decl(metadata !18600)
  %i.fl = getelementptr inbounds nuw i8, ptr %i.o, i64 8
  %.val3.i.i.i = load i64, ptr %i.fl, align 8, !alias.scope !18603, !noundef !15 ; 2 uses
...
"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i.i.i.i": ; preds = %bb.bg
  %.val2.i.i.i = load ptr, ptr %i.o, align 8, !alias.scope !18603, !nonnull !15, !noundef !15
  call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val2.i.i.i, i64 noundef %.val3.i.i.i, i64 noundef 1) #51, !noalias !18603
  br label %bb.bi
...
bb.bi:                                            ; preds = %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i.i.i.i", %bb.bg
  ...
  %.val.i.i.i163 = load i32, ptr %i.fo, align 8, !range !1468, !alias.scope !18603, !noundef !15
  %i.fp = call noundef i32 @close(i32 noundef %.val.i.i.i163) #51, !noalias !18603 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.o)
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.054.i), !noalias !18604
...
.noexc168:                                        ; preds = %bb.bi
  ...
  br i1 %.not.i164, label %bb.bj, label %"_ZN92_$LT$core..str..iter..RSplitN$LT$P$GT$$u20$as$u20$core..iter..traits..iterator..Iterator$GT$4next17h42ce14be90945f97E.exit.i.i.i.i.i", !prof !169
...
"_ZN92_$LT$core..str..iter..RSplitN$LT$P$GT$$u20$as$u20$core..iter..traits..iterator..Iterator$GT$4next17h42ce14be90945f97E.exit.i.i.i.i.i": ; preds = %.noexc168
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e), !noalias !18604
...
.noexc170:                                        ; preds = %.noexc169
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !18608
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %i.d, ptr noundef nonnull align 8 dereferenceable(104) %.sroa.054.i, i64 104, i1 false), !alias.scope !18615, !noalias !18619
  %.sroa.4.0..sroa_idx.i166 = getelementptr inbounds nuw i8, ptr %i.d, i64 104
  store i64 0, ptr %.sroa.4.0..sroa_idx.i166, align 8, !alias.scope !18615, !noalias !18619
  %.sroa.5.0..sroa_idx.i167 = getelementptr inbounds nuw i8, ptr %i.d, i64 112
  store i64 %.sroa.5.0.i, ptr %.sroa.5.0..sroa_idx.i167, align 8, !alias.scope !18615, !noalias !18619
  %.sroa.655.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.d, i64 120
  store i8 1, ptr %.sroa.655.0..sroa_idx.i, align 8, !alias.scope !18615, !noalias !18619
  %.sroa.7.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.d, i64 121
  store i8 0, ptr %.sroa.7.0..sroa_idx.i, align 1, !alias.scope !18615, !noalias !18619
  %.sroa.856.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.d, i64 128
  call void @llvm.experimental.noalias.scope.decl(metadata !18620)
  call void @llvm.experimental.noalias.scope.decl(metadata !18623)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !18626
  store i64 1, ptr %.sroa.856.0..sroa_idx.i, align 8, !alias.scope !18629, !noalias !18634
end_hunk_0
