...
bb.h:                                             ; preds = %bb.g
  ...
  store ptr %.sroa.0.032, ptr %.sroa.631, align 8, !alias.scope !12852, !noalias !12854
...
"_ZN110_$LT$core..iter..adapters..enumerate..Enumerate$LT$I$GT$$u20$as$u20$core..iter..traits..iterator..Iterator$GT$4next17hdeb343d0fcdca947E.exit": ; preds = %bb.g, %bb.h
  ...
  %.sroa.631.0..sroa.631.0..sroa.631.0..sroa.631.8. = load ptr, ptr %.sroa.631, align 8, !noundef !17 ; 4 uses
...
bb.i:                                             ; preds = %"_ZN110_$LT$core..iter..adapters..enumerate..Enumerate$LT$I$GT$$u20$as$u20$core..iter..traits..iterator..Iterator$GT$4next17hdeb343d0fcdca947E.exit"
  %.sroa.9.0..sroa.9.0..sroa.9.0..sroa.9.16. = load ptr, ptr %.sroa.9, align 8, !nonnull !17, !align !29, !noundef !17 ; 2 uses
  %i.bi = load i8, ptr %.sroa.631.0..sroa.631.0..sroa.631.0..sroa.631.8., align 8, !range !16, !noundef !17
  %i.bj = and i8 %i.bi, 6
...
bb.s:                                             ; preds = %"_ZN77_$LT$alloc..string..String$u20$as$u20$core..cmp..PartialEq$LT$$RF$str$GT$$GT$2eq17h5e5f3ec0c5cf38a3E.exit.thread"
  ...
  call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.sroa.9.04460, i64 noundef %.sroa.05.04858, i64 noundef range(i64 1, -9223372036854775807) 1) #51, !noalias !18477
...
bb.u:                                             ; preds = %bb.t
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.9.04460) ]
  call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.sroa.9.04460, i64 noundef %.sroa.05.04858, i64 noundef range(i64 1, -9223372036854775807) 1) #51, !noalias !18478
