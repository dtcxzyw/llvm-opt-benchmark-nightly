...
begin_hunk_0_@"_ZN5alloc3vec16Vec$LT$T$C$A$GT$16into_boxed_slice17hed08685c27ccda50E":bb.a
...
bb.u:                                             ; preds = %.noexc._crit_edge.i, %bb.p
  ...
  %i.an = load i32, ptr %i.e, align 8             ; 2 uses
  %i.ao = udiv i64 %i.am, 10
  %i.ap = urem i64 %i.am, 10
  %i.aq = mul nuw nsw i64 %i.ap, 1000000000
  %i.ar = urem i32 %i.an, 10
  %i.as = zext nneg i32 %i.ar to i64
  %i.at = or disjoint i64 %i.aq, %i.as
  %i.au = udiv i32 %i.an, 10
  %i.av = udiv i64 %i.at, 10
  %i.aw = trunc nuw nsw i64 %i.av to i32
  %i.ax = add nuw nsw i32 %i.au, %i.aw            ; 3 uses
  %i.ay = icmp samesign ugt i32 %i.ax, 999999999  ; 2 uses
  %i.az = add nsw i32 %i.ax, -1000000000
  %.sroa.3.0.i.i.i = select i1 %i.ay, i32 %i.az, i32 %i.ax
  %i.ba = zext i1 %i.ay to i64
  %.sroa.0.0.i.i.i = add nuw nsw i64 %i.ao, %i.ba
  ...
  store i64 %.sroa.33.0.copyload.i, ptr %i.bd, align 8
  %i.be = getelementptr inbounds nuw i8, ptr %0, i64 80
  store i64 %.sroa.0.0.i.i.i, ptr %i.be, align 8
  %i.bf = getelementptr inbounds nuw i8, ptr %0, i64 88
  store i32 %.sroa.3.0.i.i.i, ptr %i.bf, align 8
  ...
  store i64 %.sroa.0.0, ptr %i.bh, align 8
  %i.bi = getelementptr inbounds nuw i8, ptr %0, i64 72
  store i64 %.sroa.4.0, ptr %i.bi, align 8
  ret void
...
"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit": ; preds = %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit_crit_edge", %bb.o
  %i.bk = phi ptr [ %.pre, %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit_crit_edge" ], [ %i.x, %bb.o ]
  store i64 0, ptr %i.bk, align 8
  store i64 1, ptr %i.z, align 8
  %i.bl = load i64, ptr %i.b, align 8             ; 2 uses
  %i.bm = icmp eq i64 %i.bl, 1
  br i1 %i.bm, label %bb.x, label %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.1"
...
"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.1": ; preds = %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.1_crit_edge", %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit"
  %i.bn = phi i64 [ %.pre41, %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.1_crit_edge" ], [ %i.bl, %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit" ] ; 2 uses
  %i.bo = load ptr, ptr %i.y, align 8
  %i.bp = getelementptr inbounds nuw i8, ptr %i.bo, i64 8
  store i64 0, ptr %i.bp, align 8
  store i64 2, ptr %i.z, align 8
  %i.bq = icmp eq i64 %i.bn, 2
  br i1 %i.bq, label %bb.y, label %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.2"
...
"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.2": ; preds = %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.2_crit_edge", %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.1"
  %i.br = phi i64 [ %.pre42, %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.2_crit_edge" ], [ %i.bn, %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.1" ] ; 2 uses
  %i.bs = load ptr, ptr %i.y, align 8             ; 2 uses
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bs, i64 16
  store i64 0, ptr %i.bt, align 8
  store i64 3, ptr %i.z, align 8
  %i.bu = icmp eq i64 %i.br, 3
  br i1 %i.bu, label %bb.z, label %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.3"
...
"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.3": ; preds = %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.3_crit_edge", %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.2"
  %i.bv = phi i64 [ %.pre44, %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.3_crit_edge" ], [ %i.br, %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.2" ] ; 2 uses
  %i.bw = phi ptr [ %.pre43, %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.3_crit_edge" ], [ %i.bs, %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.2" ] ; 2 uses
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bw, i64 24
  store i64 0, ptr %i.bx, align 8
  store i64 4, ptr %i.z, align 8
  %i.by = icmp eq i64 %i.bv, 4
  br i1 %i.by, label %bb.aa, label %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.4"
...
"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.4": ; preds = %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.4_crit_edge", %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.3"
  %i.bz = phi i64 [ %.pre46, %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.4_crit_edge" ], [ %i.bv, %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.3" ] ; 2 uses
  %i.ca = phi ptr [ %.pre45, %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.4_crit_edge" ], [ %i.bw, %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.3" ] ; 2 uses
  %i.cb = getelementptr inbounds nuw i8, ptr %i.ca, i64 32
  store i64 0, ptr %i.cb, align 8
  store i64 5, ptr %i.z, align 8
  %i.cc = icmp eq i64 %i.bz, 5
  br i1 %i.cc, label %bb.ab, label %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.5"
...
"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.5": ; preds = %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.5_crit_edge", %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.4"
  %i.cd = phi i64 [ %.pre48, %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.5_crit_edge" ], [ %i.bz, %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.4" ] ; 2 uses
  %i.ce = phi ptr [ %.pre47, %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.5_crit_edge" ], [ %i.ca, %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.4" ] ; 2 uses
  %i.cf = getelementptr inbounds nuw i8, ptr %i.ce, i64 40
  store i64 0, ptr %i.cf, align 8
  store i64 6, ptr %i.z, align 8
  %i.cg = icmp eq i64 %i.cd, 6
  br i1 %i.cg, label %bb.ac, label %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.6"
...
"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.6": ; preds = %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.6_crit_edge", %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.5"
  %i.ch = phi i64 [ %.pre50, %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.6_crit_edge" ], [ %i.cd, %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.5" ] ; 2 uses
  %i.ci = phi ptr [ %.pre49, %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.6_crit_edge" ], [ %i.ce, %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.5" ] ; 2 uses
  %i.cj = getelementptr inbounds nuw i8, ptr %i.ci, i64 48
  store i64 0, ptr %i.cj, align 8
  store i64 7, ptr %i.z, align 8
  %i.ck = icmp eq i64 %i.ch, 7
  br i1 %i.ck, label %bb.ad, label %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.7"
...
"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.7": ; preds = %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.7_crit_edge", %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.6"
  %i.cl = phi i64 [ %.pre52, %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.7_crit_edge" ], [ %i.ch, %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.6" ] ; 2 uses
  %i.cm = phi ptr [ %.pre51, %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.7_crit_edge" ], [ %i.ci, %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.6" ] ; 2 uses
  %i.cn = getelementptr inbounds nuw i8, ptr %i.cm, i64 56
  store i64 0, ptr %i.cn, align 8
  store i64 8, ptr %i.z, align 8
  %i.co = icmp eq i64 %i.cl, 8
  br i1 %i.co, label %bb.ae, label %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.8"
...
"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.8": ; preds = %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.8_crit_edge", %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.7"
  %i.cp = phi i64 [ %.pre54, %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.8_crit_edge" ], [ %i.cl, %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.7" ]
  %i.cq = phi ptr [ %.pre53, %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.8_crit_edge" ], [ %i.cm, %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.7" ] ; 2 uses
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cq, i64 64
  store i64 0, ptr %i.cr, align 8
  store i64 9, ptr %i.z, align 8
  %i.cs = icmp eq i64 %i.cp, 9
  br i1 %i.cs, label %bb.af, label %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.9"
...
"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.9": ; preds = %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.9_crit_edge", %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.8"
  %i.ct = phi ptr [ %.pre55, %"._ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.9_crit_edge" ], [ %i.cq, %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$4push17hdf0081c64cf04c2aE.exit.8" ]
  %i.cu = getelementptr inbounds nuw i8, ptr %i.ct, i64 72
  store i64 0, ptr %i.cu, align 8
  store i64 10, ptr %i.z, align 8
  %i.cv = invoke { i64, i32 } @_ZN5tokio4time7instant7Instant3now17h457a2db67d794c3eE()
