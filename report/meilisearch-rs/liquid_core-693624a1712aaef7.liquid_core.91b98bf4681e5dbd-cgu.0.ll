...
bb.k:                                             ; preds = %thread-pre-split.i.i
  ...
  br i1 %i.bd, label %.lr.ph.i.i, label %.lr.ph
...
.preheader99.i.i:                                 ; preds = %bb.n
  ...
  br i1 %.not.i.i, label %"_ZN4core3num21_$LT$impl$u20$i64$GT$16from_ascii_radix17h9bd37d44ea71734dE.exit.i", label %.lr.ph

.lr.ph:                                           ; preds = %bb.k, %.preheader99.i.i
...
.loopexit103.i:                                   ; preds = %bb.n, %bb.m, %.lr.ph, %.lr.ph.i.i, %bb.r, %bb.q, %.lr.ph57, %.lr.ph117.i.i, %bb.i, %bb.i
...
bb.l:                                             ; preds = %bb.j
  ...
  br i1 %i.ab, label %.preheader97.i, label %.lr.ph
...
.preheader99.i:                                   ; preds = %bb.o
  ...
  br i1 %.not.i.not, label %"_ZN4core3num21_$LT$impl$u20$i64$GT$16from_ascii_radix17h9bd37d44ea71734dE.exit", label %.lr.ph

.lr.ph:                                           ; preds = %bb.l, %.preheader99.i
...
bb.al:                                            ; preds = %bb.aj
  ...
  br i1 %i.di, label %.preheader97.i, label %.lr.ph
...
.preheader99.i:                                   ; preds = %bb.ao
  ...
  br i1 %.not.i43, label %.loopexit83, label %.lr.ph

.lr.ph:                                           ; preds = %bb.al, %.preheader99.i
...
.loopexit:                                        ; preds = %bb.ao, %bb.an, %.lr.ph, %.lr.ph.i, %.lr.ph155, %bb.ar, %bb.as, %.lr.ph117.i, %bb.ai, %bb.ai, %bb.ah
  %.sroa.4.0.ph = phi i8 [ 1, %bb.ai ], [ 1, %bb.ai ], [ 0, %bb.ah ], [ 2, %bb.ar ], [ 1, %.lr.ph.i ], [ 1, %.lr.ph117.i ], [ 2, %bb.as ], [ 1, %.lr.ph155 ], [ 1, %.lr.ph ], [ 3, %bb.ao ], [ 3, %bb.an ]
