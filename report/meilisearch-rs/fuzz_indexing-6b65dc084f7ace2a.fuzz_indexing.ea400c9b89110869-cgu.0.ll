...
.lr.ph156.i:                                      ; preds = %"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit57.i", %.lr.ph156.preheader.i
  ...
  %i.dh = phi <2 x double> [ %i.dx, %"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit57.i" ], [ %i.by, %.lr.ph156.preheader.i ] ; 2 uses
  %i.di = phi <2 x double> [ %i.du, %"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit57.i" ], [ %i.bv, %.lr.ph156.preheader.i ] ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !43127)
  %i.dj = load i64, ptr %.sroa.025.0153.i, align 8, !range !52, !alias.scope !43128, !noalias !43127, !noundef !16
...
bb.o:                                             ; preds = %.lr.ph156.i
  ...
  %.sroa.781.24.copyload.i = load double, ptr %i.dl, align 8, !alias.scope !43129
  %.sroa.1083.24..sroa_idx.i = getelementptr inbounds nuw i8, ptr %.sroa.025.0153.i, i64 56
  %.sroa.073.0.copyload.i = load double, ptr %i.dk, align 8, !alias.scope !43129
  %.sroa.575.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %.sroa.025.0153.i, i64 32
  %i.dm = load <2 x double>, ptr %.sroa.1083.24..sroa_idx.i, align 8, !alias.scope !43129
  %i.dn = load <2 x double>, ptr %.sroa.575.0..sroa_idx.i, align 8, !alias.scope !43129
...
bb.p:                                             ; preds = %.lr.ph156.i
  ...
  %.sroa.073.0.copyload74.i = load double, ptr %i.do, align 8, !alias.scope !43130 ; 2 uses
  %.sroa.575.0..sroa_idx76.i = getelementptr inbounds nuw i8, ptr %.sroa.025.0153.i, i64 16
  %i.dp = load <2 x double>, ptr %.sroa.575.0..sroa_idx76.i, align 8, !alias.scope !43130 ; 2 uses
  br label %"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit57.i"
...
._crit_edge157.i:                                 ; preds = %"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit57.i", %._crit_edge.i
  ...
  %3 = phi <2 x double> [ %i.by, %._crit_edge.i ], [ %i.dx, %"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit57.i" ]
  %4 = phi <2 x double> [ %i.bv, %._crit_edge.i ], [ %i.du, %"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit57.i" ]
...
._crit_edge241:                                   ; preds = %._crit_edge228, %"_ZN72_$LT$rstar..aabb..AABB$LT$P$GT$$u20$as$u20$rstar..envelope..Envelope$GT$14sort_envelopes17hb161179fd9292f95E.exit"
  ...
  br i1 %i.ew, label %bb.t, label %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i, !prof !18
...
_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i: ; preds = %._crit_edge241
  ...
  br i1 %i.ez, label %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$9split_off17h51b9c8a631cb2e92E.exit", label %bb.r
...
bb.r:                                             ; preds = %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i
  ...
  %i.fa = call noundef align 8 ptr @_RNvCskdKJRKLKjqM_7___rustc12___rust_alloc(i64 noundef %i.ey, i64 noundef range(i64 1, 9) 8) #65, !noalias !43134 ; 2 uses
  %i.fb = icmp eq ptr %i.fa, null
  br i1 %i.fb, label %bb.s, label %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$9split_off17h51b9c8a631cb2e92E.exit"

bb.s:                                             ; preds = %bb.r
  call void @_ZN5alloc7raw_vec12handle_error17h5794e6eba25188a7E(i64 noundef 8, i64 %i.ey, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) @900) #66, !noalias !43135
  unreachable
...
"_ZN5alloc3vec16Vec$LT$T$C$A$GT$9split_off17h51b9c8a631cb2e92E.exit": ; preds = %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i, %bb.r
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %.sroa.10.0.i.i, ptr nonnull align 8 %i.fc, i64 %i.ey, i1 false), !noalias !43137
  ...
  br i1 %i.fe, label %_ZN5rstar4node21envelope_for_children17h42c51f49c90f4724E.exit, label %.lr.ph.i
...
.lr.ph.i:                                         ; preds = %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$9split_off17h51b9c8a631cb2e92E.exit", %"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit.i38"
  %.sroa.02.023.i = phi ptr [ %i.fh, %"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit.i38" ], [ %.val26, %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$9split_off17h51b9c8a631cb2e92E.exit" ] ; 9 uses
  ...
  %i.ff = phi <2 x double> [ %i.ft, %"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit.i38" ], [ splat (double f0x7FEFFFFFFFFFFFFF), %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$9split_off17h51b9c8a631cb2e92E.exit" ] ; 2 uses
  %i.fg = phi <2 x double> [ %i.fw, %"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit.i38" ], [ splat (double f0xFFEFFFFFFFFFFFFF), %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$9split_off17h51b9c8a631cb2e92E.exit" ] ; 2 uses
  ...
  %i.fi = load i64, ptr %.sroa.02.023.i, align 8, !range !52, !alias.scope !43139, !noalias !43140, !noundef !16
...
bb.u:                                             ; preds = %.lr.ph.i
  ...
  %i.fl = load <2 x double>, ptr %i.fk, align 8, !alias.scope !43141, !noalias !43142
  ...
  %i.fm = load <2 x double>, ptr %i.fj, align 8, !alias.scope !43141, !noalias !43142
...
bb.v:                                             ; preds = %.lr.ph.i
  ...
  %i.fo = load <2 x double>, ptr %i.fn, align 8, !alias.scope !43143, !noalias !43142 ; 2 uses
...
"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit.i38": ; preds = %bb.v, %bb.u
  ...
  br i1 %i.fy, label %_ZN5rstar4node21envelope_for_children17h42c51f49c90f4724E.exit, label %.lr.ph.i
...
_ZN5rstar4node21envelope_for_children17h42c51f49c90f4724E.exit: ; preds = %"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit.i38", %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$9split_off17h51b9c8a631cb2e92E.exit"
  ...
  %i.fz = phi <2 x double> [ splat (double f0x7FEFFFFFFFFFFFFF), %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$9split_off17h51b9c8a631cb2e92E.exit" ], [ %i.ft, %"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit.i38" ]
  %i.ga = phi <2 x double> [ splat (double f0xFFEFFFFFFFFFFFFF), %"_ZN5alloc3vec16Vec$LT$T$C$A$GT$9split_off17h51b9c8a631cb2e92E.exit" ], [ %i.fw, %"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit.i38" ]
  ...
  br i1 %i.ez, label %"_ZN5rstar4node19ParentNode$LT$T$GT$10new_parent17h9548047a08813715E.exit", label %.lr.ph.i.i
...
.lr.ph.i.i:                                       ; preds = %_ZN5rstar4node21envelope_for_children17h42c51f49c90f4724E.exit, %"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit.i.i"
  %.sroa.02.023.i.i = phi ptr [ %i.gf, %"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit.i.i" ], [ %.sroa.10.0.i.i, %_ZN5rstar4node21envelope_for_children17h42c51f49c90f4724E.exit ] ; 9 uses
  ...
  %i.gd = phi <2 x double> [ %i.gr, %"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit.i.i" ], [ splat (double f0x7FEFFFFFFFFFFFFF), %_ZN5rstar4node21envelope_for_children17h42c51f49c90f4724E.exit ] ; 2 uses
  %i.ge = phi <2 x double> [ %i.gu, %"_ZN78_$LT$rstar..node..RTreeNode$LT$T$GT$$u20$as$u20$rstar..object..RTreeObject$GT$8envelope17hb51705d4db01ce66E.exit.i.i" ], [ splat (double f0xFFEFFFFFFFFFFFFF), %_ZN5rstar4node21envelope_for_children17h42c51f49c90f4724E.exit ] ; 2 uses
  ...
  %i.gg = load i64, ptr %.sroa.02.023.i.i, align 8, !range !52, !alias.scope !43145, !noalias !43146, !noundef !16
...
bb.w:                                             ; preds = %.lr.ph.i.i
  ...
  %i.gj = load <2 x double>, ptr %i.gi, align 8, !alias.scope !43147, !noalias !43148
  %.sroa.11.24..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %.sroa.02.023.i.i, i64 64
  %.sroa.11.24.copyload.i.i = load double, ptr %.sroa.11.24..sroa_idx.i.i, align 8, !alias.scope !43147, !noalias !43148
  %i.gk = load <2 x double>, ptr %i.gh, align 8, !alias.scope !43147, !noalias !43148
  %.sroa.69.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %.sroa.02.023.i.i, i64 40
...
bb.x:                                             ; preds = %.lr.ph.i.i
  ...
  %i.gm = load <2 x double>, ptr %i.gl, align 8, !alias.scope !43149, !noalias !43148 ; 2 uses
  %.sroa.69.0..sroa_idx10.i.i = getelementptr inbounds nuw i8, ptr %.sroa.02.023.i.i, i64 24
