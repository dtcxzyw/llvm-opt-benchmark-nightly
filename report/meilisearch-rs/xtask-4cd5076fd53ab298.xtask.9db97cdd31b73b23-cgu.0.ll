...
.lr.ph.i.i.i:                                     ; preds = %bb.jo, %"_ZN4core3ptr198drop_in_place$LT$tokio..runtime..task..join..JoinHandle$LT$core..result..Result$LT$core..option..Option$LT$$LP$serde_json..value..Value$C$http..status..StatusCode$RP$$GT$$C$anyhow..Error$GT$$GT$$GT$17h231c2729dba5deb9E.exit.i.i.i"
  ...
  %.val7.i.i.i = load ptr, ptr %i.aek, align 8, !alias.scope !34627, !noalias !34628, !nonnull !24, !noundef !24 ; 2 uses
  %i.aem = invoke noundef zeroext i1 @_ZN5tokio7runtime4task5state5State21drop_join_handle_fast17hb9ab0c5145feba20E(ptr noundef nonnull align 8 %.val7.i.i.i)
          to label %.noexc.i.i.i32 unwind label %bb.jq, !noalias !34629
...
bb.jp:                                            ; preds = %.noexc.i.i.i32
  invoke void @_ZN5tokio7runtime4task3raw7RawTask21drop_join_handle_slow17h4d222bbab74c4274E(ptr noundef nonnull %.val7.i.i.i)
          to label %"_ZN4core3ptr198drop_in_place$LT$tokio..runtime..task..join..JoinHandle$LT$core..result..Result$LT$core..option..Option$LT$$LP$serde_json..value..Value$C$http..status..StatusCode$RP$$GT$$C$anyhow..Error$GT$$GT$$GT$17h231c2729dba5deb9E.exit.i.i.i" unwind label %bb.jq, !noalias !34629
...
.lr.ph15.i.i.i:                                   ; preds = %bb.jq, %"_ZN4core3ptr198drop_in_place$LT$tokio..runtime..task..join..JoinHandle$LT$core..result..Result$LT$core..option..Option$LT$$LP$serde_json..value..Value$C$http..status..StatusCode$RP$$GT$$C$anyhow..Error$GT$$GT$$GT$17h231c2729dba5deb9E.exit11.i.i.i"
  ...
  %.val.i.i.i29 = load ptr, ptr %i.aeq, align 8, !alias.scope !34627, !noalias !34628, !nonnull !24, !noundef !24 ; 2 uses
  %i.aes = invoke noundef zeroext i1 @_ZN5tokio7runtime4task5state5State21drop_join_handle_fast17hb9ab0c5145feba20E(ptr noundef nonnull align 8 %.val.i.i.i29)
          to label %.noexc9.i.i.i unwind label %bb.js, !noalias !34629
...
bb.jr:                                            ; preds = %.noexc9.i.i.i
  invoke void @_ZN5tokio7runtime4task3raw7RawTask21drop_join_handle_slow17h4d222bbab74c4274E(ptr noundef nonnull %.val.i.i.i29)
          to label %"_ZN4core3ptr198drop_in_place$LT$tokio..runtime..task..join..JoinHandle$LT$core..result..Result$LT$core..option..Option$LT$$LP$serde_json..value..Value$C$http..status..StatusCode$RP$$GT$$C$anyhow..Error$GT$$GT$$GT$17h231c2729dba5deb9E.exit11.i.i.i" unwind label %bb.js, !noalias !34629
...
bb.js:                                            ; preds = %bb.jr, %.lr.ph15.i.i.i
  %i.aeu = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_ZN4core9panicking16panic_in_cleanup17h5eff40bcc4481d72E() #56, !noalias !34629
  unreachable
...
.body.i30:                                        ; preds = %"_ZN4core3ptr198drop_in_place$LT$tokio..runtime..task..join..JoinHandle$LT$core..result..Result$LT$core..option..Option$LT$$LP$serde_json..value..Value$C$http..status..StatusCode$RP$$GT$$C$anyhow..Error$GT$$GT$$GT$17h231c2729dba5deb9E.exit11.i.i.i", %bb.jq
  %.val2.i31 = load i64, ptr %i.aeg, align 8, !range !30, !alias.scope !34626, !noalias !34448, !noundef !24 ; 2 uses
  %i.aev = icmp eq i64 %.val2.i31, 0
  br i1 %i.aev, label %.body34, label %bb.jt

bb.jt:                                            ; preds = %.body.i30
  %i.aew = shl nuw i64 %.val2.i31, 3
  call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val4.i28, i64 noundef %i.aew, i64 noundef range(i64 1, -9223372036854775807) 8) #47, !noalias !34628
  br label %.body34
...
"_ZN70_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h5b694516929171f2E.exit.i": ; preds = %"_ZN4core3ptr198drop_in_place$LT$tokio..runtime..task..join..JoinHandle$LT$core..result..Result$LT$core..option..Option$LT$$LP$serde_json..value..Value$C$http..status..StatusCode$RP$$GT$$C$anyhow..Error$GT$$GT$$GT$17h231c2729dba5deb9E.exit.i.i.i", %bb.jo
  %.val.i33 = load i64, ptr %i.aeg, align 8, !range !30, !alias.scope !34626, !noalias !34448, !noundef !24 ; 2 uses
...
bb.ju:                                            ; preds = %"_ZN70_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h5b694516929171f2E.exit.i"
  ...
  call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val4.i28, i64 noundef %i.aey, i64 noundef range(i64 1, -9223372036854775807) 8) #47, !noalias !34628
...
.thread142:                                       ; preds = %bb.jj, %bb.ek
  ...
  store i8 %.sink.i.ph, ptr %i.afa, align 1, !noalias !34446
...
bb.jw:                                            ; preds = %"_ZN4core3ptr340drop_in_place$LT$core..iter..adapters..zip..Zip$LT$alloc..vec..into_iter..IntoIter$LT$tokio..runtime..task..join..JoinHandle$LT$core..result..Result$LT$core..option..Option$LT$$LP$serde_json..value..Value$C$http..status..StatusCode$RP$$GT$$C$anyhow..Error$GT$$GT$$GT$$C$core..slice..iter..Iter$LT$xtask..common..command..Command$GT$$GT$$GT$17h2965cdbf8883eef4E.exit150.i", %bb.jm
  ...
  %.sroa.0261.0.copyload.i = load i64, ptr %i.afd, align 8, !noalias !34446 ; 2 uses
  %.sroa.4262.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %1, i64 240
  %.sroa.4262.0.copyload.i = load ptr, ptr %.sroa.4262.0..sroa_idx.i, align 8, !noalias !34446
  %.sroa.5263.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %1, i64 248
  %.sroa.5263.0.copyload.i = load i64, ptr %.sroa.5263.0..sroa_idx.i, align 8, !noalias !34446
  %i.afe = getelementptr inbounds nuw i8, ptr %1, i64 282
  store i8 0, ptr %i.afe, align 2, !noalias !34446
  store i8 1, ptr %i.afb, align 1, !noalias !34446
  call void @llvm.lifetime.end.p0(ptr nonnull %i.aw)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.az)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ba)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.bc)
...
.sink.split:                                      ; preds = %bb.l, %.thread155
  ...
  store i8 1, ptr %.sink, align 1, !noalias !34446
  call void @llvm.lifetime.end.p0(ptr nonnull %i.aw)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.az)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ba)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.bc)
...
"_ZN79_$LT$core..result..Result$LT$T$C$E$GT$$u20$as$u20$core..ops..try_trait..Try$GT$6branch17hb2ba1f312c196b47E.exit": ; preds = %bb.ka
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !34632)
  %i.afk = getelementptr inbounds nuw i8, ptr %1, i64 120 ; 3 uses
  %i.afl = load i64, ptr %i.afk, align 8, !alias.scope !34633, !noalias !34631, !noundef !24 ; 3 uses
  %i.afm = load i64, ptr %i.afj, align 8, !range !30, !alias.scope !34633, !noalias !34631, !noundef !24
...
.noexc24:                                         ; preds = %bb.kb
  %.pre.i.i23 = load i64, ptr %i.afk, align 8, !alias.scope !34634, !noalias !34631
...
"_ZN70_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h3ca717c3dfa02006E.exit.i": ; preds = %"_ZN79_$LT$core..result..Result$LT$T$C$E$GT$$u20$as$u20$core..ops..try_trait..Try$GT$6branch17hb2ba1f312c196b47E.exit", %.noexc24
  ...
  %i.aft = load ptr, ptr %i.afs, align 8, !alias.scope !34634, !noalias !34631, !nonnull !24, !noundef !24
  %i.afu = getelementptr inbounds nuw [80 x i8], ptr %i.aft, i64 %i.afq
  %i.afv = mul i64 %.sroa.1093.0152, 80
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.afu, ptr nonnull readonly align 8 %.sroa.992.0153, i64 %i.afv, i1 false), !noalias !34635
  %i.afw = add i64 %i.afq, %.sroa.1093.0152
  store i64 %i.afw, ptr %i.afk, align 8, !alias.scope !34634, !noalias !34631
  store i64 0, ptr %.sroa.598.0..sroa_idx, align 8, !alias.scope !34631, !noalias !34630
...
bb.kd:                                            ; preds = %"_ZN70_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h3ca717c3dfa02006E.exit.i"
  ...
  call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.sroa.992.0153, i64 noundef %i.agd, i64 noundef range(i64 1, -9223372036854775807) 8) #47, !noalias !34636
...
"_ZN4core3ptr103drop_in_place$LT$alloc..vec..Vec$LT$$LP$serde_json..value..Value$C$http..status..StatusCode$RP$$GT$$GT$17h076e4bdcd3dbabf2E.exit": ; preds = %bb.kd, %"_ZN70_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h3ca717c3dfa02006E.exit.i"
  ...
  %.pre = load i8, ptr %.phi.trans.insert, align 8, !range !38, !alias.scope !34444
  br label %bb.e
...
.thread390:                                       ; preds = %.thread, %bb.h
  ...
  store ptr %i.agh, ptr %i.cm, align 8, !alias.scope !34444
  store i64 %i.agg, ptr %i.cq, align 8, !alias.scope !34444
...
bb.a:
  ...
  %i.b = tail call noundef dereferenceable_or_null(44) ptr @_RNvCskdKJRKLKjqM_7___rustc12___rust_alloc(i64 noundef 44, i64 noundef range(i64 1, 9) 1) #47, !noalias !34667 ; 4 uses
...
bb.b:                                             ; preds = %bb.a
  tail call void @_ZN5alloc7raw_vec12handle_error17h5794e6eba25188a7E(i64 noundef 1, i64 44, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) @1765) #54, !noalias !34668
  unreachable
...
"_ZN87_$LT$T$u20$as$u20$alloc..slice..$LT$impl$u20$$u5b$T$u5d$$GT$..to_vec_in..ConvertVec$GT$6to_vec17h4e722af2283a9a09E.exit": ; preds = %bb.a
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(44) %i.b, ptr noundef nonnull align 1 dereferenceable(44) @1217, i64 44, i1 false), !noalias !34669
  tail call void @_RNvCskdKJRKLKjqM_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #47, !noalias !34670
  %i.d = tail call noundef dereferenceable_or_null(7) ptr @_RNvCskdKJRKLKjqM_7___rustc12___rust_alloc(i64 noundef 7, i64 noundef range(i64 1, 9) 1) #47, !noalias !34670 ; 4 uses
...
bb.e:                                             ; preds = %"_ZN87_$LT$T$u20$as$u20$alloc..slice..$LT$impl$u20$$u5b$T$u5d$$GT$..to_vec_in..ConvertVec$GT$6to_vec17h4e722af2283a9a09E.exit"
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(7) %i.d, ptr noundef nonnull align 1 dereferenceable(7) @1218, i64 7, i1 false), !noalias !34671
  ...
  %i.i = load i8, ptr %i.h, align 8, !range !38, !noalias !34672, !noundef !24
...
._ZN4core3ops8function6FnOnce9call_once17he8e49505c7ce8ce8E.exit_crit_edge.i.i: ; preds = %bb.e
  %.pre.i.i = load i64, ptr %i.g, align 8, !noalias !34673
  %.phi.trans.insert.i.i = getelementptr inbounds nuw i8, ptr %i.g, i64 8
  %.pre1.i.i = load i64, ptr %.phi.trans.insert.i.i, align 8, !noalias !34673
  br label %bb.g
...
.noexc13:                                         ; preds = %"_ZN3std3sys12thread_local6native4lazy20Storage$LT$T$C$D$GT$16get_or_init_slow17h1d011a7d4dd08efeE.exit.i.i"
  ...
  store i64 %i.m, ptr %i.n, align 8, !noalias !34674
  store i8 1, ptr %i.h, align 8, !noalias !34674
  br label %bb.g
...
bb.g:                                             ; preds = %.noexc13, %._ZN4core3ops8function6FnOnce9call_once17he8e49505c7ce8ce8E.exit_crit_edge.i.i
  ...
  store i64 %i.p, ptr %i.g, align 8, !noalias !34673
