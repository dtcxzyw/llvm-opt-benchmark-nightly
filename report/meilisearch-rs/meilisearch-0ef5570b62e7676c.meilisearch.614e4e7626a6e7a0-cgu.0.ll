...
.lr.ph583.i.i.preheader:                          ; preds = %bb.au
  ...
  br i1 %min.iters.check3753, label %.lr.ph583.i.i.preheader4464, label %vector.ph3754
...
middle.block3760:                                 ; preds = %vector.body3756
  ...
  br i1 %cmp.n, label %._crit_edge584.i.i, label %.lr.ph583.i.i.preheader4464

.lr.ph583.i.i.preheader4464:                      ; preds = %.lr.ph583.i.i.preheader, %middle.block3760
...
.lr.ph583.i.i:                                    ; preds = %.lr.ph583.i.i.preheader4464, %.lr.ph583.i.i
  %.sroa.047.2581.i.i = phi i32 [ %i.kx, %.lr.ph583.i.i ], [ %.sroa.047.2581.i.i.ph, %.lr.ph583.i.i.preheader4464 ] ; 2 uses
  %.sroa.0135.0580.i.i = phi ptr [ %.sroa.0135.1.i.i, %.lr.ph583.i.i ], [ %.sroa.0135.0580.i.i.ph, %.lr.ph583.i.i.preheader4464 ] ; 2 uses
...
bb.bd:                                            ; preds = %bb.bd, %bb.bc
  ...
  %i.lo = shl i64 %.sroa.0101.1.i.i, 1
...
bb.bi:                                            ; preds = %bb.bi, %bb.bh
  ...
  %i.lx = shl i64 %.sroa.0104.1.i.i, 1
...
.lr.ph597.i.i.preheader:                          ; preds = %bb.ik
  ...
  %min.iters.check3845 = icmp ult i64 %i.bcy, 28
  br i1 %min.iters.check3845, label %.lr.ph597.i.i.preheader4245, label %vector.ph3846

vector.ph3846:                                    ; preds = %.lr.ph597.i.i.preheader
  %n.vec3847 = and i64 %i.bda, 9223372036854775800 ; 4 uses
  %i.bdb = trunc i64 %n.vec3847 to i32
  %i.bdc = shl i64 %n.vec3847, 2
  %i.bdd = getelementptr i8, ptr %i.bcu, i64 %i.bdc
  br label %vector.body3848

vector.body3848:                                  ; preds = %vector.body3848, %vector.ph3846
  %index3849 = phi i64 [ 0, %vector.ph3846 ], [ %index.next3853, %vector.body3848 ] ; 2 uses
  %vec.ind3850 = phi <4 x i32> [ <i32 0, i32 1, i32 2, i32 3>, %vector.ph3846 ], [ %vec.ind.next3854, %vector.body3848 ] ; 3 uses
  %step.add3851 = add <4 x i32> %vec.ind3850, splat (i32 4)
  %i.bde = shl i64 %index3849, 2
  %next.gep3852 = getelementptr i8, ptr %i.bcu, i64 %i.bde ; 2 uses
  %i.bdf = getelementptr i8, ptr %next.gep3852, i64 16
  store <4 x i32> %vec.ind3850, ptr %next.gep3852, align 4, !noalias !34805
  store <4 x i32> %step.add3851, ptr %i.bdf, align 4, !noalias !34805
  %index.next3853 = add nuw i64 %index3849, 8     ; 2 uses
  %vec.ind.next3854 = add <4 x i32> %vec.ind3850, splat (i32 8)
  %i.bdg = icmp eq i64 %index.next3853, %n.vec3847
  br i1 %i.bdg, label %middle.block3855, label %vector.body3848, !llvm.loop !34859

middle.block3855:                                 ; preds = %vector.body3848
  %cmp.n3856 = icmp eq i64 %i.bda, %n.vec3847
  br i1 %cmp.n3856, label %._crit_edge598.i.i, label %.lr.ph597.i.i.preheader4245

.lr.ph597.i.i.preheader4245:                      ; preds = %.lr.ph597.i.i.preheader, %middle.block3855
  %.sroa.047.2595.i.i.ph = phi i32 [ 0, %.lr.ph597.i.i.preheader ], [ %i.bdb, %middle.block3855 ]
  %.sroa.0135.0594.i.i.ph = phi ptr [ %i.bcu, %.lr.ph597.i.i.preheader ], [ %i.bdd, %middle.block3855 ]
  br label %.lr.ph597.i.i

.lr.ph597.i.i:                                    ; preds = %.lr.ph597.i.i.preheader4245, %.lr.ph597.i.i
  %.sroa.047.2595.i.i = phi i32 [ %i.bdh, %.lr.ph597.i.i ], [ %.sroa.047.2595.i.i.ph, %.lr.ph597.i.i.preheader4245 ] ; 2 uses
  %.sroa.0135.0594.i.i = phi ptr [ %.sroa.0135.1.i.i300, %.lr.ph597.i.i ], [ %.sroa.0135.0594.i.i.ph, %.lr.ph597.i.i.preheader4245 ] ; 2 uses
...
bb.iq:                                            ; preds = %bb.in, %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i469.i.i317
  %.sroa.10.0.i.i470.i.i318 = phi i64 [ %i.bdn, %bb.in ], [ 4, %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i469.i.i317 ]
  %i.bdp = inttoptr i64 %.sroa.10.0.i.i470.i.i318 to ptr ; 6 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %i.bdp) ]
  br i1 %i.bcx, label %.preheader.split.i.i319, label %.lr.ph601.preheader.i.i

.lr.ph601.preheader.i.i:                          ; preds = %bb.iq
  tail call void @llvm.memset.p0.i64(ptr nonnull align 4 %i.bdp, i8 -1, i64 %i.bck, i1 false), !noalias !34805
  br label %.preheader.split.i.i319

.preheader.split.i.i319:                          ; preds = %.lr.ph601.preheader.i.i, %bb.iq
  %i.bdq = getelementptr inbounds nuw i8, ptr %i.w, i64 2816 ; 2 uses
  %i.bdr = getelementptr inbounds nuw i8, ptr %i.w, i64 2824
  %i.bds = getelementptr inbounds nuw i8, ptr %i.u, i64 2816 ; 3 uses
  %.not1175.i.i = icmp eq i64 %i.bdj, 0           ; 2 uses
  %i.bdt = getelementptr inbounds nuw i8, ptr %i.v, i64 2816 ; 3 uses
  br label %bb.jn

bb.ir:                                            ; preds = %bb.jr
  tail call void @mi_free(ptr noundef nonnull align 4 %i.bcu) #38, !noalias !34805
  ...
  %i.bdu = getelementptr inbounds nuw i8, ptr %8, i64 8 ; 2 uses
  %.val366.i.i348 = load i64, ptr %i.bdu, align 8, !alias.scope !34866, !noalias !34867, !noundef !27 ; 5 uses
  %i.bdv = icmp ult i64 %.val366.i.i348, %.sroa.0.0.i.i204
  br i1 %i.bdv, label %bb.is, label %bb.iw

bb.is:                                            ; preds = %bb.ir
  %i.bdw = icmp eq i64 %.val366.i.i348, 0         ; 2 uses
  %spec.select.i170.i = select i1 %i.bdw, i64 %.sroa.0.0.i.i204, i64 %.val366.i.i348
  br label %bb.it

bb.it:                                            ; preds = %bb.it, %bb.is
  %.sroa.0101.1.i.i368 = phi i64 [ %spec.select.i170.i, %bb.is ], [ %i.bdy, %bb.it ] ; 9 uses
  %i.bdx = icmp ult i64 %.sroa.0101.1.i.i368, %.sroa.0.0.i.i204
  %i.bdy = shl i64 %.sroa.0101.1.i.i368, 1
  br i1 %i.bdx, label %bb.it, label %bb.iu

bb.iu:                                            ; preds = %bb.it
  %i.bdz = icmp slt i64 %.sroa.0101.1.i.i368, 0
  br i1 %i.bdz, label %.invoke1168.i.i, label %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i478.i.i369, !prof !3798
...
_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i478.i.i369: ; preds = %bb.iu
  ...
  %i.bea = tail call noundef ptr @mi_zalloc_aligned(i64 noundef range(i64 1, 0) %.sroa.0101.1.i.i368, i64 noundef range(i64 1, -9223372036854775807) 1) #38, !noalias !34868 ; 5 uses
  %i.beb = icmp eq ptr %i.bea, null
  br i1 %i.beb, label %.invoke1168.i.i, label %bb.iv

bb.iv:                                            ; preds = %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i478.i.i369
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.bea, ptr nonnull readonly align 1 %.val365.i.i347, i64 %.val366.i.i348, i1 false), !alias.scope !34873, !noalias !34877
  store ptr %i.bea, ptr %8, align 8, !alias.scope !34866, !noalias !34867
  store i64 %.sroa.0101.1.i.i368, ptr %i.bdu, align 8, !alias.scope !34866, !noalias !34867
  br i1 %i.bdw, label %bb.iw, label %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i.i483.i.i370"
...
bb.iw:                                            ; preds = %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i.i483.i.i370", %bb.iv, %bb.ir
  %.val.i.i349 = phi ptr [ %.val365.i.i347, %bb.ir ], [ %i.bea, %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i.i483.i.i370" ], [ %i.bea, %bb.iv ]
  ...
  %i.bec = getelementptr inbounds nuw i8, ptr %8, i64 16 ; 2 uses
  %.val309.i.i351 = load ptr, ptr %i.bec, align 8, !alias.scope !34866, !noalias !34867, !nonnull !27, !align !603, !noundef !27 ; 3 uses
  %i.bed = getelementptr inbounds nuw i8, ptr %8, i64 24 ; 2 uses
  %.val310.i.i352 = load i64, ptr %i.bed, align 8, !alias.scope !34866, !noalias !34867, !noundef !27 ; 5 uses
  %i.bee = icmp ult i64 %.val310.i.i352, %.sroa.0.0.i.i204
  br i1 %i.bee, label %bb.ix, label %"_ZN111_$LT$alloc_stdlib..std_alloc..StandardAlloc$u20$as$u20$alloc_no_stdlib..stack_allocator..Allocator$LT$T$GT$$GT$9free_cell17hd73f7e4c840310d1E.exit493.i.i353"
...
"_ZN111_$LT$alloc_stdlib..std_alloc..StandardAlloc$u20$as$u20$alloc_no_stdlib..stack_allocator..Allocator$LT$T$GT$$GT$9free_cell17hd73f7e4c840310d1E.exit493.i.i353": ; preds = %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i.i492.i.i367", %bb.jc, %bb.iw
  %.val339.i.i354 = phi ptr [ %i.ber, %bb.jc ], [ %i.ber, %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i.i492.i.i367" ], [ %.val309.i.i351, %bb.iw ]
...
bb.ix:                                            ; preds = %bb.iw
  %i.bef = icmp eq i64 %.val310.i.i352, 0         ; 2 uses
  %spec.select247.i.i362 = select i1 %i.bef, i64 %.sroa.0.0.i.i204, i64 %.val310.i.i352
  br label %bb.iy

bb.iy:                                            ; preds = %bb.iy, %bb.ix
  %.sroa.0104.1.i.i363 = phi i64 [ %spec.select247.i.i362, %bb.ix ], [ %i.beh, %bb.iy ] ; 8 uses
  %i.beg = icmp ult i64 %.sroa.0104.1.i.i363, %.sroa.0.0.i.i204
  %i.beh = shl i64 %.sroa.0104.1.i.i363, 1
  br i1 %i.beg, label %bb.iy, label %bb.iz

bb.iz:                                            ; preds = %bb.iy
  %i.bei = shl i64 %.sroa.0104.1.i.i363, 2        ; 5 uses
  %i.bej = icmp ugt i64 %.sroa.0104.1.i.i363, 4611686018427387903
  %i.bek = icmp ugt i64 %i.bei, 9223372036854775804
  %or.cond.i.i.i.i484.i.i364 = or i1 %i.bej, %i.bek
...
_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i485.i.i365: ; preds = %bb.iz
  %i.bel = icmp eq i64 %i.bei, 0
  br i1 %i.bel, label %bb.jc, label %bb.ja
...
bb.ja:                                            ; preds = %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i485.i.i365
  ...
  %i.bem = tail call noundef ptr @mi_zalloc_aligned(i64 noundef range(i64 1, 0) %i.bei, i64 noundef range(i64 1, -9223372036854775807) 4) #38, !noalias !34879 ; 2 uses
  %i.ben = icmp eq ptr %i.bem, null
  br i1 %i.ben, label %.invoke1168.i.i, label %bb.jb
...
.invoke1168.i.i:                                  ; preds = %bb.ja, %bb.iz, %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i478.i.i369, %bb.iu
  %i.bep = phi i64 [ 0, %bb.iu ], [ 1, %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i478.i.i369 ], [ 4, %bb.ja ], [ 0, %bb.iz ]
  %i.beq = phi i64 [ %.sroa.0101.1.i.i368, %bb.iu ], [ %.sroa.0101.1.i.i368, %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i478.i.i369 ], [ %i.bei, %bb.ja ], [ %i.bei, %bb.iz ]
  invoke void @_ZN5alloc7raw_vec12handle_error17h5794e6eba25188a7E(i64 noundef %i.bep, i64 %i.beq, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @220) #43
...
bb.jc:                                            ; preds = %bb.jb, %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i485.i.i365
  %.sroa.10.0.i.i486.i.i366 = phi i64 [ %i.beo, %bb.jb ], [ 4, %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i485.i.i365 ]
  %i.ber = inttoptr i64 %.sroa.10.0.i.i486.i.i366 to ptr ; 5 uses
  %i.bes = icmp samesign ult i64 %.sroa.0104.1.i.i363, 2305843009213693952
  tail call void @llvm.assume(i1 %i.bes)
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %i.ber) ]
  %i.bet = shl nuw nsw i64 %.val310.i.i352, 2
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %i.ber, ptr nonnull readonly align 4 %.val309.i.i351, i64 %i.bet, i1 false), !alias.scope !34884, !noalias !34888
  store ptr %i.ber, ptr %i.bec, align 8, !alias.scope !34866, !noalias !34867
  store i64 %.sroa.0104.1.i.i363, ptr %i.bed, align 8, !alias.scope !34866, !noalias !34867
  br i1 %i.bef, label %"_ZN111_$LT$alloc_stdlib..std_alloc..StandardAlloc$u20$as$u20$alloc_no_stdlib..stack_allocator..Allocator$LT$T$GT$$GT$9free_cell17hd73f7e4c840310d1E.exit493.i.i353", label %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i.i492.i.i367"
...
bb.je:                                            ; preds = %bb.ji, %"_ZN111_$LT$alloc_stdlib..std_alloc..StandardAlloc$u20$as$u20$alloc_no_stdlib..stack_allocator..Allocator$LT$T$GT$$GT$9free_cell17hd73f7e4c840310d1E.exit493.i.i353"
  %i.beu = phi i64 [ 1, %"_ZN111_$LT$alloc_stdlib..std_alloc..StandardAlloc$u20$as$u20$alloc_no_stdlib..stack_allocator..Allocator$LT$T$GT$$GT$9free_cell17hd73f7e4c840310d1E.exit493.i.i353" ], [ %i.bfe, %bb.ji ] ; 6 uses
  ...
  %.sroa.0143.0621.i.i = phi i64 [ 0, %"_ZN111_$LT$alloc_stdlib..std_alloc..StandardAlloc$u20$as$u20$alloc_no_stdlib..stack_allocator..Allocator$LT$T$GT$$GT$9free_cell17hd73f7e4c840310d1E.exit493.i.i353" ], [ %i.beu, %bb.ji ] ; 3 uses
  %i.bev = getelementptr inbounds nuw [4 x i8], ptr %.sroa.10.0.i.i411.i.i207, i64 %.sroa.0143.0621.i.i
  %i.bew = load i32, ptr %i.bev, align 4, !noalias !34805, !noundef !27
  %i.bex = add i32 %i.bew, %.sroa.0107.0624.i.i   ; 2 uses
  %i.bey = icmp eq i64 %i.beu, %.sroa.0.0.i.i204  ; 2 uses
  br i1 %i.bey, label %._crit_edge870.i.i, label %bb.jg

._crit_edge870.i.i:                               ; preds = %bb.je
  %.phi.trans.insert.i.i361 = getelementptr inbounds nuw [4 x i8], ptr %i.azy, i64 %.sroa.0143.0621.i.i
...
bb.jg:                                            ; preds = %bb.je
  %i.bez = icmp ult i64 %i.beu, %.sroa.0.0.i.i204
  br i1 %i.bez, label %bb.jh, label %.invoke1170.i.i

bb.jh:                                            ; preds = %bb.jg
  %i.bfa = getelementptr inbounds nuw [4 x i8], ptr %i.azy, i64 %.sroa.0143.0621.i.i
  %i.bfb = load i32, ptr %i.bfa, align 4, !noalias !34805, !noundef !27 ; 2 uses
  %i.bfc = getelementptr inbounds nuw [4 x i8], ptr %i.azy, i64 %i.beu
  %i.bfd = load i32, ptr %i.bfc, align 4, !noalias !34805, !noundef !27
  %.not223.i.i356 = icmp eq i32 %i.bfb, %i.bfd
...
bb.ji:                                            ; preds = %bb.jm, %bb.jh
  ...
  %.sroa.0109.1.i.i359 = phi i64 [ %i.bfs, %bb.jm ], [ %.sroa.0109.0623.i.i, %bb.jh ] ; 2 uses
  %.sroa.0107.1.i.i360 = phi i32 [ 0, %bb.jm ], [ %i.bex, %bb.jh ]
  %i.bfe = add i64 %i.beu, 1
  br i1 %i.bey, label %_ZN6brotli3enc14block_splitter15SplitByteVector17he88e5a9ef69dcbe2E.exit, label %bb.je

bb.jj:                                            ; preds = %bb.jh, %._crit_edge870.i.i
  %i.bff = phi i32 [ %.pre871.i.i, %._crit_edge870.i.i ], [ %i.bfb, %bb.jh ]
  %i.bfg = zext i32 %i.bff to i64                 ; 3 uses
  %i.bfh = icmp samesign ugt i64 %i.bnf, %i.bfg
  br i1 %i.bfh, label %bb.jk, label %.invoke1170.i.i

bb.jk:                                            ; preds = %bb.jj
  %i.bfi = getelementptr inbounds nuw [4 x i8], ptr %i.bdp, i64 %i.bfg
  %i.bfj = load i32, ptr %i.bfi, align 4, !noalias !34805, !noundef !27
  %i.bfk = trunc i32 %i.bfj to i8                 ; 2 uses
  %i.bfl = icmp ult i64 %.sroa.0109.0623.i.i, %.val270.i.i350
  br i1 %i.bfl, label %bb.jl, label %.invoke1170.i.i

bb.jl:                                            ; preds = %bb.jk
  %i.bfm = getelementptr inbounds nuw i8, ptr %.val.i.i349, i64 %.sroa.0109.0623.i.i
  store i8 %i.bfk, ptr %i.bfm, align 1, !noalias !34805
  %i.bfn = icmp ult i64 %.sroa.0109.0623.i.i, %.val340.i.i355
  br i1 %i.bfn, label %bb.jm, label %.invoke1170.i.i

.invoke1170.i.i:                                  ; preds = %bb.jl, %bb.jk, %bb.jj, %bb.jg
  %i.bfo = phi i64 [ %.sroa.0109.0623.i.i, %bb.jk ], [ %i.bfg, %bb.jj ], [ %i.beu, %bb.jg ], [ %.sroa.0109.0623.i.i, %bb.jl ]
  %i.bfp = phi i64 [ %.val270.i.i350, %bb.jk ], [ %i.bnf, %bb.jj ], [ %.sroa.0.0.i.i204, %bb.jg ], [ %.val340.i.i355, %bb.jl ]
  %i.bfq = phi ptr [ @1550, %bb.jk ], [ @1549, %bb.jj ], [ @1548, %bb.jg ], [ @1551, %bb.jl ]
  invoke void @_ZN4core9panicking18panic_bounds_check17hbc09f5d79f1a5789E(i64 noundef %i.bfo, i64 noundef %i.bfp, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.bfq) #43
...
bb.jm:                                            ; preds = %bb.jl
  %i.bfr = getelementptr inbounds nuw [4 x i8], ptr %.val339.i.i354, i64 %.sroa.0109.0623.i.i
  store i32 %i.bex, ptr %i.bfr, align 4, !noalias !34805
  %.sroa.0.0.i511.i.i357 = tail call noundef i8 @llvm.umax.i8(i8 %i.bfk, i8 %.sroa.0113.0622.i.i)
  %i.bfs = add nuw i64 %.sroa.0109.0623.i.i, 1
  br label %bb.ji
...
bb.jn:                                            ; preds = %bb.jr, %.preheader.split.i.i319
  ...
  store float 3.402000e+38, ptr %i.bdr, align 8, !alias.scope !34890, !noalias !34805
  %i.bft = getelementptr inbounds nuw [4 x i8], ptr %.sroa.10.0.i.i411.i.i207, i64 %.sroa.0137.0617.i.i
  %i.bfu = load i32, ptr %i.bft, align 4, !noalias !34805, !noundef !27 ; 2 uses
  %.not628.i.i = icmp eq i32 %i.bfu, 0
...
.lr.ph605.preheader.i.i:                          ; preds = %bb.jn
  ...
  %i.bfw = add nuw nsw i64 %reass.sub448.i, 1
  br label %.lr.ph605.i.i

.lr.ph605.i.i:                                    ; preds = %bb.jw, %.lr.ph605.preheader.i.i
  %i.bfx = phi i64 [ %i.bll, %bb.jw ], [ 1, %.lr.ph605.preheader.i.i ] ; 3 uses
  %.sroa.043.2603.i.i = phi i64 [ %i.blk, %bb.jw ], [ %.sroa.043.1619.i.i, %.lr.ph605.preheader.i.i ] ; 3 uses
  %exitcond859.not.i.i = icmp eq i64 %i.bfx, %i.bfw
  br i1 %exitcond859.not.i.i, label %.invoke1172.i.i, label %bb.jv

._crit_edge606.i.i:                               ; preds = %bb.jw
  %i.bfy = icmp eq i64 %.sroa.0137.0617.i.i, 0
  %i.bfz = getelementptr [4 x i8], ptr %i.azy, i64 %.sroa.0137.0617.i.i ; 4 uses
  %i.bga = getelementptr i8, ptr %i.bfz, i64 -4
  %.sroa.097.0.in.i.i328 = select i1 %i.bfy, ptr %i.azy, ptr %i.bga
  %.sroa.097.0.i.i329 = load i32, ptr %.sroa.097.0.in.i.i328, align 4, !noalias !34805, !noundef !27 ; 4 uses
  %i.bgb = zext i32 %.sroa.097.0.i.i329 to i64    ; 5 uses
  %i.bgc = icmp ugt i64 %.sroa.14.7.i.i284, %i.bgb
  br i1 %i.bgc, label %.noexc244.i.i330, label %.invoke1172.i.i

._crit_edge606.thread.i.i:                        ; preds = %bb.jn
  %i.bgd = icmp eq i64 %.sroa.0137.0617.i.i, 0
  %i.bge = getelementptr [4 x i8], ptr %i.azy, i64 %.sroa.0137.0617.i.i ; 2 uses
  %i.bgf = getelementptr i8, ptr %i.bge, i64 -4
  %.sroa.097.0.in936.i.i = select i1 %i.bgd, ptr %i.azy, ptr %i.bgf
  %.sroa.097.0937.i.i = load i32, ptr %.sroa.097.0.in936.i.i, align 4, !noalias !34805, !noundef !27 ; 2 uses
  %i.bgg = zext i32 %.sroa.097.0937.i.i to i64    ; 3 uses
  %i.bgh = icmp ugt i64 %.sroa.14.7.i.i284, %i.bgg
  br i1 %i.bgh, label %_ZN6brotli3enc7cluster30BrotliHistogramBitCostDistance17h549dfdad1e1f7ec5E.exit249.i.i, label %.invoke1172.i.i
...
.lr.ph597.i.i788.preheader:                       ; preds = %bb.qh
  ...
  %min.iters.check3930 = icmp ult i64 %i.ctx, 28
  br i1 %min.iters.check3930, label %.lr.ph597.i.i788.preheader4010, label %vector.ph3931

vector.ph3931:                                    ; preds = %.lr.ph597.i.i788.preheader
  %n.vec3932 = and i64 %i.ctz, 9223372036854775800 ; 4 uses
  %i.cua = trunc i64 %n.vec3932 to i32
  %i.cub = shl i64 %n.vec3932, 2
  %i.cuc = getelementptr i8, ptr %i.ctt, i64 %i.cub
  br label %vector.body3933

vector.body3933:                                  ; preds = %vector.body3933, %vector.ph3931
  %index3934 = phi i64 [ 0, %vector.ph3931 ], [ %index.next3938, %vector.body3933 ] ; 2 uses
  %vec.ind3935 = phi <4 x i32> [ <i32 0, i32 1, i32 2, i32 3>, %vector.ph3931 ], [ %vec.ind.next3939, %vector.body3933 ] ; 3 uses
  %step.add3936 = add <4 x i32> %vec.ind3935, splat (i32 4)
  %i.cud = shl i64 %index3934, 2
  %next.gep3937 = getelementptr i8, ptr %i.ctt, i64 %i.cud ; 2 uses
  %i.cue = getelementptr i8, ptr %next.gep3937, i64 16
  store <4 x i32> %vec.ind3935, ptr %next.gep3937, align 4, !noalias !35247
  store <4 x i32> %step.add3936, ptr %i.cue, align 4, !noalias !35247
  %index.next3938 = add nuw i64 %index3934, 8     ; 2 uses
  %vec.ind.next3939 = add <4 x i32> %vec.ind3935, splat (i32 8)
  %i.cuf = icmp eq i64 %index.next3938, %n.vec3932
  br i1 %i.cuf, label %middle.block3940, label %vector.body3933, !llvm.loop !35301

middle.block3940:                                 ; preds = %vector.body3933
  %cmp.n3941 = icmp eq i64 %i.ctz, %n.vec3932
  br i1 %cmp.n3941, label %._crit_edge598.i.i792, label %.lr.ph597.i.i788.preheader4010

.lr.ph597.i.i788.preheader4010:                   ; preds = %.lr.ph597.i.i788.preheader, %middle.block3940
  %.sroa.047.2595.i.i789.ph = phi i32 [ 0, %.lr.ph597.i.i788.preheader ], [ %i.cua, %middle.block3940 ]
  %.sroa.0135.0594.i.i790.ph = phi ptr [ %i.ctt, %.lr.ph597.i.i788.preheader ], [ %i.cuc, %middle.block3940 ]
  br label %.lr.ph597.i.i788

.lr.ph597.i.i788:                                 ; preds = %.lr.ph597.i.i788.preheader4010, %.lr.ph597.i.i788
  %.sroa.047.2595.i.i789 = phi i32 [ %i.cug, %.lr.ph597.i.i788 ], [ %.sroa.047.2595.i.i789.ph, %.lr.ph597.i.i788.preheader4010 ] ; 2 uses
  %.sroa.0135.0594.i.i790 = phi ptr [ %.sroa.0135.1.i.i791, %.lr.ph597.i.i788 ], [ %.sroa.0135.0594.i.i790.ph, %.lr.ph597.i.i788.preheader4010 ] ; 2 uses
...
._crit_edge598.i.i792:                            ; preds = %.lr.ph597.i.i788, %middle.block3940, %bb.qh
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.016.7.i.i756) ]
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.026.5.i.i760) ]
  %i.cui = invoke fastcc noundef i64 @_ZN6brotli3enc7cluster22BrotliHistogramCombine17h74b2081842603b54E(ptr noalias noundef nonnull align 8 %.sroa.016.7.i.i756, i64 noundef %.sroa.14.7.i.i755, ptr noalias noundef nonnull align 4 %.sroa.026.5.i.i760, i64 noundef %.sroa.12.5.i.i759, ptr noalias noundef nonnull align 4 %i.cqx, i64 noundef %.sroa.0.0.i.i634, ptr noalias noundef nonnull align 4 %i.ctt, i64 noundef %i.dee, ptr noalias noundef nonnull align 4 %.sroa.044.2.i.i784, i64 noundef %.sroa.11.2.i.i783, i64 noundef %i.dee, i64 noundef %.sroa.0.0.i.i634, i64 noundef 256, i64 noundef %.sroa.0.0.i448.i.i782)
...
bb.qn:                                            ; preds = %bb.qk, %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i469.i.i810
  %.sroa.10.0.i.i470.i.i811 = phi i64 [ %i.cum, %bb.qk ], [ 4, %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i469.i.i810 ]
  %i.cuo = inttoptr i64 %.sroa.10.0.i.i470.i.i811 to ptr ; 6 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %i.cuo) ]
  br i1 %i.ctw, label %.preheader.split.i.i813, label %.lr.ph601.preheader.i.i812

.lr.ph601.preheader.i.i812:                       ; preds = %bb.qn
  tail call void @llvm.memset.p0.i64(ptr nonnull align 4 %i.cuo, i8 -1, i64 %i.ctj, i1 false), !noalias !35247
  br label %.preheader.split.i.i813

.preheader.split.i.i813:                          ; preds = %.lr.ph601.preheader.i.i812, %bb.qn
  %i.cup = getelementptr inbounds nuw i8, ptr %i.i, i64 2184
  %i.cuq = getelementptr inbounds nuw i8, ptr %i.i, i64 2176 ; 2 uses
  %i.cur = getelementptr inbounds nuw i8, ptr %i.g, i64 2176 ; 3 uses
  %.not1175.i.i814 = icmp eq i64 %i.cui, 0        ; 2 uses
  %i.cus = getelementptr inbounds nuw i8, ptr %i.h, i64 2176 ; 3 uses
  br label %bb.rk

bb.qo:                                            ; preds = %bb.ro
  tail call void @mi_free(ptr noundef nonnull align 4 %i.ctt) #38, !noalias !35247
  ...
  %i.cut = getelementptr inbounds nuw i8, ptr %9, i64 8 ; 2 uses
  %.val366.i.i878 = load i64, ptr %i.cut, align 8, !alias.scope !35308, !noalias !35309, !noundef !27 ; 5 uses
  %i.cuu = icmp ult i64 %.val366.i.i878, %.sroa.0.0.i.i634
  br i1 %i.cuu, label %bb.qp, label %bb.qt

bb.qp:                                            ; preds = %bb.qo
  %i.cuv = icmp eq i64 %.val366.i.i878, 0         ; 2 uses
  %spec.select.i170.i908 = select i1 %i.cuv, i64 %.sroa.0.0.i.i634, i64 %.val366.i.i878
  br label %bb.qq

bb.qq:                                            ; preds = %bb.qq, %bb.qp
  %.sroa.0101.1.i.i909 = phi i64 [ %spec.select.i170.i908, %bb.qp ], [ %i.cux, %bb.qq ] ; 9 uses
  %i.cuw = icmp ult i64 %.sroa.0101.1.i.i909, %.sroa.0.0.i.i634
  %i.cux = shl i64 %.sroa.0101.1.i.i909, 1
  br i1 %i.cuw, label %bb.qq, label %bb.qr

bb.qr:                                            ; preds = %bb.qq
  %i.cuy = icmp slt i64 %.sroa.0101.1.i.i909, 0
  br i1 %i.cuy, label %.invoke1168.i.i906, label %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i478.i.i910, !prof !3798
...
_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i478.i.i910: ; preds = %bb.qr
  ...
  %i.cuz = tail call noundef ptr @mi_zalloc_aligned(i64 noundef range(i64 1, 0) %.sroa.0101.1.i.i909, i64 noundef range(i64 1, -9223372036854775807) 1) #38, !noalias !35310 ; 5 uses
  %i.cva = icmp eq ptr %i.cuz, null
  br i1 %i.cva, label %.invoke1168.i.i906, label %bb.qs

bb.qs:                                            ; preds = %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i478.i.i910
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.cuz, ptr nonnull readonly align 1 %.val365.i.i877, i64 %.val366.i.i878, i1 false), !alias.scope !35315, !noalias !35319
  store ptr %i.cuz, ptr %9, align 8, !alias.scope !35308, !noalias !35309
  store i64 %.sroa.0101.1.i.i909, ptr %i.cut, align 8, !alias.scope !35308, !noalias !35309
  br i1 %i.cuv, label %bb.qt, label %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i.i483.i.i911"
...
bb.qt:                                            ; preds = %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i.i483.i.i911", %bb.qs, %bb.qo
  %.val.i.i879 = phi ptr [ %.val365.i.i877, %bb.qo ], [ %i.cuz, %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i.i483.i.i911" ], [ %i.cuz, %bb.qs ]
  ...
  %i.cvb = getelementptr inbounds nuw i8, ptr %9, i64 16 ; 2 uses
  %.val309.i.i881 = load ptr, ptr %i.cvb, align 8, !alias.scope !35308, !noalias !35309, !nonnull !27, !align !603, !noundef !27 ; 3 uses
  %i.cvc = getelementptr inbounds nuw i8, ptr %9, i64 24 ; 2 uses
  %.val310.i.i882 = load i64, ptr %i.cvc, align 8, !alias.scope !35308, !noalias !35309, !noundef !27 ; 5 uses
  %i.cvd = icmp ult i64 %.val310.i.i882, %.sroa.0.0.i.i634
  br i1 %i.cvd, label %bb.qu, label %"_ZN111_$LT$alloc_stdlib..std_alloc..StandardAlloc$u20$as$u20$alloc_no_stdlib..stack_allocator..Allocator$LT$T$GT$$GT$9free_cell17hd73f7e4c840310d1E.exit493.i.i883"
...
"_ZN111_$LT$alloc_stdlib..std_alloc..StandardAlloc$u20$as$u20$alloc_no_stdlib..stack_allocator..Allocator$LT$T$GT$$GT$9free_cell17hd73f7e4c840310d1E.exit493.i.i883": ; preds = %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i.i492.i.i905", %bb.qz, %bb.qt
  %.val339.i.i884 = phi ptr [ %i.cvq, %bb.qz ], [ %i.cvq, %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i.i492.i.i905" ], [ %.val309.i.i881, %bb.qt ]
...
bb.qu:                                            ; preds = %bb.qt
  %i.cve = icmp eq i64 %.val310.i.i882, 0         ; 2 uses
  %spec.select247.i.i900 = select i1 %i.cve, i64 %.sroa.0.0.i.i634, i64 %.val310.i.i882
  br label %bb.qv

bb.qv:                                            ; preds = %bb.qv, %bb.qu
  %.sroa.0104.1.i.i901 = phi i64 [ %spec.select247.i.i900, %bb.qu ], [ %i.cvg, %bb.qv ] ; 8 uses
  %i.cvf = icmp ult i64 %.sroa.0104.1.i.i901, %.sroa.0.0.i.i634
  %i.cvg = shl i64 %.sroa.0104.1.i.i901, 1
  br i1 %i.cvf, label %bb.qv, label %bb.qw

bb.qw:                                            ; preds = %bb.qv
  %i.cvh = shl i64 %.sroa.0104.1.i.i901, 2        ; 5 uses
  %i.cvi = icmp ugt i64 %.sroa.0104.1.i.i901, 4611686018427387903
  %i.cvj = icmp ugt i64 %i.cvh, 9223372036854775804
  %or.cond.i.i.i.i484.i.i902 = or i1 %i.cvi, %i.cvj
...
_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i485.i.i903: ; preds = %bb.qw
  %i.cvk = icmp eq i64 %i.cvh, 0
  br i1 %i.cvk, label %bb.qz, label %bb.qx
...
bb.qx:                                            ; preds = %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i485.i.i903
  ...
  %i.cvl = tail call noundef ptr @mi_zalloc_aligned(i64 noundef range(i64 1, 0) %i.cvh, i64 noundef range(i64 1, -9223372036854775807) 4) #38, !noalias !35321 ; 2 uses
  %i.cvm = icmp eq ptr %i.cvl, null
  br i1 %i.cvm, label %.invoke1168.i.i906, label %bb.qy

bb.qy:                                            ; preds = %bb.qx
  %i.cvn = ptrtoint ptr %i.cvl to i64
  br label %bb.qz

.invoke1168.i.i906:                               ; preds = %bb.qx, %bb.qw, %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i478.i.i910, %bb.qr
  %i.cvo = phi i64 [ 0, %bb.qr ], [ 1, %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i478.i.i910 ], [ 4, %bb.qx ], [ 0, %bb.qw ]
  %i.cvp = phi i64 [ %.sroa.0101.1.i.i909, %bb.qr ], [ %.sroa.0101.1.i.i909, %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i478.i.i910 ], [ %i.cvh, %bb.qx ], [ %i.cvh, %bb.qw ]
  invoke void @_ZN5alloc7raw_vec12handle_error17h5794e6eba25188a7E(i64 noundef %i.cvo, i64 %i.cvp, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @220) #43
...
bb.qz:                                            ; preds = %bb.qy, %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i485.i.i903
  %.sroa.10.0.i.i486.i.i904 = phi i64 [ %i.cvn, %bb.qy ], [ 4, %_ZN4core5alloc6layout6Layout6repeat17h29edbb865869b355E.exit.i.i.i485.i.i903 ]
  %i.cvq = inttoptr i64 %.sroa.10.0.i.i486.i.i904 to ptr ; 5 uses
  %i.cvr = icmp samesign ult i64 %.sroa.0104.1.i.i901, 2305843009213693952
  tail call void @llvm.assume(i1 %i.cvr)
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %i.cvq) ]
  %i.cvs = shl nuw nsw i64 %.val310.i.i882, 2
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %i.cvq, ptr nonnull readonly align 4 %.val309.i.i881, i64 %i.cvs, i1 false), !alias.scope !35326, !noalias !35330
  store ptr %i.cvq, ptr %i.cvb, align 8, !alias.scope !35308, !noalias !35309
  store i64 %.sroa.0104.1.i.i901, ptr %i.cvc, align 8, !alias.scope !35308, !noalias !35309
  br i1 %i.cve, label %"_ZN111_$LT$alloc_stdlib..std_alloc..StandardAlloc$u20$as$u20$alloc_no_stdlib..stack_allocator..Allocator$LT$T$GT$$GT$9free_cell17hd73f7e4c840310d1E.exit493.i.i883", label %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i.i492.i.i905"
...
"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i502.i.i682": ; preds = %"_ZN4core3ptr103drop_in_place$LT$alloc_stdlib..heap_alloc..WrapBox$LT$brotli..enc..histogram..HistogramDistance$GT$$GT$17h88549cc0cac5fba0E.exit551.i.i", %"_ZN4core3ptr65drop_in_place$LT$alloc_stdlib..heap_alloc..WrapBox$LT$u32$GT$$GT$17h9b85be35385d1483E.exit549.i.i941", %bb.sp, %bb.ra, %.thread163.loopexit.split-lp.loopexit.split-lp.i.i673, %.thread163.loopexit.split-lp.loopexit.i.i753, %.thread163.loopexit.i.i748
  %.pn230.pn202.i.i683 = phi { ptr, i32 } [ %.pn230155.i.i799, %bb.ra ], [ %i.dfp, %"_ZN4core3ptr65drop_in_place$LT$alloc_stdlib..heap_alloc..WrapBox$LT$u32$GT$$GT$17h9b85be35385d1483E.exit549.i.i941" ], [ %i.dey, %bb.sp ], [ %i.dfq, %"_ZN4core3ptr103drop_in_place$LT$alloc_stdlib..heap_alloc..WrapBox$LT$brotli..enc..histogram..HistogramDistance$GT$$GT$17h88549cc0cac5fba0E.exit551.i.i" ], [ %lpad.loopexit255.i.i749, %.thread163.loopexit.i.i748 ], [ %lpad.loopexit258.i.i754, %.thread163.loopexit.split-lp.loopexit.i.i753 ], [ %lpad.loopexit.split-lp259.i.i681, %.thread163.loopexit.split-lp.loopexit.split-lp.i.i673 ]
  %.sroa.044.0122201.i.i684 = phi ptr [ %.sroa.044.0148.i.i804, %bb.ra ], [ %i.cst, %"_ZN4core3ptr65drop_in_place$LT$alloc_stdlib..heap_alloc..WrapBox$LT$u32$GT$$GT$17h9b85be35385d1483E.exit549.i.i941" ], [ %i.cst, %bb.sp ], [ %i.cst, %"_ZN4core3ptr103drop_in_place$LT$alloc_stdlib..heap_alloc..WrapBox$LT$brotli..enc..histogram..HistogramDistance$GT$$GT$17h88549cc0cac5fba0E.exit551.i.i" ], [ %i.cst, %.thread163.loopexit.i.i748 ], [ %i.cst, %.thread163.loopexit.split-lp.loopexit.i.i753 ], [ %.sroa.044.1.ph.ph.ph.i.i674, %.thread163.loopexit.split-lp.loopexit.split-lp.i.i673 ] ; 2 uses
...
bb.rb:                                            ; preds = %bb.rf, %"_ZN111_$LT$alloc_stdlib..std_alloc..StandardAlloc$u20$as$u20$alloc_no_stdlib..stack_allocator..Allocator$LT$T$GT$$GT$9free_cell17hd73f7e4c840310d1E.exit493.i.i883"
  %i.cvt = phi i64 [ 1, %"_ZN111_$LT$alloc_stdlib..std_alloc..StandardAlloc$u20$as$u20$alloc_no_stdlib..stack_allocator..Allocator$LT$T$GT$$GT$9free_cell17hd73f7e4c840310d1E.exit493.i.i883" ], [ %i.cwd, %bb.rf ] ; 6 uses
  ...
  %.sroa.0143.0621.i.i889 = phi i64 [ 0, %"_ZN111_$LT$alloc_stdlib..std_alloc..StandardAlloc$u20$as$u20$alloc_no_stdlib..stack_allocator..Allocator$LT$T$GT$$GT$9free_cell17hd73f7e4c840310d1E.exit493.i.i883" ], [ %i.cvt, %bb.rf ] ; 3 uses
  %i.cvu = getelementptr inbounds nuw [4 x i8], ptr %.sroa.10.0.i.i411.i.i649, i64 %.sroa.0143.0621.i.i889
  %i.cvv = load i32, ptr %i.cvu, align 4, !noalias !35247, !noundef !27
  %i.cvw = add i32 %i.cvv, %.sroa.0107.0624.i.i886 ; 2 uses
  %i.cvx = icmp eq i64 %i.cvt, %.sroa.0.0.i.i634  ; 2 uses
  br i1 %i.cvx, label %._crit_edge870.i.i897, label %bb.rd

._crit_edge870.i.i897:                            ; preds = %bb.rb
  %.phi.trans.insert.i.i898 = getelementptr inbounds nuw [4 x i8], ptr %i.cqx, i64 %.sroa.0143.0621.i.i889
...
bb.rd:                                            ; preds = %bb.rb
  %i.cvy = icmp ult i64 %i.cvt, %.sroa.0.0.i.i634
  br i1 %i.cvy, label %bb.re, label %.invoke1170.i.i890

bb.re:                                            ; preds = %bb.rd
  %i.cvz = getelementptr inbounds nuw [4 x i8], ptr %i.cqx, i64 %.sroa.0143.0621.i.i889
  %i.cwa = load i32, ptr %i.cvz, align 4, !noalias !35247, !noundef !27 ; 2 uses
  %i.cwb = getelementptr inbounds nuw [4 x i8], ptr %i.cqx, i64 %i.cvt
  %i.cwc = load i32, ptr %i.cwb, align 4, !noalias !35247, !noundef !27
  %.not223.i.i892 = icmp eq i32 %i.cwa, %i.cwc
...
bb.rf:                                            ; preds = %bb.rj, %bb.re
  ...
  %.sroa.0109.1.i.i895 = phi i64 [ %i.cwr, %bb.rj ], [ %.sroa.0109.0623.i.i887, %bb.re ] ; 2 uses
  %.sroa.0107.1.i.i896 = phi i32 [ 0, %bb.rj ], [ %i.cvw, %bb.re ]
  %i.cwd = add i64 %i.cvt, 1
  br i1 %i.cvx, label %bb.tf, label %bb.rb

bb.rg:                                            ; preds = %bb.re, %._crit_edge870.i.i897
  %i.cwe = phi i32 [ %.pre871.i.i899, %._crit_edge870.i.i897 ], [ %i.cwa, %bb.re ]
  %i.cwf = zext i32 %i.cwe to i64                 ; 3 uses
  %i.cwg = icmp samesign ugt i64 %i.dee, %i.cwf
  br i1 %i.cwg, label %bb.rh, label %.invoke1170.i.i890

bb.rh:                                            ; preds = %bb.rg
  %i.cwh = getelementptr inbounds nuw [4 x i8], ptr %i.cuo, i64 %i.cwf
  %i.cwi = load i32, ptr %i.cwh, align 4, !noalias !35247, !noundef !27
  %i.cwj = trunc i32 %i.cwi to i8                 ; 2 uses
  %i.cwk = icmp ult i64 %.sroa.0109.0623.i.i887, %.val270.i.i880
  br i1 %i.cwk, label %bb.ri, label %.invoke1170.i.i890

bb.ri:                                            ; preds = %bb.rh
  %i.cwl = getelementptr inbounds nuw i8, ptr %.val.i.i879, i64 %.sroa.0109.0623.i.i887
  store i8 %i.cwj, ptr %i.cwl, align 1, !noalias !35247
  %i.cwm = icmp ult i64 %.sroa.0109.0623.i.i887, %.val340.i.i885
  br i1 %i.cwm, label %bb.rj, label %.invoke1170.i.i890

.invoke1170.i.i890:                               ; preds = %bb.ri, %bb.rh, %bb.rg, %bb.rd
  %i.cwn = phi i64 [ %.sroa.0109.0623.i.i887, %bb.rh ], [ %i.cwf, %bb.rg ], [ %i.cvt, %bb.rd ], [ %.sroa.0109.0623.i.i887, %bb.ri ]
  %i.cwo = phi i64 [ %.val270.i.i880, %bb.rh ], [ %i.dee, %bb.rg ], [ %.sroa.0.0.i.i634, %bb.rd ], [ %.val340.i.i885, %bb.ri ]
  %i.cwp = phi ptr [ @1550, %bb.rh ], [ @1549, %bb.rg ], [ @1548, %bb.rd ], [ @1551, %bb.ri ]
  invoke void @_ZN4core9panicking18panic_bounds_check17hbc09f5d79f1a5789E(i64 noundef %i.cwn, i64 noundef %i.cwo, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.cwp) #43
...
bb.rj:                                            ; preds = %bb.ri
  %i.cwq = getelementptr inbounds nuw [4 x i8], ptr %.val339.i.i884, i64 %.sroa.0109.0623.i.i887
  store i32 %i.cvw, ptr %i.cwq, align 4, !noalias !35247
  %.sroa.0.0.i511.i.i893 = tail call noundef i8 @llvm.umax.i8(i8 %i.cwj, i8 %.sroa.0113.0622.i.i888)
  %i.cwr = add nuw i64 %.sroa.0109.0623.i.i887, 1
  br label %bb.rf
...
bb.rk:                                            ; preds = %bb.ro, %.preheader.split.i.i813
  ...
  store float 3.402000e+38, ptr %i.cup, align 8, !alias.scope !35332, !noalias !35247
  %i.cws = getelementptr inbounds nuw [4 x i8], ptr %.sroa.10.0.i.i411.i.i649, i64 %.sroa.0137.0617.i.i818
  %i.cwt = load i32, ptr %i.cws, align 4, !noalias !35247, !noundef !27 ; 2 uses
  %.not628.i.i819 = icmp eq i32 %i.cwt, 0
...
.lr.ph605.preheader.i.i820:                       ; preds = %bb.rk
  %i.cwu = zext i32 %i.cwt to i64
  %reass.sub448.i821 = tail call i64 @llvm.usub.sat.i64(i64 %2, i64 %.sroa.043.1619.i.i816)
  %i.cwv = add nuw nsw i64 %reass.sub448.i821, 1
  br label %.lr.ph605.i.i822

.lr.ph605.i.i822:                                 ; preds = %bb.rt, %.lr.ph605.preheader.i.i820
  %i.cww = phi i64 [ %i.dck, %bb.rt ], [ 1, %.lr.ph605.preheader.i.i820 ] ; 3 uses
  %.sroa.043.2603.i.i823 = phi i64 [ %i.dcj, %bb.rt ], [ %.sroa.043.1619.i.i816, %.lr.ph605.preheader.i.i820 ] ; 3 uses
  %exitcond859.not.i.i824 = icmp eq i64 %i.cww, %i.cwv
  br i1 %exitcond859.not.i.i824, label %.invoke1172.i.i825, label %bb.rs

._crit_edge606.i.i842:                            ; preds = %bb.rt
  %i.cwx = icmp eq i64 %.sroa.0137.0617.i.i818, 0
  %i.cwy = getelementptr [4 x i8], ptr %i.cqx, i64 %.sroa.0137.0617.i.i818 ; 4 uses
  %i.cwz = getelementptr i8, ptr %i.cwy, i64 -4
  %.sroa.097.0.in.i.i843 = select i1 %i.cwx, ptr %i.cqx, ptr %i.cwz
  %.sroa.097.0.i.i844 = load i32, ptr %.sroa.097.0.in.i.i843, align 4, !noalias !35247, !noundef !27 ; 4 uses
  %i.cxa = zext i32 %.sroa.097.0.i.i844 to i64    ; 5 uses
  %i.cxb = icmp ugt i64 %.sroa.14.7.i.i755, %i.cxa
  br i1 %i.cxb, label %.noexc244.i.i845, label %.invoke1172.i.i825

._crit_edge606.thread.i.i919:                     ; preds = %bb.rk
  %i.cxc = icmp eq i64 %.sroa.0137.0617.i.i818, 0
  %i.cxd = getelementptr [4 x i8], ptr %i.cqx, i64 %.sroa.0137.0617.i.i818 ; 2 uses
  %i.cxe = getelementptr i8, ptr %i.cxd, i64 -4
  %.sroa.097.0.in936.i.i920 = select i1 %i.cxc, ptr %i.cqx, ptr %i.cxe
  %.sroa.097.0937.i.i921 = load i32, ptr %.sroa.097.0.in936.i.i920, align 4, !noalias !35247, !noundef !27 ; 2 uses
  %i.cxf = zext i32 %.sroa.097.0937.i.i921 to i64 ; 3 uses
  %i.cxg = icmp ugt i64 %.sroa.14.7.i.i755, %i.cxf
  br i1 %i.cxg, label %_ZN6brotli3enc7cluster30BrotliHistogramBitCostDistance17h947b41782effd87bE.exit249.i.i, label %.invoke1172.i.i825

.noexc244.i.i845:                                 ; preds = %._crit_edge606.i.i842
end_hunk_2
begin_hunk_3_@"_ZN8indexmap5inner17Core$LT$K$C$V$GT$15reserve_entries17h4bf27c1e01d5462aE":bb.a
  %.sroa.3.0.i.ph.i = phi i64 [ undef, %bb.b ], [ undef, %bb.c ], [ %i.ab, %bb.e ]
  %.sroa.0.0.i.ph.i = phi i64 [ 0, %bb.b ], [ 0, %bb.c ], [ %i.z, %bb.e ]
  tail call void @_ZN5alloc7raw_vec12handle_error17h5794e6eba25188a7E(i64 noundef %.sroa.0.0.i.ph.i, i64 %.sroa.3.0.i.ph.i, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @2175) #43, !noalias !40609
  unreachable

bb.g:                                             ; preds = %bb.a
  tail call void @llvm.experimental.noalias.scope.decl(metadata !40622)
  %i.ad = sub nsw i64 %.pre, %i.k                 ; 3 uses
  %i.ae = icmp ugt i64 %i.m, %i.ad
  br i1 %i.ae, label %bb.h, label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$13reserve_exact17h37680925839d5ab2E.exit"

bb.h:                                             ; preds = %bb.g
  tail call void @llvm.experimental.noalias.scope.decl(metadata !40625)
  %i.af = icmp ult i64 %i.i, %i.k
  br i1 %i.af, label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$17try_reserve_exact17hd40aa27d88bd02dcE.exit", label %bb.i, !prof !29

bb.i:                                             ; preds = %bb.h
  %i.ag = mul nuw nsw i64 %.sroa.0.0.i, 104
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !40628
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !40628
  %i.ah = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.ai = icmp eq i64 %.pre, 0
  br i1 %i.ai, label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$14current_memory17h3a83bd277e8def63E.exit.i.i", label %bb.j

bb.j:                                             ; preds = %bb.i
  %.val28.i.i = load ptr, ptr %i.ah, align 8, !alias.scope !40628, !nonnull !27, !noundef !27
  %i.aj = mul nuw i64 %.pre, 104
  store ptr %.val28.i.i, ptr %i.a, align 8, !alias.scope !40629, !noalias !40628
  %.sroa.5.0..sroa_idx.i.i.i = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store i64 %i.aj, ptr %.sroa.5.0..sroa_idx.i.i.i, align 8, !alias.scope !40629, !noalias !40628
  br label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$14current_memory17h3a83bd277e8def63E.exit.i.i"

"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$14current_memory17h3a83bd277e8def63E.exit.i.i": ; preds = %bb.j, %bb.i
  %.sink.i.i.i = phi i64 [ 8, %bb.j ], [ 0, %bb.i ]
  %i.ak = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store i64 %.sink.i.i.i, ptr %i.ak, align 8, !alias.scope !40629, !noalias !40628
  call fastcc void @_ZN5alloc7raw_vec11finish_grow17h6777eb6dc489659eE(ptr noalias noundef align 8 captures(address) dereferenceable(24) %i.b, i64 noundef 8, i64 noundef %i.ag, ptr noalias noundef readonly align 8 captures(address) dereferenceable(24) %i.a), !noalias !40628
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !40628
  %i.al = load i64, ptr %i.b, align 8, !range !223, !noalias !40628, !noundef !27
  %i.am = trunc nuw i64 %i.al to i1
  br i1 %i.am, label %bb.k, label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$10grow_exact17h911ee2d31eaf84b7E.exit.i"

bb.k:                                             ; preds = %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$14current_memory17h3a83bd277e8def63E.exit.i.i"
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !40628
  br label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$17try_reserve_exact17hd40aa27d88bd02dcE.exit"

"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$10grow_exact17h911ee2d31eaf84b7E.exit.i": ; preds = %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$14current_memory17h3a83bd277e8def63E.exit.i.i"
  %i.an = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %i.ao = load ptr, ptr %i.an, align 8, !noalias !40628, !nonnull !27, !noundef !27
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !40628
  store ptr %i.ao, ptr %i.ah, align 8, !alias.scope !40628
  br label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$13reserve_exact17h37680925839d5ab2E.exit.sink.split"

"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$13reserve_exact17h37680925839d5ab2E.exit.sink.split": ; preds = %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$10grow_exact17h911ee2d31eaf84b7E.exit.i.i", %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$10grow_exact17h911ee2d31eaf84b7E.exit.i"
  %.sroa.0.0.i.sink = phi i64 [ %.sroa.0.0.i, %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$10grow_exact17h911ee2d31eaf84b7E.exit.i" ], [ %i.p, %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$10grow_exact17h911ee2d31eaf84b7E.exit.i.i" ]
  store i64 %.sroa.0.0.i.sink, ptr %0, align 8
  br label %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$13reserve_exact17h37680925839d5ab2E.exit"

"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$13reserve_exact17h37680925839d5ab2E.exit": ; preds = %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$13reserve_exact17h37680925839d5ab2E.exit.sink.split", %bb.g, %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$17try_reserve_exact17hd40aa27d88bd02dcE.exit"
  ret void
}

; Function Attrs: cold nonlazybind uwtable
define internal fastcc void @"_ZN8smallvec17SmallVec$LT$A$GT$21reserve_one_unchecked17h2cffbac112d8fa02E"(ptr noalias nofree noundef nonnull align 8 captures(none) dereferenceable(648) %0) unnamed_addr #5 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 640
  %i.b = load i64, ptr %i.a, align 8, !alias.scope !40632, !noalias !40635, !noundef !27 ; 2 uses
  %i.c = icmp ugt i64 %i.b, 16
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.e = load i64, ptr %i.d, align 8, !alias.scope !40632, !noalias !40635
  %.sink10.i = select i1 %i.c, i64 %i.e, i64 %i.b ; 3 uses
  %i.f = icmp eq i64 %.sink10.i, -1
  br i1 %i.f, label %bb.f, label %bb.b, !prof !29
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.j, label %bb.f, label %bb.c, !prof !29

bb.c:                                             ; preds = %bb.b
  %i.k = add nuw i64 %.sroa.02.0, 1
  %i.l = tail call fastcc { i64, i64 } @"_ZN8smallvec17SmallVec$LT$A$GT$8try_grow17ha08c7f562073f1b2E"(ptr noalias noundef align 8 dereferenceable(648) %0, i64 noundef %i.k) ; 2 uses
  %i.m = extractvalue { i64, i64 } %i.l, 0        ; 2 uses
  switch i64 %i.m, label %bb.d [
    i64 -9223372036854775807, label %_ZN8smallvec10infallible17ha3158390c9a20c12E.exit
    i64 0, label %bb.e
  ], !prof !40637

bb.d:                                             ; preds = %bb.c
  %i.n = extractvalue { i64, i64 } %i.l, 1
  tail call void @_ZN5alloc5alloc18handle_alloc_error17h8f86e24af4223f3dE(i64 noundef range(i64 0, -9223372036854775806) %i.m, i64 noundef %i.n) #43
  unreachable

bb.e:                                             ; preds = %bb.c
  tail call void @_ZN4core9panicking5panic17ha264d2bb233f2b69E(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) @218, i64 noundef 17, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @2177) #43
  unreachable

_ZN8smallvec10infallible17ha3158390c9a20c12E.exit: ; preds = %bb.c
  ret void

bb.f:                                             ; preds = %bb.b, %bb.a
  tail call void @_ZN4core6option13expect_failed17h1729d0bd73171c50E(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) @218, i64 noundef 17, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @2178) #43
  unreachable
}

; Function Attrs: cold nonlazybind uwtable
define internal fastcc void @"_ZN8smallvec17SmallVec$LT$A$GT$21reserve_one_unchecked17h714637fa8dae859bE"(ptr noalias nofree noundef nonnull align 8 captures(none) dereferenceable(456) %0) unnamed_addr #5 personality ptr @rust_eh_personality {
bb.a:
  %i.a = alloca [16 x i8], align 8                ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 448 ; 3 uses
  %i.c = load i64, ptr %i.b, align 8, !alias.scope !40638, !noalias !40641, !noundef !27 ; 6 uses
  %i.d = icmp ugt i64 %i.c, 8
  %i.e = load ptr, ptr %0, align 8, !alias.scope !40638, !noalias !40641, !nonnull !27 ; 3 uses
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.g = load i64, ptr %i.f, align 8, !alias.scope !40638, !noalias !40641 ; 3 uses
  %.sink10.i = select i1 %i.d, i64 %i.g, i64 %i.c ; 5 uses
  %i.h = icmp eq i64 %.sink10.i, -1
  br i1 %i.h, label %bb.t, label %bb.b, !prof !29
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.l, label %bb.t, label %bb.c, !prof !29

bb.c:                                             ; preds = %bb.b
  %i.m = add nuw i64 %.sroa.02.0, 1               ; 4 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !40643)
...
bb.d:                                             ; preds = %bb.c
  tail call void @_ZN4core9panicking5panic17ha264d2bb233f2b69E(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) @2181, i64 noundef 32, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @2182) #43, !noalias !40643
  unreachable
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %.not47.i, label %_ZN8smallvec10infallible17ha3158390c9a20c12E.exit, label %bb.h

bb.g:                                             ; preds = %bb.e
  br i1 %i.n, label %_ZN8smallvec10infallible17ha3158390c9a20c12E.exit, label %bb.o

bb.h:                                             ; preds = %bb.f
  %i.p = tail call { i64, i1 } @llvm.umul.with.overflow.i64(i64 %i.m, i64 56) ; 2 uses
  %i.q = extractvalue { i64, i1 } %i.p, 0         ; 4 uses
  %i.r = extractvalue { i64, i1 } %i.p, 1
  br i1 %i.r, label %bb.s, label %bb.i, !prof !29

bb.i:                                             ; preds = %bb.h
  %i.s = tail call noundef zeroext i1 @_ZN4core5alloc6layout6Layout19is_size_align_valid17h26adf6c6175f55f5E(i64 noundef %i.q, i64 noundef 8), !noalias !40646
  br i1 %i.s, label %_ZN8smallvec12layout_array17hbe5175c1e8a3b5b1E.exit.i, label %bb.s

_ZN8smallvec12layout_array17hbe5175c1e8a3b5b1E.exit.i: ; preds = %bb.i
  br i1 %i.n, label %bb.l, label %bb.j

bb.j:                                             ; preds = %_ZN8smallvec12layout_array17hbe5175c1e8a3b5b1E.exit.i
  %i.t = tail call { i64, i1 } @llvm.umul.with.overflow.i64(i64 %.sink.i.i, i64 56) ; 2 uses
  %i.u = extractvalue { i64, i1 } %i.t, 1
  br i1 %i.u, label %bb.s, label %bb.k, !prof !29

bb.k:                                             ; preds = %bb.j
  %i.v = extractvalue { i64, i1 } %i.t, 0
  %i.w = tail call noundef zeroext i1 @_ZN4core5alloc6layout6Layout19is_size_align_valid17h26adf6c6175f55f5E(i64 noundef %i.v, i64 noundef 8), !noalias !40649
  br i1 %i.w, label %_ZN8smallvec12layout_array17hbe5175c1e8a3b5b1E.exit55.i, label %bb.s

bb.l:                                             ; preds = %_ZN8smallvec12layout_array17hbe5175c1e8a3b5b1E.exit.i
  tail call void @_RNvCskdKJRKLKjqM_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #38, !noalias !40643
  %i.x = tail call noundef ptr @mi_malloc_aligned(i64 noundef %i.q, i64 noundef 8) #38, !noalias !40643 ; 3 uses
  %.not71.i = icmp eq ptr %i.x, null
  br i1 %.not71.i, label %bb.r, label %bb.n

_ZN8smallvec12layout_array17hbe5175c1e8a3b5b1E.exit55.i: ; preds = %bb.k
  %i.y = tail call noundef ptr @mi_realloc_aligned(ptr noundef nonnull %i.e, i64 noundef %i.q, i64 noundef 8) #38, !noalias !40643 ; 2 uses
  %.not70.i = icmp eq ptr %i.y, null
  br i1 %.not70.i, label %bb.r, label %bb.m

bb.m:                                             ; preds = %_ZN8smallvec12layout_array17hbe5175c1e8a3b5b1E.exit55.i, %bb.n
  %.sroa.021.0.i = phi ptr [ %i.x, %bb.n ], [ %i.y, %_ZN8smallvec12layout_array17hbe5175c1e8a3b5b1E.exit55.i ]
  store ptr %.sroa.021.0.i, ptr %0, align 8, !alias.scope !40643
  store i64 %.sink10.i, ptr %i.f, align 8, !alias.scope !40643
  store i64 %i.m, ptr %i.b, align 8, !alias.scope !40643
  br label %_ZN8smallvec10infallible17ha3158390c9a20c12E.exit

bb.n:                                             ; preds = %bb.l
  %i.z = mul nuw nsw i64 %i.c, 56
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.x, ptr nonnull align 8 dereferenceable(456) %0, i64 %i.z, i1 false)
  br label %bb.m

bb.o:                                             ; preds = %bb.g
  %i.aa = mul i64 %i.g, 56
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 dereferenceable(456) %0, ptr nonnull align 8 %i.e, i64 %i.aa, i1 false)
  store i64 %i.g, ptr %i.b, align 8, !alias.scope !40643
  %i.ab = tail call { i64, i1 } @llvm.umul.with.overflow.i64(i64 %.sink.i.i, i64 56) ; 2 uses
  %i.ac = extractvalue { i64, i1 } %i.ab, 0       ; 2 uses
  %i.ad = extractvalue { i64, i1 } %i.ab, 1
  br i1 %i.ad, label %bb.q, label %bb.p, !prof !29

bb.p:                                             ; preds = %bb.o
  %i.ae = tail call noundef zeroext i1 @_ZN4core5alloc6layout6Layout19is_size_align_valid17h26adf6c6175f55f5E(i64 noundef %i.ac, i64 noundef 8), !noalias !40652
  br i1 %i.ae, label %_ZN8smallvec10deallocate17h5d4ffa0a5a3be3aaE.exit.i, label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.o
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !40655
  store i64 0, ptr %i.a, align 8, !noalias !40655
  %i.af = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store i64 %i.ac, ptr %i.af, align 8, !noalias !40655
  call void @_ZN4core6result13unwrap_failed17h0501379eaec3e720E(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) @1072, i64 noundef 43, ptr noundef nonnull align 1 %i.a, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @1079, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @2176) #43, !noalias !40655
  unreachable

_ZN8smallvec10deallocate17h5d4ffa0a5a3be3aaE.exit.i: ; preds = %bb.p
  tail call void @mi_free(ptr noundef nonnull %i.e) #38, !noalias !40643
  br label %_ZN8smallvec10infallible17ha3158390c9a20c12E.exit

bb.r:                                             ; preds = %_ZN8smallvec12layout_array17hbe5175c1e8a3b5b1E.exit55.i, %bb.l
  tail call void @_ZN5alloc5alloc18handle_alloc_error17h8f86e24af4223f3dE(i64 noundef range(i64 0, -9223372036854775806) 8, i64 noundef %i.q) #43
  unreachable
...
_ZN8smallvec10infallible17ha3158390c9a20c12E.exit: ; preds = %_ZN8smallvec10deallocate17h5d4ffa0a5a3be3aaE.exit.i, %bb.g, %bb.f, %bb.m
  ret void
...
; Function Attrs: cold nonlazybind uwtable
define internal fastcc void @"_ZN8smallvec17SmallVec$LT$A$GT$21reserve_one_unchecked17h7285d29bfcc6520dE"(ptr noalias nofree noundef nonnull align 8 captures(none) dereferenceable(72) %0) unnamed_addr #5 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 64
  %i.b = load i64, ptr %i.a, align 8, !alias.scope !40658, !noalias !40661, !noundef !27 ; 2 uses
  %i.c = icmp ugt i64 %i.b, 4
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.e = load i64, ptr %i.d, align 8, !alias.scope !40658, !noalias !40661
  %.sink10.i = select i1 %i.c, i64 %i.e, i64 %i.b ; 3 uses
  %i.f = icmp eq i64 %.sink10.i, -1
  br i1 %i.f, label %bb.f, label %bb.b, !prof !29
...
bb.c:                                             ; preds = %bb.b
  %i.k = add nuw i64 %.sroa.02.0, 1
  %i.l = tail call fastcc { i64, i64 } @"_ZN8smallvec17SmallVec$LT$A$GT$8try_grow17hd51cc09351e744a3E"(ptr noalias noundef align 8 dereferenceable(72) %0, i64 noundef %i.k) ; 2 uses
  %i.m = extractvalue { i64, i64 } %i.l, 0        ; 2 uses
  switch i64 %i.m, label %bb.d [
    i64 -9223372036854775807, label %_ZN8smallvec10infallible17ha3158390c9a20c12E.exit
    i64 0, label %bb.e
...
define internal fastcc { i64, i64 } @"_ZN8smallvec17SmallVec$LT$A$GT$8try_grow17ha08c7f562073f1b2E"(ptr noalias nofree noundef nonnull align 8 captures(none) dereferenceable(648) %0, i64 noundef %1) unnamed_addr #3 personality ptr @rust_eh_personality {
bb.a:
  %i.a = alloca [16 x i8], align 8                ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 640 ; 3 uses
  %i.c = load i64, ptr %i.b, align 8, !noundef !27 ; 6 uses
  %i.d = icmp ult i64 %i.c, 17                    ; 2 uses
  %i.e = icmp ugt i64 %i.c, 16
  %i.f = load ptr, ptr %0, align 8, !alias.scope !40663, !noalias !40666, !nonnull !27 ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  tail call void @_ZN4core9panicking5panic17ha264d2bb233f2b69E(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) @2181, i64 noundef 32, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @2182) #43
  unreachable
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %.not47, label %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit55.thread, label %bb.f

bb.e:                                             ; preds = %bb.c
  br i1 %i.d, label %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit55.thread, label %bb.m
...
bb.f:                                             ; preds = %bb.d
  ...
  br i1 %i.l, label %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit55.thread, label %bb.g, !prof !29

bb.g:                                             ; preds = %bb.f
  %i.m = tail call noundef zeroext i1 @_ZN4core5alloc6layout6Layout19is_size_align_valid17h26adf6c6175f55f5E(i64 noundef %i.k, i64 noundef 8), !noalias !40668
  br i1 %i.m, label %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit, label %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit55.thread

_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit: ; preds = %bb.g
  br i1 %i.d, label %bb.j, label %bb.h

bb.h:                                             ; preds = %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit
  %i.n = tail call { i64, i1 } @llvm.umul.with.overflow.i64(i64 %.sink.i, i64 40) ; 2 uses
  %i.o = extractvalue { i64, i1 } %i.n, 0         ; 3 uses
  %i.p = extractvalue { i64, i1 } %i.n, 1
  br i1 %i.p, label %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit55.thread, label %bb.i, !prof !29

bb.i:                                             ; preds = %bb.h
  %i.q = tail call noundef zeroext i1 @_ZN4core5alloc6layout6Layout19is_size_align_valid17h26adf6c6175f55f5E(i64 noundef %i.o, i64 noundef 8), !noalias !40671
  br i1 %i.q, label %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit55, label %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit55.thread

bb.j:                                             ; preds = %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit
  tail call void @_RNvCskdKJRKLKjqM_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #38
  %i.r = tail call noundef ptr @mi_malloc_aligned(i64 noundef %i.k, i64 noundef 8) #38 ; 3 uses
  %.not71 = icmp eq ptr %i.r, null
  br i1 %.not71, label %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit55.thread, label %bb.l

_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit55: ; preds = %bb.i
  %i.s = tail call noundef ptr @mi_realloc_aligned(ptr noundef nonnull %i.f, i64 noundef %i.k, i64 noundef 8) #38 ; 2 uses
  %.not70 = icmp eq ptr %i.s, null
  br i1 %.not70, label %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit55.thread, label %bb.k

bb.k:                                             ; preds = %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit55, %bb.l
  %.sroa.021.0 = phi ptr [ %i.r, %bb.l ], [ %i.s, %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit55 ]
  store ptr %.sroa.021.0, ptr %0, align 8
  store i64 %i.h, ptr %i.g, align 8
  store i64 %1, ptr %i.b, align 8
  br label %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit55.thread
...
bb.m:                                             ; preds = %bb.e
  ...
  %i.w = extractvalue { i64, i1 } %i.v, 0         ; 2 uses
  %i.x = extractvalue { i64, i1 } %i.v, 1
  br i1 %i.x, label %bb.o, label %bb.n, !prof !29

bb.n:                                             ; preds = %bb.m
  %i.y = tail call noundef zeroext i1 @_ZN4core5alloc6layout6Layout19is_size_align_valid17h26adf6c6175f55f5E(i64 noundef %i.w, i64 noundef 8), !noalias !40674
  br i1 %i.y, label %_ZN8smallvec10deallocate17hbef97e41d06e00f1E.exit, label %bb.o

bb.o:                                             ; preds = %bb.n, %bb.m
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !40677
  store i64 0, ptr %i.a, align 8, !noalias !40677
  %i.z = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store i64 %i.w, ptr %i.z, align 8, !noalias !40677
  call void @_ZN4core6result13unwrap_failed17h0501379eaec3e720E(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) @1072, i64 noundef 43, ptr noundef nonnull align 1 %i.a, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @1079, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @2176) #43, !noalias !40677
  unreachable

_ZN8smallvec10deallocate17hbef97e41d06e00f1E.exit: ; preds = %bb.n
  tail call void @mi_free(ptr noundef nonnull %i.f) #38
  br label %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit55.thread

_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit55.thread: ; preds = %bb.i, %bb.h, %bb.g, %bb.f, %bb.e, %_ZN8smallvec10deallocate17hbef97e41d06e00f1E.exit, %bb.k, %bb.d, %bb.j, %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit55
  %.sroa.7.1 = phi i64 [ undef, %_ZN8smallvec10deallocate17hbef97e41d06e00f1E.exit ], [ %i.k, %bb.j ], [ undef, %bb.e ], [ %i.k, %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit55 ], [ %i.k, %bb.g ], [ undef, %bb.d ], [ undef, %bb.k ], [ %i.k, %bb.f ], [ %i.o, %bb.h ], [ %i.o, %bb.i ]
  %.sroa.0.1 = phi i64 [ -9223372036854775807, %_ZN8smallvec10deallocate17hbef97e41d06e00f1E.exit ], [ 8, %bb.j ], [ -9223372036854775807, %bb.e ], [ 8, %_ZN8smallvec12layout_array17hc7d37ef6c9d5acc3E.exit55 ], [ 0, %bb.g ], [ -9223372036854775807, %bb.d ], [ -9223372036854775807, %bb.k ], [ 0, %bb.f ], [ 0, %bb.h ], [ 0, %bb.i ]
...
; Function Attrs: nonlazybind uwtable
define internal fastcc { i64, i64 } @"_ZN8smallvec17SmallVec$LT$A$GT$8try_grow17hd51cc09351e744a3E"(ptr noalias nofree noundef nonnull align 8 captures(none) dereferenceable(72) %0, i64 noundef %1) unnamed_addr #3 personality ptr @rust_eh_personality {
bb.a:
  %i.a = alloca [16 x i8], align 8                ; 3 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 64 ; 3 uses
  %i.c = load i64, ptr %i.b, align 8, !noundef !27 ; 8 uses
  %i.d = icmp ult i64 %i.c, 5                     ; 2 uses
  %i.e = icmp ugt i64 %i.c, 4
  %i.f = load ptr, ptr %0, align 8, !alias.scope !40680, !noalias !40683, !nonnull !27 ; 3 uses
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  %.not47 = icmp eq i64 %i.c, %1
  br i1 %.not47, label %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit55.thread, label %bb.f

bb.e:                                             ; preds = %bb.c
  br i1 %i.d, label %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit55.thread, label %bb.m

bb.f:                                             ; preds = %bb.d
  %i.j = shl nuw i64 %1, 4                        ; 5 uses
  %i.k = icmp ugt i64 %1, 1152921504606846975
  br i1 %i.k, label %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit55.thread, label %bb.g, !prof !29

bb.g:                                             ; preds = %bb.f
  %i.l = tail call noundef zeroext i1 @_ZN4core5alloc6layout6Layout19is_size_align_valid17h26adf6c6175f55f5E(i64 noundef %i.j, i64 noundef 8), !noalias !40685
  br i1 %i.l, label %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit, label %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit55.thread

_ZN8smallvec12layout_array17hb062c7101d476b75E.exit: ; preds = %bb.g
  br i1 %i.d, label %bb.j, label %bb.h

bb.h:                                             ; preds = %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit
  %i.m = icmp ugt i64 %i.c, 1152921504606846975
  br i1 %i.m, label %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit55.thread, label %bb.i, !prof !29

bb.i:                                             ; preds = %bb.h
  %i.n = shl nuw i64 %.sink.i, 4
  %i.o = tail call noundef zeroext i1 @_ZN4core5alloc6layout6Layout19is_size_align_valid17h26adf6c6175f55f5E(i64 noundef %i.n, i64 noundef 8), !noalias !40688
  br i1 %i.o, label %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit55, label %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit55.thread

bb.j:                                             ; preds = %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit
  tail call void @_RNvCskdKJRKLKjqM_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #38
  %i.p = tail call noundef ptr @mi_malloc_aligned(i64 noundef %i.j, i64 noundef 8) #38 ; 3 uses
  %.not74 = icmp eq ptr %i.p, null
  br i1 %.not74, label %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit55.thread, label %bb.l

_ZN8smallvec12layout_array17hb062c7101d476b75E.exit55: ; preds = %bb.i
  %i.q = tail call noundef ptr @mi_realloc_aligned(ptr noundef nonnull %i.f, i64 noundef %i.j, i64 noundef 8) #38 ; 2 uses
  %.not73 = icmp eq ptr %i.q, null
  br i1 %.not73, label %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit55.thread, label %bb.k

bb.k:                                             ; preds = %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit55, %bb.l
  %.sroa.021.0 = phi ptr [ %i.p, %bb.l ], [ %i.q, %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit55 ]
  store ptr %.sroa.021.0, ptr %0, align 8
  store i64 %i.h, ptr %i.g, align 8
  store i64 %1, ptr %i.b, align 8
  br label %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit55.thread
...
bb.m:                                             ; preds = %bb.e
  ...
  br i1 %i.t, label %bb.o, label %bb.n, !prof !29

bb.n:                                             ; preds = %bb.m
  %i.u = shl nuw i64 %.sink.i, 4
  %i.v = tail call noundef zeroext i1 @_ZN4core5alloc6layout6Layout19is_size_align_valid17h26adf6c6175f55f5E(i64 noundef %i.u, i64 noundef 8), !noalias !40691
  br i1 %i.v, label %_ZN8smallvec10deallocate17h74feda8f4d5b5c3dE.exit, label %bb.o

bb.o:                                             ; preds = %bb.n, %bb.m
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !40694
  store i64 0, ptr %i.a, align 8, !noalias !40694
  call void @_ZN4core6result13unwrap_failed17h0501379eaec3e720E(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) @1072, i64 noundef 43, ptr noundef nonnull align 1 %i.a, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @1079, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @2176) #43, !noalias !40694
  unreachable

_ZN8smallvec10deallocate17h74feda8f4d5b5c3dE.exit: ; preds = %bb.n
  tail call void @mi_free(ptr noundef nonnull %i.f) #38
  br label %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit55.thread

_ZN8smallvec12layout_array17hb062c7101d476b75E.exit55.thread: ; preds = %bb.i, %bb.h, %bb.g, %bb.f, %bb.e, %_ZN8smallvec10deallocate17h74feda8f4d5b5c3dE.exit, %bb.k, %bb.d, %bb.j, %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit55
  %.sroa.7.1 = phi i64 [ undef, %_ZN8smallvec10deallocate17h74feda8f4d5b5c3dE.exit ], [ %i.j, %bb.j ], [ undef, %bb.e ], [ %i.j, %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit55 ], [ undef, %bb.g ], [ undef, %bb.d ], [ undef, %bb.k ], [ undef, %bb.f ], [ undef, %bb.h ], [ undef, %bb.i ]
  %.sroa.0.1 = phi i64 [ -9223372036854775807, %_ZN8smallvec10deallocate17h74feda8f4d5b5c3dE.exit ], [ 8, %bb.j ], [ -9223372036854775807, %bb.e ], [ 8, %_ZN8smallvec12layout_array17hb062c7101d476b75E.exit55 ], [ 0, %bb.g ], [ -9223372036854775807, %bb.d ], [ -9223372036854775807, %bb.k ], [ 0, %bb.f ], [ 0, %bb.h ], [ 0, %bb.i ]
...
define internal void @"_ZN91_$LT$actix_utils..future..ready..Ready$LT$T$GT$$u20$as$u20$core..future..future..Future$GT$4poll17h12450eb11f669b94E"(ptr dead_on_unwind noalias nofree noundef writable writeonly sret([120 x i8]) align 8 captures(none) dereferenceable(120) %0, ptr noalias nofree noundef align 8 captures(none) dereferenceable(120) %1, ptr noalias nofree readnone align 8 captures(none) %2) unnamed_addr #1 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(112) %.sroa.2.0..sroa_idx, ptr noundef nonnull align 8 dereferenceable(112) %.sroa.5.0..sroa_idx, i64 112, i1 false)
  store i64 %.sroa.0.0.copyload, ptr %0, align 8
  ret void

bb.c:                                             ; preds = %bb.a
  tail call void @_ZN4core6option13expect_failed17h1729d0bd73171c50E(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) @2183, i64 noundef 29, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @2185) #43
  unreachable
}

; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind nonlazybind willreturn memory(argmem: read) uwtable
define internal noundef nonnull align 8 dereferenceable(120) ptr @"_ZN92_$LT$tracing_core..callsite..DefaultCallsite$u20$as$u20$tracing_core..callsite..Callsite$GT$8metadata17hc5da72d39852d977E"(ptr nofree noundef nonnull readonly align 8 captures(none) %0) unnamed_addr #24 {
bb.a:
  %i.a = load ptr, ptr %0, align 8, !nonnull !27, !align !148, !noundef !27
  ret ptr %i.a
}

; Function Attrs: nonlazybind uwtable
define internal fastcc void @"_ZN94_$LT$actix_http..h2..HandshakeWithTimeout$LT$T$GT$$u20$as$u20$core..future..future..Future$GT$4poll17h4500024112ab0602E"(ptr dead_on_unwind noalias nofree noundef nonnull writable writeonly align 8 captures(none) dereferenceable(2408) %0, ptr noalias noundef nonnull align 8 dereferenceable(2304) %1, ptr noalias noundef nonnull align 8 dereferenceable(32) %2) unnamed_addr #3 personality ptr @rust_eh_personality {
bb.a:
  ...
  %i.m = alloca [2080 x i8], align 8              ; 5 uses
  ...
  %i.ai = alloca [24 x i8], align 1               ; 4 uses
  ...
  %i.bc = alloca [2400 x i8], align 8             ; 5 uses
  ...
  %i.bk = alloca [2080 x i8], align 8             ; 6 uses
  %i.bl = alloca [2400 x i8], align 8             ; 37 uses
  %i.bm = alloca [2080 x i8], align 8             ; 24 uses
  %.sroa.853.i.sroa.7 = alloca [7 x i8], align 1  ; 7 uses
  %.sroa.853.i.sroa.9 = alloca [24 x i8], align 8 ; 7 uses
  %i.bn = alloca [2080 x i8], align 8             ; 10 uses
  %i.bo = alloca [32 x i8], align 8               ; 7 uses
  %i.bp = alloca [40 x i8], align 8               ; 7 uses
  %i.bq = alloca [32 x i8], align 8               ; 7 uses
  %i.br = alloca [40 x i8], align 8               ; 5 uses
  %i.bs = alloca [2088 x i8], align 8             ; 6 uses
  %i.bt = alloca [2128 x i8], align 8             ; 5 uses
  %i.bu = alloca [2128 x i8], align 8             ; 5 uses
  ...
  %i.cc = alloca [2080 x i8], align 8             ; 10 uses
  ...
  %.sroa.8.sroa.7.i = alloca [7 x i8], align 1    ; 6 uses
  %.sroa.8.sroa.9.i = alloca [24 x i8], align 8   ; 6 uses
  %.sroa.10255.i = alloca [7 x i8], align 1       ; 7 uses
  %.sroa.11.i = alloca [2056 x i8], align 8       ; 8 uses
  ...
  %i.cq = alloca [32 x i8], align 8               ; 8 uses
  %i.cr = alloca [40 x i8], align 8               ; 17 uses
  %.sroa.10 = alloca [2352 x i8], align 8         ; 2 uses
  %.sroa.13 = alloca [7 x i8], align 1            ; 9 uses
  %.sroa.15 = alloca [24 x i8], align 8           ; 9 uses
  %.sroa.16 = alloca [2352 x i8], align 8         ; 6 uses
  %.sroa.8.sroa.8 = alloca [7 x i8], align 1      ; 6 uses
  %.sroa.8.sroa.10 = alloca [24 x i8], align 8    ; 6 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.8.sroa.8)
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.8.sroa.10)
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.13)
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.15)
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.16)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !40697)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.bg)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.by)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.cg)
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.8.sroa.7.i)
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.8.sroa.9.i)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.cn)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.cr), !noalias !40700
  %i.cs = getelementptr inbounds nuw i8, ptr %1, i64 128 ; 2 uses
  %i.ct = load i64, ptr %i.cs, align 8, !range !210, !alias.scope !40697, !noalias !40703, !noundef !27
  %.not.i = icmp eq i64 %i.ct, 2
  br i1 %.not.i, label %.thread441.i, label %bb.b

.thread441.i:                                     ; preds = %bb.a
  %i.cu = getelementptr inbounds nuw i8, ptr %1, i64 160
  %i.cv = load ptr, ptr %i.cu, align 8, !alias.scope !40697, !noalias !40703, !align !148, !noundef !27
  store i64 2, ptr %i.cr, align 8, !noalias !40700
  %i.cw = getelementptr inbounds nuw i8, ptr %i.cr, i64 32 ; 2 uses
  store ptr %i.cv, ptr %i.cw, align 8, !noalias !40700
  br label %.noexc199.i

bb.b:                                             ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %i.bb), !noalias !40700
  call void @"_ZN59_$LT$tracing..span..Inner$u20$as$u20$core..clone..Clone$GT$5clone17hc006a05015ab03a4E"(ptr noalias noundef nonnull sret([32 x i8]) align 8 captures(address) dereferenceable(32) %i.bb, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.cs), !noalias !40704
  %.sroa.082.0.copyload.i = load i64, ptr %i.bb, align 8, !noalias !40700 ; 2 uses
  %.sroa.584.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.bb, i64 8
  %.sroa.584.0..sroa_idx85.i = getelementptr inbounds nuw i8, ptr %i.cr, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.sroa.584.0..sroa_idx85.i, ptr noundef nonnull align 8 dereferenceable(24) %.sroa.584.0..sroa_idx.i, i64 24, i1 false), !noalias !40700
  call void @llvm.lifetime.end.p0(ptr nonnull %i.bb), !noalias !40700
end_hunk_3
