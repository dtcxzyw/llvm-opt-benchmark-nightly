...
begin_hunk_0_@"_ZN144_$LT$lindera_dictionary..dictionary_builder..cc_cedict..CcCedictBuilder$u20$as$u20$lindera_dictionary..dictionary_builder..DictionaryBuilder$GT$26build_character_definition17h8e6595323372510cE":bb.a
...
define { ptr, i8 } @"_ZN144_$LT$lindera_dictionary..dictionary_builder..cc_cedict..CcCedictBuilder$u20$as$u20$lindera_dictionary..dictionary_builder..DictionaryBuilder$GT$28build_connection_cost_matrix17hc639fad0e9b8a0cdE"(ptr noalias noundef nonnull readonly align 1 captures(none) %0, ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %1, i64 noundef %2, ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %3, i64 noundef %4) unnamed_addr #2 personality ptr @rust_eh_personality {
"_ZN4core3ptr119drop_in_place$LT$lindera_dictionary..dictionary_builder..connection_cost_matrix..ConnectionCostMatrixBuilderOptions$GT$17h9d2d41c85513e92fE.exit11":
  %i.a = alloca [32 x i8], align 8                ; 7 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  store i64 -9223372036854775808, ptr %i.a, align 8, !alias.scope !1134, !noalias !1138
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store ptr @186, ptr %.sroa.5.0..sroa_idx, align 8, !alias.scope !1134, !noalias !1138
  %.sroa.7.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store i64 5, ptr %.sroa.7.0..sroa_idx, align 8, !alias.scope !1134, !noalias !1138
  %.sroa.8.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.a, i64 24
  store i8 0, ptr %.sroa.8.0..sroa_idx, align 8, !alias.scope !1134, !noalias !1138
  %i.b = call { ptr, i8 } @_ZN18lindera_dictionary18dictionary_builder22connection_cost_matrix27ConnectionCostMatrixBuilder5build17hf06875aade560198E(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.a, ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %1, i64 noundef %2, ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %3, i64 noundef %4)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a)
  ret { ptr, i8 } %i.b
}

; Function Attrs: nonlazybind uwtable
define internal fastcc noundef ptr @"_ZN14encoding_rs_io30DecodeReaderBytes$LT$R$C$B$GT$4fill17hafd1a5ab973823dcE"(ptr noalias noundef nonnull align 8 dereferenceable(160) %0) unnamed_addr #2 personality ptr @rust_eh_personality {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  ...
  %.val17 = load ptr, ptr %i.h, align 8, !nonnull !6, !noundef !6 ; 4 uses
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 56
  %.val18 = load i64, ptr %i.i, align 8, !noundef !6 ; 9 uses
  %i.j = icmp ult i64 %i.f, %.val18
  br i1 %i.j, label %.lr.ph.preheader, label %bb.d, !prof !7

.lr.ph.preheader:                                 ; preds = %bb.b
  %i.k = sub i64 %i.f, %i.d                       ; 5 uses
  %i.l = xor i64 %i.d, -1
  %i.m = add i64 %i.f, %i.l
  %i.n = tail call i64 @llvm.umin.i64(i64 %.val18, i64 %i.m)
  %i.o = add i64 %i.n, 1                          ; 3 uses
  %min.iters.check = icmp ult i64 %i.o, 33
  %diff.check = icmp ugt i64 %i.d, -32
  %or.cond = or i1 %min.iters.check, %diff.check
  br i1 %or.cond, label %.lr.ph.preheader59, label %vector.ph

.lr.ph.preheader59:                               ; preds = %vector.body, %.lr.ph.preheader
  %.sroa.0.02244.ph = phi i64 [ %i.d, %.lr.ph.preheader ], [ %i.s, %vector.body ]
  %.sroa.7.043.ph = phi i64 [ 0, %.lr.ph.preheader ], [ %n.vec, %vector.body ]
  br label %.lr.ph
...
vector.ph:                                        ; preds = %.lr.ph.preheader
  ...
  %i.s = add i64 %i.d, %n.vec
  %i.t = getelementptr inbounds nuw i8, ptr %.val17, i64 %i.d
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load57 = load <16 x i8>, ptr %i.v, align 1
  %i.w = getelementptr inbounds nuw i8, ptr %.val17, i64 %index ; 2 uses
  %i.x = getelementptr inbounds nuw i8, ptr %i.w, i64 16
  store <16 x i8> %wide.load, ptr %i.w, align 1
  store <16 x i8> %wide.load57, ptr %i.x, align 1
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.y = icmp eq i64 %index.next, %n.vec
  br i1 %i.y, label %.lr.ph.preheader59, label %vector.body, !llvm.loop !1140

bb.c:                                             ; preds = %bb.m
  store i64 %i.k, ptr %i.e, align 8
  store i64 0, ptr %i.c, align 8
  %i.z = icmp ugt i64 %i.k, %.val18
  br i1 %i.z, label %bb.j, label %bb.e, !prof !1143

bb.d:                                             ; preds = %bb.b
  tail call void @_ZN3std9panicking11begin_panic17h3ae8d44fd2c8c89bE(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) @55, i64 noundef 41, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @56) #46
  unreachable

.lr.ph:                                           ; preds = %.lr.ph.preheader59, %bb.m
  %.sroa.0.02244 = phi i64 [ %i.bj, %bb.m ], [ %.sroa.0.02244.ph, %.lr.ph.preheader59 ] ; 2 uses
  %.sroa.7.043 = phi i64 [ %i.bi, %bb.m ], [ %.sroa.7.043.ph, %.lr.ph.preheader59 ] ; 3 uses
  %exitcond.not = icmp eq i64 %.sroa.7.043, %.val18
  br i1 %exitcond.not, label %bb.n, label %bb.m

bb.e:                                             ; preds = %.thread, %bb.c
  %storemerge56 = phi i64 [ 0, %.thread ], [ %i.k, %bb.c ] ; 2 uses
  %.val1655 = phi i64 [ %.val16.pre, %.thread ], [ %.val18, %bb.c ]
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 48
  %.val15 = load ptr, ptr %i.aa, align 8, !nonnull !6, !noundef !6
  %i.ab = sub nuw i64 %.val1655, %storemerge56    ; 2 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %.val15, i64 %storemerge56 ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !1144)
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 5 uses
  %i.ae = load i64, ptr %i.ad, align 8, !alias.scope !1144, !noalias !1147, !noundef !6
...
bb.f:                                             ; preds = %bb.e
  ...
  call fastcc void @"_ZN14encoding_rs_io4util18BomPeeker$LT$R$GT$8peek_bom17h6d87da8efc36030cE"(ptr noalias noundef align 8 captures(address) dereferenceable(24) %i.a, ptr noalias noundef nonnull align 8 dereferenceable(40) %0), !noalias !1147
  %i.ag = load i64, ptr %i.a, align 8, !range !66, !noalias !1149, !noundef !6
  %i.ah = trunc nuw i64 %i.ag to i1
  %i.ai = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  %i.aj = load ptr, ptr %i.ai, align 8, !noalias !1149 ; 2 uses
  br i1 %i.ah, label %"_ZN74_$LT$encoding_rs_io..util..BomPeeker$LT$R$GT$$u20$as$u20$std..io..Read$GT$4read17hd8f26a9073bbee5dE.exit.thread36", label %bb.h

bb.g:                                             ; preds = %bb.i, %bb.e
  %i.ak = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.al = call { i64, ptr } @"_ZN47_$LT$std..fs..File$u20$as$u20$std..io..Read$GT$4read17h190ab4ac9c2ac827E"(ptr noalias noundef nonnull align 4 dereferenceable(4) %i.ak, ptr noalias noundef nonnull align 1 %i.ac, i64 noundef %i.ab) ; 2 uses
  %i.am = extractvalue { i64, ptr } %i.al, 0
  %i.an = extractvalue { i64, ptr } %i.al, 1      ; 2 uses
  %i.ao = trunc nuw i64 %i.am to i1
  br i1 %i.ao, label %"_ZN74_$LT$encoding_rs_io..util..BomPeeker$LT$R$GT$$u20$as$u20$std..io..Read$GT$4read17hd8f26a9073bbee5dE.exit.thread", label %"_ZN74_$LT$encoding_rs_io..util..BomPeeker$LT$R$GT$$u20$as$u20$std..io..Read$GT$4read17hd8f26a9073bbee5dE.exit.thread32"

"_ZN74_$LT$encoding_rs_io..util..BomPeeker$LT$R$GT$$u20$as$u20$std..io..Read$GT$4read17hd8f26a9073bbee5dE.exit.thread36": ; preds = %bb.f
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !1149
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !1149
  br label %"_ZN74_$LT$encoding_rs_io..util..BomPeeker$LT$R$GT$$u20$as$u20$std..io..Read$GT$4read17hd8f26a9073bbee5dE.exit.thread"

bb.h:                                             ; preds = %bb.f
  %.sroa.513.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  %.sroa.513.0.copyload.i = load i64, ptr %.sroa.513.0..sroa_idx.i, align 8, !noalias !1149
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !1149
  store ptr %i.aj, ptr %i.b, align 8, !noalias !1149
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  store i64 %.sroa.513.0.copyload.i, ptr %.sroa.4.0..sroa_idx.i, align 8, !noalias !1149
  %i.ap = getelementptr inbounds nuw i8, ptr %0, i64 36
  %i.aq = load i8, ptr %i.ap, align 4, !range !1150, !alias.scope !1144, !noalias !1147, !noundef !6
  %i.ar = trunc nuw i8 %i.aq to i1
  %i.as = xor i1 %i.ar, true
  %i.at = call { ptr, i64 } @_ZN14encoding_rs_io4util11PossibleBom8as_slice17h120ee4b44cc0a6aaE(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %i.b, i1 noundef zeroext %i.as), !noalias !1147 ; 2 uses
  %i.au = extractvalue { ptr, i64 } %i.at, 1      ; 2 uses
  %i.av = load i64, ptr %i.ad, align 8, !alias.scope !1144, !noalias !1147, !noundef !6 ; 4 uses
  %i.aw = icmp ult i64 %i.av, %i.au
  br i1 %i.aw, label %"_ZN74_$LT$encoding_rs_io..util..BomPeeker$LT$R$GT$$u20$as$u20$std..io..Read$GT$4read17hd8f26a9073bbee5dE.exit", label %bb.i

bb.i:                                             ; preds = %bb.h
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !1149
  br label %bb.g

"_ZN74_$LT$encoding_rs_io..util..BomPeeker$LT$R$GT$$u20$as$u20$std..io..Read$GT$4read17hd8f26a9073bbee5dE.exit.thread32": ; preds = %bb.g
  %i.ax = ptrtoint ptr %i.an to i64               ; 2 uses
  %i.ay = load i64, ptr %i.ad, align 8, !alias.scope !1144, !noalias !1147, !noundef !6
  %i.az = add i64 %i.ay, %i.ax
  store i64 %i.az, ptr %i.ad, align 8, !alias.scope !1144, !noalias !1147
  br label %bb.k

"_ZN74_$LT$encoding_rs_io..util..BomPeeker$LT$R$GT$$u20$as$u20$std..io..Read$GT$4read17hd8f26a9073bbee5dE.exit": ; preds = %bb.h
  %i.ba = extractvalue { ptr, i64 } %i.at, 0
  %i.bb = sub nuw i64 %i.au, %i.av
  %i.bc = getelementptr inbounds nuw i8, ptr %i.ba, i64 %i.av
  %.sroa.0.0.i.i = call noundef i64 @llvm.umin.i64(i64 %i.bb, i64 %i.ab) ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.ac, ptr nonnull readonly align 1 %i.bc, i64 %.sroa.0.0.i.i, i1 false), !alias.scope !1151, !noalias !1155
  %i.bd = add i64 %.sroa.0.0.i.i, %i.av
  store i64 %i.bd, ptr %i.ad, align 8, !alias.scope !1144, !noalias !1147
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !1149
  br label %bb.k

bb.j:                                             ; preds = %bb.c
  tail call void @_ZN4core5slice5index16slice_index_fail17hfe436548ecebea33E(i64 noundef %i.k, i64 noundef %.val18, i64 noundef %.val18, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @57) #46
  unreachable

bb.k:                                             ; preds = %"_ZN74_$LT$encoding_rs_io..util..BomPeeker$LT$R$GT$$u20$as$u20$std..io..Read$GT$4read17hd8f26a9073bbee5dE.exit", %"_ZN74_$LT$encoding_rs_io..util..BomPeeker$LT$R$GT$$u20$as$u20$std..io..Read$GT$4read17hd8f26a9073bbee5dE.exit.thread32"
  %.sroa.5.0.i35 = phi i64 [ %i.ax, %"_ZN74_$LT$encoding_rs_io..util..BomPeeker$LT$R$GT$$u20$as$u20$std..io..Read$GT$4read17hd8f26a9073bbee5dE.exit.thread32" ], [ %.sroa.0.0.i.i, %"_ZN74_$LT$encoding_rs_io..util..BomPeeker$LT$R$GT$$u20$as$u20$std..io..Read$GT$4read17hd8f26a9073bbee5dE.exit" ]
  %i.be = load i64, ptr %i.e, align 8, !noundef !6
  %i.bf = add i64 %i.be, %.sroa.5.0.i35           ; 2 uses
  store i64 %i.bf, ptr %i.e, align 8
  %i.bg = icmp eq i64 %i.bf, 0
  br i1 %i.bg, label %bb.l, label %"_ZN74_$LT$encoding_rs_io..util..BomPeeker$LT$R$GT$$u20$as$u20$std..io..Read$GT$4read17hd8f26a9073bbee5dE.exit.thread"

bb.l:                                             ; preds = %bb.k
  %i.bh = getelementptr inbounds nuw i8, ptr %0, i64 154
  store i8 1, ptr %i.bh, align 2
  br label %"_ZN74_$LT$encoding_rs_io..util..BomPeeker$LT$R$GT$$u20$as$u20$std..io..Read$GT$4read17hd8f26a9073bbee5dE.exit.thread"

"_ZN74_$LT$encoding_rs_io..util..BomPeeker$LT$R$GT$$u20$as$u20$std..io..Read$GT$4read17hd8f26a9073bbee5dE.exit.thread": ; preds = %bb.g, %"_ZN74_$LT$encoding_rs_io..util..BomPeeker$LT$R$GT$$u20$as$u20$std..io..Read$GT$4read17hd8f26a9073bbee5dE.exit.thread36", %bb.l, %bb.k
  %.sroa.0.0 = phi ptr [ %i.aj, %"_ZN74_$LT$encoding_rs_io..util..BomPeeker$LT$R$GT$$u20$as$u20$std..io..Read$GT$4read17hd8f26a9073bbee5dE.exit.thread36" ], [ null, %bb.k ], [ null, %bb.l ], [ %i.an, %bb.g ]
  ret ptr %.sroa.0.0

bb.m:                                             ; preds = %.lr.ph
  %i.bi = add nuw i64 %.sroa.7.043, 1             ; 2 uses
  %i.bj = add nuw i64 %.sroa.0.02244, 1
  %i.bk = getelementptr inbounds nuw i8, ptr %.val17, i64 %.sroa.0.02244
  %i.bl = load i8, ptr %i.bk, align 1, !noundef !6
  %i.bm = getelementptr inbounds nuw i8, ptr %.val17, i64 %.sroa.7.043
  store i8 %i.bl, ptr %i.bm, align 1
  %exitcond46.not = icmp eq i64 %i.bi, %i.k
  br i1 %exitcond46.not, label %bb.c, label %.lr.ph, !llvm.loop !1157

bb.n:                                             ; preds = %.lr.ph
  tail call void @_ZN4core9panicking18panic_bounds_check17hbc09f5d79f1a5789E(i64 noundef %.val18, i64 noundef %.val18, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @58) #46
  unreachable
}

; Function Attrs: nonlazybind uwtable
define internal fastcc void @"_ZN14encoding_rs_io4util18BomPeeker$LT$R$GT$8peek_bom17h6d87da8efc36030cE"(ptr dead_on_unwind noalias nofree noundef nonnull writable writeonly align 8 captures(none) dereferenceable(24) %0, ptr noalias noundef nonnull align 8 dereferenceable(40) %1) unnamed_addr #2 personality ptr @rust_eh_personality {
bb.a:
  %i.a = alloca [16 x i8], align 8                ; 6 uses
  %i.b = alloca [3 x i8], align 1                 ; 6 uses
  %i.c = load i64, ptr %1, align 8, !range !66, !noundef !6
...
bb.c:                                             ; preds = %bb.a
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(11) %.sroa.4.0..sroa_idx, i8 0, i64 11, i1 false)
  %i.g = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.h = getelementptr inbounds nuw i8, ptr %i.a, i64 8 ; 2 uses
  br label %bb.d

bb.d:                                             ; preds = %bb.k, %bb.c
  %.sroa.0.036.i = phi ptr [ %i.b, %bb.c ], [ %.sroa.0.119.i, %bb.k ] ; 3 uses
  %.sroa.5.035.i = phi i64 [ 3, %bb.c ], [ %.sroa.5.117.i, %bb.k ] ; 6 uses
  %.sroa.06.034.i = phi i64 [ 0, %bb.c ], [ %.sroa.06.115.i, %bb.k ] ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !1158
  %i.i = call { i64, ptr } @"_ZN47_$LT$std..fs..File$u20$as$u20$std..io..Read$GT$4read17h190ab4ac9c2ac827E"(ptr noalias noundef nonnull align 4 dereferenceable(4) %i.g, ptr noalias noundef nonnull align 1 %.sroa.0.036.i, i64 noundef range(i64 1, 4) %.sroa.5.035.i) ; 2 uses
  %i.j = extractvalue { i64, ptr } %i.i, 0        ; 2 uses
  %i.k = extractvalue { i64, ptr } %i.i, 1        ; 5 uses
  store i64 %i.j, ptr %i.a, align 8, !noalias !1158
  store ptr %i.k, ptr %i.h, align 8, !noalias !1158
  %i.l = trunc nuw i64 %i.j to i1
  %i.m = ptrtoint ptr %i.k to i64                 ; 5 uses
  br i1 %i.l, label %bb.e, label %bb.f

bb.e:                                             ; preds = %bb.d
  %i.n = call fastcc noundef i8 @_ZN3std2io5error5Error4kind17hcef9c5606d2f7459E(ptr %i.k)
  %i.o = icmp eq i8 %i.n, 35
  br i1 %i.o, label %.thread.i, label %bb.m
...
bb.h:                                             ; preds = %bb.f
  %i.q = icmp ult i64 %.sroa.5.035.i, %i.m
  br i1 %i.q, label %bb.i, label %bb.j, !prof !238

bb.i:                                             ; preds = %bb.h
  call void @_ZN4core5slice5index16slice_index_fail17hfe436548ecebea33E(i64 noundef %i.m, i64 noundef %.sroa.5.035.i, i64 noundef %.sroa.5.035.i, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @63) #46
  unreachable

bb.j:                                             ; preds = %bb.h
  %i.r = add i64 %.sroa.06.034.i, %i.m
  %i.s = sub nuw nsw i64 %.sroa.5.035.i, %i.m
  %i.t = getelementptr inbounds nuw i8, ptr %.sroa.0.036.i, i64 %i.m
  br label %bb.k

.thread.i:                                        ; preds = %bb.e
  call void @"_ZN4core3ptr42drop_in_place$LT$std..io..error..Error$GT$17h3f70fb415ce2d7ddE"(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.h)
  br label %bb.k

bb.k:                                             ; preds = %.thread.i, %bb.j
  %.sroa.0.119.i = phi ptr [ %.sroa.0.036.i, %.thread.i ], [ %i.t, %bb.j ]
  %.sroa.5.117.i = phi i64 [ %.sroa.5.035.i, %.thread.i ], [ %i.s, %bb.j ] ; 2 uses
  %.sroa.06.115.i = phi i64 [ %.sroa.06.034.i, %.thread.i ], [ %i.r, %bb.j ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !1158
  %i.u = icmp eq i64 %.sroa.5.117.i, 0
  br i1 %i.u, label %.loopexit, label %bb.d

bb.l:                                             ; preds = %.loopexit, %bb.m, %bb.b
  ret void
...
.loopexit:                                        ; preds = %bb.k, %bb.g
  %.sroa.06.030.i = phi i64 [ %.sroa.06.034.i, %bb.g ], [ %.sroa.06.115.i, %bb.k ]
  store i64 1, ptr %1, align 8
  store i64 %.sroa.06.030.i, ptr %.sroa.4.0..sroa_idx, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(3) %.sroa.4.sroa.4.0..sroa.4.0..sroa_idx.sroa_idx, ptr noundef nonnull align 1 dereferenceable(3) %i.b, i64 3, i1 false)
  %i.w = getelementptr inbounds nuw i8, ptr %0, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.w, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.4.0..sroa_idx, i64 16, i1 false)
  store i64 0, ptr %0, align 8
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b)
  br label %bb.l
}
...
; Function Attrs: nonlazybind uwtable
define void @"_ZN154_$LT$lindera_dictionary..dictionary_builder..ipadic_neologd..IpadicNeologdBuilder$u20$as$u20$lindera_dictionary..dictionary_builder..DictionaryBuilder$GT$15build_user_dict17haf8e5ec8d27a0f06E"(ptr dead_on_unwind noalias nofree noundef writable writeonly sret([104 x i8]) align 8 captures(none) dereferenceable(104) %0, ptr noalias nonnull readonly align 1 captures(none) %1, ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %2, i64 noundef %3) unnamed_addr #2 personality ptr @rust_eh_personality {
"_ZN4core6result19Result$LT$T$C$E$GT$6unwrap17h9cd4b36396336e1dE.exit":
  ...
  %.sroa.498.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store i64 3, ptr %.sroa.498.0..sroa_idx, align 8
  %.sroa.599.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store i64 1, ptr %.sroa.599.0..sroa_idx, align 8
  %.sroa.6100.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.a, i64 24
  store i64 13, ptr %.sroa.6100.0..sroa_idx, align 8
  %.sroa.7101.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.a, i64 32
  store i64 0, ptr %.sroa.7101.0..sroa_idx, align 8
  %.sroa.9103.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.a, i64 56
  store <4 x i16> <i16 1, i16 -10000, i16 1, i16 0>, ptr %.sroa.9103.0..sroa_idx, align 8
  %.sroa.13107.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.a, i64 64
  store i8 1, ptr %.sroa.13107.0..sroa_idx, align 8
  call void @_ZN18lindera_dictionary18dictionary_builder15user_dictionary28UserDictionaryBuilderOptions30simple_userdic_details_handler17h0500a143217f2492E(ptr noalias noundef nonnull sret([72 x i8]) align 8 captures(address) dereferenceable(72) %i.b, ptr noalias noundef nonnull readonly align 8 captures(address) dereferenceable(72) %i.a, ptr noundef nonnull align 1 inttoptr (i64 1 to ptr), ptr nonnull @64)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a)
  %i.d = load i64, ptr %i.b, align 8, !range !66, !alias.scope !1162, !noalias !1165, !noundef !6
  %i.e = trunc nuw i64 %i.d to i1
  %i.f = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %i.g = load i64, ptr %i.f, align 8, !alias.scope !1162, !noalias !1165
  %.sroa.01.0.i = select i1 %i.e, i64 %i.g, i64 3
  %i.h = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  %i.i = load i64, ptr %i.h, align 8, !range !66, !alias.scope !1162, !noalias !1165, !noundef !6
  %i.j = trunc nuw i64 %i.i to i1
  %i.k = getelementptr inbounds nuw i8, ptr %i.b, i64 24
  %i.l = load i64, ptr %i.k, align 8, !alias.scope !1162, !noalias !1165
  %.sroa.02.0.i = select i1 %i.j, i64 %i.l, i64 4
  %i.m = getelementptr inbounds nuw i8, ptr %i.b, i64 56
  %i.n = load i16, ptr %i.m, align 8, !range !256, !alias.scope !1162, !noalias !1165, !noundef !6
  %i.o = trunc nuw i16 %i.n to i1
  %i.p = getelementptr inbounds nuw i8, ptr %i.b, i64 58
  %i.q = load i16, ptr %i.p, align 2, !alias.scope !1162, !noalias !1165
  %.sroa.03.0.i = select i1 %i.o, i16 %i.q, i16 -10000
  %i.r = getelementptr inbounds nuw i8, ptr %i.b, i64 60
  %i.s = load i16, ptr %i.r, align 4, !range !256, !alias.scope !1162, !noalias !1165, !noundef !6
  %i.t = trunc nuw i16 %i.s to i1
  %i.u = getelementptr inbounds nuw i8, ptr %i.b, i64 62
  %i.v = load i16, ptr %i.u, align 2, !alias.scope !1162, !noalias !1165
  %.sroa.04.0.i = select i1 %i.t, i16 %i.v, i16 0
  %i.w = getelementptr inbounds nuw i8, ptr %i.b, i64 64
  %i.x = load i8, ptr %i.w, align 8, !range !257, !alias.scope !1162, !noalias !1165, !noundef !6 ; 2 uses
  %.not.i = icmp eq i8 %i.x, 2
  %.sroa.05.0.i = select i1 %.not.i, i8 1, i8 %i.x
  %i.y = getelementptr inbounds nuw i8, ptr %i.b, i64 32
  %i.z = load i64, ptr %i.y, align 8, !range !66, !alias.scope !1162, !noalias !1165, !noundef !6
  %i.aa = trunc nuw i64 %i.z to i1                ; 2 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %i.b, i64 40
  %i.ac = load ptr, ptr %i.ab, align 8, !alias.scope !1162, !noalias !1165, !align !44 ; 2 uses
  %i.ad = getelementptr inbounds nuw i8, ptr %i.b, i64 48
  %i.ae = load ptr, ptr %i.ad, align 8, !alias.scope !1162, !noalias !1165
  %.sroa.57.0.i = select i1 %i.aa, ptr %i.ae, ptr undef ; 8 uses
  %.sroa.06.0.i = select i1 %i.aa, ptr %i.ac, ptr null ; 5 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b)
  store i64 %.sroa.01.0.i, ptr %i.c, align 8, !alias.scope !1167, !noalias !1171
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.c, i64 8
  store i64 %.sroa.02.0.i, ptr %.sroa.5.0..sroa_idx, align 8, !alias.scope !1167, !noalias !1171
  %.sroa.6.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.c, i64 16
  store ptr %.sroa.06.0.i, ptr %.sroa.6.0..sroa_idx, align 8, !alias.scope !1167, !noalias !1171
  %.sroa.7.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.c, i64 24
  store ptr %.sroa.57.0.i, ptr %.sroa.7.0..sroa_idx, align 8, !alias.scope !1167, !noalias !1171
  %.sroa.8.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.c, i64 32
  store i16 %.sroa.03.0.i, ptr %.sroa.8.0..sroa_idx, align 8, !alias.scope !1167, !noalias !1171
  %.sroa.9.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.c, i64 34
  store i16 %.sroa.04.0.i, ptr %.sroa.9.0..sroa_idx, align 2, !alias.scope !1167, !noalias !1171
  %.sroa.10.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.c, i64 36
  store i8 %.sroa.05.0.i, ptr %.sroa.10.0..sroa_idx, align 4, !alias.scope !1167, !noalias !1171
  invoke void @_ZN18lindera_dictionary18dictionary_builder15user_dictionary21UserDictionaryBuilder5build17h0c4c5c9a5cf6970fE(ptr noalias noundef nonnull sret([104 x i8]) align 8 captures(address) dereferenceable(104) %0, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %i.c, ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %2, i64 noundef %3)
          to label %bb.b unwind label %bb.a

bb.a:                                             ; preds = %"_ZN4core6result19Result$LT$T$C$E$GT$6unwrap17h9cd4b36396336e1dE.exit"
  %i.af = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @"_ZN4core3ptr99drop_in_place$LT$lindera_dictionary..dictionary_builder..user_dictionary..UserDictionaryBuilder$GT$17h2eefa44c0dd434e4E"(ptr %.sroa.06.0.i, ptr %.sroa.57.0.i) #48
          to label %common.resume unwind label %bb.g

bb.b:                                             ; preds = %"_ZN4core6result19Result$LT$T$C$E$GT$6unwrap17h9cd4b36396336e1dE.exit"
end_hunk_0
...
end_hunk_1
begin_hunk_2_@_ZN18lindera_dictionary4util9read_file17ha263f8fc88fb9c1bE:bb.a
...
end_hunk_2
begin_hunk_3_@_ZN3csv11byte_record10ByteRecord15clone_truncated17hf7751234a95e422bE:bb.a
