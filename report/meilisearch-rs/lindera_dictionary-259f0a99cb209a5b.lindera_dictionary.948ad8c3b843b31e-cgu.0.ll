...
.lr.ph7.i.i.preheader:                            ; preds = %._crit_edge.i.i
  ...
  %xtraiter3097 = and i64 %i.aj, 7                ; 2 uses
  %lcmp.mod3098.not = icmp eq i64 %xtraiter3097, 0
  br i1 %lcmp.mod3098.not, label %.lr.ph7.i.i.prol.loopexit, label %.lr.ph7.i.i.prol
...
.lr.ph7.i.i.prol:                                 ; preds = %.lr.ph7.i.i.preheader, %.lr.ph7.i.i.prol
  ...
  %prol.iter3099 = phi i64 [ %prol.iter3099.next, %.lr.ph7.i.i.prol ], [ 0, %.lr.ph7.i.i.preheader ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load117 = load <4 x i32>, ptr %i.ai, align 4, !alias.scope !9308, !noalias !9311
  %i.aj = getelementptr i8, ptr %i.ah, i64 -12    ; 2 uses
  %i.ak = getelementptr i8, ptr %i.ah, i64 -28    ; 2 uses
  %wide.load118 = load <4 x i32>, ptr %i.aj, align 4, !alias.scope !9312, !noalias !9313
  %wide.load119 = load <4 x i32>, ptr %i.ak, align 4, !alias.scope !9312, !noalias !9313
  ...
  store <4 x i32> %reverse120, ptr %i.ai, align 4, !alias.scope !9308, !noalias !9311
  ...
  store <4 x i32> %reverse121, ptr %i.aj, align 4, !alias.scope !9312, !noalias !9313
  store <4 x i32> %reverse122, ptr %i.ak, align 4, !alias.scope !9312, !noalias !9313
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %exitcond.not.i.i, label %"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$7reverse17h8b9b509eef5ee7daE.exit", label %scalar.ph, !llvm.loop !9315
...
bb.n:                                             ; preds = %bb.g
  ...
  tail call void @_ZN4core5slice4sort6stable9quicksort9quicksort17h7ddf27d5d9d76b2fE(ptr noalias noundef nonnull align 8 %i.m, i64 noundef %.sroa.0.0.i39, ptr noalias noundef nonnull align 8 %2, i64 noundef %3, i32 noundef 0, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable_or_null(8) null, ptr noalias noundef nonnull align 8 dereferenceable(8) %5), !inline_history !9355
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load374 = load <2 x ptr>, ptr %i.ai, align 8, !alias.scope !9361, !noalias !9364
  %i.aj = getelementptr i8, ptr %i.ah, i64 -8
  %i.ak = getelementptr i8, ptr %i.ah, i64 -24
  %wide.load375 = load <2 x i64>, ptr %i.aj, align 8, !alias.scope !9365, !noalias !9366
  %wide.load376 = load <2 x i64>, ptr %i.ak, align 8, !alias.scope !9365, !noalias !9366
  ...
  store <2 x i64> %reverse377, ptr %i.al, align 8, !alias.scope !9361, !noalias !9364
  ...
  store <2 x ptr> %reverse378, ptr %i.am, align 8, !alias.scope !9365, !noalias !9366
  store <2 x ptr> %reverse379, ptr %i.an, align 8, !alias.scope !9365, !noalias !9366
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %exitcond.not.i.i, label %"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$7reverse17he79e7530934b1227E.exit", label %scalar.ph, !llvm.loop !9368
...
begin_hunk_9_@_ZN4core5slice4sort6stable5drift4sort17h2eaa57a4a6b23babE:bb.a
  ...
  %i.dt = tail call i32 @memcmp(ptr nonnull %i.dc, ptr nonnull %i.dr, i64 %..i.i51), !noalias !9375 ; 2 uses
...
.noexc21.i:                                       ; preds = %bb.ae
  ...
  %i.fg = tail call i32 @memcmp(ptr nonnull %i.ep, ptr nonnull %i.fe, i64 %..i.i41), !noalias !9375 ; 2 uses
...
bb.n:                                             ; preds = %bb.g
  %.sroa.0.0.i39 = tail call noundef i64 @llvm.umin.i64(i64 %i.l, i64 32) ; 2 uses
  tail call void @_ZN4core5slice4sort6stable9quicksort9quicksort17h73bbf79b86abfb69E(ptr noalias noundef nonnull align 8 %i.m, i64 noundef %.sroa.0.0.i39, ptr noalias noundef nonnull align 8 %2, i64 noundef %3, i32 noundef 0, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable_or_null(8) null, ptr noalias noundef nonnull align 8 dereferenceable(8) %5), !inline_history !9427
  %i.y = shl nuw nsw i64 %.sroa.0.0.i39, 1
  %i.z = or disjoint i64 %i.y, 1
  br label %_ZN4core5slice4sort6stable5drift10create_run17h0749cf3a7902462aE.exit
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load150 = load <2 x ptr>, ptr %i.ai, align 8, !alias.scope !9433, !noalias !9436
  %i.aj = getelementptr i8, ptr %i.ah, i64 -8
  %i.ak = getelementptr i8, ptr %i.ah, i64 -24
  %wide.load151 = load <2 x i64>, ptr %i.aj, align 8, !alias.scope !9437, !noalias !9438
  %wide.load152 = load <2 x i64>, ptr %i.ak, align 8, !alias.scope !9437, !noalias !9438
  ...
  store <2 x i64> %reverse153, ptr %i.al, align 8, !alias.scope !9433, !noalias !9436
  %i.am = getelementptr i8, ptr %i.ah, i64 -8
  %i.an = getelementptr i8, ptr %i.ah, i64 -24
  ...
  store <2 x ptr> %reverse154, ptr %i.am, align 8, !alias.scope !9437, !noalias !9438
  store <2 x ptr> %reverse155, ptr %i.an, align 8, !alias.scope !9437, !noalias !9438
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ao = icmp eq i64 %index.next, %n.vec
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.au = add nuw nsw i64 %.sroa.0.014.i.i, 1     ; 2 uses
  %exitcond.not.i.i = icmp eq i64 %i.au, %i.ad
  br i1 %exitcond.not.i.i, label %"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$7reverse17he79e7530934b1227E.exit", label %scalar.ph, !llvm.loop !9440
...
bb.n:                                             ; preds = %bb.g
  %.sroa.0.0.i39 = tail call noundef i64 @llvm.umin.i64(i64 %i.l, i64 32) ; 2 uses
  tail call void @_ZN4core5slice4sort6stable9quicksort9quicksort17h8f22d88c1dd45868E(ptr noalias noundef nonnull align 8 %i.m, i64 noundef %.sroa.0.0.i39, ptr noalias noundef nonnull align 8 %2, i64 noundef %3, i32 noundef 0, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable_or_null(8) null, ptr noalias noundef nonnull align 8 dereferenceable(8) %5), !inline_history !9475
  %i.y = shl nuw nsw i64 %.sroa.0.0.i39, 1
  %i.z = or disjoint i64 %i.y, 1
  br label %_ZN4core5slice4sort6stable5drift10create_run17he0116fa2f8489170E.exit
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load150 = load <2 x ptr>, ptr %i.ai, align 8, !alias.scope !9481, !noalias !9484
  %i.aj = getelementptr i8, ptr %i.ah, i64 -8
  %i.ak = getelementptr i8, ptr %i.ah, i64 -24
  %wide.load151 = load <2 x i64>, ptr %i.aj, align 8, !alias.scope !9485, !noalias !9486
  %wide.load152 = load <2 x i64>, ptr %i.ak, align 8, !alias.scope !9485, !noalias !9486
  %reverse = shufflevector <2 x i64> %wide.load151, <2 x i64> poison, <2 x i32> <i32 1, i32 0>
  %reverse153 = shufflevector <2 x i64> %wide.load152, <2 x i64> poison, <2 x i32> <i32 1, i32 0>
  %i.al = getelementptr inbounds nuw i8, ptr %i.ag, i64 16
  store <2 x i64> %reverse, ptr %i.ag, align 8, !alias.scope !9481, !noalias !9484
  store <2 x i64> %reverse153, ptr %i.al, align 8, !alias.scope !9481, !noalias !9484
  %i.am = getelementptr i8, ptr %i.ah, i64 -8
  %i.an = getelementptr i8, ptr %i.ah, i64 -24
  %reverse154 = shufflevector <2 x ptr> %wide.load, <2 x ptr> poison, <2 x i32> <i32 1, i32 0>
  %reverse155 = shufflevector <2 x ptr> %wide.load150, <2 x ptr> poison, <2 x i32> <i32 1, i32 0>
  store <2 x ptr> %reverse154, ptr %i.am, align 8, !alias.scope !9485, !noalias !9486
  store <2 x ptr> %reverse155, ptr %i.an, align 8, !alias.scope !9485, !noalias !9486
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ao = icmp eq i64 %index.next, %n.vec
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.au = add nuw nsw i64 %.sroa.0.014.i.i, 1     ; 2 uses
  %exitcond.not.i.i = icmp eq i64 %i.au, %i.ad
  br i1 %exitcond.not.i.i, label %"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$7reverse17he79e7530934b1227E.exit", label %scalar.ph, !llvm.loop !9488
