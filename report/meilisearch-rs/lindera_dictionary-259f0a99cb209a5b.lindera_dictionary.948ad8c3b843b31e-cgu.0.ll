...
.loopexit.split-lp.loopexit.split-lp.i:           ; preds = %.invoke1818
  %lpad.loopexit.split-lp202.i = landingpad { ptr, i32 }
          cleanup
  br label %.loopexit.split-lp.i

.loopexit.split-lp.i:                             ; preds = %.loopexit.split-lp.loopexit.split-lp.i, %.loopexit.split-lp.loopexit.i, %.loopexit.i
  %lpad.phi.i = phi { ptr, i32 } [ %lpad.loopexit.i, %.loopexit.i ], [ %lpad.loopexit201.i, %.loopexit.split-lp.loopexit.i ], [ %lpad.loopexit.split-lp202.i, %.loopexit.split-lp.loopexit.split-lp.i ] ; 2 uses
  %.val.pre.i.i.i.i.i.i = load i64, ptr %i.w, align 8, !noalias !5240 ; 2 uses
  %i.ux = icmp eq i64 %.val.pre.i.i.i.i.i.i, 0
  br i1 %i.ux, label %.body.i.i, label %._crit_edge.i.i.i.i.i

._crit_edge.i.i.i.i.i:                            ; preds = %.loopexit.split-lp.i
  %.val9.i.pre.i.i.i.i.i = load ptr, ptr %.sroa.4.0..sroa_idx.i.i.i.i63.i.i, align 8, !noalias !5240
  %i.uy = shl nuw i64 %.val.pre.i.i.i.i.i.i, 4
  br label %bb.dm

bb.dm:                                            ; preds = %._crit_edge.i.i.i.i.i, %.thread.i.i.i.i.i.i
  %.val9.i.i.i.i65.i.i = phi ptr [ %i.qg, %.thread.i.i.i.i.i.i ], [ %.val9.i.pre.i.i.i.i.i, %._crit_edge.i.i.i.i.i ]
  %lpad.phi9.i.i.i.i.i.i = phi { ptr, i32 } [ %lpad.loopexit.split-lp.i.i.i.i.i.i, %.thread.i.i.i.i.i.i ], [ %lpad.phi.i, %._crit_edge.i.i.i.i.i ]
  %.val8.i.i.i.i.i.i = phi i64 [ 64, %.thread.i.i.i.i.i.i ], [ %i.uy, %._crit_edge.i.i.i.i.i ]
  call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val9.i.i.i.i65.i.i, i64 noundef %.val8.i.i.i.i.i.i, i64 noundef range(i64 1, -9223372036854775807) 8) #47, !noalias !5252
  br label %.body.i.i

.loopexit.i.i:                                    ; preds = %bb.dk, %"_ZN80_$LT$core..str..pattern..StrSearcher$u20$as$u20$core..str..pattern..Searcher$GT$10next_match17hb2017821d4657afdE.exit.i.i.thread179.i", %bb.ck
  %.sroa.094.0.copyload.pre.i.i = load i64, ptr %i.w, align 8, !noalias !5305 ; 7 uses
  %.sroa.895.0.copyload.pre.i.i = load ptr, ptr %.sroa.4.0..sroa_idx.i.i.i.i63.i.i, align 8, !noalias !5305 ; 11 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.v), !noalias !5240
  call void @llvm.lifetime.end.p0(ptr nonnull %i.w), !noalias !5240
  call void @llvm.lifetime.end.p0(ptr nonnull %i.x), !noalias !5228
  switch i64 %i.qw, label %.loopexit845.i [
    i64 1, label %bb.dn
    i64 2, label %bb.du
  ]

.loopexit845.i:                                   ; preds = %.loopexit.i.i, %.thread.i112.i
  %.sroa.094.0169.i.i = phi i64 [ 0, %.thread.i112.i ], [ %.sroa.094.0.copyload.pre.i.i, %.loopexit.i.i ] ; 2 uses
  %.sroa.895.0164.i.i = phi ptr [ inttoptr (i64 8 to ptr), %.thread.i112.i ], [ %.sroa.895.0.copyload.pre.i.i, %.loopexit.i.i ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.ac), !noalias !5153
  store ptr %i.ah, ptr %i.ac, align 8, !noalias !5153
  store ptr @"_ZN44_$LT$$RF$T$u20$as$u20$core..fmt..Display$GT$3fmt17h723775f099bd1798E", ptr %.sroa.435.0..sroa_idx.i.i, align 8, !noalias !5153
  call void @llvm.lifetime.start.p0(ptr nonnull %i.u), !noalias !5306
  store ptr @200, ptr %i.u, align 8, !noalias !5314
  store i64 1, ptr %.sroa.4108.0..sroa_idx.i.i, align 8, !noalias !5314
  store ptr %i.ac, ptr %.sroa.5109.0..sroa_idx.i.i, align 8, !noalias !5314
  store i64 1, ptr %.sroa.6110.0..sroa_idx.i.i, align 8, !noalias !5314
  store ptr null, ptr %.sroa.7111.0..sroa_idx.i.i, align 8, !noalias !5314
  invoke void @_ZN5alloc3fmt6format12format_inner17hce37e7516f243f46E(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(address) dereferenceable(24) %i.ad, ptr noalias noundef nonnull readonly align 8 captures(address) dereferenceable(48) %i.u)
          to label %bb.ek unwind label %.loopexit228.loopexit.split-lp.i, !noalias !5150

bb.dn:                                            ; preds = %.loopexit.i.i, %.loopexit.thread.i.i
  %.sroa.094.0.copyload200.i.i = phi i64 [ 4, %.loopexit.thread.i.i ], [ %.sroa.094.0.copyload.pre.i.i, %.loopexit.i.i ] ; 3 uses
  %.sroa.895.0.copyload198.i.i = phi ptr [ %i.qg, %.loopexit.thread.i.i ], [ %.sroa.895.0.copyload.pre.i.i, %.loopexit.i.i ] ; 5 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.ag), !noalias !5153
  %i.uz = load ptr, ptr %.sroa.895.0.copyload198.i.i, align 8, !noalias !5150, !nonnull !6, !align !44, !noundef !6
  %i.va = getelementptr inbounds nuw i8, ptr %.sroa.895.0.copyload198.i.i, i64 8
  %i.vb = load i64, ptr %i.va, align 8, !noalias !5150, !noundef !6
  invoke fastcc void @_ZN18lindera_dictionary18dictionary_builder20character_definition19parse_hex_codepoint17hdaa298bad32d966eE(ptr noalias noundef align 8 captures(address) dereferenceable(16) %i.ag, ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %i.uz, i64 noundef %i.vb)
          to label %bb.dp unwind label %.loopexit228.loopexit.i, !noalias !5150

.loopexit228.loopexit.i:                          ; preds = %bb.dx, %bb.du, %bb.dn
  %.sroa.094.0172.i.ph.ph.i = phi i64 [ %.sroa.094.0.copyload200.i.i, %bb.dn ], [ %.sroa.094.0.copyload.pre.i.i, %bb.du ], [ %.sroa.094.0.copyload.pre.i.i, %bb.dx ]
  %.sroa.895.0167.i.ph.ph.i = phi ptr [ %.sroa.895.0.copyload198.i.i, %bb.dn ], [ %.sroa.895.0.copyload.pre.i.i, %bb.du ], [ %.sroa.895.0.copyload.pre.i.i, %bb.dx ]
  %lpad.loopexit846.i = landingpad { ptr, i32 }
          cleanup
  br label %.body82.i.i

.loopexit228.loopexit.split-lp.i:                 ; preds = %bb.ek, %.loopexit845.i
  %lpad.loopexit.split-lp847.i = landingpad { ptr, i32 }
          cleanup
  br label %.body82.i.i

.loopexit.split-lp229.i:                          ; preds = %bb.ed
  %lpad.loopexit.split-lp231.i = landingpad { ptr, i32 }
          cleanup
  br label %.body82.i.i

.body82.i.i:                                      ; preds = %bb.eh, %bb.eg, %.body.i.i.i.i.i.i, %.loopexit.split-lp229.i, %.loopexit228.loopexit.split-lp.i, %.loopexit228.loopexit.i
  %.sroa.094.0170.i.i = phi i64 [ %.sroa.094.0.copyload199.i.i, %.body.i.i.i.i.i.i ], [ %.sroa.094.0.copyload199.i.i, %bb.eg ], [ %.sroa.094.0.copyload199.i.i, %bb.eh ], [ %.sroa.094.0.copyload199.i.i, %.loopexit.split-lp229.i ], [ %.sroa.094.0172.i.ph.ph.i, %.loopexit228.loopexit.i ], [ %.sroa.094.0169.i.i, %.loopexit228.loopexit.split-lp.i ] ; 2 uses
  %.sroa.895.0165.i.i = phi ptr [ %.sroa.895.0.copyload197.i.i, %.body.i.i.i.i.i.i ], [ %.sroa.895.0.copyload197.i.i, %bb.eg ], [ %.sroa.895.0.copyload197.i.i, %bb.eh ], [ %.sroa.895.0.copyload197.i.i, %.loopexit.split-lp229.i ], [ %.sroa.895.0167.i.ph.ph.i, %.loopexit228.loopexit.i ], [ %.sroa.895.0164.i.i, %.loopexit228.loopexit.split-lp.i ] ; 2 uses
  %eh.lpad-body83.i.i = phi { ptr, i32 } [ %i.wi, %.body.i.i.i.i.i.i ], [ %i.wm, %bb.eg ], [ %i.wm, %bb.eh ], [ %lpad.loopexit.split-lp231.i, %.loopexit.split-lp229.i ], [ %lpad.loopexit846.i, %.loopexit228.loopexit.i ], [ %lpad.loopexit.split-lp847.i, %.loopexit228.loopexit.split-lp.i ] ; 2 uses
  %i.vc = icmp eq i64 %.sroa.094.0170.i.i, 0
  br i1 %i.vc, label %.body.i.i, label %bb.do

bb.do:                                            ; preds = %.body82.i.i
  %i.vd = shl nuw i64 %.sroa.094.0170.i.i, 4
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.895.0165.i.i) ]
  call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.sroa.895.0165.i.i, i64 noundef %i.vd, i64 noundef range(i64 1, -9223372036854775807) 8) #47
  br label %.body.i.i

bb.dp:                                            ; preds = %bb.dn
  %i.ve = load i8, ptr %i.cy, align 8, !range !5315, !noalias !5153, !noundef !6 ; 2 uses
  %.not48.i.i = icmp eq i8 %i.ve, 16
  br i1 %.not48.i.i, label %bb.dr, label %bb.dq

bb.dq:                                            ; preds = %bb.dp
  %i.vf = load ptr, ptr %i.ag, align 8, !noalias !5153, !nonnull !6, !noundef !6
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ag), !noalias !5153
  br label %bb.ds

bb.dr:                                            ; preds = %bb.dp
  %i.vg = load i32, ptr %i.ag, align 8, !noalias !5153, !noundef !6 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ag), !noalias !5153
  br label %bb.eb

bb.ds:                                            ; preds = %bb.ek, %bb.dz, %bb.dw, %bb.dq
  %.sroa.094.0168.i.i = phi i64 [ %.sroa.094.0.copyload.pre.i.i, %bb.dz ], [ %.sroa.094.0.copyload200.i.i, %bb.dq ], [ %.sroa.094.0.copyload.pre.i.i, %bb.dw ], [ %.sroa.094.0169.i.i, %bb.ek ] ; 2 uses
  %.sroa.895.0163.i.i = phi ptr [ %.sroa.895.0.copyload.pre.i.i, %bb.dz ], [ %.sroa.895.0.copyload198.i.i, %bb.dq ], [ %.sroa.895.0.copyload.pre.i.i, %bb.dw ], [ %.sroa.895.0164.i.i, %bb.ek ] ; 2 uses
  %.sroa.6.0.i107.i = phi i8 [ %i.vt, %bb.dz ], [ %i.ve, %bb.dq ], [ %i.vm, %bb.dw ], [ 1, %bb.ek ]
  %.sroa.0.0.i108.i = phi ptr [ %i.vu, %bb.dz ], [ %i.vf, %bb.dq ], [ %i.vn, %bb.dw ], [ %i.ww, %bb.ek ]
  %i.vh = icmp eq i64 %.sroa.094.0168.i.i, 0
  br i1 %i.vh, label %"_ZN4core3ptr51drop_in_place$LT$alloc..vec..Vec$LT$$RF$str$GT$$GT$17h818ca1b63095d917E.exit78.i.i", label %bb.dt

bb.dt:                                            ; preds = %bb.ds
  %i.vi = shl nuw i64 %.sroa.094.0168.i.i, 4
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.895.0163.i.i) ]
  call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.sroa.895.0163.i.i, i64 noundef %i.vi, i64 noundef range(i64 1, -9223372036854775807) 8) #47, !noalias !5150
  br label %"_ZN4core3ptr51drop_in_place$LT$alloc..vec..Vec$LT$$RF$str$GT$$GT$17h818ca1b63095d917E.exit78.i.i"

bb.du:                                            ; preds = %.loopexit.i.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.af), !noalias !5153
  %i.vj = load ptr, ptr %.sroa.895.0.copyload.pre.i.i, align 8, !noalias !5150, !nonnull !6, !align !44, !noundef !6
  %i.vk = getelementptr inbounds nuw i8, ptr %.sroa.895.0.copyload.pre.i.i, i64 8
  %i.vl = load i64, ptr %i.vk, align 8, !noalias !5150, !noundef !6
  invoke fastcc void @_ZN18lindera_dictionary18dictionary_builder20character_definition19parse_hex_codepoint17hdaa298bad32d966eE(ptr noalias noundef align 8 captures(address) dereferenceable(16) %i.af, ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %i.vj, i64 noundef %i.vl)
          to label %bb.dv unwind label %.loopexit228.loopexit.i, !noalias !5150

bb.dv:                                            ; preds = %bb.du
  %i.vm = load i8, ptr %i.cw, align 8, !range !5315, !noalias !5153, !noundef !6 ; 2 uses
  %.not45.i.i = icmp eq i8 %i.vm, 16
  br i1 %.not45.i.i, label %bb.dx, label %bb.dw

bb.dw:                                            ; preds = %bb.dv
  %i.vn = load ptr, ptr %i.af, align 8, !noalias !5153, !nonnull !6, !noundef !6
  call void @llvm.lifetime.end.p0(ptr nonnull %i.af), !noalias !5153
  br label %bb.ds

bb.dx:                                            ; preds = %bb.dv
  %i.vo = load i32, ptr %i.af, align 8, !noalias !5153, !noundef !6
  call void @llvm.lifetime.end.p0(ptr nonnull %i.af), !noalias !5153
  call void @llvm.lifetime.start.p0(ptr nonnull %i.ae), !noalias !5153
  %i.vp = getelementptr inbounds nuw i8, ptr %.sroa.895.0.copyload.pre.i.i, i64 16
  %i.vq = load ptr, ptr %i.vp, align 8, !noalias !5150, !nonnull !6, !align !44, !noundef !6
  %i.vr = getelementptr inbounds nuw i8, ptr %.sroa.895.0.copyload.pre.i.i, i64 24
  %i.vs = load i64, ptr %i.vr, align 8, !noalias !5150, !noundef !6
  invoke fastcc void @_ZN18lindera_dictionary18dictionary_builder20character_definition19parse_hex_codepoint17hdaa298bad32d966eE(ptr noalias noundef align 8 captures(address) dereferenceable(16) %i.ae, ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %i.vq, i64 noundef %i.vs)
          to label %bb.dy unwind label %.loopexit228.loopexit.i, !noalias !5150

bb.dy:                                            ; preds = %bb.dx
  %i.vt = load i8, ptr %i.cx, align 8, !range !5315, !noalias !5153, !noundef !6 ; 2 uses
  %.not46.i.i = icmp eq i8 %i.vt, 16
  br i1 %.not46.i.i, label %bb.ea, label %bb.dz

bb.dz:                                            ; preds = %bb.dy
  %i.vu = load ptr, ptr %i.ae, align 8, !noalias !5153, !nonnull !6, !noundef !6
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ae), !noalias !5153
  br label %bb.ds

bb.ea:                                            ; preds = %bb.dy
  %i.vv = load i32, ptr %i.ae, align 8, !noalias !5153, !noundef !6
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ae), !noalias !5153
  br label %bb.eb

bb.eb:                                            ; preds = %bb.ea, %bb.dr
  %.sroa.094.0.copyload199.i.i = phi i64 [ %.sroa.094.0.copyload200.i.i, %bb.dr ], [ %.sroa.094.0.copyload.pre.i.i, %bb.ea ] ; 6 uses
  %.sroa.895.0.copyload197.i.i = phi ptr [ %.sroa.895.0.copyload198.i.i, %bb.dr ], [ %.sroa.895.0.copyload.pre.i.i, %bb.ea ] ; 5 uses
  %.sroa.03.0.i111.i = phi i32 [ %i.vg, %bb.dr ], [ %i.vv, %bb.ea ]
  %.sroa.01.0.i.i = phi i32 [ %i.vg, %bb.dr ], [ %i.vo, %bb.ea ]
  %i.vw = getelementptr inbounds nuw i8, ptr %.sroa.8.0.copyload155.i.i, i64 16
  %gepdiff.i.i = add i64 %.sroa.14.0.copyload149.i.i, -16 ; 2 uses
  %i.vx = lshr exact i64 %gepdiff.i.i, 4          ; 2 uses
  %i.vy = lshr exact i64 %gepdiff.i.i, 1          ; 3 uses
  %i.vz = icmp eq i64 %.sroa.14.0.copyload149.i.i, 16
  br i1 %i.vz, label %_ZN4core4iter6traits8iterator8Iterator7collect17h587556dc9458ff9eE.exit.i.i, label %bb.ec

bb.ec:                                            ; preds = %bb.eb
  call void @_RNvCskdKJRKLKjqM_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #47, !noalias !5316
  %i.wa = call noundef align 8 ptr @_RNvCskdKJRKLKjqM_7___rustc12___rust_alloc(i64 noundef %i.vy, i64 noundef range(i64 1, 9) 8) #47, !noalias !5316 ; 4 uses
  %i.wb = icmp eq ptr %i.wa, null
  br i1 %i.wb, label %bb.ed, label %.preheader.i.i.i.i.i.i.i.i

bb.ed:                                            ; preds = %bb.ec
  invoke void @_ZN5alloc7raw_vec12handle_error17h5794e6eba25188a7E(i64 noundef 8, i64 %i.vy, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) @315) #46
          to label %.noexc81.i.i unwind label %.loopexit.split-lp229.i, !noalias !5150

.noexc81.i.i:                                     ; preds = %bb.ed
  unreachable

.preheader.i.i.i.i.i.i.i.i:                       ; preds = %bb.ec, %bb.ee
  %.val20.i.i.i.i.i.i.i.i.i.i.i = phi i64 [ %i.wg, %bb.ee ], [ 0, %bb.ec ] ; 3 uses
  %i.wc = getelementptr inbounds nuw [16 x i8], ptr %i.vw, i64 %.val20.i.i.i.i.i.i.i.i.i.i.i ; 2 uses
  %.val21.i.i.i.i.i.i.i.i.i.i.i = load ptr, ptr %i.wc, align 8, !noalias !5333, !nonnull !6, !align !44, !noundef !6
  %i.wd = getelementptr i8, ptr %i.wc, i64 8
  %.val22.i.i.i.i.i.i.i.i.i.i.i = load i64, ptr %i.wd, align 8, !noalias !5333, !noundef !6
  %i.we = invoke noundef i64 @_ZN18lindera_dictionary18dictionary_builder20character_definition26CharacterDefinitionBuilder11category_id17had50c71a38f65706E(ptr noalias noundef nonnull align 8 dereferenceable(128) %1, ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %.val21.i.i.i.i.i.i.i.i.i.i.i, i64 noundef %.val22.i.i.i.i.i.i.i.i.i.i.i)
          to label %bb.ee unwind label %.body.i.i.i.i.i.i, !noalias !5333
...
.body.i.i.i.i.i.i:                                ; preds = %.preheader.i.i.i.i.i.i.i.i
  %i.wi = landingpad { ptr, i32 }
          cleanup
  call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %i.wa, i64 noundef %i.vy, i64 noundef range(i64 1, -9223372036854775807) 8) #47, !noalias !5355
  br label %.body82.i.i

_ZN4core4iter6traits8iterator8Iterator7collect17h587556dc9458ff9eE.exit.i.i: ; preds = %bb.ee, %bb.eb
  %.sroa.4.0.i13.i.i.i.i.i.i = phi i64 [ 0, %bb.eb ], [ %i.vx, %bb.ee ] ; 4 uses
  %.sroa.10.0.i12.i.i.i.i.i.i = phi ptr [ inttoptr (i64 8 to ptr), %bb.eb ], [ %i.wa, %bb.ee ] ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !5356)
  %i.wj = load i64, ptr %i.da, align 8, !alias.scope !5359, !noalias !5360, !noundef !6 ; 3 uses
  %i.wk = load i64, ptr %i.cz, align 8, !range !165, !alias.scope !5359, !noalias !5360, !noundef !6
  %i.wl = icmp eq i64 %i.wj, %i.wk
  br i1 %i.wl, label %bb.ef, label %bb.ei
...
.invoke:                                          ; preds = %bb.h, %bb.a
  %i.g = phi i64 [ 1, %bb.a ], [ %i.au, %bb.h ]
...
bb.d:                                             ; preds = %_ZN18lindera_dictionary7viterbi7Lattice4edge17hfc4be10caf523974E.exit, %bb.h
  %i.l = phi ptr [ inttoptr (i64 8 to ptr), %_ZN18lindera_dictionary7viterbi7Lattice4edge17hfc4be10caf523974E.exit ], [ %i.ar, %bb.h ] ; 5 uses
  %i.m = phi i64 [ 0, %_ZN18lindera_dictionary7viterbi7Lattice4edge17hfc4be10caf523974E.exit ], [ %i.at, %bb.h ] ; 9 uses
  %i.n = phi i64 [ 1, %_ZN18lindera_dictionary7viterbi7Lattice4edge17hfc4be10caf523974E.exit ], [ %i.au, %bb.h ]
...
.lr.ph.preheader.i.i:                             ; preds = %bb.g
  ...
  br i1 %i.ae, label %.lr.ph.i.i.epil.preheader, label %.lr.ph.preheader.i.i.new
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.preheader.i.i.new
  %.sroa.0.014.i.i = phi i64 [ 0, %.lr.ph.preheader.i.i.new ], [ %i.aq, %.lr.ph.i.i ] ; 5 uses
...
"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$7reverse17h065073bf2b8ac653E.exit.loopexit.unr-lcssa": ; preds = %.lr.ph.i.i
  %i.aw = and i64 %i.m, 2
  %lcmp.mod.not = icmp eq i64 %i.aw, 0
  br i1 %lcmp.mod.not, label %"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$7reverse17h065073bf2b8ac653E.exit", label %.lr.ph.i.i.epil.preheader

.lr.ph.i.i.epil.preheader:                        ; preds = %"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$7reverse17h065073bf2b8ac653E.exit.loopexit.unr-lcssa", %.lr.ph.preheader.i.i
...
end_hunk_1
begin_hunk_2_@"_ZN4core3ptr153drop_in_place$LT$std..collections..hash..map..HashMap$LT$alloc..string..String$C$lindera_dictionary..dictionary..character_definition..CategoryId$GT$$GT$17h3f53c845a31ee4a5E":bb.a
  %.val3.i.i.i.i.i.i = load <16 x i8>, ptr %i.g, align 16, !noalias !8477
  %i.h = icmp sgt <16 x i8> %.val3.i.i.i.i.i.i, splat (i8 -1)
  %i.i = getelementptr inbounds nuw i8, ptr %i.g, i64 16
  %i.j = bitcast <16 x i1> %i.h to i16
  br label %bb.d

bb.d:                                             ; preds = %"_ZN4core3ptr117drop_in_place$LT$$LP$alloc..string..String$C$lindera_dictionary..dictionary..character_definition..CategoryId$RP$$GT$17h4d6d18d44fc2fe63E.exit.i.i.i.i.i", %bb.c
  %.sroa.07.018.i.i.i.i.i = phi ptr [ %i.g, %bb.c ], [ %.sroa.07.1.i.i.i.i.i, %"_ZN4core3ptr117drop_in_place$LT$$LP$alloc..string..String$C$lindera_dictionary..dictionary..character_definition..CategoryId$RP$$GT$17h4d6d18d44fc2fe63E.exit.i.i.i.i.i" ] ; 2 uses
  %.sroa.6.017.i.i.i.i.i = phi ptr [ %i.i, %bb.c ], [ %.sroa.6.1.i.i.i.i.i, %"_ZN4core3ptr117drop_in_place$LT$$LP$alloc..string..String$C$lindera_dictionary..dictionary..character_definition..CategoryId$RP$$GT$17h4d6d18d44fc2fe63E.exit.i.i.i.i.i" ] ; 2 uses
  %.sroa.88.016.i.i.i.i.i = phi i16 [ %i.j, %bb.c ], [ %i.s, %"_ZN4core3ptr117drop_in_place$LT$$LP$alloc..string..String$C$lindera_dictionary..dictionary..character_definition..CategoryId$RP$$GT$17h4d6d18d44fc2fe63E.exit.i.i.i.i.i" ] ; 2 uses
  %.sroa.109.015.i.i.i.i.i = phi i64 [ %i.e, %bb.c ], [ %i.v, %"_ZN4core3ptr117drop_in_place$LT$$LP$alloc..string..String$C$lindera_dictionary..dictionary..character_definition..CategoryId$RP$$GT$17h4d6d18d44fc2fe63E.exit.i.i.i.i.i" ]
  %.not13.i.i.i.i.i.i = icmp eq i16 %.sroa.88.016.i.i.i.i.i, 0
  br i1 %.not13.i.i.i.i.i.i, label %.lr.ph.i.i.i.i.i.i, label %"_ZN9hashbrown3raw21RawIterRange$LT$T$GT$9next_impl17h92ca5b70514ab889E.exit.i.i.i.i.i"
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %bb.d, %.lr.ph.i.i.i.i.i.i
  ...
  %.val11.i.i.i.i.i.i = load <16 x i8>, ptr %i.k, align 16, !noalias !8480
  ...
  br i1 %.not.i.i.i.i.i.i, label %.lr.ph.i.i.i.i.i.i, label %"_ZN9hashbrown3raw21RawIterRange$LT$T$GT$9next_impl17h92ca5b70514ab889E.exit.i.i.i.i.i"

"_ZN9hashbrown3raw21RawIterRange$LT$T$GT$9next_impl17h92ca5b70514ab889E.exit.i.i.i.i.i": ; preds = %.lr.ph.i.i.i.i.i.i, %bb.d
  ...
  %.val.i.i.i.i.i = load i64, ptr %i.w, align 8, !alias.scope !8483, !noalias !8476 ; 2 uses
  %i.x = icmp eq i64 %.val.i.i.i.i.i, 0
  br i1 %i.x, label %"_ZN4core3ptr117drop_in_place$LT$$LP$alloc..string..String$C$lindera_dictionary..dictionary..character_definition..CategoryId$RP$$GT$17h4d6d18d44fc2fe63E.exit.i.i.i.i.i", label %bb.e

bb.e:                                             ; preds = %"_ZN9hashbrown3raw21RawIterRange$LT$T$GT$9next_impl17h92ca5b70514ab889E.exit.i.i.i.i.i"
  %i.y = getelementptr i8, ptr %i.u, i64 -24
  %.val6.i.i.i.i.i = load ptr, ptr %i.y, align 8, !noalias !8476, !nonnull !6, !noundef !6
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val6.i.i.i.i.i, i64 noundef %.val.i.i.i.i.i, i64 noundef range(i64 1, -9223372036854775807) 1) #47, !noalias !8486
  br label %"_ZN4core3ptr117drop_in_place$LT$$LP$alloc..string..String$C$lindera_dictionary..dictionary..character_definition..CategoryId$RP$$GT$17h4d6d18d44fc2fe63E.exit.i.i.i.i.i"

"_ZN4core3ptr117drop_in_place$LT$$LP$alloc..string..String$C$lindera_dictionary..dictionary..character_definition..CategoryId$RP$$GT$17h4d6d18d44fc2fe63E.exit.i.i.i.i.i": ; preds = %bb.e, %"_ZN9hashbrown3raw21RawIterRange$LT$T$GT$9next_impl17h92ca5b70514ab889E.exit.i.i.i.i.i"
  %i.z = icmp eq i64 %i.v, 0
  br i1 %i.z, label %_ZN9hashbrown3raw13RawTableInner13drop_elements17h40dcfb6dd7ec86a5E.exit.i.i.i.i, label %bb.d

_ZN9hashbrown3raw13RawTableInner13drop_elements17h40dcfb6dd7ec86a5E.exit.i.i.i.i: ; preds = %"_ZN4core3ptr117drop_in_place$LT$$LP$alloc..string..String$C$lindera_dictionary..dictionary..character_definition..CategoryId$RP$$GT$17h4d6d18d44fc2fe63E.exit.i.i.i.i.i", %bb.b
  ...
  br i1 %i.ag, label %"_ZN4core3ptr173drop_in_place$LT$hashbrown..map..HashMap$LT$alloc..string..String$C$lindera_dictionary..dictionary..character_definition..CategoryId$C$std..hash..random..RandomState$GT$$GT$17h6e50990a7beac59cE.exit", label %bb.f

bb.f:                                             ; preds = %_ZN9hashbrown3raw13RawTableInner13drop_elements17h40dcfb6dd7ec86a5E.exit.i.i.i.i
  %i.ah = load ptr, ptr %0, align 8, !alias.scope !8472, !nonnull !6, !noundef !6
  %i.ai = sub nuw nsw i64 -32, %i.aa
  %i.aj = getelementptr inbounds i8, ptr %i.ah, i64 %i.ai
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %i.aj, i64 noundef %i.ad, i64 noundef range(i64 1, -9223372036854775807) 16) #47, !noalias !8472
  br label %"_ZN4core3ptr173drop_in_place$LT$hashbrown..map..HashMap$LT$alloc..string..String$C$lindera_dictionary..dictionary..character_definition..CategoryId$C$std..hash..random..RandomState$GT$$GT$17h6e50990a7beac59cE.exit"

"_ZN4core3ptr173drop_in_place$LT$hashbrown..map..HashMap$LT$alloc..string..String$C$lindera_dictionary..dictionary..character_definition..CategoryId$C$std..hash..random..RandomState$GT$$GT$17h6e50990a7beac59cE.exit": ; preds = %bb.a, %_ZN9hashbrown3raw13RawTableInner13drop_elements17h40dcfb6dd7ec86a5E.exit.i.i.i.i, %bb.f
  ret void
}

; Function Attrs: nonlazybind uwtable
define internal fastcc void @"_ZN4core3ptr154drop_in_place$LT$alloc..collections..btree..map..BTreeMap$LT$alloc..string..String$C$alloc..vec..Vec$LT$lindera_dictionary..viterbi..WordEntry$GT$$GT$$GT$17h2bd0b5f0f27c1545E"(ptr noalias nofree noundef nonnull readonly align 8 captures(none) dereferenceable(24) %0) unnamed_addr #2 personality ptr @rust_eh_personality {
bb.a:
  %i.a = alloca [24 x i8], align 8                ; 9 uses
  %i.b = alloca [72 x i8], align 8                ; 13 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8489)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !8489
  %.sroa.0.0.copyload.i = load ptr, ptr %0, align 8, !alias.scope !8489 ; 3 uses
  %.not.i.i = icmp eq ptr %.sroa.0.0.copyload.i, null
  br i1 %.not.i.i, label %"_ZN119_$LT$alloc..collections..btree..map..BTreeMap$LT$K$C$V$C$A$GT$$u20$as$u20$core..iter..traits..collect..IntoIterator$GT$9into_iter17hda96e87042687b78E.exit.i", label %bb.b

bb.b:                                             ; preds = %bb.a
  %.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %0, i64 16
  %.sroa.5.0.copyload.i = load i64, ptr %.sroa.5.0..sroa_idx.i, align 8, !alias.scope !8489
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %0, i64 8
  %.sroa.4.0.copyload.i = load i64, ptr %.sroa.4.0..sroa_idx.i, align 8, !alias.scope !8489 ; 2 uses
  %.sroa.2.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  store ptr null, ptr %.sroa.2.0..sroa_idx.i.i, align 8, !alias.scope !8492, !noalias !8495
  %.sroa.2.sroa.2.0..sroa.2.0..sroa_idx.sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  store ptr %.sroa.0.0.copyload.i, ptr %.sroa.2.sroa.2.0..sroa.2.0..sroa_idx.sroa_idx.i.i, align 8, !alias.scope !8492, !noalias !8495
  %.sroa.2.sroa.3.0..sroa.2.0..sroa_idx.sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.b, i64 24
  store i64 %.sroa.4.0.copyload.i, ptr %.sroa.2.sroa.3.0..sroa.2.0..sroa_idx.sroa_idx.i.i, align 8, !alias.scope !8492, !noalias !8495
  %.sroa.4.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.b, i64 40
  store ptr null, ptr %.sroa.4.0..sroa_idx.i.i, align 8, !alias.scope !8492, !noalias !8495
  %.sroa.4.sroa.2.0..sroa.4.0..sroa_idx.sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.b, i64 48
  store ptr %.sroa.0.0.copyload.i, ptr %.sroa.4.sroa.2.0..sroa.4.0..sroa_idx.sroa_idx.i.i, align 8, !alias.scope !8492, !noalias !8495
  %.sroa.4.sroa.3.0..sroa.4.0..sroa_idx.sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.b, i64 56
  store i64 %.sroa.4.0.copyload.i, ptr %.sroa.4.sroa.3.0..sroa.4.0..sroa_idx.sroa_idx.i.i, align 8, !alias.scope !8492, !noalias !8495
  br label %"_ZN119_$LT$alloc..collections..btree..map..BTreeMap$LT$K$C$V$C$A$GT$$u20$as$u20$core..iter..traits..collect..IntoIterator$GT$9into_iter17hda96e87042687b78E.exit.i"

"_ZN119_$LT$alloc..collections..btree..map..BTreeMap$LT$K$C$V$C$A$GT$$u20$as$u20$core..iter..traits..collect..IntoIterator$GT$9into_iter17hda96e87042687b78E.exit.i": ; preds = %bb.b, %bb.a
  %.sink23.i.i = phi i64 [ 1, %bb.b ], [ 0, %bb.a ] ; 2 uses
  %.sroa.7.0.copyload.sink.i.i = phi i64 [ %.sroa.5.0.copyload.i, %bb.b ], [ 0, %bb.a ]
  store i64 %.sink23.i.i, ptr %i.b, align 8, !alias.scope !8492, !noalias !8495
  %i.c = getelementptr inbounds nuw i8, ptr %i.b, i64 32
  store i64 %.sink23.i.i, ptr %i.c, align 8, !alias.scope !8492, !noalias !8495
  %i.d = getelementptr inbounds nuw i8, ptr %i.b, i64 64
  store i64 %.sroa.7.0.copyload.sink.i.i, ptr %i.d, align 8, !alias.scope !8492, !noalias !8495
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !8497
  call fastcc void @"_ZN5alloc11collections5btree3map25IntoIter$LT$K$C$V$C$A$GT$10dying_next17h373f035985f41430E"(ptr noalias noundef align 8 captures(address) dereferenceable(24) %i.a, ptr noalias noundef nonnull align 8 dereferenceable(72) %i.b), !noalias !8489
  %i.e = load ptr, ptr %i.a, align 8, !noalias !8497, !noundef !6 ; 2 uses
  %.not5.i.i.i = icmp eq ptr %i.e, null
  br i1 %.not5.i.i.i, label %"_ZN99_$LT$alloc..collections..btree..map..BTreeMap$LT$K$C$V$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17ha358c385a0e08478E.exit", label %.lr.ph.i.i.i

.lr.ph.i.i.i:                                     ; preds = %"_ZN119_$LT$alloc..collections..btree..map..BTreeMap$LT$K$C$V$C$A$GT$$u20$as$u20$core..iter..traits..collect..IntoIterator$GT$9into_iter17hda96e87042687b78E.exit.i"
  %.sroa.23.0..sroa_idx.i.i.i = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  br label %bb.c

bb.c:                                             ; preds = %"_ZN5alloc11collections5btree4node173Handle$LT$alloc..collections..btree..node..NodeRef$LT$alloc..collections..btree..node..marker..Dying$C$K$C$V$C$NodeType$GT$$C$alloc..collections..btree..node..marker..KV$GT$12drop_key_val17h5f966fbe8d438fe6E.exit.i.i.i", %.lr.ph.i.i.i
  %i.f = phi ptr [ %i.e, %.lr.ph.i.i.i ], [ %i.p, %"_ZN5alloc11collections5btree4node173Handle$LT$alloc..collections..btree..node..NodeRef$LT$alloc..collections..btree..node..marker..Dying$C$K$C$V$C$NodeType$GT$$C$alloc..collections..btree..node..marker..KV$GT$12drop_key_val17h5f966fbe8d438fe6E.exit.i.i.i" ] ; 2 uses
  %.sroa.23.0.copyload.i.i.i = load i64, ptr %.sroa.23.0..sroa_idx.i.i.i, align 8, !noalias !8497 ; 2 uses
  ...
  %i.j = getelementptr inbounds nuw [24 x i8], ptr %i.i, i64 %.sroa.23.0.copyload.i.i.i ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8502)
  %.val.i.i.i.i.i = load i64, ptr %i.h, align 8, !alias.scope !8502, !noalias !8497 ; 2 uses
  %i.k = icmp eq i64 %.val.i.i.i.i.i, 0
  br i1 %i.k, label %"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17hc9d9ef159760e033E.exit.i.i.i.i", label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.l = getelementptr inbounds nuw i8, ptr %i.h, i64 8
  %.val1.i.i.i.i.i = load ptr, ptr %i.l, align 8, !alias.scope !8502, !noalias !8497, !nonnull !6, !noundef !6
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val1.i.i.i.i.i, i64 noundef %.val.i.i.i.i.i, i64 noundef range(i64 1, -9223372036854775807) 1) #47, !noalias !8505
  br label %"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17hc9d9ef159760e033E.exit.i.i.i.i"

"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17hc9d9ef159760e033E.exit.i.i.i.i": ; preds = %bb.d, %bb.c
  %.val.i.i6.i.i.i.i = load i64, ptr %i.j, align 8, !noalias !8497 ; 2 uses
  %i.m = icmp eq i64 %.val.i.i6.i.i.i.i, 0
  br i1 %i.m, label %"_ZN5alloc11collections5btree4node173Handle$LT$alloc..collections..btree..node..NodeRef$LT$alloc..collections..btree..node..marker..Dying$C$K$C$V$C$NodeType$GT$$C$alloc..collections..btree..node..marker..KV$GT$12drop_key_val17h5f966fbe8d438fe6E.exit.i.i.i", label %bb.e

bb.e:                                             ; preds = %"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17hc9d9ef159760e033E.exit.i.i.i.i"
  %i.n = getelementptr i8, ptr %i.j, i64 8
  %.val1.i.i7.i.i.i.i = load ptr, ptr %i.n, align 8, !noalias !8497, !nonnull !6, !noundef !6
  %i.o = shl nuw i64 %.val.i.i6.i.i.i.i, 4
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val1.i.i7.i.i.i.i, i64 noundef %i.o, i64 noundef range(i64 1, -9223372036854775807) 4) #47, !noalias !8497
  br label %"_ZN5alloc11collections5btree4node173Handle$LT$alloc..collections..btree..node..NodeRef$LT$alloc..collections..btree..node..marker..Dying$C$K$C$V$C$NodeType$GT$$C$alloc..collections..btree..node..marker..KV$GT$12drop_key_val17h5f966fbe8d438fe6E.exit.i.i.i"

"_ZN5alloc11collections5btree4node173Handle$LT$alloc..collections..btree..node..NodeRef$LT$alloc..collections..btree..node..marker..Dying$C$K$C$V$C$NodeType$GT$$C$alloc..collections..btree..node..marker..KV$GT$12drop_key_val17h5f966fbe8d438fe6E.exit.i.i.i": ; preds = %bb.e, %"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17hc9d9ef159760e033E.exit.i.i.i.i"
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !8497
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !8497
  call fastcc void @"_ZN5alloc11collections5btree3map25IntoIter$LT$K$C$V$C$A$GT$10dying_next17h373f035985f41430E"(ptr noalias noundef align 8 captures(address) dereferenceable(24) %i.a, ptr noalias noundef nonnull align 8 dereferenceable(72) %i.b), !noalias !8489
  %i.p = load ptr, ptr %i.a, align 8, !noalias !8497, !noundef !6 ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.p, null
  br i1 %.not.i.i.i, label %"_ZN99_$LT$alloc..collections..btree..map..BTreeMap$LT$K$C$V$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17ha358c385a0e08478E.exit", label %bb.c

"_ZN99_$LT$alloc..collections..btree..map..BTreeMap$LT$K$C$V$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17ha358c385a0e08478E.exit": ; preds = %"_ZN5alloc11collections5btree4node173Handle$LT$alloc..collections..btree..node..NodeRef$LT$alloc..collections..btree..node..marker..Dying$C$K$C$V$C$NodeType$GT$$C$alloc..collections..btree..node..marker..KV$GT$12drop_key_val17h5f966fbe8d438fe6E.exit.i.i.i", %"_ZN119_$LT$alloc..collections..btree..map..BTreeMap$LT$K$C$V$C$A$GT$$u20$as$u20$core..iter..traits..collect..IntoIterator$GT$9into_iter17hda96e87042687b78E.exit.i"
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !8497
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !8489
  ret void
}

; Function Attrs: nonlazybind uwtable
define internal fastcc void @"_ZN4core3ptr181drop_in_place$LT$hashbrown..scopeguard..ScopeGuard$LT$$RF$mut$u20$hashbrown..raw..RawTableInner$C$hashbrown..raw..RawTableInner..rehash_in_place..$u7b$$u7b$closure$u7d$$u7d$$GT$$GT$17h4014954ab0ed36a7E"(ptr noalias nofree noundef nonnull readonly align 8 captures(none) dereferenceable(24) %0) unnamed_addr #2 {
bb.a:
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8506)
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  %.val.i = load ptr, ptr %i.a, align 8, !alias.scope !8506, !noundef !6 ; 2 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 16
  %.val1.i = load i64, ptr %i.b, align 8, !alias.scope !8506
  %.val2.i = load ptr, ptr %0, align 8, !alias.scope !8506 ; 10 uses
  %.not.i.i = icmp eq ptr %.val.i, null
  br i1 %.not.i.i, label %"_ZN88_$LT$hashbrown..scopeguard..ScopeGuard$LT$T$C$F$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h45e81de5e21a6615E.exit", label %bb.b

bb.b:                                             ; preds = %bb.a
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.val2.i) ]
  %i.c = getelementptr inbounds nuw i8, ptr %.val2.i, i64 8 ; 2 uses
  %i.d = load i64, ptr %i.c, align 8, !noalias !8506, !noundef !6 ; 2 uses
  %.not4.i.i = icmp eq i64 %i.d, -1
  br i1 %.not4.i.i, label %"_ZN88_$LT$hashbrown..scopeguard..ScopeGuard$LT$T$C$F$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h45e81de5e21a6615E.exit", label %.lr.ph.i.i
...
bb.c:                                             ; preds = %bb.e, %.lr.ph.i.i
  ...
  %i.g = load ptr, ptr %.val2.i, align 8, !noalias !8506, !nonnull !6, !noundef !6
  %i.h = getelementptr inbounds nuw i8, ptr %i.g, i64 %.sroa.0.03.i.i ; 2 uses
  %i.i = load i8, ptr %i.h, align 1, !noalias !8506, !noundef !6
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.n = load ptr, ptr %.val2.i, align 8, !noalias !8506, !nonnull !6, !noundef !6
  %i.o = getelementptr i8, ptr %i.n, i64 %i.m
  %i.p = getelementptr i8, ptr %i.o, i64 16
  store i8 -1, ptr %i.p, align 1, !noalias !8506
  %i.q = load ptr, ptr %.val2.i, align 8, !noalias !8506, !nonnull !6, !noundef !6
  %.neg4.i.i = mul i64 %.val1.i, %.neg.i.i
  %i.r = getelementptr inbounds i8, ptr %i.q, i64 %.neg4.i.i
  tail call void %.val.i(ptr noundef nonnull %i.r), !noalias !8506, !inline_history !8509
  %i.s = load i64, ptr %i.e, align 8, !noalias !8506, !noundef !6
  %i.t = add i64 %i.s, -1
  store i64 %i.t, ptr %i.e, align 8, !noalias !8506
  br label %bb.e

bb.e:                                             ; preds = %bb.d, %bb.c
  %exitcond.not.i.i = icmp eq i64 %.sroa.0.03.i.i, %i.d
  br i1 %exitcond.not.i.i, label %"_ZN88_$LT$hashbrown..scopeguard..ScopeGuard$LT$T$C$F$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h45e81de5e21a6615E.exit", label %bb.c

"_ZN88_$LT$hashbrown..scopeguard..ScopeGuard$LT$T$C$F$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h45e81de5e21a6615E.exit": ; preds = %bb.e, %bb.a, %bb.b
  %i.u = getelementptr inbounds nuw i8, ptr %.val2.i, i64 8
  %i.v = load i64, ptr %i.u, align 8, !noalias !8506, !noundef !6 ; 3 uses
  ...
  %i.ab = load i64, ptr %i.aa, align 8, !noalias !8506, !noundef !6
  %i.ac = getelementptr inbounds nuw i8, ptr %.val2.i, i64 16
  %i.ad = sub i64 %.sroa.03.0.i.i, %i.ab
  store i64 %i.ad, ptr %i.ac, align 8, !noalias !8506
  ret void
}

; Function Attrs: inlinehint nofree norecurse nosync nounwind nonlazybind memory(argmem: readwrite, inaccessiblemem: readwrite) uwtable
define internal fastcc void @_ZN4core3ptr19swap_nonoverlapping17h373b35d9db9cd362E(ptr nofree noundef nonnull captures(none) %0, ptr nofree noundef nonnull captures(none) %1, i64 noundef range(i64 4, 33) %2) unnamed_addr #13 {
bb.a:
  %i.a = lshr i64 %2, 3                           ; 4 uses
  %i.b = and i64 %2, 7                            ; 2 uses
  %.not.i = icmp eq i64 %i.a, 0
  br i1 %.not.i, label %_ZN4core3ptr25swap_nonoverlapping_bytes26swap_nonoverlapping_chunks17h5fee07feb76c2d71E.exit.i, label %.preheader.i
...
.preheader.i:                                     ; preds = %bb.a
  ...
  %.sroa.0.0.copyload.i.i.i = load i64, ptr %0, align 1, !alias.scope !8510, !noalias !8513
  %.sroa.02.0.copyload.i.i.i = load i64, ptr %1, align 1, !alias.scope !8513, !noalias !8510
  store i64 %.sroa.02.0.copyload.i.i.i, ptr %0, align 1, !alias.scope !8510, !noalias !8513
  store i64 %.sroa.0.0.copyload.i.i.i, ptr %1, align 1, !alias.scope !8513, !noalias !8510
  %exitcond.not.i.i = icmp eq i64 %i.a, 1
  br i1 %exitcond.not.i.i, label %_ZN4core3ptr25swap_nonoverlapping_bytes26swap_nonoverlapping_chunks17h5fee07feb76c2d71E.exit.i, label %.preheader.i.1

.preheader.i.1:                                   ; preds = %.preheader.i
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.d = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8515)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8517)
  %.sroa.0.0.copyload.i.i.i.1 = load i64, ptr %i.c, align 1, !alias.scope !8515, !noalias !8517
  %.sroa.02.0.copyload.i.i.i.1 = load i64, ptr %i.d, align 1, !alias.scope !8517, !noalias !8515
  store i64 %.sroa.02.0.copyload.i.i.i.1, ptr %i.c, align 1, !alias.scope !8515, !noalias !8517
  store i64 %.sroa.0.0.copyload.i.i.i.1, ptr %i.d, align 1, !alias.scope !8517, !noalias !8515
  %exitcond.not.i.i.1 = icmp eq i64 %i.a, 2
  br i1 %exitcond.not.i.i.1, label %_ZN4core3ptr25swap_nonoverlapping_bytes26swap_nonoverlapping_chunks17h5fee07feb76c2d71E.exit.i, label %.preheader.i.2

.preheader.i.2:                                   ; preds = %.preheader.i.1
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.f = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8519)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8521)
  %.sroa.0.0.copyload.i.i.i.2 = load i64, ptr %i.e, align 1, !alias.scope !8519, !noalias !8521
  %.sroa.02.0.copyload.i.i.i.2 = load i64, ptr %i.f, align 1, !alias.scope !8521, !noalias !8519
  store i64 %.sroa.02.0.copyload.i.i.i.2, ptr %i.e, align 1, !alias.scope !8519, !noalias !8521
  store i64 %.sroa.0.0.copyload.i.i.i.2, ptr %i.f, align 1, !alias.scope !8521, !noalias !8519
  %exitcond.not.i.i.2 = icmp eq i64 %i.a, 3
  br i1 %exitcond.not.i.i.2, label %_ZN4core3ptr25swap_nonoverlapping_bytes26swap_nonoverlapping_chunks17h5fee07feb76c2d71E.exit.i, label %.preheader.i.3

.preheader.i.3:                                   ; preds = %.preheader.i.2
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 2 uses
  %i.h = getelementptr inbounds nuw i8, ptr %1, i64 24 ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8523)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8525)
  %.sroa.0.0.copyload.i.i.i.3 = load i64, ptr %i.g, align 1, !alias.scope !8523, !noalias !8525
  %.sroa.02.0.copyload.i.i.i.3 = load i64, ptr %i.h, align 1, !alias.scope !8525, !noalias !8523
  store i64 %.sroa.02.0.copyload.i.i.i.3, ptr %i.g, align 1, !alias.scope !8523, !noalias !8525
  store i64 %.sroa.0.0.copyload.i.i.i.3, ptr %i.h, align 1, !alias.scope !8525, !noalias !8523
  br label %_ZN4core3ptr25swap_nonoverlapping_bytes26swap_nonoverlapping_chunks17h5fee07feb76c2d71E.exit.i

_ZN4core3ptr25swap_nonoverlapping_bytes26swap_nonoverlapping_chunks17h5fee07feb76c2d71E.exit.i: ; preds = %.preheader.i, %.preheader.i.1, %.preheader.i.2, %.preheader.i.3, %bb.a
  %.not4.i = icmp eq i64 %i.b, 0
  br i1 %.not4.i, label %_ZN4core3ptr25swap_nonoverlapping_bytes17h2566d41837ce52f6E.exit, label %bb.b

bb.b:                                             ; preds = %_ZN4core3ptr25swap_nonoverlapping_bytes26swap_nonoverlapping_chunks17h5fee07feb76c2d71E.exit.i
...
bb.c:                                             ; preds = %bb.b
  ...
  %.sroa.0.0.copyload.i.i5.i = load i32, ptr %i.j, align 1, !alias.scope !8527, !noalias !8530
  %.sroa.02.0.copyload.i.i6.i = load i32, ptr %i.k, align 1, !alias.scope !8530, !noalias !8527
  store i32 %.sroa.02.0.copyload.i.i6.i, ptr %i.j, align 1, !alias.scope !8527, !noalias !8530
  store i32 %.sroa.0.0.copyload.i.i5.i, ptr %i.k, align 1, !alias.scope !8530, !noalias !8527
  br label %bb.d
...
bb.e:                                             ; preds = %bb.d
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8532)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8535)
  %.sroa.0.0.copyload.i9.i.i = load i16, ptr %i.o, align 1, !alias.scope !8532, !noalias !8535
  %.sroa.02.0.copyload.i10.i.i = load i16, ptr %i.p, align 1, !alias.scope !8535, !noalias !8532
  store i16 %.sroa.02.0.copyload.i10.i.i, ptr %i.o, align 1, !alias.scope !8532, !noalias !8535
  store i16 %.sroa.0.0.copyload.i9.i.i, ptr %i.p, align 1, !alias.scope !8535, !noalias !8532
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  br i1 %i.s, label %_ZN4core3ptr25swap_nonoverlapping_bytes17h2566d41837ce52f6E.exit, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.t = getelementptr inbounds nuw i8, ptr %i.j, i64 %.sroa.0.1.i.i ; 2 uses
  %i.u = getelementptr inbounds nuw i8, ptr %i.k, i64 %.sroa.0.1.i.i ; 2 uses
  ...
  %.sroa.0.0.copyload.i11.i.i = load i8, ptr %i.t, align 1, !alias.scope !8537, !noalias !8540
  %.sroa.02.0.copyload.i12.i.i = load i8, ptr %i.u, align 1, !alias.scope !8540, !noalias !8537
  store i8 %.sroa.02.0.copyload.i12.i.i, ptr %i.t, align 1, !alias.scope !8537, !noalias !8540
  store i8 %.sroa.0.0.copyload.i11.i.i, ptr %i.u, align 1, !alias.scope !8540, !noalias !8537
  br label %_ZN4core3ptr25swap_nonoverlapping_bytes17h2566d41837ce52f6E.exit

_ZN4core3ptr25swap_nonoverlapping_bytes17h2566d41837ce52f6E.exit: ; preds = %_ZN4core3ptr25swap_nonoverlapping_bytes26swap_nonoverlapping_chunks17h5fee07feb76c2d71E.exit.i, %bb.f, %bb.g
  ret void
}

; Function Attrs: nounwind nonlazybind uwtable
define internal void @"_ZN4core3ptr238drop_in_place$LT$alloc..boxed..convert..$LT$impl$u20$core..convert..From$LT$alloc..string..String$GT$$u20$for$u20$alloc..boxed..Box$LT$dyn$u20$core..error..Error$u2b$core..marker..Sync$u2b$core..marker..Send$GT$$GT$..from..StringError$GT$17h10dc009258ee510dE"(ptr noalias nofree noundef readonly align 8 captures(none) dereferenceable(24) %0) unnamed_addr #5 personality ptr @rust_eh_personality {
bb.a:
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8542)
  %.val.i = load i64, ptr %0, align 8, !alias.scope !8542 ; 2 uses
  %i.a = icmp eq i64 %.val.i, 0
  br i1 %i.a, label %"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17hc9d9ef159760e033E.exit", label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8
  %.val1.i = load ptr, ptr %i.b, align 8, !alias.scope !8542, !nonnull !6, !noundef !6
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val1.i, i64 noundef %.val.i, i64 noundef range(i64 1, -9223372036854775807) 1) #47, !noalias !8542
  br label %"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17hc9d9ef159760e033E.exit"

"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17hc9d9ef159760e033E.exit": ; preds = %bb.a, %bb.b
  ret void
}

; Function Attrs: nonlazybind uwtable
define internal fastcc void @"_ZN4core3ptr32drop_in_place$LT$glob..Paths$GT$17hf5eb03cd200e91a6E"(ptr noalias nofree noundef nonnull readonly align 8 captures(none) dereferenceable(88) %0) unnamed_addr #2 personality ptr @rust_eh_personality {
bb.a:
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8545)
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  %.val.i = load ptr, ptr %i.a, align 8, !alias.scope !8545, !nonnull !6, !noundef !6 ; 2 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 16
  %.val1.i = load i64, ptr %i.b, align 8, !alias.scope !8545, !noundef !6 ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8548)
  %i.c = icmp eq i64 %.val1.i, 0
  br i1 %i.c, label %"_ZN70_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h78fe91e245ae4160E.exit.i", label %.lr.ph.i.i.i

.lr.ph.i.i.i:                                     ; preds = %bb.a, %"_ZN4core3ptr34drop_in_place$LT$glob..Pattern$GT$17h1e671ebf4242371bE.exit.i.i.i"
  %.sroa.0.07.i.i.i = phi i64 [ %i.e, %"_ZN4core3ptr34drop_in_place$LT$glob..Pattern$GT$17h1e671ebf4242371bE.exit.i.i.i" ], [ 0, %bb.a ] ; 2 uses
  %i.d = getelementptr inbounds nuw [56 x i8], ptr %.val.i, i64 %.sroa.0.07.i.i.i ; 5 uses
  %i.e = add nuw i64 %.sroa.0.07.i.i.i, 1         ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8551)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8554)
  %.val.i.i.i.i.i = load i64, ptr %i.d, align 8, !alias.scope !8557, !noalias !8545 ; 2 uses
  %i.f = icmp eq i64 %.val.i.i.i.i.i, 0
  br i1 %i.f, label %"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17hc9d9ef159760e033E.exit.i.i.i.i", label %bb.b

bb.b:                                             ; preds = %.lr.ph.i.i.i
  %i.g = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  %.val1.i.i.i.i.i = load ptr, ptr %i.g, align 8, !alias.scope !8557, !noalias !8545, !nonnull !6, !noundef !6
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val1.i.i.i.i.i, i64 noundef %.val.i.i.i.i.i, i64 noundef range(i64 1, -9223372036854775807) 1) #47, !noalias !8558
  br label %"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17hc9d9ef159760e033E.exit.i.i.i.i"

"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17hc9d9ef159760e033E.exit.i.i.i.i": ; preds = %bb.b, %.lr.ph.i.i.i
  %i.h = getelementptr inbounds nuw i8, ptr %i.d, i64 24
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8559)
  %i.i = getelementptr inbounds nuw i8, ptr %i.d, i64 32
  %.val.i1.i.i.i.i = load ptr, ptr %i.i, align 8, !alias.scope !8562, !noalias !8545, !nonnull !6, !noundef !6 ; 2 uses
end_hunk_2
begin_hunk_3_@"_ZN4core3ptr32drop_in_place$LT$glob..Paths$GT$17hf5eb03cd200e91a6E":bb.a
  %i.w = shl nuw i64 %.val2.i.i.i.i.i, 5
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val.i1.i.i.i.i, i64 noundef %i.w, i64 noundef range(i64 1, -9223372036854775807) 8) #47, !noalias !8571
  br label %"_ZN4core3ptr34drop_in_place$LT$glob..Pattern$GT$17h1e671ebf4242371bE.exit.i.i.i"

"_ZN4core3ptr34drop_in_place$LT$glob..Pattern$GT$17h1e671ebf4242371bE.exit.i.i.i": ; preds = %bb.e, %"_ZN70_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h2ba11da44382b521E.exit.i.i.i.i.i"
  %i.x = icmp eq i64 %i.e, %.val1.i
  br i1 %i.x, label %"_ZN70_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h78fe91e245ae4160E.exit.i", label %.lr.ph.i.i.i

"_ZN70_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h78fe91e245ae4160E.exit.i": ; preds = %"_ZN4core3ptr34drop_in_place$LT$glob..Pattern$GT$17h1e671ebf4242371bE.exit.i.i.i", %bb.a
  %.val2.i = load i64, ptr %0, align 8, !range !165, !alias.scope !8545, !noundef !6 ; 2 uses
  %i.y = icmp eq i64 %.val2.i, 0
  br i1 %i.y, label %"_ZN4core3ptr57drop_in_place$LT$alloc..vec..Vec$LT$glob..Pattern$GT$$GT$17h6501885ef9323c75E.exit", label %bb.f

bb.f:                                             ; preds = %"_ZN70_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h78fe91e245ae4160E.exit.i"
  %i.z = mul nuw i64 %.val2.i, 56
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val.i, i64 noundef %i.z, i64 noundef range(i64 1, -9223372036854775807) 8) #47, !noalias !8545
  br label %"_ZN4core3ptr57drop_in_place$LT$alloc..vec..Vec$LT$glob..Pattern$GT$$GT$17h6501885ef9323c75E.exit"

"_ZN4core3ptr57drop_in_place$LT$alloc..vec..Vec$LT$glob..Pattern$GT$$GT$17h6501885ef9323c75E.exit": ; preds = %bb.f, %"_ZN70_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h78fe91e245ae4160E.exit.i"
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 24
  invoke fastcc void @"_ZN4core3ptr123drop_in_place$LT$alloc..vec..Vec$LT$core..result..Result$LT$$LP$glob..PathWrapper$C$usize$RP$$C$glob..GlobError$GT$$GT$$GT$17hd7eef9f039f059b5E"(ptr noalias noundef align 8 dereferenceable(24) %i.aa)
          to label %bb.i unwind label %bb.h

bb.g:                                             ; preds = %bb.h
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 56
  %.val4 = load ptr, ptr %i.ab, align 8, !nonnull !6, !noundef !6
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val4, i64 noundef %.val3, i64 noundef range(i64 1, -9223372036854775807) 1) #47, !noalias !8573
  br label %"_ZN4core3ptr66drop_in_place$LT$core..option..Option$LT$glob..PathWrapper$GT$$GT$17h6f482dbe07311ff0E.exit"

bb.h:                                             ; preds = %"_ZN4core3ptr57drop_in_place$LT$alloc..vec..Vec$LT$glob..Pattern$GT$$GT$17h6501885ef9323c75E.exit"
  %i.ac = landingpad { ptr, i32 }
          cleanup
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 48
  %.val3 = load i64, ptr %i.ad, align 8, !range !225, !noundef !6 ; 2 uses
  %switch = icmp sgt i64 %.val3, 0
  br i1 %switch, label %bb.g, label %"_ZN4core3ptr66drop_in_place$LT$core..option..Option$LT$glob..PathWrapper$GT$$GT$17h6f482dbe07311ff0E.exit"

bb.i:                                             ; preds = %"_ZN4core3ptr57drop_in_place$LT$alloc..vec..Vec$LT$glob..Pattern$GT$$GT$17h6501885ef9323c75E.exit"
  %i.ae = getelementptr inbounds nuw i8, ptr %0, i64 48
  %.val = load i64, ptr %i.ae, align 8, !range !225, !noundef !6 ; 2 uses
  %switch6 = icmp sgt i64 %.val, 0
  br i1 %switch6, label %bb.j, label %"_ZN4core3ptr66drop_in_place$LT$core..option..Option$LT$glob..PathWrapper$GT$$GT$17h6f482dbe07311ff0E.exit5"

bb.j:                                             ; preds = %bb.i
  %i.af = getelementptr inbounds nuw i8, ptr %0, i64 56
  %.val2 = load ptr, ptr %i.af, align 8, !nonnull !6, !noundef !6
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val2, i64 noundef %.val, i64 noundef range(i64 1, -9223372036854775807) 1) #47, !noalias !8576
  br label %"_ZN4core3ptr66drop_in_place$LT$core..option..Option$LT$glob..PathWrapper$GT$$GT$17h6f482dbe07311ff0E.exit5"

"_ZN4core3ptr66drop_in_place$LT$core..option..Option$LT$glob..PathWrapper$GT$$GT$17h6f482dbe07311ff0E.exit5": ; preds = %bb.i, %bb.j
  ret void

"_ZN4core3ptr66drop_in_place$LT$core..option..Option$LT$glob..PathWrapper$GT$$GT$17h6f482dbe07311ff0E.exit": ; preds = %bb.h, %bb.g
  resume { ptr, i32 } %i.ac
}

; Function Attrs: nounwind nonlazybind uwtable
define internal void @"_ZN4core3ptr34drop_in_place$LT$std..fs..File$GT$17h2531209e59c12754E"(ptr noalias nofree noundef readonly align 4 captures(none) dereferenceable(4) %0) unnamed_addr #5 {
bb.a:
  %.val = load i32, ptr %0, align 4, !range !3182, !noundef !6
  %i.a = tail call noundef i32 @close(i32 noundef %.val) #47 ; 0 uses
  ret void
}

; Function Attrs: nonlazybind uwtable
define internal void @"_ZN4core3ptr36drop_in_place$LT$glob..GlobError$GT$17hd1f4fbcb66b0c6cdE"(ptr noalias nofree noundef readonly align 8 captures(none) dereferenceable(32) %0) unnamed_addr #2 personality ptr @rust_eh_personality {
bb.a:
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8579)
  %.val.i = load i64, ptr %0, align 8, !alias.scope !8579 ; 2 uses
  %i.a = icmp eq i64 %.val.i, 0
  br i1 %i.a, label %"_ZN4core3ptr39drop_in_place$LT$std..path..PathBuf$GT$17hb9309341f9b26f65E.exit", label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8
  %.val1.i = load ptr, ptr %i.b, align 8, !alias.scope !8579, !nonnull !6, !noundef !6
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val1.i, i64 noundef %.val.i, i64 noundef range(i64 1, -9223372036854775807) 1) #47, !noalias !8579
  br label %"_ZN4core3ptr39drop_in_place$LT$std..path..PathBuf$GT$17hb9309341f9b26f65E.exit"

"_ZN4core3ptr39drop_in_place$LT$std..path..PathBuf$GT$17hb9309341f9b26f65E.exit": ; preds = %bb.b, %bb.a
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 24
  tail call void @"_ZN4core3ptr42drop_in_place$LT$std..io..error..Error$GT$17h3f70fb415ce2d7ddE"(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.c)
  ret void
}

; Function Attrs: nounwind nonlazybind uwtable
define internal fastcc void @"_ZN4core3ptr374drop_in_place$LT$core..iter..adapters..flatten..FlatMap$LT$core..slice..iter..Iter$LT$$LP$u32$C$u32$C$alloc..vec..Vec$LT$lindera_dictionary..dictionary..character_definition..CategoryId$GT$$RP$$GT$$C$alloc..vec..Vec$LT$u32$GT$$C$lindera_dictionary..dictionary_builder..character_definition..CharacterDefinitionBuilder..build_lookup_table..$u7b$$u7b$closure$u7d$$u7d$$GT$$GT$17hb27190de85fdf98dE"(ptr noalias nofree noundef nonnull readonly align 8 captures(none) dereferenceable(80) %0) unnamed_addr #5 personality ptr @rust_eh_personality {
bb.a:
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8582)
  %.val4.i = load ptr, ptr %0, align 8, !alias.scope !8582, !noundef !6 ; 3 uses
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16
  %.val5.i = load i64, ptr %i.a, align 8, !alias.scope !8582 ; 2 uses
  %i.b = icmp eq ptr %.val4.i, null
  %i.c = icmp eq i64 %.val5.i, 0
  %or.cond.i.i = select i1 %i.b, i1 true, i1 %i.c
  br i1 %or.cond.i.i, label %"_ZN4core3ptr91drop_in_place$LT$core..option..Option$LT$alloc..vec..into_iter..IntoIter$LT$u32$GT$$GT$$GT$17h413142e79c47f5f4E.exit.i", label %bb.b

bb.b:                                             ; preds = %bb.a
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.val4.i) ]
  %i.d = shl nuw i64 %.val5.i, 2
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val4.i, i64 noundef %i.d, i64 noundef range(i64 1, -9223372036854775807) 4) #47, !noalias !8585
  br label %"_ZN4core3ptr91drop_in_place$LT$core..option..Option$LT$alloc..vec..into_iter..IntoIter$LT$u32$GT$$GT$$GT$17h413142e79c47f5f4E.exit.i"

"_ZN4core3ptr91drop_in_place$LT$core..option..Option$LT$alloc..vec..into_iter..IntoIter$LT$u32$GT$$GT$$GT$17h413142e79c47f5f4E.exit.i": ; preds = %bb.b, %bb.a
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 32
  %.val.i = load ptr, ptr %i.e, align 8, !alias.scope !8582, !noundef !6 ; 3 uses
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 48
  %.val1.i = load i64, ptr %i.f, align 8, !alias.scope !8582 ; 2 uses
  %i.g = icmp eq ptr %.val.i, null
  %i.h = icmp eq i64 %.val1.i, 0
  %or.cond.i8.i = select i1 %i.g, i1 true, i1 %i.h
  br i1 %or.cond.i8.i, label %"_ZN4core3ptr434drop_in_place$LT$core..iter..adapters..flatten..FlattenCompat$LT$core..iter..adapters..map..Map$LT$core..slice..iter..Iter$LT$$LP$u32$C$u32$C$alloc..vec..Vec$LT$lindera_dictionary..dictionary..character_definition..CategoryId$GT$$RP$$GT$$C$lindera_dictionary..dictionary_builder..character_definition..CharacterDefinitionBuilder..build_lookup_table..$u7b$$u7b$closure$u7d$$u7d$$GT$$C$alloc..vec..into_iter..IntoIter$LT$u32$GT$$GT$$GT$17h7a8adbba6b1ef072E.exit", label %bb.c

bb.c:                                             ; preds = %"_ZN4core3ptr91drop_in_place$LT$core..option..Option$LT$alloc..vec..into_iter..IntoIter$LT$u32$GT$$GT$$GT$17h413142e79c47f5f4E.exit.i"
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.val.i) ]
  %i.i = shl nuw i64 %.val1.i, 2
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val.i, i64 noundef %i.i, i64 noundef range(i64 1, -9223372036854775807) 4) #47, !noalias !8588
  br label %"_ZN4core3ptr434drop_in_place$LT$core..iter..adapters..flatten..FlattenCompat$LT$core..iter..adapters..map..Map$LT$core..slice..iter..Iter$LT$$LP$u32$C$u32$C$alloc..vec..Vec$LT$lindera_dictionary..dictionary..character_definition..CategoryId$GT$$RP$$GT$$C$lindera_dictionary..dictionary_builder..character_definition..CharacterDefinitionBuilder..build_lookup_table..$u7b$$u7b$closure$u7d$$u7d$$GT$$C$alloc..vec..into_iter..IntoIter$LT$u32$GT$$GT$$GT$17h7a8adbba6b1ef072E.exit"

"_ZN4core3ptr434drop_in_place$LT$core..iter..adapters..flatten..FlattenCompat$LT$core..iter..adapters..map..Map$LT$core..slice..iter..Iter$LT$$LP$u32$C$u32$C$alloc..vec..Vec$LT$lindera_dictionary..dictionary..character_definition..CategoryId$GT$$RP$$GT$$C$lindera_dictionary..dictionary_builder..character_definition..CharacterDefinitionBuilder..build_lookup_table..$u7b$$u7b$closure$u7d$$u7d$$GT$$C$alloc..vec..into_iter..IntoIter$LT$u32$GT$$GT$$GT$17h7a8adbba6b1ef072E.exit": ; preds = %"_ZN4core3ptr91drop_in_place$LT$core..option..Option$LT$alloc..vec..into_iter..IntoIter$LT$u32$GT$$GT$$GT$17h413142e79c47f5f4E.exit.i", %bb.c
  ret void
}

; Function Attrs: nonlazybind uwtable
define internal void @"_ZN4core3ptr38drop_in_place$LT$csv..error..Error$GT$17hd6eb239f1d3a2085E"(ptr noalias nofree noundef readonly align 8 captures(none) dereferenceable(8) %0) unnamed_addr #2 personality ptr @rust_eh_personality {
bb.a:
  %.val = load ptr, ptr %0, align 8, !nonnull !6, !noundef !6 ; 9 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8591)
  %i.a = load i64, ptr %.val, align 8, !range !8161, !alias.scope !8591, !noundef !6 ; 2 uses
  %i.b = add nsw i64 %i.a, -2
  %i.c = icmp samesign ugt i64 %i.a, 1
  %i.d = select i1 %i.c, i64 %i.b, i64 5
  switch i64 %i.d, label %bb.b [
    i64 0, label %bb.e
    i64 1, label %"_ZN4core3ptr67drop_in_place$LT$alloc..boxed..Box$LT$csv..error..ErrorKind$GT$$GT$17h22a033b7f7b46411E.exit"
    i64 2, label %"_ZN4core3ptr67drop_in_place$LT$alloc..boxed..Box$LT$csv..error..ErrorKind$GT$$GT$17h22a033b7f7b46411E.exit"
    i64 3, label %"_ZN4core3ptr67drop_in_place$LT$alloc..boxed..Box$LT$csv..error..ErrorKind$GT$$GT$17h22a033b7f7b46411E.exit"
    i64 4, label %bb.f
  ]

bb.b:                                             ; preds = %bb.a
  %i.e = getelementptr inbounds nuw i8, ptr %.val, i64 48
  %i.f = load i8, ptr %i.e, align 8, !range !8170, !alias.scope !8594, !noundef !6
  switch i8 %i.f, label %"_ZN4core3ptr67drop_in_place$LT$alloc..boxed..Box$LT$csv..error..ErrorKind$GT$$GT$17h22a033b7f7b46411E.exit" [
    i8 0, label %bb.c
    i8 1, label %bb.d
  ]

bb.c:                                             ; preds = %bb.b
  %i.g = getelementptr inbounds nuw i8, ptr %.val, i64 56
  %.val.i.i.i.i.i = load i64, ptr %i.g, align 8, !alias.scope !8599 ; 2 uses
  %i.h = icmp eq i64 %.val.i.i.i.i.i, 0
  br i1 %i.h, label %"_ZN4core3ptr67drop_in_place$LT$alloc..boxed..Box$LT$csv..error..ErrorKind$GT$$GT$17h22a033b7f7b46411E.exit", label %"_ZN4core3ptr42drop_in_place$LT$csv..error..ErrorKind$GT$17h432403935758fd9fE.exit.sink.split.i"

bb.d:                                             ; preds = %bb.b
  %i.i = getelementptr inbounds nuw i8, ptr %.val, i64 56
  %.val.i1.i.i.i.i = load i64, ptr %i.i, align 8, !alias.scope !8602 ; 2 uses
  %i.j = icmp eq i64 %.val.i1.i.i.i.i, 0
  br i1 %i.j, label %"_ZN4core3ptr67drop_in_place$LT$alloc..boxed..Box$LT$csv..error..ErrorKind$GT$$GT$17h22a033b7f7b46411E.exit", label %"_ZN4core3ptr42drop_in_place$LT$csv..error..ErrorKind$GT$17h432403935758fd9fE.exit.sink.split.i"

bb.e:                                             ; preds = %bb.a
  %i.k = getelementptr inbounds nuw i8, ptr %.val, i64 8
  invoke void @"_ZN4core3ptr42drop_in_place$LT$std..io..error..Error$GT$17h3f70fb415ce2d7ddE"(ptr noalias noundef nonnull readonly align 8 dereferenceable(8) %i.k)
          to label %"_ZN4core3ptr67drop_in_place$LT$alloc..boxed..Box$LT$csv..error..ErrorKind$GT$$GT$17h22a033b7f7b46411E.exit" unwind label %bb.g

bb.f:                                             ; preds = %bb.a
  %i.l = getelementptr inbounds nuw i8, ptr %.val, i64 8
  %.val.i.i.i = load i64, ptr %i.l, align 8, !alias.scope !8605 ; 2 uses
  %i.m = icmp eq i64 %.val.i.i.i, 0
  br i1 %i.m, label %"_ZN4core3ptr67drop_in_place$LT$alloc..boxed..Box$LT$csv..error..ErrorKind$GT$$GT$17h22a033b7f7b46411E.exit", label %"_ZN4core3ptr42drop_in_place$LT$csv..error..ErrorKind$GT$17h432403935758fd9fE.exit.sink.split.i"

"_ZN4core3ptr42drop_in_place$LT$csv..error..ErrorKind$GT$17h432403935758fd9fE.exit.sink.split.i": ; preds = %bb.f, %bb.d, %bb.c
  %.sink1.i = phi i64 [ 64, %bb.c ], [ 64, %bb.d ], [ 16, %bb.f ]
  %.val.i.i.sink.i = phi i64 [ %.val.i.i.i.i.i, %bb.c ], [ %.val.i1.i.i.i.i, %bb.d ], [ %.val.i.i.i, %bb.f ]
  %i.n = getelementptr inbounds nuw i8, ptr %.val, i64 %.sink1.i
  %.val1.i.i.i = load ptr, ptr %i.n, align 8, !alias.scope !8591, !nonnull !6, !noundef !6
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val1.i.i.i, i64 noundef %.val.i.i.sink.i, i64 noundef range(i64 1, -9223372036854775807) 1) #47, !noalias !8591
  br label %"_ZN4core3ptr67drop_in_place$LT$alloc..boxed..Box$LT$csv..error..ErrorKind$GT$$GT$17h22a033b7f7b46411E.exit"

bb.g:                                             ; preds = %bb.e
  %i.o = landingpad { ptr, i32 }
          cleanup
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val, i64 noundef 80, i64 noundef 8) #47
  resume { ptr, i32 } %i.o

"_ZN4core3ptr67drop_in_place$LT$alloc..boxed..Box$LT$csv..error..ErrorKind$GT$$GT$17h22a033b7f7b46411E.exit": ; preds = %bb.a, %bb.a, %bb.a, %bb.b, %bb.c, %bb.d, %bb.e, %bb.f, %"_ZN4core3ptr42drop_in_place$LT$csv..error..ErrorKind$GT$17h432403935758fd9fE.exit.sink.split.i"
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val, i64 noundef 80, i64 noundef 8) #47
  ret void
}

; Function Attrs: nounwind nonlazybind uwtable
define internal fastcc void @"_ZN4core3ptr395drop_in_place$LT$hashbrown..scopeguard..ScopeGuard$LT$$LP$usize$C$$RF$mut$u20$hashbrown..raw..RawTable$LT$$LP$alloc..string..String$C$lindera_dictionary..dictionary..character_definition..CategoryId$RP$$GT$$RP$$C$hashbrown..raw..RawTable$LT$$LP$alloc..string..String$C$lindera_dictionary..dictionary..character_definition..CategoryId$RP$$GT$..clone_from_impl..$u7b$$u7b$closure$u7d$$u7d$$GT$$GT$17h6e57d00695116440E"(i64 %.0.val, ptr nofree readonly captures(none) %.8.val) unnamed_addr #5 personality ptr @rust_eh_personality {
bb.a:
  %.not.i.i = icmp eq i64 %.0.val, 0
  br i1 %.not.i.i, label %"_ZN88_$LT$hashbrown..scopeguard..ScopeGuard$LT$T$C$F$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h6daac5f348ffea33E.exit", label %.lr.ph.i.i
...
"_ZN4core3ptr117drop_in_place$LT$$LP$alloc..string..String$C$lindera_dictionary..dictionary..character_definition..CategoryId$RP$$GT$17h4d6d18d44fc2fe63E.exit.i.i": ; preds = %bb.d, %bb.c, %bb.b
  %exitcond.not.i.i = icmp eq i64 %i.a, %.0.val
  br i1 %exitcond.not.i.i, label %"_ZN88_$LT$hashbrown..scopeguard..ScopeGuard$LT$T$C$F$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h6daac5f348ffea33E.exit", label %bb.b

"_ZN88_$LT$hashbrown..scopeguard..ScopeGuard$LT$T$C$F$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h6daac5f348ffea33E.exit": ; preds = %"_ZN4core3ptr117drop_in_place$LT$$LP$alloc..string..String$C$lindera_dictionary..dictionary..character_definition..CategoryId$RP$$GT$17h4d6d18d44fc2fe63E.exit.i.i", %bb.a
  ret void
}

; Function Attrs: nounwind nonlazybind uwtable
define internal void @"_ZN4core3ptr39drop_in_place$LT$std..path..PathBuf$GT$17hb9309341f9b26f65E"(ptr noalias nofree noundef readonly align 8 captures(none) dereferenceable(24) %0) unnamed_addr #5 personality ptr @rust_eh_personality {
bb.a:
  %.val = load i64, ptr %0, align 8               ; 2 uses
  %i.a = icmp eq i64 %.val, 0
  br i1 %i.a, label %"_ZN4core3ptr47drop_in_place$LT$std..ffi..os_str..OsString$GT$17h016f64f1365ea1b9E.exit", label %bb.b
...
bb.b:                                             ; preds = %bb.a
  ...
  br label %"_ZN4core3ptr47drop_in_place$LT$std..ffi..os_str..OsString$GT$17h016f64f1365ea1b9E.exit"

"_ZN4core3ptr47drop_in_place$LT$std..ffi..os_str..OsString$GT$17h016f64f1365ea1b9E.exit": ; preds = %bb.a, %bb.b
  ret void
}

; Function Attrs: nounwind nonlazybind uwtable
define internal void @"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17hc9d9ef159760e033E"(ptr noalias nofree noundef readonly align 8 captures(none) dereferenceable(24) %0) unnamed_addr #5 personality ptr @rust_eh_personality {
bb.a:
  %.val = load i64, ptr %0, align 8               ; 2 uses
  %i.a = icmp eq i64 %.val, 0
  br i1 %i.a, label %"_ZN4core3ptr46drop_in_place$LT$alloc..vec..Vec$LT$u8$GT$$GT$17h741b5a0cffaf7c2aE.exit", label %bb.b
...
"_ZN4core3ptr46drop_in_place$LT$alloc..vec..Vec$LT$u8$GT$$GT$17h741b5a0cffaf7c2aE.exit": ; preds = %bb.a, %bb.b
  ret void
}

; Function Attrs: nounwind nonlazybind uwtable
define internal fastcc void @"_ZN4core3ptr42drop_in_place$LT$flate2..mem..Compress$GT$17hd3bf269655b8ef2bE"(ptr %.0.val) unnamed_addr #5 personality ptr @rust_eh_personality {
bb.a:
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.0.val) ]
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8614)
  %i.a = getelementptr inbounds nuw i8, ptr %.0.val, i64 65656
  %.val.i.i.i = load ptr, ptr %i.a, align 8, !alias.scope !8614, !nonnull !6, !noundef !6
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val.i.i.i, i64 noundef 85196, i64 noundef 1) #47, !noalias !8614
  %i.b = getelementptr inbounds nuw i8, ptr %.0.val, i64 65632
  %.val2.i.i.i = load ptr, ptr %i.b, align 8, !alias.scope !8614, !nonnull !6, !noundef !6
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val2.i.i.i, i64 noundef 4320, i64 noundef 2) #47, !noalias !8614
  %i.c = getelementptr inbounds nuw i8, ptr %.0.val, i64 65560
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8617)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8620)
  %.val.i.i.i.i.i = load ptr, ptr %i.c, align 8, !alias.scope !8623, !nonnull !6, !noundef !6
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val.i.i.i.i.i, i64 noundef 33026, i64 noundef 1) #47, !noalias !8623
  %i.d = getelementptr inbounds nuw i8, ptr %.0.val, i64 65568
  %.val4.i.i.i.i.i = load ptr, ptr %i.d, align 8, !alias.scope !8623, !nonnull !6, !noundef !6
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val4.i.i.i.i.i, i64 noundef 65536, i64 noundef 2) #47, !noalias !8623
  %i.e = getelementptr inbounds nuw i8, ptr %.0.val, i64 65576
  %.val2.i.i.i.i.i = load ptr, ptr %i.e, align 8, !alias.scope !8623, !nonnull !6, !noundef !6
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val2.i.i.i.i.i, i64 noundef 65536, i64 noundef 2) #47, !noalias !8623
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.0.val, i64 noundef 65712, i64 noundef 8) #47
  ret void
}

; Function Attrs: nonlazybind uwtable
define internal void @"_ZN4core3ptr42drop_in_place$LT$std..io..error..Error$GT$17h3f70fb415ce2d7ddE"(ptr noalias nofree noundef readonly align 8 captures(none) dereferenceable(8) %0) unnamed_addr #2 personality ptr @rust_eh_personality {
bb.a:
  %.val = load ptr, ptr %0, align 8, !nonnull !6, !noundef !6 ; 4 uses
  %i.a = ptrtoint ptr %.val to i64
  %i.b = and i64 %i.a, 3
  switch i64 %i.b, label %default.unreachable [
    i64 2, label %"_ZN4core3ptr57drop_in_place$LT$std..io..error..repr_bitpacked..Repr$GT$17h640369b4a1d25e2bE.exit"
    i64 3, label %bb.b
    i64 0, label %"_ZN4core3ptr57drop_in_place$LT$std..io..error..repr_bitpacked..Repr$GT$17h640369b4a1d25e2bE.exit"
    i64 1, label %bb.c
  ], !prof !1466
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void @llvm.assume(i1 %i.c)
  br label %"_ZN4core3ptr57drop_in_place$LT$std..io..error..repr_bitpacked..Repr$GT$17h640369b4a1d25e2bE.exit"
...
bb.c:                                             ; preds = %bb.a
  ...
  %.val1.i.i.i.i = load ptr, ptr %i.e, align 8, !nonnull !6, !align !15, !noundef !6 ; 5 uses
  %i.f = load ptr, ptr %.val1.i.i.i.i, align 8, !invariant.load !6 ; 2 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %i.h = load i64, ptr %i.g, align 8, !range !165, !invariant.load !6 ; 2 uses
  %i.i = getelementptr inbounds nuw i8, ptr %.val1.i.i.i.i, i64 16
  %i.j = load i64, ptr %i.i, align 8, !range !264, !invariant.load !6 ; 2 uses
  %i.k = icmp ult i64 %i.j, -9223372036854775807
  tail call void @llvm.assume(i1 %i.k)
  %i.l = icmp eq i64 %i.h, 0
  br i1 %i.l, label %"_ZN4core3ptr68drop_in_place$LT$alloc..boxed..Box$LT$std..io..error..Custom$GT$$GT$17h12375bd83da71235E.exit.i.i.i", label %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i.i.i.i.i"
...
"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i.i.i.i.i": ; preds = %bb.e
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.val.i.i.i.i) ]
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val.i.i.i.i, i64 noundef %i.h, i64 noundef range(i64 1, -9223372036854775807) %i.j) #47
  br label %"_ZN4core3ptr68drop_in_place$LT$alloc..boxed..Box$LT$std..io..error..Custom$GT$$GT$17h12375bd83da71235E.exit.i.i.i"

bb.f:                                             ; preds = %bb.d
  %i.m = landingpad { ptr, i32 }
          cleanup
  %i.n = getelementptr inbounds nuw i8, ptr %.val1.i.i.i.i, i64 8
  %i.o = load i64, ptr %i.n, align 8, !range !165, !invariant.load !6 ; 2 uses
  %i.p = getelementptr inbounds nuw i8, ptr %.val1.i.i.i.i, i64 16
  %i.q = load i64, ptr %i.p, align 8, !range !264, !invariant.load !6 ; 2 uses
...
"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i4.i.i.i.i.i.i": ; preds = %bb.f
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val.i.i.i.i, i64 noundef %i.o, i64 noundef range(i64 1, -9223372036854775807) %i.q) #47
  br label %bb.g
...
bb.g:                                             ; preds = %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i4.i.i.i.i.i.i", %bb.f
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %i.d, i64 noundef 24, i64 noundef 8) #47
  resume { ptr, i32 } %i.m

"_ZN4core3ptr68drop_in_place$LT$alloc..boxed..Box$LT$std..io..error..Custom$GT$$GT$17h12375bd83da71235E.exit.i.i.i": ; preds = %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1e0b43146c957e5eE.exit.i.i.i.i.i.i.i", %bb.e
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %i.d, i64 noundef 24, i64 noundef 8) #47
  br label %"_ZN4core3ptr57drop_in_place$LT$std..io..error..repr_bitpacked..Repr$GT$17h640369b4a1d25e2bE.exit"

"_ZN4core3ptr57drop_in_place$LT$std..io..error..repr_bitpacked..Repr$GT$17h640369b4a1d25e2bE.exit": ; preds = %bb.a, %bb.a, %bb.b, %"_ZN4core3ptr68drop_in_place$LT$alloc..boxed..Box$LT$std..io..error..Custom$GT$$GT$17h12375bd83da71235E.exit.i.i.i"
  ret void
}

; Function Attrs: nounwind nonlazybind uwtable
define internal fastcc void @"_ZN4core3ptr47drop_in_place$LT$flate2..gz..GzHeaderParser$GT$17hcfdc23d655b3fae9E"(ptr noalias nofree noundef nonnull readonly align 8 captures(none) dereferenceable(104) %0) unnamed_addr #5 personality ptr @rust_eh_personality {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 80
  %.val = load i8, ptr %i.a, align 8, !range !8170, !noundef !6
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 88
  %.val1 = load ptr, ptr %i.b, align 8            ; 6 uses
  switch i8 %.val, label %"_ZN4core3ptr46drop_in_place$LT$flate2..gz..GzHeaderState$GT$17h0ecffcdd8aa8f584E.exit" [
    i8 1, label %bb.b
    i8 2, label %bb.c
    i8 3, label %bb.d
    i8 4, label %bb.e
...
"_ZN4core3ptr106drop_in_place$LT$core..option..Option$LT$alloc..boxed..Box$LT$flate2..crc..impl_crc32fast..Crc$GT$$GT$$GT$17h0ef1ba0f83882073E.exit.sink.split.i": ; preds = %bb.f, %bb.e, %bb.d, %bb.c, %bb.b
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val1, i64 noundef 24, i64 noundef 8) #47
  br label %"_ZN4core3ptr46drop_in_place$LT$flate2..gz..GzHeaderState$GT$17h0ecffcdd8aa8f584E.exit"

bb.b:                                             ; preds = %bb.a
  %i.c = icmp eq ptr %.val1, null
  br i1 %i.c, label %"_ZN4core3ptr46drop_in_place$LT$flate2..gz..GzHeaderState$GT$17h0ecffcdd8aa8f584E.exit", label %"_ZN4core3ptr106drop_in_place$LT$core..option..Option$LT$alloc..boxed..Box$LT$flate2..crc..impl_crc32fast..Crc$GT$$GT$$GT$17h0ef1ba0f83882073E.exit.sink.split.i"

bb.c:                                             ; preds = %bb.a
  %i.d = icmp eq ptr %.val1, null
  br i1 %i.d, label %"_ZN4core3ptr46drop_in_place$LT$flate2..gz..GzHeaderState$GT$17h0ecffcdd8aa8f584E.exit", label %"_ZN4core3ptr106drop_in_place$LT$core..option..Option$LT$alloc..boxed..Box$LT$flate2..crc..impl_crc32fast..Crc$GT$$GT$$GT$17h0ef1ba0f83882073E.exit.sink.split.i"

bb.d:                                             ; preds = %bb.a
  %i.e = icmp eq ptr %.val1, null
  br i1 %i.e, label %"_ZN4core3ptr46drop_in_place$LT$flate2..gz..GzHeaderState$GT$17h0ecffcdd8aa8f584E.exit", label %"_ZN4core3ptr106drop_in_place$LT$core..option..Option$LT$alloc..boxed..Box$LT$flate2..crc..impl_crc32fast..Crc$GT$$GT$$GT$17h0ef1ba0f83882073E.exit.sink.split.i"

bb.e:                                             ; preds = %bb.a
  %i.f = icmp eq ptr %.val1, null
  br i1 %i.f, label %"_ZN4core3ptr46drop_in_place$LT$flate2..gz..GzHeaderState$GT$17h0ecffcdd8aa8f584E.exit", label %"_ZN4core3ptr106drop_in_place$LT$core..option..Option$LT$alloc..boxed..Box$LT$flate2..crc..impl_crc32fast..Crc$GT$$GT$$GT$17h0ef1ba0f83882073E.exit.sink.split.i"

bb.f:                                             ; preds = %bb.a
  %i.g = icmp eq ptr %.val1, null
  br i1 %i.g, label %"_ZN4core3ptr46drop_in_place$LT$flate2..gz..GzHeaderState$GT$17h0ecffcdd8aa8f584E.exit", label %"_ZN4core3ptr106drop_in_place$LT$core..option..Option$LT$alloc..boxed..Box$LT$flate2..crc..impl_crc32fast..Crc$GT$$GT$$GT$17h0ef1ba0f83882073E.exit.sink.split.i"

"_ZN4core3ptr46drop_in_place$LT$flate2..gz..GzHeaderState$GT$17h0ecffcdd8aa8f584E.exit": ; preds = %bb.f, %bb.e, %bb.d, %bb.c, %bb.b, %"_ZN4core3ptr106drop_in_place$LT$core..option..Option$LT$alloc..boxed..Box$LT$flate2..crc..impl_crc32fast..Crc$GT$$GT$$GT$17h0ef1ba0f83882073E.exit.sink.split.i", %bb.a
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8624)
  %.val9.i = load i64, ptr %0, align 8, !range !225, !alias.scope !8624, !noundef !6 ; 2 uses
  %switch.i = icmp sgt i64 %.val9.i, 0
  br i1 %switch.i, label %bb.g, label %"_ZN4core3ptr74drop_in_place$LT$core..option..Option$LT$alloc..vec..Vec$LT$u8$GT$$GT$$GT$17hc80f7e7ae0f69cbbE.exit.i"

bb.g:                                             ; preds = %"_ZN4core3ptr46drop_in_place$LT$flate2..gz..GzHeaderState$GT$17h0ecffcdd8aa8f584E.exit"
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 8
  %.val10.i = load ptr, ptr %i.h, align 8, !alias.scope !8624, !nonnull !6, !noundef !6
  tail call void @_RNvCskdKJRKLKjqM_7___rustc14___rust_dealloc(ptr noundef nonnull %.val10.i, i64 noundef %.val9.i, i64 noundef range(i64 1, -9223372036854775807) 1) #47, !noalias !8624
end_hunk_3
begin_hunk_4_@"_ZN5alloc3str21_$LT$impl$u20$str$GT$7replace17h7d0841879e301d78E":bb.a
  br label %bb.d
...
end_hunk_4
begin_hunk_5_@"_ZN91_$LT$core..str..iter..SplitWhitespace$u20$as$u20$core..iter..traits..iterator..Iterator$GT$4next17h28d1d74b6235900eE":bb.a
  %i.bq = lshr i8 %i.bp, 1
