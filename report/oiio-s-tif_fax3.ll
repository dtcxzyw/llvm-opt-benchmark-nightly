...
35:                                               ; preds = %28, %27
  %.0119 = phi ptr [ %30, %28 ], [ %23, %27 ]     ; [#uses=6 type=ptr]
...
.preheader156:                                    ; preds = %37
  %39 = ptrtoint ptr %.0119 to i64                ; [#uses=2 type=i64]
...
begin_hunk_3
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %.0119, i8 0, i64 %46, i1 false), !tbaa !7
  %scevgep = getelementptr i8, ptr %.0119, i64 1  ; [#uses=1 type=ptr]
...
.loopexit155:                                     ; preds = %.preheader156, %.lr.ph.preheader
  %.1120.lcssa = phi ptr [ %.0119, %.preheader156 ], [ %scevgep187, %.lr.ph.preheader ] ; [#uses=2 type=ptr]
...
.lr.ph163.preheader:                              ; preds = %37, %.loopexit155
  %.1111215 = phi i32 [ %54, %.loopexit155 ], [ %36, %37 ] ; [#uses=1 type=i32]
  %.2121214 = phi ptr [ %scevgep190, %.loopexit155 ], [ %.0119, %37 ] ; [#uses=2 type=ptr]
  %55 = zext nneg i32 %.1111215 to i64            ; [#uses=2 type=i64]
  tail call void @llvm.memset.p0.i64(ptr align 1 %.2121214, i8 0, i64 %55, i1 false), !tbaa !7
  br label %._crit_edge

._crit_edge:                                      ; preds = %.loopexit155, %.lr.ph163.preheader
  %.2121213 = phi ptr [ %.2121214, %.lr.ph163.preheader ], [ %scevgep190, %.loopexit155 ] ; [#uses=1 type=ptr]
  %.pre-phi201 = phi i64 [ %55, %.lr.ph163.preheader ], [ 0, %.loopexit155 ] ; [#uses=1 type=i64]
  %56 = getelementptr inbounds nuw i8, ptr %.2121213, i64 %.pre-phi201 ; [#uses=1 type=ptr]
  %57 = and i32 %.1113, 7                         ; [#uses=1 type=i32]
  br label %58

58:                                               ; preds = %._crit_edge, %35
  %.3122 = phi ptr [ %56, %._crit_edge ], [ %.0119, %35 ] ; [#uses=2 type=ptr]
...
101:                                              ; preds = %94, %93
  %.4123 = phi ptr [ %96, %94 ], [ %89, %93 ]     ; [#uses=6 type=ptr]
...
.preheader:                                       ; preds = %103
  %105 = ptrtoint ptr %.4123 to i64               ; [#uses=2 type=i64]
...
begin_hunk_7
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %.4123, i8 -1, i64 %112, i1 false), !tbaa !7
  %scevgep193 = getelementptr i8, ptr %.4123, i64 1 ; [#uses=1 type=ptr]
...
.loopexit:                                        ; preds = %.preheader, %.lr.ph167.preheader
  %.5124.lcssa = phi ptr [ %.4123, %.preheader ], [ %scevgep195, %.lr.ph167.preheader ] ; [#uses=2 type=ptr]
...
.lr.ph172.preheader:                              ; preds = %103, %.loopexit
  %.3221 = phi i32 [ %120, %.loopexit ], [ %102, %103 ] ; [#uses=1 type=i32]
  %.6220 = phi ptr [ %scevgep198, %.loopexit ], [ %.4123, %103 ] ; [#uses=2 type=ptr]
  %121 = zext nneg i32 %.3221 to i64              ; [#uses=2 type=i64]
  tail call void @llvm.memset.p0.i64(ptr align 1 %.6220, i8 -1, i64 %121, i1 false), !tbaa !7
  br label %._crit_edge173

._crit_edge173:                                   ; preds = %.loopexit, %.lr.ph172.preheader
  %.6219 = phi ptr [ %.6220, %.lr.ph172.preheader ], [ %scevgep198, %.loopexit ] ; [#uses=1 type=ptr]
  %.pre-phi = phi i64 [ %121, %.lr.ph172.preheader ], [ 0, %.loopexit ] ; [#uses=1 type=i64]
  %122 = getelementptr inbounds nuw i8, ptr %.6219, i64 %.pre-phi ; [#uses=1 type=ptr]
  %123 = and i32 %.4, 7                           ; [#uses=1 type=i32]
  br label %124

124:                                              ; preds = %._crit_edge173, %101
  %.7 = phi ptr [ %122, %._crit_edge173 ], [ %.4123, %101 ] ; [#uses=2 type=ptr]
