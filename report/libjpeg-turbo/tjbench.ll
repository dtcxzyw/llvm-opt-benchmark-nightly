...
bb.di:                                            ; preds = %.split865.us
  ...
  %10 = sitofp i32 %i.oz to double
  %11 = uitofp nneg i32 %.us-phi866 to double     ; 3 uses
  %i.pa = insertelement <2 x double> poison, double %11, i64 0
  %i.pb = insertelement <2 x double> %i.pa, double %10, i64 1
  ...
  %i.ph = fmul double %i.pg, %11                  ; 2 uses
