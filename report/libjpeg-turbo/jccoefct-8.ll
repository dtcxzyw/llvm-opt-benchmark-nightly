...
.lr.ph121:                                        ; preds = %bb.a
  ...
  %i.n = getelementptr inbounds nuw i8, ptr %0, i64 488 ; 2 uses
  br label %bb.b
...
bb.a:
  ...
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 324 ; 4 uses
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  store ptr %i.y, ptr %i.z, align 8, !tbaa !105
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.aa = load i32, ptr %i.d, align 4, !tbaa !50  ; 2 uses
...
.preheader:                                       ; preds = %bb.c, %bb.e
  ...
  %i.at = load i32, ptr %i.d, align 4, !tbaa !50  ; 2 uses
...
.lr.ph78:                                         ; preds = %.lr.ph78.preheader, %._crit_edge74
  ...
  %i.ay = load i32, ptr %i.ax, align 4, !tbaa !64 ; 5 uses
...
.lr.ph68.us.preheader:                            ; preds = %.lr.ph73
  ...
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !105
