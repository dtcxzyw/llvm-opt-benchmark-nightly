...
.lr.ph:                                           ; preds = %bb.d, %.lr.ph
  ...
  %i.bj = sext i16 %i.aw to i32
  %i.bk = sext i16 %i.bi to i32
  %i.bl = insertelement <2 x i32> poison, i32 %i.bj, i64 0
  %i.bm = insertelement <2 x i32> %i.bl, i32 %i.bk, i64 1 ; 3 uses
