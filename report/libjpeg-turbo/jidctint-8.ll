...
bb.b:                                             ; preds = %bb.a, %bb.b
  ...
  %i.at = add nsw i64 %i.as, %.neg257
  %i.au = add nsw i64 %i.at, %i.ak                ; 2 uses
  %i.av = mul nsw i64 %i.ai, 17333
  %i.aw = add nsw i64 %i.ar, %i.ak
  %i.ax = add nsw i64 %i.aw, %i.av                ; 2 uses
  %.neg258 = mul nsw i64 %i.u, -12399
  %i.ay = add nsw i64 %i.as, %.neg258             ; 2 uses
  %i.az = add nsw i64 %i.ar, %i.ao                ; 2 uses
  %.neg259 = mul nsw i64 %i.ai, -6461
  %i.ba = add nsw i64 %i.az, %.neg259             ; 2 uses
