...
bb.d:                                             ; preds = %bb.c, %bb.d
  ...
  %i.bg = add i64 %i.bf, %i.ba                    ; 2 uses
  %i.bh = add i64 %i.bg, %.neg267
  %i.bi = add i64 %i.bh, %i.ay                    ; 2 uses
  %i.bj = mul nsw i64 %i.aw, 17333
  %i.bk = add i64 %i.bf, %i.ay
  %i.bl = add i64 %i.bk, %i.bj                    ; 2 uses
  %.neg268 = mul nsw i64 %i.ag, -12399
  %i.bm = add i64 %i.bg, %.neg268                 ; 2 uses
  %i.bn = add nsw i64 %i.bf, %i.bc                ; 2 uses
  %.neg269 = mul nsw i64 %i.aw, -6461
  %i.bo = add i64 %i.bn, %.neg269                 ; 2 uses
