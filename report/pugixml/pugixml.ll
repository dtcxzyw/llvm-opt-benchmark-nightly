...
bb.o:                                             ; preds = %bb.n
  ...
  store i32 %i.cq, ptr %.074, align 4, !tbaa !135
  %i.cr = getelementptr inbounds nuw i8, ptr %.074, i64 4
  %i.cs = getelementptr inbounds nuw i8, ptr %.06372, i64 4
  %i.ct = add i64 %.06073, -4
  br label %.critedge

bb.p:                                             ; preds = %bb.n, %bb.m, %bb.l, %bb.k
  %i.cu = getelementptr inbounds nuw i8, ptr %.06372, i64 1
  %i.cv = add i64 %.06073, -1
  br label %.critedge

.critedge:                                        ; preds = %bb.c, %.preheader, %bb.f, %bb.o, %bb.p, %bb.j, %bb.b
  %.265 = phi ptr [ %i.cs, %bb.o ], [ %i.cu, %bb.p ], [ %i.e, %bb.b ], [ %i.aq, %bb.f ], [ %i.bn, %bb.j ], [ %.164, %.preheader ], [ %i.ab, %bb.c ]
  %.262 = phi i64 [ %i.ct, %bb.o ], [ %i.cv, %bb.p ], [ %i.f, %bb.b ], [ %i.ar, %bb.f ], [ %i.bo, %bb.j ], [ %.161, %.preheader ], [ %i.ac, %bb.c ] ; 2 uses
  %.2 = phi ptr [ %i.cr, %bb.o ], [ %.074, %bb.p ], [ %i.d, %bb.b ], [ %i.ap, %bb.f ], [ %i.bm, %bb.j ], [ %.1, %.preheader ], [ %i.aa, %bb.c ] ; 2 uses
  %.not = icmp eq i64 %.262, 0
  br i1 %.not, label %._crit_edge, label %.lr.ph, !llvm.loop !631

._crit_edge:                                      ; preds = %.critedge, %bb.a
  %.0.lcssa = phi ptr [ %2, %bb.a ], [ %.2, %.critedge ]
  ret ptr %.0.lcssa
}
...
bb.b:                                             ; preds = %.lr.ph, %bb.j
  ...
  %.sroa.0.0.copyload = load ptr, ptr %.2.i, align 8, !tbaa !63 ; 2 uses
  %.sroa.2.0..sroa_idx = getelementptr inbounds nuw i8, ptr %.2.i, i64 8
  %.sroa.2.0.copyload = load ptr, ptr %.sroa.2.0..sroa_idx, align 8, !tbaa !68 ; 2 uses
...
bb.d:                                             ; preds = %.lr.ph.i
  %i.s = load ptr, ptr %.0262.i, align 8, !tbaa !57
...
bb.e:                                             ; preds = %bb.d
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %5, ptr noundef nonnull align 8 dereferenceable(16) %.0281.i, i64 16, i1 false), !tbaa.struct !352
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.0281.i, ptr noundef nonnull align 8 dereferenceable(16) %.0262.i, i64 16, i1 false), !tbaa.struct !352
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.0262.i, ptr noundef nonnull align 8 dereferenceable(16) %5, i64 16, i1 false), !tbaa.struct !352
...
bb.f:                                             ; preds = %bb.d
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %4, ptr noundef nonnull align 8 dereferenceable(16) %.0262.i, i64 16, i1 false), !tbaa.struct !352
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.0262.i, ptr noundef nonnull align 8 dereferenceable(16) %i.aa, i64 16, i1 false), !tbaa.struct !352
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.aa, ptr noundef nonnull align 8 dereferenceable(16) %4, i64 16, i1 false), !tbaa.struct !352
...
bb.g:                                             ; preds = %bb.f, %bb.e, %bb.c
  ...
  br i1 %i.ab, label %.lr.ph.i, label %.preheader.i, !llvm.loop !632
...
.lr.ph8.i:                                        ; preds = %.preheader.i, %.lr.ph8.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %.07.i, i64 16, i1 false), !tbaa.struct !352
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.07.i, ptr noundef nonnull align 8 dereferenceable(16) %i.ac, i64 16, i1 false), !tbaa.struct !352
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.ac, ptr noundef nonnull align 8 dereferenceable(16) %3, i64 16, i1 false), !tbaa.struct !352
  call void @llvm.lifetime.end.p0(ptr nonnull %3)
  %i.ad = getelementptr inbounds nuw i8, ptr %.07.i, i64 16 ; 2 uses
  %.not.i = icmp eq ptr %i.ad, %.129.i
  br i1 %.not.i, label %_ZN4pugi4impl12_GLOBAL__N_110partition3INS_10xpath_nodeENS1_25document_order_comparatorEEEvPT_S6_S5_RKT0_PS6_SA_.exit, label %.lr.ph8.i, !llvm.loop !633
...
bb.j:                                             ; preds = %bb.i, %bb.h
  ...
  br i1 %i.al, label %bb.b, label %._crit_edge, !llvm.loop !634
...
.lr.ph7.i:                                        ; preds = %._crit_edge, %.critedge.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %.0166.i, i64 16, i1 false), !tbaa.struct !352
  br label %.lr.ph.i28
...
bb.k:                                             ; preds = %.lr.ph.i28
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.01.i, ptr noundef nonnull align 8 dereferenceable(16) %i.an, i64 16, i1 false), !tbaa.struct !352
  %i.ap = icmp ugt ptr %i.an, %.0.lcssa
  br i1 %i.ap, label %.lr.ph.i28, label %.critedge.i, !llvm.loop !635

.critedge.i:                                      ; preds = %.lr.ph.i28, %bb.k
  %.0.lcssa.i.ph = phi ptr [ %.01.i, %.lr.ph.i28 ], [ %i.an, %bb.k ]
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.0.lcssa.i.ph, ptr noundef nonnull align 8 dereferenceable(16) %2, i64 16, i1 false), !tbaa.struct !352
  ...
  br i1 %.not.i27, label %_ZN4pugi4impl12_GLOBAL__N_114insertion_sortINS_10xpath_nodeENS1_25document_order_comparatorEEEvPT_S6_RKT0_.exit, label %.lr.ph7.i, !llvm.loop !636
...
bb.c:                                             ; preds = %bb.a
  %i.c = load i64, ptr %0, align 8, !tbaa !63
...
bb.d:                                             ; preds = %_ZNK4pugi10xpath_node4nodeEv.exit.i
  %i.f = load i64, ptr %i.e, align 8, !tbaa !66   ; 3 uses
  %i.g = lshr i64 %i.f, 8
  %i.h = sub nsw i64 0, %i.g
  %i.i = getelementptr inbounds i8, ptr %i.e, i64 %i.h
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !37, !nonnull !84, !noundef !84
...
bb.h:                                             ; preds = %_ZNK4pugi10xpath_node4nodeEv.exit.i
  %.sroa.0.0.copyload.i.i = load ptr, ptr %i.a, align 8, !tbaa !68 ; 5 uses
...
bb.i:                                             ; preds = %bb.h
  %i.w = load i64, ptr %.sroa.0.0.copyload.i.i, align 8, !tbaa !86 ; 3 uses
  %i.x = lshr i64 %i.w, 8
  %i.y = sub nsw i64 0, %i.x
  %i.z = getelementptr inbounds i8, ptr %.sroa.0.0.copyload.i.i, i64 %i.y
  %i.aa = load ptr, ptr %i.z, align 8, !tbaa !37, !nonnull !84, !noundef !84
...
bb.p:                                             ; preds = %_ZNK4pugi10xpath_node4nodeEv.exit.i38
  %i.as = load i64, ptr %i.ar, align 8, !tbaa !66 ; 3 uses
  %i.at = lshr i64 %i.as, 8
  %i.au = sub nsw i64 0, %i.at
  %i.av = getelementptr inbounds i8, ptr %i.ar, i64 %i.au
  %i.aw = load ptr, ptr %i.av, align 8, !tbaa !37, !nonnull !84, !noundef !84
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.bc = load ptr, ptr %i.bb, align 8, !tbaa !64 ; 2 uses
...
bb.s:                                             ; preds = %_ZNK4pugi10xpath_node4nodeEv.exit.i38
  %.sroa.0.0.copyload.i.i45 = load ptr, ptr %i.an, align 8, !tbaa !68 ; 4 uses
...
bb.t:                                             ; preds = %bb.s
  %i.bj = load i64, ptr %.sroa.0.0.copyload.i.i45, align 8, !tbaa !86 ; 3 uses
  %i.bk = lshr i64 %i.bj, 8
  %i.bl = sub nsw i64 0, %i.bk
  %i.bm = getelementptr inbounds i8, ptr %.sroa.0.0.copyload.i.i45, i64 %i.bl
  %i.bn = load ptr, ptr %i.bm, align 8, !tbaa !37, !nonnull !84, !noundef !84
  %i.bo = getelementptr inbounds i8, ptr %i.bn, i64 -64
  %i.bp = load i64, ptr %i.bo, align 8, !tbaa !66
