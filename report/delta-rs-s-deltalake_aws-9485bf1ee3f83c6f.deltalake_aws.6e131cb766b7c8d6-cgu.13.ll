...
default.unreachable1278:                          ; preds = %3350, %3156, %2985, %2810, %2567, %2334, %2090, %1915, %1900, %1714, %1518, %1369, %1204, %1046, %1035, %714, %522, %3
  unreachable
...
begin_hunk_1
  ...
  br i1 %.not.i462, label %1911, label %1909
...
1911:                                             ; preds = %1905
  %1912 = getelementptr inbounds nuw i8, ptr %1, i64 2024 ; [#uses=1 type=ptr]
  store i32 1000000001, ptr %1912, align 8, !alias.scope !2906, !noalias !2895
  %1913 = getelementptr inbounds nuw i8, ptr %1, i64 2040 ; [#uses=1 type=ptr]
  store i32 1000000001, ptr %1913, align 8, !alias.scope !2906, !noalias !2895
  %1914 = getelementptr inbounds nuw i8, ptr %1, i64 2056 ; [#uses=1 type=ptr]
  store i32 1000000001, ptr %1914, align 8, !alias.scope !2906, !noalias !2895
  br label %1915

1915:                                             ; preds = %1909, %1911
  %1916 = phi i32 [ 1000000001, %1911 ], [ %.pre1164, %1909 ] ; [#uses=2 type=i32]
  %1917 = phi i32 [ 1000000001, %1911 ], [ %.pre1162, %1909 ] ; [#uses=2 type=i32]
  %1918 = phi i32 [ 1000000001, %1911 ], [ %.pre1160, %1909 ] ; [#uses=2 type=i32]
  %.sroa.5894.0.copyload.sink = phi i32 [ 1000000001, %1911 ], [ %.sroa.5894.0.copyload, %1909 ] ; [#uses=3 type=i32]
...
begin_hunk_3
  ...
  %1924 = icmp eq i32 %1917, 1000000001           ; [#uses=1 type=i1]
  ...
  store i32 %1917, ptr %1923, align 8, !alias.scope !2901, !noalias !2904
  ...
  %1928 = icmp eq i32 %1916, 1000000001           ; [#uses=1 type=i1]
  ...
  store i32 %1916, ptr %1927, align 8, !alias.scope !2901, !noalias !2904
