...
1911:                                             ; preds = %1905
  %1912 = getelementptr inbounds nuw i8, ptr %1, i64 2024
  store i32 1000000001, ptr %1912, align 8, !alias.scope !2906, !noalias !2895
  %1913 = getelementptr inbounds nuw i8, ptr %1, i64 2040
  store i32 1000000001, ptr %1913, align 8, !alias.scope !2906, !noalias !2895
  %1914 = getelementptr inbounds nuw i8, ptr %1, i64 2056
  store i32 1000000001, ptr %1914, align 8, !alias.scope !2906, !noalias !2895
  br label %1915

1915:                                             ; preds = %1909, %1911
  %1916 = phi i32 [ 1000000001, %1911 ], [ %.pre1164, %1909 ] ; 2 uses
  %1917 = phi i32 [ 1000000001, %1911 ], [ %.pre1162, %1909 ] ; 2 uses
  %1918 = phi i32 [ 1000000001, %1911 ], [ %.pre1160, %1909 ] ; 2 uses
  %.sroa.5894.0.copyload.sink = phi i32 [ 1000000001, %1911 ], [ %.sroa.5894.0.copyload, %1909 ] ; 3 uses
...
begin_hunk_3
  ...
  %1924 = icmp eq i32 %1917, 1000000001
  ...
  %1928 = icmp eq i32 %1916, 1000000001
