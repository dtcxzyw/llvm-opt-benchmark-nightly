...
begin_hunk_1
  ...
  %.5.lcssa = phi i64 [ %.4.fr, %89 ], [ %99, %middle.block ], [ %109, %.lr.ph ] ; 2 uses
...
.lr.ph.preheader214:                              ; preds = %.lr.ph.preheader, %middle.block
  %.5148.ph = phi i64 [ %.4.fr, %.lr.ph.preheader ], [ %99, %middle.block ]
