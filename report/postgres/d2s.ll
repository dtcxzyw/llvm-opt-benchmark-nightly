...
bb.aq:                                            ; preds = %bb.ap
  ...
  %2 = udiv i32 %i.gv, 10000
  %3 = insertelement <2 x i32> poison, i32 %i.gv, i64 0
  %4 = insertelement <2 x i32> %3, i32 %2, i64 1
  %5 = urem <2 x i32> %4, splat (i32 10000)
  %6 = trunc nuw nsw <2 x i32> %5 to <2 x i16>
  %.frozen = freeze <2 x i16> %6                  ; 2 uses
  %7 = udiv <2 x i16> %.frozen, splat (i16 100)   ; 3 uses
  %8 = extractelement <2 x i16> %7, i64 0
  %i.gw = shl nuw nsw i16 %8, 1
  %9 = mul <2 x i16> %7, splat (i16 100)
  %.decomposed = sub <2 x i16> %.frozen, %9       ; 2 uses
  %10 = extractelement <2 x i16> %.decomposed, i64 0
  %11 = shl nuw nsw i16 %10, 1
  %12 = extractelement <2 x i16> %.decomposed, i64 1
  %i.gx = shl nuw nsw i16 %12, 1
  %13 = extractelement <2 x i16> %7, i64 1
  %i.gy = shl nuw nsw i16 %13, 1
  ...
  %i.hi = zext nneg i16 %i.gw to i64
...
bb.bk:                                            ; preds = %.loopexit.i
  ...
  %14 = udiv i32 %i.lk, 10000
  %15 = insertelement <2 x i32> poison, i32 %i.lk, i64 0
  %16 = insertelement <2 x i32> %15, i32 %14, i64 1
  %17 = urem <2 x i32> %16, splat (i32 10000)
  %18 = trunc nuw nsw <2 x i32> %17 to <2 x i16>
  %.frozen123 = freeze <2 x i16> %18              ; 2 uses
  %19 = udiv <2 x i16> %.frozen123, splat (i16 100) ; 3 uses
  %20 = extractelement <2 x i16> %19, i64 0
  %i.ll = shl nuw nsw i16 %20, 1
  %21 = mul <2 x i16> %19, splat (i16 100)
  %.decomposed124 = sub <2 x i16> %.frozen123, %21 ; 2 uses
  %22 = extractelement <2 x i16> %.decomposed124, i64 0
  %23 = shl nuw nsw i16 %22, 1
  %24 = extractelement <2 x i16> %.decomposed124, i64 1
  %i.lm = shl nuw nsw i16 %24, 1
  %25 = extractelement <2 x i16> %19, i64 1
  %i.ln = shl nuw nsw i16 %25, 1
  ...
  %i.lx = zext nneg i16 %i.ll to i64
