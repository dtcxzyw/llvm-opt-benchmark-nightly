...
bb.j:                                             ; preds = %bb.h
  ...
  br i1 %.not61, label %bb.k, label %.preheader, !prof !10
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.af = load i8, ptr %i.a, align 1, !range !6, !noundef !7
...
._crit_edge:                                      ; preds = %bb.t, %.preheader
  ...
  %i.bc = load i8, ptr %i.a, align 1, !range !6, !noundef !7
...
bb.o:                                             ; preds = %.lr.ph.i
  ...
  %i.as = load i8, ptr %i.a, align 1, !range !6, !noundef !7
