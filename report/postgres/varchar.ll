...
.loopexit:                                        ; preds = %bb.d, %bb.c, %bb.g, %bb.a
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %i.u, ptr align 1 %0, i64 %.351, i1 false)
...
.loopexit:                                        ; preds = %bb.k, %bb.j, %bb.n
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %i.aw, ptr nonnull align 1 %i.ab, i64 %i.ax, i1 false)
