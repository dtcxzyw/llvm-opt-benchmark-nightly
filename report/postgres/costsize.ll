...
bb.e:                                             ; preds = %bb.a, %bb.c, %bb.d
  ...
  %8 = load double, ptr @cpu_operator_cost, align 8 ; 2 uses
  %9 = fdiv double %i.h, f0x3FE62E42FEFA39EC
  %i.i = fmul double %8, 2.000000e+00
  ...
  %i.o = insertelement <2 x double> poison, double %9, i64 0
  ...
  %i.s = tail call double @llvm.fmuladd.f64(double %8, double %.sink, double %i.r)
...
bb.a:
  ...
  %i.h = tail call double @log(double noundef %i.g) #14
  %8 = load double, ptr @cpu_operator_cost, align 8
  %9 = fdiv double %i.h, f0x3FE62E42FEFA39EC
  %i.i = fmul double %8, 2.000000e+00
