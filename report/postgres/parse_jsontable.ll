...
.lr.ph127:                                        ; preds = %.lr.ph, %.thread
  %.06188126 = phi i1 [ %.2, %.thread ], [ false, %.lr.ph ] ; 4 uses
...
.critedge.loopexit:                               ; preds = %.thread, %.lr.ph
  %.pre108.a = load ptr, ptr %i.s, align 8
  br label %.critedge

.critedge:                                        ; preds = %.critedge.loopexit, %list_length.exit
  %i.ak = phi ptr [ %i.t, %list_length.exit ], [ %.pre108.a, %.critedge.loopexit ] ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  br i1 %.06188126, label %bb.g, label %bb.h
...
bb.r:                                             ; preds = %transformJsonTableColumn.exit, %bb.h
  ...
  %i.ec = call ptr @lappend_oid(ptr noundef %i.eb, i32 noundef %.063.a) #6
  store ptr %i.ec, ptr %i.ac, align 8
  %i.ed = load ptr, ptr %i.s, align 8
  %i.ee = call ptr @lappend(ptr noundef %i.ed, ptr noundef %.062.a) #6
  store ptr %i.ee, ptr %i.s, align 8
  br label %.thread

.thread:                                          ; preds = %.lr.ph127, %bb.e, %bb.r
  %.2 = phi i1 [ %.1, %bb.r ], [ %.06188126, %bb.e ], [ %.06188126, %.lr.ph127 ]
...
.lr.ph93:                                         ; preds = %list_length.exit78
  ...
  br i1 %i.en, label %.lr.ph100, label %transformJsonTableNestedColumns.exit

.lr.ph100:                                        ; preds = %.lr.ph93, %bb.w
  %indvars.iv105 = phi i64 [ %indvars.iv.next106, %bb.w ], [ 0, %.lr.ph93 ] ; 2 uses
  %.0.i799298 = phi ptr [ %.2.i, %bb.w ], [ null, %.lr.ph93 ] ; 3 uses
  %i.eo = load ptr, ptr %i.ej, align 8
  %i.ep = getelementptr inbounds nuw [8 x i8], ptr %i.eo, i64 %indvars.iv105
...
bb.t:                                             ; preds = %bb.s
  ...
  %.pre109 = load ptr, ptr %i.et, align 8
  br label %bb.u

bb.u:                                             ; preds = %bb.t, %bb.s
  %i.fg = phi ptr [ %.pre109, %bb.t ], [ %i.eu, %bb.s ]
  ...
  %.not23.i = icmp eq ptr %.0.i799298, null
...
bb.v:                                             ; preds = %bb.u
  ...
  store ptr %.0.i799298, ptr %i.fl, align 8
  %i.fm = getelementptr inbounds nuw i8, ptr %i.fk, i64 16
  store ptr %i.fj, ptr %i.fm, align 8
  br label %bb.w

bb.w:                                             ; preds = %bb.v, %bb.u, %.lr.ph100
  %.2.i = phi ptr [ %.0.i799298, %.lr.ph100 ], [ %i.fk, %bb.v ], [ %i.fj, %bb.u ] ; 2 uses
  %indvars.iv.next106 = add nuw nsw i64 %indvars.iv105, 1 ; 2 uses
  %i.fn = load i32, ptr %i.ei, align 4
  %i.fo = sext i32 %i.fn to i64
  %i.fp = icmp slt i64 %indvars.iv.next106, %i.fo
  br i1 %i.fp, label %.lr.ph100, label %transformJsonTableNestedColumns.exit
