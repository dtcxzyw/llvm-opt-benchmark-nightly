...
begin_hunk_0_@json_to_tsvector_byid:bb.a
  %i.m = getelementptr inbounds nuw i8, ptr %2, i64 12
  store i32 0, ptr %i.m, align 4
  store ptr %2, ptr %1, align 8
  %i.n = getelementptr inbounds nuw i8, ptr %1, i64 8
  store i32 %i.c, ptr %i.n, align 8
  call void @iterate_json_values(ptr noundef %i.g, i32 noundef %i.l, ptr noundef nonnull %1, ptr noundef nonnull @add_to_tsvector) #7
  %i.o = call noundef ptr @make_tsvector(ptr noundef nonnull %2)
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #7
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #7
  %i.p = load i64, ptr %i.d, align 8
  %i.q = inttoptr i64 %i.p to ptr
  %.not = icmp eq ptr %i.g, %i.q
  br i1 %.not, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.a
  call void @pfree(ptr noundef %i.g) #7
  br label %bb.c

bb.c:                                             ; preds = %bb.a, %bb.b
  %i.r = load i64, ptr %i.h, align 8
  %i.s = inttoptr i64 %i.r to ptr
  %.not14 = icmp eq ptr %i.k, %i.s
  br i1 %.not14, label %bb.e, label %bb.d

bb.d:                                             ; preds = %bb.c
  call void @pfree(ptr noundef %i.k) #7
  br label %bb.e
...
define dso_local noundef i64 @json_to_tsvector(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #0 {
bb.a:
  %1 = alloca %struct.TSVectorBuildState, align 8 ; 5 uses
  %2 = alloca %struct.ParsedText, align 8         ; 6 uses
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 32 ; 2 uses
  %i.b = load i64, ptr %i.a, align 8
  %i.c = inttoptr i64 %i.b to ptr
  %i.d = tail call ptr @pg_detoast_datum(ptr noundef %i.c) #7 ; 3 uses
...
bb.a:
  ...
  br i1 %i.g, label %.lr.ph78, label %bb.o

.lr.ph78:                                         ; preds = %bb.a
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 4 ; 2 uses
  br label %bb.b

bb.b:                                             ; preds = %.lr.ph78, %bb.n
  %i.i = phi i32 [ %i.f, %.lr.ph78 ], [ %i.cr, %bb.n ] ; 2 uses
  %.04677 = phi i32 [ 0, %.lr.ph78 ], [ %i.cs, %bb.n ] ; 3 uses
  %.04876 = phi i32 [ 0, %.lr.ph78 ], [ %i.ag, %bb.n ] ; 2 uses
  %.05075 = phi i32 [ 0, %.lr.ph78 ], [ %.151.lcssa, %bb.n ] ; 5 uses
...
bb.h:                                             ; preds = %.lr.ph110
  ...
  %i.cc = load i16, ptr %i.br, align 8
  %i.cd = and i16 %i.cc, 2
  %i.ce = icmp ne i16 %i.cd, 0
  %i.cf = or i1 %5, %i.ce
  call void @pushValue(ptr noundef %1, ptr noundef %i.by, i32 noundef %i.cb, i16 noundef signext %4, i1 noundef zeroext %i.cf) #7
  %i.cg = load ptr, ptr %6, align 8
  %i.ch = getelementptr inbounds [24 x i8], ptr %i.cg, i64 %i.bs
...
.critedge:                                        ; preds = %.lr.ph71, %bb.l, %.loopexit
  %i.co = phi i32 [ %i.ab, %.loopexit ], [ %i.ck, %bb.l ], [ %i.ai, %.lr.ph71 ]
  %.151.lcssa = phi i32 [ %.05075, %.loopexit ], [ %.252.lcssa, %bb.l ], [ %.15169, %.lr.ph71 ] ; 2 uses
  %.not55 = icmp eq i32 %.2, 0
  br i1 %.not55, label %bb.n, label %bb.m

bb.m:                                             ; preds = %.critedge
  %i.cp = load i32, ptr %i.h, align 4
  %i.cq = trunc i32 %i.cp to i8
  call void @pushOperator(ptr noundef %1, i8 noundef signext %i.cq, i16 noundef signext 1) #7
  %.pre84 = load i32, ptr %i.b, align 4
  br label %bb.n

bb.n:                                             ; preds = %bb.m, %.critedge
  %i.cr = phi i32 [ %.pre84, %bb.m ], [ %i.co, %.critedge ] ; 2 uses
  %i.cs = add i32 %.2, 1
  %i.ct = icmp slt i32 %.151.lcssa, %i.cr
  br i1 %i.ct, label %bb.b, label %._crit_edge, !llvm.loop !13

._crit_edge:                                      ; preds = %bb.n
  %i.cu = load ptr, ptr %6, align 8
  call void @pfree(ptr noundef %i.cu) #7
  br label %bb.p
...
bb.d:                                             ; preds = %bb.a, %bb.c, %bb.b
  %.010 = phi i32 [ 0, %bb.b ], [ %i.s, %bb.c ], [ %i.k, %bb.a ]
  ret i32 %.010
}
...
declare ptr @repalloc_mul(ptr noundef, i64 noundef, i64 noundef) local_unnamed_addr #1
end_hunk_0
