...
bb.y:                                             ; preds = %.lr.ph271, %bb.bk
  ...
  %.0215266 = phi i32 [ 0, %.lr.ph271 ], [ %.lcssa, %bb.bk ] ; 7 uses
...
.lr.ph254:                                        ; preds = %.lr.ph254.preheader, %bb.aq
  ...
  %.0205252 = phi i32 [ %i.gq, %bb.aq ], [ 1, %.lr.ph254.preheader ] ; 2 uses
  %9 = sext i32 %8 to i64
...
bb.aq:                                            ; preds = %log_heap_new_cid.exit, %bb.ai
  %i.gq = add i32 %.0205252, 1                    ; 3 uses
  %10 = add i32 %i.gq, %.0215266
...
._crit_edge255:                                   ; preds = %bb.aq, %.lr.ph254, %bb.ah
  %.0205.lcssa = phi i32 [ 1, %bb.ah ], [ %.0205252, %.lr.ph254 ], [ %i.fm, %bb.aq ] ; 4 uses
