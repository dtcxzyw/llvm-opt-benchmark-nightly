...
begin_hunk_0_@heap_multi_insert:bb.a
  ...
  %i.i = getelementptr inbounds nuw i8, ptr %i.h, i64 118
...
bb.aa:                                            ; preds = %bb.z, %bb.y
  %i.cy = icmp ne i32 %.0201269, 0
  %or.cond5 = and i1 %.0202268, %i.cy
  br i1 %or.cond5, label %bb.ab, label %.lr.ph.preheader.i

.lr.ph.preheader.i:                               ; preds = %bb.aa
  %i.cz = sext i32 %.0201269 to i64               ; 6 uses
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %.lr.ph.preheader.i.new
  ...
  %.019.i = phi i64 [ %i.cl, %.lr.ph.preheader.i.new ], [ %i.dw, %.lr.ph.i ] ; 2 uses
  %.01417.i = phi i32 [ 1, %.lr.ph.preheader.i.new ], [ %spec.select.i.1, %.lr.ph.i ]
  ...
  %i.dj = icmp ult i64 %.019.i, %i.di             ; 2 uses
  %i.dk = zext i1 %i.dj to i32
  %spec.select.i = add i32 %.01417.i, %i.dk
  %spec.select16.i = select i1 %i.dj, i64 %i.cl, i64 %.019.i
  %i.dl = sub i64 %spec.select16.i, %i.di         ; 2 uses
  ...
  %spec.select.i.1 = add i32 %spec.select.i, %i.dv ; 3 uses
  %spec.select16.i.1 = select i1 %i.du, i64 %i.cl, i64 %i.dl
  %i.dw = sub i64 %spec.select16.i.1, %i.dt       ; 2 uses
...
bb.ab:                                            ; preds = %bb.aa
  %i.dx = add i32 %.0209266, 1
  %.pre299 = sext i32 %.0201269 to i64
...
.lr.ph.i.epil.preheader:                          ; preds = %heap_multi_insert_pages.exit.loopexit.unr-lcssa, %.lr.ph.preheader.i
  ...
  %.019.i.epil.init = phi i64 [ %i.cl, %.lr.ph.preheader.i ], [ %i.dw, %heap_multi_insert_pages.exit.loopexit.unr-lcssa ]
  %.01417.i.epil.init = phi i32 [ 1, %.lr.ph.preheader.i ], [ %spec.select.i.1, %heap_multi_insert_pages.exit.loopexit.unr-lcssa ]
  ...
  %i.ef = icmp ult i64 %.019.i.epil.init, %i.ee
  %i.eg = zext i1 %i.ef to i32
  %spec.select.i.epil = add i32 %.01417.i.epil.init, %i.eg
  br label %heap_multi_insert_pages.exit
...
heap_multi_insert_pages.exit:                     ; preds = %.lr.ph.i.epil.preheader, %heap_multi_insert_pages.exit.loopexit.unr-lcssa, %bb.ab
  ...
  %.1210 = phi i32 [ %i.dx, %bb.ab ], [ 0, %heap_multi_insert_pages.exit.loopexit.unr-lcssa ], [ 0, %.lr.ph.i.epil.preheader ] ; 2 uses
  %.1206 = phi i32 [ %.0205267, %bb.ab ], [ %spec.select.i.1, %heap_multi_insert_pages.exit.loopexit.unr-lcssa ], [ %spec.select.i.epil, %.lr.ph.i.epil.preheader ] ; 2 uses
  %i.eh = getelementptr inbounds [8 x i8], ptr %i.bw, i64 %.pre-phi ; 3 uses
  %i.ei = load ptr, ptr %i.eh, align 8
  %i.ej = load i32, ptr %i.ei, align 8
  %i.ek = zext i32 %i.ej to i64
  %i.el = sub i32 %.1206, %.1210
...
bb.ah:                                            ; preds = %bb.ag, %bb.af
  %i.fk = add nsw i32 %.0201269, 1                ; 3 uses
...
bb.ay:                                            ; preds = %bb.ax
  %i.hi = sext i32 %.0214.lcssa to i64
  %i.hj = shl nsw i64 %i.hi, 1
  %.0207.idx = select i1 %i.fe, i64 0, i64 %i.hj  ; 2 uses
  %.0207 = getelementptr inbounds nuw i8, ptr %i.ct, i64 %.0207.idx ; 5 uses
...
bb.ba:                                            ; preds = %bb.az, %.lr.ph263
  %i.ht = ptrtoint ptr %.1208260 to i64
  %i.hu = add i64 %i.ht, 1
  %i.hv = and i64 %i.hu, -2
...
._crit_edge264:                                   ; preds = %bb.ba, %bb.ay
  %.1208.lcssa = phi ptr [ %.0207, %bb.ay ], [ %i.ir, %bb.ba ]
  %i.is = ptrtoint ptr %.1208.lcssa to i64
  %i.it = ptrtoint ptr %.0207 to i64
...
bb.be:                                            ; preds = %bb.bd, %bb.bc
  ...
  call void @XLogBeginInsert() #12
  %i.jb = trunc i64 %.0207.idx to i32
  %i.jc = add i32 %i.jb, 4
...
bb.bf:                                            ; preds = %bb.be
  ...
  call void @XLogRegisterBufData(i8 noundef zeroext 0, ptr noundef nonnull %.0207, i32 noundef %i.iv) #12
