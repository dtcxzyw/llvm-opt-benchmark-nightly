...
begin_hunk_0_@pg_available_extension_versions:bb.a
  %.241 = phi ptr [ %.3, %get_available_versions_for_extension.exit ], [ %.14480, %bb.c ] ; 6 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %.not.i36, label %get_available_versions_for_extension.exit, label %.lr.ph80.i

.lr.ph80.i:                                       ; preds = %bb.f
...
.lr.ph:                                           ; preds = %.lr.ph80.i, %.critedge56.i
  %indvars.iv83.i39 = phi i64 [ %indvars.iv.next84.i, %.critedge56.i ], [ 0, %.lr.ph80.i ] ; 2 uses
  %i.bi = phi i32 [ %i.jy, %.critedge56.i ], [ %.pre.i, %.lr.ph80.i ]
  %i.bj = load ptr, ptr %i.bg, align 8
  %i.bk = getelementptr inbounds nuw [8 x i8], ptr %i.bj, i64 %indvars.iv83.i39
...
convert_requires_to_datum.exit.i:                 ; preds = %.critedge.loopexit.i.i, %bb.l
  %.0.lcssa.i.i = phi i32 [ 0, %bb.l ], [ %i.dd, %.critedge.loopexit.i.i ]
  %i.de = call ptr @construct_array_builtin(ptr noundef %i.cs, i32 noundef %.0.lcssa.i.i, i32 noundef 19) #16
...
.lr.ph44.i.i:                                     ; preds = %find_update_path.exit.thread.i, %.lr.ph44.i.preheader.i
  ...
  %indvars.iv.i61.i = phi i64 [ %indvars.iv.next.i62.i, %find_update_path.exit.thread.i ], [ 0, %.lr.ph44.i.preheader.i ] ; 2 uses
  %.0263842.i.i = phi ptr [ %.2.i.i, %find_update_path.exit.thread.i ], [ null, %.lr.ph44.i.preheader.i ] ; 7 uses
  %i.eb = load ptr, ptr %i.bg, align 8
  %i.ec = getelementptr inbounds nuw [8 x i8], ptr %i.eb, i64 %indvars.iv.i61.i
  %i.ed = load ptr, ptr %i.ec, align 8            ; 6 uses
  %i.ee = getelementptr inbounds nuw i8, ptr %i.ed, i64 16
  %i.ef = load i8, ptr %i.ee, align 8, !range !6, !noundef !7
  %i.eg = trunc nuw i8 %i.ef to i1
  br i1 %i.eg, label %.lr.ph.i72.i, label %find_update_path.exit.thread.i

.lr.ph.i72.i:                                     ; preds = %.lr.ph44.i.i
  %i.eh = icmp sgt i32 %i.ea, 0
  br i1 %i.eh, label %.lr.ph73.i.i, label %.critedge.thread.i.i

.lr.ph73.i.i:                                     ; preds = %.lr.ph.i72.i, %.lr.ph73.i.i
  %indvars.iv.i74.i = phi i64 [ %indvars.iv.next.i75.i, %.lr.ph73.i.i ], [ 0, %.lr.ph.i72.i ] ; 2 uses
  %i.ei = load ptr, ptr %i.bg, align 8
  %i.ej = getelementptr inbounds nuw [8 x i8], ptr %i.ei, i64 %indvars.iv.i74.i
  ...
  %indvars.iv.next.i75.i = add nuw nsw i64 %indvars.iv.i74.i, 1 ; 2 uses
  %i.eo = load i32, ptr %i.bf, align 4
  %i.ep = sext i32 %i.eo to i64
  %i.eq = icmp slt i64 %indvars.iv.next.i75.i, %i.ep
  br i1 %i.eq, label %.lr.ph73.i.i, label %.critedge.thread.i.i

.critedge.thread.i.i:                             ; preds = %.lr.ph73.i.i, %.lr.ph.i72.i
...
bb.t:                                             ; preds = %bb.ab, %.lr.ph22.i.i.i.new
  ...
  %.01620.i.i.i = phi ptr [ null, %.lr.ph22.i.i.i.new ], [ %.2.i.i.i.1, %bb.ab ] ; 4 uses
...
bb.u:                                             ; preds = %bb.t
  %i.fc = icmp eq ptr %.01620.i.i.i, null
  br i1 %i.fc, label %bb.w, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.fd = getelementptr inbounds nuw i8, ptr %.01620.i.i.i, i64 20
...
bb.x:                                             ; preds = %bb.w, %bb.v, %bb.t
  %.2.i.i.i = phi ptr [ %.01620.i.i.i, %bb.t ], [ %i.ey, %bb.w ], [ %.01620.i.i.i, %bb.v ] ; 4 uses
...
.epil.preheader:                                  ; preds = %get_nearest_unprocessed_vertex.exit.i.i.unr-lcssa, %.lr.ph22.i.i.i
  ...
  %.01620.i.i.i.epil.init = phi ptr [ null, %.lr.ph22.i.i.i ], [ %.2.i.i.i.1, %get_nearest_unprocessed_vertex.exit.i.i.unr-lcssa ] ; 4 uses
...
bb.ac:                                            ; preds = %.epil.preheader
  %i.fz = icmp eq ptr %.01620.i.i.i.epil.init, null
  br i1 %i.fz, label %bb.ae, label %bb.ad

bb.ad:                                            ; preds = %bb.ac
  %i.ga = getelementptr inbounds nuw i8, ptr %.01620.i.i.i.epil.init, i64 20
...
get_nearest_unprocessed_vertex.exit.i.i:          ; preds = %.epil.preheader, %bb.ad, %bb.ae, %get_nearest_unprocessed_vertex.exit.i.i.unr-lcssa
  %.2.i.i.i.lcssa = phi ptr [ %.2.i.i.i.1, %get_nearest_unprocessed_vertex.exit.i.i.unr-lcssa ], [ %.01620.i.i.i.epil.init, %.epil.preheader ], [ %i.fv, %bb.ae ], [ %.01620.i.i.i.epil.init, %bb.ad ] ; 8 uses
