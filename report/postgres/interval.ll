Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/postgres/original/interval?download=true
...
bb.a:
  ...
  %.0163222 = add i32 %2, -1                      ; 2 uses
  %i.d = icmp sgt i32 %.0163222, -1
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %i.j = zext nneg i32 %.0163222 to i64
  br label %bb.b

bb.b:                                             ; preds = %.lr.ph, %bb.at
  %indvars.iv = phi i64 [ %i.j, %.lr.ph ], [ %indvars.iv.next, %bb.at ] ; 8 uses
  %.0165226 = phi i32 [ 8, %.lr.ph ], [ %.5170, %bb.at ] ; 2 uses
  %.0171224 = phi i32 [ 0, %.lr.ph ], [ %.1172, %bb.at ] ; 9 uses
  %.0173223 = phi i1 [ false, %.lr.ph ], [ %.2175, %bb.at ] ; 18 uses
...
bb.i:                                             ; preds = %bb.d, %bb.e, %bb.b, %bb.b
  %6 = icmp eq i32 %.0165226, 8
  %.1166 = select i1 %6, i32 18, i32 %.0165226
...
bb.ar:                                            ; preds = %._crit_edge229, %bb.ao, %bb.ap, %bb.aq, %bb.r, %bb.s, %AdjustFractSeconds.exit, %AdjustFractSeconds.exit202, %AdjustFractSeconds.exit203, %AdjustFractDays.exit, %AdjustFractDays.exit204, %bb.ai, %bb.aj, %bb.ak, %bb.al, %bb.v, %bb.u, %bb.h
  ...
  %.1174 = phi i1 [ %.0173223, %bb.aq ], [ %.0173223, %bb.h ], [ %.0173223, %bb.r ], [ %.0173223, %bb.s ], [ %.0173223, %bb.u ], [ %.0173223, %bb.v ], [ %.0173223, %AdjustFractSeconds.exit ], [ %.0173223, %AdjustFractSeconds.exit202 ], [ %.0173223, %AdjustFractSeconds.exit203 ], [ %.0173223, %AdjustFractDays.exit ], [ %.0173223, %AdjustFractDays.exit204 ], [ %.0173223, %bb.ai ], [ %.0173223, %bb.aj ], [ %.0173223, %bb.ak ], [ %.0173223, %bb.al ], [ %.0173223, %bb.ao ], [ true, %bb.ap ], [ %.0173223, %._crit_edge229 ]
  %.4169 = phi i32 [ 0, %bb.aq ], [ 21, %bb.h ], [ 30, %bb.r ], [ 29, %bb.s ], [ 18, %bb.u ], [ 18, %bb.v ], [ 19, %AdjustFractSeconds.exit ], [ 21, %AdjustFractSeconds.exit202 ], [ 21, %AdjustFractSeconds.exit203 ], [ 22, %AdjustFractDays.exit ], [ 23, %AdjustFractDays.exit204 ], [ 25, %bb.ai ], [ 26, %bb.aj ], [ 27, %bb.ak ], [ 28, %bb.al ], [ %i.ij, %bb.ao ], [ %i.ik, %bb.ap ], [ 21, %._crit_edge229 ]
  %i.in = and i32 %i.im, %.0171224
  %.not201 = icmp eq i32 %i.in, 0
  br i1 %.not201, label %bb.as, label %.thread

bb.as:                                            ; preds = %bb.ar
  %i.io = or i32 %i.im, %.0171224
  br label %bb.at

bb.at:                                            ; preds = %bb.am, %bb.as
  %.2175 = phi i1 [ %.1174, %bb.as ], [ %.0173223, %bb.am ] ; 2 uses
  %.1172 = phi i32 [ %i.io, %bb.as ], [ %.0171224, %bb.am ] ; 2 uses
  %.5170 = phi i32 [ %.4169, %bb.as ], [ 8, %bb.am ]
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %i.ip = icmp sgt i64 %indvars.iv, 0
  br i1 %i.ip, label %bb.b, label %._crit_edge, !llvm.loop !4

._crit_edge:                                      ; preds = %bb.at
  %i.iq = icmp eq i32 %.1172, 0
...
bb.aw:                                            ; preds = %bb.au, %bb.av
  br i1 %.2175, label %bb.ax, label %.thread
...
bb.f:                                             ; preds = %bb.e, %bb.d
  %.0258 = phi i32 [ %i.aq, %bb.e ], [ %i.f, %bb.d ] ; 3 uses
  %.0257 = phi i32 [ %i.ar, %bb.e ], [ %i.h, %bb.d ] ; 4 uses
  %.0256 = phi i32 [ %i.as, %bb.e ], [ %i.j, %bb.d ] ; 4 uses
  %.0255 = phi i32 [ %i.at, %bb.e ], [ %i.k, %bb.d ] ; 4 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.az = icmp slt i32 %.0258, 0
  %i.ba = icmp slt i32 %.0257, 0
  %i.bb = icmp slt i32 %.0256, 0
  ...
  %i.bj = tail call i32 @llvm.abs.i32(i32 %.0258, i1 false)
  %i.bk = select i1 %i.be, i32 45, i32 43
  %i.bl = tail call i32 @llvm.abs.i32(i32 %.0257, i1 false)
  %i.bm = tail call i32 @llvm.abs.i32(i32 %.0256, i1 false)
  ...
  %i.br = tail call i32 @llvm.abs.i32(i32 %.0255, i1 false) ; 2 uses
