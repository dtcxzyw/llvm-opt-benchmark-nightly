...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %i.h, label %bb.ad, label %bb.f

bb.d:                                             ; preds = %bb.b
  %i.i = icmp eq ptr %i.f, null
  br i1 %i.i, label %bb.ad, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.j = load i32, ptr %i.f, align 4
  %i.k = and i32 %i.j, 268435455
  %i.l = icmp eq i32 %i.k, 0
  br i1 %i.l, label %bb.ad, label %bb.f
...
.loopexit105:                                     ; preds = %.lr.ph.preheader, %bb.m, %bb.n
...
bb.o:                                             ; preds = %._crit_edge118, %.loopexit105
...
bb.p:                                             ; preds = %.lr.ph110, %bb.ac
  %indvars.iv113 = phi i64 [ 0, %.lr.ph110 ], [ %indvars.iv.next114, %bb.ac ] ; 7 uses
...
bb.r:                                             ; preds = %bb.p
  ...
  br i1 %i.cn, label %bb.s, label %bb.w
...
bb.s:                                             ; preds = %bb.r
  ...
  br i1 %i.cq, label %bb.t, label %.thread.i
...
bb.v:                                             ; preds = %bb.u, %bb.t, %.thread.i
  %i.cw = phi ptr [ %i.cv, %bb.u ], [ null, %bb.t ], [ null, %.thread.i ] ; 2 uses
...
bb.w:                                             ; preds = %bb.r
  ...
  br i1 %.not.i104, label %bb.y, label %bb.x
...
bb.y:                                             ; preds = %bb.x, %bb.w
  %i.db = phi ptr [ %i.da, %bb.x ], [ null, %bb.w ] ; 2 uses
  store ptr %i.db, ptr %i.bx, align 8
  %i.dc = icmp ne ptr %i.db, null
  br label %JsObjectGetField.exit

JsObjectGetField.exit:                            ; preds = %bb.v, %bb.y
  %.0.i = phi i1 [ %i.cq, %bb.v ], [ %i.dc, %bb.y ]
