...
bb.ax:                                            ; preds = %_brin_begin_parallel.exit
  ...
  %i.op = call double %i.oo(ptr noundef %0, ptr noundef nonnull %1, ptr noundef nonnull %2, i1 noundef zeroext false, i1 noundef zeroext false, i1 noundef zeroext true, i32 noundef 0, i32 noundef -1, ptr noundef nonnull @brinbuildCallback, ptr noundef nonnull %i.bk, ptr noundef null) #9, !inline_history !0 ; 2 uses
...
brin_build_empty_tuple.exit.i:                    ; preds = %bb.bc, %bb.bb
  ...
  br i1 %i.qb, label %bb.ba, label %brin_fill_empty_ranges.exit, !llvm.loop !13
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.j = load i8, ptr %i.i, align 4, !range !6, !noundef !7
...
bb.e:                                             ; preds = %bb.d, %bb.c
  %.064 = phi ptr [ %i.e, %bb.c ], [ %i.o, %bb.d ] ; 3 uses
  %i.t = load ptr, ptr %.064, align 8             ; 3 uses
  %i.u = getelementptr inbounds nuw i8, ptr %.064, i64 8
  %i.v = load ptr, ptr %i.u, align 8              ; 5 uses
  %i.w = getelementptr inbounds nuw i8, ptr %.064, i64 16
  ...
  %8 = icmp eq i32 %i.ad, 0
  %9 = icmp ne i32 %.fr, 0
  %10 = and i1 %8, %9
  %or.cond74 = and i1 %i.l, %10
...
bb.r:                                             ; preds = %bb.q, %bb.p
  %.163 = phi ptr [ %i.bb, %bb.q ], [ %.062, %bb.p ] ; 4 uses
  ...
  %i.be = load i8, ptr %i.bd, align 1, !range !6, !noundef !7 ; 2 uses
...
bb.w:                                             ; preds = %bb.v
  ...
  %i.bz = load i8, ptr %i.by, align 1, !range !6, !noundef !7
  %i.ca = trunc nuw i8 %i.bz to i1
  br i1 %i.ca, label %bb.x, label %bb.z

bb.x:                                             ; preds = %bb.w
  %i.cb = getelementptr inbounds nuw i8, ptr %i.bj, i64 2 ; 2 uses
  %i.cc = load i8, ptr %i.cb, align 2, !range !6, !noundef !7
...
bb.z:                                             ; preds = %bb.w, %bb.v
  ...
  %i.co = load i8, ptr %i.cn, align 1, !range !6, !noundef !7
...
bb.ad:                                            ; preds = %bb.ac, %bb.ab, %bb.aa, %bb.z, %bb.y, %bb.x
  %.2.i = phi i8 [ 1, %bb.y ], [ %.035.i, %bb.x ], [ %i.ct, %bb.ac ], [ %i.ct, %bb.ab ], [ %i.ct, %bb.aa ], [ %i.ct, %bb.z ] ; 2 uses
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %i.da = load ptr, ptr %i.aj, align 8
  %i.db = load i32, ptr %i.da, align 8
  %i.dc = sext i32 %i.db to i64
  %i.dd = icmp slt i64 %indvars.iv.next.i, %i.dc
  br i1 %i.dd, label %bb.s, label %add_values_to_range.exit, !llvm.loop !1

add_values_to_range.exit:                         ; preds = %bb.ad, %bb.r
  %.0.lcssa.i = phi i8 [ %i.be, %bb.r ], [ %.2.i, %bb.ad ]
  store i8 0, ptr %i.bd, align 1
  %i.de = trunc nuw i8 %.0.lcssa.i to i1
