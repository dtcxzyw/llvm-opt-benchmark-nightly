...
bb.g:                                             ; preds = %bb.c, %bb.f, %bb.b
  ...
  %i.ag = mul nsw i64 %i.af, 1000000              ; 4 uses
  %i.ah = add i64 %i.ag, %i.aa
  %smax = call i64 @llvm.smax.i64(i64 %i.ah, i64 0)
  %2 = sub i64 %smax, %i.aa                       ; 2 uses
  %3 = icmp ne i64 %2, %i.ag
  %umin = zext i1 %3 to i64                       ; 2 uses
  %4 = or disjoint i64 %i.ag, %umin
  %i.ai = sub i64 %2, %4
  %5 = udiv i64 %i.ai, 86400000000
  %6 = add nuw nsw i64 %5, %umin
  %7 = mul i64 %6, 86400000000
  %i.aj = add i64 %i.aa, %7
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.am = mul nsw i64 %i.al, 1000000              ; 4 uses
  %i.an = add i64 %i.am, %i.ah
  %smax = tail call i64 @llvm.smax.i64(i64 %i.an, i64 0)
  %1 = sub i64 %smax, %i.ah                       ; 2 uses
  %2 = icmp ne i64 %1, %i.am
  %umin = zext i1 %2 to i64                       ; 2 uses
  %3 = or disjoint i64 %i.am, %umin
  %i.ao = sub i64 %1, %3
  %4 = udiv i64 %i.ao, 86400000000
  %5 = add nuw nsw i64 %4, %umin
  %6 = mul i64 %5, 86400000000
  %i.ap = add i64 %i.ah, %6
