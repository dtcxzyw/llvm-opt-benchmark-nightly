...
.lr.ph166:                                        ; preds = %bb.a, %bb.l
  %.0112164 = phi ptr [ %i.bf, %bb.l ], [ %i.l, %bb.a ] ; 2 uses
  %.0113163 = phi ptr [ %.1114.lcssa, %bb.l ], [ %i.l, %bb.a ] ; 3 uses
  %.0118162 = phi i32 [ %i.bo, %bb.l ], [ 0, %bb.a ] ; 3 uses
  %.0120161 = phi i32 [ %.1121, %bb.l ], [ 64, %bb.a ] ; 3 uses
  %.0122160 = phi ptr [ %.1123, %bb.l ], [ %i.k, %bb.a ] ; 2 uses
...
bb.d:                                             ; preds = %.lr.ph166
  %i.t = ptrtoint ptr %.0112164 to i64
  %i.u = ptrtoint ptr %.0113163 to i64
