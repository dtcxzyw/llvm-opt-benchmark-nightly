Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/postgres/original/createuser?download=true
begin_hunk_0
...
bb.b:                                             ; preds = %.backedge, %bb.a
  %.0122 = phi ptr [ null, %bb.a ], [ %.0122.be, %.backedge ] ; 28 uses
  %.0120 = phi ptr [ null, %bb.a ], [ %.0120.be, %.backedge ] ; 28 uses
  %.0118 = phi ptr [ null, %bb.a ], [ %.0118.be, %.backedge ] ; 28 uses
  %.0116 = phi i32 [ 0, %bb.a ], [ %.0116.be, %.backedge ] ; 27 uses
  %.0114 = phi i1 [ false, %bb.a ], [ %.0114.be, %.backedge ] ; 29 uses
  %.0112 = phi i8 [ 0, %bb.a ], [ %.0112.be, %.backedge ] ; 31 uses
  %.0110 = phi i1 [ false, %bb.a ], [ %.0110.be, %.backedge ] ; 28 uses
  %.0107 = phi ptr [ null, %bb.a ], [ %.0107.be, %.backedge ] ; 29 uses
  %.0103 = phi i32 [ 0, %bb.a ], [ %.0103.be, %.backedge ] ; 27 uses
  %.0100 = phi i32 [ 0, %bb.a ], [ %.0100.be, %.backedge ] ; 28 uses
  %.098 = phi i32 [ 0, %bb.a ], [ %.098.be, %.backedge ] ; 27 uses
  %.096 = phi i32 [ 0, %bb.a ], [ %.096.be, %.backedge ] ; 28 uses
  %.094 = phi i32 [ 0, %bb.a ], [ %.094.be, %.backedge ] ; 28 uses
  %.092 = phi i32 [ 0, %bb.a ], [ %.092.be, %.backedge ] ; 27 uses
  %.091 = phi i32 [ 0, %bb.a ], [ %.091.be, %.backedge ] ; 27 uses
...
.backedge:                                        ; preds = %bb.b, %bb.d, %bb.ad, %bb.ac, %bb.ab, %bb.aa, %bb.z, %bb.y, %bb.x, %bb.w, %bb.v, %bb.u, %bb.t, %bb.s, %bb.r, %bb.q, %bb.p, %bb.o, %bb.n, %bb.m, %bb.l, %bb.k, %bb.j, %bb.i, %bb.h, %bb.g, %bb.f, %bb.c
  %.0122.be = phi ptr [ %.0122, %bb.c ], [ %.0122, %bb.d ], [ %.0122, %bb.f ], [ %.0122, %bb.g ], [ %.0122, %bb.h ], [ %.0122, %bb.b ], [ %.0122, %bb.i ], [ %i.m, %bb.j ], [ %.0122, %bb.k ], [ %.0122, %bb.l ], [ %.0122, %bb.m ], [ %.0122, %bb.n ], [ %.0122, %bb.o ], [ %.0122, %bb.p ], [ %.0122, %bb.q ], [ %.0122, %bb.r ], [ %.0122, %bb.s ], [ %.0122, %bb.t ], [ %.0122, %bb.u ], [ %.0122, %bb.v ], [ %.0122, %bb.w ], [ %.0122, %bb.x ], [ %.0122, %bb.y ], [ %.0122, %bb.z ], [ %.0122, %bb.aa ], [ %.0122, %bb.ab ], [ %.0122, %bb.ac ], [ %.0122, %bb.ad ]
  %.0120.be = phi ptr [ %.0120, %bb.c ], [ %.0120, %bb.d ], [ %.0120, %bb.f ], [ %.0120, %bb.g ], [ %.0120, %bb.h ], [ %.0120, %bb.b ], [ %.0120, %bb.i ], [ %.0120, %bb.j ], [ %.0120, %bb.k ], [ %.0120, %bb.l ], [ %.0120, %bb.m ], [ %.0120, %bb.n ], [ %.0120, %bb.o ], [ %i.p, %bb.p ], [ %.0120, %bb.q ], [ %.0120, %bb.r ], [ %.0120, %bb.s ], [ %.0120, %bb.t ], [ %.0120, %bb.u ], [ %.0120, %bb.v ], [ %.0120, %bb.w ], [ %.0120, %bb.x ], [ %.0120, %bb.y ], [ %.0120, %bb.z ], [ %.0120, %bb.aa ], [ %.0120, %bb.ab ], [ %.0120, %bb.ac ], [ %.0120, %bb.ad ]
  %.0100.be = phi i32 [ %.0100, %bb.c ], [ %.0100, %bb.d ], [ %.0100, %bb.f ], [ %.0100, %bb.g ], [ %.0100, %bb.h ], [ %.0100, %bb.b ], [ %.0100, %bb.i ], [ %.0100, %bb.j ], [ %.0100, %bb.k ], [ %.0100, %bb.l ], [ %.0100, %bb.m ], [ %.0100, %bb.n ], [ %.0100, %bb.o ], [ %.0100, %bb.p ], [ %.0100, %bb.q ], [ %.0100, %bb.r ], [ %.0100, %bb.s ], [ 2, %bb.t ], [ 1, %bb.u ], [ %.0100, %bb.v ], [ %.0100, %bb.w ], [ %.0100, %bb.x ], [ %.0100, %bb.y ], [ %.0100, %bb.z ], [ %.0100, %bb.aa ], [ %.0100, %bb.ab ], [ %.0100, %bb.ac ], [ %.0100, %bb.ad ]
  %.098.be = phi i32 [ %.098, %bb.c ], [ %.098, %bb.d ], [ %.098, %bb.f ], [ %.098, %bb.g ], [ %.098, %bb.h ], [ %.098, %bb.b ], [ %.098, %bb.i ], [ %.098, %bb.j ], [ %.098, %bb.k ], [ %.098, %bb.l ], [ %.098, %bb.m ], [ %.098, %bb.n ], [ %.098, %bb.o ], [ %.098, %bb.p ], [ %.098, %bb.q ], [ 2, %bb.r ], [ 1, %bb.s ], [ %.098, %bb.t ], [ %.098, %bb.u ], [ %.098, %bb.v ], [ %.098, %bb.w ], [ %.098, %bb.x ], [ %.098, %bb.y ], [ %.098, %bb.z ], [ %.098, %bb.aa ], [ %.098, %bb.ab ], [ %.098, %bb.ac ], [ %.098, %bb.ad ]
  %.096.be = phi i32 [ %.096, %bb.c ], [ %.096, %bb.d ], [ %.096, %bb.f ], [ %.096, %bb.g ], [ %.096, %bb.h ], [ %.096, %bb.b ], [ %.096, %bb.i ], [ %.096, %bb.j ], [ 2, %bb.k ], [ 1, %bb.l ], [ %.096, %bb.m ], [ %.096, %bb.n ], [ %.096, %bb.o ], [ %.096, %bb.p ], [ %.096, %bb.q ], [ %.096, %bb.r ], [ %.096, %bb.s ], [ %.096, %bb.t ], [ %.096, %bb.u ], [ %.096, %bb.v ], [ %.096, %bb.w ], [ %.096, %bb.x ], [ %.096, %bb.y ], [ %.096, %bb.z ], [ %.096, %bb.aa ], [ %.096, %bb.ab ], [ %.096, %bb.ac ], [ %.096, %bb.ad ]
  %.094.be = phi i32 [ %.094, %bb.c ], [ %.094, %bb.d ], [ %.094, %bb.f ], [ %.094, %bb.g ], [ %.094, %bb.h ], [ %.094, %bb.b ], [ %.094, %bb.i ], [ %.094, %bb.j ], [ %.094, %bb.k ], [ %.094, %bb.l ], [ 2, %bb.m ], [ 1, %bb.n ], [ %.094, %bb.o ], [ %.094, %bb.p ], [ %.094, %bb.q ], [ %.094, %bb.r ], [ %.094, %bb.s ], [ %.094, %bb.t ], [ %.094, %bb.u ], [ %.094, %bb.v ], [ %.094, %bb.w ], [ %.094, %bb.x ], [ %.094, %bb.y ], [ %.094, %bb.z ], [ %.094, %bb.aa ], [ %.094, %bb.ab ], [ %.094, %bb.ac ], [ %.094, %bb.ad ]
  %.092.be = phi i32 [ %.092, %bb.c ], [ %.092, %bb.d ], [ %.092, %bb.f ], [ %.092, %bb.g ], [ %.092, %bb.h ], [ %.092, %bb.b ], [ %.092, %bb.i ], [ %.092, %bb.j ], [ %.092, %bb.k ], [ %.092, %bb.l ], [ %.092, %bb.m ], [ %.092, %bb.n ], [ %.092, %bb.o ], [ %.092, %bb.p ], [ %.092, %bb.q ], [ %.092, %bb.r ], [ %.092, %bb.s ], [ %.092, %bb.t ], [ %.092, %bb.u ], [ %.092, %bb.v ], [ %.092, %bb.w ], [ %.092, %bb.x ], [ %.092, %bb.y ], [ 2, %bb.z ], [ 1, %bb.aa ], [ %.092, %bb.ab ], [ %.092, %bb.ac ], [ %.092, %bb.ad ]
  %.091.be = phi i32 [ %.091, %bb.c ], [ %.091, %bb.d ], [ %.091, %bb.f ], [ %.091, %bb.g ], [ %.091, %bb.h ], [ %.091, %bb.b ], [ %.091, %bb.i ], [ %.091, %bb.j ], [ %.091, %bb.k ], [ %.091, %bb.l ], [ %.091, %bb.m ], [ %.091, %bb.n ], [ %.091, %bb.o ], [ %.091, %bb.p ], [ %.091, %bb.q ], [ %.091, %bb.r ], [ %.091, %bb.s ], [ %.091, %bb.t ], [ %.091, %bb.u ], [ %.091, %bb.v ], [ %.091, %bb.w ], [ %.091, %bb.x ], [ %.091, %bb.y ], [ %.091, %bb.z ], [ %.091, %bb.aa ], [ %.091, %bb.ab ], [ 2, %bb.ac ], [ 1, %bb.ad ]
...
bb.al:                                            ; preds = %bb.aj, %bb.ai, %bb.ak, %bb.ah
  %.1125 = phi ptr [ %i.af, %bb.ai ], [ %i.ac, %bb.ah ], [ %i.ah, %bb.ak ], [ %i.ag, %bb.aj ] ; 2 uses
  br i1 %.0110, label %bb.am, label %bb.ap
...
bb.ap:                                            ; preds = %bb.ao, %bb.al
  %.0109 = phi ptr [ %i.ai, %bb.ao ], [ null, %bb.al ] ; 2 uses
  %i.an = icmp eq i32 %.0100, 0
  br i1 %i.an, label %bb.aq, label %bb.as

bb.aq:                                            ; preds = %bb.ap
  %i.ao = trunc nuw i8 %.0112 to i1
...
bb.as:                                            ; preds = %bb.aq, %bb.ar, %bb.ap
  %.2102 = phi i32 [ %.0100, %bb.ap ], [ 1, %bb.ar ], [ 1, %bb.aq ] ; 4 uses
  %i.aq = icmp eq i32 %.2102, 2                   ; 5 uses
  %spec.select = select i1 %i.aq, i32 2, i32 %.0103 ; 2 uses
  %spec.select145 = select i1 %i.aq, i32 2, i32 %.098 ; 2 uses
  %i.ar = icmp eq i32 %spec.select, 0
  br i1 %i.ar, label %bb.at, label %bb.aw

bb.at:                                            ; preds = %bb.as
  %i.as = trunc nuw i8 %.0112 to i1
...
bb.aw:                                            ; preds = %bb.au, %bb.av, %bb.as
  %.3106 = phi i32 [ %spec.select, %bb.as ], [ 1, %bb.av ], [ 2, %bb.au ] ; 3 uses
  %i.au = icmp eq i32 %spec.select145, 0
  br i1 %i.au, label %bb.ax, label %.thread153

bb.ax:                                            ; preds = %bb.aw
  %i.av = trunc nuw i8 %.0112 to i1
...
.thread153:                                       ; preds = %bb.ar, %bb.ay, %bb.az, %bb.aw
  %.3106158 = phi i32 [ %.3106, %bb.aw ], [ %.3106, %bb.az ], [ %.3106, %bb.ay ], [ 2, %bb.ar ]
  %.2102151157 = phi i32 [ %.2102, %bb.aw ], [ %.2102, %bb.az ], [ %.2102, %bb.ay ], [ 2, %bb.ar ]
  %i.ax = phi i1 [ %i.aq, %bb.aw ], [ %i.aq, %bb.az ], [ %i.aq, %bb.ay ], [ true, %bb.ar ]
  %.3 = phi i32 [ %spec.select145, %bb.aw ], [ 1, %bb.az ], [ 2, %bb.ay ], [ 2, %bb.ar ]
  %7 = icmp eq i32 %.096, 0
  %spec.store.select1 = select i1 %7, i32 2, i32 %.096
  %8 = icmp eq i32 %.094, 0
  %spec.store.select3 = select i1 %8, i32 2, i32 %.094
  store ptr null, ptr %5, align 8
  %i.ay = getelementptr inbounds nuw i8, ptr %5, i64 8
  store ptr %.0122, ptr %i.ay, align 8
  %i.az = getelementptr inbounds nuw i8, ptr %5, i64 16
  store ptr %.0120, ptr %i.az, align 8
  %i.ba = getelementptr inbounds nuw i8, ptr %5, i64 24
  store ptr %.0118, ptr %i.ba, align 8
  %i.bb = getelementptr inbounds nuw i8, ptr %5, i64 32
  store i32 %.0116, ptr %i.bb, align 8
  %i.bc = getelementptr inbounds nuw i8, ptr %5, i64 40
  store ptr null, ptr %i.bc, align 8
  %i.bd = call ptr @connectMaintenanceDatabase(ptr noundef nonnull %5, ptr noundef %i.e, i1 noundef zeroext %.0114) #10 ; 9 uses
...
bb.ba:                                            ; preds = %.thread153
  ...
  %i.bg = call ptr @PQencryptPasswordConn(ptr noundef %i.bd, ptr noundef nonnull %.0109, ptr noundef %.1125, ptr noundef null) #10 ; 3 uses
...
bb.bh:                                            ; preds = %bb.bg, %.thread160
  %.not134 = icmp eq ptr %.0107, null
  br i1 %.not134, label %bb.bj, label %bb.bi

bb.bi:                                            ; preds = %bb.bh
  call void @appendPQExpBufferStr(ptr noundef nonnull %6, ptr noundef nonnull @.str.61) #10
  call void @appendStringLiteralConn(ptr noundef nonnull %6, ptr noundef nonnull %.0107, ptr noundef %i.bd) #10
  br label %bb.bj
...
bb.bn:                                            ; preds = %bb.bl, %bb.bm
  ...
  br i1 %.not136, label %.loopexit162, label %.lr.ph, !llvm.loop !5
...
bb.br:                                            ; preds = %bb.bp, %bb.bq
  ...
  br i1 %.not138, label %.loopexit161, label %.lr.ph199, !llvm.loop !6
