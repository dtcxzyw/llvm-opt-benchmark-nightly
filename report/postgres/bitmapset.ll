...
begin_hunk_0_@bms_add_members:bb.a
  ...
  %i.v = add nuw nsw i64 %i.u, 8                  ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.w, align 8, !alias.scope !53
  %wide.load33 = load <2 x i64>, ptr %i.x, align 8, !alias.scope !53
  %i.y = getelementptr inbounds nuw [8 x i8], ptr %i.t, i64 %index ; 3 uses
  %i.z = getelementptr inbounds nuw i8, ptr %i.y, i64 16 ; 2 uses
  %wide.load34 = load <2 x i64>, ptr %i.y, align 8, !alias.scope !54, !noalias !53
  %wide.load35 = load <2 x i64>, ptr %i.z, align 8, !alias.scope !54, !noalias !53
  %i.aa = or <2 x i64> %wide.load34, %wide.load
  %i.ab = or <2 x i64> %wide.load35, %wide.load33
  store <2 x i64> %i.aa, ptr %i.y, align 8, !alias.scope !54, !noalias !53
  store <2 x i64> %i.ab, ptr %i.z, align 8, !alias.scope !54, !noalias !53
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ac = icmp eq i64 %index.next, %n.vec
  br i1 %i.ac, label %middle.block, label %vector.body, !llvm.loop !50
...
bb.i:                                             ; preds = %bb.i, %bb.h
  ...
  br i1 %i.y, label %bb.i, label %bb.j, !llvm.loop !55
...
bb.g:                                             ; preds = %bb.f
  %i.p = add nuw nsw i32 %i.e, 1                  ; 2 uses
...
bb.h:                                             ; preds = %bb.h, %bb.g
  ...
  br i1 %i.aa, label %bb.h, label %.loopexit, !llvm.loop !56
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.k, align 8, !alias.scope !62
  %wide.load32 = load <2 x i64>, ptr %i.l, align 8, !alias.scope !62
  %i.m = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %index ; 3 uses
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 16 ; 2 uses
  %wide.load33 = load <2 x i64>, ptr %i.m, align 8, !alias.scope !63, !noalias !62
  %wide.load34 = load <2 x i64>, ptr %i.n, align 8, !alias.scope !63, !noalias !62
  %i.o = and <2 x i64> %wide.load33, %wide.load   ; 2 uses
  %i.p = and <2 x i64> %wide.load34, %wide.load32 ; 2 uses
  store <2 x i64> %i.o, ptr %i.m, align 8, !alias.scope !63, !noalias !62
  store <2 x i64> %i.p, ptr %i.n, align 8, !alias.scope !63, !noalias !62
