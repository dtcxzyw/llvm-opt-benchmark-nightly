Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/postgres/original/ruleutils?download=true
...
bb.c:                                             ; preds = %.lr.ph270, %.thread135
  %.0101206269 = phi ptr [ %i.o, %.lr.ph270 ], [ %.1102.ph, %.thread135 ] ; 4 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.v = icmp eq ptr %.0101206269, %i.u
...
.thread135:                                       ; preds = %bb.k, %bb.l, %bb.c, %bb.e, %.lr.ph, %bb.d, %bb.h, %thread-pre-split
  %.1102.ph = phi ptr [ %i.r, %thread-pre-split ], [ %i.r, %.lr.ph ], [ %.0101206269, %bb.h ], [ %i.r, %bb.c ], [ %i.r, %bb.e ], [ %i.r, %bb.d ], [ %.0101206269, %bb.l ], [ %.0101206269, %bb.k ]
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.t = load i8, ptr %i.s, align 1, !range !17, !noundef !18
  %i.u = trunc nuw i8 %i.t to i1
  %i.v = getelementptr inbounds nuw i8, ptr %1, i64 54
  %i.w = load i8, ptr %i.v, align 2, !range !17, !noundef !18
...
bb.g:                                             ; preds = %bb.f, %bb.e
  %.059 = phi ptr [ %3, %bb.e ], [ %i.y, %bb.f ]
  %i.z = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.aa = load ptr, ptr %i.z, align 8
  %.not66 = icmp eq ptr %i.aa, null
  %i.ab = select i1 %.not66, ptr @.str.35, ptr @.str.200
  call void (ptr, ptr, ...) @appendStringInfo(ptr noundef %i.c, ptr noundef nonnull @.str.199, ptr noundef %.059, ptr noundef nonnull %i.ab) #11
...
bb.i:                                             ; preds = %bb.g
  ...
  %i.ai = load i8, ptr %i.ah, align 8, !range !17, !noundef !18
...
.lr.ph:                                           ; preds = %bb.k
  ...
  %i.ao = load i8, ptr %i.b, align 1, !range !17
...
.lr.ph102:                                        ; preds = %.lr.ph.split.us.split.us.split, %bb.p
  ...
  %.076.us.us101 = phi i32 [ %.1.ph.us.us, %bb.p ], [ 0, %.lr.ph.split.us.split.us.split ] ; 3 uses
  ...
  %i.az = load i8, ptr %i.ay, align 2, !range !17, !noundef !18
  %i.ba = trunc nuw i8 %i.az to i1
  br i1 %i.ba, label %bb.p, label %bb.l

bb.l:                                             ; preds = %.lr.ph102
  %i.bb = add i32 %.076.us.us101, 1               ; 2 uses
  %i.bc = icmp sgt i32 %.076.us.us101, 0
...
bb.p:                                             ; preds = %bb.o, %.lr.ph102
  ...
  %.1.ph.us.us = phi i32 [ %.076.us.us101, %.lr.ph102 ], [ %i.bb, %bb.o ]
...
.lr.ph99:                                         ; preds = %.lr.ph.split.us.split.split, %bb.w
  ...
  %.076.us98 = phi i32 [ %.1.ph.us, %bb.w ], [ 0, %.lr.ph.split.us.split.split ] ; 3 uses
  ...
  %i.bo = load i8, ptr %i.bn, align 2, !range !17, !noundef !18
  %i.bp = trunc nuw i8 %i.bo to i1
  br i1 %i.bp, label %bb.w, label %bb.q

bb.q:                                             ; preds = %.lr.ph99
  %i.bq = add i32 %.076.us98, 1                   ; 3 uses
  %i.br = icmp sgt i32 %.076.us98, 0
...
bb.w:                                             ; preds = %bb.v, %.lr.ph99
  ...
  %.1.ph.us = phi i32 [ %.076.us98, %.lr.ph99 ], [ %i.bq, %bb.v ]
