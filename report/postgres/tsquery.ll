...
bb.d:                                             ; preds = %.lr.ph131, %bb.s
  ...
  store i8 %i.u, ptr %.095128, align 4
...
bb.i:                                             ; preds = %bb.g
  %i.ag = icmp sgt i32 %.097127, 1048575
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  %.093125 = phi ptr [ %i.y, %.lr.ph.preheader.new ], [ %i.aw, %.lr.ph ] ; 3 uses
  %.094124 = phi i32 [ -1, %.lr.ph.preheader.new ], [ %i.be, %.lr.ph ] ; 2 uses
  %niter = phi i32 [ 0, %.lr.ph.preheader.new ], [ %niter.next.1, %.lr.ph ]
  %i.al = lshr i32 %.094124, 24
  %i.am = getelementptr inbounds nuw i8, ptr %.093125, i64 1
  %i.an = load i8, ptr %.093125, align 1
  %i.ao = zext i8 %i.an to i32
  %i.ap = xor i32 %i.al, %i.ao
  %i.aq = zext nneg i32 %i.ap to i64
  %i.ar = getelementptr inbounds nuw [4 x i8], ptr @pg_crc32_table, i64 %i.aq
  %i.as = load i32, ptr %i.ar, align 4
  %i.at = shl i32 %.094124, 8
  %i.au = xor i32 %i.as, %i.at                    ; 2 uses
  %i.av = lshr i32 %i.au, 24
  %i.aw = getelementptr inbounds nuw i8, ptr %.093125, i64 2 ; 2 uses
...
.lr.ph.epil.preheader:                            ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph.preheader
  %.093125.epil.init = phi ptr [ %i.y, %.lr.ph.preheader ], [ %i.aw, %._crit_edge.loopexit.unr-lcssa ]
  %.094124.epil.init = phi i32 [ -1, %.lr.ph.preheader ], [ %i.be, %._crit_edge.loopexit.unr-lcssa ] ; 2 uses
  %lcmp.mod174 = trunc i64 %i.z to i1
  tail call void @llvm.assume(i1 %lcmp.mod174)
  %i.bf = lshr i32 %.094124.epil.init, 24
  %i.bg = load i8, ptr %.093125.epil.init, align 1
  ...
  %i.bm = shl i32 %.094124.epil.init, 8
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %bb.k
  %.094.lcssa = phi i32 [ 0, %bb.k ], [ %i.bo, %._crit_edge.loopexit ]
  %i.bp = getelementptr inbounds nuw i8, ptr %.095128, i64 1
  store i8 %i.w, ptr %i.bp, align 1
  %i.bq = and i32 %i.x, 255
  %i.br = icmp ne i32 %i.bq, 0
  %i.bs = getelementptr inbounds nuw i8, ptr %.095128, i64 2
  %i.bt = zext i1 %i.br to i8
  store i8 %i.bt, ptr %i.bs, align 2
  %i.bu = getelementptr inbounds nuw i8, ptr %.095128, i64 4
  store i32 %.094.lcssa, ptr %i.bu, align 4
  %i.bv = getelementptr inbounds nuw i8, ptr %.095128, i64 8
...
bb.p:                                             ; preds = %bb.n
  %i.ck = getelementptr inbounds nuw i8, ptr %.095128, i64 1
...
._crit_edge132:                                   ; preds = %bb.s, %bb.c
  %.097.lcssa = phi i32 [ 0, %bb.c ], [ %.198, %bb.s ]
  %i.cu = add i32 %.097.lcssa, %i.n               ; 2 uses
...
bb.u:                                             ; preds = %.lr.ph137
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %.099134, ptr noundef nonnull align 1 dereferenceable(1) %i.dj, i64 %i.do, i1 false)
  %i.dp = load i32, ptr %i.dk, align 4
  %i.dq = and i32 %i.dp, 4095
  %i.dr = zext nneg i32 %i.dq to i64
  %i.ds = getelementptr inbounds nuw i8, ptr %.099134, i64 %i.dr
...
bb.f:                                             ; preds = %bb.d, %bb.e
  %.014 = phi ptr [ %i.aa, %bb.e ], [ %i.k, %bb.d ] ; 2 uses
...
bb.h:                                             ; preds = %bb.f, %bb.g, %bb.b
  %.0.in = phi ptr [ %i.h, %bb.b ], [ %.014, %bb.g ], [ %.014, %bb.f ]
