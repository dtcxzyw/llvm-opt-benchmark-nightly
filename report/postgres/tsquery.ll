Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/postgres/original/tsquery?download=true
...
bb.a:
  ...
  %i.h = load ptr, ptr %1, align 8, !alias.scope !35
  %i.i = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 12 uses
  %i.j = load i32, ptr %i.i, align 8, !alias.scope !35 ; 2 uses
  %i.k = sext i32 %i.j to i64
  %i.l = getelementptr inbounds i8, ptr %i.h, i64 %i.k
  store i32 %i.g, ptr %i.l, align 1, !noalias !35
  %i.m = add i32 %i.j, 4
  store i32 %i.m, ptr %i.i, align 8, !alias.scope !35
...
.lr.ph:                                           ; preds = %bb.a, %bb.f
  ...
  %i.q = load ptr, ptr %1, align 8, !alias.scope !36
  %i.r = load i32, ptr %i.i, align 8, !alias.scope !36 ; 2 uses
  %i.s = sext i32 %i.r to i64
  %i.t = getelementptr inbounds i8, ptr %i.q, i64 %i.s
  store i8 %i.p, ptr %i.t, align 1, !noalias !36
  %i.u = add i32 %i.r, 1
  store i32 %i.u, ptr %i.i, align 8, !alias.scope !36
...
bb.b:                                             ; preds = %.lr.ph
  ...
  %i.y = load ptr, ptr %1, align 8, !alias.scope !37
  %i.z = load i32, ptr %i.i, align 8, !alias.scope !37 ; 2 uses
  %i.aa = sext i32 %i.z to i64
  %i.ab = getelementptr inbounds i8, ptr %i.y, i64 %i.aa
  store i8 %i.x, ptr %i.ab, align 1, !noalias !37
  %i.ac = add i32 %i.z, 1
  store i32 %i.ac, ptr %i.i, align 8, !alias.scope !37
  %i.ad = getelementptr inbounds nuw i8, ptr %.024, i64 2
  %i.ae = load i8, ptr %i.ad, align 2, !range !6, !noundef !7
  call void @enlargeStringInfo(ptr noundef nonnull %1, i32 noundef 1) #11
  call void @llvm.experimental.noalias.scope.decl(metadata !38)
  %i.af = load ptr, ptr %1, align 8, !alias.scope !38
  %i.ag = load i32, ptr %i.i, align 8, !alias.scope !38 ; 2 uses
  %i.ah = sext i32 %i.ag to i64
  %i.ai = getelementptr inbounds i8, ptr %i.af, i64 %i.ah
  store i8 %i.ae, ptr %i.ai, align 1, !noalias !38
  %i.aj = add i32 %i.ag, 1
  store i32 %i.aj, ptr %i.i, align 8, !alias.scope !38
...
bb.c:                                             ; preds = %.lr.ph
  ...
  %i.av = load ptr, ptr %1, align 8, !alias.scope !39
  %i.aw = load i32, ptr %i.i, align 8, !alias.scope !39 ; 2 uses
  %i.ax = sext i32 %i.aw to i64
  %i.ay = getelementptr inbounds i8, ptr %i.av, i64 %i.ax
  store i8 %i.au, ptr %i.ay, align 1, !noalias !39
  %i.az = add i32 %i.aw, 1
  store i32 %i.az, ptr %i.i, align 8, !alias.scope !39
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.bf = load ptr, ptr %1, align 8, !alias.scope !40
  %i.bg = load i32, ptr %i.i, align 8, !alias.scope !40 ; 2 uses
  %i.bh = sext i32 %i.bg to i64
  %i.bi = getelementptr inbounds i8, ptr %i.bf, i64 %i.bh
  store i16 %i.be, ptr %i.bi, align 1, !noalias !40
  %i.bj = add i32 %i.bg, 2
  store i32 %i.bj, ptr %i.i, align 8, !alias.scope !40
  br label %bb.f
...
bb.f:                                             ; preds = %bb.c, %bb.d, %bb.b
  ...
  br i1 %i.br, label %.lr.ph, label %._crit_edge, !llvm.loop !34
...
.lr.ph137:                                        ; preds = %.lr.ph137.preheader, %bb.v
  ...
  %.198135.a = phi ptr [ %i.df, %.lr.ph137.preheader ], [ %.1, %bb.v ] ; 3 uses
  %.198135 = phi ptr [ %i.cx, %.lr.ph137.preheader ], [ %i.du, %bb.v ] ; 3 uses
  %i.dg = load i8, ptr %.198135, align 4
...
bb.u:                                             ; preds = %.lr.ph137
  ...
  %i.dk = getelementptr inbounds nuw i8, ptr %.198135, i64 8 ; 2 uses
  %i.dl = load i32, ptr %i.dk, align 4
  %i.dm = and i32 %i.dl, 4095
  %i.dn = add nuw nsw i32 %i.dm, 1
  %i.do = zext nneg i32 %i.dn to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %.198135.a, ptr noundef nonnull align 1 dereferenceable(1) %i.dj, i64 %i.do, i1 false)
  %i.dp = load i32, ptr %i.dk, align 4
  %i.dq = and i32 %i.dp, 4095
  %i.dr = zext nneg i32 %i.dq to i64
  %i.ds = getelementptr inbounds nuw i8, ptr %.198135.a, i64 %i.dr
  %i.dt = getelementptr inbounds nuw i8, ptr %i.ds, i64 1
  br label %bb.v

bb.v:                                             ; preds = %bb.u, %.lr.ph137
  %.1 = phi ptr [ %i.dt, %bb.u ], [ %.198135.a, %.lr.ph137 ]
  %i.du = getelementptr inbounds nuw i8, ptr %.198135, i64 12
