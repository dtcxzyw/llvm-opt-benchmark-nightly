...
bb.ai:                                            ; preds = %bb.ag
  %i.ff = trunc nuw i8 %.023434 to i1             ; 2 uses
  br i1 %i.fe, label %bb.aj, label %bb.ak

bb.aj:                                            ; preds = %bb.ai
  br i1 %i.ff, label %.thread11, label %bb.al

bb.ak:                                            ; preds = %bb.ai
  br i1 %i.ff, label %bb.al, label %.thread11

bb.al:                                            ; preds = %bb.ak, %bb.aj
  %.pre-phi = xor i1 %i.fe, true                  ; 2 uses
  %i.fg = load ptr, ptr %i.eu, align 8
  %i.fh = getelementptr inbounds [8 x i8], ptr %i.fg, i64 %i.dv
  %i.fi = load i64, ptr %i.fh, align 8
  %i.fj = call i64 @FunctionCall2Coll(ptr noundef nonnull %6, i32 noundef %i.dw, i64 noundef %i.fi, i64 noundef %i.fa) #13
  %i.fk = icmp ne i64 %i.fj, 0                    ; 2 uses
  %i.fl = load i8, ptr %i.du, align 4, !range !6, !noundef !7 ; 2 uses
...
.thread11:                                        ; preds = %bb.am, %bb.ak, %bb.aj, %bb.af
  ...
  %i.fz = select i1 %i.fx, i8 %.0234.lcssa, i8 0
  %.in248 = select i1 %4, i8 %i.fy, i8 %i.fz
...
bb.an:                                            ; preds = %bb.ae, %.thread11, %bb.ad
  ...
  br i1 %i.gf, label %bb.z, label %._crit_edge44, !llvm.loop !47
...
bb.aq:                                            ; preds = %bb.ap
  ...
  %i.gs = load i8, ptr %i.gr, align 1, !range !6, !noundef !7
  br label %bb.as
...
bb.ar:                                            ; preds = %bb.ap
  ...
  %i.gw = load i8, ptr %i.gv, align 1, !range !6, !noundef !7
  %i.gx = xor i8 %i.gw, 1
  br label %bb.as
...
bb.as:                                            ; preds = %bb.ar, %bb.aq, %bb.ap
  ...
  %i.gz = load i8, ptr %i.gy, align 1, !range !6, !noundef !7 ; 2 uses
  ...
  br i1 %i.hh, label %bb.ap, label %.loopexit, !llvm.loop !48
...
is_orclause.exit:                                 ; preds = %is_opclause.exit
  ...
  br i1 %i.hk, label %is_orclause.exit253, label %is_notclause.exit
...
.lr.ph28:                                         ; preds = %is_orclause.exit253, %bb.av
  %.023127 = phi i32 [ %i.hx, %bb.av ], [ 0, %is_orclause.exit253 ] ; 2 uses
  %i.hq = sext i32 %.023127 to i64                ; 3 uses
  %i.hr = getelementptr inbounds i8, ptr %i.r, i64 %i.hq
  %i.hs = load i8, ptr %i.hr, align 1, !range !6, !noundef !7
...
.sink.split:                                      ; preds = %bb.au, %bb.at
  ...
  %i.hv = load i8, ptr %i.hu, align 1, !range !6, !noundef !7
  br label %bb.av
...
bb.av:                                            ; preds = %.sink.split, %bb.au, %bb.at
  ...
  br i1 %i.hz, label %.lr.ph28, label %._crit_edge29, !llvm.loop !49
...
.sink.split88:                                    ; preds = %bb.ay, %bb.ax
  ...
  %i.ik = load i8, ptr %i.ij, align 1, !range !6, !noundef !7
  %i.il = xor i8 %i.ik, 1
  br label %bb.az
...
bb.az:                                            ; preds = %.sink.split88, %bb.ay, %bb.ax
  ...
  br i1 %i.ip, label %.lr.ph26, label %._crit_edge, !llvm.loop !50
...
bb.bb:                                            ; preds = %.lr.ph, %bb.bd
  ...
  %i.jb = load i8, ptr %i.ja, align 1, !range !6, !noundef !7
