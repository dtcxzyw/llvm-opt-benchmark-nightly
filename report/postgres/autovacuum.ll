...
.thread278:                                       ; preds = %bb.a
  ...
  %i.ah = load i32, ptr %i.x, align 8             ; 2 uses
  %9 = icmp sgt i32 %i.ah, -2
  %spec.select294 = select i1 %9, i32 %i.ah, i32 %i.y
  %10 = load i32, ptr %i.af, align 4              ; 2 uses
  %11 = icmp slt i32 %10, 0
  %spec.select295 = select i1 %11, i32 %i.ag, i32 %10
...
bb.f:                                             ; preds = %.thread293, %bb.e, %bb.d
  ...
  %12 = uitofp i32 %i.cj to double                ; 2 uses
  %13 = uitofp i32 %i.cm to double                ; 2 uses
  %i.cy = insertelement <2 x i32> poison, i32 %i.cs, i64 0
  %i.cz = insertelement <2 x i32> %i.cy, i32 %i.cu, i64 1
  %i.da = sitofp <2 x i32> %i.cz to <2 x double>  ; 2 uses
  %i.db = insertelement <2 x i32> poison, i32 %i.ct, i64 0
  %i.dc = insertelement <2 x i32> %i.db, i32 %i.cv, i64 1
  ...
  %i.dj = insertelement <4 x double> poison, double %12, i64 0
  %i.dk = insertelement <4 x double> %i.dj, double %13, i64 1
  %i.dl = shufflevector <2 x double> %i.di, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %14 = shufflevector <4 x double> %i.dk, <4 x double> %i.dl, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  ...
  %i.dw = select <2 x i1> %i.dt, <2 x i32> %i.dv, <2 x i32> %i.dh ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  %i.dz = fdiv double %12, 1.000000e+08           ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  %i.eg = fdiv double %13, 1.000000e+08           ; 2 uses
