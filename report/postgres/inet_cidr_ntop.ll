...
bb.at:                                            ; preds = %.loopexit.loopexit166.peel.begin.i
  ...
  br i1 %i.fk, label %bb.aw, label %bb.au
...
.loopexit.i13:                                    ; preds = %bb.ab, %bb.bd, %bb.ba, %.loopexit.loopexit166.peel.begin.thread.i, %bb.ax, %bb.aw, %.thread256.i, %bb.p
  ...
  br i1 %i.hg, label %bb.bf, label %bb.be

bb.be:                                            ; preds = %.loopexit.i13
  %i.hh = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %3, ptr noundef nonnull dereferenceable(1) %i.b) #8 ; 0 uses
  br label %inet_cidr_ntop_ipv6.exit

bb.bf:                                            ; preds = %.loopexit.i13
  %i.hi = tail call ptr @__errno_location() #7
  store i32 90, ptr %i.hi, align 4
  br label %inet_cidr_ntop_ipv6.exit

inet_cidr_ntop_ipv6.exit:                         ; preds = %bb.n, %bb.be, %bb.bf
  %.0113.i = phi ptr [ null, %bb.n ], [ null, %bb.bf ], [ %3, %bb.be ]
...
bb.bg:                                            ; preds = %bb.a
  ...
  store i32 97, ptr %i.hj, align 4
  br label %inet_cidr_ntop_ipv4.exit

inet_cidr_ntop_ipv4.exit:                         ; preds = %.loopexit.i, %bb.l, %bb.c, %bb.bg, %inet_cidr_ntop_ipv6.exit
  %.0 = phi ptr [ null, %bb.bg ], [ %.0113.i, %inet_cidr_ntop_ipv6.exit ], [ null, %bb.c ], [ null, %.loopexit.i ], [ %3, %bb.l ]
  ret ptr %.0
}
