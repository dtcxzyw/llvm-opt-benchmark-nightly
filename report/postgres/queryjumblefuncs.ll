...
.preheader.i:                                     ; preds = %bb.b, %bb.e
  %.030.i.i = phi i64 [ %i.u, %bb.e ], [ %i.k, %bb.b ] ; 2 uses
  %.029.i.i = phi i64 [ %i.w, %bb.e ], [ 4, %bb.b ] ; 2 uses
  %.0.i.i = phi ptr [ %i.v, %bb.e ], [ %i.h, %bb.b ] ; 2 uses
  %i.p = icmp ugt i64 %.030.i.i, 1023
...
bb.e:                                             ; preds = %bb.d, %.preheader.i
  %.1.i.i = phi i64 [ 8, %bb.d ], [ %.030.i.i, %.preheader.i ] ; 3 uses
  %i.r = sub nuw nsw i64 1024, %.1.i.i
  %i.s = tail call i64 @llvm.umin.i64(i64 %.029.i.i, i64 %i.r) ; 4 uses
  ...
  %i.w = sub i64 %.029.i.i, %i.s                  ; 2 uses
...
bb.n:                                             ; preds = %bb.a, %.loopexit
  %.038 = phi ptr [ %i.f, %.loopexit ], [ null, %bb.a ]
...
.preheader12:                                     ; preds = %bb.b, %bb.e
  %.030.i = phi i64 [ %i.o, %bb.e ], [ %i.e, %bb.b ] ; 2 uses
  %.029.i = phi i64 [ %i.q, %bb.e ], [ 4, %bb.b ] ; 2 uses
  %.0.i = phi ptr [ %i.p, %bb.e ], [ %i.a, %bb.b ] ; 2 uses
  %i.j = icmp ugt i64 %.030.i, 1023
...
bb.e:                                             ; preds = %bb.d, %.preheader12
  %.1.i = phi i64 [ 8, %bb.d ], [ %.030.i, %.preheader12 ] ; 3 uses
  %i.l = sub nuw nsw i64 1024, %.1.i
  %i.m = tail call i64 @llvm.umin.i64(i64 %.029.i, i64 %i.l) ; 4 uses
...
.preheader:                                       ; preds = %bb.f, %bb.i
  %.030.i6 = phi i64 [ %i.ae, %bb.i ], [ %i.r, %bb.f ] ; 2 uses
  %.029.i7 = phi i64 [ %i.ag, %bb.i ], [ 4, %bb.f ] ; 2 uses
  %.0.i8 = phi ptr [ %i.af, %bb.i ], [ %1, %bb.f ] ; 2 uses
  %i.z = icmp ugt i64 %.030.i6, 1023
...
bb.i:                                             ; preds = %bb.h, %.preheader
  %.1.i9 = phi i64 [ 8, %bb.h ], [ %.030.i6, %.preheader ] ; 3 uses
  %i.ab = sub nuw nsw i64 1024, %.1.i9
  %i.ac = tail call i64 @llvm.umin.i64(i64 %.029.i7, i64 %i.ab) ; 4 uses
  ...
  %i.ag = sub i64 %.029.i7, %i.ac                 ; 2 uses
...
.preheader:                                       ; preds = %bb.f, %bb.i
  %.030.i6 = phi i64 [ %i.ad, %bb.i ], [ %i.r, %bb.f ] ; 2 uses
  %.029.i7 = phi i64 [ %i.af, %bb.i ], [ %2, %bb.f ] ; 2 uses
  %.0.i8 = phi ptr [ %i.ae, %bb.i ], [ %1, %bb.f ] ; 2 uses
  %i.y = icmp ugt i64 %.030.i6, 1023
...
bb.i:                                             ; preds = %bb.h, %.preheader
  ...
  %i.ab = tail call i64 @llvm.umin.i64(i64 %.029.i7, i64 %i.aa) ; 4 uses
  ...
  %i.af = sub i64 %.029.i7, %i.ab                 ; 2 uses
...
.preheader:                                       ; preds = %bb.f, %bb.i
  %.030.i6 = phi i64 [ %8, %bb.i ], [ %i.r, %bb.f ] ; 2 uses
  %.029.i7 = phi i64 [ %10, %bb.i ], [ 2, %bb.f ] ; 2 uses
  %.0.i8 = phi ptr [ %9, %bb.i ], [ %1, %bb.f ]   ; 2 uses
  %5 = icmp ugt i64 %.030.i6, 1023
...
bb.i:                                             ; preds = %bb.h, %.preheader
  ...
  %7 = tail call i64 @llvm.umin.i64(i64 %.029.i7, i64 %6) ; 4 uses
...
bb.b:                                             ; preds = %.backedge, %bb.a
  %.020 = phi ptr [ %0, %bb.a ], [ %.020.be, %.backedge ] ; 6 uses
  %i.a = load i32, ptr %.020, align 4
...
.backedge:                                        ; preds = %bb.b, %bb.b
  %.020.be.in = getelementptr inbounds nuw i8, ptr %.020, i64 8
  %.020.be = load ptr, ptr %.020.be.in, align 8
  br label %bb.b

bb.c:                                             ; preds = %bb.b
  %i.b = getelementptr inbounds nuw i8, ptr %.020, i64 4
  %i.c = load i32, ptr %i.b, align 4
  %i.d = icmp eq i32 %i.c, 0
  br label %.thread

bb.d:                                             ; preds = %bb.b
  %i.e = getelementptr inbounds nuw i8, ptr %.020, i64 16
  %i.f = load i32, ptr %i.e, align 8
  %.off = add i32 %i.f, -1
...
bb.e:                                             ; preds = %bb.d
  %i.g = getelementptr inbounds nuw i8, ptr %.020, i64 4
  %i.h = load i32, ptr %i.g, align 4
  %i.i = icmp ugt i32 %i.h, 10000
  br i1 %i.i, label %.thread, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.j = getelementptr inbounds nuw i8, ptr %.020, i64 32
...
.preheader:                                       ; preds = %bb.f, %bb.i
  %.030.i6 = phi i64 [ %i.ae, %bb.i ], [ %i.r, %bb.f ] ; 2 uses
  %.029.i7 = phi i64 [ %i.ag, %bb.i ], [ 8, %bb.f ] ; 2 uses
  %.0.i8 = phi ptr [ %i.af, %bb.i ], [ %1, %bb.f ] ; 2 uses
  %i.z = icmp ugt i64 %.030.i6, 1023
  br i1 %i.z, label %bb.h, label %bb.i, !prof !7
