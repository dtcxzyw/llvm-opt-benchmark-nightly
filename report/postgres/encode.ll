...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %i.f = select <16 x i1> %i.d, <16 x i8> splat (i8 55), <16 x i8> zeroinitializer
  %4 = add nuw nsw <16 x i8> %i.f, %i.e
  %i.g = icmp sgt <16 x i8> %.val2127, splat (i8 96)
  %i.h = select <16 x i1> %i.g, <16 x i8> splat (i8 32), <16 x i8> zeroinitializer
  %5 = add nuw <16 x i8> %4, %i.h
  %i.i = tail call <16 x i8> @llvm.ssub.sat.v16i8(<16 x i8> %.val2127, <16 x i8> %5) ; 2 uses
  ...
  %i.q = select <16 x i1> %i.o, <16 x i8> splat (i8 55), <16 x i8> zeroinitializer
  %6 = add nuw nsw <16 x i8> %i.q, %i.p
  %i.r = icmp sgt <16 x i8> %.val28, splat (i8 96)
  %i.s = select <16 x i1> %i.r, <16 x i8> splat (i8 32), <16 x i8> zeroinitializer
  %7 = add nuw <16 x i8> %6, %i.s
  %i.t = tail call <16 x i8> @llvm.ssub.sat.v16i8(<16 x i8> %.val28, <16 x i8> %7) ; 2 uses
