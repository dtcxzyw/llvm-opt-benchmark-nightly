...
.preheader:                                       ; preds = %bb.k, %bb.c
  ...
  br i1 %i.x, label %.lr.ph211.preheader, label %._crit_edge
...
.lr.ph211.preheader:                              ; preds = %.preheader
  ...
  br i1 %lcmp.mod.not, label %.lr.ph211.prol.loopexit, label %.lr.ph211.prol
...
.preheader.i172:                                  ; preds = %bb.ab, %.preheader.preheader.i169
  ...
  %i.it = icmp slt i32 %.04258.i, %i.l
  br i1 %i.it, label %.lr.ph.i, label %.critedge.thread.thread.i

.lr.ph.i:                                         ; preds = %.preheader.i172
  %i.iu = trunc nuw nsw i64 %indvars.iv64.i to i32
  %i.iv = sitofp i32 %i.iu to float
  %i.iw = sext i32 %.04258.i to i64
  %i.ix = sub i32 %i.l, %.04258.i                 ; 3 uses
  br label %bb.x
...
.thread.i:                                        ; preds = %bb.z, %.critedge.thread.i
  ...
  %i.jp = insertelement <2 x float> %i.jo, float %.04059.i, i64 1
  ...
  %i.jt = fcmp ogt float %.04059.i, 0.000000e+00
...
.critedge.thread.thread.i:                        ; preds = %.critedge.thread.i, %.critedge.i, %.preheader.i172
  %.14349.i = phi i32 [ %i.je, %.critedge.thread.i ], [ %i.jc, %.critedge.i ], [ %.04258.i, %.preheader.i172 ] ; 2 uses
  %i.jx = fcmp ogt float %.04059.i, 0.000000e+00
  br i1 %i.jx, label %bb.aa, label %bb.ab

bb.aa:                                            ; preds = %.critedge.thread.thread.i
  %i.jy = fdiv float %i.is, %.04059.i
  br label %bb.ab
...
bb.ab:                                            ; preds = %bb.aa, %.critedge.thread.thread.i, %.thread.i
  ...
  %i.jz = getelementptr inbounds nuw [4 x i8], ptr %i.ip, i64 %indvars.iv64.i
...
.lr.ph217.preheader:                              ; preds = %bb.ab
  ...
  br i1 %i.ka, label %.lr.ph217.epil.preheader, label %.lr.ph217.preheader.new
...
.lr.ph217:                                        ; preds = %bb.ae, %.lr.ph217.preheader.new
  ...
  %i.kb = getelementptr inbounds nuw [4 x i8], ptr %.165.i, i64 %indvars.iv247
  %i.kc = load float, ptr %i.kb, align 4          ; 2 uses
  %i.kd = fcmp ogt float %i.kc, 0.000000e+00
  br i1 %i.kd, label %bb.ac, label %.lr.ph217.1

bb.ac:                                            ; preds = %.lr.ph217
  %i.ke = getelementptr inbounds nuw [4 x i8], ptr %i.ip, i64 %indvars.iv247
  %i.kf = load float, ptr %i.ke, align 4
  %i.kg = fmul float %i.kf, %i.cr
  %i.kh = getelementptr inbounds nuw [4 x i8], ptr %.064.lcssa.i, i64 %indvars.iv247
  %i.ki = load float, ptr %i.kh, align 4
  %i.kj = fmul float %i.kg, %i.ki
  %i.kk = fdiv float %i.kj, %i.kc
  %i.kl = fadd float %.0130216, %i.kk
  br label %.lr.ph217.1

.lr.ph217.1:                                      ; preds = %.lr.ph217, %bb.ac
  %.1131 = phi float [ %i.kl, %bb.ac ], [ %.0130216, %.lr.ph217 ] ; 2 uses
  %indvars.iv.next248 = or disjoint i64 %indvars.iv247, 1 ; 3 uses
  %i.km = getelementptr inbounds nuw [4 x i8], ptr %.165.i, i64 %indvars.iv.next248
...
bb.ad:                                            ; preds = %.lr.ph217.1
  %i.kp = getelementptr inbounds nuw [4 x i8], ptr %i.ip, i64 %indvars.iv.next248
  %i.kq = load float, ptr %i.kp, align 4
  %i.kr = fmul float %i.kq, %i.cr
  %i.ks = getelementptr inbounds nuw [4 x i8], ptr %.064.lcssa.i, i64 %indvars.iv.next248
...
bb.ae:                                            ; preds = %bb.ad, %.lr.ph217.1
  %.1131.1 = phi float [ %i.kw, %bb.ad ], [ %.1131, %.lr.ph217.1 ] ; 3 uses
...
.lr.ph217.epil.preheader:                         ; preds = %._crit_edge218.loopexit.unr-lcssa, %.lr.ph217.preheader
  ...
  %.0130216.epil.init = phi float [ 0.000000e+00, %.lr.ph217.preheader ], [ %.1131.1, %._crit_edge218.loopexit.unr-lcssa ] ; 2 uses
  %lcmp.mod50 = trunc i32 %smax.i170 to i1
  tail call void @llvm.assume(i1 %lcmp.mod50)
  %i.kx = getelementptr inbounds nuw [4 x i8], ptr %.165.i, i64 %indvars.iv247.epil.init
  %i.ky = load float, ptr %i.kx, align 4          ; 2 uses
  %i.kz = fcmp ogt float %i.ky, 0.000000e+00
  br i1 %i.kz, label %bb.af, label %._crit_edge218

bb.af:                                            ; preds = %.lr.ph217.epil.preheader
  %i.la = getelementptr inbounds nuw [4 x i8], ptr %i.ip, i64 %indvars.iv247.epil.init
  %i.lb = load float, ptr %i.la, align 4
  %i.lc = fmul float %i.lb, %i.cr
  %i.ld = getelementptr inbounds nuw [4 x i8], ptr %.064.lcssa.i, i64 %indvars.iv247.epil.init
  %i.le = load float, ptr %i.ld, align 4
  %i.lf = fmul float %i.lc, %i.le
  %i.lg = fdiv float %i.lf, %i.ky
  %i.lh = fadd float %.0130216.epil.init, %i.lg
  br label %._crit_edge218

._crit_edge218:                                   ; preds = %._crit_edge218.loopexit.unr-lcssa, %bb.af, %.lr.ph217.epil.preheader, %calc_distr.exit168
  %.0130.lcssa = phi float [ 0.000000e+00, %calc_distr.exit168 ], [ %.1131.1, %._crit_edge218.loopexit.unr-lcssa ], [ %i.lh, %bb.af ], [ %.0130216.epil.init, %.lr.ph217.epil.preheader ]
