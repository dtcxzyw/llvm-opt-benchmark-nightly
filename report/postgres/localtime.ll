...
.lr.ph.preheader:                                 ; preds = %bb.w
  ...
  %i.ck = add i64 %.079, %i.cj                    ; 2 uses
  %i.cl = add i64 %i.w, %1                        ; 2 uses
  %3 = icmp ne i64 %i.ck, %i.cl
  %umin = zext i1 %3 to i64                       ; 2 uses
  %i.cm = add i64 %i.cl, %umin
  %i.cn = sub i64 %i.ck, %i.cm
  %i.co = udiv i64 %i.cn, 86400
  %4 = add nuw nsw i64 %i.co, %umin               ; 2 uses
  %i.cp = mul i64 %4, 86400
  %i.cq = add i64 %i.ci, %i.cp
  %i.cr = add i64 %i.cq, 86400
  %i.cs = sub i64 %i.cr, %.079
  %i.ct = trunc i64 %4 to i32
  %i.cu = xor i32 %i.ct, -1
