...
.outer:                                           ; preds = %.preheader91, %bb.ay
  ...
  %.sroa.7.0.ph = phi i16 [ %.sroa.7.0.extract.trunc, %.preheader91 ], [ %.sroa.7.0.copyload, %bb.ay ] ; 3 uses
  ...
  %3 = zext i16 %.sroa.7.0.ph to i32              ; 2 uses
  %i.jb = or disjoint i32 %i.ja, %3               ; 2 uses
