...
bb.n:                                             ; preds = %.loopexit.split-lp, %.loopexit
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %0, ptr nonnull align 8 %2, i64 %i.dt, i1 false), !noalias !23731
  br label %.body
...
.noexc33:                                         ; preds = %bb.g, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared9smallsort11insert_tailTNtNtCskXtk6F4WjxZ_4just9attribute9AttributeNtNtB1d_4name4NameENCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB18_7sort_byNCINvXs1o_NtNtNtB2h_11collections5btree3mapINtB34_8BTreeMapB19_B1Q_EINtNtNtNtBa_4iter6traits7collect12FromIteratorB18_E9from_iterINtNtNtB2h_3vec9into_iter8IntoIterB18_EE0E0EB1d_.exit
  ...
  %i.du = getelementptr inbounds nuw [1424 x i8], ptr %0, i64 %.sroa.05.010
  %.idx = mul nuw nsw i64 %.sroa.05.010, 1424
  %i.dv = getelementptr inbounds nuw i8, ptr %2, i64 %.idx ; 5 uses
...
bb.o:                                             ; preds = %.noexc33
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1424) %i.a, ptr noundef nonnull align 8 dereferenceable(1424) %i.dv, i64 1424, i1 false)
...
._crit_edge:                                      ; preds = %bb.p, %bb.q, %bb.o
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1424) %.sroa.0.0.i32.lcssa, ptr noundef nonnull align 8 dereferenceable(1424) %i.a, i64 1424, i1 false), !noalias !23728
...
bb.r:                                             ; preds = %.loopexit.split-lp21, %.loopexit20
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1424) %.sroa.0.0.i32.lcssa17, ptr noundef nonnull align 8 dereferenceable(1424) %i.a, i64 1424, i1 false), !noalias !23732
  br label %.body
...
bb.k:                                             ; preds = %bb.j
  ...
  %.val14.i = load ptr, ptr %i.aa, align 8, !alias.scope !23766, !noalias !23767, !nonnull !28, !noundef !28 ; 3 uses
  %i.ab = getelementptr i8, ptr %i.y, i64 40
  %.val15.i = load i64, ptr %i.ab, align 8, !alias.scope !23766, !noalias !23767, !noundef !28 ; 3 uses
  %i.ac = getelementptr i8, ptr %i.y, i64 8
  %.val16.i = load ptr, ptr %i.ac, align 8, !alias.scope !23766, !noalias !23767 ; 2 uses
  %i.ad = getelementptr i8, ptr %i.y, i64 16
  %.val17.i = load i64, ptr %i.ad, align 8, !alias.scope !23766, !noalias !23767
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !23768
  call void @_RNvMs16_NtCsaKJjC64KgbL_3std4pathNtB6_4Path10components(ptr noalias nofree noundef nonnull sret([64 x i8]) align 8 captures(none) dereferenceable(64) %i.b, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %.val14.i, i64 noundef %.val15.i), !noalias !23768
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !23768
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.val16.i) ], !noalias !23768
  call void @_RNvMs16_NtCsaKJjC64KgbL_3std4pathNtB6_4Path10components(ptr noalias nofree noundef nonnull sret([64 x i8]) align 8 captures(none) dereferenceable(64) %i.a, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %.val16.i, i64 noundef %.val17.i), !noalias !23768
  %i.ae = call noundef range(i8 -1, 2) i8 @_RNvNtCsaKJjC64KgbL_3std4path18compare_components(ptr noalias nofree noundef nonnull align 8 captures(address) dereferenceable(64) %i.b, ptr noalias nofree noundef nonnull align 8 captures(address) dereferenceable(64) %i.a), !noalias !23768
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !23768
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !23768
...
.lr.ph:                                           ; preds = %.preheader47, %bb.l
  ...
  %.val10.i = load ptr, ptr %i.ah, align 8, !alias.scope !23766, !noalias !23767, !nonnull !28, !noundef !28 ; 2 uses
  %i.ai = getelementptr i8, ptr %i.ag, i64 16
  %.val11.i = load i64, ptr %i.ai, align 8, !alias.scope !23766, !noalias !23767, !noundef !28 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !23768
  call void @_RNvMs16_NtCsaKJjC64KgbL_3std4pathNtB6_4Path10components(ptr noalias nofree noundef nonnull sret([64 x i8]) align 8 captures(none) dereferenceable(64) %i.d, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %.val10.i, i64 noundef %.val11.i), !noalias !23768
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !23768
  call void @_RNvMs16_NtCsaKJjC64KgbL_3std4pathNtB6_4Path10components(ptr noalias nofree noundef nonnull sret([64 x i8]) align 8 captures(none) dereferenceable(64) %i.c, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %.val12.i, i64 noundef %.val13.i), !noalias !23768
  %i.aj = call noundef range(i8 -1, 2) i8 @_RNvNtCsaKJjC64KgbL_3std4path18compare_components(ptr noalias nofree noundef nonnull align 8 captures(address) dereferenceable(64) %i.d, ptr noalias nofree noundef nonnull align 8 captures(address) dereferenceable(64) %i.c), !noalias !23768
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !23768
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !23768
...
bb.l:                                             ; preds = %.lr.ph
  %i.al = add nuw nsw i64 %.sroa.01.0.i.i62, 1    ; 2 uses
...
.lr.ph66:                                         ; preds = %.preheader, %bb.m
  ...
  %.val.i = load ptr, ptr %i.an, align 8, !alias.scope !23766, !noalias !23767, !nonnull !28, !noundef !28 ; 2 uses
  %i.ao = getelementptr i8, ptr %i.am, i64 16
  %.val7.i = load i64, ptr %i.ao, align 8, !alias.scope !23766, !noalias !23767, !noundef !28 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f), !noalias !23768
  call void @_RNvMs16_NtCsaKJjC64KgbL_3std4pathNtB6_4Path10components(ptr noalias nofree noundef nonnull sret([64 x i8]) align 8 captures(none) dereferenceable(64) %i.f, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %.val.i, i64 noundef %.val7.i), !noalias !23768
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e), !noalias !23768
  call void @_RNvMs16_NtCsaKJjC64KgbL_3std4pathNtB6_4Path10components(ptr noalias nofree noundef nonnull sret([64 x i8]) align 8 captures(none) dereferenceable(64) %i.e, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %.val8.i, i64 noundef %.val9.i), !noalias !23768
  %i.ap = call noundef range(i8 -1, 2) i8 @_RNvNtCsaKJjC64KgbL_3std4path18compare_components(ptr noalias nofree noundef nonnull align 8 captures(address) dereferenceable(64) %i.f, ptr noalias nofree noundef nonnull align 8 captures(address) dereferenceable(64) %i.e), !noalias !23768
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e), !noalias !23768
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f), !noalias !23768
...
bb.m:                                             ; preds = %.lr.ph66
  %i.ar = add nuw nsw i64 %.sroa.01.1.i.i65, 1    ; 2 uses
...
bb.p:                                             ; preds = %bb.i
  ...
  call void @_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable9quicksort9quicksortNtNtCsaKJjC64KgbL_3std4path7PathBufNvYB15_NtNtBa_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just(ptr noalias nofree noundef nonnull align 8 %i.y, i64 noundef %..i36, ptr noalias nofree noundef nonnull align 8 %2, i64 noundef range(i64 0, 384307168202282326) %3, i32 noundef 0, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable_or_null(24) null, ptr noalias nofree noundef nonnull %5) #74, !inline_history !23737
...
bb.q:                                             ; preds = %bb.n
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !23769), !noalias !23767
  call void @llvm.experimental.noalias.scope.decl(metadata !23770), !noalias !23767
...
_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCsaKJjC64KgbL_3std4path7PathBuf12split_at_mutCskXtk6F4WjxZ_4just.exit11.i.i: ; preds = %_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCsaKJjC64KgbL_3std4path7PathBuf12split_at_mutCskXtk6F4WjxZ_4just.exit11.i.i, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCsaKJjC64KgbL_3std4path7PathBuf12split_at_mutCskXtk6F4WjxZ_4just.exit11.preheader.i.i
  ...
  %i.be = load <2 x i64>, ptr %i.bc, align 8, !alias.scope !23771, !noalias !23772
  %i.bf = load <2 x i64>, ptr %i.bd, align 8, !alias.scope !23773, !noalias !23774
  store <2 x i64> %i.bf, ptr %i.bc, align 8, !alias.scope !23771, !noalias !23772
  store <2 x i64> %i.be, ptr %i.bd, align 8, !alias.scope !23773, !noalias !23774
  %i.bg = getelementptr inbounds nuw i8, ptr %i.bc, i64 16 ; 2 uses
  %i.bh = getelementptr inbounds nuw i8, ptr %i.bd, i64 16 ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !23775), !noalias !23767
  call void @llvm.experimental.noalias.scope.decl(metadata !23776), !noalias !23767
  %.sroa.0.0.copyload.i.i.i.2.i.i.i.i = load i64, ptr %i.bg, align 8, !alias.scope !23777, !noalias !23778
  %.sroa.02.0.copyload.i.i.i.2.i.i.i.i = load i64, ptr %i.bh, align 8, !alias.scope !23779, !noalias !23780
  store i64 %.sroa.02.0.copyload.i.i.i.2.i.i.i.i, ptr %i.bg, align 8, !alias.scope !23777, !noalias !23778
  store i64 %.sroa.0.0.copyload.i.i.i.2.i.i.i.i, ptr %i.bh, align 8, !alias.scope !23779, !noalias !23780
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.n
  ...
  br i1 %.not.i.i.i.i.i38, label %._crit_edge.i.i.i.i.i51, label %.lr.ph.i.i.i.i.i39

bb.m:                                             ; preds = %.lr.ph.i.i.i.i.i39
  %i.bd = add nuw nsw i64 %.sroa.01.021.i.i.i.i.i40, 1 ; 2 uses
  %exitcond.not.i.i.i.i.i50 = icmp eq i64 %i.bd, %..i.i.i.i.i.i37
  br i1 %exitcond.not.i.i.i.i.i50, label %._crit_edge.i.i.i.i.i51, label %.lr.ph.i.i.i.i.i39

._crit_edge.i.i.i.i.i51:                          ; preds = %bb.m, %.lr.ph
  %i.be = tail call noundef range(i8 -1, 2) i8 @llvm.ucmp.i8.i64(i64 range(i64 0, 384307168202282326) %i.bc, i64 range(i64 0, 384307168202282326) %i.at)
  br label %_RNvYNvYNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBU_3ops8function5FnMutTRB5_B20_EE8call_mutB9_.exit52

.loopexit.i.i.i.i.i47:                            ; preds = %.lr.ph.i.i.i.i.i39
  %i.bf = tail call noundef range(i8 -1, 2) i8 @llvm.scmp.i8.i64(i64 %spec.select.i.i.i.i.i.i.i.i.i46, i64 0)
  br label %_RNvYNvYNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBU_3ops8function5FnMutTRB5_B20_EE8call_mutB9_.exit52

.lr.ph.i.i.i.i.i39:                               ; preds = %.lr.ph, %bb.m
  %.sroa.01.021.i.i.i.i.i40 = phi i64 [ %i.bd, %bb.m ], [ 0, %.lr.ph ] ; 3 uses
  %i.bg = getelementptr inbounds nuw [24 x i8], ptr %i.ba, i64 %.sroa.01.021.i.i.i.i.i40 ; 2 uses
  %i.bh = getelementptr inbounds nuw [24 x i8], ptr %i.au, i64 %.sroa.01.021.i.i.i.i.i40 ; 2 uses
  %i.bi = getelementptr i8, ptr %i.bg, i64 8
  %.val15.i.i.i.i.i41 = load ptr, ptr %i.bi, align 8, !alias.scope !23946, !noalias !23948, !nonnull !28, !noundef !28
  %i.bj = getelementptr i8, ptr %i.bg, i64 16
  %.val16.i.i.i.i.i42 = load i64, ptr %i.bj, align 8, !alias.scope !23946, !noalias !23948, !noundef !28 ; 2 uses
  %i.bk = getelementptr i8, ptr %i.bh, i64 8
  %.val17.i.i.i.i.i43 = load ptr, ptr %i.bk, align 8, !alias.scope !23947, !noalias !23949, !nonnull !28, !noundef !28
  %i.bl = getelementptr i8, ptr %i.bh, i64 16
  %.val18.i.i.i.i.i44 = load i64, ptr %i.bl, align 8, !alias.scope !23947, !noalias !23949, !noundef !28 ; 2 uses
  %spec.store.select.i.i.i.i.i.i.i.i.i45 = tail call i64 @llvm.umin.i64(i64 range(i64 0, -9223372036854775808) %.val16.i.i.i.i.i42, i64 range(i64 0, -9223372036854775808) %.val18.i.i.i.i.i44)
  %i.bm = tail call i32 @memcmp(ptr nonnull readonly %.val15.i.i.i.i.i41, ptr nonnull readonly %.val17.i.i.i.i.i43, i64 %spec.store.select.i.i.i.i.i.i.i.i.i45), !alias.scope !23950, !noalias !23951 ; 2 uses
  %i.bn = sext i32 %i.bm to i64
  %i.bo = icmp eq i32 %i.bm, 0
  %i.bp = sub nsw i64 %.val16.i.i.i.i.i42, %.val18.i.i.i.i.i44
  %spec.select.i.i.i.i.i.i.i.i.i46 = select i1 %i.bo, i64 %i.bp, i64 %i.bn ; 2 uses
  %i.bq = icmp eq i64 %spec.select.i.i.i.i.i.i.i.i.i46, 0
  br i1 %i.bq, label %bb.m, label %.loopexit.i.i.i.i.i47

_RNvYNvYNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBU_3ops8function5FnMutTRB5_B20_EE8call_mutB9_.exit52: ; preds = %._crit_edge.i.i.i.i.i51, %.loopexit.i.i.i.i.i47
  %.sroa.0.0.i.i.i.i.i48 = phi i8 [ %i.be, %._crit_edge.i.i.i.i.i51 ], [ %i.bf, %.loopexit.i.i.i.i.i47 ] ; 2 uses
  %i.br = icmp eq i8 %.sroa.0.0.i.i.i.i.i48, 0
  %i.bs = getelementptr inbounds nuw i8, ptr %i.av, i64 24
  %i.bt = load i8, ptr %i.bs, align 8, !range !40, !alias.scope !23952, !noalias !23953
  %i.bu = getelementptr inbounds nuw i8, ptr %i.ay, i64 24
  %i.bv = load i8, ptr %i.bu, align 8, !range !40, !alias.scope !23954, !noalias !23955
  %i.bw = sub nsw i8 %i.bt, %i.bv
  %.sroa.0.0.i.i.i.i49 = select i1 %i.br, i8 %i.bw, i8 %.sroa.0.0.i.i.i.i.i48
  %i.bx = icmp slt i8 %.sroa.0.0.i.i.i.i49, 0
  br i1 %i.bx, label %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB12_NtNtB8_3cmp10PartialOrd2ltEB16_.exit.i, label %bb.n

bb.n:                                             ; preds = %_RNvYNvYNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBU_3ops8function5FnMutTRB5_B20_EE8call_mutB9_.exit52
  %i.by = add nuw nsw i64 %.sroa.01.0.i.i88, 1    ; 2 uses
  %exitcond.not = icmp eq i64 %i.by, %umax
  br i1 %exitcond.not, label %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB12_NtNtB8_3cmp10PartialOrd2ltEB16_.exit.i, label %.lr.ph

.lr.ph91:                                         ; preds = %.lr.ph91.preheader, %bb.p
  %i.bz = phi i64 [ %i.ci, %bb.p ], [ %i.t, %.lr.ph91.preheader ] ; 2 uses
  %i.ca = phi ptr [ %i.cg, %bb.p ], [ %i.r, %.lr.ph91.preheader ]
  %.sroa.01.1.i.i90 = phi i64 [ %i.de, %bb.p ], [ 2, %.lr.ph91.preheader ] ; 4 uses
  %i.cb = getelementptr inbounds nuw [32 x i8], ptr %i.o, i64 %.sroa.01.1.i.i90 ; 3 uses
  %i.cc = add nsw i64 %.sroa.01.1.i.i90, -1       ; 2 uses
  %i.cd = icmp ult i64 %i.cc, %i.n
  tail call void @llvm.assume(i1 %i.cd)
  %i.ce = getelementptr inbounds nuw [32 x i8], ptr %i.o, i64 %i.cc
  tail call void @llvm.experimental.noalias.scope.decl(metadata !23956)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !23957)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !23958), !noalias !23917
  tail call void @llvm.experimental.noalias.scope.decl(metadata !23959), !noalias !23917
  tail call void @llvm.experimental.noalias.scope.decl(metadata !23960), !noalias !23917
  tail call void @llvm.experimental.noalias.scope.decl(metadata !23961), !noalias !23917
  tail call void @llvm.experimental.noalias.scope.decl(metadata !23962), !noalias !23917
  %i.cf = getelementptr inbounds nuw i8, ptr %i.cb, i64 8
  %i.cg = load ptr, ptr %i.cf, align 8, !alias.scope !23963, !noalias !23964, !nonnull !28, !noundef !28 ; 2 uses
  %i.ch = getelementptr inbounds nuw i8, ptr %i.cb, i64 16
  %i.ci = load i64, ptr %i.ch, align 8, !alias.scope !23963, !noalias !23964, !noundef !28 ; 3 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !23965), !noalias !23917
  tail call void @llvm.experimental.noalias.scope.decl(metadata !23966), !noalias !23917
  %..i.i.i.i.i.i = tail call noundef i64 @llvm.umin.i64(i64 range(i64 0, 384307168202282326) %i.bz, i64 range(i64 0, 384307168202282326) %i.ci) ; 2 uses
...
bb.o:                                             ; preds = %.lr.ph.i.i.i.i.i
  %i.cj = add nuw nsw i64 %.sroa.01.021.i.i.i.i.i, 1 ; 2 uses
  %exitcond.not.i.i.i.i.i = icmp eq i64 %i.cj, %..i.i.i.i.i.i
  br i1 %exitcond.not.i.i.i.i.i, label %._crit_edge.i.i.i.i.i, label %.lr.ph.i.i.i.i.i

._crit_edge.i.i.i.i.i:                            ; preds = %bb.o, %.lr.ph91
  %i.ck = tail call noundef range(i8 -1, 2) i8 @llvm.ucmp.i8.i64(i64 range(i64 0, 384307168202282326) %i.ci, i64 range(i64 0, 384307168202282326) %i.bz)
  br label %_RNvYNvYNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBU_3ops8function5FnMutTRB5_B20_EE8call_mutB9_.exit

.loopexit.i.i.i.i.i:                              ; preds = %.lr.ph.i.i.i.i.i
  %i.cl = tail call noundef range(i8 -1, 2) i8 @llvm.scmp.i8.i64(i64 %spec.select.i.i.i.i.i.i.i.i.i, i64 0)
  br label %_RNvYNvYNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBU_3ops8function5FnMutTRB5_B20_EE8call_mutB9_.exit

.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph91, %bb.o
  %.sroa.01.021.i.i.i.i.i = phi i64 [ %i.cj, %bb.o ], [ 0, %.lr.ph91 ] ; 3 uses
  %i.cm = getelementptr inbounds nuw [24 x i8], ptr %i.cg, i64 %.sroa.01.021.i.i.i.i.i ; 2 uses
  %i.cn = getelementptr inbounds nuw [24 x i8], ptr %i.ca, i64 %.sroa.01.021.i.i.i.i.i ; 2 uses
  %i.co = getelementptr i8, ptr %i.cm, i64 8
  %.val15.i.i.i.i.i = load ptr, ptr %i.co, align 8, !alias.scope !23965, !noalias !23967, !nonnull !28, !noundef !28
  %i.cp = getelementptr i8, ptr %i.cm, i64 16
  %.val16.i.i.i.i.i = load i64, ptr %i.cp, align 8, !alias.scope !23965, !noalias !23967, !noundef !28 ; 2 uses
  %i.cq = getelementptr i8, ptr %i.cn, i64 8
  %.val17.i.i.i.i.i = load ptr, ptr %i.cq, align 8, !alias.scope !23966, !noalias !23968, !nonnull !28, !noundef !28
  %i.cr = getelementptr i8, ptr %i.cn, i64 16
  %.val18.i.i.i.i.i = load i64, ptr %i.cr, align 8, !alias.scope !23966, !noalias !23968, !noundef !28 ; 2 uses
  %spec.store.select.i.i.i.i.i.i.i.i.i = tail call i64 @llvm.umin.i64(i64 range(i64 0, -9223372036854775808) %.val16.i.i.i.i.i, i64 range(i64 0, -9223372036854775808) %.val18.i.i.i.i.i)
  %i.cs = tail call i32 @memcmp(ptr nonnull readonly %.val15.i.i.i.i.i, ptr nonnull readonly %.val17.i.i.i.i.i, i64 %spec.store.select.i.i.i.i.i.i.i.i.i), !alias.scope !23969, !noalias !23970 ; 2 uses
  %i.ct = sext i32 %i.cs to i64
  %i.cu = icmp eq i32 %i.cs, 0
  %i.cv = sub nsw i64 %.val16.i.i.i.i.i, %.val18.i.i.i.i.i
  %spec.select.i.i.i.i.i.i.i.i.i = select i1 %i.cu, i64 %i.cv, i64 %i.ct ; 2 uses
  %i.cw = icmp eq i64 %spec.select.i.i.i.i.i.i.i.i.i, 0
  br i1 %i.cw, label %bb.o, label %.loopexit.i.i.i.i.i

_RNvYNvYNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBU_3ops8function5FnMutTRB5_B20_EE8call_mutB9_.exit: ; preds = %._crit_edge.i.i.i.i.i, %.loopexit.i.i.i.i.i
  %.sroa.0.0.i.i.i.i.i = phi i8 [ %i.ck, %._crit_edge.i.i.i.i.i ], [ %i.cl, %.loopexit.i.i.i.i.i ] ; 2 uses
  %i.cx = icmp eq i8 %.sroa.0.0.i.i.i.i.i, 0
  %i.cy = getelementptr inbounds nuw i8, ptr %i.cb, i64 24
  %i.cz = load i8, ptr %i.cy, align 8, !range !40, !alias.scope !23971, !noalias !23972
  %i.da = getelementptr inbounds nuw i8, ptr %i.ce, i64 24
  %i.db = load i8, ptr %i.da, align 8, !range !40, !alias.scope !23973, !noalias !23974
  %i.dc = sub nsw i8 %i.cz, %i.db
  %.sroa.0.0.i.i.i.i = select i1 %i.cx, i8 %i.dc, i8 %.sroa.0.0.i.i.i.i.i
  %i.dd = icmp slt i8 %.sroa.0.0.i.i.i.i, 0
  br i1 %i.dd, label %bb.p, label %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB12_NtNtB8_3cmp10PartialOrd2ltEB16_.exit.i

bb.p:                                             ; preds = %_RNvYNvYNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBU_3ops8function5FnMutTRB5_B20_EE8call_mutB9_.exit
  %i.de = add nuw nsw i64 %.sroa.01.1.i.i90, 1    ; 2 uses
  %exitcond116.not = icmp eq i64 %i.de, %umax115
  br i1 %exitcond116.not, label %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB12_NtNtB8_3cmp10PartialOrd2ltEB16_.exit.i, label %.lr.ph91

_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB12_NtNtB8_3cmp10PartialOrd2ltEB16_.exit.i: ; preds = %bb.n, %_RNvYNvYNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBU_3ops8function5FnMutTRB5_B20_EE8call_mutB9_.exit52, %bb.p, %_RNvYNvYNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBU_3ops8function5FnMutTRB5_B20_EE8call_mutB9_.exit
  %.sroa.0.0.i.i = phi i64 [ %.sroa.01.1.i.i90, %_RNvYNvYNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBU_3ops8function5FnMutTRB5_B20_EE8call_mutB9_.exit ], [ %umax115, %bb.p ], [ %.sroa.01.0.i.i88, %_RNvYNvYNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBU_3ops8function5FnMutTRB5_B20_EE8call_mutB9_.exit52 ], [ %umax, %bb.n ] ; 6 uses
  %i.df = icmp samesign ule i64 %.sroa.0.0.i.i, %i.n
  tail call void @llvm.assume(i1 %i.df)
  %.not5.i = icmp ult i64 %.sroa.0.0.i.i, %.sroa.01.0
  br i1 %.not5.i, label %bb.i, label %bb.q

_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB12_NtNtB8_3cmp10PartialOrd2ltEB16_.exit.i.thread147: ; preds = %.preheader
  br i1 %.not5.i149, label %bb.i, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath12split_at_mutBy_.exit11.preheader.i.i

_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB12_NtNtB8_3cmp10PartialOrd2ltEB16_.exit.i.thread: ; preds = %.preheader78
  br i1 %.not5.i144, label %bb.i, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath7reverseBy_.exit

bb.q:                                             ; preds = %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB12_NtNtB8_3cmp10PartialOrd2ltEB16_.exit.i
  br i1 %i.as, label %bb.t, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath7reverseBy_.exit

bb.r:                                             ; preds = %bb.i
  %..i36 = tail call noundef i64 @llvm.umin.i64(i64 range(i64 0, 288230376151711744) %i.n, i64 %.sroa.01.0)
  %i.dg = shl nuw nsw i64 %..i36, 1
  br label %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift10create_runNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB13_NtNtBa_3cmp10PartialOrd2ltEB17_.exit

bb.s:                                             ; preds = %bb.i
  %..i35 = tail call noundef i64 @llvm.umin.i64(i64 range(i64 0, 288230376151711744) %i.n, i64 32) ; 2 uses
  tail call void @_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable9quicksort9quicksortNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB15_NtNtBa_3cmp10PartialOrd2ltEB19_(ptr noalias nofree noundef nonnull align 8 %i.o, i64 noundef %..i35, ptr noalias nofree noundef nonnull align 8 %2, i64 noundef range(i64 0, 288230376151711744) %3, i32 noundef 0, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable_or_null(32) null, ptr noalias nofree noundef nonnull %5) #74, !inline_history !23851
  %i.dh = shl nuw nsw i64 %..i35, 1
  %i.di = or disjoint i64 %i.dh, 1
  br label %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift10create_runNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB13_NtNtBa_3cmp10PartialOrd2ltEB17_.exit

_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath7reverseBy_.exit: ; preds = %_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath12split_at_mutBy_.exit11.i.i, %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB12_NtNtB8_3cmp10PartialOrd2ltEB16_.exit.i.thread, %bb.j, %bb.t, %bb.q
  %.sroa.0.0.i.i7376 = phi i64 [ %i.n, %bb.j ], [ %.sroa.0.0.i.i, %bb.q ], [ %.sroa.0.0.i.i, %bb.t ], [ 2, %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB12_NtNtB8_3cmp10PartialOrd2ltEB16_.exit.i.thread ], [ %.sroa.0.0.i.i145152156, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath12split_at_mutBy_.exit11.i.i ]
  %i.dj = shl nuw nsw i64 %.sroa.0.0.i.i7376, 1
  %i.dk = or disjoint i64 %i.dj, 1
  br label %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift10create_runNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB13_NtNtBa_3cmp10PartialOrd2ltEB17_.exit

bb.t:                                             ; preds = %bb.q
  %i.dl = lshr i64 %.sroa.0.0.i.i, 1              ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !23975), !noalias !23917
  tail call void @llvm.experimental.noalias.scope.decl(metadata !23976), !noalias !23917
  %.not.i.i = icmp eq i64 %i.dl, 0
  br i1 %.not.i.i, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath7reverseBy_.exit, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath12split_at_mutBy_.exit11.preheader.i.i

_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath12split_at_mutBy_.exit11.preheader.i.i: ; preds = %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB12_NtNtB8_3cmp10PartialOrd2ltEB16_.exit.i.thread147, %bb.t
  %i.dm = phi i64 [ %i.dl, %bb.t ], [ 1, %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB12_NtNtB8_3cmp10PartialOrd2ltEB16_.exit.i.thread147 ]
  %.sroa.0.0.i.i145152156 = phi i64 [ %.sroa.0.0.i.i, %bb.t ], [ 2, %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB12_NtNtB8_3cmp10PartialOrd2ltEB16_.exit.i.thread147 ] ; 2 uses
  %i.dn = getelementptr inbounds nuw [32 x i8], ptr %i.o, i64 %.sroa.0.0.i.i145152156
  br label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath12split_at_mutBy_.exit11.i.i

_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath12split_at_mutBy_.exit11.i.i: ; preds = %_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath12split_at_mutBy_.exit11.i.i, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath12split_at_mutBy_.exit11.preheader.i.i
  %.sroa.0.016.i.i = phi i64 [ %i.dx, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath12split_at_mutBy_.exit11.i.i ], [ 0, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath12split_at_mutBy_.exit11.preheader.i.i ] ; 3 uses
  %i.do = xor i64 %.sroa.0.016.i.i, -1
  %i.dp = getelementptr inbounds nuw [32 x i8], ptr %i.o, i64 %.sroa.0.016.i.i ; 3 uses
  %i.dq = getelementptr [32 x i8], ptr %i.dn, i64 %i.do ; 3 uses
  %i.dr = load <2 x i64>, ptr %i.dp, align 8, !alias.scope !23977, !noalias !23978
  %i.ds = load <2 x i64>, ptr %i.dq, align 8, !alias.scope !23979, !noalias !23980
  store <2 x i64> %i.ds, ptr %i.dp, align 8, !alias.scope !23977, !noalias !23978
  store <2 x i64> %i.dr, ptr %i.dq, align 8, !alias.scope !23979, !noalias !23980
  %i.dt = getelementptr inbounds nuw i8, ptr %i.dp, i64 16 ; 2 uses
  %i.du = getelementptr inbounds nuw i8, ptr %i.dq, i64 16 ; 2 uses
  %i.dv = load <2 x i64>, ptr %i.dt, align 8, !alias.scope !23981, !noalias !23978
  %i.dw = load <2 x i64>, ptr %i.du, align 8, !alias.scope !23982, !noalias !23980
  store <2 x i64> %i.dw, ptr %i.dt, align 8, !alias.scope !23981, !noalias !23978
  store <2 x i64> %i.dv, ptr %i.du, align 8, !alias.scope !23982, !noalias !23980
  %i.dx = add nuw nsw i64 %.sroa.0.016.i.i, 1     ; 2 uses
  %exitcond.not.i.i = icmp eq i64 %i.dx, %i.dm
  br i1 %exitcond.not.i.i, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath7reverseBy_.exit, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath12split_at_mutBy_.exit11.i.i

_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift10create_runNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB13_NtNtBa_3cmp10PartialOrd2ltEB17_.exit: ; preds = %bb.r, %bb.s, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath7reverseBy_.exit
  %.sroa.0.0.i32 = phi i64 [ %i.dk, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSNtNtCskXtk6F4WjxZ_4just10modulepath10Modulepath7reverseBy_.exit ], [ %i.di, %bb.s ], [ %i.dg, %bb.r ] ; 2 uses
  %i.dy = lshr i64 %.sroa.023.0, 1
  %i.dz = lshr i64 %.sroa.0.0.i32, 1
  %factor = shl nuw nsw i64 %.sroa.09.0, 1        ; 2 uses
  %i.ea = sub nsw i64 %factor, %i.dy
  %i.eb = add nuw nsw i64 %i.dz, %factor
  %i.ec = mul i64 %i.ea, %.sroa.0.0
  %i.ed = mul i64 %i.eb, %.sroa.0.0
  %i.ee = xor i64 %i.ed, %i.ec
  %i.ef = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.ee, i1 false)
  %i.eg = trunc nuw nsw i64 %i.ef to i8
  br label %bb.g

bb.u:                                             ; preds = %.lr.ph96, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB16_NtNtBa_3cmp10PartialOrd2ltEB1a_.exit
  %.sroa.02.195 = phi i64 [ %.sroa.02.0, %.lr.ph96 ], [ %i.eh, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB16_NtNtBa_3cmp10PartialOrd2ltEB1a_.exit ] ; 2 uses
  %.sroa.023.194 = phi i64 [ %.sroa.023.0, %.lr.ph96 ], [ %.sroa.0.0.i, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB16_NtNtBa_3cmp10PartialOrd2ltEB1a_.exit ] ; 4 uses
  %i.eh = add i64 %.sroa.02.195, -1               ; 4 uses
  %i.ei = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.eh
  %i.ej = load i8, ptr %i.ei, align 1, !noundef !28
  %.not28 = icmp ult i8 %i.ej, %.sroa.021.0
  br i1 %.not28, label %._crit_edge, label %bb.v

._crit_edge:                                      ; preds = %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB16_NtNtBa_3cmp10PartialOrd2ltEB1a_.exit, %bb.u, %bb.g
  %.sroa.023.1.lcssa = phi i64 [ %.sroa.023.0, %bb.g ], [ %.sroa.023.194, %bb.u ], [ %.sroa.0.0.i, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB16_NtNtBa_3cmp10PartialOrd2ltEB1a_.exit ] ; 2 uses
  %.sroa.02.1.lcssa = phi i64 [ %.sroa.02.0, %bb.g ], [ %.sroa.02.195, %bb.u ], [ 1, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB16_NtNtBa_3cmp10PartialOrd2ltEB1a_.exit ] ; 3 uses
  %i.ek = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %.sroa.02.1.lcssa
  store i64 %.sroa.023.1.lcssa, ptr %i.ek, align 8
  %i.el = getelementptr inbounds nuw i8, ptr %i.a, i64 %.sroa.02.1.lcssa
  store i8 %.sroa.021.0, ptr %i.el, align 1
  br i1 %i.k, label %bb.af, label %bb.ag

bb.v:                                             ; preds = %bb.u
  %i.em = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %i.eh
  %i.en = load i64, ptr %i.em, align 8, !noundef !28 ; 3 uses
  %i.eo = lshr i64 %i.en, 1                       ; 8 uses
  %i.ep = lshr i64 %.sroa.023.194, 1              ; 6 uses
  %i.eq = add nuw i64 %i.eo, %i.ep                ; 4 uses
  %i.er = sub i64 %.sroa.09.0, %i.eq
  %i.es = getelementptr inbounds nuw [32 x i8], ptr %0, i64 %i.er ; 6 uses
  %i.et = icmp samesign ugt i64 %i.eq, %3
  %i.eu = trunc i64 %.sroa.023.194 to i1
  %i.ev = or i64 %i.en, %.sroa.023.194
  %i.ew = trunc i64 %i.ev to i1
  %or.cond3.i = or i1 %i.et, %i.ew
  br i1 %or.cond3.i, label %bb.w, label %bb.x

bb.w:                                             ; preds = %bb.v
  %i.ex = trunc i64 %i.en to i1
  br i1 %i.ex, label %bb.y, label %bb.z

bb.x:                                             ; preds = %bb.v
  %i.ey = shl nuw nsw i64 %i.eq, 1
...
bb.y:                                             ; preds = %bb.z, %bb.w
  br i1 %i.eu, label %bb.ab, label %bb.aa
...
bb.z:                                             ; preds = %bb.w
  ...
  tail call void @_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable9quicksort9quicksortNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB15_NtNtBa_3cmp10PartialOrd2ltEB19_(ptr noalias nofree noundef nonnull align 8 %i.es, i64 noundef range(i64 0, 288230376151711744) %i.eo, ptr noalias nofree noundef nonnull align 8 %2, i64 noundef range(i64 0, 288230376151711744) %3, i32 noundef %i.fd, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable_or_null(32) null, ptr noalias nofree noundef nonnull %5) #74, !inline_history !23866
  br label %bb.y

bb.aa:                                            ; preds = %bb.y
  %i.fe = getelementptr inbounds nuw [32 x i8], ptr %i.es, i64 %i.eo
  %i.ff = or i64 %i.ep, 1
  %i.fg = tail call range(i64 6, 64) i64 @llvm.ctlz.i64(i64 %i.ff, i1 true)
  %i.fh = trunc nuw nsw i64 %i.fg to i32
  %i.fi = shl nuw nsw i32 %i.fh, 1
  %i.fj = xor i32 %i.fi, 126
  tail call void @_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable9quicksort9quicksortNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYB15_NtNtBa_3cmp10PartialOrd2ltEB19_(ptr noalias nofree noundef nonnull align 8 %i.fe, i64 noundef range(i64 0, 288230376151711744) %i.ep, ptr noalias nofree noundef nonnull align 8 %2, i64 noundef range(i64 0, 288230376151711744) %3, i32 noundef %i.fj, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable_or_null(32) null, ptr noalias nofree noundef nonnull %5) #74, !inline_history !23866
  br label %bb.ab

bb.ab:                                            ; preds = %bb.aa, %bb.y
  tail call void @llvm.experimental.noalias.scope.decl(metadata !23983)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !23984)
  %i.fk = icmp eq i64 %i.eo, 0
  %i.fl = icmp eq i64 %i.ep, 0
  %or.cond.i = or i1 %i.fl, %i.fk
  br i1 %or.cond.i, label %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5merge5mergeNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYBX_NtNtBa_3cmp10PartialOrd2ltEB11_.exit, label %bb.ac

bb.ac:                                            ; preds = %bb.ab
  %..i.i = tail call i64 @llvm.umin.i64(i64 %i.ep, i64 range(i64 0, -9223372036854775808) %i.eo) ; 2 uses
  %i.fm = icmp samesign ult i64 %3, %..i.i
...
end_hunk_1
begin_hunk_2_@_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift4sortNtNtCskXtk6F4WjxZ_4just10modulepath10ModulepathNvYBW_NtNtBa_3cmp10PartialOrd2ltEB10_:bb.a
...
end_hunk_2
begin_hunk_3_@_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift4sortNtNtCskXtk6F4WjxZ_4just6signal6SignalNvYBW_NtNtBa_3cmp10PartialOrd2ltEB10_:bb.a
  br label %bb.ae
...
.loopexit.i.i.i.i.i.i.i.i.i48:                    ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i44
  %i.ar = tail call noundef range(i8 -1, 2) i8 @llvm.ucmp.i8.i64(i64 %.val15.i.i.i.i.i.i.i.i.i46, i64 %.val16.i.i.i.i.i.i.i.i.i47)
  br label %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe11sort_by_keyTRINtNtB7_3vec3VecjEjENCNvMNtBD_8justfileNtB1O_8Justfile14public_recipess_0E0BD_.exit54

.lr.ph.i.i.i.i.i.i.i.i.i44:                       ; preds = %.lr.ph, %bb.m
  %.sroa.01.019.i.i.i.i.i.i.i.i.i45 = phi i64 [ %i.ap, %bb.m ], [ 0, %.lr.ph ] ; 3 uses
  %i.as = getelementptr inbounds nuw [8 x i8], ptr %.val.i.i.i38, i64 %.sroa.01.019.i.i.i.i.i.i.i.i.i45
  %i.at = getelementptr inbounds nuw [8 x i8], ptr %.val2.i.i.i40, i64 %.sroa.01.019.i.i.i.i.i.i.i.i.i45
  %.val15.i.i.i.i.i.i.i.i.i46 = load i64, ptr %i.as, align 8, !alias.scope !24161, !noalias !24162, !noundef !28 ; 2 uses
  %.val16.i.i.i.i.i.i.i.i.i47 = load i64, ptr %i.at, align 8, !alias.scope !24163, !noalias !24164, !noundef !28 ; 2 uses
  %i.au = icmp eq i64 %.val15.i.i.i.i.i.i.i.i.i46, %.val16.i.i.i.i.i.i.i.i.i47
  br i1 %i.au, label %bb.m, label %.loopexit.i.i.i.i.i.i.i.i.i48

_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe11sort_by_keyTRINtNtB7_3vec3VecjEjENCNvMNtBD_8justfileNtB1O_8Justfile14public_recipess_0E0BD_.exit54: ; preds = %._crit_edge.i.i.i.i.i.i.i.i.i53, %.loopexit.i.i.i.i.i.i.i.i.i48
  %.sroa.0.0.i.i.i.i.i.i.i.i.i49 = phi i8 [ %i.aq, %._crit_edge.i.i.i.i.i.i.i.i.i53 ], [ %i.ar, %.loopexit.i.i.i.i.i.i.i.i.i48 ] ; 2 uses
  %cond.i.i.i.i.i50 = icmp eq i8 %.sroa.0.0.i.i.i.i.i.i.i.i.i49, 0
  %i.av = icmp slt i8 %.sroa.0.0.i.i.i.i.i.i.i.i.i49, 0
  %i.aw = icmp ult i64 %i.am, %i.ah
  %.sroa.0.0.i.i51 = select i1 %cond.i.i.i.i.i50, i1 %i.aw, i1 %i.av
  br i1 %.sroa.0.0.i.i51, label %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB12_11sort_by_keyTRINtNtB1M_3vec3VecjEjENCNvMNtB17_8justfileNtB2W_8Justfile14public_recipess_0E0EB17_.exit.i, label %bb.n

bb.n:                                             ; preds = %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe11sort_by_keyTRINtNtB7_3vec3VecjEjENCNvMNtBD_8justfileNtB1O_8Justfile14public_recipess_0E0BD_.exit54
  %i.ax = add nuw nsw i64 %.sroa.01.0.i.i96, 1    ; 2 uses
  %exitcond.not = icmp eq i64 %i.ax, %umax
  br i1 %exitcond.not, label %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB12_11sort_by_keyTRINtNtB1M_3vec3VecjEjENCNvMNtB17_8justfileNtB2W_8Justfile14public_recipess_0E0EB17_.exit.i, label %.lr.ph

.lr.ph99:                                         ; preds = %.lr.ph99.preheader, %bb.p
  %.val3.i.i.i = phi i64 [ %.val1.i.i.i, %bb.p ], [ %.val1.i.i.i56, %.lr.ph99.preheader ] ; 2 uses
  %.val2.i.i.i = phi ptr [ %.val.i.i.i, %bb.p ], [ %.val.i.i.i55, %.lr.ph99.preheader ]
  %i.ay = phi i64 [ %i.bd, %bb.p ], [ %i.s, %.lr.ph99.preheader ]
  %.sroa.01.1.i.i98 = phi i64 [ %i.bo, %bb.p ], [ 2, %.lr.ph99.preheader ] ; 4 uses
  %i.az = getelementptr inbounds nuw [8 x i8], ptr %i.o, i64 %.sroa.01.1.i.i98
  %i.ba = add nsw i64 %.sroa.01.1.i.i98, -1
  %i.bb = icmp ult i64 %i.ba, %i.n
  tail call void @llvm.assume(i1 %i.bb)
  %.val.i = load ptr, ptr %i.az, align 8, !alias.scope !24142, !noalias !24143, !nonnull !28, !align !35, !noundef !28 ; 3 uses
  %i.bc = getelementptr inbounds nuw i8, ptr %.val.i, i64 240
  %i.bd = load i64, ptr %i.bc, align 8, !noalias !24144, !noundef !28 ; 2 uses
  %i.be = getelementptr i8, ptr %.val.i, i64 56
  %.val.i.i.i = load ptr, ptr %i.be, align 8, !noalias !24144, !nonnull !28, !noundef !28 ; 2 uses
  %i.bf = getelementptr i8, ptr %.val.i, i64 64
  %.val1.i.i.i = load i64, ptr %i.bf, align 8, !noalias !24144, !noundef !28 ; 3 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24165), !noalias !24144
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24166), !noalias !24144
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24167), !noalias !24144
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24168), !noalias !24144
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24169), !noalias !24144
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24170), !noalias !24144
...
bb.o:                                             ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i
  %i.bg = add nuw nsw i64 %.sroa.01.019.i.i.i.i.i.i.i.i.i, 1 ; 2 uses
  %exitcond.not.i.i.i.i.i.i.i.i.i = icmp eq i64 %i.bg, %..i.i.i.i.i.i.i.i.i.i
  br i1 %exitcond.not.i.i.i.i.i.i.i.i.i, label %._crit_edge.i.i.i.i.i.i.i.i.i, label %.lr.ph.i.i.i.i.i.i.i.i.i

._crit_edge.i.i.i.i.i.i.i.i.i:                    ; preds = %bb.o, %.lr.ph99
  %i.bh = tail call noundef range(i8 -1, 2) i8 @llvm.ucmp.i8.i64(i64 range(i64 0, 1152921504606846976) %.val1.i.i.i, i64 range(i64 0, 1152921504606846976) %.val3.i.i.i)
...
.loopexit.i.i.i.i.i.i.i.i.i:                      ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i
  %i.bi = tail call noundef range(i8 -1, 2) i8 @llvm.ucmp.i8.i64(i64 %.val15.i.i.i.i.i.i.i.i.i, i64 %.val16.i.i.i.i.i.i.i.i.i)
  br label %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe11sort_by_keyTRINtNtB7_3vec3VecjEjENCNvMNtBD_8justfileNtB1O_8Justfile14public_recipess_0E0BD_.exit

.lr.ph.i.i.i.i.i.i.i.i.i:                         ; preds = %.lr.ph99, %bb.o
  %.sroa.01.019.i.i.i.i.i.i.i.i.i = phi i64 [ %i.bg, %bb.o ], [ 0, %.lr.ph99 ] ; 3 uses
  %i.bj = getelementptr inbounds nuw [8 x i8], ptr %.val.i.i.i, i64 %.sroa.01.019.i.i.i.i.i.i.i.i.i
  %i.bk = getelementptr inbounds nuw [8 x i8], ptr %.val2.i.i.i, i64 %.sroa.01.019.i.i.i.i.i.i.i.i.i
  %.val15.i.i.i.i.i.i.i.i.i = load i64, ptr %i.bj, align 8, !alias.scope !24171, !noalias !24172, !noundef !28 ; 2 uses
  %.val16.i.i.i.i.i.i.i.i.i = load i64, ptr %i.bk, align 8, !alias.scope !24173, !noalias !24174, !noundef !28 ; 2 uses
  %i.bl = icmp eq i64 %.val15.i.i.i.i.i.i.i.i.i, %.val16.i.i.i.i.i.i.i.i.i
  br i1 %i.bl, label %bb.o, label %.loopexit.i.i.i.i.i.i.i.i.i
...
_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe11sort_by_keyTRINtNtB7_3vec3VecjEjENCNvMNtBD_8justfileNtB1O_8Justfile14public_recipess_0E0BD_.exit: ; preds = %._crit_edge.i.i.i.i.i.i.i.i.i, %.loopexit.i.i.i.i.i.i.i.i.i
  %.sroa.0.0.i.i.i.i.i.i.i.i.i = phi i8 [ %i.bh, %._crit_edge.i.i.i.i.i.i.i.i.i ], [ %i.bi, %.loopexit.i.i.i.i.i.i.i.i.i ] ; 2 uses
  %cond.i.i.i.i.i = icmp eq i8 %.sroa.0.0.i.i.i.i.i.i.i.i.i, 0
  %i.bm = icmp slt i8 %.sroa.0.0.i.i.i.i.i.i.i.i.i, 0
  %i.bn = icmp ult i64 %i.bd, %i.ay
  %.sroa.0.0.i.i37 = select i1 %cond.i.i.i.i.i, i1 %i.bn, i1 %i.bm
  br i1 %.sroa.0.0.i.i37, label %bb.p, label %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB12_11sort_by_keyTRINtNtB1M_3vec3VecjEjENCNvMNtB17_8justfileNtB2W_8Justfile14public_recipess_0E0EB17_.exit.i

bb.p:                                             ; preds = %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe11sort_by_keyTRINtNtB7_3vec3VecjEjENCNvMNtBD_8justfileNtB1O_8Justfile14public_recipess_0E0BD_.exit
  %i.bo = add nuw nsw i64 %.sroa.01.1.i.i98, 1    ; 2 uses
  %exitcond129.not = icmp eq i64 %i.bo, %umax128
  br i1 %exitcond129.not, label %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB12_11sort_by_keyTRINtNtB1M_3vec3VecjEjENCNvMNtB17_8justfileNtB2W_8Justfile14public_recipess_0E0EB17_.exit.i, label %.lr.ph99

_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB12_11sort_by_keyTRINtNtB1M_3vec3VecjEjENCNvMNtB17_8justfileNtB2W_8Justfile14public_recipess_0E0EB17_.exit.i: ; preds = %bb.n, %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe11sort_by_keyTRINtNtB7_3vec3VecjEjENCNvMNtBD_8justfileNtB1O_8Justfile14public_recipess_0E0BD_.exit54, %bb.p, %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe11sort_by_keyTRINtNtB7_3vec3VecjEjENCNvMNtBD_8justfileNtB1O_8Justfile14public_recipess_0E0BD_.exit
  %.sroa.0.0.i.i = phi i64 [ %.sroa.01.1.i.i98, %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe11sort_by_keyTRINtNtB7_3vec3VecjEjENCNvMNtBD_8justfileNtB1O_8Justfile14public_recipess_0E0BD_.exit ], [ %umax128, %bb.p ], [ %.sroa.01.0.i.i96, %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe11sort_by_keyTRINtNtB7_3vec3VecjEjENCNvMNtBD_8justfileNtB1O_8Justfile14public_recipess_0E0BD_.exit54 ], [ %umax, %bb.n ] ; 6 uses
  %i.bp = icmp samesign ule i64 %.sroa.0.0.i.i, %i.n
  tail call void @llvm.assume(i1 %i.bp)
  %.not5.i = icmp ult i64 %.sroa.0.0.i.i, %.sroa.01.0
  br i1 %.not5.i, label %bb.i, label %bb.q

_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB12_11sort_by_keyTRINtNtB1M_3vec3VecjEjENCNvMNtB17_8justfileNtB2W_8Justfile14public_recipess_0E0EB17_.exit.i.thread166: ; preds = %.preheader
  br i1 %.not5.i168, label %bb.i, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe12split_at_mutBz_.exit11.preheader.i.i

_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB12_11sort_by_keyTRINtNtB1M_3vec3VecjEjENCNvMNtB17_8justfileNtB2W_8Justfile14public_recipess_0E0EB17_.exit.i.thread: ; preds = %.preheader81
  br i1 %.not5.i163, label %bb.i, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe7reverseBz_.exit

bb.q:                                             ; preds = %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB12_11sort_by_keyTRINtNtB1M_3vec3VecjEjENCNvMNtB17_8justfileNtB2W_8Justfile14public_recipess_0E0EB17_.exit.i
  br i1 %.sroa.0.0.i.i68, label %bb.t, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe7reverseBz_.exit

bb.r:                                             ; preds = %bb.i
  %..i36 = tail call noundef i64 @llvm.umin.i64(i64 range(i64 0, 1152921504606846976) %i.n, i64 %.sroa.01.0)
  %i.bq = shl nuw nsw i64 %..i36, 1
  br label %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift10create_runRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB13_11sort_by_keyTRINtNtB1N_3vec3VecjEjENCNvMNtB18_8justfileNtB2X_8Justfile14public_recipess_0E0EB18_.exit

bb.s:                                             ; preds = %bb.i
  %..i35 = tail call noundef i64 @llvm.umin.i64(i64 range(i64 0, 1152921504606846976) %i.n, i64 32) ; 2 uses
  tail call void @_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable9quicksort9quicksortRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB15_11sort_by_keyTRINtNtB1P_3vec3VecjEjENCNvMNtB1a_8justfileNtB2Z_8Justfile14public_recipess_0E0EB1a_(ptr noalias nofree noundef nonnull align 8 %i.o, i64 noundef %..i35, ptr noalias nofree noundef nonnull align 8 %2, i64 noundef range(i64 0, 1152921504606846976) %3, i32 noundef 0, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable_or_null(8) null, ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %5) #74, !inline_history !24104
  %i.br = shl nuw nsw i64 %..i35, 1
  %i.bs = or disjoint i64 %i.br, 1
  br label %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift10create_runRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB13_11sort_by_keyTRINtNtB1N_3vec3VecjEjENCNvMNtB18_8justfileNtB2X_8Justfile14public_recipess_0E0EB18_.exit

_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe7reverseBz_.exit: ; preds = %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe12split_at_mutBz_.exit11.i.i, %middle.block, %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB12_11sort_by_keyTRINtNtB1M_3vec3VecjEjENCNvMNtB17_8justfileNtB2W_8Justfile14public_recipess_0E0EB17_.exit.i.thread, %bb.j, %bb.t, %bb.q
  %.sroa.0.0.i.i7679 = phi i64 [ %i.n, %bb.j ], [ %.sroa.0.0.i.i, %bb.q ], [ %.sroa.0.0.i.i, %bb.t ], [ 2, %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB12_11sort_by_keyTRINtNtB1M_3vec3VecjEjENCNvMNtB17_8justfileNtB2W_8Justfile14public_recipess_0E0EB17_.exit.i.thread ], [ %.sroa.0.0.i.i164171175, %middle.block ], [ %.sroa.0.0.i.i164171175, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe12split_at_mutBz_.exit11.i.i ]
  %i.bt = shl nuw nsw i64 %.sroa.0.0.i.i7679, 1
  %i.bu = or disjoint i64 %i.bt, 1
  br label %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift10create_runRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB13_11sort_by_keyTRINtNtB1N_3vec3VecjEjENCNvMNtB18_8justfileNtB2X_8Justfile14public_recipess_0E0EB18_.exit

bb.t:                                             ; preds = %bb.q
  %i.bv = lshr i64 %.sroa.0.0.i.i, 1              ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24175), !noalias !24143
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24176), !noalias !24143
  %.not.i.i = icmp eq i64 %i.bv, 0
  br i1 %.not.i.i, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe7reverseBz_.exit, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe12split_at_mutBz_.exit11.preheader.i.i

_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe12split_at_mutBz_.exit11.preheader.i.i: ; preds = %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB12_11sort_by_keyTRINtNtB1M_3vec3VecjEjENCNvMNtB17_8justfileNtB2W_8Justfile14public_recipess_0E0EB17_.exit.i.thread166, %bb.t
  %i.bw = phi i64 [ %i.bv, %bb.t ], [ 1, %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB12_11sort_by_keyTRINtNtB1M_3vec3VecjEjENCNvMNtB17_8justfileNtB2W_8Justfile14public_recipess_0E0EB17_.exit.i.thread166 ] ; 4 uses
  %.sroa.0.0.i.i164171175 = phi i64 [ %.sroa.0.0.i.i, %bb.t ], [ 2, %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB12_11sort_by_keyTRINtNtB1M_3vec3VecjEjENCNvMNtB17_8justfileNtB2W_8Justfile14public_recipess_0E0EB17_.exit.i.thread166 ] ; 3 uses
  %i.bx = getelementptr inbounds nuw [8 x i8], ptr %i.o, i64 %.sroa.0.0.i.i164171175 ; 2 uses
  %min.iters.check = icmp samesign ult i64 %i.bw, 4
  br i1 %min.iters.check, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe12split_at_mutBz_.exit11.i.i.preheader, label %vector.ph

vector.ph:                                        ; preds = %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe12split_at_mutBz_.exit11.preheader.i.i
  %n.vec = and i64 %i.bw, 9223372036854775804     ; 3 uses
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 3 uses
  %i.by = xor i64 %index, -1
  %i.bz = getelementptr inbounds nuw [8 x i8], ptr %i.o, i64 %index ; 4 uses
  %i.ca = getelementptr [8 x i8], ptr %i.bx, i64 %i.by ; 4 uses
  %i.cb = getelementptr inbounds nuw i8, ptr %i.bz, i64 16
  %wide.load = load <2 x ptr>, ptr %i.bz, align 8, !alias.scope !24177, !noalias !24178
  %wide.load208 = load <2 x ptr>, ptr %i.cb, align 8, !alias.scope !24177, !noalias !24178
  %i.cc = getelementptr i8, ptr %i.ca, i64 -8
  %i.cd = getelementptr i8, ptr %i.ca, i64 -24
  %wide.load209 = load <2 x i64>, ptr %i.cc, align 8, !alias.scope !24179, !noalias !24180
  %wide.load210 = load <2 x i64>, ptr %i.cd, align 8, !alias.scope !24179, !noalias !24180
  %reverse = shufflevector <2 x i64> %wide.load209, <2 x i64> poison, <2 x i32> <i32 1, i32 0>
  %reverse211 = shufflevector <2 x i64> %wide.load210, <2 x i64> poison, <2 x i32> <i32 1, i32 0>
  %i.ce = getelementptr inbounds nuw i8, ptr %i.bz, i64 16
  store <2 x i64> %reverse, ptr %i.bz, align 8, !alias.scope !24177, !noalias !24178
  store <2 x i64> %reverse211, ptr %i.ce, align 8, !alias.scope !24177, !noalias !24178
  %i.cf = getelementptr i8, ptr %i.ca, i64 -8
  %i.cg = getelementptr i8, ptr %i.ca, i64 -24
  %reverse212 = shufflevector <2 x ptr> %wide.load, <2 x ptr> poison, <2 x i32> <i32 1, i32 0>
  %reverse213 = shufflevector <2 x ptr> %wide.load208, <2 x ptr> poison, <2 x i32> <i32 1, i32 0>
  store <2 x ptr> %reverse212, ptr %i.cf, align 8, !alias.scope !24179, !noalias !24180
  store <2 x ptr> %reverse213, ptr %i.cg, align 8, !alias.scope !24179, !noalias !24180
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ch = icmp eq i64 %index.next, %n.vec
  br i1 %i.ch, label %middle.block, label %vector.body, !llvm.loop !24110

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %i.bw, %n.vec
  br i1 %cmp.n, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe7reverseBz_.exit, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe12split_at_mutBz_.exit11.i.i.preheader

_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe12split_at_mutBz_.exit11.i.i.preheader: ; preds = %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe12split_at_mutBz_.exit11.preheader.i.i, %middle.block
  %.sroa.0.016.i.i.ph = phi i64 [ 0, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe12split_at_mutBz_.exit11.preheader.i.i ], [ %n.vec, %middle.block ]
  br label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe12split_at_mutBz_.exit11.i.i

_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe12split_at_mutBz_.exit11.i.i: ; preds = %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe12split_at_mutBz_.exit11.i.i.preheader, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe12split_at_mutBz_.exit11.i.i
  %.sroa.0.016.i.i = phi i64 [ %i.cn, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe12split_at_mutBz_.exit11.i.i ], [ %.sroa.0.016.i.i.ph, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe12split_at_mutBz_.exit11.i.i.preheader ] ; 3 uses
  %i.ci = xor i64 %.sroa.0.016.i.i, -1
  %i.cj = getelementptr inbounds nuw [8 x i8], ptr %i.o, i64 %.sroa.0.016.i.i ; 2 uses
  %i.ck = getelementptr [8 x i8], ptr %i.bx, i64 %i.ci ; 2 uses
  %i.cl = load ptr, ptr %i.cj, align 8, !alias.scope !24177, !noalias !24178, !nonnull !28, !align !35, !noundef !28
  %i.cm = load i64, ptr %i.ck, align 8, !alias.scope !24179, !noalias !24180
  store i64 %i.cm, ptr %i.cj, align 8, !alias.scope !24177, !noalias !24178
  store ptr %i.cl, ptr %i.ck, align 8, !alias.scope !24179, !noalias !24180
  %i.cn = add nuw nsw i64 %.sroa.0.016.i.i, 1     ; 2 uses
  %exitcond.not.i.i = icmp eq i64 %i.cn, %i.bw
  br i1 %exitcond.not.i.i, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe7reverseBz_.exit, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe12split_at_mutBz_.exit11.i.i, !llvm.loop !24111

_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift10create_runRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB13_11sort_by_keyTRINtNtB1N_3vec3VecjEjENCNvMNtB18_8justfileNtB2X_8Justfile14public_recipess_0E0EB18_.exit: ; preds = %bb.r, %bb.s, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe7reverseBz_.exit
  %.sroa.0.0.i32 = phi i64 [ %i.bu, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just6recipe6Recipe7reverseBz_.exit ], [ %i.bs, %bb.s ], [ %i.bq, %bb.r ] ; 2 uses
  %i.co = lshr i64 %.sroa.023.0, 1
  %i.cp = lshr i64 %.sroa.0.0.i32, 1
  %factor = shl nuw nsw i64 %.sroa.09.0, 1        ; 2 uses
  %i.cq = sub nsw i64 %factor, %i.co
  %i.cr = add nuw nsw i64 %i.cp, %factor
  %i.cs = mul i64 %i.cq, %.sroa.0.0
  %i.ct = mul i64 %i.cr, %.sroa.0.0
  %i.cu = xor i64 %i.ct, %i.cs
  %i.cv = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.cu, i1 false)
  %i.cw = trunc nuw nsw i64 %i.cv to i8
  br label %bb.g

bb.u:                                             ; preds = %.lr.ph104, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB16_11sort_by_keyTRINtNtB1Q_3vec3VecjEjENCNvMNtB1b_8justfileNtB30_8Justfile14public_recipess_0E0EB1b_.exit
  %.sroa.02.1103 = phi i64 [ %.sroa.02.0, %.lr.ph104 ], [ %i.cx, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB16_11sort_by_keyTRINtNtB1Q_3vec3VecjEjENCNvMNtB1b_8justfileNtB30_8Justfile14public_recipess_0E0EB1b_.exit ] ; 2 uses
  %.sroa.023.1102 = phi i64 [ %.sroa.023.0, %.lr.ph104 ], [ %.sroa.0.0.i, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB16_11sort_by_keyTRINtNtB1Q_3vec3VecjEjENCNvMNtB1b_8justfileNtB30_8Justfile14public_recipess_0E0EB1b_.exit ] ; 4 uses
  %i.cx = add i64 %.sroa.02.1103, -1              ; 4 uses
  %i.cy = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.cx
  %i.cz = load i8, ptr %i.cy, align 1, !noundef !28
  %.not28 = icmp ult i8 %i.cz, %.sroa.021.0
  br i1 %.not28, label %._crit_edge, label %bb.v

._crit_edge:                                      ; preds = %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB16_11sort_by_keyTRINtNtB1Q_3vec3VecjEjENCNvMNtB1b_8justfileNtB30_8Justfile14public_recipess_0E0EB1b_.exit, %bb.u, %bb.g
  %.sroa.023.1.lcssa = phi i64 [ %.sroa.023.0, %bb.g ], [ %.sroa.023.1102, %bb.u ], [ %.sroa.0.0.i, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB16_11sort_by_keyTRINtNtB1Q_3vec3VecjEjENCNvMNtB1b_8justfileNtB30_8Justfile14public_recipess_0E0EB1b_.exit ] ; 2 uses
  %.sroa.02.1.lcssa = phi i64 [ %.sroa.02.0, %bb.g ], [ %.sroa.02.1103, %bb.u ], [ 1, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB16_11sort_by_keyTRINtNtB1Q_3vec3VecjEjENCNvMNtB1b_8justfileNtB30_8Justfile14public_recipess_0E0EB1b_.exit ] ; 3 uses
...
bb.v:                                             ; preds = %bb.u
  %i.dc = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %i.cx
  %i.dd = load i64, ptr %i.dc, align 8, !noundef !28 ; 3 uses
  %i.de = lshr i64 %i.dd, 1                       ; 8 uses
  %i.df = lshr i64 %.sroa.023.1102, 1             ; 6 uses
  %i.dg = add nuw i64 %i.de, %i.df                ; 4 uses
  %i.dh = sub i64 %.sroa.09.0, %i.dg
  %i.di = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %i.dh ; 6 uses
  %i.dj = icmp samesign ugt i64 %i.dg, %3
  %i.dk = trunc i64 %.sroa.023.1102 to i1
  %i.dl = or i64 %i.dd, %.sroa.023.1102
...
bb.z:                                             ; preds = %bb.w
  %i.dp = or i64 %i.de, 1
  %i.dq = tail call range(i64 4, 64) i64 @llvm.ctlz.i64(i64 %i.dp, i1 true)
...
end_hunk_3
begin_hunk_4_@_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift4sortRNtNtCskXtk6F4WjxZ_4just6recipe6RecipeNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSBW_11sort_by_keyTRINtNtB1G_3vec3VecjEjENCNvMNtB11_8justfileNtB2P_8Justfile14public_recipess_0E0EB11_:bb.a
...
bb.l:                                             ; preds = %.lr.ph
  %i.u = add nuw nsw i64 %.sroa.01.0.i.i129, 1    ; 2 uses
  %exitcond.not = icmp eq i64 %i.u, %i.n
...
bb.m:                                             ; preds = %.lr.ph133
  %i.x = add nuw nsw i64 %.sroa.01.1.i.i132, 1    ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <2 x i64> %reverse, ptr %i.ai, align 8, !alias.scope !24280, !noalias !24281
  store <2 x i64> %reverse379, ptr %i.an, align 8, !alias.scope !24280, !noalias !24281
  ...
  store <2 x ptr> %reverse380, ptr %i.ao, align 8, !alias.scope !24282, !noalias !24283
  store <2 x ptr> %reverse381, ptr %i.ap, align 8, !alias.scope !24282, !noalias !24283
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.aq = icmp eq i64 %index.next, %n.vec
  br i1 %i.aq, label %middle.block, label %vector.body, !llvm.loop !24223
...
_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just7binding7Binding12split_at_mutBz_.exit11.i.i: ; preds = %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just7binding7Binding12split_at_mutBz_.exit11.i.i.preheader, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just7binding7Binding12split_at_mutBz_.exit11.i.i
  ...
  %i.au = load ptr, ptr %i.as, align 8, !alias.scope !24280, !noalias !24281, !nonnull !28, !align !35, !noundef !28
  %i.av = load i64, ptr %i.at, align 8, !alias.scope !24282, !noalias !24283
  store i64 %i.av, ptr %i.as, align 8, !alias.scope !24280, !noalias !24281
  store ptr %i.au, ptr %i.at, align 8, !alias.scope !24282, !noalias !24283
  %i.aw = add nuw nsw i64 %.sroa.0.016.i.i, 1     ; 2 uses
  %exitcond.not.i.i = icmp eq i64 %i.aw, %i.af
  br i1 %exitcond.not.i.i, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just7binding7Binding7reverseBz_.exit, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just7binding7Binding12split_at_mutBz_.exit11.i.i, !llvm.loop !24224
...
bb.w:                                             ; preds = %bb.t
  ...
  tail call void @_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable9quicksort9quicksortRNtNtCskXtk6F4WjxZ_4just7binding7BindingNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB15_11sort_by_keyReNCNvMNtB1a_8justfileNtB2G_8Justfile3runs0_0E0EB1a_(ptr noalias nofree noundef nonnull align 8 %i.br, i64 noundef range(i64 0, 1152921504606846976) %i.bn, ptr noalias nofree noundef nonnull align 8 %2, i64 noundef range(i64 0, 1152921504606846976) %3, i32 noundef %i.cc, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable_or_null(8) null, ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %5) #74, !inline_history !24225
  br label %bb.v
...
bb.x:                                             ; preds = %bb.v
  ...
  tail call void @_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable9quicksort9quicksortRNtNtCskXtk6F4WjxZ_4just7binding7BindingNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB15_11sort_by_keyReNCNvMNtB1a_8justfileNtB2G_8Justfile3runs0_0E0EB1a_(ptr noalias nofree noundef nonnull align 8 %i.cd, i64 noundef range(i64 0, 1152921504606846976) %i.bo, ptr noalias nofree noundef nonnull align 8 %2, i64 noundef range(i64 0, 1152921504606846976) %3, i32 noundef %i.ci, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable_or_null(8) null, ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %5) #74, !inline_history !24225
  br label %bb.y

bb.y:                                             ; preds = %bb.x, %bb.v
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24284)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24285)
...
.critedge.i:                                      ; preds = %bb.z
  ...
  %.not.i33 = icmp samesign ugt i64 %i.bn, %i.bo  ; 2 uses
  %spec.select.i = select i1 %.not.i33, ptr %i.cm, ptr %i.br
  %i.cn = shl nuw nsw i64 %..i.i, 3               ; 2 uses
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %2, ptr nonnull align 8 %spec.select.i, i64 %i.cn, i1 false), !alias.scope !24286
  %i.co = getelementptr inbounds nuw i8, ptr %2, i64 %i.cn ; 4 uses
end_hunk_4
begin_hunk_5_@_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift4sortRNtNtCskXtk6F4WjxZ_4just7binding7BindingNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSBW_11sort_by_keyReNCNvMNtB11_8justfileNtB2w_8Justfile3runs0_0E0EB11_:bb.a
...
_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile11sort_by_keyjNCNvMBB_Bz_14public_moduless_0E0BD_.exit52.thread: ; preds = %_RNCNvMNtCskXtk6F4WjxZ_4just8justfileNtB4_8Justfile14public_moduless_0B6_.exit.i44, %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile11sort_by_keyjNCNvMBB_Bz_14public_moduless_0E0BD_.exit52
  %i.w = add nuw nsw i64 %.sroa.01.0.i.i87, 1     ; 2 uses
...
_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runRNtNtCskXtk6F4WjxZ_4just8justfile8JustfileNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB12_11sort_by_keyjNCNvMB15_B13_14public_moduless_0E0EB17_.exit.i: ; preds = %bb.o, %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile11sort_by_keyjNCNvMBB_Bz_14public_moduless_0E0BD_.exit, %_RNCNvMNtCskXtk6F4WjxZ_4just8justfileNtB4_8Justfile14public_moduless_0B6_.exit.i, %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile11sort_by_keyjNCNvMBB_Bz_14public_moduless_0E0BD_.exit52.thread, %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile11sort_by_keyjNCNvMBB_Bz_14public_moduless_0E0BD_.exit52, %.preheader, %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile11sort_by_keyjNCNvMBB_Bz_14public_moduless_0E0BD_.exit66.preheader
  %.sroa.3.0.i.i = phi i1 [ false, %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile11sort_by_keyjNCNvMBB_Bz_14public_moduless_0E0BD_.exit66.preheader ], [ false, %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile11sort_by_keyjNCNvMBB_Bz_14public_moduless_0E0BD_.exit52.thread ], [ true, %.preheader ], [ false, %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile11sort_by_keyjNCNvMBB_Bz_14public_moduless_0E0BD_.exit52 ], [ true, %_RNCNvMNtCskXtk6F4WjxZ_4just8justfileNtB4_8Justfile14public_moduless_0B6_.exit.i ], [ true, %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile11sort_by_keyjNCNvMBB_Bz_14public_moduless_0E0BD_.exit ], [ true, %bb.o ]
  %.sroa.0.0.i.i = phi i64 [ 2, %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile11sort_by_keyjNCNvMBB_Bz_14public_moduless_0E0BD_.exit66.preheader ], [ %i.n, %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile11sort_by_keyjNCNvMBB_Bz_14public_moduless_0E0BD_.exit52.thread ], [ 2, %.preheader ], [ %.sroa.01.0.i.i87, %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile11sort_by_keyjNCNvMBB_Bz_14public_moduless_0E0BD_.exit52 ], [ %.sroa.01.1.i.i84, %_RNCNvMNtCskXtk6F4WjxZ_4just8justfileNtB4_8Justfile14public_moduless_0B6_.exit.i ], [ %i.n, %bb.o ], [ %.sroa.01.1.i.i84, %_RNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile11sort_by_keyjNCNvMBB_Bz_14public_moduless_0E0BD_.exit ] ; 9 uses
  %i.ac = icmp samesign ule i64 %.sroa.0.0.i.i, %i.n
  tail call void @llvm.assume(i1 %i.ac)
  %.not5.i = icmp ult i64 %.sroa.0.0.i.i, %.sroa.01.0
  br i1 %.not5.i, label %bb.i, label %bb.p

bb.p:                                             ; preds = %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runRNtNtCskXtk6F4WjxZ_4just8justfile8JustfileNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB12_11sort_by_keyjNCNvMB15_B13_14public_moduless_0E0EB17_.exit.i
  br i1 %.sroa.3.0.i.i, label %bb.s, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile7reverseBz_.exit

bb.q:                                             ; preds = %bb.i
  %..i36 = tail call noundef i64 @llvm.umin.i64(i64 range(i64 0, 1152921504606846976) %i.n, i64 %.sroa.01.0)
  %i.ad = shl nuw nsw i64 %..i36, 1
  br label %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift10create_runRNtNtCskXtk6F4WjxZ_4just8justfile8JustfileNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB13_11sort_by_keyjNCNvMB16_B14_14public_moduless_0E0EB18_.exit

bb.r:                                             ; preds = %bb.i
  %..i35 = tail call noundef i64 @llvm.umin.i64(i64 range(i64 0, 1152921504606846976) %i.n, i64 32) ; 2 uses
  tail call void @_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable9quicksort9quicksortRNtNtCskXtk6F4WjxZ_4just8justfile8JustfileNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB15_11sort_by_keyjNCNvMB18_B16_14public_moduless_0E0EB1a_(ptr noalias nofree noundef nonnull align 8 %i.o, i64 noundef %..i35, ptr noalias nofree noundef nonnull align 8 %2, i64 noundef range(i64 0, 1152921504606846976) %3, i32 noundef 0, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable_or_null(8) null, ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %5) #74, !inline_history !24313
  %i.ae = shl nuw nsw i64 %..i35, 1
  %i.af = or disjoint i64 %i.ae, 1
  br label %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift10create_runRNtNtCskXtk6F4WjxZ_4just8justfile8JustfileNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB13_11sort_by_keyjNCNvMB16_B14_14public_moduless_0E0EB18_.exit

_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile7reverseBz_.exit: ; preds = %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile12split_at_mutBz_.exit11.i.i, %middle.block, %bb.j, %bb.s, %bb.p
  %.sroa.0.0.i.i7578 = phi i64 [ %i.n, %bb.j ], [ %.sroa.0.0.i.i, %bb.p ], [ %.sroa.0.0.i.i, %bb.s ], [ %.sroa.0.0.i.i, %middle.block ], [ %.sroa.0.0.i.i, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile12split_at_mutBz_.exit11.i.i ]
  %i.ag = shl nuw nsw i64 %.sroa.0.0.i.i7578, 1
  %i.ah = or disjoint i64 %i.ag, 1
  br label %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift10create_runRNtNtCskXtk6F4WjxZ_4just8justfile8JustfileNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB13_11sort_by_keyjNCNvMB16_B14_14public_moduless_0E0EB18_.exit

bb.s:                                             ; preds = %bb.p
  %i.ai = lshr i64 %.sroa.0.0.i.i, 1              ; 4 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24336), !noalias !24334
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24337), !noalias !24334
  %.not.i.i = icmp eq i64 %i.ai, 0
  br i1 %.not.i.i, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile7reverseBz_.exit, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile12split_at_mutBz_.exit11.preheader.i.i

_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile12split_at_mutBz_.exit11.preheader.i.i: ; preds = %bb.s
  %i.aj = getelementptr inbounds nuw [8 x i8], ptr %i.o, i64 %.sroa.0.0.i.i ; 2 uses
  %min.iters.check = icmp samesign ult i64 %.sroa.0.0.i.i, 8
  br i1 %min.iters.check, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile12split_at_mutBz_.exit11.i.i.preheader, label %vector.ph

vector.ph:                                        ; preds = %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile12split_at_mutBz_.exit11.preheader.i.i
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x ptr>, ptr %i.al, align 8, !alias.scope !24338, !noalias !24339
  %wide.load137 = load <2 x ptr>, ptr %i.an, align 8, !alias.scope !24338, !noalias !24339
  %i.ao = getelementptr i8, ptr %i.am, i64 -8
  %i.ap = getelementptr i8, ptr %i.am, i64 -24
  %wide.load138 = load <2 x i64>, ptr %i.ao, align 8, !alias.scope !24340, !noalias !24341
  %wide.load139 = load <2 x i64>, ptr %i.ap, align 8, !alias.scope !24340, !noalias !24341
  %reverse = shufflevector <2 x i64> %wide.load138, <2 x i64> poison, <2 x i32> <i32 1, i32 0>
  %reverse140 = shufflevector <2 x i64> %wide.load139, <2 x i64> poison, <2 x i32> <i32 1, i32 0>
  %i.aq = getelementptr inbounds nuw i8, ptr %i.al, i64 16
  store <2 x i64> %reverse, ptr %i.al, align 8, !alias.scope !24338, !noalias !24339
  store <2 x i64> %reverse140, ptr %i.aq, align 8, !alias.scope !24338, !noalias !24339
  %i.ar = getelementptr i8, ptr %i.am, i64 -8
  %i.as = getelementptr i8, ptr %i.am, i64 -24
  %reverse141 = shufflevector <2 x ptr> %wide.load, <2 x ptr> poison, <2 x i32> <i32 1, i32 0>
  %reverse142 = shufflevector <2 x ptr> %wide.load137, <2 x ptr> poison, <2 x i32> <i32 1, i32 0>
  store <2 x ptr> %reverse141, ptr %i.ar, align 8, !alias.scope !24340, !noalias !24341
  store <2 x ptr> %reverse142, ptr %i.as, align 8, !alias.scope !24340, !noalias !24341
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.at = icmp eq i64 %index.next, %n.vec
  br i1 %i.at, label %middle.block, label %vector.body, !llvm.loop !24319

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %i.ai, %n.vec
  br i1 %cmp.n, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile7reverseBz_.exit, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile12split_at_mutBz_.exit11.i.i.preheader

_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile12split_at_mutBz_.exit11.i.i.preheader: ; preds = %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile12split_at_mutBz_.exit11.preheader.i.i, %middle.block
  %.sroa.0.016.i.i.ph = phi i64 [ 0, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile12split_at_mutBz_.exit11.preheader.i.i ], [ %n.vec, %middle.block ]
  br label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile12split_at_mutBz_.exit11.i.i

_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile12split_at_mutBz_.exit11.i.i: ; preds = %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile12split_at_mutBz_.exit11.i.i.preheader, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile12split_at_mutBz_.exit11.i.i
  %.sroa.0.016.i.i = phi i64 [ %i.az, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile12split_at_mutBz_.exit11.i.i ], [ %.sroa.0.016.i.i.ph, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile12split_at_mutBz_.exit11.i.i.preheader ] ; 3 uses
  ...
  %i.ax = load ptr, ptr %i.av, align 8, !alias.scope !24338, !noalias !24339, !nonnull !28, !align !35, !noundef !28
  %i.ay = load i64, ptr %i.aw, align 8, !alias.scope !24340, !noalias !24341
  store i64 %i.ay, ptr %i.av, align 8, !alias.scope !24338, !noalias !24339
  store ptr %i.ax, ptr %i.aw, align 8, !alias.scope !24340, !noalias !24341
  %i.az = add nuw nsw i64 %.sroa.0.016.i.i, 1     ; 2 uses
  %exitcond.not.i.i = icmp eq i64 %i.az, %i.ai
  br i1 %exitcond.not.i.i, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile7reverseBz_.exit, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile12split_at_mutBz_.exit11.i.i, !llvm.loop !24320

_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift10create_runRNtNtCskXtk6F4WjxZ_4just8justfile8JustfileNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB13_11sort_by_keyjNCNvMB16_B14_14public_moduless_0E0EB18_.exit: ; preds = %bb.q, %bb.r, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile7reverseBz_.exit
  %.sroa.0.0.i32 = phi i64 [ %i.ah, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSRNtNtCskXtk6F4WjxZ_4just8justfile8Justfile7reverseBz_.exit ], [ %i.af, %bb.r ], [ %i.ad, %bb.q ] ; 2 uses
...
bb.t:                                             ; preds = %.lr.ph93, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeRNtNtCskXtk6F4WjxZ_4just8justfile8JustfileNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB16_11sort_by_keyjNCNvMB19_B17_14public_moduless_0E0EB1b_.exit
  %.sroa.02.192 = phi i64 [ %.sroa.02.0, %.lr.ph93 ], [ %i.bj, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeRNtNtCskXtk6F4WjxZ_4just8justfile8JustfileNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB16_11sort_by_keyjNCNvMB19_B17_14public_moduless_0E0EB1b_.exit ] ; 2 uses
  %.sroa.023.191 = phi i64 [ %.sroa.023.0, %.lr.ph93 ], [ %.sroa.0.0.i, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeRNtNtCskXtk6F4WjxZ_4just8justfile8JustfileNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSB16_11sort_by_keyjNCNvMB19_B17_14public_moduless_0E0EB1b_.exit ] ; 4 uses
  %i.bj = add i64 %.sroa.02.192, -1               ; 4 uses
  %i.bk = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.bj
  %i.bl = load i8, ptr %i.bk, align 1, !noundef !28
...
end_hunk_5
begin_hunk_6_@_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift4sortRNtNtCskXtk6F4WjxZ_4just8justfile8JustfileNCINvMNtCs4wP2HXfJTCR_5alloc5sliceSBW_11sort_by_keyjNCNvMBZ_BX_14public_moduless_0E0EB11_:bb.a
...
bb.l:                                             ; preds = %.lr.ph
  %i.ah = add nuw nsw i64 %.sroa.01.0.i.i55, 1    ; 2 uses
...
bb.m:                                             ; preds = %.lr.ph59
  %i.aq = add nuw nsw i64 %.sroa.01.1.i.i58, 1    ; 2 uses
...
bb.q:                                             ; preds = %bb.n
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24410), !noalias !24405
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24411), !noalias !24405
...
_RNvMNtCsj6eKBz9Db1c_4core5sliceSTNtNtCs4wP2HXfJTCR_5alloc6string6StringBv_E12split_at_mutCskXtk6F4WjxZ_4just.exit11.i.i: ; preds = %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTNtNtCs4wP2HXfJTCR_5alloc6string6StringBv_E12split_at_mutCskXtk6F4WjxZ_4just.exit11.i.i, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTNtNtCs4wP2HXfJTCR_5alloc6string6StringBv_E12split_at_mutCskXtk6F4WjxZ_4just.exit11.preheader.i.i
  ...
  %i.bd = load <2 x i64>, ptr %i.bb, align 8, !alias.scope !24412, !noalias !24413
  %i.be = load <2 x i64>, ptr %i.bc, align 8, !alias.scope !24414, !noalias !24415
  store <2 x i64> %i.be, ptr %i.bb, align 8, !alias.scope !24412, !noalias !24413
  store <2 x i64> %i.bd, ptr %i.bc, align 8, !alias.scope !24414, !noalias !24415
...
bb.q:                                             ; preds = %bb.n
  %i.ax = lshr i64 %.sroa.0.0.i.i, 1              ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24490), !noalias !24485
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24491), !noalias !24485
  %.not.i.i = icmp eq i64 %i.ax, 0
...
_RNvMNtCsj6eKBz9Db1c_4core5sliceSTNtNtCs4wP2HXfJTCR_5alloc6string6StringNtNtCsaKJjC64KgbL_3std4path7PathBufE12split_at_mutCskXtk6F4WjxZ_4just.exit11.i.i: ; preds = %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTNtNtCs4wP2HXfJTCR_5alloc6string6StringNtNtCsaKJjC64KgbL_3std4path7PathBufE12split_at_mutCskXtk6F4WjxZ_4just.exit11.i.i, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTNtNtCs4wP2HXfJTCR_5alloc6string6StringNtNtCsaKJjC64KgbL_3std4path7PathBufE12split_at_mutCskXtk6F4WjxZ_4just.exit11.preheader.i.i
  ...
  %i.bb = getelementptr inbounds nuw [48 x i8], ptr %i.o, i64 %.sroa.0.016.i.i ; 4 uses
  %i.bc = getelementptr [48 x i8], ptr %i.az, i64 %i.ba ; 4 uses
  %i.bd = load <2 x i64>, ptr %i.bb, align 8, !alias.scope !24492, !noalias !24493
  %i.be = load <2 x i64>, ptr %i.bc, align 8, !alias.scope !24494, !noalias !24495
  store <2 x i64> %i.be, ptr %i.bb, align 8, !alias.scope !24492, !noalias !24493
  store <2 x i64> %i.bd, ptr %i.bc, align 8, !alias.scope !24494, !noalias !24495
  %i.bf = getelementptr inbounds nuw i8, ptr %i.bb, i64 16 ; 2 uses
  %i.bg = getelementptr inbounds nuw i8, ptr %i.bc, i64 16 ; 2 uses
...
.noexc.i:                                         ; preds = %.preheader.i
  ...
  %i.cy = zext i1 %i.cu to i64
end_hunk_6
begin_hunk_7_@_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift4sortTNtNtCskXtk6F4WjxZ_4just9attribute9AttributeNtNtB11_4name4NameENCINvMNtCs4wP2HXfJTCR_5alloc5sliceSBW_7sort_byNCINvXs1o_NtNtNtB25_11collections5btree3mapINtB2R_8BTreeMapBX_B1E_EINtNtNtNtBa_4iter6traits7collect12FromIteratorBW_E9from_iterINtNtNtB25_3vec9into_iter8IntoIterBW_EE0E0EB11_:bb.a
  %.sroa.0.0.i34 = phi ptr [ %i.dg, %.noexc20.i ], [ %2, %.critedge.i ] ; 4 uses
  %.sroa.0.02.i.i = phi ptr [ %i.di, %.noexc20.i ], [ %i.cn, %.critedge.i ] ; 3 uses
  %i.dc = invoke fastcc noundef range(i8 -1, 2) i8 @_RNvXsk_NtCskXtk6F4WjxZ_4just9attributeNtB5_9AttributeNtNtCsj6eKBz9Db1c_4core3cmp3Ord3cmp(ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(1424) %.sroa.0.02.i.i, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(1424) %.sroa.0.0.i34) #76
          to label %.noexc20.i unwind label %.loopexit.split-lp.i
...
bb.q:                                             ; preds = %bb.n
  %i.ax = lshr i64 %.sroa.0.0.i.i, 1              ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24652), !noalias !24650
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24653), !noalias !24650
  %.not.i.i = icmp eq i64 %i.ax, 0
...
_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE12split_at_mutCskXtk6F4WjxZ_4just.exit11.i.i: ; preds = %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE12split_at_mutCskXtk6F4WjxZ_4just.exit11.i.i, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE12split_at_mutCskXtk6F4WjxZ_4just.exit11.preheader.i.i
  ...
  %i.bb = getelementptr inbounds nuw [48 x i8], ptr %i.o, i64 %.sroa.0.016.i.i ; 4 uses
  %i.bc = getelementptr [48 x i8], ptr %i.az, i64 %i.ba ; 4 uses
  %i.bd = load <2 x i64>, ptr %i.bb, align 8, !alias.scope !24654, !noalias !24655
  %i.be = load <2 x i64>, ptr %i.bc, align 8, !alias.scope !24656, !noalias !24657
  store <2 x i64> %i.be, ptr %i.bb, align 8, !alias.scope !24654, !noalias !24655
  store <2 x i64> %i.bd, ptr %i.bc, align 8, !alias.scope !24656, !noalias !24657
  %i.bf = getelementptr inbounds nuw i8, ptr %i.bb, i64 16 ; 2 uses
  %i.bg = getelementptr inbounds nuw i8, ptr %i.bc, i64 16 ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.n
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24827), !noalias !24801
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24828), !noalias !24801
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24829), !noalias !24801
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24830), !noalias !24801
  %..i.i.i.i.i.i.i41 = tail call noundef i64 @llvm.umin.i64(i64 range(i64 0, 1152921504606846976) %.val10.i.i40, i64 range(i64 0, 1152921504606846976) %.val8.i.i38) ; 2 uses
  %.not.i.i.i.i.i.i42 = icmp eq i64 %..i.i.i.i.i.i.i41, 0
  br i1 %.not.i.i.i.i.i.i42, label %._crit_edge.i.i.i.i.i.i50, label %.lr.ph.i.i.i.i.i.i43

bb.m:                                             ; preds = %.lr.ph.i.i.i.i.i.i43
  %i.as = add nuw nsw i64 %.sroa.01.020.i.i.i.i.i.i44, 1 ; 2 uses
  %exitcond.not.i.i.i.i.i.i49 = icmp eq i64 %i.as, %..i.i.i.i.i.i.i41
  br i1 %exitcond.not.i.i.i.i.i.i49, label %._crit_edge.i.i.i.i.i.i50, label %.lr.ph.i.i.i.i.i.i43

._crit_edge.i.i.i.i.i.i50:                        ; preds = %bb.m, %.lr.ph
  %i.at = icmp eq i64 %.val8.i.i38, %.val10.i.i40
  %i.au = icmp samesign ult i64 %.val8.i.i38, %.val10.i.i40
  br i1 %i.at, label %_RNvXs8_NtNtCsj6eKBz9Db1c_4core3cmp5implsRSjNtB7_10PartialOrd13___chaining_ltCskXtk6F4WjxZ_4just.exit.i.i51, label %_RNvYNvYTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBR_3ops8function5FnMutTRB5_B1X_EE8call_mutCskXtk6F4WjxZ_4just.exit60

.loopexit.i.i.i.i.i.i47:                          ; preds = %.lr.ph.i.i.i.i.i.i43
  %i.av = icmp ult i64 %.val15.i.i.i.i.i.i45, %.val16.i.i.i.i.i.i46
  br i1 %i.av, label %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB12_NtNtB8_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit.i, label %bb.n

.lr.ph.i.i.i.i.i.i43:                             ; preds = %.lr.ph, %bb.m
  %.sroa.01.020.i.i.i.i.i.i44 = phi i64 [ %i.as, %bb.m ], [ 0, %.lr.ph ] ; 3 uses
  %i.aw = getelementptr inbounds nuw [8 x i8], ptr %.val7.i.i37, i64 %.sroa.01.020.i.i.i.i.i.i44
  %i.ax = getelementptr inbounds nuw [8 x i8], ptr %.val9.i.i39, i64 %.sroa.01.020.i.i.i.i.i.i44
  %.val15.i.i.i.i.i.i45 = load i64, ptr %i.aw, align 8, !alias.scope !24831, !noalias !24832, !noundef !28 ; 2 uses
  %.val16.i.i.i.i.i.i46 = load i64, ptr %i.ax, align 8, !alias.scope !24833, !noalias !24834, !noundef !28 ; 2 uses
  %i.ay = icmp eq i64 %.val15.i.i.i.i.i.i45, %.val16.i.i.i.i.i.i46
  br i1 %i.ay, label %bb.m, label %.loopexit.i.i.i.i.i.i47

_RNvXs8_NtNtCsj6eKBz9Db1c_4core3cmp5implsRSjNtB7_10PartialOrd13___chaining_ltCskXtk6F4WjxZ_4just.exit.i.i51: ; preds = %._crit_edge.i.i.i.i.i.i50
  %i.az = getelementptr inbounds nuw i8, ptr %i.an, i64 16
  %i.ba = getelementptr inbounds nuw i8, ptr %i.aq, i64 16
  %.val.i.i52 = load i64, ptr %i.az, align 8, !alias.scope !24823, !noalias !24824, !noundef !28 ; 2 uses
  %.val6.i.i53 = load i64, ptr %i.ba, align 8, !alias.scope !24835, !noalias !24836, !noundef !28 ; 2 uses
  %i.bb = icmp eq i64 %.val.i.i52, %.val6.i.i53
  %i.bc = icmp ult i64 %.val.i.i52, %.val6.i.i53
  br i1 %i.bb, label %.split87, label %_RNvYNvYTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBR_3ops8function5FnMutTRB5_B1X_EE8call_mutCskXtk6F4WjxZ_4just.exit60

.split87:                                         ; preds = %_RNvXs8_NtNtCsj6eKBz9Db1c_4core3cmp5implsRSjNtB7_10PartialOrd13___chaining_ltCskXtk6F4WjxZ_4just.exit.i.i51
  %i.bd = getelementptr inbounds nuw i8, ptr %i.an, i64 32
  %.val11.i.i54 = load ptr, ptr %i.bd, align 8, !alias.scope !24823, !noalias !24824, !nonnull !28, !noundef !28
  %i.be = getelementptr inbounds nuw i8, ptr %i.an, i64 40
  %.val12.i.i55 = load i64, ptr %i.be, align 8, !alias.scope !24823, !noalias !24824, !noundef !28 ; 2 uses
  %i.bf = getelementptr inbounds nuw i8, ptr %i.aq, i64 32
  %.val13.i.i56 = load ptr, ptr %i.bf, align 8, !alias.scope !24835, !noalias !24836, !nonnull !28, !noundef !28
  %i.bg = getelementptr inbounds nuw i8, ptr %i.aq, i64 40
  %.val14.i.i57 = load i64, ptr %i.bg, align 8, !alias.scope !24835, !noalias !24836, !noundef !28 ; 2 uses
  %spec.store.select.i.i.i.i.i.i58 = tail call i64 @llvm.umin.i64(i64 range(i64 0, -9223372036854775808) %.val12.i.i55, i64 range(i64 0, -9223372036854775808) %.val14.i.i57)
  %i.bh = tail call i32 @memcmp(ptr nonnull readonly %.val11.i.i54, ptr nonnull readonly %.val13.i.i56, i64 %spec.store.select.i.i.i.i.i.i58), !alias.scope !24837, !noalias !24838 ; 2 uses
  %i.bi = sext i32 %i.bh to i64
  %i.bj = icmp eq i32 %i.bh, 0
  %i.bk = sub nsw i64 %.val12.i.i55, %.val14.i.i57
  %spec.select.i.i.i.i.i.i59 = select i1 %i.bj, i64 %i.bk, i64 %i.bi
  %i.bl = icmp slt i64 %spec.select.i.i.i.i.i.i59, 0
  br i1 %i.bl, label %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB12_NtNtB8_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit.i, label %bb.n

_RNvYNvYTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBR_3ops8function5FnMutTRB5_B1X_EE8call_mutCskXtk6F4WjxZ_4just.exit60: ; preds = %._crit_edge.i.i.i.i.i.i50, %_RNvXs8_NtNtCsj6eKBz9Db1c_4core3cmp5implsRSjNtB7_10PartialOrd13___chaining_ltCskXtk6F4WjxZ_4just.exit.i.i51
  %.sroa.0.1.i.i48 = phi i1 [ %i.bc, %_RNvXs8_NtNtCsj6eKBz9Db1c_4core3cmp5implsRSjNtB7_10PartialOrd13___chaining_ltCskXtk6F4WjxZ_4just.exit.i.i51 ], [ %i.au, %._crit_edge.i.i.i.i.i.i50 ]
  br i1 %.sroa.0.1.i.i48, label %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB12_NtNtB8_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit.i, label %bb.n

bb.n:                                             ; preds = %.loopexit.i.i.i.i.i.i47, %.split87, %_RNvYNvYTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBR_3ops8function5FnMutTRB5_B1X_EE8call_mutCskXtk6F4WjxZ_4just.exit60
  %i.bm = add nuw nsw i64 %.sroa.01.0.i.i113, 1   ; 2 uses
  %exitcond.not = icmp eq i64 %i.bm, %umax
  br i1 %exitcond.not, label %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB12_NtNtB8_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit.i, label %.lr.ph

.lr.ph118:                                        ; preds = %.lr.ph118.preheader, %bb.p
  %.val10.i.i = phi i64 [ %.val8.i.i, %bb.p ], [ %.val8.i.i62, %.lr.ph118.preheader ] ; 3 uses
  %.val9.i.i = phi ptr [ %.val7.i.i, %bb.p ], [ %.val7.i.i61, %.lr.ph118.preheader ]
  %.sroa.01.1.i.i117 = phi i64 [ %i.cm, %bb.p ], [ 2, %.lr.ph118.preheader ] ; 6 uses
  %i.bn = getelementptr inbounds nuw [48 x i8], ptr %i.o, i64 %.sroa.01.1.i.i117 ; 5 uses
  %i.bo = add nsw i64 %.sroa.01.1.i.i117, -1      ; 2 uses
  %i.bp = icmp ult i64 %i.bo, %i.n
  tail call void @llvm.assume(i1 %i.bp)
  %i.bq = getelementptr inbounds nuw [48 x i8], ptr %i.o, i64 %i.bo ; 3 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24839)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24840)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24841), !noalias !24801
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24842), !noalias !24801
  %.val7.i.i = load ptr, ptr %i.bn, align 8, !alias.scope !24843, !noalias !24844, !nonnull !28, !align !35, !noundef !28 ; 2 uses
  %i.br = getelementptr inbounds nuw i8, ptr %i.bn, i64 8
  %.val8.i.i = load i64, ptr %i.br, align 8, !alias.scope !24843, !noalias !24844, !noundef !28 ; 4 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24845), !noalias !24801
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24846), !noalias !24801
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24847), !noalias !24801
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24848), !noalias !24801
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24849), !noalias !24801
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24850), !noalias !24801
  %..i.i.i.i.i.i.i = tail call noundef i64 @llvm.umin.i64(i64 range(i64 0, 1152921504606846976) %.val10.i.i, i64 range(i64 0, 1152921504606846976) %.val8.i.i) ; 2 uses
...
bb.o:                                             ; preds = %.lr.ph.i.i.i.i.i.i
  %i.bs = add nuw nsw i64 %.sroa.01.020.i.i.i.i.i.i, 1 ; 2 uses
  %exitcond.not.i.i.i.i.i.i = icmp eq i64 %i.bs, %..i.i.i.i.i.i.i
  br i1 %exitcond.not.i.i.i.i.i.i, label %._crit_edge.i.i.i.i.i.i, label %.lr.ph.i.i.i.i.i.i

._crit_edge.i.i.i.i.i.i:                          ; preds = %bb.o, %.lr.ph118
  %i.bt = icmp eq i64 %.val8.i.i, %.val10.i.i
  %i.bu = icmp samesign ult i64 %.val8.i.i, %.val10.i.i
  br i1 %i.bt, label %_RNvXs8_NtNtCsj6eKBz9Db1c_4core3cmp5implsRSjNtB7_10PartialOrd13___chaining_ltCskXtk6F4WjxZ_4just.exit.i.i, label %_RNvYNvYTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBR_3ops8function5FnMutTRB5_B1X_EE8call_mutCskXtk6F4WjxZ_4just.exit

.loopexit.i.i.i.i.i.i:                            ; preds = %.lr.ph.i.i.i.i.i.i
  %i.bv = icmp ult i64 %.val15.i.i.i.i.i.i, %.val16.i.i.i.i.i.i
  br i1 %i.bv, label %bb.p, label %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB12_NtNtB8_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit.i

.lr.ph.i.i.i.i.i.i:                               ; preds = %.lr.ph118, %bb.o
  %.sroa.01.020.i.i.i.i.i.i = phi i64 [ %i.bs, %bb.o ], [ 0, %.lr.ph118 ] ; 3 uses
  %i.bw = getelementptr inbounds nuw [8 x i8], ptr %.val7.i.i, i64 %.sroa.01.020.i.i.i.i.i.i
  %i.bx = getelementptr inbounds nuw [8 x i8], ptr %.val9.i.i, i64 %.sroa.01.020.i.i.i.i.i.i
  %.val15.i.i.i.i.i.i = load i64, ptr %i.bw, align 8, !alias.scope !24851, !noalias !24852, !noundef !28 ; 2 uses
  %.val16.i.i.i.i.i.i = load i64, ptr %i.bx, align 8, !alias.scope !24853, !noalias !24854, !noundef !28 ; 2 uses
  %i.by = icmp eq i64 %.val15.i.i.i.i.i.i, %.val16.i.i.i.i.i.i
  br i1 %i.by, label %bb.o, label %.loopexit.i.i.i.i.i.i

_RNvXs8_NtNtCsj6eKBz9Db1c_4core3cmp5implsRSjNtB7_10PartialOrd13___chaining_ltCskXtk6F4WjxZ_4just.exit.i.i: ; preds = %._crit_edge.i.i.i.i.i.i
  %i.bz = getelementptr inbounds nuw i8, ptr %i.bn, i64 16
  %i.ca = getelementptr inbounds nuw i8, ptr %i.bq, i64 16
  %.val.i.i = load i64, ptr %i.bz, align 8, !alias.scope !24843, !noalias !24844, !noundef !28 ; 2 uses
  %.val6.i.i = load i64, ptr %i.ca, align 8, !alias.scope !24855, !noalias !24856, !noundef !28 ; 2 uses
  %i.cb = icmp eq i64 %.val.i.i, %.val6.i.i
  %i.cc = icmp ult i64 %.val.i.i, %.val6.i.i
  br i1 %i.cb, label %.split88, label %_RNvYNvYTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBR_3ops8function5FnMutTRB5_B1X_EE8call_mutCskXtk6F4WjxZ_4just.exit

.split88:                                         ; preds = %_RNvXs8_NtNtCsj6eKBz9Db1c_4core3cmp5implsRSjNtB7_10PartialOrd13___chaining_ltCskXtk6F4WjxZ_4just.exit.i.i
  %i.cd = getelementptr inbounds nuw i8, ptr %i.bn, i64 32
  %.val11.i.i = load ptr, ptr %i.cd, align 8, !alias.scope !24843, !noalias !24844, !nonnull !28, !noundef !28
  %i.ce = getelementptr inbounds nuw i8, ptr %i.bn, i64 40
  %.val12.i.i = load i64, ptr %i.ce, align 8, !alias.scope !24843, !noalias !24844, !noundef !28 ; 2 uses
  %i.cf = getelementptr inbounds nuw i8, ptr %i.bq, i64 32
  %.val13.i.i = load ptr, ptr %i.cf, align 8, !alias.scope !24855, !noalias !24856, !nonnull !28, !noundef !28
  %i.cg = getelementptr inbounds nuw i8, ptr %i.bq, i64 40
  %.val14.i.i = load i64, ptr %i.cg, align 8, !alias.scope !24855, !noalias !24856, !noundef !28 ; 2 uses
  %spec.store.select.i.i.i.i.i.i = tail call i64 @llvm.umin.i64(i64 range(i64 0, -9223372036854775808) %.val12.i.i, i64 range(i64 0, -9223372036854775808) %.val14.i.i)
  %i.ch = tail call i32 @memcmp(ptr nonnull readonly %.val11.i.i, ptr nonnull readonly %.val13.i.i, i64 %spec.store.select.i.i.i.i.i.i), !alias.scope !24857, !noalias !24858 ; 2 uses
  %i.ci = sext i32 %i.ch to i64
  %i.cj = icmp eq i32 %i.ch, 0
  %i.ck = sub nsw i64 %.val12.i.i, %.val14.i.i
  %spec.select.i.i.i.i.i.i = select i1 %i.cj, i64 %i.ck, i64 %i.ci
  %i.cl = icmp slt i64 %spec.select.i.i.i.i.i.i, 0
  br i1 %i.cl, label %bb.p, label %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB12_NtNtB8_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit.i

_RNvYNvYTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBR_3ops8function5FnMutTRB5_B1X_EE8call_mutCskXtk6F4WjxZ_4just.exit: ; preds = %._crit_edge.i.i.i.i.i.i, %_RNvXs8_NtNtCsj6eKBz9Db1c_4core3cmp5implsRSjNtB7_10PartialOrd13___chaining_ltCskXtk6F4WjxZ_4just.exit.i.i
  %.sroa.0.1.i.i = phi i1 [ %i.cc, %_RNvXs8_NtNtCsj6eKBz9Db1c_4core3cmp5implsRSjNtB7_10PartialOrd13___chaining_ltCskXtk6F4WjxZ_4just.exit.i.i ], [ %i.bu, %._crit_edge.i.i.i.i.i.i ]
  br i1 %.sroa.0.1.i.i, label %bb.p, label %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB12_NtNtB8_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit.i

bb.p:                                             ; preds = %.loopexit.i.i.i.i.i.i, %.split88, %_RNvYNvYTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBR_3ops8function5FnMutTRB5_B1X_EE8call_mutCskXtk6F4WjxZ_4just.exit
  %i.cm = add nuw nsw i64 %.sroa.01.1.i.i117, 1   ; 2 uses
  %exitcond150.not = icmp eq i64 %i.cm, %umax149
  br i1 %exitcond150.not, label %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB12_NtNtB8_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit.i, label %.lr.ph118

_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB12_NtNtB8_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit.i: ; preds = %bb.n, %_RNvYNvYTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBR_3ops8function5FnMutTRB5_B1X_EE8call_mutCskXtk6F4WjxZ_4just.exit60, %.split87, %.loopexit.i.i.i.i.i.i47, %bb.p, %_RNvYNvYTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBR_3ops8function5FnMutTRB5_B1X_EE8call_mutCskXtk6F4WjxZ_4just.exit, %.split88, %.loopexit.i.i.i.i.i.i, %.preheader98, %.preheader
  %.sroa.3.0.i.i = phi i1 [ true, %.preheader ], [ true, %bb.p ], [ false, %.preheader98 ], [ true, %.loopexit.i.i.i.i.i.i ], [ true, %.split88 ], [ true, %_RNvYNvYTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBR_3ops8function5FnMutTRB5_B1X_EE8call_mutCskXtk6F4WjxZ_4just.exit ], [ false, %.loopexit.i.i.i.i.i.i47 ], [ false, %.split87 ], [ false, %_RNvYNvYTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBR_3ops8function5FnMutTRB5_B1X_EE8call_mutCskXtk6F4WjxZ_4just.exit60 ], [ false, %bb.n ]
  %.sroa.0.0.i.i = phi i64 [ 2, %.preheader ], [ %umax149, %bb.p ], [ 2, %.preheader98 ], [ %.sroa.01.1.i.i117, %_RNvYNvYTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBR_3ops8function5FnMutTRB5_B1X_EE8call_mutCskXtk6F4WjxZ_4just.exit ], [ %.sroa.01.1.i.i117, %.split88 ], [ %.sroa.01.1.i.i117, %.loopexit.i.i.i.i.i.i ], [ %umax, %bb.n ], [ %.sroa.01.0.i.i113, %_RNvYNvYTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBR_3ops8function5FnMutTRB5_B1X_EE8call_mutCskXtk6F4WjxZ_4just.exit60 ], [ %.sroa.01.0.i.i113, %.split87 ], [ %.sroa.01.0.i.i113, %.loopexit.i.i.i.i.i.i47 ] ; 7 uses
  %i.cn = icmp ule i64 %.sroa.0.0.i.i, %i.n
  tail call void @llvm.assume(i1 %i.cn)
  %.not5.i = icmp ult i64 %.sroa.0.0.i.i, %.sroa.01.0
  br i1 %.not5.i, label %bb.i, label %bb.q

bb.q:                                             ; preds = %_RINvNtNtNtCsj6eKBz9Db1c_4core5slice4sort6shared17find_existing_runTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB12_NtNtB8_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit.i
  br i1 %.sroa.3.0.i.i, label %bb.t, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE7reverseCskXtk6F4WjxZ_4just.exit

bb.r:                                             ; preds = %bb.i
  %..i36 = tail call noundef i64 @llvm.umin.i64(i64 range(i64 0, 192153584101141163) %i.n, i64 %.sroa.01.0)
  %i.co = shl nuw nsw i64 %..i36, 1
  br label %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift10create_runTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB13_NtNtBa_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit

bb.s:                                             ; preds = %bb.i
  %..i35 = tail call noundef i64 @llvm.umin.i64(i64 range(i64 0, 192153584101141163) %i.n, i64 32) ; 2 uses
  tail call void @_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable9quicksort9quicksortTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB15_NtNtBa_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just(ptr noalias nofree noundef nonnull align 8 %i.o, i64 noundef %..i35, ptr noalias nofree noundef nonnull align 8 %2, i64 noundef range(i64 0, 192153584101141163) %3, i32 noundef 0, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable_or_null(48) null, ptr noalias nofree noundef nonnull %5) #74, !inline_history !24731
  %i.cp = shl nuw nsw i64 %..i35, 1
  %i.cq = or disjoint i64 %i.cp, 1
  br label %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift10create_runTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB13_NtNtBa_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit

_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE7reverseCskXtk6F4WjxZ_4just.exit: ; preds = %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE12split_at_mutCskXtk6F4WjxZ_4just.exit11.i.i, %bb.j, %bb.t, %bb.q
  %.sroa.0.0.i.i9396 = phi i64 [ %i.n, %bb.j ], [ %.sroa.0.0.i.i, %bb.q ], [ %.sroa.0.0.i.i, %bb.t ], [ %.sroa.0.0.i.i, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE12split_at_mutCskXtk6F4WjxZ_4just.exit11.i.i ]
  %i.cr = shl nuw nsw i64 %.sroa.0.0.i.i9396, 1
  %i.cs = or disjoint i64 %i.cr, 1
  br label %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift10create_runTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB13_NtNtBa_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit

bb.t:                                             ; preds = %bb.q
  %i.ct = lshr i64 %.sroa.0.0.i.i, 1              ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24859), !noalias !24801
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24860), !noalias !24801
  %.not.i.i = icmp eq i64 %i.ct, 0
  br i1 %.not.i.i, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE7reverseCskXtk6F4WjxZ_4just.exit, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE12split_at_mutCskXtk6F4WjxZ_4just.exit11.preheader.i.i

_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE12split_at_mutCskXtk6F4WjxZ_4just.exit11.preheader.i.i: ; preds = %bb.t
  %i.cu = getelementptr inbounds nuw [48 x i8], ptr %i.o, i64 %.sroa.0.0.i.i
  br label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE12split_at_mutCskXtk6F4WjxZ_4just.exit11.i.i

_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE12split_at_mutCskXtk6F4WjxZ_4just.exit11.i.i: ; preds = %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE12split_at_mutCskXtk6F4WjxZ_4just.exit11.i.i, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE12split_at_mutCskXtk6F4WjxZ_4just.exit11.preheader.i.i
  %.sroa.0.016.i.i = phi i64 [ %i.di, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE12split_at_mutCskXtk6F4WjxZ_4just.exit11.i.i ], [ 0, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE12split_at_mutCskXtk6F4WjxZ_4just.exit11.preheader.i.i ] ; 3 uses
  %i.cv = xor i64 %.sroa.0.016.i.i, -1
  %i.cw = getelementptr inbounds nuw [48 x i8], ptr %i.o, i64 %.sroa.0.016.i.i ; 4 uses
  %i.cx = getelementptr [48 x i8], ptr %i.cu, i64 %i.cv ; 4 uses
  %i.cy = load <2 x i64>, ptr %i.cw, align 8, !alias.scope !24861, !noalias !24862
  %i.cz = load <2 x i64>, ptr %i.cx, align 8, !alias.scope !24863, !noalias !24864
  store <2 x i64> %i.cz, ptr %i.cw, align 8, !alias.scope !24861, !noalias !24862
  store <2 x i64> %i.cy, ptr %i.cx, align 8, !alias.scope !24863, !noalias !24864
  %i.da = getelementptr inbounds nuw i8, ptr %i.cw, i64 16 ; 2 uses
  %i.db = getelementptr inbounds nuw i8, ptr %i.cx, i64 16 ; 2 uses
  %i.dc = load <2 x i64>, ptr %i.da, align 8, !alias.scope !24865, !noalias !24862
  %i.dd = load <2 x i64>, ptr %i.db, align 8, !alias.scope !24866, !noalias !24864
  store <2 x i64> %i.dd, ptr %i.da, align 8, !alias.scope !24865, !noalias !24862
  store <2 x i64> %i.dc, ptr %i.db, align 8, !alias.scope !24866, !noalias !24864
  %i.de = getelementptr inbounds nuw i8, ptr %i.cw, i64 32 ; 2 uses
  %i.df = getelementptr inbounds nuw i8, ptr %i.cx, i64 32 ; 2 uses
  %i.dg = load <2 x i64>, ptr %i.de, align 8, !alias.scope !24867, !noalias !24862
  %i.dh = load <2 x i64>, ptr %i.df, align 8, !alias.scope !24868, !noalias !24864
  store <2 x i64> %i.dh, ptr %i.de, align 8, !alias.scope !24867, !noalias !24862
  store <2 x i64> %i.dg, ptr %i.df, align 8, !alias.scope !24868, !noalias !24864
  %i.di = add nuw nsw i64 %.sroa.0.016.i.i, 1     ; 2 uses
  %exitcond.not.i.i = icmp eq i64 %i.di, %i.ct
  br i1 %exitcond.not.i.i, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE7reverseCskXtk6F4WjxZ_4just.exit, label %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE12split_at_mutCskXtk6F4WjxZ_4just.exit11.i.i

_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift10create_runTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB13_NtNtBa_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit: ; preds = %bb.r, %bb.s, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE7reverseCskXtk6F4WjxZ_4just.exit
  %.sroa.0.0.i32 = phi i64 [ %i.cs, %_RNvMNtCsj6eKBz9Db1c_4core5sliceSTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringE7reverseCskXtk6F4WjxZ_4just.exit ], [ %i.cq, %bb.s ], [ %i.co, %bb.r ] ; 2 uses
...
bb.u:                                             ; preds = %.lr.ph125, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB16_NtNtBa_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit
  %.sroa.02.1124 = phi i64 [ %.sroa.02.0, %.lr.ph125 ], [ %i.ds, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB16_NtNtBa_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit ] ; 2 uses
  %.sroa.023.1123 = phi i64 [ %.sroa.023.0, %.lr.ph125 ], [ %.sroa.0.0.i, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB16_NtNtBa_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit ] ; 4 uses
  %i.ds = add i64 %.sroa.02.1124, -1              ; 4 uses
  %i.dt = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.ds
  %i.du = load i8, ptr %i.dt, align 1, !noundef !28
  %.not28 = icmp ult i8 %i.du, %.sroa.021.0
  br i1 %.not28, label %._crit_edge, label %bb.v

._crit_edge:                                      ; preds = %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB16_NtNtBa_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit, %bb.u, %bb.g
  %.sroa.023.1.lcssa = phi i64 [ %.sroa.023.0, %bb.g ], [ %.sroa.023.1123, %bb.u ], [ %.sroa.0.0.i, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB16_NtNtBa_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit ] ; 2 uses
  %.sroa.02.1.lcssa = phi i64 [ %.sroa.02.0, %bb.g ], [ %.sroa.02.1124, %bb.u ], [ 1, %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift13logical_mergeTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB16_NtNtBa_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit ] ; 3 uses
...
bb.v:                                             ; preds = %bb.u
  ...
  %i.dy = load i64, ptr %i.dx, align 8, !noundef !28 ; 3 uses
  %i.dz = lshr i64 %i.dy, 1                       ; 8 uses
  %i.ea = lshr i64 %.sroa.023.1123, 1             ; 6 uses
  %i.eb = add nuw i64 %i.dz, %i.ea                ; 4 uses
  %i.ec = sub i64 %.sroa.09.0, %i.eb
  %i.ed = getelementptr inbounds nuw [48 x i8], ptr %0, i64 %i.ec ; 6 uses
  %i.ee = icmp samesign ugt i64 %i.eb, %3
  %i.ef = trunc i64 %.sroa.023.1123 to i1
  %i.eg = or i64 %i.dy, %.sroa.023.1123
...
bb.z:                                             ; preds = %bb.w
  ...
  tail call void @_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable9quicksort9quicksortTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB15_NtNtBa_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just(ptr noalias nofree noundef nonnull align 8 %i.ed, i64 noundef range(i64 0, 192153584101141163) %i.dz, ptr noalias nofree noundef nonnull align 8 %2, i64 noundef range(i64 0, 192153584101141163) %3, i32 noundef %i.eo, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable_or_null(48) null, ptr noalias nofree noundef nonnull %5) #74, !inline_history !24750
  br label %bb.y

bb.aa:                                            ; preds = %bb.y
  %i.ep = getelementptr inbounds nuw [48 x i8], ptr %i.ed, i64 %i.dz
  %i.eq = or i64 %i.ea, 1
  ...
  tail call void @_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable9quicksort9quicksortTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYB15_NtNtBa_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just(ptr noalias nofree noundef nonnull align 8 %i.ep, i64 noundef range(i64 0, 192153584101141163) %i.ea, ptr noalias nofree noundef nonnull align 8 %2, i64 noundef range(i64 0, 192153584101141163) %3, i32 noundef %i.eu, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable_or_null(48) null, ptr noalias nofree noundef nonnull %5) #74, !inline_history !24750
  br label %bb.ab

bb.ab:                                            ; preds = %bb.aa, %bb.y
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24869)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !24870)
  %i.ev = icmp eq i64 %i.dz, 0
  %i.ew = icmp eq i64 %i.ea, 0
  %or.cond.i = or i1 %i.ew, %i.ev
  br i1 %or.cond.i, label %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5merge5mergeTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYBX_NtNtBa_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit, label %bb.ac

bb.ac:                                            ; preds = %bb.ab
  %..i.i = tail call i64 @llvm.umin.i64(i64 %i.ea, i64 range(i64 0, -9223372036854775808) %i.dz) ; 2 uses
  %i.ex = icmp samesign ult i64 %3, %..i.i
  br i1 %i.ex, label %_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5merge5mergeTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYBX_NtNtBa_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just.exit, label %.critedge.i

.critedge.i:                                      ; preds = %bb.ac
  %i.ey = getelementptr inbounds nuw [48 x i8], ptr %i.ed, i64 %i.dz ; 3 uses
  %.not.i33 = icmp samesign ugt i64 %i.dz, %i.ea  ; 2 uses
  %spec.select.i = select i1 %.not.i33, ptr %i.ey, ptr %i.ed
  %i.ez = mul nuw nsw i64 %..i.i, 48              ; 2 uses
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %2, ptr nonnull align 8 %spec.select.i, i64 %i.ez, i1 false), !alias.scope !24871
  %i.fa = getelementptr inbounds nuw i8, ptr %2, i64 %i.ez ; 3 uses
  br i1 %.not.i33, label %.preheader.i, label %.lr.ph.i.i

.preheader.i:                                     ; preds = %.critedge.i, %_RNvYNvYTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENtNtCsj6eKBz9Db1c_4core3cmp10PartialOrd2ltINtNtNtBR_3ops8function5FnMutTRB5_B1X_EE8call_mutCskXtk6F4WjxZ_4just.exit.i.i
...
end_hunk_8
begin_hunk_9_@_RINvNtNtNtNtCsj6eKBz9Db1c_4core5slice4sort6stable5drift4sortTRSjjNtNtCs4wP2HXfJTCR_5alloc6string6StringENvYBW_NtNtBa_3cmp10PartialOrd2ltECskXtk6F4WjxZ_4just:bb.a
...
bb.l:                                             ; preds = %.lr.ph
  %i.af = add nuw nsw i64 %.sroa.01.0.i.i55, 1    ; 2 uses
...
bb.m:                                             ; preds = %.lr.ph59
  %i.an = add nuw nsw i64 %.sroa.01.1.i.i58, 1    ; 2 uses
