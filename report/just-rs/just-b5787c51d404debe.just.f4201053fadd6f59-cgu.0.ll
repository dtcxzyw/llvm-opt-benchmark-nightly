...
begin_hunk_0
@2733 = private unnamed_addr constant [39 x i8] c"mapped dependencies require `set lists`", align 1
@2734 = private unnamed_addr constant [46 x i8] c"mapped dependencies must have starred argument", align 1
@2735 = private unnamed_addr constant [49 x i8] c"\17justfile requires just \C0\15 or later, but using \C0\00", align 1
@2736 = private unnamed_addr constant [79 x i8] c"\1Emismatched closing delimiter `\C0\1E`, did you mean to close the `\C0\0A` on line \C0\01?\00", align 1
@2737 = private unnamed_addr constant [123 x i8] c"7found a mix of tabs and spaces in leading whitespace: `\C0@`\0Aleading whitespace may consist of tabs or spaces, but not both\00", align 1
@2738 = private unnamed_addr constant [69 x i8] c"\08recipe `\C09` has both `[no-cd]` and `[working-directory]` attributes\00", align 1
@2739 = private unnamed_addr constant [52 x i8] c"\1Boption name for parameter `\C0\15` contains equal sign\00", align 1
@2740 = private unnamed_addr constant [41 x i8] c"\1Boption name for parameter `\C0\0A` is empty\00", align 1
@2741 = private unnamed_addr constant [49 x i8] c"\1Boption name for parameter `\C0\12` starts with dash\00", align 1
@2742 = private unnamed_addr constant [43 x i8] c"\0Bparameter `\C0\1C` follows variadic parameter\00", align 1
@2743 = private unnamed_addr constant [32 x i8] c"parsing recursion depth exceeded", align 1
@2744 = private unnamed_addr constant [59 x i8] c"\C0\02 `\C0\12` defined on line \C0\11 is redefined as \C0\01 \C0\09 on line \C0\00", align 1
@2745 = private unnamed_addr constant [56 x i8] c"\C0\02 `\C0\18` first defined on line \C0\16 is redefined on line \C0\00", align 1
@2746 = private unnamed_addr constant [54 x i8] c"\17non-default parameter `\C0\1B` follows default parameter\00", align 1
@2747 = private unnamed_addr constant [58 x i8] c"\08recipe `\C0.` has both `[script]` and `[shell]` attributes\00", align 1
@2748 = private unnamed_addr constant [45 x i8] c"\01`\C0(` setting must be a plain string literal\00", align 1
@2749 = private unnamed_addr constant [27 x i8] c"\18shell expansion failed: \C0\00", align 1
@2750 = private unnamed_addr constant [67 x i8] c"!short option name for parameter `\C0\1E` contains multiple characters\00", align 1
@2751 = private unnamed_addr constant [61 x i8] c"starred arguments may not be used outside mapped dependencies", align 1
@2752 = private unnamed_addr constant [48 x i8] c"+argument attribute for undefined argument `\C0\01`\00", align 1
@2753 = private unnamed_addr constant [33 x i8] c"\1Ccall to undefined function `\C0\01`\00", align 1
...
@switch.table._RNvMNtCskXtk6F4WjxZ_4just16const_eval_errorNtB2_14ConstEvalError18into_compile_error = private unnamed_addr constant [6 x i8] c" \10\08\100 ", align 8
...
@switch.table._RNvXs2_NtNtCsl9sG9epDjy6_3nix5errno6constsNtB5_5ErrnoNtNtCsj6eKBz9Db1c_4core3fmt5Debug3fmt = private unnamed_addr constant [134 x i8] [i8 12, i8 5, i8 6, i8 5, i8 5, i8 3, i8 5, i8 5, i8 7, i8 5, i8 6, i8 6, i8 6, i8 6, i8 6, i8 7, i8 5, i8 6, i8 5, i8 6, i8 7, i8 6, i8 6, i8 6, i8 6, i8 6, i8 7, i8 5, i8 6, i8 6, i8 5, i8 6, i8 5, i8 4, i8 6, i8 7, i8 12, i8 6, i8 6, i8 9, i8 5, i8 poison, i8 6, i8 5, i8 6, i8 8, i8 6, i8 6, i8 6, i8 7, i8 6, i8 6, i8 5, i8 5, i8 6, i8 6, i8 7, i8 7, i8 poison, i8 6, i8 6, i8 7, i8 5, i8 5, i8 6, i8 6, i8 7, i8 7, i8 4, i8 6, i8 5, i8 6, i8 9, i8 7, i8 7, i8 9, i8 8, i8 6, i8 7, i8 7, i8 7, i8 7, i8 7, i8 8, i8 6, i8 8, i8 8, i8 6, i8 8, i8 12, i8 8, i8 10, i8 11, i8 15, i8 15, i8 10, i8 12, i8 12, i8 10, i8 13, i8 8, i8 11, i8 9, i8 12, i8 10, i8 7, i8 7, i8 8, i8 9, i8 12, i8 9, i8 12, i8 9, i8 12, i8 8, i8 11, i8 6, i8 7, i8 7, i8 7, i8 6, i8 9, i8 6, i8 9, i8 11, i8 9, i8 6, i8 11, i8 11, i8 12, i8 10, i8 15, i8 7, i8 9], align 8
@switch.table._RNvXs2_NtNtCsl9sG9epDjy6_3nix5errno6constsNtB5_5ErrnoNtNtCsj6eKBz9Db1c_4core3fmt5Debug3fmt.5088 = private unnamed_addr constant [134 x ptr] [ptr @1856, ptr @1857, ptr @1858, ptr @1859, ptr @1860, ptr @1861, ptr @1862, ptr @1863, ptr @1864, ptr @1865, ptr @1866, ptr @1867, ptr @1868, ptr @1869, ptr @1870, ptr @1871, ptr @1872, ptr @1873, ptr @1874, ptr @1875, ptr @1876, ptr @1877, ptr @1878, ptr @1879, ptr @1880, ptr @1881, ptr @1882, ptr @1883, ptr @1884, ptr @1885, ptr @1886, ptr @1887, ptr @1888, ptr @1889, ptr @1890, ptr @1891, ptr @1892, ptr @1893, ptr @1894, ptr @1895, ptr @1896, ptr poison, ptr @1897, ptr @1898, ptr @1899, ptr @1900, ptr @1901, ptr @1902, ptr @1903, ptr @1904, ptr @1905, ptr @1906, ptr @1907, ptr @1908, ptr @1909, ptr @1910, ptr @1911, ptr @1912, ptr poison, ptr @1913, ptr @1914, ptr @1915, ptr @1916, ptr @1917, ptr @1918, ptr @1919, ptr @1920, ptr @1921, ptr @1922, ptr @1923, ptr @1924, ptr @1925, ptr @1926, ptr @1927, ptr @1928, ptr @1929, ptr @1930, ptr @1931, ptr @1932, ptr @1933, ptr @1934, ptr @1935, ptr @1936, ptr @1937, ptr @1938, ptr @1939, ptr @1940, ptr @1941, ptr @1942, ptr @1943, ptr @1944, ptr @1945, ptr @1946, ptr @1947, ptr @1948, ptr @1949, ptr @1950, ptr @1951, ptr @1952, ptr @1953, ptr @1954, ptr @1955, ptr @1956, ptr @1957, ptr @1958, ptr @1959, ptr @1960, ptr @1961, ptr @1962, ptr @1963, ptr @1964, ptr @1965, ptr @1966, ptr @1967, ptr @1968, ptr @1969, ptr @1970, ptr @1971, ptr @1972, ptr @1973, ptr @1974, ptr @1975, ptr @1976, ptr @1977, ptr @1978, ptr @1979, ptr @1980, ptr @1981, ptr @1982, ptr @1983, ptr @1984, ptr @1985, ptr @1986, ptr @1987], align 8
...
bb.a:
  ...
  %i.g = tail call noundef align 8 dereferenceable_or_null(256) ptr @_RNvCshxk5dXoXnx9_7___rustc12___rust_alloc(i64 noundef 256, i64 noundef range(i64 1, -9223372036854775807) 8) #70, !noalias !157 ; 11 uses
...
bb.e:                                             ; preds = %bb.a
  ...
  tail call void @_RNvCshxk5dXoXnx9_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #70, !noalias !158
  %i.k = tail call noundef ptr @_RNvCshxk5dXoXnx9_7___rustc12___rust_alloc(i64 noundef range(i64 0, -9223372036854775808) %1, i64 noundef range(i64 1, 9) 1) #70, !noalias !158 ; 3 uses
...
bb.g:                                             ; preds = %bb.e
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %i.k, ptr noundef nonnull readonly align 1 dereferenceable(1) %0, i64 range(i64 0, -9223372036854775808) %1, i1 false), !noalias !159
  tail call void @llvm.experimental.noalias.scope.decl(metadata !160)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !161)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !162)
  %i.m = load i64, ptr %i.g, align 8, !range !27, !alias.scope !163, !noalias !161, !noundef !28
...
bb.h:                                             ; preds = %bb.g
  ...
  %.val.i.i.i.i.i = load i64, ptr %i.o, align 8, !alias.scope !165, !noalias !161 ; 2 uses
...
_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCs4wP2HXfJTCR_5alloc6string6StringECskXtk6F4WjxZ_4just.exit.sink.split.i.i.i: ; preds = %bb.h
  ...
  %.val1.i.i.i = load ptr, ptr %i.q, align 8, !alias.scope !165, !noalias !161, !nonnull !28, !noundef !28
  tail call void @_RNvCshxk5dXoXnx9_7___rustc14___rust_dealloc(ptr noundef nonnull %.val1.i.i.i, i64 noundef %.val.i.i.i.i.i, i64 noundef range(i64 1, -9223372036854775807) 1) #70, !noalias !166
  br label %bb.i
...
bb.i:                                             ; preds = %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCs4wP2HXfJTCR_5alloc6string6StringECskXtk6F4WjxZ_4just.exit.sink.split.i.i.i, %bb.h, %bb.g
  store i64 0, ptr %i.g, align 8, !alias.scope !160, !noalias !161
  %.sroa.5.0..sroa.0.0.3.sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.g, i64 8
  store i64 %1, ptr %.sroa.5.0..sroa.0.0.3.sroa_idx.i, align 8, !alias.scope !167
  %.sroa.4.0..sroa.5.0..sroa.0.0.3.sroa_idx.i.sroa_idx = getelementptr inbounds nuw i8, ptr %i.g, i64 16
  store ptr %i.k, ptr %.sroa.4.0..sroa.5.0..sroa.0.0.3.sroa_idx.i.sroa_idx, align 8, !alias.scope !167
  %.sroa.5.0..sroa.5.0..sroa.0.0.3.sroa_idx.i.sroa_idx = getelementptr inbounds nuw i8, ptr %i.g, i64 24
  store i64 %1, ptr %.sroa.5.0..sroa.5.0..sroa.0.0.3.sroa_idx.i.sroa_idx, align 8, !alias.scope !167
  ret ptr %i.g
...
bb.a:
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
end_hunk_0
begin_hunk_1_@_RNvXs2_NtCskXtk6F4WjxZ_4just9delimiterNtB5_9DelimiterNtNtCsj6eKBz9Db1c_4core3fmt5Debug3fmt:bb.a
  tail call void @llvm.assume(i1 %i.c)
  %i.d = add nsw i8 %i.b, -2
  %.inv = icmp samesign ult i8 %i.b, 2
...
bb.c:                                             ; preds = %bb.a
  %i.e = tail call noundef zeroext i1 @_RNvMsa_NtCsj6eKBz9Db1c_4core3fmtNtB5_9Formatter9write_str(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %1, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @1846, i64 noundef 5)
  br label %bb.g

bb.d:                                             ; preds = %bb.a
  %i.f = tail call noundef zeroext i1 @_RNvMsa_NtCsj6eKBz9Db1c_4core3fmtNtB5_9Formatter9write_str(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %1, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @1847, i64 noundef 7)
  br label %bb.g

bb.e:                                             ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  store ptr %0, ptr %i.a, align 8
  %i.g = call noundef zeroext i1 @_RNvMsa_NtCsj6eKBz9Db1c_4core3fmtNtB5_9Formatter25debug_tuple_field1_finish(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %1, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @1849, i64 noundef 12, ptr noundef nonnull %i.a, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @1848)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a)
  br label %bb.g

bb.f:                                             ; preds = %bb.a
  %i.h = tail call noundef zeroext i1 @_RNvMsa_NtCsj6eKBz9Db1c_4core3fmtNtB5_9Formatter9write_str(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %1, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @1850, i64 noundef 5)
  br label %bb.g

bb.g:                                             ; preds = %bb.f, %bb.e, %bb.d, %bb.c
  %.sroa.0.0.in = phi i1 [ %i.e, %bb.c ], [ %i.f, %bb.d ], [ %i.g, %bb.e ], [ %i.h, %bb.f ]
  ret i1 %.sroa.0.0.in
}

; Function Attrs: nonlazybind uwtable
define internal fastcc noundef zeroext i1 @_RNvXs2_NtNtCsj6eKBz9Db1c_4core5slice3cmpNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralINtB5_14SlicePartialEqBC_E17equal_same_lengthBG_(ptr nofree noundef nonnull readonly captures(none) %0, ptr nofree noundef nonnull readonly captures(none) %1, i64 noundef %2) unnamed_addr #0 {
bb.a:
  %i.a = alloca [64 x i8], align 8                ; 4 uses
  %i.b = alloca [64 x i8], align 8                ; 4 uses
  %i.c = icmp eq i64 %2, 0
  br i1 %i.c, label %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit.thread, label %.lr.ph

bb.b:                                             ; preds = %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit
  %i.d = add nuw i64 %.sroa.01.09, 1              ; 2 uses
  %exitcond.not = icmp eq i64 %i.d, %2
  br i1 %exitcond.not, label %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit.thread, label %.lr.ph

.lr.ph:                                           ; preds = %bb.a, %bb.b
  %.sroa.01.09 = phi i64 [ %i.d, %bb.b ], [ 0, %bb.a ] ; 3 uses
  %i.e = getelementptr inbounds nuw [104 x i8], ptr %0, i64 %.sroa.01.09 ; 15 uses
  %i.f = getelementptr inbounds nuw [104 x i8], ptr %1, i64 %.sroa.01.09 ; 15 uses
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !83195)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !83196)
  %i.g = getelementptr inbounds nuw i8, ptr %i.e, i64 98
  %i.h = load i8, ptr %i.g, align 2, !range !40, !alias.scope !83197, !noalias !83198, !noundef !28
  %i.i = getelementptr inbounds nuw i8, ptr %i.f, i64 98
  %i.j = load i8, ptr %i.i, align 2, !range !40, !alias.scope !83198, !noalias !83197, !noundef !28
  %i.k = icmp eq i8 %i.h, %i.j
  br i1 %i.k, label %bb.c, label %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit.thread

bb.c:                                             ; preds = %.lr.ph
  %i.l = getelementptr inbounds nuw i8, ptr %i.e, i64 16
  %i.m = load i64, ptr %i.l, align 8, !alias.scope !83197, !noalias !83198, !noundef !28 ; 2 uses
  %i.n = getelementptr inbounds nuw i8, ptr %i.f, i64 16
  %i.o = load i64, ptr %i.n, align 8, !alias.scope !83198, !noalias !83197, !noundef !28
  %i.p = icmp eq i64 %i.m, %i.o
  br i1 %i.p, label %bb.d, label %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit.thread

bb.d:                                             ; preds = %bb.c
  %i.q = getelementptr inbounds nuw i8, ptr %i.f, i64 8
  %i.r = load ptr, ptr %i.q, align 8, !alias.scope !83198, !noalias !83197, !nonnull !28, !noundef !28
  %i.s = getelementptr inbounds nuw i8, ptr %i.e, i64 8
  %i.t = load ptr, ptr %i.s, align 8, !alias.scope !83197, !noalias !83198, !nonnull !28, !noundef !28
  %bcmp.i.i = tail call i32 @bcmp(ptr nonnull %i.t, ptr nonnull %i.r, i64 %i.m), !noalias !83199
  %i.u = icmp eq i32 %bcmp.i.i, 0
  br i1 %i.u, label %bb.e, label %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit.thread

bb.e:                                             ; preds = %bb.d
  %i.v = getelementptr inbounds nuw i8, ptr %i.e, i64 96
  %i.w = load i8, ptr %i.v, align 8, !range !40, !alias.scope !83197, !noalias !83198, !noundef !28
  %i.x = getelementptr inbounds nuw i8, ptr %i.f, i64 96
  %i.y = load i8, ptr %i.x, align 8, !range !40, !alias.scope !83198, !noalias !83197, !noundef !28
  %i.z = icmp eq i8 %i.w, %i.y
  br i1 %i.z, label %bb.f, label %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit.thread

bb.f:                                             ; preds = %bb.e
  %i.aa = getelementptr inbounds nuw i8, ptr %i.e, i64 97
  %i.ab = load i8, ptr %i.aa, align 1, !range !38, !alias.scope !83197, !noalias !83198, !noundef !28
  %i.ac = getelementptr inbounds nuw i8, ptr %i.f, i64 97
  %i.ad = load i8, ptr %i.ac, align 1, !range !38, !alias.scope !83198, !noalias !83197, !noundef !28
  %i.ae = icmp eq i8 %i.ab, %i.ad
  br i1 %i.ae, label %bb.g, label %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit.thread

bb.g:                                             ; preds = %bb.f
  %i.af = getelementptr inbounds nuw i8, ptr %i.e, i64 99
  %i.ag = load i8, ptr %i.af, align 1, !range !112, !alias.scope !83197, !noalias !83198, !noundef !28 ; 2 uses
  %.not.i.i = icmp eq i8 %i.ag, -1
  %i.ah = getelementptr inbounds nuw i8, ptr %i.f, i64 99
  %i.ai = load i8, ptr %i.ah, align 1, !range !112, !alias.scope !83198, !noalias !83197, !noundef !28 ; 2 uses
  br i1 %.not.i.i, label %bb.i, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.aj = icmp eq i8 %i.ag, %i.ai
  br i1 %i.aj, label %bb.j, label %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit.thread

bb.i:                                             ; preds = %bb.g
  %i.ak = icmp eq i8 %i.ai, -1
  br i1 %i.ak, label %bb.j, label %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit.thread

bb.j:                                             ; preds = %bb.i, %bb.h
  %i.al = getelementptr inbounds nuw i8, ptr %i.e, i64 24
  %i.am = getelementptr inbounds nuw i8, ptr %i.f, i64 24
  tail call void @llvm.experimental.noalias.scope.decl(metadata !83200)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !83201)
  %i.an = getelementptr inbounds nuw i8, ptr %i.e, i64 56
  %i.ao = load i64, ptr %i.an, align 8, !alias.scope !83200, !noalias !83201, !noundef !28
  %i.ap = getelementptr inbounds nuw i8, ptr %i.f, i64 56
  %i.aq = load i64, ptr %i.ap, align 8, !alias.scope !83201, !noalias !83200, !noundef !28
  %i.ar = icmp eq i64 %i.ao, %i.aq
  br i1 %i.ar, label %bb.k, label %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit.thread

bb.k:                                             ; preds = %bb.j
  %i.as = getelementptr inbounds nuw i8, ptr %i.e, i64 88
  %i.at = load i8, ptr %i.as, align 8, !range !125, !alias.scope !83200, !noalias !83201, !noundef !28
  %i.au = getelementptr inbounds nuw i8, ptr %i.f, i64 88
  %i.av = load i8, ptr %i.au, align 8, !range !125, !alias.scope !83201, !noalias !83200, !noundef !28
  %i.aw = icmp eq i8 %i.at, %i.av
  br i1 %i.aw, label %bb.l, label %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit.thread

bb.l:                                             ; preds = %bb.k
  %i.ax = getelementptr inbounds nuw i8, ptr %i.e, i64 64
  %i.ay = load i64, ptr %i.ax, align 8, !alias.scope !83200, !noalias !83201, !noundef !28
  %i.az = getelementptr inbounds nuw i8, ptr %i.f, i64 64
  %i.ba = load i64, ptr %i.az, align 8, !alias.scope !83201, !noalias !83200, !noundef !28
  %i.bb = icmp eq i64 %i.ay, %i.ba
  br i1 %i.bb, label %bb.m, label %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit.thread

bb.m:                                             ; preds = %bb.l
  %i.bc = getelementptr inbounds nuw i8, ptr %i.e, i64 72
  %i.bd = load i64, ptr %i.bc, align 8, !alias.scope !83200, !noalias !83201, !noundef !28
  %i.be = getelementptr inbounds nuw i8, ptr %i.f, i64 72
  %i.bf = load i64, ptr %i.be, align 8, !alias.scope !83201, !noalias !83200, !noundef !28
  %i.bg = icmp eq i64 %i.bd, %i.bf
  br i1 %i.bg, label %bb.n, label %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit.thread

bb.n:                                             ; preds = %bb.m
  %i.bh = getelementptr inbounds nuw i8, ptr %i.e, i64 80
  %i.bi = load i64, ptr %i.bh, align 8, !alias.scope !83200, !noalias !83201, !noundef !28
  %i.bj = getelementptr inbounds nuw i8, ptr %i.f, i64 80
  %i.bk = load i64, ptr %i.bj, align 8, !alias.scope !83201, !noalias !83200, !noundef !28
  %i.bl = icmp eq i64 %i.bi, %i.bk
  br i1 %i.bl, label %bb.o, label %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit.thread

bb.o:                                             ; preds = %bb.n
  %i.bm = load ptr, ptr %i.al, align 8, !alias.scope !83200, !noalias !83201, !nonnull !28, !noundef !28
  %i.bn = getelementptr inbounds nuw i8, ptr %i.e, i64 32
  %i.bo = load i64, ptr %i.bn, align 8, !alias.scope !83200, !noalias !83201, !noundef !28
  %i.bp = load ptr, ptr %i.am, align 8, !alias.scope !83201, !noalias !83200, !nonnull !28, !noundef !28
  %i.bq = getelementptr inbounds nuw i8, ptr %i.f, i64 32
  %i.br = load i64, ptr %i.bq, align 8, !alias.scope !83201, !noalias !83200, !noundef !28
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !83202
  call void @_RNvMs16_NtCsaKJjC64KgbL_3std4pathNtB6_4Path10components(ptr noalias nofree noundef nonnull sret([64 x i8]) align 8 captures(none) dereferenceable(64) %i.b, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.bm, i64 noundef %i.bo), !noalias !83202
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !83202
  call void @_RNvMs16_NtCsaKJjC64KgbL_3std4pathNtB6_4Path10components(ptr noalias nofree noundef nonnull sret([64 x i8]) align 8 captures(none) dereferenceable(64) %i.a, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.bp, i64 noundef %i.br), !noalias !83202
  %i.bs = call fastcc noundef zeroext i1 @_RNvXsl_NtCsaKJjC64KgbL_3std4pathNtB5_10ComponentsNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2eq(ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(64) %i.b, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(64) %i.a) #76, !noalias !83202
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !83202
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !83202
  br i1 %i.bs, label %bb.p, label %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit.thread

bb.p:                                             ; preds = %bb.o
  %i.bt = getelementptr inbounds nuw i8, ptr %i.e, i64 48
  %i.bu = load i64, ptr %i.bt, align 8, !alias.scope !83200, !noalias !83201, !noundef !28 ; 2 uses
  %i.bv = getelementptr inbounds nuw i8, ptr %i.f, i64 48
  %i.bw = load i64, ptr %i.bv, align 8, !alias.scope !83201, !noalias !83200, !noundef !28
  %i.bx = icmp eq i64 %i.bu, %i.bw
  br i1 %i.bx, label %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit, label %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit.thread

_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit: ; preds = %bb.p
  %i.by = getelementptr inbounds nuw i8, ptr %i.f, i64 40
  %i.bz = load ptr, ptr %i.by, align 8, !alias.scope !83201, !noalias !83200, !nonnull !28, !noundef !28
  %i.ca = getelementptr inbounds nuw i8, ptr %i.e, i64 40
  %i.cb = load ptr, ptr %i.ca, align 8, !alias.scope !83200, !noalias !83201, !nonnull !28, !noundef !28
  %bcmp.i = tail call i32 @bcmp(ptr nonnull %i.cb, ptr nonnull %i.bz, i64 %i.bu), !noalias !83202
  %.not = icmp eq i32 %bcmp.i, 0
  br i1 %.not, label %bb.b, label %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit.thread

_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit.thread: ; preds = %bb.b, %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit, %bb.h, %bb.e, %bb.c, %.lr.ph, %bb.i, %bb.f, %bb.d, %bb.k, %bb.n, %bb.m, %bb.l, %bb.j, %bb.o, %bb.p, %bb.a
  %.lcssa = phi i1 [ true, %bb.a ], [ false, %bb.p ], [ false, %bb.o ], [ false, %bb.j ], [ false, %bb.l ], [ false, %bb.m ], [ false, %bb.n ], [ false, %bb.k ], [ false, %bb.d ], [ false, %bb.f ], [ false, %bb.i ], [ false, %.lr.ph ], [ false, %bb.c ], [ false, %bb.e ], [ false, %bb.h ], [ false, %_RNvYNtNtCskXtk6F4WjxZ_4just14string_literal13StringLiteralNtNtCsj6eKBz9Db1c_4core3cmp9PartialEq2neB6_.exit ], [ true, %bb.b ]
  ret i1 %.lcssa
}
...
switch.lookup:
  %i.a = load i32, ptr %0, align 4, !range !132, !noundef !28 ; 2 uses
  %trunc = zext nneg i32 %i.a to i64
  ...
  %i.c = zext i8 %switch.load to i64
  %switch.gep1 = getelementptr inbounds nuw [8 x i8], ptr @switch.table._RNvXs2_NtNtCsl9sG9epDjy6_3nix5errno6constsNtB5_5ErrnoNtNtCsj6eKBz9Db1c_4core3fmt5Debug3fmt.5088, i64 %trunc
  %switch.load2 = load ptr, ptr %switch.gep1, align 8
  %i.d = tail call noundef zeroext i1 @_RNvMsa_NtCsj6eKBz9Db1c_4core3fmtNtB5_9Formatter9write_str(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %1, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %switch.load2, i64 noundef %i.c)
  ret i1 %i.d
}
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !nonnull !28, !noundef !28 ; 3 uses
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.f = load i64, ptr %i.e, align 8, !noundef !28 ; 4 uses
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %i.i = load i8, ptr %i.h, align 8, !range !40
  %.fr64 = freeze i8 %i.i
  %i.j = trunc i8 %.fr64 to i1
  %i.k = load ptr, ptr %1, align 8, !nonnull !28  ; 5 uses
  %i.l = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.m = load ptr, ptr %i.l, align 8, !nonnull !28, !align !35 ; 4 uses
  ...
  store ptr %i.d, ptr %i.b, align 8, !captures !36
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
...
.lr.ph.split.peel.next:                           ; preds = %bb.c
  %i.q = load ptr, ptr %i.n, align 8, !invariant.load !28, !nonnull !28
  br label %bb.j
...
.lr.ph.split.us.peel.next:                        ; preds = %bb.e
  %i.r = load ptr, ptr %i.n, align 8, !invariant.load !28, !nonnull !28
  br label %bb.f
...
bb.f:                                             ; preds = %bb.h, %.lr.ph.split.us.peel.next
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b)
  store ptr %.sroa.0.058.us, ptr %i.b, align 8, !captures !36
...
bb.h:                                             ; preds = %bb.g
  ...
  br i1 %.not66, label %.loopexit, label %bb.f, !llvm.loop !83203
...
bb.j:                                             ; preds = %bb.k, %.lr.ph.split.peel.next
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b)
  store ptr %.sroa.0.058, ptr %i.b, align 8, !captures !36
...
bb.k:                                             ; preds = %bb.i
  ...
  br i1 %.not65, label %.loopexit, label %bb.j, !llvm.loop !83204
...
bb.a:
  tail call void @llvm.experimental.noalias.scope.decl(metadata !83220)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !83221)
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.b = load ptr, ptr %i.a, align 8, !alias.scope !83220, !noalias !83221, !nonnull !28, !noundef !28
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.d = load i64, ptr %i.c, align 8, !alias.scope !83220, !noalias !83221, !noundef !28 ; 2 uses
  %i.e = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.f = load ptr, ptr %i.e, align 8, !alias.scope !83221, !noalias !83220, !nonnull !28, !noundef !28
  %i.g = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.h = load i64, ptr %i.g, align 8, !alias.scope !83221, !noalias !83220, !noundef !28 ; 2 uses
  %spec.store.select.i = tail call i64 @llvm.umin.i64(i64 %i.d, i64 %i.h)
  %i.i = tail call i32 @memcmp(ptr nonnull %i.b, ptr nonnull %i.f, i64 %spec.store.select.i), !noalias !83222 ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.p = load i8, ptr %i.o, align 2, !range !40, !alias.scope !83220, !noalias !83221, !noundef !28
  %i.q = getelementptr inbounds nuw i8, ptr %1, i64 98
  %i.r = load i8, ptr %i.q, align 2, !range !40, !alias.scope !83221, !noalias !83220, !noundef !28
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.u = load i8, ptr %i.t, align 1, !range !38, !alias.scope !83220, !noalias !83221, !noundef !28 ; 2 uses
  %i.v = getelementptr inbounds nuw i8, ptr %1, i64 97
  %i.w = load i8, ptr %i.v, align 1, !range !38, !alias.scope !83221, !noalias !83220, !noundef !28 ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.aa = load i8, ptr %i.z, align 8, !range !40, !alias.scope !83220, !noalias !83221, !noundef !28
  %i.ab = load i8, ptr %i.y, align 8, !range !40, !alias.scope !83221, !noalias !83220, !noundef !28
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.af = load i8, ptr %i.ae, align 1, !range !112, !alias.scope !83220, !noalias !83221, !noundef !28 ; 3 uses
  %.not.i = icmp eq i8 %i.af, -1
  %i.ag = getelementptr inbounds nuw i8, ptr %1, i64 99
  %i.ah = load i8, ptr %i.ag, align 1, !range !112, !alias.scope !83221, !noalias !83220, !noundef !28 ; 3 uses
