...
.lr.ph:                                           ; preds = %bb.a
  ...
  %2 = zext i1 %i.da to i32
  %.sroa.04.0.i = add nuw nsw i32 %i.cw, %2
  ...
  %3 = add nuw nsw i32 %spec.select.i101.i, 7
  %.pn.i.i = select i1 %i.go, i32 %3, i32 %spec.select.i101.i
  %.sroa.0.0.neg.i.i = add nuw nsw i32 %i.ff, 6
  %4 = sub nsw i32 %.sroa.0.0.neg.i.i, %.pn.i.i
  %5 = trunc nsw i32 %4 to i16
  %.lhs.trunc1.i.i = add nsw i16 %5, 6
