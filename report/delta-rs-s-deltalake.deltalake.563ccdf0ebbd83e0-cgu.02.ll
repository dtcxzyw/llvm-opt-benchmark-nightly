...
92:                                               ; preds = %76
  %.sroa.016.sroa.0.0.copyload.i = load i64, ptr %8, align 8, !noalias !15032 ; [#uses=1 type=i64]
  %.sroa.016.sroa.0.0.copyload.i.fr = freeze i64 %.sroa.016.sroa.0.0.copyload.i ; [#uses=2 type=i64]
...
begin_hunk_2
  ...
  %.not.i2.i.i = icmp eq i64 %.sroa.016.sroa.0.0.copyload.i.fr, 2 ; [#uses=1 type=i1]
  %93 = trunc nuw i64 %.sroa.016.sroa.0.0.copyload.i.fr to i1 ; [#uses=1 type=i1]
...
begin_hunk_3
  ...
  %.first_iter.i.fr = freeze i1 %.first_iter.i    ; [#uses=1 type=i1]
  ...
  %.not259.i.us1787 = icmp eq i64 %.sroa.63.2.i.lcssa302, 0 ; [#uses=2 type=i1]
  br label %189
...
.preheader264.i:                                  ; preds = %219
  %205 = add nuw nsw i64 %.sroa.04.0.i251.i1785, 1 ; [#uses=2 type=i64]
...
.lr.ph1789:                                       ; preds = %.preheader263.i.us.preheader, %.preheader263.i.us
  %.sroa.2.0.i252.i.us1788 = phi i64 [ %207, %.preheader263.i.us ], [ %.sroa.63.2.i.lcssa302, %.preheader263.i.us.preheader ] ; [#uses=1 type=i64]
  %207 = add i64 %.sroa.2.0.i252.i.us1788, -1     ; [#uses=4 type=i64]
...
.lr.ph1786:                                       ; preds = %.preheader264.i.preheader, %.preheader264.i
  %.sroa.04.0.i251.i1785 = phi i64 [ %205, %.preheader264.i ], [ %.sroa.63.2.i.lcssa302, %.preheader264.i.preheader ] ; [#uses=4 type=i64]
  %216 = add i64 %.sroa.04.0.i251.i1785, %191     ; [#uses=2 type=i64]
...
219:                                              ; preds = %.lr.ph1786
  %220 = getelementptr inbounds nuw i8, ptr %.sroa.101.2.i.lcssa, i64 %.sroa.04.0.i251.i1785 ; [#uses=1 type=ptr]
...
226:                                              ; preds = %219
  ...
  %228 = add i64 %227, %.sroa.04.0.i251.i1785     ; [#uses=1 type=i64]
  br label %201
...
248:                                              ; preds = %268
  %249 = add nuw nsw i64 %.sroa.04.0.i233.i1778, 1 ; [#uses=2 type=i64]
...
.lr.ph1780:                                       ; preds = %244, %248
  %.sroa.04.0.i233.i1778 = phi i64 [ %249, %248 ], [ %.sroa.0.0.i.i232.i, %244 ] ; [#uses=4 type=i64]
  %252 = add i64 %.sroa.04.0.i233.i1778, %234     ; [#uses=2 type=i64]
...
.lr.ph1782:                                       ; preds = %.preheader265.i.preheader, %.preheader265.i
  %.sroa.2.0.i234.i1781 = phi i64 [ %256, %.preheader265.i ], [ %.sroa.63.2.i.lcssa302, %.preheader265.i.preheader ] ; [#uses=1 type=i64]
  %256 = add i64 %.sroa.2.0.i234.i1781, -1        ; [#uses=6 type=i64]
...
268:                                              ; preds = %.lr.ph1780
  %269 = getelementptr inbounds nuw i8, ptr %.sroa.101.2.i.lcssa, i64 %.sroa.04.0.i233.i1778 ; [#uses=1 type=ptr]
...
275:                                              ; preds = %268
  ...
  %277 = add i64 %276, %.sroa.04.0.i233.i1778     ; [#uses=1 type=i64]
  br label %.sink.split.i236.i
...
begin_hunk_13
  ...
  %.first_iter1639.i.fr = freeze i1 %.first_iter1639.i ; [#uses=1 type=i1]
  ...
  %.not260.i.us1773 = icmp eq i64 %.sroa.5.0.i, 0 ; [#uses=2 type=i1]
  br label %371
...
.preheader261.i:                                  ; preds = %401
  %387 = add nuw nsw i64 %.sroa.04.0.i218.i1771, 1 ; [#uses=2 type=i64]
...
.lr.ph1775:                                       ; preds = %.preheader.i.us.preheader, %.preheader.i.us
  %.sroa.2.0.i219.i.us1774 = phi i64 [ %389, %.preheader.i.us ], [ %.sroa.5.0.i, %.preheader.i.us.preheader ] ; [#uses=1 type=i64]
  %389 = add i64 %.sroa.2.0.i219.i.us1774, -1     ; [#uses=4 type=i64]
...
.lr.ph1772:                                       ; preds = %.preheader261.i.preheader, %.preheader261.i
  %.sroa.04.0.i218.i1771 = phi i64 [ %387, %.preheader261.i ], [ %.sroa.5.0.i, %.preheader261.i.preheader ] ; [#uses=4 type=i64]
  %398 = add i64 %.sroa.04.0.i218.i1771, %373     ; [#uses=2 type=i64]
...
401:                                              ; preds = %.lr.ph1772
  %402 = getelementptr inbounds nuw i8, ptr %.sroa.016.sroa.14.0.copyload.i, i64 %.sroa.04.0.i218.i1771 ; [#uses=1 type=ptr]
...
408:                                              ; preds = %401
  ...
  %410 = add i64 %409, %.sroa.04.0.i218.i1771     ; [#uses=1 type=i64]
  br label %383
...
431:                                              ; preds = %454
  %432 = add nuw nsw i64 %.sroa.04.0.i200.i1765, 1 ; [#uses=2 type=i64]
...
.lr.ph1767:                                       ; preds = %427, %431
  %.sroa.04.0.i200.i1765 = phi i64 [ %432, %431 ], [ %.sroa.0.0.i.i199.i, %427 ] ; [#uses=4 type=i64]
  %435 = add i64 %.sroa.04.0.i200.i1765, %417     ; [#uses=2 type=i64]
...
.lr.ph1769:                                       ; preds = %.preheader262.i.preheader, %.preheader262.i
  %.sroa.2.0.i201.i1768 = phi i64 [ %439, %.preheader262.i ], [ %.sroa.5.0.i, %.preheader262.i.preheader ] ; [#uses=1 type=i64]
  %439 = add i64 %.sroa.2.0.i201.i1768, -1        ; [#uses=6 type=i64]
...
.invoke.i:                                        ; preds = %.preheader.i.preheader.split, %.preheader263.i.preheader.split, %441, %.lr.ph1769, %.lr.ph1775, %258, %.lr.ph1782, %.lr.ph1789, %459, %406, %273, %224
  %444 = phi i64 [ %umax.i239.i, %273 ], [ %umax.i254.i, %224 ], [ %umax.i206.i, %459 ], [ %259, %258 ], [ %208, %.lr.ph1789 ], [ %umax.i221.i, %406 ], [ %439, %.lr.ph1769 ], [ %390, %.lr.ph1775 ], [ %256, %.lr.ph1782 ], [ %442, %441 ], [ %368, %.preheader.i.preheader.split ], [ %187, %.preheader263.i.preheader.split ] ; [#uses=1 type=i64]
  ...
  %446 = phi ptr [ @16, %273 ], [ @16, %224 ], [ @16, %459 ], [ @15, %258 ], [ @15, %.lr.ph1789 ], [ @16, %406 ], [ @14, %.lr.ph1769 ], [ @15, %.lr.ph1775 ], [ @14, %.lr.ph1782 ], [ @15, %441 ], [ @14, %.preheader263.i.preheader.split ], [ @14, %.preheader.i.preheader.split ] ; [#uses=1 type=ptr]
...
454:                                              ; preds = %.lr.ph1767
  %455 = getelementptr inbounds nuw i8, ptr %.sroa.016.sroa.14.0.copyload.i, i64 %.sroa.04.0.i200.i1765 ; [#uses=1 type=ptr]
...
461:                                              ; preds = %454
  ...
  %463 = add i64 %462, %.sroa.04.0.i200.i1765     ; [#uses=1 type=i64]
  br label %.sink.split.i203.i
...
begin_hunk_23
  ...
  %.not.not.not.i.not.i1792 = icmp eq i64 %474, 0 ; [#uses=1 type=i1]
