...
.lr.ph.i38:                                       ; preds = %.lr.ph.i38, %.lr.ph.preheader.i37
  ...
  %.02830.i40 = phi i64 [ %i.cl, %.lr.ph.i38 ], [ %2, %.lr.ph.preheader.i37 ] ; 4 uses
  %4 = lshr i64 %.02830.i40, 3
  %i.cg = trunc i64 %.02830.i40 to i8
  %i.ch = and i8 %i.cg, 7
...
.lr.ph.i43:                                       ; preds = %.lr.ph.i43, %.lr.ph.preheader.i42
  ...
  %.02830.i45 = phi i64 [ %i.cr, %.lr.ph.i43 ], [ %.0, %.lr.ph.preheader.i42 ] ; 4 uses
  %4 = lshr i64 %.02830.i45, 3
  %i.cm = trunc i64 %.02830.i45 to i8
  %i.cn = and i8 %i.cm, 7
...
.lr.ph.i43:                                       ; preds = %.lr.ph.i43, %.lr.ph.preheader.i42
  ...
  %.02830.i45 = phi i32 [ %i.cd, %.lr.ph.i43 ], [ %.0, %.lr.ph.preheader.i42 ] ; 4 uses
  %4 = lshr i32 %.02830.i45, 3
  %i.by = trunc i32 %.02830.i45 to i8
  %i.bz = and i8 %i.by, 7
  %i.ca = or disjoint i8 %i.bz, 48
...
.lr.ph.i43:                                       ; preds = %.lr.ph.i43, %.lr.ph.preheader.i42
  ...
  %.02830.i45 = phi i32 [ %i.cw, %.lr.ph.i43 ], [ %.0, %.lr.ph.preheader.i42 ] ; 4 uses
  %4 = lshr i32 %.02830.i45, 3
  %i.cr = trunc i32 %.02830.i45 to i8
  %i.cs = and i8 %i.cr, 7
  %i.ct = or disjoint i8 %i.cs, 48
...
.lr.ph.i43:                                       ; preds = %.lr.ph.i43, %.lr.ph.preheader.i42
  ...
  %.02830.i45 = phi i32 [ %i.cv, %.lr.ph.i43 ], [ %.0, %.lr.ph.preheader.i42 ] ; 4 uses
  %4 = lshr i32 %.02830.i45, 3
  %i.cq = trunc i32 %.02830.i45 to i8
  %i.cr = and i8 %i.cq, 7
...
.lr.ph.i38:                                       ; preds = %.lr.ph.i38, %.lr.ph.preheader.i37
  ...
  %.02830.i40 = phi i32 [ %i.cp, %.lr.ph.i38 ], [ %2, %.lr.ph.preheader.i37 ] ; 4 uses
  %4 = lshr i32 %.02830.i40, 3
  %i.ck = trunc i32 %.02830.i40 to i8
  %i.cl = and i8 %i.ck, 7
