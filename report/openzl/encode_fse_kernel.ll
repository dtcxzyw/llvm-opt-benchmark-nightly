...
bb.aq:                                            ; preds = %.lr.ph216, %bb.aq
  ...
  %5 = and i64 %i.hp, 4294967295                  ; 2 uses
  %6 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %5
  %7 = load i32, ptr %6, align 4, !tbaa !20
  %i.hr = zext i32 %7 to i64
...
.lr.ph224:                                        ; preds = %.preheader, %.lr.ph224
  ...
  %8 = zext i32 %.val153 to i64
  %9 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %8
  %10 = load i32, ptr %9, align 4, !tbaa !20
  %i.jb = zext i32 %10 to i64
