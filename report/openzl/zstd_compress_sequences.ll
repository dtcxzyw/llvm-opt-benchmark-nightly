Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/openzl/original/zstd_compress_sequences?download=true
...
bb.a:
  %.val.i = load i16, ptr %0, align 1, !tbaa !15  ; 2 uses
  ...
  %.val = load i16, ptr %i.g, align 1, !tbaa !15
...
bb.b:                                             ; preds = %bb.b, %.new
  ...
  %i.e = load i16, ptr %i.d, align 2, !tbaa !15   ; 2 uses
  ...
  %i.p = load i16, ptr %i.o, align 2, !tbaa !15   ; 2 uses
...
.epil.preheader:                                  ; preds = %.unr-lcssa, %bb.a
  ...
  %i.aa = load i16, ptr %i.z, align 2, !tbaa !15  ; 2 uses
...
bb.t:                                             ; preds = %bb.t, %ZSTD_NCountCost.exit.new
  ...
  %i.cx = load i32, ptr %i.cw, align 4, !tbaa !18 ; 3 uses
  %i.cy = shl i32 %i.cx, 8
  ...
  %i.df = load i32, ptr %i.de, align 4, !tbaa !18
  ...
  %i.dk = load i32, ptr %i.dj, align 4, !tbaa !18 ; 3 uses
  %i.dl = shl i32 %i.dk, 8
  ...
  br i1 %niter99.ncmp.1, label %ZSTD_entropyCost.exit.unr-lcssa, label %bb.t, !llvm.loop !27
...
.epil.preheader93:                                ; preds = %ZSTD_entropyCost.exit.unr-lcssa, %ZSTD_NCountCost.exit
  ...
  %i.dw = load i32, ptr %i.dv, align 4, !tbaa !18 ; 3 uses
  %i.dx = shl i32 %i.dw, 8
...
bb.d:                                             ; preds = %bb.c
  %i.e = load i8, ptr %7, align 1, !tbaa !20
...
bb.d:                                             ; preds = %bb.c
  ...
  %.val.i.i.i = load i16, ptr %2, align 1, !tbaa !15 ; 3 uses
  ...
  %.sroa.0.0.copyload.i.i = load i32, ptr %i.p, align 4, !tbaa !18
  %.sroa.4.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.p, i64 4
  %.sroa.4.0.copyload.i.i = load i32, ptr %.sroa.4.0..sroa_idx.i.i, align 4, !tbaa !18 ; 2 uses
  ...
  %i.ac = load i8, ptr %i.ab, align 1, !tbaa !20  ; 4 uses
  %i.ad = zext i8 %i.ac to i32                    ; 3 uses
  %.val.i.i16.i = load i16, ptr %4, align 1, !tbaa !15 ; 3 uses
  ...
  %.sroa.0.0.copyload.i18.i = load i32, ptr %i.am, align 4, !tbaa !18
  %.sroa.4.0..sroa_idx.i19.i = getelementptr inbounds nuw i8, ptr %i.am, i64 4
  %.sroa.4.0.copyload.i20.i = load i32, ptr %.sroa.4.0..sroa_idx.i19.i, align 4, !tbaa !18 ; 2 uses
  ...
  %.val.i.i21.i = load i16, ptr %6, align 1, !tbaa !15 ; 3 uses
  ...
  %.sroa.0.0.copyload.i23.i = load i32, ptr %i.bi, align 4, !tbaa !18
  %.sroa.4.0..sroa_idx.i24.i = getelementptr inbounds nuw i8, ptr %i.bi, i64 4
  %.sroa.4.0.copyload.i25.i = load i32, ptr %.sroa.4.0..sroa_idx.i24.i, align 4, !tbaa !18 ; 2 uses
  ...
  %i.ce = load i16, ptr %i.cd, align 2, !tbaa !23
...
..thread_crit_edge.i:                             ; preds = %bb.e
  %.pre.i = load i32, ptr %i.bu, align 4, !tbaa !24
  br label %.thread.i

bb.f:                                             ; preds = %bb.e
  %.not93.i.i = icmp eq i8 %i.ac, 56
  %.pre158.i = load i32, ptr %i.bu, align 4, !tbaa !24 ; 3 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  store i64 %i.cs, ptr %0, align 1, !tbaa !26
...
bb.h:                                             ; preds = %bb.d
  %i.dl = load i32, ptr %i.bu, align 4, !tbaa !24
...
bb.i:                                             ; preds = %bb.h, %.thread.i
  ...
  store i64 %.sroa.058.1.i, ptr %.sroa.112.1.i, align 1, !tbaa !26
...
.lr.ph.i:                                         ; preds = %bb.r, %.lr.ph.preheader.i
  ...
  %i.ed = load i8, ptr %i.ec, align 1, !tbaa !20  ; 4 uses
  ...
  %i.ei = load i8, ptr %i.eh, align 1, !tbaa !20  ; 2 uses
  ...
  %i.en = load i8, ptr %i.em, align 1, !tbaa !20  ; 2 uses
  ...
  %.sroa.0.0.copyload.i27.i = load i32, ptr %i.eq, align 4, !tbaa !18
  %.sroa.4.0..sroa_idx.i28.i = getelementptr inbounds nuw i8, ptr %i.eq, i64 4
  %.sroa.4.0.copyload.i29.i = load i32, ptr %.sroa.4.0..sroa_idx.i28.i, align 4, !tbaa !18
  ...
  %i.fe = load i16, ptr %i.fd, align 2, !tbaa !15
  %i.ff = getelementptr inbounds nuw [8 x i8], ptr %i.n, i64 %i.el ; 2 uses
  %.sroa.0.0.copyload.i30.i = load i32, ptr %i.ff, align 4, !tbaa !18
  %.sroa.4.0..sroa_idx.i31.i = getelementptr inbounds nuw i8, ptr %i.ff, i64 4
  %.sroa.4.0.copyload.i32.i = load i32, ptr %.sroa.4.0..sroa_idx.i31.i, align 4, !tbaa !18
  ...
  %.sroa.0.0.copyload.i33.i = load i32, ptr %i.fu, align 4, !tbaa !18
  %.sroa.4.0..sroa_idx.i34.i = getelementptr inbounds nuw i8, ptr %i.fu, i64 4
  %.sroa.4.0.copyload.i35.i = load i32, ptr %.sroa.4.0..sroa_idx.i34.i, align 4, !tbaa !18
...
bb.j:                                             ; preds = %.lr.ph.i
  ...
  store i64 %i.gf, ptr %.sroa.112.2143.i, align 1, !tbaa !26
...
bb.k:                                             ; preds = %bb.j, %.lr.ph.i
  ...
  %i.gy = load i16, ptr %i.gx, align 4, !tbaa !22
  ...
  %i.hh = load i16, ptr %i.hg, align 2, !tbaa !23
...
bb.l:                                             ; preds = %bb.k
  ...
  store i64 %i.hn, ptr %.sroa.112.3.i, align 1, !tbaa !26
...
..thread133_crit_edge.i:                          ; preds = %bb.n
  %.pre159.i = load i32, ptr %i.gw, align 4, !tbaa !24
  br label %.thread133.i

bb.o:                                             ; preds = %bb.n
  %.not94.i.i = icmp eq i8 %i.ed, 56
  %.pre160.i = load i32, ptr %i.gw, align 4, !tbaa !24 ; 3 uses
...
bb.p:                                             ; preds = %bb.o
  ...
  store i64 %i.id, ptr %.sroa.112.4.i, align 1, !tbaa !26
...
bb.q:                                             ; preds = %bb.m
  %i.iw = load i32, ptr %i.gw, align 4, !tbaa !24
...
bb.r:                                             ; preds = %bb.q, %.thread133.i
  ...
  store i64 %.sroa.058.6.i, ptr %.sroa.112.6.i, align 1, !tbaa !26
...
._crit_edge.i:                                    ; preds = %bb.r, %bb.i
  ...
  store i64 %i.jp, ptr %.sroa.112.2.lcssa.i, align 1, !tbaa !26
  ...
  store i64 %i.kc, ptr %spec.store.select.i.i.i, align 1, !tbaa !26
  ...
  store i64 %i.kp, ptr %spec.store.select.i.i40.i, align 1, !tbaa !26
  ...
  store i64 %i.la, ptr %spec.store.select.i.i41.i, align 1, !tbaa !26
...
bb.b:                                             ; preds = %bb.a
  ...
  %.val.i.i = load i16, ptr %2, align 1, !tbaa !15 ; 3 uses
  ...
  %.sroa.0.0.copyload.i = load i32, ptr %i.o, align 4, !tbaa !18
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.o, i64 4
  %.sroa.4.0.copyload.i = load i32, ptr %.sroa.4.0..sroa_idx.i, align 4, !tbaa !18 ; 2 uses
  ...
  %i.ab = load i8, ptr %i.aa, align 1, !tbaa !20  ; 4 uses
  %i.ac = zext i8 %i.ab to i32                    ; 3 uses
  %.val.i.i16 = load i16, ptr %4, align 1, !tbaa !15 ; 3 uses
  ...
  %.sroa.0.0.copyload.i18 = load i32, ptr %i.al, align 4, !tbaa !18
  %.sroa.4.0..sroa_idx.i19 = getelementptr inbounds nuw i8, ptr %i.al, i64 4
  %.sroa.4.0.copyload.i20 = load i32, ptr %.sroa.4.0..sroa_idx.i19, align 4, !tbaa !18 ; 2 uses
  ...
  %.val.i.i21 = load i16, ptr %6, align 1, !tbaa !15 ; 3 uses
  ...
  %.sroa.0.0.copyload.i23 = load i32, ptr %i.bh, align 4, !tbaa !18
  %.sroa.4.0..sroa_idx.i24 = getelementptr inbounds nuw i8, ptr %i.bh, i64 4
  %.sroa.4.0.copyload.i25 = load i32, ptr %.sroa.4.0..sroa_idx.i24, align 4, !tbaa !18 ; 2 uses
  ...
  %i.bv = load i16, ptr %i.bu, align 4, !tbaa !22
  %i.bw = getelementptr inbounds nuw i8, ptr @LL_bits, i64 %i.bg
  %i.bx = load i8, ptr %i.bw, align 1, !tbaa !20  ; 2 uses
  ...
  %i.cf = load i8, ptr %i.ce, align 1, !tbaa !20  ; 2 uses
...
..thread_crit_edge:                               ; preds = %bb.c
  %.pre = load i32, ptr %i.bt, align 4, !tbaa !24
  br label %.thread

bb.d:                                             ; preds = %bb.c
  %.not93.i = icmp eq i8 %i.ab, 56
  %.pre158 = load i32, ptr %i.bt, align 4, !tbaa !24 ; 3 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  store i64 %i.cr, ptr %0, align 1, !tbaa !26
...
bb.f:                                             ; preds = %bb.b
  %i.dk = load i32, ptr %i.bt, align 4, !tbaa !24
...
bb.g:                                             ; preds = %bb.f, %.thread
  ...
  store i64 %.sroa.058.1, ptr %.sroa.112.1, align 1, !tbaa !26
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.p
  ...
  %i.ec = load i8, ptr %i.eb, align 1, !tbaa !20  ; 4 uses
  ...
  %i.eh = load i8, ptr %i.eg, align 1, !tbaa !20  ; 2 uses
  ...
  %i.em = load i8, ptr %i.el, align 1, !tbaa !20  ; 2 uses
  ...
  %.sroa.0.0.copyload.i27 = load i32, ptr %i.ep, align 4, !tbaa !18
  %.sroa.4.0..sroa_idx.i28 = getelementptr inbounds nuw i8, ptr %i.ep, i64 4
  %.sroa.4.0.copyload.i29 = load i32, ptr %.sroa.4.0..sroa_idx.i28, align 4, !tbaa !18
  ...
  %.sroa.0.0.copyload.i30 = load i32, ptr %i.fe, align 4, !tbaa !18
  %.sroa.4.0..sroa_idx.i31 = getelementptr inbounds nuw i8, ptr %i.fe, i64 4
  %.sroa.4.0.copyload.i32 = load i32, ptr %.sroa.4.0..sroa_idx.i31, align 4, !tbaa !18
  ...
  %.sroa.0.0.copyload.i33 = load i32, ptr %i.ft, align 4, !tbaa !18
  %.sroa.4.0..sroa_idx.i34 = getelementptr inbounds nuw i8, ptr %i.ft, i64 4
  %.sroa.4.0.copyload.i35 = load i32, ptr %.sroa.4.0..sroa_idx.i34, align 4, !tbaa !18
...
bb.h:                                             ; preds = %.lr.ph
  ...
  store i64 %i.ge, ptr %.sroa.112.2143, align 1, !tbaa !26
...
bb.i:                                             ; preds = %bb.h, %.lr.ph
  ...
  %i.gx = load i16, ptr %i.gw, align 4, !tbaa !22
...
bb.j:                                             ; preds = %bb.i
  ...
  store i64 %i.hm, ptr %.sroa.112.3, align 1, !tbaa !26
...
..thread133_crit_edge:                            ; preds = %bb.l
  %.pre159 = load i32, ptr %i.gv, align 4, !tbaa !24
  br label %.thread133

bb.m:                                             ; preds = %bb.l
  %.not94.i = icmp eq i8 %i.ec, 56
  %.pre160 = load i32, ptr %i.gv, align 4, !tbaa !24 ; 3 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  store i64 %i.ic, ptr %.sroa.112.4, align 1, !tbaa !26
...
bb.o:                                             ; preds = %bb.k
  %i.iv = load i32, ptr %i.gv, align 4, !tbaa !24
...
bb.p:                                             ; preds = %bb.o, %.thread133
  ...
  store i64 %.sroa.058.6, ptr %.sroa.112.6, align 1, !tbaa !26
...
._crit_edge:                                      ; preds = %bb.p, %bb.g
  ...
  store i64 %i.jo, ptr %.sroa.112.2.lcssa, align 1, !tbaa !26
  ...
  store i64 %i.kb, ptr %spec.store.select.i.i, align 1, !tbaa !26
  ...
  store i64 %i.ko, ptr %spec.store.select.i.i40, align 1, !tbaa !26
  ...
  store i64 %i.kz, ptr %spec.store.select.i.i41, align 1, !tbaa !26
...
!20 = !{!10, !10, i64 0}
!21 = !{!"SeqDef_s", !11, i64 0, !14, i64 4, !14, i64 6}
!22 = !{!21, !14, i64 4}
!23 = !{!21, !14, i64 6}
!24 = !{!21, !11, i64 0}
!25 = !{!"long", !10, i64 0}
