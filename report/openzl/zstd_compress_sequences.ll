...
bb.k:                                             ; preds = %bb.k, %.new
  ...
  %i.x = load i16, ptr %i.w, align 2, !tbaa !15   ; 2 uses
  ...
  %i.ai = load i16, ptr %i.ah, align 2, !tbaa !15 ; 2 uses
...
bb.l:                                             ; preds = %bb.i, %ZSTD_crossEntropyCost.exit
  ...
  %i.bf = load i32, ptr %0, align 4, !tbaa !18
  %.not56 = icmp eq i32 %i.bf, 0
  br i1 %.not56, label %ZSTD_fseBitCost.exit, label %bb.m

bb.m:                                             ; preds = %bb.l
  %.val.i.i = load i16, ptr %6, align 1, !tbaa !15 ; 2 uses
  ...
  %.val.i = load i16, ptr %i.bm, align 1, !tbaa !15
...
bb.t:                                             ; preds = %bb.t, %ZSTD_NCountCost.exit.new
  ...
  %13 = load i32, ptr %12, align 4, !tbaa !18     ; 3 uses
  %14 = shl i32 %13, 8
  ...
  %i.cw = load i32, ptr %24, align 4, !tbaa !18   ; 3 uses
  %i.cx = shl i32 %i.cw, 8
  ...
  br i1 %exitcond.i71, label %ZSTD_entropyCost.exit.unr-lcssa, label %bb.t, !llvm.loop !27
...
.epil.preheader93:                                ; preds = %ZSTD_entropyCost.exit.unr-lcssa, %ZSTD_NCountCost.exit
  ...
  %26 = load i32, ptr %25, align 4, !tbaa !18     ; 3 uses
  %27 = shl i32 %26, 8
