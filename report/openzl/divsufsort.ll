...
.lr.ph.i:                                         ; preds = %bb.n, %.lr.ph.preheader.i
  ...
  %i.ag = load i32, ptr %.084102.i, align 4, !tbaa !12 ; 6 uses
  %i.ah = icmp sgt i32 %i.ag, 0
  %i.ai = xor i32 %i.ag, -1
  store i32 %i.ai, ptr %.084102.i, align 4, !tbaa !12
...
bb.k:                                             ; preds = %bb.j
  ...
  store i32 %i.ay, ptr %i.bb, align 4, !tbaa !12
  br label %bb.l
...
bb.m:                                             ; preds = %bb.l, %bb.i
  ...
  store i32 %.076.i, ptr %.179.i, align 4, !tbaa !12
  br label %bb.n
...
.lr.ph108.i:                                      ; preds = %._crit_edge.i, %bb.f
  ...
  store i32 %i.by, ptr %i.br, align 4, !tbaa !12
...
bb.o:                                             ; preds = %bb.w, %.lr.ph108.i
  ...
  %i.cc = load i32, ptr %.085104.i, align 4, !tbaa !12 ; 5 uses
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.ch = load i8, ptr %i.cg, align 1, !tbaa !13  ; 3 uses
...
bb.t:                                             ; preds = %bb.s
  ...
  store i32 %i.ct, ptr %i.cv, align 4, !tbaa !12
...
bb.u:                                             ; preds = %bb.t, %bb.s
  ...
  store i32 %.177.i, ptr %.482.i, align 4, !tbaa !12
  br label %bb.w

bb.v:                                             ; preds = %bb.o
  %i.dc = xor i32 %i.cc, -1
  store i32 %i.dc, ptr %.085104.i, align 4, !tbaa !12
  br label %bb.w
...
bb.w:                                             ; preds = %bb.v, %bb.u
  ...
  br i1 %i.de, label %bb.o, label %construct_SA.exit, !llvm.loop !21
...
bb.a:                                             ; preds = %bb.b
  ...
  br i1 %.not321, label %.loopexit828, label %bb.b, !llvm.loop !23

bb.b:                                             ; preds = %.lr.ph101, %bb.a
  %.1241100 = phi i32 [ %.0240427104, %.lr.ph101 ], [ %i.u, %bb.a ] ; 2 uses
  %indvars.iv99 = phi i64 [ %i.m, %.lr.ph101 ], [ %i.r, %bb.a ] ; 2 uses
  %i.r = add nsw i64 %indvars.iv99, -1            ; 4 uses
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 %i.r
  %i.t = load i8, ptr %i.s, align 1, !tbaa !13    ; 2 uses
  %i.u = zext i8 %i.t to i32                      ; 4 uses
  %.not289 = icmp sgt i32 %.1241100, %i.u
  br i1 %.not289, label %bb.c, label %bb.a, !llvm.loop !23

bb.c:                                             ; preds = %bb.b
  %i.v = trunc nuw i64 %indvars.iv99 to i32       ; 2 uses
  %i.w = trunc nuw i64 %i.r to i32
  %i.x = shl nuw nsw i32 %i.u, 8
  %i.y = or i32 %i.x, %.1241100
  %i.z = zext nneg i32 %i.y to i64
  %i.aa = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.z ; 2 uses
  %i.ab = load i32, ptr %i.aa, align 4, !tbaa !12
  %i.ac = add nsw i32 %i.ab, 1
  store i32 %i.ac, ptr %i.aa, align 4, !tbaa !12
  %i.ad = add nsw i32 %.0246426105, -1            ; 5 uses
  %i.ae = sext i32 %i.ad to i64
  %i.af = getelementptr inbounds [4 x i8], ptr %1, i64 %i.ae
  store i32 %i.w, ptr %i.af, align 4, !tbaa !12
  %i.ag = icmp sgt i32 %i.v, 1
  br i1 %i.ag, label %.lr.ph.preheader, label %.loopexit828
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.d
  %.0420 = phi i32 [ %i.al, %bb.d ], [ %i.u, %.lr.ph.preheader ] ; 2 uses
  %.4261419 = phi i32 [ %i.as, %bb.d ], [ %i.ah, %.lr.ph.preheader ] ; 5 uses
  %i.ai = zext nneg i32 %.4261419 to i64
  ...
  %.not290 = icmp samesign ult i32 %.0420, %i.al
  br i1 %.not290, label %.preheader338.loopexit, label %bb.d

bb.d:                                             ; preds = %.lr.ph
  %i.am = shl nuw nsw i32 %.0420, 8
...
.loopexit337:                                     ; preds = %.lr.ph431.prol.loopexit, %.lr.ph431, %bb.e
  %.7264.lcssa = phi i32 [ %i.bd, %bb.e ], [ %.lcssa337.unr, %.lr.ph431.prol.loopexit ], [ %i.bs, %.lr.ph431 ]
  ...
  br i1 %exitcond584.not, label %bb.f, label %bb.e, !llvm.loop !25

bb.e:                                             ; preds = %.loopexit828, %.loopexit337
  %indvars.iv581 = phi i64 [ 0, %.loopexit828 ], [ %indvars.iv.next582, %.loopexit337 ] ; 9 uses
  %indvars.iv576 = phi i64 [ 1, %.loopexit828 ], [ %indvars.iv.next577, %.loopexit337 ] ; 5 uses
  %.0251434 = phi i32 [ 0, %.loopexit828 ], [ %.1252.lcssa, %.loopexit337 ] ; 4 uses
  %.6263433 = phi i32 [ 0, %.loopexit828 ], [ %.7264.lcssa, %.loopexit337 ] ; 2 uses
  %i.au = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %indvars.iv581 ; 2 uses
  %i.av = load i32, ptr %i.au, align 4, !tbaa !12
  %i.aw = add nsw i32 %i.av, %.6263433
  %i.ax = add nsw i32 %.0251434, %.6263433
  store i32 %i.ax, ptr %i.au, align 4, !tbaa !12
  %i.ay = shl i64 %indvars.iv581, 8
  %i.az = and i64 %i.ay, 4294967040
  %i.ba = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.az
  %i.bb = getelementptr inbounds nuw [4 x i8], ptr %i.ba, i64 %indvars.iv581
  ...
  %i.be = icmp samesign ult i64 %indvars.iv581, 255
  br i1 %i.be, label %.lr.ph431.preheader, label %.loopexit337

.lr.ph431.preheader:                              ; preds = %bb.e
  %.idx806 = shl nuw nsw i64 %indvars.iv581, 10
  %invariant.gep = getelementptr inbounds nuw i8, ptr %3, i64 %.idx806 ; 3 uses
  %invariant.gep918 = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %indvars.iv581 ; 3 uses
  %i.bf = and i64 %indvars.iv581, 1
...
.lr.ph431.prol:                                   ; preds = %.lr.ph431.preheader
  ...
  %i.bg = load i32, ptr %gep.prol, align 4, !tbaa !12
  %i.bh = add nsw i32 %i.bg, %.0251434            ; 3 uses
  store i32 %i.bh, ptr %gep.prol, align 4, !tbaa !12
  %.idx807.prol = shl nuw nsw i64 %indvars.iv576, 10
  %gep919.prol = getelementptr inbounds nuw i8, ptr %invariant.gep918, i64 %.idx807.prol
  %i.bi = load i32, ptr %gep919.prol, align 4, !tbaa !12
...
.lr.ph431.prol.loopexit:                          ; preds = %.lr.ph431.prol, %.lr.ph431.preheader
  ...
  %.7264428.unr = phi i32 [ %i.bd, %.lr.ph431.preheader ], [ %i.bj, %.lr.ph431.prol ]
...
.lr.ph431:                                        ; preds = %.lr.ph431.prol.loopexit, %.lr.ph431
  ...
  %i.bp = load i32, ptr %gep.1, align 4, !tbaa !12
  %i.bq = add nsw i32 %i.bp, %i.bm                ; 3 uses
  store i32 %i.bq, ptr %gep.1, align 4, !tbaa !12
  %.idx807.1 = shl nuw nsw i64 %indvars.iv.next579, 10
  %gep919.1 = getelementptr inbounds nuw i8, ptr %invariant.gep918, i64 %.idx807.1
  %i.br = load i32, ptr %gep919.1, align 4, !tbaa !12
  ...
  br i1 %exitcond.not.1, label %.loopexit337, label %.lr.ph431, !llvm.loop !26
...
.lr.ph437.preheader:                              ; preds = %bb.g
  ...
  %i.cd = and i64 %i.cc, 1
  %lcmp.mod357.not.not = icmp eq i64 %i.cd, 0
...
.lr.ph437.prol:                                   ; preds = %.lr.ph437.preheader
  ...
  store i32 %i.cq, ptr %i.co, align 4, !tbaa !12
  %i.cr = sext i32 %i.cq to i64
  %i.cs = getelementptr inbounds [4 x i8], ptr %1, i64 %i.cr
  store i32 %i.cb, ptr %i.cs, align 4, !tbaa !12
...
.lr.ph437.prol.loopexit:                          ; preds = %.lr.ph437.prol, %.lr.ph437.preheader
  ...
  br i1 %i.ct, label %.preheader336.lr.ph, label %.lr.ph437
...
.lr.ph437:                                        ; preds = %.lr.ph437.prol.loopexit, %.lr.ph437
  ...
  %i.cu = getelementptr inbounds nuw [4 x i8], ptr %i.bz, i64 %indvars.iv585
  ...
  store i32 %i.dg, ptr %i.de, align 4, !tbaa !12
  %i.dh = sext i32 %i.dg to i64
  %i.di = getelementptr inbounds [4 x i8], ptr %1, i64 %i.dh
  %i.dj = trunc nuw nsw i64 %indvars.iv585 to i32
  store i32 %i.dj, ptr %i.di, align 4, !tbaa !12
  %indvars.iv.next586 = add nsw i64 %indvars.iv585, -1 ; 3 uses
  %i.dk = getelementptr inbounds nuw [4 x i8], ptr %i.bz, i64 %indvars.iv.next586
  ...
  store i32 %i.dw, ptr %i.du, align 4, !tbaa !12
  %i.dx = sext i32 %i.dw to i64
  %i.dy = getelementptr inbounds [4 x i8], ptr %1, i64 %i.dx
  %i.dz = trunc nuw nsw i64 %indvars.iv.next586 to i32
  store i32 %i.dz, ptr %i.dy, align 4, !tbaa !12
  %indvars.iv.next586.1 = add nsw i64 %indvars.iv585, -2
  %.not922.1 = icmp eq i64 %indvars.iv.next586, 0
  br i1 %.not922.1, label %.preheader336.lr.ph, label %.lr.ph437, !llvm.loop !27
...
.preheader336.lr.ph:                              ; preds = %.lr.ph437.prol.loopexit, %.lr.ph437, %bb.g
  ...
  store i32 %i.ea, ptr %i.eq, align 4, !tbaa !12
