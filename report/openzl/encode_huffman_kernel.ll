...
.preheader.preheader:                             ; preds = %bb.g
  %i.ad = add i64 %2, -1                          ; 2 uses
  %xtraiter = and i64 %2, 1
  %i.ae = icmp eq i64 %i.ad, 0
  br i1 %i.ae, label %.preheader.epil.preheader, label %.preheader.preheader.new
...
.thread:                                          ; preds = %bb.g
  %i.af = call { i32, ptr } (ptr, ptr, ptr, ptr, i32, i32, ptr, ...) @ZL_E_create(ptr noundef nonnull @ZS_largeHuffmanEncode.__zl_static_error_info.26, ptr noundef nonnull %7, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.25, i32 noundef 554, i32 noundef 70, ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.28, ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.6, ptr noundef null, ptr noundef null) #12 ; 2 uses
  %i.ag = extractvalue { i32, ptr } %i.af, 0      ; 2 uses
  %i.ah = extractvalue { i32, ptr } %i.af, 1      ; 2 uses
  call void (i32, ptr, ptr, ...) @ZL_E_appendToMessage(i32 %i.ag, ptr %i.ah, ptr noundef nonnull @.str.7, ptr noundef nonnull @.str.8) #12
...
.preheader.epil.preheader:                        ; preds = %.unr-lcssa, %.preheader.preheader
  ...
  %i.an = add i32 %i.am, 1
  store i32 %i.an, ptr %i.al, align 4, !tbaa !19
  br label %bb.h
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader.new
  ...
  %i.ay = add i32 %i.ax, 1
  store i32 %i.ay, ptr %i.aw, align 4, !tbaa !19
  %i.az = add nuw i64 %.0104146, 2                ; 2 uses
...
bb.i:                                             ; preds = %bb.i, %bb.h
  ...
  %i.be = add i16 %.0, -1
  br i1 %i.bd, label %bb.i, label %bb.j, !llvm.loop !70

bb.j:                                             ; preds = %bb.i
  %i.bf = zext i32 %i.bc to i64
  %i.bg = icmp eq i64 %2, %i.bf
  br i1 %i.bg, label %bb.k, label %bb.n

bb.k:                                             ; preds = %bb.j
  tail call void @free(ptr noundef nonnull %i.ac) #12
  ...
  %i.bh = ptrtoint ptr %.val118 to i64
  %i.bi = ptrtoint ptr %.val117 to i64            ; 2 uses
  %i.bj = sub i64 %i.bh, %i.bi
  %i.bk = or i64 %2, 1
  %i.bl = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 1, 0) %i.bk, i1 true)
  %i.bm = trunc nuw nsw i64 %i.bl to i8
  %narrow2.i = sub nuw nsw i8 70, %i.bm
  %i.bn = udiv i8 %narrow2.i, 7
  %narrow = add nuw nsw i8 %i.bn, 2
  %i.bo = zext nneg i8 %narrow to i64
  %i.bp = icmp ult i64 %i.bj, %i.bo
  br i1 %i.bp, label %bb.l, label %bb.m

bb.l:                                             ; preds = %bb.k
  %i.bq = call { i32, ptr } (ptr, ptr, ptr, ptr, i32, i32, ptr, ...) @ZL_E_create(ptr noundef nonnull @ZS_largeHuffmanEncode.__zl_static_error_info.29, ptr noundef nonnull %7, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.25, i32 noundef 577, i32 noundef 1, ptr noundef nonnull @.str.11, ptr noundef nonnull @.str.8) #12 ; 2 uses
  %i.br = extractvalue { i32, ptr } %i.bq, 0      ; 2 uses
  %i.bs = extractvalue { i32, ptr } %i.bq, 1      ; 2 uses
  call void (i32, ptr, ptr, ...) @ZL_E_appendToMessage(i32 %i.br, ptr %i.bs, ptr noundef nonnull @.str.12) #12
  %i.bt = ptrtoint ptr %i.bs to i64
  br label %bb.ac

bb.m:                                             ; preds = %bb.k
  %i.bu = icmp samesign ugt i64 %2, 127
  br i1 %i.bu, label %.lr.ph.i.i, label %ZL_WC_pushVarint.exit

.lr.ph.i.i:                                       ; preds = %bb.m, %.lr.ph.i.i
  %.010.i.i = phi ptr [ %i.bx, %.lr.ph.i.i ], [ %.val117, %bb.m ] ; 2 uses
  %.089.i.i = phi i64 [ %i.by, %.lr.ph.i.i ], [ %2, %bb.m ] ; 3 uses
  %i.bv = trunc i64 %.089.i.i to i8
  %i.bw = or i8 %i.bv, -128
  %i.bx = getelementptr inbounds nuw i8, ptr %.010.i.i, i64 1 ; 2 uses
  store i8 %i.bw, ptr %.010.i.i, align 1, !tbaa !28
  %i.by = lshr i64 %.089.i.i, 7                   ; 2 uses
  %i.bz = icmp ugt i64 %.089.i.i, 16383
  br i1 %i.bz, label %.lr.ph.i.i, label %ZL_WC_pushVarint.exit, !llvm.loop !71

ZL_WC_pushVarint.exit:                            ; preds = %.lr.ph.i.i, %bb.m
  %.08.lcssa.i.i = phi i64 [ %2, %bb.m ], [ %i.by, %.lr.ph.i.i ]
  %.0.lcssa.i.i = phi ptr [ %.val117, %bb.m ], [ %i.bx, %.lr.ph.i.i ] ; 2 uses
  %i.ca = trunc nuw nsw i64 %.08.lcssa.i.i to i8
  %i.cb = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i, i64 1
  store i8 %i.ca, ptr %.0.lcssa.i.i, align 1, !tbaa !28
  %i.cc = ptrtoint ptr %i.cb to i64
  %i.cd = sub i64 %i.cc, %i.bi
  %i.ce = load ptr, ptr %i.t, align 8, !tbaa !30
  %i.cf = getelementptr inbounds nuw i8, ptr %i.ce, i64 %i.cd ; 2 uses
  store ptr %i.cf, ptr %i.t, align 8, !tbaa !30
  store i16 %.0, ptr %i.cf, align 1
  %i.cg = load ptr, ptr %i.t, align 8, !tbaa !30
  %i.ch = getelementptr inbounds nuw i8, ptr %i.cg, i64 2
  store ptr %i.ch, ptr %i.t, align 8, !tbaa !30
  br label %bb.ac

bb.n:                                             ; preds = %bb.j
  store i8 0, ptr %.val119, align 1, !tbaa !28
  %i.ci = add nuw nsw i64 %i.ba, 1
  %i.cj = tail call noalias ptr @calloc(i64 noundef %i.ci, i64 noundef 4) #14 ; 7 uses
  %i.ck = icmp eq ptr %i.cj, null
  br i1 %i.ck, label %bb.o, label %bb.p

bb.o:                                             ; preds = %bb.n
  tail call void @free(ptr noundef nonnull %i.ac) #12
  %i.cl = call { i32, ptr } (ptr, ptr, ptr, ptr, i32, i32, ptr, ...) @ZL_E_create(ptr noundef nonnull @ZS_largeHuffmanEncode.__zl_static_error_info.30, ptr noundef nonnull %7, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.25, i32 noundef 589, i32 noundef 70, ptr noundef nonnull @.str.11, ptr noundef nonnull @.str.8) #12 ; 2 uses
  %i.cm = extractvalue { i32, ptr } %i.cl, 0      ; 2 uses
  %i.cn = extractvalue { i32, ptr } %i.cl, 1      ; 2 uses
  call void (i32, ptr, ptr, ...) @ZL_E_appendToMessage(i32 %i.cm, ptr %i.cn, ptr noundef nonnull @.str.12) #12
  %i.co = ptrtoint ptr %i.cn to i64
  br label %bb.ac

bb.p:                                             ; preds = %bb.n
  %i.cp = tail call { i32, i64 } @ZS_largeHuffmanBuildCTable(ptr noundef nonnull %i.cj, ptr noundef nonnull %i.ac, i16 noundef zeroext %.0, i32 noundef %spec.store.select) ; 2 uses
  %i.cq = extractvalue { i32, i64 } %i.cp, 0      ; 2 uses
  %i.cr = extractvalue { i32, i64 } %i.cp, 1      ; 2 uses
  %.not136 = icmp eq i32 %i.cq, 0
  br i1 %.not136, label %bb.r, label %bb.q

bb.q:                                             ; preds = %bb.p
  tail call void @free(ptr noundef nonnull %i.ac) #12
  tail call void @free(ptr noundef nonnull %i.cj) #12
  br label %bb.ac
...
bb.r:                                             ; preds = %bb.p
  ...
  %i.ct = ptrtoint ptr %.val116 to i64
  %i.cu = ptrtoint ptr %.val115 to i64
  %i.cv = sub i64 %i.ct, %i.cu
  %i.cw = icmp ult i64 %i.cv, 8
  br i1 %i.cw, label %bb.y, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.cx = tail call { i32, i64 } @ZS_largeHuffmanWriteCTable(ptr noundef nonnull %0, ptr noundef nonnull %i.cj, i16 noundef zeroext %.0, i32 noundef %i.cs)
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.cz = icmp eq ptr %.val114, %.val
  br i1 %i.cz, label %bb.y, label %bb.u

bb.u:                                             ; preds = %bb.t
  %i.da = icmp ugt i64 %2, 1024
  %i.db = getelementptr inbounds nuw i8, ptr %.val, i64 1
  store ptr %i.db, ptr %i.t, align 8, !tbaa !30
  br i1 %i.da, label %bb.v, label %bb.w

bb.v:                                             ; preds = %bb.u
  store i8 1, ptr %.val, align 1, !tbaa !28
  %i.dc = tail call { i32, i64 } @ZS_largeHuffmanEncodeUsingCTableX4(ptr noundef nonnull %0, ptr noundef nonnull %1, i64 noundef %2, ptr noundef nonnull %i.cj, i32 noundef %i.cs)
...
bb.w:                                             ; preds = %bb.u
  ...
  %i.de = tail call { i32, i64 } @ZS_largeHuffmanEncodeUsingCTable(ptr noundef nonnull %0, ptr noundef nonnull %1, i64 noundef %2, ptr noundef nonnull %i.cj, i32 noundef %i.cs)
  %i.df = extractvalue { i32, i64 } %i.de, 0
  %.not138 = icmp eq i32 %i.df, 0
  br i1 %.not138, label %bb.x, label %bb.y

bb.x:                                             ; preds = %bb.w, %bb.v
  %.val121 = load ptr, ptr %i.t, align 8, !tbaa !30
  %i.dg = ptrtoint ptr %.val121 to i64
  %i.dh = sub i64 %i.dg, %i.v
  %i.di = shl i64 %2, 1
  %.not113 = icmp ult i64 %i.dh, %i.di
...
bb.y:                                             ; preds = %bb.x, %bb.w, %bb.v, %bb.t, %bb.s, %bb.r
  ...
  %i.dk = ptrtoint ptr %.val13.i127 to i64
  %i.dl = ptrtoint ptr %.val.i126 to i64
  %i.dm = sub i64 %i.dk, %i.dl
  %i.dn = or i64 %2, 1
  %i.do = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 1, 0) %i.dn, i1 true)
  %i.dp = trunc nuw nsw i64 %i.do to i8
  %narrow2.i.i = sub nuw nsw i8 70, %i.dp
  %i.dq = udiv i8 %narrow2.i.i, 7
  %narrow.i = add nuw nsw i8 %i.dq, 1
  %i.dr = zext nneg i8 %narrow.i to i64
  %i.ds = shl i64 %2, 1
...
bb.z:                                             ; preds = %bb.y
  %i.dv = call { i32, ptr } (ptr, ptr, ptr, ptr, i32, i32, ptr, ...) @ZL_E_create(ptr noundef nonnull @ZS_largeHuffmanUncompressed.__zl_static_error_info, ptr noundef nonnull %5, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.36, i32 noundef 519, i32 noundef 1, ptr noundef nonnull @.str.11, ptr noundef nonnull @.str.8) #12 ; 2 uses
  %i.dw = extractvalue { i32, ptr } %i.dv, 0      ; 2 uses
  %i.dx = extractvalue { i32, ptr } %i.dv, 1      ; 2 uses
  call void (i32, ptr, ptr, ...) @ZL_E_appendToMessage(i32 %i.dw, ptr %i.dx, ptr noundef nonnull @.str.12) #12
  %i.dy = ptrtoint ptr %i.dx to i64
  br label %ZS_largeHuffmanUncompressed.exit133

bb.aa:                                            ; preds = %bb.y
  %i.dz = getelementptr inbounds nuw i8, ptr %.val.i126, i64 1
  store ptr %i.dz, ptr %i.t, align 8, !tbaa !30
  store i8 1, ptr %.val.i126, align 1, !tbaa !28
  %.val.i.i128 = load ptr, ptr %i.t, align 8, !tbaa !30 ; 3 uses
  %i.ea = icmp ugt i64 %2, 127
  br i1 %i.ea, label %.lr.ph.i.i.i, label %ZL_WC_pushVarint.exit.i

.lr.ph.i.i.i:                                     ; preds = %bb.aa, %.lr.ph.i.i.i
  %.010.i.i.i = phi ptr [ %i.ed, %.lr.ph.i.i.i ], [ %.val.i.i128, %bb.aa ] ; 3 uses
  %.089.i.i.i = phi i64 [ %i.ee, %.lr.ph.i.i.i ], [ %2, %bb.aa ] ; 3 uses
  %i.eb = trunc i64 %.089.i.i.i to i8
  %i.ec = or i8 %i.eb, -128
  %i.ed = getelementptr inbounds nuw i8, ptr %.010.i.i.i, i64 1 ; 2 uses
  store i8 %i.ec, ptr %.010.i.i.i, align 1, !tbaa !28
  %i.ee = lshr i64 %.089.i.i.i, 7                 ; 2 uses
  %i.ef = icmp ugt i64 %.089.i.i.i, 16383
  br i1 %i.ef, label %.lr.ph.i.i.i, label %ZL_WC_pushVarint.exit.thread.i, !llvm.loop !71

ZL_WC_pushVarint.exit.thread.i:                   ; preds = %.lr.ph.i.i.i
  %i.eg = trunc nuw nsw i64 %i.ee to i8
end_hunk_0
