...
begin_hunk_0_@ZS_largeHuffmanEncodeUsingCTable:bb.a
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.hx, i64 2
  %.sroa.4.0.copyload.i = load i16, ptr %.sroa.4.0..sroa_idx.i, align 2, !tbaa !25
  %i.hy = zext i16 %.sroa.4.0.copyload.i to i32   ; 2 uses
  %notmask.i78 = shl nsw i32 -1, %i.hy
  %i.hz = xor i32 %notmask.i78, -1
  %i.ia = zext i16 %.sroa.0.0.copyload.i to i32
  %i.ib = and i32 %i.hz, %i.ia
  %i.ic = zext nneg i32 %i.ib to i64
  %i.id = zext nneg i32 %.sroa.29.2141 to i64
  %i.ie = shl nuw nsw i64 %i.ic, %i.id
  %i.if = or i64 %i.ie, %.sroa.0.2142             ; 2 uses
  %i.ig = add nuw nsw i32 %.sroa.29.2141, %i.hy   ; 2 uses
  %i.ih = lshr i32 %i.ig, 3
  %i.ii = zext nneg i32 %i.ih to i64              ; 2 uses
  store i64 %i.if, ptr %.sroa.58.2140, align 1, !tbaa !67
  %i.ij = getelementptr inbounds nuw i8, ptr %.sroa.58.2140, i64 %i.ii ; 2 uses
  %i.ik = icmp ugt ptr %i.ij, %i.u
  %spec.store.select.i79 = select i1 %i.ik, ptr %i.u, ptr %i.ij ; 2 uses
  %i.il = and i32 %i.ig, 7                        ; 2 uses
  %i.im = shl nuw nsw i64 %i.ii, 3
  %i.in = lshr i64 %i.if, %i.im                   ; 2 uses
  %i.io = add nuw i64 %.027.i143, 1               ; 2 uses
  %exitcond = icmp eq i64 %i.io, %umax
...
ZS_largeHuffmanEncodeUsingCTable_body.exit64:     ; preds = %bb.l, %bb.j, %bb.g
  %.sroa.58.0 = phi ptr [ %spec.store.select.i75, %bb.j ], [ %spec.store.select.i71, %bb.g ], [ %spec.store.select.i79, %bb.l ] ; 2 uses
  %.sroa.29.0 = phi i32 [ %i.ge, %bb.j ], [ %i.dh, %bb.g ], [ %i.il, %bb.l ] ; 2 uses
  %.sroa.0.0 = phi i64 [ %i.gg, %bb.j ], [ %i.dj, %bb.g ], [ %i.in, %bb.l ]
  %i.ip = zext nneg i32 %.sroa.29.0 to i64
  %i.iq = shl nuw nsw i64 1, %i.ip
  %i.ir = or i64 %i.iq, %.sroa.0.0
  %i.is = add nuw nsw i32 %.sroa.29.0, 1          ; 2 uses
  %i.it = lshr i32 %i.is, 3
  %i.iu = zext nneg i32 %i.it to i64
  store i64 %i.ir, ptr %.sroa.58.0, align 1, !tbaa !67
  %i.iv = getelementptr inbounds nuw i8, ptr %.sroa.58.0, i64 %i.iu ; 2 uses
  %i.iw = icmp ugt ptr %i.iv, %i.u
  %spec.store.select.i.i = select i1 %i.iw, ptr %i.u, ptr %i.iv ; 2 uses
  %.not.i80 = icmp ult ptr %spec.store.select.i.i, %i.u
  br i1 %.not.i80, label %BIT_closeCStream.exit, label %BIT_closeCStream.exit.thread

BIT_closeCStream.exit:                            ; preds = %ZS_largeHuffmanEncodeUsingCTable_body.exit64
  %i.ix = and i32 %i.is, 7
  %i.iy = ptrtoint ptr %spec.store.select.i.i to i64
  %i.iz = icmp ne i32 %i.ix, 0
  %i.ja = zext i1 %i.iz to i64
  %i.jb = add i64 %i.iy, %i.ja                    ; 2 uses
  %i.jc = icmp eq i64 %i.jb, %i.r
  br i1 %i.jc, label %BIT_closeCStream.exit.thread, label %bb.m

BIT_closeCStream.exit.thread:                     ; preds = %ZS_largeHuffmanEncodeUsingCTable_body.exit64, %BIT_closeCStream.exit
  %i.jd = call { i32, ptr } (ptr, ptr, ptr, ptr, i32, i32, ptr, ...) @ZL_E_create(ptr noundef nonnull @ZS_largeHuffmanEncodeUsingCTable.__zl_static_error_info.23, ptr noundef nonnull %5, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.21, i32 noundef 486, i32 noundef 1, ptr noundef nonnull @.str.11, ptr noundef nonnull @.str.8) #12 ; 2 uses
  %i.je = extractvalue { i32, ptr } %i.jd, 0      ; 2 uses
  %i.jf = extractvalue { i32, ptr } %i.jd, 1      ; 2 uses
  call void (i32, ptr, ptr, ...) @ZL_E_appendToMessage(i32 %i.je, ptr %i.jf, ptr noundef nonnull @.str.12) #12
  %i.jg = ptrtoint ptr %i.jf to i64
  br label %bb.n

bb.m:                                             ; preds = %BIT_closeCStream.exit
  %i.jh = sub i64 %i.jb, %i.r                     ; 2 uses
  %i.ji = getelementptr inbounds nuw i8, ptr %i.p, i64 %i.jh
  store ptr %i.ji, ptr %i.c, align 8, !tbaa !30
  %i.jj = trunc i64 %i.jh to i32
  store i32 %i.jj, ptr %i.o, align 1
  br label %bb.n

bb.n:                                             ; preds = %bb.d, %bb.m, %BIT_closeCStream.exit.thread, %bb.b
  %.sroa.036.2 = phi i32 [ %i.j, %bb.b ], [ %i.x, %bb.d ], [ %i.je, %BIT_closeCStream.exit.thread ], [ 0, %bb.m ]
  %.sroa.8.2 = phi i64 [ %i.l, %bb.b ], [ %i.z, %bb.d ], [ %i.jg, %BIT_closeCStream.exit.thread ], [ 0, %bb.m ]
...
bb.z:                                             ; preds = %bb.y
  %i.eg = call { i32, ptr } (ptr, ptr, ptr, ptr, i32, i32, ptr, ...) @ZL_E_create(ptr noundef nonnull @ZS_largeHuffmanUncompressed.__zl_static_error_info, ptr noundef nonnull %5, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.36, i32 noundef 519, i32 noundef 1, ptr noundef nonnull @.str.11, ptr noundef nonnull @.str.8) #12 ; 2 uses
  %i.eh = extractvalue { i32, ptr } %i.eg, 0      ; 2 uses
  %i.ei = extractvalue { i32, ptr } %i.eg, 1      ; 2 uses
  call void (i32, ptr, ptr, ...) @ZL_E_appendToMessage(i32 %i.eh, ptr %i.ei, ptr noundef nonnull @.str.12) #12
  %i.ej = ptrtoint ptr %i.ei to i64
  br label %ZS_largeHuffmanUncompressed.exit133

bb.aa:                                            ; preds = %bb.y
  %i.ek = getelementptr inbounds nuw i8, ptr %.val.i126, i64 1
  store ptr %i.ek, ptr %i.t, align 8, !tbaa !30
  store i8 1, ptr %.val.i126, align 1, !tbaa !28
  %.val.i.i128 = load ptr, ptr %i.t, align 8, !tbaa !30 ; 3 uses
  %i.el = icmp ugt i64 %2, 127
  br i1 %i.el, label %.lr.ph.i.i.i, label %ZL_WC_pushVarint.exit.i

.lr.ph.i.i.i:                                     ; preds = %bb.aa, %.lr.ph.i.i.i
  %.010.i.i.i = phi ptr [ %i.eo, %.lr.ph.i.i.i ], [ %.val.i.i128, %bb.aa ] ; 3 uses
  %.089.i.i.i = phi i64 [ %i.ep, %.lr.ph.i.i.i ], [ %2, %bb.aa ] ; 3 uses
  %i.em = trunc i64 %.089.i.i.i to i8
  %i.en = or i8 %i.em, -128
  %i.eo = getelementptr inbounds nuw i8, ptr %.010.i.i.i, i64 1 ; 2 uses
  store i8 %i.en, ptr %.010.i.i.i, align 1, !tbaa !28
  %i.ep = lshr i64 %.089.i.i.i, 7                 ; 2 uses
  %i.eq = icmp ugt i64 %.089.i.i.i, 16383
  br i1 %i.eq, label %.lr.ph.i.i.i, label %ZL_WC_pushVarint.exit.thread.i, !llvm.loop !71

ZL_WC_pushVarint.exit.thread.i:                   ; preds = %.lr.ph.i.i.i
  %i.er = trunc nuw nsw i64 %i.ep to i8
  %i.es = getelementptr inbounds nuw i8, ptr %.010.i.i.i, i64 2
  store i8 %i.er, ptr %i.eo, align 1, !tbaa !28
  %i.et = ptrtoint ptr %i.es to i64
  %i.eu = ptrtoint ptr %.val.i.i128 to i64
  %i.ev = sub i64 %i.et, %i.eu
  br label %.lr.ph.preheader.i

ZL_WC_pushVarint.exit.i:                          ; preds = %bb.aa
  %i.ew = trunc nuw nsw i64 %2 to i8
  store i8 %i.ew, ptr %.val.i.i128, align 1, !tbaa !28
  br label %.lr.ph.preheader.i

.lr.ph.preheader.i:                               ; preds = %ZL_WC_pushVarint.exit.i, %ZL_WC_pushVarint.exit.thread.i
  %.sink165 = phi i64 [ 1, %ZL_WC_pushVarint.exit.i ], [ %i.ev, %ZL_WC_pushVarint.exit.thread.i ]
  %i.ex = load ptr, ptr %i.t, align 8, !tbaa !30
  %i.ey = getelementptr inbounds nuw i8, ptr %i.ex, i64 %.sink165 ; 3 uses
  store ptr %i.ey, ptr %i.t, align 8, !tbaa !30
  %xtraiter180 = and i64 %2, 3                    ; 3 uses
  %i.ez = icmp ult i64 %i.ag, 3
  br i1 %i.ez, label %.lr.ph.i.epil.preheader, label %.lr.ph.preheader.i.new

.lr.ph.preheader.i.new:                           ; preds = %.lr.ph.preheader.i
  %unroll_iter183 = and i64 %2, -4
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i, %.lr.ph.preheader.i.new
  %.val.i14.i = phi ptr [ %i.ey, %.lr.ph.preheader.i.new ], [ %i.fs, %.lr.ph.i ]
  %.016.i = phi i64 [ 0, %.lr.ph.preheader.i.new ], [ %i.ft, %.lr.ph.i ] ; 5 uses
  %niter184 = phi i64 [ 0, %.lr.ph.preheader.i.new ], [ %niter184.next.3, %.lr.ph.i ]
  %i.fa = getelementptr inbounds nuw [2 x i8], ptr %1, i64 %.016.i
  %i.fb = load i16, ptr %i.fa, align 2, !tbaa !25
  store i16 %i.fb, ptr %.val.i14.i, align 1
  %i.fc = load ptr, ptr %i.t, align 8, !tbaa !30
  %i.fd = getelementptr inbounds nuw i8, ptr %i.fc, i64 2 ; 2 uses
  store ptr %i.fd, ptr %i.t, align 8, !tbaa !30
  %i.fe = getelementptr inbounds nuw [2 x i8], ptr %1, i64 %.016.i
  %i.ff = getelementptr inbounds nuw i8, ptr %i.fe, i64 2
  %i.fg = load i16, ptr %i.ff, align 2, !tbaa !25
  store i16 %i.fg, ptr %i.fd, align 1
  %i.fh = load ptr, ptr %i.t, align 8, !tbaa !30
  %i.fi = getelementptr inbounds nuw i8, ptr %i.fh, i64 2 ; 2 uses
  store ptr %i.fi, ptr %i.t, align 8, !tbaa !30
  %i.fj = getelementptr inbounds nuw [2 x i8], ptr %1, i64 %.016.i
  %i.fk = getelementptr inbounds nuw i8, ptr %i.fj, i64 4
  %i.fl = load i16, ptr %i.fk, align 2, !tbaa !25
  store i16 %i.fl, ptr %i.fi, align 1
  %i.fm = load ptr, ptr %i.t, align 8, !tbaa !30
  %i.fn = getelementptr inbounds nuw i8, ptr %i.fm, i64 2 ; 2 uses
  store ptr %i.fn, ptr %i.t, align 8, !tbaa !30
  %i.fo = getelementptr inbounds nuw [2 x i8], ptr %1, i64 %.016.i
  %i.fp = getelementptr inbounds nuw i8, ptr %i.fo, i64 6
  %i.fq = load i16, ptr %i.fp, align 2, !tbaa !25
  store i16 %i.fq, ptr %i.fn, align 1
  %i.fr = load ptr, ptr %i.t, align 8, !tbaa !30
  %i.fs = getelementptr inbounds nuw i8, ptr %i.fr, i64 2 ; 3 uses
  store ptr %i.fs, ptr %i.t, align 8, !tbaa !30
  %i.ft = add nuw i64 %.016.i, 4                  ; 2 uses
  %niter184.next.3 = add i64 %niter184, 4         ; 2 uses
  %niter184.ncmp.3 = icmp eq i64 %niter184.next.3, %unroll_iter183
  br i1 %niter184.ncmp.3, label %ZS_largeHuffmanUncompressed.exit133.loopexit.unr-lcssa, label %.lr.ph.i, !llvm.loop !72

ZS_largeHuffmanUncompressed.exit133.loopexit.unr-lcssa: ; preds = %.lr.ph.i
  %lcmp.mod181.not = icmp eq i64 %xtraiter180, 0
  br i1 %lcmp.mod181.not, label %ZS_largeHuffmanUncompressed.exit133, label %.lr.ph.i.epil.preheader

.lr.ph.i.epil.preheader:                          ; preds = %ZS_largeHuffmanUncompressed.exit133.loopexit.unr-lcssa, %.lr.ph.preheader.i
  %.val.i14.i.epil.init = phi ptr [ %i.ey, %.lr.ph.preheader.i ], [ %i.fs, %ZS_largeHuffmanUncompressed.exit133.loopexit.unr-lcssa ]
  %.016.i.epil.init = phi i64 [ 0, %.lr.ph.preheader.i ], [ %i.ft, %ZS_largeHuffmanUncompressed.exit133.loopexit.unr-lcssa ]
  %lcmp.mod182 = icmp ne i64 %xtraiter180, 0
  tail call void @llvm.assume(i1 %lcmp.mod182)
  br label %.lr.ph.i.epil

.lr.ph.i.epil:                                    ; preds = %.lr.ph.i.epil, %.lr.ph.i.epil.preheader
  %.val.i14.i.epil = phi ptr [ %i.fx, %.lr.ph.i.epil ], [ %.val.i14.i.epil.init, %.lr.ph.i.epil.preheader ]
  %.016.i.epil = phi i64 [ %i.fy, %.lr.ph.i.epil ], [ %.016.i.epil.init, %.lr.ph.i.epil.preheader ] ; 2 uses
  %epil.iter = phi i64 [ %epil.iter.next, %.lr.ph.i.epil ], [ 0, %.lr.ph.i.epil.preheader ]
  %i.fu = getelementptr inbounds nuw [2 x i8], ptr %1, i64 %.016.i.epil
  %i.fv = load i16, ptr %i.fu, align 2, !tbaa !25
  store i16 %i.fv, ptr %.val.i14.i.epil, align 1
  %i.fw = load ptr, ptr %i.t, align 8, !tbaa !30
  %i.fx = getelementptr inbounds nuw i8, ptr %i.fw, i64 2 ; 2 uses
  store ptr %i.fx, ptr %i.t, align 8, !tbaa !30
  %i.fy = add nuw i64 %.016.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter180
  br i1 %epil.iter.cmp.not, label %ZS_largeHuffmanUncompressed.exit133, label %.lr.ph.i.epil, !llvm.loop !73

ZS_largeHuffmanUncompressed.exit133:              ; preds = %ZS_largeHuffmanUncompressed.exit133.loopexit.unr-lcssa, %.lr.ph.i.epil, %bb.z
  %.sroa.012.0.i129 = phi i32 [ %i.eh, %bb.z ], [ 0, %.lr.ph.i.epil ], [ 0, %ZS_largeHuffmanUncompressed.exit133.loopexit.unr-lcssa ]
  %.sroa.4.0.i130 = phi i64 [ %i.ej, %bb.z ], [ 0, %.lr.ph.i.epil ], [ 0, %ZS_largeHuffmanUncompressed.exit133.loopexit.unr-lcssa ]
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #12
  br label %bb.ab

bb.ab:                                            ; preds = %bb.x, %ZS_largeHuffmanUncompressed.exit133
  %.sroa.0101.1 = phi i32 [ %.sroa.012.0.i129, %ZS_largeHuffmanUncompressed.exit133 ], [ 0, %bb.x ]
  %.pn = phi i64 [ %.sroa.4.0.i130, %ZS_largeHuffmanUncompressed.exit133 ], [ 0, %bb.x ]
  call void @free(ptr noundef nonnull %i.af) #12
  call void @free(ptr noundef nonnull %i.cu) #12
  br label %bb.ac

bb.ac:                                            ; preds = %bb.f, %bb.o, %bb.ab, %bb.q, %ZL_WC_pushVarint.exit, %bb.l, %.thread, %ZS_largeHuffmanUncompressed.exit
  %.sroa.012.0.i.pn = phi i32 [ %.sroa.012.0.i, %ZS_largeHuffmanUncompressed.exit ], [ %i.y, %bb.f ], [ %i.cc, %bb.l ], [ 0, %ZL_WC_pushVarint.exit ], [ %i.aj, %.thread ], [ %i.cx, %bb.o ], [ %i.db, %bb.q ], [ %.sroa.0101.1, %bb.ab ]
  %.sroa.4.0.i.pn = phi i64 [ %.sroa.4.0.i, %ZS_largeHuffmanUncompressed.exit ], [ %i.aa, %bb.f ], [ %i.ce, %bb.l ], [ 0, %ZL_WC_pushVarint.exit ], [ %i.al, %.thread ], [ %i.cz, %bb.o ], [ %i.dc, %bb.q ], [ %.pn, %bb.ab ]
  %.fca.0.insert.i.pn = insertvalue { i32, i64 } poison, i32 %.sroa.012.0.i.pn, 0
  %.fca.1.insert.merged = insertvalue { i32, i64 } %.fca.0.insert.i.pn, i64 %.sroa.4.0.i.pn, 1
...
define internal fastcc void @ZS_largeHuffmanSort_impl(ptr noalias nofree noundef captures(none) %0, i32 noundef range(i32 1, -2147483648) %1, i32 noundef range(i32 -2147483648, 32) %2, ptr noalias nofree noundef captures(none) %3, ptr nofree noundef nonnull captures(none) %4) unnamed_addr #9 {
bb.a:
  %notmask = shl nsw i32 -1, %2
  %i.a = xor i32 %notmask, -1                     ; 4 uses
  %i.b = add nsw i32 %2, 1                        ; 2 uses
  %i.c = sext i32 %i.b to i64
  %i.d = shl nsw i64 %i.c, 3
  tail call void @llvm.memset.p0.i64(ptr nonnull align 4 %4, i8 0, i64 %i.d, i1 false)
