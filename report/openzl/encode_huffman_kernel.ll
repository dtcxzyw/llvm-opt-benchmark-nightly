...
.preheader:                                       ; preds = %bb.f, %.preheader
  ...
  %.sroa.44.0.copyload.i63 = load i16, ptr %.sroa.44.0..sroa_idx.i62, align 2, !tbaa !25 ; 2 uses
  %i.ah = zext i16 %.sroa.44.0.copyload.i63 to i32
  %6 = zext i16 %.sroa.44.0.copyload.i63 to i64
  ...
  %.sroa.44.0.copyload.i63.1 = load i16, ptr %.sroa.44.0..sroa_idx.i62.1, align 2, !tbaa !25 ; 2 uses
  %i.au = zext i16 %.sroa.44.0.copyload.i63.1 to i32
  %9 = zext i16 %.sroa.44.0.copyload.i63.1 to i64
  %10 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %9
  %11 = load i32, ptr %10, align 4, !tbaa !19
  %i.av = zext i16 %.sroa.03.0.copyload.i61.1 to i32
  %i.aw = and i32 %11, %i.av
  ...
  %.sroa.44.0.copyload.i63.2 = load i16, ptr %.sroa.44.0..sroa_idx.i62.2, align 2, !tbaa !25 ; 2 uses
  %i.bh = zext i16 %.sroa.44.0.copyload.i63.2 to i32
  %12 = zext i16 %.sroa.44.0.copyload.i63.2 to i64
  %13 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %12
  %14 = load i32, ptr %13, align 4, !tbaa !19
  %i.bi = zext i16 %.sroa.03.0.copyload.i61.2 to i32
  %i.bj = and i32 %14, %i.bi
  ...
  %.sroa.44.0.copyload.i63.3 = load i16, ptr %.sroa.44.0..sroa_idx.i62.3, align 2, !tbaa !25 ; 2 uses
  %i.bu = zext i16 %.sroa.44.0.copyload.i63.3 to i32
  %15 = zext i16 %.sroa.44.0.copyload.i63.3 to i64
  %16 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %15
  %17 = load i32, ptr %16, align 4, !tbaa !19
  %i.bv = zext i16 %.sroa.03.0.copyload.i61.3 to i32
  %i.bw = and i32 %17, %i.bv
...
bb.g:                                             ; preds = %.loopexit, %bb.g
  ...
  %.sroa.4.0.copyload.i57 = load i16, ptr %.sroa.4.0..sroa_idx.i56, align 2, !tbaa !25 ; 2 uses
  %i.cq = zext i16 %.sroa.4.0.copyload.i57 to i32
  %18 = zext i16 %.sroa.4.0.copyload.i57 to i64
  %19 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %18
  %20 = load i32, ptr %19, align 4, !tbaa !19
  %i.cr = zext i16 %.sroa.0.0.copyload.i55 to i32
  %i.cs = and i32 %20, %i.cr
...
.preheader117:                                    ; preds = %bb.i, %.preheader117
  ...
  %.sroa.44.0.copyload.i50 = load i16, ptr %.sroa.44.0..sroa_idx.i49, align 2, !tbaa !25 ; 2 uses
  %i.dn = zext i16 %.sroa.44.0.copyload.i50 to i32
  %21 = zext i16 %.sroa.44.0.copyload.i50 to i64
  %22 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %21
  %23 = load i32, ptr %22, align 4, !tbaa !19
  %i.do = zext i16 %.sroa.03.0.copyload.i48 to i32
  %i.dp = and i32 %23, %i.do
  ...
  %.sroa.44.0.copyload.i50.1 = load i16, ptr %.sroa.44.0..sroa_idx.i49.1, align 2, !tbaa !25 ; 2 uses
  %i.ea = zext i16 %.sroa.44.0.copyload.i50.1 to i32
  %24 = zext i16 %.sroa.44.0.copyload.i50.1 to i64
  %25 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %24
  %26 = load i32, ptr %25, align 4, !tbaa !19
  %i.eb = zext i16 %.sroa.03.0.copyload.i48.1 to i32
  %i.ec = and i32 %26, %i.eb
  ...
  %.sroa.44.0.copyload.i50.2 = load i16, ptr %.sroa.44.0..sroa_idx.i49.2, align 2, !tbaa !25 ; 2 uses
  %i.en = zext i16 %.sroa.44.0.copyload.i50.2 to i32
  %27 = zext i16 %.sroa.44.0.copyload.i50.2 to i64
  %28 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %27
  %29 = load i32, ptr %28, align 4, !tbaa !19
  %i.eo = zext i16 %.sroa.03.0.copyload.i48.2 to i32
  %i.ep = and i32 %29, %i.eo
...
bb.j:                                             ; preds = %.loopexit119, %bb.j
  ...
  %.sroa.4.0.copyload.i44 = load i16, ptr %.sroa.4.0..sroa_idx.i43, align 2, !tbaa !25 ; 2 uses
  %i.fj = zext i16 %.sroa.4.0.copyload.i44 to i32
  %30 = zext i16 %.sroa.4.0.copyload.i44 to i64
  %31 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %30
  %32 = load i32, ptr %31, align 4, !tbaa !19
  %i.fk = zext i16 %.sroa.0.0.copyload.i42 to i32
  %i.fl = and i32 %32, %i.fk
...
.preheader121:                                    ; preds = %bb.k, %.preheader121
  ...
  %.sroa.44.0.copyload.i = load i16, ptr %.sroa.44.0..sroa_idx.i, align 2, !tbaa !25 ; 2 uses
  %i.ge = zext i16 %.sroa.44.0.copyload.i to i32
  %33 = zext i16 %.sroa.44.0.copyload.i to i64
  %34 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %33
  %35 = load i32, ptr %34, align 4, !tbaa !19
  %i.gf = zext i16 %.sroa.03.0.copyload.i to i32
  %i.gg = and i32 %35, %i.gf
  ...
  %.sroa.44.0.copyload.i.1 = load i16, ptr %.sroa.44.0..sroa_idx.i.1, align 2, !tbaa !25 ; 2 uses
  %i.gr = zext i16 %.sroa.44.0.copyload.i.1 to i32
  %36 = zext i16 %.sroa.44.0.copyload.i.1 to i64
  %37 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %36
  %38 = load i32, ptr %37, align 4, !tbaa !19
  %i.gs = zext i16 %.sroa.03.0.copyload.i.1 to i32
  %i.gt = and i32 %38, %i.gs
...
bb.l:                                             ; preds = %.loopexit123, %bb.l
  ...
  %.sroa.4.0.copyload.i = load i16, ptr %.sroa.4.0..sroa_idx.i, align 2, !tbaa !25 ; 2 uses
  %i.hn = zext i16 %.sroa.4.0.copyload.i to i32
  %39 = zext i16 %.sroa.4.0.copyload.i to i64
  %40 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %39
  %41 = load i32, ptr %40, align 4, !tbaa !19
  %i.ho = zext i16 %.sroa.0.0.copyload.i to i32
  %i.hp = and i32 %41, %i.ho
