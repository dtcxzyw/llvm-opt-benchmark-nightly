Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/openzl/original/fse_decompress?download=true
...
bb.c:                                             ; preds = %bb.i, %.lr.ph.new
  ...
  %i.u = load i16, ptr %i.t, align 2, !tbaa !13   ; 3 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  store i8 %i.w, ptr %i.aa, align 2, !tbaa !41
  br label %bb.f
...
bb.f:                                             ; preds = %bb.d, %bb.e
  ...
  store i16 %.sink, ptr %i.ac, align 2, !tbaa !13
  %indvars.iv.next = or disjoint i64 %indvars.iv, 1 ; 3 uses
  %i.ad = getelementptr inbounds nuw [2 x i8], ptr %1, i64 %indvars.iv.next
  %i.ae = load i16, ptr %i.ad, align 2, !tbaa !13 ; 3 uses
...
bb.h:                                             ; preds = %bb.f
  ...
  store i8 %i.ah, ptr %i.al, align 2, !tbaa !41
  br label %bb.i
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  store i16 %.sink.1, ptr %i.am, align 2, !tbaa !13
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.unr-lcssa, label %bb.c, !llvm.loop !31
...
.epil.preheader:                                  ; preds = %._crit_edge.unr-lcssa, %.lr.ph
  ...
  %i.ao = load i16, ptr %i.an, align 2, !tbaa !13 ; 3 uses
...
bb.k:                                             ; preds = %.epil.preheader
  ...
  store i8 %i.ar, ptr %i.av, align 2, !tbaa !41
  br label %._crit_edge.epilog-lcssa
...
._crit_edge.epilog-lcssa:                         ; preds = %bb.k, %bb.j
  ...
  store i16 %.sink.epil, ptr %i.aw, align 2, !tbaa !13
  br label %._crit_edge
...
.lr.ph160:                                        ; preds = %.lr.ph160.preheader, %._crit_edge155
  ...
  %i.bg = load i16, ptr %i.bf, align 2, !tbaa !13 ; 3 uses
  %i.bh = getelementptr inbounds nuw i8, ptr %i.d, i64 %.0124156 ; 3 uses
  store i64 %.0123157, ptr %i.bh, align 1, !tbaa !16
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <2 x i64> %broadcast.splat, ptr %i.bs, align 1, !tbaa !16
  store <2 x i64> %broadcast.splat, ptr %i.bt, align 1, !tbaa !16
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.bu = icmp eq i64 %index.next, %n.vec
  br i1 %i.bu, label %middle.block, label %vector.body, !llvm.loop !32
...
._crit_edge155:                                   ; preds = %.lr.ph154, %middle.block, %.lr.ph160
  ...
  br i1 %exitcond179.not, label %.preheader136, label %.lr.ph160, !llvm.loop !34
...
.preheader:                                       ; preds = %.preheader136, %.preheader
  ...
  store i8 %i.cc, ptr %i.ce, align 2, !tbaa !41
  ...
  store i8 %i.ci, ptr %i.ck, align 2, !tbaa !41
  ...
  br i1 %i.co, label %.preheader, label %.loopexit137, !llvm.loop !35
...
.preheader138:                                    ; preds = %.preheader138.lr.ph, %._crit_edge146
  ...
  %i.ct = load i16, ptr %i.cs, align 2, !tbaa !13 ; 5 uses
...
bb.l:                                             ; preds = %bb.p, %.lr.ph145.new
  ...
  store i8 %i.cv, ptr %i.da, align 2, !tbaa !41
  br label %bb.m
...
bb.m:                                             ; preds = %bb.m, %bb.l
  ...
  br i1 %i.db, label %bb.m, label %bb.n, !llvm.loop !36
...
bb.n:                                             ; preds = %bb.m
  ...
  store i8 %i.cv, ptr %i.de, align 2, !tbaa !41
  br label %bb.o
...
bb.o:                                             ; preds = %bb.o, %bb.n
  ...
  br i1 %i.df, label %bb.o, label %bb.p, !llvm.loop !36

bb.p:                                             ; preds = %bb.o
  %niter200.next.1 = add i32 %niter200, 2         ; 2 uses
  %niter200.ncmp.1 = icmp eq i32 %niter200.next.1, %unroll_iter199
  br i1 %niter200.ncmp.1, label %._crit_edge146.loopexit.unr-lcssa, label %bb.l, !llvm.loop !37
...
.epil.preheader194:                               ; preds = %._crit_edge146.loopexit.unr-lcssa, %.lr.ph145
  ...
  store i8 %i.cv, ptr %i.dj, align 2, !tbaa !41
  br label %bb.q
...
bb.q:                                             ; preds = %bb.q, %.epil.preheader194
  ...
  br i1 %i.dk, label %bb.q, label %._crit_edge146, !llvm.loop !36
...
._crit_edge146:                                   ; preds = %._crit_edge146.loopexit.unr-lcssa, %bb.q, %.preheader138
  ...
  br i1 %exitcond170.not, label %._crit_edge150, label %.preheader138, !llvm.loop !38
...
bb.r:                                             ; preds = %.loopexit137, %bb.r
  ...
  %i.dn = load i8, ptr %i.dm, align 2, !tbaa !41
  %i.do = zext i8 %i.dn to i64
  %i.dp = getelementptr inbounds nuw [2 x i8], ptr %4, i64 %i.do ; 2 uses
  %i.dq = load i16, ptr %i.dp, align 2, !tbaa !13 ; 2 uses
  %i.dr = add i16 %i.dq, 1
  store i16 %i.dr, ptr %i.dp, align 2, !tbaa !13
  ...
  br i1 %exitcond184.not, label %.loopexit, label %bb.r, !llvm.loop !39
...
bb.c:                                             ; preds = %bb.a
  ...
  store i32 255, ptr %i.b, align 4, !tbaa !18
...
bb.e:                                             ; preds = %bb.d
  %i.h = load i32, ptr %i.a, align 4, !tbaa !18   ; 4 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.o = load i32, ptr %i.b, align 4, !tbaa !18   ; 2 uses
  %i.p = add i32 %i.o, 1
...
bb.k:                                             ; preds = %bb.j
  ...
  store i64 %.val.i.i, ptr %8, align 8, !tbaa !27
...
bb.l:                                             ; preds = %bb.j
  ...
  store ptr %i.j, ptr %i.av, align 8, !tbaa !26
  %i.aw = load i8, ptr %i.j, align 1, !tbaa !17
  %i.ax = zext i8 %i.aw to i64                    ; 7 uses
  store i64 %i.ax, ptr %8, align 8, !tbaa !27
