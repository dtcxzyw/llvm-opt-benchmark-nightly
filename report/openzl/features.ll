...
bb.e:                                             ; preds = %.preheader.i
  ...
  %8 = fadd double %i.v, -1.000000e+00
  %9 = fmul double %i.ay, %i.bd                   ; 2 uses
  %i.be = insertelement <2 x double> poison, double %8, i64 0
  %i.bf = insertelement <2 x double> %i.be, double %9, i64 1
  %i.bg = fdiv <2 x double> %i.ci, %i.bf          ; 2 uses
  %i.bh = fmul double %i.ay, %9
