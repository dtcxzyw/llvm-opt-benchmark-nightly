...
begin_hunk_0_@ZSTD_RowFindBestMatch_noDict_4_4:bb.a
  %i.cx = getelementptr inbounds nuw [4 x i8], ptr %i.by, i64 %i.cw
  tail call void @llvm.prefetch.p0(ptr %i.cx, i32 0, i32 3, i32 1)
  %i.cy = getelementptr inbounds nuw i8, ptr %i.bx, i64 %i.cw
  tail call void @llvm.prefetch.p0(ptr %i.cy, i32 0, i32 3, i32 1)
  %i.cz = and i64 %i.cb, 7
  %i.da = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.cz
  store i32 %i.ct, ptr %i.da, align 4, !tbaa !45
  %indvars.iv.next49.prol = add nuw nsw i64 %i.cb, 1
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.unr-lcssa, %.lr.ph27
  ...
  br i1 %i.db, label %ZSTD_row_update_internal.exit.i, label %.lr.ph27.new
...
.lr.ph27.new:                                     ; preds = %.prol.loopexit, %.lr.ph27.new
  ...
  %.val6 = load i32, ptr %i.dc, align 1, !tbaa !45
  ...
  store i32 %i.dq, ptr %i.dx, align 4, !tbaa !45
  ...
  br i1 %exitcond51.not.1, label %ZSTD_row_update_internal.exit.i, label %.lr.ph27.new, !llvm.loop !5

ZSTD_row_update_internal.exit.i:                  ; preds = %.prol.loopexit, %.lr.ph27.new, %bb.f, %bb.b
  ...
  %i.eb = load ptr, ptr %i.j, align 8, !tbaa !37
  %i.ec = icmp ult i32 %.0.i284.i, %i.o
  br i1 %i.ec, label %.lr.ph29, label %ZSTD_row_update_internalImpl.exit287.i

.lr.ph29:                                         ; preds = %ZSTD_row_update_internal.exit.i
...
bb.g:                                             ; preds = %.lr.ph29, %bb.g
  ...
  %i.ev = load i32, ptr %i.eu, align 4, !tbaa !45 ; 2 uses
  store i32 %i.em, ptr %i.eu, align 4, !tbaa !45
  ...
  store i8 %i.fi, ptr %i.fa, align 1, !tbaa !53
  %i.fj = trunc i32 %i.ev to i8
  %i.fk = zext nneg i32 %i.fh to i64              ; 2 uses
  %i.fl = getelementptr inbounds nuw i8, ptr %i.fa, i64 %i.fk
  store i8 %i.fj, ptr %i.fl, align 1, !tbaa !53
  %i.fm = getelementptr inbounds nuw [4 x i8], ptr %i.ez, i64 %i.fk
  store i32 %i.es, ptr %i.fm, align 4, !tbaa !45
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1 ; 2 uses
  %i.fn = icmp samesign ult i64 %indvars.iv.next53, %i.ef
  br i1 %i.fn, label %bb.g, label %ZSTD_row_update_internalImpl.exit287.i, !llvm.loop !0

ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.g, %ZSTD_row_update_internal.exit.i
  store i32 %i.o, ptr %i.ah, align 4, !tbaa !41
  ...
  %.val8 = load i32, ptr %i.fq, align 1, !tbaa !45
  ...
  %i.gd = load i32, ptr %i.gc, align 4, !tbaa !45
  store i32 %i.fv, ptr %i.gc, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit
...
bb.h:                                             ; preds = %bb.a
  ...
  store i32 %i.o, ptr %i.gj, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.h, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.gi, %bb.h ], [ %i.gd, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.gk = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.gl = load i32, ptr %i.gk, align 8, !tbaa !86
  %i.gm = add i32 %i.gl, %.0257.i
  store i32 %i.gm, ptr %i.gk, align 8, !tbaa !86
  ...
  %i.gs = load i8, ptr %i.gr, align 1, !tbaa !53  ; 2 uses
  ...
  %i.gx = load <16 x i8>, ptr %i.gr, align 1, !tbaa !53
...
.lr.ph34.preheader:                               ; preds = %ZSTD_row_getSSEMask.exit
  %i.ha = zext i8 %i.gs to i16
  %i.hb = tail call i16 @llvm.fshr.i16(i16 %i.gz, i16 %i.gz, i16 %i.ha)
...
.lr.ph34:                                         ; preds = %.lr.ph34.preheader, %bb.k
  ...
  %i.hj = load i32, ptr %i.hi, align 4, !tbaa !45 ; 3 uses
...
._crit_edge:                                      ; preds = %bb.k, %bb.i, %ZSTD_row_getSSEMask.exit
  %.0249.i.lcssa = phi i64 [ 0, %ZSTD_row_getSSEMask.exit ], [ %.0249.i32, %bb.i ], [ %.1250.i.ph, %bb.k ] ; 2 uses
  ...
  store i8 %i.ib, ptr %i.gr, align 1, !tbaa !53
  %i.ic = zext nneg i32 %i.ia to i64              ; 2 uses
  %i.id = getelementptr inbounds nuw i8, ptr %i.gr, i64 %i.ic
  store i8 %i.gu, ptr %i.id, align 1, !tbaa !53
  %i.ie = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 2 uses
  %i.if = load i32, ptr %i.ie, align 4, !tbaa !41 ; 2 uses
  %i.ig = add i32 %i.if, 1
  store i32 %i.ig, ptr %i.ie, align 4, !tbaa !41
  %i.ih = getelementptr inbounds nuw [4 x i8], ptr %i.gq, i64 %i.ic
  store i32 %i.if, ptr %i.ih, align 4, !tbaa !45
  %.not44 = icmp eq i64 %.0249.i.lcssa, 0
  br i1 %.not44, label %ZSTD_RowFindBestMatch.exit, label %.lr.ph40
...
bb.l:                                             ; preds = %.lr.ph40, %ZSTD_count.exit.thread
  %.0248.i38 = phi i64 [ 0, %.lr.ph40 ], [ %i.jz, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i37 = phi i64 [ 3, %.lr.ph40 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 5 uses
  %i.in = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i38
  %i.io = load i32, ptr %i.in, align 4, !tbaa !45 ; 2 uses
  ...
  %.val4 = load i32, ptr %i.is, align 1, !tbaa !45
  %i.it = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i37
  %i.iu = getelementptr inbounds i8, ptr %i.it, i64 -3
  %.val = load i32, ptr %i.iu, align 1, !tbaa !45
  %i.iv = icmp eq i32 %.val4, %.val
  br i1 %i.iv, label %bb.m, label %ZSTD_count.exit.thread

bb.m:                                             ; preds = %bb.l
  br i1 %i.ij, label %bb.n, label %.loopexit.i

bb.n:                                             ; preds = %bb.m
  %.val60.i = load i64, ptr %i.iq, align 1, !tbaa !46 ; 2 uses
...
bb.w:                                             ; preds = %bb.v
  %i.jp = load i8, ptr %.4.i, align 1, !tbaa !53
  %i.jq = load i8, ptr %.453.i, align 1, !tbaa !53
...
ZSTD_count.exit:                                  ; preds = %bb.x, %.thread63.i, %bb.o
  ...
  br i1 %i.ju, label %bb.y, label %ZSTD_count.exit.thread

bb.y:                                             ; preds = %ZSTD_count.exit
  %i.jv = sub i32 %i.im, %i.io
  %i.jw = zext i32 %i.jv to i64
  store i64 %i.jw, ptr %3, align 8, !tbaa !46
  %i.jx = getelementptr inbounds nuw i8, ptr %1, i64 %.2243.i
  %i.jy = icmp eq ptr %i.jx, %2
  br i1 %i.jy, label %ZSTD_RowFindBestMatch.exit, label %ZSTD_count.exit.thread

ZSTD_count.exit.thread:                           ; preds = %bb.l, %bb.y, %ZSTD_count.exit
  %.2260.i.ph = phi i64 [ %.2243.i, %bb.y ], [ %.0258.i37, %ZSTD_count.exit ], [ %.0258.i37, %bb.l ] ; 2 uses
  %i.jz = add nuw i64 %.0248.i38, 1               ; 2 uses
  %exitcond55.not = icmp eq i64 %i.jz, %.0249.i.lcssa
  br i1 %exitcond55.not, label %ZSTD_RowFindBestMatch.exit, label %bb.l, !llvm.loop !10

ZSTD_RowFindBestMatch.exit:                       ; preds = %ZSTD_count.exit.thread, %bb.y, %._crit_edge
  %.3261.i = phi i64 [ 3, %._crit_edge ], [ %.2243.i, %bb.y ], [ %.2260.i.ph, %ZSTD_count.exit.thread ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #12
  ret i64 %.3261.i
}

; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_noDict_4_5(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  ...
  %i.k = load ptr, ptr %i.j, align 8, !tbaa !37   ; 9 uses
...
.lr.ph27.new:                                     ; preds = %.prol.loopexit, %.lr.ph27.new
  ...
  store i32 %i.dh, ptr %i.dp, align 4, !tbaa !45
  %indvars.iv.next49 = add nuw nsw i64 %indvars.iv48, 1 ; 2 uses
  %i.dq = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv.next49
  %.val6.1 = load i32, ptr %i.dq, align 1, !tbaa !45
  ...
  store i32 %i.dt, ptr %i.eb, align 4, !tbaa !45
  %indvars.iv.next49.1 = add nuw nsw i64 %indvars.iv48, 2 ; 2 uses
  %lftr.wideiv.1 = trunc i64 %indvars.iv.next49.1 to i32
...
ZSTD_row_update_internal.exit.i:                  ; preds = %.prol.loopexit, %.lr.ph27.new, %bb.f, %bb.b
  ...
  %i.ef = load ptr, ptr %i.j, align 8, !tbaa !37
  %i.eg = icmp ult i32 %.0.i284.i, %i.o
  br i1 %i.eg, label %.lr.ph29, label %ZSTD_row_update_internalImpl.exit287.i
...
bb.g:                                             ; preds = %.lr.ph29, %bb.g
  ...
  %i.fa = load i32, ptr %i.ez, align 4, !tbaa !45 ; 2 uses
  store i32 %i.eq, ptr %i.ez, align 4, !tbaa !45
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.g, %ZSTD_row_update_internal.exit.i
  ...
  %.val8 = load i32, ptr %i.fv, align 1, !tbaa !45
  ...
  store i32 %i.ga, ptr %i.gi, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit
...
bb.h:                                             ; preds = %bb.a
  ...
  store i32 %i.o, ptr %i.gp, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.h, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.go, %bb.h ], [ %i.gj, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.gq = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.gr = load i32, ptr %i.gq, align 8, !tbaa !86
  %i.gs = add i32 %i.gr, %.0257.i
  store i32 %i.gs, ptr %i.gq, align 8, !tbaa !86
...
.lr.ph34:                                         ; preds = %.lr.ph34.preheader, %bb.k
  ...
  %i.hr = load i32, ptr %i.hq, align 4, !tbaa !45 ; 3 uses
...
bb.l:                                             ; preds = %.lr.ph40, %ZSTD_count.exit.thread
  %.0248.i38 = phi i64 [ 0, %.lr.ph40 ], [ %i.kh, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i37 = phi i64 [ 3, %.lr.ph40 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 5 uses
  %i.iv = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i38
  %i.iw = load i32, ptr %i.iv, align 4, !tbaa !45 ; 2 uses
  ...
  %.val4 = load i32, ptr %i.ja, align 1, !tbaa !45
  %i.jb = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i37
  %i.jc = getelementptr inbounds i8, ptr %i.jb, i64 -3
  %.val = load i32, ptr %i.jc, align 1, !tbaa !45
  %i.jd = icmp eq i32 %.val4, %.val
  br i1 %i.jd, label %bb.m, label %ZSTD_count.exit.thread

bb.m:                                             ; preds = %bb.l
  br i1 %i.ir, label %bb.n, label %.loopexit.i

bb.n:                                             ; preds = %bb.m
  %.val60.i = load i64, ptr %i.iy, align 1, !tbaa !46 ; 2 uses
  %.val.i = load i64, ptr %1, align 1, !tbaa !46  ; 2 uses
  %.not.i11 = icmp eq i64 %.val60.i, %.val.i
  br i1 %.not.i11, label %.preheader.i, label %bb.o
...
bb.w:                                             ; preds = %bb.v
  %i.jx = load i8, ptr %.4.i, align 1, !tbaa !53
  %i.jy = load i8, ptr %.453.i, align 1, !tbaa !53
...
ZSTD_count.exit:                                  ; preds = %bb.x, %.thread63.i, %bb.o
  ...
  br i1 %i.kc, label %bb.y, label %ZSTD_count.exit.thread

bb.y:                                             ; preds = %ZSTD_count.exit
  %i.kd = sub i32 %i.iu, %i.iw
  %i.ke = zext i32 %i.kd to i64
  store i64 %i.ke, ptr %3, align 8, !tbaa !46
  %i.kf = getelementptr inbounds nuw i8, ptr %1, i64 %.2243.i
  %i.kg = icmp eq ptr %i.kf, %2
  br i1 %i.kg, label %ZSTD_RowFindBestMatch.exit, label %ZSTD_count.exit.thread

ZSTD_count.exit.thread:                           ; preds = %bb.l, %bb.y, %ZSTD_count.exit
  %.2260.i.ph = phi i64 [ %.2243.i, %bb.y ], [ %.0258.i37, %ZSTD_count.exit ], [ %.0258.i37, %bb.l ] ; 2 uses
  %i.kh = add nuw i64 %.0248.i38, 1               ; 2 uses
  %exitcond58.not = icmp eq i64 %i.kh, %.0249.i.lcssa
  br i1 %exitcond58.not, label %ZSTD_RowFindBestMatch.exit, label %bb.l, !llvm.loop !10
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_noDict_4_6(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !38   ; 6 uses
  ...
  %i.t = sub i32 %i.o, %i.s
end_hunk_1
begin_hunk_2_@ZSTD_RowFindBestMatch_noDict_4_6:bb.a
  %i.cr = sub i32 24, %i.by
  br label %bb.g

bb.g:                                             ; preds = %.lr.ph27, %bb.g
  %indvars.iv48 = phi i64 [ %i.cd, %.lr.ph27 ], [ %indvars.iv.next49, %bb.g ] ; 3 uses
  %i.cs = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv48
  %.val6 = load i32, ptr %i.cs, align 1, !tbaa !45
  %i.ct = mul i32 %.val6, -1640531535
  %i.cu = xor i32 %i.ct, %i.cq
  %i.cv = lshr i32 %i.cu, %i.cr                   ; 2 uses
  %i.cw = lshr i32 %i.cv, 2
  %i.cx = and i32 %i.cw, 1073741760
  %i.cy = zext nneg i32 %i.cx to i64              ; 2 uses
  %i.cz = getelementptr inbounds nuw [4 x i8], ptr %i.ca, i64 %i.cy ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.cz, i32 0, i32 3, i32 1)
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.da, i32 0, i32 3, i32 1)
  %i.db = getelementptr inbounds nuw i8, ptr %i.bz, i64 %i.cy ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.db, i32 0, i32 3, i32 1)
  %i.dc = getelementptr inbounds nuw i8, ptr %i.db, i64 32
  tail call void @llvm.prefetch.p0(ptr nonnull %i.dc, i32 0, i32 3, i32 1)
  %i.dd = and i64 %indvars.iv48, 7
  %i.de = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.dd
  store i32 %i.cv, ptr %i.de, align 4, !tbaa !45
  %indvars.iv.next49 = add nuw nsw i64 %indvars.iv48, 1 ; 2 uses
  %lftr.wideiv = trunc i64 %indvars.iv.next49 to i32
  %exitcond51.not = icmp eq i32 %i.cn, %lftr.wideiv
  br i1 %exitcond51.not, label %ZSTD_row_update_internal.exit.i, label %bb.g, !llvm.loop !5

ZSTD_row_update_internal.exit.i:                  ; preds = %bb.g, %bb.f, %bb.b
  %i.df = phi i32 [ %i.h, %bb.b ], [ %i.by, %bb.f ], [ %i.by, %bb.g ]
  %i.dg = phi ptr [ %i.e, %bb.b ], [ %i.bz, %bb.f ], [ %i.bz, %bb.g ] ; 2 uses
  %i.dh = phi ptr [ %i.c, %bb.b ], [ %i.ca, %bb.f ], [ %i.ca, %bb.g ] ; 2 uses
  %.0.i284.i = phi i32 [ %i.ai, %bb.b ], [ %i.cb, %bb.f ], [ %i.cb, %bb.g ] ; 2 uses
  %i.di = load ptr, ptr %i.j, align 8, !tbaa !37
  %i.dj = icmp ult i32 %.0.i284.i, %i.o
  br i1 %i.dj, label %.lr.ph29, label %ZSTD_row_update_internalImpl.exit287.i

.lr.ph29:                                         ; preds = %ZSTD_row_update_internal.exit.i
  %i.dk = sub i32 24, %i.df
  %i.dl = zext i32 %.0.i284.i to i64
  %i.dm = and i64 %i.n, 4294967295
  br label %bb.h

bb.h:                                             ; preds = %.lr.ph29, %bb.h
  %indvars.iv52 = phi i64 [ %i.dl, %.lr.ph29 ], [ %indvars.iv.next53, %bb.h ] ; 4 uses
  %i.dn = load i64, ptr %i.ac, align 8, !tbaa !52
  %i.do = getelementptr inbounds nuw i8, ptr %i.di, i64 %indvars.iv52
  %i.dp = getelementptr inbounds nuw i8, ptr %i.do, i64 8
  %i.dq = trunc i64 %i.dn to i32
  %.val7 = load i32, ptr %i.dp, align 1, !tbaa !45
  %i.dr = mul i32 %.val7, -1640531535
  %i.ds = xor i32 %i.dr, %i.dq
  %i.dt = lshr i32 %i.ds, %i.dk                   ; 2 uses
  %i.du = lshr i32 %i.dt, 2
  %i.dv = and i32 %i.du, 1073741760
  %i.dw = zext nneg i32 %i.dv to i64              ; 2 uses
  %i.dx = getelementptr inbounds nuw [4 x i8], ptr %i.dh, i64 %i.dw ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.dx, i32 0, i32 3, i32 1)
  %i.dy = getelementptr inbounds nuw i8, ptr %i.dx, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.dy, i32 0, i32 3, i32 1)
  %i.dz = getelementptr inbounds nuw i8, ptr %i.dg, i64 %i.dw ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.dz, i32 0, i32 3, i32 1)
  %i.ea = getelementptr inbounds nuw i8, ptr %i.dz, i64 32
  tail call void @llvm.prefetch.p0(ptr nonnull %i.ea, i32 0, i32 3, i32 1)
  %i.eb = trunc nuw i64 %indvars.iv52 to i32
  %i.ec = and i64 %indvars.iv52, 7
  %i.ed = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.ec ; 2 uses
  %i.ee = load i32, ptr %i.ed, align 4, !tbaa !45 ; 2 uses
  store i32 %i.dt, ptr %i.ed, align 4, !tbaa !45
  %i.ef = lshr i32 %i.ee, 2
  %i.eg = and i32 %i.ef, 1073741760
  %i.eh = zext nneg i32 %i.eg to i64              ; 2 uses
  %i.ei = getelementptr inbounds nuw [4 x i8], ptr %i.dh, i64 %i.eh
  %i.ej = getelementptr inbounds nuw i8, ptr %i.dg, i64 %i.eh ; 3 uses
  %i.ek = load i8, ptr %i.ej, align 1, !tbaa !53
  %i.el = add i8 %i.ek, 63
  %i.em = and i8 %i.el, 63                        ; 2 uses
  %i.en = zext nneg i8 %i.em to i32
  %i.eo = icmp eq i8 %i.em, 0
  %i.ep = select i1 %i.eo, i32 63, i32 0
  %i.eq = add nuw nsw i32 %i.ep, %i.en            ; 2 uses
  %i.er = trunc nuw nsw i32 %i.eq to i8
  store i8 %i.er, ptr %i.ej, align 1, !tbaa !53
  %i.es = trunc i32 %i.ee to i8
  %i.et = zext nneg i32 %i.eq to i64              ; 2 uses
  %i.eu = getelementptr inbounds nuw i8, ptr %i.ej, i64 %i.et
  store i8 %i.es, ptr %i.eu, align 1, !tbaa !53
  %i.ev = getelementptr inbounds nuw [4 x i8], ptr %i.ei, i64 %i.et
  store i32 %i.eb, ptr %i.ev, align 4, !tbaa !45
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1 ; 2 uses
  %i.ew = icmp samesign ult i64 %indvars.iv.next53, %i.dm
  br i1 %i.ew, label %bb.h, label %ZSTD_row_update_internalImpl.exit287.i, !llvm.loop !0

ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.h, %ZSTD_row_update_internal.exit.i
  store i32 %i.o, ptr %i.ah, align 4, !tbaa !41
  %i.ex = and i64 %i.n, 4294967295
  %i.ey = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.ex
  %i.ez = getelementptr inbounds nuw i8, ptr %i.ey, i64 8
  %i.fa = trunc i64 %i.ad to i32
  %.val8 = load i32, ptr %i.ez, align 1, !tbaa !45
  %i.fb = mul i32 %.val8, -1640531535
  %i.fc = xor i32 %i.fb, %i.fa
  %i.fd = sub i32 24, %i.h
  %i.fe = lshr i32 %i.fc, %i.fd                   ; 2 uses
  %i.ff = lshr i32 %i.fe, 2
  %i.fg = and i32 %i.ff, 1073741760
  %i.fh = zext nneg i32 %i.fg to i64              ; 2 uses
  %i.fi = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.fh ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.fi, i32 0, i32 3, i32 1)
  %i.fj = getelementptr inbounds nuw i8, ptr %i.fi, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.fj, i32 0, i32 3, i32 1)
  %i.fk = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.fh ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.fk, i32 0, i32 3, i32 1)
  %i.fl = getelementptr inbounds nuw i8, ptr %i.fk, i64 32
  tail call void @llvm.prefetch.p0(ptr nonnull %i.fl, i32 0, i32 3, i32 1)
  %i.fm = and i64 %i.n, 7
  %i.fn = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.fm ; 2 uses
  %i.fo = load i32, ptr %i.fn, align 4, !tbaa !45
  store i32 %i.fe, ptr %i.fn, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit

bb.i:                                             ; preds = %bb.a
  %i.fp = trunc i64 %i.ad to i32
  %.val9 = load i32, ptr %1, align 1, !tbaa !45
  %i.fq = mul i32 %.val9, -1640531535
  %i.fr = xor i32 %i.fq, %i.fp
  %i.fs = sub i32 24, %i.h
  %i.ft = lshr i32 %i.fr, %i.fs
  %i.fu = getelementptr inbounds nuw i8, ptr %0, i64 44
  store i32 %i.o, ptr %i.fu, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.i, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.ft, %bb.i ], [ %i.fo, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.fv = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.fw = load i32, ptr %i.fv, align 8, !tbaa !86
  %i.fx = add i32 %i.fw, %.0257.i
  store i32 %i.fx, ptr %i.fv, align 8, !tbaa !86
  %i.fy = lshr i32 %.0257.i, 2
  %i.fz = and i32 %i.fy, 1073741760
  %i.ga = zext nneg i32 %i.fz to i64              ; 2 uses
  %i.gb = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.ga ; 7 uses
  %i.gc = load i8, ptr %i.gb, align 1, !tbaa !53  ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #12
  %i.gd = trunc i32 %.0257.i to i8                ; 2 uses
  %i.ge = insertelement <16 x i8> poison, i8 %i.gd, i64 0
  %i.gf = shufflevector <16 x i8> %i.ge, <16 x i8> poison, <16 x i32> zeroinitializer ; 4 uses
  %i.gg = load <16 x i8>, ptr %i.gb, align 1, !tbaa !53
  %i.gh = icmp eq <16 x i8> %i.gg, %i.gf
  %i.gi = bitcast <16 x i1> %i.gh to i16
  %i.gj = getelementptr inbounds nuw i8, ptr %i.gb, i64 16
  %i.gk = load <16 x i8>, ptr %i.gj, align 1, !tbaa !53
  %i.gl = icmp eq <16 x i8> %i.gk, %i.gf
  %i.gm = bitcast <16 x i1> %i.gl to i16
  %i.gn = getelementptr inbounds nuw i8, ptr %i.gb, i64 32
  %i.go = load <16 x i8>, ptr %i.gn, align 1, !tbaa !53
  %i.gp = icmp eq <16 x i8> %i.go, %i.gf
  %i.gq = bitcast <16 x i1> %i.gp to i16
  %i.gr = getelementptr inbounds nuw i8, ptr %i.gb, i64 48
  %i.gs = load <16 x i8>, ptr %i.gr, align 1, !tbaa !53
  %i.gt = icmp eq <16 x i8> %i.gs, %i.gf
  %i.gu = bitcast <16 x i1> %i.gt to i16
  %i.gv = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.ga ; 2 uses
  %i.gw = zext i8 %i.gc to i32                    ; 2 uses
  %i.gx = insertelement <4 x i16> poison, i16 %i.gi, i64 0
  %i.gy = insertelement <4 x i16> %i.gx, i16 %i.gm, i64 1
  %i.gz = insertelement <4 x i16> %i.gy, i16 %i.gq, i64 2
  %i.ha = insertelement <4 x i16> %i.gz, i16 %i.gu, i64 3
  %i.hb = bitcast <4 x i16> %i.ha to i64          ; 3 uses
  %.not = icmp eq i64 %i.hb, 0
  br i1 %.not, label %._crit_edge, label %.lr.ph34.preheader

.lr.ph34.preheader:                               ; preds = %ZSTD_row_getSSEMask.exit
  %i.hc = zext i8 %i.gc to i64
  %i.hd = tail call i64 @llvm.fshr.i64(i64 %i.hb, i64 %i.hb, i64 %i.hc)
  br label %.lr.ph34

.lr.ph34:                                         ; preds = %.lr.ph34.preheader, %bb.l
  %.0247.i33 = phi i64 [ %i.ht, %bb.l ], [ %i.hd, %.lr.ph34.preheader ] ; 3 uses
  %.0249.i32 = phi i64 [ %.1250.i.ph, %bb.l ], [ 0, %.lr.ph34.preheader ] ; 4 uses
  %.0262.i31 = phi i32 [ %.1263.i.ph, %bb.l ], [ %i.ae, %.lr.ph34.preheader ] ; 2 uses
  %i.he = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, 0) %.0247.i33, i1 true)
  %i.hf = trunc nuw nsw i64 %i.he to i32
  %i.hg = add nuw nsw i32 %i.hf, %i.gw
  %i.hh = and i32 %i.hg, 63                       ; 2 uses
  %i.hi = zext nneg i32 %i.hh to i64
  %i.hj = getelementptr inbounds nuw [4 x i8], ptr %i.gv, i64 %i.hi
  %i.hk = load i32, ptr %i.hj, align 4, !tbaa !45 ; 3 uses
  %i.hl = icmp eq i32 %i.hh, 0
  br i1 %i.hl, label %bb.l, label %bb.j

bb.j:                                             ; preds = %.lr.ph34
  %i.hm = icmp ult i32 %i.hk, %i.z
  br i1 %i.hm, label %._crit_edge, label %bb.k
...
bb.l:                                             ; preds = %bb.k, %.lr.ph34
  %.1263.i.ph = phi i32 [ %.0262.i31, %.lr.ph34 ], [ %i.hr, %bb.k ] ; 2 uses
  %.1250.i.ph = phi i64 [ %.0249.i32, %.lr.ph34 ], [ %i.hp, %bb.k ] ; 2 uses
  %i.hs = add i64 %.0247.i33, -1
...
._crit_edge:                                      ; preds = %bb.l, %bb.j, %ZSTD_row_getSSEMask.exit
  %.0249.i.lcssa = phi i64 [ 0, %ZSTD_row_getSSEMask.exit ], [ %.0249.i32, %bb.j ], [ %.1250.i.ph, %bb.l ] ; 2 uses
  %i.hx = add nuw nsw i32 %i.gw, 63
  %i.hy = and i32 %i.hx, 63                       ; 2 uses
  %i.hz = icmp eq i32 %i.hy, 0
  %i.ia = select i1 %i.hz, i32 63, i32 0
  %i.ib = add nuw nsw i32 %i.ia, %i.hy            ; 2 uses
  %i.ic = trunc nuw nsw i32 %i.ib to i8
  store i8 %i.ic, ptr %i.gb, align 1, !tbaa !53
  %i.id = zext nneg i32 %i.ib to i64              ; 2 uses
  %i.ie = getelementptr inbounds nuw i8, ptr %i.gb, i64 %i.id
  store i8 %i.gd, ptr %i.ie, align 1, !tbaa !53
  %i.if = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 2 uses
  %i.ig = load i32, ptr %i.if, align 4, !tbaa !41 ; 2 uses
  %i.ih = add i32 %i.ig, 1
  store i32 %i.ih, ptr %i.if, align 4, !tbaa !41
  %i.ii = getelementptr inbounds nuw [4 x i8], ptr %i.gv, i64 %i.id
  store i32 %i.ig, ptr %i.ii, align 4, !tbaa !45
  %.not44 = icmp eq i64 %.0249.i.lcssa, 0
  br i1 %.not44, label %ZSTD_RowFindBestMatch.exit, label %.lr.ph40
...
bb.m:                                             ; preds = %.lr.ph40, %ZSTD_count.exit.thread
  %.0248.i38 = phi i64 [ 0, %.lr.ph40 ], [ %i.ka, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i37 = phi i64 [ 3, %.lr.ph40 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 5 uses
  %i.io = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i38
  %i.ip = load i32, ptr %i.io, align 4, !tbaa !45 ; 2 uses
  ...
  %.val4 = load i32, ptr %i.it, align 1, !tbaa !45
  %i.iu = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i37
  %i.iv = getelementptr inbounds i8, ptr %i.iu, i64 -3
  %.val = load i32, ptr %i.iv, align 1, !tbaa !45
  %i.iw = icmp eq i32 %.val4, %.val
  br i1 %i.iw, label %bb.n, label %ZSTD_count.exit.thread

bb.n:                                             ; preds = %bb.m
  br i1 %i.ik, label %bb.o, label %.loopexit.i

bb.o:                                             ; preds = %bb.n
  %.val60.i = load i64, ptr %i.ir, align 1, !tbaa !46 ; 2 uses
  %.val.i = load i64, ptr %1, align 1, !tbaa !46  ; 2 uses
  %.not.i11 = icmp eq i64 %.val60.i, %.val.i
  br i1 %.not.i11, label %.preheader.i, label %bb.p
...
.preheader.i:                                     ; preds = %bb.o, %bb.q
  ...
  %.pn67.i = phi ptr [ %.045.i, %bb.q ], [ %i.ir, %bb.o ]
  %.045.i = getelementptr inbounds nuw i8, ptr %.pn67.i, i64 8 ; 3 uses
  %.049.i = getelementptr inbounds nuw i8, ptr %.pn.i, i64 8 ; 5 uses
  %i.ja = icmp ult ptr %.049.i, %i.ij
  br i1 %i.ja, label %bb.q, label %.loopexit.i
...
.loopexit.i:                                      ; preds = %.preheader.i, %bb.n
  ...
  %.247.i = phi ptr [ %i.ir, %bb.n ], [ %.045.i, %.preheader.i ] ; 4 uses
  %i.jh = icmp ult ptr %.251.i, %i.il
  br i1 %i.jh, label %bb.r, label %bb.t
...
bb.t:                                             ; preds = %bb.s, %bb.r, %.loopexit.i
  %.352.i = phi ptr [ %i.jj, %bb.s ], [ %.251.i, %bb.r ], [ %.251.i, %.loopexit.i ] ; 5 uses
  %.348.i = phi ptr [ %i.jk, %bb.s ], [ %.247.i, %bb.r ], [ %.247.i, %.loopexit.i ] ; 4 uses
  %i.jl = icmp ult ptr %.352.i, %i.im
  br i1 %i.jl, label %bb.u, label %bb.w

bb.u:                                             ; preds = %bb.t
  %.348.val.i = load i16, ptr %.348.i, align 1, !tbaa !60
  %.352.val.i = load i16, ptr %.352.i, align 1, !tbaa !60
  %i.jm = icmp eq i16 %.348.val.i, %.352.val.i
  br i1 %i.jm, label %bb.v, label %bb.w
...
bb.w:                                             ; preds = %bb.v, %bb.u, %bb.t
  %.453.i = phi ptr [ %i.jn, %bb.v ], [ %.352.i, %bb.u ], [ %.352.i, %bb.t ] ; 4 uses
  %.4.i = phi ptr [ %i.jo, %bb.v ], [ %.348.i, %bb.u ], [ %.348.i, %bb.t ]
  %i.jp = icmp ult ptr %.453.i, %2
  br i1 %i.jp, label %bb.x, label %bb.y

bb.x:                                             ; preds = %bb.w
  %i.jq = load i8, ptr %.4.i, align 1, !tbaa !53
  %i.jr = load i8, ptr %.453.i, align 1, !tbaa !53
...
bb.y:                                             ; preds = %bb.x, %bb.w
  %.5.i = phi ptr [ %.453.i, %bb.w ], [ %spec.select.i10, %bb.x ]
  %i.jt = ptrtoint ptr %.5.i to i64
  %i.ju = sub i64 %i.jt, %i.l
  br label %ZSTD_count.exit

ZSTD_count.exit:                                  ; preds = %bb.y, %.thread63.i, %bb.p
  %.2243.i = phi i64 [ %i.iz, %bb.p ], [ %i.jg, %.thread63.i ], [ %i.ju, %bb.y ] ; 4 uses
  %i.jv = icmp ugt i64 %.2243.i, %.0258.i37
  br i1 %i.jv, label %bb.z, label %ZSTD_count.exit.thread

bb.z:                                             ; preds = %ZSTD_count.exit
  %i.jw = sub i32 %i.in, %i.ip
  %i.jx = zext i32 %i.jw to i64
  store i64 %i.jx, ptr %3, align 8, !tbaa !46
  %i.jy = getelementptr inbounds nuw i8, ptr %1, i64 %.2243.i
  %i.jz = icmp eq ptr %i.jy, %2
  br i1 %i.jz, label %ZSTD_RowFindBestMatch.exit, label %ZSTD_count.exit.thread

ZSTD_count.exit.thread:                           ; preds = %bb.m, %bb.z, %ZSTD_count.exit
  %.2260.i.ph = phi i64 [ %.2243.i, %bb.z ], [ %.0258.i37, %ZSTD_count.exit ], [ %.0258.i37, %bb.m ] ; 2 uses
  %i.ka = add nuw i64 %.0248.i38, 1               ; 2 uses
  %exitcond59.not = icmp eq i64 %i.ka, %.0249.i.lcssa
  br i1 %exitcond59.not, label %ZSTD_RowFindBestMatch.exit, label %bb.m, !llvm.loop !10

ZSTD_RowFindBestMatch.exit:                       ; preds = %ZSTD_count.exit.thread, %bb.z, %._crit_edge
  %.3261.i = phi i64 [ 3, %._crit_edge ], [ %.2243.i, %bb.z ], [ %.2260.i.ph, %ZSTD_count.exit.thread ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #12
  ret i64 %.3261.i
}

; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_noDict_5_4(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !38   ; 6 uses
  ...
  %i.t = sub i32 %i.o, %i.s
end_hunk_2
begin_hunk_3_@ZSTD_RowFindBestMatch_noDict_5_4:bb.a
  tail call void @llvm.prefetch.p0(ptr %i.cx, i32 0, i32 3, i32 1)
  %i.cy = getelementptr inbounds nuw i8, ptr %i.bx, i64 %i.cw
  tail call void @llvm.prefetch.p0(ptr %i.cy, i32 0, i32 3, i32 1)
  %i.cz = and i64 %i.cb, 7
  %i.da = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.cz
  store i32 %i.cu, ptr %i.da, align 4, !tbaa !45
  %indvars.iv.next49.prol = add nuw nsw i64 %i.cb, 1
  br label %.prol.loopexit
...
.lr.ph27.new:                                     ; preds = %.prol.loopexit, %.lr.ph27.new
  %indvars.iv48 = phi i64 [ %indvars.iv.next49.1, %.lr.ph27.new ], [ %indvars.iv48.unr, %.prol.loopexit ] ; 4 uses
  %i.dc = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv48
  %.val6 = load i64, ptr %i.dc, align 1, !tbaa !46
  ...
  %i.dl = and i64 %indvars.iv48, 7
  %i.dm = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.dl
  store i32 %i.dg, ptr %i.dm, align 4, !tbaa !45
  %indvars.iv.next49 = add nuw nsw i64 %indvars.iv48, 1 ; 2 uses
  %i.dn = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv.next49
  %.val6.1 = load i64, ptr %i.dn, align 1, !tbaa !46
  ...
  %i.dw = and i64 %indvars.iv.next49, 7
  %i.dx = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.dw
  store i32 %i.dr, ptr %i.dx, align 4, !tbaa !45
  %indvars.iv.next49.1 = add nuw nsw i64 %indvars.iv48, 2 ; 2 uses
  %lftr.wideiv.1 = trunc i64 %indvars.iv.next49.1 to i32
  %exitcond51.not.1 = icmp eq i32 %i.cl, %lftr.wideiv.1
  br i1 %exitcond51.not.1, label %ZSTD_row_update_internal.exit.i, label %.lr.ph27.new, !llvm.loop !5
...
bb.g:                                             ; preds = %.lr.ph29, %bb.g
  ...
  %i.eh = load i64, ptr %i.ac, align 8, !tbaa !52
  %i.ei = getelementptr inbounds nuw i8, ptr %i.eb, i64 %indvars.iv52
  %i.ej = getelementptr inbounds nuw i8, ptr %i.ei, i64 8
  %.val7 = load i64, ptr %i.ej, align 1, !tbaa !46
  ...
  %i.eu = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.et ; 2 uses
  %i.ev = load i32, ptr %i.eu, align 4, !tbaa !45 ; 2 uses
  store i32 %i.en, ptr %i.eu, align 4, !tbaa !45
  %i.ew = lshr i32 %i.ev, 4
  %i.ex = and i32 %i.ew, 268435440
  %i.ey = zext nneg i32 %i.ex to i64              ; 2 uses
  %i.ez = getelementptr inbounds nuw [4 x i8], ptr %i.ea, i64 %i.ey
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.g, %ZSTD_row_update_internal.exit.i
  ...
  %i.fp = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.fo
  %i.fq = getelementptr inbounds nuw i8, ptr %i.fp, i64 8
  %.val8 = load i64, ptr %i.fq, align 1, !tbaa !46
  ...
  %i.gc = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.gb ; 2 uses
  %i.gd = load i32, ptr %i.gc, align 4, !tbaa !45
  store i32 %i.fw, ptr %i.gc, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit
...
bb.h:                                             ; preds = %bb.a
  ...
  store i32 %i.o, ptr %i.gk, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.h, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.gj, %bb.h ], [ %i.gd, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.gl = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.gm = load i32, ptr %i.gl, align 8, !tbaa !86
  %i.gn = add i32 %i.gm, %.0257.i
  store i32 %i.gn, ptr %i.gl, align 8, !tbaa !86
  ...
  %i.gt = load i8, ptr %i.gs, align 1, !tbaa !53  ; 2 uses
  ...
  %i.gy = load <16 x i8>, ptr %i.gs, align 1, !tbaa !53
...
.lr.ph34.preheader:                               ; preds = %ZSTD_row_getSSEMask.exit
  ...
  %i.hc = tail call i16 @llvm.fshr.i16(i16 %i.ha, i16 %i.ha, i16 %i.hb)
...
._crit_edge:                                      ; preds = %bb.k, %bb.i, %ZSTD_row_getSSEMask.exit
  ...
  %i.ib = add nuw nsw i32 %i.ia, %i.hy            ; 2 uses
  %i.ic = trunc nuw nsw i32 %i.ib to i8
  store i8 %i.ic, ptr %i.gs, align 1, !tbaa !53
  %i.id = zext nneg i32 %i.ib to i64              ; 2 uses
  %i.ie = getelementptr inbounds nuw i8, ptr %i.gs, i64 %i.id
  store i8 %i.gv, ptr %i.ie, align 1, !tbaa !53
  %i.if = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 2 uses
  %i.ig = load i32, ptr %i.if, align 4, !tbaa !41 ; 2 uses
  %i.ih = add i32 %i.ig, 1
  store i32 %i.ih, ptr %i.if, align 4, !tbaa !41
...
bb.l:                                             ; preds = %.lr.ph40, %ZSTD_count.exit.thread
  ...
  %.val = load i32, ptr %i.iv, align 1, !tbaa !45
  %i.iw = icmp eq i32 %.val4, %.val
  br i1 %i.iw, label %bb.m, label %ZSTD_count.exit.thread
...
ZSTD_count.exit:                                  ; preds = %bb.x, %.thread63.i, %bb.o
  ...
  %i.jv = icmp ugt i64 %.2243.i, %.0258.i37
  br i1 %i.jv, label %bb.y, label %ZSTD_count.exit.thread
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_noDict_5_5(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !38   ; 6 uses
  ...
  %i.t = sub i32 %i.o, %i.s
end_hunk_3
begin_hunk_4_@ZSTD_RowFindBestMatch_noDict_5_5:bb.a
  %indvars.iv48.unr = phi i64 [ %i.cc, %.lr.ph27 ], [ %indvars.iv.next49.prol, %.prol.loopexit.unr-lcssa ]
  %i.dd = icmp eq i32 %i.cl, 1
  br i1 %i.dd, label %ZSTD_row_update_internal.exit.i, label %.lr.ph27.new
...
.lr.ph27.new:                                     ; preds = %.prol.loopexit, %.lr.ph27.new
  %indvars.iv48 = phi i64 [ %indvars.iv.next49.1, %.lr.ph27.new ], [ %indvars.iv48.unr, %.prol.loopexit ] ; 4 uses
  %i.de = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv48
  %.val6 = load i64, ptr %i.de, align 1, !tbaa !46
  ...
  %i.do = and i64 %indvars.iv48, 7
  %i.dp = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.do
  store i32 %i.di, ptr %i.dp, align 4, !tbaa !45
  %indvars.iv.next49 = add nuw nsw i64 %indvars.iv48, 1 ; 2 uses
  %i.dq = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv.next49
  %.val6.1 = load i64, ptr %i.dq, align 1, !tbaa !46
  ...
  %i.ea = and i64 %indvars.iv.next49, 7
  %i.eb = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.ea
  store i32 %i.du, ptr %i.eb, align 4, !tbaa !45
  %indvars.iv.next49.1 = add nuw nsw i64 %indvars.iv48, 2 ; 2 uses
  %lftr.wideiv.1 = trunc i64 %indvars.iv.next49.1 to i32
  %exitcond51.not.1 = icmp eq i32 %i.cm, %lftr.wideiv.1
  br i1 %exitcond51.not.1, label %ZSTD_row_update_internal.exit.i, label %.lr.ph27.new, !llvm.loop !5
...
bb.g:                                             ; preds = %.lr.ph29, %bb.g
  ...
  %i.el = load i64, ptr %i.ac, align 8, !tbaa !52
  %i.em = getelementptr inbounds nuw i8, ptr %i.ef, i64 %indvars.iv52
  %i.en = getelementptr inbounds nuw i8, ptr %i.em, i64 8
  %.val7 = load i64, ptr %i.en, align 1, !tbaa !46
  ...
  %i.ez = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.ey ; 2 uses
  %i.fa = load i32, ptr %i.ez, align 4, !tbaa !45 ; 2 uses
  store i32 %i.er, ptr %i.ez, align 4, !tbaa !45
  %i.fb = lshr i32 %i.fa, 3
  %i.fc = and i32 %i.fb, 536870880
  %i.fd = zext nneg i32 %i.fc to i64              ; 2 uses
  %i.fe = getelementptr inbounds nuw [4 x i8], ptr %i.ee, i64 %i.fd
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.g, %ZSTD_row_update_internal.exit.i
  ...
  %i.fu = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.ft
  %i.fv = getelementptr inbounds nuw i8, ptr %i.fu, i64 8
  %.val8 = load i64, ptr %i.fv, align 1, !tbaa !46
  ...
  %i.gi = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.gh ; 2 uses
  %i.gj = load i32, ptr %i.gi, align 4, !tbaa !45
  store i32 %i.gb, ptr %i.gi, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit
...
bb.h:                                             ; preds = %bb.a
  ...
  store i32 %i.o, ptr %i.gq, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.h, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.gp, %bb.h ], [ %i.gj, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.gr = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.gs = load i32, ptr %i.gr, align 8, !tbaa !86
  %i.gt = add i32 %i.gs, %.0257.i
  store i32 %i.gt, ptr %i.gr, align 8, !tbaa !86
  ...
  %i.hb = load <16 x i8>, ptr %i.gx, align 1, !tbaa !53
  %i.hc = getelementptr inbounds nuw i8, ptr %i.gx, i64 16
  %i.hd = load <16 x i8>, ptr %i.hc, align 1, !tbaa !53
...
.lr.ph34:                                         ; preds = %.lr.ph34.preheader, %bb.k
  ...
  %i.hs = load i32, ptr %i.hr, align 4, !tbaa !45 ; 3 uses
...
._crit_edge:                                      ; preds = %bb.k, %bb.i, %ZSTD_row_getSSEMask.exit
  ...
  store i8 %i.ik, ptr %i.gx, align 1, !tbaa !53
  %i.il = zext nneg i32 %i.ij to i64              ; 2 uses
  %i.im = getelementptr inbounds nuw i8, ptr %i.gx, i64 %i.il
  store i8 %i.gz, ptr %i.im, align 1, !tbaa !53
  %i.in = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 2 uses
  %i.io = load i32, ptr %i.in, align 4, !tbaa !41 ; 2 uses
  %i.ip = add i32 %i.io, 1
  store i32 %i.ip, ptr %i.in, align 4, !tbaa !41
  %i.iq = getelementptr inbounds nuw [4 x i8], ptr %i.he, i64 %i.il
  store i32 %i.io, ptr %i.iq, align 4, !tbaa !45
  %.not44 = icmp eq i64 %.0249.i.lcssa, 0
  br i1 %.not44, label %ZSTD_RowFindBestMatch.exit, label %.lr.ph40
...
bb.l:                                             ; preds = %.lr.ph40, %ZSTD_count.exit.thread
  %.0248.i38 = phi i64 [ 0, %.lr.ph40 ], [ %i.ki, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i37 = phi i64 [ 3, %.lr.ph40 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 5 uses
  %i.iw = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i38
  %i.ix = load i32, ptr %i.iw, align 4, !tbaa !45 ; 2 uses
  ...
  %.val4 = load i32, ptr %i.jb, align 1, !tbaa !45
  %i.jc = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i37
  %i.jd = getelementptr inbounds i8, ptr %i.jc, i64 -3
  %.val = load i32, ptr %i.jd, align 1, !tbaa !45
  %i.je = icmp eq i32 %.val4, %.val
  br i1 %i.je, label %bb.m, label %ZSTD_count.exit.thread

bb.m:                                             ; preds = %bb.l
  br i1 %i.is, label %bb.n, label %.loopexit.i

bb.n:                                             ; preds = %bb.m
  %.val60.i = load i64, ptr %i.iz, align 1, !tbaa !46 ; 2 uses
  %.val.i = load i64, ptr %1, align 1, !tbaa !46  ; 2 uses
  %.not.i11 = icmp eq i64 %.val60.i, %.val.i
  br i1 %.not.i11, label %.preheader.i, label %bb.o
...
bb.w:                                             ; preds = %bb.v
  %i.jy = load i8, ptr %.4.i, align 1, !tbaa !53
  %i.jz = load i8, ptr %.453.i, align 1, !tbaa !53
...
ZSTD_count.exit:                                  ; preds = %bb.x, %.thread63.i, %bb.o
  ...
  br i1 %i.kd, label %bb.y, label %ZSTD_count.exit.thread

bb.y:                                             ; preds = %ZSTD_count.exit
  %i.ke = sub i32 %i.iv, %i.ix
  %i.kf = zext i32 %i.ke to i64
  store i64 %i.kf, ptr %3, align 8, !tbaa !46
  %i.kg = getelementptr inbounds nuw i8, ptr %1, i64 %.2243.i
  %i.kh = icmp eq ptr %i.kg, %2
  br i1 %i.kh, label %ZSTD_RowFindBestMatch.exit, label %ZSTD_count.exit.thread
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_noDict_5_6(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !38   ; 6 uses
  ...
  %i.t = sub i32 %i.o, %i.s
end_hunk_4
begin_hunk_5_@ZSTD_RowFindBestMatch_noDict_5_6:bb.a
  br label %bb.g

bb.g:                                             ; preds = %.lr.ph27, %bb.g
  %indvars.iv48 = phi i64 [ %i.cd, %.lr.ph27 ], [ %indvars.iv.next49, %bb.g ] ; 3 uses
  %i.cs = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv48
  %.val6 = load i64, ptr %i.cs, align 1, !tbaa !46
  %i.ct = mul i64 %.val6, -3523014627271114752
  %i.cu = xor i64 %i.ct, %i.cp
  %i.cv = lshr i64 %i.cu, %i.cr                   ; 2 uses
  %i.cw = trunc i64 %i.cv to i32
  %i.cx = lshr i64 %i.cv, 2
  %i.cy = and i64 %i.cx, 1073741760               ; 2 uses
  %i.cz = getelementptr inbounds nuw [4 x i8], ptr %i.ca, i64 %i.cy ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.cz, i32 0, i32 3, i32 1)
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.da, i32 0, i32 3, i32 1)
  ...
  %i.dd = and i64 %indvars.iv48, 7
  %i.de = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.dd
  store i32 %i.cw, ptr %i.de, align 4, !tbaa !45
  %indvars.iv.next49 = add nuw nsw i64 %indvars.iv48, 1 ; 2 uses
  %lftr.wideiv = trunc i64 %indvars.iv.next49 to i32
  %exitcond51.not = icmp eq i32 %i.cn, %lftr.wideiv
  br i1 %exitcond51.not, label %ZSTD_row_update_internal.exit.i, label %bb.g, !llvm.loop !5
...
.lr.ph29:                                         ; preds = %ZSTD_row_update_internal.exit.i
  %i.dk = sub i32 56, %i.df
  %i.dl = zext nneg i32 %i.dk to i64
  %i.dm = zext i32 %.0.i284.i to i64
  %i.dn = and i64 %i.n, 4294967295
  br label %bb.h

bb.h:                                             ; preds = %.lr.ph29, %bb.h
  %indvars.iv52 = phi i64 [ %i.dm, %.lr.ph29 ], [ %indvars.iv.next53, %bb.h ] ; 4 uses
  %i.do = load i64, ptr %i.ac, align 8, !tbaa !52
  %i.dp = getelementptr inbounds nuw i8, ptr %i.di, i64 %indvars.iv52
  %i.dq = getelementptr inbounds nuw i8, ptr %i.dp, i64 8
  %.val7 = load i64, ptr %i.dq, align 1, !tbaa !46
  %i.dr = mul i64 %.val7, -3523014627271114752
  %i.ds = xor i64 %i.dr, %i.do
  %i.dt = lshr i64 %i.ds, %i.dl                   ; 2 uses
  %i.du = trunc i64 %i.dt to i32
  %i.dv = lshr i64 %i.dt, 2
  %i.dw = and i64 %i.dv, 1073741760               ; 2 uses
  %i.dx = getelementptr inbounds nuw [4 x i8], ptr %i.dh, i64 %i.dw ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.dx, i32 0, i32 3, i32 1)
  %i.dy = getelementptr inbounds nuw i8, ptr %i.dx, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.dy, i32 0, i32 3, i32 1)
  ...
  %i.ed = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.ec ; 2 uses
  %i.ee = load i32, ptr %i.ed, align 4, !tbaa !45 ; 2 uses
  store i32 %i.du, ptr %i.ed, align 4, !tbaa !45
  %i.ef = lshr i32 %i.ee, 2
  %i.eg = and i32 %i.ef, 1073741760
  %i.eh = zext nneg i32 %i.eg to i64              ; 2 uses
  %i.ei = getelementptr inbounds nuw [4 x i8], ptr %i.dh, i64 %i.eh
  ...
  store i32 %i.eb, ptr %i.ev, align 4, !tbaa !45
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1 ; 2 uses
  %i.ew = icmp samesign ult i64 %indvars.iv.next53, %i.dn
  br i1 %i.ew, label %bb.h, label %ZSTD_row_update_internalImpl.exit287.i, !llvm.loop !0
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.h, %ZSTD_row_update_internal.exit.i
  ...
  %i.ey = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.ex
  %i.ez = getelementptr inbounds nuw i8, ptr %i.ey, i64 8
  %.val8 = load i64, ptr %i.ez, align 1, !tbaa !46
  %i.fa = mul i64 %.val8, -3523014627271114752
  %i.fb = xor i64 %i.fa, %i.ad
  %i.fc = sub i32 56, %i.h
  %i.fd = zext nneg i32 %i.fc to i64
  %i.fe = lshr i64 %i.fb, %i.fd                   ; 2 uses
  %i.ff = trunc i64 %i.fe to i32
  %i.fg = lshr i64 %i.fe, 2
  %i.fh = and i64 %i.fg, 1073741760               ; 2 uses
  %i.fi = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.fh ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.fi, i32 0, i32 3, i32 1)
  %i.fj = getelementptr inbounds nuw i8, ptr %i.fi, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.fj, i32 0, i32 3, i32 1)
  ...
  %i.fn = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.fm ; 2 uses
  %i.fo = load i32, ptr %i.fn, align 4, !tbaa !45
  store i32 %i.ff, ptr %i.fn, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit

bb.i:                                             ; preds = %bb.a
  %.val9 = load i64, ptr %1, align 1, !tbaa !46
  %i.fp = mul i64 %.val9, -3523014627271114752
  %i.fq = xor i64 %i.fp, %i.ad
  %i.fr = sub i32 56, %i.h
  %i.fs = zext nneg i32 %i.fr to i64
  %i.ft = lshr i64 %i.fq, %i.fs
  %i.fu = trunc i64 %i.ft to i32
  %i.fv = getelementptr inbounds nuw i8, ptr %0, i64 44
  store i32 %i.o, ptr %i.fv, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.i, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.fu, %bb.i ], [ %i.fo, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.fw = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.fx = load i32, ptr %i.fw, align 8, !tbaa !86
  %i.fy = add i32 %i.fx, %.0257.i
  store i32 %i.fy, ptr %i.fw, align 8, !tbaa !86
  %i.fz = lshr i32 %.0257.i, 2
  %i.ga = and i32 %i.fz, 1073741760
  %i.gb = zext nneg i32 %i.ga to i64              ; 2 uses
  %i.gc = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.gb ; 7 uses
  %i.gd = load i8, ptr %i.gc, align 1, !tbaa !53  ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #12
  %i.ge = trunc i32 %.0257.i to i8                ; 2 uses
  %i.gf = insertelement <16 x i8> poison, i8 %i.ge, i64 0
  %i.gg = shufflevector <16 x i8> %i.gf, <16 x i8> poison, <16 x i32> zeroinitializer ; 4 uses
  %i.gh = load <16 x i8>, ptr %i.gc, align 1, !tbaa !53
  %i.gi = icmp eq <16 x i8> %i.gh, %i.gg
  %i.gj = bitcast <16 x i1> %i.gi to i16
  %i.gk = getelementptr inbounds nuw i8, ptr %i.gc, i64 16
  %i.gl = load <16 x i8>, ptr %i.gk, align 1, !tbaa !53
  %i.gm = icmp eq <16 x i8> %i.gl, %i.gg
  %i.gn = bitcast <16 x i1> %i.gm to i16
  %i.go = getelementptr inbounds nuw i8, ptr %i.gc, i64 32
  %i.gp = load <16 x i8>, ptr %i.go, align 1, !tbaa !53
  %i.gq = icmp eq <16 x i8> %i.gp, %i.gg
  %i.gr = bitcast <16 x i1> %i.gq to i16
  %i.gs = getelementptr inbounds nuw i8, ptr %i.gc, i64 48
  %i.gt = load <16 x i8>, ptr %i.gs, align 1, !tbaa !53
  %i.gu = icmp eq <16 x i8> %i.gt, %i.gg
  %i.gv = bitcast <16 x i1> %i.gu to i16
  %i.gw = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.gb ; 2 uses
  %i.gx = zext i8 %i.gd to i32                    ; 2 uses
  %i.gy = insertelement <4 x i16> poison, i16 %i.gj, i64 0
  %i.gz = insertelement <4 x i16> %i.gy, i16 %i.gn, i64 1
  %i.ha = insertelement <4 x i16> %i.gz, i16 %i.gr, i64 2
  %i.hb = insertelement <4 x i16> %i.ha, i16 %i.gv, i64 3
  %i.hc = bitcast <4 x i16> %i.hb to i64          ; 3 uses
  %.not = icmp eq i64 %i.hc, 0
  br i1 %.not, label %._crit_edge, label %.lr.ph34.preheader

.lr.ph34.preheader:                               ; preds = %ZSTD_row_getSSEMask.exit
  %i.hd = zext i8 %i.gd to i64
  %i.he = tail call i64 @llvm.fshr.i64(i64 %i.hc, i64 %i.hc, i64 %i.hd)
  br label %.lr.ph34

.lr.ph34:                                         ; preds = %.lr.ph34.preheader, %bb.l
  %.0247.i33 = phi i64 [ %i.hu, %bb.l ], [ %i.he, %.lr.ph34.preheader ] ; 3 uses
  %.0249.i32 = phi i64 [ %.1250.i.ph, %bb.l ], [ 0, %.lr.ph34.preheader ] ; 4 uses
  %.0262.i31 = phi i32 [ %.1263.i.ph, %bb.l ], [ %i.ae, %.lr.ph34.preheader ] ; 2 uses
  %i.hf = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, 0) %.0247.i33, i1 true)
  %i.hg = trunc nuw nsw i64 %i.hf to i32
  %i.hh = add nuw nsw i32 %i.hg, %i.gx
  %i.hi = and i32 %i.hh, 63                       ; 2 uses
  %i.hj = zext nneg i32 %i.hi to i64
  %i.hk = getelementptr inbounds nuw [4 x i8], ptr %i.gw, i64 %i.hj
  %i.hl = load i32, ptr %i.hk, align 4, !tbaa !45 ; 3 uses
  %i.hm = icmp eq i32 %i.hi, 0
  br i1 %i.hm, label %bb.l, label %bb.j

bb.j:                                             ; preds = %.lr.ph34
  %i.hn = icmp ult i32 %i.hl, %i.z
  br i1 %i.hn, label %._crit_edge, label %bb.k
...
bb.l:                                             ; preds = %bb.k, %.lr.ph34
  %.1263.i.ph = phi i32 [ %.0262.i31, %.lr.ph34 ], [ %i.hs, %bb.k ] ; 2 uses
  %.1250.i.ph = phi i64 [ %.0249.i32, %.lr.ph34 ], [ %i.hq, %bb.k ] ; 2 uses
  %i.ht = add i64 %.0247.i33, -1
  %i.hu = and i64 %i.ht, %.0247.i33               ; 2 uses
  %i.hv = icmp ne i64 %i.hu, 0
  %i.hw = icmp ne i32 %.1263.i.ph, 0
  %i.hx = select i1 %i.hv, i1 %i.hw, i1 false
  br i1 %i.hx, label %.lr.ph34, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %bb.l, %bb.j, %ZSTD_row_getSSEMask.exit
  %.0249.i.lcssa = phi i64 [ 0, %ZSTD_row_getSSEMask.exit ], [ %.0249.i32, %bb.j ], [ %.1250.i.ph, %bb.l ] ; 2 uses
  %i.hy = add nuw nsw i32 %i.gx, 63
  %i.hz = and i32 %i.hy, 63                       ; 2 uses
  %i.ia = icmp eq i32 %i.hz, 0
  %i.ib = select i1 %i.ia, i32 63, i32 0
  %i.ic = add nuw nsw i32 %i.ib, %i.hz            ; 2 uses
  %i.id = trunc nuw nsw i32 %i.ic to i8
  store i8 %i.id, ptr %i.gc, align 1, !tbaa !53
  %i.ie = zext nneg i32 %i.ic to i64              ; 2 uses
  %i.if = getelementptr inbounds nuw i8, ptr %i.gc, i64 %i.ie
  store i8 %i.ge, ptr %i.if, align 1, !tbaa !53
  %i.ig = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 2 uses
  %i.ih = load i32, ptr %i.ig, align 4, !tbaa !41 ; 2 uses
  %i.ii = add i32 %i.ih, 1
  store i32 %i.ii, ptr %i.ig, align 4, !tbaa !41
  %i.ij = getelementptr inbounds nuw [4 x i8], ptr %i.gw, i64 %i.ie
  store i32 %i.ih, ptr %i.ij, align 4, !tbaa !45
  %.not44 = icmp eq i64 %.0249.i.lcssa, 0
  br i1 %.not44, label %ZSTD_RowFindBestMatch.exit, label %.lr.ph40

.lr.ph40:                                         ; preds = %._crit_edge
  %i.ik = getelementptr inbounds i8, ptr %2, i64 -7 ; 2 uses
  %i.il = icmp ult ptr %1, %i.ik
  %i.im = getelementptr inbounds i8, ptr %2, i64 -3
  %i.in = getelementptr inbounds i8, ptr %2, i64 -1
  %i.io = add i32 %i.o, 3
  br label %bb.m

bb.m:                                             ; preds = %.lr.ph40, %ZSTD_count.exit.thread
  %.0248.i38 = phi i64 [ 0, %.lr.ph40 ], [ %i.kb, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i37 = phi i64 [ 3, %.lr.ph40 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 5 uses
  %i.ip = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i38
  %i.iq = load i32, ptr %i.ip, align 4, !tbaa !45 ; 2 uses
  %i.ir = zext i32 %i.iq to i64
  %i.is = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.ir ; 4 uses
  %i.it = getelementptr inbounds nuw i8, ptr %i.is, i64 %.0258.i37
  %i.iu = getelementptr inbounds i8, ptr %i.it, i64 -3
  %.val4 = load i32, ptr %i.iu, align 1, !tbaa !45
  %i.iv = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i37
  %i.iw = getelementptr inbounds i8, ptr %i.iv, i64 -3
  %.val = load i32, ptr %i.iw, align 1, !tbaa !45
  %i.ix = icmp eq i32 %.val4, %.val
  br i1 %i.ix, label %bb.n, label %ZSTD_count.exit.thread

bb.n:                                             ; preds = %bb.m
  br i1 %i.il, label %bb.o, label %.loopexit.i

bb.o:                                             ; preds = %bb.n
  %.val60.i = load i64, ptr %i.is, align 1, !tbaa !46 ; 2 uses
  %.val.i = load i64, ptr %1, align 1, !tbaa !46  ; 2 uses
  %.not.i11 = icmp eq i64 %.val60.i, %.val.i
  br i1 %.not.i11, label %.preheader.i, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.iy = xor i64 %.val.i, %.val60.i
  %i.iz = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, 0) %i.iy, i1 true)
  %i.ja = lshr i64 %i.iz, 3
  br label %ZSTD_count.exit

.preheader.i:                                     ; preds = %bb.o, %bb.q
  %.pn.i = phi ptr [ %.049.i, %bb.q ], [ %1, %bb.o ]
  %.pn67.i = phi ptr [ %.045.i, %bb.q ], [ %i.is, %bb.o ]
  %.045.i = getelementptr inbounds nuw i8, ptr %.pn67.i, i64 8 ; 3 uses
  %.049.i = getelementptr inbounds nuw i8, ptr %.pn.i, i64 8 ; 5 uses
  %i.jb = icmp ult ptr %.049.i, %i.ik
  br i1 %i.jb, label %bb.q, label %.loopexit.i
...
.thread63.i:                                      ; preds = %bb.q
  %i.jc = xor i64 %.049.val.i, %.045.val.i
  %i.jd = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, 0) %i.jc, i1 true)
  %i.je = lshr i64 %i.jd, 3
  %i.jf = getelementptr inbounds nuw i8, ptr %.049.i, i64 %i.je
  %i.jg = ptrtoint ptr %i.jf to i64
  %i.jh = sub i64 %i.jg, %i.l
  br label %ZSTD_count.exit

.loopexit.i:                                      ; preds = %.preheader.i, %bb.n
  %.251.i = phi ptr [ %1, %bb.n ], [ %.049.i, %.preheader.i ] ; 5 uses
  %.247.i = phi ptr [ %i.is, %bb.n ], [ %.045.i, %.preheader.i ] ; 4 uses
  %i.ji = icmp ult ptr %.251.i, %i.im
  br i1 %i.ji, label %bb.r, label %bb.t

bb.r:                                             ; preds = %.loopexit.i
  %.247.val.i = load i32, ptr %.247.i, align 1, !tbaa !45
  %.251.val.i = load i32, ptr %.251.i, align 1, !tbaa !45
  %i.jj = icmp eq i32 %.247.val.i, %.251.val.i
  br i1 %i.jj, label %bb.s, label %bb.t

bb.s:                                             ; preds = %bb.r
  %i.jk = getelementptr inbounds nuw i8, ptr %.251.i, i64 4
  %i.jl = getelementptr inbounds nuw i8, ptr %.247.i, i64 4
  br label %bb.t

bb.t:                                             ; preds = %bb.s, %bb.r, %.loopexit.i
  %.352.i = phi ptr [ %i.jk, %bb.s ], [ %.251.i, %bb.r ], [ %.251.i, %.loopexit.i ] ; 5 uses
  %.348.i = phi ptr [ %i.jl, %bb.s ], [ %.247.i, %bb.r ], [ %.247.i, %.loopexit.i ] ; 4 uses
  %i.jm = icmp ult ptr %.352.i, %i.in
  br i1 %i.jm, label %bb.u, label %bb.w

bb.u:                                             ; preds = %bb.t
  %.348.val.i = load i16, ptr %.348.i, align 1, !tbaa !60
  %.352.val.i = load i16, ptr %.352.i, align 1, !tbaa !60
  %i.jn = icmp eq i16 %.348.val.i, %.352.val.i
  br i1 %i.jn, label %bb.v, label %bb.w

bb.v:                                             ; preds = %bb.u
  %i.jo = getelementptr inbounds nuw i8, ptr %.352.i, i64 2
  %i.jp = getelementptr inbounds nuw i8, ptr %.348.i, i64 2
  br label %bb.w

bb.w:                                             ; preds = %bb.v, %bb.u, %bb.t
  %.453.i = phi ptr [ %i.jo, %bb.v ], [ %.352.i, %bb.u ], [ %.352.i, %bb.t ] ; 4 uses
  %.4.i = phi ptr [ %i.jp, %bb.v ], [ %.348.i, %bb.u ], [ %.348.i, %bb.t ]
  %i.jq = icmp ult ptr %.453.i, %2
  br i1 %i.jq, label %bb.x, label %bb.y

bb.x:                                             ; preds = %bb.w
  %i.jr = load i8, ptr %.4.i, align 1, !tbaa !53
  %i.js = load i8, ptr %.453.i, align 1, !tbaa !53
  %i.jt = icmp eq i8 %i.jr, %i.js
  %spec.select.idx.i = zext i1 %i.jt to i64
  %spec.select.i10 = getelementptr inbounds nuw i8, ptr %.453.i, i64 %spec.select.idx.i
  br label %bb.y

bb.y:                                             ; preds = %bb.x, %bb.w
  %.5.i = phi ptr [ %.453.i, %bb.w ], [ %spec.select.i10, %bb.x ]
  %i.ju = ptrtoint ptr %.5.i to i64
  %i.jv = sub i64 %i.ju, %i.l
  br label %ZSTD_count.exit

ZSTD_count.exit:                                  ; preds = %bb.y, %.thread63.i, %bb.p
  %.2243.i = phi i64 [ %i.ja, %bb.p ], [ %i.jh, %.thread63.i ], [ %i.jv, %bb.y ] ; 4 uses
  %i.jw = icmp ugt i64 %.2243.i, %.0258.i37
  br i1 %i.jw, label %bb.z, label %ZSTD_count.exit.thread

bb.z:                                             ; preds = %ZSTD_count.exit
  %i.jx = sub i32 %i.io, %i.iq
  %i.jy = zext i32 %i.jx to i64
  store i64 %i.jy, ptr %3, align 8, !tbaa !46
  %i.jz = getelementptr inbounds nuw i8, ptr %1, i64 %.2243.i
  %i.ka = icmp eq ptr %i.jz, %2
  br i1 %i.ka, label %ZSTD_RowFindBestMatch.exit, label %ZSTD_count.exit.thread

ZSTD_count.exit.thread:                           ; preds = %bb.m, %bb.z, %ZSTD_count.exit
  %.2260.i.ph = phi i64 [ %.2243.i, %bb.z ], [ %.0258.i37, %ZSTD_count.exit ], [ %.0258.i37, %bb.m ] ; 2 uses
  %i.kb = add nuw i64 %.0248.i38, 1               ; 2 uses
  %exitcond59.not = icmp eq i64 %i.kb, %.0249.i.lcssa
  br i1 %exitcond59.not, label %ZSTD_RowFindBestMatch.exit, label %bb.m, !llvm.loop !10
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_noDict_6_4(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !38   ; 6 uses
  ...
  %i.t = sub i32 %i.o, %i.s
end_hunk_5
begin_hunk_6_@ZSTD_RowFindBestMatch_noDict_6_4:bb.a
  tail call void @llvm.prefetch.p0(ptr %i.cx, i32 0, i32 3, i32 1)
  %i.cy = getelementptr inbounds nuw i8, ptr %i.bx, i64 %i.cw
  tail call void @llvm.prefetch.p0(ptr %i.cy, i32 0, i32 3, i32 1)
  %i.cz = and i64 %i.cb, 7
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_noDict_6_5(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !38   ; 6 uses
  ...
  %i.t = sub i32 %i.o, %i.s
end_hunk_6
begin_hunk_7_@ZSTD_RowFindBestMatch_noDict_6_5:bb.a
  %indvars.iv48.unr = phi i64 [ %i.cc, %.lr.ph27 ], [ %indvars.iv.next49.prol, %.prol.loopexit.unr-lcssa ]
  %i.dd = icmp eq i32 %i.cl, 1
  br i1 %i.dd, label %ZSTD_row_update_internal.exit.i, label %.lr.ph27.new
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_noDict_6_6(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !38   ; 6 uses
  ...
  %i.t = sub i32 %i.o, %i.s
end_hunk_7
begin_hunk_8_@ZSTD_RowFindBestMatch_noDict_6_6:bb.a
  br label %bb.g
...
bb.g:                                             ; preds = %.lr.ph27, %bb.g
  ...
  %i.cs = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv48
  %.val6 = load i64, ptr %i.cs, align 1, !tbaa !46
  %i.ct = mul i64 %.val6, -3523014627193847808
  %i.cu = xor i64 %i.ct, %i.cp
  %i.cv = lshr i64 %i.cu, %i.cr                   ; 2 uses
  %i.cw = trunc i64 %i.cv to i32
  %i.cx = lshr i64 %i.cv, 2
...
bb.h:                                             ; preds = %.lr.ph29, %bb.h
  ...
  %i.dq = getelementptr inbounds nuw i8, ptr %i.dp, i64 8
  %.val7 = load i64, ptr %i.dq, align 1, !tbaa !46
  %i.dr = mul i64 %.val7, -3523014627193847808
  %i.ds = xor i64 %i.dr, %i.do
  %i.dt = lshr i64 %i.ds, %i.dl                   ; 2 uses
  %i.du = trunc i64 %i.dt to i32
  %i.dv = lshr i64 %i.dt, 2
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.h, %ZSTD_row_update_internal.exit.i
  ...
  %i.ez = getelementptr inbounds nuw i8, ptr %i.ey, i64 8
  %.val8 = load i64, ptr %i.ez, align 1, !tbaa !46
  %i.fa = mul i64 %.val8, -3523014627193847808
  %i.fb = xor i64 %i.fa, %i.ad
  %i.fc = sub i32 56, %i.h
  %i.fd = zext nneg i32 %i.fc to i64
  %i.fe = lshr i64 %i.fb, %i.fd                   ; 2 uses
...
bb.i:                                             ; preds = %bb.a
  %.val9 = load i64, ptr %1, align 1, !tbaa !46
  %i.fp = mul i64 %.val9, -3523014627193847808
  %i.fq = xor i64 %i.fp, %i.ad
  %i.fr = sub i32 56, %i.h
  %i.fs = zext nneg i32 %i.fr to i64
  %i.ft = lshr i64 %i.fq, %i.fs
...
define internal fastcc range(i64 3, 0) i64 @ZSTD_HcFindBestMatch_extDict_4(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #6 {
bb.a:
  ...
  %i.t = trunc i64 %i.s to i32                    ; 6 uses
end_hunk_8
begin_hunk_9_@ZSTD_RowFindBestMatch_extDict_4_4:bb.a
  %i.df = getelementptr inbounds nuw i8, ptr %i.ce, i64 %i.dd
  tail call void @llvm.prefetch.p0(ptr %i.df, i32 0, i32 3, i32 1)
  %i.dg = and i64 %i.ci, 7
  %i.dh = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.dg
  store i32 %i.da, ptr %i.dh, align 4, !tbaa !45
  %indvars.iv.next51.prol = add nuw nsw i64 %i.ci, 1
  br label %.prol.loopexit
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.unr-lcssa, %.lr.ph29
  ...
  br i1 %i.di, label %ZSTD_row_update_internal.exit.i, label %.lr.ph29.new
...
.lr.ph29.new:                                     ; preds = %.prol.loopexit, %.lr.ph29.new
  ...
  %.val8 = load i32, ptr %i.dj, align 1, !tbaa !45
  ...
  store i32 %i.dx, ptr %i.ee, align 4, !tbaa !45
  ...
  br i1 %exitcond53.not.1, label %ZSTD_row_update_internal.exit.i, label %.lr.ph29.new, !llvm.loop !5

ZSTD_row_update_internal.exit.i:                  ; preds = %.prol.loopexit, %.lr.ph29.new, %bb.f, %bb.b
  ...
  %i.ei = load ptr, ptr %i.j, align 8, !tbaa !37
  %i.ej = icmp ult i32 %.0.i284.i, %i.v
  br i1 %i.ej, label %.lr.ph31, label %ZSTD_row_update_internalImpl.exit287.i

.lr.ph31:                                         ; preds = %ZSTD_row_update_internal.exit.i
...
bb.g:                                             ; preds = %.lr.ph31, %bb.g
  ...
  %i.fc = load i32, ptr %i.fb, align 4, !tbaa !45 ; 2 uses
  store i32 %i.et, ptr %i.fb, align 4, !tbaa !45
  ...
  %i.fi = load i8, ptr %i.fh, align 1, !tbaa !53
  %i.fj = add i8 %i.fi, 15
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.g, %ZSTD_row_update_internal.exit.i
  ...
  %.val10 = load i32, ptr %i.fx, align 1, !tbaa !45
  ...
  %i.gk = load i32, ptr %i.gj, align 4, !tbaa !45
  store i32 %i.gc, ptr %i.gj, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit

bb.h:                                             ; preds = %bb.a
  %i.gl = trunc i64 %i.ak to i32
  %.val11 = load i32, ptr %1, align 1, !tbaa !45
  %i.gm = mul i32 %.val11, -1640531535
  %i.gn = xor i32 %i.gm, %i.gl
  %i.go = sub i32 24, %i.h
  %i.gp = lshr i32 %i.gn, %i.go
  %i.gq = getelementptr inbounds nuw i8, ptr %0, i64 44
  store i32 %i.v, ptr %i.gq, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.h, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.gp, %bb.h ], [ %i.gk, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.gr = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.gs = load i32, ptr %i.gr, align 8, !tbaa !86
  %i.gt = add i32 %i.gs, %.0257.i
  store i32 %i.gt, ptr %i.gr, align 8, !tbaa !86
  ...
  %i.gz = load i8, ptr %i.gy, align 1, !tbaa !53  ; 2 uses
  ...
  %i.he = load <16 x i8>, ptr %i.gy, align 1, !tbaa !53
...
.lr.ph36.preheader:                               ; preds = %ZSTD_row_getSSEMask.exit
  ...
  %i.hi = tail call i16 @llvm.fshr.i16(i16 %i.hg, i16 %i.hg, i16 %i.hh)
...
.lr.ph36:                                         ; preds = %.lr.ph36.preheader, %bb.k
  ...
  %i.hq = load i32, ptr %i.hp, align 4, !tbaa !45 ; 4 uses
...
._crit_edge:                                      ; preds = %bb.k, %bb.i, %ZSTD_row_getSSEMask.exit
  %.0249.i.lcssa = phi i64 [ 0, %ZSTD_row_getSSEMask.exit ], [ %.0249.i34, %bb.i ], [ %.1250.i.ph, %bb.k ] ; 2 uses
  ...
  store i8 %i.ii, ptr %i.gy, align 1, !tbaa !53
  %i.ij = zext nneg i32 %i.ih to i64              ; 2 uses
  %i.ik = getelementptr inbounds nuw i8, ptr %i.gy, i64 %i.ij
  store i8 %i.hb, ptr %i.ik, align 1, !tbaa !53
  %i.il = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 2 uses
  %i.im = load i32, ptr %i.il, align 4, !tbaa !41 ; 2 uses
  %i.in = add i32 %i.im, 1
  store i32 %i.in, ptr %i.il, align 4, !tbaa !41
  %i.io = getelementptr inbounds nuw [4 x i8], ptr %i.gx, i64 %i.ij
  store i32 %i.im, ptr %i.io, align 4, !tbaa !45
...
bb.l:                                             ; preds = %.lr.ph42, %ZSTD_count.exit.thread
  %.0248.i40 = phi i64 [ 0, %.lr.ph42 ], [ %i.km, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i39 = phi i64 [ 3, %.lr.ph42 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 6 uses
  %i.iv = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i40
  %i.iw = load i32, ptr %i.iv, align 4, !tbaa !45 ; 3 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.ja = getelementptr inbounds i8, ptr %i.iz, i64 -3
  %.val6 = load i32, ptr %i.ja, align 1, !tbaa !45
  %i.jb = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i39
  %i.jc = getelementptr inbounds i8, ptr %i.jb, i64 -3
  %.val5 = load i32, ptr %i.jc, align 1, !tbaa !45
  %i.jd = icmp eq i32 %.val6, %.val5
  br i1 %i.jd, label %bb.n, label %ZSTD_count.exit.thread
...
bb.z:                                             ; preds = %bb.l
  ...
  %.val4 = load i32, ptr %i.kc, align 1, !tbaa !45
  %.val = load i32, ptr %1, align 1, !tbaa !45
  %i.kd = icmp eq i32 %.val4, %.val
  br i1 %i.kd, label %bb.aa, label %ZSTD_count.exit.thread

bb.aa:                                            ; preds = %bb.z
  %i.ke = getelementptr inbounds nuw i8, ptr %i.kc, i64 4
  %i.kf = tail call fastcc i64 @ZSTD_count_2segments(ptr noundef nonnull %i.it, ptr noundef nonnull %i.ke, ptr noundef %2, ptr noundef nonnull %i.r, ptr noundef nonnull %i.q)
  %i.kg = add i64 %i.kf, 4
  br label %ZSTD_count.exit

ZSTD_count.exit:                                  ; preds = %bb.y, %.thread63.i, %bb.p, %bb.aa
  %.2243.i = phi i64 [ %i.kb, %bb.y ], [ %i.jg, %bb.p ], [ %i.kg, %bb.aa ], [ %i.jn, %.thread63.i ] ; 4 uses
  %i.kh = icmp ugt i64 %.2243.i, %.0258.i39
  br i1 %i.kh, label %bb.ab, label %ZSTD_count.exit.thread

bb.ab:                                            ; preds = %ZSTD_count.exit
  %i.ki = sub i32 %i.iu, %i.iw
  %i.kj = zext i32 %i.ki to i64
  store i64 %i.kj, ptr %3, align 8, !tbaa !46
  %i.kk = getelementptr inbounds nuw i8, ptr %1, i64 %.2243.i
  %i.kl = icmp eq ptr %i.kk, %2
  br i1 %i.kl, label %ZSTD_RowFindBestMatch.exit, label %ZSTD_count.exit.thread

ZSTD_count.exit.thread:                           ; preds = %bb.z, %bb.m, %bb.ab, %ZSTD_count.exit
  %.2260.i.ph = phi i64 [ %.2243.i, %bb.ab ], [ %.0258.i39, %ZSTD_count.exit ], [ %.0258.i39, %bb.m ], [ %.0258.i39, %bb.z ] ; 2 uses
  %i.km = add nuw i64 %.0248.i40, 1               ; 2 uses
  %exitcond57.not = icmp eq i64 %i.km, %.0249.i.lcssa
  br i1 %exitcond57.not, label %ZSTD_RowFindBestMatch.exit, label %bb.l, !llvm.loop !10

ZSTD_RowFindBestMatch.exit:                       ; preds = %ZSTD_count.exit.thread, %bb.ab, %._crit_edge
  %.3261.i = phi i64 [ 3, %._crit_edge ], [ %.2243.i, %bb.ab ], [ %.2260.i.ph, %ZSTD_count.exit.thread ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #12
  ret i64 %.3261.i
}

; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_extDict_4_5(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
end_hunk_9
begin_hunk_10_@ZSTD_RowFindBestMatch_extDict_4_5:bb.a
  %i.dk = icmp eq i32 %i.cs, 1
  br i1 %i.dk, label %ZSTD_row_update_internal.exit.i, label %.lr.ph29.new

.lr.ph29.new:                                     ; preds = %.prol.loopexit, %.lr.ph29.new
  %indvars.iv50 = phi i64 [ %indvars.iv.next51.1, %.lr.ph29.new ], [ %indvars.iv50.unr, %.prol.loopexit ] ; 4 uses
  %i.dl = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv50
  %.val8 = load i32, ptr %i.dl, align 1, !tbaa !45
  ...
  %.val8.1 = load i32, ptr %i.dx, align 1, !tbaa !45
  ...
  store i32 %i.ea, ptr %i.ei, align 4, !tbaa !45
  %indvars.iv.next51.1 = add nuw nsw i64 %indvars.iv50, 2 ; 2 uses
  %lftr.wideiv.1 = trunc i64 %indvars.iv.next51.1 to i32
...
ZSTD_row_update_internal.exit.i:                  ; preds = %.prol.loopexit, %.lr.ph29.new, %bb.f, %bb.b
  ...
  %i.em = load ptr, ptr %i.j, align 8, !tbaa !37
  %i.en = icmp ult i32 %.0.i284.i, %i.v
  br i1 %i.en, label %.lr.ph31, label %ZSTD_row_update_internalImpl.exit287.i
...
bb.g:                                             ; preds = %.lr.ph31, %bb.g
  ...
  %i.fh = load i32, ptr %i.fg, align 4, !tbaa !45 ; 2 uses
  store i32 %i.ex, ptr %i.fg, align 4, !tbaa !45
  ...
  %i.fn = load i8, ptr %i.fm, align 1, !tbaa !53
  %i.fo = add i8 %i.fn, 31
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.g, %ZSTD_row_update_internal.exit.i
  ...
  %.val10 = load i32, ptr %i.gc, align 1, !tbaa !45
  ...
  %i.gq = load i32, ptr %i.gp, align 4, !tbaa !45
  store i32 %i.gh, ptr %i.gp, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit
...
bb.h:                                             ; preds = %bb.a
  ...
  store i32 %i.v, ptr %i.gw, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.h, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.gv, %bb.h ], [ %i.gq, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.gx = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.gy = load i32, ptr %i.gx, align 8, !tbaa !86
  %i.gz = add i32 %i.gy, %.0257.i
  store i32 %i.gz, ptr %i.gx, align 8, !tbaa !86
...
.lr.ph36:                                         ; preds = %.lr.ph36.preheader, %bb.k
  ...
  %i.hy = load i32, ptr %i.hx, align 4, !tbaa !45 ; 4 uses
...
bb.l:                                             ; preds = %.lr.ph42, %ZSTD_count.exit.thread
  %.0248.i40 = phi i64 [ 0, %.lr.ph42 ], [ %i.ku, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i39 = phi i64 [ 3, %.lr.ph42 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 6 uses
  %i.jd = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i40
  %i.je = load i32, ptr %i.jd, align 4, !tbaa !45 ; 3 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  %.val6 = load i32, ptr %i.ji, align 1, !tbaa !45
  %i.jj = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i39
  %i.jk = getelementptr inbounds i8, ptr %i.jj, i64 -3
  %.val5 = load i32, ptr %i.jk, align 1, !tbaa !45
  %i.jl = icmp eq i32 %.val6, %.val5
  br i1 %i.jl, label %bb.n, label %ZSTD_count.exit.thread

bb.n:                                             ; preds = %bb.m
  br i1 %i.iy, label %bb.o, label %.loopexit.i

bb.o:                                             ; preds = %bb.n
  %.val60.i = load i64, ptr %i.jg, align 1, !tbaa !46 ; 2 uses
  %.val.i = load i64, ptr %1, align 1, !tbaa !46  ; 2 uses
  %.not.i13 = icmp eq i64 %.val60.i, %.val.i
  br i1 %.not.i13, label %.preheader.i, label %bb.p
...
bb.x:                                             ; preds = %bb.w
  %i.kf = load i8, ptr %.4.i, align 1, !tbaa !53
  %i.kg = load i8, ptr %.453.i, align 1, !tbaa !53
...
bb.z:                                             ; preds = %bb.l
  ...
  %.val4 = load i32, ptr %i.kk, align 1, !tbaa !45
  %.val = load i32, ptr %1, align 1, !tbaa !45
  %i.kl = icmp eq i32 %.val4, %.val
  br i1 %i.kl, label %bb.aa, label %ZSTD_count.exit.thread

bb.aa:                                            ; preds = %bb.z
  %i.km = getelementptr inbounds nuw i8, ptr %i.kk, i64 4
  %i.kn = tail call fastcc i64 @ZSTD_count_2segments(ptr noundef nonnull %i.jb, ptr noundef nonnull %i.km, ptr noundef %2, ptr noundef nonnull %i.r, ptr noundef nonnull %i.q)
  %i.ko = add i64 %i.kn, 4
  br label %ZSTD_count.exit
...
ZSTD_count.exit:                                  ; preds = %bb.y, %.thread63.i, %bb.p, %bb.aa
  ...
  br i1 %i.kp, label %bb.ab, label %ZSTD_count.exit.thread

bb.ab:                                            ; preds = %ZSTD_count.exit
  %i.kq = sub i32 %i.jc, %i.je
  %i.kr = zext i32 %i.kq to i64
  store i64 %i.kr, ptr %3, align 8, !tbaa !46
  %i.ks = getelementptr inbounds nuw i8, ptr %1, i64 %.2243.i
  %i.kt = icmp eq ptr %i.ks, %2
  br i1 %i.kt, label %ZSTD_RowFindBestMatch.exit, label %ZSTD_count.exit.thread

ZSTD_count.exit.thread:                           ; preds = %bb.z, %bb.m, %bb.ab, %ZSTD_count.exit
  %.2260.i.ph = phi i64 [ %.2243.i, %bb.ab ], [ %.0258.i39, %ZSTD_count.exit ], [ %.0258.i39, %bb.m ], [ %.0258.i39, %bb.z ] ; 2 uses
  %i.ku = add nuw i64 %.0248.i40, 1               ; 2 uses
  %exitcond60.not = icmp eq i64 %i.ku, %.0249.i.lcssa
  br i1 %exitcond60.not, label %ZSTD_RowFindBestMatch.exit, label %bb.l, !llvm.loop !10
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_extDict_4_6(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
end_hunk_10
begin_hunk_11_@ZSTD_RowFindBestMatch_extDict_4_6:bb.a

bb.g:                                             ; preds = %.lr.ph29, %bb.g
  %indvars.iv50 = phi i64 [ %i.ck, %.lr.ph29 ], [ %indvars.iv.next51, %bb.g ] ; 3 uses
  %i.cz = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv50
  %.val8 = load i32, ptr %i.cz, align 1, !tbaa !45
  %i.da = mul i32 %.val8, -1640531535
  %i.db = xor i32 %i.da, %i.cx
  %i.dc = lshr i32 %i.db, %i.cy                   ; 2 uses
  %i.dd = lshr i32 %i.dc, 2
  %i.de = and i32 %i.dd, 1073741760
  %i.df = zext nneg i32 %i.de to i64              ; 2 uses
  %i.dg = getelementptr inbounds nuw [4 x i8], ptr %i.ch, i64 %i.df ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.dg, i32 0, i32 3, i32 1)
  %i.dh = getelementptr inbounds nuw i8, ptr %i.dg, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.dh, i32 0, i32 3, i32 1)
  %i.di = getelementptr inbounds nuw i8, ptr %i.cg, i64 %i.df ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.di, i32 0, i32 3, i32 1)
  %i.dj = getelementptr inbounds nuw i8, ptr %i.di, i64 32
  tail call void @llvm.prefetch.p0(ptr nonnull %i.dj, i32 0, i32 3, i32 1)
  %i.dk = and i64 %indvars.iv50, 7
  %i.dl = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.dk
  store i32 %i.dc, ptr %i.dl, align 4, !tbaa !45
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1 ; 2 uses
  %lftr.wideiv = trunc i64 %indvars.iv.next51 to i32
  %exitcond53.not = icmp eq i32 %i.cu, %lftr.wideiv
  br i1 %exitcond53.not, label %ZSTD_row_update_internal.exit.i, label %bb.g, !llvm.loop !5

ZSTD_row_update_internal.exit.i:                  ; preds = %bb.g, %bb.f, %bb.b
  %i.dm = phi i32 [ %i.h, %bb.b ], [ %i.cf, %bb.f ], [ %i.cf, %bb.g ]
  %i.dn = phi ptr [ %i.e, %bb.b ], [ %i.cg, %bb.f ], [ %i.cg, %bb.g ] ; 2 uses
  %i.do = phi ptr [ %i.c, %bb.b ], [ %i.ch, %bb.f ], [ %i.ch, %bb.g ] ; 2 uses
  %.0.i284.i = phi i32 [ %i.ap, %bb.b ], [ %i.ci, %bb.f ], [ %i.ci, %bb.g ] ; 2 uses
  %i.dp = load ptr, ptr %i.j, align 8, !tbaa !37
  %i.dq = icmp ult i32 %.0.i284.i, %i.v
  br i1 %i.dq, label %.lr.ph31, label %ZSTD_row_update_internalImpl.exit287.i

.lr.ph31:                                         ; preds = %ZSTD_row_update_internal.exit.i
  %i.dr = sub i32 24, %i.dm
  %i.ds = zext i32 %.0.i284.i to i64
  %i.dt = and i64 %i.u, 4294967295
  br label %bb.h

bb.h:                                             ; preds = %.lr.ph31, %bb.h
  %indvars.iv54 = phi i64 [ %i.ds, %.lr.ph31 ], [ %indvars.iv.next55, %bb.h ] ; 4 uses
  %i.du = load i64, ptr %i.aj, align 8, !tbaa !52
  %i.dv = getelementptr inbounds nuw i8, ptr %i.dp, i64 %indvars.iv54
  %i.dw = getelementptr inbounds nuw i8, ptr %i.dv, i64 8
  %i.dx = trunc i64 %i.du to i32
  %.val9 = load i32, ptr %i.dw, align 1, !tbaa !45
  %i.dy = mul i32 %.val9, -1640531535
  %i.dz = xor i32 %i.dy, %i.dx
  %i.ea = lshr i32 %i.dz, %i.dr                   ; 2 uses
  %i.eb = lshr i32 %i.ea, 2
  %i.ec = and i32 %i.eb, 1073741760
  %i.ed = zext nneg i32 %i.ec to i64              ; 2 uses
  %i.ee = getelementptr inbounds nuw [4 x i8], ptr %i.do, i64 %i.ed ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.ee, i32 0, i32 3, i32 1)
  %i.ef = getelementptr inbounds nuw i8, ptr %i.ee, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.ef, i32 0, i32 3, i32 1)
  %i.eg = getelementptr inbounds nuw i8, ptr %i.dn, i64 %i.ed ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.eg, i32 0, i32 3, i32 1)
  %i.eh = getelementptr inbounds nuw i8, ptr %i.eg, i64 32
  tail call void @llvm.prefetch.p0(ptr nonnull %i.eh, i32 0, i32 3, i32 1)
  %i.ei = trunc nuw i64 %indvars.iv54 to i32
  %i.ej = and i64 %indvars.iv54, 7
  %i.ek = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.ej ; 2 uses
  %i.el = load i32, ptr %i.ek, align 4, !tbaa !45 ; 2 uses
  store i32 %i.ea, ptr %i.ek, align 4, !tbaa !45
  %i.em = lshr i32 %i.el, 2
  %i.en = and i32 %i.em, 1073741760
  %i.eo = zext nneg i32 %i.en to i64              ; 2 uses
  %i.ep = getelementptr inbounds nuw [4 x i8], ptr %i.do, i64 %i.eo
  %i.eq = getelementptr inbounds nuw i8, ptr %i.dn, i64 %i.eo ; 3 uses
  %i.er = load i8, ptr %i.eq, align 1, !tbaa !53
  %i.es = add i8 %i.er, 63
  %i.et = and i8 %i.es, 63                        ; 2 uses
  %i.eu = zext nneg i8 %i.et to i32
  %i.ev = icmp eq i8 %i.et, 0
  %i.ew = select i1 %i.ev, i32 63, i32 0
  %i.ex = add nuw nsw i32 %i.ew, %i.eu            ; 2 uses
  %i.ey = trunc nuw nsw i32 %i.ex to i8
  store i8 %i.ey, ptr %i.eq, align 1, !tbaa !53
  %i.ez = trunc i32 %i.el to i8
  %i.fa = zext nneg i32 %i.ex to i64              ; 2 uses
  %i.fb = getelementptr inbounds nuw i8, ptr %i.eq, i64 %i.fa
  store i8 %i.ez, ptr %i.fb, align 1, !tbaa !53
  %i.fc = getelementptr inbounds nuw [4 x i8], ptr %i.ep, i64 %i.fa
  store i32 %i.ei, ptr %i.fc, align 4, !tbaa !45
  %indvars.iv.next55 = add nuw nsw i64 %indvars.iv54, 1 ; 2 uses
  %i.fd = icmp samesign ult i64 %indvars.iv.next55, %i.dt
  br i1 %i.fd, label %bb.h, label %ZSTD_row_update_internalImpl.exit287.i, !llvm.loop !0

ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.h, %ZSTD_row_update_internal.exit.i
  store i32 %i.v, ptr %i.ao, align 4, !tbaa !41
  %i.fe = and i64 %i.u, 4294967295
  %i.ff = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.fe
  %i.fg = getelementptr inbounds nuw i8, ptr %i.ff, i64 8
  %i.fh = trunc i64 %i.ak to i32
  %.val10 = load i32, ptr %i.fg, align 1, !tbaa !45
  %i.fi = mul i32 %.val10, -1640531535
  %i.fj = xor i32 %i.fi, %i.fh
  %i.fk = sub i32 24, %i.h
  %i.fl = lshr i32 %i.fj, %i.fk                   ; 2 uses
  %i.fm = lshr i32 %i.fl, 2
  %i.fn = and i32 %i.fm, 1073741760
  %i.fo = zext nneg i32 %i.fn to i64              ; 2 uses
  %i.fp = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.fo ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.fp, i32 0, i32 3, i32 1)
  %i.fq = getelementptr inbounds nuw i8, ptr %i.fp, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.fq, i32 0, i32 3, i32 1)
  %i.fr = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.fo ; 2 uses
  ...
  %i.ft = and i64 %i.u, 7
  %i.fu = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.ft ; 2 uses
  %i.fv = load i32, ptr %i.fu, align 4, !tbaa !45
  store i32 %i.fl, ptr %i.fu, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit

bb.i:                                             ; preds = %bb.a
  %i.fw = trunc i64 %i.ak to i32
  %.val11 = load i32, ptr %1, align 1, !tbaa !45
  %i.fx = mul i32 %.val11, -1640531535
  %i.fy = xor i32 %i.fx, %i.fw
  %i.fz = sub i32 24, %i.h
  %i.ga = lshr i32 %i.fy, %i.fz
  %i.gb = getelementptr inbounds nuw i8, ptr %0, i64 44
  store i32 %i.v, ptr %i.gb, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.i, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.ga, %bb.i ], [ %i.fv, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.gc = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.gd = load i32, ptr %i.gc, align 8, !tbaa !86
  %i.ge = add i32 %i.gd, %.0257.i
  store i32 %i.ge, ptr %i.gc, align 8, !tbaa !86
  %i.gf = lshr i32 %.0257.i, 2
  %i.gg = and i32 %i.gf, 1073741760
  %i.gh = zext nneg i32 %i.gg to i64              ; 2 uses
  %i.gi = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.gh ; 7 uses
  %i.gj = load i8, ptr %i.gi, align 1, !tbaa !53  ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #12
  %i.gk = trunc i32 %.0257.i to i8                ; 2 uses
  %i.gl = insertelement <16 x i8> poison, i8 %i.gk, i64 0
  %i.gm = shufflevector <16 x i8> %i.gl, <16 x i8> poison, <16 x i32> zeroinitializer ; 4 uses
  %i.gn = load <16 x i8>, ptr %i.gi, align 1, !tbaa !53
  %i.go = icmp eq <16 x i8> %i.gn, %i.gm
  %i.gp = bitcast <16 x i1> %i.go to i16
  %i.gq = getelementptr inbounds nuw i8, ptr %i.gi, i64 16
  %i.gr = load <16 x i8>, ptr %i.gq, align 1, !tbaa !53
  %i.gs = icmp eq <16 x i8> %i.gr, %i.gm
  %i.gt = bitcast <16 x i1> %i.gs to i16
  %i.gu = getelementptr inbounds nuw i8, ptr %i.gi, i64 32
  %i.gv = load <16 x i8>, ptr %i.gu, align 1, !tbaa !53
  %i.gw = icmp eq <16 x i8> %i.gv, %i.gm
  %i.gx = bitcast <16 x i1> %i.gw to i16
  %i.gy = getelementptr inbounds nuw i8, ptr %i.gi, i64 48
  %i.gz = load <16 x i8>, ptr %i.gy, align 1, !tbaa !53
  %i.ha = icmp eq <16 x i8> %i.gz, %i.gm
  %i.hb = bitcast <16 x i1> %i.ha to i16
  %i.hc = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.gh ; 2 uses
  %i.hd = zext i8 %i.gj to i32                    ; 2 uses
  %i.he = insertelement <4 x i16> poison, i16 %i.gp, i64 0
  %i.hf = insertelement <4 x i16> %i.he, i16 %i.gt, i64 1
  %i.hg = insertelement <4 x i16> %i.hf, i16 %i.gx, i64 2
  %i.hh = insertelement <4 x i16> %i.hg, i16 %i.hb, i64 3
  %i.hi = bitcast <4 x i16> %i.hh to i64          ; 3 uses
  %.not = icmp eq i64 %i.hi, 0
  br i1 %.not, label %._crit_edge, label %.lr.ph36.preheader

.lr.ph36.preheader:                               ; preds = %ZSTD_row_getSSEMask.exit
  %i.hj = zext i8 %i.gj to i64
  %i.hk = tail call i64 @llvm.fshr.i64(i64 %i.hi, i64 %i.hi, i64 %i.hj)
  br label %.lr.ph36

.lr.ph36:                                         ; preds = %.lr.ph36.preheader, %bb.l
  %.0247.i35 = phi i64 [ %i.ia, %bb.l ], [ %i.hk, %.lr.ph36.preheader ] ; 3 uses
  %.0249.i34 = phi i64 [ %.1250.i.ph, %bb.l ], [ 0, %.lr.ph36.preheader ] ; 4 uses
  %.0262.i33 = phi i32 [ %.1263.i.ph, %bb.l ], [ %i.al, %.lr.ph36.preheader ] ; 2 uses
  %i.hl = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, 0) %.0247.i35, i1 true)
  %i.hm = trunc nuw nsw i64 %i.hl to i32
  %i.hn = add nuw nsw i32 %i.hm, %i.hd
  %i.ho = and i32 %i.hn, 63                       ; 2 uses
  %i.hp = zext nneg i32 %i.ho to i64
  %i.hq = getelementptr inbounds nuw [4 x i8], ptr %i.hc, i64 %i.hp
  %i.hr = load i32, ptr %i.hq, align 4, !tbaa !45 ; 4 uses
  %i.hs = icmp eq i32 %i.ho, 0
  br i1 %i.hs, label %bb.l, label %bb.j

bb.j:                                             ; preds = %.lr.ph36
  %i.ht = icmp ult i32 %i.hr, %i.ag
  br i1 %i.ht, label %._crit_edge, label %bb.k
...
bb.l:                                             ; preds = %bb.k, %.lr.ph36
  %.1263.i.ph = phi i32 [ %.0262.i33, %.lr.ph36 ], [ %i.hy, %bb.k ] ; 2 uses
  %.1250.i.ph = phi i64 [ %.0249.i34, %.lr.ph36 ], [ %i.hw, %bb.k ] ; 2 uses
  %i.hz = add i64 %.0247.i35, -1
...
._crit_edge:                                      ; preds = %bb.l, %bb.j, %ZSTD_row_getSSEMask.exit
  %.0249.i.lcssa = phi i64 [ 0, %ZSTD_row_getSSEMask.exit ], [ %.0249.i34, %bb.j ], [ %.1250.i.ph, %bb.l ] ; 2 uses
  %i.ie = add nuw nsw i32 %i.hd, 63
  %i.if = and i32 %i.ie, 63                       ; 2 uses
  %i.ig = icmp eq i32 %i.if, 0
  %i.ih = select i1 %i.ig, i32 63, i32 0
  %i.ii = add nuw nsw i32 %i.ih, %i.if            ; 2 uses
  %i.ij = trunc nuw nsw i32 %i.ii to i8
  store i8 %i.ij, ptr %i.gi, align 1, !tbaa !53
  %i.ik = zext nneg i32 %i.ii to i64              ; 2 uses
  %i.il = getelementptr inbounds nuw i8, ptr %i.gi, i64 %i.ik
  store i8 %i.gk, ptr %i.il, align 1, !tbaa !53
  %i.im = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 2 uses
  %i.in = load i32, ptr %i.im, align 4, !tbaa !41 ; 2 uses
  %i.io = add i32 %i.in, 1
  store i32 %i.io, ptr %i.im, align 4, !tbaa !41
  %i.ip = getelementptr inbounds nuw [4 x i8], ptr %i.hc, i64 %i.ik
  store i32 %i.in, ptr %i.ip, align 4, !tbaa !45
  %.not46 = icmp eq i64 %.0249.i.lcssa, 0
  br i1 %.not46, label %ZSTD_RowFindBestMatch.exit, label %.lr.ph42
...
bb.m:                                             ; preds = %.lr.ph42, %ZSTD_count.exit.thread
  %.0248.i40 = phi i64 [ 0, %.lr.ph42 ], [ %i.kn, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i39 = phi i64 [ 3, %.lr.ph42 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 6 uses
  %i.iw = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i40
  %i.ix = load i32, ptr %i.iw, align 4, !tbaa !45 ; 3 uses
  %.not278.i = icmp ult i32 %i.ix, %i.o
  %i.iy = zext i32 %i.ix to i64                   ; 2 uses
  br i1 %.not278.i, label %bb.aa, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.iz = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.iy ; 4 uses
  %i.ja = getelementptr inbounds nuw i8, ptr %i.iz, i64 %.0258.i39
  %i.jb = getelementptr inbounds i8, ptr %i.ja, i64 -3
  %.val6 = load i32, ptr %i.jb, align 1, !tbaa !45
  %i.jc = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i39
  %i.jd = getelementptr inbounds i8, ptr %i.jc, i64 -3
  %.val5 = load i32, ptr %i.jd, align 1, !tbaa !45
  %i.je = icmp eq i32 %.val6, %.val5
  br i1 %i.je, label %bb.o, label %ZSTD_count.exit.thread

bb.o:                                             ; preds = %bb.n
  br i1 %i.ir, label %bb.p, label %.loopexit.i

bb.p:                                             ; preds = %bb.o
  %.val60.i = load i64, ptr %i.iz, align 1, !tbaa !46 ; 2 uses
  %.val.i = load i64, ptr %1, align 1, !tbaa !46  ; 2 uses
  %.not.i13 = icmp eq i64 %.val60.i, %.val.i
  br i1 %.not.i13, label %.preheader.i, label %bb.q
...
.preheader.i:                                     ; preds = %bb.p, %bb.r
  %.pn.i = phi ptr [ %.049.i, %bb.r ], [ %1, %bb.p ]
  %.pn67.i = phi ptr [ %.045.i, %bb.r ], [ %i.iz, %bb.p ]
  %.045.i = getelementptr inbounds nuw i8, ptr %.pn67.i, i64 8 ; 3 uses
  %.049.i = getelementptr inbounds nuw i8, ptr %.pn.i, i64 8 ; 5 uses
  %i.ji = icmp ult ptr %.049.i, %i.iq
  br i1 %i.ji, label %bb.r, label %.loopexit.i
...
.loopexit.i:                                      ; preds = %.preheader.i, %bb.o
  %.251.i = phi ptr [ %1, %bb.o ], [ %.049.i, %.preheader.i ] ; 5 uses
  %.247.i = phi ptr [ %i.iz, %bb.o ], [ %.045.i, %.preheader.i ] ; 4 uses
  %i.jp = icmp ult ptr %.251.i, %i.is
  br i1 %i.jp, label %bb.s, label %bb.u

bb.s:                                             ; preds = %.loopexit.i
  %.247.val.i = load i32, ptr %.247.i, align 1, !tbaa !45
  %.251.val.i = load i32, ptr %.251.i, align 1, !tbaa !45
  %i.jq = icmp eq i32 %.247.val.i, %.251.val.i
  br i1 %i.jq, label %bb.t, label %bb.u
...
bb.u:                                             ; preds = %bb.t, %bb.s, %.loopexit.i
  %.352.i = phi ptr [ %i.jr, %bb.t ], [ %.251.i, %bb.s ], [ %.251.i, %.loopexit.i ] ; 5 uses
  %.348.i = phi ptr [ %i.js, %bb.t ], [ %.247.i, %bb.s ], [ %.247.i, %.loopexit.i ] ; 4 uses
  %i.jt = icmp ult ptr %.352.i, %i.it
  br i1 %i.jt, label %bb.v, label %bb.x
...
bb.x:                                             ; preds = %bb.w, %bb.v, %bb.u
  %.453.i = phi ptr [ %i.jv, %bb.w ], [ %.352.i, %bb.v ], [ %.352.i, %bb.u ] ; 4 uses
  %.4.i = phi ptr [ %i.jw, %bb.w ], [ %.348.i, %bb.v ], [ %.348.i, %bb.u ]
  %i.jx = icmp ult ptr %.453.i, %2
  br i1 %i.jx, label %bb.y, label %bb.z
...
bb.z:                                             ; preds = %bb.y, %bb.x
  %.5.i = phi ptr [ %.453.i, %bb.x ], [ %spec.select.i12, %bb.y ]
  %i.kb = ptrtoint ptr %.5.i to i64
...
bb.aa:                                            ; preds = %bb.m
  ...
  %.val4 = load i32, ptr %i.kd, align 1, !tbaa !45
  %.val = load i32, ptr %1, align 1, !tbaa !45
  %i.ke = icmp eq i32 %.val4, %.val
  br i1 %i.ke, label %bb.ab, label %ZSTD_count.exit.thread

bb.ab:                                            ; preds = %bb.aa
  %i.kf = getelementptr inbounds nuw i8, ptr %i.kd, i64 4
  %i.kg = tail call fastcc i64 @ZSTD_count_2segments(ptr noundef nonnull %i.iu, ptr noundef nonnull %i.kf, ptr noundef %2, ptr noundef nonnull %i.r, ptr noundef nonnull %i.q)
  %i.kh = add i64 %i.kg, 4
  br label %ZSTD_count.exit

ZSTD_count.exit:                                  ; preds = %bb.z, %.thread63.i, %bb.q, %bb.ab
  %.2243.i = phi i64 [ %i.kc, %bb.z ], [ %i.jh, %bb.q ], [ %i.kh, %bb.ab ], [ %i.jo, %.thread63.i ] ; 4 uses
  %i.ki = icmp ugt i64 %.2243.i, %.0258.i39
  br i1 %i.ki, label %bb.ac, label %ZSTD_count.exit.thread

bb.ac:                                            ; preds = %ZSTD_count.exit
  %i.kj = sub i32 %i.iv, %i.ix
  %i.kk = zext i32 %i.kj to i64
  store i64 %i.kk, ptr %3, align 8, !tbaa !46
  %i.kl = getelementptr inbounds nuw i8, ptr %1, i64 %.2243.i
  %i.km = icmp eq ptr %i.kl, %2
  br i1 %i.km, label %ZSTD_RowFindBestMatch.exit, label %ZSTD_count.exit.thread

ZSTD_count.exit.thread:                           ; preds = %bb.aa, %bb.n, %bb.ac, %ZSTD_count.exit
  %.2260.i.ph = phi i64 [ %.2243.i, %bb.ac ], [ %.0258.i39, %ZSTD_count.exit ], [ %.0258.i39, %bb.n ], [ %.0258.i39, %bb.aa ] ; 2 uses
  %i.kn = add nuw i64 %.0248.i40, 1               ; 2 uses
  %exitcond61.not = icmp eq i64 %i.kn, %.0249.i.lcssa
  br i1 %exitcond61.not, label %ZSTD_RowFindBestMatch.exit, label %bb.m, !llvm.loop !10

ZSTD_RowFindBestMatch.exit:                       ; preds = %ZSTD_count.exit.thread, %bb.ac, %._crit_edge
  %.3261.i = phi i64 [ 3, %._crit_edge ], [ %.2243.i, %bb.ac ], [ %.2260.i.ph, %ZSTD_count.exit.thread ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #12
  ret i64 %.3261.i
}

; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_extDict_5_4(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
end_hunk_11
begin_hunk_12_@ZSTD_RowFindBestMatch_extDict_5_4:bb.a
  tail call void @llvm.prefetch.p0(ptr %i.df, i32 0, i32 3, i32 1)
  %i.dg = and i64 %i.ci, 7
  %i.dh = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.dg
  store i32 %i.db, ptr %i.dh, align 4, !tbaa !45
  %indvars.iv.next51.prol = add nuw nsw i64 %i.ci, 1
  br label %.prol.loopexit
...
.lr.ph29.new:                                     ; preds = %.prol.loopexit, %.lr.ph29.new
  %indvars.iv50 = phi i64 [ %indvars.iv.next51.1, %.lr.ph29.new ], [ %indvars.iv50.unr, %.prol.loopexit ] ; 4 uses
  %i.dj = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv50
  %.val8 = load i64, ptr %i.dj, align 1, !tbaa !46
  ...
  %i.ds = and i64 %indvars.iv50, 7
  %i.dt = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.ds
  store i32 %i.dn, ptr %i.dt, align 4, !tbaa !45
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1 ; 2 uses
  %i.du = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv.next51
  %.val8.1 = load i64, ptr %i.du, align 1, !tbaa !46
  ...
  %i.ed = and i64 %indvars.iv.next51, 7
  %i.ee = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.ed
  store i32 %i.dy, ptr %i.ee, align 4, !tbaa !45
  %indvars.iv.next51.1 = add nuw nsw i64 %indvars.iv50, 2 ; 2 uses
  %lftr.wideiv.1 = trunc i64 %indvars.iv.next51.1 to i32
  %exitcond53.not.1 = icmp eq i32 %i.cs, %lftr.wideiv.1
  br i1 %exitcond53.not.1, label %ZSTD_row_update_internal.exit.i, label %.lr.ph29.new, !llvm.loop !5
...
bb.g:                                             ; preds = %.lr.ph31, %bb.g
  ...
  %i.fb = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.fa ; 2 uses
  %i.fc = load i32, ptr %i.fb, align 4, !tbaa !45 ; 2 uses
  store i32 %i.eu, ptr %i.fb, align 4, !tbaa !45
  %i.fd = lshr i32 %i.fc, 4
  %i.fe = and i32 %i.fd, 268435440
  %i.ff = zext nneg i32 %i.fe to i64              ; 2 uses
  %i.fg = getelementptr inbounds nuw [4 x i8], ptr %i.eh, i64 %i.ff
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.g, %ZSTD_row_update_internal.exit.i
  ...
  %i.fw = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.fv
  %i.fx = getelementptr inbounds nuw i8, ptr %i.fw, i64 8
  %.val10 = load i64, ptr %i.fx, align 1, !tbaa !46
  ...
  %i.gj = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.gi ; 2 uses
  %i.gk = load i32, ptr %i.gj, align 4, !tbaa !45
  store i32 %i.gd, ptr %i.gj, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit

bb.h:                                             ; preds = %bb.a
  %.val11 = load i64, ptr %1, align 1, !tbaa !46
  ...
  store i32 %i.v, ptr %i.gr, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.h, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.gq, %bb.h ], [ %i.gk, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.gs = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.gt = load i32, ptr %i.gs, align 8, !tbaa !86
  %i.gu = add i32 %i.gt, %.0257.i
  store i32 %i.gu, ptr %i.gs, align 8, !tbaa !86
  ...
  %i.ha = load i8, ptr %i.gz, align 1, !tbaa !53  ; 2 uses
  ...
  %i.hf = load <16 x i8>, ptr %i.gz, align 1, !tbaa !53
...
.lr.ph36.preheader:                               ; preds = %ZSTD_row_getSSEMask.exit
  ...
  %i.hj = tail call i16 @llvm.fshr.i16(i16 %i.hh, i16 %i.hh, i16 %i.hi)
...
._crit_edge:                                      ; preds = %bb.k, %bb.i, %ZSTD_row_getSSEMask.exit
  ...
  %i.ii = add nuw nsw i32 %i.ih, %i.if            ; 2 uses
  %i.ij = trunc nuw nsw i32 %i.ii to i8
  store i8 %i.ij, ptr %i.gz, align 1, !tbaa !53
  %i.ik = zext nneg i32 %i.ii to i64              ; 2 uses
  %i.il = getelementptr inbounds nuw i8, ptr %i.gz, i64 %i.ik
  store i8 %i.hc, ptr %i.il, align 1, !tbaa !53
  %i.im = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 2 uses
  %i.in = load i32, ptr %i.im, align 4, !tbaa !41 ; 2 uses
  %i.io = add i32 %i.in, 1
  store i32 %i.io, ptr %i.im, align 4, !tbaa !41
...
bb.m:                                             ; preds = %bb.l
  ...
  %.val5 = load i32, ptr %i.jd, align 1, !tbaa !45
  %i.je = icmp eq i32 %.val6, %.val5
  br i1 %i.je, label %bb.n, label %ZSTD_count.exit.thread
...
bb.z:                                             ; preds = %bb.l
  ...
  %.val = load i32, ptr %1, align 1, !tbaa !45
  %i.ke = icmp eq i32 %.val4, %.val
  br i1 %i.ke, label %bb.aa, label %ZSTD_count.exit.thread
...
ZSTD_count.exit:                                  ; preds = %bb.y, %.thread63.i, %bb.p, %bb.aa
  ...
  %i.ki = icmp ugt i64 %.2243.i, %.0258.i39
  br i1 %i.ki, label %bb.ab, label %ZSTD_count.exit.thread
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_extDict_5_5(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
end_hunk_12
begin_hunk_13_@ZSTD_RowFindBestMatch_extDict_5_5:bb.a
  br i1 %i.dk, label %ZSTD_row_update_internal.exit.i, label %.lr.ph29.new

.lr.ph29.new:                                     ; preds = %.prol.loopexit, %.lr.ph29.new
  %indvars.iv50 = phi i64 [ %indvars.iv.next51.1, %.lr.ph29.new ], [ %indvars.iv50.unr, %.prol.loopexit ] ; 4 uses
  %i.dl = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv50
  %.val8 = load i64, ptr %i.dl, align 1, !tbaa !46
  ...
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1 ; 2 uses
  %i.dx = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv.next51
  %.val8.1 = load i64, ptr %i.dx, align 1, !tbaa !46
  ...
  %i.eh = and i64 %indvars.iv.next51, 7
  %i.ei = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.eh
  store i32 %i.eb, ptr %i.ei, align 4, !tbaa !45
  %indvars.iv.next51.1 = add nuw nsw i64 %indvars.iv50, 2 ; 2 uses
  %lftr.wideiv.1 = trunc i64 %indvars.iv.next51.1 to i32
  %exitcond53.not.1 = icmp eq i32 %i.ct, %lftr.wideiv.1
  br i1 %exitcond53.not.1, label %ZSTD_row_update_internal.exit.i, label %.lr.ph29.new, !llvm.loop !5
...
bb.g:                                             ; preds = %.lr.ph31, %bb.g
  ...
  %i.es = load i64, ptr %i.aj, align 8, !tbaa !52
  %i.et = getelementptr inbounds nuw i8, ptr %i.em, i64 %indvars.iv54
  %i.eu = getelementptr inbounds nuw i8, ptr %i.et, i64 8
  %.val9 = load i64, ptr %i.eu, align 1, !tbaa !46
  ...
  %i.fg = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.ff ; 2 uses
  %i.fh = load i32, ptr %i.fg, align 4, !tbaa !45 ; 2 uses
  store i32 %i.ey, ptr %i.fg, align 4, !tbaa !45
  %i.fi = lshr i32 %i.fh, 3
  %i.fj = and i32 %i.fi, 536870880
  %i.fk = zext nneg i32 %i.fj to i64              ; 2 uses
  %i.fl = getelementptr inbounds nuw [4 x i8], ptr %i.el, i64 %i.fk
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.g, %ZSTD_row_update_internal.exit.i
  ...
  %i.gb = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.ga
  %i.gc = getelementptr inbounds nuw i8, ptr %i.gb, i64 8
  %.val10 = load i64, ptr %i.gc, align 1, !tbaa !46
  ...
  %i.gp = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.go ; 2 uses
  %i.gq = load i32, ptr %i.gp, align 4, !tbaa !45
  store i32 %i.gi, ptr %i.gp, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit
...
bb.h:                                             ; preds = %bb.a
  ...
  store i32 %i.v, ptr %i.gx, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.h, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.gw, %bb.h ], [ %i.gq, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.gy = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.gz = load i32, ptr %i.gy, align 8, !tbaa !86
  %i.ha = add i32 %i.gz, %.0257.i
  store i32 %i.ha, ptr %i.gy, align 8, !tbaa !86
...
.lr.ph36:                                         ; preds = %.lr.ph36.preheader, %bb.k
  ...
  %i.hz = load i32, ptr %i.hy, align 4, !tbaa !45 ; 4 uses
...
._crit_edge:                                      ; preds = %bb.k, %bb.i, %ZSTD_row_getSSEMask.exit
  ...
  store i8 %i.ir, ptr %i.he, align 1, !tbaa !53
  %i.is = zext nneg i32 %i.iq to i64              ; 2 uses
  %i.it = getelementptr inbounds nuw i8, ptr %i.he, i64 %i.is
  store i8 %i.hg, ptr %i.it, align 1, !tbaa !53
  %i.iu = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 2 uses
  %i.iv = load i32, ptr %i.iu, align 4, !tbaa !41 ; 2 uses
  %i.iw = add i32 %i.iv, 1
  store i32 %i.iw, ptr %i.iu, align 4, !tbaa !41
  %i.ix = getelementptr inbounds nuw [4 x i8], ptr %i.hl, i64 %i.is
  store i32 %i.iv, ptr %i.ix, align 4, !tbaa !45
  %.not46 = icmp eq i64 %.0249.i.lcssa, 0
  br i1 %.not46, label %ZSTD_RowFindBestMatch.exit, label %.lr.ph42
...
bb.l:                                             ; preds = %.lr.ph42, %ZSTD_count.exit.thread
  %.0248.i40 = phi i64 [ 0, %.lr.ph42 ], [ %i.kv, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i39 = phi i64 [ 3, %.lr.ph42 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 6 uses
  %i.je = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i40
  %i.jf = load i32, ptr %i.je, align 4, !tbaa !45 ; 3 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  %.val6 = load i32, ptr %i.jj, align 1, !tbaa !45
  %i.jk = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i39
  %i.jl = getelementptr inbounds i8, ptr %i.jk, i64 -3
  %.val5 = load i32, ptr %i.jl, align 1, !tbaa !45
  %i.jm = icmp eq i32 %.val6, %.val5
  br i1 %i.jm, label %bb.n, label %ZSTD_count.exit.thread

bb.n:                                             ; preds = %bb.m
  br i1 %i.iz, label %bb.o, label %.loopexit.i

bb.o:                                             ; preds = %bb.n
  %.val60.i = load i64, ptr %i.jh, align 1, !tbaa !46 ; 2 uses
  %.val.i = load i64, ptr %1, align 1, !tbaa !46  ; 2 uses
  %.not.i13 = icmp eq i64 %.val60.i, %.val.i
  br i1 %.not.i13, label %.preheader.i, label %bb.p
...
bb.x:                                             ; preds = %bb.w
  %i.kg = load i8, ptr %.4.i, align 1, !tbaa !53
  %i.kh = load i8, ptr %.453.i, align 1, !tbaa !53
...
bb.z:                                             ; preds = %bb.l
  ...
  %.val4 = load i32, ptr %i.kl, align 1, !tbaa !45
  %.val = load i32, ptr %1, align 1, !tbaa !45
  %i.km = icmp eq i32 %.val4, %.val
  br i1 %i.km, label %bb.aa, label %ZSTD_count.exit.thread

bb.aa:                                            ; preds = %bb.z
  %i.kn = getelementptr inbounds nuw i8, ptr %i.kl, i64 4
  %i.ko = tail call fastcc i64 @ZSTD_count_2segments(ptr noundef nonnull %i.jc, ptr noundef nonnull %i.kn, ptr noundef %2, ptr noundef nonnull %i.r, ptr noundef nonnull %i.q)
  %i.kp = add i64 %i.ko, 4
  br label %ZSTD_count.exit
...
ZSTD_count.exit:                                  ; preds = %bb.y, %.thread63.i, %bb.p, %bb.aa
  ...
  br i1 %i.kq, label %bb.ab, label %ZSTD_count.exit.thread

bb.ab:                                            ; preds = %ZSTD_count.exit
  %i.kr = sub i32 %i.jd, %i.jf
  %i.ks = zext i32 %i.kr to i64
  store i64 %i.ks, ptr %3, align 8, !tbaa !46
  %i.kt = getelementptr inbounds nuw i8, ptr %1, i64 %.2243.i
  %i.ku = icmp eq ptr %i.kt, %2
  br i1 %i.ku, label %ZSTD_RowFindBestMatch.exit, label %ZSTD_count.exit.thread
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_extDict_5_6(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
end_hunk_13
begin_hunk_14_@ZSTD_RowFindBestMatch_extDict_5_6:bb.a
bb.g:                                             ; preds = %.lr.ph29, %bb.g
  %indvars.iv50 = phi i64 [ %i.ck, %.lr.ph29 ], [ %indvars.iv.next51, %bb.g ] ; 3 uses
  %i.cz = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv50
  %.val8 = load i64, ptr %i.cz, align 1, !tbaa !46
  %i.da = mul i64 %.val8, -3523014627271114752
  %i.db = xor i64 %i.da, %i.cw
  %i.dc = lshr i64 %i.db, %i.cy                   ; 2 uses
  %i.dd = trunc i64 %i.dc to i32
  %i.de = lshr i64 %i.dc, 2
  %i.df = and i64 %i.de, 1073741760               ; 2 uses
  %i.dg = getelementptr inbounds nuw [4 x i8], ptr %i.ch, i64 %i.df ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.dg, i32 0, i32 3, i32 1)
  %i.dh = getelementptr inbounds nuw i8, ptr %i.dg, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.dh, i32 0, i32 3, i32 1)
  ...
  %i.dk = and i64 %indvars.iv50, 7
  %i.dl = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.dk
  store i32 %i.dd, ptr %i.dl, align 4, !tbaa !45
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1 ; 2 uses
  %lftr.wideiv = trunc i64 %indvars.iv.next51 to i32
  %exitcond53.not = icmp eq i32 %i.cu, %lftr.wideiv
  br i1 %exitcond53.not, label %ZSTD_row_update_internal.exit.i, label %bb.g, !llvm.loop !5
...
.lr.ph31:                                         ; preds = %ZSTD_row_update_internal.exit.i
  %i.dr = sub i32 56, %i.dm
  %i.ds = zext nneg i32 %i.dr to i64
  %i.dt = zext i32 %.0.i284.i to i64
  %i.du = and i64 %i.u, 4294967295
  br label %bb.h

bb.h:                                             ; preds = %.lr.ph31, %bb.h
  %indvars.iv54 = phi i64 [ %i.dt, %.lr.ph31 ], [ %indvars.iv.next55, %bb.h ] ; 4 uses
  %i.dv = load i64, ptr %i.aj, align 8, !tbaa !52
  %i.dw = getelementptr inbounds nuw i8, ptr %i.dp, i64 %indvars.iv54
  %i.dx = getelementptr inbounds nuw i8, ptr %i.dw, i64 8
  %.val9 = load i64, ptr %i.dx, align 1, !tbaa !46
  %i.dy = mul i64 %.val9, -3523014627271114752
  %i.dz = xor i64 %i.dy, %i.dv
  %i.ea = lshr i64 %i.dz, %i.ds                   ; 2 uses
  %i.eb = trunc i64 %i.ea to i32
  %i.ec = lshr i64 %i.ea, 2
  %i.ed = and i64 %i.ec, 1073741760               ; 2 uses
  %i.ee = getelementptr inbounds nuw [4 x i8], ptr %i.do, i64 %i.ed ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.ee, i32 0, i32 3, i32 1)
  %i.ef = getelementptr inbounds nuw i8, ptr %i.ee, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.ef, i32 0, i32 3, i32 1)
  ...
  %i.ek = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.ej ; 2 uses
  %i.el = load i32, ptr %i.ek, align 4, !tbaa !45 ; 2 uses
  store i32 %i.eb, ptr %i.ek, align 4, !tbaa !45
  %i.em = lshr i32 %i.el, 2
  %i.en = and i32 %i.em, 1073741760
  %i.eo = zext nneg i32 %i.en to i64              ; 2 uses
  %i.ep = getelementptr inbounds nuw [4 x i8], ptr %i.do, i64 %i.eo
  ...
  store i32 %i.ei, ptr %i.fc, align 4, !tbaa !45
  %indvars.iv.next55 = add nuw nsw i64 %indvars.iv54, 1 ; 2 uses
  %i.fd = icmp samesign ult i64 %indvars.iv.next55, %i.du
  br i1 %i.fd, label %bb.h, label %ZSTD_row_update_internalImpl.exit287.i, !llvm.loop !0
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.h, %ZSTD_row_update_internal.exit.i
  ...
  %i.ff = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.fe
  %i.fg = getelementptr inbounds nuw i8, ptr %i.ff, i64 8
  %.val10 = load i64, ptr %i.fg, align 1, !tbaa !46
  %i.fh = mul i64 %.val10, -3523014627271114752
  %i.fi = xor i64 %i.fh, %i.ak
  %i.fj = sub i32 56, %i.h
  %i.fk = zext nneg i32 %i.fj to i64
  %i.fl = lshr i64 %i.fi, %i.fk                   ; 2 uses
  %i.fm = trunc i64 %i.fl to i32
  %i.fn = lshr i64 %i.fl, 2
  %i.fo = and i64 %i.fn, 1073741760               ; 2 uses
  %i.fp = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.fo ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.fp, i32 0, i32 3, i32 1)
  %i.fq = getelementptr inbounds nuw i8, ptr %i.fp, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.fq, i32 0, i32 3, i32 1)
  ...
  %i.fu = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.ft ; 2 uses
  %i.fv = load i32, ptr %i.fu, align 4, !tbaa !45
  store i32 %i.fm, ptr %i.fu, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit

bb.i:                                             ; preds = %bb.a
  %.val11 = load i64, ptr %1, align 1, !tbaa !46
  %i.fw = mul i64 %.val11, -3523014627271114752
  %i.fx = xor i64 %i.fw, %i.ak
  %i.fy = sub i32 56, %i.h
  %i.fz = zext nneg i32 %i.fy to i64
  %i.ga = lshr i64 %i.fx, %i.fz
  %i.gb = trunc i64 %i.ga to i32
  %i.gc = getelementptr inbounds nuw i8, ptr %0, i64 44
  store i32 %i.v, ptr %i.gc, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.i, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.gb, %bb.i ], [ %i.fv, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.gd = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.ge = load i32, ptr %i.gd, align 8, !tbaa !86
  %i.gf = add i32 %i.ge, %.0257.i
  store i32 %i.gf, ptr %i.gd, align 8, !tbaa !86
  %i.gg = lshr i32 %.0257.i, 2
  %i.gh = and i32 %i.gg, 1073741760
  %i.gi = zext nneg i32 %i.gh to i64              ; 2 uses
  %i.gj = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.gi ; 7 uses
  %i.gk = load i8, ptr %i.gj, align 1, !tbaa !53  ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #12
  %i.gl = trunc i32 %.0257.i to i8                ; 2 uses
  %i.gm = insertelement <16 x i8> poison, i8 %i.gl, i64 0
  %i.gn = shufflevector <16 x i8> %i.gm, <16 x i8> poison, <16 x i32> zeroinitializer ; 4 uses
  %i.go = load <16 x i8>, ptr %i.gj, align 1, !tbaa !53
  %i.gp = icmp eq <16 x i8> %i.go, %i.gn
  %i.gq = bitcast <16 x i1> %i.gp to i16
  %i.gr = getelementptr inbounds nuw i8, ptr %i.gj, i64 16
  %i.gs = load <16 x i8>, ptr %i.gr, align 1, !tbaa !53
  %i.gt = icmp eq <16 x i8> %i.gs, %i.gn
  %i.gu = bitcast <16 x i1> %i.gt to i16
  %i.gv = getelementptr inbounds nuw i8, ptr %i.gj, i64 32
  %i.gw = load <16 x i8>, ptr %i.gv, align 1, !tbaa !53
  %i.gx = icmp eq <16 x i8> %i.gw, %i.gn
  %i.gy = bitcast <16 x i1> %i.gx to i16
  %i.gz = getelementptr inbounds nuw i8, ptr %i.gj, i64 48
  %i.ha = load <16 x i8>, ptr %i.gz, align 1, !tbaa !53
  %i.hb = icmp eq <16 x i8> %i.ha, %i.gn
  %i.hc = bitcast <16 x i1> %i.hb to i16
  %i.hd = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.gi ; 2 uses
  %i.he = zext i8 %i.gk to i32                    ; 2 uses
  %i.hf = insertelement <4 x i16> poison, i16 %i.gq, i64 0
  %i.hg = insertelement <4 x i16> %i.hf, i16 %i.gu, i64 1
  %i.hh = insertelement <4 x i16> %i.hg, i16 %i.gy, i64 2
  %i.hi = insertelement <4 x i16> %i.hh, i16 %i.hc, i64 3
  %i.hj = bitcast <4 x i16> %i.hi to i64          ; 3 uses
  %.not = icmp eq i64 %i.hj, 0
  br i1 %.not, label %._crit_edge, label %.lr.ph36.preheader

.lr.ph36.preheader:                               ; preds = %ZSTD_row_getSSEMask.exit
  %i.hk = zext i8 %i.gk to i64
  %i.hl = tail call i64 @llvm.fshr.i64(i64 %i.hj, i64 %i.hj, i64 %i.hk)
  br label %.lr.ph36

.lr.ph36:                                         ; preds = %.lr.ph36.preheader, %bb.l
  %.0247.i35 = phi i64 [ %i.ib, %bb.l ], [ %i.hl, %.lr.ph36.preheader ] ; 3 uses
  %.0249.i34 = phi i64 [ %.1250.i.ph, %bb.l ], [ 0, %.lr.ph36.preheader ] ; 4 uses
  %.0262.i33 = phi i32 [ %.1263.i.ph, %bb.l ], [ %i.al, %.lr.ph36.preheader ] ; 2 uses
  %i.hm = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, 0) %.0247.i35, i1 true)
  %i.hn = trunc nuw nsw i64 %i.hm to i32
  %i.ho = add nuw nsw i32 %i.hn, %i.he
  %i.hp = and i32 %i.ho, 63                       ; 2 uses
  %i.hq = zext nneg i32 %i.hp to i64
  %i.hr = getelementptr inbounds nuw [4 x i8], ptr %i.hd, i64 %i.hq
  %i.hs = load i32, ptr %i.hr, align 4, !tbaa !45 ; 4 uses
  %i.ht = icmp eq i32 %i.hp, 0
  br i1 %i.ht, label %bb.l, label %bb.j

bb.j:                                             ; preds = %.lr.ph36
  %i.hu = icmp ult i32 %i.hs, %i.ag
  br i1 %i.hu, label %._crit_edge, label %bb.k

bb.k:                                             ; preds = %bb.j
  %.not276.i = icmp ult i32 %i.hs, %i.o
  %i.hv = zext i32 %i.hs to i64
  %. = select i1 %.not276.i, ptr %i.m, ptr %i.k
...
bb.l:                                             ; preds = %bb.k, %.lr.ph36
  %.1263.i.ph = phi i32 [ %.0262.i33, %.lr.ph36 ], [ %i.hz, %bb.k ] ; 2 uses
  %.1250.i.ph = phi i64 [ %.0249.i34, %.lr.ph36 ], [ %i.hx, %bb.k ] ; 2 uses
  %i.ia = add i64 %.0247.i35, -1
  %i.ib = and i64 %i.ia, %.0247.i35               ; 2 uses
  %i.ic = icmp ne i64 %i.ib, 0
  %i.id = icmp ne i32 %.1263.i.ph, 0
  %i.ie = select i1 %i.ic, i1 %i.id, i1 false
  br i1 %i.ie, label %.lr.ph36, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %bb.l, %bb.j, %ZSTD_row_getSSEMask.exit
  %.0249.i.lcssa = phi i64 [ 0, %ZSTD_row_getSSEMask.exit ], [ %.0249.i34, %bb.j ], [ %.1250.i.ph, %bb.l ] ; 2 uses
  %i.if = add nuw nsw i32 %i.he, 63
  %i.ig = and i32 %i.if, 63                       ; 2 uses
  %i.ih = icmp eq i32 %i.ig, 0
  %i.ii = select i1 %i.ih, i32 63, i32 0
  %i.ij = add nuw nsw i32 %i.ii, %i.ig            ; 2 uses
  %i.ik = trunc nuw nsw i32 %i.ij to i8
  store i8 %i.ik, ptr %i.gj, align 1, !tbaa !53
  %i.il = zext nneg i32 %i.ij to i64              ; 2 uses
  %i.im = getelementptr inbounds nuw i8, ptr %i.gj, i64 %i.il
  store i8 %i.gl, ptr %i.im, align 1, !tbaa !53
  %i.in = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 2 uses
  %i.io = load i32, ptr %i.in, align 4, !tbaa !41 ; 2 uses
  %i.ip = add i32 %i.io, 1
  store i32 %i.ip, ptr %i.in, align 4, !tbaa !41
  %i.iq = getelementptr inbounds nuw [4 x i8], ptr %i.hd, i64 %i.il
  store i32 %i.io, ptr %i.iq, align 4, !tbaa !45
  %.not46 = icmp eq i64 %.0249.i.lcssa, 0
  br i1 %.not46, label %ZSTD_RowFindBestMatch.exit, label %.lr.ph42
...
.lr.ph42:                                         ; preds = %._crit_edge
  ...
  %i.it = getelementptr inbounds i8, ptr %2, i64 -3
  %i.iu = getelementptr inbounds i8, ptr %2, i64 -1
  %i.iv = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.iw = add i32 %i.v, 3
  br label %bb.m

bb.m:                                             ; preds = %.lr.ph42, %ZSTD_count.exit.thread
  %.0248.i40 = phi i64 [ 0, %.lr.ph42 ], [ %i.ko, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i39 = phi i64 [ 3, %.lr.ph42 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 6 uses
  %i.ix = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i40
  %i.iy = load i32, ptr %i.ix, align 4, !tbaa !45 ; 3 uses
  %.not278.i = icmp ult i32 %i.iy, %i.o
  %i.iz = zext i32 %i.iy to i64                   ; 2 uses
  br i1 %.not278.i, label %bb.aa, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.ja = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.iz ; 4 uses
  %i.jb = getelementptr inbounds nuw i8, ptr %i.ja, i64 %.0258.i39
  %i.jc = getelementptr inbounds i8, ptr %i.jb, i64 -3
  %.val6 = load i32, ptr %i.jc, align 1, !tbaa !45
  %i.jd = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i39
  %i.je = getelementptr inbounds i8, ptr %i.jd, i64 -3
  %.val5 = load i32, ptr %i.je, align 1, !tbaa !45
  %i.jf = icmp eq i32 %.val6, %.val5
  br i1 %i.jf, label %bb.o, label %ZSTD_count.exit.thread

bb.o:                                             ; preds = %bb.n
  br i1 %i.is, label %bb.p, label %.loopexit.i

bb.p:                                             ; preds = %bb.o
  %.val60.i = load i64, ptr %i.ja, align 1, !tbaa !46 ; 2 uses
  %.val.i = load i64, ptr %1, align 1, !tbaa !46  ; 2 uses
  %.not.i13 = icmp eq i64 %.val60.i, %.val.i
  br i1 %.not.i13, label %.preheader.i, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.jg = xor i64 %.val.i, %.val60.i
  %i.jh = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, 0) %i.jg, i1 true)
  %i.ji = lshr i64 %i.jh, 3
  br label %ZSTD_count.exit

.preheader.i:                                     ; preds = %bb.p, %bb.r
  %.pn.i = phi ptr [ %.049.i, %bb.r ], [ %1, %bb.p ]
  %.pn67.i = phi ptr [ %.045.i, %bb.r ], [ %i.ja, %bb.p ]
  %.045.i = getelementptr inbounds nuw i8, ptr %.pn67.i, i64 8 ; 3 uses
  %.049.i = getelementptr inbounds nuw i8, ptr %.pn.i, i64 8 ; 5 uses
  %i.jj = icmp ult ptr %.049.i, %i.ir
  br i1 %i.jj, label %bb.r, label %.loopexit.i
...
.thread63.i:                                      ; preds = %bb.r
  %i.jk = xor i64 %.049.val.i, %.045.val.i
  %i.jl = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, 0) %i.jk, i1 true)
  %i.jm = lshr i64 %i.jl, 3
  %i.jn = getelementptr inbounds nuw i8, ptr %.049.i, i64 %i.jm
  %i.jo = ptrtoint ptr %i.jn to i64
  %i.jp = sub i64 %i.jo, %i.s
  br label %ZSTD_count.exit

.loopexit.i:                                      ; preds = %.preheader.i, %bb.o
  %.251.i = phi ptr [ %1, %bb.o ], [ %.049.i, %.preheader.i ] ; 5 uses
  %.247.i = phi ptr [ %i.ja, %bb.o ], [ %.045.i, %.preheader.i ] ; 4 uses
  %i.jq = icmp ult ptr %.251.i, %i.it
  br i1 %i.jq, label %bb.s, label %bb.u

bb.s:                                             ; preds = %.loopexit.i
  %.247.val.i = load i32, ptr %.247.i, align 1, !tbaa !45
  %.251.val.i = load i32, ptr %.251.i, align 1, !tbaa !45
  %i.jr = icmp eq i32 %.247.val.i, %.251.val.i
  br i1 %i.jr, label %bb.t, label %bb.u

bb.t:                                             ; preds = %bb.s
  %i.js = getelementptr inbounds nuw i8, ptr %.251.i, i64 4
  %i.jt = getelementptr inbounds nuw i8, ptr %.247.i, i64 4
  br label %bb.u

bb.u:                                             ; preds = %bb.t, %bb.s, %.loopexit.i
  %.352.i = phi ptr [ %i.js, %bb.t ], [ %.251.i, %bb.s ], [ %.251.i, %.loopexit.i ] ; 5 uses
  %.348.i = phi ptr [ %i.jt, %bb.t ], [ %.247.i, %bb.s ], [ %.247.i, %.loopexit.i ] ; 4 uses
  %i.ju = icmp ult ptr %.352.i, %i.iu
  br i1 %i.ju, label %bb.v, label %bb.x

bb.v:                                             ; preds = %bb.u
  %.348.val.i = load i16, ptr %.348.i, align 1, !tbaa !60
  %.352.val.i = load i16, ptr %.352.i, align 1, !tbaa !60
  %i.jv = icmp eq i16 %.348.val.i, %.352.val.i
  br i1 %i.jv, label %bb.w, label %bb.x

bb.w:                                             ; preds = %bb.v
  %i.jw = getelementptr inbounds nuw i8, ptr %.352.i, i64 2
  %i.jx = getelementptr inbounds nuw i8, ptr %.348.i, i64 2
  br label %bb.x

bb.x:                                             ; preds = %bb.w, %bb.v, %bb.u
  %.453.i = phi ptr [ %i.jw, %bb.w ], [ %.352.i, %bb.v ], [ %.352.i, %bb.u ] ; 4 uses
  %.4.i = phi ptr [ %i.jx, %bb.w ], [ %.348.i, %bb.v ], [ %.348.i, %bb.u ]
  %i.jy = icmp ult ptr %.453.i, %2
  br i1 %i.jy, label %bb.y, label %bb.z

bb.y:                                             ; preds = %bb.x
  %i.jz = load i8, ptr %.4.i, align 1, !tbaa !53
  %i.ka = load i8, ptr %.453.i, align 1, !tbaa !53
  %i.kb = icmp eq i8 %i.jz, %i.ka
  %spec.select.idx.i = zext i1 %i.kb to i64
  %spec.select.i12 = getelementptr inbounds nuw i8, ptr %.453.i, i64 %spec.select.idx.i
  br label %bb.z

bb.z:                                             ; preds = %bb.y, %bb.x
  %.5.i = phi ptr [ %.453.i, %bb.x ], [ %spec.select.i12, %bb.y ]
  %i.kc = ptrtoint ptr %.5.i to i64
  %i.kd = sub i64 %i.kc, %i.s
  br label %ZSTD_count.exit

bb.aa:                                            ; preds = %bb.m
  %i.ke = getelementptr inbounds nuw i8, ptr %i.m, i64 %i.iz ; 2 uses
  %.val4 = load i32, ptr %i.ke, align 1, !tbaa !45
  %.val = load i32, ptr %1, align 1, !tbaa !45
  %i.kf = icmp eq i32 %.val4, %.val
  br i1 %i.kf, label %bb.ab, label %ZSTD_count.exit.thread

bb.ab:                                            ; preds = %bb.aa
  %i.kg = getelementptr inbounds nuw i8, ptr %i.ke, i64 4
  %i.kh = tail call fastcc i64 @ZSTD_count_2segments(ptr noundef nonnull %i.iv, ptr noundef nonnull %i.kg, ptr noundef %2, ptr noundef nonnull %i.r, ptr noundef nonnull %i.q)
  %i.ki = add i64 %i.kh, 4
  br label %ZSTD_count.exit

ZSTD_count.exit:                                  ; preds = %bb.z, %.thread63.i, %bb.q, %bb.ab
  %.2243.i = phi i64 [ %i.kd, %bb.z ], [ %i.ji, %bb.q ], [ %i.ki, %bb.ab ], [ %i.jp, %.thread63.i ] ; 4 uses
  %i.kj = icmp ugt i64 %.2243.i, %.0258.i39
  br i1 %i.kj, label %bb.ac, label %ZSTD_count.exit.thread

bb.ac:                                            ; preds = %ZSTD_count.exit
  %i.kk = sub i32 %i.iw, %i.iy
  %i.kl = zext i32 %i.kk to i64
  store i64 %i.kl, ptr %3, align 8, !tbaa !46
  %i.km = getelementptr inbounds nuw i8, ptr %1, i64 %.2243.i
  %i.kn = icmp eq ptr %i.km, %2
  br i1 %i.kn, label %ZSTD_RowFindBestMatch.exit, label %ZSTD_count.exit.thread

ZSTD_count.exit.thread:                           ; preds = %bb.aa, %bb.n, %bb.ac, %ZSTD_count.exit
  %.2260.i.ph = phi i64 [ %.2243.i, %bb.ac ], [ %.0258.i39, %ZSTD_count.exit ], [ %.0258.i39, %bb.n ], [ %.0258.i39, %bb.aa ] ; 2 uses
  %i.ko = add nuw i64 %.0248.i40, 1               ; 2 uses
  %exitcond61.not = icmp eq i64 %i.ko, %.0249.i.lcssa
  br i1 %exitcond61.not, label %ZSTD_RowFindBestMatch.exit, label %bb.m, !llvm.loop !10
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_extDict_6_4(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
end_hunk_14
begin_hunk_15_@ZSTD_RowFindBestMatch_extDict_6_4:bb.a
  tail call void @llvm.prefetch.p0(ptr %i.df, i32 0, i32 3, i32 1)
  %i.dg = and i64 %i.ci, 7
  %i.dh = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.dg
  store i32 %i.db, ptr %i.dh, align 4, !tbaa !45
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_extDict_6_5(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
end_hunk_15
begin_hunk_16_@ZSTD_RowFindBestMatch_extDict_6_5:bb.a
  br i1 %i.dk, label %ZSTD_row_update_internal.exit.i, label %.lr.ph29.new
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_extDict_6_6(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
end_hunk_16
begin_hunk_17_@ZSTD_RowFindBestMatch_extDict_6_6:bb.a
bb.g:                                             ; preds = %.lr.ph29, %bb.g
  %indvars.iv50 = phi i64 [ %i.ck, %.lr.ph29 ], [ %indvars.iv.next51, %bb.g ] ; 3 uses
  %i.cz = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv50
  %.val8 = load i64, ptr %i.cz, align 1, !tbaa !46
  %i.da = mul i64 %.val8, -3523014627193847808
  %i.db = xor i64 %i.da, %i.cw
  %i.dc = lshr i64 %i.db, %i.cy                   ; 2 uses
  %i.dd = trunc i64 %i.dc to i32
  %i.de = lshr i64 %i.dc, 2
...
bb.h:                                             ; preds = %.lr.ph31, %bb.h
  ...
  %i.dx = getelementptr inbounds nuw i8, ptr %i.dw, i64 8
  %.val9 = load i64, ptr %i.dx, align 1, !tbaa !46
  %i.dy = mul i64 %.val9, -3523014627193847808
  %i.dz = xor i64 %i.dy, %i.dv
  %i.ea = lshr i64 %i.dz, %i.ds                   ; 2 uses
  %i.eb = trunc i64 %i.ea to i32
  %i.ec = lshr i64 %i.ea, 2
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.h, %ZSTD_row_update_internal.exit.i
  ...
  %i.fg = getelementptr inbounds nuw i8, ptr %i.ff, i64 8
  %.val10 = load i64, ptr %i.fg, align 1, !tbaa !46
  %i.fh = mul i64 %.val10, -3523014627193847808
  %i.fi = xor i64 %i.fh, %i.ak
  %i.fj = sub i32 56, %i.h
  %i.fk = zext nneg i32 %i.fj to i64
  %i.fl = lshr i64 %i.fi, %i.fk                   ; 2 uses
...
bb.i:                                             ; preds = %bb.a
  %.val11 = load i64, ptr %1, align 1, !tbaa !46
  %i.fw = mul i64 %.val11, -3523014627193847808
  %i.fx = xor i64 %i.fw, %i.ak
  %i.fy = sub i32 56, %i.h
  %i.fz = zext nneg i32 %i.fy to i64
  %i.ga = lshr i64 %i.fx, %i.fz
...
bb.a:
  ...
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 128
end_hunk_17
begin_hunk_18_@ZSTD_RowFindBestMatch_dictMatchState_4_4:bb.a
  %i.dr = and i32 %i.dq, 268435440
  %i.ds = zext nneg i32 %i.dr to i64              ; 2 uses
  %i.dt = getelementptr inbounds nuw [4 x i8], ptr %i.cu, i64 %i.ds
  tail call void @llvm.prefetch.p0(ptr %i.dt, i32 0, i32 3, i32 1)
  %i.du = getelementptr inbounds nuw i8, ptr %i.ct, i64 %i.ds
  tail call void @llvm.prefetch.p0(ptr %i.du, i32 0, i32 3, i32 1)
  %i.dv = and i64 %i.cx, 7
  %i.dw = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.dv
  store i32 %i.dp, ptr %i.dw, align 4, !tbaa !45
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.unr-lcssa, %.lr.ph55
  ...
  br i1 %i.dx, label %ZSTD_row_update_internal.exit.i, label %.lr.ph55.new
...
.lr.ph55.new:                                     ; preds = %.prol.loopexit, %.lr.ph55.new
  ...
  %.val13 = load i32, ptr %i.dy, align 1, !tbaa !45
  ...
  %.val13.1 = load i32, ptr %i.ej, align 1, !tbaa !45
  ...
  store i32 %i.em, ptr %i.et, align 4, !tbaa !45
  ...
  br i1 %exitcond100.not.1, label %ZSTD_row_update_internal.exit.i, label %.lr.ph55.new, !llvm.loop !5

ZSTD_row_update_internal.exit.i:                  ; preds = %.prol.loopexit, %.lr.ph55.new, %bb.f, %bb.b
  ...
  %i.ex = load ptr, ptr %i.k, align 8, !tbaa !37
  %i.ey = icmp ult i32 %.0.i284.i, %i.t
  br i1 %i.ey, label %.lr.ph57, label %ZSTD_row_update_internalImpl.exit287.i

.lr.ph57:                                         ; preds = %ZSTD_row_update_internal.exit.i
...
bb.g:                                             ; preds = %.lr.ph57, %bb.g
  ...
  %i.fc = load i64, ptr %i.ah, align 8, !tbaa !52
  ...
  %.val14 = load i32, ptr %i.fe, align 1, !tbaa !45
  ...
  %i.fr = load i32, ptr %i.fq, align 4, !tbaa !45 ; 2 uses
  store i32 %i.fi, ptr %i.fq, align 4, !tbaa !45
  ...
  %i.fx = load i8, ptr %i.fw, align 1, !tbaa !53
  %i.fy = add i8 %i.fx, 15
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.g, %ZSTD_row_update_internal.exit.i
  ...
  %.val15 = load i32, ptr %i.gm, align 1, !tbaa !45
  ...
  store i32 %i.gr, ptr %i.gy, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit
...
bb.h:                                             ; preds = %bb.a
  ...
  store i32 %i.t, ptr %i.he, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.h, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.hd, %bb.h ], [ %i.gz, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.hf = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.hg = load i32, ptr %i.hf, align 8, !tbaa !86
  %i.hh = add i32 %i.hg, %.0257.i
  store i32 %i.hh, ptr %i.hf, align 8, !tbaa !86
  ...
  %i.hn = load i8, ptr %i.hm, align 1, !tbaa !53  ; 2 uses
  ...
  %i.hs = load <16 x i8>, ptr %i.hm, align 1, !tbaa !53
...
.lr.ph62.preheader:                               ; preds = %ZSTD_row_getSSEMask.exit
  %i.hv = zext i8 %i.hn to i16
  %i.hw = tail call i16 @llvm.fshr.i16(i16 %i.hu, i16 %i.hu, i16 %i.hv)
...
.lr.ph62:                                         ; preds = %.lr.ph62.preheader, %bb.k
  ...
  %i.ie = load i32, ptr %i.id, align 4, !tbaa !45 ; 3 uses
...
._crit_edge:                                      ; preds = %bb.k, %bb.i, %ZSTD_row_getSSEMask.exit
  %.0262.i.lcssa = phi i32 [ %i.aj, %ZSTD_row_getSSEMask.exit ], [ %.0262.i59, %bb.i ], [ %.1263.i.ph, %bb.k ] ; 2 uses
  %.0249.i.lcssa = phi i64 [ 0, %ZSTD_row_getSSEMask.exit ], [ %.0249.i60, %bb.i ], [ %.1250.i.ph, %bb.k ] ; 2 uses
...
bb.l:                                             ; preds = %.lr.ph70, %ZSTD_count.exit.thread
  %.0248.i68 = phi i64 [ 0, %.lr.ph70 ], [ %i.ku, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i67 = phi i64 [ 3, %.lr.ph70 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 5 uses
  %i.ji = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i68
  %i.jj = load i32, ptr %i.ji, align 4, !tbaa !45 ; 2 uses
  ...
  %.val8 = load i32, ptr %i.jn, align 1, !tbaa !45
  %i.jo = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i67
  %i.jp = getelementptr inbounds i8, ptr %i.jo, i64 -3
  %.val = load i32, ptr %i.jp, align 1, !tbaa !45
  %i.jq = icmp eq i32 %.val8, %.val
  br i1 %i.jq, label %bb.m, label %ZSTD_count.exit.thread

bb.m:                                             ; preds = %bb.l
  br i1 %i.je, label %bb.n, label %.loopexit.i

bb.n:                                             ; preds = %bb.m
  %.val60.i = load i64, ptr %i.jl, align 1, !tbaa !46 ; 2 uses
  %.val.i = load i64, ptr %1, align 1, !tbaa !46  ; 2 uses
...
bb.w:                                             ; preds = %bb.v
  %i.kk = load i8, ptr %.4.i17, align 1, !tbaa !53
  %i.kl = load i8, ptr %.453.i, align 1, !tbaa !53
...
ZSTD_count.exit:                                  ; preds = %bb.x, %.thread63.i, %bb.o
  ...
  br i1 %i.kp, label %bb.y, label %ZSTD_count.exit.thread
...
bb.y:                                             ; preds = %ZSTD_count.exit
  ...
  %i.ks = getelementptr inbounds nuw i8, ptr %1, i64 %.2243.i
  %i.kt = icmp eq ptr %i.ks, %2
  br i1 %i.kt, label %._crit_edge71, label %ZSTD_count.exit.thread

ZSTD_count.exit.thread:                           ; preds = %bb.l, %bb.y, %ZSTD_count.exit
  %.2260.i.ph = phi i64 [ %.2243.i, %bb.y ], [ %.0258.i67, %ZSTD_count.exit ], [ %.0258.i67, %bb.l ] ; 2 uses
...
._crit_edge71:                                    ; preds = %ZSTD_count.exit.thread, %bb.y, %._crit_edge
  %.3261.i = phi i64 [ 3, %._crit_edge ], [ %.2243.i, %bb.y ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 3 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #12
  %i.kv = getelementptr inbounds nuw i8, ptr %i.al, i64 24
  %i.kw = load i32, ptr %i.kv, align 8, !tbaa !54
  %i.kx = getelementptr inbounds nuw i8, ptr %i.al, i64 8
  %i.ky = load ptr, ptr %i.kx, align 8, !tbaa !37 ; 3 uses
  %i.kz = load ptr, ptr %i.al, align 8, !tbaa !79 ; 2 uses
  ...
  %i.lc = load i8, ptr %i.ay, align 1, !tbaa !53  ; 2 uses
  ...
  %i.lg = load <16 x i8>, ptr %i.ay, align 1, !tbaa !53
  ...
  br i1 %i.ll, label %.lr.ph79.preheader, label %ZSTD_RowFindBestMatch.exit

.lr.ph79.preheader:                               ; preds = %._crit_edge71
  %i.lm = zext i8 %i.lc to i16
  %i.ln = tail call i16 @llvm.fshr.i16(i16 %i.li, i16 %i.li, i16 %i.lm)
...
.lr.ph79:                                         ; preds = %.lr.ph79.preheader, %bb.ab
  ...
  %i.lv = load i32, ptr %i.lu, align 4, !tbaa !45 ; 3 uses
...
._crit_edge80:                                    ; preds = %bb.ab, %bb.z
  ...
  br i1 %.not93, label %ZSTD_RowFindBestMatch.exit, label %.lr.ph87
...
bb.ac:                                            ; preds = %.lr.ph87, %.thread39
  ...
  %i.ml = load i32, ptr %i.mk, align 4, !tbaa !45 ; 2 uses
  %i.mm = zext i32 %i.ml to i64
  %i.mn = getelementptr inbounds nuw i8, ptr %i.ky, i64 %i.mm ; 2 uses
  %.val10 = load i32, ptr %i.mn, align 1, !tbaa !45
  %i.mo = icmp eq i32 %.val10, %.val9
  br i1 %i.mo, label %bb.ad, label %.thread39

bb.ad:                                            ; preds = %bb.ac
  %i.mp = getelementptr inbounds nuw i8, ptr %i.mn, i64 4
  %i.mq = tail call fastcc i64 @ZSTD_count_2segments(ptr noundef nonnull %i.mi, ptr noundef nonnull %i.mp, ptr noundef %2, ptr noundef %i.kz, ptr noundef %i.p)
...
bb.ae:                                            ; preds = %bb.ad
  ...
  store i64 %i.mv, ptr %3, align 8, !tbaa !46
  %i.mw = getelementptr inbounds nuw i8, ptr %1, i64 %i.mr
  %i.mx = icmp eq ptr %i.mw, %2
  br i1 %i.mx, label %ZSTD_RowFindBestMatch.exit, label %.thread39
...
.thread39:                                        ; preds = %bb.ac, %bb.ae, %bb.ad
  ...
  br i1 %exitcond105.not, label %ZSTD_RowFindBestMatch.exit, label %bb.ac, !llvm.loop !13

ZSTD_RowFindBestMatch.exit:                       ; preds = %.thread39, %bb.ae, %._crit_edge71, %._crit_edge80
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_dictMatchState_4_5(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  ...
  %i.i = load i32, ptr %i.h, align 4, !tbaa !51   ; 5 uses
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 256
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !37   ; 10 uses
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.n = load i32, ptr %i.m, align 8, !tbaa !54   ; 2 uses
  ...
  %i.u = load i32, ptr %i.j, align 8, !tbaa !83
  ...
  %i.ai = load i64, ptr %i.ah, align 8, !tbaa !52 ; 2 uses
  %i.aj = shl nuw nsw i32 1, %..i                 ; 2 uses
  %i.ak = getelementptr inbounds nuw i8, ptr %0, i64 248
  %i.al = load ptr, ptr %i.ak, align 8, !tbaa !78 ; 6 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.bf = load i32, ptr %i.be, align 4, !tbaa !41 ; 5 uses
  %i.bg = sub i32 %i.t, %i.bf
  %i.bh = icmp ugt i32 %i.bg, 384
  br i1 %i.bh, label %bb.c, label %ZSTD_row_update_internal.exit.i, !prof !85

bb.c:                                             ; preds = %bb.b
  %i.bi = icmp ult i32 %i.bf, -96
  br i1 %i.bi, label %.lr.ph, label %ZSTD_row_update_internalImpl.exit.i
...
bb.d:                                             ; preds = %.lr.ph, %bb.d
  ...
  %i.cc = load i32, ptr %i.cb, align 4, !tbaa !45 ; 2 uses
  store i32 %i.bs, ptr %i.cb, align 4, !tbaa !45
  ...
  %i.ci = load i8, ptr %i.ch, align 1, !tbaa !53
  %i.cj = add i8 %i.ci, 31
...
.lr.ph55.new:                                     ; preds = %.prol.loopexit, %.lr.ph55.new
  ...
  store i32 %i.ee, ptr %i.em, align 4, !tbaa !45
  %indvars.iv.next98 = add nuw nsw i64 %indvars.iv97, 1 ; 2 uses
  %i.en = getelementptr inbounds nuw i8, ptr %i.l, i64 %indvars.iv.next98
  %.val13.1 = load i32, ptr %i.en, align 1, !tbaa !45
  ...
  store i32 %i.eq, ptr %i.ey, align 4, !tbaa !45
  %indvars.iv.next98.1 = add nuw nsw i64 %indvars.iv97, 2 ; 2 uses
  %lftr.wideiv.1 = trunc i64 %indvars.iv.next98.1 to i32
...
ZSTD_row_update_internal.exit.i:                  ; preds = %.prol.loopexit, %.lr.ph55.new, %bb.f, %bb.b
  ...
  %i.fc = load ptr, ptr %i.k, align 8, !tbaa !37
  %i.fd = icmp ult i32 %.0.i284.i, %i.t
  br i1 %i.fd, label %.lr.ph57, label %ZSTD_row_update_internalImpl.exit287.i
...
bb.g:                                             ; preds = %.lr.ph57, %bb.g
  ...
  %i.fh = load i64, ptr %i.ah, align 8, !tbaa !52
  ...
  %.val14 = load i32, ptr %i.fj, align 1, !tbaa !45
  ...
  %i.fx = load i32, ptr %i.fw, align 4, !tbaa !45 ; 2 uses
  store i32 %i.fn, ptr %i.fw, align 4, !tbaa !45
  ...
  store i8 %i.gk, ptr %i.gc, align 1, !tbaa !53
  %i.gl = trunc i32 %i.fx to i8
  %i.gm = zext nneg i32 %i.gj to i64              ; 2 uses
  %i.gn = getelementptr inbounds nuw i8, ptr %i.gc, i64 %i.gm
  store i8 %i.gl, ptr %i.gn, align 1, !tbaa !53
  %i.go = getelementptr inbounds nuw [4 x i8], ptr %i.gb, i64 %i.gm
  store i32 %i.fu, ptr %i.go, align 4, !tbaa !45
  %indvars.iv.next102 = add nuw nsw i64 %indvars.iv101, 1 ; 2 uses
  %i.gp = icmp samesign ult i64 %indvars.iv.next102, %i.fg
  br i1 %i.gp, label %bb.g, label %ZSTD_row_update_internalImpl.exit287.i, !llvm.loop !0

ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.g, %ZSTD_row_update_internal.exit.i
  store i32 %i.t, ptr %i.be, align 4, !tbaa !41
  ...
  %.val15 = load i32, ptr %i.gs, align 1, !tbaa !45
  ...
  %i.hg = load i32, ptr %i.hf, align 4, !tbaa !45
  store i32 %i.gx, ptr %i.hf, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit
...
bb.h:                                             ; preds = %bb.a
  ...
  store i32 %i.t, ptr %i.hl, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.h, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.hk, %bb.h ], [ %i.hg, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.hm = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.hn = load i32, ptr %i.hm, align 8, !tbaa !86
  %i.ho = add i32 %i.hn, %.0257.i
  store i32 %i.ho, ptr %i.hm, align 8, !tbaa !86
...
.lr.ph62:                                         ; preds = %.lr.ph62.preheader, %bb.k
  ...
  %i.in = load i32, ptr %i.im, align 4, !tbaa !45 ; 3 uses
...
._crit_edge:                                      ; preds = %bb.k, %bb.i, %ZSTD_row_getSSEMask.exit
  ...
  store i8 %i.jf, ptr %i.hs, align 1, !tbaa !53
  %i.jg = zext nneg i32 %i.je to i64              ; 2 uses
  %i.jh = getelementptr inbounds nuw i8, ptr %i.hs, i64 %i.jg
  store i8 %i.hu, ptr %i.jh, align 1, !tbaa !53
  %i.ji = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 2 uses
  %i.jj = load i32, ptr %i.ji, align 4, !tbaa !41 ; 2 uses
  %i.jk = add i32 %i.jj, 1
  store i32 %i.jk, ptr %i.ji, align 4, !tbaa !41
  %i.jl = getelementptr inbounds nuw [4 x i8], ptr %i.hz, i64 %i.jg
  store i32 %i.jj, ptr %i.jl, align 4, !tbaa !45
  %.not91 = icmp eq i64 %.0249.i.lcssa, 0
  br i1 %.not91, label %._crit_edge71, label %.lr.ph70
...
bb.l:                                             ; preds = %.lr.ph70, %ZSTD_count.exit.thread
  %.0248.i68 = phi i64 [ 0, %.lr.ph70 ], [ %i.ld, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i67 = phi i64 [ 3, %.lr.ph70 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 5 uses
  %i.jr = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i68
  %i.js = load i32, ptr %i.jr, align 4, !tbaa !45 ; 2 uses
  ...
  %.val8 = load i32, ptr %i.jw, align 1, !tbaa !45
  %i.jx = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i67
  %i.jy = getelementptr inbounds i8, ptr %i.jx, i64 -3
  %.val = load i32, ptr %i.jy, align 1, !tbaa !45
  %i.jz = icmp eq i32 %.val8, %.val
  br i1 %i.jz, label %bb.m, label %ZSTD_count.exit.thread

bb.m:                                             ; preds = %bb.l
  br i1 %i.jn, label %bb.n, label %.loopexit.i

bb.n:                                             ; preds = %bb.m
  %.val60.i = load i64, ptr %i.ju, align 1, !tbaa !46 ; 2 uses
  %.val.i = load i64, ptr %1, align 1, !tbaa !46  ; 2 uses
  %.not.i20 = icmp eq i64 %.val60.i, %.val.i
  br i1 %.not.i20, label %.preheader.i, label %bb.o
...
bb.w:                                             ; preds = %bb.v
  %i.kt = load i8, ptr %.4.i17, align 1, !tbaa !53
  %i.ku = load i8, ptr %.453.i, align 1, !tbaa !53
...
ZSTD_count.exit:                                  ; preds = %bb.x, %.thread63.i, %bb.o
  ...
  br i1 %i.ky, label %bb.y, label %ZSTD_count.exit.thread

bb.y:                                             ; preds = %ZSTD_count.exit
  %i.kz = sub i32 %i.jq, %i.js
  %i.la = zext i32 %i.kz to i64
  store i64 %i.la, ptr %3, align 8, !tbaa !46
  %i.lb = getelementptr inbounds nuw i8, ptr %1, i64 %.2243.i
  %i.lc = icmp eq ptr %i.lb, %2
  br i1 %i.lc, label %._crit_edge71, label %ZSTD_count.exit.thread
...
._crit_edge71:                                    ; preds = %ZSTD_count.exit.thread, %bb.y, %._crit_edge
  ...
  %i.lf = load i32, ptr %i.le, align 8, !tbaa !54
  %i.lg = getelementptr inbounds nuw i8, ptr %i.al, i64 8
  %i.lh = load ptr, ptr %i.lg, align 8, !tbaa !37 ; 3 uses
  %i.li = load ptr, ptr %i.al, align 8, !tbaa !79 ; 2 uses
  %i.lj = load i8, ptr %i.ay, align 1, !tbaa !53
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #12
  %i.lk = insertelement <16 x i8> poison, i8 %i.bb, i64 0
  %i.ll = load <16 x i8>, ptr %i.ay, align 1, !tbaa !53
  %i.lm = getelementptr inbounds nuw i8, ptr %i.ay, i64 16
  %i.ln = load <16 x i8>, ptr %i.lm, align 1, !tbaa !53
  ...
  br i1 %i.lx, label %.lr.ph79.preheader, label %ZSTD_RowFindBestMatch.exit
...
bb.ac:                                            ; preds = %.lr.ph87, %.thread39
  ...
  %i.mw = load i32, ptr %i.mv, align 4, !tbaa !45 ; 2 uses
  %i.mx = zext i32 %i.mw to i64
  %i.my = getelementptr inbounds nuw i8, ptr %i.lh, i64 %i.mx ; 2 uses
  %.val10 = load i32, ptr %i.my, align 1, !tbaa !45
  %i.mz = icmp eq i32 %.val10, %.val9
  br i1 %i.mz, label %bb.ad, label %.thread39

bb.ad:                                            ; preds = %bb.ac
  %i.na = getelementptr inbounds nuw i8, ptr %i.my, i64 4
  %i.nb = tail call fastcc i64 @ZSTD_count_2segments(ptr noundef nonnull %i.mt, ptr noundef nonnull %i.na, ptr noundef %2, ptr noundef %i.li, ptr noundef %i.p)
...
bb.ae:                                            ; preds = %bb.ad
  ...
  store i64 %i.ng, ptr %3, align 8, !tbaa !46
  %i.nh = getelementptr inbounds nuw i8, ptr %1, i64 %i.nc
  %i.ni = icmp eq ptr %i.nh, %2
  br i1 %i.ni, label %ZSTD_RowFindBestMatch.exit, label %.thread39
...
.thread39:                                        ; preds = %bb.ac, %bb.ae, %bb.ad
  ...
  br i1 %exitcond111.not, label %ZSTD_RowFindBestMatch.exit, label %bb.ac, !llvm.loop !13
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_dictMatchState_4_6(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = alloca [64 x i32], align 16              ; 4 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
  ...
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 256
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !37   ; 8 uses
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.n = load i32, ptr %i.m, align 8, !tbaa !54   ; 2 uses
  %i.o = zext i32 %i.n to i64
  %i.p = getelementptr inbounds nuw i8, ptr %i.l, i64 %i.o
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.bg = load i32, ptr %i.bf, align 4, !tbaa !41 ; 5 uses
  %i.bh = sub i32 %i.t, %i.bg
  %i.bi = icmp ugt i32 %i.bh, 384
  br i1 %i.bi, label %bb.c, label %ZSTD_row_update_internal.exit.i, !prof !85

bb.c:                                             ; preds = %bb.b
  %i.bj = icmp ult i32 %i.bg, -96
  br i1 %i.bj, label %.lr.ph, label %ZSTD_row_update_internalImpl.exit.i
...
bb.d:                                             ; preds = %.lr.ph, %bb.d
  ...
  %i.ce = load i32, ptr %i.cd, align 4, !tbaa !45 ; 2 uses
  store i32 %i.bt, ptr %i.cd, align 4, !tbaa !45
  ...
  %i.ck = load i8, ptr %i.cj, align 1, !tbaa !53
  %i.cl = add i8 %i.ck, 63
  ...
  store i8 %i.cr, ptr %i.cj, align 1, !tbaa !53
  %i.cs = trunc i32 %i.ce to i8
  %i.ct = zext nneg i32 %i.cq to i64              ; 2 uses
  %i.cu = getelementptr inbounds nuw i8, ptr %i.cj, i64 %i.ct
  store i8 %i.cs, ptr %i.cu, align 1, !tbaa !53
  %i.cv = getelementptr inbounds nuw [4 x i8], ptr %i.ci, i64 %i.ct
  store i32 %i.cb, ptr %i.cv, align 4, !tbaa !45
end_hunk_19
begin_hunk_20_@ZSTD_RowFindBestMatch_dictMatchState_4_6:bb.a
  %i.dn = load i64, ptr %i.ah, align 8, !tbaa !52
  %i.do = trunc i64 %i.dn to i32
  %i.dp = sub i32 24, %i.cw
  br label %bb.g

bb.g:                                             ; preds = %.lr.ph55, %bb.g
  %indvars.iv97 = phi i64 [ %i.db, %.lr.ph55 ], [ %indvars.iv.next98, %bb.g ] ; 3 uses
  %i.dq = getelementptr inbounds nuw i8, ptr %i.l, i64 %indvars.iv97
  %.val13 = load i32, ptr %i.dq, align 1, !tbaa !45
  %i.dr = mul i32 %.val13, -1640531535
  %i.ds = xor i32 %i.dr, %i.do
  %i.dt = lshr i32 %i.ds, %i.dp                   ; 2 uses
  %i.du = lshr i32 %i.dt, 2
  %i.dv = and i32 %i.du, 1073741760
  %i.dw = zext nneg i32 %i.dv to i64              ; 2 uses
  %i.dx = getelementptr inbounds nuw [4 x i8], ptr %i.cy, i64 %i.dw ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.dx, i32 0, i32 3, i32 1)
  %i.dy = getelementptr inbounds nuw i8, ptr %i.dx, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.dy, i32 0, i32 3, i32 1)
  %i.dz = getelementptr inbounds nuw i8, ptr %i.cx, i64 %i.dw ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.dz, i32 0, i32 3, i32 1)
  %i.ea = getelementptr inbounds nuw i8, ptr %i.dz, i64 32
  tail call void @llvm.prefetch.p0(ptr nonnull %i.ea, i32 0, i32 3, i32 1)
  %i.eb = and i64 %indvars.iv97, 7
  %i.ec = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.eb
  store i32 %i.dt, ptr %i.ec, align 4, !tbaa !45
  %indvars.iv.next98 = add nuw nsw i64 %indvars.iv97, 1 ; 2 uses
  %lftr.wideiv = trunc i64 %indvars.iv.next98 to i32
  %exitcond100.not = icmp eq i32 %i.dl, %lftr.wideiv
  br i1 %exitcond100.not, label %ZSTD_row_update_internal.exit.i, label %bb.g, !llvm.loop !5

ZSTD_row_update_internal.exit.i:                  ; preds = %bb.g, %bb.f, %bb.b
  %i.ed = phi i32 [ %i.i, %bb.b ], [ %i.cw, %bb.f ], [ %i.cw, %bb.g ]
  %i.ee = phi ptr [ %i.f, %bb.b ], [ %i.cx, %bb.f ], [ %i.cx, %bb.g ] ; 2 uses
  %i.ef = phi ptr [ %i.d, %bb.b ], [ %i.cy, %bb.f ], [ %i.cy, %bb.g ] ; 2 uses
  %.0.i284.i = phi i32 [ %i.bg, %bb.b ], [ %i.cz, %bb.f ], [ %i.cz, %bb.g ] ; 2 uses
  %i.eg = load ptr, ptr %i.k, align 8, !tbaa !37
  %i.eh = icmp ult i32 %.0.i284.i, %i.t
  br i1 %i.eh, label %.lr.ph57, label %ZSTD_row_update_internalImpl.exit287.i

.lr.ph57:                                         ; preds = %ZSTD_row_update_internal.exit.i
  %i.ei = sub i32 24, %i.ed
  %i.ej = zext i32 %.0.i284.i to i64
  %i.ek = and i64 %i.s, 4294967295
  br label %bb.h

bb.h:                                             ; preds = %.lr.ph57, %bb.h
  %indvars.iv101 = phi i64 [ %i.ej, %.lr.ph57 ], [ %indvars.iv.next102, %bb.h ] ; 4 uses
  %i.el = load i64, ptr %i.ah, align 8, !tbaa !52
  %i.em = getelementptr inbounds nuw i8, ptr %i.eg, i64 %indvars.iv101
  %i.en = getelementptr inbounds nuw i8, ptr %i.em, i64 8
  %i.eo = trunc i64 %i.el to i32
  %.val14 = load i32, ptr %i.en, align 1, !tbaa !45
  %i.ep = mul i32 %.val14, -1640531535
  %i.eq = xor i32 %i.ep, %i.eo
  %i.er = lshr i32 %i.eq, %i.ei                   ; 2 uses
  %i.es = lshr i32 %i.er, 2
  %i.et = and i32 %i.es, 1073741760
  %i.eu = zext nneg i32 %i.et to i64              ; 2 uses
  %i.ev = getelementptr inbounds nuw [4 x i8], ptr %i.ef, i64 %i.eu ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.ev, i32 0, i32 3, i32 1)
  %i.ew = getelementptr inbounds nuw i8, ptr %i.ev, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.ew, i32 0, i32 3, i32 1)
  %i.ex = getelementptr inbounds nuw i8, ptr %i.ee, i64 %i.eu ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.ex, i32 0, i32 3, i32 1)
  %i.ey = getelementptr inbounds nuw i8, ptr %i.ex, i64 32
  tail call void @llvm.prefetch.p0(ptr nonnull %i.ey, i32 0, i32 3, i32 1)
  %i.ez = trunc nuw i64 %indvars.iv101 to i32
  %i.fa = and i64 %indvars.iv101, 7
  %i.fb = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.fa ; 2 uses
  %i.fc = load i32, ptr %i.fb, align 4, !tbaa !45 ; 2 uses
  store i32 %i.er, ptr %i.fb, align 4, !tbaa !45
  %i.fd = lshr i32 %i.fc, 2
  %i.fe = and i32 %i.fd, 1073741760
  %i.ff = zext nneg i32 %i.fe to i64              ; 2 uses
  %i.fg = getelementptr inbounds nuw [4 x i8], ptr %i.ef, i64 %i.ff
  %i.fh = getelementptr inbounds nuw i8, ptr %i.ee, i64 %i.ff ; 3 uses
  %i.fi = load i8, ptr %i.fh, align 1, !tbaa !53
  %i.fj = add i8 %i.fi, 63
  %i.fk = and i8 %i.fj, 63                        ; 2 uses
  %i.fl = zext nneg i8 %i.fk to i32
  %i.fm = icmp eq i8 %i.fk, 0
  %i.fn = select i1 %i.fm, i32 63, i32 0
  %i.fo = add nuw nsw i32 %i.fn, %i.fl            ; 2 uses
  %i.fp = trunc nuw nsw i32 %i.fo to i8
  store i8 %i.fp, ptr %i.fh, align 1, !tbaa !53
  %i.fq = trunc i32 %i.fc to i8
  ...
  store i32 %i.ez, ptr %i.ft, align 4, !tbaa !45
  %indvars.iv.next102 = add nuw nsw i64 %indvars.iv101, 1 ; 2 uses
  %i.fu = icmp samesign ult i64 %indvars.iv.next102, %i.ek
  br i1 %i.fu, label %bb.h, label %ZSTD_row_update_internalImpl.exit287.i, !llvm.loop !0

ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.h, %ZSTD_row_update_internal.exit.i
  store i32 %i.t, ptr %i.bf, align 4, !tbaa !41
  %i.fv = and i64 %i.s, 4294967295
  %i.fw = getelementptr inbounds nuw i8, ptr %i.l, i64 %i.fv
  %i.fx = getelementptr inbounds nuw i8, ptr %i.fw, i64 8
  %i.fy = trunc i64 %i.ai to i32
  %.val15 = load i32, ptr %i.fx, align 1, !tbaa !45
  %i.fz = mul i32 %.val15, -1640531535
  %i.ga = xor i32 %i.fz, %i.fy
  %i.gb = sub i32 24, %i.i
  %i.gc = lshr i32 %i.ga, %i.gb                   ; 2 uses
  %i.gd = lshr i32 %i.gc, 2
  %i.ge = and i32 %i.gd, 1073741760
  %i.gf = zext nneg i32 %i.ge to i64              ; 2 uses
  %i.gg = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %i.gf ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.gg, i32 0, i32 3, i32 1)
  %i.gh = getelementptr inbounds nuw i8, ptr %i.gg, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.gh, i32 0, i32 3, i32 1)
  %i.gi = getelementptr inbounds nuw i8, ptr %i.f, i64 %i.gf ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.gi, i32 0, i32 3, i32 1)
  %i.gj = getelementptr inbounds nuw i8, ptr %i.gi, i64 32
  tail call void @llvm.prefetch.p0(ptr nonnull %i.gj, i32 0, i32 3, i32 1)
  %i.gk = and i64 %i.s, 7
  %i.gl = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.gk ; 2 uses
  %i.gm = load i32, ptr %i.gl, align 4, !tbaa !45
  store i32 %i.gc, ptr %i.gl, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit

bb.i:                                             ; preds = %bb.a
  %i.gn = trunc i64 %i.ai to i32
  %i.go = xor i32 %i.as, %i.gn
  %i.gp = sub i32 24, %i.i
  %i.gq = lshr i32 %i.go, %i.gp
  %i.gr = getelementptr inbounds nuw i8, ptr %0, i64 44
  store i32 %i.t, ptr %i.gr, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.i, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.gq, %bb.i ], [ %i.gm, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.gs = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.gt = load i32, ptr %i.gs, align 8, !tbaa !86
  %i.gu = add i32 %i.gt, %.0257.i
  store i32 %i.gu, ptr %i.gs, align 8, !tbaa !86
  %i.gv = lshr i32 %.0257.i, 2
  %i.gw = and i32 %i.gv, 1073741760
  %i.gx = zext nneg i32 %i.gw to i64              ; 2 uses
  %i.gy = getelementptr inbounds nuw i8, ptr %i.f, i64 %i.gx ; 7 uses
  %i.gz = load i8, ptr %i.gy, align 1, !tbaa !53  ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #12
  %i.ha = trunc i32 %.0257.i to i8                ; 2 uses
  %i.hb = insertelement <16 x i8> poison, i8 %i.ha, i64 0
  %i.hc = shufflevector <16 x i8> %i.hb, <16 x i8> poison, <16 x i32> zeroinitializer ; 4 uses
  %i.hd = load <16 x i8>, ptr %i.gy, align 1, !tbaa !53
  %i.he = icmp eq <16 x i8> %i.hd, %i.hc
  %i.hf = bitcast <16 x i1> %i.he to i16
  %i.hg = getelementptr inbounds nuw i8, ptr %i.gy, i64 16
  %i.hh = load <16 x i8>, ptr %i.hg, align 1, !tbaa !53
  %i.hi = icmp eq <16 x i8> %i.hh, %i.hc
  %i.hj = bitcast <16 x i1> %i.hi to i16
  %i.hk = getelementptr inbounds nuw i8, ptr %i.gy, i64 32
  %i.hl = load <16 x i8>, ptr %i.hk, align 1, !tbaa !53
  %i.hm = icmp eq <16 x i8> %i.hl, %i.hc
  %i.hn = bitcast <16 x i1> %i.hm to i16
  %i.ho = getelementptr inbounds nuw i8, ptr %i.gy, i64 48
  %i.hp = load <16 x i8>, ptr %i.ho, align 1, !tbaa !53
  %i.hq = icmp eq <16 x i8> %i.hp, %i.hc
  %i.hr = bitcast <16 x i1> %i.hq to i16
  %i.hs = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %i.gx ; 2 uses
  %i.ht = zext i8 %i.gz to i32                    ; 2 uses
  %i.hu = insertelement <4 x i16> poison, i16 %i.hf, i64 0
  %i.hv = insertelement <4 x i16> %i.hu, i16 %i.hj, i64 1
  %i.hw = insertelement <4 x i16> %i.hv, i16 %i.hn, i64 2
  %i.hx = insertelement <4 x i16> %i.hw, i16 %i.hr, i64 3
  %i.hy = bitcast <4 x i16> %i.hx to i64          ; 3 uses
  %.not = icmp eq i64 %i.hy, 0
  br i1 %.not, label %._crit_edge, label %.lr.ph62.preheader

.lr.ph62.preheader:                               ; preds = %ZSTD_row_getSSEMask.exit
  %i.hz = zext i8 %i.gz to i64
  %i.ia = tail call i64 @llvm.fshr.i64(i64 %i.hy, i64 %i.hy, i64 %i.hz)
  br label %.lr.ph62

.lr.ph62:                                         ; preds = %.lr.ph62.preheader, %bb.l
  %.0247.i61 = phi i64 [ %i.iq, %bb.l ], [ %i.ia, %.lr.ph62.preheader ] ; 3 uses
  %.0249.i60 = phi i64 [ %.1250.i.ph, %bb.l ], [ 0, %.lr.ph62.preheader ] ; 4 uses
  %.0262.i59 = phi i32 [ %.1263.i.ph, %bb.l ], [ %i.aj, %.lr.ph62.preheader ] ; 3 uses
  %i.ib = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, 0) %.0247.i61, i1 true)
  %i.ic = trunc nuw nsw i64 %i.ib to i32
  %i.id = add nuw nsw i32 %i.ic, %i.ht
  %i.ie = and i32 %i.id, 63                       ; 2 uses
  %i.if = zext nneg i32 %i.ie to i64
  %i.ig = getelementptr inbounds nuw [4 x i8], ptr %i.hs, i64 %i.if
  %i.ih = load i32, ptr %i.ig, align 4, !tbaa !45 ; 3 uses
  %i.ii = icmp eq i32 %i.ie, 0
  br i1 %i.ii, label %bb.l, label %bb.j

bb.j:                                             ; preds = %.lr.ph62
  %i.ij = icmp ult i32 %i.ih, %i.ae
  br i1 %i.ij, label %._crit_edge, label %bb.k
...
bb.l:                                             ; preds = %bb.k, %.lr.ph62
  %.1263.i.ph = phi i32 [ %.0262.i59, %.lr.ph62 ], [ %i.io, %bb.k ] ; 3 uses
  %.1250.i.ph = phi i64 [ %.0249.i60, %.lr.ph62 ], [ %i.im, %bb.k ] ; 2 uses
  %i.ip = add i64 %.0247.i61, -1
  %i.iq = and i64 %i.ip, %.0247.i61               ; 2 uses
  %i.ir = icmp ne i64 %i.iq, 0
  %i.is = icmp ne i32 %.1263.i.ph, 0
  %i.it = select i1 %i.ir, i1 %i.is, i1 false
  br i1 %i.it, label %.lr.ph62, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %bb.l, %bb.j, %ZSTD_row_getSSEMask.exit
  %.0262.i.lcssa = phi i32 [ %i.aj, %ZSTD_row_getSSEMask.exit ], [ %.0262.i59, %bb.j ], [ %.1263.i.ph, %bb.l ] ; 2 uses
  %.0249.i.lcssa = phi i64 [ 0, %ZSTD_row_getSSEMask.exit ], [ %.0249.i60, %bb.j ], [ %.1250.i.ph, %bb.l ] ; 2 uses
  %i.iu = add nuw nsw i32 %i.ht, 63
  %i.iv = and i32 %i.iu, 63                       ; 2 uses
  %i.iw = icmp eq i32 %i.iv, 0
  %i.ix = select i1 %i.iw, i32 63, i32 0
  %i.iy = add nuw nsw i32 %i.ix, %i.iv            ; 2 uses
  %i.iz = trunc nuw nsw i32 %i.iy to i8
  store i8 %i.iz, ptr %i.gy, align 1, !tbaa !53
  %i.ja = zext nneg i32 %i.iy to i64              ; 2 uses
  %i.jb = getelementptr inbounds nuw i8, ptr %i.gy, i64 %i.ja
  store i8 %i.ha, ptr %i.jb, align 1, !tbaa !53
  %i.jc = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 2 uses
  %i.jd = load i32, ptr %i.jc, align 4, !tbaa !41 ; 2 uses
  %i.je = add i32 %i.jd, 1
  store i32 %i.je, ptr %i.jc, align 4, !tbaa !41
  %i.jf = getelementptr inbounds nuw [4 x i8], ptr %i.hs, i64 %i.ja
  store i32 %i.jd, ptr %i.jf, align 4, !tbaa !45
  %.not91 = icmp eq i64 %.0249.i.lcssa, 0
  br i1 %.not91, label %._crit_edge71, label %.lr.ph70
...
bb.m:                                             ; preds = %.lr.ph70, %ZSTD_count.exit.thread
  %.0248.i68 = phi i64 [ 0, %.lr.ph70 ], [ %i.kx, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i67 = phi i64 [ 3, %.lr.ph70 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 5 uses
  %i.jl = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i68
  %i.jm = load i32, ptr %i.jl, align 4, !tbaa !45 ; 2 uses
  %i.jn = zext i32 %i.jm to i64
  %i.jo = getelementptr inbounds nuw i8, ptr %i.l, i64 %i.jn ; 4 uses
  %i.jp = getelementptr inbounds nuw i8, ptr %i.jo, i64 %.0258.i67
  %i.jq = getelementptr inbounds i8, ptr %i.jp, i64 -3
  %.val8 = load i32, ptr %i.jq, align 1, !tbaa !45
  %i.jr = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i67
  %i.js = getelementptr inbounds i8, ptr %i.jr, i64 -3
  %.val = load i32, ptr %i.js, align 1, !tbaa !45
  %i.jt = icmp eq i32 %.val8, %.val
  br i1 %i.jt, label %bb.n, label %ZSTD_count.exit.thread

bb.n:                                             ; preds = %bb.m
  br i1 %i.jh, label %bb.o, label %.loopexit.i

bb.o:                                             ; preds = %bb.n
  %.val60.i = load i64, ptr %i.jo, align 1, !tbaa !46 ; 2 uses
  %.val.i = load i64, ptr %1, align 1, !tbaa !46  ; 2 uses
  %.not.i20 = icmp eq i64 %.val60.i, %.val.i
  br i1 %.not.i20, label %.preheader.i, label %bb.p
...
.preheader.i:                                     ; preds = %bb.o, %bb.q
  %.pn.i = phi ptr [ %.049.i, %bb.q ], [ %1, %bb.o ]
  %.pn67.i = phi ptr [ %.045.i, %bb.q ], [ %i.jo, %bb.o ]
  %.045.i = getelementptr inbounds nuw i8, ptr %.pn67.i, i64 8 ; 3 uses
  %.049.i = getelementptr inbounds nuw i8, ptr %.pn.i, i64 8 ; 5 uses
  %i.jx = icmp ult ptr %.049.i, %i.jg
  br i1 %i.jx, label %bb.q, label %.loopexit.i
...
.thread63.i:                                      ; preds = %bb.q
  ...
  %i.kd = sub i64 %i.kc, %i.q
  br label %ZSTD_count.exit

.loopexit.i:                                      ; preds = %.preheader.i, %bb.n
  %.251.i = phi ptr [ %1, %bb.n ], [ %.049.i, %.preheader.i ] ; 5 uses
  %.247.i = phi ptr [ %i.jo, %bb.n ], [ %.045.i, %.preheader.i ] ; 4 uses
  %i.ke = icmp ult ptr %.251.i, %i.ji
  br i1 %i.ke, label %bb.r, label %bb.t

bb.r:                                             ; preds = %.loopexit.i
  %.247.val.i = load i32, ptr %.247.i, align 1, !tbaa !45
  %.251.val.i = load i32, ptr %.251.i, align 1, !tbaa !45
  %i.kf = icmp eq i32 %.247.val.i, %.251.val.i
  br i1 %i.kf, label %bb.s, label %bb.t
...
bb.t:                                             ; preds = %bb.s, %bb.r, %.loopexit.i
  %.352.i = phi ptr [ %i.kg, %bb.s ], [ %.251.i, %bb.r ], [ %.251.i, %.loopexit.i ] ; 5 uses
  %.348.i = phi ptr [ %i.kh, %bb.s ], [ %.247.i, %bb.r ], [ %.247.i, %.loopexit.i ] ; 4 uses
  %i.ki = icmp ult ptr %.352.i, %i.jj
  br i1 %i.ki, label %bb.u, label %bb.w

bb.u:                                             ; preds = %bb.t
  %.348.val.i = load i16, ptr %.348.i, align 1, !tbaa !60
  %.352.val.i = load i16, ptr %.352.i, align 1, !tbaa !60
  %i.kj = icmp eq i16 %.348.val.i, %.352.val.i
  br i1 %i.kj, label %bb.v, label %bb.w
...
bb.w:                                             ; preds = %bb.v, %bb.u, %bb.t
  %.453.i = phi ptr [ %i.kk, %bb.v ], [ %.352.i, %bb.u ], [ %.352.i, %bb.t ] ; 4 uses
  %.4.i17 = phi ptr [ %i.kl, %bb.v ], [ %.348.i, %bb.u ], [ %.348.i, %bb.t ]
  %i.km = icmp ult ptr %.453.i, %2
  br i1 %i.km, label %bb.x, label %bb.y

bb.x:                                             ; preds = %bb.w
  %i.kn = load i8, ptr %.4.i17, align 1, !tbaa !53
  %i.ko = load i8, ptr %.453.i, align 1, !tbaa !53
...
bb.y:                                             ; preds = %bb.x, %bb.w
  %.5.i = phi ptr [ %.453.i, %bb.w ], [ %spec.select.i19, %bb.x ]
  %i.kq = ptrtoint ptr %.5.i to i64
  %i.kr = sub i64 %i.kq, %i.q
  br label %ZSTD_count.exit

ZSTD_count.exit:                                  ; preds = %bb.y, %.thread63.i, %bb.p
  %.2243.i = phi i64 [ %i.jw, %bb.p ], [ %i.kd, %.thread63.i ], [ %i.kr, %bb.y ] ; 4 uses
  %i.ks = icmp ugt i64 %.2243.i, %.0258.i67
  br i1 %i.ks, label %bb.z, label %ZSTD_count.exit.thread

bb.z:                                             ; preds = %ZSTD_count.exit
  %i.kt = sub i32 %i.jk, %i.jm
  %i.ku = zext i32 %i.kt to i64
  store i64 %i.ku, ptr %3, align 8, !tbaa !46
  %i.kv = getelementptr inbounds nuw i8, ptr %1, i64 %.2243.i
  %i.kw = icmp eq ptr %i.kv, %2
  br i1 %i.kw, label %._crit_edge71, label %ZSTD_count.exit.thread

ZSTD_count.exit.thread:                           ; preds = %bb.m, %bb.z, %ZSTD_count.exit
  %.2260.i.ph = phi i64 [ %.2243.i, %bb.z ], [ %.0258.i67, %ZSTD_count.exit ], [ %.0258.i67, %bb.m ] ; 2 uses
  %i.kx = add nuw i64 %.0248.i68, 1               ; 2 uses
  %exitcond108.not = icmp eq i64 %i.kx, %.0249.i.lcssa
  br i1 %exitcond108.not, label %._crit_edge71, label %bb.m, !llvm.loop !10

._crit_edge71:                                    ; preds = %ZSTD_count.exit.thread, %bb.z, %._crit_edge
  %.3261.i = phi i64 [ 3, %._crit_edge ], [ %.2243.i, %bb.z ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 3 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #12
  %i.ky = getelementptr inbounds nuw i8, ptr %i.al, i64 24
  %i.kz = load i32, ptr %i.ky, align 8, !tbaa !54
  %i.la = getelementptr inbounds nuw i8, ptr %i.al, i64 8
  %i.lb = load ptr, ptr %i.la, align 8, !tbaa !37 ; 3 uses
  %i.lc = load ptr, ptr %i.al, align 8, !tbaa !79 ; 2 uses
  %i.ld = load i8, ptr %i.ay, align 1, !tbaa !53
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #12
  %i.le = insertelement <16 x i8> poison, i8 %i.bc, i64 0
  %i.lf = shufflevector <16 x i8> %i.le, <16 x i8> poison, <16 x i32> zeroinitializer ; 4 uses
  %i.lg = load <16 x i8>, ptr %i.ay, align 1, !tbaa !53
  %i.lh = icmp eq <16 x i8> %i.lg, %i.lf
  %i.li = bitcast <16 x i1> %i.lh to i16
  %i.lj = getelementptr inbounds nuw i8, ptr %i.ay, i64 16
  %i.lk = load <16 x i8>, ptr %i.lj, align 1, !tbaa !53
  %i.ll = icmp eq <16 x i8> %i.lk, %i.lf
  %i.lm = bitcast <16 x i1> %i.ll to i16
  %i.ln = load <16 x i8>, ptr %i.bb, align 1, !tbaa !53
  %i.lo = icmp eq <16 x i8> %i.ln, %i.lf
  %i.lp = bitcast <16 x i1> %i.lo to i16
  %i.lq = getelementptr inbounds nuw i8, ptr %i.ay, i64 48
  %i.lr = load <16 x i8>, ptr %i.lq, align 1, !tbaa !53
  %i.ls = icmp eq <16 x i8> %i.lr, %i.lf
  %i.lt = bitcast <16 x i1> %i.ls to i16
  %i.lu = ptrtoint ptr %i.lc to i64
  %i.lv = ptrtoint ptr %i.lb to i64
  %.neg.i.neg = sub i64 %i.lu, %i.lv
  %.neg279.i.neg92 = trunc i64 %.neg.i.neg to i32
  %i.lw = and i8 %i.ld, 63                        ; 2 uses
  %i.lx = zext nneg i8 %i.lw to i32               ; 2 uses
  %i.ly = insertelement <4 x i16> poison, i16 %i.li, i64 0
  %i.lz = insertelement <4 x i16> %i.ly, i16 %i.lm, i64 1
  %i.ma = insertelement <4 x i16> %i.lz, i16 %i.lp, i64 2
  %i.mb = insertelement <4 x i16> %i.ma, i16 %i.lt, i64 3
  %i.mc = bitcast <4 x i16> %i.mb to i64          ; 2 uses
  %i.md = zext nneg i8 %i.lw to i64
  %i.me = lshr i64 %i.mc, %i.md
  %i.mf = sub nsw i32 0, %i.lx
  %i.mg = and i32 %i.mf, 63
  %i.mh = zext nneg i32 %i.mg to i64
  %i.mi = shl i64 %i.mc, %i.mh
  %i.mj = or i64 %i.mi, %i.me                     ; 2 uses
  %i.mk = icmp ne i64 %i.mj, 0
  %i.ml = icmp ne i32 %.0262.i.lcssa, 0
  %i.mm = select i1 %i.mk, i1 %i.ml, i1 false
  br i1 %i.mm, label %.lr.ph79, label %ZSTD_RowFindBestMatch.exit

.lr.ph79:                                         ; preds = %._crit_edge71, %bb.ac
  %.0238.i78 = phi i64 [ %i.nc, %bb.ac ], [ %i.mj, %._crit_edge71 ] ; 3 uses
  %.0240.i77 = phi i64 [ %.1.i.ph, %bb.ac ], [ 0, %._crit_edge71 ] ; 4 uses
  %.3265.i76 = phi i32 [ %.4266.i.ph, %bb.ac ], [ %.0262.i.lcssa, %._crit_edge71 ] ; 2 uses
  %i.mn = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, 0) %.0238.i78, i1 true)
  %i.mo = trunc nuw nsw i64 %i.mn to i32
  %i.mp = add nuw nsw i32 %i.mo, %i.lx
  %i.mq = and i32 %i.mp, 63                       ; 2 uses
  %i.mr = zext nneg i32 %i.mq to i64
  %i.ms = getelementptr inbounds nuw [4 x i8], ptr %i.az, i64 %i.mr
  %i.mt = load i32, ptr %i.ms, align 4, !tbaa !45 ; 3 uses
  %i.mu = icmp eq i32 %i.mq, 0
  br i1 %i.mu, label %bb.ac, label %bb.aa

bb.aa:                                            ; preds = %.lr.ph79
  %i.mv = icmp ult i32 %i.mt, %i.kz
  br i1 %i.mv, label %._crit_edge80, label %bb.ab
...
bb.ac:                                            ; preds = %bb.ab, %.lr.ph79
  %.4266.i.ph = phi i32 [ %.3265.i76, %.lr.ph79 ], [ %i.na, %bb.ab ] ; 2 uses
  %.1.i.ph = phi i64 [ %.0240.i77, %.lr.ph79 ], [ %i.my, %bb.ab ] ; 2 uses
  %i.nb = add i64 %.0238.i78, -1
  %i.nc = and i64 %i.nb, %.0238.i78               ; 2 uses
  %i.nd = icmp ne i64 %i.nc, 0
  %i.ne = icmp ne i32 %.4266.i.ph, 0
  %i.nf = select i1 %i.nd, i1 %i.ne, i1 false
  br i1 %i.nf, label %.lr.ph79, label %._crit_edge80, !llvm.loop !12

._crit_edge80:                                    ; preds = %bb.ac, %bb.aa
  %.0240.i.lcssa = phi i64 [ %.0240.i77, %bb.aa ], [ %.1.i.ph, %bb.ac ] ; 2 uses
  %.not93 = icmp eq i64 %.0240.i.lcssa, 0
  br i1 %.not93, label %ZSTD_RowFindBestMatch.exit, label %.lr.ph87
...
.lr.ph87:                                         ; preds = %._crit_edge80
  %invariant.op = add i32 %i.t, %.neg279.i.neg92
  %.val9 = load i32, ptr %1, align 1, !tbaa !45
  %i.ng = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.nh = add i32 %invariant.op, 3
  br label %bb.ad

bb.ad:                                            ; preds = %.lr.ph87, %.thread39
  %.0239.i85 = phi i64 [ 0, %.lr.ph87 ], [ %i.nw, %.thread39 ] ; 2 uses
  %.4.i84 = phi i64 [ %.3261.i, %.lr.ph87 ], [ %.6.i.ph, %.thread39 ] ; 3 uses
  %i.ni = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %.0239.i85
  %i.nj = load i32, ptr %i.ni, align 4, !tbaa !45 ; 2 uses
  %i.nk = zext i32 %i.nj to i64
  %i.nl = getelementptr inbounds nuw i8, ptr %i.lb, i64 %i.nk ; 2 uses
  %.val10 = load i32, ptr %i.nl, align 1, !tbaa !45
  %i.nm = icmp eq i32 %.val10, %.val9
  br i1 %i.nm, label %bb.ae, label %.thread39

bb.ae:                                            ; preds = %bb.ad
  %i.nn = getelementptr inbounds nuw i8, ptr %i.nl, i64 4
  %i.no = tail call fastcc i64 @ZSTD_count_2segments(ptr noundef nonnull %i.ng, ptr noundef nonnull %i.nn, ptr noundef %2, ptr noundef %i.lc, ptr noundef %i.p)
  %i.np = add i64 %i.no, 4                        ; 4 uses
  %i.nq = icmp ugt i64 %i.np, %.4.i84
  br i1 %i.nq, label %bb.af, label %.thread39

bb.af:                                            ; preds = %bb.ae
  %i.nr = add i32 %i.n, %i.nj
  %i.ns = sub i32 %i.nh, %i.nr
  %i.nt = zext i32 %i.ns to i64
  store i64 %i.nt, ptr %3, align 8, !tbaa !46
  %i.nu = getelementptr inbounds nuw i8, ptr %1, i64 %i.np
  %i.nv = icmp eq ptr %i.nu, %2
  br i1 %i.nv, label %ZSTD_RowFindBestMatch.exit, label %.thread39

.thread39:                                        ; preds = %bb.ad, %bb.af, %bb.ae
  %.6.i.ph = phi i64 [ %i.np, %bb.af ], [ %.4.i84, %bb.ae ], [ %.4.i84, %bb.ad ] ; 2 uses
  %i.nw = add nuw i64 %.0239.i85, 1               ; 2 uses
  %exitcond113.not = icmp eq i64 %i.nw, %.0240.i.lcssa
  br i1 %exitcond113.not, label %ZSTD_RowFindBestMatch.exit, label %bb.ad, !llvm.loop !13

ZSTD_RowFindBestMatch.exit:                       ; preds = %.thread39, %bb.af, %._crit_edge71, %._crit_edge80
  %.7.i = phi i64 [ %.3261.i, %._crit_edge80 ], [ %.3261.i, %._crit_edge71 ], [ %.6.i.ph, %.thread39 ], [ %i.np, %bb.af ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #12
  ret i64 %.7.i
}

; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_dictMatchState_5_4(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = alloca [64 x i32], align 16              ; 4 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
  ...
  %i.af = getelementptr inbounds nuw i8, ptr %0, i64 268
  %i.ag = load i32, ptr %i.af, align 4, !tbaa !84
  %..i = tail call i32 @llvm.umin.i32(i32 %i.ag, i32 4)
  %i.ah = getelementptr inbounds nuw i8, ptr %0, i64 96 ; 4 uses
  %i.ai = load i64, ptr %i.ah, align 8, !tbaa !52 ; 2 uses
  %i.aj = shl nuw nsw i32 1, %..i                 ; 2 uses
  %i.ak = getelementptr inbounds nuw i8, ptr %0, i64 248
  ...
  %i.ax = and i64 %i.aw, 268435440                ; 2 uses
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ap, i64 %i.ax ; 3 uses
  %i.az = getelementptr inbounds nuw [4 x i8], ptr %i.an, i64 %i.ax ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.az, i32 0, i32 3, i32 1)
  tail call void @llvm.prefetch.p0(ptr %i.ay, i32 0, i32 3, i32 1)
  %i.ba = trunc i64 %i.av to i8
  %i.bb = getelementptr inbounds nuw i8, ptr %0, i64 300
  %i.bc = load i32, ptr %i.bb, align 4, !tbaa !57
  %.not274.i = icmp eq i32 %i.bc, 0
  br i1 %.not274.i, label %bb.b, label %bb.h

bb.b:                                             ; preds = %bb.a
  %i.bd = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 2 uses
  %i.be = load i32, ptr %i.bd, align 4, !tbaa !41 ; 5 uses
  %i.bf = sub i32 %i.t, %i.be
  %i.bg = icmp ugt i32 %i.bf, 384
  br i1 %i.bg, label %bb.c, label %ZSTD_row_update_internal.exit.i, !prof !85

bb.c:                                             ; preds = %bb.b
  %i.bh = icmp ult i32 %i.be, -96
  br i1 %i.bh, label %.lr.ph, label %ZSTD_row_update_internalImpl.exit.i

.lr.ph:                                           ; preds = %bb.c
  %i.bi = add nuw i32 %i.be, 96
  %i.bj = sub i32 56, %i.i
...
bb.d:                                             ; preds = %.lr.ph, %bb.d
  ...
  %i.bn = getelementptr inbounds nuw i8, ptr %i.l, i64 %indvars.iv
  %i.bo = getelementptr inbounds nuw i8, ptr %i.bn, i64 8
  %.val12 = load i64, ptr %i.bo, align 1, !tbaa !46
  %i.bp = mul i64 %.val12, -3523014627271114752
  %i.bq = xor i64 %i.bp, %i.bm
  %i.br = lshr i64 %i.bq, %i.bk                   ; 2 uses
  %i.bs = trunc i64 %i.br to i32
  %i.bt = lshr i64 %i.br, 4
  %i.bu = and i64 %i.bt, 268435440                ; 2 uses
  %i.bv = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %i.bu
  tail call void @llvm.prefetch.p0(ptr %i.bv, i32 0, i32 3, i32 1)
  %i.bw = getelementptr inbounds nuw i8, ptr %i.f, i64 %i.bu
  tail call void @llvm.prefetch.p0(ptr %i.bw, i32 0, i32 3, i32 1)
  ...
  store i32 %i.bs, ptr %i.bz, align 4, !tbaa !45
  %i.cb = lshr i32 %i.ca, 4
  %i.cc = and i32 %i.cb, 268435440
  %i.cd = zext nneg i32 %i.cc to i64              ; 2 uses
  %i.ce = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %i.cd
  %i.cf = getelementptr inbounds nuw i8, ptr %i.f, i64 %i.cd ; 3 uses
  %i.cg = load i8, ptr %i.cf, align 1, !tbaa !53
  %i.ch = add i8 %i.cg, 15
  %i.ci = and i8 %i.ch, 15                        ; 2 uses
  %i.cj = zext nneg i8 %i.ci to i32
  %i.ck = icmp eq i8 %i.ci, 0
  %i.cl = select i1 %i.ck, i32 15, i32 0
...
ZSTD_row_update_internalImpl.exit.i.loopexit:     ; preds = %bb.d
  ...
  %.pre106 = load ptr, ptr %i.e, align 8, !tbaa !50
  %.pre107 = load i32, ptr %i.h, align 4, !tbaa !51
end_hunk_20
begin_hunk_21_@ZSTD_RowFindBestMatch_dictMatchState_5_4:bb.a
  %i.ds = and i64 %i.dr, 268435440                ; 2 uses
  %i.dt = getelementptr inbounds nuw [4 x i8], ptr %i.cu, i64 %i.ds
  tail call void @llvm.prefetch.p0(ptr %i.dt, i32 0, i32 3, i32 1)
  %i.du = getelementptr inbounds nuw i8, ptr %i.ct, i64 %i.ds
  tail call void @llvm.prefetch.p0(ptr %i.du, i32 0, i32 3, i32 1)
  %i.dv = and i64 %i.cx, 7
  %i.dw = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.dv
  store i32 %i.dq, ptr %i.dw, align 4, !tbaa !45
  %indvars.iv.next98.prol = add nuw nsw i64 %i.cx, 1
  br label %.prol.loopexit
...
.lr.ph55.new:                                     ; preds = %.prol.loopexit, %.lr.ph55.new
  %indvars.iv97 = phi i64 [ %indvars.iv.next98.1, %.lr.ph55.new ], [ %indvars.iv97.unr, %.prol.loopexit ] ; 4 uses
  %i.dy = getelementptr inbounds nuw i8, ptr %i.l, i64 %indvars.iv97
  %.val13 = load i64, ptr %i.dy, align 1, !tbaa !46
  ...
  %i.eh = and i64 %indvars.iv97, 7
  %i.ei = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.eh
  store i32 %i.ec, ptr %i.ei, align 4, !tbaa !45
  %indvars.iv.next98 = add nuw nsw i64 %indvars.iv97, 1 ; 2 uses
  %i.ej = getelementptr inbounds nuw i8, ptr %i.l, i64 %indvars.iv.next98
  %.val13.1 = load i64, ptr %i.ej, align 1, !tbaa !46
  ...
  %i.es = and i64 %indvars.iv.next98, 7
  %i.et = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.es
  store i32 %i.en, ptr %i.et, align 4, !tbaa !45
  %indvars.iv.next98.1 = add nuw nsw i64 %indvars.iv97, 2 ; 2 uses
  %lftr.wideiv.1 = trunc i64 %indvars.iv.next98.1 to i32
  %exitcond100.not.1 = icmp eq i32 %i.dh, %lftr.wideiv.1
  br i1 %exitcond100.not.1, label %ZSTD_row_update_internal.exit.i, label %.lr.ph55.new, !llvm.loop !5
...
bb.g:                                             ; preds = %.lr.ph57, %bb.g
  ...
  %i.fd = load i64, ptr %i.ah, align 8, !tbaa !52
  %i.fe = getelementptr inbounds nuw i8, ptr %i.ex, i64 %indvars.iv101
  %i.ff = getelementptr inbounds nuw i8, ptr %i.fe, i64 8
  %.val14 = load i64, ptr %i.ff, align 1, !tbaa !46
  ...
  %i.fq = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.fp ; 2 uses
  %i.fr = load i32, ptr %i.fq, align 4, !tbaa !45 ; 2 uses
  store i32 %i.fj, ptr %i.fq, align 4, !tbaa !45
  %i.fs = lshr i32 %i.fr, 4
  %i.ft = and i32 %i.fs, 268435440
  %i.fu = zext nneg i32 %i.ft to i64              ; 2 uses
  %i.fv = getelementptr inbounds nuw [4 x i8], ptr %i.ew, i64 %i.fu
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.g, %ZSTD_row_update_internal.exit.i
  ...
  %i.gl = getelementptr inbounds nuw i8, ptr %i.l, i64 %i.gk
  %i.gm = getelementptr inbounds nuw i8, ptr %i.gl, i64 8
  %.val15 = load i64, ptr %i.gm, align 1, !tbaa !46
  ...
  %i.gy = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.gx ; 2 uses
  %i.gz = load i32, ptr %i.gy, align 4, !tbaa !45
  store i32 %i.gs, ptr %i.gy, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit
...
bb.h:                                             ; preds = %bb.a
  ...
  store i32 %i.t, ptr %i.hf, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.h, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.he, %bb.h ], [ %i.gz, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.hg = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.hh = load i32, ptr %i.hg, align 8, !tbaa !86
  %i.hi = add i32 %i.hh, %.0257.i
  store i32 %i.hi, ptr %i.hg, align 8, !tbaa !86
  ...
  %i.ho = load i8, ptr %i.hn, align 1, !tbaa !53  ; 2 uses
  ...
  %i.ht = load <16 x i8>, ptr %i.hn, align 1, !tbaa !53
...
.lr.ph62.preheader:                               ; preds = %ZSTD_row_getSSEMask.exit
  ...
  %i.hx = tail call i16 @llvm.fshr.i16(i16 %i.hv, i16 %i.hv, i16 %i.hw)
...
.lr.ph62:                                         ; preds = %.lr.ph62.preheader, %bb.k
  ...
  %i.if = load i32, ptr %i.ie, align 4, !tbaa !45 ; 3 uses
...
._crit_edge:                                      ; preds = %bb.k, %bb.i, %ZSTD_row_getSSEMask.exit
  ...
  store i8 %i.ix, ptr %i.hn, align 1, !tbaa !53
  %i.iy = zext nneg i32 %i.iw to i64              ; 2 uses
  %i.iz = getelementptr inbounds nuw i8, ptr %i.hn, i64 %i.iy
  store i8 %i.hq, ptr %i.iz, align 1, !tbaa !53
  %i.ja = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 2 uses
  %i.jb = load i32, ptr %i.ja, align 4, !tbaa !41 ; 2 uses
  %i.jc = add i32 %i.jb, 1
  store i32 %i.jc, ptr %i.ja, align 4, !tbaa !41
  %i.jd = getelementptr inbounds nuw [4 x i8], ptr %i.hm, i64 %i.iy
  store i32 %i.jb, ptr %i.jd, align 4, !tbaa !45
  %.not91 = icmp eq i64 %.0249.i.lcssa, 0
  br i1 %.not91, label %._crit_edge71, label %.lr.ph70
...
bb.l:                                             ; preds = %.lr.ph70, %ZSTD_count.exit.thread
  %.0248.i68 = phi i64 [ 0, %.lr.ph70 ], [ %i.kv, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i67 = phi i64 [ 3, %.lr.ph70 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 5 uses
  %i.jj = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i68
  %i.jk = load i32, ptr %i.jj, align 4, !tbaa !45 ; 2 uses
  ...
  %.val8 = load i32, ptr %i.jo, align 1, !tbaa !45
  %i.jp = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i67
  %i.jq = getelementptr inbounds i8, ptr %i.jp, i64 -3
  %.val = load i32, ptr %i.jq, align 1, !tbaa !45
  %i.jr = icmp eq i32 %.val8, %.val
  br i1 %i.jr, label %bb.m, label %ZSTD_count.exit.thread

bb.m:                                             ; preds = %bb.l
  br i1 %i.jf, label %bb.n, label %.loopexit.i

bb.n:                                             ; preds = %bb.m
  %.val60.i = load i64, ptr %i.jm, align 1, !tbaa !46 ; 2 uses
  %.val.i = load i64, ptr %1, align 1, !tbaa !46  ; 2 uses
  %.not.i20 = icmp eq i64 %.val60.i, %.val.i
  br i1 %.not.i20, label %.preheader.i, label %bb.o
...
bb.w:                                             ; preds = %bb.v
  %i.kl = load i8, ptr %.4.i17, align 1, !tbaa !53
  %i.km = load i8, ptr %.453.i, align 1, !tbaa !53
...
ZSTD_count.exit:                                  ; preds = %bb.x, %.thread63.i, %bb.o
  ...
  br i1 %i.kq, label %bb.y, label %ZSTD_count.exit.thread
...
bb.y:                                             ; preds = %ZSTD_count.exit
  ...
  %i.kt = getelementptr inbounds nuw i8, ptr %1, i64 %.2243.i
  %i.ku = icmp eq ptr %i.kt, %2
  br i1 %i.ku, label %._crit_edge71, label %ZSTD_count.exit.thread
...
._crit_edge71:                                    ; preds = %ZSTD_count.exit.thread, %bb.y, %._crit_edge
  ...
  %i.kx = load i32, ptr %i.kw, align 8, !tbaa !54
  %i.ky = getelementptr inbounds nuw i8, ptr %i.al, i64 8
  %i.kz = load ptr, ptr %i.ky, align 8, !tbaa !37 ; 3 uses
  %i.la = load ptr, ptr %i.al, align 8, !tbaa !79 ; 2 uses
  %i.lb = ptrtoint ptr %i.la to i64
  %i.lc = ptrtoint ptr %i.kz to i64
  %.neg.i.neg = sub i64 %i.lb, %i.lc
  %.neg279.i.neg92 = trunc i64 %.neg.i.neg to i32
  %i.ld = load i8, ptr %i.ay, align 1, !tbaa !53  ; 2 uses
  ...
  %i.lh = load <16 x i8>, ptr %i.ay, align 1, !tbaa !53
  ...
  br i1 %i.lm, label %.lr.ph79.preheader, label %ZSTD_RowFindBestMatch.exit

.lr.ph79.preheader:                               ; preds = %._crit_edge71
  %i.ln = zext i8 %i.ld to i16
  %i.lo = tail call i16 @llvm.fshr.i16(i16 %i.lj, i16 %i.lj, i16 %i.ln)
...
.lr.ph79:                                         ; preds = %.lr.ph79.preheader, %bb.ab
  ...
  %i.lw = load i32, ptr %i.lv, align 4, !tbaa !45 ; 3 uses
...
bb.ac:                                            ; preds = %.lr.ph87, %.thread39
  ...
  %i.mm = load i32, ptr %i.ml, align 4, !tbaa !45 ; 2 uses
  %i.mn = zext i32 %i.mm to i64
  %i.mo = getelementptr inbounds nuw i8, ptr %i.kz, i64 %i.mn ; 2 uses
  %.val10 = load i32, ptr %i.mo, align 1, !tbaa !45
  %i.mp = icmp eq i32 %.val10, %.val9
  br i1 %i.mp, label %bb.ad, label %.thread39

bb.ad:                                            ; preds = %bb.ac
  %i.mq = getelementptr inbounds nuw i8, ptr %i.mo, i64 4
  %i.mr = tail call fastcc i64 @ZSTD_count_2segments(ptr noundef nonnull %i.mj, ptr noundef nonnull %i.mq, ptr noundef %2, ptr noundef %i.la, ptr noundef %i.p)
...
bb.ae:                                            ; preds = %bb.ad
  ...
  store i64 %i.mw, ptr %3, align 8, !tbaa !46
  %i.mx = getelementptr inbounds nuw i8, ptr %1, i64 %i.ms
  %i.my = icmp eq ptr %i.mx, %2
  br i1 %i.my, label %ZSTD_RowFindBestMatch.exit, label %.thread39
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_dictMatchState_5_5(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = alloca [64 x i32], align 16              ; 4 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
...
bb.d:                                             ; preds = %.lr.ph, %bb.d
  ...
  %i.bo = getelementptr inbounds nuw i8, ptr %i.l, i64 %indvars.iv
  %i.bp = getelementptr inbounds nuw i8, ptr %i.bo, i64 8
  %.val12 = load i64, ptr %i.bp, align 1, !tbaa !46
  ...
  %i.cb = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.ca ; 2 uses
  %i.cc = load i32, ptr %i.cb, align 4, !tbaa !45 ; 2 uses
  store i32 %i.bt, ptr %i.cb, align 4, !tbaa !45
  %i.cd = lshr i32 %i.cc, 3
  %i.ce = and i32 %i.cd, 536870880
  %i.cf = zext nneg i32 %i.ce to i64              ; 2 uses
  %i.cg = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %i.cf
...
end_hunk_21
begin_hunk_22_@ZSTD_RowFindBestMatch_dictMatchState_5_5:bb.a
...
.lr.ph55.new:                                     ; preds = %.prol.loopexit, %.lr.ph55.new
  %indvars.iv97 = phi i64 [ %indvars.iv.next98.1, %.lr.ph55.new ], [ %indvars.iv97.unr, %.prol.loopexit ] ; 4 uses
  %i.eb = getelementptr inbounds nuw i8, ptr %i.l, i64 %indvars.iv97
  %.val13 = load i64, ptr %i.eb, align 1, !tbaa !46
  ...
  %i.el = and i64 %indvars.iv97, 7
  %i.em = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.el
  store i32 %i.ef, ptr %i.em, align 4, !tbaa !45
  %indvars.iv.next98 = add nuw nsw i64 %indvars.iv97, 1 ; 2 uses
  %i.en = getelementptr inbounds nuw i8, ptr %i.l, i64 %indvars.iv.next98
  %.val13.1 = load i64, ptr %i.en, align 1, !tbaa !46
  ...
  %i.ex = and i64 %indvars.iv.next98, 7
  %i.ey = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.ex
  store i32 %i.er, ptr %i.ey, align 4, !tbaa !45
  %indvars.iv.next98.1 = add nuw nsw i64 %indvars.iv97, 2 ; 2 uses
  %lftr.wideiv.1 = trunc i64 %indvars.iv.next98.1 to i32
  %exitcond100.not.1 = icmp eq i32 %i.dj, %lftr.wideiv.1
  br i1 %exitcond100.not.1, label %ZSTD_row_update_internal.exit.i, label %.lr.ph55.new, !llvm.loop !5
...
bb.g:                                             ; preds = %.lr.ph57, %bb.g
  ...
  %i.fi = load i64, ptr %i.ah, align 8, !tbaa !52
  %i.fj = getelementptr inbounds nuw i8, ptr %i.fc, i64 %indvars.iv101
  %i.fk = getelementptr inbounds nuw i8, ptr %i.fj, i64 8
  %.val14 = load i64, ptr %i.fk, align 1, !tbaa !46
  ...
  %i.fw = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.fv ; 2 uses
  %i.fx = load i32, ptr %i.fw, align 4, !tbaa !45 ; 2 uses
  store i32 %i.fo, ptr %i.fw, align 4, !tbaa !45
  %i.fy = lshr i32 %i.fx, 3
  %i.fz = and i32 %i.fy, 536870880
  %i.ga = zext nneg i32 %i.fz to i64              ; 2 uses
  %i.gb = getelementptr inbounds nuw [4 x i8], ptr %i.fb, i64 %i.ga
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.g, %ZSTD_row_update_internal.exit.i
  ...
  %i.gr = getelementptr inbounds nuw i8, ptr %i.l, i64 %i.gq
  %i.gs = getelementptr inbounds nuw i8, ptr %i.gr, i64 8
  %.val15 = load i64, ptr %i.gs, align 1, !tbaa !46
  ...
  %i.hf = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.he ; 2 uses
  %i.hg = load i32, ptr %i.hf, align 4, !tbaa !45
  store i32 %i.gy, ptr %i.hf, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit
...
bb.h:                                             ; preds = %bb.a
  ...
  store i32 %i.t, ptr %i.hm, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.h, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.hl, %bb.h ], [ %i.hg, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.hn = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.ho = load i32, ptr %i.hn, align 8, !tbaa !86
  %i.hp = add i32 %i.ho, %.0257.i
  store i32 %i.hp, ptr %i.hn, align 8, !tbaa !86
...
.lr.ph62:                                         ; preds = %.lr.ph62.preheader, %bb.k
  ...
  %i.io = load i32, ptr %i.in, align 4, !tbaa !45 ; 3 uses
...
._crit_edge:                                      ; preds = %bb.k, %bb.i, %ZSTD_row_getSSEMask.exit
  ...
  store i8 %i.jg, ptr %i.ht, align 1, !tbaa !53
  %i.jh = zext nneg i32 %i.jf to i64              ; 2 uses
  %i.ji = getelementptr inbounds nuw i8, ptr %i.ht, i64 %i.jh
  store i8 %i.hv, ptr %i.ji, align 1, !tbaa !53
  %i.jj = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 2 uses
  %i.jk = load i32, ptr %i.jj, align 4, !tbaa !41 ; 2 uses
  %i.jl = add i32 %i.jk, 1
  store i32 %i.jl, ptr %i.jj, align 4, !tbaa !41
  %i.jm = getelementptr inbounds nuw [4 x i8], ptr %i.ia, i64 %i.jh
  store i32 %i.jk, ptr %i.jm, align 4, !tbaa !45
  %.not91 = icmp eq i64 %.0249.i.lcssa, 0
  br i1 %.not91, label %._crit_edge71, label %.lr.ph70
...
bb.l:                                             ; preds = %.lr.ph70, %ZSTD_count.exit.thread
  %.0248.i68 = phi i64 [ 0, %.lr.ph70 ], [ %i.le, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i67 = phi i64 [ 3, %.lr.ph70 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 5 uses
  %i.js = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i68
  %i.jt = load i32, ptr %i.js, align 4, !tbaa !45 ; 2 uses
  ...
  %.val8 = load i32, ptr %i.jx, align 1, !tbaa !45
  %i.jy = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i67
  %i.jz = getelementptr inbounds i8, ptr %i.jy, i64 -3
  %.val = load i32, ptr %i.jz, align 1, !tbaa !45
  %i.ka = icmp eq i32 %.val8, %.val
  br i1 %i.ka, label %bb.m, label %ZSTD_count.exit.thread

bb.m:                                             ; preds = %bb.l
  br i1 %i.jo, label %bb.n, label %.loopexit.i

bb.n:                                             ; preds = %bb.m
  %.val60.i = load i64, ptr %i.jv, align 1, !tbaa !46 ; 2 uses
  %.val.i = load i64, ptr %1, align 1, !tbaa !46  ; 2 uses
  %.not.i20 = icmp eq i64 %.val60.i, %.val.i
  br i1 %.not.i20, label %.preheader.i, label %bb.o
...
bb.w:                                             ; preds = %bb.v
  %i.ku = load i8, ptr %.4.i17, align 1, !tbaa !53
  %i.kv = load i8, ptr %.453.i, align 1, !tbaa !53
...
ZSTD_count.exit:                                  ; preds = %bb.x, %.thread63.i, %bb.o
  ...
  br i1 %i.kz, label %bb.y, label %ZSTD_count.exit.thread

bb.y:                                             ; preds = %ZSTD_count.exit
  %i.la = sub i32 %i.jr, %i.jt
  %i.lb = zext i32 %i.la to i64
  store i64 %i.lb, ptr %3, align 8, !tbaa !46
  %i.lc = getelementptr inbounds nuw i8, ptr %1, i64 %.2243.i
  %i.ld = icmp eq ptr %i.lc, %2
  br i1 %i.ld, label %._crit_edge71, label %ZSTD_count.exit.thread
...
._crit_edge71:                                    ; preds = %ZSTD_count.exit.thread, %bb.y, %._crit_edge
  ...
  %i.lg = load i32, ptr %i.lf, align 8, !tbaa !54
  %i.lh = getelementptr inbounds nuw i8, ptr %i.al, i64 8
  %i.li = load ptr, ptr %i.lh, align 8, !tbaa !37 ; 3 uses
  %i.lj = load ptr, ptr %i.al, align 8, !tbaa !79 ; 2 uses
  %i.lk = load i8, ptr %i.ay, align 1, !tbaa !53
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #12
  %i.ll = insertelement <16 x i8> poison, i8 %i.bb, i64 0
  %i.lm = load <16 x i8>, ptr %i.ay, align 1, !tbaa !53
  %i.ln = getelementptr inbounds nuw i8, ptr %i.ay, i64 16
  %i.lo = load <16 x i8>, ptr %i.ln, align 1, !tbaa !53
  ...
  br i1 %i.ly, label %.lr.ph79.preheader, label %ZSTD_RowFindBestMatch.exit
...
.lr.ph79:                                         ; preds = %.lr.ph79.preheader, %bb.ab
  ...
  %i.mh = load i32, ptr %i.mg, align 4, !tbaa !45 ; 3 uses
...
bb.ac:                                            ; preds = %.lr.ph87, %.thread39
  ...
  %i.mx = load i32, ptr %i.mw, align 4, !tbaa !45 ; 2 uses
  %i.my = zext i32 %i.mx to i64
  %i.mz = getelementptr inbounds nuw i8, ptr %i.li, i64 %i.my ; 2 uses
  %.val10 = load i32, ptr %i.mz, align 1, !tbaa !45
  %i.na = icmp eq i32 %.val10, %.val9
  br i1 %i.na, label %bb.ad, label %.thread39

bb.ad:                                            ; preds = %bb.ac
  %i.nb = getelementptr inbounds nuw i8, ptr %i.mz, i64 4
  %i.nc = tail call fastcc i64 @ZSTD_count_2segments(ptr noundef nonnull %i.mu, ptr noundef nonnull %i.nb, ptr noundef %2, ptr noundef %i.lj, ptr noundef %i.p)
...
bb.ae:                                            ; preds = %bb.ad
  ...
  store i64 %i.nh, ptr %3, align 8, !tbaa !46
  %i.ni = getelementptr inbounds nuw i8, ptr %1, i64 %i.nd
  %i.nj = icmp eq ptr %i.ni, %2
  br i1 %i.nj, label %ZSTD_RowFindBestMatch.exit, label %.thread39
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_dictMatchState_5_6(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = alloca [64 x i32], align 16              ; 4 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
...
bb.d:                                             ; preds = %.lr.ph, %bb.d
  ...
  %i.bo = load i64, ptr %i.ah, align 8, !tbaa !52
  %i.bp = getelementptr inbounds nuw i8, ptr %i.l, i64 %indvars.iv
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bp, i64 8
  %.val12 = load i64, ptr %i.bq, align 1, !tbaa !46
  ...
  %i.cd = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.cc ; 2 uses
  %i.ce = load i32, ptr %i.cd, align 4, !tbaa !45 ; 2 uses
  store i32 %i.bu, ptr %i.cd, align 4, !tbaa !45
  %i.cf = lshr i32 %i.ce, 2
  %i.cg = and i32 %i.cf, 1073741760
  %i.ch = zext nneg i32 %i.cg to i64              ; 2 uses
  %i.ci = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %i.ch
  ...
  store i32 %i.cb, ptr %i.cv, align 4, !tbaa !45
end_hunk_22
begin_hunk_23_@ZSTD_RowFindBestMatch_dictMatchState_5_6:bb.a
  %i.do = sub i32 56, %i.cw
...
bb.g:                                             ; preds = %.lr.ph55, %bb.g
  %indvars.iv97 = phi i64 [ %i.db, %.lr.ph55 ], [ %indvars.iv.next98, %bb.g ] ; 3 uses
  %i.dq = getelementptr inbounds nuw i8, ptr %i.l, i64 %indvars.iv97
  %.val13 = load i64, ptr %i.dq, align 1, !tbaa !46
  %i.dr = mul i64 %.val13, -3523014627271114752
  %i.ds = xor i64 %i.dr, %i.dn
  %i.dt = lshr i64 %i.ds, %i.dp                   ; 2 uses
  %i.du = trunc i64 %i.dt to i32
  %i.dv = lshr i64 %i.dt, 2
  %i.dw = and i64 %i.dv, 1073741760               ; 2 uses
  %i.dx = getelementptr inbounds nuw [4 x i8], ptr %i.cy, i64 %i.dw ; 2 uses
  ...
  %i.eb = and i64 %indvars.iv97, 7
  %i.ec = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.eb
  store i32 %i.du, ptr %i.ec, align 4, !tbaa !45
  %indvars.iv.next98 = add nuw nsw i64 %indvars.iv97, 1 ; 2 uses
  %lftr.wideiv = trunc i64 %indvars.iv.next98 to i32
  %exitcond100.not = icmp eq i32 %i.dl, %lftr.wideiv
  br i1 %exitcond100.not, label %ZSTD_row_update_internal.exit.i, label %bb.g, !llvm.loop !5
...
.lr.ph57:                                         ; preds = %ZSTD_row_update_internal.exit.i
  %i.ei = sub i32 56, %i.ed
  %i.ej = zext nneg i32 %i.ei to i64
  %i.ek = zext i32 %.0.i284.i to i64
  %i.el = and i64 %i.s, 4294967295
  br label %bb.h

bb.h:                                             ; preds = %.lr.ph57, %bb.h
  %indvars.iv101 = phi i64 [ %i.ek, %.lr.ph57 ], [ %indvars.iv.next102, %bb.h ] ; 4 uses
  %i.em = load i64, ptr %i.ah, align 8, !tbaa !52
  %i.en = getelementptr inbounds nuw i8, ptr %i.eg, i64 %indvars.iv101
  %i.eo = getelementptr inbounds nuw i8, ptr %i.en, i64 8
  %.val14 = load i64, ptr %i.eo, align 1, !tbaa !46
  %i.ep = mul i64 %.val14, -3523014627271114752
  %i.eq = xor i64 %i.ep, %i.em
  %i.er = lshr i64 %i.eq, %i.ej                   ; 2 uses
  %i.es = trunc i64 %i.er to i32
  %i.et = lshr i64 %i.er, 2
  %i.eu = and i64 %i.et, 1073741760               ; 2 uses
  %i.ev = getelementptr inbounds nuw [4 x i8], ptr %i.ef, i64 %i.eu ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.ev, i32 0, i32 3, i32 1)
  %i.ew = getelementptr inbounds nuw i8, ptr %i.ev, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.ew, i32 0, i32 3, i32 1)
  ...
  %i.fb = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.fa ; 2 uses
  %i.fc = load i32, ptr %i.fb, align 4, !tbaa !45 ; 2 uses
  store i32 %i.es, ptr %i.fb, align 4, !tbaa !45
  %i.fd = lshr i32 %i.fc, 2
  %i.fe = and i32 %i.fd, 1073741760
  %i.ff = zext nneg i32 %i.fe to i64              ; 2 uses
  %i.fg = getelementptr inbounds nuw [4 x i8], ptr %i.ef, i64 %i.ff
  ...
  store i32 %i.ez, ptr %i.ft, align 4, !tbaa !45
  %indvars.iv.next102 = add nuw nsw i64 %indvars.iv101, 1 ; 2 uses
  %i.fu = icmp samesign ult i64 %indvars.iv.next102, %i.el
  br i1 %i.fu, label %bb.h, label %ZSTD_row_update_internalImpl.exit287.i, !llvm.loop !0
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.h, %ZSTD_row_update_internal.exit.i
  ...
  %i.fw = getelementptr inbounds nuw i8, ptr %i.l, i64 %i.fv
  %i.fx = getelementptr inbounds nuw i8, ptr %i.fw, i64 8
  %.val15 = load i64, ptr %i.fx, align 1, !tbaa !46
  %i.fy = mul i64 %.val15, -3523014627271114752
  %i.fz = xor i64 %i.fy, %i.ai
  %i.ga = sub i32 56, %i.i
  %i.gb = zext nneg i32 %i.ga to i64
  %i.gc = lshr i64 %i.fz, %i.gb                   ; 2 uses
  %i.gd = trunc i64 %i.gc to i32
  %i.ge = lshr i64 %i.gc, 2
  %i.gf = and i64 %i.ge, 1073741760               ; 2 uses
  %i.gg = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %i.gf ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.gg, i32 0, i32 3, i32 1)
  %i.gh = getelementptr inbounds nuw i8, ptr %i.gg, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.gh, i32 0, i32 3, i32 1)
  ...
  %i.gl = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %i.gk ; 2 uses
  %i.gm = load i32, ptr %i.gl, align 4, !tbaa !45
  store i32 %i.gd, ptr %i.gl, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit

bb.i:                                             ; preds = %bb.a
  %i.gn = xor i64 %i.as, %i.ai
  %i.go = sub i32 56, %i.i
  %i.gp = zext nneg i32 %i.go to i64
  %i.gq = lshr i64 %i.gn, %i.gp
  %i.gr = trunc i64 %i.gq to i32
  %i.gs = getelementptr inbounds nuw i8, ptr %0, i64 44
  store i32 %i.t, ptr %i.gs, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.i, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.gr, %bb.i ], [ %i.gm, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.gt = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.gu = load i32, ptr %i.gt, align 8, !tbaa !86
  %i.gv = add i32 %i.gu, %.0257.i
  store i32 %i.gv, ptr %i.gt, align 8, !tbaa !86
  %i.gw = lshr i32 %.0257.i, 2
  %i.gx = and i32 %i.gw, 1073741760
  %i.gy = zext nneg i32 %i.gx to i64              ; 2 uses
  %i.gz = getelementptr inbounds nuw i8, ptr %i.f, i64 %i.gy ; 7 uses
  %i.ha = load i8, ptr %i.gz, align 1, !tbaa !53  ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #12
  %i.hb = trunc i32 %.0257.i to i8                ; 2 uses
  %i.hc = insertelement <16 x i8> poison, i8 %i.hb, i64 0
  %i.hd = shufflevector <16 x i8> %i.hc, <16 x i8> poison, <16 x i32> zeroinitializer ; 4 uses
  %i.he = load <16 x i8>, ptr %i.gz, align 1, !tbaa !53
  %i.hf = icmp eq <16 x i8> %i.he, %i.hd
  %i.hg = bitcast <16 x i1> %i.hf to i16
  %i.hh = getelementptr inbounds nuw i8, ptr %i.gz, i64 16
  %i.hi = load <16 x i8>, ptr %i.hh, align 1, !tbaa !53
  %i.hj = icmp eq <16 x i8> %i.hi, %i.hd
  %i.hk = bitcast <16 x i1> %i.hj to i16
  %i.hl = getelementptr inbounds nuw i8, ptr %i.gz, i64 32
  %i.hm = load <16 x i8>, ptr %i.hl, align 1, !tbaa !53
  %i.hn = icmp eq <16 x i8> %i.hm, %i.hd
  %i.ho = bitcast <16 x i1> %i.hn to i16
  %i.hp = getelementptr inbounds nuw i8, ptr %i.gz, i64 48
  %i.hq = load <16 x i8>, ptr %i.hp, align 1, !tbaa !53
  %i.hr = icmp eq <16 x i8> %i.hq, %i.hd
  %i.hs = bitcast <16 x i1> %i.hr to i16
  %i.ht = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %i.gy ; 2 uses
  %i.hu = zext i8 %i.ha to i32                    ; 2 uses
  %i.hv = insertelement <4 x i16> poison, i16 %i.hg, i64 0
  %i.hw = insertelement <4 x i16> %i.hv, i16 %i.hk, i64 1
  %i.hx = insertelement <4 x i16> %i.hw, i16 %i.ho, i64 2
  %i.hy = insertelement <4 x i16> %i.hx, i16 %i.hs, i64 3
  %i.hz = bitcast <4 x i16> %i.hy to i64          ; 3 uses
  %.not = icmp eq i64 %i.hz, 0
  br i1 %.not, label %._crit_edge, label %.lr.ph62.preheader

.lr.ph62.preheader:                               ; preds = %ZSTD_row_getSSEMask.exit
  %i.ia = zext i8 %i.ha to i64
  %i.ib = tail call i64 @llvm.fshr.i64(i64 %i.hz, i64 %i.hz, i64 %i.ia)
  br label %.lr.ph62

.lr.ph62:                                         ; preds = %.lr.ph62.preheader, %bb.l
  %.0247.i61 = phi i64 [ %i.ir, %bb.l ], [ %i.ib, %.lr.ph62.preheader ] ; 3 uses
  %.0249.i60 = phi i64 [ %.1250.i.ph, %bb.l ], [ 0, %.lr.ph62.preheader ] ; 4 uses
  %.0262.i59 = phi i32 [ %.1263.i.ph, %bb.l ], [ %i.aj, %.lr.ph62.preheader ] ; 3 uses
  %i.ic = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, 0) %.0247.i61, i1 true)
  %i.id = trunc nuw nsw i64 %i.ic to i32
  %i.ie = add nuw nsw i32 %i.id, %i.hu
  %i.if = and i32 %i.ie, 63                       ; 2 uses
  %i.ig = zext nneg i32 %i.if to i64
  %i.ih = getelementptr inbounds nuw [4 x i8], ptr %i.ht, i64 %i.ig
  %i.ii = load i32, ptr %i.ih, align 4, !tbaa !45 ; 3 uses
  %i.ij = icmp eq i32 %i.if, 0
  br i1 %i.ij, label %bb.l, label %bb.j

bb.j:                                             ; preds = %.lr.ph62
  %i.ik = icmp ult i32 %i.ii, %i.ae
  br i1 %i.ik, label %._crit_edge, label %bb.k
...
bb.l:                                             ; preds = %bb.k, %.lr.ph62
  %.1263.i.ph = phi i32 [ %.0262.i59, %.lr.ph62 ], [ %i.ip, %bb.k ] ; 3 uses
  %.1250.i.ph = phi i64 [ %.0249.i60, %.lr.ph62 ], [ %i.in, %bb.k ] ; 2 uses
  %i.iq = add i64 %.0247.i61, -1
  %i.ir = and i64 %i.iq, %.0247.i61               ; 2 uses
  %i.is = icmp ne i64 %i.ir, 0
  %i.it = icmp ne i32 %.1263.i.ph, 0
  %i.iu = select i1 %i.is, i1 %i.it, i1 false
  br i1 %i.iu, label %.lr.ph62, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %bb.l, %bb.j, %ZSTD_row_getSSEMask.exit
  %.0262.i.lcssa = phi i32 [ %i.aj, %ZSTD_row_getSSEMask.exit ], [ %.0262.i59, %bb.j ], [ %.1263.i.ph, %bb.l ] ; 2 uses
  %.0249.i.lcssa = phi i64 [ 0, %ZSTD_row_getSSEMask.exit ], [ %.0249.i60, %bb.j ], [ %.1250.i.ph, %bb.l ] ; 2 uses
  %i.iv = add nuw nsw i32 %i.hu, 63
  %i.iw = and i32 %i.iv, 63                       ; 2 uses
  %i.ix = icmp eq i32 %i.iw, 0
  %i.iy = select i1 %i.ix, i32 63, i32 0
  %i.iz = add nuw nsw i32 %i.iy, %i.iw            ; 2 uses
  %i.ja = trunc nuw nsw i32 %i.iz to i8
  store i8 %i.ja, ptr %i.gz, align 1, !tbaa !53
  %i.jb = zext nneg i32 %i.iz to i64              ; 2 uses
  %i.jc = getelementptr inbounds nuw i8, ptr %i.gz, i64 %i.jb
  store i8 %i.hb, ptr %i.jc, align 1, !tbaa !53
  %i.jd = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 2 uses
  %i.je = load i32, ptr %i.jd, align 4, !tbaa !41 ; 2 uses
  %i.jf = add i32 %i.je, 1
  store i32 %i.jf, ptr %i.jd, align 4, !tbaa !41
  %i.jg = getelementptr inbounds nuw [4 x i8], ptr %i.ht, i64 %i.jb
  store i32 %i.je, ptr %i.jg, align 4, !tbaa !45
  %.not91 = icmp eq i64 %.0249.i.lcssa, 0
  br i1 %.not91, label %._crit_edge71, label %.lr.ph70

.lr.ph70:                                         ; preds = %._crit_edge
  %i.jh = getelementptr inbounds i8, ptr %2, i64 -7 ; 2 uses
  %i.ji = icmp ult ptr %1, %i.jh
  %i.jj = getelementptr inbounds i8, ptr %2, i64 -3
  %i.jk = getelementptr inbounds i8, ptr %2, i64 -1
  %i.jl = add i32 %i.t, 3
  br label %bb.m

bb.m:                                             ; preds = %.lr.ph70, %ZSTD_count.exit.thread
  %.0248.i68 = phi i64 [ 0, %.lr.ph70 ], [ %i.ky, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i67 = phi i64 [ 3, %.lr.ph70 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 5 uses
  %i.jm = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i68
  %i.jn = load i32, ptr %i.jm, align 4, !tbaa !45 ; 2 uses
  %i.jo = zext i32 %i.jn to i64
  %i.jp = getelementptr inbounds nuw i8, ptr %i.l, i64 %i.jo ; 4 uses
  %i.jq = getelementptr inbounds nuw i8, ptr %i.jp, i64 %.0258.i67
  %i.jr = getelementptr inbounds i8, ptr %i.jq, i64 -3
  %.val8 = load i32, ptr %i.jr, align 1, !tbaa !45
  %i.js = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i67
  %i.jt = getelementptr inbounds i8, ptr %i.js, i64 -3
  %.val = load i32, ptr %i.jt, align 1, !tbaa !45
  %i.ju = icmp eq i32 %.val8, %.val
  br i1 %i.ju, label %bb.n, label %ZSTD_count.exit.thread

bb.n:                                             ; preds = %bb.m
  br i1 %i.ji, label %bb.o, label %.loopexit.i

bb.o:                                             ; preds = %bb.n
  %.val60.i = load i64, ptr %i.jp, align 1, !tbaa !46 ; 2 uses
  %.val.i = load i64, ptr %1, align 1, !tbaa !46  ; 2 uses
  %.not.i20 = icmp eq i64 %.val60.i, %.val.i
  br i1 %.not.i20, label %.preheader.i, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.jv = xor i64 %.val.i, %.val60.i
  %i.jw = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, 0) %i.jv, i1 true)
  %i.jx = lshr i64 %i.jw, 3
  br label %ZSTD_count.exit
...
.preheader.i:                                     ; preds = %bb.o, %bb.q
  %.pn.i = phi ptr [ %.049.i, %bb.q ], [ %1, %bb.o ]
  %.pn67.i = phi ptr [ %.045.i, %bb.q ], [ %i.jp, %bb.o ]
  %.045.i = getelementptr inbounds nuw i8, ptr %.pn67.i, i64 8 ; 3 uses
  %.049.i = getelementptr inbounds nuw i8, ptr %.pn.i, i64 8 ; 5 uses
  %i.jy = icmp ult ptr %.049.i, %i.jh
  br i1 %i.jy, label %bb.q, label %.loopexit.i
...
.thread63.i:                                      ; preds = %bb.q
  %i.jz = xor i64 %.049.val.i, %.045.val.i
  %i.ka = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, 0) %i.jz, i1 true)
  %i.kb = lshr i64 %i.ka, 3
  %i.kc = getelementptr inbounds nuw i8, ptr %.049.i, i64 %i.kb
  %i.kd = ptrtoint ptr %i.kc to i64
  %i.ke = sub i64 %i.kd, %i.q
  br label %ZSTD_count.exit

.loopexit.i:                                      ; preds = %.preheader.i, %bb.n
  %.251.i = phi ptr [ %1, %bb.n ], [ %.049.i, %.preheader.i ] ; 5 uses
  %.247.i = phi ptr [ %i.jp, %bb.n ], [ %.045.i, %.preheader.i ] ; 4 uses
  %i.kf = icmp ult ptr %.251.i, %i.jj
  br i1 %i.kf, label %bb.r, label %bb.t

bb.r:                                             ; preds = %.loopexit.i
  %.247.val.i = load i32, ptr %.247.i, align 1, !tbaa !45
  %.251.val.i = load i32, ptr %.251.i, align 1, !tbaa !45
  %i.kg = icmp eq i32 %.247.val.i, %.251.val.i
  br i1 %i.kg, label %bb.s, label %bb.t

bb.s:                                             ; preds = %bb.r
  %i.kh = getelementptr inbounds nuw i8, ptr %.251.i, i64 4
  %i.ki = getelementptr inbounds nuw i8, ptr %.247.i, i64 4
  br label %bb.t

bb.t:                                             ; preds = %bb.s, %bb.r, %.loopexit.i
  %.352.i = phi ptr [ %i.kh, %bb.s ], [ %.251.i, %bb.r ], [ %.251.i, %.loopexit.i ] ; 5 uses
  %.348.i = phi ptr [ %i.ki, %bb.s ], [ %.247.i, %bb.r ], [ %.247.i, %.loopexit.i ] ; 4 uses
  %i.kj = icmp ult ptr %.352.i, %i.jk
  br i1 %i.kj, label %bb.u, label %bb.w

bb.u:                                             ; preds = %bb.t
  %.348.val.i = load i16, ptr %.348.i, align 1, !tbaa !60
  %.352.val.i = load i16, ptr %.352.i, align 1, !tbaa !60
  %i.kk = icmp eq i16 %.348.val.i, %.352.val.i
  br i1 %i.kk, label %bb.v, label %bb.w

bb.v:                                             ; preds = %bb.u
  %i.kl = getelementptr inbounds nuw i8, ptr %.352.i, i64 2
  %i.km = getelementptr inbounds nuw i8, ptr %.348.i, i64 2
  br label %bb.w

bb.w:                                             ; preds = %bb.v, %bb.u, %bb.t
  %.453.i = phi ptr [ %i.kl, %bb.v ], [ %.352.i, %bb.u ], [ %.352.i, %bb.t ] ; 4 uses
  %.4.i17 = phi ptr [ %i.km, %bb.v ], [ %.348.i, %bb.u ], [ %.348.i, %bb.t ]
  %i.kn = icmp ult ptr %.453.i, %2
  br i1 %i.kn, label %bb.x, label %bb.y

bb.x:                                             ; preds = %bb.w
  %i.ko = load i8, ptr %.4.i17, align 1, !tbaa !53
  %i.kp = load i8, ptr %.453.i, align 1, !tbaa !53
  %i.kq = icmp eq i8 %i.ko, %i.kp
  %spec.select.idx.i = zext i1 %i.kq to i64
  %spec.select.i19 = getelementptr inbounds nuw i8, ptr %.453.i, i64 %spec.select.idx.i
  br label %bb.y

bb.y:                                             ; preds = %bb.x, %bb.w
  %.5.i = phi ptr [ %.453.i, %bb.w ], [ %spec.select.i19, %bb.x ]
  %i.kr = ptrtoint ptr %.5.i to i64
  %i.ks = sub i64 %i.kr, %i.q
  br label %ZSTD_count.exit

ZSTD_count.exit:                                  ; preds = %bb.y, %.thread63.i, %bb.p
  %.2243.i = phi i64 [ %i.jx, %bb.p ], [ %i.ke, %.thread63.i ], [ %i.ks, %bb.y ] ; 4 uses
  %i.kt = icmp ugt i64 %.2243.i, %.0258.i67
  br i1 %i.kt, label %bb.z, label %ZSTD_count.exit.thread

bb.z:                                             ; preds = %ZSTD_count.exit
  %i.ku = sub i32 %i.jl, %i.jn
  %i.kv = zext i32 %i.ku to i64
  store i64 %i.kv, ptr %3, align 8, !tbaa !46
  %i.kw = getelementptr inbounds nuw i8, ptr %1, i64 %.2243.i
  %i.kx = icmp eq ptr %i.kw, %2
  br i1 %i.kx, label %._crit_edge71, label %ZSTD_count.exit.thread

ZSTD_count.exit.thread:                           ; preds = %bb.m, %bb.z, %ZSTD_count.exit
  %.2260.i.ph = phi i64 [ %.2243.i, %bb.z ], [ %.0258.i67, %ZSTD_count.exit ], [ %.0258.i67, %bb.m ] ; 2 uses
  %i.ky = add nuw i64 %.0248.i68, 1               ; 2 uses
  %exitcond108.not = icmp eq i64 %i.ky, %.0249.i.lcssa
  br i1 %exitcond108.not, label %._crit_edge71, label %bb.m, !llvm.loop !10
...
._crit_edge71:                                    ; preds = %ZSTD_count.exit.thread, %bb.z, %._crit_edge
  ...
  %i.la = load i32, ptr %i.kz, align 8, !tbaa !54
  %i.lb = getelementptr inbounds nuw i8, ptr %i.al, i64 8
  %i.lc = load ptr, ptr %i.lb, align 8, !tbaa !37 ; 3 uses
  %i.ld = load ptr, ptr %i.al, align 8, !tbaa !79 ; 2 uses
  %i.le = load i8, ptr %i.ay, align 1, !tbaa !53
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #12
  %i.lf = insertelement <16 x i8> poison, i8 %i.bc, i64 0
  %i.lg = shufflevector <16 x i8> %i.lf, <16 x i8> poison, <16 x i32> zeroinitializer ; 4 uses
  %i.lh = load <16 x i8>, ptr %i.ay, align 1, !tbaa !53
  %i.li = icmp eq <16 x i8> %i.lh, %i.lg
  %i.lj = bitcast <16 x i1> %i.li to i16
  %i.lk = getelementptr inbounds nuw i8, ptr %i.ay, i64 16
  %i.ll = load <16 x i8>, ptr %i.lk, align 1, !tbaa !53
  %i.lm = icmp eq <16 x i8> %i.ll, %i.lg
  %i.ln = bitcast <16 x i1> %i.lm to i16
  %i.lo = load <16 x i8>, ptr %i.bb, align 1, !tbaa !53
  %i.lp = icmp eq <16 x i8> %i.lo, %i.lg
  %i.lq = bitcast <16 x i1> %i.lp to i16
  %i.lr = getelementptr inbounds nuw i8, ptr %i.ay, i64 48
  %i.ls = load <16 x i8>, ptr %i.lr, align 1, !tbaa !53
  %i.lt = icmp eq <16 x i8> %i.ls, %i.lg
  %i.lu = bitcast <16 x i1> %i.lt to i16
  %i.lv = ptrtoint ptr %i.ld to i64
  %i.lw = ptrtoint ptr %i.lc to i64
  %.neg.i.neg = sub i64 %i.lv, %i.lw
  %.neg279.i.neg92 = trunc i64 %.neg.i.neg to i32
  %i.lx = and i8 %i.le, 63                        ; 2 uses
  %i.ly = zext nneg i8 %i.lx to i32               ; 2 uses
  %i.lz = insertelement <4 x i16> poison, i16 %i.lj, i64 0
  %i.ma = insertelement <4 x i16> %i.lz, i16 %i.ln, i64 1
  %i.mb = insertelement <4 x i16> %i.ma, i16 %i.lq, i64 2
  %i.mc = insertelement <4 x i16> %i.mb, i16 %i.lu, i64 3
  %i.md = bitcast <4 x i16> %i.mc to i64          ; 2 uses
  %i.me = zext nneg i8 %i.lx to i64
  %i.mf = lshr i64 %i.md, %i.me
  %i.mg = sub nsw i32 0, %i.ly
  %i.mh = and i32 %i.mg, 63
  %i.mi = zext nneg i32 %i.mh to i64
  %i.mj = shl i64 %i.md, %i.mi
  %i.mk = or i64 %i.mj, %i.mf                     ; 2 uses
  %i.ml = icmp ne i64 %i.mk, 0
  %i.mm = icmp ne i32 %.0262.i.lcssa, 0
  %i.mn = select i1 %i.ml, i1 %i.mm, i1 false
  br i1 %i.mn, label %.lr.ph79, label %ZSTD_RowFindBestMatch.exit

.lr.ph79:                                         ; preds = %._crit_edge71, %bb.ac
  %.0238.i78 = phi i64 [ %i.nd, %bb.ac ], [ %i.mk, %._crit_edge71 ] ; 3 uses
  %.0240.i77 = phi i64 [ %.1.i.ph, %bb.ac ], [ 0, %._crit_edge71 ] ; 4 uses
  %.3265.i76 = phi i32 [ %.4266.i.ph, %bb.ac ], [ %.0262.i.lcssa, %._crit_edge71 ] ; 2 uses
  %i.mo = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, 0) %.0238.i78, i1 true)
  ...
  %i.mt = getelementptr inbounds nuw [4 x i8], ptr %i.az, i64 %i.ms
  %i.mu = load i32, ptr %i.mt, align 4, !tbaa !45 ; 3 uses
  %i.mv = icmp eq i32 %i.mr, 0
  br i1 %i.mv, label %bb.ac, label %bb.aa

bb.aa:                                            ; preds = %.lr.ph79
  %i.mw = icmp ult i32 %i.mu, %i.la
  br i1 %i.mw, label %._crit_edge80, label %bb.ab
...
bb.ac:                                            ; preds = %bb.ab, %.lr.ph79
  %.4266.i.ph = phi i32 [ %.3265.i76, %.lr.ph79 ], [ %i.nb, %bb.ab ] ; 2 uses
  %.1.i.ph = phi i64 [ %.0240.i77, %.lr.ph79 ], [ %i.mz, %bb.ab ] ; 2 uses
  %i.nc = add i64 %.0238.i78, -1
  %i.nd = and i64 %i.nc, %.0238.i78               ; 2 uses
  %i.ne = icmp ne i64 %i.nd, 0
  %i.nf = icmp ne i32 %.4266.i.ph, 0
  %i.ng = select i1 %i.ne, i1 %i.nf, i1 false
  br i1 %i.ng, label %.lr.ph79, label %._crit_edge80, !llvm.loop !12
...
.lr.ph87:                                         ; preds = %._crit_edge80
  %invariant.op = add i32 %i.t, %.neg279.i.neg92
  %.val9 = load i32, ptr %1, align 1, !tbaa !45
  %i.nh = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.ni = add i32 %invariant.op, 3
  br label %bb.ad

bb.ad:                                            ; preds = %.lr.ph87, %.thread39
  %.0239.i85 = phi i64 [ 0, %.lr.ph87 ], [ %i.nx, %.thread39 ] ; 2 uses
  %.4.i84 = phi i64 [ %.3261.i, %.lr.ph87 ], [ %.6.i.ph, %.thread39 ] ; 3 uses
  %i.nj = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %.0239.i85
  %i.nk = load i32, ptr %i.nj, align 4, !tbaa !45 ; 2 uses
  %i.nl = zext i32 %i.nk to i64
  %i.nm = getelementptr inbounds nuw i8, ptr %i.lc, i64 %i.nl ; 2 uses
  %.val10 = load i32, ptr %i.nm, align 1, !tbaa !45
  %i.nn = icmp eq i32 %.val10, %.val9
  br i1 %i.nn, label %bb.ae, label %.thread39

bb.ae:                                            ; preds = %bb.ad
  %i.no = getelementptr inbounds nuw i8, ptr %i.nm, i64 4
  %i.np = tail call fastcc i64 @ZSTD_count_2segments(ptr noundef nonnull %i.nh, ptr noundef nonnull %i.no, ptr noundef %2, ptr noundef %i.ld, ptr noundef %i.p)
  %i.nq = add i64 %i.np, 4                        ; 4 uses
  %i.nr = icmp ugt i64 %i.nq, %.4.i84
  br i1 %i.nr, label %bb.af, label %.thread39

bb.af:                                            ; preds = %bb.ae
  %i.ns = add i32 %i.n, %i.nk
  %i.nt = sub i32 %i.ni, %i.ns
  %i.nu = zext i32 %i.nt to i64
  store i64 %i.nu, ptr %3, align 8, !tbaa !46
  %i.nv = getelementptr inbounds nuw i8, ptr %1, i64 %i.nq
  %i.nw = icmp eq ptr %i.nv, %2
  br i1 %i.nw, label %ZSTD_RowFindBestMatch.exit, label %.thread39

.thread39:                                        ; preds = %bb.ad, %bb.af, %bb.ae
  %.6.i.ph = phi i64 [ %i.nq, %bb.af ], [ %.4.i84, %bb.ae ], [ %.4.i84, %bb.ad ] ; 2 uses
  %i.nx = add nuw i64 %.0239.i85, 1               ; 2 uses
  %exitcond113.not = icmp eq i64 %i.nx, %.0240.i.lcssa
  br i1 %exitcond113.not, label %ZSTD_RowFindBestMatch.exit, label %bb.ad, !llvm.loop !13

ZSTD_RowFindBestMatch.exit:                       ; preds = %.thread39, %bb.af, %._crit_edge71, %._crit_edge80
  %.7.i = phi i64 [ %.3261.i, %._crit_edge80 ], [ %.3261.i, %._crit_edge71 ], [ %.6.i.ph, %.thread39 ], [ %i.nq, %bb.af ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #12
  ret i64 %.7.i
}

; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_dictMatchState_6_4(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = alloca [64 x i32], align 16              ; 4 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
...
bb.d:                                             ; preds = %.lr.ph, %bb.d
  ...
  %i.bo = getelementptr inbounds nuw i8, ptr %i.bn, i64 8
  %.val12 = load i64, ptr %i.bo, align 1, !tbaa !46
  %i.bp = mul i64 %.val12, -3523014627193847808
  %i.bq = xor i64 %i.bp, %i.bm
  %i.br = lshr i64 %i.bq, %i.bk                   ; 2 uses
  %i.bs = trunc i64 %i.br to i32
  %i.bt = lshr i64 %i.br, 4
...
ZSTD_row_update_internalImpl.exit.i.loopexit:     ; preds = %bb.d
  ...
  %.pre107 = load i32, ptr %i.h, align 4, !tbaa !51
end_hunk_23
begin_hunk_24_@ZSTD_RowFindBestMatch_dictMatchState_6_4:bb.a
  %i.ds = and i64 %i.dr, 268435440                ; 2 uses
  %i.dt = getelementptr inbounds nuw [4 x i8], ptr %i.cu, i64 %i.ds
  tail call void @llvm.prefetch.p0(ptr %i.dt, i32 0, i32 3, i32 1)
  %i.du = getelementptr inbounds nuw i8, ptr %i.ct, i64 %i.ds
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_dictMatchState_6_5(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = alloca [64 x i32], align 16              ; 4 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
...
end_hunk_24
begin_hunk_25_@ZSTD_RowFindBestMatch_dictMatchState_6_5:bb.a
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i64 3, 0) i64 @ZSTD_RowFindBestMatch_dictMatchState_6_6(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #7 {
bb.a:
  %i.a = alloca [64 x i32], align 16              ; 4 uses
  %i.b = alloca [64 x i32], align 16              ; 4 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 2 uses
...
bb.d:                                             ; preds = %.lr.ph, %bb.d
  ...
  store i32 %i.cb, ptr %i.cv, align 4, !tbaa !45
end_hunk_25
begin_hunk_26_@ZSTD_RowFindBestMatch_dictMatchState_6_6:bb.a
  %i.do = sub i32 56, %i.cw
  %i.dp = zext nneg i32 %i.do to i64
  br label %bb.g
...
bb.g:                                             ; preds = %.lr.ph55, %bb.g
  ...
  %i.dq = getelementptr inbounds nuw i8, ptr %i.l, i64 %indvars.iv97
  %.val13 = load i64, ptr %i.dq, align 1, !tbaa !46
  %i.dr = mul i64 %.val13, -3523014627193847808
  %i.ds = xor i64 %i.dr, %i.dn
  %i.dt = lshr i64 %i.ds, %i.dp                   ; 2 uses
  %i.du = trunc i64 %i.dt to i32
  %i.dv = lshr i64 %i.dt, 2
...
bb.h:                                             ; preds = %.lr.ph57, %bb.h
  ...
  %i.eo = getelementptr inbounds nuw i8, ptr %i.en, i64 8
  %.val14 = load i64, ptr %i.eo, align 1, !tbaa !46
  %i.ep = mul i64 %.val14, -3523014627193847808
  %i.eq = xor i64 %i.ep, %i.em
  %i.er = lshr i64 %i.eq, %i.ej                   ; 2 uses
  %i.es = trunc i64 %i.er to i32
  %i.et = lshr i64 %i.er, 2
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.h, %ZSTD_row_update_internal.exit.i
  ...
  %i.fx = getelementptr inbounds nuw i8, ptr %i.fw, i64 8
  %.val15 = load i64, ptr %i.fx, align 1, !tbaa !46
  %i.fy = mul i64 %.val15, -3523014627193847808
  %i.fz = xor i64 %i.fy, %i.ai
  %i.ga = sub i32 56, %i.i
  %i.gb = zext nneg i32 %i.ga to i64
  %i.gc = lshr i64 %i.fz, %i.gb                   ; 2 uses
...
; Function Attrs: nofree noinline norecurse nosync nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc i64 @ZSTD_HcFindBestMatch_dedicatedDictSearch_4(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readnone captures(address) %2, ptr nofree noundef nonnull writeonly captures(none) %3) unnamed_addr #8 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 256
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 128
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !39   ; 5 uses
  ...
  %.val13 = load i32, ptr %1, align 1, !tbaa !45
  %i.ak = mul i32 %.val13, -1640531535
  %i.al = sub i32 34, %i.aj
  ...
  %i.ba = sub i32 32, %i.aw                       ; 5 uses
  %.fr = freeze i32 %i.as
  %.not.i.i = icmp eq i32 %.fr, 0
  %i.bb = icmp ult i32 %i.az, %i.q                ; 2 uses
  br i1 %.not.i.i, label %.split.us, label %.split

.split.us:                                        ; preds = %bb.a
  br i1 %i.bb, label %.lr.ph.preheader, label %.split53.us

.lr.ph.preheader:                                 ; preds = %.split.us
  %i.bc = zext i32 %i.az to i64                   ; 6 uses
  %i.bd = and i64 %i.p, 4294967295                ; 2 uses
  %i.be = zext nneg i32 %i.ax to i64              ; 3 uses
  %i.bf = sub i64 %i.p, %i.bc
  %.neg = add nuw nsw i64 %i.bc, 1
  %xtraiter = and i64 %i.bf, 1
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol

.lr.ph.prol:                                      ; preds = %.lr.ph.preheader
  %i.bg = getelementptr inbounds nuw i8, ptr %i.i, i64 %i.bc
  %.val11.us.prol = load i32, ptr %i.bg, align 1, !tbaa !45
  %i.bh = mul i32 %.val11.us.prol, -1640531535
  %i.bi = lshr i32 %i.bh, %i.ba
  %i.bj = zext i32 %i.bi to i64
  %i.bk = getelementptr inbounds nuw [4 x i8], ptr %i.au, i64 %i.bj ; 2 uses
  %i.bl = load i32, ptr %i.bk, align 4, !tbaa !45
  %i.bm = and i64 %i.bc, %i.be
  %i.bn = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.bm
  store i32 %i.bl, ptr %i.bn, align 4, !tbaa !45
  store i32 %i.az, ptr %i.bk, align 4, !tbaa !45
  %indvars.iv.next.prol = add nuw nsw i64 %i.bc, 1
  br label %.lr.ph.prol.loopexit

.lr.ph.prol.loopexit:                             ; preds = %.lr.ph.prol, %.lr.ph.preheader
  %indvars.iv.unr = phi i64 [ %i.bc, %.lr.ph.preheader ], [ %indvars.iv.next.prol, %.lr.ph.prol ]
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  %.val11.us = load i32, ptr %i.bp, align 1, !tbaa !45
  %i.bq = mul i32 %.val11.us, -1640531535
  %i.br = lshr i32 %i.bq, %i.ba
  %i.bs = zext i32 %i.br to i64
  %i.bt = getelementptr inbounds nuw [4 x i8], ptr %i.au, i64 %i.bs ; 2 uses
  %i.bu = load i32, ptr %i.bt, align 4, !tbaa !45
  %i.bv = trunc nuw i64 %indvars.iv to i32
  %i.bw = and i64 %indvars.iv, %i.be
  %i.bx = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.bw
  store i32 %i.bu, ptr %i.bx, align 4, !tbaa !45
  store i32 %i.bv, ptr %i.bt, align 4, !tbaa !45
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 3 uses
  %i.by = getelementptr inbounds nuw i8, ptr %i.i, i64 %indvars.iv.next
  %.val11.us.1 = load i32, ptr %i.by, align 1, !tbaa !45
  %i.bz = mul i32 %.val11.us.1, -1640531535
  %i.ca = lshr i32 %i.bz, %i.ba
  %i.cb = zext i32 %i.ca to i64
  %i.cc = getelementptr inbounds nuw [4 x i8], ptr %i.au, i64 %i.cb ; 2 uses
  %i.cd = load i32, ptr %i.cc, align 4, !tbaa !45
  %i.ce = trunc nuw i64 %indvars.iv.next to i32
  %i.cf = and i64 %indvars.iv.next, %i.be
  %i.cg = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.cf
  store i32 %i.cd, ptr %i.cg, align 4, !tbaa !45
  store i32 %i.ce, ptr %i.cc, align 4, !tbaa !45
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %i.ch = icmp samesign ult i64 %indvars.iv.next.1, %i.bd
  br i1 %i.ch, label %.lr.ph, label %.split53.us

.split:                                           ; preds = %bb.a
  br i1 %i.bb, label %bb.b, label %.split53.us

bb.b:                                             ; preds = %.split
end_hunk_26
begin_hunk_27_@ZSTD_RowFindBestMatch_dedicatedDictSearch_4_4:bb.a
...
.lr.ph62.new:                                     ; preds = %.prol.loopexit, %.lr.ph62.new
  ...
  store i32 %i.dz, ptr %i.eg, align 4, !tbaa !45
  ...
  %.val11.1 = load i32, ptr %i.eh, align 1, !tbaa !45
  ...
  store i32 %i.ek, ptr %i.er, align 4, !tbaa !45
  ...
  br i1 %exitcond114.not.1, label %ZSTD_row_update_internal.exit.i, label %.lr.ph62.new, !llvm.loop !5

ZSTD_row_update_internal.exit.i:                  ; preds = %.prol.loopexit, %.lr.ph62.new, %bb.f, %bb.b
  ...
  %i.ev = load ptr, ptr %i.j, align 8, !tbaa !37
  %i.ew = icmp ult i32 %.0.i284.i, %i.s
  br i1 %i.ew, label %.lr.ph64, label %ZSTD_row_update_internalImpl.exit287.i

.lr.ph64:                                         ; preds = %ZSTD_row_update_internal.exit.i
...
bb.g:                                             ; preds = %.lr.ph64, %bb.g
  ...
  %i.fa = load i64, ptr %i.ag, align 8, !tbaa !52
  ...
  %.val12 = load i32, ptr %i.fc, align 1, !tbaa !45
  ...
  %i.fp = load i32, ptr %i.fo, align 4, !tbaa !45 ; 2 uses
  store i32 %i.fg, ptr %i.fo, align 4, !tbaa !45
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.g, %ZSTD_row_update_internal.exit.i
  ...
  %.val13 = load i32, ptr %i.gk, align 1, !tbaa !45
  ...
  %i.gx = load i32, ptr %i.gw, align 4, !tbaa !45
...
bb.h:                                             ; preds = %bb.a
  ...
  store i32 %i.s, ptr %i.hc, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.h, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.hb, %bb.h ], [ %i.gx, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.hd = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.he = load i32, ptr %i.hd, align 8, !tbaa !86
  %i.hf = add i32 %i.he, %.0257.i
  store i32 %i.hf, ptr %i.hd, align 8, !tbaa !86
  ...
  %i.hl = load i8, ptr %i.hk, align 1, !tbaa !53  ; 2 uses
  ...
  %i.hq = load <16 x i8>, ptr %i.hk, align 1, !tbaa !53
...
.lr.ph69.preheader:                               ; preds = %ZSTD_row_getSSEMask.exit
  %i.ht = zext i8 %i.hl to i16
  %i.hu = tail call i16 @llvm.fshr.i16(i16 %i.hs, i16 %i.hs, i16 %i.ht)
...
._crit_edge:                                      ; preds = %bb.k, %bb.i, %ZSTD_row_getSSEMask.exit
  %.0262.i.lcssa = phi i32 [ %i.ai, %ZSTD_row_getSSEMask.exit ], [ %.0262.i66, %bb.i ], [ %.1263.i.ph, %bb.k ]
  %.0249.i.lcssa = phi i64 [ 0, %ZSTD_row_getSSEMask.exit ], [ %.0249.i67, %bb.i ], [ %.1250.i.ph, %bb.k ] ; 2 uses
...
bb.l:                                             ; preds = %.lr.ph77, %ZSTD_count.exit.thread
  %.0248.i75 = phi i64 [ 0, %.lr.ph77 ], [ %i.ks, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i74 = phi i64 [ 3, %.lr.ph77 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 5 uses
  %i.jg = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i75
  %i.jh = load i32, ptr %i.jg, align 4, !tbaa !45 ; 2 uses
  ...
  %i.jl = getelementptr inbounds i8, ptr %i.jk, i64 -3
  %.val4 = load i32, ptr %i.jl, align 1, !tbaa !45
  %i.jm = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i74
  %i.jn = getelementptr inbounds i8, ptr %i.jm, i64 -3
  %.val = load i32, ptr %i.jn, align 1, !tbaa !45
...
bb.n:                                             ; preds = %bb.m
  %.val60.i = load i64, ptr %i.jj, align 1, !tbaa !46 ; 2 uses
  %.val.i = load i64, ptr %1, align 1, !tbaa !46  ; 2 uses
...
bb.w:                                             ; preds = %bb.v
  %i.ki = load i8, ptr %.4.i, align 1, !tbaa !53
  %i.kj = load i8, ptr %.453.i, align 1, !tbaa !53
...
bb.y:                                             ; preds = %ZSTD_count.exit
  ...
  store i64 %i.kp, ptr %3, align 8, !tbaa !46
...
._crit_edge78:                                    ; preds = %ZSTD_count.exit.thread, %bb.y, %._crit_edge
  ...
  %i.ku = load ptr, ptr %i.kt, align 8, !tbaa !37 ; 15 uses
  %i.kv = load ptr, ptr %i.ak, align 8, !tbaa !79 ; 3 uses
  %i.kw = load ptr, ptr %i.as, align 8, !tbaa !38
  ...
  %i.lc = load i32, ptr %i.lb, align 4, !tbaa !45
  ...
  %i.lg = load i32, ptr %i.lf, align 4, !tbaa !45
...
end_hunk_27
begin_hunk_28_@ZSTD_RowFindBestMatch_dedicatedDictSearch_4_5:bb.a
  br label %.prol.loopexit
...
.lr.ph62.new:                                     ; preds = %.prol.loopexit, %.lr.ph62.new
  ...
  store i32 %i.eb, ptr %i.ej, align 4, !tbaa !45
  %indvars.iv.next112 = add nuw nsw i64 %indvars.iv111, 1 ; 2 uses
  %i.ek = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv.next112
  %.val11.1 = load i32, ptr %i.ek, align 1, !tbaa !45
  ...
  store i32 %i.en, ptr %i.ev, align 4, !tbaa !45
  %indvars.iv.next112.1 = add nuw nsw i64 %indvars.iv111, 2 ; 2 uses
  %lftr.wideiv.1 = trunc i64 %indvars.iv.next112.1 to i32
...
ZSTD_row_update_internal.exit.i:                  ; preds = %.prol.loopexit, %.lr.ph62.new, %bb.f, %bb.b
  ...
  %i.ez = load ptr, ptr %i.j, align 8, !tbaa !37
  %i.fa = icmp ult i32 %.0.i284.i, %i.s
  br i1 %i.fa, label %.lr.ph64, label %ZSTD_row_update_internalImpl.exit287.i
...
bb.g:                                             ; preds = %.lr.ph64, %bb.g
  ...
  %i.fu = load i32, ptr %i.ft, align 4, !tbaa !45 ; 2 uses
  store i32 %i.fk, ptr %i.ft, align 4, !tbaa !45
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.g, %ZSTD_row_update_internal.exit.i
  ...
  %.val13 = load i32, ptr %i.gp, align 1, !tbaa !45
  ...
  store i32 %i.gu, ptr %i.hc, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit
...
bb.h:                                             ; preds = %bb.a
  ...
  store i32 %i.s, ptr %i.hi, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.h, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.hh, %bb.h ], [ %i.hd, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.hj = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.hk = load i32, ptr %i.hj, align 8, !tbaa !86
  %i.hl = add i32 %i.hk, %.0257.i
  store i32 %i.hl, ptr %i.hj, align 8, !tbaa !86
...
.lr.ph69:                                         ; preds = %.lr.ph69.preheader, %bb.k
  ...
  %i.ik = load i32, ptr %i.ij, align 4, !tbaa !45 ; 3 uses
...
bb.l:                                             ; preds = %.lr.ph77, %ZSTD_count.exit.thread
  %.0248.i75 = phi i64 [ 0, %.lr.ph77 ], [ %i.la, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i74 = phi i64 [ 3, %.lr.ph77 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 5 uses
  %i.jo = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i75
  %i.jp = load i32, ptr %i.jo, align 4, !tbaa !45 ; 2 uses
...
bb.n:                                             ; preds = %bb.m
  %.val60.i = load i64, ptr %i.jr, align 1, !tbaa !46 ; 2 uses
  %.val.i = load i64, ptr %1, align 1, !tbaa !46  ; 2 uses
  %.not.i16 = icmp eq i64 %.val60.i, %.val.i
  br i1 %.not.i16, label %.preheader.i, label %bb.o
...
bb.w:                                             ; preds = %bb.v
  %i.kq = load i8, ptr %.4.i, align 1, !tbaa !53
  %i.kr = load i8, ptr %.453.i, align 1, !tbaa !53
...
bb.y:                                             ; preds = %ZSTD_count.exit
  ...
  store i64 %i.kx, ptr %3, align 8, !tbaa !46
...
._crit_edge78:                                    ; preds = %ZSTD_count.exit.thread, %bb.y, %._crit_edge
  ...
  %i.lc = load ptr, ptr %i.lb, align 8, !tbaa !37 ; 15 uses
  %i.ld = load ptr, ptr %i.ak, align 8, !tbaa !79 ; 3 uses
  %i.le = load ptr, ptr %i.as, align 8, !tbaa !38
  ...
  %i.lk = load i32, ptr %i.lj, align 4, !tbaa !45
  ...
  %i.lo = load i32, ptr %i.ln, align 4, !tbaa !45
  ...
  %.neg = sub i32 %.neg107.i.i.neg, %i.m          ; 2 uses
end_hunk_28
begin_hunk_29_@ZSTD_RowFindBestMatch_dedicatedDictSearch_4_6:bb.a
...
ZSTD_row_update_internal.exit.i:                  ; preds = %bb.g, %bb.f, %bb.b
  ...
  br i1 %i.ed, label %.lr.ph64, label %ZSTD_row_update_internalImpl.exit287.i

.lr.ph64:                                         ; preds = %ZSTD_row_update_internal.exit.i
  %i.ee = sub i32 24, %i.dz
  %i.ef = zext i32 %.0.i284.i to i64
  %i.eg = and i64 %i.r, 4294967295
  br label %bb.h

bb.h:                                             ; preds = %.lr.ph64, %bb.h
  %indvars.iv115 = phi i64 [ %i.ef, %.lr.ph64 ], [ %indvars.iv.next116, %bb.h ] ; 4 uses
  %i.eh = load i64, ptr %i.ag, align 8, !tbaa !52
  %i.ei = getelementptr inbounds nuw i8, ptr %i.ec, i64 %indvars.iv115
  %i.ej = getelementptr inbounds nuw i8, ptr %i.ei, i64 8
  %i.ek = trunc i64 %i.eh to i32
  %.val12 = load i32, ptr %i.ej, align 1, !tbaa !45
  %i.el = mul i32 %.val12, -1640531535
  %i.em = xor i32 %i.el, %i.ek
  %i.en = lshr i32 %i.em, %i.ee                   ; 2 uses
  %i.eo = lshr i32 %i.en, 2
  %i.ep = and i32 %i.eo, 1073741760
  %i.eq = zext nneg i32 %i.ep to i64              ; 2 uses
  %i.er = getelementptr inbounds nuw [4 x i8], ptr %i.eb, i64 %i.eq ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.er, i32 0, i32 3, i32 1)
  %i.es = getelementptr inbounds nuw i8, ptr %i.er, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.es, i32 0, i32 3, i32 1)
  %i.et = getelementptr inbounds nuw i8, ptr %i.ea, i64 %i.eq ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.et, i32 0, i32 3, i32 1)
  %i.eu = getelementptr inbounds nuw i8, ptr %i.et, i64 32
  tail call void @llvm.prefetch.p0(ptr nonnull %i.eu, i32 0, i32 3, i32 1)
  %i.ev = trunc nuw i64 %indvars.iv115 to i32
  %i.ew = and i64 %indvars.iv115, 7
  %i.ex = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.ew ; 2 uses
  %i.ey = load i32, ptr %i.ex, align 4, !tbaa !45 ; 2 uses
  store i32 %i.en, ptr %i.ex, align 4, !tbaa !45
  %i.ez = lshr i32 %i.ey, 2
  %i.fa = and i32 %i.ez, 1073741760
  %i.fb = zext nneg i32 %i.fa to i64              ; 2 uses
  %i.fc = getelementptr inbounds nuw [4 x i8], ptr %i.eb, i64 %i.fb
  %i.fd = getelementptr inbounds nuw i8, ptr %i.ea, i64 %i.fb ; 3 uses
  %i.fe = load i8, ptr %i.fd, align 1, !tbaa !53
  %i.ff = add i8 %i.fe, 63
  %i.fg = and i8 %i.ff, 63                        ; 2 uses
  %i.fh = zext nneg i8 %i.fg to i32
  %i.fi = icmp eq i8 %i.fg, 0
  %i.fj = select i1 %i.fi, i32 63, i32 0
  %i.fk = add nuw nsw i32 %i.fj, %i.fh            ; 2 uses
  %i.fl = trunc nuw nsw i32 %i.fk to i8
  store i8 %i.fl, ptr %i.fd, align 1, !tbaa !53
  %i.fm = trunc i32 %i.ey to i8
  %i.fn = zext nneg i32 %i.fk to i64              ; 2 uses
  %i.fo = getelementptr inbounds nuw i8, ptr %i.fd, i64 %i.fn
  store i8 %i.fm, ptr %i.fo, align 1, !tbaa !53
  %i.fp = getelementptr inbounds nuw [4 x i8], ptr %i.fc, i64 %i.fn
  store i32 %i.ev, ptr %i.fp, align 4, !tbaa !45
  %indvars.iv.next116 = add nuw nsw i64 %indvars.iv115, 1 ; 2 uses
  %i.fq = icmp samesign ult i64 %indvars.iv.next116, %i.eg
  br i1 %i.fq, label %bb.h, label %ZSTD_row_update_internalImpl.exit287.i, !llvm.loop !0

ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.h, %ZSTD_row_update_internal.exit.i
  store i32 %i.s, ptr %i.bb, align 4, !tbaa !41
  %i.fr = and i64 %i.r, 4294967295
  %i.fs = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.fr
  %i.ft = getelementptr inbounds nuw i8, ptr %i.fs, i64 8
  %i.fu = trunc i64 %i.ah to i32
  %.val13 = load i32, ptr %i.ft, align 1, !tbaa !45
  %i.fv = mul i32 %.val13, -1640531535
  %i.fw = xor i32 %i.fv, %i.fu
  %i.fx = sub i32 24, %i.h
  %i.fy = lshr i32 %i.fw, %i.fx                   ; 2 uses
  %i.fz = lshr i32 %i.fy, 2
  %i.ga = and i32 %i.fz, 1073741760
  %i.gb = zext nneg i32 %i.ga to i64              ; 2 uses
  %i.gc = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.gb ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.gc, i32 0, i32 3, i32 1)
  %i.gd = getelementptr inbounds nuw i8, ptr %i.gc, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.gd, i32 0, i32 3, i32 1)
  %i.ge = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.gb ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.ge, i32 0, i32 3, i32 1)
  %i.gf = getelementptr inbounds nuw i8, ptr %i.ge, i64 32
  tail call void @llvm.prefetch.p0(ptr nonnull %i.gf, i32 0, i32 3, i32 1)
  %i.gg = and i64 %i.r, 7
  %i.gh = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.gg ; 2 uses
  %i.gi = load i32, ptr %i.gh, align 4, !tbaa !45
  store i32 %i.fy, ptr %i.gh, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit

bb.i:                                             ; preds = %bb.a
  %i.gj = trunc i64 %i.ah to i32
  %i.gk = xor i32 %i.an, %i.gj
  %i.gl = sub i32 24, %i.h
  %i.gm = lshr i32 %i.gk, %i.gl
  %i.gn = getelementptr inbounds nuw i8, ptr %0, i64 44
  store i32 %i.s, ptr %i.gn, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.i, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.gm, %bb.i ], [ %i.gi, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.go = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.gp = load i32, ptr %i.go, align 8, !tbaa !86
  %i.gq = add i32 %i.gp, %.0257.i
  store i32 %i.gq, ptr %i.go, align 8, !tbaa !86
  %i.gr = lshr i32 %.0257.i, 2
  %i.gs = and i32 %i.gr, 1073741760
  %i.gt = zext nneg i32 %i.gs to i64              ; 2 uses
  %i.gu = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.gt ; 7 uses
  %i.gv = load i8, ptr %i.gu, align 1, !tbaa !53  ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #12
  %i.gw = trunc i32 %.0257.i to i8                ; 2 uses
  %i.gx = insertelement <16 x i8> poison, i8 %i.gw, i64 0
  %i.gy = shufflevector <16 x i8> %i.gx, <16 x i8> poison, <16 x i32> zeroinitializer ; 4 uses
  %i.gz = load <16 x i8>, ptr %i.gu, align 1, !tbaa !53
  %i.ha = icmp eq <16 x i8> %i.gz, %i.gy
  %i.hb = bitcast <16 x i1> %i.ha to i16
  %i.hc = getelementptr inbounds nuw i8, ptr %i.gu, i64 16
  %i.hd = load <16 x i8>, ptr %i.hc, align 1, !tbaa !53
  %i.he = icmp eq <16 x i8> %i.hd, %i.gy
  %i.hf = bitcast <16 x i1> %i.he to i16
  %i.hg = getelementptr inbounds nuw i8, ptr %i.gu, i64 32
  %i.hh = load <16 x i8>, ptr %i.hg, align 1, !tbaa !53
  %i.hi = icmp eq <16 x i8> %i.hh, %i.gy
  %i.hj = bitcast <16 x i1> %i.hi to i16
  %i.hk = getelementptr inbounds nuw i8, ptr %i.gu, i64 48
  %i.hl = load <16 x i8>, ptr %i.hk, align 1, !tbaa !53
  %i.hm = icmp eq <16 x i8> %i.hl, %i.gy
  %i.hn = bitcast <16 x i1> %i.hm to i16
  %i.ho = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.gt ; 2 uses
  %i.hp = zext i8 %i.gv to i32                    ; 2 uses
  %i.hq = insertelement <4 x i16> poison, i16 %i.hb, i64 0
  %i.hr = insertelement <4 x i16> %i.hq, i16 %i.hf, i64 1
  %i.hs = insertelement <4 x i16> %i.hr, i16 %i.hj, i64 2
  %i.ht = insertelement <4 x i16> %i.hs, i16 %i.hn, i64 3
  %i.hu = bitcast <4 x i16> %i.ht to i64          ; 3 uses
  %.not101 = icmp eq i64 %i.hu, 0
  br i1 %.not101, label %._crit_edge, label %.lr.ph69.preheader

.lr.ph69.preheader:                               ; preds = %ZSTD_row_getSSEMask.exit
  %i.hv = zext i8 %i.gv to i64
  %i.hw = tail call i64 @llvm.fshr.i64(i64 %i.hu, i64 %i.hu, i64 %i.hv)
  br label %.lr.ph69

.lr.ph69:                                         ; preds = %.lr.ph69.preheader, %bb.l
  %.0247.i68 = phi i64 [ %i.im, %bb.l ], [ %i.hw, %.lr.ph69.preheader ] ; 3 uses
  %.0249.i67 = phi i64 [ %.1250.i.ph, %bb.l ], [ 0, %.lr.ph69.preheader ] ; 4 uses
  %.0262.i66 = phi i32 [ %.1263.i.ph, %bb.l ], [ %i.ai, %.lr.ph69.preheader ] ; 3 uses
  %i.hx = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, 0) %.0247.i68, i1 true)
  %i.hy = trunc nuw nsw i64 %i.hx to i32
  %i.hz = add nuw nsw i32 %i.hy, %i.hp
  %i.ia = and i32 %i.hz, 63                       ; 2 uses
  %i.ib = zext nneg i32 %i.ia to i64
  %i.ic = getelementptr inbounds nuw [4 x i8], ptr %i.ho, i64 %i.ib
  %i.id = load i32, ptr %i.ic, align 4, !tbaa !45 ; 3 uses
  %i.ie = icmp eq i32 %i.ia, 0
  br i1 %i.ie, label %bb.l, label %bb.j

bb.j:                                             ; preds = %.lr.ph69
  %i.if = icmp ult i32 %i.id, %i.ad
  br i1 %i.if, label %._crit_edge, label %bb.k
...
bb.l:                                             ; preds = %bb.k, %.lr.ph69
  %.1263.i.ph = phi i32 [ %.0262.i66, %.lr.ph69 ], [ %i.ik, %bb.k ] ; 3 uses
  %.1250.i.ph = phi i64 [ %.0249.i67, %.lr.ph69 ], [ %i.ii, %bb.k ] ; 2 uses
  %i.il = add i64 %.0247.i68, -1
...
._crit_edge:                                      ; preds = %bb.l, %bb.j, %ZSTD_row_getSSEMask.exit
  %.0262.i.lcssa = phi i32 [ %i.ai, %ZSTD_row_getSSEMask.exit ], [ %.0262.i66, %bb.j ], [ %.1263.i.ph, %bb.l ]
  %.0249.i.lcssa = phi i64 [ 0, %ZSTD_row_getSSEMask.exit ], [ %.0249.i67, %bb.j ], [ %.1250.i.ph, %bb.l ] ; 2 uses
  %i.iq = add nuw nsw i32 %i.hp, 63
  %i.ir = and i32 %i.iq, 63                       ; 2 uses
  %i.is = icmp eq i32 %i.ir, 0
  %i.it = select i1 %i.is, i32 63, i32 0
  %i.iu = add nuw nsw i32 %i.it, %i.ir            ; 2 uses
  %i.iv = trunc nuw nsw i32 %i.iu to i8
  store i8 %i.iv, ptr %i.gu, align 1, !tbaa !53
  %i.iw = zext nneg i32 %i.iu to i64              ; 2 uses
  %i.ix = getelementptr inbounds nuw i8, ptr %i.gu, i64 %i.iw
  store i8 %i.gw, ptr %i.ix, align 1, !tbaa !53
  ...
  %i.jb = getelementptr inbounds nuw [4 x i8], ptr %i.ho, i64 %i.iw
  store i32 %i.iz, ptr %i.jb, align 4, !tbaa !45
  %.not102 = icmp eq i64 %.0249.i.lcssa, 0
  br i1 %.not102, label %._crit_edge78, label %.lr.ph77
...
bb.m:                                             ; preds = %.lr.ph77, %ZSTD_count.exit.thread
  %.0248.i75 = phi i64 [ 0, %.lr.ph77 ], [ %i.kt, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i74 = phi i64 [ 3, %.lr.ph77 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 5 uses
  %i.jh = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i75
  %i.ji = load i32, ptr %i.jh, align 4, !tbaa !45 ; 2 uses
  ...
  %.val4 = load i32, ptr %i.jm, align 1, !tbaa !45
  %i.jn = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i74
  %i.jo = getelementptr inbounds i8, ptr %i.jn, i64 -3
  %.val = load i32, ptr %i.jo, align 1, !tbaa !45
...
bb.o:                                             ; preds = %bb.n
  %.val60.i = load i64, ptr %i.jk, align 1, !tbaa !46 ; 2 uses
  %.val.i = load i64, ptr %1, align 1, !tbaa !46  ; 2 uses
  %.not.i16 = icmp eq i64 %.val60.i, %.val.i
...
bb.x:                                             ; preds = %bb.w
  %i.kj = load i8, ptr %.4.i, align 1, !tbaa !53
  %i.kk = load i8, ptr %.453.i, align 1, !tbaa !53
...
bb.z:                                             ; preds = %ZSTD_count.exit
  ...
  store i64 %i.kq, ptr %3, align 8, !tbaa !46
...
._crit_edge78:                                    ; preds = %ZSTD_count.exit.thread, %bb.z, %._crit_edge
  ...
  %i.kv = load ptr, ptr %i.ku, align 8, !tbaa !37 ; 15 uses
  %i.kw = load ptr, ptr %i.ak, align 8, !tbaa !79 ; 3 uses
  %i.kx = load ptr, ptr %i.as, align 8, !tbaa !38
  ...
  %i.ld = load i32, ptr %i.lc, align 4, !tbaa !45
  ...
  %i.lh = load i32, ptr %i.lg, align 4, !tbaa !45
  ...
  %.neg = sub i32 %.neg107.i.i.neg, %i.m          ; 2 uses
end_hunk_29
begin_hunk_30_@ZSTD_RowFindBestMatch_dedicatedDictSearch_5_4:bb.a
...
.lr.ph62.new:                                     ; preds = %.prol.loopexit, %.lr.ph62.new
  ...
  %i.ef = and i64 %indvars.iv111, 7
  %i.eg = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.ef
  store i32 %i.ea, ptr %i.eg, align 4, !tbaa !45
  %indvars.iv.next112 = add nuw nsw i64 %indvars.iv111, 1 ; 2 uses
  %i.eh = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv.next112
  %.val11.1 = load i64, ptr %i.eh, align 1, !tbaa !46
  ...
  %i.eq = and i64 %indvars.iv.next112, 7
  %i.er = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.eq
  store i32 %i.el, ptr %i.er, align 4, !tbaa !45
  %indvars.iv.next112.1 = add nuw nsw i64 %indvars.iv111, 2 ; 2 uses
  %lftr.wideiv.1 = trunc i64 %indvars.iv.next112.1 to i32
  %exitcond114.not.1 = icmp eq i32 %i.df, %lftr.wideiv.1
  br i1 %exitcond114.not.1, label %ZSTD_row_update_internal.exit.i, label %.lr.ph62.new, !llvm.loop !5
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.g, %ZSTD_row_update_internal.exit.i
  ...
  %i.gj = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.gi
  %i.gk = getelementptr inbounds nuw i8, ptr %i.gj, i64 8
  %.val13 = load i64, ptr %i.gk, align 1, !tbaa !46
  ...
  %i.gw = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.gv ; 2 uses
  %i.gx = load i32, ptr %i.gw, align 4, !tbaa !45
  store i32 %i.gq, ptr %i.gw, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit
...
bb.h:                                             ; preds = %bb.a
  ...
  store i32 %i.s, ptr %i.hd, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.h, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.hc, %bb.h ], [ %i.gx, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.he = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.hf = load i32, ptr %i.he, align 8, !tbaa !86
  %i.hg = add i32 %i.hf, %.0257.i
  store i32 %i.hg, ptr %i.he, align 8, !tbaa !86
  ...
  %i.hm = load i8, ptr %i.hl, align 1, !tbaa !53  ; 2 uses
  ...
  %i.hr = load <16 x i8>, ptr %i.hl, align 1, !tbaa !53
...
.lr.ph69.preheader:                               ; preds = %ZSTD_row_getSSEMask.exit
  ...
  %i.hv = tail call i16 @llvm.fshr.i16(i16 %i.ht, i16 %i.ht, i16 %i.hu)
...
._crit_edge:                                      ; preds = %bb.k, %bb.i, %ZSTD_row_getSSEMask.exit
  ...
  %i.iu = add nuw nsw i32 %i.it, %i.ir            ; 2 uses
  %i.iv = trunc nuw nsw i32 %i.iu to i8
  store i8 %i.iv, ptr %i.hl, align 1, !tbaa !53
  %i.iw = zext nneg i32 %i.iu to i64              ; 2 uses
  %i.ix = getelementptr inbounds nuw i8, ptr %i.hl, i64 %i.iw
  store i8 %i.ho, ptr %i.ix, align 1, !tbaa !53
  %i.iy = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 2 uses
  %i.iz = load i32, ptr %i.iy, align 4, !tbaa !41 ; 2 uses
  %i.ja = add i32 %i.iz, 1
  store i32 %i.ja, ptr %i.iy, align 4, !tbaa !41
...
._crit_edge78:                                    ; preds = %ZSTD_count.exit.thread, %bb.y, %._crit_edge
  ...
  %.neg = sub i32 %.neg107.i.i.neg, %i.m          ; 2 uses
end_hunk_30
begin_hunk_31_@ZSTD_RowFindBestMatch_dedicatedDictSearch_5_5:bb.a
...
.lr.ph62.new:                                     ; preds = %.prol.loopexit, %.lr.ph62.new
  ...
  %i.ei = and i64 %indvars.iv111, 7
  %i.ej = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.ei
  store i32 %i.ec, ptr %i.ej, align 4, !tbaa !45
  %indvars.iv.next112 = add nuw nsw i64 %indvars.iv111, 1 ; 2 uses
  %i.ek = getelementptr inbounds nuw i8, ptr %i.k, i64 %indvars.iv.next112
  %.val11.1 = load i64, ptr %i.ek, align 1, !tbaa !46
  ...
  %i.eu = and i64 %indvars.iv.next112, 7
  %i.ev = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.eu
  store i32 %i.eo, ptr %i.ev, align 4, !tbaa !45
  %indvars.iv.next112.1 = add nuw nsw i64 %indvars.iv111, 2 ; 2 uses
  %lftr.wideiv.1 = trunc i64 %indvars.iv.next112.1 to i32
  %exitcond114.not.1 = icmp eq i32 %i.dg, %lftr.wideiv.1
  br i1 %exitcond114.not.1, label %ZSTD_row_update_internal.exit.i, label %.lr.ph62.new, !llvm.loop !5
...
bb.g:                                             ; preds = %.lr.ph64, %bb.g
  ...
  %i.ft = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.fs ; 2 uses
  %i.fu = load i32, ptr %i.ft, align 4, !tbaa !45 ; 2 uses
  store i32 %i.fl, ptr %i.ft, align 4, !tbaa !45
  %i.fv = lshr i32 %i.fu, 3
  %i.fw = and i32 %i.fv, 536870880
  %i.fx = zext nneg i32 %i.fw to i64              ; 2 uses
  %i.fy = getelementptr inbounds nuw [4 x i8], ptr %i.ey, i64 %i.fx
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.g, %ZSTD_row_update_internal.exit.i
  ...
  %i.go = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.gn
  %i.gp = getelementptr inbounds nuw i8, ptr %i.go, i64 8
  %.val13 = load i64, ptr %i.gp, align 1, !tbaa !46
  ...
  %i.hc = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.hb ; 2 uses
  %i.hd = load i32, ptr %i.hc, align 4, !tbaa !45
  store i32 %i.gv, ptr %i.hc, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit
...
bb.h:                                             ; preds = %bb.a
  ...
  store i32 %i.s, ptr %i.hj, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.h, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.hi, %bb.h ], [ %i.hd, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
...
.lr.ph69:                                         ; preds = %.lr.ph69.preheader, %bb.k
  ...
  %i.il = load i32, ptr %i.ik, align 4, !tbaa !45 ; 3 uses
...
bb.l:                                             ; preds = %.lr.ph77, %ZSTD_count.exit.thread
  %.0248.i75 = phi i64 [ 0, %.lr.ph77 ], [ %i.lb, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i74 = phi i64 [ 3, %.lr.ph77 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 5 uses
  %i.jp = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i75
  %i.jq = load i32, ptr %i.jp, align 4, !tbaa !45 ; 2 uses
  ...
  %.val4 = load i32, ptr %i.ju, align 1, !tbaa !45
  %i.jv = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i74
  %i.jw = getelementptr inbounds i8, ptr %i.jv, i64 -3
  %.val = load i32, ptr %i.jw, align 1, !tbaa !45
...
bb.n:                                             ; preds = %bb.m
  %.val60.i = load i64, ptr %i.js, align 1, !tbaa !46 ; 2 uses
  %.val.i = load i64, ptr %1, align 1, !tbaa !46  ; 2 uses
  %.not.i16 = icmp eq i64 %.val60.i, %.val.i
  br i1 %.not.i16, label %.preheader.i, label %bb.o
...
bb.w:                                             ; preds = %bb.v
  %i.kr = load i8, ptr %.4.i, align 1, !tbaa !53
  %i.ks = load i8, ptr %.453.i, align 1, !tbaa !53
...
bb.y:                                             ; preds = %ZSTD_count.exit
  ...
  store i64 %i.ky, ptr %3, align 8, !tbaa !46
...
._crit_edge78:                                    ; preds = %ZSTD_count.exit.thread, %bb.y, %._crit_edge
  ...
  %i.ld = load ptr, ptr %i.lc, align 8, !tbaa !37 ; 15 uses
  %i.le = load ptr, ptr %i.ak, align 8, !tbaa !79 ; 3 uses
  %i.lf = load ptr, ptr %i.as, align 8, !tbaa !38
  ...
  %i.ll = load i32, ptr %i.lk, align 4, !tbaa !45
  ...
  %i.lp = load i32, ptr %i.lo, align 4, !tbaa !45
  ...
  %.neg = sub i32 %.neg107.i.i.neg, %i.m          ; 2 uses
end_hunk_31
begin_hunk_32_@ZSTD_RowFindBestMatch_dedicatedDictSearch_5_6:bb.a
...
.lr.ph64:                                         ; preds = %ZSTD_row_update_internal.exit.i
  %i.ee = sub i32 56, %i.dz
  %i.ef = zext nneg i32 %i.ee to i64
  %i.eg = zext i32 %.0.i284.i to i64
  %i.eh = and i64 %i.r, 4294967295
  br label %bb.h

bb.h:                                             ; preds = %.lr.ph64, %bb.h
  %indvars.iv115 = phi i64 [ %i.eg, %.lr.ph64 ], [ %indvars.iv.next116, %bb.h ] ; 4 uses
  %i.ei = load i64, ptr %i.ag, align 8, !tbaa !52
  %i.ej = getelementptr inbounds nuw i8, ptr %i.ec, i64 %indvars.iv115
  %i.ek = getelementptr inbounds nuw i8, ptr %i.ej, i64 8
  %.val12 = load i64, ptr %i.ek, align 1, !tbaa !46
  %i.el = mul i64 %.val12, -3523014627271114752
  %i.em = xor i64 %i.el, %i.ei
  %i.en = lshr i64 %i.em, %i.ef                   ; 2 uses
  %i.eo = trunc i64 %i.en to i32
  %i.ep = lshr i64 %i.en, 2
  %i.eq = and i64 %i.ep, 1073741760               ; 2 uses
  %i.er = getelementptr inbounds nuw [4 x i8], ptr %i.eb, i64 %i.eq ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.er, i32 0, i32 3, i32 1)
  %i.es = getelementptr inbounds nuw i8, ptr %i.er, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.es, i32 0, i32 3, i32 1)
  ...
  %i.ex = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.ew ; 2 uses
  %i.ey = load i32, ptr %i.ex, align 4, !tbaa !45 ; 2 uses
  store i32 %i.eo, ptr %i.ex, align 4, !tbaa !45
  %i.ez = lshr i32 %i.ey, 2
  %i.fa = and i32 %i.ez, 1073741760
  %i.fb = zext nneg i32 %i.fa to i64              ; 2 uses
  %i.fc = getelementptr inbounds nuw [4 x i8], ptr %i.eb, i64 %i.fb
  ...
  store i32 %i.ev, ptr %i.fp, align 4, !tbaa !45
  %indvars.iv.next116 = add nuw nsw i64 %indvars.iv115, 1 ; 2 uses
  %i.fq = icmp samesign ult i64 %indvars.iv.next116, %i.eh
  br i1 %i.fq, label %bb.h, label %ZSTD_row_update_internalImpl.exit287.i, !llvm.loop !0
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.h, %ZSTD_row_update_internal.exit.i
  ...
  %i.fs = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.fr
  %i.ft = getelementptr inbounds nuw i8, ptr %i.fs, i64 8
  %.val13 = load i64, ptr %i.ft, align 1, !tbaa !46
  %i.fu = mul i64 %.val13, -3523014627271114752
  %i.fv = xor i64 %i.fu, %i.ah
  %i.fw = sub i32 56, %i.h
  %i.fx = zext nneg i32 %i.fw to i64
  %i.fy = lshr i64 %i.fv, %i.fx                   ; 2 uses
  %i.fz = trunc i64 %i.fy to i32
  %i.ga = lshr i64 %i.fy, 2
  %i.gb = and i64 %i.ga, 1073741760               ; 2 uses
  %i.gc = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.gb ; 2 uses
  tail call void @llvm.prefetch.p0(ptr %i.gc, i32 0, i32 3, i32 1)
  %i.gd = getelementptr inbounds nuw i8, ptr %i.gc, i64 64
  tail call void @llvm.prefetch.p0(ptr nonnull %i.gd, i32 0, i32 3, i32 1)
  ...
  %i.gh = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.gg ; 2 uses
  %i.gi = load i32, ptr %i.gh, align 4, !tbaa !45
  store i32 %i.fz, ptr %i.gh, align 4, !tbaa !45
  br label %ZSTD_row_getSSEMask.exit

bb.i:                                             ; preds = %bb.a
  %i.gj = xor i64 %i.an, %i.ah
  %i.gk = sub i32 56, %i.h
  ...
  store i32 %i.s, ptr %i.go, align 4, !tbaa !41
  br label %ZSTD_row_getSSEMask.exit

ZSTD_row_getSSEMask.exit:                         ; preds = %bb.i, %ZSTD_row_update_internalImpl.exit287.i
  %.0257.i = phi i32 [ %i.gn, %bb.i ], [ %i.gi, %ZSTD_row_update_internalImpl.exit287.i ] ; 3 uses
  %i.gp = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.gq = load i32, ptr %i.gp, align 8, !tbaa !86
  %i.gr = add i32 %i.gq, %.0257.i
  store i32 %i.gr, ptr %i.gp, align 8, !tbaa !86
  %i.gs = lshr i32 %.0257.i, 2
  %i.gt = and i32 %i.gs, 1073741760
  %i.gu = zext nneg i32 %i.gt to i64              ; 2 uses
  %i.gv = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.gu ; 7 uses
  %i.gw = load i8, ptr %i.gv, align 1, !tbaa !53  ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #12
  %i.gx = trunc i32 %.0257.i to i8                ; 2 uses
  %i.gy = insertelement <16 x i8> poison, i8 %i.gx, i64 0
  %i.gz = shufflevector <16 x i8> %i.gy, <16 x i8> poison, <16 x i32> zeroinitializer ; 4 uses
  %i.ha = load <16 x i8>, ptr %i.gv, align 1, !tbaa !53
  %i.hb = icmp eq <16 x i8> %i.ha, %i.gz
  %i.hc = bitcast <16 x i1> %i.hb to i16
  %i.hd = getelementptr inbounds nuw i8, ptr %i.gv, i64 16
  %i.he = load <16 x i8>, ptr %i.hd, align 1, !tbaa !53
  %i.hf = icmp eq <16 x i8> %i.he, %i.gz
  %i.hg = bitcast <16 x i1> %i.hf to i16
  %i.hh = getelementptr inbounds nuw i8, ptr %i.gv, i64 32
  %i.hi = load <16 x i8>, ptr %i.hh, align 1, !tbaa !53
  %i.hj = icmp eq <16 x i8> %i.hi, %i.gz
  %i.hk = bitcast <16 x i1> %i.hj to i16
  %i.hl = getelementptr inbounds nuw i8, ptr %i.gv, i64 48
  %i.hm = load <16 x i8>, ptr %i.hl, align 1, !tbaa !53
  %i.hn = icmp eq <16 x i8> %i.hm, %i.gz
  %i.ho = bitcast <16 x i1> %i.hn to i16
  %i.hp = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.gu ; 2 uses
  %i.hq = zext i8 %i.gw to i32                    ; 2 uses
  %i.hr = insertelement <4 x i16> poison, i16 %i.hc, i64 0
  %i.hs = insertelement <4 x i16> %i.hr, i16 %i.hg, i64 1
  %i.ht = insertelement <4 x i16> %i.hs, i16 %i.hk, i64 2
  %i.hu = insertelement <4 x i16> %i.ht, i16 %i.ho, i64 3
  %i.hv = bitcast <4 x i16> %i.hu to i64          ; 3 uses
  %.not101 = icmp eq i64 %i.hv, 0
  br i1 %.not101, label %._crit_edge, label %.lr.ph69.preheader

.lr.ph69.preheader:                               ; preds = %ZSTD_row_getSSEMask.exit
  %i.hw = zext i8 %i.gw to i64
  %i.hx = tail call i64 @llvm.fshr.i64(i64 %i.hv, i64 %i.hv, i64 %i.hw)
  br label %.lr.ph69

.lr.ph69:                                         ; preds = %.lr.ph69.preheader, %bb.l
  %.0247.i68 = phi i64 [ %i.in, %bb.l ], [ %i.hx, %.lr.ph69.preheader ] ; 3 uses
  %.0249.i67 = phi i64 [ %.1250.i.ph, %bb.l ], [ 0, %.lr.ph69.preheader ] ; 4 uses
  %.0262.i66 = phi i32 [ %.1263.i.ph, %bb.l ], [ %i.ai, %.lr.ph69.preheader ] ; 3 uses
  %i.hy = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, 0) %.0247.i68, i1 true)
  %i.hz = trunc nuw nsw i64 %i.hy to i32
  %i.ia = add nuw nsw i32 %i.hz, %i.hq
  %i.ib = and i32 %i.ia, 63                       ; 2 uses
  %i.ic = zext nneg i32 %i.ib to i64
  %i.id = getelementptr inbounds nuw [4 x i8], ptr %i.hp, i64 %i.ic
  %i.ie = load i32, ptr %i.id, align 4, !tbaa !45 ; 3 uses
  %i.if = icmp eq i32 %i.ib, 0
  br i1 %i.if, label %bb.l, label %bb.j

bb.j:                                             ; preds = %.lr.ph69
  %i.ig = icmp ult i32 %i.ie, %i.ad
  br i1 %i.ig, label %._crit_edge, label %bb.k
...
bb.l:                                             ; preds = %bb.k, %.lr.ph69
  %.1263.i.ph = phi i32 [ %.0262.i66, %.lr.ph69 ], [ %i.il, %bb.k ] ; 3 uses
  %.1250.i.ph = phi i64 [ %.0249.i67, %.lr.ph69 ], [ %i.ij, %bb.k ] ; 2 uses
  %i.im = add i64 %.0247.i68, -1
  %i.in = and i64 %i.im, %.0247.i68               ; 2 uses
  %i.io = icmp ne i64 %i.in, 0
  %i.ip = icmp ne i32 %.1263.i.ph, 0
  %i.iq = select i1 %i.io, i1 %i.ip, i1 false
  br i1 %i.iq, label %.lr.ph69, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %bb.l, %bb.j, %ZSTD_row_getSSEMask.exit
  %.0262.i.lcssa = phi i32 [ %i.ai, %ZSTD_row_getSSEMask.exit ], [ %.0262.i66, %bb.j ], [ %.1263.i.ph, %bb.l ]
  %.0249.i.lcssa = phi i64 [ 0, %ZSTD_row_getSSEMask.exit ], [ %.0249.i67, %bb.j ], [ %.1250.i.ph, %bb.l ] ; 2 uses
  %i.ir = add nuw nsw i32 %i.hq, 63
  %i.is = and i32 %i.ir, 63                       ; 2 uses
  %i.it = icmp eq i32 %i.is, 0
  %i.iu = select i1 %i.it, i32 63, i32 0
  %i.iv = add nuw nsw i32 %i.iu, %i.is            ; 2 uses
  %i.iw = trunc nuw nsw i32 %i.iv to i8
  store i8 %i.iw, ptr %i.gv, align 1, !tbaa !53
  %i.ix = zext nneg i32 %i.iv to i64              ; 2 uses
  %i.iy = getelementptr inbounds nuw i8, ptr %i.gv, i64 %i.ix
  store i8 %i.gx, ptr %i.iy, align 1, !tbaa !53
  %i.iz = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 2 uses
  %i.ja = load i32, ptr %i.iz, align 4, !tbaa !41 ; 2 uses
  %i.jb = add i32 %i.ja, 1
  store i32 %i.jb, ptr %i.iz, align 4, !tbaa !41
  %i.jc = getelementptr inbounds nuw [4 x i8], ptr %i.hp, i64 %i.ix
  store i32 %i.ja, ptr %i.jc, align 4, !tbaa !45
  %.not102 = icmp eq i64 %.0249.i.lcssa, 0
  br i1 %.not102, label %._crit_edge78, label %.lr.ph77
...
bb.m:                                             ; preds = %.lr.ph77, %ZSTD_count.exit.thread
  %.0248.i75 = phi i64 [ 0, %.lr.ph77 ], [ %i.ku, %ZSTD_count.exit.thread ] ; 2 uses
  %.0258.i74 = phi i64 [ 3, %.lr.ph77 ], [ %.2260.i.ph, %ZSTD_count.exit.thread ] ; 5 uses
  %i.ji = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.0248.i75
  %i.jj = load i32, ptr %i.ji, align 4, !tbaa !45 ; 2 uses
  %i.jk = zext i32 %i.jj to i64
  %i.jl = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.jk ; 4 uses
  %i.jm = getelementptr inbounds nuw i8, ptr %i.jl, i64 %.0258.i74
  %i.jn = getelementptr inbounds i8, ptr %i.jm, i64 -3
  %.val4 = load i32, ptr %i.jn, align 1, !tbaa !45
  %i.jo = getelementptr inbounds nuw i8, ptr %1, i64 %.0258.i74
  %i.jp = getelementptr inbounds i8, ptr %i.jo, i64 -3
  %.val = load i32, ptr %i.jp, align 1, !tbaa !45
...
bb.x:                                             ; preds = %bb.w
  %i.kk = load i8, ptr %.4.i, align 1, !tbaa !53
  %i.kl = load i8, ptr %.453.i, align 1, !tbaa !53
  %i.km = icmp eq i8 %i.kk, %i.kl
  %spec.select.idx.i = zext i1 %i.km to i64
  %spec.select.i15 = getelementptr inbounds nuw i8, ptr %.453.i, i64 %spec.select.idx.i
...
._crit_edge78:                                    ; preds = %ZSTD_count.exit.thread, %bb.z, %._crit_edge
  ...
  %i.kw = load ptr, ptr %i.kv, align 8, !tbaa !37 ; 15 uses
  %i.kx = load ptr, ptr %i.ak, align 8, !tbaa !79 ; 3 uses
  %i.ky = load ptr, ptr %i.as, align 8, !tbaa !38
  ...
  %i.le = load i32, ptr %i.ld, align 4, !tbaa !45
  ...
  %i.li = load i32, ptr %i.lh, align 4, !tbaa !45
  ...
  %.neg = sub i32 %.neg107.i.i.neg, %i.m          ; 2 uses
end_hunk_32
begin_hunk_33_@ZSTD_RowFindBestMatch_dedicatedDictSearch_6_4:bb.a
  %i.dq = and i64 %i.dp, 268435440                ; 2 uses
  %i.dr = getelementptr inbounds nuw [4 x i8], ptr %i.cs, i64 %i.dq
  tail call void @llvm.prefetch.p0(ptr %i.dr, i32 0, i32 3, i32 1)
  %i.ds = getelementptr inbounds nuw i8, ptr %i.cr, i64 %i.dq
...
._crit_edge78:                                    ; preds = %ZSTD_count.exit.thread, %bb.y, %._crit_edge
  ...
  %.neg = sub i32 %.neg107.i.i.neg, %i.m          ; 2 uses
end_hunk_33
begin_hunk_34_@ZSTD_RowFindBestMatch_dedicatedDictSearch_6_5:bb.a
...
._crit_edge78:                                    ; preds = %ZSTD_count.exit.thread, %bb.y, %._crit_edge
  ...
  %.neg = sub i32 %.neg107.i.i.neg, %i.m          ; 2 uses
end_hunk_34
begin_hunk_35_@ZSTD_RowFindBestMatch_dedicatedDictSearch_6_6:bb.a
  %i.dk = sub i32 56, %i.cs
  %i.dl = zext nneg i32 %i.dk to i64
  br label %bb.g
...
bb.h:                                             ; preds = %.lr.ph64, %bb.h
  ...
  %i.ek = getelementptr inbounds nuw i8, ptr %i.ej, i64 8
  %.val12 = load i64, ptr %i.ek, align 1, !tbaa !46
  %i.el = mul i64 %.val12, -3523014627193847808
  %i.em = xor i64 %i.el, %i.ei
  %i.en = lshr i64 %i.em, %i.ef                   ; 2 uses
  %i.eo = trunc i64 %i.en to i32
  %i.ep = lshr i64 %i.en, 2
...
ZSTD_row_update_internalImpl.exit287.i:           ; preds = %bb.h, %ZSTD_row_update_internal.exit.i
  ...
  %i.ft = getelementptr inbounds nuw i8, ptr %i.fs, i64 8
  %.val13 = load i64, ptr %i.ft, align 1, !tbaa !46
  %i.fu = mul i64 %.val13, -3523014627193847808
  %i.fv = xor i64 %i.fu, %i.ah
  %i.fw = sub i32 56, %i.h
  %i.fx = zext nneg i32 %i.fw to i64
  %i.fy = lshr i64 %i.fv, %i.fx                   ; 2 uses
