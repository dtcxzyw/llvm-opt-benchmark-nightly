...
bb.a:
  ...
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !38   ; 16 uses
  ...
  %i.o = load i32, ptr %i.n, align 4, !tbaa !41   ; 5 uses
  %i.p = sub i32 %i.f, %i.o
...
bb.b:                                             ; preds = %.lr.ph, %ZSTD_hashPtr.exit141._crit_edge
  %indvars.iv = phi i64 [ %i.am, %.lr.ph ], [ %indvars.iv.next, %ZSTD_hashPtr.exit141._crit_edge ] ; 5 uses
  %i.aq = getelementptr inbounds nuw i8, ptr %i.b, i64 %indvars.iv ; 5 uses
  %i.ar = load i32, ptr %i.ai, align 8, !tbaa !44
...
bb.c:                                             ; preds = %bb.b
  %.val = load i32, ptr %i.aq, align 1, !tbaa !45
...
bb.h:                                             ; preds = %ZSTD_hashPtr.exit141
  ...
  store i32 %i.be, ptr %i.bg, align 4, !tbaa !45
...
ZSTD_hashPtr.exit141._crit_edge:                  ; preds = %ZSTD_hashPtr.exit141, %bb.h
  ...
  store i32 %i.bi, ptr %i.bh, align 4, !tbaa !45
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.bj = icmp samesign ult i64 %indvars.iv.next, %i.ao
  br i1 %i.bj, label %bb.b, label %.preheader164, !llvm.loop !87
...
.lr.ph174:                                        ; preds = %bb.i
  ...
  %.0116 = load i32, ptr %i.bp, align 4, !tbaa !45 ; 3 uses
...
.lr.ph174.1:                                      ; preds = %.lr.ph174
  ...
  %.0116.1 = load i32, ptr %i.bu, align 4, !tbaa !45 ; 3 uses
  %.not273 = icmp ult i32 %.0116.1, %i.ag
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader.new
  ...
  %i.dd = load i32, ptr %i.dc, align 4, !tbaa !45
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %scevgep, i8 0, i64 12, i1 false), !tbaa !45
  %i.de = shl i32 %i.da, 2
  %i.df = or disjoint i32 %i.de, 3
  %i.dg = zext i32 %i.df to i64
  %i.dh = getelementptr inbounds nuw [4 x i8], ptr %i.h, i64 %i.dg
  store i32 %i.dd, ptr %i.dh, align 4, !tbaa !45
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %scevgep.1, i8 0, i64 12, i1 false), !tbaa !45
  %i.ds = shl i32 %i.do, 2
  %i.dt = or disjoint i32 %i.ds, 3
  %i.du = zext i32 %i.dt to i64
  %i.dv = getelementptr inbounds nuw [4 x i8], ptr %i.h, i64 %i.du
  store i32 %i.dr, ptr %i.dv, align 4, !tbaa !45
  %indvars.iv.next213.1 = add nuw nsw i64 %indvars.iv212, 2
  %niter.next.1 = add i32 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i32 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.unr-lcssa, label %.preheader, !llvm.loop !90
...
.preheader.epil.preheader:                        ; preds = %.preheader.preheader
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %i.h, i8 0, i64 12, i1 false), !tbaa !45
  %i.ea = getelementptr inbounds nuw i8, ptr %i.h, i64 12
  store i32 %i.dz, ptr %i.ea, align 4, !tbaa !45
  br label %.unr-lcssa

.unr-lcssa:                                       ; preds = %.preheader, %.preheader.epil.preheader
  %i.eb = load i32, ptr %i.n, align 4, !tbaa !41  ; 2 uses
...
bb.m:                                             ; preds = %.lr.ph195, %ZSTD_hashPtr.exit
  %indvars.iv221 = phi i64 [ %i.eh, %.lr.ph195 ], [ %indvars.iv.next222, %ZSTD_hashPtr.exit ] ; 3 uses
  %i.ej = getelementptr inbounds nuw i8, ptr %i.b, i64 %indvars.iv221 ; 5 uses
  %i.ek = load i32, ptr %i.ed, align 8, !tbaa !44
...
bb.n:                                             ; preds = %bb.m
  %.val142 = load i32, ptr %i.ej, align 1, !tbaa !45
...
ZSTD_hashPtr.exit:                                ; preds = %bb.n, %bb.o, %bb.p, %bb.q, %bb.r
  ...
  %i.ey = load i64, ptr %scevgep217, align 4, !tbaa !45
  store i64 %i.ey, ptr %scevgep216, align 4, !tbaa !45
  %i.ez = shl i64 %.0.i, 2
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !38   ; 16 uses
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 264
  %i.f = load i32, ptr %i.e, align 8, !tbaa !48   ; 7 uses
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 128
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !39   ; 15 uses
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !37   ; 16 uses
  %i.k = ptrtoint ptr %1 to i64
  %i.l = ptrtoint ptr %i.j to i64
  %i.m = sub i64 %i.k, %i.l                       ; 7 uses
  %i.n = trunc i64 %i.m to i32                    ; 6 uses
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 44 ; 6 uses
  %i.p = load i32, ptr %i.o, align 4, !tbaa !41   ; 7 uses
