...
.lr.ph263.i:                                      ; preds = %.lr.ph263.i.preheader, %bb.bd
  %indvars.iv289.i = phi i64 [ %indvars.iv.next290.i, %bb.bd ], [ 1, %.lr.ph263.i.preheader ] ; 3 uses
  %.0146261.i = phi i32 [ %i.zu, %bb.bd ], [ 0, %.lr.ph263.i.preheader ] ; 2 uses
  ...
  br i1 %i.zw, label %._crit_edge.split.loop.exit334.i, label %bb.bd
...
bb.bd:                                            ; preds = %.lr.ph263.i
  ...
  br i1 %exitcond293.not.i, label %._crit_edge.i, label %.lr.ph263.i, !llvm.loop !87

._crit_edge.split.loop.exit334.i:                 ; preds = %.lr.ph263.i
  %7 = trunc nuw i64 %indvars.iv289.i to i32
  br label %._crit_edge.i

._crit_edge.i:                                    ; preds = %bb.bd, %._crit_edge.split.loop.exit334.i
  %.0146.lcssa.ph.i = phi i32 [ %.0146261.i, %._crit_edge.split.loop.exit334.i ], [ %i.zu, %bb.bd ]
  %.0145.lcssa.ph.i = phi i32 [ %7, %._crit_edge.split.loop.exit334.i ], [ %.pre.i, %bb.bd ] ; 2 uses
...
.lr.ph272.preheader.i:                            ; preds = %._crit_edge.i
  ...
  %wide.trip.count297.i = zext i32 %.0145.lcssa.ph.i to i64
  br label %.lr.ph272.i
...
.lr.ph272.i:                                      ; preds = %bb.be, %.lr.ph272.preheader.i
  ...
  %.0270.i = phi ptr [ %8, %.lr.ph272.preheader.i ], [ %i.aac, %bb.be ]
...
._crit_edge273.i:                                 ; preds = %bb.be, %._crit_edge.i
  %i.aag = zext i32 %.0146.lcssa.ph.i to i64
