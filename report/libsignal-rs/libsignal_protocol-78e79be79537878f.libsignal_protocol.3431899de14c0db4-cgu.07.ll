...
bb.a:
  ...
  %.val = load i64, ptr %i.c, align 8, !noundef !5 ; 2 uses
  %.sroa.0.0.i = tail call noundef i64 @llvm.umin.i64(i64 %.val, i64 10)
  %exitcond.not.a = icmp eq i64 %.val, 0
  br i1 %exitcond.not.a, label %bb.c, label %bb.d

bb.b:                                             ; preds = %bb.d
  %1 = add nuw nsw i64 %.sroa.04.020, 1           ; 2 uses
...
bb.d:                                             ; preds = %bb.a, %bb.b
  %.sroa.01.021 = phi i64 [ %i.h, %bb.b ], [ 0, %bb.a ]
  %.sroa.04.020 = phi i64 [ %1, %bb.b ], [ 0, %bb.a ] ; 3 uses
  %i.d = tail call noundef i8 @_RNvYRShNtNtNtCs17cqnTMcAHA_5bytes3buf8buf_impl3Buf6get_u8Cs4tP8yUXWbFU_18libsignal_protocol(ptr noalias nofree noundef nonnull align 8 dereferenceable(16) %0) ; 3 uses
  %i.e = and i8 %i.d, 127
  %i.f = zext nneg i8 %i.e to i64
  %3 = mul nuw nsw i64 %.sroa.04.020, 7
  %i.g = shl i64 %i.f, %3
  %i.h = or i64 %i.g, %.sroa.01.021               ; 2 uses
