...
bb.br:                                            ; preds = %bb.br, %.new
  ...
  %niter2183.next.3 = add i32 %niter2183, 4       ; 2 uses
...
.lr.ph290:                                        ; preds = %.lr.ph290.preheader, %bb.p
  %indvars.iv = phi i64 [ 0, %.lr.ph290.preheader ], [ %indvars.iv.next, %bb.p ] ; 2 uses
...
._crit_edge:                                      ; preds = %bb.p, %.lr.ph290, %bb.o
  %storemerge.lcssa = phi i32 [ 0, %bb.o ], [ %1, %.lr.ph290 ], [ %i.dl, %bb.p ] ; 2 uses
