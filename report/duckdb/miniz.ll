...
bb.ep:                                            ; preds = %bb.eo, %bb.en
  %.1111.i = phi ptr [ %i.ako, %bb.eo ], [ %.0110142.i, %bb.en ] ; 3 uses
  %.1.i = phi i32 [ %i.akr, %bb.eo ], [ %.0143.i, %bb.en ] ; 2 uses
  %i.aks = and i32 %.1.i, 1
  %.not.i4 = icmp eq i32 %i.aks, 0
  %2 = load i8, ptr %.1111.i, align 1, !tbaa !7   ; 3 uses
...
.loopexit.i6:                                     ; preds = %bb.ey, %bb.fb, %bb.ez, %._crit_edge136.i
  ...
  %.pn.i = phi i64 [ 1, %bb.ez ], [ 3, %._crit_edge136.i ], [ 1, %bb.fb ], [ 3, %bb.ey ]
  %.2.i = getelementptr inbounds nuw i8, ptr %.1111.i, i64 %.pn.i ; 2 uses
