...
bb.c:                                             ; preds = %bb.b, %._crit_edge
  %.pre-phi = phi i32 [ %i.j, %bb.b ], [ %.pre371, %._crit_edge ] ; 2 uses
  %.0239 = phi i16 [ %spec.select392, %bb.b ], [ 8, %._crit_edge ] ; 2 uses
  %i.k = and i32 %spec.store.select, 65536
  %.not275 = icmp eq i32 %i.k, 0
  %15 = or disjoint i16 %.0239, 2048
  %spec.select = select i1 %.not275, i16 %15, i16 %.0239 ; 3 uses
