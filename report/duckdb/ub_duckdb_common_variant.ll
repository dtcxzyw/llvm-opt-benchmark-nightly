...
.body140:                                         ; preds = %bb.i, %.body140.thread
  %eh.lpad-body141 = phi { ptr, i32 } [ %i.ad, %.body140.thread ], [ %i.aa, %bb.i ] ; 2 uses
...
.body:                                            ; preds = %bb.l, %.body140, %bb.r
  %.pn = phi { ptr, i32 } [ %i.ar, %bb.r ], [ %eh.lpad-body141, %.body140 ], [ %eh.lpad-body141, %bb.l ]
...
.body153:                                         ; preds = %bb.ag, %.body153.thread
  %eh.lpad-body154 = phi { ptr, i32 } [ %i.fd, %.body153.thread ], [ %i.fa, %bb.ag ] ; 2 uses
...
.body121:                                         ; preds = %bb.aj, %.body153, %bb.au
  %.pn74 = phi { ptr, i32 } [ %i.fz, %bb.au ], [ %eh.lpad-body154, %.body153 ], [ %eh.lpad-body154, %bb.aj ]
