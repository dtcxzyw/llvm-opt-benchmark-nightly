...
define void @_ZN6duckdb17LogicalCopyToFile11DeserializeERNS_12DeserializerE(ptr dead_on_unwind noalias writable writeonly sret(%"class.duckdb::unique_ptr.322") align 8 captures(none) %0, ptr noundef nonnull align 8 dereferenceable(632) %1) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
