...
bb.ah:                                            ; preds = %bb.ae, %bb.ad, %bb.r, %.loopexit120
  %.pn41 = phi { ptr, i32 } [ %i.ai, %bb.r ], [ %i.cg, %bb.ae ], [ %.pn38.pn, %bb.ad ], [ %lpad.loopexit.a, %.loopexit120 ]
  call void @_ZNSt6vectorIN6duckdb10unique_ptrINS0_16ParsedExpressionESt14default_deleteIS2_ELb1EEESaIS5_EED2Ev(ptr noundef nonnull align 8 dereferenceable(24) %10) #19
