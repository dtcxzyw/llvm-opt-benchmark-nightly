...
.body108:                                         ; preds = %bb.c, %.body108.thread
  %eh.lpad-body109 = phi { ptr, i32 } [ %i.p, %.body108.thread ], [ %i.m, %bb.c ] ; 2 uses
...
.body122:                                         ; preds = %bb.o, %.body122.thread
  %eh.lpad-body123 = phi { ptr, i32 } [ %i.as, %.body122.thread ], [ %i.ap, %bb.o ] ; 2 uses
...
.body:                                            ; preds = %bb.f, %.body108, %bb.ci
  %.pn21.pn.pn = phi { ptr, i32 } [ %.pn21.pn, %bb.ci ], [ %eh.lpad-body109, %.body108 ], [ %eh.lpad-body109, %bb.f ]
...
.body38:                                          ; preds = %bb.r, %.body122, %bb.cp
  %.pn26.pn.pn = phi { ptr, i32 } [ %.pn26.pn, %bb.cp ], [ %eh.lpad-body123, %.body122 ], [ %eh.lpad-body123, %bb.r ]
