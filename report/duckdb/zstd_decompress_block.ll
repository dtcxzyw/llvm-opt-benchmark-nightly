...
.preheader651.i.preheader:                        ; preds = %bb.da
  ...
  %umin = tail call i64 @llvm.umin.i64(i64 %.sroa.5322.0.copyload.i, i64 %i.zm)
  %i.abm = add i64 %i.abl, %umin
  %umax37 = tail call i64 @llvm.umax.i64(i64 %.sroa.5322.0.copyload.i, i64 %i.zm) ; 3 uses
  %i.abn = add i64 %i.abm, %umax37
...
.preheader655.i.preheader:                        ; preds = %bb.dv
  ...
  %umin117 = tail call i64 @llvm.umin.i64(i64 %.sroa.5485.0.copyload.i, i64 %i.aea)
  %i.aga = add i64 %i.afz, %umin117
  %umax118 = tail call i64 @llvm.umax.i64(i64 %.sroa.5485.0.copyload.i, i64 %i.aea) ; 3 uses
  %i.agb = add i64 %i.aga, %umax118
...
.preheader658.i.preheader:                        ; preds = %bb.ep
  ...
  %umin140 = tail call i64 @llvm.umin.i64(i64 %.sroa.5362.0.copyload.i, i64 %i.aij)
  %i.akj = add i64 %i.aki, %umin140
  %umax141 = tail call i64 @llvm.umax.i64(i64 %.sroa.5362.0.copyload.i, i64 %i.aij) ; 3 uses
  %i.akk = add i64 %i.akj, %umax141
...
.preheader641.i.preheader:                        ; preds = %bb.fu
  ...
  %umin164 = tail call i64 @llvm.umin.i64(i64 %.sroa.5403.0.copyload.i, i64 %i.aql)
  %i.asl = add i64 %i.ask, %umin164
  %umax165 = tail call i64 @llvm.umax.i64(i64 %.sroa.5403.0.copyload.i, i64 %i.aql) ; 3 uses
  %i.asm = add i64 %i.asl, %umax165
...
.preheader645.i.preheader:                        ; preds = %bb.go
  ...
  %umin267 = tail call i64 @llvm.umin.i64(i64 %.sroa.5526.0.copyload.i, i64 %i.aus)
  %i.aws = add i64 %i.awr, %umin267
  %umax268 = tail call i64 @llvm.umax.i64(i64 %.sroa.5526.0.copyload.i, i64 %i.aus) ; 3 uses
  %i.awt = add i64 %i.aws, %umax268
...
.preheader648.i.preheader:                        ; preds = %bb.hi
  ...
  %umin290 = tail call i64 @llvm.umin.i64(i64 %.sroa.5444.0.copyload.i, i64 %i.ayy)
  %i.bay = add i64 %i.bax, %umin290
  %umax291 = tail call i64 @llvm.umax.i64(i64 %.sroa.5444.0.copyload.i, i64 %i.ayy) ; 3 uses
  %i.baz = add i64 %i.bay, %umax291
...
.preheader261.i.preheader:                        ; preds = %bb.cu
  ...
  %umin188 = tail call i64 @llvm.umin.i64(i64 %.sink.i, i64 %i.we)
  %i.ye = add i64 %i.yd, %umin188
  %umax189 = tail call i64 @llvm.umax.i64(i64 %.sink.i, i64 %i.we) ; 3 uses
  %i.yf = add i64 %i.ye, %umax189
...
.preheader651.preheader:                          ; preds = %bb.cy
  ...
  %umin = tail call i64 @llvm.umin.i64(i64 %.sroa.5322.0.copyload, i64 %i.zl)
  %i.abl = add i64 %i.abk, %umin
  %umax30 = tail call i64 @llvm.umax.i64(i64 %.sroa.5322.0.copyload, i64 %i.zl) ; 3 uses
  %i.abm = add i64 %i.abl, %umax30
...
.preheader655.preheader:                          ; preds = %bb.dt
  ...
  %umin110 = tail call i64 @llvm.umin.i64(i64 %.sroa.5485.0.copyload, i64 %i.adz)
  %i.afz = add i64 %i.afy, %umin110
  %umax111 = tail call i64 @llvm.umax.i64(i64 %.sroa.5485.0.copyload, i64 %i.adz) ; 3 uses
  %i.aga = add i64 %i.afz, %umax111
...
.preheader658.preheader:                          ; preds = %bb.en
  ...
  %umin133 = tail call i64 @llvm.umin.i64(i64 %.sroa.5362.0.copyload, i64 %i.aii)
  %i.aki = add i64 %i.akh, %umin133
  %umax134 = tail call i64 @llvm.umax.i64(i64 %.sroa.5362.0.copyload, i64 %i.aii) ; 3 uses
  %i.akj = add i64 %i.aki, %umax134
...
.preheader641.preheader:                          ; preds = %bb.fs
  ...
  %umin157 = tail call i64 @llvm.umin.i64(i64 %.sroa.5403.0.copyload, i64 %i.aqk)
  %i.ask = add i64 %i.asj, %umin157
  %umax158 = tail call i64 @llvm.umax.i64(i64 %.sroa.5403.0.copyload, i64 %i.aqk) ; 3 uses
  %i.asl = add i64 %i.ask, %umax158
...
.preheader645.preheader:                          ; preds = %bb.gm
  ...
  %umin260 = tail call i64 @llvm.umin.i64(i64 %.sroa.5526.0.copyload, i64 %i.aur)
  %i.awr = add i64 %i.awq, %umin260
  %umax261 = tail call i64 @llvm.umax.i64(i64 %.sroa.5526.0.copyload, i64 %i.aur) ; 3 uses
  %i.aws = add i64 %i.awr, %umax261
...
.preheader648.preheader:                          ; preds = %bb.hg
  ...
  %umin283 = tail call i64 @llvm.umin.i64(i64 %.sroa.5444.0.copyload, i64 %i.ayx)
  %i.bax = add i64 %i.baw, %umin283
  %umax284 = tail call i64 @llvm.umax.i64(i64 %.sroa.5444.0.copyload, i64 %i.ayx) ; 3 uses
  %i.bay = add i64 %i.bax, %umax284
...
.preheader261.preheader:                          ; preds = %bb.cs
  ...
  %umin158 = tail call i64 @llvm.umin.i64(i64 %.sink, i64 %i.wf)
  %i.yf = add i64 %i.ye, %umin158
  %umax159 = tail call i64 @llvm.umax.i64(i64 %.sink, i64 %i.wf) ; 3 uses
  %i.yg = add i64 %i.yf, %umax159
