...
vector.ph237:                                     ; preds = %vector.memcheck229
  ...
  %i.cz = getelementptr i8, ptr %.157.i, i64 %5
  br label %vector.body240

vector.body240:                                   ; preds = %vector.body240, %vector.ph237
  %index241 = phi i64 [ 0, %vector.ph237 ], [ %index.next246, %vector.body240 ] ; 3 uses
  %offset.idx = shl i64 %index241, 4              ; 2 uses
  %next.gep242 = getelementptr i8, ptr %i.ax, i64 %offset.idx
  %next.gep244 = getelementptr i8, ptr %.157.i, i64 %offset.idx
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.bb = getelementptr i8, ptr %.157, i64 %5
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep114 = getelementptr i8, ptr %.157, i64 %offset.idx
