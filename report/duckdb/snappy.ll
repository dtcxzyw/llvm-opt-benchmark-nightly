...
pred.store.continue409:                           ; preds = %pred.store.continue, %pred.store.if408
...
pred.store.continue600:                           ; preds = %pred.store.continue, %pred.store.if599
...
pred.store.continue602:                           ; preds = %pred.store.continue600, %pred.store.if601
...
pred.store.continue604:                           ; preds = %pred.store.continue602, %pred.store.if603
  %index.next = add i64 %index, 4                 ; 2 uses
