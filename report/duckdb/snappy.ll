...
.thread167.loopexit:                              ; preds = %bb.q, %._crit_edge, %bb.t, %bb.f, %.thread, %bb.u, %bb.w, %.lr.ph, %.thread158
  %.pre189 = load ptr, ptr %i.a, align 8, !tbaa !128
  br label %.thread167
...
.thread179.loopexit:                              ; preds = %bb.r, %_ZN13duckdb_snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE6AppendEPKcmPPc.exit131, %bb.u, %bb.g, %.thread, %_ZN13duckdb_snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE14AppendFromSelfEmmPPc.exit, %bb.w, %_ZN13duckdb_snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE6AppendEPKcmPPc.exit, %.thread164
  %.pre199 = load ptr, ptr %i.a, align 8, !tbaa !128
  br label %.thread179
