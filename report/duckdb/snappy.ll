Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/duckdb/original/snappy?download=true
inline.NumInlined: 514
inline.NumDeleted: 215
loop-unroll.NumCompletelyUnrolled: 9
loop-unroll.NumRuntimeUnrolled: 2
loop-unroll.NumUnrolled: 11
begin_hunk_0_@_ZN13duckdb_snappy17SnappyIOVecWriter6AppendEPKcmPPc:bb.a
bb.e:                                             ; preds = %bb.d
  store ptr %i.m, ptr %i.g, align 8, !tbaa !51
  %i.o = load ptr, ptr %i.m, align 8, !tbaa !53   ; 2 uses
  ...
  store i64 %i.q, ptr %i.h, align 8, !tbaa !56
  br label %bb.f
...
bb.f:                                             ; preds = %bb.e, %._crit_edge21.i
  ...
  %i.t = load ptr, ptr %i.i, align 8, !tbaa !55
  %i.u = getelementptr inbounds nuw i8, ptr %i.t, i64 %.sroa.speculated.i
  store ptr %i.u, ptr %i.i, align 8, !tbaa !55
  %i.v = load i64, ptr %i.h, align 8, !tbaa !56
  %i.w = sub i64 %i.v, %.sroa.speculated.i        ; 2 uses
  store i64 %i.w, ptr %i.h, align 8, !tbaa !56
  %i.x = load i64, ptr %i.a, align 8, !tbaa !57
  %i.y = add i64 %i.x, %.sroa.speculated.i
  store i64 %i.y, ptr %i.a, align 8, !tbaa !57
  ...
  br i1 %.not.i, label %_ZN13duckdb_snappy17SnappyIOVecWriter13AppendNoCheckEPKcm.exit, label %bb.c, !llvm.loop !2
...
.lr.ph.preheader:                                 ; preds = %bb.b
  ...
  %i.m = load i64, ptr %i.l, align 8, !tbaa !56   ; 3 uses
  %i.n = sub i64 %i.k, %i.m
  br label %.lr.ph
...
bb.d:                                             ; preds = %.lr.ph
  ...
  br i1 %.not50, label %.loopexit, label %.lr.ph, !llvm.loop !149
...
.lr.ph88.split:                                   ; preds = %.outer, %.lr.ph88.lr.ph
  ...
  %.promoted = load ptr, ptr %i.h, align 8, !tbaa !51 ; 2 uses
...
.split.us:                                        ; preds = %bb.v, %.lr.ph88.split
  ...
  %i.v = load i64, ptr %i.u, align 8, !tbaa !54   ; 2 uses
...
.lr.ph.i:                                         ; preds = %.split.us
  %i.x = load ptr, ptr %.134.ph105, align 8, !tbaa !53
...
._crit_edge21.i:                                  ; preds = %bb.e
  %.pre22.i = load ptr, ptr %i.t, align 8, !tbaa !55
  br label %bb.h

bb.f:                                             ; preds = %bb.e
  %i.aa = load ptr, ptr %i.h, align 8, !tbaa !51  ; 2 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %i.aa, i64 16 ; 3 uses
  %i.ac = load ptr, ptr %0, align 8, !tbaa !50
...
bb.g:                                             ; preds = %bb.f
  store ptr %i.ab, ptr %i.h, align 8, !tbaa !51
  %i.ad = load ptr, ptr %i.ab, align 8, !tbaa !53 ; 2 uses
  store ptr %i.ad, ptr %i.t, align 8, !tbaa !55
  %i.ae = getelementptr inbounds nuw i8, ptr %i.aa, i64 24
  %i.af = load i64, ptr %i.ae, align 8, !tbaa !54 ; 2 uses
  store i64 %i.af, ptr %i.l, align 8, !tbaa !56
  br label %bb.h
...
bb.h:                                             ; preds = %bb.g, %._crit_edge21.i
  ...
  %i.ai = load ptr, ptr %i.t, align 8, !tbaa !55
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 %.sroa.speculated.i
  store ptr %i.aj, ptr %i.t, align 8, !tbaa !55
  %i.ak = load i64, ptr %i.l, align 8, !tbaa !56
  %i.al = sub i64 %i.ak, %.sroa.speculated.i      ; 4 uses
  store i64 %i.al, ptr %i.l, align 8, !tbaa !56
  %i.am = load i64, ptr %i.b, align 8, !tbaa !57
  ...
  br i1 %.not.i, label %_ZN13duckdb_snappy17SnappyIOVecWriter13AppendNoCheckEPKcm.exit, label %bb.e, !llvm.loop !2
...
bb.i:                                             ; preds = %.lr.ph101
  ...
  %i.au = load ptr, ptr %0, align 8, !tbaa !50
...
.split94.us:                                      ; preds = %.lr.ph101
  ...
  %i.av = load ptr, ptr %.134.ph105, align 8, !tbaa !53 ; 2 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %i.av, i64 %.2.ph107 ; 20 uses
  %i.ax = load ptr, ptr %i.t, align 8, !tbaa !55  ; 10 uses
...
bb.j:                                             ; preds = %.split94.us
  ...
  br i1 %.not.i58, label %iter.check, label %.lr.ph.i59, !prof !23
...
vector.body:                                      ; preds = %vector.ph, %vector.body
  ...
  store <16 x i8> %wide.load, ptr %next.gep175, align 1, !tbaa !11
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.bi = icmp eq i64 %index.next, %n.vec
  br i1 %i.bi, label %middle.block, label %vector.body, !llvm.loop !150
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load181 = load <4 x i8>, ptr %next.gep179, align 1, !tbaa !11
  store <4 x i8> %wide.load181, ptr %next.gep180, align 1, !tbaa !11
  %index.next182 = add nuw i64 %index178, 4       ; 2 uses
  %i.bl = icmp eq i64 %index.next182, %n.vec177
  br i1 %i.bl, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !151
...
.lr.ph.i59:                                       ; preds = %bb.j, %.lr.ph.i59
  ...
  br i1 %i.bo, label %.lr.ph.i59, label %._crit_edge.i, !llvm.loop !3

._crit_edge.i:                                    ; preds = %.lr.ph.i59
  %.not67.i = icmp ult ptr %i.bm, %i.ay
  br i1 %.not67.i, label %bb.k, label %.thread71, !prof !23
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  ...
  %i.bq = load i8, ptr %.08.i.i, align 1, !tbaa !11
  %i.br = getelementptr inbounds nuw i8, ptr %.057.i.i, i64 1 ; 2 uses
  store i8 %i.bq, ptr %.057.i.i, align 1, !tbaa !11
  %exitcond.not.i.i = icmp eq ptr %i.br, %i.ay
  br i1 %exitcond.not.i.i, label %.thread71, label %.lr.ph.i.i, !llvm.loop !152
...
bb.k:                                             ; preds = %._crit_edge.i, %.split94.us
  ...
  br i1 %.not68.i, label %bb.r, label %bb.l, !prof !23
...
vector.body230:                                   ; preds = %vector.body230, %vector.ph228
  ...
  %wide.load234 = load <2 x i64>, ptr %next.gep232, align 1, !alias.scope !162
  store <2 x i64> %wide.load234, ptr %next.gep233, align 1, !alias.scope !163, !noalias !162
  %index.next235 = add nuw i64 %index231, 1
  %i.cz = icmp eq i64 %index231, %i.cp
  br i1 %i.cz, label %._crit_edge91.i, label %vector.body230, !llvm.loop !156
...
vector.body195:                                   ; preds = %vector.ph193, %vector.body195
  ...
  %wide.load199 = load <16 x i8>, ptr %next.gep197, align 1, !tbaa !11
  store <16 x i8> %wide.load199, ptr %next.gep198, align 1, !tbaa !11
  %index.next200 = add nuw i64 %index196, 16      ; 2 uses
  %i.dp = icmp eq i64 %index.next200, %n.vec194
  br i1 %i.dp, label %middle.block201, label %vector.body195, !llvm.loop !158
...
vec.epilog.iter.check207:                         ; preds = %middle.block201
  ...
  br i1 %min.epilog.iters.check208, label %.lr.ph.i79.i.preheader, label %vec.epilog.ph209, !prof !115
...
vec.epilog.vector.body211:                        ; preds = %vec.epilog.vector.body211, %vec.epilog.ph209
  ...
  %wide.load215 = load <4 x i8>, ptr %next.gep213, align 1, !tbaa !11
  store <4 x i8> %wide.load215, ptr %next.gep214, align 1, !tbaa !11
  %index.next216 = add nuw i64 %index212, 4       ; 2 uses
  %i.ds = icmp eq i64 %index.next216, %n.vec210
  br i1 %i.ds, label %vec.epilog.middle.block217, label %vec.epilog.vector.body211, !llvm.loop !159
...
.lr.ph.i79.i:                                     ; preds = %.lr.ph.i79.i.preheader, %.lr.ph.i79.i
  ...
  %i.du = load i8, ptr %.08.i80.i, align 1, !tbaa !11
  %i.dv = getelementptr inbounds nuw i8, ptr %.057.i81.i, i64 1 ; 2 uses
  store i8 %i.du, ptr %.057.i81.i, align 1, !tbaa !11
  %exitcond.not.i82.i = icmp eq ptr %i.dv, %i.ay
  br i1 %exitcond.not.i82.i, label %.thread71, label %.lr.ph.i79.i, !llvm.loop !160
...
.thread71:                                        ; preds = %.lr.ph.i79.i, %.lr.ph.i.i, %middle.block201, %vec.epilog.middle.block217, %middle.block, %vec.epilog.middle.block, %bb.u, %._crit_edge91.i, %bb.q, %bb.p, %._crit_edge.i
  %i.dw = load ptr, ptr %i.t, align 8, !tbaa !55
  %i.dx = getelementptr inbounds nuw i8, ptr %i.dw, i64 %spec.select57
  store ptr %i.dx, ptr %i.t, align 8, !tbaa !55
  %i.dy = load i64, ptr %i.l, align 8, !tbaa !56
  %i.dz = sub i64 %i.dy, %spec.select57           ; 3 uses
  store i64 %i.dz, ptr %i.l, align 8, !tbaa !56
  %i.ea = add i64 %spec.select57, %.2.ph107
  %i.eb = load i64, ptr %i.b, align 8, !tbaa !57
  %i.ec = add i64 %i.eb, %spec.select57
  store i64 %i.ec, ptr %i.b, align 8, !tbaa !57
  br label %.outer

bb.v:                                             ; preds = %bb.i
  store ptr %i.at, ptr %i.h, align 8, !tbaa !51
  %i.ed = load ptr, ptr %i.at, align 8, !tbaa !53
  store ptr %i.ed, ptr %i.t, align 8, !tbaa !55
  %i.ee = getelementptr inbounds nuw i8, ptr %i.ar, i64 24
  %i.ef = load i64, ptr %i.ee, align 8, !tbaa !54 ; 4 uses
  store i64 %i.ef, ptr %i.l, align 8, !tbaa !56
  %.not53 = icmp eq ptr %.134.ph105, %i.at
  br i1 %.not53, label %.lr.ph101, label %.split.us

.outer:                                           ; preds = %.thread71, %_ZN13duckdb_snappy17SnappyIOVecWriter13AppendNoCheckEPKcm.exit
  %.pre.i132 = phi i64 [ %i.dz, %.thread71 ], [ %.pre.i129, %_ZN13duckdb_snappy17SnappyIOVecWriter13AppendNoCheckEPKcm.exit ]
  %.promoted102125 = phi i64 [ %i.dz, %.thread71 ], [ %.promoted102122, %_ZN13duckdb_snappy17SnappyIOVecWriter13AppendNoCheckEPKcm.exit ]
  %spec.select57.pn = phi i64 [ %spec.select57, %.thread71 ], [ %.sroa.speculated, %_ZN13duckdb_snappy17SnappyIOVecWriter13AppendNoCheckEPKcm.exit ]
  %.336 = phi ptr [ %.134.ph105, %.thread71 ], [ %spec.select, %_ZN13duckdb_snappy17SnappyIOVecWriter13AppendNoCheckEPKcm.exit ]
  %.5 = phi i64 [ %i.ea, %.thread71 ], [ %spec.select56, %_ZN13duckdb_snappy17SnappyIOVecWriter13AppendNoCheckEPKcm.exit ]
  %.267 = sub i64 %.0.ph104, %spec.select57.pn    ; 2 uses
  %.not52 = icmp eq i64 %.267, 0
  br i1 %.not52, label %.thread, label %.lr.ph88.split, !llvm.loop !161
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not, label %bb.c, label %.lr.ph, !prof !23
...
.lr.ph:                                           ; preds = %bb.b, %.lr.ph
  ...
  br i1 %i.j, label %.lr.ph, label %._crit_edge, !llvm.loop !3

._crit_edge:                                      ; preds = %.lr.ph
  %.not67 = icmp ult ptr %i.h, %2
  br i1 %.not67, label %bb.d, label %_ZN13duckdb_snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit, !prof !23

bb.c:                                             ; preds = %bb.b
  %i.k = icmp ult ptr %1, %2
  br i1 %i.k, label %iter.check160, label %_ZN13duckdb_snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit
...
vector.body149:                                   ; preds = %vector.ph147, %vector.body149
  ...
  %wide.load153 = load <16 x i8>, ptr %next.gep151, align 1, !tbaa !11
  store <16 x i8> %wide.load153, ptr %next.gep152, align 1, !tbaa !11
  %index.next154 = add nuw i64 %index150, 16      ; 2 uses
  %i.q = icmp eq i64 %index.next154, %n.vec148
  br i1 %i.q, label %middle.block155, label %vector.body149, !llvm.loop !164

middle.block155:                                  ; preds = %vector.body149
  %cmp.n156 = icmp eq i64 %i.l, %n.vec148
  br i1 %cmp.n156, label %_ZN13duckdb_snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit, label %vec.epilog.iter.check162

vec.epilog.iter.check162:                         ; preds = %middle.block155
  %min.epilog.iters.check163 = icmp eq i64 %i.n, 0
  br i1 %min.epilog.iters.check163, label %.lr.ph.i.preheader, label %vec.epilog.ph164, !prof !115
...
vec.epilog.vector.body166:                        ; preds = %vec.epilog.vector.body166, %vec.epilog.ph164
  ...
  %wide.load170 = load <4 x i8>, ptr %next.gep168, align 1, !tbaa !11
  store <4 x i8> %wide.load170, ptr %next.gep169, align 1, !tbaa !11
  %index.next171 = add nuw i64 %index167, 4       ; 2 uses
  %i.t = icmp eq i64 %index.next171, %n.vec165
  br i1 %i.t, label %vec.epilog.middle.block172, label %vec.epilog.vector.body166, !llvm.loop !165

vec.epilog.middle.block172:                       ; preds = %vec.epilog.vector.body166
  %cmp.n173 = icmp eq i64 %i.l, %n.vec165
  br i1 %cmp.n173, label %_ZN13duckdb_snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit, label %.lr.ph.i.preheader
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  %i.v = load i8, ptr %.08.i, align 1, !tbaa !11
  %i.w = getelementptr inbounds nuw i8, ptr %.057.i, i64 1 ; 2 uses
  store i8 %i.v, ptr %.057.i, align 1, !tbaa !11
  %exitcond.not.i = icmp eq ptr %i.w, %2
  br i1 %exitcond.not.i, label %_ZN13duckdb_snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit, label %.lr.ph.i, !llvm.loop !166
...
bb.d:                                             ; preds = %._crit_edge, %bb.a
  ...
  br i1 %.not68, label %bb.k, label %bb.e, !prof !23
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  br i1 %i.al, label %bb.j, label %_ZN13duckdb_snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %next.gep, align 1, !alias.scope !175
  store <2 x i64> %wide.load, ptr %next.gep112, align 1, !alias.scope !176, !noalias !175
  %index.next = add nuw i64 %index, 1
  %i.bd = icmp eq i64 %index, %i.at
  br i1 %i.bd, label %._crit_edge91, label %vector.body, !llvm.loop !170
...
.lr.ph90:                                         ; preds = %.lr.ph90.preheader178, %.lr.ph90
  ...
  br i1 %i.bi, label %.lr.ph90, label %._crit_edge91, !llvm.loop !171

bb.l:                                             ; preds = %._crit_edge91
  %i.bj = getelementptr inbounds i8, ptr %3, i64 -8
  %.not70 = icmp ugt ptr %.2.lcssa, %i.bj
  br i1 %.not70, label %bb.n, label %bb.m, !prof !20
...
vector.body122:                                   ; preds = %vector.ph120, %vector.body122
  ...
  %wide.load126 = load <16 x i8>, ptr %next.gep124, align 1, !tbaa !11
  store <16 x i8> %wide.load126, ptr %next.gep125, align 1, !tbaa !11
  %index.next127 = add nuw i64 %index123, 16      ; 2 uses
  %i.bs = icmp eq i64 %index.next127, %n.vec121
  br i1 %i.bs, label %middle.block128, label %vector.body122, !llvm.loop !172

middle.block128:                                  ; preds = %vector.body122
  %cmp.n129 = icmp eq i64 %i.bn, %n.vec121
  br i1 %cmp.n129, label %_ZN13duckdb_snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit, label %vec.epilog.iter.check

vec.epilog.iter.check:                            ; preds = %middle.block128
  %min.epilog.iters.check = icmp eq i64 %i.bp, 0
  br i1 %min.epilog.iters.check, label %.lr.ph.i79.preheader, label %vec.epilog.ph, !prof !115
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load136 = load <4 x i8>, ptr %next.gep134, align 1, !tbaa !11
  store <4 x i8> %wide.load136, ptr %next.gep135, align 1, !tbaa !11
  %index.next137 = add nuw i64 %index133, 4       ; 2 uses
  %i.bv = icmp eq i64 %index.next137, %n.vec132
  br i1 %i.bv, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !173

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n138 = icmp eq i64 %i.bn, %n.vec132
  br i1 %cmp.n138, label %_ZN13duckdb_snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit, label %.lr.ph.i79.preheader
...
.lr.ph.i79:                                       ; preds = %.lr.ph.i79.preheader, %.lr.ph.i79
  ...
  %i.bx = load i8, ptr %.08.i80, align 1, !tbaa !11
  %i.by = getelementptr inbounds nuw i8, ptr %.057.i81, i64 1 ; 2 uses
  store i8 %i.bx, ptr %.057.i81, align 1, !tbaa !11
  %exitcond.not.i82 = icmp eq ptr %i.by, %2
  br i1 %exitcond.not.i82, label %_ZN13duckdb_snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit, label %.lr.ph.i79, !llvm.loop !174

_ZN13duckdb_snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit: ; preds = %.lr.ph.i79, %.lr.ph.i, %middle.block128, %vec.epilog.middle.block, %middle.block155, %vec.epilog.middle.block172, %bb.n, %bb.c, %bb.j, %bb.i, %._crit_edge91, %._crit_edge
  ret ptr %2
}
...
bb.a:
  ...
  store ptr %i.j, ptr %i.k, align 8, !tbaa !108
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.n, label %bb.c, label %.thread192, !prof !20

bb.c:                                             ; preds = %bb.b
  %i.o = load ptr, ptr %i.b, align 8, !tbaa !37   ; 2 uses
  %i.p = load ptr, ptr %i.d, align 8, !tbaa !38   ; 2 uses
  ...
  store ptr %i.u, ptr %i.k, align 8, !tbaa !108
  br label %bb.d
...
.loopexit:                                        ; preds = %.loopexit.backedge, %bb.d
  ...
  %i.w = load ptr, ptr %i.d, align 8, !tbaa !38
  %i.x = add i64 %.0144, -1
  ...
  %i.ac = load ptr, ptr %i.k, align 8, !tbaa !108 ; 2 uses
  %.not116 = icmp ult ptr %i.z, %i.ac
  br i1 %.not116, label %bb.g, label %bb.e, !prof !20

bb.e:                                             ; preds = %.loopexit
  store ptr %i.z, ptr %i.b, align 8, !tbaa !37
  ...
  br i1 %i.ad, label %bb.f, label %.thread192, !prof !20

bb.f:                                             ; preds = %bb.e
  %i.ae = load ptr, ptr %i.b, align 8, !tbaa !37  ; 2 uses
  %i.af = load ptr, ptr %i.d, align 8, !tbaa !38  ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.at = load ptr, ptr %i.d, align 8, !tbaa !38
  %i.au = ptrtoint ptr %i.at to i64
  %i.av = icmp ugt i8 %i.am, -20
  br i1 %i.av, label %bb.i, label %bb.j, !prof !23
...
.lr.ph:                                           ; preds = %bb.j, %bb.l
  %.0213 = phi i64 [ %i.bw, %bb.l ], [ %i.bh, %bb.j ] ; 2 uses
  %.193211 = phi i64 [ %i.by, %bb.l ], [ %.092, %bb.j ]
  %.2146210 = phi i64 [ %i.bj, %bb.l ], [ %i.ab, %bb.j ]
  %i.bj = add i64 %.0213, %.2146210               ; 5 uses
  %i.bk = load i64, ptr %1, align 8, !tbaa !71
  %.not199 = icmp ugt i64 %i.bj, %i.bk
  br i1 %.not199, label %.thread192, label %bb.k

bb.k:                                             ; preds = %.lr.ph
  %i.bl = load ptr, ptr %0, align 8, !tbaa !39    ; 2 uses
  %i.bm = load i32, ptr %i.v, align 8, !tbaa !40
