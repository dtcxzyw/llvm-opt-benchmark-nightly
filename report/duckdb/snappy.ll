...
bb.p:                                             ; preds = %bb.o, %bb.n, %bb.m, %.preheader.3, %bb.l, %bb.k, %bb.j, %.preheader.2, %bb.i, %bb.h, %bb.g, %.preheader.1, %bb.f, %bb.e, %bb.d, %.preheader
  ...
  %.lcssa302.wide.a = phi i64 [ 0, %.preheader ], [ 1, %bb.d ], [ 2, %bb.e ], [ 3, %bb.f ], [ 4, %.preheader.1 ], [ 5, %bb.g ], [ 6, %bb.h ], [ 7, %bb.i ], [ 8, %.preheader.2 ], [ 9, %bb.j ], [ 10, %bb.k ], [ 11, %bb.l ], [ 12, %.preheader.3 ], [ 13, %bb.m ], [ 14, %bb.n ], [ 15, %bb.o ] ; 3 uses
  ...
  %.tr = trunc nuw nsw i64 %.lcssa302.wide.a to i8
  %5 = shl nuw nsw i8 %.tr, 2
  store i8 %5, ptr %.0117, align 1, !tbaa !7
