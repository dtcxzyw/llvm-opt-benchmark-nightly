...
begin_hunk_0_@_ZN13duckdb_snappy8internal26CompressFragmentDoubleHashEPKcmPcPtiS4_i:bb.a
.critedge2.loopexit.split.loop.exit.i332:         ; preds = %.lr.ph40.i329
  %i.no = trunc nuw i64 %indvars.iv48.i330 to i32
...
_ZN13duckdb_snappy8internalL20FindMatchLengthPlainEPKcS2_S2_.exit309: ; preds = %.critedge28.i333, %.critedge28.i306, %.critedge2.loopexit.split.loop.exit.i332, %.critedge.i319, %.critedge28.preheader.i324, %.critedge2.loopexit.split.loop.exit.i305, %.critedge.i292, %.critedge28.preheader.i297
  %.8209.in = phi i32 [ %i.ls, %.critedge28.i306 ], [ %i.mb, %.critedge.i292 ], [ %.026.lcssa.i298, %.critedge28.preheader.i297 ], [ %i.mh, %.critedge2.loopexit.split.loop.exit.i305 ], [ %i.ni, %.critedge.i319 ], [ %.026.lcssa.i325, %.critedge28.preheader.i324 ], [ %i.no, %.critedge2.loopexit.split.loop.exit.i332 ], [ %i.mz, %.critedge28.i333 ]
  %.8200 = phi ptr [ %i.lj, %.critedge28.i306 ], [ %i.lj, %.critedge.i292 ], [ %i.lj, %.critedge28.preheader.i297 ], [ %i.lj, %.critedge2.loopexit.split.loop.exit.i305 ], [ %i.mq, %.critedge.i319 ], [ %i.mq, %.critedge28.preheader.i324 ], [ %i.mq, %.critedge2.loopexit.split.loop.exit.i332 ], [ %i.mq, %.critedge28.i333 ]
...
.thread356:                                       ; preds = %.loopexit.loopexit, %bb.c, %_ZN13duckdb_snappyL8EmitCopyILb0EEEPcS1_mm.exit, %bb.b, %bb.a
  %.8 = phi ptr [ %.0176589, %bb.c ], [ %0, %bb.a ], [ %i.gp, %_ZN13duckdb_snappyL8EmitCopyILb0EEEPcS1_mm.exit ], [ %0, %bb.b ], [ %i.gp, %.loopexit.loopexit ] ; 3 uses
  %.5 = phi ptr [ %.0175591, %bb.c ], [ %2, %bb.a ], [ %.3, %_ZN13duckdb_snappyL8EmitCopyILb0EEEPcS1_mm.exit ], [ %2, %bb.b ], [ %.3, %.loopexit.loopexit ] ; 4 uses
  %i.np = icmp ult ptr %.8, %i.c
  br i1 %i.np, label %bb.af, label %bb.ai

bb.af:                                            ; preds = %.thread356
  %i.nq = ptrtoint ptr %i.c to i64
  %i.nr = ptrtoint ptr %.8 to i64
  %i.ns = sub i64 %i.nq, %i.nr                    ; 2 uses
  %i.nt = trunc i64 %i.ns to i32                  ; 2 uses
  %i.nu = add nsw i32 %i.nt, -1                   ; 3 uses
  %i.nv = icmp slt i32 %i.nt, 61
  br i1 %i.nv, label %bb.ag, label %bb.ah

bb.ag:                                            ; preds = %bb.af
  %.tr.i340 = trunc i32 %i.nu to i8
  %i.nw = shl i8 %.tr.i340, 2
  br label %_ZN13duckdb_snappyL11EmitLiteralILb0EEEPcS1_PKci.exit

bb.ah:                                            ; preds = %bb.af
  %i.nx = tail call range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.nu, i1 true)
  %i.ny = lshr i32 %i.nx, 3
  %i.nz = xor i32 %i.ny, 3                        ; 2 uses
  %.tr16.i = trunc nuw nsw i32 %i.nz to i8
  %i.oa = shl nuw nsw i8 %.tr16.i, 2
  %i.ob = or disjoint i8 %i.oa, -16
  %i.oc = getelementptr inbounds nuw i8, ptr %.5, i64 1 ; 2 uses
  store i32 %i.nu, ptr %i.oc, align 1
  %i.od = zext nneg i32 %i.nz to i64
  %i.oe = getelementptr i8, ptr %i.oc, i64 %i.od
  br label %_ZN13duckdb_snappyL11EmitLiteralILb0EEEPcS1_PKci.exit

_ZN13duckdb_snappyL11EmitLiteralILb0EEEPcS1_PKci.exit: ; preds = %bb.ag, %bb.ah
  %.sink.i337 = phi i8 [ %i.nw, %bb.ag ], [ %i.ob, %bb.ah ]
  %.pn.i338 = phi ptr [ %.5, %bb.ag ], [ %i.oe, %bb.ah ]
  store i8 %.sink.i337, ptr %.5, align 1, !tbaa !7
  %.0.i339 = getelementptr i8, ptr %.pn.i338, i64 1 ; 2 uses
  %sext363 = shl i64 %i.ns, 32
  %i.of = ashr exact i64 %sext363, 32             ; 2 uses
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %.0.i339, ptr readonly align 1 %.8, i64 %i.of, i1 false)
  %i.og = getelementptr inbounds i8, ptr %.0.i339, i64 %i.of
  br label %bb.ai

bb.ai:                                            ; preds = %.thread356, %_ZN13duckdb_snappyL11EmitLiteralILb0EEEPcS1_PKci.exit
  %.0 = phi ptr [ %.5, %.thread356 ], [ %i.og, %_ZN13duckdb_snappyL11EmitLiteralILb0EEEPcS1_PKci.exit ]
  ret ptr %.0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable
define hidden void @_ZN13duckdb_snappy9MemCopy64EPcPKvm(ptr noundef writeonly captures(none) initializes((0, 32)) %0, ptr noundef readonly captures(none) %1, i64 noundef %2) local_unnamed_addr #1 {
bb.a:
...
define hidden void @_ZN13duckdb_snappy9MemCopy64ElPKvm(i64 noundef %0, ptr noundef readnone captures(none) %1, i64 noundef %2) local_unnamed_addr #0 {
bb.a:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write) uwtable
define hidden void @_ZN13duckdb_snappy13ClearDeferredEPPKvPmPh(ptr noundef writeonly captures(none) initializes((0, 8)) %0, ptr noundef writeonly captures(none) initializes((0, 8)) %1, ptr noundef %2) local_unnamed_addr #11 {
bb.a:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write) uwtable
define hidden void @_ZN13duckdb_snappy12DeferMemCopyEPPKvPmS1_m(ptr noundef writeonly captures(none) initializes((0, 8)) %0, ptr noundef writeonly captures(none) initializes((0, 8)) %1, ptr noundef %2, i64 noundef %3) local_unnamed_addr #11 {
bb.a:
  store ptr %2, ptr %0, align 8, !tbaa !45
...
_ZN13duckdb_snappy15CalculateNeededEh.exit:       ; preds = %bb.e, %bb.f
...
bb.g:                                             ; preds = %_ZN13duckdb_snappy15CalculateNeededEh.exit
  ...
  %i.ax = load ptr, ptr %i.at, align 8, !tbaa !53
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ax, i64 32
  %i.az = load ptr, ptr %i.ay, align 8
  call void %i.az(ptr noundef nonnull align 8 dereferenceable(8) %i.at, i64 noundef %i.aw)
  store i32 0, ptr %i.au, align 8, !tbaa !52
  br label %bb.h
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.bm = load ptr, ptr %0, align 8, !tbaa !51    ; 2 uses
  %i.bn = load ptr, ptr %i.bm, align 8, !tbaa !53
  %i.bo = getelementptr inbounds nuw i8, ptr %i.bn, i64 32
  %i.bp = load ptr, ptr %i.bo, align 8
  call void %i.bp(ptr noundef nonnull align 8 dereferenceable(8) %i.bm, i64 noundef %i.bk)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #27
  %i.bq = icmp ult i32 %i.bl, %i.al
  br i1 %i.bq, label %bb.h, label %bb.j, !llvm.loop !56

bb.j:                                             ; preds = %bb.i
  store ptr %i.ar, ptr %i.c, align 8, !tbaa !46
  %i.br = zext i32 %i.al to i64
  %i.bs = getelementptr inbounds nuw i8, ptr %i.ar, i64 %i.br
  store ptr %i.bs, ptr %i.e, align 8, !tbaa !50
  br label %bb.n

bb.k:                                             ; preds = %_ZN13duckdb_snappy15CalculateNeededEh.exit
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.ca = load ptr, ptr %i.bw, align 8, !tbaa !53
  %i.cb = getelementptr inbounds nuw i8, ptr %i.ca, i64 32
  %i.cc = load ptr, ptr %i.cb, align 8
  call void %i.cc(ptr noundef nonnull align 8 dereferenceable(8) %i.bw, i64 noundef %i.bz)
  store i32 0, ptr %i.bx, align 8, !tbaa !52
  store ptr %i.bu, ptr %i.c, align 8, !tbaa !46
  %i.cd = getelementptr inbounds nuw i8, ptr %i.bu, i64 %i.bv
  store ptr %i.cd, ptr %i.e, align 8, !tbaa !50
  br label %bb.n

bb.m:                                             ; preds = %bb.k
  store ptr %.029, ptr %i.c, align 8, !tbaa !46
  br label %bb.n
...
; Function Attrs: mustprogress uwtable
define hidden noundef zeroext i1 @_ZN13duckdb_snappy21GetUncompressedLengthEPNS_6SourceEPj(ptr noundef %0, ptr noundef %1) local_unnamed_addr #3 personality ptr @__gxx_personality_v0 {
bb.a:
  %2 = alloca %"class.duckdb_snappy::SnappyDecompressor", align 8 ; 10 uses
  ...
  %i.d = invoke noundef zeroext i1 @_ZN13duckdb_snappy18SnappyDecompressor22ReadUncompressedLengthEPj(ptr noundef nonnull align 8 dereferenceable(42) %2, ptr noundef %1)
          to label %bb.b unwind label %bb.d

bb.b:                                             ; preds = %bb.a
  %i.e = load ptr, ptr %2, align 8, !tbaa !51     ; 2 uses
  %i.f = load i32, ptr %i.b, align 8, !tbaa !52
  %i.g = zext i32 %i.f to i64
  %i.h = load ptr, ptr %i.e, align 8, !tbaa !53
  %i.i = getelementptr inbounds nuw i8, ptr %i.h, i64 32
  %i.j = load ptr, ptr %i.i, align 8
  invoke void %i.j(ptr noundef nonnull align 8 dereferenceable(8) %i.e, i64 noundef %i.g)
          to label %_ZN13duckdb_snappy18SnappyDecompressorD2Ev.exit unwind label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.k = landingpad { ptr, i32 }
          catch ptr null
  %i.l = extractvalue { ptr, i32 } %i.k, 0
  call void @__clang_call_terminate(ptr %i.l) #28
  unreachable

_ZN13duckdb_snappy18SnappyDecompressorD2Ev.exit:  ; preds = %bb.b
...
bb.d:                                             ; preds = %bb.a
  %i.m = landingpad { ptr, i32 }
          cleanup
  %i.n = load ptr, ptr %2, align 8, !tbaa !51     ; 2 uses
  %i.o = load i32, ptr %i.b, align 8, !tbaa !52
  %i.p = zext i32 %i.o to i64
  %i.q = load ptr, ptr %i.n, align 8, !tbaa !53
  %i.r = getelementptr inbounds nuw i8, ptr %i.q, i64 32
  %i.s = load ptr, ptr %i.r, align 8
  invoke void %i.s(ptr noundef nonnull align 8 dereferenceable(8) %i.n, i64 noundef %i.p)
          to label %_ZN13duckdb_snappy18SnappyDecompressorD2Ev.exit3 unwind label %bb.e
...
_ZN13duckdb_snappy18SnappyDecompressorD2Ev.exit3: ; preds = %bb.d
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #27
  resume { ptr, i32 } %i.m
}

; Function Attrs: mustprogress uwtable
define linkonce_odr hidden noundef zeroext i1 @_ZN13duckdb_snappy18SnappyDecompressor22ReadUncompressedLengthEPj(ptr noundef nonnull align 8 dereferenceable(42) %0, ptr noundef %1) local_unnamed_addr #3 comdat align 2 {
bb.a:
  %i.a = alloca i64, align 8                      ; 20 uses
  store i32 0, ptr %1, align 4, !tbaa !3
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #27
  %i.b = load ptr, ptr %0, align 8, !tbaa !51     ; 2 uses
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !53
  %i.d = getelementptr inbounds nuw i8, ptr %i.c, i64 24
  %i.e = load ptr, ptr %i.d, align 8
  %i.f = call noundef ptr %i.e(ptr noundef nonnull align 8 dereferenceable(8) %i.b, ptr noundef nonnull %i.a)
...
bb.b:                                             ; preds = %bb.a
  ...
  call void %i.m(ptr noundef nonnull align 8 dereferenceable(8) %i.j, i64 noundef 1)
  %i.n = and i8 %i.i, 127
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.w = call noundef ptr %i.v(ptr noundef nonnull align 8 dereferenceable(8) %i.s, ptr noundef nonnull %i.a)
...
bb.d:                                             ; preds = %bb.c
  ...
  call void %i.ad(ptr noundef nonnull align 8 dereferenceable(8) %i.aa, i64 noundef 1)
  %i.ae = and i8 %i.z, 127
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ao = call noundef ptr %i.an(ptr noundef nonnull align 8 dereferenceable(8) %i.ak, ptr noundef nonnull %i.a)
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.as = load ptr, ptr %0, align 8, !tbaa !51    ; 2 uses
  %i.at = load ptr, ptr %i.as, align 8, !tbaa !53
  %i.au = getelementptr inbounds nuw i8, ptr %i.at, i64 32
  %i.av = load ptr, ptr %i.au, align 8
  call void %i.av(ptr noundef nonnull align 8 dereferenceable(8) %i.as, i64 noundef 1)
...
bb.g:                                             ; preds = %bb.f
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #27
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #27
  %i.bc = load ptr, ptr %0, align 8, !tbaa !51    ; 2 uses
  %i.bd = load ptr, ptr %i.bc, align 8, !tbaa !53
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 24
  %i.bf = load ptr, ptr %i.be, align 8
  %i.bg = call noundef ptr %i.bf(ptr noundef nonnull align 8 dereferenceable(8) %i.bc, ptr noundef nonnull %i.a)
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.bk = load ptr, ptr %0, align 8, !tbaa !51    ; 2 uses
  %i.bl = load ptr, ptr %i.bk, align 8, !tbaa !53
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 32
  %i.bn = load ptr, ptr %i.bm, align 8
  call void %i.bn(ptr noundef nonnull align 8 dereferenceable(8) %i.bk, i64 noundef 1)
...
bb.i:                                             ; preds = %bb.h
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #27
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #27
  %i.bu = load ptr, ptr %0, align 8, !tbaa !51    ; 2 uses
  %i.bv = load ptr, ptr %i.bu, align 8, !tbaa !53
  %i.bw = getelementptr inbounds nuw i8, ptr %i.bv, i64 24
  %i.bx = load ptr, ptr %i.bw, align 8
  %i.by = call noundef ptr %i.bx(ptr noundef nonnull align 8 dereferenceable(8) %i.bu, ptr noundef nonnull %i.a)
...
.lr.ph.i.i:                                       ; preds = %bb.j
  %.pre.i.i = load i64, ptr %i.z, align 8, !tbaa !71
  br label %bb.k
...
._crit_edge21.i.i:                                ; preds = %bb.k
  %.pre22.i.i = load ptr, ptr %i.aa, align 8, !tbaa !70
  br label %bb.n

bb.l:                                             ; preds = %bb.k
  %i.bl = load ptr, ptr %i.y, align 8, !tbaa !66  ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  store ptr %i.bm, ptr %i.y, align 8, !tbaa !66
  %i.bo = load ptr, ptr %i.bm, align 8, !tbaa !67 ; 2 uses
  store ptr %i.bo, ptr %i.aa, align 8, !tbaa !70
  %i.bp = getelementptr inbounds nuw i8, ptr %i.bl, i64 24
  %i.bq = load i64, ptr %i.bp, align 8, !tbaa !69 ; 2 uses
  store i64 %i.bq, ptr %i.z, align 8, !tbaa !71
  br label %bb.n
...
bb.n:                                             ; preds = %bb.m, %._crit_edge21.i.i
  ...
  %i.bt = load ptr, ptr %i.aa, align 8, !tbaa !70
  %i.bu = getelementptr inbounds nuw i8, ptr %i.bt, i64 %.sroa.speculated.i.i
  store ptr %i.bu, ptr %i.aa, align 8, !tbaa !70
  %i.bv = load i64, ptr %i.z, align 8, !tbaa !71
  %i.bw = sub i64 %i.bv, %.sroa.speculated.i.i    ; 2 uses
  store i64 %i.bw, ptr %i.z, align 8, !tbaa !71
  %i.bx = load i64, ptr %i.w, align 8, !tbaa !72
  %i.by = add i64 %i.bx, %.sroa.speculated.i.i
  store i64 %i.by, ptr %i.w, align 8, !tbaa !72
  ...
  br i1 %.not.i.i, label %.loopexit, label %bb.k, !llvm.loop !136

.loopexit:                                        ; preds = %bb.n, %bb.j
  %i.cb = load ptr, ptr %0, align 8, !tbaa !51    ; 2 uses
  %i.cc = load i32, ptr %i.ab, align 8, !tbaa !52
  %i.cd = zext i32 %i.cc to i64
  %i.ce = load ptr, ptr %i.cb, align 8, !tbaa !53
  %i.cf = getelementptr inbounds nuw i8, ptr %i.ce, i64 32
  %i.cg = load ptr, ptr %i.cf, align 8
  call void %i.cg(ptr noundef nonnull align 8 dereferenceable(8) %i.cb, i64 noundef %i.cd)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #27
  ...
  %i.cl = call noundef ptr %i.ck(ptr noundef nonnull align 8 dereferenceable(8) %i.ch, ptr noundef nonnull %i.b) ; 3 uses
  %i.cm = load i64, ptr %i.b, align 8, !tbaa !8   ; 6 uses
  %i.cn = trunc i64 %i.cm to i32
  store i32 %i.cn, ptr %i.ab, align 8, !tbaa !52
...
bb.o:                                             ; preds = %.loopexit
  ...
  store ptr %i.cp, ptr %i.e, align 8, !tbaa !50
  ...
  store ptr %i.cr, ptr %i.l, align 8, !tbaa !132
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #27
  %i.cs = icmp ult i64 %i.cm, %i.co
  br i1 %i.cs, label %.lr.ph, label %._crit_edge, !llvm.loop !137

._crit_edge:                                      ; preds = %bb.o, %bb.i
  %.1100.lcssa = phi i64 [ %.099, %bb.i ], [ %i.co, %bb.o ] ; 2 uses
  %.7.lcssa = phi ptr [ %.6, %bb.i ], [ %i.cl, %bb.o ] ; 2 uses
  %i.ct = call noundef zeroext i1 @_ZN13duckdb_snappy17SnappyIOVecWriter6AppendEPKcmPPc(ptr noundef nonnull align 8 dereferenceable(48) %1, ptr noundef %.7.lcssa, i64 noundef %.1100.lcssa, ptr noundef nonnull %i.a)
  br i1 %i.ct, label %bb.p, label %.thread149

bb.p:                                             ; preds = %._crit_edge
  %i.cu = getelementptr inbounds nuw i8, ptr %.7.lcssa, i64 %.1100.lcssa ; 3 uses
  %i.cv = load ptr, ptr %i.l, align 8, !tbaa !132
  %.not118 = icmp ult ptr %i.cu, %i.cv
  br i1 %.not118, label %bb.s, label %bb.q, !prof !19

bb.q:                                             ; preds = %bb.p
  store ptr %i.cu, ptr %i.c, align 8, !tbaa !46
  %i.cw = call noundef zeroext i1 @_ZN13duckdb_snappy18SnappyDecompressor9RefillTagEv(ptr noundef nonnull align 8 dereferenceable(42) %0)
  br i1 %i.cw, label %bb.r, label %.thread149, !prof !19

bb.r:                                             ; preds = %bb.q
  %i.cx = load ptr, ptr %i.c, align 8, !tbaa !46  ; 2 uses
  %i.cy = load ptr, ptr %i.e, align 8, !tbaa !50  ; 2 uses
...
bb.t:                                             ; preds = %_ZN13duckdb_snappy17SnappyIOVecWriter6AppendEPKcmPPc.exit
  ...
  %i.dk = call noundef zeroext i1 @_ZN13duckdb_snappy17SnappyIOVecWriter14AppendFromSelfEmmPPc(ptr noundef nonnull align 8 dereferenceable(48) %1, i64 noundef %i.dg, i64 noundef %i.dj, ptr noundef nonnull %i.a)
  br i1 %i.dk, label %bb.w, label %.thread149

bb.u:                                             ; preds = %_ZN13duckdb_snappy17SnappyIOVecWriter6AppendEPKcmPPc.exit
  %i.dl = zext nneg i32 %i.ad to i64
  %i.dm = getelementptr inbounds nuw [2 x i8], ptr @_ZN13duckdb_snappy12_GLOBAL__N_118kLengthMinusOffsetE, i64 %i.dl
  ...
  %i.dx = call noundef zeroext i1 @_ZN13duckdb_snappy17SnappyIOVecWriter14AppendFromSelfEmmPPc(ptr noundef nonnull align 8 dereferenceable(48) %1, i64 noundef %i.dw, i64 noundef %i.du, ptr noundef nonnull %i.a)
...
bb.v:                                             ; preds = %bb.u
  ...
  %i.eb = load ptr, ptr %i.l, align 8, !tbaa !132
  %.not153 = icmp ult ptr %i.dz, %i.eb
  br i1 %.not153, label %_ZN13duckdb_snappy17SnappyIOVecWriter6AppendEPKcmPPc.exit.backedge, label %.thread186, !prof !138

bb.w:                                             ; preds = %bb.t
  %i.ec = getelementptr inbounds nuw i8, ptr %.1, i64 5 ; 3 uses
  %.pre = load ptr, ptr %i.l, align 8, !tbaa !132
  %i.ed = icmp ult ptr %i.ec, %.pre
  br i1 %i.ed, label %bb.y, label %.thread186, !prof !139

.thread186:                                       ; preds = %bb.v, %bb.w
  %.12189 = phi ptr [ %i.ec, %bb.w ], [ %i.dz, %bb.v ]
  store ptr %.12189, ptr %i.c, align 8, !tbaa !46
  %i.ee = call noundef zeroext i1 @_ZN13duckdb_snappy18SnappyDecompressor9RefillTagEv(ptr noundef nonnull align 8 dereferenceable(42) %0)
  br i1 %i.ee, label %bb.x, label %.thread149, !prof !19

bb.x:                                             ; preds = %.thread186
  %i.ef = load ptr, ptr %i.c, align 8, !tbaa !46  ; 2 uses
  %i.eg = load ptr, ptr %i.e, align 8, !tbaa !50  ; 2 uses
  ...
  store ptr %i.el, ptr %i.l, align 8, !tbaa !132
  br label %bb.y
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden { ptr, i64 } @_ZN13duckdb_snappy20DecompressBranchlessIPcEESt4pairIPKhlES4_S4_lT_l(ptr noundef %0, ptr noundef %1, i64 noundef %2, ptr noundef %3, i64 noundef %4) local_unnamed_addr #3 comdat personality ptr @__gxx_personality_v0 {
bb.a:
  ...
  br i1 %or.cond, label %bb.b, label %.thread152
...
bb.c:                                             ; preds = %bb.ae, %bb.b
  %.0114 = phi ptr [ %i.j, %bb.b ], [ %i.ez, %bb.ae ] ; 13 uses
  %.0107 = phi i64 [ %2, %bb.b ], [ %.4111137.1, %bb.ae ] ; 7 uses
  %.0100 = phi ptr [ %i.b, %bb.b ], [ %.4104138.1, %bb.ae ] ; 8 uses
  %.096 = phi i64 [ 0, %bb.b ], [ %.4139.1, %bb.ae ] ; 7 uses
  %.093 = phi i64 [ %i.l, %bb.b ], [ %i.eu, %bb.ae ] ; 3 uses
  %i.m = getelementptr inbounds nuw i8, ptr %.0114, i64 128
  tail call void @llvm.prefetch.p0(ptr nonnull %i.m, i32 0, i32 3, i32 1)
  %i.n = getelementptr inbounds nuw [2 x i8], ptr @_ZN13duckdb_snappy12_GLOBAL__N_118kLengthMinusOffsetE, i64 %.093
  %i.o = load i16, ptr %i.n, align 2, !tbaa !20   ; 2 uses
  %i.p = sext i16 %i.o to i64                     ; 3 uses
  %i.q = lshr i64 %.093, 2                        ; 2 uses
  %i.r = tail call { i64, i8 } asm "and $$3, ${0:k}\0A\09", "=r,={@ccz},0,~{cc},~{dirflag},~{fpsr},~{flags}"(i64 %.093) #29, !srcloc !140 ; 2 uses
  %i.s = extractvalue { i64, i8 } %i.r, 0         ; 4 uses
  %i.t = extractvalue { i64, i8 } %i.r, 1         ; 2 uses
  %i.u = icmp ult i8 %i.t, 2
  tail call void @llvm.assume(i1 %i.u)
  %i.v = getelementptr inbounds nuw i8, ptr %.0114, i64 %i.q
  %i.w = getelementptr inbounds nuw i8, ptr %i.v, i64 1
  %i.x = load volatile i8, ptr %i.w, align 1, !tbaa !7
  %i.y = zext i8 %i.x to i64
  %i.z = getelementptr inbounds nuw i8, ptr %.0114, i64 %i.s
  ...
  %i.ae = getelementptr inbounds nuw i8, ptr %.0114, i64 1
  %i.af = getelementptr inbounds nuw i8, ptr %i.ae, i64 %i.s
  %i.ag = getelementptr inbounds nuw i8, ptr %.0114, i64 2
  %i.ah = getelementptr inbounds nuw i8, ptr %i.ag, i64 %i.q
  %i.ai = select i1 %i.ac, ptr %i.ah, ptr %i.af   ; 12 uses
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i64 %i.ab) #27, !srcloc !141
  %.0.copyload.i = load i32, ptr %.0114, align 1
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %.not50, label %bb.e, label %.thread140, !prof !19

bb.e:                                             ; preds = %bb.d
  %i.as = add i64 %.096, %.0107                   ; 5 uses
  %i.at = sub i64 %i.as, %i.aj
  %i.au = add i64 %i.at, %i.ap
  %i.av = getelementptr inbounds i8, ptr %3, i64 %.0107 ; 2 uses
  call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(32) %i.av, ptr noundef nonnull readonly align 1 dereferenceable(32) %.0100, i64 32, i1 false)
  %i.aw = icmp samesign ugt i64 %.096, 32
  br i1 %i.aw, label %bb.f, label %_ZN13duckdb_snappy9MemCopy64EPcPKvm.exit, !prof !22

bb.f:                                             ; preds = %bb.e
  %i.ax = getelementptr inbounds nuw i8, ptr %i.av, i64 32
  %i.ay = getelementptr inbounds nuw i8, ptr %.0100, i64 32
...
_ZN13duckdb_snappy9MemCopy64EPcPKvm.exit:         ; preds = %bb.e, %bb.f
  %i.az = icmp slt i64 %i.au, 0
  br i1 %i.az, label %.thread140.thread, label %bb.g, !prof !22

bb.g:                                             ; preds = %_ZN13duckdb_snappy9MemCopy64EPcPKvm.exit
  %i.ba = getelementptr inbounds i8, ptr %3, i64 %i.as ; 22 uses
  %i.bb = sub nsw i64 %i.aj, %i.ap                ; 4 uses
  %i.bc = icmp ult i64 %i.bb, 16
  br i1 %i.bc, label %bb.h, label %.preheader28.i, !prof !19

.preheader28.i:                                   ; preds = %bb.g
...
bb.h:                                             ; preds = %bb.g
  ...
  br i1 %i.bf, label %.thread140.thread, label %.preheader.i, !prof !22
...
.preheader.i:                                     ; preds = %bb.h
  ...
  %i.dc = load atomic i8, ptr @_ZGVZN13duckdb_snappy12_GLOBAL__N_131Copy64BytesWithPatternExtensionEPcmE13pattern_sizes acquire, align 8
  %i.dd = icmp eq i8 %i.dc, 0
  br i1 %i.dd, label %bb.i, label %.loopexit.loopexit.i, !prof !142

bb.i:                                             ; preds = %.preheader.i
  %i.de = tail call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZN13duckdb_snappy12_GLOBAL__N_131Copy64BytesWithPatternExtensionEPcmE13pattern_sizes) #27
  %.not.i = icmp eq i32 %i.de, 0
  br i1 %.not.i, label %.loopexit.loopexit.i, label %bb.j

bb.j:                                             ; preds = %bb.i
  store i64 1518298100812353792, ptr @_ZZN13duckdb_snappy12_GLOBAL__N_131Copy64BytesWithPatternExtensionEPcmE13pattern_sizes, align 8
  store i64 2169637811237687832, ptr getelementptr inbounds nuw (i8, ptr @_ZZN13duckdb_snappy12_GLOBAL__N_131Copy64BytesWithPatternExtensionEPcmE13pattern_sizes, i64 8), align 8
  tail call void @__cxa_guard_release(ptr nonnull @_ZGVZN13duckdb_snappy12_GLOBAL__N_131Copy64BytesWithPatternExtensionEPcmE13pattern_sizes) #27
  br label %.loopexit.loopexit.i

.loopexit.loopexit.i:                             ; preds = %bb.j, %bb.i, %.preheader.i
  %i.df = getelementptr inbounds nuw i8, ptr @_ZZN13duckdb_snappy12_GLOBAL__N_131Copy64BytesWithPatternExtensionEPcmE13pattern_sizes, i64 %i.bb
...
end_hunk_1
begin_hunk_2_@_ZN13duckdb_snappy20DecompressBranchlessImEESt4pairIPKhlES3_S3_lT_l:bb.a
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.ap, label %bb.g, label %.thread167.loopexit, !prof !19
...
bb.l:                                             ; preds = %_ZN13duckdb_snappy17SnappyArrayWriter13TryFastAppendEPKcmmPPc.exit
  ...
  %.pre190.a = ptrtoint ptr %i.cf to i64
  %.pre191 = sub i64 %i.bg, %.pre190.a
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %_ZN13duckdb_snappy17SnappyArrayWriter13TryFastAppendEPKcmmPPc.exit
  %.pre-phi192 = phi i64 [ %.pre191, %bb.l ], [ %i.bi, %_ZN13duckdb_snappy17SnappyArrayWriter13TryFastAppendEPKcmmPPc.exit ] ; 2 uses
  ...
  %i.cg = icmp ult i64 %.pre-phi192, %.099
  br i1 %i.cg, label %.lr.ph, label %._crit_edge

.lr.ph:                                           ; preds = %bb.m, %bb.o
  %.7180 = phi ptr [ %i.cx, %bb.o ], [ %.6, %bb.m ]
  %.1100179 = phi i64 [ %i.da, %bb.o ], [ %.099, %bb.m ]
  %.0101178 = phi i64 [ %i.cy, %bb.o ], [ %.pre-phi192, %bb.m ] ; 4 uses
  %i.ch = load ptr, ptr %i.a, align 8, !tbaa !133 ; 3 uses
  %i.ci = load ptr, ptr %i.z, align 8, !tbaa !79
  %i.cj = ptrtoint ptr %i.ci to i64
  %i.ck = ptrtoint ptr %i.ch to i64
  %i.cl = sub i64 %i.cj, %i.ck
  %.not172 = icmp ult i64 %i.cl, %.0101178
  br i1 %.not172, label %.thread167.loopexit, label %bb.n

bb.n:                                             ; preds = %.lr.ph
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.ch, ptr align 1 %.7180, i64 %.0101178, i1 false)
  %i.cm = getelementptr inbounds nuw i8, ptr %i.ch, i64 %.0101178
...
.thread158:                                       ; preds = %bb.n
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #27
  br label %.thread167.loopexit

bb.o:                                             ; preds = %bb.n
  %i.da = sub i64 %.1100179, %.0101178            ; 3 uses
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %bb.m
  ...
  %.not171 = icmp ult i64 %.pre-phi198, %.1100.lcssa
  br i1 %.not171, label %.thread167.loopexit, label %bb.p
...
bb.q:                                             ; preds = %bb.p
  ...
  br i1 %i.dj, label %bb.r, label %.thread167.loopexit, !prof !19
...
bb.t:                                             ; preds = %bb.i
  ...
  br i1 %i.dx, label %bb.aa, label %.thread167.loopexit
...
bb.u:                                             ; preds = %bb.i
  ...
  br i1 %i.eq, label %.thread167.loopexit, label %bb.v, !prof !22
...
bb.w:                                             ; preds = %bb.v
  ...
  br i1 %or.cond.i132, label %.thread167.loopexit, label %bb.x
...
.thread:                                          ; preds = %bb.z, %bb.aa
  %.12217 = phi ptr [ %i.fh, %bb.aa ], [ %i.fe, %bb.z ]
  store ptr %.12217, ptr %i.c, align 8, !tbaa !46
  ...
  br i1 %i.fj, label %bb.ab, label %.thread167.loopexit, !prof !19
...
.thread167.loopexit:                              ; preds = %bb.q, %._crit_edge, %bb.t, %bb.f, %.thread, %bb.u, %bb.w, %.lr.ph, %.thread158
  %.pre189 = load ptr, ptr %i.a, align 8, !tbaa !133
  br label %.thread167

.thread167:                                       ; preds = %.thread167.loopexit, %bb.b
  %2 = phi ptr [ %.pre189, %.thread167.loopexit ], [ %i.n, %bb.b ]
  store ptr %2, ptr %i.m, align 8, !tbaa !78
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #27
  ret void
}
...
bb.j:                                             ; preds = %bb.i
  ...
  br i1 %or.cond3.i, label %bb.k, label %_ZN13duckdb_snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE13TryFastAppendEPKcmmPPc.exit
...
.loopexit.backedge:                               ; preds = %bb.k, %bb.s, %bb.ac, %bb.z
  ...
  br label %.loopexit, !llvm.loop !171

_ZN13duckdb_snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE13TryFastAppendEPKcmmPPc.exit: ; preds = %bb.j
  %i.bx = icmp samesign ugt i32 %i.bb, 236
  br i1 %i.bx, label %bb.l, label %bb.m, !prof !22

bb.l:                                             ; preds = %_ZN13duckdb_snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE13TryFastAppendEPKcmmPPc.exit
...
bb.m:                                             ; preds = %bb.l, %_ZN13duckdb_snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE13TryFastAppendEPKcmmPPc.exit
  %.pre-phi202 = phi i64 [ %.pre201, %bb.l ], [ %i.bj, %_ZN13duckdb_snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE13TryFastAppendEPKcmmPPc.exit ] ; 2 uses
  %.099 = phi i64 [ %i.cg, %bb.l ], [ %i.bf, %_ZN13duckdb_snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE13TryFastAppendEPKcmmPPc.exit ] ; 3 uses
  %.6 = phi ptr [ %i.ch, %bb.l ], [ %i.ba, %_ZN13duckdb_snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE13TryFastAppendEPKcmmPPc.exit ] ; 2 uses
...
_ZN13duckdb_snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE6AppendEPKcmPPc.exit: ; preds = %.lr.ph
  ...
  %i.cp = call noundef zeroext i1 @_ZN13duckdb_snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE10SlowAppendEPKcm(ptr noundef nonnull align 8 dereferenceable(104) %1, ptr noundef %.7190, i64 noundef %.0101188)
...
bb.n:                                             ; preds = %_ZN13duckdb_snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE6AppendEPKcmPPc.exit.thread, %_ZN13duckdb_snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE6AppendEPKcmPPc.exit
...
bb.p:                                             ; preds = %_ZN13duckdb_snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE6AppendEPKcmPPc.exit131.thread, %_ZN13duckdb_snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE6AppendEPKcmPPc.exit131
...
.thread179:                                       ; preds = %.thread179.loopexit, %bb.b
  ...
  store ptr %2, ptr %i.m, align 8, !tbaa !121
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #27
  ret void
}
