...
begin_hunk_2_@_ZN11duckdb_zstd29ZSTD_ldm_skipRawSeqStoreBytesEPNS_13rawSeqStore_tEm:bb.a
  ...
  %.promoted = load i64, ptr %i.e, align 8, !tbaa !70 ; 3 uses
...
bb.b:                                             ; preds = %bb.c
  %2 = icmp ult i64 %i.o, %i.g
  br i1 %2, label %.lr.ph43, label %.loopexit
...
bb.e:                                             ; preds = %bb.f
  %7 = icmp ult i64 %i.au, %i.am
  br i1 %7, label %.lr.ph204, label %.loopexit.i
...
.loopexit.i:                                      ; preds = %bb.e, %.lr.ph.i, %.thread.i
  %i.av = phi i64 [ %i.ap, %.thread.i ], [ %.promoted.i, %.lr.ph.i ], [ %i.au, %bb.e ]
...
begin_hunk_8_@_ZN11duckdb_zstd22ZSTD_ldm_blockCompressEPNS_13rawSeqStore_tEPNS_17ZSTD_matchState_tEPNS_10seqStore_tEPjNS_18ZSTD_paramSwitch_eEPKvm:bb.a
  ...
  %.not53.i.i = icmp ne i32 %i.bb, 0
  %8 = icmp ult i64 %i.ay, %i.ax
  %or.cond222 = and i1 %.not53.i.i, %8
  br i1 %or.cond222, label %.lr.ph201, label %_ZN11duckdb_zstdL18maybeSplitSequenceEPNS_13rawSeqStore_tEjj.exit
...
bb.q:                                             ; preds = %bb.l
  ...
  %i.cf = add nuw i64 %i.bk, 1                    ; 3 uses
  store i64 %i.cf, ptr %i.o, align 8, !tbaa !70
  %.not.i.i = icmp ne i64 %i.ce, 0
  %9 = icmp ult i64 %i.cf, %i.ax
  %or.cond223 = select i1 %.not.i.i, i1 %9, i1 false
  br i1 %or.cond223, label %bb.j, label %_ZN11duckdb_zstdL18maybeSplitSequenceEPNS_13rawSeqStore_tEjj.exit
