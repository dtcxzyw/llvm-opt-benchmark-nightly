...
.epil.preheader:                                  ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph
  ...
  %i.u = shl nuw nsw i32 %indvars.iv.tr.epil, 3
  %i.v = shl i32 %i.t, %i.u
...
bb.f:                                             ; preds = %bb.f, %.lr.ph.new
  ...
  %i.ah = shl nuw nsw i32 %indvars.iv.tr, 3
  ...
  %i.an = shl nuw nsw i32 %indvars.iv.tr.1, 3
...
_ZNK6duckdb10ByteBuffer9availableEm.exit.epil.preheader: ; preds = %_ZNK6duckdb10ByteBuffer9availableEm.exit._crit_edge.loopexit.unr-lcssa, %.lr.ph
  ...
  %indvars.iv.tr.epil = trunc nuw i64 %indvars.iv.epil.init to i32
  %i.ab = shl nuw nsw i32 %indvars.iv.tr.epil, 3
...
_ZNK6duckdb10ByteBuffer9availableEm.exit:         ; preds = %_ZNK6duckdb10ByteBuffer9availableEm.exit, %.lr.ph.new
  ...
  %indvars.iv.tr = trunc nuw i64 %indvars.iv to i32
  %i.al = shl nuw nsw i32 %indvars.iv.tr, 3
  ...
  %indvars.iv.tr.1 = trunc nuw i64 %indvars.iv.next to i32
  %i.ar = shl nuw nsw i32 %indvars.iv.tr.1, 3
