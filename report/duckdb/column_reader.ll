...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.x = add i64 %i.w, -6
  %i.y = getelementptr i8, ptr %pointer.phi, i64 8
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.z = add i64 %i.w, -8
  %ptr.ind = getelementptr i8, ptr %pointer.phi, i64 8
  %i.aa = icmp eq i64 %index.next, %n.vec
  br i1 %i.aa, label %scalar.ph.preheader.loopexit, label %vector.body, !llvm.loop !888
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %_ZN6duckdb30CallbackParquetValueConversionItfXadL_ZNS_16Float16ToFloat32ERKtEEE9PlainSkipILb1EEEvRNS_10ByteBufferERNS_12ColumnReaderE.exit.i.i
  %i.ab = phi i64 [ %i.af, %_ZN6duckdb30CallbackParquetValueConversionItfXadL_ZNS_16Float16ToFloat32ERKtEEE9PlainSkipILb1EEEvRNS_10ByteBufferERNS_12ColumnReaderE.exit.i.i ], [ %.ph, %scalar.ph.preheader ] ; 2 uses
  %.08.i.i = phi i64 [ %i.ah, %_ZN6duckdb30CallbackParquetValueConversionItfXadL_ZNS_16Float16ToFloat32ERKtEEE9PlainSkipILb1EEEvRNS_10ByteBufferERNS_12ColumnReaderE.exit.i.i ], [ %.08.i.i.ph, %scalar.ph.preheader ]
  %i.ac = phi ptr [ %i.ag, %_ZN6duckdb30CallbackParquetValueConversionItfXadL_ZNS_16Float16ToFloat32ERKtEEE9PlainSkipILb1EEEvRNS_10ByteBufferERNS_12ColumnReaderE.exit.i.i ], [ %.ph17, %scalar.ph.preheader ]
  %.not.i.i.i.i.i = icmp ult i64 %i.ab, 2
...
_ZN6duckdb30CallbackParquetValueConversionItfXadL_ZNS_16Float16ToFloat32ERKtEEE9PlainSkipILb1EEEvRNS_10ByteBufferERNS_12ColumnReaderE.exit.i.i: ; preds = %scalar.ph
  %i.af = add i64 %i.ab, -2                       ; 2 uses
  store i64 %i.af, ptr %i.h, align 8, !tbaa !389
  %i.ag = getelementptr inbounds nuw i8, ptr %i.ac, i64 2 ; 2 uses
  store ptr %i.ag, ptr %1, align 8, !tbaa !386
  %i.ah = add nuw i64 %.08.i.i, 1                 ; 2 uses
