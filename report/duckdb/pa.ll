...
begin_hunk_1_@duckdb_je_pa_alloc:tsdn_witness_tsdp_get.exit
  ...
  %i.p = load i64, ptr %.142, align 8, !tbaa !59
  ...
  %i.v = or i64 %i.u, %i.q
  store i64 %i.v, ptr %.142, align 8, !tbaa !59
...
bb.a:
  %.val = load i64, ptr %2, align 8, !tbaa !59    ; 2 uses
...
begin_hunk_4_@duckdb_je_pa_expand:bb.a
  ...
  %i.p = or i64 %i.m, %i.o
  store i64 %i.p, ptr %2, align 8, !tbaa !59
...
begin_hunk_8_@duckdb_je_pa_dalloc:bb.a
  ...
  %.val18 = load i64, ptr %2, align 8, !tbaa !59  ; 2 uses
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  tail call void %i.u(ptr noundef %0, ptr noundef nonnull %i.s, ptr noundef nonnull %2, ptr noundef %3) #4
  ret void
}
...
!58 = !{!16, !10, i64 0}
!59 = !{!60, !12, i64 0}
!60 = !{!"edata_s", !12, i64 0, !10, i64 8, !5, i64 16, !43, i64 24, !12, i64 32, !5, i64 40, !5, i64 64}
!61 = !{!16, !10, i64 16}
!62 = !{!16, !10, i64 24}
!63 = !{!60, !10, i64 8}
!64 = !{!5, !5, i64 0}
