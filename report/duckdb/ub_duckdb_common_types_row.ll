...
bb.g:                                             ; preds = %.lr.ph
  ...
  tail call void @_ZN6duckdb18TupleDataAllocator20InitializeChunkStateERNS_16TupleDataSegmentERNS_17TupleDataPinStateERNS_19TupleDataChunkStateEmbNS_12optional_ptrINS_19SortKeyPayloadStateELb1EEE(ptr noundef nonnull align 8 dereferenceable(128) %i.ab, ptr noundef nonnull align 8 dereferenceable(192) %i.j, ptr noundef nonnull align 8 dereferenceable(49) %1, ptr noundef nonnull align 8 dereferenceable(488) %i.ac, i64 noundef %.02645, i1 noundef zeroext %3, i64 %i.ad)
  %i.ae = load ptr, ptr %i.aa, align 8, !tbaa !413
  %i.af = getelementptr inbounds nuw [8 x i8], ptr %i.ae, i64 %.02645
