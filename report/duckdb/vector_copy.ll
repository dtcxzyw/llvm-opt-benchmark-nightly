...
$_ZN6duckdb23NotImplementedExceptionC2IJNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEERKS7_DpOT_ = comdat any
...
$_ZN6duckdb14ConstantVector16VerifyVectorTypeINS_12list_entry_tEEEvRKNS_6VectorE = comdat any
...
$_ZN6duckdb14ConstantVector16VerifyVectorTypeItEEvRKNS_6VectorE = comdat any

$_ZN6duckdb14ConstantVector16VerifyVectorTypeIjEEvRKNS_6VectorE = comdat any

$_ZN6duckdb14ConstantVector16VerifyVectorTypeImEEvRKNS_6VectorE = comdat any

$_ZN6duckdb14ConstantVector16VerifyVectorTypeINS_9hugeint_tEEEvRKNS_6VectorE = comdat any

$_ZN6duckdb14ConstantVector16VerifyVectorTypeINS_10uhugeint_tEEEvRKNS_6VectorE = comdat any

$_ZN6duckdb14ConstantVector16VerifyVectorTypeIfEEvRKNS_6VectorE = comdat any

$_ZN6duckdb14ConstantVector16VerifyVectorTypeIdEEvRKNS_6VectorE = comdat any

$_ZN6duckdb14ConstantVector16VerifyVectorTypeINS_10interval_tEEEvRKNS_6VectorE = comdat any

$_ZN6duckdb14ConstantVector16VerifyVectorTypeINS_8string_tEEEvRKNS_6VectorE = comdat any
...
@.str.2 = private unnamed_addr constant [83 x i8] c"Operation requires a dictionary vector but a non-dictionary vector was encountered\00", align 1
...
@.str.5 = private unnamed_addr constant [39 x i8] c"Unsupported vector type in vector copy\00", align 1
...
define void @_ZN6duckdb16VectorOperations4CopyERKNS_6VectorERS1_RKNS_15SelectionVectorEmmmm(ptr noundef nonnull align 8 dereferenceable(104) %0, ptr noundef nonnull align 8 dereferenceable(104) %1, ptr noundef nonnull align 8 dereferenceable(24) %2, i64 noundef %3, i64 noundef %4, i64 noundef %5, i64 noundef %6) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
.peel.begin:
  %7 = alloca %"class.std::__cxx11::basic_string", align 8 ; 8 uses
  %8 = alloca %"class.std::allocator", align 1    ; 5 uses
  %9 = alloca %"struct.duckdb::SelectionVector", align 8 ; 14 uses
  %10 = alloca %"class.duckdb::shared_ptr", align 8 ; 11 uses
  %11 = alloca %"class.duckdb::shared_ptr", align 8 ; 8 uses
  ...
  %16 = alloca %"struct.duckdb::SelectionVector", align 8 ; 8 uses
  ...
  %i.a = getelementptr inbounds nuw i8, ptr %11, i64 8 ; 6 uses
  %i.b = getelementptr inbounds nuw i8, ptr %10, i64 8 ; 4 uses
  %i.c = getelementptr inbounds nuw i8, ptr %9, i64 8 ; 4 uses
  %i.d = getelementptr inbounds nuw i8, ptr %9, i64 16 ; 5 uses
  %i.e = load i8, ptr %0, align 8, !tbaa !7
  switch i8 %i.e, label %.loopexit670 [
    i8 3, label %bb.a
    i8 4, label %.loopexit671
    i8 2, label %.loopexit672
    i8 1, label %.loopexit611
    i8 0, label %.loopexit611
  ]

bb.a:                                             ; preds = %.peel.begin
  invoke void @_ZN6duckdb16DictionaryVector16VerifyDictionaryERKNS_6VectorE(ptr noundef nonnull align 8 dereferenceable(104) %0)
          to label %.noexc.peel unwind label %.loopexit.split-lp674
...
bb.b:                                             ; preds = %.noexc.peel
  invoke void @_ZN6duckdb16DictionaryVector16VerifyDictionaryERKNS_6VectorE(ptr noundef nonnull align 8 dereferenceable(104) %0)
          to label %.noexc362.peel unwind label %.loopexit.split-lp678
...
bb.c:                                             ; preds = %.noexc362.peel
  ...
  invoke void @_ZNK6duckdb15SelectionVector5SliceERKS0_m(ptr dead_on_unwind nonnull writable sret(%"class.duckdb::shared_ptr") align 8 %10, ptr noundef nonnull align 8 dereferenceable(24) %i.j, ptr noundef nonnull align 8 dereferenceable(24) %2, i64 noundef %3)
          to label %bb.d unwind label %.loopexit.split-lp683

bb.d:                                             ; preds = %bb.c
  %i.k = load ptr, ptr %10, align 8, !tbaa !33    ; 3 uses
  store ptr %i.k, ptr %11, align 8, !tbaa !33
  %i.l = load ptr, ptr %i.b, align 8, !tbaa !36   ; 4 uses
  store ptr %i.l, ptr %i.a, align 8, !tbaa !36
  %.not.i.i.i.i.peel = icmp eq ptr %i.l, null
  br i1 %.not.i.i.i.i.peel, label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEC2ERKS2_.exit.peel, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.m = getelementptr inbounds nuw i8, ptr %i.l, i64 8 ; 3 uses
  %i.n = load i8, ptr @__libc_single_threaded, align 1, !tbaa !37
  %.not.i.i.i.i.i.peel = icmp eq i8 %i.n, 0
  br i1 %.not.i.i.i.i.i.peel, label %bb.g, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.o = load i32, ptr %i.m, align 4, !tbaa !3
  %i.p = add nsw i32 %i.o, 1
  store i32 %i.p, ptr %i.m, align 4, !tbaa !3
  br label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEC2ERKS2_.exit.peel

bb.g:                                             ; preds = %bb.e
  %i.q = atomicrmw volatile add ptr %i.m, i32 1 acq_rel, align 4 ; 0 uses
  %.pre.peel = load ptr, ptr %11, align 8, !tbaa !33
  %.pre562.peel = load ptr, ptr %i.a, align 8, !tbaa !36
  br label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEC2ERKS2_.exit.peel

_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEC2ERKS2_.exit.peel: ; preds = %bb.g, %bb.f, %bb.d
  %i.r = phi ptr [ null, %bb.d ], [ %i.l, %bb.f ], [ %.pre562.peel, %bb.g ]
  %i.s = phi ptr [ %i.k, %bb.d ], [ %i.k, %bb.f ], [ %.pre.peel, %bb.g ]
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %11, i8 0, i64 16, i1 false)
  store ptr %i.s, ptr %i.c, align 8, !tbaa !38
  %i.t = load ptr, ptr %i.d, align 8, !tbaa !36   ; 8 uses
  store ptr %i.r, ptr %i.d, align 8, !tbaa !36
  %.not.i.i.i.i.i364.peel = icmp eq ptr %i.t, null
  br i1 %.not.i.i.i.i.i364.peel, label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEaSEOS2_.exit.i.peel, label %bb.h

bb.h:                                             ; preds = %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEC2ERKS2_.exit.peel
...
bb.i:                                             ; preds = %bb.h
  ...
  %.not.i.i.i.i.i.i.peel = icmp eq i8 %i.y, 0
  br i1 %.not.i.i.i.i.i.i.peel, label %bb.k, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.z = add nsw i32 %i.x, -1
  store i32 %i.z, ptr %i.u, align 8, !tbaa !3
  br label %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.peel

bb.k:                                             ; preds = %bb.i
  %i.aa = atomicrmw volatile add ptr %i.u, i32 -1 acq_rel, align 4
  br label %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.peel

_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.peel: ; preds = %bb.k, %bb.j
  %.0.i.i.i.i.i.i.i.peel = phi i32 [ %i.x, %bb.j ], [ %i.aa, %bb.k ]
  %i.ab = icmp eq i32 %.0.i.i.i.i.i.i.i.peel, 1
  br i1 %i.ab, label %bb.l, label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEaSEOS2_.exit.i.peel, !prof !39

bb.l:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.peel
  call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.t) #17
  br label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEaSEOS2_.exit.i.peel

bb.m:                                             ; preds = %bb.h
  store i32 0, ptr %i.u, align 8, !tbaa !40
  %i.ac = getelementptr inbounds nuw i8, ptr %i.t, i64 12
  store i32 0, ptr %i.ac, align 4, !tbaa !42
  %i.ad = load ptr, ptr %i.t, align 8, !tbaa !43
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 16
  %i.af = load ptr, ptr %i.ae, align 8
  call void %i.af(ptr noundef nonnull align 8 dereferenceable(16) %i.t) #17, !inline_history !45
  %i.ag = load ptr, ptr %i.t, align 8, !tbaa !43
  %i.ah = getelementptr inbounds nuw i8, ptr %i.ag, i64 24
  %i.ai = load ptr, ptr %i.ah, align 8
  call void %i.ai(ptr noundef nonnull align 8 dereferenceable(16) %i.t) #17, !inline_history !45
  br label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEaSEOS2_.exit.i.peel

_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEaSEOS2_.exit.i.peel: ; preds = %bb.m, %bb.l, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.peel, %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEC2ERKS2_.exit.peel
  %i.aj = invoke noundef ptr @_ZNK6duckdb10shared_ptrINS_13SelectionDataELb1EEptEv(ptr noundef nonnull align 8 dereferenceable(16) %i.c)
          to label %bb.n unwind label %.loopexit.split-lp688

bb.n:                                             ; preds = %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEaSEOS2_.exit.i.peel
  %i.ak = getelementptr inbounds nuw i8, ptr %i.aj, i64 8
  %i.al = load ptr, ptr %i.ak, align 8, !tbaa !46
  store ptr %i.al, ptr %9, align 8, !tbaa !50
  %i.am = load ptr, ptr %i.a, align 8, !tbaa !36  ; 8 uses
  %.not.i.i.i.peel = icmp eq ptr %i.am, null
  br i1 %.not.i.i.i.peel, label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev.exit.peel, label %bb.o
...
bb.o:                                             ; preds = %bb.n
  ...
  br i1 %i.ap, label %bb.t, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.ar = load i8, ptr @__libc_single_threaded, align 1, !tbaa !37
  %.not.i.i.i.i366.peel = icmp eq i8 %i.ar, 0
  br i1 %.not.i.i.i.i366.peel, label %bb.r, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.as = add nsw i32 %i.aq, -1
  store i32 %i.as, ptr %i.an, align 8, !tbaa !3
  br label %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.peel

bb.r:                                             ; preds = %bb.p
  %i.at = atomicrmw volatile add ptr %i.an, i32 -1 acq_rel, align 4
  br label %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.peel

_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.peel: ; preds = %bb.r, %bb.q
  %.0.i.i.i.i.i.peel = phi i32 [ %i.aq, %bb.q ], [ %i.at, %bb.r ]
  %i.au = icmp eq i32 %.0.i.i.i.i.i.peel, 1
  br i1 %i.au, label %bb.s, label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev.exit.peel, !prof !39

bb.s:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.peel
  ...
  br label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev.exit.peel

bb.t:                                             ; preds = %bb.o
  store i32 0, ptr %i.an, align 8, !tbaa !40
  %i.av = getelementptr inbounds nuw i8, ptr %i.am, i64 12
  store i32 0, ptr %i.av, align 4, !tbaa !42
  %i.aw = load ptr, ptr %i.am, align 8, !tbaa !43
  %i.ax = getelementptr inbounds nuw i8, ptr %i.aw, i64 16
  %i.ay = load ptr, ptr %i.ax, align 8
  call void %i.ay(ptr noundef nonnull align 8 dereferenceable(16) %i.am) #17, !inline_history !55
  %i.az = load ptr, ptr %i.am, align 8, !tbaa !43
  %i.ba = getelementptr inbounds nuw i8, ptr %i.az, i64 24
  %i.bb = load ptr, ptr %i.ba, align 8
  call void %i.bb(ptr noundef nonnull align 8 dereferenceable(16) %i.am) #17, !inline_history !55
  br label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev.exit.peel

_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev.exit.peel: ; preds = %bb.t, %bb.s, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.peel, %bb.n
  %i.bc = load ptr, ptr %i.b, align 8, !tbaa !36  ; 8 uses
  %.not.i.i.i367.peel = icmp eq ptr %i.bc, null
  br i1 %.not.i.i.i367.peel, label %.peel.next, label %bb.u

bb.u:                                             ; preds = %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev.exit.peel
  ...
  br i1 %i.bf, label %bb.z, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.bh = load i8, ptr @__libc_single_threaded, align 1, !tbaa !37
  %.not.i.i.i.i368.peel = icmp eq i8 %i.bh, 0
  br i1 %.not.i.i.i.i368.peel, label %bb.x, label %bb.w

bb.w:                                             ; preds = %bb.v
  %i.bi = add nsw i32 %i.bg, -1
  store i32 %i.bi, ptr %i.bd, align 8, !tbaa !3
  br label %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i369.peel

bb.x:                                             ; preds = %bb.v
  %i.bj = atomicrmw volatile add ptr %i.bd, i32 -1 acq_rel, align 4
  br label %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i369.peel

_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i369.peel: ; preds = %bb.x, %bb.w
  %.0.i.i.i.i.i370.peel = phi i32 [ %i.bg, %bb.w ], [ %i.bj, %bb.x ]
  %i.bk = icmp eq i32 %.0.i.i.i.i.i370.peel, 1
  br i1 %i.bk, label %bb.y, label %.peel.next, !prof !39

bb.y:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i369.peel
  call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.bc) #17
  br label %.peel.next

bb.z:                                             ; preds = %bb.u
  store i32 0, ptr %i.bd, align 8, !tbaa !40
  %i.bl = getelementptr inbounds nuw i8, ptr %i.bc, i64 12
  store i32 0, ptr %i.bl, align 4, !tbaa !42
  %i.bm = load ptr, ptr %i.bc, align 8, !tbaa !43
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bm, i64 16
  %i.bo = load ptr, ptr %i.bn, align 8
  call void %i.bo(ptr noundef nonnull align 8 dereferenceable(16) %i.bc) #17, !inline_history !55
  %i.bp = load ptr, ptr %i.bc, align 8, !tbaa !43
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bp, i64 24
  %i.br = load ptr, ptr %i.bq, align 8
  call void %i.br(ptr noundef nonnull align 8 dereferenceable(16) %i.bc) #17, !inline_history !55
  br label %.peel.next

.peel.next:                                       ; preds = %bb.z, %bb.y, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i369.peel, %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev.exit.peel
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #17
  br label %bb.aa

bb.aa:                                            ; preds = %bb.bq, %.peel.next
  %.pn698 = phi ptr [ %i.g, %.peel.next ], [ %i.bv, %bb.bq ] ; 3 uses
  %.0263493 = getelementptr inbounds nuw i8, ptr %.pn698, i64 48 ; 7 uses
  %i.bs = load i8, ptr %.0263493, align 8, !tbaa !7
  switch i8 %i.bs, label %.loopexit670 [
    i8 3, label %bb.ac
    i8 4, label %.loopexit671
    i8 2, label %.loopexit672
    i8 1, label %.loopexit611
...
bb.ab:                                            ; preds = %.loopexit672
  %i.bt = landingpad { ptr, i32 }
          cleanup
  br label %.body

bb.ac:                                            ; preds = %bb.aa
  invoke void @_ZN6duckdb16DictionaryVector16VerifyDictionaryERKNS_6VectorE(ptr noundef nonnull align 8 dereferenceable(104) %.0263493)
          to label %.noexc unwind label %.loopexit673
...
bb.ad:                                            ; preds = %.noexc
  invoke void @_ZN6duckdb16DictionaryVector16VerifyDictionaryERKNS_6VectorE(ptr noundef nonnull align 8 dereferenceable(104) %.0263493)
          to label %.noexc362 unwind label %.loopexit677
...
bb.ae:                                            ; preds = %.noexc362
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %10) #17
  invoke void @_ZNK6duckdb15SelectionVector5SliceERKS0_m(ptr dead_on_unwind nonnull writable sret(%"class.duckdb::shared_ptr") align 8 %10, ptr noundef nonnull align 8 dereferenceable(24) %i.by, ptr noundef nonnull align 8 dereferenceable(24) %9, i64 noundef %3)
          to label %bb.af unwind label %.loopexit682

bb.af:                                            ; preds = %bb.ae
  %i.bz = load ptr, ptr %10, align 8, !tbaa !33   ; 3 uses
  store ptr %i.bz, ptr %11, align 8, !tbaa !33
  %i.ca = load ptr, ptr %i.b, align 8, !tbaa !36  ; 4 uses
  store ptr %i.ca, ptr %i.a, align 8, !tbaa !36
  %.not.i.i.i.i = icmp eq ptr %i.ca, null
  br i1 %.not.i.i.i.i, label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEC2ERKS2_.exit, label %bb.ag

bb.ag:                                            ; preds = %bb.af
  %i.cb = getelementptr inbounds nuw i8, ptr %i.ca, i64 8 ; 3 uses
  %i.cc = load i8, ptr @__libc_single_threaded, align 1, !tbaa !37
  %.not.i.i.i.i.i = icmp eq i8 %i.cc, 0
  br i1 %.not.i.i.i.i.i, label %bb.ai, label %bb.ah

bb.ah:                                            ; preds = %bb.ag
  %i.cd = load i32, ptr %i.cb, align 4, !tbaa !3
  %i.ce = add nsw i32 %i.cd, 1
  store i32 %i.ce, ptr %i.cb, align 4, !tbaa !3
  br label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEC2ERKS2_.exit

bb.ai:                                            ; preds = %bb.ag
  %i.cf = atomicrmw volatile add ptr %i.cb, i32 1 acq_rel, align 4 ; 0 uses
  %.pre = load ptr, ptr %11, align 8, !tbaa !33
  %.pre562 = load ptr, ptr %i.a, align 8, !tbaa !36
  br label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEC2ERKS2_.exit

_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEC2ERKS2_.exit: ; preds = %bb.af, %bb.ah, %bb.ai
  %i.cg = phi ptr [ null, %bb.af ], [ %i.ca, %bb.ah ], [ %.pre562, %bb.ai ]
  %i.ch = phi ptr [ %i.bz, %bb.af ], [ %i.bz, %bb.ah ], [ %.pre, %bb.ai ]
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %11, i8 0, i64 16, i1 false)
  store ptr %i.ch, ptr %i.c, align 8, !tbaa !38
  %i.ci = load ptr, ptr %i.d, align 8, !tbaa !36  ; 8 uses
  store ptr %i.cg, ptr %i.d, align 8, !tbaa !36
  %.not.i.i.i.i.i364 = icmp eq ptr %i.ci, null
  br i1 %.not.i.i.i.i.i364, label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEaSEOS2_.exit.i, label %bb.aj

bb.aj:                                            ; preds = %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEC2ERKS2_.exit
...
bb.ak:                                            ; preds = %bb.aj
  store i32 0, ptr %i.cj, align 8, !tbaa !40
  %i.cn = getelementptr inbounds nuw i8, ptr %i.ci, i64 12
  store i32 0, ptr %i.cn, align 4, !tbaa !42
  %i.co = load ptr, ptr %i.ci, align 8, !tbaa !43
  %i.cp = getelementptr inbounds nuw i8, ptr %i.co, i64 16
  %i.cq = load ptr, ptr %i.cp, align 8
  call void %i.cq(ptr noundef nonnull align 8 dereferenceable(16) %i.ci) #17, !inline_history !45
  %i.cr = load ptr, ptr %i.ci, align 8, !tbaa !43
  %i.cs = getelementptr inbounds nuw i8, ptr %i.cr, i64 24
  %i.ct = load ptr, ptr %i.cs, align 8
  call void %i.ct(ptr noundef nonnull align 8 dereferenceable(16) %i.ci) #17, !inline_history !45
  br label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEaSEOS2_.exit.i

bb.al:                                            ; preds = %bb.aj
  %i.cu = load i8, ptr @__libc_single_threaded, align 1, !tbaa !37
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i: ; preds = %bb.an, %bb.am
  %.0.i.i.i.i.i.i.i = phi i32 [ %i.cm, %bb.am ], [ %i.cw, %bb.an ]
  %i.cx = icmp eq i32 %.0.i.i.i.i.i.i.i, 1
  br i1 %i.cx, label %bb.ao, label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEaSEOS2_.exit.i, !prof !39

bb.ao:                                            ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i
  call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.ci) #17
  br label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEaSEOS2_.exit.i

_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEaSEOS2_.exit.i: ; preds = %bb.ao, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i, %bb.ak, %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEC2ERKS2_.exit
  %i.cy = invoke noundef ptr @_ZNK6duckdb10shared_ptrINS_13SelectionDataELb1EEptEv(ptr noundef nonnull align 8 dereferenceable(16) %i.c)
          to label %bb.ap unwind label %.loopexit687

bb.ap:                                            ; preds = %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEaSEOS2_.exit.i
  %i.cz = getelementptr inbounds nuw i8, ptr %i.cy, i64 8
  %i.da = load ptr, ptr %i.cz, align 8, !tbaa !46
  store ptr %i.da, ptr %9, align 8, !tbaa !50
  %i.db = load ptr, ptr %i.a, align 8, !tbaa !36  ; 8 uses
  %.not.i.i.i = icmp eq ptr %i.db, null
  br i1 %.not.i.i.i, label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev.exit, label %bb.aq
...
bb.ar:                                            ; preds = %bb.aq
  store i32 0, ptr %i.dc, align 8, !tbaa !40
  %i.dg = getelementptr inbounds nuw i8, ptr %i.db, i64 12
  store i32 0, ptr %i.dg, align 4, !tbaa !42
  %i.dh = load ptr, ptr %i.db, align 8, !tbaa !43
  %i.di = getelementptr inbounds nuw i8, ptr %i.dh, i64 16
  %i.dj = load ptr, ptr %i.di, align 8
  call void %i.dj(ptr noundef nonnull align 8 dereferenceable(16) %i.db) #17, !inline_history !55
  %i.dk = load ptr, ptr %i.db, align 8, !tbaa !43
  %i.dl = getelementptr inbounds nuw i8, ptr %i.dk, i64 24
  %i.dm = load ptr, ptr %i.dl, align 8
  call void %i.dm(ptr noundef nonnull align 8 dereferenceable(16) %i.db) #17, !inline_history !55
  br label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev.exit

bb.as:                                            ; preds = %bb.aq
  %i.dn = load i8, ptr @__libc_single_threaded, align 1, !tbaa !37
  %.not.i.i.i.i366 = icmp eq i8 %i.dn, 0
  br i1 %.not.i.i.i.i366, label %bb.au, label %bb.at
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i: ; preds = %bb.au, %bb.at
  %.0.i.i.i.i.i = phi i32 [ %i.df, %bb.at ], [ %i.dp, %bb.au ]
  %i.dq = icmp eq i32 %.0.i.i.i.i.i, 1
  br i1 %i.dq, label %bb.av, label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev.exit, !prof !39

bb.av:                                            ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i
  call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.db) #17
  br label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev.exit

_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev.exit: ; preds = %bb.ap, %bb.ar, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i, %bb.av
  %i.dr = load ptr, ptr %i.b, align 8, !tbaa !36  ; 8 uses
  %.not.i.i.i367 = icmp eq ptr %i.dr, null
  br i1 %.not.i.i.i367, label %bb.bq, label %bb.aw

bb.aw:                                            ; preds = %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev.exit
...
bb.ax:                                            ; preds = %bb.aw
  store i32 0, ptr %i.ds, align 8, !tbaa !40
  %i.dw = getelementptr inbounds nuw i8, ptr %i.dr, i64 12
  store i32 0, ptr %i.dw, align 4, !tbaa !42
  %i.dx = load ptr, ptr %i.dr, align 8, !tbaa !43
  %i.dy = getelementptr inbounds nuw i8, ptr %i.dx, i64 16
  %i.dz = load ptr, ptr %i.dy, align 8
  call void %i.dz(ptr noundef nonnull align 8 dereferenceable(16) %i.dr) #17, !inline_history !55
  %i.ea = load ptr, ptr %i.dr, align 8, !tbaa !43
  %i.eb = getelementptr inbounds nuw i8, ptr %i.ea, i64 24
  %i.ec = load ptr, ptr %i.eb, align 8
  call void %i.ec(ptr noundef nonnull align 8 dereferenceable(16) %i.dr) #17, !inline_history !55
  br label %bb.bq

bb.ay:                                            ; preds = %bb.aw
  %i.ed = load i8, ptr @__libc_single_threaded, align 1, !tbaa !37
  %.not.i.i.i.i368 = icmp eq i8 %i.ed, 0
  br i1 %.not.i.i.i.i368, label %bb.ba, label %bb.az
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i369: ; preds = %bb.ba, %bb.az
  %.0.i.i.i.i.i370 = phi i32 [ %i.dv, %bb.az ], [ %i.ef, %bb.ba ]
  %i.eg = icmp eq i32 %.0.i.i.i.i.i370, 1
  br i1 %i.eg, label %bb.bb, label %bb.bq, !prof !39

bb.bb:                                            ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i369
  call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.dr) #17
  br label %bb.bq

.loopexit673:                                     ; preds = %bb.ac, %.noexc
  %lpad.loopexit675 = landingpad { ptr, i32 }
          cleanup
  br label %.body

.loopexit.split-lp674:                            ; preds = %bb.a, %.noexc.peel
  %lpad.loopexit.split-lp676 = landingpad { ptr, i32 }
end_hunk_0
begin_hunk_1_@_ZN6duckdb12_GLOBAL__N_113TemplatedCopyIdEEvRKNS_6VectorERKNS_15SelectionVectorERS2_mmm:bb.a
_ZNK6duckdb15SelectionVector9get_indexEm.exit.us: ; preds = %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us.prol.loopexit, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us
  %.012.us = phi i64 [ %i.aj, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us ], [ %.012.us.unr, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us.prol.loopexit ] ; 6 uses
  %gep19 = getelementptr [8 x i8], ptr %invariant.gep18, i64 %.012.us
  %i.y = load double, ptr %gep19, align 8, !tbaa !138
  %i.z = getelementptr [8 x i8], ptr %i.h, i64 %.012.us
  store double %i.y, ptr %i.z, align 8, !tbaa !138
  %i.aa = add nuw i64 %.012.us, 1                 ; 2 uses
  %gep19.1 = getelementptr [8 x i8], ptr %invariant.gep18, i64 %i.aa
  %i.ab = load double, ptr %gep19.1, align 8, !tbaa !138
  %i.ac = getelementptr [8 x i8], ptr %i.h, i64 %i.aa
  store double %i.ab, ptr %i.ac, align 8, !tbaa !138
  %i.ad = add nuw i64 %.012.us, 2                 ; 2 uses
  %gep19.2 = getelementptr [8 x i8], ptr %invariant.gep18, i64 %i.ad
  %i.ae = load double, ptr %gep19.2, align 8, !tbaa !138
  %i.af = getelementptr [8 x i8], ptr %i.h, i64 %i.ad
  store double %i.ae, ptr %i.af, align 8, !tbaa !138
  %i.ag = add nuw i64 %.012.us, 3                 ; 2 uses
  %gep19.3 = getelementptr [8 x i8], ptr %invariant.gep18, i64 %i.ag
  %i.ah = load double, ptr %gep19.3, align 8, !tbaa !138
  %i.ai = getelementptr [8 x i8], ptr %i.h, i64 %i.ag
  store double %i.ah, ptr %i.ai, align 8, !tbaa !138
  %i.aj = add nuw i64 %.012.us, 4                 ; 2 uses
  %exitcond16.not.3 = icmp eq i64 %i.aj, %5
  br i1 %exitcond16.not.3, label %.split14.us, label %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us, !llvm.loop !142

.split14.us.loopexit23.unr-lcssa:                 ; preds = %_ZNK6duckdb15SelectionVector9get_indexEm.exit
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.split14.us, label %_ZNK6duckdb15SelectionVector9get_indexEm.exit.epil.preheader

_ZNK6duckdb15SelectionVector9get_indexEm.exit.epil.preheader: ; preds = %.split14.us.loopexit23.unr-lcssa, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.preheader
  %.012.epil.init = phi i64 [ 0, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.preheader ], [ %i.bn, %.split14.us.loopexit23.unr-lcssa ]
...
_ZNK6duckdb15SelectionVector9get_indexEm.exit.epil: ; preds = %_ZNK6duckdb15SelectionVector9get_indexEm.exit.epil, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.epil.preheader
  %.012.epil = phi i64 [ %i.ap, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.epil ], [ %.012.epil.init, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.epil.preheader ] ; 3 uses
  ...
  %gep.epil = getelementptr [4 x i8], ptr %invariant.gep, i64 %.012.epil
  %i.ak = load i32, ptr %gep.epil, align 4, !tbaa !3
  %i.al = zext i32 %i.ak to i64
  %i.am = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %i.al
  %i.an = load double, ptr %i.am, align 8, !tbaa !138
  %i.ao = getelementptr [8 x i8], ptr %i.h, i64 %.012.epil
  store double %i.an, ptr %i.ao, align 8, !tbaa !138
  %i.ap = add nuw i64 %.012.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %.split14.us, label %_ZNK6duckdb15SelectionVector9get_indexEm.exit.epil, !llvm.loop !143

.split14.us:                                      ; preds = %.split14.us.loopexit23.unr-lcssa, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.epil, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us.prol.loopexit, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us, %middle.block
  ret void
...
_ZNK6duckdb15SelectionVector9get_indexEm.exit:    ; preds = %_ZNK6duckdb15SelectionVector9get_indexEm.exit, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.preheader.new
  %.012 = phi i64 [ 0, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.preheader.new ], [ %i.bn, %_ZNK6duckdb15SelectionVector9get_indexEm.exit ] ; 6 uses
  ...
  %gep = getelementptr [4 x i8], ptr %invariant.gep, i64 %.012
  %i.aq = load i32, ptr %gep, align 4, !tbaa !3
  %i.ar = zext i32 %i.aq to i64
  %i.as = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %i.ar
  %i.at = load double, ptr %i.as, align 8, !tbaa !138
  %i.au = getelementptr [8 x i8], ptr %i.h, i64 %.012
  store double %i.at, ptr %i.au, align 8, !tbaa !138
  %i.av = or disjoint i64 %.012, 1                ; 2 uses
  %gep.1 = getelementptr [4 x i8], ptr %invariant.gep, i64 %i.av
  %i.aw = load i32, ptr %gep.1, align 4, !tbaa !3
  %i.ax = zext i32 %i.aw to i64
  %i.ay = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %i.ax
  %i.az = load double, ptr %i.ay, align 8, !tbaa !138
  %i.ba = getelementptr [8 x i8], ptr %i.h, i64 %i.av
  store double %i.az, ptr %i.ba, align 8, !tbaa !138
  %i.bb = or disjoint i64 %.012, 2                ; 2 uses
  %gep.2 = getelementptr [4 x i8], ptr %invariant.gep, i64 %i.bb
  %i.bc = load i32, ptr %gep.2, align 4, !tbaa !3
  %i.bd = zext i32 %i.bc to i64
  %i.be = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %i.bd
  %i.bf = load double, ptr %i.be, align 8, !tbaa !138
  %i.bg = getelementptr [8 x i8], ptr %i.h, i64 %i.bb
  store double %i.bf, ptr %i.bg, align 8, !tbaa !138
  %i.bh = or disjoint i64 %.012, 3                ; 2 uses
  %gep.3 = getelementptr [4 x i8], ptr %invariant.gep, i64 %i.bh
  %i.bi = load i32, ptr %gep.3, align 4, !tbaa !3
  %i.bj = zext i32 %i.bi to i64
  %i.bk = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %i.bj
  %i.bl = load double, ptr %i.bk, align 8, !tbaa !138
  %i.bm = getelementptr [8 x i8], ptr %i.h, i64 %i.bh
  store double %i.bl, ptr %i.bm, align 8, !tbaa !138
  %i.bn = add nuw i64 %.012, 4                    ; 2 uses
  %niter.next.3 = add i64 %niter, 4               ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %.split14.us.loopexit23.unr-lcssa, label %_ZNK6duckdb15SelectionVector9get_indexEm.exit, !llvm.loop !144
}

; Function Attrs: mustprogress uwtable
define internal fastcc void @_ZN6duckdb12_GLOBAL__N_113TemplatedCopyINS_10interval_tEEEvRKNS_6VectorERKNS_15SelectionVectorERS3_mmm(ptr noundef nonnull align 8 dereferenceable(104) %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(24) %1, ptr noundef nonnull align 8 dereferenceable(104) %2, i64 noundef %3, i64 noundef %4, i64 noundef range(i64 1, 0) %5) unnamed_addr #0 {
bb.a:
  ...
  %i.e = getelementptr [16 x i8], ptr %i.d, i64 %4 ; 3 uses
...
.unr-lcssa:                                       ; preds = %_ZNK6duckdb15SelectionVector9get_indexEm.exit.1
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %bb.c, label %.epil.preheader

.epil.preheader:                                  ; preds = %.unr-lcssa, %bb.a
  %.012.epil.init = phi i64 [ 0, %bb.a ], [ %i.af, %.unr-lcssa ] ; 2 uses
  %lcmp.mod14 = trunc i64 %5 to i1
  tail call void @llvm.assume(i1 %lcmp.mod14)
  %i.g = add i64 %.012.epil.init, %3              ; 2 uses
  %i.h = load ptr, ptr %1, align 8, !tbaa !50     ; 2 uses
  %.not.i.epil = icmp eq ptr %i.h, null
  br i1 %.not.i.epil, label %_ZNK6duckdb15SelectionVector9get_indexEm.exit.epil, label %bb.b
...
_ZNK6duckdb15SelectionVector9get_indexEm.exit.epil: ; preds = %bb.b, %.epil.preheader
  %i.l = phi i64 [ %i.k, %bb.b ], [ %i.g, %.epil.preheader ]
  %i.m = getelementptr inbounds nuw [16 x i8], ptr %i.b, i64 %i.l
  %i.n = getelementptr [16 x i8], ptr %i.e, i64 %.012.epil.init
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.n, ptr noundef nonnull align 8 dereferenceable(16) %i.m, i64 16, i1 false), !tbaa.struct !145
  br label %bb.c

bb.c:                                             ; preds = %.unr-lcssa, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.epil
  ret void

bb.d:                                             ; preds = %_ZNK6duckdb15SelectionVector9get_indexEm.exit.1, %.new
  %.012 = phi i64 [ 0, %.new ], [ %i.af, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.1 ] ; 4 uses
  %niter = phi i64 [ 0, %.new ], [ %niter.next.1, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.1 ]
  %i.o = add i64 %.012, %3                        ; 2 uses
  %i.p = load ptr, ptr %1, align 8, !tbaa !50     ; 2 uses
  %.not.i = icmp eq ptr %i.p, null
  br i1 %.not.i, label %_ZNK6duckdb15SelectionVector9get_indexEm.exit, label %bb.e
...
_ZNK6duckdb15SelectionVector9get_indexEm.exit:    ; preds = %bb.d, %bb.e
  %i.t = phi i64 [ %i.s, %bb.e ], [ %i.o, %bb.d ]
  %i.u = getelementptr inbounds nuw [16 x i8], ptr %i.b, i64 %i.t
  %i.v = getelementptr [16 x i8], ptr %i.e, i64 %.012
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.v, ptr noundef nonnull align 8 dereferenceable(16) %i.u, i64 16, i1 false), !tbaa.struct !145
  %i.w = or disjoint i64 %.012, 1                 ; 2 uses
  %i.x = add i64 %i.w, %3                         ; 2 uses
  %i.y = load ptr, ptr %1, align 8, !tbaa !50     ; 2 uses
  %.not.i.1 = icmp eq ptr %i.y, null
  br i1 %.not.i.1, label %_ZNK6duckdb15SelectionVector9get_indexEm.exit.1, label %bb.f
...
_ZNK6duckdb15SelectionVector9get_indexEm.exit.1:  ; preds = %bb.f, %_ZNK6duckdb15SelectionVector9get_indexEm.exit
  %i.ac = phi i64 [ %i.ab, %bb.f ], [ %i.x, %_ZNK6duckdb15SelectionVector9get_indexEm.exit ]
  %i.ad = getelementptr inbounds nuw [16 x i8], ptr %i.b, i64 %i.ac
  %i.ae = getelementptr [16 x i8], ptr %i.e, i64 %i.w
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.ae, ptr noundef nonnull align 8 dereferenceable(16) %i.ad, i64 16, i1 false), !tbaa.struct !145
  %i.af = add nuw i64 %.012, 2                    ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.unr-lcssa, label %bb.d, !llvm.loop !146
}
...
; Function Attrs: mustprogress uwtable
define linkonce_odr noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6duckdb6vectorINS_10unique_ptrINS_6VectorESt14default_deleteIS2_ELb1EEELb1ESaIS5_EEixEm(ptr noundef nonnull align 8 dereferenceable(24) %0, i64 noundef %1) local_unnamed_addr #0 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  ...
  %i.e = load ptr, ptr %0, align 8, !tbaa !74     ; 3 uses
  ...
  store i64 %i.i, ptr %i.b, align 8, !tbaa !56
  %.not.i.i = icmp ult i64 %1, %i.i
  br i1 %.not.i.i, label %_ZNK6duckdb6vectorINS_10unique_ptrINS_6VectorESt14default_deleteIS2_ELb1EEELb1ESaIS5_EE3getILb1EEERKS5_m.exit, label %bb.b, !prof !147
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %i.l = landingpad { ptr, i32 }
          cleanup                                 ; 4 uses
  %i.m = load ptr, ptr %2, align 8, !tbaa !58     ; 2 uses
...
bb.a:
  ...
  br i1 %.not, label %bb.b, label %_ZN6duckdb10unique_ptrINS_6VectorESt14default_deleteIS1_ELb1EE13AssertNotNullEb.exit, !prof !39
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %i.d = landingpad { ptr, i32 }
          cleanup                                 ; 4 uses
  %i.e = load ptr, ptr %1, align 8, !tbaa !58     ; 2 uses
...
; Function Attrs: mustprogress uwtable
define linkonce_odr noundef nonnull align 8 dereferenceable(8) ptr @_ZN6duckdb6vectorINS_10unique_ptrINS_6VectorESt14default_deleteIS2_ELb1EEELb1ESaIS5_EEixEm(ptr noundef nonnull align 8 dereferenceable(24) %0, i64 noundef %1) local_unnamed_addr #0 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = alloca i64, align 8                      ; 4 uses
  %i.b = alloca i64, align 8                      ; 4 uses
  %2 = alloca %"class.std::__cxx11::basic_string", align 8 ; 8 uses
  ...
  store i64 %i.i, ptr %i.b, align 8, !tbaa !56
  %.not.i.i = icmp ult i64 %1, %i.i
  br i1 %.not.i.i, label %_ZN6duckdb6vectorINS_10unique_ptrINS_6VectorESt14default_deleteIS2_ELb1EEELb1ESaIS5_EE3getILb1EEERS5_m.exit, label %bb.b, !prof !147
...
; Function Attrs: mustprogress uwtable
define linkonce_odr void @_ZN6duckdb15SelectionVectorC2Em(ptr noundef nonnull align 8 dereferenceable(24) %0, i64 noundef %1) unnamed_addr #0 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.a, i8 0, i64 16, i1 false)
  invoke void @_ZN6duckdb15SelectionVector10InitializeEm(ptr noundef nonnull align 8 dereferenceable(24) %0, i64 noundef %1)
...
bb.c:                                             ; preds = %bb.a
  %i.b = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev(ptr noundef nonnull align 8 dead_on_return(16) dereferenceable(16) %i.a) #17
  resume { ptr, i32 } %i.b
}

; Function Attrs: inlinehint mustprogress nounwind uwtable
define linkonce_odr void @_ZN6duckdb15SelectionVectorD2Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %0) unnamed_addr #5 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !36   ; 8 uses
  %.not.i.i.i = icmp eq ptr %i.b, null
  br i1 %.not.i.i.i, label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev.exit, label %bb.b
...
bb.c:                                             ; preds = %bb.b
  ...
  tail call void %i.j(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #17, !inline_history !55
  %i.k = load ptr, ptr %i.b, align 8, !tbaa !43
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 24
  %i.m = load ptr, ptr %i.l, align 8
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #17, !inline_history !55
  br label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev.exit
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i: ; preds = %bb.f, %bb.e
  ...
  br i1 %i.q, label %bb.g, label %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev.exit, !prof !39
...
; Function Attrs: mustprogress uwtable
define linkonce_odr void @_ZN6duckdb23NotImplementedExceptionC2IJNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEERKS7_DpOT_(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef nonnull align 8 dereferenceable(32) %1, ptr noundef nonnull align 8 dereferenceable(32) %2) unnamed_addr #0 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %3 = alloca %"class.std::vector.40", align 8    ; 9 uses
  %4 = alloca %"class.std::__cxx11::basic_string", align 8 ; 9 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #17
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #17, !noalias !150
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %3, i8 0, i64 24, i1 false), !noalias !150
...
bb.b:                                             ; preds = %bb.a
  %i.a = load ptr, ptr %3, align 8, !tbaa !153, !noalias !150 ; 3 uses
  %i.b = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !156, !noalias !150 ; 2 uses
...
_ZSt8_DestroyIN6duckdb20ExceptionFormatValueEEvPT_.exit.i.i.i.i: ; preds = %.lr.ph.i.i.i.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i.i.i
  ...
  br i1 %.not.i.i.i.i, label %_ZSt8_DestroyIPN6duckdb20ExceptionFormatValueES1_EvT_S3_RSaIT0_E.exitthread-pre-split.i.i, label %.lr.ph.i.i.i.i, !llvm.loop !157
...
_ZSt8_DestroyIPN6duckdb20ExceptionFormatValueES1_EvT_S3_RSaIT0_E.exitthread-pre-split.i.i: ; preds = %_ZSt8_DestroyIN6duckdb20ExceptionFormatValueEEvPT_.exit.i.i.i.i
  %.pr.i.i = load ptr, ptr %3, align 8, !tbaa !153, !noalias !150
...
bb.d:                                             ; preds = %bb.a
  %i.j = landingpad { ptr, i32 }
          cleanup
  call void @_ZNSt6vectorIN6duckdb20ExceptionFormatValueESaIS1_EED2Ev(ptr noundef nonnull align 8 dereferenceable(24) %3) #17
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #17, !noalias !150
...
bb.e:                                             ; preds = %_ZN6duckdb9Exception16ConstructMessageIJNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEES7_RKS7_DpRKT_.exit
  %i.k = load ptr, ptr %4, align 8, !tbaa !58     ; 2 uses
...
bb.f:                                             ; preds = %_ZN6duckdb9Exception16ConstructMessageIJNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEES7_RKS7_DpRKT_.exit
  %i.n = landingpad { ptr, i32 }
          cleanup
  %i.o = load ptr, ptr %4, align 8, !tbaa !58     ; 2 uses
...
; Function Attrs: mustprogress uwtable
define void @_ZN6duckdb16VectorOperations4CopyERKNS_6VectorERS1_mmm(ptr noundef nonnull align 8 dereferenceable(104) %0, ptr noundef nonnull align 8 dereferenceable(104) %1, i64 noundef %2, i64 noundef %3, i64 noundef %4) local_unnamed_addr #0 align 2 {
bb.a:
  %i.a = tail call noundef ptr @_ZN6duckdb10FlatVector26IncrementalSelectionVectorEv()
  %i.b = sub i64 %2, %3
  tail call void @_ZN6duckdb16VectorOperations4CopyERKNS_6VectorERS1_RKNS_15SelectionVectorEmmmm(ptr noundef nonnull align 8 dereferenceable(104) %0, ptr noundef nonnull align 8 dereferenceable(104) %1, ptr noundef nonnull align 8 dereferenceable(24) %i.a, i64 noundef %2, i64 noundef %3, i64 noundef %4, i64 noundef %i.b), !inline_history !57
  ret void
}

declare noundef ptr @_ZN6duckdb10FlatVector26IncrementalSelectionVectorEv() local_unnamed_addr #2
end_hunk_1
begin_hunk_2_@_ZN6duckdb17InternalExceptionC2IJRmS2_EEERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_:bb.a
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !156  ; 6 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr %i.g, ptr %i.e, align 8, !tbaa !175
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.l = load i64, ptr %i.k, align 8, !tbaa !176  ; 3 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i: ; preds = %bb.b
  store ptr %i.h, ptr %i.e, align 8, !tbaa !58
  %i.o = load i64, ptr %i.i, align 8, !tbaa !37
  store i64 %i.o, ptr %i.g, align 8, !tbaa !37
...
_ZNSt6vectorIN6duckdb20ExceptionFormatValueESaIS1_EE9push_backEOS1_.exit.thread: ; preds = %bb.c, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i
  ...
  store i64 %i.p, ptr %i.r, align 8, !tbaa !176
  store ptr %i.i, ptr %i.f, align 8, !tbaa !58
  store i64 0, ptr %i.q, align 8, !tbaa !176
  %i.s = load ptr, ptr %i.a, align 8, !tbaa !156
  %i.t = getelementptr inbounds nuw i8, ptr %i.s, i64 64
  store ptr %i.t, ptr %i.a, align 8, !tbaa !156
...
_ZNSt6vectorIN6duckdb20ExceptionFormatValueESaIS1_EE9push_backEOS1_.exit: ; preds = %bb.d
  ...
  %.pre10 = load ptr, ptr %.phi.trans.insert9, align 8, !tbaa !58 ; 2 uses
...
_ZNSt6vectorIN6duckdb20ExceptionFormatValueESaIS1_EE9push_backEOS1_.exit: ; preds = %bb.d
  ...
  %.pre9 = load ptr, ptr %.phi.trans.insert8, align 8, !tbaa !58 ; 2 uses
...
!6 = !{!"Simple C++ TBAA"}
!7 = !{!8, !9, i64 0}
!8 = !{!"_ZTSN6duckdb6VectorE", !9, i64 0, !10, i64 8, !20, i64 32, !21, i64 40, !29, i64 72, !29, i64 88}
!9 = !{!"_ZTSN6duckdb10VectorTypeE", !5, i64 0}
!10 = !{!"_ZTSN6duckdb11LogicalTypeE", !11, i64 0, !12, i64 1, !13, i64 8}
!11 = !{!"_ZTSN6duckdb13LogicalTypeIdE", !5, i64 0}
!12 = !{!"_ZTSN6duckdb12PhysicalTypeE", !5, i64 0}
!13 = !{!"_ZTSN6duckdb10shared_ptrINS_13ExtraTypeInfoELb1EEE", !14, i64 0}
!14 = !{!"_ZTSSt10shared_ptrIN6duckdb13ExtraTypeInfoEE", !15, i64 0}
!15 = !{!"_ZTSSt12__shared_ptrIN6duckdb13ExtraTypeInfoELN9__gnu_cxx12_Lock_policyE2EE", !16, i64 0, !18, i64 8}
!16 = !{!"p1 _ZTSN6duckdb13ExtraTypeInfoE", !17, i64 0}
...
!22 = !{!"_ZTSN6duckdb21TemplatedValidityMaskImEE", !23, i64 0, !24, i64 8, !28, i64 24}
!23 = !{!"p1 long", !17, i64 0}
!24 = !{!"_ZTSN6duckdb10shared_ptrINS_21TemplatedValidityDataImEELb1EEE", !25, i64 0}
!25 = !{!"_ZTSSt10shared_ptrIN6duckdb21TemplatedValidityDataImEEE", !26, i64 0}
!26 = !{!"_ZTSSt12__shared_ptrIN6duckdb21TemplatedValidityDataImEELN9__gnu_cxx12_Lock_policyE2EE", !27, i64 0, !18, i64 8}
!27 = !{!"p1 _ZTSN6duckdb21TemplatedValidityDataImEE", !17, i64 0}
!28 = !{!"long", !5, i64 0}
!29 = !{!"_ZTSN6duckdb10shared_ptrINS_12VectorBufferELb1EEE", !30, i64 0}
!30 = !{!"_ZTSSt10shared_ptrIN6duckdb12VectorBufferEE", !31, i64 0}
!31 = !{!"_ZTSSt12__shared_ptrIN6duckdb12VectorBufferELN9__gnu_cxx12_Lock_policyE2EE", !32, i64 0, !18, i64 8}
!32 = !{!"p1 _ZTSN6duckdb12VectorBufferE", !17, i64 0}
!33 = !{!34, !35, i64 0}
!34 = !{!"_ZTSSt12__shared_ptrIN6duckdb13SelectionDataELN9__gnu_cxx12_Lock_policyE2EE", !35, i64 0, !18, i64 8}
!35 = !{!"p1 _ZTSN6duckdb13SelectionDataE", !17, i64 0}
!36 = !{!18, !19, i64 0}
!37 = !{!5, !5, i64 0}
!38 = !{!35, !35, i64 0}
...
!45 = distinct !{null, null, ptr @_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev, null, null, null}
!46 = !{!47, !20, i64 8}
!47 = !{!"_ZTSN6duckdb13AllocatedDataE", !48, i64 0, !20, i64 8, !28, i64 16}
!48 = !{!"_ZTSN6duckdb12optional_ptrINS_9AllocatorELb1EEE", !49, i64 0}
!49 = !{!"p1 _ZTSN6duckdb9AllocatorE", !17, i64 0}
!50 = !{!51, !52, i64 0}
!51 = !{!"_ZTSN6duckdb15SelectionVectorE", !52, i64 0, !53, i64 8}
!52 = !{!"p1 int", !17, i64 0}
!53 = !{!"_ZTSN6duckdb10shared_ptrINS_13SelectionDataELb1EEE", !54, i64 0}
!54 = !{!"_ZTSSt10shared_ptrIN6duckdb13SelectionDataEE", !34, i64 0}
!55 = distinct !{ptr @_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev, null, null, null}
!56 = !{!28, !28, i64 0}
!57 = !{ptr @_ZN6duckdb16VectorOperations4CopyERKNS_6VectorERS1_RKNS_15SelectionVectorEmmm}
!58 = !{!59, !20, i64 0}
!59 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE", !60, i64 0, !28, i64 8, !5, i64 16}
...
!70 = distinct !{!70, !62}
!71 = !{!72, !73, i64 8}
!72 = !{!"_ZTSNSt12_Vector_baseIN6duckdb10unique_ptrINS0_6VectorESt14default_deleteIS2_ELb1EEESaIS5_EE17_Vector_impl_dataE", !73, i64 0, !73, i64 8, !73, i64 16}
!73 = !{!"p1 _ZTSN6duckdb10unique_ptrINS_6VectorESt14default_deleteIS1_ELb1EEE", !17, i64 0}
!74 = !{!72, !73, i64 0}
!75 = distinct !{!75, !62}
!76 = distinct !{!76, !62, !77, !78}
!77 = !{!"llvm.loop.isvectorized", i32 1}
!78 = !{!"llvm.loop.unroll.runtime.disable"}
!79 = distinct !{!79, !62, !78, !77}
!80 = distinct !{!80, !62}
!81 = !{!82, !28, i64 8}
!82 = !{!"_ZTSN6duckdb12list_entry_tE", !28, i64 0, !28, i64 8}
!83 = !{!82, !28, i64 0}
!84 = distinct !{!84, !62}
!85 = distinct !{!85, !62}
!86 = distinct !{!86, !62}
!87 = distinct !{ptr @_ZN6duckdb15SelectionVectorD2Ev, ptr @_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev, null, null, null}
!88 = distinct !{null, null, null}
!89 = distinct !{null, null, null, null}
!90 = distinct !{null, null, null, null, null}
!91 = !{!92, !92, i64 0}
!92 = !{!"short", !5, i64 0}
!93 = distinct !{!93, !62, !77, !78}
!94 = !{!"branch_weights", i32 4, i32 12}
!95 = distinct !{!95, !62, !77, !78}
!96 = distinct !{!96, !97}
!97 = !{!"llvm.loop.unroll.disable"}
!98 = distinct !{!98, !62, !77}
!99 = distinct !{!99, !97}
!100 = distinct !{!100, !62}
!101 = distinct !{!101, !62, !77, !78}
!102 = distinct !{!102, !97}
!103 = distinct !{!103, !62, !77}
!104 = distinct !{!104, !97}
!105 = distinct !{!105, !62}
!106 = distinct !{!106, !62, !77, !78}
!107 = distinct !{!107, !97}
!108 = distinct !{!108, !62, !77}
!109 = distinct !{!109, !97}
!110 = distinct !{!110, !62}
!111 = distinct !{!111, !62}
!112 = distinct !{!112, !62, !77, !78}
!113 = distinct !{!113, !62, !77, !78}
!114 = distinct !{!114, !97}
!115 = distinct !{!115, !62, !77}
!116 = distinct !{!116, !97}
!117 = distinct !{!117, !62}
!118 = distinct !{!118, !62, !77, !78}
!119 = distinct !{!119, !97}
!120 = distinct !{!120, !62, !77}
!121 = distinct !{!121, !97}
!122 = distinct !{!122, !62}
!123 = distinct !{!123, !62, !77, !78}
!124 = distinct !{!124, !97}
!125 = distinct !{!125, !62, !77}
!126 = distinct !{!126, !97}
!127 = distinct !{!127, !62}
!128 = !{i64 0, i64 8, !56, i64 8, i64 8, !56}
!129 = distinct !{!129, !62}
!130 = distinct !{!130, !62}
!131 = !{!132, !132, i64 0}
!132 = !{!"float", !5, i64 0}
!133 = distinct !{!133, !62, !77, !78}
!134 = distinct !{!134, !97}
!135 = distinct !{!135, !62, !77}
!136 = distinct !{!136, !97}
!137 = distinct !{!137, !62}
!138 = !{!139, !139, i64 0}
!139 = !{!"double", !5, i64 0}
!140 = distinct !{!140, !62, !77, !78}
!141 = distinct !{!141, !97}
!142 = distinct !{!142, !62, !77}
!143 = distinct !{!143, !97}
!144 = distinct !{!144, !62}
!145 = !{i64 0, i64 4, !3, i64 4, i64 4, !3, i64 8, i64 8, !56}
!146 = distinct !{!146, !62}
!147 = !{!"branch_weights", !"expected", i32 2000, i32 1}
!148 = !{!149, !149, i64 0}
!149 = !{!"p1 _ZTSN6duckdb6VectorE", !17, i64 0}
!150 = !{!151}
!151 = distinct !{!151, !152, !"_ZN6duckdb9Exception16ConstructMessageIJNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEES7_RKS7_DpRKT_: argument 0"}
!152 = distinct !{!152, !"_ZN6duckdb9Exception16ConstructMessageIJNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEES7_RKS7_DpRKT_"}
!153 = !{!154, !155, i64 0}
!154 = !{!"_ZTSNSt12_Vector_baseIN6duckdb20ExceptionFormatValueESaIS1_EE17_Vector_impl_dataE", !155, i64 0, !155, i64 8, !155, i64 16}
!155 = !{!"p1 _ZTSN6duckdb20ExceptionFormatValueE", !17, i64 0}
!156 = !{!154, !155, i64 8}
!157 = distinct !{!157, !62}
!158 = !{!31, !32, i64 0}
!159 = distinct !{null}
!160 = !{!161, !163}
!161 = distinct !{!161, !162, !"_ZSt11make_sharedIN6duckdb13SelectionDataEJRmEESt10shared_ptrINSt9enable_ifIXntsr8is_arrayIT_EE5valueES5_E4typeEEDpOT0_: argument 0"}
!162 = distinct !{!162, !"_ZSt11make_sharedIN6duckdb13SelectionDataEJRmEESt10shared_ptrINSt9enable_ifIXntsr8is_arrayIT_EE5valueES5_E4typeEEDpOT0_"}
!163 = distinct !{!163, !164, !"_ZN6duckdb15make_shared_ptrINS_13SelectionDataEJRmEEENS_10shared_ptrIT_Lb1EEEDpOT0_: argument 0"}
!164 = distinct !{!164, !"_ZN6duckdb15make_shared_ptrINS_13SelectionDataEJRmEEENS_10shared_ptrIT_Lb1EEEDpOT0_"}
!165 = !{!163}
!166 = distinct !{null, null, null, null}
!167 = distinct !{null, ptr @_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EED2Ev, null, null, null}
!168 = !{!169, !20, i64 8}
!169 = !{!"_ZTSSt9type_info", !20, i64 8}
!170 = !{!12, !12, i64 0}
!171 = !{!172}
!172 = distinct !{!172, !173, !"_ZN6duckdb9Exception16ConstructMessageIJNS_12PhysicalTypeES2_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERKS8_DpRKT_: argument 0"}
end_hunk_2
