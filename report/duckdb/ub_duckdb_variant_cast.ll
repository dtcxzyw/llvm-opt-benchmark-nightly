...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %12 = load <3 x i64>, ptr %i.af, align 8, !tbaa !139
  %strided.vec = shufflevector <3 x i64> %12, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %13 = load <3 x i64>, ptr %i.ag, align 8, !tbaa !139
  %strided.vec207 = shufflevector <3 x i64> %13, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %strided.vec = shufflevector <3 x i64> %12, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %13 = load <3 x i64>, ptr %i.ag, align 8, !tbaa !139
  %strided.vec200 = shufflevector <3 x i64> %13, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %i.ah = add <2 x i64> %strided.vec, %vec.phi    ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %14 = load <3 x i64>, ptr %i.ag, align 8, !tbaa !139
  %strided.vec = shufflevector <3 x i64> %14, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %15 = load <3 x i64>, ptr %i.ah, align 8, !tbaa !139
  %strided.vec237 = shufflevector <3 x i64> %15, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ah = getelementptr inbounds nuw i8, ptr %i.af, i64 40
  %13 = load <3 x i64>, ptr %i.ag, align 8, !tbaa !139
  %strided.vec = shufflevector <3 x i64> %13, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %14 = load <3 x i64>, ptr %i.ah, align 8, !tbaa !139
  %strided.vec225 = shufflevector <3 x i64> %14, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %i.ai = add <2 x i64> %strided.vec, %vec.phi    ; 2 uses
