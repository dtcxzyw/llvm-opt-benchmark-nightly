begin_hunk_0_@duckdb_je_buf_writer_cb:bb.a
  ...
  tail call void %i.p(ptr noundef %i.q, ptr noundef %i.r) #8, !inline_history !29
...
begin_hunk_1_@duckdb_je_buf_writer_terminate:bb.a
  ...
  tail call void %i.g(ptr noundef %i.i, ptr noundef %i.j) #8, !inline_history !29
...
duckdb_je_buf_writer_flush.exit:                  ; preds = %bb.a, %bb.b
  ...
  %i.l = load i8, ptr %i.k, align 8, !tbaa !26, !range !30, !noundef !31
...
begin_hunk_2_@duckdb_je_buf_writer_pipe:bb.a
  ...
  tail call void %i.s(ptr noundef %i.t, ptr noundef %i.u) #8, !inline_history !29
...
begin_hunk_3_@duckdb_je_buf_writer_pipe:bb.a
  ...
  tail call void %i.ag(ptr noundef %i.ah, ptr noundef %i.ai) #8, !inline_history !29
  store i64 0, ptr %i.i, align 8, !tbaa !28
...
begin_hunk_4_@rtree_read:bb.a
  ...
  %i.e = load i64, ptr %i.d, align 8, !tbaa !32   ; 3 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  store i64 %i.e, ptr %i.l, align 8, !tbaa !32
  ...
  store i64 %i.c, ptr %i.d, align 8, !tbaa !32
...
bb.f:                                             ; preds = %.preheader.6, %.preheader.5, %.preheader.4, %.preheader.3, %.preheader.2, %.preheader.1, %.preheader.preheader
  ...
  store i64 %i.au, ptr %.lcssa, align 8, !tbaa !32
  %i.av = getelementptr i8, ptr %.lcssa, i64 -8   ; 2 uses
  %i.aw = load ptr, ptr %i.av, align 8, !tbaa !35
  store ptr %i.aw, ptr %i.ar, align 8, !tbaa !35
  store i64 %i.e, ptr %i.at, align 8, !tbaa !32
  %i.ax = getelementptr inbounds nuw i8, ptr %i.d, i64 8 ; 2 uses
  %i.ay = load ptr, ptr %i.ax, align 8, !tbaa !35
  store ptr %i.ay, ptr %i.av, align 8, !tbaa !35
  store i64 %i.c, ptr %i.d, align 8, !tbaa !32
  store ptr %i.as, ptr %i.ax, align 8, !tbaa !35
  %i.az = lshr i64 %3, 12
...
rtree_leaf_elm_lookup.exit:                       ; preds = %bb.f, %bb.b, %bb.d, %bb.e
  %.1.i = phi ptr [ %i.k, %bb.b ], [ %i.x, %bb.d ], [ %i.aq, %bb.e ], [ %i.bb, %bb.f ]
  %i.bc = load atomic ptr, ptr %.1.i monotonic, align 8, !noalias !46
...
!27 = !{!8, !11, i64 24}
!28 = !{!8, !11, i64 32}
!29 = !{ptr @duckdb_je_buf_writer_flush}
!30 = !{i8 0, i8 2}
!31 = !{}
!32 = !{!33, !11, i64 0}
!33 = !{!"rtree_ctx_cache_elm_s", !11, i64 0, !34, i64 8}
!34 = !{!"p1 _ZTS16rtree_leaf_elm_s", !9, i64 0}
!35 = !{!33, !34, i64 8}
!36 = !{!37}
...
!39 = !{!18, !4, i64 8}
!40 = !{!41}
!41 = distinct !{!41, !42, !"rtree_leaf_elm_bits_decode: argument 0"}
