...
bb.f:                                             ; preds = %._crit_edge
  %i.m = load ptr, ptr %2, align 8, !tbaa !928    ; 2 uses
  %i.n = load ptr, ptr %i.d, align 8, !tbaa !792
  %i.o = ptrtoint ptr %i.n to i64
  %i.p = ptrtoint ptr %i.m to i64
  %i.q = sub i64 %i.o, %i.p
  %i.r = ashr exact i64 %i.q, 4
  %i.s = load ptr, ptr %i.h, align 8, !tbaa !738, !nonnull !132, !noundef !132
...
bb.g:                                             ; preds = %_ZN17duckdb_moodycamel15ConcurrentQueueIN6duckdb10shared_ptrINS1_4TaskELb1EEENS_28ConcurrentQueueDefaultTraitsEE12enqueue_bulkISt13move_iteratorIN9__gnu_cxx17__normal_iteratorIPS4_St6vectorIS4_SaIS4_EEEEEEEbRKNS_13ProducerTokenET_m.exit
  %i.v = load ptr, ptr %i.d, align 8, !tbaa !792
  %i.w = load ptr, ptr %2, align 8, !tbaa !795
  ...
  %i.ad = load ptr, ptr %i.d, align 8, !tbaa !792
  %i.ae = load ptr, ptr %2, align 8, !tbaa !795
...
bb.i:                                             ; preds = %bb.i, %.preheader.i.i
  %i.ar = tail call i32 @sem_post(ptr noundef nonnull align 8 dereferenceable(32) %i.ao) #36
  %i.as = icmp eq i32 %i.ar, -1
  br i1 %i.as, label %bb.i, label %bb.j, !llvm.loop !1204

bb.j:                                             ; preds = %bb.i
  %i.at = add nsw i32 %.in.i.i, -1
  %i.au = icmp sgt i32 %.in.i.i, 1
  br i1 %i.au, label %.preheader.i.i, label %_ZN17duckdb_moodycamel20LightweightSemaphore6signalEl.exit, !llvm.loop !1205
...
bb.l:                                             ; preds = %_ZN17duckdb_moodycamel15ConcurrentQueueIN6duckdb10shared_ptrINS1_4TaskELb1EEENS_28ConcurrentQueueDefaultTraitsEE12enqueue_bulkISt13move_iteratorIN9__gnu_cxx17__normal_iteratorIPS4_St6vectorIS4_SaIS4_EEEEEEEbRKNS_13ProducerTokenET_m.exit
  %i.aw = tail call ptr @__cxa_allocate_exception(i64 16) #36 ; 3 uses
...
bb.n:                                             ; preds = %bb.m
  invoke void @__cxa_throw(ptr nonnull %i.aw, ptr nonnull @_ZTIN6duckdb17InternalExceptionE, ptr nonnull @_ZNSt13runtime_errorD2Ev) #37
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.o
  call void @_ZdlPv(ptr noundef %i.az) #38
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #36
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #36
...
bb.p:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.thread, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  ...
  call void @__cxa_free_exception(ptr %i.aw) #36
  br label %bb.q

_ZN17duckdb_moodycamel20LightweightSemaphore6signalEl.exit: ; preds = %bb.j, %bb.h, %_ZN6duckdb11NumericCastIlmvEET_T0_.exit
  %i.bc = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.a) #36 ; 0 uses
  ret void
...
bb.q:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %bb.p, %bb.k, %bb.e
  ...
  %i.bd = call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.a) #36 ; 0 uses
  resume { ptr, i32 } %.pn20
...
define noundef zeroext i1 @_ZN6duckdb15ConcurrentQueue19DequeueFromProducerERNS_13ProducerTokenERNS_10shared_ptrINS_4TaskELb1EEE(ptr noundef nonnull align 8 captures(none) dereferenceable(664) %0, ptr noundef nonnull align 8 dereferenceable(56) %1, ptr noundef nonnull align 8 dereferenceable(16) %2) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
bb.c:                                             ; preds = %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !738, !nonnull !132, !noundef !132
...
bb.d:                                             ; preds = %bb.c, %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit
  %i.h = landingpad { ptr, i32 }
          cleanup
  %i.i = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.a) #36 ; 0 uses
  resume { ptr, i32 } %i.h
...
bb.f:                                             ; preds = %_ZN17duckdb_moodycamel15ConcurrentQueueIN6duckdb10shared_ptrINS1_4TaskELb1EEENS_28ConcurrentQueueDefaultTraitsEE25try_dequeue_from_producerIS4_EEbRKNS_13ProducerTokenERT_.exit, %bb.e
  %i.l = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.a) #36 ; 0 uses
  ret i1 %i.g
}
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !1206 ; 2 uses
  ...
  %i.t = and i1 %i.s, %i.p
  br i1 %i.t, label %.lr.ph, label %._crit_edge, !llvm.loop !1207

bb.b:                                             ; preds = %._crit_edge
  %i.u = getelementptr inbounds nuw i8, ptr %.228, i64 72
  %i.v = load i8, ptr %i.u, align 8, !tbaa !1208, !range !268, !noundef !132
...
bb.e:                                             ; preds = %.lr.ph47
  ...
  %i.ab = load i8, ptr %i.aa, align 8, !tbaa !1208, !range !268, !noundef !132
...
select.unfold:                                    ; preds = %bb.f, %.lr.ph47, %_ZN17duckdb_moodycamel15ConcurrentQueueIN6duckdb10shared_ptrINS1_4TaskELb1EEENS_28ConcurrentQueueDefaultTraitsEE12ProducerBase7dequeueIS4_EEbRT_.exit37
  ...
  %i.ag = load ptr, ptr %i.af, align 8, !tbaa !1206
...
define noundef i64 @_ZNK6duckdb15ConcurrentQueue15GetTasksInQueueEv(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(664) %0) local_unnamed_addr #12 align 2 {
bb.a:
...
define noundef i64 @_ZNK6duckdb15ConcurrentQueue13GetApproxSizeEv(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(664) %0) local_unnamed_addr #23 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 40
...
select.unfold.i:                                  ; preds = %bb.a, %select.unfold.i
  ...
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !1206
  %.fr.i = freeze ptr %i.m                        ; 2 uses
  %i.n = icmp eq ptr %.fr.i, null
  %i.o = getelementptr inbounds i8, ptr %.fr.i, i64 -8
...
define noundef i64 @_ZNK6duckdb15ConcurrentQueue16GetProducerCountEv(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(664) %0) local_unnamed_addr #24 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.b = load atomic ptr, ptr %i.a acquire, align 8 ; 2 uses
...
select.unfold.i:                                  ; preds = %bb.a, %select.unfold.i
  ...
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !1206
  %.fr.i = freeze ptr %i.e                        ; 2 uses
  %i.f = icmp eq ptr %.fr.i, null
  %i.g = getelementptr inbounds i8, ptr %.fr.i, i64 -8
...
; Function Attrs: mustprogress uwtable
define noundef i64 @_ZNK6duckdb15ConcurrentQueue23GetTaskCountForProducerERNS_13ProducerTokenE(ptr noundef nonnull readnone align 8 captures(none) dereferenceable(664) %0, ptr noundef nonnull align 8 dereferenceable(56) %1) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 3 uses
  %i.b = tail call noundef i32 @pthread_mutex_lock(ptr noundef nonnull align 8 dereferenceable(40) %i.a) #36 ; 2 uses
  %.not.i.i = icmp eq i32 %i.b, 0
...
bb.c:                                             ; preds = %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !738, !nonnull !132, !noundef !132 ; 2 uses
  ...
  %i.n = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.a) #36 ; 0 uses
  ret i64 %i.m

bb.d:                                             ; preds = %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit
  %i.o = landingpad { ptr, i32 }
          cleanup
  %i.p = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.a) #36 ; 0 uses
  resume { ptr, i32 } %i.o
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable
define void @_ZN6duckdb13ProducerTokenC2ERNS_13TaskSchedulerENS_10unique_ptrINS_18QueueProducerTokenESt14default_deleteIS4_ELb1EEE(ptr noundef nonnull writeonly align 8 captures(none) dereferenceable(56) initializes((0, 56)) %0, ptr noundef nonnull align 8 dereferenceable(124) %1, ptr noundef captures(none) %2) unnamed_addr #10 align 2 {
bb.a:
  store ptr %1, ptr %0, align 8, !tbaa !1178
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.b = load i64, ptr %2, align 8, !tbaa !747
  store i64 %i.b, ptr %i.a, align 8, !tbaa !747
...
define void @_ZN6duckdb13ProducerTokenD2Ev(ptr noundef nonnull readonly align 8 captures(none) dead_on_return(56) dereferenceable(56) %0) unnamed_addr #5 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !747  ; 3 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  store ptr null, ptr %i.d, align 8, !tbaa !741
