...
.lr.ph.split.us.preheader:                        ; preds = %.lr.ph
  ...
  %umax60 = tail call i64 @llvm.umax.i64(i64 %i.l, i64 1)
...
.lr.ph.split.us:                                  ; preds = %.lr.ph.split.us.preheader, %_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit21.us
  %.sroa.041.051.us = phi ptr [ %i.n, %_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit21.us ], [ %i.b, %.lr.ph.split.us.preheader ] ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph.split.us
  invoke void @_ZN6duckdb8Pipeline12GetOperatorsEv(ptr dead_on_unwind nonnull writable sret(%"class.duckdb::vector.21") align 8 %3, ptr noundef nonnull align 8 dereferenceable(224) %i.m)
          to label %.preheader.us.us unwind label %.split.us

._crit_edge49.us.thread:                          ; preds = %bb.d, %._crit_edge.us.us
...
_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit21.us: ; preds = %._crit_edge49.us.thread, %._crit_edge.us.us
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #34
  %i.n = getelementptr inbounds nuw i8, ptr %.sroa.041.051.us, i64 16 ; 2 uses
  %.not.us = icmp eq ptr %i.n, %i.d
  br i1 %.not.us, label %._crit_edge, label %.lr.ph.split.us

.preheader46.us.a:                                ; preds = %._crit_edge49.us, %.preheader.us.us.preheader
  %.01447.us = phi i64 [ 0, %._crit_edge49.us ], [ %9, %.preheader.us.us.preheader ] ; 2 uses
  %4 = load ptr, ptr %10, align 8, !tbaa !680     ; 2 uses
  %5 = getelementptr inbounds nuw [8 x i8], ptr %12, i64 %.01447.us
  %i.o = load ptr, ptr %5, align 8, !tbaa !680
  %i.p = load ptr, ptr %4, align 8, !tbaa !28
  %6 = getelementptr inbounds nuw i8, ptr %i.p, i64 48
  %7 = load ptr, ptr %6, align 8
  %8 = invoke noundef zeroext i1 %7(ptr noundef nonnull align 8 dereferenceable(136) %4, ptr noundef nonnull align 8 dereferenceable(136) %i.o)
          to label %.preheader.us.us.preheader unwind label %_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit34.thread ; 0 uses

.preheader.us.us.preheader:                       ; preds = %.preheader46.us.a
  %9 = add nuw i64 %.01447.us, 1                  ; 2 uses
  %exitcond.not = icmp eq i64 %9, %16
  br i1 %exitcond.not, label %bb.d, label %.preheader46.us.a, !llvm.loop !685

._crit_edge49.us:                                 ; preds = %bb.c, %bb.d
  %.01548.us = phi i64 [ %i.q, %bb.d ], [ 0, %bb.c ] ; 2 uses
  %10 = getelementptr inbounds nuw [8 x i8], ptr %.pre, i64 %.01548.us
  br label %.preheader46.us.a

.preheader.us.us:                                 ; preds = %bb.b
  %11 = load ptr, ptr %i.h, align 8, !tbaa !330   ; 2 uses
  %12 = load ptr, ptr %3, align 8, !tbaa !334     ; 6 uses
  %.not55 = icmp eq ptr %11, %12
  br i1 %.not55, label %._crit_edge.us.us, label %bb.c
...
bb.d:                                             ; preds = %.preheader.us.us.preheader
  %i.q = add nuw i64 %.01548.us, 1                ; 2 uses
  %exitcond.not.a = icmp eq i64 %i.q, %umax60
  br i1 %exitcond.not.a, label %._crit_edge49.us.thread, label %._crit_edge49.us, !llvm.loop !686

._crit_edge.us.us:                                ; preds = %.preheader.us.us
  %exitcond61.not = icmp eq ptr %12, null
  br i1 %exitcond61.not, label %_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit21.us, label %._crit_edge49.us.thread
...
._crit_edge:                                      ; preds = %_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit21, %_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit21.us, %bb.a
...
_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit: ; preds = %._crit_edge, %bb.e
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #34
  ret void

.lr.ph.split:                                     ; preds = %.lr.ph, %_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit21
  %.sroa.041.051 = phi ptr [ %i.u, %_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit21 ], [ %i.b, %.lr.ph ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #34
  %i.s = invoke noundef ptr @_ZNK6duckdb10shared_ptrINS_8PipelineELb1EEptEv(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.041.051)
          to label %bb.f unwind label %.split

bb.f:                                             ; preds = %.lr.ph.split
  invoke void @_ZN6duckdb8Pipeline12GetOperatorsEv(ptr dead_on_unwind nonnull writable sret(%"class.duckdb::vector.21") align 8 %3, ptr noundef nonnull align 8 dereferenceable(224) %i.s)
          to label %.preheader46 unwind label %.split

.preheader46:                                     ; preds = %bb.f
  %i.t = load ptr, ptr %3, align 8, !tbaa !334    ; 2 uses
  %.not.i.i.i20 = icmp eq ptr %i.t, null
...
_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit21: ; preds = %.preheader46, %bb.g
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #34
  %i.u = getelementptr inbounds nuw i8, ptr %.sroa.041.051, i64 16 ; 2 uses
...
_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit34.thread: ; preds = %.preheader46.us.a
...
_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit34: ; preds = %.split, %.split.us
  %.pn.pn = phi { ptr, i32 } [ %i.v, %.split ], [ %i.r, %.split.us ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #34
...
bb.h:                                             ; preds = %_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit34.thread, %_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit34
  %.pn.pn72 = phi { ptr, i32 } [ %i.w, %_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit34.thread ], [ %.pn.pn, %_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit34 ]
  tail call void @_ZdlPv(ptr noundef nonnull %.pre) #36
...
_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit36: ; preds = %_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit34, %bb.h
  %.pn.pn73 = phi { ptr, i32 } [ %.pn.pn, %_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EED2Ev.exit34 ], [ %.pn.pn72, %bb.h ]
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #34
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep129 = getelementptr i8, ptr %i.s, i64 %i.ar ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !687)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !690)
  %i.as = getelementptr i8, ptr %next.gep129, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep129, align 8, !alias.scope !690, !noalias !687
  %wide.load130 = load <2 x i64>, ptr %i.as, align 8, !alias.scope !690, !noalias !687
  %i.at = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 8, !alias.scope !687, !noalias !690
  store <2 x i64> %wide.load130, ptr %i.at, align 8, !alias.scope !687, !noalias !690
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.au = icmp eq i64 %index.next, %n.vec
  br i1 %i.au, label %middle.block, label %vector.body, !llvm.loop !692
...
.lr.ph.i.i.i.i.i.i.i14.preheader152:              ; preds = %.lr.ph.i.i.i.i.i.i.i14.preheader, %middle.block
  %.012.i.i.i.i.i.i.i15.ph = phi ptr [ %i.af, %.lr.ph.i.i.i.i.i.i.i14.preheader ], [ %i.ap, %middle.block ]
  %.0911.i.i.i.i.i.i.i16.ph = phi ptr [ %i.s, %.lr.ph.i.i.i.i.i.i.i14.preheader ], [ %i.aq, %middle.block ]
  br label %.lr.ph.i.i.i.i.i.i.i14

.lr.ph.i.i.i.i.i.i.i14:                           ; preds = %.lr.ph.i.i.i.i.i.i.i14.preheader152, %.lr.ph.i.i.i.i.i.i.i14
  %.012.i.i.i.i.i.i.i15 = phi ptr [ %i.ax, %.lr.ph.i.i.i.i.i.i.i14 ], [ %.012.i.i.i.i.i.i.i15.ph, %.lr.ph.i.i.i.i.i.i.i14.preheader152 ] ; 2 uses
  %.0911.i.i.i.i.i.i.i16 = phi ptr [ %i.aw, %.lr.ph.i.i.i.i.i.i.i14 ], [ %.0911.i.i.i.i.i.i.i16.ph, %.lr.ph.i.i.i.i.i.i.i14.preheader152 ] ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !687)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !690)
  %i.av = load i64, ptr %.0911.i.i.i.i.i.i.i16, align 8, !alias.scope !690, !noalias !687
  store i64 %i.av, ptr %.012.i.i.i.i.i.i.i15, align 8, !alias.scope !687, !noalias !690
  %i.aw = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i.i.i16, i64 8 ; 2 uses
  %i.ax = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i.i.i15, i64 8 ; 2 uses
  %.not.i.i.i.i.i.i.i17 = icmp eq ptr %i.aw, %i.q
...
_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EE17_M_realloc_insertIJS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i.i21: ; preds = %.lr.ph.i.i.i.i.i.i.i14, %middle.block, %.noexc23
  %.0.lcssa.i.i.i.i.i.i.i19 = phi ptr [ %i.af, %.noexc23 ], [ %i.ap, %middle.block ], [ %i.ax, %.lr.ph.i.i.i.i.i.i.i14 ]
...
_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EE9push_backEOS3_.exit24: ; preds = %_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EE17_M_realloc_insertIJS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i.i21, %bb.a
  %i.az = phi ptr [ %i.af, %_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EE17_M_realloc_insertIJS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i.i21 ], [ %i.s, %bb.a ] ; 2 uses
  %i.ba = phi ptr [ %i.ay, %_ZNSt6vectorISt17reference_wrapperIN6duckdb16PhysicalOperatorEESaIS3_EE17_M_realloc_insertIJS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i.i21 ], [ %i.r, %bb.a ] ; 2 uses
  ...
  %i.bb = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i.i.i.i19.pn, i64 8 ; 2 uses
  %i.bc = getelementptr inbounds nuw i8, ptr %.sroa.047.067, i64 8 ; 2 uses
  %.not = icmp eq ptr %i.bc, %i.k
...
bb.e:                                             ; preds = %bb.d
  %i.bd = load ptr, ptr %i.o, align 8, !tbaa !485 ; 2 uses
