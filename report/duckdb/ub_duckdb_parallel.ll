...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.di = getelementptr i8, ptr %i.cy, i64 %i.dh
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <2 x i64> %wide.load224, ptr %i.dm, align 8, !tbaa !1003, !alias.scope !1008, !noalias !1005
  %i.dn = getelementptr i8, ptr %next.gep223, i64 16
  store <2 x ptr> splat (ptr null), ptr %next.gep223, align 8, !tbaa !1003, !alias.scope !1005, !noalias !998
  store <2 x ptr> splat (ptr null), ptr %i.dn, align 8, !tbaa !1003, !alias.scope !1005, !noalias !998
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.do = icmp eq i64 %index.next, %n.vec
  br i1 %i.do, label %middle.block, label %vector.body, !llvm.loop !1010
...
.lr.ph.i.i.i.i.i.preheader311:                    ; preds = %vector.memcheck, %.lr.ph.i.i.i.i.i.preheader, %middle.block
  %.012.i.i.i.i.i.ph = phi ptr [ %i.cy, %vector.memcheck ], [ %i.cy, %.lr.ph.i.i.i.i.i.preheader ], [ %i.di, %middle.block ]
  %.0911.i.i.i.i.i.ph = phi ptr [ %i.cp, %vector.memcheck ], [ %i.cp, %.lr.ph.i.i.i.i.i.preheader ], [ %i.dj, %middle.block ]
  br label %.lr.ph.i.i.i.i.i

.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i.preheader311, %.lr.ph.i.i.i.i.i
  %.012.i.i.i.i.i = phi ptr [ %i.dr, %.lr.ph.i.i.i.i.i ], [ %.012.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader311 ] ; 2 uses
  %.0911.i.i.i.i.i = phi ptr [ %i.dq, %.lr.ph.i.i.i.i.i ], [ %.0911.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader311 ] ; 3 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !998)
  call void @llvm.experimental.noalias.scope.decl(metadata !1001)
  %i.dp = load i64, ptr %.0911.i.i.i.i.i, align 8, !tbaa !1003, !alias.scope !1001, !noalias !998
  store i64 %i.dp, ptr %.012.i.i.i.i.i, align 8, !tbaa !1003, !alias.scope !998, !noalias !1001
  store ptr null, ptr %.0911.i.i.i.i.i, align 8, !tbaa !1003, !alias.scope !1001, !noalias !998
  %i.dq = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i, i64 8 ; 2 uses
  %i.dr = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i, i64 8
  %.not.i.i.i.i.i44 = icmp eq ptr %i.dq, %i.cv
...
.lr.ph.i.i.i.i.i47.preheader:                     ; preds = %.noexc53
  ...
  %min.iters.check233 = icmp ult i64 %i.el, 152
...
vector.ph234:                                     ; preds = %vector.memcheck226
  %n.vec236 = and i64 %i.en, 4611686018427387900  ; 3 uses
  %i.es = shl i64 %n.vec236, 3                    ; 2 uses
...
vector.body237:                                   ; preds = %vector.body237, %vector.ph234
  ...
  %i.ev = shl i64 %index238, 3                    ; 2 uses
  %next.gep239 = getelementptr i8, ptr %i.ej, i64 %i.ev ; 2 uses
  %next.gep240 = getelementptr i8, ptr %i.ea, i64 %i.ev ; 4 uses
  ...
  %wide.load242 = load <2 x i64>, ptr %i.ew, align 8, !tbaa !1020, !alias.scope !1022, !noalias !1015
  %i.ex = getelementptr i8, ptr %next.gep239, i64 16
  store <2 x i64> %wide.load241, ptr %next.gep239, align 8, !tbaa !1020, !alias.scope !1025, !noalias !1022
  store <2 x i64> %wide.load242, ptr %i.ex, align 8, !tbaa !1020, !alias.scope !1025, !noalias !1022
  %i.ey = getelementptr i8, ptr %next.gep240, i64 16
...
._crit_edge.thread:                               ; preds = %_ZNSt6vectorIN6duckdb10unique_ptrINS0_13OperatorStateESt14default_deleteIS2_ELb1EEESaIS5_EE7reserveEm.exit, %._crit_edge
  %.lcssa119197 = phi ptr [ %i.ki, %._crit_edge ], [ %i.fh, %_ZNSt6vectorIN6duckdb10unique_ptrINS0_13OperatorStateESt14default_deleteIS2_ELb1EEESaIS5_EE7reserveEm.exit ]
...
bb.ac:                                            ; preds = %._crit_edge
  %i.fn = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZN6duckdb6vectorISt17reference_wrapperINS_16PhysicalOperatorEELb1ESaIS3_EE4backEv(ptr noundef nonnull align 8 dereferenceable(24) %i.kj)
          to label %.noexc54 unwind label %bb.q
...
bb.ae:                                            ; preds = %.lr.ph, %_ZNSt10unique_ptrIN6duckdb9DataChunkESt14default_deleteIS1_EED2Ev.exit
  %i.ft = phi ptr [ %i.fi, %.lr.ph ], [ %i.kj, %_ZNSt10unique_ptrIN6duckdb9DataChunkESt14default_deleteIS1_EED2Ev.exit ]
  %i.fu = phi ptr [ %i.fh, %.lr.ph ], [ %i.ki, %_ZNSt10unique_ptrIN6duckdb9DataChunkESt14default_deleteIS1_EED2Ev.exit ]
  %.028135 = phi i64 [ 0, %.lr.ph ], [ %i.kh, %_ZNSt10unique_ptrIN6duckdb9DataChunkESt14default_deleteIS1_EED2Ev.exit ] ; 4 uses
