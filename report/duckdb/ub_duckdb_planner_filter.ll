...
.noexc9:                                          ; preds = %.noexc8
  %i.af = load ptr, ptr %1, align 8, !tbaa !18, !noalias !156
...
begin_hunk_1_@_ZN6duckdb25SelectivityOptionalFilter11DeserializeERNS_12DeserializerE:bb.a
  ...
  %i.k = invoke noundef zeroext i1 %i.j(ptr noundef nonnull align 8 dereferenceable(632) %1, i16 noundef zeroext 200, ptr noundef nonnull @.str.24)
          to label %.noexc unwind label %bb.m, !inline_history !658 ; 2 uses
...
bb.e:                                             ; preds = %.noexc
  %i.m = load ptr, ptr %1, align 8, !tbaa !18, !noalias !659
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 88
  %i.o = load ptr, ptr %i.n, align 8, !noalias !659
  %i.p = invoke noundef zeroext i1 %i.o(ptr noundef nonnull align 8 dereferenceable(632) %1)
          to label %.noexc8 unwind label %bb.m, !inline_history !658
...
.noexc10:                                         ; preds = %.noexc9
  %i.t = load ptr, ptr %2, align 8, !tbaa !165, !noalias !659 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #26, !noalias !659
  %i.u = load ptr, ptr %1, align 8, !tbaa !18, !noalias !659
  %i.v = getelementptr inbounds nuw i8, ptr %i.u, i64 64
  %i.w = load ptr, ptr %i.v, align 8, !noalias !659
  invoke void %i.w(ptr noundef nonnull align 8 dereferenceable(632) %1)
          to label %bb.f unwind label %bb.g, !noalias !659

bb.f:                                             ; preds = %.noexc10, %.noexc8
  %.sroa.0.0.i = phi ptr [ %i.t, %.noexc10 ], [ null, %.noexc8 ] ; 2 uses
  %i.x = load ptr, ptr %1, align 8, !tbaa !18, !noalias !659
  %i.y = getelementptr inbounds nuw i8, ptr %i.x, i64 96
  %i.z = load ptr, ptr %i.y, align 8, !noalias !659
  invoke void %i.z(ptr noundef nonnull align 8 dereferenceable(632) %1)
          to label %_ZN6duckdb12Deserializer4ReadINS_10unique_ptrINS_11TableFilterESt14default_deleteIS3_ELb1EEES3_EENSt9enable_ifIXaasr13is_unique_ptrIT_EE5valuesr15has_deserializeIT0_EE5valueES8_E4typeEv.exit.i unwind label %bb.g, !noalias !659
...
_ZNKSt14default_deleteIN6duckdb11TableFilterEEclEPS1_.exit.i7.i.i: ; preds = %bb.g
  %i.aa = load ptr, ptr %.ph.i.i, align 8, !tbaa !18, !noalias !659
  %i.ab = getelementptr inbounds nuw i8, ptr %i.aa, i64 8
  %i.ac = load ptr, ptr %i.ab, align 8, !noalias !659
  call void %i.ac(ptr noundef nonnull align 8 dead_on_return(9) dereferenceable(9) %.ph.i.i) #26, !noalias !659, !inline_history !662
  br label %.body
...
begin_hunk_4_@_ZN6duckdb25SelectivityOptionalFilter11DeserializeERNS_12DeserializerE:bb.a
  ...
  invoke void %i.ak(ptr noundef nonnull align 8 dereferenceable(632) %1, i1 noundef zeroext %i.ah)
          to label %_ZN6duckdb12Deserializer23ReadPropertyWithDefaultINS_10unique_ptrINS_11TableFilterESt14default_deleteIS3_ELb1EEEEEvtPKcRT_.exit unwind label %bb.m, !inline_history !658
...
begin_hunk_5_@_ZN6duckdb25SelectivityOptionalFilter11DeserializeERNS_12DeserializerE:bb.a
  ...
  %i.aq = invoke noundef zeroext i1 %i.ap(ptr noundef nonnull align 8 dereferenceable(632) %1, i16 noundef zeroext 201, ptr noundef nonnull @.str.22)
          to label %.noexc12 unwind label %bb.m, !inline_history !663 ; 2 uses
...
begin_hunk_6_@_ZN6duckdb25SelectivityOptionalFilter11DeserializeERNS_12DeserializerE:bb.a
  ...
  invoke void %i.ax(ptr noundef nonnull align 8 dereferenceable(632) %1, i1 noundef zeroext %i.aq)
          to label %_ZN6duckdb12Deserializer23ReadPropertyWithDefaultIfEEvtPKcRT_.exit unwind label %bb.m, !inline_history !663
...
begin_hunk_7_@_ZN6duckdb25SelectivityOptionalFilter11DeserializeERNS_12DeserializerE:bb.a
  ...
  %i.bd = invoke noundef zeroext i1 %i.bc(ptr noundef nonnull align 8 dereferenceable(632) %1, i16 noundef zeroext 202, ptr noundef nonnull @.str.23)
          to label %.noexc16 unwind label %bb.m, !inline_history !664 ; 2 uses
...
begin_hunk_8_@_ZN6duckdb25SelectivityOptionalFilter11DeserializeERNS_12DeserializerE:bb.a
  ...
  invoke void %i.bk(ptr noundef nonnull align 8 dereferenceable(632) %1, i1 noundef zeroext %i.bd)
          to label %_ZNSt10unique_ptrIN6duckdb25SelectivityOptionalFilterESt14default_deleteIS1_EED2Ev.exit unwind label %bb.m, !inline_history !664
...
!155 = distinct !{null}
!156 = !{!157, !153}
!157 = distinct !{!157, !158, !"_ZN6duckdb12Deserializer4ReadINS_11LogicalTypeEEENSt9enable_ifIXsr15has_deserializeIT_EE5valueES4_E4typeEv: argument 0"}
!158 = distinct !{!158, !"_ZN6duckdb12Deserializer4ReadINS_11LogicalTypeEEENSt9enable_ifIXsr15has_deserializeIT_EE5valueES4_E4typeEv"}
!159 = !{!160}
...
!658 = distinct !{null}
!659 = !{!660}
!660 = distinct !{!660, !661, !"_ZN6duckdb12Deserializer4ReadINS_10unique_ptrINS_11TableFilterESt14default_deleteIS3_ELb1EEES3_EENSt9enable_ifIXaasr13is_unique_ptrIT_EE5valuesr15has_deserializeIT0_EE5valueES8_E4typeEv: argument 0"}
!661 = distinct !{!661, !"_ZN6duckdb12Deserializer4ReadINS_10unique_ptrINS_11TableFilterESt14default_deleteIS3_ELb1EEES3_EENSt9enable_ifIXaasr13is_unique_ptrIT_EE5valuesr15has_deserializeIT0_EE5valueES8_E4typeEv"}
