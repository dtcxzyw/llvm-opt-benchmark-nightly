...
vector.ph191:                                     ; preds = %vector.memcheck
  ...
  %7 = sub nsw i64 %i.ea, %n.vec193
  %8 = add nuw nsw i64 %.053.lcssa119126, %n.vec193
  %9 = load <2 x i64>, ptr %4, align 16
  %broadcast.splat200 = shufflevector <2 x i64> %9, <2 x i64> poison, <2 x i32> zeroinitializer ; 2 uses
...
.lr.ph77.split.us.preheader208:                   ; preds = %vector.memcheck, %.lr.ph77.split.us.preheader, %middle.block202
  %indvars.iv99.ph = phi i64 [ %i.ea, %vector.memcheck ], [ %i.ea, %.lr.ph77.split.us.preheader ], [ %7, %middle.block202 ]
  %.274.us.ph = phi i64 [ %.053.lcssa119126, %vector.memcheck ], [ %.053.lcssa119126, %.lr.ph77.split.us.preheader ], [ %8, %middle.block202 ]
