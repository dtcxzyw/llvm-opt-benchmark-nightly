...
begin_hunk_0_@_ZN6duckdb12_GLOBAL__N_122ListAggregatesBindData19DeserializeFunctionERNS_12DeserializerERNS_14ScalarFunctionE:.noexc
  ...
  %i.d = tail call noundef zeroext i1 %i.c(ptr noundef nonnull align 8 dereferenceable(632) %1, i16 noundef zeroext 100, ptr noundef nonnull @.str.40), !inline_history !617
...
bb.a:                                             ; preds = %.noexc
  ...
  tail call void %i.g(ptr noundef nonnull align 8 dereferenceable(632) %1, i1 noundef zeroext false), !inline_history !617
...
.noexc6:                                          ; preds = %.noexc
  ...
  %i.i = load ptr, ptr %i.h, align 8, !noalias !618
  %i.j = tail call noundef zeroext i1 %i.i(ptr noundef nonnull align 8 dereferenceable(632) %1), !inline_history !617
  br i1 %i.j, label %.noexc.i.i, label %bb.h

.noexc.i.i:                                       ; preds = %.noexc6
  %i.k = load ptr, ptr %1, align 8, !tbaa !108, !noalias !618
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 56
  %i.m = load ptr, ptr %i.l, align 8, !noalias !618
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(632) %1), !inline_history !617
  ...
  tail call void %i.p(ptr noundef nonnull align 8 dereferenceable(632) %1, i16 noundef zeroext 1, ptr noundef nonnull @.str.41), !inline_history !617
  ...
  tail call void %i.s(ptr noundef nonnull align 8 dereferenceable(632) %1), !inline_history !617
...
begin_hunk_1_@_ZN6duckdb12_GLOBAL__N_122ListAggregatesBindData19DeserializeFunctionERNS_12DeserializerERNS_14ScalarFunctionE:.noexc
  ...
  invoke void %i.ad(ptr noundef nonnull align 8 dereferenceable(632) %1, i16 noundef zeroext 2, ptr noundef nonnull @.str.42)
          to label %.noexc.i.i.i unwind label %bb.g, !noalias !621, !inline_history !633

.noexc.i.i.i:                                     ; preds = %_ZN6duckdb12Deserializer12ReadPropertyINS_11LogicalTypeEEET_tPKc.exit.i.i.i
  %i.ae = load ptr, ptr %1, align 8, !tbaa !108, !noalias !634
  %i.af = getelementptr inbounds nuw i8, ptr %i.ae, i64 88
  %i.ag = load ptr, ptr %i.af, align 8, !noalias !634
  %i.ah = invoke noundef zeroext i1 %i.ag(ptr noundef nonnull align 8 dereferenceable(632) %1)
          to label %.noexc8.i.i.i unwind label %bb.g, !noalias !621, !inline_history !633
...
.noexc10.i.i.i:                                   ; preds = %.noexc9.i.i.i
  %i.al = load ptr, ptr %3, align 8, !tbaa !148, !noalias !634 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #25, !noalias !634
  %i.am = load ptr, ptr %1, align 8, !tbaa !108, !noalias !634
  %i.an = getelementptr inbounds nuw i8, ptr %i.am, i64 64
  %i.ao = load ptr, ptr %i.an, align 8, !noalias !634
  invoke void %i.ao(ptr noundef nonnull align 8 dereferenceable(632) %1)
          to label %bb.d unwind label %bb.e, !noalias !634

bb.d:                                             ; preds = %.noexc10.i.i.i, %.noexc8.i.i.i
  %.sroa.0.0.i.i.i = phi ptr [ %i.al, %.noexc10.i.i.i ], [ null, %.noexc8.i.i.i ] ; 10 uses
  %i.ap = load ptr, ptr %1, align 8, !tbaa !108, !noalias !634
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 96
  %i.ar = load ptr, ptr %i.aq, align 8, !noalias !634
  invoke void %i.ar(ptr noundef nonnull align 8 dereferenceable(632) %1)
          to label %_ZN6duckdb12Deserializer4ReadINS_10unique_ptrINS_10ExpressionESt14default_deleteIS3_ELb1EEES3_EENSt9enable_ifIXaasr13is_unique_ptrIT_EE5valuesr15has_deserializeIT0_EE5valueES8_E4typeEv.exit.i.i.i.i unwind label %bb.e, !noalias !634
...
begin_hunk_2_@_ZN6duckdb12_GLOBAL__N_122ListAggregatesBindData19DeserializeFunctionERNS_12DeserializerERNS_14ScalarFunctionE:.noexc
  ...
  %i.bm = load ptr, ptr %1, align 8, !tbaa !108, !noalias !618
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bm, i64 64
  %i.bo = load ptr, ptr %i.bn, align 8, !noalias !618
  invoke void %i.bo(ptr noundef nonnull align 8 dereferenceable(632) %1)
          to label %bb.h unwind label %.body.i.thread6.i, !noalias !618
...
bb.h:                                             ; preds = %_ZNSt10unique_ptrIN6duckdb12_GLOBAL__N_122ListAggregatesBindDataESt14default_deleteIS2_EED2Ev.exit.i.i, %.noexc6
  ...
  %i.bp = load ptr, ptr %1, align 8, !tbaa !108, !noalias !618
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bp, i64 96
  %i.br = load ptr, ptr %i.bq, align 8, !noalias !618
  invoke void %i.br(ptr noundef nonnull align 8 dereferenceable(632) %1)
          to label %_ZN6duckdb12Deserializer4ReadINS_10unique_ptrINS_12_GLOBAL__N_122ListAggregatesBindDataESt14default_deleteIS4_ELb1EEES4_EENSt9enable_ifIXaasr13is_unique_ptrIT_EE5valuesr15has_deserializeIT0_EE5valueES9_E4typeEv.exit.i unwind label %.body.i.i, !noalias !618
...
_ZNKSt14default_deleteIN6duckdb12_GLOBAL__N_122ListAggregatesBindDataEEclEPS2_.exit.i9.i.i: ; preds = %.body.i.i, %.body.i.thread6.i
  ...
  %i.bs = load ptr, ptr %.ph10.i, align 8, !tbaa !108, !noalias !618
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bs, i64 8
  %i.bu = load ptr, ptr %i.bt, align 8, !noalias !618
  call void %i.bu(ptr noundef nonnull align 8 dereferenceable(40) %.ph10.i) #25, !noalias !618, !inline_history !643
...
!617 = distinct !{null}
!618 = !{!619, !615}
!619 = distinct !{!619, !620, !"_ZN6duckdb12Deserializer4ReadINS_10unique_ptrINS_12_GLOBAL__N_122ListAggregatesBindDataESt14default_deleteIS4_ELb1EEES4_EENSt9enable_ifIXaasr13is_unique_ptrIT_EE5valuesr15has_deserializeIT0_EE5valueES9_E4typeEv: argument 0"}
!620 = distinct !{!620, !"_ZN6duckdb12Deserializer4ReadINS_10unique_ptrINS_12_GLOBAL__N_122ListAggregatesBindDataESt14default_deleteIS4_ELb1EEES4_EENSt9enable_ifIXaasr13is_unique_ptrIT_EE5valuesr15has_deserializeIT0_EE5valueES9_E4typeEv"}
!621 = !{!622, !619, !615}
...
!633 = distinct !{null}
!634 = !{!635, !631, !622, !619, !615}
!635 = distinct !{!635, !636, !"_ZN6duckdb12Deserializer4ReadINS_10unique_ptrINS_10ExpressionESt14default_deleteIS3_ELb1EEES3_EENSt9enable_ifIXaasr13is_unique_ptrIT_EE5valuesr15has_deserializeIT0_EE5valueES8_E4typeEv: argument 0"}
!636 = distinct !{!636, !"_ZN6duckdb12Deserializer4ReadINS_10unique_ptrINS_10ExpressionESt14default_deleteIS3_ELb1EEES3_EENSt9enable_ifIXaasr13is_unique_ptrIT_EE5valuesr15has_deserializeIT0_EE5valueES8_E4typeEv"}
