...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <4 x i64>, ptr %i.ct, align 8, !tbaa !83
  %strided.vec = shufflevector <4 x i64> %wide.vec, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
  %wide.vec348 = load <4 x i64>, ptr %i.cu, align 8, !tbaa !83
  %strided.vec349 = shufflevector <4 x i64> %wide.vec348, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
