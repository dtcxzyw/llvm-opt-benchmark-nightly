...
begin_hunk_0_@duckdb_je_large_ralloc_no_move:bb.a
  %i.dh = add i64 %i.dg, -1
  %i.di = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 range(i64 8193, -2305843009213693952) %i.dh, i1 true) ; 3 uses
  %i.dj = trunc nuw nsw i64 %i.di to i32
  %5 = shl nuw nsw i32 %i.dj, 2
  %6 = xor i32 %5, 252
  %i.dk = sub nuw nsw i64 60, %i.di
  %i.dl = ashr exact i64 -1152921504606846976, %i.di
