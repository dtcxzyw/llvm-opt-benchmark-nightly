...
bb.c:                                             ; preds = %bb.b
  invoke void @_ZN6duckdb11LogicalTypeC1ENS_13LogicalTypeIdE(ptr noundef nonnull align 8 dereferenceable(24) %i.a, i8 noundef zeroext 14)
...
.noexc112:                                        ; preds = %bb.d
  ...
  store ptr %i.v, ptr %i.b, align 8, !tbaa !11
...
_ZSt10_ConstructIN6duckdb11LogicalTypeEJRKS1_EEvPT_DpOT0_.exit.i.i.i.i.i: ; preds = %.noexc112
  ...
  invoke void @_ZN6duckdb11LogicalTypeC1ERKS0_(ptr noundef nonnull align 8 dereferenceable(24) %i.z, ptr noundef nonnull align 8 dereferenceable(24) %i.a)
...
_ZN6duckdb14ScalarFunctionD2Ev.exit:              ; preds = %_ZN6duckdb10shared_ptrINS_18ScalarFunctionInfoELb1EED2Ev.exit.i, %bb.u
  ...
  %i.bq = load ptr, ptr %i.d, align 8, !tbaa !17  ; 2 uses
...
_ZNSt14_Function_baseD2Ev.exit:                   ; preds = %_ZN6duckdb14ScalarFunctionD2Ev.exit, %bb.w
  ...
  %i.bv = load ptr, ptr %i.c, align 8, !tbaa !12  ; 2 uses
...
bb.ae:                                            ; preds = %bb.ad, %bb.aa
  ...
  %i.cd = load ptr, ptr %i.d, align 8, !tbaa !17  ; 2 uses
