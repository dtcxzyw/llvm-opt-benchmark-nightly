begin_hunk_0
  ...
  %12 = alloca %"class.duckdb::vector.97", align 8 ; 16 uses
...
begin_hunk_1
  ...
  %i.bc = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.bb) #27
          to label %.noexc81.i.i.i unwind label %bb.h ; 4 uses
...
.noexc81.i.i.i:                                   ; preds = %_ZNSt6vectorIN6duckdb6vectorImLb1ESaImEEESaIS3_EE17_S_check_init_lenEmRKS4_.exit.i.i.i.i.i
  ...
  %17 = getelementptr inbounds nuw i8, ptr %12, i64 8 ; 5 uses
  store ptr %i.bc, ptr %17, align 8, !tbaa !1708
  %i.bd = getelementptr inbounds nuw [24 x i8], ptr %i.bc, i64 %i.ba
  %i.be = getelementptr inbounds nuw i8, ptr %12, i64 16
  store ptr %i.bd, ptr %i.be, align 8, !tbaa !1709
...
bb.e:                                             ; preds = %.noexc81.i.i.i
  store ptr %i.bf, ptr %17, align 8, !tbaa !1708
...
begin_hunk_3
  ...
  %i.fc = load ptr, ptr %17, align 8, !tbaa !1708
...
_ZNSt3mapIcmSt4lessIcESaISt4pairIKcmEEED2Ev.exit.i.i.i: ; preds = %bb.ci
  ...
  %i.kj = load ptr, ptr %17, align 8, !tbaa !1708 ; 2 uses
...
_ZNSt3mapIcmSt4lessIcESaISt4pairIKcmEEED2Ev.exit.i.i: ; preds = %.body86.i.i.i
  ...
  %i.ks = load ptr, ptr %17, align 8, !tbaa !1708 ; 2 uses
...
begin_hunk_6
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !1708
...
!1708 = !{!1706, !1707, i64 8}
!1709 = !{!1706, !1707, i64 16}
