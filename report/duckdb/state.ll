...
begin_hunk_0_@_ZN13duckdb_brotli25BrotliDecoderStateCleanupEPNS_24BrotliDecoderStateStructE:bb.a
  ...
  tail call void %i.b(ptr noundef %i.d, ptr noundef %i.f), !inline_history !43
  ...
  tail call void %i.g(ptr noundef %i.h, ptr noundef %i.j), !inline_history !43
  ...
  tail call void %i.k(ptr noundef %i.l, ptr noundef %i.n), !inline_history !43
  ...
  tail call void %i.o(ptr noundef %i.p, ptr noundef %i.r), !inline_history !43
  ...
  tail call void %i.s(ptr noundef %i.t, ptr noundef %i.v), !inline_history !43
  ...
  tail call void %i.w(ptr noundef %i.x, ptr noundef %i.z), !inline_history !43
...
begin_hunk_1_@_ZN13duckdb_brotli25BrotliDecoderStateCleanupEPNS_24BrotliDecoderStateStructE:bb.a
  ...
  store ptr null, ptr %i.am, align 8, !tbaa !44
  ret void
}
...
begin_hunk_2_@_ZN13duckdb_brotli33BrotliDecoderHuffmanTreeGroupInitEPNS_24BrotliDecoderStateStructEPNS_16HuffmanTreeGroupEmmm:bb.a
  ...
  store i16 %i.g, ptr %i.h, align 8, !tbaa !45
  %i.i = trunc i64 %3 to i16
  %i.j = getelementptr inbounds nuw i8, ptr %1, i64 18
  store i16 %i.i, ptr %i.j, align 2, !tbaa !46
  %i.k = trunc i64 %4 to i16
  %i.l = getelementptr inbounds nuw i8, ptr %1, i64 20
  store i16 %i.k, ptr %i.l, align 4, !tbaa !47
  store ptr %i.f, ptr %1, align 8, !tbaa !48
...
!41 = !{!8, !15, i64 208}
!42 = !{!8, !15, i64 232}
!43 = !{ptr @_ZN13duckdb_brotli39BrotliDecoderStateCleanupAfterMetablockEPNS_24BrotliDecoderStateStructE}
!44 = !{!8, !13, i64 256}
!45 = !{!14, !16, i64 16}
!46 = !{!14, !16, i64 18}
!47 = !{!14, !16, i64 20}
