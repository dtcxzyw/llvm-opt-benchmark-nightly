...
begin_hunk_1_@_ZN6duckdb17QueryGraphManager13GenerateJoinsERNS_6vectorINS_10unique_ptrINS_15LogicalOperatorESt14default_deleteIS3_ELb1EEELb1ESaIS6_EEERNS_15JoinRelationSetE:bb.a
  ...
  %i.la = load ptr, ptr %i.kw, align 8, !tbaa !377 ; 3 uses
...
_ZNKSt14default_deleteIN6duckdb15LogicalOperatorEEclEPS1_.exit.i.i.i.i.i5.i: ; preds = %bb.cf
  %i.lb = load ptr, ptr %i.la, align 8, !tbaa !352
  %i.lc = getelementptr inbounds nuw i8, ptr %i.lb, i64 8
  %i.ld = load ptr, ptr %i.lc, align 8
  call void %i.ld(ptr noundef nonnull align 8 dead_on_return(97) dereferenceable(97) %i.la) #29, !inline_history !1287
...
_ZSt4swapIN6duckdb10unique_ptrINS0_15LogicalOperatorESt14default_deleteIS2_ELb1EEEENSt9enable_ifIXsr6__and_ISt6__not_ISt15__is_tuple_likeIT_EESt21is_move_constructibleIS9_ESt18is_move_assignableIS9_EEE5valueEvE4typeERS9_SI_.exit: ; preds = %bb.bz, %_ZNKSt14default_deleteIN6duckdb15LogicalOperatorEEclEPS1_.exit.i.i.i.i.i5.i, %bb.cf, %.loopexit531
  %.0106.shrunk = phi i1 [ false, %_ZNKSt14default_deleteIN6duckdb15LogicalOperatorEEclEPS1_.exit.i.i.i.i.i5.i ], [ true, %.loopexit531 ], [ false, %bb.cf ], [ false, %bb.bz ] ; 6 uses
