...
bb.a:
  ...
  %.not5463 = icmp eq ptr %i.c, %i.e
  br i1 %.not5463, label %.loopexit, label %.lr.ph66

.lr.ph66:                                         ; preds = %bb.a, %._crit_edge
  %.sroa.045.064 = phi ptr [ %i.v, %._crit_edge ], [ %i.c, %bb.a ] ; 2 uses
  %i.f = load ptr, ptr %.sroa.045.064, align 8, !tbaa !671 ; 3 uses
  ...
  %.not5561 = icmp eq ptr %i.h, %i.j
  br i1 %.not5561, label %._crit_edge, label %.lr.ph

bb.b:                                             ; preds = %_ZNK6duckdb12optional_ptrINS_10FilterInfoELb1EE10CheckValidEv.exit
  %i.k = getelementptr inbounds nuw i8, ptr %.sroa.041.062, i64 8 ; 2 uses
  %.not55 = icmp eq ptr %i.k, %i.j
  br i1 %.not55, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph66, %bb.b
  %.sroa.041.062 = phi ptr [ %i.k, %bb.b ], [ %i.h, %.lr.ph66 ] ; 2 uses
  %i.l = load ptr, ptr %.sroa.041.062, align 8, !tbaa !563 ; 2 uses
...
._crit_edge:                                      ; preds = %bb.b, %.lr.ph66
  %i.v = getelementptr inbounds nuw i8, ptr %.sroa.045.064, i64 8 ; 2 uses
...
.loopexit:                                        ; preds = %._crit_edge, %bb.a, %.thread50
  ...
  %.not5667 = icmp eq ptr %i.y, %i.aa
  br i1 %.not5667, label %._crit_edge71, label %.lr.ph70

.lr.ph70:                                         ; preds = %.loopexit, %.lr.ph70.backedge
  %.sroa.036.068 = phi ptr [ %.sroa.036.068.be, %.lr.ph70.backedge ], [ %i.y, %.loopexit ] ; 8 uses
  call void @_ZNK6duckdb12optional_ptrINS_10FilterInfoELb1EE10CheckValidEv(ptr noundef nonnull align 8 dereferenceable(8) %.sroa.036.068)
  %i.ab = load ptr, ptr %.sroa.036.068, align 8, !tbaa !563
...
bb.i:                                             ; preds = %.lr.ph70
  call void @_ZNK6duckdb12optional_ptrINS_10FilterInfoELb1EE10CheckValidEv(ptr noundef nonnull align 8 dereferenceable(8) %.sroa.036.068)
  %i.ae = load ptr, ptr %.sroa.036.068, align 8, !tbaa !563
...
bb.j:                                             ; preds = %bb.i
  ...
  %or.cond73 = select i1 %or.cond, i1 true, i1 %.not56
  br i1 %or.cond73, label %._crit_edge71, label %.lr.ph70.backedge

bb.k:                                             ; preds = %.lr.ph70, %bb.i
  %.old = getelementptr inbounds nuw i8, ptr %.sroa.036.068, i64 8 ; 2 uses
  %.not56.old = icmp eq ptr %.old, %i.aa
  br i1 %.not56.old, label %._crit_edge71, label %.lr.ph70.backedge

.lr.ph70.backedge:                                ; preds = %bb.k, %bb.j
  %.sroa.036.068.be = phi ptr [ %i.al, %bb.j ], [ %.old, %bb.k ]
  br label %.lr.ph70

._crit_edge71:                                    ; preds = %bb.k, %bb.j, %.loopexit
...
bb.l:                                             ; preds = %._crit_edge71
  %i.be = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %i.bd) #27, !noalias !674
  br label %common.resume

_ZN6duckdb9make_uniqINS_10DPJoinNodeEJRNS_15JoinRelationSetERNS_12optional_ptrINS_12NeighborInfoELb1EEES3_S3_RdEEENS_17TemplatedUniqueIfIT_Lb1EE25templated_unique_single_tEDpOT0_.exit: ; preds = %._crit_edge71
