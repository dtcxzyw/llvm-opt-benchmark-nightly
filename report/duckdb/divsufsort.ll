...
.backedge:                                        ; preds = %.backedge.outer, %bb.br
  %.0226 = phi ptr [ %i.si, %bb.br ], [ %.0226.ph, %.backedge.outer ] ; 37 uses
...
_ZN11duckdb_zstdL10ss_compareEPKhPKiS3_i.exit384.thread: ; preds = %.thread.i377, %bb.bk, %_ZN11duckdb_zstdL10ss_compareEPKhPKiS3_i.exit384, %bb.bl
  %.1223 = phi i32 [ %i.rl, %bb.bl ], [ %.0222545, %_ZN11duckdb_zstdL10ss_compareEPKhPKiS3_i.exit384 ], [ %.0222545, %bb.bk ], [ %.0222545, %.thread.i377 ] ; 8 uses
...
begin_hunk_3_@_ZN11duckdb_zstdL12ss_swapmergeEPKhPKiPiS4_S4_S4_ii:bb.a
  ...
  %wide.load121 = load <4 x i32>, ptr %i.rz, align 4, !tbaa !3, !alias.scope !206, !noalias !209
  %i.sa = getelementptr i8, ptr %next.gep120, i64 16 ; 2 uses
  %wide.load122 = load <4 x i32>, ptr %next.gep120, align 4, !tbaa !3, !alias.scope !209
  %wide.load123 = load <4 x i32>, ptr %i.sa, align 4, !tbaa !3, !alias.scope !209
  store <4 x i32> %wide.load122, ptr %next.gep, align 4, !tbaa !3, !alias.scope !206, !noalias !209
  store <4 x i32> %wide.load123, ptr %i.rz, align 4, !tbaa !3, !alias.scope !206, !noalias !209
  store <4 x i32> %wide.load, ptr %next.gep120, align 4, !tbaa !3, !alias.scope !209
  store <4 x i32> %wide.load121, ptr %i.sa, align 4, !tbaa !3, !alias.scope !209
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.sb = icmp eq i64 %index.next, %n.vec
  br i1 %i.sb, label %middle.block, label %vector.body, !llvm.loop !211
...
.lr.ph.i386.preheader:                            ; preds = %vector.memcheck, %bb.bm, %middle.block
  %.012.i.ph = phi ptr [ %i.rt, %vector.memcheck ], [ %i.rt, %bb.bm ], [ %i.rv, %middle.block ]
  %.0811.i.ph = phi i32 [ %.1223, %vector.memcheck ], [ %.1223, %bb.bm ], [ %i.rw, %middle.block ]
  %.0910.i.ph = phi ptr [ %.0226, %vector.memcheck ], [ %.0226, %bb.bm ], [ %i.ry, %middle.block ]
  br label %.lr.ph.i386
...
begin_hunk_4_@_ZN11duckdb_zstdL12ss_swapmergeEPKhPKiPiS4_S4_S4_ii:bb.a
  ...
  br i1 %i.sh, label %.lr.ph.i386, label %_ZN11duckdb_zstdL12ss_blockswapEPiS0_i.exit, !llvm.loop !212
...
begin_hunk_5_@_ZN11duckdb_zstdL12ss_swapmergeEPKhPKiPiS4_S4_S4_ii:bb.a
  ...
  br i1 %i.sq, label %.preheader, label %.loopexit.loopexit, !llvm.loop !213
...
begin_hunk_6_@_ZN11duckdb_zstdL12ss_swapmergeEPKhPKiPiS4_S4_S4_ii:bb.a
  ...
  br i1 %i.st, label %.preheader439, label %.loopexit.loopexit550, !llvm.loop !214
