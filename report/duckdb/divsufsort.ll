...
bb.gw:                                            ; preds = %bb.gt
  ...
  %.048.i.i.i.i.a = select i1 %i.ayx, ptr %i.tr, ptr %i.ayf
  %.0.i44.i.i.i = select i1 %i.ayx, ptr %i.ayf, ptr %i.tr ; 2 uses
  ...
  %.151.i.i.i.i = select i1 %i.aze, ptr %.0.i44.i.i.i, ptr %spec.select56.i.i.i.i ; 3 uses
  %.149.i.i.i.i = select i1 %i.aze, ptr %spec.select.i43.i.i.i, ptr %.048.i.i.i.i.a ; 2 uses
  %.1.i.i.i.i = select i1 %i.aze, ptr %spec.select56.i.i.i.i, ptr %.0.i44.i.i.i
  ...
  %.054.i.i.i.i.a = select i1 %i.azn, ptr %.151.i.i.i.i, ptr %.0455.ph.i.i
  %.252.i.i.i.i = select i1 %i.azn, ptr %.0455.ph.i.i, ptr %.151.i.i.i.i
  ...
  %.3.i.i.i.i = select i1 %i.azv, ptr %.1.i.i.i.i, ptr %.252.i.i.i.i ; 2 uses
  %.2.i.i.i.i = select i1 %i.azv, ptr %.054.i.i.i.i.a, ptr %.149.i.i.i.i ; 2 uses
...
_ZN11duckdb_zstdL10tr_median3EPKiPiS2_S2_.exit54.i.i.i: ; preds = %bb.gz, %_ZN11duckdb_zstdL10tr_median3EPKiPiS2_S2_.exit49.i.i.i
  ...
  %i.bcs = load i32, ptr %i.bcr, align 4, !tbaa !3 ; 2 uses
...
bb.ha:                                            ; preds = %_ZN11duckdb_zstdL10tr_median3EPKiPiS2_S2_.exit54.i.i.i
  %16 = select i1 %i.bcp, i32 %i.bcl, i32 %i.bch
  %spec.select22.i57.i.i.i = select i1 %i.bcp, ptr %i.bcg, ptr %i.bcf
  %i.bcy = sext i32 %16 to i64
...
_ZN11duckdb_zstdL10tr_median3EPKiPiS2_S2_.exit59.i.i.i: ; preds = %bb.ha, %_ZN11duckdb_zstdL10tr_median3EPKiPiS2_S2_.exit54.i.i.i
  %i.bdc = phi i32 [ %i.bcs, %_ZN11duckdb_zstdL10tr_median3EPKiPiS2_S2_.exit54.i.i.i ], [ %.pre66.i.i.i, %bb.ha ] ; 2 uses
...
bb.au:                                            ; preds = %bb.ar
  ...
  %.060.i.i.a = select i1 %i.pp, ptr %i.oj, ptr %i.ol
  %.0.i50.i = select i1 %i.pp, ptr %i.ol, ptr %i.oj ; 2 uses
  ...
  %.163.i.i = select i1 %i.qc, ptr %.0.i50.i, ptr %spec.select68.i.i ; 3 uses
  %.161.i.i = select i1 %i.qc, ptr %spec.select.i49.i, ptr %.060.i.i.a ; 2 uses
  %.1.i.i = select i1 %i.qc, ptr %spec.select68.i.i, ptr %.0.i50.i
  ...
  %.066.i.i.a = select i1 %i.qr, ptr %.163.i.i, ptr %.0426
  %.264.i.i = select i1 %i.qr, ptr %.0426, ptr %.163.i.i
  ...
  %.3.i.i = select i1 %i.rf, ptr %.1.i.i, ptr %.264.i.i ; 2 uses
  %.2.i.i = select i1 %i.rf, ptr %.066.i.i.a, ptr %.161.i.i ; 2 uses
...
_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit60.i: ; preds = %bb.ax, %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit55.i
  ...
  %i.vi = load i8, ptr %i.vh, align 1, !tbaa !7
  ...
  %i.vp = load i8, ptr %i.vo, align 1, !tbaa !7
  %i.vq = icmp ugt i8 %i.vi, %i.vp                ; 4 uses
  %14 = select i1 %i.vq, i32 %i.vc, i32 %i.vj
  %spec.select.i61.i = select i1 %i.vq, ptr %i.va, ptr %i.vb
  %i.vr = sext i32 %14 to i64
  %i.vs = getelementptr inbounds [4 x i8], ptr %1, i64 %i.vr
  %i.vt = load i32, ptr %i.vs, align 4, !tbaa !3
  %i.vu = sext i32 %i.vt to i64
  %i.vv = getelementptr inbounds i8, ptr %i.ce, i64 %i.vu
  %i.vw = load i8, ptr %i.vv, align 1, !tbaa !7   ; 2 uses
  %i.vx = load i32, ptr %i.uy, align 4, !tbaa !3
  %i.vy = sext i32 %i.vx to i64
  %i.vz = getelementptr inbounds [4 x i8], ptr %1, i64 %i.vy
  %i.wa = load i32, ptr %i.vz, align 4, !tbaa !3
  %i.wb = sext i32 %i.wa to i64
  %i.wc = getelementptr inbounds i8, ptr %i.ce, i64 %i.wb
  %i.wd = load i8, ptr %i.wc, align 1, !tbaa !7   ; 2 uses
  %i.we = icmp ugt i8 %i.vw, %i.wd
  br i1 %i.we, label %bb.ay, label %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit65.i
...
bb.ay:                                            ; preds = %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit60.i
  ...
  %i.wf = sext i32 %15 to i64
  %i.wg = getelementptr inbounds [4 x i8], ptr %1, i64 %i.wf
  %i.wh = load i32, ptr %i.wg, align 4, !tbaa !3
  %i.wi = sext i32 %i.wh to i64
  %i.wj = getelementptr inbounds i8, ptr %i.ce, i64 %i.wi
  %i.wk = load i8, ptr %i.wj, align 1, !tbaa !7
  %i.wl = icmp ugt i8 %i.wk, %i.wd
  %spec.select28..i64.i = select i1 %i.wl, ptr %spec.select28.i63.i, ptr %i.uy ; 2 uses
...
_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit65.i: ; preds = %bb.ay, %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit60.i
  %i.wm = phi i8 [ %i.vw, %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit60.i ], [ %.pre75.i, %bb.ay ] ; 2 uses
  %.0.i62.i = phi ptr [ %spec.select.i61.i, %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit60.i ], [ %spec.select28..i64.i, %bb.ay ]
  %i.wn = load i32, ptr %.0.i52.i, align 4, !tbaa !3 ; 3 uses
  %i.wo = sext i32 %i.wn to i64
  %i.wp = getelementptr inbounds [4 x i8], ptr %1, i64 %i.wo
  %i.wq = load i32, ptr %i.wp, align 4, !tbaa !3
  %i.wr = sext i32 %i.wq to i64
  %i.ws = getelementptr inbounds i8, ptr %i.ce, i64 %i.wr
  %i.wt = load i8, ptr %i.ws, align 1, !tbaa !7
  %i.wu = load i32, ptr %.0.i57.i, align 4, !tbaa !3 ; 3 uses
  %i.wv = sext i32 %i.wu to i64
  %i.ww = getelementptr inbounds [4 x i8], ptr %1, i64 %i.wv
  %i.wx = load i32, ptr %i.ww, align 4, !tbaa !3
  %i.wy = sext i32 %i.wx to i64
  %i.wz = getelementptr inbounds i8, ptr %i.ce, i64 %i.wy
  %i.xa = load i8, ptr %i.wz, align 1, !tbaa !7
  %i.xb = icmp ugt i8 %i.wt, %i.xa                ; 4 uses
  %16 = select i1 %i.xb, i32 %i.wn, i32 %i.wu
  %spec.select.i66.i515 = select i1 %i.xb, ptr %.0.i52.i, ptr %.0.i57.i
  %i.xc = sext i32 %16 to i64
  %i.xd = getelementptr inbounds [4 x i8], ptr %1, i64 %i.xc
  %i.xe = load i32, ptr %i.xd, align 4, !tbaa !3
  %i.xf = sext i32 %i.xe to i64
  %i.xg = getelementptr inbounds i8, ptr %i.ce, i64 %i.xf
  %i.xh = load i8, ptr %i.xg, align 1, !tbaa !7
  %i.xi = icmp ugt i8 %i.xh, %i.wm
  br i1 %i.xi, label %bb.az, label %_ZN11duckdb_zstdL8ss_pivotEPKhPKiPiS4_.exit

bb.az:                                            ; preds = %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit65.i
  %17 = select i1 %i.xb, i32 %i.wu, i32 %i.wn
  %spec.select28.i68.i = select i1 %i.xb, ptr %.0.i57.i, ptr %.0.i52.i
  %i.xj = sext i32 %17 to i64
  %i.xk = getelementptr inbounds [4 x i8], ptr %1, i64 %i.xj
  %i.xl = load i32, ptr %i.xk, align 4, !tbaa !3
  %i.xm = sext i32 %i.xl to i64
  %i.xn = getelementptr inbounds i8, ptr %i.ce, i64 %i.xm
  %i.xo = load i8, ptr %i.xn, align 1, !tbaa !7
  %i.xp = icmp ugt i8 %i.xo, %i.wm
  %spec.select28..i69.i = select i1 %i.xp, ptr %spec.select28.i68.i, ptr %.0.i62.i
  br label %_ZN11duckdb_zstdL8ss_pivotEPKhPKiPiS4_.exit
...
_ZN11duckdb_zstdL8ss_pivotEPKhPKiPiS4_.exit:      ; preds = %bb.as, %bb.at, %bb.au, %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit65.i, %bb.az
  %i.xq = phi i32 [ %i.mw, %bb.as ], [ %i.qd, %bb.au ], [ %i.mw, %bb.at ], [ %i.sb, %bb.az ], [ %i.sb, %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit65.i ]
  ...
  %i.xr = load i32, ptr %.0.i516, align 4, !tbaa !3 ; 2 uses
  %i.xs = sext i32 %i.xr to i64
  %i.xt = getelementptr inbounds [4 x i8], ptr %1, i64 %i.xs
  %i.xu = load i32, ptr %i.xt, align 4, !tbaa !3
  %i.xv = sext i32 %i.xu to i64
  %i.xw = getelementptr inbounds i8, ptr %i.ce, i64 %i.xv
  %i.xx = load i8, ptr %i.xw, align 1, !tbaa !7   ; 14 uses
  store i32 %i.xr, ptr %.0426, align 4, !tbaa !3
  store i32 %i.xq, ptr %.0.i516, align 4, !tbaa !3
  br label %bb.ba

bb.ba:                                            ; preds = %bb.bb, %_ZN11duckdb_zstdL8ss_pivotEPKhPKiPiS4_.exit
  %.0414 = phi ptr [ %.0426, %_ZN11duckdb_zstdL8ss_pivotEPKhPKiPiS4_.exit ], [ %i.xy, %bb.bb ] ; 2 uses
  %i.xy = getelementptr inbounds nuw i8, ptr %.0414, i64 4 ; 9 uses
  %i.xz = icmp ult ptr %i.xy, %.0436
  br i1 %i.xz, label %bb.bb, label %.critedge2

bb.bb:                                            ; preds = %bb.ba
  %i.ya = load i32, ptr %i.xy, align 4, !tbaa !3
  ...
  %i.yf = getelementptr inbounds i8, ptr %i.ce, i64 %i.ye
  %i.yg = load i8, ptr %i.yf, align 1, !tbaa !7   ; 2 uses
  %i.yh = icmp eq i8 %i.yg, %i.xx
  br i1 %i.yh, label %bb.ba, label %.critedge, !llvm.loop !149

.critedge:                                        ; preds = %bb.bb
  %i.yi = icmp ult i8 %i.yg, %i.xx
  br i1 %i.yi, label %.preheader558, label %.critedge2

.preheader558:                                    ; preds = %.critedge
  %i.yj = getelementptr inbounds nuw i8, ptr %.0414, i64 8 ; 3 uses
  %i.yk = icmp ult ptr %i.yj, %.0436
  br i1 %i.yk, label %.lr.ph, label %.critedge2

.lr.ph:                                           ; preds = %.preheader558, %bb.be
  %i.yl = phi ptr [ %i.yw, %bb.be ], [ %i.yj, %.preheader558 ] ; 4 uses
  %.1420600 = phi ptr [ %.2421, %bb.be ], [ %i.xy, %.preheader558 ] ; 5 uses
  %i.ym = load i32, ptr %i.yl, align 4, !tbaa !3  ; 2 uses
  %i.yn = sext i32 %i.ym to i64
  %i.yo = getelementptr inbounds [4 x i8], ptr %1, i64 %i.yn
  %i.yp = load i32, ptr %i.yo, align 4, !tbaa !3
  %i.yq = sext i32 %i.yp to i64
  %i.yr = getelementptr inbounds i8, ptr %i.ce, i64 %i.yq
  %i.ys = load i8, ptr %i.yr, align 1, !tbaa !7   ; 2 uses
  %.not = icmp ugt i8 %i.ys, %i.xx
  br i1 %.not, label %.critedge2, label %bb.bc

bb.bc:                                            ; preds = %.lr.ph
  %i.yt = icmp eq i8 %i.ys, %i.xx
  br i1 %i.yt, label %bb.bd, label %bb.be

bb.bd:                                            ; preds = %bb.bc
  %i.yu = load i32, ptr %.1420600, align 4, !tbaa !3
  store i32 %i.yu, ptr %i.yl, align 4, !tbaa !3
  store i32 %i.ym, ptr %.1420600, align 4, !tbaa !3
  %i.yv = getelementptr inbounds nuw i8, ptr %.1420600, i64 4
  br label %bb.be

bb.be:                                            ; preds = %bb.bd, %bb.bc
  %.2421 = phi ptr [ %i.yv, %bb.bd ], [ %.1420600, %bb.bc ] ; 2 uses
  %i.yw = getelementptr inbounds nuw i8, ptr %i.yl, i64 4 ; 3 uses
  %i.yx = icmp ult ptr %i.yw, %.0436
  br i1 %i.yx, label %.lr.ph, label %.critedge2, !llvm.loop !150

.critedge2:                                       ; preds = %bb.ba, %bb.be, %.lr.ph, %.preheader558, %.critedge
  %.3422 = phi ptr [ %i.xy, %.critedge ], [ %.1420600, %.lr.ph ], [ %i.xy, %.preheader558 ], [ %.2421, %bb.be ], [ %i.xy, %bb.ba ] ; 2 uses
  %.2416 = phi ptr [ %i.xy, %.critedge ], [ %i.yl, %.lr.ph ], [ %i.yj, %.preheader558 ], [ %i.yw, %bb.be ], [ %i.xy, %bb.ba ] ; 6 uses
  br label %bb.bf

bb.bf:                                            ; preds = %bb.bg, %.critedge2
  %.0409 = phi ptr [ %.0436, %.critedge2 ], [ %i.yy, %bb.bg ] ; 2 uses
  %i.yy = getelementptr inbounds i8, ptr %.0409, i64 -4 ; 9 uses
  %i.yz = icmp ult ptr %.2416, %i.yy
  br i1 %i.yz, label %bb.bg, label %.critedge6

bb.bg:                                            ; preds = %bb.bf
  %i.za = load i32, ptr %i.yy, align 4, !tbaa !3
  %i.zb = sext i32 %i.za to i64
  %i.zc = getelementptr inbounds [4 x i8], ptr %1, i64 %i.zb
  %i.zd = load i32, ptr %i.zc, align 4, !tbaa !3
  %i.ze = sext i32 %i.zd to i64
  %i.zf = getelementptr inbounds i8, ptr %i.ce, i64 %i.ze
  %i.zg = load i8, ptr %i.zf, align 1, !tbaa !7   ; 2 uses
  %i.zh = icmp eq i8 %i.zg, %i.xx
  br i1 %i.zh, label %bb.bf, label %.critedge4, !llvm.loop !151

.critedge4:                                       ; preds = %bb.bg
  %i.zi = icmp ugt i8 %i.zg, %i.xx
  br i1 %i.zi, label %.preheader, label %.critedge6

.preheader:                                       ; preds = %.critedge4
  %i.zj = getelementptr inbounds i8, ptr %.0409, i64 -8 ; 3 uses
  %i.zk = icmp ult ptr %.2416, %i.zj
  br i1 %i.zk, label %.lr.ph607, label %.critedge6

.lr.ph607:                                        ; preds = %.preheader, %bb.bj
  %i.zl = phi ptr [ %i.zw, %bb.bj ], [ %i.zj, %.preheader ] ; 4 uses
  %.0403606 = phi ptr [ %.1404, %bb.bj ], [ %i.yy, %.preheader ] ; 5 uses
  %i.zm = load i32, ptr %i.zl, align 4, !tbaa !3  ; 2 uses
  %i.zn = sext i32 %i.zm to i64
  %i.zo = getelementptr inbounds [4 x i8], ptr %1, i64 %i.zn
  %i.zp = load i32, ptr %i.zo, align 4, !tbaa !3
  %i.zq = sext i32 %i.zp to i64
  %i.zr = getelementptr inbounds i8, ptr %i.ce, i64 %i.zq
  %i.zs = load i8, ptr %i.zr, align 1, !tbaa !7   ; 2 uses
  %.not486 = icmp ult i8 %i.zs, %i.xx
  br i1 %.not486, label %.critedge6, label %bb.bh

bb.bh:                                            ; preds = %.lr.ph607
  %i.zt = icmp eq i8 %i.zs, %i.xx
  br i1 %i.zt, label %bb.bi, label %bb.bj

bb.bi:                                            ; preds = %bb.bh
  %i.zu = load i32, ptr %.0403606, align 4, !tbaa !3
  store i32 %i.zu, ptr %i.zl, align 4, !tbaa !3
  store i32 %i.zm, ptr %.0403606, align 4, !tbaa !3
  %i.zv = getelementptr inbounds i8, ptr %.0403606, i64 -4
  br label %bb.bj

bb.bj:                                            ; preds = %bb.bi, %bb.bh
  %.1404 = phi ptr [ %i.zv, %bb.bi ], [ %.0403606, %bb.bh ] ; 2 uses
  %i.zw = getelementptr inbounds i8, ptr %i.zl, i64 -4 ; 3 uses
  %i.zx = icmp ult ptr %.2416, %i.zw
  br i1 %i.zx, label %.lr.ph607, label %.critedge6, !llvm.loop !152

.critedge6:                                       ; preds = %bb.bf, %bb.bj, %.lr.ph607, %.preheader, %.critedge4
  %.2411 = phi ptr [ %i.yy, %.critedge4 ], [ %i.zl, %.lr.ph607 ], [ %i.zj, %.preheader ], [ %i.zw, %bb.bj ], [ %i.yy, %bb.bf ] ; 2 uses
  %.2405 = phi ptr [ %i.yy, %.critedge4 ], [ %.0403606, %.lr.ph607 ], [ %i.yy, %.preheader ], [ %.1404, %bb.bj ], [ %i.yy, %bb.bf ] ; 2 uses
  %i.zy = icmp ult ptr %.2416, %.2411
  br i1 %i.zy, label %.lr.ph631, label %._crit_edge
...
.lr.ph631:                                        ; preds = %.critedge6, %.critedge10
  ...
  %i.zz = load i32, ptr %.3417628, align 4, !tbaa !3
  %i.aaa = load i32, ptr %.3412629, align 4, !tbaa !3
  store i32 %i.aaa, ptr %.3417628, align 4, !tbaa !3
  store i32 %i.zz, ptr %.3412629, align 4, !tbaa !3
  %i.aab = getelementptr inbounds nuw i8, ptr %.3417628, i64 4 ; 3 uses
  %i.aac = icmp ult ptr %i.aab, %.3412629
  br i1 %i.aac, label %.lr.ph614, label %.critedge8

.lr.ph614:                                        ; preds = %.lr.ph631, %bb.bm
  %i.aad = phi ptr [ %i.aao, %bb.bm ], [ %i.aab, %.lr.ph631 ] ; 4 uses
  %.5424613 = phi ptr [ %.6425, %bb.bm ], [ %.4423627, %.lr.ph631 ] ; 5 uses
  %i.aae = load i32, ptr %i.aad, align 4, !tbaa !3 ; 2 uses
  %i.aaf = sext i32 %i.aae to i64
  %i.aag = getelementptr inbounds [4 x i8], ptr %1, i64 %i.aaf
  %i.aah = load i32, ptr %i.aag, align 4, !tbaa !3
  %i.aai = sext i32 %i.aah to i64
  %i.aaj = getelementptr inbounds i8, ptr %i.ce, i64 %i.aai
  %i.aak = load i8, ptr %i.aaj, align 1, !tbaa !7 ; 2 uses
  %.not494 = icmp ugt i8 %i.aak, %i.xx
  br i1 %.not494, label %.critedge8, label %bb.bk

bb.bk:                                            ; preds = %.lr.ph614
  %i.aal = icmp eq i8 %i.aak, %i.xx
  br i1 %i.aal, label %bb.bl, label %bb.bm

bb.bl:                                            ; preds = %bb.bk
  %i.aam = load i32, ptr %.5424613, align 4, !tbaa !3
  store i32 %i.aam, ptr %i.aad, align 4, !tbaa !3
  store i32 %i.aae, ptr %.5424613, align 4, !tbaa !3
  %i.aan = getelementptr inbounds nuw i8, ptr %.5424613, i64 4
  br label %bb.bm

bb.bm:                                            ; preds = %bb.bl, %bb.bk
  %.6425 = phi ptr [ %i.aan, %bb.bl ], [ %.5424613, %bb.bk ] ; 2 uses
  %i.aao = getelementptr inbounds nuw i8, ptr %i.aad, i64 4 ; 3 uses
  %i.aap = icmp ult ptr %i.aao, %.3412629
  br i1 %i.aap, label %.lr.ph614, label %.critedge8, !llvm.loop !153

.critedge8:                                       ; preds = %.lr.ph614, %bb.bm, %.lr.ph631
  %.5424.lcssa = phi ptr [ %.4423627, %.lr.ph631 ], [ %.6425, %bb.bm ], [ %.5424613, %.lr.ph614 ] ; 2 uses
  %.lcssa571 = phi ptr [ %i.aab, %.lr.ph631 ], [ %i.aao, %bb.bm ], [ %i.aad, %.lr.ph614 ] ; 5 uses
  %i.aaq = getelementptr inbounds i8, ptr %.3412629, i64 -4 ; 3 uses
  %i.aar = icmp ult ptr %.lcssa571, %i.aaq
  br i1 %i.aar, label %.lr.ph621, label %.critedge10

.lr.ph621:                                        ; preds = %.critedge8, %bb.bp
  %i.aas = phi ptr [ %i.abd, %bb.bp ], [ %i.aaq, %.critedge8 ] ; 4 uses
