...
_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit60.i: ; preds = %bb.ax, %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit55.i
  ...
  %i.vx = load i8, ptr %i.vw, align 1, !tbaa !7   ; 2 uses
  ...
  br i1 %i.wf, label %bb.ay, label %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit65.i

bb.ay:                                            ; preds = %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit60.i
  %14 = select i1 %i.vq, i32 %i.vj, i32 %i.vc
  %spec.select28.i63.i = select i1 %i.vq, ptr %i.vb, ptr %i.va
  %i.wg = sext i32 %14 to i64
...
_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit65.i: ; preds = %bb.ay, %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit60.i
  %i.wn = phi i8 [ %i.vx, %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit60.i ], [ %.pre75.i, %bb.ay ] ; 2 uses
...
bb.az:                                            ; preds = %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit65.i
  %16 = select i1 %i.xc, i32 %i.wv, i32 %i.wo
  %spec.select28.i68.i = select i1 %i.xc, ptr %.0.i57.i, ptr %.0.i52.i
  %i.xk = sext i32 %16 to i64
