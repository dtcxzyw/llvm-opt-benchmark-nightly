...
bb.gu:                                            ; preds = %bb.gt
  ...
  br i1 %i.axx, label %bb.gv, label %_ZN11duckdb_zstdL8tr_pivotEPKiPiS2_.exit.i.i
...
bb.gx:                                            ; preds = %bb.gs
  ...
  br i1 %i.bbh, label %bb.gy, label %_ZN11duckdb_zstdL10tr_median3EPKiPiS2_S2_.exit49.i.i.i
...
_ZN11duckdb_zstdL10tr_median3EPKiPiS2_S2_.exit49.i.i.i: ; preds = %bb.gy, %bb.gx
  ...
  br i1 %i.bch, label %bb.gz, label %_ZN11duckdb_zstdL10tr_median3EPKiPiS2_S2_.exit54.i.i.i
...
_ZN11duckdb_zstdL10tr_median3EPKiPiS2_S2_.exit59.i.i.i: ; preds = %bb.ha, %_ZN11duckdb_zstdL10tr_median3EPKiPiS2_S2_.exit54.i.i.i
  ...
  br i1 %i.beb, label %bb.hb, label %_ZN11duckdb_zstdL8tr_pivotEPKiPiS2_.exit.i.i
...
_ZN11duckdb_zstdL8tr_pivotEPKiPiS2_.exit.i.i:     ; preds = %bb.hb, %_ZN11duckdb_zstdL10tr_median3EPKiPiS2_S2_.exit59.i.i.i, %bb.gw, %bb.gv, %bb.gu
  %i.beh = phi i32 [ %i.axg, %bb.gu ], [ %i.azj, %bb.gw ], [ %i.axg, %bb.gv ], [ %i.baq, %bb.hb ], [ %i.baq, %_ZN11duckdb_zstdL10tr_median3EPKiPiS2_S2_.exit59.i.i.i ]
...
bb.hc:                                            ; preds = %bb.hd, %_ZN11duckdb_zstdL8tr_pivotEPKiPiS2_.exit.i.i
  %.0154.i.i = phi ptr [ %.0455.ph.i.i, %_ZN11duckdb_zstdL8tr_pivotEPKiPiS2_.exit.i.i ], [ %i.ben, %bb.hd ] ; 2 uses
  %i.ben = getelementptr inbounds nuw i8, ptr %.0154.i.i, i64 4 ; 9 uses
  %i.beo = icmp ult ptr %i.ben, %.0463.ph.i.i
  br i1 %i.beo, label %bb.hd, label %.critedge2.i55.i
...
bb.hd:                                            ; preds = %bb.hc
  ...
  br i1 %i.bet, label %bb.hc, label %.critedge.i58.i, !llvm.loop !46
...
.lr.ph.i59.i:                                     ; preds = %.preheader206.i.i, %bb.hg
  %i.bex = phi ptr [ %i.bff, %bb.hg ], [ %i.bev, %.preheader206.i.i ] ; 4 uses
  %.0159217.i.i = phi ptr [ %.1160.i.i, %bb.hg ], [ %i.ben, %.preheader206.i.i ] ; 5 uses
...
bb.he:                                            ; preds = %.lr.ph.i59.i
  ...
  br i1 %i.bfc, label %bb.hf, label %bb.hg
...
bb.hg:                                            ; preds = %bb.hf, %bb.he
  %.1160.i.i = phi ptr [ %i.bfe, %bb.hf ], [ %.0159217.i.i, %bb.he ] ; 2 uses
  %i.bff = getelementptr inbounds nuw i8, ptr %i.bex, i64 4 ; 3 uses
  %i.bfg = icmp ult ptr %i.bff, %.0463.ph.i.i
  br i1 %i.bfg, label %.lr.ph.i59.i, label %.critedge2.i55.i, !llvm.loop !47

.critedge2.i55.i:                                 ; preds = %bb.hc, %bb.hg, %.lr.ph.i59.i, %.preheader206.i.i, %.critedge.i58.i
  %.2161.i.i = phi ptr [ %i.ben, %.critedge.i58.i ], [ %.0159217.i.i, %.lr.ph.i59.i ], [ %i.ben, %.preheader206.i.i ], [ %.1160.i.i, %bb.hg ], [ %i.ben, %bb.hc ] ; 2 uses
  %.2156.i.i = phi ptr [ %i.ben, %.critedge.i58.i ], [ %i.bex, %.lr.ph.i59.i ], [ %i.bev, %.preheader206.i.i ], [ %i.bff, %bb.hg ], [ %i.ben, %bb.hc ] ; 6 uses
  br label %bb.hh

bb.hh:                                            ; preds = %bb.hi, %.critedge2.i55.i
  %.0149.i.i = phi ptr [ %.0463.ph.i.i, %.critedge2.i55.i ], [ %i.bfh, %bb.hi ] ; 2 uses
  %i.bfh = getelementptr inbounds i8, ptr %.0149.i.i, i64 -4 ; 9 uses
  %i.bfi = icmp ult ptr %.2156.i.i, %i.bfh
  br i1 %i.bfi, label %bb.hi, label %.critedge6.i.i
...
bb.hi:                                            ; preds = %bb.hh
  ...
  br i1 %i.bfn, label %bb.hh, label %.critedge4.i.i, !llvm.loop !48
...
.lr.ph223.i.i:                                    ; preds = %.preheader.i.i298, %bb.hl
  %i.bfr = phi ptr [ %i.bfz, %bb.hl ], [ %i.bfp, %.preheader.i.i298 ] ; 4 uses
  %.0143222.i.i = phi ptr [ %.1144.i.i, %bb.hl ], [ %i.bfh, %.preheader.i.i298 ] ; 5 uses
...
bb.hj:                                            ; preds = %.lr.ph223.i.i
  ...
  br i1 %i.bfw, label %bb.hk, label %bb.hl
...
bb.hl:                                            ; preds = %bb.hk, %bb.hj
  %.1144.i.i = phi ptr [ %i.bfy, %bb.hk ], [ %.0143222.i.i, %bb.hj ] ; 2 uses
  %i.bfz = getelementptr inbounds i8, ptr %i.bfr, i64 -4 ; 3 uses
  %i.bga = icmp ult ptr %.2156.i.i, %i.bfz
  br i1 %i.bga, label %.lr.ph223.i.i, label %.critedge6.i.i, !llvm.loop !49

.critedge6.i.i:                                   ; preds = %bb.hh, %bb.hl, %.lr.ph223.i.i, %.preheader.i.i298, %.critedge4.i.i
  %.2151.i.i = phi ptr [ %i.bfh, %.critedge4.i.i ], [ %i.bfr, %.lr.ph223.i.i ], [ %i.bfp, %.preheader.i.i298 ], [ %i.bfz, %bb.hl ], [ %i.bfh, %bb.hh ] ; 2 uses
  %.2145.i.i = phi ptr [ %i.bfh, %.critedge4.i.i ], [ %.0143222.i.i, %.lr.ph223.i.i ], [ %i.bfh, %.preheader.i.i298 ], [ %.1144.i.i, %bb.hl ], [ %i.bfh, %bb.hh ] ; 2 uses
...
.lr.ph230.i.i:                                    ; preds = %.lr.ph247.i.i, %bb.ho
  %i.bgg = phi ptr [ %i.bgo, %bb.ho ], [ %i.bge, %.lr.ph247.i.i ] ; 4 uses
...
bb.hm:                                            ; preds = %.lr.ph230.i.i
  ...
  br i1 %i.bgl, label %bb.hn, label %bb.ho
...
bb.ho:                                            ; preds = %bb.hn, %bb.hm
  %.5164.i.i = phi ptr [ %i.bgn, %bb.hn ], [ %.4163229.i.i, %bb.hm ] ; 2 uses
  %i.bgo = getelementptr inbounds nuw i8, ptr %i.bgg, i64 4 ; 3 uses
  %i.bgp = icmp ult ptr %i.bgo, %.3152245.i.i
  br i1 %i.bgp, label %.lr.ph230.i.i, label %.critedge8.i.i, !llvm.loop !50
...
.critedge8.i.i:                                   ; preds = %bb.ho, %.lr.ph230.i.i, %.lr.ph247.i.i
  ...
  %.lcssa.i57.i = phi ptr [ %i.bge, %.lr.ph247.i.i ], [ %i.bgo, %bb.ho ], [ %i.bgg, %.lr.ph230.i.i ] ; 5 uses
...
.lr.ph237.i.i:                                    ; preds = %.critedge8.i.i, %bb.hr
  %i.bgs = phi ptr [ %i.bha, %bb.hr ], [ %i.bgq, %.critedge8.i.i ] ; 4 uses
...
bb.av:                                            ; preds = %bb.aq
  ...
  br i1 %i.tj, label %bb.aw, label %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit55.i
...
_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit55.i: ; preds = %bb.aw, %bb.av
  ...
  br i1 %i.uy, label %bb.ax, label %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit60.i
...
_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit65.i: ; preds = %bb.ay, %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit60._ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit65_crit_edge.i
  ...
  br i1 %i.xu, label %bb.az, label %_ZN11duckdb_zstdL8ss_pivotEPKhPKiPiS4_.exit
...
_ZN11duckdb_zstdL8ss_pivotEPKhPKiPiS4_.exit:      ; preds = %bb.as, %bb.at, %bb.au, %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit65.i, %bb.az
  %i.yd = phi i32 [ %i.mw, %bb.as ], [ %i.qh, %bb.au ], [ %i.mw, %bb.at ], [ %i.sg, %bb.az ], [ %i.sg, %_ZN11duckdb_zstdL10ss_median3EPKhPKiPiS4_S4_.exit65.i ]
...
bb.ba:                                            ; preds = %bb.bb, %_ZN11duckdb_zstdL8ss_pivotEPKhPKiPiS4_.exit
  %.0414 = phi ptr [ %.0426, %_ZN11duckdb_zstdL8ss_pivotEPKhPKiPiS4_.exit ], [ %i.yl, %bb.bb ] ; 2 uses
...
bb.bb:                                            ; preds = %bb.ba
  ...
  br i1 %i.yu, label %bb.ba, label %.critedge, !llvm.loop !149
...
bb.be:                                            ; preds = %bb.bd, %bb.bc
  ...
  br i1 %i.zk, label %.lr.ph, label %.critedge2, !llvm.loop !150
...
bb.bg:                                            ; preds = %bb.bf
  ...
  br i1 %i.zu, label %bb.bf, label %.critedge4, !llvm.loop !151
...
bb.bj:                                            ; preds = %bb.bi, %bb.bh
  ...
  br i1 %i.aak, label %.lr.ph607, label %.critedge6, !llvm.loop !152
