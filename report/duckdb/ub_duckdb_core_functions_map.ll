...
@.str.27 = private unnamed_addr constant [11 x i8] c"list_value\00", align 1
...
_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit: ; preds = %bb.l
  ...
  %bcmp.i.i = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(3) %i.am, ptr noundef nonnull dereferenceable(3) @.str.21, i64 3)
...
_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit: ; preds = %bb.f
  ...
  %bcmp.i.i = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(10) %i.p, ptr noundef nonnull dereferenceable(10) @.str.27, i64 10)
